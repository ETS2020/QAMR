...
module FAU ( 
  ...
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n77_), .d(x02), .O(new_n90_));
  nor2   g47(.a(x16), .b(x15), .O(new_n91_));
  nor2   g48(.a(x22), .b(x21), .O(new_n92_));
  nand3  g49(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n93_));
  oai21  g50(.a(new_n93_), .b(new_n90_), .c(new_n46_), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(new_n47_), .O(new_n95_));
  nor3   g52(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n96_));
  ...
  oai21  g57(.a(new_n100_), .b(new_n90_), .c(new_n46_), .O(new_n101_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n90_), .c(new_n46_), .O(new_n107_));
  ...
  aoi21  g78(.a(new_n116_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g79(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z14));
  nand4  g81(.a(x19), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n114_), .O(z15));
  nor2   g83(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g84(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
