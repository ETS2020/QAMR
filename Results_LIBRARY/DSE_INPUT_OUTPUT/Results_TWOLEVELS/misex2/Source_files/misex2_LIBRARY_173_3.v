...
module FAU ( 
  ...
  aoi21  g26(.a(new_n60_), .b(new_n57_), .c(new_n56_), .O(z07));
  inv1   g27(.a(x08), .O(new_n73_));
  inv1   g28(.a(x05), .O(new_n74_));
  inv1   g29(.a(x06), .O(new_n75_));
  inv1   g30(.a(x03), .O(new_n76_));
  nand4  g31(.a(new_n76_), .b(x02), .c(new_n57_), .d(new_n56_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n92_), .b(new_n64_), .c(x18), .d(x01), .O(new_n93_));
  oai21  g48(.a(new_n91_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n56_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand2  g51(.a(new_n64_), .b(x18), .O(new_n97_));
  nand3  g52(.a(x22), .b(x21), .c(new_n92_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n97_), .c(new_n56_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x01), .O(new_n100_));
  inv1   g55(.a(x13), .O(new_n101_));
  nand2  g56(.a(new_n86_), .b(new_n56_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(x12), .d(new_n85_), .O(new_n104_));
  inv1   g59(.a(x14), .O(new_n105_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(x20), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(x16), .c(x15), .d(new_n105_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n104_), .c(new_n100_), .O(z10));
  nand3  g64(.a(new_n84_), .b(x21), .c(new_n92_), .O(new_n110_));
  oai21  g65(.a(new_n110_), .b(new_n97_), .c(new_n56_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x01), .O(new_n112_));
  nand4  g67(.a(new_n107_), .b(new_n89_), .c(x15), .d(new_n105_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n104_), .c(new_n112_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n64_), .b(x17), .c(new_n60_), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(new_n115_), .c(x24), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(x09), .c(new_n57_), .d(new_n56_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n59_), .O(z12));
  nand2  g74(.a(new_n47_), .b(x17), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x19), .O(z13));
  nand3  g76(.a(new_n61_), .b(new_n46_), .c(new_n60_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n65_), .c(new_n59_), .O(z14));
  nand3  g78(.a(x19), .b(new_n60_), .c(new_n57_), .O(new_n124_));
  oai21  g79(.a(new_n86_), .b(new_n56_), .c(new_n124_), .O(z15));
  nor2   g80(.a(new_n57_), .b(x00), .O(z16));
  nand2  g81(.a(new_n102_), .b(new_n59_), .O(z17));
  zero   g82(.O(z04));
  zero   g83(.O(z06));
endmodule
