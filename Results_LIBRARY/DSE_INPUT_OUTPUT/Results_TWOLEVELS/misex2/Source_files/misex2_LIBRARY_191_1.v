...
module FAU ( 
  ...
  nand2  g010(.a(x16), .b(new_n53_), .O(new_n54_));
  ...
  nand4  g023(.a(new_n54_), .b(new_n66_), .c(x18), .d(new_n44_), .O(new_n67_));
  ...
  inv1   g037(.a(new_n54_), .O(new_n81_));
  ...
  nand2  g053(.a(new_n96_), .b(new_n54_), .O(z08));
  ...
  nand4  g059(.a(new_n102_), .b(x20), .c(new_n59_), .d(new_n101_), .O(new_n103_));
  ...
  nand4  g066(.a(new_n54_), .b(x22), .c(x21), .d(new_n104_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n66_), .c(x18), .d(x01), .O(new_n112_));
  nand2  g069(.a(x10), .b(x02), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(x01), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n83_), .O(new_n115_));
  nand2  g072(.a(new_n115_), .b(new_n73_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nor3   g074(.a(new_n59_), .b(new_n101_), .c(x14), .O(new_n118_));
  ...
  aoi21  g078(.a(new_n121_), .b(new_n112_), .c(x00), .O(z10));
  nand4  g079(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n66_), .O(new_n123_));
  nand3  g080(.a(new_n115_), .b(new_n88_), .c(new_n73_), .O(new_n124_));
  nor2   g081(.a(new_n101_), .b(x14), .O(new_n125_));
  nor2   g082(.a(x21), .b(new_n104_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n125_), .c(new_n59_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n99_), .c(new_n64_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n54_), .O(z11));
  inv1   g087(.a(x24), .O(new_n131_));
  nand3  g088(.a(new_n113_), .b(x01), .c(x00), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(x23), .O(new_n133_));
  nand3  g090(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n65_), .c(new_n64_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n131_), .c(x09), .O(new_n138_));
  ...
  nor3   g098(.a(x02), .b(x01), .c(x00), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n56_), .c(new_n44_), .d(new_n47_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n59_), .c(x10), .O(z14));
  oai21  g101(.a(new_n66_), .b(x01), .c(new_n64_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n54_), .c(new_n46_), .O(new_n146_));
  nand4  g103(.a(new_n59_), .b(new_n53_), .c(x01), .d(x00), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n146_), .O(z15));
  nor3   g105(.a(new_n81_), .b(new_n65_), .c(x00), .O(z16));
  nand2  g106(.a(new_n89_), .b(new_n54_), .O(z17));
endmodule
