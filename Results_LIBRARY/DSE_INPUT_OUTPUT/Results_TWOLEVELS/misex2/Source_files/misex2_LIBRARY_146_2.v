...
module FAU ( 
  ...
  nor2   g001(.a(x14), .b(new_n44_), .O(new_n45_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n78_), .d(new_n70_), .O(new_n89_));
  ...
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n63_), .O(new_n98_));
  ...
  nor2   g060(.a(new_n52_), .b(new_n78_), .O(new_n104_));
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n53_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n70_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n46_), .O(z09));
  nand3  g065(.a(new_n53_), .b(x18), .c(x01), .O(new_n109_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n46_), .O(z10));
  nand4  g078(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n53_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n70_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n78_), .c(new_n70_), .O(new_n133_));
  ...
  nor2   g093(.a(new_n45_), .b(x19), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(x17), .c(new_n47_), .d(new_n78_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  oai21  g096(.a(new_n59_), .b(new_n50_), .c(new_n46_), .O(z14));
  oai21  g097(.a(x10), .b(new_n78_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n47_), .c(new_n78_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n45_), .O(z15));
  nor3   g101(.a(new_n45_), .b(new_n78_), .c(x00), .O(z16));
  nand2  g102(.a(new_n97_), .b(new_n70_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n46_), .O(z17));
endmodule
