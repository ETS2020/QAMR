...
module FAU ( 
  ...
  nor2   g008(.a(new_n51_), .b(x08), .O(new_n52_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n44_), .d(new_n74_), .O(new_n90_));
  ...
  nor2   g051(.a(new_n94_), .b(x21), .O(z08));
  ...
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n51_), .d(new_n74_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n53_), .O(z09));
  nand3  g065(.a(new_n50_), .b(x18), .c(x01), .O(new_n109_));
  nor4   g066(.a(new_n109_), .b(new_n96_), .c(new_n51_), .d(x20), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n71_), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(new_n98_), .c(new_n70_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand3  g070(.a(new_n96_), .b(new_n51_), .c(x20), .O(new_n114_));
  nor4   g071(.a(new_n114_), .b(new_n101_), .c(new_n100_), .d(x14), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n113_), .c(new_n110_), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n53_), .O(z10));
  nand3  g074(.a(x18), .b(x08), .c(x01), .O(new_n118_));
  nand3  g075(.a(x21), .b(new_n104_), .c(new_n50_), .O(new_n119_));
  nor2   g076(.a(new_n100_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n51_), .c(x20), .d(new_n101_), .O(new_n121_));
  oai22  g078(.a(new_n121_), .b(new_n112_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n96_), .c(new_n74_), .O(new_n123_));
  ...
  nand4  g089(.a(new_n132_), .b(new_n53_), .c(new_n125_), .d(x09), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nand2  g091(.a(new_n44_), .b(new_n74_), .O(new_n135_));
  oai21  g092(.a(new_n129_), .b(new_n135_), .c(new_n53_), .O(z13));
  ...
  aoi21  g098(.a(new_n141_), .b(new_n140_), .c(new_n52_), .O(z15));
  oai21  g099(.a(new_n44_), .b(x00), .c(new_n53_), .O(z16));
  oai21  g100(.a(new_n97_), .b(x00), .c(new_n53_), .O(z17));
endmodule
