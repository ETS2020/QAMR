...
module FAU ( 
  ...
  nor2   g007(.a(x21), .b(x03), .O(new_n51_));
  ...
  aoi21  g025(.a(new_n68_), .b(new_n66_), .c(new_n51_), .O(z03));
  ...
  nor3   g034(.a(new_n51_), .b(new_n70_), .c(new_n47_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n46_), .c(x02), .d(x01), .O(new_n79_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n44_), .d(new_n77_), .O(new_n91_));
  ...
  nand3  g065(.a(new_n108_), .b(new_n97_), .c(new_n77_), .O(new_n109_));
  aoi21  g066(.a(new_n109_), .b(x03), .c(x21), .O(z09));
  nand3  g067(.a(new_n50_), .b(x18), .c(x01), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(new_n97_), .c(new_n85_), .d(x20), .O(new_n112_));
  nor2   g069(.a(x13), .b(new_n71_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n99_), .c(new_n70_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nand3  g072(.a(new_n97_), .b(new_n85_), .c(x20), .O(new_n116_));
  ...
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n120_));
  nor2   g077(.a(new_n101_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n85_), .c(x20), .d(new_n102_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n114_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n97_), .c(new_n77_), .O(new_n124_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n44_), .c(new_n77_), .O(new_n131_));
  ...
  nand3  g093(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n137_));
  ...
  nor3   g099(.a(new_n51_), .b(new_n44_), .c(x00), .O(z16));
  oai21  g100(.a(new_n98_), .b(x00), .c(new_n52_), .O(z17));
endmodule
