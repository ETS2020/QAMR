...
module FAU ( 
  ...
  nand4  g033(.a(new_n76_), .b(x10), .c(x09), .d(new_n61_), .O(new_n77_));
  inv1   g034(.a(new_n77_), .O(z05));
  nor2   g035(.a(new_n70_), .b(new_n58_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n47_), .c(x02), .d(x00), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(new_n61_), .c(new_n69_), .O(z06));
  ...
  oai21  g050(.a(new_n93_), .b(new_n91_), .c(new_n53_), .O(z08));
  ...
  nor2   g064(.a(new_n45_), .b(x06), .O(new_n108_));
  ...
  nand3  g076(.a(new_n119_), .b(new_n88_), .c(new_n70_), .O(new_n120_));
  inv1   g077(.a(x20), .O(new_n121_));
  nand4  g078(.a(new_n102_), .b(x21), .c(new_n121_), .d(new_n55_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n86_), .O(new_n127_));
