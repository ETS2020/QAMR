...
module FAU ( 
  ...
  nor2   g019(.a(x21), .b(x06), .O(new_n63_));
  ...
  oai21  g037(.a(new_n80_), .b(new_n78_), .c(new_n53_), .O(z06));
  ...
  nor3   g047(.a(x08), .b(x07), .c(x05), .O(new_n91_));
  nor2   g048(.a(new_n50_), .b(x18), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x17), .O(new_n93_));
  aoi21  g050(.a(new_n93_), .b(x21), .c(x06), .O(z08));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n71_), .c(x02), .d(new_n44_), .O(new_n96_));
  ...
  nand3  g060(.a(new_n103_), .b(new_n95_), .c(new_n78_), .O(new_n104_));
  aoi21  g061(.a(new_n104_), .b(x06), .c(x21), .O(z09));
  ...
  nand3  g071(.a(new_n95_), .b(new_n52_), .c(x20), .O(new_n115_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n95_), .c(new_n78_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n44_), .c(new_n78_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n130_), .c(x09), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n53_), .O(z12));
  oai21  g096(.a(new_n134_), .b(new_n87_), .c(new_n53_), .O(z13));
  nand4  g097(.a(new_n60_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  ...
  oai21  g103(.a(new_n44_), .b(x00), .c(new_n53_), .O(z16));
  oai21  g104(.a(new_n109_), .b(x00), .c(new_n53_), .O(z17));
endmodule
