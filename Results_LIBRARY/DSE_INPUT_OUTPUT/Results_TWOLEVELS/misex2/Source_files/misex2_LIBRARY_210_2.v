...
module FAU ( 
  ...
  aoi21  g31(.a(x12), .b(new_n47_), .c(new_n68_), .O(new_n75_));
  ...
  nor2   g35(.a(x09), .b(new_n48_), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(new_n78_), .c(x11), .d(x10), .O(new_n80_));
  ...
  nand3  g65(.a(new_n108_), .b(new_n94_), .c(new_n68_), .O(new_n109_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n93_), .c(new_n46_), .O(new_n118_));
  ...
  nand3  g79(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n122_), .c(x01), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  oai22  g82(.a(new_n125_), .b(new_n49_), .c(x01), .d(new_n46_), .O(z12));
  aoi21  g83(.a(new_n123_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g84(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n128_));
  ...
  nor2   g89(.a(new_n47_), .b(x00), .O(z16));
  nand3  g90(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n134_));
