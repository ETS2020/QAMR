...
module FAU ( 
  ...
  nand2  g007(.a(x06), .b(x04), .O(new_n51_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n51_), .c(new_n95_), .d(new_n94_), .O(new_n106_));
  ...
  nand4  g091(.a(new_n134_), .b(new_n51_), .c(new_n127_), .d(x09), .O(new_n135_));
  ...
  nand4  g095(.a(new_n58_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n139_));
  ...
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n61_), .O(z15));
  oai21  g101(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand4  g102(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n73_), .O(new_n146_));
