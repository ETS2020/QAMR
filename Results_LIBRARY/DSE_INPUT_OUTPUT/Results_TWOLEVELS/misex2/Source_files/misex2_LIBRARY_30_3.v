...
module FAU ( 
  ...
  nand2  g007(.a(x16), .b(x05), .O(new_n51_));
  ...
  nand2  g041(.a(new_n84_), .b(new_n73_), .O(new_n85_));
  ...
  nand2  g049(.a(new_n92_), .b(new_n51_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n69_), .c(x02), .d(new_n44_), .O(new_n96_));
  ...
  nand4  g063(.a(new_n51_), .b(x22), .c(x21), .d(new_n101_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n50_), .c(x18), .d(x01), .O(new_n109_));
  nand3  g066(.a(new_n87_), .b(x02), .c(new_n44_), .O(new_n110_));
  ...
  nor3   g071(.a(new_n98_), .b(new_n97_), .c(x14), .O(new_n115_));
  ...
  aoi21  g075(.a(new_n118_), .b(new_n109_), .c(x00), .O(z10));
  nand4  g076(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n50_), .O(new_n120_));
  nand3  g077(.a(new_n112_), .b(new_n84_), .c(new_n69_), .O(new_n121_));
  nor2   g078(.a(new_n97_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n101_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n98_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  ...
  oai21  g095(.a(new_n138_), .b(new_n132_), .c(new_n51_), .O(z13));
  ...
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n51_), .O(z15));
  nand3  g102(.a(new_n51_), .b(x01), .c(new_n73_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n85_), .b(new_n51_), .O(z17));
endmodule
