...
module FAU ( 
  ...
  nand4  g023(.a(new_n66_), .b(new_n65_), .c(x18), .d(new_n50_), .O(new_n67_));
  ...
  nor4   g031(.a(new_n71_), .b(new_n44_), .c(new_n56_), .d(new_n47_), .O(z05));
  inv1   g032(.a(x01), .O(new_n76_));
  oai21  g033(.a(x14), .b(x12), .c(x11), .O(new_n77_));
  ...
  nand4  g059(.a(x20), .b(new_n102_), .c(new_n101_), .d(new_n44_), .O(new_n103_));
  ...
  nand3  g065(.a(x18), .b(x14), .c(x01), .O(new_n109_));
  ...
  nand3  g076(.a(new_n112_), .b(new_n87_), .c(new_n69_), .O(new_n120_));
  inv1   g077(.a(x20), .O(new_n121_));
  nand4  g078(.a(new_n110_), .b(x21), .c(new_n121_), .d(new_n65_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n98_), .c(new_n86_), .O(new_n127_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n76_), .c(new_n86_), .O(new_n135_));
  ...
  oai21  g099(.a(x10), .b(new_n76_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n76_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n45_), .O(z15));
  aoi21  g103(.a(x14), .b(x00), .c(new_n76_), .O(z16));
