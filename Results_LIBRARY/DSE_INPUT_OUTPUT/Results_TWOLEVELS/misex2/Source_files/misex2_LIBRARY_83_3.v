...
module FAU ( 
  ...
  aoi21  g034(.a(new_n77_), .b(new_n62_), .c(new_n76_), .O(z05));
  nand4  g035(.a(new_n62_), .b(x11), .c(x10), .d(new_n46_), .O(new_n79_));
  ...
  nand3  g040(.a(new_n62_), .b(new_n71_), .c(x11), .O(new_n84_));
  ...
  nand4  g051(.a(new_n94_), .b(x19), .c(new_n50_), .d(x17), .O(new_n95_));
  oai21  g052(.a(new_n95_), .b(new_n93_), .c(new_n44_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand3  g055(.a(new_n90_), .b(x12), .c(new_n70_), .O(new_n99_));
  ...
  nor2   g060(.a(new_n50_), .b(new_n76_), .O(new_n104_));
  nor3   g061(.a(x24), .b(x20), .c(x19), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  oai21  g063(.a(new_n103_), .b(new_n99_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n88_), .O(new_n108_));
  ...
  nand2  g070(.a(x02), .b(new_n76_), .O(new_n114_));
  ...
  nand4  g080(.a(new_n90_), .b(new_n115_), .c(x12), .d(new_n70_), .O(new_n124_));
  nand4  g081(.a(new_n104_), .b(x21), .c(new_n111_), .d(new_n51_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n98_), .c(new_n88_), .O(new_n129_));
  ...
  nand4  g092(.a(new_n135_), .b(new_n62_), .c(new_n76_), .d(new_n88_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n54_), .b(x17), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z13));
  nand4  g098(.a(new_n54_), .b(new_n49_), .c(new_n59_), .d(new_n46_), .O(new_n142_));
  nor3   g099(.a(new_n142_), .b(x19), .c(x18), .O(z14));
  oai21  g100(.a(x10), .b(new_n76_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n45_), .c(new_n76_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n44_), .O(z15));
  nand3  g104(.a(new_n62_), .b(x01), .c(new_n88_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n47_), .b(x02), .O(new_n150_));
