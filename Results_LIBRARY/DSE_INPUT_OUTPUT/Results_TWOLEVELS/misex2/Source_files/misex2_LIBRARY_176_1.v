...
module FAU ( 
  ...
  nor2   g020(.a(new_n63_), .b(x21), .O(new_n64_));
  ...
  nand4  g031(.a(new_n52_), .b(new_n68_), .c(new_n67_), .d(x10), .O(new_n75_));
  ...
  nor2   g038(.a(new_n64_), .b(new_n67_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x10), .c(new_n46_), .d(x02), .O(new_n83_));
  nor3   g040(.a(new_n83_), .b(new_n44_), .c(new_n74_), .O(z06));
  nand4  g041(.a(new_n52_), .b(new_n68_), .c(x11), .d(x10), .O(new_n85_));
  ...
  nand3  g054(.a(new_n90_), .b(x12), .c(new_n67_), .O(new_n98_));
  ...
  nand3  g063(.a(new_n106_), .b(new_n97_), .c(new_n74_), .O(new_n107_));
  aoi21  g064(.a(new_n107_), .b(new_n63_), .c(x21), .O(z09));
  ...
  aoi21  g075(.a(new_n118_), .b(new_n114_), .c(new_n111_), .O(new_n119_));
  ...
  nand4  g079(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n50_), .O(new_n123_));
  nor2   g080(.a(x16), .b(new_n99_), .O(new_n124_));
  nor2   g081(.a(x23), .b(x21), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n124_), .c(x20), .d(new_n115_), .O(new_n126_));
  ...
  nand4  g089(.a(new_n57_), .b(new_n50_), .c(x17), .d(new_n45_), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n132_), .c(new_n64_), .O(new_n134_));
  nand2  g091(.a(new_n50_), .b(new_n45_), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(x23), .c(x21), .d(new_n44_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x00), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n134_), .c(new_n130_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(new_n46_), .O(z12));
  nand2  g096(.a(new_n133_), .b(new_n52_), .O(z13));
  ...
  nand4  g105(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n74_), .O(new_n149_));
