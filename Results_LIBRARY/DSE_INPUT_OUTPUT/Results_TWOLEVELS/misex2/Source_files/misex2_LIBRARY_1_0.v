...
module FAU ( 
  ...
  nand4  g05(.a(x05), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n49_));
  ...
  nand2  g16(.a(new_n48_), .b(new_n46_), .O(new_n60_));
  inv1   g17(.a(x19), .O(new_n61_));
  nand3  g18(.a(new_n61_), .b(x18), .c(new_n44_), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n60_), .c(x05), .O(new_n63_));
  ...
  nand4  g44(.a(x12), .b(new_n68_), .c(x02), .d(new_n47_), .O(new_n88_));
  ...
  nand3  g51(.a(new_n94_), .b(new_n93_), .c(new_n61_), .O(new_n95_));
  ...
  nand3  g55(.a(new_n61_), .b(x18), .c(x01), .O(new_n99_));
  nand3  g56(.a(x22), .b(x21), .c(new_n93_), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g58(.a(x02), .b(new_n47_), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(x12), .c(new_n68_), .O(new_n104_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n112_), .c(new_n68_), .O(new_n114_));
  nand4  g71(.a(new_n94_), .b(x21), .c(new_n93_), .d(new_n61_), .O(new_n115_));
  nor2   g72(.a(new_n89_), .b(x14), .O(new_n116_));
  nor2   g73(.a(x21), .b(new_n93_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n116_), .c(new_n90_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n114_), .c(new_n115_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n87_), .c(new_n46_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n75_), .O(z11));
  inv1   g78(.a(x24), .O(new_n122_));
  aoi21  g79(.a(x10), .b(x02), .c(new_n47_), .O(new_n123_));
  ...
  nand2  g87(.a(new_n130_), .b(new_n75_), .O(z12));
  nand4  g88(.a(new_n61_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(x05), .c(x01), .O(z13));
  nor3   g90(.a(x09), .b(x02), .c(x00), .O(new_n134_));
  nor2   g91(.a(x19), .b(x18), .O(new_n135_));
  nand4  g92(.a(new_n135_), .b(new_n134_), .c(new_n44_), .d(new_n57_), .O(new_n136_));
  aoi21  g93(.a(new_n136_), .b(x05), .c(x01), .O(z14));
  aoi21  g94(.a(x05), .b(new_n48_), .c(new_n123_), .O(new_n138_));
  nand4  g95(.a(x19), .b(x05), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(new_n46_), .c(new_n139_), .O(z15));
