...
module FAU ( 
  ...
  nand2  g36(.a(x01), .b(new_n46_), .O(new_n80_));
  ...
  nand4  g48(.a(new_n68_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n92_));
  ...
  nand3  g57(.a(new_n100_), .b(new_n89_), .c(x20), .O(new_n101_));
  ...
  nand4  g61(.a(new_n102_), .b(new_n99_), .c(new_n88_), .d(x15), .O(new_n105_));
  ...
  oai21  g69(.a(new_n112_), .b(new_n49_), .c(new_n80_), .O(z12));
  aoi21  g70(.a(new_n110_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g71(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z14));
  oai21  g73(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n117_));
  oai21  g74(.a(x19), .b(x00), .c(new_n48_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(z15));
  aoi21  g76(.a(new_n48_), .b(new_n47_), .c(x00), .O(z17));
  zero   g77(.O(z16));
endmodule
