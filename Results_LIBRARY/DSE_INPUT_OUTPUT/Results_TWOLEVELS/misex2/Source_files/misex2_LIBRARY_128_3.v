...
module FAU ( 
  ...
  nand2  g000(.a(x13), .b(x04), .O(new_n44_));
  ...
  inv1   g019(.a(new_n44_), .O(new_n63_));
  ...
  nand4  g027(.a(new_n70_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(new_n69_), .c(new_n63_), .O(z03));
  inv1   g029(.a(x00), .O(new_n73_));
  nand4  g030(.a(new_n44_), .b(new_n67_), .c(new_n66_), .d(x10), .O(new_n74_));
  ...
  nand4  g037(.a(new_n44_), .b(x11), .c(x10), .d(new_n46_), .O(new_n81_));
  inv1   g038(.a(new_n81_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x02), .c(x01), .d(x00), .O(new_n83_));
  inv1   g040(.a(new_n83_), .O(z06));
  nand4  g041(.a(new_n44_), .b(new_n67_), .c(x11), .d(x10), .O(new_n85_));
  ...
  inv1   g046(.a(x13), .O(new_n90_));
  inv1   g047(.a(new_n47_), .O(new_n91_));
  ...
  nor2   g052(.a(new_n51_), .b(x18), .O(new_n96_));
  nand4  g053(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(x17), .O(new_n97_));
  aoi21  g054(.a(new_n97_), .b(new_n90_), .c(new_n89_), .O(z08));
  ...
  nand4  g059(.a(x12), .b(new_n66_), .c(x02), .d(new_n54_), .O(new_n103_));
  ...
  nand3  g079(.a(new_n115_), .b(new_n114_), .c(new_n66_), .O(new_n123_));
  and2   g080(.a(x18), .b(x01), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n101_), .d(new_n51_), .O(new_n125_));
  nor2   g082(.a(new_n104_), .b(x14), .O(new_n126_));
  nor2   g083(.a(x21), .b(new_n101_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n126_), .c(new_n105_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n123_), .c(new_n125_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n100_), .c(new_n73_), .O(new_n130_));
  ...
  nand3  g092(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n54_), .c(new_n73_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n132_), .c(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n44_), .O(z12));
  oai21  g098(.a(new_n136_), .b(new_n91_), .c(new_n44_), .O(z13));
  oai21  g099(.a(new_n61_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g100(.a(x10), .b(new_n54_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n45_), .c(new_n54_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n44_), .O(z15));
  nand3  g104(.a(new_n44_), .b(x01), .c(new_n73_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand4  g106(.a(new_n44_), .b(x02), .c(new_n54_), .d(new_n73_), .O(new_n150_));
