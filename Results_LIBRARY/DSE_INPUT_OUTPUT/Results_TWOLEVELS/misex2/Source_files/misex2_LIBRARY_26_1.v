...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(new_n44_), .c(new_n55_), .O(new_n61_));
  ...
  nand2  g34(.a(x01), .b(new_n55_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n102_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n103_));
  ...
  nor3   g74(.a(new_n56_), .b(x19), .c(new_n53_), .O(z13));
