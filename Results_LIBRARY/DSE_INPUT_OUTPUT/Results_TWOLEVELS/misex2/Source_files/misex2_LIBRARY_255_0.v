...
module FAU ( 
  ...
  nand3  g09(.a(x09), .b(new_n48_), .c(new_n46_), .O(new_n53_));
  inv1   g10(.a(new_n53_), .O(new_n54_));
  nor2   g11(.a(x19), .b(x18), .O(new_n55_));
  nand4  g12(.a(new_n55_), .b(new_n54_), .c(new_n44_), .d(x10), .O(new_n56_));
  aoi21  g13(.a(new_n56_), .b(x07), .c(x01), .O(z01));
  inv1   g14(.a(x10), .O(new_n58_));
  nand4  g15(.a(new_n55_), .b(new_n54_), .c(new_n44_), .d(new_n58_), .O(new_n59_));
  aoi21  g16(.a(new_n59_), .b(x07), .c(x01), .O(z02));
  nand3  g17(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
  inv1   g18(.a(x19), .O(new_n62_));
  nand4  g19(.a(new_n62_), .b(x18), .c(new_n44_), .d(x07), .O(new_n63_));
  ...
  nand4  g51(.a(new_n94_), .b(new_n62_), .c(x18), .d(x01), .O(new_n95_));
  oai21  g52(.a(new_n93_), .b(new_n89_), .c(new_n95_), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n75_), .O(z09));
  nor3   g55(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n62_), .c(x18), .d(x01), .O(new_n100_));
  nor3   g57(.a(new_n80_), .b(new_n48_), .c(x01), .O(new_n101_));
  ...
  nand3  g62(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n106_));
  ...
  nor2   g66(.a(new_n45_), .b(new_n47_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(x21), .c(new_n94_), .d(new_n62_), .O(new_n111_));
  nor2   g68(.a(new_n48_), .b(x01), .O(new_n112_));
  nand3  g69(.a(x12), .b(new_n68_), .c(x07), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  inv1   g71(.a(x14), .O(new_n115_));
  nand3  g72(.a(x15), .b(new_n115_), .c(new_n102_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(new_n117_));
  nand3  g74(.a(new_n87_), .b(x20), .c(new_n91_), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n117_), .c(new_n114_), .d(new_n112_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n88_), .c(new_n46_), .O(new_n122_));
  ...
  nand3  g84(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(new_n47_), .c(new_n46_), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand3  g88(.a(new_n131_), .b(new_n124_), .c(x09), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n75_), .O(z12));
  nand4  g90(.a(new_n62_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(x07), .c(x01), .O(z13));
  nand4  g92(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n136_));
  ...
  nand4  g98(.a(x07), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n142_));
