...
module FAU ( 
  ...
  nand4  g31(.a(x11), .b(x10), .c(new_n67_), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n44_), .c(new_n55_), .O(z06));
  ...
  nand4  g52(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n96_));
