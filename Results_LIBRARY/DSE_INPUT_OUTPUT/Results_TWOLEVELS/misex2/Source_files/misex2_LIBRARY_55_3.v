...
module FAU ( 
  ...
  nor2   g031(.a(new_n74_), .b(x15), .O(z04));
  nor4   g032(.a(new_n72_), .b(x15), .c(new_n58_), .d(new_n46_), .O(z05));
  nand2  g033(.a(x15), .b(x12), .O(new_n77_));
  ...
  aoi21  g037(.a(new_n80_), .b(new_n67_), .c(new_n62_), .O(z06));
  ...
  nand4  g054(.a(x12), .b(new_n70_), .c(x02), .d(new_n62_), .O(new_n98_));
  inv1   g055(.a(x16), .O(new_n99_));
  nor2   g056(.a(x14), .b(x13), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n99_), .d(new_n67_), .O(new_n101_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n61_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n44_), .O(z09));
  nor2   g064(.a(new_n50_), .b(x15), .O(new_n108_));
  ...
  nor3   g070(.a(new_n99_), .b(new_n67_), .c(x14), .O(new_n114_));
  ...
  nand4  g076(.a(new_n102_), .b(x21), .c(new_n119_), .d(new_n51_), .O(new_n120_));
  nand4  g077(.a(new_n111_), .b(x12), .c(new_n70_), .d(x02), .O(new_n121_));
  nor2   g078(.a(new_n67_), .b(x14), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n97_), .c(new_n61_), .O(new_n126_));
  ...
  nand4  g098(.a(new_n141_), .b(new_n50_), .c(new_n49_), .d(new_n58_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  aoi22  g100(.a(new_n44_), .b(x00), .c(x19), .d(new_n62_), .O(new_n144_));
  nand3  g101(.a(new_n65_), .b(new_n67_), .c(new_n58_), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  nand3  g103(.a(new_n67_), .b(x01), .c(new_n61_), .O(new_n147_));
