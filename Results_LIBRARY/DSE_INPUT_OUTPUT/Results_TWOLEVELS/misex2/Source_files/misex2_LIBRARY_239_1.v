...
module FAU ( 
  ...
  nor2   g011(.a(new_n54_), .b(x24), .O(z00));
  ...
  nand3  g022(.a(new_n46_), .b(x18), .c(new_n44_), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(new_n65_), .c(new_n60_), .O(new_n67_));
  ...
  nand2  g029(.a(x24), .b(new_n49_), .O(new_n73_));
  ...
  nand4  g037(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n81_));
  nor3   g038(.a(new_n81_), .b(new_n49_), .c(new_n48_), .O(z06));
  nand3  g039(.a(new_n75_), .b(x11), .c(x10), .O(new_n83_));
  ...
  nand2  g043(.a(x02), .b(new_n48_), .O(new_n87_));
  ...
  nor2   g049(.a(new_n46_), .b(x18), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x17), .O(new_n94_));
  aoi21  g051(.a(new_n94_), .b(new_n60_), .c(x01), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n74_), .c(x02), .d(new_n49_), .O(new_n98_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n48_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n73_), .O(z09));
  ...
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n74_), .O(new_n114_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n73_), .O(z10));
  nor2   g078(.a(new_n50_), .b(x01), .O(new_n122_));
  nor2   g079(.a(x13), .b(new_n75_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n74_), .O(new_n124_));
  nand4  g081(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n46_), .O(new_n125_));
  nor2   g082(.a(new_n99_), .b(x14), .O(new_n126_));
  nor2   g083(.a(x21), .b(new_n103_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n126_), .c(new_n100_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n124_), .c(new_n125_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n97_), .c(new_n48_), .O(new_n130_));
  ...
  nand3  g095(.a(new_n138_), .b(new_n60_), .c(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  nand4  g097(.a(new_n46_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n141_));
  aoi21  g098(.a(new_n141_), .b(new_n60_), .c(x01), .O(z13));
  nand4  g099(.a(new_n62_), .b(new_n51_), .c(new_n50_), .d(new_n48_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n60_), .c(x01), .O(z14));
  aoi21  g101(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n145_));
  aoi21  g102(.a(x19), .b(new_n50_), .c(x24), .O(new_n146_));
  oai22  g103(.a(new_n146_), .b(x01), .c(new_n145_), .d(new_n48_), .O(z15));
  nor2   g104(.a(new_n49_), .b(x00), .O(z16));
  aoi21  g105(.a(new_n87_), .b(new_n60_), .c(x01), .O(z17));
endmodule
