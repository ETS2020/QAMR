...
module FAU ( 
  ...
  nor2   g020(.a(x20), .b(x15), .O(new_n64_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n60_), .O(new_n93_));
  ...
  nand4  g055(.a(x12), .b(new_n67_), .c(x02), .d(new_n44_), .O(new_n99_));
  inv1   g056(.a(x16), .O(new_n100_));
  nor2   g057(.a(x14), .b(x13), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(x20), .c(new_n100_), .d(new_n51_), .O(new_n102_));
  nor2   g059(.a(x20), .b(x19), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(x18), .c(x15), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n99_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n98_), .c(new_n97_), .d(new_n60_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(z09));
  nor2   g064(.a(new_n98_), .b(new_n97_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n72_), .c(new_n52_), .d(x01), .O(new_n109_));
  nor2   g066(.a(x13), .b(new_n68_), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n90_), .c(new_n67_), .O(new_n111_));
  nor2   g068(.a(new_n100_), .b(x14), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n98_), .c(new_n97_), .d(x20), .O(new_n113_));
  oai21  g070(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(x15), .c(new_n60_), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(z10));
  nand2  g073(.a(x18), .b(x01), .O(new_n117_));
  nand3  g074(.a(x21), .b(new_n52_), .c(new_n50_), .O(new_n118_));
  nand4  g075(.a(new_n101_), .b(new_n97_), .c(x20), .d(new_n100_), .O(new_n119_));
  oai22  g076(.a(new_n119_), .b(new_n99_), .c(new_n118_), .d(new_n117_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n98_), .c(x15), .d(new_n60_), .O(new_n121_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n44_), .c(new_n60_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n53_), .c(new_n123_), .d(x09), .O(new_n131_));
  inv1   g088(.a(new_n131_), .O(z12));
  nor2   g089(.a(new_n64_), .b(x19), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n134_));
  nor2   g091(.a(new_n134_), .b(x00), .O(z13));
  nor2   g092(.a(new_n54_), .b(x10), .O(new_n136_));
  ...
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n53_), .O(z15));
  nor3   g099(.a(new_n64_), .b(new_n44_), .c(x00), .O(z16));
  nor4   g100(.a(new_n64_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
