...
module FAU ( 
  ...
  nand4  g13(.a(new_n56_), .b(new_n49_), .c(new_n44_), .d(x16), .O(new_n57_));
  ...
  nand4  g28(.a(new_n71_), .b(new_n69_), .c(x10), .d(new_n50_), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(x12), .O(z04));
  nand2  g30(.a(x01), .b(x00), .O(new_n74_));
  inv1   g31(.a(x16), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(new_n53_), .O(new_n76_));
  nand3  g33(.a(x10), .b(x09), .c(x02), .O(new_n77_));
  oai21  g34(.a(new_n77_), .b(new_n74_), .c(new_n76_), .O(z05));
  nand4  g35(.a(x11), .b(x10), .c(new_n50_), .d(x02), .O(new_n79_));
  nor3   g36(.a(new_n79_), .b(new_n53_), .c(new_n52_), .O(z06));
  ...
  nand4  g47(.a(new_n90_), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n94_), .b(new_n49_), .c(x17), .d(x16), .O(new_n95_));
  nor2   g52(.a(new_n95_), .b(new_n64_), .O(z08));
  inv1   g53(.a(x20), .O(new_n97_));
  inv1   g54(.a(x21), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand4  g56(.a(new_n64_), .b(x18), .c(x01), .d(new_n52_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n99_), .c(new_n98_), .d(new_n97_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nor3   g60(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n64_), .c(x18), .d(x01), .O(new_n105_));
  nor2   g62(.a(new_n54_), .b(x01), .O(new_n106_));
  nor2   g63(.a(x13), .b(new_n81_), .O(new_n107_));
  nand2  g64(.a(x16), .b(x15), .O(new_n108_));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n109_));
  nor3   g66(.a(new_n109_), .b(new_n108_), .c(x14), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n69_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n105_), .c(x00), .O(z10));
  nand3  g69(.a(x18), .b(x01), .c(new_n52_), .O(new_n113_));
  nand4  g70(.a(new_n99_), .b(x21), .c(new_n97_), .d(new_n64_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n113_), .c(new_n76_), .O(z11));
  ...
  nand3  g75(.a(new_n64_), .b(x17), .c(new_n54_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n53_), .c(new_n52_), .O(new_n121_));
  ...
  nor4   g81(.a(new_n55_), .b(x19), .c(new_n44_), .d(new_n75_), .O(z13));
  nor3   g82(.a(new_n55_), .b(x10), .c(x09), .O(new_n126_));
  nand4  g83(.a(new_n126_), .b(new_n49_), .c(new_n44_), .d(x16), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z14));
  aoi21  g85(.a(x16), .b(new_n54_), .c(new_n116_), .O(new_n129_));
  nand4  g86(.a(x19), .b(x16), .c(new_n54_), .d(new_n53_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n52_), .c(new_n130_), .O(z15));
  oai21  g88(.a(new_n53_), .b(x00), .c(new_n76_), .O(z16));
  nand4  g89(.a(x16), .b(x02), .c(new_n53_), .d(new_n52_), .O(new_n133_));
