...
module FAU ( 
  ...
  nand2  g007(.a(x23), .b(x16), .O(new_n51_));
  ...
  nand3  g036(.a(new_n66_), .b(new_n70_), .c(x11), .O(new_n80_));
  ...
  nand4  g045(.a(new_n51_), .b(x19), .c(new_n49_), .d(x17), .O(new_n89_));
  nor2   g046(.a(new_n89_), .b(x08), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n86_), .O(new_n91_));
  nor2   g048(.a(new_n91_), .b(new_n85_), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n84_), .c(x02), .d(new_n44_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(x00), .O(z08));
  inv1   g051(.a(x00), .O(new_n95_));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  inv1   g054(.a(new_n51_), .O(new_n98_));
  nor2   g055(.a(new_n98_), .b(x20), .O(new_n99_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n109_));
  ...
  nand2  g070(.a(new_n113_), .b(new_n69_), .O(new_n114_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n96_), .c(x20), .d(new_n105_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n120_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n97_), .c(new_n95_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n51_), .O(z11));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(x01), .c(x00), .O(new_n129_));
  nand4  g086(.a(new_n58_), .b(new_n50_), .c(x17), .d(new_n45_), .O(new_n130_));
  aoi21  g087(.a(new_n130_), .b(new_n129_), .c(new_n98_), .O(new_n131_));
  nand2  g088(.a(new_n50_), .b(new_n45_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(x23), .c(new_n105_), .O(new_n133_));
  nor2   g090(.a(new_n133_), .b(x01), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n95_), .c(new_n131_), .O(new_n135_));
  nor3   g092(.a(new_n135_), .b(x24), .c(new_n46_), .O(z12));
  nand2  g093(.a(new_n130_), .b(new_n51_), .O(z13));
  ...
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n98_), .O(z15));
  oai21  g101(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  oai21  g102(.a(new_n101_), .b(x00), .c(new_n51_), .O(z17));
endmodule
