...
module FAU ( 
  ...
  nand2  g007(.a(x15), .b(new_n50_), .O(new_n51_));
  inv1   g008(.a(new_n51_), .O(new_n52_));
  nor2   g009(.a(new_n52_), .b(x19), .O(new_n53_));
  nand3  g010(.a(new_n53_), .b(new_n49_), .c(new_n48_), .O(new_n54_));
  ...
  nand4  g017(.a(new_n60_), .b(new_n49_), .c(new_n48_), .d(x10), .O(new_n61_));
  oai21  g018(.a(new_n61_), .b(new_n59_), .c(new_n51_), .O(z01));
  ...
  nand3  g022(.a(new_n53_), .b(x18), .c(new_n48_), .O(new_n66_));
  inv1   g023(.a(new_n66_), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n68_));
  ...
  inv1   g030(.a(x15), .O(new_n74_));
  inv1   g031(.a(x11), .O(new_n75_));
  nand4  g032(.a(new_n70_), .b(new_n75_), .c(x10), .d(new_n46_), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n74_), .c(x12), .O(z04));
  nand2  g034(.a(x01), .b(x00), .O(new_n78_));
  nand3  g035(.a(x10), .b(x09), .c(x02), .O(new_n79_));
  oai21  g036(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(z05));
  aoi21  g037(.a(x15), .b(new_n50_), .c(new_n75_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x10), .c(new_n46_), .d(x02), .O(new_n82_));
  nor3   g039(.a(new_n82_), .b(new_n44_), .c(new_n58_), .O(z06));
  nand2  g040(.a(new_n71_), .b(x01), .O(new_n84_));
  nand3  g041(.a(new_n74_), .b(new_n50_), .c(x11), .O(new_n85_));
  oai22  g042(.a(new_n85_), .b(new_n84_), .c(new_n52_), .d(x01), .O(new_n86_));
  ...
  nand4  g050(.a(new_n51_), .b(x19), .c(new_n49_), .d(x17), .O(new_n94_));
  ...
  nand3  g059(.a(new_n102_), .b(x12), .c(new_n75_), .O(new_n103_));
  inv1   g060(.a(x16), .O(new_n104_));
  nor2   g061(.a(x14), .b(x13), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(x20), .c(new_n104_), .d(new_n74_), .O(new_n106_));
  inv1   g063(.a(x20), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n60_), .c(x18), .d(x01), .O(new_n108_));
  oai21  g065(.a(new_n106_), .b(new_n103_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n101_), .c(new_n100_), .d(new_n58_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n51_), .O(z09));
  nand4  g068(.a(new_n51_), .b(x22), .c(x21), .d(new_n107_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n60_), .c(x18), .d(x01), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n50_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n102_), .c(new_n75_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nor3   g074(.a(new_n104_), .b(new_n74_), .c(x14), .O(new_n118_));
  ...
  nor2   g078(.a(new_n52_), .b(new_n100_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n107_), .c(new_n60_), .d(x18), .O(new_n123_));
  nor2   g080(.a(new_n74_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n100_), .c(x20), .d(new_n104_), .O(new_n125_));
  oai22  g082(.a(new_n125_), .b(new_n116_), .c(new_n123_), .d(new_n44_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n101_), .c(new_n58_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n60_), .b(x17), .c(new_n45_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n53_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  nand4  g096(.a(new_n63_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n140_));
  ...
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n52_), .O(z15));
  nor3   g102(.a(new_n52_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g103(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n58_), .O(new_n147_));
