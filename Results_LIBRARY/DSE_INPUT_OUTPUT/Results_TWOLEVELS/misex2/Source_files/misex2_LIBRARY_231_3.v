...
module FAU ( 
  ...
  nand3  g27(.a(x02), .b(new_n48_), .c(x00), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(z07));
  inv1   g29(.a(x08), .O(new_n73_));
  inv1   g30(.a(x05), .O(new_n74_));
  inv1   g31(.a(x06), .O(new_n75_));
  inv1   g32(.a(x03), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n77_));
  inv1   g34(.a(new_n77_), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n75_), .c(new_n74_), .d(x04), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(x07), .O(new_n80_));
  nand4  g37(.a(new_n80_), .b(new_n45_), .c(x17), .d(new_n73_), .O(new_n81_));
  nor2   g38(.a(new_n81_), .b(new_n66_), .O(z08));
  inv1   g39(.a(x21), .O(new_n83_));
  inv1   g40(.a(x22), .O(new_n84_));
  inv1   g41(.a(x11), .O(new_n85_));
  nor2   g42(.a(new_n64_), .b(x01), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(x12), .c(new_n85_), .O(new_n87_));
  ...
  nand4  g49(.a(new_n92_), .b(new_n66_), .c(x18), .d(x01), .O(new_n93_));
  oai21  g50(.a(new_n91_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n47_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(z09));
  nor2   g53(.a(new_n84_), .b(new_n83_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n68_), .c(new_n92_), .d(x01), .O(new_n98_));
  inv1   g55(.a(x13), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(x12), .c(new_n85_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n98_), .c(x00), .O(z10));
  nand3  g63(.a(new_n84_), .b(x21), .c(new_n92_), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n67_), .c(new_n47_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(x01), .O(new_n109_));
  nor4   g66(.a(new_n103_), .b(x16), .c(new_n88_), .d(x14), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n101_), .c(new_n86_), .d(new_n47_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n109_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n66_), .b(x17), .c(new_n64_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(x24), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(x09), .c(new_n48_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x00), .O(z12));
  oai21  g74(.a(new_n114_), .b(new_n49_), .c(new_n63_), .O(z13));
  nand4  g75(.a(new_n52_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(x19), .O(z14));
  nor2   g77(.a(x19), .b(x00), .O(new_n121_));
  nor3   g78(.a(new_n121_), .b(x02), .c(x01), .O(z15));
  nand3  g79(.a(x02), .b(new_n48_), .c(new_n47_), .O(new_n123_));
  inv1   g80(.a(new_n123_), .O(z17));
  nor2   g81(.a(new_n48_), .b(new_n47_), .O(z05));
  nor2   g82(.a(new_n48_), .b(new_n47_), .O(z06));
  buf    g83(.a(x01), .O(z16));
endmodule
