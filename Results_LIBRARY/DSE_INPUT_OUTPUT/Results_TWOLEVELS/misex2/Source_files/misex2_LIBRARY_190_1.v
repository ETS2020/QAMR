...
module FAU ( 
  ...
  nand4  g51(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n95_));
  ...
  aoi21  g72(.a(new_n110_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g73(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g75(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n52_), .c(new_n120_), .O(z15));
  nor2   g78(.a(new_n44_), .b(x00), .O(z16));
  aoi21  g79(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
endmodule
