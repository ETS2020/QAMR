...
module FAU ( 
  ...
  nand2  g000(.a(x21), .b(x08), .O(new_n44_));
  ...
  nand2  g012(.a(new_n44_), .b(new_n51_), .O(new_n56_));
  nor4   g013(.a(new_n56_), .b(x18), .c(x17), .d(new_n55_), .O(new_n57_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n54_), .d(new_n70_), .O(new_n92_));
  ...
  nand4  g081(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n51_), .O(new_n125_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n54_), .c(new_n70_), .O(new_n136_));
  ...
  inv1   g096(.a(new_n56_), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n45_), .d(new_n54_), .O(new_n141_));
  ...
  nand3  g104(.a(new_n44_), .b(x01), .c(new_n70_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n100_), .b(new_n70_), .O(new_n150_));
