...
module FAU ( 
  ...
  nor2   g075(.a(new_n62_), .b(new_n98_), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n105_), .c(new_n50_), .d(x18), .O(new_n120_));
  nor2   g077(.a(new_n102_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n122_));
  oai22  g079(.a(new_n122_), .b(new_n118_), .c(new_n120_), .d(new_n44_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n99_), .c(new_n72_), .O(new_n124_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n44_), .c(new_n72_), .O(new_n131_));
  ...
  nand2  g091(.a(new_n44_), .b(new_n72_), .O(new_n135_));
  ...
  nor3   g099(.a(new_n62_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g100(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n72_), .O(new_n144_));
