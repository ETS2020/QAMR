...
module FAU ( 
  ...
  aoi21  g027(.a(new_n70_), .b(new_n68_), .c(z08), .O(z03));
  ...
  nor2   g032(.a(z08), .b(new_n47_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n60_), .O(z05));
  nand2  g035(.a(z08), .b(x12), .O(new_n79_));
  ...
  nand2  g039(.a(new_n82_), .b(new_n53_), .O(z06));
  ...
  nand3  g047(.a(new_n90_), .b(x12), .c(new_n72_), .O(new_n91_));
  ...
  nand3  g054(.a(new_n97_), .b(new_n96_), .c(new_n50_), .O(new_n98_));
  oai21  g055(.a(new_n95_), .b(new_n91_), .c(new_n98_), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(new_n89_), .c(new_n88_), .d(new_n60_), .O(new_n100_));
  nand2  g057(.a(new_n100_), .b(new_n53_), .O(z09));
  nand3  g058(.a(new_n50_), .b(x18), .c(x01), .O(new_n102_));
  nand3  g059(.a(x22), .b(x21), .c(new_n96_), .O(new_n103_));
  nor2   g060(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g061(.a(x02), .b(new_n44_), .O(new_n105_));
  inv1   g062(.a(x13), .O(new_n106_));
  nand3  g063(.a(new_n106_), .b(x12), .c(new_n72_), .O(new_n107_));
  nor2   g064(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  inv1   g065(.a(x14), .O(new_n109_));
  nand3  g066(.a(x16), .b(x15), .c(new_n109_), .O(new_n110_));
  nand3  g067(.a(new_n89_), .b(new_n88_), .c(x20), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  aoi21  g069(.a(new_n112_), .b(new_n108_), .c(new_n104_), .O(new_n113_));
  oai21  g070(.a(new_n113_), .b(x00), .c(new_n53_), .O(z10));
  nor2   g071(.a(x13), .b(new_n73_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n90_), .c(new_n72_), .O(new_n116_));
  nand4  g073(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n50_), .O(new_n117_));
  nor2   g074(.a(new_n92_), .b(x14), .O(new_n118_));
  nor2   g075(.a(x21), .b(new_n96_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n118_), .c(new_n93_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n116_), .c(new_n117_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n53_), .c(new_n89_), .d(new_n60_), .O(new_n122_));
  ...
  nand4  g088(.a(new_n131_), .b(new_n53_), .c(new_n124_), .d(x09), .O(new_n132_));
  inv1   g089(.a(new_n132_), .O(z12));
  nor2   g090(.a(z08), .b(x19), .O(new_n134_));
  nand4  g091(.a(new_n134_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x00), .O(z13));
  nor2   g093(.a(new_n54_), .b(x10), .O(new_n137_));
  ...
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(z08), .O(z15));
  oai21  g100(.a(new_n44_), .b(x00), .c(new_n53_), .O(z16));
  nor4   g101(.a(z08), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
