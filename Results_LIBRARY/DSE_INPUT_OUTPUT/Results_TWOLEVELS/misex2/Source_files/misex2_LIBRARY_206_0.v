...
module FAU ( 
  ...
  nand4  g016(.a(new_n59_), .b(new_n51_), .c(new_n50_), .d(new_n44_), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(new_n49_), .O(z01));
  nor2   g018(.a(new_n58_), .b(x10), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n51_), .c(new_n50_), .d(new_n44_), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(new_n49_), .O(z02));
  nand2  g021(.a(new_n56_), .b(new_n54_), .O(new_n65_));
  nand3  g022(.a(new_n51_), .b(x18), .c(new_n44_), .O(new_n66_));
  ...
  nand2  g034(.a(new_n49_), .b(new_n55_), .O(new_n78_));
  ...
  oai22  g042(.a(new_n85_), .b(new_n83_), .c(new_n49_), .d(x01), .O(new_n86_));
  ...
  nor2   g055(.a(new_n98_), .b(new_n49_), .O(z08));
  ...
  nor2   g082(.a(new_n49_), .b(x21), .O(new_n126_));
  ...
  nand3  g089(.a(new_n51_), .b(new_n44_), .c(new_n56_), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(x23), .c(new_n55_), .d(new_n54_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n132_), .c(x24), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  nor4   g094(.a(new_n57_), .b(new_n49_), .c(x19), .d(new_n44_), .O(z13));
  nand4  g095(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(x23), .c(x01), .O(z14));
  aoi21  g097(.a(new_n52_), .b(x01), .c(new_n56_), .O(new_n141_));
  aoi21  g098(.a(x19), .b(new_n56_), .c(new_n49_), .O(new_n142_));
  oai22  g099(.a(new_n142_), .b(x01), .c(new_n141_), .d(new_n54_), .O(z15));
  oai21  g100(.a(new_n55_), .b(x00), .c(new_n78_), .O(z16));
  nand2  g101(.a(x02), .b(new_n54_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(x23), .c(x01), .O(z17));
endmodule
