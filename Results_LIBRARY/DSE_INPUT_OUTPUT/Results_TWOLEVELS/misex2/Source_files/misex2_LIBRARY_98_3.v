...
module FAU ( 
  ...
  nand2  g000(.a(x07), .b(x01), .O(new_n44_));
  ...
  nand4  g017(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n61_));
  ...
  nand4  g021(.a(new_n64_), .b(new_n51_), .c(x18), .d(new_n49_), .O(new_n65_));
  ...
  aoi21  g027(.a(new_n70_), .b(new_n59_), .c(new_n67_), .O(z04));
  nand3  g028(.a(x02), .b(x01), .c(x00), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(x10), .c(x09), .d(new_n59_), .O(new_n74_));
  inv1   g031(.a(new_n74_), .O(z05));
  inv1   g032(.a(x00), .O(new_n76_));
  inv1   g033(.a(x11), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n56_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n59_), .c(x02), .d(x01), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(new_n76_), .O(z06));
  nand2  g037(.a(new_n46_), .b(new_n59_), .O(new_n81_));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n76_), .O(new_n91_));
  ...
  nand4  g053(.a(x12), .b(new_n77_), .c(x02), .d(new_n67_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(x18), .c(new_n59_), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n76_), .O(new_n105_));
  ...
  nand2  g067(.a(x02), .b(new_n67_), .O(new_n111_));
  inv1   g068(.a(x13), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n77_), .O(new_n113_));
  ...
  nor2   g077(.a(x13), .b(new_n82_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n88_), .c(new_n77_), .O(new_n122_));
  and2   g079(.a(x18), .b(x01), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n108_), .d(new_n51_), .O(new_n124_));
  nor2   g081(.a(new_n98_), .b(x14), .O(new_n125_));
  nor2   g082(.a(x21), .b(new_n108_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n125_), .c(new_n99_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n122_), .c(new_n124_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n96_), .c(new_n76_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n44_), .O(z11));
  inv1   g087(.a(x24), .O(new_n131_));
  nand2  g088(.a(x10), .b(x02), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(new_n59_), .c(x01), .d(x00), .O(new_n133_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n67_), .c(new_n76_), .O(new_n137_));
  ...
  aoi22  g100(.a(new_n44_), .b(x00), .c(x19), .d(new_n67_), .O(new_n144_));
  nand4  g101(.a(new_n56_), .b(new_n59_), .c(x01), .d(x00), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  aoi21  g103(.a(new_n59_), .b(x00), .c(new_n67_), .O(z16));
