...
module FAU ( 
  ...
  nor3   g31(.a(new_n74_), .b(new_n52_), .c(new_n62_), .O(z06));
  ...
  oai21  g36(.a(new_n52_), .b(x00), .c(new_n79_), .O(z07));
  ...
  aoi21  g42(.a(new_n85_), .b(new_n52_), .c(x00), .O(z08));
  ...
  aoi21  g54(.a(new_n97_), .b(new_n52_), .c(x00), .O(z09));
  nand4  g55(.a(new_n96_), .b(new_n92_), .c(x16), .d(x15), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n52_), .c(x00), .O(z10));
  inv1   g57(.a(x11), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n102_));
  ...
  nand3  g69(.a(new_n112_), .b(new_n52_), .c(new_n62_), .O(new_n113_));
  ...
  nand4  g75(.a(new_n54_), .b(new_n57_), .c(new_n46_), .d(new_n53_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n52_), .c(x00), .O(z14));
  oai21  g77(.a(new_n57_), .b(new_n62_), .c(x01), .O(new_n121_));
  oai21  g78(.a(x19), .b(x00), .c(new_n53_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(z15));
  nor2   g80(.a(new_n52_), .b(x00), .O(z16));
  aoi21  g81(.a(new_n53_), .b(new_n52_), .c(x00), .O(z17));
endmodule
