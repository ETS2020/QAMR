...
module FAU ( 
  ...
  nand3  g05(.a(x02), .b(x01), .c(x00), .O(new_n50_));
  inv1   g06(.a(new_n50_), .O(new_n51_));
  nand3  g07(.a(new_n51_), .b(x10), .c(new_n47_), .O(new_n52_));
  nor3   g08(.a(new_n52_), .b(x12), .c(x11), .O(z04));
  inv1   g09(.a(x10), .O(new_n54_));
  nor3   g10(.a(new_n50_), .b(new_n54_), .c(new_n47_), .O(z05));
  inv1   g11(.a(x00), .O(z16));
  inv1   g12(.a(x01), .O(new_n57_));
  nand4  g13(.a(x11), .b(x10), .c(new_n47_), .d(x02), .O(new_n58_));
  nor3   g14(.a(new_n58_), .b(new_n57_), .c(z16), .O(z06));
  oai21  g15(.a(x02), .b(z16), .c(new_n57_), .O(new_n60_));
  inv1   g16(.a(x12), .O(new_n61_));
  nand4  g17(.a(new_n61_), .b(x11), .c(x10), .d(new_n47_), .O(new_n62_));
  oai21  g18(.a(new_n62_), .b(new_n46_), .c(new_n60_), .O(z07));
  inv1   g19(.a(x20), .O(new_n65_));
  inv1   g20(.a(x21), .O(new_n66_));
  inv1   g21(.a(x22), .O(new_n67_));
  inv1   g22(.a(x19), .O(new_n68_));
  nand4  g23(.a(new_n68_), .b(x18), .c(x01), .d(z16), .O(new_n69_));
  inv1   g24(.a(new_n69_), .O(new_n70_));
  nand4  g25(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  inv1   g26(.a(new_n71_), .O(z09));
  nand4  g27(.a(new_n70_), .b(x22), .c(x21), .d(new_n65_), .O(new_n73_));
  inv1   g28(.a(new_n73_), .O(z10));
  nand4  g29(.a(new_n70_), .b(new_n67_), .c(x21), .d(new_n65_), .O(new_n75_));
  ...
  nand2  g34(.a(new_n54_), .b(x01), .O(new_n81_));
