...
module FAU ( 
  ...
  nand4  g22(.a(new_n65_), .b(new_n62_), .c(x10), .d(new_n49_), .O(new_n66_));
  nor3   g23(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nor2   g24(.a(x19), .b(new_n52_), .O(new_n68_));
  nand3  g25(.a(new_n68_), .b(new_n67_), .c(new_n51_), .O(new_n69_));
  aoi21  g26(.a(new_n69_), .b(new_n66_), .c(new_n44_), .O(z03));
  nand4  g27(.a(new_n45_), .b(new_n64_), .c(new_n63_), .d(x10), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n49_), .c(x02), .d(x01), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n46_), .O(z04));
  nor2   g31(.a(new_n44_), .b(new_n58_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x09), .c(x02), .d(x01), .O(new_n76_));
  nor2   g33(.a(new_n76_), .b(new_n46_), .O(z05));
  nor3   g34(.a(new_n44_), .b(new_n63_), .c(new_n58_), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n49_), .c(x02), .d(x01), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(new_n46_), .O(z06));
  nand3  g37(.a(new_n64_), .b(x11), .c(x10), .O(new_n81_));
  oai21  g38(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nand4  g39(.a(new_n82_), .b(new_n45_), .c(x02), .d(x00), .O(new_n83_));
  inv1   g40(.a(new_n83_), .O(z07));
  inv1   g41(.a(x03), .O(new_n85_));
  nor2   g42(.a(new_n48_), .b(x01), .O(new_n86_));
  inv1   g43(.a(x04), .O(new_n87_));
  nor2   g44(.a(x05), .b(new_n87_), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(new_n46_), .O(new_n89_));
  nor3   g46(.a(x08), .b(x07), .c(x06), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(x19), .c(new_n52_), .d(x17), .O(new_n91_));
  oai21  g48(.a(new_n91_), .b(new_n89_), .c(new_n45_), .O(z08));
  inv1   g49(.a(x21), .O(new_n93_));
  inv1   g50(.a(x22), .O(new_n94_));
  nand4  g51(.a(x12), .b(new_n63_), .c(x02), .d(new_n47_), .O(new_n95_));
  ...
  and2   g57(.a(x18), .b(x01), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n53_), .O(new_n102_));
  oai21  g59(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(x24), .c(new_n94_), .d(new_n93_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(x00), .O(z09));
  nor2   g62(.a(new_n94_), .b(new_n93_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n68_), .c(new_n100_), .d(x01), .O(new_n107_));
  nand3  g64(.a(new_n63_), .b(x02), .c(new_n47_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(x20), .b(x16), .c(x15), .O(new_n110_));
  nand3  g67(.a(x24), .b(new_n94_), .c(new_n93_), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n109_), .c(new_n98_), .d(x12), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n107_), .c(x00), .O(z10));
  nand4  g71(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n53_), .O(new_n115_));
  nor2   g72(.a(x13), .b(new_n64_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n86_), .c(new_n63_), .O(new_n117_));
  nor2   g74(.a(new_n96_), .b(x14), .O(new_n118_));
  nor2   g75(.a(x21), .b(new_n100_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n118_), .c(new_n97_), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n46_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(x24), .c(x22), .O(z11));
  nand2  g80(.a(x10), .b(x02), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(x01), .c(x00), .O(new_n125_));
  oai21  g82(.a(x19), .b(x02), .c(x23), .O(new_n126_));
  nand3  g83(.a(new_n53_), .b(x17), .c(new_n48_), .O(new_n127_));
  ...
  aoi21  g88(.a(new_n131_), .b(x22), .c(x24), .O(z12));
  nor2   g89(.a(new_n44_), .b(x19), .O(new_n133_));
  nand4  g90(.a(new_n133_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x00), .O(z13));
  oai21  g92(.a(new_n59_), .b(new_n50_), .c(new_n45_), .O(z14));
  ...
  nor3   g97(.a(new_n44_), .b(new_n47_), .c(x00), .O(z16));
  nor4   g98(.a(new_n44_), .b(new_n48_), .c(x01), .d(x00), .O(z17));
endmodule
