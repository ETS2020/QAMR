...
module FAU ( 
  ...
  nor2   g036(.a(new_n79_), .b(new_n73_), .O(z05));
  ...
  nand4  g050(.a(new_n52_), .b(x19), .c(new_n49_), .d(x17), .O(new_n94_));
  ...
  nand3  g059(.a(new_n102_), .b(x12), .c(new_n66_), .O(new_n103_));
  ...
  nand3  g069(.a(new_n50_), .b(x18), .c(x01), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(new_n101_), .c(new_n100_), .d(x20), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n67_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n102_), .c(new_n66_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nand3  g074(.a(new_n101_), .b(new_n100_), .c(x20), .O(new_n118_));
  nor4   g075(.a(new_n118_), .b(new_n105_), .c(new_n104_), .d(x14), .O(new_n119_));
  ...
  nand4  g079(.a(new_n122_), .b(new_n100_), .c(x20), .d(new_n105_), .O(new_n123_));
  nand3  g080(.a(x23), .b(x21), .c(new_n108_), .O(new_n124_));
  oai22  g081(.a(new_n124_), .b(new_n113_), .c(new_n123_), .d(new_n116_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n101_), .c(new_n73_), .O(new_n126_));
  ...
  inv1   g093(.a(new_n57_), .O(new_n137_));
  oai21  g094(.a(new_n131_), .b(new_n137_), .c(new_n52_), .O(z13));
  nand3  g095(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n139_));
  ...
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n63_), .O(z15));
  oai21  g101(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand2  g102(.a(new_n102_), .b(new_n73_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n52_), .O(z17));
endmodule
