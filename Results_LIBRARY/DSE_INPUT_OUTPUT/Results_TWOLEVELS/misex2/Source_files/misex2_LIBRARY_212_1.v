...
module FAU ( 
  ...
  aoi21  g31(.a(new_n74_), .b(new_n52_), .c(new_n67_), .O(new_n75_));
  ...
  nand4  g52(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n96_));
  ...
  nor3   g59(.a(new_n102_), .b(x11), .c(new_n45_), .O(new_n103_));
  ...
  aoi21  g64(.a(new_n107_), .b(new_n44_), .c(x00), .O(z10));
  ...
  oai21  g79(.a(new_n121_), .b(new_n52_), .c(new_n122_), .O(z15));
