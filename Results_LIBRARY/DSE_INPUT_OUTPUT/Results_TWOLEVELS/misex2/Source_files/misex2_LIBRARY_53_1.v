...
module FAU ( 
  ...
  nand4  g54(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n98_));
  ...
  aoi21  g70(.a(x10), .b(x02), .c(new_n60_), .O(new_n114_));
  ...
  oai22  g75(.a(new_n118_), .b(new_n46_), .c(new_n60_), .d(x00), .O(z12));
  nand2  g76(.a(new_n47_), .b(x17), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z13));
  nand4  g78(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x19), .O(z14));
  oai21  g80(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n124_));
  oai21  g81(.a(x19), .b(x00), .c(new_n61_), .O(new_n125_));
