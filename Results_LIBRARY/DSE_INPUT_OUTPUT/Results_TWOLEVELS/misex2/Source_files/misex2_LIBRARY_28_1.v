...
module FAU ( 
  ...
  nand4  g37(.a(new_n80_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n81_));
  ...
  nand4  g57(.a(new_n63_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n101_));
  ...
  nand4  g70(.a(x17), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n114_));
