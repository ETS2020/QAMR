...
module FAU ( 
  ...
  nand4  g23(.a(new_n66_), .b(new_n64_), .c(x10), .d(new_n49_), .O(new_n67_));
  nand3  g24(.a(new_n67_), .b(new_n62_), .c(new_n45_), .O(z03));
  inv1   g25(.a(x21), .O(new_n69_));
  nand4  g26(.a(new_n64_), .b(new_n65_), .c(x10), .d(new_n49_), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(new_n69_), .c(x12), .O(z04));
  nand2  g28(.a(x01), .b(x00), .O(new_n72_));
  nand3  g29(.a(x10), .b(x09), .c(x02), .O(new_n73_));
  oai21  g30(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z05));
  nor3   g31(.a(new_n65_), .b(new_n58_), .c(x09), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n45_), .O(z06));
  ...
  nand4  g43(.a(new_n45_), .b(x19), .c(new_n52_), .d(x17), .O(new_n87_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n82_), .c(x02), .d(new_n47_), .O(new_n91_));
  ...
  nor2   g57(.a(new_n52_), .b(new_n47_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n53_), .O(new_n102_));
  oai21  g59(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n93_), .c(new_n69_), .d(new_n46_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n45_), .O(z09));
  nand3  g62(.a(new_n53_), .b(x18), .c(x01), .O(new_n106_));
  nor4   g63(.a(new_n106_), .b(new_n93_), .c(new_n69_), .d(x20), .O(new_n107_));
  nor2   g64(.a(x13), .b(new_n44_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n94_), .c(new_n65_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n93_), .b(new_n69_), .c(x20), .O(new_n111_));
  ...
  nand4  g73(.a(new_n116_), .b(new_n69_), .c(x20), .d(new_n97_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n109_), .c(new_n115_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n93_), .c(new_n46_), .O(new_n119_));
  ...
  nor2   g87(.a(new_n130_), .b(x19), .O(new_n131_));
  nand4  g88(.a(new_n131_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x00), .O(z13));
  oai21  g90(.a(new_n59_), .b(new_n50_), .c(new_n45_), .O(z14));
  oai21  g91(.a(x10), .b(new_n47_), .c(x02), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(x00), .O(new_n136_));
  nand3  g93(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n137_));
  aoi21  g94(.a(new_n137_), .b(new_n136_), .c(new_n130_), .O(z15));
  oai21  g95(.a(new_n47_), .b(x00), .c(new_n45_), .O(z16));
  nand4  g96(.a(new_n45_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n140_));
