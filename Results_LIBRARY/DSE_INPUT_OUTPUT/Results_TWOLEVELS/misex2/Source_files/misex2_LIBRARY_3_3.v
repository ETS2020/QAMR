...
module FAU ( 
  ...
  nand2  g007(.a(x24), .b(x15), .O(new_n51_));
  ...
  nand3  g026(.a(new_n69_), .b(new_n63_), .c(new_n51_), .O(z03));
  nand4  g027(.a(new_n51_), .b(new_n67_), .c(new_n66_), .d(x10), .O(new_n71_));
  inv1   g028(.a(new_n71_), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n46_), .c(x02), .d(x01), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(new_n56_), .O(z04));
  ...
  nor3   g034(.a(new_n66_), .b(new_n47_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x02), .c(x01), .d(x00), .O(new_n79_));
  nand2  g036(.a(new_n79_), .b(new_n51_), .O(z06));
  ...
  nand2  g042(.a(new_n85_), .b(new_n56_), .O(new_n86_));
  ...
  aoi21  g053(.a(x24), .b(x15), .c(x20), .O(new_n97_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n56_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  inv1   g063(.a(x20), .O(new_n107_));
  nand4  g064(.a(new_n51_), .b(x22), .c(x21), .d(new_n107_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n50_), .c(x18), .d(x01), .O(new_n110_));
  nand3  g067(.a(new_n66_), .b(x02), .c(new_n44_), .O(new_n111_));
  nand2  g068(.a(new_n102_), .b(x12), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nor2   g070(.a(new_n107_), .b(new_n101_), .O(new_n114_));
  nor3   g071(.a(x24), .b(x22), .c(x21), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(x15), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n110_), .c(x00), .O(z10));
  and2   g074(.a(x18), .b(x01), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n107_), .d(new_n50_), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n67_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n85_), .c(new_n66_), .O(new_n121_));
  nor2   g078(.a(new_n100_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n107_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n101_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n119_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n56_), .O(new_n126_));
  ...
  nor2   g096(.a(new_n52_), .b(x10), .O(new_n140_));
