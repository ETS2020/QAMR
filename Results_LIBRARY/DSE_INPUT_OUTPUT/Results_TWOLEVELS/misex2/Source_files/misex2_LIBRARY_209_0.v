...
module FAU ( 
  ...
  nand4  g13(.a(x11), .b(x10), .c(new_n48_), .d(x02), .O(new_n58_));
  nor3   g14(.a(new_n58_), .b(new_n57_), .c(z16), .O(z06));
  nand3  g15(.a(new_n47_), .b(x11), .c(x10), .O(new_n60_));
  oai21  g16(.a(new_n60_), .b(x09), .c(x01), .O(new_n61_));
  ...
  oai21  g35(.a(x01), .b(x00), .c(new_n80_), .O(z12));
  nand2  g36(.a(new_n54_), .b(x01), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x02), .c(z16), .O(z15));
  zero   g38(.O(z02));
  zero   g39(.O(z08));
