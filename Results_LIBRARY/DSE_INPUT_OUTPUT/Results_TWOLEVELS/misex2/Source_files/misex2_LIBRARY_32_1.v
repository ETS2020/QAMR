...
module FAU ( 
  ...
  nand3  g54(.a(new_n97_), .b(new_n94_), .c(new_n90_), .O(new_n98_));
  aoi21  g55(.a(new_n98_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g56(.a(x15), .O(new_n100_));
  nor2   g57(.a(x16), .b(new_n100_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n94_), .c(new_n90_), .O(new_n102_));
  ...
  nand3  g64(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n44_), .c(new_n60_), .O(new_n110_));
  ...
  nand2  g70(.a(new_n52_), .b(x17), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(x19), .O(z13));
  nand2  g72(.a(new_n52_), .b(new_n46_), .O(new_n116_));
  ...
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n60_), .O(new_n124_));
