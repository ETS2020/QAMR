...
module FAU ( 
  ...
  nor2   g47(.a(new_n45_), .b(new_n57_), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n64_), .O(new_n94_));
  oai21  g49(.a(new_n91_), .b(new_n87_), .c(new_n94_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n84_), .c(new_n83_), .d(new_n56_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z09));
  nand2  g52(.a(new_n64_), .b(x18), .O(new_n98_));
  nand3  g53(.a(x22), .b(x21), .c(new_n92_), .O(new_n99_));
  oai21  g54(.a(new_n99_), .b(new_n98_), .c(new_n56_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x01), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n85_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n86_), .c(new_n56_), .O(new_n105_));
  nor3   g60(.a(new_n89_), .b(new_n88_), .c(x14), .O(new_n106_));
  nor2   g61(.a(x22), .b(x21), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(x20), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n105_), .c(new_n101_), .O(z10));
  nand4  g64(.a(new_n93_), .b(x21), .c(new_n92_), .d(new_n64_), .O(new_n110_));
  nand2  g65(.a(new_n104_), .b(new_n86_), .O(new_n111_));
  nor2   g66(.a(new_n88_), .b(x14), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n83_), .c(x20), .d(new_n89_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n84_), .c(new_n56_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(z11));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n64_), .b(x17), .c(new_n60_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(x09), .c(new_n57_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x00), .O(z12));
  nand2  g76(.a(new_n47_), .b(x17), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(x19), .O(z13));
  nand3  g78(.a(new_n61_), .b(new_n46_), .c(new_n60_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n65_), .c(new_n59_), .O(z14));
  nor2   g80(.a(x19), .b(x00), .O(new_n126_));
  nor3   g81(.a(new_n126_), .b(x02), .c(x01), .O(z15));
  nand2  g82(.a(new_n61_), .b(x02), .O(new_n128_));
