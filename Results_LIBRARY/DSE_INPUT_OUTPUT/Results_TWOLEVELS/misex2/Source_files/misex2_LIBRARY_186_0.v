...
module FAU ( 
  ...
  nor2   g020(.a(x24), .b(x16), .O(new_n64_));
  ...
  nor3   g035(.a(new_n64_), .b(new_n72_), .c(new_n47_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n46_), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n60_), .O(z06));
  nand4  g038(.a(new_n53_), .b(new_n73_), .c(x11), .d(x10), .O(new_n82_));
  ...
  nand2  g043(.a(new_n86_), .b(new_n60_), .O(new_n87_));
  ...
  nand2  g060(.a(x24), .b(x20), .O(new_n104_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n60_), .O(new_n108_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n60_), .O(new_n127_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(new_n60_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(new_n52_), .c(x16), .d(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  nand2  g094(.a(new_n44_), .b(new_n60_), .O(new_n138_));
  ...
  nor4   g104(.a(new_n64_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
