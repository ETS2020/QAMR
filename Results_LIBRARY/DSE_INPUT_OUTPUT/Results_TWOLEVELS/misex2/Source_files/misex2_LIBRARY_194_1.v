...
module FAU ( 
  ...
  nand2  g27(.a(new_n46_), .b(x02), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n70_), .c(new_n69_), .d(x10), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n56_), .O(z04));
  nand3  g31(.a(x10), .b(x09), .c(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x00), .c(new_n56_), .O(z05));
  aoi21  g33(.a(x12), .b(new_n62_), .c(new_n69_), .O(new_n77_));
  ...
  oai21  g37(.a(new_n80_), .b(new_n71_), .c(x00), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g39(.a(x02), .b(new_n56_), .c(x00), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n82_), .O(z07));
  nor2   g41(.a(x03), .b(new_n57_), .O(new_n85_));
  nor2   g42(.a(x06), .b(x05), .O(new_n86_));
  nand3  g43(.a(x19), .b(new_n45_), .c(x17), .O(new_n87_));
  nor3   g44(.a(new_n87_), .b(x08), .c(x07), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n86_), .c(new_n85_), .d(x04), .O(new_n89_));
  aoi21  g46(.a(new_n89_), .b(new_n56_), .c(x00), .O(z08));
  inv1   g47(.a(x16), .O(new_n91_));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x13), .O(new_n93_));
  inv1   g50(.a(x14), .O(new_n94_));
  nand4  g51(.a(new_n69_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n95_));
  ...
  nand3  g61(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n57_), .O(new_n106_));
  ...
  nand4  g78(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n56_), .c(x00), .O(z14));
  oai21  g80(.a(new_n58_), .b(new_n62_), .c(x01), .O(new_n124_));
  oai21  g81(.a(x19), .b(x00), .c(new_n57_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n124_), .O(z15));
  aoi21  g83(.a(new_n57_), .b(new_n56_), .c(x00), .O(z17));
  zero   g84(.O(z16));
endmodule
