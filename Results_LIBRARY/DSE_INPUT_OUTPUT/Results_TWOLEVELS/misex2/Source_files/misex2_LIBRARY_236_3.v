...
module FAU ( 
  ...
  aoi21  g031(.a(new_n74_), .b(new_n68_), .c(new_n64_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n68_), .c(new_n64_), .O(z05));
  inv1   g034(.a(x11), .O(new_n78_));
  nor3   g035(.a(new_n78_), .b(new_n58_), .c(x09), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n68_), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n63_), .O(z06));
  ...
  nand4  g056(.a(x12), .b(new_n78_), .c(x02), .d(new_n64_), .O(new_n100_));
  ...
  nor2   g066(.a(new_n45_), .b(x07), .O(new_n110_));
  ...
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n78_), .O(new_n114_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n113_), .c(x12), .d(new_n78_), .O(new_n121_));
  nor2   g078(.a(new_n98_), .b(x20), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n110_), .c(new_n66_), .d(x01), .O(new_n123_));
  nor2   g080(.a(new_n101_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n98_), .c(x20), .d(new_n102_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n121_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n99_), .c(new_n63_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(z11));
  inv1   g085(.a(x24), .O(new_n129_));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n68_), .c(x01), .d(x00), .O(new_n131_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n64_), .c(new_n63_), .O(new_n135_));
  ...
  oai21  g101(.a(x10), .b(new_n64_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n53_), .O(z15));
  aoi21  g105(.a(new_n68_), .b(x00), .c(new_n64_), .O(z16));
