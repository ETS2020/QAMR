...
module FAU ( 
  ...
  nor3   g33(.a(new_n76_), .b(new_n52_), .c(new_n62_), .O(z06));
  ...
  oai21  g38(.a(new_n52_), .b(x00), .c(new_n81_), .O(z07));
  ...
  nand4  g55(.a(new_n70_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n99_));
  ...
  nand3  g67(.a(new_n63_), .b(x17), .c(new_n53_), .O(new_n111_));
  ...
  aoi21  g77(.a(new_n57_), .b(x01), .c(new_n53_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n53_), .c(new_n52_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n62_), .c(new_n122_), .O(z15));
  nor2   g80(.a(new_n52_), .b(x00), .O(z16));
  nand3  g81(.a(x02), .b(new_n52_), .c(new_n62_), .O(new_n125_));
