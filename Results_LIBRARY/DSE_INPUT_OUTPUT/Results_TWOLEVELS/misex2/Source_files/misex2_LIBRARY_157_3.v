...
module FAU ( 
  ...
  nand4  g021(.a(new_n47_), .b(x02), .c(x01), .d(x00), .O(new_n65_));
  inv1   g022(.a(x15), .O(new_n66_));
  ...
  nor4   g031(.a(new_n71_), .b(x15), .c(new_n57_), .d(new_n47_), .O(z05));
  nand2  g032(.a(x15), .b(x12), .O(new_n76_));
  ...
  aoi21  g036(.a(new_n79_), .b(new_n66_), .c(new_n61_), .O(z06));
  ...
  nand2  g040(.a(x15), .b(x01), .O(new_n84_));
  ...
  nand4  g054(.a(x12), .b(new_n69_), .c(x02), .d(new_n61_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n66_), .O(new_n106_));
  nor2   g063(.a(new_n106_), .b(x00), .O(z09));
  nand3  g064(.a(new_n63_), .b(x18), .c(x01), .O(new_n108_));
  ...
  nand3  g068(.a(new_n100_), .b(new_n99_), .c(x12), .O(new_n112_));
  ...
  nand4  g077(.a(new_n120_), .b(new_n119_), .c(new_n63_), .d(x01), .O(new_n121_));
  nand3  g078(.a(new_n99_), .b(x12), .c(new_n69_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nor2   g080(.a(new_n66_), .b(x14), .O(new_n124_));
  nand3  g081(.a(new_n96_), .b(x20), .c(new_n101_), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n86_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n121_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n97_), .c(new_n60_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n143_), .c(new_n84_), .O(z14));
  oai21  g102(.a(x10), .b(new_n61_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n46_), .c(new_n61_), .O(new_n148_));
  nand3  g105(.a(new_n148_), .b(new_n147_), .c(new_n84_), .O(z15));
  aoi21  g106(.a(new_n66_), .b(x00), .c(new_n61_), .O(z16));
  nand2  g107(.a(new_n87_), .b(new_n84_), .O(z17));
endmodule
