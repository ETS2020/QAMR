...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n116_, new_n118_, new_n121_, new_n123_;
  ...
  nand3  g53(.a(new_n98_), .b(x12), .c(new_n81_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n82_), .c(new_n44_), .O(new_n101_));
  nor3   g56(.a(new_n85_), .b(new_n84_), .c(x14), .O(new_n102_));
  nor2   g57(.a(x22), .b(x21), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(x20), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n101_), .c(new_n97_), .O(z10));
  nand4  g60(.a(new_n89_), .b(x21), .c(new_n88_), .d(new_n53_), .O(new_n106_));
  nand2  g61(.a(new_n100_), .b(new_n82_), .O(new_n107_));
  nor2   g62(.a(new_n84_), .b(x14), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n79_), .c(x20), .d(new_n85_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n107_), .c(new_n106_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n80_), .c(new_n44_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(z11));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g68(.a(new_n53_), .b(x17), .c(new_n56_), .O(new_n114_));
  aoi21  g69(.a(new_n114_), .b(new_n113_), .c(x24), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(x09), .c(new_n45_), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(x00), .O(z12));
  inv1   g72(.a(new_n48_), .O(new_n118_));
  oai21  g73(.a(new_n114_), .b(new_n118_), .c(new_n47_), .O(z13));
  oai21  g74(.a(new_n60_), .b(new_n50_), .c(new_n47_), .O(z14));
