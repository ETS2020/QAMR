...
module FAU ( 
  ...
  nand2  g005(.a(x15), .b(x01), .O(new_n49_));
  inv1   g006(.a(x02), .O(new_n50_));
  nor2   g007(.a(x01), .b(x00), .O(new_n51_));
  nand3  g008(.a(new_n51_), .b(x09), .c(new_n50_), .O(new_n52_));
  nor2   g009(.a(x19), .b(x18), .O(new_n53_));
  nand3  g010(.a(new_n53_), .b(new_n45_), .c(x10), .O(new_n54_));
  oai21  g011(.a(new_n54_), .b(new_n52_), .c(new_n49_), .O(z01));
  inv1   g012(.a(x10), .O(new_n56_));
  nand4  g013(.a(new_n46_), .b(new_n45_), .c(new_n56_), .d(x09), .O(new_n57_));
  nor3   g014(.a(new_n57_), .b(x19), .c(x18), .O(z02));
  inv1   g015(.a(x15), .O(new_n59_));
  nand3  g016(.a(new_n44_), .b(x02), .c(x00), .O(new_n60_));
  nand4  g017(.a(new_n59_), .b(x12), .c(x11), .d(x10), .O(new_n61_));
  ...
  nor4   g030(.a(new_n70_), .b(x15), .c(new_n56_), .d(new_n44_), .O(z05));
  nand4  g031(.a(new_n59_), .b(x11), .c(x10), .d(new_n44_), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  inv1   g034(.a(new_n77_), .O(z06));
  nand2  g035(.a(x10), .b(new_n44_), .O(new_n79_));
  nand3  g036(.a(new_n59_), .b(new_n69_), .c(x11), .O(new_n80_));
  oai21  g037(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  nand3  g038(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  nand2  g039(.a(new_n82_), .b(new_n49_), .O(z07));
  inv1   g040(.a(x00), .O(new_n84_));
  nor2   g041(.a(new_n50_), .b(x01), .O(new_n85_));
  ...
  nand2  g050(.a(new_n93_), .b(new_n49_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  inv1   g053(.a(x01), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n68_), .c(x02), .d(new_n97_), .O(new_n98_));
  inv1   g055(.a(x16), .O(new_n99_));
  nor2   g056(.a(x14), .b(x13), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n99_), .d(new_n59_), .O(new_n101_));
  inv1   g058(.a(x20), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n64_), .c(x18), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n98_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n84_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n49_), .O(z09));
  ...
  nand2  g066(.a(new_n68_), .b(x02), .O(new_n110_));
  ...
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n49_), .O(z10));
  inv1   g074(.a(x18), .O(new_n118_));
  nor2   g075(.a(new_n118_), .b(x15), .O(new_n119_));
  nor2   g076(.a(new_n95_), .b(x20), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n119_), .c(new_n64_), .d(x01), .O(new_n121_));
  inv1   g078(.a(x13), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(x12), .c(new_n68_), .O(new_n123_));
  inv1   g080(.a(new_n123_), .O(new_n124_));
  nor2   g081(.a(new_n59_), .b(x14), .O(new_n125_));
  nand3  g082(.a(new_n95_), .b(x20), .c(new_n99_), .O(new_n126_));
  inv1   g083(.a(new_n126_), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n125_), .c(new_n124_), .d(new_n85_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n121_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n96_), .c(new_n84_), .O(new_n130_));
  ...
  nand3  g092(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n97_), .c(new_n84_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n132_), .c(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n49_), .O(z12));
  nand2  g098(.a(new_n46_), .b(x17), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z13));
  nor2   g100(.a(x09), .b(x02), .O(new_n144_));
  nor2   g101(.a(x17), .b(x10), .O(new_n145_));
  nand4  g102(.a(new_n145_), .b(new_n144_), .c(new_n53_), .d(new_n51_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n49_), .O(z14));
  aoi22  g104(.a(new_n49_), .b(x00), .c(x19), .d(new_n97_), .O(new_n148_));
  nand4  g105(.a(new_n59_), .b(new_n56_), .c(x01), .d(x00), .O(new_n149_));
  oai21  g106(.a(new_n148_), .b(x02), .c(new_n149_), .O(z15));
  aoi21  g107(.a(new_n59_), .b(x00), .c(new_n97_), .O(z16));
  nand2  g108(.a(new_n86_), .b(new_n49_), .O(z17));
endmodule
