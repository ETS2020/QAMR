...
module FAU ( 
  ...
  nand3  g16(.a(new_n45_), .b(new_n44_), .c(new_n52_), .O(new_n60_));
  ...
  nor3   g28(.a(new_n71_), .b(new_n44_), .c(new_n52_), .O(z06));
  ...
  nor2   g44(.a(x11), .b(new_n45_), .O(new_n88_));
  ...
  nand4  g52(.a(new_n95_), .b(new_n92_), .c(new_n91_), .d(new_n88_), .O(new_n96_));
  aoi21  g53(.a(new_n96_), .b(new_n44_), .c(x00), .O(z09));
  and2   g54(.a(x16), .b(x15), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n95_), .c(new_n91_), .d(new_n88_), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g57(.a(x15), .O(new_n101_));
  nor2   g58(.a(x16), .b(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n95_), .c(new_n91_), .d(new_n88_), .O(new_n103_));
