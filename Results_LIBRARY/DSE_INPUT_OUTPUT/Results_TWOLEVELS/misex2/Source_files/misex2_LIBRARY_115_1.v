...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n125_, new_n126_, new_n128_, new_n129_, new_n132_;
  ...
  nand4  g20(.a(new_n63_), .b(x18), .c(new_n48_), .d(new_n44_), .O(new_n64_));
  ...
  nor3   g31(.a(new_n74_), .b(new_n61_), .c(new_n45_), .O(z06));
  ...
  nand2  g36(.a(x15), .b(new_n61_), .O(new_n80_));
  ...
  nand4  g44(.a(new_n87_), .b(x02), .c(new_n61_), .d(new_n45_), .O(new_n88_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n82_), .c(x17), .d(new_n44_), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(new_n63_), .O(z08));
  inv1   g50(.a(x21), .O(new_n94_));
  inv1   g51(.a(x22), .O(new_n95_));
  nand4  g52(.a(x12), .b(new_n68_), .c(x02), .d(new_n61_), .O(new_n96_));
  inv1   g53(.a(x16), .O(new_n97_));
  nor2   g54(.a(x14), .b(x13), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(x20), .c(new_n97_), .d(new_n44_), .O(new_n99_));
  nand2  g56(.a(x18), .b(x01), .O(new_n100_));
  inv1   g57(.a(x20), .O(new_n101_));
  nand2  g58(.a(new_n101_), .b(new_n63_), .O(new_n102_));
  oai22  g59(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n96_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n95_), .c(new_n94_), .d(new_n45_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z09));
  nand3  g62(.a(x18), .b(x01), .c(new_n45_), .O(new_n106_));
  nand4  g63(.a(x22), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n106_), .c(new_n80_), .O(z10));
  nand4  g65(.a(new_n63_), .b(x18), .c(x01), .d(new_n45_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n95_), .c(x21), .d(new_n101_), .O(new_n111_));
  ...
  nand3  g72(.a(new_n63_), .b(x17), .c(new_n46_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n61_), .c(new_n45_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n114_), .c(x24), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(x09), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n80_), .O(z12));
  nand4  g78(.a(new_n63_), .b(x17), .c(new_n46_), .d(new_n45_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g80(.a(new_n47_), .b(new_n46_), .c(new_n61_), .d(new_n45_), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x10), .O(new_n125_));
  nand4  g82(.a(new_n125_), .b(new_n82_), .c(new_n48_), .d(new_n44_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z14));
  aoi21  g84(.a(new_n58_), .b(x01), .c(new_n46_), .O(new_n128_));
  aoi21  g85(.a(x19), .b(new_n46_), .c(x15), .O(new_n129_));
  oai22  g86(.a(new_n129_), .b(x01), .c(new_n128_), .d(new_n45_), .O(z15));
  oai21  g87(.a(new_n61_), .b(x00), .c(new_n80_), .O(z16));
  nand2  g88(.a(x02), .b(new_n45_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n44_), .c(x01), .O(z17));
endmodule
