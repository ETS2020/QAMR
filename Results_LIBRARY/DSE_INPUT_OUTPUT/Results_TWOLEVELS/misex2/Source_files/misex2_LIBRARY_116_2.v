...
module FAU ( 
  ...
  inv1   g021(.a(x13), .O(new_n65_));
  nor2   g022(.a(x23), .b(new_n65_), .O(new_n66_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n57_), .c(x18), .d(new_n51_), .O(new_n72_));
  ...
  nand4  g037(.a(new_n45_), .b(x11), .c(x10), .d(new_n49_), .O(new_n81_));
  ...
  nand4  g050(.a(new_n45_), .b(x19), .c(new_n56_), .d(x17), .O(new_n94_));
  ...
  nand4  g054(.a(new_n97_), .b(new_n89_), .c(x02), .d(new_n47_), .O(new_n98_));
  nor2   g055(.a(new_n98_), .b(x00), .O(z08));
  inv1   g056(.a(x21), .O(new_n100_));
  inv1   g057(.a(x22), .O(new_n101_));
  nor2   g058(.a(new_n66_), .b(x20), .O(new_n102_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n104_), .c(x12), .d(new_n74_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n103_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n101_), .c(new_n100_), .d(new_n46_), .O(new_n111_));
  ...
  nand3  g071(.a(new_n65_), .b(x12), .c(new_n74_), .O(new_n115_));
  nor3   g072(.a(new_n115_), .b(new_n48_), .c(x01), .O(new_n116_));
  nand3  g073(.a(new_n101_), .b(new_n100_), .c(x20), .O(new_n117_));
  nor4   g074(.a(new_n117_), .b(new_n106_), .c(new_n105_), .d(x14), .O(new_n118_));
  ...
  nor3   g078(.a(new_n66_), .b(new_n100_), .c(x20), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n57_), .c(x18), .O(new_n123_));
  nor2   g080(.a(new_n105_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n100_), .c(x20), .d(new_n106_), .O(new_n125_));
  oai22  g082(.a(new_n125_), .b(new_n121_), .c(new_n123_), .d(new_n47_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n101_), .c(new_n46_), .O(new_n127_));
  ...
  nand2  g094(.a(new_n47_), .b(new_n46_), .O(new_n138_));
  ...
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n66_), .O(z15));
  oai21  g102(.a(new_n47_), .b(x00), .c(new_n45_), .O(z16));
  nand4  g103(.a(new_n45_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n147_));
