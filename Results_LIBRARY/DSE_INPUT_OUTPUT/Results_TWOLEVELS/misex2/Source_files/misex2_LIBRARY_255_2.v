...
module FAU ( 
  ...
  nand4  g022(.a(x07), .b(x02), .c(x01), .d(x00), .O(new_n66_));
  ...
  nand4  g026(.a(x07), .b(x02), .c(x01), .d(x00), .O(new_n70_));
  ...
  aoi21  g031(.a(new_n74_), .b(x07), .c(new_n63_), .O(z05));
  nor3   g032(.a(new_n69_), .b(new_n59_), .c(x09), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x07), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n62_), .O(z06));
  ...
  nand2  g041(.a(x02), .b(new_n62_), .O(new_n85_));
  ...
  aoi21  g048(.a(new_n91_), .b(new_n63_), .c(x07), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  nand4  g051(.a(x12), .b(new_n69_), .c(x02), .d(new_n63_), .O(new_n95_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n62_), .O(new_n103_));
  nand2  g060(.a(new_n103_), .b(new_n54_), .O(z09));
  ...
  nor2   g065(.a(x13), .b(new_n80_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n69_), .O(new_n110_));
  ...
  nand3  g073(.a(new_n109_), .b(new_n108_), .c(new_n69_), .O(new_n117_));
  inv1   g074(.a(x20), .O(new_n118_));
  nand4  g075(.a(new_n106_), .b(x21), .c(new_n118_), .d(new_n56_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n62_), .O(new_n124_));
  ...
  oai21  g093(.a(new_n130_), .b(new_n136_), .c(new_n54_), .O(z13));
  nand4  g094(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  oai21  g096(.a(x10), .b(new_n63_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n46_), .c(new_n63_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n54_), .O(z15));
  nand3  g100(.a(x07), .b(x01), .c(new_n62_), .O(new_n144_));
