...
module FAU ( 
  ...
  nand2  g00(.a(x18), .b(x07), .O(new_n44_));
  ...
  nor4   g16(.a(new_n59_), .b(x19), .c(x17), .d(x02), .O(new_n60_));
  oai21  g17(.a(new_n60_), .b(x07), .c(x18), .O(new_n61_));
  nand3  g18(.a(x02), .b(x01), .c(x00), .O(new_n62_));
  nor2   g19(.a(new_n56_), .b(x09), .O(new_n63_));
  ...
  nand3  g24(.a(new_n63_), .b(new_n67_), .c(new_n66_), .O(new_n68_));
  oai21  g25(.a(new_n68_), .b(new_n62_), .c(new_n44_), .O(z04));
  nand2  g26(.a(x01), .b(x00), .O(new_n70_));
  nand3  g27(.a(x10), .b(x09), .c(x02), .O(new_n71_));
  oai21  g28(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(z05));
  nand3  g29(.a(x18), .b(new_n67_), .c(x07), .O(new_n73_));
  ...
  nand2  g33(.a(new_n76_), .b(new_n44_), .O(z06));
  nand3  g34(.a(new_n67_), .b(x11), .c(x10), .O(new_n78_));
  oai21  g35(.a(new_n78_), .b(x09), .c(x01), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(new_n44_), .c(x02), .d(x00), .O(new_n80_));
  ...
  nand3  g43(.a(new_n86_), .b(new_n83_), .c(x04), .O(new_n87_));
  nor3   g44(.a(new_n87_), .b(x07), .c(x06), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n50_), .c(x17), .d(new_n82_), .O(new_n89_));
  ...
  nand4  g52(.a(new_n44_), .b(x20), .c(new_n95_), .d(new_n94_), .O(new_n96_));
  nor3   g53(.a(new_n96_), .b(x14), .c(x13), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(x12), .c(new_n66_), .d(x02), .O(new_n98_));
  inv1   g55(.a(x07), .O(new_n99_));
  nor2   g56(.a(x20), .b(x19), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(x18), .c(new_n99_), .d(x01), .O(new_n101_));
  oai21  g58(.a(new_n98_), .b(x01), .c(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand3  g61(.a(new_n51_), .b(x18), .c(x01), .O(new_n105_));
  nor4   g62(.a(new_n105_), .b(new_n93_), .c(new_n92_), .d(x20), .O(new_n106_));
  inv1   g63(.a(x01), .O(new_n107_));
  nand2  g64(.a(x02), .b(new_n107_), .O(new_n108_));
  nor4   g65(.a(new_n108_), .b(x13), .c(new_n67_), .d(x11), .O(new_n109_));
  nand3  g66(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n110_));
  nor4   g67(.a(new_n110_), .b(new_n95_), .c(new_n94_), .d(x14), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n109_), .c(new_n106_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(x00), .c(new_n44_), .O(z10));
  aoi21  g70(.a(x18), .b(x07), .c(x21), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(x20), .c(new_n95_), .d(x15), .O(new_n115_));
  nor3   g72(.a(new_n115_), .b(x14), .c(x13), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(x12), .c(new_n66_), .d(x02), .O(new_n117_));
  nor2   g74(.a(new_n50_), .b(x07), .O(new_n118_));
  nor2   g75(.a(new_n92_), .b(x20), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n118_), .c(new_n51_), .d(x01), .O(new_n120_));
  oai21  g77(.a(new_n117_), .b(x01), .c(new_n120_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n93_), .c(new_n91_), .O(new_n122_));
  ...
  nand3  g84(.a(new_n51_), .b(x17), .c(new_n45_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(new_n107_), .c(new_n91_), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand4  g88(.a(new_n131_), .b(new_n44_), .c(new_n124_), .d(x09), .O(new_n132_));
  inv1   g89(.a(new_n132_), .O(z12));
  oai21  g90(.a(new_n128_), .b(new_n59_), .c(new_n44_), .O(z13));
  oai21  g91(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g92(.a(x10), .b(new_n107_), .c(x02), .O(new_n136_));
  nand2  g93(.a(new_n136_), .b(x00), .O(new_n137_));
  nand3  g94(.a(x19), .b(new_n45_), .c(new_n107_), .O(new_n138_));
  nand3  g95(.a(new_n138_), .b(new_n137_), .c(new_n44_), .O(z15));
  nand3  g96(.a(new_n44_), .b(x01), .c(new_n91_), .O(new_n140_));
  inv1   g97(.a(new_n140_), .O(z16));
  nand4  g98(.a(new_n44_), .b(x02), .c(new_n107_), .d(new_n91_), .O(new_n142_));
