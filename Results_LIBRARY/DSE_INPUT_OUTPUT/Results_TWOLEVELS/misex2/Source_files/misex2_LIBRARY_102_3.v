...
module FAU ( 
  ...
  nand2  g24(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  oai21  g25(.a(new_n68_), .b(new_n64_), .c(new_n47_), .O(z03));
  aoi21  g26(.a(new_n56_), .b(new_n45_), .c(new_n44_), .O(z07));
  inv1   g27(.a(x08), .O(new_n73_));
  inv1   g28(.a(x05), .O(new_n74_));
  inv1   g29(.a(x06), .O(new_n75_));
  inv1   g30(.a(x03), .O(new_n76_));
  nand4  g31(.a(new_n76_), .b(x02), .c(new_n45_), .d(new_n44_), .O(new_n77_));
  ...
  nand4  g35(.a(new_n80_), .b(new_n55_), .c(x17), .d(new_n73_), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(new_n65_), .O(z08));
  inv1   g37(.a(x21), .O(new_n83_));
  inv1   g38(.a(x22), .O(new_n84_));
  inv1   g39(.a(x11), .O(new_n85_));
  nor2   g40(.a(new_n56_), .b(x01), .O(new_n86_));
  ...
  nand4  g47(.a(new_n92_), .b(new_n65_), .c(x18), .d(x01), .O(new_n93_));
  oai21  g48(.a(new_n91_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n44_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nor2   g51(.a(new_n84_), .b(new_n83_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n67_), .c(new_n92_), .d(x01), .O(new_n98_));
  inv1   g53(.a(x13), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(x12), .c(new_n85_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nor3   g56(.a(new_n89_), .b(new_n88_), .c(x14), .O(new_n102_));
  nand3  g57(.a(new_n84_), .b(new_n83_), .c(x20), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n98_), .c(x00), .O(z10));
  nand3  g61(.a(new_n84_), .b(x21), .c(new_n92_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n66_), .c(new_n44_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x01), .O(new_n109_));
  nor4   g64(.a(new_n103_), .b(x16), .c(new_n88_), .d(x14), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n101_), .c(new_n86_), .d(new_n44_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n109_), .O(z11));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g68(.a(new_n65_), .b(x17), .c(new_n56_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n52_), .b(new_n51_), .c(new_n61_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n50_), .c(new_n47_), .O(z14));
