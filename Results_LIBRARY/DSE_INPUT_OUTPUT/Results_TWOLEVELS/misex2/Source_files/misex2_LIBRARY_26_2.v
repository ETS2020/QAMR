...
module FAU ( 
  ...
  or2    g13(.a(new_n56_), .b(new_n46_), .O(new_n57_));
  inv1   g14(.a(new_n57_), .O(new_n58_));
  nand4  g15(.a(new_n58_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n59_));
  nor2   g16(.a(new_n59_), .b(x19), .O(z02));
  nand3  g17(.a(new_n45_), .b(new_n55_), .c(new_n44_), .O(new_n61_));
  ...
  nand3  g63(.a(new_n106_), .b(x12), .c(new_n75_), .O(new_n107_));
  ...
  nor3   g81(.a(new_n56_), .b(x19), .c(new_n53_), .O(z13));
