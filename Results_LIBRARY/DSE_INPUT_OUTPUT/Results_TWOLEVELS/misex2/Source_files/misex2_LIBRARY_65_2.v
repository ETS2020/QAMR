...
module FAU ( 
  ...
  nand3  g16(.a(new_n45_), .b(new_n52_), .c(new_n44_), .O(new_n60_));
  inv1   g17(.a(x19), .O(new_n61_));
  nand3  g18(.a(new_n61_), .b(x18), .c(new_n50_), .O(new_n62_));
  nand3  g19(.a(x02), .b(x01), .c(x00), .O(new_n63_));
  nand4  g20(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n64_));
  oai22  g21(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(new_n60_), .O(z03));
  nor2   g22(.a(x12), .b(x11), .O(new_n66_));
  nand4  g23(.a(new_n66_), .b(x10), .c(new_n46_), .d(x02), .O(new_n67_));
  aoi21  g24(.a(new_n67_), .b(x01), .c(new_n44_), .O(z04));
  nand3  g25(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nor3   g26(.a(new_n69_), .b(new_n57_), .c(new_n46_), .O(z05));
  nand4  g27(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n71_));
  nor3   g28(.a(new_n71_), .b(new_n52_), .c(new_n44_), .O(z06));
  inv1   g29(.a(new_n69_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(x11), .c(x10), .d(new_n46_), .O(new_n74_));
  nor2   g31(.a(new_n74_), .b(x12), .O(z07));
  ...
  nand4  g39(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(new_n76_), .O(new_n83_));
  aoi21  g40(.a(new_n83_), .b(new_n44_), .c(x01), .O(z08));
  inv1   g41(.a(x21), .O(new_n85_));
  inv1   g42(.a(x22), .O(new_n86_));
  inv1   g43(.a(x11), .O(new_n87_));
  nand4  g44(.a(x12), .b(new_n87_), .c(x02), .d(new_n52_), .O(new_n88_));
  ...
  nand3  g50(.a(new_n93_), .b(x18), .c(x01), .O(new_n94_));
  oai21  g51(.a(new_n92_), .b(new_n88_), .c(new_n94_), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n86_), .c(new_n85_), .d(new_n44_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nor3   g54(.a(new_n86_), .b(new_n85_), .c(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n61_), .c(x18), .d(x01), .O(new_n99_));
  nor2   g56(.a(new_n45_), .b(x01), .O(new_n100_));
  inv1   g57(.a(x13), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(x12), .c(new_n87_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nor3   g60(.a(new_n90_), .b(new_n89_), .c(x14), .O(new_n104_));
  nor2   g61(.a(x22), .b(x21), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n104_), .c(new_n103_), .d(new_n100_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n99_), .c(x00), .O(z10));
  nand4  g66(.a(new_n91_), .b(x12), .c(new_n87_), .d(x02), .O(new_n110_));
  nand4  g67(.a(new_n105_), .b(x20), .c(new_n90_), .d(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n110_), .c(new_n44_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n52_), .O(new_n113_));
  nor3   g70(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n93_), .c(new_n86_), .d(x21), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n113_), .O(z11));
  inv1   g73(.a(x24), .O(new_n117_));
  aoi21  g74(.a(x10), .b(x02), .c(new_n44_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x01), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  nand2  g79(.a(new_n52_), .b(x00), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n46_), .c(new_n123_), .O(z12));
  aoi21  g81(.a(new_n120_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g82(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n126_));
  ...
  nand2  g86(.a(x10), .b(x02), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(x01), .c(x00), .O(new_n131_));
  nand4  g88(.a(x19), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n131_), .O(z15));
  nand2  g90(.a(x01), .b(new_n44_), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(new_n123_), .O(z16));
  aoi21  g92(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
