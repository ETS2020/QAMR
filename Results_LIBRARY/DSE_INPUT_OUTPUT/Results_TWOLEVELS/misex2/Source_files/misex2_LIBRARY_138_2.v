...
module FAU ( 
  ...
  nand2  g007(.a(new_n50_), .b(x13), .O(new_n51_));
  ...
  nand4  g069(.a(new_n112_), .b(new_n50_), .c(new_n101_), .d(new_n100_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(x00), .O(z09));
  nor2   g071(.a(new_n50_), .b(new_n101_), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n71_), .c(new_n109_), .d(x01), .O(new_n116_));
  inv1   g073(.a(new_n102_), .O(new_n117_));
  nor4   g074(.a(new_n117_), .b(x13), .c(new_n75_), .d(x11), .O(new_n118_));
  ...
  inv1   g079(.a(x00), .O(new_n123_));
  nand4  g080(.a(new_n110_), .b(x21), .c(new_n109_), .d(new_n108_), .O(new_n124_));
  nor2   g081(.a(new_n105_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n101_), .c(x20), .d(new_n106_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n103_), .c(new_n124_), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n50_), .c(new_n100_), .d(new_n123_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n108_), .b(x17), .c(new_n45_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n44_), .c(new_n123_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n51_), .c(new_n130_), .d(x09), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(z12));
  nand4  g096(.a(new_n53_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n140_));
  ...
  nand2  g101(.a(new_n144_), .b(new_n51_), .O(z14));
  ...
  aoi21  g105(.a(new_n148_), .b(new_n147_), .c(new_n52_), .O(z15));
  oai21  g106(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  oai21  g107(.a(new_n117_), .b(x00), .c(new_n51_), .O(z17));
endmodule
