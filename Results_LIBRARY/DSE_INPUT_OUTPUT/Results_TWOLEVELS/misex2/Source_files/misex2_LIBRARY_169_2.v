...
module FAU ( 
  ...
  oai21  g028(.a(new_n71_), .b(new_n64_), .c(new_n52_), .O(z04));
  inv1   g029(.a(x00), .O(new_n73_));
  inv1   g030(.a(x05), .O(new_n74_));
  nor2   g031(.a(x20), .b(new_n74_), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n73_), .O(z05));
  nor2   g035(.a(new_n75_), .b(new_n69_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x10), .c(new_n46_), .d(x02), .O(new_n80_));
  nor3   g037(.a(new_n80_), .b(new_n44_), .c(new_n73_), .O(z06));
  ...
  nand2  g043(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  inv1   g044(.a(x03), .O(new_n88_));
  nand3  g045(.a(new_n74_), .b(x04), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g053(.a(new_n86_), .b(x12), .c(new_n69_), .O(new_n97_));
  ...
  nor2   g063(.a(new_n49_), .b(x05), .O(new_n107_));
  ...
  nand2  g074(.a(new_n112_), .b(new_n86_), .O(new_n118_));
  nor2   g075(.a(new_n95_), .b(x20), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n107_), .c(new_n50_), .d(x01), .O(new_n120_));
  nor2   g077(.a(new_n98_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x20), .d(new_n99_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n118_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n73_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n73_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n44_), .b(new_n73_), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n130_), .c(new_n52_), .O(z13));
  nand4  g094(.a(new_n59_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n52_), .O(z15));
  nor3   g100(.a(new_n75_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g101(.a(new_n87_), .b(new_n52_), .O(z17));
endmodule
