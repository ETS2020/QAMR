...
module FAU ( 
  ...
  nand4  g36(.a(new_n81_), .b(new_n59_), .c(x17), .d(new_n74_), .O(new_n82_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n65_), .c(x18), .d(x01), .O(new_n94_));
  ...
  nor2   g67(.a(new_n112_), .b(new_n101_), .O(new_n113_));
  nor2   g68(.a(x16), .b(new_n89_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n113_), .c(new_n105_), .d(new_n111_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n110_), .O(z11));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n65_), .b(x17), .c(new_n55_), .O(new_n118_));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(x09), .c(new_n45_), .d(new_n44_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n47_), .O(z12));
  inv1   g76(.a(new_n48_), .O(new_n122_));
  oai21  g77(.a(new_n118_), .b(new_n122_), .c(new_n47_), .O(z13));
  nand3  g78(.a(new_n52_), .b(new_n51_), .c(new_n58_), .O(new_n124_));
  oai21  g79(.a(new_n124_), .b(new_n50_), .c(new_n47_), .O(z14));
  nand3  g80(.a(x19), .b(new_n55_), .c(new_n45_), .O(new_n126_));
  oai21  g81(.a(new_n87_), .b(new_n44_), .c(new_n126_), .O(z15));
  nand2  g82(.a(new_n112_), .b(new_n47_), .O(z17));
  zero   g83(.O(z04));
  zero   g84(.O(z06));
  buf    g85(.a(x01), .O(z16));
endmodule
