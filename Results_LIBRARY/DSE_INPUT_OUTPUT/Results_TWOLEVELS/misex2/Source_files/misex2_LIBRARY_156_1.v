...
module FAU ( 
  ...
  nand2  g001(.a(x15), .b(new_n44_), .O(new_n45_));
  ...
  inv1   g034(.a(x15), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(x07), .O(new_n79_));
  ...
  aoi21  g053(.a(new_n96_), .b(new_n78_), .c(x07), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  aoi21  g056(.a(x15), .b(new_n44_), .c(x20), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(new_n52_), .c(x18), .d(x01), .O(new_n101_));
  nand4  g058(.a(x12), .b(new_n72_), .c(x02), .d(new_n55_), .O(new_n102_));
  inv1   g059(.a(new_n102_), .O(new_n103_));
  nor2   g060(.a(x14), .b(x13), .O(new_n104_));
  inv1   g061(.a(x16), .O(new_n105_));
  nand3  g062(.a(x20), .b(new_n105_), .c(new_n78_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n104_), .c(new_n103_), .O(new_n108_));
  ...
  nor2   g080(.a(new_n46_), .b(x01), .O(new_n124_));
  inv1   g081(.a(new_n117_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nor2   g083(.a(new_n51_), .b(new_n55_), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(x21), .c(new_n113_), .d(new_n52_), .O(new_n128_));
  nor2   g085(.a(new_n78_), .b(x14), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n98_), .c(x20), .d(new_n105_), .O(new_n130_));
  oai21  g087(.a(new_n130_), .b(new_n126_), .c(new_n128_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n99_), .c(new_n71_), .O(new_n132_));
  ...
  nand3  g096(.a(new_n139_), .b(new_n55_), .c(new_n71_), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n45_), .c(new_n134_), .d(x09), .O(new_n142_));
