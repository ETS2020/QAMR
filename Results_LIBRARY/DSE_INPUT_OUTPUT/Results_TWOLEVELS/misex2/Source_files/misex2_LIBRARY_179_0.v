...
module FAU ( 
  ...
  nand2  g018(.a(new_n49_), .b(new_n47_), .O(new_n62_));
  inv1   g019(.a(x19), .O(new_n63_));
  nand3  g020(.a(new_n63_), .b(x18), .c(new_n44_), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n62_), .c(x12), .O(new_n65_));
  nand2  g022(.a(new_n65_), .b(new_n48_), .O(new_n66_));
  nand3  g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(x12), .b(x11), .c(x10), .d(new_n50_), .O(new_n68_));
  oai21  g025(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z03));
  inv1   g026(.a(x11), .O(new_n70_));
  nor2   g027(.a(new_n49_), .b(new_n47_), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n70_), .c(x10), .d(new_n50_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x01), .c(x12), .O(z04));
  inv1   g030(.a(x12), .O(new_n74_));
  nand2  g031(.a(new_n74_), .b(new_n48_), .O(new_n75_));
  ...
  nand4  g035(.a(x11), .b(x10), .c(new_n50_), .d(x02), .O(new_n79_));
  nor3   g036(.a(new_n79_), .b(new_n48_), .c(new_n47_), .O(z06));
  ...
  nor2   g046(.a(new_n63_), .b(x18), .O(new_n90_));
  ...
  nor2   g051(.a(new_n49_), .b(x01), .O(new_n95_));
  ...
  nand4  g073(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n117_));
  nand3  g074(.a(new_n95_), .b(new_n109_), .c(new_n70_), .O(new_n118_));
  nor2   g075(.a(new_n97_), .b(x14), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n93_), .c(x20), .d(new_n98_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n94_), .c(new_n47_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n75_), .O(z11));
  ...
  nand3  g084(.a(new_n63_), .b(x17), .c(new_n49_), .O(new_n128_));
  ...
  nand4  g090(.a(new_n63_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(x12), .c(x01), .O(z13));
  nor2   g092(.a(new_n51_), .b(x10), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n45_), .c(new_n44_), .d(x12), .O(new_n137_));
