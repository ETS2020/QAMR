...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n118_, new_n119_, new_n121_, new_n122_;
  ...
  nand2  g25(.a(new_n46_), .b(x02), .O(new_n69_));
  inv1   g26(.a(new_n69_), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(new_n68_), .c(new_n67_), .d(x10), .O(new_n71_));
  ...
  aoi21  g31(.a(x12), .b(new_n60_), .c(new_n67_), .O(new_n75_));
  ...
  oai21  g35(.a(new_n78_), .b(new_n69_), .c(x00), .O(new_n79_));
  nand2  g36(.a(new_n79_), .b(x01), .O(new_n80_));
  nand3  g37(.a(x02), .b(new_n44_), .c(x00), .O(new_n81_));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n87_));
  ...
  nand2  g49(.a(new_n67_), .b(x02), .O(new_n93_));
  nor4   g50(.a(new_n93_), .b(x14), .c(x13), .d(new_n68_), .O(new_n94_));
  nor2   g51(.a(x22), .b(x21), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(x20), .O(new_n96_));
  nor3   g53(.a(new_n96_), .b(x16), .c(x15), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  aoi21  g55(.a(new_n98_), .b(new_n44_), .c(x00), .O(z09));
  inv1   g56(.a(new_n96_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n94_), .c(x16), .d(x15), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g59(.a(x16), .O(new_n103_));
  nand4  g60(.a(new_n100_), .b(new_n94_), .c(new_n103_), .d(x15), .O(new_n104_));
  ...
  nand3  g67(.a(new_n110_), .b(new_n44_), .c(new_n60_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(x24), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(x09), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(z12));
  nand2  g71(.a(new_n52_), .b(x17), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z13));
  nand2  g73(.a(new_n52_), .b(new_n46_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n119_));
  ...
  nor2   g80(.a(new_n44_), .b(x00), .O(z16));
