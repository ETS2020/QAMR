...
module FAU ( 
  ...
  nand4  g011(.a(new_n54_), .b(x10), .c(x09), .d(new_n53_), .O(new_n55_));
  aoi21  g012(.a(new_n55_), .b(new_n52_), .c(x02), .O(z01));
  inv1   g013(.a(x10), .O(new_n57_));
  nand2  g014(.a(new_n47_), .b(x09), .O(new_n58_));
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x02), .O(new_n64_));
  nand2  g021(.a(new_n64_), .b(x01), .O(new_n65_));
  inv1   g022(.a(x19), .O(new_n66_));
  nor2   g023(.a(x02), .b(x00), .O(new_n67_));
  ...
  nand3  g031(.a(x10), .b(x09), .c(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(x02), .c(new_n52_), .O(z05));
  nand4  g033(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n52_), .c(new_n53_), .O(z06));
  ...
  nand3  g042(.a(x02), .b(new_n52_), .c(new_n53_), .O(new_n86_));
  ...
  nor2   g047(.a(new_n66_), .b(x18), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(x17), .O(new_n92_));
  nand2  g049(.a(new_n92_), .b(new_n84_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n70_), .c(x02), .d(new_n52_), .O(new_n96_));
  ...
  nand3  g059(.a(new_n102_), .b(new_n101_), .c(new_n66_), .O(new_n103_));
  oai21  g060(.a(new_n100_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n53_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n84_), .O(z09));
  nand3  g063(.a(new_n66_), .b(x18), .c(x01), .O(new_n107_));
  nand3  g064(.a(x22), .b(x21), .c(new_n101_), .O(new_n108_));
  nand4  g065(.a(new_n99_), .b(x12), .c(new_n70_), .d(new_n52_), .O(new_n109_));
  ...
  nand3  g069(.a(new_n112_), .b(x02), .c(new_n53_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(z10));
  nand4  g071(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n66_), .O(new_n115_));
  inv1   g072(.a(x13), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(x12), .c(new_n70_), .d(new_n52_), .O(new_n117_));
  nor2   g074(.a(new_n97_), .b(x14), .O(new_n118_));
  nor2   g075(.a(x21), .b(new_n101_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n118_), .c(new_n98_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x02), .d(new_n53_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(z11));
  inv1   g080(.a(x24), .O(new_n124_));
  nand3  g081(.a(new_n57_), .b(x01), .c(x00), .O(new_n125_));
  nand3  g082(.a(x23), .b(new_n52_), .c(new_n53_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(x02), .O(new_n128_));
  nand3  g085(.a(new_n66_), .b(x17), .c(new_n83_), .O(new_n129_));
  nand2  g086(.a(x23), .b(x19), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n52_), .c(new_n53_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n124_), .c(x09), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z12));
  nand2  g092(.a(new_n47_), .b(x17), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z13));
  nand4  g094(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n138_));
  ...
  nand3  g099(.a(x19), .b(new_n83_), .c(new_n52_), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n142_), .O(z15));
  nand3  g101(.a(x02), .b(x01), .c(new_n53_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand3  g103(.a(x02), .b(new_n52_), .c(new_n53_), .O(new_n147_));
