...
module FAU ( 
  ...
  oai21  g19(.a(new_n62_), .b(new_n60_), .c(x03), .O(new_n63_));
  ...
  nor3   g30(.a(new_n68_), .b(new_n57_), .c(x09), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(x02), .c(x01), .d(x00), .O(new_n75_));
  nor2   g32(.a(x03), .b(x01), .O(z08));
  inv1   g33(.a(z08), .O(new_n77_));
  nand2  g34(.a(new_n77_), .b(new_n75_), .O(z06));
  inv1   g35(.a(x03), .O(new_n79_));
  nand2  g36(.a(new_n53_), .b(x01), .O(new_n80_));
  inv1   g37(.a(x12), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x11), .c(x10), .O(new_n82_));
  oai22  g39(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(x01), .O(new_n83_));
  ...
  nand2  g54(.a(new_n97_), .b(new_n77_), .O(z09));
  nor3   g55(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n61_), .c(x18), .d(x01), .O(new_n100_));
  nor3   g57(.a(new_n79_), .b(new_n48_), .c(x01), .O(new_n101_));
  nor2   g58(.a(x13), .b(new_n81_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n68_), .O(new_n103_));
  ...
  nand4  g66(.a(new_n94_), .b(x21), .c(new_n93_), .d(new_n61_), .O(new_n110_));
  nor2   g67(.a(new_n48_), .b(x01), .O(new_n111_));
  nand3  g68(.a(new_n102_), .b(new_n111_), .c(new_n68_), .O(new_n112_));
  nor2   g69(.a(new_n89_), .b(x14), .O(new_n113_));
  nor2   g70(.a(x21), .b(new_n93_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n113_), .c(new_n90_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n110_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n87_), .c(new_n46_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n77_), .O(z11));
  ...
  nand3  g79(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n47_), .c(new_n46_), .O(new_n125_));
  ...
  nor3   g85(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g86(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z14));
  aoi21  g88(.a(x03), .b(new_n48_), .c(new_n120_), .O(new_n132_));
  nand4  g89(.a(x19), .b(x03), .c(new_n48_), .d(new_n47_), .O(new_n133_));
  oai21  g90(.a(new_n132_), .b(new_n46_), .c(new_n133_), .O(z15));
  oai21  g91(.a(new_n47_), .b(x00), .c(new_n77_), .O(z16));
  nand2  g92(.a(x02), .b(new_n46_), .O(new_n136_));
  aoi21  g93(.a(new_n136_), .b(x03), .c(x01), .O(z17));
endmodule
