...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    new_n55_, new_n56_, new_n58_, new_n61_, new_n62_, new_n64_, new_n65_,
    new_n67_, new_n68_, new_n69_, new_n70_, new_n72_, new_n73_, new_n75_,
    new_n76_, new_n77_, new_n78_, new_n79_, new_n81_, new_n82_, new_n85_,
    new_n86_;
  ...
  nand4  g16(.a(x11), .b(x10), .c(new_n48_), .d(x02), .O(new_n62_));
  nor3   g17(.a(new_n62_), .b(new_n61_), .c(z16), .O(z06));
  oai21  g18(.a(x02), .b(z16), .c(new_n61_), .O(new_n64_));
  nand4  g19(.a(new_n47_), .b(x11), .c(x10), .d(new_n48_), .O(new_n65_));
  oai21  g20(.a(new_n65_), .b(new_n54_), .c(new_n64_), .O(z07));
  ...
  nand4  g31(.a(new_n76_), .b(x18), .c(x01), .d(z16), .O(new_n77_));
  ...
  aoi21  g39(.a(new_n58_), .b(x01), .c(new_n85_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(z16), .c(new_n53_), .O(z15));
  zero   g41(.O(z00));
  zero   g42(.O(z02));
  zero   g43(.O(z13));
