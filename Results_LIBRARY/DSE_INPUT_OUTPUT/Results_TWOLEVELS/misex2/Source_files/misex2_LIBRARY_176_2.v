...
module FAU ( 
  ...
  nand2  g008(.a(new_n51_), .b(x21), .O(new_n52_));
  ...
  nor2   g032(.a(new_n75_), .b(new_n57_), .O(z04));
  ...
  nand4  g039(.a(new_n52_), .b(new_n67_), .c(x11), .d(x10), .O(new_n83_));
  ...
  nand3  g053(.a(new_n88_), .b(x12), .c(new_n66_), .O(new_n97_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n57_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n52_), .O(z09));
  nand3  g063(.a(new_n50_), .b(x18), .c(x01), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(new_n108_));
  nor3   g065(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n109_));
  inv1   g066(.a(x13), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(x12), .c(new_n66_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand2  g069(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  ...
  aoi22  g074(.a(new_n117_), .b(new_n114_), .c(new_n109_), .d(new_n108_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n52_), .O(z10));
  nor2   g076(.a(new_n98_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n95_), .c(x20), .d(new_n99_), .O(new_n121_));
  nand4  g078(.a(new_n108_), .b(x23), .c(x21), .d(new_n102_), .O(new_n122_));
  oai21  g079(.a(new_n121_), .b(new_n113_), .c(new_n122_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n57_), .O(new_n124_));
  inv1   g081(.a(new_n124_), .O(z11));
  inv1   g082(.a(x24), .O(new_n126_));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n52_), .c(x01), .d(x00), .O(new_n128_));
  nor2   g085(.a(x21), .b(x19), .O(new_n129_));
  aoi21  g086(.a(new_n129_), .b(new_n45_), .c(x23), .O(new_n130_));
  oai21  g087(.a(x19), .b(x02), .c(x23), .O(new_n131_));
  oai21  g088(.a(new_n130_), .b(new_n48_), .c(new_n131_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n57_), .O(new_n133_));
  ...
  nand2  g093(.a(new_n44_), .b(new_n57_), .O(new_n137_));
  nand3  g094(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n52_), .O(z13));
  ...
  aoi21  g102(.a(new_n145_), .b(new_n144_), .c(new_n63_), .O(z15));
  nor3   g103(.a(new_n63_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g104(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n57_), .O(new_n148_));
