...
module FAU ( 
  ...
  nand2  g54(.a(new_n97_), .b(new_n61_), .O(new_n98_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n61_), .c(x18), .d(x01), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n66_), .O(new_n105_));
  ...
  nand4  g68(.a(new_n94_), .b(x12), .c(new_n66_), .d(x02), .O(new_n112_));
  nand3  g69(.a(new_n109_), .b(new_n93_), .c(x15), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n112_), .c(new_n44_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n52_), .O(new_n115_));
  inv1   g72(.a(new_n98_), .O(new_n116_));
  nor2   g73(.a(new_n96_), .b(x00), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n116_), .c(new_n89_), .d(x21), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n115_), .O(z11));
  nand2  g76(.a(x10), .b(x02), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(x01), .c(x00), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n52_), .c(new_n44_), .O(new_n125_));
  ...
  nand4  g86(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n130_));
  ...
  aoi21  g90(.a(x19), .b(new_n45_), .c(x00), .O(new_n134_));
  nand2  g91(.a(new_n120_), .b(x00), .O(new_n135_));
  oai21  g92(.a(new_n134_), .b(x01), .c(new_n135_), .O(z15));
  xor2a  g93(.a(x01), .b(x00), .O(z16));
  nand3  g94(.a(x02), .b(new_n52_), .c(new_n44_), .O(new_n138_));
