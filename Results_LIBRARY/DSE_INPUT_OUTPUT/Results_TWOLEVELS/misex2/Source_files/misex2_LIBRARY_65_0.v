...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n45_, new_n46_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_,
    new_n56_, new_n57_, new_n58_, new_n60_, new_n62_, new_n64_, new_n65_,
    new_n66_, new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n73_,
    new_n74_, new_n76_, new_n78_, new_n79_, new_n81_, new_n82_, new_n85_;
  ...
  oai21  g13(.a(new_n58_), .b(new_n56_), .c(new_n46_), .O(z04));
  inv1   g14(.a(x10), .O(new_n60_));
  nor3   g15(.a(new_n52_), .b(new_n60_), .c(new_n51_), .O(z05));
  nand4  g16(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n62_));
  nor3   g17(.a(new_n62_), .b(new_n45_), .c(z16), .O(z06));
  nand3  g18(.a(new_n50_), .b(x11), .c(x10), .O(new_n64_));
  ...
  nand2  g38(.a(new_n60_), .b(x01), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(x02), .c(z16), .O(z15));
  zero   g40(.O(z01));
  zero   g41(.O(z02));
  zero   g42(.O(z14));
  inv1   g43(.a(new_n46_), .O(z08));
  inv1   g44(.a(new_n46_), .O(z13));
