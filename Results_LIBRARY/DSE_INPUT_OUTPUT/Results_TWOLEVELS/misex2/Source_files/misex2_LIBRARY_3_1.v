...
module FAU ( 
  ...
  nand3  g057(.a(new_n100_), .b(x12), .c(new_n67_), .O(new_n101_));
  inv1   g058(.a(new_n101_), .O(new_n102_));
  nor2   g059(.a(x15), .b(x14), .O(new_n103_));
  inv1   g060(.a(x16), .O(new_n104_));
  inv1   g061(.a(x24), .O(new_n105_));
  nand3  g062(.a(new_n105_), .b(x20), .c(new_n104_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n103_), .c(new_n102_), .d(new_n86_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n99_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n97_), .c(new_n96_), .d(new_n57_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(z09));
  inv1   g068(.a(x20), .O(new_n112_));
  nand4  g069(.a(new_n52_), .b(x22), .c(x21), .d(new_n112_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n50_), .c(x18), .d(x01), .O(new_n115_));
  nor3   g072(.a(new_n104_), .b(new_n51_), .c(x14), .O(new_n116_));
  nand3  g073(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n116_), .c(new_n102_), .d(new_n86_), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n115_), .c(x00), .O(z10));
  nand2  g077(.a(new_n102_), .b(new_n86_), .O(new_n121_));
  nor2   g078(.a(new_n49_), .b(new_n44_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n112_), .d(new_n50_), .O(new_n123_));
  nor2   g080(.a(new_n51_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n96_), .c(x20), .d(new_n104_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n121_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n57_), .O(new_n127_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n105_), .c(x09), .O(new_n136_));
  ...
  nand2  g104(.a(new_n87_), .b(new_n52_), .O(z17));
endmodule
