...
module FAU ( 
  ...
  oai21  g019(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  ...
  nor2   g027(.a(new_n70_), .b(x05), .O(new_n71_));
  ...
  aoi21  g032(.a(new_n75_), .b(new_n60_), .c(new_n74_), .O(z05));
  nor2   g033(.a(new_n69_), .b(new_n57_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n47_), .c(x02), .d(x00), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(new_n60_), .c(new_n74_), .O(z06));
  ...
  nand2  g040(.a(x05), .b(x01), .O(new_n84_));
  ...
  nand3  g046(.a(new_n60_), .b(x04), .c(new_n89_), .O(new_n90_));
  ...
  nand2  g051(.a(new_n94_), .b(new_n84_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n69_), .c(x02), .d(new_n74_), .O(new_n98_));
  ...
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n65_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n86_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n84_), .O(z09));
  nand3  g065(.a(new_n65_), .b(x18), .c(x01), .O(new_n109_));
  nand3  g066(.a(x22), .b(x21), .c(new_n103_), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g068(.a(x02), .b(new_n74_), .O(new_n112_));
  inv1   g069(.a(x13), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n69_), .O(new_n114_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n84_), .O(z10));
  nor2   g078(.a(x13), .b(new_n80_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n87_), .c(new_n69_), .O(new_n123_));
  nand4  g080(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n65_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n97_), .c(new_n86_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n74_), .c(new_n86_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n65_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n143_), .c(new_n84_), .O(z14));
  aoi22  g102(.a(new_n84_), .b(x00), .c(x19), .d(new_n74_), .O(new_n146_));
  nand4  g103(.a(new_n57_), .b(new_n60_), .c(x01), .d(x00), .O(new_n147_));
  oai21  g104(.a(new_n146_), .b(x02), .c(new_n147_), .O(z15));
  nand3  g105(.a(new_n60_), .b(x01), .c(new_n86_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  nand2  g107(.a(new_n88_), .b(new_n84_), .O(z17));
endmodule
