...
module FAU ( 
  ...
  nand2  g013(.a(x18), .b(x08), .O(new_n57_));
  ...
  nand4  g019(.a(new_n57_), .b(x12), .c(x11), .d(x10), .O(new_n63_));
  ...
  nand4  g025(.a(new_n68_), .b(new_n67_), .c(new_n44_), .d(new_n66_), .O(new_n69_));
  nand2  g026(.a(new_n69_), .b(new_n65_), .O(z03));
  inv1   g027(.a(x00), .O(new_n71_));
  inv1   g028(.a(x11), .O(new_n72_));
  inv1   g029(.a(x12), .O(new_n73_));
  nand4  g030(.a(new_n57_), .b(new_n73_), .c(new_n72_), .d(x10), .O(new_n74_));
  ...
  nand4  g035(.a(new_n57_), .b(x10), .c(x09), .d(x02), .O(new_n79_));
  nor3   g036(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z05));
  inv1   g037(.a(new_n57_), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(x12), .O(new_n82_));
  ...
  nand3  g050(.a(new_n48_), .b(new_n93_), .c(x02), .O(new_n94_));
  ...
  nand4  g054(.a(new_n97_), .b(new_n45_), .c(x17), .d(new_n66_), .O(new_n98_));
  nor2   g055(.a(new_n98_), .b(new_n60_), .O(z08));
  ...
  nor2   g064(.a(new_n45_), .b(new_n78_), .O(new_n108_));
  ...
  nand4  g068(.a(new_n111_), .b(new_n101_), .c(new_n100_), .d(new_n71_), .O(new_n112_));
  nand2  g069(.a(new_n112_), .b(new_n57_), .O(z09));
  inv1   g070(.a(x13), .O(new_n114_));
  inv1   g071(.a(x14), .O(new_n115_));
  nand4  g072(.a(new_n57_), .b(new_n101_), .c(new_n100_), .d(x20), .O(new_n116_));
  nor2   g073(.a(new_n116_), .b(new_n105_), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(x15), .c(new_n115_), .d(new_n114_), .O(new_n118_));
  nor2   g075(.a(new_n118_), .b(new_n73_), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n72_), .c(x02), .d(new_n78_), .O(new_n120_));
  nor2   g077(.a(new_n45_), .b(x08), .O(new_n121_));
  nor2   g078(.a(new_n101_), .b(new_n100_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n121_), .c(new_n109_), .d(x01), .O(new_n123_));
  aoi21  g080(.a(new_n123_), .b(new_n120_), .c(x00), .O(z10));
  nor2   g081(.a(new_n100_), .b(x20), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n108_), .c(new_n60_), .O(new_n126_));
  nand4  g083(.a(new_n102_), .b(new_n114_), .c(x12), .d(new_n72_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n101_), .c(new_n71_), .O(new_n131_));
  ...
  nand3  g092(.a(new_n60_), .b(x17), .c(new_n46_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n78_), .c(new_n71_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n134_), .c(x24), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n57_), .O(z12));
  nor2   g098(.a(new_n81_), .b(x19), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(x17), .c(new_n46_), .d(new_n78_), .O(new_n143_));
  ...
  oai21  g103(.a(x10), .b(new_n78_), .c(x02), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(x00), .O(new_n148_));
  nand3  g105(.a(x19), .b(new_n46_), .c(new_n78_), .O(new_n149_));
  aoi21  g106(.a(new_n149_), .b(new_n148_), .c(new_n81_), .O(z15));
  nand3  g107(.a(new_n57_), .b(x01), .c(new_n71_), .O(new_n151_));
  inv1   g108(.a(new_n151_), .O(z16));
  nand4  g109(.a(new_n57_), .b(x02), .c(new_n78_), .d(new_n71_), .O(new_n153_));
