...
module FAU ( 
  ...
  nand2  g007(.a(x20), .b(x05), .O(new_n51_));
  ...
  nand3  g028(.a(new_n71_), .b(new_n65_), .c(new_n51_), .O(z03));
  inv1   g029(.a(x00), .O(new_n73_));
  nand4  g030(.a(new_n51_), .b(new_n69_), .c(new_n68_), .d(x10), .O(new_n74_));
  ...
  nor3   g037(.a(new_n68_), .b(new_n47_), .c(x09), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x02), .c(x01), .d(x00), .O(new_n82_));
  nand2  g039(.a(new_n82_), .b(new_n51_), .O(z06));
  ...
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n73_), .O(new_n92_));
  ...
  nand3  g054(.a(new_n89_), .b(x12), .c(new_n68_), .O(new_n98_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n73_), .O(new_n107_));
  ...
  inv1   g079(.a(x05), .O(new_n123_));
  nand3  g080(.a(x12), .b(new_n68_), .c(new_n123_), .O(new_n124_));
  nor2   g081(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  nand3  g082(.a(x15), .b(new_n116_), .c(new_n113_), .O(new_n126_));
  nand3  g083(.a(new_n96_), .b(x20), .c(new_n100_), .O(new_n127_));
  nor2   g084(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n122_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n97_), .c(new_n73_), .O(new_n131_));
  ...
  nand3  g095(.a(new_n138_), .b(new_n44_), .c(new_n73_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n51_), .c(new_n133_), .d(x09), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(z12));
  inv1   g099(.a(new_n56_), .O(new_n143_));
  oai21  g100(.a(new_n137_), .b(new_n143_), .c(new_n51_), .O(z13));
  nor2   g101(.a(x09), .b(x02), .O(new_n145_));
  nor2   g102(.a(x17), .b(x10), .O(new_n146_));
  nand4  g103(.a(new_n146_), .b(new_n145_), .c(new_n58_), .d(new_n56_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n51_), .O(z14));
  ...
  nand3  g108(.a(new_n151_), .b(new_n150_), .c(new_n51_), .O(z15));
  nand3  g109(.a(new_n51_), .b(x01), .c(new_n73_), .O(new_n153_));
  inv1   g110(.a(new_n153_), .O(z16));
  nand4  g111(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n73_), .O(new_n155_));
  inv1   g112(.a(new_n155_), .O(z17));
endmodule
