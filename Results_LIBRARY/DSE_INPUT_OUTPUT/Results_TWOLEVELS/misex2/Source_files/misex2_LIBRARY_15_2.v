...
module FAU ( 
  ...
  nand4  g35(.a(new_n78_), .b(x10), .c(new_n46_), .d(x02), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n62_), .d(new_n52_), .O(new_n85_));
  ...
  nor2   g49(.a(new_n53_), .b(x01), .O(new_n93_));
  ...
  nor2   g55(.a(new_n45_), .b(new_n62_), .O(new_n99_));
  ...
  nand4  g61(.a(new_n104_), .b(new_n92_), .c(new_n91_), .d(new_n52_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z09));
  nand4  g63(.a(new_n97_), .b(x12), .c(new_n69_), .d(x02), .O(new_n107_));
  nor2   g64(.a(x22), .b(x21), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(x20), .c(x16), .d(x15), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n107_), .c(new_n52_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n62_), .O(new_n111_));
  nor2   g68(.a(new_n92_), .b(new_n91_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n102_), .c(new_n99_), .d(new_n52_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n111_), .O(z10));
  nand4  g71(.a(new_n99_), .b(x21), .c(new_n100_), .d(new_n64_), .O(new_n115_));
  inv1   g72(.a(x13), .O(new_n116_));
  nand4  g73(.a(new_n93_), .b(new_n116_), .c(x12), .d(new_n69_), .O(new_n117_));
  nor2   g74(.a(new_n95_), .b(x14), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n91_), .c(x20), .d(new_n96_), .O(new_n119_));
  ...
  nand3  g93(.a(new_n136_), .b(x19), .c(new_n53_), .O(new_n137_));
