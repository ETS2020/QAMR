...
module FAU ( 
  ...
  nor3   g30(.a(new_n70_), .b(new_n46_), .c(new_n53_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n53_), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n44_), .c(new_n54_), .O(z06));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n44_), .d(new_n54_), .O(new_n86_));
  ...
  nand4  g52(.a(new_n69_), .b(x02), .c(new_n44_), .d(new_n54_), .O(new_n96_));
  ...
  nand3  g69(.a(new_n112_), .b(new_n44_), .c(new_n54_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(x24), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(x09), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(z12));
  nor3   g73(.a(new_n55_), .b(x19), .c(new_n51_), .O(z13));
  nand4  g74(.a(new_n48_), .b(new_n46_), .c(new_n53_), .d(new_n45_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g76(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n120_));
  nand3  g77(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n54_), .c(new_n121_), .O(z15));
  nor2   g79(.a(new_n44_), .b(x00), .O(z16));
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n54_), .O(new_n124_));
