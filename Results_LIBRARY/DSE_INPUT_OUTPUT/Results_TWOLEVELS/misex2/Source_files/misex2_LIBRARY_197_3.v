...
module FAU ( 
  ...
  nor4   g22(.a(new_n57_), .b(x19), .c(new_n53_), .d(x17), .O(z03));
  ...
  nand4  g37(.a(x12), .b(new_n82_), .c(x02), .d(new_n45_), .O(new_n83_));
  ...
  nand4  g43(.a(new_n88_), .b(new_n54_), .c(x18), .d(x01), .O(new_n89_));
  oai21  g44(.a(new_n87_), .b(new_n83_), .c(new_n89_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n81_), .c(new_n80_), .d(new_n44_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand2  g47(.a(new_n54_), .b(x18), .O(new_n93_));
  nand3  g48(.a(x22), .b(x21), .c(new_n88_), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n93_), .c(new_n44_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(x01), .O(new_n96_));
  inv1   g51(.a(x12), .O(new_n97_));
  nand3  g52(.a(x02), .b(new_n45_), .c(new_n44_), .O(new_n98_));
  nor4   g53(.a(new_n98_), .b(x13), .c(new_n97_), .d(x11), .O(new_n99_));
  nor3   g54(.a(new_n85_), .b(new_n84_), .c(x14), .O(new_n100_));
  ...
  nand2  g58(.a(new_n103_), .b(new_n96_), .O(z10));
  nand3  g59(.a(new_n81_), .b(x21), .c(new_n88_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(new_n93_), .c(new_n44_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x01), .O(new_n107_));
  inv1   g62(.a(x14), .O(new_n108_));
  nor2   g63(.a(x16), .b(new_n84_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n102_), .c(new_n99_), .d(new_n108_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n107_), .O(z11));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g67(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n113_));
  ...
  nor3   g71(.a(new_n57_), .b(x19), .c(new_n52_), .O(z13));
  nand2  g72(.a(new_n58_), .b(new_n49_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n53_), .c(new_n52_), .d(new_n63_), .O(new_n120_));
