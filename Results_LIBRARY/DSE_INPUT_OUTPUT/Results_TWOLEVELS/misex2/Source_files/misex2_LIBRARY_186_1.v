...
module FAU ( 
  ...
  nor2   g020(.a(new_n63_), .b(x16), .O(new_n64_));
  ...
  nand2  g043(.a(new_n86_), .b(new_n59_), .O(new_n87_));
  ...
  aoi21  g054(.a(x24), .b(new_n51_), .c(x20), .O(new_n98_));
  ...
  nand3  g060(.a(new_n63_), .b(x20), .c(new_n51_), .O(new_n104_));
  inv1   g061(.a(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n103_), .c(new_n102_), .d(new_n86_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n59_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nor3   g066(.a(new_n101_), .b(new_n45_), .c(x01), .O(new_n110_));
  ...
  aoi21  g074(.a(new_n117_), .b(new_n110_), .c(new_n114_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n52_), .O(z10));
  nand2  g076(.a(new_n102_), .b(new_n86_), .O(new_n120_));
  nor2   g077(.a(new_n49_), .b(new_n44_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n112_), .d(new_n50_), .O(new_n122_));
  inv1   g079(.a(x15), .O(new_n123_));
  nor2   g080(.a(new_n123_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n96_), .c(x20), .d(new_n51_), .O(new_n125_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n63_), .c(x09), .O(new_n136_));
  ...
  oai21  g103(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
