...
module FAU ( 
  ...
  nor2   g029(.a(x19), .b(new_n56_), .O(new_n73_));
  nand3  g030(.a(new_n73_), .b(new_n72_), .c(new_n50_), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(new_n71_), .c(new_n65_), .O(z03));
  inv1   g032(.a(x00), .O(new_n76_));
  nand4  g033(.a(new_n45_), .b(new_n69_), .c(new_n68_), .d(x10), .O(new_n77_));
  ...
  nor2   g053(.a(new_n57_), .b(x18), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(x17), .O(new_n98_));
  aoi21  g055(.a(new_n98_), .b(x23), .c(new_n91_), .O(z08));
  ...
  nor2   g065(.a(new_n56_), .b(new_n54_), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(new_n108_), .c(new_n57_), .O(new_n110_));
  oai21  g067(.a(new_n107_), .b(new_n103_), .c(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n45_), .c(new_n101_), .d(new_n100_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(x00), .O(z09));
  nor2   g070(.a(new_n101_), .b(new_n100_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n73_), .c(new_n108_), .d(x01), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n69_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n102_), .c(new_n68_), .O(new_n117_));
  ...
  nand3  g077(.a(new_n120_), .b(new_n45_), .c(new_n76_), .O(new_n121_));
  inv1   g078(.a(new_n121_), .O(z10));
  nand4  g079(.a(new_n109_), .b(x21), .c(new_n108_), .d(new_n57_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n101_), .c(new_n76_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n45_), .O(z11));
  inv1   g085(.a(x24), .O(new_n129_));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n45_), .c(x01), .d(x00), .O(new_n131_));
  nor2   g088(.a(x19), .b(x04), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n46_), .c(x23), .O(new_n133_));
  oai21  g090(.a(x19), .b(x02), .c(x23), .O(new_n134_));
  oai21  g091(.a(new_n133_), .b(new_n50_), .c(new_n134_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n54_), .c(new_n76_), .O(new_n136_));
  ...
  nand3  g096(.a(new_n57_), .b(x17), .c(new_n46_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n92_), .c(new_n45_), .O(z13));
  nand3  g098(.a(new_n51_), .b(new_n50_), .c(new_n55_), .O(new_n142_));
  ...
  nand3  g102(.a(x19), .b(new_n46_), .c(new_n54_), .O(new_n146_));
  aoi21  g103(.a(new_n146_), .b(new_n145_), .c(new_n65_), .O(z15));
  oai21  g104(.a(new_n54_), .b(x00), .c(new_n45_), .O(z16));
  nand2  g105(.a(new_n102_), .b(new_n76_), .O(new_n149_));
