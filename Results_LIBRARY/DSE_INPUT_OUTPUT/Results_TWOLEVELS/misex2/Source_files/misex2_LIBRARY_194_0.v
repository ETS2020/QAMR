...
module FAU ( 
  ...
  nand4  g28(.a(new_n73_), .b(x18), .c(x01), .d(new_n65_), .O(new_n74_));
  inv1   g29(.a(new_n74_), .O(new_n75_));
  nand4  g30(.a(new_n75_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z09));
  nand4  g32(.a(new_n75_), .b(x22), .c(x21), .d(new_n70_), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(z10));
  nor2   g34(.a(x22), .b(new_n71_), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n70_), .c(new_n73_), .d(x18), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(x01), .c(x00), .O(z11));
  aoi21  g37(.a(x10), .b(x02), .c(x24), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(x09), .c(x01), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(new_n65_), .O(z12));
  inv1   g40(.a(x02), .O(new_n87_));
  inv1   g41(.a(x10), .O(new_n88_));
  aoi21  g42(.a(new_n88_), .b(x01), .c(new_n87_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n65_), .c(new_n53_), .O(z15));
