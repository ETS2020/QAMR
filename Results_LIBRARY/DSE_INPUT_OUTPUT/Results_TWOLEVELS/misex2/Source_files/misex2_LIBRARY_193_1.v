...
module FAU ( 
  ...
  nand3  g40(.a(x02), .b(new_n56_), .c(x00), .O(new_n84_));
  ...
  nand4  g46(.a(new_n89_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n90_));
  ...
  nand4  g56(.a(new_n69_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n99_), .c(new_n98_), .d(x12), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x15), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n97_), .c(x20), .d(new_n96_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(x22), .O(z09));
  inv1   g62(.a(x15), .O(new_n106_));
  nor2   g63(.a(new_n102_), .b(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n97_), .c(x20), .d(x16), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(x22), .O(z10));
  nand4  g66(.a(new_n107_), .b(new_n97_), .c(x20), .d(new_n96_), .O(new_n110_));
  ...
  nand3  g71(.a(new_n64_), .b(x17), .c(new_n57_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n56_), .c(new_n62_), .O(new_n117_));
  ...
  aoi21  g81(.a(new_n58_), .b(x01), .c(new_n57_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n57_), .c(new_n56_), .O(new_n126_));
