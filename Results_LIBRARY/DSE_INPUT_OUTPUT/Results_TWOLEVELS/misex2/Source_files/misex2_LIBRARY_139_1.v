...
module FAU ( 
  ...
  nand2  g001(.a(x12), .b(new_n44_), .O(new_n45_));
  ...
  nand4  g018(.a(new_n61_), .b(x09), .c(new_n46_), .d(new_n55_), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(x00), .O(z02));
  nand3  g020(.a(x02), .b(x01), .c(x00), .O(new_n64_));
  nand4  g021(.a(x11), .b(x10), .c(new_n47_), .d(x05), .O(new_n65_));
  oai21  g022(.a(new_n65_), .b(new_n64_), .c(x05), .O(new_n66_));
  nand2  g023(.a(new_n66_), .b(x12), .O(new_n67_));
  ...
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(new_n47_), .O(new_n73_));
  oai21  g030(.a(new_n73_), .b(new_n64_), .c(new_n45_), .O(z04));
  inv1   g031(.a(x00), .O(new_n75_));
  inv1   g032(.a(new_n45_), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n56_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n75_), .O(z05));
  aoi21  g036(.a(x12), .b(new_n44_), .c(new_n71_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x10), .c(new_n47_), .d(x02), .O(new_n81_));
  nor3   g038(.a(new_n81_), .b(new_n55_), .c(new_n75_), .O(z06));
  nand2  g039(.a(new_n47_), .b(x01), .O(new_n83_));
  nand3  g040(.a(new_n72_), .b(x11), .c(x10), .O(new_n84_));
  oai22  g041(.a(new_n84_), .b(new_n83_), .c(new_n76_), .d(x01), .O(new_n85_));
  nand3  g042(.a(new_n85_), .b(x02), .c(x00), .O(new_n86_));
  inv1   g043(.a(new_n86_), .O(z07));
  inv1   g044(.a(new_n48_), .O(new_n88_));
  ...
  aoi21  g051(.a(new_n94_), .b(new_n72_), .c(x05), .O(z08));
  ...
  nand2  g069(.a(x02), .b(new_n55_), .O(new_n113_));
  ...
  nand4  g079(.a(new_n98_), .b(new_n114_), .c(x12), .d(new_n71_), .O(new_n123_));
  nand4  g080(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n52_), .O(new_n124_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n55_), .c(new_n75_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n134_), .b(new_n88_), .c(new_n45_), .O(z13));
  nand4  g097(.a(new_n61_), .b(new_n47_), .c(new_n46_), .d(new_n55_), .O(new_n141_));
  ...
  nor3   g103(.a(new_n76_), .b(new_n55_), .c(x00), .O(z16));
  oai21  g104(.a(new_n113_), .b(x00), .c(new_n45_), .O(z17));
endmodule
