...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n55_,
    ...
    new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n86_;
  ...
  nand4  g19(.a(new_n48_), .b(x11), .c(x10), .d(new_n49_), .O(new_n65_));
  ...
  nand2  g36(.a(new_n82_), .b(new_n57_), .O(z12));
  nand2  g37(.a(new_n55_), .b(x01), .O(new_n86_));
