...
module FAU ( 
  ...
  nand2  g09(.a(x20), .b(x01), .O(new_n53_));
  ...
  oai21  g20(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  ...
  nor2   g31(.a(new_n74_), .b(x20), .O(z04));
  nor4   g32(.a(new_n72_), .b(x20), .c(new_n58_), .d(new_n47_), .O(z05));
  inv1   g33(.a(x01), .O(new_n77_));
  nor2   g34(.a(new_n70_), .b(new_n58_), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n47_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(new_n61_), .c(new_n77_), .O(z06));
  nand3  g37(.a(new_n71_), .b(x11), .c(x10), .O(new_n81_));
  oai21  g38(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nand3  g39(.a(new_n82_), .b(x02), .c(x00), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n53_), .O(z07));
  ...
  nand4  g46(.a(new_n89_), .b(x02), .c(new_n77_), .d(new_n88_), .O(new_n90_));
  inv1   g47(.a(new_n90_), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n87_), .c(new_n86_), .d(x04), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(x07), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n45_), .c(x17), .d(new_n85_), .O(new_n94_));
  ...
  nand3  g55(.a(new_n98_), .b(x12), .c(new_n70_), .O(new_n99_));
  inv1   g56(.a(x15), .O(new_n100_));
  inv1   g57(.a(x16), .O(new_n101_));
  nor2   g58(.a(x14), .b(x13), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(x20), .c(new_n101_), .d(new_n100_), .O(new_n103_));
  nand4  g60(.a(new_n61_), .b(new_n55_), .c(x18), .d(x01), .O(new_n104_));
  oai21  g61(.a(new_n103_), .b(new_n99_), .c(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n88_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z09));
  nor2   g64(.a(new_n97_), .b(new_n96_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n67_), .c(new_n61_), .d(x01), .O(new_n109_));
  inv1   g66(.a(new_n98_), .O(new_n110_));
  inv1   g67(.a(x13), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(x12), .c(new_n70_), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nor3   g70(.a(new_n101_), .b(new_n100_), .c(x14), .O(new_n114_));
  nor2   g71(.a(x22), .b(x21), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(x20), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n109_), .c(x00), .O(z10));
  nand4  g74(.a(x21), .b(new_n55_), .c(x18), .d(x01), .O(new_n118_));
  nand4  g75(.a(new_n111_), .b(x12), .c(new_n70_), .d(x02), .O(new_n119_));
  nor2   g76(.a(new_n100_), .b(x14), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(new_n96_), .c(x20), .d(new_n101_), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n97_), .c(new_n88_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n53_), .O(z11));
  nand2  g81(.a(x10), .b(x02), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(x01), .c(x00), .O(new_n126_));
  oai21  g83(.a(x19), .b(x02), .c(x23), .O(new_n127_));
  nand3  g84(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(new_n77_), .c(new_n88_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n126_), .c(x24), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(x09), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n53_), .O(z12));
  inv1   g90(.a(new_n48_), .O(new_n134_));
  oai21  g91(.a(new_n128_), .b(new_n134_), .c(new_n53_), .O(z13));
  nand3  g92(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n136_));
  oai21  g93(.a(new_n136_), .b(new_n59_), .c(new_n53_), .O(z14));
  aoi22  g94(.a(new_n53_), .b(x00), .c(x19), .d(new_n77_), .O(new_n138_));
  nand4  g95(.a(new_n61_), .b(new_n58_), .c(x01), .d(x00), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(x02), .c(new_n139_), .O(z15));
  aoi21  g97(.a(new_n61_), .b(x00), .c(new_n77_), .O(z16));
  oai21  g98(.a(new_n110_), .b(x00), .c(new_n53_), .O(z17));
endmodule
