...
module FAU ( 
  ...
  nor3   g049(.a(x08), .b(x06), .c(x05), .O(new_n93_));
  nand3  g050(.a(x19), .b(new_n49_), .c(x17), .O(new_n94_));
  inv1   g051(.a(new_n94_), .O(new_n95_));
  nand4  g052(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n59_), .O(new_n96_));
  aoi21  g053(.a(new_n96_), .b(new_n89_), .c(x07), .O(z08));
  ...
  nand4  g065(.a(new_n108_), .b(new_n98_), .c(new_n89_), .d(new_n73_), .O(new_n109_));
  ...
  nand3  g076(.a(new_n98_), .b(new_n89_), .c(x20), .O(new_n120_));
  ...
  nand4  g080(.a(new_n99_), .b(new_n115_), .c(x12), .d(new_n66_), .O(new_n124_));
  nand4  g081(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n125_));
  nor2   g082(.a(new_n101_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n89_), .c(x20), .d(new_n102_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n124_), .c(new_n125_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n98_), .c(new_n73_), .O(new_n129_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n44_), .c(new_n73_), .O(new_n137_));
  ...
  nor3   g107(.a(new_n63_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g108(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n73_), .O(new_n152_));
