...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n125_, new_n126_, new_n127_, new_n129_, new_n130_;
  ...
  nand4  g33(.a(new_n69_), .b(new_n68_), .c(x11), .d(x10), .O(new_n77_));
  ...
  nand3  g73(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n117_));
  ...
  nand2  g81(.a(new_n52_), .b(new_n46_), .O(new_n125_));
  ...
  nand2  g86(.a(new_n114_), .b(x00), .O(new_n130_));
