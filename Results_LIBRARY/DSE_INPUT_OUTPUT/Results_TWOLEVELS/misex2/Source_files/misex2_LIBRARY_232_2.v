...
module FAU ( 
  ...
  nor3   g015(.a(x19), .b(x17), .c(x10), .O(new_n59_));
  nand4  g016(.a(new_n59_), .b(x09), .c(new_n58_), .d(new_n57_), .O(new_n60_));
  aoi21  g017(.a(new_n60_), .b(new_n56_), .c(x18), .O(z02));
  nand3  g018(.a(new_n46_), .b(x02), .c(x00), .O(new_n62_));
  nand4  g019(.a(x18), .b(x12), .c(x11), .d(x10), .O(new_n63_));
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x18), .O(new_n64_));
  ...
  aoi21  g030(.a(new_n73_), .b(x18), .c(new_n56_), .O(z04));
  inv1   g031(.a(x10), .O(new_n75_));
  nand4  g032(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(new_n45_), .c(new_n75_), .O(z05));
  nand3  g034(.a(x18), .b(x11), .c(x10), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n46_), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n57_), .O(z06));
  nand2  g038(.a(x10), .b(new_n46_), .O(new_n82_));
  nand3  g039(.a(x18), .b(new_n71_), .c(x11), .O(new_n83_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n56_), .d(new_n57_), .O(new_n92_));
  ...
  nor2   g053(.a(new_n96_), .b(new_n87_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nor2   g056(.a(new_n58_), .b(x01), .O(new_n100_));
  ...
  nor2   g063(.a(new_n45_), .b(new_n56_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n106_), .c(new_n87_), .O(new_n108_));
  oai21  g065(.a(new_n105_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n57_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(z09));
  nor2   g068(.a(new_n99_), .b(new_n98_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n67_), .c(new_n106_), .d(x01), .O(new_n113_));
  nor2   g070(.a(x13), .b(new_n71_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n100_), .c(new_n70_), .O(new_n115_));
  ...
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n87_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n99_), .c(new_n57_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n87_), .b(x17), .c(new_n58_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n56_), .c(new_n57_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n127_), .c(x24), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(x09), .O(new_n133_));
  nand2  g090(.a(new_n45_), .b(x01), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(z12));
  nand2  g092(.a(new_n47_), .b(x17), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z13));
  nand4  g094(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n75_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  oai21  g096(.a(x10), .b(new_n56_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n58_), .c(new_n56_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n134_), .O(z15));
  aoi21  g100(.a(x18), .b(x00), .c(new_n56_), .O(z16));
  nand2  g101(.a(new_n100_), .b(new_n57_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n134_), .O(z17));
endmodule
