...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n143_, new_n144_, new_n146_, new_n147_, new_n149_;
  ...
  aoi21  g031(.a(new_n74_), .b(x05), .c(new_n73_), .O(z05));
  nor2   g032(.a(new_n68_), .b(new_n57_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n47_), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x05), .c(new_n73_), .O(z06));
  ...
  nand2  g041(.a(new_n84_), .b(new_n82_), .O(z07));
  inv1   g042(.a(x00), .O(new_n86_));
  nand2  g043(.a(x02), .b(new_n86_), .O(new_n87_));
  ...
  nand2  g049(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi21  g050(.a(new_n93_), .b(new_n73_), .c(x05), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n68_), .c(x02), .d(new_n73_), .O(new_n97_));
  ...
  nand3  g060(.a(new_n103_), .b(new_n102_), .c(new_n64_), .O(new_n104_));
  oai21  g061(.a(new_n101_), .b(new_n97_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n86_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n84_), .O(z09));
  nand3  g064(.a(new_n64_), .b(x18), .c(x01), .O(new_n108_));
  ...
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n68_), .O(new_n113_));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n84_), .O(z10));
  nor2   g077(.a(new_n46_), .b(x01), .O(new_n121_));
  nor2   g078(.a(x13), .b(new_n79_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n68_), .O(new_n123_));
  nand4  g080(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n64_), .O(new_n124_));
  nor2   g081(.a(new_n98_), .b(x14), .O(new_n125_));
  nor2   g082(.a(x21), .b(new_n102_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n125_), .c(new_n99_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n123_), .c(new_n124_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n96_), .c(new_n86_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n84_), .O(z11));
  ...
  nand3  g091(.a(new_n64_), .b(x17), .c(new_n46_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n73_), .c(new_n86_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n131_), .c(x09), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n84_), .O(z12));
  inv1   g097(.a(new_n48_), .O(new_n141_));
  oai21  g098(.a(new_n135_), .b(new_n141_), .c(new_n84_), .O(z13));
  nand3  g099(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n143_));
  nand4  g100(.a(new_n64_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n143_), .c(new_n84_), .O(z14));
  aoi22  g102(.a(new_n84_), .b(x00), .c(x19), .d(new_n73_), .O(new_n146_));
  nand4  g103(.a(new_n57_), .b(x05), .c(x01), .d(x00), .O(new_n147_));
  oai21  g104(.a(new_n146_), .b(x02), .c(new_n147_), .O(z15));
  nand3  g105(.a(x05), .b(x01), .c(new_n86_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  oai21  g107(.a(new_n111_), .b(x00), .c(new_n84_), .O(z17));
endmodule
