...
module FAU ( 
  ...
  nor2   g009(.a(x09), .b(x08), .O(new_n53_));
  ...
  nand4  g020(.a(x12), .b(x11), .c(x10), .d(x08), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(x08), .O(new_n65_));
  nand2  g022(.a(new_n65_), .b(new_n62_), .O(new_n66_));
  ...
  nand4  g027(.a(x08), .b(x02), .c(x01), .d(x00), .O(new_n71_));
  inv1   g028(.a(new_n71_), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n70_), .c(x10), .d(new_n62_), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(x12), .O(z04));
  nand2  g031(.a(x01), .b(x00), .O(new_n75_));
  nand3  g032(.a(x10), .b(x09), .c(x02), .O(new_n76_));
  oai21  g033(.a(new_n76_), .b(new_n75_), .c(new_n54_), .O(z05));
  nor3   g034(.a(new_n70_), .b(new_n59_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x08), .c(x02), .d(x01), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(new_n46_), .O(z06));
  nand3  g037(.a(new_n62_), .b(x08), .c(x01), .O(new_n81_));
  inv1   g038(.a(x12), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x11), .c(x10), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n81_), .c(new_n53_), .d(x01), .O(new_n84_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n45_), .c(x17), .d(x09), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(new_n56_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nand2  g056(.a(x02), .b(new_n47_), .O(new_n100_));
  ...
  nor2   g064(.a(new_n45_), .b(new_n47_), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(new_n107_), .c(new_n56_), .O(new_n109_));
  ...
  nand2  g068(.a(new_n111_), .b(new_n54_), .O(z09));
  nand3  g069(.a(new_n56_), .b(x18), .c(x01), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n82_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n101_), .c(new_n70_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nand3  g074(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n118_));
  nor4   g075(.a(new_n118_), .b(new_n104_), .c(new_n103_), .d(x14), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n117_), .c(new_n114_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n54_), .O(z10));
  nand4  g078(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n56_), .O(new_n122_));
  ...
  nor2   g093(.a(new_n53_), .b(x19), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  nand4  g096(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n140_));
  ...
  oai21  g102(.a(new_n47_), .b(x00), .c(new_n54_), .O(z16));
  nor4   g103(.a(new_n53_), .b(new_n48_), .c(x01), .d(x00), .O(z17));
endmodule
