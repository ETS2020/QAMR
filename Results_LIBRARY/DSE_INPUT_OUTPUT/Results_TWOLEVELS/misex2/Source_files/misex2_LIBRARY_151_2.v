...
module FAU ( 
  ...
  nor2   g55(.a(new_n51_), .b(new_n60_), .O(new_n99_));
  ...
  nand4  g63(.a(new_n92_), .b(new_n106_), .c(x12), .d(new_n69_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n65_), .O(new_n112_));
  ...
  nand3  g77(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n121_));
  ...
  nand3  g83(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n127_));
  ...
  nand3  g87(.a(new_n52_), .b(x19), .c(new_n45_), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n119_), .O(z15));
  xor2a  g89(.a(x01), .b(x00), .O(z16));
  nand2  g90(.a(new_n52_), .b(x02), .O(new_n134_));
