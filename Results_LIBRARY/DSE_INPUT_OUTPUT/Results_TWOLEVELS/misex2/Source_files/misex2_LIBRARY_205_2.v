...
module FAU ( 
  ...
  nand4  g29(.a(x11), .b(x10), .c(new_n47_), .d(x02), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n61_), .c(new_n60_), .O(z06));
  inv1   g31(.a(x11), .O(new_n75_));
  nor3   g32(.a(new_n70_), .b(x12), .c(new_n75_), .O(z07));
  nor2   g33(.a(x03), .b(new_n46_), .O(new_n77_));
  ...
  aoi21  g41(.a(new_n84_), .b(new_n60_), .c(x01), .O(z08));
  inv1   g42(.a(x21), .O(new_n86_));
  inv1   g43(.a(x22), .O(new_n87_));
  nand4  g44(.a(x12), .b(new_n75_), .c(x02), .d(new_n61_), .O(new_n88_));
  ...
  nand4  g52(.a(new_n95_), .b(new_n87_), .c(new_n86_), .d(new_n60_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nor3   g54(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n63_), .c(x18), .d(x01), .O(new_n99_));
  nor2   g56(.a(new_n46_), .b(x01), .O(new_n100_));
  inv1   g57(.a(x13), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(x12), .c(new_n75_), .O(new_n102_));
  ...
  nand4  g66(.a(new_n91_), .b(x12), .c(new_n75_), .d(x02), .O(new_n110_));
  nand4  g67(.a(new_n105_), .b(x20), .c(new_n90_), .d(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n110_), .c(new_n60_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n61_), .O(new_n113_));
  nor3   g70(.a(new_n45_), .b(new_n61_), .c(x00), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n93_), .c(new_n87_), .d(x21), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n113_), .O(z11));
  inv1   g73(.a(x24), .O(new_n117_));
  aoi21  g74(.a(x10), .b(x02), .c(new_n60_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n63_), .b(x17), .c(new_n46_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x01), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  nand2  g79(.a(new_n61_), .b(x00), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n47_), .c(new_n123_), .O(z12));
  aoi21  g81(.a(new_n120_), .b(new_n60_), .c(x01), .O(z13));
  nand4  g82(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n126_));
  ...
  nor2   g88(.a(new_n61_), .b(x00), .O(z16));
