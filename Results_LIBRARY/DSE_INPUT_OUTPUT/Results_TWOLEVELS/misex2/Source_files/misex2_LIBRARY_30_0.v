...
module FAU ( 
  ...
  oai21  g030(.a(new_n73_), .b(new_n64_), .c(new_n53_), .O(z04));
  ...
  nor3   g035(.a(new_n63_), .b(new_n71_), .c(new_n47_), .O(new_n79_));
  ...
  nor2   g042(.a(x01), .b(x00), .O(new_n86_));
  inv1   g043(.a(new_n86_), .O(new_n87_));
  inv1   g044(.a(x03), .O(new_n88_));
  nand3  g045(.a(x04), .b(new_n88_), .c(x02), .O(new_n89_));
  ...
  aoi21  g050(.a(new_n93_), .b(x16), .c(x05), .O(z08));
  ...
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n52_), .d(new_n99_), .O(new_n101_));
  ...
  oai21  g061(.a(new_n101_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n75_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n53_), .O(z09));
  nand3  g064(.a(new_n53_), .b(x22), .c(x21), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(x20), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n50_), .c(x18), .d(x01), .O(new_n110_));
  ...
  nor3   g071(.a(new_n52_), .b(new_n99_), .c(x14), .O(new_n115_));
  ...
  nand4  g075(.a(new_n97_), .b(new_n112_), .c(x12), .d(new_n71_), .O(new_n119_));
  nand4  g076(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x20), .d(new_n52_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n119_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n75_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n75_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n126_), .c(x09), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n53_), .O(z12));
  oai21  g092(.a(new_n130_), .b(new_n87_), .c(new_n53_), .O(z13));
  nand4  g093(.a(new_n60_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n137_));
  ...
  oai21  g100(.a(new_n111_), .b(x00), .c(new_n53_), .O(z17));
endmodule
