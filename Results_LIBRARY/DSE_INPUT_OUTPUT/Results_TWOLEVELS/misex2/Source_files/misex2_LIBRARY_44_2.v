...
module FAU ( 
  ...
  aoi21  g34(.a(new_n77_), .b(x01), .c(new_n53_), .O(z07));
  inv1   g35(.a(x08), .O(new_n79_));
  inv1   g36(.a(x05), .O(new_n80_));
  inv1   g37(.a(x06), .O(new_n81_));
  inv1   g38(.a(x03), .O(new_n82_));
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n60_), .d(new_n53_), .O(new_n83_));
  ...
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n69_), .d(x02), .O(new_n90_));
  ...
  oai21  g53(.a(new_n96_), .b(new_n90_), .c(new_n53_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n60_), .O(new_n98_));
  nor3   g55(.a(new_n45_), .b(new_n60_), .c(x00), .O(new_n99_));
  ...
  nor4   g63(.a(new_n106_), .b(x13), .c(new_n70_), .d(x11), .O(new_n107_));
  nor3   g64(.a(new_n92_), .b(new_n91_), .c(x14), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n107_), .c(new_n95_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x00), .O(z10));
  nand3  g67(.a(new_n95_), .b(new_n92_), .c(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n90_), .c(new_n53_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n60_), .O(new_n113_));
  inv1   g70(.a(x22), .O(new_n114_));
  nand4  g71(.a(new_n100_), .b(new_n99_), .c(new_n114_), .d(x21), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n113_), .O(z11));
  inv1   g73(.a(x24), .O(new_n117_));
  aoi21  g74(.a(x10), .b(x02), .c(new_n53_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x01), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  oai22  g79(.a(new_n122_), .b(new_n47_), .c(x01), .d(new_n53_), .O(z12));
  aoi21  g80(.a(new_n120_), .b(new_n53_), .c(x01), .O(z13));
  nand4  g81(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n125_));
