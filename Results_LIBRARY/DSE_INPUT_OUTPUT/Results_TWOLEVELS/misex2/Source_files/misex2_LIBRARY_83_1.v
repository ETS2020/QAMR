...
module FAU ( 
  ...
  nand2  g033(.a(x24), .b(new_n54_), .O(new_n77_));
  nand3  g034(.a(x10), .b(x09), .c(x02), .O(new_n78_));
  oai21  g035(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(z05));
  nand4  g036(.a(x11), .b(x10), .c(new_n68_), .d(x02), .O(new_n80_));
  nor3   g037(.a(new_n80_), .b(new_n54_), .c(new_n53_), .O(z06));
  ...
  nor2   g057(.a(x13), .b(new_n82_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(new_n102_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n77_), .O(z10));
  ...
  nand2  g085(.a(new_n128_), .b(new_n77_), .O(z11));
  ...
  oai21  g093(.a(new_n136_), .b(new_n68_), .c(new_n77_), .O(z12));
  ...
  nand4  g103(.a(new_n44_), .b(x02), .c(new_n54_), .d(new_n53_), .O(new_n147_));
