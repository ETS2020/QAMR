...
module FAU ( 
  ...
  nor2   g012(.a(x19), .b(x17), .O(new_n56_));
  nand4  g013(.a(new_n56_), .b(new_n55_), .c(x10), .d(x09), .O(new_n57_));
  aoi21  g014(.a(new_n57_), .b(new_n44_), .c(x18), .O(z01));
  ...
  nand2  g019(.a(new_n46_), .b(x14), .O(new_n63_));
  inv1   g020(.a(x19), .O(new_n64_));
  nand4  g021(.a(new_n55_), .b(new_n64_), .c(x18), .d(new_n45_), .O(new_n65_));
  ...
  nand4  g037(.a(new_n63_), .b(x11), .c(x10), .d(new_n49_), .O(new_n81_));
  nor4   g038(.a(new_n81_), .b(new_n48_), .c(new_n80_), .d(new_n75_), .O(z06));
  ...
  nand2  g042(.a(new_n85_), .b(new_n63_), .O(z07));
  ...
  nor3   g047(.a(new_n64_), .b(new_n45_), .c(x08), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n50_), .O(new_n92_));
  aoi21  g049(.a(new_n92_), .b(new_n44_), .c(x18), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n71_), .c(x02), .d(new_n80_), .O(new_n96_));
  ...
  nand2  g066(.a(x02), .b(new_n80_), .O(new_n110_));
  ...
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n71_), .O(new_n121_));
  nand4  g078(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n64_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n95_), .c(new_n75_), .O(new_n127_));
  ...
  nand3  g089(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n80_), .c(new_n75_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n129_), .c(x09), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n63_), .O(z12));
  nor2   g095(.a(new_n76_), .b(x19), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(x17), .c(new_n48_), .d(new_n80_), .O(new_n140_));
  ...
  oai21  g101(.a(x10), .b(new_n80_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n48_), .c(new_n80_), .O(new_n147_));
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n76_), .O(z15));
  nor3   g105(.a(new_n76_), .b(new_n80_), .c(x00), .O(z16));
  oai21  g106(.a(new_n110_), .b(x00), .c(new_n63_), .O(z17));
endmodule
