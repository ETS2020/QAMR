...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(new_n44_), .O(z04));
  ...
  nand3  g20(.a(new_n47_), .b(new_n63_), .c(new_n44_), .O(new_n64_));
  inv1   g21(.a(x19), .O(new_n65_));
  nand3  g22(.a(new_n65_), .b(x18), .c(new_n51_), .O(new_n66_));
  nand3  g23(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g24(.a(x12), .b(x11), .c(x10), .d(new_n48_), .O(new_n68_));
  oai22  g25(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(new_n64_), .O(z03));
  nand4  g26(.a(x10), .b(x09), .c(x02), .d(x01), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(x11), .c(new_n44_), .O(z05));
  inv1   g28(.a(x11), .O(new_n72_));
  aoi21  g29(.a(x12), .b(new_n72_), .c(new_n60_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(new_n48_), .c(x02), .d(x01), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x11), .c(new_n44_), .O(z06));
  inv1   g32(.a(x12), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(x10), .O(new_n77_));
  oai21  g34(.a(new_n77_), .b(x09), .c(x01), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(x02), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(x11), .c(new_n44_), .O(z07));
  inv1   g37(.a(x08), .O(new_n81_));
  inv1   g38(.a(x05), .O(new_n82_));
  inv1   g39(.a(x06), .O(new_n83_));
  inv1   g40(.a(x03), .O(new_n84_));
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n63_), .d(new_n44_), .O(new_n85_));
  ...
  nand4  g45(.a(new_n88_), .b(new_n55_), .c(x17), .d(new_n81_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n65_), .O(z08));
  inv1   g47(.a(x21), .O(new_n91_));
  inv1   g48(.a(x22), .O(new_n92_));
  nor2   g49(.a(new_n47_), .b(x01), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(x12), .c(new_n72_), .O(new_n94_));
  ...
  nand4  g69(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n65_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n92_), .c(new_n44_), .O(new_n117_));
  ...
  nand3  g78(.a(new_n65_), .b(x17), .c(new_n47_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g80(.a(new_n123_), .b(new_n63_), .c(new_n44_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n120_), .c(x24), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(x09), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n46_), .O(z12));
  nand3  g84(.a(new_n49_), .b(x17), .c(new_n47_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z13));
  nand3  g86(.a(new_n52_), .b(new_n51_), .c(new_n60_), .O(new_n130_));
  oai21  g87(.a(new_n130_), .b(new_n50_), .c(new_n46_), .O(z14));
  oai21  g88(.a(x10), .b(new_n63_), .c(x02), .O(new_n132_));
  nand3  g89(.a(new_n132_), .b(x11), .c(x00), .O(new_n133_));
  nand3  g90(.a(new_n49_), .b(x19), .c(new_n47_), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(new_n133_), .O(z15));
  nor2   g92(.a(new_n63_), .b(x00), .O(z16));
  nand2  g93(.a(new_n93_), .b(new_n44_), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(new_n46_), .O(z17));
endmodule
