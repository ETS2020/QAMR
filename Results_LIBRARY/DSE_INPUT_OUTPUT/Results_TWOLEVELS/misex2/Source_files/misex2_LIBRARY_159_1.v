...
module FAU ( 
  ...
  nand2  g33(.a(new_n46_), .b(x02), .O(new_n77_));
  inv1   g34(.a(x12), .O(new_n78_));
  nand3  g35(.a(new_n78_), .b(x11), .c(x10), .O(new_n79_));
  oai21  g36(.a(new_n79_), .b(new_n77_), .c(x00), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(x01), .O(new_n81_));
  nand3  g38(.a(x02), .b(new_n44_), .c(x00), .O(new_n82_));
  ...
  nand4  g58(.a(new_n99_), .b(new_n95_), .c(x16), .d(x15), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n44_), .c(x00), .O(z10));
  nand4  g60(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n93_), .c(new_n92_), .d(x12), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n96_), .c(x20), .d(new_n91_), .O(new_n108_));
  ...
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n60_), .c(new_n126_), .O(z15));
  nor2   g84(.a(new_n44_), .b(x00), .O(z16));
  nand3  g85(.a(x02), .b(new_n44_), .c(new_n60_), .O(new_n129_));
