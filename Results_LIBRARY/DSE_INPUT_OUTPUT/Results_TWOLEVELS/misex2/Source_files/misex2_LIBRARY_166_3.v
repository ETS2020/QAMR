...
module FAU ( 
  ...
  nand2  g013(.a(x17), .b(x01), .O(new_n57_));
  ...
  nand4  g024(.a(new_n67_), .b(new_n60_), .c(x18), .d(new_n44_), .O(new_n68_));
  ...
  nor2   g031(.a(new_n74_), .b(x17), .O(z04));
  nor4   g032(.a(new_n72_), .b(x17), .c(new_n59_), .d(new_n47_), .O(z05));
  inv1   g033(.a(x01), .O(new_n77_));
  nor2   g034(.a(new_n70_), .b(new_n59_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n47_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(new_n44_), .c(new_n77_), .O(z06));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n77_), .d(new_n88_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n104_), .b(x18), .c(new_n44_), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n88_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nor2   g065(.a(new_n45_), .b(x17), .O(new_n109_));
  ...
  nand4  g075(.a(new_n118_), .b(new_n60_), .c(x18), .d(x01), .O(new_n119_));
  ...
  nand2  g080(.a(new_n123_), .b(new_n57_), .O(z11));
  nand2  g081(.a(x10), .b(x02), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n44_), .c(x01), .d(x00), .O(new_n126_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n77_), .c(new_n88_), .O(new_n130_));
  aoi21  g087(.a(new_n130_), .b(new_n126_), .c(x24), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(x09), .O(new_n132_));
  inv1   g089(.a(new_n132_), .O(z12));
  nand3  g090(.a(new_n60_), .b(new_n46_), .c(new_n88_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n77_), .c(new_n44_), .O(z13));
  ...
  nand2  g095(.a(x01), .b(x00), .O(new_n139_));
  aoi22  g096(.a(new_n57_), .b(x00), .c(x19), .d(new_n77_), .O(new_n140_));
  oai22  g097(.a(new_n140_), .b(x02), .c(new_n139_), .d(new_n138_), .O(z15));
  nand3  g098(.a(new_n44_), .b(x01), .c(new_n88_), .O(new_n142_));
  inv1   g099(.a(new_n142_), .O(z16));
  nand2  g100(.a(new_n98_), .b(new_n88_), .O(new_n144_));
