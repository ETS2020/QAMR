...
module FAU ( 
  ...
  aoi21  g029(.a(new_n72_), .b(x21), .c(new_n64_), .O(z04));
  nand4  g030(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n44_), .c(new_n60_), .O(z05));
  nand2  g032(.a(new_n44_), .b(x12), .O(new_n76_));
  ...
  aoi21  g036(.a(new_n79_), .b(x21), .c(new_n64_), .O(z06));
  ...
  nor3   g055(.a(new_n98_), .b(new_n46_), .c(x00), .O(new_n99_));
  ...
  aoi21  g061(.a(new_n104_), .b(new_n64_), .c(x21), .O(z09));
  inv1   g062(.a(x20), .O(new_n106_));
  nand3  g063(.a(x22), .b(new_n106_), .c(new_n52_), .O(new_n107_));
  nor3   g064(.a(new_n107_), .b(new_n51_), .c(new_n64_), .O(new_n108_));
  inv1   g065(.a(x14), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(new_n97_), .c(x12), .O(new_n110_));
  nor3   g067(.a(new_n110_), .b(x11), .c(new_n46_), .O(new_n111_));
  inv1   g068(.a(x15), .O(new_n112_));
  nand3  g069(.a(new_n101_), .b(new_n44_), .c(x20), .O(new_n113_));
  nor3   g070(.a(new_n113_), .b(new_n100_), .c(new_n112_), .O(new_n114_));
  aoi21  g071(.a(new_n114_), .b(new_n111_), .c(new_n108_), .O(new_n115_));
  oai21  g072(.a(new_n115_), .b(x00), .c(new_n45_), .O(z10));
  nand4  g073(.a(new_n106_), .b(new_n52_), .c(x18), .d(x01), .O(new_n117_));
  nand4  g074(.a(new_n97_), .b(x12), .c(new_n96_), .d(x02), .O(new_n118_));
  nor2   g075(.a(new_n112_), .b(x14), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n44_), .c(x20), .d(new_n100_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n101_), .c(new_n63_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n45_), .O(z11));
  nand2  g080(.a(x10), .b(x02), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(x01), .d(x00), .O(new_n125_));
  ...
  oai21  g095(.a(x10), .b(new_n64_), .c(x02), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x00), .O(new_n140_));
  nand3  g097(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n140_), .c(new_n45_), .O(z15));
  nand3  g099(.a(x21), .b(x01), .c(new_n63_), .O(new_n143_));
