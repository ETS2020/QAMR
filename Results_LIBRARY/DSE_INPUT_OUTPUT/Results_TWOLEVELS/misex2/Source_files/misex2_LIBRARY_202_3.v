...
module FAU ( 
  ...
  nand2  g014(.a(new_n57_), .b(x09), .O(new_n58_));
  inv1   g015(.a(new_n58_), .O(new_n59_));
  nand4  g016(.a(new_n59_), .b(new_n50_), .c(new_n49_), .d(new_n56_), .O(new_n60_));
  ...
  nand2  g034(.a(new_n72_), .b(x05), .O(new_n78_));
  ...
  nand2  g039(.a(new_n46_), .b(new_n62_), .O(new_n83_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n70_), .d(new_n90_), .O(new_n92_));
  inv1   g049(.a(new_n92_), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n89_), .c(new_n62_), .d(x04), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(x07), .O(new_n95_));
  nand4  g052(.a(new_n95_), .b(new_n50_), .c(x17), .d(new_n88_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(new_n51_), .O(z08));
  ...
  nand4  g063(.a(new_n106_), .b(x18), .c(new_n62_), .d(x01), .O(new_n107_));
  oai21  g064(.a(new_n105_), .b(new_n101_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n90_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(z09));
  nand3  g067(.a(new_n51_), .b(x18), .c(x01), .O(new_n111_));
  ...
  nor2   g081(.a(new_n50_), .b(new_n70_), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(x21), .c(new_n112_), .d(new_n51_), .O(new_n126_));
  nor2   g083(.a(new_n102_), .b(x14), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n118_), .c(new_n126_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n99_), .c(new_n90_), .O(new_n130_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n70_), .c(new_n90_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n57_), .b(x17), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z13));
  nand2  g099(.a(new_n57_), .b(new_n46_), .O(new_n143_));
  inv1   g100(.a(new_n143_), .O(new_n144_));
  nand4  g101(.a(new_n144_), .b(new_n50_), .c(new_n49_), .d(new_n56_), .O(new_n145_));
  nor2   g102(.a(new_n145_), .b(x19), .O(z14));
  oai21  g103(.a(x10), .b(new_n70_), .c(x02), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(x00), .O(new_n148_));
  nand3  g105(.a(x19), .b(new_n45_), .c(new_n70_), .O(new_n149_));
  nand3  g106(.a(new_n149_), .b(new_n148_), .c(new_n44_), .O(z15));
  nand3  g107(.a(new_n62_), .b(x01), .c(new_n90_), .O(new_n151_));
  inv1   g108(.a(new_n151_), .O(z16));
  nand2  g109(.a(new_n100_), .b(new_n90_), .O(new_n153_));
  nand2  g110(.a(new_n153_), .b(new_n44_), .O(z17));
endmodule
