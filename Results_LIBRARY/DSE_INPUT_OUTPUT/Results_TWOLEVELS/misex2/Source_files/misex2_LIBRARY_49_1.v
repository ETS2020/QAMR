...
module FAU ( 
  ...
  inv1   g045(.a(x20), .O(new_n89_));
  inv1   g046(.a(new_n57_), .O(new_n90_));
  ...
  aoi21  g053(.a(new_n96_), .b(new_n89_), .c(x05), .O(z08));
  ...
  nand3  g062(.a(new_n105_), .b(new_n89_), .c(new_n50_), .O(new_n106_));
  ...
  nand3  g067(.a(x22), .b(x21), .c(new_n89_), .O(new_n111_));
  ...
  nand4  g079(.a(new_n105_), .b(x21), .c(new_n89_), .d(new_n50_), .O(new_n123_));
  nand3  g080(.a(x12), .b(new_n69_), .c(x05), .O(new_n124_));
  nor2   g081(.a(new_n124_), .b(new_n113_), .O(new_n125_));
  nand3  g082(.a(x15), .b(new_n117_), .c(new_n114_), .O(new_n126_));
  nand3  g083(.a(new_n98_), .b(x20), .c(new_n102_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n99_), .c(new_n74_), .O(new_n131_));
  ...
  oai21  g099(.a(new_n137_), .b(new_n90_), .c(new_n52_), .O(z13));
  ...
  nand3  g107(.a(new_n150_), .b(new_n149_), .c(new_n52_), .O(z15));
  nand2  g108(.a(new_n52_), .b(x01), .O(new_n152_));
  nor2   g109(.a(new_n152_), .b(x00), .O(z16));
  nand4  g110(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n74_), .O(new_n154_));
