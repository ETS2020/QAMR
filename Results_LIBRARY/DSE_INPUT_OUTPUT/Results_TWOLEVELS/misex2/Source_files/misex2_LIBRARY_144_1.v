...
module FAU ( 
  ...
  nand4  g18(.a(new_n61_), .b(x18), .c(new_n53_), .d(new_n45_), .O(new_n62_));
  ...
  nor3   g29(.a(new_n69_), .b(new_n52_), .c(new_n46_), .O(z05));
  ...
  nand4  g52(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n96_));
  ...
  oai22  g74(.a(new_n117_), .b(new_n46_), .c(new_n44_), .d(x00), .O(z12));
  nand2  g75(.a(new_n55_), .b(x17), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(x19), .O(z13));
  nand2  g77(.a(new_n55_), .b(new_n46_), .O(new_n121_));
  inv1   g78(.a(new_n121_), .O(new_n122_));
  nand4  g79(.a(new_n122_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z14));
  aoi21  g81(.a(new_n52_), .b(x01), .c(new_n45_), .O(new_n125_));
