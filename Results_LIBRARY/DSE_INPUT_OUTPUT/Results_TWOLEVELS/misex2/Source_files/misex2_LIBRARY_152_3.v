...
module FAU ( 
  ...
  inv1   g017(.a(x11), .O(new_n61_));
  inv1   g018(.a(x12), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand4  g020(.a(new_n63_), .b(new_n60_), .c(x10), .d(new_n46_), .O(new_n64_));
  inv1   g021(.a(x02), .O(new_n65_));
  nor2   g022(.a(x01), .b(x00), .O(new_n66_));
  nand4  g023(.a(new_n66_), .b(x18), .c(new_n44_), .d(new_n65_), .O(new_n67_));
  aoi21  g024(.a(new_n67_), .b(new_n64_), .c(x19), .O(z03));
  inv1   g025(.a(x01), .O(new_n69_));
  inv1   g026(.a(x19), .O(new_n70_));
  nor2   g027(.a(x09), .b(new_n65_), .O(new_n71_));
  nor2   g028(.a(x12), .b(x11), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(new_n70_), .c(new_n69_), .O(z04));
  nand4  g031(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n75_));
  nor3   g032(.a(new_n75_), .b(x19), .c(new_n56_), .O(z05));
  nand2  g033(.a(x19), .b(x12), .O(new_n77_));
  ...
  aoi21  g037(.a(new_n80_), .b(new_n70_), .c(new_n69_), .O(z06));
  nand3  g038(.a(new_n62_), .b(x11), .c(x10), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(x09), .c(x01), .O(new_n83_));
  nand3  g040(.a(new_n83_), .b(x02), .c(x00), .O(new_n84_));
  nand2  g041(.a(x19), .b(x01), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n84_), .O(z07));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n69_), .d(new_n90_), .O(new_n92_));
  ...
  nor2   g053(.a(new_n96_), .b(new_n70_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nor2   g056(.a(new_n65_), .b(x01), .O(new_n100_));
  nand3  g057(.a(new_n100_), .b(x12), .c(new_n61_), .O(new_n101_));
  ...
  nor2   g063(.a(new_n45_), .b(new_n69_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n106_), .c(new_n70_), .O(new_n108_));
  oai21  g065(.a(new_n105_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n90_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(z09));
  nor3   g068(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n112_));
  inv1   g069(.a(x13), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n61_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nand2  g072(.a(new_n115_), .b(new_n100_), .O(new_n116_));
  ...
  aoi22  g077(.a(new_n120_), .b(new_n117_), .c(new_n112_), .d(new_n107_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n85_), .O(z10));
  nand3  g079(.a(new_n107_), .b(x21), .c(new_n106_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n99_), .c(new_n90_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n85_), .O(z11));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(x01), .c(x00), .O(new_n130_));
  nand3  g087(.a(new_n66_), .b(x17), .c(new_n65_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n130_), .c(x19), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(x23), .O(new_n133_));
  nor3   g090(.a(new_n133_), .b(x01), .c(x00), .O(new_n134_));
  nor2   g091(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nor3   g092(.a(new_n135_), .b(x24), .c(new_n46_), .O(z12));
  nand2  g093(.a(new_n47_), .b(x17), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x19), .O(z13));
  nand4  g095(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z14));
  oai21  g097(.a(x10), .b(new_n69_), .c(x02), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n70_), .c(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n65_), .c(new_n69_), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n142_), .O(z15));
  aoi21  g101(.a(new_n70_), .b(x00), .c(new_n69_), .O(z16));
  nand2  g102(.a(new_n66_), .b(x02), .O(new_n146_));
