...
module FAU ( 
  ...
  nand2  g007(.a(x16), .b(x06), .O(new_n51_));
  ...
  nand4  g055(.a(x12), .b(new_n65_), .c(x02), .d(new_n44_), .O(new_n99_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n58_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n51_), .O(z09));
  nand4  g066(.a(new_n51_), .b(x22), .c(x21), .d(new_n104_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n50_), .c(x18), .d(x01), .O(new_n112_));
  inv1   g069(.a(x06), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(x02), .c(new_n44_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n66_), .O(new_n116_));
  nand2  g073(.a(new_n116_), .b(new_n65_), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(new_n118_));
  nor3   g075(.a(new_n101_), .b(new_n100_), .c(x14), .O(new_n119_));
  ...
  aoi21  g079(.a(new_n122_), .b(new_n112_), .c(x00), .O(z10));
  nand4  g080(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n50_), .O(new_n124_));
  nand3  g081(.a(new_n116_), .b(new_n87_), .c(new_n65_), .O(new_n125_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n98_), .c(new_n58_), .O(new_n130_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n44_), .c(new_n58_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n132_), .c(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n51_), .O(z12));
  nand2  g098(.a(new_n44_), .b(new_n58_), .O(new_n142_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n51_), .O(z13));
  ...
  nand3  g106(.a(new_n149_), .b(new_n148_), .c(new_n51_), .O(z15));
  nand3  g107(.a(new_n51_), .b(x01), .c(new_n58_), .O(new_n151_));
  inv1   g108(.a(new_n151_), .O(z16));
  nand2  g109(.a(new_n88_), .b(new_n51_), .O(z17));
endmodule
