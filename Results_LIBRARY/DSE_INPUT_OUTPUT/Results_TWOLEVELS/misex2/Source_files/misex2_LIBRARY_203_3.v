...
module FAU ( 
  ...
  nand2  g009(.a(x06), .b(x01), .O(new_n53_));
  ...
  nor2   g030(.a(new_n73_), .b(x06), .O(new_n74_));
  ...
  aoi21  g034(.a(new_n77_), .b(new_n68_), .c(new_n64_), .O(z05));
  nor3   g035(.a(new_n72_), .b(new_n58_), .c(x09), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n68_), .c(x02), .d(x00), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(new_n68_), .c(new_n64_), .O(z06));
  nand2  g038(.a(new_n47_), .b(new_n68_), .O(new_n82_));
  ...
  nand4  g056(.a(x12), .b(new_n72_), .c(x02), .d(new_n64_), .O(new_n100_));
  ...
  nand4  g062(.a(new_n105_), .b(x18), .c(new_n68_), .d(x01), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n63_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nand3  g066(.a(new_n66_), .b(x18), .c(x01), .O(new_n110_));
  inv1   g067(.a(x20), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n111_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g070(.a(x02), .b(new_n64_), .O(new_n114_));
  ...
  nor2   g080(.a(x13), .b(new_n83_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n88_), .c(new_n72_), .O(new_n125_));
  and2   g082(.a(x18), .b(x01), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(x21), .c(new_n111_), .d(new_n66_), .O(new_n127_));
  nor2   g084(.a(new_n101_), .b(x14), .O(new_n128_));
  nor2   g085(.a(x21), .b(new_n111_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n128_), .c(new_n102_), .O(new_n130_));
  oai21  g087(.a(new_n130_), .b(new_n125_), .c(new_n127_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n99_), .c(new_n63_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n53_), .O(z11));
  ...
  nand3  g094(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n64_), .c(new_n63_), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n134_), .c(x09), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(new_n53_), .O(z12));
  inv1   g100(.a(new_n48_), .O(new_n144_));
  oai21  g101(.a(new_n138_), .b(new_n144_), .c(new_n53_), .O(z13));
  nor2   g102(.a(x09), .b(x02), .O(new_n146_));
  nor2   g103(.a(x17), .b(x10), .O(new_n147_));
  nand4  g104(.a(new_n147_), .b(new_n146_), .c(new_n55_), .d(new_n48_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n53_), .O(z14));
  oai21  g106(.a(x10), .b(new_n64_), .c(x02), .O(new_n150_));
  nand2  g107(.a(new_n150_), .b(x00), .O(new_n151_));
  nand3  g108(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n152_));
  nand3  g109(.a(new_n152_), .b(new_n151_), .c(new_n53_), .O(z15));
  aoi21  g110(.a(new_n68_), .b(x00), .c(new_n64_), .O(z16));
  nand2  g111(.a(new_n89_), .b(new_n53_), .O(z17));
endmodule
