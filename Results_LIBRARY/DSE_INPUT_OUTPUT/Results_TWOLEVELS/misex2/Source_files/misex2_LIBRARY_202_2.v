...
module FAU ( 
  ...
  nand2  g015(.a(new_n58_), .b(x09), .O(new_n59_));
  inv1   g016(.a(new_n59_), .O(new_n60_));
  nand4  g017(.a(new_n60_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n61_));
  ...
  aoi21  g031(.a(new_n74_), .b(x05), .c(new_n70_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x05), .c(new_n70_), .O(z05));
  oai21  g034(.a(x12), .b(x05), .c(x11), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n57_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n47_), .c(x02), .d(x00), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(x05), .c(new_n70_), .O(z06));
  nand2  g038(.a(new_n47_), .b(x05), .O(new_n82_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n70_), .d(new_n89_), .O(new_n91_));
  inv1   g048(.a(new_n91_), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n88_), .c(new_n44_), .d(x04), .O(new_n93_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n89_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nand3  g066(.a(new_n52_), .b(x18), .c(x01), .O(new_n110_));
  ...
  nor2   g080(.a(new_n51_), .b(new_n70_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n111_), .d(new_n52_), .O(new_n125_));
  nor2   g082(.a(new_n101_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n97_), .c(x20), .d(new_n102_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n117_), .c(new_n125_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n98_), .c(new_n89_), .O(new_n129_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n70_), .c(new_n89_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n58_), .b(x17), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z13));
  nand2  g098(.a(new_n58_), .b(new_n47_), .O(new_n142_));
  inv1   g099(.a(new_n142_), .O(new_n143_));
  nand4  g100(.a(new_n143_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n144_));
  nor2   g101(.a(new_n144_), .b(x19), .O(z14));
  oai21  g102(.a(x10), .b(new_n70_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n46_), .c(new_n70_), .O(new_n148_));
  nand3  g105(.a(new_n148_), .b(new_n147_), .c(new_n45_), .O(z15));
  nand3  g106(.a(x05), .b(x01), .c(new_n89_), .O(new_n150_));
  inv1   g107(.a(new_n150_), .O(z16));
  nand2  g108(.a(new_n99_), .b(new_n89_), .O(new_n152_));
  nand2  g109(.a(new_n152_), .b(new_n45_), .O(z17));
endmodule
