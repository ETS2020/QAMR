...
module FAU ( 
  ...
  aoi21  g21(.a(new_n64_), .b(x00), .c(new_n44_), .O(z04));
  nand3  g22(.a(x10), .b(x09), .c(x02), .O(new_n66_));
  aoi21  g23(.a(new_n66_), .b(x00), .c(new_n44_), .O(z05));
  nand4  g24(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n68_));
  aoi21  g25(.a(new_n68_), .b(x00), .c(new_n44_), .O(z06));
  ...
  nand4  g36(.a(new_n79_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n80_));
  ...
  nor2   g41(.a(new_n84_), .b(new_n58_), .O(z08));
  ...
  nand4  g57(.a(new_n100_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n89_), .c(new_n88_), .d(x12), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n86_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n92_), .c(x20), .d(new_n87_), .O(new_n105_));
  ...
  nand3  g68(.a(new_n111_), .b(new_n44_), .c(new_n55_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n76_), .c(new_n57_), .d(new_n52_), .O(new_n119_));
  ...
  nand3  g81(.a(x02), .b(new_n44_), .c(new_n55_), .O(new_n125_));
