...
module FAU ( 
  ...
  nand2  g007(.a(x08), .b(x07), .O(new_n51_));
  ...
  nor3   g031(.a(new_n74_), .b(new_n44_), .c(new_n58_), .O(z05));
  nand3  g032(.a(x12), .b(x08), .c(x07), .O(new_n76_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n94_), .c(new_n93_), .d(new_n58_), .O(new_n104_));
  ...
  nand4  g077(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n50_), .O(new_n121_));
  ...
  nand4  g082(.a(new_n125_), .b(new_n51_), .c(new_n94_), .d(new_n58_), .O(new_n126_));
