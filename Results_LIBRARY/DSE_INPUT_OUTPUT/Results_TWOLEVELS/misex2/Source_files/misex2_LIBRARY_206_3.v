...
module FAU ( 
  ...
  inv1   g017(.a(x23), .O(new_n61_));
  nand3  g018(.a(new_n46_), .b(x02), .c(x00), .O(new_n62_));
  nand4  g019(.a(new_n61_), .b(x12), .c(x11), .d(x10), .O(new_n63_));
  ...
  nor4   g030(.a(x09), .b(new_n45_), .c(new_n73_), .d(new_n72_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n71_), .c(new_n70_), .d(x10), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(x23), .O(z04));
  nand4  g033(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n61_), .c(new_n73_), .O(z05));
  nand4  g035(.a(new_n61_), .b(x11), .c(x10), .d(new_n46_), .O(new_n79_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n73_), .d(new_n72_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n53_), .c(x17), .d(new_n88_), .O(new_n96_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n66_), .c(x18), .d(x01), .O(new_n107_));
  oai21  g064(.a(new_n105_), .b(new_n101_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n72_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n44_), .O(z09));
  nand3  g067(.a(new_n66_), .b(x18), .c(x01), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nor3   g069(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n113_));
  inv1   g070(.a(x13), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(x12), .c(new_n70_), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(new_n116_));
  nand2  g073(.a(new_n116_), .b(new_n100_), .O(new_n117_));
  ...
  aoi22  g078(.a(new_n121_), .b(new_n118_), .c(new_n113_), .d(new_n112_), .O(new_n122_));
  ...
  nand4  g082(.a(new_n112_), .b(new_n61_), .c(x21), .d(new_n106_), .O(new_n126_));
  oai21  g083(.a(new_n125_), .b(new_n117_), .c(new_n126_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n99_), .c(new_n72_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(z11));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n61_), .c(x01), .d(x00), .O(new_n131_));
  oai21  g088(.a(x19), .b(x02), .c(x23), .O(new_n132_));
  nand3  g089(.a(new_n66_), .b(x17), .c(new_n45_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n73_), .c(new_n72_), .O(new_n135_));
  ...
  nand3  g097(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n141_));
  ...
  aoi21  g103(.a(new_n61_), .b(x00), .c(new_n73_), .O(z16));
  nand2  g104(.a(new_n100_), .b(new_n72_), .O(new_n148_));
