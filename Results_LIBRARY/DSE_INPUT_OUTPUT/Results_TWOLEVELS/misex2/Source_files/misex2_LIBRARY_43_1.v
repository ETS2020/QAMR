...
module FAU ( 
  ...
  nand3  g024(.a(new_n67_), .b(new_n63_), .c(new_n52_), .O(z03));
  inv1   g025(.a(x11), .O(new_n69_));
  inv1   g026(.a(x00), .O(new_n70_));
  nor4   g027(.a(x09), .b(new_n45_), .c(new_n44_), .d(new_n70_), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n51_), .c(new_n69_), .d(x10), .O(new_n72_));
  nor2   g029(.a(new_n72_), .b(x15), .O(z04));
  inv1   g030(.a(new_n52_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(new_n47_), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(x09), .c(x02), .d(x01), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n70_), .O(z05));
  aoi21  g034(.a(x15), .b(new_n51_), .c(new_n69_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x10), .c(new_n46_), .d(x02), .O(new_n79_));
  nor3   g036(.a(new_n79_), .b(new_n44_), .c(new_n70_), .O(z06));
  nand2  g037(.a(new_n66_), .b(x01), .O(new_n81_));
  inv1   g038(.a(x15), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(new_n51_), .c(x11), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n81_), .c(new_n74_), .d(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  inv1   g042(.a(new_n85_), .O(z07));
  inv1   g043(.a(x03), .O(new_n87_));
  nand2  g044(.a(x02), .b(new_n44_), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(new_n89_));
  inv1   g046(.a(x04), .O(new_n90_));
  nor2   g047(.a(x05), .b(new_n90_), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n87_), .d(new_n70_), .O(new_n92_));
  ...
  aoi21  g054(.a(x15), .b(new_n51_), .c(x20), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(new_n50_), .c(x18), .d(x01), .O(new_n99_));
  nand4  g056(.a(x12), .b(new_n69_), .c(x02), .d(new_n44_), .O(new_n100_));
  inv1   g057(.a(new_n100_), .O(new_n101_));
  nor2   g058(.a(x14), .b(x13), .O(new_n102_));
  inv1   g059(.a(x16), .O(new_n103_));
  nand3  g060(.a(x20), .b(new_n103_), .c(new_n82_), .O(new_n104_));
  inv1   g061(.a(new_n104_), .O(new_n105_));
  nand3  g062(.a(new_n105_), .b(new_n102_), .c(new_n101_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(new_n70_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nand3  g066(.a(new_n50_), .b(x18), .c(x01), .O(new_n110_));
  inv1   g067(.a(x20), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n111_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g070(.a(new_n102_), .b(new_n69_), .O(new_n114_));
  nor2   g071(.a(new_n114_), .b(new_n88_), .O(new_n115_));
  nand3  g072(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n116_));
  nor3   g073(.a(new_n116_), .b(new_n103_), .c(new_n82_), .O(new_n117_));
  ...
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n111_), .d(new_n50_), .O(new_n121_));
  nor2   g078(.a(x13), .b(x11), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n89_), .O(new_n123_));
  nor2   g080(.a(new_n82_), .b(x14), .O(new_n124_));
  ...
  nand2  g094(.a(new_n137_), .b(new_n52_), .O(z12));
  nor2   g095(.a(x01), .b(x00), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n133_), .c(new_n52_), .O(z13));
  nand3  g098(.a(new_n139_), .b(new_n46_), .c(new_n45_), .O(new_n142_));
  nand4  g099(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n142_), .c(new_n52_), .O(z14));
  ...
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n74_), .O(z15));
  oai21  g105(.a(new_n44_), .b(x00), .c(new_n52_), .O(z16));
  nand4  g106(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n70_), .O(new_n150_));
