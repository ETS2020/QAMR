...
module FAU ( 
  ...
  nand4  g59(.a(new_n95_), .b(x12), .c(new_n68_), .d(x02), .O(new_n103_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n59_), .O(new_n107_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n103_), .c(new_n59_), .O(new_n114_));
  ...
  inv1   g85(.a(new_n119_), .O(new_n129_));
