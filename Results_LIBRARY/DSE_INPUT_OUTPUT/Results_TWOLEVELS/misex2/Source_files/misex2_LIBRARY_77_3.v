...
module FAU ( 
  ...
  inv1   g22(.a(new_n53_), .O(z05));
  aoi21  g23(.a(new_n46_), .b(new_n62_), .c(new_n61_), .O(z07));
  nor2   g24(.a(new_n46_), .b(x01), .O(new_n70_));
  ...
  nand3  g29(.a(new_n74_), .b(x04), .c(new_n73_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(new_n76_));
  nor3   g31(.a(x08), .b(x07), .c(x06), .O(new_n77_));
  nand3  g32(.a(x19), .b(new_n45_), .c(x17), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n77_), .c(new_n76_), .d(new_n72_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n53_), .O(z08));
  inv1   g36(.a(x21), .O(new_n82_));
  inv1   g37(.a(x22), .O(new_n83_));
  inv1   g38(.a(x11), .O(new_n84_));
  nand4  g39(.a(x12), .b(new_n84_), .c(x02), .d(new_n62_), .O(new_n85_));
  ...
  nand4  g47(.a(new_n92_), .b(new_n83_), .c(new_n82_), .d(new_n61_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand2  g49(.a(new_n55_), .b(x18), .O(new_n95_));
  nand3  g50(.a(x22), .b(x21), .c(new_n90_), .O(new_n96_));
  oai21  g51(.a(new_n96_), .b(new_n95_), .c(new_n61_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(x01), .O(new_n98_));
  inv1   g53(.a(x13), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(x12), .c(new_n84_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nor3   g56(.a(new_n87_), .b(new_n86_), .c(x14), .O(new_n102_));
  ...
  nand2  g60(.a(new_n105_), .b(new_n98_), .O(z10));
  nand3  g61(.a(new_n83_), .b(x21), .c(new_n90_), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n95_), .c(new_n61_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x01), .O(new_n109_));
  nand2  g64(.a(new_n87_), .b(x15), .O(new_n110_));
  nor3   g65(.a(new_n110_), .b(new_n103_), .c(x14), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n101_), .c(new_n72_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n109_), .O(z11));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n115_));
  ...
  nand3  g73(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x19), .O(z13));
  nand4  g75(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(x19), .O(z14));
  nand3  g77(.a(x19), .b(new_n46_), .c(new_n62_), .O(new_n123_));
  oai21  g78(.a(new_n70_), .b(new_n61_), .c(new_n123_), .O(z15));
  nand2  g79(.a(new_n48_), .b(x02), .O(new_n125_));
