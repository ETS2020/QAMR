...
module FAU ( 
  ...
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n56_), .O(z05));
  nand4  g34(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n78_));
  nor3   g35(.a(new_n78_), .b(new_n62_), .c(new_n56_), .O(z06));
  nor2   g36(.a(x12), .b(new_n71_), .O(new_n80_));
  nand4  g37(.a(new_n80_), .b(new_n63_), .c(x10), .d(x01), .O(new_n81_));
  ...
  nor2   g48(.a(new_n91_), .b(new_n67_), .O(z08));
  inv1   g49(.a(x21), .O(new_n93_));
  inv1   g50(.a(x22), .O(new_n94_));
  nand4  g51(.a(x12), .b(new_n71_), .c(x02), .d(new_n62_), .O(new_n95_));
  ...
  nand4  g62(.a(new_n98_), .b(x12), .c(new_n71_), .d(x02), .O(new_n106_));
  nand3  g63(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(x16), .c(x15), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n106_), .c(new_n56_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n62_), .O(new_n111_));
  inv1   g68(.a(new_n102_), .O(new_n112_));
  nor2   g69(.a(new_n100_), .b(x00), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n112_), .c(x22), .d(x21), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n111_), .O(z10));
  nand3  g72(.a(new_n108_), .b(new_n97_), .c(x15), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n106_), .c(new_n56_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n62_), .O(new_n118_));
  nand4  g75(.a(new_n113_), .b(new_n112_), .c(new_n94_), .d(x21), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(z11));
  inv1   g77(.a(x24), .O(new_n121_));
  aoi21  g78(.a(x10), .b(x02), .c(new_n56_), .O(new_n122_));
  oai21  g79(.a(x19), .b(x02), .c(x23), .O(new_n123_));
  nand3  g80(.a(new_n67_), .b(x17), .c(new_n57_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n123_), .c(x01), .O(new_n125_));
  oai21  g82(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai22  g83(.a(new_n126_), .b(new_n46_), .c(x01), .d(new_n56_), .O(z12));
  nand2  g84(.a(new_n47_), .b(x17), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z13));
  nand4  g86(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n56_), .c(x01), .O(z14));
  inv1   g88(.a(new_n122_), .O(new_n132_));
  aoi21  g89(.a(x19), .b(new_n57_), .c(x00), .O(new_n133_));
  oai21  g90(.a(new_n133_), .b(x01), .c(new_n132_), .O(z15));
  nor2   g91(.a(new_n62_), .b(x00), .O(z16));
  aoi21  g92(.a(new_n57_), .b(new_n56_), .c(x01), .O(z17));
endmodule
