...
module FAU ( 
  ...
  nor3   g30(.a(new_n73_), .b(new_n44_), .c(new_n53_), .O(z06));
  ...
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n84_));
  ...
  nand4  g44(.a(new_n87_), .b(new_n52_), .c(x17), .d(new_n80_), .O(new_n88_));
  ...
  nand4  g51(.a(new_n94_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n95_));
  ...
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n45_), .O(new_n106_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n44_), .c(new_n53_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n112_), .c(x24), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(x09), .O(new_n118_));
  inv1   g75(.a(new_n118_), .O(z12));
  aoi21  g76(.a(new_n114_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g77(.a(new_n48_), .b(new_n46_), .c(new_n67_), .d(new_n45_), .O(new_n121_));
  ...
  oai21  g81(.a(new_n123_), .b(new_n53_), .c(new_n124_), .O(z15));
  nor2   g82(.a(new_n44_), .b(x00), .O(z16));
  nand3  g83(.a(x02), .b(new_n44_), .c(new_n53_), .O(new_n127_));
