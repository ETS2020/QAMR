...
module FAU ( 
  ...
  aoi21  g28(.a(new_n71_), .b(x00), .c(new_n44_), .O(z06));
  ...
  nand4  g47(.a(new_n90_), .b(new_n87_), .c(new_n86_), .d(x12), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(x15), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n85_), .c(x20), .d(new_n84_), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(x22), .O(z09));
  inv1   g51(.a(x15), .O(new_n95_));
  nor2   g52(.a(new_n91_), .b(new_n95_), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n85_), .c(x20), .d(x16), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(x22), .O(z10));
  nand3  g55(.a(new_n87_), .b(new_n86_), .c(x12), .O(new_n99_));
  nor3   g56(.a(new_n99_), .b(x11), .c(new_n45_), .O(new_n100_));
  nor2   g57(.a(x16), .b(new_n95_), .O(new_n101_));
  ...
  nand3  g66(.a(new_n109_), .b(new_n44_), .c(new_n52_), .O(new_n110_));
  ...
  oai21  g73(.a(new_n57_), .b(new_n52_), .c(x01), .O(new_n117_));
  oai21  g74(.a(x19), .b(x00), .c(new_n45_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(z15));
  aoi21  g76(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
  zero   g77(.O(z16));
endmodule
