...
module FAU ( 
  ...
  nor2   g031(.a(x20), .b(x05), .O(new_n75_));
  ...
  nor3   g035(.a(new_n75_), .b(new_n70_), .c(new_n47_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(new_n46_), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n74_), .O(z06));
  ...
  aoi21  g050(.a(new_n93_), .b(x20), .c(x05), .O(z08));
  ...
  nand4  g073(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n97_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n110_), .c(x00), .O(z10));
  nand2  g075(.a(new_n113_), .b(new_n97_), .O(new_n119_));
  nand4  g076(.a(new_n109_), .b(x21), .c(new_n52_), .d(new_n50_), .O(new_n120_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n74_), .O(new_n132_));
  ...
  nor3   g099(.a(new_n75_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g100(.a(new_n97_), .b(new_n74_), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(new_n53_), .O(z17));
endmodule
