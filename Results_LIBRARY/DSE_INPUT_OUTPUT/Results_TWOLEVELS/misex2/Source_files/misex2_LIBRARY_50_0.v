...
module FAU ( 
  ...
  nand4  g015(.a(new_n58_), .b(x09), .c(new_n55_), .d(new_n54_), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(x14), .c(x02), .O(z01));
  nand3  g017(.a(new_n49_), .b(x09), .c(new_n47_), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(x10), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(x19), .O(z02));
  nand3  g021(.a(new_n47_), .b(new_n55_), .c(new_n54_), .O(new_n65_));
  nand4  g022(.a(new_n56_), .b(x18), .c(new_n44_), .d(x14), .O(new_n66_));
  nand3  g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(x12), .b(x11), .c(x10), .d(new_n48_), .O(new_n68_));
  ...
  nand4  g057(.a(new_n100_), .b(x12), .c(new_n70_), .d(new_n55_), .O(new_n101_));
  ...
  nor2   g063(.a(new_n45_), .b(new_n55_), .O(new_n107_));
  ...
  nor4   g068(.a(new_n76_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n56_), .c(x18), .d(x01), .O(new_n113_));
  nand3  g070(.a(new_n100_), .b(x12), .c(new_n70_), .O(new_n114_));
  ...
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n56_), .O(new_n120_));
  nor2   g077(.a(new_n103_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n98_), .c(x20), .d(new_n104_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n101_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n99_), .c(new_n54_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n77_), .O(z11));
  nand2  g082(.a(x10), .b(x02), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(x01), .c(x00), .O(new_n127_));
  oai21  g084(.a(x19), .b(x02), .c(x23), .O(new_n128_));
  nand3  g085(.a(new_n56_), .b(x17), .c(new_n47_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n55_), .c(new_n54_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n49_), .b(new_n56_), .c(x17), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(x14), .c(x02), .O(z13));
  nor2   g093(.a(new_n50_), .b(x10), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  aoi21  g096(.a(new_n46_), .b(x01), .c(new_n47_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n55_), .c(new_n102_), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x02), .c(new_n140_), .d(new_n54_), .O(z15));
  nor3   g099(.a(new_n76_), .b(new_n55_), .c(x00), .O(z16));
