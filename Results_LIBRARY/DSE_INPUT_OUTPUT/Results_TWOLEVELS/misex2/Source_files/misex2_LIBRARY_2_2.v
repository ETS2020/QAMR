...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n69_, new_n72_, new_n74_, new_n75_, new_n76_, new_n78_, new_n79_,
  ...
  nor3   g29(.a(new_n72_), .b(new_n52_), .c(new_n44_), .O(z06));
  nor2   g30(.a(x09), .b(new_n45_), .O(new_n74_));
  nor2   g31(.a(x12), .b(new_n66_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(new_n74_), .c(x10), .d(x01), .O(new_n76_));
  ...
  nor3   g50(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n94_));
  ...
  nand2  g62(.a(new_n105_), .b(new_n52_), .O(new_n106_));
  ...
  nand2  g72(.a(new_n52_), .b(x00), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n46_), .c(new_n116_), .O(z12));
  aoi21  g74(.a(new_n113_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g75(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n44_), .c(x01), .O(z14));
  nand2  g77(.a(x19), .b(new_n45_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n44_), .c(x01), .O(new_n122_));
  or2    g79(.a(new_n122_), .b(new_n111_), .O(z15));
  nor2   g80(.a(new_n52_), .b(x00), .O(z16));
  aoi21  g81(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
