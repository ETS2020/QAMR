...
module FAU ( 
  ...
  nor2   g020(.a(new_n63_), .b(x23), .O(new_n64_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n76_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n63_), .c(x09), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n52_), .O(z12));
  nor2   g095(.a(new_n64_), .b(x19), .O(new_n139_));
  ...
  nor3   g104(.a(new_n64_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g105(.a(new_n88_), .b(new_n52_), .O(z17));
endmodule
