...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n128_, new_n129_, new_n131_, new_n133_, new_n135_;
  ...
  oai21  g18(.a(new_n61_), .b(new_n52_), .c(x00), .O(new_n62_));
  inv1   g19(.a(x19), .O(new_n63_));
  nor2   g20(.a(x02), .b(x01), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(new_n63_), .c(x18), .d(new_n50_), .O(new_n65_));
  ...
  aoi21  g30(.a(new_n73_), .b(new_n52_), .c(new_n72_), .O(new_n74_));
  ...
  nand4  g43(.a(new_n86_), .b(x12), .c(new_n72_), .d(x02), .O(new_n87_));
  ...
  nand4  g52(.a(new_n95_), .b(new_n94_), .c(new_n90_), .d(new_n44_), .O(new_n96_));
  ...
  nor2   g67(.a(x13), .b(new_n73_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n103_), .c(new_n72_), .O(new_n112_));
  inv1   g69(.a(x20), .O(new_n113_));
  nand4  g70(.a(new_n94_), .b(x21), .c(new_n113_), .d(new_n63_), .O(new_n114_));
  nor2   g71(.a(new_n88_), .b(x14), .O(new_n115_));
  nor2   g72(.a(x21), .b(new_n113_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n115_), .c(new_n89_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n112_), .c(new_n114_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n110_), .c(new_n44_), .O(new_n119_));
  ...
  nand3  g81(.a(new_n63_), .b(x17), .c(new_n45_), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g83(.a(new_n126_), .b(new_n52_), .c(new_n44_), .O(new_n127_));
  ...
  nand3  g87(.a(new_n45_), .b(new_n52_), .c(new_n44_), .O(new_n131_));
  nor3   g88(.a(new_n131_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g89(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n133_));
  ...
  nor2   g93(.a(new_n52_), .b(x00), .O(z16));
