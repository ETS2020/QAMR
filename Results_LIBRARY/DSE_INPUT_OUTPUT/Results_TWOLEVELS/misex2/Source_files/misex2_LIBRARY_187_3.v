...
module FAU ( 
  ...
  nand2  g010(.a(x17), .b(x01), .O(new_n54_));
  ...
  nand4  g019(.a(new_n44_), .b(x12), .c(x11), .d(x10), .O(new_n63_));
  ...
  aoi21  g029(.a(new_n72_), .b(new_n44_), .c(new_n47_), .O(z04));
  nand4  g030(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(x17), .c(new_n59_), .O(z05));
  nand4  g032(.a(new_n44_), .b(x11), .c(x10), .d(new_n49_), .O(new_n76_));
  ...
  nand3  g037(.a(new_n44_), .b(new_n70_), .c(x11), .O(new_n81_));
  ...
  aoi21  g049(.a(new_n92_), .b(new_n47_), .c(new_n44_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nor2   g052(.a(new_n48_), .b(x01), .O(new_n96_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n46_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n54_), .O(z09));
  nor2   g064(.a(new_n45_), .b(x17), .O(new_n108_));
  nor2   g065(.a(new_n95_), .b(new_n94_), .O(new_n109_));
  ...
  nand4  g073(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n96_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n110_), .c(x00), .O(z10));
  nand2  g075(.a(new_n113_), .b(new_n96_), .O(new_n119_));
  nor2   g076(.a(new_n94_), .b(x20), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n102_), .c(new_n56_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n95_), .c(new_n46_), .O(new_n125_));
  ...
  nand2  g089(.a(new_n132_), .b(new_n46_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n127_), .c(x09), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n54_), .O(z12));
  nand3  g093(.a(new_n56_), .b(new_n48_), .c(new_n46_), .O(new_n137_));
  aoi21  g094(.a(new_n137_), .b(new_n47_), .c(new_n44_), .O(z13));
  ...
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n54_), .O(z15));
  nand3  g101(.a(new_n44_), .b(x01), .c(new_n46_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand2  g103(.a(new_n96_), .b(new_n46_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n54_), .O(z17));
endmodule
