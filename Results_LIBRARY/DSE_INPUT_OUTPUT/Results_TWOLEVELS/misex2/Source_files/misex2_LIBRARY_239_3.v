...
module FAU ( 
  ...
  nand2  g013(.a(x24), .b(x01), .O(new_n57_));
  ...
  nand2  g043(.a(new_n86_), .b(new_n57_), .O(z07));
  ...
  nand2  g067(.a(new_n110_), .b(new_n57_), .O(z09));
  ...
  oai21  g080(.a(new_n123_), .b(x00), .c(new_n57_), .O(z10));
  nor2   g081(.a(x13), .b(new_n73_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n89_), .c(new_n72_), .O(new_n126_));
  nand4  g083(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n60_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n100_), .c(new_n88_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n57_), .O(z11));
  nand2  g090(.a(x10), .b(x02), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(x01), .c(x00), .O(new_n135_));
  oai21  g092(.a(x19), .b(x02), .c(x23), .O(new_n136_));
  nand3  g093(.a(new_n60_), .b(x17), .c(new_n46_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n71_), .c(new_n88_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n63_), .c(x09), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(z12));
  inv1   g099(.a(new_n48_), .O(new_n143_));
  oai21  g100(.a(new_n137_), .b(new_n143_), .c(new_n57_), .O(z13));
  nand3  g101(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n145_));
  oai21  g102(.a(new_n145_), .b(new_n61_), .c(new_n57_), .O(z14));
  oai21  g103(.a(x10), .b(new_n71_), .c(x02), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(x00), .O(new_n148_));
  nand3  g105(.a(x19), .b(new_n46_), .c(new_n71_), .O(new_n149_));
  nand3  g106(.a(new_n149_), .b(new_n148_), .c(new_n57_), .O(z15));
  nand3  g107(.a(new_n63_), .b(x01), .c(new_n88_), .O(new_n151_));
  inv1   g108(.a(new_n151_), .O(z16));
  nand2  g109(.a(new_n90_), .b(new_n57_), .O(z17));
endmodule
