...
module FAU ( 
  ...
  nand2  g24(.a(new_n67_), .b(new_n60_), .O(new_n68_));
  ...
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(new_n67_), .d(x01), .O(new_n80_));
  ...
  nand4  g45(.a(new_n88_), .b(x02), .c(new_n60_), .d(new_n44_), .O(new_n89_));
  ...
  nand4  g49(.a(new_n92_), .b(new_n83_), .c(x17), .d(x15), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(new_n62_), .O(z08));
  nand3  g51(.a(x18), .b(x01), .c(new_n44_), .O(new_n95_));
  inv1   g52(.a(x20), .O(new_n96_));
  inv1   g53(.a(x21), .O(new_n97_));
  inv1   g54(.a(x22), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n62_), .O(new_n99_));
  oai21  g56(.a(new_n99_), .b(new_n95_), .c(new_n68_), .O(z09));
  ...
  nor4   g60(.a(new_n103_), .b(x13), .c(new_n70_), .d(x11), .O(new_n104_));
  ...
  nand3  g67(.a(x21), .b(new_n96_), .c(new_n62_), .O(new_n111_));
  nand4  g68(.a(x12), .b(new_n69_), .c(x02), .d(new_n60_), .O(new_n112_));
  nor2   g69(.a(x14), .b(x13), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n97_), .c(x20), .d(new_n105_), .O(new_n114_));
  oai22  g71(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n98_), .c(new_n44_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n68_), .O(z11));
  ...
  nand3  g83(.a(new_n45_), .b(new_n60_), .c(new_n44_), .O(new_n127_));
  nor4   g84(.a(new_n127_), .b(x19), .c(new_n47_), .d(new_n67_), .O(z13));
  nor3   g85(.a(new_n127_), .b(x10), .c(x09), .O(new_n129_));
  nand4  g86(.a(new_n129_), .b(new_n83_), .c(new_n47_), .d(x15), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z14));
  aoi21  g88(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n132_));
  aoi21  g89(.a(x19), .b(new_n45_), .c(new_n67_), .O(new_n133_));
  oai22  g90(.a(new_n133_), .b(x01), .c(new_n132_), .d(new_n44_), .O(z15));
  nor2   g91(.a(new_n60_), .b(x00), .O(z16));
  nand4  g92(.a(x15), .b(x02), .c(new_n60_), .d(new_n44_), .O(new_n136_));
