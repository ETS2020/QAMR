...
module FAU ( 
  ...
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n57_), .O(z05));
  aoi21  g32(.a(x12), .b(new_n62_), .c(new_n69_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x10), .c(new_n47_), .d(x02), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x01), .c(new_n57_), .O(z06));
  nand4  g35(.a(new_n71_), .b(new_n70_), .c(x11), .d(x10), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n57_), .O(z07));
  inv1   g37(.a(x08), .O(new_n81_));
  inv1   g38(.a(x05), .O(new_n82_));
  inv1   g39(.a(x06), .O(new_n83_));
  inv1   g40(.a(x03), .O(new_n84_));
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n62_), .d(new_n57_), .O(new_n85_));
  ...
  nand4  g48(.a(new_n91_), .b(x12), .c(new_n69_), .d(x02), .O(new_n92_));
  ...
  oai21  g55(.a(new_n98_), .b(new_n92_), .c(new_n57_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n62_), .O(new_n100_));
  nor3   g57(.a(new_n45_), .b(new_n62_), .c(x00), .O(new_n101_));
  nor2   g58(.a(x20), .b(x19), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n101_), .c(new_n95_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n100_), .O(z09));
  nand2  g61(.a(x22), .b(x21), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n64_), .c(x18), .d(x01), .O(new_n107_));
  nand2  g64(.a(x02), .b(new_n62_), .O(new_n108_));
  nor4   g65(.a(new_n108_), .b(x13), .c(new_n70_), .d(x11), .O(new_n109_));
  nor3   g66(.a(new_n94_), .b(new_n93_), .c(x14), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n109_), .c(new_n97_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(x00), .O(z10));
  nand3  g69(.a(new_n97_), .b(new_n94_), .c(x15), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n92_), .c(new_n57_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n62_), .O(new_n115_));
  inv1   g72(.a(x22), .O(new_n116_));
  nand4  g73(.a(new_n102_), .b(new_n101_), .c(new_n116_), .d(x21), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n115_), .O(z11));
  inv1   g75(.a(x24), .O(new_n119_));
  aoi21  g76(.a(x10), .b(x02), .c(new_n57_), .O(new_n120_));
  ...
  oai22  g81(.a(new_n124_), .b(new_n47_), .c(x01), .d(new_n57_), .O(z12));
  aoi21  g82(.a(new_n122_), .b(new_n57_), .c(x01), .O(z13));
  nand4  g83(.a(new_n59_), .b(new_n58_), .c(new_n47_), .d(new_n46_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n57_), .c(x01), .O(z14));
