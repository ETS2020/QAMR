...
module FAU ( 
  ...
  inv1   g021(.a(new_n52_), .O(new_n65_));
  ...
  nand2  g041(.a(new_n84_), .b(new_n52_), .O(z06));
  ...
  nand2  g045(.a(new_n88_), .b(new_n52_), .O(z07));
  ...
  nor2   g055(.a(new_n98_), .b(new_n50_), .O(z08));
  ...
  nand4  g067(.a(new_n110_), .b(new_n101_), .c(new_n100_), .d(new_n77_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n52_), .O(z09));
  nand3  g069(.a(x18), .b(new_n90_), .c(x01), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n108_), .c(x22), .d(x21), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n74_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n102_), .c(new_n73_), .O(new_n117_));
  nor3   g074(.a(new_n105_), .b(new_n104_), .c(x14), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n101_), .c(new_n100_), .d(x20), .O(new_n119_));
  or2    g076(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  aoi21  g077(.a(new_n120_), .b(new_n115_), .c(x00), .O(z10));
  nand3  g078(.a(x21), .b(new_n51_), .c(new_n50_), .O(new_n122_));
  nor2   g079(.a(new_n104_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n100_), .c(x20), .d(new_n105_), .O(new_n124_));
  oai22  g081(.a(new_n124_), .b(new_n117_), .c(new_n122_), .d(new_n113_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n101_), .c(new_n77_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(new_n77_), .O(new_n134_));
  ...
  nand4  g099(.a(new_n142_), .b(new_n141_), .c(new_n59_), .d(new_n57_), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n52_), .O(z14));
  ...
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n65_), .O(z15));
  nor3   g105(.a(new_n65_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g106(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n77_), .O(new_n150_));
