...
module FAU ( 
  ...
  nand2  g008(.a(x06), .b(new_n51_), .O(new_n52_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n74_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n44_), .b(new_n74_), .O(new_n139_));
  oai21  g096(.a(new_n133_), .b(new_n139_), .c(new_n52_), .O(z13));
  nand4  g097(.a(new_n59_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  ...
  nand4  g104(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n74_), .O(new_n148_));
