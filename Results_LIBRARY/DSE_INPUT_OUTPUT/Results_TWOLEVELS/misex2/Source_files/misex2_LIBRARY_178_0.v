...
module FAU ( 
  ...
  nand4  g27(.a(new_n72_), .b(x18), .c(x01), .d(new_n46_), .O(new_n73_));
  ...
  nor2   g38(.a(new_n83_), .b(new_n46_), .O(z12));
  nand2  g39(.a(new_n58_), .b(x01), .O(new_n86_));
  aoi21  g40(.a(new_n86_), .b(x02), .c(new_n46_), .O(z15));
  nor2   g41(.a(new_n47_), .b(x00), .O(z16));
  zero   g42(.O(z00));
  zero   g43(.O(z01));
  zero   g44(.O(z13));
  zero   g45(.O(z17));
  inv1   g46(.a(new_n48_), .O(z08));
  inv1   g47(.a(new_n48_), .O(z14));
endmodule
