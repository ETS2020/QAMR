...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n116_, new_n117_, new_n120_, new_n122_, new_n123_, new_n126_;
  ...
  nand4  g17(.a(new_n60_), .b(x18), .c(new_n51_), .d(new_n45_), .O(new_n61_));
  ...
  nor3   g31(.a(new_n74_), .b(new_n44_), .c(new_n53_), .O(z06));
  ...
  nand4  g57(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n101_));
  ...
  nand4  g76(.a(new_n48_), .b(new_n46_), .c(new_n67_), .d(new_n45_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g78(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n122_));
  nand3  g79(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n53_), .c(new_n123_), .O(z15));
  nand3  g81(.a(x02), .b(new_n44_), .c(new_n53_), .O(new_n126_));
