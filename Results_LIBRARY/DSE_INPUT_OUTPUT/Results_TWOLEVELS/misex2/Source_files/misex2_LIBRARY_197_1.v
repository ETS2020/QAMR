...
module FAU ( 
  ...
  nor3   g29(.a(new_n72_), .b(new_n44_), .c(new_n60_), .O(z06));
  ...
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n83_));
  ...
  nand4  g50(.a(new_n93_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n94_));
  ...
  nand3  g68(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n44_), .c(new_n60_), .O(new_n114_));
  ...
  aoi21  g83(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
  zero   g84(.O(z16));
endmodule
