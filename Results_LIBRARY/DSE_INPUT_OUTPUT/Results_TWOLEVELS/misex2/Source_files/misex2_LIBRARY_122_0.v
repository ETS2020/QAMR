...
module FAU ( 
  ...
  aoi21  g10(.a(new_n53_), .b(x14), .c(x01), .O(z01));
  ...
  nand4  g15(.a(new_n58_), .b(new_n55_), .c(new_n45_), .d(x14), .O(new_n59_));
  ...
  oai21  g20(.a(new_n63_), .b(new_n61_), .c(x14), .O(new_n64_));
  ...
  nand2  g36(.a(new_n79_), .b(new_n56_), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(new_n78_), .O(z06));
  nand2  g38(.a(new_n67_), .b(x01), .O(new_n82_));
  inv1   g39(.a(x12), .O(new_n83_));
  nand3  g40(.a(new_n83_), .b(x11), .c(x10), .O(new_n84_));
  oai22  g41(.a(new_n84_), .b(new_n82_), .c(new_n79_), .d(x01), .O(new_n85_));
  nand3  g42(.a(new_n85_), .b(x02), .c(x00), .O(new_n86_));
  inv1   g43(.a(new_n86_), .O(z07));
  nand2  g44(.a(x02), .b(new_n51_), .O(new_n88_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n97_), .c(new_n80_), .O(z09));
  nand4  g59(.a(new_n62_), .b(x18), .c(x01), .d(new_n51_), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n99_), .c(x20), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(x22), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z10));
  nand2  g63(.a(new_n104_), .b(new_n100_), .O(new_n107_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n109_), .c(x09), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n80_), .O(z12));
  nand4  g75(.a(new_n62_), .b(x17), .c(new_n52_), .d(new_n51_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(x14), .c(x01), .O(z13));
  nand4  g77(.a(new_n46_), .b(new_n44_), .c(new_n45_), .d(new_n75_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(x14), .c(x01), .O(z14));
  aoi21  g79(.a(new_n75_), .b(x01), .c(new_n52_), .O(new_n123_));
  aoi21  g80(.a(x19), .b(new_n52_), .c(new_n79_), .O(new_n124_));
  oai22  g81(.a(new_n124_), .b(x01), .c(new_n123_), .d(new_n51_), .O(z15));
  oai21  g82(.a(new_n56_), .b(x00), .c(new_n80_), .O(z16));
  nand4  g83(.a(x14), .b(x02), .c(new_n56_), .d(new_n51_), .O(new_n127_));
