...
module FAU ( 
  ...
  aoi21  g30(.a(x12), .b(new_n47_), .c(new_n67_), .O(new_n74_));
  ...
  nor2   g34(.a(x09), .b(new_n48_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n95_), .b(x12), .c(new_n67_), .d(x02), .O(new_n103_));
  ...
  nand4  g68(.a(new_n97_), .b(x21), .c(new_n111_), .d(new_n62_), .O(new_n112_));
  nor2   g69(.a(new_n48_), .b(x01), .O(new_n113_));
  nor2   g70(.a(x13), .b(new_n77_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n113_), .c(new_n67_), .O(new_n115_));
  ...
  nand3  g81(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n125_));
  ...
  nand4  g92(.a(x19), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n136_));
  nand2  g93(.a(new_n136_), .b(new_n135_), .O(z15));
  nand2  g94(.a(x01), .b(new_n46_), .O(new_n138_));
  nand2  g95(.a(new_n138_), .b(new_n128_), .O(z16));
  aoi21  g96(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
