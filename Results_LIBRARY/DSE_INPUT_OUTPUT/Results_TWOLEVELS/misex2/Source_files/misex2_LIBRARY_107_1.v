...
module FAU ( 
  ...
  nor3   g033(.a(new_n70_), .b(new_n47_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nand2  g035(.a(new_n78_), .b(new_n52_), .O(z06));
  ...
  nand4  g047(.a(new_n90_), .b(new_n85_), .c(new_n84_), .d(new_n51_), .O(new_n91_));
  nor2   g048(.a(new_n91_), .b(x08), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x19), .c(new_n49_), .d(x17), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(x22), .O(z08));
  ...
  nand2  g061(.a(new_n104_), .b(new_n50_), .O(new_n105_));
  ...
  nand3  g067(.a(x18), .b(x05), .c(x01), .O(new_n111_));
  ...
  nand4  g076(.a(new_n103_), .b(x21), .c(new_n104_), .d(new_n50_), .O(new_n120_));
  ...
  nand2  g101(.a(new_n97_), .b(new_n87_), .O(new_n145_));
