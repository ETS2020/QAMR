...
module FAU ( 
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x13), .O(new_n64_));
  ...
  nand3  g041(.a(x02), .b(new_n69_), .c(new_n84_), .O(new_n85_));
  ...
  nor2   g046(.a(new_n52_), .b(x18), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x17), .O(new_n91_));
  nand2  g048(.a(new_n91_), .b(new_n45_), .O(z08));
  ...
  nand4  g057(.a(new_n100_), .b(x18), .c(x13), .d(x01), .O(new_n101_));
  oai21  g058(.a(new_n99_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n84_), .O(new_n103_));
  ...
  nand2  g065(.a(new_n70_), .b(x02), .O(new_n109_));
  nand2  g066(.a(new_n98_), .b(x12), .O(new_n110_));
  ...
  nand4  g074(.a(new_n117_), .b(x21), .c(new_n106_), .d(new_n52_), .O(new_n118_));
  nand4  g075(.a(new_n44_), .b(x12), .c(new_n70_), .d(x02), .O(new_n119_));
  nor2   g076(.a(new_n96_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n106_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n97_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  ...
  nand4  g096(.a(new_n139_), .b(new_n51_), .c(new_n50_), .d(new_n59_), .O(new_n140_));
  ...
  aoi21  g102(.a(x13), .b(x00), .c(new_n69_), .O(z16));
