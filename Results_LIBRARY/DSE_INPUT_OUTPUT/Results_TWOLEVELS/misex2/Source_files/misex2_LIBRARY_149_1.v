...
module FAU ( 
  ...
  nand3  g18(.a(new_n47_), .b(x12), .c(x11), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(z03));
  inv1   g20(.a(x09), .O(new_n64_));
  nor2   g21(.a(x12), .b(x11), .O(new_n65_));
  nand4  g22(.a(new_n65_), .b(x10), .c(new_n64_), .d(x02), .O(new_n66_));
  aoi21  g23(.a(new_n66_), .b(x00), .c(new_n44_), .O(z04));
  nand4  g24(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n68_));
  nor2   g25(.a(new_n68_), .b(new_n46_), .O(z05));
  nand4  g26(.a(x11), .b(x10), .c(new_n64_), .d(x02), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(new_n44_), .c(new_n55_), .O(z06));
  ...
  nand4  g49(.a(new_n92_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n93_));
  ...
  nand4  g75(.a(new_n48_), .b(new_n46_), .c(new_n64_), .d(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g77(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n55_), .c(new_n122_), .O(z15));
