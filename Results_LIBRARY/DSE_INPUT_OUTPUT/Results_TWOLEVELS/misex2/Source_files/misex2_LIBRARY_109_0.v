...
module FAU ( 
  ...
  nor3   g65(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n47_), .c(x18), .d(x01), .O(new_n110_));
  nand3  g67(.a(new_n74_), .b(x02), .c(new_n50_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(x20), .b(x16), .c(x15), .O(new_n113_));
  nand3  g70(.a(x24), .b(new_n97_), .c(new_n96_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n112_), .c(new_n101_), .d(x12), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n110_), .c(x00), .O(z10));
  nand4  g74(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n47_), .O(new_n118_));
  nor2   g75(.a(new_n51_), .b(x01), .O(new_n119_));
  nor2   g76(.a(x13), .b(new_n75_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n119_), .c(new_n74_), .O(new_n121_));
  nor2   g78(.a(new_n99_), .b(x14), .O(new_n122_));
  nor2   g79(.a(x21), .b(new_n103_), .O(new_n123_));
  nand3  g80(.a(new_n123_), .b(new_n122_), .c(new_n100_), .O(new_n124_));
  oai21  g81(.a(new_n124_), .b(new_n121_), .c(new_n118_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n97_), .c(new_n49_), .O(new_n126_));
  ...
  nand3  g87(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n131_));
  nor4   g88(.a(new_n131_), .b(new_n44_), .c(x19), .d(new_n45_), .O(z13));
  nand4  g89(.a(new_n62_), .b(new_n52_), .c(new_n51_), .d(new_n49_), .O(new_n133_));
  aoi21  g90(.a(new_n133_), .b(x24), .c(x01), .O(z14));
  aoi22  g91(.a(new_n128_), .b(x01), .c(x24), .d(new_n51_), .O(new_n135_));
  nand4  g92(.a(x24), .b(x19), .c(new_n51_), .d(new_n50_), .O(new_n136_));
  oai21  g93(.a(new_n135_), .b(new_n49_), .c(new_n136_), .O(z15));
  oai21  g94(.a(new_n50_), .b(x00), .c(new_n73_), .O(z16));
  aoi21  g95(.a(new_n87_), .b(x24), .c(x01), .O(z17));
endmodule
