...
module FAU ( 
  ...
  nand2  g001(.a(x24), .b(new_n44_), .O(new_n45_));
  ...
  oai21  g013(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(z01));
  inv1   g014(.a(x10), .O(new_n58_));
  nand4  g015(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n58_), .O(new_n59_));
  oai21  g016(.a(new_n59_), .b(new_n56_), .c(new_n45_), .O(z02));
  inv1   g017(.a(x24), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(x22), .O(new_n62_));
  ...
  nor2   g023(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n64_), .c(x10), .d(new_n49_), .O(new_n68_));
  nor3   g025(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nor2   g026(.a(x19), .b(new_n52_), .O(new_n70_));
  nand3  g027(.a(new_n70_), .b(new_n69_), .c(new_n51_), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(new_n68_), .c(new_n62_), .O(z03));
  nand4  g029(.a(new_n45_), .b(new_n66_), .c(new_n65_), .d(x10), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n49_), .c(x02), .d(x01), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(new_n46_), .O(z04));
  nor2   g033(.a(new_n62_), .b(new_n58_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n46_), .O(z05));
  nor2   g036(.a(new_n62_), .b(new_n65_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x10), .c(new_n49_), .d(x02), .O(new_n81_));
  nor3   g038(.a(new_n81_), .b(new_n47_), .c(new_n46_), .O(z06));
  nand3  g039(.a(new_n66_), .b(x11), .c(x10), .O(new_n83_));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(new_n91_));
  nor3   g048(.a(x08), .b(x07), .c(x06), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x19), .c(new_n52_), .d(x17), .O(new_n93_));
  oai21  g050(.a(new_n93_), .b(new_n91_), .c(new_n45_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n65_), .c(x02), .d(new_n47_), .O(new_n96_));
  ...
  nand3  g059(.a(new_n102_), .b(new_n101_), .c(new_n53_), .O(new_n103_));
  oai21  g060(.a(new_n100_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n61_), .c(new_n44_), .d(new_n95_), .O(new_n105_));
  nor2   g062(.a(new_n105_), .b(x00), .O(z09));
  nor2   g063(.a(new_n44_), .b(new_n95_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n70_), .c(new_n101_), .d(x01), .O(new_n108_));
  nand3  g065(.a(new_n65_), .b(x02), .c(new_n47_), .O(new_n109_));
  nand2  g066(.a(new_n99_), .b(x12), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nor2   g068(.a(new_n101_), .b(new_n98_), .O(new_n112_));
  nor3   g069(.a(x24), .b(x22), .c(x21), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x15), .O(new_n114_));
  aoi21  g071(.a(new_n114_), .b(new_n108_), .c(x00), .O(z10));
  nand4  g072(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n53_), .O(new_n116_));
  nor2   g073(.a(x13), .b(new_n66_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n88_), .c(new_n65_), .O(new_n118_));
  ...
  oai21  g078(.a(new_n121_), .b(new_n118_), .c(new_n116_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n46_), .O(new_n123_));
  aoi21  g080(.a(new_n123_), .b(new_n61_), .c(x22), .O(z11));
  ...
  nand3  g088(.a(new_n131_), .b(new_n61_), .c(x09), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n45_), .O(z12));
  nor2   g090(.a(new_n62_), .b(x19), .O(new_n134_));
  nand4  g091(.a(new_n134_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x00), .O(z13));
  oai21  g093(.a(new_n59_), .b(new_n50_), .c(new_n45_), .O(z14));
  oai21  g094(.a(x10), .b(new_n47_), .c(x02), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(x00), .O(new_n139_));
  nand3  g096(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n139_), .c(new_n45_), .O(z15));
  nor3   g098(.a(new_n62_), .b(new_n47_), .c(x00), .O(z16));
  nand4  g099(.a(new_n45_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n143_));
