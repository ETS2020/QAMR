...
module FAU ( 
  ...
  inv1   g009(.a(x13), .O(new_n53_));
  nand2  g010(.a(x17), .b(new_n53_), .O(new_n54_));
  ...
  nand4  g021(.a(new_n64_), .b(new_n56_), .c(x18), .d(new_n44_), .O(new_n65_));
  ...
  nand3  g026(.a(new_n69_), .b(new_n65_), .c(new_n54_), .O(z03));
  inv1   g027(.a(x00), .O(new_n71_));
  inv1   g028(.a(x11), .O(new_n72_));
  inv1   g029(.a(x12), .O(new_n73_));
  nand4  g030(.a(new_n54_), .b(new_n73_), .c(new_n72_), .d(x10), .O(new_n74_));
  ...
  oai21  g036(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z05));
  inv1   g037(.a(x01), .O(new_n81_));
  aoi21  g038(.a(x17), .b(new_n53_), .c(new_n72_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x10), .c(new_n47_), .d(x02), .O(new_n83_));
  nor3   g040(.a(new_n83_), .b(new_n81_), .c(new_n71_), .O(z06));
  nand3  g041(.a(new_n68_), .b(new_n73_), .c(x11), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(x01), .O(new_n86_));
  nand3  g043(.a(new_n86_), .b(x02), .c(x00), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n54_), .O(z07));
  ...
  aoi21  g053(.a(new_n96_), .b(x13), .c(new_n44_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  inv1   g056(.a(x20), .O(new_n100_));
  nand4  g057(.a(new_n54_), .b(new_n100_), .c(new_n56_), .d(x18), .O(new_n101_));
  nor2   g058(.a(new_n46_), .b(x01), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n53_), .c(x12), .d(new_n72_), .O(new_n103_));
  inv1   g060(.a(x16), .O(new_n104_));
  nor2   g061(.a(x15), .b(x14), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(x20), .c(new_n44_), .d(new_n104_), .O(new_n106_));
  oai22  g063(.a(new_n106_), .b(new_n103_), .c(new_n101_), .d(new_n81_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n71_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nand4  g066(.a(new_n54_), .b(x22), .c(x21), .d(new_n100_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n56_), .c(x18), .d(x01), .O(new_n112_));
  nand3  g069(.a(new_n72_), .b(x02), .c(new_n81_), .O(new_n113_));
  nor4   g070(.a(new_n113_), .b(x14), .c(x13), .d(new_n73_), .O(new_n114_));
  nand3  g071(.a(new_n44_), .b(x16), .c(x15), .O(new_n115_));
  nor4   g072(.a(new_n115_), .b(x22), .c(x21), .d(new_n100_), .O(new_n116_));
  nand2  g073(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n112_), .c(x00), .O(z10));
  aoi21  g075(.a(x17), .b(new_n53_), .c(new_n98_), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n100_), .c(new_n56_), .d(x18), .O(new_n120_));
  ...
  nand4  g081(.a(new_n124_), .b(new_n123_), .c(new_n44_), .d(new_n121_), .O(new_n125_));
  oai22  g082(.a(new_n125_), .b(new_n103_), .c(new_n120_), .d(new_n81_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n99_), .c(new_n71_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(z11));
  inv1   g085(.a(x24), .O(new_n129_));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n54_), .c(x01), .d(x00), .O(new_n131_));
  nor2   g088(.a(x19), .b(x02), .O(new_n132_));
  oai21  g089(.a(new_n132_), .b(x23), .c(x17), .O(new_n133_));
  nand2  g090(.a(new_n56_), .b(new_n46_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(x23), .c(new_n44_), .O(new_n135_));
  oai21  g092(.a(new_n133_), .b(new_n53_), .c(new_n135_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n81_), .c(new_n71_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n132_), .b(new_n48_), .O(new_n141_));
  aoi21  g098(.a(new_n141_), .b(x13), .c(new_n44_), .O(z13));
  nand4  g099(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  oai21  g101(.a(x10), .b(new_n81_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n81_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n54_), .O(z15));
  oai21  g105(.a(new_n81_), .b(x00), .c(new_n54_), .O(z16));
  nand2  g106(.a(new_n102_), .b(new_n71_), .O(new_n150_));
  nand2  g107(.a(new_n150_), .b(new_n54_), .O(z17));
endmodule
