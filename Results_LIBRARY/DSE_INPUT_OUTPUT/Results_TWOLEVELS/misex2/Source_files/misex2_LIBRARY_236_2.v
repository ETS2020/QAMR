...
module FAU ( 
  ...
  nand4  g025(.a(x07), .b(x02), .c(x01), .d(x00), .O(new_n69_));
  ...
  nand4  g030(.a(new_n73_), .b(new_n72_), .c(x10), .d(x00), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(x07), .c(new_n65_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x07), .c(new_n65_), .O(z05));
  inv1   g034(.a(x11), .O(new_n78_));
  nor3   g035(.a(new_n78_), .b(new_n59_), .c(x09), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x07), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n64_), .O(z06));
  ...
  aoi21  g051(.a(new_n94_), .b(new_n65_), .c(x07), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n78_), .c(x02), .d(new_n65_), .O(new_n98_));
  ...
  nand2  g067(.a(x02), .b(new_n65_), .O(new_n111_));
  inv1   g068(.a(x13), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n78_), .O(new_n113_));
  ...
  nor2   g076(.a(x13), .b(new_n83_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n119_), .c(new_n78_), .O(new_n121_));
  inv1   g078(.a(x20), .O(new_n122_));
  nand4  g079(.a(new_n109_), .b(x21), .c(new_n122_), .d(new_n67_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n64_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n67_), .b(x17), .c(new_n46_), .O(new_n134_));
  ...
  oai21  g102(.a(x10), .b(new_n65_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n46_), .c(new_n65_), .O(new_n148_));
  nand3  g105(.a(new_n148_), .b(new_n147_), .c(new_n54_), .O(z15));
  aoi21  g106(.a(x07), .b(x00), .c(new_n65_), .O(z16));
  oai21  g107(.a(new_n111_), .b(x00), .c(new_n54_), .O(z17));
endmodule
