...
module FAU ( 
  ...
  aoi21  g026(.a(new_n69_), .b(new_n67_), .c(new_n61_), .O(z03));
  inv1   g027(.a(x00), .O(new_n71_));
  nand4  g028(.a(new_n51_), .b(new_n65_), .c(new_n64_), .d(x10), .O(new_n72_));
  ...
  nand3  g058(.a(new_n101_), .b(x12), .c(new_n64_), .O(new_n102_));
  ...
  nor2   g070(.a(x13), .b(new_n65_), .O(new_n114_));
  nand2  g071(.a(new_n114_), .b(new_n64_), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n100_), .O(new_n116_));
  ...
  inv1   g077(.a(new_n116_), .O(new_n121_));
  nand4  g078(.a(new_n51_), .b(x21), .c(new_n107_), .d(new_n50_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(x18), .c(x01), .O(new_n124_));
  nor2   g081(.a(new_n103_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n98_), .c(x20), .d(new_n104_), .O(new_n126_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n71_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n44_), .b(new_n71_), .O(new_n139_));
  ...
  nand3  g103(.a(new_n51_), .b(x01), .c(new_n71_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand4  g105(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n71_), .O(new_n149_));
