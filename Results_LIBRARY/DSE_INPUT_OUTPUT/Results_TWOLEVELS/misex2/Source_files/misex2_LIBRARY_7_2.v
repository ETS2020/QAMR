...
module FAU ( 
  ...
  nand4  g029(.a(new_n52_), .b(new_n66_), .c(new_n65_), .d(x10), .O(new_n73_));
  ...
  nor3   g038(.a(new_n81_), .b(new_n44_), .c(new_n72_), .O(z06));
  ...
  nand4  g048(.a(new_n52_), .b(x19), .c(new_n49_), .d(x17), .O(new_n92_));
  ...
  nand3  g057(.a(new_n100_), .b(x12), .c(new_n65_), .O(new_n101_));
  inv1   g058(.a(x15), .O(new_n102_));
  inv1   g059(.a(x16), .O(new_n103_));
  nand4  g060(.a(x20), .b(new_n103_), .c(new_n102_), .d(new_n51_), .O(new_n104_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n72_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n52_), .O(z09));
  nand3  g066(.a(new_n50_), .b(x18), .c(x01), .O(new_n110_));
  nor4   g067(.a(new_n110_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n111_));
  nand3  g068(.a(new_n51_), .b(x12), .c(new_n65_), .O(new_n112_));
  nor3   g069(.a(new_n112_), .b(new_n45_), .c(x01), .O(new_n113_));
  nand3  g070(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n114_));
  nor3   g071(.a(new_n114_), .b(new_n103_), .c(new_n102_), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n113_), .c(new_n111_), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n52_), .O(z10));
  nor2   g074(.a(new_n62_), .b(new_n98_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n105_), .c(new_n50_), .d(x18), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n66_), .O(new_n120_));
  nand3  g077(.a(new_n98_), .b(x20), .c(new_n103_), .O(new_n121_));
  nor3   g078(.a(new_n121_), .b(new_n102_), .c(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n120_), .c(new_n100_), .d(new_n65_), .O(new_n123_));
  oai21  g080(.a(new_n119_), .b(new_n44_), .c(new_n123_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n99_), .c(new_n72_), .O(new_n125_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n72_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n44_), .b(new_n72_), .O(new_n136_));
  ...
  nor3   g100(.a(new_n62_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g101(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n72_), .O(new_n145_));
