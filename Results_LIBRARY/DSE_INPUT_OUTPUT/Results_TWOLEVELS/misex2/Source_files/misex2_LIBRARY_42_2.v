...
module FAU ( 
  ...
  nand4  g018(.a(new_n52_), .b(new_n51_), .c(new_n50_), .d(new_n61_), .O(new_n62_));
  oai21  g019(.a(new_n62_), .b(new_n60_), .c(new_n45_), .O(z02));
  inv1   g020(.a(x00), .O(new_n64_));
  inv1   g021(.a(x01), .O(new_n65_));
  nand3  g022(.a(new_n46_), .b(new_n65_), .c(new_n64_), .O(new_n66_));
  nand3  g023(.a(new_n52_), .b(x18), .c(new_n50_), .O(new_n67_));
  ...
  oai22  g028(.a(new_n71_), .b(new_n70_), .c(new_n67_), .d(new_n66_), .O(z03));
  inv1   g029(.a(x11), .O(new_n73_));
  inv1   g030(.a(x12), .O(new_n74_));
  nor3   g031(.a(new_n68_), .b(x09), .c(new_n46_), .O(new_n75_));
  ...
  aoi21  g035(.a(new_n78_), .b(x16), .c(new_n65_), .O(z05));
  nand3  g036(.a(x16), .b(x11), .c(x10), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(new_n47_), .c(x02), .d(x01), .O(new_n82_));
  nor2   g039(.a(new_n82_), .b(new_n64_), .O(z06));
  nand2  g040(.a(x10), .b(new_n47_), .O(new_n84_));
  nand3  g041(.a(x16), .b(new_n74_), .c(x11), .O(new_n85_));
  ...
  nand4  g049(.a(new_n92_), .b(x02), .c(new_n65_), .d(new_n64_), .O(new_n93_));
  ...
  nand4  g053(.a(new_n96_), .b(new_n51_), .c(x17), .d(new_n89_), .O(new_n97_));
  ...
  nand4  g063(.a(new_n106_), .b(x18), .c(x16), .d(x01), .O(new_n107_));
  oai21  g064(.a(new_n105_), .b(new_n102_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n100_), .c(new_n99_), .d(new_n64_), .O(new_n109_));
  ...
  nand4  g071(.a(new_n101_), .b(new_n114_), .c(x12), .d(new_n73_), .O(new_n115_));
  nor2   g072(.a(new_n103_), .b(x14), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n100_), .c(new_n99_), .d(x20), .O(new_n117_));
  oai22  g074(.a(new_n117_), .b(new_n115_), .c(new_n113_), .d(new_n111_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(x16), .c(new_n64_), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(z10));
  nor2   g077(.a(new_n51_), .b(new_n65_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n112_), .d(new_n52_), .O(new_n122_));
  nand4  g079(.a(new_n114_), .b(x12), .c(new_n73_), .d(x02), .O(new_n123_));
  nand4  g080(.a(new_n116_), .b(new_n99_), .c(x20), .d(new_n44_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n100_), .c(new_n64_), .O(new_n126_));
  ...
  nand2  g093(.a(new_n55_), .b(x17), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x19), .O(z13));
  nand2  g095(.a(new_n55_), .b(new_n47_), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n51_), .c(new_n50_), .d(new_n61_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z14));
  aoi22  g099(.a(new_n45_), .b(x00), .c(x19), .d(new_n65_), .O(new_n143_));
  nand3  g100(.a(new_n69_), .b(x16), .c(new_n61_), .O(new_n144_));
  oai21  g101(.a(new_n143_), .b(x02), .c(new_n144_), .O(z15));
  aoi21  g102(.a(x16), .b(x00), .c(new_n65_), .O(z16));
