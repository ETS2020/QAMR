...
module FAU ( 
  ...
  nand3  g020(.a(new_n46_), .b(x02), .c(x00), .O(new_n64_));
  ...
  aoi21  g035(.a(new_n78_), .b(new_n63_), .c(new_n72_), .O(z05));
  nand4  g036(.a(new_n63_), .b(x11), .c(x10), .d(new_n46_), .O(new_n80_));
  ...
  nand3  g041(.a(new_n63_), .b(new_n74_), .c(x11), .O(new_n85_));
  ...
  nand4  g050(.a(new_n93_), .b(x02), .c(new_n72_), .d(new_n92_), .O(new_n94_));
  ...
  nand4  g054(.a(new_n97_), .b(new_n50_), .c(x17), .d(new_n89_), .O(new_n98_));
  nor2   g055(.a(new_n98_), .b(new_n51_), .O(z08));
  ...
  nor2   g064(.a(new_n50_), .b(new_n72_), .O(new_n108_));
  ...
  nand2  g069(.a(new_n112_), .b(new_n44_), .O(z09));
  nor2   g070(.a(x13), .b(new_n74_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n102_), .c(new_n73_), .O(new_n115_));
  nor3   g072(.a(new_n105_), .b(new_n104_), .c(x14), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n101_), .c(new_n100_), .d(x20), .O(new_n117_));
  or2    g074(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nor2   g075(.a(new_n100_), .b(x20), .O(new_n119_));
  nor2   g076(.a(x24), .b(new_n101_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n119_), .c(new_n69_), .d(x01), .O(new_n121_));
  aoi21  g078(.a(new_n121_), .b(new_n118_), .c(x00), .O(z10));
  nand3  g079(.a(new_n119_), .b(new_n108_), .c(new_n51_), .O(new_n123_));
  nor2   g080(.a(new_n104_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n100_), .c(x20), .d(new_n105_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n115_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n101_), .c(new_n92_), .O(new_n127_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n72_), .c(new_n92_), .O(new_n134_));
  ...
  aoi22  g100(.a(new_n44_), .b(x00), .c(x19), .d(new_n72_), .O(new_n144_));
  nand4  g101(.a(new_n63_), .b(new_n60_), .c(x01), .d(x00), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  nand3  g103(.a(new_n63_), .b(x01), .c(new_n92_), .O(new_n147_));
