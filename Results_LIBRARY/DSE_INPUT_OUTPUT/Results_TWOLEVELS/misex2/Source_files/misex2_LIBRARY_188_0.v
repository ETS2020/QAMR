...
module FAU ( 
  ...
  nor2   g020(.a(x16), .b(x06), .O(new_n64_));
  ...
  aoi21  g052(.a(new_n95_), .b(x16), .c(x06), .O(z08));
  ...
  nand4  g059(.a(new_n102_), .b(x20), .c(new_n52_), .d(new_n101_), .O(new_n103_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n74_), .O(new_n108_));
  ...
  nor3   g073(.a(new_n52_), .b(new_n101_), .c(x14), .O(new_n117_));
  ...
  nand4  g077(.a(new_n99_), .b(new_n114_), .c(x12), .d(new_n67_), .O(new_n121_));
  nand4  g078(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n50_), .O(new_n122_));
  nor2   g079(.a(new_n101_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n97_), .c(x20), .d(new_n52_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n74_), .O(new_n126_));
  ...
  oai21  g094(.a(new_n132_), .b(new_n89_), .c(new_n53_), .O(z13));
  ...
  oai21  g103(.a(new_n113_), .b(x00), .c(new_n53_), .O(z17));
endmodule
