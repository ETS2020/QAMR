...
module FAU ( 
  ...
  nand3  g024(.a(new_n67_), .b(x07), .c(x02), .O(new_n68_));
  nand4  g025(.a(x12), .b(x11), .c(x10), .d(new_n47_), .O(new_n69_));
  oai22  g026(.a(new_n69_), .b(new_n68_), .c(new_n66_), .d(new_n64_), .O(z03));
  nor2   g027(.a(x09), .b(new_n46_), .O(new_n71_));
  nor2   g028(.a(x12), .b(x11), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(x07), .c(new_n63_), .O(z04));
  nand3  g031(.a(new_n67_), .b(x07), .c(x02), .O(new_n75_));
  nor3   g032(.a(new_n75_), .b(new_n59_), .c(new_n47_), .O(z05));
  inv1   g033(.a(x11), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n59_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x07), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x07), .c(new_n63_), .O(z06));
  ...
  nand2  g043(.a(x02), .b(new_n62_), .O(new_n87_));
  inv1   g044(.a(x05), .O(new_n88_));
  nand2  g045(.a(new_n88_), .b(x04), .O(new_n89_));
  nor3   g046(.a(new_n89_), .b(new_n87_), .c(x03), .O(new_n90_));
  nand3  g047(.a(x19), .b(new_n54_), .c(x17), .O(new_n91_));
  nor3   g048(.a(new_n91_), .b(x08), .c(x06), .O(new_n92_));
  nand2  g049(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi21  g050(.a(new_n93_), .b(new_n63_), .c(x07), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n77_), .c(x02), .d(new_n63_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(x18), .c(x07), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n62_), .O(new_n105_));
  ...
  nand2  g067(.a(x02), .b(new_n63_), .O(new_n111_));
  ...
  nor2   g078(.a(x13), .b(new_n82_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n77_), .O(new_n123_));
  and2   g080(.a(x18), .b(x01), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n108_), .d(new_n65_), .O(new_n125_));
  nor2   g082(.a(new_n98_), .b(x14), .O(new_n126_));
  nor2   g083(.a(x21), .b(new_n108_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n126_), .c(new_n99_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n123_), .c(new_n125_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n96_), .c(new_n62_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n45_), .O(z11));
  inv1   g088(.a(x24), .O(new_n132_));
  nand2  g089(.a(x10), .b(x02), .O(new_n133_));
  nand4  g090(.a(new_n133_), .b(x07), .c(x01), .d(x00), .O(new_n134_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n63_), .c(new_n62_), .O(new_n138_));
  ...
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n45_), .O(z13));
  nand3  g100(.a(new_n51_), .b(new_n50_), .c(new_n59_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n49_), .c(new_n45_), .O(z14));
  aoi22  g102(.a(new_n45_), .b(x00), .c(x19), .d(new_n63_), .O(new_n146_));
  nand3  g103(.a(new_n67_), .b(new_n59_), .c(x07), .O(new_n147_));
  oai21  g104(.a(new_n146_), .b(x02), .c(new_n147_), .O(z15));
  nand3  g105(.a(x07), .b(x01), .c(new_n62_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  oai21  g107(.a(new_n111_), .b(x00), .c(new_n45_), .O(z17));
endmodule
