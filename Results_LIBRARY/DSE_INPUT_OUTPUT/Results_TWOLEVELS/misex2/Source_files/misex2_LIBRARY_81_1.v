...
module FAU ( 
  ...
  nand2  g36(.a(x01), .b(new_n59_), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(new_n79_), .O(z07));
  nor2   g38(.a(x03), .b(new_n61_), .O(new_n82_));
  ...
  aoi21  g43(.a(new_n86_), .b(new_n60_), .c(x00), .O(z08));
  inv1   g44(.a(x16), .O(new_n88_));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x13), .O(new_n90_));
  inv1   g47(.a(x14), .O(new_n91_));
  nand4  g48(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n92_));
  ...
  aoi21  g60(.a(new_n103_), .b(new_n60_), .c(x00), .O(z10));
  ...
  aoi21  g65(.a(x10), .b(x02), .c(new_n60_), .O(new_n109_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n46_), .c(new_n80_), .O(z12));
  ...
  oai21  g75(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n119_));
  oai21  g76(.a(x19), .b(x00), .c(new_n61_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n119_), .O(z15));
  nand3  g78(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n123_));
