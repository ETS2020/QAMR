...
module FAU ( 
  ...
  nor2   g020(.a(x21), .b(x07), .O(new_n64_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n50_), .c(x18), .d(new_n48_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n70_), .c(new_n64_), .O(z03));
  ...
  oai21  g040(.a(new_n83_), .b(new_n74_), .c(new_n53_), .O(z06));
  ...
  nor3   g048(.a(x08), .b(x06), .c(x05), .O(new_n92_));
  nand3  g049(.a(x19), .b(new_n49_), .c(x17), .O(new_n93_));
  inv1   g050(.a(new_n93_), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n60_), .O(new_n95_));
  aoi21  g052(.a(new_n95_), .b(x21), .c(x07), .O(z08));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n67_), .c(x02), .d(new_n44_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n52_), .d(x07), .O(new_n106_));
  ...
  nand4  g078(.a(new_n121_), .b(new_n112_), .c(x12), .d(new_n67_), .O(new_n122_));
  nor2   g079(.a(new_n49_), .b(new_n44_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n103_), .d(new_n50_), .O(new_n124_));
  nor2   g081(.a(new_n99_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n52_), .c(x20), .d(new_n100_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n122_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n74_), .O(new_n128_));
  ...
  nand4  g094(.a(new_n137_), .b(new_n53_), .c(new_n130_), .d(x09), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(z12));
  nor2   g096(.a(new_n64_), .b(x19), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  ...
  nor4   g107(.a(new_n64_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
