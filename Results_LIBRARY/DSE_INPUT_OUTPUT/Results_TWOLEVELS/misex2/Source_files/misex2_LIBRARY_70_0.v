...
module FAU ( 
  ...
  nand2  g14(.a(x01), .b(x00), .O(new_n59_));
  nand3  g15(.a(x10), .b(x09), .c(x02), .O(new_n60_));
  oai21  g16(.a(new_n60_), .b(new_n59_), .c(new_n47_), .O(z05));
  nand4  g17(.a(x11), .b(x10), .c(new_n50_), .d(x02), .O(new_n62_));
  nor3   g18(.a(new_n62_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand3  g19(.a(new_n49_), .b(x11), .c(x10), .O(new_n64_));
  ...
  nor2   g25(.a(x22), .b(x21), .O(new_n70_));
  nand4  g26(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(x18), .O(new_n71_));
  aoi21  g27(.a(new_n71_), .b(x01), .c(x00), .O(z09));
  nand4  g28(.a(new_n68_), .b(x18), .c(x01), .d(new_n45_), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(new_n74_));
  nand4  g30(.a(new_n74_), .b(x22), .c(x21), .d(new_n69_), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(z10));
  inv1   g32(.a(x22), .O(new_n77_));
  nand4  g33(.a(new_n74_), .b(new_n77_), .c(x21), .d(new_n69_), .O(new_n78_));
  inv1   g34(.a(new_n78_), .O(z11));
  aoi21  g35(.a(x10), .b(x02), .c(x24), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(x09), .c(x01), .O(new_n81_));
  nor2   g37(.a(new_n81_), .b(new_n45_), .O(z12));
  inv1   g38(.a(x02), .O(new_n83_));
  inv1   g39(.a(x10), .O(new_n84_));
  aoi21  g40(.a(new_n84_), .b(x01), .c(new_n83_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n45_), .c(new_n47_), .O(z15));
  nor2   g42(.a(new_n46_), .b(x00), .O(z16));
  zero   g43(.O(z00));
  zero   g44(.O(z17));
  inv1   g45(.a(new_n47_), .O(z02));
  inv1   g46(.a(new_n47_), .O(z08));
  inv1   g47(.a(new_n47_), .O(z13));
  inv1   g48(.a(new_n47_), .O(z14));
endmodule
