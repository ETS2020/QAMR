...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    ...
    new_n84_, new_n87_, new_n88_, new_n89_;
  ...
  nand4  g17(.a(x11), .b(x10), .c(new_n48_), .d(x02), .O(new_n63_));
  nor3   g18(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z06));
  oai21  g19(.a(x02), .b(new_n61_), .c(new_n62_), .O(new_n65_));
  nand4  g20(.a(new_n47_), .b(x11), .c(x10), .d(new_n48_), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(new_n54_), .c(new_n65_), .O(z07));
  ...
  nand4  g32(.a(new_n78_), .b(x18), .c(x01), .d(new_n61_), .O(new_n79_));
  inv1   g33(.a(new_n79_), .O(new_n80_));
  nand4  g34(.a(new_n80_), .b(new_n77_), .c(x21), .d(new_n74_), .O(new_n81_));
  inv1   g35(.a(new_n81_), .O(z11));
  aoi21  g36(.a(x10), .b(x02), .c(x24), .O(new_n83_));
  nand4  g37(.a(new_n83_), .b(x09), .c(x01), .d(x00), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n53_), .O(z12));
  inv1   g39(.a(x02), .O(new_n87_));
  inv1   g40(.a(x10), .O(new_n88_));
  aoi21  g41(.a(new_n88_), .b(x01), .c(new_n87_), .O(new_n89_));
  oai21  g42(.a(new_n89_), .b(new_n61_), .c(new_n53_), .O(z15));
  nor2   g43(.a(new_n62_), .b(x00), .O(z16));
  zero   g44(.O(z01));
  zero   g45(.O(z02));
  zero   g46(.O(z08));
  zero   g47(.O(z13));
