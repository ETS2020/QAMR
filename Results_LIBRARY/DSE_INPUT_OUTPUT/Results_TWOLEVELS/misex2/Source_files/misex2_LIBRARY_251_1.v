...
module FAU ( 
  ...
  inv1   g014(.a(new_n45_), .O(new_n58_));
  nor2   g015(.a(new_n58_), .b(x19), .O(new_n59_));
  nand3  g016(.a(new_n59_), .b(new_n52_), .c(new_n51_), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x10), .O(new_n61_));
  nand4  g018(.a(new_n61_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n62_));
  nor2   g019(.a(new_n62_), .b(x00), .O(z02));
  nand3  g020(.a(new_n59_), .b(x18), .c(new_n51_), .O(new_n64_));
  ...
  nor2   g026(.a(new_n44_), .b(new_n69_), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n68_), .c(x10), .d(new_n49_), .O(new_n71_));
  nand2  g028(.a(new_n71_), .b(new_n66_), .O(z03));
  inv1   g029(.a(x14), .O(new_n73_));
  nand4  g030(.a(new_n68_), .b(new_n69_), .c(x10), .d(new_n49_), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(new_n73_), .c(x12), .O(z04));
  ...
  nand4  g065(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n46_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n45_), .O(z09));
  nand4  g067(.a(new_n45_), .b(x22), .c(x21), .d(new_n106_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n53_), .c(x18), .d(x01), .O(new_n113_));
  nor2   g070(.a(x13), .b(new_n44_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n100_), .c(new_n69_), .O(new_n115_));
  ...
  nor2   g077(.a(new_n58_), .b(new_n98_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n106_), .c(new_n53_), .d(x18), .O(new_n122_));
  nor2   g079(.a(new_n102_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n124_));
  oai22  g081(.a(new_n124_), .b(new_n115_), .c(new_n122_), .d(new_n47_), .O(new_n125_));
  ...
  nand4  g093(.a(new_n59_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x00), .O(z13));
  nand4  g095(.a(new_n61_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  ...
  oai21  g101(.a(new_n47_), .b(x00), .c(new_n45_), .O(z16));
  nand2  g102(.a(new_n100_), .b(new_n46_), .O(new_n146_));
