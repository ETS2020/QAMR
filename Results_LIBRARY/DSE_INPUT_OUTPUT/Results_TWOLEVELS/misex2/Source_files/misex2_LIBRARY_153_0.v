...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n73_, new_n75_, new_n77_, new_n79_, new_n80_, new_n83_;
  ...
  nor3   g15(.a(new_n59_), .b(new_n46_), .c(new_n45_), .O(z06));
  ...
  nand4  g25(.a(new_n70_), .b(x18), .c(x01), .d(new_n45_), .O(new_n71_));
  ...
  nand4  g31(.a(new_n72_), .b(new_n69_), .c(x21), .d(new_n67_), .O(new_n77_));
  ...
  nand2  g36(.a(new_n57_), .b(x01), .O(new_n83_));
  aoi21  g37(.a(new_n83_), .b(x02), .c(new_n45_), .O(z15));
  nor2   g38(.a(new_n46_), .b(x00), .O(z16));
  zero   g39(.O(z00));
  zero   g40(.O(z08));
  zero   g41(.O(z14));
  zero   g42(.O(z17));
  inv1   g43(.a(new_n47_), .O(z02));
  inv1   g44(.a(new_n47_), .O(z13));
endmodule
