...
module FAU ( 
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n87_));
  ...
  nand4  g47(.a(new_n90_), .b(new_n46_), .c(x17), .d(new_n44_), .O(new_n91_));
  ...
  nand3  g52(.a(new_n95_), .b(x12), .c(new_n44_), .O(new_n96_));
  ...
  nand3  g66(.a(new_n109_), .b(x12), .c(new_n44_), .O(new_n110_));
  ...
  nand3  g74(.a(new_n95_), .b(new_n109_), .c(x12), .O(new_n118_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n94_), .c(new_n48_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n69_), .O(z11));
  ...
  nor4   g89(.a(new_n51_), .b(x19), .c(new_n45_), .d(x11), .O(z13));
  ...
  aoi21  g93(.a(x19), .b(new_n50_), .c(x11), .O(new_n137_));
  oai22  g94(.a(new_n137_), .b(x01), .c(new_n136_), .d(new_n48_), .O(z15));
  nor2   g95(.a(new_n49_), .b(x00), .O(z16));
  nand2  g96(.a(x02), .b(new_n48_), .O(new_n140_));
  aoi21  g97(.a(new_n140_), .b(new_n44_), .c(x01), .O(z17));
endmodule
