...
module FAU ( 
  ...
  aoi21  g30(.a(new_n73_), .b(new_n55_), .c(new_n67_), .O(new_n74_));
  ...
  nand4  g45(.a(new_n88_), .b(new_n54_), .c(x17), .d(new_n81_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n67_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n95_));
