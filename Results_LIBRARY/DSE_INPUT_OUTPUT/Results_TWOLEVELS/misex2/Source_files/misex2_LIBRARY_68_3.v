...
module FAU ( 
  ...
  nand4  g48(.a(new_n92_), .b(new_n82_), .c(new_n81_), .d(new_n59_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(z09));
  nand2  g50(.a(new_n65_), .b(x18), .O(new_n95_));
  nand3  g51(.a(x22), .b(x21), .c(new_n90_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n95_), .c(new_n59_), .O(new_n97_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n99_), .c(x12), .d(new_n83_), .O(new_n102_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n102_), .c(new_n98_), .O(z10));
  nand3  g63(.a(new_n82_), .b(x21), .c(new_n90_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n95_), .c(new_n59_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x01), .O(new_n110_));
  nand4  g66(.a(new_n105_), .b(new_n87_), .c(x15), .d(new_n103_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n102_), .c(new_n110_), .O(z11));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g69(.a(new_n65_), .b(x17), .c(new_n63_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(x24), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(x09), .c(new_n60_), .O(new_n116_));
  nor2   g72(.a(new_n116_), .b(x00), .O(z12));
  nand2  g73(.a(new_n47_), .b(x17), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(x19), .O(z13));
  nand4  g75(.a(new_n46_), .b(new_n63_), .c(new_n60_), .d(new_n59_), .O(new_n120_));
  nand4  g76(.a(new_n65_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n120_), .c(new_n62_), .O(z14));
  nand3  g78(.a(x19), .b(new_n63_), .c(new_n60_), .O(new_n123_));
  oai21  g79(.a(new_n84_), .b(new_n59_), .c(new_n123_), .O(z15));
  nand2  g80(.a(new_n100_), .b(new_n62_), .O(z17));
  zero   g81(.O(z04));
