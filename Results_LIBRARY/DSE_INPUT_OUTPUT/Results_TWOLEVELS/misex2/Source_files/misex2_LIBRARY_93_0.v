...
module FAU ( 
  ...
  nand4  g16(.a(x11), .b(x10), .c(new_n61_), .d(x02), .O(new_n62_));
  nor3   g17(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z06));
  oai21  g18(.a(x02), .b(new_n59_), .c(new_n60_), .O(new_n64_));
  inv1   g19(.a(x12), .O(new_n65_));
  nand3  g20(.a(new_n50_), .b(new_n65_), .c(x11), .O(new_n66_));
  ...
  nand4  g26(.a(new_n72_), .b(x18), .c(x01), .d(new_n59_), .O(new_n73_));
  ...
  nand2  g38(.a(new_n49_), .b(x01), .O(new_n87_));
  aoi21  g39(.a(new_n87_), .b(x02), .c(new_n59_), .O(z15));
