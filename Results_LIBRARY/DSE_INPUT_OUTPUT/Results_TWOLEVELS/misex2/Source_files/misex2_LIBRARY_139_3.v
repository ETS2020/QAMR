...
module FAU ( 
  ...
  nand2  g000(.a(x12), .b(x05), .O(new_n44_));
  ...
  nand4  g017(.a(new_n60_), .b(x09), .c(new_n47_), .d(new_n46_), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(x00), .O(z02));
  inv1   g019(.a(x05), .O(new_n63_));
  nand3  g020(.a(x02), .b(x01), .c(x00), .O(new_n64_));
  nand4  g021(.a(x11), .b(x10), .c(new_n48_), .d(new_n63_), .O(new_n65_));
  ...
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(new_n48_), .O(new_n73_));
  oai21  g030(.a(new_n73_), .b(new_n64_), .c(new_n44_), .O(z04));
  nand4  g031(.a(new_n44_), .b(x10), .c(x09), .d(x02), .O(new_n75_));
  nor3   g032(.a(new_n75_), .b(new_n46_), .c(new_n45_), .O(z05));
  nand2  g033(.a(x12), .b(x05), .O(new_n77_));
  ...
  inv1   g038(.a(new_n44_), .O(new_n82_));
  nand2  g039(.a(new_n48_), .b(x01), .O(new_n83_));
  ...
  nand2  g045(.a(new_n88_), .b(new_n45_), .O(new_n89_));
  inv1   g046(.a(x03), .O(new_n90_));
  nand3  g047(.a(new_n63_), .b(x04), .c(new_n90_), .O(new_n91_));
  ...
  nor2   g061(.a(new_n51_), .b(new_n46_), .O(new_n105_));
  ...
  nand4  g079(.a(new_n88_), .b(new_n114_), .c(x12), .d(new_n71_), .O(new_n123_));
  ...
  nand4  g098(.a(new_n60_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n142_));
  ...
  aoi21  g103(.a(new_n146_), .b(new_n145_), .c(new_n82_), .O(z15));
  nand3  g104(.a(new_n44_), .b(x01), .c(new_n45_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n89_), .b(new_n44_), .O(z17));
endmodule
