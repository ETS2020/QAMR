...
module FAU ( 
  ...
  nand2  g000(.a(x15), .b(x07), .O(new_n44_));
  ...
  nor3   g034(.a(new_n77_), .b(new_n54_), .c(new_n70_), .O(z05));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n70_), .O(new_n91_));
  ...
  aoi21  g053(.a(x15), .b(x07), .c(x20), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n51_), .c(x18), .d(x01), .O(new_n98_));
  nand3  g055(.a(new_n88_), .b(x12), .c(new_n71_), .O(new_n99_));
  ...
  oai21  g060(.a(new_n103_), .b(new_n99_), .c(new_n98_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n96_), .c(new_n95_), .d(new_n70_), .O(new_n105_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n112_), .c(x12), .d(new_n71_), .O(new_n121_));
  nor2   g078(.a(new_n50_), .b(new_n54_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n108_), .d(new_n51_), .O(new_n123_));
  nor2   g080(.a(new_n100_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n95_), .c(x20), .d(new_n101_), .O(new_n125_));
  ...
  oai21  g097(.a(new_n61_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g098(.a(x10), .b(new_n54_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n45_), .c(new_n54_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .O(z15));
  nand3  g102(.a(new_n44_), .b(x01), .c(new_n70_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand4  g104(.a(new_n44_), .b(x02), .c(new_n54_), .d(new_n70_), .O(new_n148_));
