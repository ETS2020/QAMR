...
module FAU ( 
  ...
  nand2  g065(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  oai21  g066(.a(new_n106_), .b(new_n102_), .c(new_n109_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n100_), .c(new_n99_), .d(new_n57_), .O(new_n111_));
  nand2  g068(.a(new_n111_), .b(new_n52_), .O(z09));
  nor2   g069(.a(x13), .b(new_n67_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n101_), .c(new_n66_), .O(new_n114_));
  ...
  nor2   g075(.a(new_n99_), .b(x20), .O(new_n119_));
  nor2   g076(.a(new_n51_), .b(new_n100_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n119_), .c(new_n71_), .d(x01), .O(new_n121_));
  aoi21  g078(.a(new_n121_), .b(new_n118_), .c(x00), .O(z10));
  nand3  g079(.a(new_n119_), .b(new_n107_), .c(new_n50_), .O(new_n123_));
  nor2   g080(.a(new_n103_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n99_), .c(x20), .d(new_n104_), .O(new_n125_));
  ...
  aoi21  g093(.a(new_n136_), .b(new_n99_), .c(x24), .O(z12));
