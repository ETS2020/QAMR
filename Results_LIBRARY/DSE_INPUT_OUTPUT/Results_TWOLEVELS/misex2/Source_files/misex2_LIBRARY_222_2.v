...
module FAU ( 
  ...
  oai21  g53(.a(new_n96_), .b(new_n91_), .c(new_n46_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  nor3   g55(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n99_));
  ...
  oai21  g60(.a(new_n103_), .b(new_n91_), .c(new_n46_), .O(new_n104_));
  ...
  oai21  g66(.a(new_n109_), .b(new_n91_), .c(new_n46_), .O(new_n110_));
  ...
  aoi21  g72(.a(x10), .b(x02), .c(new_n46_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n66_), .b(x17), .c(new_n48_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n117_), .c(x01), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n116_), .c(new_n115_), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(new_n49_), .c(x01), .d(new_n46_), .O(z12));
  aoi21  g78(.a(new_n118_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g79(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n46_), .c(x01), .O(z14));
  inv1   g81(.a(new_n116_), .O(new_n125_));
  aoi21  g82(.a(x19), .b(new_n48_), .c(x00), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(x01), .c(new_n125_), .O(z15));
  xor2a  g84(.a(x01), .b(x00), .O(z16));
  nand3  g85(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n129_));
