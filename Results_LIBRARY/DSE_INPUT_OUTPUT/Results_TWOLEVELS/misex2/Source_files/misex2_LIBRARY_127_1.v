...
module FAU ( 
  ...
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(x11), .d(x01), .O(new_n80_));
  ...
  nor2   g66(.a(x13), .b(new_n70_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n96_), .c(new_n44_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n64_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n119_), .b(new_n95_), .c(new_n48_), .O(new_n120_));
  ...
  nand4  g91(.a(new_n134_), .b(new_n133_), .c(new_n45_), .d(new_n47_), .O(new_n135_));
  aoi21  g92(.a(new_n135_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g93(.a(new_n44_), .b(new_n50_), .c(new_n122_), .O(new_n137_));
  nand4  g94(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n138_));
