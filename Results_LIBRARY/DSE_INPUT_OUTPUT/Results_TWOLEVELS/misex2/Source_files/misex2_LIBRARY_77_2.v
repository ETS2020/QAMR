...
module FAU ( 
  ...
  nand3  g16(.a(new_n49_), .b(x02), .c(x01), .O(new_n60_));
  ...
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n46_), .O(z07));
  ...
  nand4  g57(.a(new_n94_), .b(x12), .c(new_n69_), .d(x02), .O(new_n101_));
  ...
  nand3  g74(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n47_), .c(new_n46_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n114_), .c(x09), .O(new_n122_));
  inv1   g79(.a(new_n122_), .O(z12));
  nand3  g80(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n124_));
  nor3   g81(.a(new_n124_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g82(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z14));
  aoi21  g84(.a(x19), .b(new_n48_), .c(x00), .O(new_n128_));
  nand2  g85(.a(new_n115_), .b(x00), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(x01), .c(new_n129_), .O(z15));
  xor2a  g87(.a(x01), .b(x00), .O(z16));
  nand3  g88(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n132_));
