...
module FAU ( 
  ...
  aoi21  g031(.a(new_n74_), .b(new_n47_), .c(new_n57_), .O(z04));
  nand3  g032(.a(new_n69_), .b(x09), .c(x02), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n47_), .c(new_n57_), .O(z05));
  nand2  g034(.a(x12), .b(x03), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x11), .c(new_n53_), .d(x02), .O(new_n79_));
  inv1   g036(.a(new_n79_), .O(new_n80_));
  nand3  g037(.a(new_n80_), .b(x01), .c(x00), .O(new_n81_));
  aoi21  g038(.a(new_n81_), .b(new_n47_), .c(new_n57_), .O(z06));
  ...
  nand2  g043(.a(new_n86_), .b(new_n65_), .O(z07));
  inv1   g044(.a(x08), .O(new_n88_));
  inv1   g045(.a(x05), .O(new_n89_));
  inv1   g046(.a(x06), .O(new_n90_));
  nand4  g047(.a(new_n47_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n91_));
  ...
  nor2   g063(.a(new_n45_), .b(new_n63_), .O(new_n107_));
  ...
  nor2   g070(.a(x13), .b(new_n83_), .O(new_n114_));
  ...
  nand3  g075(.a(new_n118_), .b(new_n65_), .c(new_n62_), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(z10));
  nand4  g077(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n64_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n98_), .c(new_n62_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n65_), .O(z11));
  oai21  g083(.a(x03), .b(x02), .c(x10), .O(new_n127_));
  ...
  nand4  g088(.a(new_n131_), .b(new_n65_), .c(new_n63_), .d(new_n62_), .O(new_n132_));
  ...
  nand3  g094(.a(new_n48_), .b(new_n53_), .c(new_n46_), .O(new_n138_));
  nand4  g095(.a(new_n64_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n138_), .c(new_n65_), .O(z14));
  oai21  g097(.a(new_n64_), .b(x01), .c(new_n62_), .O(new_n141_));
  nand3  g098(.a(new_n141_), .b(new_n65_), .c(new_n46_), .O(new_n142_));
  nand3  g099(.a(new_n57_), .b(x01), .c(x00), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(new_n142_), .O(z15));
  oai21  g101(.a(new_n63_), .b(x00), .c(new_n65_), .O(z16));
  nand2  g102(.a(new_n100_), .b(new_n62_), .O(new_n146_));
