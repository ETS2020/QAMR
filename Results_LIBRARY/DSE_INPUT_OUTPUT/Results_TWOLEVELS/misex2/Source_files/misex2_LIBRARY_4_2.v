...
module FAU ( 
  ...
  aoi21  g25(.a(x12), .b(new_n55_), .c(new_n63_), .O(new_n69_));
  ...
  nand4  g30(.a(new_n73_), .b(new_n72_), .c(x11), .d(x10), .O(new_n74_));
  ...
  nand4  g43(.a(x12), .b(new_n63_), .c(x02), .d(new_n55_), .O(new_n87_));
  ...
  nand4  g54(.a(new_n90_), .b(x12), .c(new_n63_), .d(x02), .O(new_n98_));
  ...
  nand4  g63(.a(new_n92_), .b(x21), .c(new_n106_), .d(new_n58_), .O(new_n107_));
  nor2   g64(.a(new_n45_), .b(x01), .O(new_n108_));
  nor2   g65(.a(x13), .b(new_n72_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n108_), .c(new_n63_), .O(new_n110_));
  ...
  nand3  g77(.a(new_n58_), .b(x17), .c(new_n45_), .O(new_n121_));
  ...
  nand4  g86(.a(new_n129_), .b(new_n80_), .c(new_n57_), .d(new_n52_), .O(new_n130_));
  ...
  nor2   g91(.a(new_n55_), .b(x00), .O(z16));
