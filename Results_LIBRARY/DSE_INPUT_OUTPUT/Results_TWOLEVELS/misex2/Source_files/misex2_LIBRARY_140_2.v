...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n129_, new_n130_, new_n133_, new_n135_;
  ...
  nand4  g31(.a(x11), .b(x10), .c(new_n47_), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n61_), .c(new_n60_), .O(z06));
  inv1   g33(.a(x11), .O(new_n77_));
  nor2   g34(.a(x12), .b(new_n77_), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n62_), .c(x10), .d(x01), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n61_), .d(new_n60_), .O(new_n85_));
  ...
  nand4  g48(.a(new_n91_), .b(x12), .c(new_n77_), .d(x02), .O(new_n92_));
  ...
  oai21  g55(.a(new_n98_), .b(new_n92_), .c(new_n60_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n61_), .O(new_n100_));
  nor2   g57(.a(new_n45_), .b(new_n61_), .O(new_n101_));
  nor2   g58(.a(x20), .b(x19), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n101_), .c(new_n95_), .d(new_n60_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n100_), .O(z09));
  inv1   g61(.a(x21), .O(new_n105_));
  inv1   g62(.a(x22), .O(new_n106_));
  nor3   g63(.a(new_n106_), .b(new_n105_), .c(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n66_), .c(x18), .d(x01), .O(new_n108_));
  inv1   g65(.a(x13), .O(new_n109_));
  nor2   g66(.a(new_n46_), .b(x01), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n109_), .c(x12), .d(new_n77_), .O(new_n111_));
  nor3   g68(.a(new_n94_), .b(new_n93_), .c(x14), .O(new_n112_));
  ...
  nor2   g72(.a(new_n105_), .b(x20), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n101_), .c(new_n66_), .O(new_n117_));
  nor2   g74(.a(new_n93_), .b(x14), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n105_), .c(x20), .d(new_n94_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n111_), .c(new_n117_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n106_), .c(new_n60_), .O(new_n121_));
  ...
  nand2  g92(.a(new_n135_), .b(new_n124_), .O(z15));
  xor2a  g93(.a(x01), .b(x00), .O(z16));
  aoi21  g94(.a(new_n46_), .b(new_n60_), .c(x01), .O(z17));
endmodule
