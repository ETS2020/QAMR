...
module FAU ( 
  ...
  nand3  g39(.a(x02), .b(new_n52_), .c(x00), .O(new_n83_));
  ...
  nand4  g45(.a(new_n88_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n89_));
  ...
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n53_), .O(new_n106_));
  inv1   g63(.a(x15), .O(new_n107_));
  nor2   g64(.a(new_n95_), .b(new_n107_), .O(new_n108_));
  nor2   g65(.a(x22), .b(x21), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n108_), .c(new_n106_), .d(x20), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n52_), .c(x00), .O(z10));
  nor2   g68(.a(new_n101_), .b(new_n107_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n96_), .c(x20), .d(new_n95_), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x22), .O(z11));
  inv1   g71(.a(x24), .O(new_n115_));
  aoi21  g72(.a(x10), .b(x02), .c(new_n52_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n64_), .b(x17), .c(new_n53_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n117_), .c(x00), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n116_), .c(new_n115_), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(new_n46_), .c(new_n52_), .d(x00), .O(z12));
  nand2  g78(.a(new_n47_), .b(x17), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x19), .O(z13));
  nand4  g80(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n124_));
  ...
  nor2   g85(.a(new_n52_), .b(x00), .O(z16));
  nand3  g86(.a(x02), .b(new_n52_), .c(new_n62_), .O(new_n130_));
