...
module FAU ( 
  ...
  nand4  g22(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(x10), .O(new_n66_));
  ...
  aoi21  g26(.a(x12), .b(new_n55_), .c(new_n63_), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(x10), .c(new_n46_), .d(x02), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x01), .c(new_n44_), .O(z06));
  nand4  g29(.a(new_n65_), .b(new_n64_), .c(x11), .d(x10), .O(new_n73_));
  ...
  nand4  g43(.a(new_n86_), .b(x12), .c(new_n63_), .d(x02), .O(new_n87_));
  ...
  nor3   g52(.a(new_n76_), .b(new_n55_), .c(x00), .O(new_n96_));
  ...
  nor4   g60(.a(new_n103_), .b(x13), .c(new_n64_), .d(x11), .O(new_n104_));
  nor3   g61(.a(new_n89_), .b(new_n88_), .c(x14), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n104_), .c(new_n92_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n102_), .c(x00), .O(z10));
  nand3  g64(.a(new_n92_), .b(new_n89_), .c(x15), .O(new_n108_));
  oai21  g65(.a(new_n108_), .b(new_n87_), .c(new_n44_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n55_), .O(new_n110_));
  inv1   g67(.a(x22), .O(new_n111_));
  nand4  g68(.a(new_n97_), .b(new_n96_), .c(new_n111_), .d(x21), .O(new_n112_));
  ...
  nand3  g73(.a(new_n58_), .b(x17), .c(new_n45_), .O(new_n117_));
  ...
  nand3  g79(.a(new_n122_), .b(new_n46_), .c(new_n45_), .O(new_n123_));
  inv1   g80(.a(new_n123_), .O(new_n124_));
  nand4  g81(.a(new_n124_), .b(new_n76_), .c(new_n57_), .d(new_n52_), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z14));
  nand2  g83(.a(x10), .b(x02), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(x01), .c(x00), .O(new_n128_));
  nand3  g85(.a(new_n122_), .b(x19), .c(new_n45_), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n128_), .O(z15));
  xor2a  g87(.a(x01), .b(x00), .O(z16));
  nand2  g88(.a(new_n122_), .b(x02), .O(new_n132_));
