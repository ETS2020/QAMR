...
module FAU ( 
  ...
  nand4  g33(.a(new_n76_), .b(new_n60_), .c(x10), .d(x01), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x01), .c(new_n46_), .O(z07));
  ...
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n68_), .d(x02), .O(new_n90_));
  ...
  oai21  g51(.a(new_n94_), .b(new_n90_), .c(new_n46_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  nor3   g53(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n97_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n90_), .c(new_n46_), .O(new_n102_));
  ...
  nor2   g64(.a(new_n107_), .b(x20), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n64_), .c(x18), .d(x01), .O(new_n109_));
  inv1   g66(.a(x13), .O(new_n110_));
  nor2   g67(.a(new_n48_), .b(x01), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n110_), .c(x12), .d(new_n68_), .O(new_n112_));
  nor2   g69(.a(new_n91_), .b(x14), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n107_), .c(x20), .d(new_n92_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n112_), .c(new_n109_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n106_), .c(new_n46_), .O(new_n116_));
  ...
  nand3  g77(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n120_), .c(x01), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  oai22  g80(.a(new_n123_), .b(new_n49_), .c(x01), .d(new_n46_), .O(z12));
  aoi21  g81(.a(new_n121_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g82(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n46_), .c(x01), .O(z14));
  inv1   g84(.a(new_n119_), .O(new_n128_));
  aoi21  g85(.a(x19), .b(new_n48_), .c(x00), .O(new_n129_));
  oai21  g86(.a(new_n129_), .b(x01), .c(new_n128_), .O(z15));
  nor2   g87(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g88(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
