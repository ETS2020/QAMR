...
module FAU ( 
  ...
  nand2  g19(.a(new_n50_), .b(new_n48_), .O(new_n63_));
  inv1   g20(.a(x19), .O(new_n64_));
  nand3  g21(.a(new_n64_), .b(x18), .c(new_n45_), .O(new_n65_));
  oai21  g22(.a(new_n65_), .b(new_n63_), .c(new_n44_), .O(new_n66_));
  ...
  nand4  g30(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n51_), .O(new_n74_));
  ...
  oai21  g35(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(z05));
  nand4  g36(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n80_));
  nor3   g37(.a(new_n80_), .b(new_n49_), .c(new_n48_), .O(z06));
  ...
  nand2  g42(.a(new_n85_), .b(new_n77_), .O(z07));
  ...
  nand3  g48(.a(x19), .b(new_n46_), .c(x17), .O(new_n92_));
  ...
  nand4  g54(.a(x12), .b(new_n71_), .c(x02), .d(new_n49_), .O(new_n98_));
  ...
  nand2  g60(.a(new_n103_), .b(new_n64_), .O(new_n104_));
  ...
  nand2  g63(.a(new_n106_), .b(new_n77_), .O(z09));
  nand3  g64(.a(x18), .b(x01), .c(new_n48_), .O(new_n108_));
  nand4  g65(.a(x22), .b(x21), .c(new_n103_), .d(new_n64_), .O(new_n109_));
  oai21  g66(.a(new_n109_), .b(new_n108_), .c(new_n77_), .O(z10));
  nand4  g67(.a(new_n64_), .b(x18), .c(x01), .d(new_n48_), .O(new_n111_));
  ...
  nand3  g75(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n119_));
  ...
  nand2  g80(.a(new_n123_), .b(new_n77_), .O(z12));
  nand4  g81(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n44_), .c(x01), .O(z13));
  nor2   g83(.a(new_n52_), .b(x10), .O(new_n127_));
  nand4  g84(.a(new_n127_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n128_));
  ...
  oai21  g89(.a(new_n49_), .b(x00), .c(new_n77_), .O(z16));
  nand4  g90(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n134_));
