...
module FAU ( 
  ...
  nor3   g16(.a(new_n61_), .b(new_n47_), .c(new_n46_), .O(z06));
  ...
  nand4  g31(.a(new_n76_), .b(x18), .c(x01), .d(new_n46_), .O(new_n77_));
  ...
  nand2  g37(.a(new_n82_), .b(new_n48_), .O(z12));
  nand2  g38(.a(new_n58_), .b(x01), .O(new_n85_));
  aoi21  g39(.a(new_n85_), .b(x02), .c(new_n46_), .O(z15));
  nor2   g40(.a(new_n47_), .b(x00), .O(z16));
  zero   g41(.O(z00));
  zero   g42(.O(z01));
  zero   g43(.O(z14));
  inv1   g44(.a(new_n48_), .O(z08));
  inv1   g45(.a(new_n48_), .O(z13));
