...
module FAU ( 
  ...
  aoi21  g29(.a(x12), .b(new_n52_), .c(new_n66_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n44_), .O(z06));
  nand4  g32(.a(new_n68_), .b(new_n67_), .c(x11), .d(x10), .O(new_n76_));
  ...
  nor2   g43(.a(new_n86_), .b(new_n61_), .O(z08));
  ...
  nand3  g72(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n116_));
  ...
  aoi21  g76(.a(new_n116_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g77(.a(new_n46_), .b(new_n45_), .c(new_n52_), .d(new_n44_), .O(new_n121_));
  inv1   g78(.a(new_n121_), .O(new_n122_));
  nand4  g79(.a(new_n122_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n123_));
  nor2   g80(.a(new_n123_), .b(x19), .O(z14));
  inv1   g81(.a(new_n114_), .O(new_n125_));
  aoi21  g82(.a(x19), .b(new_n45_), .c(x00), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(x01), .c(new_n125_), .O(z15));
  xor2a  g84(.a(x01), .b(x00), .O(z16));
  aoi21  g85(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
