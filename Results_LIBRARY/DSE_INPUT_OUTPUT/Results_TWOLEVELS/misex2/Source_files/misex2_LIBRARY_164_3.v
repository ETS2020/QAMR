...
module FAU ( 
  ...
  nand2  g008(.a(x08), .b(x01), .O(new_n52_));
  ...
  nand4  g016(.a(new_n47_), .b(new_n44_), .c(new_n59_), .d(x09), .O(new_n60_));
  nor3   g017(.a(new_n60_), .b(x19), .c(x18), .O(z02));
  inv1   g018(.a(x00), .O(new_n62_));
  inv1   g019(.a(x01), .O(new_n63_));
  nand3  g020(.a(new_n53_), .b(new_n63_), .c(new_n62_), .O(new_n64_));
  nand3  g021(.a(new_n56_), .b(x18), .c(new_n44_), .O(new_n65_));
  inv1   g022(.a(x08), .O(new_n66_));
  ...
  nor2   g028(.a(new_n71_), .b(x08), .O(new_n72_));
  ...
  aoi21  g032(.a(new_n75_), .b(new_n66_), .c(new_n63_), .O(z05));
  nor3   g033(.a(new_n70_), .b(new_n59_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n66_), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n62_), .O(z06));
  nand2  g036(.a(new_n46_), .b(new_n66_), .O(new_n80_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n62_), .O(new_n90_));
  ...
  nand4  g052(.a(x12), .b(new_n70_), .c(x02), .d(new_n63_), .O(new_n96_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n62_), .O(new_n105_));
  ...
  nand2  g066(.a(x02), .b(new_n63_), .O(new_n110_));
  ...
  nand3  g077(.a(new_n120_), .b(new_n87_), .c(new_n70_), .O(new_n121_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n95_), .c(new_n62_), .O(new_n127_));
  ...
  nand3  g089(.a(new_n56_), .b(x17), .c(new_n53_), .O(new_n133_));
  ...
  nand2  g095(.a(new_n47_), .b(x17), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z13));
  nand4  g097(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z14));
  oai21  g099(.a(x10), .b(new_n63_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n53_), .c(new_n63_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n52_), .O(z15));
  nand3  g103(.a(new_n66_), .b(x01), .c(new_n62_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n54_), .b(x02), .O(new_n149_));
