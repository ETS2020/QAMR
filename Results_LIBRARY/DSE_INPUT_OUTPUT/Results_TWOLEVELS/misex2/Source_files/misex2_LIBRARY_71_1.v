...
module FAU ( 
  ...
  nand2  g010(.a(x18), .b(new_n53_), .O(new_n54_));
  ...
  nand4  g020(.a(new_n48_), .b(new_n56_), .c(new_n44_), .d(new_n46_), .O(new_n64_));
  nand2  g021(.a(new_n64_), .b(x14), .O(new_n65_));
  ...
  oai21  g030(.a(new_n73_), .b(new_n67_), .c(new_n54_), .O(z04));
  inv1   g031(.a(x00), .O(new_n75_));
  inv1   g032(.a(new_n54_), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n75_), .O(z05));
  inv1   g036(.a(x01), .O(new_n80_));
  nand4  g037(.a(new_n54_), .b(x11), .c(x10), .d(new_n47_), .O(new_n81_));
  nor4   g038(.a(new_n81_), .b(new_n46_), .c(new_n80_), .d(new_n75_), .O(z06));
  ...
  nor2   g050(.a(new_n56_), .b(x18), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(x17), .O(new_n95_));
  nand2  g052(.a(new_n95_), .b(new_n54_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n71_), .c(x02), .d(new_n80_), .O(new_n99_));
  ...
  nand3  g062(.a(new_n105_), .b(new_n104_), .c(new_n56_), .O(new_n106_));
  ...
  nand2  g065(.a(new_n108_), .b(new_n54_), .O(z09));
  nand3  g066(.a(new_n56_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n104_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g069(.a(x02), .b(new_n80_), .O(new_n113_));
  ...
  nand3  g073(.a(x16), .b(x15), .c(new_n53_), .O(new_n117_));
  ...
  nand4  g080(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n56_), .O(new_n124_));
  ...
  nand2  g086(.a(new_n129_), .b(new_n54_), .O(z11));
  ...
  nand3  g091(.a(new_n56_), .b(x17), .c(new_n46_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n80_), .c(new_n75_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n131_), .c(x09), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n54_), .O(z12));
  nor2   g097(.a(new_n76_), .b(x19), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(x17), .c(new_n46_), .d(new_n80_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x00), .O(z13));
  nand4  g100(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n144_));
  nor2   g101(.a(new_n144_), .b(x19), .O(z14));
  oai21  g102(.a(x10), .b(new_n80_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n46_), .c(new_n80_), .O(new_n148_));
  aoi21  g105(.a(new_n148_), .b(new_n147_), .c(new_n76_), .O(z15));
  nor3   g106(.a(new_n76_), .b(new_n80_), .c(x00), .O(z16));
  nand2  g107(.a(new_n88_), .b(new_n54_), .O(z17));
endmodule
