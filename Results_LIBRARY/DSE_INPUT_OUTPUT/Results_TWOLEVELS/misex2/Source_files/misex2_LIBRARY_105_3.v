...
module FAU ( 
  ...
  nand2  g007(.a(x21), .b(x03), .O(new_n51_));
  ...
  nand4  g039(.a(new_n82_), .b(new_n51_), .c(x02), .d(x00), .O(new_n83_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n49_), .c(x17), .d(new_n85_), .O(new_n94_));
  ...
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n51_), .O(z10));
  ...
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n88_), .O(new_n127_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(new_n88_), .O(new_n134_));
  ...
  inv1   g094(.a(new_n56_), .O(new_n138_));
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n51_), .O(z13));
  nand3  g096(.a(new_n56_), .b(new_n46_), .c(new_n45_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n60_), .c(new_n51_), .O(z14));
  ...
  nand3  g102(.a(new_n51_), .b(x01), .c(new_n88_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n98_), .b(new_n88_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n51_), .O(z17));
endmodule
