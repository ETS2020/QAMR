...
module FAU ( 
  ...
  nand4  g20(.a(new_n58_), .b(x18), .c(new_n44_), .d(x03), .O(new_n64_));
  ...
  nand4  g33(.a(x11), .b(x10), .c(new_n53_), .d(x02), .O(new_n77_));
  ...
  nor2   g42(.a(new_n71_), .b(x11), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(new_n85_), .c(x03), .O(new_n87_));
  ...
  nand4  g67(.a(new_n93_), .b(x21), .c(new_n92_), .d(new_n58_), .O(new_n111_));
  nor2   g68(.a(new_n88_), .b(x14), .O(new_n112_));
  nor2   g69(.a(x21), .b(new_n92_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n112_), .c(new_n89_), .d(new_n102_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n87_), .c(new_n111_), .O(new_n115_));
  ...
  nand3  g78(.a(new_n58_), .b(x17), .c(new_n48_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g80(.a(new_n123_), .b(x03), .c(new_n47_), .d(new_n46_), .O(new_n124_));
  ...
  aoi21  g87(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n131_));
  inv1   g88(.a(x03), .O(new_n132_));
  aoi21  g89(.a(x19), .b(new_n48_), .c(new_n132_), .O(new_n133_));
  oai22  g90(.a(new_n133_), .b(x01), .c(new_n131_), .d(new_n46_), .O(z15));
