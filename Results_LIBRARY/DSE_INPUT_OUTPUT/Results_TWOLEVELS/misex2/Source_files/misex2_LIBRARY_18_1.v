...
module FAU ( 
  ...
  nand4  g53(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n53_), .O(new_n97_));
  ...
  nand4  g72(.a(new_n67_), .b(new_n45_), .c(new_n44_), .d(new_n53_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n52_), .c(new_n51_), .d(new_n46_), .O(new_n118_));
  ...
  oai21  g78(.a(new_n120_), .b(new_n53_), .c(new_n121_), .O(z15));
  nor2   g79(.a(new_n44_), .b(x00), .O(z16));
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n53_), .O(new_n124_));
