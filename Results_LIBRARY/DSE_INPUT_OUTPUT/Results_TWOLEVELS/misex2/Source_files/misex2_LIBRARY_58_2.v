...
module FAU ( 
  ...
  nor2   g010(.a(new_n47_), .b(x01), .O(new_n54_));
  nor2   g011(.a(x18), .b(x17), .O(new_n55_));
  nand4  g012(.a(new_n55_), .b(new_n54_), .c(x10), .d(new_n53_), .O(new_n56_));
  aoi21  g013(.a(new_n56_), .b(new_n46_), .c(x19), .O(z01));
  ...
  nand3  g019(.a(new_n47_), .b(x01), .c(x00), .O(new_n63_));
  nand3  g020(.a(x12), .b(x11), .c(x10), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(x19), .O(new_n65_));
  nand2  g022(.a(new_n65_), .b(x02), .O(new_n66_));
  inv1   g023(.a(x19), .O(new_n67_));
  nand4  g024(.a(new_n48_), .b(new_n67_), .c(x18), .d(new_n44_), .O(new_n68_));
  ...
  aoi21  g030(.a(new_n73_), .b(x19), .c(new_n46_), .O(z04));
  nand4  g031(.a(x10), .b(x09), .c(x01), .d(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(x19), .c(new_n46_), .O(z05));
  oai21  g033(.a(x19), .b(x12), .c(x11), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n58_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n47_), .c(x01), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x19), .c(new_n46_), .O(z06));
  nand3  g037(.a(new_n71_), .b(x11), .c(x10), .O(new_n81_));
  oai21  g038(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x19), .c(x02), .d(x00), .O(new_n83_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n88_), .d(new_n53_), .O(new_n90_));
  inv1   g047(.a(new_n90_), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n87_), .c(new_n86_), .d(x04), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(x07), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n45_), .c(x17), .d(new_n85_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n67_), .O(z08));
  ...
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n53_), .O(new_n107_));
  nand2  g064(.a(new_n67_), .b(x02), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n107_), .O(z09));
  nand3  g066(.a(x18), .b(new_n46_), .c(x01), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n104_), .c(x22), .d(x21), .O(new_n112_));
  nand3  g069(.a(new_n70_), .b(x02), .c(new_n88_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand3  g071(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n115_));
  nor4   g072(.a(new_n115_), .b(new_n67_), .c(new_n101_), .d(new_n100_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n114_), .c(new_n102_), .d(x12), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n112_), .c(x00), .O(z10));
  nor2   g075(.a(new_n96_), .b(x20), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n111_), .c(new_n67_), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n71_), .O(new_n121_));
  nand2  g078(.a(new_n101_), .b(x15), .O(new_n122_));
  nand3  g079(.a(new_n96_), .b(x20), .c(x19), .O(new_n123_));
  nor3   g080(.a(new_n123_), .b(new_n122_), .c(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n121_), .c(new_n98_), .d(new_n70_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n120_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n53_), .O(new_n127_));
  inv1   g084(.a(new_n127_), .O(z11));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(x01), .c(x00), .O(new_n130_));
  nand2  g087(.a(x23), .b(x19), .O(new_n131_));
  oai21  g088(.a(x19), .b(new_n44_), .c(new_n131_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n88_), .c(new_n53_), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n130_), .c(x24), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(x09), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n108_), .O(z12));
  nand3  g093(.a(x17), .b(new_n88_), .c(new_n53_), .O(new_n137_));
  aoi21  g094(.a(new_n137_), .b(new_n46_), .c(x19), .O(z13));
  nor2   g095(.a(x09), .b(x01), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n55_), .c(new_n58_), .d(new_n53_), .O(new_n140_));
  aoi21  g097(.a(new_n140_), .b(new_n46_), .c(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n88_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n88_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n108_), .O(z15));
  oai21  g102(.a(new_n88_), .b(x00), .c(new_n108_), .O(z16));
  nand3  g103(.a(new_n48_), .b(x19), .c(x02), .O(new_n147_));
