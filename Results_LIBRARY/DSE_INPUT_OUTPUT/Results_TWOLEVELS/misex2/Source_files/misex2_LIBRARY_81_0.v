...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n55_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n81_, new_n85_, new_n86_;
  ...
  nor2   g27(.a(new_n68_), .b(new_n67_), .O(new_n74_));
  nand4  g28(.a(new_n74_), .b(new_n66_), .c(new_n69_), .d(x18), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(x01), .c(x00), .O(z10));
  nand4  g30(.a(new_n71_), .b(new_n68_), .c(x21), .d(new_n66_), .O(new_n77_));
  inv1   g31(.a(new_n77_), .O(z11));
  inv1   g32(.a(z08), .O(new_n79_));
  aoi21  g33(.a(x10), .b(x02), .c(x24), .O(new_n80_));
  nand4  g34(.a(new_n80_), .b(x09), .c(x01), .d(x00), .O(new_n81_));
  nand2  g35(.a(new_n81_), .b(new_n79_), .O(z12));
  inv1   g36(.a(x02), .O(new_n85_));
  aoi21  g37(.a(new_n55_), .b(x01), .c(new_n85_), .O(new_n86_));
  oai21  g38(.a(new_n86_), .b(new_n57_), .c(new_n79_), .O(z15));
  nor2   g39(.a(new_n58_), .b(x00), .O(z16));
  zero   g40(.O(z00));
  zero   g41(.O(z01));
  zero   g42(.O(z02));
  zero   g43(.O(z13));
