...
module FAU ( 
  ...
  nand4  g27(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n57_), .O(z05));
  ...
  nand4  g59(.a(new_n102_), .b(new_n91_), .c(x20), .d(x16), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x22), .O(z10));
  nand3  g61(.a(new_n93_), .b(new_n92_), .c(x12), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n48_), .O(new_n106_));
  nor2   g63(.a(x16), .b(new_n101_), .O(new_n107_));
  nor2   g64(.a(x22), .b(x21), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(x20), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n47_), .c(x00), .O(z11));
  inv1   g67(.a(x24), .O(new_n111_));
  aoi21  g68(.a(x10), .b(x02), .c(new_n47_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n113_), .c(x00), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(new_n116_));
  oai22  g73(.a(new_n116_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  aoi21  g74(.a(new_n114_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g75(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n119_));
  nor2   g76(.a(new_n119_), .b(x19), .O(z14));
  aoi21  g77(.a(new_n57_), .b(x01), .c(new_n48_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n46_), .c(new_n122_), .O(z15));
