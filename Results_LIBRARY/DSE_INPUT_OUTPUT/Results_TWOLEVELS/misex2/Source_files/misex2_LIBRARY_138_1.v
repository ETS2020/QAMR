...
module FAU ( 
  ...
  inv1   g006(.a(x13), .O(new_n50_));
  nand2  g007(.a(x22), .b(new_n50_), .O(new_n51_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n70_), .c(x18), .d(new_n48_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n69_), .c(new_n52_), .O(z03));
  inv1   g030(.a(x11), .O(new_n74_));
  inv1   g031(.a(x12), .O(new_n75_));
  nand3  g032(.a(new_n68_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  oai21  g033(.a(new_n76_), .b(new_n66_), .c(new_n51_), .O(z04));
  ...
  nor2   g065(.a(new_n49_), .b(new_n44_), .O(new_n109_));
  nor2   g066(.a(x20), .b(x19), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  oai21  g068(.a(new_n108_), .b(new_n104_), .c(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n102_), .c(new_n101_), .d(new_n100_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(z09));
  nand3  g071(.a(x18), .b(x13), .c(x01), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n110_), .c(x22), .d(x21), .O(new_n117_));
  nand4  g074(.a(new_n103_), .b(new_n50_), .c(x12), .d(new_n74_), .O(new_n118_));
  ...
  nor2   g080(.a(new_n101_), .b(x20), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n109_), .c(new_n70_), .O(new_n125_));
  nor2   g082(.a(new_n105_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n101_), .c(x20), .d(new_n106_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n118_), .c(new_n125_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n102_), .c(new_n100_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n70_), .b(x17), .c(new_n45_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n44_), .c(new_n100_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n51_), .c(new_n131_), .d(x09), .O(new_n139_));
  inv1   g096(.a(new_n139_), .O(z12));
  nand4  g097(.a(new_n53_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x00), .O(z13));
  nor2   g099(.a(x09), .b(x02), .O(new_n143_));
  nor2   g100(.a(x17), .b(x10), .O(new_n144_));
  nand4  g101(.a(new_n144_), .b(new_n143_), .c(new_n60_), .d(new_n58_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n51_), .O(z14));
  ...
  aoi21  g106(.a(new_n149_), .b(new_n148_), .c(new_n52_), .O(z15));
  oai21  g107(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand2  g108(.a(new_n103_), .b(new_n100_), .O(new_n152_));
  nand2  g109(.a(new_n152_), .b(new_n51_), .O(z17));
endmodule
