...
module FAU ( 
  ...
  nand4  g60(.a(new_n103_), .b(new_n90_), .c(new_n89_), .d(new_n46_), .O(new_n104_));
  ...
  oai21  g65(.a(new_n108_), .b(new_n106_), .c(new_n46_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  nor2   g67(.a(new_n90_), .b(new_n89_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n101_), .c(new_n98_), .d(new_n46_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n110_), .O(z10));
  nand4  g70(.a(new_n98_), .b(x21), .c(new_n99_), .d(new_n65_), .O(new_n114_));
  ...
  aoi21  g87(.a(new_n125_), .b(new_n46_), .c(x01), .O(z13));
