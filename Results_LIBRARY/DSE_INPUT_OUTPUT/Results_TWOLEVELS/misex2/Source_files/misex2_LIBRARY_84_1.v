...
module FAU ( 
  ...
  nor2   g019(.a(new_n62_), .b(x24), .O(z02));
  nand2  g020(.a(x24), .b(new_n54_), .O(new_n64_));
  nor2   g021(.a(x19), .b(new_n54_), .O(new_n65_));
  nand3  g022(.a(new_n65_), .b(new_n45_), .c(new_n53_), .O(new_n66_));
  nand3  g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  inv1   g024(.a(new_n67_), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n47_), .c(x12), .d(x11), .O(new_n69_));
  nand3  g026(.a(new_n69_), .b(new_n66_), .c(new_n64_), .O(z03));
  inv1   g027(.a(x11), .O(new_n71_));
  inv1   g028(.a(x12), .O(new_n72_));
  nand3  g029(.a(new_n47_), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  ...
  nor3   g034(.a(new_n71_), .b(new_n46_), .c(x09), .O(new_n78_));
  ...
  nor2   g050(.a(new_n93_), .b(x24), .O(z08));
  ...
  aoi21  g057(.a(x24), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(new_n99_), .c(new_n98_), .d(new_n97_), .O(new_n102_));
  nor2   g059(.a(new_n102_), .b(x13), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(x12), .c(new_n71_), .d(x02), .O(new_n104_));
  nor2   g061(.a(new_n54_), .b(new_n58_), .O(new_n105_));
  nand3  g062(.a(new_n105_), .b(new_n100_), .c(new_n55_), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(x01), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n96_), .c(new_n95_), .d(new_n57_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  inv1   g066(.a(x13), .O(new_n110_));
  nand4  g067(.a(new_n64_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(new_n99_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(x15), .c(new_n97_), .d(new_n110_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(new_n72_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n71_), .c(x02), .d(new_n58_), .O(new_n115_));
  nor2   g072(.a(new_n96_), .b(new_n95_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n65_), .c(new_n100_), .d(x01), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n115_), .c(x00), .O(z10));
  nand4  g075(.a(new_n105_), .b(x21), .c(new_n100_), .d(new_n55_), .O(new_n119_));
  nor2   g076(.a(new_n59_), .b(x01), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n110_), .c(x12), .d(new_n71_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n57_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n64_), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(x01), .c(x00), .O(new_n128_));
  oai21  g085(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g086(.a(new_n55_), .b(x17), .c(new_n59_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n58_), .c(new_n57_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(x09), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z12));
  inv1   g092(.a(new_n64_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(x17), .c(new_n59_), .d(new_n58_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  nor3   g096(.a(new_n60_), .b(x10), .c(x09), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n55_), .c(new_n54_), .d(new_n53_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x24), .O(z14));
  oai21  g099(.a(x10), .b(new_n58_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n59_), .c(new_n58_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n144_), .c(new_n136_), .O(z15));
  oai21  g103(.a(new_n58_), .b(x00), .c(new_n64_), .O(z16));
  nand2  g104(.a(new_n120_), .b(new_n57_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n64_), .O(z17));
endmodule
