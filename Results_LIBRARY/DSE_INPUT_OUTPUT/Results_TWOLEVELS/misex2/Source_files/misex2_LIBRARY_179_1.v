...
module FAU ( 
  ...
  nand2  g28(.a(x12), .b(new_n49_), .O(new_n72_));
  nor2   g29(.a(x12), .b(x11), .O(new_n73_));
  nand2  g30(.a(new_n73_), .b(new_n69_), .O(new_n74_));
  oai21  g31(.a(new_n74_), .b(new_n68_), .c(new_n72_), .O(z04));
  ...
  nand2  g40(.a(new_n83_), .b(new_n72_), .O(z07));
  ...
  nand4  g52(.a(new_n64_), .b(x18), .c(x01), .d(new_n48_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n93_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z09));
  nand4  g56(.a(new_n97_), .b(x22), .c(x21), .d(new_n93_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z10));
  nand3  g58(.a(x18), .b(x01), .c(new_n48_), .O(new_n102_));
  nand4  g59(.a(new_n95_), .b(x21), .c(new_n93_), .d(new_n64_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n102_), .c(new_n72_), .O(z11));
  inv1   g61(.a(x24), .O(new_n105_));
  aoi21  g62(.a(x10), .b(x02), .c(new_n49_), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(x00), .O(new_n107_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g65(.a(new_n64_), .b(x17), .c(new_n50_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n44_), .c(new_n49_), .d(new_n48_), .O(new_n111_));
  ...
  nand4  g71(.a(new_n64_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n44_), .c(x01), .O(z13));
  nor2   g73(.a(new_n52_), .b(x10), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(x19), .O(z14));
  aoi21  g76(.a(new_n44_), .b(new_n50_), .c(new_n106_), .O(new_n120_));
  nand4  g77(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n48_), .c(new_n121_), .O(z15));
  oai21  g79(.a(new_n49_), .b(x00), .c(new_n72_), .O(z16));
  nand4  g80(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n124_));
