...
module FAU ( 
  ...
  nor4   g026(.a(x05), .b(new_n61_), .c(new_n60_), .d(new_n59_), .O(new_n70_));
  ...
  nor3   g031(.a(new_n69_), .b(new_n56_), .c(x09), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n65_), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n65_), .c(new_n60_), .O(z06));
  nand2  g034(.a(new_n46_), .b(new_n65_), .O(new_n78_));
  ...
  nand4  g045(.a(new_n88_), .b(new_n85_), .c(new_n65_), .d(x04), .O(new_n89_));
  nor2   g046(.a(new_n89_), .b(x07), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n45_), .c(x17), .d(new_n84_), .O(new_n91_));
  ...
  nand2  g061(.a(x05), .b(x01), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n104_), .O(z09));
  nand3  g063(.a(x18), .b(new_n65_), .c(x01), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n101_), .c(x22), .d(x21), .O(new_n109_));
  nor2   g066(.a(x13), .b(new_n79_), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n95_), .c(new_n69_), .O(new_n111_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n65_), .c(x01), .d(x00), .O(new_n124_));
  ...
  nand3  g097(.a(new_n65_), .b(x01), .c(new_n59_), .O(new_n141_));
