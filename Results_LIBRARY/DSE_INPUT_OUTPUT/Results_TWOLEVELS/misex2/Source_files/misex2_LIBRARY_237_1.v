...
module FAU ( 
  ...
  oai21  g37(.a(new_n80_), .b(new_n65_), .c(x00), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g39(.a(x02), .b(new_n44_), .c(x00), .O(new_n83_));
  ...
  nand4  g49(.a(new_n92_), .b(new_n51_), .c(x17), .d(new_n85_), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(new_n61_), .O(z08));
  nand2  g51(.a(new_n67_), .b(x02), .O(new_n95_));
  nor4   g52(.a(new_n95_), .b(x14), .c(x13), .d(new_n68_), .O(new_n96_));
  nor2   g53(.a(x22), .b(x21), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(x20), .O(new_n98_));
  nor3   g55(.a(new_n98_), .b(x16), .c(x15), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n96_), .O(new_n100_));
  aoi21  g57(.a(new_n100_), .b(new_n44_), .c(x00), .O(z09));
  inv1   g58(.a(new_n98_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n96_), .c(x16), .d(x15), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n44_), .c(x00), .O(z10));
  inv1   g61(.a(x16), .O(new_n105_));
  nand4  g62(.a(new_n102_), .b(new_n96_), .c(new_n105_), .d(x15), .O(new_n106_));
  ...
  oai22  g70(.a(new_n113_), .b(new_n46_), .c(new_n44_), .d(x00), .O(z12));
  nor3   g71(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g72(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g74(.a(new_n58_), .b(new_n52_), .c(x01), .O(new_n118_));
  oai21  g75(.a(x19), .b(x00), .c(new_n45_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(z15));
  nor2   g77(.a(new_n44_), .b(x00), .O(z16));
  nand3  g78(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n122_));
