...
module FAU ( 
  ...
  nand3  g024(.a(new_n67_), .b(new_n46_), .c(x02), .O(new_n68_));
  ...
  nor3   g030(.a(new_n66_), .b(x09), .c(new_n45_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(x10), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(x23), .O(z04));
  nand4  g033(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n69_), .c(new_n62_), .O(z05));
  nand2  g035(.a(x23), .b(x12), .O(new_n79_));
  ...
  aoi21  g039(.a(new_n82_), .b(new_n69_), .c(new_n62_), .O(z06));
  ...
  nand4  g052(.a(new_n95_), .b(new_n56_), .c(x17), .d(new_n88_), .O(new_n96_));
  ...
  nor2   g063(.a(new_n56_), .b(new_n62_), .O(new_n107_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n99_), .c(new_n61_), .O(new_n129_));
  ...
  nand4  g092(.a(new_n64_), .b(x17), .c(new_n45_), .d(new_n62_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(new_n135_), .c(x00), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n134_), .c(new_n131_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n46_), .c(new_n44_), .O(z12));
  inv1   g096(.a(new_n47_), .O(new_n140_));
  nand3  g097(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n140_), .c(new_n44_), .O(z13));
  nand3  g099(.a(new_n50_), .b(new_n49_), .c(new_n55_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n48_), .c(new_n44_), .O(z14));
  aoi22  g101(.a(new_n44_), .b(x00), .c(x19), .d(new_n62_), .O(new_n145_));
  nand3  g102(.a(new_n67_), .b(new_n69_), .c(new_n55_), .O(new_n146_));
  oai21  g103(.a(new_n145_), .b(x02), .c(new_n146_), .O(z15));
  aoi21  g104(.a(new_n69_), .b(x00), .c(new_n62_), .O(z16));
  nand2  g105(.a(new_n100_), .b(new_n61_), .O(new_n149_));
