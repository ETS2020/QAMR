...
module FAU ( 
  ...
  nand2  g26(.a(new_n49_), .b(x02), .O(new_n70_));
  ...
  aoi21  g32(.a(x12), .b(new_n46_), .c(new_n68_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x10), .c(new_n49_), .d(x02), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x00), .c(new_n47_), .O(z06));
  ...
  nand3  g38(.a(x02), .b(new_n47_), .c(x00), .O(new_n82_));
  ...
  aoi21  g61(.a(new_n104_), .b(new_n47_), .c(x00), .O(z09));
  nand4  g62(.a(new_n68_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n97_), .c(new_n96_), .d(x12), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n94_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n100_), .c(x20), .d(x16), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x22), .O(z10));
  nand4  g68(.a(new_n103_), .b(new_n99_), .c(new_n95_), .d(x15), .O(new_n112_));
  ...
  nand4  g78(.a(new_n59_), .b(new_n58_), .c(new_n49_), .d(new_n48_), .O(new_n122_));
