...
module FAU ( 
  ...
  aoi21  g31(.a(new_n74_), .b(new_n52_), .c(new_n68_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x10), .c(new_n46_), .d(x02), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x00), .c(new_n44_), .O(z06));
  ...
  nand4  g54(.a(new_n68_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n96_), .c(x20), .d(x16), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x22), .O(z10));
  inv1   g60(.a(x16), .O(new_n104_));
  nand4  g61(.a(new_n101_), .b(new_n96_), .c(x20), .d(new_n104_), .O(new_n105_));
  ...
  nand3  g66(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n44_), .c(new_n52_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n108_), .c(x24), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(x09), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(z12));
  nor3   g72(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g73(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g75(.a(new_n58_), .b(x01), .c(new_n45_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n52_), .c(new_n120_), .O(z15));
  aoi21  g78(.a(new_n45_), .b(new_n44_), .c(x00), .O(z17));
  zero   g79(.O(z16));
endmodule
