...
module FAU ( 
  ...
  nor2   g022(.a(x09), .b(new_n45_), .O(new_n66_));
  nand3  g023(.a(new_n66_), .b(x01), .c(x00), .O(new_n67_));
  inv1   g024(.a(x16), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(x12), .c(x11), .d(x10), .O(new_n69_));
  oai22  g026(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(new_n63_), .O(z03));
  nor2   g027(.a(x12), .b(x11), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n66_), .c(x10), .d(x00), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n68_), .c(new_n62_), .O(z04));
  nand4  g030(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(x16), .c(new_n55_), .O(z05));
  nand4  g032(.a(new_n68_), .b(x11), .c(x10), .d(new_n46_), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(new_n77_));
  nand3  g034(.a(new_n77_), .b(x02), .c(x00), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(new_n68_), .c(new_n62_), .O(z06));
  nand2  g036(.a(x10), .b(new_n46_), .O(new_n80_));
  inv1   g037(.a(x12), .O(new_n81_));
  nand3  g038(.a(new_n68_), .b(new_n81_), .c(x11), .O(new_n82_));
  ...
  nor2   g045(.a(x05), .b(new_n88_), .O(new_n89_));
  nand4  g046(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n61_), .O(new_n90_));
  nor3   g047(.a(x08), .b(x07), .c(x06), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(x19), .c(new_n56_), .d(x17), .O(new_n92_));
  oai21  g049(.a(new_n92_), .b(new_n90_), .c(new_n44_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  inv1   g052(.a(x11), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n96_), .c(x02), .d(new_n62_), .O(new_n97_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n64_), .c(x18), .d(x01), .O(new_n103_));
  oai21  g060(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n68_), .O(new_n105_));
  ...
  nand2  g066(.a(new_n96_), .b(x02), .O(new_n110_));
  nand3  g067(.a(new_n99_), .b(new_n98_), .c(x12), .O(new_n111_));
  ...
  and2   g074(.a(x18), .b(x01), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n102_), .d(new_n64_), .O(new_n119_));
  nor2   g076(.a(x13), .b(new_n81_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n87_), .c(new_n96_), .O(new_n121_));
  nor2   g078(.a(new_n100_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n102_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n68_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n119_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n61_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n44_), .O(z11));
  inv1   g084(.a(x24), .O(new_n128_));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n68_), .c(x01), .d(x00), .O(new_n130_));
  oai21  g087(.a(x19), .b(x02), .c(x23), .O(new_n131_));
  nand3  g088(.a(new_n64_), .b(x17), .c(new_n45_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n62_), .c(new_n61_), .O(new_n134_));
  ...
  nand3  g096(.a(new_n50_), .b(new_n49_), .c(new_n55_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n48_), .c(new_n44_), .O(z14));
  ...
  nand3  g102(.a(new_n68_), .b(x01), .c(new_n61_), .O(new_n146_));
