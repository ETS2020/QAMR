...
module FAU ( 
  ...
  aoi21  g25(.a(new_n68_), .b(x01), .c(new_n46_), .O(z04));
  nand3  g26(.a(x02), .b(x01), .c(x00), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(new_n57_), .c(new_n64_), .O(z05));
  ...
  nand4  g45(.a(new_n88_), .b(x12), .c(new_n87_), .d(x02), .O(new_n89_));
  ...
  nand4  g60(.a(new_n103_), .b(new_n61_), .c(x18), .d(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n87_), .O(new_n106_));
  nor3   g63(.a(new_n106_), .b(new_n48_), .c(x01), .O(new_n107_));
  nor3   g64(.a(new_n91_), .b(new_n90_), .c(x14), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n107_), .c(new_n94_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n104_), .c(x00), .O(z10));
  nand3  g67(.a(new_n94_), .b(new_n91_), .c(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n89_), .c(new_n46_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  inv1   g70(.a(x22), .O(new_n114_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(new_n114_), .d(x21), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n113_), .O(z11));
  inv1   g73(.a(x24), .O(new_n117_));
  aoi21  g74(.a(x10), .b(x02), .c(new_n46_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x01), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  oai22  g79(.a(new_n122_), .b(new_n64_), .c(x01), .d(new_n46_), .O(z12));
  nor3   g80(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g81(.a(new_n54_), .b(new_n57_), .c(new_n64_), .d(new_n48_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n46_), .c(x01), .O(z14));
  inv1   g83(.a(new_n118_), .O(new_n127_));
  aoi21  g84(.a(x19), .b(new_n48_), .c(x00), .O(new_n128_));
  oai21  g85(.a(new_n128_), .b(x01), .c(new_n127_), .O(z15));
