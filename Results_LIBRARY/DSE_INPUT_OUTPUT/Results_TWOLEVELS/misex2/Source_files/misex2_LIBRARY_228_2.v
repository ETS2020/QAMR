...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n136_, new_n137_, new_n139_, new_n141_, new_n142_;
  ...
  nor3   g017(.a(x19), .b(x18), .c(x17), .O(new_n61_));
  nand4  g018(.a(new_n61_), .b(x09), .c(new_n46_), .d(new_n60_), .O(new_n62_));
  aoi21  g019(.a(new_n62_), .b(new_n59_), .c(x10), .O(z02));
  nand3  g020(.a(new_n46_), .b(new_n59_), .c(new_n60_), .O(new_n64_));
  nand3  g021(.a(new_n52_), .b(x18), .c(new_n50_), .O(new_n65_));
  ...
  nand4  g026(.a(new_n69_), .b(new_n47_), .c(x02), .d(x00), .O(new_n70_));
  aoi21  g027(.a(new_n70_), .b(x10), .c(new_n59_), .O(z04));
  nand3  g028(.a(x09), .b(x02), .c(x00), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x10), .c(new_n59_), .O(z05));
  inv1   g030(.a(x11), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(new_n44_), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n47_), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x10), .c(new_n59_), .O(z06));
  ...
  nand4  g051(.a(x12), .b(new_n74_), .c(x02), .d(new_n59_), .O(new_n95_));
  ...
  nor2   g075(.a(x13), .b(new_n78_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n83_), .c(new_n74_), .O(new_n120_));
  nand4  g077(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n52_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n94_), .c(new_n60_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n45_), .O(z11));
  inv1   g084(.a(x24), .O(new_n128_));
  nand3  g085(.a(x10), .b(x01), .c(x00), .O(new_n129_));
  nand3  g086(.a(new_n48_), .b(new_n52_), .c(x17), .O(new_n130_));
  aoi21  g087(.a(new_n130_), .b(new_n129_), .c(x02), .O(new_n131_));
  oai21  g088(.a(x19), .b(x02), .c(x23), .O(new_n132_));
  nor3   g089(.a(new_n132_), .b(x01), .c(x00), .O(new_n133_));
  oai21  g090(.a(new_n133_), .b(new_n131_), .c(new_n128_), .O(new_n134_));
  nor2   g091(.a(new_n134_), .b(new_n47_), .O(z12));
  inv1   g092(.a(new_n48_), .O(new_n136_));
  nand3  g093(.a(new_n52_), .b(x17), .c(new_n46_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n136_), .c(new_n45_), .O(z13));
  nand4  g095(.a(new_n61_), .b(new_n47_), .c(new_n46_), .d(new_n60_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(new_n59_), .c(x10), .O(z14));
  nand2  g097(.a(new_n45_), .b(x00), .O(new_n141_));
  nand2  g098(.a(x19), .b(new_n59_), .O(new_n142_));
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(x02), .O(z15));
  aoi21  g100(.a(x10), .b(x00), .c(new_n59_), .O(z16));
  nand2  g101(.a(new_n84_), .b(new_n45_), .O(z17));
endmodule
