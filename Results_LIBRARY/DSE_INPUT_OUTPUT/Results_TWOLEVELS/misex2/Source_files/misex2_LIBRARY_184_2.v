...
module FAU ( 
  ...
  nor2   g038(.a(x14), .b(new_n81_), .O(new_n82_));
  nor2   g039(.a(new_n82_), .b(new_n72_), .O(new_n83_));
  ...
  nand3  g056(.a(new_n91_), .b(x12), .c(new_n72_), .O(new_n100_));
  ...
  nand2  g070(.a(x02), .b(new_n55_), .O(new_n114_));
  ...
  nand3  g074(.a(x16), .b(x15), .c(new_n44_), .O(new_n118_));
  nand3  g075(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n119_));
  nor2   g076(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  aoi21  g077(.a(new_n120_), .b(new_n117_), .c(new_n113_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n45_), .O(z10));
  nand4  g079(.a(new_n91_), .b(new_n115_), .c(x12), .d(new_n72_), .O(new_n123_));
  nand4  g080(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n52_), .O(new_n124_));
  nor2   g081(.a(new_n101_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n98_), .c(x20), .d(new_n102_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n99_), .c(new_n71_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n52_), .b(x17), .c(new_n46_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n55_), .c(new_n71_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n45_), .c(new_n130_), .d(x09), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(z12));
  inv1   g096(.a(new_n48_), .O(new_n140_));
  oai21  g097(.a(new_n134_), .b(new_n140_), .c(new_n45_), .O(z13));
  nor2   g098(.a(new_n57_), .b(x10), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n47_), .c(new_n46_), .d(new_n55_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x00), .O(z14));
  oai21  g101(.a(x10), .b(new_n55_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n55_), .O(new_n147_));
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n82_), .O(z15));
  nor3   g105(.a(new_n82_), .b(new_n55_), .c(x00), .O(z16));
  nand4  g106(.a(new_n45_), .b(x02), .c(new_n55_), .d(new_n71_), .O(new_n150_));
