...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n125_, new_n127_, new_n128_, new_n130_;
  ...
  nand4  g15(.a(new_n58_), .b(new_n48_), .c(new_n47_), .d(x16), .O(new_n59_));
  nor2   g16(.a(new_n59_), .b(x19), .O(z02));
  nand3  g17(.a(new_n45_), .b(new_n56_), .c(new_n44_), .O(new_n61_));
  nand4  g18(.a(new_n49_), .b(x18), .c(new_n47_), .d(x16), .O(new_n62_));
  ...
  nand2  g23(.a(new_n66_), .b(new_n56_), .O(new_n67_));
  ...
  nor3   g31(.a(new_n68_), .b(new_n72_), .c(x09), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nand2  g33(.a(new_n76_), .b(new_n67_), .O(z06));
  nand2  g34(.a(new_n46_), .b(x01), .O(new_n78_));
  nand3  g35(.a(new_n69_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g36(.a(new_n79_), .b(new_n78_), .c(new_n66_), .d(x01), .O(new_n80_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n48_), .c(x17), .d(x16), .O(new_n92_));
  ...
  nand3  g54(.a(z16), .b(new_n49_), .c(x18), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nand3  g58(.a(new_n49_), .b(x18), .c(x01), .O(new_n102_));
  nor4   g59(.a(new_n102_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n103_));
  nand2  g60(.a(x02), .b(new_n56_), .O(new_n104_));
  nor4   g61(.a(new_n104_), .b(x13), .c(new_n69_), .d(x11), .O(new_n105_));
  ...
  nand3  g67(.a(x18), .b(x01), .c(new_n44_), .O(new_n111_));
  nand4  g68(.a(new_n96_), .b(x21), .c(new_n94_), .d(new_n49_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n49_), .b(x17), .c(new_n45_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(x16), .c(new_n56_), .d(new_n44_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n115_), .c(x24), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(x09), .O(new_n121_));
  inv1   g78(.a(new_n121_), .O(z12));
  nor4   g79(.a(new_n57_), .b(x19), .c(new_n47_), .d(new_n66_), .O(z13));
  nor3   g80(.a(new_n57_), .b(x10), .c(x09), .O(new_n124_));
  nand4  g81(.a(new_n124_), .b(new_n48_), .c(new_n47_), .d(x16), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z14));
  aoi21  g83(.a(new_n72_), .b(x01), .c(new_n45_), .O(new_n127_));
  aoi21  g84(.a(x19), .b(new_n45_), .c(new_n66_), .O(new_n128_));
  oai22  g85(.a(new_n128_), .b(x01), .c(new_n127_), .d(new_n44_), .O(z15));
  nand2  g86(.a(x02), .b(new_n44_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(x16), .c(x01), .O(z17));
endmodule
