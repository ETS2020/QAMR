...
module FAU ( 
  ...
  nand3  g17(.a(new_n45_), .b(new_n44_), .c(new_n52_), .O(new_n61_));
  ...
  nor3   g29(.a(new_n72_), .b(new_n44_), .c(new_n52_), .O(z06));
  ...
  nand2  g34(.a(x01), .b(new_n52_), .O(new_n78_));
  ...
  nand4  g61(.a(new_n104_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n105_));
  ...
  oai21  g73(.a(new_n116_), .b(new_n46_), .c(new_n78_), .O(z12));
  nor3   g74(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g75(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g77(.a(new_n58_), .b(new_n52_), .c(x01), .O(new_n121_));
  oai21  g78(.a(x19), .b(x00), .c(new_n45_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(z15));
  nand3  g80(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n125_));
