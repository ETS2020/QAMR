...
module FAU ( 
  ...
  nand3  g012(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n56_));
  nor3   g013(.a(new_n56_), .b(new_n55_), .c(new_n49_), .O(new_n57_));
  nand4  g014(.a(new_n57_), .b(new_n54_), .c(new_n45_), .d(new_n44_), .O(new_n58_));
  nor2   g015(.a(new_n58_), .b(x22), .O(z01));
  inv1   g016(.a(x22), .O(new_n60_));
  nor3   g017(.a(x02), .b(x01), .c(x00), .O(new_n61_));
  nor2   g018(.a(x19), .b(x18), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n61_), .c(new_n44_), .d(new_n55_), .O(new_n63_));
  aoi21  g020(.a(new_n63_), .b(new_n60_), .c(new_n49_), .O(z02));
  nand2  g021(.a(x22), .b(x09), .O(new_n65_));
  nand4  g022(.a(new_n61_), .b(new_n54_), .c(x18), .d(new_n44_), .O(new_n66_));
  ...
  nand3  g027(.a(new_n70_), .b(new_n66_), .c(new_n65_), .O(z03));
  inv1   g028(.a(x11), .O(new_n72_));
  inv1   g029(.a(x12), .O(new_n73_));
  nand3  g030(.a(new_n69_), .b(new_n73_), .c(new_n72_), .O(new_n74_));
  oai21  g031(.a(new_n74_), .b(new_n67_), .c(new_n65_), .O(z04));
  nand4  g032(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(x22), .c(new_n55_), .O(z05));
  nand4  g034(.a(x11), .b(x10), .c(new_n49_), .d(x02), .O(new_n78_));
  nor3   g035(.a(new_n78_), .b(new_n47_), .c(new_n46_), .O(z06));
  nand2  g036(.a(new_n65_), .b(new_n47_), .O(new_n80_));
  nand2  g037(.a(new_n49_), .b(x01), .O(new_n81_));
  nand3  g038(.a(new_n73_), .b(x11), .c(x10), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  ...
  oai21  g049(.a(new_n92_), .b(new_n90_), .c(new_n65_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  nand3  g051(.a(new_n87_), .b(x12), .c(new_n72_), .O(new_n95_));
  ...
  nor2   g057(.a(new_n45_), .b(new_n47_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(new_n100_), .c(new_n54_), .O(new_n102_));
  oai21  g059(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n60_), .c(new_n94_), .d(new_n46_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n65_), .O(z09));
  nand3  g062(.a(new_n54_), .b(x18), .c(x01), .O(new_n106_));
  ...
  nand3  g071(.a(new_n60_), .b(new_n94_), .c(x20), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n112_), .c(new_n108_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n65_), .O(z10));
  nand4  g075(.a(new_n87_), .b(new_n110_), .c(x12), .d(new_n72_), .O(new_n119_));
  nand4  g076(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n54_), .O(new_n120_));
  nor2   g077(.a(new_n96_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n94_), .c(x20), .d(new_n97_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n119_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n60_), .c(new_n46_), .O(new_n124_));
  ...
  nand3  g086(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n133_), .b(new_n126_), .c(new_n60_), .d(x09), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z12));
  nand3  g092(.a(new_n65_), .b(new_n54_), .c(x17), .O(new_n136_));
  nor4   g093(.a(new_n136_), .b(x02), .c(x01), .d(x00), .O(z13));
  nand4  g094(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n138_));
  ...
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n65_), .O(z15));
  oai21  g100(.a(new_n47_), .b(x00), .c(new_n65_), .O(z16));
  nand4  g101(.a(new_n65_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n145_));
