...
module FAU ( 
  ...
  nand3  g16(.a(new_n61_), .b(x11), .c(x10), .O(new_n62_));
  oai21  g17(.a(new_n62_), .b(x09), .c(x01), .O(new_n63_));
  ...
  nand4  g25(.a(new_n67_), .b(x18), .c(x01), .d(new_n57_), .O(new_n72_));
  ...
  nor2   g34(.a(new_n80_), .b(new_n57_), .O(z12));
  nand2  g35(.a(new_n55_), .b(x01), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(x02), .c(new_n57_), .O(z15));
