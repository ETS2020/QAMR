...
module FAU ( 
  ...
  nand4  g16(.a(x11), .b(x10), .c(new_n48_), .d(x02), .O(new_n63_));
  nor3   g17(.a(new_n63_), .b(new_n54_), .c(z16), .O(z06));
  ...
  nand4  g36(.a(new_n83_), .b(x09), .c(x01), .d(x00), .O(new_n84_));
  nand2  g37(.a(new_n84_), .b(new_n55_), .O(z12));
  inv1   g38(.a(new_n55_), .O(z13));
