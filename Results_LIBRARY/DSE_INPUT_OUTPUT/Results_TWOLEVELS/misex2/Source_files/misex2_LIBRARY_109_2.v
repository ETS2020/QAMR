...
module FAU ( 
  ...
  oai21  g19(.a(new_n62_), .b(new_n61_), .c(x24), .O(new_n63_));
  ...
  aoi21  g30(.a(new_n73_), .b(x24), .c(new_n69_), .O(z04));
  nand4  g31(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x24), .c(new_n69_), .O(z05));
  ...
  nor2   g36(.a(new_n79_), .b(new_n51_), .O(z06));
  ...
  nor2   g42(.a(new_n53_), .b(x01), .O(new_n86_));
  ...
  nand4  g54(.a(x12), .b(new_n70_), .c(x02), .d(new_n69_), .O(new_n98_));
  ...
  nand3  g61(.a(new_n104_), .b(new_n103_), .c(new_n58_), .O(new_n105_));
  oai21  g62(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n85_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n52_), .O(z09));
  inv1   g65(.a(x13), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(x12), .c(new_n70_), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nor3   g68(.a(new_n100_), .b(new_n99_), .c(x14), .O(new_n112_));
  nand3  g69(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n112_), .c(new_n111_), .d(new_n86_), .O(new_n115_));
  nor2   g72(.a(new_n96_), .b(x20), .O(new_n116_));
  nor2   g73(.a(new_n51_), .b(new_n97_), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n116_), .c(new_n66_), .d(x01), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n115_), .c(x00), .O(z10));
  nor2   g76(.a(x13), .b(new_n71_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n86_), .c(new_n70_), .O(new_n121_));
  nand3  g78(.a(new_n116_), .b(new_n104_), .c(new_n58_), .O(new_n122_));
  nor2   g79(.a(new_n99_), .b(x14), .O(new_n123_));
  nor2   g80(.a(x21), .b(new_n103_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n123_), .c(new_n100_), .O(new_n125_));
  oai21  g82(.a(new_n125_), .b(new_n121_), .c(new_n122_), .O(new_n126_));
  nand3  g83(.a(new_n126_), .b(new_n97_), .c(new_n85_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n52_), .O(z11));
  oai21  g85(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g86(.a(new_n58_), .b(x17), .c(new_n53_), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g88(.a(new_n131_), .b(new_n51_), .c(x09), .d(new_n69_), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x00), .O(z12));
  nand2  g90(.a(new_n46_), .b(x17), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z13));
  nand3  g92(.a(new_n54_), .b(new_n44_), .c(new_n53_), .O(new_n136_));
  oai21  g93(.a(new_n136_), .b(new_n59_), .c(new_n52_), .O(z14));
  aoi22  g94(.a(new_n52_), .b(x00), .c(x19), .d(new_n69_), .O(new_n138_));
  nand4  g95(.a(x24), .b(new_n56_), .c(x01), .d(x00), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(x02), .c(new_n139_), .O(z15));
  aoi21  g97(.a(x24), .b(x00), .c(new_n69_), .O(z16));
  nand2  g98(.a(new_n87_), .b(new_n52_), .O(z17));
endmodule
