...
module FAU ( 
  ...
  nand2  g032(.a(new_n68_), .b(x12), .O(new_n76_));
  ...
  aoi21  g036(.a(new_n79_), .b(x15), .c(new_n61_), .O(z06));
  ...
  nand2  g040(.a(new_n68_), .b(x01), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(new_n83_), .O(z07));
  nand3  g042(.a(x02), .b(new_n61_), .c(new_n60_), .O(new_n86_));
  ...
  nand4  g052(.a(x12), .b(new_n69_), .c(x02), .d(new_n61_), .O(new_n96_));
  inv1   g053(.a(x16), .O(new_n97_));
  nor2   g054(.a(x14), .b(x13), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(x20), .c(new_n97_), .d(new_n68_), .O(new_n99_));
  nor2   g056(.a(x20), .b(x19), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x18), .c(x15), .d(x01), .O(new_n101_));
  oai21  g058(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n95_), .c(new_n94_), .d(new_n60_), .O(new_n103_));
  ...
  nand3  g076(.a(x21), .b(new_n106_), .c(new_n63_), .O(new_n120_));
  nand4  g077(.a(new_n98_), .b(new_n94_), .c(x20), .d(new_n97_), .O(new_n121_));
  oai22  g078(.a(new_n121_), .b(new_n96_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n95_), .c(x15), .d(new_n60_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n61_), .c(new_n60_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n125_), .c(x09), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n84_), .O(z12));
  inv1   g091(.a(new_n48_), .O(new_n135_));
  oai21  g092(.a(new_n129_), .b(new_n135_), .c(new_n84_), .O(z13));
  nand3  g093(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n137_));
  nand4  g094(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n137_), .c(new_n84_), .O(z14));
  oai21  g096(.a(x10), .b(new_n61_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n46_), .c(new_n61_), .O(new_n142_));
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n84_), .O(z15));
  aoi21  g100(.a(x15), .b(x00), .c(new_n61_), .O(z16));
  nand2  g101(.a(new_n86_), .b(new_n84_), .O(z17));
endmodule
