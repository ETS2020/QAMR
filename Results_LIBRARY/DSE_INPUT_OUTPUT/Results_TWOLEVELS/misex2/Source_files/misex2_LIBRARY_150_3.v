...
module FAU ( 
  ...
  nand2  g013(.a(x14), .b(x01), .O(new_n57_));
  ...
  nand3  g026(.a(new_n69_), .b(new_n47_), .c(x02), .O(new_n70_));
  inv1   g027(.a(x14), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(x12), .c(x11), .d(x10), .O(new_n72_));
  oai22  g029(.a(new_n72_), .b(new_n70_), .c(new_n67_), .d(new_n65_), .O(z03));
  inv1   g030(.a(x11), .O(new_n74_));
  inv1   g031(.a(x12), .O(new_n75_));
  nor3   g032(.a(new_n68_), .b(x09), .c(new_n46_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(x10), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(x14), .O(z04));
  nand4  g035(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(new_n71_), .c(new_n64_), .O(z05));
  nand4  g037(.a(new_n71_), .b(x11), .c(x10), .d(new_n47_), .O(new_n81_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(new_n63_), .O(new_n94_));
  nor3   g051(.a(x08), .b(x07), .c(x06), .O(new_n95_));
  nand4  g052(.a(new_n95_), .b(x19), .c(new_n45_), .d(x17), .O(new_n96_));
  oai21  g053(.a(new_n96_), .b(new_n94_), .c(new_n57_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nand4  g056(.a(x12), .b(new_n74_), .c(x02), .d(new_n64_), .O(new_n100_));
  ...
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n60_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n111_), .b(new_n66_), .c(new_n105_), .d(x01), .O(new_n112_));
  nor2   g069(.a(x13), .b(new_n75_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n91_), .c(new_n74_), .O(new_n114_));
  ...
  nand3  g074(.a(new_n117_), .b(new_n71_), .c(new_n63_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(z10));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n60_), .O(new_n120_));
  nor2   g077(.a(new_n101_), .b(x13), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n105_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n102_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n100_), .c(new_n120_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n99_), .c(new_n71_), .d(new_n63_), .O(new_n125_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n64_), .c(new_n63_), .O(new_n133_));
  ...
  nand3  g095(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n61_), .c(new_n57_), .O(z14));
  aoi22  g097(.a(new_n57_), .b(x00), .c(x19), .d(new_n64_), .O(new_n141_));
  nand3  g098(.a(new_n69_), .b(new_n71_), .c(new_n59_), .O(new_n142_));
  oai21  g099(.a(new_n141_), .b(x02), .c(new_n142_), .O(z15));
  aoi21  g100(.a(new_n71_), .b(x00), .c(new_n64_), .O(z16));
