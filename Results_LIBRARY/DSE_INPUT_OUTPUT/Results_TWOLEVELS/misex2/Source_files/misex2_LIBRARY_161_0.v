...
module FAU ( 
  ...
  nand4  g036(.a(x11), .b(x10), .c(new_n50_), .d(x02), .O(new_n80_));
  nor3   g037(.a(new_n80_), .b(new_n48_), .c(new_n47_), .O(z06));
  ...
  aoi21  g051(.a(new_n94_), .b(x15), .c(x01), .O(z08));
  and2   g052(.a(x18), .b(x01), .O(new_n96_));
  nand2  g053(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  inv1   g054(.a(x20), .O(new_n98_));
  inv1   g055(.a(x21), .O(new_n99_));
  inv1   g056(.a(x22), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n63_), .O(new_n101_));
  oai21  g058(.a(new_n101_), .b(new_n97_), .c(new_n77_), .O(z09));
  ...
  nand2  g062(.a(x02), .b(new_n48_), .O(new_n106_));
  inv1   g063(.a(x13), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(x12), .c(new_n70_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  inv1   g066(.a(x14), .O(new_n110_));
  nand2  g067(.a(x16), .b(new_n110_), .O(new_n111_));
  nand3  g068(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  aoi21  g070(.a(new_n113_), .b(new_n109_), .c(new_n105_), .O(new_n114_));
  oai21  g071(.a(new_n114_), .b(x00), .c(new_n77_), .O(z10));
  nor2   g072(.a(new_n49_), .b(x01), .O(new_n116_));
  nor2   g073(.a(x13), .b(new_n82_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n116_), .c(new_n70_), .O(new_n118_));
  nand4  g075(.a(new_n96_), .b(x21), .c(new_n98_), .d(new_n63_), .O(new_n119_));
  inv1   g076(.a(x16), .O(new_n120_));
  nor2   g077(.a(new_n76_), .b(x14), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n98_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n118_), .c(new_n119_), .O(new_n124_));
  ...
  nand3  g087(.a(new_n63_), .b(x17), .c(new_n49_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n63_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n137_));
  aoi21  g094(.a(new_n137_), .b(x15), .c(x01), .O(z13));
  nor2   g095(.a(new_n51_), .b(x10), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n45_), .c(new_n44_), .d(x15), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  aoi21  g098(.a(x15), .b(new_n49_), .c(new_n128_), .O(new_n142_));
  nand4  g099(.a(x19), .b(x15), .c(new_n49_), .d(new_n48_), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(new_n47_), .c(new_n143_), .O(z15));
  oai21  g101(.a(new_n48_), .b(x00), .c(new_n77_), .O(z16));
  nand4  g102(.a(x15), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n146_));
