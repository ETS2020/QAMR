...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n146_;
  nor2   g000(.a(x13), .b(x05), .O(new_n44_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n57_), .d(new_n74_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n51_), .c(x17), .d(x13), .O(new_n94_));
  ...
  nor2   g061(.a(new_n51_), .b(new_n57_), .O(new_n105_));
  ...
  nor4   g066(.a(new_n44_), .b(new_n97_), .c(new_n96_), .d(x20), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n52_), .c(x18), .d(x01), .O(new_n111_));
  nor3   g068(.a(new_n85_), .b(new_n46_), .c(x01), .O(new_n112_));
  ...
  nand2  g078(.a(new_n115_), .b(new_n98_), .O(new_n122_));
  nor2   g079(.a(new_n100_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n96_), .c(x20), .d(new_n101_), .O(new_n124_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n57_), .c(new_n74_), .O(new_n133_));
  ...
  nor3   g101(.a(new_n44_), .b(new_n57_), .c(x00), .O(z16));
  nand2  g102(.a(new_n98_), .b(new_n74_), .O(new_n146_));
