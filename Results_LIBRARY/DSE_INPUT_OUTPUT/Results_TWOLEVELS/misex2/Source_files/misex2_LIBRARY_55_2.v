...
module FAU ( 
  ...
  nand3  g024(.a(new_n67_), .b(new_n47_), .c(x02), .O(new_n68_));
  nand4  g025(.a(x15), .b(x12), .c(x11), .d(x10), .O(new_n69_));
  ...
  nor2   g030(.a(new_n73_), .b(x09), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(x10), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(new_n44_), .O(z04));
  nor4   g033(.a(new_n73_), .b(new_n44_), .c(new_n59_), .d(new_n47_), .O(z05));
  nand2  g034(.a(new_n44_), .b(x12), .O(new_n78_));
  ...
  aoi21  g038(.a(new_n81_), .b(x15), .c(new_n63_), .O(z06));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n97_), .d(new_n62_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n45_), .O(z09));
  nand2  g066(.a(x22), .b(x21), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(x20), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(new_n65_), .c(x01), .O(new_n112_));
  nor2   g069(.a(x13), .b(new_n72_), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(new_n87_), .c(new_n71_), .O(new_n114_));
  nor2   g071(.a(x22), .b(x21), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(x20), .c(x16), .d(new_n101_), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(x15), .c(new_n62_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(z10));
  nand4  g076(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n52_), .O(new_n120_));
  nor2   g077(.a(new_n44_), .b(x14), .O(new_n121_));
  nor2   g078(.a(x21), .b(new_n104_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n102_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n114_), .c(new_n120_), .O(new_n124_));
  ...
  nand4  g097(.a(new_n140_), .b(new_n51_), .c(new_n50_), .d(new_n59_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z14));
  aoi22  g099(.a(new_n45_), .b(x00), .c(x19), .d(new_n63_), .O(new_n143_));
  nand3  g100(.a(new_n67_), .b(x15), .c(new_n59_), .O(new_n144_));
  oai21  g101(.a(new_n143_), .b(x02), .c(new_n144_), .O(z15));
  nand3  g102(.a(x15), .b(x01), .c(new_n62_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n88_), .b(new_n45_), .O(z17));
endmodule
