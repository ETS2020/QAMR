...
module FAU ( 
  ...
  nand4  g57(.a(new_n100_), .b(new_n89_), .c(new_n88_), .d(new_n46_), .O(new_n101_));
  ...
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n90_), .O(new_n106_));
  ...
  nand4  g69(.a(new_n95_), .b(x12), .c(new_n90_), .d(x02), .O(new_n113_));
  ...
  nand4  g75(.a(new_n118_), .b(new_n117_), .c(new_n89_), .d(x21), .O(new_n119_));
  ...
  aoi21  g86(.a(new_n124_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g87(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  aoi21  g89(.a(x19), .b(new_n48_), .c(x00), .O(new_n133_));
  nand2  g90(.a(new_n121_), .b(x00), .O(new_n134_));
