...
module FAU ( 
  ...
  aoi21  g13(.a(new_n56_), .b(x06), .c(x01), .O(z01));
  ...
  nor3   g36(.a(new_n74_), .b(new_n58_), .c(x09), .O(new_n80_));
  ...
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n74_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n64_), .O(new_n97_));
  ...
  nand4  g69(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n64_), .O(new_n113_));
  nand4  g70(.a(new_n89_), .b(new_n105_), .c(x12), .d(new_n74_), .O(new_n114_));
  nor2   g71(.a(new_n91_), .b(x14), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n87_), .c(x20), .d(new_n92_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n88_), .c(new_n46_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n73_), .O(z11));
  ...
  nand3  g80(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand4  g82(.a(new_n125_), .b(x06), .c(new_n47_), .d(new_n46_), .O(new_n126_));
  ...
  nor3   g86(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nor3   g87(.a(x09), .b(x02), .c(x00), .O(new_n131_));
  nand2  g88(.a(new_n131_), .b(new_n60_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(x06), .c(x01), .O(z14));
  ...
  oai21  g93(.a(new_n47_), .b(x00), .c(new_n73_), .O(z16));
  nand4  g94(.a(x06), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n138_));
