...
module FAU ( 
  ...
  nand2  g000(.a(x18), .b(x15), .O(new_n44_));
  ...
  nor3   g033(.a(new_n76_), .b(new_n75_), .c(new_n68_), .O(z05));
  nor3   g034(.a(new_n69_), .b(new_n56_), .c(x09), .O(new_n78_));
  ...
  nand3  g053(.a(new_n85_), .b(x12), .c(new_n69_), .O(new_n97_));
  inv1   g054(.a(x16), .O(new_n98_));
  nor2   g055(.a(x14), .b(x13), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(x20), .c(new_n98_), .d(new_n61_), .O(new_n100_));
  ...
  nand4  g060(.a(new_n103_), .b(new_n96_), .c(new_n95_), .d(new_n68_), .O(new_n104_));
  ...
  nand4  g075(.a(new_n85_), .b(new_n110_), .c(x12), .d(new_n69_), .O(new_n119_));
  nor2   g076(.a(new_n50_), .b(x15), .O(new_n120_));
  nor2   g077(.a(new_n95_), .b(x20), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n120_), .c(new_n51_), .d(x01), .O(new_n122_));
  nor2   g079(.a(x16), .b(new_n61_), .O(new_n123_));
  nor2   g080(.a(x21), .b(new_n101_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n123_), .c(new_n50_), .d(new_n113_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n119_), .c(new_n122_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n68_), .O(new_n127_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n75_), .c(new_n68_), .O(new_n135_));
  ...
  nand3  g097(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n50_), .c(new_n49_), .d(new_n56_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  oai21  g101(.a(x10), .b(new_n75_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n45_), .c(new_n75_), .O(new_n147_));
  nand3  g104(.a(new_n147_), .b(new_n146_), .c(new_n44_), .O(z15));
  oai21  g105(.a(new_n75_), .b(x00), .c(new_n44_), .O(z16));
