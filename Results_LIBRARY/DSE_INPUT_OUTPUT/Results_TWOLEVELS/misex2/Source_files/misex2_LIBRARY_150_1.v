...
module FAU ( 
  ...
  nand2  g31(.a(x14), .b(new_n49_), .O(new_n75_));
  nand3  g32(.a(x10), .b(x09), .c(x02), .O(new_n76_));
  oai21  g33(.a(new_n76_), .b(new_n74_), .c(new_n75_), .O(z05));
  nand4  g34(.a(x11), .b(x10), .c(new_n55_), .d(x02), .O(new_n78_));
  ...
  nand2  g41(.a(x02), .b(new_n48_), .O(new_n85_));
  ...
  nor2   g46(.a(new_n59_), .b(x18), .O(new_n90_));
  ...
  nor2   g51(.a(new_n50_), .b(x01), .O(new_n95_));
  ...
  nand3  g65(.a(new_n97_), .b(x12), .c(new_n69_), .O(new_n109_));
  ...
  nand4  g70(.a(new_n113_), .b(new_n111_), .c(new_n110_), .d(new_n95_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n108_), .c(x00), .O(z10));
  nand4  g72(.a(new_n95_), .b(new_n97_), .c(x12), .d(new_n69_), .O(new_n116_));
  nand4  g73(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n59_), .O(new_n117_));
  nor2   g74(.a(new_n98_), .b(x14), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n93_), .c(x20), .d(new_n99_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n116_), .c(new_n117_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n94_), .c(new_n48_), .O(new_n121_));
  ...
  nand3  g83(.a(new_n59_), .b(x17), .c(new_n50_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g85(.a(new_n128_), .b(new_n44_), .c(new_n49_), .d(new_n48_), .O(new_n129_));
  ...
  nor4   g89(.a(new_n51_), .b(x19), .c(new_n45_), .d(x14), .O(z13));
  nand4  g90(.a(new_n61_), .b(new_n55_), .c(new_n50_), .d(new_n48_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g92(.a(new_n44_), .b(new_n50_), .c(new_n124_), .O(new_n136_));
  nand4  g93(.a(x19), .b(new_n44_), .c(new_n50_), .d(new_n49_), .O(new_n137_));
  oai21  g94(.a(new_n136_), .b(new_n48_), .c(new_n137_), .O(z15));
  oai21  g95(.a(new_n49_), .b(x00), .c(new_n75_), .O(z16));
  nand4  g96(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n140_));
