...
module FAU ( 
  ...
  nor2   g010(.a(x09), .b(new_n49_), .O(new_n54_));
  ...
  nand4  g021(.a(x12), .b(x11), .c(x10), .d(new_n49_), .O(new_n65_));
  oai21  g022(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  nand2  g023(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nor3   g024(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n57_), .c(x18), .d(new_n44_), .O(new_n69_));
  nand2  g026(.a(new_n69_), .b(new_n67_), .O(z03));
  inv1   g027(.a(x11), .O(new_n71_));
  nand2  g028(.a(x01), .b(x00), .O(new_n72_));
  nor3   g029(.a(new_n72_), .b(x08), .c(new_n48_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n63_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand3  g032(.a(x10), .b(x09), .c(x02), .O(new_n76_));
  oai21  g033(.a(new_n76_), .b(new_n72_), .c(new_n55_), .O(z05));
  nor3   g034(.a(new_n71_), .b(new_n60_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n49_), .c(x02), .d(x01), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(new_n46_), .O(z06));
  nand3  g037(.a(new_n63_), .b(new_n49_), .c(x01), .O(new_n81_));
  inv1   g038(.a(x12), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x11), .c(x10), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n81_), .c(new_n54_), .d(x01), .O(new_n84_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n45_), .c(x17), .d(new_n49_), .O(new_n94_));
  ...
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n55_), .O(z10));
  ...
  nor2   g094(.a(new_n54_), .b(x19), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z13));
  nand4  g097(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n60_), .O(new_n141_));
  ...
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n55_), .O(z15));
  oai21  g103(.a(new_n47_), .b(x00), .c(new_n55_), .O(z16));
  nand4  g104(.a(new_n55_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n148_));
