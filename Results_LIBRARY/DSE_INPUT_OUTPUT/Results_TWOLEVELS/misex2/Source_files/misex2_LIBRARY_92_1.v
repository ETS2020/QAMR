...
module FAU ( 
  ...
  nand4  g20(.a(new_n44_), .b(new_n51_), .c(x18), .d(new_n45_), .O(new_n64_));
  ...
  nand2  g25(.a(x21), .b(new_n54_), .O(new_n69_));
  ...
  nor2   g47(.a(new_n55_), .b(x01), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(x12), .c(new_n70_), .O(new_n92_));
  ...
  nor2   g53(.a(x21), .b(x20), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n51_), .c(x18), .d(x01), .O(new_n98_));
  oai21  g55(.a(new_n96_), .b(new_n92_), .c(new_n98_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n90_), .c(new_n53_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n69_), .O(z09));
  nor3   g58(.a(new_n90_), .b(new_n44_), .c(x20), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n51_), .c(x18), .d(x01), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n70_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nor3   g63(.a(new_n94_), .b(new_n93_), .c(x14), .O(new_n107_));
  nand3  g64(.a(new_n90_), .b(new_n44_), .c(x20), .O(new_n108_));
  ...
  inv1   g69(.a(x20), .O(new_n113_));
  nand4  g70(.a(x21), .b(new_n113_), .c(new_n51_), .d(x18), .O(new_n114_));
  oai21  g71(.a(new_n112_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n90_), .c(new_n53_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n69_), .O(z11));
  inv1   g74(.a(x24), .O(new_n118_));
  aoi21  g75(.a(x10), .b(x02), .c(new_n54_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(x00), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(x23), .O(new_n121_));
  nand3  g78(.a(new_n51_), .b(x17), .c(new_n55_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g80(.a(new_n123_), .b(new_n44_), .c(new_n54_), .d(new_n53_), .O(new_n124_));
  ...
  nand3  g84(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n128_));
  nor4   g85(.a(new_n128_), .b(x21), .c(x19), .d(new_n45_), .O(z13));
  nor3   g86(.a(new_n128_), .b(x10), .c(x09), .O(new_n130_));
  nand4  g87(.a(new_n130_), .b(new_n51_), .c(new_n50_), .d(new_n45_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x21), .O(z14));
  aoi21  g89(.a(new_n44_), .b(new_n55_), .c(new_n119_), .O(new_n133_));
  nand4  g90(.a(new_n44_), .b(x19), .c(new_n55_), .d(new_n54_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n53_), .c(new_n134_), .O(z15));
  oai21  g92(.a(new_n54_), .b(x00), .c(new_n69_), .O(z16));
  aoi21  g93(.a(new_n82_), .b(new_n44_), .c(x01), .O(z17));
endmodule
