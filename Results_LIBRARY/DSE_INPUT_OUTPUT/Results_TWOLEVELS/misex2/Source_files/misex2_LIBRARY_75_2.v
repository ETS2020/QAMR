...
module FAU ( 
  ...
  nor2   g001(.a(x11), .b(new_n44_), .O(new_n45_));
  ...
  nand2  g028(.a(new_n71_), .b(new_n65_), .O(z03));
  nand4  g029(.a(new_n67_), .b(new_n69_), .c(x10), .d(new_n48_), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(new_n44_), .c(x11), .O(z04));
  ...
  nor3   g034(.a(new_n68_), .b(new_n58_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x02), .c(x01), .d(x00), .O(new_n79_));
  nand2  g036(.a(new_n79_), .b(new_n46_), .O(z06));
  nand3  g037(.a(new_n69_), .b(x11), .c(x10), .O(new_n81_));
  oai21  g038(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nand3  g039(.a(new_n82_), .b(x02), .c(x00), .O(new_n83_));
  nand2  g040(.a(new_n83_), .b(new_n46_), .O(z07));
  inv1   g041(.a(x08), .O(new_n85_));
  inv1   g042(.a(x05), .O(new_n86_));
  inv1   g043(.a(x06), .O(new_n87_));
  nand4  g044(.a(new_n44_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(new_n89_));
  nand4  g046(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(x04), .O(new_n90_));
  nor2   g047(.a(new_n90_), .b(x07), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n52_), .c(x17), .d(new_n85_), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(new_n53_), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nor2   g052(.a(new_n45_), .b(x20), .O(new_n96_));
  nand4  g053(.a(new_n96_), .b(new_n53_), .c(x18), .d(x01), .O(new_n97_));
  nor2   g054(.a(new_n47_), .b(x01), .O(new_n98_));
  nand3  g055(.a(x12), .b(new_n68_), .c(new_n44_), .O(new_n99_));
  ...
  nor3   g060(.a(new_n103_), .b(x14), .c(x13), .O(new_n104_));
  nand3  g061(.a(new_n104_), .b(new_n100_), .c(new_n98_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n97_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n95_), .c(new_n94_), .d(new_n61_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  inv1   g065(.a(x20), .O(new_n109_));
  nand4  g066(.a(new_n46_), .b(x22), .c(x21), .d(new_n109_), .O(new_n110_));
  ...
  nor4   g071(.a(new_n114_), .b(x03), .c(new_n47_), .d(x01), .O(new_n115_));
  ...
  nor2   g076(.a(new_n52_), .b(new_n62_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n109_), .d(new_n53_), .O(new_n121_));
  inv1   g078(.a(new_n114_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n98_), .O(new_n123_));
  nor2   g080(.a(new_n101_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n94_), .c(x20), .d(new_n102_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n123_), .c(new_n121_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n95_), .c(new_n61_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n46_), .O(z11));
  ...
  nand3  g089(.a(new_n53_), .b(x17), .c(new_n47_), .O(new_n133_));
  ...
  nand4  g093(.a(new_n136_), .b(new_n46_), .c(new_n129_), .d(x09), .O(new_n137_));
  inv1   g094(.a(new_n137_), .O(z12));
  inv1   g095(.a(new_n49_), .O(new_n139_));
  oai21  g096(.a(new_n133_), .b(new_n139_), .c(new_n46_), .O(z13));
  oai21  g097(.a(new_n59_), .b(new_n50_), .c(new_n46_), .O(z14));
  oai21  g098(.a(x10), .b(new_n62_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n47_), .c(new_n62_), .O(new_n144_));
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  nor3   g102(.a(new_n45_), .b(new_n62_), .c(x00), .O(z16));
  nand2  g103(.a(new_n98_), .b(new_n61_), .O(new_n147_));
