...
module FAU ( 
  ...
  nor3   g014(.a(new_n57_), .b(new_n53_), .c(new_n52_), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(new_n51_), .c(new_n50_), .d(new_n45_), .O(new_n59_));
  nor2   g016(.a(new_n59_), .b(x24), .O(z01));
  nor2   g017(.a(new_n52_), .b(x02), .O(new_n61_));
  nor2   g018(.a(x17), .b(x10), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n61_), .c(new_n47_), .d(new_n54_), .O(new_n63_));
  aoi21  g020(.a(new_n63_), .b(new_n44_), .c(x01), .O(z02));
  ...
  nand4  g037(.a(x11), .b(x10), .c(new_n52_), .d(x02), .O(new_n81_));
  ...
  nand4  g048(.a(new_n91_), .b(x02), .c(new_n55_), .d(new_n54_), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(x19), .c(new_n50_), .d(x17), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(x24), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nor2   g056(.a(new_n56_), .b(x01), .O(new_n100_));
  ...
  nor2   g063(.a(new_n50_), .b(new_n55_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n106_), .c(new_n51_), .O(new_n108_));
  oai21  g065(.a(new_n105_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n54_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n73_), .O(z09));
  nor3   g068(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n51_), .c(x18), .d(x01), .O(new_n113_));
  nand2  g070(.a(new_n104_), .b(x12), .O(new_n114_));
  nor4   g071(.a(new_n114_), .b(x11), .c(new_n56_), .d(x01), .O(new_n115_));
  nor2   g072(.a(new_n106_), .b(new_n103_), .O(new_n116_));
  nor3   g073(.a(x24), .b(x22), .c(x21), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(x15), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n113_), .c(x00), .O(z10));
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n51_), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n75_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n100_), .c(new_n74_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n99_), .c(new_n54_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n73_), .O(z11));
  aoi21  g084(.a(x10), .b(x02), .c(new_n55_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(x00), .O(new_n129_));
  oai21  g086(.a(x19), .b(x02), .c(x23), .O(new_n130_));
  nand3  g087(.a(new_n51_), .b(x17), .c(new_n56_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n55_), .c(new_n54_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(x09), .O(new_n135_));
  inv1   g092(.a(new_n135_), .O(z12));
  nor4   g093(.a(new_n57_), .b(x24), .c(x19), .d(new_n45_), .O(z13));
  nor3   g094(.a(new_n57_), .b(x10), .c(x09), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(new_n51_), .c(new_n50_), .d(new_n45_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x24), .O(z14));
  aoi21  g097(.a(new_n44_), .b(new_n56_), .c(new_n128_), .O(new_n141_));
  nand4  g098(.a(new_n44_), .b(x19), .c(new_n56_), .d(new_n55_), .O(new_n142_));
  oai21  g099(.a(new_n141_), .b(new_n54_), .c(new_n142_), .O(z15));
  nor2   g100(.a(new_n55_), .b(x00), .O(z16));
  nand4  g101(.a(new_n44_), .b(x02), .c(new_n55_), .d(new_n54_), .O(new_n145_));
