...
module FAU ( 
  ...
  nor2   g019(.a(x09), .b(new_n45_), .O(new_n63_));
  nand3  g020(.a(new_n63_), .b(x01), .c(x00), .O(new_n64_));
  inv1   g021(.a(x15), .O(new_n65_));
  nand4  g022(.a(new_n65_), .b(x12), .c(x11), .d(x10), .O(new_n66_));
  oai22  g023(.a(new_n66_), .b(new_n64_), .c(new_n62_), .d(new_n61_), .O(z03));
  nor2   g024(.a(x12), .b(x11), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n63_), .c(x10), .d(x00), .O(new_n69_));
  aoi21  g026(.a(new_n69_), .b(new_n65_), .c(new_n60_), .O(z04));
  nand4  g027(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(new_n65_), .c(new_n60_), .O(z05));
  nand4  g029(.a(new_n65_), .b(x11), .c(x10), .d(new_n46_), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(x02), .c(x01), .d(x00), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(z06));
  nand2  g033(.a(x10), .b(new_n46_), .O(new_n77_));
  inv1   g034(.a(x12), .O(new_n78_));
  nand3  g035(.a(new_n65_), .b(new_n78_), .c(x11), .O(new_n79_));
  ...
  nand4  g052(.a(x12), .b(new_n95_), .c(x02), .d(new_n60_), .O(new_n96_));
  inv1   g053(.a(x16), .O(new_n97_));
  nor2   g054(.a(x14), .b(x13), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(x20), .c(new_n97_), .d(new_n65_), .O(new_n99_));
  inv1   g056(.a(x20), .O(new_n100_));
  nor2   g057(.a(new_n50_), .b(new_n60_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(new_n100_), .c(new_n51_), .O(new_n102_));
  oai21  g059(.a(new_n99_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g065(.a(new_n98_), .b(x12), .O(new_n109_));
  nor3   g066(.a(new_n109_), .b(x11), .c(new_n45_), .O(new_n110_));
  nand3  g067(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n111_));
  nor3   g068(.a(new_n111_), .b(new_n97_), .c(new_n65_), .O(new_n112_));
  aoi21  g069(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(new_n113_));
  oai21  g070(.a(new_n113_), .b(x00), .c(new_n44_), .O(z10));
  nand4  g071(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n51_), .O(new_n115_));
  inv1   g072(.a(x13), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(x12), .c(new_n95_), .d(x02), .O(new_n117_));
  nor2   g074(.a(new_n65_), .b(x14), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n93_), .c(x20), .d(new_n97_), .O(new_n119_));
  ...
  nand3  g088(.a(new_n47_), .b(x17), .c(new_n45_), .O(new_n132_));
  ...
  oai21  g094(.a(x10), .b(new_n60_), .c(x02), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(x00), .O(new_n139_));
  nand3  g096(.a(x19), .b(new_n45_), .c(new_n60_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n139_), .c(new_n44_), .O(z15));
  nand3  g098(.a(new_n65_), .b(x01), .c(new_n59_), .O(new_n142_));
