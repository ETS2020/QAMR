...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n119_, new_n121_, new_n122_, new_n124_;
  ...
  or2    g11(.a(new_n50_), .b(new_n54_), .O(new_n55_));
  ...
  nand4  g52(.a(z16), .b(new_n94_), .c(new_n66_), .d(x18), .O(new_n96_));
  ...
  nand3  g65(.a(new_n66_), .b(x17), .c(new_n49_), .O(new_n109_));
  ...
  oai21  g70(.a(x11), .b(x01), .c(new_n113_), .O(z12));
  nand4  g71(.a(new_n66_), .b(x17), .c(new_n49_), .d(new_n47_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(x11), .c(x01), .O(z13));
  nor3   g73(.a(x09), .b(x02), .c(x00), .O(new_n117_));
  nor2   g74(.a(x19), .b(x18), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n117_), .c(new_n44_), .d(new_n46_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(x11), .c(x01), .O(z14));
  aoi21  g77(.a(x11), .b(new_n49_), .c(new_n106_), .O(new_n121_));
  nand4  g78(.a(x19), .b(x11), .c(new_n49_), .d(new_n48_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n47_), .c(new_n122_), .O(z15));
  nand4  g80(.a(x11), .b(x02), .c(new_n48_), .d(new_n47_), .O(new_n124_));
