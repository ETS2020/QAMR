...
module FAU ( 
  ...
  aoi21  g032(.a(new_n75_), .b(new_n61_), .c(new_n69_), .O(z05));
  nor2   g033(.a(new_n70_), .b(new_n58_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n46_), .c(x02), .d(x00), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(new_n61_), .c(new_n69_), .O(z06));
  ...
  nand4  g047(.a(new_n90_), .b(x19), .c(new_n50_), .d(x17), .O(new_n91_));
  ...
  nor2   g060(.a(new_n103_), .b(x00), .O(z09));
  ...
  nand2  g064(.a(x02), .b(new_n69_), .O(new_n108_));
  nand3  g065(.a(new_n61_), .b(x12), .c(new_n70_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g067(.a(x16), .b(x15), .c(new_n96_), .O(new_n111_));
  ...
  oai21  g071(.a(new_n114_), .b(x00), .c(new_n44_), .O(z10));
  nor2   g072(.a(x13), .b(new_n71_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n86_), .c(new_n70_), .O(new_n117_));
  and2   g074(.a(x18), .b(x01), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n100_), .d(new_n51_), .O(new_n119_));
  ...
  nand3  g100(.a(x19), .b(new_n45_), .c(new_n69_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .O(z15));
  aoi21  g102(.a(new_n61_), .b(x00), .c(new_n69_), .O(z16));
  nand2  g103(.a(new_n47_), .b(x02), .O(new_n147_));
