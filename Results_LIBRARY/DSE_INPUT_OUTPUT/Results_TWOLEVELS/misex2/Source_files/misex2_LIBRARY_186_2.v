...
module FAU ( 
  ...
  nand2  g008(.a(new_n51_), .b(x16), .O(new_n52_));
  ...
  nand4  g046(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n59_), .O(new_n90_));
  ...
  aoi21  g052(.a(new_n51_), .b(x16), .c(x20), .O(new_n96_));
  nand4  g053(.a(new_n96_), .b(new_n50_), .c(x18), .d(x01), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n72_), .c(x02), .d(new_n44_), .O(new_n98_));
  inv1   g055(.a(new_n98_), .O(new_n99_));
  nor2   g056(.a(x14), .b(x13), .O(new_n100_));
  inv1   g057(.a(x15), .O(new_n101_));
  nand3  g058(.a(x20), .b(new_n63_), .c(new_n101_), .O(new_n102_));
  inv1   g059(.a(new_n102_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n100_), .c(new_n99_), .O(new_n104_));
  nand2  g061(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n59_), .O(new_n106_));
  ...
  nor3   g070(.a(new_n113_), .b(new_n45_), .c(x01), .O(new_n114_));
  ...
  nand2  g077(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nor2   g078(.a(new_n49_), .b(new_n44_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n109_), .d(new_n50_), .O(new_n123_));
  nor2   g080(.a(new_n101_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n94_), .c(x20), .d(new_n63_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n121_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n95_), .c(new_n59_), .O(new_n127_));
  ...
  nand4  g092(.a(new_n135_), .b(new_n51_), .c(new_n63_), .d(x09), .O(new_n136_));
