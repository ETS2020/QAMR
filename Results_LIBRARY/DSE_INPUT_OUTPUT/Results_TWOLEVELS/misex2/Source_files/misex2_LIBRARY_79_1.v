...
module FAU ( 
  ...
  nand4  g52(.a(new_n66_), .b(x02), .c(new_n44_), .d(new_n52_), .O(new_n96_));
  ...
  nor3   g63(.a(new_n106_), .b(x11), .c(new_n45_), .O(new_n107_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n44_), .c(new_n52_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n113_), .c(x24), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(x09), .O(new_n119_));
  inv1   g76(.a(new_n119_), .O(z12));
  aoi21  g77(.a(new_n115_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g78(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n52_), .O(new_n122_));
