...
module FAU ( 
  ...
  nand2  g007(.a(x22), .b(x05), .O(new_n51_));
  ...
  nor3   g032(.a(new_n69_), .b(new_n47_), .c(x09), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x02), .c(x01), .d(x00), .O(new_n77_));
  nand2  g034(.a(new_n77_), .b(new_n51_), .O(z06));
  ...
  nand2  g038(.a(new_n81_), .b(new_n51_), .O(z07));
  ...
  nand4  g044(.a(new_n87_), .b(x02), .c(new_n44_), .d(new_n86_), .O(new_n88_));
  ...
  nand4  g048(.a(new_n91_), .b(new_n49_), .c(x17), .d(new_n83_), .O(new_n92_));
  ...
  nand2  g060(.a(new_n103_), .b(new_n50_), .O(new_n104_));
  ...
  nor2   g066(.a(new_n49_), .b(x05), .O(new_n110_));
  ...
  nand3  g070(.a(new_n113_), .b(new_n96_), .c(new_n69_), .O(new_n114_));
  ...
  nand4  g075(.a(new_n102_), .b(x21), .c(new_n103_), .d(new_n50_), .O(new_n119_));
  ...
  nand3  g086(.a(new_n129_), .b(new_n44_), .c(new_n86_), .O(new_n130_));
  aoi21  g087(.a(new_n130_), .b(new_n126_), .c(x24), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(x09), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n51_), .O(z12));
  inv1   g090(.a(new_n56_), .O(new_n134_));
  oai21  g091(.a(new_n128_), .b(new_n134_), .c(new_n51_), .O(z13));
  nand3  g092(.a(new_n56_), .b(new_n46_), .c(new_n45_), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n60_), .c(new_n51_), .O(z14));
  inv1   g094(.a(new_n51_), .O(new_n138_));
  ...
  oai21  g099(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand2  g100(.a(new_n96_), .b(new_n86_), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(new_n51_), .O(z17));
endmodule
