...
module FAU ( 
  ...
  nand4  g014(.a(new_n46_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n58_));
  nor2   g015(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand4  g016(.a(new_n59_), .b(x09), .c(new_n49_), .d(new_n48_), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x00), .O(z01));
  nand4  g018(.a(x09), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n62_));
  nand4  g019(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(new_n57_), .O(new_n63_));
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(new_n46_), .O(z02));
  nor2   g021(.a(x21), .b(x12), .O(new_n65_));
  nor2   g022(.a(new_n65_), .b(x19), .O(new_n66_));
  nand3  g023(.a(new_n66_), .b(x18), .c(new_n52_), .O(new_n67_));
  inv1   g024(.a(new_n67_), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n69_));
  nand3  g026(.a(x02), .b(x01), .c(x00), .O(new_n70_));
  inv1   g027(.a(new_n70_), .O(new_n71_));
  nor2   g028(.a(new_n57_), .b(x09), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x12), .d(x11), .O(new_n73_));
  nand2  g030(.a(new_n73_), .b(new_n69_), .O(z03));
  inv1   g031(.a(x11), .O(new_n75_));
  nand4  g032(.a(new_n71_), .b(new_n75_), .c(x10), .d(new_n50_), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x21), .c(x12), .O(z04));
  ...
  oai21  g037(.a(x21), .b(x12), .c(x11), .O(new_n81_));
  nor2   g038(.a(new_n81_), .b(new_n57_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(new_n50_), .c(x02), .d(x01), .O(new_n83_));
  nor2   g040(.a(new_n83_), .b(new_n47_), .O(z06));
  nand2  g041(.a(new_n72_), .b(x01), .O(new_n85_));
  nand3  g042(.a(x21), .b(new_n44_), .c(x11), .O(new_n86_));
  oai22  g043(.a(new_n86_), .b(new_n85_), .c(new_n65_), .d(x01), .O(new_n87_));
  nand3  g044(.a(new_n87_), .b(x02), .c(x00), .O(new_n88_));
  inv1   g045(.a(new_n88_), .O(z07));
  nor2   g046(.a(new_n49_), .b(x01), .O(new_n90_));
  nand2  g047(.a(new_n90_), .b(new_n47_), .O(new_n91_));
  ...
  nor2   g053(.a(new_n54_), .b(x18), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(x17), .O(new_n98_));
  nand2  g055(.a(new_n98_), .b(new_n46_), .O(z08));
  inv1   g056(.a(x22), .O(new_n100_));
  inv1   g057(.a(x13), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(new_n75_), .c(x02), .d(new_n48_), .O(new_n102_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n54_), .c(x18), .d(x01), .O(new_n108_));
  oai21  g065(.a(new_n106_), .b(new_n102_), .c(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n100_), .c(new_n45_), .d(x12), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(x00), .O(z09));
  nor3   g068(.a(new_n100_), .b(new_n45_), .c(x20), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n54_), .c(x18), .d(x01), .O(new_n113_));
  nand3  g070(.a(new_n101_), .b(x12), .c(new_n75_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nor3   g072(.a(new_n105_), .b(new_n104_), .c(x14), .O(new_n116_));
  nand3  g073(.a(new_n100_), .b(new_n45_), .c(x20), .O(new_n117_));
  inv1   g074(.a(new_n117_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n116_), .c(new_n115_), .d(new_n90_), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n113_), .c(x00), .O(z10));
  nor2   g077(.a(new_n53_), .b(new_n48_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n107_), .d(new_n54_), .O(new_n122_));
  nor2   g079(.a(new_n104_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n45_), .c(x20), .d(new_n105_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n102_), .c(new_n122_), .O(new_n125_));
  ...
  nand3  g088(.a(new_n54_), .b(x17), .c(new_n49_), .O(new_n132_));
  ...
  nand2  g093(.a(new_n136_), .b(new_n46_), .O(z12));
  nand4  g094(.a(new_n66_), .b(x17), .c(new_n49_), .d(new_n48_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x00), .O(z13));
  nor2   g096(.a(new_n58_), .b(x10), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n141_));
  ...
  nor3   g103(.a(new_n65_), .b(new_n48_), .c(x00), .O(z16));
  nand2  g104(.a(new_n91_), .b(new_n46_), .O(z17));
endmodule
