...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n54_,
    ...
    new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n85_;
  ...
  oai22  g20(.a(new_n65_), .b(new_n48_), .c(new_n63_), .d(x01), .O(z07));
  ...
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(new_n76_));
  nand4  g30(.a(new_n76_), .b(new_n68_), .c(new_n71_), .d(x18), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(x01), .c(x00), .O(z10));
  nand4  g32(.a(new_n73_), .b(new_n70_), .c(x21), .d(new_n68_), .O(new_n79_));
  ...
  nand2  g37(.a(new_n56_), .b(x01), .O(new_n85_));
