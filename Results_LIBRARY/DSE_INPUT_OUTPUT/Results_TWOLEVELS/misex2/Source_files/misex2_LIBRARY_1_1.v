...
module FAU ( 
  ...
  nand2  g042(.a(x02), .b(new_n46_), .O(new_n86_));
  ...
  nor2   g047(.a(x08), .b(x07), .O(new_n91_));
  nor2   g048(.a(new_n62_), .b(x18), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x17), .O(new_n93_));
  aoi21  g050(.a(new_n93_), .b(new_n49_), .c(x01), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand4  g053(.a(x12), .b(new_n69_), .c(x02), .d(new_n47_), .O(new_n97_));
  ...
  nand3  g060(.a(new_n103_), .b(new_n102_), .c(new_n62_), .O(new_n104_));
  ...
  nand2  g063(.a(new_n106_), .b(new_n75_), .O(z09));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n75_), .O(z10));
  nor2   g077(.a(new_n48_), .b(x01), .O(new_n121_));
  nor2   g078(.a(x13), .b(new_n81_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n121_), .c(new_n69_), .O(new_n123_));
  nand4  g080(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n62_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n96_), .c(new_n46_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n75_), .O(z11));
  inv1   g087(.a(x24), .O(new_n131_));
  aoi21  g088(.a(x10), .b(x02), .c(new_n47_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(x00), .O(new_n133_));
  oai21  g090(.a(x19), .b(x02), .c(x23), .O(new_n134_));
  nand3  g091(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n47_), .c(new_n46_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n131_), .c(x09), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n75_), .O(z12));
  nand4  g097(.a(new_n62_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n141_));
  aoi21  g098(.a(new_n141_), .b(new_n49_), .c(x01), .O(z13));
  nor3   g099(.a(x09), .b(x02), .c(x00), .O(new_n143_));
  nor2   g100(.a(x19), .b(x18), .O(new_n144_));
  nand4  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .d(new_n58_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g103(.a(new_n49_), .b(new_n48_), .c(new_n132_), .O(new_n147_));
  nand4  g104(.a(x19), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n148_));
  oai21  g105(.a(new_n147_), .b(new_n46_), .c(new_n148_), .O(z15));
  nor2   g106(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g107(.a(new_n86_), .b(new_n49_), .c(x01), .O(z17));
endmodule
