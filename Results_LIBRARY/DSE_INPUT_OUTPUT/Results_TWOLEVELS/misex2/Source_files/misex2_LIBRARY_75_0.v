...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n146_;
  nor2   g000(.a(x11), .b(x03), .O(new_n44_));
  ...
  nand4  g018(.a(new_n45_), .b(new_n52_), .c(x18), .d(new_n50_), .O(new_n62_));
  ...
  nand4  g026(.a(new_n69_), .b(new_n66_), .c(x10), .d(new_n47_), .O(new_n70_));
  nand2  g027(.a(new_n70_), .b(new_n64_), .O(z03));
  nand4  g028(.a(new_n66_), .b(new_n68_), .c(x10), .d(new_n47_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x03), .c(x11), .O(z04));
  nand2  g030(.a(x01), .b(x00), .O(new_n74_));
  nand3  g031(.a(x10), .b(x09), .c(x02), .O(new_n75_));
  oai21  g032(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(z05));
  nor3   g033(.a(new_n67_), .b(new_n57_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nand2  g035(.a(new_n78_), .b(new_n45_), .O(z06));
  nand3  g036(.a(new_n68_), .b(x11), .c(x10), .O(new_n80_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n100_), .c(new_n99_), .d(x03), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n60_), .O(new_n107_));
  inv1   g064(.a(new_n107_), .O(z09));
  nor4   g065(.a(new_n44_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n52_), .c(x18), .d(x01), .O(new_n110_));
  nor3   g067(.a(new_n88_), .b(new_n46_), .c(x01), .O(new_n111_));
  ...
  nand4  g077(.a(new_n120_), .b(new_n52_), .c(x18), .d(x01), .O(new_n121_));
  nand2  g078(.a(new_n114_), .b(new_n99_), .O(new_n122_));
  nor2   g079(.a(new_n101_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n102_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n122_), .c(new_n121_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n61_), .c(new_n60_), .O(new_n134_));
  ...
  oai21  g096(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g097(.a(x10), .b(new_n61_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n61_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n44_), .O(z15));
  nor3   g101(.a(new_n44_), .b(new_n61_), .c(x00), .O(z16));
  nand2  g102(.a(new_n99_), .b(new_n60_), .O(new_n146_));
