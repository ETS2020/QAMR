...
module FAU ( 
  ...
  nand2  g000(.a(x14), .b(x08), .O(new_n44_));
  ...
  nand4  g014(.a(new_n44_), .b(new_n57_), .c(new_n56_), .d(new_n49_), .O(new_n58_));
  nor2   g015(.a(new_n58_), .b(x10), .O(new_n59_));
  nand4  g016(.a(new_n59_), .b(x09), .c(new_n45_), .d(new_n55_), .O(new_n60_));
  ...
  nand4  g025(.a(new_n68_), .b(new_n57_), .c(x18), .d(new_n49_), .O(new_n69_));
  ...
  nor3   g033(.a(new_n76_), .b(new_n55_), .c(new_n75_), .O(z05));
  nand3  g034(.a(x14), .b(x12), .c(x08), .O(new_n78_));
  ...
  nand4  g055(.a(x12), .b(new_n71_), .c(x02), .d(new_n55_), .O(new_n99_));
  ...
  nand4  g066(.a(new_n44_), .b(x22), .c(x21), .d(new_n104_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n57_), .c(x18), .d(x01), .O(new_n112_));
  nor2   g069(.a(x13), .b(new_n72_), .O(new_n113_));
  nand2  g070(.a(new_n113_), .b(new_n71_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nor3   g072(.a(new_n101_), .b(new_n100_), .c(x14), .O(new_n116_));
  ...
  nand3  g077(.a(new_n113_), .b(new_n87_), .c(new_n71_), .O(new_n121_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n98_), .c(new_n75_), .O(new_n127_));
  ...
  nand3  g089(.a(new_n57_), .b(x17), .c(new_n45_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n55_), .c(new_n75_), .O(new_n135_));
  ...
  nand3  g097(.a(new_n50_), .b(new_n49_), .c(new_n65_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n48_), .c(new_n44_), .O(z14));
  oai21  g099(.a(x10), .b(new_n55_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n45_), .c(new_n55_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n144_), .c(new_n62_), .O(z15));
  nand3  g103(.a(new_n44_), .b(x01), .c(new_n75_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n88_), .b(new_n44_), .O(z17));
endmodule
