...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n95_, new_n96_, new_n98_, new_n99_, new_n101_, new_n103_,
  ...
  nor2   g15(.a(new_n58_), .b(x20), .O(z01));
  nor2   g16(.a(new_n56_), .b(x10), .O(new_n60_));
  nand4  g17(.a(new_n60_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n61_));
  nor2   g18(.a(new_n61_), .b(x20), .O(z02));
  inv1   g19(.a(x20), .O(new_n63_));
  nand2  g20(.a(new_n50_), .b(new_n48_), .O(new_n64_));
  nand3  g21(.a(new_n46_), .b(x18), .c(new_n44_), .O(new_n65_));
  oai21  g22(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(new_n49_), .O(new_n67_));
  nand3  g24(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nand4  g25(.a(x12), .b(x11), .c(x10), .d(new_n51_), .O(new_n69_));
  oai21  g26(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z03));
  nand3  g27(.a(x02), .b(x01), .c(x00), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand3  g29(.a(new_n72_), .b(x10), .c(new_n51_), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(x12), .c(x11), .O(z04));
  nor3   g31(.a(new_n71_), .b(new_n47_), .c(new_n51_), .O(z05));
  nand4  g32(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n76_));
  ...
  nand2  g38(.a(x20), .b(new_n49_), .O(new_n82_));
  nand2  g39(.a(new_n82_), .b(new_n81_), .O(z07));
  ...
  nor2   g45(.a(new_n46_), .b(x18), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x17), .O(new_n90_));
  aoi21  g47(.a(new_n90_), .b(new_n63_), .c(x01), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  inv1   g49(.a(x22), .O(new_n93_));
  nand4  g50(.a(new_n46_), .b(x18), .c(x01), .d(new_n48_), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n63_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nand3  g54(.a(x18), .b(x01), .c(new_n48_), .O(new_n98_));
  nand4  g55(.a(x22), .b(x21), .c(new_n63_), .d(new_n46_), .O(new_n99_));
  oai21  g56(.a(new_n99_), .b(new_n98_), .c(new_n82_), .O(z10));
  nand4  g57(.a(new_n95_), .b(new_n93_), .c(x21), .d(new_n63_), .O(new_n101_));
  ...
  nand3  g63(.a(new_n46_), .b(x17), .c(new_n50_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n63_), .c(new_n49_), .d(new_n48_), .O(new_n109_));
  ...
  nand3  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n113_));
  nor4   g70(.a(new_n113_), .b(x20), .c(x19), .d(new_n44_), .O(z13));
  nor2   g71(.a(new_n52_), .b(x10), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n116_));
  nor2   g73(.a(new_n116_), .b(x20), .O(z14));
  aoi21  g74(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n118_));
  aoi21  g75(.a(x19), .b(new_n50_), .c(x20), .O(new_n119_));
  oai22  g76(.a(new_n119_), .b(x01), .c(new_n118_), .d(new_n48_), .O(z15));
  oai21  g77(.a(new_n49_), .b(x00), .c(new_n82_), .O(z16));
  nand4  g78(.a(new_n63_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n122_));
