...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    ...
    new_n75_, new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n86_;
  ...
  nor2   g29(.a(x19), .b(new_n75_), .O(new_n76_));
  nand4  g30(.a(new_n76_), .b(x22), .c(x21), .d(new_n67_), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(x01), .c(x00), .O(z10));
  nand4  g32(.a(new_n76_), .b(new_n69_), .c(x21), .d(new_n67_), .O(new_n79_));
  aoi21  g33(.a(new_n79_), .b(x01), .c(x00), .O(z11));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n81_));
  nand3  g35(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nor2   g36(.a(new_n82_), .b(new_n59_), .O(z12));
  nand2  g37(.a(new_n57_), .b(x01), .O(new_n86_));
  aoi21  g38(.a(new_n86_), .b(x02), .c(new_n59_), .O(z15));
