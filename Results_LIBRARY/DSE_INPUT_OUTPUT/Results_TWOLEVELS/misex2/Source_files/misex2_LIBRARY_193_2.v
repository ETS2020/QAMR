...
module FAU ( 
  ...
  nand3  g19(.a(new_n57_), .b(new_n62_), .c(new_n56_), .O(new_n63_));
  ...
  aoi21  g31(.a(new_n74_), .b(x01), .c(new_n56_), .O(z05));
  aoi21  g32(.a(x12), .b(new_n62_), .c(new_n69_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x10), .c(new_n46_), .d(x02), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x01), .c(new_n56_), .O(z06));
  inv1   g35(.a(x12), .O(new_n79_));
  nor2   g36(.a(x09), .b(new_n57_), .O(new_n80_));
  nand4  g37(.a(new_n80_), .b(new_n79_), .c(x11), .d(x10), .O(new_n81_));
  aoi21  g38(.a(new_n81_), .b(x01), .c(new_n56_), .O(z07));
  inv1   g39(.a(x08), .O(new_n83_));
  inv1   g40(.a(x05), .O(new_n84_));
  inv1   g41(.a(x06), .O(new_n85_));
  inv1   g42(.a(x03), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n62_), .d(new_n56_), .O(new_n87_));
  ...
  nand4  g61(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n56_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z09));
  nor3   g63(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n64_), .c(x18), .d(x01), .O(new_n108_));
  nor2   g65(.a(x13), .b(new_n79_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n95_), .c(new_n69_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n64_), .O(new_n115_));
  ...
  nand3  g75(.a(new_n118_), .b(new_n94_), .c(new_n56_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n64_), .b(x17), .c(new_n57_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n62_), .c(new_n56_), .O(new_n126_));
  ...
  nand4  g88(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n132_));
  aoi21  g89(.a(new_n132_), .b(new_n56_), .c(x01), .O(z14));
  nand4  g90(.a(x19), .b(new_n57_), .c(new_n62_), .d(new_n56_), .O(new_n134_));
  nand2  g91(.a(new_n134_), .b(new_n122_), .O(z15));
  nor2   g92(.a(new_n62_), .b(x00), .O(z16));
  aoi21  g93(.a(new_n57_), .b(new_n56_), .c(x01), .O(z17));
endmodule
