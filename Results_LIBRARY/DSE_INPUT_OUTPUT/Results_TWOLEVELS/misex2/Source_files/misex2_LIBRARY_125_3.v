...
module FAU ( 
  ...
  aoi21  g014(.a(new_n57_), .b(new_n54_), .c(new_n49_), .O(z01));
  inv1   g015(.a(x10), .O(new_n59_));
  nand4  g016(.a(new_n56_), .b(new_n55_), .c(new_n44_), .d(new_n59_), .O(new_n60_));
  aoi21  g017(.a(new_n60_), .b(new_n54_), .c(new_n49_), .O(z02));
  nand2  g018(.a(x09), .b(x08), .O(new_n62_));
  inv1   g019(.a(x19), .O(new_n63_));
  nand4  g020(.a(new_n55_), .b(new_n63_), .c(x18), .d(new_n44_), .O(new_n64_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n45_), .c(x17), .d(new_n54_), .O(new_n93_));
  ...
  nand4  g078(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n63_), .O(new_n122_));
  ...
  nand2  g083(.a(new_n126_), .b(new_n62_), .O(z11));
  ...
  nand3  g091(.a(new_n134_), .b(x09), .c(new_n54_), .O(new_n135_));
  inv1   g092(.a(new_n135_), .O(z12));
  nand3  g093(.a(new_n62_), .b(new_n63_), .c(x17), .O(new_n137_));
  nor4   g094(.a(new_n137_), .b(x02), .c(x01), .d(x00), .O(z13));
  ...
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n62_), .O(z15));
  oai21  g101(.a(new_n47_), .b(x00), .c(new_n62_), .O(z16));
  nand4  g102(.a(new_n62_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n146_));
