...
module FAU ( 
  ...
  nand2  g024(.a(x07), .b(new_n53_), .O(new_n68_));
  inv1   g025(.a(x11), .O(new_n69_));
  inv1   g026(.a(x12), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n69_), .c(x10), .d(new_n51_), .O(new_n71_));
  oai21  g028(.a(new_n71_), .b(new_n65_), .c(new_n68_), .O(z04));
  nand4  g029(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(new_n59_), .O(z05));
  nor3   g031(.a(new_n69_), .b(new_n59_), .c(x09), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nand2  g033(.a(new_n76_), .b(new_n68_), .O(z06));
  nand2  g034(.a(new_n51_), .b(x01), .O(new_n78_));
  nand3  g035(.a(new_n70_), .b(x11), .c(x10), .O(new_n79_));
  oai22  g036(.a(new_n79_), .b(new_n78_), .c(x07), .d(x01), .O(new_n80_));
  nand3  g037(.a(new_n80_), .b(x02), .c(x00), .O(new_n81_));
  inv1   g038(.a(new_n81_), .O(z07));
  nand2  g039(.a(x02), .b(new_n52_), .O(new_n83_));
  inv1   g040(.a(x05), .O(new_n84_));
  nand2  g041(.a(new_n84_), .b(x04), .O(new_n85_));
  nor3   g042(.a(new_n85_), .b(new_n83_), .c(x03), .O(new_n86_));
  nor2   g043(.a(x08), .b(x06), .O(new_n87_));
  ...
  nor2   g049(.a(new_n54_), .b(x01), .O(new_n93_));
  nor2   g050(.a(new_n70_), .b(x11), .O(new_n94_));
  nand3  g051(.a(new_n94_), .b(new_n93_), .c(new_n44_), .O(new_n95_));
  ...
  nor2   g057(.a(new_n50_), .b(new_n53_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(new_n100_), .c(new_n63_), .O(new_n102_));
  oai21  g059(.a(new_n99_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n92_), .c(new_n91_), .d(new_n52_), .O(new_n104_));
  ...
  nand2  g065(.a(x02), .b(new_n53_), .O(new_n109_));
  ...
  nand3  g071(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n112_), .c(new_n108_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n68_), .O(z10));
  nand4  g075(.a(new_n93_), .b(new_n110_), .c(x12), .d(new_n69_), .O(new_n119_));
  nand4  g076(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n63_), .O(new_n120_));
  nor2   g077(.a(new_n96_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n91_), .c(x20), .d(new_n97_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n119_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n92_), .c(new_n52_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n68_), .O(z11));
  ...
  nand4  g088(.a(new_n131_), .b(new_n44_), .c(new_n53_), .d(new_n52_), .O(new_n132_));
  ...
  nand4  g092(.a(new_n63_), .b(x17), .c(new_n54_), .d(new_n52_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g094(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n59_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g096(.a(new_n44_), .b(new_n54_), .c(new_n127_), .O(new_n140_));
  nand4  g097(.a(x19), .b(new_n44_), .c(new_n54_), .d(new_n53_), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(new_n52_), .c(new_n141_), .O(z15));
  nor2   g099(.a(new_n53_), .b(x00), .O(z16));
  aoi21  g100(.a(new_n83_), .b(new_n44_), .c(x01), .O(z17));
endmodule
