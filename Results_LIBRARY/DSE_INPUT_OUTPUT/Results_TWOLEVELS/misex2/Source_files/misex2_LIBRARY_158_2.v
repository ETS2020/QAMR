...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n135_, new_n139_, new_n140_, new_n143_;
  inv1   g000(.a(x04), .O(new_n44_));
  nand2  g001(.a(new_n44_), .b(x00), .O(new_n45_));
  ...
  nand4  g012(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(x10), .O(new_n56_));
  oai21  g013(.a(new_n56_), .b(new_n52_), .c(new_n45_), .O(z00));
  nand3  g014(.a(new_n51_), .b(x09), .c(new_n46_), .O(new_n58_));
  oai21  g015(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(z01));
  inv1   g016(.a(x10), .O(new_n60_));
  nand4  g017(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(new_n60_), .O(new_n61_));
  oai21  g018(.a(new_n61_), .b(new_n58_), .c(new_n45_), .O(z02));
  nand3  g019(.a(x04), .b(x02), .c(x01), .O(new_n63_));
  nand4  g020(.a(x12), .b(x11), .c(x10), .d(new_n47_), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(x04), .O(new_n65_));
  nand2  g022(.a(new_n65_), .b(x00), .O(new_n66_));
  nor3   g023(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n55_), .c(x18), .d(new_n53_), .O(new_n68_));
  nand2  g025(.a(new_n68_), .b(new_n66_), .O(z03));
  nor2   g026(.a(x09), .b(new_n46_), .O(new_n70_));
  nor2   g027(.a(x12), .b(x11), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n70_), .c(x10), .d(x01), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x04), .c(new_n48_), .O(z04));
  nand4  g030(.a(x04), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n60_), .c(new_n47_), .O(z05));
  inv1   g032(.a(x11), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(new_n60_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x04), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n48_), .O(z06));
  inv1   g036(.a(x12), .O(new_n80_));
  nand3  g037(.a(new_n80_), .b(x11), .c(x10), .O(new_n81_));
  oai21  g038(.a(new_n81_), .b(x09), .c(x01), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x04), .c(x02), .d(x00), .O(new_n83_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n54_), .c(x17), .d(new_n85_), .O(new_n93_));
  ...
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n76_), .O(new_n98_));
  ...
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n45_), .O(z10));
  nand4  g078(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n55_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n48_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n45_), .O(z11));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(x04), .c(x01), .d(x00), .O(new_n129_));
  ...
  nor4   g093(.a(new_n50_), .b(x19), .c(new_n53_), .d(x02), .O(z13));
  oai21  g094(.a(new_n61_), .b(new_n52_), .c(new_n45_), .O(z14));
  aoi21  g095(.a(x19), .b(new_n49_), .c(x00), .O(new_n139_));
  aoi21  g096(.a(new_n60_), .b(x01), .c(new_n44_), .O(new_n140_));
  oai22  g097(.a(new_n140_), .b(new_n48_), .c(new_n139_), .d(x02), .O(z15));
  nor2   g098(.a(new_n49_), .b(x00), .O(z16));
  nand2  g099(.a(new_n51_), .b(x02), .O(new_n143_));
