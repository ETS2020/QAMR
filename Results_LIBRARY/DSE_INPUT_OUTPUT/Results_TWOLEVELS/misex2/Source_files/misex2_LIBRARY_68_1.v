...
module FAU ( 
  ...
  aoi21  g33(.a(new_n76_), .b(new_n59_), .c(new_n69_), .O(new_n77_));
  nand4  g34(.a(new_n77_), .b(x10), .c(new_n46_), .d(x02), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(x00), .c(new_n60_), .O(z06));
  ...
  nand4  g54(.a(new_n69_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n98_));
  ...
  nor3   g80(.a(x10), .b(x09), .c(x02), .O(new_n124_));
  nand4  g81(.a(new_n124_), .b(new_n62_), .c(new_n45_), .d(new_n44_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n60_), .c(x00), .O(z14));
  oai21  g83(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n127_));
  oai21  g84(.a(x19), .b(x00), .c(new_n61_), .O(new_n128_));
