...
module FAU ( 
  ...
  nand4  g015(.a(new_n58_), .b(new_n54_), .c(new_n53_), .d(new_n44_), .O(new_n59_));
  nor2   g016(.a(new_n59_), .b(x19), .O(z02));
  nand2  g017(.a(new_n54_), .b(x15), .O(new_n61_));
  inv1   g018(.a(x19), .O(new_n62_));
  nand4  g019(.a(new_n45_), .b(new_n62_), .c(x18), .d(new_n53_), .O(new_n63_));
  nand3  g020(.a(x02), .b(x01), .c(x00), .O(new_n64_));
  inv1   g021(.a(new_n64_), .O(new_n65_));
  nand4  g022(.a(new_n65_), .b(new_n47_), .c(x12), .d(x11), .O(new_n66_));
  ...
  aoi21  g032(.a(new_n54_), .b(x15), .c(new_n46_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n68_), .O(z05));
  nor3   g035(.a(new_n70_), .b(new_n46_), .c(x09), .O(new_n79_));
  ...
  nor3   g046(.a(new_n62_), .b(new_n53_), .c(x08), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n56_), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(new_n44_), .c(x18), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  nor2   g051(.a(new_n55_), .b(x01), .O(new_n95_));
  ...
  nand4  g057(.a(new_n100_), .b(new_n62_), .c(x18), .d(x01), .O(new_n101_));
  oai21  g058(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n68_), .O(new_n103_));
  nand2  g060(.a(new_n103_), .b(new_n61_), .O(z09));
  ...
  inv1   g064(.a(x01), .O(new_n108_));
  nand2  g065(.a(x02), .b(new_n108_), .O(new_n109_));
  ...
  aoi21  g073(.a(new_n116_), .b(new_n112_), .c(new_n107_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n61_), .O(z10));
  nor2   g075(.a(x13), .b(new_n71_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n95_), .c(new_n70_), .O(new_n120_));
  nand4  g077(.a(x21), .b(new_n100_), .c(new_n62_), .d(x01), .O(new_n121_));
  nor2   g078(.a(new_n44_), .b(x14), .O(new_n122_));
  ...
  nand4  g082(.a(new_n125_), .b(new_n94_), .c(x18), .d(new_n68_), .O(new_n126_));
  ...
  nand3  g088(.a(new_n62_), .b(x17), .c(new_n55_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n108_), .c(new_n68_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(new_n61_), .c(new_n128_), .d(x09), .O(new_n136_));
  inv1   g093(.a(new_n136_), .O(z12));
  inv1   g094(.a(new_n56_), .O(new_n138_));
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n61_), .O(z13));
  nand3  g096(.a(new_n56_), .b(new_n69_), .c(new_n55_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x10), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n54_), .c(new_n53_), .d(new_n44_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  oai21  g100(.a(x10), .b(new_n108_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n55_), .c(new_n108_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n61_), .O(z15));
  oai21  g104(.a(new_n108_), .b(x00), .c(new_n61_), .O(z16));
  oai21  g105(.a(new_n109_), .b(x00), .c(new_n61_), .O(z17));
endmodule
