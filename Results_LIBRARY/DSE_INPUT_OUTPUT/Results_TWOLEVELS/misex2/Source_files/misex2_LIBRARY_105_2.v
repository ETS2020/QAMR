...
module FAU ( 
  ...
  nor3   g037(.a(new_n80_), .b(new_n44_), .c(new_n78_), .O(z06));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n44_), .d(new_n78_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n49_), .c(x17), .d(new_n86_), .O(new_n94_));
  ...
  nand3  g063(.a(new_n106_), .b(new_n96_), .c(new_n78_), .O(new_n107_));
  aoi21  g064(.a(new_n107_), .b(new_n89_), .c(x21), .O(z09));
  ...
  nand3  g074(.a(new_n96_), .b(new_n51_), .c(x20), .O(new_n118_));
  ...
  nand4  g080(.a(new_n123_), .b(new_n51_), .c(x20), .d(new_n100_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n115_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n78_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n78_), .O(new_n133_));
  ...
  nand2  g102(.a(new_n97_), .b(new_n78_), .O(new_n146_));
