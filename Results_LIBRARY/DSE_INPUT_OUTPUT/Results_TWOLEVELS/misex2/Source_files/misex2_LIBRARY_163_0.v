...
module FAU ( 
  ...
  nand4  g013(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(x10), .O(new_n57_));
  inv1   g014(.a(new_n57_), .O(new_n58_));
  nand4  g015(.a(new_n58_), .b(x09), .c(new_n51_), .d(new_n49_), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(x20), .c(x01), .O(z01));
  inv1   g017(.a(x09), .O(new_n61_));
  nor3   g018(.a(new_n52_), .b(x10), .c(new_n61_), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(new_n44_), .O(z02));
  nand2  g021(.a(new_n51_), .b(new_n49_), .O(new_n65_));
  nand3  g022(.a(new_n47_), .b(x18), .c(new_n45_), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(new_n65_), .c(x20), .O(new_n67_));
  nand2  g024(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  nand3  g025(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nor2   g026(.a(new_n48_), .b(x09), .O(new_n70_));
  nand3  g027(.a(new_n70_), .b(x12), .c(x11), .O(new_n71_));
  oai21  g028(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(z03));
  nand2  g029(.a(new_n44_), .b(new_n50_), .O(new_n73_));
  ...
  nor3   g037(.a(new_n74_), .b(new_n48_), .c(x09), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x02), .c(x01), .d(x00), .O(new_n82_));
  nand2  g039(.a(new_n82_), .b(new_n73_), .O(z06));
  nand2  g040(.a(new_n61_), .b(x01), .O(new_n84_));
  nand3  g041(.a(new_n75_), .b(x11), .c(x10), .O(new_n85_));
  oai22  g042(.a(new_n85_), .b(new_n84_), .c(new_n44_), .d(x01), .O(new_n86_));
  ...
  nand2  g058(.a(x02), .b(new_n50_), .O(new_n102_));
  inv1   g059(.a(new_n102_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(x12), .c(new_n74_), .O(new_n104_));
  ...
  nor2   g065(.a(new_n46_), .b(new_n50_), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(new_n44_), .c(new_n47_), .O(new_n110_));
  oai21  g067(.a(new_n108_), .b(new_n104_), .c(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n101_), .c(new_n100_), .d(new_n49_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(z09));
  nand3  g070(.a(x22), .b(x21), .c(new_n44_), .O(new_n114_));
  nor3   g071(.a(new_n114_), .b(x19), .c(new_n46_), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n75_), .O(new_n116_));
  nand2  g073(.a(new_n116_), .b(new_n74_), .O(new_n117_));
  nor2   g074(.a(new_n117_), .b(new_n102_), .O(new_n118_));
  nand3  g075(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n119_));
  nor3   g076(.a(new_n119_), .b(new_n105_), .c(x14), .O(new_n120_));
  aoi21  g077(.a(new_n120_), .b(new_n118_), .c(new_n115_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n73_), .O(z10));
  inv1   g079(.a(new_n118_), .O(new_n123_));
  nand4  g080(.a(new_n109_), .b(x21), .c(new_n44_), .d(new_n47_), .O(new_n124_));
  nor2   g081(.a(new_n105_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n100_), .c(x20), .d(new_n106_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n101_), .c(new_n49_), .O(new_n128_));
  ...
  nand3  g089(.a(new_n47_), .b(x17), .c(new_n51_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n50_), .c(new_n49_), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(new_n131_), .c(x24), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(x09), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n73_), .O(z12));
  nand4  g095(.a(new_n47_), .b(x17), .c(new_n51_), .d(new_n49_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(x20), .c(x01), .O(z13));
  nor2   g097(.a(new_n53_), .b(x10), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(new_n44_), .O(z14));
  aoi21  g100(.a(new_n48_), .b(x01), .c(new_n51_), .O(new_n144_));
  aoi21  g101(.a(x19), .b(new_n51_), .c(new_n44_), .O(new_n145_));
  oai22  g102(.a(new_n145_), .b(x01), .c(new_n144_), .d(new_n49_), .O(z15));
  nor2   g103(.a(new_n50_), .b(x00), .O(z16));
  nand4  g104(.a(x20), .b(x02), .c(new_n50_), .d(new_n49_), .O(new_n148_));
