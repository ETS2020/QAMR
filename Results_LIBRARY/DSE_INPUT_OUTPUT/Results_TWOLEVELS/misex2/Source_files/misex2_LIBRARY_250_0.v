...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n74_, new_n75_, new_n76_, new_n78_, new_n80_, new_n81_, new_n83_,
    new_n84_, new_n88_, new_n89_;
  ...
  nand2  g13(.a(x11), .b(x10), .O(new_n60_));
  nor2   g14(.a(new_n60_), .b(x09), .O(new_n61_));
  nand4  g15(.a(new_n61_), .b(x02), .c(x01), .d(x00), .O(new_n62_));
  nand2  g16(.a(new_n62_), .b(new_n48_), .O(z06));
  inv1   g17(.a(x00), .O(new_n64_));
  inv1   g18(.a(x01), .O(new_n65_));
  oai21  g19(.a(x02), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  inv1   g20(.a(x12), .O(new_n67_));
  nand3  g21(.a(new_n51_), .b(new_n67_), .c(x11), .O(new_n68_));
  oai21  g22(.a(new_n68_), .b(new_n49_), .c(new_n66_), .O(z07));
  inv1   g23(.a(x20), .O(new_n70_));
  inv1   g24(.a(x21), .O(new_n71_));
  inv1   g25(.a(x22), .O(new_n72_));
  inv1   g26(.a(x19), .O(new_n73_));
  nand4  g27(.a(new_n73_), .b(x18), .c(x01), .d(new_n64_), .O(new_n74_));
  inv1   g28(.a(new_n74_), .O(new_n75_));
  nand4  g29(.a(new_n75_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n76_));
  inv1   g30(.a(new_n76_), .O(z09));
  nand4  g31(.a(new_n75_), .b(x22), .c(x21), .d(new_n70_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(z10));
  nor2   g33(.a(x22), .b(new_n71_), .O(new_n80_));
  nand4  g34(.a(new_n80_), .b(new_n70_), .c(new_n73_), .d(x18), .O(new_n81_));
  ...
  nand2  g38(.a(new_n84_), .b(new_n48_), .O(z12));
  inv1   g39(.a(x02), .O(new_n88_));
  aoi21  g40(.a(new_n50_), .b(x01), .c(new_n88_), .O(new_n89_));
  oai21  g41(.a(new_n89_), .b(new_n64_), .c(new_n48_), .O(z15));
  nor2   g42(.a(new_n65_), .b(x00), .O(z16));
  zero   g43(.O(z00));
  zero   g44(.O(z01));
  zero   g45(.O(z02));
  zero   g46(.O(z13));
