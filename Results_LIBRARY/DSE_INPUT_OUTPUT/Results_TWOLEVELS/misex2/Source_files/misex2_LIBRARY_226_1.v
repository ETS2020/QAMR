...
module FAU ( 
  ...
  nand4  g27(.a(new_n70_), .b(new_n68_), .c(x10), .d(new_n51_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(x12), .O(z04));
  nor3   g29(.a(new_n69_), .b(new_n59_), .c(new_n51_), .O(z05));
  nand4  g30(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n53_), .c(new_n52_), .O(z06));
  ...
  nor2   g49(.a(new_n54_), .b(x01), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(x12), .c(new_n68_), .d(new_n44_), .O(new_n94_));
  ...
  nor2   g56(.a(new_n50_), .b(new_n53_), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n63_), .O(new_n101_));
  oai21  g58(.a(new_n98_), .b(new_n94_), .c(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n52_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand3  g61(.a(new_n63_), .b(x18), .c(x01), .O(new_n105_));
  ...
  nor3   g69(.a(new_n112_), .b(new_n111_), .c(x14), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n110_), .c(new_n107_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(x00), .c(new_n80_), .O(z10));
  nand4  g72(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n116_));
  nor2   g73(.a(new_n95_), .b(x14), .O(new_n117_));
  nor2   g74(.a(x21), .b(new_n99_), .O(new_n118_));
  nand4  g75(.a(new_n118_), .b(new_n117_), .c(new_n96_), .d(new_n108_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n94_), .c(new_n116_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n92_), .c(new_n52_), .O(new_n121_));
  ...
  nand3  g82(.a(new_n63_), .b(x17), .c(new_n54_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand3  g84(.a(new_n127_), .b(new_n53_), .c(new_n52_), .O(new_n128_));
  ...
  nor3   g88(.a(new_n55_), .b(x19), .c(new_n45_), .O(z13));
  nor2   g89(.a(new_n55_), .b(x09), .O(new_n133_));
  nand4  g90(.a(new_n133_), .b(new_n50_), .c(new_n45_), .d(new_n59_), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z14));
  aoi21  g92(.a(new_n59_), .b(x01), .c(new_n54_), .O(new_n136_));
  aoi21  g93(.a(x19), .b(new_n54_), .c(x03), .O(new_n137_));
  oai22  g94(.a(new_n137_), .b(x01), .c(new_n136_), .d(new_n52_), .O(z15));
  nor2   g95(.a(new_n53_), .b(x00), .O(z16));
  nand2  g96(.a(x02), .b(new_n52_), .O(new_n140_));
