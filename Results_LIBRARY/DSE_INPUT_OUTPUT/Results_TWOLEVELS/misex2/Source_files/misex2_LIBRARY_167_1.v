...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(new_n44_), .O(new_n45_));
  ...
  nand3  g21(.a(x10), .b(new_n49_), .c(x02), .O(new_n65_));
  oai21  g22(.a(new_n65_), .b(new_n64_), .c(x11), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(x12), .O(new_n67_));
  nor3   g24(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nand4  g25(.a(new_n68_), .b(new_n53_), .c(x18), .d(new_n51_), .O(new_n69_));
  nand2  g26(.a(new_n69_), .b(new_n67_), .O(z03));
  nand3  g27(.a(x02), .b(x01), .c(x00), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n44_), .c(x10), .d(new_n49_), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(x12), .O(z04));
  inv1   g31(.a(new_n45_), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(new_n56_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g34(.a(new_n77_), .b(new_n46_), .O(z05));
  oai21  g35(.a(x12), .b(x11), .c(x10), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(x09), .O(new_n80_));
  nand4  g37(.a(new_n80_), .b(x02), .c(x01), .d(x00), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(new_n45_), .O(z06));
  ...
  nand3  g44(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n88_));
  ...
  nor2   g49(.a(new_n53_), .b(x18), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(x17), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(new_n45_), .O(z08));
  nand3  g52(.a(x18), .b(x01), .c(new_n46_), .O(new_n96_));
  inv1   g53(.a(x20), .O(new_n97_));
  inv1   g54(.a(x21), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n53_), .O(new_n100_));
  oai21  g57(.a(new_n100_), .b(new_n96_), .c(new_n45_), .O(z09));
  nand4  g58(.a(new_n45_), .b(x22), .c(x21), .d(new_n97_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n53_), .c(x18), .d(x01), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(x00), .O(z10));
  nand4  g62(.a(new_n45_), .b(new_n99_), .c(x21), .d(new_n97_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n53_), .c(x18), .d(x01), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(x00), .O(z11));
  ...
  nand3  g70(.a(new_n53_), .b(x17), .c(new_n48_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n47_), .c(new_n46_), .O(new_n116_));
  ...
  nor2   g76(.a(new_n75_), .b(x19), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x00), .O(z13));
  nor2   g79(.a(new_n57_), .b(x10), .O(new_n123_));
  nand4  g80(.a(new_n123_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x00), .O(z14));
  oai21  g82(.a(x10), .b(new_n47_), .c(x02), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(x00), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n127_), .c(new_n75_), .O(z15));
  nor3   g86(.a(new_n75_), .b(new_n47_), .c(x00), .O(z16));
  nand2  g87(.a(new_n88_), .b(new_n45_), .O(z17));
endmodule
