...
module FAU ( 
  ...
  nand4  g015(.a(new_n45_), .b(new_n58_), .c(new_n57_), .d(new_n51_), .O(new_n59_));
  ...
  inv1   g019(.a(new_n45_), .O(new_n63_));
  ...
  nand4  g026(.a(new_n69_), .b(new_n58_), .c(x18), .d(new_n51_), .O(new_n70_));
  aoi21  g027(.a(new_n70_), .b(new_n68_), .c(new_n63_), .O(z03));
  inv1   g028(.a(x11), .O(new_n72_));
  inv1   g029(.a(x12), .O(new_n73_));
  nand3  g030(.a(new_n67_), .b(new_n73_), .c(new_n72_), .O(new_n74_));
  oai21  g031(.a(new_n74_), .b(new_n64_), .c(new_n45_), .O(z04));
  nor2   g032(.a(new_n63_), .b(new_n66_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n46_), .O(z05));
  nand3  g035(.a(new_n44_), .b(x13), .c(x12), .O(new_n79_));
  ...
  nor2   g051(.a(new_n58_), .b(x18), .O(new_n95_));
  ...
  nand3  g056(.a(new_n88_), .b(x12), .c(new_n72_), .O(new_n100_));
  inv1   g057(.a(x14), .O(new_n101_));
  inv1   g058(.a(x16), .O(new_n102_));
  nand4  g059(.a(x20), .b(new_n102_), .c(new_n44_), .d(new_n101_), .O(new_n103_));
  inv1   g060(.a(x20), .O(new_n104_));
  nor2   g061(.a(new_n57_), .b(new_n47_), .O(new_n105_));
  nand3  g062(.a(new_n105_), .b(new_n104_), .c(new_n58_), .O(new_n106_));
  oai21  g063(.a(new_n103_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n46_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n45_), .O(z09));
  nand4  g066(.a(new_n45_), .b(x22), .c(x21), .d(new_n104_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(new_n111_));
  nand4  g068(.a(new_n111_), .b(new_n58_), .c(x18), .d(x01), .O(new_n112_));
  inv1   g069(.a(x13), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n72_), .O(new_n114_));
  inv1   g071(.a(new_n114_), .O(new_n115_));
  nor3   g072(.a(new_n102_), .b(new_n44_), .c(x14), .O(new_n116_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n113_), .c(x12), .d(new_n72_), .O(new_n121_));
  nand4  g078(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n58_), .O(new_n122_));
  nor2   g079(.a(new_n44_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n98_), .c(x20), .d(new_n102_), .O(new_n124_));
  ...
  nand3  g088(.a(new_n58_), .b(x17), .c(new_n48_), .O(new_n132_));
  ...
  nor2   g094(.a(new_n63_), .b(x19), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(x17), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z13));
  nand3  g097(.a(new_n52_), .b(new_n51_), .c(new_n66_), .O(new_n141_));
  ...
  nand2  g104(.a(new_n89_), .b(new_n45_), .O(z17));
endmodule
