...
module FAU ( 
  ...
  nor2   g021(.a(x19), .b(new_n51_), .O(new_n65_));
  nand3  g022(.a(new_n65_), .b(new_n64_), .c(new_n50_), .O(new_n66_));
  ...
  inv1   g035(.a(new_n45_), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(new_n56_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x09), .c(x02), .d(x01), .O(new_n81_));
  nor2   g038(.a(new_n81_), .b(new_n74_), .O(z05));
  nor3   g039(.a(new_n69_), .b(new_n56_), .c(x09), .O(new_n83_));
  ...
  nand2  g047(.a(new_n90_), .b(new_n74_), .O(new_n91_));
  ...
  nor2   g053(.a(new_n52_), .b(x18), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(x17), .O(new_n98_));
  nand2  g055(.a(new_n98_), .b(new_n45_), .O(z08));
  inv1   g056(.a(x21), .O(new_n100_));
  inv1   g057(.a(x22), .O(new_n101_));
  nand4  g058(.a(x12), .b(new_n69_), .c(x02), .d(new_n55_), .O(new_n102_));
  ...
  nand4  g066(.a(new_n109_), .b(new_n45_), .c(new_n101_), .d(new_n100_), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(x00), .O(z09));
  nor2   g068(.a(new_n101_), .b(new_n100_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n65_), .c(new_n107_), .d(x01), .O(new_n113_));
  nor2   g070(.a(x13), .b(new_n70_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n90_), .c(new_n69_), .O(new_n115_));
  inv1   g072(.a(x14), .O(new_n116_));
  nor2   g073(.a(new_n104_), .b(new_n103_), .O(new_n117_));
  nor2   g074(.a(x22), .b(x21), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n117_), .c(x20), .d(new_n116_), .O(new_n119_));
  oai21  g076(.a(new_n119_), .b(new_n115_), .c(new_n113_), .O(new_n120_));
  nand3  g077(.a(new_n120_), .b(new_n45_), .c(new_n74_), .O(new_n121_));
  inv1   g078(.a(new_n121_), .O(z10));
  nor2   g079(.a(new_n51_), .b(new_n55_), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(x21), .c(new_n107_), .d(new_n52_), .O(new_n124_));
  nor2   g081(.a(new_n103_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n100_), .c(x20), .d(new_n104_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n115_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n101_), .c(new_n74_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n55_), .c(new_n74_), .O(new_n136_));
  ...
  oai21  g098(.a(new_n62_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g099(.a(x10), .b(new_n55_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n55_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n45_), .O(z15));
  nor3   g103(.a(new_n79_), .b(new_n55_), .c(x00), .O(z16));
  nand2  g104(.a(new_n91_), .b(new_n45_), .O(z17));
endmodule
