...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(x02), .O(new_n72_));
  inv1   g29(.a(x12), .O(new_n73_));
  nand3  g30(.a(new_n73_), .b(x11), .c(x10), .O(new_n74_));
  oai21  g31(.a(new_n74_), .b(new_n72_), .c(x00), .O(new_n75_));
  ...
  nand4  g46(.a(new_n63_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n90_));
  ...
  nand3  g65(.a(new_n58_), .b(x17), .c(new_n45_), .O(new_n109_));
  ...
  nand4  g72(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n55_), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n81_), .c(new_n57_), .d(new_n52_), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(x19), .O(z14));
  oai21  g76(.a(new_n52_), .b(new_n55_), .c(x01), .O(new_n120_));
