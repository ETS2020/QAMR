...
module FAU ( 
  ...
  nor3   g031(.a(new_n74_), .b(new_n53_), .c(new_n59_), .O(z05));
  ...
  nor2   g055(.a(x13), .b(new_n81_), .O(new_n99_));
  nand3  g056(.a(new_n99_), .b(new_n98_), .c(x02), .O(new_n100_));
  ...
  nand4  g068(.a(new_n99_), .b(new_n98_), .c(x02), .d(new_n63_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand3  g070(.a(x16), .b(x15), .c(new_n101_), .O(new_n114_));
  nand3  g071(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n113_), .c(new_n111_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n54_), .O(z10));
  nand3  g075(.a(x18), .b(x16), .c(x01), .O(new_n119_));
  nand3  g076(.a(x21), .b(new_n104_), .c(new_n56_), .O(new_n120_));
  nor2   g077(.a(new_n102_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n96_), .c(x20), .d(new_n53_), .O(new_n122_));
  ...
  nand4  g083(.a(new_n126_), .b(x16), .c(x01), .d(x00), .O(new_n127_));
  ...
  nand3  g091(.a(new_n48_), .b(x17), .c(new_n46_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x19), .O(z13));
  nand3  g093(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n137_));
  oai21  g094(.a(new_n137_), .b(new_n60_), .c(new_n54_), .O(z14));
  aoi22  g095(.a(new_n54_), .b(x00), .c(x19), .d(new_n63_), .O(new_n139_));
  nand3  g096(.a(new_n66_), .b(x16), .c(new_n59_), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  nand3  g098(.a(x16), .b(x01), .c(new_n62_), .O(new_n142_));
