...
module FAU ( 
  ...
  nand2  g35(.a(new_n64_), .b(x01), .O(new_n79_));
  nand3  g36(.a(new_n70_), .b(x11), .c(x10), .O(new_n80_));
  oai22  g37(.a(new_n80_), .b(new_n79_), .c(new_n67_), .d(x01), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(z07));
  nand2  g40(.a(x02), .b(new_n51_), .O(new_n84_));
  ...
  nor2   g45(.a(new_n61_), .b(x18), .O(new_n89_));
  ...
  nor2   g51(.a(new_n55_), .b(x00), .O(z16));
  nand3  g52(.a(z16), .b(new_n61_), .c(x18), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n94_), .c(new_n93_), .d(new_n92_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z09));
  nand3  g56(.a(new_n61_), .b(x18), .c(x01), .O(new_n100_));
  nand3  g57(.a(x22), .b(x21), .c(new_n92_), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g59(.a(x02), .b(new_n55_), .O(new_n103_));
  ...
  nand3  g65(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(new_n102_), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(x00), .c(new_n68_), .O(z10));
  nand3  g69(.a(x18), .b(x01), .c(new_n51_), .O(new_n113_));
  nand4  g70(.a(new_n94_), .b(x21), .c(new_n92_), .d(new_n61_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n113_), .c(new_n68_), .O(z11));
  ...
  nand3  g76(.a(new_n61_), .b(x17), .c(new_n52_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand4  g78(.a(new_n121_), .b(x16), .c(new_n55_), .d(new_n51_), .O(new_n122_));
  ...
  nand4  g82(.a(new_n61_), .b(x17), .c(new_n52_), .d(new_n51_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(x16), .c(x01), .O(z13));
  nand4  g84(.a(new_n46_), .b(new_n44_), .c(new_n45_), .d(new_n73_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(x16), .c(x01), .O(z14));
  aoi21  g86(.a(new_n73_), .b(x01), .c(new_n52_), .O(new_n130_));
  aoi21  g87(.a(x19), .b(new_n52_), .c(new_n67_), .O(new_n131_));
  oai22  g88(.a(new_n131_), .b(x01), .c(new_n130_), .d(new_n51_), .O(z15));
  nand4  g89(.a(x16), .b(x02), .c(new_n55_), .d(new_n51_), .O(new_n133_));
