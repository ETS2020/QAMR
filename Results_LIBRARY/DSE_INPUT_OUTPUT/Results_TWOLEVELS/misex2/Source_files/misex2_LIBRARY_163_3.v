...
module FAU ( 
  ...
  nand2  g009(.a(x20), .b(x01), .O(new_n53_));
  ...
  nand2  g035(.a(x20), .b(new_n73_), .O(new_n79_));
  ...
  aoi21  g039(.a(new_n82_), .b(new_n63_), .c(new_n71_), .O(z06));
  nand2  g040(.a(x10), .b(new_n47_), .O(new_n84_));
  nand3  g041(.a(new_n63_), .b(new_n73_), .c(x11), .O(new_n85_));
  ...
  nand4  g050(.a(new_n93_), .b(x02), .c(new_n71_), .d(new_n92_), .O(new_n94_));
  ...
  nor2   g055(.a(new_n98_), .b(new_n55_), .O(z08));
  ...
  nor2   g064(.a(new_n45_), .b(new_n71_), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(new_n63_), .c(new_n55_), .O(new_n109_));
  oai21  g066(.a(new_n107_), .b(new_n103_), .c(new_n109_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n101_), .c(new_n100_), .d(new_n92_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(z09));
  nand4  g069(.a(new_n108_), .b(x22), .c(x21), .d(new_n55_), .O(new_n113_));
  nand4  g070(.a(new_n106_), .b(x12), .c(new_n72_), .d(x02), .O(new_n114_));
  nor2   g071(.a(x22), .b(x21), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(x20), .c(x16), .d(x15), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  nand2  g074(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nand2  g075(.a(new_n118_), .b(new_n53_), .O(z10));
  nand4  g076(.a(new_n108_), .b(x21), .c(new_n63_), .d(new_n55_), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n73_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n102_), .c(new_n72_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n101_), .c(new_n92_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n71_), .c(new_n92_), .O(new_n133_));
  ...
  oai21  g097(.a(x10), .b(new_n71_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n71_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n53_), .O(z15));
  nand3  g101(.a(new_n63_), .b(x01), .c(new_n92_), .O(new_n145_));
