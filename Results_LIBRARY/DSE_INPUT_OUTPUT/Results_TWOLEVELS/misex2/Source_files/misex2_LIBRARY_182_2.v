...
module FAU ( 
  ...
  nor2   g038(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x10), .c(new_n47_), .d(x02), .O(new_n83_));
  nor3   g040(.a(new_n83_), .b(new_n55_), .c(new_n71_), .O(z06));
  ...
  nand4  g049(.a(new_n92_), .b(x02), .c(new_n55_), .d(new_n71_), .O(new_n93_));
  ...
  nor2   g063(.a(new_n51_), .b(new_n55_), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(new_n106_), .c(new_n52_), .O(new_n108_));
  oai21  g065(.a(new_n105_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(new_n99_), .c(new_n71_), .O(new_n110_));
  aoi21  g067(.a(new_n110_), .b(new_n89_), .c(x21), .O(z09));
  ...
  nand3  g077(.a(new_n99_), .b(new_n44_), .c(x20), .O(new_n121_));
  ...
  nand4  g081(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n52_), .O(new_n125_));
  nor2   g082(.a(new_n102_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n44_), .c(x20), .d(new_n103_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n118_), .c(new_n125_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n99_), .c(new_n71_), .O(new_n129_));
  ...
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n46_), .d(new_n55_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x00), .O(z13));
  oai21  g099(.a(new_n62_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g100(.a(x10), .b(new_n55_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n46_), .c(new_n55_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n45_), .O(z15));
  nor3   g104(.a(new_n81_), .b(new_n55_), .c(x00), .O(z16));
  nand2  g105(.a(new_n100_), .b(new_n71_), .O(new_n149_));
