...
module FAU ( 
  ...
  nor2   g030(.a(new_n73_), .b(x24), .O(z04));
  nor4   g031(.a(new_n71_), .b(x24), .c(new_n57_), .d(new_n47_), .O(z05));
  nand4  g032(.a(new_n60_), .b(x11), .c(x10), .d(new_n47_), .O(new_n76_));
  ...
  nand2  g053(.a(new_n96_), .b(new_n84_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nand3  g056(.a(new_n87_), .b(x12), .c(new_n69_), .O(new_n100_));
  ...
  nor2   g061(.a(x24), .b(x20), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n94_), .c(x18), .d(x01), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(new_n100_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n86_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(z09));
  nand3  g066(.a(new_n94_), .b(x18), .c(x01), .O(new_n110_));
  inv1   g067(.a(x20), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n111_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  inv1   g070(.a(x01), .O(new_n114_));
  nand2  g071(.a(x02), .b(new_n114_), .O(new_n115_));
  ...
  aoi21  g079(.a(new_n122_), .b(new_n118_), .c(new_n113_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(x00), .c(new_n84_), .O(z10));
  nand4  g081(.a(new_n87_), .b(new_n116_), .c(x12), .d(new_n69_), .O(new_n125_));
  nor2   g082(.a(new_n101_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n98_), .c(x20), .d(new_n102_), .O(new_n127_));
  nor2   g084(.a(x24), .b(new_n98_), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(new_n66_), .c(new_n111_), .d(x01), .O(new_n129_));
  oai21  g086(.a(new_n127_), .b(new_n125_), .c(new_n129_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n99_), .c(new_n86_), .O(new_n131_));
  ...
  nand3  g092(.a(new_n94_), .b(x17), .c(new_n46_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n60_), .c(new_n114_), .d(new_n86_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n84_), .O(z12));
  inv1   g098(.a(new_n48_), .O(new_n142_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n84_), .O(z13));
  nand3  g100(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n144_));
  nand4  g101(.a(new_n94_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n145_));
  oai21  g102(.a(new_n145_), .b(new_n144_), .c(new_n84_), .O(z14));
  oai21  g103(.a(x10), .b(new_n114_), .c(x02), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(x00), .O(new_n148_));
  nand3  g105(.a(x19), .b(new_n46_), .c(new_n114_), .O(new_n149_));
  nand3  g106(.a(new_n149_), .b(new_n148_), .c(new_n84_), .O(z15));
  aoi21  g107(.a(new_n60_), .b(x00), .c(new_n114_), .O(z16));
  nand2  g108(.a(new_n88_), .b(new_n84_), .O(z17));
endmodule
