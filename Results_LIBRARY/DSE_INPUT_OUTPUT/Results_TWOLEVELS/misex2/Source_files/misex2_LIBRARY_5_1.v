...
module FAU ( 
  ...
  aoi21  g050(.a(new_n93_), .b(new_n85_), .c(x06), .O(z08));
  inv1   g051(.a(x00), .O(new_n95_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n85_), .d(new_n95_), .O(new_n106_));
  ...
  nand3  g073(.a(new_n96_), .b(new_n85_), .c(x20), .O(new_n117_));
  ...
  nand2  g078(.a(new_n121_), .b(new_n97_), .O(new_n122_));
  nand3  g079(.a(x18), .b(x06), .c(x01), .O(new_n123_));
  inv1   g080(.a(new_n123_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n103_), .d(new_n50_), .O(new_n125_));
  nor2   g082(.a(new_n99_), .b(x14), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(new_n85_), .c(x20), .d(new_n100_), .O(new_n127_));
  oai21  g084(.a(new_n127_), .b(new_n122_), .c(new_n125_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n96_), .c(new_n95_), .O(new_n129_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n44_), .c(new_n95_), .O(new_n137_));
  ...
  oai21  g097(.a(new_n135_), .b(new_n87_), .c(new_n52_), .O(z13));
  ...
  oai21  g105(.a(new_n111_), .b(x00), .c(new_n52_), .O(z17));
endmodule
