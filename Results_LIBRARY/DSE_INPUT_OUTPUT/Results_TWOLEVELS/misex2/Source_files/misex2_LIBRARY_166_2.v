...
module FAU ( 
  ...
  nor3   g015(.a(x19), .b(x18), .c(x10), .O(new_n59_));
  nand4  g016(.a(new_n59_), .b(x09), .c(new_n46_), .d(new_n58_), .O(new_n60_));
  aoi21  g017(.a(new_n60_), .b(new_n57_), .c(x17), .O(z02));
  ...
  nor4   g033(.a(new_n72_), .b(new_n44_), .c(new_n76_), .d(new_n47_), .O(z05));
  nor2   g034(.a(new_n70_), .b(new_n76_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n47_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x17), .c(new_n57_), .O(z06));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n57_), .d(new_n58_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n104_), .b(x18), .c(x17), .d(x01), .O(new_n105_));
  ...
  nand4  g075(.a(new_n118_), .b(new_n66_), .c(x18), .d(x01), .O(new_n119_));
  ...
  nand3  g079(.a(new_n122_), .b(new_n97_), .c(new_n58_), .O(new_n123_));
  nand2  g080(.a(new_n123_), .b(new_n84_), .O(z11));
  ...
  nand2  g085(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  aoi21  g086(.a(new_n129_), .b(new_n127_), .c(new_n44_), .O(new_n130_));
  inv1   g087(.a(x23), .O(new_n131_));
  nor4   g088(.a(new_n128_), .b(new_n131_), .c(x01), .d(x00), .O(new_n132_));
  oai21  g089(.a(new_n132_), .b(new_n130_), .c(new_n125_), .O(new_n133_));
  nor2   g090(.a(new_n133_), .b(new_n47_), .O(z12));
  inv1   g091(.a(new_n48_), .O(new_n135_));
  nand3  g092(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n135_), .c(new_n84_), .O(z13));
  nand4  g094(.a(new_n59_), .b(new_n47_), .c(new_n46_), .d(new_n58_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n57_), .c(x17), .O(z14));
  aoi22  g096(.a(new_n84_), .b(x00), .c(x19), .d(new_n57_), .O(new_n140_));
  nand4  g097(.a(x17), .b(new_n76_), .c(x01), .d(x00), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(x02), .c(new_n141_), .O(z15));
  nand3  g099(.a(x17), .b(x01), .c(new_n58_), .O(new_n143_));
  inv1   g100(.a(new_n143_), .O(z16));
  nand2  g101(.a(new_n98_), .b(new_n58_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n84_), .O(z17));
endmodule
