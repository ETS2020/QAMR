...
module FAU ( 
  ...
  inv1   g007(.a(x06), .O(new_n51_));
  nand2  g008(.a(x16), .b(new_n51_), .O(new_n52_));
  ...
  oai21  g064(.a(new_n104_), .b(new_n101_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n73_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n52_), .O(z09));
  nand4  g067(.a(new_n52_), .b(x22), .c(x21), .d(new_n105_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n50_), .c(x18), .d(x01), .O(new_n113_));
  nor3   g070(.a(new_n51_), .b(new_n45_), .c(x01), .O(new_n114_));
  inv1   g071(.a(x13), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(x12), .c(new_n66_), .O(new_n116_));
  inv1   g073(.a(new_n116_), .O(new_n117_));
  nor3   g074(.a(new_n89_), .b(new_n102_), .c(x14), .O(new_n118_));
  nand3  g075(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n114_), .O(new_n121_));
  aoi21  g078(.a(new_n121_), .b(new_n113_), .c(x00), .O(z10));
  nand4  g079(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n123_));
  nand4  g080(.a(new_n100_), .b(new_n115_), .c(x12), .d(new_n66_), .O(new_n124_));
  nor2   g081(.a(new_n102_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n98_), .c(x20), .d(new_n89_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n99_), .c(new_n73_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n44_), .c(new_n73_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n134_), .b(new_n90_), .c(new_n52_), .O(z13));
  ...
  nor3   g104(.a(new_n63_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g105(.a(new_n100_), .b(new_n73_), .O(new_n149_));
  nand2  g106(.a(new_n149_), .b(new_n52_), .O(z17));
endmodule
