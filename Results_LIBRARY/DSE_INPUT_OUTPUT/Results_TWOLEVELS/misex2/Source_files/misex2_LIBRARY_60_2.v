...
module FAU ( 
  ...
  nand4  g37(.a(new_n80_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n81_));
  ...
  nor2   g42(.a(new_n85_), .b(new_n63_), .O(z08));
  inv1   g43(.a(x21), .O(new_n87_));
  inv1   g44(.a(x22), .O(new_n88_));
  nor2   g45(.a(new_n48_), .b(x01), .O(new_n89_));
  ...
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n63_), .O(new_n97_));
  oai21  g54(.a(new_n94_), .b(new_n90_), .c(new_n97_), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n88_), .c(new_n87_), .d(new_n46_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(z09));
  nor3   g57(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n63_), .c(x18), .d(x01), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  nand4  g60(.a(new_n89_), .b(new_n103_), .c(x12), .d(new_n75_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n63_), .O(new_n109_));
  ...
  nand3  g69(.a(new_n112_), .b(new_n88_), .c(new_n46_), .O(new_n113_));
  ...
  nand3  g74(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n118_));
  ...
  aoi21  g80(.a(new_n118_), .b(new_n46_), .c(x01), .O(z13));
  nand4  g81(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z14));
  aoi21  g83(.a(x19), .b(new_n48_), .c(x00), .O(new_n127_));
  nand2  g84(.a(new_n115_), .b(x00), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(x01), .c(new_n128_), .O(z15));
  nor2   g86(.a(new_n47_), .b(x00), .O(z16));
  aoi21  g87(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
