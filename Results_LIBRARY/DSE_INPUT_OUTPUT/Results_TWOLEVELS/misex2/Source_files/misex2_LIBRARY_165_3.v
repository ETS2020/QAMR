...
module FAU ( 
  ...
  nand2  g013(.a(x10), .b(x06), .O(new_n57_));
  ...
  nand4  g021(.a(new_n57_), .b(new_n60_), .c(x18), .d(new_n44_), .O(new_n65_));
  inv1   g022(.a(new_n65_), .O(new_n66_));
  nand4  g023(.a(new_n66_), .b(new_n46_), .c(new_n64_), .d(new_n63_), .O(new_n67_));
  nand4  g024(.a(new_n47_), .b(x02), .c(x01), .d(x00), .O(new_n68_));
  nand4  g025(.a(x12), .b(x11), .c(x10), .d(new_n53_), .O(new_n69_));
  oai21  g026(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z03));
  inv1   g027(.a(x11), .O(new_n71_));
  nand3  g028(.a(x02), .b(x01), .c(x00), .O(new_n72_));
  nor2   g029(.a(new_n72_), .b(x06), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n53_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand3  g032(.a(new_n73_), .b(x10), .c(x09), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(z05));
  nand4  g034(.a(x11), .b(new_n53_), .c(new_n47_), .d(x02), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(new_n79_));
  nand3  g036(.a(new_n79_), .b(x01), .c(x00), .O(new_n80_));
  aoi21  g037(.a(new_n80_), .b(new_n47_), .c(new_n59_), .O(z06));
  nand2  g038(.a(new_n57_), .b(new_n64_), .O(new_n82_));
  nand3  g039(.a(new_n53_), .b(new_n47_), .c(x01), .O(new_n83_));
  inv1   g040(.a(x12), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x11), .c(x10), .O(new_n85_));
  oai21  g042(.a(new_n85_), .b(new_n83_), .c(new_n82_), .O(new_n86_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n63_), .O(new_n93_));
  nor3   g050(.a(x08), .b(x07), .c(x06), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(x19), .c(new_n45_), .d(x17), .O(new_n95_));
  oai21  g052(.a(new_n95_), .b(new_n93_), .c(new_n57_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n71_), .c(x02), .d(new_n64_), .O(new_n99_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n60_), .c(x18), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n57_), .c(new_n98_), .d(new_n97_), .O(new_n107_));
  ...
  nand3  g076(.a(new_n119_), .b(new_n57_), .c(new_n63_), .O(new_n120_));
  inv1   g077(.a(new_n120_), .O(z10));
  and2   g078(.a(x18), .b(x01), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n104_), .d(new_n60_), .O(new_n123_));
  nor2   g080(.a(new_n100_), .b(x14), .O(new_n124_));
  nor2   g081(.a(x21), .b(new_n104_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n124_), .c(new_n101_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n114_), .c(new_n123_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n48_), .b(new_n53_), .c(new_n46_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n61_), .c(new_n57_), .O(z14));
  oai21  g100(.a(new_n60_), .b(x01), .c(new_n63_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n57_), .c(new_n46_), .O(new_n145_));
  nand3  g102(.a(new_n59_), .b(x01), .c(x00), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n145_), .O(z15));
  oai21  g104(.a(new_n64_), .b(x00), .c(new_n57_), .O(z16));
  nand4  g105(.a(new_n57_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n149_));
