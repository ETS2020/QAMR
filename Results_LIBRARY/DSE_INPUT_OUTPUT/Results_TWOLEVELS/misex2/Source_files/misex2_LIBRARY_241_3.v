...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n117_, new_n120_, new_n122_, new_n124_;
  ...
  nor2   g12(.a(new_n55_), .b(new_n54_), .O(z04));
  inv1   g13(.a(z04), .O(new_n57_));
  ...
  nand3  g26(.a(x02), .b(new_n55_), .c(x00), .O(new_n71_));
  ...
  nand4  g32(.a(new_n76_), .b(x02), .c(new_n55_), .d(new_n54_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n60_), .c(x18), .d(x01), .O(new_n93_));
  oai21  g49(.a(new_n91_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n84_), .c(new_n83_), .d(new_n54_), .O(new_n95_));
  ...
  nand3  g55(.a(new_n99_), .b(x12), .c(new_n85_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n98_), .c(x00), .O(z10));
  nand2  g62(.a(new_n60_), .b(x18), .O(new_n107_));
  nand3  g63(.a(new_n84_), .b(x21), .c(new_n92_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n107_), .c(new_n54_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x01), .O(new_n110_));
  nor4   g66(.a(new_n103_), .b(x16), .c(new_n88_), .d(x14), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n101_), .c(new_n86_), .d(new_n54_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n110_), .O(z11));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g70(.a(new_n60_), .b(x17), .c(new_n58_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n114_), .c(x24), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x09), .c(new_n55_), .d(new_n54_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n57_), .O(z12));
  oai21  g74(.a(new_n115_), .b(new_n48_), .c(new_n57_), .O(z13));
  nand4  g75(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n63_), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(x19), .O(z14));
  nor2   g77(.a(x19), .b(x00), .O(new_n122_));
  nor3   g78(.a(new_n122_), .b(x02), .c(x01), .O(z15));
  nand2  g79(.a(new_n47_), .b(x02), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(z17));
  zero   g81(.O(z05));
  nor2   g82(.a(new_n55_), .b(new_n54_), .O(z06));
  buf    g83(.a(x01), .O(z16));
endmodule
