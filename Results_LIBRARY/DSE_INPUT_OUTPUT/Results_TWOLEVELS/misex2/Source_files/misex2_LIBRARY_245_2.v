...
module FAU ( 
  ...
  nor2   g010(.a(x22), .b(new_n53_), .O(new_n54_));
  inv1   g011(.a(new_n54_), .O(new_n55_));
  nand3  g012(.a(new_n48_), .b(x09), .c(new_n46_), .O(new_n56_));
  nand4  g013(.a(new_n53_), .b(new_n45_), .c(new_n44_), .d(x10), .O(new_n57_));
  oai21  g014(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(z01));
  inv1   g015(.a(x10), .O(new_n59_));
  nand4  g016(.a(new_n53_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n60_));
  oai21  g017(.a(new_n60_), .b(new_n56_), .c(new_n55_), .O(z02));
  inv1   g018(.a(x00), .O(new_n62_));
  nor2   g019(.a(x02), .b(x01), .O(new_n63_));
  nor2   g020(.a(x19), .b(new_n45_), .O(new_n64_));
  nand4  g021(.a(new_n64_), .b(new_n63_), .c(new_n44_), .d(new_n62_), .O(new_n65_));
  ...
  nand3  g028(.a(new_n71_), .b(new_n65_), .c(new_n55_), .O(z03));
  nand4  g029(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(x10), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n47_), .c(x02), .d(x01), .O(new_n75_));
  nor2   g032(.a(new_n75_), .b(new_n62_), .O(z04));
  nor2   g033(.a(new_n54_), .b(new_n59_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x09), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n62_), .O(z05));
  nor3   g036(.a(new_n68_), .b(new_n59_), .c(x09), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x02), .c(x01), .d(x00), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(new_n55_), .O(z06));
  ...
  nand4  g050(.a(new_n93_), .b(x02), .c(new_n92_), .d(new_n62_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n91_), .O(new_n95_));
  nand4  g052(.a(new_n95_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(x08), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(x19), .c(new_n45_), .d(x17), .O(new_n98_));
  nor2   g055(.a(new_n98_), .b(new_n87_), .O(z08));
  ...
  nand3  g064(.a(new_n107_), .b(x18), .c(x01), .O(new_n108_));
  oai21  g065(.a(new_n106_), .b(new_n102_), .c(new_n108_), .O(new_n109_));
  nand3  g066(.a(new_n109_), .b(new_n100_), .c(new_n62_), .O(new_n110_));
  aoi21  g067(.a(new_n110_), .b(new_n53_), .c(x22), .O(z09));
  nor2   g068(.a(new_n45_), .b(new_n92_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(x22), .c(x21), .d(new_n107_), .O(new_n113_));
  nor2   g070(.a(x13), .b(new_n69_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n101_), .c(new_n68_), .O(new_n115_));
  nor3   g072(.a(new_n104_), .b(new_n103_), .c(x14), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n87_), .c(new_n100_), .d(x20), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  nand3  g075(.a(new_n118_), .b(new_n53_), .c(new_n62_), .O(new_n119_));
  inv1   g076(.a(new_n119_), .O(z10));
  nand3  g077(.a(new_n112_), .b(x21), .c(new_n107_), .O(new_n121_));
  nor2   g078(.a(new_n103_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n100_), .c(x20), .d(new_n104_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n115_), .c(new_n121_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n62_), .O(new_n125_));
  aoi21  g082(.a(new_n125_), .b(new_n53_), .c(x22), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(x01), .c(x00), .O(new_n128_));
  oai21  g085(.a(x19), .b(x02), .c(x23), .O(new_n129_));
  nand3  g086(.a(new_n53_), .b(x17), .c(new_n46_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n92_), .c(new_n62_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n130_), .b(new_n136_), .c(new_n55_), .O(z13));
  nand3  g094(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n138_));
  oai21  g095(.a(new_n138_), .b(new_n60_), .c(new_n55_), .O(z14));
  aoi21  g096(.a(new_n59_), .b(x01), .c(new_n46_), .O(new_n140_));
  oai21  g097(.a(new_n63_), .b(new_n87_), .c(x19), .O(new_n141_));
  oai21  g098(.a(new_n140_), .b(new_n62_), .c(new_n141_), .O(z15));
  nor3   g099(.a(new_n54_), .b(new_n92_), .c(x00), .O(z16));
  nand4  g100(.a(new_n55_), .b(x02), .c(new_n92_), .d(new_n62_), .O(new_n144_));
