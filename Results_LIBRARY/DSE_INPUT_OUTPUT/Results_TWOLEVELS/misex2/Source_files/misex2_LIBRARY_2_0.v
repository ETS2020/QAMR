...
module FAU ( 
  ...
  nor3   g11(.a(new_n48_), .b(new_n55_), .c(new_n47_), .O(z05));
  inv1   g12(.a(x00), .O(new_n57_));
  inv1   g13(.a(x01), .O(new_n58_));
  nand4  g14(.a(x11), .b(x10), .c(new_n47_), .d(x02), .O(new_n59_));
  nor3   g15(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z06));
  oai21  g16(.a(x02), .b(new_n57_), .c(new_n58_), .O(new_n61_));
  nand3  g17(.a(x02), .b(x01), .c(x00), .O(new_n62_));
  nand4  g18(.a(new_n46_), .b(x11), .c(x10), .d(new_n47_), .O(new_n63_));
  ...
  inv1   g33(.a(z00), .O(new_n78_));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n79_));
  nand4  g35(.a(new_n79_), .b(x09), .c(x01), .d(x00), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n78_), .O(z12));
  inv1   g37(.a(x02), .O(new_n82_));
  aoi21  g38(.a(new_n55_), .b(x01), .c(new_n82_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n57_), .c(new_n78_), .O(z15));
