...
module FAU ( 
  ...
  nor2   g46(.a(new_n59_), .b(new_n45_), .O(new_n92_));
  ...
  nand3  g66(.a(new_n65_), .b(x17), .c(new_n55_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n52_), .b(new_n51_), .c(new_n58_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n50_), .c(new_n47_), .O(z14));
  nand3  g74(.a(x19), .b(new_n55_), .c(new_n45_), .O(new_n120_));
  oai21  g75(.a(new_n85_), .b(new_n44_), .c(new_n120_), .O(z15));
  nor2   g76(.a(new_n45_), .b(x00), .O(z16));
