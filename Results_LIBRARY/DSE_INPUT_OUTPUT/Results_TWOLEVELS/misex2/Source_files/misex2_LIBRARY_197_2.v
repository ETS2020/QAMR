...
module FAU ( 
  ...
  nand4  g33(.a(new_n76_), .b(new_n67_), .c(x10), .d(x01), .O(new_n77_));
  ...
  nand4  g47(.a(x12), .b(new_n75_), .c(x02), .d(new_n60_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n97_), .b(new_n62_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n94_), .b(x12), .c(new_n75_), .d(x02), .O(new_n102_));
  ...
  nand2  g63(.a(new_n106_), .b(new_n60_), .O(new_n107_));
  ...
  nand4  g88(.a(x19), .b(new_n45_), .c(new_n60_), .d(new_n44_), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n118_), .O(z15));
