...
module FAU ( 
  ...
  nor2   g41(.a(new_n55_), .b(x01), .O(new_n86_));
  ...
  nor2   g53(.a(new_n82_), .b(new_n81_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n97_), .c(new_n80_), .d(x01), .O(new_n99_));
  inv1   g55(.a(new_n90_), .O(new_n100_));
  nand2  g56(.a(x16), .b(x15), .O(new_n101_));
  nor2   g57(.a(new_n101_), .b(x14), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n94_), .c(new_n100_), .d(new_n86_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n99_), .c(x00), .O(z10));
  nand3  g60(.a(new_n82_), .b(x21), .c(new_n80_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n79_), .c(new_n44_), .O(new_n106_));
  ...
  nand4  g66(.a(new_n110_), .b(new_n94_), .c(new_n91_), .d(new_n108_), .O(new_n111_));
  ...
  nor3   g73(.a(new_n64_), .b(x19), .c(new_n51_), .O(z13));
  nand3  g74(.a(new_n52_), .b(new_n51_), .c(new_n58_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n50_), .c(new_n47_), .O(z14));
  nand3  g76(.a(x19), .b(new_n55_), .c(new_n45_), .O(new_n121_));
  oai21  g77(.a(new_n86_), .b(new_n44_), .c(new_n121_), .O(z15));
  nor2   g78(.a(new_n45_), .b(x00), .O(z16));
  nand2  g79(.a(new_n87_), .b(new_n47_), .O(z17));
  zero   g80(.O(z06));
