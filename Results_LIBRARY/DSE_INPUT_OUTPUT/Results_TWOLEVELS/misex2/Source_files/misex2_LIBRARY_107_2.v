...
module FAU ( 
  ...
  nor3   g034(.a(new_n71_), .b(new_n47_), .c(x09), .O(new_n78_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n51_), .c(new_n96_), .d(new_n86_), .O(new_n107_));
  nor2   g064(.a(new_n107_), .b(x00), .O(z09));
  nor2   g065(.a(new_n51_), .b(new_n96_), .O(new_n109_));
  ...
  nor4   g069(.a(new_n112_), .b(x05), .c(new_n45_), .d(x01), .O(new_n113_));
  ...
  nand2  g076(.a(new_n119_), .b(new_n97_), .O(new_n120_));
  ...
  nand2  g080(.a(new_n123_), .b(new_n88_), .O(new_n124_));
  aoi21  g081(.a(new_n124_), .b(new_n86_), .c(x22), .O(z11));
  ...
  inv1   g095(.a(new_n52_), .O(new_n139_));
  ...
  nand2  g101(.a(new_n97_), .b(new_n88_), .O(new_n145_));
