...
module FAU ( 
  ...
  oai21  g031(.a(new_n74_), .b(new_n67_), .c(new_n53_), .O(z04));
  ...
  nor3   g035(.a(new_n72_), .b(new_n47_), .c(x09), .O(new_n79_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n44_), .d(new_n89_), .O(new_n91_));
  nor2   g048(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n87_), .c(new_n86_), .d(new_n51_), .O(new_n93_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n52_), .c(new_n97_), .d(x05), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(x00), .O(z09));
  nor2   g066(.a(new_n52_), .b(new_n97_), .O(new_n110_));
  ...
  nand3  g073(.a(new_n52_), .b(new_n97_), .c(x20), .O(new_n117_));
  ...
  nand4  g077(.a(new_n105_), .b(x21), .c(new_n104_), .d(new_n50_), .O(new_n121_));
  ...
  nand2  g082(.a(new_n125_), .b(new_n89_), .O(new_n126_));
  aoi21  g083(.a(new_n126_), .b(x05), .c(x22), .O(z11));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n89_), .O(new_n133_));
  ...
  inv1   g093(.a(new_n58_), .O(new_n137_));
  oai21  g094(.a(new_n131_), .b(new_n137_), .c(new_n53_), .O(z13));
  nand3  g095(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(new_n139_));
  ...
  nand2  g103(.a(new_n98_), .b(new_n89_), .O(new_n147_));
