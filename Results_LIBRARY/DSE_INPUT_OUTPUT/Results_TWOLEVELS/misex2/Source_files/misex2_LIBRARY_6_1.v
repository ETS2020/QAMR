...
module FAU ( 
  ...
  nand4  g19(.a(new_n62_), .b(x18), .c(new_n44_), .d(new_n57_), .O(new_n63_));
  aoi21  g20(.a(new_n63_), .b(new_n56_), .c(x00), .O(new_n64_));
  nand2  g21(.a(new_n46_), .b(x02), .O(new_n65_));
  nand3  g22(.a(x12), .b(x11), .c(x10), .O(new_n66_));
  nor3   g23(.a(new_n66_), .b(new_n65_), .c(new_n56_), .O(new_n67_));
  ...
  aoi21  g32(.a(new_n75_), .b(x00), .c(new_n56_), .O(z06));
  ...
  nand3  g37(.a(x02), .b(new_n56_), .c(x00), .O(new_n81_));
  ...
  nand4  g44(.a(new_n87_), .b(x02), .c(new_n56_), .d(new_n86_), .O(new_n88_));
  ...
  nand4  g54(.a(new_n69_), .b(x02), .c(new_n56_), .d(new_n86_), .O(new_n98_));
  ...
  aoi21  g66(.a(new_n109_), .b(new_n56_), .c(x00), .O(z10));
  ...
  nand3  g73(.a(new_n62_), .b(x17), .c(new_n57_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n56_), .c(new_n86_), .O(new_n119_));
  ...
  nand4  g81(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n56_), .c(x00), .O(z14));
  aoi21  g83(.a(new_n58_), .b(x01), .c(new_n57_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n57_), .c(new_n56_), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n86_), .c(new_n128_), .O(z15));
  nor2   g86(.a(new_n56_), .b(x00), .O(z16));
  nand3  g87(.a(x02), .b(new_n56_), .c(new_n86_), .O(new_n131_));
