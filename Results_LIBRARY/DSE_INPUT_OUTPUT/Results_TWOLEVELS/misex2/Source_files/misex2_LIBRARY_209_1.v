...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    ...
    new_n69_, new_n72_, new_n74_, new_n75_, new_n76_, new_n77_, new_n79_,
  ...
  nor3   g29(.a(new_n72_), .b(new_n44_), .c(new_n55_), .O(z06));
  ...
  nand4  g57(.a(new_n66_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n98_), .b(new_n94_), .c(new_n90_), .d(x15), .O(new_n107_));
  ...
  nand3  g68(.a(new_n61_), .b(x17), .c(new_n45_), .O(new_n112_));
  ...
  aoi21  g72(.a(new_n112_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g73(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n117_));
