...
module FAU ( 
  ...
  nor2   g029(.a(new_n72_), .b(x20), .O(z04));
  nor4   g030(.a(new_n70_), .b(x20), .c(new_n56_), .d(new_n46_), .O(z05));
  nand4  g031(.a(new_n59_), .b(x11), .c(x10), .d(new_n46_), .O(new_n75_));
  ...
  nand3  g060(.a(new_n103_), .b(new_n59_), .c(new_n64_), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n85_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(z09));
  nand4  g064(.a(new_n103_), .b(x22), .c(x21), .d(new_n64_), .O(new_n108_));
  nand4  g065(.a(new_n101_), .b(x12), .c(new_n68_), .d(x02), .O(new_n109_));
  nor2   g066(.a(x22), .b(x21), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(x20), .c(x16), .d(x15), .O(new_n111_));
  oai21  g068(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  nand2  g069(.a(new_n112_), .b(new_n85_), .O(new_n113_));
  nand2  g070(.a(new_n113_), .b(new_n83_), .O(z10));
  nand4  g071(.a(new_n103_), .b(x21), .c(new_n59_), .d(new_n64_), .O(new_n115_));
  nor2   g072(.a(x13), .b(new_n69_), .O(new_n116_));
  nand3  g073(.a(new_n116_), .b(new_n88_), .c(new_n68_), .O(new_n117_));
  nor2   g074(.a(new_n99_), .b(x14), .O(new_n118_));
  nor2   g075(.a(x21), .b(new_n59_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n118_), .c(new_n100_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(new_n117_), .c(new_n115_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n96_), .c(new_n85_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(z11));
  inv1   g080(.a(x24), .O(new_n124_));
  nand2  g081(.a(x10), .b(x02), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n59_), .c(x01), .d(x00), .O(new_n126_));
  oai21  g083(.a(x19), .b(x02), .c(x23), .O(new_n127_));
  nand3  g084(.a(new_n64_), .b(x17), .c(new_n87_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n97_), .c(new_n85_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z14));
  oai21  g094(.a(x10), .b(new_n97_), .c(x02), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(x00), .O(new_n139_));
  nand3  g096(.a(x19), .b(new_n87_), .c(new_n97_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n139_), .c(new_n83_), .O(z15));
  aoi21  g098(.a(new_n59_), .b(x00), .c(new_n97_), .O(z16));
  nand3  g099(.a(x02), .b(new_n97_), .c(new_n85_), .O(new_n143_));
