...
module FAU ( 
  ...
  nor3   g52(.a(new_n95_), .b(x11), .c(new_n48_), .O(new_n96_));
  ...
  aoi21  g58(.a(new_n101_), .b(new_n47_), .c(x00), .O(z09));
  nand4  g59(.a(new_n100_), .b(new_n96_), .c(x16), .d(x15), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n47_), .c(x00), .O(z10));
  nand4  g61(.a(new_n67_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n105_));
