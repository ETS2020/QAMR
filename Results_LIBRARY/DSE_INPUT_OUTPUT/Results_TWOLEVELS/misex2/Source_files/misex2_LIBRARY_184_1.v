...
module FAU ( 
  ...
  inv1   g037(.a(x14), .O(new_n81_));
  nor2   g038(.a(new_n81_), .b(x05), .O(new_n82_));
  ...
  aoi21  g053(.a(new_n96_), .b(new_n81_), .c(x05), .O(z08));
  ...
  nand2  g071(.a(x02), .b(new_n55_), .O(new_n115_));
  ...
  nand3  g075(.a(x16), .b(x15), .c(new_n81_), .O(new_n119_));
  ...
  nand4  g080(.a(new_n100_), .b(new_n116_), .c(x12), .d(new_n72_), .O(new_n124_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n55_), .c(new_n71_), .O(new_n137_));
  ...
  oai21  g097(.a(new_n135_), .b(new_n90_), .c(new_n45_), .O(z13));
