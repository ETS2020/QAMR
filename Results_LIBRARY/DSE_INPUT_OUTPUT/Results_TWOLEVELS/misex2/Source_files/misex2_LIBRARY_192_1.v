...
module FAU ( 
  ...
  nor4   g49(.a(new_n92_), .b(x14), .c(x13), .d(new_n76_), .O(new_n93_));
  ...
  nand4  g69(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z14));
  aoi21  g71(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n115_));
