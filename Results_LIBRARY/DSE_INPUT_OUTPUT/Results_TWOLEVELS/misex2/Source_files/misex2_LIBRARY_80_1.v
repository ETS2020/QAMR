...
module FAU ( 
  ...
  nand4  g57(.a(new_n98_), .b(new_n94_), .c(x16), .d(x15), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n47_), .c(x00), .O(z10));
  nand4  g59(.a(new_n66_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n92_), .c(new_n91_), .d(x12), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n89_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n95_), .c(x20), .d(new_n90_), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(x22), .O(z11));
  inv1   g65(.a(x24), .O(new_n109_));
  aoi21  g66(.a(x10), .b(x02), .c(new_n47_), .O(new_n110_));
  ...
  oai22  g71(.a(new_n114_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  aoi21  g72(.a(new_n112_), .b(new_n47_), .c(x00), .O(z13));
