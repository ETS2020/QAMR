...
module FAU ( 
  ...
  nor2   g019(.a(new_n62_), .b(x05), .O(new_n63_));
  ...
  aoi21  g050(.a(new_n93_), .b(new_n62_), .c(x05), .O(z08));
  ...
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n62_), .d(new_n99_), .O(new_n101_));
  ...
  nand4  g064(.a(new_n52_), .b(x22), .c(x21), .d(new_n102_), .O(new_n108_));
  ...
  nor3   g071(.a(new_n62_), .b(new_n99_), .c(x14), .O(new_n115_));
  ...
  nand4  g077(.a(new_n97_), .b(new_n112_), .c(x12), .d(new_n71_), .O(new_n121_));
  nor2   g078(.a(new_n99_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n95_), .c(x20), .d(new_n62_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n75_), .O(new_n125_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n75_), .O(new_n133_));
  ...
  oai21  g093(.a(new_n131_), .b(new_n87_), .c(new_n52_), .O(z13));
  ...
  nor3   g100(.a(new_n63_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g101(.a(new_n97_), .b(new_n75_), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(new_n52_), .O(z17));
endmodule
