...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    ...
    new_n110_, new_n113_, new_n115_, new_n116_, new_n119_;
  ...
  nand4  g69(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n44_), .c(x00), .O(z14));
  oai21  g71(.a(new_n52_), .b(new_n55_), .c(x01), .O(new_n115_));
  oai21  g72(.a(x19), .b(x00), .c(new_n45_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n115_), .O(z15));
  nand3  g74(.a(x02), .b(new_n44_), .c(new_n55_), .O(new_n119_));
