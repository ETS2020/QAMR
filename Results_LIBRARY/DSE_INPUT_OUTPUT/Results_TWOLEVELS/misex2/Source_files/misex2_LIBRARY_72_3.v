...
module FAU ( 
  ...
  nand2  g007(.a(x21), .b(x07), .O(new_n51_));
  ...
  nand4  g028(.a(new_n51_), .b(new_n66_), .c(new_n65_), .d(x10), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n46_), .c(x02), .d(x01), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(new_n58_), .O(z04));
  ...
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n58_), .O(new_n91_));
  nor3   g048(.a(x08), .b(x07), .c(x06), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x19), .c(new_n49_), .d(x17), .O(new_n93_));
  oai21  g050(.a(new_n93_), .b(new_n91_), .c(new_n51_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nand3  g053(.a(new_n88_), .b(x12), .c(new_n65_), .O(new_n97_));
  ...
  nand3  g069(.a(new_n112_), .b(x12), .c(new_n65_), .O(new_n113_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n112_), .c(x12), .d(new_n65_), .O(new_n121_));
  nand4  g078(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n122_));
  nor2   g079(.a(new_n98_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n99_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n96_), .c(new_n58_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n51_), .O(z11));
  ...
  nand3  g104(.a(new_n51_), .b(x01), .c(new_n58_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand4  g106(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n58_), .O(new_n150_));
