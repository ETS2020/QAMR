...
module FAU ( 
  ...
  nor2   g13(.a(x11), .b(new_n56_), .O(z04));
  inv1   g14(.a(z04), .O(new_n58_));
  inv1   g15(.a(x02), .O(new_n59_));
  nor2   g16(.a(x01), .b(x00), .O(new_n60_));
  nand3  g17(.a(new_n60_), .b(x09), .c(new_n59_), .O(new_n61_));
  inv1   g18(.a(x10), .O(new_n62_));
  inv1   g19(.a(x19), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n62_), .O(new_n64_));
  oai21  g21(.a(new_n64_), .b(new_n61_), .c(new_n58_), .O(z02));
  inv1   g22(.a(x00), .O(new_n66_));
  nand3  g23(.a(new_n59_), .b(new_n56_), .c(new_n66_), .O(new_n67_));
  nand3  g24(.a(new_n63_), .b(x18), .c(new_n44_), .O(new_n68_));
  nand3  g25(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nand4  g26(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n70_));
  oai22  g27(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(z03));
  nand4  g28(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x11), .c(new_n56_), .O(z05));
  nand4  g30(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n56_), .c(new_n66_), .O(z06));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n56_), .d(new_n66_), .O(new_n85_));
  ...
  nor2   g50(.a(new_n59_), .b(x01), .O(new_n94_));
  ...
  nand4  g57(.a(new_n100_), .b(x18), .c(x11), .d(x01), .O(new_n101_));
  oai21  g58(.a(new_n99_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n66_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand3  g61(.a(x18), .b(x11), .c(x01), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n100_), .c(x22), .d(x21), .O(new_n107_));
  inv1   g64(.a(new_n94_), .O(new_n108_));
  inv1   g65(.a(x13), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(x12), .c(new_n93_), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nor3   g68(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n112_));
  nor2   g69(.a(x22), .b(x21), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x20), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n107_), .c(x00), .O(z10));
  nor2   g72(.a(new_n91_), .b(x20), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n63_), .c(x18), .d(x01), .O(new_n117_));
  nand4  g74(.a(new_n109_), .b(x12), .c(new_n93_), .d(x02), .O(new_n118_));
  nor2   g75(.a(new_n96_), .b(x14), .O(new_n119_));
  nand4  g76(.a(new_n119_), .b(new_n91_), .c(x20), .d(new_n97_), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n92_), .c(new_n66_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n58_), .O(z11));
  nand2  g80(.a(x10), .b(x02), .O(new_n124_));
  nand4  g81(.a(new_n124_), .b(x11), .c(x01), .d(x00), .O(new_n125_));
  oai21  g82(.a(x19), .b(x02), .c(x23), .O(new_n126_));
  nand3  g83(.a(new_n63_), .b(x17), .c(new_n59_), .O(new_n127_));
  nand2  g84(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g85(.a(new_n128_), .b(new_n56_), .c(new_n66_), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n125_), .c(x24), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(x09), .O(new_n131_));
  inv1   g88(.a(new_n131_), .O(z12));
  nand2  g89(.a(new_n47_), .b(x17), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(x19), .O(z13));
  nand3  g91(.a(new_n60_), .b(new_n46_), .c(new_n59_), .O(new_n135_));
  oai21  g92(.a(new_n135_), .b(new_n64_), .c(new_n58_), .O(z14));
  oai21  g93(.a(x10), .b(new_n56_), .c(x02), .O(new_n137_));
  nand2  g94(.a(new_n137_), .b(x00), .O(new_n138_));
  nand3  g95(.a(x19), .b(new_n59_), .c(new_n56_), .O(new_n139_));
  nand3  g96(.a(new_n139_), .b(new_n138_), .c(new_n58_), .O(z15));
  nand3  g97(.a(x11), .b(x01), .c(new_n66_), .O(new_n141_));
  inv1   g98(.a(new_n141_), .O(z16));
  oai21  g99(.a(new_n108_), .b(x00), .c(new_n58_), .O(z17));
endmodule
