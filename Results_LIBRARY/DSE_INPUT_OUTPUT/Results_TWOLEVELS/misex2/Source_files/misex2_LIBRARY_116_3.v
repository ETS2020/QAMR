...
module FAU ( 
  ...
  nand2  g000(.a(x23), .b(x13), .O(new_n44_));
  ...
  nor2   g023(.a(new_n54_), .b(x09), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(new_n66_), .c(x12), .d(x11), .O(new_n68_));
  nor3   g025(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nand4  g026(.a(new_n69_), .b(new_n56_), .c(x18), .d(new_n50_), .O(new_n70_));
  ...
  nand4  g035(.a(new_n44_), .b(x11), .c(x10), .d(new_n48_), .O(new_n79_));
  ...
  nand4  g048(.a(new_n44_), .b(x19), .c(new_n55_), .d(x17), .O(new_n92_));
  ...
  nand4  g057(.a(new_n100_), .b(new_n56_), .c(x18), .d(x01), .O(new_n101_));
  ...
  nand3  g067(.a(new_n56_), .b(x18), .c(x01), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n112_));
  inv1   g069(.a(x13), .O(new_n113_));
  nand3  g070(.a(new_n113_), .b(x12), .c(new_n72_), .O(new_n114_));
  nor3   g071(.a(new_n114_), .b(new_n47_), .c(x01), .O(new_n115_));
  ...
  nand4  g078(.a(new_n44_), .b(x21), .c(new_n121_), .d(new_n56_), .O(new_n122_));
  inv1   g079(.a(new_n122_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(x18), .c(x01), .O(new_n124_));
  nor2   g081(.a(new_n104_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n98_), .c(x20), .d(new_n105_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n120_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n99_), .c(new_n45_), .O(new_n128_));
  ...
  aoi21  g089(.a(x19), .b(new_n113_), .c(x02), .O(new_n133_));
  nand3  g090(.a(new_n56_), .b(x17), .c(new_n47_), .O(new_n134_));
  oai21  g091(.a(new_n133_), .b(new_n132_), .c(new_n134_), .O(new_n135_));
  ...
  nand2  g096(.a(new_n46_), .b(new_n45_), .O(new_n140_));
  oai21  g097(.a(new_n134_), .b(new_n140_), .c(new_n44_), .O(z13));
  nand3  g098(.a(new_n51_), .b(new_n50_), .c(new_n54_), .O(new_n142_));
  oai21  g099(.a(new_n142_), .b(new_n49_), .c(new_n44_), .O(z14));
