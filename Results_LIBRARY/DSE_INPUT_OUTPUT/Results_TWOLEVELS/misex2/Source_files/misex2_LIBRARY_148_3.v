...
module FAU ( 
  ...
  nand4  g16(.a(new_n51_), .b(x12), .c(x11), .d(x10), .O(new_n60_));
  ...
  nor2   g27(.a(new_n70_), .b(x19), .O(z04));
  nor4   g28(.a(new_n68_), .b(x19), .c(new_n56_), .d(new_n46_), .O(z05));
  nand4  g29(.a(new_n51_), .b(x11), .c(x10), .d(new_n46_), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(x02), .c(x01), .d(x00), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z06));
  nand2  g33(.a(x10), .b(new_n46_), .O(new_n77_));
  nand3  g34(.a(new_n51_), .b(new_n67_), .c(x11), .O(new_n78_));
  ...
  nor4   g42(.a(new_n85_), .b(x05), .c(new_n83_), .d(x03), .O(new_n86_));
  nand2  g43(.a(new_n50_), .b(x17), .O(new_n87_));
  nor4   g44(.a(new_n87_), .b(x08), .c(x07), .d(x06), .O(new_n88_));
  nand2  g45(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  aoi21  g46(.a(new_n89_), .b(new_n82_), .c(new_n51_), .O(z08));
  ...
  aoi22  g68(.a(new_n111_), .b(new_n108_), .c(new_n105_), .d(new_n100_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(x00), .c(new_n44_), .O(z10));
  inv1   g70(.a(new_n107_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n93_), .O(new_n115_));
  nand4  g72(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n51_), .O(new_n116_));
  ...
  nand3  g76(.a(new_n119_), .b(new_n92_), .c(new_n84_), .O(new_n120_));
  ...
  oai21  g85(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(new_n129_));
  ...
  oai21  g90(.a(new_n125_), .b(new_n133_), .c(new_n44_), .O(z13));
  oai21  g91(.a(new_n57_), .b(new_n48_), .c(new_n44_), .O(z14));
  aoi21  g92(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n136_));
  oai22  g93(.a(new_n136_), .b(new_n84_), .c(new_n93_), .d(new_n51_), .O(z15));
  nand3  g94(.a(new_n51_), .b(x01), .c(new_n84_), .O(new_n138_));
