...
module FAU ( 
  ...
  nand2  g22(.a(new_n49_), .b(x02), .O(new_n66_));
  ...
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n47_), .O(z04));
  nand3  g31(.a(x10), .b(x09), .c(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x00), .c(new_n47_), .O(z05));
  nand4  g33(.a(x11), .b(x10), .c(new_n49_), .d(x02), .O(new_n77_));
  ...
  nand3  g66(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n54_), .b(new_n57_), .c(new_n49_), .d(new_n48_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n47_), .c(x00), .O(z14));
