...
module FAU ( 
  ...
  nand4  g031(.a(new_n51_), .b(x10), .c(x09), .d(x02), .O(new_n75_));
  nor3   g032(.a(new_n75_), .b(new_n44_), .c(new_n74_), .O(z05));
  ...
  nand2  g042(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n74_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n51_), .O(z09));
  ...
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n51_), .O(z10));
  nor2   g077(.a(x13), .b(new_n71_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n85_), .c(new_n70_), .O(new_n122_));
  nand4  g079(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n50_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n96_), .c(new_n74_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n51_), .O(z11));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(x01), .c(x00), .O(new_n131_));
  nand4  g088(.a(new_n56_), .b(new_n50_), .c(x17), .d(new_n45_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  oai21  g090(.a(x19), .b(x02), .c(x23), .O(new_n134_));
  nor3   g091(.a(new_n134_), .b(x01), .c(x00), .O(new_n135_));
  oai21  g092(.a(new_n135_), .b(new_n133_), .c(x09), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n51_), .O(z12));
  nor2   g094(.a(new_n62_), .b(x19), .O(new_n138_));
  nand4  g095(.a(new_n138_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z13));
  nand3  g097(.a(new_n56_), .b(new_n46_), .c(new_n45_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n60_), .c(new_n51_), .O(z14));
  ...
  nand3  g103(.a(new_n51_), .b(x01), .c(new_n74_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand2  g105(.a(new_n86_), .b(new_n51_), .O(z17));
endmodule
