...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n61_, new_n63_, new_n64_, new_n66_, new_n70_, new_n71_,
    ...
    new_n118_, new_n119_, new_n121_, new_n123_;
  ...
  inv1   g13(.a(new_n50_), .O(new_n57_));
  nor2   g14(.a(new_n57_), .b(x02), .O(new_n58_));
  nand2  g15(.a(new_n58_), .b(x09), .O(new_n59_));
  inv1   g16(.a(new_n59_), .O(new_n60_));
  nand4  g17(.a(new_n60_), .b(new_n53_), .c(new_n52_), .d(x10), .O(new_n61_));
  nor2   g18(.a(new_n61_), .b(x19), .O(z01));
  inv1   g19(.a(x10), .O(new_n63_));
  nand4  g20(.a(new_n60_), .b(new_n53_), .c(new_n52_), .d(new_n63_), .O(new_n64_));
  nor2   g21(.a(new_n64_), .b(x19), .O(z02));
  nand3  g22(.a(new_n58_), .b(x18), .c(new_n52_), .O(new_n66_));
  nor2   g23(.a(new_n66_), .b(x19), .O(z03));
  ...
  nand4  g33(.a(new_n77_), .b(new_n53_), .c(x17), .d(new_n70_), .O(new_n78_));
  nor2   g34(.a(new_n78_), .b(new_n54_), .O(z08));
  inv1   g35(.a(x21), .O(new_n80_));
  inv1   g36(.a(x22), .O(new_n81_));
  inv1   g37(.a(x11), .O(new_n82_));
  nor2   g38(.a(new_n48_), .b(x01), .O(new_n83_));
  ...
  nand4  g45(.a(new_n89_), .b(new_n54_), .c(x18), .d(x01), .O(new_n90_));
  ...
  nand4  g50(.a(new_n94_), .b(new_n54_), .c(x18), .d(x01), .O(new_n95_));
  ...
  nand2  g59(.a(new_n54_), .b(x18), .O(new_n104_));
  ...
  nand3  g67(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x24), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(x09), .c(new_n45_), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(x00), .O(z12));
  oai21  g71(.a(new_n112_), .b(new_n57_), .c(new_n47_), .O(z13));
  nand2  g72(.a(new_n58_), .b(new_n49_), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n53_), .c(new_n52_), .d(new_n63_), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(x19), .O(z14));
  nand3  g76(.a(x19), .b(new_n48_), .c(new_n45_), .O(new_n121_));
  oai21  g77(.a(new_n83_), .b(new_n44_), .c(new_n121_), .O(z15));
  nand2  g78(.a(new_n50_), .b(x02), .O(new_n123_));
