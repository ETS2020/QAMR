...
module FAU ( 
  ...
  nand4  g30(.a(new_n75_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n76_));
  ...
  nand4  g59(.a(new_n92_), .b(x21), .c(new_n91_), .d(new_n65_), .O(new_n105_));
  ...
  nand3  g63(.a(new_n108_), .b(new_n83_), .c(new_n59_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(z11));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g66(.a(new_n65_), .b(x17), .c(new_n47_), .O(new_n112_));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(x24), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(x09), .c(new_n60_), .O(new_n114_));
  nor2   g69(.a(new_n114_), .b(x00), .O(z12));
  nor3   g70(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g71(.a(new_n52_), .b(new_n45_), .c(new_n44_), .d(new_n64_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(x19), .O(z14));
  nor2   g73(.a(x19), .b(x00), .O(new_n119_));
  nor3   g74(.a(new_n119_), .b(x02), .c(x01), .O(z15));
  nor2   g75(.a(new_n60_), .b(x00), .O(z16));
  nand2  g76(.a(new_n85_), .b(new_n59_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n62_), .O(z17));
  zero   g78(.O(z05));
  zero   g79(.O(z06));
endmodule
