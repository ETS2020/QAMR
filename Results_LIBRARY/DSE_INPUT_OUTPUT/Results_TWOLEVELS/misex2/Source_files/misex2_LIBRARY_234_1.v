...
module FAU ( 
  ...
  aoi21  g49(.a(new_n92_), .b(new_n47_), .c(x00), .O(z09));
  inv1   g50(.a(x21), .O(new_n94_));
  inv1   g51(.a(x15), .O(new_n95_));
  nand4  g52(.a(new_n67_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n96_));
  ...
  nand3  g66(.a(new_n109_), .b(new_n47_), .c(new_n46_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x24), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(x09), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(z12));
  aoi21  g70(.a(new_n108_), .b(new_n47_), .c(x00), .O(z13));
  nand4  g71(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z14));
  oai21  g73(.a(new_n58_), .b(new_n46_), .c(x01), .O(new_n117_));
