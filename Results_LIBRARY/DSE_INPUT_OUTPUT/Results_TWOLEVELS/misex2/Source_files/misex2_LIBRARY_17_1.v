...
module FAU ( 
  ...
  aoi21  g30(.a(new_n73_), .b(x00), .c(new_n56_), .O(z05));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n86_));
  ...
  nand4  g53(.a(new_n96_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n97_));
  inv1   g54(.a(new_n97_), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n95_), .c(new_n94_), .d(x12), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(x15), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n93_), .c(x20), .d(new_n92_), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(x22), .O(z09));
  inv1   g59(.a(x15), .O(new_n103_));
  nor2   g60(.a(new_n99_), .b(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n93_), .c(x20), .d(x16), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x22), .O(z10));
  nand3  g63(.a(new_n95_), .b(new_n94_), .c(x12), .O(new_n107_));
  ...
  aoi21  g68(.a(new_n111_), .b(new_n56_), .c(x00), .O(z11));
  inv1   g69(.a(x24), .O(new_n113_));
  aoi21  g70(.a(x10), .b(x02), .c(new_n56_), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g72(.a(new_n63_), .b(x17), .c(new_n57_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(x00), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(new_n118_));
  oai22  g75(.a(new_n118_), .b(new_n46_), .c(new_n56_), .d(x00), .O(z12));
  ...
  nor2   g83(.a(new_n56_), .b(x00), .O(z16));
