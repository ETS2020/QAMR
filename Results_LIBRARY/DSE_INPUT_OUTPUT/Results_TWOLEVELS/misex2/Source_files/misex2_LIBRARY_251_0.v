...
module FAU ( 
  ...
  oai21  g014(.a(new_n57_), .b(new_n55_), .c(new_n46_), .O(z01));
  inv1   g015(.a(new_n46_), .O(new_n59_));
  nor2   g016(.a(new_n59_), .b(x19), .O(new_n60_));
  nand3  g017(.a(new_n60_), .b(new_n53_), .c(new_n52_), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(x10), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(x09), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(x00), .O(z02));
  nand3  g021(.a(new_n60_), .b(x18), .c(new_n52_), .O(new_n65_));
  ...
  nor2   g027(.a(new_n44_), .b(new_n70_), .O(new_n71_));
  nand4  g028(.a(new_n71_), .b(new_n69_), .c(x10), .d(new_n50_), .O(new_n72_));
  nand2  g029(.a(new_n72_), .b(new_n67_), .O(z03));
  nand4  g030(.a(new_n69_), .b(new_n70_), .c(x10), .d(new_n50_), .O(new_n74_));
  aoi21  g031(.a(new_n74_), .b(x14), .c(x12), .O(z04));
  nand2  g032(.a(x01), .b(x00), .O(new_n76_));
  nand3  g033(.a(x10), .b(x09), .c(x02), .O(new_n77_));
  oai21  g034(.a(new_n77_), .b(new_n76_), .c(new_n46_), .O(z05));
  nand2  g035(.a(x11), .b(x10), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(x09), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x02), .c(x01), .d(x00), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(new_n46_), .O(z06));
  nand3  g039(.a(new_n44_), .b(x11), .c(x10), .O(new_n83_));
  oai21  g040(.a(new_n83_), .b(x09), .c(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n46_), .O(z07));
  ...
  nand4  g048(.a(new_n46_), .b(x19), .c(new_n53_), .d(x17), .O(new_n92_));
  ...
  nand4  g057(.a(new_n100_), .b(new_n70_), .c(x02), .d(new_n48_), .O(new_n101_));
  inv1   g058(.a(x15), .O(new_n102_));
  inv1   g059(.a(x16), .O(new_n103_));
  nand4  g060(.a(x20), .b(new_n103_), .c(new_n102_), .d(new_n45_), .O(new_n104_));
  inv1   g061(.a(x20), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n54_), .c(x18), .d(x01), .O(new_n106_));
  oai21  g063(.a(new_n104_), .b(new_n101_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n47_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n46_), .O(z09));
  nor4   g066(.a(new_n59_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n54_), .c(x18), .d(x01), .O(new_n111_));
  nand2  g068(.a(x02), .b(new_n48_), .O(new_n112_));
  nor4   g069(.a(new_n112_), .b(x13), .c(new_n44_), .d(x11), .O(new_n113_));
  nor3   g070(.a(new_n103_), .b(new_n102_), .c(x14), .O(new_n114_));
  ...
  nor3   g074(.a(new_n59_), .b(new_n98_), .c(x20), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n54_), .c(x18), .d(x01), .O(new_n119_));
  nand3  g076(.a(new_n98_), .b(x20), .c(new_n103_), .O(new_n120_));
  nor3   g077(.a(new_n120_), .b(new_n102_), .c(x14), .O(new_n121_));
  nand2  g078(.a(new_n121_), .b(new_n113_), .O(new_n122_));
  nand2  g079(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n54_), .b(x17), .c(new_n49_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n60_), .b(x17), .c(new_n49_), .d(new_n48_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x00), .O(z13));
  nand4  g093(.a(new_n62_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n137_));
  ...
  oai21  g100(.a(new_n112_), .b(x00), .c(new_n46_), .O(z17));
endmodule
