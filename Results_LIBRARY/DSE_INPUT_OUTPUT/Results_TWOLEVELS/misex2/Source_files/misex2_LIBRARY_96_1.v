...
module FAU ( 
  ...
  nor2   g033(.a(new_n76_), .b(new_n59_), .O(z04));
  ...
  nand2  g046(.a(new_n89_), .b(new_n59_), .O(new_n90_));
  ...
  nand4  g058(.a(new_n50_), .b(x18), .c(x01), .d(new_n59_), .O(new_n102_));
  inv1   g059(.a(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n104_));
  inv1   g061(.a(new_n104_), .O(z09));
  nor2   g062(.a(new_n101_), .b(new_n100_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n71_), .c(new_n99_), .d(x01), .O(new_n107_));
  inv1   g064(.a(x13), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(x12), .c(new_n66_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(new_n110_));
  inv1   g067(.a(x16), .O(new_n111_));
  nor3   g068(.a(new_n111_), .b(new_n51_), .c(x14), .O(new_n112_));
  nand3  g069(.a(new_n101_), .b(new_n100_), .c(x20), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n112_), .c(new_n110_), .d(new_n89_), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n107_), .c(x00), .O(z10));
  nand2  g073(.a(new_n110_), .b(new_n89_), .O(new_n117_));
  nor2   g074(.a(new_n49_), .b(new_n44_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n99_), .d(new_n50_), .O(new_n119_));
  nor2   g076(.a(new_n51_), .b(x14), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n100_), .c(x20), .d(new_n111_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(new_n117_), .c(new_n119_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n101_), .c(new_n59_), .O(new_n123_));
  ...
  nand4  g089(.a(new_n132_), .b(new_n52_), .c(new_n125_), .d(x09), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nor2   g091(.a(new_n63_), .b(x19), .O(new_n135_));
  nand4  g092(.a(new_n135_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n136_));
  ...
  nor3   g101(.a(new_n63_), .b(new_n44_), .c(x00), .O(z16));
  nand4  g102(.a(new_n52_), .b(x02), .c(new_n44_), .d(new_n59_), .O(new_n146_));
