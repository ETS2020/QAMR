...
module FAU ( 
  ...
  nand4  g35(.a(new_n78_), .b(new_n71_), .c(x10), .d(x01), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n62_), .d(new_n56_), .O(new_n85_));
  ...
  nor2   g49(.a(new_n57_), .b(x01), .O(new_n93_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n56_), .O(new_n103_));
  ...
  nor2   g63(.a(x13), .b(new_n70_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n93_), .c(new_n69_), .O(new_n108_));
  ...
  nand4  g69(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n64_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n92_), .c(new_n56_), .O(new_n117_));
  ...
  nand3  g78(.a(new_n64_), .b(x17), .c(new_n57_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g80(.a(new_n123_), .b(new_n62_), .c(new_n56_), .O(new_n124_));
  ...
  nand4  g86(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z14));
  nand4  g88(.a(x19), .b(new_n57_), .c(new_n62_), .d(new_n56_), .O(new_n132_));
  nand2  g89(.a(new_n132_), .b(new_n120_), .O(z15));
  nor2   g90(.a(new_n62_), .b(x00), .O(z16));
  aoi21  g91(.a(new_n57_), .b(new_n56_), .c(x01), .O(z17));
endmodule
