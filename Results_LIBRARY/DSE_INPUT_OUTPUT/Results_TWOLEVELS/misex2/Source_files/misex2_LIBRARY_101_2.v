...
module FAU ( 
  ...
  nor3   g33(.a(new_n76_), .b(new_n62_), .c(new_n52_), .O(z06));
  ...
  oai21  g58(.a(new_n101_), .b(new_n90_), .c(new_n52_), .O(new_n102_));
  ...
  nand4  g65(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n64_), .O(new_n109_));
  nor2   g66(.a(new_n53_), .b(x01), .O(new_n110_));
  nor2   g67(.a(x13), .b(new_n70_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n110_), .c(new_n69_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n106_), .c(new_n52_), .O(new_n117_));
  ...
  nand3  g79(.a(new_n64_), .b(x17), .c(new_n53_), .O(new_n123_));
  ...
  aoi21  g93(.a(new_n53_), .b(new_n52_), .c(x01), .O(z17));
endmodule
