...
module FAU ( 
  ...
  nand4  g57(.a(new_n100_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n91_), .c(new_n90_), .d(x12), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n99_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n98_), .c(x20), .d(x16), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x22), .O(z10));
  inv1   g63(.a(x16), .O(new_n107_));
  nand4  g64(.a(new_n104_), .b(new_n98_), .c(x20), .d(new_n107_), .O(new_n108_));
  ...
  nand4  g76(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  aoi21  g78(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n122_));
  ...
  aoi21  g82(.a(new_n48_), .b(new_n47_), .c(x00), .O(z17));
endmodule
