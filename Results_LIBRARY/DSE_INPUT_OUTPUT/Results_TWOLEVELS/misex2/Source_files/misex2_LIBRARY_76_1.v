...
module FAU ( 
  ...
  nand2  g26(.a(x12), .b(new_n49_), .O(new_n70_));
  inv1   g27(.a(x11), .O(new_n71_));
  nand4  g28(.a(new_n44_), .b(new_n71_), .c(x10), .d(new_n51_), .O(new_n72_));
  oai21  g29(.a(new_n72_), .b(new_n67_), .c(new_n70_), .O(z04));
  nand2  g30(.a(x01), .b(x00), .O(new_n74_));
  nand3  g31(.a(x10), .b(x09), .c(x02), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(z05));
  nor3   g33(.a(new_n71_), .b(new_n47_), .c(x09), .O(new_n77_));
  nand4  g34(.a(new_n77_), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(new_n70_), .O(z06));
  nand3  g36(.a(new_n44_), .b(x11), .c(x10), .O(new_n80_));
  ...
  nand3  g45(.a(x19), .b(new_n46_), .c(x17), .O(new_n89_));
  ...
  nand3  g49(.a(x18), .b(x01), .c(new_n48_), .O(new_n93_));
  inv1   g50(.a(x20), .O(new_n94_));
  inv1   g51(.a(x21), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n60_), .O(new_n97_));
  oai21  g54(.a(new_n97_), .b(new_n93_), .c(new_n70_), .O(z09));
  nand4  g55(.a(new_n60_), .b(x18), .c(x01), .d(new_n48_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(x22), .c(x21), .d(new_n94_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z10));
  nand4  g59(.a(new_n96_), .b(x21), .c(new_n94_), .d(new_n60_), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n93_), .c(new_n70_), .O(z11));
  ...
  nand3  g65(.a(new_n60_), .b(x17), .c(new_n50_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n49_), .c(new_n48_), .O(new_n111_));
  ...
  nand4  g71(.a(new_n60_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n44_), .c(x01), .O(z13));
  nand4  g73(.a(new_n62_), .b(new_n51_), .c(new_n50_), .d(new_n48_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g75(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n119_));
  aoi21  g76(.a(x19), .b(new_n50_), .c(x12), .O(new_n120_));
  oai22  g77(.a(new_n120_), .b(x01), .c(new_n119_), .d(new_n48_), .O(z15));
  oai21  g78(.a(new_n49_), .b(x00), .c(new_n70_), .O(z16));
  nand4  g79(.a(new_n44_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n123_));
