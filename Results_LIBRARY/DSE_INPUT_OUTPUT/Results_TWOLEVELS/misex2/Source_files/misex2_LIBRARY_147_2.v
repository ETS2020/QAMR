...
module FAU ( 
  ...
  aoi21  g30(.a(new_n69_), .b(new_n47_), .c(new_n68_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(x10), .c(new_n49_), .d(x02), .O(new_n75_));
  ...
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n68_), .O(new_n90_));
  ...
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n89_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g66(.a(new_n93_), .b(x12), .c(new_n68_), .d(x02), .O(new_n110_));
  nand3  g67(.a(new_n107_), .b(new_n92_), .c(x15), .O(new_n111_));
  oai21  g68(.a(new_n111_), .b(new_n110_), .c(new_n46_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n47_), .O(new_n113_));
  nor3   g70(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n95_), .c(new_n88_), .d(x21), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n121_), .b(new_n48_), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g84(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n46_), .c(x01), .O(z13));
  ...
  nand4  g89(.a(x19), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n133_));
