...
module FAU ( 
  ...
  nor2   g001(.a(new_n44_), .b(x15), .O(new_n45_));
  ...
  nand4  g009(.a(new_n52_), .b(new_n51_), .c(new_n44_), .d(x10), .O(new_n53_));
  ...
  nand4  g013(.a(new_n56_), .b(new_n51_), .c(new_n44_), .d(x10), .O(new_n57_));
  nor2   g014(.a(new_n57_), .b(x19), .O(z01));
  nand3  g015(.a(new_n49_), .b(x09), .c(new_n47_), .O(new_n59_));
  inv1   g016(.a(x10), .O(new_n60_));
  nand4  g017(.a(new_n52_), .b(new_n51_), .c(new_n44_), .d(new_n60_), .O(new_n61_));
  oai21  g018(.a(new_n61_), .b(new_n59_), .c(new_n46_), .O(z02));
  nand4  g019(.a(new_n46_), .b(x12), .c(x11), .d(x10), .O(new_n63_));
  ...
  nand4  g023(.a(new_n66_), .b(new_n52_), .c(x18), .d(new_n44_), .O(new_n67_));
  ...
  oai21  g032(.a(new_n75_), .b(new_n74_), .c(new_n46_), .O(z05));
  nand2  g033(.a(new_n45_), .b(x12), .O(new_n77_));
  ...
  inv1   g047(.a(x01), .O(new_n91_));
  inv1   g048(.a(x03), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x02), .c(new_n91_), .d(new_n90_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n89_), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n88_), .c(new_n87_), .d(new_n86_), .O(new_n95_));
  nor2   g052(.a(new_n95_), .b(x08), .O(new_n96_));
  nand4  g053(.a(new_n96_), .b(new_n51_), .c(x17), .d(x15), .O(new_n97_));
  nor2   g054(.a(new_n97_), .b(new_n52_), .O(z08));
  inv1   g055(.a(x21), .O(new_n99_));
  inv1   g056(.a(x22), .O(new_n100_));
  nor2   g057(.a(new_n45_), .b(x20), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(new_n52_), .c(x18), .d(x01), .O(new_n102_));
  nor2   g059(.a(x13), .b(new_n71_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n70_), .c(x02), .d(new_n91_), .O(new_n104_));
  inv1   g061(.a(x16), .O(new_n105_));
  nor2   g062(.a(x15), .b(x14), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(x20), .c(new_n44_), .d(new_n105_), .O(new_n107_));
  oai21  g064(.a(new_n107_), .b(new_n104_), .c(new_n102_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n100_), .c(new_n99_), .d(new_n90_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(z09));
  inv1   g067(.a(x20), .O(new_n111_));
  nand4  g068(.a(new_n46_), .b(x22), .c(x21), .d(new_n111_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n52_), .c(x18), .d(x01), .O(new_n114_));
  inv1   g071(.a(x15), .O(new_n115_));
  nor3   g072(.a(new_n105_), .b(new_n115_), .c(x14), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(new_n100_), .c(new_n99_), .d(x20), .O(new_n117_));
  or2    g074(.a(new_n117_), .b(new_n104_), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n114_), .c(x00), .O(z10));
  nor2   g076(.a(new_n51_), .b(new_n91_), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n111_), .d(new_n52_), .O(new_n121_));
  nor2   g078(.a(new_n115_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n99_), .c(x20), .d(new_n105_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n104_), .c(new_n121_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n100_), .c(new_n90_), .O(new_n125_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n91_), .c(new_n90_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n49_), .b(new_n52_), .c(new_n47_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(x15), .c(new_n44_), .O(z13));
  nand3  g094(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n51_), .c(new_n44_), .d(new_n60_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n91_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n47_), .c(new_n91_), .O(new_n144_));
  aoi21  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  nor3   g102(.a(new_n45_), .b(new_n91_), .c(x00), .O(z16));
  nand3  g103(.a(x02), .b(new_n91_), .c(new_n90_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n46_), .O(z17));
endmodule
