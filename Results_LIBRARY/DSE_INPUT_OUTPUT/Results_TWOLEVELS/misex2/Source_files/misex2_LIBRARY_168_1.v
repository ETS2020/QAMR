...
module FAU ( 
  ...
  nand3  g067(.a(new_n110_), .b(new_n107_), .c(new_n50_), .O(new_n111_));
  oai21  g068(.a(new_n109_), .b(new_n103_), .c(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n101_), .c(new_n100_), .d(new_n51_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(x00), .O(z09));
  nand3  g071(.a(new_n50_), .b(x18), .c(x01), .O(new_n115_));
  nor4   g072(.a(new_n115_), .b(new_n100_), .c(new_n51_), .d(x20), .O(new_n116_));
  nand4  g073(.a(new_n102_), .b(new_n104_), .c(x12), .d(new_n66_), .O(new_n117_));
  ...
  nand4  g079(.a(new_n110_), .b(x21), .c(new_n107_), .d(new_n50_), .O(new_n123_));
  nor2   g080(.a(x16), .b(new_n106_), .O(new_n124_));
  nor2   g081(.a(x23), .b(x21), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n124_), .c(x20), .d(new_n105_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n117_), .c(new_n123_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n100_), .c(new_n73_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(z11));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(x01), .c(x00), .O(new_n131_));
  aoi21  g088(.a(x21), .b(x19), .c(x02), .O(new_n132_));
  nand3  g089(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n133_));
  oai21  g090(.a(new_n132_), .b(new_n101_), .c(new_n133_), .O(new_n134_));
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n73_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n133_), .b(new_n139_), .c(new_n52_), .O(z13));
  nand3  g097(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  nand2  g104(.a(new_n102_), .b(new_n73_), .O(new_n148_));
