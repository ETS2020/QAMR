...
module FAU ( 
  ...
  oai21  g020(.a(new_n63_), .b(new_n62_), .c(x03), .O(new_n64_));
  ...
  aoi21  g031(.a(new_n74_), .b(x03), .c(new_n70_), .O(z04));
  nand4  g032(.a(x03), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  nor3   g033(.a(new_n76_), .b(new_n56_), .c(new_n47_), .O(z05));
  nor2   g034(.a(new_n71_), .b(new_n56_), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n47_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x03), .c(new_n70_), .O(z06));
  ...
  nand3  g062(.a(x18), .b(x03), .c(x01), .O(new_n106_));
  ...
  nor2   g066(.a(x13), .b(new_n72_), .O(new_n110_));
  ...
  nand4  g076(.a(new_n107_), .b(x21), .c(new_n119_), .d(new_n66_), .O(new_n120_));
  ...
  nand3  g087(.a(new_n66_), .b(x17), .c(new_n46_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n70_), .c(new_n93_), .O(new_n133_));
  ...
  oai21  g097(.a(x10), .b(new_n70_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n70_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n45_), .O(z15));
  nand3  g101(.a(x03), .b(x01), .c(new_n93_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand2  g103(.a(new_n109_), .b(new_n93_), .O(new_n147_));
