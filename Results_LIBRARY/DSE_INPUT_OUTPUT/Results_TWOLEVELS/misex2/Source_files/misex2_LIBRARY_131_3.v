...
module FAU ( 
  ...
  nand4  g020(.a(new_n62_), .b(x12), .c(x11), .d(x10), .O(new_n64_));
  ...
  nand3  g039(.a(new_n62_), .b(new_n72_), .c(x11), .O(new_n83_));
  ...
  nand3  g044(.a(x02), .b(new_n70_), .c(new_n87_), .O(new_n88_));
  ...
  nor2   g049(.a(new_n51_), .b(x18), .O(new_n93_));
  ...
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n99_), .d(new_n62_), .O(new_n101_));
  ...
  nand2  g067(.a(new_n71_), .b(x02), .O(new_n111_));
  ...
  nand4  g075(.a(new_n103_), .b(x21), .c(new_n102_), .d(new_n51_), .O(new_n119_));
  inv1   g076(.a(x13), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x12), .c(new_n71_), .d(x02), .O(new_n121_));
  nor2   g078(.a(new_n62_), .b(x14), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n97_), .c(new_n87_), .O(new_n126_));
  ...
  nand4  g098(.a(new_n141_), .b(new_n50_), .c(new_n49_), .d(new_n59_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  aoi22  g100(.a(new_n44_), .b(x00), .c(x19), .d(new_n70_), .O(new_n144_));
  nand4  g101(.a(new_n62_), .b(new_n59_), .c(x01), .d(x00), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  aoi21  g103(.a(new_n62_), .b(x00), .c(new_n70_), .O(z16));
