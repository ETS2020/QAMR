...
module FAU ( 
  ...
  nor3   g30(.a(new_n73_), .b(new_n52_), .c(new_n44_), .O(z06));
  ...
  nand4  g46(.a(new_n89_), .b(x12), .c(new_n75_), .d(x02), .O(new_n90_));
  ...
  nand4  g65(.a(new_n108_), .b(new_n62_), .c(x18), .d(x01), .O(new_n109_));
  inv1   g66(.a(x13), .O(new_n110_));
  nor2   g67(.a(new_n45_), .b(x01), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n110_), .c(x12), .d(new_n75_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n106_), .c(new_n44_), .O(new_n116_));
  ...
  nor3   g81(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g82(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n126_));
