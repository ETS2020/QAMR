...
module FAU ( 
  ...
  nand2  g007(.a(x23), .b(x21), .O(new_n51_));
  ...
  aoi21  g027(.a(new_n70_), .b(new_n68_), .c(new_n62_), .O(z03));
  inv1   g028(.a(x00), .O(new_n72_));
  nand4  g029(.a(new_n51_), .b(new_n66_), .c(new_n65_), .d(x10), .O(new_n73_));
  ...
  nand4  g033(.a(new_n51_), .b(x10), .c(x09), .d(x02), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n44_), .c(new_n72_), .O(z05));
  ...
  nand4  g041(.a(new_n84_), .b(new_n51_), .c(x02), .d(x00), .O(new_n85_));
  ...
  nand4  g048(.a(new_n51_), .b(x19), .c(new_n49_), .d(x17), .O(new_n92_));
  ...
  nand4  g052(.a(new_n95_), .b(new_n87_), .c(x02), .d(new_n44_), .O(new_n96_));
  nor2   g053(.a(new_n96_), .b(x00), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  nand2  g056(.a(x02), .b(new_n44_), .O(new_n100_));
  inv1   g057(.a(new_n100_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(x12), .c(new_n65_), .O(new_n102_));
  ...
  nor2   g070(.a(x13), .b(new_n66_), .O(new_n114_));
  nand3  g071(.a(new_n114_), .b(new_n101_), .c(new_n65_), .O(new_n115_));
  inv1   g072(.a(new_n115_), .O(new_n116_));
  nand3  g073(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n117_));
  nor4   g074(.a(new_n117_), .b(new_n104_), .c(new_n103_), .d(x14), .O(new_n118_));
  ...
  nand4  g078(.a(new_n121_), .b(new_n98_), .c(x20), .d(new_n104_), .O(new_n122_));
  inv1   g079(.a(x23), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(x21), .c(new_n107_), .O(new_n124_));
  oai22  g081(.a(new_n124_), .b(new_n112_), .c(new_n122_), .d(new_n115_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n99_), .c(new_n72_), .O(new_n126_));
  inv1   g083(.a(new_n126_), .O(z11));
  nand2  g084(.a(x10), .b(x02), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(x01), .c(x00), .O(new_n129_));
  aoi21  g086(.a(new_n98_), .b(x19), .c(x02), .O(new_n130_));
  nand3  g087(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n131_));
  oai21  g088(.a(new_n130_), .b(new_n123_), .c(new_n131_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n72_), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n129_), .c(x24), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(x09), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n51_), .O(z12));
  inv1   g093(.a(new_n56_), .O(new_n137_));
  oai21  g094(.a(new_n131_), .b(new_n137_), .c(new_n51_), .O(z13));
  nand3  g095(.a(new_n56_), .b(new_n46_), .c(new_n45_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n60_), .c(new_n51_), .O(z14));
  ...
  oai21  g102(.a(new_n100_), .b(x00), .c(new_n51_), .O(z17));
endmodule
