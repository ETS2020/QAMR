...
module FAU ( 
  ...
  nand2  g001(.a(x13), .b(new_n44_), .O(new_n45_));
  ...
  nor2   g021(.a(new_n64_), .b(x04), .O(new_n65_));
  ...
  aoi21  g055(.a(x13), .b(new_n44_), .c(x20), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(new_n52_), .c(x18), .d(x01), .O(new_n100_));
  nand4  g057(.a(x12), .b(new_n68_), .c(x02), .d(new_n55_), .O(new_n101_));
  ...
  nand3  g064(.a(new_n107_), .b(new_n103_), .c(new_n102_), .O(new_n108_));
  ...
  nand4  g069(.a(new_n45_), .b(x22), .c(x21), .d(new_n112_), .O(new_n113_));
  inv1   g070(.a(new_n113_), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n52_), .c(x18), .d(x01), .O(new_n115_));
  nand3  g072(.a(new_n64_), .b(x12), .c(new_n68_), .O(new_n116_));
  ...
  nand4  g077(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n91_), .O(new_n121_));
  aoi21  g078(.a(new_n121_), .b(new_n115_), .c(x00), .O(z10));
  nand2  g079(.a(new_n117_), .b(new_n91_), .O(new_n123_));
  nor2   g080(.a(new_n51_), .b(new_n55_), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(x21), .c(new_n112_), .d(new_n52_), .O(new_n125_));
  ...
  nand3  g093(.a(new_n136_), .b(new_n55_), .c(new_n75_), .O(new_n137_));
  ...
  nor3   g104(.a(new_n65_), .b(new_n55_), .c(x00), .O(z16));
  nand4  g105(.a(new_n45_), .b(x02), .c(new_n55_), .d(new_n75_), .O(new_n149_));
