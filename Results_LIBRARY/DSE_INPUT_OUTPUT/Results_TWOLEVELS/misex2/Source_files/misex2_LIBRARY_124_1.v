...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n142_, new_n145_, new_n146_, new_n147_;
  inv1   g000(.a(x13), .O(new_n44_));
  nand2  g001(.a(x22), .b(new_n44_), .O(new_n45_));
  ...
  nand3  g034(.a(x22), .b(new_n44_), .c(new_n65_), .O(new_n78_));
  ...
  nand4  g056(.a(x12), .b(new_n64_), .c(x02), .d(new_n99_), .O(new_n100_));
  ...
  nand2  g067(.a(x02), .b(new_n99_), .O(new_n111_));
  nand3  g068(.a(new_n44_), .b(x12), .c(new_n64_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  inv1   g070(.a(x14), .O(new_n114_));
  nand2  g071(.a(x15), .b(new_n114_), .O(new_n115_));
  nand3  g072(.a(new_n97_), .b(x20), .c(x16), .O(new_n116_));
  nor2   g073(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g074(.a(new_n52_), .b(x18), .c(x01), .O(new_n118_));
  nand3  g075(.a(x22), .b(x21), .c(new_n105_), .O(new_n119_));
  nor2   g076(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  aoi21  g077(.a(new_n117_), .b(new_n113_), .c(new_n120_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n45_), .O(z10));
  nor2   g079(.a(x13), .b(new_n65_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n87_), .c(new_n64_), .O(new_n124_));
  nand4  g081(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n52_), .O(new_n125_));
  nor2   g082(.a(new_n101_), .b(x14), .O(new_n126_));
  nor2   g083(.a(x21), .b(new_n105_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n126_), .c(new_n102_), .O(new_n128_));
  oai21  g085(.a(new_n128_), .b(new_n124_), .c(new_n125_), .O(new_n129_));
  nand3  g086(.a(new_n129_), .b(new_n98_), .c(new_n69_), .O(new_n130_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n99_), .c(new_n69_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n132_), .c(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n45_), .O(z12));
  inv1   g098(.a(new_n48_), .O(new_n142_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n45_), .O(z13));
  oai21  g100(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g101(.a(x10), .b(new_n99_), .c(x02), .O(new_n145_));
  nand2  g102(.a(new_n145_), .b(x00), .O(new_n146_));
  nand3  g103(.a(x19), .b(new_n46_), .c(new_n99_), .O(new_n147_));
  aoi21  g104(.a(new_n147_), .b(new_n146_), .c(new_n74_), .O(z15));
  nor3   g105(.a(new_n74_), .b(new_n99_), .c(x00), .O(z16));
  nand2  g106(.a(new_n88_), .b(new_n45_), .O(z17));
endmodule
