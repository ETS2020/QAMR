...
module FAU ( 
  ...
  nor4   g028(.a(x07), .b(new_n46_), .c(new_n71_), .d(new_n70_), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n69_), .c(x10), .d(new_n47_), .O(new_n73_));
  nor2   g030(.a(new_n73_), .b(x12), .O(z04));
  nand3  g031(.a(new_n72_), .b(x10), .c(x09), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(z05));
  nor2   g033(.a(new_n69_), .b(new_n58_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n47_), .c(x02), .d(x00), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(new_n61_), .c(new_n71_), .O(z06));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(new_n61_), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n70_), .O(new_n106_));
  ...
  nand2  g071(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  ...
  nor2   g078(.a(new_n45_), .b(new_n71_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n109_), .d(new_n55_), .O(new_n123_));
  nor2   g080(.a(new_n99_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n95_), .c(x20), .d(new_n100_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n115_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n70_), .O(new_n127_));
  ...
  aoi22  g098(.a(new_n53_), .b(x00), .c(x19), .d(new_n71_), .O(new_n142_));
  nand4  g099(.a(new_n58_), .b(new_n61_), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  nand3  g101(.a(new_n61_), .b(x01), .c(new_n70_), .O(new_n145_));
