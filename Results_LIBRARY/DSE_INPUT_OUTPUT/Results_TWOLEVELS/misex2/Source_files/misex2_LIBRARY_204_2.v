...
module FAU ( 
  ...
  nand4  g023(.a(x06), .b(x02), .c(x01), .d(x00), .O(new_n67_));
  ...
  aoi21  g029(.a(new_n72_), .b(x06), .c(new_n64_), .O(z04));
  nand4  g030(.a(x06), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  ...
  nand4  g034(.a(new_n77_), .b(x06), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n63_), .O(z06));
  nand2  g036(.a(new_n47_), .b(x06), .O(new_n80_));
  ...
  aoi21  g049(.a(new_n92_), .b(new_n64_), .c(x06), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n76_), .c(x02), .d(new_n64_), .O(new_n96_));
  ...
  nand4  g058(.a(new_n101_), .b(x18), .c(x06), .d(x01), .O(new_n102_));
  oai21  g059(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n95_), .c(new_n94_), .d(new_n63_), .O(new_n104_));
  ...
  nor2   g066(.a(x13), .b(new_n81_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  ...
  nand3  g074(.a(new_n110_), .b(new_n109_), .c(new_n76_), .O(new_n118_));
  inv1   g075(.a(x20), .O(new_n119_));
  and2   g076(.a(x18), .b(x01), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n119_), .d(new_n52_), .O(new_n121_));
  nor2   g078(.a(new_n97_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n98_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n118_), .c(new_n121_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n63_), .O(new_n126_));
  ...
  oai21  g096(.a(new_n61_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g097(.a(x10), .b(new_n64_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n64_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n45_), .O(z15));
  aoi21  g101(.a(x06), .b(x00), .c(new_n64_), .O(z16));
  nand2  g102(.a(new_n109_), .b(new_n63_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n45_), .O(z17));
endmodule
