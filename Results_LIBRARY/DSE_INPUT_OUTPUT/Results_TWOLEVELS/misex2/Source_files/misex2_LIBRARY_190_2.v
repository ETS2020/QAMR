...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n123_, new_n124_, new_n127_, new_n129_;
  ...
  nor2   g61(.a(x13), .b(new_n74_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n91_), .c(new_n73_), .O(new_n106_));
  ...
  nand4  g67(.a(new_n98_), .b(x21), .c(new_n97_), .d(new_n64_), .O(new_n111_));
  ...
  nand3  g85(.a(new_n52_), .b(x19), .c(new_n45_), .O(new_n129_));
  nand2  g86(.a(new_n129_), .b(new_n118_), .O(z15));
  xor2a  g87(.a(x01), .b(x00), .O(z16));
  aoi21  g88(.a(new_n45_), .b(new_n44_), .c(x01), .O(z17));
endmodule
