...
module FAU ( 
  ...
  nor3   g30(.a(new_n73_), .b(new_n57_), .c(new_n46_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n60_), .c(new_n44_), .O(z06));
  ...
  nand4  g55(.a(new_n98_), .b(new_n89_), .c(new_n88_), .d(new_n44_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(z09));
  nand4  g57(.a(new_n93_), .b(x12), .c(new_n69_), .d(x02), .O(new_n101_));
  nor2   g58(.a(x22), .b(x21), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(x20), .c(x16), .d(x15), .O(new_n103_));
  oai21  g60(.a(new_n103_), .b(new_n101_), .c(new_n44_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n60_), .O(new_n105_));
  nor2   g62(.a(new_n89_), .b(new_n88_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n44_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n105_), .O(z10));
  inv1   g65(.a(x20), .O(new_n109_));
  nand4  g66(.a(new_n95_), .b(x21), .c(new_n109_), .d(new_n65_), .O(new_n110_));
  nor2   g67(.a(new_n45_), .b(x01), .O(new_n111_));
  nor2   g68(.a(x13), .b(new_n70_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(new_n113_));
  nor2   g70(.a(new_n91_), .b(x14), .O(new_n114_));
  nor2   g71(.a(x21), .b(new_n109_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n114_), .c(new_n92_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n113_), .c(new_n110_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n89_), .c(new_n44_), .O(new_n118_));
  ...
  nand3  g80(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand3  g82(.a(new_n125_), .b(new_n60_), .c(new_n44_), .O(new_n126_));
  ...
  nand2  g86(.a(new_n52_), .b(x17), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z13));
  nand4  g88(.a(new_n52_), .b(new_n50_), .c(new_n57_), .d(new_n46_), .O(new_n132_));
  nor3   g89(.a(new_n132_), .b(x19), .c(x18), .O(z14));
  nor2   g90(.a(x01), .b(x00), .O(new_n134_));
  nand3  g91(.a(new_n134_), .b(x19), .c(new_n45_), .O(new_n135_));
  nand2  g92(.a(new_n135_), .b(new_n122_), .O(z15));
  nor2   g93(.a(new_n60_), .b(x00), .O(z16));
  nand2  g94(.a(new_n134_), .b(x02), .O(new_n138_));
