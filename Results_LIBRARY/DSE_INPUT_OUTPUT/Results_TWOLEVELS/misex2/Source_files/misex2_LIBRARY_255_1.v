...
module FAU ( 
  ...
  nand3  g018(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n62_));
  inv1   g019(.a(x19), .O(new_n63_));
  nand4  g020(.a(new_n63_), .b(x18), .c(new_n44_), .d(new_n49_), .O(new_n64_));
  ...
  aoi21  g049(.a(new_n92_), .b(new_n49_), .c(x01), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n69_), .c(x02), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n63_), .c(x18), .d(x01), .O(new_n107_));
  ...
  nor2   g072(.a(new_n45_), .b(new_n47_), .O(new_n116_));
  nand4  g073(.a(new_n116_), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n117_));
  nor2   g074(.a(new_n48_), .b(x01), .O(new_n118_));
  nand3  g075(.a(x12), .b(new_n69_), .c(new_n49_), .O(new_n119_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n95_), .c(new_n46_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n63_), .b(x17), .c(new_n48_), .O(new_n134_));
  ...
  nand2  g095(.a(new_n138_), .b(new_n75_), .O(z12));
  nand4  g096(.a(new_n63_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n140_));
  aoi21  g097(.a(new_n140_), .b(new_n49_), .c(x01), .O(z13));
  nand4  g098(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  aoi21  g100(.a(new_n59_), .b(x01), .c(new_n48_), .O(new_n144_));
