...
module FAU ( 
  ...
  nand2  g030(.a(x17), .b(new_n68_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(x11), .c(x10), .d(new_n46_), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand3  g033(.a(new_n76_), .b(x02), .c(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(new_n49_), .c(new_n66_), .O(z06));
  nand2  g035(.a(x10), .b(new_n46_), .O(new_n79_));
  nand3  g036(.a(new_n49_), .b(new_n68_), .c(x11), .O(new_n80_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n66_), .d(new_n87_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n50_), .c(x17), .d(new_n84_), .O(new_n93_));
  nor2   g050(.a(new_n93_), .b(new_n51_), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nor2   g053(.a(new_n45_), .b(x01), .O(new_n97_));
  nand3  g054(.a(new_n97_), .b(x12), .c(new_n67_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n96_), .c(new_n95_), .d(new_n87_), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n44_), .O(z09));
  nand3  g064(.a(x18), .b(new_n49_), .c(x01), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n103_), .c(x22), .d(x21), .O(new_n110_));
  nor2   g067(.a(x13), .b(new_n68_), .O(new_n111_));
  nand3  g068(.a(new_n111_), .b(new_n97_), .c(new_n67_), .O(new_n112_));
  nor3   g069(.a(new_n100_), .b(new_n99_), .c(x14), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n96_), .c(new_n95_), .d(x20), .O(new_n114_));
  or2    g071(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  aoi21  g072(.a(new_n115_), .b(new_n110_), .c(x00), .O(z10));
  nor2   g073(.a(new_n95_), .b(x20), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n109_), .c(new_n51_), .O(new_n118_));
  ...
  nand2  g085(.a(new_n128_), .b(new_n87_), .O(new_n129_));
