...
module FAU ( 
  ...
  nor2   g008(.a(new_n51_), .b(x03), .O(new_n52_));
  ...
  aoi21  g026(.a(new_n69_), .b(new_n67_), .c(new_n52_), .O(z03));
  ...
  nor2   g035(.a(new_n52_), .b(new_n71_), .O(new_n79_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n44_), .d(new_n78_), .O(new_n91_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n51_), .d(new_n78_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n53_), .O(z09));
  nand3  g067(.a(new_n50_), .b(x18), .c(x01), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(new_n97_), .c(new_n51_), .d(x20), .O(new_n112_));
  ...
  nand3  g072(.a(new_n97_), .b(new_n51_), .c(x20), .O(new_n116_));
  ...
  nand4  g078(.a(new_n121_), .b(new_n51_), .c(x20), .d(new_n102_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n114_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n97_), .c(new_n78_), .O(new_n124_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n44_), .c(new_n78_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n127_), .c(x24), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(x09), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n53_), .O(z12));
  ...
  nor3   g099(.a(new_n52_), .b(new_n44_), .c(x00), .O(z16));
  oai21  g100(.a(new_n98_), .b(x00), .c(new_n53_), .O(z17));
endmodule
