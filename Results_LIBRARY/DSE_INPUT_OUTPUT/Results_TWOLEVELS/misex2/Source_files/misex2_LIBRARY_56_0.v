...
module FAU ( 
  ...
  nor2   g025(.a(new_n68_), .b(new_n52_), .O(new_n69_));
  nand4  g026(.a(new_n69_), .b(new_n67_), .c(x10), .d(new_n46_), .O(new_n70_));
  nand3  g027(.a(new_n70_), .b(new_n65_), .c(new_n53_), .O(z03));
  nand4  g028(.a(new_n67_), .b(new_n68_), .c(x10), .d(new_n46_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(x08), .c(x11), .O(z04));
  inv1   g030(.a(x00), .O(new_n74_));
  nor2   g031(.a(x11), .b(x08), .O(new_n75_));
  ...
  nor3   g035(.a(new_n52_), .b(new_n47_), .c(x09), .O(new_n79_));
  ...
  nand3  g039(.a(new_n68_), .b(x11), .c(x10), .O(new_n83_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n58_), .O(new_n93_));
  aoi21  g050(.a(new_n93_), .b(x11), .c(x08), .O(z08));
  inv1   g051(.a(x21), .O(new_n95_));
  inv1   g052(.a(x22), .O(new_n96_));
  nor2   g053(.a(new_n75_), .b(x20), .O(new_n97_));
  nand4  g054(.a(new_n97_), .b(new_n50_), .c(x18), .d(x01), .O(new_n98_));
  nand2  g055(.a(x02), .b(new_n44_), .O(new_n99_));
  inv1   g056(.a(new_n99_), .O(new_n100_));
  nand3  g057(.a(x12), .b(new_n52_), .c(x08), .O(new_n101_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n103_), .c(new_n102_), .d(new_n100_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n98_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n96_), .c(new_n95_), .d(new_n74_), .O(new_n110_));
  ...
  nand3  g073(.a(new_n116_), .b(x12), .c(new_n52_), .O(new_n117_));
  nor2   g074(.a(new_n117_), .b(new_n99_), .O(new_n118_));
  nand2  g075(.a(x16), .b(x15), .O(new_n119_));
  nand3  g076(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n120_));
  ...
  nand2  g081(.a(new_n124_), .b(new_n100_), .O(new_n125_));
  ...
  nand4  g085(.a(new_n128_), .b(new_n95_), .c(x20), .d(new_n105_), .O(new_n129_));
  oai21  g086(.a(new_n129_), .b(new_n125_), .c(new_n127_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n96_), .c(new_n74_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n53_), .O(z11));
  ...
  nand4  g097(.a(new_n140_), .b(new_n53_), .c(new_n133_), .d(x09), .O(new_n141_));
  ...
  nand3  g102(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(new_n146_));
  oai21  g103(.a(new_n146_), .b(new_n62_), .c(new_n53_), .O(z14));
  ...
  oai21  g109(.a(new_n99_), .b(x00), .c(new_n53_), .O(z17));
endmodule
