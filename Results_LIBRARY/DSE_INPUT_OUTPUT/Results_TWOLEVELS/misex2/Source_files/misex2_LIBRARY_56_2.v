...
module FAU ( 
  ...
  nor2   g024(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  nand4  g025(.a(new_n68_), .b(new_n66_), .c(x10), .d(new_n46_), .O(new_n69_));
  nand3  g026(.a(new_n69_), .b(new_n64_), .c(new_n52_), .O(z03));
  inv1   g027(.a(x08), .O(new_n71_));
  nand4  g028(.a(new_n66_), .b(new_n67_), .c(x10), .d(new_n46_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n71_), .c(x11), .O(z04));
  ...
  nor3   g035(.a(new_n51_), .b(new_n47_), .c(x09), .O(new_n79_));
  ...
  nand3  g039(.a(new_n67_), .b(x11), .c(x10), .O(new_n83_));
  oai22  g040(.a(new_n83_), .b(new_n82_), .c(new_n75_), .d(x01), .O(new_n84_));
  nand3  g041(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  inv1   g042(.a(new_n85_), .O(z07));
  nor2   g043(.a(new_n45_), .b(x01), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n74_), .O(new_n88_));
  ...
  aoi21  g055(.a(new_n51_), .b(x08), .c(x20), .O(new_n99_));
  nand4  g056(.a(new_n99_), .b(new_n50_), .c(x18), .d(x01), .O(new_n100_));
  nand3  g057(.a(x12), .b(new_n51_), .c(new_n71_), .O(new_n101_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n103_), .c(new_n102_), .d(new_n87_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n100_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n98_), .c(new_n97_), .d(new_n74_), .O(new_n110_));
  ...
  nand3  g073(.a(new_n116_), .b(x12), .c(new_n51_), .O(new_n117_));
  nor3   g074(.a(new_n117_), .b(new_n45_), .c(x01), .O(new_n118_));
  ...
  oai21  g079(.a(new_n122_), .b(x00), .c(new_n52_), .O(z10));
  inv1   g080(.a(new_n117_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n87_), .O(new_n125_));
  nor2   g082(.a(new_n49_), .b(new_n44_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(x21), .c(new_n113_), .d(new_n50_), .O(new_n127_));
  nor2   g084(.a(new_n104_), .b(x14), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(new_n97_), .c(x20), .d(new_n105_), .O(new_n129_));
  oai21  g086(.a(new_n129_), .b(new_n125_), .c(new_n127_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n98_), .c(new_n74_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n52_), .O(z11));
  ...
  nand3  g093(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(new_n44_), .c(new_n74_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(new_n52_), .c(new_n133_), .d(x09), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(z12));
  nor2   g099(.a(new_n75_), .b(x19), .O(new_n143_));
  nand4  g100(.a(new_n143_), .b(x17), .c(new_n45_), .d(new_n44_), .O(new_n144_));
  nor2   g101(.a(new_n144_), .b(x00), .O(z13));
  nand3  g102(.a(new_n57_), .b(new_n46_), .c(new_n45_), .O(new_n146_));
  oai21  g103(.a(new_n146_), .b(new_n61_), .c(new_n52_), .O(z14));
  ...
  aoi21  g107(.a(new_n150_), .b(new_n149_), .c(new_n75_), .O(z15));
  nor3   g108(.a(new_n75_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g109(.a(new_n88_), .b(new_n52_), .O(z17));
endmodule
