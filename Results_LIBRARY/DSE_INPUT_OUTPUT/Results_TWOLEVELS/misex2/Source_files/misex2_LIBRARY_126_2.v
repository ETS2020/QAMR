...
module FAU ( 
  ...
  nand4  g017(.a(x24), .b(x12), .c(x11), .d(x10), .O(new_n61_));
  oai21  g018(.a(new_n61_), .b(new_n60_), .c(x24), .O(new_n62_));
  ...
  nor4   g031(.a(new_n71_), .b(new_n68_), .c(new_n57_), .d(new_n47_), .O(z05));
  inv1   g032(.a(x00), .O(new_n76_));
  nand3  g033(.a(x24), .b(x11), .c(x10), .O(new_n77_));
  ...
  nand2  g053(.a(new_n96_), .b(new_n85_), .O(z08));
  inv1   g054(.a(x21), .O(new_n98_));
  inv1   g055(.a(x22), .O(new_n99_));
  inv1   g056(.a(x01), .O(new_n100_));
  nand4  g057(.a(x12), .b(new_n69_), .c(x02), .d(new_n100_), .O(new_n101_));
  ...
  nand2  g062(.a(x18), .b(x01), .O(new_n106_));
  inv1   g063(.a(x20), .O(new_n107_));
  nand3  g064(.a(x24), .b(new_n107_), .c(new_n94_), .O(new_n108_));
  oai22  g065(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n101_), .O(new_n109_));
  nand4  g066(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n76_), .O(new_n110_));
  inv1   g067(.a(new_n110_), .O(z09));
  nand3  g068(.a(new_n94_), .b(x18), .c(x01), .O(new_n112_));
  nand3  g069(.a(x22), .b(x21), .c(new_n107_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g071(.a(x02), .b(new_n100_), .O(new_n115_));
  ...
  oai21  g080(.a(new_n123_), .b(x00), .c(new_n85_), .O(z10));
  nor2   g081(.a(x13), .b(new_n70_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n87_), .c(new_n69_), .O(new_n126_));
  nor2   g083(.a(new_n102_), .b(x14), .O(new_n127_));
  nor2   g084(.a(x21), .b(new_n107_), .O(new_n128_));
  nand3  g085(.a(new_n128_), .b(new_n127_), .c(new_n103_), .O(new_n129_));
  nand2  g086(.a(x24), .b(x21), .O(new_n130_));
  nor2   g087(.a(new_n130_), .b(x20), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n65_), .c(x01), .O(new_n132_));
  oai21  g089(.a(new_n129_), .b(new_n126_), .c(new_n132_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n99_), .c(new_n76_), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z11));
  oai21  g092(.a(x19), .b(x02), .c(x23), .O(new_n136_));
  nand3  g093(.a(new_n94_), .b(x17), .c(new_n46_), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g095(.a(new_n138_), .b(x09), .c(new_n76_), .O(new_n139_));
  aoi21  g096(.a(new_n139_), .b(new_n100_), .c(x24), .O(z12));
  inv1   g097(.a(new_n48_), .O(new_n141_));
  oai21  g098(.a(new_n137_), .b(new_n141_), .c(new_n85_), .O(z13));
  nand3  g099(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n143_));
  nand4  g100(.a(new_n94_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n144_));
  oai21  g101(.a(new_n144_), .b(new_n143_), .c(new_n85_), .O(z14));
  oai21  g102(.a(x10), .b(new_n100_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n46_), .c(new_n100_), .O(new_n148_));
  nand3  g105(.a(new_n148_), .b(new_n147_), .c(new_n85_), .O(z15));
  aoi21  g106(.a(x24), .b(x00), .c(new_n100_), .O(z16));
  nand2  g107(.a(new_n88_), .b(new_n85_), .O(z17));
endmodule
