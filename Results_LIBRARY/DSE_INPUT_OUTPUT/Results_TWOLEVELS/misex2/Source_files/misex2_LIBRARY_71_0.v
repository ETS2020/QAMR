...
module FAU ( 
  ...
  nor3   g046(.a(new_n64_), .b(new_n44_), .c(x08), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n49_), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(x14), .c(x18), .O(z08));
  ...
  nand4  g061(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n75_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n63_), .O(z09));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n63_), .O(z10));
  nor2   g076(.a(new_n47_), .b(x01), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n72_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n71_), .O(new_n122_));
  nand4  g079(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n64_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n94_), .c(new_n75_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n63_), .O(z11));
  ...
  nand3  g090(.a(new_n64_), .b(x17), .c(new_n47_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n95_), .c(new_n75_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n130_), .c(x09), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n63_), .O(z12));
  nor2   g096(.a(new_n62_), .b(x19), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n47_), .d(new_n95_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x00), .O(z13));
  nor2   g099(.a(new_n50_), .b(x10), .O(new_n143_));
  nand4  g100(.a(new_n143_), .b(new_n45_), .c(new_n44_), .d(x14), .O(new_n144_));
  nor2   g101(.a(new_n144_), .b(x19), .O(z14));
  oai21  g102(.a(x10), .b(new_n95_), .c(x02), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(x00), .O(new_n147_));
  nand3  g104(.a(x19), .b(new_n47_), .c(new_n95_), .O(new_n148_));
  aoi21  g105(.a(new_n148_), .b(new_n147_), .c(new_n62_), .O(z15));
  nor3   g106(.a(new_n62_), .b(new_n95_), .c(x00), .O(z16));
  oai21  g107(.a(new_n110_), .b(x00), .c(new_n63_), .O(z17));
endmodule
