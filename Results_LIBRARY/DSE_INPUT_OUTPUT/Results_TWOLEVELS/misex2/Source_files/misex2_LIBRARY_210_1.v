...
module FAU ( 
  ...
  aoi21  g31(.a(x12), .b(new_n46_), .c(new_n68_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x10), .c(new_n49_), .d(x02), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(x00), .c(new_n47_), .O(z06));
  nand2  g34(.a(new_n49_), .b(x02), .O(new_n78_));
  inv1   g35(.a(x12), .O(new_n79_));
  nand3  g36(.a(new_n79_), .b(x11), .c(x10), .O(new_n80_));
  oai21  g37(.a(new_n80_), .b(new_n78_), .c(x00), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g39(.a(x02), .b(new_n47_), .c(x00), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n82_), .O(z07));
  inv1   g41(.a(x08), .O(new_n85_));
  inv1   g42(.a(x05), .O(new_n86_));
  inv1   g43(.a(x06), .O(new_n87_));
  inv1   g44(.a(x03), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n89_));
  inv1   g46(.a(new_n89_), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(new_n87_), .c(new_n86_), .d(x04), .O(new_n91_));
  nor2   g48(.a(new_n91_), .b(x07), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n45_), .c(x17), .d(new_n85_), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(new_n63_), .O(z08));
  ...
  nand4  g65(.a(new_n106_), .b(new_n96_), .c(x20), .d(new_n95_), .O(new_n109_));
  ...
  oai21  g77(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n121_));
  oai21  g78(.a(x19), .b(x00), .c(new_n48_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(z15));
  nand3  g80(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n125_));
