...
module FAU ( 
  ...
  oai22  g041(.a(new_n84_), .b(new_n82_), .c(x06), .d(x01), .O(new_n85_));
  ...
  nor2   g055(.a(new_n83_), .b(x11), .O(new_n99_));
  nand3  g056(.a(new_n99_), .b(new_n98_), .c(new_n49_), .O(new_n100_));
  ...
  nand2  g070(.a(x02), .b(new_n47_), .O(new_n114_));
  ...
  oai21  g079(.a(new_n122_), .b(x00), .c(new_n76_), .O(z10));
  nor2   g080(.a(x13), .b(new_n83_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n98_), .c(new_n70_), .O(new_n125_));
  nand4  g082(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n65_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n97_), .c(new_n46_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n76_), .O(z11));
  ...
  nand3  g095(.a(new_n138_), .b(new_n47_), .c(new_n46_), .O(new_n139_));
  nand2  g096(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand3  g097(.a(new_n140_), .b(new_n133_), .c(x09), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(new_n76_), .O(z12));
  nand4  g099(.a(new_n65_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n49_), .c(x01), .O(z13));
  nor3   g101(.a(x09), .b(x02), .c(x00), .O(new_n145_));
  nand4  g102(.a(new_n145_), .b(new_n58_), .c(new_n44_), .d(new_n56_), .O(new_n146_));
  aoi21  g103(.a(new_n146_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g104(.a(new_n56_), .b(x01), .c(new_n48_), .O(new_n148_));
  aoi21  g105(.a(x19), .b(new_n48_), .c(x06), .O(new_n149_));
  oai22  g106(.a(new_n149_), .b(x01), .c(new_n148_), .d(new_n46_), .O(z15));
  oai21  g107(.a(new_n47_), .b(x00), .c(new_n76_), .O(z16));
  aoi21  g108(.a(new_n88_), .b(new_n49_), .c(x01), .O(z17));
endmodule
