...
module FAU ( 
  ...
  nand4  g24(.a(new_n67_), .b(x10), .c(new_n49_), .d(x02), .O(new_n68_));
  ...
  nand4  g50(.a(new_n93_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n94_));
  ...
  nor3   g61(.a(new_n104_), .b(x11), .c(new_n48_), .O(new_n105_));
  ...
  nand3  g69(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(x00), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n111_), .c(new_n110_), .O(new_n115_));
  oai22  g72(.a(new_n115_), .b(new_n49_), .c(new_n47_), .d(x00), .O(z12));
  aoi21  g73(.a(new_n113_), .b(new_n47_), .c(x00), .O(z13));
