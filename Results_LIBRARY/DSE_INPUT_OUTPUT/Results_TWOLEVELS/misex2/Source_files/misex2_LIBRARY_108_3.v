// Benchmark "FAU" written by ABC on Wed Aug 19 14:57:13 2020
...
module FAU ( 
  ...
  nand2  g012(.a(x03), .b(x01), .O(new_n56_));
  inv1   g013(.a(x00), .O(new_n57_));
  inv1   g014(.a(x01), .O(new_n58_));
  inv1   g015(.a(x02), .O(new_n59_));
  nand4  g016(.a(x09), .b(new_n59_), .c(new_n58_), .d(new_n57_), .O(new_n60_));
  inv1   g017(.a(x10), .O(new_n61_));
  inv1   g018(.a(x19), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n45_), .c(new_n44_), .d(new_n61_), .O(new_n63_));
  oai21  g020(.a(new_n63_), .b(new_n60_), .c(new_n56_), .O(z02));
  nand3  g021(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n65_));
  nand3  g022(.a(new_n62_), .b(x18), .c(new_n44_), .O(new_n66_));
  inv1   g023(.a(x03), .O(new_n67_));
  ...
  nor2   g027(.a(x09), .b(new_n59_), .O(new_n71_));
  nor2   g028(.a(x12), .b(x11), .O(new_n72_));
  nand4  g029(.a(new_n72_), .b(new_n71_), .c(x10), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(new_n67_), .c(new_n58_), .O(z04));
  nand4  g031(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n75_));
  aoi21  g032(.a(new_n75_), .b(new_n67_), .c(new_n58_), .O(z05));
  inv1   g033(.a(x11), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n61_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n67_), .c(x02), .d(x01), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(new_n57_), .O(z06));
  nand2  g037(.a(new_n46_), .b(new_n67_), .O(new_n81_));
  ...
  nand2  g042(.a(new_n85_), .b(new_n56_), .O(z07));
  nor2   g043(.a(new_n59_), .b(x01), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n57_), .O(new_n88_));
  inv1   g045(.a(x05), .O(new_n89_));
  nand3  g046(.a(new_n89_), .b(x04), .c(new_n67_), .O(new_n90_));
  ...
  nand2  g051(.a(new_n94_), .b(new_n56_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n77_), .c(x02), .d(new_n58_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n103_), .b(x18), .c(new_n67_), .d(x01), .O(new_n104_));
  oai21  g061(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(new_n105_));
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n57_), .O(new_n106_));
  inv1   g063(.a(new_n106_), .O(z09));
  nand3  g064(.a(new_n62_), .b(x18), .c(x01), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nor3   g066(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n110_));
  nand2  g067(.a(x02), .b(new_n58_), .O(new_n111_));
  ...
  aoi22  g075(.a(new_n118_), .b(new_n114_), .c(new_n110_), .d(new_n109_), .O(new_n119_));
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n56_), .O(z10));
  nand4  g077(.a(new_n87_), .b(new_n112_), .c(x12), .d(new_n77_), .O(new_n121_));
  nor2   g078(.a(new_n45_), .b(x03), .O(new_n122_));
  nor2   g079(.a(new_n96_), .b(x20), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n122_), .c(new_n62_), .d(x01), .O(new_n124_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n57_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(z11));
  inv1   g086(.a(x24), .O(new_n130_));
  nand2  g087(.a(x10), .b(x02), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(new_n67_), .c(x01), .d(x00), .O(new_n132_));
  oai21  g089(.a(x19), .b(x02), .c(x23), .O(new_n133_));
  nand3  g090(.a(new_n62_), .b(x17), .c(new_n59_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n58_), .c(new_n57_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n61_), .O(new_n142_));
  ...
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n56_), .O(z15));
  nand3  g104(.a(new_n67_), .b(x01), .c(new_n57_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n88_), .b(new_n56_), .O(z17));
endmodule
