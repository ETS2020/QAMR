...
module FAU ( 
  ...
  nor3   g030(.a(new_n70_), .b(new_n59_), .c(new_n47_), .O(z05));
  inv1   g031(.a(x01), .O(new_n75_));
  nor2   g032(.a(new_n69_), .b(new_n59_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n47_), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x07), .c(new_n75_), .O(z06));
  ...
  nor2   g078(.a(new_n45_), .b(new_n75_), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(x21), .c(new_n109_), .d(new_n56_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n87_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n54_), .O(z11));
  ...
  nand3  g090(.a(new_n133_), .b(new_n75_), .c(new_n87_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n130_), .c(x24), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(x09), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n54_), .O(z12));
  ...
  aoi22  g098(.a(new_n54_), .b(x00), .c(x19), .d(new_n75_), .O(new_n142_));
  nand4  g099(.a(new_n59_), .b(x07), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  nand3  g101(.a(x07), .b(x01), .c(new_n87_), .O(new_n145_));
