...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n130_, new_n132_, new_n133_, new_n134_, new_n137_;
  ...
  nand4  g20(.a(new_n53_), .b(x18), .c(new_n44_), .d(x08), .O(new_n64_));
  nand3  g21(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  nand4  g22(.a(x12), .b(x11), .c(x10), .d(new_n59_), .O(new_n66_));
  ...
  nor2   g43(.a(new_n48_), .b(x01), .O(new_n87_));
  ...
  nor2   g50(.a(new_n45_), .b(new_n47_), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n93_), .c(new_n53_), .O(new_n95_));
  oai21  g52(.a(new_n92_), .b(new_n88_), .c(new_n95_), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n86_), .c(new_n85_), .d(new_n46_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n75_), .O(z09));
  nand3  g55(.a(new_n53_), .b(x18), .c(x01), .O(new_n99_));
  ...
  nand3  g64(.a(new_n86_), .b(new_n85_), .c(x20), .O(new_n108_));
  ...
  nand4  g68(.a(new_n87_), .b(new_n103_), .c(x12), .d(new_n68_), .O(new_n112_));
  nand4  g69(.a(new_n94_), .b(x21), .c(new_n93_), .d(new_n53_), .O(new_n113_));
  nor2   g70(.a(new_n89_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n85_), .c(x20), .d(new_n90_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n113_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n86_), .c(new_n46_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n75_), .O(z11));
  ...
  nand4  g86(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n130_));
  nor2   g87(.a(new_n130_), .b(x19), .O(z14));
  aoi21  g88(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n132_));
  inv1   g89(.a(x08), .O(new_n133_));
  aoi21  g90(.a(x19), .b(new_n48_), .c(new_n133_), .O(new_n134_));
  oai22  g91(.a(new_n134_), .b(x01), .c(new_n132_), .d(new_n46_), .O(z15));
  nor2   g92(.a(new_n47_), .b(x00), .O(z16));
  nand4  g93(.a(x08), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n137_));
