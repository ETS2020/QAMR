...
module FAU ( 
  ...
  nand4  g16(.a(x11), .b(x10), .c(new_n60_), .d(x02), .O(new_n61_));
  nor3   g17(.a(new_n61_), .b(new_n59_), .c(z16), .O(z06));
  oai21  g18(.a(x02), .b(z16), .c(new_n59_), .O(new_n63_));
  inv1   g19(.a(x12), .O(new_n64_));
  nand3  g20(.a(new_n49_), .b(new_n64_), .c(x11), .O(new_n65_));
  oai21  g21(.a(new_n65_), .b(new_n47_), .c(new_n63_), .O(z07));
  ...
  aoi21  g39(.a(new_n48_), .b(x01), .c(new_n85_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(z16), .c(new_n46_), .O(z15));
  zero   g41(.O(z01));
  zero   g42(.O(z08));
  zero   g43(.O(z13));
  zero   g44(.O(z17));
