...
module FAU ( 
  ...
  nand4  g28(.a(new_n71_), .b(new_n69_), .c(x10), .d(new_n53_), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(x12), .O(z04));
  nand3  g30(.a(x10), .b(x09), .c(x02), .O(new_n74_));
  aoi21  g31(.a(new_n74_), .b(x00), .c(new_n44_), .O(z05));
  nand4  g32(.a(x11), .b(x10), .c(new_n53_), .d(x02), .O(new_n76_));
  nor3   g33(.a(new_n76_), .b(new_n44_), .c(new_n54_), .O(z06));
  ...
  oai21  g64(.a(new_n46_), .b(new_n45_), .c(x01), .O(new_n108_));
  nand2  g65(.a(x23), .b(x19), .O(new_n109_));
  oai21  g66(.a(x19), .b(new_n51_), .c(new_n109_), .O(new_n110_));
  and2   g67(.a(x23), .b(x02), .O(new_n111_));
  aoi21  g68(.a(new_n110_), .b(new_n45_), .c(new_n111_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(x00), .c(new_n108_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n107_), .c(x09), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n83_), .O(z12));
  nor3   g72(.a(new_n55_), .b(x19), .c(new_n51_), .O(z13));
  nand4  g73(.a(new_n48_), .b(new_n46_), .c(new_n53_), .d(new_n45_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n44_), .c(x00), .O(z14));
  aoi21  g75(.a(new_n46_), .b(x01), .c(new_n45_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n45_), .c(new_n44_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n54_), .c(new_n120_), .O(z15));
