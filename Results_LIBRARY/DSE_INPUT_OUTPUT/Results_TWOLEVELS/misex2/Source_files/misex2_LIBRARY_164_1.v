...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n135_, new_n138_, new_n140_, new_n141_, new_n144_;
  ...
  nand4  g013(.a(new_n56_), .b(x09), .c(new_n48_), .d(new_n46_), .O(new_n57_));
  aoi21  g014(.a(new_n57_), .b(new_n49_), .c(x01), .O(z01));
  inv1   g015(.a(x10), .O(new_n59_));
  inv1   g016(.a(x09), .O(new_n60_));
  nor2   g017(.a(new_n50_), .b(new_n60_), .O(new_n61_));
  ...
  nand4  g021(.a(new_n54_), .b(x18), .c(new_n44_), .d(new_n49_), .O(new_n65_));
  nand3  g022(.a(x02), .b(x01), .c(x00), .O(new_n66_));
  nand4  g023(.a(x12), .b(x11), .c(x10), .d(new_n60_), .O(new_n67_));
  ...
  nand3  g059(.a(new_n102_), .b(new_n101_), .c(new_n54_), .O(new_n103_));
  ...
  nand2  g062(.a(new_n105_), .b(new_n75_), .O(z09));
  nand3  g063(.a(new_n54_), .b(x18), .c(x01), .O(new_n107_));
  nand3  g064(.a(x22), .b(x21), .c(new_n101_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g066(.a(x02), .b(new_n47_), .O(new_n110_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n75_), .O(z10));
  nand4  g076(.a(new_n95_), .b(new_n111_), .c(x12), .d(new_n69_), .O(new_n120_));
  nand4  g077(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n54_), .O(new_n121_));
  ...
  nand2  g082(.a(new_n125_), .b(new_n75_), .O(z11));
  ...
  nand3  g087(.a(new_n54_), .b(x17), .c(new_n48_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g089(.a(new_n132_), .b(new_n49_), .c(new_n47_), .d(new_n46_), .O(new_n133_));
  ...
  nand4  g094(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z14));
  aoi21  g096(.a(new_n59_), .b(x01), .c(new_n48_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n48_), .c(x08), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n46_), .O(z15));
  nor2   g099(.a(new_n47_), .b(x00), .O(z16));
  nand4  g100(.a(new_n49_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n144_));
