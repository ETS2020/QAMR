...
module FAU ( 
  ...
  nand3  g19(.a(new_n62_), .b(x18), .c(new_n53_), .O(new_n63_));
  ...
  nand3  g37(.a(x19), .b(new_n54_), .c(x17), .O(new_n81_));
  ...
  nand4  g54(.a(new_n97_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n88_), .c(new_n87_), .d(x12), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(new_n85_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n91_), .c(x20), .d(x16), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x22), .O(z10));
  nand4  g60(.a(new_n94_), .b(new_n90_), .c(new_n86_), .d(x15), .O(new_n104_));
  ...
  nand3  g65(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n108_), .c(x00), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n107_), .c(new_n106_), .O(new_n111_));
  oai22  g68(.a(new_n111_), .b(new_n46_), .c(new_n44_), .d(x00), .O(z12));
  nand2  g69(.a(new_n55_), .b(x17), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z13));
  nand2  g71(.a(new_n55_), .b(new_n46_), .O(new_n115_));
  ...
  oai21  g77(.a(new_n119_), .b(new_n60_), .c(new_n120_), .O(z15));
