...
module FAU ( 
  ...
  nor3   g18(.a(new_n61_), .b(x09), .c(new_n60_), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n59_), .c(x00), .O(new_n63_));
  ...
  nor2   g25(.a(new_n59_), .b(new_n68_), .O(new_n69_));
  ...
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n68_), .O(z05));
  inv1   g30(.a(x11), .O(new_n74_));
  inv1   g31(.a(x12), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n59_), .c(new_n74_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x10), .c(new_n46_), .d(x02), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x01), .c(new_n68_), .O(z06));
  nor3   g35(.a(new_n70_), .b(x12), .c(new_n74_), .O(z07));
  inv1   g36(.a(x08), .O(new_n80_));
  inv1   g37(.a(x05), .O(new_n81_));
  inv1   g38(.a(x06), .O(new_n82_));
  inv1   g39(.a(x03), .O(new_n83_));
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n59_), .d(new_n68_), .O(new_n84_));
  ...
  nand4  g48(.a(x12), .b(new_n74_), .c(x02), .d(new_n59_), .O(new_n92_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n91_), .c(new_n90_), .d(new_n68_), .O(new_n101_));
  ...
  oai21  g63(.a(new_n106_), .b(new_n103_), .c(new_n68_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n59_), .O(new_n108_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n103_), .c(new_n68_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n59_), .O(new_n115_));
  ...
  nand3  g77(.a(new_n64_), .b(x17), .c(new_n60_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n59_), .c(new_n68_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n129_), .b(new_n64_), .c(new_n45_), .d(new_n44_), .O(new_n130_));
  aoi21  g87(.a(new_n130_), .b(new_n68_), .c(x01), .O(z14));
  aoi21  g88(.a(x19), .b(new_n60_), .c(x00), .O(new_n132_));
  nand2  g89(.a(new_n118_), .b(x00), .O(new_n133_));
  oai21  g90(.a(new_n132_), .b(x01), .c(new_n133_), .O(z15));
  xor2a  g91(.a(x01), .b(x00), .O(z16));
  aoi21  g92(.a(new_n60_), .b(new_n68_), .c(x01), .O(z17));
endmodule
