...
module FAU ( 
  ...
  nand4  g028(.a(new_n52_), .b(new_n71_), .c(new_n70_), .d(x10), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n46_), .c(x02), .d(x01), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(new_n59_), .O(z04));
  ...
  inv1   g035(.a(x24), .O(new_n79_));
  nor2   g036(.a(new_n79_), .b(x23), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x10), .c(new_n46_), .d(x02), .O(new_n82_));
  nor3   g039(.a(new_n82_), .b(new_n44_), .c(new_n59_), .O(z06));
  nand3  g040(.a(new_n67_), .b(new_n71_), .c(x11), .O(new_n84_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n52_), .c(new_n99_), .d(new_n98_), .O(new_n109_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n88_), .c(new_n70_), .O(new_n125_));
  ...
  nand4  g087(.a(new_n130_), .b(new_n52_), .c(new_n99_), .d(new_n59_), .O(new_n131_));
  ...
  nand3  g094(.a(new_n137_), .b(new_n44_), .c(new_n59_), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g096(.a(new_n139_), .b(new_n79_), .c(x09), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(new_n52_), .O(z12));
  nand2  g098(.a(new_n44_), .b(new_n59_), .O(new_n142_));
  ...
  nor3   g107(.a(new_n80_), .b(new_n44_), .c(x00), .O(z16));
  nand2  g108(.a(new_n89_), .b(new_n52_), .O(z17));
endmodule
