...
module FAU ( 
  ...
  nand2  g000(.a(x03), .b(x01), .O(new_n44_));
  ...
  nand4  g016(.a(new_n56_), .b(new_n50_), .c(new_n49_), .d(new_n59_), .O(new_n60_));
  ...
  inv1   g022(.a(x03), .O(new_n66_));
  nand2  g023(.a(x01), .b(x00), .O(new_n67_));
  inv1   g024(.a(new_n67_), .O(new_n68_));
  nand3  g025(.a(new_n68_), .b(new_n66_), .c(x02), .O(new_n69_));
  nand4  g026(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n70_));
  oai22  g027(.a(new_n70_), .b(new_n69_), .c(new_n65_), .d(new_n64_), .O(z03));
  inv1   g028(.a(x11), .O(new_n72_));
  nor3   g029(.a(new_n67_), .b(x03), .c(new_n45_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n72_), .c(x10), .d(new_n46_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n66_), .c(new_n63_), .O(z05));
  nor3   g034(.a(new_n72_), .b(new_n59_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(new_n66_), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(new_n66_), .c(new_n63_), .O(z06));
  nand2  g037(.a(new_n46_), .b(new_n66_), .O(new_n81_));
  ...
  nand4  g046(.a(new_n66_), .b(x02), .c(new_n63_), .d(new_n62_), .O(new_n90_));
  inv1   g047(.a(new_n90_), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(x04), .O(new_n92_));
  nor2   g049(.a(new_n92_), .b(x07), .O(new_n93_));
  nand4  g050(.a(new_n93_), .b(new_n50_), .c(x17), .d(new_n87_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n51_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  nor2   g054(.a(new_n45_), .b(x01), .O(new_n98_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n51_), .c(x18), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n62_), .O(new_n107_));
  ...
  nand2  g071(.a(new_n114_), .b(new_n98_), .O(new_n115_));
  ...
  nor2   g078(.a(new_n50_), .b(x03), .O(new_n122_));
  nor2   g079(.a(new_n96_), .b(x20), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n122_), .c(new_n51_), .d(x01), .O(new_n124_));
  nor2   g081(.a(new_n100_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n96_), .c(x20), .d(new_n101_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n115_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n62_), .O(new_n128_));
  inv1   g085(.a(new_n128_), .O(z11));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n66_), .c(x01), .d(x00), .O(new_n131_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n63_), .c(new_n62_), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(new_n131_), .c(x24), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(x09), .O(new_n137_));
  inv1   g094(.a(new_n137_), .O(z12));
  nand2  g095(.a(new_n54_), .b(x17), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x19), .O(z13));
  nand2  g097(.a(new_n54_), .b(new_n46_), .O(new_n141_));
  inv1   g098(.a(new_n141_), .O(new_n142_));
  nand4  g099(.a(new_n142_), .b(new_n50_), .c(new_n49_), .d(new_n59_), .O(new_n143_));
  nor2   g100(.a(new_n143_), .b(x19), .O(z14));
  aoi22  g101(.a(new_n44_), .b(x00), .c(x19), .d(new_n63_), .O(new_n145_));
  nand3  g102(.a(new_n68_), .b(new_n59_), .c(new_n66_), .O(new_n146_));
