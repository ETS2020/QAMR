...
module FAU ( 
  ...
  nor2   g020(.a(x24), .b(x23), .O(new_n64_));
  ...
  nor3   g036(.a(new_n64_), .b(new_n72_), .c(new_n47_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(new_n46_), .c(x02), .d(x01), .O(new_n81_));
  nor2   g038(.a(new_n81_), .b(new_n76_), .O(z06));
  nand4  g039(.a(new_n53_), .b(new_n73_), .c(x11), .d(x10), .O(new_n83_));
  ...
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n53_), .O(z10));
  ...
  nand3  g088(.a(new_n50_), .b(new_n48_), .c(new_n45_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n44_), .c(new_n76_), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(x09), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(x23), .c(x24), .O(z12));
