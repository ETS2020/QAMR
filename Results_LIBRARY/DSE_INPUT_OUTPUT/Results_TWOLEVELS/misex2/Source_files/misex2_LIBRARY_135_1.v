...
module FAU ( 
  ...
  or2    g008(.a(new_n51_), .b(x09), .O(new_n52_));
  ...
  nor3   g018(.a(new_n51_), .b(x10), .c(new_n61_), .O(new_n62_));
  nand4  g019(.a(new_n62_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n63_));
  nor2   g020(.a(new_n63_), .b(x21), .O(z02));
  nand2  g021(.a(new_n46_), .b(x18), .O(new_n65_));
  nor4   g022(.a(new_n65_), .b(x17), .c(x02), .d(x00), .O(new_n66_));
  oai21  g023(.a(new_n66_), .b(x21), .c(new_n49_), .O(new_n67_));
  nand3  g024(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nand4  g025(.a(x12), .b(x11), .c(x10), .d(new_n61_), .O(new_n69_));
  ...
  nand4  g030(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n61_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nor3   g032(.a(new_n72_), .b(new_n47_), .c(new_n61_), .O(z05));
  nor3   g033(.a(new_n71_), .b(new_n47_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nand2  g035(.a(x21), .b(new_n49_), .O(new_n79_));
  ...
  nor2   g052(.a(new_n95_), .b(x21), .O(z08));
  inv1   g053(.a(x22), .O(new_n97_));
  nand2  g054(.a(x02), .b(new_n49_), .O(new_n98_));
  ...
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n46_), .O(new_n107_));
  oai21  g064(.a(new_n104_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n56_), .d(new_n48_), .O(new_n109_));
  inv1   g066(.a(new_n109_), .O(z09));
  nor4   g067(.a(new_n65_), .b(new_n97_), .c(new_n56_), .d(x20), .O(new_n111_));
  nor2   g068(.a(x13), .b(new_n81_), .O(new_n112_));
  nand2  g069(.a(new_n112_), .b(new_n71_), .O(new_n113_));
  nor2   g070(.a(new_n113_), .b(new_n98_), .O(new_n114_));
  nand3  g071(.a(new_n97_), .b(x20), .c(x16), .O(new_n115_));
  nor3   g072(.a(new_n115_), .b(new_n101_), .c(x14), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n114_), .c(new_n111_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n79_), .O(z10));
  inv1   g075(.a(new_n114_), .O(new_n119_));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n46_), .O(new_n120_));
  nor2   g077(.a(new_n101_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n56_), .c(x20), .d(new_n102_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n119_), .c(new_n120_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n97_), .c(new_n48_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n46_), .b(x17), .c(new_n50_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(new_n56_), .c(new_n49_), .d(new_n48_), .O(new_n131_));
  aoi21  g088(.a(new_n131_), .b(new_n127_), .c(x24), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(x09), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nor4   g091(.a(new_n51_), .b(x21), .c(x19), .d(new_n44_), .O(z13));
  nor2   g092(.a(new_n52_), .b(x10), .O(new_n136_));
  nand4  g093(.a(new_n136_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(x21), .O(z14));
  aoi21  g095(.a(new_n56_), .b(new_n50_), .c(new_n126_), .O(new_n139_));
  nand4  g096(.a(new_n56_), .b(x19), .c(new_n50_), .d(new_n49_), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(new_n48_), .c(new_n140_), .O(z15));
  nor2   g098(.a(new_n49_), .b(x00), .O(z16));
  nand4  g099(.a(new_n56_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n143_));
