...
module FAU ( 
  ...
  nor2   g047(.a(new_n50_), .b(x18), .O(new_n91_));
  nand4  g048(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(x17), .O(new_n92_));
  nand2  g049(.a(new_n92_), .b(new_n52_), .O(z08));
  inv1   g050(.a(x06), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n70_), .c(x02), .d(new_n44_), .O(new_n96_));
  ...
  nand4  g058(.a(new_n101_), .b(new_n50_), .c(x18), .d(x01), .O(new_n102_));
  oai21  g059(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  nand3  g060(.a(new_n103_), .b(new_n95_), .c(new_n85_), .O(new_n104_));
  aoi21  g061(.a(new_n104_), .b(new_n94_), .c(x21), .O(z09));
  ...
  nand3  g071(.a(new_n95_), .b(new_n51_), .c(x20), .O(new_n115_));
  ...
  nor2   g075(.a(new_n49_), .b(new_n44_), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(x21), .c(new_n101_), .d(new_n50_), .O(new_n120_));
  nand3  g077(.a(x12), .b(new_n70_), .c(new_n94_), .O(new_n121_));
  nor2   g078(.a(new_n121_), .b(new_n109_), .O(new_n122_));
  nand3  g079(.a(x15), .b(new_n113_), .c(new_n110_), .O(new_n123_));
  nand3  g080(.a(new_n51_), .b(x20), .c(new_n98_), .O(new_n124_));
  nor2   g081(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n120_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n95_), .c(new_n85_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n44_), .c(new_n85_), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g094(.a(new_n137_), .b(new_n130_), .c(x09), .O(new_n138_));
  nand2  g095(.a(new_n138_), .b(new_n52_), .O(z12));
  nand2  g096(.a(new_n44_), .b(new_n85_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n134_), .c(new_n52_), .O(z13));
  ...
  nand2  g105(.a(new_n86_), .b(new_n52_), .O(z17));
endmodule
