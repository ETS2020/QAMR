...
module FAU ( 
  ...
  nand4  g27(.a(new_n70_), .b(x10), .c(new_n46_), .d(x02), .O(new_n71_));
  aoi21  g28(.a(new_n71_), .b(x00), .c(new_n56_), .O(z04));
  ...
  nor3   g32(.a(new_n75_), .b(new_n56_), .c(new_n62_), .O(z06));
  ...
  oai21  g37(.a(new_n56_), .b(x00), .c(new_n80_), .O(z07));
  nor2   g38(.a(x03), .b(new_n57_), .O(new_n82_));
  ...
  aoi21  g51(.a(new_n94_), .b(new_n56_), .c(x00), .O(z09));
  inv1   g52(.a(x21), .O(new_n96_));
  inv1   g53(.a(x15), .O(new_n97_));
  inv1   g54(.a(x11), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n89_), .c(new_n88_), .d(x12), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n96_), .c(x20), .d(x16), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x22), .O(z10));
  inv1   g61(.a(x16), .O(new_n105_));
  nand4  g62(.a(new_n102_), .b(new_n96_), .c(x20), .d(new_n105_), .O(new_n106_));
  ...
  nand3  g67(.a(new_n63_), .b(x17), .c(new_n57_), .O(new_n111_));
  ...
  oai21  g77(.a(new_n58_), .b(new_n62_), .c(x01), .O(new_n121_));
  oai21  g78(.a(x19), .b(x00), .c(new_n57_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(z15));
  nand3  g80(.a(x02), .b(new_n56_), .c(new_n62_), .O(new_n125_));
