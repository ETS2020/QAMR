...
module FAU ( 
  ...
  aoi21  g027(.a(new_n70_), .b(x23), .c(new_n60_), .O(z04));
  inv1   g028(.a(x23), .O(new_n72_));
  nand4  g029(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor3   g030(.a(new_n73_), .b(new_n72_), .c(new_n56_), .O(z05));
  nand3  g031(.a(x23), .b(x11), .c(x10), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n46_), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n59_), .O(z06));
  nand2  g035(.a(x10), .b(new_n46_), .O(new_n79_));
  inv1   g036(.a(x12), .O(new_n80_));
  nand3  g037(.a(x23), .b(new_n80_), .c(x11), .O(new_n81_));
  ...
  nand2  g064(.a(new_n72_), .b(x01), .O(new_n108_));
  ...
  nand4  g081(.a(new_n111_), .b(x23), .c(x21), .d(new_n104_), .O(new_n125_));
  ...
  nand3  g088(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n60_), .c(new_n59_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n130_), .c(x24), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(x09), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n108_), .O(z12));
  ...
  aoi21  g103(.a(x23), .b(x00), .c(new_n60_), .O(z16));
