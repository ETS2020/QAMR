...
module FAU ( 
  ...
  nand2  g000(.a(x07), .b(x06), .O(new_n44_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n56_), .c(x18), .d(new_n50_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n70_), .c(new_n64_), .O(z03));
  nand4  g030(.a(new_n44_), .b(new_n68_), .c(new_n67_), .d(x10), .O(new_n74_));
  inv1   g031(.a(new_n74_), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n48_), .c(x02), .d(x01), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n45_), .O(z04));
  ...
  nand4  g037(.a(new_n44_), .b(x11), .c(x10), .d(new_n48_), .O(new_n81_));
  ...
  nand4  g043(.a(new_n86_), .b(new_n44_), .c(x02), .d(x00), .O(new_n87_));
  ...
  nand4  g049(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n45_), .O(new_n93_));
  nor3   g050(.a(x08), .b(x07), .c(x06), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(x19), .c(new_n55_), .d(x17), .O(new_n95_));
  oai21  g052(.a(new_n95_), .b(new_n93_), .c(new_n44_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  inv1   g054(.a(x22), .O(new_n98_));
  nand3  g055(.a(new_n90_), .b(x12), .c(new_n67_), .O(new_n99_));
  ...
  nor2   g061(.a(new_n55_), .b(new_n46_), .O(new_n105_));
  ...
  nand3  g071(.a(new_n114_), .b(x12), .c(new_n67_), .O(new_n115_));
  ...
  nand4  g079(.a(new_n90_), .b(new_n114_), .c(x12), .d(new_n67_), .O(new_n123_));
  ...
  nand3  g090(.a(new_n56_), .b(x17), .c(new_n47_), .O(new_n134_));
  ...
  nand4  g094(.a(new_n137_), .b(new_n44_), .c(new_n130_), .d(x09), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(z12));
  nor2   g096(.a(new_n64_), .b(x19), .O(new_n140_));
  nand4  g097(.a(new_n140_), .b(x17), .c(new_n47_), .d(new_n46_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x00), .O(z13));
  nand3  g099(.a(new_n51_), .b(new_n50_), .c(new_n54_), .O(new_n143_));
  oai21  g100(.a(new_n143_), .b(new_n49_), .c(new_n44_), .O(z14));
  ...
  nand3  g105(.a(new_n44_), .b(x01), .c(new_n45_), .O(new_n149_));
  inv1   g106(.a(new_n149_), .O(z16));
  nand4  g107(.a(new_n44_), .b(x02), .c(new_n46_), .d(new_n45_), .O(new_n151_));
