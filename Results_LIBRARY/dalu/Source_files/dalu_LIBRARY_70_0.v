// Benchmark "FAU" written by ABC on Wed Jul  1 03:44:09 2020
...
module FAU ( 
  ...
  nand2  g0948(.a(new_n116_), .b(x29), .O(new_n1040_));
  ...
  inv1   g0956(.a(new_n190_), .O(new_n1048_));
  nand3  g0957(.a(new_n1048_), .b(new_n319_), .c(x32), .O(new_n1049_));
  ...
  oai22  g0969(.a(new_n154_), .b(new_n1060_), .c(new_n116_), .d(new_n319_), .O(new_n1061_));
  ...
  nand2  g0975(.a(new_n1032_), .b(new_n141_), .O(new_n1067_));
  ...
  nand2  g0987(.a(new_n1078_), .b(new_n1059_), .O(z13));
  ...
  nand2  g0994(.a(new_n935_), .b(new_n212_), .O(new_n1086_));
  nand2  g0995(.a(new_n765_), .b(x54), .O(new_n1087_));
  ...
  aoi21  g1006(.a(new_n1097_), .b(new_n777_), .c(new_n1084_), .O(new_n1098_));
  nand2  g1007(.a(new_n207_), .b(x30), .O(new_n1099_));
  nand2  g1008(.a(new_n949_), .b(new_n212_), .O(new_n1100_));
  nand2  g1009(.a(new_n765_), .b(x22), .O(new_n1101_));
  ...
  oai21  g1013(.a(x74), .b(new_n960_), .c(new_n1104_), .O(new_n1105_));
  ...
  nand2  g1019(.a(new_n1110_), .b(new_n794_), .O(new_n1111_));
  ...
  nand2  g1037(.a(new_n1128_), .b(new_n816_), .O(new_n1129_));
  ...
  nand2  g1041(.a(new_n1082_), .b(new_n101_), .O(new_n1133_));
  ...
  aoi21  g1054(.a(new_n1145_), .b(new_n1144_), .c(new_n833_), .O(new_n1146_));
  ...
  nand2  g1065(.a(new_n209_), .b(x70), .O(new_n1157_));
  nand3  g1066(.a(x74), .b(x70), .c(x62), .O(new_n1158_));
  nand3  g1067(.a(new_n209_), .b(new_n101_), .c(x31), .O(new_n1159_));
  aoi21  g1068(.a(new_n1159_), .b(new_n1158_), .c(new_n116_), .O(new_n1160_));
  aoi21  g1069(.a(new_n174_), .b(x74), .c(new_n188_), .O(new_n1161_));
  nor2   g1070(.a(new_n116_), .b(x63), .O(new_n1162_));
  oai22  g1071(.a(new_n1157_), .b(new_n1162_), .c(new_n1161_), .d(new_n1117_), .O(new_n1163_));
  oai21  g1072(.a(new_n1163_), .b(new_n1160_), .c(new_n212_), .O(new_n1164_));
  oai21  g1073(.a(new_n1157_), .b(new_n1040_), .c(new_n1164_), .O(new_n1165_));
  nand2  g1074(.a(new_n1165_), .b(new_n203_), .O(new_n1166_));
  nand3  g1075(.a(x74), .b(new_n101_), .c(x31), .O(new_n1167_));
  oai21  g1076(.a(new_n707_), .b(new_n101_), .c(new_n1167_), .O(new_n1168_));
  nand2  g1077(.a(new_n1168_), .b(x71), .O(new_n1169_));
  oai21  g1078(.a(new_n102_), .b(x74), .c(new_n117_), .O(new_n1170_));
  nor3   g1079(.a(new_n1162_), .b(new_n209_), .c(new_n101_), .O(new_n1171_));
  aoi21  g1080(.a(new_n1170_), .b(x23), .c(new_n1171_), .O(new_n1172_));
  aoi21  g1081(.a(new_n1172_), .b(new_n1169_), .c(new_n212_), .O(new_n1173_));
  nor2   g1082(.a(x73), .b(new_n116_), .O(new_n1174_));
  nand2  g1083(.a(new_n1174_), .b(new_n101_), .O(new_n1175_));
  aoi21  g1084(.a(new_n1175_), .b(new_n117_), .c(new_n800_), .O(new_n1176_));
  nand3  g1085(.a(new_n1174_), .b(x70), .c(x58), .O(new_n1177_));
  inv1   g1086(.a(new_n1177_), .O(new_n1178_));
  oai21  g1087(.a(new_n1178_), .b(new_n1176_), .c(x74), .O(new_n1179_));
  nand2  g1088(.a(x70), .b(x59), .O(new_n1180_));
  oai21  g1089(.a(x70), .b(new_n883_), .c(new_n1180_), .O(new_n1181_));
  nand3  g1090(.a(new_n1181_), .b(new_n1174_), .c(new_n209_), .O(new_n1182_));
  nand2  g1091(.a(new_n1182_), .b(new_n1179_), .O(new_n1183_));
  oai21  g1092(.a(new_n1183_), .b(new_n1173_), .c(x72), .O(new_n1184_));
  nor2   g1093(.a(x72), .b(new_n116_), .O(new_n1185_));
  nand2  g1094(.a(new_n1185_), .b(new_n101_), .O(new_n1186_));
  aoi21  g1095(.a(new_n1186_), .b(new_n117_), .c(new_n960_), .O(new_n1187_));
  nand3  g1096(.a(new_n1185_), .b(x70), .c(x60), .O(new_n1188_));
  inv1   g1097(.a(new_n1188_), .O(new_n1189_));
  oai21  g1098(.a(new_n1189_), .b(new_n1187_), .c(x74), .O(new_n1190_));
  nand2  g1099(.a(x70), .b(x61), .O(new_n1191_));
  oai21  g1100(.a(x70), .b(new_n1060_), .c(new_n1191_), .O(new_n1192_));
  nand3  g1101(.a(new_n1192_), .b(new_n1185_), .c(new_n209_), .O(new_n1193_));
  nand2  g1102(.a(new_n1193_), .b(new_n1190_), .O(new_n1194_));
  nand3  g1103(.a(new_n116_), .b(x70), .c(x27), .O(new_n1195_));
  inv1   g1104(.a(new_n1195_), .O(new_n1196_));
  aoi22  g1105(.a(new_n1196_), .b(new_n205_), .c(new_n1194_), .d(x73), .O(new_n1197_));
  nand3  g1106(.a(new_n1197_), .b(new_n1184_), .c(new_n1166_), .O(new_n1198_));
  ...
  nand2  g1110(.a(new_n268_), .b(x62), .O(new_n1202_));
  inv1   g1111(.a(new_n1202_), .O(new_n1203_));
  oai21  g1112(.a(new_n1203_), .b(new_n1201_), .c(new_n203_), .O(new_n1204_));
  nand2  g1113(.a(new_n1014_), .b(new_n212_), .O(new_n1205_));
  nand2  g1114(.a(new_n765_), .b(x55), .O(new_n1206_));
  nand2  g1115(.a(new_n1206_), .b(new_n1205_), .O(new_n1207_));
  aoi22  g1116(.a(new_n1207_), .b(x72), .c(new_n207_), .d(x63), .O(new_n1208_));
  aoi21  g1117(.a(new_n1208_), .b(new_n1204_), .c(new_n298_), .O(new_n1209_));
  aoi21  g1118(.a(new_n1198_), .b(new_n166_), .c(new_n1209_), .O(new_n1210_));
  nand2  g1119(.a(x65), .b(new_n92_), .O(new_n1211_));
  nor2   g1120(.a(new_n1211_), .b(new_n93_), .O(new_n1212_));
  aoi21  g1121(.a(new_n171_), .b(new_n93_), .c(new_n1212_), .O(new_n1213_));
  inv1   g1122(.a(x47), .O(new_n1214_));
  oai21  g1123(.a(new_n116_), .b(new_n1214_), .c(new_n154_), .O(new_n1215_));
  nand2  g1124(.a(new_n1215_), .b(x70), .O(new_n1216_));
  nand2  g1125(.a(new_n141_), .b(x15), .O(new_n1217_));
  nand3  g1126(.a(new_n126_), .b(x69), .c(x63), .O(new_n1218_));
  nand3  g1127(.a(new_n1218_), .b(new_n1217_), .c(new_n1216_), .O(new_n1219_));
  nor3   g1128(.a(new_n162_), .b(new_n137_), .c(new_n1214_), .O(new_n1220_));
  aoi21  g1129(.a(new_n1219_), .b(new_n137_), .c(new_n1220_), .O(new_n1221_));
  oai21  g1130(.a(new_n150_), .b(new_n148_), .c(x64), .O(new_n1222_));
  aoi22  g1131(.a(new_n188_), .b(x47), .c(new_n174_), .d(x15), .O(new_n1223_));
  nor2   g1132(.a(new_n137_), .b(x64), .O(new_n1224_));
  nand3  g1133(.a(new_n1224_), .b(new_n94_), .c(new_n153_), .O(new_n1225_));
  oai22  g1134(.a(new_n1225_), .b(new_n1223_), .c(new_n1222_), .d(new_n1221_), .O(new_n1226_));
  nor4   g1135(.a(new_n1223_), .b(new_n1211_), .c(new_n139_), .d(new_n94_), .O(new_n1227_));
  aoi21  g1136(.a(new_n1226_), .b(new_n132_), .c(new_n1227_), .O(new_n1228_));
  oai21  g1137(.a(new_n1213_), .b(new_n1210_), .c(new_n1228_), .O(z15));
endmodule
