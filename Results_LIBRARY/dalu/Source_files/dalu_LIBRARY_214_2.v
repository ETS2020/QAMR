// Benchmark "FAU" written by ABC on Wed Jul  1 03:49:42 2020
...
module FAU ( 
  ...
  nand2  g0316(.a(new_n181_), .b(new_n310_), .O(new_n408_));
  nor2   g0317(.a(x04), .b(new_n96_), .O(new_n409_));
  oai21  g0318(.a(new_n408_), .b(new_n407_), .c(new_n409_), .O(new_n410_));
  oai21  g0319(.a(new_n179_), .b(x00), .c(new_n410_), .O(new_n411_));
  ...
  and2   g0329(.a(new_n420_), .b(new_n132_), .O(new_n421_));
  oai21  g0330(.a(new_n421_), .b(new_n406_), .c(new_n94_), .O(new_n422_));
  nand2  g0331(.a(new_n420_), .b(new_n135_), .O(new_n423_));
  ...
  nand3  g0341(.a(new_n403_), .b(x69), .c(new_n131_), .O(new_n433_));
  nand2  g0342(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  nand2  g0343(.a(new_n434_), .b(new_n137_), .O(new_n435_));
  nor2   g0344(.a(new_n401_), .b(new_n392_), .O(new_n436_));
  ...
  nand2  g0349(.a(new_n431_), .b(new_n137_), .O(new_n441_));
  ...
  aoi22  g0357(.a(new_n205_), .b(x17), .c(new_n377_), .d(x21), .O(new_n449_));
  ...
  aoi22  g0370(.a(new_n205_), .b(x49), .c(new_n377_), .d(x53), .O(new_n462_));
  ...
  nand3  g0388(.a(new_n479_), .b(new_n478_), .c(new_n179_), .O(new_n480_));
  ...
  oai21  g0419(.a(new_n510_), .b(new_n509_), .c(new_n365_), .O(new_n511_));
  ...
  aoi21  g0423(.a(new_n514_), .b(new_n513_), .c(new_n370_), .O(new_n515_));
  oai21  g0424(.a(new_n515_), .b(new_n512_), .c(new_n171_), .O(new_n516_));
  nand2  g0425(.a(new_n516_), .b(new_n497_), .O(z05));
  aoi21  g0426(.a(new_n385_), .b(new_n384_), .c(new_n212_), .O(new_n518_));
  ...
  aoi21  g0431(.a(new_n381_), .b(new_n380_), .c(x73), .O(new_n523_));
  ...
  aoi21  g0437(.a(new_n398_), .b(new_n397_), .c(new_n212_), .O(new_n529_));
  ...
  nand2  g0450(.a(new_n538_), .b(new_n365_), .O(new_n542_));
  aoi21  g0451(.a(new_n542_), .b(new_n541_), .c(new_n132_), .O(new_n543_));
  nor2   g0452(.a(x07), .b(x05), .O(new_n544_));
  nand3  g0453(.a(new_n544_), .b(new_n479_), .c(new_n179_), .O(new_n545_));
  nand3  g0454(.a(new_n545_), .b(new_n478_), .c(x00), .O(new_n546_));
  ...
  nand2  g0480(.a(new_n571_), .b(new_n365_), .O(new_n572_));
  ...
  aoi21  g0484(.a(new_n575_), .b(new_n574_), .c(new_n370_), .O(new_n576_));
  ...
  oai21  g0510(.a(new_n480_), .b(x05), .c(new_n601_), .O(new_n602_));
  ...
  aoi21  g0561(.a(new_n398_), .b(new_n397_), .c(x73), .O(new_n653_));
  ...
  nand3  g0752(.a(new_n407_), .b(new_n175_), .c(x00), .O(new_n844_));
