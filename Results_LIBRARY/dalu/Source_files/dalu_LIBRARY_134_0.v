// Benchmark "FAU" written by ABC on Wed Jul  1 03:46:41 2020
...
module FAU ( 
  ...
  nand2  g0780(.a(new_n184_), .b(x57), .O(new_n872_));
  ...
  oai21  g0874(.a(x74), .b(new_n821_), .c(new_n965_), .O(new_n966_));
  nand2  g0875(.a(new_n966_), .b(x73), .O(new_n967_));
  nand2  g0876(.a(new_n255_), .b(x27), .O(new_n968_));
  ...
  and2   g0880(.a(new_n971_), .b(new_n260_), .O(new_n972_));
  oai21  g0881(.a(new_n972_), .b(new_n959_), .c(new_n170_), .O(new_n973_));
  aoi21  g0882(.a(new_n962_), .b(new_n961_), .c(new_n179_), .O(new_n974_));
  ...
  nand2  g0888(.a(new_n979_), .b(new_n182_), .O(new_n980_));
  aoi21  g0889(.a(new_n947_), .b(new_n946_), .c(new_n179_), .O(new_n981_));
  ...
  nand2  g0893(.a(new_n984_), .b(new_n267_), .O(new_n985_));
  xnor2a g0894(.a(x44), .b(x32), .O(new_n986_));
  nor2   g0895(.a(new_n986_), .b(x71), .O(new_n987_));
  ...
  aoi21  g0899(.a(new_n990_), .b(new_n973_), .c(new_n93_), .O(new_n991_));
  nand2  g0900(.a(new_n943_), .b(new_n170_), .O(new_n992_));
  ...
  nand2  g0904(.a(x71), .b(x44), .O(new_n996_));
  oai21  g0905(.a(new_n155_), .b(new_n977_), .c(new_n996_), .O(new_n997_));
  nand2  g0906(.a(new_n997_), .b(x70), .O(new_n998_));
  nand2  g0907(.a(new_n158_), .b(x12), .O(new_n999_));
  nand3  g0908(.a(new_n107_), .b(x69), .c(x60), .O(new_n1000_));
  nand3  g0909(.a(new_n1000_), .b(new_n999_), .c(new_n998_), .O(new_n1001_));
  and2   g0910(.a(new_n1001_), .b(x67), .O(new_n1002_));
  nand2  g0911(.a(new_n971_), .b(new_n98_), .O(new_n1003_));
  nand2  g0912(.a(new_n957_), .b(new_n101_), .O(new_n1004_));
  aoi21  g0913(.a(new_n1004_), .b(new_n1003_), .c(new_n296_), .O(new_n1005_));
  oai21  g0914(.a(new_n1005_), .b(new_n1002_), .c(new_n119_), .O(new_n1006_));
  nand2  g0915(.a(new_n957_), .b(new_n148_), .O(new_n1007_));
  nand2  g0916(.a(x67), .b(x44), .O(new_n1008_));
  nand2  g0917(.a(new_n1008_), .b(new_n1007_), .O(new_n1009_));
  nand2  g0918(.a(new_n1009_), .b(new_n302_), .O(new_n1010_));
  aoi21  g0919(.a(new_n1010_), .b(new_n1006_), .c(x66), .O(new_n1011_));
  nand2  g0920(.a(new_n1001_), .b(new_n119_), .O(new_n1012_));
  nand3  g0921(.a(new_n109_), .b(x68), .c(x44), .O(new_n1013_));
  aoi21  g0922(.a(new_n1013_), .b(new_n1012_), .c(new_n305_), .O(new_n1014_));
  oai21  g0923(.a(new_n1014_), .b(new_n1011_), .c(new_n167_), .O(new_n1015_));
  nand2  g0924(.a(new_n1015_), .b(new_n995_), .O(z12));
  nand2  g0925(.a(new_n312_), .b(x00), .O(new_n1017_));
  oai21  g0926(.a(new_n118_), .b(new_n126_), .c(x13), .O(new_n1018_));
  oai21  g0927(.a(new_n1017_), .b(new_n118_), .c(new_n1018_), .O(new_n1019_));
  ...
  aoi21  g0932(.a(new_n1023_), .b(x32), .c(x71), .O(new_n1024_));
  nand2  g0933(.a(new_n1024_), .b(x70), .O(new_n1025_));
  oai21  g0934(.a(new_n1020_), .b(x70), .c(new_n1025_), .O(new_n1026_));
  nand3  g0935(.a(new_n1026_), .b(new_n165_), .c(new_n92_), .O(new_n1027_));
  nand2  g0936(.a(x74), .b(x58), .O(new_n1028_));
  nand2  g0937(.a(new_n184_), .b(x59), .O(new_n1029_));
  aoi21  g0938(.a(new_n1029_), .b(new_n1028_), .c(new_n187_), .O(new_n1030_));
  nand2  g0939(.a(new_n255_), .b(x60), .O(new_n1031_));
  inv1   g0940(.a(new_n1031_), .O(new_n1032_));
  oai21  g0941(.a(new_n1032_), .b(new_n1030_), .c(new_n179_), .O(new_n1033_));
  aoi21  g0942(.a(new_n872_), .b(new_n871_), .c(x73), .O(new_n1034_));
  nand2  g0943(.a(new_n328_), .b(x53), .O(new_n1035_));
  inv1   g0944(.a(new_n1035_), .O(new_n1036_));
  oai21  g0945(.a(new_n1036_), .b(new_n1034_), .c(x72), .O(new_n1037_));
  aoi21  g0946(.a(new_n182_), .b(x61), .c(x66), .O(new_n1038_));
  nand3  g0947(.a(new_n1038_), .b(new_n1037_), .c(new_n1033_), .O(new_n1039_));
  aoi21  g0948(.a(new_n1039_), .b(new_n148_), .c(new_n149_), .O(new_n1040_));
  nand3  g0949(.a(new_n94_), .b(new_n170_), .c(x64), .O(new_n1041_));
  oai21  g0950(.a(new_n1041_), .b(new_n1040_), .c(new_n1027_), .O(new_n1042_));
  nand2  g0951(.a(new_n1042_), .b(x68), .O(new_n1043_));
  inv1   g0952(.a(new_n152_), .O(new_n1044_));
  inv1   g0953(.a(x29), .O(new_n1045_));
  nor2   g0954(.a(new_n92_), .b(new_n1045_), .O(new_n1046_));
  nand4  g0955(.a(new_n1046_), .b(new_n1044_), .c(x70), .d(new_n119_), .O(new_n1047_));
  aoi21  g0956(.a(new_n1047_), .b(new_n1043_), .c(x69), .O(new_n1048_));
  nand2  g0957(.a(new_n101_), .b(x45), .O(new_n1049_));
  nand3  g0958(.a(new_n107_), .b(x69), .c(x61), .O(new_n1050_));
  nand2  g0959(.a(new_n1050_), .b(new_n1049_), .O(new_n1051_));
  aoi21  g0960(.a(new_n158_), .b(x13), .c(new_n1051_), .O(new_n1052_));
  nor2   g0961(.a(new_n1052_), .b(new_n148_), .O(new_n1053_));
  nand2  g0962(.a(new_n182_), .b(x29), .O(new_n1054_));
  nand2  g0963(.a(new_n887_), .b(new_n187_), .O(new_n1055_));
  nand2  g0964(.a(new_n328_), .b(x21), .O(new_n1056_));
  ...
  nand2  g0968(.a(new_n184_), .b(x27), .O(new_n1060_));
  aoi21  g0969(.a(new_n1060_), .b(new_n1059_), .c(new_n187_), .O(new_n1061_));
  nand2  g0970(.a(new_n255_), .b(x28), .O(new_n1062_));
  inv1   g0971(.a(new_n1062_), .O(new_n1063_));
  oai21  g0972(.a(new_n1063_), .b(new_n1061_), .c(new_n179_), .O(new_n1064_));
  nand3  g0973(.a(new_n1064_), .b(new_n1058_), .c(new_n1054_), .O(new_n1065_));
  nand2  g0974(.a(new_n1065_), .b(new_n98_), .O(new_n1066_));
  nand2  g0975(.a(new_n182_), .b(x61), .O(new_n1067_));
  nand3  g0976(.a(new_n1067_), .b(new_n1037_), .c(new_n1033_), .O(new_n1068_));
  nand2  g0977(.a(new_n1068_), .b(new_n101_), .O(new_n1069_));
  aoi21  g0978(.a(new_n1069_), .b(new_n1066_), .c(new_n296_), .O(new_n1070_));
  oai21  g0979(.a(new_n1070_), .b(new_n1053_), .c(new_n150_), .O(new_n1071_));
  inv1   g0980(.a(new_n1052_), .O(new_n1072_));
  nand2  g0981(.a(new_n1072_), .b(new_n151_), .O(new_n1073_));
  nand2  g0982(.a(new_n119_), .b(x64), .O(new_n1074_));
  aoi21  g0983(.a(new_n1073_), .b(new_n1071_), .c(new_n1074_), .O(new_n1075_));
  oai21  g0984(.a(new_n1075_), .b(new_n1048_), .c(new_n138_), .O(new_n1076_));
  nand3  g0985(.a(new_n1068_), .b(new_n165_), .c(new_n94_), .O(new_n1077_));
  oai21  g0986(.a(new_n1020_), .b(new_n165_), .c(new_n1077_), .O(new_n1078_));
  nand2  g0987(.a(new_n1078_), .b(new_n194_), .O(new_n1079_));
  nand4  g0988(.a(new_n1065_), .b(new_n105_), .c(new_n165_), .d(x71), .O(new_n1080_));
  aoi21  g0989(.a(new_n1080_), .b(new_n1079_), .c(x70), .O(new_n1081_));
  nand2  g0990(.a(new_n1064_), .b(new_n1058_), .O(new_n1082_));
  nand2  g0991(.a(new_n1082_), .b(new_n94_), .O(new_n1083_));
  nand2  g0992(.a(x71), .b(x61), .O(new_n1084_));
  oai21  g0993(.a(x71), .b(new_n1045_), .c(new_n1084_), .O(new_n1085_));
  nand2  g0994(.a(new_n1085_), .b(new_n182_), .O(new_n1086_));
  nand2  g0995(.a(new_n1037_), .b(new_n1033_), .O(new_n1087_));
  nand2  g0996(.a(new_n1087_), .b(x71), .O(new_n1088_));
  nand3  g0997(.a(new_n1088_), .b(new_n1086_), .c(new_n1083_), .O(new_n1089_));
  nand3  g0998(.a(new_n1089_), .b(new_n105_), .c(new_n165_), .O(new_n1090_));
  nand3  g0999(.a(new_n1024_), .b(new_n194_), .c(new_n93_), .O(new_n1091_));
  aoi21  g1000(.a(new_n1091_), .b(new_n1090_), .c(new_n170_), .O(new_n1092_));
  nor2   g1001(.a(new_n138_), .b(x64), .O(new_n1093_));
  oai21  g1002(.a(new_n1092_), .b(new_n1081_), .c(new_n1093_), .O(new_n1094_));
  ...
  nand2  g1007(.a(new_n182_), .b(x62), .O(new_n1099_));
  nand2  g1008(.a(new_n952_), .b(new_n187_), .O(new_n1100_));
  nand2  g1009(.a(new_n328_), .b(x54), .O(new_n1101_));
  ...
  nand2  g1016(.a(new_n255_), .b(x61), .O(new_n1108_));
  nand2  g1017(.a(new_n1108_), .b(new_n1107_), .O(new_n1109_));
  nand2  g1018(.a(new_n1109_), .b(new_n179_), .O(new_n1110_));
  nand3  g1019(.a(new_n1110_), .b(new_n1103_), .c(new_n1099_), .O(new_n1111_));
  aoi22  g1020(.a(new_n1111_), .b(new_n192_), .c(new_n1098_), .d(new_n138_), .O(new_n1112_));
  nand2  g1021(.a(new_n182_), .b(x30), .O(new_n1113_));
  nand2  g1022(.a(new_n966_), .b(new_n187_), .O(new_n1114_));
  nand2  g1023(.a(new_n328_), .b(x22), .O(new_n1115_));
  ...
  oai21  g1027(.a(x74), .b(new_n977_), .c(new_n1118_), .O(new_n1119_));
  nand2  g1028(.a(new_n1119_), .b(x73), .O(new_n1120_));
  nand2  g1029(.a(new_n255_), .b(x29), .O(new_n1121_));
  nand2  g1030(.a(new_n1121_), .b(new_n1120_), .O(new_n1122_));
  nand2  g1031(.a(new_n1122_), .b(new_n179_), .O(new_n1123_));
  nand3  g1032(.a(new_n1123_), .b(new_n1117_), .c(new_n1113_), .O(new_n1124_));
  nand2  g1033(.a(new_n1124_), .b(new_n260_), .O(new_n1125_));
  oai21  g1034(.a(new_n1112_), .b(new_n195_), .c(new_n1125_), .O(new_n1126_));
  nand2  g1035(.a(new_n1126_), .b(new_n170_), .O(new_n1127_));
  aoi21  g1036(.a(new_n1115_), .b(new_n1114_), .c(new_n179_), .O(new_n1128_));
  ...
  nand2  g1042(.a(new_n1133_), .b(new_n182_), .O(new_n1134_));
  aoi21  g1043(.a(new_n1101_), .b(new_n1100_), .c(new_n179_), .O(new_n1135_));
  aoi21  g1044(.a(new_n1108_), .b(new_n1107_), .c(x72), .O(new_n1136_));
  oai21  g1045(.a(new_n1136_), .b(new_n1135_), .c(x71), .O(new_n1137_));
  nand3  g1046(.a(new_n1137_), .b(new_n1134_), .c(new_n1130_), .O(new_n1138_));
  nand2  g1047(.a(new_n1138_), .b(new_n267_), .O(new_n1139_));
  ...
  nand2  g1051(.a(new_n1142_), .b(new_n276_), .O(new_n1143_));
  nand2  g1052(.a(new_n1143_), .b(new_n1139_), .O(new_n1144_));
  nand2  g1053(.a(new_n1144_), .b(x70), .O(new_n1145_));
  aoi21  g1054(.a(new_n1145_), .b(new_n1127_), .c(new_n93_), .O(new_n1146_));
  nand2  g1055(.a(new_n1098_), .b(new_n170_), .O(new_n1147_));
  ...
  oai22  g1059(.a(new_n155_), .b(new_n1131_), .c(new_n94_), .d(new_n1021_), .O(new_n1151_));
  nand2  g1060(.a(new_n1151_), .b(x70), .O(new_n1152_));
  nand2  g1061(.a(new_n158_), .b(x14), .O(new_n1153_));
  nand3  g1062(.a(new_n107_), .b(x69), .c(x62), .O(new_n1154_));
  nand3  g1063(.a(new_n1154_), .b(new_n1153_), .c(new_n1152_), .O(new_n1155_));
  and2   g1064(.a(new_n1155_), .b(x67), .O(new_n1156_));
  nand2  g1065(.a(new_n1124_), .b(new_n98_), .O(new_n1157_));
  nand2  g1066(.a(new_n1111_), .b(new_n101_), .O(new_n1158_));
  aoi21  g1067(.a(new_n1158_), .b(new_n1157_), .c(new_n296_), .O(new_n1159_));
  oai21  g1068(.a(new_n1159_), .b(new_n1156_), .c(new_n119_), .O(new_n1160_));
  nand2  g1069(.a(new_n1111_), .b(new_n148_), .O(new_n1161_));
  oai21  g1070(.a(new_n148_), .b(new_n1021_), .c(new_n1161_), .O(new_n1162_));
  nand2  g1071(.a(new_n1162_), .b(new_n302_), .O(new_n1163_));
  aoi21  g1072(.a(new_n1163_), .b(new_n1160_), .c(x66), .O(new_n1164_));
  nand2  g1073(.a(new_n1155_), .b(new_n119_), .O(new_n1165_));
  nand3  g1074(.a(new_n109_), .b(x68), .c(x46), .O(new_n1166_));
  aoi21  g1075(.a(new_n1166_), .b(new_n1165_), .c(new_n305_), .O(new_n1167_));
  oai21  g1076(.a(new_n1167_), .b(new_n1164_), .c(new_n167_), .O(new_n1168_));
  nand2  g1077(.a(new_n1168_), .b(new_n1150_), .O(z14));
  inv1   g1078(.a(new_n167_), .O(new_n1170_));
  inv1   g1079(.a(x31), .O(new_n1171_));
  oai22  g1080(.a(new_n155_), .b(new_n1171_), .c(new_n94_), .d(new_n1022_), .O(new_n1172_));
  nand2  g1081(.a(new_n1172_), .b(x70), .O(new_n1173_));
  nand2  g1082(.a(new_n158_), .b(x15), .O(new_n1174_));
  nand3  g1083(.a(new_n107_), .b(x69), .c(x63), .O(new_n1175_));
  ...
  nand2  g1087(.a(new_n184_), .b(x29), .O(new_n1179_));
  aoi21  g1088(.a(new_n1179_), .b(new_n1178_), .c(new_n187_), .O(new_n1180_));
  nand2  g1089(.a(new_n255_), .b(x30), .O(new_n1181_));
  inv1   g1090(.a(new_n1181_), .O(new_n1182_));
  oai21  g1091(.a(new_n1182_), .b(new_n1180_), .c(new_n179_), .O(new_n1183_));
  nand2  g1092(.a(new_n182_), .b(x31), .O(new_n1184_));
  aoi21  g1093(.a(new_n1060_), .b(new_n1059_), .c(x73), .O(new_n1185_));
  nand2  g1094(.a(new_n328_), .b(x23), .O(new_n1186_));
  ...
  nand2  g1100(.a(new_n184_), .b(x61), .O(new_n1192_));
  aoi21  g1101(.a(new_n1192_), .b(new_n1191_), .c(new_n187_), .O(new_n1193_));
  nand2  g1102(.a(new_n255_), .b(x62), .O(new_n1194_));
  inv1   g1103(.a(new_n1194_), .O(new_n1195_));
  oai21  g1104(.a(new_n1195_), .b(new_n1193_), .c(new_n179_), .O(new_n1196_));
  nand2  g1105(.a(new_n182_), .b(x63), .O(new_n1197_));
  aoi21  g1106(.a(new_n1029_), .b(new_n1028_), .c(x73), .O(new_n1198_));
  nand2  g1107(.a(new_n328_), .b(x55), .O(new_n1199_));
  ...
  nand2  g1111(.a(new_n1202_), .b(new_n101_), .O(new_n1203_));
  aoi21  g1112(.a(new_n1203_), .b(new_n1190_), .c(new_n296_), .O(new_n1204_));
  oai21  g1113(.a(new_n1204_), .b(new_n1177_), .c(new_n150_), .O(new_n1205_));
  nand2  g1114(.a(new_n1176_), .b(new_n151_), .O(new_n1206_));
  aoi21  g1115(.a(new_n1206_), .b(new_n1205_), .c(new_n1170_), .O(new_n1207_));
  nand3  g1116(.a(new_n1093_), .b(new_n165_), .c(x69), .O(new_n1208_));
  aoi21  g1117(.a(new_n1203_), .b(new_n1190_), .c(new_n1208_), .O(new_n1209_));
  oai21  g1118(.a(new_n1209_), .b(new_n1207_), .c(new_n119_), .O(new_n1210_));
  nand3  g1119(.a(x71), .b(new_n138_), .c(x15), .O(new_n1211_));
  inv1   g1120(.a(new_n1211_), .O(new_n1212_));
  aoi21  g1121(.a(new_n1202_), .b(new_n192_), .c(new_n1212_), .O(new_n1213_));
  nand3  g1122(.a(new_n411_), .b(new_n138_), .c(x47), .O(new_n1214_));
  oai21  g1123(.a(new_n1213_), .b(x70), .c(new_n1214_), .O(new_n1215_));
  nand2  g1124(.a(new_n95_), .b(x15), .O(new_n1216_));
  nand2  g1125(.a(new_n411_), .b(x47), .O(new_n1217_));
  aoi21  g1126(.a(new_n1217_), .b(new_n1216_), .c(new_n425_), .O(new_n1218_));
  aoi21  g1127(.a(new_n1215_), .b(new_n165_), .c(new_n1218_), .O(new_n1219_));
  nand2  g1128(.a(new_n1202_), .b(new_n93_), .O(new_n1220_));
  oai21  g1129(.a(new_n152_), .b(new_n1022_), .c(new_n1220_), .O(new_n1221_));
  nand3  g1130(.a(new_n1221_), .b(new_n167_), .c(new_n107_), .O(new_n1222_));
  oai21  g1131(.a(new_n1219_), .b(x64), .c(new_n1222_), .O(new_n1223_));
  nand2  g1132(.a(new_n1223_), .b(new_n194_), .O(new_n1224_));
