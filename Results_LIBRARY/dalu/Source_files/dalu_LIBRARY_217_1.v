// Benchmark "FAU" written by ABC on Wed Jul  1 03:49:48 2020
...
module FAU ( 
  ...
  oai21  g0975(.a(x71), .b(new_n154_), .c(new_n102_), .O(new_n1067_));
  aoi22  g0976(.a(new_n1067_), .b(x13), .c(new_n126_), .d(x69), .O(new_n1068_));
  aoi21  g0977(.a(new_n1068_), .b(new_n1066_), .c(new_n131_), .O(new_n1069_));
  oai21  g0978(.a(new_n1031_), .b(new_n1026_), .c(new_n141_), .O(new_n1070_));
  oai21  g0979(.a(x71), .b(x70), .c(x29), .O(new_n1071_));
  nand2  g0980(.a(new_n1071_), .b(new_n142_), .O(new_n1072_));
  aoi22  g0981(.a(new_n1072_), .b(new_n208_), .c(new_n1051_), .d(new_n143_), .O(new_n1073_));
  aoi21  g0982(.a(new_n1073_), .b(new_n1070_), .c(new_n838_), .O(new_n1074_));
  oai21  g0983(.a(new_n1074_), .b(new_n1069_), .c(new_n137_), .O(new_n1075_));
  nor2   g0984(.a(new_n1020_), .b(new_n1014_), .O(new_n1076_));
  nand2  g0985(.a(new_n208_), .b(x61), .O(new_n1077_));
  aoi21  g0986(.a(new_n1077_), .b(new_n1076_), .c(x67), .O(new_n1078_));
  nor2   g0987(.a(new_n131_), .b(new_n321_), .O(new_n1079_));
  oai21  g0988(.a(new_n1079_), .b(new_n1078_), .c(new_n368_), .O(new_n1080_));
  nand2  g0989(.a(new_n1080_), .b(new_n1075_), .O(new_n1081_));
  nand2  g0990(.a(new_n1068_), .b(new_n1066_), .O(new_n1082_));
  nand2  g0991(.a(new_n1082_), .b(new_n137_), .O(new_n1083_));
  nand3  g0992(.a(new_n164_), .b(x68), .c(x45), .O(new_n1084_));
  aoi21  g0993(.a(new_n1084_), .b(new_n1083_), .c(new_n373_), .O(new_n1085_));
  aoi21  g0994(.a(new_n1081_), .b(new_n150_), .c(new_n1085_), .O(new_n1086_));
  ...
  nand2  g1072(.a(new_n1072_), .b(x74), .O(new_n1164_));
  ...
  nand2  g1116(.a(new_n1072_), .b(new_n210_), .O(new_n1208_));
