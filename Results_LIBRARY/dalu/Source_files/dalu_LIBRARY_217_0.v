...
module FAU ( 
  ...
  nand2  g0972(.a(new_n157_), .b(x13), .O(new_n1064_));
  nand3  g0973(.a(new_n126_), .b(x69), .c(x61), .O(new_n1065_));
  nand3  g0974(.a(new_n1065_), .b(new_n1064_), .c(new_n1063_), .O(new_n1066_));
  and2   g0975(.a(new_n1066_), .b(x67), .O(new_n1067_));
  nand2  g0976(.a(new_n1031_), .b(new_n141_), .O(new_n1068_));
  and2   g0977(.a(new_n209_), .b(x61), .O(new_n1069_));
  oai21  g0978(.a(new_n1069_), .b(new_n1049_), .c(new_n142_), .O(new_n1070_));
  aoi21  g0979(.a(new_n1070_), .b(new_n1068_), .c(new_n834_), .O(new_n1071_));
  oai21  g0980(.a(new_n1071_), .b(new_n1067_), .c(new_n137_), .O(new_n1072_));
  and2   g0981(.a(new_n1017_), .b(new_n131_), .O(new_n1073_));
  nor2   g0982(.a(new_n131_), .b(new_n321_), .O(new_n1074_));
  oai21  g0983(.a(new_n1074_), .b(new_n1073_), .c(new_n367_), .O(new_n1075_));
  nand2  g0984(.a(new_n1075_), .b(new_n1072_), .O(new_n1076_));
  nand2  g0985(.a(new_n1066_), .b(new_n137_), .O(new_n1077_));
  nand3  g0986(.a(new_n163_), .b(x68), .c(x45), .O(new_n1078_));
  aoi21  g0987(.a(new_n1078_), .b(new_n1077_), .c(new_n372_), .O(new_n1079_));
  aoi21  g0988(.a(new_n1076_), .b(new_n149_), .c(new_n1079_), .O(new_n1080_));
