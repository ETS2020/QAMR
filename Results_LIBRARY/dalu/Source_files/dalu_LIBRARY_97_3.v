// Benchmark "FAU" written by ABC on Wed Jul  1 03:45:11 2020
...
module FAU ( 
  ...
  inv1   g0908(.a(new_n177_), .O(new_n1000_));
  nand3  g0909(.a(new_n1000_), .b(new_n308_), .c(x00), .O(new_n1001_));
  oai21  g0910(.a(new_n177_), .b(new_n96_), .c(x13), .O(new_n1002_));
  aoi21  g0911(.a(new_n1002_), .b(new_n1001_), .c(new_n101_), .O(new_n1003_));
  nand2  g0912(.a(new_n1003_), .b(new_n134_), .O(new_n1004_));
  and2   g0913(.a(new_n208_), .b(x61), .O(new_n1005_));
  aoi21  g0914(.a(new_n856_), .b(new_n855_), .c(x73), .O(new_n1006_));
  nand3  g0915(.a(new_n206_), .b(x73), .c(x53), .O(new_n1007_));
  ...
  nand2  g0919(.a(new_n206_), .b(x59), .O(new_n1011_));
  aoi21  g0920(.a(new_n1011_), .b(new_n1010_), .c(new_n205_), .O(new_n1012_));
  nand3  g0921(.a(x74), .b(new_n205_), .c(x60), .O(new_n1013_));
  inv1   g0922(.a(new_n1013_), .O(new_n1014_));
  oai21  g0923(.a(new_n1014_), .b(new_n1012_), .c(new_n204_), .O(new_n1015_));
  nand2  g0924(.a(new_n1015_), .b(new_n1009_), .O(new_n1016_));
  aoi21  g0925(.a(new_n1016_), .b(new_n101_), .c(new_n1005_), .O(new_n1017_));
  oai21  g0926(.a(new_n1017_), .b(new_n134_), .c(new_n1004_), .O(new_n1018_));
  nand2  g0927(.a(x74), .b(x26), .O(new_n1019_));
  nand2  g0928(.a(new_n206_), .b(x27), .O(new_n1020_));
  aoi21  g0929(.a(new_n1020_), .b(new_n1019_), .c(new_n205_), .O(new_n1021_));
  nand3  g0930(.a(x74), .b(new_n205_), .c(x28), .O(new_n1022_));
  inv1   g0931(.a(new_n1022_), .O(new_n1023_));
  oai21  g0932(.a(new_n1023_), .b(new_n1021_), .c(new_n204_), .O(new_n1024_));
  nand2  g0933(.a(new_n208_), .b(x29), .O(new_n1025_));
  aoi21  g0934(.a(new_n872_), .b(new_n871_), .c(x73), .O(new_n1026_));
  nand3  g0935(.a(new_n206_), .b(x73), .c(x21), .O(new_n1027_));
  inv1   g0936(.a(new_n1027_), .O(new_n1028_));
  oai21  g0937(.a(new_n1028_), .b(new_n1026_), .c(x72), .O(new_n1029_));
  nand3  g0938(.a(new_n1029_), .b(new_n1025_), .c(new_n1024_), .O(new_n1030_));
  inv1   g0939(.a(new_n1030_), .O(new_n1031_));
  nor2   g0940(.a(new_n1031_), .b(new_n799_), .O(new_n1032_));
  aoi21  g0941(.a(new_n1018_), .b(new_n140_), .c(new_n1032_), .O(new_n1033_));
  nand2  g0942(.a(new_n1030_), .b(new_n101_), .O(new_n1034_));
  nand2  g0943(.a(new_n1016_), .b(x71), .O(new_n1035_));
  aoi21  g0944(.a(new_n1035_), .b(new_n1034_), .c(new_n147_), .O(new_n1036_));
  inv1   g0945(.a(new_n190_), .O(new_n1037_));
  nand3  g0946(.a(new_n1037_), .b(new_n319_), .c(x32), .O(new_n1038_));
  oai21  g0947(.a(new_n190_), .b(new_n112_), .c(x45), .O(new_n1039_));
  aoi21  g0948(.a(new_n1039_), .b(new_n1038_), .c(x71), .O(new_n1040_));
  nand2  g0949(.a(new_n1040_), .b(new_n816_), .O(new_n1041_));
  inv1   g0950(.a(new_n1041_), .O(new_n1042_));
  oai21  g0951(.a(new_n1042_), .b(new_n1036_), .c(x70), .O(new_n1043_));
  oai21  g0952(.a(new_n1033_), .b(x70), .c(new_n1043_), .O(new_n1044_));
  nand2  g0953(.a(new_n1003_), .b(new_n117_), .O(new_n1045_));
  nand2  g0954(.a(new_n1040_), .b(x70), .O(new_n1046_));
  aoi21  g0955(.a(new_n1046_), .b(new_n1045_), .c(new_n226_), .O(new_n1047_));
  aoi21  g0956(.a(new_n1044_), .b(new_n94_), .c(new_n1047_), .O(new_n1048_));
  inv1   g0957(.a(x29), .O(new_n1049_));
  oai22  g0958(.a(new_n156_), .b(new_n1049_), .c(new_n101_), .d(new_n319_), .O(new_n1050_));
  nand2  g0959(.a(new_n1050_), .b(x70), .O(new_n1051_));
  nand2  g0960(.a(new_n159_), .b(x13), .O(new_n1052_));
  nand3  g0961(.a(new_n117_), .b(x69), .c(x61), .O(new_n1053_));
  nand3  g0962(.a(new_n1053_), .b(new_n1052_), .c(new_n1051_), .O(new_n1054_));
  and2   g0963(.a(new_n1054_), .b(x67), .O(new_n1055_));
  nand2  g0964(.a(new_n1030_), .b(new_n143_), .O(new_n1056_));
  nand3  g0965(.a(new_n1016_), .b(x71), .c(x70), .O(new_n1057_));
  aoi21  g0966(.a(new_n1057_), .b(new_n1056_), .c(new_n833_), .O(new_n1058_));
  oai21  g0967(.a(new_n1058_), .b(new_n1055_), .c(new_n139_), .O(new_n1059_));
  nor2   g0968(.a(x71), .b(new_n133_), .O(new_n1060_));
  nand2  g0969(.a(new_n1060_), .b(x45), .O(new_n1061_));
  oai21  g0970(.a(new_n1017_), .b(x67), .c(new_n1061_), .O(new_n1062_));
  nand2  g0971(.a(new_n140_), .b(new_n117_), .O(new_n1063_));
  inv1   g0972(.a(new_n1063_), .O(new_n1064_));
  nand2  g0973(.a(new_n1064_), .b(new_n1062_), .O(new_n1065_));
  aoi21  g0974(.a(new_n1065_), .b(new_n1059_), .c(x66), .O(new_n1066_));
  nand2  g0975(.a(new_n1054_), .b(new_n139_), .O(new_n1067_));
  nand3  g0976(.a(new_n165_), .b(x68), .c(x45), .O(new_n1068_));
  aoi21  g0977(.a(new_n1068_), .b(new_n1067_), .c(new_n372_), .O(new_n1069_));
  oai21  g0978(.a(new_n1069_), .b(new_n1066_), .c(new_n173_), .O(new_n1070_));
  oai21  g0979(.a(new_n1048_), .b(x64), .c(new_n1070_), .O(z13));
  nand2  g0980(.a(x15), .b(x00), .O(new_n1072_));
  xor2a  g0981(.a(new_n1072_), .b(x14), .O(new_n1073_));
  nor2   g0982(.a(new_n1073_), .b(new_n101_), .O(new_n1074_));
  nand2  g0983(.a(new_n1074_), .b(new_n134_), .O(new_n1075_));
  nand2  g0984(.a(x74), .b(x59), .O(new_n1076_));
  nand2  g0985(.a(new_n206_), .b(x60), .O(new_n1077_));
  aoi21  g0986(.a(new_n1077_), .b(new_n1076_), .c(x72), .O(new_n1078_));
  nand3  g0987(.a(new_n206_), .b(x72), .c(x54), .O(new_n1079_));
  inv1   g0988(.a(new_n1079_), .O(new_n1080_));
  oai21  g0989(.a(new_n1080_), .b(new_n1078_), .c(x73), .O(new_n1081_));
  nor2   g0990(.a(x73), .b(new_n204_), .O(new_n1082_));
  aoi22  g0991(.a(new_n1082_), .b(new_n937_), .c(new_n208_), .d(x62), .O(new_n1083_));
  nand2  g0992(.a(new_n1083_), .b(new_n1081_), .O(new_n1084_));
  nand3  g0993(.a(new_n268_), .b(new_n204_), .c(x61), .O(new_n1085_));
  inv1   g0994(.a(new_n1085_), .O(new_n1086_));
  aoi21  g0995(.a(new_n1084_), .b(new_n101_), .c(new_n1086_), .O(new_n1087_));
  oai21  g0996(.a(new_n1087_), .b(new_n134_), .c(new_n1075_), .O(new_n1088_));
  nand2  g0997(.a(x74), .b(x27), .O(new_n1089_));
  nand2  g0998(.a(new_n206_), .b(x28), .O(new_n1090_));
  aoi21  g0999(.a(new_n1090_), .b(new_n1089_), .c(new_n205_), .O(new_n1091_));
  nand3  g1000(.a(x74), .b(new_n205_), .c(x29), .O(new_n1092_));
  inv1   g1001(.a(new_n1092_), .O(new_n1093_));
  oai21  g1002(.a(new_n1093_), .b(new_n1091_), .c(new_n204_), .O(new_n1094_));
  nand2  g1003(.a(new_n208_), .b(x30), .O(new_n1095_));
  nand2  g1004(.a(new_n206_), .b(x26), .O(new_n1096_));
  aoi21  g1005(.a(new_n1096_), .b(new_n950_), .c(x73), .O(new_n1097_));
  nand3  g1006(.a(new_n206_), .b(x73), .c(x22), .O(new_n1098_));
  ...
  nor2   g1011(.a(new_n1102_), .b(new_n799_), .O(new_n1103_));
  aoi21  g1012(.a(new_n1088_), .b(new_n140_), .c(new_n1103_), .O(new_n1104_));
  nand2  g1013(.a(new_n937_), .b(x71), .O(new_n1105_));
  nand2  g1014(.a(new_n951_), .b(new_n101_), .O(new_n1106_));
  aoi21  g1015(.a(new_n1106_), .b(new_n1105_), .c(new_n204_), .O(new_n1107_));
  nor2   g1016(.a(new_n206_), .b(x72), .O(new_n1108_));
  nand3  g1017(.a(new_n1108_), .b(new_n101_), .c(x29), .O(new_n1109_));
  inv1   g1018(.a(new_n1109_), .O(new_n1110_));
  oai21  g1019(.a(new_n1110_), .b(new_n1107_), .c(new_n205_), .O(new_n1111_));
  ...
  nand2  g1025(.a(x72), .b(x54), .O(new_n1117_));
  oai21  g1026(.a(x72), .b(new_n1116_), .c(new_n1117_), .O(new_n1118_));
  nand2  g1027(.a(new_n1118_), .b(x71), .O(new_n1119_));
  nand2  g1028(.a(x72), .b(x22), .O(new_n1120_));
  oai21  g1029(.a(x72), .b(new_n961_), .c(new_n1120_), .O(new_n1121_));
  nand2  g1030(.a(new_n1121_), .b(new_n101_), .O(new_n1122_));
  aoi21  g1031(.a(new_n1122_), .b(new_n1119_), .c(x74), .O(new_n1123_));
  and2   g1032(.a(new_n887_), .b(new_n1108_), .O(new_n1124_));
  oai21  g1033(.a(new_n1124_), .b(new_n1123_), .c(x73), .O(new_n1125_));
  nand3  g1034(.a(new_n1125_), .b(new_n1115_), .c(new_n1111_), .O(new_n1126_));
  nand2  g1035(.a(new_n1126_), .b(new_n219_), .O(new_n1127_));
  nand2  g1036(.a(x47), .b(x32), .O(new_n1128_));
  xor2a  g1037(.a(new_n1128_), .b(x46), .O(new_n1129_));
  nor2   g1038(.a(new_n1129_), .b(x71), .O(new_n1130_));
  nand2  g1039(.a(new_n1130_), .b(new_n816_), .O(new_n1131_));
  nand2  g1040(.a(new_n1131_), .b(new_n1127_), .O(new_n1132_));
  nand2  g1041(.a(new_n1132_), .b(x70), .O(new_n1133_));
  oai21  g1042(.a(new_n1104_), .b(x70), .c(new_n1133_), .O(new_n1134_));
  nand2  g1043(.a(new_n1074_), .b(new_n117_), .O(new_n1135_));
  ...
  nand2  g1047(.a(x71), .b(x46), .O(new_n1139_));
  oai21  g1048(.a(new_n156_), .b(new_n1112_), .c(new_n1139_), .O(new_n1140_));
  nand2  g1049(.a(new_n1140_), .b(x70), .O(new_n1141_));
  nand2  g1050(.a(new_n159_), .b(x14), .O(new_n1142_));
  nand3  g1051(.a(new_n128_), .b(x69), .c(x62), .O(new_n1143_));
  nand3  g1052(.a(new_n1143_), .b(new_n1142_), .c(new_n1141_), .O(new_n1144_));
  and2   g1053(.a(new_n1144_), .b(x67), .O(new_n1145_));
  nand2  g1054(.a(new_n1101_), .b(new_n143_), .O(new_n1146_));
  nand2  g1055(.a(new_n1084_), .b(new_n144_), .O(new_n1147_));
  aoi21  g1056(.a(new_n1147_), .b(new_n1146_), .c(new_n833_), .O(new_n1148_));
  oai21  g1057(.a(new_n1148_), .b(new_n1145_), .c(new_n139_), .O(new_n1149_));
  nand2  g1058(.a(new_n1060_), .b(x46), .O(new_n1150_));
  oai21  g1059(.a(new_n1087_), .b(x67), .c(new_n1150_), .O(new_n1151_));
  nand2  g1060(.a(new_n1151_), .b(new_n1064_), .O(new_n1152_));
  aoi21  g1061(.a(new_n1152_), .b(new_n1149_), .c(x66), .O(new_n1153_));
  nand2  g1062(.a(new_n1144_), .b(new_n139_), .O(new_n1154_));
  nand3  g1063(.a(new_n165_), .b(x68), .c(x46), .O(new_n1155_));
  aoi21  g1064(.a(new_n1155_), .b(new_n1154_), .c(new_n372_), .O(new_n1156_));
  oai21  g1065(.a(new_n1156_), .b(new_n1153_), .c(new_n173_), .O(new_n1157_));
  oai21  g1066(.a(new_n1138_), .b(x64), .c(new_n1157_), .O(z14));
  nand2  g1067(.a(x74), .b(x28), .O(new_n1159_));
  nand2  g1068(.a(new_n206_), .b(x29), .O(new_n1160_));
  aoi21  g1069(.a(new_n1160_), .b(new_n1159_), .c(new_n205_), .O(new_n1161_));
  nand3  g1070(.a(x74), .b(new_n205_), .c(x30), .O(new_n1162_));
  inv1   g1071(.a(new_n1162_), .O(new_n1163_));
  oai21  g1072(.a(new_n1163_), .b(new_n1161_), .c(new_n204_), .O(new_n1164_));
  nand2  g1073(.a(new_n208_), .b(x31), .O(new_n1165_));
  aoi21  g1074(.a(new_n1020_), .b(new_n1019_), .c(x73), .O(new_n1166_));
  nand3  g1075(.a(new_n206_), .b(x73), .c(x23), .O(new_n1167_));
  ...
  nand2  g1079(.a(new_n1170_), .b(new_n143_), .O(new_n1171_));
  inv1   g1080(.a(x62), .O(new_n1172_));
  nand2  g1081(.a(x73), .b(x60), .O(new_n1173_));
  oai21  g1082(.a(x73), .b(new_n1172_), .c(new_n1173_), .O(new_n1174_));
  nand2  g1083(.a(new_n1174_), .b(new_n204_), .O(new_n1175_));
  nand3  g1084(.a(new_n205_), .b(x72), .c(x58), .O(new_n1176_));
  aoi21  g1085(.a(new_n1176_), .b(new_n1175_), .c(new_n206_), .O(new_n1177_));
  nand2  g1086(.a(new_n208_), .b(x63), .O(new_n1178_));
  inv1   g1087(.a(x59), .O(new_n1179_));
  nand2  g1088(.a(x73), .b(x55), .O(new_n1180_));
  oai21  g1089(.a(x73), .b(new_n1179_), .c(new_n1180_), .O(new_n1181_));
  nand2  g1090(.a(new_n1181_), .b(new_n211_), .O(new_n1182_));
  nand2  g1091(.a(new_n1182_), .b(new_n1178_), .O(new_n1183_));
  oai21  g1092(.a(new_n1183_), .b(new_n1177_), .c(new_n144_), .O(new_n1184_));
  nand2  g1093(.a(new_n1184_), .b(new_n1171_), .O(new_n1185_));
  nand3  g1094(.a(new_n1185_), .b(x69), .c(new_n139_), .O(new_n1186_));
  oai21  g1095(.a(new_n1183_), .b(new_n1177_), .c(new_n101_), .O(new_n1187_));
  nand3  g1096(.a(new_n770_), .b(new_n204_), .c(x61), .O(new_n1188_));
  nand2  g1097(.a(new_n1188_), .b(new_n1187_), .O(new_n1189_));
  nand2  g1098(.a(new_n1189_), .b(new_n1064_), .O(new_n1190_));
  aoi21  g1099(.a(new_n1190_), .b(new_n1186_), .c(new_n134_), .O(new_n1191_));
  aoi22  g1100(.a(new_n118_), .b(x47), .c(new_n102_), .d(x15), .O(new_n1192_));
  nor2   g1101(.a(new_n1192_), .b(new_n141_), .O(new_n1193_));
  nand2  g1102(.a(new_n1193_), .b(new_n134_), .O(new_n1194_));
  inv1   g1103(.a(new_n1194_), .O(new_n1195_));
  oai21  g1104(.a(new_n1195_), .b(new_n1191_), .c(new_n94_), .O(new_n1196_));
  nand2  g1105(.a(new_n1193_), .b(new_n137_), .O(new_n1197_));
  nand2  g1106(.a(new_n1197_), .b(new_n1196_), .O(new_n1198_));
  nand2  g1107(.a(new_n1198_), .b(new_n92_), .O(new_n1199_));
  inv1   g1108(.a(x31), .O(new_n1200_));
  nand2  g1109(.a(x71), .b(x47), .O(new_n1201_));
  oai21  g1110(.a(new_n156_), .b(new_n1200_), .c(new_n1201_), .O(new_n1202_));
  nand2  g1111(.a(new_n1202_), .b(x70), .O(new_n1203_));
  nand2  g1112(.a(new_n159_), .b(x15), .O(new_n1204_));
  nand3  g1113(.a(new_n128_), .b(x69), .c(x63), .O(new_n1205_));
  nand3  g1114(.a(new_n1205_), .b(new_n1204_), .c(new_n1203_), .O(new_n1206_));
  nand2  g1115(.a(new_n1206_), .b(x67), .O(new_n1207_));
  nand3  g1116(.a(new_n1185_), .b(x69), .c(new_n133_), .O(new_n1208_));
  nand2  g1117(.a(new_n1208_), .b(new_n1207_), .O(new_n1209_));
  nand2  g1118(.a(new_n1209_), .b(new_n139_), .O(new_n1210_));
  aoi21  g1119(.a(new_n1188_), .b(new_n1187_), .c(x67), .O(new_n1211_));
  nand2  g1120(.a(new_n1060_), .b(x47), .O(new_n1212_));
  inv1   g1121(.a(new_n1212_), .O(new_n1213_));
  oai21  g1122(.a(new_n1213_), .b(new_n1211_), .c(new_n1064_), .O(new_n1214_));
  aoi21  g1123(.a(new_n1214_), .b(new_n1210_), .c(x66), .O(new_n1215_));
  nand2  g1124(.a(new_n1206_), .b(new_n139_), .O(new_n1216_));
  nand3  g1125(.a(new_n165_), .b(x68), .c(x47), .O(new_n1217_));
  aoi21  g1126(.a(new_n1217_), .b(new_n1216_), .c(new_n372_), .O(new_n1218_));
  oai21  g1127(.a(new_n1218_), .b(new_n1215_), .c(new_n173_), .O(new_n1219_));
  nand2  g1128(.a(new_n1219_), .b(new_n1199_), .O(z15));
endmodule
