...
module FAU ( 
  ...
  nand3  g219(.a(new_n349_), .b(new_n264_), .c(new_n286_), .O(new_n350_));
  ...
  nand4  g355(.a(new_n349_), .b(new_n264_), .c(new_n289_), .d(new_n286_), .O(new_n486_));
  inv1   g356(.a(new_n486_), .O(new_n487_));
  nand3  g357(.a(new_n487_), .b(new_n379_), .c(new_n290_), .O(new_n488_));
  ...
  nor2   g379(.a(new_n509_), .b(new_n486_), .O(z33));
  ...
  nor4   g525(.a(new_n486_), .b(new_n484_), .c(x43), .d(new_n314_), .O(z59));
