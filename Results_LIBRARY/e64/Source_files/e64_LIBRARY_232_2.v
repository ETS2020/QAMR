// Benchmark "FAU" written by ABC on Thu Jun 25 18:56:03 2020
...
module FAU ( 
  ...
  nor2   g118(.a(x37), .b(x35), .O(new_n249_));
  ...
  nand2  g122(.a(new_n252_), .b(new_n196_), .O(new_n253_));
  nor2   g123(.a(x45), .b(x44), .O(new_n254_));
  nand2  g124(.a(new_n254_), .b(new_n160_), .O(new_n255_));
  nor2   g125(.a(new_n255_), .b(new_n253_), .O(new_n256_));
  nand4  g126(.a(new_n256_), .b(new_n251_), .c(new_n244_), .d(new_n241_), .O(new_n257_));
  ...
  nor2   g131(.a(new_n155_), .b(x28), .O(new_n262_));
  ...
  inv1   g137(.a(new_n253_), .O(new_n268_));
  nand2  g138(.a(new_n238_), .b(new_n237_), .O(new_n269_));
  ...
  nor2   g143(.a(new_n273_), .b(new_n247_), .O(new_n274_));
  nand4  g144(.a(new_n274_), .b(new_n271_), .c(new_n268_), .d(new_n267_), .O(new_n275_));
  nor2   g145(.a(new_n275_), .b(new_n266_), .O(z03));
  ...
  nor3   g163(.a(new_n293_), .b(x39), .c(new_n245_), .O(new_n294_));
  nor2   g164(.a(x46), .b(x45), .O(new_n295_));
  nand2  g165(.a(new_n295_), .b(new_n252_), .O(new_n296_));
  ...
  nand3  g172(.a(new_n263_), .b(x29), .c(new_n154_), .O(new_n303_));
  ...
  nand2  g177(.a(new_n307_), .b(new_n260_), .O(new_n308_));
  nand2  g178(.a(new_n259_), .b(new_n248_), .O(new_n309_));
  ...
  nor2   g183(.a(new_n313_), .b(new_n253_), .O(new_n314_));
  ...
  inv1   g190(.a(new_n164_), .O(new_n321_));
  nand3  g191(.a(new_n133_), .b(new_n191_), .c(new_n145_), .O(new_n322_));
  inv1   g192(.a(new_n322_), .O(new_n323_));
  nor2   g193(.a(x46), .b(x43), .O(new_n324_));
  nand2  g194(.a(new_n324_), .b(new_n136_), .O(new_n325_));
  ...
  nand4  g198(.a(new_n328_), .b(new_n169_), .c(x06), .d(new_n141_), .O(new_n329_));
  nor2   g199(.a(x15), .b(x14), .O(new_n330_));
  nand2  g200(.a(new_n330_), .b(new_n175_), .O(new_n331_));
  nor4   g201(.a(new_n331_), .b(new_n329_), .c(new_n327_), .d(new_n157_), .O(z12));
  ...
  nand3  g207(.a(new_n337_), .b(new_n336_), .c(new_n177_), .O(new_n338_));
  nor2   g208(.a(new_n338_), .b(new_n335_), .O(new_n339_));
  inv1   g209(.a(x40), .O(new_n340_));
  nand3  g210(.a(new_n162_), .b(x41), .c(new_n340_), .O(new_n341_));
  nor2   g211(.a(new_n341_), .b(new_n157_), .O(new_n342_));
  ...
  nand4  g216(.a(new_n346_), .b(new_n262_), .c(new_n280_), .d(new_n277_), .O(new_n347_));
  nor4   g217(.a(new_n347_), .b(x58), .c(new_n345_), .d(x43), .O(z14));
  nor2   g218(.a(x58), .b(x43), .O(new_n349_));
  nand2  g219(.a(new_n349_), .b(new_n284_), .O(new_n350_));
  nand4  g220(.a(new_n154_), .b(new_n277_), .c(new_n219_), .d(x10), .O(new_n351_));
  ...
  nand2  g227(.a(new_n289_), .b(new_n191_), .O(new_n358_));
  inv1   g228(.a(x56), .O(new_n359_));
  nand3  g229(.a(new_n196_), .b(new_n359_), .c(new_n345_), .O(new_n360_));
  nor2   g230(.a(new_n360_), .b(new_n358_), .O(new_n361_));
  nand4  g231(.a(new_n361_), .b(new_n357_), .c(new_n355_), .d(new_n339_), .O(new_n362_));
  inv1   g232(.a(new_n362_), .O(z16));
  nand2  g233(.a(new_n334_), .b(new_n177_), .O(new_n364_));
  nand3  g234(.a(new_n337_), .b(new_n210_), .c(x03), .O(new_n365_));
  ...
  nand2  g244(.a(new_n374_), .b(new_n307_), .O(new_n375_));
  nand2  g245(.a(new_n262_), .b(new_n175_), .O(new_n376_));
  nor2   g246(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand3  g247(.a(new_n133_), .b(x62), .c(new_n145_), .O(new_n378_));
  nor2   g248(.a(new_n378_), .b(new_n325_), .O(new_n379_));
  ...
  nand3  g256(.a(new_n330_), .b(new_n386_), .c(new_n385_), .O(new_n387_));
  ...
  nor2   g260(.a(new_n390_), .b(new_n303_), .O(new_n391_));
  nand2  g261(.a(new_n312_), .b(new_n196_), .O(new_n392_));
  nand2  g262(.a(new_n311_), .b(new_n307_), .O(new_n393_));
  ...
  nand2  g267(.a(new_n252_), .b(new_n187_), .O(new_n398_));
  nor2   g268(.a(new_n398_), .b(new_n397_), .O(new_n399_));
  nand2  g269(.a(new_n289_), .b(new_n146_), .O(new_n400_));
  inv1   g270(.a(new_n400_), .O(new_n401_));
  nand2  g271(.a(new_n401_), .b(new_n239_), .O(new_n402_));
  inv1   g272(.a(new_n402_), .O(new_n403_));
  nand4  g273(.a(new_n403_), .b(new_n399_), .c(new_n396_), .d(new_n382_), .O(new_n404_));
  nor2   g274(.a(new_n404_), .b(new_n237_), .O(z19));
  inv1   g275(.a(new_n142_), .O(new_n406_));
  nor2   g276(.a(x07), .b(x06), .O(new_n407_));
  nand2  g277(.a(new_n337_), .b(new_n407_), .O(new_n408_));
  inv1   g278(.a(new_n408_), .O(new_n409_));
  nand2  g279(.a(new_n409_), .b(new_n406_), .O(new_n410_));
  inv1   g280(.a(new_n410_), .O(new_n411_));
  nand2  g281(.a(new_n230_), .b(new_n174_), .O(new_n412_));
  nor4   g282(.a(new_n412_), .b(new_n364_), .c(new_n279_), .d(x30), .O(new_n413_));
  nand2  g283(.a(new_n413_), .b(new_n411_), .O(new_n414_));
  nand3  g284(.a(new_n136_), .b(new_n359_), .c(x51), .O(new_n415_));
  nor2   g285(.a(new_n415_), .b(new_n358_), .O(new_n416_));
  nand4  g286(.a(new_n416_), .b(new_n324_), .c(new_n163_), .d(new_n162_), .O(new_n417_));
  nor2   g287(.a(new_n417_), .b(new_n414_), .O(z20));
  nor2   g288(.a(x43), .b(x41), .O(new_n419_));
  nand2  g289(.a(new_n419_), .b(new_n307_), .O(new_n420_));
  inv1   g290(.a(new_n420_), .O(new_n421_));
  nand2  g291(.a(new_n374_), .b(new_n262_), .O(new_n422_));
  inv1   g292(.a(new_n422_), .O(new_n423_));
  nand3  g293(.a(new_n423_), .b(new_n421_), .c(new_n361_), .O(new_n424_));
  nor2   g294(.a(new_n412_), .b(new_n364_), .O(new_n425_));
  nand4  g295(.a(new_n425_), .b(new_n409_), .c(new_n141_), .d(x00), .O(new_n426_));
  nor2   g296(.a(new_n426_), .b(new_n424_), .O(z21));
  inv1   g297(.a(new_n330_), .O(new_n428_));
  nor2   g298(.a(new_n428_), .b(new_n217_), .O(new_n429_));
  nand3  g299(.a(new_n429_), .b(new_n386_), .c(new_n385_), .O(new_n430_));
  nor3   g300(.a(new_n240_), .b(new_n138_), .c(new_n134_), .O(new_n431_));
  inv1   g301(.a(new_n383_), .O(new_n432_));
  nand2  g302(.a(new_n262_), .b(new_n230_), .O(new_n433_));
  nor2   g303(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  nand3  g304(.a(new_n389_), .b(new_n246_), .c(x36), .O(new_n435_));
  nand2  g305(.a(new_n263_), .b(new_n259_), .O(new_n436_));
  nor2   g306(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  nor2   g307(.a(new_n296_), .b(new_n293_), .O(new_n438_));
  ...
  inv1   g311(.a(new_n293_), .O(new_n442_));
  nor2   g312(.a(x39), .b(x36), .O(new_n443_));
  nand2  g313(.a(new_n443_), .b(new_n389_), .O(new_n444_));
  inv1   g314(.a(new_n444_), .O(new_n445_));
  nand2  g315(.a(new_n445_), .b(new_n442_), .O(new_n446_));
  nor2   g316(.a(new_n446_), .b(new_n298_), .O(new_n447_));
  nand2  g317(.a(new_n385_), .b(x16), .O(new_n448_));
  nand3  g318(.a(new_n174_), .b(new_n304_), .c(new_n225_), .O(new_n449_));
  ...
  nand3  g323(.a(new_n346_), .b(new_n277_), .c(x11), .O(new_n454_));
  nand3  g324(.a(new_n289_), .b(new_n345_), .c(new_n159_), .O(new_n455_));
  nor4   g325(.a(new_n455_), .b(new_n454_), .c(new_n376_), .d(new_n354_), .O(z24));
  nand2  g326(.a(new_n346_), .b(new_n277_), .O(new_n457_));
  nand4  g327(.a(new_n355_), .b(new_n262_), .c(new_n333_), .d(x24), .O(new_n458_));
  nor3   g328(.a(new_n458_), .b(new_n455_), .c(new_n457_), .O(z25));
  inv1   g329(.a(new_n222_), .O(new_n460_));
  nand4  g330(.a(new_n312_), .b(new_n311_), .c(new_n307_), .d(new_n260_), .O(new_n461_));
  nor3   g331(.a(new_n461_), .b(new_n253_), .c(new_n236_), .O(new_n462_));
  ...
  nand3  g336(.a(new_n151_), .b(new_n466_), .c(x32), .O(new_n467_));
  nor2   g337(.a(new_n467_), .b(new_n303_), .O(new_n468_));
  nand4  g338(.a(new_n468_), .b(new_n465_), .c(new_n462_), .d(new_n271_), .O(new_n469_));
  nor2   g339(.a(new_n469_), .b(new_n460_), .O(z26));
  nor2   g340(.a(new_n291_), .b(new_n138_), .O(new_n471_));
  nor2   g341(.a(new_n290_), .b(new_n288_), .O(new_n472_));
  and2   g342(.a(new_n472_), .b(new_n471_), .O(new_n473_));
  nor2   g343(.a(new_n444_), .b(new_n436_), .O(new_n474_));
  and2   g344(.a(new_n474_), .b(new_n438_), .O(new_n475_));
  nand2  g345(.a(new_n220_), .b(new_n178_), .O(new_n476_));
  nor3   g346(.a(new_n476_), .b(x14), .c(new_n218_), .O(new_n477_));
  nor3   g347(.a(new_n463_), .b(new_n433_), .c(new_n432_), .O(new_n478_));
  nand4  g348(.a(new_n478_), .b(new_n477_), .c(new_n475_), .d(new_n473_), .O(new_n479_));
  nor2   g349(.a(new_n479_), .b(new_n217_), .O(z27));
  nand2  g350(.a(new_n324_), .b(new_n307_), .O(new_n481_));
  inv1   g351(.a(new_n481_), .O(new_n482_));
  nand4  g352(.a(new_n482_), .b(new_n284_), .c(new_n154_), .d(x25), .O(new_n483_));
  nand2  g353(.a(new_n183_), .b(new_n345_), .O(new_n484_));
  nor4   g354(.a(new_n484_), .b(new_n483_), .c(new_n457_), .d(x60), .O(z28));
  nand2  g355(.a(new_n307_), .b(new_n281_), .O(new_n486_));
  or2    g356(.a(new_n486_), .b(new_n347_), .O(new_n487_));
  nand4  g357(.a(x60), .b(new_n183_), .c(new_n345_), .d(new_n159_), .O(new_n488_));
  nor2   g358(.a(new_n488_), .b(new_n487_), .O(z29));
  nand3  g359(.a(new_n187_), .b(new_n235_), .c(x52), .O(new_n490_));
  nor3   g360(.a(new_n490_), .b(new_n240_), .c(new_n134_), .O(new_n491_));
  nand3  g361(.a(new_n175_), .b(new_n226_), .c(new_n225_), .O(new_n492_));
  nor2   g362(.a(new_n492_), .b(new_n157_), .O(new_n493_));
  nor2   g363(.a(new_n308_), .b(new_n152_), .O(new_n494_));
  nand4  g364(.a(new_n494_), .b(new_n493_), .c(new_n491_), .d(new_n314_), .O(new_n495_));
  nor2   g365(.a(new_n495_), .b(new_n430_), .O(z30));
  and2   g366(.a(new_n472_), .b(new_n399_), .O(new_n497_));
  nand3  g367(.a(new_n175_), .b(new_n154_), .c(new_n153_), .O(new_n498_));
  nor3   g368(.a(new_n498_), .b(x22), .c(new_n225_), .O(new_n499_));
  nand2  g369(.a(new_n260_), .b(new_n151_), .O(new_n500_));
  nor2   g370(.a(new_n500_), .b(new_n243_), .O(new_n501_));
  nand4  g371(.a(new_n501_), .b(new_n499_), .c(new_n497_), .d(new_n394_), .O(new_n502_));
  nor2   g372(.a(new_n502_), .b(new_n430_), .O(z31));
  nand3  g373(.a(new_n183_), .b(new_n345_), .c(x46), .O(new_n504_));
  nor2   g374(.a(new_n504_), .b(new_n487_), .O(z32));
  nand4  g375(.a(new_n349_), .b(new_n345_), .c(new_n340_), .d(x39), .O(new_n506_));
  nor2   g376(.a(new_n506_), .b(new_n347_), .O(z33));
  nor4   g377(.a(new_n428_), .b(new_n282_), .c(new_n279_), .d(new_n183_), .O(z34));
  nand2  g378(.a(new_n187_), .b(new_n184_), .O(new_n509_));
  inv1   g379(.a(new_n509_), .O(new_n510_));
  nand4  g380(.a(new_n510_), .b(new_n419_), .c(new_n401_), .d(new_n196_), .O(new_n511_));
  nand3  g381(.a(new_n169_), .b(new_n167_), .c(x04), .O(new_n512_));
  nor2   g382(.a(new_n512_), .b(new_n142_), .O(new_n513_));
  nor2   g383(.a(new_n372_), .b(new_n176_), .O(new_n514_));
  inv1   g384(.a(new_n249_), .O(new_n515_));
  inv1   g385(.a(new_n307_), .O(new_n516_));
  nor3   g386(.a(new_n516_), .b(new_n515_), .c(new_n157_), .O(new_n517_));
  nand3  g387(.a(new_n517_), .b(new_n514_), .c(new_n513_), .O(new_n518_));
  nor2   g388(.a(new_n518_), .b(new_n511_), .O(z35));
  nand2  g389(.a(new_n196_), .b(new_n187_), .O(new_n520_));
  nor3   g390(.a(new_n520_), .b(new_n420_), .c(new_n515_), .O(new_n521_));
  nand3  g391(.a(new_n289_), .b(new_n191_), .c(x61), .O(new_n522_));
  nor3   g392(.a(new_n522_), .b(x56), .c(x55), .O(new_n523_));
  nand4  g393(.a(new_n523_), .b(new_n521_), .c(new_n413_), .d(new_n411_), .O(new_n524_));
  inv1   g394(.a(new_n524_), .O(z36));
  nand3  g395(.a(new_n443_), .b(new_n442_), .c(new_n249_), .O(new_n526_));
  nor2   g396(.a(new_n526_), .b(new_n298_), .O(new_n527_));
  nor3   g397(.a(new_n492_), .b(x20), .c(new_n223_), .O(new_n528_));
  nand2  g398(.a(new_n248_), .b(new_n150_), .O(new_n529_));
  nor2   g399(.a(new_n529_), .b(new_n157_), .O(new_n530_));
  nand4  g400(.a(new_n530_), .b(new_n528_), .c(new_n527_), .d(new_n292_), .O(new_n531_));
  nor2   g401(.a(new_n531_), .b(new_n460_), .O(z37));
  nand2  g402(.a(new_n407_), .b(new_n203_), .O(new_n533_));
  nor3   g403(.a(new_n533_), .b(new_n142_), .c(x04), .O(new_n534_));
  inv1   g404(.a(new_n498_), .O(new_n535_));
  nand2  g405(.a(new_n535_), .b(new_n174_), .O(new_n536_));
  inv1   g406(.a(new_n536_), .O(new_n537_));
  nand2  g407(.a(new_n249_), .b(new_n156_), .O(new_n538_));
  nor3   g408(.a(new_n538_), .b(new_n516_), .c(x41), .O(new_n539_));
  ...
  nand3  g419(.a(new_n549_), .b(new_n510_), .c(new_n401_), .O(new_n550_));
  ...
  nand3  g424(.a(new_n389_), .b(new_n311_), .c(new_n259_), .O(new_n555_));
  inv1   g425(.a(x51), .O(new_n556_));
  nand2  g426(.a(new_n136_), .b(new_n556_), .O(new_n557_));
  nor3   g427(.a(new_n557_), .b(new_n555_), .c(new_n481_), .O(new_n558_));
  ...
  nand3  g433(.a(new_n249_), .b(new_n563_), .c(x33), .O(new_n564_));
  nor2   g434(.a(new_n564_), .b(new_n393_), .O(new_n565_));
  nand3  g435(.a(new_n133_), .b(new_n132_), .c(new_n556_), .O(new_n566_));
  inv1   g436(.a(new_n566_), .O(new_n567_));
  nand4  g437(.a(new_n567_), .b(new_n565_), .c(new_n326_), .d(new_n148_), .O(new_n568_));
  nor2   g438(.a(new_n568_), .b(new_n562_), .O(z41));
  nand2  g439(.a(new_n396_), .b(new_n382_), .O(new_n570_));
  ...
  nand4  g463(.a(new_n593_), .b(new_n592_), .c(new_n442_), .d(new_n162_), .O(new_n594_));
  nor2   g464(.a(new_n594_), .b(new_n562_), .O(z45));
  inv1   g465(.a(new_n393_), .O(new_n596_));
  nand4  g466(.a(new_n567_), .b(new_n596_), .c(new_n326_), .d(new_n148_), .O(new_n597_));
  ...
  nor2   g470(.a(new_n538_), .b(new_n498_), .O(new_n601_));
  ...
  nand3  g477(.a(new_n374_), .b(new_n246_), .c(new_n607_), .O(new_n608_));
  ...
  nand3  g481(.a(new_n151_), .b(new_n466_), .c(x31), .O(new_n612_));
  ...
  nor2   g496(.a(new_n498_), .b(new_n243_), .O(new_n627_));
  nand4  g497(.a(new_n627_), .b(new_n626_), .c(new_n625_), .d(new_n299_), .O(new_n628_));
  nand2  g498(.a(new_n271_), .b(new_n382_), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(new_n628_), .O(z52));
  nand2  g500(.a(new_n237_), .b(x63), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(new_n404_), .O(z53));
  nor3   g502(.a(new_n358_), .b(x56), .c(new_n132_), .O(new_n633_));
  nand4  g503(.a(new_n633_), .b(new_n521_), .c(new_n413_), .d(new_n411_), .O(new_n634_));
  inv1   g504(.a(new_n634_), .O(z54));
  nor2   g505(.a(x37), .b(new_n607_), .O(new_n636_));
  nand4  g506(.a(new_n636_), .b(new_n542_), .c(new_n421_), .d(new_n323_), .O(new_n637_));
  nor2   g507(.a(new_n637_), .b(new_n414_), .O(z55));
  nand3  g508(.a(new_n220_), .b(x20), .c(new_n385_), .O(new_n639_));
  nor2   g509(.a(new_n639_), .b(new_n492_), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n462_), .c(new_n271_), .d(new_n158_), .O(new_n641_));
  nor2   g511(.a(new_n641_), .b(new_n441_), .O(z56));
  nand4  g512(.a(new_n373_), .b(new_n336_), .c(new_n203_), .d(new_n167_), .O(new_n643_));
  nand3  g513(.a(new_n175_), .b(new_n226_), .c(x18), .O(new_n644_));
  nor4   g514(.a(new_n644_), .b(new_n643_), .c(new_n327_), .d(new_n157_), .O(z57));
  inv1   g515(.a(new_n360_), .O(new_n646_));
  nand3  g516(.a(new_n421_), .b(new_n646_), .c(new_n541_), .O(new_n647_));
  nand3  g517(.a(new_n230_), .b(new_n304_), .c(x22), .O(new_n648_));
  nor4   g518(.a(new_n648_), .b(new_n647_), .c(new_n643_), .d(new_n422_), .O(z58));
  nor4   g519(.a(new_n484_), .b(new_n347_), .c(x43), .d(new_n340_), .O(z59));
  nor3   g520(.a(new_n372_), .b(x08), .c(new_n210_), .O(new_n651_));
  nand2  g521(.a(new_n133_), .b(new_n145_), .O(new_n652_));
  nor2   g522(.a(new_n652_), .b(new_n325_), .O(new_n653_));
  nand3  g523(.a(new_n653_), .b(new_n651_), .c(new_n377_), .O(new_n654_));
  inv1   g524(.a(new_n654_), .O(z60));
  nor2   g525(.a(x10), .b(new_n203_), .O(new_n656_));
  nand4  g526(.a(new_n656_), .b(new_n367_), .c(new_n334_), .d(new_n177_), .O(new_n657_));
  nand3  g527(.a(new_n289_), .b(new_n359_), .c(new_n345_), .O(new_n658_));
  nand2  g528(.a(new_n353_), .b(new_n196_), .O(new_n659_));
  nand2  g529(.a(new_n162_), .b(new_n156_), .O(new_n660_));
  nor4   g530(.a(new_n660_), .b(new_n659_), .c(new_n658_), .d(new_n657_), .O(z61));
  nor2   g531(.a(new_n376_), .b(new_n372_), .O(new_n662_));
  nand2  g532(.a(new_n345_), .b(x47), .O(new_n663_));
  nor2   g533(.a(new_n663_), .b(new_n652_), .O(new_n664_));
  nand4  g534(.a(new_n664_), .b(new_n662_), .c(new_n482_), .d(new_n374_), .O(new_n665_));
  inv1   g535(.a(new_n665_), .O(z62));
  nand4  g536(.a(new_n145_), .b(new_n183_), .c(x56), .d(new_n345_), .O(new_n667_));
  inv1   g537(.a(new_n667_), .O(new_n668_));
  nand4  g538(.a(new_n668_), .b(new_n662_), .c(new_n482_), .d(new_n374_), .O(new_n669_));
  inv1   g539(.a(new_n669_), .O(z63));
  nor2   g540(.a(new_n484_), .b(x60), .O(new_n671_));
  nand4  g541(.a(new_n671_), .b(new_n482_), .c(new_n280_), .d(x30), .O(new_n672_));
  nor3   g542(.a(new_n672_), .b(new_n376_), .c(new_n372_), .O(z64));
