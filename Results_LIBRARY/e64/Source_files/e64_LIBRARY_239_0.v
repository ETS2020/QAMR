...
module FAU ( 
  ...
  wire new_n136_, new_n137_, new_n138_, new_n139_, new_n140_, new_n141_,
    new_n143_, new_n144_, new_n148_, new_n150_, new_n174_, new_n175_;
  ...
  inv1   g15(.a(x14), .O(new_n174_));
  nand2  g16(.a(new_n136_), .b(new_n174_), .O(new_n175_));
  nor2   g17(.a(new_n175_), .b(new_n141_), .O(z34));
  zero   g18(.O(z00));
  zero   g19(.O(z01));
  zero   g20(.O(z02));
  zero   g21(.O(z03));
