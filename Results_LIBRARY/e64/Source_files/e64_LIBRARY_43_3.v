// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:16 2020
...
module FAU ( 
  ...
  inv1   g215(.a(new_n133_), .O(new_n346_));
  nor3   g216(.a(new_n329_), .b(new_n346_), .c(x62), .O(new_n347_));
  ...
  nand4  g237(.a(new_n367_), .b(new_n362_), .c(new_n360_), .d(new_n343_), .O(new_n368_));
  ...
  nor4   g254(.a(new_n329_), .b(new_n346_), .c(new_n192_), .d(x60), .O(new_n385_));
  nand4  g255(.a(new_n385_), .b(new_n384_), .c(new_n379_), .d(new_n167_), .O(new_n386_));
  ...
  nand2  g267(.a(new_n316_), .b(new_n196_), .O(new_n398_));
  nand2  g268(.a(new_n381_), .b(new_n255_), .O(new_n399_));
  ...
  nor4   g286(.a(new_n416_), .b(new_n370_), .c(new_n288_), .d(x30), .O(new_n417_));
  nand2  g287(.a(new_n417_), .b(new_n415_), .O(new_n418_));
  nand3  g288(.a(new_n135_), .b(new_n365_), .c(x51), .O(new_n419_));
  nor2   g289(.a(new_n419_), .b(new_n364_), .O(new_n420_));
  ...
  nand2  g293(.a(new_n423_), .b(new_n381_), .O(new_n424_));
  inv1   g294(.a(new_n424_), .O(new_n425_));
  nand2  g295(.a(new_n380_), .b(new_n264_), .O(new_n426_));
  inv1   g296(.a(new_n426_), .O(new_n427_));
  nand3  g297(.a(new_n427_), .b(new_n425_), .c(new_n367_), .O(new_n428_));
  nor2   g298(.a(new_n416_), .b(new_n370_), .O(new_n429_));
  ...
  nand3  g327(.a(new_n351_), .b(new_n286_), .c(x11), .O(new_n458_));
  nand3  g328(.a(new_n363_), .b(new_n350_), .c(new_n157_), .O(new_n459_));
  nor4   g329(.a(new_n459_), .b(new_n458_), .c(new_n383_), .d(new_n359_), .O(z24));
  nand2  g330(.a(new_n351_), .b(new_n286_), .O(new_n461_));
  nand4  g331(.a(new_n360_), .b(new_n264_), .c(new_n337_), .d(x24), .O(new_n462_));
  nor3   g332(.a(new_n462_), .b(new_n459_), .c(new_n461_), .O(z25));
  inv1   g333(.a(new_n222_), .O(new_n464_));
  nand4  g334(.a(new_n381_), .b(new_n316_), .c(new_n262_), .d(new_n255_), .O(new_n465_));
  ...
  nand2  g351(.a(new_n381_), .b(new_n328_), .O(new_n482_));
  inv1   g352(.a(new_n482_), .O(new_n483_));
  nand4  g353(.a(new_n483_), .b(new_n293_), .c(new_n152_), .d(x25), .O(new_n484_));
  nand2  g354(.a(new_n181_), .b(new_n350_), .O(new_n485_));
  nor4   g355(.a(new_n485_), .b(new_n484_), .c(new_n461_), .d(x60), .O(z28));
  nand2  g356(.a(new_n381_), .b(new_n290_), .O(new_n487_));
  or2    g357(.a(new_n487_), .b(new_n352_), .O(new_n488_));
  nand4  g358(.a(x60), .b(new_n181_), .c(new_n350_), .d(new_n157_), .O(new_n489_));
  ...
  nand4  g365(.a(new_n381_), .b(new_n262_), .c(new_n149_), .d(new_n148_), .O(new_n496_));
  ...
  nand4  g378(.a(new_n354_), .b(new_n350_), .c(new_n314_), .d(x39), .O(new_n509_));
  nor2   g379(.a(new_n509_), .b(new_n352_), .O(z33));
  nor4   g380(.a(new_n432_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  nand2  g381(.a(new_n363_), .b(new_n144_), .O(new_n512_));
  ...
  nor2   g388(.a(new_n378_), .b(new_n174_), .O(new_n519_));
  ...
  nand3  g397(.a(new_n363_), .b(new_n192_), .c(x61), .O(new_n528_));
  ...
  nand3  g428(.a(new_n395_), .b(new_n261_), .c(new_n255_), .O(new_n559_));
  ...
  nor2   g452(.a(new_n390_), .b(new_n310_), .O(new_n583_));
  ...
  nand3  g493(.a(new_n405_), .b(new_n402_), .c(new_n388_), .O(new_n624_));
  ...
  nand2  g504(.a(new_n634_), .b(new_n388_), .O(new_n635_));
  nor2   g505(.a(new_n635_), .b(new_n633_), .O(z52));
  nand2  g506(.a(new_n239_), .b(x63), .O(new_n637_));
  nor2   g507(.a(new_n637_), .b(new_n408_), .O(z53));
  nor3   g508(.a(new_n364_), .b(x56), .c(new_n132_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n527_), .c(new_n417_), .d(new_n415_), .O(new_n640_));
  inv1   g510(.a(new_n640_), .O(z54));
  nor2   g511(.a(x37), .b(new_n612_), .O(new_n642_));
  nand4  g512(.a(new_n642_), .b(new_n548_), .c(new_n425_), .d(new_n327_), .O(new_n643_));
  nor2   g513(.a(new_n643_), .b(new_n418_), .O(z55));
  nand3  g514(.a(new_n220_), .b(x20), .c(new_n391_), .O(new_n645_));
  nor2   g515(.a(new_n645_), .b(new_n493_), .O(new_n646_));
  nand4  g516(.a(new_n646_), .b(new_n466_), .c(new_n274_), .d(new_n156_), .O(new_n647_));
  nor2   g517(.a(new_n647_), .b(new_n445_), .O(z56));
  nand4  g518(.a(new_n379_), .b(new_n340_), .c(new_n203_), .d(new_n165_), .O(new_n649_));
  nand3  g519(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n650_));
  nor4   g520(.a(new_n650_), .b(new_n649_), .c(new_n331_), .d(new_n155_), .O(z57));
  inv1   g521(.a(new_n366_), .O(new_n652_));
  nand3  g522(.a(new_n425_), .b(new_n652_), .c(new_n547_), .O(new_n653_));
  nand3  g523(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n654_));
  nor4   g524(.a(new_n654_), .b(new_n653_), .c(new_n649_), .d(new_n426_), .O(z58));
  nor4   g525(.a(new_n485_), .b(new_n352_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand3  g533(.a(new_n363_), .b(new_n365_), .c(new_n350_), .O(new_n664_));
  ...
  nand4  g540(.a(new_n670_), .b(new_n668_), .c(new_n483_), .d(new_n380_), .O(new_n671_));
  ...
  nand4  g544(.a(new_n674_), .b(new_n668_), .c(new_n483_), .d(new_n380_), .O(new_n675_));
  inv1   g545(.a(new_n675_), .O(z63));
  nor2   g546(.a(new_n485_), .b(x60), .O(new_n677_));
  nand4  g547(.a(new_n677_), .b(new_n483_), .c(new_n289_), .d(x30), .O(new_n678_));
