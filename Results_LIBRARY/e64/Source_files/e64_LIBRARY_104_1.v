...
module FAU ( 
  ...
  nor2   g192(.a(new_n289_), .b(x15), .O(z11));
  ...
  nand4  g218(.a(new_n348_), .b(new_n264_), .c(new_n289_), .d(new_n286_), .O(new_n349_));
  ...
  nand3  g325(.a(new_n348_), .b(new_n286_), .c(x11), .O(new_n456_));
  ...
  nand2  g328(.a(new_n348_), .b(new_n286_), .O(new_n459_));
  ...
  nand4  g376(.a(new_n351_), .b(new_n347_), .c(new_n314_), .d(x39), .O(new_n507_));
  nor2   g377(.a(new_n507_), .b(new_n349_), .O(z33));
  nor4   g378(.a(new_n430_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  ...
  nor2   g450(.a(new_n388_), .b(new_n310_), .O(new_n581_));
  ...
  nand3  g480(.a(new_n377_), .b(new_n297_), .c(new_n610_), .O(new_n611_));
  ...
  nor4   g523(.a(new_n483_), .b(new_n349_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand4  g545(.a(new_n675_), .b(new_n481_), .c(new_n289_), .d(x30), .O(new_n676_));
