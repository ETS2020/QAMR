// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:49 2020
...
module FAU ( 
  ...
  inv1   g355(.a(new_n350_), .O(new_n486_));
  nand3  g356(.a(new_n379_), .b(new_n486_), .c(new_n290_), .O(new_n487_));
  ...
  nor3   g378(.a(new_n508_), .b(new_n460_), .c(new_n288_), .O(z33));
