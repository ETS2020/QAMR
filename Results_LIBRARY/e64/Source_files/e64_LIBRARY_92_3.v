...
module FAU ( 
  ...
  nand2  g328(.a(new_n378_), .b(new_n328_), .O(new_n459_));
  nor4   g329(.a(new_n459_), .b(new_n458_), .c(new_n456_), .d(new_n380_), .O(z24));
  nand2  g330(.a(new_n349_), .b(new_n286_), .O(new_n461_));
  nand4  g331(.a(new_n357_), .b(new_n264_), .c(new_n337_), .d(x24), .O(new_n462_));
  nand3  g332(.a(new_n360_), .b(new_n348_), .c(new_n157_), .O(new_n463_));
  nor3   g333(.a(new_n463_), .b(new_n462_), .c(new_n461_), .O(z25));
  ...
  nor3   g349(.a(new_n468_), .b(new_n435_), .c(new_n434_), .O(new_n480_));
  ...
  nor3   g354(.a(new_n484_), .b(new_n458_), .c(new_n461_), .O(z28));
  nand2  g355(.a(new_n378_), .b(new_n290_), .O(new_n486_));
  ...
  nor4   g379(.a(new_n430_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  ...
  nor3   g430(.a(new_n560_), .b(new_n558_), .c(new_n459_), .O(new_n561_));
  ...
  nand4  g511(.a(new_n641_), .b(new_n547_), .c(new_n423_), .d(new_n327_), .O(new_n642_));
  ...
  nand3  g524(.a(new_n457_), .b(new_n290_), .c(x40), .O(new_n655_));
  ...
  nand3  g534(.a(new_n196_), .b(new_n290_), .c(new_n314_), .O(new_n665_));
  ...
  nand3  g542(.a(new_n457_), .b(new_n190_), .c(x56), .O(new_n673_));
  ...
  nand3  g546(.a(new_n483_), .b(new_n289_), .c(x30), .O(new_n677_));
  nor4   g547(.a(new_n677_), .b(new_n458_), .c(new_n380_), .d(new_n375_), .O(z64));
