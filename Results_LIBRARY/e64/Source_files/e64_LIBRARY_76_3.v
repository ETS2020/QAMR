...
module FAU ( 
  ...
  nand4  g443(.a(new_n182_), .b(new_n181_), .c(new_n363_), .d(new_n131_), .O(new_n574_));
  inv1   g444(.a(new_n574_), .O(new_n575_));
  inv1   g445(.a(x49), .O(new_n576_));
  nor2   g446(.a(x50), .b(new_n576_), .O(new_n577_));
  nand4  g447(.a(new_n577_), .b(new_n575_), .c(new_n194_), .d(new_n136_), .O(new_n578_));
  nor2   g448(.a(new_n578_), .b(new_n573_), .O(z42));
  ...
  nand4  g471(.a(new_n570_), .b(new_n601_), .c(new_n330_), .d(new_n146_), .O(new_n602_));
