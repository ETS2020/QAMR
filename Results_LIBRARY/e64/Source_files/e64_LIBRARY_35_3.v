...
module FAU ( 
  ...
  nand2  g133(.a(x29), .b(new_n152_), .O(new_n264_));
  ...
  nand2  g141(.a(new_n235_), .b(new_n186_), .O(new_n272_));
  nand3  g142(.a(new_n239_), .b(new_n238_), .c(new_n192_), .O(new_n273_));
  inv1   g143(.a(x57), .O(new_n274_));
  nand4  g144(.a(new_n191_), .b(new_n190_), .c(new_n182_), .d(new_n274_), .O(new_n275_));
  nor4   g145(.a(new_n275_), .b(new_n273_), .c(new_n272_), .d(new_n271_), .O(new_n276_));
  nor2   g146(.a(x41), .b(x39), .O(new_n277_));
  nand3  g147(.a(new_n277_), .b(new_n249_), .c(new_n248_), .O(new_n278_));
  nor2   g148(.a(x37), .b(x36), .O(new_n279_));
  nand2  g149(.a(new_n279_), .b(new_n149_), .O(new_n280_));
  nand2  g150(.a(new_n256_), .b(new_n196_), .O(new_n281_));
  ...
  nand2  g154(.a(new_n284_), .b(new_n276_), .O(new_n285_));
  ...
  nor4   g161(.a(new_n291_), .b(new_n264_), .c(x15), .d(new_n219_), .O(z06));
  nor2   g162(.a(x37), .b(new_n153_), .O(new_n293_));
  nand2  g163(.a(new_n293_), .b(x43), .O(new_n294_));
  nor3   g164(.a(new_n294_), .b(x28), .c(x15), .O(z07));
  nand4  g165(.a(new_n252_), .b(new_n160_), .c(new_n249_), .d(x38), .O(new_n296_));
  inv1   g166(.a(new_n281_), .O(new_n297_));
  ...
  nand2  g172(.a(new_n302_), .b(new_n276_), .O(new_n303_));
  ...
  nand4  g178(.a(new_n279_), .b(new_n277_), .c(new_n266_), .d(new_n149_), .O(new_n309_));
  inv1   g179(.a(x42), .O(new_n310_));
  nand3  g180(.a(new_n298_), .b(new_n310_), .c(new_n249_), .O(new_n311_));
  nor3   g181(.a(new_n311_), .b(new_n309_), .c(new_n281_), .O(new_n312_));
  nand3  g182(.a(new_n312_), .b(new_n308_), .c(new_n276_), .O(new_n313_));
  nor2   g183(.a(new_n313_), .b(new_n305_), .O(z09));
  nand3  g184(.a(new_n293_), .b(x28), .c(new_n287_), .O(new_n315_));
  ...
  nand3  g207(.a(new_n160_), .b(x41), .c(new_n249_), .O(new_n338_));
  nor2   g208(.a(new_n338_), .b(new_n155_), .O(new_n339_));
  nand4  g209(.a(new_n339_), .b(new_n337_), .c(new_n324_), .d(new_n321_), .O(new_n340_));
  inv1   g210(.a(new_n340_), .O(z13));
  inv1   g211(.a(x50), .O(new_n342_));
  nor2   g212(.a(new_n153_), .b(x28), .O(new_n343_));
  nor2   g213(.a(x14), .b(x10), .O(new_n344_));
  nand4  g214(.a(new_n344_), .b(new_n343_), .c(new_n289_), .d(new_n287_), .O(new_n345_));
  nor4   g215(.a(new_n345_), .b(x58), .c(new_n342_), .d(x43), .O(z14));
  nor2   g216(.a(x58), .b(x43), .O(new_n347_));
  nand2  g217(.a(new_n347_), .b(new_n293_), .O(new_n348_));
  nand4  g218(.a(new_n152_), .b(new_n287_), .c(new_n219_), .d(x10), .O(new_n349_));
  nor2   g219(.a(new_n349_), .b(new_n348_), .O(z15));
  nor2   g220(.a(x43), .b(x40), .O(new_n351_));
  nand2  g221(.a(new_n351_), .b(new_n160_), .O(new_n352_));
  ...
  nand3  g228(.a(new_n196_), .b(new_n358_), .c(new_n342_), .O(new_n359_));
  nor2   g229(.a(new_n359_), .b(new_n357_), .O(new_n360_));
  nand4  g230(.a(new_n360_), .b(new_n355_), .c(new_n353_), .d(new_n337_), .O(new_n361_));
  inv1   g231(.a(new_n361_), .O(z16));
  nand2  g232(.a(new_n332_), .b(new_n175_), .O(new_n363_));
  nand3  g233(.a(new_n335_), .b(new_n210_), .c(x03), .O(new_n364_));
  ...
  nand2  g245(.a(new_n343_), .b(new_n173_), .O(new_n376_));
  ...
  nand2  g262(.a(new_n298_), .b(new_n196_), .O(new_n393_));
  nand2  g263(.a(new_n374_), .b(new_n258_), .O(new_n394_));
  ...
  nand2  g276(.a(new_n335_), .b(new_n406_), .O(new_n407_));
  ...
  nor4   g281(.a(new_n411_), .b(new_n363_), .c(new_n264_), .d(x30), .O(new_n412_));
  ...
  nand4  g285(.a(new_n415_), .b(new_n322_), .c(new_n161_), .d(new_n160_), .O(new_n416_));
  ...
  nand2  g290(.a(new_n373_), .b(new_n343_), .O(new_n421_));
  ...
  inv1   g296(.a(new_n328_), .O(new_n427_));
  nor2   g297(.a(new_n427_), .b(new_n217_), .O(new_n428_));
  nand3  g298(.a(new_n428_), .b(new_n386_), .c(new_n385_), .O(new_n429_));
  nor2   g299(.a(new_n275_), .b(new_n273_), .O(new_n430_));
  and2   g300(.a(new_n430_), .b(new_n138_), .O(new_n431_));
  inv1   g301(.a(new_n383_), .O(new_n432_));
  nand2  g302(.a(new_n343_), .b(new_n231_), .O(new_n433_));
  nor2   g303(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  inv1   g304(.a(x39), .O(new_n435_));
  nand3  g305(.a(new_n390_), .b(new_n435_), .c(x36), .O(new_n436_));
  nand2  g306(.a(new_n389_), .b(new_n265_), .O(new_n437_));
  nor2   g307(.a(new_n437_), .b(new_n436_), .O(new_n438_));
  nand2  g308(.a(new_n161_), .b(new_n158_), .O(new_n439_));
  nor2   g309(.a(new_n439_), .b(new_n257_), .O(new_n440_));
  nand4  g310(.a(new_n440_), .b(new_n438_), .c(new_n434_), .d(new_n431_), .O(new_n441_));
  nor2   g311(.a(new_n441_), .b(new_n429_), .O(z22));
  inv1   g312(.a(new_n428_), .O(new_n443_));
  nor3   g313(.a(new_n242_), .b(new_n240_), .c(new_n236_), .O(new_n444_));
  nand2  g314(.a(new_n252_), .b(new_n160_), .O(new_n445_));
  nor2   g315(.a(new_n445_), .b(new_n439_), .O(new_n446_));
  nor2   g316(.a(new_n257_), .b(new_n137_), .O(new_n447_));
  and2   g317(.a(new_n447_), .b(new_n446_), .O(new_n448_));
  nand2  g318(.a(new_n385_), .b(x16), .O(new_n449_));
  ...
  nor2   g323(.a(new_n453_), .b(new_n443_), .O(z23));
  nand3  g324(.a(new_n344_), .b(new_n287_), .c(x11), .O(new_n455_));
  nand3  g325(.a(new_n356_), .b(new_n342_), .c(new_n157_), .O(new_n456_));
  nor4   g326(.a(new_n456_), .b(new_n455_), .c(new_n376_), .d(new_n352_), .O(z24));
  nand2  g327(.a(new_n344_), .b(new_n287_), .O(new_n458_));
  nand4  g328(.a(new_n353_), .b(new_n343_), .c(new_n331_), .d(x24), .O(new_n459_));
  nor3   g329(.a(new_n459_), .b(new_n456_), .c(new_n458_), .O(z25));
  inv1   g330(.a(new_n222_), .O(new_n461_));
  nor3   g331(.a(new_n275_), .b(new_n273_), .c(new_n271_), .O(new_n462_));
  nand3  g332(.a(new_n374_), .b(new_n300_), .c(new_n279_), .O(new_n463_));
  inv1   g333(.a(new_n272_), .O(new_n464_));
  nand2  g334(.a(new_n297_), .b(new_n464_), .O(new_n465_));
  nor2   g335(.a(new_n465_), .b(new_n463_), .O(new_n466_));
  nand2  g336(.a(new_n225_), .b(new_n224_), .O(new_n467_));
  or2    g337(.a(new_n467_), .b(new_n384_), .O(new_n468_));
  inv1   g338(.a(new_n468_), .O(new_n469_));
  inv1   g339(.a(x33), .O(new_n470_));
  nand3  g340(.a(new_n149_), .b(new_n470_), .c(x32), .O(new_n471_));
  nor2   g341(.a(new_n471_), .b(new_n306_), .O(new_n472_));
  nand4  g342(.a(new_n472_), .b(new_n469_), .c(new_n466_), .d(new_n462_), .O(new_n473_));
  nor2   g343(.a(new_n473_), .b(new_n461_), .O(z26));
  nor2   g344(.a(new_n445_), .b(new_n437_), .O(new_n475_));
  and2   g345(.a(new_n475_), .b(new_n440_), .O(new_n476_));
  nand2  g346(.a(new_n220_), .b(new_n176_), .O(new_n477_));
  nor3   g347(.a(new_n477_), .b(x14), .c(new_n218_), .O(new_n478_));
  nor3   g348(.a(new_n467_), .b(new_n433_), .c(new_n432_), .O(new_n479_));
  nand4  g349(.a(new_n479_), .b(new_n478_), .c(new_n476_), .d(new_n244_), .O(new_n480_));
  nor2   g350(.a(new_n480_), .b(new_n217_), .O(z27));
  nand2  g351(.a(new_n374_), .b(new_n322_), .O(new_n482_));
  inv1   g352(.a(new_n482_), .O(new_n483_));
  nand4  g353(.a(new_n483_), .b(new_n293_), .c(new_n152_), .d(x25), .O(new_n484_));
  nand2  g354(.a(new_n181_), .b(new_n342_), .O(new_n485_));
  nor4   g355(.a(new_n485_), .b(new_n484_), .c(new_n458_), .d(x60), .O(z28));
  nand2  g356(.a(new_n374_), .b(new_n290_), .O(new_n487_));
  or2    g357(.a(new_n487_), .b(new_n345_), .O(new_n488_));
  nand4  g358(.a(x60), .b(new_n181_), .c(new_n342_), .d(new_n157_), .O(new_n489_));
  nor2   g359(.a(new_n489_), .b(new_n488_), .O(z29));
  nand3  g360(.a(new_n186_), .b(new_n270_), .c(x52), .O(new_n491_));
  ...
  nand4  g364(.a(new_n374_), .b(new_n279_), .c(new_n149_), .d(new_n148_), .O(new_n495_));
  nor2   g365(.a(new_n495_), .b(new_n301_), .O(new_n496_));
  nand4  g366(.a(new_n496_), .b(new_n494_), .c(new_n492_), .d(new_n430_), .O(new_n497_));
  nor2   g367(.a(new_n497_), .b(new_n429_), .O(z30));
  and2   g368(.a(new_n400_), .b(new_n243_), .O(new_n499_));
  nand3  g369(.a(new_n173_), .b(new_n152_), .c(new_n151_), .O(new_n500_));
  nor3   g370(.a(new_n500_), .b(x22), .c(new_n225_), .O(new_n501_));
  nor2   g371(.a(new_n280_), .b(new_n246_), .O(new_n502_));
  nand4  g372(.a(new_n502_), .b(new_n501_), .c(new_n499_), .d(new_n395_), .O(new_n503_));
  nor2   g373(.a(new_n503_), .b(new_n429_), .O(z31));
  nand3  g374(.a(new_n181_), .b(new_n342_), .c(x46), .O(new_n505_));
  nor2   g375(.a(new_n505_), .b(new_n488_), .O(z32));
  nand4  g376(.a(new_n347_), .b(new_n342_), .c(new_n249_), .d(x39), .O(new_n507_));
  nor2   g377(.a(new_n507_), .b(new_n345_), .O(z33));
  nor4   g378(.a(new_n427_), .b(new_n291_), .c(new_n264_), .d(new_n181_), .O(z34));
  nand2  g379(.a(new_n356_), .b(new_n144_), .O(new_n510_));
  inv1   g380(.a(new_n510_), .O(new_n511_));
  nand2  g381(.a(new_n186_), .b(new_n183_), .O(new_n512_));
  inv1   g382(.a(new_n512_), .O(new_n513_));
  nand4  g383(.a(new_n513_), .b(new_n511_), .c(new_n418_), .d(new_n196_), .O(new_n514_));
  nand3  g384(.a(new_n167_), .b(new_n165_), .c(x04), .O(new_n515_));
  nor2   g385(.a(new_n515_), .b(new_n141_), .O(new_n516_));
  nor2   g386(.a(new_n371_), .b(new_n174_), .O(new_n517_));
  inv1   g387(.a(new_n374_), .O(new_n518_));
  inv1   g388(.a(new_n390_), .O(new_n519_));
  nor3   g389(.a(new_n519_), .b(new_n518_), .c(new_n155_), .O(new_n520_));
  ...
  nor3   g393(.a(new_n523_), .b(new_n419_), .c(new_n519_), .O(new_n524_));
  nand3  g394(.a(new_n356_), .b(new_n192_), .c(x61), .O(new_n525_));
  nor3   g395(.a(new_n525_), .b(x56), .c(x55), .O(new_n526_));
  nand4  g396(.a(new_n526_), .b(new_n524_), .c(new_n412_), .d(new_n410_), .O(new_n527_));
  inv1   g397(.a(new_n527_), .O(z36));
  nor3   g398(.a(new_n493_), .b(x20), .c(new_n223_), .O(new_n529_));
  nand2  g399(.a(new_n251_), .b(new_n148_), .O(new_n530_));
  nor2   g400(.a(new_n530_), .b(new_n155_), .O(new_n531_));
  nand4  g401(.a(new_n531_), .b(new_n529_), .c(new_n448_), .d(new_n444_), .O(new_n532_));
  nor2   g402(.a(new_n532_), .b(new_n461_), .O(z37));
  nand2  g403(.a(new_n406_), .b(new_n203_), .O(new_n534_));
  nor3   g404(.a(new_n534_), .b(new_n141_), .c(x04), .O(new_n535_));
  inv1   g405(.a(new_n500_), .O(new_n536_));
  nand2  g406(.a(new_n536_), .b(new_n172_), .O(new_n537_));
  inv1   g407(.a(new_n537_), .O(new_n538_));
  nand2  g408(.a(new_n390_), .b(new_n154_), .O(new_n539_));
  nor3   g409(.a(new_n539_), .b(new_n518_), .c(x41), .O(new_n540_));
  nand4  g410(.a(new_n540_), .b(new_n538_), .c(new_n535_), .d(new_n372_), .O(new_n541_));
  inv1   g411(.a(new_n357_), .O(new_n542_));
  inv1   g412(.a(new_n523_), .O(new_n543_));
  ...
  nor2   g417(.a(x43), .b(new_n310_), .O(new_n548_));
  nand4  g418(.a(new_n548_), .b(new_n513_), .c(new_n511_), .d(new_n196_), .O(new_n549_));
  ...
  nand3  g423(.a(new_n390_), .b(new_n389_), .c(new_n258_), .O(new_n554_));
  inv1   g424(.a(x51), .O(new_n555_));
  nand2  g425(.a(new_n135_), .b(new_n555_), .O(new_n556_));
  nor3   g426(.a(new_n556_), .b(new_n554_), .c(new_n482_), .O(new_n557_));
  ...
  inv1   g431(.a(new_n394_), .O(new_n562_));
  nor2   g432(.a(x34), .b(new_n470_), .O(new_n563_));
  nand3  g433(.a(new_n133_), .b(new_n132_), .c(new_n555_), .O(new_n564_));
  nor3   g434(.a(new_n564_), .b(new_n323_), .c(new_n145_), .O(new_n565_));
  nand4  g435(.a(new_n565_), .b(new_n563_), .c(new_n562_), .d(new_n390_), .O(new_n566_));
  nor2   g436(.a(new_n566_), .b(new_n561_), .O(z41));
  nand2  g437(.a(new_n397_), .b(new_n382_), .O(new_n568_));
  ...
  nor2   g443(.a(new_n393_), .b(new_n188_), .O(new_n574_));
  nor2   g444(.a(new_n193_), .b(new_n184_), .O(new_n575_));
  nand2  g445(.a(new_n575_), .b(new_n574_), .O(new_n576_));
  nor2   g446(.a(new_n384_), .b(new_n306_), .O(new_n577_));
  nor2   g447(.a(new_n394_), .b(new_n391_), .O(new_n578_));
  nand2  g448(.a(new_n214_), .b(x01), .O(new_n579_));
  nor3   g449(.a(new_n579_), .b(new_n211_), .c(new_n141_), .O(new_n580_));
  nor2   g450(.a(new_n387_), .b(new_n207_), .O(new_n581_));
  nand4  g451(.a(new_n581_), .b(new_n580_), .c(new_n578_), .d(new_n577_), .O(new_n582_));
  nor2   g452(.a(new_n582_), .b(new_n576_), .O(z43));
  nand2  g453(.a(new_n255_), .b(new_n158_), .O(new_n584_));
  nor2   g454(.a(new_n584_), .b(new_n137_), .O(new_n585_));
  nand3  g455(.a(new_n585_), .b(new_n146_), .c(new_n569_), .O(new_n586_));
  ...
  nand3  g462(.a(new_n160_), .b(new_n592_), .c(x34), .O(new_n593_));
  nor2   g463(.a(new_n593_), .b(new_n439_), .O(new_n594_));
  ...
  nand4  g468(.a(new_n598_), .b(new_n562_), .c(new_n324_), .d(new_n146_), .O(new_n599_));
  ...
  nor2   g472(.a(new_n539_), .b(new_n500_), .O(new_n603_));
  nand3  g473(.a(new_n603_), .b(new_n602_), .c(new_n535_), .O(new_n604_));
  nor2   g474(.a(new_n604_), .b(new_n599_), .O(z46));
  nand2  g475(.a(new_n535_), .b(new_n372_), .O(new_n606_));
  nand3  g476(.a(new_n383_), .b(new_n386_), .c(x17), .O(new_n607_));
  nor2   g477(.a(new_n607_), .b(new_n433_), .O(new_n608_));
  nand3  g478(.a(new_n373_), .b(new_n435_), .c(new_n592_), .O(new_n609_));
  nor2   g479(.a(new_n609_), .b(new_n439_), .O(new_n610_));
  nand3  g480(.a(new_n610_), .b(new_n608_), .c(new_n595_), .O(new_n611_));
  nor2   g481(.a(new_n611_), .b(new_n606_), .O(z47));
  nand3  g482(.a(new_n149_), .b(new_n470_), .c(x31), .O(new_n613_));
  nor2   g483(.a(new_n613_), .b(new_n162_), .O(new_n614_));
  nor2   g484(.a(new_n197_), .b(new_n188_), .O(new_n615_));
  nand3  g485(.a(new_n615_), .b(new_n614_), .c(new_n575_), .O(new_n616_));
  nor2   g486(.a(new_n616_), .b(new_n561_), .O(z48));
  nand4  g487(.a(new_n194_), .b(new_n185_), .c(new_n131_), .d(x53), .O(new_n618_));
  nor2   g488(.a(new_n618_), .b(new_n558_), .O(z49));
  nand3  g489(.a(new_n400_), .b(new_n397_), .c(new_n382_), .O(new_n620_));
  nand3  g490(.a(new_n146_), .b(new_n181_), .c(x57), .O(new_n621_));
  nor2   g491(.a(new_n621_), .b(new_n620_), .O(z50));
  nand4  g492(.a(new_n575_), .b(new_n189_), .c(new_n570_), .d(x48), .O(new_n623_));
  nor2   g493(.a(new_n623_), .b(new_n568_), .O(z51));
  nand2  g494(.a(new_n160_), .b(new_n149_), .O(new_n625_));
  nor2   g495(.a(new_n625_), .b(new_n439_), .O(new_n626_));
  nor3   g496(.a(new_n600_), .b(x14), .c(new_n202_), .O(new_n627_));
  nor2   g497(.a(new_n500_), .b(new_n246_), .O(new_n628_));
  nand4  g498(.a(new_n628_), .b(new_n627_), .c(new_n626_), .d(new_n447_), .O(new_n629_));
  nor3   g499(.a(new_n275_), .b(new_n273_), .c(new_n134_), .O(new_n630_));
  nand2  g500(.a(new_n630_), .b(new_n382_), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(new_n629_), .O(z52));
  nand2  g502(.a(new_n239_), .b(x63), .O(new_n633_));
  nor2   g503(.a(new_n633_), .b(new_n403_), .O(z53));
  nor3   g504(.a(new_n357_), .b(x56), .c(new_n132_), .O(new_n635_));
  nand4  g505(.a(new_n635_), .b(new_n524_), .c(new_n412_), .d(new_n410_), .O(new_n636_));
  inv1   g506(.a(new_n636_), .O(z54));
  nor2   g507(.a(x37), .b(new_n592_), .O(new_n638_));
  nand4  g508(.a(new_n638_), .b(new_n543_), .c(new_n420_), .d(new_n321_), .O(new_n639_));
  nor2   g509(.a(new_n639_), .b(new_n413_), .O(z55));
  nand3  g510(.a(new_n220_), .b(x20), .c(new_n385_), .O(new_n641_));
  nor2   g511(.a(new_n641_), .b(new_n493_), .O(new_n642_));
  nand4  g512(.a(new_n642_), .b(new_n466_), .c(new_n462_), .d(new_n156_), .O(new_n643_));
  nor2   g513(.a(new_n643_), .b(new_n443_), .O(z56));
  nand4  g514(.a(new_n372_), .b(new_n334_), .c(new_n203_), .d(new_n165_), .O(new_n645_));
  nand3  g515(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n646_));
  nor4   g516(.a(new_n646_), .b(new_n645_), .c(new_n325_), .d(new_n155_), .O(z57));
  inv1   g517(.a(new_n359_), .O(new_n648_));
  nand3  g518(.a(new_n420_), .b(new_n648_), .c(new_n542_), .O(new_n649_));
  nand3  g519(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n650_));
  nor4   g520(.a(new_n650_), .b(new_n649_), .c(new_n645_), .d(new_n421_), .O(z58));
  nor4   g521(.a(new_n485_), .b(new_n345_), .c(x43), .d(new_n249_), .O(z59));
  nor3   g522(.a(new_n371_), .b(x08), .c(new_n210_), .O(new_n653_));
  nand2  g523(.a(new_n133_), .b(new_n190_), .O(new_n654_));
  nor2   g524(.a(new_n654_), .b(new_n323_), .O(new_n655_));
  nand3  g525(.a(new_n655_), .b(new_n653_), .c(new_n377_), .O(new_n656_));
  inv1   g526(.a(new_n656_), .O(z60));
  nor2   g527(.a(x10), .b(new_n203_), .O(new_n658_));
  nand4  g528(.a(new_n658_), .b(new_n366_), .c(new_n332_), .d(new_n175_), .O(new_n659_));
  nand3  g529(.a(new_n356_), .b(new_n358_), .c(new_n342_), .O(new_n660_));
  nand2  g530(.a(new_n351_), .b(new_n196_), .O(new_n661_));
  nand2  g531(.a(new_n160_), .b(new_n154_), .O(new_n662_));
  nor4   g532(.a(new_n662_), .b(new_n661_), .c(new_n660_), .d(new_n659_), .O(z61));
  nor2   g533(.a(new_n376_), .b(new_n371_), .O(new_n664_));
  nand2  g534(.a(new_n342_), .b(x47), .O(new_n665_));
  nor2   g535(.a(new_n665_), .b(new_n654_), .O(new_n666_));
  nand4  g536(.a(new_n666_), .b(new_n664_), .c(new_n483_), .d(new_n373_), .O(new_n667_));
  inv1   g537(.a(new_n667_), .O(z62));
  nand4  g538(.a(new_n190_), .b(new_n181_), .c(x56), .d(new_n342_), .O(new_n669_));
  inv1   g539(.a(new_n669_), .O(new_n670_));
  nand4  g540(.a(new_n670_), .b(new_n664_), .c(new_n483_), .d(new_n373_), .O(new_n671_));
  inv1   g541(.a(new_n671_), .O(z63));
  nor2   g542(.a(new_n485_), .b(x60), .O(new_n673_));
  nand4  g543(.a(new_n673_), .b(new_n483_), .c(new_n289_), .d(x30), .O(new_n674_));
