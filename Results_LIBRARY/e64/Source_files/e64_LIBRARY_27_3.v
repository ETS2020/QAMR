...
module FAU ( 
  ...
  nand3  g214(.a(new_n160_), .b(x41), .c(new_n314_), .O(new_n345_));
  ...
  nand4  g291(.a(new_n421_), .b(new_n326_), .c(new_n181_), .d(x51), .O(new_n422_));
  nor2   g292(.a(new_n422_), .b(new_n418_), .O(z20));
  inv1   g293(.a(new_n420_), .O(new_n424_));
  ...
  nor2   g297(.a(new_n416_), .b(new_n369_), .O(new_n428_));
  nand4  g298(.a(new_n428_), .b(new_n413_), .c(new_n140_), .d(x00), .O(new_n429_));
  ...
  nand3  g307(.a(new_n395_), .b(new_n297_), .c(x36), .O(new_n438_));
  ...
  nand3  g316(.a(new_n395_), .b(new_n297_), .c(new_n446_), .O(new_n447_));
  ...
  nand2  g355(.a(new_n380_), .b(new_n290_), .O(new_n486_));
  ...
  nand4  g364(.a(new_n380_), .b(new_n262_), .c(new_n149_), .d(new_n148_), .O(new_n495_));
  ...
  and2   g368(.a(new_n405_), .b(new_n243_), .O(new_n499_));
  ...
  nand4  g373(.a(new_n503_), .b(new_n501_), .c(new_n499_), .d(new_n400_), .O(new_n504_));
  ...
  nand4  g377(.a(new_n353_), .b(new_n349_), .c(new_n314_), .d(x39), .O(new_n508_));
  ...
  nand4  g384(.a(new_n514_), .b(new_n512_), .c(new_n419_), .d(new_n196_), .O(new_n515_));
  ...
  nand4  g511(.a(new_n641_), .b(new_n547_), .c(new_n424_), .d(new_n328_), .O(new_n642_));
  ...
  nand4  g517(.a(new_n378_), .b(new_n341_), .c(new_n203_), .d(new_n165_), .O(new_n648_));
  nand3  g518(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n649_));
  nor4   g519(.a(new_n649_), .b(new_n648_), .c(new_n332_), .d(new_n155_), .O(z57));
  nand2  g520(.a(new_n421_), .b(new_n546_), .O(new_n651_));
  nand3  g521(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n652_));
  nor4   g522(.a(new_n652_), .b(new_n651_), .c(new_n648_), .d(new_n425_), .O(z58));
  nor4   g523(.a(new_n484_), .b(new_n351_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nor2   g535(.a(new_n382_), .b(new_n377_), .O(new_n666_));
  nand2  g536(.a(new_n349_), .b(x47), .O(new_n667_));
  nor2   g537(.a(new_n667_), .b(new_n656_), .O(new_n668_));
  nand4  g538(.a(new_n668_), .b(new_n666_), .c(new_n482_), .d(new_n379_), .O(new_n669_));
  ...
  nand4  g542(.a(new_n672_), .b(new_n666_), .c(new_n482_), .d(new_n379_), .O(new_n673_));
  ...
  nor3   g546(.a(new_n676_), .b(new_n382_), .c(new_n377_), .O(z64));
