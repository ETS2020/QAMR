...
module FAU ( 
  ...
  nand3  g518(.a(new_n424_), .b(new_n648_), .c(new_n546_), .O(new_n649_));
  ...
  nor4   g521(.a(new_n651_), .b(new_n650_), .c(new_n649_), .d(new_n155_), .O(z57));
  nand3  g522(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n653_));
  nor4   g523(.a(new_n653_), .b(new_n650_), .c(new_n649_), .d(new_n425_), .O(z58));
