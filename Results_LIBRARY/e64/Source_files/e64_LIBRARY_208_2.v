// Benchmark "FAU" written by ABC on Thu Jun 25 18:55:49 2020
...
module FAU ( 
  ...
  nor3   g183(.a(new_n313_), .b(new_n309_), .c(new_n251_), .O(new_n314_));
  nand3  g184(.a(new_n314_), .b(new_n308_), .c(new_n242_), .O(new_n315_));
  nor2   g185(.a(new_n315_), .b(new_n305_), .O(z09));
  nand3  g186(.a(new_n285_), .b(x28), .c(new_n278_), .O(new_n317_));
  inv1   g187(.a(new_n317_), .O(z10));
  nand3  g188(.a(x37), .b(x29), .c(new_n278_), .O(new_n319_));
  ...
  nand3  g209(.a(new_n162_), .b(x41), .c(new_n310_), .O(new_n340_));
  ...
  nand4  g215(.a(new_n345_), .b(new_n261_), .c(new_n281_), .d(new_n278_), .O(new_n346_));
  ...
  nand4  g219(.a(new_n154_), .b(new_n278_), .c(new_n219_), .d(x10), .O(new_n350_));
  ...
  nand2  g226(.a(new_n290_), .b(new_n191_), .O(new_n357_));
  ...
  nand4  g230(.a(new_n360_), .b(new_n356_), .c(new_n354_), .d(new_n339_), .O(new_n361_));
  inv1   g231(.a(new_n361_), .O(z16));
  nand2  g232(.a(new_n334_), .b(new_n177_), .O(new_n363_));
  nand3  g233(.a(new_n337_), .b(new_n210_), .c(x03), .O(new_n364_));
  ...
  nand4  g249(.a(new_n379_), .b(new_n377_), .c(new_n372_), .d(new_n169_), .O(new_n380_));
  ...
  nand2  g259(.a(new_n389_), .b(new_n258_), .O(new_n390_));
  nor2   g260(.a(new_n390_), .b(new_n306_), .O(new_n391_));
  nand2  g261(.a(new_n312_), .b(new_n196_), .O(new_n392_));
  nand2  g262(.a(new_n374_), .b(new_n252_), .O(new_n393_));
  ...
  nor4   g282(.a(new_n412_), .b(new_n363_), .c(new_n280_), .d(x30), .O(new_n413_));
  nand2  g283(.a(new_n413_), .b(new_n411_), .O(new_n414_));
  nand3  g284(.a(new_n136_), .b(new_n358_), .c(x51), .O(new_n415_));
  nor2   g285(.a(new_n415_), .b(new_n357_), .O(new_n416_));
  ...
  nand2  g289(.a(new_n419_), .b(new_n374_), .O(new_n420_));
  inv1   g290(.a(new_n420_), .O(new_n421_));
  nand2  g291(.a(new_n373_), .b(new_n261_), .O(new_n422_));
  inv1   g292(.a(new_n422_), .O(new_n423_));
  nand3  g293(.a(new_n423_), .b(new_n421_), .c(new_n360_), .O(new_n424_));
  ...
  nand2  g302(.a(new_n261_), .b(new_n231_), .O(new_n433_));
  nor2   g303(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  nand3  g304(.a(new_n389_), .b(new_n294_), .c(x36), .O(new_n435_));
  nand2  g305(.a(new_n262_), .b(new_n258_), .O(new_n436_));
  nor2   g306(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  nor2   g307(.a(new_n299_), .b(new_n296_), .O(new_n438_));
  ...
  inv1   g311(.a(new_n296_), .O(new_n442_));
  inv1   g312(.a(x36), .O(new_n443_));
  nand3  g313(.a(new_n389_), .b(new_n294_), .c(new_n443_), .O(new_n444_));
  ...
  nand3  g318(.a(new_n174_), .b(new_n230_), .c(new_n225_), .O(new_n449_));
  nor2   g319(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  nor2   g320(.a(new_n436_), .b(new_n433_), .O(new_n451_));
  nand4  g321(.a(new_n451_), .b(new_n450_), .c(new_n447_), .d(new_n293_), .O(new_n452_));
  nor2   g322(.a(new_n452_), .b(new_n441_), .O(z23));
  nand3  g323(.a(new_n345_), .b(new_n278_), .c(x11), .O(new_n454_));
  nand3  g324(.a(new_n290_), .b(new_n344_), .c(new_n159_), .O(new_n455_));
  nor4   g325(.a(new_n455_), .b(new_n454_), .c(new_n376_), .d(new_n353_), .O(z24));
  nand2  g326(.a(new_n345_), .b(new_n278_), .O(new_n457_));
  nand4  g327(.a(new_n354_), .b(new_n261_), .c(new_n333_), .d(x24), .O(new_n458_));
  nor3   g328(.a(new_n458_), .b(new_n455_), .c(new_n457_), .O(z25));
  inv1   g329(.a(new_n222_), .O(new_n460_));
  nand4  g330(.a(new_n374_), .b(new_n312_), .c(new_n259_), .d(new_n252_), .O(new_n461_));
  nor3   g331(.a(new_n461_), .b(new_n251_), .c(new_n237_), .O(new_n462_));
  ...
  nor2   g337(.a(new_n467_), .b(new_n306_), .O(new_n468_));
  nand4  g338(.a(new_n468_), .b(new_n465_), .c(new_n462_), .d(new_n270_), .O(new_n469_));
  nor2   g339(.a(new_n469_), .b(new_n460_), .O(z26));
  nor2   g340(.a(new_n292_), .b(new_n138_), .O(new_n471_));
  nor2   g341(.a(new_n291_), .b(new_n289_), .O(new_n472_));
  ...
  nand2  g350(.a(new_n374_), .b(new_n324_), .O(new_n481_));
  inv1   g351(.a(new_n481_), .O(new_n482_));
  nand4  g352(.a(new_n482_), .b(new_n285_), .c(new_n154_), .d(x25), .O(new_n483_));
  nand2  g353(.a(new_n183_), .b(new_n344_), .O(new_n484_));
  nor4   g354(.a(new_n484_), .b(new_n483_), .c(new_n457_), .d(x60), .O(z28));
  nand2  g355(.a(new_n374_), .b(new_n282_), .O(new_n486_));
  or2    g356(.a(new_n486_), .b(new_n346_), .O(new_n487_));
  nand4  g357(.a(x60), .b(new_n183_), .c(new_n344_), .d(new_n159_), .O(new_n488_));
  nor2   g358(.a(new_n488_), .b(new_n487_), .O(z29));
  nand3  g359(.a(new_n187_), .b(new_n236_), .c(x52), .O(new_n490_));
  nor3   g360(.a(new_n490_), .b(new_n241_), .c(new_n134_), .O(new_n491_));
  nand3  g361(.a(new_n175_), .b(new_n226_), .c(new_n225_), .O(new_n492_));
  nor2   g362(.a(new_n492_), .b(new_n157_), .O(new_n493_));
  inv1   g363(.a(new_n259_), .O(new_n494_));
  inv1   g364(.a(new_n374_), .O(new_n495_));
  nor3   g365(.a(new_n495_), .b(new_n494_), .c(new_n152_), .O(new_n496_));
  nand2  g366(.a(new_n312_), .b(new_n252_), .O(new_n497_));
  nor2   g367(.a(new_n497_), .b(new_n251_), .O(new_n498_));
  nand4  g368(.a(new_n498_), .b(new_n496_), .c(new_n493_), .d(new_n491_), .O(new_n499_));
  nor2   g369(.a(new_n499_), .b(new_n430_), .O(z30));
  and2   g370(.a(new_n472_), .b(new_n399_), .O(new_n501_));
  nand3  g371(.a(new_n175_), .b(new_n154_), .c(new_n153_), .O(new_n502_));
  nor3   g372(.a(new_n502_), .b(x22), .c(new_n225_), .O(new_n503_));
  nand2  g373(.a(new_n259_), .b(new_n151_), .O(new_n504_));
  nor2   g374(.a(new_n504_), .b(new_n244_), .O(new_n505_));
  nand4  g375(.a(new_n505_), .b(new_n503_), .c(new_n501_), .d(new_n394_), .O(new_n506_));
  nor2   g376(.a(new_n506_), .b(new_n430_), .O(z31));
  nand3  g377(.a(new_n183_), .b(new_n344_), .c(x46), .O(new_n508_));
  nor2   g378(.a(new_n508_), .b(new_n487_), .O(z32));
  nand4  g379(.a(new_n348_), .b(new_n344_), .c(new_n310_), .d(x39), .O(new_n510_));
  nor2   g380(.a(new_n510_), .b(new_n346_), .O(z33));
  nor4   g381(.a(new_n428_), .b(new_n283_), .c(new_n280_), .d(new_n183_), .O(z34));
  nand2  g382(.a(new_n187_), .b(new_n184_), .O(new_n513_));
  inv1   g383(.a(new_n513_), .O(new_n514_));
  nand4  g384(.a(new_n514_), .b(new_n419_), .c(new_n401_), .d(new_n196_), .O(new_n515_));
  nand3  g385(.a(new_n169_), .b(new_n167_), .c(x04), .O(new_n516_));
  nor2   g386(.a(new_n516_), .b(new_n142_), .O(new_n517_));
  nor2   g387(.a(new_n371_), .b(new_n176_), .O(new_n518_));
  nor2   g388(.a(x37), .b(x35), .O(new_n519_));
  inv1   g389(.a(new_n519_), .O(new_n520_));
  nor3   g390(.a(new_n520_), .b(new_n495_), .c(new_n157_), .O(new_n521_));
  nand3  g391(.a(new_n521_), .b(new_n518_), .c(new_n517_), .O(new_n522_));
  nor2   g392(.a(new_n522_), .b(new_n515_), .O(z35));
  nand2  g393(.a(new_n196_), .b(new_n187_), .O(new_n524_));
  nor3   g394(.a(new_n524_), .b(new_n520_), .c(new_n420_), .O(new_n525_));
  nand3  g395(.a(new_n290_), .b(new_n191_), .c(x61), .O(new_n526_));
  nor3   g396(.a(new_n526_), .b(x56), .c(x55), .O(new_n527_));
  nand4  g397(.a(new_n527_), .b(new_n525_), .c(new_n413_), .d(new_n411_), .O(new_n528_));
  inv1   g398(.a(new_n528_), .O(z36));
  nand3  g399(.a(new_n442_), .b(new_n248_), .c(new_n162_), .O(new_n530_));
  nor2   g400(.a(new_n530_), .b(new_n301_), .O(new_n531_));
  nor3   g401(.a(new_n492_), .b(x20), .c(new_n223_), .O(new_n532_));
  nand2  g402(.a(new_n247_), .b(new_n150_), .O(new_n533_));
  nor2   g403(.a(new_n533_), .b(new_n157_), .O(new_n534_));
  nand4  g404(.a(new_n534_), .b(new_n532_), .c(new_n531_), .d(new_n293_), .O(new_n535_));
  nor2   g405(.a(new_n535_), .b(new_n460_), .O(z37));
  nand2  g406(.a(new_n407_), .b(new_n203_), .O(new_n537_));
  nor3   g407(.a(new_n537_), .b(new_n142_), .c(x04), .O(new_n538_));
  inv1   g408(.a(new_n502_), .O(new_n539_));
  nand2  g409(.a(new_n539_), .b(new_n174_), .O(new_n540_));
  inv1   g410(.a(new_n540_), .O(new_n541_));
  nand2  g411(.a(new_n519_), .b(new_n156_), .O(new_n542_));
  nor3   g412(.a(new_n542_), .b(new_n495_), .c(x41), .O(new_n543_));
  nand4  g413(.a(new_n543_), .b(new_n541_), .c(new_n538_), .d(new_n372_), .O(new_n544_));
  inv1   g414(.a(new_n357_), .O(new_n545_));
  inv1   g415(.a(new_n524_), .O(new_n546_));
  inv1   g416(.a(x61), .O(new_n547_));
  nand3  g417(.a(new_n184_), .b(new_n547_), .c(x59), .O(new_n548_));
  inv1   g418(.a(new_n548_), .O(new_n549_));
  nand4  g419(.a(new_n549_), .b(new_n546_), .c(new_n545_), .d(new_n160_), .O(new_n550_));
  nor2   g420(.a(new_n550_), .b(new_n544_), .O(z38));
  nor2   g421(.a(x43), .b(new_n311_), .O(new_n552_));
  nand4  g422(.a(new_n552_), .b(new_n514_), .c(new_n401_), .d(new_n196_), .O(new_n553_));
  ...
  nand3  g427(.a(new_n389_), .b(new_n258_), .c(new_n252_), .O(new_n558_));
  ...
  nand3  g434(.a(new_n557_), .b(new_n556_), .c(new_n538_), .O(new_n565_));
  inv1   g435(.a(x34), .O(new_n566_));
  nand3  g436(.a(new_n519_), .b(new_n566_), .c(x33), .O(new_n567_));
  ...
  nand4  g440(.a(new_n570_), .b(new_n568_), .c(new_n326_), .d(new_n148_), .O(new_n571_));
  nor2   g441(.a(new_n571_), .b(new_n565_), .O(z41));
  nand2  g442(.a(new_n396_), .b(new_n382_), .O(new_n573_));
  ...
  nor2   g447(.a(new_n392_), .b(new_n189_), .O(new_n578_));
  nor2   g448(.a(new_n193_), .b(new_n185_), .O(new_n579_));
  nand2  g449(.a(new_n579_), .b(new_n578_), .O(new_n580_));
  nor2   g450(.a(new_n384_), .b(new_n306_), .O(new_n581_));
  nor2   g451(.a(new_n393_), .b(new_n390_), .O(new_n582_));
  ...
  nand4  g458(.a(new_n588_), .b(new_n298_), .c(new_n160_), .d(new_n139_), .O(new_n589_));
  ...
  nor3   g465(.a(new_n524_), .b(new_n193_), .c(new_n185_), .O(new_n596_));
  nand4  g466(.a(new_n596_), .b(new_n595_), .c(new_n442_), .d(new_n162_), .O(new_n597_));
  nor2   g467(.a(new_n597_), .b(new_n565_), .O(z45));
  inv1   g468(.a(new_n393_), .O(new_n599_));
  nand4  g469(.a(new_n570_), .b(new_n599_), .c(new_n326_), .d(new_n148_), .O(new_n600_));
  ...
  nor2   g473(.a(new_n542_), .b(new_n502_), .O(new_n604_));
  nand3  g474(.a(new_n604_), .b(new_n603_), .c(new_n538_), .O(new_n605_));
  nor2   g475(.a(new_n605_), .b(new_n600_), .O(z46));
  nand2  g476(.a(new_n538_), .b(new_n372_), .O(new_n607_));
  nand3  g477(.a(new_n383_), .b(new_n386_), .c(x17), .O(new_n608_));
  nor2   g478(.a(new_n608_), .b(new_n433_), .O(new_n609_));
  inv1   g479(.a(x35), .O(new_n610_));
  nand3  g480(.a(new_n373_), .b(new_n294_), .c(new_n610_), .O(new_n611_));
  ...
  nand3  g484(.a(new_n151_), .b(new_n466_), .c(x31), .O(new_n615_));
  ...
  nor2   g488(.a(new_n618_), .b(new_n565_), .O(z48));
  ...
  nand4  g494(.a(new_n579_), .b(new_n190_), .c(new_n574_), .d(x48), .O(new_n625_));
  nor2   g495(.a(new_n625_), .b(new_n573_), .O(z51));
  ...
  nor2   g499(.a(new_n502_), .b(new_n244_), .O(new_n630_));
  nand4  g500(.a(new_n630_), .b(new_n629_), .c(new_n628_), .d(new_n302_), .O(new_n631_));
  nand2  g501(.a(new_n270_), .b(new_n382_), .O(new_n632_));
  nor2   g502(.a(new_n632_), .b(new_n631_), .O(z52));
  nand2  g503(.a(new_n238_), .b(x63), .O(new_n634_));
  nor2   g504(.a(new_n634_), .b(new_n404_), .O(z53));
  nor3   g505(.a(new_n357_), .b(x56), .c(new_n132_), .O(new_n636_));
  nand4  g506(.a(new_n636_), .b(new_n525_), .c(new_n413_), .d(new_n411_), .O(new_n637_));
  inv1   g507(.a(new_n637_), .O(z54));
  nor2   g508(.a(x37), .b(new_n610_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n546_), .c(new_n421_), .d(new_n323_), .O(new_n640_));
  nor2   g510(.a(new_n640_), .b(new_n414_), .O(z55));
  nand3  g511(.a(new_n220_), .b(x20), .c(new_n385_), .O(new_n642_));
  nor2   g512(.a(new_n642_), .b(new_n492_), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n462_), .c(new_n270_), .d(new_n158_), .O(new_n644_));
  nor2   g514(.a(new_n644_), .b(new_n441_), .O(z56));
  nand4  g515(.a(new_n372_), .b(new_n336_), .c(new_n203_), .d(new_n167_), .O(new_n646_));
  nand3  g516(.a(new_n175_), .b(new_n226_), .c(x18), .O(new_n647_));
  nor4   g517(.a(new_n647_), .b(new_n646_), .c(new_n327_), .d(new_n157_), .O(z57));
  inv1   g518(.a(new_n359_), .O(new_n649_));
  nand3  g519(.a(new_n421_), .b(new_n649_), .c(new_n545_), .O(new_n650_));
  nand3  g520(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n651_));
  nor4   g521(.a(new_n651_), .b(new_n650_), .c(new_n646_), .d(new_n422_), .O(z58));
  nor4   g522(.a(new_n484_), .b(new_n346_), .c(x43), .d(new_n310_), .O(z59));
  nor3   g523(.a(new_n371_), .b(x08), .c(new_n210_), .O(new_n654_));
  nand2  g524(.a(new_n133_), .b(new_n145_), .O(new_n655_));
  nor2   g525(.a(new_n655_), .b(new_n325_), .O(new_n656_));
  ...
  nand4  g529(.a(new_n659_), .b(new_n366_), .c(new_n334_), .d(new_n177_), .O(new_n660_));
  nand3  g530(.a(new_n290_), .b(new_n358_), .c(new_n344_), .O(new_n661_));
  nand2  g531(.a(new_n352_), .b(new_n196_), .O(new_n662_));
  ...
  nand4  g537(.a(new_n667_), .b(new_n665_), .c(new_n482_), .d(new_n373_), .O(new_n668_));
  ...
  nand4  g541(.a(new_n671_), .b(new_n665_), .c(new_n482_), .d(new_n373_), .O(new_n672_));
  inv1   g542(.a(new_n672_), .O(z63));
  nor2   g543(.a(new_n484_), .b(x60), .O(new_n674_));
  nand4  g544(.a(new_n674_), .b(new_n482_), .c(new_n281_), .d(x30), .O(new_n675_));
  nor3   g545(.a(new_n675_), .b(new_n376_), .c(new_n371_), .O(z64));
