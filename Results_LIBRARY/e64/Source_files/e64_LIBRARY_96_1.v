// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:47 2020
...
module FAU ( 
  ...
  inv1   g291(.a(x41), .O(new_n422_));
  nand3  g292(.a(new_n379_), .b(new_n290_), .c(new_n422_), .O(new_n423_));
  ...
  nand3  g381(.a(new_n196_), .b(new_n290_), .c(new_n422_), .O(new_n512_));
  nor2   g382(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand3  g383(.a(new_n513_), .b(new_n361_), .c(new_n144_), .O(new_n514_));
  nand4  g384(.a(new_n167_), .b(new_n409_), .c(new_n165_), .d(x04), .O(new_n515_));
  inv1   g385(.a(new_n155_), .O(new_n516_));
  nor2   g386(.a(new_n376_), .b(new_n174_), .O(new_n517_));
  nor2   g387(.a(x37), .b(x35), .O(new_n518_));
  nand4  g388(.a(new_n518_), .b(new_n517_), .c(new_n379_), .d(new_n516_), .O(new_n519_));
  nor3   g389(.a(new_n519_), .b(new_n515_), .c(new_n514_), .O(z35));
  nand2  g390(.a(new_n196_), .b(new_n186_), .O(new_n521_));
  nand2  g391(.a(new_n518_), .b(new_n424_), .O(new_n522_));
  nor2   g392(.a(new_n522_), .b(new_n521_), .O(new_n523_));
  nand3  g393(.a(new_n361_), .b(new_n192_), .c(x61), .O(new_n524_));
  ...
  nand3  g397(.a(new_n445_), .b(new_n250_), .c(new_n160_), .O(new_n528_));
  nor2   g398(.a(new_n528_), .b(new_n303_), .O(new_n529_));
  nor3   g399(.a(new_n492_), .b(x20), .c(new_n223_), .O(new_n530_));
  ...
  inv1   g404(.a(new_n500_), .O(new_n535_));
  nand2  g405(.a(new_n410_), .b(new_n203_), .O(new_n536_));
  nor3   g406(.a(new_n536_), .b(new_n141_), .c(x04), .O(new_n537_));
  nand4  g407(.a(new_n537_), .b(new_n535_), .c(new_n377_), .d(new_n172_), .O(new_n538_));
  inv1   g408(.a(new_n362_), .O(new_n539_));
  nor2   g409(.a(x39), .b(x35), .O(new_n540_));
  nand2  g410(.a(new_n540_), .b(new_n378_), .O(new_n541_));
  nor2   g411(.a(new_n541_), .b(new_n299_), .O(new_n542_));
  ...
  nor2   g415(.a(new_n545_), .b(new_n538_), .O(z38));
  nand2  g416(.a(new_n518_), .b(new_n154_), .O(new_n547_));
  inv1   g417(.a(new_n547_), .O(new_n548_));
  inv1   g418(.a(x51), .O(new_n549_));
  nand3  g419(.a(new_n133_), .b(new_n132_), .c(new_n549_), .O(new_n550_));
  nand3  g420(.a(new_n135_), .b(new_n157_), .c(x42), .O(new_n551_));
  nor2   g421(.a(new_n551_), .b(new_n550_), .O(new_n552_));
  nand4  g422(.a(new_n552_), .b(new_n548_), .c(new_n424_), .d(new_n194_), .O(new_n553_));
  nor2   g423(.a(new_n553_), .b(new_n538_), .O(z39));
  ...
  nand2  g428(.a(new_n135_), .b(new_n549_), .O(new_n559_));
  nor3   g429(.a(new_n559_), .b(new_n558_), .c(new_n481_), .O(new_n560_));
  nand4  g430(.a(new_n560_), .b(new_n557_), .c(new_n556_), .d(new_n537_), .O(new_n561_));
  nand4  g431(.a(new_n146_), .b(new_n133_), .c(new_n132_), .d(x54), .O(new_n562_));
  nor2   g432(.a(new_n562_), .b(new_n561_), .O(z40));
  nand3  g433(.a(new_n557_), .b(new_n556_), .c(new_n537_), .O(new_n564_));
  inv1   g434(.a(new_n550_), .O(new_n565_));
  inv1   g435(.a(x34), .O(new_n566_));
  nand3  g436(.a(new_n518_), .b(new_n566_), .c(x33), .O(new_n567_));
  nor2   g437(.a(new_n567_), .b(new_n398_), .O(new_n568_));
  nand4  g438(.a(new_n568_), .b(new_n565_), .c(new_n329_), .d(new_n146_), .O(new_n569_));
  nor2   g439(.a(new_n569_), .b(new_n564_), .O(z41));
  nand2  g440(.a(new_n401_), .b(new_n387_), .O(new_n571_));
  ...
  nand4  g461(.a(new_n591_), .b(new_n590_), .c(new_n589_), .d(new_n557_), .O(new_n592_));
  nor2   g462(.a(new_n592_), .b(new_n588_), .O(z44));
  nor2   g463(.a(x35), .b(new_n566_), .O(new_n594_));
  nor3   g464(.a(new_n521_), .b(new_n193_), .c(new_n184_), .O(new_n595_));
  nand4  g465(.a(new_n595_), .b(new_n594_), .c(new_n445_), .d(new_n160_), .O(new_n596_));
  nor2   g466(.a(new_n596_), .b(new_n564_), .O(z45));
  inv1   g467(.a(new_n398_), .O(new_n598_));
  nand4  g468(.a(new_n565_), .b(new_n598_), .c(new_n329_), .d(new_n146_), .O(new_n599_));
  ...
  nand4  g472(.a(new_n602_), .b(new_n548_), .c(new_n537_), .d(new_n535_), .O(new_n603_));
  nor2   g473(.a(new_n603_), .b(new_n599_), .O(z46));
  nand2  g474(.a(new_n537_), .b(new_n377_), .O(new_n605_));
  nand3  g475(.a(new_n388_), .b(new_n391_), .c(x17), .O(new_n606_));
  nor2   g476(.a(new_n606_), .b(new_n436_), .O(new_n607_));
  nand3  g477(.a(new_n607_), .b(new_n595_), .c(new_n542_), .O(new_n608_));
  nor2   g478(.a(new_n608_), .b(new_n605_), .O(z47));
  nand3  g479(.a(new_n149_), .b(new_n469_), .c(x31), .O(new_n610_));
  nor2   g480(.a(new_n610_), .b(new_n162_), .O(new_n611_));
  nor2   g481(.a(new_n197_), .b(new_n188_), .O(new_n612_));
  nand3  g482(.a(new_n612_), .b(new_n611_), .c(new_n578_), .O(new_n613_));
  nor2   g483(.a(new_n613_), .b(new_n564_), .O(z48));
  nand4  g484(.a(new_n194_), .b(new_n185_), .c(new_n131_), .d(x53), .O(new_n615_));
  nor2   g485(.a(new_n615_), .b(new_n561_), .O(z49));
  nand3  g486(.a(new_n404_), .b(new_n401_), .c(new_n387_), .O(new_n617_));
  nand3  g487(.a(new_n146_), .b(new_n181_), .c(x57), .O(new_n618_));
  nor2   g488(.a(new_n618_), .b(new_n617_), .O(z50));
  nand4  g489(.a(new_n578_), .b(new_n189_), .c(new_n573_), .d(x48), .O(new_n620_));
  nor2   g490(.a(new_n620_), .b(new_n571_), .O(z51));
  nand2  g491(.a(new_n160_), .b(new_n149_), .O(new_n622_));
  nor2   g492(.a(new_n622_), .b(new_n299_), .O(new_n623_));
  nor3   g493(.a(new_n600_), .b(x14), .c(new_n202_), .O(new_n624_));
  nor2   g494(.a(new_n500_), .b(new_n246_), .O(new_n625_));
  nand4  g495(.a(new_n625_), .b(new_n624_), .c(new_n623_), .d(new_n304_), .O(new_n626_));
  nor3   g496(.a(new_n271_), .b(new_n269_), .c(new_n134_), .O(new_n627_));
  nand2  g497(.a(new_n627_), .b(new_n387_), .O(new_n628_));
  nor2   g498(.a(new_n628_), .b(new_n626_), .O(z52));
  nand2  g499(.a(new_n239_), .b(x63), .O(new_n630_));
  nor2   g500(.a(new_n630_), .b(new_n407_), .O(z53));
  nor3   g501(.a(new_n362_), .b(x56), .c(new_n132_), .O(new_n632_));
  nand4  g502(.a(new_n632_), .b(new_n523_), .c(new_n416_), .d(new_n414_), .O(new_n633_));
  inv1   g503(.a(new_n633_), .O(z54));
  nor2   g504(.a(new_n521_), .b(new_n325_), .O(new_n635_));
  nand4  g505(.a(new_n635_), .b(new_n424_), .c(new_n289_), .d(x35), .O(new_n636_));
  nor2   g506(.a(new_n636_), .b(new_n417_), .O(z55));
  nand3  g507(.a(new_n220_), .b(x20), .c(new_n390_), .O(new_n638_));
  nor2   g508(.a(new_n638_), .b(new_n492_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n465_), .c(new_n274_), .d(new_n156_), .O(new_n640_));
  nor2   g510(.a(new_n640_), .b(new_n444_), .O(z56));
  nand4  g511(.a(new_n377_), .b(new_n339_), .c(new_n203_), .d(new_n165_), .O(new_n642_));
  nand3  g512(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n643_));
  nor4   g513(.a(new_n643_), .b(new_n642_), .c(new_n330_), .d(new_n155_), .O(z57));
  inv1   g514(.a(new_n364_), .O(new_n645_));
  nand3  g515(.a(new_n424_), .b(new_n645_), .c(new_n539_), .O(new_n646_));
  nand3  g516(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n647_));
  nor4   g517(.a(new_n647_), .b(new_n646_), .c(new_n642_), .d(new_n425_), .O(z58));
  nor4   g518(.a(new_n484_), .b(new_n350_), .c(x43), .d(new_n343_), .O(z59));
  nor3   g519(.a(new_n376_), .b(x08), .c(new_n210_), .O(new_n650_));
  nand2  g520(.a(new_n133_), .b(new_n190_), .O(new_n651_));
  nor2   g521(.a(new_n651_), .b(new_n328_), .O(new_n652_));
  nand3  g522(.a(new_n652_), .b(new_n650_), .c(new_n382_), .O(new_n653_));
  inv1   g523(.a(new_n653_), .O(z60));
  nor2   g524(.a(x10), .b(new_n203_), .O(new_n655_));
  nand4  g525(.a(new_n655_), .b(new_n371_), .c(new_n337_), .d(new_n175_), .O(new_n656_));
  nand3  g526(.a(new_n361_), .b(new_n363_), .c(new_n348_), .O(new_n657_));
  nand2  g527(.a(new_n356_), .b(new_n196_), .O(new_n658_));
  nand2  g528(.a(new_n160_), .b(new_n154_), .O(new_n659_));
  nor4   g529(.a(new_n659_), .b(new_n658_), .c(new_n657_), .d(new_n656_), .O(z61));
  nor2   g530(.a(new_n381_), .b(new_n376_), .O(new_n661_));
  nand2  g531(.a(new_n348_), .b(x47), .O(new_n662_));
  nor2   g532(.a(new_n662_), .b(new_n651_), .O(new_n663_));
  nand4  g533(.a(new_n663_), .b(new_n661_), .c(new_n482_), .d(new_n378_), .O(new_n664_));
  inv1   g534(.a(new_n664_), .O(z62));
  nand4  g535(.a(new_n190_), .b(new_n181_), .c(x56), .d(new_n348_), .O(new_n666_));
  inv1   g536(.a(new_n666_), .O(new_n667_));
  nand4  g537(.a(new_n667_), .b(new_n661_), .c(new_n482_), .d(new_n378_), .O(new_n668_));
  inv1   g538(.a(new_n668_), .O(z63));
  nor2   g539(.a(new_n484_), .b(x60), .O(new_n670_));
  nand4  g540(.a(new_n670_), .b(new_n482_), .c(new_n289_), .d(x30), .O(new_n671_));
  nor3   g541(.a(new_n671_), .b(new_n381_), .c(new_n376_), .O(z64));
