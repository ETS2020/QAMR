// Benchmark "FAU" written by ABC on Thu Jun 25 18:55:05 2020
...
module FAU ( 
  ...
  inv1   g103(.a(x30), .O(new_n241_));
  nand3  g104(.a(new_n241_), .b(x29), .c(new_n172_), .O(new_n242_));
  inv1   g105(.a(new_n242_), .O(new_n243_));
  nor2   g106(.a(x22), .b(x18), .O(new_n244_));
  nand4  g107(.a(new_n244_), .b(new_n222_), .c(new_n187_), .d(new_n182_), .O(new_n245_));
  inv1   g108(.a(new_n245_), .O(new_n246_));
  nand3  g109(.a(new_n246_), .b(new_n243_), .c(new_n240_), .O(new_n247_));
  inv1   g110(.a(new_n211_), .O(new_n248_));
  nor2   g111(.a(x46), .b(x39), .O(new_n249_));
  nand3  g112(.a(new_n249_), .b(new_n162_), .c(new_n140_), .O(new_n250_));
  inv1   g113(.a(new_n250_), .O(new_n251_));
  inv1   g114(.a(x51), .O(new_n252_));
  nor2   g115(.a(x56), .b(new_n252_), .O(new_n253_));
  nand4  g116(.a(new_n253_), .b(new_n251_), .c(new_n248_), .d(new_n158_), .O(new_n254_));
  nor2   g117(.a(new_n254_), .b(new_n247_), .O(z20));
  nand3  g118(.a(new_n140_), .b(x29), .c(new_n172_), .O(new_n256_));
  nor2   g119(.a(new_n256_), .b(new_n163_), .O(new_n257_));
  nand2  g120(.a(new_n257_), .b(new_n215_), .O(new_n258_));
  nand3  g121(.a(new_n186_), .b(new_n185_), .c(new_n166_), .O(new_n259_));
  inv1   g122(.a(new_n259_), .O(new_n260_));
  nand4  g123(.a(new_n246_), .b(new_n260_), .c(new_n184_), .d(x00), .O(new_n261_));
  nor2   g124(.a(new_n261_), .b(new_n258_), .O(z21));
  nand3  g125(.a(new_n176_), .b(x29), .c(new_n139_), .O(new_n265_));
  inv1   g126(.a(x10), .O(new_n266_));
  nand4  g127(.a(new_n135_), .b(new_n138_), .c(x11), .d(new_n266_), .O(new_n267_));
  inv1   g128(.a(x39), .O(new_n268_));
  inv1   g129(.a(x50), .O(new_n269_));
  nand3  g130(.a(new_n210_), .b(new_n269_), .c(new_n268_), .O(new_n270_));
  nand2  g131(.a(new_n232_), .b(new_n140_), .O(new_n271_));
  nor4   g132(.a(new_n271_), .b(new_n270_), .c(new_n267_), .d(new_n265_), .O(z24));
  ...
  nand4  g139(.a(new_n280_), .b(new_n249_), .c(new_n206_), .d(new_n143_), .O(new_n281_));
  ...
  nand4  g146(.a(x60), .b(new_n199_), .c(new_n269_), .d(new_n287_), .O(new_n288_));
  nor2   g147(.a(new_n288_), .b(new_n286_), .O(z29));
  nand3  g148(.a(new_n199_), .b(new_n269_), .c(x46), .O(new_n292_));
  nor2   g149(.a(new_n292_), .b(new_n286_), .O(z32));
  nand4  g150(.a(new_n202_), .b(new_n269_), .c(new_n190_), .d(x39), .O(new_n294_));
  ...
  nor2   g155(.a(x62), .b(x61), .O(new_n299_));
  nand2  g156(.a(new_n299_), .b(new_n210_), .O(new_n300_));
  inv1   g157(.a(new_n300_), .O(new_n301_));
  inv1   g158(.a(x55), .O(new_n302_));
  nand3  g159(.a(new_n213_), .b(new_n302_), .c(new_n252_), .O(new_n303_));
  inv1   g160(.a(new_n303_), .O(new_n304_));
  nor2   g161(.a(x43), .b(x41), .O(new_n305_));
  nand4  g162(.a(new_n305_), .b(new_n304_), .c(new_n301_), .d(new_n212_), .O(new_n306_));
  inv1   g163(.a(new_n238_), .O(new_n307_));
  nand3  g164(.a(new_n168_), .b(new_n166_), .c(x04), .O(new_n308_));
  nor2   g165(.a(new_n308_), .b(new_n307_), .O(new_n309_));
  nand2  g166(.a(new_n244_), .b(new_n169_), .O(new_n310_));
  nor2   g167(.a(new_n310_), .b(new_n177_), .O(new_n311_));
  inv1   g168(.a(x35), .O(new_n312_));
  nor2   g169(.a(x40), .b(x39), .O(new_n313_));
  nand3  g170(.a(new_n313_), .b(new_n312_), .c(new_n241_), .O(new_n314_));
  nor2   g171(.a(new_n314_), .b(new_n174_), .O(new_n315_));
  nand3  g172(.a(new_n315_), .b(new_n311_), .c(new_n309_), .O(new_n316_));
  nor2   g173(.a(new_n316_), .b(new_n306_), .O(z35));
  nor2   g174(.a(new_n245_), .b(new_n242_), .O(new_n318_));
  nand3  g175(.a(new_n212_), .b(new_n252_), .c(new_n269_), .O(new_n319_));
  nor2   g176(.a(x37), .b(x35), .O(new_n320_));
  nand3  g177(.a(new_n320_), .b(new_n305_), .c(new_n313_), .O(new_n321_));
  nor2   g178(.a(new_n321_), .b(new_n319_), .O(new_n322_));
  inv1   g179(.a(x56), .O(new_n323_));
  nand2  g180(.a(new_n323_), .b(new_n302_), .O(new_n324_));
  nand3  g181(.a(new_n210_), .b(new_n153_), .c(x61), .O(new_n325_));
  nor2   g182(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  nand4  g183(.a(new_n326_), .b(new_n322_), .c(new_n318_), .d(new_n240_), .O(new_n327_));
  inv1   g184(.a(new_n327_), .O(z36));
  nand2  g185(.a(new_n175_), .b(new_n168_), .O(new_n330_));
  nor2   g186(.a(x06), .b(x04), .O(new_n331_));
  nand2  g187(.a(new_n331_), .b(new_n238_), .O(new_n332_));
  nor2   g188(.a(new_n332_), .b(new_n330_), .O(new_n333_));
  nand3  g189(.a(new_n176_), .b(new_n139_), .c(new_n172_), .O(new_n334_));
  nor2   g190(.a(new_n334_), .b(new_n310_), .O(new_n335_));
  inv1   g191(.a(x41), .O(new_n336_));
  nand2  g192(.a(new_n313_), .b(new_n336_), .O(new_n337_));
  nand4  g193(.a(new_n173_), .b(new_n312_), .c(new_n241_), .d(x29), .O(new_n338_));
  nor2   g194(.a(new_n338_), .b(new_n337_), .O(new_n339_));
  nand3  g195(.a(new_n339_), .b(new_n335_), .c(new_n333_), .O(new_n340_));
  nand4  g196(.a(new_n323_), .b(new_n302_), .c(new_n252_), .d(new_n269_), .O(new_n341_));
  inv1   g197(.a(new_n341_), .O(new_n342_));
  nor2   g198(.a(x43), .b(x42), .O(new_n343_));
  nand4  g199(.a(new_n343_), .b(new_n342_), .c(new_n301_), .d(new_n212_), .O(new_n344_));
  nor2   g200(.a(new_n344_), .b(new_n340_), .O(z38));
  nand3  g201(.a(new_n212_), .b(new_n198_), .c(x42), .O(new_n346_));
  inv1   g202(.a(new_n346_), .O(new_n347_));
  nand3  g203(.a(new_n347_), .b(new_n342_), .c(new_n301_), .O(new_n348_));
  nor2   g204(.a(new_n348_), .b(new_n340_), .O(z39));
  nand2  g205(.a(new_n323_), .b(x55), .O(new_n364_));
  nor2   g206(.a(new_n364_), .b(new_n211_), .O(new_n365_));
  nand4  g207(.a(new_n365_), .b(new_n322_), .c(new_n318_), .d(new_n240_), .O(new_n366_));
  inv1   g208(.a(new_n366_), .O(z54));
  inv1   g209(.a(new_n319_), .O(new_n368_));
  nand2  g210(.a(new_n305_), .b(new_n313_), .O(new_n369_));
  inv1   g211(.a(new_n369_), .O(new_n370_));
  nor2   g212(.a(x37), .b(new_n312_), .O(new_n371_));
  nand4  g213(.a(new_n371_), .b(new_n370_), .c(new_n368_), .d(new_n156_), .O(new_n372_));
  nor2   g214(.a(new_n372_), .b(new_n247_), .O(z55));
  inv1   g215(.a(x08), .O(new_n375_));
  nand4  g216(.a(new_n375_), .b(new_n185_), .c(new_n166_), .d(new_n184_), .O(new_n376_));
  nor2   g217(.a(new_n376_), .b(new_n227_), .O(new_n377_));
  inv1   g218(.a(x22), .O(new_n378_));
  nand3  g219(.a(new_n176_), .b(new_n378_), .c(x18), .O(new_n379_));
  nor2   g220(.a(new_n379_), .b(new_n174_), .O(new_n380_));
  nand2  g221(.a(new_n380_), .b(new_n377_), .O(new_n381_));
  nor2   g222(.a(new_n381_), .b(new_n165_), .O(z57));
  inv1   g223(.a(new_n214_), .O(new_n383_));
  nand3  g224(.a(new_n383_), .b(new_n248_), .c(new_n164_), .O(new_n384_));
  inv1   g225(.a(x24), .O(new_n385_));
  nand3  g226(.a(new_n222_), .b(new_n385_), .c(x22), .O(new_n386_));
  nor2   g227(.a(new_n386_), .b(new_n256_), .O(new_n387_));
  nand2  g228(.a(new_n387_), .b(new_n377_), .O(new_n388_));
  nor2   g229(.a(new_n388_), .b(new_n384_), .O(z58));
  nor2   g230(.a(x58), .b(x50), .O(new_n390_));
  nand3  g231(.a(new_n390_), .b(new_n198_), .c(x40), .O(new_n391_));
  nor2   g232(.a(new_n391_), .b(new_n197_), .O(z59));
  nor2   g233(.a(x08), .b(new_n185_), .O(new_n393_));
  nand2  g234(.a(new_n154_), .b(new_n152_), .O(new_n394_));
  nor2   g235(.a(new_n394_), .b(new_n233_), .O(new_n395_));
  nand4  g236(.a(new_n395_), .b(new_n393_), .c(new_n230_), .d(new_n228_), .O(new_n396_));
  inv1   g237(.a(new_n396_), .O(z60));
  nor2   g238(.a(x10), .b(new_n375_), .O(new_n398_));
  nand4  g239(.a(new_n398_), .b(new_n222_), .c(new_n187_), .d(new_n182_), .O(new_n399_));
  nand2  g240(.a(new_n213_), .b(new_n210_), .O(new_n400_));
  inv1   g241(.a(new_n400_), .O(new_n401_));
  nand2  g242(.a(new_n212_), .b(new_n206_), .O(new_n402_));
  inv1   g243(.a(new_n402_), .O(new_n403_));
  nand4  g244(.a(new_n403_), .b(new_n401_), .c(new_n161_), .d(new_n143_), .O(new_n404_));
  nor2   g245(.a(new_n404_), .b(new_n399_), .O(z61));
  nor2   g246(.a(new_n265_), .b(new_n227_), .O(new_n406_));
  nand2  g247(.a(new_n269_), .b(x47), .O(new_n407_));
  nor2   g248(.a(new_n407_), .b(new_n394_), .O(new_n408_));
  nand4  g249(.a(new_n408_), .b(new_n406_), .c(new_n273_), .d(new_n161_), .O(new_n409_));
  inv1   g250(.a(new_n409_), .O(z62));
  nand3  g251(.a(new_n390_), .b(new_n152_), .c(x56), .O(new_n411_));
  inv1   g252(.a(new_n411_), .O(new_n412_));
  nand4  g253(.a(new_n412_), .b(new_n406_), .c(new_n273_), .d(new_n161_), .O(new_n413_));
  inv1   g254(.a(new_n413_), .O(z63));
  nor2   g255(.a(x37), .b(new_n241_), .O(new_n415_));
  nand4  g256(.a(new_n415_), .b(new_n313_), .c(new_n282_), .d(new_n157_), .O(new_n416_));
  nor3   g257(.a(new_n416_), .b(new_n265_), .c(new_n227_), .O(z64));
  zero   g258(.O(z00));
  zero   g259(.O(z01));
  zero   g260(.O(z02));
  zero   g261(.O(z03));
