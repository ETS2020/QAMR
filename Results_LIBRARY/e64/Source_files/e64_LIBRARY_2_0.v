// Benchmark "FAU" written by ABC on Thu Jun 25 18:53:54 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n505_, new_n507_, new_n508_, new_n509_, new_n512_, new_n513_,
  ...
  inv1   g350(.a(x63), .O(new_n492_));
  nand2  g351(.a(new_n286_), .b(new_n492_), .O(new_n493_));
  nor2   g352(.a(new_n493_), .b(new_n323_), .O(z52));
  nand2  g353(.a(new_n286_), .b(x63), .O(new_n495_));
  nor2   g354(.a(new_n495_), .b(new_n323_), .O(z53));
  nor3   g355(.a(new_n260_), .b(x56), .c(new_n132_), .O(new_n497_));
  nand4  g356(.a(new_n497_), .b(new_n389_), .c(new_n332_), .d(new_n329_), .O(new_n498_));
  inv1   g357(.a(new_n498_), .O(z54));
  nor2   g358(.a(x37), .b(new_n150_), .O(new_n500_));
  nand4  g359(.a(new_n500_), .b(new_n405_), .c(new_n387_), .d(new_n223_), .O(new_n501_));
  nor2   g360(.a(new_n501_), .b(new_n333_), .O(z55));
  nand4  g361(.a(new_n276_), .b(new_n237_), .c(new_n301_), .d(new_n166_), .O(new_n504_));
  nand3  g362(.a(new_n172_), .b(new_n309_), .c(x18), .O(new_n505_));
  nor4   g363(.a(new_n505_), .b(new_n504_), .c(new_n227_), .d(new_n156_), .O(z57));
  inv1   g364(.a(new_n262_), .O(new_n507_));
  nand3  g365(.a(new_n387_), .b(new_n507_), .c(new_n404_), .O(new_n508_));
  nand3  g366(.a(new_n270_), .b(new_n310_), .c(x22), .O(new_n509_));
  nor4   g367(.a(new_n509_), .b(new_n508_), .c(new_n504_), .d(new_n308_), .O(z58));
  nor4   g368(.a(new_n358_), .b(new_n248_), .c(x43), .d(new_n241_), .O(z59));
  nor3   g369(.a(new_n275_), .b(x08), .c(new_n267_), .O(new_n512_));
  nand2  g370(.a(new_n133_), .b(new_n142_), .O(new_n513_));
  nor2   g371(.a(new_n513_), .b(new_n225_), .O(new_n514_));
  nand3  g372(.a(new_n514_), .b(new_n512_), .c(new_n281_), .O(new_n515_));
  inv1   g373(.a(new_n515_), .O(z60));
  nor2   g374(.a(x10), .b(new_n301_), .O(new_n517_));
  nand4  g375(.a(new_n517_), .b(new_n270_), .c(new_n235_), .d(new_n176_), .O(new_n518_));
  nand3  g376(.a(new_n259_), .b(new_n261_), .c(new_n246_), .O(new_n519_));
  nand2  g377(.a(new_n254_), .b(new_n195_), .O(new_n520_));
  nand2  g378(.a(new_n161_), .b(new_n155_), .O(new_n521_));
  nor4   g379(.a(new_n521_), .b(new_n520_), .c(new_n519_), .d(new_n518_), .O(z61));
  nor2   g380(.a(new_n280_), .b(new_n275_), .O(new_n523_));
  nor3   g381(.a(new_n513_), .b(x50), .c(new_n288_), .O(new_n524_));
  nand4  g382(.a(new_n524_), .b(new_n523_), .c(new_n356_), .d(new_n277_), .O(new_n525_));
  inv1   g383(.a(new_n525_), .O(z62));
  nand4  g384(.a(new_n142_), .b(new_n182_), .c(x56), .d(new_n246_), .O(new_n527_));
  inv1   g385(.a(new_n527_), .O(new_n528_));
  nand4  g386(.a(new_n528_), .b(new_n523_), .c(new_n356_), .d(new_n277_), .O(new_n529_));
  inv1   g387(.a(new_n529_), .O(z63));
  nor2   g388(.a(new_n358_), .b(x60), .O(new_n531_));
  nand4  g389(.a(new_n531_), .b(new_n356_), .c(new_n208_), .d(x30), .O(new_n532_));
  nor3   g390(.a(new_n532_), .b(new_n280_), .c(new_n275_), .O(z64));
  zero   g391(.O(z02));
  zero   g392(.O(z03));
  zero   g393(.O(z08));
  zero   g394(.O(z09));
