...
module FAU ( 
  ...
  nand2  g394(.a(new_n196_), .b(new_n348_), .O(new_n525_));
  nor3   g395(.a(new_n525_), .b(new_n521_), .c(new_n423_), .O(new_n526_));
  inv1   g396(.a(x51), .O(new_n527_));
  nand3  g397(.a(new_n133_), .b(new_n132_), .c(new_n527_), .O(new_n528_));
  nor4   g398(.a(new_n528_), .b(x62), .c(new_n191_), .d(x60), .O(new_n529_));
  nand4  g399(.a(new_n529_), .b(new_n526_), .c(new_n416_), .d(new_n414_), .O(new_n530_));
  ...
  nand3  g429(.a(new_n394_), .b(new_n261_), .c(new_n255_), .O(new_n560_));
  nand2  g430(.a(new_n135_), .b(new_n527_), .O(new_n561_));
  nor3   g431(.a(new_n561_), .b(new_n560_), .c(new_n481_), .O(new_n562_));
  nand4  g432(.a(new_n562_), .b(new_n559_), .c(new_n558_), .d(new_n540_), .O(new_n563_));
  nand4  g433(.a(new_n146_), .b(new_n133_), .c(new_n132_), .d(x54), .O(new_n564_));
  nor2   g434(.a(new_n564_), .b(new_n563_), .O(z40));
  nand3  g435(.a(new_n559_), .b(new_n558_), .c(new_n540_), .O(new_n566_));
  inv1   g436(.a(new_n528_), .O(new_n567_));
  ...
  nand4  g440(.a(new_n570_), .b(new_n567_), .c(new_n330_), .d(new_n146_), .O(new_n571_));
  ...
  nand4  g463(.a(new_n593_), .b(new_n592_), .c(new_n591_), .d(new_n559_), .O(new_n594_));
  nor2   g464(.a(new_n594_), .b(new_n590_), .O(z44));
  nor2   g465(.a(x35), .b(new_n568_), .O(new_n596_));
  nor3   g466(.a(new_n548_), .b(new_n193_), .c(new_n184_), .O(new_n597_));
  ...
  nand4  g470(.a(new_n567_), .b(new_n600_), .c(new_n330_), .d(new_n146_), .O(new_n601_));
  ...
  nand4  g511(.a(new_n641_), .b(new_n549_), .c(new_n424_), .d(new_n327_), .O(new_n642_));
  ...
  nand3  g521(.a(new_n424_), .b(new_n651_), .c(new_n547_), .O(new_n652_));
