// Benchmark "FAU" written by ABC on Thu Jun 25 18:55:06 2020
...
module FAU ( 
  ...
  inv1   g136(.a(new_n252_), .O(new_n267_));
  nand2  g137(.a(new_n238_), .b(new_n237_), .O(new_n268_));
  nand2  g138(.a(new_n239_), .b(new_n192_), .O(new_n269_));
  ...
  nor2   g142(.a(new_n272_), .b(new_n247_), .O(new_n273_));
  nand4  g143(.a(new_n273_), .b(new_n270_), .c(new_n267_), .d(new_n266_), .O(new_n274_));
  nor2   g144(.a(new_n274_), .b(new_n265_), .O(z03));
  inv1   g145(.a(x15), .O(new_n276_));
  nor2   g146(.a(new_n155_), .b(new_n276_), .O(z04));
  nand2  g147(.a(x29), .b(new_n154_), .O(new_n278_));
  inv1   g148(.a(x37), .O(new_n279_));
  inv1   g149(.a(x43), .O(new_n280_));
  nand2  g150(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  nor4   g151(.a(new_n281_), .b(new_n278_), .c(x15), .d(new_n219_), .O(z06));
  nor2   g152(.a(x37), .b(new_n155_), .O(new_n283_));
  nand2  g153(.a(new_n283_), .b(x43), .O(new_n284_));
  nor3   g154(.a(new_n284_), .b(x28), .c(x15), .O(z07));
  inv1   g155(.a(x63), .O(new_n286_));
  nand3  g156(.a(new_n146_), .b(new_n237_), .c(new_n286_), .O(new_n287_));
  nor2   g157(.a(x60), .b(x58), .O(new_n288_));
  nand2  g158(.a(new_n288_), .b(new_n239_), .O(new_n289_));
  nand3  g159(.a(new_n184_), .b(new_n131_), .c(new_n234_), .O(new_n290_));
  nor3   g160(.a(new_n290_), .b(new_n289_), .c(new_n287_), .O(new_n291_));
  nand2  g161(.a(new_n163_), .b(new_n160_), .O(new_n292_));
  nor3   g162(.a(new_n292_), .b(x39), .c(new_n245_), .O(new_n293_));
  ...
  nand2  g177(.a(new_n258_), .b(new_n248_), .O(new_n308_));
  ...
  nor2   g182(.a(new_n312_), .b(new_n252_), .O(new_n313_));
  nand4  g183(.a(new_n313_), .b(new_n309_), .c(new_n305_), .d(new_n241_), .O(new_n314_));
  nor2   g184(.a(new_n314_), .b(new_n301_), .O(z09));
  nand3  g185(.a(new_n283_), .b(x28), .c(new_n276_), .O(new_n316_));
  inv1   g186(.a(new_n316_), .O(z10));
  nand3  g187(.a(x37), .b(x29), .c(new_n276_), .O(new_n318_));
  ...
  nand4  g215(.a(new_n345_), .b(new_n261_), .c(new_n279_), .d(new_n276_), .O(new_n346_));
  ...
  nand4  g219(.a(new_n154_), .b(new_n276_), .c(new_n219_), .d(x10), .O(new_n350_));
  ...
  nand2  g226(.a(new_n288_), .b(new_n191_), .O(new_n357_));
  ...
  nand2  g243(.a(new_n373_), .b(new_n306_), .O(new_n374_));
  ...
  nor2   g259(.a(new_n389_), .b(new_n302_), .O(new_n390_));
  nand2  g260(.a(new_n311_), .b(new_n196_), .O(new_n391_));
  nand2  g261(.a(new_n310_), .b(new_n306_), .O(new_n392_));
  ...
  nand2  g266(.a(new_n251_), .b(new_n187_), .O(new_n397_));
  ...
  nor4   g281(.a(new_n411_), .b(new_n363_), .c(new_n278_), .d(x30), .O(new_n412_));
  ...
  nand2  g288(.a(new_n418_), .b(new_n306_), .O(new_n419_));
  inv1   g289(.a(new_n419_), .O(new_n420_));
  nand2  g290(.a(new_n373_), .b(new_n261_), .O(new_n421_));
  ...
  nand2  g301(.a(new_n261_), .b(new_n230_), .O(new_n432_));
  nor2   g302(.a(new_n432_), .b(new_n431_), .O(new_n433_));
  nand3  g303(.a(new_n388_), .b(new_n246_), .c(x36), .O(new_n434_));
  nand2  g304(.a(new_n262_), .b(new_n258_), .O(new_n435_));
  nor2   g305(.a(new_n435_), .b(new_n434_), .O(new_n436_));
  nor2   g306(.a(new_n295_), .b(new_n292_), .O(new_n437_));
  ...
  inv1   g310(.a(new_n292_), .O(new_n441_));
  inv1   g311(.a(x36), .O(new_n442_));
  nand3  g312(.a(new_n388_), .b(new_n246_), .c(new_n442_), .O(new_n443_));
  ...
  nand3  g317(.a(new_n174_), .b(new_n303_), .c(new_n225_), .O(new_n448_));
  nor2   g318(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  nor2   g319(.a(new_n435_), .b(new_n432_), .O(new_n450_));
  nand4  g320(.a(new_n450_), .b(new_n449_), .c(new_n446_), .d(new_n291_), .O(new_n451_));
  nor2   g321(.a(new_n451_), .b(new_n440_), .O(z23));
  nand3  g322(.a(new_n345_), .b(new_n276_), .c(x11), .O(new_n453_));
  nand3  g323(.a(new_n288_), .b(new_n344_), .c(new_n159_), .O(new_n454_));
  nor4   g324(.a(new_n454_), .b(new_n453_), .c(new_n375_), .d(new_n353_), .O(z24));
  nand2  g325(.a(new_n345_), .b(new_n276_), .O(new_n456_));
  nand4  g326(.a(new_n354_), .b(new_n261_), .c(new_n332_), .d(x24), .O(new_n457_));
  nor3   g327(.a(new_n457_), .b(new_n454_), .c(new_n456_), .O(z25));
  inv1   g328(.a(new_n222_), .O(new_n459_));
  nand4  g329(.a(new_n311_), .b(new_n310_), .c(new_n306_), .d(new_n259_), .O(new_n460_));
  nor3   g330(.a(new_n460_), .b(new_n252_), .c(new_n236_), .O(new_n461_));
  ...
  nor2   g336(.a(new_n466_), .b(new_n302_), .O(new_n467_));
  nand4  g337(.a(new_n467_), .b(new_n464_), .c(new_n461_), .d(new_n270_), .O(new_n468_));
  nor2   g338(.a(new_n468_), .b(new_n459_), .O(z26));
  nor2   g339(.a(new_n290_), .b(new_n138_), .O(new_n470_));
  nor2   g340(.a(new_n289_), .b(new_n287_), .O(new_n471_));
  ...
  nand2  g349(.a(new_n323_), .b(new_n306_), .O(new_n480_));
  inv1   g350(.a(new_n480_), .O(new_n481_));
  nand4  g351(.a(new_n481_), .b(new_n283_), .c(new_n154_), .d(x25), .O(new_n482_));
  nand2  g352(.a(new_n183_), .b(new_n344_), .O(new_n483_));
  nor4   g353(.a(new_n483_), .b(new_n482_), .c(new_n456_), .d(x60), .O(z28));
  nand2  g354(.a(new_n306_), .b(new_n280_), .O(new_n485_));
  ...
  nor2   g362(.a(new_n307_), .b(new_n152_), .O(new_n493_));
  nand4  g363(.a(new_n493_), .b(new_n492_), .c(new_n490_), .d(new_n313_), .O(new_n494_));
  ...
  nand2  g368(.a(new_n259_), .b(new_n151_), .O(new_n499_));
  ...
  nor4   g376(.a(new_n427_), .b(new_n281_), .c(new_n278_), .d(new_n183_), .O(z34));
  ...
  inv1   g383(.a(new_n306_), .O(new_n514_));
  ...
  nand3  g391(.a(new_n288_), .b(new_n191_), .c(x61), .O(new_n522_));
  ...
  nand3  g395(.a(new_n441_), .b(new_n249_), .c(new_n162_), .O(new_n526_));
  ...
  nand4  g400(.a(new_n530_), .b(new_n528_), .c(new_n527_), .d(new_n291_), .O(new_n531_));
  ...
  nand3  g417(.a(new_n196_), .b(new_n280_), .c(x42), .O(new_n548_));
  ...
  nand3  g424(.a(new_n388_), .b(new_n310_), .c(new_n258_), .O(new_n555_));
  ...
  nor2   g447(.a(new_n383_), .b(new_n302_), .O(new_n578_));
  ...
  nand4  g455(.a(new_n585_), .b(new_n294_), .c(new_n160_), .d(new_n139_), .O(new_n586_));
  ...
  nand3  g477(.a(new_n373_), .b(new_n246_), .c(new_n607_), .O(new_n608_));
  nor2   g478(.a(new_n608_), .b(new_n292_), .O(new_n609_));
  ...
  nor2   g494(.a(new_n624_), .b(new_n292_), .O(new_n625_));
  nor3   g495(.a(new_n598_), .b(x14), .c(new_n202_), .O(new_n626_));
  nor2   g496(.a(new_n497_), .b(new_n243_), .O(new_n627_));
  nand4  g497(.a(new_n627_), .b(new_n626_), .c(new_n625_), .d(new_n298_), .O(new_n628_));
  nand2  g498(.a(new_n270_), .b(new_n381_), .O(new_n629_));
  ...
  nand4  g510(.a(new_n640_), .b(new_n461_), .c(new_n270_), .d(new_n158_), .O(new_n641_));
  ...
  nand3  g517(.a(new_n230_), .b(new_n303_), .c(x22), .O(new_n648_));
  ...
  nand3  g527(.a(new_n288_), .b(new_n358_), .c(new_n344_), .O(new_n658_));
  ...
  nand4  g541(.a(new_n671_), .b(new_n481_), .c(new_n279_), .d(x30), .O(new_n672_));
