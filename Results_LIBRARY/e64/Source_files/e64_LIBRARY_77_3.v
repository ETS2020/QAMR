...
module FAU ( 
  ...
  nand2  g369(.a(new_n250_), .b(new_n160_), .O(new_n500_));
  ...
  inv1   g398(.a(new_n500_), .O(new_n529_));
  nand2  g399(.a(new_n529_), .b(new_n444_), .O(new_n530_));
  ...
  nand4  g458(.a(new_n588_), .b(new_n252_), .c(new_n158_), .d(new_n300_), .O(new_n589_));
  ...
  nand4  g507(.a(new_n637_), .b(new_n524_), .c(new_n415_), .d(new_n413_), .O(new_n638_));
  ...
  nand4  g514(.a(new_n644_), .b(new_n464_), .c(new_n273_), .d(new_n156_), .O(new_n645_));
  ...
  nor4   g523(.a(new_n483_), .b(new_n349_), .c(x43), .d(new_n313_), .O(z59));
  ...
  nand4  g545(.a(new_n675_), .b(new_n481_), .c(new_n288_), .d(x30), .O(new_n676_));
