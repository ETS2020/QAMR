...
module FAU ( 
  ...
  nor2   g493(.a(new_n434_), .b(new_n163_), .O(new_n624_));
  nand3  g494(.a(new_n624_), .b(new_n623_), .c(new_n157_), .O(new_n625_));
  nor2   g495(.a(new_n429_), .b(new_n250_), .O(new_n626_));
  nand4  g496(.a(new_n626_), .b(new_n305_), .c(new_n304_), .d(new_n382_), .O(new_n627_));
  nor2   g497(.a(new_n627_), .b(new_n625_), .O(z52));
  nand2  g498(.a(new_n235_), .b(x63), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(new_n403_), .O(z53));
  nor3   g500(.a(new_n358_), .b(x56), .c(new_n132_), .O(new_n631_));
  nand4  g501(.a(new_n631_), .b(new_n521_), .c(new_n412_), .d(new_n410_), .O(new_n632_));
  inv1   g502(.a(new_n632_), .O(z54));
  nor2   g503(.a(x37), .b(new_n589_), .O(new_n634_));
  nand4  g504(.a(new_n634_), .b(new_n542_), .c(new_n420_), .d(new_n324_), .O(new_n635_));
  nor2   g505(.a(new_n635_), .b(new_n413_), .O(z55));
  nand2  g506(.a(new_n493_), .b(new_n562_), .O(new_n637_));
  nand2  g507(.a(new_n573_), .b(new_n302_), .O(new_n638_));
  nor2   g508(.a(new_n638_), .b(new_n637_), .O(new_n639_));
  nand3  g509(.a(new_n224_), .b(x20), .c(new_n385_), .O(new_n640_));
  nor3   g510(.a(new_n640_), .b(x18), .c(x16), .O(new_n641_));
  nor2   g511(.a(new_n488_), .b(new_n242_), .O(new_n642_));
  nand4  g512(.a(new_n642_), .b(new_n641_), .c(new_n639_), .d(new_n272_), .O(new_n643_));
  nor2   g513(.a(new_n643_), .b(new_n438_), .O(z56));
  nand4  g514(.a(new_n372_), .b(new_n337_), .c(new_n202_), .d(new_n166_), .O(new_n645_));
  inv1   g515(.a(x22), .O(new_n646_));
  nand3  g516(.a(new_n174_), .b(new_n646_), .c(x18), .O(new_n647_));
  nor4   g517(.a(new_n647_), .b(new_n645_), .c(new_n328_), .d(new_n156_), .O(z57));
  nand2  g518(.a(new_n373_), .b(new_n308_), .O(new_n649_));
  inv1   g519(.a(new_n359_), .O(new_n650_));
  nand3  g520(.a(new_n420_), .b(new_n650_), .c(new_n541_), .O(new_n651_));
  nand3  g521(.a(new_n229_), .b(new_n228_), .c(x22), .O(new_n652_));
  nor4   g522(.a(new_n652_), .b(new_n651_), .c(new_n645_), .d(new_n649_), .O(z58));
  nor4   g523(.a(new_n480_), .b(new_n347_), .c(x43), .d(new_n312_), .O(z59));
  nor3   g524(.a(new_n371_), .b(x08), .c(new_n209_), .O(new_n655_));
  nand2  g525(.a(new_n133_), .b(new_n145_), .O(new_n656_));
  nor2   g526(.a(new_n656_), .b(new_n326_), .O(new_n657_));
  nand3  g527(.a(new_n657_), .b(new_n655_), .c(new_n377_), .O(new_n658_));
  inv1   g528(.a(new_n658_), .O(z60));
  nor2   g529(.a(x10), .b(new_n202_), .O(new_n660_));
  nand4  g530(.a(new_n660_), .b(new_n366_), .c(new_n335_), .d(new_n176_), .O(new_n661_));
  nand3  g531(.a(new_n267_), .b(new_n270_), .c(new_n345_), .O(new_n662_));
  nand2  g532(.a(new_n353_), .b(new_n195_), .O(new_n663_));
  nand2  g533(.a(new_n161_), .b(new_n155_), .O(new_n664_));
  nor4   g534(.a(new_n664_), .b(new_n663_), .c(new_n662_), .d(new_n661_), .O(z61));
  nor2   g535(.a(new_n376_), .b(new_n371_), .O(new_n666_));
  nand2  g536(.a(new_n345_), .b(x47), .O(new_n667_));
  nor2   g537(.a(new_n667_), .b(new_n656_), .O(new_n668_));
  nand4  g538(.a(new_n668_), .b(new_n666_), .c(new_n478_), .d(new_n373_), .O(new_n669_));
  inv1   g539(.a(new_n669_), .O(z62));
  nand4  g540(.a(new_n145_), .b(new_n182_), .c(x56), .d(new_n345_), .O(new_n671_));
  inv1   g541(.a(new_n671_), .O(new_n672_));
  nand4  g542(.a(new_n672_), .b(new_n666_), .c(new_n478_), .d(new_n373_), .O(new_n673_));
  inv1   g543(.a(new_n673_), .O(z63));
  nor2   g544(.a(new_n480_), .b(x60), .O(new_n675_));
  nand4  g545(.a(new_n675_), .b(new_n478_), .c(new_n283_), .d(x30), .O(new_n676_));
