// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:53 2020
...
module FAU ( 
  ...
  nand3  g24(.a(new_n49_), .b(new_n43_), .c(new_n41_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n28_), .O(new_n51_));
  inv1   g26(.a(x10), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(x01), .c(new_n41_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  nand4  g31(.a(x13), .b(new_n56_), .c(new_n55_), .d(new_n31_), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(new_n58_));
  oai21  g33(.a(new_n54_), .b(new_n51_), .c(new_n58_), .O(new_n59_));
  nand3  g34(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n60_));
  ...
  nand4  g38(.a(x13), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n60_), .c(new_n61_), .O(z08));
  and2   g40(.a(x13), .b(x06), .O(z09));
  nand3  g41(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n67_));
