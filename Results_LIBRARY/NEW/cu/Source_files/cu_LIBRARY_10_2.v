...
module FAU ( 
  ...
  nand3  g26(.a(new_n51_), .b(x01), .c(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand2  g28(.a(x05), .b(new_n31_), .O(new_n54_));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  nand3  g31(.a(x13), .b(new_n56_), .c(new_n55_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  oai21  g33(.a(new_n53_), .b(new_n50_), .c(new_n58_), .O(new_n59_));
