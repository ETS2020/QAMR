...
module FAU ( 
  ...
  nand2  g11(.a(new_n27_), .b(new_n30_), .O(new_n37_));
  ...
  nand2  g30(.a(x05), .b(new_n30_), .O(new_n56_));
  ...
  nand4  g40(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n62_), .c(new_n63_), .O(z08));
  and2   g42(.a(x13), .b(x06), .O(z09));
  oai21  g43(.a(new_n27_), .b(x02), .c(new_n28_), .O(new_n69_));
  nand2  g44(.a(x06), .b(new_n30_), .O(new_n70_));
