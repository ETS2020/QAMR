...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n43_), .O(new_n47_));
  ...
  nand2  g29(.a(x05), .b(new_n41_), .O(new_n55_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(new_n56_));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n31_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  oai21  g35(.a(new_n56_), .b(new_n50_), .c(new_n60_), .O(new_n61_));
