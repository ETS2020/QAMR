...
module FAU ( 
  ...
  inv1   g33(.a(x01), .O(new_n80_));
  nand2  g34(.a(x18), .b(new_n80_), .O(new_n81_));
  nand3  g35(.a(new_n81_), .b(new_n79_), .c(x09), .O(new_n82_));
  ...
  nand2  g42(.a(new_n88_), .b(new_n79_), .O(new_n89_));
  ...
  oai21  g46(.a(new_n92_), .b(new_n79_), .c(new_n89_), .O(z11));
  ...
  oai21  g53(.a(new_n99_), .b(new_n79_), .c(new_n96_), .O(z12));
  nand2  g54(.a(x18), .b(x04), .O(new_n101_));
  oai21  g55(.a(x18), .b(new_n60_), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n79_), .O(new_n103_));
  ...
  nand2  g73(.a(new_n119_), .b(new_n79_), .O(new_n120_));
  ...
  nand2  g83(.a(new_n129_), .b(new_n79_), .O(new_n130_));
