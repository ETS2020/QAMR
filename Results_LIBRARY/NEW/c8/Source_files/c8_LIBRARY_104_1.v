// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:49 2020
...
module FAU ( 
  ...
  aoi21  g65(.a(new_n109_), .b(new_n84_), .c(x24), .O(new_n112_));
  nand2  g66(.a(x18), .b(x05), .O(new_n113_));
  oai21  g67(.a(x18), .b(new_n63_), .c(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n87_), .O(new_n115_));
  oai21  g69(.a(new_n112_), .b(new_n87_), .c(new_n115_), .O(z14));
  inv1   g70(.a(x14), .O(new_n117_));
  nand2  g71(.a(x18), .b(x06), .O(new_n118_));
  oai21  g72(.a(x18), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n87_), .O(new_n120_));
  aoi21  g74(.a(new_n109_), .b(new_n84_), .c(new_n66_), .O(new_n121_));
  nor2   g75(.a(x25), .b(x23), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n123_));
  ...
  nand2  g83(.a(new_n129_), .b(new_n87_), .O(new_n130_));
  nand4  g84(.a(new_n69_), .b(new_n66_), .c(new_n60_), .d(new_n57_), .O(new_n131_));
  inv1   g85(.a(new_n131_), .O(new_n132_));
  aoi22  g86(.a(new_n132_), .b(new_n94_), .c(new_n123_), .d(x26), .O(new_n133_));
  oai21  g87(.a(new_n133_), .b(new_n87_), .c(new_n130_), .O(z16));
  nor2   g88(.a(x21), .b(x20), .O(new_n135_));
  nand4  g89(.a(new_n132_), .b(new_n135_), .c(x19), .d(new_n72_), .O(new_n136_));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n87_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
