...
module FAU ( 
  ...
  nand2  g84(.a(new_n130_), .b(new_n69_), .O(new_n131_));
  nand3  g85(.a(new_n131_), .b(new_n75_), .c(x07), .O(new_n132_));
  nand2  g86(.a(new_n126_), .b(x26), .O(new_n133_));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n124_), .c(new_n93_), .d(new_n73_), .O(new_n135_));
  ...
  nand4  g93(.a(new_n139_), .b(new_n134_), .c(new_n124_), .d(new_n93_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n75_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
