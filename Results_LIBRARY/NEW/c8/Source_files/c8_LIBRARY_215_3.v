...
module FAU ( 
  ...
  nand2  g75(.a(new_n69_), .b(x20), .O(new_n122_));
  nor3   g76(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n122_), .c(new_n98_), .d(new_n73_), .O(new_n124_));
  nand2  g78(.a(new_n114_), .b(x25), .O(new_n125_));
  ...
  nor2   g87(.a(x24), .b(x21), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n73_), .d(new_n66_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x26), .O(new_n136_));
  nor3   g90(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n133_), .c(new_n91_), .d(new_n73_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n132_), .O(z16));
  nor2   g95(.a(new_n48_), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n137_), .c(new_n133_), .d(new_n91_), .O(new_n143_));
