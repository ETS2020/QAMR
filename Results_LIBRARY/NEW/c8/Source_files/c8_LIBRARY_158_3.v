// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:05 2020
...
module FAU ( 
  ...
  nand3  g46(.a(new_n92_), .b(new_n75_), .c(x10), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  aoi21  g48(.a(x18), .b(x02), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n91_), .b(new_n75_), .c(new_n95_), .O(z11));
  nand2  g50(.a(x18), .b(x03), .O(new_n97_));
  oai21  g51(.a(x18), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n75_), .O(new_n99_));
  nand2  g53(.a(new_n90_), .b(new_n73_), .O(new_n100_));
  nor2   g54(.a(x22), .b(x21), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n86_), .c(new_n100_), .d(x22), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n75_), .c(new_n99_), .O(z12));
  nand2  g57(.a(x18), .b(x04), .O(new_n104_));
  oai21  g58(.a(x18), .b(new_n60_), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n75_), .O(new_n106_));
  nand3  g60(.a(new_n101_), .b(new_n73_), .c(new_n51_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n86_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n75_), .c(new_n106_), .O(z13));
  inv1   g64(.a(x13), .O(new_n111_));
  nand2  g65(.a(x18), .b(x05), .O(new_n112_));
  oai21  g66(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n75_), .O(new_n114_));
  aoi21  g68(.a(new_n108_), .b(new_n86_), .c(new_n63_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n101_), .c(new_n73_), .d(new_n51_), .O(new_n117_));
  ...
  oai21  g75(.a(x18), .b(new_n66_), .c(new_n121_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n75_), .O(new_n123_));
  nand2  g77(.a(new_n117_), .b(x25), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n90_), .d(new_n73_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(x16), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n123_), .O(z15));
  nand2  g84(.a(x18), .b(x07), .O(new_n131_));
  oai21  g85(.a(x18), .b(new_n69_), .c(new_n131_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n75_), .O(new_n133_));
  nand2  g87(.a(new_n127_), .b(x26), .O(new_n134_));
  nor3   g88(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n125_), .c(new_n90_), .d(new_n73_), .O(new_n136_));
  ...
  nand4  g94(.a(new_n140_), .b(new_n135_), .c(new_n125_), .d(new_n90_), .O(new_n141_));
  nand2  g95(.a(x27), .b(x17), .O(new_n142_));
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n75_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
