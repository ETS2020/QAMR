...
module FAU ( 
  ...
  nand4  g65(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n112_));
  ...
  nand2  g83(.a(new_n122_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n131_), .c(new_n120_), .d(new_n89_), .O(new_n137_));
