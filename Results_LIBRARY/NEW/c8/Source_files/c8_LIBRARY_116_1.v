// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:52 2020
...
module FAU ( 
  ...
  oai21  g33(.a(x18), .b(x09), .c(new_n79_), .O(new_n80_));
  ...
  oai21  g44(.a(new_n90_), .b(new_n79_), .c(new_n87_), .O(z11));
  ...
  aoi22  g50(.a(new_n96_), .b(new_n82_), .c(new_n95_), .d(x22), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n79_), .c(new_n94_), .O(z12));
  nand2  g52(.a(x18), .b(x04), .O(new_n99_));
  oai21  g53(.a(x18), .b(new_n60_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  nand3  g55(.a(new_n96_), .b(new_n73_), .c(new_n51_), .O(new_n102_));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n82_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n79_), .c(new_n101_), .O(z13));
  inv1   g59(.a(x13), .O(new_n106_));
  nand2  g60(.a(x18), .b(x05), .O(new_n107_));
  oai21  g61(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n79_), .O(new_n109_));
  aoi21  g63(.a(new_n103_), .b(new_n82_), .c(new_n63_), .O(new_n110_));
  ...
  nand2  g71(.a(new_n117_), .b(new_n79_), .O(new_n118_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n79_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
