...
module FAU ( 
  ...
  nand3  g068(.a(new_n110_), .b(new_n77_), .c(new_n119_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n53_), .c(new_n63_), .O(new_n121_));
  nor3   g070(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n88_), .c(new_n71_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n98_), .c(new_n107_), .O(new_n135_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n110_), .c(new_n88_), .d(new_n87_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n53_), .c(new_n63_), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n110_), .c(new_n118_), .d(new_n119_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n122_), .c(new_n127_), .O(new_n155_));
  ...
  oai21  g123(.a(new_n174_), .b(new_n120_), .c(new_n53_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n64_), .c(new_n173_), .O(new_n176_));
  nor2   g125(.a(x31), .b(x30), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n154_), .c(new_n134_), .d(new_n107_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n144_), .c(new_n151_), .d(new_n118_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n120_), .c(new_n53_), .O(new_n186_));
