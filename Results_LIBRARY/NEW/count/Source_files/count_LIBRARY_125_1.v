...
module FAU ( 
  ...
  oai21  g016(.a(new_n63_), .b(x21), .c(x16), .O(new_n68_));
  ...
  nand4  g022(.a(new_n73_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n74_));
  ...
  nand3  g033(.a(new_n80_), .b(new_n55_), .c(new_n61_), .O(new_n85_));
  nor3   g034(.a(x24), .b(x23), .c(x22), .O(new_n86_));
  aoi22  g035(.a(new_n86_), .b(new_n63_), .c(new_n85_), .d(x24), .O(new_n87_));
  ...
  aoi21  g040(.a(new_n86_), .b(new_n63_), .c(new_n91_), .O(new_n92_));
  nor2   g041(.a(x25), .b(x24), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n80_), .c(new_n55_), .d(new_n61_), .O(new_n94_));
  ...
  nand4  g074(.a(new_n125_), .b(new_n93_), .c(new_n80_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n111_), .c(new_n86_), .d(new_n63_), .O(new_n138_));
  ...
  nand4  g092(.a(new_n110_), .b(new_n55_), .c(new_n73_), .d(new_n61_), .O(new_n144_));
