...
module FAU ( 
  ...
  nor3   g021(.a(new_n72_), .b(x18), .c(new_n58_), .O(new_n73_));
  oai21  g022(.a(new_n64_), .b(new_n69_), .c(new_n73_), .O(z02));
  ...
  nor2   g028(.a(new_n64_), .b(new_n79_), .O(new_n80_));
  ...
  oai21  g033(.a(new_n76_), .b(x19), .c(new_n64_), .O(new_n85_));
  ...
  oai21  g043(.a(new_n88_), .b(x19), .c(new_n64_), .O(new_n95_));
  ...
  nand2  g054(.a(new_n97_), .b(new_n53_), .O(new_n106_));
  ...
  nand3  g065(.a(new_n108_), .b(new_n76_), .c(new_n116_), .O(new_n117_));
  aoi21  g066(.a(new_n117_), .b(new_n53_), .c(new_n63_), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n86_), .c(new_n72_), .O(new_n120_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n86_), .c(new_n127_), .d(new_n69_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n53_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n64_), .c(new_n126_), .O(new_n131_));
  nand2  g080(.a(new_n76_), .b(new_n64_), .O(new_n132_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n108_), .c(new_n86_), .d(new_n69_), .O(new_n141_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n96_), .d(new_n76_), .O(new_n151_));
  ...
  oai22  g103(.a(new_n154_), .b(new_n89_), .c(new_n152_), .d(new_n150_), .O(new_n155_));
  ...
  nand3  g110(.a(new_n128_), .b(new_n96_), .c(new_n76_), .O(new_n162_));
  ...
  nor2   g115(.a(new_n166_), .b(new_n89_), .O(new_n167_));
  ...
  oai21  g122(.a(new_n173_), .b(new_n117_), .c(new_n53_), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n64_), .c(new_n172_), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n153_), .c(new_n133_), .d(new_n105_), .O(new_n177_));
  ...
  oai21  g133(.a(new_n184_), .b(new_n117_), .c(new_n53_), .O(new_n185_));
