// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:39 2020
...
module FAU ( 
  ...
  oai21  g21(.a(new_n40_), .b(x10), .c(new_n20_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n24_), .c(new_n21_), .O(new_n42_));
  aoi21  g23(.a(new_n22_), .b(new_n20_), .c(new_n40_), .O(new_n43_));
  ...
  aoi21  g31(.a(new_n50_), .b(new_n24_), .c(new_n21_), .O(new_n51_));
  aoi21  g32(.a(new_n49_), .b(new_n22_), .c(new_n48_), .O(new_n52_));
