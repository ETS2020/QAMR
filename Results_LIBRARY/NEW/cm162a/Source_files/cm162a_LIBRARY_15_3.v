// Benchmark "FAU" written by ABC on Thu Jun 25 17:18:53 2020
...
module FAU ( 
  ...
  oai21  g29(.a(new_n41_), .b(new_n21_), .c(x12), .O(new_n49_));
  inv1   g30(.a(x12), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n40_), .O(new_n51_));
  oai22  g32(.a(new_n51_), .b(new_n33_), .c(new_n20_), .d(new_n28_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n24_), .O(new_n53_));
  nor2   g34(.a(new_n29_), .b(new_n28_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n53_), .c(new_n49_), .O(z3));
