...
module FAU ( 
  ...
  nand3  g21(.a(new_n40_), .b(new_n32_), .c(new_n23_), .O(new_n41_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n24_), .c(x08), .O(new_n50_));
  nor2   g31(.a(new_n23_), .b(new_n28_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(x12), .O(new_n52_));
  nor2   g33(.a(x12), .b(x11), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n43_), .O(new_n54_));
  nand3  g35(.a(x13), .b(x09), .c(x03), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  oai21  g37(.a(x07), .b(x03), .c(x05), .O(new_n57_));
  aoi21  g38(.a(new_n56_), .b(new_n24_), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n52_), .O(z3));
