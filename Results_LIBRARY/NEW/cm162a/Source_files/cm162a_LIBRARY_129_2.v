// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:21 2020
...
module FAU ( 
  ...
  aoi21  g20(.a(new_n24_), .b(new_n32_), .c(x08), .O(new_n40_));
  nor2   g21(.a(new_n23_), .b(new_n28_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n40_), .c(x11), .O(new_n42_));
  oai22  g23(.a(new_n33_), .b(x11), .c(new_n20_), .d(new_n28_), .O(new_n43_));
  oai21  g24(.a(x06), .b(x03), .c(x05), .O(new_n44_));
  aoi21  g25(.a(new_n43_), .b(new_n24_), .c(new_n44_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n42_), .O(z2));
  inv1   g27(.a(x11), .O(new_n47_));
  inv1   g28(.a(x12), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n47_), .c(new_n32_), .d(new_n23_), .O(new_n49_));
