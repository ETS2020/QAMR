...
module FAU ( 
  ...
  aoi21  g12(.a(new_n20_), .b(x10), .c(new_n21_), .O(new_n32_));
  inv1   g13(.a(x10), .O(new_n33_));
  oai21  g14(.a(new_n24_), .b(new_n33_), .c(new_n23_), .O(new_n34_));
  ...
  aoi21  g22(.a(new_n24_), .b(new_n33_), .c(new_n39_), .O(new_n42_));
  ...
  nand3  g28(.a(new_n47_), .b(new_n39_), .c(new_n33_), .O(new_n48_));
