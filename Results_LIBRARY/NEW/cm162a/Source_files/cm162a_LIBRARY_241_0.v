...
module FAU ( 
  ...
  nand3  g01(.a(x13), .b(x09), .c(x02), .O(new_n21_));
  aoi21  g02(.a(new_n21_), .b(x08), .c(new_n20_), .O(new_n22_));
  inv1   g03(.a(x08), .O(new_n23_));
  oai21  g04(.a(new_n23_), .b(x04), .c(x02), .O(new_n24_));
  ...
  aoi21  g13(.a(new_n23_), .b(x04), .c(new_n32_), .O(new_n33_));
  aoi21  g14(.a(new_n31_), .b(x04), .c(new_n33_), .O(new_n34_));
  ...
  aoi21  g22(.a(new_n39_), .b(x04), .c(new_n38_), .O(new_n42_));
  ...
  aoi21  g31(.a(new_n39_), .b(x04), .c(new_n47_), .O(new_n51_));
  aoi21  g32(.a(new_n50_), .b(x04), .c(new_n51_), .O(new_n52_));
