...
module FAU ( 
  ...
  aoi22  g11(.a(new_n32_), .b(new_n24_), .c(new_n25_), .d(x11), .O(new_n33_));
  ...
  nand2  g15(.a(new_n32_), .b(new_n24_), .O(new_n37_));
  ...
  aoi21  g27(.a(new_n32_), .b(new_n24_), .c(new_n46_), .O(new_n49_));
  aoi21  g28(.a(new_n48_), .b(new_n22_), .c(new_n49_), .O(new_n50_));
