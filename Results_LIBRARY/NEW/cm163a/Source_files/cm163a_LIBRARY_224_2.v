...
module FAU ( 
  ...
  oai21  g04(.a(new_n22_), .b(x02), .c(new_n25_), .O(new_n26_));
  nand2  g05(.a(new_n26_), .b(x04), .O(new_n27_));
  nor2   g06(.a(x04), .b(x00), .O(new_n28_));
  oai21  g07(.a(new_n22_), .b(x03), .c(x05), .O(new_n29_));
  ...
  aoi21  g15(.a(new_n32_), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  oai21  g16(.a(new_n34_), .b(new_n32_), .c(new_n37_), .O(z1));
  nand2  g17(.a(new_n33_), .b(new_n24_), .O(new_n39_));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n32_), .c(new_n36_), .O(new_n43_));
  ...
  oai21  g28(.a(new_n49_), .b(new_n23_), .c(new_n45_), .O(new_n50_));
  aoi21  g29(.a(new_n33_), .b(new_n24_), .c(new_n48_), .O(new_n51_));
  aoi21  g30(.a(new_n50_), .b(new_n22_), .c(new_n51_), .O(new_n52_));
  inv1   g31(.a(x07), .O(new_n53_));
  aoi21  g32(.a(new_n53_), .b(new_n32_), .c(new_n36_), .O(new_n54_));
  oai21  g33(.a(new_n52_), .b(new_n32_), .c(new_n54_), .O(z3));
