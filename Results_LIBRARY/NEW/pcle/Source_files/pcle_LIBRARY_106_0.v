// Benchmark "FAU" written by ABC on Thu Jun 25 16:30:06 2020
...
module FAU ( 
  ...
  nand2  g27(.a(new_n40_), .b(x09), .O(new_n56_));
  ...
  aoi22  g33(.a(new_n61_), .b(new_n51_), .c(new_n59_), .d(x15), .O(new_n62_));
