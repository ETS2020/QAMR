// Benchmark "FAU" written by ABC on Thu Jun 25 19:30:27 2020
...
module FAU ( 
  ...
  nand3  g085(.a(x39), .b(new_n168_), .c(x09), .O(new_n169_));
  aoi22  g086(.a(x38), .b(new_n146_), .c(x14), .d(x00), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n169_), .c(x10), .O(z27));
  nand2  g088(.a(new_n168_), .b(x09), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(x39), .O(new_n173_));
  nand3  g090(.a(x40), .b(new_n168_), .c(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z28));
  nand2  g092(.a(new_n172_), .b(x40), .O(new_n176_));
  nand3  g093(.a(x41), .b(new_n168_), .c(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z29));
  nand2  g095(.a(new_n172_), .b(x41), .O(new_n179_));
  nand3  g096(.a(x42), .b(new_n168_), .c(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z30));
  nand2  g098(.a(new_n172_), .b(x42), .O(new_n182_));
  nand3  g099(.a(x43), .b(new_n168_), .c(x09), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z31));
  nand2  g101(.a(new_n172_), .b(x43), .O(new_n185_));
  nand3  g102(.a(x44), .b(new_n168_), .c(x09), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z32));
  nand2  g104(.a(new_n172_), .b(x44), .O(new_n188_));
  nand3  g105(.a(x45), .b(new_n168_), .c(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z33));
  nand2  g107(.a(new_n172_), .b(x45), .O(new_n191_));
  nand3  g108(.a(x46), .b(new_n168_), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z34));
  nand2  g110(.a(new_n172_), .b(x46), .O(new_n194_));
  nand3  g111(.a(new_n168_), .b(x09), .c(x00), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z35));
endmodule
