// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:40 2020
...
module FAU ( 
  ...
  nand2  g085(.a(x39), .b(x09), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z27));
  nand2  g087(.a(x39), .b(new_n146_), .O(new_n171_));
  nand2  g088(.a(x40), .b(x09), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n171_), .c(x10), .O(z28));
  nand2  g090(.a(x40), .b(new_n146_), .O(new_n174_));
  nand2  g091(.a(x41), .b(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z29));
  nand2  g093(.a(x41), .b(new_n146_), .O(new_n177_));
  nand2  g094(.a(x42), .b(x09), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z30));
  nand2  g096(.a(x42), .b(new_n146_), .O(new_n180_));
  nand2  g097(.a(x43), .b(x09), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z31));
  nand2  g099(.a(x43), .b(new_n146_), .O(new_n183_));
  nand2  g100(.a(x44), .b(x09), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z32));
  nand2  g102(.a(x44), .b(new_n146_), .O(new_n186_));
  nand2  g103(.a(x45), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z33));
  nand2  g105(.a(x45), .b(new_n146_), .O(new_n189_));
  nand2  g106(.a(x46), .b(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z34));
  nand2  g108(.a(x09), .b(x00), .O(new_n192_));
  nand2  g109(.a(x46), .b(new_n146_), .O(new_n193_));
