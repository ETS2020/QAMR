// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:43 2020
...
module FAU ( 
  ...
  aoi22  g086(.a(x39), .b(new_n169_), .c(x38), .d(new_n146_), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n168_), .c(x10), .O(z27));
  nand2  g088(.a(x39), .b(x14), .O(new_n172_));
  nand2  g089(.a(x40), .b(new_n169_), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z28));
  nand2  g091(.a(x40), .b(x14), .O(new_n175_));
  nand2  g092(.a(x41), .b(new_n169_), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z29));
  nand2  g094(.a(x41), .b(x14), .O(new_n178_));
  nand2  g095(.a(x42), .b(new_n169_), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z30));
  nand2  g097(.a(x42), .b(x14), .O(new_n181_));
  nand2  g098(.a(x43), .b(new_n169_), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z31));
  nand2  g100(.a(x43), .b(x14), .O(new_n184_));
  nand2  g101(.a(x44), .b(new_n169_), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z32));
  nand2  g103(.a(x44), .b(x14), .O(new_n187_));
  nand2  g104(.a(x45), .b(new_n169_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z33));
  nand2  g106(.a(x45), .b(x14), .O(new_n190_));
  nand2  g107(.a(x46), .b(new_n169_), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z34));
  nand2  g109(.a(new_n169_), .b(x00), .O(new_n193_));
  nand2  g110(.a(x46), .b(x14), .O(new_n194_));
