// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:00 2020
...
module FAU ( 
  ...
  inv1   g050(.a(x10), .O(new_n134_));
  nand3  g051(.a(x27), .b(new_n134_), .c(new_n103_), .O(new_n135_));
  inv1   g052(.a(new_n135_), .O(z16));
  nand3  g053(.a(x29), .b(new_n134_), .c(x08), .O(new_n137_));
  inv1   g054(.a(new_n137_), .O(z17));
