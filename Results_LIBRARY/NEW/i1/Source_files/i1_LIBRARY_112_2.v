// Benchmark "FAU" written by ABC on Thu Jun 25 17:26:08 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n58_, new_n59_, new_n62_, new_n63_, new_n65_, new_n66_,
  ...
  nand3  g11(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(x19), .c(x07), .O(new_n54_));
  inv1   g13(.a(x08), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(x05), .O(new_n56_));
  nor2   g15(.a(new_n42_), .b(x09), .O(new_n57_));
  nor2   g16(.a(x07), .b(x06), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(new_n49_), .O(new_n59_));
  oai21  g18(.a(new_n54_), .b(new_n52_), .c(new_n59_), .O(z02));
  or2    g19(.a(x21), .b(x20), .O(z04));
  inv1   g20(.a(x10), .O(new_n62_));
  nand3  g21(.a(x19), .b(new_n55_), .c(new_n43_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n53_), .c(new_n62_), .O(z05));
  inv1   g23(.a(new_n53_), .O(new_n65_));
  inv1   g24(.a(x05), .O(new_n66_));
  nand4  g25(.a(new_n58_), .b(new_n47_), .c(new_n46_), .d(new_n66_), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(new_n65_), .c(x00), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x19), .O(new_n69_));
  nand2  g28(.a(x07), .b(x00), .O(new_n70_));
