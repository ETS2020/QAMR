// Benchmark "FAU" written by ABC on Thu Jun 25 17:26:09 2020
...
module FAU ( 
  ...
  nor3   g36(.a(x24), .b(new_n77_), .c(new_n73_), .O(z12));
  nor2   g37(.a(x24), .b(new_n77_), .O(z13));
  inv1   g38(.a(x16), .O(new_n80_));
  nor2   g39(.a(x24), .b(new_n80_), .O(z14));
