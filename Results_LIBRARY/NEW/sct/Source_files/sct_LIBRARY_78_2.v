...
module FAU ( 
  ...
  nand3  g46(.a(new_n80_), .b(new_n43_), .c(x02), .O(new_n81_));
  inv1   g47(.a(x12), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(new_n84_));
  aoi21  g50(.a(new_n81_), .b(x16), .c(new_n84_), .O(new_n85_));
  inv1   g51(.a(x16), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x02), .O(new_n87_));
  aoi21  g53(.a(new_n85_), .b(new_n79_), .c(new_n87_), .O(new_n88_));
  ...
  oai21  g59(.a(new_n93_), .b(new_n85_), .c(new_n79_), .O(new_n94_));
