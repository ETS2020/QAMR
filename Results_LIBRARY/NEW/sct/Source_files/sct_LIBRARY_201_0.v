...
module FAU ( 
  ...
  nand4  g30(.a(new_n64_), .b(new_n63_), .c(new_n58_), .d(x04), .O(z06));
  nand2  g31(.a(new_n63_), .b(x11), .O(new_n66_));
  inv1   g32(.a(x11), .O(new_n67_));
  inv1   g33(.a(new_n55_), .O(new_n68_));
  nand3  g34(.a(new_n62_), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n66_), .c(new_n58_), .d(x04), .O(z07));
  inv1   g36(.a(x10), .O(new_n71_));
  nand3  g37(.a(new_n67_), .b(new_n71_), .c(new_n59_), .O(new_n72_));
  oai21  g38(.a(new_n72_), .b(new_n55_), .c(x12), .O(new_n73_));
  inv1   g39(.a(x12), .O(new_n74_));
  nand4  g40(.a(new_n62_), .b(new_n68_), .c(new_n74_), .d(new_n67_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n58_), .d(x04), .O(z08));
  nand3  g42(.a(new_n74_), .b(new_n67_), .c(new_n71_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n55_), .c(new_n59_), .O(new_n78_));
  aoi21  g44(.a(x13), .b(x09), .c(new_n40_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n58_), .O(z09));
  and2   g46(.a(x06), .b(x00), .O(new_n81_));
  nand2  g47(.a(x08), .b(x07), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x09), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n47_), .O(new_n84_));
  nand2  g50(.a(new_n45_), .b(x14), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n84_), .c(new_n40_), .O(z10));
  nand2  g52(.a(x16), .b(new_n35_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n43_), .c(new_n40_), .O(z12));
