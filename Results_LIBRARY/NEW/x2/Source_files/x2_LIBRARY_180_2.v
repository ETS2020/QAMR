// Benchmark "FAU" written by ABC on Thu Jun 25 15:17:36 2020
...
module FAU ( 
  ...
  nand3  g29(.a(new_n46_), .b(new_n41_), .c(new_n38_), .O(z5));
  ...
  nor2   g34(.a(x9), .b(x8), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n20_), .c(new_n42_), .O(new_n53_));
