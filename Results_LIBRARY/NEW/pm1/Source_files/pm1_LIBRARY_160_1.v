// Benchmark "FAU" written by ABC on Thu Jun 25 16:34:29 2020
...
module FAU ( 
  ...
  and2   g21(.a(x04), .b(x03), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n50_), .c(x11), .O(new_n52_));
