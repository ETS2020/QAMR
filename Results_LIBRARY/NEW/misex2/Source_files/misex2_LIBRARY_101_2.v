...
module FAU ( 
  ...
  nand4  g39(.a(new_n83_), .b(new_n82_), .c(x02), .d(new_n63_), .O(new_n84_));
  ...
  nand3  g49(.a(new_n93_), .b(new_n92_), .c(new_n62_), .O(new_n94_));
  aoi21  g50(.a(new_n91_), .b(new_n89_), .c(new_n94_), .O(z09));
  nor2   g51(.a(new_n93_), .b(new_n92_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n57_), .c(new_n87_), .d(x01), .O(new_n97_));
  nor2   g53(.a(new_n59_), .b(x01), .O(new_n98_));
  nand4  g54(.a(new_n93_), .b(new_n92_), .c(x20), .d(x16), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  inv1   g56(.a(x14), .O(new_n101_));
  nand4  g57(.a(x15), .b(new_n101_), .c(new_n83_), .d(new_n82_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n100_), .c(new_n98_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n97_), .c(x00), .O(z10));
  nand4  g61(.a(new_n90_), .b(x21), .c(x18), .d(x01), .O(new_n106_));
  inv1   g62(.a(x15), .O(new_n107_));
  nor2   g63(.a(new_n107_), .b(x14), .O(new_n108_));
  inv1   g64(.a(x16), .O(new_n109_));
  nand3  g65(.a(new_n92_), .b(x20), .c(new_n109_), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n108_), .c(new_n85_), .O(new_n112_));
  nand2  g68(.a(new_n93_), .b(new_n62_), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(new_n106_), .c(new_n113_), .O(z11));
