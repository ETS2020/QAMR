...
module FAU ( 
  ...
  oai22  g21(.a(new_n64_), .b(new_n62_), .c(new_n61_), .d(new_n58_), .O(z03));
  nand2  g22(.a(x10), .b(new_n44_), .O(new_n66_));
  nand3  g23(.a(x02), .b(x01), .c(x00), .O(new_n67_));
  nor4   g24(.a(new_n67_), .b(new_n66_), .c(x12), .d(x11), .O(z04));
  nor3   g25(.a(new_n67_), .b(new_n54_), .c(new_n44_), .O(z05));
  inv1   g26(.a(x11), .O(new_n70_));
  nor3   g27(.a(new_n66_), .b(new_n62_), .c(new_n70_), .O(z06));
  nor2   g28(.a(x12), .b(new_n70_), .O(new_n72_));
  nand2  g29(.a(new_n72_), .b(new_n63_), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n62_), .O(z07));
  ...
  nand4  g40(.a(new_n83_), .b(x12), .c(x02), .d(new_n82_), .O(new_n84_));
  ...
  nand3  g45(.a(new_n88_), .b(new_n86_), .c(new_n85_), .O(new_n89_));
  ...
  aoi21  g52(.a(new_n91_), .b(new_n89_), .c(new_n95_), .O(z09));
  nor2   g53(.a(new_n94_), .b(new_n93_), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n57_), .c(new_n87_), .d(x01), .O(new_n98_));
  nor2   g55(.a(new_n59_), .b(x01), .O(new_n99_));
  nand4  g56(.a(new_n94_), .b(new_n93_), .c(x20), .d(x16), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  inv1   g58(.a(x14), .O(new_n102_));
  nand4  g59(.a(x15), .b(new_n102_), .c(new_n83_), .d(x12), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n101_), .c(new_n99_), .O(new_n105_));
  ...
  nand3  g67(.a(new_n93_), .b(x20), .c(new_n110_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n109_), .c(new_n85_), .O(new_n113_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n107_), .c(new_n114_), .O(z11));
  ...
  nand3  g85(.a(x19), .b(new_n59_), .c(new_n82_), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n92_), .c(new_n129_), .O(z15));
  nor2   g87(.a(new_n82_), .b(x00), .O(z16));
