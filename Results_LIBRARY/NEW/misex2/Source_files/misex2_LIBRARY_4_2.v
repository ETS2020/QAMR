// Benchmark "FAU" written by ABC on Thu Jun 25 17:30:55 2020
...
module FAU ( 
  ...
  nand3  g58(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x14), .O(new_n104_));
  nand4  g61(.a(x16), .b(x15), .c(new_n104_), .d(new_n62_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n87_), .b(x12), .c(x02), .d(new_n66_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n106_), .c(new_n103_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g67(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  inv1   g68(.a(x15), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(x14), .O(new_n113_));
  inv1   g70(.a(x16), .O(new_n114_));
  nand3  g71(.a(new_n96_), .b(x20), .c(new_n114_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n113_), .c(new_n89_), .O(new_n117_));
  nand2  g74(.a(new_n97_), .b(new_n65_), .O(new_n118_));
  aoi21  g75(.a(new_n117_), .b(new_n111_), .c(new_n118_), .O(z11));
  oai21  g76(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(x23), .O(new_n121_));
  nand3  g78(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n60_), .O(new_n124_));
  inv1   g81(.a(x24), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(x09), .O(new_n126_));
  aoi21  g83(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z12));
  nor2   g84(.a(x19), .b(new_n47_), .O(new_n128_));
  and2   g85(.a(new_n128_), .b(new_n45_), .O(z13));
  nor2   g86(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g87(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(new_n65_), .c(new_n132_), .O(z15));
  nor2   g90(.a(new_n66_), .b(x00), .O(z16));
  inv1   g91(.a(new_n84_), .O(z17));
endmodule
