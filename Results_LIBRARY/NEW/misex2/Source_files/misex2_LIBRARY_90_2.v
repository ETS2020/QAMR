...
module FAU ( 
  ...
  nor2   g41(.a(new_n59_), .b(x01), .O(new_n85_));
  ...
  nor2   g48(.a(new_n71_), .b(x11), .O(new_n92_));
  nor2   g49(.a(x14), .b(x13), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n85_), .O(new_n94_));
  ...
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n65_), .O(new_n99_));
  aoi21  g56(.a(new_n96_), .b(new_n94_), .c(new_n99_), .O(z09));
  nor2   g57(.a(x20), .b(new_n66_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n57_), .c(x22), .d(x21), .O(new_n102_));
  nand2  g59(.a(x02), .b(new_n66_), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n62_), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nor2   g63(.a(new_n88_), .b(x14), .O(new_n107_));
  nand4  g64(.a(new_n98_), .b(new_n97_), .c(x20), .d(x16), .O(new_n108_));
  ...
  nand4  g68(.a(new_n95_), .b(x21), .c(x18), .d(x01), .O(new_n112_));
  nand3  g69(.a(new_n97_), .b(x20), .c(new_n89_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n107_), .c(new_n106_), .O(new_n115_));
  nand2  g72(.a(new_n98_), .b(new_n65_), .O(new_n116_));
