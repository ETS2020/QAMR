...
module FAU ( 
  ...
  nand3  g067(.a(x19), .b(new_n55_), .c(x10), .O(new_n120_));
  inv1   g068(.a(x30), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(x18), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  inv1   g072(.a(x29), .O(new_n125_));
  nand2  g073(.a(new_n125_), .b(new_n57_), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(new_n124_), .O(z09));
  inv1   g075(.a(new_n58_), .O(new_n128_));
  nand2  g076(.a(new_n55_), .b(x09), .O(new_n129_));
  inv1   g077(.a(x31), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(x18), .O(new_n131_));
  aoi21  g079(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(z10));
  ...
  nand2  g084(.a(new_n130_), .b(new_n57_), .O(new_n137_));
