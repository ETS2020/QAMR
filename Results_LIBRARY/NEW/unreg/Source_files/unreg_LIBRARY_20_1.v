// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:21 2020
...
module FAU ( 
  ...
  oai21  g032(.a(new_n84_), .b(new_n55_), .c(new_n58_), .O(new_n85_));
  ...
  nand2  g040(.a(new_n84_), .b(new_n57_), .O(new_n93_));
