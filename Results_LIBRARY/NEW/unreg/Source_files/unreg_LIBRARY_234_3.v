// Benchmark "FAU" written by ABC on Thu Jun 25 17:25:00 2020
...
module FAU ( 
  ...
  nand3  g069(.a(new_n58_), .b(new_n121_), .c(x18), .O(new_n122_));
  ...
  nand2  g075(.a(new_n121_), .b(new_n57_), .O(new_n128_));
