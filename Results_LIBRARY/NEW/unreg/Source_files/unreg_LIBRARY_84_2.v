...
module FAU ( 
  ...
  nand2  g095(.a(new_n55_), .b(x14), .O(new_n148_));
  ...
  nor2   g105(.a(x35), .b(new_n55_), .O(new_n158_));
  oai21  g106(.a(new_n158_), .b(new_n157_), .c(new_n58_), .O(new_n159_));
  nand2  g107(.a(new_n149_), .b(new_n57_), .O(new_n160_));
