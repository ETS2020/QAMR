// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:59 2020
...
module FAU ( 
  ...
  nor2   g020(.a(x18), .b(new_n72_), .O(new_n73_));
  nor2   g021(.a(x23), .b(new_n55_), .O(new_n74_));
  oai21  g022(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(new_n75_));
  nand2  g023(.a(new_n65_), .b(new_n57_), .O(new_n76_));
  ...
  nand2  g030(.a(new_n82_), .b(new_n57_), .O(new_n83_));
  nand2  g031(.a(new_n83_), .b(new_n81_), .O(z03));
  inv1   g032(.a(x07), .O(new_n85_));
  nor2   g033(.a(x18), .b(new_n85_), .O(new_n86_));
  nor2   g034(.a(x25), .b(new_n55_), .O(new_n87_));
  oai21  g035(.a(new_n87_), .b(new_n86_), .c(new_n58_), .O(new_n88_));
  inv1   g036(.a(x24), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n57_), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n88_), .O(z04));
  inv1   g039(.a(x06), .O(new_n92_));
  nor2   g040(.a(x18), .b(new_n92_), .O(new_n93_));
  nor2   g041(.a(x26), .b(new_n55_), .O(new_n94_));
  oai21  g042(.a(new_n94_), .b(new_n93_), .c(new_n58_), .O(new_n95_));
  inv1   g043(.a(x25), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n57_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(new_n95_), .O(z05));
  inv1   g046(.a(x05), .O(new_n99_));
  nor2   g047(.a(x18), .b(new_n99_), .O(new_n100_));
  nor2   g048(.a(x27), .b(new_n55_), .O(new_n101_));
  oai21  g049(.a(new_n101_), .b(new_n100_), .c(new_n58_), .O(new_n102_));
  inv1   g050(.a(x26), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n57_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n102_), .O(z06));
  inv1   g053(.a(x04), .O(new_n106_));
  nor2   g054(.a(x18), .b(new_n106_), .O(new_n107_));
  nor2   g055(.a(x20), .b(new_n55_), .O(new_n108_));
  ...
  nor2   g062(.a(x29), .b(new_n55_), .O(new_n115_));
  ...
  nor2   g069(.a(x30), .b(new_n55_), .O(new_n122_));
  ...
  nor2   g076(.a(x31), .b(new_n55_), .O(new_n129_));
  ...
  nor2   g083(.a(x24), .b(new_n55_), .O(new_n136_));
  ...
  nor2   g090(.a(x33), .b(new_n55_), .O(new_n143_));
  ...
  nor2   g097(.a(x34), .b(new_n55_), .O(new_n150_));
  ...
  nor2   g104(.a(x35), .b(new_n55_), .O(new_n157_));
  ...
  nor2   g111(.a(x28), .b(new_n55_), .O(new_n164_));
  oai21  g112(.a(new_n164_), .b(new_n163_), .c(new_n58_), .O(new_n165_));
  inv1   g113(.a(x35), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n57_), .O(new_n167_));
