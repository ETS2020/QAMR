// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:25 2020
...
module FAU ( 
  ...
  inv1   g031(.a(new_n58_), .O(new_n84_));
  nand2  g032(.a(new_n55_), .b(x07), .O(new_n85_));
  inv1   g033(.a(x25), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(x18), .O(new_n87_));
  aoi21  g035(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(z04));
  ...
  inv1   g077(.a(x17), .O(new_n130_));
  nand3  g078(.a(x19), .b(new_n55_), .c(x08), .O(new_n131_));
  inv1   g079(.a(x24), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(x18), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n130_), .O(new_n135_));
