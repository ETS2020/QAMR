// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:38 2020
...
module FAU ( 
  ...
  nor2   g013(.a(x22), .b(new_n55_), .O(new_n66_));
  oai21  g014(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(x19), .O(z01));
  inv1   g016(.a(x01), .O(new_n69_));
  nor2   g017(.a(x18), .b(new_n69_), .O(new_n70_));
  nor2   g018(.a(x23), .b(new_n55_), .O(new_n71_));
  oai21  g019(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(new_n72_));
  inv1   g020(.a(x22), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n57_), .O(new_n74_));
  ...
  nand2  g026(.a(new_n78_), .b(new_n58_), .O(new_n79_));
  inv1   g027(.a(x23), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n57_), .O(new_n81_));
