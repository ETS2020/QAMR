// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:42 2020
...
module FAU ( 
  ...
  nand2  g088(.a(x19), .b(new_n140_), .O(new_n141_));
  nor2   g089(.a(x18), .b(x15), .O(new_n142_));
  oai22  g090(.a(new_n142_), .b(new_n141_), .c(x32), .d(x19), .O(z12));
  inv1   g091(.a(x33), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(new_n55_), .c(x14), .O(new_n145_));
  inv1   g093(.a(x34), .O(new_n146_));
  nand3  g094(.a(new_n146_), .b(x19), .c(x18), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n140_), .O(new_n149_));
  nand2  g097(.a(new_n144_), .b(new_n57_), .O(new_n150_));
  ...
  nand2  g103(.a(new_n146_), .b(new_n57_), .O(new_n156_));
