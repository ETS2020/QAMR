// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:35 2020
...
module FAU ( 
  ...
  oai21  g095(.a(new_n147_), .b(new_n55_), .c(new_n58_), .O(new_n148_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n57_), .O(new_n156_));
