// Benchmark "FAU" written by ABC on Thu Jun 25 18:52:08 2020
...
module FAU ( 
  ...
  nand2  g16(.a(x13), .b(x12), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(new_n57_), .O(z12));
