// Benchmark "FAU" written by ABC on Thu Jun 25 18:52:43 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n74_, new_n76_, new_n78_, new_n79_, new_n81_, new_n82_;
  ...
  nand3  g21(.a(new_n62_), .b(x15), .c(x10), .O(new_n63_));
  ...
  oai21  g34(.a(new_n51_), .b(x05), .c(x18), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n63_), .c(new_n57_), .O(z17));
