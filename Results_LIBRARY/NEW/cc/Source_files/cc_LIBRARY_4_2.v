// Benchmark "FAU" written by ABC on Thu Jun 25 18:50:54 2020
...
module FAU ( 
  ...
  nand3  g18(.a(x10), .b(x08), .c(x01), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(new_n61_));
  oai22  g20(.a(new_n61_), .b(new_n46_), .c(new_n57_), .d(new_n47_), .O(z13));
  nand3  g21(.a(new_n57_), .b(x15), .c(x12), .O(new_n63_));
  nand4  g22(.a(new_n47_), .b(x10), .c(x08), .d(x02), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z14));
  nand3  g24(.a(new_n47_), .b(x08), .c(x03), .O(new_n66_));
  nand3  g25(.a(x16), .b(x15), .c(new_n43_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x10), .O(new_n69_));
  nand4  g28(.a(new_n57_), .b(x16), .c(new_n43_), .d(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n69_), .O(z15));
  nand3  g30(.a(new_n47_), .b(x08), .c(x04), .O(new_n72_));
  nand2  g31(.a(x17), .b(x15), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x10), .O(new_n75_));
  nand3  g34(.a(new_n57_), .b(x17), .c(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(z16));
  nand3  g36(.a(new_n47_), .b(x08), .c(x05), .O(new_n78_));
  nand2  g37(.a(x18), .b(x15), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x10), .O(new_n81_));
  nand3  g40(.a(new_n57_), .b(x18), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(z17));
  nand3  g42(.a(new_n47_), .b(x08), .c(x06), .O(new_n84_));
  nand2  g43(.a(x19), .b(x15), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x10), .O(new_n87_));
  nand3  g46(.a(new_n57_), .b(x19), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z18));
  nand3  g48(.a(new_n47_), .b(x08), .c(x07), .O(new_n90_));
  nand2  g49(.a(x20), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x10), .O(new_n93_));
  nand3  g52(.a(new_n57_), .b(x20), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z19));
  inv1   g54(.a(new_n44_), .O(z03));
  buf    g55(.a(x19), .O(z05));
  buf    g56(.a(x15), .O(z06));
  buf    g57(.a(x17), .O(z07));
  buf    g58(.a(x16), .O(z08));
