// Benchmark "FAU" written by ABC on Thu Jun 25 18:51:07 2020
...
module FAU ( 
  ...
  inv1   g29(.a(new_n47_), .O(new_n71_));
  nand2  g30(.a(x17), .b(x12), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(new_n71_), .O(z16));
