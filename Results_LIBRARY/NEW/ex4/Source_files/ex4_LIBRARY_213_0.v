// Benchmark "FAU" written by ABC on Fri Jun 26 05:07:59 2020
...
module FAU ( 
  ...
  nand2  g292(.a(new_n449_), .b(new_n300_), .O(new_n450_));
  ...
  oai21  g301(.a(new_n448_), .b(x094), .c(new_n283_), .O(new_n459_));
  ...
  nand4  g305(.a(x126), .b(new_n316_), .c(new_n297_), .d(x014), .O(new_n463_));
