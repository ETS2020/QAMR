// Benchmark "FAU" written by ABC on Fri Jun 26 05:08:05 2020
...
module FAU ( 
  ...
  nand2  g126(.a(x118), .b(x110), .O(new_n283_));
  inv1   g127(.a(new_n283_), .O(new_n284_));
  aoi21  g128(.a(new_n284_), .b(new_n282_), .c(new_n280_), .O(new_n285_));
  ...
  oai21  g142(.a(x126), .b(new_n298_), .c(new_n297_), .O(new_n299_));
  ...
  nand4  g147(.a(new_n303_), .b(new_n300_), .c(new_n295_), .d(new_n291_), .O(new_n304_));
  oai21  g148(.a(new_n304_), .b(new_n285_), .c(x078), .O(new_n305_));
  nand4  g149(.a(new_n293_), .b(x062), .c(x038), .d(new_n287_), .O(new_n306_));
  aoi21  g150(.a(new_n306_), .b(new_n305_), .c(new_n279_), .O(new_n307_));
  nor3   g151(.a(x086), .b(new_n297_), .c(new_n287_), .O(new_n308_));
  oai21  g152(.a(new_n308_), .b(new_n307_), .c(new_n278_), .O(new_n309_));
  nand3  g153(.a(x086), .b(x054), .c(new_n286_), .O(new_n310_));
  aoi21  g154(.a(new_n310_), .b(x022), .c(new_n297_), .O(new_n311_));
  inv1   g155(.a(new_n290_), .O(new_n312_));
  nand2  g156(.a(x086), .b(x054), .O(new_n313_));
  nor2   g157(.a(new_n313_), .b(new_n312_), .O(new_n314_));
  oai21  g158(.a(new_n314_), .b(new_n311_), .c(new_n280_), .O(new_n315_));
  nor2   g159(.a(x094), .b(x062), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(x030), .c(x022), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n283_), .O(new_n318_));
  inv1   g162(.a(x094), .O(new_n319_));
  nand2  g163(.a(new_n319_), .b(new_n301_), .O(new_n320_));
  nand4  g164(.a(new_n320_), .b(new_n289_), .c(new_n281_), .d(new_n286_), .O(new_n321_));
  aoi21  g165(.a(new_n321_), .b(new_n318_), .c(new_n279_), .O(new_n322_));
  nand2  g166(.a(new_n289_), .b(new_n286_), .O(new_n323_));
  aoi21  g167(.a(new_n323_), .b(new_n312_), .c(x038), .O(new_n324_));
  oai21  g168(.a(new_n324_), .b(new_n322_), .c(x086), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n315_), .O(new_n326_));
  oai21  g170(.a(new_n313_), .b(new_n284_), .c(x078), .O(new_n327_));
  nand2  g171(.a(new_n327_), .b(new_n287_), .O(new_n328_));
  nor2   g172(.a(x022), .b(new_n287_), .O(new_n329_));
  nor2   g173(.a(x070), .b(new_n279_), .O(new_n330_));
  aoi22  g174(.a(new_n330_), .b(new_n329_), .c(new_n279_), .d(new_n297_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n328_), .O(new_n332_));
  aoi21  g176(.a(new_n326_), .b(x078), .c(new_n332_), .O(new_n333_));
  aoi21  g177(.a(new_n333_), .b(new_n309_), .c(new_n277_), .O(z06));
  ...
  nand2  g255(.a(new_n240_), .b(new_n412_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n262_), .O(new_n414_));
  ...
  oai21  g260(.a(new_n263_), .b(x029), .c(new_n417_), .O(new_n418_));
  nor2   g261(.a(x117), .b(x021), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(x125), .c(x085), .O(new_n420_));
  oai21  g263(.a(new_n240_), .b(x109), .c(x037), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(x117), .O(new_n422_));
  oai21  g265(.a(new_n412_), .b(x061), .c(new_n229_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n243_), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n422_), .c(new_n420_), .d(new_n418_), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(new_n416_), .c(new_n259_), .O(new_n426_));
  nand4  g269(.a(x125), .b(new_n246_), .c(new_n243_), .d(x013), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n426_), .c(x053), .O(new_n428_));
  nand3  g271(.a(x085), .b(new_n243_), .c(new_n234_), .O(new_n429_));
  ...
  nand2  g275(.a(new_n432_), .b(new_n235_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n259_), .O(new_n434_));
  aoi21  g277(.a(new_n434_), .b(new_n234_), .c(new_n415_), .O(new_n435_));
  nor2   g278(.a(new_n233_), .b(x021), .O(new_n436_));
  oai21  g279(.a(new_n436_), .b(new_n263_), .c(x069), .O(new_n437_));
  nand4  g280(.a(new_n417_), .b(new_n413_), .c(new_n237_), .d(x029), .O(new_n438_));
  aoi21  g281(.a(new_n438_), .b(new_n437_), .c(x077), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(new_n435_), .c(new_n225_), .O(new_n440_));
  nand2  g283(.a(new_n417_), .b(x029), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n255_), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n259_), .c(x037), .O(new_n443_));
  ...
  aoi21  g291(.a(new_n444_), .b(new_n239_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n431_), .c(x045), .O(z13));
  inv1   g293(.a(x078), .O(new_n451_));
  inv1   g294(.a(x102), .O(new_n452_));
  nand2  g295(.a(new_n293_), .b(new_n452_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n319_), .O(new_n454_));
  ...
  oai21  g300(.a(new_n320_), .b(x030), .c(new_n457_), .O(new_n458_));
  nor2   g301(.a(x118), .b(x022), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(x126), .c(x086), .O(new_n460_));
  oai21  g303(.a(new_n293_), .b(x110), .c(x038), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(x118), .O(new_n462_));
  oai21  g305(.a(new_n452_), .b(x062), .c(new_n298_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n297_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n462_), .c(new_n460_), .d(new_n458_), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n456_), .c(new_n451_), .O(new_n466_));
  nand4  g309(.a(x126), .b(new_n301_), .c(new_n297_), .d(x014), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n466_), .c(x054), .O(new_n468_));
  nand3  g311(.a(x086), .b(new_n297_), .c(new_n287_), .O(new_n469_));
  inv1   g312(.a(new_n469_), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(new_n468_), .c(x006), .O(new_n471_));
  nand2  g314(.a(new_n290_), .b(x030), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n288_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n451_), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n287_), .c(new_n455_), .O(new_n475_));
  nor2   g318(.a(new_n286_), .b(x022), .O(new_n476_));
  oai21  g319(.a(new_n476_), .b(new_n320_), .c(x070), .O(new_n477_));
  nand4  g320(.a(new_n457_), .b(new_n453_), .c(new_n290_), .d(x030), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n477_), .c(x078), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(new_n475_), .c(new_n279_), .O(new_n480_));
  nand2  g323(.a(new_n457_), .b(x030), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n316_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n451_), .c(x038), .O(new_n483_));
  ...
  aoi21  g331(.a(new_n484_), .b(new_n292_), .c(new_n488_), .O(new_n489_));
