// Benchmark "FAU" written by ABC on Fri Jun 26 05:06:31 2020
...
module FAU ( 
  ...
  and2   g141(.a(x110), .b(x022), .O(new_n298_));
  aoi21  g142(.a(new_n298_), .b(new_n297_), .c(new_n296_), .O(new_n299_));
  inv1   g143(.a(x038), .O(new_n300_));
  oai21  g144(.a(x126), .b(new_n287_), .c(new_n300_), .O(new_n301_));
  nand2  g145(.a(new_n301_), .b(new_n286_), .O(new_n302_));
  inv1   g146(.a(x062), .O(new_n303_));
  oai21  g147(.a(x102), .b(new_n303_), .c(x118), .O(new_n304_));
  ...
  oai21  g304(.a(new_n451_), .b(x062), .c(new_n286_), .O(new_n462_));
