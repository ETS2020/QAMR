// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:23 2020
...
module FAU ( 
  ...
  nand2  g071(.a(x117), .b(x109), .O(new_n228_));
  inv1   g072(.a(new_n228_), .O(new_n229_));
  aoi21  g073(.a(new_n229_), .b(new_n227_), .c(new_n225_), .O(new_n230_));
  ...
  oai21  g079(.a(new_n235_), .b(new_n231_), .c(new_n234_), .O(new_n236_));
  inv1   g080(.a(x085), .O(new_n237_));
  inv1   g081(.a(x125), .O(new_n238_));
  and2   g082(.a(x117), .b(x021), .O(new_n239_));
  aoi21  g083(.a(new_n239_), .b(new_n238_), .c(new_n237_), .O(new_n240_));
  inv1   g084(.a(x117), .O(new_n241_));
  inv1   g085(.a(x037), .O(new_n242_));
  inv1   g086(.a(x109), .O(new_n243_));
  oai21  g087(.a(x125), .b(new_n243_), .c(new_n242_), .O(new_n244_));
  ...
  nand4  g092(.a(new_n248_), .b(new_n245_), .c(new_n240_), .d(new_n236_), .O(new_n249_));
  oai21  g093(.a(new_n249_), .b(new_n230_), .c(x077), .O(new_n250_));
  nand4  g094(.a(new_n238_), .b(x061), .c(x037), .d(new_n232_), .O(new_n251_));
  aoi21  g095(.a(new_n251_), .b(new_n250_), .c(new_n224_), .O(new_n252_));
  nor3   g096(.a(x085), .b(new_n242_), .c(new_n232_), .O(new_n253_));
  oai21  g097(.a(new_n253_), .b(new_n252_), .c(new_n223_), .O(new_n254_));
  nand3  g098(.a(x085), .b(x053), .c(new_n231_), .O(new_n255_));
  aoi21  g099(.a(new_n255_), .b(x021), .c(new_n242_), .O(new_n256_));
  inv1   g100(.a(new_n235_), .O(new_n257_));
  nand2  g101(.a(x085), .b(x053), .O(new_n258_));
  nor2   g102(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  oai21  g103(.a(new_n259_), .b(new_n256_), .c(new_n225_), .O(new_n260_));
  nor2   g104(.a(x093), .b(x061), .O(new_n261_));
  oai21  g105(.a(new_n261_), .b(x029), .c(x021), .O(new_n262_));
  nand2  g106(.a(new_n262_), .b(new_n228_), .O(new_n263_));
  inv1   g107(.a(x093), .O(new_n264_));
  nand2  g108(.a(new_n264_), .b(new_n246_), .O(new_n265_));
  nand4  g109(.a(new_n265_), .b(new_n234_), .c(new_n226_), .d(new_n231_), .O(new_n266_));
  aoi21  g110(.a(new_n266_), .b(new_n263_), .c(new_n224_), .O(new_n267_));
  nand2  g111(.a(new_n234_), .b(new_n231_), .O(new_n268_));
  aoi21  g112(.a(new_n268_), .b(new_n257_), .c(x037), .O(new_n269_));
  oai21  g113(.a(new_n269_), .b(new_n267_), .c(x085), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(new_n260_), .O(new_n271_));
  oai21  g115(.a(new_n258_), .b(new_n229_), .c(x077), .O(new_n272_));
  nand2  g116(.a(new_n272_), .b(new_n232_), .O(new_n273_));
  nor2   g117(.a(x021), .b(new_n232_), .O(new_n274_));
  nor2   g118(.a(x069), .b(new_n224_), .O(new_n275_));
  aoi22  g119(.a(new_n275_), .b(new_n274_), .c(new_n224_), .d(new_n242_), .O(new_n276_));
  nand2  g120(.a(new_n276_), .b(new_n273_), .O(new_n277_));
  aoi21  g121(.a(new_n271_), .b(x077), .c(new_n277_), .O(new_n278_));
  aoi21  g122(.a(new_n278_), .b(new_n254_), .c(new_n222_), .O(z05));
  ...
  aoi21  g132(.a(new_n288_), .b(new_n285_), .c(new_n283_), .O(new_n289_));
  ...
  and2   g141(.a(x118), .b(x022), .O(new_n298_));
  aoi21  g142(.a(new_n298_), .b(new_n297_), .c(new_n296_), .O(new_n299_));
  inv1   g143(.a(x038), .O(new_n300_));
  oai21  g144(.a(x126), .b(new_n286_), .c(new_n300_), .O(new_n301_));
  ...
  nand4  g149(.a(new_n305_), .b(new_n302_), .c(new_n299_), .d(new_n295_), .O(new_n306_));
  oai21  g150(.a(new_n306_), .b(new_n289_), .c(x078), .O(new_n307_));
  nand4  g151(.a(new_n297_), .b(x062), .c(x038), .d(new_n291_), .O(new_n308_));
  aoi21  g152(.a(new_n308_), .b(new_n307_), .c(new_n282_), .O(new_n309_));
  nor3   g153(.a(x086), .b(new_n300_), .c(new_n291_), .O(new_n310_));
  oai21  g154(.a(new_n310_), .b(new_n309_), .c(new_n281_), .O(new_n311_));
  ...
  aoi21  g158(.a(new_n314_), .b(x014), .c(new_n288_), .O(new_n315_));
  inv1   g159(.a(x078), .O(new_n316_));
  nor2   g160(.a(x030), .b(new_n292_), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n294_), .c(new_n283_), .O(new_n318_));
  inv1   g162(.a(x094), .O(new_n319_));
  nand2  g163(.a(new_n319_), .b(new_n303_), .O(new_n320_));
  nand4  g164(.a(new_n320_), .b(new_n293_), .c(new_n284_), .d(new_n290_), .O(new_n321_));
  aoi21  g165(.a(new_n321_), .b(new_n318_), .c(new_n316_), .O(new_n322_));
  oai21  g166(.a(new_n322_), .b(new_n315_), .c(x054), .O(new_n323_));
  aoi21  g167(.a(new_n292_), .b(new_n291_), .c(x030), .O(new_n324_));
  nor2   g168(.a(new_n316_), .b(x038), .O(new_n325_));
  oai21  g169(.a(new_n324_), .b(new_n294_), .c(new_n325_), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n323_), .O(new_n327_));
  aoi22  g171(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n328_));
  nand2  g172(.a(new_n283_), .b(new_n292_), .O(new_n329_));
  aoi22  g173(.a(new_n316_), .b(new_n291_), .c(new_n282_), .d(new_n300_), .O(new_n330_));
  oai21  g174(.a(new_n329_), .b(new_n328_), .c(new_n330_), .O(new_n331_));
  aoi21  g175(.a(new_n327_), .b(x086), .c(new_n331_), .O(new_n332_));
  aoi21  g176(.a(new_n332_), .b(new_n311_), .c(new_n280_), .O(z06));
  ...
  nand2  g255(.a(new_n238_), .b(new_n412_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n264_), .O(new_n414_));
  nor2   g257(.a(x117), .b(x109), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n414_), .c(x069), .O(new_n416_));
  nand2  g259(.a(x021), .b(x013), .O(new_n417_));
  oai21  g260(.a(new_n265_), .b(x029), .c(new_n417_), .O(new_n418_));
  nor2   g261(.a(x117), .b(x021), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(x125), .c(x085), .O(new_n420_));
  oai21  g263(.a(new_n238_), .b(x109), .c(x037), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(x117), .O(new_n422_));
  oai21  g265(.a(new_n412_), .b(x061), .c(new_n243_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n242_), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n422_), .c(new_n420_), .d(new_n418_), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(new_n416_), .c(new_n411_), .O(new_n426_));
  nand4  g269(.a(x125), .b(new_n246_), .c(new_n242_), .d(x013), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n426_), .c(x053), .O(new_n428_));
  nand3  g271(.a(x085), .b(new_n242_), .c(new_n232_), .O(new_n429_));
  inv1   g272(.a(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n428_), .c(x005), .O(new_n431_));
  nand2  g274(.a(new_n235_), .b(x029), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n233_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n411_), .O(new_n434_));
  aoi21  g277(.a(new_n434_), .b(new_n232_), .c(new_n415_), .O(new_n435_));
  nor2   g278(.a(new_n231_), .b(x021), .O(new_n436_));
  oai21  g279(.a(new_n436_), .b(new_n265_), .c(x069), .O(new_n437_));
  nand4  g280(.a(new_n417_), .b(new_n413_), .c(new_n235_), .d(x029), .O(new_n438_));
  aoi21  g281(.a(new_n438_), .b(new_n437_), .c(x077), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(new_n435_), .c(new_n224_), .O(new_n440_));
  nand2  g283(.a(new_n417_), .b(x029), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n261_), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n411_), .c(x037), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n440_), .O(new_n444_));
  oai22  g287(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(x069), .c(x021), .O(new_n446_));
  aoi22  g289(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n446_), .O(new_n448_));
  aoi21  g291(.a(new_n444_), .b(new_n237_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n431_), .c(x045), .O(z13));
  inv1   g293(.a(x102), .O(new_n451_));
  nand2  g294(.a(new_n297_), .b(new_n451_), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(new_n319_), .O(new_n453_));
  nor2   g296(.a(x118), .b(x110), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n453_), .c(x070), .O(new_n455_));
  nand2  g298(.a(x022), .b(x014), .O(new_n456_));
  oai21  g299(.a(new_n320_), .b(x030), .c(new_n456_), .O(new_n457_));
  nor2   g300(.a(x110), .b(x022), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(x126), .c(x086), .O(new_n459_));
  oai21  g302(.a(new_n297_), .b(x118), .c(x038), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(x110), .O(new_n461_));
  oai21  g304(.a(new_n451_), .b(x062), .c(new_n287_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n300_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n461_), .c(new_n459_), .d(new_n457_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n455_), .c(new_n316_), .O(new_n465_));
  nand4  g308(.a(x126), .b(new_n303_), .c(new_n300_), .d(x014), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n465_), .c(x054), .O(new_n467_));
  nand3  g310(.a(x086), .b(new_n300_), .c(new_n291_), .O(new_n468_));
  inv1   g311(.a(new_n468_), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n467_), .c(x006), .O(new_n470_));
  nand2  g313(.a(new_n294_), .b(x030), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n292_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n316_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n291_), .c(new_n454_), .O(new_n474_));
  nor2   g317(.a(new_n290_), .b(x022), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n320_), .c(x070), .O(new_n476_));
  nand4  g319(.a(new_n456_), .b(new_n452_), .c(new_n294_), .d(x030), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n476_), .c(x078), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n474_), .c(new_n282_), .O(new_n479_));
  nand2  g322(.a(new_n456_), .b(x030), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n312_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n316_), .c(x038), .O(new_n482_));
  ...
  aoi21  g330(.a(new_n483_), .b(new_n296_), .c(new_n487_), .O(new_n488_));
