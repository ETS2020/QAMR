...
module FAU ( 
  ...
  nand2  g295(.a(new_n452_), .b(new_n303_), .O(new_n453_));
  ...
  oai21  g304(.a(new_n451_), .b(x094), .c(new_n286_), .O(new_n462_));
  ...
  nand4  g308(.a(x126), .b(new_n319_), .c(new_n300_), .d(x014), .O(new_n466_));
