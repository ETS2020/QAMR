...
module FAU ( 
  ...
  oai21  g035(.a(x21), .b(x16), .c(new_n79_), .O(new_n80_));
  ...
  inv1   g072(.a(x21), .O(new_n117_));
  oai21  g073(.a(new_n87_), .b(new_n117_), .c(new_n116_), .O(new_n118_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n116_), .c(x11), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n77_), .O(new_n136_));
  nand3  g092(.a(x16), .b(new_n77_), .c(x10), .O(new_n137_));
  ...
  nor2   g101(.a(new_n116_), .b(new_n77_), .O(new_n146_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n116_), .O(new_n150_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n133_), .c(new_n77_), .O(new_n155_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n154_), .c(new_n77_), .O(new_n189_));
