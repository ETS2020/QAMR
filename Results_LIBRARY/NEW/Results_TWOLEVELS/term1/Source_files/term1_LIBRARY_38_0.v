// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:52 2020
...
module FAU ( 
  ...
  nor3   g082(.a(new_n123_), .b(new_n122_), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n93_), .b(new_n92_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n98_), .c(x29), .O(new_n129_));
  ...
  oai21  g089(.a(new_n127_), .b(new_n126_), .c(new_n133_), .O(new_n134_));
  nor2   g090(.a(new_n116_), .b(new_n114_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(x17), .c(x16), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n112_), .O(new_n137_));
  nand3  g093(.a(new_n135_), .b(x17), .c(x11), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n122_), .O(new_n139_));
  nand2  g095(.a(new_n135_), .b(x12), .O(new_n140_));
  ...
  oai21  g113(.a(new_n127_), .b(new_n126_), .c(new_n157_), .O(new_n158_));
  ...
  aoi21  g131(.a(new_n174_), .b(x16), .c(x19), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(x11), .c(x16), .O(new_n177_));
