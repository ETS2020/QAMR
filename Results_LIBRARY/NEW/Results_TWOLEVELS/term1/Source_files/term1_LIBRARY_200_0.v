...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n88_), .c(new_n58_), .O(new_n97_));
  nor2   g053(.a(new_n97_), .b(new_n80_), .O(z5));
  oai21  g054(.a(new_n91_), .b(new_n93_), .c(new_n47_), .O(new_n99_));
  inv1   g055(.a(x30), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(x29), .c(x28), .d(new_n50_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x27), .O(new_n103_));
  nor2   g059(.a(new_n100_), .b(x02), .O(new_n104_));
  oai21  g060(.a(new_n100_), .b(x02), .c(x03), .O(new_n105_));
  nand2  g061(.a(x29), .b(x28), .O(new_n106_));
  aoi22  g062(.a(new_n106_), .b(new_n104_), .c(new_n105_), .d(new_n92_), .O(new_n107_));
  nand2  g063(.a(new_n88_), .b(new_n81_), .O(new_n108_));
  aoi21  g064(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nand4  g066(.a(new_n94_), .b(new_n110_), .c(x30), .d(x29), .O(new_n111_));
  nand2  g067(.a(new_n88_), .b(new_n58_), .O(new_n112_));
  nor2   g068(.a(new_n100_), .b(new_n91_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n94_), .c(new_n110_), .O(new_n114_));
  ...
  nand2  g089(.a(new_n93_), .b(new_n92_), .O(new_n134_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n93_), .O(new_n153_));
  oai21  g109(.a(x19), .b(x14), .c(x31), .O(new_n154_));
  aoi21  g110(.a(new_n100_), .b(new_n91_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g120(.a(new_n110_), .b(new_n100_), .O(new_n165_));
  ...
  nand2  g129(.a(x31), .b(new_n100_), .O(new_n174_));
