// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:39 2020
...
module FAU ( 
  ...
  nand2  g097(.a(new_n102_), .b(x27), .O(new_n142_));
  oai21  g098(.a(x30), .b(x27), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n86_), .O(new_n144_));
  oai21  g100(.a(x19), .b(x14), .c(x31), .O(new_n145_));
  aoi21  g101(.a(new_n94_), .b(new_n101_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(x19), .b(x13), .c(x18), .O(new_n147_));
  aoi21  g103(.a(new_n102_), .b(x28), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g106(.a(new_n79_), .b(x00), .O(new_n151_));
  aoi21  g107(.a(new_n150_), .b(new_n131_), .c(new_n151_), .O(z8));
  inv1   g108(.a(x33), .O(new_n153_));
  oai21  g109(.a(new_n124_), .b(new_n122_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n105_), .b(new_n94_), .O(new_n155_));
  oai22  g111(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n105_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n127_), .O(new_n157_));
  inv1   g113(.a(new_n127_), .O(new_n158_));
  nand2  g114(.a(x31), .b(x30), .O(new_n159_));
  nand2  g115(.a(x33), .b(new_n105_), .O(new_n160_));
  ...
  nand2  g119(.a(x31), .b(new_n94_), .O(new_n164_));
  ...
  nand2  g123(.a(new_n112_), .b(x14), .O(new_n168_));
  nor2   g124(.a(new_n110_), .b(new_n109_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n132_), .O(new_n170_));
  nand2  g126(.a(new_n169_), .b(new_n132_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n112_), .O(new_n172_));
  inv1   g128(.a(new_n169_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n140_), .c(new_n108_), .O(new_n174_));
  ...
  nor2   g134(.a(new_n178_), .b(new_n153_), .O(new_n179_));
  aoi21  g135(.a(new_n161_), .b(new_n158_), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n157_), .c(new_n151_), .O(z9));
endmodule
