...
module FAU ( 
  ...
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(x10), .O(new_n124_));
  nand2  g080(.a(x16), .b(x00), .O(new_n125_));
  aoi21  g081(.a(new_n124_), .b(new_n120_), .c(new_n125_), .O(new_n126_));
  inv1   g082(.a(x11), .O(new_n127_));
  nor4   g083(.a(new_n122_), .b(x16), .c(new_n121_), .d(new_n127_), .O(new_n128_));
  ...
  nand2  g091(.a(new_n115_), .b(x14), .O(new_n136_));
  nor2   g092(.a(new_n113_), .b(new_n112_), .O(new_n137_));
  ...
  nand2  g107(.a(new_n113_), .b(new_n151_), .O(new_n152_));
  ...
  aoi21  g111(.a(new_n108_), .b(x28), .c(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n154_), .c(new_n150_), .O(new_n157_));
  inv1   g113(.a(x00), .O(new_n158_));
  nor2   g114(.a(z0), .b(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n157_), .b(new_n147_), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n135_), .c(x26), .O(z8));
  aoi21  g117(.a(new_n124_), .b(new_n120_), .c(x33), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n106_), .c(new_n98_), .d(x16), .O(new_n163_));
  nand2  g119(.a(x33), .b(x31), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n163_), .c(new_n158_), .O(new_n165_));
  nand4  g121(.a(x17), .b(new_n144_), .c(x15), .d(x11), .O(new_n166_));
  inv1   g122(.a(x33), .O(new_n167_));
  nor2   g123(.a(new_n115_), .b(new_n113_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n167_), .c(new_n106_), .d(new_n98_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n165_), .c(new_n131_), .O(new_n171_));
  inv1   g127(.a(new_n131_), .O(new_n172_));
  nand3  g128(.a(x31), .b(x30), .c(x16), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nor2   g130(.a(new_n167_), .b(x31), .O(new_n175_));
  aoi21  g131(.a(new_n174_), .b(new_n162_), .c(new_n175_), .O(new_n176_));
  inv1   g132(.a(new_n166_), .O(new_n177_));
  nor3   g133(.a(x33), .b(new_n106_), .c(new_n98_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n177_), .c(new_n168_), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n158_), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(new_n106_), .b(x30), .O(new_n181_));
  inv1   g137(.a(new_n155_), .O(new_n182_));
  nand2  g138(.a(x31), .b(new_n98_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n152_), .d(new_n181_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n147_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x00), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  aoi21  g143(.a(new_n180_), .b(new_n172_), .c(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n171_), .c(x26), .O(z9));
endmodule
