...
module FAU ( 
  ...
  aoi21  g064(.a(new_n108_), .b(x31), .c(new_n96_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n107_), .c(new_n81_), .O(z7));
  inv1   g066(.a(x00), .O(new_n111_));
  aoi21  g067(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n112_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n128_), .c(z0), .O(new_n131_));
  nand2  g087(.a(x32), .b(new_n98_), .O(new_n132_));
  ...
  oai21  g091(.a(new_n131_), .b(x30), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n112_), .O(new_n137_));
  nand2  g093(.a(new_n118_), .b(x14), .O(new_n138_));
  nor2   g094(.a(new_n116_), .b(new_n115_), .O(new_n139_));
  ...
  nand2  g103(.a(new_n139_), .b(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n124_), .O(new_n149_));
  nand2  g105(.a(new_n140_), .b(new_n118_), .O(new_n150_));
  nand3  g106(.a(new_n139_), .b(x16), .c(x10), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n114_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n147_), .c(x32), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n137_), .c(new_n134_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x31), .O(new_n156_));
  nor2   g112(.a(x31), .b(x26), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n156_), .c(new_n111_), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  oai21  g116(.a(new_n130_), .b(new_n128_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(x31), .b(x30), .O(new_n162_));
  nand2  g118(.a(new_n157_), .b(x33), .O(new_n163_));
  oai21  g119(.a(new_n162_), .b(new_n161_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n112_), .O(new_n165_));
  nand2  g121(.a(new_n157_), .b(new_n98_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n161_), .c(new_n160_), .d(new_n106_), .O(new_n167_));
  inv1   g123(.a(x26), .O(new_n168_));
  nand2  g124(.a(new_n106_), .b(x30), .O(new_n169_));
  nand4  g125(.a(new_n146_), .b(new_n144_), .c(new_n142_), .d(new_n169_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n153_), .c(new_n168_), .O(new_n171_));
  nand2  g127(.a(x31), .b(new_n98_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(new_n160_), .O(new_n173_));
  aoi21  g129(.a(new_n167_), .b(new_n113_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n165_), .c(new_n111_), .O(z9));
endmodule
