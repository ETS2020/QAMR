...
module FAU ( 
  ...
  nand3  g083(.a(new_n127_), .b(new_n123_), .c(x11), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n122_), .c(new_n113_), .O(new_n129_));
  ...
  nand2  g092(.a(x17), .b(x15), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n124_), .c(new_n123_), .O(new_n138_));
  nand2  g094(.a(x17), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n124_), .c(new_n113_), .O(new_n140_));
  inv1   g096(.a(x12), .O(new_n141_));
  oai21  g097(.a(new_n124_), .b(new_n141_), .c(new_n114_), .O(new_n142_));
  ...
  nand2  g101(.a(new_n109_), .b(x27), .O(new_n146_));
  ...
  aoi21  g107(.a(new_n109_), .b(x28), .c(new_n151_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n145_), .c(x32), .O(new_n154_));
  oai21  g110(.a(new_n136_), .b(new_n132_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x00), .O(new_n156_));
  inv1   g112(.a(x11), .O(new_n157_));
  nand3  g113(.a(x32), .b(new_n123_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n156_), .c(x26), .O(z8));
  ...
  oai21  g127(.a(new_n115_), .b(new_n141_), .c(new_n114_), .O(new_n172_));
  nand2  g128(.a(x31), .b(new_n98_), .O(new_n173_));
  inv1   g129(.a(x13), .O(new_n174_));
  nand2  g130(.a(new_n115_), .b(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n173_), .c(new_n172_), .d(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n117_), .b(x14), .O(new_n177_));
  nor2   g133(.a(new_n115_), .b(new_n114_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n177_), .c(new_n143_), .O(new_n179_));
  aoi21  g135(.a(new_n178_), .b(x15), .c(x19), .O(new_n180_));
  aoi21  g136(.a(new_n178_), .b(x10), .c(x15), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n179_), .c(new_n138_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n176_), .c(x33), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n170_), .c(new_n166_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x00), .O(new_n186_));
  nand3  g142(.a(x33), .b(new_n123_), .c(new_n157_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n186_), .c(x26), .O(z9));
endmodule
