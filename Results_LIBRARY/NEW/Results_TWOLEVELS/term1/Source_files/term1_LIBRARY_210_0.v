...
module FAU ( 
  ...
  nand3  g065(.a(x18), .b(new_n109_), .c(x12), .O(new_n110_));
  inv1   g066(.a(x18), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x17), .c(x13), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(new_n113_));
  nand4  g069(.a(x18), .b(x17), .c(new_n108_), .d(x11), .O(new_n114_));
  ...
  nand2  g120(.a(new_n111_), .b(x13), .O(new_n165_));
