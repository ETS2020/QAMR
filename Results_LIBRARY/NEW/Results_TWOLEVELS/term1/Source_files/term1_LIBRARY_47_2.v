...
module FAU ( 
  ...
  nand3  g069(.a(x19), .b(new_n113_), .c(x12), .O(new_n114_));
  ...
  and2   g085(.a(x31), .b(x18), .O(new_n130_));
  ...
  nand2  g100(.a(x19), .b(x12), .O(new_n145_));
  ...
  nand3  g110(.a(new_n106_), .b(new_n98_), .c(x18), .O(new_n155_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n138_), .c(new_n165_), .d(x18), .O(new_n167_));
