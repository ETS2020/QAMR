// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:42 2020
...
module FAU ( 
  ...
  nor2   g061(.a(new_n98_), .b(new_n91_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n94_), .c(new_n105_), .O(new_n107_));
  aoi21  g063(.a(new_n106_), .b(new_n94_), .c(new_n105_), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n96_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n107_), .c(new_n81_), .O(z7));
  inv1   g066(.a(x15), .O(new_n111_));
  inv1   g067(.a(x16), .O(new_n112_));
  nand3  g068(.a(x19), .b(x18), .c(x17), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  inv1   g070(.a(x18), .O(new_n115_));
  inv1   g071(.a(x19), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x17), .c(x11), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n112_), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(x12), .c(x17), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g078(.a(x16), .b(x10), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n113_), .c(new_n111_), .O(new_n124_));
  nand2  g080(.a(new_n106_), .b(x27), .O(new_n125_));
  oai21  g081(.a(x30), .b(x27), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n93_), .O(new_n127_));
  inv1   g083(.a(x14), .O(new_n128_));
  nand2  g084(.a(new_n116_), .b(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x31), .O(new_n130_));
  aoi21  g086(.a(new_n98_), .b(new_n91_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(x19), .b(x13), .O(new_n132_));
  aoi22  g088(.a(new_n132_), .b(new_n115_), .c(new_n106_), .d(x28), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n127_), .d(new_n124_), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n122_), .c(new_n114_), .O(new_n135_));
  inv1   g091(.a(x26), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x00), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n135_), .O(z8));
  aoi21  g094(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  inv1   g096(.a(x33), .O(new_n141_));
  inv1   g097(.a(x17), .O(new_n142_));
  nand3  g098(.a(x19), .b(new_n115_), .c(x13), .O(new_n143_));
  nand3  g099(.a(new_n116_), .b(x18), .c(x14), .O(new_n144_));
  ...
  inv1   g104(.a(new_n113_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n112_), .c(x11), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n148_), .c(new_n111_), .O(new_n151_));
  nor3   g107(.a(new_n123_), .b(new_n113_), .c(x15), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n141_), .O(new_n153_));
  nand2  g109(.a(new_n105_), .b(new_n98_), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n153_), .c(new_n141_), .d(new_n98_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n140_), .O(new_n156_));
  nand2  g112(.a(x31), .b(x30), .O(new_n157_));
  nand2  g113(.a(x33), .b(new_n105_), .O(new_n158_));
  oai21  g114(.a(new_n157_), .b(new_n153_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n132_), .b(new_n115_), .O(new_n160_));
  nand2  g116(.a(x31), .b(new_n98_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n160_), .c(new_n129_), .d(new_n119_), .O(new_n162_));
  nor3   g118(.a(new_n162_), .b(new_n120_), .c(new_n114_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n124_), .c(new_n141_), .O(new_n164_));
  aoi21  g120(.a(new_n159_), .b(new_n139_), .c(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n156_), .c(new_n137_), .O(z9));
endmodule
