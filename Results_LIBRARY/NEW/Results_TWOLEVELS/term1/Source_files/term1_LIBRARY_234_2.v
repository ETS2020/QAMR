...
module FAU ( 
  ...
  inv1   g083(.a(x10), .O(new_n128_));
  nor2   g084(.a(x15), .b(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(x17), .d(x16), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand2  g087(.a(new_n97_), .b(new_n96_), .O(new_n132_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n103_), .c(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n131_), .c(z0), .d(x31), .O(new_n137_));
  nand2  g093(.a(new_n127_), .b(x12), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n118_), .O(new_n139_));
  nand3  g095(.a(new_n127_), .b(x17), .c(x10), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n77_), .O(new_n141_));
  nand2  g097(.a(new_n103_), .b(new_n95_), .O(new_n142_));
  inv1   g098(.a(x14), .O(new_n143_));
  nand2  g099(.a(x31), .b(x16), .O(new_n144_));
  aoi21  g100(.a(new_n121_), .b(new_n143_), .c(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n142_), .c(new_n141_), .d(new_n139_), .O(new_n146_));
  nand2  g102(.a(new_n114_), .b(x27), .O(new_n147_));
  oai21  g103(.a(x30), .b(x27), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n97_), .O(new_n149_));
  nand2  g105(.a(new_n114_), .b(x28), .O(new_n150_));
  aoi21  g106(.a(x19), .b(x13), .c(x18), .O(new_n151_));
  nor2   g107(.a(new_n118_), .b(new_n77_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n127_), .c(new_n151_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n150_), .c(new_n149_), .O(new_n154_));
  ...
  nand2  g115(.a(new_n131_), .b(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n112_), .b(new_n103_), .O(new_n161_));
  ...
  nor2   g120(.a(new_n112_), .b(new_n103_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n131_), .c(new_n159_), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n112_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  aoi21  g124(.a(x18), .b(x12), .c(x17), .O(new_n169_));
  oai21  g125(.a(x31), .b(new_n103_), .c(x16), .O(new_n170_));
  nor2   g126(.a(x18), .b(x13), .O(new_n171_));
  nor2   g127(.a(new_n112_), .b(x30), .O(new_n172_));
  nor4   g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n169_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n128_), .c(new_n77_), .O(new_n175_));
  nand2  g131(.a(new_n121_), .b(x14), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n152_), .c(x18), .O(new_n177_));
  ...
  aoi21  g136(.a(new_n180_), .b(new_n173_), .c(new_n159_), .O(new_n181_));
  aoi21  g137(.a(new_n168_), .b(new_n135_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n164_), .c(new_n157_), .O(z9));
endmodule
