// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:36 2020
...
module FAU ( 
  ...
  nor2   g037(.a(x26), .b(new_n56_), .O(new_n82_));
  nand4  g038(.a(new_n82_), .b(new_n81_), .c(new_n57_), .d(new_n76_), .O(new_n83_));
  inv1   g039(.a(new_n83_), .O(z3));
  xor2a  g040(.a(x28), .b(x27), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n82_), .c(new_n81_), .d(new_n57_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(z4));
  inv1   g043(.a(x29), .O(new_n88_));
  inv1   g044(.a(x28), .O(new_n89_));
  nor2   g045(.a(new_n89_), .b(new_n76_), .O(new_n90_));
  xor2a  g046(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand2  g047(.a(new_n82_), .b(new_n57_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n91_), .c(new_n80_), .O(z5));
  inv1   g049(.a(x30), .O(new_n94_));
  nand2  g050(.a(new_n90_), .b(x29), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n90_), .b(new_n94_), .c(x29), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n94_), .c(new_n97_), .O(new_n98_));
  nor2   g054(.a(new_n92_), .b(new_n80_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z6));
  inv1   g057(.a(x31), .O(new_n102_));
  nand3  g058(.a(new_n96_), .b(new_n102_), .c(x30), .O(new_n103_));
  nor2   g059(.a(new_n94_), .b(new_n88_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(x31), .c(new_n92_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n103_), .c(new_n81_), .O(z7));
  ...
  nand3  g078(.a(x16), .b(new_n108_), .c(x10), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  nand2  g080(.a(new_n89_), .b(new_n76_), .O(new_n125_));
  ...
  nor2   g087(.a(new_n118_), .b(new_n108_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n120_), .O(new_n133_));
  nor2   g089(.a(new_n112_), .b(new_n110_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(x17), .c(x11), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n118_), .O(new_n136_));
  nand2  g092(.a(new_n134_), .b(x12), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n109_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n136_), .c(new_n133_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x10), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n119_), .c(new_n108_), .O(new_n141_));
  nand2  g097(.a(new_n104_), .b(x27), .O(new_n142_));
  oai21  g098(.a(x30), .b(x27), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n89_), .O(new_n144_));
  oai21  g100(.a(x19), .b(x14), .c(x31), .O(new_n145_));
  aoi21  g101(.a(new_n94_), .b(new_n88_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(x19), .b(x13), .c(x18), .O(new_n147_));
  aoi21  g103(.a(new_n104_), .b(x28), .c(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n139_), .c(x32), .O(new_n150_));
  inv1   g106(.a(x26), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x00), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n131_), .c(new_n152_), .O(z8));
  inv1   g109(.a(x33), .O(new_n154_));
  oai21  g110(.a(new_n124_), .b(new_n122_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n102_), .b(new_n94_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n102_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n127_), .O(new_n158_));
  inv1   g114(.a(new_n127_), .O(new_n159_));
  nand2  g115(.a(x31), .b(x30), .O(new_n160_));
  nand2  g116(.a(x33), .b(new_n102_), .O(new_n161_));
  oai21  g117(.a(new_n160_), .b(new_n155_), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(x18), .b(x12), .c(x17), .O(new_n163_));
  nand2  g119(.a(new_n102_), .b(x30), .O(new_n164_));
  nand2  g120(.a(x31), .b(new_n94_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  nand2  g122(.a(new_n110_), .b(new_n166_), .O(new_n167_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n169_), .c(new_n132_), .O(new_n171_));
  nand2  g127(.a(new_n170_), .b(new_n132_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n112_), .O(new_n173_));
  inv1   g129(.a(new_n170_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n140_), .c(new_n108_), .O(new_n175_));
  nand2  g131(.a(new_n170_), .b(x11), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n118_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n175_), .c(new_n173_), .d(new_n171_), .O(new_n178_));
  nor3   g134(.a(new_n178_), .b(new_n168_), .c(new_n163_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n154_), .O(new_n180_));
  aoi21  g136(.a(new_n162_), .b(new_n159_), .c(new_n180_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n158_), .c(new_n152_), .O(z9));
endmodule
