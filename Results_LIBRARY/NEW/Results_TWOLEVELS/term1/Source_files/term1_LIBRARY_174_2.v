...
module FAU ( 
  ...
  nand3  g050(.a(new_n91_), .b(x28), .c(x27), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  nand2  g052(.a(new_n88_), .b(new_n57_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g055(.a(new_n80_), .b(new_n77_), .c(new_n99_), .O(z5));
  inv1   g056(.a(x30), .O(new_n101_));
  oai21  g057(.a(new_n91_), .b(new_n93_), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(x27), .c(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n98_), .c(new_n81_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z6));
  nor2   g061(.a(new_n91_), .b(new_n93_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n92_), .c(x31), .O(new_n108_));
  inv1   g064(.a(x31), .O(new_n109_));
  nand3  g065(.a(new_n94_), .b(new_n109_), .c(x29), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n108_), .c(new_n98_), .d(new_n81_), .O(z7));
  ...
  nand2  g086(.a(new_n106_), .b(new_n101_), .O(new_n131_));
  ...
  oai21  g090(.a(new_n91_), .b(new_n92_), .c(x30), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  ...
  nand3  g097(.a(new_n124_), .b(x16), .c(x15), .O(new_n142_));
  ...
  aoi21  g102(.a(new_n101_), .b(new_n91_), .c(new_n146_), .O(new_n147_));
  inv1   g103(.a(x13), .O(new_n148_));
  oai21  g104(.a(new_n116_), .b(new_n148_), .c(new_n114_), .O(new_n149_));
  nand2  g105(.a(new_n106_), .b(x30), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n151_));
  ...
  oai21  g111(.a(new_n101_), .b(new_n93_), .c(new_n92_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x31), .c(x29), .O(new_n157_));
  nand3  g113(.a(new_n107_), .b(new_n109_), .c(new_n101_), .O(new_n158_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n122_), .O(new_n163_));
  nand4  g119(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n116_), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n144_), .c(new_n112_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  oai21  g123(.a(new_n114_), .b(new_n140_), .c(new_n113_), .O(new_n168_));
  nand2  g124(.a(new_n114_), .b(new_n148_), .O(new_n169_));
  nand2  g125(.a(new_n109_), .b(x30), .O(new_n170_));
  and2   g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  aoi21  g127(.a(new_n116_), .b(x14), .c(new_n164_), .O(new_n172_));
  aoi21  g128(.a(new_n129_), .b(x31), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n168_), .d(new_n131_), .O(new_n174_));
