...
module FAU ( 
  ...
  nand4  g065(.a(new_n109_), .b(new_n107_), .c(new_n98_), .d(new_n81_), .O(z7));
  ...
  oai21  g083(.a(x32), .b(new_n93_), .c(new_n92_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n101_), .O(new_n129_));
  aoi21  g085(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(z0), .c(x30), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(new_n106_), .O(new_n133_));
  ...
  nand3  g105(.a(x30), .b(x29), .c(x28), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n147_), .d(new_n144_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n142_), .c(x32), .O(new_n152_));
  ...
  oai21  g112(.a(new_n127_), .b(new_n125_), .c(new_n156_), .O(new_n157_));
  inv1   g113(.a(x30), .O(new_n158_));
  nand2  g114(.a(new_n106_), .b(new_n158_), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n157_), .c(new_n156_), .d(new_n106_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n131_), .O(new_n161_));
  nand2  g117(.a(x31), .b(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n106_), .O(new_n163_));
  ...
  nand2  g122(.a(x31), .b(new_n158_), .O(new_n167_));
  nand2  g123(.a(new_n113_), .b(new_n148_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .O(new_n169_));
  nand2  g125(.a(new_n115_), .b(x14), .O(new_n170_));
  nor2   g126(.a(new_n113_), .b(new_n112_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n170_), .c(new_n135_), .O(new_n172_));
  nand2  g128(.a(new_n171_), .b(new_n135_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n115_), .O(new_n174_));
  inv1   g130(.a(new_n171_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n143_), .c(new_n111_), .O(new_n176_));
  nand2  g132(.a(new_n171_), .b(x11), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n121_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n164_), .b(new_n130_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n161_), .c(new_n154_), .O(z9));
endmodule
