...
module FAU ( 
  ...
  aoi21  g086(.a(new_n129_), .b(new_n102_), .c(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n128_), .b(new_n126_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n98_), .b(new_n92_), .O(new_n133_));
  nand4  g089(.a(x32), .b(x30), .c(x29), .d(x27), .O(new_n134_));
  ...
  nand2  g095(.a(new_n138_), .b(x12), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n113_), .c(new_n139_), .d(new_n122_), .O(new_n141_));
  nand2  g097(.a(x16), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n123_), .c(new_n112_), .O(new_n143_));
  inv1   g099(.a(x14), .O(new_n144_));
  aoi21  g100(.a(new_n116_), .b(new_n144_), .c(new_n107_), .O(new_n145_));
  oai21  g101(.a(x30), .b(x29), .c(new_n145_), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  oai21  g103(.a(new_n116_), .b(new_n147_), .c(new_n114_), .O(new_n148_));
  nand3  g104(.a(x30), .b(x29), .c(x28), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n143_), .c(new_n141_), .d(new_n137_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(x32), .c(new_n135_), .O(new_n153_));
  inv1   g109(.a(x26), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x00), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(new_n132_), .c(new_n155_), .O(z8));
  ...
  nand2  g116(.a(new_n107_), .b(new_n98_), .O(new_n161_));
  ...
  oai21  g121(.a(new_n164_), .b(new_n160_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n107_), .b(x30), .O(new_n167_));
  nand2  g123(.a(x18), .b(x12), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n113_), .O(new_n169_));
  nand2  g125(.a(x31), .b(new_n98_), .O(new_n170_));
  nand2  g126(.a(new_n114_), .b(new_n147_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n167_), .O(new_n172_));
  nor2   g128(.a(new_n114_), .b(new_n113_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n136_), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  oai21  g131(.a(x19), .b(new_n144_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n174_), .b(new_n116_), .O(new_n177_));
  inv1   g133(.a(new_n173_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n142_), .c(new_n112_), .O(new_n179_));
  nand2  g135(.a(new_n173_), .b(x11), .O(new_n180_));
  ...
  aoi21  g140(.a(new_n166_), .b(new_n157_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n163_), .c(new_n155_), .O(z9));
endmodule
