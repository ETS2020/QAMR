...
module FAU ( 
  ...
  nand3  g061(.a(new_n105_), .b(new_n95_), .c(new_n81_), .O(z7));
  inv1   g062(.a(x26), .O(new_n107_));
  nand3  g063(.a(x32), .b(new_n107_), .c(x00), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z8));
  nand2  g065(.a(new_n107_), .b(x00), .O(new_n110_));
  ...
  nor2   g084(.a(x33), .b(x30), .O(new_n129_));
  and2   g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n113_), .b(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n128_), .d(new_n99_), .O(new_n136_));
  nand2  g092(.a(new_n115_), .b(x14), .O(new_n137_));
  nor2   g093(.a(new_n113_), .b(new_n112_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x16), .c(x15), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n139_), .b(new_n115_), .O(new_n142_));
  nand3  g098(.a(new_n138_), .b(x16), .c(x10), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n111_), .O(new_n144_));
  nand2  g100(.a(new_n138_), .b(x11), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n121_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n144_), .c(new_n142_), .d(new_n141_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n136_), .c(x33), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n131_), .c(new_n110_), .O(z9));
endmodule
