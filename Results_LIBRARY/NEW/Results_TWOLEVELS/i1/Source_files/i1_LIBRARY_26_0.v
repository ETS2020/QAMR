...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n59_, new_n63_, new_n64_, new_n66_, new_n68_, new_n71_, new_n73_,
    new_n74_;
  ...
  nand2  g15(.a(new_n44_), .b(new_n43_), .O(new_n57_));
  nor2   g16(.a(x08), .b(x07), .O(new_n58_));
  nand3  g17(.a(new_n58_), .b(new_n45_), .c(x19), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(z05));
