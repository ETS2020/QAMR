// Benchmark "FAU" written by ABC on Fri Jun 26 04:02:36 2020
...
module FAU ( 
  ...
  wire new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    ...
    new_n854_, new_n855_, new_n856_, new_n857_, new_n858_, new_n861_,
  ...
  nor3   g091(.a(new_n167_), .b(new_n165_), .c(x34), .O(new_n168_));
  ...
  aoi21  g653(.a(new_n722_), .b(new_n617_), .c(x32), .O(new_n730_));
  nand3  g654(.a(new_n717_), .b(new_n111_), .c(x32), .O(new_n731_));
  oai21  g655(.a(new_n730_), .b(new_n401_), .c(new_n731_), .O(new_n732_));
  oai21  g656(.a(new_n732_), .b(new_n729_), .c(new_n202_), .O(new_n733_));
  nand2  g657(.a(new_n733_), .b(x33), .O(z21));
  nor2   g658(.a(x32), .b(new_n366_), .O(new_n735_));
  nand2  g659(.a(new_n735_), .b(new_n210_), .O(new_n736_));
  nand2  g660(.a(new_n736_), .b(new_n671_), .O(new_n737_));
  nand2  g661(.a(new_n735_), .b(x38), .O(new_n738_));
  nor2   g662(.a(new_n738_), .b(new_n689_), .O(new_n739_));
  aoi21  g663(.a(new_n737_), .b(new_n77_), .c(new_n739_), .O(new_n740_));
  nor2   g664(.a(new_n78_), .b(x32), .O(new_n741_));
  nand4  g665(.a(new_n741_), .b(new_n702_), .c(new_n581_), .d(x38), .O(new_n742_));
  oai21  g666(.a(new_n740_), .b(x36), .c(new_n742_), .O(new_n743_));
  nand2  g667(.a(new_n743_), .b(new_n111_), .O(new_n744_));
  inv1   g668(.a(new_n714_), .O(new_n745_));
  nand3  g669(.a(new_n735_), .b(new_n718_), .c(new_n745_), .O(new_n746_));
  aoi21  g670(.a(new_n746_), .b(new_n744_), .c(new_n674_), .O(z22));
  aoi21  g671(.a(new_n300_), .b(new_n299_), .c(x36), .O(new_n748_));
  oai21  g672(.a(new_n748_), .b(new_n358_), .c(new_n111_), .O(new_n749_));
  nand2  g673(.a(new_n726_), .b(new_n332_), .O(new_n750_));
  nor4   g674(.a(new_n750_), .b(new_n123_), .c(x31), .d(x14), .O(new_n751_));
  nor2   g675(.a(new_n751_), .b(new_n115_), .O(new_n752_));
  aoi21  g676(.a(new_n752_), .b(new_n749_), .c(new_n161_), .O(new_n753_));
  aoi22  g677(.a(new_n93_), .b(new_n366_), .c(new_n87_), .d(x34), .O(new_n754_));
  nor2   g678(.a(new_n754_), .b(x38), .O(new_n755_));
  nand3  g679(.a(new_n88_), .b(x13), .c(x09), .O(new_n756_));
  nand3  g680(.a(new_n756_), .b(new_n414_), .c(new_n101_), .O(new_n757_));
  aoi21  g681(.a(new_n757_), .b(new_n107_), .c(new_n755_), .O(new_n758_));
  inv1   g682(.a(new_n138_), .O(new_n759_));
  nand2  g683(.a(new_n204_), .b(new_n171_), .O(new_n760_));
  oai21  g684(.a(new_n445_), .b(x36), .c(new_n760_), .O(new_n761_));
  aoi22  g685(.a(new_n761_), .b(new_n581_), .c(new_n759_), .d(new_n111_), .O(new_n762_));
  oai21  g686(.a(new_n758_), .b(x36), .c(new_n762_), .O(new_n763_));
  oai21  g687(.a(new_n763_), .b(new_n753_), .c(new_n142_), .O(new_n764_));
  nand3  g688(.a(new_n322_), .b(new_n79_), .c(x37), .O(new_n765_));
  aoi21  g689(.a(new_n765_), .b(new_n414_), .c(x38), .O(new_n766_));
  oai21  g690(.a(new_n766_), .b(new_n437_), .c(new_n212_), .O(new_n767_));
  aoi21  g691(.a(new_n767_), .b(new_n211_), .c(x05), .O(new_n768_));
  nor2   g692(.a(new_n209_), .b(new_n366_), .O(new_n769_));
  oai21  g693(.a(new_n769_), .b(new_n768_), .c(new_n111_), .O(new_n770_));
  aoi21  g694(.a(new_n161_), .b(new_n366_), .c(new_n79_), .O(new_n771_));
  oai22  g695(.a(new_n771_), .b(new_n111_), .c(new_n567_), .d(new_n366_), .O(new_n772_));
  nand2  g696(.a(new_n772_), .b(x37), .O(new_n773_));
  nand2  g697(.a(new_n773_), .b(new_n770_), .O(new_n774_));
  aoi22  g698(.a(new_n774_), .b(new_n78_), .c(new_n193_), .d(new_n111_), .O(new_n775_));
  aoi21  g699(.a(new_n775_), .b(new_n764_), .c(x35), .O(new_n776_));
  nand2  g700(.a(new_n193_), .b(x35), .O(new_n777_));
  aoi21  g701(.a(new_n777_), .b(new_n343_), .c(x00), .O(new_n778_));
  aoi21  g702(.a(new_n493_), .b(x35), .c(new_n778_), .O(new_n779_));
  nor2   g703(.a(new_n779_), .b(new_n366_), .O(new_n780_));
  oai21  g704(.a(new_n179_), .b(new_n84_), .c(new_n727_), .O(new_n781_));
  nand2  g705(.a(new_n781_), .b(x37), .O(new_n782_));
  nand2  g706(.a(new_n460_), .b(x24), .O(new_n783_));
  aoi21  g707(.a(x23), .b(x21), .c(x40), .O(new_n784_));
  inv1   g708(.a(new_n784_), .O(new_n785_));
  nand3  g709(.a(new_n785_), .b(new_n506_), .c(x22), .O(new_n786_));
  aoi21  g710(.a(new_n786_), .b(x24), .c(new_n783_), .O(new_n787_));
  aoi21  g711(.a(new_n787_), .b(new_n90_), .c(new_n388_), .O(new_n788_));
  oai21  g712(.a(new_n788_), .b(new_n358_), .c(new_n142_), .O(new_n789_));
  aoi21  g713(.a(new_n789_), .b(new_n782_), .c(new_n77_), .O(new_n790_));
  oai21  g714(.a(new_n790_), .b(new_n780_), .c(x38), .O(new_n791_));
  nand2  g715(.a(new_n466_), .b(new_n526_), .O(new_n792_));
  nand3  g716(.a(new_n792_), .b(new_n161_), .c(x35), .O(new_n793_));
  aoi21  g717(.a(new_n793_), .b(new_n791_), .c(x34), .O(new_n794_));
  oai21  g718(.a(new_n794_), .b(new_n776_), .c(new_n199_), .O(new_n795_));
  aoi21  g719(.a(new_n795_), .b(new_n202_), .c(new_n203_), .O(z23));
  nand2  g720(.a(new_n595_), .b(new_n142_), .O(new_n797_));
  nand4  g721(.a(new_n309_), .b(new_n105_), .c(new_n111_), .d(new_n97_), .O(new_n798_));
  aoi21  g722(.a(new_n798_), .b(new_n797_), .c(new_n161_), .O(new_n799_));
  oai21  g723(.a(new_n799_), .b(new_n619_), .c(new_n77_), .O(new_n800_));
  inv1   g724(.a(new_n195_), .O(new_n801_));
  nand3  g725(.a(new_n493_), .b(new_n354_), .c(new_n332_), .O(new_n802_));
  nand3  g726(.a(new_n335_), .b(new_n193_), .c(new_n81_), .O(new_n803_));
  aoi21  g727(.a(new_n803_), .b(new_n802_), .c(new_n161_), .O(new_n804_));
  oai21  g728(.a(new_n804_), .b(new_n801_), .c(new_n197_), .O(new_n805_));
  aoi21  g729(.a(new_n805_), .b(new_n800_), .c(new_n200_), .O(z24));
  nand3  g730(.a(new_n77_), .b(new_n212_), .c(new_n307_), .O(new_n807_));
  nand3  g731(.a(new_n284_), .b(new_n187_), .c(new_n459_), .O(new_n808_));
  nand2  g732(.a(new_n808_), .b(new_n807_), .O(new_n809_));
  nand2  g733(.a(new_n809_), .b(new_n97_), .O(new_n810_));
  nor2   g734(.a(new_n784_), .b(new_n348_), .O(new_n811_));
  aoi21  g735(.a(new_n811_), .b(x24), .c(new_n77_), .O(new_n812_));
  inv1   g736(.a(new_n268_), .O(new_n813_));
  nor3   g737(.a(new_n813_), .b(new_n128_), .c(new_n79_), .O(new_n814_));
  oai21  g738(.a(new_n814_), .b(new_n812_), .c(new_n142_), .O(new_n815_));
  aoi21  g739(.a(new_n815_), .b(new_n810_), .c(new_n161_), .O(new_n816_));
  nor3   g740(.a(new_n665_), .b(new_n315_), .c(new_n813_), .O(new_n817_));
  oai21  g741(.a(new_n817_), .b(new_n816_), .c(new_n111_), .O(new_n818_));
  nand2  g742(.a(new_n608_), .b(new_n400_), .O(new_n819_));
  aoi21  g743(.a(new_n819_), .b(new_n818_), .c(new_n145_), .O(new_n820_));
  inv1   g744(.a(new_n540_), .O(new_n821_));
  nand2  g745(.a(new_n164_), .b(new_n97_), .O(new_n822_));
  aoi21  g746(.a(new_n822_), .b(new_n611_), .c(new_n821_), .O(new_n823_));
  oai21  g747(.a(new_n823_), .b(new_n820_), .c(new_n169_), .O(new_n824_));
  nand2  g748(.a(new_n680_), .b(new_n335_), .O(new_n825_));
  and2   g749(.a(new_n825_), .b(new_n621_), .O(new_n826_));
  aoi21  g750(.a(new_n826_), .b(new_n824_), .c(new_n200_), .O(z25));
  inv1   g751(.a(new_n119_), .O(new_n828_));
  nand4  g752(.a(new_n591_), .b(new_n256_), .c(new_n199_), .d(new_n828_), .O(new_n829_));
  inv1   g753(.a(new_n829_), .O(z26));
  nand2  g754(.a(new_n543_), .b(new_n166_), .O(new_n831_));
  nor3   g755(.a(new_n831_), .b(new_n163_), .c(new_n161_), .O(new_n832_));
  oai21  g756(.a(new_n832_), .b(new_n820_), .c(new_n169_), .O(new_n833_));
  aoi21  g757(.a(new_n833_), .b(new_n621_), .c(new_n200_), .O(z27));
  inv1   g758(.a(new_n678_), .O(new_n835_));
  nand4  g759(.a(x33), .b(new_n625_), .c(new_n202_), .d(x04), .O(new_n836_));
  nor3   g760(.a(new_n836_), .b(new_n835_), .c(new_n601_), .O(z28));
  nor2   g761(.a(new_n534_), .b(new_n409_), .O(new_n838_));
  nor4   g762(.a(new_n342_), .b(new_n172_), .c(x37), .d(new_n263_), .O(new_n839_));
  nor2   g763(.a(new_n839_), .b(new_n838_), .O(new_n840_));
  nand2  g764(.a(new_n536_), .b(new_n375_), .O(new_n841_));
  oai22  g765(.a(new_n841_), .b(new_n840_), .c(new_n611_), .d(new_n821_), .O(new_n842_));
  nand2  g766(.a(new_n842_), .b(new_n169_), .O(new_n843_));
  aoi21  g767(.a(new_n843_), .b(new_n621_), .c(new_n200_), .O(z29));
  nor2   g768(.a(new_n840_), .b(x21), .O(new_n845_));
  nand4  g769(.a(new_n111_), .b(x24), .c(new_n349_), .d(x21), .O(new_n846_));
  nor2   g770(.a(new_n846_), .b(new_n285_), .O(new_n847_));
  oai21  g771(.a(new_n847_), .b(new_n845_), .c(x22), .O(new_n848_));
  nor4   g772(.a(new_n367_), .b(new_n77_), .c(x34), .d(new_n263_), .O(new_n849_));
  oai21  g773(.a(new_n849_), .b(new_n838_), .c(new_n348_), .O(new_n850_));
  inv1   g774(.a(new_n574_), .O(new_n851_));
  nand2  g775(.a(new_n659_), .b(new_n851_), .O(new_n852_));
  aoi21  g776(.a(new_n850_), .b(new_n848_), .c(new_n852_), .O(z30));
  inv1   g777(.a(new_n566_), .O(new_n854_));
  nand3  g778(.a(new_n79_), .b(x24), .c(new_n349_), .O(new_n855_));
  oai21  g779(.a(new_n855_), .b(new_n854_), .c(x24), .O(new_n856_));
  nor2   g780(.a(new_n597_), .b(new_n89_), .O(new_n857_));
  nand4  g781(.a(new_n857_), .b(new_n856_), .c(new_n493_), .d(x38), .O(new_n858_));
  aoi21  g782(.a(new_n858_), .b(new_n825_), .c(new_n200_), .O(z31));
  nand4  g783(.a(new_n472_), .b(new_n377_), .c(new_n125_), .d(x23), .O(new_n861_));
  nand2  g784(.a(new_n861_), .b(new_n518_), .O(new_n862_));
  nand2  g785(.a(new_n862_), .b(x35), .O(new_n863_));
  nand2  g786(.a(x15), .b(new_n121_), .O(new_n864_));
  aoi21  g787(.a(new_n864_), .b(new_n518_), .c(new_n516_), .O(new_n865_));
  nor2   g788(.a(new_n865_), .b(new_n515_), .O(new_n866_));
  aoi21  g789(.a(new_n866_), .b(new_n863_), .c(new_n161_), .O(new_n867_));
  inv1   g790(.a(new_n253_), .O(new_n868_));
  aoi21  g791(.a(new_n756_), .b(new_n868_), .c(new_n813_), .O(new_n869_));
  oai21  g792(.a(new_n869_), .b(new_n867_), .c(new_n142_), .O(new_n870_));
  nand3  g793(.a(new_n544_), .b(new_n194_), .c(new_n154_), .O(new_n871_));
  oai21  g794(.a(new_n161_), .b(new_n97_), .c(new_n871_), .O(new_n872_));
  nand3  g795(.a(new_n872_), .b(new_n268_), .c(x37), .O(new_n873_));
  aoi21  g796(.a(new_n873_), .b(new_n870_), .c(new_n388_), .O(new_n874_));
  nand3  g797(.a(new_n173_), .b(new_n142_), .c(x36), .O(new_n875_));
  inv1   g798(.a(new_n875_), .O(new_n876_));
  oai21  g799(.a(new_n876_), .b(new_n874_), .c(new_n111_), .O(new_n877_));
  aoi21  g800(.a(new_n143_), .b(new_n94_), .c(new_n91_), .O(new_n878_));
  nand2  g801(.a(new_n145_), .b(new_n366_), .O(new_n879_));
  oai22  g802(.a(new_n879_), .b(new_n878_), .c(x37), .d(new_n111_), .O(new_n880_));
  nand2  g803(.a(new_n880_), .b(new_n78_), .O(new_n881_));
  nand3  g804(.a(new_n474_), .b(new_n111_), .c(new_n120_), .O(new_n882_));
  aoi21  g805(.a(new_n882_), .b(new_n473_), .c(new_n121_), .O(new_n883_));
  nor2   g806(.a(new_n883_), .b(new_n476_), .O(new_n884_));
  aoi21  g807(.a(new_n884_), .b(new_n881_), .c(x38), .O(new_n885_));
  inv1   g808(.a(new_n135_), .O(new_n886_));
  nand2  g809(.a(new_n235_), .b(new_n886_), .O(new_n887_));
  inv1   g810(.a(new_n887_), .O(new_n888_));
  oai21  g811(.a(new_n888_), .b(new_n885_), .c(new_n77_), .O(new_n889_));
  oai21  g812(.a(new_n184_), .b(x21), .c(new_n508_), .O(new_n890_));
  nand2  g813(.a(new_n268_), .b(new_n222_), .O(new_n891_));
  nand2  g814(.a(new_n891_), .b(new_n890_), .O(new_n892_));
  nand4  g815(.a(new_n892_), .b(new_n332_), .c(new_n134_), .d(new_n142_), .O(new_n893_));
  oai21  g816(.a(new_n683_), .b(new_n682_), .c(new_n893_), .O(new_n894_));
  aoi21  g817(.a(new_n894_), .b(x38), .c(new_n686_), .O(new_n895_));
  nand2  g818(.a(new_n895_), .b(new_n889_), .O(new_n896_));
  nand2  g819(.a(new_n896_), .b(x40), .O(new_n897_));
  nand3  g820(.a(new_n897_), .b(new_n877_), .c(new_n681_), .O(new_n898_));
  aoi21  g821(.a(new_n898_), .b(new_n625_), .c(x07), .O(new_n899_));
  nand2  g822(.a(new_n203_), .b(x32), .O(new_n900_));
  oai21  g823(.a(new_n899_), .b(new_n203_), .c(new_n900_), .O(z33));
  aoi21  g824(.a(new_n371_), .b(new_n90_), .c(new_n106_), .O(new_n902_));
  inv1   g825(.a(new_n232_), .O(new_n903_));
  nand3  g826(.a(new_n903_), .b(new_n215_), .c(x38), .O(new_n904_));
  inv1   g827(.a(new_n904_), .O(new_n905_));
  oai21  g828(.a(new_n905_), .b(new_n902_), .c(new_n142_), .O(new_n906_));
  nand2  g829(.a(new_n253_), .b(new_n105_), .O(new_n907_));
  aoi21  g830(.a(new_n907_), .b(new_n906_), .c(x36), .O(new_n908_));
  nand3  g831(.a(new_n399_), .b(x36), .c(x11), .O(new_n909_));
  inv1   g832(.a(new_n909_), .O(new_n910_));
  oai21  g833(.a(new_n910_), .b(new_n908_), .c(new_n111_), .O(new_n911_));
  nand3  g834(.a(x36), .b(new_n111_), .c(new_n84_), .O(new_n912_));
  oai21  g835(.a(new_n912_), .b(new_n367_), .c(new_n410_), .O(new_n913_));
  nor3   g836(.a(new_n407_), .b(new_n111_), .c(new_n682_), .O(new_n914_));
  aoi21  g837(.a(new_n913_), .b(x05), .c(new_n914_), .O(new_n915_));
  nand2  g838(.a(new_n915_), .b(new_n911_), .O(new_n916_));
  nand2  g839(.a(new_n916_), .b(new_n77_), .O(new_n917_));
  oai21  g840(.a(new_n653_), .b(new_n682_), .c(new_n655_), .O(new_n918_));
  nand3  g841(.a(new_n918_), .b(new_n197_), .c(new_n142_), .O(new_n919_));
  aoi21  g842(.a(new_n919_), .b(new_n917_), .c(new_n79_), .O(new_n920_));
  oai22  g843(.a(new_n779_), .b(new_n161_), .c(new_n717_), .d(new_n209_), .O(new_n921_));
  aoi21  g844(.a(new_n123_), .b(x15), .c(new_n517_), .O(new_n922_));
  oai22  g845(.a(new_n922_), .b(new_n172_), .c(x15), .d(new_n94_), .O(new_n923_));
  aoi21  g846(.a(new_n923_), .b(x09), .c(new_n253_), .O(new_n924_));
  oai21  g847(.a(new_n924_), .b(new_n489_), .c(new_n630_), .O(new_n925_));
  nor2   g848(.a(x37), .b(x35), .O(new_n926_));
  aoi22  g849(.a(new_n926_), .b(new_n925_), .c(new_n921_), .d(x05), .O(new_n927_));
  nand4  g850(.a(new_n543_), .b(new_n474_), .c(new_n204_), .d(new_n80_), .O(new_n928_));
  oai21  g851(.a(new_n835_), .b(new_n80_), .c(new_n928_), .O(new_n929_));
  nand2  g852(.a(new_n497_), .b(new_n85_), .O(new_n930_));
  inv1   g853(.a(new_n930_), .O(new_n931_));
  nand2  g854(.a(new_n581_), .b(new_n77_), .O(new_n932_));
  nor3   g855(.a(new_n932_), .b(new_n685_), .c(new_n445_), .O(new_n933_));
  aoi21  g856(.a(new_n931_), .b(new_n929_), .c(new_n933_), .O(new_n934_));
  oai21  g857(.a(new_n927_), .b(x34), .c(new_n934_), .O(new_n935_));
  oai21  g858(.a(new_n935_), .b(new_n920_), .c(new_n199_), .O(new_n936_));
  aoi21  g859(.a(new_n936_), .b(new_n202_), .c(new_n203_), .O(z34));
  zero   g860(.O(z32));
  aoi21  g861(.a(new_n584_), .b(new_n202_), .c(new_n203_), .O(z14));
endmodule
