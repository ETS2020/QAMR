// Benchmark "FAU" written by ABC on Fri Jun 26 04:04:16 2020
...
module FAU ( 
  ...
  oai21  g0374(.a(x40), .b(new_n299_), .c(new_n302_), .O(new_n451_));
  aoi21  g0375(.a(new_n451_), .b(new_n450_), .c(x39), .O(new_n452_));
  nor2   g0376(.a(new_n112_), .b(new_n83_), .O(new_n453_));
  aoi21  g0377(.a(new_n83_), .b(new_n298_), .c(new_n453_), .O(new_n454_));
  ...
  oai21  g0555(.a(x40), .b(new_n299_), .c(new_n112_), .O(new_n632_));
  nand2  g0556(.a(new_n100_), .b(new_n298_), .O(new_n633_));
  ...
  oai21  g0707(.a(x39), .b(x27), .c(x10), .O(new_n784_));
  ...
  nand3  g1146(.a(new_n100_), .b(x27), .c(new_n298_), .O(new_n1223_));
