// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:05 2020
...
module FAU ( 
  ...
  inv1   g075(.a(x10), .O(new_n159_));
  nand3  g076(.a(x35), .b(new_n159_), .c(new_n146_), .O(new_n160_));
  inv1   g077(.a(new_n160_), .O(z24));
  nand3  g078(.a(x37), .b(new_n159_), .c(x09), .O(new_n162_));
