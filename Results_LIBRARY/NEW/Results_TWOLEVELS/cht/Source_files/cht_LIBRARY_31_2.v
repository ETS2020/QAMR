...
module FAU ( 
  ...
  nand2  g084(.a(x09), .b(x00), .O(new_n168_));
  nand2  g085(.a(x38), .b(new_n146_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z27));
  inv1   g087(.a(x39), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(x10), .O(z28));
  inv1   g089(.a(x40), .O(new_n173_));
  nor2   g090(.a(new_n173_), .b(x10), .O(z29));
  inv1   g091(.a(x41), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(x10), .O(z30));
  inv1   g093(.a(x42), .O(new_n177_));
  nor2   g094(.a(new_n177_), .b(x10), .O(z31));
  inv1   g095(.a(x43), .O(new_n179_));
  nor2   g096(.a(new_n179_), .b(x10), .O(z32));
  inv1   g097(.a(x44), .O(new_n181_));
  nor2   g098(.a(new_n181_), .b(x10), .O(z33));
  inv1   g099(.a(x45), .O(new_n183_));
  nor2   g100(.a(new_n183_), .b(x10), .O(z34));
  inv1   g101(.a(x46), .O(new_n185_));
  nor2   g102(.a(new_n185_), .b(x10), .O(z35));
endmodule
