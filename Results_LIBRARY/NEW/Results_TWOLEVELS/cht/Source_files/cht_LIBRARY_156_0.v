// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:08 2020
...
module FAU ( 
  ...
  aoi21  g092(.a(new_n175_), .b(new_n168_), .c(x10), .O(z28));
  inv1   g093(.a(x41), .O(new_n177_));
  nor2   g094(.a(x14), .b(new_n146_), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z29));
  nand2  g096(.a(new_n175_), .b(x41), .O(new_n180_));
  nand2  g097(.a(new_n178_), .b(x42), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z30));
  nand2  g099(.a(new_n175_), .b(x42), .O(new_n183_));
  nand2  g100(.a(new_n178_), .b(x43), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z31));
  nand2  g102(.a(new_n175_), .b(x43), .O(new_n186_));
  nand2  g103(.a(new_n178_), .b(x44), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z32));
  nand2  g105(.a(new_n175_), .b(x44), .O(new_n189_));
  nand2  g106(.a(new_n178_), .b(x45), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z33));
  nand2  g108(.a(new_n175_), .b(x45), .O(new_n192_));
  nand2  g109(.a(new_n178_), .b(x46), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n192_), .c(x10), .O(z34));
  nand2  g111(.a(new_n175_), .b(x46), .O(new_n195_));
  nand2  g112(.a(new_n178_), .b(x00), .O(new_n196_));
