// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:31 2020
...
module FAU ( 
  ...
  inv1   g106(.a(x10), .O(new_n190_));
  nand3  g107(.a(new_n175_), .b(x43), .c(new_n190_), .O(new_n191_));
  oai21  g108(.a(new_n175_), .b(new_n189_), .c(new_n191_), .O(z32));
  nand3  g109(.a(new_n177_), .b(x45), .c(new_n190_), .O(new_n193_));
  oai21  g110(.a(new_n177_), .b(new_n189_), .c(new_n193_), .O(z33));
