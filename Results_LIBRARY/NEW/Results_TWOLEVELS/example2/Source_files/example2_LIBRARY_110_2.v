// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:14 2020
...
module FAU ( 
  ...
  nand3  g148(.a(new_n246_), .b(x77), .c(x56), .O(new_n300_));
  nor2   g149(.a(new_n300_), .b(new_n290_), .O(z38));
  nand3  g150(.a(new_n291_), .b(new_n246_), .c(x57), .O(new_n302_));
  inv1   g151(.a(new_n302_), .O(z39));
  nand3  g152(.a(new_n291_), .b(new_n246_), .c(x58), .O(new_n304_));
