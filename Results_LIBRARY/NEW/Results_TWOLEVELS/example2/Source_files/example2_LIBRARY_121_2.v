...
module FAU ( 
  ...
  inv1   g209(.a(new_n167_), .O(new_n361_));
  nand4  g210(.a(new_n361_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n362_));
  aoi21  g211(.a(new_n360_), .b(new_n359_), .c(new_n362_), .O(z53));
  nand2  g212(.a(x52), .b(x22), .O(new_n364_));
  nand2  g213(.a(new_n286_), .b(x14), .O(new_n365_));
  aoi21  g214(.a(new_n365_), .b(new_n364_), .c(new_n362_), .O(z54));
  ...
  oai21  g238(.a(new_n361_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g273(.a(new_n361_), .b(x81), .O(new_n425_));
