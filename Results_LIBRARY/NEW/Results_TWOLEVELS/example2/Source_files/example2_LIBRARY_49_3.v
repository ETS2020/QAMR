// Benchmark "FAU" written by ABC on Thu Jun 25 19:52:49 2020
...
module FAU ( 
  ...
  nand2  g201(.a(new_n332_), .b(x72), .O(new_n353_));
  nor2   g202(.a(x77), .b(x52), .O(new_n354_));
  nand4  g203(.a(new_n354_), .b(new_n172_), .c(x12), .d(x04), .O(new_n355_));
  aoi21  g204(.a(new_n355_), .b(new_n353_), .c(x01), .O(z52));
