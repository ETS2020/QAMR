// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:52 2020
...
module FAU ( 
  ...
  nor3   g161(.a(new_n302_), .b(new_n293_), .c(new_n200_), .O(z41));
  nor3   g162(.a(new_n302_), .b(new_n293_), .c(new_n197_), .O(z42));
  nor3   g163(.a(new_n302_), .b(new_n293_), .c(new_n194_), .O(z43));
  nor3   g164(.a(new_n302_), .b(new_n293_), .c(new_n191_), .O(z44));
  nor3   g165(.a(new_n302_), .b(new_n293_), .c(new_n188_), .O(z45));
  nor3   g166(.a(new_n302_), .b(new_n293_), .c(new_n185_), .O(z46));
  inv1   g167(.a(x07), .O(new_n320_));
  nand2  g168(.a(x52), .b(x15), .O(new_n321_));
  oai21  g169(.a(x52), .b(new_n320_), .c(new_n321_), .O(new_n322_));
  nand3  g170(.a(new_n236_), .b(new_n154_), .c(new_n159_), .O(new_n323_));
  inv1   g171(.a(new_n323_), .O(new_n324_));
  nand2  g172(.a(new_n324_), .b(new_n322_), .O(new_n325_));
  nor2   g173(.a(x75), .b(x67), .O(new_n326_));
  inv1   g174(.a(new_n171_), .O(new_n327_));
  nand2  g175(.a(new_n327_), .b(x79), .O(new_n328_));
  nor2   g176(.a(new_n328_), .b(new_n326_), .O(new_n329_));
  nand2  g177(.a(new_n329_), .b(new_n233_), .O(new_n330_));
  aoi21  g178(.a(new_n330_), .b(new_n325_), .c(x01), .O(z47));
  inv1   g179(.a(x08), .O(new_n332_));
  nand2  g180(.a(x52), .b(x16), .O(new_n333_));
  oai21  g181(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g182(.a(new_n334_), .b(new_n324_), .O(new_n335_));
  inv1   g183(.a(new_n233_), .O(new_n336_));
  nor2   g184(.a(new_n328_), .b(new_n336_), .O(new_n337_));
  nand2  g185(.a(new_n337_), .b(x68), .O(new_n338_));
  aoi21  g186(.a(new_n338_), .b(new_n335_), .c(x01), .O(z48));
  inv1   g187(.a(x09), .O(new_n340_));
  nand2  g188(.a(x52), .b(x17), .O(new_n341_));
  oai21  g189(.a(x52), .b(new_n340_), .c(new_n341_), .O(new_n342_));
  nand2  g190(.a(new_n342_), .b(new_n324_), .O(new_n343_));
  nand2  g191(.a(new_n337_), .b(x69), .O(new_n344_));
  aoi21  g192(.a(new_n344_), .b(new_n343_), .c(x01), .O(z49));
  inv1   g193(.a(x10), .O(new_n346_));
  nand2  g194(.a(x52), .b(x18), .O(new_n347_));
  oai21  g195(.a(x52), .b(new_n346_), .c(new_n347_), .O(new_n348_));
  nand2  g196(.a(new_n348_), .b(new_n324_), .O(new_n349_));
  nand2  g197(.a(new_n337_), .b(x70), .O(new_n350_));
  aoi21  g198(.a(new_n350_), .b(new_n349_), .c(x01), .O(z50));
  inv1   g199(.a(x11), .O(new_n352_));
  nand2  g200(.a(x52), .b(x19), .O(new_n353_));
  oai21  g201(.a(x52), .b(new_n352_), .c(new_n353_), .O(new_n354_));
  nand2  g202(.a(new_n354_), .b(new_n324_), .O(new_n355_));
  nand2  g203(.a(new_n337_), .b(x71), .O(new_n356_));
  aoi21  g204(.a(new_n356_), .b(new_n355_), .c(x01), .O(z51));
  inv1   g205(.a(x12), .O(new_n358_));
  nand2  g206(.a(x52), .b(x20), .O(new_n359_));
  oai21  g207(.a(x52), .b(new_n358_), .c(new_n359_), .O(new_n360_));
  nand2  g208(.a(new_n360_), .b(new_n324_), .O(new_n361_));
  nand2  g209(.a(new_n337_), .b(x72), .O(new_n362_));
  aoi21  g210(.a(new_n362_), .b(new_n361_), .c(x01), .O(z52));
  inv1   g211(.a(x13), .O(new_n364_));
  nand2  g212(.a(x52), .b(x21), .O(new_n365_));
  oai21  g213(.a(x52), .b(new_n364_), .c(new_n365_), .O(new_n366_));
  nand2  g214(.a(new_n366_), .b(new_n324_), .O(new_n367_));
  nand2  g215(.a(new_n337_), .b(x73), .O(new_n368_));
  aoi21  g216(.a(new_n368_), .b(new_n367_), .c(x01), .O(z53));
  nand2  g217(.a(x52), .b(x22), .O(new_n370_));
  nand2  g218(.a(new_n292_), .b(x14), .O(new_n371_));
  inv1   g219(.a(new_n170_), .O(new_n372_));
  nand4  g220(.a(new_n372_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n373_));
  aoi21  g221(.a(new_n371_), .b(new_n370_), .c(new_n373_), .O(z54));
  inv1   g222(.a(x82), .O(new_n375_));
  nand3  g223(.a(new_n279_), .b(x84), .c(new_n375_), .O(new_n376_));
  inv1   g224(.a(x80), .O(new_n377_));
  nand4  g225(.a(new_n251_), .b(new_n165_), .c(new_n377_), .d(x79), .O(new_n378_));
  nor2   g226(.a(new_n378_), .b(new_n376_), .O(z55));
  nand2  g227(.a(new_n249_), .b(x76), .O(new_n380_));
  xnor2a g228(.a(x84), .b(x81), .O(new_n381_));
  aoi21  g229(.a(new_n171_), .b(new_n170_), .c(new_n381_), .O(new_n382_));
  nand2  g230(.a(new_n382_), .b(new_n153_), .O(new_n383_));
  nand2  g231(.a(new_n383_), .b(new_n380_), .O(new_n384_));
  nand2  g232(.a(new_n384_), .b(x79), .O(new_n385_));
  nor2   g233(.a(x77), .b(x01), .O(new_n386_));
  aoi21  g234(.a(new_n386_), .b(new_n164_), .c(new_n246_), .O(new_n387_));
  nand2  g235(.a(new_n387_), .b(new_n385_), .O(z56));
  inv1   g236(.a(x02), .O(new_n389_));
  nand3  g237(.a(new_n247_), .b(x03), .c(new_n389_), .O(new_n390_));
  inv1   g238(.a(new_n390_), .O(z57));
  nand4  g239(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n392_));
  oai22  g240(.a(new_n392_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n393_));
  nand3  g241(.a(new_n393_), .b(new_n236_), .c(x79), .O(new_n394_));
  nand3  g242(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n395_));
  nand2  g243(.a(new_n395_), .b(new_n394_), .O(new_n396_));
  nand2  g244(.a(new_n396_), .b(x77), .O(new_n397_));
  oai21  g245(.a(new_n372_), .b(new_n160_), .c(new_n154_), .O(new_n398_));
  aoi21  g246(.a(new_n398_), .b(new_n397_), .c(x01), .O(z58));
  aoi21  g247(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n400_));
  oai21  g248(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n401_));
  aoi21  g249(.a(new_n401_), .b(x79), .c(new_n163_), .O(new_n402_));
  oai21  g250(.a(new_n402_), .b(new_n400_), .c(x77), .O(new_n403_));
  nor2   g251(.a(x79), .b(x04), .O(new_n404_));
  inv1   g252(.a(new_n404_), .O(new_n405_));
  aoi21  g253(.a(new_n405_), .b(new_n403_), .c(x01), .O(z59));
  aoi21  g254(.a(new_n382_), .b(x79), .c(new_n404_), .O(new_n407_));
  aoi21  g255(.a(new_n407_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g256(.a(new_n173_), .O(new_n409_));
  nand2  g257(.a(new_n171_), .b(new_n170_), .O(new_n410_));
  aoi22  g258(.a(new_n410_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n411_));
  nor3   g259(.a(new_n411_), .b(new_n409_), .c(new_n377_), .O(z61));
  nand3  g260(.a(x84), .b(x81), .c(x79), .O(new_n413_));
  oai21  g261(.a(x79), .b(new_n160_), .c(new_n413_), .O(new_n414_));
  nand2  g262(.a(new_n414_), .b(new_n159_), .O(new_n415_));
  nand2  g263(.a(new_n401_), .b(x79), .O(new_n416_));
  nand3  g264(.a(x81), .b(x79), .c(new_n160_), .O(new_n417_));
  inv1   g265(.a(new_n417_), .O(new_n418_));
  aoi21  g266(.a(new_n416_), .b(x04), .c(new_n418_), .O(new_n419_));
  oai21  g267(.a(new_n419_), .b(new_n159_), .c(new_n415_), .O(new_n420_));
  nand2  g268(.a(new_n420_), .b(x78), .O(new_n421_));
  inv1   g269(.a(new_n413_), .O(new_n422_));
  nand2  g270(.a(new_n422_), .b(new_n327_), .O(new_n423_));
  aoi21  g271(.a(new_n423_), .b(new_n421_), .c(x01), .O(z62));
  nor3   g272(.a(new_n411_), .b(new_n409_), .c(new_n375_), .O(z63));
  nand2  g273(.a(x83), .b(x79), .O(new_n426_));
  or2    g274(.a(new_n426_), .b(new_n411_), .O(new_n427_));
  nand3  g275(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n428_));
  aoi21  g276(.a(new_n428_), .b(new_n427_), .c(x01), .O(z64));
  nor2   g277(.a(new_n164_), .b(x04), .O(new_n430_));
  nor2   g278(.a(new_n258_), .b(x78), .O(new_n431_));
  oai21  g279(.a(new_n431_), .b(new_n430_), .c(x77), .O(new_n432_));
  nand2  g280(.a(new_n372_), .b(x81), .O(new_n433_));
  nand2  g281(.a(new_n173_), .b(x84), .O(new_n434_));
  aoi21  g282(.a(new_n433_), .b(new_n432_), .c(new_n434_), .O(z65));
  zero   g283(.O(z40));
endmodule
