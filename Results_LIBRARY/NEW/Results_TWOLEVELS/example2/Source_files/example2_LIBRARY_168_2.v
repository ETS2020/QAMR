...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n264_, new_n266_, new_n268_, new_n269_, new_n271_, new_n273_,
  ...
  oai21  g061(.a(new_n211_), .b(new_n152_), .c(new_n212_), .O(z17));
  ...
  inv1   g116(.a(new_n248_), .O(new_n268_));
  nor4   g117(.a(new_n268_), .b(new_n235_), .c(new_n160_), .d(new_n211_), .O(new_n269_));
  and2   g118(.a(new_n269_), .b(new_n256_), .O(z30));
  nand4  g119(.a(new_n257_), .b(new_n248_), .c(x49), .d(new_n234_), .O(new_n271_));
  ...
  nor3   g146(.a(new_n297_), .b(new_n268_), .c(new_n288_), .O(z34));
  ...
  nor3   g155(.a(new_n297_), .b(new_n268_), .c(new_n199_), .O(z39));
  nor3   g156(.a(new_n297_), .b(new_n268_), .c(new_n196_), .O(z40));
  nor3   g157(.a(new_n297_), .b(new_n268_), .c(new_n193_), .O(z41));
  nor3   g158(.a(new_n297_), .b(new_n268_), .c(new_n190_), .O(z42));
  nor3   g159(.a(new_n297_), .b(new_n268_), .c(new_n187_), .O(z43));
  nor3   g160(.a(new_n297_), .b(new_n268_), .c(new_n184_), .O(z44));
  nor3   g161(.a(new_n297_), .b(new_n268_), .c(new_n181_), .O(z45));
  nor3   g162(.a(new_n297_), .b(new_n268_), .c(new_n178_), .O(z46));
