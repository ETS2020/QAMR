...
module FAU ( 
  ...
  nand2  g123(.a(x51), .b(new_n249_), .O(new_n275_));
  oai22  g124(.a(new_n275_), .b(new_n253_), .c(new_n274_), .d(new_n273_), .O(new_n276_));
  ...
  nand2  g130(.a(new_n246_), .b(new_n281_), .O(new_n282_));
  aoi21  g131(.a(new_n280_), .b(new_n277_), .c(new_n282_), .O(z33));
  inv1   g132(.a(x52), .O(new_n284_));
  inv1   g133(.a(new_n246_), .O(new_n285_));
  ...
  nand4  g217(.a(new_n246_), .b(new_n161_), .c(new_n253_), .d(x79), .O(new_n369_));
  nor4   g218(.a(new_n369_), .b(new_n368_), .c(new_n229_), .d(x82), .O(z55));
  ...
  nand2  g230(.a(x42), .b(new_n152_), .O(new_n382_));
  inv1   g231(.a(new_n230_), .O(new_n383_));
  inv1   g232(.a(x80), .O(new_n384_));
  nor2   g233(.a(new_n384_), .b(x74), .O(new_n385_));
  nor2   g234(.a(new_n245_), .b(x42), .O(new_n386_));
  nand4  g235(.a(new_n386_), .b(new_n385_), .c(new_n383_), .d(x81), .O(new_n387_));
  nand2  g236(.a(new_n236_), .b(x79), .O(new_n388_));
  aoi21  g237(.a(new_n387_), .b(new_n382_), .c(new_n388_), .O(new_n389_));
  nor2   g238(.a(x79), .b(x78), .O(new_n390_));
  nand3  g239(.a(new_n390_), .b(new_n249_), .c(x40), .O(new_n391_));
  inv1   g240(.a(new_n391_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n389_), .c(x77), .O(new_n393_));
  oai21  g242(.a(new_n365_), .b(new_n239_), .c(new_n154_), .O(new_n394_));
  ...
  aoi21  g252(.a(new_n373_), .b(x79), .c(new_n401_), .O(new_n404_));
  ...
  nand2  g256(.a(new_n170_), .b(x80), .O(new_n408_));
  nor2   g257(.a(new_n408_), .b(new_n407_), .O(z61));
  ...
  nand2  g268(.a(new_n419_), .b(new_n320_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n418_), .c(x01), .O(z62));
  nand2  g270(.a(new_n170_), .b(x82), .O(new_n422_));
  nor2   g271(.a(new_n422_), .b(new_n407_), .O(z63));
  nand2  g272(.a(x83), .b(x79), .O(new_n424_));
  or2    g273(.a(new_n424_), .b(new_n407_), .O(new_n425_));
