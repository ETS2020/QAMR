...
module FAU ( 
  ...
  and2   g172(.a(new_n323_), .b(new_n226_), .O(new_n324_));
  nand2  g173(.a(new_n324_), .b(x75), .O(new_n325_));
  ...
  nand2  g179(.a(new_n324_), .b(x68), .O(new_n331_));
  ...
  nand2  g185(.a(new_n324_), .b(x69), .O(new_n337_));
  ...
  nand2  g197(.a(new_n324_), .b(x71), .O(new_n349_));
  ...
  nand2  g203(.a(new_n324_), .b(x72), .O(new_n355_));
  ...
  nand2  g209(.a(new_n324_), .b(x73), .O(new_n361_));
  aoi21  g210(.a(new_n361_), .b(new_n360_), .c(x01), .O(z53));
  nand2  g211(.a(x52), .b(x22), .O(new_n363_));
  nand2  g212(.a(new_n286_), .b(x14), .O(new_n364_));
  ...
  oai21  g239(.a(new_n365_), .b(new_n239_), .c(new_n154_), .O(new_n391_));
