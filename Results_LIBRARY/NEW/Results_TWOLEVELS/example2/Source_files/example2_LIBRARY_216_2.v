...
module FAU ( 
  ...
  nand3  g077(.a(x82), .b(x81), .c(x80), .O(new_n229_));
  inv1   g078(.a(x74), .O(new_n230_));
  inv1   g079(.a(x83), .O(new_n231_));
  nand4  g080(.a(x84), .b(new_n231_), .c(new_n230_), .d(x43), .O(new_n232_));
  nor2   g081(.a(new_n232_), .b(new_n229_), .O(new_n233_));
  ...
  nand2  g124(.a(x81), .b(x79), .O(new_n276_));
  oai22  g125(.a(new_n276_), .b(new_n275_), .c(new_n274_), .d(new_n273_), .O(new_n277_));
  nand2  g126(.a(new_n277_), .b(new_n251_), .O(new_n278_));
  xor2a  g127(.a(x83), .b(x81), .O(new_n279_));
  nor2   g128(.a(x81), .b(new_n154_), .O(new_n280_));
  inv1   g129(.a(new_n280_), .O(new_n281_));
  oai22  g130(.a(new_n281_), .b(new_n275_), .c(new_n279_), .d(new_n274_), .O(new_n282_));
  nand2  g131(.a(new_n282_), .b(new_n254_), .O(new_n283_));
  nand2  g132(.a(new_n246_), .b(new_n161_), .O(new_n284_));
  aoi21  g133(.a(new_n283_), .b(new_n278_), .c(new_n284_), .O(z33));
  ...
  nand3  g141(.a(new_n288_), .b(x81), .c(x79), .O(new_n293_));
  nand3  g142(.a(x83), .b(new_n253_), .c(x42), .O(new_n294_));
  aoi21  g143(.a(new_n294_), .b(new_n293_), .c(new_n250_), .O(new_n295_));
  oai21  g144(.a(new_n295_), .b(new_n292_), .c(new_n161_), .O(new_n296_));
  ...
  nor4   g221(.a(new_n372_), .b(new_n281_), .c(new_n287_), .d(new_n244_), .O(z55));
  ...
  nand2  g233(.a(x42), .b(new_n152_), .O(new_n385_));
  inv1   g234(.a(new_n229_), .O(new_n386_));
  inv1   g235(.a(x84), .O(new_n387_));
  nor2   g236(.a(new_n387_), .b(x83), .O(new_n388_));
  nor2   g237(.a(new_n245_), .b(x42), .O(new_n389_));
  nor2   g238(.a(new_n154_), .b(x74), .O(new_n390_));
  nand4  g239(.a(new_n390_), .b(new_n389_), .c(new_n388_), .d(new_n386_), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(new_n385_), .c(new_n159_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n317_), .c(new_n236_), .O(new_n393_));
  oai21  g242(.a(new_n168_), .b(new_n152_), .c(x04), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n154_), .O(new_n395_));
  aoi21  g244(.a(new_n395_), .b(new_n393_), .c(x01), .O(z58));
  nand2  g245(.a(new_n154_), .b(new_n160_), .O(new_n397_));
  aoi21  g246(.a(new_n235_), .b(new_n397_), .c(new_n152_), .O(new_n398_));
  oai21  g247(.a(new_n232_), .b(new_n229_), .c(new_n249_), .O(new_n399_));
  ...
  aoi21  g253(.a(new_n376_), .b(x79), .c(new_n402_), .O(new_n405_));
  ...
  nor2   g263(.a(new_n276_), .b(x04), .O(new_n415_));
  ...
  nor3   g270(.a(new_n409_), .b(new_n407_), .c(new_n371_), .O(z63));
