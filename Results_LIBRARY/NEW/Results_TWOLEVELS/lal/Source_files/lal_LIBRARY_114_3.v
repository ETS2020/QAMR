...
module FAU ( 
  ...
  nand2  g43(.a(new_n72_), .b(new_n50_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  nor2   g45(.a(x20), .b(new_n83_), .O(new_n92_));
  inv1   g46(.a(x22), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x21), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n92_), .c(new_n84_), .O(new_n95_));
  nand2  g49(.a(new_n68_), .b(x21), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z14));
  inv1   g51(.a(new_n87_), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n70_), .c(new_n67_), .O(new_n99_));
  nand2  g53(.a(new_n68_), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n99_), .c(new_n91_), .O(z15));
  inv1   g55(.a(x21), .O(new_n102_));
  nand3  g56(.a(new_n93_), .b(new_n102_), .c(new_n67_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n87_), .c(x23), .O(new_n104_));
  nor2   g58(.a(x23), .b(x22), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n98_), .c(new_n102_), .d(new_n67_), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n104_), .c(new_n91_), .O(z16));
  nor2   g61(.a(x24), .b(x23), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n70_), .c(new_n92_), .d(new_n84_), .O(new_n109_));
  nand4  g63(.a(new_n64_), .b(new_n93_), .c(new_n102_), .d(new_n67_), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n87_), .c(x24), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n91_), .c(new_n109_), .O(z17));
  nor3   g66(.a(x25), .b(x24), .c(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n70_), .c(new_n92_), .d(new_n84_), .O(new_n114_));
  nand4  g68(.a(new_n65_), .b(new_n64_), .c(new_n93_), .d(new_n102_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n68_), .c(x25), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n114_), .c(new_n91_), .O(z18));
  buf    g71(.a(x16), .O(z02));
endmodule
