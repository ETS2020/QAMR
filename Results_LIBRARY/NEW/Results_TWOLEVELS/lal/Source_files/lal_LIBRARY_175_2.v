...
module FAU ( 
  ...
  oai21  g22(.a(x12), .b(new_n61_), .c(new_n67_), .O(z04));
  ...
  nand3  g50(.a(new_n93_), .b(new_n56_), .c(new_n80_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  xnor2a g52(.a(x18), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(new_n56_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(new_n98_), .O(z11));
  oai21  g55(.a(new_n82_), .b(new_n80_), .c(x19), .O(new_n101_));
  nor2   g56(.a(new_n82_), .b(new_n80_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n83_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z12));
  nand2  g59(.a(new_n102_), .b(x19), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n93_), .c(new_n74_), .d(new_n56_), .O(z13));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n93_), .b(new_n56_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n115_), .b(new_n75_), .c(new_n73_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z15));
  nand2  g72(.a(new_n75_), .b(new_n73_), .O(new_n118_));
  ...
  inv1   g78(.a(new_n77_), .O(new_n124_));
  oai21  g79(.a(new_n120_), .b(new_n105_), .c(x24), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n113_), .c(new_n124_), .O(z17));
  inv1   g81(.a(new_n74_), .O(new_n127_));
  nand4  g82(.a(new_n89_), .b(new_n75_), .c(new_n127_), .d(new_n48_), .O(new_n128_));
