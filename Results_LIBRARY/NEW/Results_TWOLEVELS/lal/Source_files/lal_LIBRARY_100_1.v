...
module FAU ( 
  ...
  nor2   g04(.a(x18), .b(x17), .O(new_n50_));
  ...
  nand2  g38(.a(new_n77_), .b(new_n54_), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(new_n83_), .O(z11));
  nand3  g40(.a(new_n77_), .b(x18), .c(x17), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n55_), .O(z12));
  nor2   g42(.a(z09), .b(x07), .O(new_n88_));
  nor2   g43(.a(x20), .b(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(z13));
  nor2   g45(.a(x21), .b(x15), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n88_), .O(z14));
  nor2   g47(.a(x22), .b(x15), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n88_), .O(z15));
  inv1   g49(.a(x15), .O(new_n95_));
  nand3  g50(.a(new_n88_), .b(new_n48_), .c(new_n95_), .O(z16));
  nand3  g51(.a(new_n88_), .b(new_n49_), .c(new_n95_), .O(z17));
  nand3  g52(.a(new_n88_), .b(new_n74_), .c(new_n95_), .O(z18));
  buf    g53(.a(x16), .O(z02));
endmodule
