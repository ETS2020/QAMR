...
module FAU ( 
  ...
  oai21  g49(.a(x07), .b(x05), .c(x04), .O(new_n95_));
  nor2   g50(.a(x17), .b(x15), .O(new_n96_));
  and2   g51(.a(new_n96_), .b(new_n95_), .O(z10));
  ...
  nand2  g56(.a(new_n95_), .b(new_n98_), .O(new_n102_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(x19), .O(new_n103_));
  nor2   g58(.a(new_n81_), .b(new_n79_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(z12));
  nand2  g61(.a(new_n104_), .b(x19), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x20), .O(new_n108_));
  nand2  g63(.a(new_n58_), .b(new_n98_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n73_), .O(z13));
  inv1   g66(.a(new_n107_), .O(new_n112_));
  nor2   g67(.a(x21), .b(x20), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g69(.a(new_n73_), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n110_), .O(z14));
  inv1   g71(.a(new_n113_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n107_), .c(x22), .O(new_n118_));
  nand3  g73(.a(new_n112_), .b(new_n74_), .c(new_n72_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n110_), .O(z15));
  nand2  g75(.a(new_n74_), .b(new_n72_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n107_), .c(x23), .O(new_n122_));
  nand3  g77(.a(new_n113_), .b(new_n48_), .c(new_n52_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n110_), .O(z16));
  inv1   g81(.a(new_n76_), .O(new_n127_));
  oai21  g82(.a(new_n123_), .b(new_n107_), .c(x24), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n92_), .c(new_n127_), .d(new_n56_), .O(z17));
