// Benchmark "FAU" written by ABC on Thu Jun 25 18:08:17 2020
...
module FAU ( 
  ...
  nand4  g56(.a(new_n82_), .b(x18), .c(x17), .d(new_n101_), .O(new_n102_));
  oai21  g57(.a(new_n100_), .b(new_n82_), .c(new_n102_), .O(new_n103_));
  and2   g58(.a(new_n103_), .b(new_n58_), .O(z12));
  nand2  g59(.a(new_n100_), .b(x19), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n92_), .c(new_n73_), .d(new_n56_), .O(z13));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n92_), .b(new_n56_), .O(new_n110_));
  aoi21  g65(.a(new_n73_), .b(x21), .c(new_n110_), .O(new_n111_));
  oai21  g66(.a(new_n109_), .b(new_n105_), .c(new_n111_), .O(z14));
  inv1   g67(.a(new_n110_), .O(new_n113_));
  oai21  g68(.a(new_n109_), .b(new_n105_), .c(x22), .O(new_n114_));
  inv1   g69(.a(new_n105_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n74_), .c(new_n72_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(z15));
  nand2  g72(.a(new_n74_), .b(new_n72_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n105_), .c(x23), .O(new_n119_));
  nand3  g74(.a(new_n108_), .b(new_n48_), .c(new_n52_), .O(new_n120_));
  ...
  inv1   g78(.a(new_n76_), .O(new_n124_));
  oai21  g79(.a(new_n120_), .b(new_n105_), .c(x24), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n113_), .c(new_n124_), .O(z17));
  inv1   g81(.a(new_n73_), .O(new_n127_));
  nand4  g82(.a(new_n88_), .b(new_n74_), .c(new_n127_), .d(new_n48_), .O(new_n128_));
  nand2  g83(.a(new_n124_), .b(x25), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n128_), .c(new_n113_), .O(z18));
  buf    g85(.a(x16), .O(z02));
endmodule
