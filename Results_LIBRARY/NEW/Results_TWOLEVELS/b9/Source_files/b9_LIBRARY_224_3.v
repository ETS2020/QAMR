...
module FAU ( 
  ...
  aoi21  g057(.a(x35), .b(x27), .c(x08), .O(new_n120_));
  oai21  g058(.a(new_n72_), .b(new_n64_), .c(new_n74_), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(x35), .c(new_n120_), .O(new_n122_));
  ...
  nand3  g089(.a(new_n88_), .b(new_n117_), .c(x28), .O(new_n152_));
  ...
  oai21  g101(.a(new_n75_), .b(x27), .c(new_n118_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  inv1   g103(.a(new_n75_), .O(new_n166_));
  nor2   g104(.a(new_n72_), .b(x04), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n166_), .c(new_n125_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n165_), .O(z18));
  nor2   g107(.a(new_n86_), .b(x27), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(new_n120_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n119_), .c(new_n125_), .O(z20));
