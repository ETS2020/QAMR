// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:17 2020
...
module FAU ( 
  ...
  nand2  g01(.a(x39), .b(new_n63_), .O(new_n64_));
  ...
  nand2  g46(.a(x39), .b(x05), .O(new_n109_));
  oai21  g47(.a(x39), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  ...
  nand2  g52(.a(x39), .b(x29), .O(new_n115_));
  ...
  nand3  g75(.a(x39), .b(new_n128_), .c(new_n63_), .O(new_n138_));
