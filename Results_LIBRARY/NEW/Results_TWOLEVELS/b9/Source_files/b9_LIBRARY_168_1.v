...
module FAU ( 
  ...
  aoi21  g19(.a(x28), .b(x04), .c(new_n81_), .O(new_n82_));
  oai21  g20(.a(x27), .b(x08), .c(x35), .O(new_n83_));
  nand2  g21(.a(new_n83_), .b(x04), .O(new_n84_));
  ...
  inv1   g27(.a(z06), .O(new_n90_));
  nand3  g28(.a(new_n90_), .b(new_n88_), .c(x21), .O(z03));
  nor2   g29(.a(z06), .b(x21), .O(new_n92_));
  nand2  g30(.a(new_n92_), .b(new_n88_), .O(z04));
  oai21  g31(.a(new_n74_), .b(new_n72_), .c(new_n86_), .O(z05));
  ...
  nand2  g44(.a(x40), .b(x39), .O(new_n107_));
  inv1   g45(.a(new_n107_), .O(z08));
  nand4  g46(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n109_));
  inv1   g47(.a(new_n109_), .O(z09));
  inv1   g48(.a(x05), .O(new_n111_));
  nand2  g49(.a(new_n107_), .b(x07), .O(new_n112_));
  oai21  g50(.a(new_n107_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand3  g51(.a(x40), .b(x39), .c(x05), .O(new_n114_));
  aoi21  g52(.a(new_n78_), .b(new_n77_), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g65(.a(new_n77_), .b(new_n127_), .O(new_n128_));
  aoi21  g66(.a(new_n126_), .b(new_n121_), .c(new_n128_), .O(z11));
  aoi21  g67(.a(new_n63_), .b(new_n86_), .c(new_n72_), .O(new_n130_));
  nor2   g68(.a(new_n66_), .b(new_n72_), .O(new_n131_));
  nor2   g69(.a(new_n107_), .b(x04), .O(new_n132_));
  oai22  g70(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(x10), .O(z12));
  nor2   g71(.a(x19), .b(x18), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n131_), .c(x20), .O(new_n135_));
  inv1   g73(.a(new_n135_), .O(z13));
  inv1   g74(.a(new_n66_), .O(new_n137_));
  nand4  g75(.a(new_n134_), .b(new_n137_), .c(x27), .d(x20), .O(z14));
  ...
  nand2  g83(.a(new_n124_), .b(new_n72_), .O(new_n146_));
  nand2  g84(.a(new_n146_), .b(new_n119_), .O(new_n147_));
  nand2  g85(.a(new_n147_), .b(x08), .O(new_n148_));
  nand4  g86(.a(new_n148_), .b(new_n125_), .c(new_n77_), .d(new_n127_), .O(z18));
  oai21  g87(.a(new_n123_), .b(new_n72_), .c(new_n122_), .O(new_n150_));
  oai21  g88(.a(new_n74_), .b(x27), .c(x35), .O(new_n151_));
  nand2  g89(.a(new_n151_), .b(new_n119_), .O(new_n152_));
  aoi21  g90(.a(new_n152_), .b(new_n150_), .c(new_n128_), .O(z20));
  aoi21  g91(.a(new_n126_), .b(new_n121_), .c(new_n128_), .O(z19));
endmodule
