// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:38 2020
...
module FAU ( 
  ...
  nand2  g047(.a(new_n106_), .b(x07), .O(new_n110_));
  nand2  g048(.a(x39), .b(x05), .O(new_n111_));
  nand2  g049(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nor2   g050(.a(new_n111_), .b(new_n77_), .O(new_n113_));
  ...
  nor2   g057(.a(new_n85_), .b(x28), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(x27), .c(new_n64_), .O(new_n121_));
  ...
  oai22  g065(.a(new_n106_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n128_));
  oai21  g066(.a(new_n127_), .b(x10), .c(new_n128_), .O(z12));
  aoi21  g067(.a(x36), .b(x35), .c(new_n74_), .O(new_n130_));
  inv1   g068(.a(x13), .O(new_n131_));
  nand4  g069(.a(x40), .b(x39), .c(new_n131_), .d(new_n64_), .O(new_n132_));
  nor2   g070(.a(x19), .b(x18), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x20), .O(new_n134_));
  oai22  g072(.a(new_n134_), .b(new_n66_), .c(new_n132_), .d(new_n130_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x27), .O(new_n136_));
  inv1   g074(.a(new_n132_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n78_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(z13));
  inv1   g077(.a(x32), .O(new_n140_));
  nand2  g078(.a(x36), .b(x35), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n140_), .c(new_n124_), .d(x28), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(new_n143_));
  nand3  g081(.a(z08), .b(new_n131_), .c(new_n64_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n134_), .O(new_n145_));
  nand4  g083(.a(x40), .b(x39), .c(new_n131_), .d(new_n64_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n72_), .O(new_n147_));
  nand3  g085(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n77_), .O(new_n150_));
  nand2  g088(.a(new_n144_), .b(new_n66_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n150_), .c(new_n147_), .d(new_n145_), .O(z14));
  ...
  nand2  g097(.a(new_n120_), .b(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n117_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x08), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n121_), .c(new_n124_), .d(new_n123_), .O(z18));
  oai21  g101(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n164_));
  oai21  g102(.a(new_n74_), .b(x27), .c(x35), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n117_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n125_), .O(z20));
  aoi21  g105(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
