...
module FAU ( 
  ...
  inv1   g017(.a(new_n75_), .O(new_n80_));
  ...
  nand3  g057(.a(new_n80_), .b(x27), .c(new_n64_), .O(new_n120_));
  ...
  aoi21  g062(.a(new_n63_), .b(new_n87_), .c(new_n72_), .O(new_n125_));
  inv1   g063(.a(new_n66_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x27), .O(new_n127_));
  oai21  g065(.a(new_n81_), .b(x04), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g100(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g103(.a(new_n85_), .b(new_n72_), .c(new_n119_), .O(new_n166_));
  oai21  g104(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n116_), .O(new_n168_));
