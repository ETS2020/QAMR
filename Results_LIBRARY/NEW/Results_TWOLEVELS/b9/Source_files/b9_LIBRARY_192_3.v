...
module FAU ( 
  ...
  nor2   g74(.a(x37), .b(x35), .O(new_n137_));
  nand2  g75(.a(new_n77_), .b(x28), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(new_n139_));
  nand2  g77(.a(new_n131_), .b(z08), .O(new_n140_));
  oai22  g78(.a(new_n140_), .b(new_n139_), .c(new_n137_), .d(new_n130_), .O(new_n141_));
  oai21  g79(.a(x37), .b(x28), .c(x27), .O(new_n142_));
  aoi22  g80(.a(new_n142_), .b(new_n140_), .c(new_n77_), .d(new_n72_), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(new_n141_), .O(z14));
  ...
  oai21  g89(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n152_));
  nand2  g90(.a(new_n152_), .b(x08), .O(new_n153_));
  nand3  g91(.a(new_n153_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g92(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n155_));
  oai21  g93(.a(new_n74_), .b(x27), .c(x35), .O(new_n156_));
  nand2  g94(.a(new_n156_), .b(new_n117_), .O(new_n157_));
  aoi21  g95(.a(new_n157_), .b(new_n155_), .c(new_n124_), .O(z20));
  aoi21  g96(.a(new_n122_), .b(new_n119_), .c(new_n124_), .O(z19));
endmodule
