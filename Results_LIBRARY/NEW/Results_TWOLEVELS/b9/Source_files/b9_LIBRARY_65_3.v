// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:55 2020
...
module FAU ( 
  ...
  inv1   g079(.a(x20), .O(new_n142_));
  inv1   g080(.a(x30), .O(new_n143_));
  inv1   g081(.a(x32), .O(new_n144_));
  nand4  g082(.a(new_n131_), .b(new_n144_), .c(new_n143_), .d(x28), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n139_), .b(z08), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n146_), .c(new_n142_), .d(x19), .O(new_n148_));
  nand3  g086(.a(new_n130_), .b(x40), .c(new_n128_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n72_), .O(new_n150_));
  ...
  aoi21  g091(.a(new_n147_), .b(new_n66_), .c(x18), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n153_), .c(new_n150_), .d(new_n148_), .O(z14));
