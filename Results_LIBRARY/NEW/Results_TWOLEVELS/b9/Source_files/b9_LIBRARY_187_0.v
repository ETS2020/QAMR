...
module FAU ( 
  ...
  aoi21  g104(.a(new_n118_), .b(new_n165_), .c(new_n126_), .O(new_n167_));
  oai21  g105(.a(new_n166_), .b(new_n117_), .c(new_n167_), .O(z18));
  oai21  g106(.a(new_n74_), .b(x27), .c(x35), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n121_), .c(new_n80_), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(new_n126_), .O(z20));
  aoi21  g109(.a(new_n123_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
