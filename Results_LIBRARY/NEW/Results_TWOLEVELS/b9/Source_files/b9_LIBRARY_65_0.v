// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:54 2020
...
module FAU ( 
  ...
  nand2  g074(.a(new_n85_), .b(new_n87_), .O(new_n137_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n148_), .c(new_n124_), .d(x28), .O(new_n149_));
  oai21  g087(.a(x13), .b(x04), .c(x40), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(x39), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n140_), .O(new_n152_));
  aoi22  g090(.a(new_n145_), .b(x39), .c(x35), .d(x28), .O(new_n153_));
  inv1   g091(.a(x35), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n148_), .c(new_n124_), .d(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n153_), .c(new_n87_), .O(new_n157_));
  nand2  g095(.a(new_n138_), .b(x13), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n120_), .c(new_n78_), .d(x39), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n72_), .c(new_n134_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n157_), .c(new_n152_), .O(z14));
  ...
  nor2   g106(.a(new_n154_), .b(x28), .O(new_n169_));
  ...
  oai21  g111(.a(new_n154_), .b(new_n72_), .c(new_n82_), .O(new_n174_));
