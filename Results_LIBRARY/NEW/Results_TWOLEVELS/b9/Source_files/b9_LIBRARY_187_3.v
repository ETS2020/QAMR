...
module FAU ( 
  ...
  oai21  g017(.a(new_n75_), .b(new_n72_), .c(x04), .O(new_n80_));
  ...
  nand2  g047(.a(new_n81_), .b(x07), .O(new_n110_));
  oai21  g048(.a(new_n81_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nor3   g049(.a(new_n77_), .b(new_n81_), .c(new_n109_), .O(new_n112_));
  ...
  inv1   g053(.a(x29), .O(new_n116_));
  oai21  g054(.a(new_n81_), .b(new_n116_), .c(new_n85_), .O(new_n117_));
  aoi21  g055(.a(x35), .b(x27), .c(x08), .O(new_n118_));
  nand2  g056(.a(new_n74_), .b(new_n64_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(x35), .c(new_n118_), .O(new_n120_));
  nor2   g058(.a(x30), .b(x09), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n120_), .b(new_n117_), .c(new_n122_), .O(z11));
  aoi21  g061(.a(new_n63_), .b(new_n87_), .c(new_n72_), .O(new_n124_));
  inv1   g062(.a(new_n66_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x27), .O(new_n126_));
  oai21  g064(.a(new_n81_), .b(x04), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n125_), .O(new_n138_));
  ...
  nand2  g090(.a(new_n148_), .b(new_n126_), .O(new_n153_));
  ...
  nand4  g099(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n162_));
  nand3  g100(.a(z08), .b(x29), .c(x08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n121_), .O(z18));
  inv1   g102(.a(new_n118_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n117_), .c(new_n122_), .O(z20));
