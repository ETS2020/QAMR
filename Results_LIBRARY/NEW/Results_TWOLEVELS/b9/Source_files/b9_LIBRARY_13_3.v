...
module FAU ( 
  ...
  nand2  g046(.a(new_n68_), .b(x07), .O(new_n109_));
  nand4  g047(.a(x40), .b(x39), .c(x36), .d(x05), .O(new_n110_));
  oai21  g048(.a(new_n109_), .b(new_n76_), .c(new_n110_), .O(new_n111_));
  inv1   g049(.a(x05), .O(new_n112_));
  nor3   g050(.a(new_n77_), .b(new_n68_), .c(new_n112_), .O(new_n113_));
  aoi21  g051(.a(new_n111_), .b(x27), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g056(.a(new_n118_), .b(new_n80_), .c(new_n117_), .O(new_n119_));
  inv1   g057(.a(x08), .O(new_n120_));
  nand4  g058(.a(x35), .b(new_n75_), .c(x27), .d(new_n64_), .O(new_n121_));
  ...
  aoi21  g063(.a(new_n63_), .b(new_n88_), .c(new_n74_), .O(new_n126_));
  nor2   g064(.a(new_n66_), .b(new_n74_), .O(new_n127_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n66_), .c(new_n134_), .O(new_n137_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n136_), .O(new_n148_));
  nand3  g086(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n77_), .O(new_n151_));
  oai21  g089(.a(new_n66_), .b(new_n74_), .c(new_n147_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(new_n148_), .O(z14));
  ...
  oai21  g098(.a(new_n80_), .b(x27), .c(new_n117_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x08), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g101(.a(new_n86_), .b(new_n74_), .c(new_n120_), .O(new_n164_));
