...
module FAU ( 
  ...
  oai21  g101(.a(x28), .b(x27), .c(new_n118_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n123_), .c(new_n121_), .O(z18));
  aoi21  g104(.a(new_n118_), .b(x28), .c(new_n120_), .O(new_n167_));
  nor3   g105(.a(new_n167_), .b(new_n124_), .c(x27), .O(z20));
