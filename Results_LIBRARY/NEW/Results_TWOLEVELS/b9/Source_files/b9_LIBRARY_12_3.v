...
module FAU ( 
  ...
  nor2   g060(.a(new_n74_), .b(new_n64_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n83_), .c(new_n122_), .O(new_n124_));
  inv1   g062(.a(x08), .O(new_n125_));
  nand4  g063(.a(x35), .b(new_n73_), .c(x27), .d(new_n64_), .O(new_n126_));
  ...
  aoi21  g068(.a(new_n63_), .b(new_n91_), .c(new_n74_), .O(new_n131_));
  inv1   g069(.a(new_n66_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x27), .O(new_n133_));
  oai21  g071(.a(new_n85_), .b(x04), .c(new_n133_), .O(new_n134_));
  oai21  g072(.a(new_n131_), .b(x10), .c(new_n134_), .O(z12));
  inv1   g073(.a(x13), .O(new_n136_));
  inv1   g074(.a(x39), .O(new_n137_));
  nor2   g075(.a(new_n137_), .b(x04), .O(new_n138_));
  oai21  g076(.a(new_n77_), .b(new_n89_), .c(x28), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(new_n138_), .c(x40), .d(new_n136_), .O(new_n140_));
  ...
  nand2  g083(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nor2   g085(.a(new_n117_), .b(new_n85_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n136_), .c(new_n64_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  nand2  g088(.a(new_n89_), .b(new_n75_), .O(new_n151_));
  nand2  g089(.a(new_n72_), .b(x28), .O(new_n152_));
  aoi21  g090(.a(new_n151_), .b(new_n78_), .c(new_n152_), .O(new_n153_));
  nand3  g091(.a(z08), .b(new_n136_), .c(new_n64_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n143_), .O(new_n155_));
  nand3  g093(.a(new_n91_), .b(new_n89_), .c(x28), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  aoi22  g095(.a(new_n157_), .b(new_n117_), .c(new_n154_), .d(new_n133_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z14));
  ...
  oai21  g104(.a(new_n83_), .b(x27), .c(new_n122_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n128_), .c(new_n126_), .O(z18));
  oai21  g107(.a(new_n89_), .b(new_n74_), .c(new_n125_), .O(new_n170_));
  oai21  g108(.a(new_n73_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n122_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n129_), .O(z20));
  aoi21  g111(.a(new_n127_), .b(new_n124_), .c(new_n129_), .O(z19));
endmodule
