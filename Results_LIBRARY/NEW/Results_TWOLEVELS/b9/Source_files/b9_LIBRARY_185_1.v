...
module FAU ( 
  ...
  aoi21  g065(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n153_));
  ...
  oai21  g106(.a(new_n166_), .b(new_n121_), .c(new_n168_), .O(z18));
  oai21  g107(.a(new_n87_), .b(new_n72_), .c(new_n121_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n118_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n126_), .O(z20));
  aoi21  g111(.a(new_n123_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
