// Benchmark "FAU" written by ABC on Thu Jun 25 16:34:21 2020
...
module FAU ( 
  ...
  nor2   g18(.a(new_n34_), .b(new_n47_), .O(new_n48_));
  ...
  nand4  g24(.a(x12), .b(x11), .c(new_n53_), .d(x09), .O(new_n54_));
  ...
  nand3  g32(.a(x12), .b(x11), .c(new_n53_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n55_), .c(new_n61_), .O(z09));
  nand2  g34(.a(new_n52_), .b(x12), .O(new_n64_));
  nand2  g35(.a(x11), .b(x09), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z10));
  nor2   g37(.a(new_n49_), .b(x10), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(new_n52_), .c(x12), .O(new_n68_));
  nand2  g39(.a(new_n32_), .b(new_n30_), .O(new_n69_));
  nand2  g40(.a(x11), .b(x00), .O(new_n70_));
  aoi21  g41(.a(new_n69_), .b(new_n68_), .c(new_n70_), .O(z11));
  nor4   g42(.a(new_n58_), .b(new_n32_), .c(new_n31_), .d(x09), .O(z12));
endmodule
