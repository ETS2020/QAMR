// Benchmark "FAU" written by ABC on Thu Jun 25 16:33:56 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n55_), .b(new_n51_), .c(new_n45_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z10));
  nand3  g33(.a(new_n32_), .b(x11), .c(new_n30_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n58_), .O(z11));
