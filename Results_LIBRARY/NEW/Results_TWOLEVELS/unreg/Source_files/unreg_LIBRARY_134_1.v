...
module FAU ( 
  ...
  nor2   g101(.a(x18), .b(x13), .O(new_n154_));
  inv1   g102(.a(x35), .O(new_n155_));
  nand2  g103(.a(new_n58_), .b(new_n155_), .O(new_n156_));
  inv1   g104(.a(x34), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n57_), .O(new_n158_));
  oai21  g106(.a(new_n156_), .b(new_n154_), .c(new_n158_), .O(z14));
  inv1   g107(.a(x17), .O(new_n160_));
  nand2  g108(.a(new_n55_), .b(x12), .O(new_n161_));
  nand3  g109(.a(new_n116_), .b(x19), .c(x18), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n160_), .O(new_n164_));
