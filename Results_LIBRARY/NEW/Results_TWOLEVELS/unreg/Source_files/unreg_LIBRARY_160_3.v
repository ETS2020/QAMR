...
module FAU ( 
  ...
  nand3  g005(.a(x19), .b(new_n57_), .c(x02), .O(new_n58_));
  ...
  nor2   g014(.a(new_n63_), .b(x17), .O(new_n67_));
  ...
  nand2  g054(.a(new_n106_), .b(new_n63_), .O(new_n107_));
  ...
  nand2  g075(.a(new_n127_), .b(new_n63_), .O(new_n128_));
  ...
  nand2  g096(.a(new_n148_), .b(new_n63_), .O(new_n149_));
