...
module FAU ( 
  ...
  nand3  g033(.a(new_n85_), .b(new_n55_), .c(x07), .O(new_n86_));
  inv1   g034(.a(x25), .O(new_n87_));
  nand3  g035(.a(new_n87_), .b(x19), .c(x18), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand2  g037(.a(new_n89_), .b(new_n84_), .O(new_n90_));
  nand2  g038(.a(new_n85_), .b(new_n57_), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n90_), .O(z04));
  ...
  nand2  g044(.a(new_n87_), .b(new_n57_), .O(new_n97_));
  ...
  nand2  g081(.a(x19), .b(new_n84_), .O(new_n134_));
  nor2   g082(.a(x18), .b(x08), .O(new_n135_));
  oai22  g083(.a(new_n135_), .b(new_n134_), .c(x31), .d(x19), .O(z11));
