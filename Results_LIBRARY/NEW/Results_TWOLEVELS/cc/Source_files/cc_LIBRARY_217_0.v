...
module FAU ( 
  ...
  nand4  g20(.a(new_n57_), .b(x10), .c(x08), .d(x01), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(x14), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n46_), .c(new_n56_), .O(z13));
  nand2  g23(.a(new_n44_), .b(x15), .O(new_n65_));
  nand4  g24(.a(new_n57_), .b(x10), .c(x08), .d(x02), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n56_), .O(z14));
  nand4  g26(.a(new_n57_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  nand2  g27(.a(x16), .b(new_n43_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(z15));
  nand2  g29(.a(new_n58_), .b(x17), .O(new_n71_));
  nand4  g30(.a(new_n57_), .b(x10), .c(x08), .d(x04), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(z16));
  nand2  g32(.a(new_n58_), .b(x18), .O(new_n74_));
  nand4  g33(.a(new_n57_), .b(x10), .c(x08), .d(x05), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(z17));
  nand2  g35(.a(new_n58_), .b(x19), .O(new_n77_));
  nand4  g36(.a(new_n57_), .b(x10), .c(x08), .d(x06), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(z18));
  nand2  g38(.a(new_n58_), .b(x20), .O(new_n80_));
  nand4  g39(.a(new_n57_), .b(x10), .c(x08), .d(x07), .O(new_n81_));
