// Benchmark "FAU" written by ABC on Thu Jun 25 18:51:29 2020
...
module FAU ( 
  ...
  nand2  g41(.a(new_n48_), .b(x08), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x20), .c(new_n59_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n53_), .O(z19));
  buf    g44(.a(x19), .O(z05));
  buf    g45(.a(x15), .O(z06));
  buf    g46(.a(x17), .O(z07));
  buf    g47(.a(x16), .O(z08));
