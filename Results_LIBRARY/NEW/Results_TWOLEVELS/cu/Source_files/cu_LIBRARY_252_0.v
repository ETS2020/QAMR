...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n38_, new_n39_, new_n42_, new_n43_, new_n44_,
  ...
  nor3   g14(.a(new_n39_), .b(x02), .c(x00), .O(z04));
  nand2  g15(.a(new_n27_), .b(new_n31_), .O(new_n42_));
  nand3  g16(.a(new_n38_), .b(x05), .c(new_n26_), .O(new_n43_));
  nand2  g17(.a(x01), .b(x00), .O(new_n44_));
  nor3   g18(.a(new_n44_), .b(new_n43_), .c(new_n42_), .O(z05));
  inv1   g19(.a(x11), .O(new_n46_));
  nand3  g20(.a(new_n46_), .b(x01), .c(x00), .O(new_n47_));
  inv1   g21(.a(x01), .O(new_n48_));
  ...
  nand3  g27(.a(new_n53_), .b(new_n50_), .c(new_n47_), .O(new_n54_));
  ...
  nor2   g37(.a(new_n43_), .b(new_n42_), .O(z07));
