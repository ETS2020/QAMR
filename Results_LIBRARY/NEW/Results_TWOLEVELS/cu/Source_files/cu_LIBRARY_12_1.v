...
module FAU ( 
  ...
  nand2  g14(.a(new_n27_), .b(new_n31_), .O(new_n40_));
  nand3  g15(.a(new_n37_), .b(x05), .c(new_n26_), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(x00), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(z03));
  nor3   g19(.a(new_n38_), .b(x02), .c(new_n42_), .O(z05));
  inv1   g20(.a(x09), .O(new_n47_));
  nand3  g21(.a(new_n47_), .b(new_n42_), .c(x00), .O(new_n48_));
  inv1   g22(.a(x00), .O(new_n49_));
  inv1   g23(.a(x08), .O(new_n50_));
  nand2  g24(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  inv1   g25(.a(x11), .O(new_n52_));
  nand2  g26(.a(new_n52_), .b(x01), .O(new_n53_));
  nand3  g27(.a(new_n53_), .b(new_n51_), .c(new_n48_), .O(new_n54_));
