...
module FAU ( 
  ...
  nor4   g18(.a(new_n39_), .b(new_n37_), .c(x01), .d(new_n40_), .O(z03));
  nor4   g19(.a(new_n39_), .b(new_n37_), .c(new_n41_), .d(x00), .O(z04));
  nor4   g20(.a(new_n39_), .b(new_n37_), .c(new_n41_), .d(new_n40_), .O(z05));
  ...
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n40_), .O(new_n51_));
  inv1   g26(.a(x10), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(x01), .O(new_n53_));
  oai21  g28(.a(new_n42_), .b(x08), .c(new_n53_), .O(new_n54_));
