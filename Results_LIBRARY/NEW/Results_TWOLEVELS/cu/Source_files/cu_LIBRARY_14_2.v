...
module FAU ( 
  ...
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(new_n56_));
  oai21  g27(.a(new_n52_), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  inv1   g28(.a(x13), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(x02), .O(new_n59_));
  nand2  g30(.a(x04), .b(new_n26_), .O(new_n60_));
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n60_), .O(z06));
  nand3  g32(.a(new_n54_), .b(x05), .c(new_n31_), .O(new_n63_));
  aoi21  g33(.a(new_n63_), .b(new_n59_), .c(new_n60_), .O(z08));
  and2   g34(.a(x13), .b(x06), .O(z09));
  nand3  g35(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n66_));
  inv1   g36(.a(new_n66_), .O(z10));
  zero   g37(.O(z02));
  zero   g38(.O(z03));
  zero   g39(.O(z04));
  zero   g40(.O(z05));
