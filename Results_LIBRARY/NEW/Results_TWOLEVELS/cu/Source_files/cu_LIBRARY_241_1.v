// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:58 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n38_, new_n39_, new_n42_, new_n44_, new_n45_,
  ...
  nor3   g13(.a(new_n39_), .b(x02), .c(x01), .O(z03));
  inv1   g14(.a(x01), .O(new_n42_));
  nor3   g15(.a(new_n39_), .b(x02), .c(new_n42_), .O(z05));
  ...
  nand3  g27(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n55_));
  nand2  g28(.a(x04), .b(new_n26_), .O(new_n56_));
  aoi21  g29(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z06));
  nand3  g30(.a(new_n38_), .b(x05), .c(new_n26_), .O(new_n58_));
