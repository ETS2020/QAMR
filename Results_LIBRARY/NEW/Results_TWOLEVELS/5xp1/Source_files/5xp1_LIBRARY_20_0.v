// Benchmark "FAU" written by ABC on Thu Jun 25 19:29:12 2020
...
module FAU ( 
  ...
  nand2  g097(.a(new_n27_), .b(x0), .O(new_n115_));
  nand3  g098(.a(new_n115_), .b(x6), .c(x1), .O(new_n116_));
  nand3  g099(.a(x6), .b(new_n18_), .c(new_n21_), .O(new_n117_));
  inv1   g100(.a(new_n117_), .O(new_n118_));
  aoi21  g101(.a(new_n118_), .b(new_n116_), .c(x3), .O(z8));
  nand2  g102(.a(x5), .b(x4), .O(new_n120_));
  oai21  g103(.a(x3), .b(new_n22_), .c(x6), .O(new_n121_));
  oai21  g104(.a(new_n45_), .b(x3), .c(new_n46_), .O(new_n122_));
  aoi21  g105(.a(new_n122_), .b(x1), .c(x0), .O(new_n123_));
  aoi21  g106(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(z9));
endmodule
