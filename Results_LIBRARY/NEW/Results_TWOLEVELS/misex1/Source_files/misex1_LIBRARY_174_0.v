// Benchmark "FAU" written by ABC on Thu Jun 25 17:14:37 2020
...
module FAU ( 
  ...
  nor2   g22(.a(new_n18_), .b(x0), .O(new_n38_));
  ...
  nand3  g27(.a(new_n32_), .b(x2), .c(new_n18_), .O(new_n43_));
  ...
  aoi21  g32(.a(new_n46_), .b(new_n30_), .c(new_n17_), .O(new_n48_));
  aoi21  g33(.a(x5), .b(new_n19_), .c(x2), .O(new_n49_));
  nor2   g34(.a(new_n49_), .b(x0), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n48_), .c(new_n18_), .O(new_n51_));
  nor2   g36(.a(x3), .b(x2), .O(new_n52_));
  ...
  oai21  g40(.a(new_n55_), .b(new_n48_), .c(new_n18_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n53_), .O(z5));
  inv1   g42(.a(new_n33_), .O(new_n58_));
  oai21  g43(.a(new_n48_), .b(new_n58_), .c(new_n18_), .O(new_n59_));
