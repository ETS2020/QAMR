...
module FAU ( 
  ...
  nand3  g087(.a(new_n120_), .b(new_n84_), .c(x14), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n118_), .O(z2));
  nand4  g089(.a(new_n120_), .b(new_n84_), .c(x14), .d(x08), .O(new_n123_));
  aoi21  g090(.a(new_n54_), .b(new_n52_), .c(new_n123_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nand4  g092(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n125_), .O(new_n126_));
  aoi21  g093(.a(new_n65_), .b(new_n64_), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g097(.a(new_n48_), .b(new_n68_), .O(new_n131_));
  nand4  g098(.a(new_n47_), .b(new_n76_), .c(new_n125_), .d(x07), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n129_), .O(new_n133_));
  nand4  g100(.a(x15), .b(x14), .c(x11), .d(x08), .O(new_n134_));
  nand4  g101(.a(new_n47_), .b(x19), .c(new_n76_), .d(new_n125_), .O(new_n135_));
  ...
  aoi21  g109(.a(x23), .b(new_n67_), .c(new_n78_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n72_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n125_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n118_), .c(new_n142_), .d(new_n46_), .O(z4));
  inv1   g113(.a(new_n46_), .O(z5));
  inv1   g114(.a(x03), .O(new_n148_));
  aoi21  g115(.a(x11), .b(new_n68_), .c(new_n148_), .O(new_n149_));
  oai21  g116(.a(new_n47_), .b(x14), .c(new_n68_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n119_), .c(x03), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n46_), .c(new_n149_), .d(new_n118_), .O(z6));
  inv1   g119(.a(new_n118_), .O(z7));
endmodule
