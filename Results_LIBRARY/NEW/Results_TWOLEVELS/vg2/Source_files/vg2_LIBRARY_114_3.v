...
module FAU ( 
  ...
  oai21  g021(.a(new_n53_), .b(x02), .c(new_n54_), .O(new_n55_));
  ...
  oai21  g111(.a(x23), .b(new_n144_), .c(new_n71_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n72_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n106_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(z5), .O(new_n148_));
  oai21  g115(.a(new_n73_), .b(x04), .c(x17), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x22), .c(new_n103_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n70_), .c(x08), .O(new_n151_));
  nand4  g118(.a(new_n35_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n120_), .c(new_n116_), .O(z7));
  nand2  g120(.a(z7), .b(new_n151_), .O(new_n154_));
  ...
  oai21  g128(.a(new_n161_), .b(new_n156_), .c(z7), .O(new_n162_));
