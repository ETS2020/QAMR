...
module FAU ( 
  ...
  and2   g36(.a(x11), .b(x06), .O(new_n70_));
  nand4  g37(.a(new_n70_), .b(new_n62_), .c(x20), .d(x14), .O(new_n71_));
  nor2   g38(.a(new_n71_), .b(new_n61_), .O(z2));
  nand3  g39(.a(x15), .b(x13), .c(x05), .O(new_n73_));
  nand2  g40(.a(new_n56_), .b(x21), .O(new_n74_));
  nand3  g41(.a(x20), .b(x14), .c(x08), .O(new_n75_));
  inv1   g42(.a(new_n75_), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n70_), .c(new_n62_), .O(new_n77_));
  aoi21  g44(.a(new_n74_), .b(new_n73_), .c(new_n77_), .O(new_n78_));
  nand2  g45(.a(new_n56_), .b(x00), .O(new_n79_));
  nand3  g46(.a(x19), .b(x13), .c(x05), .O(new_n80_));
  nor2   g47(.a(x14), .b(x08), .O(new_n81_));
  nand4  g48(.a(new_n81_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n82_));
  aoi21  g49(.a(new_n80_), .b(new_n79_), .c(new_n82_), .O(new_n83_));
  oai21  g50(.a(new_n83_), .b(new_n78_), .c(new_n36_), .O(new_n84_));
  inv1   g51(.a(x01), .O(new_n85_));
  inv1   g52(.a(x03), .O(new_n86_));
  inv1   g53(.a(x06), .O(new_n87_));
  inv1   g54(.a(x11), .O(new_n88_));
  nand4  g55(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n89_));
  nand4  g56(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n90_));
  nand4  g57(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n91_));
  inv1   g58(.a(x08), .O(new_n92_));
  nand4  g59(.a(new_n48_), .b(new_n47_), .c(new_n92_), .d(x07), .O(new_n93_));
  oai22  g60(.a(new_n93_), .b(new_n89_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  nor2   g61(.a(new_n39_), .b(new_n36_), .O(new_n95_));
  nand4  g62(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n96_));
  nand4  g63(.a(new_n48_), .b(x19), .c(new_n47_), .d(new_n92_), .O(new_n97_));
  oai22  g64(.a(new_n97_), .b(new_n89_), .c(new_n96_), .d(new_n90_), .O(new_n98_));
  aoi22  g65(.a(new_n98_), .b(new_n39_), .c(new_n95_), .d(new_n94_), .O(new_n99_));
  nand2  g66(.a(new_n99_), .b(new_n84_), .O(z3));
  inv1   g67(.a(x22), .O(new_n101_));
  nor2   g68(.a(new_n101_), .b(x09), .O(new_n102_));
  oai21  g69(.a(new_n102_), .b(x16), .c(new_n92_), .O(new_n103_));
  oai21  g70(.a(new_n45_), .b(new_n38_), .c(new_n103_), .O(new_n104_));
  inv1   g71(.a(x04), .O(new_n105_));
  inv1   g72(.a(x17), .O(new_n106_));
  aoi21  g73(.a(x23), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  oai21  g74(.a(new_n107_), .b(new_n101_), .c(x09), .O(new_n108_));
  aoi21  g75(.a(new_n108_), .b(x16), .c(new_n92_), .O(new_n109_));
  oai21  g76(.a(new_n109_), .b(new_n61_), .c(new_n104_), .O(z4));
  inv1   g77(.a(new_n46_), .O(z5));
  oai21  g78(.a(new_n48_), .b(x14), .c(new_n87_), .O(new_n112_));
  aoi21  g79(.a(new_n112_), .b(new_n88_), .c(x03), .O(new_n113_));
  oai21  g80(.a(x20), .b(new_n47_), .c(x06), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(x11), .c(new_n86_), .O(new_n115_));
  oai22  g82(.a(new_n115_), .b(new_n61_), .c(new_n113_), .d(new_n46_), .O(z6));
  inv1   g83(.a(new_n61_), .O(z7));
endmodule
