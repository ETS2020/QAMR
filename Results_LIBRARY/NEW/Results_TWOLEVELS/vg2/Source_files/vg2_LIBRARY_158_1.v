...
module FAU ( 
  ...
  nor2   g066(.a(new_n43_), .b(new_n36_), .O(new_n100_));
  ...
  nand2  g086(.a(new_n43_), .b(x15), .O(new_n120_));
  ...
  aoi22  g105(.a(new_n138_), .b(new_n43_), .c(new_n135_), .d(new_n100_), .O(new_n139_));
  ...
  oai21  g117(.a(x14), .b(new_n47_), .c(x11), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x03), .c(new_n150_), .O(new_n152_));
  aoi21  g119(.a(new_n48_), .b(x06), .c(x03), .O(new_n153_));
  nand2  g120(.a(x20), .b(new_n77_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(x11), .c(new_n153_), .d(new_n93_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n152_), .c(new_n100_), .O(new_n156_));
  inv1   g123(.a(x03), .O(new_n157_));
  inv1   g124(.a(new_n118_), .O(new_n158_));
  nand2  g125(.a(new_n78_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n48_), .O(new_n160_));
  inv1   g127(.a(x15), .O(new_n161_));
  inv1   g128(.a(new_n43_), .O(new_n162_));
  nand3  g129(.a(new_n36_), .b(x13), .c(x05), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n162_), .c(new_n161_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n158_), .c(new_n160_), .d(new_n157_), .O(new_n165_));
  nand2  g132(.a(new_n44_), .b(new_n42_), .O(new_n166_));
  aoi21  g133(.a(new_n154_), .b(new_n47_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(new_n166_), .O(new_n168_));
  inv1   g135(.a(new_n65_), .O(new_n169_));
  nand2  g136(.a(new_n36_), .b(x06), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n154_), .c(x11), .O(new_n171_));
  nor2   g138(.a(x24), .b(new_n157_), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n171_), .c(new_n169_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n168_), .c(new_n165_), .d(new_n156_), .O(z6));
  inv1   g141(.a(new_n122_), .O(z7));
endmodule
