...
module FAU ( 
  ...
  nand4  g052(.a(new_n85_), .b(x12), .c(x11), .d(x09), .O(new_n86_));
  nor2   g053(.a(new_n78_), .b(new_n77_), .O(new_n87_));
  and2   g054(.a(x20), .b(x18), .O(new_n88_));
  nor2   g055(.a(new_n74_), .b(new_n73_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x17), .O(new_n90_));
  ...
  oai22  g065(.a(new_n98_), .b(new_n95_), .c(new_n90_), .d(new_n86_), .O(new_n99_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n89_), .c(new_n87_), .O(new_n104_));
  ...
  oai22  g077(.a(new_n110_), .b(new_n108_), .c(new_n104_), .d(new_n86_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n39_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n101_), .c(new_n83_), .O(z1));
  ...
  nand4  g091(.a(new_n124_), .b(new_n85_), .c(new_n56_), .d(x20), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand2  g093(.a(new_n107_), .b(new_n49_), .O(new_n127_));
  inv1   g094(.a(new_n127_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n126_), .c(new_n67_), .O(new_n129_));
  ...
  nand4  g105(.a(new_n138_), .b(x19), .c(new_n77_), .d(new_n48_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n127_), .c(new_n137_), .d(new_n84_), .O(new_n140_));
  aoi22  g107(.a(new_n140_), .b(new_n39_), .c(new_n136_), .d(new_n100_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n131_), .O(z3));
  ...
  aoi21  g113(.a(x23), .b(new_n96_), .c(new_n72_), .O(new_n147_));
  ...
  oai21  g118(.a(new_n138_), .b(x14), .c(new_n47_), .O(new_n152_));
