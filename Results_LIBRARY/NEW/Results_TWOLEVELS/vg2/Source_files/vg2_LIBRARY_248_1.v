...
module FAU ( 
  ...
  nand3  g051(.a(x12), .b(x09), .c(x08), .O(new_n85_));
  ...
  nor2   g085(.a(new_n47_), .b(new_n68_), .O(new_n119_));
  ...
  nand4  g097(.a(x20), .b(x18), .c(x14), .d(x08), .O(new_n131_));
  ...
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x08), .O(new_n134_));
