...
module FAU ( 
  ...
  oai21  g57(.a(x20), .b(new_n91_), .c(x06), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(x11), .c(new_n90_), .O(new_n93_));
  oai22  g59(.a(new_n93_), .b(new_n47_), .c(new_n89_), .d(new_n75_), .O(z6));
  inv1   g60(.a(new_n47_), .O(z7));
  zero   g61(.O(z0));
endmodule
