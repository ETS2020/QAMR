...
module FAU ( 
  ...
  nand4  g52(.a(new_n57_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n99_));
  nand2  g53(.a(x22), .b(x17), .O(new_n100_));
  aoi21  g54(.a(new_n100_), .b(new_n99_), .c(x21), .O(new_n101_));
  aoi21  g55(.a(new_n92_), .b(new_n48_), .c(new_n57_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n101_), .c(x16), .O(new_n103_));
  ...
  nand3  g64(.a(new_n110_), .b(new_n74_), .c(new_n51_), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(x23), .c(new_n109_), .d(new_n84_), .O(new_n112_));
  ...
  aoi21  g71(.a(new_n109_), .b(new_n84_), .c(new_n63_), .O(new_n118_));
  nand3  g72(.a(new_n110_), .b(new_n63_), .c(new_n60_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n91_), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n118_), .c(x16), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n117_), .O(z14));
  ...
  nand2  g79(.a(new_n63_), .b(new_n60_), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n92_), .c(new_n74_), .d(new_n57_), .O(new_n127_));
  nand2  g81(.a(new_n111_), .b(x25), .O(new_n128_));
  ...
  oai21  g89(.a(new_n69_), .b(new_n87_), .c(new_n135_), .O(z16));
