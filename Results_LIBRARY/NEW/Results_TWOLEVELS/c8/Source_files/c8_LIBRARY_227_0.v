// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:24 2020
...
module FAU ( 
  ...
  nor2   g32(.a(x18), .b(x09), .O(new_n79_));
  ...
  oai21  g38(.a(new_n81_), .b(new_n79_), .c(new_n84_), .O(z10));
  nand2  g39(.a(x18), .b(x02), .O(new_n86_));
  oai21  g40(.a(x18), .b(new_n54_), .c(new_n86_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n80_), .O(new_n88_));
  nand2  g42(.a(new_n73_), .b(new_n51_), .O(new_n89_));
  nor2   g43(.a(x21), .b(x20), .O(new_n90_));
  aoi22  g44(.a(new_n90_), .b(new_n73_), .c(new_n89_), .d(x21), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n80_), .c(new_n88_), .O(z11));
  nand2  g46(.a(x18), .b(x03), .O(new_n93_));
  oai21  g47(.a(x18), .b(new_n57_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n80_), .O(new_n95_));
  nand2  g49(.a(new_n90_), .b(new_n73_), .O(new_n96_));
  nor2   g50(.a(x22), .b(x21), .O(new_n97_));
  aoi22  g51(.a(new_n97_), .b(new_n83_), .c(new_n96_), .d(x22), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n80_), .c(new_n95_), .O(z12));
  nand2  g53(.a(x18), .b(x04), .O(new_n100_));
  oai21  g54(.a(x18), .b(new_n60_), .c(new_n100_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n80_), .O(new_n102_));
  nand3  g56(.a(new_n97_), .b(new_n73_), .c(new_n51_), .O(new_n103_));
  nor3   g57(.a(x23), .b(x22), .c(x21), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n83_), .c(new_n103_), .d(x23), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n80_), .c(new_n102_), .O(z13));
  ...
  aoi21  g64(.a(new_n104_), .b(new_n83_), .c(new_n63_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n97_), .c(new_n73_), .d(new_n51_), .O(new_n113_));
  ...
  oai21  g71(.a(x18), .b(new_n66_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n80_), .O(new_n119_));
  nand2  g73(.a(new_n113_), .b(x25), .O(new_n120_));
  nor2   g74(.a(x23), .b(x22), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n90_), .d(new_n73_), .O(new_n123_));
  ...
  oai21  g81(.a(x18), .b(new_n69_), .c(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n80_), .O(new_n129_));
  nand2  g83(.a(new_n123_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n121_), .c(new_n90_), .d(new_n73_), .O(new_n132_));
  ...
  nor2   g89(.a(new_n48_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n131_), .c(new_n121_), .d(new_n90_), .O(new_n137_));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n80_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
