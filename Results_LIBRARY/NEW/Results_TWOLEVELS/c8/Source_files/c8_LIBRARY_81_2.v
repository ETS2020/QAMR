...
module FAU ( 
  ...
  nand2  g71(.a(new_n114_), .b(x25), .O(new_n118_));
  ...
  nand3  g77(.a(x18), .b(new_n86_), .c(x06), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n123_), .O(z15));
  ...
  nand4  g84(.a(new_n130_), .b(new_n119_), .c(new_n91_), .d(new_n73_), .O(new_n131_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n130_), .c(new_n119_), .d(new_n91_), .O(new_n136_));
