...
module FAU ( 
  ...
  nand3  g29(.a(x18), .b(new_n75_), .c(x00), .O(new_n76_));
  ...
  nand2  g36(.a(new_n82_), .b(new_n75_), .O(new_n83_));
  nor2   g37(.a(new_n73_), .b(new_n51_), .O(new_n84_));
  nor3   g38(.a(x20), .b(x19), .c(x17), .O(new_n85_));
  oai21  g39(.a(new_n85_), .b(new_n84_), .c(x16), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n83_), .O(z10));
  ...
  aoi22  g53(.a(new_n99_), .b(new_n85_), .c(new_n98_), .d(x22), .O(new_n100_));
  ...
  aoi22  g60(.a(new_n106_), .b(new_n85_), .c(new_n105_), .d(x23), .O(new_n107_));
  ...
  aoi21  g66(.a(new_n106_), .b(new_n85_), .c(new_n63_), .O(new_n113_));
