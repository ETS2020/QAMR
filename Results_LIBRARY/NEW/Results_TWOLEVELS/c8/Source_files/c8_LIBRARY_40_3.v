...
module FAU ( 
  ...
  nand2  g069(.a(new_n66_), .b(x22), .O(new_n116_));
  nor2   g070(.a(x24), .b(x23), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n116_), .c(new_n93_), .d(new_n74_), .O(new_n118_));
  oai21  g072(.a(new_n109_), .b(new_n92_), .c(x24), .O(new_n119_));
  ...
  nor3   g080(.a(x24), .b(x23), .c(x21), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(new_n84_), .c(new_n66_), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nor2   g083(.a(x25), .b(x24), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n129_), .c(new_n93_), .d(new_n74_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n128_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n126_), .O(z15));
  ...
  nand2  g091(.a(new_n131_), .b(x26), .O(new_n138_));
  nor3   g092(.a(x26), .b(x25), .c(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n129_), .c(new_n93_), .d(new_n74_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n139_), .c(new_n129_), .d(new_n93_), .O(new_n145_));
