...
module FAU ( 
  ...
  nand3  g54(.a(new_n98_), .b(new_n73_), .c(new_n51_), .O(new_n101_));
  nor3   g55(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g56(.a(new_n102_), .b(new_n83_), .c(new_n101_), .d(x23), .O(new_n103_));
  nand3  g57(.a(x18), .b(new_n86_), .c(x04), .O(new_n104_));
  oai21  g58(.a(new_n103_), .b(new_n86_), .c(new_n104_), .O(z13));
  ...
  aoi21  g63(.a(new_n102_), .b(new_n83_), .c(new_n63_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n112_));
