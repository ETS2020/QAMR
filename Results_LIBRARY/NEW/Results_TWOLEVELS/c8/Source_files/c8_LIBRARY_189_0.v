// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:14 2020
...
module FAU ( 
  ...
  inv1   g83(.a(x18), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(x07), .c(new_n75_), .O(new_n131_));
  nand2  g85(.a(new_n126_), .b(x26), .O(new_n132_));
  nor3   g86(.a(x26), .b(x25), .c(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n124_), .c(new_n93_), .d(new_n73_), .O(new_n134_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n133_), .c(new_n124_), .d(new_n93_), .O(new_n139_));
