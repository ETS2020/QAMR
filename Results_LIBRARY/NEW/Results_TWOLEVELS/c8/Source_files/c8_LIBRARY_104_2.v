...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n140_, new_n141_, new_n143_, new_n144_;
  ...
  oai21  g56(.a(new_n94_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n100_), .O(z12));
  ...
  aoi22  g64(.a(new_n110_), .b(new_n84_), .c(new_n102_), .d(x23), .O(new_n111_));
  ...
  nand2  g71(.a(x24), .b(new_n60_), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n117_), .c(new_n74_), .d(new_n57_), .O(new_n119_));
  nand2  g73(.a(new_n102_), .b(x24), .O(new_n120_));
  ...
  nor3   g81(.a(x24), .b(x22), .c(x21), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n84_), .c(new_n66_), .O(new_n129_));
  nor2   g83(.a(x25), .b(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n131_));
  inv1   g85(.a(new_n131_), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n127_), .O(z15));
  inv1   g88(.a(x15), .O(new_n135_));
  nand2  g89(.a(x18), .b(x07), .O(new_n136_));
  oai21  g90(.a(x18), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n87_), .O(new_n138_));
  nand4  g92(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n57_), .O(new_n139_));
  inv1   g93(.a(new_n139_), .O(new_n140_));
  aoi22  g94(.a(new_n140_), .b(new_n94_), .c(new_n131_), .d(x26), .O(new_n141_));
  oai21  g95(.a(new_n141_), .b(new_n87_), .c(new_n138_), .O(z16));
  nand4  g96(.a(new_n140_), .b(new_n117_), .c(x19), .d(new_n72_), .O(new_n143_));
