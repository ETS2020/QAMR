...
module FAU ( 
  ...
  aoi21  g63(.a(new_n107_), .b(new_n86_), .c(new_n63_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  inv1   g68(.a(x18), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(new_n75_), .c(x13), .O(new_n116_));
