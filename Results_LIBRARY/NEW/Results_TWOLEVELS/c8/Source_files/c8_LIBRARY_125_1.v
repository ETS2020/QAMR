// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:55 2020
...
module FAU ( 
  ...
  oai21  g61(.a(x18), .b(x13), .c(new_n86_), .O(new_n108_));
  aoi21  g62(.a(new_n105_), .b(new_n83_), .c(new_n63_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n111_));
  ...
  nand2  g70(.a(new_n116_), .b(new_n86_), .O(new_n117_));
  nand2  g71(.a(new_n111_), .b(x25), .O(new_n118_));
  nor2   g72(.a(x23), .b(x22), .O(new_n119_));
  nor2   g73(.a(x25), .b(x24), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n91_), .d(new_n73_), .O(new_n121_));
  ...
  nand2  g80(.a(new_n126_), .b(new_n86_), .O(new_n127_));
  nand2  g81(.a(new_n121_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n119_), .c(new_n91_), .d(new_n73_), .O(new_n130_));
  ...
  nand4  g88(.a(new_n134_), .b(new_n129_), .c(new_n119_), .d(new_n91_), .O(new_n135_));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n135_), .c(new_n86_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
