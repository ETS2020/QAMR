...
module FAU ( 
  ...
  nand2  g51(.a(new_n91_), .b(new_n73_), .O(new_n98_));
  ...
  nand2  g58(.a(new_n63_), .b(x23), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n91_), .c(new_n73_), .d(new_n57_), .O(new_n106_));
  nand3  g60(.a(new_n99_), .b(new_n73_), .c(new_n51_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x23), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n104_), .O(z13));
  ...
  nand2  g69(.a(new_n107_), .b(x24), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n99_), .c(new_n73_), .d(new_n51_), .O(new_n118_));
  ...
  oai21  g76(.a(x18), .b(new_n66_), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n86_), .O(new_n124_));
  nand2  g78(.a(new_n118_), .b(x25), .O(new_n125_));
  nor2   g79(.a(x23), .b(x22), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n126_), .c(new_n91_), .d(new_n73_), .O(new_n128_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n126_), .c(new_n91_), .d(new_n73_), .O(new_n137_));
  ...
  nand4  g95(.a(new_n141_), .b(new_n136_), .c(new_n126_), .d(new_n91_), .O(new_n142_));
