...
module FAU ( 
  ...
  nand4  g61(.a(x15), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n105_));
  ...
  nand3  g67(.a(new_n97_), .b(x20), .c(new_n88_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  inv1   g69(.a(x13), .O(new_n113_));
  inv1   g70(.a(x14), .O(new_n114_));
  nand4  g71(.a(x15), .b(new_n114_), .c(new_n113_), .d(new_n62_), .O(new_n115_));
