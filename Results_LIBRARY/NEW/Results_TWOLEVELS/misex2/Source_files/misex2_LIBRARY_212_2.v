...
module FAU ( 
  ...
  nor2   g47(.a(new_n69_), .b(x11), .O(new_n91_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n94_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g58(.a(x13), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x12), .c(new_n62_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  nor2   g62(.a(new_n86_), .b(x14), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n96_), .c(x20), .d(x16), .O(new_n107_));
  oai21  g64(.a(new_n107_), .b(new_n105_), .c(new_n101_), .O(z10));
  nand3  g65(.a(new_n100_), .b(new_n94_), .c(x21), .O(new_n109_));
  inv1   g66(.a(x21), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(x20), .c(new_n87_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n106_), .c(new_n104_), .d(new_n90_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(x22), .O(z11));
  oai21  g71(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n82_), .O(new_n119_));
  inv1   g76(.a(x24), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(x09), .O(new_n121_));
  aoi21  g78(.a(new_n119_), .b(new_n115_), .c(new_n121_), .O(z12));
  nor4   g79(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g80(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n45_), .c(new_n126_), .O(z15));
  nor2   g84(.a(new_n46_), .b(x00), .O(z16));
  inv1   g85(.a(new_n83_), .O(z17));
endmodule
