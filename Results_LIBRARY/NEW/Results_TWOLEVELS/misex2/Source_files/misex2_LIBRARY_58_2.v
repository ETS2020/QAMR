// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:05 2020
...
module FAU ( 
  ...
  nand4  g44(.a(new_n87_), .b(x12), .c(x02), .d(new_n66_), .O(new_n88_));
  ...
  nand3  g54(.a(new_n97_), .b(new_n96_), .c(new_n65_), .O(new_n98_));
  aoi21  g55(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nor2   g56(.a(new_n97_), .b(new_n96_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n57_), .c(new_n91_), .d(x01), .O(new_n101_));
  nor2   g58(.a(new_n59_), .b(x01), .O(new_n102_));
  nand4  g59(.a(new_n97_), .b(new_n96_), .c(x20), .d(x16), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  inv1   g61(.a(x14), .O(new_n105_));
  nand4  g62(.a(x15), .b(new_n105_), .c(new_n87_), .d(x12), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n104_), .c(new_n102_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g66(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  inv1   g67(.a(x15), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(x14), .O(new_n112_));
  inv1   g69(.a(x16), .O(new_n113_));
  nand3  g70(.a(new_n96_), .b(x20), .c(new_n113_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n112_), .c(new_n89_), .O(new_n116_));
  nand2  g73(.a(new_n97_), .b(new_n65_), .O(new_n117_));
  aoi21  g74(.a(new_n116_), .b(new_n110_), .c(new_n117_), .O(z11));
  oai21  g75(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n60_), .O(new_n123_));
  inv1   g80(.a(x24), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g82(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z12));
  nor2   g83(.a(x19), .b(new_n47_), .O(new_n127_));
  and2   g84(.a(new_n127_), .b(new_n45_), .O(z13));
  nor2   g85(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g86(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n65_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n66_), .b(x00), .O(z16));
  inv1   g90(.a(new_n84_), .O(z17));
endmodule
