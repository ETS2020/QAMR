// Benchmark "FAU" written by ABC on Thu Jun 25 17:30:54 2020
...
module FAU ( 
  ...
  nand4  g48(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n92_));
  ...
  nor2   g61(.a(x11), .b(new_n59_), .O(new_n105_));
  inv1   g62(.a(x13), .O(new_n106_));
  inv1   g63(.a(x14), .O(new_n107_));
  nand4  g64(.a(x15), .b(new_n107_), .c(new_n106_), .d(x12), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n105_), .c(new_n104_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n102_), .c(x00), .O(z10));
  nand4  g68(.a(new_n95_), .b(x21), .c(x18), .d(x01), .O(new_n112_));
  nand3  g69(.a(new_n97_), .b(x20), .c(new_n88_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n109_), .c(new_n105_), .O(new_n115_));
