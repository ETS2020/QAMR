// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:27 2020
...
module FAU ( 
  ...
  nor2   g46(.a(new_n59_), .b(x01), .O(new_n90_));
  nor2   g47(.a(new_n71_), .b(x11), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n87_), .O(new_n92_));
  nand4  g49(.a(new_n88_), .b(new_n49_), .c(x18), .d(x01), .O(new_n93_));
  inv1   g50(.a(x21), .O(new_n94_));
  inv1   g51(.a(x22), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(new_n94_), .c(new_n65_), .O(new_n96_));
  aoi21  g53(.a(new_n93_), .b(new_n92_), .c(new_n96_), .O(z09));
  nor2   g54(.a(new_n95_), .b(new_n94_), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n57_), .c(new_n88_), .d(x01), .O(new_n99_));
  nand4  g56(.a(new_n95_), .b(new_n94_), .c(x20), .d(x15), .O(new_n100_));
  ...
  nand3  g62(.a(new_n105_), .b(new_n101_), .c(new_n90_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n99_), .c(x00), .O(z10));
  nand3  g64(.a(new_n95_), .b(x21), .c(new_n88_), .O(new_n108_));
  nor2   g65(.a(new_n66_), .b(x00), .O(z16));
  nand2  g66(.a(z16), .b(new_n57_), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n108_), .O(z11));
