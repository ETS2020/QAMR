// Benchmark "FAU" written by ABC on Thu Jun 25 17:29:06 2020
...
module FAU ( 
  ...
  nor2   g19(.a(x10), .b(x07), .O(new_n54_));
  inv1   g20(.a(x09), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(x08), .c(x06), .O(new_n56_));
  or2    g22(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand2  g23(.a(x04), .b(new_n35_), .O(new_n58_));
  aoi21  g24(.a(new_n58_), .b(new_n43_), .c(new_n44_), .O(new_n59_));
  nand2  g25(.a(new_n51_), .b(x08), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(x09), .c(new_n59_), .O(new_n61_));
  nand3  g27(.a(new_n61_), .b(new_n57_), .c(x04), .O(z05));
  nor2   g28(.a(new_n59_), .b(new_n40_), .O(new_n63_));
  nand2  g29(.a(new_n56_), .b(x10), .O(new_n64_));
  inv1   g30(.a(x10), .O(new_n65_));
  inv1   g31(.a(new_n60_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand2  g34(.a(new_n65_), .b(new_n55_), .O(new_n69_));
  oai21  g35(.a(new_n69_), .b(new_n60_), .c(x11), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n66_), .c(new_n55_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n63_), .O(z07));
  nand2  g39(.a(new_n71_), .b(new_n55_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n60_), .c(x12), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n65_), .d(new_n55_), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n66_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n75_), .c(new_n63_), .O(z08));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n77_), .c(new_n76_), .d(new_n65_), .O(new_n83_));
  nand4  g49(.a(new_n55_), .b(x08), .c(x07), .d(x06), .O(new_n84_));
  ...
  oai21  g53(.a(new_n78_), .b(new_n60_), .c(x13), .O(new_n88_));
  ...
  nand2  g58(.a(new_n83_), .b(new_n92_), .O(new_n93_));
