...
module FAU ( 
  ...
  oai21  g31(.a(new_n41_), .b(new_n21_), .c(new_n50_), .O(new_n51_));
  nand2  g32(.a(new_n49_), .b(new_n40_), .O(new_n52_));
  oai22  g33(.a(new_n52_), .b(new_n33_), .c(new_n20_), .d(new_n28_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n24_), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n28_), .c(new_n29_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n54_), .c(new_n51_), .O(z3));
