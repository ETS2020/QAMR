// Benchmark "FAU" written by ABC on Thu Jun 25 17:18:50 2020
...
module FAU ( 
  ...
  oai21  g13(.a(x11), .b(new_n23_), .c(new_n32_), .O(new_n33_));
  ...
  nor2   g20(.a(x11), .b(x08), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n32_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n20_), .c(new_n21_), .O(new_n42_));
  inv1   g23(.a(x11), .O(new_n43_));
  aoi21  g24(.a(new_n24_), .b(new_n32_), .c(new_n43_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n40_), .b(new_n49_), .c(new_n32_), .O(new_n50_));
