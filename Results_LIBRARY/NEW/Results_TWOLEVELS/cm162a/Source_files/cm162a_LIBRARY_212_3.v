...
module FAU ( 
  ...
  aoi21  g23(.a(new_n42_), .b(x02), .c(new_n41_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n28_), .c(new_n40_), .O(new_n44_));
  oai22  g25(.a(new_n33_), .b(x11), .c(new_n20_), .d(new_n28_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n24_), .O(new_n46_));
  inv1   g27(.a(x04), .O(new_n47_));
  nand3  g28(.a(x11), .b(new_n47_), .c(x03), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n46_), .c(new_n44_), .d(x05), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n41_), .c(new_n32_), .d(new_n23_), .O(new_n51_));
