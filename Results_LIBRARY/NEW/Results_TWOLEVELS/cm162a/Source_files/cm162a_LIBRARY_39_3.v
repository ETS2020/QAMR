...
module FAU ( 
  ...
  aoi21  g23(.a(new_n42_), .b(new_n24_), .c(new_n39_), .O(new_n43_));
  ...
  nand4  g29(.a(new_n39_), .b(new_n38_), .c(new_n23_), .d(x04), .O(new_n49_));
  ...
  nand2  g34(.a(new_n53_), .b(new_n42_), .O(new_n54_));
  nand3  g35(.a(x13), .b(x09), .c(x03), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  inv1   g37(.a(x02), .O(new_n57_));
  nand3  g38(.a(x12), .b(x03), .c(new_n57_), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(x05), .O(new_n59_));
  aoi21  g40(.a(new_n56_), .b(new_n24_), .c(new_n59_), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(new_n52_), .O(z3));
