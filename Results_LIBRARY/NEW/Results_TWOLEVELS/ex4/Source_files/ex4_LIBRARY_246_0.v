// Benchmark "FAU" written by ABC on Fri Jun 26 05:08:25 2020
...
module FAU ( 
  ...
  nand2  g076(.a(x093), .b(x061), .O(new_n233_));
  oai22  g077(.a(new_n233_), .b(new_n232_), .c(x021), .d(x013), .O(new_n234_));
  inv1   g078(.a(x085), .O(new_n235_));
  inv1   g079(.a(x125), .O(new_n236_));
  and2   g080(.a(x117), .b(x021), .O(new_n237_));
  aoi21  g081(.a(new_n237_), .b(new_n236_), .c(new_n235_), .O(new_n238_));
  inv1   g082(.a(x037), .O(new_n239_));
  oai21  g083(.a(x125), .b(new_n228_), .c(new_n239_), .O(new_n240_));
  nand2  g084(.a(new_n240_), .b(new_n229_), .O(new_n241_));
  inv1   g085(.a(x061), .O(new_n242_));
  oai21  g086(.a(x101), .b(new_n242_), .c(x109), .O(new_n243_));
  nand2  g087(.a(new_n243_), .b(x037), .O(new_n244_));
  nand4  g088(.a(new_n244_), .b(new_n241_), .c(new_n238_), .d(new_n234_), .O(new_n245_));
  oai21  g089(.a(new_n245_), .b(new_n231_), .c(x077), .O(new_n246_));
  inv1   g090(.a(x021), .O(new_n247_));
  nand4  g091(.a(new_n236_), .b(x061), .c(x037), .d(new_n247_), .O(new_n248_));
  aoi21  g092(.a(new_n248_), .b(new_n246_), .c(new_n224_), .O(new_n249_));
  nor2   g093(.a(x085), .b(new_n239_), .O(new_n250_));
  nand2  g094(.a(new_n250_), .b(x013), .O(new_n251_));
  inv1   g095(.a(new_n251_), .O(new_n252_));
  oai21  g096(.a(new_n252_), .b(new_n249_), .c(new_n223_), .O(new_n253_));
  inv1   g097(.a(x093), .O(new_n254_));
  nand2  g098(.a(new_n254_), .b(new_n242_), .O(new_n255_));
  nand3  g099(.a(new_n255_), .b(x077), .c(new_n232_), .O(new_n256_));
  inv1   g100(.a(x013), .O(new_n257_));
  nor2   g101(.a(new_n247_), .b(new_n257_), .O(new_n258_));
  aoi21  g102(.a(new_n258_), .b(new_n256_), .c(new_n230_), .O(new_n259_));
  aoi21  g103(.a(new_n232_), .b(x021), .c(new_n233_), .O(new_n260_));
  oai21  g104(.a(x021), .b(x013), .c(new_n232_), .O(new_n261_));
  nand2  g105(.a(new_n255_), .b(new_n226_), .O(new_n262_));
  oai22  g106(.a(new_n262_), .b(new_n261_), .c(new_n260_), .d(x069), .O(new_n263_));
  aoi21  g107(.a(new_n263_), .b(x077), .c(new_n259_), .O(new_n264_));
  nand3  g108(.a(new_n261_), .b(x093), .c(x061), .O(new_n265_));
  nand3  g109(.a(new_n265_), .b(x077), .c(new_n239_), .O(new_n266_));
  oai21  g110(.a(new_n264_), .b(new_n224_), .c(new_n266_), .O(new_n267_));
  nand2  g111(.a(new_n239_), .b(new_n257_), .O(new_n268_));
  nand3  g112(.a(new_n268_), .b(new_n225_), .c(new_n247_), .O(new_n269_));
  inv1   g113(.a(x077), .O(new_n270_));
  aoi22  g114(.a(new_n270_), .b(new_n257_), .c(new_n224_), .d(new_n239_), .O(new_n271_));
  nand2  g115(.a(new_n271_), .b(new_n269_), .O(new_n272_));
  aoi21  g116(.a(new_n267_), .b(x085), .c(new_n272_), .O(new_n273_));
  ...
  aoi22  g248(.a(new_n254_), .b(new_n225_), .c(new_n242_), .d(new_n239_), .O(new_n406_));
  nor2   g249(.a(new_n232_), .b(x013), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n233_), .c(new_n235_), .O(new_n408_));
  oai21  g251(.a(new_n406_), .b(new_n223_), .c(new_n408_), .O(new_n409_));
  oai21  g252(.a(x125), .b(x101), .c(new_n409_), .O(new_n410_));
  oai21  g253(.a(new_n232_), .b(x013), .c(new_n235_), .O(new_n411_));
  aoi21  g254(.a(new_n229_), .b(new_n228_), .c(x085), .O(new_n412_));
  aoi21  g255(.a(new_n411_), .b(x005), .c(new_n412_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n410_), .c(x053), .O(new_n414_));
  nand3  g257(.a(new_n224_), .b(new_n257_), .c(x005), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(new_n250_), .c(new_n255_), .O(new_n417_));
  aoi22  g260(.a(new_n407_), .b(new_n250_), .c(x069), .d(new_n239_), .O(new_n418_));
  nand2  g261(.a(new_n418_), .b(new_n417_), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(new_n414_), .c(new_n270_), .O(new_n420_));
  nand3  g263(.a(x069), .b(new_n224_), .c(x021), .O(new_n421_));
  nand3  g264(.a(x085), .b(new_n239_), .c(x005), .O(new_n422_));
  nand2  g265(.a(new_n422_), .b(new_n421_), .O(new_n423_));
  oai22  g266(.a(new_n270_), .b(new_n257_), .c(new_n224_), .d(new_n239_), .O(new_n424_));
  aoi21  g267(.a(new_n423_), .b(new_n257_), .c(new_n424_), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n420_), .c(x045), .O(z13));
