...
module FAU ( 
  ...
  and2   g084(.a(x109), .b(x021), .O(new_n241_));
  aoi21  g085(.a(new_n241_), .b(new_n240_), .c(new_n239_), .O(new_n242_));
  inv1   g086(.a(x037), .O(new_n243_));
  oai21  g087(.a(x125), .b(new_n230_), .c(new_n243_), .O(new_n244_));
  nand2  g088(.a(new_n244_), .b(new_n229_), .O(new_n245_));
  inv1   g089(.a(x061), .O(new_n246_));
  oai21  g090(.a(x101), .b(new_n246_), .c(x117), .O(new_n247_));
