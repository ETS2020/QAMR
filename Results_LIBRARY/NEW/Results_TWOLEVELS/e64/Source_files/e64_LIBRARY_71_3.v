// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:32 2020
...
module FAU ( 
  ...
  nand3  g141(.a(new_n133_), .b(new_n132_), .c(new_n186_), .O(new_n272_));
  ...
  nand3  g270(.a(new_n183_), .b(new_n131_), .c(new_n186_), .O(new_n401_));
  nand2  g271(.a(new_n253_), .b(new_n187_), .O(new_n402_));
  ...
  nand3  g358(.a(new_n187_), .b(new_n186_), .c(x52), .O(new_n489_));
  ...
  nand3  g369(.a(new_n149_), .b(new_n296_), .c(new_n445_), .O(new_n500_));
  nor2   g370(.a(new_n500_), .b(new_n246_), .O(new_n501_));
  nand4  g371(.a(new_n501_), .b(new_n499_), .c(new_n440_), .d(new_n433_), .O(new_n502_));
  nor2   g372(.a(new_n502_), .b(new_n432_), .O(z31));
  ...
  nor4   g377(.a(new_n430_), .b(new_n290_), .c(new_n287_), .d(new_n181_), .O(z34));
  nand2  g378(.a(new_n360_), .b(new_n144_), .O(new_n509_));
  inv1   g379(.a(new_n509_), .O(new_n510_));
  nand2  g380(.a(new_n187_), .b(new_n183_), .O(new_n511_));
  inv1   g381(.a(new_n511_), .O(new_n512_));
  nand4  g382(.a(new_n512_), .b(new_n510_), .c(new_n421_), .d(new_n196_), .O(new_n513_));
  ...
  nand2  g392(.a(new_n196_), .b(new_n187_), .O(new_n523_));
  nor3   g393(.a(new_n523_), .b(new_n519_), .c(new_n422_), .O(new_n524_));
  nand3  g394(.a(new_n360_), .b(new_n192_), .c(x61), .O(new_n525_));
  nor3   g395(.a(new_n525_), .b(x56), .c(x55), .O(new_n526_));
  nand4  g396(.a(new_n526_), .b(new_n524_), .c(new_n415_), .d(new_n413_), .O(new_n527_));
  inv1   g397(.a(new_n527_), .O(z36));
  nand3  g398(.a(new_n444_), .b(new_n250_), .c(new_n160_), .O(new_n529_));
  nor2   g399(.a(new_n529_), .b(new_n302_), .O(new_n530_));
  nor3   g400(.a(new_n491_), .b(x20), .c(new_n223_), .O(new_n531_));
  nand2  g401(.a(new_n249_), .b(new_n148_), .O(new_n532_));
  nor2   g402(.a(new_n532_), .b(new_n155_), .O(new_n533_));
  nand4  g403(.a(new_n533_), .b(new_n531_), .c(new_n530_), .d(new_n295_), .O(new_n534_));
  ...
  nand4  g412(.a(new_n542_), .b(new_n540_), .c(new_n537_), .d(new_n376_), .O(new_n543_));
  inv1   g413(.a(new_n361_), .O(new_n544_));
  ...
  nor2   g419(.a(x43), .b(new_n314_), .O(new_n550_));
  ...
  nand3  g425(.a(new_n393_), .b(new_n261_), .c(new_n255_), .O(new_n556_));
  ...
  nand4  g438(.a(new_n568_), .b(new_n566_), .c(new_n329_), .d(new_n146_), .O(new_n569_));
  ...
  nand4  g457(.a(new_n587_), .b(new_n252_), .c(new_n158_), .d(new_n300_), .O(new_n588_));
  ...
  nand4  g465(.a(new_n595_), .b(new_n594_), .c(new_n444_), .d(new_n160_), .O(new_n596_));
  nor2   g466(.a(new_n596_), .b(new_n563_), .O(z45));
  inv1   g467(.a(new_n397_), .O(new_n598_));
  nand4  g468(.a(new_n568_), .b(new_n598_), .c(new_n329_), .d(new_n146_), .O(new_n599_));
  ...
  nand2  g475(.a(new_n537_), .b(new_n376_), .O(new_n606_));
  nand3  g476(.a(new_n387_), .b(new_n390_), .c(x17), .O(new_n607_));
  nor2   g477(.a(new_n607_), .b(new_n435_), .O(new_n608_));
  inv1   g478(.a(x35), .O(new_n609_));
  nand3  g479(.a(new_n377_), .b(new_n296_), .c(new_n609_), .O(new_n610_));
  ...
  nor2   g496(.a(new_n626_), .b(new_n298_), .O(new_n627_));
  nor3   g497(.a(new_n600_), .b(x14), .c(new_n202_), .O(new_n628_));
  nor2   g498(.a(new_n498_), .b(new_n246_), .O(new_n629_));
  nand4  g499(.a(new_n629_), .b(new_n628_), .c(new_n627_), .d(new_n303_), .O(new_n630_));
  ...
  nor3   g505(.a(new_n361_), .b(x56), .c(new_n132_), .O(new_n636_));
  nand4  g506(.a(new_n636_), .b(new_n524_), .c(new_n415_), .d(new_n413_), .O(new_n637_));
  inv1   g507(.a(new_n637_), .O(z54));
  nor2   g508(.a(x37), .b(new_n609_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n545_), .c(new_n423_), .d(new_n326_), .O(new_n640_));
  nor2   g510(.a(new_n640_), .b(new_n416_), .O(z55));
  nand3  g511(.a(new_n220_), .b(x20), .c(new_n389_), .O(new_n642_));
  nor2   g512(.a(new_n642_), .b(new_n491_), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n464_), .c(new_n273_), .d(new_n156_), .O(new_n644_));
  nor2   g514(.a(new_n644_), .b(new_n443_), .O(z56));
  nand4  g515(.a(new_n376_), .b(new_n339_), .c(new_n203_), .d(new_n165_), .O(new_n646_));
  nand3  g516(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n647_));
  nor4   g517(.a(new_n647_), .b(new_n646_), .c(new_n330_), .d(new_n155_), .O(z57));
  inv1   g518(.a(new_n363_), .O(new_n649_));
  nand3  g519(.a(new_n423_), .b(new_n649_), .c(new_n544_), .O(new_n650_));
  nand3  g520(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n651_));
  nor4   g521(.a(new_n651_), .b(new_n650_), .c(new_n646_), .d(new_n424_), .O(z58));
  nor4   g522(.a(new_n483_), .b(new_n349_), .c(x43), .d(new_n313_), .O(z59));
  nor3   g523(.a(new_n375_), .b(x08), .c(new_n210_), .O(new_n654_));
  nand2  g524(.a(new_n133_), .b(new_n190_), .O(new_n655_));
  nor2   g525(.a(new_n655_), .b(new_n328_), .O(new_n656_));
  nand3  g526(.a(new_n656_), .b(new_n654_), .c(new_n381_), .O(new_n657_));
  inv1   g527(.a(new_n657_), .O(z60));
  nor2   g528(.a(x10), .b(new_n203_), .O(new_n659_));
  nand4  g529(.a(new_n659_), .b(new_n370_), .c(new_n337_), .d(new_n175_), .O(new_n660_));
  nand3  g530(.a(new_n360_), .b(new_n362_), .c(new_n347_), .O(new_n661_));
  nand2  g531(.a(new_n355_), .b(new_n196_), .O(new_n662_));
  nand2  g532(.a(new_n160_), .b(new_n154_), .O(new_n663_));
  nor4   g533(.a(new_n663_), .b(new_n662_), .c(new_n661_), .d(new_n660_), .O(z61));
  nor2   g534(.a(new_n380_), .b(new_n375_), .O(new_n665_));
  nand2  g535(.a(new_n347_), .b(x47), .O(new_n666_));
  nor2   g536(.a(new_n666_), .b(new_n655_), .O(new_n667_));
  nand4  g537(.a(new_n667_), .b(new_n665_), .c(new_n481_), .d(new_n377_), .O(new_n668_));
  inv1   g538(.a(new_n668_), .O(z62));
  nand4  g539(.a(new_n190_), .b(new_n181_), .c(x56), .d(new_n347_), .O(new_n670_));
  inv1   g540(.a(new_n670_), .O(new_n671_));
  nand4  g541(.a(new_n671_), .b(new_n665_), .c(new_n481_), .d(new_n377_), .O(new_n672_));
  inv1   g542(.a(new_n672_), .O(z63));
  nor2   g543(.a(new_n483_), .b(x60), .O(new_n674_));
  nand4  g544(.a(new_n674_), .b(new_n481_), .c(new_n288_), .d(x30), .O(new_n675_));
  nor3   g545(.a(new_n675_), .b(new_n380_), .c(new_n375_), .O(z64));
