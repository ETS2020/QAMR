// Benchmark "FAU" written by ABC on Thu Jun 25 18:55:24 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n655_, new_n657_, new_n658_, new_n659_, new_n660_, new_n663_,
  ...
  nor2   g494(.a(x58), .b(x53), .O(new_n625_));
  inv1   g495(.a(x49), .O(new_n626_));
  nand3  g496(.a(new_n358_), .b(new_n626_), .c(x48), .O(new_n627_));
  inv1   g497(.a(new_n627_), .O(new_n628_));
  nand4  g498(.a(new_n628_), .b(new_n625_), .c(new_n147_), .d(new_n131_), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(new_n572_), .O(z51));
  nand3  g500(.a(new_n176_), .b(new_n217_), .c(x12), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(new_n174_), .O(new_n632_));
  nand4  g502(.a(new_n632_), .b(new_n586_), .c(new_n321_), .d(new_n156_), .O(new_n633_));
  nor2   g503(.a(new_n434_), .b(new_n268_), .O(new_n634_));
  nand4  g504(.a(new_n634_), .b(new_n304_), .c(new_n303_), .d(new_n382_), .O(new_n635_));
  nor2   g505(.a(new_n635_), .b(new_n633_), .O(z52));
  nand2  g506(.a(new_n264_), .b(x63), .O(new_n637_));
  nor2   g507(.a(new_n637_), .b(new_n404_), .O(z53));
  nor3   g508(.a(new_n357_), .b(x56), .c(new_n488_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n527_), .c(new_n413_), .d(new_n411_), .O(new_n640_));
  inv1   g510(.a(new_n640_), .O(z54));
  nor2   g511(.a(x37), .b(new_n593_), .O(new_n642_));
  nand4  g512(.a(new_n642_), .b(new_n547_), .c(new_n423_), .d(new_n324_), .O(new_n643_));
  nor2   g513(.a(new_n643_), .b(new_n414_), .O(z55));
  nand2  g514(.a(new_n497_), .b(new_n566_), .O(new_n645_));
  nand2  g515(.a(new_n577_), .b(new_n301_), .O(new_n646_));
  nor2   g516(.a(new_n646_), .b(new_n645_), .O(new_n647_));
  nand3  g517(.a(new_n223_), .b(x20), .c(new_n385_), .O(new_n648_));
  nor3   g518(.a(new_n648_), .b(x18), .c(x16), .O(new_n649_));
  nor2   g519(.a(new_n492_), .b(new_n241_), .O(new_n650_));
  nand4  g520(.a(new_n650_), .b(new_n649_), .c(new_n647_), .d(new_n269_), .O(new_n651_));
  nor2   g521(.a(new_n651_), .b(new_n439_), .O(z56));
  nand4  g522(.a(new_n372_), .b(new_n337_), .c(new_n201_), .d(new_n165_), .O(new_n653_));
  inv1   g523(.a(x22), .O(new_n654_));
  nand3  g524(.a(new_n173_), .b(new_n654_), .c(x18), .O(new_n655_));
  nor4   g525(.a(new_n655_), .b(new_n653_), .c(new_n328_), .d(new_n155_), .O(z57));
  nand2  g526(.a(new_n373_), .b(new_n307_), .O(new_n657_));
  inv1   g527(.a(new_n359_), .O(new_n658_));
  nand3  g528(.a(new_n423_), .b(new_n658_), .c(new_n415_), .O(new_n659_));
  nand3  g529(.a(new_n228_), .b(new_n227_), .c(x22), .O(new_n660_));
  nor4   g530(.a(new_n660_), .b(new_n659_), .c(new_n653_), .d(new_n657_), .O(z58));
  nor4   g531(.a(new_n482_), .b(new_n346_), .c(x43), .d(new_n311_), .O(z59));
  nor3   g532(.a(new_n371_), .b(x08), .c(new_n208_), .O(new_n663_));
  nand2  g533(.a(new_n132_), .b(new_n322_), .O(new_n664_));
  nor2   g534(.a(new_n664_), .b(new_n326_), .O(new_n665_));
  nand3  g535(.a(new_n665_), .b(new_n663_), .c(new_n377_), .O(new_n666_));
  inv1   g536(.a(new_n666_), .O(z60));
  nor2   g537(.a(x10), .b(new_n201_), .O(new_n668_));
  nand4  g538(.a(new_n668_), .b(new_n366_), .c(new_n335_), .d(new_n175_), .O(new_n669_));
  nand2  g539(.a(new_n358_), .b(new_n266_), .O(new_n670_));
  nand2  g540(.a(new_n352_), .b(new_n194_), .O(new_n671_));
  nand2  g541(.a(new_n160_), .b(new_n154_), .O(new_n672_));
  nor4   g542(.a(new_n672_), .b(new_n671_), .c(new_n670_), .d(new_n669_), .O(z61));
  nor2   g543(.a(new_n376_), .b(new_n371_), .O(new_n674_));
  nand2  g544(.a(new_n274_), .b(x47), .O(new_n675_));
  nor2   g545(.a(new_n675_), .b(new_n664_), .O(new_n676_));
  nand4  g546(.a(new_n676_), .b(new_n674_), .c(new_n479_), .d(new_n373_), .O(new_n677_));
  inv1   g547(.a(new_n677_), .O(z62));
  nand4  g548(.a(new_n322_), .b(new_n481_), .c(x56), .d(new_n274_), .O(new_n679_));
  inv1   g549(.a(new_n679_), .O(new_n680_));
  nand4  g550(.a(new_n680_), .b(new_n674_), .c(new_n479_), .d(new_n373_), .O(new_n681_));
  inv1   g551(.a(new_n681_), .O(z63));
  nor2   g552(.a(new_n482_), .b(x60), .O(new_n683_));
  nand4  g553(.a(new_n683_), .b(new_n479_), .c(new_n281_), .d(x30), .O(new_n684_));
  nor3   g554(.a(new_n684_), .b(new_n376_), .c(new_n371_), .O(z64));
