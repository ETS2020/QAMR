...
module FAU ( 
  ...
  nand2  g357(.a(new_n379_), .b(new_n290_), .O(new_n488_));
  or2    g358(.a(new_n488_), .b(new_n350_), .O(new_n489_));
  nand3  g359(.a(new_n458_), .b(x60), .c(new_n181_), .O(new_n490_));
  ...
  nand4  g366(.a(new_n379_), .b(new_n262_), .c(new_n149_), .d(new_n148_), .O(new_n497_));
  ...
  nand4  g375(.a(new_n505_), .b(new_n503_), .c(new_n501_), .d(new_n399_), .O(new_n506_));
  ...
  nor4   g381(.a(new_n431_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  nand2  g382(.a(new_n361_), .b(new_n144_), .O(new_n513_));
  ...
  nor2   g389(.a(new_n376_), .b(new_n174_), .O(new_n520_));
  ...
  nor4   g526(.a(new_n486_), .b(new_n350_), .c(x43), .d(new_n314_), .O(z59));
  nor3   g527(.a(new_n376_), .b(x08), .c(new_n210_), .O(new_n658_));
  nor3   g528(.a(new_n329_), .b(new_n383_), .c(x60), .O(new_n659_));
  nand3  g529(.a(new_n659_), .b(new_n658_), .c(new_n382_), .O(new_n660_));
  ...
  nand4  g534(.a(new_n356_), .b(new_n196_), .c(new_n160_), .d(new_n154_), .O(new_n665_));
  nor3   g535(.a(new_n665_), .b(new_n664_), .c(new_n663_), .O(z61));
  nand3  g536(.a(new_n377_), .b(new_n264_), .c(new_n173_), .O(new_n667_));
  or2    g537(.a(new_n667_), .b(x30), .O(new_n668_));
  inv1   g538(.a(new_n459_), .O(new_n669_));
  nand3  g539(.a(new_n356_), .b(new_n363_), .c(x47), .O(new_n670_));
  inv1   g540(.a(new_n670_), .O(new_n671_));
  nand3  g541(.a(new_n671_), .b(new_n669_), .c(new_n160_), .O(new_n672_));
  nor2   g542(.a(new_n672_), .b(new_n668_), .O(z62));
  nand4  g543(.a(new_n485_), .b(new_n483_), .c(new_n190_), .d(x56), .O(new_n674_));
  nor2   g544(.a(new_n674_), .b(new_n668_), .O(z63));
  nand3  g545(.a(new_n483_), .b(new_n289_), .c(x30), .O(new_n676_));
  nor4   g546(.a(new_n676_), .b(new_n667_), .c(new_n486_), .d(x60), .O(z64));
