...
module FAU ( 
  ...
  nand4  g436(.a(new_n297_), .b(new_n520_), .c(new_n566_), .d(x33), .O(new_n567_));
  nor2   g437(.a(new_n567_), .b(new_n299_), .O(new_n568_));
  nor3   g438(.a(new_n525_), .b(new_n193_), .c(new_n184_), .O(new_n569_));
  ...
  nand4  g465(.a(new_n595_), .b(new_n569_), .c(new_n445_), .d(new_n160_), .O(new_n596_));
  nor2   g466(.a(new_n596_), .b(new_n565_), .O(z45));
  nor2   g467(.a(new_n398_), .b(new_n329_), .O(new_n598_));
  nor2   g468(.a(x55), .b(x51), .O(new_n599_));
  nand4  g469(.a(new_n599_), .b(new_n598_), .c(new_n146_), .d(new_n133_), .O(new_n600_));
  ...
  nand3  g481(.a(new_n611_), .b(new_n609_), .c(new_n569_), .O(new_n612_));
  ...
  nand4  g493(.a(new_n579_), .b(new_n189_), .c(new_n574_), .d(x48), .O(new_n624_));
  nor2   g494(.a(new_n624_), .b(new_n572_), .O(z51));
