...
module FAU ( 
  ...
  nand3  g113(.a(new_n243_), .b(new_n144_), .c(new_n240_), .O(new_n244_));
  ...
  nand3  g140(.a(new_n270_), .b(new_n240_), .c(new_n192_), .O(new_n271_));
  ...
  nand2  g153(.a(new_n254_), .b(new_n196_), .O(new_n284_));
  ...
  nand3  g167(.a(new_n144_), .b(new_n270_), .c(new_n240_), .O(new_n298_));
  nor3   g168(.a(new_n298_), .b(new_n242_), .c(new_n237_), .O(new_n299_));
  ...
  inv1   g173(.a(new_n255_), .O(new_n304_));
  ...
  nor2   g177(.a(new_n307_), .b(new_n269_), .O(z08));
  ...
  nand3  g181(.a(new_n266_), .b(x29), .c(new_n152_), .O(new_n312_));
  ...
  nand4  g221(.a(new_n351_), .b(new_n265_), .c(new_n291_), .d(new_n288_), .O(new_n352_));
  ...
  nor2   g279(.a(new_n409_), .b(new_n270_), .O(z19));
  ...
  nor2   g312(.a(new_n302_), .b(new_n255_), .O(new_n443_));
  ...
  nand4  g335(.a(new_n381_), .b(new_n318_), .c(new_n263_), .d(new_n256_), .O(new_n466_));
  ...
  nand2  g346(.a(new_n476_), .b(new_n243_), .O(new_n477_));
  ...
  nand2  g368(.a(new_n318_), .b(new_n256_), .O(new_n499_));
  ...
  nor2   g373(.a(new_n298_), .b(new_n242_), .O(new_n504_));
  ...
  nand2  g377(.a(new_n263_), .b(new_n149_), .O(new_n508_));
  ...
  nand3  g406(.a(new_n447_), .b(new_n251_), .c(new_n160_), .O(new_n537_));
  nor2   g407(.a(new_n537_), .b(new_n305_), .O(new_n538_));
  nor3   g408(.a(new_n497_), .b(x20), .c(new_n223_), .O(new_n539_));
  nand2  g409(.a(new_n250_), .b(new_n148_), .O(new_n540_));
  ...
  nand4  g465(.a(new_n595_), .b(new_n253_), .c(new_n158_), .d(new_n235_), .O(new_n596_));
  ...
  nor2   g506(.a(new_n506_), .b(new_n247_), .O(new_n637_));
  ...
  nand2  g511(.a(new_n270_), .b(x63), .O(new_n642_));
