...
module FAU ( 
  ...
  nand4  g136(.a(new_n149_), .b(new_n125_), .c(new_n114_), .d(new_n104_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n164_), .b(new_n132_), .c(new_n186_), .d(new_n171_), .O(new_n199_));
  ...
  nand4  g159(.a(new_n203_), .b(new_n175_), .c(new_n152_), .d(new_n125_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n128_), .c(new_n53_), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n64_), .c(new_n210_), .O(new_n213_));
  nand3  g162(.a(new_n203_), .b(new_n175_), .c(new_n210_), .O(new_n214_));
  nor3   g163(.a(new_n214_), .b(new_n202_), .c(new_n108_), .O(new_n215_));
