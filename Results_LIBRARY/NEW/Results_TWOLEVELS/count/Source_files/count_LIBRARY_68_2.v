...
module FAU ( 
  ...
  nand2  g065(.a(new_n76_), .b(new_n55_), .O(new_n117_));
  ...
  nand2  g070(.a(new_n98_), .b(new_n97_), .O(new_n122_));
  inv1   g071(.a(x26), .O(new_n123_));
  inv1   g072(.a(x27), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n123_), .c(new_n99_), .O(new_n125_));
  ...
  nand3  g078(.a(x27), .b(x20), .c(x16), .O(new_n130_));
  inv1   g079(.a(x07), .O(new_n131_));
  aoi21  g080(.a(new_n58_), .b(new_n131_), .c(x18), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(z08));
  nand3  g082(.a(new_n126_), .b(new_n76_), .c(new_n63_), .O(new_n134_));
  nor2   g083(.a(x28), .b(x27), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n107_), .c(new_n123_), .d(new_n97_), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n81_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n150_), .b(new_n135_), .c(new_n118_), .d(new_n98_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n88_), .O(new_n152_));
  ...
  oai21  g105(.a(new_n151_), .b(new_n88_), .c(x31), .O(new_n157_));
  nor2   g106(.a(x27), .b(x26), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nor2   g108(.a(x31), .b(x30), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n99_), .O(new_n161_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n90_), .c(x32), .O(new_n169_));
  nor2   g118(.a(x32), .b(x31), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n150_), .c(new_n135_), .d(new_n118_), .O(new_n171_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n160_), .c(new_n159_), .d(new_n158_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n101_), .O(new_n183_));
  ...
  nand2  g138(.a(new_n159_), .b(new_n158_), .O(new_n190_));
  ...
  nand3  g148(.a(new_n199_), .b(new_n191_), .c(new_n101_), .O(new_n200_));
