...
module FAU ( 
  ...
  nand3  g110(.a(new_n89_), .b(new_n76_), .c(new_n55_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n161_), .c(x32), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n126_), .d(new_n142_), .O(new_n165_));
  ...
  oai21  g119(.a(x16), .b(x02), .c(new_n170_), .O(new_n171_));
  aoi21  g120(.a(x32), .b(x20), .c(new_n171_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n169_), .O(z13));
  oai21  g122(.a(new_n165_), .b(new_n90_), .c(x33), .O(new_n174_));
  nor2   g123(.a(x33), .b(x32), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n152_), .c(new_n151_), .d(new_n117_), .O(new_n176_));
  ...
  nand2  g133(.a(new_n151_), .b(new_n117_), .O(new_n185_));
