...
module FAU ( 
  ...
  oai21  g046(.a(new_n90_), .b(x19), .c(new_n64_), .O(new_n98_));
  ...
  aoi21  g052(.a(new_n98_), .b(x24), .c(new_n103_), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n58_), .c(new_n97_), .O(z05));
  inv1   g054(.a(x25), .O(new_n106_));
  nand2  g055(.a(new_n100_), .b(new_n53_), .O(new_n107_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n99_), .c(new_n106_), .O(new_n135_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n109_), .c(new_n88_), .d(new_n87_), .O(new_n142_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(new_n99_), .d(new_n77_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n129_), .b(new_n99_), .c(new_n77_), .O(new_n163_));
  ...
  nor2   g127(.a(new_n178_), .b(new_n102_), .O(new_n179_));
