...
module FAU ( 
  ...
  aoi21  g063(.a(x26), .b(x20), .c(new_n114_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n112_), .O(z07));
  nor2   g065(.a(x27), .b(x26), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n89_), .c(new_n100_), .O(new_n118_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n109_), .c(new_n82_), .d(new_n63_), .O(new_n137_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n124_), .c(new_n91_), .d(new_n63_), .O(new_n156_));
  ...
  nand4  g110(.a(new_n153_), .b(new_n152_), .c(new_n117_), .d(new_n100_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n96_), .c(x32), .O(new_n163_));
  nand2  g112(.a(new_n144_), .b(new_n127_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nor2   g114(.a(x32), .b(x31), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n143_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n165_), .c(new_n91_), .d(new_n63_), .O(new_n169_));
  ...
  nand4  g123(.a(new_n166_), .b(new_n144_), .c(new_n127_), .d(new_n143_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n96_), .c(x33), .O(new_n176_));
  nor2   g125(.a(x33), .b(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n153_), .c(new_n152_), .d(new_n117_), .O(new_n178_));
  ...
  nor2   g134(.a(x21), .b(x20), .O(new_n186_));
  nand4  g135(.a(new_n126_), .b(new_n87_), .c(new_n186_), .d(new_n55_), .O(new_n187_));
  oai21  g136(.a(new_n178_), .b(new_n187_), .c(x34), .O(new_n188_));
  nand2  g137(.a(new_n152_), .b(new_n117_), .O(new_n189_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n190_), .c(new_n102_), .O(new_n199_));
