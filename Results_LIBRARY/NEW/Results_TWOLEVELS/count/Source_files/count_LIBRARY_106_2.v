...
module FAU ( 
  ...
  nand4  g055(.a(new_n106_), .b(new_n82_), .c(new_n71_), .d(new_n105_), .O(new_n107_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n106_), .c(new_n129_), .d(new_n105_), .O(new_n131_));
  ...
  nand2  g085(.a(new_n54_), .b(new_n53_), .O(new_n137_));
  nor2   g086(.a(x27), .b(x26), .O(new_n138_));
  nor3   g087(.a(x30), .b(x29), .c(x28), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n121_), .c(new_n138_), .d(new_n76_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n61_), .c(new_n137_), .O(new_n141_));
  inv1   g090(.a(x30), .O(new_n142_));
  inv1   g091(.a(new_n131_), .O(new_n143_));
  nand2  g092(.a(new_n82_), .b(new_n69_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n137_), .O(new_n145_));
  ...
  nor2   g099(.a(new_n137_), .b(x21), .O(new_n151_));
  nor3   g100(.a(x24), .b(x23), .c(x22), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n151_), .c(new_n139_), .d(new_n113_), .O(new_n153_));
  inv1   g102(.a(x22), .O(new_n154_));
  nand4  g103(.a(new_n89_), .b(new_n52_), .c(new_n154_), .d(new_n69_), .O(new_n155_));
  inv1   g104(.a(x25), .O(new_n156_));
  nor2   g105(.a(x31), .b(x30), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n130_), .c(new_n138_), .d(new_n156_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  aoi21  g108(.a(new_n153_), .b(x31), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g113(.a(new_n97_), .b(new_n82_), .c(new_n52_), .d(new_n69_), .O(new_n165_));
  ...
  oai21  g119(.a(new_n170_), .b(new_n165_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g124(.a(new_n170_), .b(new_n165_), .c(x33), .O(new_n176_));
  nor2   g125(.a(x33), .b(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n157_), .c(new_n130_), .d(new_n138_), .O(new_n178_));
  ...
  oai21  g132(.a(new_n178_), .b(new_n165_), .c(x34), .O(new_n184_));
  nand2  g133(.a(new_n169_), .b(new_n168_), .O(new_n185_));
  nand2  g134(.a(new_n167_), .b(new_n106_), .O(new_n186_));
  ...
  nor2   g138(.a(new_n189_), .b(new_n90_), .O(new_n190_));
