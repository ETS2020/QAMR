...
module FAU ( 
  ...
  oai21  g121(.a(new_n168_), .b(x31), .c(x16), .O(new_n173_));
  ...
  nand3  g126(.a(new_n166_), .b(new_n134_), .c(new_n141_), .O(new_n178_));
  ...
  nand4  g139(.a(new_n181_), .b(new_n144_), .c(new_n151_), .d(new_n116_), .O(new_n191_));
