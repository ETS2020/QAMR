...
module FAU ( 
  ...
  nand2  g009(.a(new_n55_), .b(x16), .O(new_n61_));
  inv1   g010(.a(x14), .O(new_n62_));
  aoi21  g011(.a(new_n58_), .b(new_n62_), .c(x18), .O(new_n63_));
  ...
  nand3  g033(.a(new_n80_), .b(new_n55_), .c(new_n65_), .O(new_n85_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n80_), .c(new_n55_), .d(new_n65_), .O(new_n94_));
  ...
  nand4  g092(.a(new_n110_), .b(new_n55_), .c(new_n73_), .d(new_n65_), .O(new_n144_));
