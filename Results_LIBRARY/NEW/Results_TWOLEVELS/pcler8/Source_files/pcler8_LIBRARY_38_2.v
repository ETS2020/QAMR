...
module FAU ( 
  ...
  nand4  g66(.a(new_n110_), .b(new_n87_), .c(x23), .d(x22), .O(new_n111_));
  inv1   g67(.a(x24), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(x21), .O(new_n113_));
  aoi21  g69(.a(new_n111_), .b(x21), .c(new_n113_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n76_), .c(new_n67_), .O(z14));
  ...
  nand3  g79(.a(x25), .b(x23), .c(new_n123_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n104_), .c(x26), .O(new_n125_));
