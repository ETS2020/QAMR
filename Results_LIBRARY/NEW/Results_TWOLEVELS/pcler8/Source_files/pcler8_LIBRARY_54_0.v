...
module FAU ( 
  ...
  nand2  g65(.a(new_n73_), .b(new_n102_), .O(new_n110_));
  nor2   g66(.a(new_n110_), .b(new_n88_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n109_), .c(new_n77_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n64_), .O(z13));
  nand2  g69(.a(new_n105_), .b(x16), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n96_), .c(new_n46_), .O(new_n115_));
  nor3   g71(.a(new_n95_), .b(new_n45_), .c(x24), .O(new_n116_));
  aoi21  g72(.a(new_n115_), .b(x24), .c(new_n116_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n76_), .c(new_n66_), .O(z14));
  nand2  g74(.a(x26), .b(x17), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(new_n96_), .c(new_n46_), .d(x24), .O(new_n120_));
  nand4  g76(.a(new_n103_), .b(x24), .c(x23), .d(x22), .O(new_n121_));
  nor2   g77(.a(new_n121_), .b(new_n95_), .O(new_n122_));
  aoi21  g78(.a(new_n120_), .b(x25), .c(new_n122_), .O(new_n123_));
  oai22  g79(.a(new_n123_), .b(new_n76_), .c(new_n56_), .d(new_n68_), .O(z15));
  ...
  nor2   g84(.a(x26), .b(new_n103_), .O(new_n129_));
  nand4  g85(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n130_));
  inv1   g86(.a(new_n130_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n129_), .c(new_n73_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n128_), .c(x08), .O(new_n133_));
  nor2   g89(.a(new_n104_), .b(x21), .O(new_n134_));
