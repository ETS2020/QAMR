...
module FAU ( 
  ...
  nand3  g02(.a(new_n46_), .b(x26), .c(x24), .O(new_n47_));
  ...
  nand3  g35(.a(x26), .b(x24), .c(x23), .O(new_n80_));
  ...
  nand4  g49(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n94_));
  ...
  nand3  g58(.a(x26), .b(x24), .c(x15), .O(new_n103_));
  ...
  nand2  g62(.a(x22), .b(x21), .O(new_n107_));
  nor3   g63(.a(new_n89_), .b(new_n107_), .c(x23), .O(new_n108_));
  ...
  nand2  g68(.a(x26), .b(x16), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n46_), .O(new_n114_));
  nor3   g70(.a(new_n111_), .b(new_n45_), .c(x24), .O(new_n115_));
  aoi21  g71(.a(new_n114_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n76_), .c(new_n67_), .O(z14));
  nand3  g73(.a(x24), .b(x23), .c(x22), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n111_), .c(x25), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n112_), .b(new_n46_), .c(new_n120_), .d(x24), .O(new_n121_));
  nand2  g77(.a(x26), .b(x17), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n121_), .c(new_n119_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n77_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n69_), .O(z15));
  inv1   g81(.a(x26), .O(new_n126_));
  nor2   g82(.a(new_n107_), .b(x18), .O(new_n127_));
  nand4  g83(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n128_));
  inv1   g84(.a(new_n128_), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n127_), .c(new_n126_), .O(new_n130_));
  nand4  g86(.a(new_n126_), .b(x25), .c(x22), .d(x21), .O(new_n131_));
  nor2   g87(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n130_), .c(new_n77_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n71_), .O(z16));
endmodule
