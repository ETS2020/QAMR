...
module FAU ( 
  ...
  nor3   g65(.a(new_n88_), .b(new_n109_), .c(x23), .O(new_n110_));
  ...
  nand4  g84(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  and2   g86(.a(x24), .b(x23), .O(new_n131_));
  inv1   g87(.a(new_n109_), .O(new_n132_));
  nor2   g88(.a(x26), .b(new_n122_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n89_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n103_), .O(new_n136_));
