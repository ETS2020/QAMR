...
module FAU ( 
  ...
  oai21  g42(.a(new_n86_), .b(new_n85_), .c(x21), .O(new_n87_));
  nand2  g43(.a(x20), .b(x19), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(new_n89_));
  and2   g45(.a(new_n88_), .b(x21), .O(new_n90_));
  aoi21  g46(.a(new_n89_), .b(new_n87_), .c(new_n90_), .O(new_n91_));
  ...
  oai21  g51(.a(new_n93_), .b(new_n86_), .c(new_n95_), .O(new_n96_));
  ...
  aoi22  g63(.a(new_n107_), .b(new_n89_), .c(new_n105_), .d(x23), .O(new_n108_));
  ...
  nor3   g69(.a(new_n111_), .b(new_n85_), .c(x24), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n78_), .c(new_n67_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n117_));
  nand3  g73(.a(x24), .b(x23), .c(x22), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n117_), .c(new_n112_), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  inv1   g78(.a(new_n122_), .O(new_n123_));
  aoi22  g79(.a(new_n123_), .b(new_n112_), .c(new_n120_), .d(x25), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n78_), .c(new_n69_), .O(z15));
  nor2   g81(.a(new_n52_), .b(x18), .O(new_n126_));
  ...
  nand4  g85(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n130_));
  nor2   g86(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g87(.a(new_n127_), .b(x26), .c(new_n131_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
