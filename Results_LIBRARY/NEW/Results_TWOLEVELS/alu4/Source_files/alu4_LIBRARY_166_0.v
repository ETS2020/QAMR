// Benchmark "FAU" written by ABC on Fri Jun 26 15:08:09 2020
...
module FAU ( 
  ...
  aoi21  g250(.a(x11), .b(new_n196_), .c(x03), .O(new_n273_));
  oai21  g251(.a(new_n196_), .b(x03), .c(x11), .O(new_n274_));
  oai22  g252(.a(new_n274_), .b(x06), .c(new_n273_), .d(new_n89_), .O(new_n275_));
  ...
  oai21  g436(.a(new_n327_), .b(x03), .c(new_n171_), .O(new_n459_));
  nand2  g437(.a(new_n459_), .b(new_n132_), .O(new_n460_));
  ...
  oai21  g476(.a(new_n197_), .b(x03), .c(new_n422_), .O(new_n499_));
  nand2  g477(.a(new_n499_), .b(new_n497_), .O(new_n500_));
  aoi21  g478(.a(new_n500_), .b(new_n498_), .c(x13), .O(new_n501_));
  inv1   g479(.a(new_n257_), .O(new_n502_));
  nand2  g480(.a(new_n345_), .b(x03), .O(new_n503_));
  nand2  g481(.a(new_n60_), .b(x12), .O(new_n504_));
  aoi21  g482(.a(new_n503_), .b(new_n502_), .c(new_n504_), .O(new_n505_));
  oai21  g483(.a(new_n505_), .b(new_n501_), .c(x06), .O(new_n506_));
  nand3  g484(.a(new_n318_), .b(x11), .c(x10), .O(new_n507_));
  aoi21  g485(.a(new_n507_), .b(new_n268_), .c(x04), .O(new_n508_));
  nand2  g486(.a(new_n52_), .b(new_n34_), .O(new_n509_));
  nand2  g487(.a(new_n509_), .b(new_n268_), .O(new_n510_));
  nand2  g488(.a(new_n510_), .b(x03), .O(new_n511_));
  aoi21  g489(.a(new_n163_), .b(new_n43_), .c(new_n35_), .O(new_n512_));
  aoi21  g490(.a(new_n61_), .b(new_n34_), .c(new_n512_), .O(new_n513_));
  nand2  g491(.a(new_n513_), .b(new_n511_), .O(new_n514_));
  oai21  g492(.a(new_n514_), .b(new_n508_), .c(x02), .O(new_n515_));
  inv1   g493(.a(new_n293_), .O(new_n516_));
  aoi21  g494(.a(new_n516_), .b(new_n259_), .c(x04), .O(new_n517_));
  oai21  g495(.a(new_n517_), .b(x13), .c(new_n108_), .O(new_n518_));
  oai21  g496(.a(new_n170_), .b(new_n35_), .c(new_n200_), .O(new_n519_));
  nand3  g497(.a(new_n519_), .b(new_n370_), .c(x12), .O(new_n520_));
  nand4  g498(.a(new_n520_), .b(new_n518_), .c(new_n515_), .d(new_n506_), .O(new_n521_));
  oai21  g499(.a(new_n521_), .b(new_n495_), .c(x01), .O(new_n522_));
  aoi21  g500(.a(new_n117_), .b(x07), .c(new_n132_), .O(new_n523_));
  inv1   g501(.a(new_n234_), .O(new_n524_));
  aoi21  g502(.a(new_n502_), .b(new_n117_), .c(new_n524_), .O(new_n525_));
  oai21  g503(.a(new_n525_), .b(new_n523_), .c(new_n44_), .O(new_n526_));
  nand2  g504(.a(new_n134_), .b(new_n59_), .O(new_n527_));
  nand2  g505(.a(new_n77_), .b(new_n132_), .O(new_n528_));
  nand3  g506(.a(new_n528_), .b(new_n527_), .c(x09), .O(new_n529_));
  nand3  g507(.a(new_n529_), .b(new_n451_), .c(new_n343_), .O(new_n530_));
  aoi21  g508(.a(new_n530_), .b(new_n526_), .c(x06), .O(new_n531_));
  inv1   g509(.a(new_n431_), .O(new_n532_));
  inv1   g510(.a(new_n391_), .O(new_n533_));
  oai21  g511(.a(new_n484_), .b(new_n208_), .c(x07), .O(new_n534_));
  nand2  g512(.a(new_n534_), .b(new_n452_), .O(new_n535_));
  aoi22  g513(.a(new_n535_), .b(x12), .c(new_n533_), .d(new_n274_), .O(new_n536_));
  oai22  g514(.a(new_n536_), .b(new_n532_), .c(new_n432_), .d(new_n132_), .O(new_n537_));
  aoi21  g515(.a(new_n537_), .b(x06), .c(new_n531_), .O(new_n538_));
  nand3  g516(.a(new_n538_), .b(new_n522_), .c(new_n483_), .O(z5));
  ...
  aoi21  g608(.a(new_n630_), .b(new_n629_), .c(new_n524_), .O(new_n631_));
  ...
  nand2  g706(.a(new_n189_), .b(new_n101_), .O(new_n729_));
  nand2  g707(.a(new_n134_), .b(new_n106_), .O(new_n730_));
  nor2   g708(.a(new_n64_), .b(x11), .O(new_n731_));
  nand4  g709(.a(new_n731_), .b(new_n730_), .c(new_n729_), .d(new_n533_), .O(new_n732_));
  aoi21  g710(.a(new_n732_), .b(new_n728_), .c(new_n89_), .O(new_n733_));
  nor2   g711(.a(new_n116_), .b(x00), .O(new_n734_));
  nor2   g712(.a(new_n23_), .b(x03), .O(new_n735_));
  oai21  g713(.a(new_n735_), .b(new_n734_), .c(new_n24_), .O(new_n736_));
  nand2  g714(.a(x08), .b(x05), .O(new_n737_));
  nand2  g715(.a(x13), .b(new_n29_), .O(new_n738_));
  aoi21  g716(.a(new_n737_), .b(new_n736_), .c(new_n738_), .O(new_n739_));
  oai21  g717(.a(new_n739_), .b(new_n733_), .c(x06), .O(new_n740_));
  oai21  g718(.a(new_n533_), .b(new_n139_), .c(new_n724_), .O(new_n741_));
  oai21  g719(.a(new_n140_), .b(new_n101_), .c(new_n741_), .O(new_n742_));
  nand2  g720(.a(new_n742_), .b(new_n730_), .O(new_n743_));
  inv1   g721(.a(new_n101_), .O(new_n744_));
  nand3  g722(.a(new_n571_), .b(new_n347_), .c(new_n744_), .O(new_n745_));
  nand2  g723(.a(new_n745_), .b(new_n743_), .O(new_n746_));
  nand2  g724(.a(new_n117_), .b(x05), .O(new_n747_));
  nand2  g725(.a(x08), .b(new_n54_), .O(new_n748_));
  aoi21  g726(.a(new_n748_), .b(new_n747_), .c(x12), .O(new_n749_));
  aoi21  g727(.a(new_n746_), .b(new_n34_), .c(new_n749_), .O(new_n750_));
  nand3  g728(.a(x13), .b(new_n24_), .c(new_n89_), .O(new_n751_));
  oai21  g729(.a(new_n751_), .b(new_n750_), .c(new_n740_), .O(new_n752_));
  nand2  g730(.a(new_n752_), .b(x09), .O(new_n753_));
  nand3  g731(.a(new_n45_), .b(x03), .c(new_n89_), .O(new_n754_));
  aoi21  g732(.a(new_n754_), .b(new_n247_), .c(x00), .O(new_n755_));
  nor2   g733(.a(new_n380_), .b(x01), .O(new_n756_));
  oai21  g734(.a(new_n756_), .b(new_n755_), .c(new_n77_), .O(new_n757_));
  inv1   g735(.a(new_n247_), .O(new_n758_));
  nand2  g736(.a(new_n117_), .b(new_n84_), .O(new_n759_));
  nand3  g737(.a(new_n28_), .b(x01), .c(new_n54_), .O(new_n760_));
  oai21  g738(.a(new_n697_), .b(new_n240_), .c(new_n760_), .O(new_n761_));
  aoi22  g739(.a(new_n761_), .b(new_n759_), .c(new_n703_), .d(new_n758_), .O(new_n762_));
  aoi21  g740(.a(new_n762_), .b(new_n757_), .c(x02), .O(new_n763_));
  oai21  g741(.a(new_n23_), .b(new_n89_), .c(new_n614_), .O(new_n764_));
  nand3  g742(.a(x08), .b(x01), .c(x00), .O(new_n765_));
  nand2  g743(.a(new_n45_), .b(x03), .O(new_n766_));
  nand3  g744(.a(new_n766_), .b(new_n765_), .c(x11), .O(new_n767_));
  aoi21  g745(.a(new_n764_), .b(new_n106_), .c(new_n767_), .O(new_n768_));
  nor2   g746(.a(new_n768_), .b(new_n35_), .O(new_n769_));
  oai21  g747(.a(new_n769_), .b(new_n763_), .c(new_n29_), .O(new_n770_));
  nand2  g748(.a(new_n187_), .b(new_n42_), .O(new_n771_));
  nand2  g749(.a(new_n771_), .b(new_n35_), .O(new_n772_));
  aoi22  g750(.a(new_n772_), .b(new_n293_), .c(new_n187_), .d(new_n26_), .O(new_n773_));
  aoi22  g751(.a(new_n77_), .b(x02), .c(new_n59_), .d(x03), .O(new_n774_));
  nand2  g752(.a(new_n91_), .b(new_n24_), .O(new_n775_));
  oai22  g753(.a(new_n775_), .b(new_n774_), .c(new_n773_), .d(new_n89_), .O(new_n776_));
  nor2   g754(.a(new_n774_), .b(new_n89_), .O(new_n777_));
  nor2   g755(.a(new_n516_), .b(x06), .O(new_n778_));
  oai21  g756(.a(new_n778_), .b(new_n777_), .c(x09), .O(new_n779_));
  nand2  g757(.a(new_n187_), .b(new_n34_), .O(new_n780_));
  aoi21  g758(.a(new_n780_), .b(new_n779_), .c(new_n380_), .O(new_n781_));
  ...
  inv1   g762(.a(new_n382_), .O(new_n785_));
  aoi21  g763(.a(new_n780_), .b(new_n35_), .c(new_n380_), .O(new_n786_));
  nand2  g764(.a(new_n772_), .b(x00), .O(new_n787_));
  oai21  g765(.a(new_n432_), .b(new_n23_), .c(new_n787_), .O(new_n788_));
  oai21  g766(.a(new_n788_), .b(new_n786_), .c(new_n785_), .O(new_n789_));
  nand2  g767(.a(new_n789_), .b(new_n784_), .O(new_n790_));
  nand2  g768(.a(new_n771_), .b(x12), .O(new_n791_));
  nand2  g769(.a(new_n791_), .b(new_n24_), .O(new_n792_));
  nand2  g770(.a(new_n634_), .b(new_n45_), .O(new_n793_));
  nand3  g771(.a(new_n584_), .b(new_n125_), .c(new_n83_), .O(new_n794_));
  aoi21  g772(.a(new_n793_), .b(new_n792_), .c(new_n794_), .O(new_n795_));
  aoi21  g773(.a(new_n790_), .b(x10), .c(new_n795_), .O(new_n796_));
  nand3  g774(.a(new_n796_), .b(new_n753_), .c(new_n718_), .O(z7));
endmodule
