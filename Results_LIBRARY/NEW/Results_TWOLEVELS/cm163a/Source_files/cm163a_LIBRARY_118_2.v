...
module FAU ( 
  ...
  xnor2a g11(.a(new_n23_), .b(x11), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n22_), .O(new_n34_));
  nand3  g13(.a(x11), .b(x09), .c(x04), .O(new_n35_));
  inv1   g14(.a(x01), .O(new_n36_));
  aoi21  g15(.a(new_n29_), .b(new_n36_), .c(new_n30_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n35_), .c(new_n34_), .O(z1));
  ...
  nand4  g25(.a(new_n39_), .b(new_n46_), .c(x03), .d(x02), .O(new_n47_));
