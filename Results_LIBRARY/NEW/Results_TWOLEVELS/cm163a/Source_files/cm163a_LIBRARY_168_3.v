// Benchmark "FAU" written by ABC on Thu Jun 25 17:10:46 2020
...
module FAU ( 
  ...
  nand2  g09(.a(new_n22_), .b(x11), .O(new_n31_));
  ...
  aoi21  g15(.a(x11), .b(x09), .c(new_n36_), .O(new_n37_));
  ...
  nand4  g24(.a(new_n32_), .b(new_n45_), .c(x03), .d(x02), .O(new_n46_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n27_), .c(new_n28_), .O(new_n50_));
  oai21  g29(.a(new_n48_), .b(new_n27_), .c(new_n50_), .O(z3));
