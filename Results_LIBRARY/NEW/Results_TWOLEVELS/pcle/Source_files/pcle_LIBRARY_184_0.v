...
module FAU ( 
  ...
  nor2   g38(.a(new_n66_), .b(new_n35_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x05), .O(new_n68_));
  oai21  g40(.a(new_n67_), .b(new_n45_), .c(new_n68_), .O(z6));
  oai21  g41(.a(new_n54_), .b(new_n29_), .c(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  nand3  g43(.a(new_n55_), .b(new_n30_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g48(.a(x17), .b(x15), .c(x14), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(new_n54_), .c(x18), .O(new_n78_));
  inv1   g50(.a(x18), .O(new_n79_));
  nand4  g51(.a(new_n79_), .b(x17), .c(x15), .d(x14), .O(new_n80_));
