...
module FAU ( 
  ...
  nand2  g30(.a(new_n52_), .b(x14), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  nor2   g32(.a(new_n60_), .b(x13), .O(new_n61_));
  aoi21  g33(.a(new_n59_), .b(x13), .c(new_n61_), .O(new_n62_));
  ...
  inv1   g42(.a(new_n45_), .O(new_n71_));
  oai21  g43(.a(new_n53_), .b(new_n29_), .c(x17), .O(new_n72_));
  ...
  oai21  g52(.a(new_n80_), .b(new_n53_), .c(x18), .O(new_n81_));
