...
module FAU ( 
  ...
  oai21  g27(.a(new_n56_), .b(new_n42_), .c(new_n55_), .O(new_n57_));
  ...
  nand3  g32(.a(new_n32_), .b(x16), .c(new_n38_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n61_), .O(z6));
  nand2  g34(.a(x08), .b(x06), .O(new_n64_));
  nand3  g35(.a(new_n32_), .b(x17), .c(new_n38_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n64_), .O(z7));
  nand2  g37(.a(x08), .b(x07), .O(new_n67_));
  nand3  g38(.a(new_n32_), .b(x18), .c(new_n38_), .O(new_n68_));
