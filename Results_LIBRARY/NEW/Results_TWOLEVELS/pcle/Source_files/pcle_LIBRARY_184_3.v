// Benchmark "FAU" written by ABC on Thu Jun 25 16:30:20 2020
...
module FAU ( 
  ...
  nor2   g08(.a(x11), .b(x10), .O(new_n37_));
  ...
  nand3  g30(.a(x15), .b(x14), .c(x13), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n31_), .c(x16), .O(new_n60_));
  inv1   g32(.a(x16), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(x15), .c(new_n41_), .O(new_n62_));
  ...
  oai21  g38(.a(new_n59_), .b(new_n31_), .c(x17), .O(new_n67_));
  inv1   g39(.a(x17), .O(new_n68_));
  inv1   g40(.a(new_n48_), .O(new_n69_));
  and2   g41(.a(x15), .b(x14), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  aoi21  g43(.a(new_n71_), .b(new_n67_), .c(new_n61_), .O(new_n72_));
  nand3  g44(.a(x17), .b(new_n61_), .c(new_n41_), .O(new_n73_));
  inv1   g45(.a(new_n73_), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n72_), .c(new_n36_), .O(new_n75_));
  nand2  g47(.a(x08), .b(x06), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z7));
  inv1   g49(.a(x18), .O(new_n78_));
  oai21  g50(.a(new_n68_), .b(new_n61_), .c(new_n41_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n60_), .c(new_n78_), .O(new_n80_));
  nand4  g52(.a(new_n78_), .b(x17), .c(x16), .d(x15), .O(new_n81_));
  nor2   g53(.a(new_n81_), .b(new_n33_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n80_), .c(new_n36_), .O(new_n83_));
