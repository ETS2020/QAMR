// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:43 2020
...
module FAU ( 
  ...
  oai21  g32(.a(new_n56_), .b(new_n40_), .c(x00), .O(new_n57_));
  oai21  g33(.a(x12), .b(x00), .c(new_n57_), .O(z3));
  inv1   g34(.a(x00), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n40_), .c(new_n59_), .O(new_n61_));
  inv1   g37(.a(x08), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n40_), .O(new_n64_));
  nand2  g40(.a(new_n56_), .b(x07), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n61_), .O(z4));
  nor2   g42(.a(x12), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  aoi21  g44(.a(x09), .b(new_n34_), .c(x02), .O(new_n69_));
  nand3  g45(.a(new_n63_), .b(x03), .c(new_n30_), .O(new_n70_));
  oai21  g46(.a(new_n69_), .b(x01), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n62_), .b(new_n59_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(x14), .b(x02), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n59_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n72_), .c(new_n45_), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n30_), .O(new_n77_));
  nand4  g53(.a(new_n41_), .b(new_n62_), .c(new_n40_), .d(x02), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(new_n62_), .c(new_n45_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  nand2  g59(.a(new_n60_), .b(new_n30_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n81_), .c(x09), .O(new_n85_));
  aoi21  g61(.a(new_n63_), .b(new_n59_), .c(new_n45_), .O(new_n86_));
