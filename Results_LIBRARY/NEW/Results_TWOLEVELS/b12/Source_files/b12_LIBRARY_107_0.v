// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:41 2020
...
module FAU ( 
  ...
  nand3  g38(.a(x13), .b(new_n62_), .c(new_n56_), .O(new_n63_));
  inv1   g39(.a(new_n63_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n41_), .c(new_n40_), .O(z5));
  oai21  g41(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n59_), .c(new_n25_), .O(new_n67_));
  ...
  nand2  g58(.a(new_n62_), .b(new_n30_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n80_), .c(x09), .O(new_n84_));
  aoi21  g60(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n85_));
