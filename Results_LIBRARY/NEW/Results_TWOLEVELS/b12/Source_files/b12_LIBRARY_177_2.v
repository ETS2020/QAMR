...
module FAU ( 
  ...
  nand2  g25(.a(new_n45_), .b(x09), .O(new_n50_));
  oai21  g26(.a(new_n45_), .b(x03), .c(new_n50_), .O(new_n51_));
  nand4  g27(.a(new_n51_), .b(new_n49_), .c(new_n44_), .d(new_n25_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n48_), .O(z2));
  aoi22  g29(.a(x12), .b(new_n40_), .c(x11), .d(x07), .O(z3));
  ...
  oai21  g39(.a(new_n49_), .b(new_n40_), .c(new_n63_), .O(new_n64_));
  aoi21  g40(.a(new_n62_), .b(new_n61_), .c(new_n64_), .O(z6));
  aoi21  g41(.a(new_n63_), .b(x01), .c(new_n34_), .O(new_n66_));
  inv1   g42(.a(new_n63_), .O(new_n67_));
  nor2   g43(.a(new_n34_), .b(x01), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(x09), .c(new_n67_), .O(new_n69_));
  oai21  g45(.a(new_n66_), .b(x08), .c(new_n69_), .O(z7));
  inv1   g46(.a(new_n68_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x12), .c(x09), .O(new_n72_));
  aoi21  g48(.a(new_n60_), .b(new_n40_), .c(new_n67_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z8));
endmodule
