...
module FAU ( 
  ...
  oai21  g27(.a(new_n51_), .b(x01), .c(new_n30_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n50_), .c(new_n40_), .O(new_n53_));
  oai21  g29(.a(new_n49_), .b(x00), .c(new_n53_), .O(z2));
  inv1   g30(.a(x00), .O(new_n55_));
  aoi22  g31(.a(x12), .b(new_n55_), .c(x11), .d(x07), .O(z3));
  aoi21  g32(.a(new_n51_), .b(new_n25_), .c(x08), .O(new_n57_));
  ...
  oai21  g38(.a(x10), .b(x00), .c(x08), .O(new_n63_));
  oai21  g39(.a(new_n51_), .b(x03), .c(new_n30_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n25_), .O(new_n65_));
  nor2   g41(.a(x10), .b(x00), .O(new_n66_));
  oai21  g42(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n41_), .b(new_n30_), .c(new_n55_), .O(new_n68_));
  oai21  g44(.a(x08), .b(new_n55_), .c(new_n68_), .O(new_n69_));
  nor2   g45(.a(x14), .b(new_n25_), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n66_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n65_), .c(x07), .O(z6));
  nand3  g48(.a(new_n50_), .b(new_n40_), .c(x02), .O(new_n73_));
  ...
  nand4  g56(.a(new_n80_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g58(.a(new_n51_), .b(new_n55_), .c(new_n45_), .O(new_n83_));
