...
module FAU ( 
  ...
  aoi21  g36(.a(x09), .b(new_n25_), .c(new_n52_), .O(new_n61_));
  nor2   g37(.a(new_n27_), .b(x01), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  aoi21  g39(.a(x14), .b(x02), .c(new_n25_), .O(new_n64_));
  aoi21  g40(.a(x09), .b(new_n27_), .c(x01), .O(new_n65_));
  ...
  nand4  g44(.a(new_n43_), .b(new_n60_), .c(new_n42_), .d(x02), .O(new_n69_));
  oai21  g45(.a(new_n68_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(new_n71_));
  aoi21  g47(.a(new_n60_), .b(x01), .c(new_n59_), .O(new_n72_));
  ...
  nand4  g53(.a(new_n43_), .b(new_n68_), .c(new_n42_), .d(new_n25_), .O(new_n78_));
