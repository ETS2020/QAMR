...
module FAU ( 
  ...
  nand3  g40(.a(x09), .b(new_n35_), .c(new_n27_), .O(new_n65_));
  nand2  g41(.a(new_n59_), .b(x03), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n26_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n60_), .O(new_n68_));
  inv1   g44(.a(x14), .O(new_n69_));
  nand2  g45(.a(new_n27_), .b(new_n57_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n57_), .c(new_n70_), .O(new_n71_));
  nor2   g47(.a(new_n27_), .b(x00), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n69_), .c(new_n71_), .d(x02), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n68_), .c(new_n46_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n27_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand4  g52(.a(new_n42_), .b(new_n76_), .c(new_n41_), .d(x01), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n76_), .c(new_n46_), .O(new_n81_));
  ...
  aoi21  g61(.a(new_n59_), .b(new_n57_), .c(new_n46_), .O(new_n86_));
