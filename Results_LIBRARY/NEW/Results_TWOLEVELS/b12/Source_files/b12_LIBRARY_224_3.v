...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n57_, new_n60_, new_n61_, new_n62_, new_n64_, new_n65_,
  ...
  nand2  g33(.a(x12), .b(new_n57_), .O(z3));
  nand4  g34(.a(x09), .b(x08), .c(new_n41_), .d(x00), .O(z4));
  inv1   g35(.a(x12), .O(new_n60_));
  inv1   g36(.a(x13), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x10), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n60_), .c(new_n41_), .d(new_n57_), .O(z5));
  ...
  oai21  g50(.a(new_n74_), .b(new_n71_), .c(new_n57_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n70_), .c(new_n46_), .O(z6));
  ...
  aoi21  g57(.a(new_n81_), .b(new_n64_), .c(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  nand4  g59(.a(new_n60_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n65_), .b(new_n57_), .c(new_n46_), .O(new_n86_));
