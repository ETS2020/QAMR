// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:51 2020
...
module FAU ( 
  ...
  nand4  g424(.a(new_n554_), .b(new_n514_), .c(new_n403_), .d(new_n159_), .O(new_n555_));
  ...
  inv1   g435(.a(new_n163_), .O(new_n566_));
  nor2   g436(.a(x34), .b(new_n470_), .O(new_n567_));
  nor2   g437(.a(x55), .b(x51), .O(new_n568_));
  nand2  g438(.a(new_n568_), .b(new_n186_), .O(new_n569_));
  nor3   g439(.a(new_n569_), .b(new_n380_), .c(new_n184_), .O(new_n570_));
  nand4  g440(.a(new_n570_), .b(new_n567_), .c(new_n520_), .d(new_n566_), .O(new_n571_));
  nor2   g441(.a(new_n571_), .b(new_n565_), .O(z41));
  nand2  g442(.a(new_n398_), .b(new_n384_), .O(new_n573_));
  inv1   g443(.a(new_n187_), .O(new_n574_));
  inv1   g444(.a(x49), .O(new_n575_));
  nor2   g445(.a(x50), .b(new_n575_), .O(new_n576_));
  nand4  g446(.a(new_n576_), .b(new_n194_), .c(new_n574_), .d(new_n562_), .O(new_n577_));
  nor2   g447(.a(new_n577_), .b(new_n573_), .O(z42));
  nand4  g448(.a(new_n297_), .b(new_n258_), .c(new_n288_), .d(new_n188_), .O(new_n579_));
  nand2  g449(.a(new_n387_), .b(new_n385_), .O(new_n580_));
  nor2   g450(.a(new_n580_), .b(new_n310_), .O(new_n581_));
  nand2  g451(.a(new_n390_), .b(new_n251_), .O(new_n582_));
  nor2   g452(.a(new_n582_), .b(new_n456_), .O(new_n583_));
  nand4  g453(.a(new_n165_), .b(new_n214_), .c(new_n219_), .d(x01), .O(new_n584_));
  nor2   g454(.a(new_n584_), .b(new_n143_), .O(new_n585_));
  nand3  g455(.a(new_n409_), .b(new_n209_), .c(new_n208_), .O(new_n586_));
  nor2   g456(.a(new_n586_), .b(new_n373_), .O(new_n587_));
  nand4  g457(.a(new_n587_), .b(new_n585_), .c(new_n583_), .d(new_n581_), .O(new_n588_));
  nor2   g458(.a(new_n588_), .b(new_n579_), .O(z43));
  nor2   g459(.a(new_n437_), .b(new_n139_), .O(new_n590_));
  nor2   g460(.a(new_n147_), .b(new_n134_), .O(new_n591_));
  nand2  g461(.a(new_n591_), .b(new_n590_), .O(new_n592_));
  nor2   g462(.a(new_n163_), .b(new_n152_), .O(new_n593_));
  nor4   g463(.a(new_n167_), .b(new_n143_), .c(x04), .d(new_n219_), .O(new_n594_));
  ...
  nand3  g467(.a(new_n251_), .b(new_n553_), .c(new_n250_), .O(new_n598_));
  inv1   g468(.a(x35), .O(new_n599_));
  nand3  g469(.a(new_n282_), .b(new_n599_), .c(x34), .O(new_n600_));
  nor2   g470(.a(new_n600_), .b(new_n598_), .O(new_n601_));
  nor3   g471(.a(new_n525_), .b(new_n147_), .c(new_n134_), .O(new_n602_));
  nand2  g472(.a(new_n602_), .b(new_n601_), .O(new_n603_));
  nor2   g473(.a(new_n603_), .b(new_n565_), .O(z45));
  inv1   g474(.a(new_n380_), .O(new_n605_));
  inv1   g475(.a(new_n569_), .O(new_n606_));
  nand4  g476(.a(new_n606_), .b(new_n605_), .c(new_n562_), .d(new_n566_), .O(new_n607_));
  nand3  g477(.a(new_n176_), .b(new_n210_), .c(x09), .O(new_n608_));
  nor2   g478(.a(new_n608_), .b(new_n203_), .O(new_n609_));
  nor2   g479(.a(new_n543_), .b(new_n202_), .O(new_n610_));
  nand3  g480(.a(new_n610_), .b(new_n609_), .c(new_n540_), .O(new_n611_));
  nor2   g481(.a(new_n611_), .b(new_n607_), .O(z46));
  nand2  g482(.a(new_n540_), .b(new_n374_), .O(new_n613_));
  inv1   g483(.a(x18), .O(new_n614_));
  nand3  g484(.a(new_n385_), .b(new_n614_), .c(x17), .O(new_n615_));
  nor2   g485(.a(new_n615_), .b(new_n310_), .O(new_n616_));
  nand3  g486(.a(new_n375_), .b(new_n250_), .c(new_n599_), .O(new_n617_));
  nor2   g487(.a(new_n617_), .b(new_n295_), .O(new_n618_));
  nand3  g488(.a(new_n618_), .b(new_n616_), .c(new_n602_), .O(new_n619_));
  nor2   g489(.a(new_n619_), .b(new_n613_), .O(z47));
  nand2  g490(.a(new_n470_), .b(x31), .O(new_n621_));
  nor2   g491(.a(new_n621_), .b(new_n190_), .O(new_n622_));
  nand3  g492(.a(new_n622_), .b(new_n198_), .c(new_n188_), .O(new_n623_));
  nor2   g493(.a(new_n623_), .b(new_n565_), .O(z48));
  nand4  g494(.a(new_n148_), .b(new_n135_), .c(new_n137_), .d(x53), .O(new_n625_));
  nor2   g495(.a(new_n625_), .b(new_n561_), .O(z49));
  nand3  g496(.a(new_n401_), .b(new_n398_), .c(new_n384_), .O(new_n627_));
  nand3  g497(.a(new_n562_), .b(new_n131_), .c(x57), .O(new_n628_));
  nor2   g498(.a(new_n628_), .b(new_n627_), .O(z50));
  nand4  g499(.a(new_n591_), .b(new_n140_), .c(new_n575_), .d(x48), .O(new_n630_));
  nor2   g500(.a(new_n630_), .b(new_n573_), .O(z51));
  nand3  g501(.a(new_n177_), .b(new_n224_), .c(x12), .O(new_n632_));
  nor2   g502(.a(new_n632_), .b(new_n175_), .O(new_n633_));
  nor2   g503(.a(new_n437_), .b(new_n163_), .O(new_n634_));
  nand3  g504(.a(new_n634_), .b(new_n633_), .c(new_n157_), .O(new_n635_));
  nand4  g505(.a(new_n401_), .b(new_n306_), .c(new_n305_), .d(new_n384_), .O(new_n636_));
  nor2   g506(.a(new_n636_), .b(new_n635_), .O(z52));
  nand2  g507(.a(new_n241_), .b(x63), .O(new_n638_));
  nor2   g508(.a(new_n638_), .b(new_n406_), .O(z53));
  nor3   g509(.a(new_n359_), .b(x56), .c(new_n185_), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n526_), .c(new_n415_), .d(new_n413_), .O(new_n641_));
  inv1   g511(.a(new_n641_), .O(z54));
  nor2   g512(.a(x37), .b(new_n599_), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n547_), .c(new_n423_), .d(new_n323_), .O(new_n644_));
  nor2   g514(.a(new_n644_), .b(new_n416_), .O(z55));
  nand2  g515(.a(new_n299_), .b(new_n288_), .O(new_n646_));
  inv1   g516(.a(new_n295_), .O(new_n647_));
  nand2  g517(.a(new_n498_), .b(new_n647_), .O(new_n648_));
  nor2   g518(.a(new_n648_), .b(new_n646_), .O(new_n649_));
  nand3  g519(.a(new_n230_), .b(x20), .c(new_n451_), .O(new_n650_));
  nor3   g520(.a(new_n650_), .b(x18), .c(x16), .O(new_n651_));
  nor2   g521(.a(new_n202_), .b(new_n191_), .O(new_n652_));
  nand4  g522(.a(new_n652_), .b(new_n651_), .c(new_n649_), .d(new_n294_), .O(new_n653_));
  nor2   g523(.a(new_n653_), .b(new_n441_), .O(z56));
  nand4  g524(.a(new_n374_), .b(new_n337_), .c(new_n208_), .d(new_n166_), .O(new_n655_));
  inv1   g525(.a(x22), .O(new_n656_));
  nand3  g526(.a(new_n174_), .b(new_n656_), .c(x18), .O(new_n657_));
  nor4   g527(.a(new_n657_), .b(new_n655_), .c(new_n327_), .d(new_n156_), .O(z57));
  inv1   g528(.a(new_n361_), .O(new_n659_));
  nand3  g529(.a(new_n423_), .b(new_n659_), .c(new_n546_), .O(new_n660_));
  nand3  g530(.a(new_n235_), .b(new_n234_), .c(x22), .O(new_n661_));
  nor4   g531(.a(new_n661_), .b(new_n660_), .c(new_n655_), .d(new_n424_), .O(z58));
  nor4   g532(.a(new_n486_), .b(new_n351_), .c(x43), .d(new_n433_), .O(z59));
  nor3   g533(.a(new_n373_), .b(x08), .c(new_n215_), .O(new_n664_));
  nand2  g534(.a(new_n186_), .b(new_n182_), .O(new_n665_));
  nor2   g535(.a(new_n665_), .b(new_n380_), .O(new_n666_));
  nand3  g536(.a(new_n666_), .b(new_n664_), .c(new_n378_), .O(new_n667_));
  inv1   g537(.a(new_n667_), .O(z60));
  nor2   g538(.a(x10), .b(new_n208_), .O(new_n669_));
  nand4  g539(.a(new_n669_), .b(new_n368_), .c(new_n335_), .d(new_n176_), .O(new_n670_));
  nand3  g540(.a(new_n291_), .b(new_n360_), .c(new_n348_), .O(new_n671_));
  nand4  g541(.a(new_n282_), .b(new_n161_), .c(new_n159_), .d(new_n155_), .O(new_n672_));
  nor3   g542(.a(new_n672_), .b(new_n671_), .c(new_n670_), .O(z61));
  nor2   g543(.a(new_n377_), .b(new_n373_), .O(new_n674_));
  nor3   g544(.a(new_n665_), .b(x50), .c(new_n394_), .O(new_n675_));
  nand4  g545(.a(new_n675_), .b(new_n674_), .c(new_n484_), .d(new_n375_), .O(new_n676_));
  inv1   g546(.a(new_n676_), .O(z62));
  nand4  g547(.a(new_n182_), .b(new_n131_), .c(x56), .d(new_n348_), .O(new_n678_));
  inv1   g548(.a(new_n678_), .O(new_n679_));
  nand4  g549(.a(new_n679_), .b(new_n674_), .c(new_n484_), .d(new_n375_), .O(new_n680_));
  inv1   g550(.a(new_n680_), .O(z63));
  nor2   g551(.a(new_n486_), .b(x60), .O(new_n682_));
  nand4  g552(.a(new_n682_), .b(new_n484_), .c(new_n349_), .d(x30), .O(new_n683_));
  nor3   g553(.a(new_n683_), .b(new_n377_), .c(new_n373_), .O(z64));
