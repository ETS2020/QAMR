...
module FAU ( 
  ...
  nor2   g520(.a(x39), .b(x30), .O(new_n651_));
  nand4  g521(.a(new_n651_), .b(new_n330_), .c(new_n327_), .d(new_n161_), .O(new_n652_));
  inv1   g522(.a(new_n434_), .O(new_n653_));
  nand4  g523(.a(new_n647_), .b(new_n653_), .c(new_n230_), .d(x22), .O(new_n654_));
  nor2   g524(.a(new_n654_), .b(new_n652_), .O(z58));
  nor4   g525(.a(new_n482_), .b(new_n350_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand4  g540(.a(new_n670_), .b(new_n668_), .c(new_n480_), .d(new_n378_), .O(new_n671_));
  ...
  nand4  g544(.a(new_n674_), .b(new_n668_), .c(new_n480_), .d(new_n378_), .O(new_n675_));
  inv1   g545(.a(new_n675_), .O(z63));
  nor2   g546(.a(new_n482_), .b(x60), .O(new_n677_));
  nand4  g547(.a(new_n677_), .b(new_n480_), .c(new_n289_), .d(x30), .O(new_n678_));
