...
module FAU ( 
  ...
  nand3  g470(.a(new_n251_), .b(new_n553_), .c(new_n250_), .O(new_n601_));
  ...
  nand2  g493(.a(new_n470_), .b(x31), .O(new_n624_));
  nor2   g494(.a(new_n624_), .b(new_n190_), .O(new_n625_));
  nand3  g495(.a(new_n625_), .b(new_n198_), .c(new_n188_), .O(new_n626_));
  nor2   g496(.a(new_n626_), .b(new_n569_), .O(z48));
  nand4  g497(.a(new_n148_), .b(new_n135_), .c(new_n137_), .d(x53), .O(new_n628_));
  nor2   g498(.a(new_n628_), .b(new_n565_), .O(z49));
  nand3  g499(.a(new_n401_), .b(new_n398_), .c(new_n384_), .O(new_n630_));
  nand3  g500(.a(new_n566_), .b(new_n131_), .c(x57), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(new_n630_), .O(z50));
  nand4  g502(.a(new_n594_), .b(new_n140_), .c(new_n578_), .d(x48), .O(new_n633_));
  nor2   g503(.a(new_n633_), .b(new_n576_), .O(z51));
  nand3  g504(.a(new_n177_), .b(new_n224_), .c(x12), .O(new_n635_));
  nor2   g505(.a(new_n635_), .b(new_n175_), .O(new_n636_));
  nor2   g506(.a(new_n437_), .b(new_n163_), .O(new_n637_));
  nand3  g507(.a(new_n637_), .b(new_n636_), .c(new_n157_), .O(new_n638_));
  nand4  g508(.a(new_n401_), .b(new_n306_), .c(new_n305_), .d(new_n384_), .O(new_n639_));
  nor2   g509(.a(new_n639_), .b(new_n638_), .O(z52));
  nand2  g510(.a(new_n241_), .b(x63), .O(new_n641_));
  nor2   g511(.a(new_n641_), .b(new_n406_), .O(z53));
  nor3   g512(.a(new_n359_), .b(x56), .c(new_n185_), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n526_), .c(new_n415_), .d(new_n413_), .O(new_n644_));
  inv1   g514(.a(new_n644_), .O(z54));
  nor2   g515(.a(x37), .b(new_n602_), .O(new_n646_));
  nand4  g516(.a(new_n646_), .b(new_n547_), .c(new_n423_), .d(new_n323_), .O(new_n647_));
  nor2   g517(.a(new_n647_), .b(new_n416_), .O(z55));
  nand2  g518(.a(new_n299_), .b(new_n288_), .O(new_n649_));
  inv1   g519(.a(new_n295_), .O(new_n650_));
  nand2  g520(.a(new_n498_), .b(new_n650_), .O(new_n651_));
  nor2   g521(.a(new_n651_), .b(new_n649_), .O(new_n652_));
  nand3  g522(.a(new_n230_), .b(x20), .c(new_n451_), .O(new_n653_));
  nor3   g523(.a(new_n653_), .b(x18), .c(x16), .O(new_n654_));
  nor2   g524(.a(new_n202_), .b(new_n191_), .O(new_n655_));
  nand4  g525(.a(new_n655_), .b(new_n654_), .c(new_n652_), .d(new_n294_), .O(new_n656_));
  nor2   g526(.a(new_n656_), .b(new_n441_), .O(z56));
  nand4  g527(.a(new_n374_), .b(new_n337_), .c(new_n208_), .d(new_n166_), .O(new_n658_));
  inv1   g528(.a(x22), .O(new_n659_));
  nand3  g529(.a(new_n174_), .b(new_n659_), .c(x18), .O(new_n660_));
  nor4   g530(.a(new_n660_), .b(new_n658_), .c(new_n327_), .d(new_n156_), .O(z57));
  inv1   g531(.a(new_n361_), .O(new_n662_));
  nand3  g532(.a(new_n423_), .b(new_n662_), .c(new_n546_), .O(new_n663_));
  nand3  g533(.a(new_n235_), .b(new_n234_), .c(x22), .O(new_n664_));
  nor4   g534(.a(new_n664_), .b(new_n663_), .c(new_n658_), .d(new_n424_), .O(z58));
  nor4   g535(.a(new_n486_), .b(new_n351_), .c(x43), .d(new_n433_), .O(z59));
  nor3   g536(.a(new_n373_), .b(x08), .c(new_n215_), .O(new_n667_));
  nand2  g537(.a(new_n186_), .b(new_n182_), .O(new_n668_));
  nor2   g538(.a(new_n668_), .b(new_n380_), .O(new_n669_));
  nand3  g539(.a(new_n669_), .b(new_n667_), .c(new_n378_), .O(new_n670_));
  inv1   g540(.a(new_n670_), .O(z60));
  nor2   g541(.a(x10), .b(new_n208_), .O(new_n672_));
  nand4  g542(.a(new_n672_), .b(new_n368_), .c(new_n335_), .d(new_n176_), .O(new_n673_));
  nand3  g543(.a(new_n291_), .b(new_n360_), .c(new_n348_), .O(new_n674_));
  nand4  g544(.a(new_n282_), .b(new_n161_), .c(new_n159_), .d(new_n155_), .O(new_n675_));
  nor3   g545(.a(new_n675_), .b(new_n674_), .c(new_n673_), .O(z61));
  nor2   g546(.a(new_n377_), .b(new_n373_), .O(new_n677_));
  nor3   g547(.a(new_n668_), .b(x50), .c(new_n394_), .O(new_n678_));
  nand4  g548(.a(new_n678_), .b(new_n677_), .c(new_n484_), .d(new_n375_), .O(new_n679_));
  inv1   g549(.a(new_n679_), .O(z62));
  nand4  g550(.a(new_n182_), .b(new_n131_), .c(x56), .d(new_n348_), .O(new_n681_));
  inv1   g551(.a(new_n681_), .O(new_n682_));
  nand4  g552(.a(new_n682_), .b(new_n677_), .c(new_n484_), .d(new_n375_), .O(new_n683_));
  inv1   g553(.a(new_n683_), .O(z63));
  nor2   g554(.a(new_n486_), .b(x60), .O(new_n685_));
  nand4  g555(.a(new_n685_), .b(new_n484_), .c(new_n349_), .d(x30), .O(new_n686_));
  nor3   g556(.a(new_n686_), .b(new_n377_), .c(new_n373_), .O(z64));
