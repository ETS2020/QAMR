...
module FAU ( 
  ...
  nor2   g432(.a(x55), .b(new_n131_), .O(new_n563_));
  nand4  g433(.a(new_n563_), .b(new_n143_), .c(new_n133_), .d(new_n191_), .O(new_n564_));
  nor2   g434(.a(new_n564_), .b(new_n562_), .O(z40));
  nand3  g435(.a(new_n557_), .b(new_n556_), .c(new_n539_), .O(new_n566_));
