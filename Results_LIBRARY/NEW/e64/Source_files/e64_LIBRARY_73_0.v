// Benchmark "FAU" written by ABC on Thu Jun 25 18:54:33 2020
...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n140_, new_n141_,
    ...
    new_n411_, new_n412_, new_n413_, new_n421_, new_n422_, new_n423_,
  ...
  nor2   g176(.a(x51), .b(x50), .O(new_n320_));
  nand2  g177(.a(new_n320_), .b(new_n212_), .O(new_n321_));
  ...
  nand3  g203(.a(new_n212_), .b(new_n198_), .c(x42), .O(new_n348_));
  inv1   g204(.a(new_n348_), .O(new_n349_));
  nand4  g205(.a(new_n349_), .b(new_n325_), .c(new_n320_), .d(new_n302_), .O(new_n350_));
  nor2   g206(.a(new_n350_), .b(new_n341_), .O(z39));
  inv1   g207(.a(new_n333_), .O(new_n352_));
  nor2   g208(.a(x10), .b(x09), .O(new_n353_));
  nand3  g209(.a(new_n353_), .b(new_n187_), .c(new_n182_), .O(new_n354_));
  inv1   g210(.a(new_n354_), .O(new_n355_));
  nand3  g211(.a(new_n173_), .b(new_n242_), .c(x29), .O(new_n356_));
  inv1   g212(.a(x17), .O(new_n357_));
  nand3  g213(.a(new_n245_), .b(new_n181_), .c(new_n357_), .O(new_n358_));
  nor2   g214(.a(new_n358_), .b(new_n356_), .O(new_n359_));
  nand3  g215(.a(new_n359_), .b(new_n355_), .c(new_n352_), .O(new_n360_));
  nand2  g216(.a(new_n306_), .b(new_n313_), .O(new_n361_));
  nor2   g217(.a(x34), .b(x33), .O(new_n362_));
  nand2  g218(.a(new_n362_), .b(new_n322_), .O(new_n363_));
  nor2   g219(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  inv1   g220(.a(x59), .O(new_n365_));
  nand4  g221(.a(new_n153_), .b(new_n300_), .c(new_n152_), .d(new_n365_), .O(new_n366_));
  inv1   g222(.a(new_n366_), .O(new_n367_));
  nand3  g223(.a(new_n154_), .b(new_n303_), .c(new_n253_), .O(new_n368_));
  inv1   g224(.a(x42), .O(new_n369_));
  nand3  g225(.a(new_n158_), .b(new_n288_), .c(new_n369_), .O(new_n370_));
  nor2   g226(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand3  g227(.a(new_n371_), .b(new_n367_), .c(new_n364_), .O(new_n372_));
  nor2   g228(.a(new_n372_), .b(new_n360_), .O(z40));
  inv1   g229(.a(x34), .O(new_n374_));
  nand3  g230(.a(new_n322_), .b(new_n374_), .c(x33), .O(new_n375_));
  nor2   g231(.a(new_n375_), .b(new_n361_), .O(new_n376_));
  nand3  g232(.a(new_n376_), .b(new_n371_), .c(new_n367_), .O(new_n377_));
  nor2   g233(.a(new_n377_), .b(new_n360_), .O(z41));
  nand4  g234(.a(new_n288_), .b(new_n369_), .c(new_n337_), .d(new_n190_), .O(new_n382_));
  inv1   g235(.a(x35), .O(new_n383_));
  nand3  g236(.a(new_n140_), .b(new_n383_), .c(x34), .O(new_n384_));
  nor2   g237(.a(new_n384_), .b(new_n382_), .O(new_n385_));
  inv1   g238(.a(x56), .O(new_n386_));
  nand4  g239(.a(new_n300_), .b(new_n365_), .c(new_n386_), .d(new_n303_), .O(new_n387_));
  inv1   g240(.a(x47), .O(new_n388_));
  nand4  g241(.a(new_n253_), .b(new_n270_), .c(new_n388_), .d(new_n269_), .O(new_n389_));
  nor2   g242(.a(new_n389_), .b(new_n387_), .O(new_n390_));
  nand3  g243(.a(new_n390_), .b(new_n385_), .c(new_n249_), .O(new_n391_));
  nor2   g244(.a(new_n391_), .b(new_n360_), .O(z45));
  inv1   g245(.a(new_n361_), .O(new_n393_));
  inv1   g246(.a(new_n368_), .O(new_n394_));
  inv1   g247(.a(new_n370_), .O(new_n395_));
  nand4  g248(.a(new_n395_), .b(new_n394_), .c(new_n367_), .d(new_n393_), .O(new_n396_));
  nand2  g249(.a(new_n245_), .b(new_n182_), .O(new_n397_));
  nand3  g250(.a(new_n187_), .b(new_n267_), .c(x09), .O(new_n398_));
  nor2   g251(.a(new_n398_), .b(new_n397_), .O(new_n399_));
  nand3  g252(.a(new_n322_), .b(new_n242_), .c(x29), .O(new_n400_));
  nand3  g253(.a(new_n173_), .b(new_n181_), .c(new_n357_), .O(new_n401_));
  nor2   g254(.a(new_n401_), .b(new_n400_), .O(new_n402_));
  nand3  g255(.a(new_n402_), .b(new_n399_), .c(new_n352_), .O(new_n403_));
  nor2   g256(.a(new_n403_), .b(new_n396_), .O(z46));
  inv1   g257(.a(new_n334_), .O(new_n405_));
  nand4  g258(.a(new_n383_), .b(new_n242_), .c(new_n139_), .d(new_n181_), .O(new_n406_));
  inv1   g259(.a(x18), .O(new_n407_));
  inv1   g260(.a(x22), .O(new_n408_));
  inv1   g261(.a(x24), .O(new_n409_));
  nand4  g262(.a(new_n409_), .b(new_n408_), .c(new_n407_), .d(x17), .O(new_n410_));
  nor2   g263(.a(new_n410_), .b(new_n406_), .O(new_n411_));
  nor2   g264(.a(new_n382_), .b(new_n257_), .O(new_n412_));
  nand4  g265(.a(new_n412_), .b(new_n411_), .c(new_n390_), .d(new_n249_), .O(new_n413_));
  nor2   g266(.a(new_n413_), .b(new_n405_), .O(z47));
  nand2  g267(.a(new_n386_), .b(x55), .O(new_n421_));
  nor2   g268(.a(new_n421_), .b(new_n211_), .O(new_n422_));
  nand4  g269(.a(new_n422_), .b(new_n324_), .c(new_n319_), .d(new_n240_), .O(new_n423_));
  inv1   g270(.a(new_n423_), .O(z54));
  nor2   g271(.a(x37), .b(new_n383_), .O(new_n425_));
  nand4  g272(.a(new_n425_), .b(new_n393_), .c(new_n342_), .d(new_n156_), .O(new_n426_));
  nor2   g273(.a(new_n426_), .b(new_n248_), .O(z55));
  nand2  g274(.a(new_n162_), .b(new_n140_), .O(new_n429_));
  inv1   g275(.a(new_n429_), .O(new_n430_));
  nand4  g276(.a(new_n430_), .b(new_n250_), .c(new_n158_), .d(new_n156_), .O(new_n431_));
  inv1   g277(.a(x08), .O(new_n432_));
  nand4  g278(.a(new_n432_), .b(new_n185_), .c(new_n166_), .d(new_n184_), .O(new_n433_));
  nor2   g279(.a(new_n433_), .b(new_n227_), .O(new_n434_));
  nand3  g280(.a(new_n176_), .b(new_n408_), .c(x18), .O(new_n435_));
  nor2   g281(.a(new_n435_), .b(new_n356_), .O(new_n436_));
  nand2  g282(.a(new_n436_), .b(new_n434_), .O(new_n437_));
  nor2   g283(.a(new_n437_), .b(new_n431_), .O(z57));
  inv1   g284(.a(new_n214_), .O(new_n439_));
  nand3  g285(.a(new_n430_), .b(new_n439_), .c(new_n249_), .O(new_n440_));
  nand3  g286(.a(new_n161_), .b(x29), .c(new_n241_), .O(new_n441_));
  nand3  g287(.a(new_n222_), .b(new_n409_), .c(x22), .O(new_n442_));
  nor2   g288(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  nand2  g289(.a(new_n443_), .b(new_n434_), .O(new_n444_));
  nor2   g290(.a(new_n444_), .b(new_n440_), .O(z58));
  nor2   g291(.a(x58), .b(x50), .O(new_n446_));
  nand3  g292(.a(new_n446_), .b(new_n198_), .c(x40), .O(new_n447_));
  nor2   g293(.a(new_n447_), .b(new_n197_), .O(z59));
  nor2   g294(.a(x08), .b(new_n185_), .O(new_n449_));
  nand2  g295(.a(new_n154_), .b(new_n152_), .O(new_n450_));
  nor2   g296(.a(new_n450_), .b(new_n233_), .O(new_n451_));
  nand4  g297(.a(new_n451_), .b(new_n449_), .c(new_n230_), .d(new_n228_), .O(new_n452_));
  inv1   g298(.a(new_n452_), .O(z60));
  nor2   g299(.a(x10), .b(new_n432_), .O(new_n454_));
  nand4  g300(.a(new_n454_), .b(new_n222_), .c(new_n187_), .d(new_n182_), .O(new_n455_));
  nor2   g301(.a(x30), .b(new_n136_), .O(new_n456_));
  nand2  g302(.a(new_n213_), .b(new_n210_), .O(new_n457_));
  inv1   g303(.a(new_n457_), .O(new_n458_));
  nand2  g304(.a(new_n313_), .b(new_n212_), .O(new_n459_));
  inv1   g305(.a(new_n459_), .O(new_n460_));
  nand4  g306(.a(new_n460_), .b(new_n458_), .c(new_n456_), .d(new_n140_), .O(new_n461_));
  nor2   g307(.a(new_n461_), .b(new_n455_), .O(z61));
  nor2   g308(.a(new_n266_), .b(new_n227_), .O(new_n463_));
  nand2  g309(.a(new_n270_), .b(x47), .O(new_n464_));
  nor2   g310(.a(new_n464_), .b(new_n450_), .O(new_n465_));
  nand4  g311(.a(new_n465_), .b(new_n463_), .c(new_n274_), .d(new_n161_), .O(new_n466_));
  inv1   g312(.a(new_n466_), .O(z62));
  nand3  g313(.a(new_n446_), .b(new_n152_), .c(x56), .O(new_n468_));
  inv1   g314(.a(new_n468_), .O(new_n469_));
  nand4  g315(.a(new_n469_), .b(new_n463_), .c(new_n274_), .d(new_n161_), .O(new_n470_));
  inv1   g316(.a(new_n470_), .O(z63));
  nor2   g317(.a(x37), .b(new_n242_), .O(new_n472_));
  nand4  g318(.a(new_n472_), .b(new_n313_), .c(new_n283_), .d(new_n157_), .O(new_n473_));
  nor3   g319(.a(new_n473_), .b(new_n266_), .c(new_n227_), .O(z64));
  zero   g320(.O(z00));
  zero   g321(.O(z01));
  zero   g322(.O(z02));
  zero   g323(.O(z03));
