...
module FAU ( 
  ...
  nand3  g219(.a(new_n196_), .b(new_n349_), .c(new_n348_), .O(new_n350_));
  nor2   g220(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  nand3  g221(.a(new_n351_), .b(new_n345_), .c(new_n343_), .O(new_n352_));
  inv1   g222(.a(new_n352_), .O(z13));
  nor2   g223(.a(x14), .b(x10), .O(new_n354_));
  nand4  g224(.a(new_n354_), .b(new_n264_), .c(new_n289_), .d(new_n286_), .O(new_n355_));
  nor4   g225(.a(new_n355_), .b(x58), .c(new_n348_), .d(x43), .O(z14));
  nor2   g226(.a(x58), .b(x43), .O(new_n357_));
  nand2  g227(.a(new_n357_), .b(new_n293_), .O(new_n358_));
  nand4  g228(.a(new_n152_), .b(new_n286_), .c(new_n219_), .d(x10), .O(new_n359_));
  ...
  nand4  g235(.a(new_n365_), .b(new_n363_), .c(new_n351_), .d(new_n343_), .O(new_n366_));
  ...
  nand4  g243(.a(new_n373_), .b(new_n370_), .c(new_n363_), .d(new_n351_), .O(new_n374_));
  ...
  nand3  g287(.a(new_n135_), .b(new_n349_), .c(x51), .O(new_n418_));
  ...
  nand3  g296(.a(new_n426_), .b(new_n424_), .c(new_n351_), .O(new_n427_));
  ...
  nand3  g326(.a(new_n354_), .b(new_n286_), .c(x11), .O(new_n457_));
  nand3  g327(.a(new_n346_), .b(new_n348_), .c(new_n157_), .O(new_n458_));
  nor4   g328(.a(new_n458_), .b(new_n457_), .c(new_n381_), .d(new_n362_), .O(z24));
  nand2  g329(.a(new_n354_), .b(new_n286_), .O(new_n460_));
  nand4  g330(.a(new_n363_), .b(new_n264_), .c(new_n337_), .d(x24), .O(new_n461_));
  ...
  or2    g356(.a(new_n486_), .b(new_n355_), .O(new_n487_));
  ...
  nand4  g377(.a(new_n357_), .b(new_n348_), .c(new_n314_), .d(x39), .O(new_n508_));
  nor2   g378(.a(new_n508_), .b(new_n355_), .O(z33));
  nor4   g379(.a(new_n431_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  nand2  g380(.a(new_n346_), .b(new_n144_), .O(new_n511_));
  ...
  nand3  g396(.a(new_n346_), .b(new_n192_), .c(x61), .O(new_n527_));
  ...
  inv1   g415(.a(new_n347_), .O(new_n546_));
  ...
  inv1   g520(.a(new_n350_), .O(new_n651_));
  ...
  nor4   g524(.a(new_n484_), .b(new_n355_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand3  g532(.a(new_n346_), .b(new_n349_), .c(new_n348_), .O(new_n663_));
  nand2  g533(.a(new_n361_), .b(new_n196_), .O(new_n664_));
