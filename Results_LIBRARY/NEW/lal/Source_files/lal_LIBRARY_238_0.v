...
module FAU ( 
  ...
  nand2  g66(.a(new_n111_), .b(new_n98_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n109_), .c(new_n90_), .O(z17));
  nand4  g70(.a(new_n111_), .b(new_n98_), .c(new_n110_), .d(new_n48_), .O(new_n116_));
  oai21  g71(.a(new_n112_), .b(new_n88_), .c(x25), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n90_), .O(z18));
  buf    g73(.a(x16), .O(z02));
endmodule
