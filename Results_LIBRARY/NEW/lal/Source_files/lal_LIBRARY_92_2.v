// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:49 2020
...
module FAU ( 
  ...
  nor2   g46(.a(new_n56_), .b(x15), .O(z09));
  inv1   g47(.a(x15), .O(new_n93_));
  nand3  g48(.a(new_n56_), .b(new_n79_), .c(new_n93_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  xnor2a g50(.a(x18), .b(x17), .O(new_n96_));
  nand2  g51(.a(new_n56_), .b(new_n93_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n96_), .O(z11));
  oai21  g53(.a(new_n81_), .b(new_n79_), .c(x19), .O(new_n99_));
  nor2   g54(.a(new_n81_), .b(new_n79_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n82_), .O(new_n101_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n73_), .c(new_n56_), .d(new_n93_), .O(z13));
  inv1   g60(.a(new_n103_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n73_), .b(x21), .O(new_n109_));
  nor2   g64(.a(new_n57_), .b(x15), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(z14));
  inv1   g66(.a(new_n107_), .O(new_n112_));
  oai21  g67(.a(new_n112_), .b(new_n103_), .c(x22), .O(new_n113_));
  nand3  g68(.a(new_n106_), .b(new_n74_), .c(new_n72_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n110_), .O(z15));
  nand2  g70(.a(new_n74_), .b(new_n72_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n103_), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n107_), .b(new_n48_), .c(new_n52_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n106_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n117_), .c(new_n110_), .O(z16));
  inv1   g76(.a(new_n76_), .O(new_n122_));
  oai21  g77(.a(new_n118_), .b(new_n103_), .c(x24), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n110_), .c(new_n122_), .O(z17));
  inv1   g79(.a(new_n73_), .O(new_n125_));
  nand4  g80(.a(new_n88_), .b(new_n74_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
  nand2  g81(.a(new_n122_), .b(x25), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n126_), .c(new_n110_), .O(z18));
  buf    g83(.a(x16), .O(z02));
endmodule
