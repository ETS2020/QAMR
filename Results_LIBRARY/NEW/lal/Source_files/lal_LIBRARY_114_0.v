...
module FAU ( 
  ...
  nand4  g47(.a(new_n82_), .b(new_n92_), .c(new_n49_), .d(x19), .O(new_n93_));
  nand2  g48(.a(new_n88_), .b(x21), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n90_), .O(z14));
  nand2  g50(.a(new_n93_), .b(x22), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n90_), .O(z15));
  inv1   g52(.a(x07), .O(new_n98_));
  inv1   g53(.a(x15), .O(new_n99_));
  inv1   g54(.a(x23), .O(new_n100_));
  nand4  g55(.a(new_n58_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(z16));
  inv1   g56(.a(x24), .O(new_n102_));
  nand4  g57(.a(new_n58_), .b(new_n102_), .c(new_n99_), .d(new_n98_), .O(z17));
  nand4  g58(.a(new_n58_), .b(new_n48_), .c(new_n99_), .d(new_n98_), .O(z18));
  buf    g59(.a(x16), .O(z02));
endmodule
