...
module FAU ( 
  ...
  nand4  g32(.a(new_n77_), .b(new_n76_), .c(new_n49_), .d(new_n48_), .O(new_n78_));
  nand4  g33(.a(new_n78_), .b(new_n74_), .c(new_n49_), .d(new_n51_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x25), .O(new_n80_));
  inv1   g35(.a(x17), .O(new_n81_));
  inv1   g36(.a(x25), .O(new_n82_));
  nand3  g37(.a(new_n53_), .b(new_n73_), .c(new_n72_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  oai21  g40(.a(new_n52_), .b(new_n51_), .c(new_n82_), .O(new_n86_));
  aoi21  g41(.a(new_n82_), .b(new_n49_), .c(new_n48_), .O(new_n87_));
  aoi21  g42(.a(new_n86_), .b(x20), .c(new_n87_), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n85_), .c(new_n80_), .O(z08));
  nor2   g44(.a(x15), .b(x07), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n57_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand3  g47(.a(new_n90_), .b(new_n56_), .c(new_n81_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xnor2a g49(.a(x18), .b(x17), .O(new_n95_));
  nand2  g50(.a(new_n90_), .b(new_n56_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n95_), .O(z11));
  oai21  g52(.a(new_n72_), .b(new_n81_), .c(x19), .O(new_n98_));
  nor2   g53(.a(new_n72_), .b(new_n81_), .O(new_n99_));
  ...
  nand2  g59(.a(new_n90_), .b(new_n56_), .O(new_n105_));
  ...
  nand3  g63(.a(new_n99_), .b(new_n77_), .c(x19), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n106_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n77_), .b(new_n76_), .c(new_n52_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n106_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nand4  g69(.a(new_n77_), .b(new_n76_), .c(new_n48_), .d(new_n52_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n106_), .O(z16));
  inv1   g71(.a(x20), .O(new_n117_));
  nor2   g72(.a(x23), .b(x21), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n75_), .c(x24), .O(new_n120_));
  oai21  g75(.a(x24), .b(x23), .c(new_n52_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n103_), .c(new_n99_), .d(new_n51_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n120_), .c(new_n106_), .O(z17));
  nand2  g78(.a(new_n78_), .b(x25), .O(new_n124_));
  inv1   g79(.a(new_n104_), .O(new_n125_));
  nand4  g80(.a(new_n118_), .b(new_n125_), .c(new_n82_), .d(new_n49_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n106_), .O(z18));
  buf    g82(.a(x16), .O(z02));
endmodule
