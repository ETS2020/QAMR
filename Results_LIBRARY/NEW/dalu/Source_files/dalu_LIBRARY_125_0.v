// Benchmark "FAU" written by ABC on Wed Jul  1 03:46:18 2020
...
module FAU ( 
  ...
  inv1   g0315(.a(x06), .O(new_n407_));
  nor2   g0316(.a(x07), .b(x05), .O(new_n408_));
  nand4  g0317(.a(new_n408_), .b(new_n177_), .c(new_n176_), .d(new_n407_), .O(new_n409_));
  nand3  g0318(.a(new_n409_), .b(new_n179_), .c(x00), .O(new_n410_));
  ...
  nand2  g0386(.a(new_n177_), .b(new_n176_), .O(new_n478_));
  inv1   g0387(.a(new_n478_), .O(new_n479_));
  nand3  g0388(.a(new_n479_), .b(new_n407_), .c(new_n179_), .O(new_n480_));
  ...
  nand3  g0452(.a(new_n478_), .b(new_n95_), .c(new_n310_), .O(new_n544_));
  nor3   g0453(.a(x07), .b(x05), .c(x04), .O(new_n545_));
  nand2  g0454(.a(new_n407_), .b(x00), .O(new_n546_));
  aoi21  g0455(.a(new_n545_), .b(new_n544_), .c(new_n546_), .O(new_n547_));
  nor2   g0456(.a(new_n407_), .b(x00), .O(new_n548_));
  oai21  g0457(.a(new_n548_), .b(new_n547_), .c(new_n174_), .O(new_n549_));
  nand4  g0458(.a(new_n191_), .b(new_n190_), .c(new_n485_), .d(new_n193_), .O(new_n550_));
  nor2   g0459(.a(x38), .b(new_n111_), .O(new_n551_));
  oai21  g0460(.a(new_n550_), .b(x39), .c(new_n551_), .O(new_n552_));
  oai21  g0461(.a(new_n486_), .b(x32), .c(new_n552_), .O(new_n553_));
  nand2  g0462(.a(new_n553_), .b(new_n188_), .O(new_n554_));
  aoi21  g0463(.a(new_n554_), .b(new_n549_), .c(new_n139_), .O(new_n555_));
  ...
  nand2  g0467(.a(new_n555_), .b(new_n135_), .O(new_n559_));
  ...
  oai22  g0471(.a(new_n154_), .b(new_n562_), .c(new_n116_), .d(new_n486_), .O(new_n563_));
  ...
  nand3  g0477(.a(new_n540_), .b(x69), .c(new_n131_), .O(new_n569_));
  nand2  g0478(.a(new_n569_), .b(new_n568_), .O(new_n570_));
  nand2  g0479(.a(new_n570_), .b(new_n137_), .O(new_n571_));
  nand2  g0480(.a(new_n538_), .b(new_n131_), .O(new_n572_));
  oai21  g0481(.a(new_n131_), .b(new_n486_), .c(new_n572_), .O(new_n573_));
  ...
  aoi21  g0489(.a(new_n456_), .b(new_n455_), .c(new_n212_), .O(new_n581_));
  ...
  oai21  g0495(.a(new_n586_), .b(new_n525_), .c(x72), .O(new_n587_));
  nand3  g0496(.a(new_n587_), .b(new_n585_), .c(new_n584_), .O(new_n588_));
  nand2  g0497(.a(new_n588_), .b(new_n141_), .O(new_n589_));
  aoi21  g0498(.a(new_n469_), .b(new_n468_), .c(new_n212_), .O(new_n590_));
  ...
  oai21  g0512(.a(new_n480_), .b(x05), .c(new_n603_), .O(new_n604_));
  ...
  oai21  g0516(.a(new_n550_), .b(x38), .c(new_n607_), .O(new_n608_));
  ...
  oai21  g0564(.a(new_n536_), .b(new_n655_), .c(x72), .O(new_n656_));
  ...
  aoi21  g0622(.a(new_n469_), .b(new_n468_), .c(x73), .O(new_n714_));
  ...
  aoi21  g0636(.a(new_n456_), .b(new_n455_), .c(x73), .O(new_n728_));
  ...
  oai21  g0753(.a(new_n479_), .b(new_n96_), .c(x11), .O(new_n845_));
  nand3  g0754(.a(new_n478_), .b(new_n175_), .c(x00), .O(new_n846_));
  ...
  oai21  g0800(.a(new_n487_), .b(new_n111_), .c(x43), .O(new_n892_));
  nand3  g0801(.a(new_n413_), .b(new_n189_), .c(x32), .O(new_n893_));
