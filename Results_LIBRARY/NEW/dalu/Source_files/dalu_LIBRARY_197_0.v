...
module FAU ( 
  ...
  nor2   g0044(.a(x68), .b(x67), .O(new_n136_));
  ...
  nand2  g0051(.a(new_n142_), .b(x67), .O(new_n143_));
  oai21  g0052(.a(new_n141_), .b(x67), .c(new_n143_), .O(new_n144_));
  ...
  nand2  g0057(.a(x67), .b(x00), .O(new_n149_));
  oai21  g0058(.a(x67), .b(new_n148_), .c(new_n149_), .O(new_n150_));
  nand2  g0059(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g0060(.a(new_n140_), .b(x67), .c(x32), .O(new_n152_));
  ...
  nor2   g0069(.a(x67), .b(new_n139_), .O(new_n161_));
  ...
  nor2   g0141(.a(new_n110_), .b(x66), .O(new_n233_));
  ...
  oai22  g0160(.a(new_n203_), .b(x66), .c(x69), .d(new_n239_), .O(new_n252_));
  nor2   g0161(.a(new_n111_), .b(x67), .O(new_n253_));
  ...
  nor2   g0165(.a(new_n163_), .b(x67), .O(new_n257_));
  ...
  nor2   g0233(.a(new_n171_), .b(x67), .O(new_n325_));
  ...
  oai21  g0487(.a(new_n556_), .b(x67), .c(new_n578_), .O(new_n579_));
  ...
  nand2  g0533(.a(x67), .b(x07), .O(new_n625_));
  ...
  oai21  g0538(.a(new_n609_), .b(x67), .c(new_n629_), .O(new_n630_));
  ...
  nand2  g0997(.a(x67), .b(x15), .O(new_n1089_));
  ...
  oai21  g1015(.a(new_n1106_), .b(x67), .c(new_n1093_), .O(new_n1107_));
