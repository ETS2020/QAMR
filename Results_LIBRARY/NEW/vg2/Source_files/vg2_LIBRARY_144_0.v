...
module FAU ( 
  ...
  nand2  g69(.a(new_n102_), .b(x17), .O(new_n103_));
  aoi21  g70(.a(new_n103_), .b(new_n101_), .c(x16), .O(new_n104_));
  oai22  g71(.a(new_n104_), .b(x08), .c(new_n45_), .d(new_n38_), .O(new_n105_));
  inv1   g72(.a(x04), .O(new_n106_));
  inv1   g73(.a(x17), .O(new_n107_));
  aoi21  g74(.a(x23), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  oai21  g75(.a(new_n108_), .b(new_n102_), .c(x09), .O(new_n109_));
  aoi21  g76(.a(new_n109_), .b(x16), .c(new_n92_), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(new_n61_), .c(new_n105_), .O(z4));
  inv1   g78(.a(new_n46_), .O(z5));
  oai21  g79(.a(new_n48_), .b(x14), .c(new_n87_), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(new_n88_), .c(x03), .O(new_n114_));
  oai21  g81(.a(x20), .b(new_n47_), .c(x06), .O(new_n115_));
  aoi21  g82(.a(new_n115_), .b(x11), .c(new_n86_), .O(new_n116_));
  oai22  g83(.a(new_n116_), .b(new_n61_), .c(new_n114_), .d(new_n46_), .O(z6));
  inv1   g84(.a(new_n61_), .O(z7));
endmodule
