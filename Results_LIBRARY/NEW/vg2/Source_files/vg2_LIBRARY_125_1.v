// Benchmark "FAU" written by ABC on Thu Jun 25 17:02:43 2020
...
module FAU ( 
  ...
  and2   g011(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  ...
  aoi21  g017(.a(new_n45_), .b(new_n40_), .c(new_n50_), .O(z0));
  ...
  nand2  g049(.a(new_n61_), .b(new_n58_), .O(new_n83_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n49_), .O(new_n88_));
  ...
  nand2  g060(.a(new_n90_), .b(x15), .O(new_n94_));
  oai21  g061(.a(new_n93_), .b(new_n90_), .c(new_n94_), .O(new_n95_));
  aoi22  g062(.a(new_n95_), .b(new_n84_), .c(new_n92_), .d(new_n89_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n82_), .O(z1));
  nand3  g064(.a(new_n37_), .b(x15), .c(x13), .O(new_n98_));
  aoi21  g065(.a(new_n98_), .b(new_n93_), .c(new_n34_), .O(new_n99_));
  nand3  g066(.a(new_n53_), .b(new_n37_), .c(x21), .O(new_n100_));
  nand3  g067(.a(x24), .b(x18), .c(x13), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n100_), .c(new_n94_), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n99_), .O(new_n103_));
  nand4  g070(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n104_));
  nor3   g071(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(z2));
  nand2  g072(.a(x11), .b(x06), .O(new_n106_));
  nand3  g073(.a(x20), .b(x14), .c(x08), .O(new_n107_));
  nor3   g074(.a(new_n107_), .b(new_n106_), .c(new_n56_), .O(new_n108_));
  inv1   g075(.a(x08), .O(new_n109_));
  nand3  g076(.a(new_n77_), .b(new_n76_), .c(new_n109_), .O(new_n110_));
  nand3  g077(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  aoi22  g079(.a(new_n112_), .b(new_n65_), .c(new_n108_), .d(new_n55_), .O(new_n113_));
  aoi22  g080(.a(new_n112_), .b(new_n92_), .c(new_n108_), .d(new_n95_), .O(new_n114_));
  oai21  g081(.a(new_n113_), .b(x24), .c(new_n114_), .O(z3));
  nand2  g082(.a(new_n45_), .b(new_n40_), .O(z5));
  inv1   g083(.a(x04), .O(new_n117_));
  oai21  g084(.a(x23), .b(new_n117_), .c(new_n71_), .O(new_n118_));
  aoi21  g085(.a(new_n118_), .b(new_n72_), .c(x09), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(x16), .c(new_n109_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(z5), .O(new_n121_));
  nand2  g088(.a(new_n39_), .b(x15), .O(new_n122_));
  nand3  g089(.a(x24), .b(x18), .c(x08), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n122_), .c(new_n100_), .O(new_n124_));
  aoi21  g091(.a(x23), .b(new_n117_), .c(new_n71_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n72_), .c(x09), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n124_), .c(x16), .O(new_n127_));
  oai21  g094(.a(new_n102_), .b(new_n99_), .c(new_n109_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n127_), .c(new_n121_), .O(z4));
  inv1   g096(.a(x03), .O(new_n130_));
  oai21  g097(.a(new_n102_), .b(new_n99_), .c(new_n130_), .O(new_n131_));
  aoi21  g098(.a(x20), .b(new_n76_), .c(x06), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x11), .c(new_n130_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(z5), .O(new_n134_));
  inv1   g101(.a(new_n122_), .O(new_n135_));
  oai21  g102(.a(new_n93_), .b(new_n130_), .c(new_n100_), .O(new_n136_));
  nand2  g103(.a(new_n77_), .b(x14), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(x06), .c(new_n47_), .O(new_n138_));
  oai21  g105(.a(new_n136_), .b(new_n135_), .c(new_n138_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n134_), .c(new_n131_), .O(z6));
  inv1   g107(.a(new_n103_), .O(z7));
endmodule
