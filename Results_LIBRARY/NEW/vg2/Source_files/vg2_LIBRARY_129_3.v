...
module FAU ( 
  ...
  nand4  g031(.a(x19), .b(x13), .c(new_n64_), .d(x05), .O(new_n65_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n48_), .d(new_n95_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n94_), .c(new_n90_), .O(new_n99_));
  nor2   g066(.a(new_n38_), .b(new_n35_), .O(new_n100_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n86_), .c(new_n84_), .O(new_n104_));
  inv1   g071(.a(x09), .O(new_n105_));
  nand4  g072(.a(new_n73_), .b(new_n72_), .c(new_n47_), .d(new_n105_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  inv1   g074(.a(x08), .O(new_n108_));
  nand4  g075(.a(new_n71_), .b(x19), .c(new_n108_), .d(new_n46_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nor2   g078(.a(x17), .b(x14), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n96_), .c(new_n48_), .d(new_n95_), .O(new_n113_));
  ...
  nand3  g085(.a(new_n35_), .b(x15), .c(x13), .O(new_n119_));
  ...
  nor2   g094(.a(new_n75_), .b(new_n47_), .O(new_n128_));
  ...
  nand3  g098(.a(new_n48_), .b(new_n108_), .c(new_n46_), .O(new_n132_));
  inv1   g099(.a(new_n132_), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n131_), .c(new_n91_), .d(new_n71_), .O(new_n134_));
  ...
  nand3  g104(.a(new_n49_), .b(new_n47_), .c(new_n108_), .O(new_n138_));
  nand3  g105(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n85_), .O(new_n140_));
  nand4  g107(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n141_));
  nand2  g108(.a(new_n91_), .b(new_n48_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n109_), .c(new_n141_), .d(new_n85_), .O(new_n143_));
  aoi22  g110(.a(new_n143_), .b(new_n38_), .c(new_n140_), .d(new_n100_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n136_), .O(z3));
  aoi21  g112(.a(new_n73_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n105_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n76_), .c(x08), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n95_), .c(new_n77_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n72_), .c(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x16), .c(new_n108_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n125_), .c(new_n148_), .d(new_n45_), .O(z4));
  inv1   g119(.a(new_n45_), .O(z5));
  oai21  g120(.a(new_n71_), .b(x14), .c(new_n46_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n47_), .c(x03), .O(new_n155_));
  inv1   g122(.a(x03), .O(new_n156_));
  oai21  g123(.a(x20), .b(new_n75_), .c(x06), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x11), .c(new_n156_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n125_), .c(new_n155_), .d(new_n45_), .O(z6));
