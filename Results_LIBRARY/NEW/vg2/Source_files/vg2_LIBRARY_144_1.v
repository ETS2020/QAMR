...
module FAU ( 
  ...
  nand4  g060(.a(x23), .b(x20), .c(x14), .d(x12), .O(new_n94_));
  ...
  nor2   g105(.a(x17), .b(x04), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n138_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n71_), .c(x08), .O(new_n141_));
  nand2  g108(.a(x23), .b(new_n88_), .O(new_n142_));
  nand2  g109(.a(x22), .b(new_n72_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n142_), .c(x09), .O(new_n144_));
