// Benchmark "FAU" written by ABC on Thu Jun 25 17:02:51 2020
...
module FAU ( 
  ...
  nand4  g054(.a(new_n87_), .b(x18), .c(x17), .d(x16), .O(new_n88_));
  nor2   g055(.a(x12), .b(x11), .O(new_n89_));
  inv1   g056(.a(x07), .O(new_n90_));
  nor2   g057(.a(new_n90_), .b(x06), .O(new_n91_));
  nor2   g058(.a(x23), .b(x20), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n68_), .O(new_n93_));
  inv1   g060(.a(x04), .O(new_n94_));
  nor2   g061(.a(x16), .b(x14), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n49_), .c(new_n72_), .d(new_n94_), .O(new_n96_));
  oai22  g063(.a(new_n96_), .b(new_n93_), .c(new_n88_), .d(new_n85_), .O(new_n97_));
  nor2   g064(.a(new_n39_), .b(new_n36_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g066(.a(new_n87_), .b(x17), .c(x16), .d(x15), .O(new_n100_));
  nor2   g067(.a(x11), .b(x09), .O(new_n101_));
  nor2   g068(.a(x14), .b(x12), .O(new_n102_));
  nor2   g069(.a(x08), .b(x06), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n92_), .O(new_n104_));
  nor2   g071(.a(x17), .b(x16), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n49_), .c(x19), .d(new_n94_), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n104_), .c(new_n100_), .d(new_n85_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n39_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n99_), .c(new_n82_), .O(z1));
  nand2  g076(.a(x24), .b(x18), .O(new_n110_));
  nand3  g077(.a(new_n36_), .b(x15), .c(x13), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n110_), .c(new_n34_), .O(new_n112_));
  nand3  g079(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n113_));
  ...
  nand4  g084(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n117_), .c(new_n57_), .O(z2));
  nor2   g086(.a(new_n76_), .b(new_n48_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n84_), .c(new_n56_), .d(x20), .O(new_n121_));
  nor3   g088(.a(x20), .b(x14), .c(x11), .O(new_n122_));
  nand2  g089(.a(new_n103_), .b(new_n49_), .O(new_n123_));
  inv1   g090(.a(new_n123_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n122_), .c(new_n66_), .O(new_n125_));
  ...
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n128_), .d(new_n83_), .O(new_n132_));
  nand4  g099(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n133_));
  nand4  g100(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n123_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  aoi21  g107(.a(new_n140_), .b(new_n71_), .c(x08), .O(new_n141_));
  inv1   g108(.a(x22), .O(new_n142_));
  aoi21  g109(.a(x23), .b(new_n94_), .c(new_n72_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n142_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n129_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n117_), .c(new_n141_), .d(new_n46_), .O(z4));
  inv1   g113(.a(new_n46_), .O(z5));
  oai21  g114(.a(new_n77_), .b(x14), .c(new_n47_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n48_), .c(x03), .O(new_n149_));
  inv1   g116(.a(x03), .O(new_n150_));
  oai21  g117(.a(x20), .b(new_n76_), .c(x06), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x11), .c(new_n150_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n117_), .c(new_n149_), .d(new_n46_), .O(z6));
