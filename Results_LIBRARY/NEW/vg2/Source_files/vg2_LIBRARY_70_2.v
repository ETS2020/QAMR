...
module FAU ( 
  ...
  oai22  g022(.a(new_n55_), .b(new_n53_), .c(new_n54_), .d(new_n34_), .O(new_n56_));
  ...
  oai22  g033(.a(new_n66_), .b(new_n65_), .c(new_n55_), .d(new_n64_), .O(new_n67_));
  ...
  nand4  g058(.a(new_n80_), .b(new_n69_), .c(x07), .d(new_n47_), .O(new_n92_));
  nand3  g059(.a(new_n77_), .b(new_n49_), .c(new_n68_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n94_));
  nor2   g061(.a(new_n39_), .b(new_n36_), .O(new_n95_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n101_), .c(new_n48_), .d(new_n100_), .O(new_n106_));
  ...
  oai21  g077(.a(new_n54_), .b(x24), .c(new_n110_), .O(new_n111_));
  nor2   g078(.a(x10), .b(x02), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n36_), .c(x21), .O(new_n113_));
  inv1   g080(.a(new_n110_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(x13), .O(new_n115_));
  inv1   g082(.a(x13), .O(new_n116_));
  nand3  g083(.a(x15), .b(new_n116_), .c(new_n34_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  aoi21  g085(.a(new_n111_), .b(x05), .c(new_n118_), .O(new_n119_));
  nand4  g086(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(new_n119_), .c(new_n57_), .O(z2));
  inv1   g088(.a(x14), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n124_));
  nor3   g091(.a(x20), .b(x14), .c(x11), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n103_), .c(new_n67_), .d(new_n49_), .O(new_n126_));
  ...
  nand3  g097(.a(new_n50_), .b(new_n48_), .c(new_n130_), .O(new_n131_));
  nand3  g098(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n129_), .d(new_n86_), .O(new_n133_));
  nand3  g100(.a(new_n123_), .b(x20), .c(x15), .O(new_n134_));
  nand3  g101(.a(new_n49_), .b(new_n122_), .c(new_n48_), .O(new_n135_));
  ...
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n130_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n119_), .c(new_n141_), .d(new_n46_), .O(z4));
  inv1   g112(.a(new_n46_), .O(z5));
  oai21  g113(.a(x20), .b(new_n122_), .c(x06), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n112_), .c(x21), .O(new_n148_));
  nand4  g115(.a(x15), .b(x13), .c(new_n47_), .d(x05), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n148_), .c(x24), .O(new_n150_));
  inv1   g117(.a(new_n117_), .O(new_n151_));
  nor2   g118(.a(new_n110_), .b(new_n39_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n151_), .c(new_n47_), .O(new_n153_));
  nand4  g120(.a(new_n114_), .b(new_n102_), .c(x14), .d(x03), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n150_), .c(x11), .O(new_n156_));
  inv1   g123(.a(new_n39_), .O(new_n157_));
  oai21  g124(.a(new_n66_), .b(x24), .c(new_n157_), .O(new_n158_));
  inv1   g125(.a(x15), .O(new_n159_));
  oai21  g126(.a(new_n102_), .b(x14), .c(new_n47_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n48_), .c(x03), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n65_), .c(new_n159_), .d(x03), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  inv1   g130(.a(x07), .O(new_n164_));
  inv1   g131(.a(x18), .O(new_n165_));
  oai22  g132(.a(new_n161_), .b(new_n164_), .c(new_n165_), .d(x03), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n95_), .O(new_n167_));
  oai22  g134(.a(new_n161_), .b(new_n64_), .c(new_n53_), .d(x03), .O(new_n168_));
  nor2   g135(.a(new_n55_), .b(x24), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n167_), .c(new_n163_), .d(new_n156_), .O(z6));
  inv1   g138(.a(new_n119_), .O(z7));
endmodule
