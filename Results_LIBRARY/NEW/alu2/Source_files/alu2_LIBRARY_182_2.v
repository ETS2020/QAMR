...
module FAU ( 
  ...
  nand2  g055(.a(x6), .b(new_n21_), .O(new_n72_));
  nand3  g056(.a(x7), .b(new_n19_), .c(x2), .O(new_n73_));
  oai21  g057(.a(new_n72_), .b(x2), .c(new_n73_), .O(new_n74_));
  ...
  nand2  g091(.a(new_n107_), .b(new_n19_), .O(new_n108_));
  aoi21  g092(.a(new_n105_), .b(new_n104_), .c(new_n108_), .O(new_n109_));
  aoi21  g093(.a(new_n102_), .b(x4), .c(new_n109_), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n91_), .c(new_n29_), .O(new_n111_));
  inv1   g095(.a(new_n38_), .O(new_n112_));
  nor2   g096(.a(x7), .b(x3), .O(new_n113_));
  oai21  g097(.a(new_n54_), .b(new_n21_), .c(new_n113_), .O(new_n114_));
  nand3  g098(.a(new_n31_), .b(new_n28_), .c(x3), .O(new_n115_));
  nand3  g099(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(new_n116_));
  nand2  g100(.a(new_n116_), .b(new_n29_), .O(new_n117_));
  oai21  g101(.a(new_n19_), .b(new_n80_), .c(x0), .O(new_n118_));
  aoi21  g102(.a(new_n57_), .b(new_n41_), .c(new_n118_), .O(new_n119_));
  nor3   g103(.a(new_n81_), .b(x4), .c(x0), .O(new_n120_));
  oai21  g104(.a(new_n120_), .b(new_n119_), .c(new_n21_), .O(new_n121_));
  nand2  g105(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  oai21  g106(.a(new_n122_), .b(new_n111_), .c(new_n79_), .O(new_n123_));
  nand2  g107(.a(new_n22_), .b(x2), .O(new_n124_));
  aoi21  g108(.a(new_n106_), .b(x6), .c(new_n124_), .O(new_n125_));
  nand3  g109(.a(x8), .b(x6), .c(x3), .O(new_n126_));
  inv1   g110(.a(new_n126_), .O(new_n127_));
  oai21  g111(.a(new_n127_), .b(new_n125_), .c(new_n19_), .O(new_n128_));
  nand3  g112(.a(x8), .b(new_n20_), .c(x3), .O(new_n129_));
  oai21  g113(.a(new_n41_), .b(x5), .c(new_n129_), .O(new_n130_));
  nand3  g114(.a(x8), .b(new_n28_), .c(new_n80_), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(new_n132_));
  aoi21  g116(.a(new_n130_), .b(new_n18_), .c(new_n132_), .O(new_n133_));
  aoi21  g117(.a(new_n133_), .b(new_n128_), .c(new_n29_), .O(new_n134_));
  nand2  g118(.a(x7), .b(new_n19_), .O(new_n135_));
  nand4  g119(.a(new_n20_), .b(x4), .c(new_n80_), .d(x2), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n135_), .c(new_n72_), .O(new_n137_));
  oai21  g121(.a(new_n137_), .b(new_n134_), .c(new_n17_), .O(new_n138_));
  nor2   g122(.a(new_n21_), .b(x3), .O(new_n139_));
  ...
  aoi21  g126(.a(new_n142_), .b(x9), .c(new_n20_), .O(new_n143_));
  nand2  g127(.a(x9), .b(x8), .O(new_n144_));
  nor2   g128(.a(x8), .b(x5), .O(new_n145_));
  aoi21  g129(.a(new_n144_), .b(x4), .c(new_n145_), .O(new_n146_));
  nand3  g130(.a(new_n107_), .b(new_n29_), .c(new_n19_), .O(new_n147_));
  oai21  g131(.a(new_n146_), .b(x3), .c(new_n147_), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(new_n143_), .c(x6), .O(new_n149_));
  nand2  g133(.a(x3), .b(x2), .O(new_n150_));
  nand3  g134(.a(new_n20_), .b(new_n80_), .c(new_n18_), .O(new_n151_));
  oai21  g135(.a(new_n150_), .b(new_n38_), .c(new_n151_), .O(new_n152_));
  nand2  g136(.a(new_n80_), .b(new_n18_), .O(new_n153_));
  aoi21  g137(.a(new_n153_), .b(x7), .c(x6), .O(new_n154_));
  aoi21  g138(.a(new_n152_), .b(x0), .c(new_n154_), .O(new_n155_));
  nand2  g139(.a(x2), .b(new_n17_), .O(new_n156_));
  nand4  g140(.a(new_n156_), .b(new_n22_), .c(x6), .d(new_n80_), .O(new_n157_));
  oai21  g141(.a(new_n155_), .b(new_n22_), .c(new_n157_), .O(new_n158_));
  nor2   g142(.a(x5), .b(x3), .O(new_n159_));
  nor2   g143(.a(new_n159_), .b(new_n107_), .O(new_n160_));
  nor3   g144(.a(new_n160_), .b(x9), .c(new_n20_), .O(new_n161_));
  aoi21  g145(.a(new_n158_), .b(x9), .c(new_n161_), .O(new_n162_));
  ...
  nand3  g153(.a(x8), .b(new_n80_), .c(new_n18_), .O(new_n170_));
  nand2  g154(.a(new_n28_), .b(x5), .O(new_n171_));
  aoi21  g155(.a(new_n170_), .b(new_n169_), .c(new_n171_), .O(new_n172_));
  oai21  g156(.a(new_n172_), .b(new_n168_), .c(x9), .O(new_n173_));
  nand2  g157(.a(x2), .b(x0), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(x6), .c(x9), .O(new_n175_));
  nor2   g159(.a(new_n98_), .b(x4), .O(new_n176_));
  nor2   g160(.a(x9), .b(new_n28_), .O(new_n177_));
  aoi22  g161(.a(new_n177_), .b(new_n159_), .c(new_n176_), .d(new_n175_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n173_), .O(new_n179_));
  aoi21  g163(.a(new_n163_), .b(x1), .c(new_n179_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(new_n123_), .O(z1));
  nand2  g165(.a(new_n80_), .b(new_n79_), .O(new_n182_));
  nand2  g166(.a(x3), .b(x1), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(new_n182_), .O(z2));
  inv1   g168(.a(new_n183_), .O(z3));
  oai21  g169(.a(new_n139_), .b(x1), .c(new_n46_), .O(new_n186_));
  nand3  g170(.a(new_n21_), .b(x4), .c(x3), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n186_), .c(new_n17_), .O(new_n188_));
  nand2  g172(.a(new_n21_), .b(x4), .O(new_n189_));
  nand2  g173(.a(new_n139_), .b(new_n19_), .O(new_n190_));
  aoi21  g174(.a(new_n190_), .b(new_n189_), .c(new_n79_), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n188_), .c(x7), .O(new_n192_));
  oai21  g176(.a(new_n80_), .b(x1), .c(new_n156_), .O(new_n193_));
  oai21  g177(.a(x3), .b(new_n79_), .c(new_n69_), .O(new_n194_));
  aoi21  g178(.a(new_n193_), .b(x4), .c(new_n194_), .O(new_n195_));
  nand2  g179(.a(new_n18_), .b(new_n17_), .O(new_n196_));
  aoi22  g180(.a(new_n183_), .b(new_n182_), .c(new_n174_), .d(new_n196_), .O(z5));
  nand2  g181(.a(z5), .b(x5), .O(new_n198_));
  oai21  g182(.a(new_n195_), .b(x5), .c(new_n198_), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n20_), .c(new_n145_), .O(new_n200_));
  nand2  g184(.a(new_n200_), .b(new_n192_), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(x6), .O(new_n202_));
  nor2   g186(.a(new_n19_), .b(new_n80_), .O(new_n203_));
  nor2   g187(.a(new_n203_), .b(x1), .O(new_n204_));
  oai21  g188(.a(new_n204_), .b(new_n17_), .c(new_n140_), .O(new_n205_));
  nand2  g189(.a(new_n205_), .b(new_n22_), .O(new_n206_));
  nand2  g190(.a(new_n80_), .b(x0), .O(new_n207_));
  nand3  g191(.a(x7), .b(x5), .c(new_n19_), .O(new_n208_));
  nand2  g192(.a(new_n22_), .b(x4), .O(new_n209_));
  oai22  g193(.a(new_n209_), .b(new_n79_), .c(new_n208_), .d(new_n207_), .O(new_n210_));
  nand2  g194(.a(new_n210_), .b(x2), .O(new_n211_));
  inv1   g195(.a(new_n36_), .O(new_n212_));
  nor3   g196(.a(new_n183_), .b(new_n212_), .c(new_n20_), .O(new_n213_));
  aoi21  g197(.a(new_n80_), .b(new_n17_), .c(new_n20_), .O(new_n214_));
  oai21  g198(.a(z3), .b(x2), .c(new_n214_), .O(new_n215_));
  aoi21  g199(.a(new_n215_), .b(new_n212_), .c(new_n213_), .O(new_n216_));
  nand3  g200(.a(new_n216_), .b(new_n211_), .c(new_n206_), .O(new_n217_));
  nand2  g201(.a(x4), .b(new_n79_), .O(new_n218_));
  nand3  g202(.a(z3), .b(new_n22_), .c(new_n18_), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n218_), .c(x0), .O(new_n220_));
  nand2  g204(.a(new_n203_), .b(new_n84_), .O(new_n221_));
  nand4  g205(.a(new_n22_), .b(new_n80_), .c(new_n79_), .d(x0), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n221_), .c(new_n18_), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n220_), .c(x5), .O(new_n224_));
  nand3  g208(.a(x7), .b(new_n21_), .c(x0), .O(new_n225_));
  oai22  g209(.a(new_n225_), .b(new_n204_), .c(new_n209_), .d(new_n80_), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(x2), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(new_n224_), .O(new_n228_));
  aoi21  g212(.a(new_n217_), .b(new_n28_), .c(new_n228_), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n202_), .c(new_n29_), .O(z4));
endmodule
