...
module FAU ( 
  ...
  nor3   g105(.a(x63), .b(x44), .c(x43), .O(new_n236_));
  ...
  inv1   g151(.a(x64), .O(new_n282_));
  nand3  g152(.a(new_n282_), .b(new_n266_), .c(new_n177_), .O(new_n283_));
  ...
  nor2   g252(.a(new_n382_), .b(new_n282_), .O(z19));
  ...
  nand2  g442(.a(new_n282_), .b(x63), .O(new_n573_));
