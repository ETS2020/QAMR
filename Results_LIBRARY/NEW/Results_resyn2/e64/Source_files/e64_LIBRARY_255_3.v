// Benchmark "FAU" written by ABC on Tue Jul 28 01:17:12 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n582_, new_n583_, new_n584_, new_n586_, new_n588_, new_n590_,
  ...
  nand3  g158(.a(x43), .b(new_n152_), .c(x29), .O(new_n289_));
  ...
  nand3  g176(.a(x29), .b(x28), .c(new_n282_), .O(new_n307_));
  inv1   g177(.a(new_n307_), .O(z10));
  nand3  g178(.a(x37), .b(x29), .c(new_n282_), .O(new_n309_));
  ...
  nand2  g184(.a(new_n314_), .b(new_n173_), .O(new_n315_));
  nor2   g185(.a(new_n315_), .b(new_n313_), .O(new_n316_));
  nand2  g186(.a(new_n316_), .b(new_n311_), .O(new_n317_));
  nor2   g187(.a(new_n146_), .b(new_n144_), .O(new_n318_));
  ...
  nand4  g192(.a(new_n322_), .b(new_n321_), .c(new_n156_), .d(new_n318_), .O(new_n323_));
  nor2   g193(.a(new_n323_), .b(new_n317_), .O(z12));
  nand3  g194(.a(new_n136_), .b(new_n222_), .c(new_n134_), .O(new_n325_));
  inv1   g195(.a(x25), .O(new_n326_));
  nor2   g196(.a(x10), .b(x08), .O(new_n327_));
  nand4  g197(.a(new_n327_), .b(new_n326_), .c(new_n198_), .d(new_n205_), .O(new_n328_));
  nor2   g198(.a(new_n328_), .b(new_n325_), .O(new_n329_));
  nand3  g199(.a(new_n154_), .b(x41), .c(new_n152_), .O(new_n330_));
  ...
  nand2  g205(.a(new_n167_), .b(new_n244_), .O(new_n336_));
  nor4   g206(.a(new_n336_), .b(new_n335_), .c(new_n285_), .d(new_n334_), .O(z14));
  inv1   g207(.a(new_n136_), .O(new_n338_));
  nor4   g208(.a(new_n336_), .b(new_n285_), .c(new_n338_), .d(new_n195_), .O(z15));
  nor2   g209(.a(x60), .b(x58), .O(new_n340_));
  nand2  g210(.a(new_n340_), .b(new_n173_), .O(new_n341_));
  nand3  g211(.a(new_n273_), .b(new_n166_), .c(new_n334_), .O(new_n342_));
  nor2   g212(.a(new_n342_), .b(new_n341_), .O(new_n343_));
  nand2  g213(.a(new_n265_), .b(new_n143_), .O(new_n344_));
  nand3  g214(.a(new_n292_), .b(new_n294_), .c(new_n152_), .O(new_n345_));
  ...
  nand3  g221(.a(new_n351_), .b(new_n198_), .c(x03), .O(new_n352_));
  ...
  nand4  g227(.a(new_n312_), .b(new_n154_), .c(new_n152_), .d(new_n143_), .O(new_n358_));
  inv1   g228(.a(new_n358_), .O(new_n359_));
  nand2  g229(.a(new_n145_), .b(new_n265_), .O(new_n360_));
  inv1   g230(.a(new_n360_), .O(new_n361_));
  and2   g231(.a(new_n314_), .b(new_n162_), .O(new_n362_));
  nand3  g232(.a(new_n362_), .b(new_n361_), .c(new_n359_), .O(new_n363_));
  nand3  g233(.a(new_n321_), .b(new_n156_), .c(x62), .O(new_n364_));
  ...
  nand4  g238(.a(new_n368_), .b(new_n367_), .c(new_n366_), .d(new_n157_), .O(new_n369_));
  nor2   g239(.a(new_n206_), .b(new_n369_), .O(new_n370_));
  nand4  g240(.a(new_n277_), .b(new_n273_), .c(new_n240_), .d(new_n154_), .O(new_n371_));
  inv1   g241(.a(new_n371_), .O(new_n372_));
  nand4  g242(.a(x29), .b(new_n142_), .c(new_n141_), .d(new_n326_), .O(new_n373_));
  ...
  nand4  g248(.a(new_n152_), .b(new_n378_), .c(new_n377_), .d(new_n376_), .O(new_n379_));
  nand4  g249(.a(new_n210_), .b(new_n135_), .c(new_n282_), .d(new_n284_), .O(new_n380_));
  ...
  nand3  g253(.a(new_n230_), .b(new_n160_), .c(new_n334_), .O(new_n384_));
  nand3  g254(.a(new_n254_), .b(new_n164_), .c(new_n161_), .O(new_n385_));
  nor2   g255(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  nor3   g256(.a(new_n174_), .b(x58), .c(x57), .O(new_n387_));
  nand4  g257(.a(new_n387_), .b(new_n386_), .c(new_n383_), .d(new_n370_), .O(new_n388_));
  nor2   g258(.a(new_n388_), .b(new_n234_), .O(z19));
  nand2  g259(.a(new_n223_), .b(new_n139_), .O(new_n390_));
  nor2   g260(.a(new_n390_), .b(new_n325_), .O(new_n391_));
  inv1   g261(.a(new_n150_), .O(new_n392_));
  nand2  g262(.a(new_n327_), .b(new_n368_), .O(new_n393_));
  nor3   g263(.a(new_n393_), .b(new_n392_), .c(new_n344_), .O(new_n394_));
  nand2  g264(.a(new_n394_), .b(new_n391_), .O(new_n395_));
  nand3  g265(.a(new_n316_), .b(new_n311_), .c(x51), .O(new_n396_));
  nor2   g266(.a(new_n396_), .b(new_n395_), .O(z20));
  nand2  g267(.a(new_n292_), .b(new_n276_), .O(new_n398_));
  inv1   g268(.a(new_n398_), .O(new_n399_));
  nand4  g269(.a(new_n399_), .b(new_n343_), .c(new_n286_), .d(new_n143_), .O(new_n400_));
  ...
  inv1   g276(.a(new_n293_), .O(new_n407_));
  nand2  g277(.a(new_n375_), .b(new_n407_), .O(new_n408_));
  nor2   g278(.a(new_n408_), .b(new_n255_), .O(new_n409_));
  nand2  g279(.a(new_n266_), .b(new_n262_), .O(new_n410_));
  nor2   g280(.a(x37), .b(x34), .O(new_n411_));
  nand3  g281(.a(new_n411_), .b(new_n294_), .c(x36), .O(new_n412_));
  ...
  nand3  g288(.a(new_n241_), .b(new_n294_), .c(new_n377_), .O(new_n419_));
  ...
  nor2   g292(.a(new_n373_), .b(new_n293_), .O(new_n423_));
  nand4  g293(.a(new_n423_), .b(new_n422_), .c(new_n420_), .d(new_n291_), .O(new_n424_));
  ...
  nand3  g300(.a(new_n430_), .b(new_n350_), .c(new_n253_), .O(new_n431_));
  nor4   g301(.a(new_n431_), .b(new_n360_), .c(new_n335_), .d(new_n134_), .O(z24));
  nor2   g302(.a(new_n431_), .b(new_n335_), .O(new_n433_));
  nand2  g303(.a(new_n433_), .b(new_n265_), .O(new_n434_));
  nand2  g304(.a(new_n326_), .b(x24), .O(new_n435_));
  nor2   g305(.a(new_n435_), .b(new_n434_), .O(z25));
  inv1   g306(.a(new_n213_), .O(new_n437_));
  nand2  g307(.a(new_n437_), .b(new_n404_), .O(new_n438_));
  nand4  g308(.a(new_n277_), .b(new_n241_), .c(new_n240_), .d(new_n154_), .O(new_n439_));
  nor2   g309(.a(new_n439_), .b(new_n274_), .O(new_n440_));
  nand3  g310(.a(new_n262_), .b(new_n377_), .c(x32), .O(new_n441_));
  nor3   g311(.a(new_n441_), .b(x21), .c(x20), .O(new_n442_));
  nand4  g312(.a(new_n442_), .b(new_n440_), .c(new_n375_), .d(new_n266_), .O(new_n443_));
  nor3   g313(.a(new_n443_), .b(new_n270_), .c(new_n438_), .O(z26));
  ...
  nor4   g317(.a(new_n447_), .b(new_n419_), .c(new_n410_), .d(new_n446_), .O(new_n448_));
  nand3  g318(.a(new_n448_), .b(new_n409_), .c(new_n404_), .O(new_n449_));
  nor2   g319(.a(new_n449_), .b(new_n445_), .O(z27));
  nor2   g320(.a(new_n434_), .b(new_n326_), .O(z28));
  nand4  g321(.a(new_n319_), .b(new_n286_), .c(new_n154_), .d(new_n244_), .O(new_n452_));
  nand3  g322(.a(new_n428_), .b(x60), .c(new_n253_), .O(new_n453_));
  ...
  nand2  g334(.a(new_n464_), .b(new_n353_), .O(new_n465_));
  ...
  nand2  g339(.a(new_n386_), .b(new_n372_), .O(new_n470_));
  nor3   g340(.a(new_n470_), .b(new_n469_), .c(new_n406_), .O(z31));
  nor3   g341(.a(new_n452_), .b(new_n429_), .c(new_n253_), .O(z32));
  nand4  g342(.a(new_n428_), .b(new_n319_), .c(new_n286_), .d(new_n244_), .O(new_n473_));
  nor3   g343(.a(new_n473_), .b(x40), .c(new_n294_), .O(z33));
  nor3   g344(.a(new_n287_), .b(new_n338_), .c(new_n167_), .O(z34));
  inv1   g345(.a(new_n147_), .O(new_n476_));
  nand2  g346(.a(new_n368_), .b(new_n199_), .O(new_n477_));
  nor3   g347(.a(new_n477_), .b(new_n320_), .c(x03), .O(new_n478_));
  nor3   g348(.a(new_n384_), .b(new_n341_), .c(x61), .O(new_n479_));
  nor2   g349(.a(x37), .b(x35), .O(new_n480_));
  nand2  g350(.a(new_n480_), .b(new_n399_), .O(new_n481_));
  nand3  g351(.a(new_n273_), .b(x04), .c(new_n202_), .O(new_n482_));
  ...
  nor2   g355(.a(new_n481_), .b(new_n459_), .O(new_n486_));
  nor3   g356(.a(new_n315_), .b(new_n172_), .c(x55), .O(new_n487_));
  nand4  g357(.a(new_n487_), .b(new_n486_), .c(new_n394_), .d(new_n391_), .O(new_n488_));
  inv1   g358(.a(new_n488_), .O(z36));
  nand3  g359(.a(new_n131_), .b(new_n216_), .c(x19), .O(new_n490_));
  nand2  g360(.a(new_n292_), .b(new_n248_), .O(new_n491_));
  nor2   g361(.a(new_n491_), .b(new_n490_), .O(new_n492_));
  nand3  g362(.a(new_n492_), .b(new_n291_), .c(new_n243_), .O(new_n493_));
  inv1   g363(.a(new_n493_), .O(new_n494_));
  nand4  g364(.a(new_n494_), .b(new_n458_), .c(new_n238_), .d(new_n214_), .O(new_n495_));
  inv1   g365(.a(new_n495_), .O(z37));
  nor2   g366(.a(new_n477_), .b(new_n151_), .O(new_n497_));
  nand2  g367(.a(new_n480_), .b(new_n351_), .O(new_n498_));
  nor2   g368(.a(new_n498_), .b(new_n465_), .O(new_n499_));
  nand2  g369(.a(new_n154_), .b(new_n153_), .O(new_n500_));
  nor2   g370(.a(new_n500_), .b(new_n140_), .O(new_n501_));
  nand4  g371(.a(new_n501_), .b(new_n499_), .c(new_n497_), .d(new_n321_), .O(new_n502_));
  inv1   g372(.a(new_n459_), .O(new_n503_));
  inv1   g373(.a(x42), .O(new_n504_));
  nand4  g374(.a(new_n172_), .b(x59), .c(new_n244_), .d(new_n504_), .O(new_n505_));
  inv1   g375(.a(new_n505_), .O(new_n506_));
  nand4  g376(.a(new_n506_), .b(new_n340_), .c(new_n503_), .d(new_n185_), .O(new_n507_));
  nor2   g377(.a(new_n507_), .b(new_n502_), .O(z38));
  nand4  g378(.a(new_n479_), .b(new_n273_), .c(new_n244_), .d(x42), .O(new_n509_));
  nor2   g379(.a(new_n509_), .b(new_n502_), .O(z39));
  inv1   g380(.a(new_n137_), .O(new_n511_));
  nand2  g381(.a(new_n157_), .b(new_n511_), .O(new_n512_));
  inv1   g382(.a(new_n512_), .O(new_n513_));
  nand2  g383(.a(new_n312_), .b(new_n154_), .O(new_n514_));
  nand3  g384(.a(new_n240_), .b(new_n162_), .c(new_n160_), .O(new_n515_));
  nor3   g385(.a(new_n515_), .b(new_n379_), .c(new_n514_), .O(new_n516_));
  nand4  g386(.a(new_n516_), .b(new_n513_), .c(new_n497_), .d(new_n147_), .O(new_n517_));
  nor2   g387(.a(new_n174_), .b(x58), .O(new_n518_));
  nand3  g388(.a(new_n518_), .b(new_n230_), .c(x54), .O(new_n519_));
  nor2   g389(.a(new_n519_), .b(new_n517_), .O(z40));
  nand3  g390(.a(new_n513_), .b(new_n497_), .c(new_n147_), .O(new_n521_));
  nor2   g391(.a(new_n313_), .b(new_n300_), .O(new_n522_));
  nand4  g392(.a(new_n522_), .b(new_n518_), .c(new_n230_), .d(new_n160_), .O(new_n523_));
  nand3  g393(.a(new_n132_), .b(new_n152_), .c(x33), .O(new_n524_));
  nor3   g394(.a(new_n524_), .b(new_n523_), .c(new_n521_), .O(z41));
  nand2  g395(.a(new_n383_), .b(new_n370_), .O(new_n526_));
  nor2   g396(.a(new_n174_), .b(new_n168_), .O(new_n527_));
  nand4  g397(.a(new_n527_), .b(new_n272_), .c(new_n161_), .d(x49), .O(new_n528_));
  nor2   g398(.a(new_n528_), .b(new_n526_), .O(z42));
  nor2   g399(.a(new_n392_), .b(x02), .O(new_n530_));
  nand3  g400(.a(new_n272_), .b(new_n164_), .c(new_n161_), .O(new_n531_));
  inv1   g401(.a(new_n531_), .O(new_n532_));
  nor2   g402(.a(new_n369_), .b(new_n188_), .O(new_n533_));
  nand4  g403(.a(new_n533_), .b(new_n532_), .c(new_n530_), .d(x01), .O(new_n534_));
  nor2   g404(.a(new_n534_), .b(new_n382_), .O(z43));
  nor2   g405(.a(new_n158_), .b(new_n155_), .O(new_n536_));
  nand3  g406(.a(new_n227_), .b(new_n536_), .c(new_n138_), .O(new_n537_));
  nand4  g407(.a(new_n252_), .b(new_n176_), .c(new_n175_), .d(x02), .O(new_n538_));
  nor2   g408(.a(new_n538_), .b(new_n151_), .O(new_n539_));
  nand3  g409(.a(new_n539_), .b(new_n527_), .c(new_n177_), .O(new_n540_));
  nor3   g410(.a(new_n540_), .b(new_n537_), .c(new_n476_), .O(z44));
  nor2   g411(.a(new_n459_), .b(new_n188_), .O(new_n542_));
  nor2   g412(.a(x39), .b(new_n377_), .O(new_n543_));
  nand4  g413(.a(new_n543_), .b(new_n542_), .c(new_n480_), .d(new_n407_), .O(new_n544_));
  nor2   g414(.a(new_n544_), .b(new_n521_), .O(z45));
  nand2  g415(.a(new_n211_), .b(new_n139_), .O(new_n546_));
  nand4  g416(.a(new_n284_), .b(new_n134_), .c(new_n195_), .d(x09), .O(new_n547_));
  nor2   g417(.a(new_n547_), .b(new_n546_), .O(new_n548_));
  nand3  g418(.a(new_n548_), .b(new_n499_), .c(new_n497_), .O(new_n549_));
  nor2   g419(.a(new_n549_), .b(new_n523_), .O(z46));
  nand3  g420(.a(new_n239_), .b(new_n210_), .c(x17), .O(new_n551_));
  nor3   g421(.a(new_n551_), .b(x37), .c(x30), .O(new_n552_));
  nand3  g422(.a(new_n552_), .b(new_n375_), .c(new_n407_), .O(new_n553_));
  nand3  g423(.a(new_n542_), .b(new_n497_), .c(new_n321_), .O(new_n554_));
  nor2   g424(.a(new_n554_), .b(new_n553_), .O(z47));
  nand3  g425(.a(new_n132_), .b(new_n376_), .c(x31), .O(new_n556_));
  nor2   g426(.a(new_n556_), .b(new_n155_), .O(new_n557_));
  nand3  g427(.a(new_n557_), .b(new_n189_), .c(new_n183_), .O(new_n558_));
  nor2   g428(.a(new_n558_), .b(new_n521_), .O(z48));
  nand3  g429(.a(new_n189_), .b(new_n164_), .c(x53), .O(new_n560_));
  nor2   g430(.a(new_n560_), .b(new_n517_), .O(z49));
  nand3  g431(.a(new_n386_), .b(new_n383_), .c(new_n370_), .O(new_n562_));
  nand2  g432(.a(new_n518_), .b(x57), .O(new_n563_));
  nor2   g433(.a(new_n563_), .b(new_n562_), .O(z50));
  inv1   g434(.a(x49), .O(new_n565_));
  nand4  g435(.a(new_n532_), .b(new_n189_), .c(new_n565_), .d(x48), .O(new_n566_));
  nor2   g436(.a(new_n566_), .b(new_n526_), .O(z51));
  nand4  g437(.a(new_n411_), .b(new_n239_), .c(new_n284_), .d(x12), .O(new_n568_));
  nor3   g438(.a(new_n568_), .b(new_n546_), .c(new_n293_), .O(new_n569_));
  nand4  g439(.a(new_n569_), .b(new_n466_), .c(new_n291_), .d(new_n370_), .O(new_n570_));
  nor2   g440(.a(new_n570_), .b(new_n455_), .O(z52));
  nand2  g441(.a(new_n234_), .b(x63), .O(new_n572_));
  nor2   g442(.a(new_n572_), .b(new_n388_), .O(z53));
  nor2   g443(.a(new_n315_), .b(new_n165_), .O(new_n574_));
  nand4  g444(.a(new_n574_), .b(new_n486_), .c(new_n394_), .d(new_n391_), .O(new_n575_));
  inv1   g445(.a(new_n575_), .O(z54));
  inv1   g446(.a(new_n315_), .O(new_n577_));
  nor2   g447(.a(x41), .b(new_n378_), .O(new_n578_));
  nand4  g448(.a(new_n578_), .b(new_n350_), .c(new_n577_), .d(new_n503_), .O(new_n579_));
  nor2   g449(.a(new_n579_), .b(new_n395_), .O(z55));
  inv1   g450(.a(x16), .O(new_n581_));
  nand4  g451(.a(x20), .b(new_n210_), .c(new_n135_), .d(new_n581_), .O(new_n582_));
  nor2   g452(.a(new_n582_), .b(new_n133_), .O(new_n583_));
  nand3  g453(.a(new_n583_), .b(new_n458_), .c(new_n440_), .O(new_n584_));
  nor3   g454(.a(new_n584_), .b(new_n418_), .c(new_n270_), .O(z56));
  nand4  g455(.a(new_n478_), .b(new_n318_), .c(new_n218_), .d(x18), .O(new_n586_));
  nor2   g456(.a(new_n586_), .b(new_n317_), .O(z57));
  nand4  g457(.a(new_n478_), .b(new_n464_), .c(new_n326_), .d(x22), .O(new_n588_));
  nor2   g458(.a(new_n588_), .b(new_n400_), .O(z58));
  inv1   g459(.a(x40), .O(new_n590_));
  nor2   g460(.a(new_n473_), .b(new_n590_), .O(z59));
  nand3  g461(.a(new_n319_), .b(new_n367_), .c(x07), .O(new_n592_));
  or2    g462(.a(new_n592_), .b(new_n363_), .O(new_n593_));
  inv1   g463(.a(new_n593_), .O(z60));
  nand2  g464(.a(new_n350_), .b(new_n349_), .O(new_n595_));
  nand3  g465(.a(new_n351_), .b(new_n195_), .c(x08), .O(new_n596_));
  nand2  g466(.a(new_n353_), .b(new_n340_), .O(new_n597_));
  nor4   g467(.a(new_n597_), .b(new_n596_), .c(new_n595_), .d(new_n342_), .O(z61));
  nand2  g468(.a(new_n361_), .b(new_n321_), .O(new_n599_));
  nor2   g469(.a(new_n599_), .b(new_n358_), .O(new_n600_));
  ...
  nand3  g474(.a(new_n600_), .b(new_n430_), .c(x56), .O(new_n605_));
  inv1   g475(.a(new_n605_), .O(z63));
  nor3   g476(.a(new_n599_), .b(new_n431_), .c(new_n143_), .O(z64));
