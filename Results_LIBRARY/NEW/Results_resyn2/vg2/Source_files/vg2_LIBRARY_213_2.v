...
module FAU ( 
  ...
  nor2   g052(.a(new_n64_), .b(new_n80_), .O(new_n86_));
  ...
  nor2   g057(.a(x17), .b(x09), .O(new_n91_));
  ...
  oai21  g101(.a(new_n64_), .b(new_n59_), .c(x22), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(x09), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x16), .c(new_n134_), .O(new_n137_));
  oai21  g104(.a(x22), .b(new_n64_), .c(new_n63_), .O(new_n138_));
  nand2  g105(.a(new_n90_), .b(x04), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  aoi21  g107(.a(new_n138_), .b(new_n80_), .c(new_n140_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n46_), .c(new_n137_), .d(new_n110_), .O(z4));
  inv1   g109(.a(new_n46_), .O(z5));
  oai21  g110(.a(new_n48_), .b(x14), .c(new_n47_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n68_), .c(x03), .O(new_n145_));
  inv1   g112(.a(x03), .O(new_n146_));
  oai21  g113(.a(x20), .b(new_n70_), .c(x06), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x11), .c(new_n146_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n110_), .c(new_n145_), .d(new_n46_), .O(z6));
  inv1   g116(.a(new_n110_), .O(z7));
endmodule
