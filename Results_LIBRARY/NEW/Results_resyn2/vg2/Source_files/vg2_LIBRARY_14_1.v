...
module FAU ( 
  ...
  nand4  g021(.a(x08), .b(x06), .c(x04), .d(x01), .O(new_n55_));
  ...
  aoi21  g102(.a(new_n51_), .b(x20), .c(x03), .O(new_n136_));
  oai21  g103(.a(x20), .b(new_n74_), .c(x06), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(x11), .c(new_n48_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n111_), .c(new_n136_), .d(new_n46_), .O(z6));
  inv1   g106(.a(new_n111_), .O(z7));
endmodule
