...
module FAU ( 
  ...
  nor2   g57(.a(new_n90_), .b(new_n52_), .O(new_n91_));
  nand4  g58(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n92_));
  inv1   g59(.a(new_n92_), .O(new_n93_));
  nand4  g60(.a(new_n93_), .b(new_n91_), .c(x20), .d(x18), .O(new_n94_));
  ...
  nand4  g66(.a(new_n93_), .b(new_n91_), .c(x20), .d(x15), .O(new_n100_));
  nand2  g67(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  aoi22  g68(.a(new_n101_), .b(new_n45_), .c(new_n96_), .d(new_n95_), .O(new_n102_));
  nand2  g69(.a(new_n102_), .b(new_n86_), .O(z3));
  inv1   g70(.a(x23), .O(new_n104_));
  aoi21  g71(.a(new_n104_), .b(x04), .c(x17), .O(new_n105_));
  oai21  g72(.a(new_n105_), .b(x22), .c(new_n51_), .O(new_n106_));
  aoi21  g73(.a(new_n106_), .b(new_n54_), .c(x08), .O(new_n107_));
  inv1   g74(.a(x22), .O(new_n108_));
  inv1   g75(.a(x17), .O(new_n109_));
  aoi21  g76(.a(x23), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(new_n108_), .c(x09), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(x16), .c(new_n59_), .O(new_n112_));
  oai22  g79(.a(new_n112_), .b(new_n72_), .c(new_n107_), .d(new_n49_), .O(z4));
  inv1   g80(.a(new_n49_), .O(z5));
  inv1   g81(.a(x06), .O(new_n115_));
  inv1   g82(.a(x20), .O(new_n116_));
  oai21  g83(.a(new_n116_), .b(x14), .c(new_n115_), .O(new_n117_));
  aoi21  g84(.a(new_n117_), .b(new_n52_), .c(x03), .O(new_n118_));
  oai21  g85(.a(x20), .b(new_n90_), .c(x06), .O(new_n119_));
  aoi21  g86(.a(new_n119_), .b(x11), .c(new_n57_), .O(new_n120_));
  oai22  g87(.a(new_n120_), .b(new_n72_), .c(new_n118_), .d(new_n49_), .O(z6));
  inv1   g88(.a(new_n72_), .O(z7));
endmodule
