...
module FAU ( 
  ...
  nand2  g017(.a(x14), .b(x11), .O(new_n51_));
  nand4  g018(.a(x16), .b(x12), .c(x09), .d(x04), .O(new_n52_));
  ...
  nand3  g027(.a(new_n60_), .b(new_n56_), .c(new_n53_), .O(new_n61_));
  nand3  g028(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n62_));
  nand2  g029(.a(new_n59_), .b(new_n62_), .O(new_n63_));
  ...
  oai21  g065(.a(new_n98_), .b(new_n45_), .c(new_n97_), .O(new_n99_));
  inv1   g066(.a(new_n45_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n38_), .O(new_n101_));
  aoi22  g068(.a(new_n101_), .b(new_n96_), .c(new_n99_), .d(new_n88_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n86_), .O(z1));
  nand3  g070(.a(new_n39_), .b(x15), .c(x13), .O(new_n104_));
  aoi21  g071(.a(new_n104_), .b(new_n98_), .c(new_n37_), .O(new_n105_));
  nand4  g072(.a(new_n39_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n106_));
  nand3  g073(.a(x24), .b(x18), .c(x13), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n106_), .c(new_n97_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  ...
  nor2   g080(.a(new_n113_), .b(new_n109_), .O(z2));
  nand3  g081(.a(new_n112_), .b(new_n60_), .c(x08), .O(new_n115_));
  nand3  g082(.a(x19), .b(x13), .c(x05), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n62_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(new_n35_), .c(new_n34_), .d(new_n72_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n39_), .O(new_n120_));
  nand4  g087(.a(new_n35_), .b(new_n34_), .c(new_n72_), .d(x07), .O(new_n121_));
  inv1   g088(.a(new_n54_), .O(new_n122_));
  inv1   g089(.a(new_n110_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n122_), .c(x18), .O(new_n124_));
  nand2  g091(.a(new_n100_), .b(x24), .O(new_n125_));
  aoi21  g092(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand4  g093(.a(new_n35_), .b(new_n34_), .c(x19), .d(new_n72_), .O(new_n127_));
  nand3  g094(.a(new_n123_), .b(new_n122_), .c(x15), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n127_), .c(new_n100_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n120_), .O(z3));
  aoi21  g098(.a(new_n81_), .b(x04), .c(x17), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x22), .c(new_n64_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n67_), .c(x08), .O(new_n134_));
  aoi21  g101(.a(x23), .b(new_n71_), .c(new_n79_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n80_), .c(x09), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x16), .c(new_n72_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n109_), .c(new_n134_), .d(new_n49_), .O(z4));
  inv1   g105(.a(new_n49_), .O(z5));
  nand2  g106(.a(x20), .b(new_n76_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n75_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n65_), .c(x03), .O(new_n142_));
  nand2  g109(.a(new_n77_), .b(x14), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(x06), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x11), .c(new_n70_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n109_), .c(new_n142_), .d(new_n49_), .O(z6));
  inv1   g113(.a(new_n109_), .O(z7));
endmodule
