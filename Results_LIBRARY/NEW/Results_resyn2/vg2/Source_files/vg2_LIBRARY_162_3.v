...
module FAU ( 
  ...
  aoi21  g50(.a(x11), .b(new_n84_), .c(new_n83_), .O(new_n85_));
  inv1   g51(.a(x11), .O(new_n86_));
  inv1   g52(.a(x20), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n86_), .c(x03), .O(new_n89_));
  oai22  g55(.a(new_n89_), .b(new_n61_), .c(new_n85_), .d(new_n80_), .O(z6));
