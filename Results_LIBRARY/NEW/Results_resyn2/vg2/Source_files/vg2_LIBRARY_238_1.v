...
module FAU ( 
  ...
  oai21  g006(.a(x13), .b(x05), .c(x24), .O(new_n40_));
  inv1   g007(.a(new_n40_), .O(new_n41_));
  aoi22  g008(.a(new_n41_), .b(x07), .c(new_n39_), .d(new_n34_), .O(new_n42_));
  inv1   g009(.a(x06), .O(new_n43_));
  nor2   g010(.a(x20), .b(x11), .O(new_n44_));
  ...
  nand3  g015(.a(x21), .b(new_n36_), .c(new_n35_), .O(new_n49_));
  ...
  nand4  g029(.a(new_n62_), .b(new_n61_), .c(new_n44_), .d(new_n60_), .O(new_n63_));
  ...
  nand2  g034(.a(new_n45_), .b(new_n43_), .O(new_n68_));
  nor2   g035(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g036(.a(new_n69_), .b(new_n64_), .c(new_n39_), .O(new_n70_));
  ...
  nand4  g050(.a(new_n83_), .b(new_n66_), .c(new_n65_), .d(new_n45_), .O(new_n84_));
  ...
  aoi21  g075(.a(new_n38_), .b(new_n37_), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g080(.a(new_n40_), .b(new_n113_), .c(new_n87_), .O(new_n114_));
  nand2  g081(.a(x07), .b(new_n43_), .O(new_n115_));
  nor3   g082(.a(new_n108_), .b(new_n115_), .c(new_n40_), .O(new_n116_));
