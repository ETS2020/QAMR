...
module FAU ( 
  ...
  nand2  g018(.a(x13), .b(x05), .O(new_n52_));
  nand3  g019(.a(x21), .b(new_n43_), .c(new_n42_), .O(new_n53_));
  oai21  g020(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g051(.a(new_n84_), .b(new_n75_), .c(new_n64_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n61_), .O(new_n86_));
  nand2  g053(.a(new_n86_), .b(new_n39_), .O(new_n87_));
  nand2  g054(.a(new_n60_), .b(new_n57_), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  nor2   g056(.a(x03), .b(x01), .O(new_n90_));
  nor2   g057(.a(x11), .b(x09), .O(new_n91_));
  nor2   g058(.a(x16), .b(x12), .O(new_n92_));
  nor2   g059(.a(x08), .b(x04), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  nor3   g061(.a(x23), .b(x22), .c(x17), .O(new_n95_));
  nand2  g062(.a(new_n95_), .b(new_n34_), .O(new_n96_));
  nor2   g063(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  inv1   g064(.a(new_n45_), .O(new_n98_));
  nand2  g065(.a(x24), .b(x18), .O(new_n99_));
  oai21  g066(.a(new_n98_), .b(new_n51_), .c(new_n99_), .O(new_n100_));
  oai21  g067(.a(new_n45_), .b(new_n38_), .c(new_n46_), .O(new_n101_));
  aoi22  g068(.a(new_n101_), .b(new_n97_), .c(new_n100_), .d(new_n89_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n87_), .O(z1));
  oai21  g070(.a(new_n52_), .b(x24), .c(new_n98_), .O(new_n104_));
  nand4  g071(.a(new_n39_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n99_), .O(new_n106_));
  aoi21  g073(.a(new_n104_), .b(x15), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g078(.a(new_n108_), .b(new_n55_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n54_), .c(x08), .O(new_n113_));
  nand4  g080(.a(new_n64_), .b(new_n35_), .c(new_n34_), .d(new_n73_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n39_), .O(new_n116_));
  nor2   g083(.a(new_n110_), .b(new_n73_), .O(new_n117_));
  nor2   g084(.a(new_n36_), .b(x08), .O(new_n118_));
  aoi22  g085(.a(new_n118_), .b(new_n101_), .c(new_n117_), .d(new_n100_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n116_), .O(z3));
  aoi21  g087(.a(new_n82_), .b(x04), .c(x17), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(x22), .c(new_n65_), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n68_), .c(x08), .O(new_n123_));
  aoi21  g090(.a(x23), .b(new_n72_), .c(new_n80_), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n81_), .c(x09), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x16), .c(new_n73_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n107_), .c(new_n123_), .d(new_n49_), .O(z4));
  inv1   g094(.a(new_n49_), .O(z5));
  nand2  g095(.a(x20), .b(new_n77_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n76_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n66_), .c(x03), .O(new_n131_));
  nand2  g098(.a(new_n78_), .b(x14), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(x06), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x11), .c(new_n71_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n107_), .c(new_n131_), .d(new_n49_), .O(z6));
  inv1   g102(.a(new_n107_), .O(z7));
endmodule
