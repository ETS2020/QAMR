...
module FAU ( 
  ...
  nand2  g069(.a(x06), .b(x03), .O(new_n103_));
  ...
  nand2  g080(.a(new_n96_), .b(new_n67_), .O(new_n114_));
  nor3   g081(.a(new_n112_), .b(new_n103_), .c(new_n72_), .O(new_n115_));
  ...
  oai21  g103(.a(new_n49_), .b(x14), .c(new_n136_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n73_), .c(x03), .O(new_n138_));
  oai21  g105(.a(x20), .b(new_n74_), .c(x06), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x11), .c(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n111_), .c(new_n138_), .d(new_n46_), .O(z6));
