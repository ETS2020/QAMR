...
module FAU ( 
  ...
  nand3  g026(.a(new_n48_), .b(new_n59_), .c(new_n58_), .O(new_n60_));
  ...
  nand3  g041(.a(new_n74_), .b(new_n65_), .c(new_n61_), .O(new_n75_));
  inv1   g042(.a(x15), .O(new_n76_));
  nand3  g043(.a(x21), .b(new_n40_), .c(new_n39_), .O(new_n77_));
  oai21  g044(.a(new_n64_), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  ...
  nor3   g049(.a(new_n82_), .b(new_n48_), .c(new_n59_), .O(new_n83_));
  nand3  g050(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n36_), .O(new_n86_));
  inv1   g053(.a(new_n70_), .O(new_n87_));
  nand4  g054(.a(new_n72_), .b(new_n71_), .c(x07), .d(new_n47_), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  nand3  g056(.a(new_n89_), .b(new_n87_), .c(new_n61_), .O(new_n90_));
  inv1   g057(.a(new_n82_), .O(new_n91_));
  nor2   g058(.a(new_n48_), .b(new_n59_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n81_), .d(x18), .O(new_n93_));
  ...
  nand4  g063(.a(new_n92_), .b(new_n91_), .c(new_n81_), .d(x15), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nor2   g065(.a(x20), .b(x06), .O(new_n99_));
  nor2   g066(.a(x17), .b(x16), .O(new_n100_));
  nor2   g067(.a(x12), .b(x08), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(x19), .O(new_n102_));
  nor3   g069(.a(new_n102_), .b(new_n70_), .c(new_n57_), .O(new_n103_));
  oai21  g070(.a(new_n103_), .b(new_n98_), .c(new_n42_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n96_), .c(new_n86_), .O(z1));
  ...
  nand3  g085(.a(new_n115_), .b(new_n118_), .c(new_n78_), .O(new_n119_));
  inv1   g086(.a(new_n52_), .O(new_n120_));
  nor2   g087(.a(new_n49_), .b(x08), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n65_), .c(new_n120_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n36_), .O(new_n124_));
  inv1   g091(.a(x18), .O(new_n125_));
  nand2  g092(.a(new_n115_), .b(new_n118_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  inv1   g094(.a(x07), .O(new_n128_));
  nand4  g095(.a(new_n51_), .b(new_n50_), .c(new_n99_), .d(new_n71_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(new_n95_), .O(new_n131_));
  nor2   g098(.a(new_n126_), .b(new_n76_), .O(new_n132_));
  nor2   g099(.a(new_n129_), .b(new_n62_), .O(new_n133_));
  ...
  aoi21  g104(.a(new_n137_), .b(new_n58_), .c(x08), .O(new_n138_));
  aoi21  g105(.a(x23), .b(new_n56_), .c(new_n59_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n68_), .c(x09), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x16), .c(new_n71_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n113_), .c(new_n138_), .d(new_n46_), .O(z4));
  inv1   g109(.a(new_n46_), .O(z5));
  oai21  g110(.a(new_n48_), .b(x14), .c(new_n47_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n67_), .c(x03), .O(new_n145_));
  inv1   g112(.a(x14), .O(new_n146_));
  oai21  g113(.a(x20), .b(new_n146_), .c(x06), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x11), .c(new_n55_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n113_), .c(new_n145_), .d(new_n46_), .O(z6));
