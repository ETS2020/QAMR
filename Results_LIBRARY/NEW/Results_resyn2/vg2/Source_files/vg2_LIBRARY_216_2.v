...
module FAU ( 
  ...
  nand4  g032(.a(x23), .b(x22), .c(x16), .d(x14), .O(new_n66_));
  nor2   g033(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g034(.a(x12), .b(x11), .c(x04), .O(new_n68_));
  nand2  g035(.a(x20), .b(x17), .O(new_n69_));
  ...
  nand3  g040(.a(x20), .b(x18), .c(x17), .O(new_n74_));
  nor2   g041(.a(new_n74_), .b(new_n68_), .O(new_n75_));
