...
module FAU ( 
  ...
  nand2  g07(.a(x19), .b(x05), .O(new_n41_));
  nand2  g08(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  inv1   g09(.a(x13), .O(new_n43_));
  nand2  g10(.a(x19), .b(new_n43_), .O(new_n44_));
  ...
  nand3  g55(.a(x24), .b(x18), .c(x13), .O(new_n89_));
  oai21  g56(.a(new_n88_), .b(x13), .c(new_n89_), .O(new_n90_));
