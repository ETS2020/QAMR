// Benchmark "FAU" written by ABC on Mon Jul 27 18:39:19 2020
...
module FAU ( 
  ...
  aoi21  g013(.a(new_n40_), .b(x05), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g048(.a(new_n81_), .b(new_n78_), .c(new_n69_), .O(new_n82_));
  ...
  oai21  g062(.a(new_n37_), .b(new_n95_), .c(new_n42_), .O(new_n96_));
  nand2  g063(.a(x24), .b(x18), .O(new_n97_));
  nand2  g064(.a(new_n41_), .b(x15), .O(new_n98_));
  oai21  g065(.a(new_n97_), .b(new_n41_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g069(.a(new_n102_), .b(new_n97_), .c(new_n95_), .O(new_n103_));
  nand4  g070(.a(new_n38_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n104_));
  nand3  g071(.a(x24), .b(x18), .c(x13), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n104_), .c(new_n98_), .O(new_n106_));
  ...
  nor2   g078(.a(new_n108_), .b(new_n49_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n57_), .c(x08), .O(new_n113_));
  nand4  g080(.a(new_n81_), .b(new_n35_), .c(new_n34_), .d(new_n67_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n38_), .O(new_n116_));
  nor2   g083(.a(new_n110_), .b(new_n67_), .O(new_n117_));
  nor2   g084(.a(new_n36_), .b(x08), .O(new_n118_));
  aoi22  g085(.a(new_n118_), .b(new_n96_), .c(new_n117_), .d(new_n99_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n116_), .O(z3));
  aoi21  g087(.a(new_n76_), .b(x04), .c(x17), .O(new_n121_));
  oai21  g088(.a(new_n121_), .b(x22), .c(new_n59_), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n62_), .c(x08), .O(new_n123_));
  aoi21  g090(.a(x23), .b(new_n66_), .c(new_n74_), .O(new_n124_));
  oai21  g091(.a(new_n124_), .b(new_n75_), .c(x09), .O(new_n125_));
  aoi21  g092(.a(new_n125_), .b(x16), .c(new_n67_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n107_), .c(new_n123_), .d(new_n47_), .O(z4));
  inv1   g094(.a(new_n47_), .O(z5));
  oai21  g095(.a(new_n72_), .b(x14), .c(new_n70_), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(new_n60_), .c(x03), .O(new_n130_));
  nand2  g097(.a(new_n72_), .b(x14), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(x06), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x11), .c(new_n65_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n107_), .c(new_n130_), .d(new_n47_), .O(z6));
