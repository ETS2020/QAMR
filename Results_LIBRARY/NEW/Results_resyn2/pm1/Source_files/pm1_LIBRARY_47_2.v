// Benchmark "FAU" written by ABC on Mon Jul 27 18:08:12 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n52_), .b(new_n50_), .c(z01), .O(z08));
  nand2  g24(.a(new_n52_), .b(x11), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(z09));
  nand3  g26(.a(new_n42_), .b(new_n37_), .c(new_n47_), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n51_), .O(z10));
  nand2  g28(.a(x01), .b(x00), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n56_), .O(z11));
  inv1   g30(.a(x09), .O(new_n60_));
  nand3  g31(.a(new_n52_), .b(x11), .c(new_n60_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z12));
endmodule
