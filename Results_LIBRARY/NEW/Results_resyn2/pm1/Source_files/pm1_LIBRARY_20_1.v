// Benchmark "FAU" written by ABC on Mon Jul 27 18:08:05 2020
...
module FAU ( 
  ...
  aoi21  g08(.a(new_n31_), .b(x01), .c(new_n37_), .O(new_n38_));
  ...
  nand3  g22(.a(new_n51_), .b(new_n49_), .c(new_n44_), .O(new_n52_));
  ...
  aoi21  g29(.a(new_n58_), .b(new_n32_), .c(new_n57_), .O(z09));
  nand3  g30(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(new_n60_));
  inv1   g31(.a(new_n60_), .O(z10));
  nor3   g32(.a(new_n58_), .b(new_n57_), .c(x09), .O(z12));
  inv1   g33(.a(new_n60_), .O(z11));
endmodule
