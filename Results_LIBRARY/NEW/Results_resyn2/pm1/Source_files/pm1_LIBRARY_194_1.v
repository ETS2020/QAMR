...
module FAU ( 
  ...
  nand2  g20(.a(x11), .b(new_n49_), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n48_), .c(x00), .O(z08));
  aoi21  g23(.a(new_n31_), .b(x00), .c(x12), .O(new_n53_));
  oai21  g24(.a(new_n32_), .b(x11), .c(new_n49_), .O(new_n54_));
  nor2   g25(.a(new_n54_), .b(new_n53_), .O(z09));
  nand2  g26(.a(new_n44_), .b(x12), .O(new_n56_));
  nand3  g27(.a(x11), .b(new_n49_), .c(x09), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(new_n56_), .O(z10));
  nand4  g29(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  nand3  g30(.a(new_n32_), .b(new_n30_), .c(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(new_n50_), .O(z11));
  inv1   g32(.a(x09), .O(new_n62_));
  nand4  g33(.a(x12), .b(x11), .c(new_n49_), .d(new_n62_), .O(new_n63_));
  inv1   g34(.a(new_n63_), .O(z12));
endmodule
