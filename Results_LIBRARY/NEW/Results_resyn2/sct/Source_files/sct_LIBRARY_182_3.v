...
module FAU ( 
  ...
  nand3  g24(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(new_n59_));
  inv1   g25(.a(new_n59_), .O(z04));
  inv1   g26(.a(x09), .O(new_n61_));
  nand3  g27(.a(new_n58_), .b(new_n48_), .c(new_n61_), .O(z05));
  nand2  g28(.a(new_n58_), .b(x10), .O(new_n63_));
  inv1   g29(.a(x10), .O(new_n64_));
  inv1   g30(.a(new_n58_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(new_n48_), .O(z06));
  ...
  nor3   g38(.a(new_n58_), .b(x11), .c(x10), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g40(.a(new_n70_), .b(x12), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z08));
  oai21  g42(.a(new_n70_), .b(x12), .c(x13), .O(new_n77_));
  inv1   g43(.a(x13), .O(new_n78_));
  nand3  g44(.a(new_n73_), .b(new_n78_), .c(new_n72_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z09));
  oai21  g46(.a(x03), .b(new_n36_), .c(x16), .O(new_n81_));
  inv1   g47(.a(x00), .O(new_n82_));
  nand4  g48(.a(new_n78_), .b(new_n72_), .c(new_n69_), .d(new_n64_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n65_), .c(new_n81_), .O(new_n85_));
