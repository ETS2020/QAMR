...
module FAU ( 
  ...
  nand3  g37(.a(new_n68_), .b(new_n71_), .c(new_n67_), .O(new_n72_));
  oai21  g38(.a(new_n64_), .b(x10), .c(x11), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n72_), .c(new_n48_), .O(z07));
  oai21  g40(.a(new_n64_), .b(x11), .c(x12), .O(new_n75_));
  nor2   g41(.a(x09), .b(new_n58_), .O(new_n76_));
  nor2   g42(.a(x12), .b(x11), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n56_), .d(new_n67_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n48_), .O(z08));
