...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
    ...
    new_n79_, new_n81_, new_n82_, new_n83_, new_n84_, new_n86_;
  ...
  oai21  g41(.a(new_n75_), .b(new_n53_), .c(new_n63_), .O(new_n76_));
  nand2  g42(.a(x12), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n76_), .c(new_n61_), .O(z08));
  inv1   g44(.a(x13), .O(new_n79_));
  nand2  g45(.a(new_n61_), .b(new_n79_), .O(z09));
  nand2  g46(.a(new_n60_), .b(x14), .O(new_n81_));
  inv1   g47(.a(new_n48_), .O(new_n82_));
  nor2   g48(.a(x09), .b(new_n54_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n45_), .d(x00), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n81_), .c(new_n41_), .O(z10));
  nand2  g51(.a(x16), .b(new_n36_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n58_), .c(new_n41_), .O(z12));
