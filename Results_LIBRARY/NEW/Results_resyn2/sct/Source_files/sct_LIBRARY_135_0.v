...
module FAU ( 
  ...
  nor2   g13(.a(x10), .b(x08), .O(new_n48_));
  ...
  oai21  g19(.a(new_n48_), .b(new_n52_), .c(new_n53_), .O(new_n54_));
  ...
  aoi21  g27(.a(new_n55_), .b(new_n61_), .c(new_n41_), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z04));
  inv1   g30(.a(x09), .O(new_n65_));
  nand3  g31(.a(new_n59_), .b(new_n65_), .c(x08), .O(new_n66_));
  nand2  g32(.a(new_n60_), .b(x09), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n47_), .O(z05));
  inv1   g34(.a(x10), .O(new_n69_));
  nand2  g35(.a(new_n55_), .b(new_n69_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n60_), .c(new_n58_), .O(new_n71_));
  nor2   g37(.a(new_n55_), .b(x09), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g39(.a(x10), .b(x09), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n71_), .d(new_n47_), .O(z06));
  nand2  g41(.a(new_n73_), .b(x11), .O(new_n76_));
  nor2   g42(.a(x11), .b(x10), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(z07));
  nand2  g45(.a(new_n78_), .b(x12), .O(new_n80_));
  inv1   g46(.a(x12), .O(new_n81_));
  nand3  g47(.a(new_n77_), .b(new_n72_), .c(new_n81_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n80_), .c(new_n47_), .O(z08));
  nand2  g49(.a(new_n82_), .b(x13), .O(new_n84_));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n77_), .b(new_n72_), .c(new_n85_), .d(new_n81_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n84_), .c(new_n47_), .O(z09));
  nand2  g53(.a(new_n46_), .b(x14), .O(new_n88_));
  nand2  g54(.a(x08), .b(x00), .O(new_n89_));
  inv1   g55(.a(x11), .O(new_n90_));
  nand4  g56(.a(new_n85_), .b(new_n81_), .c(new_n90_), .d(new_n69_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n72_), .c(new_n58_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n88_), .c(new_n41_), .O(z10));
  nand2  g60(.a(x16), .b(new_n36_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n44_), .c(new_n41_), .O(z12));
