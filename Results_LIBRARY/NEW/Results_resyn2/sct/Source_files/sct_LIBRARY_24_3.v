...
module FAU ( 
  ...
  nand2  g17(.a(new_n46_), .b(x07), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  oai21  g19(.a(x07), .b(x06), .c(x04), .O(new_n54_));
  aoi21  g20(.a(new_n53_), .b(x06), .c(new_n54_), .O(z03));
  nand3  g21(.a(new_n52_), .b(new_n51_), .c(x08), .O(new_n56_));
  inv1   g22(.a(x08), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(new_n44_), .O(new_n58_));
  nand2  g24(.a(x08), .b(x06), .O(new_n59_));
  nand3  g25(.a(new_n59_), .b(new_n58_), .c(x07), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(new_n56_), .c(new_n41_), .O(z04));
  ...
  inv1   g39(.a(x07), .O(new_n74_));
  nor2   g40(.a(x09), .b(new_n74_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n67_), .O(new_n76_));
  oai21  g42(.a(new_n65_), .b(x10), .c(x11), .O(new_n77_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n48_), .O(z08));
  inv1   g50(.a(x12), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n72_), .d(new_n67_), .O(new_n87_));
  nand2  g53(.a(x16), .b(new_n36_), .O(new_n88_));
  oai21  g54(.a(new_n87_), .b(new_n65_), .c(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(x04), .O(new_n90_));
  oai21  g56(.a(new_n46_), .b(new_n45_), .c(x04), .O(new_n91_));
  ...
  nand2  g62(.a(new_n47_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n41_), .O(z10));
  aoi21  g64(.a(new_n88_), .b(new_n45_), .c(new_n41_), .O(z12));
