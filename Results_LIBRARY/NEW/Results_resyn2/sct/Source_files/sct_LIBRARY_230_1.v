// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:38 2020
...
module FAU ( 
  ...
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n48_), .O(z09));
  ...
  aoi21  g53(.a(new_n87_), .b(new_n45_), .c(new_n41_), .O(z12));
