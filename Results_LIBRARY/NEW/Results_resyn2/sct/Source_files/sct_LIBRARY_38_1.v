// Benchmark "FAU" written by ABC on Mon Jul 27 17:49:51 2020
...
module FAU ( 
  ...
  nand2  g15(.a(new_n44_), .b(x02), .O(new_n50_));
  nor2   g16(.a(x16), .b(x07), .O(new_n51_));
  aoi21  g17(.a(new_n50_), .b(x16), .c(new_n51_), .O(new_n52_));
  nor2   g18(.a(new_n52_), .b(x06), .O(new_n53_));
  nand2  g19(.a(x07), .b(x06), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(x04), .O(new_n55_));
  nor2   g21(.a(new_n55_), .b(new_n53_), .O(z03));
  oai21  g22(.a(new_n46_), .b(x06), .c(x07), .O(new_n57_));
  nand2  g23(.a(new_n57_), .b(x08), .O(new_n58_));
  inv1   g24(.a(x08), .O(new_n59_));
  nand3  g25(.a(new_n52_), .b(new_n59_), .c(x06), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(new_n58_), .c(new_n40_), .O(z04));
  ...
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n47_), .O(z06));
  ...
  nand3  g46(.a(new_n80_), .b(new_n77_), .c(new_n73_), .O(new_n81_));
  inv1   g47(.a(x10), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n62_), .c(x08), .d(x06), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nor2   g50(.a(new_n45_), .b(x02), .O(new_n85_));
  aoi21  g51(.a(new_n84_), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  nand2  g52(.a(new_n78_), .b(x13), .O(new_n87_));
  nand2  g53(.a(x16), .b(x03), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(x04), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  oai21  g56(.a(new_n81_), .b(x10), .c(new_n90_), .O(new_n91_));
  nor3   g57(.a(x09), .b(new_n59_), .c(new_n43_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n91_), .c(new_n52_), .O(new_n93_));
