// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:09 2020
...
module FAU ( 
  ...
  nand3  g33(.a(new_n65_), .b(new_n48_), .c(new_n67_), .O(z06));
  ...
  nand3  g38(.a(new_n72_), .b(new_n69_), .c(new_n48_), .O(z07));
  ...
  nand3  g51(.a(new_n85_), .b(new_n71_), .c(new_n57_), .O(new_n86_));
