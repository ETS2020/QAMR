// Benchmark "FAU" written by ABC on Mon Jul 27 17:49:56 2020
...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n64_), .c(new_n47_), .O(z06));
  nand2  g35(.a(new_n68_), .b(x11), .O(new_n70_));
  inv1   g36(.a(x11), .O(new_n71_));
  nand4  g37(.a(new_n67_), .b(new_n71_), .c(new_n66_), .d(new_n65_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n47_), .O(z07));
  nand2  g39(.a(new_n72_), .b(x12), .O(new_n74_));
  nor2   g40(.a(x12), .b(x11), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n47_), .O(z08));
  nor2   g43(.a(new_n45_), .b(x02), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n71_), .d(new_n66_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n60_), .c(new_n78_), .O(new_n83_));
  nand2  g49(.a(new_n76_), .b(x13), .O(new_n84_));
  nand2  g50(.a(x16), .b(x03), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(x04), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  nand2  g53(.a(new_n44_), .b(x02), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(x16), .c(new_n87_), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n82_), .c(new_n60_), .O(new_n90_));
  nand2  g56(.a(new_n46_), .b(x14), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(new_n40_), .O(z10));
  nor2   g58(.a(new_n78_), .b(x03), .O(new_n93_));
