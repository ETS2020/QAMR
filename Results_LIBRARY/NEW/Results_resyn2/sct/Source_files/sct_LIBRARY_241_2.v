...
module FAU ( 
  ...
  nand3  g41(.a(x09), .b(x08), .c(x07), .O(new_n76_));
  ...
  nand2  g45(.a(new_n79_), .b(new_n61_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand2  g47(.a(new_n61_), .b(new_n81_), .O(z09));
  nand2  g48(.a(new_n60_), .b(x14), .O(new_n83_));
  nor2   g49(.a(new_n53_), .b(x09), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n45_), .c(x00), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n83_), .c(new_n41_), .O(z10));
