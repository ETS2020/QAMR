// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:37 2020
...
module FAU ( 
  ...
  nand4  g36(.a(new_n67_), .b(new_n70_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n61_), .d(new_n45_), .O(new_n79_));
  ...
  aoi21  g50(.a(new_n76_), .b(x13), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n82_), .O(z09));
  nand2  g52(.a(new_n46_), .b(x14), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n79_), .c(new_n41_), .O(z10));
  inv1   g54(.a(x03), .O(new_n89_));
  aoi21  g55(.a(new_n80_), .b(new_n89_), .c(new_n41_), .O(z12));
