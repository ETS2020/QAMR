...
module FAU ( 
  ...
  nand2  g23(.a(new_n50_), .b(new_n57_), .O(new_n58_));
  ...
  nand3  g41(.a(new_n75_), .b(new_n55_), .c(new_n45_), .O(new_n76_));
  ...
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(x13), .O(new_n83_));
  ...
  nand2  g53(.a(new_n82_), .b(new_n78_), .O(new_n88_));
