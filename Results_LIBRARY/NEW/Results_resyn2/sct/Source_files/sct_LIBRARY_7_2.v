...
module FAU ( 
  ...
  oai21  g39(.a(new_n65_), .b(x10), .c(x11), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z07));
  oai21  g41(.a(new_n65_), .b(x11), .c(x12), .O(new_n76_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n48_), .O(z08));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n69_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n83_));
  oai21  g49(.a(new_n78_), .b(new_n65_), .c(x13), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n48_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n82_), .b(new_n77_), .c(new_n72_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n69_), .c(new_n57_), .O(new_n89_));
