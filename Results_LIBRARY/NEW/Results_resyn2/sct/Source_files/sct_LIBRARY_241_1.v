...
module FAU ( 
  ...
  inv1   g36(.a(new_n56_), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n62_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n48_), .O(z07));
  inv1   g40(.a(x12), .O(new_n75_));
  nand4  g41(.a(new_n72_), .b(new_n71_), .c(new_n75_), .d(new_n62_), .O(new_n76_));
  inv1   g42(.a(new_n72_), .O(new_n77_));
  nand3  g43(.a(new_n62_), .b(x08), .c(x07), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n76_), .c(new_n48_), .O(z08));
  nand2  g46(.a(new_n72_), .b(new_n75_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n63_), .c(x13), .O(new_n82_));
  nor2   g48(.a(x13), .b(x12), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n72_), .c(new_n71_), .d(new_n62_), .O(new_n84_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n75_), .c(new_n89_), .d(new_n66_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n67_), .c(new_n87_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n86_), .c(new_n41_), .O(z10));
  nand2  g60(.a(x16), .b(new_n36_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n45_), .c(new_n41_), .O(z12));
