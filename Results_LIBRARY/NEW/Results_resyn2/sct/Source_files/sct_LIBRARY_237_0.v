...
module FAU ( 
  ...
  nand3  g34(.a(new_n68_), .b(new_n65_), .c(new_n48_), .O(z06));
  ...
  nand4  g40(.a(new_n67_), .b(new_n74_), .c(new_n70_), .d(new_n66_), .O(new_n75_));
  nand2  g41(.a(new_n71_), .b(x12), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n75_), .c(new_n48_), .O(z08));
  nand2  g43(.a(new_n75_), .b(x13), .O(new_n78_));
  inv1   g44(.a(x13), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n74_), .c(new_n70_), .d(new_n66_), .O(new_n80_));
  inv1   g46(.a(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n67_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n48_), .O(z09));
  inv1   g49(.a(x00), .O(new_n84_));
  nand2  g50(.a(new_n80_), .b(new_n84_), .O(new_n85_));
  nor2   g51(.a(new_n63_), .b(new_n47_), .O(new_n86_));
  nand3  g52(.a(x16), .b(x14), .c(x03), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n86_), .b(new_n85_), .c(new_n88_), .O(new_n89_));
  nand3  g55(.a(x16), .b(x14), .c(new_n36_), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n41_), .c(new_n90_), .O(z10));
  oai22  g57(.a(new_n46_), .b(x02), .c(new_n41_), .d(new_n45_), .O(z12));
