...
module FAU ( 
  ...
  nor2   g39(.a(x09), .b(new_n59_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n52_), .c(new_n73_), .d(new_n68_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n72_), .c(new_n48_), .O(z07));
  inv1   g42(.a(x12), .O(new_n77_));
  nand3  g43(.a(new_n75_), .b(new_n48_), .c(new_n77_), .O(z08));
  nand2  g44(.a(new_n75_), .b(x13), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n73_), .c(new_n68_), .O(new_n81_));
