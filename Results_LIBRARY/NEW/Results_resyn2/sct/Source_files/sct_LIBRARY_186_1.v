...
module FAU ( 
  ...
  nor2   g10(.a(new_n44_), .b(new_n41_), .O(new_n45_));
  nand2  g11(.a(new_n45_), .b(new_n40_), .O(new_n46_));
  inv1   g12(.a(new_n46_), .O(z02));
  nand2  g13(.a(x07), .b(x06), .O(new_n48_));
  inv1   g14(.a(x07), .O(new_n49_));
  nand2  g15(.a(new_n49_), .b(new_n40_), .O(new_n50_));
  nand3  g16(.a(new_n50_), .b(new_n48_), .c(new_n45_), .O(new_n51_));
  ...
  nand3  g22(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(new_n57_));
  ...
  nand3  g27(.a(new_n61_), .b(new_n59_), .c(new_n45_), .O(z05));
  ...
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(new_n45_), .O(z06));
  inv1   g33(.a(x11), .O(new_n68_));
  nor2   g34(.a(x09), .b(new_n55_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n53_), .c(new_n68_), .d(new_n64_), .O(new_n70_));
  oai21  g36(.a(new_n61_), .b(x10), .c(x11), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n45_), .O(z07));
  nand2  g38(.a(new_n70_), .b(x12), .O(new_n73_));
  nor2   g39(.a(x12), .b(x11), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n69_), .c(new_n53_), .d(new_n64_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n45_), .O(z08));
  ...
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n45_), .O(z09));
  nand2  g46(.a(new_n44_), .b(x14), .O(new_n81_));
  oai21  g47(.a(x03), .b(new_n36_), .c(x16), .O(new_n82_));
  inv1   g48(.a(x00), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand4  g50(.a(new_n78_), .b(new_n84_), .c(new_n68_), .d(new_n64_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n65_), .c(new_n82_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n81_), .c(new_n41_), .O(z10));
  nand2  g54(.a(x16), .b(new_n36_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n42_), .c(new_n41_), .O(z12));
