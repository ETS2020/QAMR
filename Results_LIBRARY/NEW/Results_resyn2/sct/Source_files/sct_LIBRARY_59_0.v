...
module FAU ( 
  ...
  nand3  g40(.a(new_n58_), .b(new_n45_), .c(x02), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n56_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n71_), .c(new_n48_), .O(z07));
  inv1   g44(.a(x11), .O(new_n79_));
  nand3  g45(.a(new_n68_), .b(new_n79_), .c(new_n67_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x12), .O(new_n81_));
  nor2   g47(.a(new_n51_), .b(x12), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n73_), .c(new_n72_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(z08));
  nand2  g50(.a(x16), .b(new_n36_), .O(new_n85_));
  nor2   g51(.a(x13), .b(x12), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n73_), .c(new_n46_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n64_), .c(new_n85_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x04), .O(new_n89_));
  oai21  g55(.a(new_n46_), .b(new_n45_), .c(x04), .O(new_n90_));
  aoi21  g56(.a(new_n83_), .b(x13), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n89_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  oai21  g59(.a(new_n47_), .b(new_n93_), .c(new_n87_), .O(new_n94_));
  ...
  aoi21  g63(.a(new_n85_), .b(new_n45_), .c(new_n41_), .O(z12));
  nor2   g64(.a(x08), .b(new_n36_), .O(new_n99_));
  oai21  g65(.a(new_n99_), .b(new_n72_), .c(x07), .O(new_n100_));
  oai21  g66(.a(new_n46_), .b(x02), .c(new_n45_), .O(new_n101_));
  nor3   g67(.a(new_n101_), .b(x11), .c(new_n44_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n41_), .O(z13));
