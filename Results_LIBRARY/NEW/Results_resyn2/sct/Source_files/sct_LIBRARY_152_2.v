...
module FAU ( 
  ...
  nand3  g33(.a(new_n63_), .b(new_n56_), .c(new_n67_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n48_), .O(z06));
  inv1   g35(.a(x11), .O(new_n70_));
  nand4  g36(.a(new_n63_), .b(new_n56_), .c(new_n70_), .d(new_n67_), .O(new_n71_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n63_), .c(new_n56_), .d(new_n67_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n48_), .O(z08));
  nand2  g43(.a(new_n76_), .b(x13), .O(new_n78_));
  nor2   g44(.a(x13), .b(x10), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n63_), .d(new_n56_), .O(new_n80_));
  ...
  nand3  g50(.a(new_n79_), .b(new_n75_), .c(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  inv1   g52(.a(x09), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(x08), .c(x06), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n82_), .c(new_n41_), .O(z10));
