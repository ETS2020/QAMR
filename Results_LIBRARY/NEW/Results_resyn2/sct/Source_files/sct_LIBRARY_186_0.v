...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n42_, new_n43_,
  ...
  aoi21  g05(.a(x05), .b(x04), .c(new_n39_), .O(z01));
  ...
  nor2   g11(.a(new_n45_), .b(new_n42_), .O(new_n46_));
  nand2  g12(.a(new_n46_), .b(new_n41_), .O(new_n47_));
  inv1   g13(.a(new_n47_), .O(z02));
  nand2  g14(.a(x07), .b(x06), .O(new_n49_));
  inv1   g15(.a(x07), .O(new_n50_));
  nand2  g16(.a(new_n50_), .b(new_n41_), .O(new_n51_));
  nand3  g17(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(new_n52_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n46_), .O(z07));
  ...
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n46_), .O(z08));
  ...
  nand3  g46(.a(new_n80_), .b(new_n78_), .c(new_n46_), .O(z09));
  nand2  g47(.a(new_n45_), .b(x14), .O(new_n82_));
  ...
  aoi21  g54(.a(new_n88_), .b(new_n82_), .c(new_n42_), .O(z10));
  nand2  g55(.a(x16), .b(new_n36_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n43_), .c(new_n42_), .O(z12));
