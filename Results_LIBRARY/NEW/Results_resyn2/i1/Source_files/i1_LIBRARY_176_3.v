// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:59 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n60_, new_n61_, new_n65_, new_n66_, new_n68_, new_n70_,
  ...
  nand4  g13(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(new_n54_), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(x00), .O(new_n56_));
  nand3  g15(.a(new_n47_), .b(new_n50_), .c(x08), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n56_), .c(new_n42_), .O(z02));
  or2    g17(.a(x21), .b(x20), .O(z04));
  inv1   g18(.a(x10), .O(new_n60_));
  nand3  g19(.a(x19), .b(new_n48_), .c(new_n54_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n46_), .c(new_n60_), .O(z05));
