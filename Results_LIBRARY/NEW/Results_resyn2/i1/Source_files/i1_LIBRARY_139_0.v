// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:47 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n62_, new_n63_, new_n65_, new_n67_, new_n70_, new_n72_,
    new_n73_;
  ...
  nor3   g22(.a(x24), .b(new_n63_), .c(new_n62_), .O(z10));
  inv1   g23(.a(x17), .O(new_n65_));
  nor3   g24(.a(x24), .b(new_n63_), .c(new_n65_), .O(z11));
  inv1   g25(.a(x23), .O(new_n67_));
  nor3   g26(.a(x24), .b(new_n67_), .c(new_n62_), .O(z12));
  nor3   g27(.a(x24), .b(new_n67_), .c(new_n65_), .O(z13));
  inv1   g28(.a(x16), .O(new_n70_));
  nor2   g29(.a(x24), .b(new_n70_), .O(z14));
  nor2   g30(.a(x13), .b(x12), .O(new_n72_));
  nor2   g31(.a(x15), .b(x14), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(z15));
  buf    g33(.a(x00), .O(z00));
  buf    g34(.a(x20), .O(z03));
  buf    g35(.a(x10), .O(z05));
  buf    g36(.a(x19), .O(z06));
