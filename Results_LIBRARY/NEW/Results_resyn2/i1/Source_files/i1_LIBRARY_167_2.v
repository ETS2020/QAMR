...
module FAU ( 
  ...
  oai21  g09(.a(new_n50_), .b(x07), .c(x09), .O(new_n51_));
  ...
  nand3  g15(.a(new_n47_), .b(new_n48_), .c(x08), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n56_), .c(new_n42_), .O(z02));
  or2    g17(.a(x21), .b(x20), .O(z04));
  inv1   g18(.a(x10), .O(new_n60_));
  nand2  g19(.a(x19), .b(new_n50_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n55_), .c(new_n60_), .O(z05));
