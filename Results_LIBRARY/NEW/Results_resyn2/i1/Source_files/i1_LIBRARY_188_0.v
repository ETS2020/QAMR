...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n66_, new_n67_, new_n70_,
  ...
  nor2   g27(.a(x24), .b(new_n67_), .O(z11));
  inv1   g28(.a(x23), .O(new_n70_));
  nor3   g29(.a(x24), .b(new_n70_), .c(new_n66_), .O(z12));
  nor2   g30(.a(x24), .b(new_n70_), .O(z13));
