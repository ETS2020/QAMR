// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:53 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n58_, new_n59_, new_n60_, new_n63_, new_n64_, new_n68_,
    new_n69_, new_n71_, new_n73_, new_n76_, new_n78_, new_n79_;
  inv1   g00(.a(x19), .O(new_n42_));
  nor2   g01(.a(x05), .b(x03), .O(new_n43_));
  nor2   g02(.a(x02), .b(x01), .O(new_n44_));
  nor2   g03(.a(x07), .b(x06), .O(new_n45_));
  ...
  oai21  g09(.a(new_n50_), .b(x04), .c(x09), .O(new_n51_));
  nand3  g10(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(x00), .c(new_n42_), .O(z01));
  nor3   g12(.a(x05), .b(x04), .c(x03), .O(new_n54_));
  nand4  g13(.a(new_n54_), .b(new_n49_), .c(new_n45_), .d(new_n44_), .O(new_n55_));
  inv1   g14(.a(x00), .O(new_n56_));
  inv1   g15(.a(x04), .O(new_n57_));
  nand4  g16(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  ...
  nand2  g22(.a(x19), .b(new_n50_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n46_), .c(new_n63_), .O(z05));
