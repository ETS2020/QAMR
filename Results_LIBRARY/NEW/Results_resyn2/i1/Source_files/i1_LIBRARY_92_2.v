...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n65_, new_n68_, new_n69_, new_n71_, new_n75_, new_n76_,
  ...
  nand4  g11(.a(new_n52_), .b(new_n50_), .c(new_n48_), .d(x00), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(new_n47_), .c(new_n43_), .O(z01));
  nand4  g13(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n48_), .O(new_n55_));
  ...
  nand4  g21(.a(x19), .b(new_n49_), .c(x08), .d(new_n48_), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(new_n62_), .c(new_n44_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n56_), .O(z02));
  or2    g25(.a(x21), .b(x20), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  nand2  g27(.a(x19), .b(new_n51_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n55_), .c(new_n68_), .O(z05));
