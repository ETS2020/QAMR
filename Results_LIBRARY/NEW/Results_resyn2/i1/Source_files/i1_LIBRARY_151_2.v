...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(new_n45_), .c(new_n50_), .d(new_n43_), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x19), .c(x04), .O(new_n59_));
  ...
  oai21  g29(.a(new_n44_), .b(new_n56_), .c(new_n42_), .O(z06));
