// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:55 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n63_, new_n67_, new_n68_,
    new_n70_, new_n72_, new_n75_, new_n77_, new_n78_;
  inv1   g00(.a(x19), .O(new_n42_));
  nor2   g01(.a(x02), .b(x01), .O(new_n43_));
  nor2   g02(.a(x07), .b(x06), .O(new_n44_));
  nor3   g03(.a(x05), .b(x04), .c(x03), .O(new_n45_));
  ...
  nor2   g12(.a(x04), .b(x03), .O(new_n54_));
  nand4  g13(.a(new_n54_), .b(new_n44_), .c(new_n43_), .d(new_n53_), .O(new_n55_));
  ...
  nand2  g19(.a(new_n44_), .b(new_n43_), .O(new_n61_));
  inv1   g20(.a(x08), .O(new_n62_));
  nand3  g21(.a(new_n54_), .b(x19), .c(new_n62_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(z05));
  and2   g23(.a(x24), .b(x18), .O(z07));
  and2   g24(.a(x24), .b(x11), .O(z09));
  inv1   g25(.a(x14), .O(new_n67_));
  inv1   g26(.a(x22), .O(new_n68_));
  nor3   g27(.a(x24), .b(new_n68_), .c(new_n67_), .O(z10));
  inv1   g28(.a(x17), .O(new_n70_));
  nor3   g29(.a(x24), .b(new_n68_), .c(new_n70_), .O(z11));
  inv1   g30(.a(x23), .O(new_n72_));
  nor3   g31(.a(x24), .b(new_n72_), .c(new_n67_), .O(z12));
  nor3   g32(.a(x24), .b(new_n72_), .c(new_n70_), .O(z13));
  inv1   g33(.a(x16), .O(new_n75_));
  nor2   g34(.a(x24), .b(new_n75_), .O(z14));
  nor2   g35(.a(x13), .b(x12), .O(new_n77_));
  nor2   g36(.a(x15), .b(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n77_), .O(z15));
  buf    g38(.a(x00), .O(z00));
  buf    g39(.a(x20), .O(z03));
  buf    g40(.a(x19), .O(z06));
  buf    g41(.a(x11), .O(z08));
