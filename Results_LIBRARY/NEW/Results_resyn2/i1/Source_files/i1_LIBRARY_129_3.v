// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:43 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n59_, new_n60_, new_n61_, new_n63_, new_n64_, new_n65_, new_n69_,
    new_n70_, new_n72_, new_n74_, new_n77_, new_n79_, new_n80_;
  ...
  nand3  g09(.a(new_n50_), .b(x08), .c(new_n49_), .O(new_n51_));
  nand4  g10(.a(new_n51_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n52_));
  inv1   g11(.a(x00), .O(new_n53_));
  nand3  g12(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand3  g14(.a(new_n55_), .b(new_n52_), .c(x19), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z02));
  or2    g16(.a(x21), .b(x20), .O(z04));
  inv1   g17(.a(x10), .O(new_n59_));
  inv1   g18(.a(x08), .O(new_n60_));
  nand3  g19(.a(x19), .b(new_n60_), .c(new_n49_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n54_), .c(new_n59_), .O(z05));
  inv1   g21(.a(new_n54_), .O(new_n63_));
  nand2  g22(.a(x07), .b(x00), .O(new_n64_));
  aoi21  g23(.a(x09), .b(x08), .c(new_n64_), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n63_), .c(new_n42_), .O(z06));
