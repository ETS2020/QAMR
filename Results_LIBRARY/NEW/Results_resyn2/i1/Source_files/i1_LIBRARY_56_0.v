...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n58_, new_n61_, new_n62_, new_n66_, new_n67_, new_n69_,
  ...
  nand4  g12(.a(new_n53_), .b(new_n51_), .c(new_n45_), .d(new_n43_), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x00), .c(new_n42_), .O(z01));
  and2   g14(.a(new_n45_), .b(new_n43_), .O(new_n56_));
  inv1   g15(.a(x06), .O(new_n57_));
  oai21  g16(.a(new_n57_), .b(x00), .c(x19), .O(new_n58_));
  aoi21  g17(.a(new_n51_), .b(new_n56_), .c(new_n58_), .O(z02));
  or2    g18(.a(x21), .b(x20), .O(z04));
  inv1   g19(.a(x10), .O(new_n61_));
  nand3  g20(.a(new_n43_), .b(x19), .c(new_n52_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n50_), .c(new_n61_), .O(z05));
