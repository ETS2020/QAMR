...
module FAU ( 
  ...
  inv1   g26(.a(new_n64_), .O(new_n72_));
  nand4  g27(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n73_));
  inv1   g28(.a(x22), .O(new_n74_));
  nand2  g29(.a(new_n69_), .b(new_n74_), .O(new_n75_));
  nand3  g30(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n53_), .O(z12));
  inv1   g32(.a(x23), .O(new_n78_));
  nand2  g33(.a(new_n73_), .b(new_n78_), .O(new_n79_));
  inv1   g34(.a(new_n69_), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(x23), .c(x22), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n79_), .c(new_n72_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n55_), .O(z13));
  inv1   g38(.a(x24), .O(new_n84_));
  oai21  g39(.a(new_n73_), .b(new_n78_), .c(new_n84_), .O(new_n85_));
  nand2  g40(.a(x24), .b(x23), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n80_), .c(x22), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n85_), .c(new_n72_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n57_), .O(z14));
  inv1   g45(.a(x25), .O(new_n91_));
  oai21  g46(.a(new_n86_), .b(new_n73_), .c(new_n91_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n59_), .O(z15));
  inv1   g49(.a(x26), .O(new_n95_));
  oai22  g50(.a(new_n64_), .b(new_n95_), .c(new_n47_), .d(new_n61_), .O(z16));
  zero   g51(.O(z00));
endmodule
