...
module FAU ( 
  ...
  xnor2a g36(.a(new_n74_), .b(x21), .O(new_n81_));
  nand2  g37(.a(x22), .b(x13), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(new_n69_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n81_), .c(new_n68_), .O(new_n84_));
  ...
  aoi21  g44(.a(new_n75_), .b(x14), .c(new_n88_), .O(new_n89_));
  ...
  and2   g64(.a(x20), .b(x19), .O(new_n109_));
  and2   g65(.a(x22), .b(x21), .O(new_n110_));
  nand4  g66(.a(new_n103_), .b(new_n110_), .c(new_n109_), .d(x25), .O(new_n111_));
  inv1   g67(.a(x25), .O(new_n112_));
  nand2  g68(.a(x24), .b(x23), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n46_), .c(new_n112_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n111_), .c(new_n108_), .O(new_n115_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n75_), .c(x19), .d(new_n119_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n68_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n118_), .c(new_n66_), .O(z16));
endmodule
