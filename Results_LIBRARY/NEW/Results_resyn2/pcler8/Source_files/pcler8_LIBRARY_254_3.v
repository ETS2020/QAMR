...
module FAU ( 
  ...
  oai22  g23(.a(new_n50_), .b(x19), .c(new_n48_), .d(new_n52_), .O(z09));
  and2   g24(.a(x20), .b(x19), .O(new_n69_));
  nand4  g25(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n70_));
  nand3  g26(.a(x22), .b(x21), .c(x12), .O(new_n71_));
  oai21  g27(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  nor2   g28(.a(x20), .b(x19), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  oai21  g31(.a(new_n48_), .b(new_n54_), .c(new_n75_), .O(z10));
  inv1   g32(.a(new_n70_), .O(new_n77_));
  nand3  g33(.a(x21), .b(x20), .c(x19), .O(new_n78_));
  and2   g34(.a(x22), .b(x13), .O(new_n79_));
  aoi21  g35(.a(new_n79_), .b(new_n77_), .c(new_n78_), .O(new_n80_));
  inv1   g36(.a(new_n50_), .O(new_n81_));
  oai21  g37(.a(new_n69_), .b(x21), .c(new_n81_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n80_), .c(new_n48_), .d(new_n56_), .O(z11));
  inv1   g39(.a(new_n78_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(x22), .O(new_n85_));
  aoi21  g41(.a(new_n77_), .b(x14), .c(new_n85_), .O(new_n86_));
  oai21  g42(.a(new_n84_), .b(x22), .c(new_n81_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n86_), .c(new_n58_), .O(z12));
  inv1   g44(.a(new_n46_), .O(new_n89_));
  inv1   g45(.a(new_n47_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(x15), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n89_), .c(x23), .O(new_n92_));
  aoi21  g48(.a(new_n46_), .b(new_n45_), .c(new_n50_), .O(new_n93_));
  ...
  nand2  g56(.a(new_n100_), .b(new_n89_), .O(new_n101_));
  ...
  nand4  g62(.a(new_n100_), .b(new_n106_), .c(new_n69_), .d(x25), .O(new_n107_));
  inv1   g63(.a(x25), .O(new_n108_));
  nand2  g64(.a(x24), .b(x23), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n46_), .c(new_n108_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n107_), .c(new_n105_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n50_), .c(new_n64_), .O(z15));
  nor2   g68(.a(new_n109_), .b(new_n46_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(x25), .c(x26), .O(new_n114_));
  inv1   g70(.a(x18), .O(new_n115_));
  nand3  g71(.a(new_n77_), .b(new_n89_), .c(new_n115_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n81_), .O(new_n117_));
  oai22  g73(.a(new_n117_), .b(new_n114_), .c(new_n48_), .d(new_n66_), .O(z16));
endmodule
