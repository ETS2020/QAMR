...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_,
    ...
    new_n79_, new_n80_, new_n82_, new_n84_, new_n86_;
  ...
  nor2   g27(.a(new_n72_), .b(x08), .O(new_n73_));
  nand4  g28(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n74_));
  inv1   g29(.a(x22), .O(new_n75_));
  nand2  g30(.a(new_n69_), .b(new_n75_), .O(new_n76_));
  nand4  g31(.a(new_n76_), .b(new_n74_), .c(new_n73_), .d(new_n63_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n53_), .O(z12));
  nand3  g33(.a(x22), .b(x21), .c(new_n63_), .O(new_n79_));
  nand4  g34(.a(x20), .b(x19), .c(x09), .d(new_n47_), .O(new_n80_));
  oai22  g35(.a(new_n80_), .b(new_n79_), .c(new_n47_), .d(new_n55_), .O(z13));
  inv1   g36(.a(x24), .O(new_n82_));
  oai22  g37(.a(new_n64_), .b(new_n82_), .c(new_n47_), .d(new_n57_), .O(z14));
  inv1   g38(.a(x25), .O(new_n84_));
  oai22  g39(.a(new_n64_), .b(new_n84_), .c(new_n47_), .d(new_n59_), .O(z15));
  inv1   g40(.a(x26), .O(new_n86_));
  oai22  g41(.a(new_n64_), .b(new_n86_), .c(new_n47_), .d(new_n61_), .O(z16));
  zero   g42(.O(z00));
endmodule
