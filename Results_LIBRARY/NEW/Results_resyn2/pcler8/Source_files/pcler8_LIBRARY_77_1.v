// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:33 2020
...
module FAU ( 
  ...
  nand3  g43(.a(new_n87_), .b(new_n69_), .c(x22), .O(new_n88_));
  inv1   g44(.a(x22), .O(new_n89_));
  nand2  g45(.a(new_n82_), .b(new_n89_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n88_), .c(new_n68_), .O(new_n91_));
  oai21  g47(.a(new_n48_), .b(new_n58_), .c(new_n91_), .O(z12));
  ...
  inv1   g75(.a(x19), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(x18), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n119_), .c(new_n81_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n68_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n117_), .c(new_n66_), .O(z16));
endmodule
