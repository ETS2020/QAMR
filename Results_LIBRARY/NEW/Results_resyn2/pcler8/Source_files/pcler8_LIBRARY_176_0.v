...
module FAU ( 
  ...
  nand2  g26(.a(x21), .b(x08), .O(new_n71_));
  nand4  g27(.a(new_n71_), .b(new_n70_), .c(new_n49_), .d(x09), .O(new_n72_));
  ...
  oai22  g42(.a(new_n86_), .b(new_n84_), .c(new_n48_), .d(new_n56_), .O(z11));
  ...
  nand4  g66(.a(new_n104_), .b(new_n110_), .c(new_n74_), .d(x25), .O(new_n111_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n81_), .c(x19), .d(new_n119_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n85_), .O(new_n123_));
