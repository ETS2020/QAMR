// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:53 2020
...
module FAU ( 
  ...
  nand3  g30(.a(new_n75_), .b(new_n73_), .c(new_n63_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n53_), .O(z12));
  inv1   g32(.a(x23), .O(new_n78_));
  oai22  g33(.a(new_n64_), .b(new_n78_), .c(new_n47_), .d(new_n55_), .O(z13));
  inv1   g34(.a(x24), .O(new_n80_));
  oai22  g35(.a(new_n64_), .b(new_n80_), .c(new_n47_), .d(new_n57_), .O(z14));
  inv1   g36(.a(x25), .O(new_n82_));
  oai22  g37(.a(new_n64_), .b(new_n82_), .c(new_n47_), .d(new_n59_), .O(z15));
  inv1   g38(.a(x26), .O(new_n84_));
  oai22  g39(.a(new_n64_), .b(new_n84_), .c(new_n47_), .d(new_n61_), .O(z16));
  zero   g40(.O(z00));
endmodule
