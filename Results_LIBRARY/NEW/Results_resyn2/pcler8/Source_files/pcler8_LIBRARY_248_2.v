...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n53_,
    ...
    new_n115_;
  nand4  g00(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n45_));
  ...
  nand2  g34(.a(new_n78_), .b(new_n53_), .O(z10));
  inv1   g35(.a(new_n45_), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(x13), .c(new_n46_), .O(new_n81_));
  oai21  g37(.a(new_n74_), .b(x21), .c(new_n67_), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n81_), .c(new_n55_), .O(z11));
  and2   g39(.a(x25), .b(x24), .O(new_n84_));
  and2   g40(.a(x23), .b(x14), .O(new_n85_));
  nand3  g41(.a(x21), .b(x20), .c(x19), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(x22), .O(new_n88_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n88_), .O(new_n89_));
  ...
  nand2  g48(.a(new_n84_), .b(x15), .O(new_n93_));
  nand2  g49(.a(x23), .b(x22), .O(new_n94_));
  nor2   g50(.a(new_n86_), .b(new_n94_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  inv1   g52(.a(x23), .O(new_n97_));
  nand2  g53(.a(new_n88_), .b(new_n97_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n96_), .c(new_n67_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n59_), .O(z13));
  nand3  g56(.a(x25), .b(x24), .c(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  inv1   g58(.a(new_n94_), .O(new_n103_));
  nand3  g59(.a(new_n87_), .b(new_n103_), .c(x24), .O(new_n104_));
  inv1   g60(.a(x24), .O(new_n105_));
  oai21  g61(.a(new_n86_), .b(new_n94_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n49_), .c(new_n61_), .O(z14));
  aoi21  g64(.a(new_n95_), .b(x24), .c(x25), .O(new_n109_));
  inv1   g65(.a(x17), .O(new_n110_));
  nand3  g66(.a(new_n87_), .b(new_n80_), .c(new_n110_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n67_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n109_), .c(new_n63_), .O(z15));
  nor3   g69(.a(new_n46_), .b(new_n45_), .c(x18), .O(new_n114_));
  oai21  g70(.a(x26), .b(x21), .c(new_n67_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n114_), .c(new_n65_), .O(z16));
endmodule
