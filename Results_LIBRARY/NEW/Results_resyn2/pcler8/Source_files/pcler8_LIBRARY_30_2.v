...
module FAU ( 
  ...
  nor2   g20(.a(new_n50_), .b(new_n64_), .O(z05));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(new_n82_));
  ...
  oai21  g42(.a(new_n79_), .b(x21), .c(new_n53_), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n86_), .c(new_n60_), .O(z11));
  ...
  aoi21  g51(.a(new_n90_), .b(x15), .c(new_n91_), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n52_), .c(new_n50_), .d(new_n64_), .O(z13));
  nor2   g53(.a(new_n91_), .b(x24), .O(new_n98_));
  nand4  g54(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n99_));
  nand2  g55(.a(new_n91_), .b(x24), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n98_), .c(new_n53_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n66_), .O(z14));
  nand3  g59(.a(x26), .b(x25), .c(x17), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  inv1   g61(.a(new_n46_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n93_), .c(x25), .O(new_n107_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n52_), .c(new_n68_), .O(z15));
  aoi21  g67(.a(new_n47_), .b(x25), .c(x26), .O(new_n112_));
  inv1   g68(.a(x18), .O(new_n113_));
  nand3  g69(.a(new_n49_), .b(new_n47_), .c(new_n113_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n53_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n112_), .c(new_n70_), .O(z16));
endmodule
