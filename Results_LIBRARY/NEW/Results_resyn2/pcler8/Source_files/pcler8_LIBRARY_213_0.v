// Benchmark "FAU" written by ABC on Mon Jul 27 18:38:08 2020
...
module FAU ( 
  ...
  nand4  g01(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n46_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n49_), .c(new_n62_), .O(z14));
  inv1   g64(.a(x25), .O(new_n109_));
  aoi21  g65(.a(x26), .b(x17), .c(new_n109_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n103_), .c(x24), .d(x21), .O(new_n111_));
  nand2  g67(.a(new_n104_), .b(new_n109_), .O(new_n112_));
  ...
  oai21  g72(.a(new_n116_), .b(new_n46_), .c(x26), .O(new_n117_));
  nand3  g73(.a(x25), .b(x24), .c(x23), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(x26), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n94_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n68_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n66_), .O(z16));
endmodule
