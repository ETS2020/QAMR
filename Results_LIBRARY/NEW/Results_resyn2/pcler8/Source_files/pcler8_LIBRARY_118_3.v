...
module FAU ( 
  ...
  oai21  g29(.a(new_n49_), .b(new_n53_), .c(new_n73_), .O(z09));
  ...
  oai21  g36(.a(new_n49_), .b(new_n55_), .c(new_n80_), .O(z10));
  ...
  oai21  g41(.a(new_n75_), .b(x21), .c(new_n69_), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n49_), .d(new_n57_), .O(z11));
  inv1   g43(.a(new_n83_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(x22), .O(new_n89_));
  aoi21  g45(.a(new_n82_), .b(x14), .c(new_n89_), .O(new_n90_));
  oai21  g46(.a(new_n88_), .b(x22), .c(new_n69_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n90_), .c(new_n59_), .O(z12));
  inv1   g48(.a(x23), .O(new_n93_));
  nand2  g49(.a(new_n45_), .b(new_n93_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n69_), .c(new_n47_), .O(new_n95_));
  oai21  g51(.a(new_n49_), .b(new_n61_), .c(new_n95_), .O(z13));
  nand4  g52(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  inv1   g54(.a(x24), .O(new_n99_));
  oai21  g55(.a(new_n45_), .b(new_n93_), .c(new_n99_), .O(new_n100_));
  and2   g56(.a(x24), .b(x23), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n46_), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n51_), .c(new_n63_), .O(z14));
  nand3  g60(.a(x26), .b(x25), .c(x17), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  and2   g62(.a(x22), .b(x21), .O(new_n107_));
  nand4  g63(.a(new_n101_), .b(new_n107_), .c(new_n75_), .d(x25), .O(new_n108_));
  inv1   g64(.a(x25), .O(new_n109_));
  nand2  g65(.a(x24), .b(x23), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n45_), .c(new_n109_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n108_), .c(new_n106_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n51_), .c(new_n65_), .O(z15));
  nor2   g69(.a(new_n110_), .b(new_n45_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n118_), .b(new_n82_), .c(x19), .d(new_n116_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n69_), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n115_), .c(new_n67_), .O(z16));
endmodule
