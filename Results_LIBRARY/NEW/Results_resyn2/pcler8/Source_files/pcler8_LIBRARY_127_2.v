...
module FAU ( 
  ...
  nand4  g24(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n87_), .b(x15), .c(new_n88_), .O(new_n93_));
  oai21  g49(.a(x23), .b(x21), .c(new_n68_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n93_), .c(new_n60_), .O(z13));
  nor2   g51(.a(new_n88_), .b(x24), .O(new_n96_));
  nand4  g52(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n97_));
  nand2  g53(.a(new_n88_), .b(x24), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n96_), .c(new_n68_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n62_), .O(z14));
  nand3  g57(.a(x26), .b(x25), .c(x17), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n46_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n90_), .c(x25), .O(new_n105_));
  ...
  oai21  g64(.a(new_n108_), .b(new_n50_), .c(new_n64_), .O(z15));
  nor2   g65(.a(new_n46_), .b(new_n45_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(x25), .c(x26), .O(new_n111_));
  inv1   g67(.a(x18), .O(new_n112_));
  nand2  g68(.a(new_n87_), .b(new_n112_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n88_), .c(new_n68_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n111_), .c(new_n66_), .O(z16));
endmodule
