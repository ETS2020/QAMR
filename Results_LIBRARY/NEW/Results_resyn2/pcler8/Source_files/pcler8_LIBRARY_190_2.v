...
module FAU ( 
  ...
  inv1   g30(.a(new_n47_), .O(new_n75_));
  nand3  g31(.a(x23), .b(x22), .c(x12), .O(new_n76_));
  ...
  oai21  g35(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z10));
  nand3  g36(.a(x23), .b(x22), .c(x13), .O(new_n81_));
  inv1   g37(.a(new_n81_), .O(new_n82_));
  aoi21  g38(.a(new_n82_), .b(new_n75_), .c(new_n46_), .O(new_n83_));
  inv1   g39(.a(x21), .O(new_n84_));
  nand2  g40(.a(new_n74_), .b(new_n84_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n68_), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n83_), .c(new_n56_), .O(z11));
  inv1   g43(.a(new_n69_), .O(new_n88_));
  ...
  oai21  g48(.a(new_n92_), .b(new_n90_), .c(new_n58_), .O(z12));
  inv1   g49(.a(new_n89_), .O(new_n94_));
  nand2  g50(.a(new_n75_), .b(x15), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n94_), .c(x23), .O(new_n96_));
  inv1   g52(.a(x23), .O(new_n97_));
  aoi21  g53(.a(new_n89_), .b(new_n97_), .c(new_n50_), .O(new_n98_));
  ...
  nand3  g62(.a(new_n106_), .b(new_n91_), .c(x22), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n104_), .c(new_n102_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n50_), .c(new_n62_), .O(z14));
  nor2   g65(.a(new_n105_), .b(new_n89_), .O(new_n110_));
  inv1   g66(.a(x25), .O(new_n111_));
  aoi21  g67(.a(x26), .b(x17), .c(new_n111_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g69(.a(new_n107_), .b(new_n111_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n68_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n64_), .O(z15));
  aoi21  g72(.a(new_n110_), .b(x25), .c(x26), .O(new_n117_));
  inv1   g73(.a(x18), .O(new_n118_));
  nand3  g74(.a(new_n94_), .b(new_n88_), .c(new_n118_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n68_), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n117_), .c(new_n66_), .O(z16));
endmodule
