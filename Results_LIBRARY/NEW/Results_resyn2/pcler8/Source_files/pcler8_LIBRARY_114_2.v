...
module FAU ( 
  ...
  nand2  g49(.a(new_n81_), .b(x15), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n93_), .c(x23), .O(new_n95_));
  ...
  nand2  g59(.a(new_n103_), .b(new_n93_), .O(new_n104_));
  ...
  nand4  g76(.a(new_n120_), .b(new_n87_), .c(x19), .d(new_n118_), .O(new_n121_));
