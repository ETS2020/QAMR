...
module FAU ( 
  ...
  nor2   g31(.a(new_n69_), .b(new_n75_), .O(new_n76_));
  and2   g32(.a(x21), .b(x12), .O(new_n77_));
  aoi21  g33(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(new_n78_));
  ...
  aoi21  g37(.a(new_n76_), .b(x13), .c(new_n81_), .O(new_n82_));
  inv1   g38(.a(x21), .O(new_n83_));
  nand2  g39(.a(new_n74_), .b(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n68_), .O(new_n85_));
  oai22  g41(.a(new_n85_), .b(new_n82_), .c(new_n48_), .d(new_n56_), .O(z11));
  ...
  oai21  g46(.a(new_n69_), .b(new_n88_), .c(new_n90_), .O(new_n91_));
  aoi21  g47(.a(new_n81_), .b(new_n75_), .c(x08), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(new_n93_));
  nand2  g49(.a(new_n49_), .b(x09), .O(new_n94_));
  ...
  nand2  g64(.a(new_n108_), .b(new_n96_), .O(new_n109_));
  ...
  nand3  g69(.a(new_n108_), .b(new_n96_), .c(x25), .O(new_n114_));
  inv1   g70(.a(x25), .O(new_n115_));
  oai21  g71(.a(new_n107_), .b(new_n46_), .c(new_n115_), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n50_), .c(new_n64_), .O(z15));
  nor2   g74(.a(new_n107_), .b(new_n46_), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(x25), .c(x26), .O(new_n120_));
  nor2   g76(.a(new_n69_), .b(x18), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n96_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n68_), .O(new_n123_));
  oai22  g79(.a(new_n123_), .b(new_n120_), .c(new_n48_), .d(new_n66_), .O(z16));
endmodule
