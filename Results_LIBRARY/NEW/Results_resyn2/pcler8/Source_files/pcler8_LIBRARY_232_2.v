...
module FAU ( 
  ...
  aoi21  g31(.a(x20), .b(x08), .c(x19), .O(new_n76_));
  ...
  nor2   g41(.a(new_n85_), .b(x08), .O(new_n86_));
  ...
  and2   g45(.a(x21), .b(x19), .O(new_n90_));
  nand2  g46(.a(x22), .b(x13), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n78_), .c(new_n90_), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n59_), .c(new_n54_), .O(new_n93_));
  inv1   g49(.a(new_n84_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x21), .c(new_n53_), .O(new_n95_));
  oai22  g51(.a(new_n95_), .b(new_n93_), .c(new_n59_), .d(new_n63_), .O(z11));
  inv1   g52(.a(x22), .O(new_n97_));
  nand3  g53(.a(x22), .b(x21), .c(x19), .O(new_n98_));
  inv1   g54(.a(x14), .O(new_n99_));
  nor2   g55(.a(new_n78_), .b(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(new_n59_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(x20), .c(new_n97_), .O(new_n102_));
  inv1   g58(.a(new_n98_), .O(new_n103_));
  oai21  g59(.a(new_n78_), .b(new_n99_), .c(new_n103_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n94_), .c(x21), .d(new_n59_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n102_), .c(new_n53_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n65_), .O(z12));
  inv1   g64(.a(x15), .O(new_n109_));
  oai21  g65(.a(new_n50_), .b(new_n109_), .c(new_n46_), .O(new_n110_));
  ...
  aoi22  g69(.a(new_n113_), .b(new_n110_), .c(x23), .d(new_n54_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n75_), .c(new_n67_), .O(z13));
  nand2  g71(.a(x24), .b(new_n54_), .O(new_n116_));
  inv1   g72(.a(x24), .O(new_n117_));
  oai21  g73(.a(new_n112_), .b(new_n111_), .c(new_n117_), .O(new_n118_));
  nand2  g74(.a(new_n49_), .b(x16), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n46_), .c(x24), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n59_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n116_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n69_), .O(z14));
  nand3  g80(.a(x22), .b(x21), .c(x19), .O(new_n125_));
  ...
  nand4  g85(.a(new_n129_), .b(new_n47_), .c(x24), .d(x23), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(x08), .O(new_n131_));
  nor2   g87(.a(new_n47_), .b(x20), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n131_), .c(new_n53_), .O(new_n133_));
  oai21  g89(.a(new_n59_), .b(new_n71_), .c(new_n133_), .O(z15));
  nor2   g90(.a(new_n48_), .b(x20), .O(new_n135_));
  inv1   g91(.a(x18), .O(new_n136_));
  nor2   g92(.a(new_n47_), .b(new_n117_), .O(new_n137_));
  nand3  g93(.a(new_n137_), .b(new_n46_), .c(new_n136_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(x26), .O(new_n139_));
  nand4  g95(.a(new_n137_), .b(new_n129_), .c(new_n48_), .d(x23), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n139_), .c(x08), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(new_n135_), .c(new_n53_), .O(new_n142_));
