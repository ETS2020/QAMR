...
module FAU ( 
  ...
  aoi21  g70(.a(x25), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  aoi21  g71(.a(new_n102_), .b(x25), .c(new_n115_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n50_), .c(new_n66_), .O(z16));
endmodule
