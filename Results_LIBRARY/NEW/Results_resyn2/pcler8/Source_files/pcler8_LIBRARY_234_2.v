...
module FAU ( 
  ...
  nor2   g26(.a(new_n50_), .b(new_n70_), .O(z08));
  ...
  nor2   g51(.a(new_n91_), .b(x23), .O(new_n96_));
  nand4  g52(.a(x25), .b(x24), .c(x23), .d(x15), .O(new_n97_));
  nand2  g53(.a(new_n91_), .b(x23), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n96_), .c(new_n53_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n64_), .O(z13));
  nand3  g57(.a(x25), .b(x24), .c(x16), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n46_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n93_), .c(x24), .O(new_n105_));
  ...
  oai21  g64(.a(new_n108_), .b(new_n52_), .c(new_n66_), .O(z14));
  aoi21  g65(.a(new_n47_), .b(x24), .c(x25), .O(new_n110_));
  inv1   g66(.a(x17), .O(new_n111_));
  nand3  g67(.a(new_n49_), .b(new_n47_), .c(new_n111_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n53_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n110_), .c(new_n68_), .O(z15));
  inv1   g70(.a(x20), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(x18), .c(x26), .O(new_n116_));
  nand3  g72(.a(x22), .b(x21), .c(x19), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n78_), .c(x20), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n53_), .O(new_n120_));
  oai21  g76(.a(new_n50_), .b(new_n70_), .c(new_n120_), .O(z16));
endmodule
