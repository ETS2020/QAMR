...
module FAU ( 
  ...
  aoi21  g34(.a(new_n62_), .b(new_n47_), .c(new_n60_), .O(new_n63_));
  nor3   g35(.a(new_n61_), .b(new_n44_), .c(x16), .O(new_n64_));
  oai21  g36(.a(new_n64_), .b(new_n63_), .c(new_n32_), .O(new_n65_));
  ...
  aoi21  g42(.a(new_n70_), .b(new_n47_), .c(new_n68_), .O(new_n71_));
  nor3   g43(.a(new_n69_), .b(new_n44_), .c(x17), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n32_), .O(new_n73_));
  ...
  oai21  g51(.a(new_n61_), .b(new_n79_), .c(new_n36_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n47_), .c(x18), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n78_), .c(new_n32_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n76_), .O(z8));
endmodule
