...
module FAU ( 
  ...
  nand4  g03(.a(x17), .b(x16), .c(x15), .d(x11), .O(new_n32_));
  inv1   g04(.a(new_n32_), .O(new_n33_));
  nand4  g05(.a(new_n33_), .b(x18), .c(x14), .d(x13), .O(new_n34_));
  ...
  nand2  g31(.a(new_n55_), .b(x16), .O(new_n60_));
  inv1   g32(.a(x16), .O(new_n61_));
  oai21  g33(.a(new_n50_), .b(new_n54_), .c(new_n61_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n60_), .c(new_n43_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n59_), .O(z6));
  nand2  g36(.a(x08), .b(x06), .O(new_n65_));
  aoi21  g37(.a(new_n55_), .b(x16), .c(x17), .O(new_n66_));
  nand3  g38(.a(new_n33_), .b(x14), .c(x13), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n43_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(z7));
  nand2  g41(.a(x08), .b(x07), .O(new_n70_));
  inv1   g42(.a(x18), .O(new_n71_));
  nand2  g43(.a(x14), .b(x13), .O(new_n72_));
  oai21  g44(.a(new_n32_), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n34_), .c(new_n43_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n70_), .O(z8));
endmodule
