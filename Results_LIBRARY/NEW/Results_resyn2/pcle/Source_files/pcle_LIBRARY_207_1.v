// Benchmark "FAU" written by ABC on Mon Jul 27 18:25:17 2020
...
module FAU ( 
  ...
  nand3  g33(.a(new_n61_), .b(new_n53_), .c(x15), .O(new_n62_));
  nand2  g34(.a(new_n54_), .b(new_n60_), .O(new_n63_));
  inv1   g35(.a(x09), .O(new_n64_));
  nor2   g36(.a(x10), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n59_), .O(z6));
  nand2  g39(.a(x08), .b(x06), .O(new_n68_));
  nor2   g40(.a(new_n60_), .b(new_n55_), .O(new_n69_));
  nand3  g41(.a(new_n53_), .b(new_n69_), .c(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  nand2  g43(.a(new_n53_), .b(new_n69_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n70_), .c(new_n43_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n68_), .O(z7));
  oai21  g47(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n76_));
  nor2   g48(.a(x18), .b(new_n71_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n53_), .c(new_n69_), .O(new_n78_));
