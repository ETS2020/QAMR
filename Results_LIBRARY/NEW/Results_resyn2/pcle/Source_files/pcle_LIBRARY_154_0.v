// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:59 2020
...
module FAU ( 
  ...
  nand2  g10(.a(new_n38_), .b(new_n36_), .O(z1));
  ...
  nand3  g24(.a(new_n52_), .b(new_n33_), .c(new_n30_), .O(new_n53_));
  ...
  oai21  g29(.a(new_n31_), .b(x15), .c(new_n33_), .O(new_n58_));
