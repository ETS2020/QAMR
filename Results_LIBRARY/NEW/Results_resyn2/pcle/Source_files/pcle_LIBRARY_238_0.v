...
module FAU ( 
  ...
  nand2  g08(.a(new_n33_), .b(x09), .O(new_n37_));
  oai21  g09(.a(new_n37_), .b(x11), .c(new_n36_), .O(z1));
  ...
  nand3  g39(.a(new_n54_), .b(new_n63_), .c(x17), .O(new_n68_));
  ...
  nand3  g46(.a(new_n74_), .b(new_n54_), .c(new_n63_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n44_), .O(new_n77_));
