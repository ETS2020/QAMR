...
module FAU ( 
  ...
  or2    g22(.a(x14), .b(x11), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(new_n32_), .c(new_n50_), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(new_n49_), .O(z4));
  nand2  g25(.a(x08), .b(x04), .O(new_n54_));
  nand4  g26(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n46_), .c(new_n30_), .O(new_n64_));
  ...
  nand3  g42(.a(new_n70_), .b(new_n67_), .c(new_n50_), .O(new_n71_));
