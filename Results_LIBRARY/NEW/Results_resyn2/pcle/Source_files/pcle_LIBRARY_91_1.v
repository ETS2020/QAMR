...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n46_));
  oai21  g18(.a(new_n46_), .b(new_n45_), .c(new_n43_), .O(z3));
  nand2  g19(.a(x08), .b(x03), .O(new_n48_));
  nor2   g20(.a(new_n35_), .b(x14), .O(new_n49_));
  nand4  g21(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n50_));
  nand4  g22(.a(new_n50_), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(new_n49_), .c(new_n48_), .O(z4));
  ...
  oai21  g34(.a(new_n50_), .b(new_n57_), .c(new_n62_), .O(new_n63_));
  and2   g35(.a(x16), .b(x15), .O(new_n64_));
  nand2  g36(.a(new_n55_), .b(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n54_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n61_), .O(z6));
  nand2  g39(.a(x08), .b(x06), .O(new_n68_));
  and2   g40(.a(x14), .b(x13), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(new_n44_), .c(new_n64_), .d(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  nand2  g43(.a(x16), .b(x15), .O(new_n72_));
  oai21  g44(.a(new_n50_), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n70_), .c(new_n54_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n68_), .O(z7));
  nand2  g47(.a(x08), .b(x07), .O(new_n76_));
  inv1   g48(.a(x18), .O(new_n77_));
  oai21  g49(.a(new_n50_), .b(new_n32_), .c(new_n77_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n36_), .c(new_n54_), .O(new_n79_));
