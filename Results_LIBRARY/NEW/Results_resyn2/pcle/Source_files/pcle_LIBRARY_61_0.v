// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:27 2020
...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n64_, new_n65_, new_n66_, new_n68_, new_n69_, new_n70_;
  ...
  nand2  g31(.a(new_n59_), .b(new_n57_), .O(z6));
  nand2  g32(.a(x08), .b(x06), .O(new_n61_));
  nor2   g33(.a(new_n34_), .b(new_n32_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(x17), .O(new_n63_));
  inv1   g35(.a(x17), .O(new_n64_));
  oai21  g36(.a(new_n34_), .b(new_n32_), .c(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n63_), .c(new_n45_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n61_), .O(z7));
  nand2  g39(.a(x08), .b(x07), .O(new_n68_));
  aoi21  g40(.a(new_n62_), .b(x17), .c(x18), .O(new_n69_));
  nand2  g41(.a(new_n36_), .b(new_n45_), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z8));
endmodule
