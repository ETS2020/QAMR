...
module FAU ( 
  ...
  nand3  g41(.a(new_n69_), .b(new_n62_), .c(new_n54_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n67_), .O(z7));
  nand2  g43(.a(x08), .b(x07), .O(new_n72_));
  inv1   g44(.a(x18), .O(new_n73_));
  nand2  g45(.a(x16), .b(x15), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n50_), .c(new_n73_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n35_), .c(new_n54_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n72_), .O(z8));
endmodule
