...
module FAU ( 
  ...
  nand3  g05(.a(x17), .b(x16), .c(x14), .O(new_n34_));
  ...
  oai21  g35(.a(new_n51_), .b(new_n57_), .c(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n33_), .b(x16), .c(x14), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n64_), .c(new_n50_), .O(new_n66_));
