...
module FAU ( 
  ...
  nand3  g19(.a(new_n30_), .b(x15), .c(new_n47_), .O(new_n48_));
  inv1   g20(.a(new_n48_), .O(new_n49_));
  oai21  g21(.a(new_n30_), .b(new_n47_), .c(new_n43_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n49_), .c(new_n46_), .O(z4));
  nand2  g23(.a(x08), .b(x04), .O(new_n52_));
  aoi21  g24(.a(new_n30_), .b(x15), .c(new_n47_), .O(new_n53_));
  oai21  g25(.a(new_n30_), .b(x15), .c(new_n53_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n43_), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n52_), .O(z5));
  nand2  g28(.a(x08), .b(x05), .O(new_n57_));
  inv1   g29(.a(x16), .O(new_n58_));
  nand2  g30(.a(x15), .b(x14), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n30_), .c(new_n58_), .O(new_n60_));
  inv1   g32(.a(new_n30_), .O(new_n61_));
  nand3  g33(.a(x16), .b(x15), .c(x14), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n60_), .c(new_n43_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n57_), .O(z6));
  nand2  g38(.a(x08), .b(x06), .O(new_n67_));
  nand3  g39(.a(new_n63_), .b(new_n61_), .c(x17), .O(new_n68_));
  ...
  nand4  g45(.a(new_n63_), .b(new_n61_), .c(new_n29_), .d(x17), .O(new_n74_));
