...
module FAU ( 
  ...
  aoi21  g36(.a(new_n63_), .b(x14), .c(new_n64_), .O(new_n65_));
  nand2  g37(.a(new_n64_), .b(new_n63_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n46_), .c(new_n30_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  nand2  g41(.a(new_n35_), .b(new_n33_), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  nand2  g43(.a(x16), .b(x15), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n32_), .c(new_n71_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n70_), .c(new_n50_), .O(new_n74_));
  ...
  nand3  g50(.a(new_n78_), .b(new_n36_), .c(new_n50_), .O(new_n79_));
