...
module FAU ( 
  ...
  aoi21  g20(.a(new_n30_), .b(new_n46_), .c(new_n48_), .O(z4));
  nand2  g21(.a(x08), .b(x04), .O(new_n50_));
  inv1   g22(.a(new_n47_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(x15), .O(new_n52_));
  ...
  nor2   g31(.a(new_n58_), .b(new_n53_), .O(new_n60_));
  nand2  g32(.a(new_n51_), .b(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(new_n43_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n57_), .O(z6));
  nand2  g35(.a(x08), .b(x06), .O(new_n64_));
  nand3  g36(.a(new_n51_), .b(new_n60_), .c(x17), .O(new_n65_));
  ...
  oai21  g41(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n70_));
  nor2   g42(.a(x18), .b(new_n66_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n51_), .c(new_n60_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n43_), .O(new_n74_));
