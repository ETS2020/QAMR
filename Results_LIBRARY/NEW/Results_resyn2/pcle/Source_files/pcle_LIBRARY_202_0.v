...
module FAU ( 
  ...
  nand3  g22(.a(new_n50_), .b(new_n48_), .c(new_n43_), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(new_n47_), .O(z4));
  nand2  g24(.a(x08), .b(x04), .O(new_n53_));
  inv1   g25(.a(x15), .O(new_n54_));
  nand2  g26(.a(new_n48_), .b(new_n54_), .O(new_n55_));
  nor2   g27(.a(new_n54_), .b(new_n49_), .O(new_n56_));
  inv1   g28(.a(new_n44_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n55_), .c(new_n43_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n53_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n61_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(x16), .O(new_n62_));
  ...
  oai21  g41(.a(new_n69_), .b(new_n68_), .c(x17), .O(new_n70_));
  inv1   g42(.a(x17), .O(new_n71_));
  inv1   g43(.a(new_n68_), .O(new_n72_));
  inv1   g44(.a(new_n69_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n70_), .c(x11), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n67_), .O(z7));
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n78_));
  nor2   g50(.a(new_n71_), .b(new_n63_), .O(new_n79_));
  inv1   g51(.a(new_n48_), .O(new_n80_));
  nor2   g52(.a(x18), .b(new_n54_), .O(new_n81_));
