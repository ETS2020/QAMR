// Benchmark "FAU" written by ABC on Mon Jul 27 18:25:28 2020
...
module FAU ( 
  ...
  nand3  g14(.a(new_n30_), .b(new_n33_), .c(x09), .O(new_n43_));
  oai21  g15(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(z3));
  ...
  oai21  g22(.a(new_n50_), .b(new_n47_), .c(new_n45_), .O(z4));
  ...
  nand3  g28(.a(new_n56_), .b(new_n54_), .c(new_n48_), .O(new_n57_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n61_), .c(new_n48_), .O(new_n64_));
  ...
  nand3  g41(.a(new_n69_), .b(new_n67_), .c(new_n48_), .O(new_n70_));
