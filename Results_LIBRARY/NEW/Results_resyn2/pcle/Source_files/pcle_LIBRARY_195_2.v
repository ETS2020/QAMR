...
module FAU ( 
  ...
  oai21  g16(.a(x13), .b(x12), .c(new_n44_), .O(new_n45_));
  oai21  g17(.a(new_n45_), .b(new_n31_), .c(new_n43_), .O(z3));
  nand2  g18(.a(x08), .b(x03), .O(new_n47_));
  aoi21  g19(.a(x12), .b(x11), .c(x14), .O(new_n48_));
  inv1   g20(.a(x09), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(x08), .O(new_n50_));
  nand3  g22(.a(new_n32_), .b(new_n50_), .c(new_n30_), .O(new_n51_));
  oai21  g23(.a(new_n51_), .b(new_n48_), .c(new_n47_), .O(z4));
  ...
  nand3  g35(.a(new_n63_), .b(new_n50_), .c(new_n30_), .O(new_n64_));
