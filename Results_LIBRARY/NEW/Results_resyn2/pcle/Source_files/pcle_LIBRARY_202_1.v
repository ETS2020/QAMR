...
module FAU ( 
  ...
  oai21  g35(.a(new_n52_), .b(new_n56_), .c(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n45_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n61_), .O(z6));
  inv1   g38(.a(x17), .O(new_n67_));
  and2   g39(.a(x16), .b(x15), .O(new_n68_));
  aoi21  g40(.a(new_n68_), .b(new_n33_), .c(new_n67_), .O(new_n69_));
  nand3  g41(.a(new_n67_), .b(x16), .c(x15), .O(new_n70_));
  nor2   g42(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  oai21  g43(.a(new_n71_), .b(new_n69_), .c(new_n45_), .O(new_n72_));
