...
module FAU ( 
  ...
  nor2   g21(.a(x14), .b(x13), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n47_), .c(new_n49_), .O(z4));
  nand2  g23(.a(x08), .b(x04), .O(new_n52_));
  inv1   g24(.a(new_n31_), .O(new_n53_));
  nand4  g25(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n54_));
  ...
  nor2   g32(.a(new_n54_), .b(new_n60_), .O(new_n61_));
  nand2  g33(.a(new_n54_), .b(new_n60_), .O(new_n62_));
  nand3  g34(.a(new_n62_), .b(new_n46_), .c(new_n30_), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n61_), .c(new_n59_), .O(z6));
  nand2  g36(.a(x08), .b(x06), .O(new_n65_));
  nand2  g37(.a(new_n35_), .b(new_n33_), .O(new_n66_));
  inv1   g38(.a(x17), .O(new_n67_));
  nand2  g39(.a(x16), .b(x15), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n32_), .c(new_n67_), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(new_n66_), .c(new_n53_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n65_), .O(z7));
  nand2  g43(.a(x08), .b(x07), .O(new_n72_));
  inv1   g44(.a(x18), .O(new_n73_));
  oai21  g45(.a(new_n34_), .b(new_n32_), .c(new_n73_), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n36_), .c(new_n53_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n72_), .O(z8));
endmodule
