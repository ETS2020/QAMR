...
module FAU ( 
  ...
  or2    g31(.a(x16), .b(x11), .O(new_n60_));
  nand3  g32(.a(new_n60_), .b(new_n56_), .c(new_n45_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n59_), .O(z6));
  ...
  oai21  g38(.a(new_n34_), .b(new_n32_), .c(new_n66_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n63_), .O(z7));
  nand2  g41(.a(x08), .b(x07), .O(new_n70_));
  aoi21  g42(.a(new_n64_), .b(x17), .c(x18), .O(new_n71_));
  nand2  g43(.a(new_n36_), .b(new_n45_), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(z8));
endmodule
