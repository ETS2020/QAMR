...
module FAU ( 
  ...
  and2   g04(.a(x14), .b(x13), .O(new_n33_));
  ...
  nor2   g15(.a(new_n32_), .b(x13), .O(new_n44_));
  ...
  nand3  g29(.a(new_n33_), .b(new_n32_), .c(x15), .O(new_n58_));
  ...
  oai21  g34(.a(new_n51_), .b(new_n56_), .c(new_n62_), .O(new_n63_));
  nand2  g35(.a(x16), .b(x15), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n33_), .c(new_n32_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n63_), .c(new_n55_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n61_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  inv1   g41(.a(x17), .O(new_n70_));
  oai21  g42(.a(new_n64_), .b(new_n51_), .c(new_n70_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n36_), .c(new_n55_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n69_), .O(z7));
  nand2  g45(.a(x08), .b(x07), .O(new_n74_));
  inv1   g46(.a(x18), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n49_), .O(new_n76_));
