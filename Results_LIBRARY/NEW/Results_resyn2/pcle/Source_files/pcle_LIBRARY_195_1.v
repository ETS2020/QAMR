// Benchmark "FAU" written by ABC on Mon Jul 27 18:25:13 2020
...
module FAU ( 
  ...
  nand2  g18(.a(x13), .b(x11), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(new_n46_), .c(new_n30_), .O(new_n48_));
  oai21  g20(.a(new_n48_), .b(new_n44_), .c(new_n43_), .O(z3));
  nand2  g21(.a(x08), .b(x03), .O(new_n50_));
  aoi21  g22(.a(x13), .b(x11), .c(x14), .O(new_n51_));
  nand3  g23(.a(new_n32_), .b(new_n46_), .c(new_n30_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(z4));
  nand2  g25(.a(x08), .b(x04), .O(new_n54_));
  inv1   g26(.a(new_n31_), .O(new_n55_));
  nand4  g27(.a(x15), .b(x14), .c(x13), .d(x11), .O(new_n56_));
  ...
  nor2   g34(.a(new_n56_), .b(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n56_), .b(new_n62_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n46_), .c(new_n30_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(z6));
  nand2  g38(.a(x08), .b(x06), .O(new_n67_));
  nand2  g39(.a(new_n35_), .b(new_n33_), .O(new_n68_));
  inv1   g40(.a(x17), .O(new_n69_));
  nand2  g41(.a(x16), .b(x15), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n32_), .c(new_n69_), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(new_n68_), .c(new_n55_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n67_), .O(z7));
  nand2  g45(.a(x08), .b(x07), .O(new_n74_));
  inv1   g46(.a(x18), .O(new_n75_));
  oai21  g47(.a(new_n34_), .b(new_n32_), .c(new_n75_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n36_), .c(new_n55_), .O(new_n77_));
