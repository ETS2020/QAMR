...
module FAU ( 
  ...
  oai21  g17(.a(new_n44_), .b(new_n31_), .c(new_n45_), .O(z3));
  nand2  g18(.a(x08), .b(x03), .O(new_n47_));
  inv1   g19(.a(x09), .O(new_n48_));
  nor2   g20(.a(new_n48_), .b(x08), .O(new_n49_));
  nand3  g21(.a(new_n32_), .b(new_n49_), .c(new_n30_), .O(new_n50_));
  inv1   g22(.a(x14), .O(new_n51_));
  nand2  g23(.a(new_n43_), .b(new_n51_), .O(new_n52_));
  oai21  g24(.a(new_n43_), .b(x13), .c(new_n52_), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n50_), .c(new_n47_), .O(z4));
  nand2  g26(.a(x08), .b(x04), .O(new_n55_));
  inv1   g27(.a(new_n31_), .O(new_n56_));
  nand4  g28(.a(x15), .b(x14), .c(x12), .d(x11), .O(new_n57_));
  inv1   g29(.a(x15), .O(new_n58_));
  nand2  g30(.a(new_n32_), .b(new_n58_), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(new_n57_), .c(new_n56_), .O(new_n60_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n49_), .c(new_n30_), .O(new_n66_));
  ...
  nand3  g44(.a(new_n72_), .b(new_n69_), .c(new_n56_), .O(new_n73_));
  ...
  nand3  g49(.a(new_n77_), .b(new_n36_), .c(new_n56_), .O(new_n78_));
