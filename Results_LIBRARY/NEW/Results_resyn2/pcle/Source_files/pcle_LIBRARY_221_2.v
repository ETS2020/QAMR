...
module FAU ( 
  ...
  nor2   g21(.a(new_n33_), .b(x14), .O(new_n50_));
  nand4  g22(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n51_));
  nand3  g23(.a(new_n51_), .b(new_n46_), .c(new_n30_), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(new_n50_), .c(new_n49_), .O(z4));
  nand2  g25(.a(x08), .b(x04), .O(new_n54_));
  nor2   g26(.a(x15), .b(x14), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n52_), .c(new_n54_), .O(z5));
  nand2  g28(.a(x08), .b(x05), .O(new_n57_));
  inv1   g29(.a(x16), .O(new_n58_));
  nor2   g30(.a(new_n51_), .b(new_n58_), .O(new_n59_));
  nand2  g31(.a(new_n51_), .b(new_n58_), .O(new_n60_));
  ...
  nand2  g38(.a(x16), .b(x14), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n32_), .c(new_n66_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n65_), .c(new_n64_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n63_), .O(z7));
  nand2  g42(.a(x08), .b(x07), .O(new_n71_));
  inv1   g43(.a(x18), .O(new_n72_));
  oai21  g44(.a(new_n34_), .b(new_n32_), .c(new_n72_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n36_), .c(new_n64_), .O(new_n74_));
