...
module FAU ( 
  ...
  nand3  g40(.a(new_n53_), .b(new_n62_), .c(x17), .O(new_n69_));
  inv1   g41(.a(x17), .O(new_n70_));
  nand2  g42(.a(new_n63_), .b(new_n70_), .O(new_n71_));
  ...
  nor2   g46(.a(x18), .b(new_n70_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n53_), .c(new_n62_), .O(new_n76_));
