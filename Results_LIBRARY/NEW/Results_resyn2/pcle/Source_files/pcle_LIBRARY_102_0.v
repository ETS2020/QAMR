...
module FAU ( 
  ...
  inv1   g17(.a(new_n37_), .O(new_n46_));
  ...
  nand3  g29(.a(new_n31_), .b(x15), .c(x14), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n55_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n61_));
  inv1   g33(.a(x16), .O(new_n62_));
  nor2   g34(.a(new_n58_), .b(new_n62_), .O(new_n63_));
  nand2  g35(.a(new_n58_), .b(new_n62_), .O(new_n64_));
  inv1   g36(.a(x09), .O(new_n65_));
  nand2  g37(.a(new_n36_), .b(new_n35_), .O(new_n66_));
  aoi21  g38(.a(x16), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n63_), .c(new_n61_), .O(z6));
  nand2  g41(.a(x08), .b(x06), .O(new_n70_));
  nor2   g42(.a(new_n63_), .b(x17), .O(new_n71_));
  nand2  g43(.a(new_n67_), .b(new_n34_), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(z7));
  oai21  g45(.a(new_n32_), .b(new_n30_), .c(x18), .O(new_n74_));
  nand4  g46(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n50_), .c(new_n74_), .O(new_n76_));
  nor2   g48(.a(new_n29_), .b(x16), .O(new_n77_));
  aoi21  g49(.a(new_n76_), .b(x09), .c(new_n77_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x07), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n66_), .c(new_n79_), .O(z8));
endmodule
