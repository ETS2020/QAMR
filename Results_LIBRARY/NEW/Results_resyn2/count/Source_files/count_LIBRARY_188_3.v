...
module FAU ( 
  ...
  nand3  g121(.a(new_n101_), .b(new_n100_), .c(new_n55_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n172_), .c(x32), .O(new_n174_));
  inv1   g123(.a(x26), .O(new_n175_));
  inv1   g124(.a(x32), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n162_), .c(new_n175_), .d(new_n103_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n152_), .c(new_n95_), .d(new_n63_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n174_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(x16), .O(new_n181_));
  inv1   g130(.a(x18), .O(new_n182_));
  oai21  g131(.a(x16), .b(x02), .c(new_n182_), .O(new_n183_));
  aoi21  g132(.a(x32), .b(x20), .c(new_n183_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n181_), .O(z13));
  nor2   g134(.a(x32), .b(x31), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n159_), .c(new_n130_), .d(new_n129_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n102_), .c(x33), .O(new_n188_));
  inv1   g137(.a(x33), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n176_), .c(new_n148_), .d(new_n175_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n164_), .c(new_n105_), .d(new_n71_), .O(new_n192_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n171_), .c(new_n159_), .d(new_n120_), .O(new_n201_));
