...
module FAU ( 
  ...
  or2    g097(.a(new_n148_), .b(new_n123_), .O(new_n149_));
  nor2   g098(.a(x18), .b(new_n52_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n149_), .c(new_n146_), .O(z12));
  oai21  g100(.a(new_n148_), .b(new_n123_), .c(x32), .O(new_n152_));
  nor3   g101(.a(x32), .b(x31), .c(x30), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n133_), .c(new_n130_), .d(new_n87_), .O(new_n154_));
  ...
  nor3   g108(.a(x33), .b(x26), .c(x25), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n153_), .c(new_n133_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n163_), .b(new_n52_), .c(new_n165_), .O(z14));
  oai21  g115(.a(new_n161_), .b(new_n94_), .c(x34), .O(new_n167_));
  inv1   g116(.a(x34), .O(new_n168_));
  inv1   g117(.a(new_n94_), .O(new_n169_));
  nand2  g118(.a(new_n131_), .b(new_n143_), .O(new_n170_));
  inv1   g119(.a(x33), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n107_), .c(new_n106_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n169_), .d(new_n168_), .O(new_n174_));
