...
module FAU ( 
  ...
  nand2  g042(.a(new_n93_), .b(new_n85_), .O(z05));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  aoi22  g044(.a(new_n95_), .b(new_n80_), .c(new_n88_), .d(x25), .O(new_n96_));
  ...
  aoi21  g049(.a(new_n95_), .b(new_n80_), .c(new_n100_), .O(new_n101_));
  nand4  g050(.a(new_n95_), .b(new_n89_), .c(new_n60_), .d(new_n100_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n95_), .c(new_n80_), .d(new_n100_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n122_), .b(new_n95_), .c(new_n80_), .d(new_n100_), .O(new_n123_));
  ...
  oai21  g078(.a(new_n129_), .b(new_n102_), .c(x30), .O(new_n130_));
  inv1   g079(.a(x29), .O(new_n131_));
  inv1   g080(.a(x30), .O(new_n132_));
  nand3  g081(.a(new_n113_), .b(new_n132_), .c(new_n131_), .O(new_n133_));
  inv1   g082(.a(new_n133_), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n95_), .c(new_n80_), .d(new_n100_), .O(new_n135_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n122_), .c(new_n132_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n102_), .c(x33), .O(new_n157_));
  inv1   g106(.a(x33), .O(new_n158_));
  inv1   g107(.a(new_n144_), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n80_), .c(new_n158_), .d(new_n150_), .O(new_n160_));
  ...
  oai21  g115(.a(new_n60_), .b(x34), .c(x16), .O(new_n167_));
  inv1   g116(.a(x00), .O(new_n168_));
  aoi21  g117(.a(new_n52_), .b(new_n168_), .c(x18), .O(new_n169_));
  oai21  g118(.a(new_n167_), .b(new_n166_), .c(new_n169_), .O(z15));
endmodule
