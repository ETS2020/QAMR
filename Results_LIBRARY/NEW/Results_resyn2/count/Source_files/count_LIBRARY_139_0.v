...
module FAU ( 
  ...
  nand3  g18(.a(new_n58_), .b(new_n65_), .c(new_n57_), .O(new_n70_));
  ...
  nand4  g30(.a(new_n71_), .b(new_n58_), .c(new_n81_), .d(new_n57_), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(x24), .O(new_n83_));
  nor2   g32(.a(x24), .b(x23), .O(new_n84_));
  nand4  g33(.a(new_n84_), .b(new_n71_), .c(new_n58_), .d(new_n57_), .O(new_n85_));
  ...
  nand4  g41(.a(new_n84_), .b(new_n71_), .c(new_n60_), .d(new_n92_), .O(new_n93_));
