...
module FAU ( 
  ...
  aoi22  g040(.a(new_n91_), .b(new_n79_), .c(new_n85_), .d(x25), .O(new_n92_));
  ...
  nand2  g044(.a(new_n91_), .b(new_n79_), .O(new_n96_));
  nor2   g045(.a(x26), .b(x25), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n86_), .c(new_n96_), .d(x26), .O(new_n98_));
  inv1   g047(.a(x08), .O(new_n99_));
  aoi21  g048(.a(new_n52_), .b(new_n99_), .c(x18), .O(new_n100_));
  oai21  g049(.a(new_n98_), .b(new_n52_), .c(new_n100_), .O(z07));
  nand2  g050(.a(new_n97_), .b(new_n86_), .O(new_n102_));
  nor3   g051(.a(x27), .b(x26), .c(x25), .O(new_n103_));
  aoi22  g052(.a(new_n103_), .b(new_n86_), .c(new_n102_), .d(x27), .O(new_n104_));
  inv1   g053(.a(x07), .O(new_n105_));
  aoi21  g054(.a(new_n52_), .b(new_n105_), .c(x18), .O(new_n106_));
  oai21  g055(.a(new_n104_), .b(new_n52_), .c(new_n106_), .O(z08));
  nand2  g056(.a(new_n103_), .b(new_n86_), .O(new_n108_));
  inv1   g057(.a(x27), .O(new_n109_));
  inv1   g058(.a(x28), .O(new_n110_));
  nand3  g059(.a(new_n97_), .b(new_n110_), .c(new_n109_), .O(new_n111_));
  ...
  inv1   g065(.a(x29), .O(new_n117_));
  nor2   g066(.a(x29), .b(x28), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n103_), .c(new_n86_), .O(new_n119_));
  ...
  aoi22  g074(.a(new_n125_), .b(new_n112_), .c(new_n119_), .d(x30), .O(new_n126_));
  inv1   g075(.a(x04), .O(new_n127_));
  aoi21  g076(.a(new_n52_), .b(new_n127_), .c(x18), .O(new_n128_));
  oai21  g077(.a(new_n126_), .b(new_n52_), .c(new_n128_), .O(z11));
  inv1   g078(.a(new_n111_), .O(new_n130_));
  nand3  g079(.a(new_n125_), .b(new_n130_), .c(new_n86_), .O(new_n131_));
  nor2   g080(.a(x31), .b(x30), .O(new_n132_));
  nor2   g081(.a(x27), .b(x26), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n118_), .c(new_n91_), .O(new_n134_));
  nor2   g083(.a(new_n134_), .b(new_n78_), .O(new_n135_));
  aoi22  g084(.a(new_n135_), .b(new_n132_), .c(new_n131_), .d(x31), .O(new_n136_));
  ...
  nand2  g088(.a(new_n132_), .b(new_n118_), .O(new_n140_));
  inv1   g089(.a(new_n140_), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n103_), .c(new_n86_), .O(new_n142_));
  nor3   g091(.a(x32), .b(x31), .c(x30), .O(new_n143_));
  aoi22  g092(.a(new_n143_), .b(new_n135_), .c(new_n142_), .d(x32), .O(new_n144_));
  inv1   g093(.a(x02), .O(new_n145_));
  aoi21  g094(.a(new_n52_), .b(new_n145_), .c(x18), .O(new_n146_));
  oai21  g095(.a(new_n144_), .b(new_n52_), .c(new_n146_), .O(z13));
  inv1   g096(.a(x32), .O(new_n148_));
  nand3  g097(.a(new_n132_), .b(new_n148_), .c(new_n117_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n130_), .c(new_n86_), .O(new_n151_));
  inv1   g100(.a(x33), .O(new_n152_));
  nand2  g101(.a(new_n143_), .b(new_n152_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  aoi22  g103(.a(new_n154_), .b(new_n135_), .c(new_n151_), .d(x33), .O(new_n155_));
  inv1   g104(.a(x01), .O(new_n156_));
  aoi21  g105(.a(new_n52_), .b(new_n156_), .c(x18), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n52_), .c(new_n157_), .O(z14));
  aoi22  g107(.a(new_n153_), .b(new_n135_), .c(new_n119_), .d(x34), .O(new_n159_));
  inv1   g108(.a(x00), .O(new_n160_));
  aoi21  g109(.a(new_n52_), .b(new_n160_), .c(x18), .O(new_n161_));
  oai21  g110(.a(new_n159_), .b(new_n52_), .c(new_n161_), .O(z15));
endmodule
