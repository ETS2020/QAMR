...
module FAU ( 
  ...
  oai21  g027(.a(new_n74_), .b(x23), .c(x16), .O(new_n79_));
  ...
  nand2  g032(.a(new_n52_), .b(x10), .O(new_n84_));
  inv1   g033(.a(x24), .O(new_n85_));
  nand2  g034(.a(new_n74_), .b(new_n85_), .O(new_n86_));
  aoi21  g035(.a(new_n73_), .b(x24), .c(new_n52_), .O(new_n87_));
  nand2  g036(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g037(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand2  g038(.a(new_n89_), .b(new_n83_), .O(z05));
  xor2a  g039(.a(new_n86_), .b(x25), .O(new_n91_));
  ...
  nand3  g044(.a(new_n74_), .b(new_n95_), .c(new_n85_), .O(new_n96_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n74_), .c(new_n96_), .d(x26), .O(new_n98_));
  ...
  nand2  g050(.a(new_n97_), .b(new_n74_), .O(new_n102_));
  inv1   g051(.a(x26), .O(new_n103_));
  inv1   g052(.a(x27), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n103_), .c(new_n95_), .d(new_n85_), .O(new_n105_));
  nor2   g054(.a(new_n105_), .b(new_n73_), .O(new_n106_));
  aoi21  g055(.a(new_n102_), .b(x27), .c(new_n106_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n97_), .c(new_n72_), .d(new_n60_), .O(new_n113_));
  ...
  nand4  g068(.a(new_n119_), .b(new_n97_), .c(new_n72_), .d(new_n60_), .O(new_n120_));
  ...
  aoi21  g076(.a(new_n127_), .b(new_n106_), .c(new_n126_), .O(new_n128_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n129_), .c(new_n106_), .O(new_n156_));
