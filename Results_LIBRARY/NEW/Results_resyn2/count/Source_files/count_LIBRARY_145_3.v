...
module FAU ( 
  ...
  aoi22  g044(.a(new_n95_), .b(new_n61_), .c(new_n86_), .d(x24), .O(new_n96_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n55_), .d(new_n67_), .O(new_n102_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n95_), .c(new_n61_), .O(new_n128_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n127_), .c(new_n95_), .d(new_n61_), .O(new_n165_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n152_), .c(new_n95_), .d(new_n61_), .O(new_n178_));
