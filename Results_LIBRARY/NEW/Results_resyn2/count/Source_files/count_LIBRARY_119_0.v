// Benchmark "FAU" written by ABC on Mon Jul 27 22:45:06 2020
...
module FAU ( 
  ...
  aoi21  g38(.a(new_n79_), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nor2   g39(.a(x25), .b(x24), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n79_), .O(new_n92_));
  ...
  nand2  g47(.a(new_n91_), .b(new_n98_), .O(new_n99_));
  nor2   g48(.a(new_n99_), .b(new_n78_), .O(new_n100_));
  aoi21  g49(.a(new_n92_), .b(x26), .c(new_n100_), .O(new_n101_));
  inv1   g50(.a(x08), .O(new_n102_));
  aoi21  g51(.a(new_n52_), .b(new_n102_), .c(x18), .O(new_n103_));
  oai21  g52(.a(new_n101_), .b(new_n52_), .c(new_n103_), .O(z07));
  inv1   g53(.a(x27), .O(new_n105_));
  xor2a  g54(.a(new_n100_), .b(new_n105_), .O(new_n106_));
  inv1   g55(.a(x07), .O(new_n107_));
  aoi21  g56(.a(new_n52_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g57(.a(new_n106_), .b(new_n52_), .c(new_n108_), .O(z08));
  inv1   g58(.a(new_n99_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n79_), .c(new_n105_), .O(new_n111_));
  nor2   g60(.a(x28), .b(x27), .O(new_n112_));
  aoi22  g61(.a(new_n112_), .b(new_n100_), .c(new_n111_), .d(x28), .O(new_n113_));
  inv1   g62(.a(x06), .O(new_n114_));
  aoi21  g63(.a(new_n52_), .b(new_n114_), .c(x18), .O(new_n115_));
  oai21  g64(.a(new_n113_), .b(new_n52_), .c(new_n115_), .O(z09));
  nand2  g65(.a(new_n112_), .b(new_n100_), .O(new_n117_));
  inv1   g66(.a(x29), .O(new_n118_));
  nand2  g67(.a(new_n112_), .b(new_n118_), .O(new_n119_));
  nor3   g68(.a(new_n119_), .b(new_n99_), .c(new_n78_), .O(new_n120_));
  aoi21  g69(.a(new_n117_), .b(x29), .c(new_n120_), .O(new_n121_));
  inv1   g70(.a(x05), .O(new_n122_));
  aoi21  g71(.a(new_n52_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g72(.a(new_n121_), .b(new_n52_), .c(new_n123_), .O(z10));
  inv1   g73(.a(new_n119_), .O(new_n125_));
  nand3  g74(.a(new_n125_), .b(new_n110_), .c(new_n79_), .O(new_n126_));
  xor2a  g75(.a(new_n126_), .b(x30), .O(new_n127_));
  inv1   g76(.a(x04), .O(new_n128_));
  aoi21  g77(.a(new_n52_), .b(new_n128_), .c(x18), .O(new_n129_));
  oai21  g78(.a(new_n127_), .b(new_n52_), .c(new_n129_), .O(z11));
  nor2   g79(.a(new_n58_), .b(x31), .O(new_n131_));
  nor2   g80(.a(new_n131_), .b(new_n52_), .O(new_n132_));
  oai21  g81(.a(new_n126_), .b(x30), .c(new_n132_), .O(new_n133_));
  inv1   g82(.a(x03), .O(new_n134_));
  aoi21  g83(.a(new_n52_), .b(new_n134_), .c(x18), .O(new_n135_));
  nand2  g84(.a(new_n135_), .b(new_n133_), .O(z12));
  inv1   g85(.a(x18), .O(new_n137_));
  nand2  g86(.a(x32), .b(x16), .O(new_n138_));
  inv1   g87(.a(x02), .O(new_n139_));
  nand2  g88(.a(new_n52_), .b(new_n139_), .O(new_n140_));
  nand3  g89(.a(new_n140_), .b(new_n138_), .c(new_n137_), .O(z13));
  nand2  g90(.a(x33), .b(x16), .O(new_n142_));
  inv1   g91(.a(x01), .O(new_n143_));
  nand2  g92(.a(new_n52_), .b(new_n143_), .O(new_n144_));
  nand3  g93(.a(new_n144_), .b(new_n142_), .c(new_n137_), .O(z14));
  nand2  g94(.a(x34), .b(x16), .O(new_n146_));
  inv1   g95(.a(x00), .O(new_n147_));
  nand2  g96(.a(new_n52_), .b(new_n147_), .O(new_n148_));
  nand3  g97(.a(new_n148_), .b(new_n146_), .c(new_n137_), .O(z15));
endmodule
