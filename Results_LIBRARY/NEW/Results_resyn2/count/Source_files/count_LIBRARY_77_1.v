...
module FAU ( 
  ...
  nand2  g057(.a(new_n102_), .b(new_n108_), .O(new_n109_));
  ...
  nand2  g070(.a(new_n86_), .b(new_n79_), .O(new_n122_));
  inv1   g071(.a(new_n122_), .O(new_n123_));
  nor3   g072(.a(x28), .b(x26), .c(x25), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n123_), .c(new_n60_), .O(new_n125_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n73_), .c(x30), .O(new_n136_));
  ...
  oai21  g095(.a(new_n146_), .b(new_n80_), .c(x31), .O(new_n147_));
  nor2   g096(.a(x31), .b(x30), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n129_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n137_), .c(new_n81_), .O(new_n151_));
  ...
  oai21  g106(.a(new_n157_), .b(new_n80_), .c(x32), .O(new_n158_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n124_), .c(new_n123_), .d(new_n60_), .O(new_n164_));
  ...
  oai21  g120(.a(new_n171_), .b(new_n87_), .c(x33), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n128_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n150_), .c(new_n123_), .d(new_n60_), .O(new_n176_));
  ...
  oai21  g131(.a(new_n182_), .b(new_n87_), .c(x34), .O(new_n183_));
  inv1   g132(.a(x28), .O(new_n184_));
  inv1   g133(.a(x33), .O(new_n185_));
  inv1   g134(.a(x34), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n101_), .O(new_n187_));
