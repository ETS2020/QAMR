// Benchmark "FAU" written by ABC on Mon Jul 27 22:44:58 2020
...
module FAU ( 
  ...
  nand4  g069(.a(new_n120_), .b(new_n101_), .c(new_n100_), .d(new_n103_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(new_n68_), .O(new_n122_));
  ...
  nor3   g093(.a(x21), .b(x19), .c(x17), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n138_), .c(new_n113_), .d(new_n85_), .O(new_n146_));
  inv1   g095(.a(x28), .O(new_n147_));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n55_), .c(new_n147_), .O(new_n149_));
  nor2   g098(.a(new_n149_), .b(new_n121_), .O(new_n150_));
  aoi21  g099(.a(new_n146_), .b(x30), .c(new_n150_), .O(new_n151_));
  nor2   g100(.a(new_n61_), .b(new_n58_), .O(new_n152_));
  inv1   g101(.a(x18), .O(new_n153_));
  oai21  g102(.a(x16), .b(x04), .c(new_n153_), .O(new_n154_));
  aoi21  g103(.a(new_n152_), .b(x30), .c(new_n154_), .O(new_n155_));
  oai21  g104(.a(new_n151_), .b(x20), .c(new_n155_), .O(z11));
  nand4  g105(.a(new_n148_), .b(new_n130_), .c(new_n129_), .d(new_n93_), .O(new_n157_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n160_), .c(new_n159_), .d(new_n147_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n127_), .c(new_n95_), .d(new_n63_), .O(new_n164_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n148_), .c(new_n55_), .d(new_n61_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n121_), .c(x32), .O(new_n172_));
  inv1   g121(.a(x27), .O(new_n173_));
  nand4  g122(.a(new_n160_), .b(new_n159_), .c(new_n147_), .d(new_n173_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  inv1   g124(.a(x26), .O(new_n176_));
  inv1   g125(.a(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n161_), .c(new_n176_), .d(new_n103_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n175_), .c(new_n95_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n148_), .c(new_n130_), .d(new_n129_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n102_), .c(x33), .O(new_n188_));
  inv1   g137(.a(x33), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n177_), .c(new_n173_), .d(new_n176_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n163_), .c(new_n105_), .d(new_n71_), .O(new_n192_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n170_), .c(new_n148_), .d(new_n120_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n111_), .c(new_n198_), .O(new_n202_));
