...
module FAU ( 
  ...
  nand4  g22(.a(new_n73_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n74_));
  nor2   g23(.a(x22), .b(x21), .O(new_n75_));
  aoi22  g24(.a(new_n75_), .b(new_n63_), .c(new_n74_), .d(x22), .O(new_n76_));
