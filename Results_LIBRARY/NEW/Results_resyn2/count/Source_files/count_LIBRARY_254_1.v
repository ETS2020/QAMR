...
module FAU ( 
  ...
  nor2   g026(.a(new_n68_), .b(new_n77_), .O(new_n78_));
  nand3  g027(.a(new_n66_), .b(new_n58_), .c(new_n77_), .O(new_n79_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n66_), .c(new_n58_), .O(new_n86_));
  ...
  nor2   g040(.a(x25), .b(x21), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n85_), .c(new_n58_), .d(new_n57_), .O(new_n93_));
  ...
  nand4  g048(.a(new_n99_), .b(new_n85_), .c(new_n66_), .d(new_n58_), .O(new_n100_));
