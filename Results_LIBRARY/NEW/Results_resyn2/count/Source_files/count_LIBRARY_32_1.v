...
module FAU ( 
  ...
  nand4  g089(.a(new_n140_), .b(new_n136_), .c(new_n122_), .d(new_n139_), .O(new_n141_));
  ...
  nor2   g097(.a(new_n141_), .b(new_n109_), .O(new_n149_));
  oai21  g098(.a(new_n149_), .b(x32), .c(x16), .O(new_n150_));
  inv1   g099(.a(x02), .O(new_n151_));
  aoi21  g100(.a(new_n52_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n150_), .O(z13));
  nand3  g102(.a(new_n140_), .b(new_n136_), .c(new_n122_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n116_), .c(x33), .O(new_n155_));
  nor3   g104(.a(x33), .b(x31), .c(x30), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n125_), .c(new_n102_), .O(new_n157_));
  ...
  aoi22  g112(.a(new_n163_), .b(new_n149_), .c(new_n157_), .d(x34), .O(new_n164_));
