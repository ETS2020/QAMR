...
module FAU ( 
  ...
  aoi21  g031(.a(new_n82_), .b(new_n81_), .c(x21), .O(new_n83_));
  oai21  g032(.a(x23), .b(new_n73_), .c(new_n53_), .O(new_n84_));
  oai22  g033(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(new_n79_), .O(new_n85_));
  ...
  nand4  g047(.a(new_n93_), .b(new_n55_), .c(new_n90_), .d(new_n61_), .O(new_n99_));
  ...
  nor3   g053(.a(x24), .b(x23), .c(x21), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n63_), .c(new_n104_), .O(new_n106_));
  nor2   g055(.a(x26), .b(x25), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n105_), .c(new_n63_), .O(new_n108_));
  ...
  nand3  g066(.a(new_n107_), .b(new_n92_), .c(new_n117_), .O(new_n118_));
  nand2  g067(.a(new_n108_), .b(x27), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n118_), .c(x16), .O(new_n120_));
  inv1   g069(.a(new_n120_), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(new_n116_), .c(new_n114_), .O(z08));
  ...
  nand3  g076(.a(new_n123_), .b(new_n107_), .c(new_n92_), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  aoi22  g078(.a(new_n129_), .b(new_n109_), .c(new_n128_), .d(x29), .O(new_n130_));
  ...
  nand3  g082(.a(new_n129_), .b(new_n107_), .c(new_n92_), .O(new_n134_));
  nor2   g083(.a(x30), .b(x26), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n106_), .O(new_n137_));
  ...
  nand4  g090(.a(new_n135_), .b(new_n129_), .c(new_n92_), .d(new_n104_), .O(new_n142_));
  ...
  nand4  g098(.a(new_n143_), .b(new_n129_), .c(new_n107_), .d(new_n92_), .O(new_n150_));
  nor3   g099(.a(x32), .b(x31), .c(x30), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n129_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n108_), .O(new_n153_));
  ...
  oai21  g106(.a(new_n152_), .b(new_n108_), .c(x33), .O(new_n158_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n129_), .c(new_n107_), .d(new_n92_), .O(new_n165_));
  ...
  nand3  g120(.a(new_n171_), .b(new_n135_), .c(new_n129_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n106_), .c(x34), .O(new_n173_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n123_), .c(new_n107_), .d(new_n92_), .O(new_n178_));
