...
module FAU ( 
  ...
  nor2   g017(.a(x18), .b(new_n52_), .O(new_n69_));
  nand3  g018(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(z02));
  ...
  nand2  g031(.a(new_n76_), .b(new_n67_), .O(new_n83_));
  nor2   g032(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  nor2   g033(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g034(.a(new_n72_), .b(new_n82_), .O(new_n86_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n72_), .c(new_n58_), .d(new_n57_), .O(new_n94_));
  ...
  nor3   g057(.a(new_n108_), .b(new_n86_), .c(new_n65_), .O(new_n109_));
  ...
  nand4  g064(.a(new_n115_), .b(new_n100_), .c(new_n72_), .d(new_n60_), .O(new_n116_));
  ...
  nand4  g071(.a(new_n122_), .b(new_n100_), .c(new_n72_), .d(new_n60_), .O(new_n123_));
  ...
  oai21  g120(.a(new_n169_), .b(new_n52_), .c(new_n171_), .O(z14));
