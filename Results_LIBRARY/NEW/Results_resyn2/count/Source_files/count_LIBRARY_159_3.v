...
module FAU ( 
  ...
  nand3  g035(.a(new_n86_), .b(new_n78_), .c(new_n55_), .O(new_n87_));
  ...
  aoi22  g045(.a(new_n96_), .b(new_n63_), .c(new_n87_), .d(x24), .O(new_n97_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n86_), .c(new_n78_), .d(new_n55_), .O(new_n112_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n96_), .c(new_n63_), .O(new_n129_));
  ...
  nand3  g088(.a(new_n139_), .b(new_n114_), .c(new_n88_), .O(new_n140_));
  ...
  oai21  g096(.a(new_n147_), .b(new_n87_), .c(x30), .O(new_n148_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n114_), .c(new_n88_), .O(new_n154_));
  ...
  oai21  g110(.a(new_n161_), .b(new_n87_), .c(x31), .O(new_n162_));
  inv1   g111(.a(x31), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n151_), .c(new_n146_), .d(new_n150_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n128_), .c(new_n96_), .d(new_n63_), .O(new_n166_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n153_), .c(new_n96_), .d(new_n63_), .O(new_n179_));
