...
module FAU ( 
  ...
  aoi21  g024(.a(new_n70_), .b(new_n58_), .c(new_n75_), .O(new_n76_));
  nand3  g025(.a(new_n70_), .b(new_n58_), .c(new_n75_), .O(new_n77_));
  ...
  nand3  g032(.a(new_n83_), .b(new_n70_), .c(new_n58_), .O(new_n84_));
  ...
  nand4  g039(.a(new_n90_), .b(new_n83_), .c(new_n58_), .d(new_n57_), .O(new_n91_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n70_), .d(new_n58_), .O(new_n98_));
