...
module FAU ( 
  ...
  nand4  g096(.a(new_n147_), .b(new_n130_), .c(new_n129_), .d(new_n93_), .O(new_n148_));
  ...
  oai21  g100(.a(x16), .b(x04), .c(new_n151_), .O(new_n152_));
  aoi21  g101(.a(x30), .b(x20), .c(new_n152_), .O(new_n153_));
  oai21  g102(.a(new_n150_), .b(new_n58_), .c(new_n153_), .O(z11));
  oai21  g103(.a(new_n148_), .b(new_n86_), .c(x31), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n127_), .c(new_n95_), .d(new_n63_), .O(new_n162_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n147_), .c(new_n120_), .d(new_n103_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n102_), .c(x32), .O(new_n170_));
  inv1   g119(.a(x27), .O(new_n171_));
  nand4  g120(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n171_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  inv1   g122(.a(x26), .O(new_n174_));
  inv1   g123(.a(x32), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n159_), .c(new_n174_), .d(new_n103_), .O(new_n176_));
  inv1   g125(.a(new_n176_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n173_), .c(new_n95_), .d(new_n63_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n184_), .b(new_n147_), .c(new_n130_), .d(new_n129_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n102_), .c(x33), .O(new_n186_));
  inv1   g135(.a(x33), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n175_), .c(new_n171_), .d(new_n174_), .O(new_n188_));
  inv1   g137(.a(new_n188_), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n161_), .c(new_n105_), .d(new_n71_), .O(new_n190_));
  ...
  nand4  g147(.a(new_n198_), .b(new_n168_), .c(new_n147_), .d(new_n120_), .O(new_n199_));
