...
module FAU ( 
  ...
  nand4  g21(.a(new_n68_), .b(new_n61_), .c(new_n54_), .d(new_n53_), .O(new_n73_));
  nor2   g22(.a(x22), .b(x21), .O(new_n74_));
  aoi22  g23(.a(new_n74_), .b(new_n63_), .c(new_n73_), .d(x22), .O(new_n75_));
