...
module FAU ( 
  ...
  nand4  g043(.a(new_n94_), .b(new_n71_), .c(new_n58_), .d(new_n57_), .O(new_n95_));
  ...
  aoi22  g048(.a(new_n99_), .b(new_n84_), .c(new_n95_), .d(x25), .O(new_n100_));
  ...
  nand2  g052(.a(new_n99_), .b(new_n84_), .O(new_n104_));
  inv1   g053(.a(x25), .O(new_n105_));
  inv1   g054(.a(x26), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n105_), .c(new_n93_), .O(new_n107_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n114_), .c(new_n99_), .d(new_n84_), .O(new_n150_));
  ...
  nor2   g115(.a(new_n166_), .b(new_n95_), .O(new_n167_));
  ...
  oai21  g120(.a(new_n166_), .b(new_n95_), .c(x34), .O(new_n172_));
  inv1   g121(.a(x34), .O(new_n173_));
  inv1   g122(.a(new_n95_), .O(new_n174_));
