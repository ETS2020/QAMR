...
module FAU ( 
  ...
  oai21  g036(.a(new_n78_), .b(x24), .c(x25), .O(new_n88_));
  nor2   g037(.a(x25), .b(x24), .O(new_n89_));
  nand4  g038(.a(new_n89_), .b(new_n77_), .c(new_n64_), .d(new_n58_), .O(new_n90_));
  ...
  nand2  g043(.a(new_n94_), .b(new_n92_), .O(z06));
  nand2  g044(.a(new_n90_), .b(x26), .O(new_n96_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n77_), .c(new_n64_), .d(new_n58_), .O(new_n98_));
  ...
  nor2   g053(.a(x26), .b(x23), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n89_), .c(new_n104_), .O(new_n106_));
  nor2   g055(.a(new_n106_), .b(new_n71_), .O(new_n107_));
  aoi21  g056(.a(new_n98_), .b(x27), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g060(.a(new_n106_), .b(new_n71_), .c(x28), .O(new_n112_));
  nor2   g061(.a(x28), .b(x27), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n105_), .c(new_n89_), .O(new_n114_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n126_), .c(new_n104_), .O(new_n128_));
  nor2   g077(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n79_), .O(new_n130_));
  oai21  g079(.a(new_n114_), .b(new_n71_), .c(x29), .O(new_n131_));
  ...
  nand4  g085(.a(new_n113_), .b(new_n89_), .c(new_n127_), .d(new_n124_), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n78_), .c(x30), .O(new_n138_));
  inv1   g087(.a(x30), .O(new_n139_));
  nand3  g088(.a(new_n129_), .b(new_n79_), .c(new_n139_), .O(new_n140_));
  ...
  aoi21  g094(.a(new_n129_), .b(new_n79_), .c(x31), .O(new_n146_));
  nand2  g095(.a(new_n140_), .b(x16), .O(new_n147_));
  inv1   g096(.a(x03), .O(new_n148_));
  aoi21  g097(.a(new_n52_), .b(new_n148_), .c(x18), .O(new_n149_));
  oai21  g098(.a(new_n147_), .b(new_n146_), .c(new_n149_), .O(z12));
