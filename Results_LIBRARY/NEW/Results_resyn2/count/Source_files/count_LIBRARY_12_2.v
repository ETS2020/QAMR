...
module FAU ( 
  ...
  nand3  g005(.a(new_n56_), .b(new_n54_), .c(new_n53_), .O(z00));
  ...
  aoi21  g016(.a(new_n55_), .b(new_n67_), .c(x18), .O(new_n68_));
  oai21  g017(.a(new_n66_), .b(new_n55_), .c(new_n68_), .O(z02));
  ...
  aoi21  g027(.a(new_n55_), .b(new_n78_), .c(x18), .O(new_n79_));
  nand2  g028(.a(new_n79_), .b(new_n77_), .O(z03));
  inv1   g029(.a(x23), .O(new_n81_));
  nand2  g030(.a(new_n52_), .b(new_n58_), .O(new_n82_));
  nand2  g031(.a(new_n75_), .b(new_n65_), .O(new_n83_));
  nor2   g032(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nor2   g033(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  nand2  g034(.a(new_n71_), .b(new_n81_), .O(new_n86_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n71_), .c(new_n52_), .d(new_n58_), .O(new_n94_));
  ...
  aoi22  g049(.a(new_n100_), .b(new_n84_), .c(new_n94_), .d(x25), .O(new_n101_));
  ...
  nand2  g053(.a(new_n100_), .b(new_n84_), .O(new_n105_));
  inv1   g054(.a(x25), .O(new_n106_));
  inv1   g055(.a(x26), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n106_), .c(new_n92_), .O(new_n108_));
  nor3   g057(.a(new_n108_), .b(new_n86_), .c(new_n82_), .O(new_n109_));
  aoi21  g058(.a(new_n105_), .b(x26), .c(new_n109_), .O(new_n110_));
  inv1   g059(.a(x08), .O(new_n111_));
  aoi21  g060(.a(new_n55_), .b(new_n111_), .c(x18), .O(new_n112_));
  oai21  g061(.a(new_n110_), .b(new_n55_), .c(new_n112_), .O(z07));
  inv1   g062(.a(x27), .O(new_n114_));
  nor2   g063(.a(x27), .b(x26), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n116_));
  ...
  aoi21  g068(.a(new_n55_), .b(new_n119_), .c(x18), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n118_), .O(z08));
  nor3   g070(.a(x28), .b(x27), .c(x26), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  aoi21  g073(.a(new_n116_), .b(x28), .c(new_n124_), .O(new_n125_));
  inv1   g074(.a(x06), .O(new_n126_));
  aoi21  g075(.a(new_n55_), .b(new_n126_), .c(x18), .O(new_n127_));
  oai21  g076(.a(new_n125_), .b(new_n55_), .c(new_n127_), .O(z09));
  inv1   g077(.a(new_n86_), .O(new_n129_));
  inv1   g078(.a(new_n108_), .O(new_n130_));
  nor2   g079(.a(x28), .b(x27), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n60_), .O(new_n132_));
  nor3   g081(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  aoi22  g082(.a(new_n133_), .b(new_n109_), .c(new_n132_), .d(x29), .O(new_n134_));
  inv1   g083(.a(x05), .O(new_n135_));
  aoi21  g084(.a(new_n55_), .b(new_n135_), .c(x18), .O(new_n136_));
  oai21  g085(.a(new_n134_), .b(new_n55_), .c(new_n136_), .O(z10));
  nand3  g086(.a(new_n133_), .b(new_n130_), .c(new_n87_), .O(new_n138_));
  xor2a  g087(.a(new_n138_), .b(x30), .O(new_n139_));
  inv1   g088(.a(x04), .O(new_n140_));
  aoi21  g089(.a(new_n55_), .b(new_n140_), .c(x18), .O(new_n141_));
  oai21  g090(.a(new_n139_), .b(new_n55_), .c(new_n141_), .O(z11));
  inv1   g091(.a(x29), .O(new_n143_));
  inv1   g092(.a(x30), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n123_), .c(x31), .O(new_n146_));
  inv1   g095(.a(x28), .O(new_n147_));
  inv1   g096(.a(x31), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n144_), .c(new_n143_), .d(new_n147_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n115_), .c(new_n100_), .d(new_n84_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g102(.a(x03), .O(new_n154_));
  aoi21  g103(.a(new_n55_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n153_), .O(z12));
  nand3  g105(.a(new_n148_), .b(new_n144_), .c(new_n143_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n123_), .c(x32), .O(new_n158_));
  nor3   g107(.a(x32), .b(x31), .c(x30), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n133_), .c(new_n130_), .d(new_n87_), .O(new_n160_));
  ...
  nor3   g114(.a(x33), .b(x26), .c(x25), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n159_), .c(new_n133_), .O(new_n167_));
  ...
  oai21  g120(.a(new_n169_), .b(new_n55_), .c(new_n171_), .O(z14));
  oai21  g121(.a(new_n167_), .b(new_n94_), .c(x34), .O(new_n173_));
  inv1   g122(.a(x34), .O(new_n174_));
  inv1   g123(.a(new_n94_), .O(new_n175_));
  nand2  g124(.a(new_n131_), .b(new_n143_), .O(new_n176_));
  inv1   g125(.a(x33), .O(new_n177_));
  nand3  g126(.a(new_n177_), .b(new_n107_), .c(new_n106_), .O(new_n178_));
  nor2   g127(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n159_), .c(new_n175_), .d(new_n174_), .O(new_n180_));
