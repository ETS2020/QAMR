...
module FAU ( 
  ...
  oai21  g034(.a(new_n81_), .b(x24), .c(x16), .O(new_n86_));
  inv1   g035(.a(x10), .O(new_n87_));
  aoi21  g036(.a(new_n52_), .b(new_n87_), .c(x18), .O(new_n88_));
  nand2  g037(.a(new_n88_), .b(new_n86_), .O(z05));
  nor2   g038(.a(x25), .b(x21), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n79_), .c(new_n58_), .d(new_n57_), .O(new_n91_));
  inv1   g040(.a(new_n91_), .O(new_n92_));
  aoi21  g041(.a(new_n80_), .b(x25), .c(new_n92_), .O(new_n93_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n79_), .c(new_n66_), .d(new_n58_), .O(new_n98_));
  ...
  nand3  g054(.a(new_n97_), .b(new_n81_), .c(new_n105_), .O(new_n106_));
  ...
  nand2  g068(.a(new_n90_), .b(new_n79_), .O(new_n120_));
  inv1   g069(.a(new_n120_), .O(new_n121_));
  nor3   g070(.a(x28), .b(x27), .c(x26), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n60_), .O(new_n123_));
  ...
  oai21  g082(.a(new_n128_), .b(new_n73_), .c(x30), .O(new_n134_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n135_));
  nor3   g084(.a(x30), .b(x29), .c(x28), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n135_), .c(new_n81_), .O(new_n137_));
  ...
  oai21  g093(.a(new_n144_), .b(new_n80_), .c(x31), .O(new_n145_));
  nor2   g094(.a(x31), .b(x30), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n127_), .O(new_n147_));
  inv1   g096(.a(new_n147_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n135_), .c(new_n81_), .O(new_n149_));
  ...
  oai21  g104(.a(new_n155_), .b(new_n80_), .c(x32), .O(new_n156_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n122_), .c(new_n121_), .d(new_n60_), .O(new_n162_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n148_), .c(new_n121_), .d(new_n60_), .O(new_n174_));
