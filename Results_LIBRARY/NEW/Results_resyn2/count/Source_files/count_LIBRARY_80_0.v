...
module FAU ( 
  ...
  nand4  g18(.a(new_n68_), .b(new_n61_), .c(new_n54_), .d(new_n53_), .O(new_n70_));
  ...
  nand4  g31(.a(new_n76_), .b(new_n52_), .c(new_n81_), .d(new_n61_), .O(new_n83_));
