...
module FAU ( 
  ...
  nor2   g089(.a(new_n140_), .b(new_n80_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(x30), .c(x16), .O(new_n142_));
  inv1   g091(.a(x04), .O(new_n143_));
  aoi21  g092(.a(new_n52_), .b(new_n143_), .c(x18), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n142_), .O(z11));
  oai21  g094(.a(new_n140_), .b(new_n80_), .c(x31), .O(new_n146_));
  nor2   g095(.a(x31), .b(x29), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n123_), .O(new_n148_));
  inv1   g097(.a(new_n148_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n131_), .c(new_n81_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n147_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n80_), .c(x32), .O(new_n157_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n118_), .c(new_n117_), .d(new_n60_), .O(new_n163_));
  ...
  nor2   g117(.a(x32), .b(x28), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n147_), .c(new_n109_), .d(new_n108_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n87_), .c(x33), .O(new_n171_));
  nor2   g120(.a(x33), .b(x32), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n122_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n149_), .c(new_n117_), .d(new_n60_), .O(new_n175_));
  ...
  nand4  g129(.a(new_n172_), .b(new_n147_), .c(new_n123_), .d(new_n122_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n87_), .c(x34), .O(new_n182_));
  inv1   g131(.a(x27), .O(new_n183_));
  inv1   g132(.a(x33), .O(new_n184_));
  inv1   g133(.a(x34), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n101_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n161_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n95_), .O(new_n188_));
