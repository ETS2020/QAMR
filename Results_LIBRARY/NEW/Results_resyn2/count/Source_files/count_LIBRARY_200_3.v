...
module FAU ( 
  ...
  aoi21  g013(.a(new_n53_), .b(new_n64_), .c(x18), .O(new_n65_));
  oai21  g014(.a(new_n63_), .b(new_n53_), .c(new_n65_), .O(z01));
  nor2   g015(.a(x20), .b(x19), .O(new_n67_));
  nand2  g016(.a(new_n67_), .b(new_n57_), .O(new_n68_));
  inv1   g017(.a(x21), .O(new_n69_));
  nand4  g018(.a(new_n69_), .b(new_n55_), .c(new_n58_), .d(new_n57_), .O(new_n70_));
  ...
  nor2   g026(.a(x21), .b(x17), .O(new_n78_));
  nand3  g027(.a(new_n78_), .b(new_n67_), .c(new_n76_), .O(new_n79_));
  ...
  aoi22  g044(.a(new_n95_), .b(new_n62_), .c(new_n86_), .d(x24), .O(new_n96_));
  inv1   g045(.a(x10), .O(new_n97_));
  aoi21  g046(.a(new_n53_), .b(new_n97_), .c(x18), .O(new_n98_));
  oai21  g047(.a(new_n96_), .b(new_n53_), .c(new_n98_), .O(z05));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nor2   g049(.a(x22), .b(x21), .O(new_n101_));
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n67_), .d(new_n57_), .O(new_n102_));
  ...
  oai21  g057(.a(new_n106_), .b(new_n53_), .c(new_n108_), .O(z06));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n85_), .c(new_n78_), .d(new_n67_), .O(new_n111_));
  ...
  oai21  g074(.a(new_n123_), .b(new_n53_), .c(new_n125_), .O(z08));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n95_), .c(new_n62_), .O(new_n128_));
  ...
  oai21  g084(.a(new_n133_), .b(new_n53_), .c(new_n135_), .O(z09));
  ...
  nand4  g113(.a(new_n164_), .b(new_n127_), .c(new_n95_), .d(new_n62_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g116(.a(x03), .O(new_n168_));
  aoi21  g117(.a(new_n53_), .b(new_n168_), .c(x18), .O(new_n169_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n152_), .c(new_n95_), .d(new_n62_), .O(new_n178_));
