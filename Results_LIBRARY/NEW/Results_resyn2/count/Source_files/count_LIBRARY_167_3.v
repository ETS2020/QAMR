...
module FAU ( 
  ...
  aoi21  g012(.a(new_n55_), .b(new_n63_), .c(new_n62_), .O(new_n64_));
  oai21  g013(.a(new_n64_), .b(new_n61_), .c(x16), .O(new_n65_));
  inv1   g014(.a(x14), .O(new_n66_));
  aoi21  g015(.a(new_n58_), .b(new_n66_), .c(x18), .O(new_n67_));
  nand2  g016(.a(new_n67_), .b(new_n65_), .O(z01));
  nor2   g017(.a(new_n55_), .b(new_n63_), .O(new_n69_));
  nand4  g018(.a(new_n63_), .b(new_n62_), .c(new_n53_), .d(new_n52_), .O(new_n70_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n76_), .d(new_n63_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n55_), .d(new_n62_), .O(new_n102_));
