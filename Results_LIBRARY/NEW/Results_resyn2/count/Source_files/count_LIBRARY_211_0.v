...
module FAU ( 
  ...
  inv1   g077(.a(x18), .O(new_n129_));
  inv1   g078(.a(new_n86_), .O(new_n130_));
  inv1   g079(.a(new_n108_), .O(new_n131_));
  nor2   g080(.a(x28), .b(x27), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n60_), .O(new_n133_));
  nor3   g082(.a(x29), .b(x28), .c(x27), .O(new_n134_));
  aoi22  g083(.a(new_n134_), .b(new_n109_), .c(new_n133_), .d(x29), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n52_), .c(new_n129_), .O(z10));
  nand3  g085(.a(new_n134_), .b(new_n131_), .c(new_n87_), .O(new_n137_));
  ...
  oai21  g093(.a(new_n144_), .b(new_n123_), .c(x31), .O(new_n145_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n115_), .c(new_n100_), .d(new_n84_), .O(new_n150_));
  ...
  oai21  g105(.a(new_n156_), .b(new_n123_), .c(x32), .O(new_n157_));
  nor3   g106(.a(x32), .b(x31), .c(x30), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n134_), .c(new_n131_), .d(new_n87_), .O(new_n159_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n158_), .c(new_n134_), .O(new_n166_));
  ...
  nand2  g123(.a(new_n132_), .b(new_n142_), .O(new_n175_));
