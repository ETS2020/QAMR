...
module FAU ( 
  ...
  nand4  g100(.a(new_n151_), .b(new_n142_), .c(new_n109_), .d(new_n108_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n87_), .O(new_n153_));
  ...
  oai21  g106(.a(new_n153_), .b(x32), .c(x16), .O(new_n158_));
  inv1   g107(.a(x02), .O(new_n159_));
  aoi21  g108(.a(new_n52_), .b(new_n159_), .c(x18), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n158_), .O(z13));
  oai21  g110(.a(new_n152_), .b(new_n87_), .c(x33), .O(new_n162_));
  nor2   g111(.a(x33), .b(x31), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n122_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n144_), .c(new_n117_), .d(new_n60_), .O(new_n166_));
  ...
  nand4  g120(.a(new_n163_), .b(new_n142_), .c(new_n123_), .d(new_n122_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n87_), .c(x34), .O(new_n173_));
  inv1   g122(.a(x28), .O(new_n174_));
  inv1   g123(.a(x30), .O(new_n175_));
  inv1   g124(.a(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n175_), .c(new_n139_), .d(new_n174_), .O(new_n177_));
