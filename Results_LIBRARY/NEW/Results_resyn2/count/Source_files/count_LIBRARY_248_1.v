...
module FAU ( 
  ...
  nand3  g041(.a(new_n74_), .b(new_n92_), .c(new_n81_), .O(new_n93_));
  aoi21  g042(.a(new_n93_), .b(new_n91_), .c(new_n52_), .O(new_n94_));
  oai21  g043(.a(x16), .b(x09), .c(new_n79_), .O(new_n95_));
  or2    g044(.a(new_n95_), .b(new_n94_), .O(z06));
  nor3   g045(.a(x26), .b(x24), .c(x23), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n74_), .c(new_n93_), .d(x26), .O(new_n98_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n103_), .c(new_n92_), .d(new_n81_), .O(new_n105_));
