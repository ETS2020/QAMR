...
module FAU ( 
  ...
  nand3  g106(.a(new_n148_), .b(new_n144_), .c(new_n143_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n123_), .c(x32), .O(new_n159_));
  nor3   g108(.a(x32), .b(x31), .c(x30), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n133_), .c(new_n130_), .d(new_n87_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n160_), .c(new_n133_), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n94_), .O(new_n167_));
  aoi21  g116(.a(new_n161_), .b(x33), .c(new_n167_), .O(new_n168_));
  ...
  oai21  g120(.a(new_n166_), .b(new_n94_), .c(x34), .O(new_n172_));
  inv1   g121(.a(x34), .O(new_n173_));
  inv1   g122(.a(new_n94_), .O(new_n174_));
  nand2  g123(.a(new_n131_), .b(new_n143_), .O(new_n175_));
  inv1   g124(.a(x33), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n107_), .c(new_n106_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n160_), .c(new_n174_), .d(new_n173_), .O(new_n179_));
