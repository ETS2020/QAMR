...
module FAU ( 
  ...
  oai21  g095(.a(new_n146_), .b(new_n123_), .c(x31), .O(new_n147_));
  inv1   g096(.a(x28), .O(new_n148_));
  inv1   g097(.a(x31), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n145_), .c(new_n144_), .d(new_n148_), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n115_), .c(new_n100_), .d(new_n84_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n147_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n143_), .O(z12));
  nand3  g104(.a(new_n149_), .b(new_n145_), .c(new_n144_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n123_), .c(x32), .O(new_n157_));
  nor3   g106(.a(x32), .b(x31), .c(x30), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n133_), .c(new_n130_), .d(new_n87_), .O(new_n159_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n158_), .c(new_n133_), .O(new_n166_));
  ...
  nand2  g123(.a(new_n131_), .b(new_n144_), .O(new_n175_));
