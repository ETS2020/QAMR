...
module FAU ( 
  ...
  nand3  g097(.a(new_n140_), .b(new_n136_), .c(new_n122_), .O(new_n149_));
  ...
  nor2   g106(.a(new_n141_), .b(new_n109_), .O(new_n158_));
  nor2   g107(.a(x33), .b(x32), .O(new_n159_));
  aoi22  g108(.a(new_n159_), .b(new_n158_), .c(new_n152_), .d(x33), .O(new_n160_));
  ...
  aoi21  g112(.a(new_n159_), .b(new_n158_), .c(x34), .O(new_n164_));
