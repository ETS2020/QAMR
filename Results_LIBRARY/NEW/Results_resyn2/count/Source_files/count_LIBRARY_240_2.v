...
module FAU ( 
  ...
  nand2  g016(.a(new_n55_), .b(x21), .O(new_n68_));
  inv1   g017(.a(x21), .O(new_n69_));
  oai21  g018(.a(x19), .b(x17), .c(new_n69_), .O(new_n70_));
  nand3  g019(.a(new_n70_), .b(new_n68_), .c(new_n61_), .O(new_n71_));
  ...
  nand4  g025(.a(new_n69_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n77_));
  inv1   g026(.a(new_n77_), .O(new_n78_));
  nor2   g027(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nor2   g028(.a(x21), .b(x20), .O(new_n80_));
  nand3  g029(.a(new_n80_), .b(new_n55_), .c(new_n76_), .O(new_n81_));
  ...
  aoi22  g056(.a(new_n107_), .b(new_n78_), .c(new_n104_), .d(x25), .O(new_n108_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n107_), .d(new_n78_), .O(new_n192_));
