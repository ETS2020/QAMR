...
module FAU ( 
  ...
  nand4  g041(.a(new_n92_), .b(new_n72_), .c(new_n58_), .d(new_n57_), .O(new_n93_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n99_), .c(new_n72_), .d(new_n60_), .O(new_n115_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n99_), .c(new_n72_), .d(new_n60_), .O(new_n122_));
