...
module FAU ( 
  ...
  nand3  g063(.a(new_n114_), .b(new_n100_), .c(new_n84_), .O(new_n115_));
  inv1   g064(.a(new_n109_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(x27), .O(new_n117_));
  nor2   g066(.a(x18), .b(new_n52_), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n117_), .c(new_n115_), .O(z08));
  nor3   g068(.a(x28), .b(x27), .c(x26), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n121_));
  inv1   g070(.a(new_n121_), .O(new_n122_));
  aoi21  g071(.a(new_n115_), .b(x28), .c(new_n122_), .O(new_n123_));
  ...
  inv1   g075(.a(new_n86_), .O(new_n127_));
  inv1   g076(.a(new_n108_), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n60_), .O(new_n130_));
  nor3   g079(.a(x29), .b(x28), .c(x27), .O(new_n131_));
  aoi22  g080(.a(new_n131_), .b(new_n109_), .c(new_n130_), .d(x29), .O(new_n132_));
  ...
  nand3  g084(.a(new_n131_), .b(new_n128_), .c(new_n87_), .O(new_n136_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n142_), .c(new_n141_), .d(new_n145_), .O(new_n147_));
  inv1   g096(.a(new_n147_), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n114_), .c(new_n100_), .d(new_n84_), .O(new_n149_));
  ...
  nand3  g103(.a(new_n146_), .b(new_n142_), .c(new_n141_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n121_), .c(x32), .O(new_n156_));
  nor3   g105(.a(x32), .b(x31), .c(x30), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n131_), .c(new_n128_), .d(new_n87_), .O(new_n158_));
  ...
  nor3   g112(.a(x33), .b(x26), .c(x25), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n157_), .c(new_n131_), .O(new_n165_));
  nor2   g114(.a(new_n165_), .b(new_n94_), .O(new_n166_));
  aoi21  g115(.a(new_n158_), .b(x33), .c(new_n166_), .O(new_n167_));
  ...
  oai21  g119(.a(new_n165_), .b(new_n94_), .c(x34), .O(new_n171_));
  inv1   g120(.a(x34), .O(new_n172_));
  inv1   g121(.a(new_n94_), .O(new_n173_));
  nand2  g122(.a(new_n129_), .b(new_n141_), .O(new_n174_));
  inv1   g123(.a(x33), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n107_), .c(new_n106_), .O(new_n176_));
  nor2   g125(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n157_), .c(new_n173_), .d(new_n172_), .O(new_n178_));
