...
module FAU ( 
  ...
  nand4  g40(.a(new_n91_), .b(new_n77_), .c(new_n64_), .d(new_n58_), .O(new_n92_));
  ...
  xor2a  g46(.a(new_n92_), .b(x26), .O(new_n98_));
  inv1   g47(.a(x08), .O(new_n99_));
  aoi21  g48(.a(new_n52_), .b(new_n99_), .c(x18), .O(new_n100_));
  oai21  g49(.a(new_n98_), .b(new_n52_), .c(new_n100_), .O(z07));
  nor2   g50(.a(new_n92_), .b(x26), .O(new_n102_));
  oai21  g51(.a(new_n79_), .b(x27), .c(x16), .O(new_n103_));
  inv1   g52(.a(x07), .O(new_n104_));
  aoi21  g53(.a(new_n52_), .b(new_n104_), .c(x18), .O(new_n105_));
  oai21  g54(.a(new_n103_), .b(new_n102_), .c(new_n105_), .O(z08));
  ...
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(z09));
  nand2  g60(.a(x29), .b(x16), .O(new_n112_));
  inv1   g61(.a(x05), .O(new_n113_));
  nand2  g62(.a(new_n52_), .b(new_n113_), .O(new_n114_));
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(new_n107_), .O(z10));
  nand2  g64(.a(x30), .b(x16), .O(new_n116_));
  inv1   g65(.a(x04), .O(new_n117_));
  nand2  g66(.a(new_n52_), .b(new_n117_), .O(new_n118_));
  nand3  g67(.a(new_n118_), .b(new_n116_), .c(new_n107_), .O(z11));
  nand2  g68(.a(x31), .b(x16), .O(new_n120_));
  inv1   g69(.a(x03), .O(new_n121_));
  nand2  g70(.a(new_n52_), .b(new_n121_), .O(new_n122_));
  nand3  g71(.a(new_n122_), .b(new_n120_), .c(new_n107_), .O(z12));
  nand2  g72(.a(x32), .b(x16), .O(new_n124_));
  inv1   g73(.a(x02), .O(new_n125_));
  nand2  g74(.a(new_n52_), .b(new_n125_), .O(new_n126_));
  nand3  g75(.a(new_n126_), .b(new_n124_), .c(new_n107_), .O(z13));
  nand2  g76(.a(x33), .b(x16), .O(new_n128_));
  inv1   g77(.a(x01), .O(new_n129_));
  nand2  g78(.a(new_n52_), .b(new_n129_), .O(new_n130_));
  nand3  g79(.a(new_n130_), .b(new_n128_), .c(new_n107_), .O(z14));
  nand2  g80(.a(x34), .b(x16), .O(new_n132_));
  inv1   g81(.a(x00), .O(new_n133_));
  nand2  g82(.a(new_n52_), .b(new_n133_), .O(new_n134_));
  nand3  g83(.a(new_n134_), .b(new_n132_), .c(new_n107_), .O(z15));
endmodule
