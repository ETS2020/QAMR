...
module FAU ( 
  ...
  nand2  g011(.a(new_n59_), .b(x14), .O(new_n63_));
  ...
  oai21  g048(.a(new_n97_), .b(new_n59_), .c(new_n99_), .O(z05));
  nor2   g049(.a(x24), .b(x23), .O(new_n101_));
  nor2   g050(.a(x22), .b(x21), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n101_), .c(new_n55_), .d(new_n65_), .O(new_n103_));
  inv1   g052(.a(x25), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n77_), .O(new_n105_));
  inv1   g054(.a(new_n105_), .O(new_n106_));
  aoi22  g055(.a(new_n106_), .b(new_n72_), .c(new_n103_), .d(x25), .O(new_n107_));
  inv1   g056(.a(x09), .O(new_n108_));
  aoi21  g057(.a(new_n59_), .b(new_n108_), .c(x18), .O(new_n109_));
  oai21  g058(.a(new_n107_), .b(new_n59_), .c(new_n109_), .O(z06));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n86_), .c(new_n79_), .d(new_n55_), .O(new_n112_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n96_), .c(new_n64_), .O(new_n129_));
  ...
  oai21  g085(.a(new_n134_), .b(new_n59_), .c(new_n136_), .O(z09));
  ...
  nand4  g114(.a(new_n165_), .b(new_n128_), .c(new_n96_), .d(new_n64_), .O(new_n166_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n153_), .c(new_n96_), .d(new_n64_), .O(new_n179_));
  ...
  nand4  g139(.a(new_n190_), .b(new_n165_), .c(new_n106_), .d(new_n72_), .O(new_n191_));
