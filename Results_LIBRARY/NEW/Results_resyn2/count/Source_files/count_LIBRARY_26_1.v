...
module FAU ( 
  ...
  nand3  g049(.a(new_n100_), .b(new_n87_), .c(new_n89_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n81_), .O(new_n102_));
  aoi21  g051(.a(new_n90_), .b(x26), .c(new_n102_), .O(new_n103_));
  ...
  nor3   g056(.a(x27), .b(x26), .c(x24), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n82_), .c(new_n61_), .O(new_n109_));
  ...
  nand4  g068(.a(new_n108_), .b(new_n82_), .c(new_n61_), .d(new_n119_), .O(new_n120_));
  inv1   g069(.a(x27), .O(new_n121_));
  inv1   g070(.a(x29), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n119_), .c(new_n121_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  aoi22  g073(.a(new_n124_), .b(new_n102_), .c(new_n120_), .d(x29), .O(new_n125_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n108_), .c(new_n82_), .d(new_n61_), .O(new_n130_));
  nor3   g079(.a(x30), .b(x29), .c(x28), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n108_), .c(new_n82_), .d(new_n61_), .O(new_n132_));
  ...
  aoi21  g097(.a(new_n148_), .b(new_n102_), .c(new_n144_), .O(new_n149_));
  ...
  nand2  g107(.a(new_n158_), .b(new_n102_), .O(new_n159_));
  ...
  oai21  g115(.a(new_n161_), .b(new_n109_), .c(x34), .O(new_n167_));
  nor2   g116(.a(x34), .b(x33), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n158_), .c(new_n102_), .O(new_n169_));
