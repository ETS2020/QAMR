...
module FAU ( 
  ...
  aoi22  g050(.a(new_n101_), .b(new_n84_), .c(new_n94_), .d(x25), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n52_), .c(new_n100_), .O(z06));
  nand2  g052(.a(new_n101_), .b(new_n84_), .O(new_n104_));
