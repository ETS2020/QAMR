...
module FAU ( 
  ...
  oai21  g082(.a(new_n129_), .b(x30), .c(x16), .O(new_n134_));
  ...
  nor2   g087(.a(new_n128_), .b(new_n138_), .O(new_n139_));
  oai21  g088(.a(new_n129_), .b(x31), .c(x16), .O(new_n140_));
  ...
  nand2  g094(.a(new_n125_), .b(new_n145_), .O(new_n146_));
  nand2  g095(.a(new_n138_), .b(new_n117_), .O(new_n147_));
