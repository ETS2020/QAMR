...
module FAU ( 
  ...
  oai21  g066(.a(new_n117_), .b(x28), .c(x16), .O(new_n118_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n115_), .c(new_n122_), .O(new_n124_));
  inv1   g073(.a(new_n124_), .O(new_n125_));
  aoi22  g074(.a(new_n125_), .b(new_n98_), .c(new_n116_), .d(x29), .O(new_n126_));
  ...
  nor2   g078(.a(x29), .b(x27), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n104_), .c(new_n82_), .d(new_n61_), .O(new_n131_));
  nor3   g080(.a(x30), .b(x29), .c(x27), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n104_), .c(new_n82_), .d(new_n61_), .O(new_n133_));
  ...
  nor2   g088(.a(new_n133_), .b(new_n139_), .O(new_n140_));
  oai21  g089(.a(new_n134_), .b(x31), .c(x16), .O(new_n141_));
  inv1   g090(.a(x03), .O(new_n142_));
  aoi21  g091(.a(new_n56_), .b(new_n142_), .c(x18), .O(new_n143_));
  oai21  g092(.a(new_n141_), .b(new_n140_), .c(new_n143_), .O(z12));
  inv1   g093(.a(x32), .O(new_n145_));
  inv1   g094(.a(x30), .O(new_n146_));
  nand2  g095(.a(new_n130_), .b(new_n146_), .O(new_n147_));
  nand2  g096(.a(new_n139_), .b(new_n122_), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n98_), .c(new_n145_), .O(new_n150_));
  nor2   g099(.a(x32), .b(x31), .O(new_n151_));
  inv1   g100(.a(new_n151_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n133_), .O(new_n153_));
  ...
  nand2  g106(.a(new_n151_), .b(new_n146_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n124_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n98_), .O(new_n160_));
  inv1   g109(.a(x33), .O(new_n161_));
  nand3  g110(.a(new_n151_), .b(new_n132_), .c(new_n161_), .O(new_n162_));
  nor2   g111(.a(new_n162_), .b(new_n105_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n162_), .b(new_n105_), .c(x34), .O(new_n168_));
  nor2   g117(.a(x34), .b(x33), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n159_), .c(new_n98_), .O(new_n170_));
