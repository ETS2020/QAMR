...
module FAU ( 
  ...
  aoi21  g013(.a(new_n63_), .b(x21), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g018(.a(new_n58_), .b(new_n69_), .O(new_n70_));
  nor2   g019(.a(x22), .b(x21), .O(new_n71_));
  aoi22  g020(.a(new_n71_), .b(new_n58_), .c(new_n70_), .d(x22), .O(new_n72_));
  ...
  aoi21  g025(.a(new_n71_), .b(new_n58_), .c(new_n76_), .O(new_n77_));
  nand3  g026(.a(new_n71_), .b(new_n58_), .c(new_n76_), .O(new_n78_));
  ...
  nand3  g033(.a(new_n84_), .b(new_n71_), .c(new_n58_), .O(new_n85_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n84_), .c(new_n58_), .d(new_n69_), .O(new_n92_));
  ...
  nand4  g047(.a(new_n98_), .b(new_n84_), .c(new_n71_), .d(new_n58_), .O(new_n99_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n123_), .c(new_n122_), .d(new_n64_), .O(new_n163_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n149_), .c(new_n122_), .d(new_n64_), .O(new_n175_));
