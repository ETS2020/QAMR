...
module FAU ( 
  ...
  nand2  g032(.a(new_n71_), .b(new_n83_), .O(new_n84_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n71_), .c(new_n58_), .d(new_n57_), .O(new_n92_));
  ...
  nand2  g046(.a(new_n75_), .b(new_n65_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nor3   g048(.a(x25), .b(x24), .c(x23), .O(new_n100_));
  aoi22  g049(.a(new_n100_), .b(new_n99_), .c(new_n92_), .d(x25), .O(new_n101_));
  ...
  nand2  g053(.a(new_n100_), .b(new_n99_), .O(new_n105_));
  inv1   g054(.a(x25), .O(new_n106_));
  inv1   g055(.a(x26), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n106_), .c(new_n90_), .O(new_n108_));
  nor3   g057(.a(new_n108_), .b(new_n84_), .c(new_n82_), .O(new_n109_));
  ...
  inv1   g077(.a(new_n84_), .O(new_n129_));
  ...
  nand3  g086(.a(new_n133_), .b(new_n130_), .c(new_n85_), .O(new_n138_));
  ...
  nand4  g099(.a(new_n150_), .b(new_n115_), .c(new_n100_), .d(new_n99_), .O(new_n151_));
  ...
  nand4  g105(.a(new_n124_), .b(new_n148_), .c(new_n144_), .d(new_n143_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(x32), .O(new_n158_));
  nor3   g107(.a(x32), .b(x31), .c(x30), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n133_), .c(new_n130_), .d(new_n85_), .O(new_n160_));
  nor2   g109(.a(x18), .b(new_n52_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(z13));
  nor3   g111(.a(x33), .b(x26), .c(x25), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n159_), .c(new_n133_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n92_), .O(new_n165_));
  aoi21  g114(.a(new_n160_), .b(x33), .c(new_n165_), .O(new_n166_));
  ...
  oai21  g118(.a(new_n164_), .b(new_n92_), .c(x34), .O(new_n170_));
  inv1   g119(.a(x34), .O(new_n171_));
  inv1   g120(.a(new_n92_), .O(new_n172_));
  nand3  g121(.a(new_n143_), .b(new_n147_), .c(new_n114_), .O(new_n173_));
  inv1   g122(.a(x33), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n107_), .c(new_n106_), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n159_), .c(new_n172_), .d(new_n171_), .O(new_n177_));
