...
module FAU ( 
  ...
  nor2   g047(.a(new_n89_), .b(new_n72_), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(x06), .O(new_n111_));
  nor2   g049(.a(x32), .b(x30), .O(new_n112_));
  nor2   g050(.a(new_n84_), .b(new_n112_), .O(new_n113_));
  inv1   g051(.a(x40), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n74_), .c(x35), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n73_), .O(new_n116_));
  inv1   g054(.a(x07), .O(new_n117_));
  aoi21  g055(.a(new_n84_), .b(new_n117_), .c(new_n72_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n116_), .c(new_n113_), .O(new_n119_));
  oai21  g057(.a(new_n84_), .b(x05), .c(new_n64_), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n119_), .c(new_n111_), .O(z10));
  inv1   g059(.a(x09), .O(new_n122_));
  nand2  g060(.a(new_n77_), .b(new_n122_), .O(new_n123_));
  nand2  g061(.a(x35), .b(x27), .O(new_n124_));
  nor2   g062(.a(new_n124_), .b(x04), .O(new_n125_));
  ...
  and2   g069(.a(x39), .b(x29), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x08), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x28), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n131_), .c(new_n123_), .O(z11));
  nand2  g073(.a(x39), .b(new_n64_), .O(new_n136_));
  oai21  g074(.a(new_n66_), .b(new_n72_), .c(new_n136_), .O(new_n137_));
  inv1   g075(.a(x10), .O(new_n138_));
  oai21  g076(.a(x36), .b(x35), .c(x27), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n138_), .c(new_n114_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n110_), .c(new_n137_), .O(z12));
  nand2  g079(.a(new_n87_), .b(new_n89_), .O(new_n142_));
  ...
  nand2  g084(.a(new_n73_), .b(x28), .O(new_n147_));
  nand2  g085(.a(new_n127_), .b(x28), .O(new_n148_));
  nand2  g086(.a(new_n114_), .b(new_n74_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n147_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n146_), .c(new_n144_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand3  g090(.a(new_n113_), .b(new_n145_), .c(new_n64_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  inv1   g092(.a(x18), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand3  g094(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n157_));
  inv1   g095(.a(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n147_), .b(new_n158_), .c(x27), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n112_), .O(new_n160_));
  oai21  g098(.a(new_n146_), .b(new_n114_), .c(new_n72_), .O(new_n161_));
  oai21  g099(.a(new_n148_), .b(new_n79_), .c(x40), .O(new_n162_));
  nand3  g100(.a(new_n143_), .b(x37), .c(x20), .O(new_n163_));
  aoi22  g101(.a(new_n163_), .b(new_n162_), .c(new_n146_), .d(new_n144_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n161_), .c(new_n160_), .O(z14));
  ...
  nand3  g110(.a(x35), .b(new_n74_), .c(new_n72_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n128_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  aoi21  g113(.a(new_n125_), .b(new_n74_), .c(new_n123_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n175_), .O(z18));
  oai21  g115(.a(new_n132_), .b(new_n74_), .c(x35), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n128_), .O(new_n179_));
  nand3  g117(.a(new_n124_), .b(new_n77_), .c(new_n122_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(x08), .c(new_n180_), .O(z20));
  aoi21  g119(.a(new_n134_), .b(new_n131_), .c(new_n123_), .O(z19));
endmodule
