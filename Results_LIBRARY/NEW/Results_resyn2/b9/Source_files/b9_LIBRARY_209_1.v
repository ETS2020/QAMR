...
module FAU ( 
  ...
  nor2   g050(.a(x32), .b(x30), .O(new_n113_));
  nor2   g051(.a(new_n111_), .b(new_n113_), .O(new_n114_));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n84_), .c(new_n121_), .O(z11));
  nor2   g061(.a(x36), .b(x35), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n70_), .c(new_n69_), .O(new_n125_));
  nor2   g063(.a(new_n65_), .b(new_n64_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(x37), .c(x27), .O(new_n127_));
  ...
  oai21  g071(.a(new_n126_), .b(new_n116_), .c(new_n133_), .O(new_n134_));
  aoi21  g072(.a(new_n64_), .b(x27), .c(new_n81_), .O(new_n135_));
  nand3  g073(.a(x36), .b(x35), .c(x28), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  inv1   g075(.a(x13), .O(new_n138_));
  nor2   g076(.a(new_n85_), .b(x04), .O(new_n139_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n134_), .O(z13));
  oai21  g081(.a(new_n140_), .b(new_n135_), .c(new_n127_), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n113_), .c(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(new_n122_), .c(z08), .d(new_n138_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n132_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n144_), .O(z14));
  ...
  oai22  g095(.a(new_n85_), .b(new_n157_), .c(new_n65_), .d(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x08), .O(new_n159_));
  nand4  g097(.a(x35), .b(new_n64_), .c(x27), .d(new_n66_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n159_), .c(new_n119_), .O(z18));
  oai21  g099(.a(x27), .b(x08), .c(x35), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n120_), .c(new_n119_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(z20));
  aoi21  g102(.a(new_n122_), .b(new_n84_), .c(new_n121_), .O(z19));
endmodule
