...
module FAU ( 
  ...
  oai21  g47(.a(new_n108_), .b(x04), .c(new_n109_), .O(z10));
  inv1   g48(.a(x08), .O(new_n111_));
  nand2  g49(.a(z08), .b(x29), .O(new_n112_));
  aoi21  g50(.a(new_n112_), .b(new_n78_), .c(new_n111_), .O(new_n113_));
  nand2  g51(.a(new_n112_), .b(x27), .O(new_n114_));
  nand4  g52(.a(x35), .b(new_n73_), .c(x27), .d(new_n67_), .O(new_n115_));
  nor2   g53(.a(x30), .b(x09), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  aoi21  g55(.a(new_n114_), .b(new_n113_), .c(new_n117_), .O(z11));
  aoi22  g56(.a(new_n66_), .b(new_n86_), .c(x40), .d(new_n72_), .O(new_n119_));
  or2    g57(.a(new_n65_), .b(new_n72_), .O(new_n120_));
  nand2  g58(.a(new_n120_), .b(new_n68_), .O(new_n121_));
  oai21  g59(.a(new_n119_), .b(x10), .c(new_n121_), .O(z12));
  aoi21  g60(.a(x36), .b(x35), .c(new_n73_), .O(new_n123_));
  inv1   g61(.a(x13), .O(new_n124_));
  nand2  g62(.a(new_n64_), .b(new_n124_), .O(new_n125_));
  nor2   g63(.a(x19), .b(x18), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(x20), .O(new_n127_));
  oai22  g65(.a(new_n127_), .b(new_n65_), .c(new_n125_), .d(new_n123_), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(x27), .O(new_n129_));
  inv1   g67(.a(new_n75_), .O(new_n130_));
  nand3  g68(.a(new_n130_), .b(new_n64_), .c(new_n124_), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n129_), .O(z13));
  nand2  g70(.a(new_n123_), .b(new_n75_), .O(new_n133_));
  inv1   g71(.a(new_n133_), .O(new_n134_));
  oai21  g72(.a(new_n134_), .b(new_n125_), .c(new_n127_), .O(new_n135_));
  aoi21  g73(.a(new_n73_), .b(x27), .c(new_n130_), .O(new_n136_));
  oai21  g74(.a(new_n136_), .b(new_n125_), .c(new_n120_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(new_n135_), .O(z14));
  ...
  nand2  g85(.a(new_n147_), .b(new_n116_), .O(new_n148_));
  nor2   g86(.a(new_n148_), .b(new_n113_), .O(z20));
  aoi21  g87(.a(new_n114_), .b(new_n113_), .c(new_n117_), .O(z19));
endmodule
