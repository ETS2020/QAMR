...
module FAU ( 
  ...
  and2   g45(.a(x39), .b(x05), .O(new_n108_));
  and2   g46(.a(new_n63_), .b(x07), .O(new_n109_));
  aoi22  g47(.a(new_n109_), .b(new_n107_), .c(new_n108_), .d(new_n76_), .O(new_n110_));
  ...
  aoi21  g52(.a(new_n114_), .b(new_n78_), .c(new_n113_), .O(new_n115_));
  nand2  g53(.a(new_n114_), .b(x27), .O(new_n116_));
  nand4  g54(.a(x35), .b(new_n73_), .c(x27), .d(new_n67_), .O(new_n117_));
  ...
  aoi22  g58(.a(new_n66_), .b(new_n86_), .c(x40), .d(new_n72_), .O(new_n121_));
  or2    g59(.a(new_n65_), .b(new_n72_), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(new_n68_), .O(new_n123_));
  oai21  g61(.a(new_n121_), .b(x10), .c(new_n123_), .O(z12));
  aoi21  g62(.a(x36), .b(x35), .c(new_n73_), .O(new_n125_));
  inv1   g63(.a(x13), .O(new_n126_));
  nand2  g64(.a(new_n64_), .b(new_n126_), .O(new_n127_));
  nor2   g65(.a(x19), .b(x18), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(x20), .O(new_n129_));
  oai22  g67(.a(new_n129_), .b(new_n65_), .c(new_n127_), .d(new_n125_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  inv1   g69(.a(new_n75_), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n64_), .c(new_n126_), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(new_n131_), .O(z13));
  nand2  g72(.a(new_n125_), .b(new_n75_), .O(new_n135_));
  inv1   g73(.a(new_n135_), .O(new_n136_));
  oai21  g74(.a(new_n136_), .b(new_n127_), .c(new_n129_), .O(new_n137_));
  aoi21  g75(.a(new_n73_), .b(x27), .c(new_n132_), .O(new_n138_));
  oai21  g76(.a(new_n138_), .b(new_n127_), .c(new_n122_), .O(new_n139_));
  ...
  nand2  g87(.a(new_n149_), .b(new_n118_), .O(new_n150_));
