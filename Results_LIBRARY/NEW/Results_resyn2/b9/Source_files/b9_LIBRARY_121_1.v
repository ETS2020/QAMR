...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n86_, new_n87_, new_n90_, new_n92_, new_n95_, new_n96_, new_n97_,
  ...
  nor2   g026(.a(x37), .b(x28), .O(z06));
  oai22  g027(.a(z06), .b(x27), .c(new_n65_), .d(new_n64_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x21), .O(z03));
  inv1   g029(.a(x21), .O(new_n92_));
  nand2  g030(.a(new_n90_), .b(new_n92_), .O(z04));
  ...
  nand4  g055(.a(x35), .b(new_n64_), .c(x27), .d(new_n66_), .O(new_n118_));
  nor2   g056(.a(x30), .b(x09), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x29), .O(new_n121_));
  oai21  g059(.a(new_n77_), .b(x27), .c(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(x08), .c(new_n120_), .O(z11));
  nor2   g061(.a(new_n85_), .b(x04), .O(new_n124_));
  aoi21  g062(.a(x35), .b(x28), .c(x37), .O(new_n125_));
  nor2   g063(.a(x36), .b(x35), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n72_), .c(new_n125_), .O(new_n127_));
  aoi22  g065(.a(new_n127_), .b(x27), .c(new_n124_), .d(x10), .O(z12));
  nor2   g066(.a(new_n65_), .b(new_n64_), .O(new_n129_));
  ...
  oai21  g071(.a(new_n129_), .b(new_n115_), .c(new_n133_), .O(new_n134_));
  inv1   g072(.a(x13), .O(new_n135_));
  nand2  g073(.a(new_n124_), .b(new_n135_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  aoi21  g075(.a(new_n64_), .b(x27), .c(new_n81_), .O(new_n138_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n134_), .O(z13));
  nand2  g080(.a(x36), .b(x35), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n112_), .c(x28), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n136_), .c(new_n132_), .O(new_n146_));
  oai22  g084(.a(new_n138_), .b(new_n136_), .c(new_n125_), .d(new_n69_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z14));
  ...
  oai21  g093(.a(new_n65_), .b(x27), .c(new_n121_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x08), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n119_), .c(new_n118_), .O(z18));
  inv1   g096(.a(new_n121_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x08), .O(new_n160_));
  oai21  g098(.a(x27), .b(x08), .c(x35), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(new_n119_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z20));
  aoi21  g101(.a(new_n122_), .b(x08), .c(new_n120_), .O(z19));
endmodule
