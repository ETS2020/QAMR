...
module FAU ( 
  ...
  nand2  g61(.a(new_n86_), .b(new_n88_), .O(new_n124_));
  nor2   g62(.a(x19), .b(x18), .O(new_n125_));
  nand3  g63(.a(new_n125_), .b(new_n124_), .c(x20), .O(new_n126_));
  aoi21  g64(.a(x36), .b(x35), .c(new_n74_), .O(new_n127_));
  nor2   g65(.a(x13), .b(x04), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(z08), .O(new_n129_));
  oai21  g67(.a(new_n129_), .b(new_n127_), .c(new_n126_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  nand2  g69(.a(new_n128_), .b(new_n109_), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n131_), .O(z13));
  inv1   g71(.a(x35), .O(new_n134_));
  nand2  g72(.a(new_n88_), .b(new_n134_), .O(new_n135_));
  nand3  g73(.a(new_n135_), .b(new_n125_), .c(x20), .O(new_n136_));
  aoi21  g74(.a(new_n136_), .b(new_n127_), .c(new_n72_), .O(new_n137_));
  inv1   g75(.a(x40), .O(new_n138_));
  nand2  g76(.a(new_n128_), .b(x39), .O(new_n139_));
  nand4  g77(.a(new_n125_), .b(new_n124_), .c(x27), .d(x20), .O(new_n140_));
  aoi21  g78(.a(new_n140_), .b(new_n139_), .c(new_n138_), .O(new_n141_));
  oai21  g79(.a(new_n137_), .b(new_n78_), .c(new_n141_), .O(z14));
  ...
  nand2  g87(.a(new_n119_), .b(new_n118_), .O(new_n150_));
  nand3  g88(.a(new_n121_), .b(new_n120_), .c(new_n150_), .O(z18));
  oai21  g89(.a(new_n134_), .b(new_n72_), .c(new_n121_), .O(new_n152_));
