...
module FAU ( 
  ...
  oai21  g021(.a(new_n69_), .b(x04), .c(x28), .O(new_n84_));
  nand2  g022(.a(new_n75_), .b(x27), .O(new_n85_));
  nand4  g023(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(x40), .O(z02));
  ...
  aoi21  g050(.a(new_n78_), .b(new_n67_), .c(new_n112_), .O(new_n113_));
  aoi21  g051(.a(new_n111_), .b(new_n77_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g057(.a(new_n63_), .b(new_n119_), .c(x35), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n70_), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(x29), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n75_), .c(x08), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n85_), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n121_), .c(new_n118_), .O(z11));
  nand2  g064(.a(z08), .b(new_n119_), .O(new_n127_));
  oai21  g065(.a(x37), .b(x35), .c(x27), .O(new_n128_));
  aoi22  g066(.a(new_n128_), .b(new_n127_), .c(new_n89_), .d(new_n75_), .O(new_n129_));
  nor2   g067(.a(x37), .b(x35), .O(new_n130_));
  aoi22  g068(.a(new_n130_), .b(new_n74_), .c(x40), .d(new_n63_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(x10), .c(new_n129_), .O(z12));
  ...
  oai22  g075(.a(new_n137_), .b(new_n135_), .c(new_n134_), .d(new_n64_), .O(new_n138_));
  ...
  nand2  g080(.a(new_n135_), .b(new_n78_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n137_), .c(new_n134_), .O(new_n145_));
  oai21  g083(.a(new_n130_), .b(x40), .c(x13), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n79_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n128_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n145_), .c(new_n129_), .O(z14));
  ...
  aoi21  g095(.a(new_n122_), .b(new_n76_), .c(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n123_), .b(new_n63_), .c(new_n158_), .O(new_n159_));
  nand4  g097(.a(x35), .b(new_n75_), .c(x27), .d(new_n119_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n159_), .c(new_n117_), .O(z18));
  oai21  g099(.a(new_n87_), .b(new_n63_), .c(new_n117_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n158_), .O(z20));
  aoi21  g101(.a(new_n125_), .b(new_n121_), .c(new_n118_), .O(z19));
endmodule
