// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:40 2020
...
module FAU ( 
  ...
  nor2   g47(.a(x32), .b(x30), .O(new_n110_));
  nor2   g48(.a(new_n110_), .b(new_n83_), .O(new_n111_));
  inv1   g49(.a(x07), .O(new_n112_));
  nand2  g50(.a(new_n83_), .b(new_n112_), .O(new_n113_));
  aoi21  g51(.a(new_n113_), .b(new_n76_), .c(new_n111_), .O(new_n114_));
  oai21  g52(.a(new_n83_), .b(x05), .c(new_n65_), .O(new_n115_));
  nand3  g53(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g54(.a(new_n115_), .b(new_n114_), .c(new_n116_), .O(z10));
  inv1   g55(.a(x08), .O(new_n118_));
  nand2  g56(.a(z08), .b(x29), .O(new_n119_));
  aoi21  g57(.a(new_n119_), .b(new_n75_), .c(new_n118_), .O(new_n120_));
  nand2  g58(.a(new_n119_), .b(x27), .O(new_n121_));
  nand4  g59(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n122_));
  nor2   g60(.a(x30), .b(x09), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g62(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(z11));
  nand2  g63(.a(x36), .b(x35), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(x28), .O(new_n127_));
  nor2   g65(.a(x13), .b(x04), .O(new_n128_));
  nand3  g66(.a(new_n128_), .b(new_n127_), .c(z08), .O(new_n129_));
  inv1   g67(.a(x18), .O(new_n130_));
  inv1   g68(.a(x19), .O(new_n131_));
  nand3  g69(.a(x20), .b(new_n131_), .c(new_n130_), .O(new_n132_));
  oai21  g70(.a(new_n132_), .b(new_n63_), .c(new_n129_), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(x27), .O(new_n134_));
  nand2  g72(.a(new_n128_), .b(new_n111_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n134_), .O(z13));
  nand2  g74(.a(new_n128_), .b(z08), .O(new_n137_));
  nand3  g75(.a(new_n126_), .b(new_n110_), .c(x28), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(new_n139_));
  oai21  g77(.a(new_n139_), .b(new_n137_), .c(new_n132_), .O(new_n140_));
  aoi21  g78(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n141_));
  oai22  g79(.a(new_n141_), .b(new_n137_), .c(new_n63_), .d(new_n72_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(new_n140_), .O(z14));
  ...
  nand2  g88(.a(new_n121_), .b(new_n120_), .O(new_n151_));
  nand3  g89(.a(new_n123_), .b(new_n122_), .c(new_n151_), .O(z18));
  nand2  g90(.a(x35), .b(x27), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n123_), .O(new_n154_));
  nor2   g92(.a(new_n154_), .b(new_n120_), .O(z20));
  aoi21  g93(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(z19));
endmodule
