...
module FAU ( 
  ...
  and2   g047(.a(x37), .b(x06), .O(new_n110_));
  inv1   g048(.a(x39), .O(new_n111_));
  oai21  g049(.a(new_n111_), .b(x05), .c(new_n65_), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(x40), .O(new_n113_));
  aoi21  g051(.a(x40), .b(x39), .c(x07), .O(new_n114_));
  aoi21  g052(.a(new_n75_), .b(new_n73_), .c(new_n114_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n113_), .c(new_n110_), .O(new_n116_));
  nor2   g054(.a(x32), .b(x30), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n66_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(x05), .O(new_n119_));
  oai21  g057(.a(new_n116_), .b(new_n72_), .c(new_n119_), .O(z10));
  inv1   g058(.a(x08), .O(new_n121_));
  nand2  g059(.a(z08), .b(x29), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n75_), .c(new_n121_), .O(new_n123_));
  nand2  g061(.a(x39), .b(x29), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x27), .O(new_n125_));
  nor2   g063(.a(x30), .b(x09), .O(new_n126_));
  nand4  g064(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  aoi21  g066(.a(new_n125_), .b(new_n123_), .c(new_n128_), .O(z11));
  aoi22  g067(.a(new_n64_), .b(new_n89_), .c(x40), .d(new_n72_), .O(new_n130_));
  nand2  g068(.a(new_n87_), .b(new_n89_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n66_), .O(new_n133_));
  oai21  g071(.a(new_n130_), .b(x10), .c(new_n133_), .O(z12));
  inv1   g072(.a(x13), .O(new_n135_));
  nor2   g073(.a(new_n83_), .b(x04), .O(new_n136_));
  inv1   g074(.a(x35), .O(new_n137_));
  oai21  g075(.a(new_n73_), .b(new_n137_), .c(x28), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n136_), .c(new_n135_), .O(new_n139_));
  inv1   g077(.a(x18), .O(new_n140_));
  inv1   g078(.a(x19), .O(new_n141_));
  nand4  g079(.a(new_n131_), .b(x20), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nand2  g082(.a(new_n118_), .b(new_n135_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  nand3  g084(.a(x20), .b(new_n141_), .c(new_n140_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  inv1   g086(.a(new_n138_), .O(new_n149_));
  nand2  g087(.a(new_n136_), .b(new_n135_), .O(new_n150_));
  aoi21  g088(.a(new_n149_), .b(new_n117_), .c(new_n150_), .O(new_n151_));
  aoi21  g089(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(new_n132_), .O(new_n153_));
  ...
  nand2  g099(.a(new_n122_), .b(x27), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n123_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n127_), .c(new_n126_), .O(z18));
  oai21  g102(.a(new_n137_), .b(new_n72_), .c(new_n126_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n123_), .O(z20));
  aoi21  g104(.a(new_n125_), .b(new_n123_), .c(new_n128_), .O(z19));
endmodule
