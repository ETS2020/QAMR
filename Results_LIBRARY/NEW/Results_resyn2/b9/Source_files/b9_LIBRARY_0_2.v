...
module FAU ( 
  ...
  nor2   g046(.a(new_n77_), .b(new_n82_), .O(new_n109_));
  inv1   g047(.a(x07), .O(new_n110_));
  nand2  g048(.a(new_n82_), .b(new_n110_), .O(new_n111_));
  aoi21  g049(.a(new_n111_), .b(new_n76_), .c(new_n109_), .O(new_n112_));
  oai21  g050(.a(new_n82_), .b(x05), .c(new_n65_), .O(new_n113_));
  nand3  g051(.a(x37), .b(x27), .c(x06), .O(new_n114_));
  oai21  g052(.a(new_n113_), .b(new_n112_), .c(new_n114_), .O(z10));
  inv1   g053(.a(x08), .O(new_n116_));
  nand2  g054(.a(z08), .b(x29), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n75_), .c(new_n116_), .O(new_n118_));
  nand2  g056(.a(new_n117_), .b(x27), .O(new_n119_));
  nand4  g057(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n120_));
  ...
  aoi22  g061(.a(new_n64_), .b(new_n88_), .c(x40), .d(new_n72_), .O(new_n124_));
  oai21  g062(.a(new_n63_), .b(new_n72_), .c(new_n66_), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(x10), .c(new_n125_), .O(z12));
  inv1   g064(.a(x18), .O(new_n127_));
  nand2  g065(.a(new_n86_), .b(new_n88_), .O(new_n128_));
  inv1   g066(.a(x20), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(x19), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  inv1   g069(.a(x35), .O(new_n132_));
  oai21  g070(.a(new_n73_), .b(new_n132_), .c(x28), .O(new_n133_));
  ...
  nand2  g075(.a(new_n134_), .b(new_n109_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(z13));
  inv1   g077(.a(new_n109_), .O(new_n140_));
  inv1   g078(.a(x40), .O(new_n141_));
  oai21  g079(.a(new_n129_), .b(x19), .c(new_n141_), .O(new_n142_));
  nor2   g080(.a(new_n82_), .b(x28), .O(new_n143_));
  aoi21  g081(.a(new_n142_), .b(new_n128_), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n72_), .c(new_n140_), .O(new_n145_));
  nand2  g083(.a(new_n130_), .b(new_n127_), .O(new_n146_));
  oai21  g084(.a(new_n133_), .b(new_n78_), .c(x39), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  inv1   g086(.a(new_n134_), .O(new_n149_));
  aoi21  g087(.a(new_n130_), .b(x27), .c(new_n141_), .O(new_n150_));
  nand2  g088(.a(new_n128_), .b(new_n127_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n148_), .c(new_n145_), .O(z14));
  ...
  nand2  g098(.a(new_n119_), .b(new_n118_), .O(new_n161_));
  nand3  g099(.a(new_n121_), .b(new_n120_), .c(new_n161_), .O(z18));
  oai21  g100(.a(new_n132_), .b(new_n72_), .c(new_n121_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n118_), .O(z20));
  aoi21  g102(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
