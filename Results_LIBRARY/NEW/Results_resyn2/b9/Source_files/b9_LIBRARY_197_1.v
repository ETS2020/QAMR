...
module FAU ( 
  ...
  inv1   g18(.a(x08), .O(new_n81_));
  aoi21  g19(.a(new_n72_), .b(new_n81_), .c(new_n75_), .O(new_n82_));
  nand2  g20(.a(x40), .b(x39), .O(new_n83_));
  aoi21  g21(.a(x29), .b(x08), .c(x02), .O(new_n84_));
  nor2   g22(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g23(.a(new_n82_), .b(new_n65_), .c(new_n85_), .O(z02));
  ...
  nand2  g47(.a(z08), .b(x05), .O(new_n110_));
  oai21  g48(.a(new_n87_), .b(x28), .c(new_n73_), .O(new_n111_));
  inv1   g49(.a(x07), .O(new_n112_));
  aoi21  g50(.a(x40), .b(x39), .c(new_n112_), .O(new_n113_));
  nand3  g51(.a(new_n113_), .b(new_n111_), .c(x27), .O(new_n114_));
  nand2  g52(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  nand2  g53(.a(new_n115_), .b(new_n65_), .O(new_n116_));
  nand3  g54(.a(x37), .b(x27), .c(x06), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(new_n116_), .O(z10));
  inv1   g56(.a(x09), .O(new_n119_));
  nand2  g57(.a(new_n77_), .b(new_n119_), .O(new_n120_));
  nand2  g58(.a(x27), .b(x04), .O(new_n121_));
  aoi21  g59(.a(new_n121_), .b(new_n82_), .c(new_n120_), .O(z11));
  nor2   g60(.a(x19), .b(x18), .O(new_n123_));
  nand3  g61(.a(new_n123_), .b(x27), .c(x20), .O(new_n124_));
  oai22  g62(.a(new_n124_), .b(new_n63_), .c(new_n66_), .d(x13), .O(z13));
  inv1   g63(.a(z13), .O(z14));
  ...
  oai21  g72(.a(x28), .b(new_n81_), .c(new_n72_), .O(new_n135_));
  aoi21  g73(.a(new_n135_), .b(x35), .c(new_n120_), .O(z20));
  aoi21  g74(.a(new_n121_), .b(new_n82_), .c(new_n120_), .O(z19));
endmodule
