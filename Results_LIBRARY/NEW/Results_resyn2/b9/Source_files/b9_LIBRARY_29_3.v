...
module FAU ( 
  ...
  nor2   g055(.a(new_n117_), .b(x28), .O(new_n118_));
  nor2   g056(.a(new_n72_), .b(x04), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n118_), .c(x09), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  inv1   g059(.a(x40), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(x39), .c(x09), .O(new_n123_));
  nand3  g061(.a(x40), .b(x39), .c(x29), .O(new_n124_));
  oai21  g062(.a(new_n72_), .b(new_n65_), .c(new_n118_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n121_), .c(x30), .O(z11));
  aoi22  g065(.a(new_n64_), .b(new_n89_), .c(x40), .d(new_n72_), .O(new_n128_));
  ...
  nor2   g071(.a(new_n83_), .b(x04), .O(new_n134_));
  oai21  g072(.a(new_n73_), .b(new_n117_), .c(x28), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  inv1   g074(.a(x18), .O(new_n137_));
  inv1   g075(.a(x19), .O(new_n138_));
  nand4  g076(.a(new_n129_), .b(x20), .c(new_n138_), .d(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x27), .O(new_n141_));
  nand3  g079(.a(new_n79_), .b(new_n134_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(z13));
  nand3  g081(.a(x20), .b(new_n138_), .c(new_n137_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  inv1   g083(.a(new_n79_), .O(new_n146_));
  inv1   g084(.a(new_n135_), .O(new_n147_));
  nand2  g085(.a(new_n134_), .b(new_n133_), .O(new_n148_));
  aoi21  g086(.a(new_n147_), .b(new_n146_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n130_), .O(new_n151_));
  oai21  g089(.a(new_n149_), .b(new_n145_), .c(new_n151_), .O(z14));
  ...
  aoi21  g097(.a(new_n124_), .b(new_n75_), .c(new_n116_), .O(new_n160_));
  nand2  g098(.a(new_n124_), .b(x27), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n120_), .c(new_n77_), .O(z18));
  ...
  nand4  g105(.a(new_n167_), .b(new_n164_), .c(new_n123_), .d(new_n77_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z20));
  aoi21  g107(.a(new_n126_), .b(new_n121_), .c(x30), .O(z19));
endmodule
