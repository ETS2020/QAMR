// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:17 2020
...
module FAU ( 
  ...
  aoi21  g17(.a(new_n72_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  inv1   g18(.a(new_n63_), .O(z08));
  nand2  g19(.a(z08), .b(x02), .O(new_n82_));
  inv1   g20(.a(new_n82_), .O(new_n83_));
  oai21  g21(.a(new_n80_), .b(new_n67_), .c(new_n83_), .O(z02));
  ...
  nor2   g44(.a(new_n74_), .b(new_n72_), .O(new_n107_));
  aoi22  g45(.a(new_n76_), .b(z08), .c(new_n107_), .d(x07), .O(new_n108_));
  oai21  g46(.a(new_n63_), .b(x05), .c(new_n67_), .O(new_n109_));
  nand3  g47(.a(x37), .b(x27), .c(x06), .O(new_n110_));
  oai21  g48(.a(new_n109_), .b(new_n108_), .c(new_n110_), .O(z10));
  inv1   g49(.a(x09), .O(new_n112_));
  inv1   g50(.a(x30), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g52(.a(x27), .b(x04), .O(new_n115_));
  aoi21  g53(.a(new_n115_), .b(new_n80_), .c(new_n114_), .O(z11));
  aoi22  g54(.a(new_n66_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n117_));
  oai21  g55(.a(new_n65_), .b(new_n72_), .c(new_n68_), .O(new_n118_));
  oai21  g56(.a(new_n117_), .b(x10), .c(new_n118_), .O(z12));
  aoi21  g57(.a(x36), .b(x35), .c(new_n73_), .O(new_n120_));
  inv1   g58(.a(x13), .O(new_n121_));
  nand2  g59(.a(new_n64_), .b(new_n121_), .O(new_n122_));
  nand2  g60(.a(new_n85_), .b(new_n87_), .O(new_n123_));
  nor2   g61(.a(x19), .b(x18), .O(new_n124_));
  nand3  g62(.a(new_n124_), .b(new_n123_), .c(x20), .O(new_n125_));
  oai21  g63(.a(new_n122_), .b(new_n120_), .c(new_n125_), .O(new_n126_));
  nor2   g64(.a(new_n122_), .b(new_n75_), .O(new_n127_));
  aoi21  g65(.a(new_n126_), .b(x27), .c(new_n127_), .O(z14));
  inv1   g66(.a(z14), .O(z13));
  ...
  nand4  g72(.a(new_n134_), .b(x23), .c(x22), .d(x01), .O(new_n135_));
  inv1   g73(.a(new_n135_), .O(z17));
  inv1   g74(.a(z11), .O(z18));
  oai21  g75(.a(x28), .b(new_n78_), .c(new_n72_), .O(new_n138_));
  aoi21  g76(.a(new_n138_), .b(x35), .c(new_n114_), .O(z20));
  aoi21  g77(.a(new_n115_), .b(new_n80_), .c(new_n114_), .O(z19));
endmodule
