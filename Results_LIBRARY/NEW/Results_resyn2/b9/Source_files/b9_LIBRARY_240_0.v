...
module FAU ( 
  ...
  and2   g47(.a(new_n80_), .b(x07), .O(new_n110_));
  aoi22  g48(.a(new_n110_), .b(new_n107_), .c(new_n109_), .d(new_n75_), .O(new_n111_));
  ...
  aoi21  g53(.a(new_n115_), .b(new_n77_), .c(new_n114_), .O(new_n116_));
  nand2  g54(.a(new_n115_), .b(x27), .O(new_n117_));
  nand4  g55(.a(x35), .b(new_n72_), .c(x27), .d(new_n63_), .O(new_n118_));
  ...
  aoi21  g59(.a(x36), .b(x35), .c(new_n72_), .O(new_n122_));
  inv1   g60(.a(x13), .O(new_n123_));
  nand3  g61(.a(x39), .b(new_n123_), .c(new_n63_), .O(new_n124_));
  nor2   g62(.a(x19), .b(x18), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(x20), .O(new_n126_));
  oai22  g64(.a(new_n126_), .b(new_n66_), .c(new_n124_), .d(new_n122_), .O(new_n127_));
  nor2   g65(.a(new_n124_), .b(new_n74_), .O(new_n128_));
  aoi21  g66(.a(new_n127_), .b(x27), .c(new_n128_), .O(z14));
  inv1   g67(.a(z14), .O(z13));
  nand4  g68(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n131_));
  inv1   g69(.a(new_n131_), .O(z15));
  nand2  g70(.a(x22), .b(x01), .O(new_n133_));
  nor2   g71(.a(new_n133_), .b(x23), .O(z16));
  inv1   g72(.a(x24), .O(new_n135_));
  nand4  g73(.a(new_n135_), .b(x23), .c(x22), .d(x01), .O(new_n136_));
  inv1   g74(.a(new_n136_), .O(z17));
  inv1   g75(.a(z11), .O(z18));
  nand2  g76(.a(x35), .b(x27), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n119_), .O(new_n140_));
  nor2   g78(.a(new_n140_), .b(new_n116_), .O(z20));
  aoi21  g79(.a(new_n117_), .b(new_n116_), .c(new_n120_), .O(z19));
endmodule
