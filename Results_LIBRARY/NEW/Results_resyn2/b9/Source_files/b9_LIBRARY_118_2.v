// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:25 2020
...
module FAU ( 
  ...
  nand2  g02(.a(x39), .b(new_n64_), .O(new_n65_));
  aoi21  g03(.a(x35), .b(x28), .c(x37), .O(new_n66_));
  oai21  g04(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  nand3  g05(.a(x39), .b(x10), .c(new_n64_), .O(new_n68_));
  ...
  oai21  g25(.a(new_n87_), .b(new_n74_), .c(x27), .O(new_n88_));
  ...
  and2   g44(.a(x40), .b(x39), .O(z08));
  nand4  g45(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  inv1   g46(.a(new_n108_), .O(z09));
  nand3  g47(.a(z08), .b(new_n79_), .c(x05), .O(new_n110_));
  oai21  g48(.a(new_n87_), .b(x28), .c(new_n73_), .O(new_n111_));
  inv1   g49(.a(x05), .O(new_n112_));
  nand3  g50(.a(x40), .b(x39), .c(new_n112_), .O(new_n113_));
  inv1   g51(.a(x07), .O(new_n114_));
  nand2  g52(.a(new_n83_), .b(new_n114_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(new_n113_), .c(new_n111_), .d(x27), .O(new_n116_));
  nand2  g54(.a(new_n116_), .b(new_n110_), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(new_n64_), .O(new_n118_));
  nand3  g56(.a(x37), .b(x27), .c(x06), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n118_), .O(z10));
  inv1   g58(.a(x08), .O(new_n121_));
  nand2  g59(.a(z08), .b(x29), .O(new_n122_));
  aoi21  g60(.a(new_n122_), .b(new_n75_), .c(new_n121_), .O(new_n123_));
  nand2  g61(.a(new_n122_), .b(x27), .O(new_n124_));
  nand4  g62(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n125_));
  nor2   g63(.a(x30), .b(x09), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  aoi21  g65(.a(new_n124_), .b(new_n123_), .c(new_n127_), .O(z11));
  inv1   g66(.a(new_n63_), .O(new_n129_));
  nand4  g67(.a(new_n129_), .b(x40), .c(x39), .d(new_n64_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(new_n66_), .O(new_n131_));
  aoi22  g69(.a(new_n131_), .b(x27), .c(new_n69_), .d(x40), .O(z12));
  aoi21  g70(.a(x36), .b(x35), .c(new_n74_), .O(new_n133_));
  nor2   g71(.a(x13), .b(x04), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(z08), .O(new_n135_));
  nor2   g73(.a(x19), .b(x18), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x20), .O(new_n137_));
  oai22  g75(.a(new_n137_), .b(new_n66_), .c(new_n135_), .d(new_n133_), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(x27), .O(new_n139_));
  nand3  g77(.a(new_n134_), .b(z08), .c(new_n79_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n139_), .O(z13));
  nand3  g79(.a(new_n133_), .b(new_n78_), .c(new_n77_), .O(new_n142_));
  nand3  g80(.a(new_n142_), .b(new_n134_), .c(z08), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  aoi21  g82(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n145_));
  oai22  g83(.a(new_n145_), .b(new_n135_), .c(new_n66_), .d(new_n72_), .O(new_n146_));
  ...
  nand2  g92(.a(new_n124_), .b(new_n123_), .O(new_n155_));
  nand3  g93(.a(new_n126_), .b(new_n125_), .c(new_n155_), .O(z18));
  oai21  g94(.a(new_n87_), .b(new_n72_), .c(new_n126_), .O(new_n157_));
  nor2   g95(.a(new_n157_), .b(new_n123_), .O(z20));
  aoi21  g96(.a(new_n124_), .b(new_n123_), .c(new_n127_), .O(z19));
endmodule
