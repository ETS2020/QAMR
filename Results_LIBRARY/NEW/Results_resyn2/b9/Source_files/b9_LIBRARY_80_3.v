// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:09 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n143_, new_n145_, new_n147_, new_n148_, new_n151_;
  ...
  aoi21  g12(.a(x35), .b(new_n74_), .c(x36), .O(new_n75_));
  oai21  g13(.a(new_n75_), .b(new_n72_), .c(new_n73_), .O(new_n76_));
  oai21  g14(.a(new_n76_), .b(x32), .c(x04), .O(z01));
  nand2  g15(.a(x35), .b(new_n74_), .O(new_n78_));
  ...
  inv1   g41(.a(new_n63_), .O(z08));
  nand4  g42(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n105_));
  inv1   g43(.a(new_n105_), .O(z09));
  nor2   g44(.a(new_n75_), .b(new_n72_), .O(new_n107_));
  nand2  g45(.a(z08), .b(x05), .O(new_n108_));
  inv1   g46(.a(new_n108_), .O(new_n109_));
  and2   g47(.a(new_n63_), .b(x07), .O(new_n110_));
  aoi22  g48(.a(new_n110_), .b(new_n107_), .c(new_n109_), .d(new_n76_), .O(new_n111_));
  ...
  aoi21  g53(.a(new_n115_), .b(new_n78_), .c(new_n114_), .O(new_n116_));
  nand2  g54(.a(new_n115_), .b(x27), .O(new_n117_));
  nand4  g55(.a(x35), .b(new_n74_), .c(x27), .d(new_n67_), .O(new_n118_));
  ...
  aoi22  g59(.a(new_n66_), .b(new_n86_), .c(x40), .d(new_n72_), .O(new_n122_));
  or2    g60(.a(new_n65_), .b(new_n72_), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n68_), .O(new_n124_));
  oai21  g62(.a(new_n122_), .b(x10), .c(new_n124_), .O(z12));
  aoi21  g63(.a(x36), .b(x35), .c(new_n74_), .O(new_n126_));
  inv1   g64(.a(x13), .O(new_n127_));
  nand2  g65(.a(new_n64_), .b(new_n127_), .O(new_n128_));
  nor2   g66(.a(x19), .b(x18), .O(new_n129_));
  nand2  g67(.a(new_n129_), .b(x20), .O(new_n130_));
  oai22  g68(.a(new_n130_), .b(new_n65_), .c(new_n128_), .d(new_n126_), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(x27), .O(new_n132_));
  nand3  g70(.a(new_n64_), .b(x30), .c(new_n127_), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(new_n132_), .O(z13));
  nand2  g72(.a(new_n126_), .b(new_n73_), .O(new_n135_));
  inv1   g73(.a(new_n135_), .O(new_n136_));
  oai21  g74(.a(new_n136_), .b(new_n128_), .c(new_n130_), .O(new_n137_));
  nand2  g75(.a(new_n128_), .b(new_n123_), .O(new_n138_));
  nand3  g76(.a(new_n86_), .b(new_n84_), .c(x28), .O(new_n139_));
  oai21  g77(.a(x32), .b(x27), .c(new_n139_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n73_), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n138_), .c(new_n137_), .O(z14));
  nand4  g80(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n143_));
  inv1   g81(.a(new_n143_), .O(z15));
  nand2  g82(.a(x22), .b(x01), .O(new_n145_));
  nor2   g83(.a(new_n145_), .b(x23), .O(z16));
  inv1   g84(.a(x24), .O(new_n147_));
  nand4  g85(.a(new_n147_), .b(x23), .c(x22), .d(x01), .O(new_n148_));
  inv1   g86(.a(new_n148_), .O(z17));
  inv1   g87(.a(z11), .O(z18));
  oai21  g88(.a(new_n84_), .b(new_n72_), .c(new_n119_), .O(new_n151_));
  nor2   g89(.a(new_n151_), .b(new_n116_), .O(z20));
  aoi21  g90(.a(new_n117_), .b(new_n116_), .c(new_n120_), .O(z19));
endmodule
