...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n134_, new_n135_, new_n138_, new_n140_, new_n142_, new_n143_,
    new_n145_, new_n147_;
  ...
  inv1   g47(.a(x39), .O(new_n110_));
  aoi21  g48(.a(new_n78_), .b(new_n77_), .c(new_n110_), .O(new_n111_));
  nor2   g49(.a(new_n111_), .b(new_n76_), .O(new_n112_));
  inv1   g50(.a(x05), .O(new_n113_));
  aoi21  g51(.a(x39), .b(new_n113_), .c(x04), .O(new_n114_));
  oai21  g52(.a(x39), .b(x07), .c(new_n114_), .O(new_n115_));
  nand3  g53(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g54(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(z10));
  inv1   g55(.a(new_n75_), .O(new_n118_));
  nand4  g56(.a(new_n118_), .b(x40), .c(x27), .d(new_n64_), .O(new_n119_));
  nor2   g57(.a(x30), .b(x09), .O(new_n120_));
  inv1   g58(.a(x08), .O(new_n121_));
  nand3  g59(.a(x40), .b(x39), .c(x29), .O(new_n122_));
  ...
  nand3  g63(.a(new_n125_), .b(new_n120_), .c(new_n119_), .O(new_n126_));
  inv1   g64(.a(new_n126_), .O(z11));
  nor2   g65(.a(x13), .b(x04), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n111_), .O(new_n129_));
  nor2   g67(.a(x19), .b(x18), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x20), .O(new_n131_));
  aoi21  g69(.a(x36), .b(x35), .c(new_n74_), .O(new_n132_));
  nand2  g70(.a(new_n128_), .b(x39), .O(new_n133_));
  oai22  g71(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n66_), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(x27), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n129_), .O(z13));
  aoi22  g74(.a(new_n134_), .b(x27), .c(new_n128_), .d(new_n111_), .O(z14));
  ...
  nand3  g82(.a(new_n118_), .b(x27), .c(new_n64_), .O(new_n145_));
  nand3  g83(.a(new_n125_), .b(new_n120_), .c(new_n145_), .O(z18));
  oai21  g84(.a(new_n87_), .b(new_n72_), .c(new_n120_), .O(new_n147_));
  nor2   g85(.a(new_n147_), .b(new_n123_), .O(z20));
  inv1   g86(.a(new_n126_), .O(z19));
endmodule
