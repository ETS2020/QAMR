...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n70_, new_n71_,
    ...
    new_n80_, new_n81_, new_n82_, new_n84_, new_n85_, new_n87_, new_n91_,
  ...
  aoi21  g05(.a(new_n65_), .b(x27), .c(new_n67_), .O(z12));
  oai21  g06(.a(z12), .b(x15), .c(x16), .O(z00));
  inv1   g07(.a(x27), .O(new_n70_));
  inv1   g08(.a(x36), .O(new_n71_));
  inv1   g09(.a(x28), .O(new_n72_));
  nand2  g10(.a(x35), .b(new_n72_), .O(new_n73_));
  aoi21  g11(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  ...
  nand2  g22(.a(new_n63_), .b(new_n70_), .O(new_n85_));
  nand3  g23(.a(new_n85_), .b(new_n84_), .c(x21), .O(z03));
  inv1   g24(.a(x21), .O(new_n87_));
  nand3  g25(.a(new_n85_), .b(new_n84_), .c(new_n87_), .O(z04));
  ...
  inv1   g39(.a(new_n66_), .O(z08));
  nand4  g40(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n103_));
  inv1   g41(.a(new_n103_), .O(z09));
  nor2   g42(.a(x32), .b(x30), .O(new_n105_));
  nand3  g43(.a(x40), .b(x39), .c(x05), .O(new_n106_));
  nor2   g44(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g45(.a(new_n66_), .b(x07), .O(new_n108_));
  nand2  g46(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  aoi21  g47(.a(new_n109_), .b(new_n74_), .c(new_n107_), .O(new_n110_));
  nand3  g48(.a(x37), .b(x27), .c(x06), .O(new_n111_));
  oai21  g49(.a(new_n110_), .b(x04), .c(new_n111_), .O(z10));
  nor2   g50(.a(x30), .b(x09), .O(new_n113_));
  inv1   g51(.a(new_n113_), .O(new_n114_));
  inv1   g52(.a(x08), .O(new_n115_));
  and2   g53(.a(x40), .b(x04), .O(new_n116_));
  inv1   g54(.a(x35), .O(new_n117_));
  nor2   g55(.a(new_n117_), .b(x28), .O(new_n118_));
  nand2  g56(.a(new_n118_), .b(x27), .O(new_n119_));
  oai21  g57(.a(new_n119_), .b(new_n116_), .c(new_n115_), .O(new_n120_));
  nand2  g58(.a(z08), .b(x29), .O(new_n121_));
  inv1   g59(.a(x04), .O(new_n122_));
  nor2   g60(.a(new_n70_), .b(new_n122_), .O(new_n123_));
  oai21  g61(.a(new_n123_), .b(new_n73_), .c(new_n121_), .O(new_n124_));
  aoi21  g62(.a(new_n124_), .b(new_n120_), .c(new_n114_), .O(z11));
  inv1   g63(.a(x13), .O(new_n126_));
  oai21  g64(.a(new_n71_), .b(new_n117_), .c(x28), .O(new_n127_));
  nand3  g65(.a(new_n127_), .b(new_n67_), .c(new_n126_), .O(new_n128_));
  inv1   g66(.a(x18), .O(new_n129_));
  inv1   g67(.a(x19), .O(new_n130_));
  nand4  g68(.a(new_n65_), .b(x20), .c(new_n130_), .d(new_n129_), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(x27), .O(new_n133_));
  nand3  g71(.a(new_n77_), .b(new_n67_), .c(new_n126_), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(new_n133_), .O(z13));
  nand3  g73(.a(x20), .b(new_n130_), .c(new_n129_), .O(new_n136_));
  inv1   g74(.a(new_n136_), .O(new_n137_));
  inv1   g75(.a(new_n127_), .O(new_n138_));
  nand2  g76(.a(new_n67_), .b(new_n126_), .O(new_n139_));
  aoi21  g77(.a(new_n138_), .b(new_n105_), .c(new_n139_), .O(new_n140_));
  nand2  g78(.a(new_n65_), .b(x27), .O(new_n141_));
  aoi21  g79(.a(new_n72_), .b(x27), .c(new_n77_), .O(new_n142_));
  oai21  g80(.a(new_n142_), .b(new_n139_), .c(new_n141_), .O(new_n143_));
  oai21  g81(.a(new_n140_), .b(new_n137_), .c(new_n143_), .O(z14));
  ...
  nand2  g89(.a(new_n121_), .b(new_n73_), .O(new_n152_));
  nand2  g90(.a(new_n121_), .b(x27), .O(new_n153_));
  nand3  g91(.a(new_n153_), .b(new_n152_), .c(x08), .O(new_n154_));
  nand3  g92(.a(new_n118_), .b(x27), .c(new_n122_), .O(new_n155_));
  nand3  g93(.a(new_n155_), .b(new_n154_), .c(new_n113_), .O(z18));
  oai21  g94(.a(new_n117_), .b(new_n70_), .c(new_n113_), .O(new_n157_));
  aoi21  g95(.a(new_n152_), .b(x08), .c(new_n157_), .O(z20));
  aoi21  g96(.a(new_n124_), .b(new_n120_), .c(new_n114_), .O(z19));
endmodule
