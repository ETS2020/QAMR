...
module FAU ( 
  ...
  inv1   g09(.a(x32), .O(new_n72_));
  inv1   g10(.a(x36), .O(new_n73_));
  oai21  g11(.a(x36), .b(x35), .c(x27), .O(new_n74_));
  aoi22  g12(.a(new_n74_), .b(new_n72_), .c(new_n73_), .d(x28), .O(new_n75_));
  oai21  g13(.a(new_n75_), .b(x30), .c(x04), .O(z01));
  ...
  inv1   g43(.a(new_n81_), .O(z08));
  nand4  g44(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n107_));
  inv1   g45(.a(new_n107_), .O(z09));
  nand2  g46(.a(new_n79_), .b(new_n73_), .O(new_n109_));
  inv1   g47(.a(x30), .O(new_n110_));
  aoi21  g48(.a(new_n72_), .b(new_n110_), .c(new_n81_), .O(new_n111_));
  aoi21  g49(.a(new_n109_), .b(x27), .c(new_n111_), .O(new_n112_));
  inv1   g50(.a(x07), .O(new_n113_));
  aoi21  g51(.a(new_n81_), .b(new_n113_), .c(x04), .O(new_n114_));
  oai21  g52(.a(new_n81_), .b(x05), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g57(.a(new_n119_), .b(new_n79_), .c(new_n118_), .O(new_n120_));
  ...
  nand2  g64(.a(new_n126_), .b(new_n111_), .O(new_n127_));
  nand2  g65(.a(new_n127_), .b(new_n87_), .O(new_n128_));
  inv1   g66(.a(x18), .O(new_n129_));
  inv1   g67(.a(x19), .O(new_n130_));
  nand2  g68(.a(new_n85_), .b(new_n88_), .O(new_n131_));
  nand4  g69(.a(new_n131_), .b(x20), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  nand2  g70(.a(x36), .b(x35), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(x28), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n126_), .c(z08), .O(new_n135_));
  nand3  g73(.a(new_n135_), .b(new_n132_), .c(new_n127_), .O(new_n136_));
  and2   g74(.a(new_n136_), .b(new_n128_), .O(z13));
  nand3  g75(.a(x20), .b(new_n130_), .c(new_n129_), .O(new_n138_));
  nand2  g76(.a(new_n126_), .b(z08), .O(new_n139_));
  nand3  g77(.a(new_n133_), .b(new_n110_), .c(x28), .O(new_n140_));
  inv1   g78(.a(new_n140_), .O(new_n141_));
  oai21  g79(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(new_n142_));
  nor2   g80(.a(x30), .b(new_n78_), .O(new_n143_));
  nor2   g81(.a(x37), .b(x35), .O(new_n144_));
  aoi22  g82(.a(new_n144_), .b(new_n143_), .c(new_n139_), .d(new_n63_), .O(new_n145_));
  nand3  g83(.a(new_n145_), .b(new_n142_), .c(new_n128_), .O(z14));
  ...
  nand2  g91(.a(new_n121_), .b(new_n120_), .O(new_n154_));
  nand3  g92(.a(new_n123_), .b(new_n122_), .c(new_n154_), .O(z18));
  nand2  g93(.a(x35), .b(x27), .O(new_n156_));
  nand2  g94(.a(new_n156_), .b(new_n123_), .O(new_n157_));
  nor2   g95(.a(new_n157_), .b(new_n120_), .O(z20));
  aoi21  g96(.a(new_n121_), .b(new_n120_), .c(new_n124_), .O(z19));
endmodule
