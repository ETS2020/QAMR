// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:04 2020
...
module FAU ( 
  ...
  nor2   g67(.a(new_n81_), .b(x04), .O(new_n130_));
  nand2  g68(.a(x36), .b(x35), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(x28), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(new_n133_));
  inv1   g71(.a(x18), .O(new_n134_));
  inv1   g72(.a(x19), .O(new_n135_));
  nand4  g73(.a(new_n125_), .b(x20), .c(new_n135_), .d(new_n134_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(x27), .O(new_n138_));
  inv1   g76(.a(new_n75_), .O(new_n139_));
  nand3  g77(.a(new_n139_), .b(new_n130_), .c(new_n129_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n138_), .O(z13));
  nand2  g79(.a(new_n130_), .b(new_n129_), .O(new_n142_));
  nand2  g80(.a(x20), .b(new_n134_), .O(new_n143_));
  nand3  g81(.a(new_n131_), .b(new_n75_), .c(x28), .O(new_n144_));
  inv1   g82(.a(new_n144_), .O(new_n145_));
  oai21  g83(.a(new_n145_), .b(new_n142_), .c(new_n143_), .O(new_n146_));
  aoi21  g84(.a(new_n73_), .b(x27), .c(new_n139_), .O(new_n147_));
  oai21  g85(.a(new_n147_), .b(new_n142_), .c(new_n126_), .O(new_n148_));
  nand3  g86(.a(new_n148_), .b(new_n146_), .c(new_n135_), .O(z14));
  ...
  nand2  g94(.a(new_n119_), .b(new_n118_), .O(new_n157_));
  nand3  g95(.a(new_n121_), .b(new_n120_), .c(new_n157_), .O(z18));
  nand2  g96(.a(x35), .b(x27), .O(new_n159_));
  nand2  g97(.a(new_n159_), .b(new_n121_), .O(new_n160_));
