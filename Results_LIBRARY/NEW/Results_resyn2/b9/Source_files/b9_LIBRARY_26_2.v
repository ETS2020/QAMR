...
module FAU ( 
  ...
  nand3  g05(.a(x39), .b(x10), .c(new_n65_), .O(new_n68_));
  ...
  aoi21  g61(.a(new_n64_), .b(new_n87_), .c(new_n72_), .O(new_n124_));
  nand2  g62(.a(x40), .b(x04), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(x39), .O(new_n126_));
  aoi22  g64(.a(new_n126_), .b(new_n72_), .c(new_n66_), .d(new_n63_), .O(new_n127_));
  oai21  g65(.a(new_n124_), .b(x10), .c(new_n127_), .O(z12));
  inv1   g66(.a(x13), .O(new_n129_));
  nor2   g67(.a(new_n81_), .b(x04), .O(new_n130_));
  oai21  g68(.a(new_n108_), .b(new_n85_), .c(x28), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n130_), .c(new_n129_), .O(new_n132_));
  inv1   g70(.a(new_n63_), .O(new_n133_));
  nor2   g71(.a(x19), .b(x18), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n133_), .c(x20), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  inv1   g75(.a(new_n75_), .O(new_n138_));
  nand2  g76(.a(new_n130_), .b(new_n129_), .O(new_n139_));
  inv1   g77(.a(new_n139_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n137_), .O(z13));
  aoi22  g80(.a(new_n136_), .b(x27), .c(new_n140_), .d(new_n138_), .O(z14));
  ...
  oai21  g90(.a(new_n85_), .b(new_n72_), .c(new_n121_), .O(new_n153_));
