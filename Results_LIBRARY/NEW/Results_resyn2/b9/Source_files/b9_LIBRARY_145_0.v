...
module FAU ( 
  ...
  nand2  g055(.a(x40), .b(x29), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n78_), .c(new_n117_), .O(new_n119_));
  nand2  g057(.a(new_n118_), .b(x27), .O(new_n120_));
  nand4  g058(.a(x35), .b(new_n73_), .c(x27), .d(new_n65_), .O(new_n121_));
  nor2   g059(.a(x30), .b(x09), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  aoi21  g061(.a(new_n120_), .b(new_n119_), .c(new_n123_), .O(z11));
  aoi22  g062(.a(new_n64_), .b(new_n88_), .c(x39), .d(new_n72_), .O(new_n125_));
  nand2  g063(.a(new_n86_), .b(new_n88_), .O(new_n126_));
  ...
  nor2   g068(.a(new_n82_), .b(x04), .O(new_n131_));
  inv1   g069(.a(x35), .O(new_n132_));
  oai21  g070(.a(new_n109_), .b(new_n132_), .c(x28), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n131_), .c(new_n130_), .O(new_n134_));
  inv1   g072(.a(x18), .O(new_n135_));
  inv1   g073(.a(x19), .O(new_n136_));
  nand4  g074(.a(new_n126_), .b(x20), .c(new_n136_), .d(new_n135_), .O(new_n137_));
  ...
  nand2  g081(.a(new_n143_), .b(new_n139_), .O(z13));
  nand3  g082(.a(x20), .b(new_n136_), .c(new_n135_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  inv1   g084(.a(new_n133_), .O(new_n147_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n148_));
  aoi21  g086(.a(new_n147_), .b(new_n75_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n73_), .b(x27), .c(new_n142_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n127_), .O(new_n151_));
  oai21  g089(.a(new_n149_), .b(new_n146_), .c(new_n151_), .O(z14));
  ...
  oai21  g098(.a(new_n132_), .b(new_n72_), .c(new_n122_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n119_), .O(z20));
  aoi21  g100(.a(new_n120_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
