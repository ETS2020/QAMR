...
module FAU ( 
  ...
  nand2  g02(.a(x40), .b(new_n64_), .O(new_n65_));
  aoi21  g03(.a(x35), .b(x28), .c(x37), .O(new_n66_));
  oai21  g04(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  nand3  g05(.a(x40), .b(x10), .c(new_n64_), .O(new_n68_));
  ...
  aoi21  g49(.a(x40), .b(new_n111_), .c(x04), .O(new_n112_));
  oai21  g50(.a(x40), .b(x07), .c(new_n112_), .O(new_n113_));
  ...
  nand2  g66(.a(new_n124_), .b(x40), .O(new_n129_));
