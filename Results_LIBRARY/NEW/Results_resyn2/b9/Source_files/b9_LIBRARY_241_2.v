// Benchmark "FAU" written by ABC on Mon Jul 27 23:01:17 2020
...
module FAU ( 
  ...
  nand3  g007(.a(new_n69_), .b(new_n68_), .c(new_n63_), .O(new_n70_));
  nand3  g008(.a(new_n67_), .b(x40), .c(x10), .O(new_n71_));
  ...
  nand3  g055(.a(new_n65_), .b(new_n117_), .c(x07), .O(new_n118_));
  ...
  and2   g068(.a(x39), .b(x29), .O(new_n131_));
  ...
  inv1   g072(.a(new_n67_), .O(new_n135_));
  aoi21  g073(.a(new_n69_), .b(new_n135_), .c(new_n117_), .O(new_n136_));
  ...
  nand3  g078(.a(new_n67_), .b(x40), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g083(.a(new_n67_), .b(new_n140_), .O(new_n146_));
  ...
  aoi21  g089(.a(new_n69_), .b(new_n63_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g095(.a(new_n146_), .b(new_n69_), .O(new_n158_));
  nand3  g096(.a(new_n80_), .b(new_n111_), .c(x28), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n158_), .c(x40), .O(new_n160_));
