// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:32 2020
...
module FAU ( 
  ...
  aoi22  g57(.a(new_n67_), .b(new_n86_), .c(x39), .d(new_n71_), .O(new_n120_));
  ...
  inv1   g63(.a(x39), .O(new_n126_));
  nand2  g64(.a(x36), .b(x35), .O(new_n127_));
  oai22  g65(.a(new_n127_), .b(x32), .c(new_n126_), .d(x28), .O(new_n128_));
  ...
  nand2  g69(.a(new_n131_), .b(x40), .O(new_n132_));
