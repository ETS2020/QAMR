...
module FAU ( 
  ...
  oai21  g35(.a(x25), .b(x00), .c(new_n97_), .O(new_n98_));
  inv1   g36(.a(x38), .O(new_n99_));
  ...
  aoi21  g42(.a(new_n104_), .b(new_n98_), .c(new_n96_), .O(z07));
  inv1   g43(.a(new_n83_), .O(z08));
  nand4  g44(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n107_));
  inv1   g45(.a(new_n107_), .O(z09));
  nor2   g46(.a(x32), .b(x30), .O(new_n109_));
  nor2   g47(.a(new_n109_), .b(new_n83_), .O(new_n110_));
  inv1   g48(.a(x07), .O(new_n111_));
  nand2  g49(.a(new_n83_), .b(new_n111_), .O(new_n112_));
  aoi21  g50(.a(new_n112_), .b(new_n76_), .c(new_n110_), .O(new_n113_));
  oai21  g51(.a(new_n83_), .b(x05), .c(new_n65_), .O(new_n114_));
  nand3  g52(.a(x37), .b(x27), .c(x06), .O(new_n115_));
  oai21  g53(.a(new_n114_), .b(new_n113_), .c(new_n115_), .O(z10));
  inv1   g54(.a(x08), .O(new_n117_));
  nand2  g55(.a(z08), .b(x29), .O(new_n118_));
  aoi21  g56(.a(new_n118_), .b(new_n75_), .c(new_n117_), .O(new_n119_));
  ...
  nand3  g68(.a(x20), .b(new_n130_), .c(new_n129_), .O(new_n131_));
  oai21  g69(.a(new_n131_), .b(new_n63_), .c(new_n128_), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(x27), .O(new_n133_));
  nand2  g71(.a(new_n127_), .b(new_n110_), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(new_n133_), .O(z13));
  nand2  g73(.a(new_n127_), .b(z08), .O(new_n136_));
  nand3  g74(.a(new_n125_), .b(new_n109_), .c(x28), .O(new_n137_));
  inv1   g75(.a(new_n137_), .O(new_n138_));
  oai21  g76(.a(new_n138_), .b(new_n136_), .c(new_n131_), .O(new_n139_));
  aoi21  g77(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n140_));
  oai22  g78(.a(new_n140_), .b(new_n136_), .c(new_n63_), .d(new_n72_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n139_), .O(z14));
  ...
  nand2  g87(.a(new_n120_), .b(new_n119_), .O(new_n150_));
  nand3  g88(.a(new_n122_), .b(new_n121_), .c(new_n150_), .O(z18));
  nand2  g89(.a(x35), .b(x27), .O(new_n152_));
  nand2  g90(.a(new_n152_), .b(new_n122_), .O(new_n153_));
  nor2   g91(.a(new_n153_), .b(new_n119_), .O(z20));
  aoi21  g92(.a(new_n120_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
