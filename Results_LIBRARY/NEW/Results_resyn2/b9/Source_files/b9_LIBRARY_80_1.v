...
module FAU ( 
  ...
  aoi21  g17(.a(new_n75_), .b(x04), .c(new_n79_), .O(new_n80_));
  inv1   g18(.a(x08), .O(new_n81_));
  nand3  g19(.a(new_n72_), .b(new_n81_), .c(x04), .O(new_n82_));
  ...
  aoi21  g54(.a(new_n116_), .b(new_n75_), .c(new_n81_), .O(new_n117_));
  nand2  g55(.a(new_n116_), .b(x27), .O(new_n118_));
  nand4  g56(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n119_));
  ...
  nand2  g71(.a(new_n118_), .b(new_n117_), .O(new_n134_));
  nand3  g72(.a(new_n120_), .b(new_n119_), .c(new_n134_), .O(z18));
  oai21  g73(.a(new_n84_), .b(new_n72_), .c(new_n120_), .O(new_n136_));
  nor2   g74(.a(new_n136_), .b(new_n117_), .O(z20));
  aoi21  g75(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
