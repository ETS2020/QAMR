...
module FAU ( 
  ...
  aoi21  g047(.a(new_n76_), .b(x07), .c(z08), .O(new_n110_));
  inv1   g048(.a(x05), .O(new_n111_));
  aoi21  g049(.a(z08), .b(new_n111_), .c(x04), .O(new_n112_));
  oai21  g050(.a(new_n79_), .b(new_n76_), .c(new_n112_), .O(new_n113_));
  nand3  g051(.a(x37), .b(x27), .c(x06), .O(new_n114_));
  oai21  g052(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z10));
  inv1   g053(.a(x40), .O(new_n116_));
  aoi21  g054(.a(x39), .b(x29), .c(x09), .O(new_n117_));
  nor2   g055(.a(new_n72_), .b(new_n65_), .O(new_n118_));
  oai22  g056(.a(new_n118_), .b(new_n75_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  inv1   g057(.a(x08), .O(new_n120_));
  inv1   g058(.a(x09), .O(new_n121_));
  inv1   g059(.a(x35), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(x28), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(x27), .c(new_n65_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n119_), .c(x30), .O(z11));
  aoi22  g064(.a(new_n64_), .b(new_n89_), .c(x40), .d(new_n72_), .O(new_n127_));
  nand2  g065(.a(new_n87_), .b(new_n89_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n66_), .O(new_n130_));
  oai21  g068(.a(new_n127_), .b(x10), .c(new_n130_), .O(z12));
  inv1   g069(.a(x13), .O(new_n132_));
  nor2   g070(.a(new_n83_), .b(x04), .O(new_n133_));
  oai21  g071(.a(new_n73_), .b(new_n122_), .c(x28), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  inv1   g073(.a(x18), .O(new_n136_));
  inv1   g074(.a(x19), .O(new_n137_));
  nand4  g075(.a(new_n128_), .b(x20), .c(new_n137_), .d(new_n136_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  nand3  g078(.a(new_n79_), .b(new_n133_), .c(new_n132_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(z13));
  nand3  g080(.a(x20), .b(new_n137_), .c(new_n136_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  inv1   g082(.a(new_n79_), .O(new_n145_));
  inv1   g083(.a(new_n134_), .O(new_n146_));
  nand2  g084(.a(new_n133_), .b(new_n132_), .O(new_n147_));
  aoi21  g085(.a(new_n146_), .b(new_n145_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n129_), .O(new_n150_));
  oai21  g088(.a(new_n148_), .b(new_n144_), .c(new_n150_), .O(z14));
  ...
  nand3  g096(.a(x40), .b(x39), .c(x29), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n75_), .c(new_n120_), .O(new_n160_));
  nand2  g098(.a(new_n159_), .b(x27), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n124_), .c(new_n77_), .d(new_n121_), .O(z18));
  aoi21  g101(.a(new_n75_), .b(new_n116_), .c(new_n121_), .O(new_n164_));
  oai21  g102(.a(new_n122_), .b(new_n72_), .c(new_n77_), .O(new_n165_));
  nor3   g103(.a(new_n165_), .b(new_n164_), .c(new_n160_), .O(z20));
  aoi21  g104(.a(new_n125_), .b(new_n119_), .c(x30), .O(z19));
endmodule
