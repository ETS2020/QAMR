...
module FAU ( 
  ...
  aoi22  g009(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(new_n64_), .O(new_n72_));
  inv1   g010(.a(x16), .O(new_n73_));
  aoi21  g011(.a(new_n69_), .b(x10), .c(new_n73_), .O(new_n74_));
  oai21  g012(.a(new_n72_), .b(new_n63_), .c(new_n74_), .O(z00));
  inv1   g013(.a(x36), .O(new_n76_));
  inv1   g014(.a(x28), .O(new_n77_));
  nand2  g015(.a(x35), .b(new_n77_), .O(new_n78_));
  aoi21  g016(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(new_n79_));
  ...
  nand2  g027(.a(new_n65_), .b(new_n63_), .O(new_n90_));
  ...
  inv1   g044(.a(new_n68_), .O(z08));
  nand4  g045(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  inv1   g046(.a(new_n108_), .O(z09));
  nor2   g047(.a(x32), .b(x30), .O(new_n110_));
  nand3  g048(.a(x40), .b(x39), .c(x05), .O(new_n111_));
  nor2   g049(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g050(.a(new_n68_), .b(x07), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n79_), .c(new_n112_), .O(new_n115_));
  ...
  and2   g058(.a(x40), .b(x04), .O(new_n121_));
  inv1   g059(.a(x35), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(x28), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x27), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  nand2  g063(.a(z08), .b(x29), .O(new_n126_));
  inv1   g064(.a(x04), .O(new_n127_));
  nor2   g065(.a(new_n63_), .b(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n78_), .c(new_n126_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n125_), .c(new_n119_), .O(z11));
  aoi22  g068(.a(new_n70_), .b(new_n65_), .c(x40), .d(new_n63_), .O(new_n131_));
  nand2  g069(.a(new_n67_), .b(x27), .O(new_n132_));
  oai21  g070(.a(new_n68_), .b(x04), .c(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n131_), .b(x10), .c(new_n133_), .O(z12));
  inv1   g072(.a(x13), .O(new_n135_));
  oai21  g073(.a(new_n76_), .b(new_n122_), .c(x28), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n69_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x18), .O(new_n138_));
  inv1   g076(.a(x19), .O(new_n139_));
  nand4  g077(.a(new_n67_), .b(x20), .c(new_n139_), .d(new_n138_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x27), .O(new_n142_));
  nand3  g080(.a(new_n82_), .b(new_n69_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(z13));
  nand3  g082(.a(x20), .b(new_n139_), .c(new_n138_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  inv1   g084(.a(new_n136_), .O(new_n147_));
  nand2  g085(.a(new_n69_), .b(new_n135_), .O(new_n148_));
  aoi21  g086(.a(new_n147_), .b(new_n110_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n77_), .b(x27), .c(new_n82_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n132_), .O(new_n151_));
  ...
  nand2  g098(.a(new_n126_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(x08), .O(new_n162_));
  nand3  g100(.a(new_n123_), .b(x27), .c(new_n127_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n118_), .O(z18));
  oai21  g102(.a(new_n122_), .b(new_n63_), .c(new_n118_), .O(new_n165_));
  aoi21  g103(.a(new_n160_), .b(x08), .c(new_n165_), .O(z20));
  aoi21  g104(.a(new_n129_), .b(new_n125_), .c(new_n119_), .O(z19));
endmodule
