// Benchmark "FAU" written by ABC on Mon Jul 27 22:59:57 2020
...
module FAU ( 
  ...
  oai21  g017(.a(x27), .b(x08), .c(new_n79_), .O(new_n80_));
  nand2  g018(.a(new_n80_), .b(x04), .O(new_n81_));
  aoi21  g019(.a(x29), .b(x08), .c(x02), .O(new_n82_));
  nor2   g020(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  ...
  inv1   g042(.a(new_n63_), .O(z08));
  nand4  g043(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n106_));
  inv1   g044(.a(new_n106_), .O(z09));
  nor2   g045(.a(new_n75_), .b(new_n72_), .O(new_n108_));
  nand2  g046(.a(z08), .b(x05), .O(new_n109_));
  inv1   g047(.a(new_n109_), .O(new_n110_));
  and2   g048(.a(new_n63_), .b(x07), .O(new_n111_));
  aoi22  g049(.a(new_n111_), .b(new_n108_), .c(new_n110_), .d(new_n76_), .O(new_n112_));
  nand3  g050(.a(x37), .b(x27), .c(x06), .O(new_n113_));
  oai21  g051(.a(new_n112_), .b(x04), .c(new_n113_), .O(z10));
  inv1   g052(.a(x08), .O(new_n115_));
  nor2   g053(.a(new_n72_), .b(x04), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n79_), .c(x30), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  inv1   g056(.a(x40), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x39), .c(x30), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x29), .O(new_n121_));
  oai21  g059(.a(new_n72_), .b(new_n67_), .c(new_n79_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n118_), .c(x09), .O(z11));
  aoi22  g062(.a(new_n66_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n125_));
  oai21  g063(.a(new_n65_), .b(new_n72_), .c(new_n68_), .O(new_n126_));
  oai21  g064(.a(new_n125_), .b(x10), .c(new_n126_), .O(z12));
  inv1   g065(.a(x13), .O(new_n128_));
  nand2  g066(.a(new_n64_), .b(new_n128_), .O(new_n129_));
  aoi21  g067(.a(x36), .b(x35), .c(new_n74_), .O(new_n130_));
  nand2  g068(.a(new_n85_), .b(new_n87_), .O(new_n131_));
  nor2   g069(.a(x19), .b(x18), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(x20), .O(new_n133_));
  oai21  g071(.a(new_n129_), .b(new_n130_), .c(new_n133_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x27), .O(new_n135_));
  oai21  g073(.a(new_n129_), .b(new_n73_), .c(new_n135_), .O(z13));
  nand2  g074(.a(new_n130_), .b(new_n73_), .O(new_n137_));
  aoi21  g075(.a(new_n132_), .b(x20), .c(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n129_), .c(new_n133_), .O(new_n139_));
  inv1   g077(.a(x30), .O(new_n140_));
  nand2  g078(.a(new_n73_), .b(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n64_), .c(new_n128_), .O(new_n142_));
  nand4  g080(.a(new_n87_), .b(new_n78_), .c(new_n73_), .d(x28), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  aoi21  g082(.a(new_n142_), .b(new_n72_), .c(new_n144_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n139_), .O(z14));
  ...
  oai21  g093(.a(new_n155_), .b(new_n79_), .c(x08), .O(new_n156_));
  nor2   g094(.a(new_n155_), .b(new_n72_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n117_), .c(new_n154_), .O(z18));
  oai21  g097(.a(new_n140_), .b(x28), .c(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x35), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n156_), .c(new_n120_), .d(new_n154_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z20));
  aoi21  g101(.a(new_n123_), .b(new_n118_), .c(x09), .O(z19));
endmodule
