// Benchmark "FAU" written by ABC on Fri Jul 31 08:30:46 2020
...
module FAU ( 
  ...
  wire new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    ...
    new_n749_, new_n750_, new_n751_, new_n752_, new_n755_, new_n756_,
  ...
  aoi21  g553(.a(new_n491_), .b(new_n213_), .c(x34), .O(new_n630_));
  nand2  g554(.a(new_n614_), .b(new_n110_), .O(new_n631_));
  nand2  g555(.a(new_n631_), .b(new_n244_), .O(new_n632_));
  oai21  g556(.a(new_n632_), .b(new_n630_), .c(x05), .O(new_n633_));
  nand3  g557(.a(new_n212_), .b(new_n218_), .c(new_n100_), .O(new_n634_));
  aoi21  g558(.a(new_n634_), .b(new_n120_), .c(new_n215_), .O(new_n635_));
  aoi21  g559(.a(new_n181_), .b(new_n101_), .c(new_n635_), .O(new_n636_));
  nor2   g560(.a(new_n636_), .b(x31), .O(new_n637_));
  nand2  g561(.a(new_n322_), .b(new_n81_), .O(new_n638_));
  nand2  g562(.a(new_n245_), .b(new_n101_), .O(new_n639_));
  aoi21  g563(.a(new_n639_), .b(x34), .c(x05), .O(new_n640_));
  oai21  g564(.a(new_n638_), .b(new_n637_), .c(new_n640_), .O(new_n641_));
  aoi21  g565(.a(new_n641_), .b(new_n633_), .c(x35), .O(new_n642_));
  aoi21  g566(.a(new_n250_), .b(x37), .c(new_n102_), .O(new_n643_));
  inv1   g567(.a(new_n643_), .O(new_n644_));
  oai22  g568(.a(new_n425_), .b(x05), .c(new_n156_), .d(new_n117_), .O(new_n645_));
  nand3  g569(.a(new_n645_), .b(new_n101_), .c(x35), .O(new_n646_));
  nand2  g570(.a(new_n79_), .b(new_n81_), .O(new_n647_));
  aoi21  g571(.a(new_n646_), .b(new_n644_), .c(new_n647_), .O(new_n648_));
  oai21  g572(.a(new_n648_), .b(new_n642_), .c(new_n103_), .O(new_n649_));
  nand3  g573(.a(new_n484_), .b(new_n82_), .c(x11), .O(new_n650_));
  aoi21  g574(.a(new_n650_), .b(new_n649_), .c(new_n78_), .O(z20));
  inv1   g575(.a(new_n464_), .O(new_n652_));
  nand3  g576(.a(new_n614_), .b(new_n102_), .c(new_n110_), .O(new_n653_));
  aoi21  g577(.a(new_n653_), .b(new_n209_), .c(new_n652_), .O(new_n654_));
  nor3   g578(.a(new_n242_), .b(x38), .c(new_n209_), .O(new_n655_));
  ...
  nor2   g588(.a(new_n633_), .b(x32), .O(new_n665_));
  oai21  g589(.a(new_n665_), .b(new_n611_), .c(new_n82_), .O(new_n666_));
  nand3  g590(.a(new_n643_), .b(new_n528_), .c(new_n79_), .O(new_n667_));
  ...
  nand2  g597(.a(new_n491_), .b(new_n213_), .O(new_n674_));
  oai21  g598(.a(new_n387_), .b(new_n210_), .c(new_n127_), .O(new_n675_));
  aoi21  g599(.a(new_n675_), .b(new_n674_), .c(x34), .O(new_n676_));
  oai21  g600(.a(new_n245_), .b(new_n81_), .c(new_n102_), .O(new_n677_));
  aoi21  g601(.a(new_n676_), .b(new_n673_), .c(new_n677_), .O(new_n678_));
  inv1   g602(.a(new_n303_), .O(new_n679_));
  oai21  g603(.a(new_n184_), .b(new_n320_), .c(new_n679_), .O(new_n680_));
  nand2  g604(.a(new_n680_), .b(x39), .O(new_n681_));
  inv1   g605(.a(new_n523_), .O(new_n682_));
  oai21  g606(.a(new_n565_), .b(new_n682_), .c(new_n234_), .O(new_n683_));
  aoi22  g607(.a(new_n597_), .b(x34), .c(new_n158_), .d(x31), .O(new_n684_));
  nand3  g608(.a(new_n684_), .b(new_n683_), .c(new_n681_), .O(new_n685_));
  nand2  g609(.a(new_n685_), .b(new_n80_), .O(new_n686_));
  nand2  g610(.a(x40), .b(x05), .O(new_n687_));
  oai21  g611(.a(x40), .b(new_n81_), .c(new_n687_), .O(new_n688_));
  nand2  g612(.a(new_n688_), .b(x39), .O(new_n689_));
  nor2   g613(.a(x39), .b(new_n81_), .O(new_n690_));
  oai21  g614(.a(new_n620_), .b(new_n398_), .c(new_n690_), .O(new_n691_));
  aoi21  g615(.a(new_n691_), .b(new_n689_), .c(new_n80_), .O(new_n692_));
  nand2  g616(.a(new_n674_), .b(x05), .O(new_n693_));
  nand2  g617(.a(new_n693_), .b(new_n321_), .O(new_n694_));
  aoi21  g618(.a(new_n694_), .b(new_n81_), .c(new_n692_), .O(new_n695_));
  nand2  g619(.a(new_n695_), .b(new_n686_), .O(new_n696_));
  oai21  g620(.a(new_n696_), .b(new_n678_), .c(new_n82_), .O(new_n697_));
  oai21  g621(.a(x37), .b(new_n102_), .c(new_n82_), .O(new_n698_));
  nor2   g622(.a(new_n517_), .b(x34), .O(new_n699_));
  aoi21  g623(.a(new_n699_), .b(new_n698_), .c(x36), .O(new_n700_));
  nand2  g624(.a(new_n700_), .b(new_n697_), .O(new_n701_));
  oai21  g625(.a(new_n541_), .b(new_n240_), .c(new_n250_), .O(new_n702_));
  nand2  g626(.a(new_n702_), .b(x37), .O(new_n703_));
  aoi21  g627(.a(new_n298_), .b(new_n517_), .c(x34), .O(new_n704_));
  nand2  g628(.a(new_n704_), .b(new_n703_), .O(new_n705_));
  aoi21  g629(.a(new_n705_), .b(new_n376_), .c(x32), .O(new_n706_));
  nand2  g630(.a(new_n706_), .b(new_n701_), .O(new_n707_));
  aoi21  g631(.a(new_n707_), .b(new_n207_), .c(new_n208_), .O(z23));
  nand2  g632(.a(new_n332_), .b(new_n80_), .O(new_n709_));
  aoi21  g633(.a(new_n381_), .b(new_n96_), .c(new_n80_), .O(new_n710_));
  oai21  g634(.a(new_n710_), .b(new_n83_), .c(x40), .O(new_n711_));
  aoi21  g635(.a(new_n711_), .b(new_n709_), .c(new_n82_), .O(new_n712_));
  nand2  g636(.a(new_n264_), .b(x37), .O(new_n713_));
  inv1   g637(.a(new_n713_), .O(new_n714_));
  nand2  g638(.a(new_n714_), .b(new_n125_), .O(new_n715_));
  inv1   g639(.a(new_n715_), .O(new_n716_));
  oai21  g640(.a(new_n716_), .b(new_n712_), .c(new_n549_), .O(new_n717_));
  aoi21  g641(.a(new_n717_), .b(new_n551_), .c(x36), .O(new_n718_));
  nor3   g642(.a(new_n374_), .b(x40), .c(new_n103_), .O(new_n719_));
  or2    g643(.a(new_n719_), .b(new_n555_), .O(new_n720_));
  oai21  g644(.a(new_n720_), .b(new_n718_), .c(new_n79_), .O(new_n721_));
  aoi21  g645(.a(new_n721_), .b(new_n568_), .c(new_n78_), .O(z24));
  inv1   g646(.a(new_n564_), .O(new_n723_));
  nand2  g647(.a(new_n616_), .b(new_n723_), .O(new_n724_));
  nand4  g648(.a(new_n402_), .b(new_n311_), .c(new_n223_), .d(new_n187_), .O(new_n725_));
  nand2  g649(.a(new_n725_), .b(new_n724_), .O(new_n726_));
  nand2  g650(.a(new_n726_), .b(x34), .O(new_n727_));
  inv1   g651(.a(new_n195_), .O(new_n728_));
  nand2  g652(.a(new_n183_), .b(new_n181_), .O(new_n729_));
  nand2  g653(.a(new_n467_), .b(new_n125_), .O(new_n730_));
  aoi21  g654(.a(new_n730_), .b(new_n729_), .c(new_n101_), .O(new_n731_));
  oai21  g655(.a(new_n731_), .b(new_n728_), .c(new_n178_), .O(new_n732_));
  aoi21  g656(.a(new_n732_), .b(new_n727_), .c(x35), .O(new_n733_));
  inv1   g657(.a(new_n334_), .O(new_n734_));
  aoi21  g658(.a(new_n711_), .b(new_n709_), .c(new_n734_), .O(new_n735_));
  oai21  g659(.a(new_n735_), .b(new_n733_), .c(new_n103_), .O(new_n736_));
  oai21  g660(.a(new_n82_), .b(x34), .c(new_n537_), .O(new_n737_));
  or2    g661(.a(new_n690_), .b(new_n187_), .O(new_n738_));
  nand3  g662(.a(new_n738_), .b(new_n737_), .c(new_n109_), .O(new_n739_));
  aoi21  g663(.a(new_n739_), .b(new_n736_), .c(new_n78_), .O(z25));
  nand4  g664(.a(new_n200_), .b(new_n114_), .c(new_n140_), .d(x35), .O(new_n741_));
  nand2  g665(.a(new_n741_), .b(new_n145_), .O(new_n742_));
  aoi21  g666(.a(new_n742_), .b(x37), .c(new_n719_), .O(new_n743_));
  nor3   g667(.a(new_n743_), .b(new_n78_), .c(x39), .O(z26));
  inv1   g668(.a(new_n204_), .O(new_n745_));
  oai21  g669(.a(new_n716_), .b(new_n712_), .c(new_n79_), .O(new_n746_));
  nand3  g670(.a(new_n264_), .b(new_n183_), .c(new_n181_), .O(new_n747_));
  aoi21  g671(.a(new_n747_), .b(new_n746_), .c(x34), .O(new_n748_));
  inv1   g672(.a(new_n557_), .O(new_n749_));
  nand2  g673(.a(new_n749_), .b(new_n82_), .O(new_n750_));
  inv1   g674(.a(new_n750_), .O(new_n751_));
  oai21  g675(.a(new_n751_), .b(new_n748_), .c(new_n105_), .O(new_n752_));
  aoi21  g676(.a(new_n752_), .b(new_n745_), .c(new_n78_), .O(z27));
  nor3   g677(.a(new_n724_), .b(new_n516_), .c(new_n81_), .O(z28));
  nor3   g678(.a(new_n470_), .b(x40), .c(x37), .O(new_n755_));
  aoi21  g679(.a(new_n507_), .b(x37), .c(new_n755_), .O(new_n756_));
  nand2  g680(.a(new_n120_), .b(new_n85_), .O(new_n757_));
  oai22  g681(.a(new_n757_), .b(new_n756_), .c(new_n560_), .d(x35), .O(new_n758_));
  nand2  g682(.a(new_n758_), .b(new_n243_), .O(new_n759_));
  aoi21  g683(.a(new_n759_), .b(new_n745_), .c(new_n78_), .O(z29));
  inv1   g684(.a(x23), .O(new_n761_));
  nand2  g685(.a(new_n346_), .b(new_n761_), .O(new_n762_));
  nand3  g686(.a(new_n762_), .b(x37), .c(x22), .O(new_n763_));
  nand3  g687(.a(new_n763_), .b(new_n508_), .c(new_n311_), .O(new_n764_));
  nor3   g688(.a(new_n119_), .b(new_n118_), .c(x05), .O(new_n765_));
  nand3  g689(.a(new_n765_), .b(new_n365_), .c(new_n103_), .O(new_n766_));
  aoi21  g690(.a(new_n764_), .b(new_n750_), .c(new_n766_), .O(z30));
  nand3  g691(.a(new_n565_), .b(new_n234_), .c(new_n82_), .O(new_n768_));
  nand4  g692(.a(new_n765_), .b(new_n222_), .c(new_n81_), .d(new_n83_), .O(new_n769_));
  nand2  g693(.a(new_n769_), .b(new_n768_), .O(new_n770_));
  nand2  g694(.a(new_n770_), .b(new_n80_), .O(new_n771_));
  nand2  g695(.a(new_n85_), .b(x37), .O(new_n772_));
  oai21  g696(.a(new_n772_), .b(new_n762_), .c(x24), .O(new_n773_));
  nand3  g697(.a(new_n773_), .b(new_n334_), .c(x40), .O(new_n774_));
  aoi21  g698(.a(new_n774_), .b(new_n771_), .c(new_n514_), .O(z31));
  nor2   g699(.a(x33), .b(x32), .O(new_n777_));
  inv1   g700(.a(new_n131_), .O(new_n778_));
  nand4  g701(.a(new_n100_), .b(new_n575_), .c(x35), .d(x15), .O(new_n779_));
  aoi21  g702(.a(new_n435_), .b(new_n433_), .c(new_n779_), .O(new_n780_));
  nand2  g703(.a(x35), .b(new_n117_), .O(new_n781_));
  nor2   g704(.a(new_n781_), .b(new_n425_), .O(new_n782_));
  oai21  g705(.a(new_n782_), .b(new_n714_), .c(new_n101_), .O(new_n783_));
  oai21  g706(.a(new_n713_), .b(new_n634_), .c(new_n783_), .O(new_n784_));
  oai21  g707(.a(new_n784_), .b(new_n780_), .c(new_n243_), .O(new_n785_));
  nand2  g708(.a(new_n657_), .b(new_n539_), .O(new_n786_));
  nand3  g709(.a(new_n786_), .b(new_n658_), .c(x35), .O(new_n787_));
  aoi21  g710(.a(new_n156_), .b(new_n82_), .c(new_n529_), .O(new_n788_));
  nand2  g711(.a(new_n788_), .b(new_n787_), .O(new_n789_));
  aoi21  g712(.a(new_n789_), .b(x36), .c(x39), .O(new_n790_));
  nand2  g713(.a(new_n790_), .b(new_n785_), .O(new_n791_));
  nand2  g714(.a(new_n390_), .b(new_n101_), .O(new_n792_));
  nand2  g715(.a(new_n223_), .b(x36), .O(new_n793_));
  aoi21  g716(.a(new_n793_), .b(new_n792_), .c(x37), .O(new_n794_));
  nor3   g717(.a(new_n420_), .b(new_n446_), .c(new_n157_), .O(new_n795_));
  oai21  g718(.a(new_n795_), .b(new_n794_), .c(new_n82_), .O(new_n796_));
  aoi21  g719(.a(new_n456_), .b(new_n251_), .c(new_n79_), .O(new_n797_));
  nand2  g720(.a(new_n797_), .b(new_n796_), .O(new_n798_));
  aoi22  g721(.a(new_n798_), .b(new_n791_), .c(new_n409_), .d(new_n778_), .O(new_n799_));
  aoi21  g722(.a(new_n462_), .b(x37), .c(new_n234_), .O(new_n800_));
  oai21  g723(.a(new_n800_), .b(new_n621_), .c(new_n136_), .O(new_n801_));
  oai21  g724(.a(new_n799_), .b(x34), .c(new_n801_), .O(new_n802_));
  nand2  g725(.a(new_n802_), .b(new_n209_), .O(new_n803_));
  aoi21  g726(.a(new_n803_), .b(new_n572_), .c(new_n777_), .O(z33));
  oai21  g727(.a(new_n635_), .b(new_n409_), .c(new_n129_), .O(new_n805_));
  aoi21  g728(.a(new_n805_), .b(new_n693_), .c(x34), .O(new_n806_));
  nand3  g729(.a(new_n187_), .b(x40), .c(x05), .O(new_n807_));
  nand2  g730(.a(new_n161_), .b(new_n137_), .O(new_n808_));
  oai21  g731(.a(new_n808_), .b(new_n563_), .c(new_n523_), .O(new_n809_));
  aoi22  g732(.a(new_n809_), .b(new_n234_), .c(new_n411_), .d(new_n101_), .O(new_n810_));
  oai21  g733(.a(new_n810_), .b(x37), .c(new_n807_), .O(new_n811_));
  oai21  g734(.a(new_n811_), .b(new_n806_), .c(new_n82_), .O(new_n812_));
  oai22  g735(.a(new_n644_), .b(x39), .c(new_n198_), .d(new_n82_), .O(new_n813_));
  nand2  g736(.a(new_n813_), .b(new_n81_), .O(new_n814_));
  aoi21  g737(.a(new_n814_), .b(new_n812_), .c(x36), .O(new_n815_));
  inv1   g738(.a(new_n200_), .O(new_n816_));
  nand2  g739(.a(new_n787_), .b(new_n299_), .O(new_n817_));
  nand2  g740(.a(new_n817_), .b(new_n467_), .O(new_n818_));
  nand3  g741(.a(new_n199_), .b(new_n82_), .c(x11), .O(new_n819_));
  aoi21  g742(.a(new_n819_), .b(new_n818_), .c(new_n816_), .O(new_n820_));
  oai21  g743(.a(new_n820_), .b(new_n815_), .c(new_n209_), .O(new_n821_));
  aoi21  g744(.a(new_n821_), .b(new_n207_), .c(new_n208_), .O(z34));
  zero   g745(.O(z32));
endmodule
