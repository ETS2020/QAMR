// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:16 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n48_), .b(x05), .c(new_n42_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n47_), .c(new_n35_), .O(new_n50_));
  nand2  g25(.a(x10), .b(x01), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(x05), .c(new_n35_), .O(new_n52_));
  aoi21  g27(.a(x08), .b(new_n42_), .c(new_n52_), .O(new_n53_));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nand4  g30(.a(x13), .b(new_n55_), .c(new_n54_), .d(new_n26_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  oai21  g32(.a(new_n53_), .b(new_n50_), .c(new_n57_), .O(new_n58_));
