...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    ...
    new_n53_, new_n54_, new_n55_, new_n56_, new_n59_, new_n60_, new_n63_,
    new_n64_;
  ...
  aoi21  g22(.a(new_n47_), .b(new_n44_), .c(x12), .O(new_n48_));
  ...
  nand4  g27(.a(x13), .b(new_n52_), .c(x05), .d(new_n27_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  oai21  g29(.a(new_n51_), .b(new_n48_), .c(new_n54_), .O(new_n55_));
  nand2  g30(.a(x04), .b(new_n33_), .O(new_n56_));
  aoi21  g31(.a(new_n55_), .b(new_n42_), .c(new_n56_), .O(z06));
  inv1   g32(.a(new_n35_), .O(z07));
  inv1   g33(.a(x12), .O(new_n59_));
  nand4  g34(.a(x13), .b(new_n59_), .c(x05), .d(new_n27_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n42_), .c(new_n56_), .O(z08));
