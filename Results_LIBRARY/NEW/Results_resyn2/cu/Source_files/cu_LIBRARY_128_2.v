// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:52 2020
...
module FAU ( 
  ...
  nand3  g11(.a(new_n27_), .b(new_n36_), .c(new_n35_), .O(new_n37_));
  inv1   g12(.a(x00), .O(new_n38_));
  nand2  g13(.a(x05), .b(new_n38_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(new_n37_), .c(x01), .O(z02));
  inv1   g15(.a(x01), .O(new_n41_));
  inv1   g16(.a(new_n37_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n41_), .c(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z03));
  nor3   g19(.a(new_n39_), .b(new_n37_), .c(new_n41_), .O(z04));
  nand3  g20(.a(new_n42_), .b(x01), .c(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z05));
  nand3  g22(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n48_));
  nand2  g23(.a(x08), .b(new_n41_), .O(new_n49_));
  nand2  g24(.a(x10), .b(x01), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n49_), .c(x05), .d(new_n38_), .O(new_n51_));
  nand2  g26(.a(x11), .b(x01), .O(new_n52_));
  nand2  g27(.a(x09), .b(new_n41_), .O(new_n53_));
  ...
  aoi21  g36(.a(new_n60_), .b(new_n48_), .c(new_n61_), .O(z06));
  aoi21  g37(.a(new_n31_), .b(new_n38_), .c(new_n37_), .O(z07));
  nand4  g38(.a(x13), .b(new_n57_), .c(x05), .d(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n48_), .c(new_n61_), .O(z08));
  and2   g40(.a(x13), .b(x06), .O(z09));
  nand2  g41(.a(x05), .b(x02), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n35_), .O(new_n68_));
