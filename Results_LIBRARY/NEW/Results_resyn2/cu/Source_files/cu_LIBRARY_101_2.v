...
module FAU ( 
  ...
  oai21  g19(.a(x09), .b(x01), .c(x11), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(x00), .O(new_n46_));
  nand2  g21(.a(x10), .b(x01), .O(new_n47_));
  nand2  g22(.a(x08), .b(new_n42_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n47_), .c(new_n35_), .O(new_n49_));
