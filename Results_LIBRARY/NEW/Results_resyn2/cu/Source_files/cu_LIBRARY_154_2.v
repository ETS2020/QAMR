...
module FAU ( 
  ...
  nor2   g19(.a(x11), .b(new_n42_), .O(new_n45_));
  nor3   g20(.a(x09), .b(x07), .c(x01), .O(new_n46_));
  ...
  nor2   g25(.a(x07), .b(x00), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n52_));
  and2   g27(.a(new_n52_), .b(new_n48_), .O(new_n53_));
  ...
  aoi21  g32(.a(new_n55_), .b(new_n48_), .c(new_n57_), .O(z08));
  inv1   g33(.a(z08), .O(new_n59_));
  aoi21  g34(.a(new_n53_), .b(new_n47_), .c(new_n59_), .O(z06));
  ...
  nand3  g39(.a(new_n64_), .b(x06), .c(new_n56_), .O(new_n65_));
