...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n39_, new_n43_, new_n44_, new_n45_,
  ...
  nand4  g11(.a(new_n36_), .b(new_n35_), .c(x05), .d(new_n34_), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(x00), .O(z02));
  inv1   g13(.a(x00), .O(new_n39_));
  nor2   g14(.a(new_n37_), .b(new_n39_), .O(z03));
  nand3  g15(.a(new_n35_), .b(new_n30_), .c(x02), .O(new_n43_));
  inv1   g16(.a(x07), .O(new_n44_));
  nor2   g17(.a(x08), .b(x00), .O(new_n45_));
  nor2   g18(.a(x09), .b(new_n39_), .O(new_n46_));
