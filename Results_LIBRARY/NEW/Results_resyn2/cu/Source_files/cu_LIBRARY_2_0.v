// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:02 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n64_, new_n66_, new_n69_, new_n70_;
  ...
  nand4  g31(.a(new_n56_), .b(new_n55_), .c(x05), .d(new_n26_), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n54_), .c(new_n49_), .O(new_n59_));
  nand3  g34(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n60_));
  inv1   g35(.a(x03), .O(new_n61_));
  nand2  g36(.a(x04), .b(new_n61_), .O(new_n62_));
  aoi21  g37(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(z06));
  nand2  g38(.a(new_n37_), .b(new_n36_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(new_n28_), .O(z07));
  nand3  g40(.a(new_n56_), .b(x05), .c(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n60_), .b(new_n66_), .c(new_n62_), .O(z08));
