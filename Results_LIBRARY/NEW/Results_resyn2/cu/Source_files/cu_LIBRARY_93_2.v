// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:35 2020
...
module FAU ( 
  ...
  nand2  g19(.a(x10), .b(x01), .O(new_n45_));
  nand2  g20(.a(x08), .b(new_n42_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n45_), .c(new_n35_), .O(new_n47_));
  inv1   g22(.a(x11), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(x01), .c(x00), .O(new_n49_));
  nand2  g24(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  ...
  aoi21  g32(.a(new_n55_), .b(new_n54_), .c(new_n57_), .O(z06));
  nand2  g33(.a(new_n37_), .b(new_n36_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(new_n28_), .O(z07));
  aoi21  g35(.a(new_n55_), .b(new_n52_), .c(new_n57_), .O(z08));
