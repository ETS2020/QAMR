// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:22 2020
...
module FAU ( 
  ...
  nand3  g25(.a(x10), .b(x01), .c(new_n35_), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  nand4  g27(.a(x13), .b(new_n52_), .c(x05), .d(new_n26_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n51_), .c(new_n50_), .d(new_n45_), .O(new_n55_));
  nand3  g30(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n56_));
  inv1   g31(.a(x03), .O(new_n57_));
  nand2  g32(.a(x04), .b(new_n57_), .O(new_n58_));
  aoi21  g33(.a(new_n56_), .b(new_n55_), .c(new_n58_), .O(z06));
  nand2  g34(.a(new_n37_), .b(new_n36_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n28_), .O(z07));
  aoi21  g36(.a(new_n56_), .b(new_n53_), .c(new_n58_), .O(z08));
  and2   g37(.a(x13), .b(x06), .O(z09));
  nand2  g38(.a(x05), .b(x02), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x06), .c(new_n57_), .O(new_n65_));
