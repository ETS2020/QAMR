...
module FAU ( 
  ...
  aoi21  g02(.a(x04), .b(x02), .c(new_n27_), .O(new_n28_));
  inv1   g03(.a(x02), .O(new_n29_));
  inv1   g04(.a(x03), .O(new_n30_));
  oai21  g05(.a(new_n26_), .b(new_n29_), .c(new_n30_), .O(new_n31_));
  or2    g06(.a(new_n31_), .b(new_n28_), .O(z00));
  nand2  g07(.a(new_n30_), .b(new_n29_), .O(new_n33_));
  aoi21  g08(.a(new_n33_), .b(x05), .c(new_n28_), .O(z01));
  ...
  nor2   g23(.a(new_n48_), .b(new_n33_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n36_), .b(new_n26_), .c(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z06));
  nand2  g37(.a(new_n27_), .b(new_n36_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n33_), .O(z07));
  inv1   g39(.a(new_n61_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n49_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(new_n45_), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  nor2   g43(.a(new_n36_), .b(new_n68_), .O(z09));
  aoi21  g44(.a(new_n33_), .b(x05), .c(new_n68_), .O(z10));
endmodule
