...
module FAU ( 
  ...
  nand2  g18(.a(x10), .b(x01), .O(new_n44_));
  nand2  g19(.a(x08), .b(new_n41_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n44_), .c(new_n39_), .O(new_n46_));
  inv1   g21(.a(x09), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n41_), .c(x00), .O(new_n48_));
