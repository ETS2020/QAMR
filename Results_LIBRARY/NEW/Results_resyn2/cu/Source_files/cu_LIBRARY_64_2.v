// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:24 2020
...
module FAU ( 
  ...
  nand2  g19(.a(x08), .b(new_n42_), .O(new_n45_));
  nand2  g20(.a(x10), .b(x01), .O(new_n46_));
  nor2   g21(.a(x07), .b(x00), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n48_));
  nand3  g23(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n49_));
  oai21  g24(.a(x11), .b(x07), .c(x01), .O(new_n50_));
  nand2  g25(.a(x09), .b(new_n42_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n50_), .c(x00), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n49_), .c(new_n48_), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  nand4  g29(.a(x13), .b(new_n54_), .c(x05), .d(new_n26_), .O(new_n55_));
  inv1   g30(.a(x03), .O(new_n56_));
  nand2  g31(.a(x04), .b(new_n56_), .O(new_n57_));
  aoi21  g32(.a(new_n55_), .b(new_n49_), .c(new_n57_), .O(z08));
  and2   g33(.a(z08), .b(new_n53_), .O(z06));
  nand2  g34(.a(new_n37_), .b(new_n36_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(new_n28_), .O(z07));
  and2   g36(.a(x13), .b(x06), .O(z09));
  nand2  g37(.a(x05), .b(x02), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x06), .c(new_n56_), .O(new_n64_));
