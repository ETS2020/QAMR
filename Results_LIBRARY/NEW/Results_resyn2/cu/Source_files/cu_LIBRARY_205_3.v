// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:27 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n32_, new_n34_,
    ...
    new_n60_, new_n61_, new_n63_, new_n66_, new_n68_;
  inv1   g00(.a(x02), .O(new_n26_));
  nand2  g01(.a(x05), .b(x04), .O(new_n27_));
  oai21  g02(.a(x04), .b(new_n26_), .c(new_n27_), .O(new_n28_));
  inv1   g03(.a(x03), .O(new_n29_));
  oai21  g04(.a(x05), .b(x02), .c(new_n29_), .O(new_n30_));
  or2    g05(.a(new_n30_), .b(new_n28_), .O(z00));
  aoi21  g06(.a(new_n29_), .b(x02), .c(x05), .O(new_n32_));
  nor2   g07(.a(new_n32_), .b(new_n28_), .O(z01));
  ...
  nand4  g13(.a(new_n38_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n39_));
  nor2   g14(.a(new_n39_), .b(x01), .O(z02));
  nand4  g15(.a(new_n38_), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n41_));
  ...
  nand2  g29(.a(new_n54_), .b(new_n43_), .O(new_n55_));
  ...
  nand4  g35(.a(new_n36_), .b(new_n37_), .c(new_n29_), .d(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(new_n35_), .O(z06));
  nand3  g37(.a(new_n38_), .b(new_n36_), .c(new_n35_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z07));
  aoi21  g39(.a(new_n61_), .b(new_n58_), .c(new_n35_), .O(z08));
  inv1   g40(.a(x06), .O(new_n66_));
  nor2   g41(.a(new_n36_), .b(new_n66_), .O(z09));
  aoi21  g42(.a(new_n37_), .b(new_n29_), .c(new_n38_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(new_n66_), .O(z10));
endmodule
