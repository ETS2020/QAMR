...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n66_, new_n67_;
  ...
  nand2  g08(.a(new_n32_), .b(x13), .O(new_n34_));
  nand2  g09(.a(new_n34_), .b(z00), .O(z01));
  ...
  nand3  g35(.a(new_n38_), .b(new_n30_), .c(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(new_n28_), .O(z06));
  nor3   g37(.a(new_n29_), .b(x13), .c(x03), .O(z07));
  aoi21  g38(.a(new_n61_), .b(new_n58_), .c(new_n28_), .O(z08));
