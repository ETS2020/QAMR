...
module FAU ( 
  ...
  nor2   g47(.a(new_n54_), .b(x15), .O(new_n93_));
  nand2  g48(.a(x18), .b(x07), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n77_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  aoi21  g51(.a(x18), .b(new_n89_), .c(x17), .O(new_n97_));
  nand2  g52(.a(x18), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(new_n97_), .O(z11));
  nand2  g55(.a(new_n98_), .b(new_n80_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n94_), .c(new_n93_), .d(new_n70_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z12));
  nand2  g58(.a(new_n70_), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n55_), .b(new_n90_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n72_), .O(z13));
  ...
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n106_), .O(z17));
  ...
  nand3  g80(.a(new_n125_), .b(new_n123_), .c(new_n106_), .O(z18));
  buf    g81(.a(x16), .O(z02));
endmodule
