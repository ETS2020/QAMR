// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:07 2020
...
module FAU ( 
  ...
  nand2  g38(.a(new_n77_), .b(new_n49_), .O(new_n84_));
  ...
  nand3  g56(.a(new_n101_), .b(new_n93_), .c(new_n71_), .O(z13));
  nand2  g57(.a(new_n71_), .b(x21), .O(new_n103_));
  inv1   g58(.a(x21), .O(new_n104_));
  nor2   g59(.a(new_n69_), .b(x20), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n103_), .c(new_n93_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  nor2   g63(.a(x22), .b(x21), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n105_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n93_), .O(z15));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n112_));
  nand3  g67(.a(new_n109_), .b(new_n105_), .c(new_n48_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n93_), .O(z16));
  nand2  g69(.a(new_n113_), .b(x24), .O(new_n115_));
  nand3  g70(.a(new_n73_), .b(new_n105_), .c(new_n48_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n93_), .O(z17));
  aoi21  g72(.a(new_n116_), .b(x25), .c(new_n92_), .O(new_n118_));
  oai21  g73(.a(new_n113_), .b(new_n84_), .c(new_n118_), .O(z18));
  buf    g74(.a(x16), .O(z02));
endmodule
