...
module FAU ( 
  ...
  aoi21  g42(.a(new_n83_), .b(new_n52_), .c(new_n87_), .O(z12));
  ...
  nand3  g54(.a(new_n99_), .b(new_n97_), .c(new_n79_), .O(z15));
  nand2  g55(.a(new_n99_), .b(x23), .O(new_n101_));
  inv1   g56(.a(x23), .O(new_n102_));
  nand3  g57(.a(new_n98_), .b(new_n89_), .c(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n79_), .O(z16));
  inv1   g59(.a(x24), .O(new_n105_));
  nand3  g60(.a(new_n98_), .b(new_n89_), .c(new_n105_), .O(new_n106_));
  nor2   g61(.a(x25), .b(new_n102_), .O(new_n107_));
  aoi21  g62(.a(new_n103_), .b(x24), .c(new_n78_), .O(new_n108_));
  oai21  g63(.a(new_n107_), .b(new_n106_), .c(new_n108_), .O(z17));
  nand2  g64(.a(new_n106_), .b(x25), .O(new_n110_));
  inv1   g65(.a(new_n106_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n48_), .c(new_n102_), .O(new_n112_));
