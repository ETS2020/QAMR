...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n85_, new_n86_, new_n87_, new_n89_, new_n93_;
  ...
  or2    g40(.a(new_n82_), .b(x19), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z12));
  oai21  g43(.a(x20), .b(x18), .c(new_n85_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n79_), .O(z13));
  nand2  g45(.a(new_n79_), .b(new_n52_), .O(z14));
  nand2  g46(.a(new_n79_), .b(new_n53_), .O(z15));
  inv1   g47(.a(x23), .O(new_n93_));
  nand2  g48(.a(new_n79_), .b(new_n93_), .O(z16));
  nand2  g49(.a(new_n79_), .b(new_n48_), .O(z17));
  nand2  g50(.a(new_n79_), .b(new_n49_), .O(z18));
  buf    g51(.a(x16), .O(z02));
endmodule
