...
module FAU ( 
  ...
  aoi21  g05(.a(new_n50_), .b(new_n49_), .c(x20), .O(new_n51_));
  ...
  oai21  g10(.a(new_n55_), .b(new_n51_), .c(new_n48_), .O(new_n56_));
  ...
  nand2  g28(.a(new_n50_), .b(new_n49_), .O(new_n74_));
  nand3  g29(.a(new_n74_), .b(new_n52_), .c(new_n73_), .O(new_n75_));
  nand3  g30(.a(new_n75_), .b(new_n54_), .c(x24), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n48_), .O(z08));
  ...
  nand3  g37(.a(new_n57_), .b(new_n79_), .c(new_n78_), .O(new_n83_));
  ...
  nor3   g42(.a(new_n87_), .b(new_n83_), .c(new_n50_), .O(z11));
  nor2   g43(.a(new_n87_), .b(x19), .O(new_n89_));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n84_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(new_n89_), .O(z12));
  nand2  g47(.a(new_n90_), .b(x20), .O(new_n93_));
  ...
  nand2  g53(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n97_), .c(new_n84_), .O(z14));
  nand2  g55(.a(new_n99_), .b(x22), .O(new_n101_));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n94_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n101_), .c(new_n84_), .O(z15));
  nand3  g59(.a(new_n103_), .b(new_n84_), .c(new_n52_), .O(z16));
  nand2  g60(.a(new_n103_), .b(x24), .O(new_n106_));
  inv1   g61(.a(x24), .O(new_n107_));
  nand3  g62(.a(new_n102_), .b(new_n94_), .c(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n84_), .O(z17));
  nand4  g64(.a(new_n102_), .b(new_n94_), .c(new_n48_), .d(new_n107_), .O(new_n110_));
  nand2  g65(.a(new_n108_), .b(x25), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n84_), .O(z18));
  buf    g67(.a(x16), .O(z02));
endmodule
