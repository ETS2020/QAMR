// Benchmark "FAU" written by ABC on Mon Jul 27 19:17:15 2020
...
module FAU ( 
  ...
  nand2  g55(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n86_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n103_));
  inv1   g58(.a(x22), .O(new_n104_));
  nand3  g59(.a(new_n100_), .b(new_n94_), .c(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n86_), .O(z15));
  inv1   g61(.a(x23), .O(new_n107_));
  nand3  g62(.a(new_n105_), .b(new_n86_), .c(new_n107_), .O(z16));
  nand2  g63(.a(new_n105_), .b(x24), .O(new_n109_));
  nand4  g64(.a(new_n100_), .b(new_n94_), .c(new_n54_), .d(new_n104_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n86_), .O(z17));
  aoi21  g66(.a(new_n110_), .b(x25), .c(new_n85_), .O(new_n112_));
  oai21  g67(.a(new_n110_), .b(x25), .c(new_n112_), .O(z18));
  buf    g68(.a(x16), .O(z02));
endmodule
