...
module FAU ( 
  ...
  nand2  g53(.a(new_n96_), .b(new_n89_), .O(new_n99_));
  nand2  g54(.a(new_n69_), .b(new_n54_), .O(new_n100_));
  aoi21  g55(.a(new_n99_), .b(new_n79_), .c(new_n100_), .O(z12));
  ...
  aoi21  g73(.a(new_n117_), .b(x25), .c(new_n92_), .O(new_n119_));
  oai21  g74(.a(new_n114_), .b(new_n84_), .c(new_n119_), .O(z18));
  buf    g75(.a(x16), .O(z02));
endmodule
