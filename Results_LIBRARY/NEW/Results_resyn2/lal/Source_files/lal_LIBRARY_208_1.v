// Benchmark "FAU" written by ABC on Mon Jul 27 19:17:12 2020
...
module FAU ( 
  ...
  nand2  g46(.a(new_n54_), .b(new_n91_), .O(new_n92_));
  ...
  nand2  g52(.a(x17), .b(new_n97_), .O(new_n98_));
  inv1   g53(.a(x05), .O(new_n99_));
  nand2  g54(.a(x18), .b(x17), .O(new_n100_));
  nand2  g55(.a(new_n78_), .b(new_n76_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n98_), .c(new_n96_), .O(z11));
  nand2  g58(.a(x19), .b(new_n97_), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(new_n79_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n69_), .c(new_n99_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n96_), .O(z12));
  nand2  g62(.a(new_n69_), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n93_), .c(new_n71_), .O(z13));
  nand2  g64(.a(new_n71_), .b(x21), .O(new_n110_));
  inv1   g65(.a(x21), .O(new_n111_));
  nor2   g66(.a(new_n69_), .b(x20), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n110_), .c(new_n93_), .O(z14));
  nand2  g69(.a(new_n113_), .b(x22), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n115_), .c(new_n93_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nand3  g74(.a(new_n116_), .b(new_n112_), .c(new_n48_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n93_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n73_), .b(new_n112_), .c(new_n48_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n93_), .O(z17));
  nand2  g79(.a(new_n123_), .b(x25), .O(new_n125_));
  inv1   g80(.a(new_n120_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n77_), .c(new_n49_), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n125_), .c(new_n93_), .O(z18));
  buf    g83(.a(x16), .O(z02));
endmodule
