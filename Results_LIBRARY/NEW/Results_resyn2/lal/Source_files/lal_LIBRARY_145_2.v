...
module FAU ( 
  ...
  nand4  g19(.a(new_n64_), .b(new_n48_), .c(x05), .d(x04), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(z09));
  inv1   g21(.a(x17), .O(new_n67_));
  nand3  g22(.a(new_n51_), .b(new_n64_), .c(new_n48_), .O(new_n68_));
  ...
  nand2  g30(.a(new_n72_), .b(x19), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n69_), .O(new_n77_));
  nor2   g32(.a(new_n77_), .b(new_n75_), .O(z12));
  nand2  g33(.a(new_n76_), .b(x20), .O(new_n79_));
  inv1   g34(.a(x20), .O(new_n80_));
  nand3  g35(.a(new_n72_), .b(new_n80_), .c(x19), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n79_), .c(new_n69_), .O(z13));
  inv1   g37(.a(x21), .O(new_n83_));
  inv1   g38(.a(x19), .O(new_n84_));
  nor2   g39(.a(x20), .b(new_n84_), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n72_), .c(new_n83_), .O(new_n86_));
  nand2  g41(.a(new_n81_), .b(x21), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n86_), .c(new_n69_), .O(z14));
  inv1   g43(.a(x22), .O(new_n89_));
  nand4  g44(.a(new_n85_), .b(new_n72_), .c(new_n89_), .d(new_n83_), .O(new_n90_));
  nand2  g45(.a(new_n86_), .b(x22), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n69_), .O(z15));
  oai21  g47(.a(new_n81_), .b(x22), .c(x23), .O(new_n93_));
  oai21  g48(.a(x23), .b(x22), .c(new_n83_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n85_), .c(new_n72_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n93_), .c(new_n69_), .O(z16));
  inv1   g51(.a(x23), .O(new_n97_));
  nand4  g52(.a(new_n85_), .b(new_n72_), .c(new_n97_), .d(new_n89_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x24), .O(new_n99_));
  nor3   g54(.a(x24), .b(x23), .c(x22), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n85_), .c(new_n72_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n69_), .O(z17));
  inv1   g57(.a(x25), .O(new_n103_));
  nand4  g58(.a(new_n100_), .b(new_n85_), .c(new_n72_), .d(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n101_), .b(x25), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n69_), .O(z18));
  buf    g61(.a(x16), .O(z02));
endmodule
