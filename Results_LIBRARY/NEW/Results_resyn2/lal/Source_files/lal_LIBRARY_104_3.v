// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:30 2020
...
module FAU ( 
  ...
  nand3  g75(.a(new_n120_), .b(new_n77_), .c(new_n49_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n93_), .O(z18));
  buf    g77(.a(x16), .O(z02));
endmodule
