...
module FAU ( 
  ...
  nor2   g30(.a(new_n75_), .b(x23), .O(new_n76_));
  nand2  g31(.a(new_n51_), .b(new_n50_), .O(new_n77_));
  ...
  aoi21  g43(.a(new_n82_), .b(new_n49_), .c(new_n48_), .O(new_n89_));
  aoi21  g44(.a(new_n86_), .b(new_n82_), .c(new_n72_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n88_), .c(new_n80_), .O(z08));
  ...
  nor3   g58(.a(new_n103_), .b(new_n97_), .c(new_n102_), .O(z11));
  nand2  g59(.a(new_n98_), .b(new_n73_), .O(new_n105_));
  aoi21  g60(.a(new_n101_), .b(new_n84_), .c(new_n105_), .O(z12));
  nand2  g61(.a(new_n73_), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n98_), .c(new_n75_), .O(z13));
  nand2  g63(.a(new_n75_), .b(x21), .O(new_n109_));
  inv1   g64(.a(new_n75_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n50_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n98_), .O(z14));
  nand2  g67(.a(new_n111_), .b(x22), .O(new_n113_));
  inv1   g68(.a(new_n77_), .O(new_n114_));
  nand2  g69(.a(new_n48_), .b(x20), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n74_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n113_), .c(new_n98_), .O(z15));
  nand3  g72(.a(new_n114_), .b(new_n110_), .c(new_n48_), .O(new_n118_));
  oai21  g73(.a(new_n77_), .b(new_n73_), .c(x23), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n98_), .O(z16));
  nand2  g75(.a(new_n118_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n78_), .b(new_n110_), .c(new_n48_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n98_), .O(z17));
  nand3  g78(.a(new_n78_), .b(new_n76_), .c(new_n82_), .O(new_n124_));
  nand2  g79(.a(new_n122_), .b(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n98_), .O(z18));
  buf    g81(.a(x16), .O(z02));
endmodule
