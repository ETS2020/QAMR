...
module FAU ( 
  ...
  nand3  g30(.a(new_n75_), .b(x21), .c(new_n52_), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(new_n49_), .c(new_n74_), .O(new_n77_));
  ...
  nor3   g44(.a(new_n89_), .b(new_n84_), .c(new_n75_), .O(z11));
  nand3  g45(.a(x19), .b(x18), .c(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n85_), .O(new_n92_));
  aoi21  g47(.a(new_n88_), .b(new_n52_), .c(new_n92_), .O(z12));
  ...
  nand4  g53(.a(new_n98_), .b(new_n96_), .c(new_n85_), .d(new_n49_), .O(z14));
  nand2  g54(.a(new_n97_), .b(new_n74_), .O(new_n100_));
  ...
  nand3  g59(.a(new_n97_), .b(new_n104_), .c(new_n74_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(z16));
  inv1   g61(.a(x24), .O(new_n107_));
  nand4  g62(.a(new_n97_), .b(new_n107_), .c(new_n104_), .d(new_n74_), .O(new_n108_));
  nand2  g63(.a(new_n105_), .b(x24), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n85_), .O(z17));
  aoi21  g65(.a(new_n108_), .b(x25), .c(new_n84_), .O(new_n111_));
  oai21  g66(.a(new_n108_), .b(x25), .c(new_n111_), .O(z18));
  buf    g67(.a(x16), .O(z02));
endmodule
