...
module FAU ( 
  ...
  nand4  g36(.a(x24), .b(x22), .c(new_n52_), .d(new_n51_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n48_), .c(x17), .O(new_n83_));
  ...
  oai21  g50(.a(x21), .b(x18), .c(new_n50_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n95_), .O(z10));
  nor2   g52(.a(x18), .b(new_n50_), .O(new_n98_));
  nor2   g53(.a(new_n51_), .b(x17), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(new_n95_), .O(z11));
  aoi21  g56(.a(x18), .b(x17), .c(x19), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor3   g59(.a(new_n104_), .b(new_n102_), .c(new_n95_), .O(z12));
  inv1   g60(.a(new_n95_), .O(new_n106_));
  nand2  g61(.a(new_n103_), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n104_), .b(new_n49_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(z13));
  nand2  g64(.a(new_n78_), .b(new_n76_), .O(new_n110_));
  oai21  g65(.a(new_n98_), .b(x21), .c(new_n108_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n106_), .c(new_n110_), .O(z14));
  nand3  g67(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n113_));
  nand2  g68(.a(new_n110_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n106_), .c(new_n113_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n106_), .c(new_n79_), .O(z16));
  inv1   g72(.a(new_n79_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n75_), .O(new_n119_));
  nand2  g74(.a(new_n79_), .b(x24), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n106_), .c(new_n119_), .O(z17));
  oai21  g76(.a(new_n79_), .b(x24), .c(x25), .O(new_n122_));
  nand3  g77(.a(new_n118_), .b(new_n48_), .c(new_n75_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n106_), .O(z18));
  buf    g79(.a(x16), .O(z02));
endmodule
