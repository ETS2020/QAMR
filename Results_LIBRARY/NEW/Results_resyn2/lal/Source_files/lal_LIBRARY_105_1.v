...
module FAU ( 
  ...
  nor2   g28(.a(x24), .b(x21), .O(new_n74_));
  nand3  g29(.a(x19), .b(x18), .c(x17), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(new_n76_));
  nand3  g31(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(new_n73_), .c(x25), .O(new_n78_));
  inv1   g33(.a(x25), .O(new_n79_));
  aoi21  g34(.a(new_n48_), .b(new_n68_), .c(new_n79_), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(new_n51_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n78_), .O(z08));
  ...
  nand3  g42(.a(new_n52_), .b(new_n84_), .c(new_n83_), .O(new_n88_));
  ...
  nor2   g47(.a(new_n92_), .b(new_n87_), .O(new_n93_));
  nor2   g48(.a(x18), .b(x17), .O(new_n94_));
  nor3   g49(.a(new_n94_), .b(new_n88_), .c(new_n93_), .O(z11));
  nor2   g50(.a(new_n93_), .b(x19), .O(new_n96_));
  nor3   g51(.a(new_n96_), .b(new_n88_), .c(new_n76_), .O(z12));
  nand2  g52(.a(new_n75_), .b(x20), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n89_), .c(new_n69_), .O(z13));
  inv1   g54(.a(x19), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n100_), .O(new_n101_));
  nor2   g56(.a(x21), .b(new_n87_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(x18), .O(new_n103_));
  nand2  g58(.a(new_n69_), .b(x21), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n89_), .O(z14));
  nand4  g60(.a(new_n102_), .b(new_n101_), .c(new_n71_), .d(x18), .O(new_n106_));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n89_), .O(z15));
  nand2  g63(.a(new_n106_), .b(x23), .O(new_n109_));
  nor2   g64(.a(x23), .b(x22), .O(new_n110_));
  nand2  g65(.a(new_n49_), .b(new_n92_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n102_), .c(new_n110_), .d(new_n101_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n89_), .O(z16));
  nand4  g68(.a(new_n74_), .b(new_n110_), .c(new_n101_), .d(new_n93_), .O(new_n114_));
  nand3  g69(.a(new_n102_), .b(new_n110_), .c(new_n101_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x24), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n89_), .c(new_n114_), .O(z17));
  nand2  g72(.a(new_n73_), .b(new_n79_), .O(new_n118_));
  nand2  g73(.a(new_n114_), .b(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n89_), .O(z18));
  buf    g75(.a(x16), .O(z02));
endmodule
