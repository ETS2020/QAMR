...
module FAU ( 
  ...
  nand2  g36(.a(new_n79_), .b(x17), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z11));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(z12));
  nand2  g40(.a(new_n79_), .b(new_n49_), .O(z13));
  inv1   g41(.a(x21), .O(new_n87_));
  nand2  g42(.a(new_n79_), .b(new_n87_), .O(z14));
  inv1   g43(.a(x22), .O(new_n89_));
  nand2  g44(.a(new_n79_), .b(new_n89_), .O(z15));
  inv1   g45(.a(x23), .O(new_n91_));
  nand2  g46(.a(new_n79_), .b(new_n91_), .O(z16));
  inv1   g47(.a(x24), .O(new_n93_));
  nand2  g48(.a(new_n79_), .b(new_n93_), .O(z17));
  nand2  g49(.a(new_n79_), .b(new_n48_), .O(z18));
  buf    g50(.a(x16), .O(z02));
endmodule
