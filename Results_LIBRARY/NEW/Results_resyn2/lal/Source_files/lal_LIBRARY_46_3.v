// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:06 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n67_, new_n70_, new_n71_, new_n72_, new_n74_,
  ...
  nand2  g25(.a(new_n52_), .b(new_n48_), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(x24), .O(new_n72_));
  nand2  g27(.a(new_n72_), .b(new_n70_), .O(z08));
  inv1   g28(.a(x07), .O(new_n74_));
  inv1   g29(.a(x15), .O(new_n75_));
  nand3  g30(.a(new_n55_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z09));
  inv1   g32(.a(x17), .O(new_n78_));
  nand3  g33(.a(new_n54_), .b(new_n75_), .c(new_n74_), .O(new_n79_));
  ...
  nor3   g38(.a(new_n83_), .b(new_n79_), .c(new_n51_), .O(z11));
  nor2   g39(.a(new_n83_), .b(x19), .O(new_n85_));
  nand3  g40(.a(x19), .b(x18), .c(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n85_), .c(new_n79_), .O(z12));
  nand2  g43(.a(new_n86_), .b(x20), .O(new_n89_));
  inv1   g44(.a(x21), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(x20), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n89_), .c(new_n80_), .O(z13));
  nand2  g48(.a(new_n86_), .b(x21), .O(new_n94_));
  nor2   g49(.a(x20), .b(new_n50_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n83_), .c(new_n90_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n94_), .c(new_n80_), .O(z14));
  nand2  g52(.a(new_n96_), .b(x22), .O(new_n98_));
  nor2   g53(.a(x22), .b(x21), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n95_), .c(new_n83_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n80_), .O(z15));
  nand4  g56(.a(new_n99_), .b(new_n95_), .c(new_n83_), .d(new_n48_), .O(new_n102_));
  nand2  g57(.a(new_n100_), .b(x23), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n80_), .O(z16));
  nand2  g59(.a(new_n102_), .b(x24), .O(new_n105_));
  nor2   g60(.a(x24), .b(x23), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n99_), .c(new_n95_), .d(new_n83_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n80_), .O(z17));
  nand3  g63(.a(new_n99_), .b(x18), .c(x17), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand4  g65(.a(new_n106_), .b(new_n110_), .c(new_n95_), .d(new_n70_), .O(new_n111_));
  nand2  g66(.a(new_n107_), .b(x25), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n80_), .O(z18));
  buf    g68(.a(x16), .O(z02));
endmodule
