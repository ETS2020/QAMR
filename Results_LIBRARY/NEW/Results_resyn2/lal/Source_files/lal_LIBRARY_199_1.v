...
module FAU ( 
  ...
  and2   g28(.a(x18), .b(x17), .O(new_n74_));
  nor2   g29(.a(x22), .b(x21), .O(new_n75_));
  nand4  g30(.a(new_n75_), .b(new_n74_), .c(new_n49_), .d(x19), .O(new_n76_));
  ...
  nor3   g46(.a(new_n91_), .b(new_n87_), .c(new_n74_), .O(z11));
  nor2   g47(.a(new_n74_), .b(x19), .O(new_n93_));
  nand2  g48(.a(new_n74_), .b(x19), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n88_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(new_n93_), .O(z12));
  nand2  g51(.a(new_n94_), .b(x20), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n88_), .c(new_n69_), .O(z13));
  nor2   g53(.a(x22), .b(x17), .O(new_n99_));
  inv1   g54(.a(x19), .O(new_n100_));
  nor2   g55(.a(x20), .b(new_n100_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n70_), .c(x18), .O(new_n102_));
  aoi21  g57(.a(new_n69_), .b(x21), .c(new_n87_), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n99_), .c(new_n103_), .O(z14));
  nand3  g59(.a(new_n75_), .b(new_n101_), .c(new_n74_), .O(new_n105_));
  nand2  g60(.a(new_n102_), .b(x22), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n88_), .O(z15));
  nand4  g62(.a(new_n75_), .b(new_n101_), .c(new_n74_), .d(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n105_), .b(x23), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n88_), .O(z16));
  nand2  g65(.a(new_n108_), .b(x24), .O(new_n111_));
  nor2   g66(.a(new_n87_), .b(new_n73_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(z17));
  nand2  g68(.a(new_n73_), .b(new_n78_), .O(new_n114_));
  oai21  g69(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n88_), .O(z18));
  buf    g71(.a(x16), .O(z02));
endmodule
