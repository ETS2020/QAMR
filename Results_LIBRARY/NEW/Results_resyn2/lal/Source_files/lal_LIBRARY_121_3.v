...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n84_, new_n88_, new_n90_, new_n92_, new_n94_;
  ...
  aoi21  g40(.a(new_n83_), .b(new_n52_), .c(new_n78_), .O(z12));
  nand2  g41(.a(new_n79_), .b(new_n49_), .O(z13));
  inv1   g42(.a(x21), .O(new_n88_));
  nand2  g43(.a(new_n79_), .b(new_n88_), .O(z14));
  inv1   g44(.a(x22), .O(new_n90_));
  nand2  g45(.a(new_n79_), .b(new_n90_), .O(z15));
  inv1   g46(.a(x23), .O(new_n92_));
  nand2  g47(.a(new_n79_), .b(new_n92_), .O(z16));
  inv1   g48(.a(x24), .O(new_n94_));
  nand2  g49(.a(new_n79_), .b(new_n94_), .O(z17));
  nand2  g50(.a(new_n79_), .b(new_n48_), .O(z18));
  buf    g51(.a(x16), .O(z02));
endmodule
