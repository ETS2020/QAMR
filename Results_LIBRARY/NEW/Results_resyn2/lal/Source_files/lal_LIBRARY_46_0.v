// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:05 2020
...
module FAU ( 
  ...
  nand2  g31(.a(new_n74_), .b(new_n58_), .O(new_n77_));
  ...
  nor3   g37(.a(new_n82_), .b(new_n77_), .c(new_n81_), .O(z11));
  inv1   g38(.a(new_n82_), .O(new_n84_));
  oai21  g39(.a(x21), .b(x20), .c(x19), .O(new_n85_));
  nand2  g40(.a(new_n82_), .b(x19), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n78_), .O(new_n87_));
  aoi21  g42(.a(new_n85_), .b(new_n84_), .c(new_n87_), .O(z12));
  aoi21  g43(.a(new_n86_), .b(x20), .c(new_n77_), .O(new_n89_));
  oai21  g44(.a(new_n86_), .b(x20), .c(new_n89_), .O(z13));
  oai21  g45(.a(new_n86_), .b(x20), .c(x21), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n78_), .O(z14));
  inv1   g47(.a(x22), .O(new_n93_));
  nand2  g48(.a(new_n78_), .b(new_n93_), .O(z15));
  inv1   g49(.a(x23), .O(new_n95_));
  nand2  g50(.a(new_n78_), .b(new_n95_), .O(z16));
  inv1   g51(.a(x24), .O(new_n97_));
  nand2  g52(.a(new_n78_), .b(new_n97_), .O(z17));
  nand2  g53(.a(new_n78_), .b(new_n48_), .O(z18));
  buf    g54(.a(x16), .O(z02));
endmodule
