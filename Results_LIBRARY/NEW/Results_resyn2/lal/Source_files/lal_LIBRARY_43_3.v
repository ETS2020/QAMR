...
module FAU ( 
  ...
  nand3  g43(.a(new_n83_), .b(new_n49_), .c(x19), .O(new_n89_));
  nand2  g44(.a(new_n85_), .b(x20), .O(new_n90_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n92_), .c(new_n79_), .O(z14));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n79_), .O(z16));
  nand2  g60(.a(new_n98_), .b(new_n103_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n89_), .c(x24), .O(new_n107_));
  nand2  g62(.a(new_n48_), .b(x20), .O(new_n108_));
  inv1   g63(.a(x24), .O(new_n109_));
  nand3  g64(.a(new_n98_), .b(new_n109_), .c(new_n103_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n83_), .d(x19), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n107_), .c(new_n79_), .O(z17));
  oai21  g68(.a(new_n110_), .b(new_n85_), .c(x25), .O(new_n114_));
  nand3  g69(.a(new_n111_), .b(new_n94_), .c(new_n48_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(z18));
  buf    g71(.a(x16), .O(z02));
endmodule
