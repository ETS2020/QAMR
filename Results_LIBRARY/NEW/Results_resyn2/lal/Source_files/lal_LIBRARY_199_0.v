...
module FAU ( 
  ...
  nor2   g30(.a(x21), .b(new_n52_), .O(new_n76_));
  inv1   g31(.a(x23), .O(new_n77_));
  nor2   g32(.a(x20), .b(new_n51_), .O(new_n78_));
  ...
  nand4  g36(.a(x24), .b(x21), .c(new_n52_), .d(new_n50_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n48_), .c(x18), .O(new_n83_));
  nand3  g38(.a(x24), .b(x22), .c(x21), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n48_), .O(new_n85_));
  ...
  nand2  g44(.a(new_n89_), .b(new_n81_), .O(z08));
  ...
  nor2   g53(.a(new_n51_), .b(new_n50_), .O(new_n99_));
  nor2   g54(.a(x18), .b(x17), .O(new_n100_));
  nor3   g55(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(z11));
  nor2   g56(.a(new_n99_), .b(x19), .O(new_n102_));
  nand2  g57(.a(new_n99_), .b(x19), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n102_), .O(z12));
  ...
  oai21  g66(.a(new_n103_), .b(x20), .c(x21), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n96_), .O(z14));
  nand3  g68(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n114_));
  nand2  g69(.a(new_n78_), .b(new_n76_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x22), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n96_), .c(new_n114_), .d(x17), .O(z15));
  nand2  g72(.a(new_n114_), .b(x23), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n96_), .c(new_n79_), .O(z16));
  inv1   g74(.a(new_n79_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n75_), .O(new_n121_));
  nand2  g76(.a(new_n79_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n96_), .c(new_n121_), .O(z17));
  oai21  g78(.a(new_n79_), .b(x24), .c(x25), .O(new_n124_));
  nand3  g79(.a(new_n120_), .b(new_n48_), .c(new_n75_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n96_), .O(z18));
  buf    g81(.a(x16), .O(z02));
endmodule
