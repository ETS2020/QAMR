...
module FAU ( 
  ...
  nand3  g20(.a(x13), .b(x09), .c(x03), .O(new_n40_));
  oai21  g21(.a(new_n33_), .b(x11), .c(new_n40_), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(new_n23_), .O(new_n42_));
  ...
  aoi21  g29(.a(new_n43_), .b(new_n23_), .c(x11), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n45_), .c(x12), .O(new_n50_));
  nor2   g31(.a(x12), .b(x11), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n40_), .O(new_n53_));
  oai21  g34(.a(x07), .b(x03), .c(x05), .O(new_n54_));
  aoi21  g35(.a(new_n53_), .b(new_n23_), .c(new_n54_), .O(new_n55_));
  nand2  g36(.a(new_n55_), .b(new_n50_), .O(z3));
