...
module FAU ( 
  ...
  nand3  g21(.a(new_n31_), .b(x12), .c(new_n40_), .O(new_n41_));
  oai21  g22(.a(x10), .b(x08), .c(new_n24_), .O(new_n42_));
  oai21  g23(.a(x12), .b(x11), .c(new_n24_), .O(new_n43_));
  ...
  nand2  g27(.a(new_n31_), .b(new_n23_), .O(new_n47_));
  nor2   g28(.a(new_n40_), .b(new_n20_), .O(new_n48_));
  oai21  g29(.a(x06), .b(x03), .c(x05), .O(new_n49_));
  aoi21  g30(.a(new_n48_), .b(new_n47_), .c(new_n49_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n46_), .O(z2));
  inv1   g32(.a(new_n44_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n23_), .O(new_n53_));
  nand3  g34(.a(new_n31_), .b(new_n23_), .c(new_n40_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x12), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n20_), .c(new_n28_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(z3));
