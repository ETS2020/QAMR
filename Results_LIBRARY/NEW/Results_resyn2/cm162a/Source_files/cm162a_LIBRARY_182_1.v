// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:33 2020
...
module FAU ( 
  ...
  aoi21  g11(.a(new_n30_), .b(new_n24_), .c(new_n21_), .O(new_n31_));
  aoi21  g12(.a(new_n23_), .b(new_n28_), .c(new_n29_), .O(new_n32_));
  oai21  g13(.a(new_n32_), .b(new_n31_), .c(x03), .O(new_n33_));
  ...
  nand3  g19(.a(new_n38_), .b(new_n29_), .c(new_n28_), .O(new_n39_));
  aoi21  g20(.a(new_n39_), .b(new_n24_), .c(new_n21_), .O(new_n40_));
  nor2   g21(.a(x10), .b(x08), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n23_), .c(new_n38_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n40_), .c(x03), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n20_), .c(new_n35_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z2));
  nand2  g27(.a(new_n39_), .b(new_n24_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n23_), .c(x12), .O(new_n48_));
  nand3  g29(.a(new_n24_), .b(new_n23_), .c(x12), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n39_), .c(x03), .O(new_n50_));
  inv1   g31(.a(x07), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n20_), .c(new_n35_), .O(new_n52_));
