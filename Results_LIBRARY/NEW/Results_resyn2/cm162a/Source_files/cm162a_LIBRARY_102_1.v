// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:56 2020
...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n59_;
  nand3  g00(.a(x13), .b(x09), .c(x02), .O(new_n20_));
  ...
  nand4  g33(.a(new_n42_), .b(new_n33_), .c(new_n21_), .d(x02), .O(new_n53_));
