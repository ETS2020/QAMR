...
module FAU ( 
  ...
  aoi21  g05(.a(new_n24_), .b(x08), .c(new_n22_), .O(new_n25_));
  ...
  aoi21  g13(.a(new_n32_), .b(new_n23_), .c(new_n21_), .O(new_n33_));
  nor2   g14(.a(new_n22_), .b(new_n31_), .O(new_n34_));
  oai21  g15(.a(new_n34_), .b(new_n33_), .c(x03), .O(new_n35_));
  ...
  nand3  g27(.a(new_n46_), .b(new_n45_), .c(new_n31_), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n23_), .c(new_n21_), .O(new_n48_));
  nand4  g29(.a(new_n45_), .b(new_n31_), .c(x04), .d(x02), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(x12), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n30_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n48_), .c(x03), .O(new_n52_));
  inv1   g33(.a(x07), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n20_), .c(new_n27_), .O(new_n54_));
