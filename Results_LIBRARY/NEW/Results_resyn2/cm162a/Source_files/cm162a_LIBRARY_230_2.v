...
module FAU ( 
  ...
  oai21  g29(.a(x10), .b(x08), .c(new_n24_), .O(new_n49_));
  oai21  g30(.a(x12), .b(x11), .c(new_n24_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n49_), .c(new_n23_), .O(new_n51_));
  oai21  g32(.a(new_n41_), .b(new_n21_), .c(x12), .O(new_n52_));
