// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:55 2020
...
module FAU ( 
  ...
  nor2   g15(.a(new_n22_), .b(new_n32_), .O(new_n35_));
  ...
  aoi21  g22(.a(new_n41_), .b(new_n23_), .c(new_n40_), .O(new_n42_));
  nand2  g23(.a(new_n24_), .b(x11), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n34_), .c(new_n42_), .O(new_n44_));
  ...
  aoi21  g29(.a(new_n41_), .b(new_n23_), .c(new_n48_), .O(new_n49_));
  oai21  g30(.a(x12), .b(x11), .c(new_n24_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n34_), .c(new_n49_), .O(new_n51_));
  oai21  g32(.a(x07), .b(x03), .c(x05), .O(new_n52_));
  aoi21  g33(.a(x12), .b(x11), .c(new_n52_), .O(new_n53_));
  oai21  g34(.a(new_n51_), .b(new_n20_), .c(new_n53_), .O(z3));
