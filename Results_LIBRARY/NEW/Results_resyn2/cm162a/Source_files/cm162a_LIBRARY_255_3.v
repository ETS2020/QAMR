// Benchmark "FAU" written by ABC on Mon Jul 27 20:50:07 2020
...
module FAU ( 
  ...
  nand3  g24(.a(new_n24_), .b(new_n43_), .c(x11), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n34_), .c(new_n42_), .O(new_n45_));
  ...
  aoi21  g29(.a(new_n41_), .b(new_n23_), .c(new_n43_), .O(new_n49_));
