...
module FAU ( 
  ...
  oai21  g22(.a(new_n41_), .b(new_n24_), .c(x03), .O(new_n42_));
  inv1   g23(.a(x06), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n20_), .c(new_n27_), .O(new_n44_));
  oai21  g25(.a(new_n42_), .b(new_n39_), .c(new_n44_), .O(z2));
  inv1   g26(.a(x02), .O(new_n46_));
  nand3  g27(.a(x13), .b(x09), .c(x04), .O(new_n47_));
  inv1   g28(.a(x11), .O(new_n48_));
  inv1   g29(.a(x12), .O(new_n49_));
  nand3  g30(.a(new_n40_), .b(new_n49_), .c(new_n48_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n47_), .c(new_n46_), .O(new_n51_));
  nand4  g32(.a(new_n48_), .b(new_n31_), .c(new_n30_), .d(x02), .O(new_n52_));
