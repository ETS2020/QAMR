// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:53 2020
...
module FAU ( 
  ...
  oai22  g29(.a(new_n41_), .b(x12), .c(new_n24_), .d(new_n20_), .O(new_n49_));
  nand2  g30(.a(new_n49_), .b(new_n23_), .O(new_n50_));
  nand3  g31(.a(new_n43_), .b(new_n23_), .c(new_n40_), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  aoi21  g33(.a(x11), .b(new_n20_), .c(new_n52_), .O(new_n53_));
