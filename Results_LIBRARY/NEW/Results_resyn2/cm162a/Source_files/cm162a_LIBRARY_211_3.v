...
module FAU ( 
  ...
  nand2  g21(.a(new_n40_), .b(new_n31_), .O(new_n41_));
  nor2   g22(.a(x12), .b(new_n32_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n41_), .c(new_n24_), .O(new_n43_));
  nor2   g24(.a(x10), .b(x08), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n23_), .c(new_n40_), .O(new_n45_));
  aoi21  g26(.a(new_n43_), .b(new_n23_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g31(.a(new_n23_), .b(new_n40_), .c(new_n31_), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(x12), .c(new_n50_), .d(new_n34_), .O(new_n52_));
