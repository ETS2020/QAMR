...
module FAU ( 
  ...
  nand2  g20(.a(new_n22_), .b(new_n32_), .O(new_n40_));
  inv1   g21(.a(x11), .O(new_n41_));
  aoi21  g22(.a(x10), .b(new_n20_), .c(new_n41_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  nand3  g24(.a(new_n41_), .b(new_n32_), .c(new_n31_), .O(new_n44_));
  oai21  g25(.a(new_n24_), .b(new_n20_), .c(new_n44_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n23_), .O(new_n46_));
  inv1   g27(.a(x06), .O(new_n47_));
  aoi21  g28(.a(new_n47_), .b(new_n20_), .c(new_n28_), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(new_n46_), .c(new_n43_), .O(z2));
  oai21  g30(.a(new_n44_), .b(new_n21_), .c(x12), .O(new_n50_));
  oai21  g31(.a(x10), .b(x08), .c(new_n24_), .O(new_n51_));
  oai21  g32(.a(x12), .b(x11), .c(new_n24_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n51_), .c(new_n23_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n50_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n20_), .c(new_n28_), .O(new_n57_));
