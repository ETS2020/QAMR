...
module FAU ( 
  ...
  aoi21  g14(.a(new_n33_), .b(new_n21_), .c(new_n24_), .O(new_n34_));
  aoi21  g15(.a(new_n22_), .b(new_n31_), .c(new_n32_), .O(new_n35_));
  ...
  aoi21  g22(.a(new_n41_), .b(new_n21_), .c(new_n24_), .O(new_n42_));
  ...
  nand2  g29(.a(new_n41_), .b(new_n21_), .O(new_n49_));
