// Benchmark "FAU" written by ABC on Mon Jul 27 20:50:08 2020
...
module FAU ( 
  ...
  oai21  g13(.a(new_n23_), .b(x09), .c(x12), .O(new_n35_));
  ...
  aoi21  g19(.a(x12), .b(x11), .c(new_n40_), .O(new_n41_));
  nand2  g20(.a(new_n41_), .b(new_n39_), .O(z2));
  nor2   g21(.a(new_n23_), .b(x09), .O(new_n43_));
  nand3  g22(.a(new_n36_), .b(new_n43_), .c(x13), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  inv1   g24(.a(x11), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n30_), .c(new_n45_), .O(new_n49_));
