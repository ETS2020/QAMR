// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:36 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n54_, new_n55_;
  aoi21  g00(.a(x03), .b(x02), .c(x09), .O(new_n22_));
  nand3  g01(.a(x09), .b(x03), .c(x02), .O(new_n23_));
  ...
  oai21  g09(.a(x09), .b(new_n30_), .c(x11), .O(new_n31_));
  inv1   g10(.a(x09), .O(new_n32_));
  inv1   g11(.a(x11), .O(new_n33_));
  nand3  g12(.a(new_n33_), .b(new_n32_), .c(x03), .O(new_n34_));
  nand3  g13(.a(new_n34_), .b(new_n31_), .c(x02), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x04), .O(new_n36_));
  inv1   g15(.a(x01), .O(new_n37_));
  aoi21  g16(.a(new_n26_), .b(new_n37_), .c(new_n27_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(z1));
  nor2   g18(.a(x09), .b(new_n30_), .O(new_n40_));
  nor2   g19(.a(x12), .b(x11), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(new_n40_), .c(new_n34_), .d(x12), .O(new_n42_));
  inv1   g21(.a(x06), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(new_n26_), .c(new_n27_), .O(new_n44_));
  oai21  g23(.a(new_n42_), .b(new_n26_), .c(new_n44_), .O(z2));
  nand3  g24(.a(new_n41_), .b(new_n40_), .c(x13), .O(new_n46_));
  inv1   g25(.a(x13), .O(new_n47_));
  nand3  g26(.a(new_n41_), .b(new_n32_), .c(x03), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n46_), .c(x04), .O(new_n50_));
  inv1   g29(.a(x07), .O(new_n51_));
  aoi21  g30(.a(new_n51_), .b(new_n26_), .c(new_n27_), .O(new_n52_));
