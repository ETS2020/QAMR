// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:31 2020
...
module FAU ( 
  ...
  nor2   g21(.a(new_n32_), .b(x12), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nor2   g23(.a(new_n42_), .b(new_n22_), .O(new_n45_));
  oai21  g24(.a(new_n32_), .b(x12), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x07), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n22_), .c(new_n26_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(z3));
