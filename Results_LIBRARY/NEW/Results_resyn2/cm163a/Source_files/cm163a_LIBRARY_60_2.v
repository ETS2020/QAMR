...
module FAU ( 
  ...
  nand3  g11(.a(new_n32_), .b(x11), .c(x04), .O(new_n33_));
  inv1   g12(.a(x01), .O(new_n34_));
  aoi21  g13(.a(new_n22_), .b(new_n34_), .c(new_n26_), .O(new_n35_));
  nand3  g14(.a(new_n35_), .b(new_n33_), .c(new_n31_), .O(z1));
  nor2   g15(.a(new_n23_), .b(x09), .O(new_n37_));
  nor2   g16(.a(x12), .b(x11), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n37_), .c(new_n31_), .d(x12), .O(new_n39_));
  ...
  nand3  g21(.a(new_n38_), .b(new_n37_), .c(x13), .O(new_n43_));
