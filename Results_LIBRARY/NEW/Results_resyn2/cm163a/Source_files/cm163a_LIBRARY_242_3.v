...
module FAU ( 
  ...
  nand3  g09(.a(new_n30_), .b(new_n29_), .c(x04), .O(new_n31_));
  inv1   g10(.a(x01), .O(new_n32_));
  aoi21  g11(.a(new_n22_), .b(new_n32_), .c(new_n26_), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(new_n31_), .O(z1));
  ...
  nand3  g21(.a(new_n36_), .b(new_n30_), .c(x13), .O(new_n43_));
  inv1   g22(.a(x13), .O(new_n44_));
  nand2  g23(.a(new_n37_), .b(new_n44_), .O(new_n45_));
