...
module FAU ( 
  ...
  nand2  g20(.a(new_n37_), .b(x13), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  oai21  g22(.a(x13), .b(new_n24_), .c(new_n43_), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  oai21  g24(.a(x12), .b(x11), .c(new_n45_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n44_), .c(new_n22_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n42_), .O(new_n48_));
