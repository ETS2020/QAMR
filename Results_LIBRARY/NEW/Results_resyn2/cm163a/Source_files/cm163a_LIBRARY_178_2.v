// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:50 2020
...
module FAU ( 
  ...
  oai21  g17(.a(new_n23_), .b(x09), .c(new_n35_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(x04), .O(new_n40_));
  inv1   g19(.a(x06), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n22_), .c(new_n26_), .O(new_n42_));
  oai21  g21(.a(new_n40_), .b(new_n38_), .c(new_n42_), .O(z2));
  inv1   g22(.a(new_n23_), .O(new_n44_));
  nor2   g23(.a(x12), .b(x09), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n44_), .c(x13), .O(new_n46_));
  nand4  g25(.a(new_n45_), .b(x13), .c(x03), .d(x02), .O(new_n47_));
