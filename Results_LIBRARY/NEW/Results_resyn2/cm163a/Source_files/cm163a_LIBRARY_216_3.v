...
module FAU ( 
  ...
  nand4  g17(.a(new_n38_), .b(new_n35_), .c(x05), .d(x04), .O(z2));
  nand3  g18(.a(new_n37_), .b(new_n36_), .c(x13), .O(new_n40_));
  inv1   g19(.a(x13), .O(new_n41_));
  inv1   g20(.a(x11), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(new_n41_), .O(new_n45_));
  nand3  g24(.a(new_n45_), .b(new_n40_), .c(x04), .O(new_n46_));
