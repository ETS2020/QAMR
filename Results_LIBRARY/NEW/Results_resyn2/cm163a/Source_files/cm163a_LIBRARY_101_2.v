...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n29_), .c(x12), .O(new_n37_));
  inv1   g16(.a(x12), .O(new_n38_));
  nand2  g17(.a(new_n32_), .b(new_n29_), .O(new_n39_));
  ...
  nor2   g23(.a(new_n23_), .b(x09), .O(new_n45_));
  inv1   g24(.a(x11), .O(new_n46_));
  oai21  g25(.a(x13), .b(x12), .c(new_n46_), .O(new_n47_));
  nand4  g26(.a(new_n38_), .b(new_n30_), .c(x03), .d(x02), .O(new_n48_));
  aoi22  g27(.a(new_n48_), .b(x13), .c(new_n47_), .d(new_n45_), .O(new_n49_));
