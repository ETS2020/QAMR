...
module FAU ( 
  ...
  xor2a  g09(.a(new_n30_), .b(new_n29_), .O(new_n31_));
  ...
  nand2  g13(.a(x06), .b(new_n22_), .O(new_n35_));
  inv1   g14(.a(x09), .O(new_n36_));
  nand4  g15(.a(new_n29_), .b(new_n36_), .c(x03), .d(x02), .O(new_n37_));
  ...
  nand4  g24(.a(new_n39_), .b(new_n45_), .c(x03), .d(x02), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n44_), .c(x09), .O(new_n47_));
  aoi21  g26(.a(new_n30_), .b(new_n29_), .c(new_n45_), .O(new_n48_));
