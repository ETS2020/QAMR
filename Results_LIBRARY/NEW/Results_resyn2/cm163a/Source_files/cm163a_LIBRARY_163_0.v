// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:43 2020
...
module FAU ( 
  ...
  nor2   g20(.a(new_n32_), .b(x12), .O(new_n42_));
  nand2  g21(.a(x13), .b(x04), .O(new_n43_));
  inv1   g22(.a(x07), .O(new_n44_));
  aoi21  g23(.a(new_n44_), .b(new_n22_), .c(new_n26_), .O(new_n45_));
  oai21  g24(.a(new_n43_), .b(new_n42_), .c(new_n45_), .O(z3));
