// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:03 2020
...
module FAU ( 
  ...
  aoi21  g15(.a(new_n31_), .b(new_n24_), .c(new_n36_), .O(new_n37_));
  inv1   g16(.a(x11), .O(new_n38_));
  nand4  g17(.a(new_n36_), .b(new_n38_), .c(x03), .d(x02), .O(new_n39_));
  nor2   g18(.a(x13), .b(new_n23_), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  oai21  g20(.a(new_n41_), .b(new_n37_), .c(x04), .O(new_n42_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n23_), .c(new_n39_), .O(new_n47_));
  nand2  g26(.a(new_n39_), .b(new_n46_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x04), .O(new_n49_));
  inv1   g28(.a(x07), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n22_), .c(new_n27_), .O(new_n51_));
