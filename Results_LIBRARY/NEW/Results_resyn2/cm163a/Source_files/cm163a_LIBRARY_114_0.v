...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n29_,
    ...
    new_n38_, new_n40_, new_n41_, new_n42_, new_n44_, new_n45_;
  ...
  and2   g13(.a(x12), .b(x04), .O(new_n35_));
  oai21  g14(.a(new_n30_), .b(x11), .c(new_n35_), .O(new_n36_));
  inv1   g15(.a(x06), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n22_), .c(new_n26_), .O(new_n38_));
  ...
  nand3  g21(.a(new_n42_), .b(new_n40_), .c(x05), .O(z3));
