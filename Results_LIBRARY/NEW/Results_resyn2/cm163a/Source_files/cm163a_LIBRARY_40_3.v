// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:47 2020
...
module FAU ( 
  ...
  oai21  g10(.a(new_n23_), .b(x11), .c(x12), .O(new_n32_));
  ...
  nand4  g18(.a(new_n33_), .b(x13), .c(x03), .d(x02), .O(new_n40_));
  inv1   g19(.a(x13), .O(new_n41_));
  nand2  g20(.a(new_n34_), .b(new_n41_), .O(new_n42_));
  ...
  nand2  g24(.a(new_n45_), .b(new_n43_), .O(z3));
