...
module FAU ( 
  ...
  inv1   g16(.a(new_n31_), .O(new_n38_));
  inv1   g17(.a(x13), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n22_), .O(new_n40_));
  nand3  g19(.a(new_n40_), .b(new_n38_), .c(new_n37_), .O(new_n41_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n42_), .c(new_n41_), .O(z2));
  nor2   g24(.a(x13), .b(new_n22_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n38_), .c(new_n37_), .O(new_n47_));
  oai21  g26(.a(new_n31_), .b(x12), .c(x13), .O(new_n48_));
