...
module FAU ( 
  ...
  nand2  g250(.a(x70), .b(x04), .O(new_n342_));
  nand2  g251(.a(new_n160_), .b(x52), .O(new_n343_));
  nand2  g252(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  nand2  g253(.a(new_n344_), .b(x69), .O(new_n345_));
  nand3  g254(.a(new_n106_), .b(new_n147_), .c(x20), .O(new_n346_));
  aoi21  g255(.a(new_n346_), .b(new_n345_), .c(x68), .O(new_n347_));
  ...
  aoi21  g300(.a(new_n129_), .b(new_n391_), .c(new_n195_), .O(new_n392_));
  oai21  g301(.a(new_n129_), .b(x52), .c(new_n392_), .O(new_n393_));
  aoi21  g302(.a(new_n129_), .b(new_n140_), .c(new_n306_), .O(new_n394_));
  oai21  g303(.a(new_n129_), .b(x48), .c(new_n394_), .O(new_n395_));
  aoi21  g304(.a(new_n395_), .b(new_n393_), .c(new_n197_), .O(new_n396_));
