// Benchmark "FAU" written by ABC on Tue Jul 28 07:04:41 2020
...
module FAU ( 
  ...
  nand4  g166(.a(new_n305_), .b(x070), .c(x062), .d(new_n314_), .O(new_n323_));
  ...
  nand2  g312(.a(new_n299_), .b(new_n298_), .O(new_n470_));
  aoi21  g313(.a(new_n469_), .b(new_n339_), .c(new_n470_), .O(new_n471_));
  ...
  aoi21  g332(.a(new_n489_), .b(new_n315_), .c(x038), .O(new_n490_));
  and2   g333(.a(new_n488_), .b(new_n340_), .O(new_n491_));
  ...
  nand2  g337(.a(new_n317_), .b(x030), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n494_), .c(new_n493_), .O(new_n496_));
  nand2  g339(.a(new_n475_), .b(x030), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n329_), .c(new_n304_), .O(new_n498_));
  ...
  nor2   g344(.a(new_n315_), .b(x014), .O(new_n502_));
  nor2   g345(.a(new_n334_), .b(x054), .O(new_n503_));
  aoi22  g346(.a(new_n503_), .b(new_n502_), .c(x054), .d(x038), .O(new_n504_));
  oai21  g347(.a(new_n501_), .b(new_n314_), .c(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n500_), .b(new_n333_), .c(new_n505_), .O(new_n506_));
