...
module FAU ( 
  ...
  nand2  g311(.a(new_n296_), .b(new_n295_), .O(new_n469_));
  aoi21  g312(.a(new_n468_), .b(new_n336_), .c(new_n469_), .O(new_n470_));
  nor2   g313(.a(new_n470_), .b(x070), .O(new_n471_));
  ...
  nor2   g329(.a(x086), .b(x054), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(x030), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n312_), .c(x038), .O(new_n489_));
  and2   g332(.a(new_n487_), .b(new_n337_), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(new_n489_), .c(x070), .O(new_n491_));
  nand2  g334(.a(new_n469_), .b(x022), .O(new_n492_));
  aoi21  g335(.a(new_n474_), .b(new_n468_), .c(new_n469_), .O(new_n493_));
  nand2  g336(.a(new_n314_), .b(x030), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n493_), .c(new_n492_), .O(new_n495_));
  nand2  g338(.a(new_n474_), .b(x030), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n326_), .c(new_n301_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n294_), .c(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(x086), .c(new_n491_), .O(new_n499_));
  aoi21  g342(.a(new_n487_), .b(new_n469_), .c(x078), .O(new_n500_));
  nor2   g343(.a(new_n312_), .b(x014), .O(new_n501_));
  nor2   g344(.a(new_n331_), .b(x054), .O(new_n502_));
  aoi22  g345(.a(new_n502_), .b(new_n501_), .c(x054), .d(x038), .O(new_n503_));
  oai21  g346(.a(new_n500_), .b(new_n311_), .c(new_n503_), .O(new_n504_));
  aoi21  g347(.a(new_n499_), .b(new_n330_), .c(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n486_), .c(x046), .O(z14));
  zero   g349(.O(z07));
  zero   g350(.O(z15));
  zero   g351(.O(z16));
  zero   g352(.O(z17));
