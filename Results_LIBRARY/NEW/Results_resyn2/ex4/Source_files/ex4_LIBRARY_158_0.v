// Benchmark "FAU" written by ABC on Tue Jul 28 07:05:10 2020
...
module FAU ( 
  ...
  nor2   g080(.a(x085), .b(new_n236_), .O(new_n237_));
  nand2  g081(.a(new_n237_), .b(x013), .O(new_n238_));
  inv1   g082(.a(x101), .O(new_n239_));
  nand2  g083(.a(new_n239_), .b(x061), .O(new_n240_));
  nand3  g084(.a(new_n240_), .b(x117), .c(x109), .O(new_n241_));
  ...
  oai21  g093(.a(new_n249_), .b(new_n247_), .c(x069), .O(new_n250_));
  ...
  nor2   g101(.a(new_n242_), .b(new_n253_), .O(new_n258_));
  ...
  nand4  g104(.a(new_n243_), .b(x061), .c(x037), .d(new_n253_), .O(new_n261_));
  inv1   g105(.a(new_n261_), .O(new_n262_));
  aoi21  g106(.a(new_n260_), .b(x077), .c(new_n262_), .O(new_n263_));
  oai21  g107(.a(new_n263_), .b(new_n235_), .c(new_n238_), .O(new_n264_));
  nand2  g108(.a(new_n264_), .b(new_n234_), .O(new_n265_));
  inv1   g109(.a(x077), .O(new_n266_));
  inv1   g110(.a(new_n255_), .O(new_n267_));
  inv1   g111(.a(x029), .O(new_n268_));
  nand2  g112(.a(new_n254_), .b(new_n268_), .O(new_n269_));
  aoi21  g113(.a(new_n269_), .b(new_n267_), .c(x037), .O(new_n270_));
  nand2  g114(.a(x125), .b(x101), .O(new_n271_));
  inv1   g115(.a(x061), .O(new_n272_));
  nand2  g116(.a(new_n248_), .b(new_n272_), .O(new_n273_));
  nand3  g117(.a(new_n273_), .b(new_n257_), .c(new_n271_), .O(new_n274_));
  inv1   g118(.a(x069), .O(new_n275_));
  nor2   g119(.a(x029), .b(new_n253_), .O(new_n276_));
  oai21  g120(.a(new_n276_), .b(new_n255_), .c(new_n275_), .O(new_n277_));
  nand3  g121(.a(new_n273_), .b(new_n247_), .c(new_n268_), .O(new_n278_));
  nand3  g122(.a(new_n278_), .b(new_n277_), .c(new_n274_), .O(new_n279_));
  aoi21  g123(.a(new_n279_), .b(x053), .c(new_n270_), .O(new_n280_));
  nand2  g124(.a(x021), .b(x013), .O(new_n281_));
  nand3  g125(.a(new_n281_), .b(new_n247_), .c(x053), .O(new_n282_));
  oai21  g126(.a(new_n280_), .b(new_n266_), .c(new_n282_), .O(new_n283_));
  nand2  g127(.a(new_n236_), .b(new_n252_), .O(new_n284_));
  nand3  g128(.a(new_n284_), .b(new_n275_), .c(new_n253_), .O(new_n285_));
  aoi22  g129(.a(new_n266_), .b(new_n252_), .c(new_n235_), .d(new_n236_), .O(new_n286_));
  nand2  g130(.a(new_n286_), .b(new_n285_), .O(new_n287_));
  aoi21  g131(.a(new_n283_), .b(x085), .c(new_n287_), .O(new_n288_));
  aoi21  g132(.a(new_n288_), .b(new_n265_), .c(new_n233_), .O(z05));
  inv1   g133(.a(x046), .O(new_n290_));
  inv1   g134(.a(x006), .O(new_n291_));
  inv1   g135(.a(x054), .O(new_n292_));
  nand2  g136(.a(x118), .b(x110), .O(new_n293_));
  ...
  nand3  g144(.a(new_n300_), .b(new_n299_), .c(x110), .O(new_n301_));
  nand2  g145(.a(new_n301_), .b(new_n298_), .O(new_n302_));
  nand2  g146(.a(new_n302_), .b(new_n297_), .O(new_n303_));
  inv1   g147(.a(x094), .O(new_n304_));
  aoi21  g148(.a(x126), .b(x102), .c(new_n304_), .O(new_n305_));
  oai21  g149(.a(new_n305_), .b(new_n293_), .c(x070), .O(new_n306_));
  ...
  nor2   g157(.a(new_n299_), .b(new_n309_), .O(new_n314_));
  aoi21  g158(.a(new_n314_), .b(new_n300_), .c(new_n313_), .O(new_n315_));
  nand4  g159(.a(new_n315_), .b(new_n312_), .c(new_n306_), .d(new_n303_), .O(new_n316_));
  nand4  g160(.a(new_n300_), .b(x062), .c(x038), .d(new_n308_), .O(new_n317_));
  ...
  oai21  g164(.a(new_n319_), .b(new_n292_), .c(new_n320_), .O(new_n321_));
  ...
  nand4  g178(.a(new_n334_), .b(new_n310_), .c(new_n332_), .d(new_n331_), .O(new_n335_));
  ...
  aoi22  g189(.a(new_n327_), .b(new_n308_), .c(new_n292_), .d(new_n298_), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n345_), .O(new_n347_));
  aoi21  g191(.a(new_n340_), .b(x086), .c(new_n347_), .O(new_n348_));
  aoi21  g192(.a(new_n348_), .b(new_n322_), .c(new_n290_), .O(z06));
  ...
  aoi21  g199(.a(new_n356_), .b(new_n355_), .c(x064), .O(new_n357_));
  ...
  nand2  g204(.a(new_n351_), .b(new_n361_), .O(new_n362_));
  oai21  g205(.a(new_n362_), .b(x024), .c(new_n360_), .O(new_n363_));
  oai21  g206(.a(new_n353_), .b(x104), .c(x032), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(x112), .O(new_n365_));
  inv1   g208(.a(x104), .O(new_n366_));
  oai21  g209(.a(new_n352_), .b(x056), .c(new_n366_), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n160_), .O(new_n368_));
  nand4  g211(.a(new_n368_), .b(new_n365_), .c(new_n363_), .d(new_n359_), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(new_n357_), .c(new_n167_), .O(new_n370_));
  nand4  g213(.a(x120), .b(new_n361_), .c(new_n160_), .d(x008), .O(new_n371_));
  aoi21  g214(.a(new_n371_), .b(new_n370_), .c(x048), .O(new_n372_));
  nand3  g215(.a(x080), .b(new_n160_), .c(new_n165_), .O(new_n373_));
  inv1   g216(.a(new_n373_), .O(new_n374_));
  oai21  g217(.a(new_n374_), .b(new_n372_), .c(x000), .O(new_n375_));
  inv1   g218(.a(x080), .O(new_n376_));
  ...
  nand2  g223(.a(new_n380_), .b(new_n167_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n165_), .c(new_n356_), .O(new_n382_));
  inv1   g225(.a(x024), .O(new_n383_));
  nor2   g226(.a(new_n383_), .b(x016), .O(new_n384_));
  oai21  g227(.a(new_n384_), .b(new_n362_), .c(x064), .O(new_n385_));
  aoi21  g228(.a(x016), .b(x008), .c(new_n383_), .O(new_n386_));
  nand3  g229(.a(new_n378_), .b(new_n386_), .c(new_n354_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n385_), .c(x072), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n382_), .c(new_n166_), .O(new_n389_));
  nor2   g232(.a(x072), .b(new_n160_), .O(new_n390_));
  oai21  g233(.a(new_n362_), .b(new_n386_), .c(new_n390_), .O(new_n391_));
  ...
  nand2  g237(.a(x072), .b(x008), .O(new_n395_));
  nand3  g238(.a(new_n395_), .b(new_n394_), .c(new_n159_), .O(new_n396_));
  aoi21  g239(.a(new_n392_), .b(new_n376_), .c(new_n396_), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n375_), .c(x040), .O(z08));
  oai22  g241(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(x065), .c(x017), .O(new_n400_));
  oai21  g243(.a(x073), .b(x049), .c(new_n182_), .O(new_n401_));
  nor2   g244(.a(new_n174_), .b(new_n173_), .O(new_n402_));
  oai22  g245(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n403_));
  ...
  oai21  g250(.a(x074), .b(x050), .c(new_n197_), .O(new_n408_));
  nor2   g251(.a(new_n189_), .b(new_n188_), .O(new_n409_));
  oai22  g252(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n410_));
  ...
  oai21  g257(.a(x075), .b(x051), .c(new_n212_), .O(new_n415_));
  nor2   g258(.a(new_n204_), .b(new_n203_), .O(new_n416_));
  oai22  g259(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n417_));
  aoi21  g260(.a(new_n416_), .b(new_n415_), .c(new_n417_), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n414_), .c(x043), .O(z11));
  oai22  g262(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(x068), .c(x020), .O(new_n421_));
  oai21  g264(.a(x076), .b(x052), .c(new_n227_), .O(new_n422_));
  nor2   g265(.a(new_n219_), .b(new_n218_), .O(new_n423_));
  oai22  g266(.a(new_n223_), .b(new_n220_), .c(new_n222_), .d(new_n221_), .O(new_n424_));
  aoi21  g267(.a(new_n423_), .b(new_n422_), .c(new_n424_), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n421_), .c(x044), .O(z12));
  aoi22  g269(.a(new_n248_), .b(new_n275_), .c(new_n272_), .d(new_n236_), .O(new_n427_));
  nand2  g270(.a(x029), .b(new_n252_), .O(new_n428_));
  nand2  g271(.a(new_n255_), .b(new_n251_), .O(new_n429_));
  oai22  g272(.a(new_n429_), .b(new_n428_), .c(new_n427_), .d(new_n234_), .O(new_n430_));
  oai21  g273(.a(x125), .b(x101), .c(new_n430_), .O(new_n431_));
  nand2  g274(.a(new_n428_), .b(new_n251_), .O(new_n432_));
  inv1   g275(.a(x109), .O(new_n433_));
  aoi21  g276(.a(new_n242_), .b(new_n433_), .c(x085), .O(new_n434_));
  aoi21  g277(.a(new_n432_), .b(x005), .c(new_n434_), .O(new_n435_));
  aoi21  g278(.a(new_n435_), .b(new_n431_), .c(x053), .O(new_n436_));
  nand3  g279(.a(new_n235_), .b(new_n252_), .c(x005), .O(new_n437_));
  inv1   g280(.a(new_n437_), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(new_n237_), .c(new_n273_), .O(new_n439_));
  inv1   g282(.a(new_n428_), .O(new_n440_));
  aoi22  g283(.a(new_n440_), .b(new_n237_), .c(x069), .d(new_n236_), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n439_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n436_), .c(new_n266_), .O(new_n443_));
  nand3  g286(.a(x069), .b(new_n235_), .c(x021), .O(new_n444_));
  nand3  g287(.a(x085), .b(new_n236_), .c(x005), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  oai22  g289(.a(new_n266_), .b(new_n252_), .c(new_n235_), .d(new_n236_), .O(new_n447_));
  aoi21  g290(.a(new_n446_), .b(new_n252_), .c(new_n447_), .O(new_n448_));
  aoi21  g291(.a(new_n448_), .b(new_n443_), .c(x045), .O(z13));
  nand2  g292(.a(new_n300_), .b(new_n295_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n304_), .O(new_n451_));
  ...
  oai21  g299(.a(new_n334_), .b(x030), .c(new_n456_), .O(new_n457_));
  oai21  g300(.a(new_n300_), .b(x110), .c(x038), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(x118), .O(new_n459_));
  inv1   g302(.a(x110), .O(new_n460_));
  oai21  g303(.a(new_n295_), .b(x062), .c(new_n460_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n298_), .O(new_n462_));
  nand4  g305(.a(new_n462_), .b(new_n459_), .c(new_n457_), .d(new_n455_), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n453_), .c(new_n327_), .O(new_n464_));
  nand4  g307(.a(x126), .b(new_n333_), .c(new_n298_), .d(x014), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n464_), .c(x054), .O(new_n466_));
  nand3  g309(.a(x086), .b(new_n298_), .c(new_n308_), .O(new_n467_));
  inv1   g310(.a(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(new_n466_), .c(x006), .O(new_n469_));
  nand2  g312(.a(new_n311_), .b(x030), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n309_), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n327_), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n308_), .c(new_n452_), .O(new_n473_));
  nor2   g316(.a(new_n331_), .b(x022), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n334_), .c(x070), .O(new_n475_));
  nand4  g318(.a(new_n456_), .b(new_n450_), .c(new_n311_), .d(x030), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n475_), .c(x078), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n473_), .c(new_n292_), .O(new_n478_));
  nand2  g321(.a(new_n456_), .b(x030), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n323_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n327_), .c(x038), .O(new_n481_));
  ...
  nand3  g328(.a(new_n485_), .b(new_n484_), .c(new_n342_), .O(new_n486_));
