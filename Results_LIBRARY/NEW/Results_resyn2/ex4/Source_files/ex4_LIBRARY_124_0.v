// Benchmark "FAU" written by ABC on Tue Jul 28 07:04:39 2020
...
module FAU ( 
  ...
  oai21  g143(.a(x102), .b(new_n297_), .c(new_n299_), .O(new_n300_));
  ...
  oai21  g152(.a(new_n308_), .b(new_n298_), .c(x070), .O(new_n309_));
  ...
  aoi22  g161(.a(new_n317_), .b(new_n303_), .c(new_n313_), .d(new_n316_), .O(new_n318_));
  ...
  oai21  g167(.a(new_n322_), .b(new_n296_), .c(new_n323_), .O(new_n324_));
  nand2  g168(.a(new_n324_), .b(new_n295_), .O(new_n325_));
  inv1   g169(.a(x070), .O(new_n326_));
  nand3  g170(.a(x086), .b(x054), .c(new_n316_), .O(new_n327_));
  aoi21  g171(.a(new_n327_), .b(x022), .c(new_n301_), .O(new_n328_));
  inv1   g172(.a(new_n314_), .O(new_n329_));
  nand2  g173(.a(x086), .b(x054), .O(new_n330_));
  nor2   g174(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  oai21  g175(.a(new_n331_), .b(new_n328_), .c(new_n326_), .O(new_n332_));
  nand2  g176(.a(new_n298_), .b(new_n312_), .O(new_n333_));
  nand2  g177(.a(x126), .b(x102), .O(new_n334_));
  aoi21  g178(.a(new_n313_), .b(new_n334_), .c(new_n298_), .O(new_n335_));
  nand2  g179(.a(new_n307_), .b(new_n297_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(new_n316_), .O(new_n337_));
  oai21  g181(.a(new_n337_), .b(new_n335_), .c(new_n333_), .O(new_n338_));
  nand2  g182(.a(new_n313_), .b(new_n316_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n329_), .c(x038), .O(new_n340_));
  aoi21  g184(.a(new_n338_), .b(x054), .c(new_n340_), .O(new_n341_));
  oai21  g185(.a(new_n341_), .b(new_n310_), .c(new_n332_), .O(new_n342_));
  oai21  g186(.a(new_n330_), .b(new_n299_), .c(x078), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(new_n311_), .O(new_n344_));
  nor2   g188(.a(x022), .b(new_n311_), .O(new_n345_));
  nor2   g189(.a(x070), .b(new_n296_), .O(new_n346_));
  aoi22  g190(.a(new_n346_), .b(new_n345_), .c(new_n296_), .d(new_n301_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  aoi21  g192(.a(new_n342_), .b(x078), .c(new_n348_), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n325_), .c(new_n294_), .O(z06));
  ...
  nor2   g209(.a(new_n353_), .b(x056), .O(new_n367_));
  oai21  g210(.a(new_n367_), .b(x104), .c(new_n160_), .O(new_n368_));
  nand4  g211(.a(new_n368_), .b(new_n366_), .c(new_n364_), .d(new_n360_), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(new_n358_), .c(new_n167_), .O(new_n370_));
  nand4  g213(.a(x120), .b(new_n362_), .c(new_n160_), .d(x008), .O(new_n371_));
  ...
  aoi21  g220(.a(x088), .b(x056), .c(new_n377_), .O(new_n378_));
  oai21  g221(.a(new_n378_), .b(x016), .c(new_n167_), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n165_), .c(new_n357_), .O(new_n380_));
  nor2   g223(.a(new_n377_), .b(x016), .O(new_n381_));
  oai21  g224(.a(new_n381_), .b(new_n363_), .c(x064), .O(new_n382_));
  aoi21  g225(.a(x016), .b(x008), .c(new_n377_), .O(new_n383_));
  nand2  g226(.a(x088), .b(x056), .O(new_n384_));
  nand3  g227(.a(new_n384_), .b(new_n383_), .c(new_n355_), .O(new_n385_));
  aoi21  g228(.a(new_n385_), .b(new_n382_), .c(x072), .O(new_n386_));
  oai21  g229(.a(new_n386_), .b(new_n380_), .c(new_n166_), .O(new_n387_));
  nor2   g230(.a(x072), .b(new_n160_), .O(new_n388_));
  oai21  g231(.a(new_n363_), .b(new_n383_), .c(new_n388_), .O(new_n389_));
  ...
  aoi21  g237(.a(new_n390_), .b(new_n376_), .c(new_n394_), .O(new_n395_));
  aoi21  g238(.a(new_n395_), .b(new_n375_), .c(x040), .O(z08));
  ...
  nand2  g267(.a(new_n243_), .b(new_n239_), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n277_), .O(new_n426_));
  nor2   g269(.a(x117), .b(x109), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n426_), .c(x069), .O(new_n428_));
  nor2   g271(.a(x117), .b(x021), .O(new_n429_));
  aoi21  g272(.a(new_n429_), .b(x125), .c(x085), .O(new_n430_));
  nand2  g273(.a(x021), .b(x013), .O(new_n431_));
  oai21  g274(.a(new_n278_), .b(x029), .c(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n243_), .b(x109), .c(x037), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(x117), .O(new_n434_));
  oai21  g277(.a(new_n239_), .b(x061), .c(new_n236_), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n242_), .O(new_n436_));
  nand4  g279(.a(new_n436_), .b(new_n434_), .c(new_n432_), .d(new_n430_), .O(new_n437_));
  oai21  g280(.a(new_n437_), .b(new_n428_), .c(new_n271_), .O(new_n438_));
  nand4  g281(.a(x125), .b(new_n276_), .c(new_n242_), .d(x013), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n438_), .c(x053), .O(new_n440_));
  nand3  g283(.a(x085), .b(new_n242_), .c(new_n252_), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n440_), .c(x005), .O(new_n443_));
  nand2  g286(.a(new_n255_), .b(x029), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n253_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n271_), .O(new_n446_));
  aoi21  g289(.a(new_n446_), .b(new_n252_), .c(new_n427_), .O(new_n447_));
  nor2   g290(.a(new_n275_), .b(x021), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(new_n278_), .c(x069), .O(new_n449_));
  nand4  g292(.a(new_n431_), .b(new_n425_), .c(new_n255_), .d(x029), .O(new_n450_));
  aoi21  g293(.a(new_n450_), .b(new_n449_), .c(x077), .O(new_n451_));
  oai21  g294(.a(new_n451_), .b(new_n447_), .c(new_n235_), .O(new_n452_));
  nand2  g295(.a(new_n431_), .b(x029), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n267_), .O(new_n454_));
  nand3  g297(.a(new_n454_), .b(new_n271_), .c(x037), .O(new_n455_));
  ...
  nand2  g301(.a(x077), .b(x013), .O(new_n459_));
  nand3  g302(.a(new_n459_), .b(new_n458_), .c(new_n286_), .O(new_n460_));
  aoi21  g303(.a(new_n456_), .b(new_n251_), .c(new_n460_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n443_), .c(x045), .O(z13));
  inv1   g305(.a(x110), .O(new_n463_));
  nand2  g306(.a(new_n302_), .b(new_n463_), .O(new_n464_));
  nand2  g307(.a(new_n314_), .b(x030), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n312_), .c(x078), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x014), .c(new_n464_), .O(new_n467_));
  inv1   g310(.a(x078), .O(new_n468_));
  aoi21  g311(.a(x030), .b(new_n312_), .c(new_n336_), .O(new_n469_));
  nor2   g312(.a(new_n469_), .b(new_n326_), .O(new_n470_));
  nand2  g313(.a(x022), .b(x014), .O(new_n471_));
  inv1   g314(.a(x102), .O(new_n472_));
  nand2  g315(.a(new_n303_), .b(new_n472_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n471_), .O(new_n474_));
  nor2   g317(.a(new_n474_), .b(new_n465_), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n470_), .c(new_n468_), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n467_), .c(x054), .O(new_n477_));
  aoi21  g320(.a(new_n471_), .b(x030), .c(new_n336_), .O(new_n478_));
  nor3   g321(.a(new_n478_), .b(x078), .c(new_n301_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(new_n477_), .c(new_n310_), .O(new_n480_));
  nand2  g323(.a(x070), .b(x038), .O(new_n481_));
  aoi22  g324(.a(new_n481_), .b(new_n464_), .c(new_n471_), .d(x030), .O(new_n482_));
  nor2   g325(.a(x118), .b(x022), .O(new_n483_));
  nor2   g326(.a(x094), .b(x070), .O(new_n484_));
  aoi22  g327(.a(new_n484_), .b(new_n473_), .c(new_n483_), .d(x126), .O(new_n485_));
  oai22  g328(.a(new_n303_), .b(new_n307_), .c(new_n472_), .d(x038), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n297_), .O(new_n487_));
  aoi21  g330(.a(new_n471_), .b(new_n336_), .c(x086), .O(new_n488_));
  nand4  g331(.a(new_n488_), .b(new_n487_), .c(new_n485_), .d(new_n482_), .O(new_n489_));
  nand4  g332(.a(x126), .b(new_n463_), .c(x038), .d(new_n311_), .O(new_n490_));
  inv1   g333(.a(new_n490_), .O(new_n491_));
  aoi21  g334(.a(new_n489_), .b(new_n296_), .c(new_n491_), .O(new_n492_));
  nand3  g335(.a(x086), .b(new_n301_), .c(new_n311_), .O(new_n493_));
  oai21  g336(.a(new_n492_), .b(x078), .c(new_n493_), .O(new_n494_));
  ...
  aoi21  g341(.a(new_n494_), .b(x006), .c(new_n498_), .O(new_n499_));
