// Benchmark "FAU" written by ABC on Tue Jul 28 07:02:48 2020
...
module FAU ( 
  ...
  nand2  g081(.a(new_n237_), .b(x029), .O(new_n238_));
  nand2  g082(.a(new_n238_), .b(new_n235_), .O(new_n239_));
  inv1   g083(.a(x125), .O(new_n240_));
  nand3  g084(.a(x117), .b(x109), .c(x101), .O(new_n241_));
  nor2   g085(.a(x093), .b(x061), .O(new_n242_));
  nor2   g086(.a(new_n242_), .b(x029), .O(new_n243_));
  oai21  g087(.a(new_n241_), .b(new_n240_), .c(new_n243_), .O(new_n244_));
  aoi21  g088(.a(new_n244_), .b(new_n239_), .c(new_n234_), .O(new_n245_));
  aoi21  g089(.a(x117), .b(x109), .c(x013), .O(new_n246_));
  oai21  g090(.a(new_n246_), .b(new_n245_), .c(x053), .O(new_n247_));
  inv1   g091(.a(x037), .O(new_n248_));
  nand3  g092(.a(new_n238_), .b(x077), .c(new_n248_), .O(new_n249_));
  nand2  g093(.a(new_n249_), .b(new_n247_), .O(new_n250_));
  nand2  g094(.a(new_n250_), .b(x085), .O(new_n251_));
  inv1   g095(.a(new_n238_), .O(new_n252_));
  oai21  g096(.a(x069), .b(x037), .c(new_n241_), .O(new_n253_));
  inv1   g097(.a(x109), .O(new_n254_));
  inv1   g098(.a(x117), .O(new_n255_));
  nand2  g099(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand2  g100(.a(new_n256_), .b(new_n240_), .O(new_n257_));
  nand4  g101(.a(new_n257_), .b(new_n253_), .c(new_n252_), .d(x085), .O(new_n258_));
  nand2  g102(.a(x077), .b(x053), .O(new_n259_));
  inv1   g103(.a(x085), .O(new_n260_));
  nand3  g104(.a(new_n260_), .b(x037), .c(x013), .O(new_n261_));
  aoi21  g105(.a(new_n261_), .b(new_n259_), .c(x005), .O(new_n262_));
  inv1   g106(.a(x021), .O(new_n263_));
  nand3  g107(.a(new_n235_), .b(x053), .c(new_n263_), .O(new_n264_));
  inv1   g108(.a(x053), .O(new_n265_));
  nand2  g109(.a(new_n265_), .b(new_n248_), .O(new_n266_));
  inv1   g110(.a(x013), .O(new_n267_));
  nand2  g111(.a(new_n234_), .b(new_n267_), .O(new_n268_));
  nand3  g112(.a(new_n268_), .b(new_n266_), .c(new_n264_), .O(new_n269_));
  aoi21  g113(.a(new_n262_), .b(new_n258_), .c(new_n269_), .O(new_n270_));
  aoi21  g114(.a(new_n270_), .b(new_n251_), .c(new_n233_), .O(z05));
  ...
  inv1   g120(.a(x102), .O(new_n277_));
  nand2  g121(.a(new_n277_), .b(x062), .O(new_n278_));
  nand2  g122(.a(new_n278_), .b(new_n276_), .O(new_n279_));
  inv1   g123(.a(x038), .O(new_n280_));
  inv1   g124(.a(x118), .O(new_n281_));
  inv1   g125(.a(x126), .O(new_n282_));
  nand3  g126(.a(new_n282_), .b(new_n281_), .c(x110), .O(new_n283_));
  nand2  g127(.a(new_n283_), .b(new_n280_), .O(new_n284_));
  nand2  g128(.a(new_n284_), .b(new_n279_), .O(new_n285_));
  inv1   g129(.a(x094), .O(new_n286_));
  aoi21  g130(.a(x126), .b(x102), .c(new_n286_), .O(new_n287_));
  oai21  g131(.a(new_n287_), .b(new_n275_), .c(x070), .O(new_n288_));
  ...
  aoi21  g137(.a(new_n293_), .b(new_n292_), .c(new_n289_), .O(new_n294_));
  aoi21  g138(.a(new_n291_), .b(new_n290_), .c(x030), .O(new_n295_));
  nor2   g139(.a(new_n281_), .b(new_n291_), .O(new_n296_));
  aoi21  g140(.a(new_n296_), .b(new_n282_), .c(new_n295_), .O(new_n297_));
  nand4  g141(.a(new_n297_), .b(new_n294_), .c(new_n288_), .d(new_n285_), .O(new_n298_));
  nand4  g142(.a(new_n282_), .b(x062), .c(x038), .d(new_n290_), .O(new_n299_));
  inv1   g143(.a(new_n299_), .O(new_n300_));
  aoi21  g144(.a(new_n298_), .b(x078), .c(new_n300_), .O(new_n301_));
  nand3  g145(.a(new_n289_), .b(x038), .c(x014), .O(new_n302_));
  oai21  g146(.a(new_n301_), .b(new_n274_), .c(new_n302_), .O(new_n303_));
  ...
  aoi21  g151(.a(new_n307_), .b(x014), .c(new_n276_), .O(new_n308_));
  inv1   g152(.a(x078), .O(new_n309_));
  inv1   g153(.a(x070), .O(new_n310_));
  nor2   g154(.a(x030), .b(new_n291_), .O(new_n311_));
  oai21  g155(.a(new_n311_), .b(new_n293_), .c(new_n310_), .O(new_n312_));
  inv1   g156(.a(x030), .O(new_n313_));
  nand2  g157(.a(x126), .b(x102), .O(new_n314_));
  inv1   g158(.a(x062), .O(new_n315_));
  nand2  g159(.a(new_n286_), .b(new_n315_), .O(new_n316_));
  nand4  g160(.a(new_n316_), .b(new_n292_), .c(new_n314_), .d(new_n313_), .O(new_n317_));
  aoi21  g161(.a(new_n317_), .b(new_n312_), .c(new_n309_), .O(new_n318_));
  oai21  g162(.a(new_n318_), .b(new_n308_), .c(x054), .O(new_n319_));
  nor2   g163(.a(new_n309_), .b(x038), .O(new_n320_));
  oai21  g164(.a(new_n295_), .b(new_n293_), .c(new_n320_), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(new_n319_), .O(new_n322_));
  nand2  g166(.a(x078), .b(x038), .O(new_n323_));
  nand2  g167(.a(x054), .b(x038), .O(new_n324_));
  nand2  g168(.a(new_n280_), .b(x014), .O(new_n325_));
  nand3  g169(.a(new_n325_), .b(new_n324_), .c(new_n323_), .O(new_n326_));
  nand3  g170(.a(new_n326_), .b(new_n310_), .c(new_n291_), .O(new_n327_));
  aoi22  g171(.a(new_n309_), .b(new_n290_), .c(new_n274_), .d(new_n280_), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  aoi21  g173(.a(new_n322_), .b(x086), .c(new_n329_), .O(new_n330_));
  aoi21  g174(.a(new_n330_), .b(new_n304_), .c(new_n272_), .O(z06));
  ...
  nand2  g186(.a(new_n333_), .b(new_n343_), .O(new_n344_));
  ...
  nand2  g192(.a(new_n349_), .b(new_n160_), .O(new_n350_));
  nand4  g193(.a(new_n350_), .b(new_n347_), .c(new_n345_), .d(new_n341_), .O(new_n351_));
  oai21  g194(.a(new_n351_), .b(new_n339_), .c(new_n167_), .O(new_n352_));
  nand4  g195(.a(x120), .b(new_n343_), .c(new_n160_), .d(x008), .O(new_n353_));
  aoi21  g196(.a(new_n353_), .b(new_n352_), .c(x048), .O(new_n354_));
  nand3  g197(.a(x080), .b(new_n160_), .c(new_n165_), .O(new_n355_));
  ...
  nand2  g205(.a(new_n362_), .b(new_n167_), .O(new_n363_));
  aoi21  g206(.a(new_n363_), .b(new_n165_), .c(new_n338_), .O(new_n364_));
  inv1   g207(.a(x024), .O(new_n365_));
  nor2   g208(.a(new_n365_), .b(x016), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(new_n344_), .c(x064), .O(new_n367_));
  aoi21  g210(.a(x016), .b(x008), .c(new_n365_), .O(new_n368_));
  nand3  g211(.a(new_n360_), .b(new_n368_), .c(new_n336_), .O(new_n369_));
  aoi21  g212(.a(new_n369_), .b(new_n367_), .c(x072), .O(new_n370_));
  oai21  g213(.a(new_n370_), .b(new_n364_), .c(new_n166_), .O(new_n371_));
  nor2   g214(.a(x072), .b(new_n160_), .O(new_n372_));
  oai21  g215(.a(new_n344_), .b(new_n368_), .c(new_n372_), .O(new_n373_));
  ...
  nand2  g219(.a(x072), .b(x008), .O(new_n377_));
  nand3  g220(.a(new_n377_), .b(new_n376_), .c(new_n159_), .O(new_n378_));
  ...
  oai21  g225(.a(x073), .b(x049), .c(new_n182_), .O(new_n383_));
  nor2   g226(.a(new_n174_), .b(new_n173_), .O(new_n384_));
  oai22  g227(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n385_));
  ...
  oai21  g232(.a(x074), .b(x050), .c(new_n197_), .O(new_n390_));
  nor2   g233(.a(new_n189_), .b(new_n188_), .O(new_n391_));
  oai22  g234(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n392_));
  ...
  oai21  g239(.a(x075), .b(x051), .c(new_n212_), .O(new_n397_));
  nor2   g240(.a(new_n204_), .b(new_n203_), .O(new_n398_));
  oai22  g241(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n399_));
  ...
  oai21  g246(.a(x076), .b(x052), .c(new_n227_), .O(new_n404_));
  nor2   g247(.a(new_n219_), .b(new_n218_), .O(new_n405_));
  oai22  g248(.a(new_n223_), .b(new_n220_), .c(new_n222_), .d(new_n221_), .O(new_n406_));
  aoi21  g249(.a(new_n405_), .b(new_n404_), .c(new_n406_), .O(new_n407_));
  aoi21  g250(.a(new_n407_), .b(new_n403_), .c(x044), .O(z12));
  nor2   g251(.a(new_n240_), .b(x109), .O(new_n409_));
  nand2  g252(.a(x069), .b(x037), .O(new_n410_));
  oai21  g253(.a(new_n410_), .b(new_n409_), .c(new_n256_), .O(new_n411_));
  inv1   g254(.a(x061), .O(new_n412_));
  inv1   g255(.a(x101), .O(new_n413_));
  nand2  g256(.a(x125), .b(x093), .O(new_n414_));
  oai21  g257(.a(new_n413_), .b(x037), .c(new_n414_), .O(new_n415_));
  nand2  g258(.a(new_n415_), .b(new_n412_), .O(new_n416_));
  nand2  g259(.a(new_n240_), .b(new_n413_), .O(new_n417_));
  nor2   g260(.a(x093), .b(x069), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n417_), .c(x085), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(new_n416_), .c(new_n411_), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n234_), .O(new_n421_));
  oai21  g264(.a(x077), .b(x013), .c(x021), .O(new_n422_));
  inv1   g265(.a(x029), .O(new_n423_));
  nand3  g266(.a(x125), .b(new_n255_), .c(new_n263_), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(new_n242_), .c(new_n423_), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n422_), .O(new_n426_));
  aoi21  g269(.a(new_n426_), .b(new_n421_), .c(x053), .O(new_n427_));
  nand3  g270(.a(x085), .b(new_n248_), .c(new_n267_), .O(new_n428_));
  inv1   g271(.a(new_n428_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(new_n427_), .c(x005), .O(new_n430_));
  aoi21  g273(.a(new_n236_), .b(x029), .c(x021), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(x077), .c(new_n267_), .O(new_n432_));
  nand2  g275(.a(new_n422_), .b(x029), .O(new_n433_));
  nand2  g276(.a(new_n417_), .b(new_n236_), .O(new_n434_));
  nor2   g277(.a(new_n434_), .b(new_n433_), .O(new_n435_));
  aoi21  g278(.a(new_n432_), .b(new_n256_), .c(new_n435_), .O(new_n436_));
  oai21  g279(.a(new_n242_), .b(x077), .c(new_n433_), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(x037), .O(new_n438_));
  oai21  g281(.a(new_n436_), .b(x053), .c(new_n438_), .O(new_n439_));
  nand2  g282(.a(new_n248_), .b(x029), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n242_), .c(x085), .O(new_n441_));
  aoi21  g284(.a(x037), .b(x013), .c(new_n263_), .O(new_n442_));
  nor2   g285(.a(new_n235_), .b(x053), .O(new_n443_));
  oai21  g286(.a(new_n442_), .b(new_n441_), .c(new_n443_), .O(new_n444_));
  nand2  g287(.a(x069), .b(x021), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(x077), .c(new_n248_), .O(new_n446_));
  aoi22  g289(.a(new_n446_), .b(x053), .c(x077), .d(x013), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n444_), .O(new_n448_));
  aoi21  g291(.a(new_n439_), .b(new_n260_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n430_), .c(x045), .O(z13));
  nand2  g293(.a(new_n282_), .b(new_n277_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n286_), .O(new_n452_));
  nor2   g295(.a(x118), .b(x110), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n452_), .c(x070), .O(new_n454_));
  nor2   g297(.a(x118), .b(x022), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(x126), .c(x086), .O(new_n456_));
  nand2  g299(.a(x022), .b(x014), .O(new_n457_));
  oai21  g300(.a(new_n316_), .b(x030), .c(new_n457_), .O(new_n458_));
  oai21  g301(.a(new_n282_), .b(x110), .c(x038), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(x118), .O(new_n460_));
  inv1   g303(.a(x110), .O(new_n461_));
  oai21  g304(.a(new_n277_), .b(x062), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n280_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n460_), .c(new_n458_), .d(new_n456_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n454_), .c(new_n309_), .O(new_n465_));
  nand4  g308(.a(x126), .b(new_n315_), .c(new_n280_), .d(x014), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n465_), .c(x054), .O(new_n467_));
  nand3  g310(.a(x086), .b(new_n280_), .c(new_n290_), .O(new_n468_));
  inv1   g311(.a(new_n468_), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n467_), .c(x006), .O(new_n470_));
  nand2  g313(.a(new_n293_), .b(x030), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n291_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n309_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n290_), .c(new_n453_), .O(new_n474_));
  nor2   g317(.a(new_n313_), .b(x022), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n316_), .c(x070), .O(new_n476_));
  nand4  g319(.a(new_n457_), .b(new_n451_), .c(new_n293_), .d(x030), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n476_), .c(x078), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n474_), .c(new_n274_), .O(new_n479_));
  nand2  g322(.a(new_n457_), .b(x030), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n305_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n309_), .c(x038), .O(new_n482_));
  ...
  nand2  g328(.a(x078), .b(x014), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n485_), .c(new_n324_), .O(new_n487_));
  aoi21  g330(.a(new_n483_), .b(new_n289_), .c(new_n487_), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n470_), .c(x046), .O(z14));
  zero   g332(.O(z07));
  zero   g333(.O(z15));
  zero   g334(.O(z16));
  zero   g335(.O(z17));
