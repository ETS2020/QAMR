// Benchmark "FAU" written by ABC on Tue Jul 28 07:05:58 2020
...
module FAU ( 
  ...
  inv1   g147(.a(x118), .O(new_n304_));
  inv1   g148(.a(x126), .O(new_n305_));
  nand3  g149(.a(new_n305_), .b(new_n304_), .c(x110), .O(new_n306_));
  nand2  g150(.a(new_n306_), .b(new_n303_), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(new_n302_), .O(new_n308_));
  inv1   g152(.a(x094), .O(new_n309_));
  aoi21  g153(.a(x126), .b(x102), .c(new_n309_), .O(new_n310_));
  oai21  g154(.a(new_n310_), .b(new_n298_), .c(x070), .O(new_n311_));
  ...
  nor2   g162(.a(new_n304_), .b(new_n314_), .O(new_n319_));
  aoi22  g163(.a(new_n319_), .b(new_n305_), .c(new_n315_), .d(new_n318_), .O(new_n320_));
  nand4  g164(.a(new_n320_), .b(new_n317_), .c(new_n311_), .d(new_n308_), .O(new_n321_));
  nand4  g165(.a(new_n305_), .b(x062), .c(x038), .d(new_n313_), .O(new_n322_));
  ...
  oai21  g169(.a(new_n324_), .b(new_n297_), .c(new_n325_), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n296_), .O(new_n327_));
  inv1   g171(.a(x070), .O(new_n328_));
  nand3  g172(.a(x086), .b(x054), .c(new_n318_), .O(new_n329_));
  aoi21  g173(.a(new_n329_), .b(x022), .c(new_n303_), .O(new_n330_));
  inv1   g174(.a(new_n316_), .O(new_n331_));
  nand2  g175(.a(x086), .b(x054), .O(new_n332_));
  nor2   g176(.a(new_n332_), .b(new_n331_), .O(new_n333_));
  oai21  g177(.a(new_n333_), .b(new_n330_), .c(new_n328_), .O(new_n334_));
  nand2  g178(.a(new_n298_), .b(new_n314_), .O(new_n335_));
  nand2  g179(.a(x126), .b(x102), .O(new_n336_));
  aoi21  g180(.a(new_n315_), .b(new_n336_), .c(new_n298_), .O(new_n337_));
  inv1   g181(.a(x062), .O(new_n338_));
  nand2  g182(.a(new_n309_), .b(new_n338_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n318_), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n337_), .c(new_n335_), .O(new_n341_));
  nand2  g185(.a(new_n315_), .b(new_n318_), .O(new_n342_));
  aoi21  g186(.a(new_n342_), .b(new_n331_), .c(x038), .O(new_n343_));
  aoi21  g187(.a(new_n341_), .b(x054), .c(new_n343_), .O(new_n344_));
  oai21  g188(.a(new_n344_), .b(new_n312_), .c(new_n334_), .O(new_n345_));
  oai21  g189(.a(new_n332_), .b(new_n299_), .c(x078), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n313_), .O(new_n347_));
  nor2   g191(.a(x022), .b(new_n313_), .O(new_n348_));
  nor2   g192(.a(x070), .b(new_n297_), .O(new_n349_));
  aoi22  g193(.a(new_n349_), .b(new_n348_), .c(new_n297_), .d(new_n303_), .O(new_n350_));
  nand2  g194(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  aoi21  g195(.a(new_n345_), .b(x078), .c(new_n351_), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(new_n327_), .c(new_n295_), .O(z06));
  ...
  nand2  g271(.a(new_n244_), .b(new_n240_), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n278_), .O(new_n430_));
  ...
  oai21  g281(.a(new_n240_), .b(x061), .c(new_n237_), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n243_), .O(new_n440_));
  nand4  g283(.a(new_n440_), .b(new_n438_), .c(new_n436_), .d(new_n434_), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(new_n432_), .c(new_n272_), .O(new_n442_));
  nand4  g285(.a(x125), .b(new_n277_), .c(new_n243_), .d(x013), .O(new_n443_));
  aoi21  g286(.a(new_n443_), .b(new_n442_), .c(x053), .O(new_n444_));
  nand3  g287(.a(x085), .b(new_n243_), .c(new_n253_), .O(new_n445_));
  inv1   g288(.a(new_n445_), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(new_n444_), .c(x005), .O(new_n447_));
  nand2  g290(.a(new_n256_), .b(x029), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n254_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n272_), .O(new_n450_));
  aoi21  g293(.a(new_n450_), .b(new_n253_), .c(new_n431_), .O(new_n451_));
  nor2   g294(.a(new_n276_), .b(x021), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n279_), .c(x069), .O(new_n453_));
  nand4  g296(.a(new_n435_), .b(new_n429_), .c(new_n256_), .d(x029), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n453_), .c(x077), .O(new_n455_));
  oai21  g298(.a(new_n455_), .b(new_n451_), .c(new_n236_), .O(new_n456_));
  nand2  g299(.a(new_n435_), .b(x029), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n268_), .O(new_n458_));
  nand3  g301(.a(new_n458_), .b(new_n272_), .c(x037), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n456_), .O(new_n460_));
  oai22  g303(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n461_));
  nand3  g304(.a(new_n461_), .b(x069), .c(x021), .O(new_n462_));
  nand2  g305(.a(x077), .b(x013), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n462_), .c(new_n287_), .O(new_n464_));
  aoi21  g307(.a(new_n460_), .b(new_n252_), .c(new_n464_), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n447_), .c(x045), .O(z13));
  inv1   g309(.a(x078), .O(new_n467_));
  nand2  g310(.a(new_n305_), .b(new_n300_), .O(new_n468_));
  ...
  oai21  g317(.a(new_n339_), .b(x030), .c(new_n474_), .O(new_n475_));
  oai21  g318(.a(new_n305_), .b(x110), .c(x038), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x118), .O(new_n477_));
  inv1   g320(.a(x110), .O(new_n478_));
  oai21  g321(.a(new_n300_), .b(x062), .c(new_n478_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n303_), .O(new_n480_));
  nand4  g323(.a(new_n480_), .b(new_n477_), .c(new_n475_), .d(new_n473_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n471_), .c(new_n467_), .O(new_n482_));
  nand4  g325(.a(x126), .b(new_n338_), .c(new_n303_), .d(x014), .O(new_n483_));
  ...
  nand2  g332(.a(new_n489_), .b(new_n467_), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n313_), .c(new_n470_), .O(new_n491_));
  nor2   g334(.a(new_n318_), .b(x022), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n339_), .c(x070), .O(new_n493_));
  nand4  g336(.a(new_n474_), .b(new_n468_), .c(new_n316_), .d(x030), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n493_), .c(x078), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n491_), .c(new_n297_), .O(new_n496_));
  aoi21  g339(.a(x022), .b(x014), .c(new_n318_), .O(new_n497_));
  nor2   g340(.a(x078), .b(new_n303_), .O(new_n498_));
  oai21  g341(.a(new_n497_), .b(new_n339_), .c(new_n498_), .O(new_n499_));
