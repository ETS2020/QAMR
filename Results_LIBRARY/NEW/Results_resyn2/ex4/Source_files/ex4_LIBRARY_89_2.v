// Benchmark "FAU" written by ABC on Tue Jul 28 07:04:08 2020
...
module FAU ( 
  ...
  nand2  g212(.a(new_n357_), .b(new_n369_), .O(new_n370_));
  ...
  oai21  g216(.a(new_n358_), .b(x056), .c(new_n361_), .O(new_n374_));
  ...
  oai21  g234(.a(new_n357_), .b(new_n369_), .c(x024), .O(new_n392_));
  ...
  nand2  g274(.a(new_n431_), .b(new_n278_), .O(new_n432_));
  nor2   g275(.a(x117), .b(x109), .O(new_n433_));
  aoi21  g276(.a(new_n433_), .b(new_n432_), .c(x069), .O(new_n434_));
  ...
  nand2  g292(.a(new_n256_), .b(x029), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n254_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n272_), .O(new_n452_));
  aoi21  g295(.a(new_n452_), .b(new_n253_), .c(new_n433_), .O(new_n453_));
  nor2   g296(.a(new_n276_), .b(x021), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n279_), .c(x069), .O(new_n455_));
  nand4  g298(.a(new_n437_), .b(new_n431_), .c(new_n256_), .d(x029), .O(new_n456_));
  ...
  nand3  g303(.a(new_n460_), .b(new_n272_), .c(x037), .O(new_n461_));
  ...
  nand3  g308(.a(new_n465_), .b(new_n464_), .c(new_n287_), .O(new_n466_));
  aoi21  g309(.a(new_n462_), .b(new_n252_), .c(new_n466_), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n449_), .c(x045), .O(z13));
  nand2  g311(.a(new_n305_), .b(new_n301_), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n339_), .O(new_n470_));
  ...
  oai21  g318(.a(new_n340_), .b(x030), .c(new_n475_), .O(new_n476_));
  oai21  g319(.a(new_n305_), .b(x110), .c(x038), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(x118), .O(new_n478_));
  oai21  g321(.a(new_n301_), .b(x062), .c(new_n298_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n304_), .O(new_n480_));
  nand4  g323(.a(new_n480_), .b(new_n478_), .c(new_n476_), .d(new_n474_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n472_), .c(new_n333_), .O(new_n482_));
  nand4  g325(.a(x126), .b(new_n338_), .c(new_n304_), .d(x014), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n482_), .c(x054), .O(new_n484_));
  nand3  g327(.a(x086), .b(new_n304_), .c(new_n314_), .O(new_n485_));
  inv1   g328(.a(new_n485_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n484_), .c(x006), .O(new_n487_));
  nand2  g330(.a(new_n317_), .b(x030), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n315_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n333_), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n314_), .c(new_n471_), .O(new_n491_));
  nor2   g334(.a(new_n337_), .b(x022), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n340_), .c(x070), .O(new_n493_));
  nand4  g336(.a(new_n475_), .b(new_n469_), .c(new_n317_), .d(x030), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n493_), .c(x078), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n491_), .c(new_n297_), .O(new_n496_));
  nand2  g339(.a(new_n475_), .b(x030), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n329_), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n333_), .c(x038), .O(new_n499_));
  ...
  nand3  g346(.a(new_n503_), .b(new_n502_), .c(new_n348_), .O(new_n504_));
  aoi21  g347(.a(new_n500_), .b(new_n313_), .c(new_n504_), .O(new_n505_));
