...
module FAU ( 
  ...
  inv1   g310(.a(x110), .O(new_n468_));
  nand2  g311(.a(new_n303_), .b(new_n468_), .O(new_n469_));
  oai21  g312(.a(new_n327_), .b(new_n302_), .c(new_n469_), .O(new_n470_));
  nand3  g313(.a(x102), .b(new_n327_), .c(new_n337_), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n470_), .c(new_n311_), .O(new_n472_));
  nand2  g315(.a(new_n303_), .b(x022), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(new_n297_), .c(x126), .O(new_n474_));
  oai22  g317(.a(new_n304_), .b(x070), .c(new_n299_), .d(x038), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n308_), .O(new_n476_));
  nand2  g319(.a(x022), .b(x014), .O(new_n477_));
  oai21  g320(.a(new_n338_), .b(x030), .c(new_n477_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n476_), .c(new_n474_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(new_n472_), .c(new_n467_), .O(new_n480_));
  nand4  g323(.a(x126), .b(new_n337_), .c(new_n302_), .d(x014), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n480_), .c(x054), .O(new_n482_));
  nand3  g325(.a(x086), .b(new_n302_), .c(new_n312_), .O(new_n483_));
  ...
  aoi21  g330(.a(new_n487_), .b(new_n313_), .c(x038), .O(new_n488_));
  and2   g331(.a(new_n486_), .b(new_n338_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n488_), .c(x070), .O(new_n490_));
  nand2  g333(.a(new_n469_), .b(x022), .O(new_n491_));
  nand2  g334(.a(new_n304_), .b(new_n299_), .O(new_n492_));
  aoi21  g335(.a(new_n492_), .b(new_n477_), .c(new_n469_), .O(new_n493_));
  nand2  g336(.a(new_n315_), .b(x030), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n493_), .c(new_n491_), .O(new_n495_));
  aoi21  g338(.a(new_n477_), .b(x030), .c(new_n338_), .O(new_n496_));
  nor2   g339(.a(new_n496_), .b(new_n302_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n296_), .c(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(x086), .c(new_n490_), .O(new_n499_));
  aoi21  g342(.a(new_n486_), .b(new_n469_), .c(x078), .O(new_n500_));
  nor2   g343(.a(new_n313_), .b(x014), .O(new_n501_));
  nor2   g344(.a(new_n327_), .b(x054), .O(new_n502_));
  aoi22  g345(.a(new_n502_), .b(new_n501_), .c(x054), .d(x038), .O(new_n503_));
  oai21  g346(.a(new_n500_), .b(new_n312_), .c(new_n503_), .O(new_n504_));
  aoi21  g347(.a(new_n499_), .b(new_n467_), .c(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n485_), .c(x046), .O(z14));
  zero   g349(.O(z07));
  zero   g350(.O(z15));
  zero   g351(.O(z16));
  zero   g352(.O(z17));
