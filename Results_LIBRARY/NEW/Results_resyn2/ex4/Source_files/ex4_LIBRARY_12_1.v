// Benchmark "FAU" written by ABC on Tue Jul 28 07:02:57 2020
...
module FAU ( 
  ...
  nand2  g312(.a(new_n298_), .b(new_n297_), .O(new_n470_));
  aoi21  g313(.a(new_n469_), .b(new_n338_), .c(new_n470_), .O(new_n471_));
  nor2   g314(.a(new_n471_), .b(x070), .O(new_n472_));
  ...
  nor2   g330(.a(x086), .b(x054), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x030), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n314_), .c(x038), .O(new_n490_));
  and2   g333(.a(new_n488_), .b(new_n339_), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n490_), .c(x070), .O(new_n492_));
  nand2  g335(.a(new_n470_), .b(x022), .O(new_n493_));
  aoi21  g336(.a(new_n475_), .b(new_n469_), .c(new_n470_), .O(new_n494_));
  nand2  g337(.a(new_n316_), .b(x030), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n494_), .c(new_n493_), .O(new_n496_));
  nand2  g339(.a(new_n475_), .b(x030), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n328_), .c(new_n303_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n296_), .c(new_n498_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(x086), .c(new_n492_), .O(new_n500_));
  aoi21  g343(.a(new_n488_), .b(new_n470_), .c(x078), .O(new_n501_));
  nor2   g344(.a(new_n314_), .b(x014), .O(new_n502_));
  nor2   g345(.a(new_n333_), .b(x054), .O(new_n503_));
  aoi22  g346(.a(new_n503_), .b(new_n502_), .c(x054), .d(x038), .O(new_n504_));
  oai21  g347(.a(new_n501_), .b(new_n313_), .c(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n500_), .b(new_n332_), .c(new_n505_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n487_), .c(x046), .O(z14));
  zero   g350(.O(z07));
  zero   g351(.O(z15));
  zero   g352(.O(z16));
  zero   g353(.O(z17));
