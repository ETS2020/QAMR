...
module FAU ( 
  ...
  inv1   g209(.a(x088), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n355_), .O(new_n368_));
  ...
  oai21  g214(.a(new_n356_), .b(x088), .c(new_n359_), .O(new_n372_));
  ...
  oai21  g232(.a(new_n367_), .b(new_n355_), .c(x024), .O(new_n390_));
