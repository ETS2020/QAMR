...
module FAU ( 
  ...
  oai21  g145(.a(new_n301_), .b(new_n295_), .c(new_n298_), .O(new_n302_));
  ...
  inv1   g151(.a(new_n298_), .O(new_n308_));
  aoi21  g152(.a(new_n308_), .b(x038), .c(new_n307_), .O(new_n309_));
  nor2   g153(.a(x022), .b(x014), .O(new_n310_));
  inv1   g154(.a(new_n310_), .O(new_n311_));
  nand3  g155(.a(x094), .b(x062), .c(x030), .O(new_n312_));
  inv1   g156(.a(x022), .O(new_n313_));
  nand2  g157(.a(x118), .b(new_n313_), .O(new_n314_));
  aoi21  g158(.a(new_n297_), .b(new_n296_), .c(x126), .O(new_n315_));
  aoi22  g159(.a(new_n315_), .b(new_n314_), .c(new_n312_), .d(new_n311_), .O(new_n316_));
  nand4  g160(.a(new_n316_), .b(new_n309_), .c(new_n306_), .d(new_n303_), .O(new_n317_));
  nand3  g161(.a(new_n317_), .b(x054), .c(new_n294_), .O(new_n318_));
  oai21  g162(.a(new_n310_), .b(new_n301_), .c(new_n298_), .O(new_n319_));
  inv1   g163(.a(x030), .O(new_n320_));
  oai21  g164(.a(x094), .b(x062), .c(new_n320_), .O(new_n321_));
  oai21  g165(.a(new_n298_), .b(x022), .c(new_n321_), .O(new_n322_));
  oai21  g166(.a(new_n295_), .b(x030), .c(new_n307_), .O(new_n323_));
  nand4  g167(.a(new_n323_), .b(new_n322_), .c(new_n319_), .d(x054), .O(new_n324_));
  nand2  g168(.a(x038), .b(new_n313_), .O(new_n325_));
  nor2   g169(.a(new_n295_), .b(x030), .O(new_n326_));
  nand3  g170(.a(new_n326_), .b(x054), .c(x022), .O(new_n327_));
  aoi21  g171(.a(new_n327_), .b(new_n325_), .c(x070), .O(new_n328_));
  inv1   g172(.a(x070), .O(new_n329_));
  aoi21  g173(.a(new_n329_), .b(x054), .c(new_n304_), .O(new_n330_));
  nand2  g174(.a(x094), .b(x062), .O(new_n331_));
  oai21  g175(.a(x094), .b(x086), .c(new_n331_), .O(new_n332_));
  nand3  g176(.a(new_n326_), .b(new_n304_), .c(x014), .O(new_n333_));
  oai21  g177(.a(new_n332_), .b(new_n330_), .c(new_n333_), .O(new_n334_));
  nor2   g178(.a(new_n334_), .b(new_n328_), .O(new_n335_));
  nand3  g179(.a(new_n335_), .b(new_n324_), .c(new_n318_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(x078), .O(new_n337_));
  inv1   g181(.a(x014), .O(new_n338_));
  nand3  g182(.a(new_n326_), .b(x022), .c(new_n338_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(x054), .c(x038), .O(new_n340_));
  nand3  g184(.a(new_n308_), .b(x086), .c(x054), .O(new_n341_));
  aoi21  g185(.a(new_n341_), .b(x078), .c(x014), .O(new_n342_));
  nand4  g186(.a(new_n329_), .b(x054), .c(new_n313_), .d(x014), .O(new_n343_));
  nand4  g187(.a(new_n307_), .b(x038), .c(x014), .d(new_n294_), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  nor3   g189(.a(new_n345_), .b(new_n342_), .c(new_n340_), .O(new_n346_));
  aoi21  g190(.a(new_n346_), .b(new_n337_), .c(new_n293_), .O(z06));
  ...
  nand2  g267(.a(new_n243_), .b(new_n238_), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n247_), .O(new_n426_));
  ...
  oai21  g274(.a(new_n277_), .b(x029), .c(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n243_), .b(x109), .c(x037), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(x117), .O(new_n434_));
  inv1   g277(.a(x109), .O(new_n435_));
  oai21  g278(.a(new_n238_), .b(x061), .c(new_n435_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n241_), .O(new_n437_));
  nand4  g280(.a(new_n437_), .b(new_n434_), .c(new_n432_), .d(new_n430_), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(new_n428_), .c(new_n270_), .O(new_n439_));
  nand4  g282(.a(x125), .b(new_n276_), .c(new_n241_), .d(x013), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n439_), .c(x053), .O(new_n441_));
  nand3  g284(.a(x085), .b(new_n241_), .c(new_n251_), .O(new_n442_));
  inv1   g285(.a(new_n442_), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n441_), .c(x005), .O(new_n444_));
  nand2  g287(.a(new_n254_), .b(x029), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n252_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n270_), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n251_), .c(new_n427_), .O(new_n448_));
  nor2   g291(.a(new_n274_), .b(x021), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(new_n277_), .c(x069), .O(new_n450_));
  nand4  g293(.a(new_n431_), .b(new_n425_), .c(new_n254_), .d(x029), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n450_), .c(x077), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n448_), .c(new_n235_), .O(new_n453_));
  nand2  g296(.a(new_n431_), .b(x029), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n266_), .O(new_n455_));
  nand3  g298(.a(new_n455_), .b(new_n270_), .c(x037), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n453_), .O(new_n457_));
  oai22  g300(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n458_));
  nand3  g301(.a(new_n458_), .b(x069), .c(x021), .O(new_n459_));
  nand2  g302(.a(x077), .b(x013), .O(new_n460_));
  nand3  g303(.a(new_n460_), .b(new_n459_), .c(new_n285_), .O(new_n461_));
  aoi21  g304(.a(new_n457_), .b(new_n250_), .c(new_n461_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n444_), .c(x045), .O(z13));
  inv1   g306(.a(x054), .O(new_n464_));
  inv1   g307(.a(x078), .O(new_n465_));
  nor2   g308(.a(x118), .b(x022), .O(new_n466_));
  oai21  g309(.a(x110), .b(x014), .c(x070), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n466_), .c(x126), .O(new_n468_));
  nand2  g311(.a(new_n297_), .b(new_n296_), .O(new_n469_));
  oai22  g312(.a(new_n469_), .b(x102), .c(new_n329_), .d(new_n304_), .O(new_n470_));
  oai21  g313(.a(new_n313_), .b(new_n338_), .c(x062), .O(new_n471_));
  aoi21  g314(.a(x022), .b(x014), .c(new_n320_), .O(new_n472_));
  nor2   g315(.a(new_n472_), .b(x086), .O(new_n473_));
  nand4  g316(.a(new_n473_), .b(new_n471_), .c(new_n470_), .d(new_n468_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n465_), .c(new_n464_), .O(new_n475_));
  nand3  g318(.a(x086), .b(new_n304_), .c(new_n338_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(x006), .O(new_n478_));
  nor2   g321(.a(new_n472_), .b(x062), .O(new_n479_));
  nor2   g322(.a(new_n479_), .b(new_n304_), .O(new_n480_));
  nand2  g323(.a(x070), .b(new_n313_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n300_), .c(new_n299_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n472_), .O(new_n483_));
  nand2  g326(.a(new_n320_), .b(new_n313_), .O(new_n484_));
  aoi22  g327(.a(new_n484_), .b(new_n469_), .c(x070), .d(x062), .O(new_n485_));
  aoi21  g328(.a(new_n485_), .b(new_n483_), .c(x054), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n480_), .c(new_n465_), .O(new_n487_));
  nand3  g330(.a(new_n469_), .b(new_n464_), .c(x014), .O(new_n488_));
  ...
  aoi21  g336(.a(new_n489_), .b(new_n307_), .c(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n478_), .c(x046), .O(z14));
  zero   g338(.O(z07));
  zero   g339(.O(z15));
  zero   g340(.O(z16));
  zero   g341(.O(z17));
