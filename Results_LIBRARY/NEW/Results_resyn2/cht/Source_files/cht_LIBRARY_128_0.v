...
module FAU ( 
  ...
  nand3  g083(.a(x14), .b(x09), .c(x00), .O(new_n167_));
  inv1   g084(.a(x14), .O(new_n168_));
  aoi22  g085(.a(x39), .b(new_n168_), .c(x38), .d(new_n145_), .O(new_n169_));
  ...
  nand3  g123(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n207_));
