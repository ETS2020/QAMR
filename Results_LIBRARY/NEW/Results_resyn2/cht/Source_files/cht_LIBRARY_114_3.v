...
module FAU ( 
  ...
  nand3  g024(.a(x18), .b(new_n85_), .c(new_n103_), .O(new_n108_));
  oai21  g025(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z07));
  nand3  g026(.a(x20), .b(new_n85_), .c(x08), .O(new_n110_));
  oai21  g027(.a(new_n107_), .b(x08), .c(new_n110_), .O(z08));
