...
module FAU ( 
  ...
  nand2  g109(.a(x44), .b(x09), .O(new_n193_));
  aoi21  g110(.a(x43), .b(new_n145_), .c(x14), .O(new_n194_));
  ...
  oai21  g115(.a(x14), .b(new_n145_), .c(new_n198_), .O(new_n199_));
  ...
  oai21  g120(.a(x14), .b(new_n145_), .c(new_n196_), .O(new_n204_));
