...
module FAU ( 
  ...
  aoi21  g012(.a(x07), .b(new_n95_), .c(x10), .O(z03));
  ...
  nor2   g059(.a(new_n103_), .b(x00), .O(new_n143_));
  oai21  g060(.a(x30), .b(x08), .c(new_n86_), .O(new_n144_));
  nor2   g061(.a(new_n144_), .b(new_n143_), .O(z19));
  ...
  nor2   g084(.a(new_n146_), .b(x00), .O(new_n168_));
  oai21  g085(.a(x38), .b(x09), .c(new_n86_), .O(new_n169_));
  nor2   g086(.a(new_n169_), .b(new_n168_), .O(z27));
