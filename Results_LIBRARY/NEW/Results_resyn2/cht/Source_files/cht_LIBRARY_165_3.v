// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:29 2020
...
module FAU ( 
  ...
  nand3  g042(.a(x24), .b(new_n85_), .c(new_n103_), .O(new_n126_));
  oai21  g043(.a(new_n125_), .b(new_n103_), .c(new_n126_), .O(z13));
  nand3  g044(.a(x26), .b(new_n85_), .c(x08), .O(new_n128_));
  oai21  g045(.a(new_n125_), .b(x08), .c(new_n128_), .O(z14));
