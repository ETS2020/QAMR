...
module FAU ( 
  ...
  nor2   g109(.a(x14), .b(new_n145_), .O(new_n193_));
  nand3  g110(.a(x44), .b(new_n168_), .c(x09), .O(new_n194_));
  nand2  g111(.a(x43), .b(new_n85_), .O(new_n195_));
  oai21  g112(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(z32));
  oai21  g113(.a(x14), .b(new_n145_), .c(x44), .O(new_n197_));
  nand3  g114(.a(new_n193_), .b(x45), .c(new_n85_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n197_), .O(z33));
  inv1   g116(.a(x46), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n168_), .c(x09), .O(new_n201_));
  inv1   g118(.a(x45), .O(new_n202_));
  oai21  g119(.a(x14), .b(new_n145_), .c(new_n202_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n201_), .c(new_n85_), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z34));
  nand3  g122(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n206_));
  oai21  g123(.a(x14), .b(new_n145_), .c(new_n200_), .O(new_n207_));
