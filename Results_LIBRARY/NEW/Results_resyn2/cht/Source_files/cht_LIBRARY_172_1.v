...
module FAU ( 
  ...
  nor2   g012(.a(new_n95_), .b(x10), .O(z03));
  ...
  nor2   g084(.a(x39), .b(new_n146_), .O(new_n168_));
  oai21  g085(.a(x38), .b(x09), .c(new_n86_), .O(new_n169_));
  nor2   g086(.a(new_n169_), .b(new_n168_), .O(z27));
  nor2   g087(.a(x40), .b(new_n146_), .O(new_n171_));
  oai21  g088(.a(x39), .b(x09), .c(new_n86_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n171_), .O(z28));
  nor2   g090(.a(x41), .b(new_n146_), .O(new_n174_));
  oai21  g091(.a(x40), .b(x09), .c(new_n86_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n174_), .O(z29));
  nor2   g093(.a(x42), .b(new_n146_), .O(new_n177_));
  oai21  g094(.a(x41), .b(x09), .c(new_n86_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(new_n177_), .O(z30));
  nor2   g096(.a(x43), .b(new_n146_), .O(new_n180_));
  oai21  g097(.a(x42), .b(x09), .c(new_n86_), .O(new_n181_));
  nor2   g098(.a(new_n181_), .b(new_n180_), .O(z31));
  nor2   g099(.a(x44), .b(new_n146_), .O(new_n183_));
  oai21  g100(.a(x43), .b(x09), .c(new_n86_), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(new_n183_), .O(z32));
  nor2   g102(.a(x45), .b(new_n146_), .O(new_n186_));
  oai21  g103(.a(x44), .b(x09), .c(new_n86_), .O(new_n187_));
  nor2   g104(.a(new_n187_), .b(new_n186_), .O(z33));
  nor2   g105(.a(x46), .b(new_n146_), .O(new_n189_));
  oai21  g106(.a(x45), .b(x09), .c(new_n86_), .O(new_n190_));
  nor2   g107(.a(new_n190_), .b(new_n189_), .O(z34));
  nor2   g108(.a(new_n146_), .b(x00), .O(new_n192_));
  oai21  g109(.a(x46), .b(x09), .c(new_n86_), .O(new_n193_));
  nor2   g110(.a(new_n193_), .b(new_n192_), .O(z35));
endmodule
