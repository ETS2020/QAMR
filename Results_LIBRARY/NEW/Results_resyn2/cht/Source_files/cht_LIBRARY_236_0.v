...
module FAU ( 
  ...
  aoi21  g012(.a(new_n95_), .b(new_n84_), .c(x10), .O(z03));
  ...
  aoi21  g084(.a(x39), .b(new_n95_), .c(new_n145_), .O(new_n168_));
  oai21  g085(.a(x38), .b(x09), .c(new_n86_), .O(new_n169_));
  aoi21  g086(.a(new_n168_), .b(new_n167_), .c(new_n169_), .O(z27));
  inv1   g087(.a(x40), .O(new_n171_));
  nand3  g088(.a(new_n171_), .b(new_n95_), .c(x09), .O(new_n172_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n95_), .c(x09), .O(new_n178_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n95_), .c(x09), .O(new_n183_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n95_), .c(x09), .O(new_n188_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n95_), .c(x09), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n95_), .c(x09), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n95_), .c(x09), .O(new_n203_));
  ...
  nand3  g123(.a(new_n95_), .b(x09), .c(new_n142_), .O(new_n207_));
