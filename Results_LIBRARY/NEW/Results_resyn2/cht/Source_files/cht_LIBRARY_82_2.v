...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n203_, new_n204_, new_n205_, new_n207_;
  ...
  nand3  g059(.a(x30), .b(new_n85_), .c(new_n103_), .O(new_n143_));
  ...
  aoi21  g086(.a(new_n169_), .b(new_n167_), .c(x10), .O(z27));
  inv1   g087(.a(x40), .O(new_n171_));
  nand3  g088(.a(new_n171_), .b(new_n168_), .c(x09), .O(new_n172_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n168_), .c(x09), .O(new_n178_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n168_), .c(x09), .O(new_n188_));
  ...
  nand2  g123(.a(x46), .b(new_n85_), .O(new_n207_));
  aoi21  g124(.a(new_n168_), .b(x09), .c(new_n207_), .O(z35));
endmodule
