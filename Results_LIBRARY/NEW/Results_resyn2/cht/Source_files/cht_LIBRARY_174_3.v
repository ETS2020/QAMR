...
module FAU ( 
  ...
  nand3  g105(.a(x43), .b(new_n168_), .c(x09), .O(new_n189_));
  nand2  g106(.a(x42), .b(new_n85_), .O(new_n190_));
  oai21  g107(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(z31));
  oai21  g108(.a(x14), .b(new_n145_), .c(x43), .O(new_n192_));
  nand3  g109(.a(new_n188_), .b(x44), .c(new_n85_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n192_), .O(z32));
  inv1   g111(.a(x45), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n168_), .c(x09), .O(new_n196_));
  inv1   g113(.a(x44), .O(new_n197_));
  oai21  g114(.a(x14), .b(new_n145_), .c(new_n197_), .O(new_n198_));
  ...
  oai21  g119(.a(x14), .b(new_n145_), .c(new_n195_), .O(new_n203_));
