...
module FAU ( 
  ...
  nand3  g035(.a(x22), .b(new_n85_), .c(new_n103_), .O(new_n119_));
  inv1   g036(.a(new_n119_), .O(z11));
  nand3  g037(.a(x24), .b(new_n85_), .c(x08), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z12));
  nor2   g039(.a(x25), .b(new_n103_), .O(new_n123_));
  oai21  g040(.a(x24), .b(x08), .c(new_n85_), .O(new_n124_));
  nor2   g041(.a(new_n124_), .b(new_n123_), .O(z13));
  nor2   g042(.a(x26), .b(new_n103_), .O(new_n126_));
  oai21  g043(.a(x25), .b(x08), .c(new_n85_), .O(new_n127_));
  nor2   g044(.a(new_n127_), .b(new_n126_), .O(z14));
  nor2   g045(.a(x27), .b(new_n103_), .O(new_n129_));
  oai21  g046(.a(x26), .b(x08), .c(new_n85_), .O(new_n130_));
  nor2   g047(.a(new_n130_), .b(new_n129_), .O(z15));
  nor2   g048(.a(x28), .b(new_n103_), .O(new_n132_));
  oai21  g049(.a(x27), .b(x08), .c(new_n85_), .O(new_n133_));
  nor2   g050(.a(new_n133_), .b(new_n132_), .O(z16));
  nor2   g051(.a(x29), .b(new_n103_), .O(new_n135_));
  oai21  g052(.a(x28), .b(x08), .c(new_n85_), .O(new_n136_));
  nor2   g053(.a(new_n136_), .b(new_n135_), .O(z17));
  nor2   g054(.a(x30), .b(new_n103_), .O(new_n138_));
  oai21  g055(.a(x29), .b(x08), .c(new_n85_), .O(new_n139_));
  nor2   g056(.a(new_n139_), .b(new_n138_), .O(z18));
