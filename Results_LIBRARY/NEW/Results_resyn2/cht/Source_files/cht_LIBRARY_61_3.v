// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:33 2020
...
module FAU ( 
  ...
  nand3  g069(.a(x33), .b(new_n85_), .c(new_n145_), .O(new_n153_));
  oai21  g070(.a(new_n152_), .b(new_n145_), .c(new_n153_), .O(z22));
  nand3  g071(.a(x35), .b(new_n85_), .c(x09), .O(new_n155_));
  oai21  g072(.a(new_n152_), .b(x09), .c(new_n155_), .O(z23));
  nor2   g073(.a(x36), .b(new_n145_), .O(new_n157_));
  oai21  g074(.a(x35), .b(x09), .c(new_n85_), .O(new_n158_));
  nor2   g075(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g076(.a(x37), .b(new_n145_), .O(new_n160_));
  oai21  g077(.a(x36), .b(x09), .c(new_n85_), .O(new_n161_));
  nor2   g078(.a(new_n161_), .b(new_n160_), .O(z25));
  nor2   g079(.a(x38), .b(new_n145_), .O(new_n163_));
  ...
  aoi21  g084(.a(x39), .b(new_n167_), .c(new_n145_), .O(new_n168_));
  ...
  oai21  g090(.a(x14), .b(new_n145_), .c(new_n173_), .O(new_n174_));
  ...
  oai21  g095(.a(x14), .b(new_n145_), .c(new_n171_), .O(new_n179_));
  ...
  oai21  g100(.a(x14), .b(new_n145_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g124(.a(x14), .b(new_n145_), .c(new_n202_), .O(new_n208_));
