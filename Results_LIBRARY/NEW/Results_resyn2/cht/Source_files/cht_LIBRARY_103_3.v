// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:56 2020
...
module FAU ( 
  ...
  nand3  g021(.a(x17), .b(new_n85_), .c(new_n103_), .O(new_n105_));
  oai21  g022(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(z06));
  nand3  g023(.a(x19), .b(new_n85_), .c(x08), .O(new_n107_));
  oai21  g024(.a(new_n104_), .b(x08), .c(new_n107_), .O(z07));
  nor2   g025(.a(x20), .b(new_n103_), .O(new_n109_));
  oai21  g026(.a(x19), .b(x08), .c(new_n85_), .O(new_n110_));
  nor2   g027(.a(new_n110_), .b(new_n109_), .O(z08));
  nor2   g028(.a(x21), .b(new_n103_), .O(new_n112_));
  oai21  g029(.a(x20), .b(x08), .c(new_n85_), .O(new_n113_));
  nor2   g030(.a(new_n113_), .b(new_n112_), .O(z09));
