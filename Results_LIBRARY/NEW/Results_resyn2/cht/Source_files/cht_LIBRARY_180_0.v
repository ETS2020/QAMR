...
module FAU ( 
  ...
  nand2  g094(.a(new_n168_), .b(x09), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n172_), .c(x10), .O(z29));
  inv1   g096(.a(x42), .O(new_n180_));
  inv1   g097(.a(new_n178_), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z30));
  inv1   g099(.a(x43), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n168_), .c(x09), .O(new_n184_));
  oai21  g101(.a(x14), .b(new_n145_), .c(new_n180_), .O(new_n185_));
