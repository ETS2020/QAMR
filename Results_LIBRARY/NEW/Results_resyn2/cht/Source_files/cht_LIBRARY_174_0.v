...
module FAU ( 
  ...
  nand2  g104(.a(new_n168_), .b(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n183_), .c(x10), .O(z31));
  inv1   g106(.a(x44), .O(new_n190_));
  inv1   g107(.a(new_n188_), .O(new_n191_));
  ...
  oai21  g111(.a(x14), .b(new_n145_), .c(new_n190_), .O(new_n195_));
