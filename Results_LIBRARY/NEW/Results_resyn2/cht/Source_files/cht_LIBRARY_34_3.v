// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:18 2020
...
module FAU ( 
  ...
  nand3  g027(.a(x19), .b(new_n85_), .c(new_n103_), .O(new_n111_));
  oai21  g028(.a(new_n110_), .b(new_n103_), .c(new_n111_), .O(z08));
  nand3  g029(.a(x21), .b(new_n85_), .c(x08), .O(new_n113_));
  oai21  g030(.a(new_n110_), .b(x08), .c(new_n113_), .O(z09));
  nor2   g031(.a(x22), .b(new_n103_), .O(new_n115_));
  oai21  g032(.a(x21), .b(x08), .c(new_n85_), .O(new_n116_));
  nor2   g033(.a(new_n116_), .b(new_n115_), .O(z10));
  nor2   g034(.a(x23), .b(new_n103_), .O(new_n118_));
  oai21  g035(.a(x22), .b(x08), .c(new_n85_), .O(new_n119_));
  nor2   g036(.a(new_n119_), .b(new_n118_), .O(z11));
  nor2   g037(.a(x24), .b(new_n103_), .O(new_n121_));
  oai21  g038(.a(x23), .b(x08), .c(new_n85_), .O(new_n122_));
  nor2   g039(.a(new_n122_), .b(new_n121_), .O(z12));
  nor2   g040(.a(x25), .b(new_n103_), .O(new_n124_));
  oai21  g041(.a(x24), .b(x08), .c(new_n85_), .O(new_n125_));
  nor2   g042(.a(new_n125_), .b(new_n124_), .O(z13));
  nor2   g043(.a(x26), .b(new_n103_), .O(new_n127_));
  oai21  g044(.a(x25), .b(x08), .c(new_n85_), .O(new_n128_));
  nor2   g045(.a(new_n128_), .b(new_n127_), .O(z14));
  nor2   g046(.a(x27), .b(new_n103_), .O(new_n130_));
  oai21  g047(.a(x26), .b(x08), .c(new_n85_), .O(new_n131_));
  nor2   g048(.a(new_n131_), .b(new_n130_), .O(z15));
  nor2   g049(.a(x28), .b(new_n103_), .O(new_n133_));
  oai21  g050(.a(x27), .b(x08), .c(new_n85_), .O(new_n134_));
  nor2   g051(.a(new_n134_), .b(new_n133_), .O(z16));
  nor2   g052(.a(x29), .b(new_n103_), .O(new_n136_));
  oai21  g053(.a(x28), .b(x08), .c(new_n85_), .O(new_n137_));
  nor2   g054(.a(new_n137_), .b(new_n136_), .O(z17));
  nor2   g055(.a(x30), .b(new_n103_), .O(new_n139_));
