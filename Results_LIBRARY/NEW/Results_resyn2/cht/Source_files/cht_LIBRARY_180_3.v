...
module FAU ( 
  ...
  nor2   g094(.a(x14), .b(new_n145_), .O(new_n178_));
  nand3  g095(.a(x41), .b(new_n168_), .c(x09), .O(new_n179_));
  nand2  g096(.a(x40), .b(new_n85_), .O(new_n180_));
  oai21  g097(.a(new_n180_), .b(new_n178_), .c(new_n179_), .O(z29));
  oai21  g098(.a(x14), .b(new_n145_), .c(x41), .O(new_n182_));
  nand3  g099(.a(new_n178_), .b(x42), .c(new_n85_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(z30));
