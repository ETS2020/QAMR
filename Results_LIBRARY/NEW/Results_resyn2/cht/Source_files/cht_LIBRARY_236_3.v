...
module FAU ( 
  ...
  nand3  g012(.a(x14), .b(new_n86_), .c(new_n84_), .O(new_n96_));
  ...
  aoi21  g086(.a(x39), .b(new_n169_), .c(new_n146_), .O(new_n170_));
  oai21  g087(.a(x38), .b(x09), .c(new_n86_), .O(new_n171_));
  ...
  nand3  g125(.a(new_n169_), .b(x09), .c(new_n143_), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n146_), .c(new_n204_), .O(new_n210_));
