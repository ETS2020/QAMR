...
module FAU ( 
  ...
  nand3  g030(.a(x20), .b(new_n85_), .c(new_n103_), .O(new_n114_));
  oai21  g031(.a(new_n113_), .b(new_n103_), .c(new_n114_), .O(z09));
  nand3  g032(.a(x22), .b(new_n85_), .c(x08), .O(new_n116_));
  oai21  g033(.a(new_n113_), .b(x08), .c(new_n116_), .O(z10));
