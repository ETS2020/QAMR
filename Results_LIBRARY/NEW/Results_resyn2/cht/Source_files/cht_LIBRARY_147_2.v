// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:19 2020
...
module FAU ( 
  ...
  aoi21  g084(.a(x39), .b(new_n167_), .c(new_n150_), .O(new_n168_));
  ...
  oai21  g090(.a(x14), .b(new_n150_), .c(new_n173_), .O(new_n174_));
  ...
  oai21  g095(.a(x14), .b(new_n150_), .c(new_n171_), .O(new_n179_));
  ...
  oai21  g100(.a(x14), .b(new_n150_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g105(.a(x14), .b(new_n150_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g110(.a(x14), .b(new_n150_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g115(.a(x14), .b(new_n150_), .c(new_n192_), .O(new_n199_));
  ...
  oai21  g120(.a(x14), .b(new_n150_), .c(new_n197_), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(new_n203_), .c(new_n85_), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z34));
  nand3  g123(.a(new_n167_), .b(x09), .c(new_n142_), .O(new_n207_));
  oai21  g124(.a(x14), .b(new_n150_), .c(new_n202_), .O(new_n208_));
