// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:30 2020
...
module FAU ( 
  ...
  nand3  g057(.a(x29), .b(new_n85_), .c(new_n103_), .O(new_n141_));
  oai21  g058(.a(new_n140_), .b(new_n103_), .c(new_n141_), .O(z18));
  nand2  g059(.a(x08), .b(x00), .O(new_n143_));
  oai22  g060(.a(new_n143_), .b(x10), .c(new_n140_), .d(x08), .O(z19));
  ...
  nand3  g125(.a(new_n168_), .b(x09), .c(new_n208_), .O(new_n209_));
  oai21  g126(.a(x14), .b(new_n145_), .c(new_n203_), .O(new_n210_));
