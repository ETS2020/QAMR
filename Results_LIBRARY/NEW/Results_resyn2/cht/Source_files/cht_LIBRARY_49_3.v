// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:26 2020
...
module FAU ( 
  ...
  nand3  g045(.a(x25), .b(new_n85_), .c(new_n103_), .O(new_n129_));
  oai21  g046(.a(new_n128_), .b(new_n103_), .c(new_n129_), .O(z14));
  nand3  g047(.a(x27), .b(new_n85_), .c(x08), .O(new_n131_));
  oai21  g048(.a(new_n128_), .b(x08), .c(new_n131_), .O(z15));
