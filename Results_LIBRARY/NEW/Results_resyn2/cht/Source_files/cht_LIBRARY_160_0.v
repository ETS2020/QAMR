...
module FAU ( 
  ...
  nand2  g109(.a(new_n168_), .b(x09), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n188_), .c(x10), .O(z32));
  inv1   g111(.a(x45), .O(new_n195_));
  inv1   g112(.a(new_n193_), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z33));
  inv1   g114(.a(x46), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n168_), .c(x09), .O(new_n199_));
  oai21  g116(.a(x14), .b(new_n145_), .c(new_n195_), .O(new_n200_));
