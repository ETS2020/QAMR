...
module FAU ( 
  ...
  nand3  g054(.a(x28), .b(new_n85_), .c(new_n103_), .O(new_n138_));
  oai21  g055(.a(new_n137_), .b(new_n103_), .c(new_n138_), .O(z17));
  nand3  g056(.a(x30), .b(new_n85_), .c(x08), .O(new_n140_));
  oai21  g057(.a(new_n137_), .b(x08), .c(new_n140_), .O(z18));
