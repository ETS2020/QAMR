...
module FAU ( 
  ...
  nand3  g099(.a(x42), .b(new_n168_), .c(x09), .O(new_n183_));
  ...
  oai21  g104(.a(x14), .b(new_n145_), .c(new_n187_), .O(new_n188_));
  ...
  oai21  g109(.a(x14), .b(new_n145_), .c(new_n185_), .O(new_n193_));
