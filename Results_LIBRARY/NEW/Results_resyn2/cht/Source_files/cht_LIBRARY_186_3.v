...
module FAU ( 
  ...
  nand3  g033(.a(x21), .b(new_n85_), .c(new_n103_), .O(new_n117_));
  oai21  g034(.a(new_n116_), .b(new_n103_), .c(new_n117_), .O(z10));
  nand3  g035(.a(x23), .b(new_n85_), .c(x08), .O(new_n119_));
  oai21  g036(.a(new_n116_), .b(x08), .c(new_n119_), .O(z11));
