...
module FAU ( 
  ...
  nor2   g114(.a(x14), .b(new_n145_), .O(new_n198_));
  nand2  g115(.a(x44), .b(new_n85_), .O(new_n199_));
  nor2   g116(.a(new_n199_), .b(new_n198_), .O(z33));
  nand3  g117(.a(new_n198_), .b(x46), .c(new_n85_), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z34));
  nand3  g119(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n203_));
  inv1   g120(.a(x46), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n145_), .c(new_n204_), .O(new_n205_));
