// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:09 2020
...
module FAU ( 
  ...
  nor2   g104(.a(x14), .b(new_n145_), .O(new_n188_));
  nand2  g105(.a(x42), .b(new_n85_), .O(new_n189_));
  nor2   g106(.a(new_n189_), .b(new_n188_), .O(z31));
  nand3  g107(.a(new_n188_), .b(x44), .c(new_n85_), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z32));
  inv1   g109(.a(x45), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n168_), .c(x09), .O(new_n194_));
  inv1   g111(.a(x44), .O(new_n195_));
  oai21  g112(.a(x14), .b(new_n145_), .c(new_n195_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n194_), .c(new_n85_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z33));
  inv1   g115(.a(x46), .O(new_n199_));
  nand3  g116(.a(new_n199_), .b(new_n168_), .c(x09), .O(new_n200_));
  oai21  g117(.a(x14), .b(new_n145_), .c(new_n193_), .O(new_n201_));
