...
module FAU ( 
  ...
  nand3  g036(.a(x22), .b(new_n85_), .c(new_n103_), .O(new_n120_));
  oai21  g037(.a(new_n119_), .b(new_n103_), .c(new_n120_), .O(z11));
  nand3  g038(.a(x24), .b(new_n85_), .c(x08), .O(new_n122_));
  oai21  g039(.a(new_n119_), .b(x08), .c(new_n122_), .O(z12));
