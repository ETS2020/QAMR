// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:06 2020
...
module FAU ( 
  ...
  nand3  g041(.a(x24), .b(new_n85_), .c(new_n103_), .O(new_n125_));
  inv1   g042(.a(new_n125_), .O(z13));
  aoi21  g043(.a(x26), .b(x08), .c(x25), .O(new_n127_));
  nor2   g044(.a(new_n127_), .b(x10), .O(z14));
