...
module FAU ( 
  ...
  nand2  g120(.a(x45), .b(new_n85_), .O(new_n204_));
  nor2   g121(.a(new_n204_), .b(new_n203_), .O(z34));
  nand3  g122(.a(new_n203_), .b(new_n85_), .c(x00), .O(new_n206_));
