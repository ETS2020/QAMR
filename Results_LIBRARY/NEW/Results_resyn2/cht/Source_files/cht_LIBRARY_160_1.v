// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:26 2020
...
module FAU ( 
  ...
  nand2  g110(.a(x43), .b(new_n85_), .O(new_n194_));
  nor2   g111(.a(new_n194_), .b(new_n193_), .O(z32));
  nand3  g112(.a(new_n193_), .b(x45), .c(new_n85_), .O(new_n196_));
  inv1   g113(.a(new_n196_), .O(z33));
  inv1   g114(.a(x46), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n168_), .c(x09), .O(new_n199_));
  inv1   g116(.a(x45), .O(new_n200_));
  oai21  g117(.a(x14), .b(new_n145_), .c(new_n200_), .O(new_n201_));
