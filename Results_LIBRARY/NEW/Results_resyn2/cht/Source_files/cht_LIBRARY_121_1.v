...
module FAU ( 
  ...
  nand3  g029(.a(x20), .b(new_n85_), .c(new_n103_), .O(new_n113_));
  inv1   g030(.a(new_n113_), .O(z09));
  nand3  g031(.a(x22), .b(new_n85_), .c(x08), .O(new_n115_));
  inv1   g032(.a(new_n115_), .O(z10));
