// Benchmark "FAU" written by ABC on Mon Jul 27 21:10:50 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n49_, new_n54_, new_n55_,
  ...
  aoi21  g22(.a(new_n63_), .b(new_n45_), .c(new_n49_), .O(z13));
  inv1   g23(.a(new_n58_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x02), .O(new_n66_));
  nand2  g25(.a(new_n45_), .b(x12), .O(new_n67_));
  aoi21  g26(.a(new_n66_), .b(new_n55_), .c(new_n67_), .O(z14));
  nand2  g27(.a(new_n65_), .b(new_n55_), .O(new_n69_));
  inv1   g28(.a(x14), .O(new_n70_));
  nand2  g29(.a(x16), .b(new_n70_), .O(new_n71_));
  inv1   g30(.a(x03), .O(new_n72_));
  nand4  g31(.a(new_n55_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x12), .O(new_n74_));
  aoi21  g33(.a(new_n71_), .b(new_n69_), .c(new_n74_), .O(z15));
  inv1   g34(.a(x04), .O(new_n76_));
  nand4  g35(.a(new_n55_), .b(x10), .c(x08), .d(new_n76_), .O(new_n77_));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n58_), .b(x15), .c(new_n78_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n77_), .c(x12), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z16));
  inv1   g40(.a(x05), .O(new_n82_));
  nand4  g41(.a(new_n55_), .b(x10), .c(x08), .d(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n58_), .b(x15), .c(z04), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(x12), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z17));
  inv1   g45(.a(x06), .O(new_n87_));
  nand4  g46(.a(new_n55_), .b(x10), .c(x08), .d(new_n87_), .O(new_n88_));
  ...
  nand4  g52(.a(new_n55_), .b(x10), .c(x08), .d(new_n93_), .O(new_n94_));
  oai21  g53(.a(new_n58_), .b(x15), .c(new_n43_), .O(new_n95_));
