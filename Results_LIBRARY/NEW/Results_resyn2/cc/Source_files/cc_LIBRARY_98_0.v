// Benchmark "FAU" written by ABC on Mon Jul 27 21:11:30 2020
...
module FAU ( 
  ...
  nand3  g16(.a(new_n48_), .b(x08), .c(new_n57_), .O(new_n58_));
  ...
  nand3  g22(.a(new_n48_), .b(x08), .c(x01), .O(new_n64_));
  ...
  nand3  g29(.a(new_n48_), .b(x08), .c(x03), .O(new_n71_));
  ...
  nand3  g33(.a(new_n48_), .b(x08), .c(new_n74_), .O(new_n75_));
  ...
  nand3  g39(.a(new_n48_), .b(x08), .c(new_n80_), .O(new_n81_));
  ...
  nand3  g44(.a(new_n48_), .b(x08), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g50(.a(new_n48_), .b(x08), .c(new_n91_), .O(new_n92_));
