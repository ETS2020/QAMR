...
module FAU ( 
  ...
  oai21  g38(.a(new_n45_), .b(x15), .c(new_n79_), .O(new_n80_));
  ...
  oai21  g47(.a(x15), .b(new_n88_), .c(x19), .O(new_n89_));
  inv1   g48(.a(x10), .O(new_n90_));
  nor2   g49(.a(x15), .b(new_n88_), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(x06), .c(new_n90_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n89_), .c(new_n54_), .O(z18));
