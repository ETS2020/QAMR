// Benchmark "FAU" written by ABC on Mon Jul 27 21:10:52 2020
...
module FAU ( 
  ...
  nand2  g17(.a(x15), .b(x14), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  inv1   g19(.a(x00), .O(new_n61_));
  nand4  g20(.a(new_n48_), .b(x10), .c(x08), .d(new_n61_), .O(new_n62_));
  ...
  oai21  g35(.a(new_n58_), .b(x15), .c(new_n76_), .O(new_n77_));
  ...
  oai21  g40(.a(new_n58_), .b(x15), .c(z04), .O(new_n82_));
  ...
  oai21  g46(.a(new_n58_), .b(x15), .c(new_n87_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n58_), .b(x15), .c(new_n43_), .O(new_n93_));
