...
module FAU ( 
  ...
  nand4  g10(.a(x15), .b(new_n45_), .c(x12), .d(x08), .O(new_n52_));
  ...
  nand3  g42(.a(new_n48_), .b(x08), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g47(.a(new_n48_), .b(x08), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n48_), .b(x08), .c(new_n94_), .O(new_n95_));
