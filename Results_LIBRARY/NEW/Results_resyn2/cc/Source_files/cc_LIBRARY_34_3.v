// Benchmark "FAU" written by ABC on Mon Jul 27 21:10:57 2020
...
module FAU ( 
  ...
  nand2  g47(.a(new_n59_), .b(x20), .O(new_n89_));
  nand4  g48(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(z19));
  buf    g50(.a(x19), .O(z05));
  buf    g51(.a(x15), .O(z06));
  buf    g52(.a(x17), .O(z07));
  buf    g53(.a(x16), .O(z08));
