...
module FAU ( 
  ...
  nand3  g18(.a(new_n50_), .b(new_n48_), .c(new_n59_), .O(new_n60_));
  ...
  aoi21  g24(.a(new_n45_), .b(new_n47_), .c(new_n65_), .O(z13));
  nand2  g25(.a(new_n50_), .b(x02), .O(new_n67_));
  nand2  g26(.a(new_n45_), .b(x12), .O(new_n68_));
  aoi21  g27(.a(new_n67_), .b(new_n48_), .c(new_n68_), .O(z14));
  nand2  g28(.a(x16), .b(x15), .O(new_n70_));
  nand2  g29(.a(x08), .b(x03), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(x15), .c(new_n70_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x10), .O(new_n73_));
  nand3  g32(.a(new_n49_), .b(x16), .c(new_n47_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n65_), .O(z15));
  inv1   g34(.a(x04), .O(new_n76_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n76_), .O(new_n77_));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n49_), .b(x15), .c(new_n78_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n77_), .c(x12), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z16));
  inv1   g40(.a(x05), .O(new_n82_));
  nand3  g41(.a(new_n50_), .b(new_n48_), .c(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n49_), .b(x15), .c(z04), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(x12), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z17));
  inv1   g45(.a(x06), .O(new_n87_));
  nand3  g46(.a(new_n50_), .b(new_n48_), .c(new_n87_), .O(new_n88_));
  inv1   g47(.a(x19), .O(new_n89_));
  oai21  g48(.a(new_n49_), .b(x15), .c(new_n89_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n88_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z18));
  inv1   g51(.a(x07), .O(new_n93_));
  nand3  g52(.a(new_n50_), .b(new_n48_), .c(new_n93_), .O(new_n94_));
  oai21  g53(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n95_));
