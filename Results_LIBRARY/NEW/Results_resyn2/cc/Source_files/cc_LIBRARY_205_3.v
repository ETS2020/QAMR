...
module FAU ( 
  ...
  oai21  g24(.a(new_n60_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n45_), .c(new_n64_), .O(z13));
  ...
  oai21  g30(.a(new_n71_), .b(x15), .c(x16), .O(new_n72_));
  nand4  g31(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n64_), .O(z15));
  inv1   g33(.a(x04), .O(new_n75_));
  nand4  g34(.a(new_n48_), .b(x10), .c(x08), .d(new_n75_), .O(new_n76_));
  inv1   g35(.a(x17), .O(new_n77_));
  oai21  g36(.a(new_n60_), .b(x15), .c(new_n77_), .O(new_n78_));
  ...
  oai21  g41(.a(new_n60_), .b(x15), .c(z04), .O(new_n83_));
  ...
  oai21  g47(.a(new_n60_), .b(x15), .c(new_n88_), .O(new_n89_));
  ...
  oai21  g52(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n94_));
