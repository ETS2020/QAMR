...
module FAU ( 
  ...
  inv1   g45(.a(x08), .O(new_n87_));
  oai21  g46(.a(x15), .b(new_n87_), .c(x19), .O(new_n88_));
  nand3  g47(.a(new_n50_), .b(new_n48_), .c(x06), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n54_), .O(z18));
