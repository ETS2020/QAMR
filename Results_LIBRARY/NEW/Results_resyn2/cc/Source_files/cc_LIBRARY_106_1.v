...
module FAU ( 
  ...
  aoi21  g10(.a(new_n50_), .b(new_n47_), .c(new_n51_), .O(z02));
  ...
  nand4  g17(.a(new_n48_), .b(x10), .c(x08), .d(new_n58_), .O(new_n59_));
  inv1   g18(.a(x13), .O(new_n60_));
  nand2  g19(.a(x10), .b(x08), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(x15), .c(new_n60_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n59_), .c(x12), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z12));
  inv1   g23(.a(x01), .O(new_n65_));
  oai21  g24(.a(new_n61_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n45_), .c(new_n53_), .O(z13));
  nand2  g26(.a(new_n49_), .b(x02), .O(new_n68_));
  ...
  oai21  g51(.a(new_n61_), .b(x15), .c(new_n43_), .O(new_n93_));
