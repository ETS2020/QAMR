...
module FAU ( 
  ...
  nor2   g08(.a(new_n45_), .b(x15), .O(new_n50_));
  ...
  nand2  g18(.a(new_n50_), .b(new_n59_), .O(new_n60_));
  inv1   g19(.a(x13), .O(new_n61_));
  oai21  g20(.a(new_n45_), .b(x15), .c(new_n61_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n60_), .c(x12), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z12));
  inv1   g23(.a(x01), .O(new_n65_));
  oai21  g24(.a(new_n45_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n47_), .c(new_n54_), .O(z13));
  aoi21  g26(.a(new_n46_), .b(x02), .c(x15), .O(new_n68_));
  nand2  g27(.a(new_n47_), .b(x12), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n68_), .O(z14));
  nand2  g29(.a(x16), .b(new_n49_), .O(new_n71_));
  inv1   g30(.a(x03), .O(new_n72_));
  inv1   g31(.a(x15), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(x10), .c(x08), .d(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  aoi21  g34(.a(new_n71_), .b(new_n51_), .c(new_n75_), .O(z15));
  inv1   g35(.a(x08), .O(new_n77_));
  oai21  g36(.a(x15), .b(new_n77_), .c(x17), .O(new_n78_));
  inv1   g37(.a(x10), .O(new_n79_));
  nor2   g38(.a(x15), .b(new_n77_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x04), .c(new_n79_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n78_), .c(new_n54_), .O(z16));
  inv1   g41(.a(x05), .O(new_n83_));
  nand2  g42(.a(new_n50_), .b(new_n83_), .O(new_n84_));
  oai21  g43(.a(new_n45_), .b(x15), .c(z04), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(x12), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z17));
  inv1   g46(.a(x06), .O(new_n88_));
  nand2  g47(.a(new_n50_), .b(new_n88_), .O(new_n89_));
  inv1   g48(.a(x19), .O(new_n90_));
  oai21  g49(.a(new_n45_), .b(x15), .c(new_n90_), .O(new_n91_));
  ...
  oai21  g54(.a(new_n45_), .b(x15), .c(new_n43_), .O(new_n96_));
