// Benchmark "FAU" written by ABC on Mon Jul 27 21:11:40 2020
...
module FAU ( 
  ...
  nand4  g48(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n43_), .c(new_n52_), .O(z19));
  buf    g50(.a(x19), .O(z05));
  buf    g51(.a(x15), .O(z06));
  buf    g52(.a(x17), .O(z07));
  buf    g53(.a(x16), .O(z08));
