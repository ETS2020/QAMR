// Benchmark "FAU" written by ABC on Mon Jul 27 21:12:17 2020
...
module FAU ( 
  ...
  inv1   g31(.a(new_n49_), .O(new_n73_));
  nand2  g32(.a(x17), .b(x12), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n73_), .O(z16));
  inv1   g34(.a(x05), .O(new_n76_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(new_n76_), .O(new_n77_));
  oai21  g36(.a(new_n60_), .b(x15), .c(z04), .O(new_n78_));
  ...
  oai21  g42(.a(new_n60_), .b(x15), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g47(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n89_));
