...
module FAU ( 
  ...
  nor2   g09(.a(new_n50_), .b(new_n49_), .O(z02));
  inv1   g10(.a(x12), .O(new_n52_));
  inv1   g11(.a(z01), .O(new_n53_));
  ...
  nand2  g17(.a(new_n48_), .b(new_n58_), .O(new_n59_));
  inv1   g18(.a(x13), .O(new_n60_));
  oai21  g19(.a(new_n47_), .b(x15), .c(new_n60_), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n59_), .c(x12), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z12));
  inv1   g22(.a(x15), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(x08), .c(x01), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n53_), .c(new_n52_), .O(z13));
  nand3  g26(.a(x10), .b(x08), .c(x02), .O(new_n68_));
  nand2  g27(.a(new_n45_), .b(x12), .O(new_n69_));
  aoi21  g28(.a(new_n68_), .b(new_n64_), .c(new_n69_), .O(z14));
  inv1   g29(.a(x10), .O(new_n71_));
  aoi21  g30(.a(new_n64_), .b(x08), .c(x14), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n71_), .c(x16), .O(new_n73_));
  nand2  g32(.a(new_n48_), .b(x03), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n52_), .O(z15));
  inv1   g34(.a(x04), .O(new_n76_));
  nand2  g35(.a(new_n48_), .b(new_n76_), .O(new_n77_));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n47_), .b(x15), .c(new_n78_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n77_), .c(x12), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z16));
  inv1   g40(.a(x05), .O(new_n82_));
  nand2  g41(.a(new_n48_), .b(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n47_), .b(x15), .c(z04), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n83_), .c(x12), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z17));
  inv1   g45(.a(x06), .O(new_n87_));
  nand2  g46(.a(new_n48_), .b(new_n87_), .O(new_n88_));
  inv1   g47(.a(x19), .O(new_n89_));
  oai21  g48(.a(new_n47_), .b(x15), .c(new_n89_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n88_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z18));
  inv1   g51(.a(x07), .O(new_n93_));
  nand2  g52(.a(new_n48_), .b(new_n93_), .O(new_n94_));
  oai21  g53(.a(new_n47_), .b(x15), .c(new_n43_), .O(new_n95_));
