// Benchmark "FAU" written by ABC on Mon Jul 27 21:12:08 2020
...
module FAU ( 
  ...
  nand3  g04(.a(x15), .b(new_n45_), .c(x10), .O(new_n46_));
  ...
  nand2  g24(.a(x15), .b(x10), .O(new_n66_));
  inv1   g25(.a(x01), .O(new_n67_));
  oai21  g26(.a(new_n49_), .b(new_n67_), .c(x14), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(z13));
  nand2  g28(.a(new_n50_), .b(x02), .O(new_n70_));
  nand2  g29(.a(new_n66_), .b(x12), .O(new_n71_));
  aoi21  g30(.a(new_n70_), .b(new_n48_), .c(new_n71_), .O(z14));
  ...
  oai21  g44(.a(new_n49_), .b(x15), .c(z04), .O(new_n86_));
  ...
  oai21  g50(.a(new_n49_), .b(x15), .c(new_n91_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n90_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z18));
  inv1   g53(.a(x07), .O(new_n95_));
  nand4  g54(.a(new_n48_), .b(x10), .c(x08), .d(new_n95_), .O(new_n96_));
  oai21  g55(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n97_));
