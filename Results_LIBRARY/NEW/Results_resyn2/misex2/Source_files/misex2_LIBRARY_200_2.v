...
module FAU ( 
  ...
  nand3  g35(.a(x19), .b(new_n51_), .c(x17), .O(new_n79_));
  ...
  nand4  g40(.a(x04), .b(new_n83_), .c(x02), .d(new_n45_), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z08));
  nor2   g42(.a(x20), .b(new_n46_), .O(new_n86_));
  nand2  g43(.a(new_n86_), .b(new_n64_), .O(new_n87_));
  ...
  aoi21  g55(.a(new_n95_), .b(new_n87_), .c(new_n98_), .O(z09));
  nand4  g56(.a(new_n86_), .b(new_n64_), .c(x22), .d(x21), .O(new_n100_));
  inv1   g57(.a(x14), .O(new_n101_));
  nand4  g58(.a(new_n96_), .b(x20), .c(x15), .d(new_n101_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x16), .O(new_n104_));
  nor2   g61(.a(x22), .b(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n103_), .c(new_n91_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n100_), .c(x00), .O(z10));
  nand2  g64(.a(new_n97_), .b(new_n45_), .O(new_n108_));
  nand3  g65(.a(new_n86_), .b(new_n64_), .c(x21), .O(new_n109_));
  nand3  g66(.a(new_n103_), .b(new_n91_), .c(new_n104_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(z11));
  ...
  nand2  g84(.a(new_n113_), .b(x02), .O(new_n128_));
