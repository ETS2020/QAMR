// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:40 2020
...
module FAU ( 
  ...
  nand4  g60(.a(new_n87_), .b(x20), .c(x16), .d(x15), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n94_), .c(new_n90_), .O(new_n106_));
  nor2   g63(.a(x20), .b(new_n46_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n64_), .c(x22), .d(x21), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n106_), .c(x00), .O(z10));
  ...
  nand4  g69(.a(new_n101_), .b(x21), .c(x18), .d(x01), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(new_n88_), .O(z11));
  nand2  g71(.a(new_n71_), .b(new_n72_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n52_), .b(x17), .c(new_n89_), .O(new_n117_));
  ...
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n89_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n89_), .c(new_n46_), .O(new_n126_));
