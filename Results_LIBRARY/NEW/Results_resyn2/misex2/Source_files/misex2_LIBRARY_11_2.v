// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:15 2020
...
module FAU ( 
  ...
  nand4  g21(.a(new_n64_), .b(new_n63_), .c(x10), .d(new_n44_), .O(new_n65_));
  nor2   g22(.a(new_n65_), .b(new_n57_), .O(z04));
  ...
  nand2  g27(.a(new_n70_), .b(x09), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n67_), .O(z05));
  ...
  nand4  g42(.a(new_n85_), .b(new_n49_), .c(x18), .d(x01), .O(new_n86_));
  inv1   g43(.a(x02), .O(new_n87_));
  nor2   g44(.a(new_n87_), .b(x01), .O(new_n88_));
  inv1   g45(.a(x13), .O(new_n89_));
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n63_), .O(new_n90_));
  inv1   g47(.a(new_n90_), .O(new_n91_));
  nor2   g48(.a(new_n85_), .b(x16), .O(new_n92_));
  nor2   g49(.a(x15), .b(x14), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n88_), .O(new_n94_));
  nor2   g51(.a(x22), .b(x21), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  aoi21  g53(.a(new_n94_), .b(new_n86_), .c(new_n96_), .O(z09));
  nand2  g54(.a(new_n91_), .b(new_n88_), .O(new_n98_));
  inv1   g55(.a(new_n86_), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(x00), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n99_), .c(x22), .O(new_n102_));
  inv1   g59(.a(x15), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x14), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n95_), .c(x20), .d(x16), .O(new_n105_));
  oai21  g62(.a(new_n105_), .b(new_n98_), .c(new_n102_), .O(z10));
  nand2  g63(.a(new_n101_), .b(new_n99_), .O(new_n107_));
  inv1   g64(.a(x16), .O(new_n108_));
  nand3  g65(.a(new_n100_), .b(x20), .c(new_n108_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n104_), .c(new_n91_), .d(new_n88_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(x22), .O(z11));
  nand2  g69(.a(new_n67_), .b(new_n70_), .O(new_n113_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g71(.a(new_n49_), .b(x17), .c(new_n87_), .O(new_n115_));
  ...
  nand2  g77(.a(new_n45_), .b(new_n49_), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(new_n47_), .O(z13));
  nor2   g79(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g80(.a(new_n54_), .b(x01), .c(new_n87_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n87_), .c(new_n69_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n68_), .c(new_n125_), .O(z15));
  nor2   g83(.a(new_n69_), .b(x00), .O(z16));
