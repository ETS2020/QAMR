...
module FAU ( 
  ...
  nor4   g24(.a(new_n67_), .b(new_n60_), .c(x12), .d(x11), .O(z04));
  nand2  g25(.a(x10), .b(x02), .O(new_n69_));
  nor2   g26(.a(new_n46_), .b(new_n45_), .O(new_n70_));
  nand2  g27(.a(new_n70_), .b(x09), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n69_), .O(z05));
  ...
  nand4  g45(.a(new_n88_), .b(x12), .c(x02), .d(new_n46_), .O(new_n89_));
  ...
  aoi21  g54(.a(new_n94_), .b(new_n87_), .c(new_n97_), .O(z09));
  nand4  g55(.a(new_n86_), .b(new_n64_), .c(x22), .d(x21), .O(new_n99_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n64_), .c(x21), .O(new_n106_));
  ...
  nand2  g69(.a(new_n69_), .b(new_n70_), .O(new_n113_));
