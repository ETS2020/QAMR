// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:13 2020
...
module FAU ( 
  ...
  nand3  g61(.a(new_n104_), .b(new_n102_), .c(new_n91_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n100_), .c(x00), .O(z10));
  nand3  g63(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n107_));
  inv1   g64(.a(x16), .O(new_n108_));
  nand3  g65(.a(new_n96_), .b(x20), .c(new_n108_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n102_), .c(new_n91_), .O(new_n111_));
  nand2  g68(.a(new_n97_), .b(new_n45_), .O(new_n112_));
