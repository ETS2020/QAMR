...
module FAU ( 
  ...
  nand3  g60(.a(new_n98_), .b(x15), .c(new_n103_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  and2   g62(.a(x20), .b(x16), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n105_), .c(new_n93_), .d(new_n90_), .O(new_n107_));
  ...
  nand4  g67(.a(new_n105_), .b(new_n95_), .c(new_n93_), .d(new_n90_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n52_), .b(x17), .c(new_n89_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n83_), .O(new_n117_));
  ...
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n89_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n89_), .c(new_n46_), .O(new_n124_));
