// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:50 2020
...
module FAU ( 
  ...
  nand4  g43(.a(new_n86_), .b(new_n85_), .c(x12), .d(new_n63_), .O(new_n87_));
  inv1   g44(.a(x15), .O(new_n88_));
  inv1   g45(.a(x16), .O(new_n89_));
  inv1   g46(.a(x21), .O(new_n90_));
  inv1   g47(.a(x22), .O(new_n91_));
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n92_));
  nor3   g49(.a(new_n92_), .b(new_n87_), .c(new_n82_), .O(z09));
  inv1   g50(.a(x20), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(new_n49_), .c(x18), .d(x01), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(x22), .O(new_n97_));
  inv1   g54(.a(new_n87_), .O(new_n98_));
  inv1   g55(.a(x02), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(x01), .O(new_n100_));
  nand4  g57(.a(new_n91_), .b(new_n90_), .c(x16), .d(x15), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n97_), .c(x00), .O(z10));
  nand3  g61(.a(new_n90_), .b(new_n89_), .c(x15), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n100_), .c(new_n98_), .O(new_n107_));
  nand2  g64(.a(new_n91_), .b(new_n68_), .O(new_n108_));
  aoi21  g65(.a(new_n107_), .b(new_n95_), .c(new_n108_), .O(z11));
  nand2  g66(.a(new_n67_), .b(new_n70_), .O(new_n110_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g68(.a(new_n49_), .b(x17), .c(new_n99_), .O(new_n112_));
  ...
  nand2  g74(.a(new_n45_), .b(new_n49_), .O(new_n118_));
  nor2   g75(.a(new_n118_), .b(new_n47_), .O(z13));
  nor2   g76(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g77(.a(new_n54_), .b(x01), .c(new_n99_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n99_), .c(new_n69_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n68_), .c(new_n122_), .O(z15));
  nor2   g80(.a(new_n69_), .b(x00), .O(z16));
