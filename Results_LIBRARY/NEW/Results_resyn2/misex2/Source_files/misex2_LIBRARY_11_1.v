...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n95_, new_n96_, new_n97_, new_n100_, new_n101_, new_n103_,
    new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    new_n111_, new_n112_, new_n114_, new_n117_, new_n118_;
  ...
  nand4  g45(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n63_), .O(new_n89_));
  inv1   g46(.a(new_n89_), .O(new_n90_));
  nor2   g47(.a(new_n85_), .b(x16), .O(new_n91_));
  inv1   g48(.a(x15), .O(new_n92_));
  nand3  g49(.a(new_n92_), .b(x02), .c(new_n69_), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n91_), .c(new_n90_), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(new_n68_), .O(new_n97_));
  aoi21  g54(.a(new_n95_), .b(new_n86_), .c(new_n97_), .O(z09));
  inv1   g55(.a(new_n82_), .O(z17));
  nand3  g56(.a(new_n90_), .b(z17), .c(x15), .O(new_n100_));
  nand3  g57(.a(new_n96_), .b(x20), .c(x16), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(new_n100_), .O(z10));
  nand2  g59(.a(new_n91_), .b(new_n96_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n100_), .O(z11));
  nand2  g61(.a(new_n67_), .b(new_n70_), .O(new_n105_));
  oai21  g62(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  inv1   g63(.a(x02), .O(new_n107_));
  nand3  g64(.a(new_n49_), .b(x17), .c(new_n107_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n81_), .O(new_n110_));
  inv1   g67(.a(x24), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(x09), .O(new_n112_));
  aoi21  g69(.a(new_n110_), .b(new_n105_), .c(new_n112_), .O(z12));
  nand2  g70(.a(new_n45_), .b(new_n49_), .O(new_n114_));
  nor2   g71(.a(new_n114_), .b(new_n47_), .O(z13));
  nor2   g72(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g73(.a(new_n54_), .b(x01), .c(new_n107_), .O(new_n117_));
  nand3  g74(.a(x19), .b(new_n107_), .c(new_n69_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n68_), .c(new_n118_), .O(z15));
