...
module FAU ( 
  ...
  nand2  g23(.a(x10), .b(new_n44_), .O(new_n67_));
  nand3  g24(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nor4   g25(.a(new_n68_), .b(new_n67_), .c(x12), .d(x11), .O(z04));
  nor3   g26(.a(new_n68_), .b(new_n57_), .c(new_n44_), .O(z05));
  inv1   g27(.a(x12), .O(new_n71_));
  inv1   g28(.a(new_n61_), .O(new_n72_));
  nand2  g29(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(x01), .c(new_n60_), .O(z07));
  ...
  nor2   g39(.a(x20), .b(new_n46_), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n64_), .O(new_n84_));
  inv1   g41(.a(x13), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(x12), .c(x02), .d(new_n46_), .O(new_n86_));
  ...
  nand3  g50(.a(new_n93_), .b(new_n92_), .c(new_n45_), .O(new_n94_));
  aoi21  g51(.a(new_n91_), .b(new_n84_), .c(new_n94_), .O(z09));
  nand4  g52(.a(new_n83_), .b(new_n64_), .c(x22), .d(x21), .O(new_n96_));
  inv1   g53(.a(x15), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(x14), .O(new_n98_));
  nand4  g55(.a(new_n93_), .b(new_n92_), .c(x20), .d(x16), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n98_), .c(new_n87_), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n96_), .c(x00), .O(z10));
  nand3  g59(.a(new_n83_), .b(new_n64_), .c(x21), .O(new_n103_));
  inv1   g60(.a(x16), .O(new_n104_));
  nand3  g61(.a(new_n92_), .b(x20), .c(new_n104_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n98_), .c(new_n87_), .O(new_n107_));
  nand2  g64(.a(new_n93_), .b(new_n45_), .O(new_n108_));
  aoi21  g65(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z11));
  ...
  aoi21  g75(.a(new_n116_), .b(new_n114_), .c(new_n118_), .O(z12));
  nor2   g76(.a(new_n112_), .b(new_n47_), .O(z13));
  nor2   g77(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g78(.a(new_n57_), .b(x01), .c(new_n111_), .O(new_n122_));
  nand3  g79(.a(x19), .b(new_n111_), .c(new_n46_), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n45_), .c(new_n123_), .O(z15));
  nor2   g81(.a(new_n46_), .b(x00), .O(z16));
  inv1   g82(.a(new_n80_), .O(z17));
endmodule
