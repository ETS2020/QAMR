...
module FAU ( 
  ...
  nand3  g52(.a(new_n95_), .b(new_n91_), .c(new_n87_), .O(new_n96_));
  inv1   g53(.a(x22), .O(new_n97_));
  nor2   g54(.a(x20), .b(new_n46_), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n64_), .c(new_n97_), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n45_), .O(new_n101_));
  aoi21  g58(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(z09));
  nor2   g59(.a(x21), .b(new_n87_), .O(new_n103_));
  nand4  g60(.a(new_n97_), .b(x20), .c(x16), .d(new_n92_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n103_), .c(new_n91_), .O(new_n106_));
  nor2   g63(.a(new_n100_), .b(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n64_), .c(x22), .d(x01), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n106_), .c(x00), .O(z10));
  nand3  g66(.a(new_n103_), .b(new_n95_), .c(new_n91_), .O(new_n110_));
  nand4  g67(.a(new_n107_), .b(new_n64_), .c(new_n97_), .d(x01), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(x00), .O(z11));
