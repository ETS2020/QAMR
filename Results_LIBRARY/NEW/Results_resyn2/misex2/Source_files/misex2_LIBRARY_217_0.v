...
module FAU ( 
  ...
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(x12), .d(new_n66_), .O(new_n92_));
  ...
  inv1   g56(.a(new_n87_), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(x22), .c(x21), .O(new_n101_));
  nand4  g58(.a(new_n97_), .b(new_n96_), .c(x16), .d(x15), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n93_), .c(new_n89_), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n101_), .c(x00), .O(z10));
  nand2  g62(.a(new_n97_), .b(new_n45_), .O(new_n106_));
  nand2  g63(.a(new_n100_), .b(x21), .O(new_n107_));
  inv1   g64(.a(x16), .O(new_n108_));
  nand3  g65(.a(new_n96_), .b(new_n108_), .c(x15), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n93_), .c(new_n89_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(new_n106_), .O(z11));
  nand2  g69(.a(new_n70_), .b(new_n71_), .O(new_n113_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g71(.a(new_n52_), .b(x17), .c(new_n88_), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n88_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n88_), .c(new_n46_), .O(new_n124_));
