...
module FAU ( 
  ...
  nand3  g55(.a(new_n98_), .b(new_n94_), .c(new_n90_), .O(new_n99_));
  inv1   g56(.a(x20), .O(new_n100_));
  nor2   g57(.a(x21), .b(new_n46_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n64_), .c(new_n100_), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n99_), .c(new_n88_), .O(z09));
  nand4  g60(.a(new_n64_), .b(x22), .c(x21), .d(new_n100_), .O(new_n104_));
  nand4  g61(.a(new_n87_), .b(x20), .c(x16), .d(x15), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n94_), .c(new_n90_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n104_), .c(x00), .O(z10));
  nand3  g65(.a(new_n64_), .b(x21), .c(new_n100_), .O(new_n109_));
  nand3  g66(.a(x20), .b(new_n96_), .c(x15), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n94_), .c(new_n90_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n109_), .c(new_n88_), .O(z11));
  nand2  g70(.a(new_n71_), .b(new_n72_), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g72(.a(new_n52_), .b(x17), .c(new_n89_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  ...
  aoi21  g80(.a(new_n57_), .b(x01), .c(new_n89_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n89_), .c(new_n46_), .O(new_n125_));
