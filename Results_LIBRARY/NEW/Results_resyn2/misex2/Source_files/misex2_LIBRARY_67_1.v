...
module FAU ( 
  ...
  nor2   g46(.a(x21), .b(new_n89_), .O(new_n90_));
  inv1   g47(.a(x15), .O(new_n91_));
  inv1   g48(.a(x16), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x02), .d(new_n69_), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n90_), .c(new_n88_), .O(new_n95_));
  nand4  g52(.a(new_n89_), .b(new_n49_), .c(x18), .d(x01), .O(new_n96_));
  inv1   g53(.a(x22), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n68_), .O(new_n98_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n98_), .O(z09));
  inv1   g56(.a(new_n82_), .O(z17));
  nand3  g57(.a(new_n88_), .b(z17), .c(x15), .O(new_n101_));
  nand3  g58(.a(new_n90_), .b(new_n97_), .c(x16), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(new_n101_), .O(z10));
  nand3  g60(.a(new_n90_), .b(new_n97_), .c(new_n92_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n101_), .O(z11));
  nand2  g62(.a(new_n67_), .b(new_n70_), .O(new_n106_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  inv1   g64(.a(x02), .O(new_n108_));
  nand3  g65(.a(new_n49_), .b(x17), .c(new_n108_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n81_), .O(new_n111_));
  inv1   g68(.a(x24), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(x09), .O(new_n113_));
  aoi21  g70(.a(new_n111_), .b(new_n106_), .c(new_n113_), .O(z12));
  nand2  g71(.a(new_n45_), .b(new_n49_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(new_n47_), .O(z13));
  nor2   g73(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g74(.a(new_n54_), .b(x01), .c(new_n108_), .O(new_n118_));
  nand3  g75(.a(x19), .b(new_n108_), .c(new_n69_), .O(new_n119_));
  oai21  g76(.a(new_n118_), .b(new_n68_), .c(new_n119_), .O(z15));
  nor2   g77(.a(new_n69_), .b(x00), .O(z16));
endmodule
