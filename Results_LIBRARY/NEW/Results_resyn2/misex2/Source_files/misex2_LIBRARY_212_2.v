...
module FAU ( 
  ...
  nor2   g42(.a(new_n71_), .b(x00), .O(z16));
  nand2  g43(.a(z16), .b(new_n62_), .O(new_n87_));
  inv1   g44(.a(x21), .O(new_n88_));
  inv1   g45(.a(x22), .O(new_n89_));
  nand2  g46(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n87_), .O(z09));
  nor2   g48(.a(new_n88_), .b(x20), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(z16), .c(new_n62_), .d(x22), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(z10));
  nand4  g51(.a(new_n92_), .b(z16), .c(new_n62_), .d(new_n89_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(z11));
  nand2  g53(.a(new_n69_), .b(new_n72_), .O(new_n97_));
  oai21  g54(.a(x19), .b(x02), .c(x23), .O(new_n98_));
  nand3  g55(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(new_n46_), .O(new_n101_));
  inv1   g58(.a(x24), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(x09), .O(new_n103_));
  aoi21  g60(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(z12));
  nor3   g61(.a(new_n99_), .b(x01), .c(x00), .O(z13));
  nor2   g62(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n107_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n108_));
  oai21  g65(.a(new_n107_), .b(new_n70_), .c(new_n108_), .O(z15));
