...
module FAU ( 
  ...
  nand4  g20(.a(new_n63_), .b(x18), .c(new_n48_), .d(new_n62_), .O(new_n64_));
  nand2  g21(.a(new_n64_), .b(new_n61_), .O(z03));
  inv1   g22(.a(x11), .O(new_n66_));
  inv1   g23(.a(x12), .O(new_n67_));
  nand4  g24(.a(new_n67_), .b(new_n66_), .c(x10), .d(new_n45_), .O(new_n68_));
  nor2   g25(.a(new_n68_), .b(new_n58_), .O(z04));
  nand2  g26(.a(x10), .b(x02), .O(new_n70_));
  inv1   g27(.a(x01), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n62_), .O(new_n72_));
  nand2  g29(.a(new_n72_), .b(x09), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n70_), .O(z05));
  inv1   g31(.a(new_n59_), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(new_n67_), .O(new_n76_));
  ...
  nor2   g42(.a(new_n67_), .b(x11), .O(new_n86_));
  nor2   g43(.a(x14), .b(x13), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(new_n86_), .c(new_n46_), .d(x02), .O(new_n88_));
  inv1   g45(.a(x15), .O(new_n89_));
  inv1   g46(.a(x16), .O(new_n90_));
  inv1   g47(.a(x21), .O(new_n91_));
  inv1   g48(.a(x22), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x20), .d(new_n90_), .O(new_n93_));
  inv1   g50(.a(new_n93_), .O(new_n94_));
  nand2  g51(.a(new_n94_), .b(new_n89_), .O(new_n95_));
  nor2   g52(.a(new_n95_), .b(new_n88_), .O(z09));
  inv1   g53(.a(new_n83_), .O(z17));
  ...
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(x20), .d(x16), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n101_), .c(z17), .d(x15), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z10));
  nand4  g62(.a(new_n94_), .b(new_n101_), .c(z17), .d(x15), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z11));
  nand2  g64(.a(new_n70_), .b(new_n72_), .O(new_n108_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g66(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n46_), .O(new_n112_));
  inv1   g69(.a(x24), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(x09), .O(new_n114_));
  aoi21  g71(.a(new_n112_), .b(new_n108_), .c(new_n114_), .O(z12));
  nor3   g72(.a(new_n110_), .b(x01), .c(x00), .O(z13));
  nor2   g73(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g74(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n118_));
  nand3  g75(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n119_));
  oai21  g76(.a(new_n118_), .b(new_n62_), .c(new_n119_), .O(z15));
  nor2   g77(.a(new_n71_), .b(x00), .O(z16));
endmodule
