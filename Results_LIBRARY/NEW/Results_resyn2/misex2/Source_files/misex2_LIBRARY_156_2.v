...
module FAU ( 
  ...
  nand4  g56(.a(new_n87_), .b(new_n64_), .c(x22), .d(x21), .O(new_n100_));
  inv1   g57(.a(x15), .O(new_n101_));
  nor2   g58(.a(new_n101_), .b(x14), .O(new_n102_));
  nand2  g59(.a(x16), .b(new_n46_), .O(new_n103_));
  nand3  g60(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n102_), .c(new_n91_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n100_), .c(x00), .O(z10));
  nand2  g64(.a(new_n97_), .b(new_n45_), .O(new_n108_));
  nand3  g65(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n109_));
  inv1   g66(.a(x16), .O(new_n110_));
  nand3  g67(.a(new_n96_), .b(x20), .c(new_n110_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n102_), .c(new_n91_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(new_n108_), .O(z11));
  nand2  g71(.a(new_n71_), .b(new_n72_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  inv1   g73(.a(x02), .O(new_n117_));
  nand3  g74(.a(new_n52_), .b(x17), .c(new_n117_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n83_), .O(new_n120_));
  inv1   g77(.a(x24), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(x09), .O(new_n122_));
  aoi21  g79(.a(new_n120_), .b(new_n115_), .c(new_n122_), .O(z12));
  nor2   g80(.a(new_n118_), .b(new_n47_), .O(z13));
  nor2   g81(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g82(.a(new_n57_), .b(x01), .c(new_n117_), .O(new_n126_));
  nand3  g83(.a(x19), .b(new_n117_), .c(new_n46_), .O(new_n127_));
