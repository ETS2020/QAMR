...
module FAU ( 
  ...
  nand2  g43(.a(new_n86_), .b(new_n45_), .O(new_n87_));
  inv1   g44(.a(x15), .O(new_n88_));
  inv1   g45(.a(x13), .O(new_n89_));
  inv1   g46(.a(x14), .O(new_n90_));
  inv1   g47(.a(x16), .O(new_n91_));
  nand4  g48(.a(x20), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(new_n93_));
  nand4  g50(.a(x12), .b(new_n66_), .c(x02), .d(new_n46_), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(new_n96_));
  inv1   g53(.a(x21), .O(new_n97_));
  nor2   g54(.a(x20), .b(x19), .O(new_n98_));
  nor2   g55(.a(new_n51_), .b(new_n46_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  aoi21  g57(.a(new_n100_), .b(new_n96_), .c(new_n87_), .O(z09));
  nand3  g58(.a(x20), .b(new_n90_), .c(new_n89_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n86_), .b(new_n97_), .c(x16), .d(x15), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n95_), .c(new_n103_), .O(new_n106_));
  nand4  g63(.a(new_n99_), .b(new_n98_), .c(x22), .d(x21), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n106_), .c(x00), .O(z10));
  nand3  g65(.a(new_n99_), .b(new_n98_), .c(x21), .O(new_n109_));
  nand3  g66(.a(new_n95_), .b(new_n93_), .c(x15), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n109_), .c(new_n87_), .O(z11));
  nand2  g68(.a(new_n70_), .b(new_n71_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  inv1   g70(.a(x02), .O(new_n114_));
  nand3  g71(.a(new_n52_), .b(x17), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n114_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n114_), .c(new_n46_), .O(new_n124_));
