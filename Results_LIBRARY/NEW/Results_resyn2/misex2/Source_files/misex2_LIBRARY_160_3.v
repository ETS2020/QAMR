// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:51 2020
...
module FAU ( 
  ...
  nand4  g22(.a(new_n65_), .b(new_n64_), .c(x10), .d(new_n44_), .O(new_n66_));
  nor2   g23(.a(new_n66_), .b(new_n57_), .O(z04));
  nand2  g24(.a(x10), .b(x02), .O(new_n68_));
  inv1   g25(.a(x00), .O(new_n69_));
  inv1   g26(.a(x01), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g28(.a(new_n71_), .b(x09), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n68_), .O(z05));
  inv1   g30(.a(new_n58_), .O(new_n74_));
  nand2  g31(.a(new_n74_), .b(new_n65_), .O(new_n75_));
  ...
  nand2  g42(.a(x02), .b(new_n70_), .O(new_n86_));
  inv1   g43(.a(x13), .O(new_n87_));
  nand3  g44(.a(new_n87_), .b(x12), .c(new_n64_), .O(new_n88_));
  ...
  nand4  g50(.a(new_n91_), .b(new_n49_), .c(x18), .d(x01), .O(new_n94_));
  inv1   g51(.a(x21), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n69_), .O(new_n97_));
  aoi21  g54(.a(new_n94_), .b(new_n93_), .c(new_n97_), .O(z09));
  nand4  g55(.a(x21), .b(new_n91_), .c(x18), .d(x01), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand2  g57(.a(new_n100_), .b(x22), .O(new_n101_));
  inv1   g58(.a(x14), .O(new_n102_));
  nand4  g59(.a(new_n95_), .b(x20), .c(x15), .d(new_n102_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  inv1   g61(.a(x16), .O(new_n105_));
  nor2   g62(.a(x22), .b(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n104_), .c(new_n89_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n101_), .c(x00), .O(z10));
  nand2  g65(.a(new_n96_), .b(new_n69_), .O(new_n109_));
  nand3  g66(.a(new_n104_), .b(new_n89_), .c(new_n105_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n99_), .c(new_n109_), .O(z11));
  nand2  g68(.a(new_n68_), .b(new_n71_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  inv1   g70(.a(x02), .O(new_n114_));
  nand3  g71(.a(new_n49_), .b(x17), .c(new_n114_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n82_), .O(new_n117_));
  inv1   g74(.a(x24), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(x09), .O(new_n119_));
  aoi21  g76(.a(new_n117_), .b(new_n112_), .c(new_n119_), .O(z12));
  nor2   g77(.a(new_n61_), .b(new_n47_), .O(z13));
  nor2   g78(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g79(.a(new_n54_), .b(x01), .c(new_n114_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n114_), .c(new_n70_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n69_), .c(new_n124_), .O(z15));
  nor2   g82(.a(new_n70_), .b(x00), .O(z16));
