...
module FAU ( 
  ...
  aoi21  g26(.a(new_n43_), .b(x9), .c(new_n41_), .O(new_n44_));
  ...
  nand2  g32(.a(x9), .b(new_n42_), .O(new_n50_));
  aoi21  g33(.a(new_n36_), .b(x8), .c(x7), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n50_), .c(new_n41_), .O(new_n52_));
