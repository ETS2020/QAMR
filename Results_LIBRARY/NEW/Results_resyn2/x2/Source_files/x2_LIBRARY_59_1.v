// Benchmark "FAU" written by ABC on Mon Jul 27 18:02:41 2020
...
module FAU ( 
  ...
  nand3  g13(.a(new_n24_), .b(x7), .c(x6), .O(z4));
  ...
  nand4  g30(.a(new_n47_), .b(new_n24_), .c(new_n22_), .d(x7), .O(new_n48_));
  nand2  g31(.a(new_n37_), .b(new_n22_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(x6), .O(z6));
endmodule
