...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n21_, new_n24_, new_n25_, new_n27_, new_n28_,
  ...
  nand3  g13(.a(x8), .b(new_n24_), .c(x5), .O(new_n31_));
  nor2   g14(.a(x8), .b(new_n24_), .O(new_n32_));
  ...
  aoi21  g24(.a(new_n41_), .b(new_n27_), .c(new_n38_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n37_), .O(z5));
  nand2  g26(.a(x9), .b(new_n18_), .O(new_n44_));
  ...
  nor2   g30(.a(new_n19_), .b(x7), .O(new_n48_));
  inv1   g31(.a(x5), .O(new_n49_));
  nand2  g32(.a(x8), .b(new_n49_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(new_n44_), .O(new_n51_));
  aoi21  g34(.a(new_n28_), .b(new_n25_), .c(new_n38_), .O(new_n52_));
