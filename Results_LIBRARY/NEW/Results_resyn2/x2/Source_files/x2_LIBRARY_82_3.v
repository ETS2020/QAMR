// Benchmark "FAU" written by ABC on Mon Jul 27 18:02:47 2020
...
module FAU ( 
  ...
  nor3   g13(.a(x8), .b(x7), .c(x1), .O(new_n31_));
  nand3  g14(.a(x9), .b(x8), .c(x7), .O(new_n32_));
  inv1   g15(.a(new_n32_), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nor2   g17(.a(new_n34_), .b(x0), .O(new_n35_));
  oai21  g18(.a(new_n33_), .b(new_n31_), .c(new_n35_), .O(new_n36_));
  ...
  aoi21  g26(.a(new_n43_), .b(new_n22_), .c(new_n41_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n40_), .c(new_n36_), .O(z5));
  oai21  g28(.a(x2), .b(x0), .c(x8), .O(new_n46_));
  ...
  aoi21  g34(.a(new_n51_), .b(new_n22_), .c(new_n41_), .O(new_n52_));
