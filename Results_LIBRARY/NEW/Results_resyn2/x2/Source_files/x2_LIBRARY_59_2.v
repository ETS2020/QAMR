...
module FAU ( 
  ...
  nand4  g14(.a(x9), .b(x8), .c(x7), .d(new_n31_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n24_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(x2), .c(new_n26_), .O(new_n34_));
  ...
  nand3  g27(.a(new_n27_), .b(new_n26_), .c(new_n31_), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(x8), .c(new_n35_), .O(new_n46_));
  nand4  g29(.a(new_n35_), .b(x8), .c(x4), .d(x3), .O(new_n47_));
  inv1   g30(.a(new_n47_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n46_), .c(x7), .O(new_n49_));
  oai21  g32(.a(x9), .b(x8), .c(new_n41_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n23_), .c(new_n40_), .O(new_n51_));
