...
module FAU ( 
  ...
  aoi21  g25(.a(new_n42_), .b(new_n22_), .c(new_n40_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n39_), .c(new_n35_), .O(z5));
  oai21  g27(.a(x2), .b(x1), .c(x8), .O(new_n45_));
  ...
  oai21  g32(.a(x9), .b(x8), .c(new_n41_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n22_), .c(new_n40_), .O(new_n51_));
