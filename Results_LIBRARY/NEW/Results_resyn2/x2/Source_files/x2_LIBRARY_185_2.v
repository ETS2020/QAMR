// Benchmark "FAU" written by ABC on Mon Jul 27 18:03:10 2020
...
module FAU ( 
  ...
  nand3  g08(.a(new_n25_), .b(new_n19_), .c(new_n24_), .O(z3));
  ...
  nand3  g20(.a(new_n37_), .b(new_n25_), .c(x2), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n33_), .d(x6), .O(z5));
  ...
  aoi21  g26(.a(new_n43_), .b(x8), .c(new_n29_), .O(new_n44_));
  ...
  oai21  g31(.a(x9), .b(x8), .c(new_n34_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n24_), .c(new_n48_), .O(new_n50_));
