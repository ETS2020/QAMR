...
module FAU ( 
  ...
  oai21  g25(.a(x2), .b(x1), .c(x8), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x9), .O(new_n44_));
  nand4  g27(.a(new_n33_), .b(x8), .c(x4), .d(x3), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x7), .O(new_n47_));
  oai21  g30(.a(x9), .b(x8), .c(new_n39_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n24_), .c(new_n38_), .O(new_n49_));
