...
module FAU ( 
  ...
  nand2  g16(.a(x6), .b(new_n23_), .O(new_n32_));
  ...
  nor2   g20(.a(x4), .b(x2), .O(new_n36_));
  nor2   g21(.a(x3), .b(new_n23_), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(x1), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n35_), .c(new_n18_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n30_), .O(z2));
  nand2  g25(.a(new_n37_), .b(new_n29_), .O(new_n41_));
  nand2  g26(.a(x7), .b(x4), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n23_), .c(new_n16_), .O(new_n43_));
  nand3  g28(.a(new_n26_), .b(new_n19_), .c(x2), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x1), .c(new_n18_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n43_), .c(new_n41_), .O(z3));
  xor2a  g32(.a(x3), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  nand2  g34(.a(new_n26_), .b(new_n19_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x2), .c(new_n18_), .O(new_n51_));
  nand3  g36(.a(new_n32_), .b(new_n19_), .c(new_n18_), .O(new_n52_));
  ...
  nand2  g42(.a(new_n51_), .b(new_n49_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  aoi21  g45(.a(new_n48_), .b(x0), .c(new_n45_), .O(new_n61_));
  nor2   g46(.a(new_n16_), .b(x0), .O(new_n62_));
  oai21  g47(.a(new_n36_), .b(x3), .c(new_n62_), .O(new_n63_));
