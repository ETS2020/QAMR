...
module FAU ( 
  ...
  nand2  g09(.a(x3), .b(new_n19_), .O(new_n25_));
  inv1   g10(.a(x5), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n16_), .O(new_n27_));
  nand3  g12(.a(new_n27_), .b(new_n25_), .c(new_n17_), .O(new_n28_));
  inv1   g13(.a(x6), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(x3), .c(new_n17_), .O(new_n30_));
  ...
  or2    g18(.a(new_n25_), .b(new_n20_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(z1));
  oai21  g20(.a(x5), .b(new_n19_), .c(x6), .O(new_n36_));
  nor2   g21(.a(x3), .b(x1), .O(new_n37_));
  inv1   g22(.a(x4), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(new_n16_), .c(new_n19_), .O(new_n39_));
  aoi21  g24(.a(new_n16_), .b(x2), .c(new_n17_), .O(new_n40_));
  aoi22  g25(.a(new_n40_), .b(new_n39_), .c(new_n37_), .d(new_n36_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(x0), .c(new_n34_), .O(z2));
  nand2  g27(.a(new_n16_), .b(x2), .O(new_n43_));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n19_), .c(new_n17_), .O(new_n45_));
  nand3  g30(.a(new_n26_), .b(new_n16_), .c(x2), .O(new_n46_));
  inv1   g31(.a(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(x1), .c(new_n24_), .O(new_n48_));
  oai22  g33(.a(new_n48_), .b(new_n45_), .c(new_n43_), .d(new_n20_), .O(z3));
  aoi21  g34(.a(new_n43_), .b(new_n25_), .c(new_n24_), .O(new_n50_));
  oai21  g35(.a(new_n29_), .b(x5), .c(new_n16_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n19_), .c(x0), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n50_), .c(new_n17_), .O(new_n53_));
  nand3  g38(.a(new_n43_), .b(new_n30_), .c(new_n24_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(z4));
  nand3  g40(.a(new_n27_), .b(new_n25_), .c(new_n24_), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n50_), .c(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(z5));
  oai21  g44(.a(new_n50_), .b(new_n47_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n39_), .b(new_n16_), .O(new_n61_));
