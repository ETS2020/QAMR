...
module FAU ( 
  ...
  nor2   g26(.a(new_n23_), .b(x1), .O(new_n42_));
  aoi22  g27(.a(new_n42_), .b(new_n41_), .c(new_n40_), .d(new_n39_), .O(new_n43_));
  inv1   g28(.a(x7), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n23_), .c(new_n18_), .O(new_n45_));
  oai21  g30(.a(new_n43_), .b(x3), .c(new_n45_), .O(z3));
  ...
  nand2  g35(.a(new_n26_), .b(new_n19_), .O(new_n51_));
  ...
  nand2  g42(.a(new_n52_), .b(new_n50_), .O(new_n58_));
  ...
  oai21  g47(.a(new_n40_), .b(x3), .c(new_n39_), .O(new_n63_));
