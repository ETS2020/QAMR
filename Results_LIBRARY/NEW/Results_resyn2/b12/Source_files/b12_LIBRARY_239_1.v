...
module FAU ( 
  ...
  oai21  g33(.a(new_n57_), .b(x09), .c(x12), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n56_), .c(x13), .d(new_n41_), .O(z5));
  ...
  oai21  g45(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n56_), .O(z7));
  nand2  g47(.a(new_n45_), .b(x00), .O(new_n72_));
  inv1   g48(.a(x12), .O(new_n73_));
  nand4  g49(.a(new_n60_), .b(new_n73_), .c(x09), .d(x03), .O(new_n74_));
