...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n60_, new_n61_, new_n62_, new_n64_, new_n66_;
  ...
  nand3  g21(.a(new_n45_), .b(new_n41_), .c(new_n29_), .O(new_n46_));
  ...
  nor2   g28(.a(new_n49_), .b(new_n35_), .O(new_n53_));
  ...
  oai22  g36(.a(new_n60_), .b(new_n31_), .c(new_n26_), .d(new_n59_), .O(new_n61_));
  oai21  g37(.a(new_n49_), .b(new_n35_), .c(new_n56_), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n35_), .c(new_n62_), .O(z6));
  nand4  g39(.a(x09), .b(x03), .c(new_n30_), .d(new_n29_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n50_), .c(new_n56_), .O(z7));
