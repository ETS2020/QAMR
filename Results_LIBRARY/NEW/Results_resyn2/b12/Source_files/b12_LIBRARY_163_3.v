// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:50 2020
...
module FAU ( 
  ...
  nand2  g27(.a(x08), .b(new_n42_), .O(new_n52_));
  nand3  g28(.a(x11), .b(x10), .c(new_n29_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nor2   g30(.a(new_n45_), .b(new_n41_), .O(new_n55_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n46_), .c(new_n42_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n63_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(z6));
  nand3  g45(.a(new_n60_), .b(x09), .c(x03), .O(new_n70_));
  oai21  g46(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(z7));
  nand2  g48(.a(new_n45_), .b(x00), .O(new_n73_));
  nand4  g49(.a(new_n60_), .b(new_n57_), .c(x09), .d(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n58_), .O(z8));
endmodule
