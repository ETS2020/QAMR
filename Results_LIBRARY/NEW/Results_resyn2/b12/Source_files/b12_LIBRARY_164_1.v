...
module FAU ( 
  ...
  nand3  g36(.a(new_n60_), .b(new_n52_), .c(new_n56_), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n59_), .O(z6));
  oai21  g38(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n63_));
  nand4  g39(.a(x09), .b(x03), .c(new_n30_), .d(new_n29_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n56_), .O(z7));
  nand2  g41(.a(new_n45_), .b(x00), .O(new_n66_));
