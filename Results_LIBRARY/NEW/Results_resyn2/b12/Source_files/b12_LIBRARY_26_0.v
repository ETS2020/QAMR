// Benchmark "FAU" written by ABC on Mon Jul 27 21:36:41 2020
...
module FAU ( 
  ...
  nor2   g35(.a(x14), .b(x00), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n52_), .c(new_n57_), .O(new_n63_));
  aoi21  g39(.a(new_n61_), .b(new_n59_), .c(new_n63_), .O(z6));
  nor2   g40(.a(x02), .b(x01), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(x09), .c(x03), .O(new_n66_));
  oai21  g42(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n57_), .O(z7));
  nand2  g44(.a(new_n45_), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n65_), .b(new_n56_), .c(x09), .d(x03), .O(new_n70_));
