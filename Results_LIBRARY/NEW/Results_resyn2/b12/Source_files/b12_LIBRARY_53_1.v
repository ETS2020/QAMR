...
module FAU ( 
  ...
  nor2   g27(.a(new_n43_), .b(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n45_), .b(x07), .O(new_n53_));
  ...
  inv1   g33(.a(new_n28_), .O(new_n58_));
  xnor2a g34(.a(x09), .b(x03), .O(new_n59_));
  oai21  g35(.a(new_n43_), .b(new_n41_), .c(new_n55_), .O(new_n60_));
  aoi21  g36(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z6));
  nand4  g37(.a(x09), .b(x03), .c(new_n27_), .d(new_n26_), .O(new_n62_));
  nand3  g38(.a(x03), .b(new_n27_), .c(new_n26_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n43_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n55_), .O(z7));
  oai21  g41(.a(new_n63_), .b(x12), .c(x09), .O(new_n66_));
  nand2  g42(.a(new_n45_), .b(new_n41_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n55_), .O(z8));
endmodule
