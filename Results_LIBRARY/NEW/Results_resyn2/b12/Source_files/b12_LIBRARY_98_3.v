// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:16 2020
...
module FAU ( 
  ...
  aoi21  g25(.a(new_n49_), .b(new_n32_), .c(new_n44_), .O(z2));
  ...
  nand4  g32(.a(new_n46_), .b(x13), .c(new_n56_), .d(new_n41_), .O(z5));
  aoi21  g33(.a(x03), .b(new_n32_), .c(x01), .O(new_n58_));
  nand3  g34(.a(x02), .b(x01), .c(new_n41_), .O(new_n59_));
  oai21  g35(.a(new_n58_), .b(new_n43_), .c(new_n59_), .O(new_n60_));
  nand2  g36(.a(new_n45_), .b(x03), .O(new_n61_));
  nand2  g37(.a(x09), .b(new_n26_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n27_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n52_), .c(new_n46_), .O(new_n64_));
  aoi21  g40(.a(new_n60_), .b(x14), .c(new_n64_), .O(z6));
  aoi21  g41(.a(new_n27_), .b(x03), .c(new_n43_), .O(new_n66_));
  nand3  g42(.a(new_n27_), .b(new_n45_), .c(x03), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n46_), .O(z7));
  nand2  g45(.a(new_n27_), .b(x03), .O(new_n70_));
  nand2  g46(.a(new_n56_), .b(x09), .O(new_n71_));
  oai22  g47(.a(new_n71_), .b(new_n70_), .c(x09), .d(new_n41_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n46_), .O(z8));
endmodule
