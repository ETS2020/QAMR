...
module FAU ( 
  ...
  nand3  g23(.a(new_n47_), .b(new_n45_), .c(new_n28_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n29_), .c(new_n42_), .O(z2));
  aoi22  g25(.a(x12), .b(new_n34_), .c(x11), .d(x07), .O(z3));
  nor2   g26(.a(new_n41_), .b(new_n34_), .O(new_n51_));
  nor2   g27(.a(new_n43_), .b(x07), .O(new_n52_));
  aoi22  g28(.a(new_n52_), .b(new_n51_), .c(x11), .d(x07), .O(z4));
  nor2   g29(.a(x12), .b(x00), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n44_), .c(x13), .O(z5));
  aoi21  g31(.a(x03), .b(new_n29_), .c(x01), .O(new_n56_));
  nand2  g32(.a(new_n43_), .b(x03), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n29_), .c(x01), .O(new_n58_));
  oai21  g34(.a(new_n56_), .b(x00), .c(new_n58_), .O(new_n59_));
  inv1   g35(.a(new_n51_), .O(new_n60_));
  nand2  g36(.a(x09), .b(new_n35_), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n57_), .c(new_n29_), .d(new_n28_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n60_), .c(new_n44_), .O(new_n63_));
  aoi21  g39(.a(new_n59_), .b(x14), .c(new_n63_), .O(z6));
  inv1   g40(.a(x10), .O(new_n65_));
  inv1   g41(.a(x14), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(x01), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n29_), .c(x07), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n35_), .c(new_n41_), .O(new_n69_));
  nand3  g45(.a(x03), .b(new_n29_), .c(new_n28_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(x09), .c(new_n46_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n69_), .O(z7));
  oai21  g49(.a(new_n70_), .b(x12), .c(x09), .O(new_n74_));
  nand2  g50(.a(new_n43_), .b(new_n34_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n44_), .O(z8));
endmodule
