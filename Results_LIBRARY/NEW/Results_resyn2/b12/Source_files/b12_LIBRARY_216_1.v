...
module FAU ( 
  ...
  oai21  g26(.a(new_n44_), .b(new_n38_), .c(new_n50_), .O(z2));
  aoi22  g27(.a(x12), .b(new_n41_), .c(x11), .d(x07), .O(z3));
  inv1   g28(.a(new_n46_), .O(new_n53_));
  nor2   g29(.a(new_n47_), .b(x07), .O(new_n54_));
  ...
  inv1   g34(.a(x01), .O(new_n59_));
  nand3  g35(.a(x14), .b(x02), .c(new_n41_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n42_), .c(new_n59_), .O(new_n61_));
  nand2  g37(.a(x09), .b(new_n26_), .O(new_n62_));
  nand2  g38(.a(new_n47_), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n27_), .O(new_n64_));
  aoi21  g40(.a(x08), .b(x00), .c(x10), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(new_n61_), .O(z6));
  nand3  g43(.a(new_n27_), .b(x09), .c(x03), .O(new_n68_));
  nand2  g44(.a(new_n27_), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n43_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n56_), .O(z7));
  nand2  g47(.a(new_n47_), .b(x00), .O(new_n72_));
  oai21  g48(.a(new_n68_), .b(x12), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n56_), .O(z8));
endmodule
