// Benchmark "FAU" written by ABC on Mon Jul 27 21:36:47 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n49_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
  ...
  nand2  g26(.a(x12), .b(new_n41_), .O(z3));
  nand4  g27(.a(x09), .b(x08), .c(new_n42_), .d(x00), .O(z4));
  inv1   g28(.a(x12), .O(new_n53_));
  nor2   g29(.a(x10), .b(x07), .O(new_n54_));
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n53_), .d(new_n41_), .O(z5));
  nor2   g31(.a(x02), .b(x01), .O(new_n56_));
  nand2  g32(.a(new_n45_), .b(x03), .O(new_n57_));
  nand2  g33(.a(x09), .b(new_n35_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n60_));
  nand2  g36(.a(x08), .b(x00), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n46_), .c(new_n42_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n60_), .c(new_n59_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(z6));
  nand3  g41(.a(new_n56_), .b(x09), .c(x03), .O(new_n66_));
  oai21  g42(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n54_), .O(z7));
  nand2  g44(.a(new_n45_), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n56_), .b(new_n53_), .c(x09), .d(x03), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n54_), .O(z8));
endmodule
