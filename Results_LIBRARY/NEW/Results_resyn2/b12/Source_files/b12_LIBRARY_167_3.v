...
module FAU ( 
  ...
  nand2  g18(.a(x07), .b(new_n36_), .O(new_n43_));
  ...
  nand3  g25(.a(new_n45_), .b(x09), .c(new_n49_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x07), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n47_), .c(new_n26_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n42_), .O(z2));
  aoi22  g29(.a(x12), .b(new_n35_), .c(x11), .d(x07), .O(z3));
  nand2  g30(.a(x08), .b(x00), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n46_), .O(new_n56_));
  aoi21  g32(.a(x11), .b(x07), .c(new_n56_), .O(z4));
  inv1   g33(.a(x12), .O(new_n58_));
  nor2   g34(.a(x07), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n58_), .d(new_n45_), .O(z5));
  nand2  g36(.a(x09), .b(new_n36_), .O(new_n61_));
  inv1   g37(.a(x09), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x03), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n61_), .c(new_n30_), .O(new_n64_));
  nand3  g40(.a(new_n28_), .b(x14), .c(new_n35_), .O(new_n65_));
  nor2   g41(.a(x10), .b(x07), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n55_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  aoi21  g44(.a(new_n30_), .b(x03), .c(new_n49_), .O(new_n69_));
  nand3  g45(.a(new_n30_), .b(new_n62_), .c(x03), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(z7));
  nand3  g48(.a(new_n30_), .b(new_n58_), .c(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x09), .O(new_n74_));
  nand2  g50(.a(new_n62_), .b(new_n35_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n66_), .O(z8));
endmodule
