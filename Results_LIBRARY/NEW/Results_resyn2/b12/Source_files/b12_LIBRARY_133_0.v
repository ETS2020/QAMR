...
module FAU ( 
  ...
  oai21  g28(.a(new_n52_), .b(new_n45_), .c(new_n42_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(x11), .O(z4));
  ...
  oai21  g43(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n56_), .O(z7));
  nand2  g45(.a(new_n45_), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n58_), .b(new_n55_), .c(x09), .d(x03), .O(new_n71_));
