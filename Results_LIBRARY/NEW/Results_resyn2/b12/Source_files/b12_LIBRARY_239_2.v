...
module FAU ( 
  ...
  nand3  g31(.a(new_n55_), .b(new_n46_), .c(x13), .O(z5));
  xnor2a g32(.a(x09), .b(x03), .O(new_n57_));
  nor2   g33(.a(x02), .b(x01), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n52_), .c(new_n46_), .O(new_n60_));
  ...
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n46_), .O(z7));
  nand2  g41(.a(new_n45_), .b(x00), .O(new_n66_));
  oai21  g42(.a(new_n62_), .b(x12), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(z8));
endmodule
