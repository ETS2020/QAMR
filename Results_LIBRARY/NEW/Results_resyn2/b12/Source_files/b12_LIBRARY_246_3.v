...
module FAU ( 
  ...
  nand3  g12(.a(new_n26_), .b(x06), .c(x05), .O(new_n37_));
  ...
  nand2  g31(.a(new_n43_), .b(x03), .O(new_n56_));
  nand2  g32(.a(x09), .b(new_n35_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n29_), .d(new_n28_), .O(new_n58_));
  nand4  g34(.a(new_n57_), .b(new_n26_), .c(x14), .d(new_n34_), .O(new_n59_));
  nand2  g35(.a(new_n50_), .b(new_n44_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n59_), .c(new_n58_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z6));
  nand3  g39(.a(x03), .b(new_n29_), .c(new_n28_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n41_), .O(new_n65_));
  nand3  g41(.a(x09), .b(x03), .c(new_n28_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n44_), .O(z7));
  oai22  g43(.a(new_n66_), .b(x12), .c(x09), .d(new_n34_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n44_), .O(z8));
endmodule
