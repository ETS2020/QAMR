// Benchmark "FAU" written by ABC on Mon Jul 27 21:36:40 2020
...
module FAU ( 
  ...
  aoi21  g23(.a(new_n47_), .b(new_n29_), .c(new_n42_), .O(z2));
  aoi22  g24(.a(x12), .b(new_n34_), .c(x11), .d(x07), .O(z3));
  ...
  nand4  g31(.a(new_n55_), .b(x13), .c(new_n54_), .d(new_n34_), .O(z5));
  xor2a  g32(.a(x09), .b(x03), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n30_), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n34_), .O(new_n59_));
  ...
  oai21  g39(.a(new_n30_), .b(new_n35_), .c(new_n41_), .O(new_n64_));
