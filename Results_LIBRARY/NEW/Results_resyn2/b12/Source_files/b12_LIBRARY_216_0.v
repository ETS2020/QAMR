...
module FAU ( 
  ...
  nand3  g18(.a(new_n36_), .b(new_n25_), .c(new_n42_), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(new_n41_), .O(z2));
  aoi22  g20(.a(x12), .b(new_n42_), .c(x11), .d(x07), .O(z3));
  inv1   g21(.a(x08), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n42_), .O(new_n47_));
  ...
  oai21  g30(.a(new_n46_), .b(new_n42_), .c(new_n51_), .O(new_n55_));
