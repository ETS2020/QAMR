...
module FAU ( 
  ...
  aoi21  g43(.a(new_n59_), .b(x03), .c(new_n43_), .O(new_n68_));
  nand3  g44(.a(new_n59_), .b(new_n45_), .c(x03), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n57_), .O(z7));
  nand3  g47(.a(new_n59_), .b(new_n56_), .c(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x09), .O(new_n73_));
  nand2  g49(.a(new_n45_), .b(new_n41_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n57_), .O(z8));
endmodule
