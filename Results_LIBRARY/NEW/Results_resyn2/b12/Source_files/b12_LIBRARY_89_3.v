...
module FAU ( 
  ...
  nand3  g28(.a(x09), .b(x08), .c(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  aoi21  g30(.a(x11), .b(x07), .c(new_n54_), .O(z4));
  nand3  g31(.a(new_n52_), .b(new_n46_), .c(x13), .O(z5));
  nand2  g32(.a(x09), .b(new_n31_), .O(new_n57_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n61_), .c(new_n60_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(z6));
  aoi21  g43(.a(new_n58_), .b(x03), .c(new_n43_), .O(new_n68_));
  nand3  g44(.a(new_n58_), .b(new_n45_), .c(x03), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n68_), .c(new_n46_), .O(z7));
  nand2  g47(.a(new_n58_), .b(x03), .O(new_n72_));
