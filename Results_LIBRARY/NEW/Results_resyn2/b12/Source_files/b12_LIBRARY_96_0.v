...
module FAU ( 
  ...
  nand3  g36(.a(x02), .b(x01), .c(new_n41_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n52_), .c(new_n57_), .O(new_n62_));
  aoi21  g38(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(z6));
  nand3  g39(.a(new_n59_), .b(x09), .c(x03), .O(new_n64_));
  oai21  g40(.a(new_n28_), .b(new_n35_), .c(new_n43_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z7));
  nand2  g42(.a(new_n45_), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n59_), .b(new_n56_), .c(x09), .d(x03), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n57_), .O(z8));
endmodule
