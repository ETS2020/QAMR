// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:11 2020
...
module FAU ( 
  ...
  nor2   g27(.a(new_n51_), .b(x12), .O(new_n52_));
  ...
  aoi21  g32(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(z4));
  ...
  nand3  g41(.a(new_n54_), .b(new_n46_), .c(new_n42_), .O(new_n66_));
  ...
  nand4  g49(.a(new_n61_), .b(new_n58_), .c(x09), .d(x03), .O(new_n74_));
