...
module FAU ( 
  ...
  nand3  g30(.a(new_n54_), .b(x13), .c(new_n43_), .O(z5));
  nand3  g31(.a(x03), .b(new_n30_), .c(new_n29_), .O(new_n56_));
  nand4  g32(.a(x14), .b(x02), .c(x01), .d(new_n43_), .O(new_n57_));
  ...
  nand3  g36(.a(new_n56_), .b(new_n60_), .c(new_n41_), .O(z7));
  inv1   g37(.a(new_n56_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n54_), .O(z8));
endmodule
