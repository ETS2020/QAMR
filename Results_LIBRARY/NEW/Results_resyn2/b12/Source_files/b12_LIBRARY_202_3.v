...
module FAU ( 
  ...
  nand3  g24(.a(x07), .b(new_n36_), .c(new_n35_), .O(new_n49_));
  inv1   g25(.a(new_n49_), .O(new_n50_));
  aoi21  g26(.a(new_n48_), .b(new_n43_), .c(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(x01), .c(new_n42_), .O(z2));
  aoi22  g28(.a(x12), .b(new_n35_), .c(x11), .d(x07), .O(z3));
  inv1   g29(.a(new_n43_), .O(new_n54_));
  inv1   g30(.a(x09), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(x07), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(new_n54_), .c(x11), .d(x07), .O(z4));
  ...
  nand3  g37(.a(new_n28_), .b(x14), .c(new_n35_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n58_), .c(new_n43_), .O(new_n63_));
  aoi21  g39(.a(new_n61_), .b(new_n30_), .c(new_n63_), .O(z6));
  nand3  g40(.a(new_n30_), .b(x09), .c(x03), .O(new_n65_));
  inv1   g41(.a(x08), .O(new_n66_));
  oai21  g42(.a(new_n31_), .b(new_n36_), .c(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n58_), .O(z7));
  oai22  g44(.a(new_n65_), .b(x12), .c(x09), .d(new_n35_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n58_), .O(z8));
endmodule
