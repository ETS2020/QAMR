// Benchmark "FAU" written by ABC on Mon Jul 27 20:37:30 2020
...
module FAU ( 
  ...
  nand4  g13(.a(new_n25_), .b(x2), .c(new_n32_), .d(x0), .O(new_n35_));
  inv1   g14(.a(new_n35_), .O(z05));
  nand4  g15(.a(x3), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n37_));
  inv1   g16(.a(new_n37_), .O(z06));
  nand4  g17(.a(new_n25_), .b(new_n28_), .c(new_n32_), .d(x0), .O(new_n39_));
  ...
  nand3  g23(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n23_), .O(z10));
  nor2   g25(.a(new_n45_), .b(new_n26_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n48_));
  inv1   g27(.a(new_n48_), .O(z12));
  nand4  g28(.a(new_n25_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n50_));
  inv1   g29(.a(new_n50_), .O(z13));
  nand4  g30(.a(x3), .b(new_n28_), .c(new_n32_), .d(new_n41_), .O(new_n52_));
  inv1   g31(.a(new_n52_), .O(z14));
  nand4  g32(.a(new_n25_), .b(new_n28_), .c(new_n32_), .d(new_n41_), .O(new_n54_));
