// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:18 2020
...
module FAU ( 
  ...
  nand2  g088(.a(x19), .b(new_n56_), .O(new_n141_));
  inv1   g089(.a(x33), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(x18), .O(new_n143_));
  oai22  g091(.a(new_n143_), .b(new_n141_), .c(x32), .d(x19), .O(z12));
  nand2  g092(.a(new_n142_), .b(new_n53_), .O(new_n145_));
