...
module FAU ( 
  ...
  oai21  g008(.a(new_n57_), .b(new_n55_), .c(new_n60_), .O(z00));
  nand2  g009(.a(new_n54_), .b(new_n58_), .O(new_n62_));
  nand2  g010(.a(x22), .b(x18), .O(new_n63_));
  inv1   g011(.a(x02), .O(new_n64_));
  nand2  g012(.a(new_n53_), .b(new_n64_), .O(new_n65_));
  nand4  g013(.a(new_n65_), .b(new_n63_), .c(x19), .d(new_n56_), .O(new_n66_));
  ...
  nand2  g019(.a(new_n53_), .b(new_n71_), .O(new_n72_));
  nand4  g020(.a(new_n72_), .b(new_n70_), .c(x19), .d(new_n56_), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n69_), .O(z02));
  inv1   g022(.a(x23), .O(new_n75_));
  nand2  g023(.a(new_n75_), .b(new_n58_), .O(new_n76_));
  inv1   g024(.a(x16), .O(new_n77_));
  nand2  g025(.a(x18), .b(new_n77_), .O(new_n78_));
  inv1   g026(.a(x00), .O(new_n79_));
  nand2  g027(.a(new_n53_), .b(new_n79_), .O(new_n80_));
  ...
  nand2  g031(.a(new_n83_), .b(new_n58_), .O(new_n84_));
  nand2  g032(.a(x25), .b(x18), .O(new_n85_));
  inv1   g033(.a(x07), .O(new_n86_));
  nand2  g034(.a(new_n53_), .b(new_n86_), .O(new_n87_));
  ...
  nand2  g041(.a(new_n53_), .b(new_n93_), .O(new_n94_));
  ...
  nand2  g055(.a(new_n53_), .b(new_n107_), .O(new_n108_));
  ...
  nand2  g062(.a(new_n53_), .b(new_n114_), .O(new_n115_));
  ...
  nand2  g069(.a(new_n53_), .b(new_n121_), .O(new_n122_));
  ...
  nand2  g076(.a(new_n53_), .b(new_n128_), .O(new_n129_));
  ...
  nand2  g083(.a(new_n53_), .b(new_n135_), .O(new_n136_));
  ...
  nand2  g090(.a(new_n53_), .b(new_n142_), .O(new_n143_));
  ...
  nand2  g097(.a(new_n53_), .b(new_n149_), .O(new_n150_));
  ...
  nand2  g101(.a(new_n153_), .b(new_n58_), .O(new_n154_));
  ...
  nand2  g108(.a(new_n160_), .b(new_n58_), .O(new_n161_));
  nand2  g109(.a(x28), .b(x18), .O(new_n162_));
  inv1   g110(.a(x12), .O(new_n163_));
  nand2  g111(.a(new_n53_), .b(new_n163_), .O(new_n164_));
