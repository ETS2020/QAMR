// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:58 2020
...
module FAU ( 
  ...
  nand2  g26(.a(x19), .b(x18), .O(new_n79_));
  oai22  g27(.a(new_n79_), .b(x25), .c(x18), .d(new_n78_), .O(new_n80_));
  ...
  nand2  g63(.a(new_n115_), .b(new_n54_), .O(new_n116_));
  nor2   g64(.a(x18), .b(x08), .O(new_n117_));
  nand2  g65(.a(new_n55_), .b(new_n82_), .O(new_n118_));
  oai21  g66(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(z11));
