// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:28 2020
...
module FAU ( 
  ...
  inv1   g69(.a(x33), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(new_n54_), .O(new_n123_));
  nor2   g71(.a(x18), .b(x14), .O(new_n124_));
  inv1   g72(.a(x34), .O(new_n125_));
  nand2  g73(.a(new_n55_), .b(new_n125_), .O(new_n126_));
  oai21  g74(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(z13));
  inv1   g75(.a(x17), .O(new_n128_));
  inv1   g76(.a(x13), .O(new_n129_));
  nand2  g77(.a(x19), .b(x18), .O(new_n130_));
  oai22  g78(.a(new_n130_), .b(x35), .c(x18), .d(new_n129_), .O(new_n131_));
  nand2  g79(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand2  g80(.a(new_n125_), .b(new_n54_), .O(new_n133_));
