// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:06 2020
...
module FAU ( 
  ...
  nand2  g060(.a(x19), .b(new_n56_), .O(new_n113_));
  nand2  g061(.a(new_n59_), .b(x11), .O(new_n114_));
  oai22  g062(.a(new_n114_), .b(new_n113_), .c(x28), .d(x19), .O(z08));
  ...
  nand2  g067(.a(new_n119_), .b(x29), .O(z09));
