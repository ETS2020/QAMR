...
module FAU ( 
  ...
  nand2  g55(.a(x19), .b(new_n107_), .O(new_n108_));
  nor2   g56(.a(x18), .b(x09), .O(new_n109_));
  oai22  g57(.a(new_n109_), .b(new_n108_), .c(x30), .d(x19), .O(z10));
  inv1   g58(.a(x24), .O(new_n111_));
  nand3  g59(.a(new_n111_), .b(x19), .c(x18), .O(new_n112_));
  inv1   g60(.a(x31), .O(new_n113_));
  nand3  g61(.a(new_n113_), .b(new_n57_), .c(x08), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n107_), .O(new_n116_));
  nand2  g64(.a(new_n113_), .b(new_n54_), .O(new_n117_));
