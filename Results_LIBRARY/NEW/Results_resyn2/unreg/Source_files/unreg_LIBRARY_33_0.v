// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:48 2020
...
module FAU ( 
  ...
  nand3  g015(.a(new_n67_), .b(new_n65_), .c(new_n56_), .O(new_n68_));
  ...
  nand3  g022(.a(new_n74_), .b(new_n72_), .c(new_n56_), .O(new_n75_));
  ...
  nand3  g030(.a(new_n82_), .b(new_n80_), .c(new_n56_), .O(new_n83_));
  ...
  nand3  g037(.a(new_n89_), .b(new_n87_), .c(new_n56_), .O(new_n90_));
  ...
  nand3  g044(.a(new_n96_), .b(new_n94_), .c(new_n56_), .O(new_n97_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n56_), .O(new_n118_));
  ...
  nand3  g072(.a(new_n124_), .b(new_n122_), .c(new_n56_), .O(new_n125_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n157_), .c(new_n56_), .O(new_n160_));
  ...
  nand3  g114(.a(new_n166_), .b(new_n164_), .c(new_n56_), .O(new_n167_));
