// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:03 2020
...
module FAU ( 
  ...
  aoi21  g104(.a(new_n156_), .b(x18), .c(x13), .O(new_n157_));
  inv1   g105(.a(x34), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n53_), .O(new_n159_));
  oai21  g107(.a(new_n157_), .b(new_n155_), .c(new_n159_), .O(z14));
  nand2  g108(.a(new_n156_), .b(new_n53_), .O(new_n161_));
