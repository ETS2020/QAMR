...
module FAU ( 
  ...
  inv1   g54(.a(x30), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  nor2   g56(.a(x18), .b(x09), .O(new_n109_));
  inv1   g57(.a(x31), .O(new_n110_));
  nand2  g58(.a(new_n55_), .b(new_n110_), .O(new_n111_));
  oai21  g59(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(z10));
  inv1   g60(.a(x17), .O(new_n113_));
  inv1   g61(.a(x08), .O(new_n114_));
  nand2  g62(.a(x19), .b(x18), .O(new_n115_));
  oai22  g63(.a(new_n115_), .b(x24), .c(x18), .d(new_n114_), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g65(.a(new_n110_), .b(new_n54_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n117_), .O(z11));
