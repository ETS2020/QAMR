...
module FAU ( 
  ...
  inv1   g40(.a(x20), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(x18), .O(new_n94_));
  nand3  g42(.a(x19), .b(new_n57_), .c(x04), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  inv1   g45(.a(x27), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n54_), .O(new_n99_));
