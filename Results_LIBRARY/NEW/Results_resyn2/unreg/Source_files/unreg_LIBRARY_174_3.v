...
module FAU ( 
  ...
  nand2  g14(.a(x19), .b(new_n66_), .O(new_n67_));
  nor2   g15(.a(x18), .b(x01), .O(new_n68_));
  oai22  g16(.a(new_n68_), .b(new_n67_), .c(x22), .d(x19), .O(z02));
  nand3  g17(.a(x19), .b(x18), .c(x16), .O(new_n70_));
  inv1   g18(.a(x23), .O(new_n71_));
  nand3  g19(.a(new_n71_), .b(new_n57_), .c(x00), .O(new_n72_));
  nand2  g20(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand2  g22(.a(new_n71_), .b(new_n54_), .O(new_n75_));
  ...
  nand2  g81(.a(new_n57_), .b(new_n133_), .O(new_n134_));
  nand3  g82(.a(new_n134_), .b(new_n132_), .c(new_n55_), .O(new_n135_));
