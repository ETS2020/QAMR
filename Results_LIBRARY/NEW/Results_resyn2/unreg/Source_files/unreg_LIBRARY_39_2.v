// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:49 2020
...
module FAU ( 
  ...
  oai22  g070(.a(new_n122_), .b(new_n120_), .c(x29), .d(x19), .O(z09));
  nand2  g071(.a(new_n121_), .b(new_n53_), .O(new_n124_));
