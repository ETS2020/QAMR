...
module FAU ( 
  ...
  inv1   g69(.a(x17), .O(new_n122_));
  inv1   g70(.a(x14), .O(new_n123_));
  nand2  g71(.a(x19), .b(x18), .O(new_n124_));
  oai22  g72(.a(new_n124_), .b(x34), .c(x18), .d(new_n123_), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  inv1   g74(.a(x33), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n54_), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n126_), .O(z13));
