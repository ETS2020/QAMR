...
module FAU ( 
  ...
  nand2  g49(.a(new_n101_), .b(new_n54_), .O(new_n102_));
  nand3  g50(.a(new_n101_), .b(new_n57_), .c(x10), .O(new_n103_));
  inv1   g51(.a(x30), .O(new_n104_));
  nand3  g52(.a(new_n104_), .b(x19), .c(x18), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n97_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n102_), .O(z09));
