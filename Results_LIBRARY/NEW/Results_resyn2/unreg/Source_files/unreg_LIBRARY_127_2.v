// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:11 2020
...
module FAU ( 
  ...
  nand2  g074(.a(x19), .b(new_n56_), .O(new_n127_));
  nand2  g075(.a(new_n59_), .b(x09), .O(new_n128_));
  oai22  g076(.a(new_n128_), .b(new_n127_), .c(x30), .d(x19), .O(z10));
  ...
  nand2  g081(.a(new_n133_), .b(x31), .O(z11));
