...
module FAU ( 
  ...
  nand2  g34(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  nand3  g35(.a(new_n86_), .b(new_n57_), .c(x05), .O(new_n88_));
  inv1   g36(.a(x27), .O(new_n89_));
  nand3  g37(.a(new_n89_), .b(x19), .c(x18), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n82_), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n87_), .O(z06));
