...
module FAU ( 
  ...
  nor2   g51(.a(x18), .b(x10), .O(new_n104_));
  inv1   g52(.a(x30), .O(new_n105_));
  nand2  g53(.a(new_n55_), .b(new_n105_), .O(new_n106_));
  oai21  g54(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z09));
  inv1   g55(.a(x17), .O(new_n108_));
  inv1   g56(.a(x09), .O(new_n109_));
  nand2  g57(.a(x19), .b(x18), .O(new_n110_));
  oai22  g58(.a(new_n110_), .b(x31), .c(x18), .d(new_n109_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g60(.a(new_n105_), .b(new_n54_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n112_), .O(z10));
