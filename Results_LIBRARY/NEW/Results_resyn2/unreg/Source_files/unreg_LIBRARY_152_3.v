...
module FAU ( 
  ...
  inv1   g64(.a(x17), .O(new_n117_));
  inv1   g65(.a(x33), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(x18), .O(new_n119_));
  nand3  g67(.a(x19), .b(new_n57_), .c(x15), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  inv1   g70(.a(x32), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n54_), .O(new_n124_));
  nand2  g72(.a(new_n124_), .b(new_n122_), .O(z12));
