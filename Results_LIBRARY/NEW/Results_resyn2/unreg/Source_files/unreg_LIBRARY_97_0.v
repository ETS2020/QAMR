...
module FAU ( 
  ...
  nand2  g74(.a(x35), .b(x18), .O(new_n127_));
  inv1   g75(.a(x13), .O(new_n128_));
  nand2  g76(.a(new_n57_), .b(new_n128_), .O(new_n129_));
  nand3  g77(.a(new_n129_), .b(new_n127_), .c(new_n55_), .O(new_n130_));
  oai21  g78(.a(x34), .b(x19), .c(new_n130_), .O(z14));
  inv1   g79(.a(x17), .O(new_n132_));
  inv1   g80(.a(x28), .O(new_n133_));
  nand2  g81(.a(new_n133_), .b(x18), .O(new_n134_));
  nand3  g82(.a(x19), .b(new_n57_), .c(x12), .O(new_n135_));
  nand2  g83(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g84(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  inv1   g85(.a(x35), .O(new_n138_));
  nand2  g86(.a(new_n138_), .b(new_n54_), .O(new_n139_));
  nand2  g87(.a(new_n139_), .b(new_n137_), .O(z15));
endmodule
