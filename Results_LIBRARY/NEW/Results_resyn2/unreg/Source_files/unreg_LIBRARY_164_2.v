...
module FAU ( 
  ...
  inv1   g59(.a(x17), .O(new_n112_));
  inv1   g60(.a(x08), .O(new_n113_));
  nand2  g61(.a(x19), .b(x18), .O(new_n114_));
  oai22  g62(.a(new_n114_), .b(x24), .c(x18), .d(new_n113_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  inv1   g64(.a(x31), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n116_), .O(z11));
