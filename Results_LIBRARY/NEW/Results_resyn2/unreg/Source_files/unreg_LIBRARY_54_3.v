// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:53 2020
...
module FAU ( 
  ...
  nand2  g081(.a(x19), .b(new_n56_), .O(new_n134_));
  aoi21  g082(.a(new_n85_), .b(x18), .c(x08), .O(new_n135_));
  inv1   g083(.a(x31), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  oai21  g085(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(z11));
