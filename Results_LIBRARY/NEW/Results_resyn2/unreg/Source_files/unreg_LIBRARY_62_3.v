...
module FAU ( 
  ...
  nand3  g55(.a(x19), .b(new_n57_), .c(x09), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n102_), .O(new_n110_));
  inv1   g58(.a(x30), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n54_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n110_), .O(z10));
