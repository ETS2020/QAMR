...
module FAU ( 
  ...
  nand2  g095(.a(x19), .b(new_n56_), .O(new_n148_));
  inv1   g096(.a(x34), .O(new_n149_));
  nor2   g097(.a(new_n149_), .b(new_n59_), .O(new_n150_));
  oai22  g098(.a(new_n150_), .b(new_n148_), .c(x33), .d(x19), .O(z13));
  nand2  g099(.a(new_n149_), .b(new_n53_), .O(new_n152_));
