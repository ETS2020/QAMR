...
module FAU ( 
  ...
  inv1   g64(.a(x32), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nor2   g66(.a(x18), .b(x15), .O(new_n119_));
  inv1   g67(.a(x33), .O(new_n120_));
  nand2  g68(.a(new_n55_), .b(new_n120_), .O(new_n121_));
  oai21  g69(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(z12));
  inv1   g70(.a(x17), .O(new_n123_));
  inv1   g71(.a(x14), .O(new_n124_));
  nand2  g72(.a(x19), .b(x18), .O(new_n125_));
  oai22  g73(.a(new_n125_), .b(x34), .c(x18), .d(new_n124_), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand2  g75(.a(new_n120_), .b(new_n54_), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n127_), .O(z13));
