...
module FAU ( 
  ...
  inv1   g29(.a(x17), .O(new_n82_));
  nand2  g30(.a(x19), .b(new_n82_), .O(new_n83_));
  nor2   g31(.a(x18), .b(x06), .O(new_n84_));
  oai22  g32(.a(new_n84_), .b(new_n83_), .c(x25), .d(x19), .O(z05));
  inv1   g33(.a(x27), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(x18), .O(new_n87_));
  nand3  g35(.a(x19), .b(new_n57_), .c(x05), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n82_), .O(new_n90_));
  inv1   g38(.a(x26), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n54_), .O(new_n92_));
