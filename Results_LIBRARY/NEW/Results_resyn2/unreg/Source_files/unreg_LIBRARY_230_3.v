...
module FAU ( 
  ...
  nand3  g051(.a(new_n103_), .b(new_n101_), .c(new_n57_), .O(new_n104_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n108_), .c(new_n57_), .O(new_n111_));
  ...
  nand3  g065(.a(new_n117_), .b(new_n115_), .c(new_n57_), .O(new_n118_));
  ...
  nand3  g113(.a(new_n165_), .b(new_n163_), .c(new_n57_), .O(new_n166_));
