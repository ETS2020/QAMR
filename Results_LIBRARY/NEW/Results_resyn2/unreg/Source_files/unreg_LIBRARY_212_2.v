// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:31 2020
...
module FAU ( 
  ...
  oai22  g020(.a(new_n72_), .b(new_n70_), .c(x22), .d(x19), .O(z02));
  nand2  g021(.a(new_n71_), .b(new_n53_), .O(new_n74_));
  inv1   g022(.a(x16), .O(new_n75_));
  nand2  g023(.a(x18), .b(new_n75_), .O(new_n76_));
  inv1   g024(.a(x00), .O(new_n77_));
  nand2  g025(.a(new_n59_), .b(new_n77_), .O(new_n78_));
  nand4  g026(.a(new_n78_), .b(new_n76_), .c(x19), .d(new_n56_), .O(new_n79_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n56_), .O(new_n93_));
  ...
  nand4  g047(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n56_), .O(new_n100_));
  ...
  nand4  g054(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n56_), .O(new_n107_));
  ...
  nand2  g060(.a(new_n59_), .b(new_n112_), .O(new_n113_));
  nand4  g061(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n56_), .O(new_n114_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n56_), .O(new_n121_));
  ...
  nand4  g075(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n56_), .O(new_n128_));
  ...
  nand4  g082(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n56_), .O(new_n135_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n56_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n56_), .O(new_n149_));
  ...
  nand2  g102(.a(new_n59_), .b(new_n154_), .O(new_n155_));
  nand4  g103(.a(new_n155_), .b(new_n153_), .c(x19), .d(new_n56_), .O(new_n156_));
  ...
  nand2  g109(.a(new_n59_), .b(new_n161_), .O(new_n162_));
  nand4  g110(.a(new_n162_), .b(new_n160_), .c(x19), .d(new_n56_), .O(new_n163_));
