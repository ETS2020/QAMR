// Benchmark "FAU" written by ABC on Mon Jul 27 20:35:55 2020
...
module FAU ( 
  ...
  nor2   g13(.a(new_n27_), .b(x5), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n18_), .c(new_n15_), .O(z3));
  nand3  g15(.a(new_n18_), .b(new_n16_), .c(x2), .O(z4));
  nand3  g16(.a(new_n21_), .b(new_n18_), .c(x2), .O(z5));
  nand4  g17(.a(new_n25_), .b(new_n18_), .c(new_n23_), .d(x2), .O(z6));
