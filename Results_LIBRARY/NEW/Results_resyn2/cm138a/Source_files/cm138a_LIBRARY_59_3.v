...
module FAU ( 
  ...
  nand4  g13(.a(new_n19_), .b(new_n27_), .c(new_n16_), .d(x1), .O(z3));
  nand2  g14(.a(x2), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x0), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(new_n27_), .d(new_n16_), .O(z4));
  nand2  g17(.a(new_n29_), .b(new_n21_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n25_), .c(new_n19_), .d(new_n16_), .O(z5));
  one    g19(.O(z6));
  one    g20(.O(z7));
endmodule
