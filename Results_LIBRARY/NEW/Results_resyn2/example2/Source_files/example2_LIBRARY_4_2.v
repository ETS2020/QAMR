...
module FAU ( 
  ...
  nand3  g121(.a(new_n260_), .b(x49), .c(new_n230_), .O(new_n273_));
  inv1   g122(.a(new_n273_), .O(z31));
  nor2   g123(.a(new_n162_), .b(x04), .O(new_n275_));
  nand4  g124(.a(new_n275_), .b(x50), .c(new_n230_), .d(new_n174_), .O(new_n276_));
  nor2   g125(.a(new_n276_), .b(new_n258_), .O(z32));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n275_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n275_), .b(new_n160_), .O(new_n420_));
