// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:33 2020
...
module FAU ( 
  ...
  nand4  g113(.a(new_n264_), .b(new_n249_), .c(x45), .d(new_n227_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(new_n257_), .O(z27));
  nand3  g115(.a(new_n259_), .b(x46), .c(new_n227_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z28));
  nand3  g117(.a(new_n259_), .b(x47), .c(new_n227_), .O(new_n269_));
  inv1   g118(.a(new_n269_), .O(z29));
  nand3  g119(.a(new_n259_), .b(x48), .c(new_n227_), .O(new_n271_));
