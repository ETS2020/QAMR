// Benchmark "FAU" written by ABC on Mon Jul 27 23:24:40 2020
...
module FAU ( 
  ...
  aoi21  g021(.a(new_n170_), .b(new_n168_), .c(new_n172_), .O(z02));
  nand3  g022(.a(new_n155_), .b(x52), .c(new_n171_), .O(new_n174_));
  ...
  nand2  g085(.a(new_n170_), .b(new_n168_), .O(new_n237_));
  ...
  nand2  g101(.a(new_n163_), .b(x79), .O(new_n253_));
  inv1   g102(.a(new_n253_), .O(new_n254_));
  xor2a  g103(.a(x84), .b(x82), .O(new_n255_));
  inv1   g104(.a(new_n255_), .O(new_n256_));
  nand3  g105(.a(new_n256_), .b(new_n254_), .c(new_n250_), .O(new_n257_));
  nor3   g106(.a(new_n257_), .b(x42), .c(new_n244_), .O(z25));
  ...
  nand2  g114(.a(new_n254_), .b(new_n250_), .O(new_n266_));
  nand4  g115(.a(new_n255_), .b(x83), .c(x42), .d(x05), .O(new_n267_));
  nand2  g116(.a(x42), .b(x05), .O(new_n268_));
  oai22  g117(.a(new_n268_), .b(x83), .c(new_n203_), .d(x42), .O(new_n269_));
  nand2  g118(.a(new_n269_), .b(new_n256_), .O(new_n270_));
  aoi21  g119(.a(new_n270_), .b(new_n267_), .c(new_n266_), .O(z33));
  nand2  g120(.a(x83), .b(x42), .O(new_n272_));
  xnor2a g121(.a(new_n272_), .b(new_n255_), .O(new_n273_));
  nor2   g122(.a(new_n273_), .b(new_n253_), .O(new_n274_));
  nand3  g123(.a(new_n274_), .b(new_n250_), .c(x52), .O(new_n275_));
  inv1   g124(.a(new_n275_), .O(z34));
  nand3  g125(.a(new_n274_), .b(new_n250_), .c(x53), .O(new_n277_));
  inv1   g126(.a(new_n277_), .O(z35));
  nand3  g127(.a(new_n274_), .b(new_n250_), .c(x54), .O(new_n279_));
  inv1   g128(.a(new_n279_), .O(z36));
  nand3  g129(.a(new_n274_), .b(new_n250_), .c(x55), .O(new_n281_));
  inv1   g130(.a(new_n281_), .O(z37));
  nand3  g131(.a(new_n274_), .b(new_n250_), .c(x56), .O(new_n283_));
  inv1   g132(.a(new_n283_), .O(z38));
  nand3  g133(.a(new_n274_), .b(new_n250_), .c(x57), .O(new_n285_));
  inv1   g134(.a(new_n285_), .O(z39));
  nand3  g135(.a(new_n274_), .b(new_n250_), .c(x58), .O(new_n287_));
  inv1   g136(.a(new_n287_), .O(z40));
  nand3  g137(.a(new_n274_), .b(new_n250_), .c(x59), .O(new_n289_));
  inv1   g138(.a(new_n289_), .O(z41));
  nand3  g139(.a(new_n274_), .b(new_n250_), .c(x60), .O(new_n291_));
  inv1   g140(.a(new_n291_), .O(z42));
  nand3  g141(.a(new_n274_), .b(new_n250_), .c(x61), .O(new_n293_));
  inv1   g142(.a(new_n293_), .O(z43));
  nand3  g143(.a(new_n274_), .b(new_n250_), .c(x62), .O(new_n295_));
  inv1   g144(.a(new_n295_), .O(z44));
  nand3  g145(.a(new_n274_), .b(new_n250_), .c(x63), .O(new_n297_));
  inv1   g146(.a(new_n297_), .O(z45));
  nand3  g147(.a(new_n274_), .b(new_n250_), .c(x64), .O(new_n299_));
  inv1   g148(.a(new_n299_), .O(z46));
  nand2  g149(.a(new_n239_), .b(new_n169_), .O(new_n301_));
  inv1   g150(.a(new_n301_), .O(new_n302_));
  oai21  g151(.a(x75), .b(x67), .c(new_n302_), .O(new_n303_));
  inv1   g152(.a(x04), .O(new_n304_));
  nor2   g153(.a(x77), .b(new_n304_), .O(new_n305_));
  nand2  g154(.a(new_n305_), .b(new_n155_), .O(new_n306_));
  ...
  inv1   g159(.a(x15), .O(new_n311_));
  nand2  g160(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g161(.a(new_n312_), .b(new_n310_), .c(new_n307_), .O(new_n313_));
  aoi21  g162(.a(new_n313_), .b(new_n303_), .c(x01), .O(z47));
  nand2  g163(.a(new_n302_), .b(x68), .O(new_n315_));
  inv1   g164(.a(x08), .O(new_n316_));
  nand2  g165(.a(new_n309_), .b(new_n316_), .O(new_n317_));
  inv1   g166(.a(x16), .O(new_n318_));
  nand2  g167(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g168(.a(new_n319_), .b(new_n317_), .c(new_n307_), .O(new_n320_));
  aoi21  g169(.a(new_n320_), .b(new_n315_), .c(x01), .O(z48));
  nand2  g170(.a(new_n302_), .b(x69), .O(new_n322_));
  inv1   g171(.a(x09), .O(new_n323_));
  nand2  g172(.a(new_n309_), .b(new_n323_), .O(new_n324_));
  inv1   g173(.a(x17), .O(new_n325_));
  nand2  g174(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g175(.a(new_n326_), .b(new_n324_), .c(new_n307_), .O(new_n327_));
  aoi21  g176(.a(new_n327_), .b(new_n322_), .c(x01), .O(z49));
  nand2  g177(.a(new_n302_), .b(x70), .O(new_n329_));
  inv1   g178(.a(x10), .O(new_n330_));
  nand2  g179(.a(new_n309_), .b(new_n330_), .O(new_n331_));
  inv1   g180(.a(x18), .O(new_n332_));
  nand2  g181(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g182(.a(new_n333_), .b(new_n331_), .c(new_n307_), .O(new_n334_));
  aoi21  g183(.a(new_n334_), .b(new_n329_), .c(x01), .O(z50));
  nand2  g184(.a(new_n302_), .b(x71), .O(new_n336_));
  inv1   g185(.a(x11), .O(new_n337_));
  nand2  g186(.a(new_n309_), .b(new_n337_), .O(new_n338_));
  inv1   g187(.a(x19), .O(new_n339_));
  nand2  g188(.a(x52), .b(new_n339_), .O(new_n340_));
  nand3  g189(.a(new_n340_), .b(new_n338_), .c(new_n307_), .O(new_n341_));
  aoi21  g190(.a(new_n341_), .b(new_n336_), .c(x01), .O(z51));
  nand2  g191(.a(new_n302_), .b(x72), .O(new_n343_));
  inv1   g192(.a(x12), .O(new_n344_));
  nand2  g193(.a(new_n309_), .b(new_n344_), .O(new_n345_));
  inv1   g194(.a(x20), .O(new_n346_));
  nand2  g195(.a(x52), .b(new_n346_), .O(new_n347_));
  nand3  g196(.a(new_n347_), .b(new_n345_), .c(new_n307_), .O(new_n348_));
  aoi21  g197(.a(new_n348_), .b(new_n343_), .c(x01), .O(z52));
  nand2  g198(.a(new_n302_), .b(x73), .O(new_n350_));
  inv1   g199(.a(x13), .O(new_n351_));
  nand2  g200(.a(new_n309_), .b(new_n351_), .O(new_n352_));
  inv1   g201(.a(x21), .O(new_n353_));
  nand2  g202(.a(x52), .b(new_n353_), .O(new_n354_));
  nand3  g203(.a(new_n354_), .b(new_n352_), .c(new_n307_), .O(new_n355_));
  aoi21  g204(.a(new_n355_), .b(new_n350_), .c(x01), .O(z53));
  nor2   g205(.a(x52), .b(x14), .O(new_n357_));
  oai21  g206(.a(new_n309_), .b(x22), .c(new_n171_), .O(new_n358_));
  nor3   g207(.a(new_n358_), .b(new_n357_), .c(new_n306_), .O(z54));
  oai21  g208(.a(new_n238_), .b(x76), .c(new_n164_), .O(new_n361_));
  nand3  g209(.a(new_n361_), .b(new_n246_), .c(new_n160_), .O(z56));
  inv1   g210(.a(x02), .O(new_n363_));
  nand3  g211(.a(new_n246_), .b(x03), .c(new_n363_), .O(new_n364_));
  inv1   g212(.a(new_n364_), .O(z57));
  oai21  g213(.a(new_n167_), .b(new_n304_), .c(new_n161_), .O(new_n366_));
  nand3  g214(.a(new_n161_), .b(new_n154_), .c(x40), .O(new_n367_));
  nand2  g215(.a(new_n232_), .b(x79), .O(new_n368_));
  oai21  g216(.a(new_n368_), .b(new_n234_), .c(new_n367_), .O(new_n369_));
  aoi21  g217(.a(x42), .b(x40), .c(new_n162_), .O(new_n370_));
  nand2  g218(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  aoi21  g219(.a(new_n371_), .b(new_n366_), .c(x01), .O(z58));
  nand3  g220(.a(new_n232_), .b(x79), .c(new_n153_), .O(new_n373_));
  nand2  g221(.a(new_n373_), .b(new_n235_), .O(new_n374_));
  nand2  g222(.a(new_n374_), .b(new_n367_), .O(new_n375_));
  nand2  g223(.a(new_n375_), .b(x77), .O(new_n376_));
  aoi21  g224(.a(new_n376_), .b(new_n248_), .c(x01), .O(z59));
  nor2   g225(.a(new_n162_), .b(new_n304_), .O(new_n378_));
  inv1   g226(.a(new_n378_), .O(new_n379_));
  aoi21  g227(.a(new_n232_), .b(x79), .c(new_n379_), .O(new_n380_));
  nor3   g228(.a(new_n247_), .b(new_n239_), .c(x77), .O(new_n381_));
  oai21  g229(.a(new_n381_), .b(new_n380_), .c(x78), .O(new_n382_));
  nor2   g230(.a(x84), .b(new_n161_), .O(new_n383_));
  aoi21  g231(.a(new_n383_), .b(new_n169_), .c(new_n247_), .O(new_n384_));
  aoi21  g232(.a(new_n384_), .b(new_n382_), .c(x01), .O(z60));
  inv1   g233(.a(x80), .O(new_n386_));
  aoi21  g234(.a(new_n378_), .b(x78), .c(new_n159_), .O(new_n387_));
  oai21  g235(.a(new_n163_), .b(x84), .c(new_n387_), .O(new_n388_));
  nor3   g236(.a(new_n388_), .b(new_n172_), .c(new_n386_), .O(z61));
  nand2  g237(.a(new_n248_), .b(x78), .O(new_n390_));
  aoi21  g238(.a(new_n383_), .b(new_n162_), .c(new_n390_), .O(new_n391_));
  oai21  g239(.a(new_n379_), .b(new_n368_), .c(new_n391_), .O(new_n392_));
  aoi21  g240(.a(new_n392_), .b(new_n301_), .c(x01), .O(z62));
  inv1   g241(.a(x82), .O(new_n394_));
  nor3   g242(.a(new_n388_), .b(new_n172_), .c(new_n394_), .O(z63));
  inv1   g243(.a(new_n388_), .O(new_n396_));
  nand3  g244(.a(new_n396_), .b(x83), .c(x79), .O(new_n397_));
  aoi21  g245(.a(new_n397_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g246(.a(new_n240_), .b(x01), .O(new_n399_));
  and2   g247(.a(new_n399_), .b(new_n387_), .O(z65));
  zero   g248(.O(z55));
endmodule
