...
module FAU ( 
  ...
  nand4  g154(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x60), .O(new_n306_));
  inv1   g155(.a(new_n306_), .O(z42));
  nand4  g156(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x61), .O(new_n308_));
  inv1   g157(.a(new_n308_), .O(z43));
  nand4  g158(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x62), .O(new_n310_));
  inv1   g159(.a(new_n310_), .O(z44));
  inv1   g160(.a(new_n163_), .O(new_n312_));
  nor3   g161(.a(new_n250_), .b(new_n312_), .c(new_n182_), .O(new_n313_));
  and2   g162(.a(new_n313_), .b(new_n289_), .O(z45));
  ...
  aoi21  g229(.a(new_n312_), .b(x76), .c(new_n380_), .O(new_n381_));
