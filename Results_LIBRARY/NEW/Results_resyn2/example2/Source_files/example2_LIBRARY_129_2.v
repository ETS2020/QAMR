...
module FAU ( 
  ...
  nand2  g210(.a(new_n317_), .b(new_n361_), .O(new_n362_));
  inv1   g211(.a(x21), .O(new_n363_));
  nand2  g212(.a(x52), .b(new_n363_), .O(new_n364_));
  nand3  g213(.a(new_n364_), .b(new_n362_), .c(new_n322_), .O(new_n365_));
  aoi21  g214(.a(new_n365_), .b(new_n360_), .c(x01), .O(z53));
  nor2   g215(.a(x52), .b(x14), .O(new_n367_));
  oai21  g216(.a(new_n317_), .b(x22), .c(new_n173_), .O(new_n368_));
  nor3   g217(.a(new_n368_), .b(new_n367_), .c(new_n321_), .O(z54));
  ...
  oai21  g230(.a(new_n318_), .b(new_n319_), .c(new_n161_), .O(new_n382_));
  ...
  aoi22  g246(.a(new_n397_), .b(new_n238_), .c(new_n163_), .d(new_n319_), .O(new_n398_));
  ...
  nand3  g251(.a(x81), .b(x79), .c(new_n319_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n402_), .c(new_n162_), .O(new_n404_));
  oai21  g253(.a(new_n404_), .b(new_n320_), .c(x78), .O(new_n405_));
  ...
  aoi21  g259(.a(new_n410_), .b(new_n321_), .c(x01), .O(z64));
  nand2  g260(.a(new_n397_), .b(x81), .O(new_n412_));
  nand3  g261(.a(x78), .b(x77), .c(new_n319_), .O(new_n413_));
