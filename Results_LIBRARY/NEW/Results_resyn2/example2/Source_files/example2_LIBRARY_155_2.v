...
module FAU ( 
  ...
  nand2  g140(.a(new_n163_), .b(x53), .O(new_n292_));
  nor2   g141(.a(new_n292_), .b(new_n250_), .O(new_n293_));
  and2   g142(.a(new_n293_), .b(new_n289_), .O(z35));
  nand4  g143(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x54), .O(new_n295_));
  inv1   g144(.a(new_n295_), .O(z36));
  nand4  g145(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x55), .O(new_n297_));
  inv1   g146(.a(new_n297_), .O(z37));
  nand4  g147(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x56), .O(new_n299_));
  inv1   g148(.a(new_n299_), .O(z38));
  nand4  g149(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x57), .O(new_n301_));
  inv1   g150(.a(new_n301_), .O(z39));
  nand4  g151(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x58), .O(new_n303_));
  ...
  inv1   g228(.a(new_n163_), .O(new_n380_));
  aoi21  g229(.a(new_n169_), .b(new_n168_), .c(new_n238_), .O(new_n381_));
  aoi21  g230(.a(new_n380_), .b(x76), .c(new_n381_), .O(new_n382_));
  ...
  oai21  g236(.a(new_n319_), .b(new_n320_), .c(new_n161_), .O(new_n388_));
  ...
  aoi22  g252(.a(new_n403_), .b(new_n238_), .c(new_n163_), .d(new_n320_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n402_), .c(new_n376_), .O(z61));
  ...
  nor3   g262(.a(new_n404_), .b(new_n402_), .c(new_n377_), .O(z63));
