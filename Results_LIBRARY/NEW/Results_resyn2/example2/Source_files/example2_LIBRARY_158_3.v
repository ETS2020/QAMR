// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:50 2020
...
module FAU ( 
  ...
  nand3  g186(.a(new_n161_), .b(new_n323_), .c(x09), .O(new_n338_));
  nand2  g187(.a(new_n338_), .b(new_n337_), .O(new_n339_));
  nand3  g188(.a(new_n339_), .b(new_n317_), .c(x04), .O(new_n340_));
  ...
  oai21  g219(.a(new_n323_), .b(x22), .c(new_n173_), .O(new_n371_));
  ...
  inv1   g225(.a(new_n163_), .O(new_n377_));
  aoi21  g226(.a(new_n169_), .b(new_n168_), .c(new_n238_), .O(new_n378_));
  aoi21  g227(.a(new_n377_), .b(x76), .c(new_n378_), .O(new_n379_));
  nor2   g228(.a(new_n244_), .b(new_n159_), .O(new_n380_));
  oai21  g229(.a(new_n379_), .b(new_n161_), .c(new_n380_), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand3  g231(.a(new_n245_), .b(x03), .c(new_n382_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  oai21  g233(.a(new_n317_), .b(new_n318_), .c(new_n161_), .O(new_n385_));
  nand3  g234(.a(new_n161_), .b(new_n154_), .c(x40), .O(new_n386_));
  nand3  g235(.a(new_n235_), .b(new_n232_), .c(x79), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  aoi21  g237(.a(x42), .b(x40), .c(new_n162_), .O(new_n389_));
  ...
  aoi21  g244(.a(new_n395_), .b(new_n247_), .c(x01), .O(z59));
  aoi21  g245(.a(new_n378_), .b(x79), .c(new_n246_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g247(.a(new_n171_), .O(new_n399_));
  nand2  g248(.a(new_n169_), .b(new_n168_), .O(new_n400_));
  aoi22  g249(.a(new_n400_), .b(new_n238_), .c(new_n163_), .d(new_n318_), .O(new_n401_));
  ...
  nand3  g254(.a(x81), .b(x79), .c(new_n318_), .O(new_n406_));
  aoi21  g255(.a(new_n406_), .b(new_n405_), .c(new_n162_), .O(new_n407_));
  oai21  g256(.a(new_n407_), .b(new_n319_), .c(x78), .O(new_n408_));
  ...
  nand3  g264(.a(x78), .b(x77), .c(new_n318_), .O(new_n416_));
  nand2  g265(.a(new_n171_), .b(x84), .O(new_n417_));
