// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:09 2020
...
module FAU ( 
  ...
  inv1   g158(.a(new_n163_), .O(new_n310_));
  nor3   g159(.a(new_n250_), .b(new_n310_), .c(new_n185_), .O(new_n311_));
  and2   g160(.a(new_n311_), .b(new_n289_), .O(z44));
  ...
  aoi21  g229(.a(new_n310_), .b(x76), .c(new_n380_), .O(new_n381_));
