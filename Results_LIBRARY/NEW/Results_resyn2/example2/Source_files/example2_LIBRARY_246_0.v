// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:35 2020
...
module FAU ( 
  ...
  oai21  g081(.a(new_n232_), .b(new_n159_), .c(x79), .O(new_n233_));
  ...
  nand3  g090(.a(new_n241_), .b(new_n168_), .c(new_n237_), .O(new_n242_));
  aoi21  g091(.a(new_n242_), .b(new_n236_), .c(x01), .O(z22));
  ...
  inv1   g098(.a(new_n160_), .O(new_n250_));
  ...
  nand3  g106(.a(new_n252_), .b(new_n160_), .c(x79), .O(new_n258_));
  ...
  nor2   g125(.a(new_n227_), .b(new_n244_), .O(new_n277_));
  nor2   g126(.a(x83), .b(new_n255_), .O(new_n278_));
  nor2   g127(.a(new_n230_), .b(x81), .O(new_n279_));
  nor2   g128(.a(new_n279_), .b(new_n278_), .O(new_n280_));
  nand2  g129(.a(new_n280_), .b(new_n277_), .O(new_n281_));
  nand3  g130(.a(new_n255_), .b(x51), .c(new_n227_), .O(new_n282_));
  ...
  nand3  g134(.a(x81), .b(x51), .c(new_n227_), .O(new_n286_));
  ...
  nor2   g166(.a(new_n240_), .b(new_n167_), .O(new_n318_));
  oai21  g167(.a(x75), .b(x67), .c(new_n318_), .O(new_n319_));
  inv1   g168(.a(x04), .O(new_n320_));
  nor2   g169(.a(x79), .b(new_n320_), .O(new_n321_));
  nand2  g170(.a(new_n321_), .b(new_n165_), .O(new_n322_));
  ...
  aoi21  g177(.a(new_n328_), .b(new_n319_), .c(x01), .O(z47));
  nand2  g178(.a(new_n318_), .b(x68), .O(new_n330_));
  inv1   g179(.a(x08), .O(new_n331_));
  nand2  g180(.a(new_n172_), .b(new_n331_), .O(new_n332_));
  inv1   g181(.a(x16), .O(new_n333_));
  nand2  g182(.a(x52), .b(new_n333_), .O(new_n334_));
  nand3  g183(.a(new_n334_), .b(new_n332_), .c(new_n323_), .O(new_n335_));
  ...
  nand3  g190(.a(new_n341_), .b(new_n339_), .c(new_n323_), .O(new_n342_));
  aoi21  g191(.a(new_n342_), .b(new_n337_), .c(x01), .O(z49));
  nand2  g192(.a(new_n318_), .b(x70), .O(new_n344_));
  inv1   g193(.a(x10), .O(new_n345_));
  nand2  g194(.a(new_n172_), .b(new_n345_), .O(new_n346_));
  inv1   g195(.a(x18), .O(new_n347_));
  nand2  g196(.a(x52), .b(new_n347_), .O(new_n348_));
  nand3  g197(.a(new_n348_), .b(new_n346_), .c(new_n323_), .O(new_n349_));
  aoi21  g198(.a(new_n349_), .b(new_n344_), .c(x01), .O(z50));
  nand2  g199(.a(new_n318_), .b(x71), .O(new_n351_));
  inv1   g200(.a(x11), .O(new_n352_));
  nand2  g201(.a(new_n172_), .b(new_n352_), .O(new_n353_));
  inv1   g202(.a(x19), .O(new_n354_));
  nand2  g203(.a(x52), .b(new_n354_), .O(new_n355_));
  nand3  g204(.a(new_n355_), .b(new_n353_), .c(new_n323_), .O(new_n356_));
  aoi21  g205(.a(new_n356_), .b(new_n351_), .c(x01), .O(z51));
  nand2  g206(.a(new_n318_), .b(x72), .O(new_n358_));
  inv1   g207(.a(x12), .O(new_n359_));
  nand2  g208(.a(new_n172_), .b(new_n359_), .O(new_n360_));
  inv1   g209(.a(x20), .O(new_n361_));
  nand2  g210(.a(x52), .b(new_n361_), .O(new_n362_));
  nand3  g211(.a(new_n362_), .b(new_n360_), .c(new_n323_), .O(new_n363_));
  aoi21  g212(.a(new_n363_), .b(new_n358_), .c(x01), .O(z52));
  nand2  g213(.a(new_n318_), .b(x73), .O(new_n365_));
  inv1   g214(.a(x13), .O(new_n366_));
  nand2  g215(.a(new_n172_), .b(new_n366_), .O(new_n367_));
  inv1   g216(.a(x21), .O(new_n368_));
  nand2  g217(.a(x52), .b(new_n368_), .O(new_n369_));
  nand3  g218(.a(new_n369_), .b(new_n367_), .c(new_n323_), .O(new_n370_));
  aoi21  g219(.a(new_n370_), .b(new_n365_), .c(x01), .O(z53));
  nor2   g220(.a(x52), .b(x14), .O(new_n372_));
  nor2   g221(.a(new_n172_), .b(x22), .O(new_n373_));
  nor4   g222(.a(new_n373_), .b(new_n372_), .c(new_n322_), .d(x01), .O(z54));
  inv1   g223(.a(x80), .O(new_n375_));
  inv1   g224(.a(x82), .O(new_n376_));
  nand4  g225(.a(new_n279_), .b(x84), .c(new_n376_), .d(new_n375_), .O(new_n377_));
  nor2   g226(.a(new_n377_), .b(new_n258_), .O(z55));
  inv1   g227(.a(new_n161_), .O(new_n379_));
  inv1   g228(.a(x76), .O(new_n380_));
  aoi21  g229(.a(new_n239_), .b(new_n380_), .c(x78), .O(new_n381_));
  oai21  g230(.a(new_n381_), .b(new_n159_), .c(x79), .O(new_n382_));
  nand3  g231(.a(new_n382_), .b(new_n246_), .c(new_n379_), .O(z56));
  inv1   g232(.a(x02), .O(new_n384_));
  nand3  g233(.a(new_n246_), .b(x03), .c(new_n384_), .O(new_n385_));
  inv1   g234(.a(new_n385_), .O(z57));
  oai21  g235(.a(new_n165_), .b(new_n320_), .c(new_n169_), .O(new_n387_));
  nand3  g236(.a(new_n169_), .b(new_n154_), .c(x40), .O(new_n388_));
  nand3  g237(.a(new_n235_), .b(new_n232_), .c(x79), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n388_), .O(new_n390_));
  aoi21  g239(.a(x42), .b(x40), .c(new_n159_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(new_n390_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n387_), .c(x01), .O(z58));
  nand3  g242(.a(new_n232_), .b(x79), .c(new_n153_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n235_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n388_), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(x77), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n248_), .c(x01), .O(z59));
  nand2  g247(.a(new_n169_), .b(new_n154_), .O(new_n399_));
  nand3  g248(.a(new_n399_), .b(new_n238_), .c(new_n162_), .O(new_n400_));
  and2   g249(.a(new_n400_), .b(new_n248_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g251(.a(new_n170_), .O(new_n403_));
  aoi22  g252(.a(new_n239_), .b(new_n162_), .c(new_n160_), .d(new_n320_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n403_), .c(new_n375_), .O(z61));
  inv1   g254(.a(new_n228_), .O(new_n406_));
  nand4  g255(.a(new_n278_), .b(new_n406_), .c(new_n229_), .d(x43), .O(new_n407_));
  nand3  g256(.a(new_n407_), .b(new_n227_), .c(x04), .O(new_n408_));
  nand3  g257(.a(x81), .b(x79), .c(new_n320_), .O(new_n409_));
  aoi21  g258(.a(new_n409_), .b(new_n408_), .c(new_n159_), .O(new_n410_));
  oai21  g259(.a(new_n410_), .b(new_n321_), .c(x78), .O(new_n411_));
  inv1   g260(.a(new_n165_), .O(new_n412_));
  nand2  g261(.a(new_n167_), .b(new_n412_), .O(new_n413_));
  nand4  g262(.a(new_n413_), .b(x84), .c(x81), .d(x79), .O(new_n414_));
  aoi21  g263(.a(new_n414_), .b(new_n411_), .c(x01), .O(z62));
  nor3   g264(.a(new_n404_), .b(new_n403_), .c(new_n376_), .O(z63));
  inv1   g265(.a(new_n404_), .O(new_n417_));
  nand3  g266(.a(new_n417_), .b(x83), .c(x79), .O(new_n418_));
  aoi21  g267(.a(new_n418_), .b(new_n322_), .c(x01), .O(z64));
  nand2  g268(.a(new_n413_), .b(x81), .O(new_n420_));
  nand3  g269(.a(x78), .b(x77), .c(new_n320_), .O(new_n421_));
  nand2  g270(.a(new_n170_), .b(x84), .O(new_n422_));
