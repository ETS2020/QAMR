...
module FAU ( 
  ...
  oai21  g177(.a(x52), .b(x08), .c(new_n321_), .O(new_n329_));
  nand2  g178(.a(new_n315_), .b(x68), .O(new_n330_));
  aoi21  g179(.a(new_n330_), .b(new_n329_), .c(x01), .O(z48));
  nand2  g180(.a(new_n315_), .b(x69), .O(new_n332_));
  inv1   g181(.a(x09), .O(new_n333_));
  nand2  g182(.a(new_n323_), .b(new_n333_), .O(new_n334_));
  inv1   g183(.a(x17), .O(new_n335_));
  nand2  g184(.a(x52), .b(new_n335_), .O(new_n336_));
  nand3  g185(.a(new_n336_), .b(new_n334_), .c(new_n321_), .O(new_n337_));
  aoi21  g186(.a(new_n337_), .b(new_n332_), .c(x01), .O(z49));
  nand2  g187(.a(new_n315_), .b(x70), .O(new_n339_));
  inv1   g188(.a(x10), .O(new_n340_));
  nand2  g189(.a(new_n323_), .b(new_n340_), .O(new_n341_));
  inv1   g190(.a(x18), .O(new_n342_));
  nand2  g191(.a(x52), .b(new_n342_), .O(new_n343_));
  nand3  g192(.a(new_n343_), .b(new_n341_), .c(new_n321_), .O(new_n344_));
