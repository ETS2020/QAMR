...
module FAU ( 
  ...
  inv1   g106(.a(new_n257_), .O(z32));
  nand2  g107(.a(z32), .b(x05), .O(new_n259_));
  inv1   g108(.a(new_n259_), .O(z25));
  nand2  g109(.a(z32), .b(x44), .O(new_n261_));
  inv1   g110(.a(new_n261_), .O(z26));
  nand2  g111(.a(z32), .b(x45), .O(new_n263_));
  inv1   g112(.a(new_n263_), .O(z27));
  nand2  g113(.a(z32), .b(x46), .O(new_n265_));
  inv1   g114(.a(new_n265_), .O(z28));
  nand2  g115(.a(z32), .b(x47), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z29));
  nand2  g117(.a(z32), .b(x48), .O(new_n269_));
  inv1   g118(.a(new_n269_), .O(z30));
  nand2  g119(.a(z32), .b(x49), .O(new_n271_));
