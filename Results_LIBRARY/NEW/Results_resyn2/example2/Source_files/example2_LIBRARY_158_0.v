...
module FAU ( 
  ...
  oai21  g184(.a(x52), .b(x09), .c(new_n321_), .O(new_n336_));
  nand2  g185(.a(new_n316_), .b(x69), .O(new_n337_));
  aoi21  g186(.a(new_n337_), .b(new_n336_), .c(x01), .O(z49));
  nand2  g187(.a(new_n316_), .b(x70), .O(new_n339_));
  ...
  nand2  g194(.a(new_n316_), .b(x71), .O(new_n346_));
  ...
  oai21  g216(.a(new_n323_), .b(x22), .c(new_n170_), .O(new_n368_));
  ...
  oai21  g229(.a(new_n159_), .b(new_n318_), .c(new_n167_), .O(new_n381_));
  ...
  nand2  g244(.a(new_n247_), .b(new_n318_), .O(new_n396_));
  ...
  nand3  g252(.a(x81), .b(x79), .c(new_n318_), .O(new_n404_));
  aoi21  g253(.a(new_n404_), .b(new_n403_), .c(new_n226_), .O(new_n405_));
  oai21  g254(.a(new_n405_), .b(new_n319_), .c(x78), .O(new_n406_));
