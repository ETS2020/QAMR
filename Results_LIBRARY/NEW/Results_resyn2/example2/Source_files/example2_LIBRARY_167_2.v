...
module FAU ( 
  ...
  inv1   g163(.a(new_n168_), .O(new_n315_));
  inv1   g164(.a(x04), .O(new_n316_));
  nor2   g165(.a(x79), .b(new_n316_), .O(new_n317_));
  ...
  nand2  g172(.a(x52), .b(new_n323_), .O(new_n324_));
  nand3  g173(.a(new_n324_), .b(new_n322_), .c(new_n319_), .O(new_n325_));
  inv1   g174(.a(new_n169_), .O(new_n326_));
  inv1   g175(.a(x67), .O(new_n327_));
  oai21  g176(.a(new_n161_), .b(new_n167_), .c(new_n327_), .O(new_n328_));
  nand3  g177(.a(new_n328_), .b(new_n238_), .c(new_n326_), .O(new_n329_));
  aoi21  g178(.a(new_n329_), .b(new_n325_), .c(x01), .O(z47));
  nor2   g179(.a(new_n239_), .b(new_n169_), .O(new_n331_));
  nand2  g180(.a(new_n331_), .b(x68), .O(new_n332_));
  inv1   g181(.a(x08), .O(new_n333_));
  nand2  g182(.a(new_n321_), .b(new_n333_), .O(new_n334_));
  inv1   g183(.a(x16), .O(new_n335_));
  nand2  g184(.a(x52), .b(new_n335_), .O(new_n336_));
  nand3  g185(.a(new_n336_), .b(new_n334_), .c(new_n319_), .O(new_n337_));
  aoi21  g186(.a(new_n337_), .b(new_n332_), .c(x01), .O(z48));
  nand2  g187(.a(new_n331_), .b(x69), .O(new_n339_));
  inv1   g188(.a(x09), .O(new_n340_));
  nand2  g189(.a(new_n321_), .b(new_n340_), .O(new_n341_));
  inv1   g190(.a(x17), .O(new_n342_));
  nand2  g191(.a(x52), .b(new_n342_), .O(new_n343_));
  nand3  g192(.a(new_n343_), .b(new_n341_), .c(new_n319_), .O(new_n344_));
  aoi21  g193(.a(new_n344_), .b(new_n339_), .c(x01), .O(z49));
  nand2  g194(.a(new_n331_), .b(x70), .O(new_n346_));
  inv1   g195(.a(x10), .O(new_n347_));
  nand2  g196(.a(new_n321_), .b(new_n347_), .O(new_n348_));
  inv1   g197(.a(x18), .O(new_n349_));
  nand2  g198(.a(x52), .b(new_n349_), .O(new_n350_));
  nand3  g199(.a(new_n350_), .b(new_n348_), .c(new_n319_), .O(new_n351_));
  aoi21  g200(.a(new_n351_), .b(new_n346_), .c(x01), .O(z50));
  nand2  g201(.a(new_n331_), .b(x71), .O(new_n353_));
  inv1   g202(.a(x11), .O(new_n354_));
  nand2  g203(.a(new_n321_), .b(new_n354_), .O(new_n355_));
  inv1   g204(.a(x19), .O(new_n356_));
  nand2  g205(.a(x52), .b(new_n356_), .O(new_n357_));
  nand3  g206(.a(new_n357_), .b(new_n355_), .c(new_n319_), .O(new_n358_));
  aoi21  g207(.a(new_n358_), .b(new_n353_), .c(x01), .O(z51));
  nand2  g208(.a(new_n331_), .b(x72), .O(new_n360_));
  inv1   g209(.a(x12), .O(new_n361_));
  nand2  g210(.a(new_n321_), .b(new_n361_), .O(new_n362_));
  inv1   g211(.a(x20), .O(new_n363_));
  nand2  g212(.a(x52), .b(new_n363_), .O(new_n364_));
  nand3  g213(.a(new_n364_), .b(new_n362_), .c(new_n319_), .O(new_n365_));
  aoi21  g214(.a(new_n365_), .b(new_n360_), .c(x01), .O(z52));
  nand2  g215(.a(new_n331_), .b(x73), .O(new_n367_));
  inv1   g216(.a(x13), .O(new_n368_));
  nand2  g217(.a(new_n321_), .b(new_n368_), .O(new_n369_));
  inv1   g218(.a(x21), .O(new_n370_));
  nand2  g219(.a(x52), .b(new_n370_), .O(new_n371_));
  nand3  g220(.a(new_n371_), .b(new_n369_), .c(new_n319_), .O(new_n372_));
  aoi21  g221(.a(new_n372_), .b(new_n367_), .c(x01), .O(z53));
  nor2   g222(.a(x52), .b(x14), .O(new_n374_));
  oai21  g223(.a(new_n321_), .b(x22), .c(new_n173_), .O(new_n375_));
  nor3   g224(.a(new_n375_), .b(new_n374_), .c(new_n318_), .O(z54));
  inv1   g225(.a(x80), .O(new_n377_));
  inv1   g226(.a(x82), .O(new_n378_));
  nand4  g227(.a(new_n276_), .b(x84), .c(new_n378_), .d(new_n377_), .O(new_n379_));
  nor2   g228(.a(new_n379_), .b(new_n255_), .O(z55));
  ...
  oai21  g237(.a(new_n315_), .b(new_n316_), .c(new_n161_), .O(new_n389_));
  ...
  aoi22  g253(.a(new_n404_), .b(new_n238_), .c(new_n163_), .d(new_n316_), .O(new_n405_));
  nor3   g254(.a(new_n405_), .b(new_n403_), .c(new_n377_), .O(z61));
  inv1   g255(.a(new_n228_), .O(new_n407_));
  nand4  g256(.a(new_n275_), .b(new_n407_), .c(new_n229_), .d(x43), .O(new_n408_));
  nand3  g257(.a(new_n408_), .b(new_n227_), .c(x04), .O(new_n409_));
  nand3  g258(.a(x81), .b(x79), .c(new_n316_), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n409_), .c(new_n162_), .O(new_n411_));
  oai21  g260(.a(new_n411_), .b(new_n317_), .c(x78), .O(new_n412_));
  ...
  aoi21  g266(.a(new_n417_), .b(new_n318_), .c(x01), .O(z64));
  nand2  g267(.a(new_n404_), .b(x81), .O(new_n419_));
  nand3  g268(.a(x78), .b(x77), .c(new_n316_), .O(new_n420_));
