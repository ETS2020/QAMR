...
module FAU ( 
  ...
  nand2  g191(.a(new_n321_), .b(new_n170_), .O(new_n343_));
  nor2   g192(.a(x52), .b(x10), .O(new_n344_));
  nor2   g193(.a(new_n323_), .b(x18), .O(new_n345_));
  nor3   g194(.a(new_n345_), .b(new_n344_), .c(new_n343_), .O(z50));
  ...
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n343_), .O(z54));
