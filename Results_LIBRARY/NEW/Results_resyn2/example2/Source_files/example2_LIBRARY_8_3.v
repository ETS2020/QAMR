...
module FAU ( 
  ...
  oai21  g207(.a(x77), .b(new_n358_), .c(x52), .O(new_n359_));
  inv1   g208(.a(x12), .O(new_n360_));
  nand2  g209(.a(new_n323_), .b(new_n360_), .O(new_n361_));
  nand4  g210(.a(new_n361_), .b(new_n359_), .c(new_n225_), .d(new_n167_), .O(new_n362_));
