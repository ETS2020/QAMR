// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:06 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n157_, new_n159_,
    ...
    new_n298_, new_n300_, new_n302_, new_n303_, new_n305_, new_n307_,
  ...
  nand2  g102(.a(new_n163_), .b(x79), .O(new_n254_));
  ...
  nor2   g136(.a(new_n230_), .b(new_n227_), .O(new_n288_));
  xor2a  g137(.a(new_n288_), .b(new_n253_), .O(new_n289_));
  nand4  g138(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x52), .O(new_n290_));
  inv1   g139(.a(new_n290_), .O(z34));
  nand4  g140(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x53), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(z35));
  nand4  g142(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x54), .O(new_n294_));
  inv1   g143(.a(new_n294_), .O(z36));
  nand4  g144(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x55), .O(new_n296_));
  inv1   g145(.a(new_n296_), .O(z37));
  nand4  g146(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x56), .O(new_n298_));
  inv1   g147(.a(new_n298_), .O(z38));
  nand4  g148(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x57), .O(new_n300_));
  inv1   g149(.a(new_n300_), .O(z39));
  inv1   g150(.a(new_n163_), .O(new_n302_));
  nor3   g151(.a(new_n250_), .b(new_n302_), .c(new_n197_), .O(new_n303_));
  and2   g152(.a(new_n303_), .b(new_n289_), .O(z40));
  nand4  g153(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x59), .O(new_n305_));
  inv1   g154(.a(new_n305_), .O(z41));
  nand4  g155(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x60), .O(new_n307_));
  inv1   g156(.a(new_n307_), .O(z42));
  nand4  g157(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x61), .O(new_n309_));
  inv1   g158(.a(new_n309_), .O(z43));
  nand4  g159(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x62), .O(new_n311_));
  inv1   g160(.a(new_n311_), .O(z44));
  nand4  g161(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x63), .O(new_n313_));
  inv1   g162(.a(new_n313_), .O(z45));
  nand4  g163(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x64), .O(new_n315_));
  inv1   g164(.a(new_n315_), .O(z46));
  nor2   g165(.a(new_n239_), .b(new_n169_), .O(new_n317_));
  oai21  g166(.a(x75), .b(x67), .c(new_n317_), .O(new_n318_));
  inv1   g167(.a(new_n168_), .O(new_n319_));
  ...
  aoi21  g178(.a(new_n329_), .b(new_n318_), .c(x01), .O(z47));
  nand2  g179(.a(new_n317_), .b(x68), .O(new_n331_));
  ...
  nand2  g193(.a(new_n317_), .b(x70), .O(new_n345_));
  ...
  nand2  g200(.a(new_n317_), .b(x71), .O(new_n352_));
  ...
  nand2  g207(.a(new_n317_), .b(x72), .O(new_n359_));
  ...
  oai21  g222(.a(new_n325_), .b(x22), .c(new_n173_), .O(new_n374_));
  nor3   g223(.a(new_n374_), .b(new_n373_), .c(new_n322_), .O(z54));
  inv1   g224(.a(x80), .O(new_n376_));
  inv1   g225(.a(x82), .O(new_n377_));
  nand4  g226(.a(new_n276_), .b(x84), .c(new_n377_), .d(new_n376_), .O(new_n378_));
  nor3   g227(.a(new_n378_), .b(new_n254_), .c(new_n250_), .O(z55));
  aoi21  g228(.a(new_n169_), .b(new_n168_), .c(new_n238_), .O(new_n380_));
  aoi21  g229(.a(new_n302_), .b(x76), .c(new_n380_), .O(new_n381_));
  nor2   g230(.a(new_n244_), .b(new_n159_), .O(new_n382_));
  oai21  g231(.a(new_n381_), .b(new_n161_), .c(new_n382_), .O(z56));
  inv1   g232(.a(x02), .O(new_n384_));
  nand3  g233(.a(new_n245_), .b(x03), .c(new_n384_), .O(new_n385_));
  inv1   g234(.a(new_n385_), .O(z57));
  oai21  g235(.a(new_n319_), .b(new_n320_), .c(new_n161_), .O(new_n387_));
  ...
  aoi21  g239(.a(x42), .b(x40), .c(new_n162_), .O(new_n391_));
  ...
  aoi21  g246(.a(new_n397_), .b(new_n247_), .c(x01), .O(z59));
  aoi21  g247(.a(new_n380_), .b(x79), .c(new_n246_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g249(.a(new_n171_), .O(new_n401_));
  nand2  g250(.a(new_n169_), .b(new_n168_), .O(new_n402_));
  aoi22  g251(.a(new_n402_), .b(new_n238_), .c(new_n163_), .d(new_n320_), .O(new_n403_));
  nor3   g252(.a(new_n403_), .b(new_n401_), .c(new_n376_), .O(z61));
  inv1   g253(.a(new_n228_), .O(new_n405_));
  nand4  g254(.a(new_n275_), .b(new_n405_), .c(new_n229_), .d(x43), .O(new_n406_));
  nand3  g255(.a(new_n406_), .b(new_n227_), .c(x04), .O(new_n407_));
  nand3  g256(.a(x81), .b(x79), .c(new_n320_), .O(new_n408_));
  aoi21  g257(.a(new_n408_), .b(new_n407_), .c(new_n162_), .O(new_n409_));
  oai21  g258(.a(new_n409_), .b(new_n321_), .c(x78), .O(new_n410_));
  nand4  g259(.a(new_n402_), .b(x84), .c(x81), .d(x79), .O(new_n411_));
  aoi21  g260(.a(new_n411_), .b(new_n410_), .c(x01), .O(z62));
  nor3   g261(.a(new_n403_), .b(new_n401_), .c(new_n377_), .O(z63));
  nand2  g262(.a(x83), .b(x79), .O(new_n414_));
  or2    g263(.a(new_n414_), .b(new_n403_), .O(new_n415_));
  aoi21  g264(.a(new_n415_), .b(new_n322_), .c(x01), .O(z64));
  nand2  g265(.a(new_n402_), .b(x81), .O(new_n417_));
  nand3  g266(.a(x78), .b(x77), .c(new_n320_), .O(new_n418_));
  nand2  g267(.a(new_n171_), .b(x84), .O(new_n419_));
