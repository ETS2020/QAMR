// Benchmark "FAU" written by ABC on Mon Jul 27 23:24:45 2020
...
module FAU ( 
  ...
  nand2  g142(.a(new_n163_), .b(x54), .O(new_n294_));
  nor2   g143(.a(new_n294_), .b(new_n250_), .O(new_n295_));
  and2   g144(.a(new_n295_), .b(new_n289_), .O(z36));
