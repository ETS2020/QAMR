...
module FAU ( 
  ...
  nand4  g150(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x58), .O(new_n302_));
  inv1   g151(.a(new_n302_), .O(z40));
  nand4  g152(.a(new_n289_), .b(new_n287_), .c(new_n249_), .d(x59), .O(new_n304_));
  inv1   g153(.a(new_n304_), .O(z41));
  inv1   g154(.a(new_n163_), .O(new_n306_));
  nor3   g155(.a(new_n250_), .b(new_n306_), .c(new_n191_), .O(new_n307_));
  and2   g156(.a(new_n307_), .b(new_n289_), .O(z42));
  ...
  aoi21  g229(.a(new_n306_), .b(x76), .c(new_n380_), .O(new_n381_));
