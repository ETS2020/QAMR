...
module FAU ( 
  ...
  nand2  g178(.a(new_n323_), .b(new_n329_), .O(new_n330_));
  inv1   g179(.a(x16), .O(new_n331_));
  nand2  g180(.a(x52), .b(new_n331_), .O(new_n332_));
  nand3  g181(.a(new_n332_), .b(new_n330_), .c(new_n321_), .O(new_n333_));
  nand4  g182(.a(new_n238_), .b(new_n154_), .c(x77), .d(x68), .O(new_n334_));
