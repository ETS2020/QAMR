...
module FAU ( 
  ...
  oai21  g088(.a(new_n169_), .b(x41), .c(new_n167_), .O(new_n240_));
  ...
  nor2   g227(.a(new_n168_), .b(new_n166_), .O(new_n379_));
  nor2   g228(.a(new_n379_), .b(new_n237_), .O(new_n380_));
  aoi21  g229(.a(new_n378_), .b(x76), .c(new_n380_), .O(new_n381_));
  ...
  oai21  g235(.a(new_n166_), .b(new_n318_), .c(new_n161_), .O(new_n387_));
  ...
  inv1   g249(.a(new_n379_), .O(new_n401_));
  aoi22  g250(.a(new_n401_), .b(new_n237_), .c(new_n163_), .d(new_n318_), .O(new_n402_));
  nor3   g251(.a(new_n402_), .b(new_n171_), .c(new_n374_), .O(z61));
  ...
  nor3   g260(.a(new_n402_), .b(new_n171_), .c(new_n375_), .O(z63));
  nand2  g261(.a(new_n163_), .b(new_n318_), .O(new_n413_));
  nand2  g262(.a(new_n401_), .b(new_n237_), .O(new_n414_));
  ...
  nand2  g266(.a(new_n401_), .b(x81), .O(new_n418_));
  nand3  g267(.a(x78), .b(x77), .c(new_n318_), .O(new_n419_));
