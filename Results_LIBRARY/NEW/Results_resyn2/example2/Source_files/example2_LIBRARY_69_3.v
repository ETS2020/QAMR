...
module FAU ( 
  ...
  nand2  g184(.a(new_n321_), .b(new_n170_), .O(new_n336_));
  nor2   g185(.a(x52), .b(x09), .O(new_n337_));
  nor2   g186(.a(new_n323_), .b(x17), .O(new_n338_));
  nor3   g187(.a(new_n338_), .b(new_n337_), .c(new_n336_), .O(z49));
  ...
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n336_), .O(z54));
