...
module FAU ( 
  ...
  nand2  g212(.a(new_n321_), .b(new_n170_), .O(new_n364_));
  nor2   g213(.a(x52), .b(x13), .O(new_n365_));
  nor2   g214(.a(new_n323_), .b(x21), .O(new_n366_));
  nor3   g215(.a(new_n366_), .b(new_n365_), .c(new_n364_), .O(z53));
  nor2   g216(.a(x52), .b(x14), .O(new_n368_));
  nor2   g217(.a(new_n323_), .b(x22), .O(new_n369_));
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n364_), .O(z54));
