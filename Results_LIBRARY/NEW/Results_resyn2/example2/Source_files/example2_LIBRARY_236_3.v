...
module FAU ( 
  ...
  nor2   g094(.a(new_n154_), .b(new_n159_), .O(new_n246_));
  ...
  nor2   g163(.a(new_n236_), .b(new_n161_), .O(new_n315_));
  oai21  g164(.a(x75), .b(x67), .c(new_n315_), .O(new_n316_));
  inv1   g165(.a(new_n160_), .O(new_n317_));
  ...
  nor2   g226(.a(new_n235_), .b(new_n167_), .O(new_n378_));
  nor2   g227(.a(new_n378_), .b(new_n154_), .O(new_n379_));
  nand2  g228(.a(new_n159_), .b(new_n170_), .O(new_n380_));
  nand2  g229(.a(x79), .b(x76), .O(new_n381_));
  nand2  g230(.a(new_n381_), .b(new_n242_), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(new_n383_));
  oai21  g232(.a(new_n380_), .b(new_n379_), .c(new_n383_), .O(z56));
  inv1   g233(.a(x02), .O(new_n385_));
  nand3  g234(.a(new_n242_), .b(x03), .c(new_n385_), .O(new_n386_));
  inv1   g235(.a(new_n386_), .O(z57));
  oai21  g236(.a(new_n317_), .b(new_n318_), .c(new_n167_), .O(new_n388_));
  nand3  g237(.a(new_n167_), .b(new_n154_), .c(x40), .O(new_n389_));
  nand3  g238(.a(new_n231_), .b(new_n225_), .c(x79), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  aoi21  g240(.a(x42), .b(x40), .c(new_n159_), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(new_n391_), .O(new_n393_));
  aoi21  g242(.a(new_n393_), .b(new_n388_), .c(x01), .O(z58));
  nand3  g243(.a(new_n231_), .b(x79), .c(new_n153_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n225_), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(new_n389_), .O(new_n397_));
  nand2  g246(.a(new_n397_), .b(x77), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n244_), .c(x01), .O(z59));
  aoi21  g248(.a(new_n378_), .b(new_n162_), .c(new_n243_), .O(new_n400_));
  aoi21  g249(.a(new_n400_), .b(new_n233_), .c(x01), .O(z60));
  inv1   g250(.a(new_n168_), .O(new_n402_));
  aoi22  g251(.a(new_n246_), .b(new_n318_), .c(new_n235_), .d(new_n162_), .O(new_n403_));
  nor3   g252(.a(new_n403_), .b(new_n402_), .c(new_n374_), .O(z61));
  inv1   g253(.a(new_n227_), .O(new_n405_));
  nand4  g254(.a(new_n275_), .b(new_n405_), .c(new_n228_), .d(x43), .O(new_n406_));
  nand3  g255(.a(new_n406_), .b(new_n226_), .c(x04), .O(new_n407_));
  nand3  g256(.a(x81), .b(x79), .c(new_n318_), .O(new_n408_));
  aoi21  g257(.a(new_n408_), .b(new_n407_), .c(new_n159_), .O(new_n409_));
  ...
  nor3   g261(.a(new_n403_), .b(new_n402_), .c(new_n375_), .O(z63));
  ...
  nand2  g265(.a(new_n224_), .b(x77), .O(new_n417_));
  nand2  g266(.a(new_n247_), .b(new_n252_), .O(new_n418_));
  nand3  g267(.a(new_n418_), .b(new_n168_), .c(x84), .O(new_n419_));
  aoi21  g268(.a(new_n417_), .b(new_n160_), .c(new_n419_), .O(z65));
endmodule
