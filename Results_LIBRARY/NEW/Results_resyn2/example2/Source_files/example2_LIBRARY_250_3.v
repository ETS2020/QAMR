// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:37 2020
...
module FAU ( 
  ...
  nand3  g146(.a(new_n289_), .b(new_n274_), .c(x57), .O(new_n299_));
  inv1   g147(.a(new_n299_), .O(z39));
  nand3  g148(.a(new_n289_), .b(new_n274_), .c(x58), .O(new_n301_));
  inv1   g149(.a(new_n301_), .O(z40));
  nand3  g150(.a(new_n289_), .b(new_n274_), .c(x59), .O(new_n303_));
  inv1   g151(.a(new_n303_), .O(z41));
  nand3  g152(.a(new_n289_), .b(new_n274_), .c(x60), .O(new_n305_));
  inv1   g153(.a(new_n305_), .O(z42));
  nand3  g154(.a(new_n289_), .b(new_n274_), .c(x61), .O(new_n307_));
  inv1   g155(.a(new_n307_), .O(z43));
  nand3  g156(.a(new_n289_), .b(new_n274_), .c(x62), .O(new_n309_));
  inv1   g157(.a(new_n309_), .O(z44));
  nand3  g158(.a(new_n289_), .b(new_n274_), .c(x63), .O(new_n311_));
  inv1   g159(.a(new_n311_), .O(z45));
  nand3  g160(.a(new_n289_), .b(new_n274_), .c(x64), .O(new_n313_));
  ...
  nand4  g222(.a(new_n277_), .b(x84), .c(new_n374_), .d(new_n373_), .O(new_n375_));
  ...
  nand4  g252(.a(new_n276_), .b(new_n404_), .c(new_n229_), .d(x43), .O(new_n405_));
