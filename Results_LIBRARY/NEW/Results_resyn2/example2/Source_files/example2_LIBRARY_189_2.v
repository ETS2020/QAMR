...
module FAU ( 
  ...
  nor2   g113(.a(new_n162_), .b(x04), .O(new_n265_));
  nand4  g114(.a(new_n265_), .b(x45), .c(new_n230_), .d(new_n174_), .O(new_n266_));
  nor2   g115(.a(new_n266_), .b(new_n258_), .O(z27));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n265_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n265_), .b(new_n160_), .O(new_n420_));
