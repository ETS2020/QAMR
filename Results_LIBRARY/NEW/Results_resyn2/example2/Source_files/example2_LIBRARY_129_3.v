// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:35 2020
...
module FAU ( 
  ...
  nand3  g168(.a(new_n226_), .b(new_n319_), .c(x07), .O(new_n320_));
  nand2  g169(.a(new_n320_), .b(new_n318_), .O(new_n321_));
  nand3  g170(.a(new_n321_), .b(new_n225_), .c(new_n167_), .O(new_n322_));
  aoi21  g171(.a(new_n322_), .b(new_n317_), .c(x01), .O(z47));
  nand2  g172(.a(new_n316_), .b(x68), .O(new_n324_));
  inv1   g173(.a(x04), .O(new_n325_));
  nor2   g174(.a(x79), .b(new_n325_), .O(new_n326_));
  nand2  g175(.a(new_n326_), .b(new_n159_), .O(new_n327_));
  inv1   g176(.a(new_n327_), .O(new_n328_));
  inv1   g177(.a(x08), .O(new_n329_));
  nand2  g178(.a(new_n319_), .b(new_n329_), .O(new_n330_));
  ...
  aoi21  g182(.a(new_n333_), .b(new_n324_), .c(x01), .O(z48));
  nand2  g183(.a(new_n316_), .b(x69), .O(new_n335_));
  inv1   g184(.a(x09), .O(new_n336_));
  nand2  g185(.a(new_n319_), .b(new_n336_), .O(new_n337_));
  inv1   g186(.a(x17), .O(new_n338_));
  nand2  g187(.a(x52), .b(new_n338_), .O(new_n339_));
  nand3  g188(.a(new_n339_), .b(new_n337_), .c(new_n328_), .O(new_n340_));
  aoi21  g189(.a(new_n340_), .b(new_n335_), .c(x01), .O(z49));
  nand2  g190(.a(new_n316_), .b(x70), .O(new_n342_));
  ...
  nand3  g195(.a(new_n346_), .b(new_n344_), .c(new_n328_), .O(new_n347_));
  aoi21  g196(.a(new_n347_), .b(new_n342_), .c(x01), .O(z50));
  nand2  g197(.a(new_n316_), .b(x71), .O(new_n349_));
  inv1   g198(.a(x11), .O(new_n350_));
  nand2  g199(.a(new_n319_), .b(new_n350_), .O(new_n351_));
  inv1   g200(.a(x19), .O(new_n352_));
  nand2  g201(.a(x52), .b(new_n352_), .O(new_n353_));
  nand3  g202(.a(new_n353_), .b(new_n351_), .c(new_n328_), .O(new_n354_));
  aoi21  g203(.a(new_n354_), .b(new_n349_), .c(x01), .O(z51));
  nand2  g204(.a(new_n316_), .b(x72), .O(new_n356_));
  inv1   g205(.a(x12), .O(new_n357_));
  nand2  g206(.a(new_n319_), .b(new_n357_), .O(new_n358_));
  ...
  nand2  g211(.a(new_n316_), .b(x73), .O(new_n363_));
  inv1   g212(.a(x13), .O(new_n364_));
  nand2  g213(.a(new_n319_), .b(new_n364_), .O(new_n365_));
  inv1   g214(.a(x21), .O(new_n366_));
  nand2  g215(.a(x52), .b(new_n366_), .O(new_n367_));
  nand3  g216(.a(new_n367_), .b(new_n365_), .c(new_n328_), .O(new_n368_));
  aoi21  g217(.a(new_n368_), .b(new_n363_), .c(x01), .O(z53));
  nor2   g218(.a(x52), .b(x14), .O(new_n370_));
  oai21  g219(.a(new_n319_), .b(x22), .c(new_n170_), .O(new_n371_));
  nor3   g220(.a(new_n371_), .b(new_n370_), .c(new_n327_), .O(z54));
  inv1   g221(.a(x80), .O(new_n373_));
  inv1   g222(.a(x82), .O(new_n374_));
  nand4  g223(.a(new_n277_), .b(x84), .c(new_n374_), .d(new_n373_), .O(new_n375_));
  nor2   g224(.a(new_n375_), .b(new_n256_), .O(z55));
  aoi21  g225(.a(new_n161_), .b(new_n160_), .c(new_n236_), .O(new_n377_));
  aoi21  g226(.a(new_n248_), .b(x76), .c(new_n377_), .O(new_n378_));
  aoi21  g227(.a(new_n154_), .b(new_n226_), .c(new_n242_), .O(new_n379_));
  oai21  g228(.a(new_n378_), .b(new_n167_), .c(new_n379_), .O(z56));
  inv1   g229(.a(x02), .O(new_n381_));
  nand3  g230(.a(new_n243_), .b(x03), .c(new_n381_), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(z57));
  oai21  g232(.a(new_n159_), .b(new_n325_), .c(new_n167_), .O(new_n384_));
  nand3  g233(.a(new_n167_), .b(new_n154_), .c(x40), .O(new_n385_));
  nand3  g234(.a(new_n232_), .b(new_n225_), .c(x79), .O(new_n386_));
  nand2  g235(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  aoi21  g236(.a(x42), .b(x40), .c(new_n226_), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  aoi21  g238(.a(new_n389_), .b(new_n384_), .c(x01), .O(z58));
  nand3  g239(.a(new_n232_), .b(x79), .c(new_n153_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(new_n225_), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(new_n385_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(x77), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n245_), .c(x01), .O(z59));
  aoi21  g244(.a(new_n377_), .b(x79), .c(new_n244_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(new_n234_), .c(x01), .O(z60));
  inv1   g246(.a(new_n168_), .O(new_n398_));
  nand2  g247(.a(new_n247_), .b(new_n325_), .O(new_n399_));
  nand2  g248(.a(new_n236_), .b(new_n162_), .O(new_n400_));
  nand2  g249(.a(new_n400_), .b(new_n399_), .O(new_n401_));
  inv1   g250(.a(new_n401_), .O(new_n402_));
  nor3   g251(.a(new_n402_), .b(new_n398_), .c(new_n373_), .O(z61));
  inv1   g252(.a(new_n228_), .O(new_n404_));
  nand4  g253(.a(new_n276_), .b(new_n404_), .c(new_n229_), .d(x43), .O(new_n405_));
  nand3  g254(.a(new_n405_), .b(new_n227_), .c(x04), .O(new_n406_));
  nand3  g255(.a(x81), .b(x79), .c(new_n325_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n406_), .c(new_n226_), .O(new_n408_));
  oai21  g257(.a(new_n408_), .b(new_n326_), .c(x78), .O(new_n409_));
  nand4  g258(.a(new_n162_), .b(x84), .c(x81), .d(x79), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n409_), .c(x01), .O(z62));
  nor3   g260(.a(new_n402_), .b(new_n398_), .c(new_n374_), .O(z63));
  nand3  g261(.a(new_n401_), .b(x83), .c(x79), .O(new_n413_));
  aoi21  g262(.a(new_n413_), .b(new_n327_), .c(x01), .O(z64));
  nand2  g263(.a(new_n162_), .b(x81), .O(new_n415_));
  nand2  g264(.a(new_n168_), .b(x84), .O(new_n416_));
  aoi21  g265(.a(new_n415_), .b(new_n399_), .c(new_n416_), .O(z65));
endmodule
