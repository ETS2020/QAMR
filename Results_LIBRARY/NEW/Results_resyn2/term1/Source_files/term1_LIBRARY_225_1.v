...
module FAU ( 
  ...
  aoi21  g052(.a(new_n83_), .b(x29), .c(new_n93_), .O(new_n97_));
  xor2a  g053(.a(x31), .b(x30), .O(new_n98_));
  inv1   g054(.a(x31), .O(new_n99_));
  nand3  g055(.a(new_n88_), .b(new_n99_), .c(x30), .O(new_n100_));
  oai21  g056(.a(new_n98_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n79_), .O(z7));
  inv1   g058(.a(x15), .O(new_n103_));
  aoi21  g059(.a(x19), .b(x13), .c(x18), .O(new_n104_));
  inv1   g060(.a(x18), .O(new_n105_));
  aoi21  g061(.a(new_n69_), .b(x14), .c(new_n105_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n104_), .c(x17), .O(new_n107_));
  inv1   g063(.a(x16), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  nand3  g065(.a(x19), .b(x18), .c(x12), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(new_n111_));
  inv1   g067(.a(x11), .O(new_n112_));
  nand3  g068(.a(x19), .b(x18), .c(x17), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(x16), .c(new_n112_), .O(new_n114_));
  aoi21  g070(.a(new_n111_), .b(new_n107_), .c(new_n114_), .O(new_n115_));
  inv1   g071(.a(new_n113_), .O(new_n116_));
  nand2  g072(.a(x16), .b(x10), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  oai21  g075(.a(new_n115_), .b(new_n103_), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(x28), .b(x27), .c(x29), .O(new_n121_));
  xor2a  g077(.a(new_n121_), .b(new_n93_), .O(new_n122_));
  nor2   g078(.a(new_n99_), .b(x26), .O(new_n123_));
  and2   g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand2  g081(.a(new_n108_), .b(new_n112_), .O(new_n126_));
  inv1   g082(.a(new_n104_), .O(new_n127_));
  nand2  g083(.a(new_n110_), .b(new_n109_), .O(new_n128_));
  nand2  g084(.a(x16), .b(x15), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n116_), .O(new_n131_));
  inv1   g087(.a(x14), .O(new_n132_));
  nand2  g088(.a(x32), .b(x31), .O(new_n133_));
  aoi21  g089(.a(new_n69_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n131_), .c(new_n128_), .d(new_n127_), .O(new_n135_));
  aoi22  g091(.a(new_n129_), .b(new_n113_), .c(new_n117_), .d(new_n103_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n122_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(new_n77_), .O(new_n138_));
  ...
  xor2a  g097(.a(new_n121_), .b(x31), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n122_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n120_), .O(new_n145_));
  nand3  g101(.a(x33), .b(new_n108_), .c(new_n112_), .O(new_n146_));
  nand2  g102(.a(x18), .b(x17), .O(new_n147_));
  aoi21  g103(.a(new_n69_), .b(x14), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n130_), .O(new_n149_));
  nor2   g105(.a(new_n98_), .b(new_n47_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(new_n136_), .O(new_n151_));
  aoi22  g107(.a(x18), .b(x12), .c(x17), .d(x13), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n69_), .c(new_n147_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n142_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n151_), .c(new_n77_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n146_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x00), .O(new_n157_));
  aoi21  g113(.a(new_n145_), .b(new_n47_), .c(new_n157_), .O(z9));
endmodule
