...
module FAU ( 
  ...
  nand3  g075(.a(new_n102_), .b(x17), .c(x13), .O(new_n120_));
  nand3  g076(.a(x18), .b(new_n114_), .c(x12), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n110_), .O(new_n122_));
  nand4  g078(.a(x18), .b(x17), .c(new_n110_), .d(x11), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(x15), .O(new_n125_));
  inv1   g081(.a(new_n107_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x18), .c(new_n106_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n101_), .c(z0), .d(x19), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n119_), .c(new_n97_), .O(z8));
  nand2  g086(.a(new_n128_), .b(x19), .O(new_n131_));
  ...
  nand4  g093(.a(new_n47_), .b(x31), .c(x30), .d(x19), .O(new_n138_));
