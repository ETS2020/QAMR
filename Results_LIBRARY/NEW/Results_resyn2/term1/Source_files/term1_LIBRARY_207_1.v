...
module FAU ( 
  ...
  or2    g046(.a(new_n85_), .b(x30), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n76_), .O(new_n93_));
  ...
  nand3  g053(.a(new_n85_), .b(new_n97_), .c(x30), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n76_), .O(z7));
  nand3  g056(.a(x19), .b(x18), .c(x17), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand2  g058(.a(x16), .b(x10), .O(new_n103_));
  nand2  g059(.a(x15), .b(x11), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g061(.a(x16), .b(x15), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n105_), .c(new_n102_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  aoi21  g065(.a(x19), .b(x18), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(x19), .b(x14), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  inv1   g068(.a(x13), .O(new_n113_));
  inv1   g069(.a(x18), .O(new_n114_));
  inv1   g070(.a(x19), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n113_), .c(new_n114_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n112_), .c(new_n110_), .O(new_n117_));
  nand4  g073(.a(x19), .b(x18), .c(new_n109_), .d(x12), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n117_), .c(new_n106_), .O(new_n119_));
  oai21  g075(.a(x28), .b(x27), .c(x29), .O(new_n120_));
  xor2a  g076(.a(new_n120_), .b(x30), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n97_), .O(new_n122_));
  oai21  g078(.a(new_n119_), .b(new_n108_), .c(new_n122_), .O(new_n123_));
  inv1   g079(.a(x11), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  nand2  g081(.a(x18), .b(x17), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(new_n125_), .O(new_n127_));
  inv1   g083(.a(new_n106_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x18), .c(x17), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n115_), .O(new_n130_));
  inv1   g086(.a(x15), .O(new_n131_));
  oai21  g087(.a(new_n126_), .b(new_n103_), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n127_), .O(new_n133_));
  oai22  g089(.a(new_n106_), .b(new_n101_), .c(x18), .d(x13), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand2  g091(.a(x18), .b(x12), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n109_), .O(new_n137_));
  nor2   g093(.a(new_n111_), .b(z0), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(new_n135_), .d(new_n122_), .O(new_n139_));
  inv1   g095(.a(x00), .O(new_n140_));
  nand2  g096(.a(new_n111_), .b(x32), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(x26), .c(new_n140_), .O(new_n142_));
  oai21  g098(.a(new_n139_), .b(new_n133_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n123_), .b(z0), .c(new_n143_), .O(z8));
  nand2  g100(.a(new_n118_), .b(new_n117_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n128_), .c(new_n108_), .O(new_n146_));
  xor2a  g102(.a(new_n120_), .b(new_n97_), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n121_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n146_), .c(new_n47_), .O(new_n150_));
  inv1   g106(.a(new_n133_), .O(new_n151_));
  nand3  g107(.a(new_n137_), .b(new_n95_), .c(x33), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n147_), .c(new_n134_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n151_), .c(x26), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  inv1   g111(.a(new_n129_), .O(new_n156_));
  nor2   g112(.a(new_n47_), .b(x14), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n155_), .c(new_n140_), .O(z9));
endmodule
