...
module FAU ( 
  ...
  nand2  g004(.a(x03), .b(new_n48_), .O(new_n49_));
  nand2  g005(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  inv1   g006(.a(x33), .O(new_n51_));
  nor2   g007(.a(new_n50_), .b(new_n51_), .O(new_n52_));
  aoi21  g008(.a(new_n50_), .b(x32), .c(new_n52_), .O(z1));
  inv1   g009(.a(x08), .O(new_n54_));
  nor2   g010(.a(x03), .b(x02), .O(new_n55_));
  nor2   g011(.a(new_n46_), .b(new_n48_), .O(new_n56_));
  oai21  g012(.a(new_n56_), .b(new_n55_), .c(x01), .O(new_n57_));
  inv1   g013(.a(x01), .O(new_n58_));
  nand3  g014(.a(new_n55_), .b(x06), .c(x05), .O(new_n59_));
  inv1   g015(.a(x05), .O(new_n60_));
  oai21  g016(.a(new_n60_), .b(x03), .c(x02), .O(new_n61_));
  inv1   g017(.a(x06), .O(new_n62_));
  nand2  g018(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand4  g019(.a(new_n63_), .b(new_n61_), .c(new_n59_), .d(new_n58_), .O(new_n64_));
  xor2a  g020(.a(x07), .b(x04), .O(new_n65_));
  oai21  g021(.a(new_n49_), .b(x06), .c(new_n65_), .O(new_n66_));
  aoi21  g022(.a(new_n64_), .b(new_n57_), .c(new_n66_), .O(new_n67_));
  inv1   g023(.a(new_n65_), .O(new_n68_));
  nand2  g024(.a(new_n62_), .b(new_n48_), .O(new_n69_));
  nor2   g025(.a(new_n55_), .b(x01), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(new_n69_), .c(new_n61_), .O(new_n71_));
  nand2  g027(.a(x06), .b(x05), .O(new_n72_));
  nand3  g028(.a(new_n63_), .b(new_n72_), .c(new_n55_), .O(new_n73_));
  nand4  g029(.a(new_n73_), .b(new_n71_), .c(new_n68_), .d(new_n57_), .O(new_n74_));
  inv1   g030(.a(new_n74_), .O(new_n75_));
  nor4   g031(.a(new_n75_), .b(new_n67_), .c(x09), .d(new_n54_), .O(z2));
  ...
  nand4  g041(.a(new_n85_), .b(x25), .c(new_n46_), .d(x01), .O(new_n86_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n108_), .c(new_n51_), .O(new_n146_));
  ...
  aoi21  g117(.a(new_n161_), .b(new_n154_), .c(new_n51_), .O(new_n162_));
