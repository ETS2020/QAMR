...
module FAU ( 
  ...
  nand2  g052(.a(new_n82_), .b(x29), .O(new_n97_));
  inv1   g053(.a(x16), .O(new_n98_));
  nand2  g054(.a(x30), .b(x17), .O(new_n99_));
  ...
  nand2  g059(.a(x19), .b(x18), .O(new_n104_));
  inv1   g060(.a(x14), .O(new_n105_));
  inv1   g061(.a(x19), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n104_), .c(new_n103_), .d(new_n100_), .O(new_n108_));
  ...
  nand3  g067(.a(x19), .b(x18), .c(x11), .O(new_n112_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n111_), .c(x15), .O(new_n116_));
  nand2  g072(.a(x16), .b(x10), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n104_), .c(x15), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n100_), .O(new_n119_));
  nand2  g075(.a(z0), .b(x31), .O(new_n120_));
  aoi21  g076(.a(new_n119_), .b(new_n116_), .c(new_n120_), .O(new_n121_));
  nor2   g077(.a(z0), .b(x30), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n97_), .O(new_n123_));
  inv1   g079(.a(new_n97_), .O(new_n124_));
  nand2  g080(.a(x32), .b(x30), .O(new_n125_));
  inv1   g081(.a(x15), .O(new_n126_));
  nand4  g082(.a(new_n107_), .b(new_n104_), .c(new_n103_), .d(x16), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n114_), .c(new_n126_), .O(new_n128_));
  nor2   g084(.a(x30), .b(new_n109_), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n118_), .c(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n120_), .c(new_n125_), .O(new_n131_));
  inv1   g087(.a(x12), .O(new_n132_));
  oai21  g088(.a(new_n104_), .b(new_n132_), .c(new_n109_), .O(new_n133_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(new_n133_), .d(new_n103_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand4  g097(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n106_), .c(new_n126_), .O(new_n143_));
  oai21  g099(.a(new_n112_), .b(new_n109_), .c(new_n98_), .O(new_n144_));
  and2   g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n141_), .c(z0), .O(new_n146_));
  aoi21  g102(.a(new_n131_), .b(new_n124_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n74_), .b(x00), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n123_), .c(new_n148_), .O(z8));
  nand3  g105(.a(new_n119_), .b(new_n116_), .c(new_n47_), .O(new_n150_));
  nor2   g106(.a(new_n47_), .b(new_n137_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nor2   g108(.a(x33), .b(x31), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n152_), .c(new_n150_), .d(new_n124_), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n130_), .c(new_n152_), .O(new_n156_));
  aoi21  g112(.a(x18), .b(x12), .c(x17), .O(new_n157_));
  nor2   g113(.a(x18), .b(x13), .O(new_n158_));
  xor2a  g114(.a(x31), .b(x30), .O(new_n159_));
  nor4   g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n138_), .O(new_n160_));
  nand2  g116(.a(new_n142_), .b(new_n126_), .O(new_n161_));
  nand2  g117(.a(new_n134_), .b(new_n106_), .O(new_n162_));
  nand3  g118(.a(x18), .b(x17), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n98_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n162_), .c(new_n161_), .d(new_n136_), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n160_), .c(new_n47_), .O(new_n167_));
  aoi21  g123(.a(new_n156_), .b(new_n97_), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n155_), .c(new_n148_), .O(z9));
endmodule
