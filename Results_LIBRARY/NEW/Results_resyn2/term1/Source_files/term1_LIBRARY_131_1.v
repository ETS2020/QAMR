// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:33 2020
...
module FAU ( 
  ...
  nand2  g067(.a(new_n111_), .b(new_n102_), .O(new_n112_));
  ...
  and2   g073(.a(new_n117_), .b(new_n103_), .O(new_n118_));
  ...
  aoi21  g077(.a(new_n79_), .b(new_n66_), .c(new_n86_), .O(new_n122_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(new_n122_), .O(new_n137_));
  inv1   g093(.a(new_n122_), .O(new_n138_));
  nor2   g094(.a(new_n96_), .b(x33), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n121_), .c(new_n107_), .O(new_n140_));
  ...
  oai21  g102(.a(new_n126_), .b(new_n146_), .c(new_n102_), .O(new_n147_));
  nand2  g103(.a(x19), .b(x12), .O(new_n148_));
  nand2  g104(.a(new_n115_), .b(x17), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n147_), .c(new_n145_), .d(new_n98_), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n143_), .c(new_n47_), .O(new_n153_));
  aoi21  g109(.a(new_n141_), .b(new_n138_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n137_), .c(new_n133_), .O(z9));
endmodule
