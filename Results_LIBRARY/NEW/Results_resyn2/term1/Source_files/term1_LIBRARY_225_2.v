...
module FAU ( 
  ...
  nand2  g055(.a(x17), .b(x10), .O(new_n100_));
  ...
  and2   g076(.a(x31), .b(x16), .O(new_n121_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n90_), .c(x16), .O(new_n135_));
  ...
  nand4  g094(.a(new_n47_), .b(x31), .c(x30), .d(x16), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n114_), .c(new_n137_), .O(new_n140_));
  inv1   g096(.a(new_n124_), .O(new_n141_));
  nand3  g097(.a(new_n127_), .b(new_n95_), .c(x16), .O(new_n142_));
