// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:24 2020
...
module FAU ( 
  ...
  aoi21  g030(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(new_n75_));
  aoi21  g031(.a(new_n75_), .b(new_n71_), .c(new_n68_), .O(new_n76_));
  ...
  oai21  g049(.a(new_n74_), .b(new_n72_), .c(new_n73_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n71_), .O(new_n95_));
  nand2  g051(.a(x31), .b(x30), .O(new_n96_));
  inv1   g052(.a(x31), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n90_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  or2    g055(.a(new_n99_), .b(new_n85_), .O(new_n100_));
  aoi21  g056(.a(new_n85_), .b(x31), .c(new_n68_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n95_), .O(z7));
  ...
  oai21  g063(.a(new_n107_), .b(new_n72_), .c(new_n103_), .O(new_n108_));
  inv1   g064(.a(x16), .O(new_n109_));
  nand3  g065(.a(new_n106_), .b(x18), .c(x11), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g067(.a(x19), .b(x13), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n72_), .O(new_n113_));
  nand2  g069(.a(x19), .b(x18), .O(new_n114_));
  inv1   g070(.a(x14), .O(new_n115_));
  nand2  g071(.a(new_n105_), .b(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n114_), .c(new_n113_), .O(new_n117_));
  nand3  g073(.a(x19), .b(x18), .c(x12), .O(new_n118_));
  and2   g074(.a(new_n118_), .b(new_n104_), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(x17), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n109_), .c(new_n111_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x15), .O(new_n122_));
  aoi21  g078(.a(new_n79_), .b(new_n66_), .c(new_n86_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(x30), .c(x31), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(x30), .c(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n108_), .O(new_n126_));
  nand3  g082(.a(new_n106_), .b(x16), .c(x15), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n72_), .O(new_n128_));
  nand3  g084(.a(new_n116_), .b(new_n113_), .c(x32), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n128_), .c(new_n119_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n111_), .d(new_n108_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n67_), .c(x00), .O(new_n132_));
  aoi21  g088(.a(new_n126_), .b(z0), .c(new_n132_), .O(z8));
  nand2  g089(.a(new_n67_), .b(x00), .O(new_n134_));
  nand2  g090(.a(new_n122_), .b(new_n108_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n96_), .c(new_n47_), .O(new_n136_));
  nand2  g092(.a(x33), .b(x31), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n123_), .O(new_n138_));
  inv1   g094(.a(new_n123_), .O(new_n139_));
  nor2   g095(.a(new_n98_), .b(x33), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n122_), .c(new_n108_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  aoi21  g098(.a(new_n106_), .b(x11), .c(x16), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n103_), .c(new_n107_), .O(new_n144_));
  inv1   g100(.a(new_n127_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x18), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  oai21  g103(.a(new_n127_), .b(new_n147_), .c(new_n72_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x12), .O(new_n149_));
  nand2  g105(.a(new_n116_), .b(x17), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n148_), .c(new_n146_), .d(new_n99_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n144_), .c(new_n47_), .O(new_n154_));
  aoi21  g110(.a(new_n142_), .b(new_n139_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n138_), .c(new_n134_), .O(z9));
endmodule
