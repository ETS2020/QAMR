...
module FAU ( 
  ...
  nand3  g063(.a(new_n69_), .b(x18), .c(x14), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(new_n109_));
  nand4  g065(.a(x19), .b(x18), .c(new_n105_), .d(x11), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(x17), .O(new_n112_));
  inv1   g068(.a(x17), .O(new_n113_));
  nand4  g069(.a(x18), .b(new_n113_), .c(x16), .d(x12), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n104_), .O(new_n115_));
  nand4  g071(.a(x17), .b(x16), .c(new_n104_), .d(x10), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n69_), .c(new_n106_), .O(new_n117_));
  oai21  g073(.a(x28), .b(x27), .c(x29), .O(new_n118_));
  xor2a  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(x32), .c(new_n100_), .O(new_n120_));
  oai21  g076(.a(new_n117_), .b(new_n115_), .c(new_n120_), .O(new_n121_));
  nand3  g077(.a(x19), .b(x16), .c(x15), .O(new_n122_));
  nand3  g078(.a(x19), .b(x16), .c(x10), .O(new_n123_));
  aoi22  g079(.a(new_n123_), .b(new_n104_), .c(new_n122_), .d(new_n106_), .O(new_n124_));
  nand4  g080(.a(x18), .b(x16), .c(x15), .d(x12), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n113_), .O(new_n126_));
  nand2  g082(.a(new_n106_), .b(x13), .O(new_n127_));
  inv1   g083(.a(new_n122_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(x17), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n126_), .c(new_n124_), .O(new_n130_));
  inv1   g086(.a(new_n119_), .O(new_n131_));
  nand2  g087(.a(x19), .b(x11), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n105_), .O(new_n133_));
  inv1   g089(.a(x14), .O(new_n134_));
  nand2  g090(.a(new_n69_), .b(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n131_), .d(x31), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n130_), .c(x32), .O(new_n137_));
  nand2  g093(.a(new_n77_), .b(x00), .O(new_n138_));
  aoi21  g094(.a(new_n137_), .b(new_n121_), .c(new_n138_), .O(z8));
  nand2  g095(.a(new_n119_), .b(new_n98_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  oai21  g097(.a(new_n117_), .b(new_n115_), .c(new_n141_), .O(new_n142_));
  inv1   g098(.a(new_n138_), .O(new_n143_));
  inv1   g099(.a(new_n130_), .O(new_n144_));
  nand4  g100(.a(new_n135_), .b(new_n133_), .c(new_n144_), .d(x33), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n140_), .c(new_n143_), .O(new_n146_));
  aoi21  g102(.a(new_n142_), .b(new_n47_), .c(new_n146_), .O(z9));
endmodule
