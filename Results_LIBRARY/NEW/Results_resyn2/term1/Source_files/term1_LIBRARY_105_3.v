...
module FAU ( 
  ...
  nand2  g029(.a(new_n51_), .b(x25), .O(new_n74_));
  ...
  xnor2a g053(.a(new_n97_), .b(new_n93_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n75_), .O(z7));
  ...
  nand3  g060(.a(new_n104_), .b(x16), .c(x10), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n101_), .c(new_n100_), .O(new_n106_));
  inv1   g062(.a(x16), .O(new_n107_));
  nand3  g063(.a(new_n104_), .b(x19), .c(x11), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand2  g066(.a(x18), .b(x12), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n101_), .c(new_n102_), .O(new_n112_));
  aoi21  g068(.a(x19), .b(x13), .c(x18), .O(new_n113_));
  aoi21  g069(.a(new_n101_), .b(x14), .c(new_n103_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(x17), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n112_), .c(new_n107_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n110_), .c(x15), .O(new_n117_));
  aoi21  g073(.a(new_n78_), .b(new_n66_), .c(new_n85_), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(x30), .c(x31), .O(new_n119_));
  aoi21  g075(.a(new_n118_), .b(x30), .c(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n117_), .c(new_n106_), .O(new_n121_));
  inv1   g077(.a(x26), .O(new_n122_));
  nand3  g078(.a(new_n104_), .b(x16), .c(x15), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  inv1   g080(.a(new_n113_), .O(new_n125_));
  inv1   g081(.a(x14), .O(new_n126_));
  aoi21  g082(.a(new_n101_), .b(new_n126_), .c(z0), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(new_n112_), .O(new_n128_));
  aoi21  g084(.a(new_n124_), .b(x19), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n120_), .c(new_n109_), .d(new_n106_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n122_), .c(x00), .O(new_n131_));
  aoi21  g087(.a(new_n121_), .b(z0), .c(new_n131_), .O(z8));
  nand2  g088(.a(new_n122_), .b(x00), .O(new_n133_));
  nand2  g089(.a(new_n117_), .b(new_n106_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n96_), .c(new_n47_), .O(new_n135_));
  nand2  g091(.a(x33), .b(x31), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(new_n118_), .O(new_n137_));
  inv1   g093(.a(new_n118_), .O(new_n138_));
  nor2   g094(.a(new_n95_), .b(x33), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n117_), .c(new_n106_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  aoi21  g097(.a(new_n104_), .b(x11), .c(x16), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n100_), .c(new_n105_), .O(new_n143_));
  oai21  g099(.a(x18), .b(x13), .c(x17), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n111_), .O(new_n145_));
  nand2  g101(.a(new_n101_), .b(x14), .O(new_n146_));
  nand2  g102(.a(new_n124_), .b(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n123_), .b(new_n101_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n145_), .d(new_n97_), .O(new_n149_));
