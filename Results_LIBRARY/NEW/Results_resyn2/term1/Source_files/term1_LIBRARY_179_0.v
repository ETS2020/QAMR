...
module FAU ( 
  ...
  xnor2a g046(.a(x31), .b(x30), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  inv1   g048(.a(x31), .O(new_n93_));
  nand3  g049(.a(new_n81_), .b(new_n93_), .c(x30), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n72_), .O(z7));
  nand2  g052(.a(new_n70_), .b(x00), .O(new_n97_));
  inv1   g053(.a(x16), .O(new_n98_));
  inv1   g054(.a(x14), .O(new_n99_));
  oai21  g055(.a(x19), .b(new_n99_), .c(x18), .O(new_n100_));
  ...
  nand3  g063(.a(new_n107_), .b(new_n101_), .c(x12), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n98_), .O(new_n109_));
  nand2  g065(.a(x17), .b(x11), .O(new_n110_));
  nand2  g066(.a(new_n107_), .b(new_n98_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n109_), .c(x15), .O(new_n113_));
  inv1   g069(.a(x15), .O(new_n114_));
  nand3  g070(.a(x17), .b(x16), .c(x10), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n107_), .c(new_n114_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n113_), .O(new_n118_));
  oai21  g074(.a(x28), .b(x27), .c(x29), .O(new_n119_));
  xor2a  g075(.a(new_n119_), .b(new_n86_), .O(new_n120_));
  and2   g076(.a(new_n120_), .b(x31), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(z0), .O(new_n122_));
  ...
  aoi21  g083(.a(new_n102_), .b(x13), .c(new_n127_), .O(new_n128_));
  oai21  g084(.a(new_n115_), .b(new_n106_), .c(new_n114_), .O(new_n129_));
  nand2  g085(.a(new_n127_), .b(new_n102_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  oai21  g088(.a(x19), .b(x14), .c(x17), .O(new_n133_));
  nand2  g089(.a(x19), .b(x12), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x16), .O(new_n136_));
  oai21  g092(.a(new_n110_), .b(new_n106_), .c(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n132_), .c(new_n121_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x32), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n124_), .c(new_n97_), .O(z8));
  xor2a  g096(.a(new_n119_), .b(new_n93_), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n120_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n118_), .O(new_n143_));
  inv1   g099(.a(new_n97_), .O(new_n144_));
  aoi22  g100(.a(x17), .b(x11), .c(x16), .d(x12), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n114_), .c(new_n115_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x19), .c(new_n126_), .O(new_n147_));
  oai21  g103(.a(new_n106_), .b(x13), .c(new_n100_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n126_), .c(new_n141_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n130_), .c(new_n91_), .d(x33), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n147_), .c(new_n144_), .O(new_n151_));
  aoi21  g107(.a(new_n143_), .b(new_n47_), .c(new_n151_), .O(z9));
endmodule
