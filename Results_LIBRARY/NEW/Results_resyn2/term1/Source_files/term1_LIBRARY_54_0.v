...
module FAU ( 
  ...
  nand2  g009(.a(x05), .b(new_n53_), .O(new_n54_));
  nand3  g010(.a(new_n54_), .b(x06), .c(new_n52_), .O(new_n55_));
  nand2  g011(.a(x06), .b(new_n52_), .O(new_n56_));
  nand3  g012(.a(new_n56_), .b(x05), .c(new_n53_), .O(new_n57_));
  ...
  nand4  g030(.a(new_n74_), .b(x25), .c(new_n52_), .d(x01), .O(new_n75_));
