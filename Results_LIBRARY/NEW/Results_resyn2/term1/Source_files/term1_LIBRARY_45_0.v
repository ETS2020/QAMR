...
module FAU ( 
  ...
  oai21  g067(.a(x18), .b(new_n111_), .c(x17), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n103_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n107_), .c(x15), .O(new_n114_));
  ...
  nand2  g095(.a(new_n104_), .b(x13), .O(new_n140_));
  oai21  g096(.a(x17), .b(x12), .c(x16), .O(new_n141_));
