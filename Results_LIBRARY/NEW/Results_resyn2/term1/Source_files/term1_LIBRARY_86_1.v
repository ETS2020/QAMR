...
module FAU ( 
  ...
  xnor2a g052(.a(x31), .b(x30), .O(new_n97_));
  ...
  aoi21  g061(.a(x18), .b(x14), .c(x19), .O(new_n106_));
  ...
  and2   g065(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  inv1   g067(.a(x16), .O(new_n112_));
  inv1   g068(.a(new_n109_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(x11), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n111_), .c(new_n104_), .O(new_n115_));
  nand3  g071(.a(x16), .b(new_n104_), .c(x10), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n109_), .O(new_n117_));
  oai21  g073(.a(x28), .b(x27), .c(x29), .O(new_n118_));
  xor2a  g074(.a(new_n118_), .b(new_n92_), .O(new_n119_));
  nor2   g075(.a(x32), .b(new_n99_), .O(new_n120_));
  and2   g076(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  oai21  g077(.a(new_n117_), .b(new_n115_), .c(new_n121_), .O(new_n122_));
  nand4  g078(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n104_), .O(new_n124_));
  nand4  g080(.a(x19), .b(x17), .c(x16), .d(x15), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  inv1   g082(.a(x18), .O(new_n127_));
  nand3  g083(.a(x19), .b(x17), .c(x11), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n112_), .c(new_n127_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n126_), .c(new_n124_), .O(new_n130_));
  nor2   g086(.a(x19), .b(x14), .O(new_n131_));
  aoi21  g087(.a(new_n126_), .b(x18), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(x19), .b(x12), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n105_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n132_), .c(new_n119_), .d(x31), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n130_), .c(x32), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n122_), .c(new_n103_), .O(z8));
  xor2a  g093(.a(new_n118_), .b(new_n99_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n119_), .O(new_n139_));
  oai21  g095(.a(new_n117_), .b(new_n115_), .c(new_n139_), .O(new_n140_));
  inv1   g096(.a(new_n103_), .O(new_n141_));
  inv1   g097(.a(new_n138_), .O(new_n142_));
  nand3  g098(.a(new_n134_), .b(new_n97_), .c(x33), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n142_), .c(new_n132_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n130_), .c(new_n141_), .O(new_n146_));
  aoi21  g102(.a(new_n140_), .b(new_n47_), .c(new_n146_), .O(z9));
endmodule
