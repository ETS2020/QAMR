...
module FAU ( 
  ...
  nand2  g060(.a(x19), .b(x18), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x17), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(x15), .c(new_n104_), .d(new_n103_), .O(new_n109_));
  nand3  g065(.a(x18), .b(x17), .c(x11), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n102_), .c(new_n104_), .O(new_n111_));
  ...
  oai21  g072(.a(new_n113_), .b(new_n111_), .c(new_n116_), .O(new_n117_));
  ...
  oai21  g080(.a(new_n109_), .b(new_n102_), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x32), .O(new_n126_));
  inv1   g082(.a(x17), .O(new_n127_));
  nand3  g083(.a(new_n104_), .b(x18), .c(x14), .O(new_n128_));
  ...
  nor2   g090(.a(new_n127_), .b(x16), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n106_), .c(new_n74_), .d(x11), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n134_), .c(new_n114_), .O(new_n137_));
  nand3  g093(.a(new_n108_), .b(new_n114_), .c(x10), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n102_), .O(new_n139_));
  inv1   g095(.a(x31), .O(new_n140_));
  nor2   g096(.a(x32), .b(new_n140_), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n119_), .O(new_n142_));
  oai21  g098(.a(new_n139_), .b(new_n137_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n126_), .c(new_n101_), .O(z8));
  inv1   g100(.a(new_n118_), .O(new_n145_));
  inv1   g101(.a(new_n97_), .O(new_n146_));
  nor2   g102(.a(new_n105_), .b(x33), .O(new_n147_));
  and2   g103(.a(x15), .b(x11), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n135_), .d(new_n146_), .O(new_n149_));
  oai21  g105(.a(new_n47_), .b(x31), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n74_), .O(new_n151_));
  oai21  g107(.a(new_n133_), .b(new_n131_), .c(x15), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n138_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n146_), .c(new_n47_), .d(x16), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n145_), .O(new_n156_));
  nand4  g112(.a(new_n148_), .b(new_n147_), .c(new_n135_), .d(new_n95_), .O(new_n157_));
  oai21  g113(.a(new_n47_), .b(new_n140_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n74_), .O(new_n159_));
  nand2  g115(.a(new_n95_), .b(x16), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n153_), .c(new_n47_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  oai21  g119(.a(x19), .b(new_n103_), .c(new_n113_), .O(new_n164_));
  nand2  g120(.a(new_n122_), .b(new_n98_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n117_), .c(new_n74_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n164_), .c(new_n47_), .O(new_n167_));
  aoi21  g123(.a(new_n163_), .b(new_n118_), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n156_), .c(new_n101_), .O(z9));
endmodule
