...
module FAU ( 
  ...
  oai21  g008(.a(new_n49_), .b(new_n47_), .c(x01), .O(new_n53_));
  inv1   g009(.a(x05), .O(new_n54_));
  inv1   g010(.a(x06), .O(new_n55_));
  oai21  g011(.a(new_n55_), .b(new_n54_), .c(new_n46_), .O(new_n56_));
  aoi22  g012(.a(new_n56_), .b(new_n50_), .c(new_n55_), .d(new_n54_), .O(new_n57_));
  oai21  g013(.a(new_n57_), .b(x01), .c(new_n53_), .O(new_n58_));
  xnor2a g014(.a(x07), .b(x04), .O(new_n59_));
  inv1   g015(.a(new_n59_), .O(new_n60_));
  inv1   g016(.a(x07), .O(new_n61_));
  aoi21  g017(.a(x05), .b(x04), .c(x03), .O(new_n62_));
  inv1   g018(.a(x04), .O(new_n63_));
  nor2   g019(.a(new_n63_), .b(new_n48_), .O(new_n64_));
  nor4   g020(.a(new_n64_), .b(new_n62_), .c(new_n61_), .d(x01), .O(new_n65_));
  inv1   g021(.a(new_n64_), .O(new_n66_));
  nand3  g022(.a(x05), .b(new_n63_), .c(new_n48_), .O(new_n67_));
  nand2  g023(.a(new_n61_), .b(new_n46_), .O(new_n68_));
  aoi21  g024(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  oai21  g025(.a(new_n69_), .b(new_n65_), .c(new_n55_), .O(new_n70_));
  nor2   g026(.a(x04), .b(x02), .O(new_n71_));
  nand2  g027(.a(x04), .b(x02), .O(new_n72_));
  oai21  g028(.a(x06), .b(x02), .c(new_n72_), .O(new_n73_));
  nor4   g029(.a(new_n73_), .b(new_n71_), .c(new_n61_), .d(x01), .O(new_n74_));
  nand2  g030(.a(new_n71_), .b(x06), .O(new_n75_));
  nand2  g031(.a(new_n61_), .b(new_n48_), .O(new_n76_));
  aoi21  g032(.a(new_n75_), .b(new_n72_), .c(new_n76_), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(new_n74_), .c(new_n54_), .O(new_n78_));
  nand2  g034(.a(new_n49_), .b(x06), .O(new_n79_));
  aoi21  g035(.a(new_n47_), .b(x05), .c(x01), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(new_n59_), .c(new_n53_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n78_), .c(new_n70_), .O(new_n83_));
  aoi21  g039(.a(new_n60_), .b(new_n58_), .c(new_n83_), .O(new_n84_));
  inv1   g040(.a(x09), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(x08), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n84_), .O(z2));
