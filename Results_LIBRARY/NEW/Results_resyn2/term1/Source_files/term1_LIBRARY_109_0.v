...
module FAU ( 
  ...
  xor2a  g045(.a(new_n84_), .b(new_n89_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n75_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z6));
  aoi21  g048(.a(new_n73_), .b(x23), .c(new_n72_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n71_), .O(new_n94_));
  ...
  or2    g054(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  aoi21  g055(.a(new_n84_), .b(x31), .c(new_n68_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z7));
  ...
  aoi21  g078(.a(new_n78_), .b(new_n66_), .c(new_n85_), .O(new_n123_));
  ...
  nor2   g083(.a(new_n127_), .b(new_n103_), .O(new_n128_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n95_), .c(new_n47_), .O(new_n136_));
  ...
  oai21  g103(.a(new_n127_), .b(new_n147_), .c(new_n103_), .O(new_n148_));
