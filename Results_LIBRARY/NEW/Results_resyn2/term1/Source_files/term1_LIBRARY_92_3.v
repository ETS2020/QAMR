...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n103_), .c(new_n102_), .d(new_n99_), .O(new_n107_));
  inv1   g063(.a(new_n103_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n98_), .c(x12), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n97_), .O(new_n110_));
  nand2  g066(.a(new_n108_), .b(x11), .O(new_n111_));
  nand2  g067(.a(new_n99_), .b(new_n97_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n110_), .c(x15), .O(new_n114_));
  nand3  g070(.a(new_n108_), .b(x16), .c(x10), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  nand2  g073(.a(new_n82_), .b(x29), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n106_), .b(new_n103_), .c(new_n102_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x16), .O(new_n121_));
  inv1   g077(.a(x15), .O(new_n122_));
  aoi21  g078(.a(new_n111_), .b(new_n97_), .c(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(new_n116_), .O(new_n124_));
  nand3  g080(.a(new_n118_), .b(x30), .c(x17), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n119_), .c(x31), .O(new_n127_));
  nand2  g083(.a(new_n111_), .b(new_n97_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nor2   g085(.a(z0), .b(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n106_), .d(new_n102_), .O(new_n131_));
  ...
  aoi22  g092(.a(new_n136_), .b(x19), .c(new_n115_), .d(new_n122_), .O(new_n137_));
  xor2a  g093(.a(new_n118_), .b(new_n91_), .O(new_n138_));
  nand2  g094(.a(new_n108_), .b(x12), .O(new_n139_));
  oai21  g095(.a(new_n133_), .b(new_n139_), .c(new_n98_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n137_), .d(new_n132_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n74_), .c(x00), .O(new_n142_));
  aoi21  g098(.a(new_n127_), .b(z0), .c(new_n142_), .O(z8));
  nand2  g099(.a(new_n74_), .b(x00), .O(new_n144_));
  nand3  g100(.a(new_n117_), .b(new_n114_), .c(new_n129_), .O(new_n145_));
  nand2  g101(.a(x33), .b(new_n129_), .O(new_n146_));
  nand2  g102(.a(new_n47_), .b(x31), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n118_), .O(new_n148_));
  inv1   g104(.a(new_n118_), .O(new_n149_));
  nand4  g105(.a(new_n47_), .b(x31), .c(x30), .d(x17), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n124_), .c(new_n146_), .O(new_n151_));
  aoi21  g107(.a(x18), .b(x12), .c(x17), .O(new_n152_));
  oai21  g108(.a(x18), .b(x13), .c(new_n106_), .O(new_n153_));
  xor2a  g109(.a(x31), .b(x30), .O(new_n154_));
  nor3   g110(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  xor2a  g111(.a(new_n135_), .b(x19), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n134_), .b(new_n157_), .c(new_n122_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n134_), .b(new_n159_), .c(new_n97_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n155_), .O(new_n163_));
  aoi22  g119(.a(new_n163_), .b(x33), .c(new_n151_), .d(new_n149_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n148_), .c(new_n144_), .O(z9));
endmodule
