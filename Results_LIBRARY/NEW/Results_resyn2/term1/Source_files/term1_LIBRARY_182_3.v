...
module FAU ( 
  ...
  nand2  g052(.a(new_n96_), .b(new_n90_), .O(new_n97_));
  ...
  nor2   g064(.a(new_n104_), .b(new_n108_), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(new_n107_), .c(new_n104_), .d(new_n103_), .O(new_n110_));
  nand3  g066(.a(x18), .b(x17), .c(x11), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n108_), .c(new_n104_), .O(new_n112_));
  ...
  oai21  g072(.a(new_n114_), .b(new_n112_), .c(new_n116_), .O(new_n117_));
  oai21  g073(.a(x28), .b(x27), .c(x29), .O(new_n118_));
  xor2a  g074(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  nand2  g075(.a(x18), .b(x12), .O(new_n120_));
  oai21  g076(.a(x18), .b(x13), .c(x17), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n119_), .c(x31), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n117_), .c(new_n74_), .O(new_n124_));
  oai21  g080(.a(new_n110_), .b(new_n102_), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x32), .O(new_n126_));
  nand3  g082(.a(new_n104_), .b(x18), .c(x14), .O(new_n127_));
  nand3  g083(.a(x19), .b(new_n106_), .c(x13), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n105_), .O(new_n129_));
  nand4  g085(.a(x19), .b(x18), .c(new_n105_), .d(x12), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n129_), .c(x16), .O(new_n132_));
  inv1   g088(.a(new_n111_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x19), .c(new_n108_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n132_), .c(new_n102_), .O(new_n135_));
  inv1   g091(.a(x10), .O(new_n136_));
  nor2   g092(.a(x15), .b(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n107_), .O(new_n138_));
  nand2  g094(.a(new_n109_), .b(new_n74_), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nor2   g096(.a(x32), .b(new_n96_), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n119_), .O(new_n142_));
  oai21  g098(.a(new_n140_), .b(new_n135_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n126_), .c(new_n101_), .O(z8));
  nor2   g100(.a(new_n97_), .b(x33), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n137_), .c(new_n109_), .d(new_n107_), .O(new_n146_));
  oai21  g102(.a(new_n47_), .b(new_n96_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n74_), .O(new_n148_));
  nand2  g104(.a(new_n145_), .b(new_n135_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n118_), .O(new_n151_));
  inv1   g107(.a(new_n118_), .O(new_n152_));
  nand2  g108(.a(new_n134_), .b(new_n132_), .O(new_n153_));
  inv1   g109(.a(new_n95_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n47_), .c(x15), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand4  g113(.a(new_n137_), .b(new_n109_), .c(new_n107_), .d(new_n154_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n47_), .O(new_n159_));
  aoi21  g115(.a(x33), .b(x31), .c(x26), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  oai21  g118(.a(x19), .b(new_n103_), .c(new_n114_), .O(new_n163_));
  nand2  g119(.a(new_n122_), .b(new_n98_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n117_), .c(new_n74_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n163_), .c(new_n47_), .O(new_n166_));
  aoi21  g122(.a(new_n162_), .b(new_n152_), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n151_), .c(new_n101_), .O(z9));
endmodule
