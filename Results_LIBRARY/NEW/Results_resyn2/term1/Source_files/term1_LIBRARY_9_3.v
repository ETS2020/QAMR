// Benchmark "FAU" written by ABC on Tue Jul 28 01:54:43 2020
...
module FAU ( 
  ...
  aoi21  g053(.a(new_n79_), .b(new_n66_), .c(new_n86_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(x30), .c(x31), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(x30), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g074(.a(new_n118_), .b(new_n107_), .c(new_n100_), .O(new_n119_));
  nand3  g075(.a(new_n105_), .b(x16), .c(x15), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  inv1   g077(.a(new_n114_), .O(new_n122_));
  inv1   g078(.a(x14), .O(new_n123_));
  nand2  g079(.a(new_n102_), .b(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n113_), .d(x32), .O(new_n125_));
  aoi21  g081(.a(new_n121_), .b(x19), .c(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n110_), .c(new_n107_), .d(new_n100_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n74_), .c(x00), .O(new_n128_));
  aoi21  g084(.a(new_n119_), .b(z0), .c(new_n128_), .O(z8));
  inv1   g085(.a(x00), .O(new_n130_));
  inv1   g086(.a(new_n98_), .O(new_n131_));
  nand2  g087(.a(new_n118_), .b(new_n107_), .O(new_n132_));
  inv1   g088(.a(x31), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n90_), .c(new_n74_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(new_n47_), .O(new_n135_));
  nand2  g091(.a(x33), .b(new_n133_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n135_), .c(new_n131_), .O(new_n137_));
  nand4  g093(.a(new_n47_), .b(x31), .c(x30), .d(new_n74_), .O(new_n138_));
  ...
  nand2  g099(.a(new_n112_), .b(new_n103_), .O(new_n144_));
  inv1   g100(.a(x13), .O(new_n145_));
  nand2  g101(.a(new_n104_), .b(new_n145_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n144_), .c(new_n124_), .d(new_n95_), .O(new_n147_));
  xor2a  g103(.a(new_n120_), .b(x19), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n143_), .c(new_n47_), .O(new_n150_));
  aoi21  g106(.a(new_n141_), .b(new_n98_), .c(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n137_), .c(new_n130_), .O(z9));
endmodule
