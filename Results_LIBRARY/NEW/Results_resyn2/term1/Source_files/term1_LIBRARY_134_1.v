...
module FAU ( 
  ...
  nand3  g060(.a(new_n101_), .b(x19), .c(x11), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  aoi21  g063(.a(x19), .b(x13), .c(x18), .O(new_n108_));
  aoi21  g064(.a(new_n98_), .b(x14), .c(new_n100_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n108_), .c(x17), .O(new_n110_));
  nand2  g066(.a(x18), .b(x12), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n98_), .c(new_n99_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n107_), .c(x15), .O(new_n114_));
  nand2  g070(.a(new_n82_), .b(x29), .O(new_n115_));
  nand2  g071(.a(z0), .b(x30), .O(new_n116_));
  oai21  g072(.a(new_n115_), .b(new_n91_), .c(x31), .O(new_n117_));
  aoi21  g073(.a(new_n116_), .b(new_n115_), .c(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n114_), .c(new_n103_), .O(new_n119_));
  inv1   g075(.a(new_n108_), .O(new_n120_));
  inv1   g076(.a(new_n115_), .O(new_n121_));
  oai21  g077(.a(x19), .b(x14), .c(x31), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n112_), .c(new_n120_), .d(new_n106_), .O(new_n124_));
  nand2  g080(.a(new_n101_), .b(x15), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x16), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n98_), .c(new_n103_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n114_), .b(new_n103_), .c(new_n47_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x30), .O(new_n133_));
  inv1   g089(.a(x31), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n91_), .c(new_n47_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n121_), .O(new_n136_));
  nand2  g092(.a(new_n132_), .b(new_n134_), .O(new_n137_));
  aoi21  g093(.a(new_n134_), .b(new_n91_), .c(x33), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n121_), .O(new_n139_));
  oai21  g095(.a(new_n126_), .b(x19), .c(x16), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  nand2  g097(.a(new_n98_), .b(x14), .O(new_n142_));
  inv1   g098(.a(new_n127_), .O(new_n143_));
  nand2  g099(.a(new_n102_), .b(new_n97_), .O(new_n144_));
  nand2  g100(.a(new_n111_), .b(new_n99_), .O(new_n145_));
  inv1   g101(.a(x13), .O(new_n146_));
  nand2  g102(.a(new_n100_), .b(new_n146_), .O(new_n147_));
