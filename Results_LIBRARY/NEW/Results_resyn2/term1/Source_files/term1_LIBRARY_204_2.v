// Benchmark "FAU" written by ABC on Tue Jul 28 01:56:03 2020
...
module FAU ( 
  ...
  nand2  g056(.a(new_n82_), .b(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x30), .O(new_n103_));
  nand2  g059(.a(new_n101_), .b(new_n90_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(x31), .O(new_n105_));
  ...
  aoi22  g069(.a(new_n113_), .b(new_n108_), .c(new_n112_), .d(new_n107_), .O(new_n114_));
  inv1   g070(.a(x19), .O(new_n115_));
  nand3  g071(.a(new_n111_), .b(x16), .c(x15), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  inv1   g073(.a(new_n116_), .O(new_n118_));
  nand2  g074(.a(new_n115_), .b(x14), .O(new_n119_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n106_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x32), .O(new_n127_));
  nand3  g083(.a(new_n115_), .b(x18), .c(x14), .O(new_n128_));
  nand3  g084(.a(x19), .b(new_n110_), .c(x13), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n109_), .O(new_n130_));
  nand4  g086(.a(x19), .b(x18), .c(new_n109_), .d(x12), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  inv1   g089(.a(new_n113_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(x19), .c(new_n108_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n107_), .O(new_n136_));
  nor3   g092(.a(new_n112_), .b(new_n115_), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n106_), .b(z0), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n137_), .b(new_n136_), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n74_), .b(x00), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(new_n127_), .c(new_n141_), .O(z8));
  inv1   g098(.a(x00), .O(new_n143_));
  oai21  g099(.a(new_n137_), .b(new_n136_), .c(new_n47_), .O(new_n144_));
  nor2   g100(.a(new_n47_), .b(x26), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  oai22  g102(.a(new_n146_), .b(x31), .c(new_n144_), .d(new_n97_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n102_), .O(new_n148_));
  nand2  g104(.a(new_n145_), .b(x31), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n96_), .c(new_n149_), .O(new_n150_));
  and2   g106(.a(new_n125_), .b(new_n98_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n122_), .c(new_n146_), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n101_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n148_), .c(new_n143_), .O(z9));
endmodule
