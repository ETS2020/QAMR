...
module FAU ( 
  ...
  nand2  g054(.a(x32), .b(new_n98_), .O(new_n99_));
  inv1   g055(.a(x17), .O(new_n100_));
  nand3  g056(.a(x19), .b(x18), .c(x12), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  inv1   g058(.a(x18), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x19), .c(x16), .d(x15), .O(new_n105_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n107_), .c(new_n105_), .d(new_n102_), .O(new_n111_));
  nand2  g067(.a(new_n82_), .b(x29), .O(new_n112_));
  xor2a  g068(.a(new_n112_), .b(new_n91_), .O(new_n113_));
  inv1   g069(.a(x15), .O(new_n114_));
  nand3  g070(.a(new_n104_), .b(x16), .c(x10), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n109_), .c(new_n114_), .O(new_n116_));
  inv1   g072(.a(x16), .O(new_n117_));
  nand3  g073(.a(new_n104_), .b(x19), .c(x11), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n116_), .c(new_n113_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n111_), .c(x32), .O(new_n121_));
  inv1   g077(.a(new_n102_), .O(new_n122_));
  nand2  g078(.a(x19), .b(x18), .O(new_n123_));
  nand3  g079(.a(new_n110_), .b(new_n107_), .c(new_n123_), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(x17), .c(new_n122_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n117_), .c(new_n119_), .O(new_n126_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n121_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n74_), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n99_), .c(new_n97_), .O(z8));
  inv1   g088(.a(new_n112_), .O(new_n133_));
  nand2  g089(.a(x33), .b(new_n98_), .O(new_n134_));
  nand3  g090(.a(new_n127_), .b(new_n116_), .c(new_n47_), .O(new_n135_));
  nand3  g091(.a(x31), .b(x30), .c(new_n74_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand3  g094(.a(x33), .b(x31), .c(new_n74_), .O(new_n139_));
  nor2   g095(.a(x31), .b(x30), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n127_), .c(new_n116_), .d(new_n47_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g098(.a(new_n98_), .b(x30), .O(new_n143_));
  nand3  g099(.a(new_n104_), .b(x16), .c(x15), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n108_), .O(new_n145_));
  nand2  g101(.a(new_n104_), .b(x11), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n117_), .c(new_n109_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g104(.a(new_n115_), .b(new_n114_), .O(new_n149_));
  nand2  g105(.a(x18), .b(x12), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n100_), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  aoi22  g108(.a(x31), .b(new_n91_), .c(new_n103_), .d(new_n152_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n149_), .d(new_n105_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n148_), .c(new_n74_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n143_), .c(new_n47_), .O(new_n156_));
  aoi21  g112(.a(new_n142_), .b(new_n112_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n138_), .c(new_n97_), .O(z9));
endmodule
