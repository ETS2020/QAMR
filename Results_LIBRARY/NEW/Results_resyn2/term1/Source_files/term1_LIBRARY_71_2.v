...
module FAU ( 
  ...
  nand4  g064(.a(x19), .b(new_n76_), .c(x17), .d(x13), .O(new_n109_));
  ...
  nand3  g082(.a(x32), .b(x31), .c(x19), .O(new_n127_));
  ...
  nand3  g090(.a(new_n126_), .b(new_n105_), .c(x19), .O(new_n135_));
  nand2  g091(.a(new_n76_), .b(x13), .O(new_n136_));
