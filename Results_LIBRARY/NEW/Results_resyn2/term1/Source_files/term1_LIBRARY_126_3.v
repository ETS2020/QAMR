// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:31 2020
...
module FAU ( 
  ...
  nor2   g055(.a(x19), .b(new_n99_), .O(new_n100_));
  nand3  g056(.a(x17), .b(x16), .c(x15), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x19), .c(new_n100_), .O(new_n102_));
  ...
  oai21  g062(.a(new_n106_), .b(new_n102_), .c(x18), .O(new_n107_));
  ...
  oai21  g069(.a(x19), .b(x17), .c(x18), .O(new_n114_));
  nand3  g070(.a(x19), .b(x17), .c(x13), .O(new_n115_));
  ...
  nand2  g081(.a(new_n100_), .b(x18), .O(new_n126_));
  inv1   g082(.a(x18), .O(new_n127_));
  nand4  g083(.a(new_n74_), .b(x19), .c(new_n127_), .d(x13), .O(new_n128_));
  ...
  nand2  g100(.a(new_n144_), .b(x13), .O(new_n145_));
  inv1   g101(.a(x31), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n90_), .O(new_n147_));
  nand3  g103(.a(new_n47_), .b(x19), .c(new_n127_), .O(new_n148_));
  ...
  nand4  g108(.a(x19), .b(x17), .c(new_n109_), .d(x11), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n136_), .b(x14), .O(new_n155_));
  ...
  nand4  g116(.a(new_n160_), .b(new_n147_), .c(new_n47_), .d(x18), .O(new_n161_));
  ...
  nand2  g123(.a(new_n164_), .b(x18), .O(new_n168_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n106_), .c(x18), .O(new_n173_));
