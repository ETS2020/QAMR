...
module FAU ( 
  ...
  aoi21  g069(.a(new_n109_), .b(x16), .c(new_n113_), .O(new_n114_));
  inv1   g070(.a(x18), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x17), .c(x16), .d(x13), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n114_), .c(x15), .O(new_n118_));
  ...
  and2   g084(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n124_), .O(new_n130_));
  and2   g086(.a(new_n112_), .b(new_n108_), .O(new_n131_));
  nand2  g087(.a(x17), .b(x13), .O(new_n132_));
  nand2  g088(.a(x16), .b(x15), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n115_), .O(new_n134_));
  nand3  g090(.a(new_n120_), .b(x16), .c(x15), .O(new_n135_));
  inv1   g091(.a(x15), .O(new_n136_));
  oai21  g092(.a(new_n121_), .b(new_n106_), .c(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n134_), .d(new_n131_), .O(new_n138_));
  nand3  g094(.a(new_n126_), .b(new_n105_), .c(x31), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(x32), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n130_), .c(new_n102_), .O(z8));
  nor2   g097(.a(new_n126_), .b(new_n99_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n124_), .O(new_n143_));
  inv1   g099(.a(new_n102_), .O(new_n144_));
  xor2a  g100(.a(new_n125_), .b(x31), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n105_), .c(new_n98_), .d(x33), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n138_), .c(new_n144_), .O(new_n147_));
  aoi21  g103(.a(new_n143_), .b(new_n47_), .c(new_n147_), .O(z9));
endmodule
