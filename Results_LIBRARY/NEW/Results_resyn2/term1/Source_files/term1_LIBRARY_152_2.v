// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:42 2020
...
module FAU ( 
  ...
  aoi21  g068(.a(new_n112_), .b(x17), .c(new_n105_), .O(new_n113_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n90_), .c(x15), .O(new_n135_));
  ...
  nand4  g094(.a(new_n47_), .b(x31), .c(x30), .d(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n114_), .c(new_n137_), .O(new_n140_));
  inv1   g096(.a(new_n124_), .O(new_n141_));
  nand3  g097(.a(new_n127_), .b(new_n95_), .c(x15), .O(new_n142_));
