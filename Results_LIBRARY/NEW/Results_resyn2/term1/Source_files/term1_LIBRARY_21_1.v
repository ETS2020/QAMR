...
module FAU ( 
  ...
  nor2   g058(.a(x18), .b(x13), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x32), .O(new_n104_));
  inv1   g060(.a(x16), .O(new_n105_));
  nand3  g061(.a(x19), .b(x17), .c(x11), .O(new_n106_));
  ...
  nand4  g070(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n113_), .c(new_n107_), .O(new_n117_));
  aoi21  g073(.a(new_n112_), .b(x19), .c(x18), .O(new_n118_));
  oai21  g074(.a(x28), .b(x27), .c(x29), .O(new_n119_));
  xor2a  g075(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  inv1   g076(.a(x17), .O(new_n121_));
  nand2  g077(.a(x19), .b(x12), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nor2   g079(.a(x19), .b(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n122_), .c(new_n96_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n123_), .c(new_n120_), .O(new_n126_));
  nor3   g082(.a(new_n126_), .b(new_n118_), .c(new_n117_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(z0), .O(new_n128_));
  inv1   g084(.a(x14), .O(new_n129_));
  oai21  g085(.a(x19), .b(new_n129_), .c(x18), .O(new_n130_));
  nand2  g086(.a(x19), .b(x13), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n108_), .c(new_n121_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g089(.a(new_n110_), .b(new_n121_), .c(x12), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n105_), .O(new_n135_));
  nand3  g091(.a(x17), .b(new_n105_), .c(x11), .O(new_n136_));
  nor3   g092(.a(new_n136_), .b(new_n109_), .c(new_n108_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x15), .O(new_n138_));
  nor2   g094(.a(new_n121_), .b(new_n105_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n110_), .c(new_n114_), .d(x10), .O(new_n140_));
  nand3  g096(.a(new_n120_), .b(z0), .c(x31), .O(new_n141_));
  aoi21  g097(.a(new_n140_), .b(new_n138_), .c(new_n141_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n128_), .c(new_n74_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n104_), .c(new_n102_), .O(z8));
  nor2   g100(.a(new_n120_), .b(new_n99_), .O(new_n145_));
  nand3  g101(.a(new_n122_), .b(new_n106_), .c(new_n121_), .O(new_n146_));
  nand2  g102(.a(new_n109_), .b(x14), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n112_), .c(x18), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n146_), .c(new_n107_), .O(new_n149_));
  nand2  g105(.a(new_n116_), .b(x33), .O(new_n150_));
  nor3   g106(.a(new_n150_), .b(new_n149_), .c(new_n118_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n145_), .c(x26), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n103_), .c(x33), .O(new_n153_));
  nand2  g109(.a(new_n140_), .b(new_n138_), .O(new_n154_));
  nand3  g110(.a(new_n152_), .b(new_n145_), .c(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n153_), .c(new_n102_), .O(z9));
endmodule
