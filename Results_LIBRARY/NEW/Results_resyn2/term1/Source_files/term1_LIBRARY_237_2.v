...
module FAU ( 
  ...
  oai21  g053(.a(x31), .b(x28), .c(new_n95_), .O(new_n98_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n69_), .c(new_n103_), .O(new_n105_));
  ...
  nand2  g065(.a(new_n69_), .b(new_n109_), .O(new_n110_));
  ...
  aoi21  g072(.a(new_n112_), .b(x17), .c(new_n116_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n103_), .c(new_n105_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g075(.a(x31), .b(x27), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n82_), .c(new_n89_), .O(new_n121_));
  or2    g077(.a(new_n121_), .b(x30), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  aoi21  g079(.a(new_n82_), .b(new_n66_), .c(new_n89_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(x30), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(z0), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n119_), .c(new_n102_), .O(new_n128_));
  ...
  or2    g088(.a(new_n124_), .b(x30), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(new_n129_), .O(new_n134_));
  nand2  g090(.a(new_n110_), .b(x31), .O(new_n135_));
  aoi21  g091(.a(new_n107_), .b(new_n106_), .c(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n115_), .c(new_n105_), .d(new_n102_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n134_), .c(x32), .O(new_n138_));
  nand2  g094(.a(new_n77_), .b(x00), .O(new_n139_));
  aoi21  g095(.a(new_n138_), .b(new_n128_), .c(new_n139_), .O(z8));
  nand2  g096(.a(new_n121_), .b(x30), .O(new_n141_));
  nand2  g097(.a(x29), .b(x27), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n123_), .c(new_n93_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(x33), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n119_), .c(new_n102_), .O(new_n145_));
  nand2  g101(.a(new_n104_), .b(new_n103_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x15), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n101_), .O(new_n148_));
  oai21  g104(.a(new_n129_), .b(new_n123_), .c(new_n143_), .O(new_n149_));
  oai21  g105(.a(new_n130_), .b(new_n109_), .c(new_n69_), .O(new_n150_));
  nor2   g106(.a(x18), .b(x13), .O(new_n151_));
  nand2  g107(.a(x18), .b(x12), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n113_), .c(new_n151_), .O(new_n153_));
  and2   g109(.a(new_n153_), .b(new_n132_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x33), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n145_), .c(new_n139_), .O(z9));
endmodule
