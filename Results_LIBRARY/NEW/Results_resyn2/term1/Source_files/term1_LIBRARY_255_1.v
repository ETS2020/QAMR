// Benchmark "FAU" written by ABC on Tue Jul 28 01:56:24 2020
...
module FAU ( 
  ...
  oai21  g020(.a(x22), .b(x17), .c(x26), .O(new_n65_));
  ...
  nand2  g070(.a(x15), .b(x12), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(x18), .b(x16), .c(x15), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x17), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  inv1   g077(.a(x16), .O(new_n122_));
  nand3  g078(.a(x19), .b(x18), .c(x11), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  inv1   g080(.a(x18), .O(new_n125_));
  nand2  g081(.a(x19), .b(x13), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  inv1   g083(.a(x14), .O(new_n128_));
  nand2  g084(.a(new_n69_), .b(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(new_n124_), .d(x31), .O(new_n130_));
  aoi21  g086(.a(new_n121_), .b(x19), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n85_), .b(x29), .O(new_n132_));
  xor2a  g088(.a(new_n132_), .b(x30), .O(new_n133_));
  inv1   g089(.a(new_n114_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x10), .c(x15), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n131_), .c(x26), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n117_), .c(x32), .O(new_n138_));
  nand3  g094(.a(new_n122_), .b(x15), .c(x11), .O(new_n139_));
  inv1   g095(.a(x15), .O(new_n140_));
  nand3  g096(.a(x16), .b(new_n140_), .c(x10), .O(new_n141_));
  nand2  g097(.a(x19), .b(x18), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n108_), .c(x17), .O(new_n144_));
  aoi21  g100(.a(new_n141_), .b(new_n139_), .c(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n143_), .b(new_n113_), .c(x12), .O(new_n146_));
  nand2  g102(.a(new_n108_), .b(x17), .O(new_n147_));
  nand3  g103(.a(new_n129_), .b(new_n127_), .c(new_n142_), .O(new_n148_));
  or2    g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g105(.a(x16), .b(x15), .O(new_n150_));
  aoi21  g106(.a(new_n149_), .b(new_n146_), .c(new_n150_), .O(new_n151_));
  inv1   g107(.a(x31), .O(new_n152_));
  nor3   g108(.a(new_n133_), .b(x32), .c(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n151_), .b(new_n145_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n138_), .c(new_n112_), .O(z8));
  inv1   g111(.a(new_n132_), .O(new_n156_));
  nand2  g112(.a(x33), .b(new_n152_), .O(new_n157_));
  nand2  g113(.a(new_n148_), .b(x16), .O(new_n158_));
  aoi21  g114(.a(new_n123_), .b(new_n122_), .c(new_n140_), .O(new_n159_));
  and2   g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g116(.a(new_n140_), .b(x10), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n114_), .O(new_n162_));
  inv1   g118(.a(x33), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x31), .c(x30), .d(x17), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n160_), .c(new_n165_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n157_), .c(x26), .O(new_n167_));
  nor2   g123(.a(new_n142_), .b(x33), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n113_), .b(x16), .c(x15), .d(x12), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n104_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n167_), .c(new_n156_), .O(new_n172_));
  aoi21  g128(.a(new_n159_), .b(new_n158_), .c(new_n162_), .O(new_n173_));
  nand2  g129(.a(new_n102_), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n173_), .c(new_n163_), .O(new_n175_));
  aoi21  g131(.a(x33), .b(new_n152_), .c(x26), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  inv1   g133(.a(new_n170_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n168_), .c(new_n102_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  nand3  g136(.a(x18), .b(x16), .c(x10), .O(new_n181_));
  aoi22  g137(.a(x18), .b(x11), .c(x16), .d(x13), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n140_), .c(new_n181_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(x19), .c(new_n119_), .O(new_n184_));
  nor2   g140(.a(x19), .b(new_n128_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n120_), .c(new_n105_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n184_), .c(new_n108_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n116_), .c(new_n163_), .O(new_n188_));
  aoi21  g144(.a(new_n180_), .b(new_n132_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n172_), .c(new_n112_), .O(z9));
endmodule
