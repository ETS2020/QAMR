// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:40 2020
...
module FAU ( 
  ...
  aoi21  g070(.a(new_n111_), .b(x15), .c(new_n114_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x30), .c(z0), .O(new_n116_));
  nand2  g072(.a(new_n82_), .b(x29), .O(new_n117_));
  aoi21  g073(.a(x32), .b(new_n91_), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g075(.a(x32), .b(new_n91_), .O(new_n120_));
  nand2  g076(.a(z0), .b(x30), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n115_), .c(new_n120_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n117_), .O(new_n123_));
  aoi21  g079(.a(new_n108_), .b(new_n107_), .c(new_n99_), .O(new_n124_));
  nand3  g080(.a(new_n112_), .b(x16), .c(x15), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g083(.a(x18), .b(x12), .O(new_n128_));
  oai21  g084(.a(x18), .b(x13), .c(x17), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g086(.a(x15), .O(new_n131_));
  nand2  g087(.a(new_n113_), .b(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n99_), .b(x14), .O(new_n133_));
  nand2  g089(.a(new_n126_), .b(new_n133_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n130_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n127_), .c(x32), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n123_), .c(new_n119_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x31), .O(new_n138_));
  inv1   g094(.a(x31), .O(new_n139_));
  nand3  g095(.a(x32), .b(new_n139_), .c(new_n74_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n138_), .c(new_n97_), .O(z8));
  inv1   g097(.a(new_n115_), .O(new_n142_));
  aoi21  g098(.a(new_n117_), .b(new_n91_), .c(x31), .O(new_n143_));
  nor2   g099(.a(new_n117_), .b(new_n91_), .O(new_n144_));
  aoi21  g100(.a(new_n139_), .b(new_n74_), .c(new_n144_), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n142_), .c(x33), .O(new_n147_));
  nor3   g103(.a(new_n143_), .b(new_n135_), .c(new_n127_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(x26), .O(new_n149_));
  oai21  g105(.a(new_n144_), .b(new_n139_), .c(x33), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(x00), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n147_), .O(z9));
endmodule
