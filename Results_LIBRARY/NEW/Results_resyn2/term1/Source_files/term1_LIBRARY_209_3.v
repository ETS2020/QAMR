...
module FAU ( 
  ...
  nor2   g32(.a(x20), .b(x15), .O(new_n77_));
  aoi21  g33(.a(new_n76_), .b(new_n75_), .c(new_n77_), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(new_n74_), .c(new_n71_), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(new_n70_), .c(new_n67_), .O(new_n80_));
  ...
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(new_n79_), .d(new_n70_), .O(new_n86_));
  ...
  nand4  g46(.a(new_n90_), .b(new_n88_), .c(new_n79_), .d(new_n70_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n94_), .c(new_n79_), .d(new_n70_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(z6));
  xor2a  g53(.a(new_n95_), .b(x31), .O(new_n98_));
  nand2  g54(.a(x20), .b(x19), .O(new_n99_));
  oai21  g55(.a(new_n77_), .b(new_n76_), .c(new_n99_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n74_), .c(new_n71_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n98_), .c(new_n70_), .O(z7));
  nand2  g58(.a(new_n68_), .b(x00), .O(new_n103_));
  inv1   g59(.a(x10), .O(new_n104_));
  aoi21  g60(.a(x15), .b(x14), .c(x19), .O(new_n105_));
  aoi21  g61(.a(x19), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  oai21  g62(.a(x28), .b(x27), .c(x29), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x30), .O(new_n109_));
  nand3  g65(.a(x18), .b(x17), .c(x16), .O(new_n110_));
  aoi21  g66(.a(new_n107_), .b(new_n93_), .c(new_n110_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n109_), .c(new_n106_), .d(x31), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(x32), .O(new_n113_));
  oai21  g69(.a(new_n107_), .b(new_n93_), .c(x31), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand2  g71(.a(x15), .b(x14), .O(new_n116_));
  oai21  g72(.a(new_n75_), .b(new_n104_), .c(new_n116_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n111_), .c(new_n115_), .d(z0), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n113_), .c(new_n103_), .O(z8));
  inv1   g75(.a(new_n110_), .O(new_n120_));
  inv1   g76(.a(x31), .O(new_n121_));
  nand2  g77(.a(new_n107_), .b(new_n93_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n120_), .c(new_n114_), .d(new_n106_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x33), .O(new_n125_));
  aoi21  g81(.a(new_n122_), .b(new_n121_), .c(new_n110_), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n117_), .c(new_n114_), .d(new_n47_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n125_), .c(new_n103_), .O(z9));
endmodule
