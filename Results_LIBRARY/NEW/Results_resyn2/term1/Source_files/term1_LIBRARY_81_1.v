...
module FAU ( 
  ...
  oai21  g051(.a(new_n74_), .b(new_n72_), .c(new_n73_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n71_), .c(new_n68_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n95_), .O(z7));
  inv1   g054(.a(x19), .O(new_n99_));
  nand4  g055(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n99_), .c(new_n72_), .O(new_n101_));
  nand3  g057(.a(x18), .b(x17), .c(x11), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(x19), .c(x16), .O(new_n104_));
  ...
  aoi21  g064(.a(x19), .b(x13), .c(x18), .O(new_n109_));
  inv1   g065(.a(x18), .O(new_n110_));
  aoi21  g066(.a(new_n99_), .b(x14), .c(new_n110_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(x17), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n108_), .c(new_n105_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n104_), .c(x15), .O(new_n114_));
  ...
  nand3  g073(.a(new_n117_), .b(new_n114_), .c(new_n101_), .O(new_n118_));
  inv1   g074(.a(x00), .O(new_n119_));
  nor2   g075(.a(x26), .b(new_n119_), .O(new_n120_));
  ...
  inv1   g079(.a(new_n109_), .O(new_n124_));
  nor2   g080(.a(x19), .b(x14), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(z0), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n124_), .c(new_n108_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n117_), .c(new_n121_), .d(new_n101_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n120_), .O(new_n130_));
  aoi21  g086(.a(new_n118_), .b(z0), .c(new_n130_), .O(z8));
  nand2  g087(.a(x31), .b(x30), .O(new_n132_));
  and2   g088(.a(new_n132_), .b(new_n115_), .O(new_n133_));
  nor2   g089(.a(x31), .b(x30), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n115_), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n114_), .c(new_n101_), .O(new_n137_));
  oai21  g093(.a(new_n103_), .b(x16), .c(x15), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n100_), .O(new_n139_));
  aoi21  g095(.a(x18), .b(x12), .c(x17), .O(new_n140_));
  nor2   g096(.a(x18), .b(x13), .O(new_n141_));
  nor4   g097(.a(new_n141_), .b(new_n140_), .c(new_n125_), .d(new_n47_), .O(new_n142_));
  nor2   g098(.a(new_n133_), .b(new_n123_), .O(new_n143_));
  aoi21  g099(.a(new_n122_), .b(new_n99_), .c(new_n135_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n139_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n120_), .O(new_n146_));
  aoi21  g102(.a(new_n137_), .b(new_n47_), .c(new_n146_), .O(z9));
endmodule
