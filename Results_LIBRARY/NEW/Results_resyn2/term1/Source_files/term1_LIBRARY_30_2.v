...
module FAU ( 
  ...
  nand3  g058(.a(x18), .b(x17), .c(x16), .O(new_n103_));
  ...
  nand3  g071(.a(new_n115_), .b(new_n112_), .c(x15), .O(new_n116_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n101_), .c(z0), .d(x15), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n119_), .c(new_n97_), .O(z8));
  nand2  g086(.a(new_n128_), .b(x15), .O(new_n131_));
  ...
  nand4  g093(.a(new_n47_), .b(x31), .c(x30), .d(x15), .O(new_n138_));
