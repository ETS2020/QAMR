...
module FAU ( 
  ...
  nand3  g54(.a(new_n96_), .b(new_n77_), .c(new_n80_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x23), .O(new_n102_));
  inv1   g56(.a(x24), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x23), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n96_), .c(new_n82_), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  nand2  g60(.a(x18), .b(x04), .O(new_n107_));
  nand2  g61(.a(new_n73_), .b(x12), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n107_), .c(new_n76_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n106_), .O(z13));
  nand2  g64(.a(new_n101_), .b(x24), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n96_), .c(new_n77_), .d(new_n80_), .O(new_n113_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n103_), .c(new_n60_), .d(new_n119_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n91_), .c(new_n113_), .d(x25), .O(new_n123_));
  ...
  nor2   g83(.a(x25), .b(x22), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n77_), .O(new_n131_));
  ...
  aoi21  g88(.a(new_n132_), .b(new_n128_), .c(new_n134_), .O(z16));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nor2   g90(.a(new_n47_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n122_), .c(new_n129_), .d(new_n127_), .O(new_n138_));
