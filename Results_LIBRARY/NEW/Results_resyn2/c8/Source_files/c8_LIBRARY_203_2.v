...
module FAU ( 
  ...
  nand2  g60(.a(new_n101_), .b(new_n106_), .O(new_n107_));
  aoi21  g61(.a(new_n100_), .b(x24), .c(new_n76_), .O(new_n108_));
  oai21  g62(.a(x18), .b(new_n63_), .c(new_n76_), .O(new_n109_));
  aoi21  g63(.a(x18), .b(x05), .c(new_n109_), .O(new_n110_));
  aoi21  g64(.a(new_n108_), .b(new_n107_), .c(new_n110_), .O(z14));
  oai21  g65(.a(new_n100_), .b(x24), .c(x25), .O(new_n112_));
  inv1   g66(.a(x25), .O(new_n113_));
  aoi21  g67(.a(new_n101_), .b(new_n113_), .c(new_n76_), .O(new_n114_));
  oai21  g68(.a(x18), .b(new_n66_), .c(new_n76_), .O(new_n115_));
  aoi21  g69(.a(x18), .b(x06), .c(new_n115_), .O(new_n116_));
  aoi21  g70(.a(new_n114_), .b(new_n112_), .c(new_n116_), .O(z15));
  nor2   g71(.a(x25), .b(x21), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n99_), .c(new_n77_), .d(new_n80_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(x26), .O(new_n120_));
  nor2   g74(.a(x26), .b(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n99_), .c(new_n86_), .d(new_n77_), .O(new_n122_));
  ...
  nand4  g83(.a(new_n129_), .b(new_n121_), .c(new_n99_), .d(new_n86_), .O(new_n130_));
