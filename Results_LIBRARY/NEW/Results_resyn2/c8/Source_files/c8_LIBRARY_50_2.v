// Benchmark "FAU" written by ABC on Mon Jul 27 21:44:51 2020
...
module FAU ( 
  ...
  aoi21  g42(.a(new_n72_), .b(new_n53_), .c(x16), .O(new_n89_));
  ...
  aoi21  g46(.a(new_n72_), .b(new_n56_), .c(x16), .O(new_n93_));
  ...
  nand4  g61(.a(new_n107_), .b(new_n99_), .c(new_n76_), .d(new_n79_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x16), .O(new_n110_));
  aoi21  g64(.a(new_n72_), .b(new_n62_), .c(x16), .O(new_n111_));
  oai21  g65(.a(new_n72_), .b(x05), .c(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n110_), .O(z14));
  nand2  g67(.a(new_n108_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n99_), .c(new_n85_), .d(new_n76_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(x16), .O(new_n118_));
  aoi21  g72(.a(new_n72_), .b(new_n65_), .c(x16), .O(new_n119_));
  oai21  g73(.a(new_n72_), .b(x06), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g79(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n96_), .O(new_n127_));
  nor2   g81(.a(x25), .b(x23), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n107_), .c(new_n76_), .d(new_n79_), .O(new_n129_));
  aoi22  g83(.a(new_n129_), .b(x26), .c(new_n127_), .d(new_n87_), .O(new_n130_));
  aoi21  g84(.a(new_n72_), .b(new_n68_), .c(x16), .O(new_n131_));
  oai21  g85(.a(new_n72_), .b(x07), .c(new_n131_), .O(new_n132_));
  oai21  g86(.a(new_n130_), .b(new_n75_), .c(new_n132_), .O(z16));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  inv1   g88(.a(x17), .O(new_n135_));
  inv1   g89(.a(new_n126_), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n85_), .c(x19), .d(new_n135_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n134_), .c(new_n75_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
