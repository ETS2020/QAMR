...
module FAU ( 
  ...
  nand2  g85(.a(new_n73_), .b(new_n69_), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n76_), .c(x07), .O(new_n133_));
  oai21  g87(.a(new_n131_), .b(new_n129_), .c(new_n133_), .O(z16));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  nor2   g89(.a(new_n47_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n121_), .c(new_n99_), .d(new_n126_), .O(new_n137_));
