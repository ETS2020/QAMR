...
module FAU ( 
  ...
  nor2   g27(.a(x16), .b(x08), .O(new_n74_));
  aoi22  g28(.a(new_n74_), .b(new_n72_), .c(new_n73_), .d(x16), .O(z09));
  inv1   g29(.a(x16), .O(new_n76_));
  inv1   g30(.a(x20), .O(new_n77_));
  nor2   g31(.a(x19), .b(x17), .O(new_n78_));
  xor2a  g32(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nor2   g33(.a(new_n72_), .b(x01), .O(new_n80_));
  oai21  g34(.a(x18), .b(x09), .c(new_n76_), .O(new_n81_));
  oai22  g35(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n76_), .O(z10));
  inv1   g36(.a(x21), .O(new_n83_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n83_), .O(new_n84_));
  inv1   g38(.a(x17), .O(new_n85_));
  nand4  g39(.a(new_n83_), .b(new_n77_), .c(new_n47_), .d(new_n85_), .O(new_n86_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n78_), .c(new_n96_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  nor2   g53(.a(x23), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n97_), .c(new_n78_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x16), .O(new_n103_));
  aoi21  g57(.a(new_n72_), .b(new_n60_), .c(x16), .O(new_n104_));
  ...
  nand4  g62(.a(new_n108_), .b(new_n100_), .c(new_n78_), .d(new_n77_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x16), .O(new_n111_));
  aoi21  g65(.a(new_n72_), .b(new_n63_), .c(x16), .O(new_n112_));
  oai21  g66(.a(new_n72_), .b(x05), .c(new_n112_), .O(new_n113_));
  ...
  aoi21  g74(.a(new_n72_), .b(new_n66_), .c(x16), .O(new_n121_));
  oai21  g75(.a(new_n72_), .b(x06), .c(new_n121_), .O(new_n122_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n100_), .c(new_n97_), .d(new_n78_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n119_), .b(new_n97_), .c(new_n133_), .d(new_n124_), .O(new_n134_));
