// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:50 2020
...
module FAU ( 
  ...
  aoi21  g59(.a(new_n73_), .b(new_n60_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n73_), .b(x04), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n105_), .O(z13));
  nand2  g62(.a(x18), .b(x05), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n63_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  nand2  g65(.a(new_n103_), .b(x24), .O(new_n112_));
  nor2   g66(.a(x24), .b(x21), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n77_), .d(new_n80_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n98_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n89_), .c(new_n114_), .d(x25), .O(new_n123_));
  ...
  nand4  g83(.a(new_n129_), .b(new_n102_), .c(new_n99_), .d(new_n77_), .O(new_n130_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n122_), .c(new_n99_), .d(new_n127_), .O(new_n137_));
