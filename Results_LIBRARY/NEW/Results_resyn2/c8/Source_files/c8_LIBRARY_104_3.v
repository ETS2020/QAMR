...
module FAU ( 
  ...
  nor2   g26(.a(new_n47_), .b(new_n72_), .O(new_n73_));
  ...
  nand3  g31(.a(new_n77_), .b(new_n76_), .c(x08), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n75_), .O(z09));
  inv1   g33(.a(x20), .O(new_n80_));
  xor2a  g34(.a(new_n74_), .b(new_n80_), .O(new_n81_));
  nor2   g35(.a(new_n77_), .b(x01), .O(new_n82_));
  ...
  aoi21  g39(.a(new_n74_), .b(new_n80_), .c(new_n85_), .O(new_n86_));
  nand4  g40(.a(new_n85_), .b(new_n80_), .c(new_n47_), .d(new_n72_), .O(new_n87_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n101_), .c(new_n74_), .d(new_n80_), .O(new_n110_));
  ...
  nand4  g81(.a(new_n127_), .b(new_n101_), .c(new_n98_), .d(new_n74_), .O(new_n128_));
  ...
  nand4  g86(.a(new_n120_), .b(new_n98_), .c(new_n125_), .d(x19), .O(new_n133_));
  oai21  g87(.a(x27), .b(new_n72_), .c(x16), .O(new_n134_));
  aoi21  g88(.a(new_n133_), .b(new_n72_), .c(new_n134_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
