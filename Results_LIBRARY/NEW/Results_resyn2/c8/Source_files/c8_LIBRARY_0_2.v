...
module FAU ( 
  ...
  nor2   g51(.a(x18), .b(new_n60_), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(x04), .c(new_n76_), .O(new_n99_));
  inv1   g53(.a(x22), .O(new_n100_));
  nor2   g54(.a(x21), .b(x20), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n77_), .c(new_n100_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x23), .O(new_n103_));
  nor2   g57(.a(x23), .b(x22), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n101_), .c(new_n77_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x16), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n99_), .O(z13));
  nand2  g62(.a(new_n105_), .b(x24), .O(new_n109_));
  nor2   g63(.a(x24), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n104_), .c(new_n77_), .d(new_n80_), .O(new_n111_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n100_), .O(new_n120_));
  ...
  nand4  g82(.a(new_n128_), .b(new_n104_), .c(new_n101_), .d(new_n77_), .O(new_n129_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n121_), .c(new_n101_), .d(new_n126_), .O(new_n136_));
