...
module FAU ( 
  ...
  nor2   g16(.a(new_n50_), .b(new_n62_), .O(new_n63_));
  ...
  aoi21  g45(.a(new_n72_), .b(x11), .c(x16), .O(new_n92_));
  nor2   g46(.a(x22), .b(new_n75_), .O(new_n93_));
  aoi22  g47(.a(new_n93_), .b(new_n90_), .c(new_n92_), .d(new_n91_), .O(z12));
  xor2a  g48(.a(new_n90_), .b(x23), .O(new_n95_));
  aoi21  g49(.a(new_n72_), .b(new_n59_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n72_), .b(x04), .c(new_n96_), .O(new_n97_));
  oai21  g51(.a(new_n95_), .b(new_n75_), .c(new_n97_), .O(z13));
  inv1   g52(.a(x23), .O(new_n99_));
  nand3  g53(.a(new_n85_), .b(new_n76_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(x24), .O(new_n101_));
  nor2   g55(.a(x24), .b(x23), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n85_), .c(new_n76_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x16), .O(new_n105_));
  aoi21  g59(.a(new_n72_), .b(new_n62_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n72_), .b(x05), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n105_), .O(z14));
  nand2  g62(.a(new_n103_), .b(x25), .O(new_n109_));
  nor2   g63(.a(x25), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n102_), .c(new_n76_), .d(new_n79_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x16), .O(new_n113_));
  aoi21  g67(.a(new_n72_), .b(new_n65_), .c(x16), .O(new_n114_));
  oai21  g68(.a(new_n72_), .b(x06), .c(new_n114_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n113_), .O(z15));
  nand2  g70(.a(new_n111_), .b(x26), .O(new_n117_));
  nor2   g71(.a(x26), .b(x25), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n102_), .c(new_n85_), .d(new_n76_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(x16), .O(new_n121_));
  aoi21  g75(.a(new_n72_), .b(new_n68_), .c(x16), .O(new_n122_));
  oai21  g76(.a(new_n72_), .b(x07), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n121_), .O(z16));
  nand2  g78(.a(x27), .b(x17), .O(new_n125_));
  nor2   g79(.a(new_n47_), .b(x17), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n118_), .c(new_n102_), .d(new_n85_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(new_n125_), .c(new_n75_), .O(z17));
  buf    g82(.a(x27), .O(z08));
endmodule
