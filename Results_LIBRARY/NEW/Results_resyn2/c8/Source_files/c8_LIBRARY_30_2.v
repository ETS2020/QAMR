...
module FAU ( 
  ...
  aoi21  g47(.a(new_n88_), .b(new_n77_), .c(new_n93_), .O(new_n94_));
  nand3  g48(.a(new_n88_), .b(new_n77_), .c(new_n93_), .O(new_n95_));
  ...
  nand2  g53(.a(new_n99_), .b(new_n97_), .O(z12));
  nand2  g54(.a(new_n95_), .b(x23), .O(new_n101_));
  nor2   g55(.a(x23), .b(x22), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n88_), .c(new_n77_), .O(new_n103_));
  ...
  nor3   g63(.a(x24), .b(x19), .c(x17), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n102_), .c(new_n88_), .O(new_n111_));
  ...
  nand2  g71(.a(new_n111_), .b(new_n117_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x21), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n102_), .c(new_n82_), .d(x25), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n118_), .c(x16), .O(new_n121_));
  ...
  nand4  g78(.a(new_n119_), .b(new_n102_), .c(new_n77_), .d(new_n80_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x26), .O(new_n126_));
  nand2  g80(.a(x26), .b(new_n117_), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n110_), .c(new_n102_), .d(new_n88_), .O(new_n128_));
  ...
  nor2   g89(.a(x26), .b(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n102_), .d(new_n88_), .O(new_n137_));
