// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:35 2020
...
module FAU ( 
  ...
  oai21  g22(.a(new_n50_), .b(x15), .c(x26), .O(z07));
  ...
  aoi21  g42(.a(new_n71_), .b(new_n54_), .c(x16), .O(new_n89_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n57_), .c(x16), .O(new_n93_));
  ...
  aoi21  g57(.a(new_n71_), .b(new_n60_), .c(x16), .O(new_n104_));
  ...
  aoi21  g65(.a(new_n71_), .b(new_n63_), .c(x16), .O(new_n112_));
  ...
  aoi21  g74(.a(new_n71_), .b(new_n66_), .c(x16), .O(new_n121_));
  ...
  aoi21  g83(.a(new_n71_), .b(x15), .c(x16), .O(new_n130_));
