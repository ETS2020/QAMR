// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:31 2020
...
module FAU ( 
  ...
  nand3  g69(.a(new_n115_), .b(new_n76_), .c(x13), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n113_), .O(z14));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x25), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n63_), .c(new_n118_), .d(new_n98_), .O(new_n120_));
