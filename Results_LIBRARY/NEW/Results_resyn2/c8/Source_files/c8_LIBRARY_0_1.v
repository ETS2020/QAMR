// Benchmark "FAU" written by ABC on Mon Jul 27 21:44:24 2020
...
module FAU ( 
  ...
  oai21  g51(.a(x18), .b(x12), .c(new_n76_), .O(new_n98_));
  inv1   g52(.a(x22), .O(new_n99_));
  nor2   g53(.a(x21), .b(x20), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n77_), .c(new_n99_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x23), .O(new_n102_));
  nor2   g56(.a(x23), .b(x22), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n100_), .c(new_n77_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n98_), .O(z13));
  nand2  g61(.a(new_n104_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n103_), .c(new_n77_), .d(new_n80_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n116_), .c(new_n60_), .d(new_n99_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n89_), .c(new_n110_), .d(x25), .O(new_n120_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n103_), .c(new_n100_), .d(new_n77_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n119_), .c(new_n100_), .d(new_n124_), .O(new_n134_));
