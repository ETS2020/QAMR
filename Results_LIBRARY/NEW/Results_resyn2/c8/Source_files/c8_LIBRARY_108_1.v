// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:21 2020
...
module FAU ( 
  ...
  nor3   g33(.a(x18), .b(x16), .c(x09), .O(new_n80_));
  oai21  g34(.a(x19), .b(x17), .c(x20), .O(new_n81_));
  aoi21  g35(.a(new_n77_), .b(new_n50_), .c(new_n76_), .O(new_n82_));
  aoi21  g36(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(z10));
  inv1   g37(.a(x21), .O(new_n84_));
  aoi21  g38(.a(new_n77_), .b(new_n50_), .c(new_n84_), .O(new_n85_));
  inv1   g39(.a(x17), .O(new_n86_));
  nand4  g40(.a(new_n84_), .b(new_n50_), .c(new_n47_), .d(new_n86_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n85_), .c(x16), .O(new_n89_));
  aoi21  g43(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n90_));
  oai21  g44(.a(new_n73_), .b(x02), .c(new_n90_), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n89_), .O(z11));
  xor2a  g46(.a(new_n87_), .b(x22), .O(new_n93_));
  aoi21  g47(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n94_));
  oai21  g48(.a(new_n73_), .b(x03), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n93_), .b(new_n76_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nor2   g51(.a(x21), .b(x20), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n77_), .c(new_n97_), .O(new_n99_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n101_), .c(new_n77_), .d(new_n50_), .O(new_n110_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n97_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n88_), .c(new_n110_), .d(x25), .O(new_n121_));
  ...
  nand3  g79(.a(new_n120_), .b(new_n88_), .c(new_n125_), .O(new_n126_));
