...
module FAU ( 
  ...
  aoi21  g52(.a(new_n72_), .b(x12), .c(x16), .O(new_n99_));
  nor2   g53(.a(x23), .b(new_n75_), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n92_), .c(new_n99_), .d(new_n98_), .O(z13));
  nand2  g55(.a(new_n92_), .b(x24), .O(new_n102_));
  nor2   g56(.a(x24), .b(x22), .O(new_n103_));
  ...
  aoi21  g60(.a(new_n72_), .b(new_n62_), .c(x16), .O(new_n107_));
  oai21  g61(.a(new_n72_), .b(x05), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n106_), .O(z14));
  nand2  g63(.a(new_n104_), .b(x25), .O(new_n110_));
  nor2   g64(.a(x25), .b(x21), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n103_), .c(new_n76_), .d(new_n79_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n103_), .c(new_n85_), .d(new_n76_), .O(new_n120_));
  ...
  inv1   g80(.a(x17), .O(new_n127_));
  nand3  g81(.a(new_n59_), .b(x19), .c(new_n127_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n119_), .c(new_n103_), .d(new_n85_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n126_), .c(new_n75_), .O(z17));
  buf    g85(.a(x27), .O(z08));
endmodule
