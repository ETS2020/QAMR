// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:22 2020
...
module FAU ( 
  ...
  nand2  g52(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n76_), .O(new_n100_));
  inv1   g54(.a(x22), .O(new_n101_));
  nor2   g55(.a(x21), .b(x20), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n77_), .c(new_n101_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x23), .O(new_n104_));
  nor2   g58(.a(x23), .b(x22), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n102_), .c(new_n77_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n100_), .O(z13));
  nand2  g63(.a(new_n106_), .b(x24), .O(new_n110_));
  nor2   g64(.a(x24), .b(x21), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n105_), .c(new_n77_), .d(new_n80_), .O(new_n112_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n101_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n89_), .c(new_n112_), .d(x25), .O(new_n123_));
  ...
  nand3  g81(.a(new_n122_), .b(new_n89_), .c(new_n127_), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n105_), .c(new_n102_), .d(new_n77_), .O(new_n130_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n122_), .c(new_n102_), .d(new_n127_), .O(new_n137_));
