...
module FAU ( 
  ...
  nand3  g51(.a(new_n93_), .b(new_n73_), .c(new_n79_), .O(new_n98_));
  xor2a  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  aoi21  g53(.a(new_n75_), .b(new_n60_), .c(x16), .O(new_n100_));
  oai21  g54(.a(new_n75_), .b(x04), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n99_), .b(new_n86_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x23), .O(new_n103_));
  nand3  g57(.a(new_n93_), .b(new_n81_), .c(new_n103_), .O(new_n104_));
  inv1   g58(.a(x24), .O(new_n105_));
  nand2  g59(.a(new_n98_), .b(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g61(.a(x18), .b(new_n63_), .c(new_n86_), .O(new_n108_));
  aoi21  g62(.a(x18), .b(x05), .c(new_n108_), .O(new_n109_));
  aoi21  g63(.a(new_n107_), .b(x16), .c(new_n109_), .O(z14));
  nand2  g64(.a(new_n75_), .b(new_n66_), .O(new_n111_));
  oai21  g65(.a(new_n75_), .b(x06), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x25), .b(new_n86_), .O(new_n113_));
  aoi21  g67(.a(new_n112_), .b(new_n86_), .c(new_n113_), .O(z15));
  nand2  g68(.a(new_n75_), .b(new_n69_), .O(new_n115_));
  oai21  g69(.a(new_n75_), .b(x07), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x26), .b(new_n86_), .O(new_n117_));
  aoi21  g71(.a(new_n116_), .b(new_n86_), .c(new_n117_), .O(z16));
