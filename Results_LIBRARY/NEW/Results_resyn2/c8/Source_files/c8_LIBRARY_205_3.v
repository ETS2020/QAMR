// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:05 2020
...
module FAU ( 
  ...
  aoi21  g09(.a(x27), .b(x10), .c(new_n55_), .O(z02));
  ...
  aoi21  g38(.a(new_n77_), .b(new_n80_), .c(new_n54_), .O(new_n85_));
  inv1   g39(.a(x17), .O(new_n86_));
  nand4  g40(.a(new_n54_), .b(new_n80_), .c(new_n47_), .d(new_n86_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n85_), .c(x16), .O(new_n89_));
  nand3  g43(.a(new_n73_), .b(new_n76_), .c(x10), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n89_), .O(z11));
  xor2a  g45(.a(new_n87_), .b(x22), .O(new_n92_));
  aoi21  g46(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n73_), .b(x03), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n92_), .b(new_n76_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x22), .O(new_n96_));
  nor2   g50(.a(x21), .b(x20), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n77_), .c(new_n96_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x23), .O(new_n99_));
  nor2   g53(.a(x23), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n97_), .c(new_n77_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x16), .O(new_n103_));
  aoi21  g57(.a(new_n73_), .b(new_n60_), .c(x16), .O(new_n104_));
  oai21  g58(.a(new_n73_), .b(x04), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n103_), .O(z13));
  nand2  g60(.a(new_n101_), .b(x24), .O(new_n107_));
  nor2   g61(.a(x24), .b(x21), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n100_), .c(new_n77_), .d(new_n80_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x16), .O(new_n111_));
  aoi21  g65(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n112_));
  oai21  g66(.a(new_n73_), .b(x05), .c(new_n112_), .O(new_n113_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n88_), .c(new_n109_), .d(x25), .O(new_n120_));
  aoi21  g74(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n121_));
  oai21  g75(.a(new_n73_), .b(x06), .c(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n120_), .b(new_n76_), .c(new_n122_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nand3  g78(.a(new_n119_), .b(new_n88_), .c(new_n124_), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n100_), .c(new_n97_), .d(new_n77_), .O(new_n127_));
  aoi21  g81(.a(new_n127_), .b(x26), .c(new_n76_), .O(new_n128_));
  oai21  g82(.a(x18), .b(new_n69_), .c(new_n76_), .O(new_n129_));
  ...
  aoi21  g88(.a(new_n134_), .b(new_n132_), .c(new_n76_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
