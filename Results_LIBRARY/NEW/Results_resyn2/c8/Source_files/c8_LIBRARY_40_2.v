// Benchmark "FAU" written by ABC on Mon Jul 27 21:44:46 2020
...
module FAU ( 
  ...
  nor2   g17(.a(x27), .b(new_n63_), .O(new_n64_));
  aoi21  g18(.a(x27), .b(x13), .c(new_n64_), .O(z05));
  ...
  nand3  g67(.a(x18), .b(new_n76_), .c(x05), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(z14));
  inv1   g69(.a(x23), .O(new_n116_));
  inv1   g70(.a(x25), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n63_), .c(new_n116_), .d(new_n98_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n120_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n119_), .c(new_n99_), .d(new_n124_), .O(new_n134_));
