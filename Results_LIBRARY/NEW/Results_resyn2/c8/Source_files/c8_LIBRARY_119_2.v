// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:27 2020
...
module FAU ( 
  ...
  nor2   g70(.a(x18), .b(new_n66_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(x06), .c(new_n76_), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x24), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n98_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n76_), .c(new_n118_), .O(z15));
  inv1   g79(.a(x26), .O(new_n126_));
  nand3  g80(.a(new_n123_), .b(new_n89_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n123_), .c(new_n99_), .d(new_n126_), .O(new_n136_));
