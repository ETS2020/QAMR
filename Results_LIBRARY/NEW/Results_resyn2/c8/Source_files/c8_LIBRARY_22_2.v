...
module FAU ( 
  ...
  aoi21  g26(.a(new_n72_), .b(x08), .c(x00), .O(new_n73_));
  inv1   g27(.a(x17), .O(new_n74_));
  nor2   g28(.a(x19), .b(new_n74_), .O(new_n75_));
  oai21  g29(.a(new_n47_), .b(x17), .c(x16), .O(new_n76_));
  oai22  g30(.a(new_n76_), .b(new_n75_), .c(new_n73_), .d(x16), .O(z09));
  inv1   g31(.a(x16), .O(new_n78_));
  inv1   g32(.a(x20), .O(new_n79_));
  nor2   g33(.a(x19), .b(x17), .O(new_n80_));
  xor2a  g34(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nor2   g35(.a(new_n72_), .b(x01), .O(new_n82_));
  oai21  g36(.a(x18), .b(x09), .c(new_n78_), .O(new_n83_));
  oai22  g37(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n78_), .O(z10));
  inv1   g38(.a(x21), .O(new_n85_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n85_), .O(new_n86_));
  nand4  g40(.a(new_n85_), .b(new_n79_), .c(new_n47_), .d(new_n74_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  aoi21  g43(.a(new_n72_), .b(new_n54_), .c(x16), .O(new_n90_));
  oai21  g44(.a(new_n72_), .b(x02), .c(new_n90_), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n89_), .O(z11));
  xor2a  g46(.a(new_n87_), .b(x22), .O(new_n93_));
  aoi21  g47(.a(new_n72_), .b(new_n57_), .c(x16), .O(new_n94_));
  oai21  g48(.a(new_n72_), .b(x03), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n93_), .b(new_n78_), .c(new_n95_), .O(z12));
  inv1   g50(.a(x22), .O(new_n97_));
  nor2   g51(.a(x21), .b(x20), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n80_), .c(new_n97_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x23), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n98_), .c(new_n80_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x16), .O(new_n104_));
  aoi21  g58(.a(new_n72_), .b(new_n60_), .c(x16), .O(new_n105_));
  oai21  g59(.a(new_n72_), .b(x04), .c(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(z13));
  nand2  g61(.a(new_n102_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n101_), .c(new_n80_), .d(new_n79_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x16), .O(new_n112_));
  aoi21  g66(.a(new_n72_), .b(new_n63_), .c(x16), .O(new_n113_));
  ...
  aoi21  g75(.a(new_n72_), .b(new_n66_), .c(x16), .O(new_n122_));
  oai21  g76(.a(new_n72_), .b(x06), .c(new_n122_), .O(new_n123_));
  oai21  g77(.a(new_n121_), .b(new_n78_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n120_), .b(new_n88_), .c(new_n125_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n101_), .c(new_n98_), .d(new_n80_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(x26), .c(new_n78_), .O(new_n129_));
  oai21  g83(.a(x18), .b(new_n69_), .c(new_n78_), .O(new_n130_));
  ...
  nand4  g88(.a(new_n120_), .b(new_n98_), .c(new_n134_), .d(new_n125_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n133_), .c(new_n78_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
