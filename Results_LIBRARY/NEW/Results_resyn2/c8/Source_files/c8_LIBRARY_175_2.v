...
module FAU ( 
  ...
  nand2  g33(.a(new_n77_), .b(new_n50_), .O(new_n80_));
  nor2   g34(.a(new_n77_), .b(new_n50_), .O(new_n81_));
  nor2   g35(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  nand2  g36(.a(new_n73_), .b(x09), .O(new_n83_));
  nor2   g37(.a(x16), .b(x01), .O(new_n84_));
  aoi22  g38(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n80_), .O(z10));
  inv1   g39(.a(x17), .O(new_n86_));
  inv1   g40(.a(x21), .O(new_n87_));
  nand4  g41(.a(new_n87_), .b(new_n50_), .c(new_n47_), .d(new_n86_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  aoi21  g43(.a(new_n80_), .b(x21), .c(new_n89_), .O(new_n90_));
  aoi21  g44(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n91_));
  oai21  g45(.a(new_n73_), .b(x02), .c(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n90_), .b(new_n76_), .c(new_n92_), .O(z11));
  ...
  nand4  g64(.a(new_n110_), .b(new_n102_), .c(new_n77_), .d(new_n50_), .O(new_n111_));
