...
module FAU ( 
  ...
  inv1   g43(.a(x02), .O(new_n90_));
  nand2  g44(.a(x18), .b(new_n90_), .O(new_n91_));
  nand2  g45(.a(new_n77_), .b(new_n54_), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(new_n81_), .O(new_n93_));
  oai21  g47(.a(new_n89_), .b(new_n81_), .c(new_n93_), .O(z11));
  inv1   g48(.a(x22), .O(new_n95_));
  nand3  g49(.a(new_n88_), .b(new_n72_), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n88_), .b(new_n72_), .O(new_n97_));
  aoi21  g51(.a(new_n97_), .b(x22), .c(new_n81_), .O(new_n98_));
  and2   g52(.a(x18), .b(x03), .O(new_n99_));
  oai21  g53(.a(x18), .b(new_n57_), .c(new_n81_), .O(new_n100_));
  nor2   g54(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(new_n96_), .c(new_n101_), .O(z12));
  oai21  g56(.a(x19), .b(x17), .c(new_n60_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nand2  g58(.a(x18), .b(x04), .O(new_n105_));
  aoi21  g59(.a(new_n77_), .b(x12), .c(x16), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(x16), .O(z13));
  nand2  g61(.a(new_n77_), .b(new_n63_), .O(new_n108_));
  oai21  g62(.a(new_n77_), .b(x05), .c(new_n108_), .O(new_n109_));
  nor2   g63(.a(x24), .b(new_n81_), .O(new_n110_));
  aoi21  g64(.a(new_n109_), .b(new_n81_), .c(new_n110_), .O(z14));
  nand2  g65(.a(new_n77_), .b(new_n66_), .O(new_n112_));
  oai21  g66(.a(new_n77_), .b(x06), .c(new_n112_), .O(new_n113_));
  nor2   g67(.a(x25), .b(new_n81_), .O(new_n114_));
  aoi21  g68(.a(new_n113_), .b(new_n81_), .c(new_n114_), .O(z15));
  nand2  g69(.a(new_n77_), .b(new_n69_), .O(new_n116_));
  oai21  g70(.a(new_n77_), .b(x07), .c(new_n116_), .O(new_n117_));
  nor2   g71(.a(x26), .b(new_n81_), .O(new_n118_));
  aoi21  g72(.a(new_n117_), .b(new_n81_), .c(new_n118_), .O(z16));
  nand3  g73(.a(x27), .b(x17), .c(x16), .O(new_n120_));
