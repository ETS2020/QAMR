...
module FAU ( 
  ...
  nand3  g84(.a(x18), .b(new_n76_), .c(x07), .O(new_n131_));
  oai21  g85(.a(new_n130_), .b(new_n128_), .c(new_n131_), .O(z16));
  nand2  g86(.a(x27), .b(x17), .O(new_n133_));
  nor2   g87(.a(new_n47_), .b(x17), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n121_), .c(new_n99_), .d(new_n69_), .O(new_n135_));
