// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:13 2020
...
module FAU ( 
  ...
  nor2   g20(.a(x27), .b(new_n66_), .O(new_n67_));
  aoi21  g21(.a(x27), .b(x14), .c(new_n67_), .O(z06));
  ...
  nand2  g62(.a(new_n103_), .b(x24), .O(new_n109_));
  nor2   g63(.a(x24), .b(x21), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n102_), .c(new_n77_), .d(new_n80_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x16), .O(new_n113_));
  aoi21  g67(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n114_));
  oai21  g68(.a(new_n73_), .b(x05), .c(new_n114_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n113_), .O(z14));
  inv1   g70(.a(x23), .O(new_n117_));
  inv1   g71(.a(x24), .O(new_n118_));
  nand4  g72(.a(new_n66_), .b(new_n118_), .c(new_n117_), .d(new_n98_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n121_));
  nand3  g75(.a(new_n73_), .b(new_n76_), .c(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n76_), .c(new_n122_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nand3  g78(.a(new_n120_), .b(new_n89_), .c(new_n124_), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n102_), .c(new_n99_), .d(new_n77_), .O(new_n127_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n120_), .c(new_n99_), .d(new_n124_), .O(new_n134_));
