// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:54 2020
...
module FAU ( 
  ...
  nor2   g30(.a(new_n75_), .b(x16), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(x00), .O(new_n78_));
  nand3  g32(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(z09));
  inv1   g33(.a(x16), .O(new_n80_));
  xor2a  g34(.a(new_n73_), .b(new_n50_), .O(new_n81_));
  aoi22  g35(.a(new_n77_), .b(x01), .c(new_n75_), .d(x09), .O(new_n82_));
  oai21  g36(.a(new_n81_), .b(new_n80_), .c(new_n82_), .O(z10));
  aoi21  g37(.a(new_n73_), .b(new_n50_), .c(new_n53_), .O(new_n84_));
  nand4  g38(.a(new_n53_), .b(new_n50_), .c(new_n47_), .d(new_n71_), .O(new_n85_));
  inv1   g39(.a(new_n85_), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n84_), .c(x16), .O(new_n87_));
  aoi22  g41(.a(new_n77_), .b(x02), .c(new_n75_), .d(x10), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n87_), .O(z11));
  xor2a  g43(.a(new_n85_), .b(x22), .O(new_n90_));
  aoi22  g44(.a(new_n77_), .b(x03), .c(new_n75_), .d(x11), .O(new_n91_));
  oai21  g45(.a(new_n90_), .b(new_n80_), .c(new_n91_), .O(z12));
  nor2   g46(.a(x21), .b(x20), .O(new_n93_));
  nand3  g47(.a(new_n93_), .b(new_n73_), .c(new_n56_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(x23), .O(new_n95_));
  nor2   g49(.a(x23), .b(x22), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n93_), .c(new_n73_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x16), .O(new_n99_));
  aoi22  g53(.a(new_n77_), .b(x04), .c(new_n75_), .d(x12), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n99_), .O(z13));
  nand2  g55(.a(new_n97_), .b(x24), .O(new_n102_));
  nor2   g56(.a(x24), .b(x21), .O(new_n103_));
  nand4  g57(.a(new_n103_), .b(new_n96_), .c(new_n73_), .d(new_n50_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x16), .O(new_n106_));
  aoi22  g60(.a(new_n77_), .b(x05), .c(new_n75_), .d(x13), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n106_), .O(z14));
  nand4  g62(.a(new_n65_), .b(new_n62_), .c(new_n59_), .d(new_n56_), .O(new_n109_));
  inv1   g63(.a(new_n109_), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n86_), .c(new_n104_), .d(x25), .O(new_n111_));
  aoi22  g65(.a(new_n77_), .b(x06), .c(new_n75_), .d(x14), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n80_), .c(new_n112_), .O(z15));
  nor2   g67(.a(x25), .b(x24), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n96_), .c(new_n93_), .d(new_n73_), .O(new_n115_));
  nor2   g69(.a(new_n115_), .b(new_n68_), .O(new_n116_));
  nand2  g70(.a(new_n115_), .b(new_n68_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(x16), .O(new_n118_));
  aoi22  g72(.a(new_n77_), .b(x07), .c(new_n75_), .d(x15), .O(new_n119_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(new_n119_), .O(z16));
  nand4  g74(.a(new_n110_), .b(new_n93_), .c(new_n68_), .d(x19), .O(new_n121_));
  oai21  g75(.a(x27), .b(new_n71_), .c(x16), .O(new_n122_));
  aoi21  g76(.a(new_n121_), .b(new_n71_), .c(new_n122_), .O(z17));
  buf    g77(.a(x27), .O(z08));
endmodule
