...
module FAU ( 
  ...
  nand3  g53(.a(new_n99_), .b(new_n86_), .c(new_n77_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n93_), .b(x23), .c(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n73_), .b(new_n60_), .c(x16), .O(new_n103_));
  oai21  g57(.a(new_n73_), .b(x04), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n102_), .b(new_n76_), .c(new_n104_), .O(z13));
  nand2  g59(.a(new_n100_), .b(x24), .O(new_n106_));
  nor2   g60(.a(x24), .b(x21), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n99_), .c(new_n77_), .d(new_n80_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x16), .O(new_n110_));
  aoi21  g64(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n111_));
  oai21  g65(.a(new_n73_), .b(x05), .c(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n110_), .O(z14));
  nand2  g67(.a(new_n108_), .b(x25), .O(new_n114_));
  nor2   g68(.a(x25), .b(x24), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n99_), .c(new_n86_), .d(new_n77_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(x16), .O(new_n118_));
  aoi21  g72(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n119_));
  oai21  g73(.a(new_n73_), .b(x06), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n118_), .O(z15));
  nand2  g75(.a(new_n116_), .b(x26), .O(new_n122_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n101_), .c(x16), .O(new_n124_));
  aoi21  g78(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n125_));
  oai21  g79(.a(new_n73_), .b(x07), .c(new_n125_), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n124_), .c(new_n122_), .O(z16));
  nand2  g81(.a(x27), .b(x17), .O(new_n128_));
  nor2   g82(.a(new_n47_), .b(x17), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n123_), .c(new_n99_), .d(new_n86_), .O(new_n130_));
