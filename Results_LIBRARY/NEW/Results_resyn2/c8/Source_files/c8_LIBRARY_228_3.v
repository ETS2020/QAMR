...
module FAU ( 
  ...
  nand3  g59(.a(new_n73_), .b(new_n76_), .c(x12), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n105_), .O(z13));
  nand2  g61(.a(new_n103_), .b(x24), .O(new_n108_));
  nor2   g62(.a(x24), .b(x21), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n102_), .c(new_n77_), .d(new_n80_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n116_), .c(new_n60_), .d(new_n98_), .O(new_n118_));
