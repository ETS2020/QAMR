...
module FAU ( 
  ...
  nand2  g52(.a(new_n93_), .b(x23), .O(new_n99_));
  nor2   g53(.a(x23), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n86_), .c(new_n77_), .O(new_n101_));
  ...
  nand2  g68(.a(new_n109_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n86_), .d(new_n77_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(x16), .O(new_n119_));
  aoi21  g73(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n120_));
  oai21  g74(.a(new_n73_), .b(x06), .c(new_n120_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n119_), .O(z15));
  inv1   g76(.a(new_n117_), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(x26), .c(x16), .O(new_n124_));
  ...
  nand4  g83(.a(new_n129_), .b(new_n116_), .c(new_n100_), .d(new_n86_), .O(new_n130_));
