// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:53 2020
...
module FAU ( 
  ...
  xor2a  g33(.a(new_n77_), .b(new_n50_), .O(new_n80_));
  nand3  g34(.a(new_n73_), .b(new_n76_), .c(x09), .O(new_n81_));
  oai21  g35(.a(new_n80_), .b(new_n76_), .c(new_n81_), .O(z10));
  inv1   g36(.a(x21), .O(new_n83_));
  aoi21  g37(.a(new_n77_), .b(new_n50_), .c(new_n83_), .O(new_n84_));
  inv1   g38(.a(x17), .O(new_n85_));
  nand4  g39(.a(new_n83_), .b(new_n50_), .c(new_n47_), .d(new_n85_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(new_n84_), .c(x16), .O(new_n88_));
  aoi21  g42(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n89_));
  oai21  g43(.a(new_n73_), .b(x02), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g62(.a(new_n108_), .b(new_n100_), .c(new_n77_), .d(new_n50_), .O(new_n109_));
