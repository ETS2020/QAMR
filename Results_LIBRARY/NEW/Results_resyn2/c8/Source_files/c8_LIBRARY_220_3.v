...
module FAU ( 
  ...
  nand4  g50(.a(new_n96_), .b(new_n87_), .c(new_n80_), .d(new_n47_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi22  g52(.a(new_n98_), .b(new_n89_), .c(new_n90_), .d(x22), .O(new_n99_));
  aoi21  g53(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n100_));
  oai21  g54(.a(new_n73_), .b(x03), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n99_), .b(new_n76_), .c(new_n101_), .O(z12));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n82_), .c(new_n97_), .d(x23), .O(new_n104_));
  aoi21  g58(.a(new_n73_), .b(new_n60_), .c(x16), .O(new_n105_));
  oai21  g59(.a(new_n73_), .b(x04), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n104_), .b(new_n76_), .c(new_n106_), .O(z13));
  inv1   g61(.a(x24), .O(new_n108_));
  aoi21  g62(.a(new_n103_), .b(new_n82_), .c(new_n108_), .O(new_n109_));
  nor2   g63(.a(x20), .b(x19), .O(new_n110_));
  nor2   g64(.a(x22), .b(x21), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n89_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n109_), .c(x16), .O(new_n115_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n108_), .c(new_n119_), .d(new_n96_), .O(new_n121_));
