...
module FAU ( 
  ...
  nand2  g70(.a(new_n116_), .b(x22), .O(new_n117_));
  nor3   g71(.a(x25), .b(x24), .c(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n117_), .c(new_n86_), .d(new_n77_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  ...
  nor2   g79(.a(x23), .b(x21), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n77_), .d(new_n80_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x23), .c(x22), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n125_), .c(new_n86_), .d(new_n77_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  aoi21  g86(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n133_));
  oai21  g87(.a(new_n73_), .b(x07), .c(new_n133_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n132_), .O(z16));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  nor2   g90(.a(new_n47_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n129_), .c(new_n125_), .d(new_n86_), .O(new_n138_));
