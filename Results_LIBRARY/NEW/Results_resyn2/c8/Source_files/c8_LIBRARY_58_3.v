...
module FAU ( 
  ...
  nand3  g48(.a(new_n94_), .b(new_n77_), .c(new_n57_), .O(new_n95_));
  aoi21  g49(.a(new_n88_), .b(x22), .c(new_n76_), .O(new_n96_));
  nand2  g50(.a(x18), .b(x03), .O(new_n97_));
  nor2   g51(.a(x16), .b(x11), .O(new_n98_));
  aoi22  g52(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(z12));
  nand2  g53(.a(new_n95_), .b(x23), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n94_), .c(new_n77_), .O(new_n102_));
  ...
  nand4  g81(.a(new_n127_), .b(new_n101_), .c(new_n94_), .d(new_n77_), .O(new_n128_));
  ...
  nand4  g88(.a(new_n134_), .b(new_n120_), .c(new_n94_), .d(new_n125_), .O(new_n135_));
