// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:09 2020
...
module FAU ( 
  ...
  oai21  g70(.a(new_n73_), .b(x06), .c(new_n76_), .O(new_n117_));
  inv1   g71(.a(x23), .O(new_n118_));
  inv1   g72(.a(x24), .O(new_n119_));
  nand4  g73(.a(new_n66_), .b(new_n119_), .c(new_n118_), .d(new_n98_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n76_), .c(new_n117_), .O(z15));
  inv1   g77(.a(x26), .O(new_n124_));
  nand3  g78(.a(new_n121_), .b(new_n89_), .c(new_n124_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n121_), .c(new_n99_), .d(new_n124_), .O(new_n134_));
