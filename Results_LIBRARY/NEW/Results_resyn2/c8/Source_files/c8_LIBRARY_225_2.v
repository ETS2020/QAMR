...
module FAU ( 
  ...
  aoi21  g80(.a(new_n121_), .b(new_n69_), .c(new_n76_), .O(new_n127_));
  inv1   g81(.a(x07), .O(new_n128_));
  nand2  g82(.a(new_n76_), .b(new_n128_), .O(new_n129_));
  aoi21  g83(.a(new_n73_), .b(x15), .c(new_n129_), .O(new_n130_));
  aoi21  g84(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z16));
  nand2  g85(.a(x27), .b(x17), .O(new_n132_));
  inv1   g86(.a(new_n120_), .O(new_n133_));
  nor2   g87(.a(new_n47_), .b(x17), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n99_), .d(new_n69_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n132_), .c(new_n76_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
