// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:17 2020
...
module FAU ( 
  ...
  nor2   g34(.a(new_n77_), .b(new_n80_), .O(new_n81_));
  nor3   g35(.a(x20), .b(x19), .c(x17), .O(new_n82_));
  oai21  g36(.a(new_n82_), .b(new_n81_), .c(x16), .O(new_n83_));
  aoi21  g37(.a(new_n73_), .b(new_n51_), .c(x16), .O(new_n84_));
  oai21  g38(.a(new_n73_), .b(x01), .c(new_n84_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n83_), .O(z10));
  inv1   g40(.a(x21), .O(new_n87_));
  nor2   g41(.a(new_n82_), .b(new_n87_), .O(new_n88_));
  inv1   g42(.a(x17), .O(new_n89_));
  nand4  g43(.a(new_n87_), .b(new_n80_), .c(new_n47_), .d(new_n89_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n88_), .c(x16), .O(new_n92_));
  aoi21  g46(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n73_), .b(x02), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n92_), .O(z11));
  nor2   g49(.a(x22), .b(x21), .O(new_n96_));
  aoi22  g50(.a(new_n96_), .b(new_n82_), .c(new_n90_), .d(x22), .O(new_n97_));
  aoi21  g51(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n98_));
  oai21  g52(.a(new_n73_), .b(x03), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n97_), .b(new_n76_), .c(new_n99_), .O(z12));
  inv1   g54(.a(x23), .O(new_n101_));
  nand3  g55(.a(new_n96_), .b(new_n82_), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n96_), .b(new_n82_), .O(new_n103_));
  aoi21  g57(.a(new_n103_), .b(x23), .c(new_n76_), .O(new_n104_));
  oai21  g58(.a(x18), .b(new_n60_), .c(new_n76_), .O(new_n105_));
  aoi21  g59(.a(x18), .b(x04), .c(new_n105_), .O(new_n106_));
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(new_n106_), .O(z13));
  nor2   g61(.a(x21), .b(x20), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n77_), .c(new_n101_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x24), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n96_), .c(new_n77_), .d(new_n80_), .O(new_n112_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n119_), .c(new_n101_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n91_), .c(new_n112_), .d(x25), .O(new_n123_));
  aoi21  g77(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n124_));
  oai21  g78(.a(new_n73_), .b(x06), .c(new_n124_), .O(new_n125_));
  oai21  g79(.a(new_n123_), .b(new_n76_), .c(new_n125_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nand3  g81(.a(new_n122_), .b(new_n91_), .c(new_n127_), .O(new_n128_));
  nor2   g82(.a(x25), .b(x22), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n111_), .c(new_n108_), .d(new_n77_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(x26), .c(new_n76_), .O(new_n131_));
  oai21  g85(.a(x18), .b(new_n69_), .c(new_n76_), .O(new_n132_));
  aoi21  g86(.a(x18), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(new_n133_), .O(z16));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  nor2   g89(.a(new_n47_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n122_), .c(new_n108_), .d(new_n127_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n135_), .c(new_n76_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
