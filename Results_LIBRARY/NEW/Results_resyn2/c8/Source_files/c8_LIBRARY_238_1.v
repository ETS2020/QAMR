...
module FAU ( 
  ...
  and2   g16(.a(x27), .b(x13), .O(new_n63_));
  aoi21  g17(.a(new_n50_), .b(x24), .c(new_n63_), .O(z05));
  inv1   g18(.a(x14), .O(new_n65_));
  nor2   g19(.a(new_n50_), .b(new_n65_), .O(new_n66_));
  aoi21  g20(.a(new_n50_), .b(x25), .c(new_n66_), .O(z06));
  inv1   g21(.a(x15), .O(new_n68_));
  nor2   g22(.a(new_n50_), .b(new_n68_), .O(new_n69_));
  aoi21  g23(.a(new_n50_), .b(x26), .c(new_n69_), .O(z07));
  ...
  aoi21  g40(.a(new_n72_), .b(new_n54_), .c(x16), .O(new_n87_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n76_), .c(new_n90_), .O(new_n91_));
  nand3  g45(.a(new_n85_), .b(new_n76_), .c(new_n90_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  aoi21  g48(.a(new_n72_), .b(new_n57_), .c(x16), .O(new_n95_));
  oai21  g49(.a(new_n72_), .b(x03), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n94_), .O(z12));
  nand2  g51(.a(new_n92_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n85_), .c(new_n76_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(x16), .O(new_n102_));
  aoi21  g56(.a(new_n72_), .b(new_n60_), .c(x16), .O(new_n103_));
  oai21  g57(.a(new_n72_), .b(x04), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n102_), .O(z13));
  nand2  g59(.a(x18), .b(x05), .O(new_n106_));
  aoi21  g60(.a(new_n72_), .b(x13), .c(x16), .O(new_n107_));
  nor2   g61(.a(x24), .b(new_n75_), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n100_), .c(new_n107_), .d(new_n106_), .O(z14));
  nand2  g63(.a(new_n100_), .b(x25), .O(new_n110_));
  nor2   g64(.a(x25), .b(x21), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n99_), .c(new_n76_), .d(new_n79_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x16), .O(new_n114_));
  aoi21  g68(.a(new_n72_), .b(new_n65_), .c(x16), .O(new_n115_));
  oai21  g69(.a(new_n72_), .b(x06), .c(new_n115_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n114_), .O(z15));
  nand2  g71(.a(new_n112_), .b(x26), .O(new_n118_));
  nor2   g72(.a(x26), .b(x25), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n99_), .c(new_n85_), .d(new_n76_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(x16), .O(new_n122_));
  aoi21  g76(.a(new_n72_), .b(new_n68_), .c(x16), .O(new_n123_));
  oai21  g77(.a(new_n72_), .b(x07), .c(new_n123_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n122_), .O(z16));
  nand2  g79(.a(x27), .b(x17), .O(new_n126_));
  nor2   g80(.a(new_n47_), .b(x17), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n119_), .c(new_n99_), .d(new_n85_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n126_), .c(new_n75_), .O(z17));
  buf    g83(.a(x27), .O(z08));
endmodule
