...
module FAU ( 
  ...
  nand3  g77(.a(new_n123_), .b(new_n76_), .c(x14), .O(new_n124_));
  oai21  g78(.a(new_n121_), .b(new_n76_), .c(new_n124_), .O(z15));
  inv1   g79(.a(x26), .O(new_n126_));
  nand3  g80(.a(new_n120_), .b(new_n89_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n120_), .c(new_n99_), .d(new_n126_), .O(new_n136_));
