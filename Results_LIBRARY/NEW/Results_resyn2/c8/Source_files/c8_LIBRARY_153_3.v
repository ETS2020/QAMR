// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:45 2020
...
module FAU ( 
  ...
  nand2  g40(.a(new_n77_), .b(new_n80_), .O(new_n87_));
  nor2   g41(.a(x21), .b(x20), .O(new_n88_));
  aoi22  g42(.a(new_n88_), .b(new_n77_), .c(new_n87_), .d(x21), .O(new_n89_));
  aoi21  g43(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n90_));
  oai21  g44(.a(new_n73_), .b(x02), .c(new_n90_), .O(new_n91_));
  oai21  g45(.a(new_n89_), .b(new_n76_), .c(new_n91_), .O(z11));
  nand2  g46(.a(new_n88_), .b(new_n77_), .O(new_n93_));
  nor2   g47(.a(x22), .b(x21), .O(new_n94_));
  aoi22  g48(.a(new_n94_), .b(new_n82_), .c(new_n93_), .d(x22), .O(new_n95_));
  aoi21  g49(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n73_), .b(x03), .c(new_n96_), .O(new_n97_));
  oai21  g51(.a(new_n95_), .b(new_n76_), .c(new_n97_), .O(z12));
  inv1   g52(.a(x23), .O(new_n99_));
  aoi21  g53(.a(new_n94_), .b(new_n82_), .c(new_n99_), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n88_), .c(new_n77_), .O(new_n102_));
  ...
  nand2  g63(.a(new_n109_), .b(x23), .O(new_n110_));
  nor3   g64(.a(x24), .b(x22), .c(x21), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n110_), .c(new_n82_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  ...
  aoi21  g71(.a(new_n111_), .b(new_n82_), .c(new_n109_), .O(new_n118_));
  nor2   g72(.a(x25), .b(x24), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n101_), .c(new_n88_), .d(new_n77_), .O(new_n120_));
  ...
  nand2  g78(.a(new_n124_), .b(new_n122_), .O(z15));
  inv1   g79(.a(x26), .O(new_n126_));
  nand2  g80(.a(new_n121_), .b(new_n126_), .O(new_n127_));
  aoi21  g81(.a(new_n120_), .b(x26), .c(new_n76_), .O(new_n128_));
  oai21  g82(.a(x18), .b(new_n69_), .c(new_n76_), .O(new_n129_));
  aoi21  g83(.a(x18), .b(x07), .c(new_n129_), .O(new_n130_));
  aoi21  g84(.a(new_n128_), .b(new_n127_), .c(new_n130_), .O(z16));
  nand2  g85(.a(x27), .b(x17), .O(new_n132_));
  nand2  g86(.a(new_n119_), .b(new_n101_), .O(new_n133_));
  inv1   g87(.a(new_n133_), .O(new_n134_));
  nor2   g88(.a(new_n47_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n88_), .d(new_n126_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n132_), .c(new_n76_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
