...
module FAU ( 
  ...
  aoi21  g85(.a(new_n129_), .b(new_n96_), .c(new_n127_), .O(new_n130_));
  inv1   g86(.a(x18), .O(new_n131_));
  nand4  g87(.a(new_n127_), .b(x25), .c(x22), .d(x21), .O(new_n132_));
  nand4  g88(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n130_), .c(new_n103_), .O(new_n135_));
