...
module FAU ( 
  ...
  oai21  g70(.a(new_n97_), .b(new_n114_), .c(x24), .O(new_n115_));
  ...
  nand4  g76(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  nor2   g78(.a(x10), .b(new_n52_), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n120_), .c(new_n123_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n69_), .O(z14));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n118_), .c(new_n116_), .d(x24), .O(new_n127_));
  nand4  g83(.a(new_n46_), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(new_n117_), .O(new_n129_));
  aoi21  g85(.a(new_n127_), .b(x25), .c(new_n129_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n79_), .c(new_n71_), .O(z15));
  ...
  oai21  g94(.a(new_n138_), .b(new_n79_), .c(new_n73_), .O(z16));
endmodule
