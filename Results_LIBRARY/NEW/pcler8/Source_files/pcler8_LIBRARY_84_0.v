...
module FAU ( 
  ...
  nand2  g58(.a(x23), .b(new_n102_), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(x21), .c(x20), .d(x19), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n97_), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g63(.a(x22), .b(x20), .c(x19), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n107_), .c(new_n104_), .O(new_n110_));
  nor2   g66(.a(x10), .b(new_n50_), .O(new_n111_));
  oai21  g67(.a(new_n110_), .b(new_n106_), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g72(.a(new_n116_), .b(new_n114_), .c(x23), .d(x22), .O(new_n117_));
  nand2  g73(.a(x23), .b(x22), .O(new_n118_));
  nor3   g74(.a(new_n115_), .b(new_n118_), .c(x24), .O(new_n119_));
  aoi21  g75(.a(new_n117_), .b(x24), .c(new_n119_), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n78_), .c(new_n67_), .O(z14));
  nand2  g77(.a(x26), .b(x17), .O(new_n122_));
  nand3  g78(.a(x24), .b(x23), .c(x22), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n116_), .O(new_n125_));
  inv1   g81(.a(x25), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(x24), .c(x23), .d(x22), .O(new_n127_));
  inv1   g83(.a(new_n127_), .O(new_n128_));
  aoi22  g84(.a(new_n128_), .b(new_n116_), .c(new_n125_), .d(x25), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n78_), .c(new_n69_), .O(z15));
  ...
  oai21  g93(.a(new_n137_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
