...
module FAU ( 
  ...
  xnor2a g40(.a(new_n84_), .b(x21), .O(new_n85_));
  nand3  g41(.a(x22), .b(x21), .c(x13), .O(new_n86_));
  nor2   g42(.a(new_n86_), .b(new_n72_), .O(new_n87_));
  aoi21  g43(.a(new_n85_), .b(new_n56_), .c(new_n87_), .O(new_n88_));
  nand2  g44(.a(new_n76_), .b(x09), .O(new_n89_));
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n56_), .d(new_n60_), .O(z11));
  ...
  nor3   g63(.a(new_n84_), .b(new_n107_), .c(x23), .O(new_n108_));
  ...
  inv1   g88(.a(new_n84_), .O(new_n133_));
