...
module FAU ( 
  ...
  xnor2a g45(.a(new_n89_), .b(x21), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n88_), .c(new_n77_), .O(new_n91_));
  oai21  g47(.a(new_n59_), .b(new_n61_), .c(new_n91_), .O(z11));
  and2   g48(.a(x20), .b(x19), .O(new_n93_));
  nand2  g49(.a(x23), .b(x14), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n80_), .c(new_n93_), .O(new_n95_));
  ...
  nor3   g70(.a(new_n89_), .b(new_n87_), .c(x24), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n114_), .c(new_n77_), .O(new_n116_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n112_), .c(x26), .O(new_n127_));
