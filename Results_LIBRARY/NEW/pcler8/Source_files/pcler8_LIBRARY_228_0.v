...
module FAU ( 
  ...
  nand2  g59(.a(x19), .b(new_n57_), .O(new_n104_));
  inv1   g60(.a(x23), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x21), .c(x20), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g64(.a(x22), .b(x20), .c(x19), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  nand2  g66(.a(x23), .b(new_n57_), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(new_n108_), .c(new_n111_), .O(new_n112_));
  aoi21  g68(.a(new_n107_), .b(x22), .c(new_n112_), .O(new_n113_));
  nand2  g69(.a(new_n77_), .b(x09), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n113_), .c(new_n65_), .O(z13));
  ...
  oai21  g78(.a(new_n122_), .b(new_n78_), .c(new_n67_), .O(z14));
  ...
  oai21  g87(.a(new_n131_), .b(new_n78_), .c(new_n69_), .O(z15));
  ...
  oai21  g95(.a(new_n139_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
