// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:26 2020
...
module FAU ( 
  ...
  oai21  g38(.a(new_n82_), .b(new_n73_), .c(x19), .O(new_n83_));
  ...
  oai22  g49(.a(new_n93_), .b(new_n78_), .c(new_n57_), .d(new_n61_), .O(z11));
  ...
  aoi22  g56(.a(new_n100_), .b(new_n89_), .c(new_n98_), .d(x22), .O(new_n101_));
  ...
  nand3  g61(.a(new_n89_), .b(new_n74_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(x10), .O(new_n107_));
  nand2  g63(.a(x23), .b(x15), .O(new_n108_));
  nor2   g64(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n107_), .c(new_n51_), .O(new_n110_));
  ...
  oai22  g74(.a(new_n118_), .b(new_n78_), .c(new_n57_), .d(new_n67_), .O(z14));
  ...
  oai22  g83(.a(new_n127_), .b(new_n78_), .c(new_n57_), .d(new_n69_), .O(z15));
  nor2   g84(.a(new_n52_), .b(x18), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n49_), .c(new_n45_), .O(new_n130_));
  inv1   g86(.a(x26), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(x25), .c(x24), .d(x23), .O(new_n132_));
  nor2   g88(.a(new_n132_), .b(new_n103_), .O(new_n133_));
