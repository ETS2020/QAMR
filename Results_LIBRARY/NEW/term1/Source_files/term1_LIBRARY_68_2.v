...
module FAU ( 
  ...
  nor2   g078(.a(new_n116_), .b(new_n114_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x17), .c(new_n122_), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(new_n112_), .O(new_n125_));
  nand2  g081(.a(new_n123_), .b(x17), .O(new_n126_));
  ...
  oai21  g090(.a(new_n128_), .b(new_n125_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n123_), .b(x17), .c(x15), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n122_), .O(new_n137_));
  nand3  g093(.a(new_n123_), .b(x17), .c(x10), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n112_), .O(new_n139_));
  nand2  g095(.a(new_n123_), .b(x12), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n113_), .O(new_n141_));
  nor2   g097(.a(new_n122_), .b(new_n112_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n123_), .c(x17), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n141_), .c(new_n139_), .d(new_n137_), .O(new_n144_));
  nand2  g100(.a(new_n108_), .b(x27), .O(new_n145_));
  ...
  aoi21  g104(.a(new_n98_), .b(new_n91_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(x19), .b(x13), .c(x18), .O(new_n150_));
  aoi21  g106(.a(new_n108_), .b(x28), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n147_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n144_), .c(x32), .O(new_n153_));
  ...
  oai21  g113(.a(new_n128_), .b(new_n125_), .c(new_n157_), .O(new_n158_));
  ...
  nand4  g127(.a(new_n171_), .b(new_n169_), .c(new_n168_), .d(new_n166_), .O(new_n172_));
  nand2  g128(.a(new_n116_), .b(x14), .O(new_n173_));
  nor2   g129(.a(new_n114_), .b(new_n113_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n142_), .O(new_n175_));
  aoi21  g131(.a(new_n174_), .b(x15), .c(x19), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(x10), .c(x15), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n175_), .c(new_n137_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n172_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n157_), .O(new_n181_));
  aoi21  g137(.a(new_n165_), .b(new_n162_), .c(new_n181_), .O(new_n182_));
