...
module FAU ( 
  ...
  nand3  g084(.a(z0), .b(x31), .c(x16), .O(new_n129_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n121_), .O(new_n134_));
  nand2  g090(.a(new_n115_), .b(x14), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x18), .c(x17), .d(x15), .O(new_n136_));
  oai21  g092(.a(new_n133_), .b(new_n121_), .c(new_n115_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n134_), .O(new_n138_));
  nand2  g094(.a(new_n108_), .b(x27), .O(new_n139_));
  oai21  g095(.a(x30), .b(x27), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n93_), .O(new_n141_));
  aoi21  g097(.a(x18), .b(x12), .c(x17), .O(new_n142_));
  oai21  g098(.a(x30), .b(x29), .c(x31), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  oai21  g100(.a(x18), .b(x13), .c(x16), .O(new_n145_));
  aoi21  g101(.a(new_n108_), .b(x28), .c(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n144_), .c(new_n141_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n138_), .c(x32), .O(new_n148_));
  ...
  nand3  g109(.a(new_n106_), .b(new_n98_), .c(x16), .O(new_n154_));
  nand2  g110(.a(x33), .b(x31), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n153_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n127_), .O(new_n157_));
  inv1   g113(.a(new_n127_), .O(new_n158_));
  nand3  g114(.a(x31), .b(x30), .c(x16), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n124_), .c(new_n152_), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n106_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  inv1   g119(.a(new_n138_), .O(new_n164_));
  xor2a  g120(.a(x31), .b(x30), .O(new_n165_));
  nor3   g121(.a(new_n165_), .b(new_n145_), .c(new_n142_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n164_), .c(new_n152_), .O(new_n167_));
  aoi21  g123(.a(new_n163_), .b(new_n158_), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n157_), .c(new_n150_), .O(z9));
endmodule
