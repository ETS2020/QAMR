...
module FAU ( 
  ...
  oai21  g042(.a(x23), .b(x18), .c(new_n86_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n83_), .c(new_n81_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n93_), .b(new_n91_), .c(new_n78_), .d(new_n77_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nor2   g052(.a(new_n92_), .b(x26), .O(new_n97_));
  ...
  nor2   g057(.a(new_n101_), .b(new_n78_), .O(new_n102_));
  xor2a  g058(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g059(.a(new_n97_), .b(new_n58_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n103_), .c(new_n90_), .O(z5));
  oai21  g061(.a(x20), .b(x15), .c(x18), .O(new_n106_));
  inv1   g062(.a(new_n80_), .O(new_n107_));
  nand3  g063(.a(new_n86_), .b(new_n83_), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g068(.a(new_n108_), .b(new_n106_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n102_), .b(new_n89_), .c(new_n109_), .d(x29), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(new_n104_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n111_), .b(new_n116_), .c(x30), .O(new_n117_));
  nor2   g073(.a(new_n109_), .b(new_n100_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n102_), .c(new_n116_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n104_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n117_), .c(new_n89_), .O(z7));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n124_), .c(new_n84_), .O(new_n127_));
  nand4  g083(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n128_));
  ...
  nand3  g091(.a(x16), .b(new_n122_), .c(x10), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n101_), .b(new_n78_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n109_), .c(x29), .O(new_n139_));
  nand2  g095(.a(new_n138_), .b(x29), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x30), .O(new_n141_));
  nand2  g097(.a(z0), .b(x31), .O(new_n142_));
  aoi21  g098(.a(new_n141_), .b(new_n139_), .c(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n137_), .b(new_n135_), .c(new_n143_), .O(new_n144_));
  nor2   g100(.a(new_n131_), .b(new_n122_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n133_), .O(new_n146_));
  nor2   g102(.a(new_n125_), .b(new_n123_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x17), .c(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n131_), .O(new_n149_));
  nand2  g105(.a(new_n147_), .b(x12), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n84_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n146_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n132_), .c(new_n122_), .O(new_n154_));
  nand2  g110(.a(new_n118_), .b(x27), .O(new_n155_));
  oai21  g111(.a(x30), .b(x27), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n101_), .O(new_n157_));
  oai21  g113(.a(x19), .b(x14), .c(x31), .O(new_n158_));
  aoi21  g114(.a(new_n109_), .b(new_n100_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(x19), .b(x13), .c(x18), .O(new_n160_));
  aoi21  g116(.a(new_n118_), .b(x28), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n152_), .c(x32), .O(new_n163_));
  nand2  g119(.a(new_n77_), .b(x00), .O(new_n164_));
  aoi21  g120(.a(new_n163_), .b(new_n144_), .c(new_n164_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  oai21  g122(.a(new_n137_), .b(new_n135_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n116_), .b(new_n109_), .O(new_n168_));
  oai22  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n116_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n140_), .O(new_n170_));
  inv1   g126(.a(new_n140_), .O(new_n171_));
  nand2  g127(.a(x31), .b(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n116_), .O(new_n173_));
  oai21  g129(.a(new_n172_), .b(new_n167_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(x18), .b(x12), .c(x17), .O(new_n175_));
  nand2  g131(.a(new_n116_), .b(x30), .O(new_n176_));
  nand2  g132(.a(x31), .b(new_n109_), .O(new_n177_));
  inv1   g133(.a(x13), .O(new_n178_));
  nand2  g134(.a(new_n123_), .b(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .O(new_n180_));
  nand2  g136(.a(new_n125_), .b(x14), .O(new_n181_));
  nor2   g137(.a(new_n123_), .b(new_n84_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n181_), .c(new_n145_), .O(new_n183_));
  nand2  g139(.a(new_n182_), .b(new_n145_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n125_), .O(new_n185_));
  inv1   g141(.a(new_n182_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n153_), .c(new_n122_), .O(new_n187_));
  nand2  g143(.a(new_n182_), .b(x11), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n131_), .O(new_n189_));
