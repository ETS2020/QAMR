...
module FAU ( 
  ...
  nand2  g101(.a(new_n112_), .b(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x31), .O(new_n147_));
  aoi21  g103(.a(new_n94_), .b(new_n101_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(x19), .b(x13), .c(x18), .O(new_n149_));
  aoi21  g105(.a(new_n102_), .b(x28), .c(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n144_), .d(new_n141_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n139_), .c(x32), .O(new_n152_));
  nand2  g108(.a(new_n79_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n131_), .c(new_n153_), .O(z8));
  inv1   g110(.a(x33), .O(new_n155_));
  oai21  g111(.a(new_n124_), .b(new_n122_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n105_), .b(new_n94_), .O(new_n157_));
  ...
  nand2  g117(.a(x33), .b(new_n105_), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n156_), .c(new_n162_), .O(new_n163_));
  aoi21  g119(.a(x19), .b(x12), .c(x17), .O(new_n164_));
  nand2  g120(.a(new_n105_), .b(x30), .O(new_n165_));
  nand2  g121(.a(x31), .b(new_n94_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n146_), .c(new_n165_), .O(new_n167_));
  nand2  g123(.a(new_n110_), .b(x13), .O(new_n168_));
  nor2   g124(.a(new_n112_), .b(new_n109_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n132_), .c(new_n168_), .O(new_n170_));
  nand2  g126(.a(new_n169_), .b(new_n132_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n110_), .O(new_n172_));
  ...
  nor3   g133(.a(new_n177_), .b(new_n167_), .c(new_n164_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n155_), .O(new_n179_));
  aoi21  g135(.a(new_n163_), .b(new_n160_), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n159_), .c(new_n153_), .O(z9));
endmodule
