...
module FAU ( 
  ...
  nor2   g013(.a(new_n57_), .b(x02), .O(new_n58_));
  nor4   g014(.a(new_n58_), .b(new_n56_), .c(x03), .d(x01), .O(new_n59_));
  ...
  nor2   g018(.a(new_n47_), .b(x01), .O(new_n63_));
  nor2   g019(.a(x05), .b(x03), .O(new_n64_));
  oai21  g020(.a(new_n64_), .b(new_n63_), .c(new_n58_), .O(new_n65_));
  ...
  nand3  g024(.a(new_n61_), .b(x06), .c(x05), .O(new_n69_));
  oai21  g025(.a(new_n56_), .b(x03), .c(x02), .O(new_n70_));
  nand2  g026(.a(new_n57_), .b(new_n56_), .O(new_n71_));
  ...
  aoi22  g031(.a(new_n75_), .b(x01), .c(new_n74_), .d(new_n57_), .O(new_n76_));
  oai21  g032(.a(new_n73_), .b(x01), .c(new_n76_), .O(new_n77_));
