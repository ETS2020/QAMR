...
module FAU ( 
  ...
  nand2  g052(.a(new_n89_), .b(new_n58_), .O(new_n97_));
  ...
  or2    g059(.a(new_n79_), .b(new_n78_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n77_), .c(new_n103_), .O(new_n105_));
  nand2  g061(.a(new_n101_), .b(new_n80_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n97_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand3  g064(.a(new_n101_), .b(new_n108_), .c(x30), .O(new_n109_));
  nor2   g065(.a(new_n99_), .b(new_n92_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n95_), .c(new_n108_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n97_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n109_), .c(new_n82_), .O(z7));
  ...
  nand2  g086(.a(new_n94_), .b(new_n93_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n99_), .c(x29), .O(new_n132_));
  ...
  aoi21  g107(.a(new_n99_), .b(new_n92_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g117(.a(new_n108_), .b(new_n99_), .O(new_n162_));
  ...
  nand2  g126(.a(x31), .b(new_n99_), .O(new_n171_));
