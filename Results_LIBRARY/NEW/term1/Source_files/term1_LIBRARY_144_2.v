// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:29 2020
...
module FAU ( 
  ...
  oai21  g035(.a(x23), .b(x18), .c(x22), .O(new_n80_));
  ...
  nand4  g068(.a(z0), .b(x31), .c(new_n101_), .d(x19), .O(new_n113_));
  nand2  g069(.a(new_n94_), .b(new_n84_), .O(new_n114_));
  nand4  g070(.a(x18), .b(x16), .c(x15), .d(x12), .O(new_n115_));
  ...
  nand4  g078(.a(z0), .b(x31), .c(x30), .d(x19), .O(new_n123_));
  oai22  g079(.a(new_n123_), .b(new_n115_), .c(z0), .d(x30), .O(new_n124_));
  nand3  g080(.a(x16), .b(x15), .c(x12), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand3  g082(.a(x31), .b(x19), .c(x18), .O(new_n127_));
  ...
  and2   g090(.a(x19), .b(x18), .O(new_n135_));
  ...
  nand4  g097(.a(new_n141_), .b(x31), .c(x30), .d(x19), .O(new_n142_));
  ...
  nand4  g101(.a(new_n141_), .b(new_n108_), .c(new_n101_), .d(x19), .O(new_n146_));
