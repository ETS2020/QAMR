// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:26 2020
...
module FAU ( 
  ...
  nor2   g078(.a(new_n114_), .b(x16), .O(new_n123_));
  nor2   g079(.a(x26), .b(new_n117_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(x18), .d(x11), .O(new_n125_));
  ...
  oai21  g091(.a(new_n129_), .b(new_n126_), .c(new_n135_), .O(new_n136_));
  nor2   g092(.a(new_n117_), .b(new_n115_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x17), .c(x15), .O(new_n138_));
  oai21  g094(.a(x19), .b(x14), .c(new_n138_), .O(new_n139_));
  ...
  nand2  g114(.a(new_n108_), .b(x28), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n156_), .d(new_n152_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n149_), .c(new_n141_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n140_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n136_), .c(new_n112_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand3  g121(.a(new_n123_), .b(x15), .c(x11), .O(new_n166_));
  nand4  g122(.a(new_n137_), .b(new_n165_), .c(new_n106_), .d(new_n98_), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n141_), .O(new_n169_));
  oai21  g125(.a(new_n121_), .b(new_n119_), .c(x15), .O(new_n170_));
  inv1   g126(.a(new_n127_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n113_), .c(x10), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n165_), .O(new_n174_));
  nand3  g130(.a(new_n106_), .b(new_n98_), .c(x16), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(new_n169_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n132_), .O(new_n177_));
  inv1   g133(.a(new_n132_), .O(new_n178_));
  nand4  g134(.a(new_n137_), .b(new_n165_), .c(x31), .d(x30), .O(new_n179_));
  oai22  g135(.a(new_n179_), .b(new_n166_), .c(new_n165_), .d(x31), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n141_), .O(new_n181_));
  nand3  g137(.a(x31), .b(x30), .c(x16), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n173_), .c(new_n165_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  inv1   g141(.a(new_n145_), .O(new_n186_));
  nand2  g142(.a(new_n117_), .b(x14), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g144(.a(new_n106_), .b(x30), .O(new_n189_));
  nand2  g145(.a(x31), .b(new_n98_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n158_), .c(new_n154_), .d(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n149_), .c(new_n141_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n188_), .c(new_n165_), .O(new_n193_));
  aoi21  g149(.a(new_n185_), .b(new_n178_), .c(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n177_), .c(new_n112_), .O(z9));
endmodule
