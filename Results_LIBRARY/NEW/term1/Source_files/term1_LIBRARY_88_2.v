...
module FAU ( 
  ...
  oai21  g073(.a(new_n81_), .b(new_n117_), .c(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n88_), .c(new_n85_), .d(new_n79_), .O(new_n119_));
  ...
  nor2   g102(.a(new_n86_), .b(new_n83_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n148_), .b(new_n127_), .O(new_n151_));
  ...
  nand2  g116(.a(new_n86_), .b(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x31), .O(new_n162_));
  aoi21  g118(.a(new_n109_), .b(new_n101_), .c(new_n162_), .O(new_n163_));
  ...
  aoi21  g125(.a(new_n167_), .b(new_n145_), .c(new_n169_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  oai21  g127(.a(new_n138_), .b(new_n136_), .c(new_n171_), .O(new_n172_));
  nand2  g128(.a(new_n120_), .b(new_n109_), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(new_n172_), .c(new_n171_), .d(new_n120_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n141_), .O(new_n175_));
  inv1   g131(.a(new_n141_), .O(new_n176_));
  nand2  g132(.a(x31), .b(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n120_), .O(new_n178_));
  ...
  nand2  g137(.a(x31), .b(new_n109_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n181_), .c(new_n161_), .d(new_n180_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n156_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n171_), .O(new_n185_));
  aoi21  g141(.a(new_n179_), .b(new_n176_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n175_), .c(new_n169_), .O(z9));
endmodule
