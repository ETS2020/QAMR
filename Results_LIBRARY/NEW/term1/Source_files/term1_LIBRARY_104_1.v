// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:16 2020
...
module FAU ( 
  ...
  nand2  g079(.a(new_n78_), .b(x17), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(new_n121_), .c(new_n124_), .O(new_n125_));
  nor2   g081(.a(new_n122_), .b(new_n120_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n82_), .c(x12), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n125_), .c(x16), .O(new_n129_));
  inv1   g085(.a(x16), .O(new_n130_));
  nor2   g086(.a(x26), .b(new_n122_), .O(new_n131_));
  nor2   g087(.a(new_n120_), .b(new_n82_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(x11), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n129_), .c(new_n119_), .O(new_n134_));
  nand3  g090(.a(new_n131_), .b(new_n119_), .c(x10), .O(new_n135_));
  nor4   g091(.a(new_n135_), .b(new_n120_), .c(new_n82_), .d(new_n130_), .O(new_n136_));
  ...
  nor2   g099(.a(new_n130_), .b(new_n119_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n126_), .c(x17), .O(new_n145_));
  nand3  g101(.a(new_n126_), .b(x16), .c(x10), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n119_), .O(new_n147_));
  inv1   g103(.a(x11), .O(new_n148_));
  inv1   g104(.a(new_n126_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n130_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(new_n145_), .O(new_n151_));
  ...
  nand2  g116(.a(x15), .b(x12), .O(new_n161_));
  nand2  g117(.a(new_n126_), .b(x16), .O(new_n162_));
  ...
  aoi21  g121(.a(new_n165_), .b(new_n143_), .c(new_n118_), .O(z8));
  aoi21  g122(.a(new_n123_), .b(new_n121_), .c(new_n130_), .O(new_n167_));
  nand4  g123(.a(x19), .b(x18), .c(new_n130_), .d(x11), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(x15), .O(new_n170_));
  nand4  g126(.a(new_n126_), .b(x16), .c(new_n119_), .d(x10), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(x33), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n111_), .c(new_n101_), .d(x17), .O(new_n173_));
  nand2  g129(.a(x33), .b(x31), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n173_), .c(x26), .O(new_n175_));
  nand4  g131(.a(new_n82_), .b(x16), .c(x15), .d(x12), .O(new_n176_));
  inv1   g132(.a(x33), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n111_), .c(new_n101_), .O(new_n178_));
  nor3   g134(.a(new_n178_), .b(new_n176_), .c(new_n149_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n175_), .c(new_n139_), .O(new_n180_));
  inv1   g136(.a(new_n139_), .O(new_n181_));
  nand3  g137(.a(x31), .b(x30), .c(x17), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nor2   g139(.a(new_n177_), .b(x31), .O(new_n184_));
  aoi21  g140(.a(new_n183_), .b(new_n172_), .c(new_n184_), .O(new_n185_));
  inv1   g141(.a(new_n176_), .O(new_n186_));
  nor3   g142(.a(x33), .b(new_n111_), .c(new_n101_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n186_), .c(new_n126_), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(x26), .c(new_n188_), .O(new_n189_));
  nand2  g145(.a(new_n111_), .b(x30), .O(new_n190_));
  oai21  g146(.a(new_n120_), .b(new_n148_), .c(new_n130_), .O(new_n191_));
  nand2  g147(.a(x31), .b(new_n101_), .O(new_n192_));
  inv1   g148(.a(x13), .O(new_n193_));
  nand2  g149(.a(new_n120_), .b(new_n193_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n192_), .c(new_n191_), .d(new_n190_), .O(new_n195_));
  inv1   g151(.a(x10), .O(new_n196_));
  nand2  g152(.a(x18), .b(x16), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n196_), .c(new_n119_), .O(new_n198_));
  nand2  g154(.a(new_n122_), .b(x14), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n144_), .c(new_n132_), .O(new_n200_));
  oai21  g156(.a(new_n197_), .b(new_n119_), .c(new_n122_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n200_), .c(new_n198_), .O(new_n202_));
  oai21  g158(.a(new_n202_), .b(new_n195_), .c(new_n78_), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n163_), .c(new_n177_), .O(new_n204_));
  aoi21  g160(.a(new_n189_), .b(new_n181_), .c(new_n204_), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n180_), .c(new_n118_), .O(z9));
endmodule
