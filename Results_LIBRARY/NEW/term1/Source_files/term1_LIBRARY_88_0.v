// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:10 2020
...
module FAU ( 
  ...
  nor2   g043(.a(new_n87_), .b(new_n80_), .O(new_n88_));
  and2   g044(.a(new_n88_), .b(new_n79_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand2  g046(.a(x25), .b(x01), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nor2   g048(.a(x27), .b(x26), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n90_), .d(new_n58_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nor2   g052(.a(new_n91_), .b(x26), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n90_), .d(new_n58_), .O(new_n98_));
  ...
  xor2a  g059(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  nand2  g060(.a(new_n97_), .b(new_n58_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n104_), .c(new_n89_), .O(z5));
  inv1   g062(.a(new_n105_), .O(new_n107_));
  inv1   g063(.a(x30), .O(new_n108_));
  nand2  g064(.a(new_n103_), .b(x29), .O(new_n109_));
  ...
  nand3  g068(.a(new_n112_), .b(new_n107_), .c(new_n90_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(z6));
  inv1   g070(.a(new_n77_), .O(new_n115_));
  inv1   g071(.a(x19), .O(new_n116_));
  oai21  g072(.a(x21), .b(x16), .c(x24), .O(new_n117_));
  oai21  g073(.a(x24), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n86_), .c(new_n83_), .d(new_n115_), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nand3  g076(.a(new_n110_), .b(new_n120_), .c(x30), .O(new_n121_));
  nor2   g077(.a(new_n108_), .b(new_n100_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n103_), .c(new_n120_), .O(new_n123_));
  ...
  nand3  g083(.a(new_n116_), .b(x18), .c(x14), .O(new_n128_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n132_), .c(new_n126_), .O(new_n137_));
  nand3  g093(.a(x16), .b(new_n126_), .c(x10), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g095(.a(new_n102_), .b(new_n101_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n108_), .c(x29), .O(new_n141_));
  ...
  nor2   g102(.a(new_n133_), .b(new_n126_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n135_), .O(new_n148_));
  nor2   g104(.a(new_n116_), .b(new_n84_), .O(new_n149_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n134_), .c(new_n126_), .O(new_n156_));
  ...
  aoi21  g116(.a(new_n108_), .b(new_n100_), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(x19), .b(x13), .c(x18), .O(new_n162_));
  aoi21  g118(.a(new_n122_), .b(x28), .c(new_n162_), .O(new_n163_));
  ...
  aoi21  g123(.a(new_n165_), .b(new_n146_), .c(new_n167_), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  oai21  g125(.a(new_n139_), .b(new_n137_), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n120_), .b(new_n108_), .O(new_n171_));
  oai22  g127(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n120_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n142_), .O(new_n173_));
  inv1   g129(.a(new_n142_), .O(new_n174_));
  nand2  g130(.a(x31), .b(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n120_), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(new_n170_), .c(new_n176_), .O(new_n177_));
  aoi21  g133(.a(x18), .b(x12), .c(x17), .O(new_n178_));
  nand2  g134(.a(new_n120_), .b(x30), .O(new_n179_));
  nand2  g135(.a(x31), .b(new_n108_), .O(new_n180_));
  inv1   g136(.a(x13), .O(new_n181_));
  nand2  g137(.a(new_n84_), .b(new_n181_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n180_), .c(new_n179_), .O(new_n183_));
  nand2  g139(.a(new_n116_), .b(x14), .O(new_n184_));
  nor2   g140(.a(new_n84_), .b(new_n81_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n184_), .c(new_n147_), .O(new_n186_));
  nand2  g142(.a(new_n185_), .b(new_n147_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n116_), .O(new_n188_));
  inv1   g144(.a(new_n185_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n155_), .c(new_n126_), .O(new_n190_));
  nand2  g146(.a(new_n185_), .b(x11), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n133_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n190_), .c(new_n188_), .d(new_n186_), .O(new_n193_));
  nor3   g149(.a(new_n193_), .b(new_n183_), .c(new_n178_), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n169_), .O(new_n195_));
  aoi21  g151(.a(new_n177_), .b(new_n174_), .c(new_n195_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n173_), .c(new_n167_), .O(z9));
endmodule
