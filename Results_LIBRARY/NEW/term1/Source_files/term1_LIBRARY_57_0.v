...
module FAU ( 
  ...
  nand2  g067(.a(new_n108_), .b(x28), .O(new_n112_));
  inv1   g068(.a(x18), .O(new_n113_));
  nand2  g069(.a(x19), .b(x13), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g071(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(new_n112_), .O(new_n117_));
  ...
  oai22  g083(.a(new_n127_), .b(new_n126_), .c(x19), .d(x14), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n108_), .b(x27), .O(new_n130_));
  oai21  g086(.a(x30), .b(x27), .c(new_n130_), .O(new_n131_));
  inv1   g087(.a(new_n126_), .O(new_n132_));
  and2   g088(.a(x16), .b(x10), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(x15), .O(new_n134_));
  aoi21  g090(.a(new_n131_), .b(new_n93_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  nor3   g092(.a(new_n136_), .b(new_n125_), .c(new_n117_), .O(new_n137_));
  inv1   g093(.a(x26), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x00), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n137_), .O(z8));
  aoi21  g096(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  inv1   g098(.a(x33), .O(new_n143_));
  inv1   g099(.a(x15), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n113_), .c(x13), .O(new_n145_));
  inv1   g101(.a(x19), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x18), .c(x14), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n145_), .c(new_n123_), .O(new_n148_));
  ...
  nand3  g107(.a(new_n132_), .b(new_n118_), .c(x11), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n151_), .c(new_n144_), .O(new_n153_));
  nand2  g109(.a(new_n133_), .b(new_n144_), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n126_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n143_), .O(new_n156_));
  nand2  g112(.a(new_n106_), .b(new_n98_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n156_), .c(new_n143_), .d(new_n106_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n142_), .O(new_n159_));
  nand2  g115(.a(x31), .b(x30), .O(new_n160_));
  nand2  g116(.a(x33), .b(new_n106_), .O(new_n161_));
  oai21  g117(.a(new_n160_), .b(new_n156_), .c(new_n161_), .O(new_n162_));
  xnor2a g118(.a(x31), .b(x30), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n124_), .c(new_n121_), .d(new_n115_), .O(new_n164_));
  nor3   g120(.a(new_n164_), .b(new_n134_), .c(new_n128_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n143_), .O(new_n166_));
  aoi21  g122(.a(new_n162_), .b(new_n141_), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n159_), .c(new_n139_), .O(z9));
endmodule
