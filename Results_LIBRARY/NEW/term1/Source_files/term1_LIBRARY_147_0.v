...
module FAU ( 
  ...
  nand3  g054(.a(new_n98_), .b(x29), .c(x28), .O(new_n99_));
  inv1   g055(.a(x28), .O(new_n100_));
  oai21  g056(.a(new_n91_), .b(new_n100_), .c(x30), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n99_), .c(x27), .O(new_n102_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(x30), .d(x29), .O(new_n107_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n107_), .c(new_n95_), .d(new_n81_), .O(z7));
  ...
  nand2  g084(.a(x30), .b(new_n91_), .O(new_n129_));
  inv1   g085(.a(x27), .O(new_n130_));
  aoi22  g086(.a(new_n98_), .b(x29), .c(new_n100_), .d(new_n130_), .O(new_n131_));
  nand2  g087(.a(z0), .b(x31), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(new_n129_), .c(new_n132_), .O(new_n133_));
  oai21  g089(.a(new_n128_), .b(new_n126_), .c(new_n133_), .O(new_n134_));
  oai21  g090(.a(x28), .b(x27), .c(new_n108_), .O(new_n135_));
  ...
  oai21  g095(.a(new_n136_), .b(new_n139_), .c(new_n113_), .O(new_n140_));
  nor2   g096(.a(new_n122_), .b(new_n112_), .O(new_n141_));
  ...
  aoi21  g105(.a(new_n116_), .b(new_n149_), .c(new_n105_), .O(new_n150_));
  ...
  nand2  g111(.a(new_n100_), .b(new_n130_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n108_), .c(x31), .O(new_n157_));
  nand3  g113(.a(new_n105_), .b(new_n98_), .c(new_n91_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(x33), .O(new_n159_));
  oai21  g115(.a(new_n128_), .b(new_n126_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(x31), .b(new_n91_), .O(new_n161_));
  aoi22  g117(.a(new_n105_), .b(x30), .c(new_n114_), .d(new_n146_), .O(new_n162_));
  oai21  g118(.a(new_n114_), .b(new_n139_), .c(new_n113_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n131_), .O(new_n164_));
  nand2  g120(.a(new_n116_), .b(x14), .O(new_n165_));
  nor2   g121(.a(new_n114_), .b(new_n113_), .O(new_n166_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n144_), .c(new_n112_), .O(new_n171_));
  nand2  g127(.a(new_n166_), .b(x11), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n122_), .O(new_n173_));
