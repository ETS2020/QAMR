...
module FAU ( 
  ...
  nand3  g095(.a(new_n137_), .b(x17), .c(x10), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n113_), .O(new_n141_));
  nand2  g097(.a(new_n137_), .b(x12), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n114_), .O(new_n143_));
  nor2   g099(.a(new_n123_), .b(new_n113_), .O(new_n144_));
  ...
  nor2   g106(.a(x30), .b(x29), .O(new_n151_));
  nor2   g107(.a(x19), .b(x14), .O(new_n152_));
  nor4   g108(.a(new_n152_), .b(new_n151_), .c(new_n108_), .d(new_n150_), .O(new_n153_));
  ...
  nand2  g118(.a(new_n108_), .b(new_n98_), .O(new_n163_));
  ...
  oai22  g126(.a(new_n108_), .b(x30), .c(x18), .d(x13), .O(new_n171_));
  nor4   g127(.a(new_n171_), .b(new_n170_), .c(new_n106_), .d(new_n150_), .O(new_n172_));
  nand2  g128(.a(new_n117_), .b(x14), .O(new_n173_));
  nor2   g129(.a(new_n115_), .b(new_n114_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n144_), .O(new_n175_));
  ...
  nand3  g134(.a(new_n178_), .b(new_n175_), .c(new_n139_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n172_), .c(new_n161_), .O(new_n181_));
  aoi21  g137(.a(new_n169_), .b(new_n166_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n165_), .c(new_n159_), .O(z9));
endmodule
