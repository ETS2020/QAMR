...
module FAU ( 
  ...
  nand4  g076(.a(x19), .b(x18), .c(new_n114_), .d(x12), .O(new_n121_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n123_), .c(new_n113_), .O(new_n128_));
  ...
  nor2   g093(.a(new_n115_), .b(new_n114_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x16), .c(x15), .O(new_n139_));
  oai21  g095(.a(x18), .b(x13), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x19), .O(new_n141_));
  nand3  g097(.a(x19), .b(x17), .c(x11), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n124_), .O(new_n143_));
  nand4  g099(.a(x19), .b(x17), .c(x16), .d(x15), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n115_), .O(new_n145_));
  nand4  g101(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n146_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n148_), .c(new_n118_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n141_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n137_), .c(new_n112_), .O(z8));
  inv1   g119(.a(x33), .O(new_n164_));
  nand4  g120(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n165_));
  nor2   g121(.a(x19), .b(new_n115_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n106_), .d(new_n98_), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(new_n165_), .c(new_n164_), .d(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n118_), .O(new_n169_));
  nand3  g125(.a(x18), .b(new_n114_), .c(x12), .O(new_n170_));
  nand3  g126(.a(new_n115_), .b(x17), .c(x13), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(new_n124_), .O(new_n172_));
  nand4  g128(.a(x18), .b(x17), .c(new_n124_), .d(x11), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n172_), .c(x15), .O(new_n175_));
  inv1   g131(.a(new_n129_), .O(new_n176_));
  nand2  g132(.a(new_n138_), .b(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n164_), .O(new_n179_));
  nand3  g135(.a(new_n106_), .b(new_n98_), .c(x19), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n169_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n133_), .O(new_n182_));
  inv1   g138(.a(new_n133_), .O(new_n183_));
  nand4  g139(.a(new_n166_), .b(new_n164_), .c(x31), .d(x30), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n165_), .c(new_n164_), .d(x31), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n118_), .O(new_n186_));
  nand3  g142(.a(x31), .b(x30), .c(x19), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n178_), .c(new_n164_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  nand2  g146(.a(new_n115_), .b(x13), .O(new_n191_));
  inv1   g147(.a(new_n144_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand2  g149(.a(new_n106_), .b(x30), .O(new_n194_));
  nand2  g150(.a(x31), .b(new_n98_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n157_), .c(new_n153_), .d(new_n194_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n148_), .c(new_n118_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n193_), .c(new_n164_), .O(new_n198_));
  aoi21  g154(.a(new_n190_), .b(new_n183_), .c(new_n198_), .O(new_n199_));
  aoi21  g155(.a(new_n199_), .b(new_n182_), .c(new_n112_), .O(z9));
endmodule
