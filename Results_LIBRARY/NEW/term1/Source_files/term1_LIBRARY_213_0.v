...
module FAU ( 
  ...
  nand2  g091(.a(new_n108_), .b(x28), .O(new_n136_));
  aoi21  g092(.a(x19), .b(x13), .c(x18), .O(new_n137_));
  oai21  g093(.a(x30), .b(x29), .c(x31), .O(new_n138_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n143_), .c(new_n113_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n139_), .d(new_n136_), .O(new_n145_));
  nand2  g101(.a(x16), .b(x15), .O(new_n146_));
  oai22  g102(.a(new_n146_), .b(new_n123_), .c(x19), .d(x14), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n108_), .b(x27), .O(new_n149_));
  oai21  g105(.a(x30), .b(x27), .c(new_n149_), .O(new_n150_));
  nor2   g106(.a(new_n122_), .b(new_n127_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n124_), .c(x15), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(new_n93_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n145_), .c(x32), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n135_), .c(x26), .O(z8));
  ...
  nand2  g116(.a(new_n160_), .b(new_n131_), .O(new_n161_));
  ...
  inv1   g121(.a(new_n137_), .O(new_n166_));
  xnor2a g122(.a(x31), .b(x30), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n144_), .c(new_n142_), .d(new_n166_), .O(new_n168_));
  nor3   g124(.a(new_n168_), .b(new_n152_), .c(new_n147_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n157_), .O(new_n170_));
  aoi21  g126(.a(new_n165_), .b(new_n162_), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n161_), .c(x26), .O(z9));
endmodule
