// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:57 2020
...
module FAU ( 
  ...
  nand3  g114(.a(new_n130_), .b(new_n106_), .c(x31), .O(new_n159_));
  inv1   g115(.a(x33), .O(new_n160_));
  nor2   g116(.a(x31), .b(x30), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n132_), .c(new_n160_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  oai21  g119(.a(new_n127_), .b(new_n125_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n115_), .b(x14), .O(new_n165_));
  nor2   g121(.a(new_n113_), .b(new_n112_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n137_), .O(new_n167_));
  oai21  g123(.a(new_n113_), .b(new_n142_), .c(new_n112_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  nand2  g125(.a(new_n113_), .b(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(new_n167_), .d(new_n161_), .O(new_n171_));
  nand2  g127(.a(new_n166_), .b(x11), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n121_), .O(new_n173_));
  nand2  g129(.a(new_n166_), .b(new_n137_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n115_), .O(new_n175_));
  inv1   g131(.a(new_n166_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n145_), .c(new_n111_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n175_), .c(new_n173_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n171_), .c(x33), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n164_), .c(new_n157_), .O(z9));
endmodule
