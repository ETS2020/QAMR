...
module FAU ( 
  ...
  oai21  g32(.a(new_n56_), .b(x00), .c(new_n40_), .O(new_n57_));
  inv1   g33(.a(x11), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n57_), .O(z3));
  ...
  nand4  g41(.a(new_n65_), .b(new_n56_), .c(new_n41_), .d(new_n40_), .O(z5));
  inv1   g42(.a(x09), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x03), .c(new_n30_), .O(new_n68_));
  aoi21  g44(.a(x08), .b(x00), .c(x01), .O(new_n69_));
  ...
  nand2  g49(.a(new_n30_), .b(new_n73_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n73_), .c(new_n74_), .O(new_n75_));
  nor2   g51(.a(new_n25_), .b(x00), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n71_), .c(new_n75_), .d(new_n72_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n70_), .c(new_n45_), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n30_), .O(new_n79_));
  inv1   g55(.a(x08), .O(new_n80_));
  nand4  g56(.a(new_n41_), .b(new_n80_), .c(new_n40_), .d(x02), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n84_), .b(new_n80_), .c(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n83_), .O(z7));
  nand2  g62(.a(new_n56_), .b(new_n30_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n84_), .c(x09), .O(new_n88_));
  aoi21  g64(.a(new_n67_), .b(new_n73_), .c(new_n45_), .O(new_n89_));
