...
module FAU ( 
  ...
  aoi21  g47(.a(new_n66_), .b(new_n27_), .c(x02), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n70_), .c(new_n46_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n27_), .O(new_n75_));
  nand4  g51(.a(new_n42_), .b(new_n64_), .c(new_n41_), .d(x01), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  oai21  g54(.a(x07), .b(new_n25_), .c(x03), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n64_), .c(new_n46_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n78_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n65_), .b(new_n57_), .c(new_n46_), .O(new_n85_));
