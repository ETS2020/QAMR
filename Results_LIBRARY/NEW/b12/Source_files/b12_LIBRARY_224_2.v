// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:36 2020
...
module FAU ( 
  ...
  aoi21  g32(.a(x12), .b(new_n56_), .c(x07), .O(z3));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(x09), .c(x07), .O(z4));
  inv1   g36(.a(x12), .O(new_n61_));
  nand3  g37(.a(x13), .b(new_n61_), .c(new_n56_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n41_), .c(new_n40_), .O(z5));
  inv1   g40(.a(x09), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x03), .c(new_n30_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n58_), .c(new_n25_), .O(new_n67_));
  inv1   g43(.a(x14), .O(new_n68_));
  oai21  g44(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n69_));
  nand2  g45(.a(new_n30_), .b(new_n56_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n56_), .c(new_n70_), .O(new_n71_));
  nor2   g47(.a(new_n25_), .b(x00), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n68_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n67_), .c(new_n45_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n30_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand4  g52(.a(new_n41_), .b(new_n76_), .c(new_n40_), .d(x02), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n76_), .c(new_n45_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z7));
  nand2  g58(.a(new_n61_), .b(new_n30_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n80_), .c(x09), .O(new_n84_));
  aoi21  g60(.a(new_n65_), .b(new_n56_), .c(new_n45_), .O(new_n85_));
