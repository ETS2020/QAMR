...
module FAU ( 
  ...
  nand2  g39(.a(x03), .b(new_n30_), .O(new_n64_));
  aoi21  g40(.a(x09), .b(new_n34_), .c(x02), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x01), .c(new_n64_), .d(x09), .O(new_n66_));
  oai21  g42(.a(new_n63_), .b(new_n56_), .c(new_n66_), .O(new_n67_));
  aoi21  g43(.a(x14), .b(x02), .c(x00), .O(new_n68_));
  nor2   g44(.a(x08), .b(new_n56_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(x01), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(new_n45_), .O(z6));
  nor2   g47(.a(new_n34_), .b(x01), .O(new_n72_));
  oai21  g48(.a(x07), .b(new_n30_), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n63_), .O(new_n74_));
  inv1   g50(.a(x09), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(x02), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n72_), .c(new_n45_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z7));
  inv1   g54(.a(x12), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  aoi21  g56(.a(new_n64_), .b(new_n40_), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n75_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(new_n75_), .c(new_n82_), .O(z8));
endmodule
