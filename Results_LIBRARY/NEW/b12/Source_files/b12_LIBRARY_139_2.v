...
module FAU ( 
  ...
  aoi21  g39(.a(x09), .b(new_n34_), .c(x02), .O(new_n64_));
  nand3  g40(.a(new_n57_), .b(x03), .c(new_n30_), .O(new_n65_));
  ...
  nor2   g44(.a(x08), .b(new_n55_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(x01), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(x10), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n30_), .O(new_n72_));
  nand3  g48(.a(new_n40_), .b(new_n48_), .c(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g51(.a(x03), .b(new_n25_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n48_), .c(x10), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(z7));
  nand2  g54(.a(new_n61_), .b(new_n30_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n76_), .c(x09), .O(new_n80_));
  aoi21  g56(.a(new_n57_), .b(new_n55_), .c(x10), .O(new_n81_));
