// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:37 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n56_, new_n58_, new_n60_, new_n61_, new_n62_, new_n64_,
    new_n66_, new_n67_, new_n68_, new_n69_, new_n70_, new_n71_, new_n72_,
    new_n73_, new_n74_, new_n76_, new_n77_, new_n78_, new_n79_, new_n80_,
    new_n81_, new_n82_, new_n84_, new_n85_, new_n86_, new_n87_;
  inv1   g00(.a(x01), .O(new_n25_));
  nor2   g01(.a(x06), .b(x04), .O(new_n26_));
  ...
  aoi22  g11(.a(x06), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n36_));
  ...
  oai21  g17(.a(x05), .b(new_n30_), .c(x01), .O(new_n42_));
  nand2  g18(.a(new_n26_), .b(x03), .O(new_n43_));
  inv1   g19(.a(x07), .O(new_n44_));
  inv1   g20(.a(x10), .O(new_n45_));
  nand3  g21(.a(new_n45_), .b(new_n44_), .c(new_n25_), .O(new_n46_));
  nand4  g22(.a(new_n46_), .b(new_n43_), .c(new_n42_), .d(new_n41_), .O(new_n47_));
  oai21  g23(.a(x10), .b(x07), .c(new_n35_), .O(new_n48_));
  nand3  g24(.a(new_n45_), .b(x09), .c(new_n44_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n48_), .c(x01), .O(new_n50_));
  aoi21  g26(.a(new_n47_), .b(x02), .c(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n45_), .b(x09), .O(new_n52_));
  ...
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n44_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n44_), .c(new_n62_), .O(z4));
  nor2   g39(.a(x12), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n45_), .d(new_n44_), .O(z5));
  nand2  g41(.a(new_n45_), .b(new_n44_), .O(new_n66_));
  oai21  g42(.a(new_n60_), .b(x03), .c(new_n31_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n61_), .c(new_n25_), .O(new_n68_));
  inv1   g44(.a(x14), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n35_), .c(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n31_), .b(new_n58_), .O(new_n71_));
  oai21  g47(.a(x08), .b(new_n58_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g51(.a(x09), .b(x03), .c(new_n31_), .O(new_n76_));
  inv1   g52(.a(x08), .O(new_n77_));
  nand4  g53(.a(new_n45_), .b(new_n77_), .c(new_n44_), .d(x02), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(new_n77_), .c(new_n66_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n31_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(x09), .O(new_n86_));
  aoi21  g62(.a(new_n60_), .b(new_n58_), .c(new_n66_), .O(new_n87_));
