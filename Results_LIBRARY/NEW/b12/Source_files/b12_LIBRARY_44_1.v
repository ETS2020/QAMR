...
module FAU ( 
  ...
  nand4  g36(.a(new_n60_), .b(x13), .c(new_n59_), .d(new_n40_), .O(z5));
  nor2   g37(.a(x09), .b(new_n34_), .O(new_n62_));
  oai21  g38(.a(new_n49_), .b(x03), .c(new_n30_), .O(new_n63_));
  aoi21  g39(.a(x08), .b(x00), .c(x01), .O(new_n64_));
  oai21  g40(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(new_n65_));
  aoi21  g41(.a(x14), .b(x02), .c(x00), .O(new_n66_));
  nor2   g42(.a(x08), .b(new_n53_), .O(new_n67_));
  nor2   g43(.a(x10), .b(new_n25_), .O(new_n68_));
  oai21  g44(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n65_), .c(x07), .O(z6));
  ...
  nand2  g50(.a(new_n59_), .b(new_n40_), .O(new_n75_));
  oai21  g51(.a(x07), .b(new_n25_), .c(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n48_), .c(new_n75_), .O(new_n77_));
  ...
  aoi21  g57(.a(new_n49_), .b(new_n53_), .c(new_n75_), .O(new_n82_));
