// Benchmark "FAU" written by ABC on Fri Jun 26 07:24:32 2020
...
module FAU ( 
  ...
  nand2  g0728(.a(new_n107_), .b(new_n832_), .O(new_n833_));
  ...
  nand3  g1157(.a(new_n339_), .b(x48), .c(x02), .O(new_n1262_));
  ...
  nand4  g1439(.a(new_n1543_), .b(new_n302_), .c(new_n171_), .d(x47), .O(new_n1544_));
  nor3   g1440(.a(new_n1544_), .b(new_n415_), .c(x46), .O(z48));
  nand2  g1441(.a(new_n1490_), .b(new_n863_), .O(new_n1546_));
  oai21  g1442(.a(new_n1393_), .b(new_n1335_), .c(new_n1546_), .O(new_n1547_));
  nand2  g1443(.a(new_n1547_), .b(new_n176_), .O(new_n1548_));
  aoi21  g1444(.a(new_n1548_), .b(new_n1533_), .c(x50), .O(new_n1549_));
  nor3   g1445(.a(new_n1000_), .b(new_n166_), .c(x49), .O(new_n1550_));
  oai21  g1446(.a(new_n1550_), .b(new_n1549_), .c(new_n171_), .O(new_n1551_));
  nand2  g1447(.a(new_n277_), .b(new_n178_), .O(new_n1552_));
  oai21  g1448(.a(new_n1552_), .b(new_n1000_), .c(new_n1551_), .O(z49));
  nor2   g1449(.a(new_n1499_), .b(x53), .O(z45));
endmodule
