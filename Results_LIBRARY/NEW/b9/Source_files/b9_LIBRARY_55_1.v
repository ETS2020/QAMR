...
module FAU ( 
  ...
  nor2   g51(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  aoi21  g52(.a(new_n112_), .b(new_n76_), .c(new_n114_), .O(new_n115_));
  nand3  g53(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g54(.a(new_n115_), .b(x04), .c(new_n116_), .O(z10));
  nand2  g55(.a(z08), .b(x29), .O(new_n118_));
  nor2   g56(.a(new_n72_), .b(new_n64_), .O(new_n119_));
  oai21  g57(.a(new_n119_), .b(new_n75_), .c(new_n118_), .O(new_n120_));
  inv1   g58(.a(x08), .O(new_n121_));
  nor2   g59(.a(new_n86_), .b(x28), .O(new_n122_));
  nand3  g60(.a(new_n122_), .b(x27), .c(new_n64_), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  inv1   g62(.a(x09), .O(new_n125_));
  inv1   g63(.a(x30), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  aoi21  g65(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z11));
  aoi21  g66(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n129_));
  nor2   g67(.a(new_n66_), .b(new_n72_), .O(new_n130_));
  nor2   g68(.a(new_n82_), .b(x04), .O(new_n131_));
  oai22  g69(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(x10), .O(z12));
  aoi21  g70(.a(x36), .b(x35), .c(new_n74_), .O(new_n133_));
  oai21  g71(.a(new_n133_), .b(new_n72_), .c(new_n77_), .O(new_n134_));
  inv1   g72(.a(x40), .O(new_n135_));
  nor2   g73(.a(new_n135_), .b(x13), .O(new_n136_));
  nand4  g74(.a(new_n136_), .b(new_n134_), .c(x39), .d(new_n64_), .O(new_n137_));
  nor2   g75(.a(x19), .b(x18), .O(new_n138_));
  nand4  g76(.a(new_n138_), .b(x37), .c(x27), .d(x20), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(z13));
  nand2  g78(.a(new_n139_), .b(x13), .O(new_n141_));
  nor2   g79(.a(x37), .b(x28), .O(new_n142_));
  nand3  g80(.a(new_n138_), .b(x27), .c(x20), .O(new_n143_));
  oai22  g81(.a(new_n143_), .b(new_n142_), .c(new_n82_), .d(x04), .O(new_n144_));
  nand3  g82(.a(new_n144_), .b(new_n141_), .c(new_n134_), .O(z14));
  ...
  nand2  g90(.a(new_n122_), .b(new_n72_), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n118_), .O(new_n154_));
  nand2  g92(.a(new_n154_), .b(x08), .O(new_n155_));
  nand4  g93(.a(new_n155_), .b(new_n123_), .c(new_n126_), .d(new_n125_), .O(z18));
  oai21  g94(.a(new_n86_), .b(new_n72_), .c(new_n121_), .O(new_n157_));
  oai21  g95(.a(new_n74_), .b(x27), .c(x35), .O(new_n158_));
  nand2  g96(.a(new_n158_), .b(new_n118_), .O(new_n159_));
  aoi21  g97(.a(new_n159_), .b(new_n157_), .c(new_n127_), .O(z20));
  aoi21  g98(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z19));
endmodule
