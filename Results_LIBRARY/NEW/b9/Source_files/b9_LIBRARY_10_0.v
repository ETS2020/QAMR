...
module FAU ( 
  ...
  nand2  g000(.a(x39), .b(x36), .O(new_n63_));
  ...
  aoi21  g095(.a(new_n157_), .b(x39), .c(x37), .O(new_n158_));
  ...
  nand2  g100(.a(z08), .b(new_n70_), .O(new_n163_));
  oai21  g101(.a(new_n130_), .b(new_n147_), .c(new_n84_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n77_), .O(new_n165_));
  nor2   g103(.a(x13), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(x40), .c(new_n153_), .O(new_n167_));
  nand4  g105(.a(new_n78_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x39), .c(new_n159_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n165_), .c(new_n162_), .O(z14));
  ...
  oai22  g117(.a(new_n80_), .b(x27), .c(new_n71_), .d(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n134_), .c(new_n128_), .O(z18));
  oai22  g120(.a(new_n130_), .b(new_n126_), .c(new_n86_), .d(new_n77_), .O(new_n183_));
  oai21  g121(.a(new_n79_), .b(x27), .c(x35), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n131_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n183_), .c(new_n135_), .O(z20));
  aoi21  g124(.a(new_n133_), .b(new_n129_), .c(new_n135_), .O(z19));
endmodule
