...
module FAU ( 
  ...
  oai21  g021(.a(new_n83_), .b(new_n81_), .c(x04), .O(new_n84_));
  ...
  oai21  g026(.a(new_n88_), .b(new_n82_), .c(x27), .O(new_n89_));
  ...
  oai21  g049(.a(new_n88_), .b(x28), .c(new_n75_), .O(new_n112_));
  ...
  oai21  g059(.a(new_n74_), .b(new_n64_), .c(new_n82_), .O(new_n122_));
  ...
  oai21  g095(.a(x28), .b(x27), .c(new_n123_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x08), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n128_), .c(new_n126_), .O(z18));
  aoi21  g098(.a(new_n123_), .b(x28), .c(new_n125_), .O(new_n161_));
  nor3   g099(.a(new_n161_), .b(new_n129_), .c(x27), .O(z20));
  aoi21  g100(.a(new_n127_), .b(new_n124_), .c(new_n129_), .O(z19));
endmodule
