...
module FAU ( 
  ...
  nor2   g055(.a(new_n86_), .b(x28), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(x27), .c(new_n64_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  inv1   g058(.a(x29), .O(new_n121_));
  ...
  oai22  g103(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n121_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n125_), .c(new_n119_), .O(z18));
  ...
  aoi21  g109(.a(new_n171_), .b(new_n117_), .c(new_n121_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n126_), .O(z20));
  aoi21  g111(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
