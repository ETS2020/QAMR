// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:29 2020
...
module FAU ( 
  ...
  inv1   g026(.a(x19), .O(new_n89_));
  nor2   g027(.a(new_n66_), .b(new_n74_), .O(new_n90_));
  nand4  g028(.a(new_n90_), .b(x20), .c(new_n89_), .d(new_n85_), .O(new_n91_));
  ...
  nand4  g083(.a(new_n145_), .b(x20), .c(new_n89_), .d(new_n85_), .O(new_n146_));
  ...
  aoi22  g092(.a(new_n154_), .b(x40), .c(new_n68_), .d(x18), .O(new_n155_));
