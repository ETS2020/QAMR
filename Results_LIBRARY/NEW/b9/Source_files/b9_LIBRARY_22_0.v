...
module FAU ( 
  ...
  oai21  g062(.a(new_n66_), .b(new_n72_), .c(new_n65_), .O(new_n125_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n127_), .c(new_n126_), .O(new_n130_));
  nand2  g068(.a(new_n128_), .b(new_n72_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n125_), .O(z12));
  ...
  nand4  g075(.a(new_n137_), .b(new_n135_), .c(x40), .d(new_n133_), .O(new_n138_));
  ...
  nand4  g084(.a(new_n78_), .b(z08), .c(new_n133_), .d(new_n64_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  inv1   g086(.a(x30), .O(new_n149_));
  inv1   g087(.a(x32), .O(new_n150_));
  nand4  g088(.a(new_n136_), .b(new_n150_), .c(new_n149_), .d(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x40), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n142_), .O(new_n153_));
  nand3  g091(.a(new_n135_), .b(x40), .c(new_n133_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n72_), .O(new_n155_));
  nand3  g093(.a(x39), .b(new_n133_), .c(new_n64_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n144_), .O(new_n157_));
  nand3  g095(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n77_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(z14));
  ...
  oai21  g106(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n122_), .c(new_n120_), .O(z18));
  ...
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n123_), .O(z20));
  aoi21  g113(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
