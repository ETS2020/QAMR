// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:39 2020
...
module FAU ( 
  ...
  nand2  g048(.a(new_n86_), .b(x07), .O(new_n111_));
  oai21  g049(.a(new_n86_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nor3   g050(.a(new_n86_), .b(new_n80_), .c(new_n110_), .O(new_n113_));
  ...
  nor2   g055(.a(new_n75_), .b(new_n65_), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(new_n78_), .c(new_n117_), .O(new_n119_));
  inv1   g057(.a(x08), .O(new_n120_));
  nand4  g058(.a(x35), .b(new_n77_), .c(x27), .d(new_n65_), .O(new_n121_));
  ...
  inv1   g063(.a(new_n64_), .O(new_n126_));
  nor2   g064(.a(new_n86_), .b(x04), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n72_), .c(new_n126_), .O(z12));
  ...
  nand4  g070(.a(new_n132_), .b(new_n130_), .c(x39), .d(new_n65_), .O(new_n133_));
  ...
  nand3  g088(.a(new_n68_), .b(new_n150_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n80_), .O(new_n153_));
  nand2  g091(.a(new_n148_), .b(new_n71_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n153_), .c(new_n149_), .O(z14));
  ...
  oai21  g100(.a(new_n78_), .b(x27), .c(new_n117_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g103(.a(new_n150_), .b(new_n75_), .c(new_n120_), .O(new_n166_));
  oai21  g104(.a(new_n77_), .b(x27), .c(x35), .O(new_n167_));
