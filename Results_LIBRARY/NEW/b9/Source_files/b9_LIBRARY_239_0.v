...
module FAU ( 
  ...
  aoi21  g20(.a(new_n77_), .b(x04), .c(new_n82_), .O(new_n83_));
  inv1   g21(.a(x08), .O(new_n84_));
  nand3  g22(.a(new_n74_), .b(new_n84_), .c(x04), .O(new_n85_));
  nand4  g23(.a(new_n85_), .b(new_n83_), .c(x40), .d(x39), .O(z02));
  inv1   g24(.a(x35), .O(new_n87_));
  oai21  g25(.a(new_n87_), .b(new_n76_), .c(x27), .O(new_n88_));
  inv1   g26(.a(x37), .O(new_n89_));
  nand2  g27(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  ...
  nand2  g48(.a(new_n68_), .b(x07), .O(new_n111_));
  oai21  g49(.a(new_n68_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand3  g50(.a(x40), .b(x39), .c(x05), .O(new_n113_));
  nor2   g51(.a(new_n113_), .b(new_n79_), .O(new_n114_));
  aoi21  g52(.a(new_n112_), .b(new_n78_), .c(new_n114_), .O(new_n115_));
  nand3  g53(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g54(.a(new_n115_), .b(x04), .c(new_n116_), .O(z10));
  nand2  g55(.a(z08), .b(x29), .O(new_n118_));
  nor2   g56(.a(new_n74_), .b(new_n64_), .O(new_n119_));
  oai21  g57(.a(new_n119_), .b(new_n77_), .c(new_n118_), .O(new_n120_));
  nand4  g58(.a(x35), .b(new_n76_), .c(x27), .d(new_n64_), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(new_n84_), .O(new_n122_));
  nor2   g60(.a(x30), .b(x09), .O(new_n123_));
  inv1   g61(.a(new_n123_), .O(new_n124_));
  aoi21  g62(.a(new_n122_), .b(new_n120_), .c(new_n124_), .O(z11));
  nor3   g63(.a(x37), .b(x36), .c(x35), .O(new_n126_));
  oai21  g64(.a(new_n126_), .b(new_n74_), .c(new_n70_), .O(new_n127_));
  oai22  g65(.a(new_n68_), .b(x04), .c(new_n66_), .d(new_n74_), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n127_), .O(z12));
  inv1   g67(.a(x13), .O(new_n130_));
  nand3  g68(.a(x39), .b(new_n130_), .c(new_n64_), .O(new_n131_));
  nand2  g69(.a(x36), .b(x35), .O(new_n132_));
  aoi21  g70(.a(new_n132_), .b(x28), .c(new_n131_), .O(new_n133_));
  inv1   g71(.a(x18), .O(new_n134_));
  inv1   g72(.a(x19), .O(new_n135_));
  nand3  g73(.a(x20), .b(new_n135_), .c(new_n134_), .O(new_n136_));
  nor2   g74(.a(new_n136_), .b(new_n66_), .O(new_n137_));
  oai21  g75(.a(new_n137_), .b(new_n133_), .c(x27), .O(new_n138_));
  oai21  g76(.a(new_n131_), .b(new_n79_), .c(new_n138_), .O(z13));
  nand4  g77(.a(x27), .b(x20), .c(new_n135_), .d(new_n134_), .O(new_n140_));
  oai21  g78(.a(new_n140_), .b(new_n66_), .c(new_n131_), .O(new_n141_));
  nor2   g79(.a(x37), .b(x35), .O(new_n142_));
  aoi21  g80(.a(new_n136_), .b(new_n132_), .c(new_n142_), .O(new_n143_));
  oai21  g81(.a(new_n143_), .b(new_n76_), .c(x27), .O(new_n144_));
  nand2  g82(.a(new_n144_), .b(new_n79_), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(new_n141_), .O(z14));
  ...
  oai21  g91(.a(new_n77_), .b(x27), .c(new_n118_), .O(new_n154_));
  nand2  g92(.a(new_n154_), .b(x08), .O(new_n155_));
  nand3  g93(.a(new_n155_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g94(.a(new_n87_), .b(new_n74_), .c(new_n84_), .O(new_n157_));
  oai21  g95(.a(new_n76_), .b(x27), .c(x35), .O(new_n158_));
  nand2  g96(.a(new_n158_), .b(new_n118_), .O(new_n159_));
  aoi21  g97(.a(new_n159_), .b(new_n157_), .c(new_n124_), .O(z20));
  aoi21  g98(.a(new_n122_), .b(new_n120_), .c(new_n124_), .O(z19));
endmodule
