...
module FAU ( 
  ...
  nand2  g067(.a(new_n74_), .b(new_n129_), .O(new_n130_));
  nand2  g068(.a(x36), .b(x35), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n65_), .O(new_n132_));
  nor2   g070(.a(x19), .b(x18), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x20), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(new_n66_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n132_), .c(x27), .O(new_n136_));
  nand4  g074(.a(new_n78_), .b(z08), .c(new_n129_), .d(new_n64_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(z13));
  inv1   g076(.a(x32), .O(new_n139_));
  nor2   g077(.a(x30), .b(new_n74_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n86_), .c(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n129_), .O(new_n142_));
  nand3  g080(.a(new_n133_), .b(x37), .c(x20), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand3  g082(.a(new_n133_), .b(x27), .c(x20), .O(new_n145_));
  oai22  g083(.a(new_n145_), .b(new_n66_), .c(new_n82_), .d(x04), .O(new_n146_));
  oai21  g084(.a(new_n77_), .b(x13), .c(new_n72_), .O(new_n147_));
  nand4  g085(.a(new_n140_), .b(new_n134_), .c(new_n73_), .d(new_n139_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n144_), .O(z14));
  ...
  oai21  g094(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x08), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g097(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n160_));
  oai21  g098(.a(new_n74_), .b(x27), .c(x35), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n117_), .O(new_n162_));
