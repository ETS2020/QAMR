...
module FAU ( 
  ...
  oai21  g011(.a(x36), .b(new_n72_), .c(x27), .O(new_n74_));
  aoi22  g012(.a(new_n74_), .b(new_n73_), .c(new_n63_), .d(new_n72_), .O(new_n75_));
  oai21  g013(.a(new_n75_), .b(x32), .c(x04), .O(z01));
  nor2   g014(.a(x27), .b(x08), .O(new_n77_));
  nand2  g015(.a(x35), .b(new_n72_), .O(new_n78_));
  ...
  oai21  g022(.a(new_n84_), .b(new_n72_), .c(x27), .O(new_n85_));
  ...
  nor2   g057(.a(new_n84_), .b(x28), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(x30), .O(new_n121_));
  nor3   g059(.a(x28), .b(new_n86_), .c(new_n64_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n121_), .c(new_n119_), .O(new_n123_));
  inv1   g061(.a(x08), .O(new_n124_));
  nand3  g062(.a(x35), .b(new_n72_), .c(x27), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n73_), .O(new_n126_));
  nand2  g064(.a(new_n72_), .b(x04), .O(new_n127_));
  ...
  aoi21  g068(.a(new_n63_), .b(new_n87_), .c(new_n86_), .O(new_n131_));
  inv1   g069(.a(new_n66_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x27), .O(new_n133_));
  oai21  g071(.a(new_n80_), .b(x04), .c(new_n133_), .O(new_n134_));
  ...
  nor2   g085(.a(new_n114_), .b(new_n80_), .O(new_n148_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n152_), .c(new_n73_), .d(x28), .O(new_n153_));
  ...
  nand3  g094(.a(new_n87_), .b(new_n84_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n114_), .O(new_n159_));
  ...
  aoi22  g106(.a(new_n120_), .b(new_n86_), .c(z08), .d(x29), .O(new_n169_));
  nor2   g107(.a(new_n86_), .b(x04), .O(new_n170_));
  inv1   g108(.a(x09), .O(new_n171_));
  nand2  g109(.a(new_n73_), .b(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n170_), .b(new_n120_), .c(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n169_), .b(new_n124_), .c(new_n173_), .O(z18));
  oai21  g112(.a(new_n84_), .b(new_n86_), .c(new_n124_), .O(new_n175_));
  oai21  g113(.a(new_n72_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n119_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n175_), .c(new_n172_), .O(z20));
  aoi21  g116(.a(new_n129_), .b(new_n123_), .c(x09), .O(z19));
endmodule
