// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:32 2020
...
module FAU ( 
  ...
  inv1   g066(.a(x10), .O(new_n129_));
  nor3   g067(.a(x37), .b(x36), .c(x35), .O(new_n130_));
  inv1   g068(.a(x40), .O(new_n131_));
  nor2   g069(.a(new_n131_), .b(x27), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(new_n133_));
  oai21  g071(.a(new_n106_), .b(x04), .c(new_n66_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n128_), .O(z12));
  nand2  g073(.a(x36), .b(x35), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x28), .O(new_n137_));
  nor2   g075(.a(new_n131_), .b(x13), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n137_), .c(x39), .d(new_n64_), .O(new_n139_));
  ...
  nand4  g086(.a(new_n78_), .b(z08), .c(new_n148_), .d(new_n64_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  inv1   g088(.a(x32), .O(new_n151_));
  nand4  g089(.a(new_n136_), .b(new_n151_), .c(new_n124_), .d(x28), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  nand4  g091(.a(x40), .b(x39), .c(new_n148_), .d(new_n64_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n143_), .O(new_n155_));
  nand2  g093(.a(new_n154_), .b(new_n72_), .O(new_n156_));
  nand3  g094(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n77_), .O(new_n159_));
  nand2  g097(.a(new_n148_), .b(new_n64_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n106_), .c(new_n66_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n159_), .c(new_n156_), .d(new_n155_), .O(z14));
  ...
  nor2   g107(.a(new_n85_), .b(x28), .O(new_n170_));
  aoi22  g108(.a(new_n170_), .b(new_n72_), .c(z08), .d(x29), .O(new_n171_));
  nor2   g109(.a(new_n72_), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n125_), .O(new_n173_));
  oai21  g111(.a(new_n171_), .b(new_n82_), .c(new_n173_), .O(z18));
  oai21  g112(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n175_));
  oai21  g113(.a(new_n74_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n117_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n175_), .c(new_n125_), .O(z20));
  aoi21  g116(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
