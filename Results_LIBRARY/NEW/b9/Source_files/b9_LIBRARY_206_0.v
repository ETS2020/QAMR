// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:14 2020
...
module FAU ( 
  ...
  nand2  g054(.a(x39), .b(x29), .O(new_n117_));
  ...
  nand3  g066(.a(x36), .b(x35), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(x40), .b(new_n74_), .O(new_n130_));
  inv1   g068(.a(x13), .O(new_n131_));
  nand3  g069(.a(x39), .b(new_n131_), .c(new_n64_), .O(new_n132_));
  aoi21  g070(.a(new_n130_), .b(new_n129_), .c(new_n132_), .O(new_n133_));
  nor2   g071(.a(x19), .b(x18), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x20), .O(new_n135_));
  nor2   g073(.a(new_n135_), .b(new_n66_), .O(new_n136_));
  ...
  nand4  g080(.a(new_n142_), .b(new_n141_), .c(new_n128_), .d(x28), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n138_), .b(z08), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n135_), .O(new_n146_));
  nand4  g084(.a(x40), .b(x39), .c(new_n131_), .d(new_n64_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n72_), .O(new_n148_));
  nand3  g086(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n77_), .O(new_n151_));
  nand2  g089(.a(new_n145_), .b(new_n66_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n151_), .c(new_n148_), .d(new_n146_), .O(z14));
  ...
  oai21  g098(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x08), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n122_), .c(new_n120_), .O(z18));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n123_), .O(z20));
  aoi21  g105(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
