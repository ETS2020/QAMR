// Benchmark "FAU" written by ABC on Thu Jun 25 20:41:53 2020
...
module FAU ( 
  ...
  aoi21  g060(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(new_n123_));
  inv1   g061(.a(x09), .O(new_n124_));
  inv1   g062(.a(x30), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  aoi21  g064(.a(new_n123_), .b(new_n120_), .c(new_n126_), .O(z11));
  ...
  inv1   g103(.a(new_n122_), .O(new_n166_));
  aoi21  g104(.a(new_n165_), .b(new_n72_), .c(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n118_), .b(new_n165_), .c(new_n126_), .O(new_n168_));
  oai21  g106(.a(new_n167_), .b(new_n117_), .c(new_n168_), .O(z18));
  oai21  g107(.a(new_n166_), .b(new_n74_), .c(x08), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n72_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(x35), .c(new_n126_), .O(z20));
  aoi21  g110(.a(new_n123_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
