...
module FAU ( 
  ...
  nand3  g190(.a(x78), .b(x52), .c(x18), .O(new_n342_));
  oai21  g191(.a(x52), .b(new_n341_), .c(new_n342_), .O(new_n343_));
  nor2   g192(.a(x77), .b(new_n240_), .O(new_n344_));
  nand3  g193(.a(new_n344_), .b(new_n343_), .c(new_n154_), .O(new_n345_));
  nand2  g194(.a(new_n332_), .b(x70), .O(new_n346_));
  ...
  nand2  g199(.a(new_n344_), .b(new_n172_), .O(new_n351_));
  ...
  nand2  g213(.a(new_n364_), .b(new_n352_), .O(new_n365_));
  ...
  aoi21  g275(.a(new_n426_), .b(new_n351_), .c(x01), .O(z64));
