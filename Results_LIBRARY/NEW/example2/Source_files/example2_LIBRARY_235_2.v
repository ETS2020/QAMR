...
module FAU ( 
  ...
  nand3  g184(.a(x78), .b(x52), .c(x17), .O(new_n336_));
  oai21  g185(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nor2   g186(.a(x77), .b(new_n240_), .O(new_n338_));
  nand3  g187(.a(new_n338_), .b(new_n337_), .c(new_n154_), .O(new_n339_));
  nand2  g188(.a(new_n332_), .b(x69), .O(new_n340_));
  ...
  nand2  g193(.a(new_n338_), .b(new_n172_), .O(new_n345_));
  ...
  nand2  g202(.a(new_n332_), .b(x71), .O(new_n354_));
  ...
  nand2  g208(.a(new_n332_), .b(x72), .O(new_n360_));
  ...
  nand2  g214(.a(new_n332_), .b(x73), .O(new_n366_));
  aoi21  g215(.a(new_n366_), .b(new_n365_), .c(x01), .O(z53));
  nand2  g216(.a(x52), .b(x22), .O(new_n368_));
  nand2  g217(.a(new_n287_), .b(x14), .O(new_n369_));
  ...
  nand3  g222(.a(new_n274_), .b(x84), .c(new_n373_), .O(new_n374_));
  ...
  nand4  g237(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n389_));
  oai22  g238(.a(new_n389_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n390_));
  ...
  oai21  g248(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n400_));
  ...
  aoi22  g258(.a(new_n409_), .b(new_n227_), .c(new_n161_), .d(new_n240_), .O(new_n410_));
  ...
  nand2  g270(.a(new_n421_), .b(new_n322_), .O(new_n422_));
  ...
  aoi21  g275(.a(new_n426_), .b(new_n345_), .c(x01), .O(z64));
