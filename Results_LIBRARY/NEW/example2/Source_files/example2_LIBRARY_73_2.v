// Benchmark "FAU" written by ABC on Thu Jun 25 19:52:59 2020
...
module FAU ( 
  ...
  nand4  g153(.a(new_n246_), .b(x78), .c(x77), .d(x58), .O(new_n305_));
  aoi21  g154(.a(new_n292_), .b(new_n288_), .c(new_n305_), .O(z40));
  nor3   g155(.a(new_n294_), .b(new_n284_), .c(new_n193_), .O(z41));
  nor3   g156(.a(new_n294_), .b(new_n284_), .c(new_n190_), .O(z42));
  nor3   g157(.a(new_n294_), .b(new_n284_), .c(new_n187_), .O(z43));
  nor3   g158(.a(new_n294_), .b(new_n284_), .c(new_n184_), .O(z44));
