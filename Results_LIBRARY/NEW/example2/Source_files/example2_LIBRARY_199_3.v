...
module FAU ( 
  ...
  inv1   g170(.a(new_n169_), .O(new_n322_));
  ...
  inv1   g215(.a(new_n168_), .O(new_n367_));
  ...
  nand2  g223(.a(new_n169_), .b(new_n168_), .O(new_n375_));
  xor2a  g224(.a(x84), .b(x81), .O(new_n376_));
  nand3  g225(.a(new_n376_), .b(new_n375_), .c(x79), .O(new_n377_));
  inv1   g226(.a(new_n377_), .O(new_n378_));
  oai21  g227(.a(new_n378_), .b(new_n163_), .c(new_n153_), .O(new_n379_));
  nand2  g228(.a(x79), .b(x76), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(new_n379_), .c(new_n243_), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand3  g231(.a(new_n243_), .b(x03), .c(new_n382_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  nand4  g233(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n385_));
  oai22  g234(.a(new_n385_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n386_));
  nand3  g235(.a(new_n386_), .b(new_n237_), .c(x79), .O(new_n387_));
  nor2   g236(.a(x79), .b(x78), .O(new_n388_));
  nand3  g237(.a(new_n388_), .b(new_n250_), .c(x40), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n387_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x77), .O(new_n391_));
  oai21  g240(.a(new_n367_), .b(new_n240_), .c(new_n154_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n391_), .c(x01), .O(z58));
  inv1   g242(.a(new_n388_), .O(new_n394_));
  aoi21  g243(.a(new_n236_), .b(new_n394_), .c(new_n152_), .O(new_n395_));
  oai21  g244(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(x79), .c(new_n236_), .O(new_n397_));
  oai21  g246(.a(new_n397_), .b(new_n395_), .c(x77), .O(new_n398_));
  nand2  g247(.a(new_n154_), .b(new_n240_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n398_), .c(x01), .O(z59));
  and2   g249(.a(new_n399_), .b(new_n377_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(new_n238_), .c(x01), .O(z60));
  inv1   g251(.a(new_n171_), .O(new_n403_));
  aoi22  g252(.a(new_n375_), .b(new_n227_), .c(new_n161_), .d(new_n240_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n403_), .c(new_n372_), .O(z61));
  nand3  g254(.a(x84), .b(x81), .c(x79), .O(new_n406_));
  oai21  g255(.a(x79), .b(new_n240_), .c(new_n406_), .O(new_n407_));
  nand2  g256(.a(new_n407_), .b(new_n159_), .O(new_n408_));
  nand2  g257(.a(new_n396_), .b(x79), .O(new_n409_));
  nand3  g258(.a(x81), .b(x79), .c(new_n240_), .O(new_n410_));
  ...
  nor3   g266(.a(new_n404_), .b(new_n403_), .c(new_n370_), .O(z63));
