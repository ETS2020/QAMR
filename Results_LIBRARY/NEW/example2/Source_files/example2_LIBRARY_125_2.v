// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:20 2020
...
module FAU ( 
  ...
  nand3  g128(.a(new_n246_), .b(new_n161_), .c(x79), .O(new_n280_));
  aoi21  g129(.a(new_n279_), .b(new_n276_), .c(new_n280_), .O(z33));
  nor2   g130(.a(new_n229_), .b(new_n249_), .O(new_n282_));
  nand3  g131(.a(x83), .b(x81), .c(x42), .O(new_n283_));
  oai21  g132(.a(new_n282_), .b(x81), .c(new_n283_), .O(new_n284_));
  nand2  g133(.a(new_n284_), .b(new_n253_), .O(new_n285_));
  nand2  g134(.a(x83), .b(new_n252_), .O(new_n286_));
  oai22  g135(.a(new_n282_), .b(new_n252_), .c(new_n286_), .d(new_n249_), .O(new_n287_));
  ...
  nor2   g139(.a(new_n290_), .b(new_n244_), .O(new_n291_));
  nand3  g140(.a(new_n291_), .b(new_n246_), .c(x52), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(z34));
  nand3  g142(.a(new_n291_), .b(new_n246_), .c(x53), .O(new_n294_));
  inv1   g143(.a(new_n294_), .O(z35));
  nand3  g144(.a(new_n291_), .b(new_n246_), .c(x54), .O(new_n296_));
  inv1   g145(.a(new_n296_), .O(z36));
  nand3  g146(.a(new_n291_), .b(new_n246_), .c(x55), .O(new_n298_));
  inv1   g147(.a(new_n298_), .O(z37));
  nand3  g148(.a(new_n291_), .b(new_n246_), .c(x56), .O(new_n300_));
  inv1   g149(.a(new_n300_), .O(z38));
  nand3  g150(.a(new_n291_), .b(new_n246_), .c(x57), .O(new_n302_));
  inv1   g151(.a(new_n302_), .O(z39));
  nand3  g152(.a(new_n246_), .b(x77), .c(x58), .O(new_n304_));
  nor2   g153(.a(new_n304_), .b(new_n290_), .O(z40));
  nand3  g154(.a(new_n291_), .b(new_n246_), .c(x59), .O(new_n306_));
  inv1   g155(.a(new_n306_), .O(z41));
  nand3  g156(.a(new_n291_), .b(new_n246_), .c(x60), .O(new_n308_));
  inv1   g157(.a(new_n308_), .O(z42));
  nand3  g158(.a(new_n291_), .b(new_n246_), .c(x61), .O(new_n310_));
  inv1   g159(.a(new_n310_), .O(z43));
  nand3  g160(.a(new_n291_), .b(new_n246_), .c(x62), .O(new_n312_));
  inv1   g161(.a(new_n312_), .O(z44));
  nand3  g162(.a(new_n291_), .b(new_n246_), .c(x63), .O(new_n314_));
  inv1   g163(.a(new_n314_), .O(z45));
  nand3  g164(.a(new_n291_), .b(new_n246_), .c(x64), .O(new_n316_));
  ...
  nand2  g170(.a(new_n321_), .b(new_n236_), .O(new_n322_));
  ...
  nand2  g177(.a(new_n328_), .b(new_n226_), .O(new_n329_));
  ...
  inv1   g183(.a(new_n226_), .O(new_n335_));
  ...
  nor2   g218(.a(x52), .b(new_n369_), .O(new_n370_));
  aoi21  g219(.a(x52), .b(x22), .c(new_n370_), .O(new_n371_));
  inv1   g220(.a(new_n167_), .O(new_n372_));
  nand4  g221(.a(new_n372_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n373_));
  nor2   g222(.a(new_n373_), .b(new_n371_), .O(z54));
  inv1   g223(.a(x84), .O(new_n375_));
  inv1   g224(.a(x80), .O(new_n376_));
  nand4  g225(.a(new_n246_), .b(new_n161_), .c(new_n376_), .d(x79), .O(new_n377_));
  nor4   g226(.a(new_n377_), .b(new_n286_), .c(new_n375_), .d(x82), .O(z55));
  ...
  nand3  g234(.a(new_n385_), .b(new_n384_), .c(new_n242_), .O(z56));
  inv1   g235(.a(x02), .O(new_n387_));
  nand3  g236(.a(new_n242_), .b(x03), .c(new_n387_), .O(new_n388_));
  inv1   g237(.a(new_n388_), .O(z57));
  nand4  g238(.a(x80), .b(new_n231_), .c(x43), .d(new_n249_), .O(new_n390_));
  oai22  g239(.a(new_n390_), .b(new_n230_), .c(new_n249_), .d(x40), .O(new_n391_));
  nand3  g240(.a(new_n391_), .b(new_n236_), .c(x79), .O(new_n392_));
  nor2   g241(.a(x79), .b(x78), .O(new_n393_));
  nand3  g242(.a(new_n393_), .b(new_n249_), .c(x40), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n392_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(x77), .O(new_n396_));
  oai21  g245(.a(new_n372_), .b(new_n239_), .c(new_n154_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n396_), .c(x01), .O(z58));
  inv1   g247(.a(new_n393_), .O(new_n399_));
  aoi21  g248(.a(new_n235_), .b(new_n399_), .c(new_n152_), .O(new_n400_));
  oai21  g249(.a(new_n232_), .b(new_n230_), .c(new_n249_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(x79), .c(new_n235_), .O(new_n402_));
  ...
  aoi21  g255(.a(new_n381_), .b(x79), .c(new_n404_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n237_), .c(x01), .O(z60));
  nand2  g257(.a(new_n168_), .b(new_n167_), .O(new_n409_));
  aoi22  g258(.a(new_n409_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n410_));
  nand2  g259(.a(new_n170_), .b(x80), .O(new_n411_));
  nor2   g260(.a(new_n411_), .b(new_n410_), .O(z61));
  nand3  g261(.a(x84), .b(x81), .c(x79), .O(new_n413_));
  oai21  g262(.a(x79), .b(new_n239_), .c(new_n413_), .O(new_n414_));
  nand2  g263(.a(new_n414_), .b(new_n159_), .O(new_n415_));
  nand2  g264(.a(new_n401_), .b(x79), .O(new_n416_));
  nand3  g265(.a(x81), .b(x79), .c(new_n239_), .O(new_n417_));
  ...
  nand2  g271(.a(new_n422_), .b(new_n326_), .O(new_n423_));
  aoi21  g272(.a(new_n423_), .b(new_n421_), .c(x01), .O(z62));
  nand2  g273(.a(new_n170_), .b(x82), .O(new_n425_));
  nor2   g274(.a(new_n425_), .b(new_n410_), .O(z63));
  nand2  g275(.a(x83), .b(x79), .O(new_n427_));
  or2    g276(.a(new_n427_), .b(new_n410_), .O(new_n428_));
  aoi21  g277(.a(new_n428_), .b(new_n322_), .c(x01), .O(z64));
  nor2   g278(.a(new_n160_), .b(x04), .O(new_n430_));
  nor2   g279(.a(new_n252_), .b(x78), .O(new_n431_));
  oai21  g280(.a(new_n431_), .b(new_n430_), .c(x77), .O(new_n432_));
  nand2  g281(.a(new_n372_), .b(x81), .O(new_n433_));
