// Benchmark "FAU" written by ABC on Thu Jun 25 19:52:34 2020
...
module FAU ( 
  ...
  nor3   g156(.a(new_n296_), .b(new_n287_), .c(new_n190_), .O(z42));
  nor3   g157(.a(new_n296_), .b(new_n287_), .c(new_n187_), .O(z43));
  nor3   g158(.a(new_n296_), .b(new_n287_), .c(new_n184_), .O(z44));
  nor3   g159(.a(new_n296_), .b(new_n287_), .c(new_n181_), .O(z45));
  nor3   g160(.a(new_n296_), .b(new_n287_), .c(new_n178_), .O(z46));
  inv1   g161(.a(x07), .O(new_n314_));
  nand2  g162(.a(x52), .b(x15), .O(new_n315_));
  oai21  g163(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nor2   g164(.a(x79), .b(x77), .O(new_n317_));
  nand2  g165(.a(new_n317_), .b(new_n236_), .O(new_n318_));
  inv1   g166(.a(new_n318_), .O(new_n319_));
  nand2  g167(.a(new_n319_), .b(new_n316_), .O(new_n320_));
  nor2   g168(.a(x75), .b(x67), .O(new_n321_));
  inv1   g169(.a(new_n168_), .O(new_n322_));
  nand2  g170(.a(new_n322_), .b(x79), .O(new_n323_));
  nor2   g171(.a(new_n323_), .b(new_n321_), .O(new_n324_));
  nand2  g172(.a(new_n324_), .b(new_n226_), .O(new_n325_));
  aoi21  g173(.a(new_n325_), .b(new_n320_), .c(x01), .O(z47));
  inv1   g174(.a(x08), .O(new_n327_));
  nand2  g175(.a(x52), .b(x16), .O(new_n328_));
  oai21  g176(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g177(.a(new_n329_), .b(new_n319_), .O(new_n330_));
  inv1   g178(.a(new_n226_), .O(new_n331_));
  nor2   g179(.a(new_n323_), .b(new_n331_), .O(new_n332_));
  nand2  g180(.a(new_n332_), .b(x68), .O(new_n333_));
  aoi21  g181(.a(new_n333_), .b(new_n330_), .c(x01), .O(z48));
  inv1   g182(.a(x09), .O(new_n335_));
  nand2  g183(.a(x52), .b(x17), .O(new_n336_));
  oai21  g184(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g185(.a(new_n337_), .b(new_n319_), .O(new_n338_));
  nand2  g186(.a(new_n332_), .b(x69), .O(new_n339_));
  aoi21  g187(.a(new_n339_), .b(new_n338_), .c(x01), .O(z49));
  inv1   g188(.a(x10), .O(new_n341_));
  nand2  g189(.a(x52), .b(x18), .O(new_n342_));
  oai21  g190(.a(x52), .b(new_n341_), .c(new_n342_), .O(new_n343_));
  nand2  g191(.a(new_n343_), .b(new_n319_), .O(new_n344_));
  nand2  g192(.a(new_n332_), .b(x70), .O(new_n345_));
  aoi21  g193(.a(new_n345_), .b(new_n344_), .c(x01), .O(z50));
  inv1   g194(.a(x11), .O(new_n347_));
  nand2  g195(.a(x52), .b(x19), .O(new_n348_));
  oai21  g196(.a(x52), .b(new_n347_), .c(new_n348_), .O(new_n349_));
  nand2  g197(.a(new_n349_), .b(new_n319_), .O(new_n350_));
  nand2  g198(.a(new_n332_), .b(x71), .O(new_n351_));
  aoi21  g199(.a(new_n351_), .b(new_n350_), .c(x01), .O(z51));
  inv1   g200(.a(x12), .O(new_n353_));
  nand2  g201(.a(x52), .b(x20), .O(new_n354_));
  oai21  g202(.a(x52), .b(new_n353_), .c(new_n354_), .O(new_n355_));
  nand2  g203(.a(new_n355_), .b(new_n319_), .O(new_n356_));
  nand2  g204(.a(new_n332_), .b(x72), .O(new_n357_));
  aoi21  g205(.a(new_n357_), .b(new_n356_), .c(x01), .O(z52));
  inv1   g206(.a(x13), .O(new_n359_));
  nand2  g207(.a(x52), .b(x21), .O(new_n360_));
  oai21  g208(.a(x52), .b(new_n359_), .c(new_n360_), .O(new_n361_));
  nand2  g209(.a(new_n361_), .b(new_n319_), .O(new_n362_));
  nand2  g210(.a(new_n332_), .b(x73), .O(new_n363_));
  aoi21  g211(.a(new_n363_), .b(new_n362_), .c(x01), .O(z53));
  nand2  g212(.a(x52), .b(x22), .O(new_n365_));
  nand2  g213(.a(new_n286_), .b(x14), .O(new_n366_));
  inv1   g214(.a(new_n167_), .O(new_n367_));
  nand4  g215(.a(new_n367_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n368_));
  aoi21  g216(.a(new_n366_), .b(new_n365_), .c(new_n368_), .O(z54));
  inv1   g217(.a(x82), .O(new_n370_));
  nand3  g218(.a(new_n273_), .b(x84), .c(new_n370_), .O(new_n371_));
  inv1   g219(.a(x80), .O(new_n372_));
  nand4  g220(.a(new_n246_), .b(new_n161_), .c(new_n372_), .d(x79), .O(new_n373_));
  nor2   g221(.a(new_n373_), .b(new_n371_), .O(z55));
  nand2  g222(.a(new_n244_), .b(x76), .O(new_n375_));
  xnor2a g223(.a(x84), .b(x81), .O(new_n376_));
  aoi21  g224(.a(new_n168_), .b(new_n167_), .c(new_n376_), .O(new_n377_));
  nand2  g225(.a(new_n377_), .b(new_n153_), .O(new_n378_));
  nand2  g226(.a(new_n378_), .b(new_n375_), .O(new_n379_));
  nand2  g227(.a(new_n379_), .b(x79), .O(new_n380_));
  nand3  g228(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n381_));
  nand3  g229(.a(new_n381_), .b(new_n380_), .c(new_n242_), .O(z56));
  inv1   g230(.a(x02), .O(new_n383_));
  nand3  g231(.a(new_n242_), .b(x03), .c(new_n383_), .O(new_n384_));
  inv1   g232(.a(new_n384_), .O(z57));
  nand4  g233(.a(x80), .b(new_n231_), .c(x43), .d(new_n249_), .O(new_n386_));
  oai22  g234(.a(new_n386_), .b(new_n230_), .c(new_n249_), .d(x40), .O(new_n387_));
  nand3  g235(.a(new_n387_), .b(new_n236_), .c(x79), .O(new_n388_));
  nor2   g236(.a(x79), .b(x78), .O(new_n389_));
  nand3  g237(.a(new_n389_), .b(new_n249_), .c(x40), .O(new_n390_));
  nand2  g238(.a(new_n390_), .b(new_n388_), .O(new_n391_));
  nand2  g239(.a(new_n391_), .b(x77), .O(new_n392_));
  oai21  g240(.a(new_n367_), .b(new_n239_), .c(new_n154_), .O(new_n393_));
  aoi21  g241(.a(new_n393_), .b(new_n392_), .c(x01), .O(z58));
  inv1   g242(.a(new_n389_), .O(new_n395_));
  aoi21  g243(.a(new_n235_), .b(new_n395_), .c(new_n152_), .O(new_n396_));
  oai21  g244(.a(new_n232_), .b(new_n230_), .c(new_n249_), .O(new_n397_));
  aoi21  g245(.a(new_n397_), .b(x79), .c(new_n235_), .O(new_n398_));
  oai21  g246(.a(new_n398_), .b(new_n396_), .c(x77), .O(new_n399_));
  nor2   g247(.a(x79), .b(x04), .O(new_n400_));
  inv1   g248(.a(new_n400_), .O(new_n401_));
  aoi21  g249(.a(new_n401_), .b(new_n399_), .c(x01), .O(z59));
  aoi21  g250(.a(new_n377_), .b(x79), .c(new_n400_), .O(new_n403_));
  aoi21  g251(.a(new_n403_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g252(.a(new_n170_), .O(new_n405_));
  nand2  g253(.a(new_n168_), .b(new_n167_), .O(new_n406_));
  aoi22  g254(.a(new_n406_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n407_));
  nor3   g255(.a(new_n407_), .b(new_n405_), .c(new_n372_), .O(z61));
  nand3  g256(.a(x84), .b(x81), .c(x79), .O(new_n409_));
  oai21  g257(.a(x79), .b(new_n239_), .c(new_n409_), .O(new_n410_));
  nand2  g258(.a(new_n410_), .b(new_n159_), .O(new_n411_));
  nand2  g259(.a(new_n397_), .b(x79), .O(new_n412_));
  nand3  g260(.a(x81), .b(x79), .c(new_n239_), .O(new_n413_));
  inv1   g261(.a(new_n413_), .O(new_n414_));
  aoi21  g262(.a(new_n412_), .b(x04), .c(new_n414_), .O(new_n415_));
  oai21  g263(.a(new_n415_), .b(new_n159_), .c(new_n411_), .O(new_n416_));
  nand2  g264(.a(new_n416_), .b(x78), .O(new_n417_));
  inv1   g265(.a(new_n409_), .O(new_n418_));
  nand2  g266(.a(new_n418_), .b(new_n322_), .O(new_n419_));
  aoi21  g267(.a(new_n419_), .b(new_n417_), .c(x01), .O(z62));
  nor3   g268(.a(new_n407_), .b(new_n405_), .c(new_n370_), .O(z63));
  nand2  g269(.a(x83), .b(x79), .O(new_n422_));
  or2    g270(.a(new_n422_), .b(new_n407_), .O(new_n423_));
  aoi21  g271(.a(new_n423_), .b(new_n318_), .c(x01), .O(z64));
  nor2   g272(.a(new_n160_), .b(x04), .O(new_n425_));
  nor2   g273(.a(new_n253_), .b(x78), .O(new_n426_));
  oai21  g274(.a(new_n426_), .b(new_n425_), .c(x77), .O(new_n427_));
  nand2  g275(.a(new_n367_), .b(x81), .O(new_n428_));
  nand2  g276(.a(new_n170_), .b(x84), .O(new_n429_));
  aoi21  g277(.a(new_n428_), .b(new_n427_), .c(new_n429_), .O(z65));
  zero   g278(.O(z41));
endmodule
