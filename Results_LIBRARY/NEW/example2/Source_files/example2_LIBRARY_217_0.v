...
module FAU ( 
  ...
  nand2  g142(.a(new_n252_), .b(new_n243_), .O(new_n294_));
  ...
  and2   g148(.a(new_n299_), .b(new_n248_), .O(new_n300_));
  nand2  g149(.a(new_n296_), .b(x81), .O(new_n301_));
  nand3  g150(.a(x83), .b(new_n246_), .c(x42), .O(new_n302_));
  aoi21  g151(.a(new_n302_), .b(new_n301_), .c(new_n247_), .O(new_n303_));
  oai21  g152(.a(new_n303_), .b(new_n300_), .c(new_n252_), .O(new_n304_));
  ...
  nand4  g234(.a(x84), .b(x83), .c(new_n385_), .d(new_n246_), .O(new_n386_));
  ...
  oai22  g253(.a(new_n404_), .b(new_n251_), .c(x79), .d(x77), .O(new_n405_));
  ...
  nor2   g279(.a(new_n246_), .b(new_n154_), .O(new_n431_));
