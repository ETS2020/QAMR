...
module FAU ( 
  ...
  nand3  g171(.a(new_n227_), .b(new_n322_), .c(x79), .O(new_n323_));
  ...
  nand2  g176(.a(new_n327_), .b(new_n320_), .O(new_n328_));
  inv1   g177(.a(new_n323_), .O(new_n329_));
  ...
  nand2  g183(.a(new_n334_), .b(new_n320_), .O(new_n335_));
  ...
  nand2  g189(.a(new_n340_), .b(new_n320_), .O(new_n341_));
  ...
  nand2  g195(.a(new_n346_), .b(new_n320_), .O(new_n347_));
  ...
  nand2  g201(.a(new_n352_), .b(new_n320_), .O(new_n353_));
  ...
  nand3  g216(.a(new_n274_), .b(x84), .c(new_n367_), .O(new_n368_));
  inv1   g217(.a(x80), .O(new_n369_));
  nand4  g218(.a(new_n247_), .b(new_n161_), .c(new_n369_), .d(x79), .O(new_n370_));
  nor2   g219(.a(new_n370_), .b(new_n368_), .O(z55));
  nand2  g220(.a(new_n245_), .b(x76), .O(new_n372_));
  ...
  nand3  g227(.a(new_n378_), .b(new_n377_), .c(new_n243_), .O(z56));
  inv1   g228(.a(x02), .O(new_n380_));
  nand3  g229(.a(new_n243_), .b(x03), .c(new_n380_), .O(new_n381_));
  inv1   g230(.a(new_n381_), .O(z57));
  nand4  g231(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n383_));
  oai22  g232(.a(new_n383_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n384_));
  nand3  g233(.a(new_n384_), .b(new_n237_), .c(x79), .O(new_n385_));
  nor2   g234(.a(x79), .b(x78), .O(new_n386_));
  nand3  g235(.a(new_n386_), .b(new_n250_), .c(x40), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n385_), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(x77), .O(new_n389_));
  oai21  g238(.a(new_n364_), .b(new_n240_), .c(new_n154_), .O(new_n390_));
  aoi21  g239(.a(new_n390_), .b(new_n389_), .c(x01), .O(z58));
  inv1   g240(.a(new_n386_), .O(new_n392_));
  aoi21  g241(.a(new_n236_), .b(new_n392_), .c(new_n152_), .O(new_n393_));
  oai21  g242(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(x79), .c(new_n236_), .O(new_n395_));
  ...
  aoi21  g249(.a(new_n400_), .b(new_n238_), .c(x01), .O(z60));
  inv1   g250(.a(new_n170_), .O(new_n402_));
  nand2  g251(.a(new_n168_), .b(new_n167_), .O(new_n403_));
  aoi22  g252(.a(new_n403_), .b(new_n227_), .c(new_n161_), .d(new_n240_), .O(new_n404_));
  ...
  aoi21  g269(.a(new_n420_), .b(new_n319_), .c(x01), .O(z64));
