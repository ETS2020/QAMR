// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:07 2020
...
module FAU ( 
  ...
  oai21  g170(.a(x78), .b(new_n166_), .c(new_n321_), .O(new_n322_));
  nand4  g171(.a(new_n322_), .b(new_n226_), .c(x79), .d(x77), .O(new_n323_));
  ...
  inv1   g177(.a(new_n168_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x79), .O(new_n330_));
  inv1   g179(.a(new_n330_), .O(new_n331_));
  and2   g180(.a(new_n331_), .b(new_n226_), .O(new_n332_));
  ...
  nand2  g267(.a(new_n418_), .b(new_n329_), .O(new_n419_));
