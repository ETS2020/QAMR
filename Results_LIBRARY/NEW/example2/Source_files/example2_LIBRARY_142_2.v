...
module FAU ( 
  ...
  nor2   g178(.a(new_n154_), .b(x78), .O(new_n330_));
  nand2  g179(.a(new_n330_), .b(new_n226_), .O(new_n331_));
  nor2   g180(.a(new_n331_), .b(new_n159_), .O(new_n332_));
  ...
  nand3  g199(.a(new_n330_), .b(new_n226_), .c(x71), .O(new_n351_));
  ...
  nand2  g267(.a(new_n418_), .b(new_n321_), .O(new_n419_));
