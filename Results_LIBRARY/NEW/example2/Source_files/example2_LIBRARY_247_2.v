...
module FAU ( 
  ...
  nand4  g213(.a(new_n286_), .b(x14), .c(x04), .d(new_n153_), .O(new_n365_));
  nor3   g214(.a(new_n365_), .b(new_n167_), .c(x79), .O(z54));
  ...
  inv1   g238(.a(new_n167_), .O(new_n390_));
  oai21  g239(.a(new_n390_), .b(new_n239_), .c(new_n154_), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(new_n389_), .c(x01), .O(z58));
  inv1   g241(.a(new_n386_), .O(new_n393_));
  ...
  aoi21  g249(.a(new_n374_), .b(x79), .c(new_n398_), .O(new_n401_));
  ...
  aoi22  g253(.a(new_n404_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n405_));
  nor3   g254(.a(new_n405_), .b(new_n403_), .c(new_n369_), .O(z61));
  ...
  nor3   g267(.a(new_n405_), .b(new_n403_), .c(new_n367_), .O(z63));
  nand2  g268(.a(x83), .b(x79), .O(new_n420_));
  or2    g269(.a(new_n420_), .b(new_n405_), .O(new_n421_));
  aoi21  g270(.a(new_n421_), .b(new_n318_), .c(x01), .O(z64));
  ...
  nand2  g274(.a(new_n390_), .b(x81), .O(new_n426_));
