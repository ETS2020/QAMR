...
module FAU ( 
  ...
  oai21  g189(.a(x52), .b(x10), .c(new_n319_), .O(new_n341_));
  nand2  g190(.a(new_n332_), .b(x70), .O(new_n342_));
  ...
  nand2  g196(.a(new_n332_), .b(x71), .O(new_n348_));
  ...
  nand2  g201(.a(new_n352_), .b(new_n319_), .O(new_n353_));
  nand2  g202(.a(new_n332_), .b(x72), .O(new_n354_));
  ...
  nand2  g207(.a(new_n358_), .b(new_n319_), .O(new_n359_));
  nand2  g208(.a(new_n332_), .b(x73), .O(new_n360_));
  aoi21  g209(.a(new_n360_), .b(new_n359_), .c(x01), .O(z53));
  nand2  g210(.a(x52), .b(x22), .O(new_n362_));
  nand2  g211(.a(new_n286_), .b(x14), .O(new_n363_));
  inv1   g212(.a(new_n167_), .O(new_n364_));
  nand4  g213(.a(new_n364_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n365_));
  aoi21  g214(.a(new_n363_), .b(new_n362_), .c(new_n365_), .O(z54));
  ...
  oai21  g238(.a(new_n364_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g273(.a(new_n364_), .b(x81), .O(new_n425_));
