...
module FAU ( 
  ...
  nand3  g011(.a(new_n73_), .b(x27), .c(new_n63_), .O(new_n74_));
  ...
  oai21  g027(.a(new_n69_), .b(x28), .c(x35), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x27), .O(new_n91_));
  aoi21  g029(.a(x28), .b(x27), .c(x37), .O(z06));
  inv1   g030(.a(z06), .O(new_n93_));
  nand3  g031(.a(new_n93_), .b(new_n91_), .c(x21), .O(z03));
  nor2   g032(.a(z06), .b(x21), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n91_), .O(z04));
  oai21  g034(.a(new_n78_), .b(new_n87_), .c(new_n69_), .O(z05));
  ...
  nor2   g065(.a(new_n87_), .b(new_n64_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n79_), .c(new_n127_), .O(new_n129_));
  nand4  g067(.a(x35), .b(new_n78_), .c(x27), .d(new_n64_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n86_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n76_), .c(new_n126_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  nand2  g072(.a(x37), .b(new_n87_), .O(new_n135_));
  nand2  g073(.a(z08), .b(new_n64_), .O(new_n136_));
  nand2  g074(.a(new_n67_), .b(x27), .O(new_n137_));
  aoi21  g075(.a(new_n136_), .b(new_n70_), .c(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(x37), .c(new_n135_), .O(z12));
  ...
  nand4  g081(.a(new_n143_), .b(x39), .c(new_n140_), .d(new_n64_), .O(new_n144_));
  ...
  nand3  g087(.a(new_n120_), .b(new_n140_), .c(new_n64_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  nand3  g089(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n152_));
  nand4  g090(.a(new_n142_), .b(new_n77_), .c(new_n76_), .d(x28), .O(new_n153_));
  nand2  g091(.a(new_n140_), .b(new_n64_), .O(new_n154_));
  ...
  nand3  g095(.a(new_n69_), .b(new_n65_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n77_), .c(new_n76_), .O(new_n160_));
  oai22  g098(.a(new_n154_), .b(new_n110_), .c(new_n72_), .d(new_n87_), .O(new_n161_));
  ...
  oai21  g106(.a(new_n79_), .b(x27), .c(new_n127_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n130_), .c(new_n76_), .d(new_n126_), .O(z18));
  inv1   g109(.a(new_n127_), .O(new_n172_));
  oai21  g110(.a(new_n65_), .b(new_n87_), .c(new_n86_), .O(new_n173_));
  aoi21  g111(.a(x28), .b(new_n87_), .c(new_n65_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n76_), .c(new_n126_), .O(new_n176_));
