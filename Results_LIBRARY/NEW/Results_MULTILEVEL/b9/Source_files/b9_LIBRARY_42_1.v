...
module FAU ( 
  ...
  nor2   g032(.a(x37), .b(x28), .O(z06));
  inv1   g033(.a(z06), .O(z05));
  nand3  g034(.a(z05), .b(new_n94_), .c(x21), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  nand3  g036(.a(z05), .b(new_n94_), .c(new_n98_), .O(z04));
  ...
  nand2  g055(.a(new_n78_), .b(new_n77_), .O(new_n118_));
  nand4  g056(.a(new_n118_), .b(x40), .c(x39), .d(x05), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n66_), .O(new_n121_));
  ...
  nand2  g063(.a(x27), .b(x04), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(x35), .c(new_n64_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  inv1   g066(.a(x08), .O(new_n129_));
  nand4  g067(.a(x35), .b(new_n64_), .c(x27), .d(new_n66_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n77_), .c(new_n124_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  inv1   g072(.a(x27), .O(new_n135_));
  nor2   g073(.a(x37), .b(x36), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n65_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x37), .O(new_n138_));
  nand2  g076(.a(new_n93_), .b(new_n138_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n85_), .b(x04), .c(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n137_), .b(x10), .c(new_n141_), .O(z12));
  inv1   g080(.a(x18), .O(new_n143_));
  inv1   g081(.a(x19), .O(new_n144_));
  nand2  g082(.a(new_n93_), .b(new_n73_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(new_n64_), .b(x27), .O(new_n148_));
  nand3  g086(.a(x36), .b(x35), .c(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(new_n148_), .c(new_n78_), .d(new_n77_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x40), .c(x39), .d(new_n147_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(x04), .c(new_n146_), .O(z13));
  nand3  g090(.a(x20), .b(new_n144_), .c(new_n143_), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  nand3  g094(.a(z08), .b(new_n147_), .c(new_n66_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n156_), .c(new_n153_), .O(new_n158_));
  nand3  g096(.a(new_n138_), .b(new_n65_), .c(x28), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n78_), .c(new_n77_), .O(new_n161_));
  nand2  g099(.a(new_n157_), .b(new_n140_), .O(new_n162_));
  ...
  oai21  g107(.a(new_n65_), .b(x27), .c(new_n125_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n130_), .c(new_n77_), .d(new_n124_), .O(z18));
  oai21  g110(.a(new_n65_), .b(new_n135_), .c(new_n129_), .O(new_n173_));
  nand2  g111(.a(new_n125_), .b(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n77_), .c(new_n124_), .O(new_n176_));
