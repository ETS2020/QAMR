...
module FAU ( 
  ...
  oai21  g108(.a(new_n84_), .b(x27), .c(new_n130_), .O(new_n171_));
  ...
  nand2  g116(.a(x28), .b(new_n64_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n177_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n81_), .c(new_n128_), .O(new_n181_));
