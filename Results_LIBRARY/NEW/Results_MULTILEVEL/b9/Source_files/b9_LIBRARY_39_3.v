...
module FAU ( 
  ...
  aoi21  g073(.a(new_n132_), .b(x27), .c(x09), .O(new_n136_));
  nor2   g074(.a(new_n128_), .b(new_n65_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n134_), .c(x30), .O(z11));
  inv1   g077(.a(x10), .O(new_n140_));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  nor2   g079(.a(new_n128_), .b(x27), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  nand2  g081(.a(z08), .b(new_n65_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n71_), .c(new_n70_), .O(new_n145_));
  nand3  g083(.a(x40), .b(x39), .c(new_n65_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n64_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n143_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n128_), .O(new_n151_));
  ...
  nand3  g095(.a(new_n121_), .b(new_n149_), .c(new_n65_), .O(new_n158_));
  ...
  nand2  g099(.a(new_n149_), .b(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x40), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n161_), .c(z08), .O(new_n164_));
  ...
  oai21  g106(.a(new_n142_), .b(new_n73_), .c(new_n162_), .O(new_n169_));
  oai21  g107(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n165_), .O(z14));
  ...
  oai22  g116(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n127_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n64_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n132_), .c(x30), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n180_), .c(new_n178_), .O(z18));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n135_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n129_), .c(new_n184_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n178_), .O(new_n187_));
  nor2   g125(.a(new_n185_), .b(new_n128_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n119_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n187_), .c(x30), .O(z20));
  aoi21  g128(.a(new_n138_), .b(new_n134_), .c(x30), .O(z19));
endmodule
