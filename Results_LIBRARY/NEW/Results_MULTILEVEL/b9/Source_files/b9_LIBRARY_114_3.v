...
module FAU ( 
  ...
  nand2  g028(.a(z08), .b(x02), .O(new_n91_));
  inv1   g029(.a(new_n91_), .O(new_n92_));
  oai21  g030(.a(new_n90_), .b(new_n65_), .c(new_n92_), .O(z02));
  ...
  nand2  g065(.a(new_n64_), .b(new_n89_), .O(new_n128_));
  nand2  g066(.a(x27), .b(x04), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(new_n128_), .c(x35), .d(new_n83_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n81_), .c(new_n127_), .O(new_n131_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(new_n133_), .O(new_n137_));
  nand2  g075(.a(z08), .b(new_n65_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n71_), .c(new_n70_), .O(new_n139_));
  nand3  g077(.a(x40), .b(x39), .c(new_n65_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n64_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n139_), .c(new_n137_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x28), .c(new_n135_), .O(new_n145_));
  ...
  nand2  g093(.a(new_n143_), .b(new_n65_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x40), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(z08), .O(new_n158_));
  ...
  oai21  g100(.a(new_n136_), .b(new_n73_), .c(new_n156_), .O(new_n163_));
  oai21  g101(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n159_), .O(z14));
  ...
  oai21  g110(.a(x27), .b(new_n89_), .c(new_n172_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x35), .c(new_n83_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n127_), .O(z18));
  aoi21  g113(.a(new_n83_), .b(x08), .c(x27), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n66_), .c(new_n81_), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(x09), .O(z20));
