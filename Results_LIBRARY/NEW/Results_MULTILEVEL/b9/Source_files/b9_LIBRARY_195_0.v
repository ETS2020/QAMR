...
module FAU ( 
  ...
  nand2  g067(.a(x40), .b(x04), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(x35), .c(new_n83_), .d(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n81_), .c(new_n125_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  inv1   g073(.a(x10), .O(new_n136_));
  nor3   g074(.a(x37), .b(x36), .c(x35), .O(new_n137_));
  inv1   g075(.a(x40), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(x27), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n137_), .c(new_n136_), .O(new_n140_));
  nand2  g078(.a(z08), .b(new_n65_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n71_), .c(new_n70_), .O(new_n142_));
  nand3  g080(.a(x40), .b(x39), .c(new_n65_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n64_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n142_), .c(new_n140_), .O(z12));
  ...
  nand4  g092(.a(new_n119_), .b(x39), .c(new_n146_), .d(new_n65_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand3  g094(.a(x39), .b(new_n146_), .c(new_n65_), .O(new_n157_));
  ...
  nand3  g099(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n162_));
  nand4  g100(.a(new_n147_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n130_), .c(x39), .d(new_n146_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g103(.a(new_n130_), .b(x39), .O(new_n166_));
  nand2  g104(.a(new_n119_), .b(new_n146_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n64_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n165_), .c(new_n161_), .O(z14));
  ...
  oai21  g113(.a(new_n84_), .b(x27), .c(new_n126_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  inv1   g115(.a(new_n84_), .O(new_n178_));
  nor2   g116(.a(new_n64_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(x30), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n177_), .c(new_n125_), .O(z18));
  inv1   g119(.a(new_n126_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n129_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n81_), .c(new_n125_), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z20));
  inv1   g125(.a(new_n134_), .O(z19));
endmodule
