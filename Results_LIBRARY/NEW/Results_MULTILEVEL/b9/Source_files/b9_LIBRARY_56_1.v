...
module FAU ( 
  ...
  nor2   g021(.a(new_n68_), .b(x28), .O(new_n84_));
  aoi21  g022(.a(new_n83_), .b(new_n81_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g028(.a(x35), .b(new_n82_), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n90_), .c(x04), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n89_), .c(z08), .O(z02));
  ...
  nand2  g052(.a(new_n91_), .b(new_n67_), .O(new_n115_));
  ...
  oai21  g069(.a(new_n131_), .b(new_n91_), .c(new_n130_), .O(new_n132_));
  inv1   g070(.a(x08), .O(new_n133_));
  nand4  g071(.a(x35), .b(new_n82_), .c(x27), .d(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n129_), .c(new_n128_), .O(new_n137_));
  ...
  nand3  g091(.a(new_n122_), .b(new_n144_), .c(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n156_));
  nand4  g094(.a(new_n146_), .b(new_n81_), .c(new_n129_), .d(x28), .O(new_n157_));
  ...
  nand3  g100(.a(new_n162_), .b(new_n81_), .c(new_n129_), .O(new_n163_));
  ...
  oai21  g109(.a(new_n91_), .b(x27), .c(new_n130_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n134_), .c(new_n129_), .d(new_n128_), .O(z18));
  ...
  nand3  g116(.a(new_n178_), .b(new_n129_), .c(new_n128_), .O(new_n179_));
