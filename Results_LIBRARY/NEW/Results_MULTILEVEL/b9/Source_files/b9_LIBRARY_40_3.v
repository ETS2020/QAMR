...
module FAU ( 
  ...
  nand3  g055(.a(new_n117_), .b(new_n82_), .c(x27), .O(new_n118_));
  ...
  oai21  g084(.a(new_n94_), .b(x19), .c(new_n92_), .O(new_n147_));
  ...
  nand2  g090(.a(x20), .b(new_n146_), .O(new_n153_));
  nand4  g091(.a(new_n143_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n154_));
  ...
  nand3  g095(.a(new_n94_), .b(new_n66_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n79_), .c(new_n78_), .O(new_n160_));
  inv1   g098(.a(x19), .O(new_n161_));
  nand2  g099(.a(x27), .b(new_n161_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n70_), .c(new_n156_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n160_), .c(new_n157_), .O(z14));
  ...
  oai21  g108(.a(new_n81_), .b(x27), .c(new_n128_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n132_), .c(new_n78_), .d(new_n127_), .O(z18));
  inv1   g111(.a(new_n128_), .O(new_n174_));
  oai21  g112(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n175_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n78_), .c(new_n127_), .O(new_n178_));
