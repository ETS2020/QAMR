...
module FAU ( 
  ...
  oai21  g005(.a(new_n66_), .b(x10), .c(new_n67_), .O(new_n68_));
  ...
  oai21  g055(.a(new_n75_), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  ...
  oai21  g068(.a(new_n130_), .b(new_n85_), .c(new_n129_), .O(new_n131_));
  nand2  g069(.a(x40), .b(x04), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(x35), .c(new_n84_), .d(x27), .O(new_n133_));
  ...
  nand3  g093(.a(new_n122_), .b(new_n146_), .c(new_n65_), .O(new_n156_));
  ...
  nor2   g104(.a(new_n147_), .b(x27), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n73_), .c(new_n160_), .O(new_n168_));
  oai21  g106(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .d(new_n163_), .O(z14));
