...
module FAU ( 
  ...
  nor2   g027(.a(new_n89_), .b(new_n65_), .O(new_n90_));
  ...
  nand2  g055(.a(new_n83_), .b(new_n82_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(x40), .c(x39), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n117_), .c(new_n116_), .O(new_n120_));
  ...
  oai21  g063(.a(new_n125_), .b(new_n120_), .c(new_n65_), .O(new_n126_));
  ...
  nand2  g069(.a(new_n131_), .b(new_n89_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g071(.a(new_n89_), .b(x27), .c(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n92_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n82_), .c(new_n129_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n73_), .b(new_n64_), .c(new_n141_), .O(new_n142_));
  oai21  g080(.a(new_n140_), .b(x10), .c(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x28), .c(new_n76_), .O(new_n146_));
  ...
  nor2   g090(.a(new_n119_), .b(x13), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(z13));
  nand3  g093(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n156_));
  nand4  g094(.a(new_n145_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n157_));
  ...
  nand2  g111(.a(new_n89_), .b(new_n64_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n130_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n134_), .c(new_n82_), .d(new_n129_), .O(z18));
  inv1   g115(.a(new_n130_), .O(new_n178_));
  ...
  nand3  g119(.a(new_n181_), .b(new_n82_), .c(new_n129_), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z20));
  inv1   g121(.a(new_n137_), .O(z19));
endmodule
