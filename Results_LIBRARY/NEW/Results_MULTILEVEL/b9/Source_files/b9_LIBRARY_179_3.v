...
module FAU ( 
  ...
  nand4  g080(.a(new_n142_), .b(x40), .c(x39), .d(new_n65_), .O(new_n143_));
  ...
  nand2  g086(.a(new_n121_), .b(new_n65_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand4  g088(.a(x27), .b(x20), .c(new_n145_), .d(new_n144_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n73_), .c(new_n138_), .O(new_n152_));
  nand3  g090(.a(x20), .b(new_n145_), .c(new_n144_), .O(new_n153_));
  nor2   g091(.a(x37), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n153_), .b(new_n141_), .c(new_n154_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n83_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n82_), .c(new_n81_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n152_), .O(z14));
  ...
  oai21  g102(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n131_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g105(.a(new_n128_), .O(new_n168_));
  oai21  g106(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n169_));
  aoi21  g107(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n81_), .c(new_n127_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z20));
  inv1   g111(.a(new_n134_), .O(z19));
endmodule
