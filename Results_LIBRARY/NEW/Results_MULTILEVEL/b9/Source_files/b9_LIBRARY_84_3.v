...
module FAU ( 
  ...
  oai21  g061(.a(new_n123_), .b(new_n90_), .c(new_n85_), .O(new_n124_));
  inv1   g062(.a(x40), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n86_), .c(new_n123_), .O(new_n126_));
  oai21  g064(.a(new_n90_), .b(new_n64_), .c(new_n78_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  inv1   g066(.a(x39), .O(new_n129_));
  nand2  g067(.a(x40), .b(new_n129_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(new_n126_), .d(new_n124_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n76_), .c(new_n122_), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(z11));
  nand2  g071(.a(x40), .b(new_n69_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x27), .O(new_n135_));
  oai21  g073(.a(new_n129_), .b(x04), .c(new_n135_), .O(new_n136_));
  oai21  g074(.a(x37), .b(x36), .c(x27), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x40), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n72_), .b(new_n125_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n136_), .O(z12));
  inv1   g078(.a(x18), .O(new_n141_));
  inv1   g079(.a(x19), .O(new_n142_));
  nand4  g080(.a(new_n71_), .b(x20), .c(new_n142_), .d(new_n141_), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(z08), .c(new_n78_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  inv1   g085(.a(x13), .O(new_n148_));
  nor2   g086(.a(x32), .b(x30), .O(new_n149_));
  nor2   g087(.a(new_n149_), .b(new_n125_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n64_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n147_), .O(z13));
  nand4  g090(.a(new_n134_), .b(x20), .c(new_n142_), .d(new_n141_), .O(new_n153_));
  nand2  g091(.a(new_n149_), .b(x28), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n144_), .c(x39), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nor2   g094(.a(x19), .b(x18), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n71_), .c(x27), .d(x20), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n125_), .O(new_n159_));
  oai21  g097(.a(x32), .b(x30), .c(new_n64_), .O(new_n160_));
  oai21  g098(.a(new_n125_), .b(new_n148_), .c(x39), .O(new_n161_));
  ...
  oai22  g107(.a(new_n109_), .b(new_n86_), .c(new_n79_), .d(x27), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nor2   g109(.a(new_n90_), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n80_), .c(x30), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n171_), .c(new_n122_), .O(z18));
  nand3  g112(.a(new_n125_), .b(x28), .c(new_n90_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n130_), .c(new_n126_), .d(new_n124_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n76_), .c(new_n122_), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(z20));
  inv1   g116(.a(new_n132_), .O(z19));
endmodule
