...
module FAU ( 
  ...
  aoi21  g027(.a(new_n64_), .b(x04), .c(new_n89_), .O(new_n90_));
  nand2  g028(.a(new_n84_), .b(x04), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(new_n90_), .c(x40), .d(x39), .O(z02));
  ...
  nand4  g067(.a(new_n129_), .b(new_n127_), .c(x35), .d(new_n83_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n81_), .c(new_n126_), .O(new_n131_));
  ...
  nand3  g089(.a(new_n120_), .b(new_n143_), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  inv1   g091(.a(new_n136_), .O(new_n154_));
  nor2   g092(.a(x19), .b(x18), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n154_), .c(new_n72_), .d(x20), .O(new_n156_));
  oai21  g094(.a(x13), .b(x04), .c(new_n156_), .O(new_n157_));
  nand3  g095(.a(new_n155_), .b(x27), .c(x20), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n73_), .c(new_n75_), .O(new_n159_));
  ...
  nand3  g101(.a(new_n163_), .b(new_n82_), .c(new_n81_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n159_), .c(new_n157_), .O(z14));
  ...
  oai21  g110(.a(x27), .b(new_n128_), .c(new_n172_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x35), .c(new_n83_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n126_), .O(z18));
