...
module FAU ( 
  ...
  nand3  g080(.a(x36), .b(x35), .c(x28), .O(new_n143_));
  oai21  g081(.a(x28), .b(x13), .c(new_n143_), .O(new_n144_));
  ...
  nand4  g094(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand4  g096(.a(x37), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g098(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n67_), .c(new_n82_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n81_), .c(x28), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n160_), .c(new_n156_), .d(new_n155_), .O(z14));
  ...
  oai21  g109(.a(new_n84_), .b(x27), .c(new_n129_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g112(.a(new_n129_), .O(new_n175_));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n175_), .c(new_n176_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n81_), .c(new_n128_), .O(new_n179_));
