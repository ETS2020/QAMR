// Benchmark "FAU" written by ABC on Mon Jul 27 18:20:13 2020
...
module FAU ( 
  ...
  nand3  g023(.a(new_n85_), .b(new_n83_), .c(x39), .O(z02));
  ...
  nand4  g076(.a(new_n138_), .b(x39), .c(new_n136_), .d(new_n112_), .O(new_n139_));
  ...
  nand3  g085(.a(x39), .b(new_n136_), .c(new_n112_), .O(new_n148_));
