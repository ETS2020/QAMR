...
module FAU ( 
  ...
  oai22  g028(.a(new_n90_), .b(x02), .c(x27), .d(new_n65_), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g030(.a(new_n84_), .b(x40), .c(x04), .O(new_n93_));
  nand3  g031(.a(new_n93_), .b(new_n92_), .c(z08), .O(z02));
  ...
  nand3  g072(.a(new_n134_), .b(new_n81_), .c(new_n128_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  nor2   g076(.a(new_n90_), .b(x27), .O(new_n139_));
  ...
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n90_), .O(new_n148_));
  ...
  nand3  g092(.a(new_n122_), .b(new_n146_), .c(new_n65_), .O(new_n155_));
  ...
  oai21  g112(.a(new_n84_), .b(x27), .c(new_n75_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  inv1   g114(.a(new_n84_), .O(new_n177_));
  nor2   g115(.a(new_n64_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(x30), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n176_), .c(new_n128_), .O(z18));
  oai21  g118(.a(new_n66_), .b(new_n64_), .c(new_n89_), .O(new_n181_));
  aoi21  g119(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(z08), .c(new_n181_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n81_), .c(new_n128_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z20));
  inv1   g123(.a(new_n135_), .O(z19));
endmodule
