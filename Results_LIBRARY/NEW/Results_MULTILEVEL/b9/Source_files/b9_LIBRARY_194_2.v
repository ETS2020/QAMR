...
module FAU ( 
  ...
  nand2  g095(.a(x20), .b(new_n152_), .O(new_n158_));
  nand4  g096(.a(new_n148_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x39), .O(new_n160_));
  oai21  g098(.a(new_n158_), .b(x18), .c(new_n160_), .O(new_n161_));
  nand2  g099(.a(x27), .b(x20), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x19), .c(x40), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n72_), .c(new_n151_), .O(new_n164_));
  ...
  aoi22  g106(.a(new_n168_), .b(new_n81_), .c(new_n158_), .d(new_n139_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n166_), .c(new_n165_), .d(new_n161_), .O(z14));
