...
module FAU ( 
  ...
  aoi21  g084(.a(new_n146_), .b(x28), .c(new_n93_), .O(new_n147_));
  ...
  nand3  g091(.a(new_n126_), .b(new_n145_), .c(new_n65_), .O(new_n154_));
  ...
  oai21  g111(.a(new_n84_), .b(x27), .c(new_n133_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n136_), .c(new_n81_), .d(new_n132_), .O(z18));
  inv1   g114(.a(new_n133_), .O(new_n177_));
  oai21  g115(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n178_));
  aoi21  g116(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(new_n178_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n81_), .c(new_n132_), .O(new_n181_));
