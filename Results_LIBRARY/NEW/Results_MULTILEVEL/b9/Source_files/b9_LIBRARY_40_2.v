...
module FAU ( 
  ...
  nor2   g085(.a(new_n70_), .b(new_n147_), .O(new_n148_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  nand3  g093(.a(z08), .b(new_n140_), .c(new_n65_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n155_), .c(new_n147_), .d(x18), .O(new_n157_));
  nand2  g095(.a(x27), .b(new_n146_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n70_), .c(new_n156_), .O(new_n159_));
  nand2  g097(.a(new_n142_), .b(x19), .O(new_n160_));
  nand3  g098(.a(new_n93_), .b(new_n66_), .c(x28), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n79_), .c(new_n78_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n159_), .c(new_n157_), .O(z14));
