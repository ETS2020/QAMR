// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:48 2020
...
module FAU ( 
  ...
  oai21  g036(.a(new_n82_), .b(new_n64_), .c(new_n70_), .O(z05));
  nand3  g037(.a(x28), .b(x27), .c(x13), .O(new_n100_));
  and2   g038(.a(new_n100_), .b(new_n70_), .O(z06));
  ...
  nand4  g070(.a(x35), .b(new_n82_), .c(x27), .d(new_n65_), .O(new_n133_));
  ...
  oai22  g077(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n140_));
  oai21  g078(.a(new_n139_), .b(x10), .c(new_n140_), .O(z12));
  ...
  nand3  g083(.a(z08), .b(new_n145_), .c(new_n65_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand4  g086(.a(new_n122_), .b(x39), .c(new_n145_), .d(new_n65_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  aoi21  g088(.a(new_n70_), .b(new_n82_), .c(new_n64_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x20), .c(new_n143_), .d(new_n142_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  nor2   g091(.a(x37), .b(x35), .O(new_n154_));
  aoi22  g092(.a(new_n154_), .b(x13), .c(new_n121_), .d(new_n64_), .O(new_n155_));
  ...
  oai21  g100(.a(new_n83_), .b(x27), .c(new_n129_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g103(.a(new_n129_), .O(new_n166_));
  oai21  g104(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n167_));
  aoi21  g105(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(new_n167_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n128_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(z20));
  inv1   g109(.a(new_n136_), .O(z19));
endmodule
