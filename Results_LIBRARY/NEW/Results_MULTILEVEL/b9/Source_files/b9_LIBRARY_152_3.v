// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:55 2020
...
module FAU ( 
  ...
  nor2   g067(.a(new_n129_), .b(x09), .O(new_n130_));
  nor2   g068(.a(new_n128_), .b(x39), .O(new_n131_));
  nor2   g069(.a(new_n66_), .b(x28), .O(new_n132_));
  oai21  g070(.a(new_n64_), .b(new_n65_), .c(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n131_), .b(new_n130_), .c(new_n133_), .O(new_n134_));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(new_n132_), .b(x27), .c(new_n65_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n91_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n134_), .c(x30), .O(z11));
  nor2   g076(.a(x37), .b(x36), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n140_));
  oai22  g078(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n141_));
  oai21  g079(.a(new_n140_), .b(x10), .c(new_n141_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x28), .c(new_n128_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n146_));
  ...
  nand3  g089(.a(new_n121_), .b(new_n143_), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand3  g091(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n154_));
  nand4  g092(.a(new_n144_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  nand3  g094(.a(z08), .b(new_n143_), .c(new_n65_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n156_), .c(new_n154_), .O(new_n158_));
  nand3  g096(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n82_), .c(new_n81_), .O(new_n161_));
  nand3  g099(.a(new_n157_), .b(new_n71_), .c(new_n70_), .O(new_n162_));
  nand4  g100(.a(x40), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n64_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n162_), .c(new_n161_), .d(new_n158_), .O(z14));
  ...
  oai22  g109(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n127_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n136_), .c(new_n81_), .d(new_n135_), .O(z18));
  oai21  g112(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n129_), .c(new_n175_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n135_), .O(new_n178_));
  nor2   g116(.a(new_n176_), .b(new_n128_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n119_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n178_), .c(x30), .O(z20));
  aoi21  g119(.a(new_n137_), .b(new_n134_), .c(x30), .O(z19));
endmodule
