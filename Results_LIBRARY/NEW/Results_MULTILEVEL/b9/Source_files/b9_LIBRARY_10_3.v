...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n95_, new_n97_, new_n98_, new_n102_, new_n103_, new_n104_,
  ...
  oai21  g032(.a(new_n70_), .b(x27), .c(new_n83_), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(x21), .O(z03));
  nand2  g034(.a(new_n71_), .b(x27), .O(new_n97_));
  aoi21  g035(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n97_), .O(z04));
  ...
  nand2  g077(.a(new_n72_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n75_), .b(x04), .c(new_n140_), .O(new_n141_));
  ...
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n147_));
  ...
  nand3  g090(.a(new_n122_), .b(new_n143_), .c(new_n65_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand3  g092(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n155_));
  nand4  g093(.a(new_n145_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  nand3  g095(.a(z08), .b(new_n143_), .c(new_n65_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n155_), .O(new_n159_));
  nand3  g097(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n82_), .c(new_n81_), .O(new_n162_));
  nand2  g100(.a(new_n158_), .b(new_n140_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n159_), .O(z14));
  ...
  oai21  g108(.a(new_n84_), .b(x27), .c(new_n129_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g111(.a(new_n129_), .O(new_n174_));
  oai21  g112(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n175_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n128_), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z20));
  inv1   g117(.a(new_n136_), .O(z19));
endmodule
