...
module FAU ( 
  ...
  nand2  g057(.a(x40), .b(x32), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n81_), .c(new_n119_), .O(new_n121_));
  ...
  nor2   g065(.a(new_n119_), .b(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(x30), .c(x40), .O(new_n129_));
  inv1   g067(.a(new_n84_), .O(new_n130_));
  oai21  g068(.a(new_n64_), .b(new_n65_), .c(new_n130_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nor2   g070(.a(new_n64_), .b(x04), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n130_), .c(x30), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n91_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(x09), .O(z11));
  ...
  inv1   g113(.a(x09), .O(new_n176_));
  oai22  g114(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n127_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n134_), .c(new_n176_), .O(z18));
  oai21  g117(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n128_), .c(new_n180_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n81_), .O(new_n183_));
  or2    g121(.a(new_n181_), .b(x40), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x09), .O(z20));
  aoi21  g123(.a(new_n135_), .b(new_n132_), .c(x09), .O(z19));
endmodule
