...
module FAU ( 
  ...
  aoi21  g067(.a(new_n129_), .b(x35), .c(x09), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(x28), .c(new_n128_), .O(new_n131_));
  inv1   g069(.a(x08), .O(new_n132_));
  nor2   g070(.a(new_n66_), .b(new_n64_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n65_), .c(x09), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(x28), .c(new_n132_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n131_), .c(x30), .O(z11));
  ...
  nand3  g089(.a(new_n122_), .b(new_n142_), .c(new_n65_), .O(new_n152_));
  ...
  nand2  g114(.a(new_n128_), .b(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n133_), .b(x08), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n170_), .O(new_n179_));
  nand3  g117(.a(new_n128_), .b(x28), .c(new_n64_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(x30), .O(z20));
  aoi21  g119(.a(new_n135_), .b(new_n131_), .c(x30), .O(z19));
endmodule
