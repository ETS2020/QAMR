...
module FAU ( 
  ...
  nand3  g071(.a(new_n84_), .b(x27), .c(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n91_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n81_), .c(new_n130_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nor2   g076(.a(x37), .b(x36), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n83_), .c(x40), .d(new_n64_), .O(new_n140_));
  ...
  oai21  g083(.a(new_n144_), .b(x28), .c(new_n145_), .O(new_n146_));
  ...
  nand3  g090(.a(new_n125_), .b(new_n143_), .c(new_n65_), .O(new_n153_));
  ...
  nand3  g097(.a(new_n70_), .b(new_n83_), .c(x28), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n82_), .c(new_n81_), .O(new_n162_));
  nand3  g100(.a(new_n158_), .b(new_n71_), .c(new_n70_), .O(new_n163_));
  nand4  g101(.a(x40), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n64_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n163_), .c(new_n162_), .d(new_n159_), .O(z14));
  ...
  nand2  g110(.a(new_n84_), .b(new_n64_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n131_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n134_), .c(new_n81_), .d(new_n130_), .O(z18));
  inv1   g114(.a(new_n131_), .O(new_n177_));
  oai21  g115(.a(new_n83_), .b(new_n64_), .c(new_n91_), .O(new_n178_));
  aoi21  g116(.a(x28), .b(new_n64_), .c(new_n83_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(new_n178_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n81_), .c(new_n130_), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z20));
  inv1   g120(.a(new_n137_), .O(z19));
endmodule
