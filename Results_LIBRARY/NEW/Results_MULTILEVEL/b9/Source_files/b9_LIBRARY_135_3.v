...
module FAU ( 
  ...
  aoi21  g070(.a(new_n129_), .b(x27), .c(x30), .O(new_n133_));
  nor2   g071(.a(new_n125_), .b(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n131_), .c(x09), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  nor2   g076(.a(new_n125_), .b(x27), .O(new_n139_));
  ...
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n125_), .O(new_n148_));
  ...
  nand3  g093(.a(new_n155_), .b(z08), .c(x32), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n158_));
  nand3  g096(.a(new_n147_), .b(new_n82_), .c(x28), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n155_), .c(x40), .d(x39), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g099(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n162_));
  oai21  g100(.a(x30), .b(x27), .c(new_n162_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n82_), .O(new_n164_));
  oai22  g102(.a(new_n139_), .b(new_n73_), .c(x13), .d(x04), .O(new_n165_));
  oai21  g103(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n161_), .O(z14));
  ...
  oai22  g112(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n124_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n64_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n129_), .c(x30), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n176_), .c(new_n174_), .O(z18));
  oai21  g117(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n126_), .c(new_n180_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n81_), .O(new_n183_));
  inv1   g121(.a(x39), .O(new_n184_));
  nor2   g122(.a(new_n181_), .b(new_n125_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n183_), .c(x09), .O(z20));
  aoi21  g125(.a(new_n135_), .b(new_n131_), .c(x09), .O(z19));
endmodule
