...
module FAU ( 
  ...
  aoi22  g075(.a(new_n137_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n138_));
  oai22  g076(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n139_));
  ...
  nand4  g099(.a(x40), .b(x39), .c(new_n141_), .d(new_n65_), .O(new_n162_));
  ...
  nand3  g111(.a(new_n173_), .b(new_n134_), .c(new_n171_), .O(z18));
  oai21  g112(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n128_), .c(new_n175_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n81_), .O(new_n178_));
  or2    g116(.a(new_n176_), .b(x40), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(x09), .O(z20));
  aoi21  g118(.a(new_n135_), .b(new_n132_), .c(x09), .O(z19));
endmodule
