...
module FAU ( 
  ...
  nand2  g053(.a(x39), .b(x05), .O(new_n116_));
  nand2  g054(.a(new_n75_), .b(x07), .O(new_n117_));
  nand3  g055(.a(new_n117_), .b(new_n116_), .c(x40), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n86_), .c(x27), .O(new_n119_));
  ...
  nand4  g069(.a(new_n131_), .b(x35), .c(new_n84_), .d(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n92_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n82_), .c(new_n127_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  nor2   g076(.a(new_n76_), .b(x27), .O(new_n139_));
  ...
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n76_), .O(new_n148_));
  ...
  nand3  g092(.a(new_n121_), .b(new_n146_), .c(new_n65_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand3  g094(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n157_));
  nand4  g095(.a(new_n147_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n158_));
  nand2  g096(.a(new_n146_), .b(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x40), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n158_), .c(z08), .O(new_n161_));
  ...
  oai21  g103(.a(new_n139_), .b(new_n73_), .c(new_n159_), .O(new_n166_));
  oai22  g104(.a(new_n73_), .b(new_n64_), .c(new_n76_), .d(new_n75_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(new_n162_), .O(z14));
  ...
  oai21  g112(.a(new_n85_), .b(x27), .c(new_n128_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  inv1   g114(.a(new_n85_), .O(new_n177_));
  nor2   g115(.a(new_n64_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(x30), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n176_), .c(new_n127_), .O(z18));
  inv1   g118(.a(new_n128_), .O(new_n181_));
  oai21  g119(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n182_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n82_), .c(new_n127_), .O(new_n185_));
  inv1   g123(.a(new_n185_), .O(z20));
  inv1   g124(.a(new_n135_), .O(z19));
endmodule
