...
module FAU ( 
  ...
  nand3  g066(.a(z08), .b(x29), .c(x08), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n81_), .c(new_n128_), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(z11));
  nor2   g069(.a(x37), .b(x36), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n66_), .c(new_n64_), .O(new_n133_));
  nand2  g071(.a(new_n72_), .b(x27), .O(new_n134_));
  oai21  g072(.a(new_n75_), .b(x04), .c(new_n134_), .O(new_n135_));
  ...
  nand3  g084(.a(new_n122_), .b(new_n137_), .c(new_n65_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  nand3  g086(.a(x20), .b(new_n143_), .c(new_n142_), .O(new_n149_));
  nand4  g087(.a(new_n139_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  nand3  g089(.a(z08), .b(new_n137_), .c(new_n65_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n149_), .O(new_n153_));
  nand3  g091(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n82_), .c(new_n81_), .O(new_n156_));
  nand2  g094(.a(new_n152_), .b(new_n134_), .O(new_n157_));
  ...
  nand3  g102(.a(new_n129_), .b(new_n81_), .c(new_n128_), .O(z18));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n129_), .c(new_n81_), .d(new_n128_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z20));
  inv1   g106(.a(new_n130_), .O(z19));
endmodule
