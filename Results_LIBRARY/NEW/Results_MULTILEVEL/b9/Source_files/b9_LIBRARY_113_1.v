// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:46 2020
...
module FAU ( 
  ...
  nand3  g052(.a(new_n84_), .b(x27), .c(x07), .O(new_n115_));
  nand2  g053(.a(new_n83_), .b(new_n82_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(x40), .c(x39), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  nand2  g056(.a(x40), .b(new_n75_), .O(new_n119_));
  nand2  g057(.a(new_n76_), .b(x07), .O(new_n120_));
  ...
  oai21  g061(.a(new_n123_), .b(new_n118_), .c(new_n65_), .O(new_n124_));
  ...
  nor2   g066(.a(new_n66_), .b(x28), .O(new_n129_));
  ...
  inv1   g071(.a(x28), .O(new_n134_));
  nand2  g072(.a(x40), .b(x04), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n134_), .d(x27), .O(new_n136_));
  ...
  nor2   g096(.a(new_n117_), .b(x13), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(z13));
  nand3  g099(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n162_));
  nand4  g100(.a(new_n151_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n163_));
  nand2  g101(.a(new_n150_), .b(new_n65_), .O(new_n164_));
  ...
  oai22  g109(.a(new_n73_), .b(new_n64_), .c(new_n76_), .d(new_n75_), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n167_), .O(z14));
  ...
  nand2  g117(.a(new_n129_), .b(new_n64_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n128_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n64_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n129_), .c(x30), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n182_), .c(new_n127_), .O(z18));
  inv1   g123(.a(new_n128_), .O(new_n186_));
  oai21  g124(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n82_), .c(new_n127_), .O(new_n190_));
