...
module FAU ( 
  ...
  nand2  g032(.a(new_n71_), .b(new_n66_), .O(new_n95_));
  ...
  nand2  g052(.a(new_n90_), .b(x07), .O(new_n115_));
  ...
  nand2  g061(.a(new_n123_), .b(new_n64_), .O(new_n124_));
  ...
  nor2   g066(.a(new_n66_), .b(new_n64_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n80_), .c(new_n128_), .O(new_n130_));
  inv1   g068(.a(x08), .O(new_n131_));
  nand4  g069(.a(x35), .b(new_n79_), .c(x27), .d(new_n64_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n77_), .c(new_n127_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z11));
  nor2   g074(.a(x37), .b(x36), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n70_), .c(new_n66_), .O(new_n138_));
  nand2  g076(.a(new_n93_), .b(new_n71_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n90_), .b(x04), .c(new_n140_), .O(new_n141_));
  ...
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n143_), .d(new_n64_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand4  g087(.a(new_n139_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand3  g090(.a(new_n121_), .b(new_n143_), .c(new_n64_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand3  g092(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n155_));
  nand4  g093(.a(new_n145_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  nand3  g095(.a(z08), .b(new_n143_), .c(new_n64_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n155_), .O(new_n159_));
  oai21  g097(.a(new_n72_), .b(new_n79_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n78_), .c(new_n77_), .O(new_n161_));
  nand2  g099(.a(new_n158_), .b(new_n140_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n161_), .c(new_n159_), .O(z14));
  ...
  oai21  g107(.a(new_n80_), .b(x27), .c(new_n128_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n132_), .c(new_n77_), .d(new_n127_), .O(z18));
  inv1   g110(.a(new_n128_), .O(new_n173_));
  oai21  g111(.a(new_n70_), .b(new_n66_), .c(new_n131_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n66_), .c(new_n70_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n77_), .c(new_n127_), .O(new_n177_));
