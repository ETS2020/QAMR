...
module FAU ( 
  ...
  nand4  g058(.a(new_n120_), .b(x40), .c(x39), .d(x05), .O(new_n121_));
  ...
  nor2   g080(.a(new_n66_), .b(x13), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(z08), .c(x36), .d(new_n65_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x27), .O(new_n146_));
  inv1   g084(.a(x13), .O(new_n147_));
  nand4  g085(.a(new_n120_), .b(x40), .c(x39), .d(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(x04), .c(new_n146_), .O(z13));
  nand3  g087(.a(x20), .b(new_n141_), .c(new_n140_), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n82_), .c(new_n81_), .O(new_n152_));
  ...
  oai21  g093(.a(x37), .b(x35), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n153_), .b(new_n120_), .c(z08), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g096(.a(new_n70_), .b(new_n83_), .O(new_n159_));
  ...
  oai21  g104(.a(new_n84_), .b(x27), .c(new_n127_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n131_), .c(new_n81_), .d(new_n126_), .O(z18));
  inv1   g107(.a(new_n127_), .O(new_n170_));
  oai21  g108(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n171_));
  aoi21  g109(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n171_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n126_), .O(new_n174_));
