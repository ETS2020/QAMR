...
module FAU ( 
  ...
  nand3  g056(.a(z08), .b(x32), .c(x05), .O(new_n119_));
  ...
  inv1   g061(.a(x29), .O(new_n124_));
  inv1   g062(.a(x40), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(x30), .O(new_n127_));
  nor2   g065(.a(new_n125_), .b(x39), .O(new_n128_));
  nor2   g066(.a(new_n66_), .b(x28), .O(new_n129_));
  oai21  g067(.a(new_n64_), .b(new_n65_), .c(new_n129_), .O(new_n130_));
  oai21  g068(.a(new_n128_), .b(new_n127_), .c(new_n130_), .O(new_n131_));
  nor2   g069(.a(new_n64_), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n129_), .c(x30), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n131_), .c(x09), .O(z11));
  ...
  aoi21  g079(.a(new_n141_), .b(x28), .c(new_n125_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(x39), .c(new_n140_), .d(new_n65_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n149_), .b(z08), .c(x32), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n148_), .O(z13));
  nand3  g089(.a(x20), .b(new_n145_), .c(new_n144_), .O(new_n152_));
  nand3  g090(.a(new_n141_), .b(new_n82_), .c(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  nand2  g092(.a(new_n149_), .b(z08), .O(new_n155_));
  ...
  nand2  g096(.a(new_n158_), .b(new_n82_), .O(new_n159_));
  ...
  oai22  g108(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n124_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n133_), .c(new_n170_), .O(z18));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n126_), .c(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n81_), .O(new_n177_));
  inv1   g115(.a(x39), .O(new_n178_));
  nor2   g116(.a(new_n175_), .b(new_n125_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n177_), .c(x09), .O(z20));
  aoi21  g119(.a(new_n134_), .b(new_n131_), .c(x09), .O(z19));
endmodule
