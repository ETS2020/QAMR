// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:57 2020
...
module FAU ( 
  ...
  aoi21  g054(.a(new_n75_), .b(x27), .c(new_n76_), .O(new_n117_));
  nand4  g055(.a(x40), .b(x39), .c(x27), .d(x05), .O(new_n118_));
  oai21  g056(.a(new_n117_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  inv1   g057(.a(x05), .O(new_n120_));
  oai21  g058(.a(x32), .b(x30), .c(x40), .O(new_n121_));
  nor3   g059(.a(new_n121_), .b(new_n75_), .c(new_n120_), .O(new_n122_));
  aoi21  g060(.a(new_n119_), .b(new_n86_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(x04), .c(new_n124_), .O(z10));
  inv1   g063(.a(x09), .O(new_n126_));
  nand2  g064(.a(new_n64_), .b(new_n92_), .O(new_n127_));
  nand2  g065(.a(x39), .b(x29), .O(new_n128_));
  nor2   g066(.a(new_n64_), .b(new_n65_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n85_), .c(new_n128_), .O(new_n130_));
  oai22  g068(.a(new_n85_), .b(x04), .c(new_n76_), .d(new_n92_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n127_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n82_), .c(new_n126_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  inv1   g072(.a(x10), .O(new_n135_));
  nor3   g073(.a(x37), .b(x36), .c(x35), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n64_), .c(new_n135_), .O(new_n137_));
  oai22  g075(.a(new_n73_), .b(new_n64_), .c(new_n75_), .d(x04), .O(new_n138_));
  nand3  g076(.a(new_n71_), .b(new_n76_), .c(new_n70_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x28), .c(new_n76_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(x39), .c(new_n141_), .d(new_n65_), .O(new_n144_));
  ...
  nor2   g087(.a(new_n121_), .b(new_n75_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n141_), .c(new_n65_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  nand3  g090(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n153_));
  nand4  g091(.a(new_n142_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n154_));
  oai21  g092(.a(x13), .b(x04), .c(x39), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(z08), .O(new_n156_));
  ...
  nand3  g097(.a(new_n159_), .b(new_n83_), .c(new_n82_), .O(new_n160_));
  nand3  g098(.a(z08), .b(new_n141_), .c(new_n65_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n71_), .c(new_n70_), .O(new_n162_));
  nand3  g100(.a(x39), .b(new_n141_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n64_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(z14));
  ...
  nand2  g109(.a(z08), .b(x29), .O(new_n172_));
  oai21  g110(.a(new_n85_), .b(x27), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  inv1   g112(.a(new_n85_), .O(new_n175_));
  nor2   g113(.a(new_n64_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(x30), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n174_), .c(new_n126_), .O(z18));
  oai21  g116(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n179_));
  oai21  g117(.a(new_n84_), .b(x27), .c(x35), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n128_), .O(new_n181_));
  nand2  g119(.a(new_n76_), .b(new_n66_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n181_), .c(new_n179_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n82_), .c(new_n126_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z20));
  inv1   g123(.a(new_n133_), .O(z19));
endmodule
