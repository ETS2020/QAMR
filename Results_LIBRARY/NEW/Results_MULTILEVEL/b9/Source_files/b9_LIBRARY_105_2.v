...
module FAU ( 
  ...
  oai21  g066(.a(new_n128_), .b(x09), .c(x40), .O(new_n129_));
  ...
  nand3  g071(.a(new_n130_), .b(x27), .c(new_n65_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n91_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(x30), .O(z11));
  ...
  oai22  g113(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n127_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n134_), .c(new_n81_), .d(new_n133_), .O(z18));
  oai21  g116(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n179_));
  aoi21  g117(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n128_), .c(new_n179_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n133_), .O(new_n182_));
  or2    g120(.a(new_n180_), .b(x40), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x30), .O(z20));
  aoi21  g122(.a(new_n135_), .b(new_n132_), .c(x30), .O(z19));
endmodule
