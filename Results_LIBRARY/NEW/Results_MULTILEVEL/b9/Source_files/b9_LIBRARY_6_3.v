// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:22 2020
...
module FAU ( 
  ...
  nand2  g019(.a(new_n68_), .b(x27), .O(new_n82_));
  aoi22  g020(.a(new_n82_), .b(new_n81_), .c(new_n67_), .d(x28), .O(new_n83_));
  oai21  g021(.a(new_n83_), .b(x32), .c(x04), .O(z01));
  ...
  nand3  g029(.a(new_n91_), .b(new_n87_), .c(z08), .O(z02));
  ...
  nand2  g051(.a(new_n90_), .b(new_n67_), .O(new_n114_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n114_), .c(x27), .O(new_n118_));
  ...
  nand2  g065(.a(x27), .b(x04), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(x35), .c(x30), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(x28), .c(new_n127_), .O(new_n130_));
  inv1   g068(.a(x08), .O(new_n131_));
  nor2   g069(.a(new_n66_), .b(new_n64_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n65_), .c(x30), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(x28), .c(new_n131_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n130_), .c(x09), .O(z11));
  nor2   g073(.a(x37), .b(x36), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n66_), .c(new_n64_), .O(new_n137_));
  nand2  g075(.a(new_n72_), .b(x27), .O(new_n138_));
  oai21  g076(.a(new_n75_), .b(x04), .c(new_n138_), .O(new_n139_));
  oai21  g077(.a(new_n137_), .b(x10), .c(new_n139_), .O(z12));
  ...
  nand4  g082(.a(new_n144_), .b(x39), .c(new_n141_), .d(new_n65_), .O(new_n145_));
  ...
  nand3  g088(.a(new_n121_), .b(new_n141_), .c(new_n65_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n153_));
  inv1   g091(.a(x32), .O(new_n154_));
  nand3  g092(.a(new_n143_), .b(new_n154_), .c(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  nand3  g094(.a(z08), .b(new_n141_), .c(new_n65_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n156_), .c(new_n153_), .O(new_n158_));
  nand3  g096(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n159_));
  oai21  g097(.a(x30), .b(x27), .c(new_n159_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n154_), .O(new_n161_));
  nand2  g099(.a(new_n157_), .b(new_n138_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n161_), .c(new_n158_), .O(z14));
  ...
  inv1   g107(.a(x09), .O(new_n170_));
  oai21  g108(.a(new_n90_), .b(x27), .c(new_n127_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  inv1   g110(.a(new_n90_), .O(new_n173_));
  nor2   g111(.a(new_n64_), .b(x04), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(x30), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n172_), .c(new_n170_), .O(z18));
  nand2  g114(.a(new_n127_), .b(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n132_), .b(x08), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n81_), .O(new_n179_));
  nand3  g117(.a(new_n127_), .b(x28), .c(new_n64_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(x09), .O(z20));
  aoi21  g119(.a(new_n134_), .b(new_n130_), .c(x09), .O(z19));
endmodule
