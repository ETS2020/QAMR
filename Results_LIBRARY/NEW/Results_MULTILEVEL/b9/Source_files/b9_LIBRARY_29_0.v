...
module FAU ( 
  ...
  nand2  g065(.a(new_n127_), .b(x39), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n123_), .c(new_n65_), .O(new_n130_));
  ...
  oai22  g073(.a(new_n135_), .b(new_n84_), .c(new_n119_), .d(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n136_), .c(x40), .O(new_n140_));
  ...
  nor2   g082(.a(new_n125_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n143_), .O(new_n146_));
  oai22  g084(.a(new_n73_), .b(new_n64_), .c(new_n119_), .d(x04), .O(new_n147_));
  oai21  g085(.a(x37), .b(x35), .c(x27), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n125_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n146_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  oai21  g089(.a(new_n67_), .b(new_n66_), .c(x28), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n153_));
  ...
  nand4  g096(.a(new_n127_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n159_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n73_), .c(new_n161_), .O(new_n163_));
  nand2  g101(.a(new_n126_), .b(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(x40), .c(x37), .O(new_n165_));
  nand4  g103(.a(new_n162_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n66_), .O(new_n168_));
  inv1   g106(.a(x36), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x40), .O(new_n171_));
  nor2   g109(.a(new_n126_), .b(x04), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(x40), .c(x39), .d(new_n151_), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n64_), .c(new_n171_), .d(new_n162_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n168_), .c(new_n163_), .O(z14));
  nand4  g113(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z15));
  nand2  g115(.a(x22), .b(x01), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(x23), .O(z16));
  inv1   g117(.a(x23), .O(new_n180_));
  nor3   g118(.a(new_n178_), .b(x24), .c(new_n180_), .O(z17));
  oai22  g119(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n134_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n138_), .c(new_n81_), .d(new_n133_), .O(z18));
  nor2   g122(.a(new_n119_), .b(new_n134_), .O(new_n185_));
  oai22  g123(.a(new_n125_), .b(new_n137_), .c(new_n66_), .d(new_n64_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n81_), .c(new_n133_), .O(new_n189_));
