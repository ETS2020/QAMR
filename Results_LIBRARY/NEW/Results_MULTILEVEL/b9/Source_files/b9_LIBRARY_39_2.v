...
module FAU ( 
  ...
  oai22  g108(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n127_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n134_), .c(new_n81_), .d(new_n133_), .O(z18));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n128_), .c(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n133_), .O(new_n177_));
  or2    g115(.a(new_n175_), .b(x40), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(x30), .O(z20));
  aoi21  g117(.a(new_n135_), .b(new_n132_), .c(x30), .O(z19));
endmodule
