...
module FAU ( 
  ...
  inv1   g028(.a(new_n90_), .O(z08));
  nand3  g029(.a(z08), .b(new_n89_), .c(new_n87_), .O(z02));
  nand2  g030(.a(new_n71_), .b(x27), .O(new_n93_));
  nand2  g031(.a(new_n70_), .b(new_n66_), .O(new_n94_));
  ...
  nand2  g051(.a(new_n90_), .b(x07), .O(new_n114_));
  nand3  g052(.a(x40), .b(x39), .c(x05), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n81_), .c(x27), .O(new_n117_));
  ...
  nor2   g065(.a(new_n66_), .b(new_n64_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n80_), .c(new_n127_), .O(new_n129_));
  inv1   g067(.a(x08), .O(new_n130_));
  nand4  g068(.a(x35), .b(new_n79_), .c(x27), .d(new_n64_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n77_), .c(new_n126_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  inv1   g073(.a(x35), .O(new_n136_));
  nor2   g074(.a(x37), .b(x36), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(new_n66_), .O(new_n138_));
  oai21  g076(.a(new_n90_), .b(x04), .c(new_n73_), .O(new_n139_));
  oai21  g077(.a(new_n138_), .b(x10), .c(new_n139_), .O(z12));
  ...
  nand4  g082(.a(new_n144_), .b(x39), .c(new_n141_), .d(new_n64_), .O(new_n145_));
  ...
  nand3  g088(.a(new_n120_), .b(new_n141_), .c(new_n64_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n153_));
  nand4  g091(.a(new_n143_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  nand3  g093(.a(z08), .b(new_n141_), .c(new_n64_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n155_), .c(new_n153_), .O(new_n157_));
  nand3  g095(.a(new_n70_), .b(new_n136_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n78_), .c(new_n77_), .O(new_n160_));
  nand2  g098(.a(new_n156_), .b(new_n73_), .O(new_n161_));
  ...
  oai21  g106(.a(new_n80_), .b(x27), .c(new_n127_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n131_), .c(new_n77_), .d(new_n126_), .O(z18));
  inv1   g109(.a(new_n127_), .O(new_n172_));
  oai21  g110(.a(new_n136_), .b(new_n66_), .c(new_n130_), .O(new_n173_));
  aoi21  g111(.a(x28), .b(new_n66_), .c(new_n136_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n77_), .c(new_n126_), .O(new_n176_));
