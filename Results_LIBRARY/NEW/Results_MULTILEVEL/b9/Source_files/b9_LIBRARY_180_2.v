...
module FAU ( 
  ...
  aoi21  g080(.a(x39), .b(new_n65_), .c(x37), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n140_), .c(new_n71_), .O(new_n144_));
  oai21  g082(.a(new_n75_), .b(x04), .c(new_n64_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n142_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n140_), .O(new_n149_));
  ...
  nand4  g098(.a(x40), .b(x39), .c(new_n147_), .d(new_n65_), .O(new_n161_));
  ...
  nand3  g103(.a(x39), .b(new_n147_), .c(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n70_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x40), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n71_), .O(new_n169_));
  nand4  g107(.a(x40), .b(x39), .c(new_n147_), .d(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n64_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n169_), .c(new_n165_), .d(new_n162_), .O(z14));
  ...
  oai21  g116(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  inv1   g118(.a(new_n84_), .O(new_n181_));
  nor2   g119(.a(new_n64_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(x30), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n180_), .c(new_n127_), .O(z18));
  inv1   g122(.a(new_n128_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n81_), .c(new_n127_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z20));
  inv1   g128(.a(new_n136_), .O(z19));
endmodule
