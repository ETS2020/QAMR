...
module FAU ( 
  ...
  aoi22  g078(.a(z08), .b(new_n65_), .c(x35), .d(x28), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n70_), .O(new_n142_));
  ...
  nand3  g083(.a(new_n119_), .b(x40), .c(x39), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x40), .c(x39), .d(new_n65_), .O(new_n149_));
  ...
  oai21  g092(.a(new_n146_), .b(x04), .c(new_n154_), .O(z13));
  nand4  g093(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n156_));
  inv1   g094(.a(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n141_), .c(new_n70_), .O(new_n158_));
  nand3  g096(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n159_));
  nand4  g097(.a(new_n147_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n143_), .c(new_n159_), .O(new_n162_));
  nand2  g100(.a(x40), .b(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n119_), .b(x39), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(new_n64_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n162_), .c(new_n158_), .O(z14));
