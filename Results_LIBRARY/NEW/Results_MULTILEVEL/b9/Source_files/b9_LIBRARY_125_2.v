...
module FAU ( 
  ...
  oai21  g048(.a(new_n110_), .b(x25), .c(new_n109_), .O(new_n111_));
  aoi21  g049(.a(new_n111_), .b(new_n108_), .c(new_n102_), .O(z07));
  ...
  nand4  g069(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n132_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n66_), .c(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n72_), .b(x27), .O(new_n139_));
  oai21  g077(.a(new_n75_), .b(x04), .c(new_n139_), .O(new_n140_));
  oai21  g078(.a(new_n138_), .b(x10), .c(new_n140_), .O(z12));
  ...
  nand3  g089(.a(new_n121_), .b(new_n142_), .c(new_n65_), .O(new_n152_));
  ...
  nand3  g094(.a(z08), .b(new_n142_), .c(new_n65_), .O(new_n157_));
  ...
  nand2  g099(.a(new_n157_), .b(new_n139_), .O(new_n162_));
  ...
  nand4  g109(.a(new_n171_), .b(new_n132_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g110(.a(new_n128_), .O(new_n173_));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n174_));
