...
module FAU ( 
  ...
  oai22  g054(.a(new_n75_), .b(new_n115_), .c(x39), .d(new_n116_), .O(new_n117_));
  ...
  nor2   g077(.a(new_n139_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n138_), .c(new_n137_), .O(new_n141_));
  nand2  g079(.a(z08), .b(new_n65_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n71_), .c(new_n70_), .O(new_n143_));
  ...
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n139_), .O(new_n149_));
  ...
  nand3  g093(.a(new_n121_), .b(new_n147_), .c(new_n65_), .O(new_n156_));
  ...
  nand2  g097(.a(new_n147_), .b(new_n65_), .O(new_n160_));
  ...
  oai21  g104(.a(new_n140_), .b(new_n73_), .c(new_n160_), .O(new_n167_));
