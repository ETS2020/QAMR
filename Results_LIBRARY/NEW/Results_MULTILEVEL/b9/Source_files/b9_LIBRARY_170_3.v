...
module FAU ( 
  ...
  nand3  g028(.a(new_n90_), .b(new_n88_), .c(z08), .O(z02));
  nor3   g029(.a(new_n66_), .b(new_n64_), .c(x04), .O(new_n92_));
  nor2   g030(.a(x37), .b(new_n65_), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n92_), .c(new_n80_), .O(new_n94_));
  oai21  g032(.a(x37), .b(new_n66_), .c(x27), .O(new_n95_));
  ...
  nand2  g054(.a(new_n72_), .b(x07), .O(new_n117_));
  ...
  oai21  g069(.a(new_n131_), .b(new_n81_), .c(new_n130_), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n80_), .c(x27), .d(new_n65_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(x08), .c(new_n132_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n78_), .c(new_n129_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nor2   g075(.a(x37), .b(x36), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n66_), .c(new_n64_), .O(new_n139_));
  oai22  g077(.a(new_n72_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n140_));
  ...
  nor2   g087(.a(new_n70_), .b(new_n149_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n147_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n123_), .b(new_n142_), .c(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n156_));
  nand2  g094(.a(new_n142_), .b(new_n65_), .O(new_n157_));
  nand4  g095(.a(new_n67_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(z08), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(new_n156_), .O(new_n160_));
  oai21  g098(.a(x35), .b(new_n80_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n79_), .c(new_n78_), .O(new_n162_));
  oai22  g100(.a(new_n157_), .b(new_n72_), .c(new_n70_), .d(new_n64_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n160_), .O(z14));
  ...
  oai21  g108(.a(new_n81_), .b(x27), .c(new_n130_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n133_), .c(new_n78_), .d(new_n129_), .O(z18));
  nor2   g111(.a(new_n66_), .b(new_n64_), .O(new_n174_));
  ...
  nand3  g115(.a(new_n177_), .b(new_n78_), .c(new_n129_), .O(new_n178_));
