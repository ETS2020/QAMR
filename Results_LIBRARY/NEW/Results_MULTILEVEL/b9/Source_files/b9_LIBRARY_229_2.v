...
module FAU ( 
  ...
  nand3  g089(.a(x39), .b(new_n140_), .c(new_n65_), .O(new_n152_));
  nand4  g090(.a(x27), .b(x20), .c(new_n146_), .d(new_n145_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n73_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n155_));
  nor2   g093(.a(x37), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n155_), .b(new_n142_), .c(new_n156_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n83_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n82_), .c(new_n81_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n154_), .c(x40), .O(z14));
  ...
  oai21  g104(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n131_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g107(.a(new_n128_), .O(new_n170_));
  oai21  g108(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n171_));
  aoi21  g109(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n171_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n127_), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(z20));
  inv1   g113(.a(new_n134_), .O(z19));
endmodule
