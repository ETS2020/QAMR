...
module FAU ( 
  ...
  nand2  g026(.a(new_n72_), .b(x18), .O(new_n89_));
  inv1   g027(.a(x18), .O(new_n90_));
  inv1   g028(.a(x19), .O(new_n91_));
  nor2   g029(.a(new_n70_), .b(new_n64_), .O(new_n92_));
  nand4  g030(.a(new_n92_), .b(x20), .c(new_n91_), .d(new_n90_), .O(new_n93_));
  ...
  nand2  g035(.a(x20), .b(new_n91_), .O(new_n98_));
  oai21  g036(.a(new_n98_), .b(new_n70_), .c(new_n97_), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n96_), .c(new_n95_), .O(new_n100_));
  inv1   g038(.a(new_n100_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n93_), .c(new_n89_), .d(new_n88_), .O(z02));
  ...
  oai22  g088(.a(new_n150_), .b(new_n92_), .c(new_n149_), .d(x10), .O(z12));
  ...
  nand4  g094(.a(new_n156_), .b(x20), .c(new_n91_), .d(new_n90_), .O(new_n157_));
  ...
  nand4  g104(.a(new_n166_), .b(new_n164_), .c(new_n162_), .d(new_n89_), .O(z14));
