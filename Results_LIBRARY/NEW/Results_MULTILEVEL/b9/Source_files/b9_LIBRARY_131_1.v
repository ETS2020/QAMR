...
module FAU ( 
  ...
  nand4  g096(.a(new_n149_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n159_));
  nand2  g097(.a(new_n148_), .b(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x40), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(z08), .O(new_n162_));
  oai21  g100(.a(x19), .b(x18), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n141_), .b(new_n73_), .c(new_n160_), .O(new_n167_));
  inv1   g105(.a(x20), .O(new_n168_));
  nand2  g106(.a(new_n72_), .b(x27), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n75_), .c(new_n168_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n167_), .c(new_n166_), .d(new_n163_), .O(z14));
