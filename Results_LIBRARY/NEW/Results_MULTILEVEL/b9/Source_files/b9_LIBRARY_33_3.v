...
module FAU ( 
  ...
  aoi21  g015(.a(z08), .b(new_n75_), .c(new_n73_), .O(new_n78_));
  oai21  g016(.a(new_n72_), .b(new_n63_), .c(new_n78_), .O(z00));
  ...
  nand2  g031(.a(new_n69_), .b(new_n63_), .O(new_n94_));
  ...
  nand2  g051(.a(new_n76_), .b(x07), .O(new_n114_));
  ...
  nor2   g056(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n132_), .b(x35), .c(new_n127_), .d(x27), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n80_), .c(new_n125_), .O(new_n136_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n138_), .c(new_n74_), .O(new_n141_));
  nand2  g079(.a(z08), .b(new_n64_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n70_), .c(new_n69_), .O(new_n143_));
  nand3  g081(.a(x40), .b(x39), .c(new_n64_), .O(new_n144_));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n64_), .O(new_n150_));
  ...
  nand3  g093(.a(new_n119_), .b(new_n147_), .c(new_n64_), .O(new_n156_));
  ...
  nand2  g097(.a(new_n147_), .b(new_n64_), .O(new_n160_));
  ...
  nand3  g101(.a(new_n69_), .b(new_n82_), .c(x28), .O(new_n164_));
  ...
  oai21  g105(.a(new_n140_), .b(new_n167_), .c(new_n160_), .O(new_n168_));
  oai21  g106(.a(new_n167_), .b(new_n63_), .c(new_n76_), .O(new_n169_));
  ...
  nor2   g114(.a(new_n82_), .b(x28), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n63_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n126_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n63_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n177_), .c(x30), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n180_), .c(new_n125_), .O(z18));
  inv1   g121(.a(new_n126_), .O(new_n184_));
  oai21  g122(.a(new_n82_), .b(new_n63_), .c(new_n131_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n63_), .c(new_n82_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n80_), .c(new_n125_), .O(new_n188_));
