...
module FAU ( 
  ...
  aoi21  g027(.a(new_n66_), .b(x04), .c(new_n89_), .O(new_n90_));
  ...
  nand2  g052(.a(new_n84_), .b(new_n67_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x39), .c(x05), .O(new_n116_));
  nand2  g054(.a(new_n75_), .b(x36), .O(new_n117_));
  inv1   g055(.a(x39), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(x35), .c(new_n83_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(x07), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n116_), .c(new_n64_), .O(new_n122_));
  ...
  nand2  g064(.a(new_n126_), .b(x39), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n122_), .c(new_n65_), .O(new_n129_));
  ...
  oai22  g072(.a(new_n134_), .b(new_n84_), .c(new_n118_), .d(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand3  g074(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n135_), .c(x40), .O(new_n139_));
  ...
  nor2   g081(.a(new_n124_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  oai22  g083(.a(new_n73_), .b(new_n64_), .c(new_n118_), .d(x04), .O(new_n146_));
  oai21  g084(.a(x37), .b(x35), .c(x27), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n124_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n145_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  oai21  g088(.a(new_n67_), .b(new_n66_), .c(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n152_));
  ...
  nand4  g095(.a(new_n126_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n160_));
  nand3  g098(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n73_), .c(new_n160_), .O(new_n162_));
  nand2  g100(.a(new_n125_), .b(x28), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x40), .c(x37), .O(new_n164_));
  nand4  g102(.a(new_n161_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(new_n66_), .O(new_n167_));
  inv1   g105(.a(x36), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x40), .O(new_n170_));
  nor2   g108(.a(new_n125_), .b(x04), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(x40), .c(x39), .d(new_n150_), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n64_), .c(new_n170_), .d(new_n161_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n167_), .c(new_n162_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(z15));
  nand2  g114(.a(x22), .b(x01), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(x23), .O(z16));
  inv1   g116(.a(x23), .O(new_n179_));
  nor3   g117(.a(new_n177_), .b(x24), .c(new_n179_), .O(z17));
  oai22  g118(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n133_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n137_), .c(new_n81_), .d(new_n132_), .O(z18));
  nor2   g121(.a(new_n118_), .b(new_n133_), .O(new_n184_));
  oai22  g122(.a(new_n124_), .b(new_n136_), .c(new_n66_), .d(new_n64_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n81_), .c(new_n132_), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z20));
  inv1   g127(.a(new_n140_), .O(z19));
endmodule
