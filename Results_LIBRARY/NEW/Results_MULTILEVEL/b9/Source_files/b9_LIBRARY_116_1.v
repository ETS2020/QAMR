...
module FAU ( 
  ...
  inv1   g066(.a(new_n91_), .O(new_n129_));
  nand3  g067(.a(new_n82_), .b(x27), .c(x04), .O(new_n130_));
  oai21  g068(.a(new_n129_), .b(x30), .c(new_n130_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  inv1   g070(.a(x08), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n82_), .c(x27), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n81_), .O(new_n135_));
  oai21  g073(.a(x28), .b(new_n65_), .c(new_n135_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n132_), .c(x09), .O(z11));
  ...
  nand4  g095(.a(new_n146_), .b(new_n157_), .c(new_n81_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  nand3  g097(.a(z08), .b(new_n144_), .c(new_n65_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n156_), .O(new_n161_));
  nand3  g099(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n157_), .c(new_n81_), .O(new_n164_));
  ...
  inv1   g110(.a(x09), .O(new_n173_));
  oai21  g111(.a(new_n91_), .b(x27), .c(new_n128_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n64_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n129_), .c(x30), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n175_), .c(new_n173_), .O(z18));
  inv1   g116(.a(new_n128_), .O(new_n179_));
  oai21  g117(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n179_), .c(new_n180_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n81_), .c(new_n173_), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z20));
  aoi21  g122(.a(new_n137_), .b(new_n132_), .c(x09), .O(z19));
endmodule
