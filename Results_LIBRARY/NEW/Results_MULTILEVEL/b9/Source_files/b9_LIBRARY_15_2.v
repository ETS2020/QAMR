...
module FAU ( 
  ...
  nand3  g055(.a(new_n117_), .b(new_n83_), .c(x27), .O(new_n118_));
  ...
  nand2  g065(.a(new_n91_), .b(new_n87_), .O(new_n128_));
  oai21  g066(.a(new_n75_), .b(new_n88_), .c(x28), .O(new_n129_));
  ...
  nand3  g070(.a(new_n132_), .b(new_n81_), .c(new_n127_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  nor2   g072(.a(x37), .b(x36), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n66_), .c(new_n64_), .O(new_n136_));
  nand2  g074(.a(new_n72_), .b(x27), .O(new_n137_));
  oai21  g075(.a(new_n75_), .b(x04), .c(new_n137_), .O(new_n138_));
  ...
  nand2  g097(.a(new_n155_), .b(new_n137_), .O(new_n160_));
  ...
  nand2  g105(.a(new_n89_), .b(z08), .O(new_n168_));
  nand3  g106(.a(new_n90_), .b(x27), .c(new_n65_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n81_), .d(new_n127_), .O(z18));
  nand2  g108(.a(x35), .b(x27), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n168_), .c(new_n81_), .d(new_n127_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z20));
  inv1   g111(.a(new_n133_), .O(z19));
endmodule
