...
module FAU ( 
  ...
  nand3  g075(.a(new_n137_), .b(new_n81_), .c(new_n129_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  nor2   g077(.a(x37), .b(x36), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n66_), .c(new_n64_), .O(new_n141_));
  nand2  g079(.a(new_n72_), .b(x27), .O(new_n142_));
  oai21  g080(.a(new_n75_), .b(x04), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g092(.a(new_n123_), .b(new_n145_), .c(new_n65_), .O(new_n155_));
  ...
  nand3  g097(.a(z08), .b(new_n145_), .c(new_n65_), .O(new_n160_));
  ...
  nand2  g102(.a(new_n160_), .b(new_n142_), .O(new_n165_));
  ...
  oai21  g110(.a(new_n84_), .b(x27), .c(new_n130_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n135_), .c(new_n81_), .d(new_n129_), .O(z18));
  inv1   g113(.a(new_n130_), .O(new_n176_));
  oai21  g114(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n177_));
  aoi21  g115(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n177_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n81_), .c(new_n129_), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z20));
  inv1   g119(.a(new_n138_), .O(z19));
endmodule
