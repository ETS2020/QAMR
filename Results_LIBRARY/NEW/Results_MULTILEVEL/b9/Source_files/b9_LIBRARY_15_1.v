...
module FAU ( 
  ...
  nor3   g066(.a(new_n66_), .b(new_n64_), .c(x04), .O(new_n129_));
  ...
  oai21  g070(.a(new_n129_), .b(x08), .c(new_n132_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n81_), .c(new_n128_), .O(new_n134_));
  ...
  nand3  g088(.a(new_n122_), .b(new_n141_), .c(new_n65_), .O(new_n151_));
  ...
  oai21  g106(.a(new_n84_), .b(x27), .c(new_n130_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  inv1   g108(.a(new_n84_), .O(new_n171_));
  nor2   g109(.a(new_n64_), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(x30), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n170_), .c(new_n128_), .O(z18));
  nor2   g112(.a(new_n66_), .b(new_n64_), .O(new_n175_));
  inv1   g113(.a(new_n130_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai22  g115(.a(new_n177_), .b(new_n176_), .c(new_n175_), .d(x08), .O(new_n178_));
