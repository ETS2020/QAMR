...
module FAU ( 
  ...
  nand4  g052(.a(new_n68_), .b(x40), .c(x39), .d(x05), .O(new_n115_));
  oai21  g053(.a(new_n66_), .b(x28), .c(new_n67_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n75_), .c(x07), .O(new_n117_));
  ...
  aoi21  g064(.a(x27), .b(x04), .c(new_n66_), .O(new_n127_));
  nand2  g065(.a(z08), .b(x29), .O(new_n128_));
  inv1   g066(.a(new_n128_), .O(new_n129_));
  inv1   g067(.a(x08), .O(new_n130_));
  nand3  g068(.a(x35), .b(x27), .c(new_n65_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  oai21  g070(.a(new_n129_), .b(new_n127_), .c(new_n132_), .O(new_n133_));
  ...
  nor2   g084(.a(new_n121_), .b(x13), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n65_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(z13));
  nand4  g087(.a(x27), .b(x20), .c(new_n141_), .d(new_n140_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n73_), .c(new_n144_), .O(new_n151_));
  oai21  g089(.a(new_n120_), .b(x27), .c(new_n151_), .O(z14));
  ...
  nor2   g096(.a(new_n66_), .b(x27), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n129_), .c(x08), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n131_), .c(new_n81_), .d(new_n126_), .O(z18));
  oai21  g099(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n162_));
  oai21  g100(.a(new_n129_), .b(x35), .c(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n81_), .c(new_n126_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z20));
  inv1   g103(.a(new_n134_), .O(z19));
endmodule
