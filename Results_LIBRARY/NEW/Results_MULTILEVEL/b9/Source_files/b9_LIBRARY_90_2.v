...
module FAU ( 
  ...
  nand3  g028(.a(new_n90_), .b(x40), .c(new_n89_), .O(new_n91_));
  ...
  nand2  g053(.a(new_n84_), .b(new_n67_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(x39), .c(x05), .O(new_n117_));
  nand2  g055(.a(new_n75_), .b(x36), .O(new_n118_));
  inv1   g056(.a(x39), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(x35), .c(new_n83_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(x07), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n117_), .c(new_n64_), .O(new_n123_));
  ...
  nor2   g069(.a(new_n64_), .b(new_n65_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n84_), .c(new_n131_), .O(new_n133_));
  inv1   g071(.a(x08), .O(new_n134_));
  nand3  g072(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n133_), .c(x40), .O(new_n137_));
  ...
  oai22  g082(.a(new_n73_), .b(new_n64_), .c(new_n119_), .d(x04), .O(new_n145_));
  oai21  g083(.a(new_n70_), .b(new_n64_), .c(new_n142_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  inv1   g086(.a(x36), .O(new_n149_));
  oai22  g087(.a(new_n142_), .b(x28), .c(new_n149_), .d(new_n66_), .O(new_n150_));
  ...
  nand3  g094(.a(new_n125_), .b(new_n148_), .c(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x39), .b(new_n148_), .c(new_n65_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n73_), .c(new_n159_), .O(new_n161_));
  nand4  g099(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x40), .O(new_n163_));
  nand4  g101(.a(x37), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g103(.a(new_n160_), .b(new_n149_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n82_), .c(new_n81_), .O(new_n168_));
  nand4  g106(.a(x40), .b(x39), .c(new_n148_), .d(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n64_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n168_), .c(new_n165_), .d(new_n161_), .O(z14));
  ...
  oai22  g116(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n135_), .c(new_n81_), .d(new_n130_), .O(z18));
  oai21  g119(.a(new_n66_), .b(new_n64_), .c(new_n134_), .O(new_n182_));
  oai21  g120(.a(new_n83_), .b(x27), .c(x35), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n131_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n182_), .c(x40), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n81_), .c(new_n130_), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z20));
  inv1   g125(.a(new_n138_), .O(z19));
endmodule
