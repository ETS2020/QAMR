// Benchmark "FAU" written by ABC on Mon Jul 27 18:20:07 2020
...
module FAU ( 
  ...
  aoi22  g007(.a(z08), .b(new_n67_), .c(new_n65_), .d(x27), .O(new_n70_));
  ...
  nand3  g022(.a(new_n84_), .b(new_n83_), .c(x04), .O(new_n85_));
  nand4  g023(.a(new_n85_), .b(new_n82_), .c(x40), .d(x39), .O(z02));
  inv1   g024(.a(x35), .O(new_n87_));
  oai21  g025(.a(new_n87_), .b(new_n75_), .c(x27), .O(new_n88_));
  inv1   g026(.a(x37), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(new_n84_), .O(new_n90_));
  ...
  nand4  g040(.a(new_n102_), .b(new_n100_), .c(new_n98_), .d(new_n97_), .O(new_n103_));
  ...
  aoi21  g045(.a(new_n107_), .b(new_n103_), .c(new_n96_), .O(z07));
  ...
  nand3  g052(.a(new_n114_), .b(new_n77_), .c(x27), .O(new_n115_));
  inv1   g053(.a(x39), .O(new_n116_));
  oai21  g054(.a(x32), .b(x30), .c(x40), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(x05), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  nand3  g059(.a(x37), .b(x27), .c(x06), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n121_), .O(z10));
  inv1   g061(.a(x09), .O(new_n124_));
  nand2  g062(.a(x39), .b(x29), .O(new_n125_));
  nor2   g063(.a(new_n84_), .b(new_n111_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n76_), .c(new_n125_), .O(new_n127_));
  inv1   g065(.a(x40), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n83_), .c(new_n76_), .O(new_n129_));
  oai21  g067(.a(new_n84_), .b(x04), .c(new_n83_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n127_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n72_), .c(new_n124_), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(z11));
  nor3   g071(.a(x37), .b(x36), .c(x35), .O(new_n134_));
  nor2   g072(.a(new_n128_), .b(x27), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n134_), .c(new_n66_), .O(new_n136_));
  oai22  g074(.a(new_n64_), .b(new_n84_), .c(new_n116_), .d(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(x40), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nand2  g077(.a(x36), .b(x35), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x28), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(x39), .c(new_n139_), .d(new_n111_), .O(new_n142_));
  inv1   g080(.a(x18), .O(new_n143_));
  inv1   g081(.a(x19), .O(new_n144_));
  inv1   g082(.a(new_n64_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand3  g086(.a(new_n118_), .b(new_n139_), .c(new_n111_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand3  g088(.a(x39), .b(new_n139_), .c(new_n111_), .O(new_n151_));
  nand3  g089(.a(x20), .b(new_n144_), .c(new_n143_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n64_), .c(new_n151_), .O(new_n153_));
  nor2   g091(.a(x37), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n152_), .b(new_n140_), .c(new_n154_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n75_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n73_), .c(new_n72_), .O(new_n157_));
  nand2  g095(.a(x40), .b(x13), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(x39), .c(new_n111_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n84_), .c(new_n128_), .O(new_n160_));
  ...
  inv1   g105(.a(x29), .O(new_n168_));
  oai22  g106(.a(new_n76_), .b(x27), .c(new_n68_), .d(new_n168_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  inv1   g108(.a(new_n76_), .O(new_n171_));
  nor2   g109(.a(new_n84_), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(x30), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n170_), .c(new_n124_), .O(z18));
  oai21  g112(.a(new_n87_), .b(new_n84_), .c(new_n83_), .O(new_n175_));
  oai21  g113(.a(new_n75_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n125_), .O(new_n177_));
  nand2  g115(.a(new_n76_), .b(new_n128_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n175_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n72_), .c(new_n124_), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z20));
  inv1   g119(.a(new_n132_), .O(z19));
endmodule
