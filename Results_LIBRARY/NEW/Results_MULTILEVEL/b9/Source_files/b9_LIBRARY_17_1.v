...
module FAU ( 
  ...
  nand4  g029(.a(new_n91_), .b(new_n89_), .c(z08), .d(new_n86_), .O(z02));
  ...
  oai21  g035(.a(new_n86_), .b(new_n64_), .c(new_n70_), .O(z05));
  nand3  g036(.a(x28), .b(x27), .c(x04), .O(new_n99_));
  and2   g037(.a(new_n99_), .b(new_n70_), .O(z06));
  ...
  nand3  g055(.a(new_n117_), .b(new_n68_), .c(x27), .O(new_n118_));
  ...
  oai21  g071(.a(new_n86_), .b(x27), .c(x35), .O(new_n134_));
  ...
  oai21  g076(.a(x37), .b(x28), .c(x27), .O(new_n139_));
  ...
  nand3  g082(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n141_), .O(z12));
  ...
  nand3  g088(.a(z08), .b(new_n150_), .c(new_n65_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand4  g091(.a(new_n121_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  inv1   g093(.a(x20), .O(new_n156_));
  nor2   g094(.a(new_n139_), .b(new_n156_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n148_), .c(new_n147_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n140_), .O(new_n159_));
  oai21  g097(.a(new_n120_), .b(x13), .c(new_n64_), .O(new_n160_));
  oai22  g098(.a(x35), .b(new_n86_), .c(new_n150_), .d(x04), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n70_), .O(new_n162_));
  nand3  g100(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x13), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n162_), .c(new_n160_), .d(new_n159_), .O(z14));
  ...
  nand3  g109(.a(x35), .b(new_n86_), .c(new_n64_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n132_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n130_), .c(new_n81_), .d(new_n127_), .O(z18));
  nand2  g113(.a(new_n134_), .b(new_n132_), .O(new_n176_));
  oai21  g114(.a(new_n129_), .b(x08), .c(new_n176_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n127_), .O(new_n178_));
