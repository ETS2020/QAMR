...
module FAU ( 
  ...
  aoi21  g078(.a(x39), .b(new_n65_), .c(x37), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n138_), .c(new_n71_), .O(new_n142_));
  oai21  g080(.a(new_n75_), .b(x04), .c(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(new_n140_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x28), .c(new_n138_), .O(new_n147_));
  ...
  nand4  g095(.a(new_n157_), .b(z08), .c(new_n145_), .d(new_n65_), .O(new_n158_));
  ...
  nand3  g100(.a(x39), .b(new_n145_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n70_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x40), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n71_), .O(new_n166_));
  nand4  g104(.a(x40), .b(x39), .c(new_n145_), .d(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n64_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n166_), .c(new_n162_), .d(new_n159_), .O(z14));
  ...
  nand4  g115(.a(new_n177_), .b(new_n131_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g116(.a(new_n128_), .O(new_n179_));
  oai21  g117(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n179_), .c(new_n180_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n81_), .c(new_n127_), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z20));
  inv1   g122(.a(new_n134_), .O(z19));
endmodule
