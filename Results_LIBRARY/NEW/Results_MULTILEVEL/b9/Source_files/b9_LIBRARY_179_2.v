...
module FAU ( 
  ...
  nand3  g103(.a(z08), .b(new_n147_), .c(new_n65_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n71_), .c(new_n70_), .O(new_n167_));
  nand2  g105(.a(new_n161_), .b(new_n64_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n167_), .c(new_n165_), .d(new_n162_), .O(z14));
