...
module FAU ( 
  ...
  aoi22  g074(.a(new_n136_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n140_), .d(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g093(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x27), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n82_), .c(new_n81_), .O(new_n158_));
  nand3  g096(.a(z08), .b(new_n140_), .c(new_n65_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n71_), .c(new_n70_), .O(new_n160_));
  nand3  g098(.a(x27), .b(new_n146_), .c(new_n145_), .O(new_n161_));
  nand2  g099(.a(x40), .b(x13), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(x39), .c(new_n65_), .O(new_n163_));
  aoi22  g101(.a(new_n163_), .b(new_n64_), .c(new_n161_), .d(new_n141_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n160_), .c(new_n158_), .d(new_n155_), .O(z14));
  ...
  oai21  g109(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n131_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g112(.a(new_n128_), .O(new_n175_));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n175_), .c(new_n176_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n81_), .c(new_n127_), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(z20));
  inv1   g118(.a(new_n134_), .O(z19));
endmodule
