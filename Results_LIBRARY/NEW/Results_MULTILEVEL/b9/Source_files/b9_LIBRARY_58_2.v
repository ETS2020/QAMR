// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:34 2020
...
module FAU ( 
  ...
  nand2  g056(.a(new_n82_), .b(new_n81_), .O(new_n119_));
  ...
  oai21  g065(.a(new_n127_), .b(new_n84_), .c(new_n126_), .O(new_n128_));
  nand2  g066(.a(x40), .b(x04), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x35), .c(new_n83_), .d(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n91_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n81_), .c(new_n125_), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(z11));
  inv1   g072(.a(x10), .O(new_n135_));
  nor3   g073(.a(x37), .b(x36), .c(x35), .O(new_n136_));
  inv1   g074(.a(x40), .O(new_n137_));
  nor2   g075(.a(new_n137_), .b(x27), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n136_), .c(new_n135_), .O(new_n139_));
  nand2  g077(.a(z08), .b(new_n65_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n71_), .c(new_n70_), .O(new_n141_));
  nand3  g079(.a(x40), .b(x39), .c(new_n65_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n141_), .c(new_n139_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x28), .c(new_n137_), .O(new_n147_));
  ...
  aoi21  g091(.a(new_n82_), .b(new_n81_), .c(new_n137_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n145_), .d(new_n65_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(z13));
  nand3  g094(.a(x39), .b(new_n145_), .c(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n71_), .O(new_n158_));
  nand4  g096(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n159_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n163_));
  oai21  g101(.a(x13), .b(x04), .c(x40), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n163_), .c(x39), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g104(.a(x20), .b(x13), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n129_), .c(new_n119_), .d(x39), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n64_), .c(new_n137_), .O(new_n169_));
  ...
  nor3   g113(.a(new_n173_), .b(x24), .c(new_n175_), .O(z17));
  oai21  g114(.a(new_n84_), .b(x27), .c(new_n126_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  inv1   g116(.a(new_n84_), .O(new_n179_));
  nor2   g117(.a(new_n64_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(x30), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n178_), .c(new_n125_), .O(z18));
  inv1   g120(.a(new_n126_), .O(new_n183_));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n81_), .c(new_n125_), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(z20));
  inv1   g126(.a(new_n133_), .O(z19));
endmodule
