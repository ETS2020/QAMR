...
module FAU ( 
  ...
  inv1   g110(.a(x10), .O(new_n194_));
  nand3  g111(.a(new_n175_), .b(x45), .c(new_n194_), .O(new_n195_));
  ...
  nand4  g115(.a(new_n174_), .b(new_n194_), .c(x09), .d(x00), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n198_), .O(z35));
endmodule
