...
module FAU ( 
  ...
  inv1   g054(.a(x10), .O(new_n138_));
  nand3  g055(.a(x28), .b(new_n138_), .c(new_n103_), .O(new_n139_));
  oai21  g056(.a(new_n137_), .b(new_n103_), .c(new_n139_), .O(z17));
  nand3  g057(.a(x30), .b(new_n138_), .c(x08), .O(new_n141_));
  oai21  g058(.a(new_n137_), .b(x08), .c(new_n141_), .O(z18));
