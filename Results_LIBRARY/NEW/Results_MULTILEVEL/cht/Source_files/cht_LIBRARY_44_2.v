...
module FAU ( 
  ...
  nand3  g096(.a(x39), .b(x14), .c(new_n168_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n179_), .O(z28));
  inv1   g098(.a(x40), .O(new_n182_));
  nand2  g099(.a(x41), .b(x09), .O(new_n183_));
  oai21  g100(.a(new_n182_), .b(x09), .c(new_n183_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n170_), .O(new_n185_));
  nand3  g102(.a(x40), .b(x14), .c(new_n168_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n185_), .O(z29));
  inv1   g104(.a(x41), .O(new_n188_));
  nand2  g105(.a(x42), .b(x09), .O(new_n189_));
  oai21  g106(.a(new_n188_), .b(x09), .c(new_n189_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n170_), .O(new_n191_));
  nand3  g108(.a(x41), .b(x14), .c(new_n168_), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(new_n191_), .O(z30));
  inv1   g110(.a(x42), .O(new_n194_));
  nand2  g111(.a(x43), .b(x09), .O(new_n195_));
  oai21  g112(.a(new_n194_), .b(x09), .c(new_n195_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n170_), .O(new_n197_));
  nand3  g114(.a(x42), .b(x14), .c(new_n168_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n197_), .O(z31));
  inv1   g116(.a(x43), .O(new_n200_));
  nand2  g117(.a(x44), .b(x09), .O(new_n201_));
  oai21  g118(.a(new_n200_), .b(x09), .c(new_n201_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n170_), .O(new_n203_));
  nand3  g120(.a(x43), .b(x14), .c(new_n168_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n203_), .O(z32));
  inv1   g122(.a(x44), .O(new_n206_));
  nand2  g123(.a(x45), .b(x09), .O(new_n207_));
  oai21  g124(.a(new_n206_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n170_), .O(new_n209_));
  nand3  g126(.a(x44), .b(x14), .c(new_n168_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n209_), .O(z33));
  inv1   g128(.a(x45), .O(new_n212_));
  nand2  g129(.a(x46), .b(x09), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(x09), .c(new_n213_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n170_), .O(new_n215_));
  nand3  g132(.a(x45), .b(x14), .c(new_n168_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n215_), .O(z34));
  inv1   g134(.a(x46), .O(new_n218_));
  nand2  g135(.a(x09), .b(x00), .O(new_n219_));
  oai21  g136(.a(new_n218_), .b(x09), .c(new_n219_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n170_), .O(new_n221_));
  nand3  g138(.a(x46), .b(x14), .c(new_n168_), .O(new_n222_));
