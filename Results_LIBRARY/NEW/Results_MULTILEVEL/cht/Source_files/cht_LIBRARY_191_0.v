// Benchmark "FAU" written by ABC on Mon Jul 27 17:54:05 2020
...
module FAU ( 
  ...
  aoi21  g105(.a(new_n175_), .b(new_n188_), .c(x10), .O(z32));
  nor2   g106(.a(x45), .b(x14), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(x09), .c(x10), .O(z33));
