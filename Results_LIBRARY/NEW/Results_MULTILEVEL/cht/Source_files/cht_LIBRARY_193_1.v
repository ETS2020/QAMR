...
module FAU ( 
  ...
  nand3  g021(.a(x17), .b(new_n104_), .c(new_n103_), .O(new_n105_));
  inv1   g022(.a(new_n105_), .O(z06));
  nand3  g023(.a(x19), .b(new_n104_), .c(x08), .O(new_n107_));
  inv1   g024(.a(new_n107_), .O(z07));
  nand2  g025(.a(x19), .b(new_n103_), .O(new_n109_));
