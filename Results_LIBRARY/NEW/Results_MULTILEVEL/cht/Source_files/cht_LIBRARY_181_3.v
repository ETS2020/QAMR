// Benchmark "FAU" written by ABC on Mon Jul 27 17:54:03 2020
...
module FAU ( 
  ...
  nand3  g065(.a(x31), .b(new_n148_), .c(new_n146_), .O(new_n149_));
  oai21  g066(.a(new_n147_), .b(new_n146_), .c(new_n149_), .O(z20));
  nand3  g067(.a(x33), .b(new_n148_), .c(x09), .O(new_n151_));
  oai21  g068(.a(new_n147_), .b(x09), .c(new_n151_), .O(z21));
