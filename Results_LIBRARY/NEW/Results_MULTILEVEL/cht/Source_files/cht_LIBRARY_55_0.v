// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:42 2020
...
module FAU ( 
  ...
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z06));
  inv1   g022(.a(x19), .O(new_n106_));
  aoi21  g023(.a(new_n106_), .b(x08), .c(x10), .O(z07));
  nand2  g024(.a(x19), .b(new_n103_), .O(new_n108_));
  nand2  g025(.a(x20), .b(x08), .O(new_n109_));
  aoi21  g026(.a(new_n109_), .b(new_n108_), .c(x10), .O(z08));
  nand2  g027(.a(x20), .b(new_n103_), .O(new_n111_));
  nand2  g028(.a(x21), .b(x08), .O(new_n112_));
  aoi21  g029(.a(new_n112_), .b(new_n111_), .c(x10), .O(z09));
  nand2  g030(.a(x21), .b(new_n103_), .O(new_n114_));
  nand2  g031(.a(x22), .b(x08), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n114_), .c(x10), .O(z10));
  nand2  g033(.a(x22), .b(new_n103_), .O(new_n117_));
  nand2  g034(.a(x23), .b(x08), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n117_), .c(x10), .O(z11));
  nand2  g036(.a(x23), .b(new_n103_), .O(new_n120_));
  nand2  g037(.a(x24), .b(x08), .O(new_n121_));
  aoi21  g038(.a(new_n121_), .b(new_n120_), .c(x10), .O(z12));
  nand2  g039(.a(x24), .b(new_n103_), .O(new_n123_));
  nand2  g040(.a(x25), .b(x08), .O(new_n124_));
  aoi21  g041(.a(new_n124_), .b(new_n123_), .c(x10), .O(z13));
  nand2  g042(.a(x25), .b(new_n103_), .O(new_n126_));
  nand2  g043(.a(x26), .b(x08), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n126_), .c(x10), .O(z14));
  nand2  g045(.a(x26), .b(new_n103_), .O(new_n129_));
  nand2  g046(.a(x27), .b(x08), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n129_), .c(x10), .O(z15));
  ...
  nand3  g091(.a(x40), .b(new_n172_), .c(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z28));
  nand2  g093(.a(new_n173_), .b(x40), .O(new_n177_));
  nand3  g094(.a(x41), .b(new_n172_), .c(x09), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z29));
  nand2  g096(.a(new_n173_), .b(x41), .O(new_n180_));
  nand3  g097(.a(x42), .b(new_n172_), .c(x09), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z30));
  nand2  g099(.a(new_n173_), .b(x42), .O(new_n183_));
  nand3  g100(.a(x43), .b(new_n172_), .c(x09), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z31));
  nand2  g102(.a(new_n173_), .b(x43), .O(new_n186_));
  nand3  g103(.a(x44), .b(new_n172_), .c(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z32));
  nand2  g105(.a(new_n173_), .b(x44), .O(new_n189_));
  nand3  g106(.a(x45), .b(new_n172_), .c(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z33));
  nand2  g108(.a(new_n173_), .b(x45), .O(new_n192_));
  nand3  g109(.a(x46), .b(new_n172_), .c(x09), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n192_), .c(x10), .O(z34));
  nand2  g111(.a(new_n173_), .b(x46), .O(new_n195_));
  nand3  g112(.a(new_n172_), .b(x09), .c(x00), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z35));
endmodule
