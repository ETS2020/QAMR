...
module FAU ( 
  ...
  inv1   g095(.a(x10), .O(new_n179_));
  nand3  g096(.a(new_n175_), .b(x40), .c(new_n179_), .O(new_n180_));
  nand3  g097(.a(x41), .b(new_n174_), .c(x09), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(z29));
  nand2  g099(.a(new_n175_), .b(x41), .O(new_n183_));
  nand4  g100(.a(x42), .b(new_n174_), .c(new_n179_), .d(x09), .O(new_n184_));
