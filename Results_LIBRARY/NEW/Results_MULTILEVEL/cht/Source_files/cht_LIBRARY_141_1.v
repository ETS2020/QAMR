...
module FAU ( 
  ...
  nor2   g096(.a(new_n179_), .b(x10), .O(z29));
  inv1   g097(.a(x10), .O(new_n181_));
  nand4  g098(.a(x42), .b(new_n174_), .c(new_n181_), .d(x09), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z30));
  nand2  g100(.a(new_n175_), .b(x42), .O(new_n184_));
  nand3  g101(.a(x43), .b(new_n174_), .c(x09), .O(new_n185_));
