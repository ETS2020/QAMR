...
module FAU ( 
  ...
  inv1   g101(.a(x10), .O(new_n185_));
  nand3  g102(.a(new_n175_), .b(x42), .c(new_n185_), .O(new_n186_));
  nand3  g103(.a(x43), .b(new_n174_), .c(x09), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z31));
  nand2  g105(.a(new_n175_), .b(x43), .O(new_n189_));
  nand4  g106(.a(x44), .b(new_n174_), .c(new_n185_), .d(x09), .O(new_n190_));
