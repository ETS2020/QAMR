// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:52 2020
...
module FAU ( 
  ...
  nand3  g033(.a(x21), .b(new_n116_), .c(new_n103_), .O(new_n117_));
  inv1   g034(.a(new_n117_), .O(z10));
  nand3  g035(.a(x23), .b(new_n116_), .c(x08), .O(new_n119_));
