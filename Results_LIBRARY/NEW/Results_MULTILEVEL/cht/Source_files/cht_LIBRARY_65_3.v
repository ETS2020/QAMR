// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:44 2020
...
module FAU ( 
  ...
  inv1   g067(.a(x10), .O(new_n151_));
  nand3  g068(.a(x32), .b(new_n151_), .c(new_n146_), .O(new_n152_));
  oai21  g069(.a(new_n150_), .b(new_n146_), .c(new_n152_), .O(z21));
  nand3  g070(.a(x34), .b(new_n151_), .c(x09), .O(new_n154_));
  oai21  g071(.a(new_n150_), .b(x09), .c(new_n154_), .O(z22));
