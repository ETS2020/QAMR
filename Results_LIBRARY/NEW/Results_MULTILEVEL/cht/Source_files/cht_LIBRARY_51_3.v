// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:41 2020
...
module FAU ( 
  ...
  nand3  g012(.a(new_n95_), .b(x07), .c(x01), .O(new_n96_));
  oai21  g013(.a(new_n94_), .b(x07), .c(new_n96_), .O(z03));
  ...
  nand3  g086(.a(x39), .b(new_n94_), .c(new_n95_), .O(new_n170_));
  nand2  g087(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(x09), .O(new_n172_));
  nand3  g089(.a(x38), .b(new_n95_), .c(new_n147_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z27));
  nand2  g091(.a(x39), .b(new_n147_), .O(new_n175_));
  nand3  g092(.a(x40), .b(new_n94_), .c(x09), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n95_), .O(new_n178_));
  nand2  g095(.a(x39), .b(x14), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n178_), .O(z28));
  nand2  g097(.a(x40), .b(new_n147_), .O(new_n181_));
  nand3  g098(.a(x41), .b(new_n94_), .c(x09), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n95_), .O(new_n184_));
  nand2  g101(.a(x40), .b(x14), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(z29));
  nand2  g103(.a(x41), .b(new_n147_), .O(new_n187_));
  nand3  g104(.a(x42), .b(new_n94_), .c(x09), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n95_), .O(new_n190_));
  nand2  g107(.a(x41), .b(x14), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n190_), .O(z30));
  nand2  g109(.a(x42), .b(new_n147_), .O(new_n193_));
  nand3  g110(.a(x43), .b(new_n94_), .c(x09), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g112(.a(new_n195_), .b(new_n95_), .O(new_n196_));
  nand2  g113(.a(x42), .b(x14), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n196_), .O(z31));
  nand2  g115(.a(x43), .b(new_n147_), .O(new_n199_));
  nand3  g116(.a(x44), .b(new_n94_), .c(x09), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n95_), .O(new_n202_));
  nand2  g119(.a(x43), .b(x14), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n202_), .O(z32));
  nand2  g121(.a(x44), .b(new_n147_), .O(new_n205_));
  nand3  g122(.a(x45), .b(new_n94_), .c(x09), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n95_), .O(new_n208_));
  nand2  g125(.a(x44), .b(x14), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n208_), .O(z33));
  nand2  g127(.a(x45), .b(new_n147_), .O(new_n211_));
  nand3  g128(.a(x46), .b(new_n94_), .c(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n95_), .O(new_n214_));
  nand2  g131(.a(x45), .b(x14), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n214_), .O(z34));
  nand3  g133(.a(new_n94_), .b(x09), .c(x00), .O(new_n217_));
  nand2  g134(.a(x46), .b(new_n147_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n217_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n95_), .O(new_n220_));
  nand2  g137(.a(x46), .b(x14), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n220_), .O(z35));
endmodule
