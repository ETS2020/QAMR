...
module FAU ( 
  ...
  nand4  g18(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n43_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x13), .c(x04), .O(z04));
  nand4  g20(.a(new_n26_), .b(new_n31_), .c(x01), .d(x00), .O(new_n46_));
  ...
  nand4  g33(.a(new_n58_), .b(x05), .c(x04), .d(new_n26_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x02), .O(z06));
  inv1   g35(.a(x13), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n27_), .c(new_n26_), .d(new_n31_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(z07));
  nor2   g38(.a(x03), .b(x02), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n49_), .c(x05), .d(x04), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n61_), .O(z08));
