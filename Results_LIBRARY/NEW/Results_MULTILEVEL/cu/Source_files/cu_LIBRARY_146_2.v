...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n70_, new_n72_, new_n73_, new_n76_, new_n77_;
  ...
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(x05), .d(new_n27_), .O(new_n67_));
  nand4  g42(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(new_n31_), .O(z06));
  nand4  g44(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  inv1   g46(.a(x12), .O(new_n72_));
  nand4  g47(.a(x13), .b(new_n72_), .c(x05), .d(new_n27_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n68_), .c(new_n31_), .O(z08));
