...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n68_, new_n69_, new_n71_, new_n72_, new_n73_, new_n76_;
  ...
  nand3  g35(.a(new_n60_), .b(x05), .c(new_n44_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n55_), .c(new_n43_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n52_), .c(new_n51_), .d(new_n31_), .O(new_n63_));
  nand3  g38(.a(new_n43_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand2  g42(.a(new_n28_), .b(new_n44_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n43_), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n52_), .c(x05), .d(new_n31_), .O(new_n71_));
  ...
  nand3  g50(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n76_));
