...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n52_, new_n53_, new_n55_, new_n57_, new_n60_, new_n61_;
  ...
  nand4  g31(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x02), .O(z07));
  and2   g33(.a(x13), .b(x06), .O(z09));
  nand2  g34(.a(x05), .b(x02), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x06), .c(new_n26_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(z10));
  nor2   g37(.a(new_n55_), .b(x13), .O(z08));
endmodule
