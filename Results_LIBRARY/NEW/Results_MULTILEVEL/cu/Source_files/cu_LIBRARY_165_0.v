...
module FAU ( 
  ...
  nand3  g33(.a(new_n58_), .b(x05), .c(x00), .O(new_n59_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n53_), .c(new_n52_), .d(new_n31_), .O(new_n64_));
  ...
  nand2  g43(.a(new_n28_), .b(x00), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n40_), .c(new_n27_), .d(new_n26_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n72_));
