...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n29_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n40_, new_n41_, new_n42_, new_n43_, new_n44_, new_n45_,
    new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    new_n53_, new_n56_, new_n57_, new_n60_, new_n61_;
  ...
  aoi21  g13(.a(new_n42_), .b(new_n40_), .c(new_n37_), .O(new_n43_));
  inv1   g14(.a(x08), .O(new_n44_));
  nand2  g15(.a(new_n44_), .b(new_n38_), .O(new_n45_));
  inv1   g16(.a(x10), .O(new_n46_));
  nand2  g17(.a(new_n46_), .b(x01), .O(new_n47_));
  aoi21  g18(.a(new_n47_), .b(new_n45_), .c(x00), .O(new_n48_));
  oai21  g19(.a(new_n48_), .b(new_n43_), .c(x13), .O(new_n49_));
  nor2   g20(.a(new_n49_), .b(x12), .O(new_n50_));
  nand4  g21(.a(new_n50_), .b(new_n36_), .c(x05), .d(new_n35_), .O(new_n51_));
  ...
  inv1   g25(.a(x12), .O(new_n56_));
  nand4  g26(.a(x13), .b(new_n56_), .c(x05), .d(new_n35_), .O(new_n57_));
  aoi21  g27(.a(new_n57_), .b(new_n53_), .c(x03), .O(z08));
