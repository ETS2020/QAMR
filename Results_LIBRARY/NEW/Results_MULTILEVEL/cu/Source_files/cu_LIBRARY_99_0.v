// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:23 2020
...
module FAU ( 
  ...
  oai21  g38(.a(new_n63_), .b(new_n60_), .c(x05), .O(new_n64_));
  inv1   g39(.a(x08), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n41_), .c(new_n46_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n64_), .c(new_n40_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n55_), .c(new_n54_), .d(new_n31_), .O(new_n68_));
  nand3  g43(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand4  g47(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n75_));
