...
module FAU ( 
  ...
  nor2   g13(.a(new_n38_), .b(new_n28_), .O(z02));
  inv1   g14(.a(x01), .O(new_n40_));
  nand4  g15(.a(new_n26_), .b(new_n27_), .c(new_n40_), .d(x00), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(new_n28_), .c(x04), .O(z03));
  ...
  aoi21  g32(.a(new_n57_), .b(new_n55_), .c(new_n43_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n59_));
  nand3  g34(.a(new_n43_), .b(new_n28_), .c(x02), .O(new_n60_));
  ...
  nand2  g38(.a(x13), .b(x01), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n53_), .c(x05), .d(new_n27_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n60_), .O(new_n68_));
