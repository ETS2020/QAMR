...
module FAU ( 
  ...
  nand2  g37(.a(x04), .b(new_n41_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n40_), .c(x05), .d(new_n26_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(x02), .O(z07));
  nand4  g40(.a(x13), .b(new_n52_), .c(x05), .d(new_n31_), .O(new_n66_));
