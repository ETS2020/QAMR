...
module FAU ( 
  ...
  oai21  g38(.a(new_n63_), .b(new_n60_), .c(new_n26_), .O(new_n64_));
  inv1   g39(.a(x08), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n41_), .c(new_n46_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n55_), .d(new_n54_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x05), .c(new_n31_), .O(new_n70_));
  nand4  g45(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n70_), .c(new_n27_), .O(z06));
  ...
  nand3  g50(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n76_));
