...
module FAU ( 
  ...
  nor3   g22(.a(new_n47_), .b(x13), .c(x04), .O(z04));
  nand4  g23(.a(new_n26_), .b(new_n31_), .c(x01), .d(x00), .O(new_n49_));
  nor3   g24(.a(new_n49_), .b(x13), .c(x04), .O(z05));
  inv1   g25(.a(x07), .O(new_n51_));
  inv1   g26(.a(x12), .O(new_n52_));
  inv1   g27(.a(x09), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(x05), .c(new_n41_), .O(new_n54_));
  ...
  nand3  g34(.a(new_n59_), .b(x05), .c(new_n41_), .O(new_n60_));
  inv1   g35(.a(x10), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n46_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n58_), .c(new_n40_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n52_), .c(new_n51_), .d(new_n31_), .O(new_n66_));
  ...
  nand2  g45(.a(new_n28_), .b(new_n41_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n40_), .c(new_n27_), .d(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n52_), .c(x05), .d(new_n31_), .O(new_n74_));
