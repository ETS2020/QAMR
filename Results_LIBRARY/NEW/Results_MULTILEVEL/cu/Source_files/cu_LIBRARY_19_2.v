// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:10 2020
...
module FAU ( 
  ...
  nand4  g30(.a(new_n46_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n58_));
  nor2   g31(.a(new_n58_), .b(x02), .O(z07));
  nand4  g32(.a(x13), .b(new_n45_), .c(x05), .d(new_n27_), .O(new_n60_));
  ...
  nand3  g38(.a(new_n65_), .b(x06), .c(new_n26_), .O(new_n66_));
  inv1   g39(.a(new_n66_), .O(z10));
  zero   g40(.O(z04));
  zero   g41(.O(z05));
endmodule
