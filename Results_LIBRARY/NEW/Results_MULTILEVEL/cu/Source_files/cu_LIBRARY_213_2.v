...
module FAU ( 
  ...
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n67_));
  nand4  g42(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(new_n27_), .O(z06));
  nand4  g44(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  inv1   g46(.a(x12), .O(new_n72_));
  nand4  g47(.a(x13), .b(new_n72_), .c(x05), .d(new_n31_), .O(new_n73_));
