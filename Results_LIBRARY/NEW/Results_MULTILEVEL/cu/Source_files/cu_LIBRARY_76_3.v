...
module FAU ( 
  ...
  nand4  g21(.a(new_n27_), .b(new_n31_), .c(x01), .d(new_n46_), .O(new_n47_));
  nor3   g22(.a(new_n47_), .b(x13), .c(new_n28_), .O(z04));
  nand4  g23(.a(new_n27_), .b(new_n31_), .c(x01), .d(x00), .O(new_n49_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n64_));
  nand4  g39(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n64_), .c(new_n27_), .O(z06));
  nand2  g41(.a(x03), .b(new_n41_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n40_), .c(x05), .d(new_n27_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  inv1   g44(.a(x12), .O(new_n70_));
  nand4  g45(.a(x13), .b(new_n70_), .c(x05), .d(new_n31_), .O(new_n71_));
