// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:21 2020
...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n54_), .d(new_n31_), .O(new_n63_));
  ...
  nand4  g42(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  ...
  nand3  g49(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n75_));
