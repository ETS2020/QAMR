...
module FAU ( 
  ...
  nand4  g15(.a(new_n27_), .b(new_n26_), .c(new_n40_), .d(x00), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x13), .c(new_n28_), .O(z03));
  inv1   g17(.a(x00), .O(new_n43_));
  nand4  g18(.a(new_n27_), .b(new_n26_), .c(x01), .d(new_n43_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x13), .c(new_n28_), .O(z04));
  nand4  g20(.a(new_n27_), .b(new_n26_), .c(x01), .d(x00), .O(new_n46_));
  ...
  nand4  g36(.a(new_n61_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n62_));
