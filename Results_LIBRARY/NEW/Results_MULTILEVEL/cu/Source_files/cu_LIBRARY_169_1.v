...
module FAU ( 
  ...
  nand4  g20(.a(new_n27_), .b(new_n26_), .c(new_n31_), .d(x01), .O(new_n47_));
  ...
  nand3  g28(.a(new_n54_), .b(new_n41_), .c(x00), .O(new_n55_));
  ...
  nand3  g34(.a(new_n60_), .b(x05), .c(new_n31_), .O(new_n61_));
  nand3  g35(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(x04), .c(new_n26_), .O(new_n64_));
  inv1   g38(.a(new_n64_), .O(z06));
  nor2   g39(.a(x01), .b(x00), .O(new_n66_));
