// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:46 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n69_, new_n71_, new_n73_, new_n75_;
  ...
  nand4  g24(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nor3   g26(.a(x02), .b(new_n42_), .c(new_n47_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n53_));
  ...
  nand4  g40(.a(new_n65_), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n66_));
  nand3  g41(.a(new_n41_), .b(new_n28_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n31_), .O(z06));
  nand4  g43(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand4  g45(.a(new_n35_), .b(x13), .c(new_n56_), .d(x05), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n67_), .c(new_n31_), .O(z08));
  inv1   g47(.a(x06), .O(new_n73_));
  nor2   g48(.a(new_n41_), .b(new_n73_), .O(z09));
  inv1   g49(.a(new_n35_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(x05), .c(new_n73_), .O(z10));
endmodule
