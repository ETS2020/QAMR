...
module FAU ( 
  ...
  nor3   g19(.a(new_n44_), .b(new_n28_), .c(x04), .O(z04));
  nand4  g20(.a(new_n26_), .b(new_n31_), .c(x01), .d(x00), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(new_n28_), .c(x04), .O(z05));
  nand4  g22(.a(new_n28_), .b(x04), .c(new_n26_), .d(x02), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z06));
  nand4  g24(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z07));
  and2   g26(.a(x13), .b(x06), .O(z09));
  nand3  g27(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n53_));
