...
module FAU ( 
  ...
  nand3  g21(.a(x13), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  nand2  g22(.a(new_n49_), .b(new_n46_), .O(new_n50_));
  nand2  g23(.a(new_n50_), .b(x00), .O(new_n51_));
  inv1   g24(.a(x00), .O(new_n52_));
  inv1   g25(.a(x10), .O(new_n53_));
  nand2  g26(.a(new_n53_), .b(x01), .O(new_n54_));
  inv1   g27(.a(x08), .O(new_n55_));
  nand3  g28(.a(x13), .b(new_n55_), .c(new_n47_), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand2  g30(.a(new_n57_), .b(new_n52_), .O(new_n58_));
  aoi21  g31(.a(new_n58_), .b(new_n51_), .c(x12), .O(new_n59_));
  nand4  g32(.a(new_n59_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n60_));
  inv1   g33(.a(x13), .O(new_n61_));
  nand3  g34(.a(new_n61_), .b(new_n28_), .c(x02), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand3  g36(.a(new_n63_), .b(x04), .c(new_n26_), .O(new_n64_));
  inv1   g37(.a(new_n64_), .O(z06));
  nand4  g38(.a(new_n61_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  nor2   g39(.a(new_n66_), .b(x02), .O(z07));
  inv1   g40(.a(x12), .O(new_n68_));
  nand4  g41(.a(x13), .b(new_n68_), .c(x05), .d(new_n31_), .O(new_n69_));
  nand2  g42(.a(new_n69_), .b(new_n62_), .O(new_n70_));
  nand3  g43(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  inv1   g44(.a(new_n71_), .O(z08));
  and2   g45(.a(x13), .b(x06), .O(z09));
  nand3  g46(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n74_));
