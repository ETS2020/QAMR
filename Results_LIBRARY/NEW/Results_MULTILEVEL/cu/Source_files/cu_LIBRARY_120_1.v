// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:27 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_, new_n77_,
    new_n78_;
  ...
  nand4  g21(.a(new_n31_), .b(new_n26_), .c(x01), .d(new_n46_), .O(new_n47_));
  nor3   g22(.a(new_n47_), .b(x13), .c(new_n28_), .O(z04));
  nor3   g23(.a(x02), .b(new_n41_), .c(new_n46_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n50_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n27_), .c(x00), .O(new_n59_));
  nor2   g34(.a(x08), .b(x01), .O(new_n60_));
  nor2   g35(.a(x10), .b(new_n41_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n40_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n53_), .c(new_n52_), .d(x05), .O(new_n64_));
  ...
  nand2  g43(.a(x02), .b(x00), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n40_), .c(x05), .d(new_n31_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x03), .O(z07));
  nand4  g46(.a(x13), .b(new_n53_), .c(x05), .d(new_n27_), .O(new_n72_));
