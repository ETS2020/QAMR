// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:29 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_,
    ...
    new_n60_, new_n62_, new_n64_, new_n65_, new_n66_, new_n69_, new_n70_;
  inv1   g00(.a(x03), .O(new_n26_));
  nand2  g01(.a(x05), .b(x04), .O(new_n27_));
  inv1   g02(.a(x04), .O(new_n28_));
  nand2  g03(.a(new_n28_), .b(x02), .O(new_n29_));
  nand3  g04(.a(new_n29_), .b(new_n27_), .c(new_n26_), .O(z00));
  inv1   g05(.a(x02), .O(new_n31_));
  nand2  g06(.a(new_n28_), .b(new_n31_), .O(new_n32_));
  ...
  nand4  g11(.a(new_n36_), .b(new_n28_), .c(new_n26_), .d(new_n31_), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(x13), .O(z02));
  inv1   g13(.a(x01), .O(new_n39_));
  nand4  g14(.a(new_n26_), .b(new_n31_), .c(new_n39_), .d(x00), .O(new_n40_));
  nor3   g15(.a(new_n40_), .b(x13), .c(x04), .O(z03));
  inv1   g16(.a(x00), .O(new_n42_));
  nand4  g17(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n42_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x13), .c(x04), .O(z04));
  nand4  g19(.a(new_n26_), .b(new_n31_), .c(x01), .d(x00), .O(new_n45_));
  nor3   g20(.a(new_n45_), .b(x13), .c(x04), .O(z05));
  ...
  nand4  g31(.a(new_n56_), .b(new_n48_), .c(new_n47_), .d(new_n31_), .O(new_n57_));
  nand2  g32(.a(new_n49_), .b(new_n33_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x04), .c(new_n26_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(z06));
  nand4  g36(.a(new_n49_), .b(new_n28_), .c(new_n26_), .d(new_n31_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(z07));
  nand3  g38(.a(x13), .b(new_n48_), .c(new_n31_), .O(new_n64_));
