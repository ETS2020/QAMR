...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n44_), .O(new_n45_));
  ...
  nand3  g30(.a(new_n55_), .b(new_n26_), .c(x01), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n54_), .c(new_n44_), .O(new_n57_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n52_), .c(x05), .d(new_n27_), .O(new_n65_));
  nand4  g40(.a(new_n43_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n31_), .O(z06));
  nand2  g42(.a(x03), .b(x01), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  inv1   g45(.a(x12), .O(new_n71_));
  nand4  g46(.a(x13), .b(new_n71_), .c(x05), .d(new_n27_), .O(new_n72_));
  nand3  g47(.a(new_n43_), .b(new_n28_), .c(x02), .O(new_n73_));
