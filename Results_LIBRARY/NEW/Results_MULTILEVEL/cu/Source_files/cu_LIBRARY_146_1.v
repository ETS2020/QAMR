// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:31 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n75_;
  ...
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(x05), .d(new_n27_), .O(new_n62_));
  nand3  g37(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n26_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z06));
  nand4  g41(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand3  g43(.a(x13), .b(x05), .c(new_n27_), .O(new_n69_));
