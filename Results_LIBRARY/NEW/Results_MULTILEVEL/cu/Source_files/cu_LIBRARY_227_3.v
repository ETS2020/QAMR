// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:45 2020
...
module FAU ( 
  ...
  nand4  g35(.a(new_n60_), .b(new_n48_), .c(x05), .d(new_n31_), .O(new_n61_));
  inv1   g36(.a(x13), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n27_), .O(z06));
  nand4  g39(.a(new_n62_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z07));
  inv1   g41(.a(x12), .O(new_n67_));
  nand4  g42(.a(x13), .b(new_n67_), .c(x05), .d(new_n31_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n63_), .c(new_n27_), .O(z08));
  inv1   g44(.a(x06), .O(new_n70_));
  nor2   g45(.a(new_n62_), .b(new_n70_), .O(z09));
  nand2  g46(.a(x05), .b(new_n31_), .O(new_n72_));
