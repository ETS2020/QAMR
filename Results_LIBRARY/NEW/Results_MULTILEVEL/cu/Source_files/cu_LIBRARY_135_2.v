...
module FAU ( 
  ...
  nand3  g33(.a(new_n58_), .b(new_n26_), .c(x01), .O(new_n59_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n26_), .c(new_n46_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n71_), .c(new_n31_), .O(z06));
