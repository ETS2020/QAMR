...
module FAU ( 
  ...
  nand4  g12(.a(new_n38_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n39_));
  nor2   g13(.a(new_n39_), .b(x13), .O(z03));
  nor2   g14(.a(x02), .b(x00), .O(new_n41_));
  nand4  g15(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n42_));
  ...
  nand3  g33(.a(new_n59_), .b(x05), .c(new_n27_), .O(new_n60_));
