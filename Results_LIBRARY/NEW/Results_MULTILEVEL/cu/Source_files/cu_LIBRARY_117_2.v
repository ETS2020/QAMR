...
module FAU ( 
  ...
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n55_), .d(new_n54_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x05), .c(new_n27_), .O(new_n68_));
  nand4  g43(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n68_), .c(new_n31_), .O(z06));
  nand4  g45(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n73_));
  nand3  g48(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n74_));
