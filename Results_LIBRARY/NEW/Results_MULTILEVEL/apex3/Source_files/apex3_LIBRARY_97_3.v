...
module FAU ( 
  ...
  nand3  g1356(.a(new_n1460_), .b(new_n107_), .c(new_n105_), .O(new_n1461_));
  nand3  g1357(.a(new_n140_), .b(x48), .c(x23), .O(new_n1462_));
  aoi21  g1358(.a(new_n1462_), .b(new_n1461_), .c(new_n108_), .O(new_n1463_));
  nand4  g1359(.a(new_n1463_), .b(new_n106_), .c(x47), .d(new_n109_), .O(new_n1464_));
