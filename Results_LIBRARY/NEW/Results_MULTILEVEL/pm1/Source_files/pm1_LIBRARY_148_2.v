...
module FAU ( 
  ...
  nand4  g23(.a(x12), .b(x11), .c(new_n52_), .d(x09), .O(new_n53_));
  inv1   g24(.a(x12), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n34_), .O(new_n55_));
  oai21  g26(.a(new_n53_), .b(new_n51_), .c(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(new_n57_));
  inv1   g28(.a(x00), .O(new_n58_));
  nor2   g29(.a(x10), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n57_), .c(new_n35_), .O(z08));
  nand4  g31(.a(new_n51_), .b(new_n46_), .c(x09), .d(x04), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x12), .c(x11), .d(new_n52_), .O(new_n62_));
  aoi21  g33(.a(new_n62_), .b(new_n55_), .c(new_n58_), .O(z09));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n51_), .b(x12), .c(x11), .d(new_n52_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z10));
  nand4  g37(.a(new_n51_), .b(x12), .c(new_n52_), .d(x09), .O(new_n67_));
  nand2  g38(.a(new_n54_), .b(new_n30_), .O(new_n68_));
  oai21  g39(.a(new_n67_), .b(new_n30_), .c(new_n68_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x11), .c(x00), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  nand4  g42(.a(x11), .b(new_n52_), .c(new_n64_), .d(x00), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n54_), .O(z12));
endmodule
