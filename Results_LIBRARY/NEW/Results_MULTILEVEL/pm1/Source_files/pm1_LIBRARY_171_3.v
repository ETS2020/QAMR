...
module FAU ( 
  ...
  nand4  g37(.a(x11), .b(new_n50_), .c(new_n30_), .d(x00), .O(new_n67_));
  nor2   g38(.a(new_n67_), .b(x12), .O(z11));
  nand4  g39(.a(x11), .b(new_n50_), .c(new_n64_), .d(x00), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n51_), .O(z12));
endmodule
