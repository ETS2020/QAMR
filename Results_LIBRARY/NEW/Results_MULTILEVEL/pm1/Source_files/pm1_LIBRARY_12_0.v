// Benchmark "FAU" written by ABC on Mon Jul 27 18:36:42 2020
...
module FAU ( 
  ...
  and2   g22(.a(x09), .b(x04), .O(new_n52_));
  nor2   g23(.a(new_n34_), .b(x10), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(new_n52_), .c(new_n46_), .d(x00), .O(new_n54_));
  ...
  nand4  g28(.a(new_n57_), .b(x11), .c(new_n51_), .d(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  inv1   g30(.a(x00), .O(new_n60_));
  nand4  g31(.a(new_n56_), .b(x11), .c(new_n51_), .d(x09), .O(new_n61_));
  nor2   g32(.a(new_n61_), .b(new_n60_), .O(z10));
  nor3   g33(.a(new_n61_), .b(new_n30_), .c(new_n60_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(x11), .b(new_n51_), .c(new_n64_), .d(x00), .O(new_n65_));
  inv1   g36(.a(new_n65_), .O(z12));
endmodule
