...
module FAU ( 
  ...
  nand3  g07(.a(new_n36_), .b(new_n34_), .c(new_n32_), .O(z00));
  nand2  g08(.a(new_n35_), .b(new_n33_), .O(new_n38_));
  nand2  g09(.a(new_n38_), .b(new_n32_), .O(z01));
  inv1   g10(.a(new_n30_), .O(new_n40_));
  nand3  g11(.a(new_n40_), .b(x08), .c(x07), .O(new_n41_));
  inv1   g12(.a(new_n41_), .O(new_n42_));
  nand4  g13(.a(new_n36_), .b(new_n42_), .c(x11), .d(x09), .O(z02));
  nand4  g14(.a(new_n40_), .b(x11), .c(x08), .d(x07), .O(new_n44_));
  nand4  g15(.a(new_n44_), .b(new_n36_), .c(x11), .d(x09), .O(z03));
  inv1   g16(.a(x14), .O(z04));
  inv1   g17(.a(x13), .O(z05));
  and2   g18(.a(x03), .b(x02), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(new_n34_), .c(x04), .O(new_n49_));
  ...
  nor2   g26(.a(new_n35_), .b(new_n33_), .O(new_n56_));
  ...
  nand4  g37(.a(new_n59_), .b(x12), .c(x11), .d(new_n53_), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z10));
  nand4  g39(.a(x11), .b(new_n53_), .c(new_n66_), .d(x00), .O(new_n69_));
  nor2   g40(.a(new_n69_), .b(new_n35_), .O(z12));
  nor3   g41(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z11));
endmodule
