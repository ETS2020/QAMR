// Benchmark "FAU" written by ABC on Mon Jul 27 18:36:54 2020
...
module FAU ( 
  ...
  nand3  g23(.a(x03), .b(x02), .c(x00), .O(new_n53_));
  nand4  g24(.a(x12), .b(x11), .c(x09), .d(x04), .O(new_n54_));
  nor2   g25(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  aoi21  g26(.a(new_n52_), .b(new_n34_), .c(new_n55_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n35_), .c(new_n51_), .d(x00), .O(z08));
  nand2  g28(.a(new_n52_), .b(new_n34_), .O(new_n58_));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n46_), .c(x09), .d(x04), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(x12), .c(x11), .d(x00), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n58_), .c(x10), .O(z09));
  inv1   g33(.a(x00), .O(new_n63_));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n59_), .b(x12), .c(x11), .d(new_n51_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(z10));
  nand4  g37(.a(new_n59_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  nand2  g38(.a(new_n52_), .b(new_n30_), .O(new_n68_));
  oai21  g39(.a(new_n67_), .b(new_n63_), .c(new_n68_), .O(new_n69_));
  nand3  g40(.a(new_n69_), .b(x11), .c(new_n51_), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z11));
  nand4  g42(.a(x11), .b(new_n51_), .c(new_n64_), .d(x00), .O(new_n72_));
  nor2   g43(.a(new_n72_), .b(new_n52_), .O(z12));
endmodule
