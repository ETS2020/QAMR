...
module FAU ( 
  ...
  nand4  g11(.a(new_n37_), .b(x11), .c(x08), .d(x07), .O(new_n41_));
  ...
  aoi21  g25(.a(new_n51_), .b(new_n33_), .c(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n34_), .c(new_n50_), .d(x00), .O(z08));
  nand2  g27(.a(new_n51_), .b(new_n33_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n52_), .b(x09), .c(x01), .O(new_n67_));
