...
module FAU ( 
  ...
  nand2  g22(.a(new_n51_), .b(x02), .O(new_n52_));
  ...
  inv1   g30(.a(x02), .O(new_n60_));
  nand3  g31(.a(x04), .b(x03), .c(new_n60_), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n60_), .O(new_n62_));
  nand2  g33(.a(x12), .b(new_n59_), .O(new_n63_));
  oai21  g34(.a(new_n62_), .b(new_n59_), .c(new_n63_), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x11), .c(new_n55_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(x10), .c(new_n58_), .O(z09));
  inv1   g37(.a(x12), .O(new_n67_));
  oai21  g38(.a(new_n51_), .b(new_n67_), .c(x02), .O(new_n68_));
  ...
  nand4  g45(.a(x11), .b(new_n50_), .c(new_n59_), .d(x00), .O(new_n75_));
  nor2   g46(.a(new_n75_), .b(new_n67_), .O(z12));
endmodule
