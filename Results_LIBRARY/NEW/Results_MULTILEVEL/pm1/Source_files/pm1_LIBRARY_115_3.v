// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:00 2020
...
module FAU ( 
  ...
  nand3  g25(.a(new_n54_), .b(new_n34_), .c(new_n51_), .O(new_n55_));
  oai21  g26(.a(new_n53_), .b(new_n52_), .c(new_n55_), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(x00), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n35_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g29(.a(x00), .O(new_n59_));
  nand4  g30(.a(new_n52_), .b(new_n46_), .c(x09), .d(x04), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x12), .c(x11), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n55_), .c(new_n59_), .O(z09));
  nand4  g33(.a(new_n52_), .b(x12), .c(x11), .d(x09), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n59_), .O(z10));
  nand4  g35(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand3  g36(.a(new_n54_), .b(new_n51_), .c(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x11), .c(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  inv1   g40(.a(x09), .O(new_n70_));
  nand4  g41(.a(x12), .b(x11), .c(new_n70_), .d(x00), .O(new_n71_));
