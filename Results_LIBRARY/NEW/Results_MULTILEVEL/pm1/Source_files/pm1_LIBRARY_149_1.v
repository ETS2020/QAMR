// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:06 2020
...
module FAU ( 
  ...
  nand2  g01(.a(x07), .b(x06), .O(new_n31_));
  nand3  g02(.a(x08), .b(x07), .c(x06), .O(new_n32_));
  nand2  g03(.a(new_n32_), .b(x08), .O(new_n33_));
  oai21  g04(.a(new_n33_), .b(new_n31_), .c(x11), .O(new_n34_));
  inv1   g05(.a(x11), .O(new_n35_));
  nand2  g06(.a(x12), .b(new_n35_), .O(new_n36_));
  nand3  g07(.a(new_n36_), .b(new_n34_), .c(new_n30_), .O(z00));
  nand2  g08(.a(new_n34_), .b(x12), .O(z01));
  inv1   g09(.a(new_n32_), .O(new_n39_));
  nand4  g10(.a(new_n39_), .b(x12), .c(x11), .d(x09), .O(z02));
  nand4  g11(.a(x11), .b(x08), .c(x07), .d(x06), .O(new_n41_));
  nand4  g12(.a(new_n41_), .b(x12), .c(x11), .d(x09), .O(z03));
  inv1   g13(.a(x14), .O(z04));
  inv1   g14(.a(x13), .O(z05));
  and2   g15(.a(x03), .b(x02), .O(new_n45_));
  nand3  g16(.a(new_n45_), .b(new_n36_), .c(x04), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n51_), .b(new_n35_), .c(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n36_), .c(new_n50_), .d(x00), .O(z08));
  nand2  g27(.a(new_n51_), .b(new_n35_), .O(new_n57_));
  nand4  g28(.a(new_n52_), .b(new_n45_), .c(x09), .d(x04), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(x12), .c(x11), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(new_n50_), .c(x00), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z09));
  inv1   g33(.a(x00), .O(new_n63_));
  inv1   g34(.a(x09), .O(new_n64_));
  nand4  g35(.a(new_n52_), .b(x12), .c(x11), .d(new_n50_), .O(new_n65_));
  ...
  nand4  g39(.a(new_n68_), .b(x11), .c(new_n50_), .d(x00), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z11));
  nand4  g41(.a(x11), .b(new_n50_), .c(new_n64_), .d(x00), .O(new_n71_));
  nor2   g42(.a(new_n71_), .b(new_n51_), .O(z12));
endmodule
