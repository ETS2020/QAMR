// Benchmark "FAU" written by ABC on Mon Jul 27 18:36:51 2020
...
module FAU ( 
  ...
  nor4   g25(.a(new_n54_), .b(new_n52_), .c(new_n34_), .d(new_n53_), .O(new_n55_));
  ...
  nand3  g29(.a(new_n54_), .b(new_n46_), .c(x04), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(x12), .c(new_n53_), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n34_), .c(new_n58_), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n51_), .c(x00), .O(new_n62_));
  inv1   g33(.a(new_n62_), .O(z09));
  inv1   g34(.a(x00), .O(new_n64_));
  nand4  g35(.a(new_n54_), .b(x12), .c(x11), .d(new_n51_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n53_), .c(new_n64_), .O(z10));
  nand4  g37(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  ...
  nand4  g41(.a(x11), .b(new_n51_), .c(new_n53_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z12));
endmodule
