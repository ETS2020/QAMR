// Benchmark "FAU" written by ABC on Mon Jul 27 18:36:43 2020
...
module FAU ( 
  ...
  nor4   g25(.a(new_n54_), .b(new_n53_), .c(new_n34_), .d(new_n52_), .O(new_n55_));
  nor2   g26(.a(x12), .b(x11), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(new_n35_), .c(new_n51_), .d(x00), .O(z08));
  inv1   g29(.a(x00), .O(new_n59_));
  inv1   g30(.a(x04), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x03), .c(x02), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x12), .c(new_n60_), .O(new_n62_));
  nand2  g33(.a(x12), .b(new_n52_), .O(new_n63_));
  oai21  g34(.a(new_n62_), .b(new_n52_), .c(new_n63_), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(x11), .c(new_n56_), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(x10), .c(new_n59_), .O(z09));
  oai21  g37(.a(new_n46_), .b(new_n53_), .c(x04), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x11), .c(new_n51_), .d(x09), .O(new_n68_));
  nor2   g39(.a(new_n68_), .b(new_n59_), .O(z10));
  nand3  g40(.a(new_n67_), .b(x09), .c(x01), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n51_), .c(new_n52_), .d(x00), .O(new_n74_));
