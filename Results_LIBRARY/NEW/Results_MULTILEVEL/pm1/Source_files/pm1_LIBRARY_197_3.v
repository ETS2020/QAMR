...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n42_, new_n46_, new_n47_, new_n48_, new_n50_,
  ...
  nand3  g10(.a(new_n39_), .b(new_n38_), .c(x09), .O(z02));
  inv1   g11(.a(new_n36_), .O(new_n41_));
  nand4  g12(.a(new_n41_), .b(new_n35_), .c(x08), .d(x07), .O(new_n42_));
  ...
  nand3  g20(.a(new_n36_), .b(x08), .c(x07), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(new_n51_));
  aoi21  g22(.a(new_n51_), .b(new_n41_), .c(x15), .O(z07));
  inv1   g23(.a(x10), .O(new_n53_));
  nand4  g24(.a(x04), .b(x03), .c(x02), .d(x00), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n39_), .c(new_n53_), .d(x09), .O(new_n56_));
