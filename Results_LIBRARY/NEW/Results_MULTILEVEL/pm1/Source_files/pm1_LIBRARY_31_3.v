...
module FAU ( 
  ...
  nand4  g28(.a(new_n57_), .b(new_n35_), .c(new_n50_), .d(x00), .O(z08));
  inv1   g29(.a(x00), .O(new_n59_));
  inv1   g30(.a(new_n53_), .O(new_n60_));
  ...
  aoi21  g35(.a(new_n64_), .b(new_n60_), .c(new_n59_), .O(z09));
  inv1   g36(.a(x09), .O(new_n66_));
  nand4  g37(.a(new_n51_), .b(x12), .c(x11), .d(new_n50_), .O(new_n67_));
  nor3   g38(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z10));
  nand4  g39(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n69_));
  nand2  g40(.a(new_n54_), .b(new_n30_), .O(new_n70_));
  ...
  nand4  g44(.a(x11), .b(new_n50_), .c(new_n66_), .d(x00), .O(new_n74_));
  nor2   g45(.a(new_n74_), .b(new_n54_), .O(z12));
endmodule
