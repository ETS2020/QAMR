...
module FAU ( 
  ...
  nand2  g18(.a(x12), .b(new_n39_), .O(new_n48_));
  ...
  nand3  g27(.a(new_n56_), .b(x11), .c(new_n53_), .O(z08));
  nand4  g28(.a(new_n54_), .b(new_n47_), .c(x09), .d(x04), .O(new_n58_));
  nand3  g29(.a(new_n58_), .b(x12), .c(x11), .O(new_n59_));
  nand3  g30(.a(new_n31_), .b(new_n39_), .c(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(x10), .O(z09));
  inv1   g32(.a(x09), .O(new_n62_));
  nand4  g33(.a(new_n54_), .b(x12), .c(x11), .d(new_n53_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n62_), .O(z10));
  nand2  g35(.a(new_n31_), .b(new_n30_), .O(new_n65_));
  nand4  g36(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(x11), .c(new_n53_), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  nand4  g40(.a(x12), .b(x11), .c(new_n53_), .d(new_n62_), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(z12));
endmodule
