...
module FAU ( 
  ...
  nand3  g65(.a(new_n82_), .b(new_n80_), .c(x2), .O(new_n83_));
  oai21  g66(.a(new_n81_), .b(new_n31_), .c(new_n26_), .O(new_n84_));
  nand2  g67(.a(x3), .b(new_n31_), .O(new_n85_));
  oai21  g68(.a(new_n85_), .b(new_n18_), .c(new_n84_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(x6), .O(new_n87_));
  oai21  g70(.a(new_n21_), .b(x0), .c(new_n33_), .O(new_n88_));
  ...
  oai21  g74(.a(new_n85_), .b(new_n26_), .c(new_n91_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n18_), .O(new_n93_));
  aoi21  g76(.a(x3), .b(x1), .c(x2), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n21_), .c(x0), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n93_), .O(z5));
  nor2   g79(.a(x5), .b(new_n35_), .O(new_n97_));
  nor2   g80(.a(x6), .b(x4), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n97_), .c(x0), .O(new_n99_));
  aoi21  g82(.a(x6), .b(new_n35_), .c(new_n30_), .O(new_n100_));
  oai21  g83(.a(x5), .b(x0), .c(new_n19_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n100_), .c(x3), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n99_), .c(new_n31_), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(z8), .c(x1), .O(new_n104_));
  nand3  g87(.a(x3), .b(new_n31_), .c(new_n26_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n104_), .O(z6));
  nand2  g89(.a(new_n91_), .b(new_n85_), .O(z7));
  nand2  g90(.a(new_n22_), .b(new_n18_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(x5), .O(new_n109_));
  aoi21  g92(.a(new_n109_), .b(new_n19_), .c(new_n35_), .O(z9));
endmodule
