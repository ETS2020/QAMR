...
module FAU ( 
  ...
  inv1   g123(.a(new_n151_), .O(z7));
  oai21  g124(.a(new_n36_), .b(x06), .c(x03), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(z7), .O(new_n159_));
  nand2  g126(.a(new_n113_), .b(new_n112_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n57_), .c(x14), .d(x11), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n159_), .c(new_n156_), .O(z6));
endmodule
