...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n72_), .c(new_n71_), .d(new_n39_), .O(new_n80_));
  ...
  nand4  g056(.a(new_n89_), .b(new_n74_), .c(new_n73_), .d(new_n36_), .O(new_n90_));
  nor2   g057(.a(new_n90_), .b(x17), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n71_), .c(new_n55_), .d(new_n35_), .O(new_n92_));
  ...
  aoi21  g074(.a(new_n107_), .b(new_n106_), .c(new_n36_), .O(new_n108_));
  ...
  nand4  g080(.a(new_n77_), .b(new_n36_), .c(new_n39_), .d(new_n35_), .O(new_n114_));
  ...
  nand3  g085(.a(new_n89_), .b(new_n36_), .c(new_n35_), .O(new_n119_));
  nor4   g086(.a(new_n119_), .b(x08), .c(x06), .d(x03), .O(new_n120_));
  nand4  g087(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n121_));
  nand3  g088(.a(x24), .b(x20), .c(x18), .O(new_n122_));
  nor4   g089(.a(new_n122_), .b(new_n121_), .c(new_n39_), .d(new_n35_), .O(new_n123_));
  aoi21  g090(.a(new_n120_), .b(new_n66_), .c(new_n123_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n118_), .O(z3));
  aoi21  g092(.a(new_n74_), .b(x04), .c(x17), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x22), .c(new_n70_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n71_), .c(x08), .O(new_n128_));
  nand2  g095(.a(x24), .b(x07), .O(new_n129_));
  nand3  g096(.a(new_n40_), .b(x19), .c(x13), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n129_), .c(new_n50_), .O(new_n131_));
  nand3  g098(.a(new_n51_), .b(new_n47_), .c(new_n44_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g100(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n73_), .c(x09), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x16), .c(new_n69_), .O(new_n136_));
  nand3  g103(.a(new_n40_), .b(x15), .c(x13), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n107_), .c(new_n50_), .O(new_n138_));
  nand3  g105(.a(x24), .b(x18), .c(x13), .O(new_n139_));
  nand3  g106(.a(x15), .b(new_n37_), .c(new_n50_), .O(new_n140_));
  nand4  g107(.a(new_n40_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n140_), .c(new_n139_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n136_), .c(new_n133_), .d(new_n128_), .O(z4));
  inv1   g111(.a(new_n133_), .O(z5));
  nand2  g112(.a(x20), .b(new_n39_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n34_), .c(x11), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(x03), .c(new_n131_), .d(new_n48_), .O(new_n148_));
  nor2   g115(.a(x20), .b(x06), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x11), .c(new_n67_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x19), .O(new_n151_));
  oai21  g118(.a(new_n35_), .b(x06), .c(x03), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x15), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n37_), .c(new_n50_), .O(new_n155_));
  nand2  g122(.a(new_n36_), .b(x14), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x06), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(x21), .c(new_n46_), .d(new_n45_), .O(new_n158_));
  oai21  g125(.a(new_n37_), .b(x06), .c(new_n156_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x15), .c(x05), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n158_), .c(x24), .O(new_n161_));
  nand2  g128(.a(new_n87_), .b(new_n34_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n156_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x24), .c(x18), .O(new_n164_));
  inv1   g131(.a(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n161_), .c(x11), .O(new_n166_));
  nand2  g133(.a(new_n141_), .b(new_n139_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n138_), .c(new_n67_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n166_), .c(new_n155_), .d(new_n148_), .O(z6));
  inv1   g136(.a(new_n143_), .O(z7));
endmodule
