...
module FAU ( 
  ...
  nor2   g75(.a(x16), .b(new_n81_), .O(new_n109_));
  aoi21  g76(.a(new_n59_), .b(x04), .c(x17), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(x22), .c(new_n54_), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(new_n56_), .c(x08), .O(new_n112_));
  oai22  g79(.a(new_n112_), .b(new_n49_), .c(new_n109_), .d(new_n77_), .O(z4));
  inv1   g80(.a(new_n49_), .O(z5));
  nand2  g81(.a(x20), .b(new_n69_), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n35_), .O(new_n116_));
  aoi21  g83(.a(new_n116_), .b(new_n36_), .c(x03), .O(new_n117_));
  nand2  g84(.a(new_n58_), .b(x14), .O(new_n118_));
  nand2  g85(.a(new_n118_), .b(x06), .O(new_n119_));
  aoi21  g86(.a(new_n119_), .b(x11), .c(new_n34_), .O(new_n120_));
  oai22  g87(.a(new_n120_), .b(new_n77_), .c(new_n117_), .d(new_n49_), .O(z6));
  inv1   g88(.a(new_n77_), .O(z7));
endmodule
