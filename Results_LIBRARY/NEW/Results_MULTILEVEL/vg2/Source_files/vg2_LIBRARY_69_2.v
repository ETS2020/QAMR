...
module FAU ( 
  ...
  nand4  g057(.a(new_n90_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n91_));
  ...
  nand4  g068(.a(new_n90_), .b(new_n70_), .c(x19), .d(new_n69_), .O(new_n102_));
  ...
  nand2  g108(.a(new_n55_), .b(x17), .O(new_n142_));
  nand2  g109(.a(new_n90_), .b(x04), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n142_), .c(new_n67_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n68_), .c(x08), .O(new_n145_));
  oai21  g112(.a(new_n69_), .b(new_n65_), .c(x22), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n66_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n115_), .c(new_n145_), .d(new_n49_), .O(z4));
