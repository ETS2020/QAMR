...
module FAU ( 
  ...
  nand4  g054(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n88_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n66_), .d(new_n35_), .O(new_n94_));
  nand4  g061(.a(new_n70_), .b(new_n69_), .c(new_n68_), .d(new_n53_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nor2   g063(.a(x23), .b(x22), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n71_), .d(x19), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n94_), .c(new_n91_), .O(new_n99_));
  ...
  nor3   g069(.a(new_n102_), .b(x23), .c(x22), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n104_));
  nor2   g071(.a(new_n104_), .b(x14), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n53_), .c(new_n36_), .d(new_n67_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(x08), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(x07), .c(new_n35_), .d(new_n65_), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(x03), .O(new_n109_));
  aoi21  g076(.a(new_n109_), .b(new_n64_), .c(new_n101_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n85_), .O(z1));
  inv1   g078(.a(x15), .O(new_n112_));
  nand2  g079(.a(new_n46_), .b(new_n37_), .O(new_n113_));
  ...
  nand4  g098(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n132_));
  nand4  g099(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n46_), .c(new_n37_), .O(new_n135_));
  nor4   g102(.a(new_n102_), .b(x20), .c(x14), .d(x11), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n66_), .c(x07), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(x06), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n34_), .c(new_n64_), .O(new_n139_));
  ...
  aoi21  g109(.a(new_n142_), .b(new_n69_), .c(x08), .O(new_n143_));
  aoi21  g110(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n72_), .c(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n66_), .O(new_n146_));
  nand2  g113(.a(x24), .b(x18), .O(new_n147_));
  nand3  g114(.a(new_n39_), .b(x15), .c(x13), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n147_), .c(new_n37_), .O(new_n149_));
  nand3  g116(.a(x24), .b(x18), .c(x13), .O(new_n150_));
  nand3  g117(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n150_), .c(new_n116_), .O(new_n152_));
  nor2   g119(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n146_), .c(new_n143_), .d(new_n49_), .O(z4));
  inv1   g121(.a(new_n49_), .O(z5));
  nand2  g122(.a(x20), .b(new_n68_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n35_), .c(x11), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x03), .c(z5), .O(new_n158_));
  nand2  g125(.a(new_n71_), .b(x14), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x06), .c(new_n36_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n34_), .c(new_n117_), .d(new_n115_), .O(new_n161_));
  oai21  g128(.a(x14), .b(new_n35_), .c(x11), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x03), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n113_), .c(x24), .d(x18), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n161_), .c(new_n158_), .O(z6));
  inv1   g132(.a(new_n153_), .O(z7));
endmodule
