...
module FAU ( 
  ...
  nand4  g007(.a(new_n40_), .b(x19), .c(new_n39_), .d(x13), .O(new_n41_));
  ...
  aoi21  g018(.a(new_n49_), .b(new_n39_), .c(new_n51_), .O(new_n52_));
  nand2  g019(.a(new_n52_), .b(new_n43_), .O(new_n53_));
  ...
  nor2   g031(.a(x04), .b(x03), .O(new_n65_));
  ...
  nand4  g036(.a(new_n69_), .b(new_n65_), .c(new_n56_), .d(x00), .O(new_n70_));
  inv1   g037(.a(x22), .O(new_n71_));
  inv1   g038(.a(x12), .O(new_n72_));
  inv1   g039(.a(x16), .O(new_n73_));
  inv1   g040(.a(x17), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(new_n73_), .c(new_n39_), .d(new_n72_), .O(new_n75_));
  inv1   g042(.a(new_n75_), .O(new_n76_));
  nor2   g043(.a(x24), .b(x23), .O(new_n77_));
  nand4  g044(.a(new_n77_), .b(new_n76_), .c(new_n71_), .d(new_n36_), .O(new_n78_));
  oai21  g045(.a(new_n78_), .b(new_n70_), .c(new_n64_), .O(new_n79_));
  ...
  nand3  g059(.a(new_n82_), .b(x19), .c(new_n39_), .O(new_n93_));
  nand2  g060(.a(new_n93_), .b(new_n50_), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(new_n42_), .c(new_n92_), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(x22), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n36_), .c(new_n74_), .d(new_n73_), .O(new_n97_));
  ...
  nand4  g067(.a(new_n100_), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n101_));
  ...
  nand4  g078(.a(new_n34_), .b(new_n57_), .c(new_n56_), .d(x00), .O(new_n112_));
  nor2   g079(.a(x11), .b(x08), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n40_), .c(new_n36_), .d(new_n39_), .O(new_n114_));
  ...
  nand3  g086(.a(new_n93_), .b(new_n50_), .c(new_n43_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n36_), .c(new_n35_), .d(new_n66_), .O(new_n121_));
  inv1   g088(.a(new_n121_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n34_), .c(new_n57_), .d(new_n56_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n119_), .c(new_n116_), .O(z3));
  aoi21  g091(.a(new_n92_), .b(x04), .c(x17), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(x22), .c(new_n67_), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n73_), .c(x08), .O(new_n127_));
  nand3  g094(.a(new_n40_), .b(x19), .c(x13), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n38_), .c(new_n37_), .O(new_n129_));
  nor3   g096(.a(new_n129_), .b(new_n51_), .c(new_n49_), .O(new_n130_));
  aoi21  g097(.a(x23), .b(new_n58_), .c(new_n74_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n71_), .c(x09), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(x16), .c(new_n66_), .O(new_n133_));
  nand2  g100(.a(x24), .b(x18), .O(new_n134_));
  nand3  g101(.a(new_n40_), .b(x15), .c(x13), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n134_), .c(new_n37_), .O(new_n136_));
  nand3  g103(.a(x24), .b(x18), .c(x13), .O(new_n137_));
  nand3  g104(.a(x15), .b(new_n44_), .c(new_n37_), .O(new_n138_));
  nand4  g105(.a(new_n40_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n138_), .c(new_n137_), .O(new_n140_));
  nor2   g107(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n133_), .c(new_n130_), .d(new_n127_), .O(z4));
  inv1   g109(.a(new_n130_), .O(z5));
  inv1   g110(.a(new_n48_), .O(new_n144_));
  nand2  g111(.a(x20), .b(new_n39_), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n148_), .b(new_n83_), .c(new_n147_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n144_), .c(new_n146_), .d(x03), .O(new_n150_));
  nor2   g117(.a(x20), .b(x06), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x11), .c(new_n57_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x07), .O(new_n153_));
  oai21  g120(.a(new_n35_), .b(x06), .c(x03), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x18), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n83_), .c(x24), .O(new_n157_));
  nand2  g124(.a(new_n36_), .b(x14), .O(new_n158_));
  nand2  g125(.a(new_n40_), .b(new_n34_), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n158_), .c(new_n35_), .O(new_n160_));
  nor2   g127(.a(x24), .b(x03), .O(new_n161_));
  nand3  g128(.a(x15), .b(x13), .c(x05), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n104_), .O(new_n163_));
  oai21  g130(.a(new_n161_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g131(.a(new_n36_), .b(x14), .c(new_n34_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n35_), .c(x03), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(x15), .c(new_n44_), .d(new_n37_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n164_), .c(new_n157_), .d(new_n150_), .O(z6));
  inv1   g135(.a(new_n141_), .O(z7));
endmodule
