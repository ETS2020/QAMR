...
module FAU ( 
  ...
  nand4  g048(.a(new_n81_), .b(new_n63_), .c(x07), .d(new_n37_), .O(new_n82_));
  inv1   g049(.a(x17), .O(new_n83_));
  inv1   g050(.a(x20), .O(new_n84_));
  inv1   g051(.a(x12), .O(new_n85_));
  inv1   g052(.a(x16), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n36_), .c(new_n85_), .d(new_n35_), .O(new_n87_));
  inv1   g054(.a(new_n87_), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n70_), .c(new_n84_), .d(new_n83_), .O(new_n89_));
  ...
  nand3  g060(.a(new_n93_), .b(new_n34_), .c(new_n48_), .O(new_n94_));
  inv1   g061(.a(x04), .O(new_n95_));
  inv1   g062(.a(x08), .O(new_n96_));
  nand4  g063(.a(new_n49_), .b(new_n62_), .c(new_n96_), .d(new_n95_), .O(new_n97_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n98_), .c(new_n88_), .O(new_n103_));
  ...
  nand4  g089(.a(x07), .b(new_n37_), .c(new_n34_), .d(new_n105_), .O(new_n123_));
  nand4  g090(.a(new_n84_), .b(new_n36_), .c(new_n35_), .d(new_n96_), .O(new_n124_));
  ...
  nor3   g093(.a(x08), .b(x03), .c(x02), .O(new_n127_));
  ...
  aoi21  g098(.a(new_n100_), .b(x04), .c(x17), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(x22), .c(new_n62_), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(new_n86_), .c(x08), .O(new_n134_));
  nand3  g101(.a(new_n50_), .b(new_n45_), .c(new_n43_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(new_n42_), .O(new_n136_));
  aoi21  g103(.a(x23), .b(new_n95_), .c(new_n83_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n99_), .c(x09), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x16), .c(new_n96_), .O(new_n139_));
  nand4  g106(.a(new_n40_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n110_), .c(new_n109_), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n108_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(z4));
  inv1   g110(.a(new_n136_), .O(z5));
  nand3  g111(.a(x20), .b(new_n36_), .c(new_n35_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n34_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(z5), .O(new_n147_));
  nand2  g114(.a(new_n35_), .b(x03), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(x21), .c(new_n49_), .d(new_n48_), .O(new_n149_));
  ...
  nand3  g119(.a(x19), .b(new_n35_), .c(x06), .O(new_n153_));
  ...
  nand3  g125(.a(new_n35_), .b(x07), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n152_), .b(new_n158_), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n73_), .c(x24), .O(new_n161_));
  nand3  g128(.a(new_n154_), .b(new_n44_), .c(new_n38_), .O(new_n162_));
  and2   g129(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n157_), .c(new_n147_), .O(z6));
  inv1   g131(.a(new_n142_), .O(z7));
endmodule
