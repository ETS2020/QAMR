...
module FAU ( 
  ...
  nand4  g030(.a(new_n63_), .b(new_n60_), .c(new_n36_), .d(new_n59_), .O(new_n64_));
  nor2   g031(.a(new_n64_), .b(x16), .O(new_n65_));
  nand4  g032(.a(new_n65_), .b(new_n58_), .c(new_n35_), .d(new_n57_), .O(new_n66_));
  nor2   g033(.a(new_n66_), .b(x08), .O(new_n67_));
  nand4  g034(.a(new_n67_), .b(new_n34_), .c(new_n56_), .d(new_n55_), .O(new_n68_));
  ...
  nor3   g045(.a(new_n78_), .b(new_n36_), .c(new_n59_), .O(new_n79_));
  ...
  oai21  g051(.a(new_n83_), .b(x05), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g059(.a(x14), .b(new_n43_), .c(new_n44_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(x24), .c(x07), .O(new_n94_));
  nand4  g061(.a(x19), .b(new_n37_), .c(new_n44_), .d(new_n43_), .O(new_n95_));
  aoi21  g062(.a(new_n95_), .b(new_n94_), .c(x23), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n60_), .c(new_n36_), .d(new_n59_), .O(new_n97_));
  nor3   g064(.a(new_n97_), .b(x16), .c(x12), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n35_), .c(new_n57_), .d(new_n72_), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(x06), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n56_), .c(new_n55_), .d(new_n69_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n92_), .c(new_n82_), .O(z1));
  nand4  g069(.a(new_n39_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  inv1   g071(.a(new_n104_), .O(new_n105_));
  oai21  g072(.a(new_n83_), .b(x05), .c(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(x20), .c(x14), .d(x11), .O(new_n107_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n36_), .c(new_n35_), .d(new_n72_), .O(new_n112_));
  nor4   g079(.a(new_n112_), .b(x06), .c(x03), .d(x01), .O(new_n113_));
  nand3  g080(.a(new_n73_), .b(new_n70_), .c(x03), .O(new_n114_));
  nand3  g081(.a(x21), .b(x20), .c(x14), .O(new_n115_));
  nor4   g082(.a(new_n115_), .b(new_n114_), .c(new_n35_), .d(x10), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(new_n113_), .c(new_n39_), .O(new_n117_));
  nand4  g084(.a(new_n85_), .b(x20), .c(x14), .d(x11), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n72_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x06), .c(x03), .d(x01), .O(new_n120_));
  nand2  g087(.a(new_n95_), .b(new_n94_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n36_), .c(new_n35_), .d(new_n72_), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n34_), .c(new_n55_), .d(new_n69_), .O(new_n124_));
  ...
  aoi21  g101(.a(x23), .b(new_n56_), .c(new_n59_), .O(new_n135_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n141_), .c(new_n103_), .O(new_n143_));
  ...
  aoi21  g113(.a(x20), .b(new_n37_), .c(x06), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x11), .c(new_n55_), .O(new_n148_));
  nand3  g115(.a(x24), .b(x07), .c(x05), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n48_), .c(new_n45_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g118(.a(new_n39_), .b(x19), .c(x05), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n132_), .O(new_n153_));
  nor2   g120(.a(x20), .b(x06), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x11), .c(new_n55_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g123(.a(new_n39_), .b(x15), .c(x05), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n138_), .O(new_n158_));
  ...
  inv1   g129(.a(new_n142_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n104_), .c(new_n159_), .O(new_n164_));
  nand4  g131(.a(new_n106_), .b(new_n36_), .c(x14), .d(x11), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n151_), .O(z6));
