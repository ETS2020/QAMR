...
module FAU ( 
  ...
  nor3   g044(.a(new_n77_), .b(new_n58_), .c(new_n69_), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(x11), .c(x06), .d(x03), .O(new_n79_));
  nor2   g046(.a(new_n79_), .b(new_n68_), .O(z2));
  ...
  nand4  g057(.a(new_n90_), .b(new_n58_), .c(new_n69_), .d(new_n36_), .O(new_n91_));
  nor2   g058(.a(new_n91_), .b(x08), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n93_));
  ...
  nand4  g065(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n99_));
  nand4  g066(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n100_));
  nand4  g067(.a(new_n58_), .b(new_n69_), .c(new_n36_), .d(new_n81_), .O(new_n101_));
  oai22  g068(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n97_), .c(x24), .O(new_n103_));
  nand4  g070(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n104_));
  nand4  g071(.a(new_n81_), .b(new_n35_), .c(new_n34_), .d(new_n68_), .O(new_n105_));
  nand4  g072(.a(new_n58_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n98_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n46_), .c(new_n37_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n103_), .c(new_n95_), .O(z3));
  nand3  g076(.a(new_n39_), .b(x13), .c(x05), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  inv1   g078(.a(x19), .O(new_n112_));
  aoi21  g079(.a(new_n59_), .b(x04), .c(x17), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(x22), .c(new_n54_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n56_), .c(x08), .O(new_n115_));
  nand2  g082(.a(x15), .b(new_n81_), .O(new_n116_));
  oai21  g083(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n111_), .O(new_n118_));
  inv1   g085(.a(x07), .O(new_n119_));
  nand2  g086(.a(x18), .b(new_n81_), .O(new_n120_));
  oai21  g087(.a(new_n115_), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n97_), .c(x24), .O(new_n122_));
  inv1   g089(.a(x00), .O(new_n123_));
  nand2  g090(.a(x21), .b(new_n81_), .O(new_n124_));
  oai21  g091(.a(new_n115_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n122_), .c(new_n118_), .O(z4));
  inv1   g094(.a(new_n49_), .O(z5));
  nand2  g095(.a(x20), .b(new_n69_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n35_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n36_), .c(x03), .O(new_n131_));
  nand2  g098(.a(new_n58_), .b(x14), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(x06), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x11), .c(new_n34_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n77_), .c(new_n131_), .d(new_n49_), .O(z6));
  inv1   g102(.a(new_n77_), .O(z7));
endmodule
