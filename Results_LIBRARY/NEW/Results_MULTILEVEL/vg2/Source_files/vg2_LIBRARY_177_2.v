...
module FAU ( 
  ...
  nand4  g067(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(x19), .O(new_n101_));
  ...
  nor3   g081(.a(new_n114_), .b(new_n69_), .c(new_n54_), .O(new_n115_));
  ...
  nand4  g089(.a(new_n122_), .b(new_n69_), .c(new_n54_), .d(new_n36_), .O(new_n123_));
  ...
  nand4  g098(.a(new_n69_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n132_));
  ...
  nand4  g103(.a(new_n69_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n137_));
  ...
  aoi21  g111(.a(x23), .b(new_n65_), .c(new_n144_), .O(new_n145_));
  ...
  nand2  g119(.a(new_n69_), .b(x14), .O(new_n153_));
