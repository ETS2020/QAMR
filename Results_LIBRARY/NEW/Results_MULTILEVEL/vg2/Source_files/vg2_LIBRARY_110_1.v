...
module FAU ( 
  ...
  nand3  g061(.a(x16), .b(x15), .c(x12), .O(new_n95_));
  ...
  nor3   g083(.a(new_n116_), .b(new_n68_), .c(new_n108_), .O(new_n117_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n68_), .c(new_n108_), .d(new_n36_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n68_), .b(new_n108_), .c(new_n36_), .d(new_n66_), .O(new_n134_));
  ...
  nand4  g105(.a(new_n68_), .b(x19), .c(new_n108_), .d(new_n36_), .O(new_n139_));
