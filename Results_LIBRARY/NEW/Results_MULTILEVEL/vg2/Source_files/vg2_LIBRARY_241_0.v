...
module FAU ( 
  ...
  nand2  g040(.a(new_n46_), .b(new_n37_), .O(new_n74_));
  ...
  nand4  g056(.a(x04), .b(x03), .c(new_n43_), .d(x01), .O(new_n90_));
  nand3  g057(.a(new_n56_), .b(new_n44_), .c(x09), .O(new_n91_));
  ...
  nand3  g063(.a(new_n39_), .b(x23), .c(x21), .O(new_n97_));
  nor3   g064(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n89_), .c(new_n77_), .O(z1));
  ...
  nor3   g077(.a(new_n110_), .b(new_n96_), .c(new_n102_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(x11), .c(x06), .d(x03), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n101_), .O(z2));
  ...
  nand4  g089(.a(new_n122_), .b(new_n96_), .c(new_n102_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x08), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n35_), .c(new_n34_), .d(new_n101_), .O(new_n125_));
  ...
  nand4  g096(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n101_), .O(new_n130_));
  nand4  g097(.a(new_n96_), .b(new_n102_), .c(new_n36_), .d(new_n55_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n74_), .c(x24), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  nand3  g101(.a(new_n65_), .b(new_n34_), .c(new_n101_), .O(new_n135_));
  nand3  g102(.a(new_n70_), .b(new_n102_), .c(new_n36_), .O(new_n136_));
  ...
  inv1   g107(.a(new_n49_), .O(z5));
  oai21  g108(.a(x16), .b(new_n63_), .c(new_n55_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(z5), .O(new_n143_));
  nand4  g110(.a(x22), .b(x15), .c(x13), .d(x05), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n115_), .O(new_n145_));
  inv1   g112(.a(x23), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x04), .c(x17), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g115(.a(new_n116_), .b(new_n63_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n148_), .c(x24), .O(new_n150_));
  nand3  g117(.a(new_n74_), .b(x24), .c(x18), .O(new_n151_));
  nand2  g118(.a(new_n147_), .b(x22), .O(new_n152_));
  aoi22  g119(.a(new_n152_), .b(x09), .c(new_n151_), .d(new_n107_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n150_), .c(x16), .O(new_n154_));
  inv1   g121(.a(x16), .O(new_n155_));
  nand2  g122(.a(new_n146_), .b(x04), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n95_), .c(x22), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(x19), .c(new_n155_), .O(new_n158_));
  nand2  g125(.a(x15), .b(new_n55_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n76_), .O(new_n161_));
  inv1   g128(.a(new_n74_), .O(new_n162_));
  nand3  g129(.a(new_n157_), .b(new_n155_), .c(x07), .O(new_n163_));
  nand2  g130(.a(x18), .b(new_n55_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n163_), .c(new_n162_), .O(new_n165_));
  nand3  g132(.a(new_n39_), .b(x21), .c(new_n44_), .O(new_n166_));
  nor3   g133(.a(new_n166_), .b(x08), .c(x02), .O(new_n167_));
  aoi21  g134(.a(new_n165_), .b(x24), .c(new_n167_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n161_), .c(new_n154_), .d(new_n143_), .O(z4));
  nand2  g136(.a(x20), .b(new_n102_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n35_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n36_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n96_), .b(x14), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x06), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x11), .c(new_n34_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n110_), .c(new_n172_), .d(new_n49_), .O(z6));
  inv1   g143(.a(new_n110_), .O(z7));
endmodule
