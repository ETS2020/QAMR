...
module FAU ( 
  ...
  nand3  g037(.a(new_n70_), .b(new_n46_), .c(new_n37_), .O(new_n71_));
  nand2  g038(.a(new_n46_), .b(new_n37_), .O(new_n72_));
  nor2   g039(.a(x09), .b(x08), .O(new_n73_));
  nand4  g040(.a(new_n73_), .b(new_n61_), .c(x07), .d(new_n35_), .O(new_n74_));
  nor2   g041(.a(x12), .b(x11), .O(new_n75_));
  nor2   g042(.a(x16), .b(x14), .O(new_n76_));
  nor2   g043(.a(x20), .b(x17), .O(new_n77_));
  nand4  g044(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n68_), .O(new_n78_));
  nand4  g045(.a(x06), .b(x04), .c(x03), .d(x01), .O(new_n79_));
  nand4  g046(.a(x12), .b(x11), .c(x09), .d(x08), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g048(.a(x18), .b(x17), .c(x16), .d(x14), .O(new_n82_));
  nand4  g049(.a(x24), .b(x23), .c(x22), .d(x20), .O(new_n83_));
  nor2   g050(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  oai21  g052(.a(new_n78_), .b(new_n74_), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n39_), .c(x22), .d(x20), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(x17), .c(x16), .d(x14), .O(new_n94_));
  nor2   g061(.a(new_n94_), .b(new_n88_), .O(new_n95_));
  ...
  nand3  g065(.a(new_n98_), .b(new_n87_), .c(new_n71_), .O(z1));
  ...
  nor3   g077(.a(new_n110_), .b(new_n102_), .c(new_n101_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(x11), .c(x06), .d(x03), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n100_), .O(z2));
  inv1   g080(.a(x08), .O(new_n114_));
  nand4  g081(.a(new_n91_), .b(x20), .c(x14), .d(x11), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nand3  g084(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n118_));
  nand3  g085(.a(x19), .b(x13), .c(x05), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n102_), .c(new_n101_), .d(new_n36_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(x08), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n35_), .c(new_n34_), .d(new_n100_), .O(new_n123_));
  ...
  nand4  g094(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n100_), .O(new_n128_));
  nand4  g095(.a(new_n102_), .b(new_n101_), .c(new_n36_), .d(new_n114_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n72_), .c(x24), .O(new_n131_));
  nand4  g098(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n132_));
  nand3  g099(.a(new_n62_), .b(new_n34_), .c(new_n100_), .O(new_n133_));
  nand3  g100(.a(new_n67_), .b(new_n101_), .c(new_n36_), .O(new_n134_));
  ...
  inv1   g104(.a(new_n49_), .O(z5));
  inv1   g105(.a(x22), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x17), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n60_), .c(x16), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x08), .c(z5), .O(new_n142_));
  inv1   g109(.a(x16), .O(new_n143_));
  inv1   g110(.a(x23), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x04), .c(x17), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x22), .c(new_n60_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n143_), .c(x08), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(x24), .c(x18), .O(new_n148_));
  nand4  g115(.a(new_n68_), .b(new_n143_), .c(x07), .d(x04), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n72_), .O(new_n151_));
  nand2  g118(.a(x17), .b(x04), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x22), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x09), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n91_), .c(new_n39_), .O(new_n155_));
  inv1   g122(.a(new_n146_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(x15), .c(new_n46_), .d(new_n37_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g125(.a(x15), .b(new_n114_), .O(new_n159_));
  nand2  g126(.a(new_n143_), .b(x04), .O(new_n160_));
  nand2  g127(.a(new_n68_), .b(x19), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n160_), .c(new_n159_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n46_), .c(new_n37_), .O(new_n163_));
  nand3  g130(.a(new_n91_), .b(new_n39_), .c(new_n114_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  aoi21  g132(.a(new_n158_), .b(x16), .c(new_n165_), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n151_), .c(new_n142_), .O(z4));
  nand2  g134(.a(x20), .b(new_n101_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n35_), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(new_n36_), .c(x03), .O(new_n170_));
  nand2  g137(.a(new_n102_), .b(x14), .O(new_n171_));
