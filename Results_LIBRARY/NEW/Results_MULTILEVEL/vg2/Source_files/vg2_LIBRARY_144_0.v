...
module FAU ( 
  ...
  nand2  g052(.a(new_n46_), .b(new_n37_), .O(new_n86_));
  nand2  g053(.a(new_n86_), .b(new_n38_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  nor2   g057(.a(new_n90_), .b(x12), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n36_), .c(new_n67_), .d(new_n66_), .O(new_n92_));
  nor2   g059(.a(new_n92_), .b(x06), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n65_), .c(new_n34_), .d(new_n64_), .O(new_n94_));
  nand3  g061(.a(new_n86_), .b(x24), .c(x18), .O(new_n95_));
  nand3  g062(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(x23), .c(x22), .d(x20), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(x17), .c(x16), .d(x14), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n53_), .O(new_n101_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n94_), .c(new_n85_), .O(z1));
  ...
  nand2  g077(.a(new_n107_), .b(x13), .O(new_n111_));
  nand4  g078(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n111_), .c(new_n96_), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nor3   g081(.a(new_n114_), .b(new_n71_), .c(new_n68_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n64_), .O(z2));
  nand4  g084(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  ...
  nand4  g089(.a(new_n122_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x08), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n120_), .O(new_n126_));
  ...
  nand4  g096(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n130_));
  nand4  g097(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n86_), .c(x24), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  nand4  g101(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n135_));
  nand4  g102(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n128_), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n46_), .c(new_n37_), .O(new_n138_));
  nand3  g105(.a(new_n138_), .b(new_n133_), .c(new_n127_), .O(z3));
  nor2   g106(.a(new_n73_), .b(new_n72_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n65_), .c(new_n67_), .O(new_n141_));
  oai21  g108(.a(new_n108_), .b(new_n66_), .c(new_n112_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(x22), .c(new_n70_), .O(new_n143_));
  oai21  g110(.a(new_n141_), .b(new_n114_), .c(new_n143_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g112(.a(new_n39_), .b(x13), .c(x05), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n86_), .O(new_n147_));
  inv1   g114(.a(x19), .O(new_n148_));
  aoi21  g115(.a(new_n73_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x22), .c(new_n67_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n69_), .c(x08), .O(new_n151_));
  nand2  g118(.a(x15), .b(new_n66_), .O(new_n152_));
  oai21  g119(.a(new_n151_), .b(new_n148_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n147_), .O(new_n154_));
  nor2   g121(.a(new_n149_), .b(x24), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n156_));
  nand2  g123(.a(new_n86_), .b(x17), .O(new_n157_));
  nand3  g124(.a(new_n73_), .b(x19), .c(x04), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(x24), .c(x07), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n156_), .c(x22), .O(new_n161_));
  nand3  g128(.a(new_n86_), .b(x24), .c(x07), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n45_), .c(new_n67_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n161_), .c(new_n69_), .O(new_n164_));
  inv1   g131(.a(x21), .O(new_n165_));
  nand2  g132(.a(x08), .b(x00), .O(new_n166_));
  oai21  g133(.a(new_n165_), .b(x08), .c(new_n166_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n168_));
  nand2  g135(.a(x08), .b(x07), .O(new_n169_));
  oai21  g136(.a(new_n106_), .b(x08), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n86_), .c(x24), .O(new_n171_));
  and2   g138(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n164_), .c(new_n154_), .d(new_n145_), .O(z4));
  inv1   g140(.a(new_n49_), .O(z5));
  nand2  g141(.a(x20), .b(new_n68_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n35_), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(new_n36_), .c(x03), .O(new_n177_));
  nand2  g144(.a(new_n71_), .b(x14), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(x06), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x11), .c(new_n34_), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(new_n114_), .c(new_n177_), .d(new_n49_), .O(z6));
  inv1   g148(.a(new_n114_), .O(z7));
endmodule
