...
module FAU ( 
  ...
  oai21  g022(.a(new_n54_), .b(x02), .c(new_n55_), .O(new_n56_));
  ...
  nor2   g085(.a(new_n39_), .b(new_n91_), .O(new_n119_));
  ...
  nand3  g091(.a(new_n39_), .b(x21), .c(new_n43_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n71_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x14), .c(x11), .d(x06), .O(new_n129_));
  nor3   g096(.a(new_n129_), .b(new_n34_), .c(new_n64_), .O(z2));
  nand4  g097(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n66_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(x06), .c(x03), .d(x01), .O(new_n133_));
  nand4  g100(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n134_));
  ...
  nor2   g107(.a(new_n68_), .b(new_n36_), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n140_), .c(new_n92_), .O(new_n142_));
  nor2   g109(.a(x03), .b(x01), .O(new_n143_));
  nor2   g110(.a(x11), .b(x08), .O(new_n144_));
  nor2   g111(.a(x20), .b(x14), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n97_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n142_), .c(new_n86_), .O(new_n147_));
  nand4  g114(.a(new_n141_), .b(new_n140_), .c(x20), .d(x15), .O(new_n148_));
  nor2   g115(.a(x14), .b(x11), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n143_), .c(new_n112_), .d(new_n108_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n148_), .c(x13), .O(new_n151_));
  aoi22  g118(.a(new_n151_), .b(new_n37_), .c(new_n147_), .d(x24), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n138_), .O(z3));
  aoi21  g120(.a(new_n73_), .b(x04), .c(x17), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x22), .c(new_n67_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n69_), .c(x08), .O(new_n156_));
  aoi21  g123(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(new_n72_), .c(x09), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x16), .c(new_n66_), .O(new_n159_));
  nand4  g126(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n124_), .c(new_n123_), .O(new_n161_));
  nor2   g128(.a(new_n161_), .b(new_n122_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n159_), .c(new_n156_), .d(new_n49_), .O(z4));
  inv1   g130(.a(new_n49_), .O(z5));
  oai21  g131(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(z5), .O(new_n166_));
  inv1   g133(.a(new_n86_), .O(new_n167_));
  aoi21  g134(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n36_), .c(x03), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x18), .O(new_n170_));
  nand4  g137(.a(x20), .b(new_n68_), .c(new_n36_), .d(x07), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n167_), .c(x24), .O(new_n173_));
  nand3  g140(.a(new_n39_), .b(x13), .c(x05), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n167_), .O(new_n175_));
  nand2  g142(.a(new_n169_), .b(x15), .O(new_n176_));
  nand3  g143(.a(new_n149_), .b(x20), .c(x19), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g145(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  nand3  g146(.a(new_n169_), .b(x21), .c(new_n44_), .O(new_n180_));
  nand4  g147(.a(x20), .b(new_n68_), .c(new_n36_), .d(x00), .O(new_n181_));
  nand2  g148(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n39_), .c(new_n43_), .O(new_n183_));
  nand4  g150(.a(new_n183_), .b(new_n179_), .c(new_n173_), .d(new_n166_), .O(z6));
  inv1   g151(.a(new_n162_), .O(z7));
endmodule
