...
module FAU ( 
  ...
  nand3  g115(.a(x24), .b(new_n66_), .c(x07), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n45_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n148_), .c(new_n72_), .O(new_n151_));
  oai21  g118(.a(new_n49_), .b(new_n67_), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n69_), .O(new_n153_));
  aoi21  g120(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n154_));
