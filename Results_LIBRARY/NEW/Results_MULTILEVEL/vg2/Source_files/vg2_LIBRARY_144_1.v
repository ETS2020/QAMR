...
module FAU ( 
  ...
  aoi21  g122(.a(x22), .b(new_n68_), .c(x16), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x08), .c(x19), .O(new_n157_));
  oai21  g124(.a(new_n148_), .b(new_n100_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  inv1   g126(.a(x00), .O(new_n160_));
  inv1   g127(.a(x21), .O(new_n161_));
  oai22  g128(.a(new_n151_), .b(new_n160_), .c(new_n148_), .d(new_n161_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n159_), .c(new_n153_), .O(z4));
  ...
  nand2  g135(.a(new_n92_), .b(x14), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x06), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x11), .c(new_n34_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n115_), .c(new_n168_), .d(new_n49_), .O(z6));
  inv1   g139(.a(new_n115_), .O(z7));
endmodule
