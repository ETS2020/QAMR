...
module FAU ( 
  ...
  aoi21  g073(.a(new_n106_), .b(new_n87_), .c(new_n37_), .O(new_n107_));
  ...
  nand4  g087(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n121_));
  ...
  nand3  g105(.a(x24), .b(new_n72_), .c(x07), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n40_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x05), .O(new_n141_));
  inv1   g108(.a(new_n47_), .O(new_n142_));
  nand2  g109(.a(new_n45_), .b(new_n42_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n72_), .c(new_n142_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n141_), .c(new_n138_), .O(new_n145_));
  nor2   g112(.a(new_n49_), .b(new_n67_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n145_), .c(new_n69_), .O(new_n147_));
  inv1   g114(.a(new_n86_), .O(new_n148_));
  oai21  g115(.a(new_n69_), .b(x09), .c(x08), .O(new_n149_));
  ...
  nand2  g119(.a(x23), .b(new_n65_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x17), .c(new_n72_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(x18), .c(x16), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n152_), .c(x24), .O(new_n157_));
  nand3  g124(.a(new_n39_), .b(x13), .c(x05), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n86_), .O(new_n159_));
  nand2  g126(.a(new_n149_), .b(x15), .O(new_n160_));
  nand2  g127(.a(new_n154_), .b(x16), .O(new_n161_));
  ...
  aoi21  g134(.a(new_n167_), .b(x16), .c(new_n66_), .O(new_n168_));
  ...
  nand4  g138(.a(new_n171_), .b(new_n164_), .c(new_n157_), .d(new_n147_), .O(z4));
  inv1   g139(.a(new_n49_), .O(z5));
  nand2  g140(.a(x20), .b(new_n68_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n35_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n36_), .c(x03), .O(new_n176_));
  nand2  g143(.a(new_n71_), .b(x14), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(x06), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x11), .c(new_n34_), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n112_), .c(new_n176_), .d(new_n49_), .O(z6));
  inv1   g147(.a(new_n112_), .O(z7));
endmodule
