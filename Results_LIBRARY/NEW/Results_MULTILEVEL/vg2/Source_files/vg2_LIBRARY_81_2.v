...
module FAU ( 
  ...
  nand3  g048(.a(x17), .b(x14), .c(x12), .O(new_n82_));
  ...
  nand4  g054(.a(new_n36_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n88_));
  ...
  nand4  g065(.a(new_n53_), .b(new_n36_), .c(new_n66_), .d(new_n35_), .O(new_n99_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n68_), .c(new_n54_), .O(new_n116_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n68_), .c(new_n54_), .d(new_n36_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n68_), .b(new_n54_), .c(new_n36_), .d(new_n119_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n119_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n138_));
  nand4  g105(.a(new_n68_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n139_));
  ...
  nand2  g113(.a(x23), .b(new_n65_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x17), .c(new_n69_), .O(new_n148_));
  nor3   g115(.a(new_n148_), .b(new_n66_), .c(new_n119_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n115_), .c(new_n146_), .d(new_n49_), .O(z4));
  ...
  oai22  g124(.a(new_n157_), .b(new_n115_), .c(new_n154_), .d(new_n49_), .O(z6));
  inv1   g125(.a(new_n115_), .O(z7));
endmodule
