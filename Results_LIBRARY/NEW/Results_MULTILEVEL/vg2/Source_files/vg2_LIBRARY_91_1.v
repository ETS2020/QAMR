// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:25 2020
...
module FAU ( 
  ...
  nand3  g049(.a(x17), .b(x14), .c(x12), .O(new_n83_));
  ...
  nand4  g069(.a(new_n55_), .b(new_n70_), .c(x19), .d(new_n69_), .O(new_n103_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n109_), .c(new_n54_), .O(new_n118_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n109_), .c(new_n54_), .d(new_n36_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n109_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n135_));
  ...
  nand4  g106(.a(new_n109_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n140_));
  ...
  aoi21  g112(.a(new_n145_), .b(new_n68_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n147_));
  ...
  nand2  g121(.a(new_n109_), .b(x14), .O(new_n155_));
