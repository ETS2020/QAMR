...
module FAU ( 
  ...
  nand4  g045(.a(new_n78_), .b(new_n76_), .c(x20), .d(x18), .O(new_n79_));
  nor2   g046(.a(x09), .b(x08), .O(new_n80_));
  nand4  g047(.a(new_n80_), .b(new_n60_), .c(x07), .d(new_n35_), .O(new_n81_));
  ...
  oai22  g052(.a(new_n85_), .b(new_n81_), .c(new_n79_), .d(new_n55_), .O(new_n86_));
  nand3  g053(.a(new_n86_), .b(new_n70_), .c(x24), .O(new_n87_));
  inv1   g054(.a(x02), .O(new_n88_));
  nand4  g055(.a(x04), .b(x03), .c(new_n88_), .d(x01), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  inv1   g057(.a(x08), .O(new_n91_));
  inv1   g058(.a(x10), .O(new_n92_));
  nand3  g059(.a(x11), .b(new_n92_), .c(x09), .O(new_n93_));
  nor3   g060(.a(new_n93_), .b(new_n91_), .c(new_n35_), .O(new_n94_));
  nand2  g061(.a(x21), .b(x20), .O(new_n95_));
  nor4   g062(.a(new_n95_), .b(x24), .c(new_n75_), .d(new_n74_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n94_), .c(new_n90_), .d(new_n78_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n87_), .c(new_n73_), .O(z1));
  ...
  nand4  g072(.a(new_n40_), .b(x21), .c(new_n92_), .d(new_n88_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n105_), .c(new_n104_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n103_), .c(x20), .O(new_n108_));
  nor2   g075(.a(new_n108_), .b(new_n100_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(x11), .c(x06), .d(x03), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n99_), .O(z2));
  nor2   g078(.a(new_n91_), .b(new_n35_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(x03), .c(x01), .O(new_n113_));
  nor2   g080(.a(new_n100_), .b(new_n36_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(x20), .c(x15), .O(new_n115_));
  nand3  g082(.a(new_n61_), .b(new_n34_), .c(new_n99_), .O(new_n116_));
  nand3  g083(.a(new_n66_), .b(new_n100_), .c(new_n36_), .O(new_n117_));
  oai22  g084(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n113_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n72_), .O(new_n119_));
  nand3  g086(.a(new_n114_), .b(x20), .c(x18), .O(new_n120_));
  nand4  g087(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n99_), .O(new_n121_));
  nand4  g088(.a(new_n37_), .b(new_n100_), .c(new_n36_), .d(new_n91_), .O(new_n122_));
  oai22  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n113_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n70_), .c(x24), .O(new_n124_));
  nor2   g091(.a(x02), .b(new_n99_), .O(new_n125_));
  nand2  g092(.a(new_n114_), .b(new_n92_), .O(new_n126_));
  nand3  g093(.a(new_n40_), .b(x21), .c(x20), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n125_), .c(new_n112_), .d(x03), .O(new_n129_));
  nand3  g096(.a(new_n129_), .b(new_n124_), .c(new_n119_), .O(z3));
  nor2   g097(.a(new_n46_), .b(new_n42_), .O(new_n131_));
  nor2   g098(.a(new_n107_), .b(new_n103_), .O(new_n132_));
  inv1   g099(.a(x04), .O(new_n133_));
  inv1   g100(.a(x17), .O(new_n134_));
  aoi21  g101(.a(x23), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(new_n74_), .c(x09), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x16), .c(new_n91_), .O(new_n137_));
  inv1   g104(.a(x16), .O(new_n138_));
  aoi21  g105(.a(new_n75_), .b(x04), .c(x17), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n59_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n138_), .c(x08), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n131_), .c(new_n137_), .d(new_n132_), .O(z4));
  inv1   g109(.a(new_n131_), .O(z5));
  nand2  g110(.a(new_n37_), .b(x14), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x06), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x11), .c(new_n34_), .O(new_n146_));
  nand2  g113(.a(x20), .b(new_n100_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n35_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n36_), .c(x03), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n131_), .c(new_n146_), .d(new_n132_), .O(z6));
  inv1   g117(.a(new_n132_), .O(z7));
endmodule
