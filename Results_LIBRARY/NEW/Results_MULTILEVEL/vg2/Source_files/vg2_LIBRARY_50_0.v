...
module FAU ( 
  ...
  oai21  g011(.a(new_n44_), .b(new_n40_), .c(x19), .O(new_n45_));
  ...
  nand3  g016(.a(new_n49_), .b(new_n45_), .c(new_n42_), .O(z5));
  ...
  nand3  g039(.a(new_n47_), .b(new_n46_), .c(x00), .O(new_n73_));
  nand2  g040(.a(x19), .b(x13), .O(new_n74_));
  nand2  g041(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g042(.a(new_n75_), .b(new_n72_), .c(new_n71_), .d(new_n39_), .O(new_n76_));
  inv1   g043(.a(new_n76_), .O(new_n77_));
  nand4  g044(.a(new_n77_), .b(new_n70_), .c(new_n69_), .d(new_n38_), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(x12), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n37_), .c(new_n68_), .d(new_n67_), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(x06), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n82_));
  ...
  nor4   g053(.a(new_n86_), .b(new_n66_), .c(new_n35_), .d(new_n34_), .O(new_n87_));
  nand4  g054(.a(x17), .b(x16), .c(x14), .d(x12), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  and2   g056(.a(x20), .b(x18), .O(new_n90_));
  nor2   g057(.a(new_n72_), .b(new_n71_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n87_), .O(new_n92_));
  nor3   g059(.a(x04), .b(x03), .c(x01), .O(new_n93_));
  nand4  g060(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n36_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n69_), .b(new_n38_), .c(new_n55_), .d(new_n37_), .O(new_n96_));
  nand4  g063(.a(new_n72_), .b(new_n71_), .c(new_n39_), .d(new_n70_), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n95_), .c(new_n93_), .O(new_n99_));
  aoi21  g066(.a(new_n99_), .b(new_n92_), .c(new_n40_), .O(new_n100_));
  ...
  nand4  g071(.a(new_n37_), .b(new_n68_), .c(new_n67_), .d(new_n36_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n70_), .b(new_n69_), .c(new_n38_), .d(new_n55_), .O(new_n107_));
  nand4  g074(.a(new_n72_), .b(new_n71_), .c(new_n39_), .d(x19), .O(new_n108_));
  ...
  aoi22  g078(.a(new_n111_), .b(new_n85_), .c(new_n100_), .d(x24), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n84_), .O(z1));
  nand2  g080(.a(x24), .b(x18), .O(new_n114_));
  nand2  g081(.a(new_n48_), .b(x15), .O(new_n115_));
  aoi21  g082(.a(new_n115_), .b(new_n114_), .c(new_n43_), .O(new_n116_));
  nand3  g083(.a(x24), .b(x18), .c(x05), .O(new_n117_));
  nand3  g084(.a(x15), .b(new_n43_), .c(new_n85_), .O(new_n118_));
  nand4  g085(.a(new_n48_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n116_), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n39_), .c(new_n38_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n34_), .O(z2));
  nand4  g091(.a(new_n58_), .b(x20), .c(x14), .d(x11), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  nand4  g094(.a(new_n75_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n128_));
  ...
  nand3  g100(.a(new_n90_), .b(x14), .c(x11), .O(new_n134_));
  nand4  g101(.a(x07), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n135_));
  nand4  g102(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n67_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n67_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n140_));
  ...
  nand3  g109(.a(new_n142_), .b(new_n43_), .c(new_n85_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n138_), .c(new_n132_), .O(z3));
  oai21  g111(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n71_), .c(x09), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x16), .c(new_n67_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(z5), .O(new_n148_));
  inv1   g115(.a(new_n121_), .O(z7));
  oai21  g116(.a(new_n72_), .b(x04), .c(x17), .O(new_n150_));
  ...
  aoi21  g121(.a(x20), .b(new_n38_), .c(x06), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x11), .c(new_n35_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(z5), .O(new_n157_));
  nand2  g124(.a(new_n39_), .b(x14), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x06), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x11), .c(new_n35_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n121_), .c(new_n157_), .O(z6));
endmodule
