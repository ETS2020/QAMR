...
module FAU ( 
  ...
  aoi21  g061(.a(new_n94_), .b(new_n87_), .c(new_n80_), .O(new_n95_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n109_), .c(new_n53_), .O(new_n118_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n53_), .c(new_n36_), .d(new_n66_), .O(new_n125_));
  nor4   g092(.a(new_n125_), .b(x06), .c(x03), .d(x01), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n123_), .c(new_n39_), .O(new_n127_));
  nor3   g094(.a(x06), .b(x03), .c(x01), .O(new_n128_));
  nor2   g095(.a(x14), .b(x11), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n66_), .d(x07), .O(new_n130_));
  nand3  g097(.a(x06), .b(x03), .c(x01), .O(new_n131_));
  inv1   g098(.a(new_n131_), .O(new_n132_));
  nor2   g099(.a(new_n53_), .b(new_n36_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n132_), .c(new_n85_), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(new_n130_), .c(new_n80_), .O(new_n135_));
  nor2   g102(.a(x11), .b(x08), .O(new_n136_));
  nand4  g103(.a(new_n136_), .b(new_n128_), .c(x19), .d(new_n53_), .O(new_n137_));
  nand4  g104(.a(new_n133_), .b(new_n132_), .c(x20), .d(x15), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n137_), .c(x13), .O(new_n139_));
  aoi22  g106(.a(new_n139_), .b(new_n37_), .c(new_n135_), .d(x24), .O(new_n140_));
  ...
  aoi21  g110(.a(new_n143_), .b(new_n54_), .c(x08), .O(new_n144_));
