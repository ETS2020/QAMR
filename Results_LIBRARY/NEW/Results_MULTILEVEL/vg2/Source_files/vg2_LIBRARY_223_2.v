...
module FAU ( 
  ...
  nand3  g024(.a(new_n57_), .b(x22), .c(x21), .O(new_n58_));
  aoi21  g025(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(new_n59_));
  nand4  g026(.a(new_n59_), .b(x20), .c(x17), .d(x16), .O(new_n60_));
  ...
  nor4   g052(.a(new_n85_), .b(new_n66_), .c(new_n34_), .d(new_n65_), .O(new_n86_));
  ...
  nand4  g058(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n35_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n69_), .b(new_n54_), .c(new_n53_), .d(new_n36_), .O(new_n94_));
  nand4  g061(.a(new_n55_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand3  g063(.a(new_n96_), .b(new_n93_), .c(new_n91_), .O(new_n97_));
  aoi22  g064(.a(new_n97_), .b(new_n90_), .c(new_n46_), .d(new_n37_), .O(new_n98_));
  nand3  g065(.a(x15), .b(x14), .c(x12), .O(new_n99_));
  nand4  g066(.a(x23), .b(x20), .c(x17), .d(x16), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  nand4  g069(.a(new_n36_), .b(new_n68_), .c(new_n67_), .d(new_n35_), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  nand4  g071(.a(new_n70_), .b(new_n69_), .c(new_n54_), .d(new_n53_), .O(new_n105_));
  nand4  g072(.a(new_n55_), .b(new_n72_), .c(new_n71_), .d(x19), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n104_), .c(new_n91_), .O(new_n108_));
  aoi21  g075(.a(new_n108_), .b(new_n102_), .c(x13), .O(new_n109_));
  aoi22  g076(.a(new_n109_), .b(new_n37_), .c(new_n98_), .d(x24), .O(new_n110_));
  ...
  nand4  g094(.a(new_n75_), .b(new_n71_), .c(new_n54_), .d(new_n36_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n130_));
  ...
  nand4  g103(.a(new_n71_), .b(new_n54_), .c(new_n36_), .d(new_n67_), .O(new_n137_));
  ...
  nand4  g108(.a(new_n71_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n142_));
  ...
  oai21  g113(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n147_));
  ...
  nand3  g118(.a(x24), .b(x22), .c(x18), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n113_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x05), .O(new_n154_));
  inv1   g121(.a(new_n116_), .O(new_n155_));
  nand2  g122(.a(new_n117_), .b(new_n115_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x22), .c(new_n155_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n154_), .c(new_n151_), .O(new_n158_));
  nor2   g125(.a(new_n119_), .b(x09), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n158_), .c(x16), .O(new_n160_));
  inv1   g127(.a(new_n119_), .O(z7));
  nand2  g128(.a(z7), .b(new_n67_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n160_), .c(new_n150_), .O(z4));
  nand2  g130(.a(x20), .b(new_n54_), .O(new_n164_));
  ...
  oai22  g136(.a(new_n169_), .b(new_n119_), .c(new_n166_), .d(new_n49_), .O(z6));
endmodule
