...
module FAU ( 
  ...
  aoi21  g123(.a(x20), .b(new_n68_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n34_), .O(new_n158_));
  inv1   g125(.a(x07), .O(new_n159_));
  nand2  g126(.a(new_n136_), .b(x24), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n159_), .c(new_n45_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand3  g129(.a(new_n39_), .b(x13), .c(x05), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n136_), .O(new_n164_));
  inv1   g131(.a(x15), .O(new_n165_));
  oai22  g132(.a(x20), .b(new_n68_), .c(new_n165_), .d(x06), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(x11), .O(new_n167_));
  aoi21  g134(.a(x14), .b(new_n35_), .c(x11), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x03), .c(x19), .O(new_n169_));
  nand2  g136(.a(x15), .b(new_n34_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n169_), .c(new_n167_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n164_), .O(new_n172_));
  oai21  g139(.a(new_n36_), .b(x06), .c(x03), .O(new_n173_));
  oai21  g140(.a(new_n160_), .b(new_n91_), .c(new_n122_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g142(.a(new_n122_), .b(new_n117_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n71_), .c(x14), .d(x11), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n175_), .c(new_n172_), .d(new_n162_), .O(z6));
