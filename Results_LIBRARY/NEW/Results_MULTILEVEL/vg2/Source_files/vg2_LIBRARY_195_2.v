...
module FAU ( 
  ...
  nand4  g055(.a(x23), .b(x22), .c(x18), .d(x17), .O(new_n89_));
  nor4   g056(.a(new_n89_), .b(new_n69_), .c(new_n68_), .d(new_n53_), .O(new_n90_));
  ...
  aoi21  g065(.a(new_n98_), .b(new_n91_), .c(new_n86_), .O(new_n99_));
  ...
  nand4  g080(.a(new_n39_), .b(x20), .c(x15), .d(x13), .O(new_n114_));
  ...
  inv1   g087(.a(new_n113_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(x13), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n120_), .c(new_n116_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x14), .c(x11), .d(x06), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n34_), .c(new_n64_), .O(z2));
  ...
  inv1   g100(.a(new_n86_), .O(new_n134_));
  nand3  g101(.a(x06), .b(x03), .c(x01), .O(new_n135_));
  nand4  g102(.a(x18), .b(x14), .c(x11), .d(x08), .O(new_n136_));
  nand4  g103(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n137_));
  nand4  g104(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n138_));
  ...
  oai21  g115(.a(new_n148_), .b(x22), .c(new_n67_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n69_), .c(x08), .O(new_n150_));
  aoi21  g117(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n72_), .c(x09), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x16), .c(new_n66_), .O(new_n153_));
  inv1   g120(.a(new_n122_), .O(new_n154_));
  nand3  g121(.a(new_n39_), .b(x15), .c(x13), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n113_), .c(new_n37_), .O(new_n156_));
  nor3   g123(.a(new_n156_), .b(new_n154_), .c(new_n119_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n153_), .c(new_n150_), .d(new_n49_), .O(z4));
  inv1   g125(.a(new_n49_), .O(z5));
  nand2  g126(.a(x20), .b(new_n68_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n35_), .c(x11), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x03), .c(z5), .O(new_n162_));
  inv1   g129(.a(new_n118_), .O(new_n163_));
  nand2  g130(.a(new_n71_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n36_), .O(new_n165_));
  inv1   g132(.a(x15), .O(new_n166_));
  nand3  g133(.a(new_n39_), .b(x13), .c(x05), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n134_), .c(new_n166_), .O(new_n168_));
  oai22  g135(.a(new_n168_), .b(new_n163_), .c(new_n165_), .d(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n36_), .b(x06), .c(x03), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n134_), .c(x24), .d(x18), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n169_), .c(new_n162_), .O(z6));
  inv1   g139(.a(new_n157_), .O(z7));
endmodule
