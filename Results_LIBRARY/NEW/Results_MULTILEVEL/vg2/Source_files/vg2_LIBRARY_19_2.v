...
module FAU ( 
  ...
  nor4   g048(.a(new_n81_), .b(new_n65_), .c(new_n64_), .d(new_n80_), .O(new_n82_));
  ...
  nor3   g055(.a(x06), .b(x04), .c(x03), .O(new_n89_));
  ...
  nand3  g065(.a(new_n87_), .b(x20), .c(x17), .O(new_n99_));
  ...
  nor2   g088(.a(new_n121_), .b(new_n80_), .O(z2));
  nand2  g089(.a(new_n57_), .b(new_n56_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x20), .c(x11), .d(x08), .O(new_n124_));
  nor4   g091(.a(new_n124_), .b(new_n34_), .c(new_n64_), .d(new_n80_), .O(new_n125_));
  nand2  g092(.a(new_n71_), .b(new_n70_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n68_), .c(new_n36_), .d(new_n35_), .O(new_n127_));
  nor4   g094(.a(new_n127_), .b(x08), .c(x06), .d(x03), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n125_), .c(new_n39_), .O(new_n129_));
  nand2  g096(.a(new_n46_), .b(new_n37_), .O(new_n130_));
  nand3  g097(.a(x06), .b(x03), .c(x01), .O(new_n131_));
  nand3  g098(.a(new_n86_), .b(x11), .c(x08), .O(new_n132_));
  nand3  g099(.a(x07), .b(new_n34_), .c(new_n64_), .O(new_n133_));
  nand4  g100(.a(new_n68_), .b(new_n36_), .c(new_n35_), .d(new_n90_), .O(new_n134_));
  ...
  nand4  g103(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n137_));
  nand3  g104(.a(new_n90_), .b(new_n34_), .c(new_n64_), .O(new_n138_));
  nand4  g105(.a(new_n68_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n139_));
  ...
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n66_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n54_), .c(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n69_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n90_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n119_), .c(new_n145_), .d(new_n49_), .O(z4));
  inv1   g116(.a(new_n49_), .O(z5));
  nand2  g117(.a(x20), .b(new_n36_), .O(new_n151_));
  ...
  aoi21  g122(.a(new_n155_), .b(x11), .c(new_n64_), .O(new_n156_));
