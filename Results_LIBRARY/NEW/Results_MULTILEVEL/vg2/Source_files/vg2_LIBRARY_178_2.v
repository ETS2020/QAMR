...
module FAU ( 
  ...
  nand4  g052(.a(new_n85_), .b(new_n82_), .c(new_n61_), .d(new_n57_), .O(new_n86_));
  ...
  inv1   g063(.a(new_n56_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n54_), .c(new_n42_), .d(x01), .O(new_n98_));
  nand4  g065(.a(new_n82_), .b(new_n61_), .c(x21), .d(x20), .O(new_n99_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n38_), .c(new_n43_), .O(new_n104_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n84_), .c(new_n107_), .O(new_n116_));
  ...
  nand4  g095(.a(new_n128_), .b(new_n84_), .c(new_n107_), .d(new_n36_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n35_), .c(new_n34_), .d(new_n106_), .O(new_n131_));
  ...
  nor2   g102(.a(new_n107_), .b(new_n36_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n135_), .c(new_n85_), .O(new_n137_));
  nor2   g104(.a(x11), .b(x08), .O(new_n138_));
  nor2   g105(.a(x20), .b(x14), .O(new_n139_));
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n100_), .d(new_n88_), .O(new_n140_));
  ...
  nand4  g110(.a(new_n143_), .b(new_n100_), .c(new_n72_), .d(new_n67_), .O(new_n144_));
  ...
  aoi21  g115(.a(new_n60_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x22), .c(new_n65_), .O(new_n150_));
  nand2  g117(.a(new_n40_), .b(x05), .O(new_n151_));
  nand3  g118(.a(new_n38_), .b(new_n43_), .c(x00), .O(new_n152_));
  nand4  g119(.a(new_n152_), .b(new_n47_), .c(new_n41_), .d(new_n151_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n150_), .c(new_n148_), .O(new_n154_));
  inv1   g121(.a(x17), .O(new_n155_));
  aoi21  g122(.a(x23), .b(new_n53_), .c(new_n155_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n59_), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x16), .c(new_n119_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n83_), .c(new_n119_), .d(new_n87_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n77_), .c(x24), .O(new_n160_));
  inv1   g127(.a(x15), .O(new_n161_));
  oai22  g128(.a(new_n158_), .b(new_n161_), .c(new_n71_), .d(new_n119_), .O(new_n162_));
  ...
  nand4  g133(.a(new_n166_), .b(new_n38_), .c(new_n43_), .d(new_n42_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n163_), .c(new_n160_), .d(new_n154_), .O(z4));
  inv1   g135(.a(new_n49_), .O(z5));
  nand2  g136(.a(x20), .b(new_n107_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n35_), .O(new_n171_));
  aoi21  g138(.a(new_n171_), .b(new_n36_), .c(x03), .O(new_n172_));
  nand2  g139(.a(new_n84_), .b(x14), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x06), .O(new_n174_));
  aoi21  g141(.a(new_n174_), .b(x11), .c(new_n34_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n115_), .c(new_n172_), .d(new_n49_), .O(z6));
  inv1   g143(.a(new_n115_), .O(z7));
endmodule
