...
module FAU ( 
  ...
  nor4   g053(.a(new_n86_), .b(new_n66_), .c(new_n65_), .d(new_n64_), .O(new_n87_));
  ...
  nand4  g061(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n34_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n69_), .b(new_n36_), .c(new_n52_), .d(new_n35_), .O(new_n97_));
  ...
  aoi22  g067(.a(new_n100_), .b(new_n93_), .c(new_n45_), .d(new_n37_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n35_), .b(new_n68_), .c(new_n67_), .d(new_n34_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n70_), .b(new_n69_), .c(new_n36_), .d(new_n52_), .O(new_n108_));
  ...
  nand3  g086(.a(x15), .b(new_n45_), .c(new_n37_), .O(new_n120_));
  nand4  g087(.a(new_n39_), .b(x21), .c(new_n54_), .d(new_n43_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n71_), .c(new_n36_), .O(new_n124_));
  ...
  nor2   g094(.a(new_n127_), .b(new_n67_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  nand4  g096(.a(new_n76_), .b(new_n71_), .c(new_n36_), .d(new_n35_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n39_), .O(new_n134_));
  nand2  g101(.a(new_n45_), .b(new_n37_), .O(new_n135_));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand3  g103(.a(new_n91_), .b(x14), .c(x11), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n138_));
  nand4  g105(.a(new_n71_), .b(new_n36_), .c(new_n35_), .d(new_n67_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n67_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n143_));
  nand4  g110(.a(new_n71_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n136_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n45_), .c(new_n37_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n134_), .O(z3));
  aoi21  g114(.a(new_n73_), .b(x04), .c(x17), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x22), .c(new_n68_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n69_), .c(x08), .O(new_n150_));
  nand4  g117(.a(new_n39_), .b(new_n54_), .c(new_n43_), .d(x00), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n46_), .c(new_n42_), .O(new_n152_));
  nor2   g119(.a(new_n152_), .b(new_n41_), .O(new_n153_));
  aoi21  g120(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n72_), .c(x09), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x16), .c(new_n67_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n123_), .c(new_n153_), .d(new_n150_), .O(z4));
  ...
  inv1   g128(.a(new_n123_), .O(z7));
  oai21  g129(.a(new_n35_), .b(x06), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z7), .O(new_n164_));
  inv1   g131(.a(new_n118_), .O(new_n165_));
  nand3  g132(.a(new_n39_), .b(x21), .c(new_n43_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n120_), .c(new_n119_), .d(new_n165_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n71_), .c(x14), .d(x11), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n164_), .c(new_n161_), .O(z6));
endmodule
