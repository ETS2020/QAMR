...
module FAU ( 
  ...
  nand4  g068(.a(new_n56_), .b(new_n69_), .c(x19), .d(new_n68_), .O(new_n102_));
  ...
  nor3   g083(.a(new_n116_), .b(new_n108_), .c(new_n54_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x11), .c(x06), .d(x03), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n65_), .O(z2));
  nand2  g086(.a(new_n58_), .b(new_n57_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x20), .c(x14), .d(x11), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n53_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x06), .c(x03), .d(x01), .O(new_n123_));
  nand2  g090(.a(new_n71_), .b(new_n70_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n108_), .c(new_n54_), .d(new_n36_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(x08), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n127_));
  ...
  nand4  g100(.a(new_n108_), .b(new_n54_), .c(new_n36_), .d(new_n53_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n53_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n138_));
  nand4  g105(.a(new_n108_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n139_));
  ...
  aoi21  g109(.a(new_n56_), .b(x04), .c(x17), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n67_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n55_), .c(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n66_), .c(new_n68_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n69_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n53_), .O(new_n148_));
