...
module FAU ( 
  ...
  nand2  g55(.a(x20), .b(new_n37_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n60_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n89_), .c(x03), .O(new_n92_));
  inv1   g58(.a(x20), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x14), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x06), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x11), .c(new_n59_), .O(new_n96_));
  oai22  g62(.a(new_n96_), .b(new_n61_), .c(new_n92_), .d(new_n81_), .O(z6));
  zero   g63(.O(z0));
endmodule
