...
module FAU ( 
  ...
  nand4  g055(.a(new_n36_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n89_));
  ...
  nand4  g066(.a(new_n67_), .b(new_n36_), .c(new_n66_), .d(new_n35_), .O(new_n100_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n69_), .c(new_n53_), .d(new_n36_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n69_), .b(new_n53_), .c(new_n36_), .d(new_n120_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n120_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n139_));
  nand4  g106(.a(new_n69_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n140_));
  ...
  nand2  g110(.a(x23), .b(new_n65_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x17), .c(new_n70_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n120_), .O(new_n146_));
  aoi21  g113(.a(new_n55_), .b(x04), .c(x17), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x22), .c(new_n66_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n54_), .c(x08), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n49_), .c(new_n146_), .d(new_n116_), .O(z4));
  inv1   g117(.a(new_n49_), .O(z5));
  nand2  g118(.a(x20), .b(new_n53_), .O(new_n152_));
