...
module FAU ( 
  ...
  nand2  g121(.a(new_n47_), .b(new_n45_), .O(new_n155_));
  nor2   g122(.a(new_n71_), .b(x14), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n35_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(new_n155_), .O(new_n159_));
  inv1   g126(.a(new_n120_), .O(new_n160_));
  ...
  aoi21  g131(.a(new_n164_), .b(new_n134_), .c(new_n163_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n160_), .c(new_n162_), .d(new_n34_), .O(new_n166_));
  oai21  g133(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x07), .O(new_n168_));
  aoi21  g135(.a(new_n68_), .b(x06), .c(new_n36_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n34_), .c(x18), .O(new_n170_));
  nand2  g137(.a(new_n156_), .b(new_n36_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n134_), .c(x24), .O(new_n173_));
  aoi21  g140(.a(new_n39_), .b(x06), .c(new_n156_), .O(new_n174_));
  oai22  g141(.a(new_n174_), .b(x11), .c(x24), .d(new_n34_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(x19), .c(x13), .d(x05), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n173_), .c(new_n166_), .d(new_n159_), .O(z6));
  inv1   g144(.a(new_n122_), .O(z7));
endmodule
