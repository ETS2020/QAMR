...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n81_), .c(new_n63_), .d(new_n56_), .O(new_n94_));
  ...
  nand3  g068(.a(new_n101_), .b(new_n92_), .c(new_n79_), .O(z1));
  ...
  aoi21  g078(.a(new_n111_), .b(new_n106_), .c(new_n37_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x14), .c(x11), .d(x06), .O(new_n113_));
  nor3   g080(.a(new_n113_), .b(new_n34_), .c(new_n96_), .O(z2));
  nand4  g081(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n115_));
  inv1   g082(.a(x14), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n36_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(x20), .c(x15), .O(new_n118_));
  nand3  g085(.a(new_n67_), .b(new_n34_), .c(new_n96_), .O(new_n119_));
  nand3  g086(.a(new_n72_), .b(new_n116_), .c(new_n36_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n115_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n78_), .O(new_n122_));
  nand2  g089(.a(new_n117_), .b(new_n83_), .O(new_n123_));
  nand4  g090(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n96_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nor2   g092(.a(x20), .b(x14), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n36_), .c(new_n125_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n124_), .c(new_n123_), .d(new_n115_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n76_), .c(x24), .O(new_n129_));
  nand3  g096(.a(new_n126_), .b(new_n67_), .c(new_n36_), .O(new_n130_));
  nand2  g097(.a(new_n117_), .b(new_n93_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n115_), .c(new_n130_), .d(new_n97_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n40_), .c(new_n45_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n129_), .c(new_n122_), .O(z3));
  nor2   g101(.a(new_n49_), .b(new_n42_), .O(new_n135_));
  inv1   g102(.a(x16), .O(new_n136_));
  aoi21  g103(.a(new_n62_), .b(x04), .c(x17), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(x22), .c(new_n65_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n136_), .c(x08), .O(new_n139_));
  aoi21  g106(.a(x23), .b(new_n95_), .c(new_n59_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n61_), .c(x09), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x16), .c(new_n125_), .O(new_n142_));
  nand4  g109(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n143_));
  nand3  g110(.a(new_n143_), .b(new_n108_), .c(new_n107_), .O(new_n144_));
  aoi21  g111(.a(new_n105_), .b(x05), .c(new_n144_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n142_), .c(new_n139_), .d(new_n135_), .O(z4));
  inv1   g113(.a(new_n135_), .O(z5));
  oai21  g114(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(z5), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n116_), .c(x06), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x11), .c(new_n34_), .O(new_n151_));
  nand4  g118(.a(x20), .b(new_n116_), .c(new_n36_), .d(x07), .O(new_n152_));
  oai21  g119(.a(new_n151_), .b(new_n82_), .c(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n76_), .c(x24), .O(new_n154_));
  inv1   g121(.a(x15), .O(new_n155_));
  nand4  g122(.a(x20), .b(x19), .c(new_n116_), .d(new_n36_), .O(new_n156_));
  oai21  g123(.a(new_n151_), .b(new_n155_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n78_), .O(new_n158_));
  nand2  g125(.a(new_n150_), .b(x11), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x03), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(x21), .c(new_n44_), .O(new_n161_));
  nand4  g128(.a(x20), .b(new_n116_), .c(new_n36_), .d(x00), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n40_), .c(new_n45_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n158_), .c(new_n154_), .d(new_n149_), .O(z6));
  inv1   g132(.a(new_n145_), .O(z7));
endmodule
