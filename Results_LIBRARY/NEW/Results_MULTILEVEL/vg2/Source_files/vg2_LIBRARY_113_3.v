...
module FAU ( 
  ...
  nand2  g116(.a(new_n110_), .b(new_n105_), .O(new_n150_));
  oai21  g117(.a(x20), .b(new_n115_), .c(x06), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n150_), .c(x11), .O(new_n152_));
  inv1   g119(.a(new_n144_), .O(z7));
  nand2  g120(.a(z7), .b(new_n34_), .O(new_n154_));
