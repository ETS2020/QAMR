...
module FAU ( 
  ...
  nand2  g75(.a(x22), .b(new_n57_), .O(new_n109_));
  nand2  g76(.a(new_n109_), .b(x09), .O(new_n110_));
  aoi21  g77(.a(new_n110_), .b(x16), .c(new_n81_), .O(new_n111_));
  aoi21  g78(.a(new_n59_), .b(x04), .c(x17), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(x22), .c(new_n54_), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(new_n56_), .c(x08), .O(new_n114_));
  oai22  g81(.a(new_n114_), .b(new_n49_), .c(new_n111_), .d(new_n77_), .O(z4));
  inv1   g82(.a(new_n49_), .O(z5));
  nand2  g83(.a(x20), .b(new_n69_), .O(new_n117_));
  nand2  g84(.a(new_n117_), .b(new_n35_), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(new_n36_), .c(x03), .O(new_n119_));
  nand2  g86(.a(new_n58_), .b(x14), .O(new_n120_));
  nand2  g87(.a(new_n120_), .b(x06), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(x11), .c(new_n34_), .O(new_n122_));
  oai22  g89(.a(new_n122_), .b(new_n77_), .c(new_n119_), .d(new_n49_), .O(z6));
  inv1   g90(.a(new_n77_), .O(z7));
endmodule
