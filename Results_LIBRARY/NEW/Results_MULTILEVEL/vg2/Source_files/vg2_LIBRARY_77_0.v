...
module FAU ( 
  ...
  nor2   g067(.a(new_n37_), .b(new_n100_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand3  g069(.a(new_n37_), .b(x15), .c(x13), .O(new_n103_));
  aoi21  g070(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(new_n104_));
  nand2  g071(.a(new_n101_), .b(x13), .O(new_n105_));
  nand4  g072(.a(new_n37_), .b(x21), .c(new_n39_), .d(new_n38_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nor3   g075(.a(new_n108_), .b(new_n70_), .c(new_n36_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(x11), .c(x06), .d(x03), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n63_), .O(z2));
  nand4  g078(.a(new_n55_), .b(x20), .c(x14), .d(x11), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n66_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(x06), .c(x03), .d(x01), .O(new_n114_));
  nand4  g081(.a(new_n42_), .b(new_n70_), .c(new_n36_), .d(new_n35_), .O(new_n115_));
  nor2   g082(.a(new_n115_), .b(x08), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n34_), .c(new_n64_), .d(new_n63_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n37_), .O(new_n119_));
  nand4  g086(.a(new_n47_), .b(new_n70_), .c(new_n36_), .d(new_n35_), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(x08), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n34_), .c(new_n64_), .d(new_n63_), .O(new_n122_));
  nand4  g089(.a(new_n91_), .b(x20), .c(x14), .d(x11), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n66_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x06), .c(x03), .d(x01), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n122_), .c(new_n119_), .O(z3));
  aoi21  g093(.a(new_n72_), .b(x04), .c(x17), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(x22), .c(new_n67_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n68_), .c(x08), .O(new_n129_));
  nand3  g096(.a(new_n37_), .b(x19), .c(x13), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n46_), .c(new_n43_), .O(new_n131_));
  nand3  g098(.a(x24), .b(x13), .c(x07), .O(new_n132_));
  nand4  g099(.a(new_n37_), .b(new_n39_), .c(new_n38_), .d(x00), .O(new_n133_));
  nand3  g100(.a(x19), .b(new_n44_), .c(new_n43_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  aoi21  g103(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n137_));
  oai21  g104(.a(new_n137_), .b(new_n71_), .c(x09), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x16), .c(new_n66_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n108_), .c(new_n136_), .d(new_n129_), .O(z4));
  inv1   g107(.a(new_n136_), .O(z5));
  oai21  g108(.a(x20), .b(new_n36_), .c(x06), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(x21), .c(new_n39_), .d(new_n38_), .O(new_n143_));
  inv1   g110(.a(new_n41_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n70_), .c(x15), .d(x14), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n143_), .c(x24), .O(new_n146_));
  nand3  g113(.a(new_n91_), .b(new_n70_), .c(x14), .O(new_n147_));
  nand3  g114(.a(new_n101_), .b(new_n34_), .c(x03), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n146_), .c(x11), .O(new_n150_));
  nand3  g117(.a(new_n37_), .b(x13), .c(x05), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n45_), .O(new_n152_));
  inv1   g119(.a(x19), .O(new_n153_));
  oai21  g120(.a(new_n70_), .b(x14), .c(new_n34_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n35_), .c(x03), .O(new_n155_));
  nand2  g122(.a(x15), .b(new_n64_), .O(new_n156_));
  ...
  nand4  g126(.a(new_n154_), .b(new_n37_), .c(new_n39_), .d(new_n38_), .O(new_n160_));
  nand2  g127(.a(new_n45_), .b(x06), .O(new_n161_));
  nand3  g128(.a(x20), .b(x19), .c(new_n36_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(x24), .c(x07), .O(new_n164_));
  oai21  g131(.a(new_n160_), .b(new_n159_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(x21), .b(new_n64_), .O(new_n166_));
  oai21  g133(.a(new_n64_), .b(new_n159_), .c(new_n166_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n37_), .c(new_n39_), .d(new_n38_), .O(new_n168_));
  nand2  g135(.a(x07), .b(x03), .O(new_n169_));
  oai21  g136(.a(new_n100_), .b(x03), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n45_), .c(x24), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  aoi21  g139(.a(new_n165_), .b(new_n35_), .c(new_n172_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n158_), .c(new_n150_), .O(z6));
  inv1   g141(.a(new_n108_), .O(z7));
endmodule
