...
module FAU ( 
  ...
  nand4  g064(.a(new_n69_), .b(new_n36_), .c(new_n53_), .d(new_n35_), .O(new_n98_));
  ...
  nand4  g075(.a(new_n70_), .b(new_n69_), .c(new_n36_), .d(new_n53_), .O(new_n109_));
  ...
  nand4  g098(.a(new_n75_), .b(new_n71_), .c(new_n36_), .d(new_n35_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(x08), .O(new_n133_));
  nand4  g100(.a(new_n133_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n134_));
  ...
  nor2   g105(.a(new_n36_), .b(new_n35_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n138_), .c(new_n91_), .O(new_n140_));
  ...
  aoi21  g111(.a(new_n144_), .b(new_n140_), .c(new_n85_), .O(new_n145_));
  nand4  g112(.a(new_n139_), .b(new_n138_), .c(x20), .d(x15), .O(new_n146_));
  nor2   g113(.a(x14), .b(x11), .O(new_n147_));
  nand4  g114(.a(new_n147_), .b(new_n141_), .c(new_n111_), .d(new_n107_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n146_), .c(x13), .O(new_n149_));
  aoi22  g116(.a(new_n149_), .b(new_n37_), .c(new_n145_), .d(x24), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n136_), .O(z3));
  aoi21  g118(.a(new_n73_), .b(x04), .c(x17), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x22), .c(new_n68_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n69_), .c(x08), .O(new_n154_));
  nand4  g121(.a(new_n39_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n47_), .c(new_n42_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(new_n41_), .O(new_n157_));
  aoi21  g124(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n72_), .c(x09), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x16), .c(new_n67_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n125_), .c(new_n157_), .d(new_n154_), .O(z4));
  inv1   g128(.a(new_n157_), .O(z5));
  oai21  g129(.a(x11), .b(new_n34_), .c(new_n65_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z5), .O(new_n164_));
  inv1   g131(.a(new_n85_), .O(new_n165_));
  oai21  g132(.a(x20), .b(new_n36_), .c(x06), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x11), .c(new_n65_), .O(new_n167_));
  nand2  g134(.a(new_n35_), .b(x07), .O(new_n168_));
  nand2  g135(.a(x20), .b(new_n36_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n90_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n165_), .c(x24), .O(new_n171_));
  nand3  g138(.a(new_n39_), .b(x13), .c(x05), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n165_), .O(new_n173_));
  inv1   g140(.a(x15), .O(new_n174_));
  nand3  g141(.a(new_n147_), .b(x20), .c(x19), .O(new_n175_));
  oai21  g142(.a(new_n167_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  inv1   g144(.a(x21), .O(new_n178_));
  nand2  g145(.a(x20), .b(x06), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x11), .c(new_n65_), .O(new_n180_));
  oai22  g147(.a(new_n180_), .b(new_n178_), .c(new_n169_), .d(x11), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n182_));
  nand4  g149(.a(new_n182_), .b(new_n177_), .c(new_n171_), .d(new_n164_), .O(z6));
  inv1   g150(.a(new_n125_), .O(z7));
endmodule
