...
module FAU ( 
  ...
  nand4  g034(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(new_n35_), .O(new_n68_));
  ...
  nand3  g044(.a(new_n39_), .b(x13), .c(x05), .O(new_n78_));
  ...
  nand4  g050(.a(new_n83_), .b(new_n82_), .c(new_n63_), .d(new_n55_), .O(new_n84_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n82_), .c(new_n63_), .d(new_n55_), .O(new_n94_));
  inv1   g061(.a(x04), .O(new_n95_));
  inv1   g062(.a(x01), .O(new_n96_));
  nand4  g063(.a(new_n34_), .b(new_n43_), .c(new_n96_), .d(x00), .O(new_n97_));
  ...
  nand3  g067(.a(new_n100_), .b(new_n39_), .c(new_n44_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n92_), .c(new_n80_), .O(z1));
  ...
  nand4  g090(.a(new_n123_), .b(new_n59_), .c(new_n103_), .d(new_n36_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(x08), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n35_), .c(new_n34_), .d(new_n96_), .O(new_n126_));
  ...
  nand3  g096(.a(new_n83_), .b(x14), .c(x11), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n96_), .O(new_n131_));
  nand4  g098(.a(new_n59_), .b(new_n103_), .c(new_n36_), .d(new_n65_), .O(new_n132_));
  ...
  nand4  g102(.a(new_n65_), .b(new_n35_), .c(new_n34_), .d(new_n96_), .O(new_n136_));
  nand3  g103(.a(new_n72_), .b(new_n103_), .c(new_n36_), .O(new_n137_));
  ...
  and2   g106(.a(new_n139_), .b(new_n134_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n128_), .O(z3));
  inv1   g108(.a(new_n49_), .O(z5));
  oai21  g109(.a(x23), .b(new_n95_), .c(new_n58_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n61_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n65_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(z5), .O(new_n146_));
  inv1   g113(.a(new_n111_), .O(z7));
  ...
  nand2  g118(.a(new_n106_), .b(x05), .O(new_n152_));
  nand3  g119(.a(new_n39_), .b(x21), .c(new_n44_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n108_), .c(new_n107_), .d(new_n152_), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n151_), .c(x22), .d(x16), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n150_), .c(new_n146_), .O(z4));
  nand2  g123(.a(x20), .b(new_n103_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n35_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n36_), .c(x03), .O(new_n159_));
  nand2  g126(.a(new_n59_), .b(x14), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x06), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(x11), .c(new_n34_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n111_), .c(new_n159_), .d(new_n49_), .O(z6));
endmodule
