...
module FAU ( 
  ...
  oai21  g122(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n157_));
  nand4  g124(.a(x19), .b(x13), .c(x06), .d(x05), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n157_), .c(x24), .O(new_n159_));
  nand3  g126(.a(new_n135_), .b(x24), .c(x07), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n47_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x06), .O(new_n162_));
  nor2   g129(.a(new_n39_), .b(new_n71_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n68_), .c(x07), .d(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n159_), .c(new_n36_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n68_), .c(x06), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x11), .c(new_n34_), .O(new_n168_));
  nand2  g135(.a(x07), .b(x03), .O(new_n169_));
  oai21  g136(.a(new_n168_), .b(new_n91_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n135_), .c(x24), .O(new_n171_));
  nand3  g138(.a(new_n39_), .b(x13), .c(x05), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n135_), .O(new_n173_));
  inv1   g140(.a(x15), .O(new_n174_));
  nand2  g141(.a(x19), .b(x03), .O(new_n175_));
  oai21  g142(.a(new_n168_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  inv1   g144(.a(x21), .O(new_n178_));
  nand2  g145(.a(x03), .b(x00), .O(new_n179_));
  oai21  g146(.a(new_n168_), .b(new_n178_), .c(new_n179_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n177_), .c(new_n171_), .d(new_n166_), .O(z6));
