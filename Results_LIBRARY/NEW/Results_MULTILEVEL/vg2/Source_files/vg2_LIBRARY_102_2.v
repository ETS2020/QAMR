...
module FAU ( 
  ...
  nand2  g063(.a(new_n86_), .b(x24), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n96_), .c(new_n47_), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(x12), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n36_), .c(new_n67_), .d(new_n66_), .O(new_n103_));
  nor2   g070(.a(new_n103_), .b(x06), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n65_), .c(new_n34_), .d(new_n64_), .O(new_n105_));
  nand3  g072(.a(new_n105_), .b(new_n95_), .c(new_n85_), .O(z1));
  aoi21  g073(.a(new_n56_), .b(new_n39_), .c(new_n88_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n71_), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(x14), .c(x11), .d(x06), .O(new_n109_));
  nor3   g076(.a(new_n109_), .b(new_n34_), .c(new_n64_), .O(z2));
  nand4  g077(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n66_), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(x06), .c(x03), .d(x01), .O(new_n113_));
  nand4  g080(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(x08), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n39_), .O(new_n118_));
  nand4  g085(.a(new_n88_), .b(x20), .c(x14), .d(x11), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n66_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(x06), .c(x03), .d(x01), .O(new_n121_));
  nand4  g088(.a(new_n98_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(x08), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n121_), .c(new_n118_), .O(z3));
  aoi21  g092(.a(new_n73_), .b(x04), .c(x17), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x22), .c(new_n67_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n69_), .c(x08), .O(new_n128_));
  aoi21  g095(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n72_), .c(x09), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x16), .c(new_n66_), .O(new_n131_));
  nand3  g098(.a(new_n39_), .b(x15), .c(x13), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n87_), .c(new_n37_), .O(new_n133_));
  nand3  g100(.a(x24), .b(x18), .c(x13), .O(new_n134_));
  nand3  g101(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n135_));
  nand4  g102(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  nor2   g104(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n131_), .c(new_n128_), .d(new_n49_), .O(z4));
  inv1   g106(.a(new_n49_), .O(z5));
  aoi21  g107(.a(x20), .b(new_n68_), .c(x06), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x11), .c(new_n34_), .O(new_n142_));
  oai21  g109(.a(new_n97_), .b(new_n96_), .c(new_n45_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand3  g111(.a(new_n39_), .b(x13), .c(x05), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n86_), .O(new_n146_));
  inv1   g113(.a(x15), .O(new_n147_));
  oai22  g114(.a(x20), .b(new_n68_), .c(new_n147_), .d(x06), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x11), .O(new_n149_));
  nor2   g116(.a(x20), .b(x06), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x11), .c(new_n34_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x19), .O(new_n152_));
  nand2  g119(.a(x15), .b(new_n34_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n152_), .c(new_n149_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n146_), .O(new_n155_));
  oai21  g122(.a(new_n36_), .b(x06), .c(x03), .O(new_n156_));
  inv1   g123(.a(x18), .O(new_n157_));
  oai21  g124(.a(new_n97_), .b(new_n157_), .c(new_n136_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g126(.a(new_n136_), .b(new_n87_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(new_n71_), .c(x14), .d(x11), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n159_), .c(new_n155_), .d(new_n144_), .O(z6));
  inv1   g129(.a(new_n138_), .O(z7));
endmodule
