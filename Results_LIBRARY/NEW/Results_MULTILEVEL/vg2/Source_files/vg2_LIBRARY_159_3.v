...
module FAU ( 
  ...
  nand3  g086(.a(new_n72_), .b(new_n119_), .c(new_n36_), .O(new_n120_));
  oai22  g087(.a(new_n120_), .b(new_n118_), .c(new_n117_), .d(new_n114_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n78_), .O(new_n122_));
  nand2  g089(.a(new_n116_), .b(new_n82_), .O(new_n123_));
  nand4  g090(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n95_), .O(new_n124_));
  inv1   g091(.a(x08), .O(new_n125_));
  nor2   g092(.a(x20), .b(x14), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n36_), .c(new_n125_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n124_), .c(new_n123_), .d(new_n114_), .O(new_n128_));
  nand3  g095(.a(new_n128_), .b(new_n76_), .c(x24), .O(new_n129_));
  nand3  g096(.a(new_n126_), .b(new_n67_), .c(new_n36_), .O(new_n130_));
  nand2  g097(.a(new_n116_), .b(new_n92_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n114_), .c(new_n130_), .d(new_n96_), .O(new_n132_));
  ...
  aoi21  g106(.a(x23), .b(new_n94_), .c(new_n59_), .O(new_n140_));
  ...
  aoi21  g111(.a(new_n104_), .b(x05), .c(new_n144_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n142_), .c(new_n139_), .d(new_n135_), .O(z4));
  inv1   g113(.a(new_n135_), .O(z5));
  nand3  g114(.a(x20), .b(new_n119_), .c(new_n36_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n34_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(z5), .O(new_n150_));
  inv1   g117(.a(new_n145_), .O(z7));
  oai21  g118(.a(new_n36_), .b(x06), .c(x03), .O(new_n152_));
  nand3  g119(.a(x19), .b(new_n36_), .c(x06), .O(new_n153_));
  nand2  g120(.a(new_n37_), .b(x15), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n115_), .c(new_n153_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n78_), .O(new_n156_));
  nand3  g123(.a(new_n36_), .b(x07), .c(x06), .O(new_n157_));
  nand2  g124(.a(new_n37_), .b(x18), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n115_), .c(new_n157_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n76_), .c(x24), .O(new_n160_));
  nand2  g127(.a(new_n36_), .b(x00), .O(new_n161_));
  nand2  g128(.a(x21), .b(new_n37_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n115_), .c(new_n161_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n40_), .c(new_n45_), .d(x06), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n160_), .c(new_n156_), .O(new_n165_));
  aoi21  g132(.a(new_n152_), .b(z7), .c(new_n165_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n150_), .O(z6));
endmodule
