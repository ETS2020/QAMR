// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:51 2020
...
module FAU ( 
  ...
  nor2   g058(.a(new_n91_), .b(new_n53_), .O(new_n92_));
  ...
  nand3  g062(.a(new_n86_), .b(x24), .c(x07), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(x12), .O(new_n101_));
  nand4  g068(.a(new_n101_), .b(new_n36_), .c(new_n67_), .d(new_n66_), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(x06), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n65_), .c(new_n34_), .d(new_n64_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n95_), .c(new_n85_), .O(z1));
  aoi21  g072(.a(new_n56_), .b(new_n39_), .c(new_n88_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n71_), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(x14), .c(x11), .d(x06), .O(new_n108_));
  nor3   g075(.a(new_n108_), .b(new_n34_), .c(new_n64_), .O(z2));
  nand4  g076(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n66_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(x06), .c(x03), .d(x01), .O(new_n112_));
  nand4  g079(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(x08), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n39_), .O(new_n117_));
  nand4  g084(.a(new_n88_), .b(x20), .c(x14), .d(x11), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x06), .c(x03), .d(x01), .O(new_n120_));
  nand4  g087(.a(new_n97_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(x08), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n120_), .c(new_n117_), .O(z3));
  aoi21  g091(.a(new_n73_), .b(x04), .c(x17), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(x22), .c(new_n67_), .O(new_n126_));
  aoi21  g093(.a(new_n126_), .b(new_n69_), .c(x08), .O(new_n127_));
  aoi21  g094(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n128_));
  oai21  g095(.a(new_n128_), .b(new_n72_), .c(x09), .O(new_n129_));
  aoi21  g096(.a(new_n129_), .b(x16), .c(new_n66_), .O(new_n130_));
  nand3  g097(.a(new_n39_), .b(x15), .c(x13), .O(new_n131_));
  aoi21  g098(.a(new_n131_), .b(new_n87_), .c(new_n37_), .O(new_n132_));
  nand3  g099(.a(x24), .b(x18), .c(x13), .O(new_n133_));
  nand3  g100(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n134_));
  nand4  g101(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n130_), .c(new_n127_), .d(new_n49_), .O(z4));
  inv1   g105(.a(new_n49_), .O(z5));
  oai21  g106(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n141_));
  nand4  g108(.a(x19), .b(x13), .c(x06), .d(x05), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n141_), .c(x24), .O(new_n143_));
  nand2  g110(.a(new_n97_), .b(x06), .O(new_n144_));
  nor2   g111(.a(new_n39_), .b(new_n71_), .O(new_n145_));
  nand4  g112(.a(new_n145_), .b(new_n68_), .c(x07), .d(new_n34_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n143_), .c(new_n36_), .O(new_n148_));
  inv1   g115(.a(x18), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n68_), .c(x06), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x11), .c(new_n34_), .O(new_n151_));
  nand2  g118(.a(x07), .b(x03), .O(new_n152_));
  oai21  g119(.a(new_n151_), .b(new_n149_), .c(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n86_), .c(x24), .O(new_n154_));
  nand3  g121(.a(new_n39_), .b(x13), .c(x05), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n86_), .O(new_n156_));
  inv1   g123(.a(x15), .O(new_n157_));
  nand2  g124(.a(x19), .b(x03), .O(new_n158_));
  oai21  g125(.a(new_n151_), .b(new_n157_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  inv1   g127(.a(x21), .O(new_n161_));
  nand2  g128(.a(x03), .b(x00), .O(new_n162_));
  oai21  g129(.a(new_n151_), .b(new_n161_), .c(new_n162_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n160_), .c(new_n154_), .d(new_n148_), .O(z6));
