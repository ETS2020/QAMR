...
module FAU ( 
  ...
  aoi21  g70(.a(new_n56_), .b(x17), .c(x09), .O(new_n104_));
  nor2   g71(.a(new_n104_), .b(x16), .O(new_n105_));
  nor2   g72(.a(new_n105_), .b(x08), .O(new_n106_));
  inv1   g73(.a(x04), .O(new_n107_));
  inv1   g74(.a(x17), .O(new_n108_));
  aoi21  g75(.a(x23), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  oai21  g76(.a(new_n109_), .b(new_n56_), .c(x09), .O(new_n110_));
  aoi21  g77(.a(new_n110_), .b(x16), .c(new_n54_), .O(new_n111_));
  oai22  g78(.a(new_n111_), .b(new_n73_), .c(new_n106_), .d(new_n49_), .O(z4));
  inv1   g79(.a(new_n49_), .O(z5));
  nand2  g80(.a(x20), .b(new_n55_), .O(new_n114_));
  nand2  g81(.a(new_n114_), .b(new_n35_), .O(new_n115_));
  aoi21  g82(.a(new_n115_), .b(new_n36_), .c(x03), .O(new_n116_));
  nand2  g83(.a(new_n72_), .b(x14), .O(new_n117_));
  nand2  g84(.a(new_n117_), .b(x06), .O(new_n118_));
  aoi21  g85(.a(new_n118_), .b(x11), .c(new_n34_), .O(new_n119_));
  oai22  g86(.a(new_n119_), .b(new_n73_), .c(new_n116_), .d(new_n49_), .O(z6));
  inv1   g87(.a(new_n73_), .O(z7));
endmodule
