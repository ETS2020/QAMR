...
module FAU ( 
  ...
  oai21  g129(.a(new_n35_), .b(x03), .c(x19), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  oai21  g131(.a(new_n159_), .b(new_n38_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n39_), .b(x18), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n110_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n161_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n165_), .c(new_n157_), .O(z6));
  inv1   g136(.a(new_n112_), .O(z7));
endmodule
