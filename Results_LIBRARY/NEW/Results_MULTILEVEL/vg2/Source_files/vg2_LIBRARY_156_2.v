...
module FAU ( 
  ...
  nand4  g039(.a(new_n72_), .b(new_n55_), .c(new_n69_), .d(new_n68_), .O(new_n73_));
  nor3   g040(.a(new_n73_), .b(x16), .c(x12), .O(new_n74_));
  ...
  nand4  g049(.a(x22), .b(x20), .c(x18), .d(x17), .O(new_n83_));
  nor4   g050(.a(new_n83_), .b(new_n82_), .c(new_n54_), .d(new_n53_), .O(new_n84_));
  ...
  nor3   g055(.a(x16), .b(x12), .c(x11), .O(new_n89_));
  inv1   g056(.a(x23), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n55_), .c(new_n69_), .d(new_n68_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n89_), .c(new_n88_), .d(new_n86_), .O(new_n93_));
  aoi22  g060(.a(new_n93_), .b(new_n85_), .c(new_n46_), .d(new_n37_), .O(new_n94_));
  nand3  g061(.a(x15), .b(x14), .c(x12), .O(new_n95_));
  nand4  g062(.a(x22), .b(x20), .c(x17), .d(x16), .O(new_n96_));
  ...
  nor3   g067(.a(x17), .b(x16), .c(x12), .O(new_n101_));
  nand4  g068(.a(new_n90_), .b(new_n55_), .c(new_n69_), .d(x19), .O(new_n102_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n69_), .c(new_n54_), .O(new_n116_));
  ...
  nand2  g089(.a(new_n71_), .b(new_n70_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n69_), .c(new_n54_), .d(new_n36_), .O(new_n124_));
  ...
  nand4  g099(.a(new_n69_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n133_));
  ...
  nand4  g104(.a(new_n69_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n138_));
  ...
  aoi21  g108(.a(new_n90_), .b(x04), .c(x17), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n67_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n82_), .c(x08), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n55_), .c(x09), .O(new_n146_));
