...
module FAU ( 
  ...
  nand4  g132(.a(x20), .b(new_n68_), .c(new_n36_), .d(x07), .O(new_n166_));
  oai21  g133(.a(new_n165_), .b(new_n91_), .c(new_n166_), .O(new_n167_));
  ...
  nand3  g138(.a(new_n148_), .b(x20), .c(x19), .O(new_n172_));
  ...
  nand4  g142(.a(new_n175_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n174_), .c(new_n168_), .d(new_n162_), .O(z6));
  inv1   g144(.a(new_n126_), .O(z7));
endmodule
