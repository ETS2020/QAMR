...
module FAU ( 
  ...
  nor4   g048(.a(new_n81_), .b(new_n35_), .c(new_n66_), .d(new_n65_), .O(new_n82_));
  ...
  nor2   g054(.a(new_n56_), .b(new_n69_), .O(new_n88_));
  ...
  nand4  g060(.a(new_n56_), .b(new_n69_), .c(new_n68_), .d(new_n55_), .O(new_n94_));
  ...
  nand4  g071(.a(new_n56_), .b(new_n69_), .c(x19), .d(new_n68_), .O(new_n105_));
  ...
  nor2   g088(.a(new_n121_), .b(new_n65_), .O(z2));
  nand2  g089(.a(new_n58_), .b(new_n57_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(x20), .c(x14), .d(x11), .O(new_n124_));
  nor4   g091(.a(new_n124_), .b(new_n53_), .c(new_n35_), .d(new_n65_), .O(new_n125_));
  nand2  g092(.a(new_n71_), .b(new_n70_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n54_), .c(new_n36_), .d(new_n53_), .O(new_n127_));
  ...
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n53_), .d(x07), .O(new_n132_));
  nand3  g099(.a(x08), .b(x06), .c(x01), .O(new_n133_));
  inv1   g100(.a(new_n133_), .O(new_n134_));
  nor2   g101(.a(new_n54_), .b(new_n36_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n130_), .c(x19), .d(new_n54_), .O(new_n139_));
  nand4  g106(.a(new_n135_), .b(new_n134_), .c(x20), .d(x15), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n139_), .c(x13), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n37_), .c(new_n137_), .d(x24), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n129_), .O(z3));
  aoi21  g110(.a(new_n56_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n67_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n55_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n66_), .c(new_n68_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n69_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n53_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n119_), .c(new_n146_), .d(new_n49_), .O(z4));
  inv1   g117(.a(new_n49_), .O(z5));
  aoi21  g118(.a(new_n36_), .b(x06), .c(x03), .O(new_n152_));
  nand2  g119(.a(new_n86_), .b(x14), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x06), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x11), .c(new_n34_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n119_), .c(new_n152_), .d(new_n49_), .O(z6));
  inv1   g123(.a(new_n119_), .O(z7));
endmodule
