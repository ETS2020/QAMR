...
module FAU ( 
  ...
  nand4  g006(.a(new_n39_), .b(new_n38_), .c(x19), .d(x13), .O(new_n40_));
  ...
  nand3  g023(.a(x21), .b(new_n47_), .c(new_n46_), .O(new_n57_));
  ...
  nand4  g062(.a(new_n70_), .b(new_n69_), .c(x07), .d(new_n34_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nor3   g064(.a(x14), .b(x12), .c(x11), .O(new_n98_));
  nand4  g065(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n71_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(new_n97_), .d(new_n95_), .O(new_n101_));
  aoi21  g068(.a(new_n101_), .b(new_n94_), .c(new_n87_), .O(new_n102_));
  ...
  nand4  g073(.a(new_n35_), .b(new_n70_), .c(new_n69_), .d(new_n34_), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  nand4  g075(.a(new_n72_), .b(new_n71_), .c(new_n36_), .d(new_n55_), .O(new_n109_));
  nand4  g076(.a(new_n74_), .b(new_n73_), .c(new_n38_), .d(x19), .O(new_n110_));
  ...
  aoi22  g080(.a(new_n113_), .b(new_n43_), .c(new_n102_), .d(x24), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n86_), .O(z1));
  nand2  g082(.a(x24), .b(x18), .O(new_n116_));
  nand3  g083(.a(new_n39_), .b(x15), .c(x13), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(new_n43_), .O(new_n118_));
  nand3  g085(.a(x24), .b(x18), .c(x13), .O(new_n119_));
  nand3  g086(.a(x15), .b(new_n44_), .c(new_n43_), .O(new_n120_));
  nand4  g087(.a(new_n39_), .b(x21), .c(new_n47_), .d(new_n46_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  nor3   g090(.a(new_n123_), .b(new_n38_), .c(new_n36_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x11), .c(x06), .d(x03), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n66_), .O(z2));
  ...
  nand4  g096(.a(new_n77_), .b(new_n38_), .c(new_n36_), .d(new_n35_), .O(new_n130_));
  ...
  inv1   g101(.a(new_n87_), .O(new_n135_));
  nand3  g102(.a(new_n34_), .b(new_n67_), .c(new_n66_), .O(new_n136_));
  nand4  g103(.a(new_n36_), .b(new_n35_), .c(new_n69_), .d(x07), .O(new_n137_));
  ...
  nand4  g109(.a(new_n69_), .b(new_n34_), .c(new_n67_), .d(new_n66_), .O(new_n143_));
  nand4  g110(.a(new_n38_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n138_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n44_), .c(new_n43_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n134_), .O(z3));
  aoi21  g114(.a(new_n74_), .b(x04), .c(x17), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x22), .c(new_n70_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n71_), .c(x08), .O(new_n150_));
  inv1   g117(.a(new_n51_), .O(new_n151_));
  nand3  g118(.a(new_n39_), .b(x19), .c(x13), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n37_), .c(new_n43_), .O(new_n153_));
  nor3   g120(.a(new_n153_), .b(new_n151_), .c(new_n49_), .O(new_n154_));
  aoi21  g121(.a(x23), .b(new_n68_), .c(new_n72_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n73_), .c(x09), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x16), .c(new_n69_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n123_), .c(new_n154_), .d(new_n150_), .O(z4));
  inv1   g125(.a(new_n154_), .O(z5));
  nand2  g126(.a(x20), .b(new_n36_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n34_), .c(x11), .O(new_n161_));
  inv1   g128(.a(x19), .O(new_n162_));
  nor2   g129(.a(x24), .b(new_n44_), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x05), .c(new_n87_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n162_), .c(new_n48_), .O(new_n165_));
  oai21  g132(.a(new_n161_), .b(x03), .c(new_n165_), .O(new_n166_));
  oai21  g133(.a(x11), .b(new_n34_), .c(new_n67_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x07), .O(new_n168_));
  aoi21  g135(.a(new_n38_), .b(x14), .c(new_n34_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n35_), .c(x03), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(x18), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n135_), .c(x24), .O(new_n173_));
  inv1   g140(.a(x15), .O(new_n174_));
  oai21  g141(.a(new_n164_), .b(new_n174_), .c(new_n121_), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(new_n170_), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n173_), .c(new_n166_), .O(z6));
  inv1   g144(.a(new_n123_), .O(z7));
endmodule
