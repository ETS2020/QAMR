...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n88_, new_n90_, new_n91_, new_n92_, new_n93_, new_n94_;
  ...
  nor2   g55(.a(x20), .b(x06), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(x11), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x03), .O(new_n92_));
  aoi21  g58(.a(new_n35_), .b(x06), .c(new_n34_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(new_n53_), .O(new_n94_));
  oai22  g60(.a(new_n94_), .b(new_n88_), .c(new_n92_), .d(new_n49_), .O(z6));
  inv1   g61(.a(new_n88_), .O(z7));
  zero   g62(.O(z2));
endmodule
