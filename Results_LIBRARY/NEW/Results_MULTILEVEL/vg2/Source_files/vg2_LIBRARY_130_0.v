...
module FAU ( 
  ...
  oai22  g77(.a(new_n110_), .b(new_n73_), .c(new_n105_), .d(new_n49_), .O(z4));
  inv1   g78(.a(new_n49_), .O(z5));
  nand2  g79(.a(x20), .b(new_n55_), .O(new_n113_));
  nand2  g80(.a(new_n113_), .b(new_n35_), .O(new_n114_));
  aoi21  g81(.a(new_n114_), .b(new_n36_), .c(x03), .O(new_n115_));
  nand2  g82(.a(new_n72_), .b(x14), .O(new_n116_));
  nand2  g83(.a(new_n116_), .b(x06), .O(new_n117_));
  aoi21  g84(.a(new_n117_), .b(x11), .c(new_n34_), .O(new_n118_));
  oai22  g85(.a(new_n118_), .b(new_n73_), .c(new_n115_), .d(new_n49_), .O(z6));
  inv1   g86(.a(new_n73_), .O(z7));
endmodule
