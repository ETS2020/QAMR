...
module FAU ( 
  ...
  nand2  g55(.a(x20), .b(new_n35_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n34_), .c(x03), .O(new_n92_));
  nand2  g58(.a(new_n36_), .b(x14), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(x06), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(x11), .c(new_n53_), .O(new_n95_));
  oai22  g61(.a(new_n95_), .b(new_n88_), .c(new_n92_), .d(new_n49_), .O(z6));
