...
module FAU ( 
  ...
  nor2   g053(.a(new_n55_), .b(new_n70_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n83_), .O(new_n88_));
  ...
  nand4  g062(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n89_), .O(new_n98_));
  aoi21  g065(.a(new_n98_), .b(new_n88_), .c(new_n81_), .O(new_n99_));
  nand3  g066(.a(x16), .b(x15), .c(x14), .O(new_n100_));
  nand3  g067(.a(new_n87_), .b(x20), .c(x17), .O(new_n101_));
  ...
  nand3  g071(.a(new_n104_), .b(new_n67_), .c(new_n36_), .O(new_n105_));
  ...
  nand3  g076(.a(new_n109_), .b(new_n55_), .c(new_n70_), .O(new_n110_));
  inv1   g077(.a(new_n110_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n107_), .c(new_n106_), .d(new_n89_), .O(new_n112_));
  aoi21  g079(.a(new_n112_), .b(new_n103_), .c(x13), .O(new_n113_));
  aoi22  g080(.a(new_n113_), .b(new_n37_), .c(new_n99_), .d(x24), .O(new_n114_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n69_), .c(new_n53_), .O(new_n124_));
  ...
  nand4  g098(.a(new_n131_), .b(new_n69_), .c(new_n53_), .d(new_n36_), .O(new_n132_));
  ...
  nor2   g105(.a(new_n53_), .b(new_n36_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n138_), .c(new_n86_), .O(new_n140_));
  nor2   g107(.a(x03), .b(x01), .O(new_n141_));
  nor2   g108(.a(x20), .b(x14), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n92_), .d(new_n91_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n140_), .c(new_n81_), .O(new_n144_));
  nand4  g111(.a(new_n139_), .b(new_n138_), .c(x20), .d(x15), .O(new_n145_));
  nor2   g112(.a(x14), .b(x11), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n141_), .c(new_n109_), .d(new_n104_), .O(new_n147_));
  ...
  nand2  g117(.a(new_n55_), .b(x04), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n68_), .c(x22), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n54_), .c(x08), .O(new_n153_));
  aoi21  g120(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n70_), .c(x09), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x16), .c(new_n66_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n123_), .c(new_n153_), .d(new_n49_), .O(z4));
  inv1   g124(.a(new_n49_), .O(z5));
  nand2  g125(.a(x20), .b(new_n53_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n36_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n69_), .b(x14), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x06), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x11), .c(new_n34_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n123_), .c(new_n161_), .d(new_n49_), .O(z6));
  inv1   g132(.a(new_n123_), .O(z7));
endmodule
