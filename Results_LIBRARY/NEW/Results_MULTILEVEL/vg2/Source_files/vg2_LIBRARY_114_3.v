...
module FAU ( 
  ...
  nand2  g027(.a(new_n60_), .b(new_n56_), .O(new_n61_));
  ...
  nand2  g039(.a(new_n46_), .b(new_n37_), .O(new_n73_));
  ...
  nand3  g044(.a(new_n58_), .b(x20), .c(x18), .O(new_n78_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n70_), .c(new_n86_), .d(new_n85_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n84_), .c(new_n80_), .O(new_n93_));
  nand3  g060(.a(new_n93_), .b(new_n73_), .c(x24), .O(new_n94_));
  nand4  g061(.a(new_n34_), .b(new_n43_), .c(new_n53_), .d(x00), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand3  g063(.a(new_n44_), .b(new_n62_), .c(new_n81_), .O(new_n97_));
  nor3   g064(.a(new_n97_), .b(x06), .c(x04), .O(new_n98_));
  nand2  g065(.a(new_n86_), .b(new_n85_), .O(new_n99_));
  nor4   g066(.a(new_n99_), .b(x24), .c(x23), .d(x22), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(new_n96_), .d(new_n91_), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n94_), .c(new_n76_), .O(z1));
  ...
  nor3   g077(.a(new_n110_), .b(new_n86_), .c(new_n88_), .O(new_n111_));
  ...
  nand3  g081(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x20), .c(x14), .d(x11), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n81_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x06), .c(x03), .d(x01), .O(new_n119_));
  nand3  g086(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n120_));
  nand3  g087(.a(x19), .b(x13), .c(x05), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n86_), .c(new_n88_), .d(new_n36_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x08), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n35_), .c(new_n34_), .d(new_n53_), .O(new_n125_));
  ...
  nand3  g096(.a(new_n83_), .b(new_n34_), .c(new_n53_), .O(new_n130_));
  nand4  g097(.a(new_n86_), .b(new_n88_), .c(new_n36_), .d(new_n81_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n73_), .c(x24), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  nand3  g101(.a(new_n64_), .b(new_n34_), .c(new_n53_), .O(new_n135_));
  nand3  g102(.a(new_n69_), .b(new_n88_), .c(new_n36_), .O(new_n136_));
  ...
  and2   g105(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n127_), .O(z3));
  inv1   g107(.a(new_n110_), .O(z7));
  nand2  g108(.a(x22), .b(new_n85_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x09), .c(new_n89_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n81_), .c(z7), .O(new_n144_));
  inv1   g111(.a(x23), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n62_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n89_), .c(x08), .O(new_n148_));
  nand4  g115(.a(new_n58_), .b(x16), .c(x15), .d(new_n54_), .O(new_n149_));
  oai21  g116(.a(new_n148_), .b(new_n68_), .c(new_n149_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n75_), .O(new_n151_));
  nand4  g118(.a(new_n58_), .b(x18), .c(x16), .d(new_n54_), .O(new_n152_));
  oai21  g119(.a(new_n148_), .b(new_n82_), .c(new_n152_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n73_), .c(x24), .O(new_n154_));
  nor2   g121(.a(new_n148_), .b(x24), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n154_), .c(new_n151_), .d(new_n144_), .O(z4));
  inv1   g124(.a(new_n49_), .O(z5));
  nand2  g125(.a(x20), .b(new_n88_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n36_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n86_), .b(x14), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x06), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x11), .c(new_n34_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n110_), .c(new_n161_), .d(new_n49_), .O(z6));
endmodule
