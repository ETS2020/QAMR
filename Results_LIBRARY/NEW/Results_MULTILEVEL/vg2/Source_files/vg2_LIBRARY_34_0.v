...
module FAU ( 
  ...
  oai21  g089(.a(new_n116_), .b(new_n46_), .c(new_n122_), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n118_), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n71_), .c(new_n68_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x11), .c(x06), .d(x03), .O(new_n126_));
  nor2   g093(.a(new_n126_), .b(new_n64_), .O(z2));
  nand4  g094(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(new_n66_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(x06), .c(x03), .d(x01), .O(new_n130_));
  nand4  g097(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(x08), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n39_), .O(new_n135_));
  inv1   g102(.a(new_n86_), .O(new_n136_));
  nand4  g103(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n137_));
  nand3  g104(.a(new_n92_), .b(x14), .c(x11), .O(new_n138_));
  nand4  g105(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n139_));
  nand4  g106(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n140_));
  ...
  nand4  g110(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n144_));
  nand4  g111(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n145_));
  ...
  nand3  g114(.a(new_n147_), .b(new_n142_), .c(new_n135_), .O(z3));
  ...
  aoi21  g118(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n72_), .c(x09), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x16), .c(new_n66_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n124_), .c(new_n151_), .d(new_n49_), .O(z4));
  inv1   g122(.a(new_n49_), .O(z5));
  inv1   g123(.a(new_n45_), .O(new_n157_));
  nand2  g124(.a(x20), .b(new_n68_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n35_), .c(x11), .O(new_n159_));
  inv1   g126(.a(x19), .O(new_n160_));
  nand3  g127(.a(new_n39_), .b(x13), .c(x05), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n136_), .c(new_n160_), .O(new_n162_));
  oai22  g129(.a(new_n162_), .b(new_n157_), .c(new_n159_), .d(x03), .O(new_n163_));
  nor2   g130(.a(new_n91_), .b(x06), .O(new_n164_));
  nor2   g131(.a(x20), .b(new_n68_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n164_), .c(x11), .O(new_n166_));
  aoi21  g133(.a(x14), .b(new_n35_), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x03), .c(x07), .O(new_n168_));
  nand2  g135(.a(x18), .b(new_n34_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n136_), .c(x24), .O(new_n171_));
  inv1   g138(.a(new_n165_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n36_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n34_), .c(new_n121_), .O(new_n174_));
  aoi21  g141(.a(new_n39_), .b(new_n35_), .c(new_n165_), .O(new_n175_));
  oai22  g142(.a(new_n175_), .b(new_n36_), .c(x24), .d(x03), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(x15), .c(x13), .d(x05), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n174_), .c(new_n171_), .d(new_n163_), .O(z6));
  inv1   g145(.a(new_n124_), .O(z7));
endmodule
