...
module FAU ( 
  ...
  nand4  g006(.a(new_n39_), .b(x19), .c(new_n38_), .d(x13), .O(new_n40_));
  ...
  nand4  g044(.a(new_n77_), .b(new_n74_), .c(new_n73_), .d(new_n36_), .O(new_n78_));
  ...
  nor3   g064(.a(x16), .b(x12), .c(x11), .O(new_n98_));
  nand4  g065(.a(new_n74_), .b(new_n73_), .c(new_n36_), .d(new_n72_), .O(new_n99_));
  ...
  nand4  g075(.a(new_n72_), .b(new_n71_), .c(new_n38_), .d(new_n55_), .O(new_n109_));
  nand4  g076(.a(new_n74_), .b(new_n73_), .c(new_n36_), .d(x19), .O(new_n110_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n36_), .c(new_n38_), .O(new_n124_));
  ...
  nand4  g096(.a(new_n77_), .b(new_n36_), .c(new_n38_), .d(new_n35_), .O(new_n130_));
  ...
  nand3  g104(.a(new_n34_), .b(new_n67_), .c(new_n66_), .O(new_n138_));
  nand4  g105(.a(new_n36_), .b(new_n35_), .c(new_n69_), .d(x07), .O(new_n139_));
  ...
  nand4  g110(.a(new_n36_), .b(x19), .c(new_n38_), .d(new_n35_), .O(new_n144_));
  ...
  nand2  g126(.a(x20), .b(new_n38_), .O(new_n160_));
  ...
  aoi21  g133(.a(new_n36_), .b(x14), .c(new_n34_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n35_), .c(x03), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(x18), .O(new_n169_));
  nor2   g136(.a(x20), .b(x06), .O(new_n170_));
  oai21  g137(.a(new_n170_), .b(x11), .c(new_n67_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x07), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n135_), .c(x24), .O(new_n174_));
  inv1   g141(.a(x15), .O(new_n175_));
  oai21  g142(.a(new_n164_), .b(new_n175_), .c(new_n121_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n168_), .O(new_n177_));
  nand3  g144(.a(new_n177_), .b(new_n174_), .c(new_n166_), .O(z6));
  inv1   g145(.a(new_n123_), .O(z7));
endmodule
