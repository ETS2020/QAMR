...
module FAU ( 
  ...
  nand3  g038(.a(new_n71_), .b(new_n46_), .c(new_n37_), .O(new_n72_));
  ...
  nand4  g044(.a(new_n77_), .b(new_n62_), .c(new_n61_), .d(new_n75_), .O(new_n78_));
  ...
  nand4  g050(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n36_), .O(new_n84_));
  inv1   g051(.a(new_n84_), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n69_), .c(new_n80_), .d(new_n79_), .O(new_n86_));
  ...
  nand4  g056(.a(x18), .b(x17), .c(x16), .d(x14), .O(new_n90_));
  nand4  g057(.a(x24), .b(x23), .c(x22), .d(x20), .O(new_n91_));
  nor2   g058(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g059(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  oai21  g060(.a(new_n86_), .b(new_n78_), .c(new_n93_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n74_), .O(new_n95_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n39_), .c(x23), .d(x20), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(x17), .c(x16), .d(x14), .O(new_n101_));
  nor2   g068(.a(new_n101_), .b(new_n81_), .O(new_n102_));
  ...
  nand3  g072(.a(new_n105_), .b(new_n95_), .c(new_n72_), .O(z1));
  ...
  nor3   g081(.a(new_n114_), .b(new_n80_), .c(new_n82_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n53_), .O(z2));
  nand4  g084(.a(new_n98_), .b(x20), .c(x14), .d(x11), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n75_), .O(new_n119_));
  ...
  nand4  g090(.a(new_n123_), .b(new_n80_), .c(new_n82_), .d(new_n36_), .O(new_n124_));
  ...
  nand3  g097(.a(new_n77_), .b(new_n34_), .c(new_n53_), .O(new_n131_));
  nand4  g098(.a(new_n80_), .b(new_n82_), .c(new_n36_), .d(new_n75_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n63_), .b(new_n34_), .c(new_n53_), .O(new_n136_));
  nand3  g103(.a(new_n68_), .b(new_n82_), .c(new_n36_), .O(new_n137_));
  ...
  oai21  g108(.a(x16), .b(new_n61_), .c(new_n75_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(z5), .O(new_n143_));
  inv1   g110(.a(x22), .O(new_n144_));
  oai21  g111(.a(x23), .b(new_n54_), .c(new_n79_), .O(new_n145_));
  oai21  g112(.a(new_n73_), .b(new_n76_), .c(new_n47_), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n83_), .O(new_n147_));
  inv1   g114(.a(x23), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n61_), .c(x16), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x08), .O(new_n151_));
  nand3  g118(.a(new_n151_), .b(new_n98_), .c(new_n39_), .O(new_n152_));
  nand3  g119(.a(new_n74_), .b(x24), .c(x18), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n111_), .O(new_n154_));
  aoi21  g121(.a(new_n149_), .b(x22), .c(new_n61_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n83_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(new_n152_), .c(new_n147_), .d(new_n143_), .O(z4));
  nand2  g125(.a(x20), .b(new_n82_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n35_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n36_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n80_), .b(x14), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x06), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x11), .c(new_n34_), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n114_), .c(new_n161_), .d(new_n49_), .O(z6));
  inv1   g132(.a(new_n114_), .O(z7));
endmodule
