...
module FAU ( 
  ...
  nor3   g056(.a(x16), .b(x14), .c(x11), .O(new_n90_));
  nand4  g057(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n91_));
  ...
  nand2  g064(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  ...
  nand4  g068(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(x19), .O(new_n102_));
  ...
  nand2  g073(.a(new_n106_), .b(new_n80_), .O(z1));
  ...
  aoi21  g110(.a(new_n143_), .b(new_n83_), .c(x08), .O(new_n144_));
