...
module FAU ( 
  ...
  nand4  g056(.a(x04), .b(x03), .c(new_n89_), .d(x01), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  inv1   g058(.a(x10), .O(new_n92_));
  nand3  g059(.a(x11), .b(new_n92_), .c(x09), .O(new_n93_));
  nor3   g060(.a(new_n93_), .b(new_n79_), .c(new_n35_), .O(new_n94_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n94_), .c(new_n91_), .d(new_n75_), .O(new_n99_));
  ...
  nand4  g074(.a(new_n40_), .b(x21), .c(new_n92_), .d(new_n89_), .O(new_n108_));
  ...
  nor2   g080(.a(new_n79_), .b(new_n35_), .O(new_n114_));
  ...
  nand3  g084(.a(new_n61_), .b(new_n34_), .c(new_n101_), .O(new_n118_));
  nand3  g085(.a(new_n66_), .b(new_n102_), .c(new_n36_), .O(new_n119_));
  oai22  g086(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n115_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n72_), .O(new_n121_));
  nand2  g088(.a(new_n116_), .b(new_n77_), .O(new_n122_));
  nand3  g089(.a(new_n81_), .b(new_n34_), .c(new_n101_), .O(new_n123_));
  nand4  g090(.a(new_n37_), .b(new_n102_), .c(new_n36_), .d(new_n79_), .O(new_n124_));
  oai22  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n115_), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n70_), .c(x24), .O(new_n126_));
  nor2   g093(.a(x02), .b(new_n101_), .O(new_n127_));
  nand2  g094(.a(new_n116_), .b(new_n92_), .O(new_n128_));
  nand3  g095(.a(new_n40_), .b(x21), .c(x20), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n127_), .c(new_n114_), .d(x03), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n121_), .O(z3));
  nor2   g099(.a(new_n109_), .b(new_n105_), .O(new_n133_));
  inv1   g100(.a(x16), .O(new_n134_));
  aoi21  g101(.a(new_n96_), .b(x04), .c(x17), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x22), .c(new_n59_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n134_), .c(x08), .O(new_n137_));
  nand4  g104(.a(new_n40_), .b(new_n92_), .c(new_n89_), .d(x00), .O(new_n138_));
  ...
  oai21  g110(.a(new_n143_), .b(new_n95_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n79_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n133_), .c(new_n140_), .d(new_n137_), .O(z4));
  inv1   g113(.a(new_n140_), .O(z5));
  nand3  g114(.a(new_n92_), .b(new_n89_), .c(x00), .O(new_n148_));
  ...
  nand3  g120(.a(x21), .b(new_n92_), .c(new_n89_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai21  g122(.a(x20), .b(new_n102_), .c(x06), .O(new_n156_));
  ...
  nand4  g126(.a(x20), .b(x19), .c(x13), .d(x05), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n148_), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n102_), .c(new_n36_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n152_), .O(new_n163_));
  ...
  oai22  g133(.a(new_n166_), .b(new_n80_), .c(new_n157_), .d(new_n76_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n70_), .c(x24), .O(new_n168_));
  inv1   g135(.a(x15), .O(new_n169_));
  oai22  g136(.a(new_n166_), .b(new_n65_), .c(new_n157_), .d(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n44_), .c(new_n38_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n164_), .O(z6));
  inv1   g139(.a(new_n133_), .O(z7));
endmodule
