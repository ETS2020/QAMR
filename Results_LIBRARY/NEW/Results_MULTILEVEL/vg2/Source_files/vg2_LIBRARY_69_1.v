...
module FAU ( 
  ...
  nand4  g048(.a(new_n67_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n82_));
  ...
  nand4  g057(.a(x23), .b(x20), .c(x18), .d(x17), .O(new_n91_));
  nor4   g058(.a(new_n91_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n92_));
  nand2  g059(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  aoi22  g060(.a(new_n93_), .b(new_n88_), .c(new_n46_), .d(new_n37_), .O(new_n94_));
  nand4  g061(.a(new_n36_), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nor3   g063(.a(x16), .b(x14), .c(x12), .O(new_n97_));
  nand4  g064(.a(new_n85_), .b(new_n70_), .c(x19), .d(new_n69_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n81_), .O(new_n100_));
  nand3  g067(.a(x15), .b(x14), .c(x12), .O(new_n101_));
  nand4  g068(.a(x23), .b(x20), .c(x17), .d(x16), .O(new_n102_));
  nor2   g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n90_), .O(new_n104_));
  aoi21  g071(.a(new_n104_), .b(new_n100_), .c(x13), .O(new_n105_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n70_), .c(new_n54_), .O(new_n116_));
  ...
  nand4  g090(.a(new_n123_), .b(new_n70_), .c(new_n54_), .d(new_n36_), .O(new_n124_));
  ...
  nand4  g099(.a(new_n70_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n133_));
  ...
  nand4  g104(.a(new_n70_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n138_));
  ...
  nand2  g111(.a(x22), .b(new_n69_), .O(new_n145_));
  nand2  g112(.a(x23), .b(new_n65_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n145_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n66_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n115_), .c(new_n144_), .d(new_n49_), .O(z4));
  ...
  nand2  g120(.a(new_n70_), .b(x14), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(x06), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x11), .c(new_n34_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n115_), .c(new_n153_), .d(new_n49_), .O(z6));
