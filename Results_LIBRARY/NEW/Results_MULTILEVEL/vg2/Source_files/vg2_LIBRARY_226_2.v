...
module FAU ( 
  ...
  nand4  g041(.a(new_n74_), .b(new_n53_), .c(new_n36_), .d(new_n66_), .O(new_n75_));
  ...
  nand4  g060(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n87_), .O(new_n96_));
  aoi21  g063(.a(new_n96_), .b(new_n86_), .c(new_n80_), .O(new_n97_));
  nand3  g064(.a(x15), .b(x14), .c(x12), .O(new_n98_));
  nand4  g065(.a(x23), .b(x22), .c(x17), .d(x16), .O(new_n99_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n53_), .c(new_n36_), .O(new_n103_));
  ...
  nand3  g074(.a(new_n107_), .b(new_n55_), .c(new_n69_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n105_), .c(new_n104_), .d(new_n87_), .O(new_n110_));
  aoi21  g077(.a(new_n110_), .b(new_n101_), .c(x13), .O(new_n111_));
  aoi22  g078(.a(new_n111_), .b(new_n37_), .c(new_n97_), .d(x24), .O(new_n112_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n68_), .c(new_n54_), .O(new_n122_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n68_), .c(new_n54_), .d(new_n36_), .O(new_n130_));
  ...
  nor2   g103(.a(new_n54_), .b(new_n36_), .O(new_n137_));
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(x20), .d(x18), .O(new_n138_));
  nor2   g105(.a(x03), .b(x01), .O(new_n139_));
  nor2   g106(.a(x20), .b(x14), .O(new_n140_));
  nand4  g107(.a(new_n140_), .b(new_n139_), .c(new_n90_), .d(new_n89_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n138_), .c(new_n80_), .O(new_n142_));
  nand4  g109(.a(new_n137_), .b(new_n136_), .c(x20), .d(x15), .O(new_n143_));
  nor2   g110(.a(x14), .b(x11), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n139_), .c(new_n107_), .d(new_n102_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n143_), .c(x13), .O(new_n146_));
  aoi22  g113(.a(new_n146_), .b(new_n37_), .c(new_n142_), .d(x24), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n134_), .O(z3));
  inv1   g115(.a(x09), .O(new_n149_));
  aoi21  g116(.a(new_n55_), .b(x04), .c(x17), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x22), .c(new_n149_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n83_), .c(x08), .O(new_n152_));
  aoi21  g119(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n69_), .c(x09), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x16), .c(new_n66_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n121_), .c(new_n152_), .d(new_n49_), .O(z4));
  inv1   g123(.a(new_n49_), .O(z5));
  nand2  g124(.a(x20), .b(new_n54_), .O(new_n158_));
  ...
  oai22  g130(.a(new_n163_), .b(new_n121_), .c(new_n160_), .d(new_n49_), .O(z6));
