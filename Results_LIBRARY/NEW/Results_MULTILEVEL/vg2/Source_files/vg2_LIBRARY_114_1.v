...
module FAU ( 
  ...
  nand4  g060(.a(new_n66_), .b(new_n65_), .c(x07), .d(new_n35_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n68_), .b(new_n67_), .c(new_n53_), .d(new_n36_), .O(new_n96_));
  nand4  g063(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n97_));
  ...
  nor4   g069(.a(new_n102_), .b(new_n101_), .c(new_n70_), .d(new_n69_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  nand4  g071(.a(new_n36_), .b(new_n66_), .c(new_n65_), .d(new_n35_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n53_), .O(new_n107_));
  nand4  g074(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(x19), .O(new_n108_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n70_), .c(new_n67_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x11), .c(x06), .d(x03), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n63_), .O(z2));
  nand3  g091(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n125_));
  ...
  nand4  g096(.a(new_n75_), .b(new_n70_), .c(new_n67_), .d(new_n36_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(x08), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n39_), .O(new_n134_));
  inv1   g101(.a(new_n85_), .O(new_n135_));
  nand4  g102(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n136_));
  nand3  g103(.a(new_n90_), .b(x14), .c(x11), .O(new_n137_));
  nand4  g104(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n138_));
  nand4  g105(.a(new_n70_), .b(new_n67_), .c(new_n36_), .d(new_n65_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n65_), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n143_));
  nand4  g110(.a(new_n70_), .b(x19), .c(new_n67_), .d(new_n36_), .O(new_n144_));
  ...
  inv1   g114(.a(new_n121_), .O(z7));
  nand2  g115(.a(x22), .b(new_n69_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x09), .c(new_n68_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n65_), .c(z7), .O(new_n151_));
  nand3  g118(.a(new_n39_), .b(x13), .c(x05), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n135_), .O(new_n153_));
  inv1   g120(.a(x19), .O(new_n154_));
  aoi21  g121(.a(new_n72_), .b(x04), .c(x17), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x22), .c(new_n66_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n68_), .c(x08), .O(new_n157_));
  nand4  g124(.a(new_n91_), .b(x16), .c(x15), .d(new_n64_), .O(new_n158_));
  ...
  nand2  g128(.a(x16), .b(new_n64_), .O(new_n162_));
  nand2  g129(.a(new_n91_), .b(x18), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n162_), .c(new_n157_), .d(new_n161_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n135_), .c(x24), .O(new_n165_));
  inv1   g132(.a(x00), .O(new_n166_));
  nor2   g133(.a(x17), .b(x04), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x22), .c(new_n66_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n68_), .c(x08), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n166_), .c(new_n162_), .d(new_n101_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n165_), .c(new_n160_), .d(new_n151_), .O(z4));
  inv1   g139(.a(new_n49_), .O(z5));
  nand2  g140(.a(x20), .b(new_n67_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n35_), .O(new_n175_));
  aoi21  g142(.a(new_n175_), .b(new_n36_), .c(x03), .O(new_n176_));
  nand2  g143(.a(new_n70_), .b(x14), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(x06), .O(new_n178_));
  aoi21  g145(.a(new_n178_), .b(x11), .c(new_n34_), .O(new_n179_));
  oai22  g146(.a(new_n179_), .b(new_n121_), .c(new_n176_), .d(new_n49_), .O(z6));
endmodule
