...
module FAU ( 
  ...
  nor2   g102(.a(new_n68_), .b(new_n36_), .O(new_n136_));
  ...
  oai22  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n135_), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n46_), .c(new_n37_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n141_), .c(new_n133_), .O(z3));
  ...
  oai22  g120(.a(new_n153_), .b(new_n122_), .c(new_n150_), .d(new_n49_), .O(z4));
  ...
  nand2  g126(.a(new_n159_), .b(new_n134_), .O(new_n160_));
  inv1   g127(.a(x19), .O(new_n161_));
  oai21  g128(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n36_), .c(x03), .O(new_n163_));
  nand3  g130(.a(new_n136_), .b(new_n71_), .c(x15), .O(new_n164_));
  ...
  nand3  g134(.a(new_n136_), .b(new_n71_), .c(x18), .O(new_n168_));
  oai21  g135(.a(new_n163_), .b(new_n167_), .c(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n134_), .c(x24), .O(new_n170_));
  aoi21  g137(.a(x14), .b(new_n35_), .c(x11), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(x03), .c(x00), .O(new_n172_));
  nand3  g139(.a(new_n71_), .b(x14), .c(x11), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n175_));
  nand4  g142(.a(new_n175_), .b(new_n170_), .c(new_n166_), .d(new_n158_), .O(z6));
endmodule
