...
module FAU ( 
  ...
  nand4  g048(.a(x22), .b(x20), .c(x18), .d(x17), .O(new_n82_));
  nor4   g049(.a(new_n82_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n83_));
  nand2  g050(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nor3   g051(.a(x04), .b(x03), .c(x01), .O(new_n85_));
  nand4  g052(.a(new_n67_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n86_));
  inv1   g053(.a(new_n86_), .O(new_n87_));
  nor3   g054(.a(x14), .b(x12), .c(x11), .O(new_n88_));
  inv1   g055(.a(x23), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n55_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n88_), .c(new_n87_), .d(new_n85_), .O(new_n92_));
  aoi22  g059(.a(new_n92_), .b(new_n84_), .c(new_n46_), .d(new_n37_), .O(new_n93_));
  ...
  nand4  g067(.a(new_n89_), .b(new_n55_), .c(x19), .d(new_n69_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n85_), .O(new_n103_));
  ...
  aoi21  g108(.a(new_n89_), .b(x04), .c(x17), .O(new_n142_));
