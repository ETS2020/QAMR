// Benchmark "FAU" written by ABC on Sat Aug  1 09:45:37 2020
...
module FAU ( 
  ...
  nand3  g1144(.a(new_n108_), .b(x69), .c(x63), .O(new_n1236_));
  oai21  g1145(.a(x69), .b(new_n1235_), .c(new_n1236_), .O(new_n1237_));
  nand2  g1146(.a(new_n1237_), .b(new_n126_), .O(new_n1238_));
  nand3  g1147(.a(x71), .b(x70), .c(x47), .O(new_n1239_));
  nand3  g1148(.a(new_n1239_), .b(new_n1238_), .c(new_n1234_), .O(new_n1240_));
  nand2  g1149(.a(new_n1240_), .b(x67), .O(new_n1241_));
  nand2  g1150(.a(new_n1090_), .b(new_n1089_), .O(new_n1242_));
  nand2  g1151(.a(new_n1242_), .b(new_n219_), .O(new_n1243_));
  nand3  g1152(.a(new_n216_), .b(x73), .c(x23), .O(new_n1244_));
  aoi21  g1153(.a(new_n1244_), .b(new_n1243_), .c(new_n211_), .O(new_n1245_));
  nand2  g1154(.a(x74), .b(x28), .O(new_n1246_));
  oai21  g1155(.a(x74), .b(new_n1100_), .c(new_n1246_), .O(new_n1247_));
  nand2  g1156(.a(new_n1247_), .b(x73), .O(new_n1248_));
  nand2  g1157(.a(new_n278_), .b(x30), .O(new_n1249_));
  aoi21  g1158(.a(new_n1249_), .b(new_n1248_), .c(x72), .O(new_n1250_));
  oai21  g1159(.a(new_n1250_), .b(new_n1245_), .c(new_n144_), .O(new_n1251_));
  inv1   g1160(.a(x63), .O(new_n1252_));
  oai22  g1161(.a(new_n146_), .b(new_n1252_), .c(x71), .d(new_n1235_), .O(new_n1253_));
  nand2  g1162(.a(new_n1253_), .b(new_n214_), .O(new_n1254_));
  ...
  nand3  g1175(.a(new_n1266_), .b(new_n1254_), .c(new_n1251_), .O(new_n1267_));
  nand3  g1176(.a(new_n1267_), .b(x69), .c(new_n136_), .O(new_n1268_));
  nand2  g1177(.a(new_n1268_), .b(new_n1241_), .O(new_n1269_));
  nand2  g1178(.a(new_n1269_), .b(new_n135_), .O(new_n1270_));
  nand3  g1179(.a(new_n1240_), .b(new_n136_), .c(x66), .O(new_n1271_));
  ...
  nand2  g1184(.a(new_n214_), .b(x63), .O(new_n1276_));
  nand3  g1185(.a(new_n1276_), .b(new_n1264_), .c(new_n1258_), .O(new_n1277_));
  nand3  g1186(.a(new_n1277_), .b(new_n126_), .c(x65), .O(new_n1278_));
  nand3  g1187(.a(x71), .b(new_n140_), .c(x15), .O(new_n1279_));
  aoi21  g1188(.a(new_n1279_), .b(new_n1278_), .c(x70), .O(new_n1280_));
  nand4  g1189(.a(new_n126_), .b(x70), .c(new_n140_), .d(x47), .O(new_n1281_));
  inv1   g1190(.a(new_n1281_), .O(new_n1282_));
  oai21  g1191(.a(new_n1282_), .b(new_n1280_), .c(new_n93_), .O(new_n1283_));
  oai22  g1192(.a(new_n127_), .b(new_n1195_), .c(new_n109_), .d(new_n1148_), .O(new_n1284_));
  nand4  g1193(.a(new_n1284_), .b(new_n136_), .c(new_n135_), .d(x65), .O(new_n1285_));
  nand2  g1194(.a(new_n1285_), .b(new_n1283_), .O(new_n1286_));
  nand2  g1195(.a(new_n1286_), .b(new_n409_), .O(new_n1287_));
  nand2  g1196(.a(new_n238_), .b(x47), .O(new_n1288_));
  nand3  g1197(.a(new_n1277_), .b(new_n136_), .c(new_n135_), .O(new_n1289_));
  aoi21  g1198(.a(new_n1289_), .b(new_n1288_), .c(x71), .O(new_n1290_));
  nand4  g1199(.a(new_n1290_), .b(new_n108_), .c(new_n140_), .d(x64), .O(new_n1291_));
  nand2  g1200(.a(new_n1291_), .b(new_n1287_), .O(new_n1292_));
  nand3  g1201(.a(new_n1292_), .b(new_n152_), .c(x68), .O(new_n1293_));
  oai21  g1202(.a(new_n1275_), .b(x68), .c(new_n1293_), .O(z15));
endmodule
