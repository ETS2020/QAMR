...
module FAU ( 
  ...
  aoi21  g50(.a(x14), .b(x01), .c(new_n25_), .O(new_n75_));
  xnor2a g51(.a(x09), .b(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n27_), .c(x02), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n63_), .O(new_n78_));
  ...
  nand4  g65(.a(new_n89_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n90_));
