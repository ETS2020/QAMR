...
module FAU ( 
  ...
  nor2   g48(.a(new_n55_), .b(new_n65_), .O(new_n73_));
  oai21  g49(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(new_n73_), .O(new_n77_));
  nand2  g53(.a(x14), .b(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n65_), .O(new_n79_));
  nand2  g55(.a(new_n55_), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(new_n25_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n77_), .c(new_n56_), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(x07), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n38_), .O(new_n84_));
  nand4  g60(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(new_n87_));
  aoi21  g63(.a(x03), .b(new_n25_), .c(x08), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(z7));
  nand4  g66(.a(new_n66_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n50_), .b(new_n65_), .c(x10), .O(new_n93_));
