...
module FAU ( 
  ...
  oai21  g39(.a(x12), .b(x07), .c(new_n63_), .O(z3));
  ...
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n49_), .d(new_n68_), .O(z5));
  nor2   g46(.a(new_n55_), .b(new_n68_), .O(new_n71_));
  oai21  g47(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand3  g49(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n71_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n68_), .O(new_n77_));
  nand2  g53(.a(new_n55_), .b(x00), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n25_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n75_), .c(new_n56_), .O(new_n80_));
  ...
  aoi21  g67(.a(new_n50_), .b(new_n68_), .c(x10), .O(new_n92_));
