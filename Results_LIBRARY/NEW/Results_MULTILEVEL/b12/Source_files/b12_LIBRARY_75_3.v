...
module FAU ( 
  ...
  nand2  g22(.a(x10), .b(new_n34_), .O(new_n47_));
  ...
  nand2  g28(.a(x07), .b(new_n34_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  aoi21  g30(.a(new_n46_), .b(x02), .c(new_n54_), .O(new_n55_));
  inv1   g31(.a(x08), .O(new_n56_));
  inv1   g32(.a(x09), .O(new_n57_));
  oai21  g33(.a(x10), .b(new_n57_), .c(new_n47_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n25_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n38_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n56_), .c(new_n48_), .O(new_n61_));
  ...
  oai21  g42(.a(x11), .b(new_n48_), .c(new_n66_), .O(z4));
  nor2   g43(.a(x12), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n49_), .d(new_n48_), .O(z5));
  oai21  g45(.a(x09), .b(new_n34_), .c(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x00), .O(new_n71_));
  nand3  g47(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(x08), .O(new_n73_));
  oai21  g49(.a(new_n57_), .b(x03), .c(new_n38_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n57_), .b(x03), .c(new_n38_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(x00), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n48_), .O(new_n78_));
  aoi21  g54(.a(x14), .b(x02), .c(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(x02), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(x01), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n78_), .c(x10), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n25_), .O(new_n83_));
  nand3  g59(.a(new_n49_), .b(new_n56_), .c(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n38_), .O(new_n86_));
  oai21  g62(.a(x07), .b(new_n38_), .c(x03), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n56_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n44_), .O(z7));
  ...
  aoi21  g68(.a(new_n57_), .b(new_n63_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n48_), .O(z8));
endmodule
