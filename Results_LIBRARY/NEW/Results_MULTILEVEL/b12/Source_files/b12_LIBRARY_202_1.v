...
module FAU ( 
  ...
  nand2  g22(.a(x07), .b(new_n34_), .O(new_n47_));
  ...
  nand3  g29(.a(new_n49_), .b(x09), .c(new_n25_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n38_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n53_), .c(new_n48_), .O(new_n56_));
  ...
  oai22  g41(.a(x10), .b(new_n38_), .c(new_n65_), .d(x03), .O(new_n66_));
  nand2  g42(.a(new_n53_), .b(x00), .O(new_n67_));
  oai21  g43(.a(x01), .b(x00), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  oai21  g45(.a(x02), .b(x00), .c(new_n67_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n65_), .c(x03), .O(new_n71_));
  aoi21  g47(.a(x14), .b(x02), .c(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(x02), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n76_), .b(new_n69_), .c(x07), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n25_), .O(new_n78_));
  nand4  g54(.a(new_n49_), .b(new_n53_), .c(new_n48_), .d(x01), .O(new_n79_));
  ...
  aoi21  g63(.a(new_n65_), .b(new_n58_), .c(x10), .O(new_n88_));
