// Benchmark "FAU" written by ABC on Mon Jul 27 17:22:04 2020
...
module FAU ( 
  ...
  oai21  g30(.a(new_n54_), .b(x02), .c(new_n51_), .O(new_n55_));
  oai22  g31(.a(new_n55_), .b(x07), .c(new_n50_), .d(x00), .O(z2));
  ...
  oai21  g39(.a(x09), .b(new_n36_), .c(new_n25_), .O(new_n64_));
  ...
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n39_), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n44_), .b(x02), .c(new_n57_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n43_), .c(new_n42_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n39_), .O(new_n76_));
  nand4  g52(.a(new_n43_), .b(new_n51_), .c(new_n42_), .d(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n25_), .O(new_n79_));
  oai21  g55(.a(new_n36_), .b(x01), .c(new_n51_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n43_), .d(new_n42_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x09), .O(new_n84_));
  aoi21  g60(.a(new_n68_), .b(new_n57_), .c(x10), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n42_), .O(z8));
endmodule
