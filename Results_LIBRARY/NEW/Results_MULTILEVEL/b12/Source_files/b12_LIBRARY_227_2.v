...
module FAU ( 
  ...
  aoi21  g38(.a(x12), .b(new_n62_), .c(x07), .O(z3));
  nor2   g39(.a(new_n50_), .b(new_n55_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x00), .c(x07), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  aoi21  g42(.a(x12), .b(new_n62_), .c(new_n66_), .O(new_n67_));
