...
module FAU ( 
  ...
  nand3  g47(.a(x09), .b(new_n34_), .c(new_n62_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(x02), .O(new_n73_));
  aoi21  g49(.a(x14), .b(x01), .c(x00), .O(new_n74_));
  aoi21  g50(.a(new_n55_), .b(x00), .c(new_n74_), .O(new_n75_));
  nand4  g51(.a(x09), .b(new_n55_), .c(new_n34_), .d(new_n25_), .O(new_n76_));
  oai21  g52(.a(new_n75_), .b(new_n38_), .c(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n56_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n25_), .O(new_n80_));
  nand4  g56(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n38_), .O(new_n83_));
  oai21  g59(.a(x07), .b(new_n38_), .c(x03), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n55_), .c(new_n47_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n83_), .O(z7));
  nand4  g62(.a(new_n56_), .b(new_n50_), .c(new_n49_), .d(x00), .O(z8));
endmodule
