...
module FAU ( 
  ...
  nand3  g30(.a(x10), .b(new_n34_), .c(new_n25_), .O(new_n55_));
  ...
  oai21  g37(.a(new_n61_), .b(new_n59_), .c(new_n49_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n49_), .c(new_n62_), .O(z4));
  nor2   g39(.a(x12), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n50_), .d(new_n49_), .O(z5));
  oai21  g41(.a(x03), .b(x01), .c(x00), .O(new_n66_));
  nand2  g42(.a(x02), .b(new_n25_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  nand2  g44(.a(x14), .b(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x01), .O(new_n70_));
  oai21  g46(.a(new_n61_), .b(x03), .c(new_n38_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(new_n72_));
  nand3  g48(.a(new_n61_), .b(x03), .c(new_n38_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n70_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n59_), .c(new_n68_), .O(new_n75_));
  nor3   g51(.a(new_n75_), .b(x10), .c(x07), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n38_), .O(new_n77_));
  nand4  g53(.a(new_n50_), .b(new_n54_), .c(new_n49_), .d(x02), .O(new_n78_));
  ...
  aoi21  g62(.a(new_n61_), .b(new_n59_), .c(x10), .O(new_n87_));
