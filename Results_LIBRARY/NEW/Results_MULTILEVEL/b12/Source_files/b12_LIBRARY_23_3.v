...
module FAU ( 
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n49_), .d(new_n70_), .O(z5));
  oai21  g48(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n73_));
  nor2   g49(.a(x02), .b(x00), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n70_), .O(new_n75_));
  ...
  nand3  g56(.a(new_n80_), .b(x01), .c(new_n70_), .O(new_n81_));
  ...
  nand4  g67(.a(new_n62_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n50_), .b(new_n70_), .c(x10), .O(new_n94_));
