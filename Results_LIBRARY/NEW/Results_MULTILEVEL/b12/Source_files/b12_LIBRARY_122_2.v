...
module FAU ( 
  ...
  nand2  g39(.a(x12), .b(new_n62_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(x09), .c(x08), .O(new_n65_));
  ...
  aoi21  g49(.a(new_n50_), .b(x03), .c(x01), .O(new_n74_));
  nand3  g50(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n72_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n56_), .c(new_n49_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n25_), .O(new_n83_));
  nor2   g59(.a(x10), .b(x08), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n49_), .c(x01), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n88_), .b(new_n55_), .c(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n84_), .b(new_n49_), .c(new_n34_), .d(new_n25_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n38_), .d(new_n25_), .O(new_n93_));
