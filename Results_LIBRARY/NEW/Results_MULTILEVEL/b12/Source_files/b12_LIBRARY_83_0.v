...
module FAU ( 
  ...
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(x14), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n63_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n74_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n57_), .c(new_n50_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(new_n87_));
  oai21  g63(.a(x07), .b(new_n25_), .c(x03), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n56_), .c(new_n48_), .O(new_n89_));
  ...
  aoi21  g69(.a(new_n51_), .b(new_n63_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n50_), .O(z8));
endmodule
