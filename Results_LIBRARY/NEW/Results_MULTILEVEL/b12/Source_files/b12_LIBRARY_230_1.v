...
module FAU ( 
  ...
  nand2  g31(.a(new_n52_), .b(new_n38_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n47_), .O(new_n57_));
  ...
  oai21  g38(.a(x11), .b(new_n47_), .c(new_n62_), .O(z4));
  nor2   g39(.a(x12), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n48_), .d(new_n47_), .O(z5));
  ...
  nand3  g45(.a(new_n69_), .b(new_n66_), .c(new_n38_), .O(new_n70_));
  nand2  g46(.a(x14), .b(x01), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n59_), .O(new_n72_));
  oai21  g48(.a(x08), .b(new_n59_), .c(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n47_), .c(x02), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n70_), .c(x10), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n25_), .O(new_n76_));
  nand3  g52(.a(new_n48_), .b(new_n55_), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n38_), .O(new_n79_));
  oai21  g55(.a(x07), .b(new_n38_), .c(x03), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n55_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n44_), .O(z7));
  ...
  aoi21  g61(.a(new_n50_), .b(new_n59_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n47_), .O(z8));
endmodule
