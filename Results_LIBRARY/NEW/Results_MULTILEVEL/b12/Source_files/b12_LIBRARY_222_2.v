...
module FAU ( 
  ...
  nand2  g16(.a(new_n33_), .b(x01), .O(new_n41_));
  oai21  g17(.a(new_n32_), .b(new_n27_), .c(x04), .O(new_n42_));
  nor2   g18(.a(x04), .b(new_n36_), .O(new_n43_));
  nor2   g19(.a(x10), .b(x07), .O(new_n44_));
  oai21  g20(.a(new_n44_), .b(new_n43_), .c(new_n27_), .O(new_n45_));
  ...
  aoi21  g45(.a(new_n69_), .b(new_n25_), .c(new_n62_), .O(new_n70_));
  nand3  g46(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n26_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n55_), .O(new_n73_));
  oai21  g49(.a(new_n50_), .b(x03), .c(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n27_), .O(new_n75_));
  oai21  g51(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x02), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n56_), .c(new_n49_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g61(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x01), .O(new_n86_));
  ...
  aoi21  g65(.a(new_n89_), .b(new_n55_), .c(new_n47_), .O(new_n90_));
  ...
  aoi21  g70(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n95_));
