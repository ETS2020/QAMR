...
module FAU ( 
  ...
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n49_), .d(new_n62_), .O(z5));
  nor2   g44(.a(new_n55_), .b(new_n62_), .O(new_n69_));
  oai21  g45(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(new_n69_), .O(new_n73_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n56_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n38_), .O(new_n80_));
  nand4  g56(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n81_));
  ...
  aoi21  g65(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n90_));
