// Benchmark "FAU" written by ABC on Mon Jul 27 17:22:02 2020
...
module FAU ( 
  ...
  nand2  g43(.a(new_n51_), .b(x03), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n25_), .c(new_n63_), .O(new_n70_));
  nand3  g45(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n26_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n70_), .c(new_n56_), .O(new_n73_));
  oai21  g48(.a(new_n51_), .b(x03), .c(new_n25_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n27_), .O(new_n75_));
  oai21  g50(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  inv1   g52(.a(x14), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(x02), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(new_n57_), .c(new_n50_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g60(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  oai21  g63(.a(x07), .b(new_n25_), .c(x03), .O(new_n89_));
  aoi21  g64(.a(new_n89_), .b(new_n56_), .c(new_n48_), .O(new_n90_));
  nand2  g65(.a(new_n90_), .b(new_n88_), .O(z7));
  inv1   g66(.a(x12), .O(new_n92_));
  nand4  g67(.a(new_n92_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n93_));
  nand2  g68(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g69(.a(new_n51_), .b(new_n63_), .c(x10), .O(new_n95_));
  nand3  g70(.a(new_n95_), .b(new_n94_), .c(new_n50_), .O(z8));
  one    g71(.O(z5));
endmodule
