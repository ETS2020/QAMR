...
module FAU ( 
  ...
  oai21  g47(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n73_));
  nand2  g48(.a(x08), .b(x00), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  inv1   g50(.a(x14), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x02), .c(new_n70_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(new_n55_), .c(new_n48_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z6));
  nand2  g55(.a(new_n48_), .b(x02), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x03), .c(new_n25_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n54_), .O(new_n83_));
  nand4  g58(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(new_n83_), .c(new_n55_), .d(new_n48_), .O(z7));
  nand4  g60(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(x00), .O(z8));
  one    g61(.O(z5));
endmodule
