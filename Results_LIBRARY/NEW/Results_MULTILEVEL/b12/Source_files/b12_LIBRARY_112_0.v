...
module FAU ( 
  ...
  oai21  g40(.a(x12), .b(x11), .c(new_n64_), .O(z3));
  ...
  nand3  g61(.a(new_n85_), .b(new_n57_), .c(new_n50_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand4  g64(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n89_));
  ...
  aoi21  g68(.a(new_n92_), .b(new_n56_), .c(new_n48_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n91_), .O(z7));
  nand4  g70(.a(new_n57_), .b(new_n51_), .c(new_n50_), .d(x00), .O(z8));
endmodule
