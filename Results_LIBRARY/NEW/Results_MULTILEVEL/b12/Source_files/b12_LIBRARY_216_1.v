...
module FAU ( 
  ...
  oai21  g18(.a(x04), .b(new_n34_), .c(x07), .O(new_n43_));
  ...
  nand2  g23(.a(x09), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g28(.a(new_n52_), .b(new_n38_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n25_), .b(new_n56_), .c(new_n52_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n51_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(x09), .c(x00), .O(new_n60_));
  ...
  nand4  g41(.a(x13), .b(new_n65_), .c(new_n47_), .d(new_n56_), .O(z5));
  ...
  aoi22  g47(.a(new_n71_), .b(new_n38_), .c(x08), .d(x00), .O(new_n72_));
  nor2   g48(.a(x14), .b(new_n25_), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n56_), .c(new_n72_), .d(new_n25_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n70_), .c(x07), .O(z6));
  nand2  g51(.a(new_n47_), .b(x02), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x03), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n51_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(new_n34_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n79_), .c(x07), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n78_), .O(z7));
  nand3  g59(.a(new_n79_), .b(new_n65_), .c(x03), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n80_), .b(new_n56_), .c(x07), .O(new_n86_));
