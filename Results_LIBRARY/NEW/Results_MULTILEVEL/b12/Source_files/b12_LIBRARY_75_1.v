...
module FAU ( 
  ...
  nor2   g27(.a(x07), .b(new_n38_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n51_), .O(new_n53_));
  oai21  g29(.a(new_n50_), .b(x00), .c(new_n53_), .O(z2));
  ...
  oai21  g35(.a(x11), .b(new_n57_), .c(new_n59_), .O(z4));
  nor2   g36(.a(x12), .b(x10), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n57_), .d(new_n55_), .O(z5));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n38_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n63_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(x14), .b(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n55_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n55_), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n57_), .c(x01), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n68_), .c(x10), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n38_), .O(new_n74_));
  nand3  g50(.a(new_n47_), .b(new_n51_), .c(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  oai21  g53(.a(new_n34_), .b(x01), .c(new_n51_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n47_), .d(new_n57_), .O(z7));
  ...
  aoi21  g58(.a(new_n65_), .b(new_n55_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n57_), .O(z8));
endmodule
