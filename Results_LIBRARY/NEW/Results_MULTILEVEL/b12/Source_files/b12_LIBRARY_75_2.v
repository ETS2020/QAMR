...
module FAU ( 
  ...
  nor2   g23(.a(new_n43_), .b(x01), .O(new_n48_));
  nor2   g24(.a(new_n44_), .b(x07), .O(new_n49_));
  ...
  nand2  g30(.a(new_n44_), .b(x09), .O(new_n55_));
  nand2  g31(.a(x10), .b(new_n36_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n55_), .c(new_n39_), .O(new_n57_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n39_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n66_), .c(new_n44_), .d(new_n43_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(z6));
  oai21  g48(.a(x07), .b(new_n39_), .c(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n54_), .O(new_n74_));
  nand3  g50(.a(x09), .b(x03), .c(new_n39_), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n44_), .d(new_n43_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x03), .c(new_n39_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  aoi21  g55(.a(new_n68_), .b(new_n42_), .c(x10), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n43_), .O(z8));
endmodule
