...
module FAU ( 
  ...
  oai21  g38(.a(new_n62_), .b(new_n49_), .c(x00), .O(new_n63_));
  oai21  g39(.a(x12), .b(x00), .c(new_n63_), .O(z3));
  inv1   g40(.a(x00), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n49_), .c(new_n65_), .O(new_n67_));
  oai21  g43(.a(new_n50_), .b(new_n55_), .c(new_n49_), .O(new_n68_));
  nand2  g44(.a(new_n62_), .b(x07), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z4));
  nor2   g46(.a(x12), .b(x00), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n56_), .d(new_n49_), .O(z5));
  oai21  g48(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n73_));
  nor2   g49(.a(x02), .b(x00), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n65_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(new_n76_));
  oai21  g52(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n77_));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n25_), .O(new_n79_));
  inv1   g55(.a(x14), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x01), .c(new_n65_), .O(new_n81_));
  ...
  nand3  g60(.a(x09), .b(x03), .c(new_n38_), .O(new_n85_));
  nand4  g61(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n86_));
  ...
  nor2   g65(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z7));
  nand4  g67(.a(new_n66_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n50_), .b(new_n65_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n49_), .O(z8));
endmodule
