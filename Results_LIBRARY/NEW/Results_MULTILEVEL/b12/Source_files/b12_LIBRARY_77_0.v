...
module FAU ( 
  ...
  nand2  g19(.a(new_n26_), .b(x04), .O(new_n44_));
  nor2   g20(.a(new_n26_), .b(new_n38_), .O(new_n45_));
  oai21  g21(.a(new_n45_), .b(new_n33_), .c(x01), .O(new_n46_));
  inv1   g22(.a(x07), .O(new_n47_));
  inv1   g23(.a(x10), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n31_), .O(new_n50_));
  ...
  nand2  g47(.a(new_n51_), .b(x03), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n38_), .c(new_n43_), .O(new_n73_));
  nand3  g49(.a(x09), .b(new_n31_), .c(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n39_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n59_), .O(new_n76_));
  oai21  g52(.a(new_n51_), .b(x03), .c(new_n38_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  oai21  g54(.a(x09), .b(new_n31_), .c(new_n25_), .O(new_n79_));
  ...
  nand2  g59(.a(new_n83_), .b(new_n43_), .O(new_n84_));
  ...
  nand4  g64(.a(new_n48_), .b(new_n59_), .c(new_n47_), .d(x01), .O(new_n89_));
  ...
  aoi21  g68(.a(new_n92_), .b(new_n59_), .c(new_n49_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n91_), .O(z7));
  inv1   g70(.a(x12), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g73(.a(new_n51_), .b(new_n43_), .c(x10), .O(new_n98_));
