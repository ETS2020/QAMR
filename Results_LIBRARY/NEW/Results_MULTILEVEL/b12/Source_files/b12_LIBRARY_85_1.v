// Benchmark "FAU" written by ABC on Mon Jul 27 17:21:54 2020
...
module FAU ( 
  ...
  nand3  g27(.a(x10), .b(new_n36_), .c(new_n27_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n25_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(new_n54_));
  oai21  g30(.a(new_n49_), .b(x00), .c(new_n54_), .O(z2));
  inv1   g31(.a(x00), .O(new_n56_));
  aoi22  g32(.a(x12), .b(new_n56_), .c(x11), .d(x07), .O(z3));
  nand2  g33(.a(new_n51_), .b(x02), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(x09), .c(x00), .O(new_n59_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n62_), .d(new_n50_), .O(z5));
  oai21  g40(.a(x03), .b(x02), .c(x00), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n26_), .c(x08), .O(new_n66_));
  nand2  g42(.a(x14), .b(x01), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x02), .O(new_n68_));
  oai21  g44(.a(x03), .b(x01), .c(new_n25_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n68_), .c(x00), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n66_), .c(new_n62_), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(x07), .O(z6));
  oai21  g48(.a(x10), .b(new_n27_), .c(new_n25_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n50_), .c(new_n36_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x08), .c(new_n45_), .O(z7));
  inv1   g51(.a(x09), .O(new_n76_));
  nand4  g52(.a(new_n62_), .b(new_n76_), .c(new_n50_), .d(x00), .O(z8));
endmodule
