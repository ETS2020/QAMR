...
module FAU ( 
  ...
  nand2  g39(.a(x12), .b(new_n63_), .O(z3));
  nand4  g40(.a(x09), .b(x08), .c(new_n50_), .d(x00), .O(z4));
  nor2   g41(.a(x12), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n57_), .d(new_n50_), .O(z5));
  nand2  g43(.a(new_n51_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n25_), .c(new_n63_), .O(new_n69_));
  nand3  g45(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n56_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n51_), .b(x03), .c(new_n25_), .O(new_n77_));
  ...
  nand4  g59(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n87_), .b(new_n56_), .c(new_n48_), .O(new_n88_));
