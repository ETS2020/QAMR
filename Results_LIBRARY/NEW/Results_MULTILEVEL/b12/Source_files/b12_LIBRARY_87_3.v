...
module FAU ( 
  ...
  nor2   g44(.a(x09), .b(new_n34_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x01), .c(x00), .O(new_n70_));
  oai21  g46(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n70_), .c(x08), .O(new_n73_));
  nor2   g49(.a(x14), .b(new_n25_), .O(new_n74_));
  aoi21  g50(.a(new_n69_), .b(new_n38_), .c(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n72_), .c(x00), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n49_), .O(new_n77_));
  nand4  g53(.a(x14), .b(new_n38_), .c(x01), .d(new_n62_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(x10), .O(z6));
