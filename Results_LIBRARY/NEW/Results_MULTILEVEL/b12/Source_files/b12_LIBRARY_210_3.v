...
module FAU ( 
  ...
  aoi21  g24(.a(x09), .b(new_n48_), .c(x10), .O(new_n49_));
  ...
  oai21  g29(.a(new_n53_), .b(x01), .c(new_n38_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(new_n55_));
  oai21  g31(.a(new_n51_), .b(x00), .c(new_n55_), .O(z2));
  inv1   g32(.a(x00), .O(new_n57_));
  aoi22  g33(.a(x12), .b(new_n57_), .c(x11), .d(x07), .O(z3));
  oai21  g34(.a(x09), .b(x01), .c(new_n52_), .O(new_n59_));
  ...
  oai22  g41(.a(x10), .b(new_n25_), .c(x09), .d(new_n34_), .O(new_n66_));
  nand2  g42(.a(new_n38_), .b(new_n57_), .O(new_n67_));
  oai21  g43(.a(x08), .b(new_n57_), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x03), .c(new_n38_), .O(new_n71_));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x01), .c(new_n57_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n63_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n69_), .c(x07), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n38_), .O(new_n79_));
  nand4  g55(.a(new_n63_), .b(new_n52_), .c(new_n48_), .d(x02), .O(new_n80_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n44_), .O(z7));
  ...
  aoi21  g64(.a(new_n70_), .b(new_n57_), .c(x10), .O(new_n89_));
