...
module FAU ( 
  ...
  nor2   g43(.a(new_n55_), .b(new_n62_), .O(new_n68_));
  oai21  g44(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(new_n70_));
  nand3  g46(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n70_), .c(new_n68_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n62_), .O(new_n74_));
  nand2  g50(.a(new_n55_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n25_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n72_), .c(new_n56_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n38_), .O(new_n79_));
  nand4  g55(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  aoi21  g58(.a(x03), .b(new_n25_), .c(x08), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(new_n47_), .O(new_n84_));
  ...
  aoi21  g64(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n89_));
