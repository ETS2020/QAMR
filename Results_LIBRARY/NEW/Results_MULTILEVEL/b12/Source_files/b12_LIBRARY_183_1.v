...
module FAU ( 
  ...
  oai21  g23(.a(x10), .b(x07), .c(new_n36_), .O(new_n48_));
  ...
  aoi21  g29(.a(new_n47_), .b(x02), .c(new_n53_), .O(new_n54_));
  inv1   g30(.a(x08), .O(new_n55_));
  inv1   g31(.a(x10), .O(new_n56_));
  nor2   g32(.a(new_n56_), .b(x03), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n51_), .c(new_n27_), .O(new_n58_));
  ...
  nand4  g42(.a(x13), .b(new_n56_), .c(new_n49_), .d(new_n62_), .O(z5));
  nand2  g43(.a(new_n50_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n25_), .c(new_n62_), .O(new_n69_));
  nand3  g45(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n55_), .O(new_n72_));
  oai21  g48(.a(new_n50_), .b(x03), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n27_), .O(new_n74_));
  oai21  g50(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n75_));
  ...
  nand2  g55(.a(new_n79_), .b(new_n62_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n72_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n56_), .c(new_n49_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand3  g60(.a(new_n56_), .b(new_n55_), .c(x01), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(x02), .O(new_n86_));
  aoi21  g62(.a(new_n55_), .b(x02), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n55_), .b(new_n36_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n56_), .d(new_n49_), .O(z7));
