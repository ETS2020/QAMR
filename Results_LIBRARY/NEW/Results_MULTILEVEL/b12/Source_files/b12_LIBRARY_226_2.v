...
module FAU ( 
  ...
  nor3   g22(.a(new_n44_), .b(x03), .c(x01), .O(new_n47_));
  aoi21  g23(.a(new_n46_), .b(x02), .c(new_n47_), .O(new_n48_));
  inv1   g24(.a(x07), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand3  g26(.a(x10), .b(new_n34_), .c(new_n25_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n38_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n50_), .c(new_n49_), .O(new_n53_));
  ...
  oai21  g34(.a(x11), .b(new_n49_), .c(new_n58_), .O(z4));
  inv1   g35(.a(x09), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x00), .O(new_n61_));
  nand2  g37(.a(x12), .b(new_n55_), .O(new_n62_));
  inv1   g38(.a(x13), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(x10), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n62_), .c(new_n61_), .d(new_n49_), .O(z5));
  inv1   g41(.a(x10), .O(new_n66_));
  nand2  g42(.a(new_n25_), .b(new_n55_), .O(new_n67_));
  nand2  g43(.a(new_n50_), .b(x00), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n67_), .c(new_n34_), .d(new_n38_), .O(new_n69_));
  nand2  g45(.a(x14), .b(x02), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n55_), .O(new_n71_));
  nand2  g47(.a(new_n50_), .b(new_n38_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n69_), .c(new_n66_), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(x07), .O(z6));
  oai21  g51(.a(x10), .b(new_n25_), .c(new_n38_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n49_), .c(new_n34_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x08), .c(new_n44_), .O(z7));
  nand3  g54(.a(new_n66_), .b(new_n49_), .c(x00), .O(z8));
endmodule
