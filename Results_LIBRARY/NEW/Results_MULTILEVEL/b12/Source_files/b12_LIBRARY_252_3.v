...
module FAU ( 
  ...
  oai21  g40(.a(x13), .b(x00), .c(x09), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n56_), .c(new_n50_), .O(new_n66_));
  ...
  oai21  g52(.a(new_n51_), .b(x03), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n27_), .O(new_n78_));
  nand3  g54(.a(new_n51_), .b(x03), .c(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n76_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n74_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n57_), .c(new_n50_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g61(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  oai21  g64(.a(x07), .b(new_n25_), .c(x03), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n56_), .c(new_n48_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n51_), .b(new_n63_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n50_), .O(z8));
endmodule
