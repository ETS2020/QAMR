// Benchmark "FAU" written by ABC on Mon Jul 27 17:22:13 2020
...
module FAU ( 
  ...
  oai21  g30(.a(new_n49_), .b(x03), .c(new_n54_), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n53_), .c(new_n48_), .d(new_n25_), .O(new_n56_));
  ...
  nand2  g36(.a(new_n60_), .b(new_n48_), .O(new_n61_));
  oai21  g37(.a(x11), .b(new_n48_), .c(new_n61_), .O(z4));
  nor2   g38(.a(x12), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n49_), .d(new_n48_), .O(z5));
  oai21  g40(.a(x02), .b(x00), .c(x08), .O(new_n65_));
  ...
  oai21  g46(.a(new_n68_), .b(x01), .c(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n58_), .O(new_n72_));
  nand3  g48(.a(x09), .b(new_n53_), .c(new_n34_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n67_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n49_), .c(new_n48_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  nand2  g52(.a(new_n44_), .b(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x01), .O(new_n80_));
  inv1   g56(.a(x09), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(new_n34_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n80_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n79_), .c(new_n48_), .O(z7));
  inv1   g60(.a(x12), .O(new_n85_));
  nand3  g61(.a(new_n80_), .b(new_n85_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n81_), .b(new_n58_), .c(x10), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n48_), .O(z8));
endmodule
