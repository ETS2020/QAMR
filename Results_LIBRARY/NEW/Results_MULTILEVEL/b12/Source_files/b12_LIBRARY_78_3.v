...
module FAU ( 
  ...
  oai21  g39(.a(x13), .b(x07), .c(x11), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  oai21  g41(.a(new_n50_), .b(new_n55_), .c(new_n49_), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(x07), .c(x00), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(z4));
  inv1   g45(.a(x13), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n49_), .c(x12), .d(new_n67_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n56_), .c(new_n49_), .d(new_n62_), .O(z5));
  oai21  g48(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n73_));
  nor2   g49(.a(x02), .b(x00), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n62_), .O(new_n75_));
  ...
  nand3  g56(.a(new_n80_), .b(x01), .c(new_n62_), .O(new_n81_));
