...
module FAU ( 
  ...
  nand4  g43(.a(new_n67_), .b(new_n55_), .c(new_n48_), .d(new_n61_), .O(z5));
  nor2   g44(.a(new_n54_), .b(new_n61_), .O(new_n69_));
  oai21  g45(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n72_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n55_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand2  g55(.a(new_n48_), .b(x02), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x03), .c(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nand4  g58(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n55_), .d(new_n48_), .O(z7));
  aoi21  g60(.a(x03), .b(new_n38_), .c(x07), .O(new_n85_));
  inv1   g61(.a(x12), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n85_), .c(x09), .O(new_n88_));
