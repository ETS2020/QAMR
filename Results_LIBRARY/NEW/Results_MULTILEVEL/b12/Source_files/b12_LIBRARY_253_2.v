...
module FAU ( 
  ...
  nor2   g45(.a(new_n69_), .b(new_n62_), .O(new_n70_));
  nand3  g46(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n50_), .b(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n70_), .c(new_n55_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n72_), .O(new_n79_));
  ...
  nor2   g59(.a(x09), .b(x02), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(x03), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n55_), .O(new_n86_));
  nor2   g62(.a(new_n50_), .b(new_n34_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n69_), .c(new_n47_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x03), .c(new_n38_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n49_), .d(new_n25_), .O(z8));
endmodule
