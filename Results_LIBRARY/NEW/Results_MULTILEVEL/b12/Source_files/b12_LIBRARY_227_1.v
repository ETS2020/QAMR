...
module FAU ( 
  ...
  aoi21  g37(.a(x12), .b(new_n61_), .c(x11), .O(z3));
  nor3   g38(.a(new_n49_), .b(new_n54_), .c(x07), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(x00), .c(x11), .O(z4));
  inv1   g40(.a(x11), .O(new_n65_));
  nor3   g41(.a(x12), .b(x07), .c(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n65_), .d(new_n55_), .O(z5));
  ...
  oai21  g47(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n72_));
  ...
  oai21  g59(.a(new_n34_), .b(x01), .c(new_n54_), .O(new_n84_));
  nor2   g60(.a(x11), .b(x07), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n55_), .O(z7));
