...
module FAU ( 
  ...
  nand2  g31(.a(x10), .b(new_n34_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n55_), .c(x01), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x02), .c(new_n54_), .O(new_n58_));
  ...
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(new_n49_), .O(new_n63_));
  inv1   g39(.a(x11), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x07), .c(new_n54_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z4));
  nor2   g42(.a(x12), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n50_), .d(new_n49_), .O(z5));
  oai21  g44(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n69_));
  nor3   g45(.a(x07), .b(x02), .c(x00), .O(new_n70_));
  nor2   g46(.a(x08), .b(new_n60_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  oai21  g48(.a(new_n62_), .b(x03), .c(new_n38_), .O(new_n73_));
  oai21  g49(.a(x07), .b(x00), .c(x08), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  inv1   g51(.a(x14), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n49_), .c(x01), .d(new_n60_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(new_n78_));
  and2   g54(.a(new_n78_), .b(new_n50_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n38_), .O(new_n80_));
  nand3  g56(.a(new_n50_), .b(new_n54_), .c(x02), .O(new_n81_));
  ...
  aoi21  g65(.a(new_n62_), .b(new_n60_), .c(x10), .O(new_n90_));
