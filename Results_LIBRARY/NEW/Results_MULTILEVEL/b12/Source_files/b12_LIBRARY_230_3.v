...
module FAU ( 
  ...
  oai21  g19(.a(x04), .b(new_n36_), .c(x10), .O(new_n44_));
  nand2  g20(.a(new_n44_), .b(new_n27_), .O(new_n45_));
  nand3  g21(.a(new_n45_), .b(new_n43_), .c(new_n42_), .O(new_n46_));
  ...
  nand3  g26(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n51_));
  ...
  nand2  g30(.a(new_n48_), .b(x09), .O(new_n55_));
  nand2  g31(.a(x10), .b(new_n36_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n47_), .c(new_n27_), .O(new_n58_));
  ...
  nand2  g40(.a(new_n64_), .b(new_n47_), .O(new_n65_));
  oai21  g41(.a(x11), .b(new_n47_), .c(new_n65_), .O(z4));
  nor2   g42(.a(x12), .b(x00), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(x13), .c(new_n48_), .d(new_n47_), .O(z5));
  inv1   g44(.a(x09), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n47_), .c(x03), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n25_), .c(new_n62_), .O(new_n71_));
  nand3  g47(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n26_), .c(x07), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(new_n74_));
  nand3  g50(.a(x09), .b(new_n47_), .c(new_n36_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n25_), .c(x01), .O(new_n76_));
  oai21  g52(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n47_), .c(new_n25_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n76_), .c(new_n62_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n74_), .c(x10), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n48_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n88_), .b(new_n54_), .c(new_n49_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n69_), .b(new_n62_), .c(x10), .O(new_n94_));
