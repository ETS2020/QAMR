// Benchmark "FAU" written by ABC on Mon Jul 27 17:22:01 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n63_), .b(x12), .O(z3));
  inv1   g40(.a(x00), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x07), .c(x11), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  oai21  g44(.a(new_n50_), .b(new_n55_), .c(new_n49_), .O(new_n69_));
  nand3  g45(.a(new_n62_), .b(x07), .c(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z4));
  nor2   g47(.a(x12), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n56_), .d(new_n49_), .O(z5));
  oai21  g49(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n65_), .O(new_n76_));
  ...
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n65_), .O(new_n82_));
  ...
  nand4  g68(.a(new_n66_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n50_), .b(new_n65_), .c(x10), .O(new_n95_));
