...
module FAU ( 
  ...
  oai21  g26(.a(new_n44_), .b(x03), .c(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n25_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n47_), .c(x00), .O(z2));
  inv1   g29(.a(x00), .O(new_n54_));
  aoi22  g30(.a(x12), .b(new_n54_), .c(x11), .d(x07), .O(z3));
  inv1   g31(.a(x09), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n48_), .O(new_n57_));
  ...
  oai21  g38(.a(new_n56_), .b(x03), .c(new_n38_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n25_), .O(new_n64_));
  nand3  g40(.a(new_n56_), .b(x03), .c(new_n38_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n49_), .c(new_n48_), .d(new_n54_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  nand4  g44(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n49_), .c(new_n48_), .O(z7));
  inv1   g46(.a(x12), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x09), .O(new_n73_));
  aoi21  g49(.a(new_n56_), .b(new_n54_), .c(x10), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z8));
endmodule
