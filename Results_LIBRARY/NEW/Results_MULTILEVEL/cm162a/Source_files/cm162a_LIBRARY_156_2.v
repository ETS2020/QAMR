// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:52 2020
...
module FAU ( 
  ...
  aoi22  g05(.a(new_n24_), .b(x02), .c(new_n21_), .d(x08), .O(new_n25_));
  ...
  aoi22  g20(.a(x13), .b(x09), .c(x10), .d(new_n32_), .O(new_n40_));
  nand4  g21(.a(new_n40_), .b(new_n32_), .c(x04), .d(x02), .O(new_n41_));
  nand2  g22(.a(new_n41_), .b(x03), .O(new_n42_));
  inv1   g23(.a(x06), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n20_), .c(new_n27_), .O(new_n44_));
  nand2  g25(.a(new_n44_), .b(new_n42_), .O(z2));
  inv1   g26(.a(x12), .O(new_n46_));
  oai21  g27(.a(new_n23_), .b(new_n21_), .c(new_n46_), .O(new_n47_));
