...
module FAU ( 
  ...
  aoi21  g27(.a(new_n46_), .b(new_n26_), .c(new_n43_), .O(new_n47_));
  aoi21  g28(.a(new_n45_), .b(x02), .c(new_n47_), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n30_), .O(new_n50_));
  ...
  nor2   g36(.a(x08), .b(new_n25_), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(new_n57_));
  aoi21  g38(.a(new_n54_), .b(x02), .c(new_n57_), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand2  g41(.a(x12), .b(new_n21_), .O(new_n61_));
