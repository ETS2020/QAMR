// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:41 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(new_n21_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n25_), .c(new_n24_), .O(new_n44_));
  nor2   g25(.a(x10), .b(x08), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n22_), .c(new_n42_), .O(new_n46_));
  ...
  and2   g31(.a(x13), .b(x09), .O(new_n51_));
  nand2  g32(.a(new_n42_), .b(new_n41_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n21_), .c(new_n51_), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n21_), .c(x04), .d(x02), .O(new_n54_));
