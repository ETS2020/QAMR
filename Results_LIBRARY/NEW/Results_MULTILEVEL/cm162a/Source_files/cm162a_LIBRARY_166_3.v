...
module FAU ( 
  ...
  aoi21  g34(.a(new_n42_), .b(new_n41_), .c(new_n51_), .O(new_n54_));
  aoi21  g35(.a(new_n53_), .b(x02), .c(new_n54_), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  nand2  g37(.a(new_n34_), .b(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n56_), .c(new_n29_), .O(new_n59_));
