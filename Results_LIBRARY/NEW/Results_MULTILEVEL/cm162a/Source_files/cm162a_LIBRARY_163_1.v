...
module FAU ( 
  ...
  aoi21  g12(.a(new_n23_), .b(x02), .c(x10), .O(new_n32_));
  inv1   g13(.a(x01), .O(new_n33_));
  aoi21  g14(.a(new_n20_), .b(new_n33_), .c(new_n29_), .O(new_n34_));
  oai21  g15(.a(new_n32_), .b(new_n20_), .c(new_n34_), .O(z1));
  oai21  g16(.a(x11), .b(x08), .c(new_n22_), .O(new_n36_));
  nand3  g17(.a(new_n36_), .b(x04), .c(x02), .O(new_n37_));
  nand3  g18(.a(new_n24_), .b(x04), .c(x02), .O(new_n38_));
  ...
  aoi21  g23(.a(new_n42_), .b(new_n20_), .c(new_n29_), .O(new_n43_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n25_), .c(new_n46_), .O(new_n50_));
