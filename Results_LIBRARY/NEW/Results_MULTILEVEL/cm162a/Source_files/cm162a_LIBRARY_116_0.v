...
module FAU ( 
  ...
  nand2  g24(.a(new_n34_), .b(new_n39_), .O(new_n44_));
  ...
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(new_n43_), .O(z2));
  ...
  oai21  g35(.a(x11), .b(x10), .c(x03), .O(new_n55_));
  ...
  nand3  g40(.a(new_n59_), .b(new_n57_), .c(new_n54_), .O(z3));
