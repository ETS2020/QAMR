...
module FAU ( 
  ...
  nand4  g36(.a(new_n42_), .b(new_n41_), .c(new_n24_), .d(x02), .O(new_n56_));
  nand2  g37(.a(new_n56_), .b(x12), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(x03), .O(new_n58_));
  nand2  g39(.a(new_n58_), .b(new_n55_), .O(new_n59_));
  nor2   g40(.a(new_n51_), .b(x04), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(x03), .c(new_n29_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n59_), .c(new_n54_), .O(z3));
