...
module FAU ( 
  ...
  nand4  g24(.a(new_n43_), .b(new_n36_), .c(new_n24_), .d(x04), .O(new_n44_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n36_), .c(new_n24_), .d(x04), .O(new_n52_));
