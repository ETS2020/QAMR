...
module FAU ( 
  ...
  nand3  g32(.a(new_n51_), .b(new_n42_), .c(new_n41_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nand4  g35(.a(new_n42_), .b(new_n41_), .c(x04), .d(x02), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(x12), .c(x08), .O(new_n56_));
