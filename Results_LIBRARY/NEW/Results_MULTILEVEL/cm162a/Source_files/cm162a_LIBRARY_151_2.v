// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:51 2020
...
module FAU ( 
  ...
  nand3  g11(.a(new_n30_), .b(new_n26_), .c(new_n22_), .O(z0));
  ...
  aoi21  g17(.a(new_n28_), .b(new_n36_), .c(new_n29_), .O(new_n37_));
  nand3  g18(.a(new_n37_), .b(new_n35_), .c(new_n33_), .O(z1));
  ...
  nand3  g24(.a(new_n24_), .b(new_n39_), .c(new_n23_), .O(new_n44_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n40_), .c(new_n39_), .d(new_n23_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n20_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(x04), .c(x02), .O(new_n52_));
  nand4  g33(.a(new_n24_), .b(new_n40_), .c(new_n39_), .d(new_n23_), .O(new_n53_));
  nand3  g34(.a(new_n53_), .b(x12), .c(x03), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n28_), .c(new_n29_), .O(new_n56_));
  nand3  g37(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z3));
