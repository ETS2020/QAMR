...
module FAU ( 
  ...
  nand2  g14(.a(x08), .b(x03), .O(new_n34_));
  oai21  g15(.a(new_n24_), .b(x08), .c(new_n34_), .O(new_n35_));
  nand2  g16(.a(new_n35_), .b(x10), .O(new_n36_));
  inv1   g17(.a(x01), .O(new_n37_));
  aoi21  g18(.a(new_n28_), .b(new_n37_), .c(new_n29_), .O(new_n38_));
  nand3  g19(.a(new_n38_), .b(new_n36_), .c(new_n33_), .O(z1));
  ...
  nand2  g27(.a(new_n46_), .b(new_n34_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x11), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n28_), .c(new_n29_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n43_), .O(z2));
  nor2   g32(.a(x12), .b(x11), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(new_n44_), .c(new_n23_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n20_), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(x04), .c(x02), .O(new_n55_));
  inv1   g36(.a(new_n34_), .O(new_n56_));
  aoi21  g37(.a(new_n40_), .b(new_n24_), .c(x08), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n56_), .c(x12), .O(new_n58_));
  inv1   g39(.a(x07), .O(new_n59_));
  aoi21  g40(.a(new_n59_), .b(new_n28_), .c(new_n29_), .O(new_n60_));
  nand3  g41(.a(new_n60_), .b(new_n58_), .c(new_n55_), .O(z3));
