...
module FAU ( 
  ...
  nand3  g04(.a(new_n23_), .b(new_n22_), .c(x08), .O(new_n24_));
  ...
  oai21  g13(.a(x10), .b(x08), .c(new_n23_), .O(new_n33_));
  nand3  g14(.a(new_n33_), .b(x04), .c(x02), .O(new_n34_));
  inv1   g15(.a(new_n34_), .O(new_n35_));
  nor2   g16(.a(new_n21_), .b(new_n22_), .O(new_n36_));
  oai21  g17(.a(new_n36_), .b(new_n35_), .c(x03), .O(new_n37_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n22_), .c(new_n20_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n23_), .c(new_n41_), .O(new_n44_));
  nor2   g25(.a(x10), .b(x08), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n21_), .c(new_n42_), .O(new_n46_));
  ...
  nand4  g32(.a(new_n51_), .b(new_n42_), .c(new_n22_), .d(new_n20_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n23_), .c(new_n41_), .O(new_n53_));
  nor3   g34(.a(x11), .b(x10), .c(x08), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n21_), .c(new_n51_), .O(new_n55_));
  ...
  oai21  g39(.a(new_n56_), .b(new_n29_), .c(new_n58_), .O(z3));
