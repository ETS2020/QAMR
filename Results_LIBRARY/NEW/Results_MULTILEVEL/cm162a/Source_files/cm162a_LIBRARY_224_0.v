// Benchmark "FAU" written by ABC on Mon Jul 27 17:26:02 2020
...
module FAU ( 
  ...
  nand4  g31(.a(new_n25_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n51_));
  nand4  g32(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n52_));
  inv1   g33(.a(new_n52_), .O(new_n53_));
  aoi21  g34(.a(new_n51_), .b(x12), .c(new_n53_), .O(new_n54_));
