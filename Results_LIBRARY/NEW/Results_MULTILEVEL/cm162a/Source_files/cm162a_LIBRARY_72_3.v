...
module FAU ( 
  ...
  nand2  g22(.a(new_n41_), .b(x08), .O(new_n42_));
  nand3  g23(.a(new_n42_), .b(new_n40_), .c(new_n39_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n22_), .c(new_n21_), .O(new_n44_));
  nor2   g25(.a(x10), .b(x08), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n25_), .c(new_n40_), .O(new_n46_));
  ...
  nand3  g31(.a(new_n45_), .b(new_n41_), .c(new_n40_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n22_), .c(new_n21_), .O(new_n52_));
  nor2   g33(.a(x11), .b(x10), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n25_), .c(new_n41_), .O(new_n54_));
