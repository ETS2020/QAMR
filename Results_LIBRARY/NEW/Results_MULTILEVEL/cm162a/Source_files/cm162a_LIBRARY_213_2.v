...
module FAU ( 
  ...
  nand3  g26(.a(new_n25_), .b(new_n45_), .c(new_n24_), .O(new_n46_));
  ...
  nand3  g30(.a(new_n49_), .b(new_n47_), .c(new_n44_), .O(z2));
  inv1   g31(.a(x11), .O(new_n51_));
  inv1   g32(.a(x12), .O(new_n52_));
  nand4  g33(.a(new_n52_), .b(new_n51_), .c(new_n45_), .d(new_n24_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n21_), .O(new_n54_));
  aoi21  g35(.a(new_n41_), .b(new_n25_), .c(new_n52_), .O(new_n55_));
  aoi21  g36(.a(new_n54_), .b(x02), .c(new_n55_), .O(new_n56_));
