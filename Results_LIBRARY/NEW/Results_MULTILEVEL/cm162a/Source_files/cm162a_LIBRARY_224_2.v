...
module FAU ( 
  ...
  nand4  g22(.a(new_n38_), .b(new_n24_), .c(x04), .d(x02), .O(new_n42_));
  aoi22  g23(.a(new_n42_), .b(x11), .c(new_n41_), .d(x02), .O(new_n43_));
  ...
  nand2  g27(.a(x12), .b(new_n39_), .O(new_n47_));
  nand3  g28(.a(new_n47_), .b(new_n38_), .c(new_n24_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n22_), .c(new_n21_), .O(new_n49_));
  and2   g30(.a(new_n42_), .b(x12), .O(new_n50_));
