...
module FAU ( 
  ...
  nand3  g33(.a(new_n45_), .b(new_n52_), .c(new_n42_), .O(new_n53_));
  nand3  g34(.a(x13), .b(x09), .c(x03), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(new_n55_));
  aoi21  g36(.a(new_n42_), .b(new_n41_), .c(new_n52_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n55_), .c(x04), .O(new_n57_));
  oai21  g38(.a(x08), .b(new_n51_), .c(x12), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(x03), .c(x07), .O(new_n59_));
  nand3  g40(.a(x12), .b(new_n21_), .c(x03), .O(new_n60_));
  nand2  g41(.a(new_n60_), .b(x05), .O(new_n61_));
  nor2   g42(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g43(.a(new_n62_), .b(new_n57_), .O(z3));
