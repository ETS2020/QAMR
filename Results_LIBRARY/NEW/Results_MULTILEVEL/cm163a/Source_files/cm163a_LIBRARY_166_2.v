...
module FAU ( 
  ...
  aoi21  g24(.a(new_n45_), .b(new_n24_), .c(new_n44_), .O(new_n46_));
  inv1   g25(.a(x11), .O(new_n47_));
  inv1   g26(.a(x12), .O(new_n48_));
  nand3  g27(.a(new_n44_), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  oai21  g28(.a(new_n49_), .b(new_n23_), .c(new_n22_), .O(new_n50_));
