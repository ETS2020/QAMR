...
module FAU ( 
  ...
  nand2  g20(.a(new_n41_), .b(new_n28_), .O(new_n42_));
  nand3  g21(.a(x12), .b(x09), .c(x04), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(new_n42_), .c(x05), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n40_), .b(x09), .c(new_n45_), .O(z2));
  inv1   g25(.a(new_n24_), .O(new_n47_));
  nand4  g26(.a(new_n39_), .b(new_n22_), .c(x03), .d(x02), .O(new_n48_));
