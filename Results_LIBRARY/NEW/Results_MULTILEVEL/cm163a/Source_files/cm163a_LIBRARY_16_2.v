// Benchmark "FAU" written by ABC on Mon Jul 27 17:19:53 2020
...
module FAU ( 
  ...
  aoi21  g13(.a(new_n23_), .b(x11), .c(new_n34_), .O(new_n35_));
  ...
  oai21  g22(.a(x13), .b(x12), .c(new_n32_), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n22_), .c(x03), .d(x02), .O(new_n45_));
  nor2   g24(.a(x12), .b(x09), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n24_), .O(new_n47_));
