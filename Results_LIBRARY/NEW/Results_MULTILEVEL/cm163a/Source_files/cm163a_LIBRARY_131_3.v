// Benchmark "FAU" written by ABC on Mon Jul 27 17:20:12 2020
...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(x11), .c(x12), .O(new_n40_));
  nand4  g19(.a(new_n40_), .b(new_n22_), .c(x03), .d(x02), .O(new_n41_));
  nand2  g20(.a(new_n33_), .b(x12), .O(new_n42_));
  ...
  aoi21  g27(.a(new_n48_), .b(new_n23_), .c(new_n39_), .O(new_n49_));
  inv1   g28(.a(x12), .O(new_n50_));
  nand3  g29(.a(new_n39_), .b(new_n50_), .c(new_n32_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  oai21  g31(.a(new_n52_), .b(new_n49_), .c(x04), .O(new_n53_));
  inv1   g32(.a(x07), .O(new_n54_));
  aoi21  g33(.a(new_n54_), .b(new_n28_), .c(new_n29_), .O(new_n55_));
