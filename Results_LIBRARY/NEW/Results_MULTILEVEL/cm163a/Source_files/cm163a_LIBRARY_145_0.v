...
module FAU ( 
  ...
  oai21  g10(.a(x09), .b(new_n25_), .c(x11), .O(new_n32_));
  nor2   g11(.a(x11), .b(x09), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x03), .O(new_n34_));
  nand3  g13(.a(new_n34_), .b(new_n32_), .c(x02), .O(new_n35_));
  ...
  aoi21  g19(.a(new_n33_), .b(x03), .c(new_n40_), .O(new_n41_));
  inv1   g20(.a(x11), .O(new_n42_));
  nand4  g21(.a(new_n40_), .b(new_n42_), .c(new_n23_), .d(x03), .O(new_n43_));
