...
module FAU ( 
  ...
  aoi21  g10(.a(new_n22_), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  oai21  g11(.a(new_n29_), .b(new_n22_), .c(new_n32_), .O(z0));
  nand4  g12(.a(new_n24_), .b(new_n26_), .c(x03), .d(x02), .O(new_n34_));
  oai21  g13(.a(new_n27_), .b(new_n24_), .c(new_n34_), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x04), .O(new_n36_));
  inv1   g15(.a(x01), .O(new_n37_));
  aoi21  g16(.a(new_n22_), .b(new_n37_), .c(new_n31_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(z1));
  nor3   g18(.a(x12), .b(x11), .c(x09), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n27_), .c(new_n34_), .d(x12), .O(new_n41_));
  inv1   g20(.a(x06), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n22_), .c(new_n31_), .O(new_n43_));
  ...
  nand3  g25(.a(new_n26_), .b(x03), .c(x02), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n22_), .c(new_n31_), .O(new_n52_));
