...
module FAU ( 
  ...
  aoi21  g10(.a(new_n23_), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  nand3  g11(.a(new_n32_), .b(new_n29_), .c(new_n26_), .O(z0));
  nand3  g12(.a(new_n22_), .b(x03), .c(x02), .O(new_n34_));
  nand4  g13(.a(new_n24_), .b(new_n22_), .c(x03), .d(x02), .O(new_n35_));
  inv1   g14(.a(new_n35_), .O(new_n36_));
  aoi21  g15(.a(new_n34_), .b(x11), .c(new_n36_), .O(new_n37_));
  inv1   g16(.a(x01), .O(new_n38_));
  aoi21  g17(.a(new_n23_), .b(new_n38_), .c(new_n31_), .O(new_n39_));
  oai21  g18(.a(new_n37_), .b(new_n23_), .c(new_n39_), .O(z1));
  nor3   g19(.a(x12), .b(x11), .c(x09), .O(new_n41_));
  aoi22  g20(.a(new_n41_), .b(new_n27_), .c(new_n35_), .d(x12), .O(new_n42_));
  inv1   g21(.a(x06), .O(new_n43_));
  aoi21  g22(.a(new_n43_), .b(new_n23_), .c(new_n31_), .O(new_n44_));
  oai21  g23(.a(new_n42_), .b(new_n23_), .c(new_n44_), .O(z2));
  inv1   g24(.a(new_n34_), .O(new_n46_));
  ...
  aoi21  g30(.a(new_n51_), .b(new_n23_), .c(new_n31_), .O(new_n52_));
  oai21  g31(.a(new_n50_), .b(new_n23_), .c(new_n52_), .O(z3));
