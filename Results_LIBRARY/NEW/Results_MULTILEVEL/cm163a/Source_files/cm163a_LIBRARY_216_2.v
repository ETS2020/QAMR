...
module FAU ( 
  ...
  nand4  g23(.a(new_n44_), .b(new_n37_), .c(x03), .d(x02), .O(new_n45_));
  nor3   g24(.a(x13), .b(x12), .c(x11), .O(new_n46_));
  aoi22  g25(.a(new_n46_), .b(new_n23_), .c(new_n45_), .d(x13), .O(new_n47_));
  inv1   g26(.a(x07), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(new_n28_), .O(new_n49_));
  nand3  g28(.a(x13), .b(x09), .c(x04), .O(new_n50_));
  nand3  g29(.a(new_n50_), .b(new_n49_), .c(x05), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(new_n52_));
  oai21  g31(.a(new_n47_), .b(x09), .c(new_n52_), .O(z3));
