...
module FAU ( 
  ...
  nand3  g22(.a(new_n43_), .b(new_n42_), .c(new_n22_), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n40_), .c(new_n38_), .d(x05), .O(z2));
  inv1   g24(.a(new_n24_), .O(new_n46_));
  nand4  g25(.a(new_n43_), .b(new_n22_), .c(x03), .d(x02), .O(new_n47_));
