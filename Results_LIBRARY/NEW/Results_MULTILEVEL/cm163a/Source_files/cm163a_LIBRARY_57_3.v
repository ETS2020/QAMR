// Benchmark "FAU" written by ABC on Mon Jul 27 17:20:00 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n39_), .b(new_n23_), .O(new_n44_));
  nand2  g23(.a(new_n44_), .b(x13), .O(new_n45_));
  inv1   g24(.a(new_n24_), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi21  g26(.a(new_n47_), .b(new_n46_), .c(new_n29_), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n45_), .c(x04), .O(z3));
