// Benchmark "FAU" written by ABC on Mon Jul 27 17:19:58 2020
...
module FAU ( 
  ...
  nand2  g17(.a(new_n38_), .b(x12), .O(new_n39_));
  ...
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(new_n43_), .d(x05), .O(z2));
  inv1   g26(.a(new_n24_), .O(new_n48_));
  nor3   g27(.a(x13), .b(x12), .c(x11), .O(new_n49_));
  aoi22  g28(.a(new_n49_), .b(new_n48_), .c(new_n41_), .d(x13), .O(new_n50_));
