...
module FAU ( 
  ...
  nand2  g21(.a(new_n42_), .b(new_n28_), .O(new_n43_));
  nand2  g22(.a(x12), .b(x11), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(new_n43_), .c(new_n41_), .d(x05), .O(z2));
  inv1   g24(.a(new_n24_), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n46_), .c(new_n39_), .d(x13), .O(new_n48_));
