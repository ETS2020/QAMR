// Benchmark "FAU" written by ABC on Mon Jul 27 16:22:02 2020
...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n21_, new_n23_, new_n27_,
    new_n29_;
  ...
  nand4  g07(.a(new_n17_), .b(new_n16_), .c(x1), .d(new_n21_), .O(z2));
  nand2  g08(.a(x2), .b(x1), .O(new_n23_));
  nand3  g09(.a(new_n23_), .b(new_n17_), .c(x0), .O(z3));
  ...
  nand2  g14(.a(new_n17_), .b(new_n21_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand2  g16(.a(new_n19_), .b(new_n17_), .O(z5));
