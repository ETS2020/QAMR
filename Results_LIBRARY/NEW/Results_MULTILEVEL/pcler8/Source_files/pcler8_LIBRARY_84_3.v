...
module FAU ( 
  ...
  oai21  g84(.a(new_n128_), .b(new_n109_), .c(x26), .O(new_n129_));
  nor2   g85(.a(new_n113_), .b(new_n104_), .O(new_n130_));
  nand4  g86(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n131_));
  inv1   g87(.a(new_n131_), .O(new_n132_));
  nor2   g88(.a(x26), .b(new_n122_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(new_n132_), .c(new_n130_), .O(new_n134_));
  aoi21  g90(.a(new_n134_), .b(new_n129_), .c(x10), .O(new_n135_));
  and2   g91(.a(x26), .b(x18), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n135_), .c(x09), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(x08), .c(new_n68_), .O(z16));
endmodule
