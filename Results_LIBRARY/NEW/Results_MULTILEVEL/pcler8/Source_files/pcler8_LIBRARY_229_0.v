...
module FAU ( 
  ...
  aoi21  g55(.a(new_n71_), .b(x23), .c(new_n95_), .O(new_n100_));
  ...
  nor2   g75(.a(x25), .b(new_n111_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n112_), .c(x23), .d(x22), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  oai21  g79(.a(new_n46_), .b(new_n66_), .c(new_n123_), .O(z15));
  inv1   g80(.a(x18), .O(new_n125_));
  nand4  g81(.a(x21), .b(x20), .c(x19), .d(new_n125_), .O(new_n126_));
  ...
  inv1   g85(.a(new_n102_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n129_), .c(new_n45_), .d(x25), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  oai21  g89(.a(new_n46_), .b(new_n68_), .c(new_n133_), .O(z16));
endmodule
