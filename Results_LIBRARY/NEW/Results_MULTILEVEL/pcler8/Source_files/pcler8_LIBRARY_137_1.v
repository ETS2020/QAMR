...
module FAU ( 
  ...
  oai21  g53(.a(new_n97_), .b(new_n90_), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n83_), .c(x22), .O(new_n99_));
  nand4  g55(.a(new_n47_), .b(x21), .c(x20), .d(x19), .O(new_n100_));
  ...
  nand2  g59(.a(x21), .b(x20), .O(new_n104_));
  ...
  nand3  g64(.a(new_n105_), .b(new_n72_), .c(x22), .O(new_n109_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n104_), .c(x24), .O(new_n115_));
  nand4  g71(.a(new_n105_), .b(new_n73_), .c(x23), .d(x22), .O(new_n116_));
  ...
  nand4  g80(.a(new_n124_), .b(new_n75_), .c(x24), .d(x23), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n127_));
  oai21  g83(.a(new_n48_), .b(new_n66_), .c(new_n127_), .O(z15));
  inv1   g84(.a(x18), .O(new_n129_));
  nand3  g85(.a(x21), .b(x20), .c(new_n129_), .O(new_n130_));
  nand4  g86(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n130_), .c(x26), .O(new_n132_));
  nand4  g88(.a(new_n124_), .b(new_n74_), .c(new_n45_), .d(x25), .O(new_n133_));
