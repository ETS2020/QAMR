...
module FAU ( 
  ...
  oai21  g72(.a(new_n113_), .b(x10), .c(new_n116_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x09), .c(new_n46_), .O(new_n118_));
  ...
  aoi21  g81(.a(new_n125_), .b(new_n122_), .c(x10), .O(new_n126_));
  nor2   g82(.a(new_n123_), .b(x24), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n126_), .c(x09), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(x08), .c(new_n66_), .O(z15));
  inv1   g85(.a(x18), .O(new_n130_));
  nand3  g86(.a(x20), .b(x19), .c(new_n130_), .O(new_n131_));
  nand4  g87(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n132_));
  ...
  aoi21  g92(.a(new_n136_), .b(new_n133_), .c(x10), .O(new_n137_));
  nor2   g93(.a(new_n45_), .b(x24), .O(new_n138_));
