...
module FAU ( 
  ...
  oai22  g77(.a(new_n121_), .b(new_n110_), .c(new_n120_), .d(x23), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(x24), .O(new_n123_));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(x24), .c(x22), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n110_), .c(x25), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n47_), .c(x09), .O(new_n128_));
  ...
  nor2   g89(.a(new_n114_), .b(new_n105_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n120_), .O(new_n135_));
