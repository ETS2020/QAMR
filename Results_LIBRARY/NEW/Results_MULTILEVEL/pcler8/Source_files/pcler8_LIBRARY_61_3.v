...
module FAU ( 
  ...
  and2   g78(.a(x23), .b(x22), .O(new_n123_));
  nand4  g79(.a(new_n115_), .b(new_n123_), .c(new_n122_), .d(x24), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n121_), .c(x10), .O(new_n125_));
  nand3  g81(.a(x26), .b(x25), .c(x17), .O(new_n126_));
  inv1   g82(.a(new_n126_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n125_), .c(x09), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(x08), .c(new_n66_), .O(z15));
