...
module FAU ( 
  ...
  nand3  g83(.a(x21), .b(x20), .c(new_n127_), .O(new_n128_));
  nand4  g84(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  nor2   g86(.a(new_n113_), .b(new_n104_), .O(new_n131_));
  nand3  g87(.a(x22), .b(x21), .c(x20), .O(new_n132_));
  inv1   g88(.a(new_n132_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n131_), .c(new_n45_), .d(x25), .O(new_n134_));
  nand3  g90(.a(new_n134_), .b(new_n130_), .c(x19), .O(new_n135_));
