...
module FAU ( 
  ...
  nand4  g28(.a(new_n73_), .b(new_n64_), .c(x09), .d(new_n47_), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n51_), .O(z11));
  nand2  g30(.a(x22), .b(new_n64_), .O(new_n76_));
  oai22  g31(.a(new_n76_), .b(new_n63_), .c(new_n47_), .d(new_n53_), .O(z12));
  nand2  g32(.a(x23), .b(new_n64_), .O(new_n78_));
  oai22  g33(.a(new_n78_), .b(new_n63_), .c(new_n47_), .d(new_n55_), .O(z13));
  nand2  g34(.a(x24), .b(new_n64_), .O(new_n80_));
  oai22  g35(.a(new_n80_), .b(new_n63_), .c(new_n47_), .d(new_n57_), .O(z14));
  nand2  g36(.a(x25), .b(new_n64_), .O(new_n82_));
  oai22  g37(.a(new_n82_), .b(new_n63_), .c(new_n47_), .d(new_n59_), .O(z15));
  nand2  g38(.a(x26), .b(new_n64_), .O(new_n84_));
  oai22  g39(.a(new_n84_), .b(new_n63_), .c(new_n47_), .d(new_n61_), .O(z16));
  zero   g40(.O(z00));
endmodule
