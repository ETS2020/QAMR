...
module FAU ( 
  ...
  nand3  g29(.a(new_n73_), .b(x26), .c(x24), .O(new_n74_));
  ...
  nand4  g50(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n94_), .c(x21), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(x22), .O(new_n97_));
  nand3  g53(.a(new_n94_), .b(new_n71_), .c(x21), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n60_), .O(z12));
  nand3  g57(.a(x26), .b(x24), .c(x15), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x22), .c(x21), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n93_), .c(x23), .O(new_n104_));
  nand4  g60(.a(new_n94_), .b(new_n72_), .c(x22), .d(x21), .O(new_n105_));
  ...
  nand2  g65(.a(x26), .b(x16), .O(new_n110_));
  ...
  nor2   g69(.a(x24), .b(new_n72_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(x22), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n117_));
  oai21  g73(.a(new_n48_), .b(new_n64_), .c(new_n117_), .O(z14));
  ...
  nand3  g81(.a(x20), .b(x19), .c(new_n125_), .O(new_n126_));
  nand4  g82(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n126_), .c(x26), .O(new_n128_));
  nand4  g84(.a(new_n113_), .b(new_n73_), .c(new_n45_), .d(x24), .O(new_n129_));
