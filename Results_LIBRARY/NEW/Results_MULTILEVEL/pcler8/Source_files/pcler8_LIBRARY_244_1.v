...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_,
    ...
    new_n77_, new_n79_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_;
  ...
  nand3  g33(.a(new_n68_), .b(x09), .c(new_n47_), .O(new_n79_));
  nand3  g34(.a(x21), .b(x20), .c(x19), .O(new_n80_));
  oai22  g35(.a(new_n80_), .b(new_n79_), .c(new_n47_), .d(new_n53_), .O(z12));
  nand3  g36(.a(new_n64_), .b(x23), .c(new_n68_), .O(new_n82_));
  oai21  g37(.a(new_n47_), .b(new_n55_), .c(new_n82_), .O(z13));
  nand3  g38(.a(new_n64_), .b(x24), .c(new_n68_), .O(new_n84_));
  oai21  g39(.a(new_n47_), .b(new_n57_), .c(new_n84_), .O(z14));
  nand3  g40(.a(new_n64_), .b(x25), .c(new_n68_), .O(new_n86_));
  oai21  g41(.a(new_n47_), .b(new_n59_), .c(new_n86_), .O(z15));
  nand3  g42(.a(new_n64_), .b(x26), .c(new_n68_), .O(new_n88_));
  oai21  g43(.a(new_n47_), .b(new_n61_), .c(new_n88_), .O(z16));
  zero   g44(.O(z00));
endmodule
