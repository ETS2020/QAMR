...
module FAU ( 
  ...
  nand4  g36(.a(new_n81_), .b(x21), .c(x20), .d(x19), .O(new_n82_));
  ...
  nand3  g40(.a(new_n68_), .b(x09), .c(new_n47_), .O(new_n86_));
  nand4  g41(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  oai22  g42(.a(new_n87_), .b(new_n86_), .c(new_n47_), .d(new_n55_), .O(z13));
  nand3  g43(.a(new_n64_), .b(x24), .c(new_n68_), .O(new_n89_));
  oai21  g44(.a(new_n47_), .b(new_n57_), .c(new_n89_), .O(z14));
  nand3  g45(.a(new_n64_), .b(x25), .c(new_n68_), .O(new_n91_));
  oai21  g46(.a(new_n47_), .b(new_n59_), .c(new_n91_), .O(z15));
  nand3  g47(.a(new_n64_), .b(x26), .c(new_n68_), .O(new_n93_));
  oai21  g48(.a(new_n47_), .b(new_n61_), .c(new_n93_), .O(z16));
  zero   g49(.O(z00));
endmodule
