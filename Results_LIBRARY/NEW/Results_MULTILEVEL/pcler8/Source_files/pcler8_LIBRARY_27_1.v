...
module FAU ( 
  ...
  nand3  g42(.a(new_n70_), .b(x20), .c(x19), .O(new_n87_));
  oai21  g43(.a(new_n86_), .b(new_n70_), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g50(.a(new_n86_), .b(new_n71_), .c(x21), .O(new_n95_));
  ...
  oai21  g56(.a(new_n100_), .b(new_n85_), .c(x23), .O(new_n101_));
  inv1   g57(.a(x23), .O(new_n102_));
  nand4  g58(.a(new_n86_), .b(new_n102_), .c(x22), .d(x21), .O(new_n103_));
  ...
  nor2   g76(.a(new_n102_), .b(new_n71_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n112_), .c(new_n120_), .d(x24), .O(new_n122_));
  ...
  nor2   g85(.a(new_n111_), .b(new_n102_), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n120_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n86_), .c(new_n130_), .d(new_n72_), .O(new_n132_));
