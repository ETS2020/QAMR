...
module FAU ( 
  ...
  nor2   g58(.a(new_n102_), .b(x21), .O(new_n103_));
  nor2   g59(.a(x23), .b(new_n70_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n97_), .c(new_n103_), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n97_), .c(x22), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n108_));
  oai21  g64(.a(new_n105_), .b(new_n71_), .c(new_n108_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n47_), .c(x09), .O(new_n110_));
  ...
  nor2   g81(.a(new_n102_), .b(new_n71_), .O(new_n126_));
  ...
  nor2   g90(.a(new_n116_), .b(new_n102_), .O(new_n135_));
