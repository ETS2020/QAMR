...
module FAU ( 
  ...
  nand3  g47(.a(new_n64_), .b(x19), .c(new_n68_), .O(new_n93_));
  nand4  g48(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n94_));
  oai22  g49(.a(new_n94_), .b(new_n93_), .c(new_n47_), .d(new_n57_), .O(z14));
  nand3  g50(.a(new_n64_), .b(x25), .c(new_n68_), .O(new_n96_));
  oai21  g51(.a(new_n47_), .b(new_n59_), .c(new_n96_), .O(z15));
  nand3  g52(.a(new_n64_), .b(x26), .c(new_n68_), .O(new_n98_));
  oai21  g53(.a(new_n47_), .b(new_n61_), .c(new_n98_), .O(z16));
  zero   g54(.O(z00));
endmodule
