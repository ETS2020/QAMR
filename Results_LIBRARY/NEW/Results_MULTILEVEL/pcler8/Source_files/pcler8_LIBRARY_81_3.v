...
module FAU ( 
  ...
  nand3  g37(.a(new_n72_), .b(x20), .c(x12), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n77_), .c(new_n81_), .d(x10), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(x09), .c(new_n46_), .O(new_n84_));
  oai21  g40(.a(new_n46_), .b(new_n56_), .c(new_n84_), .O(z10));
  ...
  oai21  g45(.a(new_n89_), .b(new_n86_), .c(x21), .O(new_n90_));
  nand3  g46(.a(new_n70_), .b(x20), .c(x19), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n93_));
  oai21  g49(.a(new_n46_), .b(new_n58_), .c(new_n93_), .O(z11));
  nand2  g50(.a(x20), .b(x19), .O(new_n95_));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n88_), .c(x21), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(x22), .O(new_n98_));
  inv1   g54(.a(new_n95_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n71_), .c(x21), .O(new_n100_));
  ...
  nand4  g62(.a(new_n99_), .b(new_n74_), .c(x22), .d(x21), .O(new_n107_));
  ...
  inv1   g70(.a(new_n111_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n75_), .c(x23), .d(x22), .O(new_n116_));
  ...
  oai21  g77(.a(new_n121_), .b(new_n111_), .c(x25), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nor2   g79(.a(new_n74_), .b(new_n71_), .O(new_n124_));
  ...
  nand4  g89(.a(new_n133_), .b(new_n99_), .c(new_n76_), .d(new_n72_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n136_));
  oai21  g92(.a(new_n46_), .b(new_n68_), .c(new_n136_), .O(z16));
endmodule
