...
module FAU ( 
  ...
  nor3   g83(.a(new_n127_), .b(new_n47_), .c(new_n46_), .O(new_n128_));
  oai21  g84(.a(new_n75_), .b(x18), .c(x26), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n75_), .c(new_n129_), .O(new_n130_));
