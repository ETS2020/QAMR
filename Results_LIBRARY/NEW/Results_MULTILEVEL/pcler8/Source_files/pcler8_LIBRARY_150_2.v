...
module FAU ( 
  ...
  oai21  g39(.a(new_n46_), .b(new_n56_), .c(new_n83_), .O(z10));
  ...
  oai21  g54(.a(new_n96_), .b(x10), .c(new_n98_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(x09), .c(new_n46_), .O(new_n100_));
  ...
  aoi22  g62(.a(new_n106_), .b(new_n97_), .c(new_n103_), .d(x23), .O(new_n107_));
  nand2  g63(.a(x23), .b(new_n71_), .O(new_n108_));
  oai21  g64(.a(new_n107_), .b(x10), .c(new_n108_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x09), .c(new_n46_), .O(new_n110_));
  ...
  oai21  g69(.a(new_n113_), .b(new_n93_), .c(x24), .O(new_n114_));
  inv1   g70(.a(x24), .O(new_n115_));
  nand3  g71(.a(x21), .b(x20), .c(x19), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n115_), .c(x23), .d(x22), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n114_), .c(x10), .O(new_n119_));
  nor2   g75(.a(new_n115_), .b(x22), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n119_), .c(x09), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(x08), .c(new_n64_), .O(z14));
  nand2  g78(.a(x26), .b(x17), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(x24), .c(x23), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n116_), .c(x25), .O(new_n125_));
  inv1   g81(.a(x25), .O(new_n126_));
  nor2   g82(.a(new_n104_), .b(new_n71_), .O(new_n127_));
  nand4  g83(.a(new_n117_), .b(new_n127_), .c(new_n126_), .d(x24), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n125_), .c(x10), .O(new_n129_));
  nor2   g85(.a(new_n126_), .b(x22), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n129_), .c(x09), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(x08), .c(new_n66_), .O(z15));
  ...
  nor2   g92(.a(new_n115_), .b(new_n104_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n126_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n97_), .c(new_n137_), .d(new_n72_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x10), .O(new_n140_));
  nor2   g96(.a(new_n45_), .b(x22), .O(new_n141_));
