...
module FAU ( 
  ...
  nand3  g59(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n75_), .b(x24), .c(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n105_), .c(x19), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n108_));
  oai21  g64(.a(new_n48_), .b(new_n62_), .c(new_n108_), .O(z13));
  ...
  nand4  g68(.a(new_n96_), .b(new_n72_), .c(x22), .d(x21), .O(new_n113_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n74_), .c(x24), .d(x22), .O(new_n122_));
  ...
  nand4  g83(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n128_));
