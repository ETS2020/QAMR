...
module FAU ( 
  ...
  nand4  g31(.a(new_n75_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(new_n54_), .O(z09));
  inv1   g33(.a(x19), .O(new_n78_));
  nand3  g34(.a(x23), .b(x21), .c(x12), .O(new_n79_));
  ...
  oai21  g38(.a(x20), .b(new_n78_), .c(new_n82_), .O(new_n83_));
  nand4  g39(.a(new_n83_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n56_), .O(z10));
  ...
  nand3  g44(.a(new_n47_), .b(x20), .c(x19), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand4  g46(.a(new_n90_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n58_), .O(z11));
  inv1   g48(.a(new_n80_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(x23), .c(x14), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(x21), .c(x20), .d(x19), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n96_));
  oai21  g52(.a(new_n48_), .b(new_n60_), .c(new_n96_), .O(z12));
  ...
  nand3  g58(.a(new_n99_), .b(new_n71_), .c(x21), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n62_), .O(z13));
  nand3  g62(.a(x26), .b(x25), .c(x16), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(x23), .c(x21), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n98_), .c(x24), .O(new_n109_));
  nand4  g65(.a(new_n99_), .b(new_n72_), .c(x23), .d(x21), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n64_), .O(z14));
  nand3  g69(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  nand2  g70(.a(x26), .b(x17), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(x24), .c(x23), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n114_), .c(x25), .O(new_n117_));
  inv1   g73(.a(new_n114_), .O(new_n118_));
  nor2   g74(.a(x25), .b(new_n72_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n118_), .c(x23), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n122_));
  oai21  g78(.a(new_n48_), .b(new_n66_), .c(new_n122_), .O(z15));
  inv1   g79(.a(x18), .O(new_n124_));
  nand3  g80(.a(x20), .b(x19), .c(new_n124_), .O(new_n125_));
  nand4  g81(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n125_), .c(x26), .O(new_n127_));
  nand4  g83(.a(new_n118_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n130_));
  oai21  g86(.a(new_n48_), .b(new_n68_), .c(new_n130_), .O(z16));
endmodule
