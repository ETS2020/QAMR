...
module FAU ( 
  ...
  oai21  g71(.a(new_n115_), .b(new_n110_), .c(new_n113_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n117_));
  oai21  g73(.a(new_n46_), .b(new_n64_), .c(new_n117_), .O(z14));
  nand2  g74(.a(new_n45_), .b(x25), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(x24), .c(x23), .d(x22), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x21), .c(x20), .d(x19), .O(new_n122_));
  nor2   g78(.a(new_n114_), .b(new_n105_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(x22), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n110_), .c(x25), .O(new_n125_));
  ...
  inv1   g88(.a(x25), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n133_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n97_), .c(new_n123_), .d(new_n72_), .O(new_n135_));
