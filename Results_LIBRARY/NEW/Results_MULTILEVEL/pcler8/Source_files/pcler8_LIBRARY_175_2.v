...
module FAU ( 
  ...
  nand2  g76(.a(new_n97_), .b(new_n120_), .O(new_n121_));
  nor2   g77(.a(new_n114_), .b(new_n105_), .O(new_n122_));
  ...
  nor2   g81(.a(new_n105_), .b(new_n71_), .O(new_n126_));
  nand4  g82(.a(new_n115_), .b(new_n126_), .c(new_n125_), .d(x24), .O(new_n127_));
  ...
  nand4  g91(.a(new_n135_), .b(new_n97_), .c(new_n122_), .d(new_n72_), .O(new_n136_));
