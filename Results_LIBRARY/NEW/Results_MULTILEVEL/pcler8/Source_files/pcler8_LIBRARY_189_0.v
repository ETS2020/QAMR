...
module FAU ( 
  ...
  oai21  g26(.a(x25), .b(x20), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g31(.a(new_n75_), .b(new_n74_), .c(new_n71_), .O(new_n76_));
  ...
  oai21  g37(.a(x20), .b(new_n70_), .c(new_n81_), .O(new_n82_));
  ...
  oai21  g43(.a(new_n87_), .b(new_n70_), .c(x21), .O(new_n88_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n72_), .c(x20), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x19), .O(new_n125_));
  nand2  g81(.a(new_n73_), .b(x19), .O(new_n126_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n99_), .c(new_n137_), .d(new_n73_), .O(new_n139_));
