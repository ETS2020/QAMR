...
module FAU ( 
  ...
  xnor2a g38(.a(x21), .b(x20), .O(new_n83_));
  ...
  oai21  g43(.a(new_n83_), .b(new_n76_), .c(new_n87_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n47_), .c(x09), .O(new_n89_));
  oai21  g45(.a(new_n46_), .b(new_n58_), .c(new_n89_), .O(z11));
  nand2  g46(.a(x20), .b(x19), .O(new_n91_));
  nand2  g47(.a(x23), .b(x14), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n85_), .c(x21), .O(new_n93_));
