// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:46 2020
...
module FAU ( 
  ...
  oai21  g76(.a(new_n120_), .b(new_n110_), .c(x25), .O(new_n121_));
  inv1   g77(.a(x25), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n110_), .c(new_n121_), .O(new_n124_));
  ...
  nor2   g86(.a(new_n114_), .b(new_n105_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n122_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n97_), .c(new_n131_), .d(new_n72_), .O(new_n133_));
