// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:03 2020
...
module FAU ( 
  ...
  oai21  g37(.a(new_n46_), .b(new_n54_), .c(new_n81_), .O(z09));
  ...
  nand4  g42(.a(new_n78_), .b(new_n76_), .c(new_n72_), .d(x12), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  oai21  g45(.a(new_n46_), .b(new_n56_), .c(new_n89_), .O(z10));
  nand3  g46(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  nand3  g47(.a(x26), .b(x25), .c(x24), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n83_), .c(x21), .O(new_n94_));
  nand3  g50(.a(new_n70_), .b(x20), .c(x19), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n97_));
  oai21  g53(.a(new_n46_), .b(new_n58_), .c(new_n97_), .O(z11));
  nand2  g54(.a(x20), .b(x19), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n92_), .c(x21), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n99_), .c(x22), .O(new_n102_));
  inv1   g58(.a(new_n99_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n71_), .c(x21), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  oai21  g62(.a(new_n46_), .b(new_n60_), .c(new_n106_), .O(z12));
  ...
  nand4  g75(.a(new_n119_), .b(new_n75_), .c(x23), .d(x22), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  oai21  g78(.a(new_n46_), .b(new_n64_), .c(new_n122_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(x24), .c(x23), .d(x22), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n115_), .c(x25), .O(new_n126_));
  nor2   g82(.a(new_n74_), .b(new_n71_), .O(new_n127_));
  nand4  g83(.a(new_n119_), .b(new_n127_), .c(new_n77_), .d(x24), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  oai21  g86(.a(new_n46_), .b(new_n66_), .c(new_n130_), .O(z15));
  ...
  nor2   g91(.a(x26), .b(new_n77_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n103_), .c(new_n76_), .d(new_n72_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n135_), .O(new_n138_));
