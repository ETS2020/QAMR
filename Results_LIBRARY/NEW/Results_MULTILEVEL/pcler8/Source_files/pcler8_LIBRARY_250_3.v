...
module FAU ( 
  ...
  nand4  g59(.a(new_n96_), .b(new_n103_), .c(x22), .d(x21), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(x10), .O(new_n105_));
  nand2  g61(.a(x23), .b(x15), .O(new_n106_));
  nor2   g62(.a(new_n106_), .b(new_n83_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n105_), .c(x09), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(x08), .c(new_n62_), .O(z13));
  ...
  nor2   g87(.a(new_n114_), .b(new_n103_), .O(new_n132_));
  inv1   g88(.a(new_n101_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n132_), .c(new_n45_), .d(x25), .O(new_n134_));
