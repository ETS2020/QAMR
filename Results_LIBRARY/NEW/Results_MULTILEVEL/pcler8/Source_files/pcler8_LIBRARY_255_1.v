...
module FAU ( 
  ...
  xnor2a g36(.a(x21), .b(x20), .O(new_n81_));
  ...
  oai21  g41(.a(new_n81_), .b(new_n74_), .c(new_n85_), .O(new_n86_));
  nand3  g42(.a(new_n86_), .b(new_n47_), .c(x09), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n46_), .O(z11));
  ...
  oai21  g53(.a(new_n46_), .b(new_n58_), .c(new_n97_), .O(z12));
  ...
  oai21  g71(.a(new_n46_), .b(new_n62_), .c(new_n115_), .O(z14));
  ...
  oai21  g80(.a(new_n46_), .b(new_n64_), .c(new_n124_), .O(z15));
  ...
  nand4  g87(.a(new_n131_), .b(new_n94_), .c(new_n130_), .d(new_n68_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n134_));
  oai21  g90(.a(new_n46_), .b(new_n66_), .c(new_n134_), .O(z16));
  buf1   g91(.a(x08), .O(z03));
endmodule
