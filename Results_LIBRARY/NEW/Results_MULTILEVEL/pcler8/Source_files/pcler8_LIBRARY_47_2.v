...
module FAU ( 
  ...
  aoi21  g75(.a(x26), .b(x17), .c(new_n113_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n114_), .c(new_n119_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(x25), .c(new_n47_), .O(new_n122_));
  ...
  nand3  g81(.a(new_n125_), .b(x09), .c(new_n46_), .O(new_n126_));
  ...
  nor2   g93(.a(new_n45_), .b(x25), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n137_), .c(x09), .O(new_n139_));
  oai21  g95(.a(new_n139_), .b(x08), .c(new_n68_), .O(z16));
endmodule
