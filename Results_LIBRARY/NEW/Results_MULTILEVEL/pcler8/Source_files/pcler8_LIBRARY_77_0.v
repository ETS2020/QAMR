...
module FAU ( 
  ...
  nand3  g48(.a(new_n71_), .b(x20), .c(x19), .O(new_n93_));
  oai21  g49(.a(new_n71_), .b(x20), .c(new_n93_), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(x21), .O(new_n95_));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n86_), .c(x21), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n78_), .c(x22), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n95_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n47_), .c(x09), .O(new_n100_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n102_), .c(x23), .O(new_n105_));
  inv1   g61(.a(x23), .O(new_n106_));
  inv1   g62(.a(new_n102_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n106_), .c(x22), .d(x21), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  ...
  nor2   g81(.a(new_n106_), .b(new_n71_), .O(new_n126_));
  ...
  nor2   g90(.a(new_n116_), .b(new_n106_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n125_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n107_), .c(new_n135_), .d(new_n72_), .O(new_n137_));
