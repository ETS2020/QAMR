...
module FAU ( 
  ...
  nand4  g26(.a(x26), .b(x24), .c(x23), .d(x22), .O(new_n71_));
  oai21  g27(.a(new_n71_), .b(new_n70_), .c(x19), .O(new_n72_));
  nand3  g28(.a(new_n72_), .b(x25), .c(new_n47_), .O(new_n73_));
  oai21  g29(.a(x25), .b(x19), .c(new_n73_), .O(new_n74_));
  ...
  nor2   g77(.a(new_n107_), .b(new_n98_), .O(new_n122_));
  aoi21  g78(.a(x26), .b(x17), .c(new_n116_), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n117_), .c(new_n122_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(x25), .c(new_n47_), .O(new_n125_));
  ...
  nand3  g84(.a(new_n128_), .b(x09), .c(new_n46_), .O(new_n129_));
  ...
  nand3  g94(.a(new_n138_), .b(new_n137_), .c(new_n135_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n134_), .c(x10), .O(new_n140_));
  nor2   g96(.a(new_n45_), .b(x25), .O(new_n141_));
