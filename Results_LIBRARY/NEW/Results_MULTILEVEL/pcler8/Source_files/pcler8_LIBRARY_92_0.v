...
module FAU ( 
  ...
  nand3  g43(.a(new_n87_), .b(x20), .c(x19), .O(new_n88_));
  nand2  g44(.a(x20), .b(x19), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n70_), .c(new_n88_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n58_), .O(z11));
  nand2  g49(.a(x23), .b(x14), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n86_), .c(x21), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n89_), .c(x22), .O(new_n96_));
  nand3  g52(.a(new_n90_), .b(new_n71_), .c(x21), .O(new_n97_));
  ...
  oai21  g58(.a(new_n102_), .b(new_n89_), .c(x23), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nand4  g60(.a(new_n90_), .b(new_n104_), .c(x22), .d(x21), .O(new_n105_));
  ...
  inv1   g78(.a(new_n85_), .O(new_n123_));
  ...
  nand4  g89(.a(new_n133_), .b(new_n90_), .c(new_n132_), .d(new_n72_), .O(new_n134_));
