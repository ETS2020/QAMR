...
module FAU ( 
  ...
  nand4  g03(.a(new_n47_), .b(x21), .c(x20), .d(x19), .O(new_n48_));
  nor2   g04(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand4  g05(.a(new_n49_), .b(x25), .c(x24), .d(x23), .O(new_n50_));
  nor2   g06(.a(new_n50_), .b(new_n45_), .O(z00));
  ...
  nand3  g30(.a(new_n74_), .b(new_n69_), .c(new_n68_), .O(new_n75_));
  ...
  nand3  g38(.a(new_n82_), .b(new_n69_), .c(new_n68_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n54_), .O(z10));
  inv1   g40(.a(x19), .O(new_n85_));
  nand3  g41(.a(x23), .b(x22), .c(x13), .O(new_n86_));
  nand3  g42(.a(x26), .b(x25), .c(x24), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n85_), .c(x21), .O(new_n89_));
  nand3  g45(.a(new_n70_), .b(x20), .c(x19), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n69_), .c(new_n68_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n56_), .O(z11));
  ...
  nand3  g54(.a(new_n98_), .b(new_n46_), .c(x21), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n69_), .c(new_n68_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n58_), .O(z12));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x22), .c(x21), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n94_), .c(x23), .O(new_n105_));
  ...
  nand3  g64(.a(new_n108_), .b(new_n69_), .c(new_n68_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n60_), .O(z13));
  ...
  oai21  g69(.a(new_n113_), .b(new_n111_), .c(x24), .O(new_n114_));
  inv1   g70(.a(x24), .O(new_n115_));
  inv1   g71(.a(new_n111_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n115_), .c(x23), .d(x22), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n69_), .c(new_n68_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n62_), .O(z14));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n111_), .c(x25), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  nor2   g80(.a(new_n106_), .b(new_n46_), .O(new_n125_));
  nand4  g81(.a(new_n116_), .b(new_n125_), .c(new_n124_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n69_), .c(new_n68_), .O(new_n128_));
  ...
  nor2   g89(.a(new_n115_), .b(new_n106_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n124_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n98_), .c(new_n134_), .d(new_n71_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g93(.a(new_n137_), .b(new_n69_), .c(new_n68_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n66_), .O(z16));
endmodule
