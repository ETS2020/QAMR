...
module FAU ( 
  ...
  oai21  g78(.a(new_n122_), .b(new_n114_), .c(x25), .O(new_n123_));
  nand4  g79(.a(new_n115_), .b(new_n73_), .c(new_n74_), .d(x24), .O(new_n124_));
  ...
  nor2   g87(.a(new_n71_), .b(new_n47_), .O(new_n132_));
  nor2   g88(.a(new_n113_), .b(new_n72_), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n74_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n133_), .c(new_n96_), .d(new_n132_), .O(new_n135_));
