...
module FAU ( 
  ...
  inv1   g67(.a(new_n91_), .O(new_n112_));
  ...
  oai21  g76(.a(new_n120_), .b(new_n91_), .c(x25), .O(new_n121_));
  nand4  g77(.a(new_n96_), .b(new_n112_), .c(new_n72_), .d(x24), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n121_), .c(x10), .O(new_n123_));
  nand2  g79(.a(new_n73_), .b(x17), .O(new_n124_));
  ...
  nand3  g85(.a(new_n96_), .b(x25), .c(x24), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n129_), .c(x26), .O(new_n131_));
  inv1   g87(.a(x10), .O(new_n132_));
  nand4  g88(.a(x21), .b(x20), .c(x19), .d(new_n132_), .O(new_n133_));
  inv1   g89(.a(new_n133_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n72_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n96_), .d(x24), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n131_), .O(new_n137_));
