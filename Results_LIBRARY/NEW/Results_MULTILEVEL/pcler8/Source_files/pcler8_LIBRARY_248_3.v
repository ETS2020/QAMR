...
module FAU ( 
  ...
  aoi21  g71(.a(new_n115_), .b(new_n111_), .c(x10), .O(new_n116_));
  nand4  g72(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n116_), .c(x09), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(x08), .c(new_n64_), .O(z14));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n113_), .c(x25), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  nor2   g80(.a(new_n105_), .b(new_n71_), .O(new_n125_));
  nand4  g81(.a(new_n114_), .b(new_n125_), .c(new_n124_), .d(x24), .O(new_n126_));
  ...
  nor2   g89(.a(new_n112_), .b(new_n105_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n124_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n97_), .c(new_n134_), .d(new_n72_), .O(new_n136_));
