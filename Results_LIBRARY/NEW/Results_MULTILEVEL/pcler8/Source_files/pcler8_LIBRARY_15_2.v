// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:25 2020
...
module FAU ( 
  ...
  nand4  g64(.a(new_n101_), .b(new_n74_), .c(x22), .d(x21), .O(new_n109_));
  ...
  nand4  g73(.a(new_n117_), .b(new_n75_), .c(x23), .d(x22), .O(new_n118_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n113_), .c(x25), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nor2   g81(.a(new_n74_), .b(new_n71_), .O(new_n126_));
  ...
  oai21  g85(.a(new_n46_), .b(new_n66_), .c(new_n129_), .O(z15));
  ...
  nand4  g91(.a(new_n135_), .b(new_n101_), .c(new_n76_), .d(new_n72_), .O(new_n136_));
