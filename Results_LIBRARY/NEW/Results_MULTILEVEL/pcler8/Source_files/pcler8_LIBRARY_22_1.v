...
module FAU ( 
  ...
  nand3  g66(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n95_), .c(x24), .O(new_n112_));
  nand3  g68(.a(x21), .b(x20), .c(x19), .O(new_n113_));
  inv1   g69(.a(new_n113_), .O(new_n114_));
  nor2   g70(.a(x24), .b(new_n72_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n114_), .c(x22), .O(new_n116_));
  nand2  g72(.a(new_n75_), .b(x16), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n116_), .c(new_n112_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n119_));
  oai21  g75(.a(new_n48_), .b(new_n64_), .c(new_n119_), .O(z14));
  ...
  nand4  g79(.a(new_n114_), .b(new_n73_), .c(new_n74_), .d(x24), .O(new_n124_));
  ...
  nand4  g85(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n129_), .c(x26), .O(new_n131_));
  nand4  g87(.a(new_n114_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n132_));
