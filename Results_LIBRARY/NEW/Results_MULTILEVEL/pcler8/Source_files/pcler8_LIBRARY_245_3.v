...
module FAU ( 
  ...
  aoi21  g43(.a(new_n87_), .b(new_n86_), .c(x10), .O(new_n88_));
  nand2  g44(.a(new_n72_), .b(x13), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n88_), .c(x09), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(x08), .c(new_n58_), .O(z11));
  nand2  g48(.a(x23), .b(x14), .O(new_n93_));
  nand3  g49(.a(x26), .b(x25), .c(x24), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n93_), .c(x21), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n85_), .c(x22), .O(new_n96_));
  inv1   g52(.a(new_n85_), .O(new_n97_));
  ...
  oai21  g59(.a(new_n103_), .b(new_n85_), .c(x23), .O(new_n104_));
  ...
  nand4  g80(.a(new_n124_), .b(new_n115_), .c(new_n123_), .d(x24), .O(new_n125_));
