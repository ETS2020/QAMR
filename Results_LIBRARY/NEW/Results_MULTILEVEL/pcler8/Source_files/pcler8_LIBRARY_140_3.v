...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_,
    ...
    new_n94_, new_n95_, new_n96_, new_n98_, new_n100_;
  ...
  nand4  g40(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x23), .O(new_n87_));
  ...
  nand3  g48(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(new_n72_), .c(new_n93_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n68_), .c(x09), .d(new_n47_), .O(new_n96_));
  oai21  g51(.a(new_n47_), .b(new_n57_), .c(new_n96_), .O(z14));
  nand3  g52(.a(new_n64_), .b(x25), .c(new_n68_), .O(new_n98_));
  oai21  g53(.a(new_n47_), .b(new_n59_), .c(new_n98_), .O(z15));
  nand3  g54(.a(new_n64_), .b(x26), .c(new_n68_), .O(new_n100_));
