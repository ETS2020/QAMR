...
module FAU ( 
  ...
  nand2  g51(.a(new_n71_), .b(x21), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n71_), .O(new_n97_));
  ...
  oai21  g57(.a(new_n101_), .b(new_n95_), .c(x23), .O(new_n102_));
  inv1   g58(.a(x23), .O(new_n103_));
  inv1   g59(.a(new_n95_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n103_), .c(x22), .d(x21), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n93_), .c(x24), .O(new_n111_));
  inv1   g67(.a(x24), .O(new_n112_));
  nand4  g68(.a(new_n94_), .b(new_n112_), .c(x23), .d(x22), .O(new_n113_));
  ...
  nor2   g76(.a(new_n103_), .b(new_n71_), .O(new_n121_));
  nand4  g77(.a(new_n94_), .b(new_n121_), .c(new_n120_), .d(x24), .O(new_n122_));
  ...
  nor2   g85(.a(new_n112_), .b(new_n103_), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n120_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n104_), .c(new_n130_), .d(new_n72_), .O(new_n132_));
