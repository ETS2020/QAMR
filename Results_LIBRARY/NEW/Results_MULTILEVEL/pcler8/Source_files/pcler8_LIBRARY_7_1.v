...
module FAU ( 
  ...
  oai21  g51(.a(new_n48_), .b(new_n58_), .c(new_n95_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n90_), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n81_), .c(x22), .O(new_n99_));
  nand3  g55(.a(new_n47_), .b(x21), .c(x19), .O(new_n100_));
  ...
  nand2  g59(.a(x21), .b(x19), .O(new_n104_));
  ...
  nand3  g85(.a(x21), .b(x19), .c(new_n129_), .O(new_n130_));
