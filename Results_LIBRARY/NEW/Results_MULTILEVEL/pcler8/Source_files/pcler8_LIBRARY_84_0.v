...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n126_, new_n128_, new_n129_, new_n130_;
  ...
  nand3  g83(.a(new_n123_), .b(x25), .c(x24), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n109_), .c(new_n45_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n130_));
  oai21  g86(.a(new_n46_), .b(new_n68_), .c(new_n130_), .O(z16));
endmodule
