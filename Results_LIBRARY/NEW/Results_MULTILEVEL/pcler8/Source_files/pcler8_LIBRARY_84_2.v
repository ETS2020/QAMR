...
module FAU ( 
  ...
  nor2   g69(.a(x24), .b(new_n104_), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(x22), .O(new_n115_));
  ...
  nor2   g78(.a(new_n104_), .b(new_n95_), .O(new_n123_));
  nand4  g79(.a(new_n113_), .b(new_n123_), .c(new_n122_), .d(x24), .O(new_n124_));
  ...
  oai21  g83(.a(new_n122_), .b(x18), .c(new_n47_), .O(new_n128_));
  nand3  g84(.a(x24), .b(x23), .c(x22), .O(new_n129_));
  nor2   g85(.a(new_n129_), .b(new_n109_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(x18), .c(new_n128_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(x26), .O(new_n132_));
  nand4  g88(.a(x21), .b(x20), .c(x19), .d(new_n47_), .O(new_n133_));
  inv1   g89(.a(new_n133_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n122_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n123_), .d(x24), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g93(.a(new_n137_), .b(x09), .c(new_n46_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n68_), .O(z16));
endmodule
