...
module FAU ( 
  ...
  nand4  g36(.a(new_n81_), .b(new_n68_), .c(x09), .d(new_n47_), .O(new_n82_));
  oai21  g37(.a(new_n47_), .b(new_n53_), .c(new_n82_), .O(z12));
  nand3  g38(.a(new_n64_), .b(x23), .c(new_n68_), .O(new_n84_));
  oai21  g39(.a(new_n47_), .b(new_n55_), .c(new_n84_), .O(z13));
  nand3  g40(.a(new_n64_), .b(x24), .c(new_n68_), .O(new_n86_));
  oai21  g41(.a(new_n47_), .b(new_n57_), .c(new_n86_), .O(z14));
  nand3  g42(.a(new_n64_), .b(x25), .c(new_n68_), .O(new_n88_));
  oai21  g43(.a(new_n47_), .b(new_n59_), .c(new_n88_), .O(z15));
  nand3  g44(.a(new_n64_), .b(x26), .c(new_n68_), .O(new_n90_));
