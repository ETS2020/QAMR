// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:29 2020
...
module FAU ( 
  ...
  nand4  g771(.a(new_n901_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n902_));
  ...
  nand4  g775(.a(new_n905_), .b(new_n136_), .c(new_n138_), .d(new_n137_), .O(new_n906_));
