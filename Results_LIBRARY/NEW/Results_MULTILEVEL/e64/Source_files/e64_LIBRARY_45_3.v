...
module FAU ( 
  ...
  nand2  g745(.a(new_n865_), .b(x22), .O(new_n876_));
  nor2   g746(.a(new_n876_), .b(x24), .O(new_n877_));
  nand4  g747(.a(new_n877_), .b(new_n149_), .c(new_n148_), .d(new_n187_), .O(new_n878_));
  nor2   g748(.a(new_n878_), .b(new_n186_), .O(new_n879_));
  nand4  g749(.a(new_n879_), .b(new_n143_), .c(new_n142_), .d(new_n185_), .O(new_n880_));
  nor2   g750(.a(new_n880_), .b(x40), .O(new_n881_));
  nand4  g751(.a(new_n881_), .b(new_n220_), .c(new_n141_), .d(new_n183_), .O(new_n882_));
  nor2   g752(.a(new_n882_), .b(x47), .O(new_n883_));
  nand4  g753(.a(new_n883_), .b(new_n132_), .c(new_n136_), .d(new_n138_), .O(new_n884_));
