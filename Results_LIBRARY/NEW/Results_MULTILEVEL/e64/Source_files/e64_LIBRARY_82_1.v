...
module FAU ( 
  ...
  nand4  g228(.a(new_n358_), .b(new_n289_), .c(new_n143_), .d(x29), .O(new_n359_));
  ...
  nor4   g401(.a(new_n353_), .b(new_n148_), .c(x28), .d(new_n149_), .O(new_n532_));
  nand4  g402(.a(new_n532_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n533_));
  ...
  nand4  g451(.a(new_n354_), .b(new_n289_), .c(new_n187_), .d(x39), .O(new_n582_));
  ...
  nand4  g734(.a(new_n354_), .b(new_n138_), .c(new_n289_), .d(x40), .O(new_n865_));
  nor2   g735(.a(new_n865_), .b(x58), .O(z59));
  nand4  g736(.a(new_n156_), .b(new_n155_), .c(new_n160_), .d(x07), .O(new_n867_));
  inv1   g737(.a(new_n867_), .O(new_n868_));
  nand4  g738(.a(new_n868_), .b(new_n189_), .c(new_n190_), .d(new_n157_), .O(new_n869_));
  nor2   g739(.a(new_n869_), .b(x25), .O(new_n870_));
  nand4  g740(.a(new_n870_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n871_));
  nor2   g741(.a(new_n871_), .b(x37), .O(new_n872_));
  nand4  g742(.a(new_n872_), .b(new_n219_), .c(new_n187_), .d(new_n144_), .O(new_n873_));
  nor2   g743(.a(new_n873_), .b(x47), .O(new_n874_));
  nand4  g744(.a(new_n874_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n875_));
  nor2   g745(.a(new_n875_), .b(x60), .O(z60));
  nand4  g746(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(x08), .O(new_n877_));
  inv1   g747(.a(new_n877_), .O(new_n878_));
  nand4  g748(.a(new_n878_), .b(new_n149_), .c(new_n189_), .d(new_n190_), .O(new_n879_));
  inv1   g749(.a(new_n879_), .O(new_n880_));
  nand4  g750(.a(new_n880_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n881_));
  nor2   g751(.a(new_n881_), .b(x37), .O(new_n882_));
  nand4  g752(.a(new_n882_), .b(new_n219_), .c(new_n187_), .d(new_n144_), .O(new_n883_));
  nor2   g753(.a(new_n883_), .b(x47), .O(new_n884_));
  nand4  g754(.a(new_n884_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n885_));
  nor2   g755(.a(new_n885_), .b(x60), .O(z61));
  nand4  g756(.a(new_n190_), .b(new_n157_), .c(new_n156_), .d(new_n155_), .O(new_n887_));
  inv1   g757(.a(new_n887_), .O(new_n888_));
  nand4  g758(.a(new_n888_), .b(new_n151_), .c(new_n149_), .d(new_n189_), .O(new_n889_));
  nor4   g759(.a(new_n889_), .b(x37), .c(x30), .d(new_n148_), .O(new_n890_));
  nand3  g760(.a(new_n890_), .b(new_n187_), .c(new_n144_), .O(new_n891_));
  nor3   g761(.a(new_n891_), .b(new_n137_), .c(x46), .O(new_n892_));
  nand4  g762(.a(new_n892_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n893_));
  nor2   g763(.a(new_n893_), .b(x60), .O(z62));
  nor2   g764(.a(new_n891_), .b(x46), .O(new_n895_));
  nand4  g765(.a(new_n895_), .b(new_n215_), .c(x56), .d(new_n138_), .O(new_n896_));
  nor2   g766(.a(new_n896_), .b(x60), .O(z63));
  nor2   g767(.a(new_n889_), .b(new_n148_), .O(new_n898_));
  nand4  g768(.a(new_n898_), .b(new_n144_), .c(new_n143_), .d(x30), .O(new_n899_));
  nor2   g769(.a(new_n899_), .b(x40), .O(new_n900_));
  nand4  g770(.a(new_n900_), .b(new_n215_), .c(new_n138_), .d(new_n219_), .O(new_n901_));
