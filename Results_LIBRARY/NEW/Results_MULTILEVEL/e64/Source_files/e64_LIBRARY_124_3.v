...
module FAU ( 
  ...
  nor2   g331(.a(new_n438_), .b(new_n461_), .O(new_n462_));
  nand4  g332(.a(new_n462_), .b(new_n222_), .c(new_n150_), .d(new_n188_), .O(new_n463_));
  ...
  nand4  g338(.a(new_n468_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n469_));
  ...
  nand4  g342(.a(new_n472_), .b(new_n220_), .c(new_n219_), .d(new_n141_), .O(new_n473_));
  nor2   g343(.a(new_n473_), .b(x47), .O(new_n474_));
  nand4  g344(.a(new_n474_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n475_));
  nor2   g345(.a(new_n475_), .b(x51), .O(new_n476_));
  nand4  g346(.a(new_n476_), .b(new_n134_), .c(new_n217_), .d(new_n460_), .O(new_n477_));
  nor2   g347(.a(new_n477_), .b(x55), .O(new_n478_));
  nand4  g348(.a(new_n478_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n479_));
