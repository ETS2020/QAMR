...
module FAU ( 
  ...
  nor2   g487(.a(new_n496_), .b(new_n224_), .O(new_n618_));
  nand4  g488(.a(new_n618_), .b(new_n151_), .c(new_n222_), .d(new_n518_), .O(new_n619_));
  ...
  nand4  g492(.a(new_n622_), .b(new_n304_), .c(new_n145_), .d(new_n185_), .O(new_n623_));
  nor2   g493(.a(new_n623_), .b(x33), .O(new_n624_));
  nand4  g494(.a(new_n624_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n625_));
  ...
  nand4  g498(.a(new_n628_), .b(new_n220_), .c(new_n219_), .d(new_n141_), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(x47), .O(new_n630_));
  nand4  g500(.a(new_n630_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(x51), .O(new_n632_));
  nand4  g502(.a(new_n632_), .b(new_n134_), .c(new_n217_), .d(new_n549_), .O(new_n633_));
