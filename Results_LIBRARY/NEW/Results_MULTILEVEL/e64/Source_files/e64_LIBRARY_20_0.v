...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n141_, new_n142_,
    ...
    new_n349_, new_n351_, new_n352_, new_n353_, new_n354_;
  ...
  inv1   g127(.a(x22), .O(new_n295_));
  nor3   g128(.a(x07), .b(x06), .c(x03), .O(new_n296_));
  nand4  g129(.a(new_n296_), .b(new_n177_), .c(new_n178_), .d(new_n163_), .O(new_n297_));
  nor2   g130(.a(new_n297_), .b(x14), .O(new_n298_));
  nand4  g131(.a(new_n298_), .b(new_n160_), .c(new_n295_), .d(new_n135_), .O(new_n299_));
  nor2   g132(.a(new_n299_), .b(x25), .O(new_n300_));
  nand4  g133(.a(new_n300_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n301_));
  nor2   g134(.a(new_n301_), .b(x30), .O(new_n302_));
  nand4  g135(.a(new_n302_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n303_));
  nor2   g136(.a(new_n303_), .b(x41), .O(new_n304_));
  nand4  g137(.a(new_n304_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n305_));
  nor2   g138(.a(new_n305_), .b(x50), .O(new_n306_));
  nand4  g139(.a(new_n306_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n307_));
  nor2   g140(.a(new_n307_), .b(x62), .O(z57));
  nand4  g141(.a(new_n298_), .b(new_n160_), .c(x22), .d(new_n135_), .O(new_n309_));
  nor2   g142(.a(new_n309_), .b(x25), .O(new_n310_));
  nand4  g143(.a(new_n310_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n311_));
  nor2   g144(.a(new_n311_), .b(x30), .O(new_n312_));
  nand4  g145(.a(new_n312_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n313_));
  nor2   g146(.a(new_n313_), .b(x41), .O(new_n314_));
  nand4  g147(.a(new_n314_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n315_));
  nor2   g148(.a(new_n315_), .b(x50), .O(new_n316_));
  nand4  g149(.a(new_n316_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n317_));
  nor2   g150(.a(new_n317_), .b(x62), .O(z58));
  nand4  g151(.a(new_n193_), .b(new_n239_), .c(new_n141_), .d(x40), .O(new_n319_));
  nor2   g152(.a(new_n319_), .b(x58), .O(z59));
  nand4  g153(.a(new_n177_), .b(new_n178_), .c(new_n163_), .d(x07), .O(new_n321_));
  nor2   g154(.a(new_n321_), .b(x14), .O(new_n322_));
  nand4  g155(.a(new_n322_), .b(new_n209_), .c(new_n160_), .d(new_n135_), .O(new_n323_));
  nor2   g156(.a(new_n323_), .b(x28), .O(new_n324_));
  nand4  g157(.a(new_n324_), .b(new_n142_), .c(new_n200_), .d(x29), .O(new_n325_));
  nor2   g158(.a(new_n325_), .b(x39), .O(new_n326_));
  nand4  g159(.a(new_n326_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n327_));
  nor2   g160(.a(new_n327_), .b(x47), .O(new_n328_));
  nand4  g161(.a(new_n328_), .b(new_n152_), .c(new_n151_), .d(new_n239_), .O(new_n329_));
  nor2   g162(.a(new_n329_), .b(x60), .O(z60));
  nand4  g163(.a(new_n159_), .b(new_n177_), .c(new_n178_), .d(x08), .O(new_n331_));
  inv1   g164(.a(new_n331_), .O(new_n332_));
  nand4  g165(.a(new_n332_), .b(new_n209_), .c(new_n160_), .d(new_n135_), .O(new_n333_));
  nor2   g166(.a(new_n333_), .b(x28), .O(new_n334_));
  nand4  g167(.a(new_n334_), .b(new_n142_), .c(new_n200_), .d(x29), .O(new_n335_));
  nor2   g168(.a(new_n335_), .b(x39), .O(new_n336_));
  nand4  g169(.a(new_n336_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n337_));
  nor2   g170(.a(new_n337_), .b(x47), .O(new_n338_));
  nand4  g171(.a(new_n338_), .b(new_n152_), .c(new_n151_), .d(new_n239_), .O(new_n339_));
  nor2   g172(.a(new_n339_), .b(x60), .O(z61));
  nand4  g173(.a(new_n135_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n341_));
  nor2   g174(.a(new_n341_), .b(x24), .O(new_n342_));
  nand4  g175(.a(new_n342_), .b(x29), .c(new_n138_), .d(new_n209_), .O(new_n343_));
  nor3   g176(.a(new_n343_), .b(x37), .c(x30), .O(new_n344_));
  nand4  g177(.a(new_n344_), .b(new_n141_), .c(new_n157_), .d(new_n156_), .O(new_n345_));
  nor2   g178(.a(new_n345_), .b(x46), .O(new_n346_));
  nand4  g179(.a(new_n346_), .b(new_n151_), .c(new_n239_), .d(x47), .O(new_n347_));
  nor3   g180(.a(new_n347_), .b(x60), .c(x58), .O(z62));
  nand4  g181(.a(new_n346_), .b(new_n152_), .c(x56), .d(new_n239_), .O(new_n349_));
  nor2   g182(.a(new_n349_), .b(x60), .O(z63));
  nor2   g183(.a(new_n343_), .b(new_n200_), .O(new_n351_));
  nand4  g184(.a(new_n351_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n352_));
  nor2   g185(.a(new_n352_), .b(x43), .O(new_n353_));
  nand4  g186(.a(new_n353_), .b(new_n152_), .c(new_n239_), .d(new_n154_), .O(new_n354_));
  nor2   g187(.a(new_n354_), .b(x60), .O(z64));
  zero   g188(.O(z00));
  zero   g189(.O(z01));
  zero   g190(.O(z02));
  zero   g191(.O(z03));
