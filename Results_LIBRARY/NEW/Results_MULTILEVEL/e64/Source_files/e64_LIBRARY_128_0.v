...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n141_, new_n142_,
    ...
    new_n355_, new_n356_, new_n357_, new_n358_, new_n359_, new_n367_,
    new_n368_, new_n369_, new_n370_, new_n371_, new_n372_, new_n373_,
    new_n374_, new_n375_, new_n376_, new_n377_, new_n378_, new_n379_,
    new_n380_, new_n381_, new_n383_, new_n384_, new_n385_, new_n386_,
    new_n387_, new_n388_, new_n389_, new_n390_, new_n391_, new_n392_,
    new_n393_, new_n394_, new_n395_, new_n403_, new_n404_, new_n405_,
  ...
  nor2   g191(.a(new_n335_), .b(x07), .O(new_n336_));
  nand4  g192(.a(new_n336_), .b(new_n177_), .c(new_n178_), .d(new_n163_), .O(new_n337_));
  nor2   g193(.a(new_n337_), .b(x14), .O(new_n338_));
  nand3  g194(.a(new_n338_), .b(new_n253_), .c(new_n135_), .O(new_n339_));
  ...
  inv1   g216(.a(x59), .O(new_n367_));
  inv1   g217(.a(x17), .O(new_n368_));
  nand4  g218(.a(new_n338_), .b(new_n253_), .c(new_n368_), .d(new_n135_), .O(new_n369_));
  nor2   g219(.a(new_n369_), .b(x22), .O(new_n370_));
  nand4  g220(.a(new_n370_), .b(new_n158_), .c(new_n210_), .d(new_n160_), .O(new_n371_));
  nor2   g221(.a(new_n371_), .b(x28), .O(new_n372_));
  nand4  g222(.a(new_n372_), .b(new_n306_), .c(new_n201_), .d(x29), .O(new_n373_));
  nor2   g223(.a(new_n373_), .b(x37), .O(new_n374_));
  nand4  g224(.a(new_n374_), .b(new_n176_), .c(new_n157_), .d(new_n156_), .O(new_n375_));
  nor2   g225(.a(new_n375_), .b(x42), .O(new_n376_));
  nand4  g226(.a(new_n376_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n377_));
  nor2   g227(.a(new_n377_), .b(x50), .O(new_n378_));
  nand4  g228(.a(new_n378_), .b(new_n151_), .c(new_n305_), .d(new_n236_), .O(new_n379_));
  nor2   g229(.a(new_n379_), .b(x58), .O(new_n380_));
  nand4  g230(.a(new_n380_), .b(new_n304_), .c(new_n153_), .d(new_n367_), .O(new_n381_));
  nor2   g231(.a(new_n381_), .b(x62), .O(z46));
  nand4  g232(.a(new_n338_), .b(new_n253_), .c(x17), .d(new_n135_), .O(new_n383_));
  nor2   g233(.a(new_n383_), .b(x22), .O(new_n384_));
  nand4  g234(.a(new_n384_), .b(new_n158_), .c(new_n210_), .d(new_n160_), .O(new_n385_));
  nor2   g235(.a(new_n385_), .b(x28), .O(new_n386_));
  nand4  g236(.a(new_n386_), .b(new_n306_), .c(new_n201_), .d(x29), .O(new_n387_));
  nor2   g237(.a(new_n387_), .b(x37), .O(new_n388_));
  nand4  g238(.a(new_n388_), .b(new_n176_), .c(new_n157_), .d(new_n156_), .O(new_n389_));
  nor2   g239(.a(new_n389_), .b(x42), .O(new_n390_));
  nand4  g240(.a(new_n390_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n391_));
  nor2   g241(.a(new_n391_), .b(x50), .O(new_n392_));
  nand4  g242(.a(new_n392_), .b(new_n151_), .c(new_n305_), .d(new_n236_), .O(new_n393_));
  nor2   g243(.a(new_n393_), .b(x58), .O(new_n394_));
  nand4  g244(.a(new_n394_), .b(new_n304_), .c(new_n153_), .d(new_n367_), .O(new_n395_));
  nor2   g245(.a(new_n395_), .b(x62), .O(z47));
  nand3  g246(.a(new_n327_), .b(new_n236_), .c(new_n191_), .O(new_n403_));
  nor2   g247(.a(new_n403_), .b(new_n305_), .O(new_n404_));
  nand4  g248(.a(new_n404_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n405_));
  nor2   g249(.a(new_n405_), .b(x62), .O(z54));
  nor3   g250(.a(new_n245_), .b(x37), .c(new_n306_), .O(new_n407_));
  nand4  g251(.a(new_n407_), .b(new_n176_), .c(new_n157_), .d(new_n156_), .O(new_n408_));
  nor2   g252(.a(new_n408_), .b(x43), .O(new_n409_));
  nand4  g253(.a(new_n409_), .b(new_n191_), .c(new_n155_), .d(new_n154_), .O(new_n410_));
  nor2   g254(.a(new_n410_), .b(x51), .O(new_n411_));
  nand4  g255(.a(new_n411_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n412_));
  nor2   g256(.a(new_n412_), .b(x62), .O(z55));
  nand4  g257(.a(new_n163_), .b(new_n162_), .c(new_n237_), .d(new_n161_), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(new_n416_));
  nand4  g259(.a(new_n416_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n417_));
  nor2   g260(.a(new_n417_), .b(x15), .O(new_n418_));
  nand4  g261(.a(new_n418_), .b(new_n160_), .c(new_n254_), .d(x18), .O(new_n419_));
  nor2   g262(.a(new_n419_), .b(x25), .O(new_n420_));
  nand4  g263(.a(new_n420_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n421_));
  nor2   g264(.a(new_n421_), .b(x30), .O(new_n422_));
  nand4  g265(.a(new_n422_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n423_));
  nor2   g266(.a(new_n423_), .b(x41), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n425_));
  nor2   g268(.a(new_n425_), .b(x50), .O(new_n426_));
  nand4  g269(.a(new_n426_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n427_));
  nor2   g270(.a(new_n427_), .b(x62), .O(z57));
  nand3  g271(.a(new_n418_), .b(new_n160_), .c(x22), .O(new_n429_));
  nor2   g272(.a(new_n429_), .b(x25), .O(new_n430_));
  nand4  g273(.a(new_n430_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n431_));
  nor2   g274(.a(new_n431_), .b(x30), .O(new_n432_));
  nand4  g275(.a(new_n432_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n433_));
  nor2   g276(.a(new_n433_), .b(x41), .O(new_n434_));
  nand4  g277(.a(new_n434_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n435_));
  nor2   g278(.a(new_n435_), .b(x50), .O(new_n436_));
  nand4  g279(.a(new_n436_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n437_));
  nor2   g280(.a(new_n437_), .b(x62), .O(z58));
  nand4  g281(.a(new_n194_), .b(new_n191_), .c(new_n141_), .d(x40), .O(new_n439_));
  nor2   g282(.a(new_n439_), .b(x58), .O(z59));
  nand4  g283(.a(new_n177_), .b(new_n178_), .c(new_n163_), .d(x07), .O(new_n441_));
  nor2   g284(.a(new_n441_), .b(x14), .O(new_n442_));
  nand4  g285(.a(new_n442_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n443_));
  nor2   g286(.a(new_n443_), .b(x28), .O(new_n444_));
  nand4  g287(.a(new_n444_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n445_));
  nor2   g288(.a(new_n445_), .b(x39), .O(new_n446_));
  nand4  g289(.a(new_n446_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n447_));
  nor2   g290(.a(new_n447_), .b(x47), .O(new_n448_));
  nand4  g291(.a(new_n448_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n449_));
  nor2   g292(.a(new_n449_), .b(x60), .O(z60));
  nand4  g293(.a(new_n159_), .b(new_n177_), .c(new_n178_), .d(x08), .O(new_n451_));
  inv1   g294(.a(new_n451_), .O(new_n452_));
  nand4  g295(.a(new_n452_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n453_));
  nor2   g296(.a(new_n453_), .b(x28), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n455_));
  nor2   g298(.a(new_n455_), .b(x39), .O(new_n456_));
  nand4  g299(.a(new_n456_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n457_));
  nor2   g300(.a(new_n457_), .b(x47), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n459_));
  nor2   g302(.a(new_n459_), .b(x60), .O(z61));
  nand4  g303(.a(new_n135_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n461_));
  nor2   g304(.a(new_n461_), .b(x24), .O(new_n462_));
  nand4  g305(.a(new_n462_), .b(x29), .c(new_n138_), .d(new_n210_), .O(new_n463_));
  nor3   g306(.a(new_n463_), .b(x37), .c(x30), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n141_), .c(new_n157_), .d(new_n156_), .O(new_n465_));
  nor2   g308(.a(new_n465_), .b(x46), .O(new_n466_));
  nand4  g309(.a(new_n466_), .b(new_n151_), .c(new_n191_), .d(x47), .O(new_n467_));
  nor3   g310(.a(new_n467_), .b(x60), .c(x58), .O(z62));
  nand4  g311(.a(new_n466_), .b(new_n152_), .c(x56), .d(new_n191_), .O(new_n469_));
  nor2   g312(.a(new_n469_), .b(x60), .O(z63));
  nor2   g313(.a(new_n463_), .b(new_n201_), .O(new_n471_));
  nand4  g314(.a(new_n471_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n472_));
  nor2   g315(.a(new_n472_), .b(x43), .O(new_n473_));
  nand4  g316(.a(new_n473_), .b(new_n152_), .c(new_n191_), .d(new_n154_), .O(new_n474_));
  nor2   g317(.a(new_n474_), .b(x60), .O(z64));
  zero   g318(.O(z00));
  zero   g319(.O(z01));
  zero   g320(.O(z02));
  zero   g321(.O(z03));
