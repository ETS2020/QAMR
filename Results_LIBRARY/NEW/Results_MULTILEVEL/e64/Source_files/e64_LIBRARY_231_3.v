// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:59 2020
...
module FAU ( 
  ...
  nand4  g670(.a(new_n403_), .b(new_n138_), .c(new_n218_), .d(x48), .O(new_n801_));
  nor2   g671(.a(new_n801_), .b(x51), .O(new_n802_));
  nand4  g672(.a(new_n802_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n803_));
