...
module FAU ( 
  ...
  nand4  g538(.a(new_n668_), .b(new_n184_), .c(new_n147_), .d(new_n146_), .O(new_n669_));
  nor4   g539(.a(new_n669_), .b(x40), .c(x39), .d(x37), .O(new_n670_));
  nand4  g540(.a(new_n670_), .b(new_n141_), .c(new_n140_), .d(new_n183_), .O(new_n671_));
  nor2   g541(.a(new_n671_), .b(x46), .O(new_n672_));
  nand4  g542(.a(new_n672_), .b(new_n139_), .c(new_n138_), .d(new_n137_), .O(new_n673_));
  nor4   g543(.a(new_n673_), .b(x56), .c(x55), .d(new_n134_), .O(new_n674_));
  nand4  g544(.a(new_n674_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n675_));
  nor2   g545(.a(new_n675_), .b(x62), .O(z40));
  nand4  g546(.a(new_n668_), .b(new_n184_), .c(new_n147_), .d(x33), .O(new_n677_));
  ...
  nor4   g608(.a(new_n667_), .b(x37), .c(x35), .d(new_n147_), .O(new_n739_));
  ...
  nand4  g617(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(x09), .O(new_n748_));
  ...
  nand3  g633(.a(new_n641_), .b(new_n150_), .c(x17), .O(new_n764_));
  ...
  nor4   g647(.a(new_n667_), .b(x34), .c(x33), .d(new_n145_), .O(new_n778_));
  ...
  nor2   g658(.a(new_n673_), .b(new_n217_), .O(new_n789_));
  ...
  nand4  g688(.a(new_n818_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n819_));
  ...
  nor3   g696(.a(new_n410_), .b(x64), .c(new_n214_), .O(z53));
  nor2   g697(.a(new_n614_), .b(new_n135_), .O(new_n828_));
  nand4  g698(.a(new_n828_), .b(new_n132_), .c(new_n216_), .d(new_n136_), .O(new_n829_));
  nor2   g699(.a(new_n829_), .b(x62), .O(z54));
  nor3   g700(.a(new_n416_), .b(x37), .c(new_n184_), .O(new_n831_));
  ...
  nor4   g707(.a(new_n438_), .b(x18), .c(x17), .d(x16), .O(new_n838_));
