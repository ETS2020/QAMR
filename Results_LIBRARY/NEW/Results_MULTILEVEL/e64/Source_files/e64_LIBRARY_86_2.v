// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:02 2020
...
module FAU ( 
  ...
  nand4  g121(.a(new_n251_), .b(new_n221_), .c(new_n143_), .d(new_n220_), .O(new_n252_));
  ...
  nand4  g141(.a(new_n271_), .b(new_n221_), .c(new_n143_), .d(new_n220_), .O(new_n272_));
  ...
  nand4  g159(.a(new_n143_), .b(x29), .c(new_n151_), .d(new_n190_), .O(new_n290_));
  nor2   g160(.a(new_n290_), .b(new_n289_), .O(z07));
  nand3  g161(.a(new_n271_), .b(new_n143_), .c(new_n220_), .O(new_n292_));
  nor2   g162(.a(new_n292_), .b(new_n221_), .O(new_n293_));
  ...
  nand4  g195(.a(new_n143_), .b(x29), .c(x28), .d(new_n190_), .O(new_n326_));
  ...
  nand4  g207(.a(new_n337_), .b(new_n137_), .c(new_n219_), .d(new_n140_), .O(new_n338_));
  ...
  nand4  g217(.a(new_n347_), .b(new_n137_), .c(new_n219_), .d(x41), .O(new_n348_));
  ...
  nor4   g223(.a(new_n353_), .b(x37), .c(new_n148_), .d(x28), .O(new_n354_));
  inv1   g224(.a(new_n354_), .O(new_n355_));
  nor3   g225(.a(new_n355_), .b(x58), .c(new_n138_), .O(z14));
  nand4  g226(.a(new_n151_), .b(new_n190_), .c(new_n157_), .d(x10), .O(new_n357_));
  inv1   g227(.a(new_n357_), .O(new_n358_));
  nand4  g228(.a(new_n358_), .b(new_n215_), .c(new_n143_), .d(x29), .O(new_n359_));
  ...
  nand4  g233(.a(new_n363_), .b(new_n137_), .c(new_n219_), .d(new_n187_), .O(new_n364_));
  ...
  nand4  g243(.a(new_n373_), .b(new_n137_), .c(new_n219_), .d(new_n187_), .O(new_n374_));
  ...
  nand4  g253(.a(new_n383_), .b(new_n137_), .c(new_n219_), .d(new_n187_), .O(new_n384_));
  ...
  nor2   g266(.a(new_n396_), .b(x42), .O(new_n397_));
  ...
  nand4  g299(.a(new_n429_), .b(new_n137_), .c(new_n219_), .d(new_n140_), .O(new_n430_));
  ...
  nor2   g350(.a(new_n480_), .b(x40), .O(new_n481_));
  ...
  nor2   g355(.a(new_n485_), .b(x40), .O(new_n486_));
  ...
  nand4  g451(.a(new_n354_), .b(new_n138_), .c(new_n187_), .d(x39), .O(new_n582_));
  nor2   g452(.a(new_n582_), .b(x58), .O(z33));
  nor3   g453(.a(x28), .b(x15), .c(x14), .O(new_n584_));
  nand4  g454(.a(new_n584_), .b(new_n289_), .c(new_n143_), .d(x29), .O(new_n585_));
  nor2   g455(.a(new_n585_), .b(new_n215_), .O(z34));
  nor4   g456(.a(new_n163_), .b(x07), .c(x06), .d(new_n229_), .O(new_n587_));
  ...
  nand4  g463(.a(new_n593_), .b(new_n143_), .c(new_n142_), .d(new_n145_), .O(new_n594_));
  nor2   g464(.a(new_n594_), .b(x39), .O(new_n595_));
  nand4  g465(.a(new_n595_), .b(new_n219_), .c(new_n140_), .d(new_n187_), .O(new_n596_));
  ...
  nor4   g471(.a(new_n412_), .b(x39), .c(x37), .d(x35), .O(new_n602_));
  nand4  g472(.a(new_n602_), .b(new_n219_), .c(new_n140_), .d(new_n187_), .O(new_n603_));
  nor4   g473(.a(new_n603_), .b(x51), .c(x50), .d(x47), .O(new_n604_));
  nand2  g474(.a(new_n604_), .b(new_n135_), .O(new_n605_));
  nor2   g475(.a(new_n605_), .b(x56), .O(new_n606_));
  nand4  g476(.a(new_n606_), .b(x61), .c(new_n132_), .d(new_n215_), .O(new_n607_));
  nor2   g477(.a(new_n607_), .b(x62), .O(z36));
  inv1   g478(.a(x19), .O(new_n609_));
  nor2   g479(.a(new_n242_), .b(new_n609_), .O(new_n610_));
  nand4  g480(.a(new_n610_), .b(new_n154_), .c(new_n225_), .d(new_n224_), .O(new_n611_));
  nor2   g481(.a(new_n611_), .b(x24), .O(new_n612_));
  nand4  g482(.a(new_n612_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n613_));
  nor2   g483(.a(new_n613_), .b(new_n148_), .O(new_n614_));
  nand4  g484(.a(new_n614_), .b(new_n222_), .c(new_n146_), .d(new_n145_), .O(new_n615_));
  nor2   g485(.a(new_n615_), .b(x33), .O(new_n616_));
  nand4  g486(.a(new_n616_), .b(new_n220_), .c(new_n142_), .d(new_n188_), .O(new_n617_));
  nor2   g487(.a(new_n617_), .b(x37), .O(new_n618_));
  nand4  g488(.a(new_n618_), .b(new_n140_), .c(new_n187_), .d(new_n144_), .O(new_n619_));
  nor2   g489(.a(new_n619_), .b(x42), .O(new_n620_));
  nand4  g490(.a(new_n620_), .b(new_n137_), .c(new_n219_), .d(new_n218_), .O(new_n621_));
  nor2   g491(.a(new_n621_), .b(x48), .O(new_n622_));
  nand4  g492(.a(new_n622_), .b(new_n139_), .c(new_n138_), .d(new_n217_), .O(new_n623_));
  nor2   g493(.a(new_n623_), .b(x52), .O(new_n624_));
  nand4  g494(.a(new_n624_), .b(new_n135_), .c(new_n134_), .d(new_n216_), .O(new_n625_));
  nor2   g495(.a(new_n625_), .b(x56), .O(new_n626_));
  nand4  g496(.a(new_n626_), .b(new_n131_), .c(new_n215_), .d(new_n214_), .O(new_n627_));
  nor2   g497(.a(new_n627_), .b(x60), .O(new_n628_));
  nand4  g498(.a(new_n628_), .b(new_n213_), .c(new_n212_), .d(new_n133_), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(x64), .O(z37));
  nand4  g500(.a(new_n164_), .b(new_n160_), .c(new_n159_), .d(new_n158_), .O(new_n631_));
  inv1   g501(.a(new_n631_), .O(new_n632_));
  nand4  g502(.a(new_n632_), .b(new_n157_), .c(new_n156_), .d(new_n155_), .O(new_n633_));
  nor2   g503(.a(new_n633_), .b(x15), .O(new_n634_));
  nand4  g504(.a(new_n634_), .b(new_n189_), .c(new_n154_), .d(new_n153_), .O(new_n635_));
  nor3   g505(.a(new_n635_), .b(x26), .c(x25), .O(new_n636_));
  nand4  g506(.a(new_n636_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n637_));
  nor2   g507(.a(new_n637_), .b(x35), .O(new_n638_));
  nand4  g508(.a(new_n638_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n639_));
  nor2   g509(.a(new_n639_), .b(x41), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n641_));
  nor2   g511(.a(new_n641_), .b(x50), .O(new_n642_));
  nand4  g512(.a(new_n642_), .b(new_n136_), .c(new_n135_), .d(new_n139_), .O(new_n643_));
  nor2   g513(.a(new_n643_), .b(x58), .O(new_n644_));
  nand4  g514(.a(new_n644_), .b(new_n133_), .c(new_n132_), .d(x59), .O(new_n645_));
  nor2   g515(.a(new_n645_), .b(x62), .O(z38));
  nand3  g516(.a(new_n640_), .b(new_n219_), .c(x42), .O(new_n647_));
  ...
  nand4  g520(.a(new_n650_), .b(new_n133_), .c(new_n132_), .d(new_n215_), .O(new_n651_));
  nor2   g521(.a(new_n651_), .b(x62), .O(z39));
  nand4  g522(.a(new_n632_), .b(new_n156_), .c(new_n155_), .d(new_n191_), .O(new_n653_));
  nor4   g523(.a(new_n653_), .b(x17), .c(x15), .d(x14), .O(new_n654_));
  nand4  g524(.a(new_n654_), .b(new_n189_), .c(new_n154_), .d(new_n153_), .O(new_n655_));
  nor4   g525(.a(new_n655_), .b(x28), .c(x26), .d(x25), .O(new_n656_));
  nand3  g526(.a(new_n656_), .b(new_n145_), .c(x29), .O(new_n657_));
  inv1   g527(.a(new_n657_), .O(new_n658_));
  nand4  g528(.a(new_n658_), .b(new_n142_), .c(new_n188_), .d(new_n147_), .O(new_n659_));
  nor2   g529(.a(new_n659_), .b(x37), .O(new_n660_));
  nand4  g530(.a(new_n660_), .b(new_n140_), .c(new_n187_), .d(new_n144_), .O(new_n661_));
  nor2   g531(.a(new_n661_), .b(x42), .O(new_n662_));
  nand4  g532(.a(new_n662_), .b(new_n138_), .c(new_n137_), .d(new_n219_), .O(new_n663_));
  nor2   g533(.a(new_n663_), .b(x51), .O(new_n664_));
  nand4  g534(.a(new_n664_), .b(new_n136_), .c(new_n135_), .d(x54), .O(new_n665_));
  ...
  nor4   g538(.a(new_n657_), .b(x35), .c(x34), .d(new_n147_), .O(new_n669_));
  nand4  g539(.a(new_n669_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n670_));
  nor2   g540(.a(new_n670_), .b(x41), .O(new_n671_));
  nand4  g541(.a(new_n671_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n672_));
  ...
  nand4  g547(.a(new_n399_), .b(new_n139_), .c(new_n138_), .d(x49), .O(new_n678_));
  ...
  nand4  g553(.a(new_n233_), .b(new_n232_), .c(x01), .d(new_n230_), .O(new_n684_));
  nor3   g554(.a(new_n684_), .b(x05), .c(x04), .O(new_n685_));
  nand4  g555(.a(new_n685_), .b(new_n160_), .c(new_n159_), .d(new_n158_), .O(new_n686_));
  nor2   g556(.a(new_n686_), .b(x09), .O(new_n687_));
  nand4  g557(.a(new_n687_), .b(new_n157_), .c(new_n156_), .d(new_n155_), .O(new_n688_));
  nor2   g558(.a(new_n688_), .b(x15), .O(new_n689_));
  nand4  g559(.a(new_n689_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n690_));
  nor2   g560(.a(new_n690_), .b(x24), .O(new_n691_));
  nand4  g561(.a(new_n691_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n692_));
  nor2   g562(.a(new_n692_), .b(new_n148_), .O(new_n693_));
  nand4  g563(.a(new_n693_), .b(new_n147_), .c(new_n146_), .d(new_n145_), .O(new_n694_));
  nor2   g564(.a(new_n694_), .b(x34), .O(new_n695_));
  nand4  g565(.a(new_n695_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n696_));
  nor2   g566(.a(new_n696_), .b(x40), .O(new_n697_));
  nand4  g567(.a(new_n697_), .b(new_n218_), .c(new_n141_), .d(new_n140_), .O(new_n698_));
  ...
  nand4  g571(.a(new_n701_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n702_));
  ...
  nand4  g575(.a(new_n229_), .b(new_n233_), .c(x02), .d(new_n230_), .O(new_n706_));
  nor2   g576(.a(new_n706_), .b(x05), .O(new_n707_));
  nand4  g577(.a(new_n707_), .b(new_n160_), .c(new_n159_), .d(new_n158_), .O(new_n708_));
  nor2   g578(.a(new_n708_), .b(x09), .O(new_n709_));
  nand4  g579(.a(new_n709_), .b(new_n157_), .c(new_n156_), .d(new_n155_), .O(new_n710_));
  nor2   g580(.a(new_n710_), .b(x15), .O(new_n711_));
  nand4  g581(.a(new_n711_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n712_));
  nor2   g582(.a(new_n712_), .b(x24), .O(new_n713_));
  nand4  g583(.a(new_n713_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n714_));
  nor2   g584(.a(new_n714_), .b(new_n148_), .O(new_n715_));
  nand4  g585(.a(new_n715_), .b(new_n147_), .c(new_n146_), .d(new_n145_), .O(new_n716_));
  nor2   g586(.a(new_n716_), .b(x34), .O(new_n717_));
  nand4  g587(.a(new_n717_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n718_));
  nor2   g588(.a(new_n718_), .b(x40), .O(new_n719_));
  nand4  g589(.a(new_n719_), .b(new_n218_), .c(new_n141_), .d(new_n140_), .O(new_n720_));
  ...
  nor3   g597(.a(new_n657_), .b(x35), .c(new_n188_), .O(new_n728_));
  nand4  g598(.a(new_n728_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n729_));
  nor2   g599(.a(new_n729_), .b(x41), .O(new_n730_));
  nand4  g600(.a(new_n730_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n731_));
  ...
  nor4   g606(.a(new_n631_), .b(x11), .c(x10), .d(new_n191_), .O(new_n737_));
  nand4  g607(.a(new_n737_), .b(new_n152_), .c(new_n190_), .d(new_n157_), .O(new_n738_));
  nor2   g608(.a(new_n738_), .b(x18), .O(new_n739_));
  nand4  g609(.a(new_n739_), .b(new_n149_), .c(new_n189_), .d(new_n154_), .O(new_n740_));
  nor2   g610(.a(new_n740_), .b(x26), .O(new_n741_));
  nand4  g611(.a(new_n741_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n742_));
  nor2   g612(.a(new_n742_), .b(x35), .O(new_n743_));
  nand4  g613(.a(new_n743_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n744_));
  nor2   g614(.a(new_n744_), .b(x41), .O(new_n745_));
  nand4  g615(.a(new_n745_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n746_));
  ...
  nand2  g621(.a(new_n634_), .b(x17), .O(new_n752_));
  nor2   g622(.a(new_n752_), .b(x18), .O(new_n753_));
  nand4  g623(.a(new_n753_), .b(new_n149_), .c(new_n189_), .d(new_n154_), .O(new_n754_));
  nor2   g624(.a(new_n754_), .b(x26), .O(new_n755_));
  nand4  g625(.a(new_n755_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n756_));
  nor2   g626(.a(new_n756_), .b(x35), .O(new_n757_));
  nand4  g627(.a(new_n757_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n758_));
  nor2   g628(.a(new_n758_), .b(x41), .O(new_n759_));
  nand4  g629(.a(new_n759_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n760_));
  ...
  nor3   g635(.a(new_n657_), .b(x33), .c(new_n146_), .O(new_n766_));
  nand4  g636(.a(new_n766_), .b(new_n143_), .c(new_n142_), .d(new_n188_), .O(new_n767_));
  nor2   g637(.a(new_n767_), .b(x39), .O(new_n768_));
  nand4  g638(.a(new_n768_), .b(new_n141_), .c(new_n140_), .d(new_n187_), .O(new_n769_));
  ...
  nor3   g646(.a(new_n663_), .b(new_n216_), .c(x51), .O(new_n777_));
  ...
  nand2  g651(.a(new_n403_), .b(x57), .O(new_n782_));
  ...
  nor2   g655(.a(new_n398_), .b(new_n389_), .O(new_n786_));
  nand4  g656(.a(new_n786_), .b(new_n139_), .c(new_n138_), .d(new_n217_), .O(new_n787_));
  ...
  nand4  g662(.a(new_n239_), .b(new_n190_), .c(new_n157_), .d(x12), .O(new_n793_));
  nor2   g663(.a(new_n793_), .b(x17), .O(new_n794_));
  nand4  g664(.a(new_n794_), .b(new_n189_), .c(new_n154_), .d(new_n153_), .O(new_n795_));
  nor2   g665(.a(new_n795_), .b(x25), .O(new_n796_));
  nand4  g666(.a(new_n796_), .b(x29), .c(new_n151_), .d(new_n150_), .O(new_n797_));
  nor2   g667(.a(new_n797_), .b(x30), .O(new_n798_));
  nand4  g668(.a(new_n798_), .b(new_n188_), .c(new_n147_), .d(new_n146_), .O(new_n799_));
  nor2   g669(.a(new_n799_), .b(x35), .O(new_n800_));
  nand4  g670(.a(new_n800_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n801_));
  nor2   g671(.a(new_n801_), .b(x41), .O(new_n802_));
  nand4  g672(.a(new_n802_), .b(new_n219_), .c(new_n218_), .d(new_n141_), .O(new_n803_));
  nor2   g673(.a(new_n803_), .b(x47), .O(new_n804_));
  nand4  g674(.a(new_n804_), .b(new_n138_), .c(new_n217_), .d(new_n389_), .O(new_n805_));
  nor2   g675(.a(new_n805_), .b(x51), .O(new_n806_));
  nand4  g676(.a(new_n806_), .b(new_n135_), .c(new_n134_), .d(new_n216_), .O(new_n807_));
  nor2   g677(.a(new_n807_), .b(x56), .O(new_n808_));
  nand4  g678(.a(new_n808_), .b(new_n131_), .c(new_n215_), .d(new_n214_), .O(new_n809_));
  nor2   g679(.a(new_n809_), .b(x60), .O(new_n810_));
  nand4  g680(.a(new_n810_), .b(new_n213_), .c(new_n212_), .d(new_n133_), .O(new_n811_));
  nor2   g681(.a(new_n811_), .b(x64), .O(z52));
  nor3   g682(.a(new_n406_), .b(x64), .c(new_n213_), .O(z53));
  nand4  g683(.a(new_n604_), .b(new_n215_), .c(new_n136_), .d(x55), .O(new_n814_));
  nor3   g684(.a(new_n814_), .b(x62), .c(x60), .O(z54));
  nor2   g685(.a(new_n412_), .b(new_n142_), .O(new_n816_));
  nand4  g686(.a(new_n816_), .b(new_n187_), .c(new_n144_), .d(new_n143_), .O(new_n817_));
  nor2   g687(.a(new_n817_), .b(x41), .O(new_n818_));
  nand4  g688(.a(new_n818_), .b(new_n138_), .c(new_n137_), .d(new_n219_), .O(new_n819_));
  nor2   g689(.a(new_n819_), .b(x51), .O(new_n820_));
  nand4  g690(.a(new_n820_), .b(new_n132_), .c(new_n215_), .d(new_n136_), .O(new_n821_));
  nor2   g691(.a(new_n821_), .b(x62), .O(z55));
  nor3   g692(.a(new_n435_), .b(x17), .c(x16), .O(new_n823_));
  nand4  g693(.a(new_n823_), .b(new_n225_), .c(x20), .d(new_n153_), .O(new_n824_));
  nor2   g694(.a(new_n824_), .b(x22), .O(new_n825_));
  nand4  g695(.a(new_n825_), .b(new_n150_), .c(new_n149_), .d(new_n189_), .O(new_n826_));
  nor2   g696(.a(new_n826_), .b(x28), .O(new_n827_));
  nand4  g697(.a(new_n827_), .b(new_n146_), .c(new_n145_), .d(x29), .O(new_n828_));
  nor2   g698(.a(new_n828_), .b(x33), .O(new_n829_));
  nand4  g699(.a(new_n829_), .b(new_n220_), .c(new_n142_), .d(new_n188_), .O(new_n830_));
  nor2   g700(.a(new_n830_), .b(x37), .O(new_n831_));
  nand4  g701(.a(new_n831_), .b(new_n140_), .c(new_n187_), .d(new_n144_), .O(new_n832_));
  nor2   g702(.a(new_n832_), .b(x42), .O(new_n833_));
  nand4  g703(.a(new_n833_), .b(new_n137_), .c(new_n219_), .d(new_n218_), .O(new_n834_));
  nor2   g704(.a(new_n834_), .b(x48), .O(new_n835_));
  nand4  g705(.a(new_n835_), .b(new_n139_), .c(new_n138_), .d(new_n217_), .O(new_n836_));
  nor2   g706(.a(new_n836_), .b(x52), .O(new_n837_));
  nand4  g707(.a(new_n837_), .b(new_n135_), .c(new_n134_), .d(new_n216_), .O(new_n838_));
  nor2   g708(.a(new_n838_), .b(x56), .O(new_n839_));
  nand4  g709(.a(new_n839_), .b(new_n131_), .c(new_n215_), .d(new_n214_), .O(new_n840_));
  nor2   g710(.a(new_n840_), .b(x60), .O(new_n841_));
  nand4  g711(.a(new_n841_), .b(new_n213_), .c(new_n212_), .d(new_n133_), .O(new_n842_));
  nor2   g712(.a(new_n842_), .b(x64), .O(z56));
  nand4  g713(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n233_), .O(new_n844_));
  nor2   g714(.a(new_n844_), .b(x10), .O(new_n845_));
  nand4  g715(.a(new_n845_), .b(new_n190_), .c(new_n157_), .d(new_n156_), .O(new_n846_));
  nor4   g716(.a(new_n846_), .b(x24), .c(x22), .d(new_n153_), .O(new_n847_));
  nand4  g717(.a(new_n847_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n848_));
  nor2   g718(.a(new_n848_), .b(new_n148_), .O(new_n849_));
  nand4  g719(.a(new_n849_), .b(new_n144_), .c(new_n143_), .d(new_n145_), .O(new_n850_));
  nor2   g720(.a(new_n850_), .b(x40), .O(new_n851_));
  nand4  g721(.a(new_n851_), .b(new_n137_), .c(new_n219_), .d(new_n140_), .O(new_n852_));
  nor2   g722(.a(new_n852_), .b(x50), .O(new_n853_));
  nand4  g723(.a(new_n853_), .b(new_n132_), .c(new_n215_), .d(new_n136_), .O(new_n854_));
  nor2   g724(.a(new_n854_), .b(x62), .O(z57));
  nor3   g725(.a(new_n846_), .b(x24), .c(new_n154_), .O(new_n856_));
  nand4  g726(.a(new_n856_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n857_));
  nor2   g727(.a(new_n857_), .b(new_n148_), .O(new_n858_));
  nand4  g728(.a(new_n858_), .b(new_n144_), .c(new_n143_), .d(new_n145_), .O(new_n859_));
  nor2   g729(.a(new_n859_), .b(x40), .O(new_n860_));
  nand4  g730(.a(new_n860_), .b(new_n137_), .c(new_n219_), .d(new_n140_), .O(new_n861_));
  ...
  nor4   g734(.a(new_n355_), .b(x58), .c(x50), .d(new_n187_), .O(z59));
  nand4  g735(.a(new_n156_), .b(new_n155_), .c(new_n160_), .d(x07), .O(new_n866_));
  inv1   g736(.a(new_n866_), .O(new_n867_));
  nand4  g737(.a(new_n867_), .b(new_n189_), .c(new_n190_), .d(new_n157_), .O(new_n868_));
  nor2   g738(.a(new_n868_), .b(x25), .O(new_n869_));
  nand4  g739(.a(new_n869_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n870_));
  nor2   g740(.a(new_n870_), .b(x37), .O(new_n871_));
  nand4  g741(.a(new_n871_), .b(new_n219_), .c(new_n187_), .d(new_n144_), .O(new_n872_));
  nor2   g742(.a(new_n872_), .b(x47), .O(new_n873_));
  nand4  g743(.a(new_n873_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n874_));
  nor2   g744(.a(new_n874_), .b(x60), .O(z60));
  nand4  g745(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(x08), .O(new_n876_));
  inv1   g746(.a(new_n876_), .O(new_n877_));
  nand4  g747(.a(new_n877_), .b(new_n149_), .c(new_n189_), .d(new_n190_), .O(new_n878_));
  inv1   g748(.a(new_n878_), .O(new_n879_));
  nand4  g749(.a(new_n879_), .b(new_n145_), .c(x29), .d(new_n151_), .O(new_n880_));
  nor2   g750(.a(new_n880_), .b(x37), .O(new_n881_));
  nand4  g751(.a(new_n881_), .b(new_n219_), .c(new_n187_), .d(new_n144_), .O(new_n882_));
  nor2   g752(.a(new_n882_), .b(x47), .O(new_n883_));
  nand4  g753(.a(new_n883_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n884_));
  nor2   g754(.a(new_n884_), .b(x60), .O(z61));
  nand4  g755(.a(new_n190_), .b(new_n157_), .c(new_n156_), .d(new_n155_), .O(new_n886_));
  inv1   g756(.a(new_n886_), .O(new_n887_));
  nand4  g757(.a(new_n887_), .b(new_n151_), .c(new_n149_), .d(new_n189_), .O(new_n888_));
  nor4   g758(.a(new_n888_), .b(x37), .c(x30), .d(new_n148_), .O(new_n889_));
  nand3  g759(.a(new_n889_), .b(new_n187_), .c(new_n144_), .O(new_n890_));
  nor3   g760(.a(new_n890_), .b(new_n137_), .c(x46), .O(new_n891_));
  nand4  g761(.a(new_n891_), .b(new_n215_), .c(new_n136_), .d(new_n138_), .O(new_n892_));
  nor2   g762(.a(new_n892_), .b(x60), .O(z62));
  nor2   g763(.a(new_n890_), .b(x46), .O(new_n894_));
  nand4  g764(.a(new_n894_), .b(new_n215_), .c(x56), .d(new_n138_), .O(new_n895_));
  nor2   g765(.a(new_n895_), .b(x60), .O(z63));
  nor2   g766(.a(new_n888_), .b(new_n148_), .O(new_n897_));
  nand4  g767(.a(new_n897_), .b(new_n144_), .c(new_n143_), .d(x30), .O(new_n898_));
  nor2   g768(.a(new_n898_), .b(x40), .O(new_n899_));
  nand4  g769(.a(new_n899_), .b(new_n215_), .c(new_n138_), .d(new_n219_), .O(new_n900_));
