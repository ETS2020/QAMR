...
module FAU ( 
  ...
  nor3   g566(.a(new_n696_), .b(x05), .c(x04), .O(new_n697_));
  nand4  g567(.a(new_n697_), .b(new_n157_), .c(new_n156_), .d(new_n190_), .O(new_n698_));
  nor2   g568(.a(new_n698_), .b(x09), .O(new_n699_));
  ...
  nand4  g575(.a(new_n705_), .b(new_n146_), .c(new_n145_), .d(new_n185_), .O(new_n706_));
  nor2   g576(.a(new_n706_), .b(x34), .O(new_n707_));
  nand4  g577(.a(new_n707_), .b(new_n143_), .c(new_n142_), .d(new_n184_), .O(new_n708_));
  nor2   g578(.a(new_n708_), .b(x40), .O(new_n709_));
  nand4  g579(.a(new_n709_), .b(new_n141_), .c(new_n140_), .d(new_n183_), .O(new_n710_));
  nor2   g580(.a(new_n710_), .b(x45), .O(new_n711_));
  nand4  g581(.a(new_n711_), .b(new_n138_), .c(new_n137_), .d(new_n220_), .O(new_n712_));
  nor2   g582(.a(new_n712_), .b(x51), .O(new_n713_));
  nand4  g583(.a(new_n713_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n714_));
  ...
  nor4   g609(.a(new_n667_), .b(x37), .c(x35), .d(new_n147_), .O(new_n740_));
  ...
  nor4   g648(.a(new_n667_), .b(x34), .c(x33), .d(new_n145_), .O(new_n779_));
  ...
  nor3   g659(.a(new_n673_), .b(new_n217_), .c(x51), .O(new_n790_));
