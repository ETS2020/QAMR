...
module FAU ( 
  ...
  nor2   g263(.a(new_n235_), .b(x14), .O(new_n394_));
  nand3  g264(.a(new_n394_), .b(new_n188_), .c(new_n155_), .O(new_n395_));
  ...
  nor2   g271(.a(new_n401_), .b(x45), .O(new_n402_));
  nand3  g272(.a(new_n402_), .b(new_n137_), .c(new_n220_), .O(new_n403_));
  nor4   g273(.a(new_n403_), .b(x50), .c(x49), .d(x48), .O(new_n404_));
  nand4  g274(.a(new_n404_), .b(new_n134_), .c(new_n217_), .d(new_n139_), .O(new_n405_));
  nor3   g275(.a(new_n405_), .b(x56), .c(x55), .O(new_n406_));
  ...
  nand4  g321(.a(new_n451_), .b(new_n138_), .c(new_n218_), .d(new_n437_), .O(new_n452_));
  ...
  nand4  g449(.a(new_n579_), .b(new_n138_), .c(new_n218_), .d(new_n437_), .O(new_n580_));
  ...
  nor4   g480(.a(new_n415_), .b(x39), .c(x37), .d(x35), .O(new_n611_));
  ...
  nor4   g559(.a(new_n403_), .b(x51), .c(x50), .d(new_n218_), .O(new_n690_));
  nand4  g560(.a(new_n690_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n691_));
  ...
  nor4   g610(.a(new_n667_), .b(x37), .c(x35), .d(new_n147_), .O(new_n741_));
  ...
  nand4  g619(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(x09), .O(new_n750_));
  ...
  nand3  g635(.a(new_n641_), .b(new_n150_), .c(x17), .O(new_n766_));
  ...
  nor4   g649(.a(new_n667_), .b(x34), .c(x33), .d(new_n145_), .O(new_n780_));
  ...
  nor3   g660(.a(new_n673_), .b(new_n217_), .c(x51), .O(new_n791_));
  ...
  nor2   g669(.a(new_n403_), .b(new_n437_), .O(new_n800_));
  ...
  nand4  g690(.a(new_n820_), .b(new_n138_), .c(new_n218_), .d(new_n437_), .O(new_n821_));
  ...
  nor2   g699(.a(new_n614_), .b(new_n135_), .O(new_n830_));
