...
module FAU ( 
  ...
  nand4  g309(.a(new_n439_), .b(new_n187_), .c(new_n152_), .d(new_n151_), .O(new_n440_));
  nor2   g310(.a(new_n440_), .b(x26), .O(new_n441_));
  nand4  g311(.a(new_n441_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n442_));
  nor2   g312(.a(new_n442_), .b(x31), .O(new_n443_));
  nand4  g313(.a(new_n443_), .b(new_n184_), .c(new_n147_), .d(new_n146_), .O(new_n444_));
  ...
  nand4  g317(.a(new_n447_), .b(new_n219_), .c(new_n141_), .d(new_n140_), .O(new_n448_));
  nor2   g318(.a(new_n448_), .b(x46), .O(new_n449_));
  nand4  g319(.a(new_n449_), .b(new_n218_), .c(new_n394_), .d(new_n137_), .O(new_n450_));
  nor2   g320(.a(new_n450_), .b(x50), .O(new_n451_));
  nand4  g321(.a(new_n451_), .b(new_n134_), .c(new_n217_), .d(new_n139_), .O(new_n452_));
  nor2   g322(.a(new_n452_), .b(x55), .O(new_n453_));
  nand4  g323(.a(new_n453_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n454_));
  ...
  nor3   g328(.a(new_n438_), .b(x17), .c(new_n458_), .O(new_n459_));
  ...
  inv1   g417(.a(new_n439_), .O(new_n548_));
  nor4   g418(.a(new_n548_), .b(x24), .c(x22), .d(x21), .O(new_n549_));
  ...
  nor3   g437(.a(new_n548_), .b(x22), .c(new_n222_), .O(new_n568_));
  ...
  nor3   g486(.a(new_n494_), .b(x20), .c(new_n224_), .O(new_n617_));
