...
module FAU ( 
  ...
  nand3  g387(.a(new_n236_), .b(new_n154_), .c(x13), .O(new_n518_));
  nor2   g388(.a(new_n518_), .b(x15), .O(new_n519_));
  nand4  g389(.a(new_n519_), .b(new_n150_), .c(new_n188_), .d(new_n460_), .O(new_n520_));
  nor4   g390(.a(new_n520_), .b(x22), .c(x21), .d(x20), .O(new_n521_));
  ...
  nand4  g395(.a(new_n525_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n526_));
  ...
  nand4  g399(.a(new_n529_), .b(new_n137_), .c(new_n219_), .d(new_n141_), .O(new_n530_));
