...
module FAU ( 
  ...
  nor2   g516(.a(new_n646_), .b(x41), .O(new_n647_));
  nand4  g517(.a(new_n647_), .b(new_n220_), .c(new_n141_), .d(new_n140_), .O(new_n648_));
  ...
  nand4  g523(.a(new_n647_), .b(new_n220_), .c(new_n141_), .d(x42), .O(new_n654_));
  ...
  nand4  g529(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(new_n158_), .O(new_n660_));
