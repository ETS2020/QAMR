// Benchmark "FAU" written by ABC on Mon Jul 27 19:30:56 2020
...
module FAU ( 
  ...
  inv1   g387(.a(x52), .O(new_n518_));
  nand3  g388(.a(new_n236_), .b(new_n154_), .c(x13), .O(new_n519_));
  nor2   g389(.a(new_n519_), .b(x15), .O(new_n520_));
  nand4  g390(.a(new_n520_), .b(new_n150_), .c(new_n188_), .d(new_n460_), .O(new_n521_));
  nor4   g391(.a(new_n521_), .b(x22), .c(x21), .d(x20), .O(new_n522_));
  ...
  nand4  g396(.a(new_n526_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n527_));
  ...
  nand4  g400(.a(new_n530_), .b(new_n220_), .c(new_n219_), .d(new_n141_), .O(new_n531_));
  nor2   g401(.a(new_n531_), .b(x47), .O(new_n532_));
  nand4  g402(.a(new_n532_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n533_));
  nor2   g403(.a(new_n533_), .b(x51), .O(new_n534_));
  nand4  g404(.a(new_n534_), .b(new_n134_), .c(new_n217_), .d(new_n518_), .O(new_n535_));
  ...
  nor4   g418(.a(new_n440_), .b(x24), .c(x22), .d(x21), .O(new_n549_));
  ...
  nor2   g430(.a(new_n560_), .b(new_n518_), .O(new_n561_));
  ...
  nor3   g437(.a(new_n440_), .b(x22), .c(new_n222_), .O(new_n568_));
  ...
  nand4  g448(.a(new_n578_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n579_));
  ...
  nor4   g479(.a(new_n416_), .b(x39), .c(x37), .d(x35), .O(new_n610_));
  ...
  nor3   g486(.a(new_n496_), .b(x20), .c(new_n224_), .O(new_n617_));
  ...
  nand4  g558(.a(new_n403_), .b(new_n139_), .c(new_n138_), .d(x49), .O(new_n689_));
  ...
  nand2  g665(.a(new_n407_), .b(x57), .O(new_n796_));
  ...
  and2   g669(.a(new_n403_), .b(x48), .O(new_n800_));
  ...
  nand4  g690(.a(new_n820_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n821_));
  ...
  nor3   g698(.a(new_n410_), .b(x64), .c(new_n214_), .O(z53));
  ...
  nor3   g702(.a(new_n416_), .b(x37), .c(new_n184_), .O(new_n833_));
  ...
  nor4   g709(.a(new_n438_), .b(x18), .c(x17), .d(x16), .O(new_n840_));
