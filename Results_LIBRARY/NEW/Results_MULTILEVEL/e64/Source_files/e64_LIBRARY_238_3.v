...
module FAU ( 
  ...
  nor4   g777(.a(new_n354_), .b(x28), .c(x25), .d(x24), .O(new_n908_));
  nand4  g778(.a(new_n908_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n909_));
  nor2   g779(.a(new_n909_), .b(x39), .O(new_n910_));
  nand4  g780(.a(new_n910_), .b(new_n220_), .c(new_n141_), .d(new_n144_), .O(new_n911_));
  nor2   g781(.a(new_n911_), .b(new_n137_), .O(new_n912_));
  nand4  g782(.a(new_n912_), .b(new_n216_), .c(new_n136_), .d(new_n138_), .O(new_n913_));
  nor2   g783(.a(new_n913_), .b(x60), .O(z62));
  nand4  g784(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n915_));
  nor2   g785(.a(new_n915_), .b(x24), .O(new_n916_));
  nand4  g786(.a(new_n916_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n917_));
  nor3   g787(.a(new_n917_), .b(x37), .c(x30), .O(new_n918_));
  nand4  g788(.a(new_n918_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n919_));
  nor2   g789(.a(new_n919_), .b(x46), .O(new_n920_));
  nand4  g790(.a(new_n920_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n921_));
  nor2   g791(.a(new_n921_), .b(x60), .O(z63));
  nor2   g792(.a(new_n917_), .b(new_n185_), .O(new_n923_));
  nand4  g793(.a(new_n923_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n924_));
  nor2   g794(.a(new_n924_), .b(x43), .O(new_n925_));
  nand4  g795(.a(new_n925_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n926_));
