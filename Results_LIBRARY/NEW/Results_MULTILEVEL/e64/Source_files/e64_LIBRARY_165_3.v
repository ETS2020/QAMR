...
module FAU ( 
  ...
  nand4  g295(.a(new_n425_), .b(new_n153_), .c(new_n189_), .d(new_n157_), .O(new_n426_));
  nor2   g296(.a(new_n426_), .b(x14), .O(new_n427_));
  nand4  g297(.a(new_n427_), .b(new_n151_), .c(new_n150_), .d(new_n155_), .O(new_n428_));
  nor2   g298(.a(new_n428_), .b(x24), .O(new_n429_));
  nand4  g299(.a(new_n429_), .b(new_n149_), .c(new_n148_), .d(new_n187_), .O(new_n430_));
  ...
  nand4  g303(.a(new_n433_), .b(new_n220_), .c(new_n141_), .d(new_n183_), .O(new_n434_));
  nor2   g304(.a(new_n434_), .b(x47), .O(new_n435_));
  nand4  g305(.a(new_n435_), .b(new_n132_), .c(new_n136_), .d(new_n138_), .O(new_n436_));
