...
module FAU ( 
  ...
  nor3   g410(.a(new_n354_), .b(x28), .c(new_n187_), .O(new_n541_));
  nand4  g411(.a(new_n541_), .b(new_n143_), .c(new_n142_), .d(x29), .O(new_n542_));
  nor2   g412(.a(new_n542_), .b(x40), .O(new_n543_));
  nand4  g413(.a(new_n543_), .b(new_n138_), .c(new_n220_), .d(new_n141_), .O(new_n544_));
