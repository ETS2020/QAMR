...
module FAU ( 
  ...
  nor4   g512(.a(new_n642_), .b(x28), .c(x26), .d(x25), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n184_), .c(new_n185_), .d(x29), .O(new_n644_));
  ...
  nor4   g523(.a(new_n646_), .b(x46), .c(x43), .d(new_n140_), .O(new_n654_));
  nand4  g524(.a(new_n654_), .b(new_n139_), .c(new_n138_), .d(new_n137_), .O(new_n655_));
  nor2   g525(.a(new_n655_), .b(x55), .O(new_n656_));
  nand4  g526(.a(new_n656_), .b(new_n133_), .c(new_n132_), .d(new_n136_), .O(new_n657_));
  nor2   g527(.a(new_n657_), .b(x62), .O(z39));
  nand4  g528(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(new_n158_), .O(new_n659_));
  ...
  nand4  g618(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(x09), .O(new_n749_));
  ...
  nand3  g634(.a(new_n641_), .b(new_n150_), .c(x17), .O(new_n765_));
  ...
  nor2   g698(.a(new_n614_), .b(new_n135_), .O(new_n829_));
