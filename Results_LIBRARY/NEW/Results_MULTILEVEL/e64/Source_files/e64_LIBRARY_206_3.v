...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n587_, new_n590_, new_n592_, new_n593_, new_n595_, new_n596_,
  ...
  nand3  g415(.a(new_n355_), .b(new_n144_), .c(new_n143_), .O(new_n546_));
  ...
  nor4   g420(.a(new_n440_), .b(x24), .c(x22), .d(x21), .O(new_n551_));
  ...
  nor3   g439(.a(new_n440_), .b(x22), .c(new_n222_), .O(new_n570_));
  ...
  nand4  g450(.a(new_n580_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n581_));
  ...
  nor4   g458(.a(new_n546_), .b(x58), .c(x50), .d(new_n220_), .O(z32));
