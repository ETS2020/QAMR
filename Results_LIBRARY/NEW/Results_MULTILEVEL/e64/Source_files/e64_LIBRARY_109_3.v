...
module FAU ( 
  ...
  nor3   g418(.a(new_n440_), .b(x22), .c(x21), .O(new_n549_));
  ...
  nand4  g423(.a(new_n553_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n554_));
  ...
  nand4  g427(.a(new_n557_), .b(new_n220_), .c(new_n219_), .d(new_n141_), .O(new_n558_));
  nor2   g428(.a(new_n558_), .b(x47), .O(new_n559_));
  nand4  g429(.a(new_n559_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n560_));
