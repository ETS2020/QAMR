// Benchmark "FAU" written by ABC on Mon Jul 27 19:01:33 2020
...
module FAU ( 
  ...
  nand4  g25(.a(new_n42_), .b(new_n41_), .c(new_n37_), .d(x6), .O(z5));
  ...
  nand3  g30(.a(new_n47_), .b(new_n35_), .c(new_n28_), .O(new_n48_));
