...
module FAU ( 
  ...
  nand2  g19(.a(x7), .b(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n22_), .c(new_n26_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(x2), .c(new_n28_), .O(new_n39_));
  ...
  nand3  g26(.a(new_n31_), .b(new_n20_), .c(x5), .O(new_n44_));
  ...
  nand3  g32(.a(new_n49_), .b(new_n36_), .c(new_n28_), .O(new_n50_));
  ...
  nand3  g37(.a(new_n54_), .b(new_n48_), .c(x6), .O(z6));
endmodule
