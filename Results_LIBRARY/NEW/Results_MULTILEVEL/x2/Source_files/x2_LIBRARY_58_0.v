...
module FAU ( 
  ...
  nand3  g10(.a(x9), .b(x8), .c(x2), .O(new_n29_));
  inv1   g11(.a(new_n29_), .O(new_n30_));
  nor2   g12(.a(x9), .b(x4), .O(new_n31_));
  aoi22  g13(.a(new_n31_), .b(x3), .c(new_n30_), .d(new_n25_), .O(new_n32_));
  nand3  g14(.a(x9), .b(new_n24_), .c(x5), .O(new_n33_));
  nand2  g15(.a(new_n18_), .b(new_n20_), .O(new_n34_));
  nand3  g16(.a(new_n34_), .b(new_n33_), .c(x6), .O(new_n35_));
  inv1   g17(.a(new_n35_), .O(new_n36_));
  oai21  g18(.a(new_n32_), .b(new_n24_), .c(new_n36_), .O(z5));
  nand3  g19(.a(new_n25_), .b(x9), .c(new_n23_), .O(new_n38_));
  nand4  g20(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n39_));
  nand2  g21(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand2  g22(.a(new_n40_), .b(x7), .O(new_n41_));
  inv1   g23(.a(x5), .O(new_n42_));
  oai21  g24(.a(x7), .b(new_n42_), .c(x8), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(x9), .O(new_n44_));
