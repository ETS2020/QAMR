...
module FAU ( 
  ...
  aoi21  g12(.a(x9), .b(x8), .c(x1), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .d(new_n26_), .O(z3));
  nand2  g14(.a(new_n23_), .b(x8), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n29_), .c(x6), .O(z4));
  inv1   g16(.a(x1), .O(new_n34_));
  nand3  g17(.a(x2), .b(new_n34_), .c(new_n26_), .O(new_n35_));
  nand2  g18(.a(new_n20_), .b(x5), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(x9), .c(x8), .O(new_n38_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n34_), .c(new_n26_), .O(new_n48_));
