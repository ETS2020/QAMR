// Benchmark "FAU" written by ABC on Mon Jul 27 19:02:02 2020
...
module FAU ( 
  ...
  oai21  g11(.a(new_n18_), .b(new_n25_), .c(x7), .O(new_n29_));
  oai21  g12(.a(x9), .b(new_n25_), .c(new_n20_), .O(new_n30_));
  ...
  nand3  g17(.a(new_n34_), .b(new_n30_), .c(x6), .O(z4));
  inv1   g18(.a(x1), .O(new_n36_));
  oai21  g19(.a(new_n22_), .b(new_n20_), .c(new_n26_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(x2), .c(new_n36_), .d(new_n28_), .O(new_n38_));
  ...
  aoi21  g28(.a(new_n45_), .b(new_n31_), .c(new_n43_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n42_), .c(new_n38_), .O(z5));
  nand2  g30(.a(new_n18_), .b(new_n25_), .O(new_n48_));
  oai21  g31(.a(new_n22_), .b(new_n44_), .c(new_n48_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  inv1   g33(.a(x2), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n36_), .c(new_n28_), .O(new_n52_));
