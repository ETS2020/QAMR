// Benchmark "FAU" written by ABC on Mon Jul 27 19:01:58 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n48_), .b(new_n34_), .c(new_n33_), .O(new_n49_));
  nand4  g32(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n49_), .c(new_n47_), .O(new_n51_));
