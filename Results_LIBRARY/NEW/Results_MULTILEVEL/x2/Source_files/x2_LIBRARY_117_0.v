...
module FAU ( 
  ...
  nand4  g14(.a(new_n23_), .b(new_n31_), .c(new_n30_), .d(new_n29_), .O(z3));
  oai21  g15(.a(x9), .b(new_n25_), .c(x8), .O(new_n33_));
  oai21  g16(.a(x9), .b(new_n26_), .c(new_n25_), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(x6), .O(z4));
  nand2  g18(.a(x7), .b(x2), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n21_), .c(new_n27_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n30_), .c(new_n29_), .O(new_n38_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n47_), .c(x6), .O(z6));
endmodule
