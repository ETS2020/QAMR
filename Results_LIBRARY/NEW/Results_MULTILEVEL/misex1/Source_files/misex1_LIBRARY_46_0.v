// Benchmark "FAU" written by ABC on Mon Jul 27 17:10:02 2020
...
module FAU ( 
  ...
  nand3  g27(.a(x2), .b(new_n19_), .c(x0), .O(new_n43_));
  ...
  nand4  g48(.a(new_n52_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n64_));
