...
module FAU ( 
  ...
  oai21  g12(.a(new_n27_), .b(x3), .c(x1), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n25_), .c(x2), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(new_n24_), .c(new_n17_), .O(new_n30_));
  ...
  oai21  g20(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n36_));
  ...
  nor2   g41(.a(new_n25_), .b(x2), .O(new_n57_));
  ...
  nand3  g47(.a(new_n44_), .b(x2), .c(new_n17_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n51_), .c(new_n19_), .O(new_n65_));
