// Benchmark "FAU" written by ABC on Mon Jul 27 17:09:58 2020
...
module FAU ( 
  ...
  aoi21  g21(.a(new_n36_), .b(new_n19_), .c(new_n32_), .O(new_n37_));
  ...
  oai21  g34(.a(new_n35_), .b(x3), .c(new_n25_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n17_), .c(new_n49_), .O(new_n51_));
  aoi21  g36(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n52_));
  ...
  oai21  g42(.a(new_n57_), .b(new_n49_), .c(new_n19_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z5));
  nand3  g44(.a(new_n42_), .b(x2), .c(new_n17_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n49_), .c(new_n19_), .O(new_n62_));
