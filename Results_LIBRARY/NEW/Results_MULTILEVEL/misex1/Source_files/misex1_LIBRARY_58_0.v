...
module FAU ( 
  ...
  aoi21  g24(.a(new_n38_), .b(x1), .c(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x0), .c(new_n36_), .O(z2));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n16_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n33_), .b(x2), .c(new_n18_), .O(new_n44_));
  ...
  nor2   g38(.a(x3), .b(x2), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n20_), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n53_), .O(z4));
  nor2   g41(.a(new_n27_), .b(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n51_), .c(new_n18_), .O(new_n58_));
  aoi21  g43(.a(x4), .b(new_n16_), .c(x3), .O(new_n59_));
  nand3  g44(.a(x6), .b(new_n19_), .c(new_n16_), .O(new_n60_));
  ...
  oai21  g49(.a(new_n51_), .b(new_n64_), .c(new_n18_), .O(new_n65_));
