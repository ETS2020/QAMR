...
module FAU ( 
  ...
  aoi21  g20(.a(new_n35_), .b(new_n19_), .c(new_n31_), .O(new_n36_));
  ...
  oai21  g25(.a(x2), .b(new_n19_), .c(new_n40_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n17_), .O(new_n42_));
  nand2  g27(.a(new_n20_), .b(x2), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n38_), .c(new_n42_), .O(z3));
  nand2  g29(.a(x3), .b(new_n16_), .O(new_n45_));
  aoi21  g30(.a(new_n43_), .b(new_n45_), .c(new_n17_), .O(new_n46_));
  oai21  g31(.a(new_n34_), .b(x3), .c(new_n25_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n17_), .c(new_n46_), .O(new_n48_));
  aoi21  g33(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n49_));
  nand3  g34(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n49_), .c(new_n17_), .O(new_n52_));
  oai21  g37(.a(new_n48_), .b(x1), .c(new_n52_), .O(z4));
  nor2   g38(.a(new_n25_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n46_), .c(new_n19_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n52_), .O(z5));
  nand3  g41(.a(new_n39_), .b(x2), .c(new_n17_), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n46_), .c(new_n19_), .O(new_n59_));
