...
module FAU ( 
  ...
  oai21  g12(.a(new_n27_), .b(new_n24_), .c(new_n17_), .O(new_n28_));
  ...
  oai21  g24(.a(new_n39_), .b(x0), .c(new_n35_), .O(z2));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n16_), .c(x1), .O(new_n42_));
  nand3  g27(.a(new_n32_), .b(x2), .c(new_n19_), .O(new_n43_));
