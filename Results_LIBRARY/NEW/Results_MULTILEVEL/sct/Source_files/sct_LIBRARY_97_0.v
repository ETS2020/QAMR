// Benchmark "FAU" written by ABC on Mon Jul 27 19:28:58 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n56_), .b(x14), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(x04), .c(new_n35_), .O(new_n58_));
  ...
  nor2   g29(.a(new_n56_), .b(new_n63_), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  and2   g31(.a(new_n65_), .b(new_n62_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n60_), .c(new_n58_), .d(x04), .O(z05));
  nor2   g33(.a(x10), .b(x09), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n51_), .c(x08), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n65_), .c(x04), .O(new_n70_));
  aoi21  g36(.a(new_n62_), .b(x10), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n58_), .O(z06));
  ...
  and2   g43(.a(new_n77_), .b(new_n65_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n73_), .c(new_n58_), .d(x04), .O(z07));
  inv1   g45(.a(x12), .O(new_n80_));
  nand4  g46(.a(new_n68_), .b(new_n76_), .c(new_n80_), .d(new_n75_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n65_), .c(x04), .O(new_n82_));
  aoi21  g48(.a(new_n77_), .b(x12), .c(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n58_), .O(z08));
  nand2  g50(.a(new_n57_), .b(new_n35_), .O(new_n85_));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n44_), .b(new_n86_), .c(new_n80_), .d(new_n75_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n61_), .c(x08), .d(x07), .O(new_n89_));
  oai21  g55(.a(new_n89_), .b(new_n43_), .c(new_n85_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(new_n65_), .b(x04), .O(new_n92_));
  aoi21  g58(.a(new_n81_), .b(x13), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n91_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand4  g61(.a(new_n86_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n98_));
  inv1   g64(.a(new_n98_), .O(new_n99_));
  nand3  g65(.a(new_n99_), .b(x07), .c(x06), .O(new_n100_));
  inv1   g66(.a(new_n44_), .O(new_n101_));
  nand2  g67(.a(new_n101_), .b(x14), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n100_), .c(new_n40_), .O(z10));
  aoi21  g69(.a(new_n85_), .b(new_n63_), .c(new_n40_), .O(z12));
