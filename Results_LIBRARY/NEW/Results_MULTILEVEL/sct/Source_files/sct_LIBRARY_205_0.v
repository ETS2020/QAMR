// Benchmark "FAU" written by ABC on Mon Jul 27 19:29:18 2020
...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n61_), .d(new_n58_), .O(z08));
  ...
  nand4  g45(.a(new_n79_), .b(new_n59_), .c(x08), .d(x07), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n43_), .c(x02), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n61_), .b(x04), .O(new_n83_));
  aoi21  g49(.a(new_n75_), .b(x13), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n82_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand4  g52(.a(new_n77_), .b(new_n74_), .c(new_n69_), .d(new_n68_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n44_), .c(new_n59_), .d(x08), .O(new_n89_));
  inv1   g55(.a(new_n89_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(x07), .c(x06), .O(new_n91_));
  nand2  g57(.a(new_n61_), .b(x02), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n40_), .O(z10));
  inv1   g60(.a(x03), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(x02), .c(new_n40_), .O(z12));
