...
module FAU ( 
  ...
  inv1   g09(.a(x08), .O(new_n44_));
  inv1   g10(.a(x12), .O(new_n45_));
  ...
  nand3  g16(.a(new_n46_), .b(new_n50_), .c(x06), .O(new_n51_));
  ...
  nor2   g20(.a(new_n44_), .b(x07), .O(new_n55_));
  nor2   g21(.a(x08), .b(new_n50_), .O(new_n56_));
  oai21  g22(.a(new_n56_), .b(new_n55_), .c(x06), .O(new_n57_));
  oai21  g23(.a(new_n44_), .b(x06), .c(new_n57_), .O(new_n58_));
  ...
  nor2   g32(.a(new_n50_), .b(new_n43_), .O(new_n67_));
  ...
  nand4  g37(.a(new_n67_), .b(new_n71_), .c(new_n66_), .d(x08), .O(new_n72_));
  ...
  or2    g42(.a(new_n76_), .b(new_n64_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n63_), .d(x04), .O(z07));
  nor2   g44(.a(new_n45_), .b(x07), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n56_), .c(x06), .O(new_n80_));
  oai21  g46(.a(new_n45_), .b(x06), .c(new_n80_), .O(new_n81_));
  inv1   g47(.a(x16), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x02), .O(new_n83_));
  aoi21  g49(.a(new_n81_), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n76_), .b(x12), .O(new_n85_));
  nor3   g51(.a(x12), .b(x11), .c(x10), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n66_), .c(x07), .d(x06), .O(new_n87_));
  nand2  g53(.a(x16), .b(x03), .O(new_n88_));
  and2   g54(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n85_), .c(new_n84_), .d(x04), .O(z08));
  inv1   g56(.a(new_n83_), .O(new_n91_));
  inv1   g57(.a(x11), .O(new_n92_));
  inv1   g58(.a(x13), .O(new_n93_));
  nand4  g59(.a(new_n47_), .b(new_n93_), .c(new_n45_), .d(new_n92_), .O(new_n94_));
  nor2   g60(.a(new_n94_), .b(x10), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(new_n66_), .c(x07), .d(x06), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n91_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(x04), .O(new_n98_));
  nand2  g64(.a(new_n88_), .b(x04), .O(new_n99_));
  aoi21  g65(.a(new_n87_), .b(x13), .c(new_n99_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(new_n98_), .O(z09));
  inv1   g67(.a(new_n47_), .O(new_n102_));
  nand2  g68(.a(x08), .b(x00), .O(new_n103_));
  nand3  g69(.a(new_n75_), .b(new_n93_), .c(new_n45_), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(new_n105_));
  nand4  g71(.a(new_n105_), .b(new_n66_), .c(x07), .d(x06), .O(new_n106_));
