...
module FAU ( 
  ...
  nand4  g39(.a(new_n44_), .b(new_n73_), .c(new_n69_), .d(new_n65_), .O(new_n74_));
  ...
  aoi21  g47(.a(new_n71_), .b(x12), .c(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n79_), .O(z08));
  aoi21  g49(.a(x16), .b(x03), .c(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n77_), .c(new_n76_), .d(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n73_), .b(new_n69_), .c(new_n65_), .O(new_n87_));
  ...
  aoi21  g60(.a(new_n77_), .b(new_n56_), .c(new_n40_), .O(z12));
