...
module FAU ( 
  ...
  nand3  g23(.a(new_n57_), .b(new_n44_), .c(x07), .O(new_n58_));
  nand2  g24(.a(x16), .b(new_n35_), .O(new_n59_));
  inv1   g25(.a(x07), .O(new_n60_));
  aoi22  g26(.a(x16), .b(x03), .c(x09), .d(new_n60_), .O(new_n61_));
  nand4  g27(.a(new_n61_), .b(new_n59_), .c(new_n58_), .d(x04), .O(z05));
  inv1   g28(.a(x16), .O(new_n63_));
  aoi21  g29(.a(x04), .b(new_n35_), .c(x03), .O(new_n64_));
  nor2   g30(.a(x10), .b(new_n40_), .O(new_n65_));
  oai21  g31(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  nor2   g32(.a(x11), .b(new_n40_), .O(new_n67_));
  oai21  g33(.a(new_n64_), .b(new_n63_), .c(new_n67_), .O(z07));
  nor2   g34(.a(x12), .b(new_n40_), .O(new_n69_));
  oai21  g35(.a(new_n64_), .b(new_n63_), .c(new_n69_), .O(z08));
  nor2   g36(.a(x13), .b(new_n40_), .O(new_n71_));
  oai21  g37(.a(new_n64_), .b(new_n63_), .c(new_n71_), .O(z09));
  inv1   g38(.a(x03), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x02), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(x16), .c(x14), .d(x04), .O(new_n75_));
  inv1   g41(.a(new_n75_), .O(z10));
  aoi21  g42(.a(new_n59_), .b(new_n73_), .c(new_n40_), .O(z12));
  and2   g43(.a(x17), .b(x04), .O(z14));
  buf1   g44(.a(x02), .O(z11));
  buf1   g45(.a(x04), .O(z13));
endmodule
