...
module FAU ( 
  ...
  nand4  g13(.a(new_n44_), .b(new_n47_), .c(x06), .d(x04), .O(new_n48_));
  ...
  nand4  g43(.a(new_n77_), .b(new_n58_), .c(x08), .d(x07), .O(new_n78_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n58_), .c(x08), .d(x07), .O(new_n90_));
