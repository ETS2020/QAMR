...
module FAU ( 
  ...
  nand3  g10(.a(new_n44_), .b(new_n43_), .c(x02), .O(new_n45_));
  aoi21  g11(.a(new_n45_), .b(x16), .c(new_n40_), .O(z02));
  xor2a  g12(.a(x07), .b(x06), .O(new_n47_));
  nand3  g13(.a(new_n47_), .b(new_n43_), .c(x02), .O(new_n48_));
  inv1   g14(.a(x16), .O(new_n49_));
  nand2  g15(.a(new_n49_), .b(x07), .O(new_n50_));
  aoi21  g16(.a(new_n50_), .b(new_n48_), .c(new_n40_), .O(z03));
  ...
  nand3  g21(.a(new_n55_), .b(new_n43_), .c(x02), .O(new_n56_));
  nand2  g22(.a(new_n49_), .b(x08), .O(new_n57_));
  ...
  nand3  g33(.a(new_n67_), .b(new_n53_), .c(x08), .O(new_n68_));
  ...
  nand2  g45(.a(new_n43_), .b(x02), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n61_), .O(new_n81_));
  nor3   g47(.a(x13), .b(x12), .c(x11), .O(new_n82_));
  and2   g48(.a(new_n82_), .b(new_n67_), .O(new_n83_));
  ...
  nand4  g55(.a(new_n89_), .b(new_n77_), .c(new_n72_), .d(new_n71_), .O(new_n90_));
  ...
  nand3  g60(.a(new_n80_), .b(x16), .c(x14), .O(new_n95_));
