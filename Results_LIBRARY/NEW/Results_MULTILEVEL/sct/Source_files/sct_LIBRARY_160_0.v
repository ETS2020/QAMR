// Benchmark "FAU" written by ABC on Mon Jul 27 19:29:09 2020
...
module FAU ( 
  ...
  nand4  g44(.a(new_n44_), .b(new_n78_), .c(new_n75_), .d(new_n70_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(x10), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n61_), .c(x08), .d(x07), .O(new_n81_));
  nand2  g47(.a(x16), .b(new_n35_), .O(new_n82_));
  oai21  g48(.a(new_n81_), .b(new_n43_), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g55(.a(new_n78_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x07), .c(x06), .O(new_n94_));
  inv1   g60(.a(new_n44_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(x14), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n94_), .c(new_n40_), .O(z10));
  aoi21  g63(.a(new_n82_), .b(new_n56_), .c(new_n40_), .O(z12));
