...
module FAU ( 
  ...
  aoi21  g10(.a(x07), .b(new_n35_), .c(x03), .O(new_n45_));
  oai21  g11(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(new_n46_));
  nor2   g12(.a(new_n46_), .b(new_n40_), .O(z02));
  ...
  nor2   g18(.a(x07), .b(new_n43_), .O(new_n53_));
  oai21  g19(.a(new_n53_), .b(new_n52_), .c(new_n48_), .O(new_n54_));
  oai21  g20(.a(new_n53_), .b(new_n50_), .c(new_n44_), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n54_), .c(new_n40_), .O(z03));
  inv1   g22(.a(x08), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(x07), .c(x06), .O(new_n58_));
  oai21  g24(.a(new_n57_), .b(x06), .c(new_n58_), .O(new_n59_));
  oai21  g25(.a(x03), .b(new_n35_), .c(x16), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g27(.a(x16), .b(x03), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(x08), .c(new_n49_), .O(new_n63_));
  aoi21  g29(.a(new_n63_), .b(new_n61_), .c(new_n40_), .O(z04));
  oai21  g30(.a(new_n40_), .b(x02), .c(new_n48_), .O(new_n65_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n66_), .d(x04), .O(z07));
  ...
  nand4  g50(.a(new_n84_), .b(new_n82_), .c(new_n66_), .d(x04), .O(z08));
  inv1   g51(.a(x13), .O(new_n86_));
  nand4  g52(.a(new_n60_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n87_));
  nor2   g53(.a(new_n87_), .b(x10), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n69_), .c(x08), .d(x07), .O(new_n89_));
  nand2  g55(.a(x16), .b(new_n35_), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n43_), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  nand2  g58(.a(new_n62_), .b(x04), .O(new_n93_));
  aoi21  g59(.a(new_n84_), .b(x13), .c(new_n93_), .O(new_n94_));
  ...
  nand4  g64(.a(new_n98_), .b(new_n60_), .c(new_n69_), .d(x08), .O(new_n99_));
  inv1   g65(.a(new_n99_), .O(new_n100_));
  nand3  g66(.a(new_n100_), .b(x07), .c(x06), .O(new_n101_));
  inv1   g67(.a(new_n60_), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n101_), .c(new_n40_), .O(z10));
  aoi21  g70(.a(new_n90_), .b(new_n48_), .c(new_n40_), .O(z12));
  and2   g71(.a(x17), .b(x04), .O(z14));
  buf1   g72(.a(x02), .O(z11));
  buf1   g73(.a(x04), .O(z13));
endmodule
