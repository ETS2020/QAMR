...
module FAU ( 
  ...
  nand3  g36(.a(new_n70_), .b(new_n56_), .c(x08), .O(new_n71_));
  ...
  oai21  g44(.a(new_n45_), .b(x06), .c(new_n51_), .O(new_n79_));
  inv1   g45(.a(x16), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(x02), .O(new_n81_));
  aoi21  g47(.a(new_n79_), .b(new_n47_), .c(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n76_), .b(new_n66_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x12), .O(new_n84_));
  nor3   g50(.a(x12), .b(x11), .c(x10), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n66_), .c(x06), .O(new_n86_));
  nand2  g52(.a(x16), .b(x03), .O(new_n87_));
  and2   g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n84_), .c(new_n82_), .d(x04), .O(z08));
  inv1   g55(.a(new_n81_), .O(new_n90_));
  inv1   g56(.a(x11), .O(new_n91_));
  inv1   g57(.a(x13), .O(new_n92_));
  nand4  g58(.a(new_n47_), .b(new_n92_), .c(new_n45_), .d(new_n91_), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x10), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n74_), .c(x08), .d(x06), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n90_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g63(.a(new_n87_), .b(x04), .O(new_n98_));
  aoi21  g64(.a(new_n86_), .b(x13), .c(new_n98_), .O(new_n99_));
  nand2  g65(.a(new_n99_), .b(new_n97_), .O(z09));
  inv1   g66(.a(new_n47_), .O(new_n101_));
  nand2  g67(.a(x07), .b(x00), .O(new_n102_));
  nand3  g68(.a(new_n76_), .b(new_n92_), .c(new_n45_), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand4  g70(.a(new_n104_), .b(new_n74_), .c(x08), .d(x06), .O(new_n105_));
  nand2  g71(.a(new_n101_), .b(x14), .O(new_n106_));
  aoi21  g72(.a(new_n106_), .b(new_n105_), .c(new_n40_), .O(z10));
  aoi21  g73(.a(new_n90_), .b(new_n61_), .c(new_n40_), .O(z12));
  and2   g74(.a(x17), .b(x04), .O(z14));
  buf1   g75(.a(x02), .O(z11));
  buf1   g76(.a(x04), .O(z13));
endmodule
