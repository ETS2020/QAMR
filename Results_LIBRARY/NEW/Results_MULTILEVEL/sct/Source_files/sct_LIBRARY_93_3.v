// Benchmark "FAU" written by ABC on Mon Jul 27 19:28:57 2020
...
module FAU ( 
  ...
  nand3  g44(.a(x16), .b(new_n56_), .c(x02), .O(new_n79_));
  inv1   g45(.a(x16), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n78_), .c(new_n75_), .d(new_n69_), .O(new_n83_));
  ...
  oai21  g54(.a(new_n80_), .b(new_n56_), .c(x04), .O(new_n89_));
  aoi21  g55(.a(new_n76_), .b(x13), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n88_), .O(z09));
  nand2  g57(.a(new_n44_), .b(x00), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n83_), .c(x09), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n86_), .b(new_n56_), .c(new_n40_), .O(z12));
