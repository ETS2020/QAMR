...
module FAU ( 
  ...
  nand2  g09(.a(x16), .b(x03), .O(new_n44_));
  ...
  nand3  g24(.a(new_n51_), .b(new_n58_), .c(x08), .O(new_n59_));
  nand4  g25(.a(new_n59_), .b(new_n57_), .c(new_n44_), .d(x04), .O(z05));
  nand2  g26(.a(new_n59_), .b(x10), .O(new_n61_));
  nor2   g27(.a(x10), .b(x09), .O(new_n62_));
  nand3  g28(.a(new_n62_), .b(new_n51_), .c(x08), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n61_), .c(new_n44_), .d(x04), .O(z06));
  ...
  nand4  g35(.a(new_n69_), .b(new_n65_), .c(new_n44_), .d(x04), .O(z07));
  ...
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n44_), .d(x04), .O(z08));
  inv1   g40(.a(x13), .O(new_n75_));
  nand4  g41(.a(new_n44_), .b(new_n75_), .c(new_n72_), .d(new_n67_), .O(new_n76_));
  nor3   g42(.a(new_n76_), .b(x10), .c(x09), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(x08), .c(x07), .d(x06), .O(new_n78_));
  nand2  g44(.a(new_n73_), .b(x13), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n44_), .d(x04), .O(z09));
  inv1   g46(.a(x00), .O(new_n81_));
  nand4  g47(.a(new_n75_), .b(new_n72_), .c(new_n67_), .d(new_n66_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n44_), .c(new_n58_), .d(x08), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(x07), .c(x06), .O(new_n86_));
  nand3  g52(.a(x16), .b(x14), .c(x03), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(z10));
  and2   g54(.a(x04), .b(x03), .O(z12));
  and2   g55(.a(x17), .b(x04), .O(z14));
  buf1   g56(.a(x02), .O(z11));
  buf1   g57(.a(x04), .O(z13));
endmodule
