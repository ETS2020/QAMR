...
module FAU ( 
  ...
  nand4  g16(.a(new_n50_), .b(new_n46_), .c(new_n43_), .d(x04), .O(new_n51_));
  ...
  nor2   g22(.a(new_n44_), .b(new_n43_), .O(new_n57_));
  ...
  oai21  g27(.a(new_n40_), .b(x02), .c(new_n47_), .O(new_n62_));
  ...
  nand3  g36(.a(new_n70_), .b(new_n57_), .c(x08), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n63_), .d(x04), .O(z06));
  ...
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n63_), .d(x04), .O(z07));
  ...
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n63_), .d(x04), .O(z08));
  nand3  g48(.a(new_n74_), .b(new_n66_), .c(x08), .O(new_n83_));
  nand3  g49(.a(new_n45_), .b(new_n80_), .c(new_n75_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n83_), .c(x07), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x06), .O(new_n86_));
  nand2  g52(.a(x13), .b(new_n43_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nor2   g54(.a(new_n48_), .b(x02), .O(new_n89_));
  aoi21  g55(.a(new_n88_), .b(new_n50_), .c(new_n89_), .O(new_n90_));
  nand2  g56(.a(new_n66_), .b(x08), .O(new_n91_));
  nand3  g57(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(new_n92_));
  ...
  nand2  g61(.a(x07), .b(x00), .O(new_n96_));
  nand4  g62(.a(new_n45_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n49_), .O(new_n98_));
  nand4  g64(.a(new_n98_), .b(new_n66_), .c(x08), .d(x06), .O(new_n99_));
  nand2  g65(.a(new_n49_), .b(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n40_), .O(z10));
  inv1   g67(.a(new_n89_), .O(new_n102_));
  aoi21  g68(.a(new_n102_), .b(new_n47_), .c(new_n40_), .O(z12));
  and2   g69(.a(x17), .b(x04), .O(z14));
  buf1   g70(.a(x02), .O(z11));
  buf1   g71(.a(x04), .O(z13));
endmodule
