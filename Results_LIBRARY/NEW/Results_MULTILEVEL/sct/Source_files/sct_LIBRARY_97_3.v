...
module FAU ( 
  ...
  and2   g57(.a(new_n91_), .b(new_n44_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n61_), .c(x08), .d(x07), .O(new_n93_));
  nor3   g59(.a(new_n93_), .b(new_n43_), .c(new_n40_), .O(z10));
  aoi21  g60(.a(new_n82_), .b(new_n56_), .c(new_n40_), .O(z12));
