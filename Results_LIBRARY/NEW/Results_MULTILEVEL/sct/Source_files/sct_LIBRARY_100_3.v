...
module FAU ( 
  ...
  nand3  g46(.a(x16), .b(new_n44_), .c(x02), .O(new_n81_));
  nand2  g47(.a(new_n45_), .b(new_n63_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n80_), .c(new_n77_), .d(new_n72_), .O(new_n84_));
  ...
  oai21  g55(.a(new_n45_), .b(new_n44_), .c(x04), .O(new_n90_));
  aoi21  g56(.a(new_n78_), .b(x13), .c(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n89_), .O(z09));
  inv1   g58(.a(x00), .O(new_n93_));
  nand4  g59(.a(new_n80_), .b(new_n77_), .c(new_n72_), .d(new_n71_), .O(new_n94_));
  aoi22  g60(.a(new_n94_), .b(new_n93_), .c(new_n82_), .d(new_n81_), .O(new_n95_));
  nand4  g61(.a(new_n95_), .b(x08), .c(x07), .d(x06), .O(new_n96_));
  nand2  g62(.a(new_n46_), .b(x14), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n96_), .c(new_n40_), .O(z10));
  aoi21  g64(.a(new_n87_), .b(new_n44_), .c(new_n40_), .O(z12));
