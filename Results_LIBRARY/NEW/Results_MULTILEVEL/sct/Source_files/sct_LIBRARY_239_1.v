...
module FAU ( 
  ...
  nand2  g47(.a(new_n76_), .b(x13), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n58_), .c(x04), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  oai21  g50(.a(new_n81_), .b(new_n43_), .c(new_n84_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand4  g52(.a(new_n78_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n86_), .c(new_n47_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n61_), .c(x08), .d(x07), .O(new_n89_));
  nand3  g55(.a(new_n47_), .b(x14), .c(x04), .O(new_n90_));
  oai21  g56(.a(new_n89_), .b(new_n43_), .c(new_n90_), .O(z10));
  inv1   g57(.a(x16), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(x02), .c(new_n56_), .O(new_n93_));
  and2   g59(.a(new_n93_), .b(x04), .O(z12));
  nand2  g60(.a(x07), .b(x06), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n44_), .c(new_n93_), .O(new_n96_));
  oai21  g62(.a(new_n96_), .b(new_n40_), .c(new_n49_), .O(z13));
