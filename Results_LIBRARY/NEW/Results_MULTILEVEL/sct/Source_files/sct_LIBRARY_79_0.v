...
module FAU ( 
  ...
  nand4  g34(.a(new_n51_), .b(new_n68_), .c(new_n56_), .d(x08), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n66_), .d(x04), .O(z06));
  nand2  g36(.a(new_n57_), .b(x04), .O(new_n71_));
  ...
  aoi21  g41(.a(new_n75_), .b(new_n74_), .c(new_n40_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n73_), .c(new_n66_), .O(z07));
  inv1   g43(.a(x11), .O(new_n78_));
  nand2  g44(.a(new_n71_), .b(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(x12), .O(new_n80_));
  aoi21  g46(.a(new_n78_), .b(x10), .c(new_n40_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(new_n66_), .O(z08));
  nor2   g48(.a(x13), .b(new_n40_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n66_), .O(z09));
  nand4  g50(.a(new_n44_), .b(new_n56_), .c(x08), .d(x07), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(x06), .c(x00), .O(new_n87_));
  inv1   g53(.a(x14), .O(new_n88_));
  or2    g54(.a(new_n44_), .b(new_n88_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n87_), .c(new_n40_), .O(z10));
  aoi21  g56(.a(new_n58_), .b(new_n64_), .c(new_n40_), .O(z12));
  nor2   g57(.a(x12), .b(x11), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n57_), .c(new_n40_), .O(z13));
