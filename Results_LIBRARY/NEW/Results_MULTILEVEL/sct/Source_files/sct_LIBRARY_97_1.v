...
module FAU ( 
  ...
  or2    g42(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nand2  g43(.a(new_n73_), .b(x13), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n44_), .d(x04), .O(z09));
  inv1   g45(.a(x00), .O(new_n80_));
  aoi21  g46(.a(new_n76_), .b(new_n80_), .c(x09), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(x08), .c(x07), .d(x06), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n44_), .c(new_n40_), .O(z10));
  aoi21  g49(.a(x16), .b(new_n35_), .c(x03), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(new_n40_), .O(z12));
  and2   g51(.a(x17), .b(x04), .O(z14));
  buf1   g52(.a(x02), .O(z11));
  buf1   g53(.a(x04), .O(z13));
endmodule
