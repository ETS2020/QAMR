...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n44_), .c(x07), .O(new_n66_));
  aoi22  g32(.a(x16), .b(new_n35_), .c(x10), .d(x09), .O(new_n67_));
  aoi22  g33(.a(x16), .b(x03), .c(x10), .d(new_n50_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n67_), .c(new_n66_), .d(x04), .O(z06));
  inv1   g35(.a(x03), .O(new_n70_));
  oai21  g36(.a(new_n40_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x16), .O(new_n72_));
  nor2   g38(.a(x11), .b(new_n40_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(z07));
  nor2   g40(.a(x12), .b(new_n40_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n72_), .O(z08));
  nor2   g42(.a(x13), .b(new_n40_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n72_), .O(z09));
  nand4  g44(.a(new_n44_), .b(new_n57_), .c(x08), .d(x07), .O(new_n79_));
  inv1   g45(.a(new_n79_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(x06), .c(x00), .O(new_n81_));
  inv1   g47(.a(x14), .O(new_n82_));
  or2    g48(.a(new_n44_), .b(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n81_), .c(new_n40_), .O(z10));
  aoi21  g50(.a(new_n59_), .b(new_n70_), .c(new_n40_), .O(z12));
  nand3  g51(.a(x08), .b(x07), .c(x06), .O(new_n86_));
  nand3  g52(.a(new_n67_), .b(new_n58_), .c(new_n70_), .O(new_n87_));
  aoi21  g53(.a(new_n86_), .b(new_n44_), .c(new_n87_), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(new_n40_), .O(z13));
