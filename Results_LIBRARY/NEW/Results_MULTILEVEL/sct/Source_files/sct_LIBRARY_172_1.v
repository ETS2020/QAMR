...
module FAU ( 
  ...
  nor2   g14(.a(new_n48_), .b(x06), .O(z02));
  xnor2a g15(.a(x07), .b(x06), .O(new_n50_));
  nor2   g16(.a(new_n50_), .b(new_n48_), .O(z03));
  ...
  aoi21  g21(.a(new_n55_), .b(new_n53_), .c(new_n48_), .O(z04));
  ...
  nand3  g27(.a(new_n61_), .b(new_n60_), .c(x08), .O(new_n62_));
  nand4  g28(.a(new_n62_), .b(new_n59_), .c(new_n57_), .d(x04), .O(z05));
  nand2  g29(.a(new_n62_), .b(x10), .O(new_n64_));
  nor2   g30(.a(x10), .b(x09), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n61_), .c(x08), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n64_), .c(new_n57_), .d(x04), .O(z06));
  nand2  g33(.a(new_n66_), .b(x11), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  inv1   g35(.a(x11), .O(new_n70_));
  inv1   g36(.a(new_n58_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n60_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n68_), .c(new_n57_), .d(x04), .O(z07));
  ...
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n57_), .d(x04), .O(z08));
  inv1   g43(.a(x06), .O(new_n78_));
  inv1   g44(.a(x13), .O(new_n79_));
  nand4  g45(.a(new_n47_), .b(new_n79_), .c(new_n75_), .d(new_n70_), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(x10), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n60_), .c(x08), .d(x07), .O(new_n82_));
  nand2  g48(.a(new_n76_), .b(x13), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n57_), .c(x04), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  oai21  g51(.a(new_n82_), .b(new_n78_), .c(new_n85_), .O(z09));
  inv1   g52(.a(x14), .O(new_n87_));
  inv1   g53(.a(x00), .O(new_n88_));
  nand4  g54(.a(new_n79_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n89_));
  aoi22  g55(.a(new_n89_), .b(new_n88_), .c(new_n46_), .d(new_n44_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n60_), .c(x08), .d(x07), .O(new_n91_));
  oai22  g57(.a(new_n91_), .b(new_n78_), .c(new_n57_), .d(new_n87_), .O(z10));
  oai22  g58(.a(new_n45_), .b(x02), .c(new_n40_), .d(new_n43_), .O(z12));
