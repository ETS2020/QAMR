...
module FAU ( 
  ...
  aoi21  g28(.a(new_n62_), .b(x09), .c(new_n40_), .O(new_n63_));
  nand3  g29(.a(new_n63_), .b(new_n61_), .c(new_n58_), .O(z05));
  nand3  g30(.a(new_n52_), .b(new_n57_), .c(x08), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(x10), .O(new_n66_));
  inv1   g32(.a(x10), .O(new_n67_));
  nand4  g33(.a(new_n52_), .b(new_n67_), .c(new_n57_), .d(x08), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n61_), .d(x04), .O(z06));
  aoi21  g35(.a(x11), .b(new_n67_), .c(x09), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(x08), .c(x07), .d(x06), .O(new_n71_));
  nand2  g37(.a(new_n65_), .b(x11), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n61_), .d(x04), .O(z07));
  inv1   g39(.a(x11), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n57_), .c(x08), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n51_), .c(x12), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  inv1   g43(.a(new_n62_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n74_), .d(new_n57_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n61_), .d(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n44_), .b(new_n81_), .c(new_n77_), .d(new_n74_), .O(new_n82_));
  ...
  nand3  g58(.a(new_n81_), .b(new_n77_), .c(new_n74_), .O(new_n93_));
  ...
  aoi21  g66(.a(new_n85_), .b(new_n59_), .c(new_n40_), .O(z12));
