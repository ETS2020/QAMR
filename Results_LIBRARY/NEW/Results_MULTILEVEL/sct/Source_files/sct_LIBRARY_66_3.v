...
module FAU ( 
  ...
  nand2  g28(.a(new_n56_), .b(x10), .O(new_n63_));
  inv1   g29(.a(x10), .O(new_n64_));
  nand3  g30(.a(new_n51_), .b(new_n64_), .c(x08), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n63_), .c(new_n62_), .d(x04), .O(z06));
  nand2  g32(.a(new_n65_), .b(x11), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n51_), .b(new_n68_), .c(new_n64_), .d(x08), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n62_), .d(x04), .O(z07));
  nand2  g36(.a(new_n69_), .b(x12), .O(new_n71_));
  inv1   g37(.a(x12), .O(new_n72_));
  inv1   g38(.a(new_n56_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n68_), .d(new_n64_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n62_), .d(x04), .O(z08));
  ...
  nand2  g45(.a(new_n79_), .b(new_n57_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  nand2  g47(.a(new_n58_), .b(x04), .O(new_n82_));
  aoi21  g48(.a(new_n74_), .b(x13), .c(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n81_), .O(z09));
  inv1   g50(.a(x00), .O(new_n85_));
  inv1   g51(.a(new_n44_), .O(new_n86_));
  nand4  g52(.a(new_n76_), .b(new_n72_), .c(new_n68_), .d(new_n64_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n85_), .c(new_n86_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(x08), .c(x07), .d(x06), .O(new_n89_));
  nand2  g55(.a(new_n86_), .b(x14), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n40_), .O(z10));
  aoi21  g57(.a(new_n57_), .b(new_n60_), .c(new_n40_), .O(z12));
  nand3  g58(.a(x08), .b(x07), .c(x06), .O(new_n93_));
  nand3  g59(.a(new_n57_), .b(new_n56_), .c(new_n60_), .O(new_n94_));
  aoi21  g60(.a(new_n93_), .b(new_n44_), .c(new_n94_), .O(new_n95_));
