...
module FAU ( 
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n64_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n64_), .d(x04), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n56_), .b(new_n85_), .c(new_n82_), .d(new_n77_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n67_), .c(x08), .d(x06), .O(new_n88_));
  nand2  g54(.a(x16), .b(new_n35_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  oai21  g57(.a(new_n44_), .b(new_n43_), .c(x04), .O(new_n92_));
  ...
  aoi22  g62(.a(new_n96_), .b(new_n95_), .c(new_n55_), .d(x16), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n67_), .c(x08), .d(x06), .O(new_n98_));
  nand2  g64(.a(new_n45_), .b(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(z10));
  aoi21  g66(.a(new_n89_), .b(new_n43_), .c(new_n40_), .O(z12));
