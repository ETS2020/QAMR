// Benchmark "FAU" written by ABC on Mon Jul 27 19:29:02 2020
...
module FAU ( 
  ...
  nor2   g31(.a(x09), .b(new_n56_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(x07), .c(x06), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n63_), .d(x04), .O(z05));
  oai21  g34(.a(new_n45_), .b(x06), .c(new_n51_), .O(new_n69_));
  inv1   g35(.a(x16), .O(new_n70_));
  nor2   g36(.a(new_n70_), .b(x02), .O(new_n71_));
  aoi21  g37(.a(new_n69_), .b(new_n47_), .c(new_n71_), .O(new_n72_));
  oai21  g38(.a(x09), .b(new_n56_), .c(x10), .O(new_n73_));
  inv1   g39(.a(x09), .O(new_n74_));
  nand4  g40(.a(new_n45_), .b(new_n74_), .c(x08), .d(x06), .O(new_n75_));
  nand2  g41(.a(x16), .b(x03), .O(new_n76_));
  and2   g42(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n72_), .d(x04), .O(z06));
  nand2  g44(.a(new_n75_), .b(x11), .O(new_n79_));
  nor2   g45(.a(x11), .b(x10), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n74_), .c(x08), .d(x06), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n79_), .c(new_n63_), .d(x04), .O(z07));
  nand2  g48(.a(new_n81_), .b(x12), .O(new_n83_));
  nor3   g49(.a(x12), .b(x11), .c(x10), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n66_), .c(x06), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n63_), .d(x04), .O(z08));
  inv1   g52(.a(new_n71_), .O(new_n87_));
  inv1   g53(.a(x11), .O(new_n88_));
  inv1   g54(.a(x12), .O(new_n89_));
  inv1   g55(.a(x13), .O(new_n90_));
  nand4  g56(.a(new_n47_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x10), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n74_), .c(x08), .d(x06), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n87_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x04), .O(new_n95_));
  nand2  g61(.a(new_n76_), .b(x04), .O(new_n96_));
  aoi21  g62(.a(new_n85_), .b(x13), .c(new_n96_), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n95_), .O(z09));
  inv1   g64(.a(new_n47_), .O(new_n99_));
  nand2  g65(.a(x07), .b(x00), .O(new_n100_));
  nand3  g66(.a(new_n80_), .b(new_n90_), .c(new_n89_), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n100_), .c(new_n99_), .O(new_n102_));
  nand4  g68(.a(new_n102_), .b(new_n74_), .c(x08), .d(x06), .O(new_n103_));
  nand2  g69(.a(new_n99_), .b(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n40_), .O(z10));
  aoi21  g71(.a(new_n87_), .b(new_n61_), .c(new_n40_), .O(z12));
