...
module FAU ( 
  ...
  aoi21  g30(.a(new_n64_), .b(x10), .c(x09), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(x08), .c(x07), .d(x06), .O(new_n66_));
  nand2  g32(.a(new_n62_), .b(x10), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n66_), .c(new_n58_), .d(x04), .O(z06));
  nand2  g34(.a(new_n62_), .b(x11), .O(new_n69_));
  inv1   g35(.a(new_n59_), .O(new_n70_));
  nor2   g36(.a(x11), .b(x10), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n61_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n69_), .c(new_n58_), .d(x04), .O(z07));
  nand2  g39(.a(new_n72_), .b(x12), .O(new_n74_));
  inv1   g40(.a(x12), .O(new_n75_));
  nor2   g41(.a(x10), .b(x09), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n70_), .c(new_n75_), .d(new_n64_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n74_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g44(.a(x13), .O(new_n79_));
  nand4  g45(.a(new_n44_), .b(new_n79_), .c(new_n75_), .d(new_n64_), .O(new_n80_));
  ...
  nand3  g56(.a(new_n71_), .b(new_n79_), .c(new_n75_), .O(new_n91_));
