...
module FAU ( 
  ...
  nand3  g45(.a(new_n63_), .b(x08), .c(x07), .O(new_n80_));
  ...
  nor2   g49(.a(new_n45_), .b(x02), .O(new_n84_));
  aoi21  g50(.a(new_n83_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n77_), .b(new_n72_), .c(new_n71_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n80_), .c(x13), .O(new_n87_));
  nand2  g53(.a(x16), .b(x03), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n85_), .d(x04), .O(z09));
  nand2  g55(.a(x06), .b(x00), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n82_), .c(new_n46_), .O(new_n91_));
