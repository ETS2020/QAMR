...
module FAU ( 
  ...
  oai21  g21(.a(new_n50_), .b(new_n43_), .c(x09), .O(new_n56_));
  ...
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n68_), .d(new_n60_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n67_), .c(new_n59_), .d(x04), .O(z07));
  nand2  g39(.a(new_n72_), .b(x12), .O(new_n74_));
  inv1   g40(.a(x12), .O(new_n75_));
  nand4  g41(.a(new_n71_), .b(new_n64_), .c(new_n75_), .d(new_n69_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n74_), .c(new_n59_), .d(x04), .O(z08));
  inv1   g43(.a(x13), .O(new_n78_));
  nand4  g44(.a(new_n44_), .b(new_n78_), .c(new_n75_), .d(new_n69_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(x10), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n60_), .c(x08), .d(x07), .O(new_n81_));
  ...
  nand4  g55(.a(new_n78_), .b(new_n75_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n44_), .c(new_n60_), .d(x08), .O(new_n92_));
  ...
  aoi21  g63(.a(new_n82_), .b(new_n57_), .c(new_n40_), .O(z12));
