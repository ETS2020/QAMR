...
module FAU ( 
  ...
  oai21  g18(.a(new_n45_), .b(new_n44_), .c(x06), .O(new_n53_));
  oai21  g19(.a(new_n45_), .b(x06), .c(new_n53_), .O(new_n54_));
  ...
  nand4  g45(.a(new_n47_), .b(new_n79_), .c(new_n76_), .d(new_n71_), .O(new_n80_));
  ...
  nand4  g58(.a(new_n92_), .b(new_n47_), .c(new_n62_), .d(x08), .O(new_n93_));
  ...
  aoi21  g64(.a(new_n83_), .b(new_n57_), .c(new_n40_), .O(z12));
