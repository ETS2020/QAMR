...
module FAU ( 
  ...
  nand4  g57(.a(new_n91_), .b(new_n70_), .c(new_n69_), .d(x07), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n89_), .c(new_n90_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n61_), .c(x08), .d(x06), .O(new_n94_));
