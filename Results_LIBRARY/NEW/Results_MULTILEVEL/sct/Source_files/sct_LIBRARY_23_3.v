...
module FAU ( 
  ...
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n68_), .d(new_n61_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n58_), .d(x04), .O(z07));
  ...
  nand4  g56(.a(new_n79_), .b(new_n76_), .c(new_n71_), .d(new_n68_), .O(new_n91_));
