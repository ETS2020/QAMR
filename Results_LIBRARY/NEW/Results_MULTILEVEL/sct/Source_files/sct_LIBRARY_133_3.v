...
module FAU ( 
  ...
  nor3   g41(.a(x16), .b(x13), .c(x12), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n67_), .c(new_n75_), .O(new_n77_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n72_), .c(new_n71_), .d(new_n81_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n44_), .c(new_n58_), .d(x08), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(x07), .c(x06), .O(new_n87_));
  nand2  g53(.a(x16), .b(x14), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n87_), .c(new_n40_), .O(z10));
  inv1   g55(.a(x03), .O(new_n90_));
  aoi21  g56(.a(new_n44_), .b(new_n90_), .c(new_n40_), .O(z12));
