...
module FAU ( 
  ...
  nand4  g38(.a(new_n72_), .b(new_n69_), .c(new_n59_), .d(x04), .O(z07));
  nand3  g39(.a(new_n71_), .b(new_n52_), .c(new_n62_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand4  g43(.a(new_n66_), .b(new_n70_), .c(new_n77_), .d(new_n76_), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n59_), .d(x04), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n44_), .b(new_n80_), .c(new_n77_), .d(new_n76_), .O(new_n81_));
  ...
  nand3  g57(.a(new_n71_), .b(new_n80_), .c(new_n77_), .O(new_n92_));
