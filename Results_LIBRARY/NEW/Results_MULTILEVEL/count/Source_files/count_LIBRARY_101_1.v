...
module FAU ( 
  ...
  oai21  g076(.a(new_n123_), .b(x27), .c(x16), .O(new_n128_));
  ...
  nand4  g081(.a(new_n119_), .b(new_n87_), .c(new_n118_), .d(new_n69_), .O(new_n133_));
  ...
  nor2   g085(.a(x28), .b(x26), .O(new_n137_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n121_), .c(new_n132_), .O(new_n161_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n119_), .c(new_n132_), .O(new_n168_));
