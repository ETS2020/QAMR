...
module FAU ( 
  ...
  nand2  g10(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  ...
  nand3  g15(.a(new_n61_), .b(x21), .c(x16), .O(new_n67_));
  inv1   g16(.a(x13), .O(new_n68_));
  aoi21  g17(.a(new_n52_), .b(new_n68_), .c(x18), .O(new_n69_));
  nand2  g18(.a(new_n69_), .b(new_n67_), .O(z02));
