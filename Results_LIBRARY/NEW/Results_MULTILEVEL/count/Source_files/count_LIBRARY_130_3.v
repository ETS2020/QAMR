// Benchmark "FAU" written by ABC on Mon Jul 27 18:27:20 2020
...
module FAU ( 
  ...
  oai21  g078(.a(new_n122_), .b(new_n129_), .c(new_n53_), .O(new_n130_));
  ...
  nor4   g083(.a(new_n134_), .b(new_n132_), .c(x24), .d(x23), .O(new_n135_));
  ...
  nand2  g089(.a(new_n133_), .b(new_n107_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n129_), .c(new_n53_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n63_), .c(new_n140_), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n114_), .O(new_n145_));
  nor3   g094(.a(new_n145_), .b(new_n132_), .c(new_n117_), .O(new_n146_));
  ...
  aoi21  g100(.a(new_n151_), .b(x26), .c(x29), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n140_), .c(new_n128_), .d(new_n104_), .O(new_n153_));
  nor3   g102(.a(new_n153_), .b(x24), .c(x23), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n80_), .c(new_n69_), .d(new_n61_), .O(new_n155_));
  nand2  g104(.a(new_n144_), .b(new_n121_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n96_), .c(x29), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(x17), .c(new_n157_), .O(new_n158_));
  inv1   g107(.a(x29), .O(new_n159_));
  nor2   g108(.a(new_n63_), .b(new_n159_), .O(new_n160_));
  aoi21  g109(.a(new_n158_), .b(new_n53_), .c(new_n160_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n128_), .c(new_n104_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n96_), .c(new_n53_), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n63_), .c(new_n151_), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n144_), .O(new_n170_));
  nor4   g119(.a(new_n170_), .b(new_n122_), .c(new_n129_), .d(new_n68_), .O(new_n171_));
  ...
  nand3  g125(.a(new_n165_), .b(new_n121_), .c(new_n128_), .O(new_n177_));
  or2    g126(.a(new_n177_), .b(new_n96_), .O(new_n178_));
  nand3  g127(.a(new_n55_), .b(new_n151_), .c(new_n61_), .O(new_n179_));
  aoi21  g128(.a(new_n178_), .b(new_n53_), .c(new_n179_), .O(new_n180_));
  nor2   g129(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nor2   g130(.a(x31), .b(x30), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n165_), .O(new_n183_));
  nor3   g132(.a(new_n183_), .b(new_n134_), .c(new_n98_), .O(new_n184_));
  ...
  nand4  g139(.a(new_n190_), .b(new_n169_), .c(new_n144_), .d(new_n104_), .O(new_n191_));
  oai22  g140(.a(new_n191_), .b(new_n98_), .c(new_n189_), .d(new_n176_), .O(new_n192_));
  nor2   g141(.a(new_n180_), .b(new_n189_), .O(new_n193_));
  aoi21  g142(.a(new_n192_), .b(new_n114_), .c(new_n193_), .O(new_n194_));
  ...
  oai21  g146(.a(new_n190_), .b(x26), .c(new_n180_), .O(new_n198_));
  inv1   g147(.a(new_n182_), .O(new_n199_));
  nand2  g148(.a(new_n165_), .b(new_n133_), .O(new_n200_));
  inv1   g149(.a(x33), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n189_), .O(new_n202_));
  nor3   g151(.a(new_n202_), .b(new_n200_), .c(new_n199_), .O(new_n203_));
  aoi22  g152(.a(new_n203_), .b(new_n109_), .c(new_n198_), .d(x33), .O(new_n204_));
  ...
  oai21  g156(.a(new_n202_), .b(x31), .c(new_n114_), .O(new_n208_));
  nand2  g157(.a(new_n208_), .b(new_n180_), .O(new_n209_));
  nor2   g158(.a(x34), .b(x33), .O(new_n210_));
  nand3  g159(.a(new_n210_), .b(new_n182_), .c(new_n189_), .O(new_n211_));
