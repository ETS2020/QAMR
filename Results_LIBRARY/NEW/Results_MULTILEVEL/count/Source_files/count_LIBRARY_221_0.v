...
module FAU ( 
  ...
  aoi22  g024(.a(new_n75_), .b(new_n55_), .c(new_n74_), .d(x22), .O(new_n76_));
  ...
  nand3  g038(.a(new_n89_), .b(new_n80_), .c(new_n63_), .O(new_n90_));
  ...
  nand3  g046(.a(new_n97_), .b(new_n96_), .c(new_n87_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(new_n74_), .O(new_n99_));
  ...
  oai21  g052(.a(new_n98_), .b(new_n74_), .c(x26), .O(new_n104_));
  nor3   g053(.a(x26), .b(x25), .c(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n97_), .c(new_n69_), .d(new_n55_), .O(new_n106_));
  ...
  nand3  g061(.a(new_n112_), .b(new_n89_), .c(new_n96_), .O(new_n113_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n120_), .c(new_n75_), .d(new_n55_), .O(new_n122_));
  ...
  nand3  g076(.a(new_n122_), .b(x29), .c(x16), .O(new_n128_));
  ...
  nand2  g083(.a(new_n58_), .b(new_n134_), .O(new_n135_));
