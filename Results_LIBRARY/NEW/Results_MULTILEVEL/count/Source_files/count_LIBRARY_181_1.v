...
module FAU ( 
  ...
  nand4  g093(.a(new_n144_), .b(new_n106_), .c(new_n113_), .d(new_n114_), .O(new_n145_));
  ...
  oai21  g099(.a(new_n146_), .b(x29), .c(x16), .O(new_n151_));
  ...
  nand2  g104(.a(new_n89_), .b(new_n64_), .O(new_n156_));
  nand4  g105(.a(new_n144_), .b(new_n119_), .c(new_n95_), .d(new_n77_), .O(new_n157_));
  ...
  oai22  g109(.a(new_n160_), .b(new_n156_), .c(new_n158_), .d(new_n155_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n159_), .b(new_n119_), .c(new_n128_), .O(new_n167_));
  ...
  nand3  g119(.a(new_n170_), .b(new_n144_), .c(new_n121_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n156_), .O(new_n172_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n133_), .c(new_n140_), .O(new_n178_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n159_), .c(new_n133_), .d(new_n102_), .O(new_n182_));
  ...
  nand4  g137(.a(new_n181_), .b(new_n144_), .c(new_n155_), .d(new_n113_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n115_), .c(new_n53_), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n64_), .c(new_n188_), .O(new_n191_));
  nor2   g140(.a(x33), .b(x32), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n170_), .c(new_n144_), .d(new_n119_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n96_), .O(new_n194_));
  ...
  nand4  g148(.a(new_n192_), .b(new_n159_), .c(new_n166_), .d(new_n128_), .O(new_n200_));
  oai21  g149(.a(new_n200_), .b(new_n129_), .c(new_n53_), .O(new_n201_));
  aoi21  g150(.a(new_n201_), .b(new_n64_), .c(new_n199_), .O(new_n202_));
  nor2   g151(.a(x34), .b(x33), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n181_), .c(new_n159_), .d(new_n133_), .O(new_n204_));
  nor3   g153(.a(new_n204_), .b(new_n107_), .c(new_n70_), .O(new_n205_));
