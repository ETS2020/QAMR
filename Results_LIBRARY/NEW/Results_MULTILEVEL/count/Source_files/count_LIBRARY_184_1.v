...
module FAU ( 
  ...
  oai21  g088(.a(new_n135_), .b(x28), .c(x16), .O(new_n140_));
  ...
  nand2  g093(.a(new_n133_), .b(new_n106_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n88_), .c(new_n53_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n64_), .c(new_n144_), .O(new_n147_));
  nand2  g096(.a(new_n106_), .b(new_n114_), .O(new_n148_));
  nor2   g097(.a(x29), .b(x27), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n113_), .O(new_n150_));
  nor3   g099(.a(new_n150_), .b(new_n132_), .c(new_n148_), .O(new_n151_));
  ...
  nand4  g106(.a(new_n149_), .b(new_n119_), .c(new_n95_), .d(new_n77_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n53_), .c(new_n63_), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n121_), .c(new_n128_), .O(new_n161_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n119_), .c(new_n128_), .O(new_n168_));
  ...
  nand3  g120(.a(new_n171_), .b(new_n149_), .c(new_n121_), .O(new_n172_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n133_), .c(new_n144_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n115_), .c(new_n53_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n64_), .c(new_n178_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n160_), .c(new_n133_), .d(new_n102_), .O(new_n183_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n149_), .c(new_n156_), .d(new_n113_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n115_), .c(new_n53_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n64_), .c(new_n189_), .O(new_n192_));
  nor2   g141(.a(x33), .b(x32), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n171_), .c(new_n149_), .d(new_n119_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n160_), .c(new_n167_), .d(new_n128_), .O(new_n201_));
  ...
  nand4  g153(.a(new_n204_), .b(new_n182_), .c(new_n160_), .d(new_n133_), .O(new_n205_));
