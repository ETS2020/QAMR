...
module FAU ( 
  ...
  nor2   g071(.a(x26), .b(x20), .O(new_n123_));
  nand4  g072(.a(new_n123_), .b(new_n112_), .c(new_n79_), .d(new_n52_), .O(new_n124_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n125_), .c(new_n53_), .O(new_n128_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n95_), .O(new_n135_));
  nor2   g084(.a(x20), .b(x17), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n114_), .c(new_n68_), .O(new_n137_));
  nor2   g086(.a(x25), .b(x24), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n138_), .c(new_n116_), .O(new_n140_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n136_), .c(new_n147_), .d(new_n89_), .O(new_n149_));
  oai21  g098(.a(new_n141_), .b(new_n146_), .c(new_n149_), .O(new_n150_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n126_), .c(new_n156_), .d(new_n105_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  aoi21  g108(.a(new_n149_), .b(x30), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n134_), .O(new_n167_));
  nor2   g116(.a(x29), .b(x28), .O(new_n168_));
  nor2   g117(.a(x31), .b(x30), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n168_), .c(new_n126_), .d(new_n105_), .O(new_n170_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n146_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n164_), .c(new_n177_), .d(new_n107_), .O(new_n183_));
  ...
  nand4  g137(.a(new_n138_), .b(new_n114_), .c(new_n70_), .d(new_n52_), .O(new_n189_));
  nor2   g138(.a(x32), .b(x31), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n157_), .c(new_n139_), .d(new_n116_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n189_), .c(x33), .O(new_n192_));
  inv1   g141(.a(x27), .O(new_n193_));
  nand4  g142(.a(new_n146_), .b(new_n156_), .c(new_n193_), .d(new_n116_), .O(new_n194_));
  inv1   g143(.a(new_n194_), .O(new_n195_));
  inv1   g144(.a(x33), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n180_), .c(new_n179_), .d(new_n178_), .O(new_n197_));
  inv1   g146(.a(new_n197_), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n195_), .c(new_n164_), .d(new_n107_), .O(new_n199_));
  ...
  nand4  g154(.a(new_n205_), .b(new_n169_), .c(new_n168_), .d(new_n126_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n189_), .c(x34), .O(new_n207_));
  nand4  g156(.a(new_n116_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n208_));
  inv1   g157(.a(new_n208_), .O(new_n209_));
  nand4  g158(.a(new_n178_), .b(new_n146_), .c(new_n156_), .d(new_n193_), .O(new_n210_));
  inv1   g159(.a(new_n210_), .O(new_n211_));
  inv1   g160(.a(x34), .O(new_n212_));
  nand4  g161(.a(new_n212_), .b(new_n196_), .c(new_n180_), .d(new_n179_), .O(new_n213_));
  inv1   g162(.a(new_n213_), .O(new_n214_));
  nand4  g163(.a(new_n214_), .b(new_n211_), .c(new_n209_), .d(new_n133_), .O(new_n215_));
