...
module FAU ( 
  ...
  nand3  g035(.a(new_n86_), .b(new_n64_), .c(new_n69_), .O(new_n87_));
  inv1   g036(.a(new_n87_), .O(new_n88_));
  aoi21  g037(.a(new_n77_), .b(x23), .c(new_n88_), .O(new_n89_));
  ...
  nand3  g049(.a(new_n100_), .b(new_n86_), .c(new_n71_), .O(new_n101_));
  ...
  nand3  g057(.a(new_n108_), .b(new_n86_), .c(new_n71_), .O(new_n109_));
  ...
  nor4   g073(.a(new_n124_), .b(x25), .c(x24), .d(x23), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n83_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g075(.a(new_n126_), .b(x19), .O(new_n127_));
  inv1   g076(.a(x28), .O(new_n128_));
  nor2   g077(.a(new_n118_), .b(new_n128_), .O(new_n129_));
  ...
  nand3  g085(.a(new_n136_), .b(new_n135_), .c(new_n107_), .O(new_n137_));
  nor2   g086(.a(new_n137_), .b(x25), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n134_), .c(new_n84_), .d(new_n83_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(x21), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n141_));
  inv1   g090(.a(new_n124_), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n100_), .c(new_n78_), .d(new_n84_), .O(new_n143_));
  ...
  nand4  g099(.a(new_n150_), .b(new_n128_), .c(new_n135_), .d(new_n107_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(x25), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n134_), .c(new_n84_), .d(new_n83_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(x21), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n155_));
  nand3  g104(.a(new_n136_), .b(new_n108_), .c(new_n135_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n87_), .c(x30), .O(new_n157_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n163_), .c(new_n128_), .d(new_n135_), .O(new_n165_));
  nor2   g114(.a(new_n165_), .b(x26), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n115_), .c(new_n134_), .d(new_n84_), .O(new_n167_));
  nor2   g116(.a(new_n167_), .b(x22), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n69_), .c(new_n61_), .d(new_n53_), .O(new_n169_));
  nand3  g118(.a(new_n150_), .b(new_n123_), .c(new_n108_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n87_), .c(x31), .O(new_n171_));
  oai21  g120(.a(new_n169_), .b(x17), .c(new_n171_), .O(new_n172_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n177_), .c(new_n163_), .d(new_n128_), .O(new_n179_));
  nor3   g128(.a(new_n179_), .b(x27), .c(x26), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n115_), .c(new_n134_), .d(new_n84_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(x22), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n69_), .c(new_n61_), .d(new_n53_), .O(new_n183_));
  nand4  g132(.a(new_n164_), .b(new_n136_), .c(new_n116_), .d(new_n115_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n94_), .c(x32), .O(new_n185_));
  oai21  g134(.a(new_n183_), .b(x17), .c(new_n185_), .O(new_n186_));
  ...
  nand4  g140(.a(new_n178_), .b(new_n150_), .c(new_n123_), .d(new_n191_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n94_), .c(x33), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n164_), .c(new_n136_), .d(new_n116_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n101_), .c(new_n193_), .O(new_n196_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n201_), .c(new_n177_), .d(new_n163_), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n128_), .c(new_n135_), .d(new_n107_), .O(new_n204_));
  nor2   g153(.a(new_n204_), .b(x25), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n134_), .c(new_n84_), .d(new_n83_), .O(new_n206_));
  nor2   g155(.a(new_n206_), .b(x21), .O(new_n207_));
  nand4  g156(.a(new_n207_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n208_));
  nand2  g157(.a(new_n143_), .b(x34), .O(new_n209_));
