...
module FAU ( 
  ...
  aoi21  g145(.a(new_n196_), .b(x28), .c(x33), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n185_), .c(new_n172_), .d(new_n161_), .O(new_n198_));
  nor3   g147(.a(new_n198_), .b(x29), .c(x27), .O(new_n199_));
  ...
  nand4  g161(.a(new_n212_), .b(new_n165_), .c(new_n172_), .d(new_n126_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n128_), .c(new_n53_), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n63_), .c(new_n196_), .O(new_n215_));
  nor3   g164(.a(x34), .b(x33), .c(x32), .O(new_n216_));
  nand4  g165(.a(new_n216_), .b(new_n178_), .c(new_n177_), .d(new_n132_), .O(new_n217_));
