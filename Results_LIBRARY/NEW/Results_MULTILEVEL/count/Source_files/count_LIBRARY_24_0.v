...
module FAU ( 
  ...
  inv1   g09(.a(new_n52_), .O(new_n61_));
  nor3   g10(.a(x20), .b(x19), .c(x17), .O(new_n62_));
  aoi21  g11(.a(new_n61_), .b(x20), .c(new_n62_), .O(new_n63_));
  ...
  oai21  g18(.a(new_n62_), .b(new_n67_), .c(new_n69_), .O(new_n70_));
  ...
  nand4  g25(.a(new_n76_), .b(new_n67_), .c(new_n75_), .d(new_n54_), .O(new_n77_));
  nor2   g26(.a(new_n77_), .b(x17), .O(new_n78_));
  aoi21  g27(.a(new_n68_), .b(new_n52_), .c(new_n76_), .O(new_n79_));
  oai21  g28(.a(new_n79_), .b(new_n78_), .c(x16), .O(new_n80_));
  inv1   g29(.a(x12), .O(new_n81_));
  aoi21  g30(.a(new_n58_), .b(new_n81_), .c(x18), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(new_n80_), .O(z03));
  nand4  g32(.a(new_n52_), .b(new_n76_), .c(new_n67_), .d(new_n75_), .O(new_n84_));
  nor3   g33(.a(x23), .b(x22), .c(x21), .O(new_n85_));
  aoi22  g34(.a(new_n85_), .b(new_n62_), .c(new_n84_), .d(x23), .O(new_n86_));
  ...
  nand4  g39(.a(new_n90_), .b(new_n76_), .c(new_n67_), .d(new_n75_), .O(new_n91_));
  nand3  g40(.a(new_n91_), .b(new_n54_), .c(new_n53_), .O(new_n92_));
  nand2  g41(.a(new_n61_), .b(x24), .O(new_n93_));
