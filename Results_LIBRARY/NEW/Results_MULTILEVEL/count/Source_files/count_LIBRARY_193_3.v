...
module FAU ( 
  ...
  nand4  g155(.a(new_n206_), .b(new_n127_), .c(new_n61_), .d(new_n52_), .O(new_n207_));
  ...
  and2   g162(.a(x34), .b(x19), .O(new_n214_));
  nor3   g163(.a(new_n214_), .b(new_n213_), .c(x18), .O(new_n215_));
  oai21  g164(.a(new_n212_), .b(new_n58_), .c(new_n215_), .O(z15));
endmodule
