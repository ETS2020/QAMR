...
module FAU ( 
  ...
  nor2   g028(.a(new_n60_), .b(new_n79_), .O(new_n80_));
  ...
  aoi21  g034(.a(new_n85_), .b(x19), .c(x23), .O(new_n86_));
  nand4  g035(.a(new_n86_), .b(new_n79_), .c(new_n65_), .d(new_n57_), .O(new_n87_));
  oai21  g036(.a(x22), .b(x21), .c(x23), .O(new_n88_));
  aoi21  g037(.a(new_n88_), .b(new_n87_), .c(x17), .O(new_n89_));
  ...
  nor3   g046(.a(new_n97_), .b(x20), .c(x17), .O(new_n98_));
  nand4  g047(.a(new_n76_), .b(new_n60_), .c(new_n85_), .d(new_n90_), .O(new_n99_));
  oai21  g048(.a(new_n98_), .b(new_n85_), .c(new_n99_), .O(new_n100_));
  ...
  inv1   g053(.a(new_n97_), .O(new_n105_));
  nand3  g054(.a(new_n58_), .b(new_n85_), .c(new_n57_), .O(new_n106_));
  inv1   g055(.a(new_n106_), .O(new_n107_));
  oai21  g056(.a(new_n105_), .b(x17), .c(new_n107_), .O(new_n108_));
  nor2   g057(.a(x25), .b(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n96_), .c(new_n67_), .d(new_n58_), .O(new_n110_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n76_), .c(new_n90_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n117_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n107_), .c(new_n129_), .O(new_n133_));
  nand3  g082(.a(new_n76_), .b(new_n58_), .c(new_n57_), .O(new_n134_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n85_), .c(new_n90_), .O(new_n136_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n96_), .c(new_n118_), .d(new_n65_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n117_), .O(new_n145_));
  aoi21  g094(.a(new_n145_), .b(new_n107_), .c(new_n142_), .O(new_n146_));
  nor2   g095(.a(x28), .b(x27), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n109_), .c(new_n116_), .d(new_n90_), .O(new_n148_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n130_), .c(new_n96_), .d(new_n65_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n117_), .c(new_n106_), .O(new_n156_));
  nand2  g105(.a(new_n105_), .b(new_n60_), .O(new_n157_));
  nor2   g106(.a(x29), .b(x28), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n122_), .c(new_n129_), .O(new_n159_));
  oai22  g108(.a(new_n159_), .b(new_n157_), .c(new_n156_), .d(new_n154_), .O(new_n160_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n143_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n119_), .c(new_n117_), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n107_), .c(new_n165_), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n147_), .c(new_n122_), .O(new_n170_));
  ...
  nand3  g125(.a(new_n169_), .b(new_n143_), .c(new_n142_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n119_), .c(new_n117_), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n107_), .c(new_n176_), .O(new_n179_));
  nor2   g128(.a(x31), .b(x30), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n158_), .c(new_n135_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n99_), .O(new_n182_));
  ...
  nand3  g136(.a(new_n180_), .b(new_n147_), .c(new_n154_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n131_), .c(new_n117_), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n107_), .c(new_n187_), .O(new_n190_));
  nor2   g139(.a(x32), .b(x31), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n169_), .c(new_n147_), .d(new_n130_), .O(new_n192_));
  nor2   g141(.a(new_n192_), .b(new_n99_), .O(new_n193_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n158_), .c(new_n165_), .d(new_n129_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n131_), .c(new_n117_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n107_), .c(new_n198_), .O(new_n201_));
  nor2   g150(.a(x33), .b(x32), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n180_), .O(new_n203_));
  nor3   g152(.a(new_n203_), .b(new_n166_), .c(new_n110_), .O(new_n204_));
  ...
  nand4  g158(.a(new_n202_), .b(new_n169_), .c(new_n176_), .d(new_n142_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n144_), .c(new_n117_), .O(new_n211_));
  aoi21  g160(.a(new_n211_), .b(new_n107_), .c(new_n209_), .O(new_n212_));
  nand4  g161(.a(new_n180_), .b(new_n209_), .c(new_n198_), .d(new_n187_), .O(new_n213_));
  nor3   g162(.a(new_n213_), .b(new_n166_), .c(new_n110_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n212_), .c(x16), .O(new_n215_));
  inv1   g164(.a(x00), .O(new_n216_));
  aoi21  g165(.a(new_n52_), .b(new_n216_), .c(x18), .O(new_n217_));
