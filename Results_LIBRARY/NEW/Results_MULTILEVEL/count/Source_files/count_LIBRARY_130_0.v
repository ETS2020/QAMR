...
module FAU ( 
  ...
  nand3  g040(.a(new_n91_), .b(new_n76_), .c(new_n64_), .O(new_n92_));
  oai21  g041(.a(new_n85_), .b(new_n90_), .c(new_n92_), .O(new_n93_));
  ...
  nor3   g057(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n110_));
  oai21  g059(.a(new_n100_), .b(new_n105_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n117_), .b(new_n105_), .c(new_n116_), .O(new_n118_));
  nor4   g067(.a(new_n118_), .b(x24), .c(x23), .d(x22), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n69_), .c(new_n61_), .d(new_n53_), .O(new_n120_));
  nand3  g069(.a(new_n107_), .b(new_n83_), .c(new_n71_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(x27), .O(new_n122_));
  oai21  g071(.a(new_n120_), .b(x17), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n116_), .c(new_n90_), .d(new_n106_), .O(new_n129_));
  nor2   g078(.a(new_n129_), .b(x22), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n69_), .c(new_n61_), .d(new_n53_), .O(new_n131_));
  nand4  g080(.a(new_n91_), .b(new_n117_), .c(new_n105_), .d(new_n116_), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n77_), .c(x28), .O(new_n133_));
  oai21  g082(.a(new_n131_), .b(x17), .c(new_n133_), .O(new_n134_));
  ...
  nand3  g087(.a(new_n128_), .b(new_n98_), .c(new_n106_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n77_), .c(x29), .O(new_n140_));
  nor3   g089(.a(x29), .b(x28), .c(x27), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n107_), .c(new_n85_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n140_), .c(new_n58_), .O(new_n143_));
  inv1   g092(.a(x18), .O(new_n144_));
  oai21  g093(.a(x16), .b(x05), .c(new_n144_), .O(new_n145_));
  or2    g094(.a(new_n145_), .b(new_n143_), .O(z10));
  inv1   g095(.a(x28), .O(new_n147_));
  inv1   g096(.a(x29), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n147_), .c(new_n117_), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n105_), .c(new_n116_), .d(new_n90_), .O(new_n150_));
  nor3   g099(.a(new_n150_), .b(x23), .c(x22), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n69_), .c(new_n61_), .d(new_n53_), .O(new_n152_));
  nand2  g101(.a(new_n121_), .b(x30), .O(new_n153_));
  oai21  g102(.a(new_n152_), .b(x17), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g107(.a(x31), .b(x16), .O(new_n159_));
  inv1   g108(.a(x03), .O(new_n160_));
  nand2  g109(.a(new_n58_), .b(new_n160_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n159_), .c(new_n144_), .O(z12));
  nand2  g111(.a(x32), .b(x16), .O(new_n163_));
  inv1   g112(.a(x02), .O(new_n164_));
  nand2  g113(.a(new_n58_), .b(new_n164_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n163_), .c(new_n144_), .O(z13));
  nand2  g115(.a(x33), .b(x16), .O(new_n167_));
  inv1   g116(.a(x01), .O(new_n168_));
  nand2  g117(.a(new_n58_), .b(new_n168_), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n144_), .O(z14));
  nand2  g119(.a(x34), .b(x16), .O(new_n171_));
  inv1   g120(.a(x00), .O(new_n172_));
  nand2  g121(.a(new_n58_), .b(new_n172_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n144_), .O(z15));
endmodule
