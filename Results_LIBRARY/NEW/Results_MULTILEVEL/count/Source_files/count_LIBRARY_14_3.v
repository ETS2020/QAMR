...
module FAU ( 
  ...
  aoi21  g010(.a(x20), .b(x17), .c(new_n61_), .O(new_n62_));
  nor2   g011(.a(x16), .b(x14), .O(new_n63_));
  inv1   g012(.a(x20), .O(new_n64_));
  nor2   g013(.a(new_n64_), .b(new_n53_), .O(new_n65_));
  nor3   g014(.a(new_n65_), .b(new_n63_), .c(x18), .O(new_n66_));
  oai21  g015(.a(new_n62_), .b(new_n58_), .c(new_n66_), .O(z01));
  ...
  aoi22  g047(.a(new_n98_), .b(new_n61_), .c(new_n95_), .d(x24), .O(new_n99_));
  ...
  nand3  g077(.a(new_n76_), .b(new_n55_), .c(new_n64_), .O(new_n129_));
  ...
  nand3  g123(.a(new_n96_), .b(new_n76_), .c(new_n61_), .O(new_n175_));
  ...
  nand4  g145(.a(new_n196_), .b(new_n127_), .c(new_n68_), .d(new_n52_), .O(new_n197_));
  ...
  nor2   g154(.a(new_n200_), .b(new_n154_), .O(new_n206_));
  nand4  g155(.a(new_n206_), .b(new_n127_), .c(new_n68_), .d(new_n52_), .O(new_n207_));
