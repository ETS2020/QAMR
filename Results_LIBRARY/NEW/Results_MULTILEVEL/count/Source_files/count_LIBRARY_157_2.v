...
module FAU ( 
  ...
  nor2   g033(.a(new_n75_), .b(x19), .O(new_n85_));
  oai21  g034(.a(new_n85_), .b(new_n63_), .c(x23), .O(new_n86_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n86_), .c(new_n84_), .d(x16), .O(z04));
  oai21  g041(.a(new_n90_), .b(x19), .c(new_n64_), .O(new_n93_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n88_), .c(new_n69_), .d(new_n55_), .O(new_n106_));
  ...
  oai21  g089(.a(new_n140_), .b(new_n89_), .c(new_n53_), .O(new_n141_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n127_), .c(new_n94_), .d(new_n75_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n53_), .c(new_n63_), .O(new_n153_));
  nor2   g102(.a(x29), .b(x28), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n118_), .c(new_n125_), .O(new_n155_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n127_), .c(new_n125_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n102_), .c(new_n53_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n64_), .c(new_n161_), .O(new_n164_));
  nor2   g113(.a(x30), .b(x29), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n144_), .c(new_n118_), .O(new_n166_));
  ...
  nand4  g125(.a(new_n176_), .b(new_n154_), .c(new_n132_), .d(new_n101_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n95_), .O(new_n178_));
  ...
  nand4  g132(.a(new_n176_), .b(new_n144_), .c(new_n151_), .d(new_n112_), .O(new_n184_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n165_), .c(new_n144_), .d(new_n127_), .O(new_n188_));
  ...
  nand2  g146(.a(new_n154_), .b(new_n132_), .O(new_n198_));
  ...
  nand4  g155(.a(new_n199_), .b(new_n176_), .c(new_n154_), .d(new_n125_), .O(new_n207_));
