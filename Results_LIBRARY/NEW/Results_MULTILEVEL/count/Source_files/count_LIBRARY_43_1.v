...
module FAU ( 
  ...
  oai21  g009(.a(new_n55_), .b(x20), .c(x16), .O(new_n61_));
  ...
  aoi22  g029(.a(new_n80_), .b(new_n55_), .c(new_n74_), .d(x23), .O(new_n81_));
  ...
  oai21  g039(.a(new_n88_), .b(new_n58_), .c(new_n90_), .O(z05));
  ...
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n80_), .d(new_n55_), .O(new_n130_));
