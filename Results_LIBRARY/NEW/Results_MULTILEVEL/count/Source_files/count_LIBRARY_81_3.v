...
module FAU ( 
  ...
  nand3  g066(.a(new_n107_), .b(new_n77_), .c(new_n117_), .O(new_n118_));
  ...
  nor3   g073(.a(new_n124_), .b(new_n121_), .c(new_n70_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n124_), .b(new_n88_), .c(new_n53_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n64_), .c(new_n130_), .O(new_n132_));
  nand3  g081(.a(new_n77_), .b(new_n55_), .c(new_n62_), .O(new_n133_));
  nor2   g082(.a(x27), .b(x26), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n104_), .O(new_n135_));
  nor4   g084(.a(new_n135_), .b(new_n133_), .c(x24), .d(x23), .O(new_n136_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n107_), .O(new_n142_));
  ...
  nand4  g094(.a(new_n145_), .b(new_n107_), .c(new_n116_), .d(new_n117_), .O(new_n146_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n123_), .O(new_n153_));
  inv1   g102(.a(new_n153_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n97_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n53_), .c(new_n63_), .O(new_n156_));
  inv1   g105(.a(new_n124_), .O(new_n157_));
  nand2  g106(.a(new_n152_), .b(new_n141_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(x27), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n157_), .c(new_n89_), .d(new_n64_), .O(new_n160_));
  oai21  g109(.a(new_n156_), .b(new_n152_), .c(new_n160_), .O(new_n161_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n166_), .c(new_n152_), .d(new_n141_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(x27), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n116_), .c(new_n104_), .d(new_n122_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(x23), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n80_), .c(new_n62_), .d(new_n52_), .O(new_n173_));
  nand3  g122(.a(new_n159_), .b(new_n123_), .c(new_n97_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(x30), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n173_), .c(x19), .O(new_n176_));
  nor2   g125(.a(new_n64_), .b(new_n166_), .O(new_n177_));
  ...
  nand3  g131(.a(new_n182_), .b(new_n134_), .c(new_n141_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n108_), .c(new_n53_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n64_), .c(new_n167_), .O(new_n185_));
  nor2   g134(.a(x31), .b(x30), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nor4   g136(.a(new_n187_), .b(new_n158_), .c(new_n135_), .d(new_n98_), .O(new_n188_));
  ...
  oai21  g142(.a(new_n183_), .b(new_n118_), .c(new_n53_), .O(new_n194_));
  nand3  g143(.a(new_n55_), .b(new_n167_), .c(new_n62_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n194_), .c(new_n193_), .O(new_n197_));
  nand4  g146(.a(new_n182_), .b(new_n154_), .c(new_n193_), .d(new_n167_), .O(new_n198_));
  ...
  nor4   g153(.a(new_n61_), .b(x32), .c(x31), .d(x20), .O(new_n205_));
  aoi21  g154(.a(new_n205_), .b(new_n194_), .c(new_n204_), .O(new_n206_));
  nand3  g155(.a(new_n134_), .b(new_n152_), .c(new_n141_), .O(new_n207_));
  nand3  g156(.a(new_n186_), .b(new_n204_), .c(new_n193_), .O(new_n208_));
  nor3   g157(.a(new_n208_), .b(new_n207_), .c(new_n110_), .O(new_n209_));
  ...
  nor4   g163(.a(new_n63_), .b(x33), .c(x32), .d(x31), .O(new_n215_));
  aoi21  g164(.a(new_n215_), .b(new_n194_), .c(new_n214_), .O(new_n216_));
  nand4  g165(.a(new_n186_), .b(new_n214_), .c(new_n204_), .d(new_n193_), .O(new_n217_));
  nor3   g166(.a(new_n217_), .b(new_n207_), .c(new_n110_), .O(new_n218_));
