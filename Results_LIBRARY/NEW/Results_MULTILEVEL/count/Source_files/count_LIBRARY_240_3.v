...
module FAU ( 
  ...
  nand4  g099(.a(new_n150_), .b(new_n98_), .c(new_n61_), .d(new_n52_), .O(new_n151_));
  ...
  nor3   g108(.a(new_n159_), .b(new_n157_), .c(x18), .O(new_n160_));
  oai21  g109(.a(new_n156_), .b(new_n58_), .c(new_n160_), .O(z10));
  inv1   g110(.a(new_n119_), .O(new_n162_));
  nor2   g111(.a(new_n154_), .b(new_n162_), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n98_), .c(new_n68_), .d(new_n52_), .O(new_n164_));
  nor2   g113(.a(x30), .b(x29), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n142_), .c(new_n119_), .d(new_n118_), .O(new_n166_));
  ...
  nand2  g133(.a(new_n178_), .b(new_n158_), .O(new_n185_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n165_), .c(new_n142_), .d(new_n119_), .O(new_n189_));
  nor2   g138(.a(new_n189_), .b(new_n177_), .O(new_n190_));
