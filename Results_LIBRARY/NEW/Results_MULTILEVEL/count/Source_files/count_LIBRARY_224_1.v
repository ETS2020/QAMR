...
module FAU ( 
  ...
  nand4  g137(.a(new_n188_), .b(new_n115_), .c(new_n74_), .d(new_n84_), .O(new_n189_));
  nor2   g138(.a(x32), .b(x31), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n165_), .c(new_n140_), .d(new_n117_), .O(new_n191_));
  ...
  oai21  g144(.a(new_n193_), .b(new_n52_), .c(new_n195_), .O(z13));
  oai21  g145(.a(new_n192_), .b(x33), .c(x16), .O(new_n197_));
