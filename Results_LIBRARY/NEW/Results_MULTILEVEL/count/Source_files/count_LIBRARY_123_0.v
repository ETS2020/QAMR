// Benchmark "FAU" written by ABC on Mon Jul 27 18:27:18 2020
...
module FAU ( 
  ...
  nand2  g063(.a(new_n68_), .b(new_n58_), .O(new_n115_));
  inv1   g064(.a(x24), .O(new_n116_));
  nor2   g065(.a(x26), .b(x25), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n85_), .c(new_n116_), .O(new_n118_));
  ...
  nand2  g072(.a(new_n117_), .b(new_n116_), .O(new_n124_));
  nor2   g073(.a(new_n124_), .b(new_n86_), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n66_), .c(new_n65_), .O(new_n126_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n92_), .c(new_n66_), .d(new_n65_), .O(new_n138_));
  inv1   g087(.a(x26), .O(new_n139_));
  nor2   g088(.a(x28), .b(x27), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nor3   g090(.a(new_n141_), .b(new_n127_), .c(new_n112_), .O(new_n142_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n96_), .c(new_n66_), .d(new_n65_), .O(new_n149_));
  inv1   g098(.a(x27), .O(new_n150_));
  nor2   g099(.a(x29), .b(x28), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n124_), .O(new_n153_));
  aoi22  g102(.a(new_n153_), .b(new_n87_), .c(new_n149_), .d(x29), .O(new_n154_));
  inv1   g103(.a(x05), .O(new_n155_));
  aoi21  g104(.a(new_n52_), .b(new_n155_), .c(x18), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(new_n52_), .c(new_n156_), .O(z10));
  inv1   g106(.a(new_n117_), .O(new_n158_));
  nor2   g107(.a(new_n152_), .b(new_n158_), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n96_), .c(new_n66_), .d(new_n65_), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n140_), .c(new_n117_), .d(new_n116_), .O(new_n162_));
  nor3   g111(.a(new_n162_), .b(new_n86_), .c(new_n67_), .O(new_n163_));
  ...
  inv1   g116(.a(new_n129_), .O(new_n168_));
  inv1   g117(.a(x28), .O(new_n169_));
  nand2  g118(.a(new_n161_), .b(new_n169_), .O(new_n170_));
  nor2   g119(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n113_), .c(new_n66_), .d(new_n65_), .O(new_n172_));
  nand3  g121(.a(new_n94_), .b(new_n74_), .c(new_n60_), .O(new_n173_));
  ...
  oai21  g128(.a(new_n177_), .b(new_n52_), .c(new_n179_), .O(z12));
  inv1   g129(.a(x29), .O(new_n181_));
  nand2  g130(.a(new_n174_), .b(new_n181_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n141_), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n113_), .c(new_n66_), .d(new_n65_), .O(new_n184_));
  ...
  aoi21  g138(.a(new_n52_), .b(new_n189_), .c(x18), .O(new_n190_));
  oai21  g139(.a(new_n188_), .b(new_n52_), .c(new_n190_), .O(z13));
  inv1   g140(.a(x30), .O(new_n192_));
  nand2  g141(.a(new_n185_), .b(new_n192_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n152_), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n125_), .c(new_n66_), .d(new_n65_), .O(new_n195_));
  ...
  nor3   g147(.a(new_n198_), .b(new_n196_), .c(new_n104_), .O(new_n199_));
  aoi21  g148(.a(new_n195_), .b(x33), .c(new_n199_), .O(new_n200_));
  inv1   g149(.a(x01), .O(new_n201_));
  aoi21  g150(.a(new_n52_), .b(new_n201_), .c(x18), .O(new_n202_));
  oai21  g151(.a(new_n200_), .b(new_n52_), .c(new_n202_), .O(z14));
  nor2   g152(.a(new_n198_), .b(new_n152_), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n125_), .c(new_n66_), .d(new_n65_), .O(new_n205_));
  inv1   g154(.a(x32), .O(new_n206_));
  nor2   g155(.a(x34), .b(x33), .O(new_n207_));
  nand3  g156(.a(new_n207_), .b(new_n174_), .c(new_n206_), .O(new_n208_));
  nor3   g157(.a(new_n208_), .b(new_n196_), .c(new_n104_), .O(new_n209_));
  aoi21  g158(.a(new_n205_), .b(x34), .c(new_n209_), .O(new_n210_));
  inv1   g159(.a(x00), .O(new_n211_));
  aoi21  g160(.a(new_n52_), .b(new_n211_), .c(x18), .O(new_n212_));
  oai21  g161(.a(new_n210_), .b(new_n52_), .c(new_n212_), .O(z15));
endmodule
