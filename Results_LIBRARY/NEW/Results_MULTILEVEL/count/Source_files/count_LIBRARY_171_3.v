...
module FAU ( 
  ...
  nand3  g033(.a(new_n76_), .b(new_n61_), .c(new_n52_), .O(new_n85_));
  ...
  oai21  g043(.a(new_n90_), .b(new_n58_), .c(new_n94_), .O(z04));
  inv1   g044(.a(new_n88_), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n68_), .c(new_n52_), .O(new_n97_));
  ...
  nand3  g053(.a(new_n100_), .b(new_n68_), .c(new_n52_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x25), .O(new_n106_));
  nor2   g055(.a(x25), .b(x24), .O(new_n107_));
  nand4  g056(.a(new_n107_), .b(new_n87_), .c(new_n70_), .d(new_n55_), .O(new_n108_));
  ...
  nand2  g063(.a(new_n107_), .b(new_n92_), .O(new_n115_));
  ...
  nand3  g069(.a(new_n120_), .b(new_n87_), .c(new_n119_), .O(new_n121_));
  ...
  nor2   g076(.a(new_n127_), .b(new_n88_), .O(new_n128_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n96_), .c(new_n68_), .d(new_n52_), .O(new_n141_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n100_), .c(new_n68_), .d(new_n52_), .O(new_n152_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n100_), .c(new_n68_), .d(new_n52_), .O(new_n163_));
  ...
  nand3  g124(.a(new_n98_), .b(new_n76_), .c(new_n63_), .O(new_n176_));
