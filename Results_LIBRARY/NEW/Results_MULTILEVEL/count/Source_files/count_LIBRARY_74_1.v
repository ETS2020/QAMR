...
module FAU ( 
  ...
  nand4  g118(.a(new_n169_), .b(new_n140_), .c(new_n117_), .d(new_n112_), .O(new_n170_));
  ...
  nand2  g124(.a(new_n151_), .b(new_n125_), .O(new_n176_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n152_), .c(new_n130_), .d(new_n113_), .O(new_n183_));
  ...
  nand3  g137(.a(new_n164_), .b(new_n151_), .c(new_n125_), .O(new_n189_));
  ...
  nand4  g143(.a(new_n194_), .b(new_n169_), .c(new_n140_), .d(new_n117_), .O(new_n195_));
  ...
  nand4  g154(.a(new_n205_), .b(new_n182_), .c(new_n152_), .d(new_n130_), .O(new_n206_));
