...
module FAU ( 
  ...
  nand3  g031(.a(new_n82_), .b(new_n62_), .c(new_n69_), .O(new_n83_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n106_), .c(new_n129_), .O(new_n131_));
  ...
  nand3  g086(.a(new_n98_), .b(new_n90_), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g091(.a(new_n142_), .b(new_n138_), .c(new_n67_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n54_), .c(new_n53_), .O(new_n144_));
  nand3  g093(.a(new_n82_), .b(new_n52_), .c(new_n69_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n131_), .c(x30), .O(new_n146_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n113_), .O(new_n155_));
  nand2  g104(.a(new_n154_), .b(new_n153_), .O(new_n156_));
  nor2   g105(.a(x31), .b(x30), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n130_), .c(new_n113_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  aoi21  g108(.a(new_n155_), .b(x31), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g112(.a(new_n158_), .b(new_n156_), .c(x32), .O(new_n164_));
  nand3  g113(.a(new_n69_), .b(new_n54_), .c(new_n53_), .O(new_n165_));
  ...
  nand3  g118(.a(new_n169_), .b(new_n166_), .c(new_n122_), .O(new_n170_));
  ...
  nand3  g124(.a(new_n153_), .b(new_n98_), .c(new_n82_), .O(new_n176_));
  nand3  g125(.a(new_n167_), .b(new_n141_), .c(new_n122_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(x33), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n157_), .c(new_n130_), .d(new_n140_), .O(new_n180_));
  ...
  oai21  g136(.a(new_n180_), .b(new_n176_), .c(x34), .O(new_n188_));
  nand2  g137(.a(new_n90_), .b(new_n52_), .O(new_n189_));
  ...
  nand3  g141(.a(new_n141_), .b(new_n139_), .c(new_n129_), .O(new_n193_));
  nor2   g142(.a(x34), .b(x33), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n167_), .O(new_n195_));
