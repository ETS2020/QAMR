...
module FAU ( 
  ...
  oai21  g006(.a(new_n57_), .b(x19), .c(x16), .O(new_n58_));
  ...
  nand4  g022(.a(new_n73_), .b(new_n62_), .c(new_n72_), .d(new_n71_), .O(new_n74_));
  inv1   g023(.a(new_n74_), .O(new_n75_));
  aoi21  g024(.a(new_n70_), .b(x22), .c(new_n75_), .O(new_n76_));
  ...
  aoi22  g029(.a(new_n80_), .b(new_n63_), .c(new_n74_), .d(x23), .O(new_n81_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n63_), .c(new_n62_), .O(new_n86_));
  nor3   g035(.a(x24), .b(x23), .c(x22), .O(new_n87_));
  aoi22  g036(.a(new_n87_), .b(new_n65_), .c(new_n86_), .d(x24), .O(new_n88_));
  ...
  aoi21  g041(.a(new_n87_), .b(new_n65_), .c(new_n92_), .O(new_n93_));
  nor2   g042(.a(x21), .b(x20), .O(new_n94_));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n85_), .c(new_n94_), .d(new_n71_), .O(new_n96_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n80_), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g084(.a(new_n112_), .b(new_n94_), .c(new_n73_), .d(new_n71_), .O(new_n136_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n113_), .c(new_n87_), .d(new_n65_), .O(new_n147_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n159_), .c(new_n158_), .d(new_n65_), .O(new_n165_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n176_), .c(new_n158_), .d(new_n65_), .O(new_n180_));
