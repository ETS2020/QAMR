...
module FAU ( 
  ...
  nor2   g119(.a(x32), .b(x30), .O(new_n171_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n145_), .c(new_n144_), .d(new_n134_), .O(new_n187_));
