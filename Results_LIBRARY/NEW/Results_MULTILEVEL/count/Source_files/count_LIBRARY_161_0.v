...
module FAU ( 
  ...
  nand3  g026(.a(new_n77_), .b(new_n54_), .c(new_n53_), .O(new_n78_));
  nand2  g027(.a(new_n69_), .b(new_n52_), .O(new_n79_));
  inv1   g028(.a(new_n79_), .O(new_n80_));
  oai21  g029(.a(new_n80_), .b(new_n76_), .c(new_n78_), .O(new_n81_));
  ...
  nand3  g035(.a(new_n86_), .b(new_n61_), .c(new_n54_), .O(new_n87_));
  nor2   g036(.a(new_n87_), .b(x17), .O(new_n88_));
  inv1   g037(.a(x23), .O(new_n89_));
  aoi21  g038(.a(new_n77_), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n76_), .c(new_n68_), .d(new_n61_), .O(new_n96_));
  nor2   g045(.a(new_n96_), .b(x19), .O(new_n97_));
  inv1   g046(.a(x24), .O(new_n98_));
  aoi21  g047(.a(new_n86_), .b(new_n63_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n89_), .c(new_n76_), .O(new_n105_));
  nor2   g054(.a(new_n105_), .b(x21), .O(new_n106_));
  nand4  g055(.a(new_n106_), .b(new_n61_), .c(new_n54_), .d(new_n53_), .O(new_n107_));
  nand4  g056(.a(new_n95_), .b(new_n63_), .c(new_n76_), .d(new_n68_), .O(new_n108_));
  ...
  oai21  g065(.a(new_n116_), .b(new_n79_), .c(x26), .O(new_n117_));
  nor3   g066(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n115_), .c(new_n80_), .O(new_n119_));
  ...
  or2    g071(.a(new_n122_), .b(new_n120_), .O(z07));
  inv1   g072(.a(x25), .O(new_n124_));
  inv1   g073(.a(x26), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n98_), .d(new_n89_), .O(new_n126_));
  inv1   g075(.a(new_n126_), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n76_), .c(new_n68_), .d(new_n61_), .O(new_n128_));
  nand3  g077(.a(new_n128_), .b(new_n54_), .c(new_n53_), .O(new_n129_));
  oai21  g078(.a(x19), .b(x17), .c(x27), .O(new_n130_));
