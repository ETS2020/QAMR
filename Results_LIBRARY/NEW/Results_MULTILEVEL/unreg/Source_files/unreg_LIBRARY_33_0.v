...
module FAU ( 
  ...
  oai21  g041(.a(x25), .b(x19), .c(new_n93_), .O(z05));
  ...
  nand2  g054(.a(new_n96_), .b(new_n60_), .O(new_n107_));
  ...
  nand2  g062(.a(new_n114_), .b(new_n60_), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n113_), .O(z08));
  nand2  g064(.a(new_n54_), .b(x10), .O(new_n117_));
  ...
  nand2  g069(.a(new_n110_), .b(new_n60_), .O(new_n122_));
  ...
  nand2  g097(.a(new_n138_), .b(new_n60_), .O(new_n150_));
  ...
  nand2  g104(.a(new_n146_), .b(new_n60_), .O(new_n157_));
