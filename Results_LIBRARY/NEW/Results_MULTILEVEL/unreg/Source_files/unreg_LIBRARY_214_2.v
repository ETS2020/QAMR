...
module FAU ( 
  ...
  nand2  g038(.a(new_n90_), .b(x25), .O(z05));
  nand2  g039(.a(new_n54_), .b(x05), .O(new_n92_));
  ...
  nand2  g065(.a(new_n106_), .b(new_n60_), .O(new_n118_));
  ...
  nand2  g072(.a(new_n114_), .b(new_n60_), .O(new_n125_));
