// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:17 2020
...
module FAU ( 
  ...
  oai21  g032(.a(x18), .b(new_n84_), .c(x25), .O(new_n85_));
  ...
  nand2  g050(.a(new_n91_), .b(new_n60_), .O(new_n103_));
  ...
  nand2  g081(.a(new_n87_), .b(x18), .O(new_n134_));
