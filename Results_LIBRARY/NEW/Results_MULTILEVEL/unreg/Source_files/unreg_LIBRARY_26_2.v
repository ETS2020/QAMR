// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:04 2020
...
module FAU ( 
  ...
  nand4  g088(.a(new_n140_), .b(x19), .c(x18), .d(new_n53_), .O(new_n141_));
  oai21  g089(.a(x32), .b(x19), .c(new_n141_), .O(z12));
  ...
  nand2  g095(.a(new_n140_), .b(new_n60_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n147_), .O(z13));
  nand2  g097(.a(new_n54_), .b(x13), .O(new_n150_));
  inv1   g098(.a(x35), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x18), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(x19), .c(new_n53_), .O(new_n154_));
  nand2  g102(.a(new_n144_), .b(new_n60_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n154_), .O(z14));
  nand2  g104(.a(new_n54_), .b(x12), .O(new_n157_));
  nand2  g105(.a(new_n117_), .b(x18), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g107(.a(new_n159_), .b(x19), .c(new_n53_), .O(new_n160_));
  nand2  g108(.a(new_n151_), .b(new_n60_), .O(new_n161_));
