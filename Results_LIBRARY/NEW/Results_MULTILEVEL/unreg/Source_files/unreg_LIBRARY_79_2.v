...
module FAU ( 
  ...
  nand4  g032(.a(new_n84_), .b(x19), .c(x18), .d(new_n53_), .O(new_n85_));
  ...
  nand2  g037(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand3  g038(.a(new_n90_), .b(x19), .c(new_n53_), .O(new_n91_));
  nand2  g039(.a(new_n84_), .b(new_n60_), .O(new_n92_));
  ...
  nand2  g046(.a(new_n88_), .b(new_n60_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n98_), .O(z06));
  nand2  g048(.a(new_n54_), .b(x04), .O(new_n101_));
  nand2  g049(.a(new_n61_), .b(x18), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(x19), .c(new_n53_), .O(new_n104_));
  nand2  g052(.a(new_n95_), .b(new_n60_), .O(new_n105_));
  ...
  nand2  g081(.a(new_n123_), .b(new_n60_), .O(new_n134_));
  ...
  nand2  g106(.a(new_n112_), .b(x18), .O(new_n159_));
