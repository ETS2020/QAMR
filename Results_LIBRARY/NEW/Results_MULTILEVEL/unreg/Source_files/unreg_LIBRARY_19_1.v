...
module FAU ( 
  ...
  nand2  g089(.a(new_n54_), .b(new_n141_), .O(new_n142_));
  nand4  g090(.a(new_n142_), .b(new_n140_), .c(x19), .d(new_n53_), .O(new_n143_));
  oai21  g091(.a(x32), .b(x19), .c(new_n143_), .O(z12));
  ...
  nand2  g107(.a(new_n117_), .b(x18), .O(new_n160_));
