...
module FAU ( 
  ...
  oai21  g102(.a(x18), .b(x13), .c(x19), .O(new_n155_));
  oai22  g103(.a(new_n155_), .b(x17), .c(x34), .d(x19), .O(z14));
  nand3  g104(.a(x19), .b(new_n54_), .c(x12), .O(new_n157_));
  nand2  g105(.a(new_n117_), .b(x18), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n53_), .O(new_n160_));
