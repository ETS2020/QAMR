...
module FAU ( 
  ...
  oai21  g087(.a(x18), .b(x15), .c(x19), .O(new_n140_));
  oai22  g088(.a(new_n140_), .b(x17), .c(x32), .d(x19), .O(z12));
  inv1   g089(.a(x33), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(new_n54_), .c(x14), .O(new_n143_));
  inv1   g091(.a(x34), .O(new_n144_));
  nand3  g092(.a(new_n144_), .b(x19), .c(x18), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n53_), .O(new_n147_));
  nand2  g095(.a(new_n142_), .b(new_n60_), .O(new_n148_));
