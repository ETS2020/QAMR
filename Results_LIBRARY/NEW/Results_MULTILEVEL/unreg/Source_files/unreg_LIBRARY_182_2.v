...
module FAU ( 
  ...
  nor2   g032(.a(x18), .b(x17), .O(new_n85_));
  aoi22  g033(.a(new_n85_), .b(x07), .c(new_n84_), .d(x18), .O(new_n86_));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  oai21  g036(.a(new_n86_), .b(new_n60_), .c(new_n88_), .O(z04));
  ...
  nand2  g042(.a(new_n84_), .b(new_n60_), .O(new_n95_));
