...
module FAU ( 
  ...
  nand2  g033(.a(new_n54_), .b(new_n85_), .O(new_n86_));
  nand4  g034(.a(new_n86_), .b(new_n84_), .c(x19), .d(new_n53_), .O(new_n87_));
  oai21  g035(.a(x24), .b(x19), .c(new_n87_), .O(z04));
  ...
  nand2  g041(.a(new_n84_), .b(new_n60_), .O(new_n94_));
  ...
  nand2  g083(.a(new_n125_), .b(new_n60_), .O(new_n136_));
  ...
  nand2  g093(.a(new_n54_), .b(x14), .O(new_n146_));
  ...
  nand2  g098(.a(new_n139_), .b(new_n60_), .O(new_n151_));
