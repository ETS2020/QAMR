// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:43 2020
...
module FAU ( 
  ...
  oai21  g011(.a(x18), .b(x02), .c(x19), .O(new_n64_));
  oai22  g012(.a(new_n64_), .b(x17), .c(x21), .d(x19), .O(z01));
  nand3  g013(.a(x19), .b(new_n54_), .c(x01), .O(new_n66_));
  inv1   g014(.a(x23), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(x18), .O(new_n68_));
  nand2  g016(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g017(.a(new_n69_), .b(new_n53_), .O(new_n70_));
  inv1   g018(.a(x22), .O(new_n71_));
  nand2  g019(.a(new_n71_), .b(new_n60_), .O(new_n72_));
  ...
  nand2  g025(.a(new_n67_), .b(new_n60_), .O(new_n78_));
  ...
  nand2  g040(.a(new_n81_), .b(new_n60_), .O(new_n93_));
  ...
  nand2  g068(.a(new_n109_), .b(new_n60_), .O(new_n121_));
  ...
  nand2  g075(.a(new_n117_), .b(new_n60_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n127_), .O(z10));
  nand2  g077(.a(new_n54_), .b(x08), .O(new_n130_));
  nand2  g078(.a(new_n85_), .b(x18), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g080(.a(new_n132_), .b(x19), .c(new_n53_), .O(new_n133_));
  nand2  g081(.a(new_n124_), .b(new_n60_), .O(new_n134_));
  ...
  nand2  g106(.a(new_n113_), .b(x18), .O(new_n159_));
