// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:11 2020
...
module FAU ( 
  ...
  oai21  g059(.a(x18), .b(x11), .c(x19), .O(new_n112_));
  oai22  g060(.a(new_n112_), .b(x17), .c(x28), .d(x19), .O(z08));
  ...
  nand2  g074(.a(new_n115_), .b(new_n60_), .O(new_n127_));
