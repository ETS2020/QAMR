// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:16 2020
...
module FAU ( 
  ...
  nand2  g075(.a(new_n116_), .b(new_n60_), .O(new_n128_));
  ...
  inv1   g106(.a(x28), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(x18), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g109(.a(new_n161_), .b(x19), .c(new_n53_), .O(new_n162_));
  nand2  g110(.a(new_n152_), .b(new_n60_), .O(new_n163_));
