...
module FAU ( 
  ...
  oai21  g022(.a(x22), .b(x19), .c(new_n74_), .O(z02));
  inv1   g023(.a(x00), .O(new_n76_));
  nand3  g024(.a(x19), .b(x18), .c(x16), .O(new_n77_));
  oai21  g025(.a(x18), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  nand2  g026(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  nand2  g027(.a(new_n71_), .b(new_n60_), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n79_), .O(z03));
  ...
  nand2  g042(.a(new_n83_), .b(new_n60_), .O(new_n95_));
  ...
  nand2  g049(.a(new_n91_), .b(new_n60_), .O(new_n102_));
  ...
  nand2  g055(.a(new_n98_), .b(new_n60_), .O(new_n108_));
  ...
  nand2  g070(.a(new_n111_), .b(new_n60_), .O(new_n123_));
