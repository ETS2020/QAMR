// Benchmark "FAU" written by ABC on Tue Jul 28 06:25:51 2020
...
module FAU ( 
  ...
  nor2   g441(.a(x36), .b(new_n106_), .O(new_n518_));
  nand3  g442(.a(new_n518_), .b(new_n82_), .c(x37), .O(new_n519_));
  nand2  g443(.a(new_n519_), .b(new_n517_), .O(new_n520_));
  nand2  g444(.a(new_n520_), .b(new_n180_), .O(new_n521_));
  ...
  inv1   g599(.a(new_n607_), .O(new_n676_));
  oai21  g600(.a(new_n676_), .b(new_n518_), .c(x32), .O(new_n677_));
  nand4  g601(.a(new_n339_), .b(x34), .c(new_n104_), .d(new_n95_), .O(new_n678_));
  aoi21  g602(.a(new_n678_), .b(new_n677_), .c(x35), .O(new_n679_));
  nor2   g603(.a(x39), .b(new_n79_), .O(new_n680_));
  oai21  g604(.a(new_n680_), .b(new_n82_), .c(new_n104_), .O(new_n681_));
  nand2  g605(.a(new_n86_), .b(x36), .O(new_n682_));
  aoi21  g606(.a(new_n682_), .b(new_n681_), .c(new_n97_), .O(new_n683_));
  aoi21  g607(.a(new_n683_), .b(new_n95_), .c(x32), .O(new_n684_));
  oai22  g608(.a(new_n684_), .b(new_n180_), .c(new_n79_), .d(new_n78_), .O(new_n685_));
  aoi21  g609(.a(new_n685_), .b(new_n106_), .c(new_n679_), .O(new_n686_));
  oai21  g610(.a(new_n686_), .b(x07), .c(x33), .O(z21));
  oai21  g611(.a(new_n643_), .b(new_n642_), .c(x38), .O(new_n688_));
  nor2   g612(.a(new_n147_), .b(x37), .O(new_n689_));
  aoi21  g613(.a(new_n665_), .b(new_n180_), .c(new_n689_), .O(new_n690_));
  oai21  g614(.a(new_n690_), .b(x36), .c(new_n688_), .O(new_n691_));
  nand3  g615(.a(new_n691_), .b(new_n78_), .c(x05), .O(new_n692_));
  aoi21  g616(.a(new_n692_), .b(new_n621_), .c(x34), .O(new_n693_));
  nand2  g617(.a(new_n478_), .b(new_n337_), .O(new_n694_));
  nor4   g618(.a(new_n694_), .b(x32), .c(new_n104_), .d(x00), .O(new_n695_));
  oai21  g619(.a(new_n695_), .b(new_n693_), .c(x33), .O(new_n696_));
  nor2   g620(.a(new_n696_), .b(x07), .O(z22));
  nand3  g621(.a(new_n342_), .b(x02), .c(new_n96_), .O(new_n698_));
  nand3  g622(.a(new_n86_), .b(x37), .c(x36), .O(new_n699_));
  inv1   g623(.a(new_n699_), .O(new_n700_));
  nand4  g624(.a(new_n700_), .b(new_n333_), .c(new_n167_), .d(x01), .O(new_n701_));
  nand2  g625(.a(new_n701_), .b(new_n698_), .O(new_n702_));
  nand3  g626(.a(new_n702_), .b(x04), .c(x00), .O(new_n703_));
  nand3  g627(.a(new_n91_), .b(x34), .c(new_n90_), .O(new_n704_));
  oai21  g628(.a(new_n704_), .b(new_n562_), .c(new_n703_), .O(new_n705_));
  nand2  g629(.a(new_n705_), .b(new_n89_), .O(new_n706_));
  nand2  g630(.a(new_n82_), .b(new_n106_), .O(new_n707_));
  nand2  g631(.a(new_n337_), .b(new_n180_), .O(new_n708_));
  aoi21  g632(.a(new_n708_), .b(new_n707_), .c(x00), .O(new_n709_));
  nand3  g633(.a(new_n360_), .b(new_n359_), .c(new_n86_), .O(new_n710_));
  oai21  g634(.a(new_n710_), .b(new_n120_), .c(new_n180_), .O(new_n711_));
  nand2  g635(.a(new_n148_), .b(new_n97_), .O(new_n712_));
  aoi21  g636(.a(new_n712_), .b(new_n711_), .c(x34), .O(new_n713_));
  oai21  g637(.a(new_n713_), .b(new_n709_), .c(x05), .O(new_n714_));
  nand3  g638(.a(new_n603_), .b(new_n601_), .c(new_n93_), .O(new_n715_));
  nand2  g639(.a(new_n715_), .b(x34), .O(new_n716_));
  nand4  g640(.a(new_n278_), .b(new_n122_), .c(new_n114_), .d(x15), .O(new_n717_));
  nand2  g641(.a(new_n717_), .b(new_n81_), .O(new_n718_));
  aoi21  g642(.a(new_n718_), .b(new_n277_), .c(new_n97_), .O(new_n719_));
  oai21  g643(.a(new_n719_), .b(new_n659_), .c(new_n80_), .O(new_n720_));
  oai21  g644(.a(new_n398_), .b(new_n365_), .c(x38), .O(new_n721_));
  nand2  g645(.a(new_n721_), .b(new_n396_), .O(new_n722_));
  nor2   g646(.a(new_n83_), .b(x09), .O(new_n723_));
  aoi21  g647(.a(new_n722_), .b(new_n97_), .c(new_n723_), .O(new_n724_));
  aoi21  g648(.a(new_n724_), .b(new_n720_), .c(x31), .O(new_n725_));
  oai21  g649(.a(new_n725_), .b(new_n200_), .c(new_n106_), .O(new_n726_));
  oai21  g650(.a(new_n726_), .b(x05), .c(new_n716_), .O(new_n727_));
  nand2  g651(.a(new_n727_), .b(new_n180_), .O(new_n728_));
  aoi21  g652(.a(new_n203_), .b(new_n202_), .c(new_n205_), .O(new_n729_));
  nor3   g653(.a(x31), .b(x14), .c(x05), .O(new_n730_));
  oai21  g654(.a(new_n730_), .b(new_n729_), .c(x37), .O(new_n731_));
  nand3  g655(.a(new_n97_), .b(x35), .c(new_n104_), .O(new_n732_));
  oai21  g656(.a(new_n731_), .b(new_n113_), .c(new_n732_), .O(new_n733_));
  nand3  g657(.a(new_n733_), .b(new_n81_), .c(new_n80_), .O(new_n734_));
  nand3  g658(.a(new_n84_), .b(x35), .c(new_n104_), .O(new_n735_));
  nand2  g659(.a(new_n735_), .b(new_n734_), .O(new_n736_));
  nand2  g660(.a(new_n736_), .b(x11), .O(new_n737_));
  nand4  g661(.a(new_n148_), .b(x24), .c(x22), .d(x21), .O(new_n738_));
  aoi21  g662(.a(new_n738_), .b(new_n300_), .c(x37), .O(new_n739_));
  nand4  g663(.a(new_n739_), .b(x35), .c(x12), .d(new_n104_), .O(new_n740_));
  aoi21  g664(.a(new_n740_), .b(new_n737_), .c(new_n107_), .O(new_n741_));
  nand2  g665(.a(new_n215_), .b(new_n104_), .O(new_n742_));
  oai21  g666(.a(new_n580_), .b(new_n80_), .c(x37), .O(new_n743_));
  aoi21  g667(.a(new_n743_), .b(new_n742_), .c(new_n180_), .O(new_n744_));
  oai21  g668(.a(new_n744_), .b(new_n741_), .c(new_n106_), .O(new_n745_));
  nand3  g669(.a(new_n745_), .b(new_n728_), .c(new_n714_), .O(new_n746_));
  nand2  g670(.a(new_n746_), .b(new_n79_), .O(new_n747_));
  nand2  g671(.a(new_n522_), .b(new_n80_), .O(new_n748_));
  nand2  g672(.a(new_n748_), .b(new_n312_), .O(new_n749_));
  nand3  g673(.a(new_n749_), .b(x37), .c(x00), .O(new_n750_));
  aoi21  g674(.a(new_n750_), .b(new_n338_), .c(new_n180_), .O(new_n751_));
  inv1   g675(.a(x27), .O(new_n752_));
  nor2   g676(.a(new_n752_), .b(x10), .O(new_n753_));
  nand3  g677(.a(new_n753_), .b(x38), .c(x10), .O(new_n754_));
  nand2  g678(.a(new_n754_), .b(new_n97_), .O(new_n755_));
  aoi21  g679(.a(new_n755_), .b(new_n515_), .c(x35), .O(new_n756_));
  oai21  g680(.a(new_n756_), .b(new_n751_), .c(new_n81_), .O(new_n757_));
  oai21  g681(.a(x38), .b(x35), .c(new_n97_), .O(new_n758_));
  nand2  g682(.a(new_n568_), .b(new_n171_), .O(new_n759_));
  nand3  g683(.a(new_n759_), .b(x38), .c(x35), .O(new_n760_));
  nand2  g684(.a(new_n760_), .b(x37), .O(new_n761_));
  nand2  g685(.a(new_n761_), .b(new_n758_), .O(new_n762_));
  nand2  g686(.a(x05), .b(new_n95_), .O(new_n763_));
  nor3   g687(.a(new_n763_), .b(new_n515_), .c(new_n180_), .O(new_n764_));
  aoi21  g688(.a(new_n762_), .b(x39), .c(new_n764_), .O(new_n765_));
  aoi21  g689(.a(new_n765_), .b(new_n757_), .c(x34), .O(new_n766_));
  and2   g690(.a(new_n336_), .b(new_n689_), .O(new_n767_));
  oai21  g691(.a(new_n767_), .b(new_n766_), .c(x36), .O(new_n768_));
  nand3  g692(.a(new_n768_), .b(new_n747_), .c(new_n706_), .O(new_n769_));
  nand2  g693(.a(new_n769_), .b(new_n78_), .O(new_n770_));
  aoi21  g694(.a(new_n770_), .b(new_n77_), .c(new_n193_), .O(z23));
  oai21  g695(.a(new_n130_), .b(new_n97_), .c(new_n306_), .O(new_n772_));
  nand3  g696(.a(new_n772_), .b(x35), .c(new_n106_), .O(new_n773_));
  nand2  g697(.a(new_n773_), .b(new_n540_), .O(new_n774_));
  nand2  g698(.a(new_n774_), .b(new_n79_), .O(new_n775_));
  nor2   g699(.a(new_n555_), .b(x34), .O(new_n776_));
  oai21  g700(.a(new_n776_), .b(new_n767_), .c(x36), .O(new_n777_));
  nand2  g701(.a(new_n777_), .b(new_n775_), .O(new_n778_));
  nand4  g702(.a(new_n778_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n779_));
  inv1   g703(.a(new_n779_), .O(z24));
  nand3  g704(.a(new_n627_), .b(new_n89_), .c(x02), .O(new_n781_));
  inv1   g705(.a(new_n781_), .O(new_n782_));
  nand3  g706(.a(new_n782_), .b(new_n96_), .c(x00), .O(new_n783_));
  nand4  g707(.a(new_n123_), .b(x37), .c(new_n180_), .d(new_n105_), .O(new_n784_));
  nand3  g708(.a(new_n153_), .b(new_n97_), .c(x35), .O(new_n785_));
  nand2  g709(.a(new_n785_), .b(new_n784_), .O(new_n786_));
  nand3  g710(.a(new_n786_), .b(new_n81_), .c(new_n80_), .O(new_n787_));
  nand4  g711(.a(new_n147_), .b(new_n180_), .c(new_n105_), .d(new_n111_), .O(new_n788_));
  nand4  g712(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n789_));
  nand4  g713(.a(new_n789_), .b(x39), .c(x38), .d(x35), .O(new_n790_));
  oai21  g714(.a(new_n788_), .b(x09), .c(new_n790_), .O(new_n791_));
  nand2  g715(.a(new_n791_), .b(new_n97_), .O(new_n792_));
  nand2  g716(.a(new_n792_), .b(new_n787_), .O(new_n793_));
  nand3  g717(.a(new_n793_), .b(new_n114_), .c(x15), .O(new_n794_));
  nand4  g718(.a(new_n535_), .b(x39), .c(new_n180_), .d(new_n105_), .O(new_n795_));
  nand2  g719(.a(new_n795_), .b(new_n794_), .O(new_n796_));
  nand3  g720(.a(new_n796_), .b(new_n79_), .c(new_n104_), .O(new_n797_));
  inv1   g721(.a(new_n797_), .O(new_n798_));
  nand3  g722(.a(new_n260_), .b(x37), .c(x35), .O(new_n799_));
  aoi21  g723(.a(new_n799_), .b(new_n554_), .c(new_n79_), .O(new_n800_));
  oai21  g724(.a(new_n800_), .b(new_n798_), .c(new_n106_), .O(new_n801_));
  nand3  g725(.a(new_n586_), .b(new_n689_), .c(x34), .O(new_n802_));
  nand3  g726(.a(new_n802_), .b(new_n801_), .c(new_n783_), .O(new_n803_));
  nand4  g727(.a(new_n803_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n804_));
  inv1   g728(.a(new_n804_), .O(z25));
  oai21  g729(.a(new_n93_), .b(x36), .c(new_n607_), .O(new_n806_));
  nand3  g730(.a(new_n806_), .b(new_n180_), .c(x34), .O(new_n807_));
  nand3  g731(.a(new_n98_), .b(new_n167_), .c(x01), .O(new_n808_));
  nand4  g732(.a(new_n808_), .b(new_n81_), .c(new_n80_), .d(x37), .O(new_n809_));
  nor2   g733(.a(new_n809_), .b(new_n79_), .O(new_n810_));
  nand4  g734(.a(new_n810_), .b(x35), .c(new_n106_), .d(x00), .O(new_n811_));
  nand2  g735(.a(new_n811_), .b(new_n807_), .O(new_n812_));
  nand4  g736(.a(new_n812_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n813_));
  inv1   g737(.a(new_n813_), .O(z26));
  nand3  g738(.a(new_n292_), .b(new_n82_), .c(new_n180_), .O(new_n815_));
  nand2  g739(.a(new_n815_), .b(new_n794_), .O(new_n816_));
  nand3  g740(.a(new_n816_), .b(new_n79_), .c(new_n104_), .O(new_n817_));
  nand2  g741(.a(new_n475_), .b(new_n422_), .O(new_n818_));
  nand2  g742(.a(new_n818_), .b(new_n817_), .O(new_n819_));
  nand4  g743(.a(new_n819_), .b(new_n106_), .c(x33), .d(new_n78_), .O(new_n820_));
  nor2   g744(.a(new_n820_), .b(x07), .O(z27));
  nor2   g745(.a(x35), .b(x34), .O(new_n822_));
  nand4  g746(.a(new_n822_), .b(new_n606_), .c(new_n184_), .d(new_n321_), .O(new_n823_));
  nand2  g747(.a(new_n823_), .b(new_n783_), .O(new_n824_));
  nand4  g748(.a(new_n824_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n825_));
  inv1   g749(.a(new_n825_), .O(z28));
  nand4  g750(.a(new_n148_), .b(new_n114_), .c(new_n97_), .d(x35), .O(new_n827_));
  nor2   g751(.a(new_n827_), .b(new_n461_), .O(new_n828_));
  nand4  g752(.a(new_n828_), .b(x22), .c(new_n150_), .d(x15), .O(new_n829_));
  nand4  g753(.a(new_n139_), .b(x39), .c(new_n80_), .d(x37), .O(new_n830_));
  inv1   g754(.a(new_n830_), .O(new_n831_));
  nand3  g755(.a(new_n831_), .b(new_n180_), .c(new_n105_), .O(new_n832_));
  nand2  g756(.a(new_n832_), .b(new_n829_), .O(new_n833_));
  nand3  g757(.a(new_n833_), .b(new_n79_), .c(new_n104_), .O(new_n834_));
  nand2  g758(.a(new_n834_), .b(new_n818_), .O(new_n835_));
  nand4  g759(.a(new_n835_), .b(new_n106_), .c(x33), .d(new_n78_), .O(new_n836_));
  nor2   g760(.a(new_n836_), .b(x07), .O(z29));
  inv1   g761(.a(new_n148_), .O(new_n838_));
  nand2  g762(.a(x22), .b(x21), .O(new_n839_));
  inv1   g763(.a(x23), .O(new_n840_));
  nand2  g764(.a(new_n82_), .b(new_n840_), .O(new_n841_));
  oai22  g765(.a(new_n841_), .b(new_n839_), .c(new_n152_), .d(new_n838_), .O(new_n842_));
  nand4  g766(.a(new_n842_), .b(new_n114_), .c(new_n79_), .d(x35), .O(new_n843_));
  inv1   g767(.a(new_n843_), .O(new_n844_));
  nand4  g768(.a(new_n844_), .b(x24), .c(x15), .d(new_n104_), .O(new_n845_));
  inv1   g769(.a(new_n552_), .O(new_n846_));
  nand3  g770(.a(new_n846_), .b(new_n321_), .c(x36), .O(new_n847_));
  aoi21  g771(.a(new_n847_), .b(new_n845_), .c(x37), .O(new_n848_));
  nand4  g772(.a(new_n848_), .b(new_n106_), .c(x33), .d(new_n78_), .O(new_n849_));
  nor2   g773(.a(new_n849_), .b(x07), .O(z30));
  nand2  g774(.a(new_n148_), .b(new_n461_), .O(new_n851_));
  aoi21  g775(.a(new_n851_), .b(new_n302_), .c(new_n127_), .O(new_n852_));
  nand4  g776(.a(new_n852_), .b(new_n79_), .c(x35), .d(x15), .O(new_n853_));
  oai21  g777(.a(new_n853_), .b(x05), .c(new_n847_), .O(new_n854_));
  nand3  g778(.a(new_n854_), .b(new_n97_), .c(new_n106_), .O(new_n855_));
  nand2  g779(.a(new_n855_), .b(new_n783_), .O(new_n856_));
  nand4  g780(.a(new_n856_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n857_));
  inv1   g781(.a(new_n857_), .O(z31));
  nand4  g782(.a(new_n106_), .b(x33), .c(new_n78_), .d(new_n77_), .O(new_n859_));
  nor2   g783(.a(new_n859_), .b(new_n180_), .O(new_n860_));
  nand4  g784(.a(new_n860_), .b(x38), .c(x37), .d(new_n79_), .O(new_n861_));
  nor2   g785(.a(new_n861_), .b(x39), .O(z32));
  nand2  g786(.a(x38), .b(new_n96_), .O(new_n863_));
  nand2  g787(.a(new_n86_), .b(x01), .O(new_n864_));
  aoi21  g788(.a(new_n864_), .b(new_n863_), .c(new_n180_), .O(new_n865_));
  nand4  g789(.a(new_n865_), .b(x04), .c(new_n89_), .d(new_n167_), .O(new_n866_));
  oai22  g790(.a(new_n866_), .b(new_n95_), .c(new_n147_), .d(x35), .O(new_n867_));
  nand2  g791(.a(new_n867_), .b(x36), .O(new_n868_));
  inv1   g792(.a(new_n484_), .O(new_n869_));
  oai21  g793(.a(new_n657_), .b(new_n869_), .c(new_n80_), .O(new_n870_));
  nand2  g794(.a(new_n82_), .b(x09), .O(new_n871_));
  aoi21  g795(.a(new_n871_), .b(new_n870_), .c(x36), .O(new_n872_));
  nand4  g796(.a(new_n872_), .b(new_n180_), .c(new_n105_), .d(new_n104_), .O(new_n873_));
  aoi21  g797(.a(new_n873_), .b(new_n868_), .c(new_n97_), .O(new_n874_));
  nand2  g798(.a(new_n436_), .b(x35), .O(new_n875_));
  nand2  g799(.a(new_n647_), .b(x38), .O(new_n876_));
  nand2  g800(.a(new_n649_), .b(new_n80_), .O(new_n877_));
  nand2  g801(.a(new_n877_), .b(new_n876_), .O(new_n878_));
  nand3  g802(.a(new_n878_), .b(new_n180_), .c(new_n105_), .O(new_n879_));
  aoi21  g803(.a(new_n879_), .b(new_n875_), .c(x05), .O(new_n880_));
  nand2  g804(.a(new_n321_), .b(x35), .O(new_n881_));
  inv1   g805(.a(new_n881_), .O(new_n882_));
  oai21  g806(.a(new_n882_), .b(new_n880_), .c(new_n79_), .O(new_n883_));
  nand2  g807(.a(new_n80_), .b(x35), .O(new_n884_));
  aoi21  g808(.a(new_n884_), .b(new_n374_), .c(x39), .O(new_n885_));
  oai21  g809(.a(new_n885_), .b(new_n82_), .c(x36), .O(new_n886_));
  aoi21  g810(.a(new_n886_), .b(new_n883_), .c(x37), .O(new_n887_));
  oai21  g811(.a(new_n887_), .b(new_n874_), .c(new_n106_), .O(new_n888_));
  nand3  g812(.a(new_n97_), .b(x04), .c(x00), .O(new_n889_));
  nand2  g813(.a(new_n369_), .b(new_n90_), .O(new_n890_));
  aoi21  g814(.a(new_n890_), .b(new_n889_), .c(x38), .O(new_n891_));
  nand4  g815(.a(new_n891_), .b(new_n89_), .c(new_n167_), .d(new_n96_), .O(new_n892_));
  nand2  g816(.a(new_n892_), .b(new_n322_), .O(new_n893_));
  nand4  g817(.a(new_n893_), .b(new_n79_), .c(new_n180_), .d(x34), .O(new_n894_));
  aoi21  g818(.a(new_n894_), .b(new_n888_), .c(x32), .O(new_n895_));
  oai21  g819(.a(new_n895_), .b(x07), .c(x33), .O(new_n896_));
  oai21  g820(.a(x33), .b(new_n78_), .c(new_n896_), .O(z33));
  nand2  g821(.a(new_n342_), .b(new_n96_), .O(new_n898_));
  nand3  g822(.a(new_n700_), .b(new_n333_), .c(x01), .O(new_n899_));
  aoi21  g823(.a(new_n899_), .b(new_n898_), .c(new_n90_), .O(new_n900_));
  nand4  g824(.a(new_n900_), .b(new_n89_), .c(new_n167_), .d(x00), .O(new_n901_));
  nand2  g825(.a(new_n691_), .b(x05), .O(new_n902_));
  nand2  g826(.a(new_n88_), .b(x36), .O(new_n903_));
  oai22  g827(.a(new_n876_), .b(x37), .c(new_n660_), .d(x38), .O(new_n904_));
  nand4  g828(.a(new_n904_), .b(new_n79_), .c(new_n105_), .d(new_n104_), .O(new_n905_));
  nand2  g829(.a(new_n905_), .b(new_n903_), .O(new_n906_));
  nand2  g830(.a(new_n906_), .b(new_n180_), .O(new_n907_));
  nand3  g831(.a(new_n602_), .b(new_n79_), .c(x35), .O(new_n908_));
  nand3  g832(.a(new_n908_), .b(new_n907_), .c(new_n902_), .O(new_n909_));
  nand2  g833(.a(new_n909_), .b(new_n106_), .O(new_n910_));
  nand2  g834(.a(x37), .b(x34), .O(new_n911_));
  oai22  g835(.a(new_n911_), .b(new_n130_), .c(new_n763_), .d(new_n338_), .O(new_n912_));
  nand3  g836(.a(new_n912_), .b(new_n79_), .c(new_n180_), .O(new_n913_));
  nand3  g837(.a(new_n913_), .b(new_n910_), .c(new_n901_), .O(new_n914_));
  nand2  g838(.a(new_n914_), .b(new_n78_), .O(new_n915_));
  aoi21  g839(.a(new_n915_), .b(new_n77_), .c(new_n193_), .O(z34));
  nor2   g840(.a(new_n193_), .b(new_n77_), .O(z15));
endmodule
