...
module FAU ( 
  ...
  inv1   g55(.a(x20), .O(new_n101_));
  inv1   g56(.a(x22), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n87_), .c(x21), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n101_), .c(x19), .d(x18), .O(new_n104_));
  nand3  g59(.a(new_n52_), .b(new_n84_), .c(new_n83_), .O(new_n105_));
  aoi21  g60(.a(new_n97_), .b(x21), .c(new_n105_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n104_), .O(z14));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(x19), .c(x18), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n74_), .b(new_n73_), .c(new_n101_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n99_), .d(new_n52_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  nand4  g68(.a(new_n108_), .b(new_n73_), .c(new_n48_), .d(new_n102_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n113_), .c(new_n99_), .d(new_n52_), .O(z16));
  nand2  g70(.a(new_n78_), .b(new_n102_), .O(new_n116_));
  nor3   g71(.a(new_n116_), .b(x21), .c(x20), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(x19), .c(x18), .d(x17), .O(new_n118_));
  aoi21  g73(.a(new_n114_), .b(x24), .c(new_n105_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n118_), .O(z17));
  nand2  g75(.a(new_n79_), .b(x25), .O(new_n121_));
  nor3   g76(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n77_), .c(new_n75_), .d(new_n74_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n99_), .d(new_n52_), .O(z18));
