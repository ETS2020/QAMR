// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:33 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n76_), .b(new_n51_), .c(new_n50_), .O(new_n77_));
  aoi21  g32(.a(new_n77_), .b(new_n49_), .c(new_n75_), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(x21), .c(x23), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(new_n74_), .c(new_n48_), .O(z08));
  inv1   g35(.a(x07), .O(new_n81_));
  inv1   g36(.a(x15), .O(new_n82_));
  nand3  g37(.a(new_n59_), .b(new_n82_), .c(new_n81_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z09));
  nand4  g39(.a(new_n58_), .b(new_n50_), .c(new_n82_), .d(new_n81_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z10));
  xor2a  g41(.a(x18), .b(x17), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n58_), .c(new_n82_), .d(new_n81_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z11));
  nor2   g44(.a(new_n51_), .b(new_n50_), .O(new_n90_));
  nand3  g45(.a(new_n76_), .b(x18), .c(x17), .O(new_n91_));
  oai21  g46(.a(new_n90_), .b(new_n76_), .c(new_n91_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n58_), .c(new_n82_), .d(new_n81_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z12));
  nand4  g49(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n95_));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand3  g51(.a(new_n58_), .b(new_n82_), .c(new_n81_), .O(new_n97_));
  aoi21  g52(.a(new_n96_), .b(x20), .c(new_n97_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n95_), .O(z13));
  nor2   g54(.a(x15), .b(x07), .O(new_n100_));
  nand3  g55(.a(new_n90_), .b(new_n49_), .c(x19), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x21), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n90_), .c(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(new_n100_), .d(new_n58_), .O(z14));
  nor2   g60(.a(new_n76_), .b(new_n50_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n51_), .c(new_n58_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n82_), .O(new_n108_));
  oai21  g63(.a(x20), .b(new_n51_), .c(x22), .O(new_n109_));
  nand3  g64(.a(x21), .b(new_n49_), .c(x19), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n90_), .c(x15), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n108_), .d(new_n81_), .O(z15));
  inv1   g68(.a(x23), .O(new_n114_));
  nand4  g69(.a(new_n58_), .b(new_n114_), .c(new_n82_), .d(new_n81_), .O(z16));
  nand4  g70(.a(new_n58_), .b(new_n74_), .c(new_n82_), .d(new_n81_), .O(z17));
  nand4  g71(.a(new_n58_), .b(new_n48_), .c(new_n82_), .d(new_n81_), .O(z18));
