// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:53 2020
...
module FAU ( 
  ...
  nand3  g52(.a(new_n59_), .b(new_n52_), .c(x17), .O(new_n98_));
  ...
  nand3  g57(.a(new_n59_), .b(x19), .c(new_n52_), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n93_), .c(new_n48_), .O(new_n105_));
