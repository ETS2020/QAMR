...
module FAU ( 
  ...
  nand4  g27(.a(x24), .b(x22), .c(new_n72_), .d(new_n71_), .O(new_n73_));
  ...
  nor2   g39(.a(x23), .b(x22), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n81_), .c(new_n76_), .d(new_n80_), .O(new_n87_));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n53_), .O(z13));
  nand2  g63(.a(new_n107_), .b(x21), .O(new_n109_));
  nand3  g64(.a(new_n99_), .b(new_n84_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n109_), .c(new_n105_), .d(new_n53_), .O(z14));
  nand2  g66(.a(new_n110_), .b(x22), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n83_), .c(new_n106_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n105_), .d(new_n53_), .O(z15));
  nand3  g70(.a(new_n85_), .b(new_n80_), .c(new_n106_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(x19), .c(x18), .d(x17), .O(new_n118_));
  nand3  g73(.a(new_n53_), .b(new_n91_), .c(new_n90_), .O(new_n119_));
  aoi21  g74(.a(new_n114_), .b(x23), .c(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(z16));
  nand4  g76(.a(new_n118_), .b(new_n105_), .c(new_n53_), .d(new_n49_), .O(z17));
  nand2  g77(.a(new_n86_), .b(x25), .O(new_n123_));
  inv1   g78(.a(new_n107_), .O(new_n124_));
  nand4  g79(.a(new_n113_), .b(new_n124_), .c(new_n70_), .d(new_n48_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n105_), .d(new_n53_), .O(z18));
