...
module FAU ( 
  ...
  nand3  g52(.a(new_n52_), .b(x17), .c(new_n48_), .O(new_n98_));
  oai21  g53(.a(new_n52_), .b(x17), .c(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n59_), .c(new_n93_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z11));
  xnor2a g56(.a(x19), .b(x17), .O(new_n102_));
  nand3  g57(.a(x19), .b(new_n52_), .c(new_n48_), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n52_), .c(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n59_), .c(new_n93_), .O(new_n105_));
