...
module FAU ( 
  ...
  nor3   g28(.a(new_n73_), .b(x19), .c(x18), .O(new_n74_));
  oai21  g29(.a(new_n74_), .b(x25), .c(new_n72_), .O(new_n75_));
  inv1   g30(.a(new_n73_), .O(new_n76_));
  oai21  g31(.a(new_n76_), .b(x25), .c(x20), .O(new_n77_));
  oai21  g32(.a(x25), .b(x24), .c(x23), .O(new_n78_));
  nand3  g33(.a(new_n50_), .b(x19), .c(x18), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(new_n80_));
  and2   g35(.a(x18), .b(x17), .O(new_n81_));
  inv1   g36(.a(x19), .O(new_n82_));
  nor2   g37(.a(x20), .b(new_n82_), .O(new_n83_));
  ...
  nand4  g41(.a(new_n86_), .b(new_n80_), .c(new_n49_), .d(new_n51_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x25), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n78_), .c(new_n77_), .d(new_n75_), .O(z08));
  ...
  nand3  g53(.a(new_n82_), .b(x18), .c(x17), .O(new_n99_));
  oai21  g54(.a(new_n81_), .b(new_n82_), .c(new_n99_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n56_), .c(new_n91_), .d(new_n90_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  nand2  g57(.a(new_n83_), .b(new_n81_), .O(new_n103_));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nor2   g60(.a(x15), .b(x07), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n103_), .d(new_n56_), .O(z13));
  nand2  g62(.a(new_n103_), .b(x21), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n81_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n106_), .d(new_n56_), .O(z14));
  inv1   g66(.a(x20), .O(new_n112_));
  inv1   g67(.a(x18), .O(new_n113_));
  aoi21  g68(.a(new_n48_), .b(new_n113_), .c(x22), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n50_), .c(new_n112_), .d(x19), .O(new_n115_));
  nand3  g70(.a(new_n56_), .b(new_n91_), .c(new_n90_), .O(new_n116_));
  aoi21  g71(.a(new_n110_), .b(x22), .c(new_n116_), .O(new_n117_));
  oai21  g72(.a(new_n115_), .b(new_n72_), .c(new_n117_), .O(z15));
  nand2  g73(.a(x19), .b(x17), .O(new_n119_));
  nand2  g74(.a(new_n84_), .b(new_n112_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n119_), .c(x23), .O(new_n121_));
  inv1   g76(.a(new_n104_), .O(new_n122_));
  nand4  g77(.a(new_n109_), .b(new_n122_), .c(new_n48_), .d(new_n51_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n106_), .d(new_n56_), .O(z16));
  nand3  g79(.a(new_n85_), .b(new_n51_), .c(new_n50_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(x20), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(x19), .c(x18), .d(x17), .O(new_n127_));
  aoi21  g82(.a(new_n123_), .b(x24), .c(new_n116_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n127_), .O(z17));
  nand2  g84(.a(new_n86_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n84_), .c(new_n83_), .d(new_n81_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n106_), .d(new_n56_), .O(z18));
