...
module FAU ( 
  ...
  nor2   g36(.a(x21), .b(new_n52_), .O(new_n82_));
  nor2   g37(.a(x20), .b(new_n52_), .O(new_n83_));
  ...
  nand2  g47(.a(new_n80_), .b(new_n53_), .O(new_n93_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z11));
  nor2   g53(.a(new_n52_), .b(new_n51_), .O(new_n99_));
  nand3  g54(.a(new_n53_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n102_));
  ...
  nand3  g61(.a(new_n99_), .b(new_n50_), .c(x19), .O(new_n107_));
  ...
  nand2  g67(.a(x22), .b(new_n51_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n100_), .c(new_n59_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n90_), .O(new_n115_));
  nand2  g70(.a(new_n110_), .b(x18), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n99_), .b(new_n84_), .c(new_n50_), .O(new_n118_));
  and2   g73(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n115_), .d(new_n48_), .O(z15));
  nand2  g75(.a(new_n118_), .b(x23), .O(new_n121_));
  inv1   g76(.a(x21), .O(new_n122_));
  nor2   g77(.a(x23), .b(x22), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n83_), .c(new_n122_), .d(x17), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n121_), .c(new_n106_), .d(new_n59_), .O(z16));
  nand3  g80(.a(new_n85_), .b(new_n80_), .c(new_n122_), .O(new_n126_));
  inv1   g81(.a(new_n126_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n50_), .c(x18), .d(x17), .O(new_n128_));
  nand3  g83(.a(new_n59_), .b(new_n90_), .c(new_n48_), .O(new_n129_));
  aoi21  g84(.a(new_n124_), .b(x24), .c(new_n129_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n128_), .O(z17));
  nand2  g86(.a(new_n86_), .b(x25), .O(new_n132_));
  nor2   g87(.a(x25), .b(x24), .O(new_n133_));
  nand4  g88(.a(new_n123_), .b(new_n110_), .c(new_n99_), .d(new_n133_), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n132_), .c(new_n106_), .d(new_n59_), .O(z18));
