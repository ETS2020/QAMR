...
module FAU ( 
  ...
  nand2  g33(.a(new_n76_), .b(new_n72_), .O(new_n79_));
  ...
  nor2   g41(.a(x21), .b(x20), .O(new_n87_));
  nor2   g42(.a(x24), .b(x22), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(x25), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n81_), .c(new_n80_), .d(new_n78_), .O(z08));
  ...
  nand2  g61(.a(new_n85_), .b(x20), .O(new_n107_));
  nor2   g62(.a(x15), .b(x07), .O(new_n108_));
  inv1   g63(.a(x20), .O(new_n109_));
  nand3  g64(.a(new_n102_), .b(new_n109_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n55_), .O(z13));
  nand2  g66(.a(new_n110_), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n102_), .b(new_n87_), .c(x19), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n112_), .c(new_n108_), .d(new_n55_), .O(z14));
  nand2  g69(.a(new_n113_), .b(x22), .O(new_n115_));
  nor2   g70(.a(x22), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n86_), .c(new_n109_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n108_), .d(new_n55_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nand4  g74(.a(new_n87_), .b(new_n86_), .c(new_n48_), .d(new_n83_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n119_), .c(new_n108_), .d(new_n55_), .O(z16));
  nand2  g76(.a(new_n72_), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n49_), .c(new_n83_), .d(new_n82_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x20), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(x19), .c(x18), .d(x17), .O(new_n125_));
  nand3  g80(.a(new_n55_), .b(new_n94_), .c(new_n93_), .O(new_n126_));
  aoi21  g81(.a(new_n120_), .b(x24), .c(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(z17));
  nand2  g83(.a(new_n89_), .b(x25), .O(new_n129_));
  inv1   g84(.a(new_n110_), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand3  g86(.a(new_n131_), .b(new_n116_), .c(new_n130_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n129_), .c(new_n108_), .d(new_n55_), .O(z18));
