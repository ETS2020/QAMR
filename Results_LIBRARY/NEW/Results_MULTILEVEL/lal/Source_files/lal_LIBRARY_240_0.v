...
module FAU ( 
  ...
  nand4  g32(.a(new_n53_), .b(new_n77_), .c(new_n74_), .d(new_n73_), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(z10));
  xor2a  g34(.a(x18), .b(x17), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n53_), .c(new_n74_), .d(new_n73_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z11));
  inv1   g37(.a(x19), .O(new_n83_));
  and2   g38(.a(x18), .b(x17), .O(new_n84_));
  nand3  g39(.a(new_n83_), .b(x18), .c(x17), .O(new_n85_));
  oai21  g40(.a(new_n84_), .b(new_n83_), .c(new_n85_), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n53_), .c(new_n74_), .d(new_n73_), .O(new_n87_));
  ...
  nand3  g47(.a(new_n84_), .b(new_n92_), .c(x19), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(new_n53_), .O(z13));
  nand2  g49(.a(new_n93_), .b(x21), .O(new_n95_));
  nor2   g50(.a(x21), .b(x20), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n84_), .c(x19), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n95_), .c(new_n91_), .d(new_n53_), .O(z14));
  nand2  g53(.a(new_n97_), .b(x22), .O(new_n99_));
  inv1   g54(.a(new_n89_), .O(new_n100_));
  nor2   g55(.a(x22), .b(x21), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n92_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n99_), .c(new_n91_), .d(new_n53_), .O(z15));
  nand2  g58(.a(new_n102_), .b(x23), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n53_), .c(new_n74_), .d(new_n73_), .O(z16));
  nand4  g60(.a(new_n53_), .b(new_n49_), .c(new_n74_), .d(new_n73_), .O(z17));
  nand4  g61(.a(new_n53_), .b(new_n69_), .c(new_n74_), .d(new_n73_), .O(z18));
