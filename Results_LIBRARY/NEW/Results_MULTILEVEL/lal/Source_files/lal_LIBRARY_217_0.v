...
module FAU ( 
  ...
  nand4  g27(.a(x24), .b(x22), .c(new_n53_), .d(new_n52_), .O(new_n73_));
  ...
  nand4  g49(.a(new_n94_), .b(new_n59_), .c(new_n51_), .d(new_n90_), .O(new_n95_));
  nor2   g50(.a(new_n95_), .b(x07), .O(z10));
  nand2  g51(.a(x18), .b(new_n51_), .O(new_n97_));
  nand2  g52(.a(new_n52_), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n105_));
  ...
  nand3  g64(.a(new_n83_), .b(x18), .c(x17), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n59_), .O(z13));
  nand2  g66(.a(x21), .b(new_n51_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n98_), .c(new_n59_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n90_), .O(new_n114_));
  oai21  g69(.a(x20), .b(new_n53_), .c(x21), .O(new_n115_));
  nand4  g70(.a(new_n93_), .b(new_n50_), .c(x19), .d(x17), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nor2   g72(.a(new_n117_), .b(x15), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n115_), .c(new_n114_), .d(new_n48_), .O(z14));
  nand2  g74(.a(new_n116_), .b(x22), .O(new_n120_));
  nand4  g75(.a(new_n84_), .b(new_n50_), .c(x19), .d(x17), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n109_), .d(new_n59_), .O(z15));
  nand2  g77(.a(new_n121_), .b(x23), .O(new_n123_));
  nand2  g78(.a(new_n83_), .b(x17), .O(new_n124_));
  nor2   g79(.a(x23), .b(x22), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n93_), .O(new_n126_));
  or2    g81(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n123_), .c(new_n109_), .d(new_n59_), .O(z16));
  nand3  g83(.a(new_n85_), .b(new_n80_), .c(new_n93_), .O(new_n129_));
  inv1   g84(.a(new_n129_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n50_), .c(x19), .d(x17), .O(new_n131_));
  oai21  g86(.a(new_n126_), .b(new_n124_), .c(x24), .O(new_n132_));
  nand3  g87(.a(new_n59_), .b(new_n90_), .c(new_n48_), .O(new_n133_));
  inv1   g88(.a(new_n133_), .O(new_n134_));
  nand3  g89(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(z17));
  nand2  g90(.a(new_n86_), .b(x25), .O(new_n136_));
  nand4  g91(.a(new_n125_), .b(new_n117_), .c(new_n49_), .d(new_n81_), .O(new_n137_));
  nand4  g92(.a(new_n137_), .b(new_n136_), .c(new_n109_), .d(new_n59_), .O(z18));
