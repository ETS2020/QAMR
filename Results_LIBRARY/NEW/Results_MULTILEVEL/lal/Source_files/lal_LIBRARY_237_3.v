// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:47 2020
...
module FAU ( 
  ...
  nand3  g52(.a(new_n52_), .b(x17), .c(new_n93_), .O(new_n98_));
  oai21  g53(.a(new_n52_), .b(x17), .c(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n59_), .c(new_n48_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z11));
  xnor2a g56(.a(x19), .b(x17), .O(new_n102_));
  nand3  g57(.a(x19), .b(new_n52_), .c(new_n93_), .O(new_n103_));
  ...
  nand2  g61(.a(new_n86_), .b(new_n85_), .O(new_n107_));
  nand3  g62(.a(x19), .b(x18), .c(x17), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x20), .O(new_n109_));
  nor2   g64(.a(x15), .b(x07), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n109_), .c(new_n107_), .d(new_n59_), .O(z13));
  nand2  g66(.a(new_n107_), .b(x21), .O(new_n112_));
  nor2   g67(.a(x21), .b(x20), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n85_), .c(x19), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n110_), .d(new_n59_), .O(z14));
  nand2  g70(.a(new_n114_), .b(x22), .O(new_n116_));
  inv1   g71(.a(new_n108_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n87_), .c(new_n50_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n110_), .d(new_n59_), .O(z15));
  ...
  nand4  g77(.a(new_n122_), .b(new_n120_), .c(new_n110_), .d(new_n59_), .O(z16));
  nand3  g78(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(x20), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(x19), .c(x18), .d(x17), .O(new_n126_));
  nand3  g81(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n127_));
  aoi21  g82(.a(new_n122_), .b(x24), .c(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n126_), .O(z17));
  nand2  g84(.a(new_n89_), .b(x25), .O(new_n130_));
  nor3   g85(.a(x25), .b(x24), .c(x23), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n130_), .c(new_n110_), .d(new_n59_), .O(z18));
