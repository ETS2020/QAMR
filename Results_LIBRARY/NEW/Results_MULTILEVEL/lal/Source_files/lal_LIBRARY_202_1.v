...
module FAU ( 
  ...
  oai22  g53(.a(new_n98_), .b(x05), .c(new_n51_), .d(x04), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n93_), .c(new_n48_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z11));
  oai21  g56(.a(new_n52_), .b(new_n51_), .c(x19), .O(new_n102_));
  nand3  g57(.a(new_n53_), .b(x18), .c(x17), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n102_), .c(x05), .O(new_n104_));
  nor2   g59(.a(new_n53_), .b(x04), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(new_n104_), .c(new_n93_), .O(new_n106_));
  nor2   g61(.a(new_n106_), .b(x07), .O(z12));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n108_));
  nand3  g63(.a(x19), .b(x18), .c(x17), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x20), .O(new_n110_));
  nor2   g65(.a(x15), .b(x07), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n108_), .d(new_n59_), .O(z13));
  nand2  g67(.a(new_n108_), .b(x21), .O(new_n113_));
  nor2   g68(.a(x21), .b(x20), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n85_), .c(x19), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n113_), .c(new_n111_), .d(new_n59_), .O(z14));
  nand2  g71(.a(new_n115_), .b(x22), .O(new_n117_));
  inv1   g72(.a(new_n109_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n87_), .c(new_n50_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n117_), .c(new_n111_), .d(new_n59_), .O(z15));
  nand2  g75(.a(new_n119_), .b(x23), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n114_), .c(new_n118_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n111_), .d(new_n59_), .O(z16));
  nand3  g79(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(x20), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(x19), .c(x18), .d(x17), .O(new_n127_));
  nand3  g82(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n128_));
  aoi21  g83(.a(new_n123_), .b(x24), .c(new_n128_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n127_), .O(z17));
  nand2  g85(.a(new_n89_), .b(x25), .O(new_n131_));
  nor3   g86(.a(x25), .b(x24), .c(x23), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n111_), .d(new_n59_), .O(z18));
