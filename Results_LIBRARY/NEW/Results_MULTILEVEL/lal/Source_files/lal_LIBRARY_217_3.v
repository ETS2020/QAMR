...
module FAU ( 
  ...
  nand2  g60(.a(new_n105_), .b(new_n91_), .O(new_n106_));
  nand3  g61(.a(new_n99_), .b(new_n51_), .c(x19), .O(new_n107_));
  and2   g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n105_), .c(new_n104_), .O(z13));
  nor2   g64(.a(x21), .b(x15), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n48_), .O(z14));
  ...
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n105_), .d(new_n56_), .O(z18));
