...
module FAU ( 
  ...
  nand3  g55(.a(new_n100_), .b(new_n89_), .c(x19), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n99_), .c(new_n96_), .d(new_n61_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n103_));
  inv1   g58(.a(new_n94_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n57_), .c(new_n56_), .d(new_n50_), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n96_), .d(new_n61_), .O(z15));
  nand2  g61(.a(new_n105_), .b(x23), .O(new_n107_));
  nor2   g62(.a(x23), .b(x22), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n100_), .c(new_n104_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n96_), .d(new_n61_), .O(z16));
  nand2  g65(.a(new_n109_), .b(x24), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n61_), .c(new_n81_), .d(new_n80_), .O(z17));
  nand4  g67(.a(new_n61_), .b(new_n49_), .c(new_n81_), .d(new_n80_), .O(z18));
  buf1   g68(.a(x16), .O(z02));
endmodule
