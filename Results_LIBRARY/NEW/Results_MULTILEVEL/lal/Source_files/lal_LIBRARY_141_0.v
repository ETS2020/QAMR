...
module FAU ( 
  ...
  nand3  g54(.a(new_n89_), .b(new_n50_), .c(x19), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x21), .O(new_n101_));
  nand4  g56(.a(new_n89_), .b(new_n56_), .c(new_n50_), .d(x19), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n99_), .d(new_n61_), .O(z14));
  nand4  g58(.a(new_n61_), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n81_), .c(new_n80_), .O(new_n105_));
  nand4  g60(.a(new_n89_), .b(x21), .c(new_n50_), .d(x19), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n99_), .d(new_n50_), .O(z15));
  inv1   g62(.a(x23), .O(new_n108_));
  nand4  g63(.a(new_n61_), .b(new_n108_), .c(new_n81_), .d(new_n80_), .O(z16));
  nand4  g64(.a(new_n61_), .b(new_n48_), .c(new_n81_), .d(new_n80_), .O(z17));
  nand4  g65(.a(new_n61_), .b(new_n49_), .c(new_n81_), .d(new_n80_), .O(z18));
  buf1   g66(.a(x16), .O(z02));
endmodule
