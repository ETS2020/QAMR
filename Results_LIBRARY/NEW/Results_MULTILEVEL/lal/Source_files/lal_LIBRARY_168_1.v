...
module FAU ( 
  ...
  oai21  g25(.a(new_n70_), .b(new_n50_), .c(new_n49_), .O(new_n71_));
  nand2  g26(.a(new_n71_), .b(x22), .O(new_n72_));
  ...
  nand4  g31(.a(new_n70_), .b(new_n52_), .c(new_n51_), .d(new_n74_), .O(new_n77_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n82_), .O(new_n104_));
  nor2   g59(.a(x21), .b(x15), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n102_), .c(new_n104_), .d(new_n48_), .O(z14));
  nand2  g61(.a(new_n102_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n51_), .b(new_n74_), .c(x19), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n100_), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n99_), .d(new_n56_), .O(z15));
  oai21  g66(.a(new_n108_), .b(new_n91_), .c(x23), .O(new_n112_));
  ...
  nand4  g70(.a(new_n70_), .b(new_n52_), .c(new_n51_), .d(new_n74_), .O(new_n116_));
