// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:50 2020
...
module FAU ( 
  ...
  nand4  g27(.a(x24), .b(x21), .c(new_n53_), .d(new_n51_), .O(new_n73_));
  nand2  g28(.a(new_n73_), .b(new_n49_), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n52_), .O(new_n75_));
  ...
  nand4  g40(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(x18), .O(new_n86_));
  ...
  nand4  g47(.a(new_n59_), .b(new_n51_), .c(new_n90_), .d(new_n48_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z11));
  nor2   g52(.a(new_n52_), .b(new_n51_), .O(new_n98_));
  nand3  g53(.a(new_n53_), .b(x18), .c(x17), .O(new_n99_));
  oai21  g54(.a(new_n98_), .b(new_n53_), .c(new_n99_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n59_), .c(new_n90_), .d(new_n48_), .O(new_n101_));
  ...
  nand2  g61(.a(new_n98_), .b(new_n83_), .O(new_n107_));
  ...
  oai21  g67(.a(new_n53_), .b(x17), .c(new_n59_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n90_), .O(new_n114_));
  nand2  g69(.a(new_n110_), .b(new_n103_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n103_), .b(new_n84_), .c(new_n50_), .O(new_n117_));
  and2   g72(.a(new_n117_), .b(new_n90_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n114_), .d(new_n48_), .O(z15));
  nand2  g74(.a(new_n117_), .b(x23), .O(new_n120_));
  inv1   g75(.a(x21), .O(new_n121_));
  nor2   g76(.a(x23), .b(x22), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n83_), .c(new_n121_), .d(x18), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n106_), .d(new_n59_), .O(z16));
  nand3  g79(.a(new_n85_), .b(new_n80_), .c(new_n121_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n50_), .c(x19), .d(x18), .O(new_n127_));
  nand3  g82(.a(new_n59_), .b(new_n90_), .c(new_n48_), .O(new_n128_));
  aoi21  g83(.a(new_n123_), .b(x24), .c(new_n128_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n127_), .O(z17));
  nand2  g85(.a(new_n86_), .b(x25), .O(new_n131_));
  inv1   g86(.a(new_n115_), .O(new_n132_));
  nand4  g87(.a(new_n122_), .b(new_n132_), .c(new_n49_), .d(new_n81_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n106_), .d(new_n59_), .O(z18));
  buf1   g89(.a(x16), .O(z02));
endmodule
