...
module FAU ( 
  ...
  nand2  g10(.a(x21), .b(x18), .O(new_n56_));
  nand3  g11(.a(new_n56_), .b(new_n55_), .c(new_n53_), .O(new_n57_));
  aoi22  g12(.a(new_n57_), .b(new_n50_), .c(x22), .d(new_n51_), .O(new_n58_));
  oai21  g13(.a(new_n58_), .b(new_n49_), .c(x22), .O(new_n59_));
  ...
  inv1   g20(.a(new_n63_), .O(new_n66_));
  ...
  nand3  g36(.a(new_n54_), .b(new_n52_), .c(new_n81_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n50_), .c(new_n80_), .O(new_n83_));
  aoi21  g38(.a(new_n83_), .b(x21), .c(x23), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n49_), .c(new_n79_), .O(z08));
  ...
  nand4  g44(.a(new_n61_), .b(new_n81_), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  ...
  nor2   g49(.a(new_n52_), .b(new_n81_), .O(new_n95_));
  ...
  nand3  g57(.a(new_n95_), .b(new_n50_), .c(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n61_), .O(z13));
  ...
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n102_), .d(new_n61_), .O(z14));
  ...
  nand4  g67(.a(new_n112_), .b(new_n109_), .c(new_n102_), .d(new_n61_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nand4  g69(.a(new_n106_), .b(new_n110_), .c(new_n48_), .d(new_n80_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n102_), .d(new_n61_), .O(z16));
  nand2  g71(.a(x19), .b(x18), .O(new_n117_));
  nand2  g72(.a(x24), .b(new_n54_), .O(new_n118_));
  nand3  g73(.a(new_n49_), .b(new_n80_), .c(new_n51_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n117_), .c(new_n118_), .O(new_n120_));
  aoi21  g75(.a(new_n56_), .b(new_n53_), .c(new_n49_), .O(new_n121_));
  aoi21  g76(.a(new_n120_), .b(x17), .c(new_n121_), .O(new_n122_));
  nand3  g77(.a(x24), .b(x22), .c(new_n51_), .O(new_n123_));
  ...
  nand3  g81(.a(new_n61_), .b(new_n87_), .c(new_n86_), .O(new_n127_));
  aoi21  g82(.a(new_n126_), .b(x24), .c(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(z17));
  nand2  g84(.a(new_n102_), .b(new_n62_), .O(new_n130_));
  nor2   g85(.a(x25), .b(x15), .O(new_n131_));
  inv1   g86(.a(new_n103_), .O(new_n132_));
  nand4  g87(.a(new_n111_), .b(new_n132_), .c(new_n49_), .d(new_n48_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n130_), .d(new_n86_), .O(z18));
