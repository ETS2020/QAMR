...
module FAU ( 
  ...
  nand4  g51(.a(new_n96_), .b(new_n59_), .c(new_n51_), .d(new_n48_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  nand3  g53(.a(x18), .b(new_n51_), .c(new_n93_), .O(new_n99_));
  oai21  g54(.a(x18), .b(new_n51_), .c(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n59_), .c(new_n48_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z11));
  nand2  g57(.a(x19), .b(new_n51_), .O(new_n103_));
  nand3  g58(.a(new_n53_), .b(x18), .c(x17), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n103_), .c(x15), .O(new_n105_));
  nor2   g60(.a(new_n53_), .b(x18), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n105_), .c(new_n59_), .O(new_n107_));
