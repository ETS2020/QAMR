...
module FAU ( 
  ...
  oai21  g27(.a(new_n72_), .b(x25), .c(new_n49_), .O(new_n73_));
  inv1   g28(.a(new_n71_), .O(new_n74_));
  oai21  g29(.a(new_n74_), .b(x25), .c(x20), .O(new_n75_));
  inv1   g30(.a(x24), .O(new_n76_));
  inv1   g31(.a(x21), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(x19), .c(x18), .O(new_n78_));
  inv1   g33(.a(new_n78_), .O(new_n79_));
  nor2   g34(.a(x23), .b(x22), .O(new_n80_));
  and2   g35(.a(x18), .b(x17), .O(new_n81_));
  nor2   g36(.a(x20), .b(new_n51_), .O(new_n82_));
  ...
  nand4  g40(.a(new_n85_), .b(new_n80_), .c(new_n79_), .d(new_n76_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(x25), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n75_), .c(new_n73_), .O(z08));
  inv1   g43(.a(x07), .O(new_n89_));
  inv1   g44(.a(x15), .O(new_n90_));
  nand3  g45(.a(new_n56_), .b(new_n90_), .c(new_n89_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand4  g47(.a(new_n55_), .b(new_n49_), .c(new_n90_), .d(new_n89_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xor2a  g49(.a(x18), .b(x17), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n55_), .c(new_n90_), .d(new_n89_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z11));
  nand3  g52(.a(new_n51_), .b(x18), .c(x17), .O(new_n98_));
  oai21  g53(.a(new_n81_), .b(new_n51_), .c(new_n98_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n55_), .c(new_n90_), .d(new_n89_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand2  g56(.a(new_n82_), .b(new_n81_), .O(new_n102_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g59(.a(x15), .b(x07), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n102_), .d(new_n55_), .O(z13));
  nand2  g61(.a(new_n102_), .b(x21), .O(new_n107_));
  nand4  g62(.a(new_n81_), .b(new_n77_), .c(new_n48_), .d(x19), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n105_), .d(new_n55_), .O(z14));
  nand2  g64(.a(new_n108_), .b(x22), .O(new_n110_));
  inv1   g65(.a(new_n103_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n83_), .c(new_n48_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n105_), .d(new_n55_), .O(z15));
  inv1   g68(.a(x22), .O(new_n114_));
  nand2  g69(.a(new_n76_), .b(x23), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n77_), .d(new_n48_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(x19), .c(x18), .d(x17), .O(new_n118_));
  nand3  g73(.a(new_n55_), .b(new_n90_), .c(new_n89_), .O(new_n119_));
  aoi21  g74(.a(new_n112_), .b(x23), .c(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n118_), .O(z16));
  nand3  g76(.a(new_n84_), .b(new_n114_), .c(new_n77_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(x20), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(x19), .c(x18), .d(x17), .O(new_n124_));
  aoi21  g79(.a(new_n112_), .b(x24), .c(new_n119_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n124_), .O(z17));
  nand2  g81(.a(new_n85_), .b(x25), .O(new_n127_));
  nor3   g82(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n105_), .d(new_n55_), .O(z18));
