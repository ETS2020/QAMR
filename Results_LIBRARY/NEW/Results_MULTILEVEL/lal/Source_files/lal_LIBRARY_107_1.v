// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:01 2020
...
module FAU ( 
  ...
  aoi21  g04(.a(x21), .b(x17), .c(x19), .O(new_n50_));
  ...
  nand4  g41(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(x18), .O(new_n87_));
  ...
  nand4  g49(.a(new_n56_), .b(new_n74_), .c(new_n92_), .d(new_n91_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  nand4  g51(.a(new_n56_), .b(new_n82_), .c(x17), .d(new_n92_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(x07), .O(z11));
  xor2a  g53(.a(x19), .b(x18), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n56_), .c(new_n92_), .d(new_n91_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z12));
  nand2  g56(.a(new_n84_), .b(x18), .O(new_n102_));
  oai21  g57(.a(new_n72_), .b(new_n82_), .c(x20), .O(new_n103_));
  nor2   g58(.a(x15), .b(x07), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n56_), .O(z13));
  nand2  g60(.a(new_n102_), .b(x21), .O(new_n106_));
  inv1   g61(.a(x20), .O(new_n107_));
  nor2   g62(.a(new_n72_), .b(new_n82_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n51_), .c(new_n107_), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n106_), .c(new_n104_), .d(new_n56_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n108_), .b(new_n85_), .c(new_n107_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n111_), .c(new_n104_), .d(new_n56_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n84_), .c(new_n51_), .d(x18), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n104_), .d(new_n56_), .O(z16));
  nand3  g72(.a(new_n86_), .b(new_n52_), .c(new_n51_), .O(new_n118_));
  inv1   g73(.a(new_n118_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n107_), .c(x19), .d(x18), .O(new_n120_));
  nand3  g75(.a(new_n56_), .b(new_n92_), .c(new_n91_), .O(new_n121_));
  aoi21  g76(.a(new_n116_), .b(x24), .c(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(new_n120_), .O(z17));
  nand2  g78(.a(new_n87_), .b(x25), .O(new_n124_));
  inv1   g79(.a(new_n109_), .O(new_n125_));
  nand4  g80(.a(new_n115_), .b(new_n125_), .c(new_n73_), .d(new_n49_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n124_), .c(new_n104_), .d(new_n56_), .O(z18));
