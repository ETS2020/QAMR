...
module FAU ( 
  ...
  oai21  g05(.a(x19), .b(x17), .c(x22), .O(new_n51_));
  ...
  oai21  g31(.a(new_n76_), .b(new_n75_), .c(new_n48_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  inv1   g33(.a(x20), .O(new_n79_));
  inv1   g34(.a(x24), .O(new_n80_));
  oai21  g35(.a(new_n80_), .b(new_n79_), .c(new_n48_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(x22), .O(new_n82_));
  oai21  g37(.a(x25), .b(x24), .c(x23), .O(new_n83_));
  inv1   g38(.a(x21), .O(new_n84_));
  nor2   g39(.a(new_n74_), .b(new_n50_), .O(new_n85_));
  nand3  g40(.a(x19), .b(x18), .c(x17), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor2   g42(.a(x22), .b(x21), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(new_n80_), .d(new_n49_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n85_), .c(new_n80_), .d(new_n84_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(x25), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n83_), .c(new_n82_), .d(new_n78_), .O(z08));
  inv1   g47(.a(x07), .O(new_n93_));
  inv1   g48(.a(x15), .O(new_n94_));
  nand3  g49(.a(new_n58_), .b(new_n94_), .c(new_n93_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand4  g51(.a(new_n57_), .b(new_n73_), .c(new_n94_), .d(new_n93_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n57_), .c(new_n94_), .d(new_n93_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(z11));
  nor2   g56(.a(new_n50_), .b(new_n73_), .O(new_n102_));
  nand3  g57(.a(new_n74_), .b(x18), .c(x17), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n74_), .c(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n57_), .c(new_n94_), .d(new_n93_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(z12));
  nand2  g61(.a(new_n86_), .b(x20), .O(new_n107_));
  nor2   g62(.a(x15), .b(x07), .O(new_n108_));
  nand3  g63(.a(new_n102_), .b(new_n79_), .c(x19), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n57_), .O(z13));
  nand2  g65(.a(new_n86_), .b(x21), .O(new_n111_));
  nand3  g66(.a(new_n102_), .b(new_n84_), .c(x19), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(x20), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n111_), .c(new_n108_), .d(new_n57_), .O(z14));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n102_), .b(new_n88_), .c(x19), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n116_), .c(new_n108_), .d(new_n57_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n87_), .c(new_n84_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n108_), .d(new_n57_), .O(z16));
  inv1   g77(.a(x22), .O(new_n123_));
  nand4  g78(.a(new_n80_), .b(new_n49_), .c(new_n123_), .d(new_n84_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(x19), .c(x18), .d(x17), .O(new_n126_));
  nand3  g81(.a(new_n57_), .b(new_n94_), .c(new_n93_), .O(new_n127_));
  ...
  nand4  g85(.a(new_n120_), .b(new_n113_), .c(new_n48_), .d(new_n80_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n130_), .c(new_n108_), .d(new_n57_), .O(z18));
