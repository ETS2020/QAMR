// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:39 2020
...
module FAU ( 
  ...
  nand3  g38(.a(new_n83_), .b(x19), .c(x18), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  and2   g40(.a(x18), .b(x17), .O(new_n86_));
  nor2   g41(.a(x20), .b(new_n73_), .O(new_n87_));
  ...
  nand4  g45(.a(new_n90_), .b(new_n85_), .c(new_n82_), .d(new_n81_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(x25), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n80_), .c(new_n79_), .d(new_n77_), .O(z08));
  ...
  nand3  g56(.a(new_n73_), .b(x18), .c(x17), .O(new_n102_));
  oai21  g57(.a(new_n86_), .b(new_n73_), .c(new_n102_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n59_), .c(new_n94_), .d(new_n48_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(z12));
  nand2  g60(.a(new_n87_), .b(new_n86_), .O(new_n106_));
  nand3  g61(.a(x19), .b(x18), .c(x17), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(x20), .O(new_n108_));
  nor2   g63(.a(x15), .b(x07), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n108_), .c(new_n106_), .d(new_n59_), .O(z13));
  nand2  g65(.a(new_n106_), .b(x21), .O(new_n111_));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n86_), .c(x19), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n109_), .d(new_n59_), .O(z14));
  nand2  g69(.a(new_n113_), .b(x22), .O(new_n115_));
  inv1   g70(.a(new_n107_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n88_), .c(new_n50_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n109_), .d(new_n59_), .O(z15));
  nand2  g73(.a(new_n117_), .b(x23), .O(new_n119_));
  nor2   g74(.a(x23), .b(x22), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n112_), .c(new_n116_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n109_), .d(new_n59_), .O(z16));
  nand3  g77(.a(new_n89_), .b(new_n81_), .c(new_n83_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(x20), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(x19), .c(x18), .d(x17), .O(new_n125_));
  nand3  g80(.a(new_n59_), .b(new_n94_), .c(new_n48_), .O(new_n126_));
  aoi21  g81(.a(new_n121_), .b(x24), .c(new_n126_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(z17));
  nand2  g83(.a(new_n90_), .b(x25), .O(new_n129_));
  nor3   g84(.a(x25), .b(x24), .c(x23), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n88_), .c(new_n87_), .d(new_n86_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n129_), .c(new_n109_), .d(new_n59_), .O(z18));
