...
module FAU ( 
  ...
  inv1   g45(.a(new_n59_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n48_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  nand4  g48(.a(new_n59_), .b(new_n51_), .c(new_n90_), .d(new_n48_), .O(new_n94_));
  ...
  nand2  g62(.a(new_n99_), .b(new_n83_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n59_), .O(z13));
  ...
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n107_), .d(new_n59_), .O(z14));
  oai21  g68(.a(new_n91_), .b(new_n51_), .c(new_n90_), .O(new_n114_));
  nand2  g69(.a(new_n111_), .b(new_n104_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(x22), .O(new_n116_));
  nand3  g71(.a(new_n104_), .b(new_n84_), .c(new_n50_), .O(new_n117_));
  ...
  nand4  g78(.a(new_n123_), .b(new_n120_), .c(new_n107_), .d(new_n59_), .O(z16));
  ...
  nand4  g88(.a(new_n133_), .b(new_n131_), .c(new_n107_), .d(new_n59_), .O(z18));
