...
module FAU ( 
  ...
  nand4  g48(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n94_));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  nand3  g50(.a(new_n61_), .b(new_n81_), .c(new_n80_), .O(new_n96_));
  aoi21  g51(.a(new_n95_), .b(x20), .c(new_n96_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n94_), .O(z13));
  nor2   g53(.a(x15), .b(x07), .O(new_n99_));
  inv1   g54(.a(new_n89_), .O(new_n100_));
  nand2  g55(.a(new_n50_), .b(x19), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(new_n100_), .c(x21), .O(new_n102_));
  nand4  g57(.a(new_n89_), .b(new_n56_), .c(new_n50_), .d(x19), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n102_), .c(new_n99_), .d(new_n61_), .O(z14));
  oai21  g59(.a(new_n89_), .b(new_n53_), .c(new_n61_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n81_), .O(new_n106_));
  nand2  g61(.a(new_n101_), .b(x22), .O(new_n107_));
  nand3  g62(.a(x21), .b(new_n50_), .c(x19), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n89_), .c(x15), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n80_), .O(z15));
  inv1   g66(.a(x23), .O(new_n112_));
  nand4  g67(.a(new_n61_), .b(new_n112_), .c(new_n81_), .d(new_n80_), .O(z16));
  nand4  g68(.a(new_n61_), .b(new_n48_), .c(new_n81_), .d(new_n80_), .O(z17));
  nand4  g69(.a(new_n61_), .b(new_n49_), .c(new_n81_), .d(new_n80_), .O(z18));
  buf1   g70(.a(x16), .O(z02));
endmodule
