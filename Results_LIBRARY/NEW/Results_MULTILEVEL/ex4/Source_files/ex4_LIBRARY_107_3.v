// Benchmark "FAU" written by ABC on Tue Jul 28 06:47:44 2020
...
module FAU ( 
  ...
  oai21  g141(.a(x126), .b(new_n293_), .c(new_n297_), .O(new_n298_));
  nand2  g142(.a(new_n298_), .b(new_n292_), .O(new_n299_));
  inv1   g143(.a(x062), .O(new_n300_));
  oai21  g144(.a(x102), .b(new_n300_), .c(x118), .O(new_n301_));
  inv1   g145(.a(x126), .O(new_n302_));
  nand3  g146(.a(new_n302_), .b(x110), .c(x022), .O(new_n303_));
  ...
  oai21  g261(.a(new_n417_), .b(x061), .c(new_n418_), .O(new_n419_));
  ...
  oai21  g266(.a(new_n423_), .b(x093), .c(new_n236_), .O(new_n424_));
  ...
  inv1   g271(.a(x093), .O(new_n429_));
  nand4  g272(.a(x125), .b(new_n429_), .c(new_n241_), .d(x013), .O(new_n430_));
  inv1   g273(.a(new_n430_), .O(new_n431_));
  aoi21  g274(.a(new_n428_), .b(new_n262_), .c(new_n431_), .O(new_n432_));
  nand3  g275(.a(x085), .b(new_n241_), .c(new_n229_), .O(new_n433_));
  ...
  aoi21  g279(.a(new_n436_), .b(new_n230_), .c(x037), .O(new_n437_));
  nor3   g280(.a(new_n258_), .b(x085), .c(x053), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(new_n437_), .c(x069), .O(new_n439_));
  aoi21  g282(.a(new_n232_), .b(x029), .c(x021), .O(new_n440_));
  inv1   g283(.a(new_n417_), .O(new_n441_));
  nand4  g284(.a(new_n441_), .b(new_n415_), .c(new_n232_), .d(x029), .O(new_n442_));
  oai21  g285(.a(new_n440_), .b(new_n418_), .c(new_n442_), .O(new_n443_));
  nand2  g286(.a(new_n415_), .b(x029), .O(new_n444_));
  aoi21  g287(.a(new_n444_), .b(new_n258_), .c(new_n241_), .O(new_n445_));
  aoi21  g288(.a(new_n443_), .b(new_n227_), .c(new_n445_), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(x085), .c(new_n439_), .O(new_n447_));
  nor2   g290(.a(new_n418_), .b(x085), .O(new_n448_));
  aoi21  g291(.a(new_n448_), .b(new_n227_), .c(x077), .O(new_n449_));
  nor2   g292(.a(new_n230_), .b(x013), .O(new_n450_));
  nor2   g293(.a(new_n263_), .b(x053), .O(new_n451_));
  aoi22  g294(.a(new_n451_), .b(new_n450_), .c(x053), .d(x037), .O(new_n452_));
  oai21  g295(.a(new_n449_), .b(new_n229_), .c(new_n452_), .O(new_n453_));
  aoi21  g296(.a(new_n447_), .b(new_n262_), .c(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n435_), .c(x045), .O(z13));
  nand2  g298(.a(x022), .b(x014), .O(new_n456_));
  oai21  g299(.a(new_n322_), .b(x030), .c(new_n456_), .O(new_n457_));
  ...
  oai21  g304(.a(new_n302_), .b(x110), .c(x038), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(x118), .O(new_n463_));
  inv1   g306(.a(x102), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(x062), .c(new_n292_), .O(new_n465_));
  nand3  g308(.a(x126), .b(new_n293_), .c(new_n286_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n310_), .O(new_n467_));
  aoi21  g310(.a(new_n465_), .b(new_n297_), .c(new_n467_), .O(new_n468_));
  nand4  g311(.a(new_n468_), .b(new_n463_), .c(new_n461_), .d(new_n457_), .O(new_n469_));
  nand4  g312(.a(x126), .b(new_n300_), .c(new_n297_), .d(x014), .O(new_n470_));
  inv1   g313(.a(new_n470_), .O(new_n471_));
  aoi21  g314(.a(new_n469_), .b(new_n318_), .c(new_n471_), .O(new_n472_));
  nand3  g315(.a(x086), .b(new_n297_), .c(new_n285_), .O(new_n473_));
  oai21  g316(.a(new_n472_), .b(x054), .c(new_n473_), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(x006), .O(new_n475_));
  nand2  g318(.a(new_n288_), .b(x030), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n286_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n318_), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n285_), .c(new_n459_), .O(new_n479_));
  nor2   g322(.a(new_n284_), .b(x022), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n322_), .c(x070), .O(new_n481_));
  inv1   g324(.a(new_n458_), .O(new_n482_));
  nand4  g325(.a(new_n482_), .b(new_n456_), .c(new_n288_), .d(x030), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n481_), .c(x078), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n479_), .c(new_n283_), .O(new_n485_));
  nand2  g328(.a(new_n456_), .b(x030), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n314_), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(new_n318_), .c(x038), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n485_), .O(new_n489_));
  oai22  g332(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(x070), .c(x022), .O(new_n491_));
  aoi22  g334(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  aoi21  g336(.a(new_n489_), .b(new_n310_), .c(new_n493_), .O(new_n494_));
