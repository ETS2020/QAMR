...
module FAU ( 
  ...
  oai21  g304(.a(new_n460_), .b(x062), .c(new_n461_), .O(new_n462_));
  ...
  oai21  g309(.a(new_n466_), .b(x094), .c(new_n294_), .O(new_n467_));
  ...
  inv1   g314(.a(x094), .O(new_n472_));
  nand4  g315(.a(x126), .b(new_n472_), .c(new_n299_), .d(x014), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(new_n474_));
  aoi21  g317(.a(new_n471_), .b(new_n320_), .c(new_n474_), .O(new_n475_));
  nand3  g318(.a(x086), .b(new_n299_), .c(new_n287_), .O(new_n476_));
  oai21  g319(.a(new_n475_), .b(x054), .c(new_n476_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(x006), .O(new_n478_));
  nand2  g321(.a(new_n290_), .b(x030), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n288_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n320_), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n287_), .c(new_n461_), .O(new_n482_));
  nor2   g325(.a(new_n286_), .b(x022), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n324_), .c(x070), .O(new_n484_));
  inv1   g327(.a(new_n460_), .O(new_n485_));
  nand4  g328(.a(new_n485_), .b(new_n458_), .c(new_n290_), .d(x030), .O(new_n486_));
  aoi21  g329(.a(new_n486_), .b(new_n484_), .c(x078), .O(new_n487_));
  oai21  g330(.a(new_n487_), .b(new_n482_), .c(new_n285_), .O(new_n488_));
  nand2  g331(.a(new_n458_), .b(x030), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n316_), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n320_), .c(x038), .O(new_n491_));
