// Benchmark "FAU" written by ABC on Tue Jul 28 06:48:48 2020
...
module FAU ( 
  ...
  nand2  g279(.a(new_n232_), .b(x029), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n230_), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n262_), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n229_), .c(new_n420_), .O(new_n440_));
  nor2   g283(.a(new_n228_), .b(x021), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(new_n266_), .c(x069), .O(new_n442_));
  inv1   g285(.a(new_n419_), .O(new_n443_));
  nand4  g286(.a(new_n443_), .b(new_n417_), .c(new_n232_), .d(x029), .O(new_n444_));
  aoi21  g287(.a(new_n444_), .b(new_n442_), .c(x077), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n440_), .c(new_n227_), .O(new_n446_));
  nand2  g289(.a(new_n417_), .b(x029), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n258_), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n262_), .c(x037), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n446_), .O(new_n450_));
  oai22  g293(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n451_));
  nand3  g294(.a(new_n451_), .b(x069), .c(x021), .O(new_n452_));
  aoi22  g295(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n452_), .O(new_n454_));
  aoi21  g297(.a(new_n450_), .b(new_n254_), .c(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n436_), .c(x045), .O(z13));
  inv1   g299(.a(x078), .O(new_n457_));
  nand2  g300(.a(x022), .b(x014), .O(new_n458_));
  oai21  g301(.a(new_n323_), .b(x030), .c(new_n458_), .O(new_n459_));
  ...
  oai21  g306(.a(new_n301_), .b(x110), .c(x038), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x118), .O(new_n465_));
  inv1   g308(.a(x102), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x062), .c(new_n296_), .O(new_n467_));
  nand3  g310(.a(x126), .b(new_n294_), .c(new_n286_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n309_), .O(new_n469_));
  aoi21  g312(.a(new_n467_), .b(new_n295_), .c(new_n469_), .O(new_n470_));
  nand4  g313(.a(new_n470_), .b(new_n465_), .c(new_n463_), .d(new_n459_), .O(new_n471_));
  nand4  g314(.a(x126), .b(new_n299_), .c(new_n295_), .d(x014), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n471_), .b(new_n457_), .c(new_n473_), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n295_), .c(new_n285_), .O(new_n475_));
  oai21  g318(.a(new_n474_), .b(x054), .c(new_n475_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x006), .O(new_n477_));
  nand2  g320(.a(new_n288_), .b(x030), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n286_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n457_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n285_), .c(new_n461_), .O(new_n481_));
  nor2   g324(.a(new_n284_), .b(x022), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n323_), .c(x070), .O(new_n483_));
  inv1   g326(.a(new_n460_), .O(new_n484_));
  nand4  g327(.a(new_n484_), .b(new_n458_), .c(new_n288_), .d(x030), .O(new_n485_));
  aoi21  g328(.a(new_n485_), .b(new_n483_), .c(x078), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n481_), .c(new_n283_), .O(new_n487_));
  nand2  g330(.a(new_n458_), .b(x030), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n319_), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n457_), .c(x038), .O(new_n490_));
  ...
  aoi21  g338(.a(new_n491_), .b(new_n309_), .c(new_n495_), .O(new_n496_));
