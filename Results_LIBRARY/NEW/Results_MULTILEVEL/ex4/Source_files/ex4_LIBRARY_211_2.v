// Benchmark "FAU" written by ABC on Tue Jul 28 06:49:10 2020
...
module FAU ( 
  ...
  inv1   g071(.a(x125), .O(new_n228_));
  nand4  g072(.a(new_n228_), .b(x061), .c(x037), .d(new_n227_), .O(new_n229_));
  nand3  g073(.a(new_n229_), .b(x117), .c(x109), .O(new_n230_));
  ...
  aoi21  g079(.a(new_n235_), .b(new_n234_), .c(x005), .O(new_n236_));
  nor2   g080(.a(x093), .b(x061), .O(new_n237_));
  oai21  g081(.a(new_n237_), .b(x029), .c(x021), .O(new_n238_));
  oai22  g082(.a(new_n238_), .b(new_n236_), .c(new_n233_), .d(new_n232_), .O(new_n239_));
  ...
  nand3  g090(.a(new_n246_), .b(new_n244_), .c(new_n241_), .O(new_n247_));
  nand3  g091(.a(x093), .b(x069), .c(new_n227_), .O(new_n248_));
  nand2  g092(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  oai21  g093(.a(new_n228_), .b(new_n240_), .c(new_n249_), .O(new_n250_));
  nand2  g094(.a(x093), .b(x061), .O(new_n251_));
  oai21  g095(.a(new_n251_), .b(new_n241_), .c(new_n246_), .O(new_n252_));
  nand2  g096(.a(x117), .b(x021), .O(new_n253_));
  oai21  g097(.a(x117), .b(new_n232_), .c(new_n253_), .O(new_n254_));
  nand2  g098(.a(new_n254_), .b(new_n228_), .O(new_n255_));
  nand3  g099(.a(new_n240_), .b(x061), .c(x037), .O(new_n256_));
  nand3  g100(.a(new_n256_), .b(new_n255_), .c(new_n252_), .O(new_n257_));
  nand2  g101(.a(new_n257_), .b(new_n227_), .O(new_n258_));
  nor2   g102(.a(x029), .b(new_n245_), .O(new_n259_));
  oai21  g103(.a(new_n259_), .b(new_n251_), .c(new_n235_), .O(new_n260_));
  nand4  g104(.a(new_n260_), .b(new_n258_), .c(new_n250_), .d(new_n239_), .O(new_n261_));
  nand2  g105(.a(new_n261_), .b(x077), .O(new_n262_));
  nand3  g106(.a(new_n235_), .b(new_n245_), .c(x013), .O(new_n263_));
  nand3  g107(.a(new_n263_), .b(new_n262_), .c(new_n231_), .O(new_n264_));
  nand2  g108(.a(new_n264_), .b(x053), .O(new_n265_));
  inv1   g109(.a(x077), .O(new_n266_));
  aoi21  g110(.a(new_n246_), .b(new_n241_), .c(new_n251_), .O(new_n267_));
  oai21  g111(.a(new_n267_), .b(new_n266_), .c(x053), .O(new_n268_));
  nand3  g112(.a(x077), .b(new_n235_), .c(new_n245_), .O(new_n269_));
  oai21  g113(.a(x085), .b(x005), .c(new_n269_), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(x037), .O(new_n271_));
  oai21  g115(.a(x077), .b(x013), .c(new_n271_), .O(new_n272_));
  aoi21  g116(.a(new_n268_), .b(new_n234_), .c(new_n272_), .O(new_n273_));
  aoi21  g117(.a(new_n273_), .b(new_n265_), .c(new_n225_), .O(z05));
  ...
  oai21  g178(.a(new_n335_), .b(x024), .c(new_n332_), .O(new_n336_));
  ...
  nand4  g195(.a(x120), .b(new_n333_), .c(new_n161_), .d(x008), .O(new_n353_));
  inv1   g196(.a(new_n353_), .O(new_n354_));
  aoi21  g197(.a(new_n352_), .b(new_n163_), .c(new_n354_), .O(new_n355_));
  nand3  g198(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n356_));
  oai21  g199(.a(new_n355_), .b(x048), .c(new_n356_), .O(new_n357_));
  nand2  g200(.a(new_n357_), .b(x000), .O(new_n358_));
  nand2  g201(.a(x088), .b(x056), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(x024), .O(new_n360_));
  nand2  g203(.a(new_n360_), .b(new_n166_), .O(new_n361_));
  nand2  g204(.a(new_n361_), .b(new_n163_), .O(new_n362_));
  aoi21  g205(.a(new_n362_), .b(new_n160_), .c(new_n339_), .O(new_n363_));
  inv1   g206(.a(x024), .O(new_n364_));
  nor2   g207(.a(new_n364_), .b(x016), .O(new_n365_));
  oai21  g208(.a(new_n365_), .b(new_n335_), .c(x064), .O(new_n366_));
  inv1   g209(.a(new_n338_), .O(new_n367_));
  nand4  g210(.a(new_n359_), .b(new_n367_), .c(new_n332_), .d(x024), .O(new_n368_));
  aoi21  g211(.a(new_n368_), .b(new_n366_), .c(x072), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(new_n363_), .c(new_n162_), .O(new_n370_));
  nand2  g213(.a(new_n332_), .b(x024), .O(new_n371_));
  nand3  g214(.a(new_n371_), .b(new_n334_), .c(new_n333_), .O(new_n372_));
  nand3  g215(.a(new_n372_), .b(new_n163_), .c(x032), .O(new_n373_));
  ...
  aoi21  g221(.a(new_n374_), .b(new_n159_), .c(new_n378_), .O(new_n379_));
  ...
  nand3  g251(.a(x069), .b(new_n234_), .c(x021), .O(new_n409_));
  inv1   g252(.a(x053), .O(new_n410_));
  nand3  g253(.a(x085), .b(new_n410_), .c(x005), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n409_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n266_), .O(new_n413_));
  inv1   g256(.a(x085), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n235_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(x037), .c(new_n227_), .O(new_n416_));
  aoi21  g259(.a(new_n251_), .b(x029), .c(new_n246_), .O(new_n417_));
  nor2   g260(.a(new_n417_), .b(x085), .O(new_n418_));
  oai22  g261(.a(new_n418_), .b(new_n416_), .c(x117), .d(x109), .O(new_n419_));
  nand2  g262(.a(new_n242_), .b(new_n234_), .O(new_n420_));
  nand3  g263(.a(new_n243_), .b(new_n414_), .c(new_n235_), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n420_), .c(new_n227_), .O(new_n422_));
  nand2  g265(.a(x021), .b(x013), .O(new_n423_));
  nand4  g266(.a(new_n423_), .b(new_n251_), .c(new_n414_), .d(x029), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(new_n425_));
  oai22  g268(.a(new_n425_), .b(new_n422_), .c(x125), .d(x101), .O(new_n426_));
  aoi22  g269(.a(new_n237_), .b(new_n241_), .c(x021), .d(x013), .O(new_n427_));
  nand2  g270(.a(x117), .b(new_n232_), .O(new_n428_));
  nand2  g271(.a(new_n233_), .b(new_n245_), .O(new_n429_));
  aoi21  g272(.a(new_n429_), .b(new_n428_), .c(new_n228_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n427_), .c(x005), .O(new_n431_));
  nor2   g274(.a(x037), .b(new_n241_), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(new_n244_), .c(x069), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n431_), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n414_), .O(new_n435_));
  nand3  g278(.a(x069), .b(x021), .c(new_n226_), .O(new_n436_));
  nand4  g279(.a(new_n436_), .b(new_n435_), .c(new_n426_), .d(new_n419_), .O(new_n437_));
  nand3  g280(.a(x085), .b(new_n234_), .c(x005), .O(new_n438_));
  nand3  g281(.a(new_n414_), .b(x037), .c(x029), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n438_), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(new_n226_), .O(new_n441_));
  nand2  g284(.a(x029), .b(new_n245_), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(new_n237_), .c(x085), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(x053), .c(x037), .O(new_n444_));
  nand2  g287(.a(x077), .b(x013), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(new_n444_), .c(new_n441_), .O(new_n446_));
  aoi21  g289(.a(new_n437_), .b(new_n410_), .c(new_n446_), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n413_), .c(x045), .O(z13));
  nand2  g291(.a(x022), .b(x014), .O(new_n449_));
  oai21  g292(.a(new_n316_), .b(x030), .c(new_n449_), .O(new_n450_));
  ...
  nand2  g296(.a(new_n453_), .b(new_n313_), .O(new_n454_));
  oai21  g297(.a(new_n296_), .b(x110), .c(x038), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(x118), .O(new_n456_));
  inv1   g299(.a(x102), .O(new_n457_));
  oai21  g300(.a(new_n457_), .b(x062), .c(new_n286_), .O(new_n458_));
  nand3  g301(.a(x126), .b(new_n287_), .c(new_n280_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n304_), .O(new_n460_));
  aoi21  g303(.a(new_n458_), .b(new_n291_), .c(new_n460_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n456_), .c(new_n454_), .d(new_n450_), .O(new_n462_));
  nand4  g305(.a(x126), .b(new_n294_), .c(new_n291_), .d(x014), .O(new_n463_));
  inv1   g306(.a(new_n463_), .O(new_n464_));
  aoi21  g307(.a(new_n462_), .b(new_n312_), .c(new_n464_), .O(new_n465_));
  nand3  g308(.a(x086), .b(new_n291_), .c(new_n279_), .O(new_n466_));
  oai21  g309(.a(new_n465_), .b(x054), .c(new_n466_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(x006), .O(new_n468_));
  nand2  g311(.a(new_n282_), .b(x030), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n280_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n312_), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n279_), .c(new_n452_), .O(new_n472_));
  nor2   g315(.a(new_n278_), .b(x022), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n316_), .c(x070), .O(new_n474_));
  inv1   g317(.a(new_n451_), .O(new_n475_));
  nand4  g318(.a(new_n475_), .b(new_n449_), .c(new_n282_), .d(x030), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n474_), .c(x078), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n472_), .c(new_n277_), .O(new_n478_));
  nand2  g321(.a(new_n449_), .b(x030), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n308_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n312_), .c(x038), .O(new_n481_));
  ...
  aoi21  g329(.a(new_n482_), .b(new_n304_), .c(new_n486_), .O(new_n487_));
