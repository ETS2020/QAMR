// Benchmark "FAU" written by ABC on Tue Jul 28 06:46:22 2020
...
module FAU ( 
  ...
  aoi22  g133(.a(new_n289_), .b(x030), .c(new_n287_), .d(new_n286_), .O(new_n290_));
  inv1   g134(.a(x038), .O(new_n291_));
  inv1   g135(.a(x070), .O(new_n292_));
  oai22  g136(.a(x126), .b(new_n292_), .c(x102), .d(new_n291_), .O(new_n293_));
  ...
  nor2   g146(.a(x102), .b(new_n292_), .O(new_n303_));
  aoi21  g147(.a(new_n303_), .b(x062), .c(new_n302_), .O(new_n304_));
  nand4  g148(.a(new_n304_), .b(new_n301_), .c(new_n296_), .d(new_n294_), .O(new_n305_));
  oai21  g149(.a(new_n305_), .b(new_n290_), .c(x078), .O(new_n306_));
  nand4  g150(.a(new_n297_), .b(x062), .c(x038), .d(new_n286_), .O(new_n307_));
  aoi21  g151(.a(new_n307_), .b(new_n306_), .c(new_n285_), .O(new_n308_));
  nand3  g152(.a(new_n302_), .b(x038), .c(x014), .O(new_n309_));
  inv1   g153(.a(new_n309_), .O(new_n310_));
  oai21  g154(.a(new_n310_), .b(new_n308_), .c(new_n284_), .O(new_n311_));
  inv1   g155(.a(x030), .O(new_n312_));
  nand3  g156(.a(x086), .b(x054), .c(new_n312_), .O(new_n313_));
  aoi21  g157(.a(new_n313_), .b(x022), .c(new_n291_), .O(new_n314_));
  nand3  g158(.a(new_n288_), .b(x086), .c(x054), .O(new_n315_));
  inv1   g159(.a(new_n315_), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(new_n314_), .c(new_n292_), .O(new_n317_));
  nor2   g161(.a(x094), .b(x062), .O(new_n318_));
  oai21  g162(.a(new_n318_), .b(x030), .c(x022), .O(new_n319_));
  nand2  g163(.a(new_n319_), .b(new_n295_), .O(new_n320_));
  nand2  g164(.a(new_n287_), .b(new_n286_), .O(new_n321_));
  inv1   g165(.a(new_n318_), .O(new_n322_));
  nand2  g166(.a(x126), .b(x102), .O(new_n323_));
  nand4  g167(.a(new_n323_), .b(new_n322_), .c(new_n321_), .d(new_n312_), .O(new_n324_));
  aoi21  g168(.a(new_n324_), .b(new_n320_), .c(new_n285_), .O(new_n325_));
  nand2  g169(.a(new_n321_), .b(new_n312_), .O(new_n326_));
  aoi21  g170(.a(new_n326_), .b(new_n289_), .c(x038), .O(new_n327_));
  oai21  g171(.a(new_n327_), .b(new_n325_), .c(x086), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n317_), .O(new_n329_));
  nand3  g173(.a(new_n295_), .b(x086), .c(x054), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(x078), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n286_), .O(new_n332_));
  nor2   g176(.a(x022), .b(new_n286_), .O(new_n333_));
  nor2   g177(.a(x070), .b(new_n285_), .O(new_n334_));
  aoi22  g178(.a(new_n334_), .b(new_n333_), .c(new_n285_), .d(new_n291_), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(new_n332_), .O(new_n336_));
  aoi21  g180(.a(new_n329_), .b(x078), .c(new_n336_), .O(new_n337_));
  aoi21  g181(.a(new_n337_), .b(new_n311_), .c(new_n283_), .O(z06));
  ...
  inv1   g300(.a(x078), .O(new_n458_));
  nand2  g301(.a(x022), .b(x014), .O(new_n459_));
  oai21  g302(.a(new_n322_), .b(x030), .c(new_n459_), .O(new_n460_));
  nor2   g303(.a(x126), .b(x102), .O(new_n461_));
  nor2   g304(.a(x118), .b(x110), .O(new_n462_));
  oai21  g305(.a(new_n461_), .b(x094), .c(new_n462_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n292_), .O(new_n464_));
  oai21  g307(.a(new_n297_), .b(x110), .c(x038), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(x118), .O(new_n466_));
  inv1   g309(.a(x102), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(x062), .c(new_n298_), .O(new_n468_));
  inv1   g311(.a(x118), .O(new_n469_));
  nand3  g312(.a(x126), .b(new_n469_), .c(new_n287_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n302_), .O(new_n471_));
  aoi21  g314(.a(new_n468_), .b(new_n291_), .c(new_n471_), .O(new_n472_));
  nand4  g315(.a(new_n472_), .b(new_n466_), .c(new_n464_), .d(new_n460_), .O(new_n473_));
  inv1   g316(.a(x062), .O(new_n474_));
  nand4  g317(.a(x126), .b(new_n474_), .c(new_n291_), .d(x014), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(new_n476_));
  aoi21  g319(.a(new_n473_), .b(new_n458_), .c(new_n476_), .O(new_n477_));
  nand3  g320(.a(x086), .b(new_n291_), .c(new_n286_), .O(new_n478_));
  oai21  g321(.a(new_n477_), .b(x054), .c(new_n478_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(x006), .O(new_n480_));
  nand3  g323(.a(new_n302_), .b(new_n285_), .c(x030), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n287_), .c(x038), .O(new_n482_));
  nor3   g325(.a(new_n318_), .b(x086), .c(x054), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n482_), .c(x070), .O(new_n484_));
  aoi21  g327(.a(new_n288_), .b(x030), .c(x022), .O(new_n485_));
  inv1   g328(.a(new_n461_), .O(new_n486_));
  nand4  g329(.a(new_n486_), .b(new_n459_), .c(new_n288_), .d(x030), .O(new_n487_));
  oai21  g330(.a(new_n485_), .b(new_n462_), .c(new_n487_), .O(new_n488_));
  nand2  g331(.a(new_n459_), .b(x030), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n318_), .c(new_n291_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n285_), .c(new_n490_), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(x086), .c(new_n484_), .O(new_n492_));
  nor2   g335(.a(new_n462_), .b(x086), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n285_), .c(x078), .O(new_n494_));
  nor2   g337(.a(new_n287_), .b(x014), .O(new_n495_));
  nor2   g338(.a(new_n292_), .b(x054), .O(new_n496_));
  aoi22  g339(.a(new_n496_), .b(new_n495_), .c(x054), .d(x038), .O(new_n497_));
  oai21  g340(.a(new_n494_), .b(new_n286_), .c(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n492_), .b(new_n458_), .c(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n480_), .c(x046), .O(z14));
  zero   g343(.O(z07));
  zero   g344(.O(z15));
  zero   g345(.O(z16));
  zero   g346(.O(z17));
