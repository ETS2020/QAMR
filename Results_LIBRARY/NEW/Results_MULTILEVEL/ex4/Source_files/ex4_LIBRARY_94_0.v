...
module FAU ( 
  ...
  nand3  g153(.a(x086), .b(x054), .c(new_n284_), .O(new_n310_));
  aoi21  g154(.a(new_n310_), .b(x022), .c(new_n293_), .O(new_n311_));
  nand3  g155(.a(new_n288_), .b(x086), .c(x054), .O(new_n312_));
  inv1   g156(.a(new_n312_), .O(new_n313_));
  oai21  g157(.a(new_n313_), .b(new_n311_), .c(new_n290_), .O(new_n314_));
  inv1   g158(.a(x054), .O(new_n315_));
  nor2   g159(.a(x094), .b(x062), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(x030), .c(x022), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n296_), .O(new_n318_));
  inv1   g162(.a(new_n316_), .O(new_n319_));
  nand2  g163(.a(x126), .b(x102), .O(new_n320_));
  nand4  g164(.a(new_n320_), .b(new_n319_), .c(new_n287_), .d(new_n284_), .O(new_n321_));
  aoi21  g165(.a(new_n321_), .b(new_n318_), .c(new_n315_), .O(new_n322_));
  aoi21  g166(.a(new_n287_), .b(new_n284_), .c(new_n288_), .O(new_n323_));
  ...
  nand3  g170(.a(new_n296_), .b(x086), .c(x054), .O(new_n327_));
  nand2  g171(.a(new_n327_), .b(x078), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n285_), .O(new_n329_));
  nor2   g173(.a(x022), .b(new_n285_), .O(new_n330_));
  nor2   g174(.a(x070), .b(new_n315_), .O(new_n331_));
  aoi22  g175(.a(new_n331_), .b(new_n330_), .c(new_n315_), .d(new_n293_), .O(new_n332_));
  nand2  g176(.a(new_n332_), .b(new_n329_), .O(new_n333_));
  aoi21  g177(.a(new_n326_), .b(x078), .c(new_n333_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(new_n309_), .c(new_n281_), .O(z06));
  ...
  oai21  g190(.a(new_n347_), .b(x112), .c(x032), .O(new_n348_));
  nand2  g191(.a(new_n348_), .b(x104), .O(new_n349_));
  ...
  oai21  g257(.a(new_n266_), .b(x029), .c(new_n414_), .O(new_n415_));
  ...
  nand2  g261(.a(new_n418_), .b(new_n263_), .O(new_n419_));
  oai21  g262(.a(new_n246_), .b(x109), .c(x037), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(x117), .O(new_n421_));
  inv1   g264(.a(x101), .O(new_n422_));
  oai21  g265(.a(new_n422_), .b(x061), .c(new_n236_), .O(new_n423_));
  nand3  g266(.a(x125), .b(new_n237_), .c(new_n230_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n254_), .O(new_n425_));
  aoi21  g268(.a(new_n423_), .b(new_n241_), .c(new_n425_), .O(new_n426_));
  nand4  g269(.a(new_n426_), .b(new_n421_), .c(new_n419_), .d(new_n415_), .O(new_n427_));
  nand4  g270(.a(x125), .b(new_n244_), .c(new_n241_), .d(x013), .O(new_n428_));
  inv1   g271(.a(new_n428_), .O(new_n429_));
  aoi21  g272(.a(new_n427_), .b(new_n262_), .c(new_n429_), .O(new_n430_));
  nand3  g273(.a(x085), .b(new_n241_), .c(new_n229_), .O(new_n431_));
  oai21  g274(.a(new_n430_), .b(x053), .c(new_n431_), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(x005), .O(new_n433_));
  nand2  g276(.a(new_n232_), .b(x029), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n230_), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n262_), .O(new_n436_));
  aoi21  g279(.a(new_n436_), .b(new_n229_), .c(new_n417_), .O(new_n437_));
  nor2   g280(.a(new_n228_), .b(x021), .O(new_n438_));
  ...
  aoi21  g284(.a(new_n441_), .b(new_n439_), .c(x077), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n437_), .c(new_n227_), .O(new_n443_));
  nand2  g286(.a(new_n414_), .b(x029), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n258_), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(new_n262_), .c(x037), .O(new_n446_));
  ...
  aoi21  g294(.a(new_n447_), .b(new_n254_), .c(new_n451_), .O(new_n452_));
  aoi21  g295(.a(new_n452_), .b(new_n433_), .c(x045), .O(z13));
  nand2  g296(.a(x022), .b(x014), .O(new_n454_));
  oai21  g297(.a(new_n319_), .b(x030), .c(new_n454_), .O(new_n455_));
  ...
  oai21  g302(.a(new_n298_), .b(x110), .c(x038), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(x118), .O(new_n461_));
  inv1   g304(.a(x102), .O(new_n462_));
  inv1   g305(.a(x110), .O(new_n463_));
  oai21  g306(.a(new_n462_), .b(x062), .c(new_n463_), .O(new_n464_));
  inv1   g307(.a(x118), .O(new_n465_));
  nand3  g308(.a(x126), .b(new_n465_), .c(new_n286_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n306_), .O(new_n467_));
  aoi21  g310(.a(new_n464_), .b(new_n293_), .c(new_n467_), .O(new_n468_));
  nand4  g311(.a(new_n468_), .b(new_n461_), .c(new_n459_), .d(new_n455_), .O(new_n469_));
  inv1   g312(.a(x062), .O(new_n470_));
  nand4  g313(.a(x126), .b(new_n470_), .c(new_n293_), .d(x014), .O(new_n471_));
  inv1   g314(.a(new_n471_), .O(new_n472_));
  aoi21  g315(.a(new_n469_), .b(new_n283_), .c(new_n472_), .O(new_n473_));
  nand3  g316(.a(x086), .b(new_n293_), .c(new_n285_), .O(new_n474_));
  oai21  g317(.a(new_n473_), .b(x054), .c(new_n474_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(x006), .O(new_n476_));
  nand2  g319(.a(new_n288_), .b(x030), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n286_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n283_), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n285_), .c(new_n457_), .O(new_n480_));
  nor2   g323(.a(new_n284_), .b(x022), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n319_), .c(x070), .O(new_n482_));
  inv1   g325(.a(new_n456_), .O(new_n483_));
  nand4  g326(.a(new_n483_), .b(new_n454_), .c(new_n288_), .d(x030), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n482_), .c(x078), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n480_), .c(new_n315_), .O(new_n486_));
  nand2  g329(.a(new_n454_), .b(x030), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n316_), .O(new_n488_));
  nand3  g331(.a(new_n488_), .b(new_n283_), .c(x038), .O(new_n489_));
  ...
  aoi21  g337(.a(new_n490_), .b(new_n306_), .c(new_n494_), .O(new_n495_));
