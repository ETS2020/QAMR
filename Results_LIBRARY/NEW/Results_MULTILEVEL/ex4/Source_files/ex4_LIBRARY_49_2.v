...
module FAU ( 
  ...
  nand4  g150(.a(new_n302_), .b(x094), .c(x038), .d(new_n285_), .O(new_n307_));
  ...
  aoi21  g299(.a(new_n314_), .b(new_n284_), .c(new_n456_), .O(new_n457_));
  inv1   g300(.a(x062), .O(new_n458_));
  inv1   g301(.a(x102), .O(new_n459_));
  oai22  g302(.a(new_n302_), .b(new_n300_), .c(new_n459_), .d(x038), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n458_), .O(new_n461_));
  oai22  g304(.a(x118), .b(x110), .c(new_n319_), .d(new_n297_), .O(new_n462_));
  nand2  g305(.a(new_n302_), .b(new_n459_), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n300_), .c(new_n319_), .O(new_n464_));
  nor2   g307(.a(new_n302_), .b(x110), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n286_), .c(x086), .O(new_n466_));
  nand4  g309(.a(new_n466_), .b(new_n464_), .c(new_n462_), .d(new_n461_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n457_), .c(new_n283_), .O(new_n468_));
  nand4  g311(.a(x126), .b(new_n293_), .c(x038), .d(new_n285_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n468_), .c(x078), .O(new_n470_));
  nand3  g313(.a(x086), .b(new_n297_), .c(new_n285_), .O(new_n471_));
