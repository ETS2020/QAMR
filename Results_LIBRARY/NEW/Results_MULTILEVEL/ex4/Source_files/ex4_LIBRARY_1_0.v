// Benchmark "FAU" written by ABC on Tue Jul 28 06:46:18 2020
...
module FAU ( 
  ...
  nand2  g075(.a(new_n231_), .b(x093), .O(new_n232_));
  inv1   g076(.a(x109), .O(new_n233_));
  inv1   g077(.a(x117), .O(new_n234_));
  nor2   g078(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g079(.a(new_n235_), .b(new_n232_), .O(new_n236_));
  nand2  g080(.a(new_n236_), .b(x069), .O(new_n237_));
  inv1   g081(.a(x061), .O(new_n238_));
  oai21  g082(.a(x101), .b(new_n238_), .c(new_n235_), .O(new_n239_));
  nand2  g083(.a(new_n239_), .b(x037), .O(new_n240_));
  inv1   g084(.a(x085), .O(new_n241_));
  nor2   g085(.a(x125), .b(new_n234_), .O(new_n242_));
  aoi21  g086(.a(new_n242_), .b(x021), .c(new_n241_), .O(new_n243_));
  nand4  g087(.a(new_n243_), .b(new_n240_), .c(new_n237_), .d(new_n230_), .O(new_n244_));
  nand2  g088(.a(new_n244_), .b(x077), .O(new_n245_));
  inv1   g089(.a(x013), .O(new_n246_));
  inv1   g090(.a(x125), .O(new_n247_));
  nand4  g091(.a(new_n247_), .b(x061), .c(x037), .d(new_n246_), .O(new_n248_));
  aoi21  g092(.a(new_n248_), .b(new_n245_), .c(new_n227_), .O(new_n249_));
  nand3  g093(.a(new_n241_), .b(x037), .c(x013), .O(new_n250_));
  nor2   g094(.a(x069), .b(x037), .O(new_n251_));
  nand4  g095(.a(new_n251_), .b(new_n247_), .c(new_n234_), .d(x109), .O(new_n252_));
  nand2  g096(.a(new_n252_), .b(new_n250_), .O(new_n253_));
  oai21  g097(.a(new_n253_), .b(new_n249_), .c(new_n226_), .O(new_n254_));
  inv1   g098(.a(x021), .O(new_n255_));
  oai21  g099(.a(x037), .b(x013), .c(new_n255_), .O(new_n256_));
  inv1   g100(.a(x037), .O(new_n257_));
  inv1   g101(.a(new_n229_), .O(new_n258_));
  oai21  g102(.a(new_n257_), .b(x029), .c(new_n258_), .O(new_n259_));
  nand3  g103(.a(new_n259_), .b(x085), .c(x053), .O(new_n260_));
  aoi21  g104(.a(new_n260_), .b(new_n256_), .c(x069), .O(new_n261_));
  nor2   g105(.a(x093), .b(x061), .O(new_n262_));
  oai21  g106(.a(new_n262_), .b(x029), .c(x021), .O(new_n263_));
  aoi21  g107(.a(new_n263_), .b(x077), .c(new_n246_), .O(new_n264_));
  nor2   g108(.a(x021), .b(x013), .O(new_n265_));
  nor2   g109(.a(new_n262_), .b(new_n265_), .O(new_n266_));
  nand4  g110(.a(new_n266_), .b(new_n231_), .c(x077), .d(new_n228_), .O(new_n267_));
  oai21  g111(.a(new_n264_), .b(new_n235_), .c(new_n267_), .O(new_n268_));
  nor2   g112(.a(new_n265_), .b(x029), .O(new_n269_));
  oai21  g113(.a(new_n269_), .b(new_n229_), .c(x077), .O(new_n270_));
  nor2   g114(.a(new_n270_), .b(x037), .O(new_n271_));
  aoi21  g115(.a(new_n268_), .b(x053), .c(new_n271_), .O(new_n272_));
  inv1   g116(.a(x077), .O(new_n273_));
  aoi22  g117(.a(new_n273_), .b(new_n246_), .c(new_n227_), .d(new_n257_), .O(new_n274_));
  oai21  g118(.a(new_n272_), .b(new_n241_), .c(new_n274_), .O(new_n275_));
  nor2   g119(.a(new_n275_), .b(new_n261_), .O(new_n276_));
  aoi21  g120(.a(new_n276_), .b(new_n254_), .c(new_n225_), .O(z05));
  ...
  oai21  g132(.a(new_n288_), .b(new_n281_), .c(new_n284_), .O(new_n289_));
  ...
  oai21  g143(.a(x102), .b(new_n285_), .c(x110), .O(new_n300_));
  ...
  nand4  g148(.a(new_n304_), .b(new_n299_), .c(new_n296_), .d(new_n289_), .O(new_n305_));
  nand4  g149(.a(new_n301_), .b(x062), .c(x038), .d(new_n282_), .O(new_n306_));
  ...
  oai21  g154(.a(new_n308_), .b(new_n280_), .c(new_n310_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(new_n279_), .O(new_n312_));
  ...
  aoi21  g159(.a(new_n315_), .b(x014), .c(new_n294_), .O(new_n316_));
  inv1   g160(.a(x078), .O(new_n317_));
  inv1   g161(.a(x070), .O(new_n318_));
  nor2   g162(.a(x030), .b(new_n283_), .O(new_n319_));
  oai21  g163(.a(new_n319_), .b(new_n288_), .c(new_n318_), .O(new_n320_));
  inv1   g164(.a(new_n313_), .O(new_n321_));
  nand4  g165(.a(new_n321_), .b(new_n290_), .c(new_n284_), .d(new_n281_), .O(new_n322_));
  aoi21  g166(.a(new_n322_), .b(new_n320_), .c(new_n317_), .O(new_n323_));
  oai21  g167(.a(new_n323_), .b(new_n316_), .c(x054), .O(new_n324_));
  nand2  g168(.a(new_n284_), .b(new_n281_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n287_), .O(new_n326_));
  nand3  g170(.a(new_n326_), .b(x078), .c(new_n297_), .O(new_n327_));
  nand2  g171(.a(new_n327_), .b(new_n324_), .O(new_n328_));
  oai22  g172(.a(new_n317_), .b(new_n297_), .c(new_n280_), .d(new_n282_), .O(new_n329_));
  nand3  g173(.a(new_n329_), .b(new_n318_), .c(new_n283_), .O(new_n330_));
  aoi22  g174(.a(new_n317_), .b(new_n282_), .c(new_n280_), .d(new_n297_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  aoi21  g176(.a(new_n328_), .b(x086), .c(new_n332_), .O(new_n333_));
  aoi21  g177(.a(new_n333_), .b(new_n312_), .c(new_n278_), .O(z06));
  ...
  nand2  g187(.a(new_n344_), .b(new_n338_), .O(new_n345_));
  ...
  oai21  g191(.a(new_n343_), .b(x104), .c(x032), .O(new_n349_));
  nand2  g192(.a(new_n349_), .b(x112), .O(new_n350_));
  inv1   g193(.a(x104), .O(new_n351_));
  oai21  g194(.a(new_n342_), .b(x056), .c(new_n351_), .O(new_n352_));
  ...
  nand4  g199(.a(new_n356_), .b(new_n350_), .c(new_n348_), .d(new_n340_), .O(new_n357_));
  nand4  g200(.a(x120), .b(new_n337_), .c(new_n161_), .d(x008), .O(new_n358_));
  ...
  aoi21  g210(.a(new_n367_), .b(new_n160_), .c(new_n346_), .O(new_n368_));
  inv1   g211(.a(x024), .O(new_n369_));
  nor2   g212(.a(new_n369_), .b(x016), .O(new_n370_));
  oai21  g213(.a(new_n370_), .b(new_n339_), .c(x064), .O(new_n371_));
  nand4  g214(.a(new_n364_), .b(new_n344_), .c(new_n336_), .d(x024), .O(new_n372_));
  aoi21  g215(.a(new_n372_), .b(new_n371_), .c(x072), .O(new_n373_));
  oai21  g216(.a(new_n373_), .b(new_n368_), .c(new_n162_), .O(new_n374_));
  ...
  aoi21  g226(.a(new_n383_), .b(new_n363_), .c(x040), .O(z08));
  ...
  nand3  g255(.a(x069), .b(new_n227_), .c(new_n246_), .O(new_n413_));
  oai21  g256(.a(x077), .b(x037), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(x021), .O(new_n415_));
  nand4  g258(.a(x125), .b(new_n233_), .c(new_n273_), .d(new_n227_), .O(new_n416_));
  oai21  g259(.a(new_n241_), .b(x037), .c(new_n416_), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(new_n246_), .O(new_n418_));
  nand2  g261(.a(new_n234_), .b(new_n233_), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(x101), .c(new_n257_), .O(new_n420_));
  nand3  g263(.a(x125), .b(new_n234_), .c(new_n255_), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(new_n420_), .c(new_n241_), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(new_n273_), .c(new_n227_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n418_), .O(new_n424_));
  aoi21  g267(.a(new_n234_), .b(new_n233_), .c(new_n246_), .O(new_n425_));
  nand2  g268(.a(x029), .b(new_n255_), .O(new_n426_));
  aoi21  g269(.a(new_n426_), .b(new_n262_), .c(x077), .O(new_n427_));
  oai21  g270(.a(new_n427_), .b(new_n425_), .c(new_n241_), .O(new_n428_));
  aoi22  g271(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n429_));
  oai21  g272(.a(new_n428_), .b(x053), .c(new_n429_), .O(new_n430_));
  aoi21  g273(.a(new_n424_), .b(x005), .c(new_n430_), .O(new_n431_));
  aoi21  g274(.a(new_n431_), .b(new_n415_), .c(x045), .O(z13));
  nand2  g275(.a(x022), .b(x014), .O(new_n433_));
  oai21  g276(.a(new_n321_), .b(x030), .c(new_n433_), .O(new_n434_));
  inv1   g277(.a(x102), .O(new_n435_));
  nand2  g278(.a(new_n301_), .b(new_n435_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n286_), .O(new_n437_));
  nor2   g280(.a(x118), .b(x110), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n437_), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n318_), .O(new_n440_));
  oai21  g283(.a(new_n301_), .b(x110), .c(x038), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(x118), .O(new_n442_));
  oai21  g285(.a(new_n435_), .b(x062), .c(new_n292_), .O(new_n443_));
  nand3  g286(.a(x126), .b(new_n293_), .c(new_n283_), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n309_), .O(new_n445_));
  aoi21  g288(.a(new_n443_), .b(new_n297_), .c(new_n445_), .O(new_n446_));
  nand4  g289(.a(new_n446_), .b(new_n442_), .c(new_n440_), .d(new_n434_), .O(new_n447_));
  nand4  g290(.a(x126), .b(new_n285_), .c(new_n297_), .d(x014), .O(new_n448_));
  inv1   g291(.a(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n447_), .b(new_n317_), .c(new_n449_), .O(new_n450_));
  nand3  g293(.a(x086), .b(new_n297_), .c(new_n282_), .O(new_n451_));
  oai21  g294(.a(new_n450_), .b(x054), .c(new_n451_), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(x006), .O(new_n453_));
  oai21  g296(.a(new_n287_), .b(new_n281_), .c(new_n283_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n317_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n282_), .c(new_n438_), .O(new_n456_));
  nor2   g299(.a(new_n281_), .b(x022), .O(new_n457_));
  oai21  g300(.a(new_n457_), .b(new_n321_), .c(x070), .O(new_n458_));
  nand4  g301(.a(new_n436_), .b(new_n433_), .c(new_n288_), .d(x030), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n458_), .c(x078), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n456_), .c(new_n280_), .O(new_n461_));
  nand2  g304(.a(new_n433_), .b(x030), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n313_), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n317_), .c(x038), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n461_), .O(new_n465_));
  oai22  g308(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(x070), .c(x022), .O(new_n467_));
  aoi22  g310(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n467_), .O(new_n469_));
  aoi21  g312(.a(new_n465_), .b(new_n309_), .c(new_n469_), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n453_), .c(x046), .O(z14));
  zero   g314(.O(z07));
  zero   g315(.O(z15));
  zero   g316(.O(z16));
  zero   g317(.O(z17));
