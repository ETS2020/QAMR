...
module FAU ( 
  ...
  nand2  g087(.a(x117), .b(x021), .O(new_n244_));
  oai21  g088(.a(x117), .b(new_n243_), .c(new_n244_), .O(new_n245_));
  aoi21  g089(.a(new_n245_), .b(new_n242_), .c(new_n241_), .O(new_n246_));
  nand4  g090(.a(new_n246_), .b(new_n240_), .c(new_n236_), .d(new_n233_), .O(new_n247_));
  nand2  g091(.a(new_n247_), .b(x077), .O(new_n248_));
  nand3  g092(.a(new_n242_), .b(x061), .c(new_n229_), .O(new_n249_));
  nand2  g093(.a(new_n249_), .b(x109), .O(new_n250_));
  aoi22  g094(.a(new_n250_), .b(x037), .c(new_n243_), .d(x069), .O(new_n251_));
  aoi21  g095(.a(new_n251_), .b(new_n248_), .c(new_n227_), .O(new_n252_));
  nand3  g096(.a(new_n241_), .b(x037), .c(x013), .O(new_n253_));
  inv1   g097(.a(new_n253_), .O(new_n254_));
  oai21  g098(.a(new_n254_), .b(new_n252_), .c(new_n226_), .O(new_n255_));
  inv1   g099(.a(x117), .O(new_n256_));
  oai21  g100(.a(new_n256_), .b(new_n243_), .c(new_n229_), .O(new_n257_));
  inv1   g101(.a(x077), .O(new_n258_));
  oai21  g102(.a(x117), .b(new_n258_), .c(x109), .O(new_n259_));
  inv1   g103(.a(x093), .O(new_n260_));
  aoi21  g104(.a(new_n260_), .b(new_n234_), .c(x029), .O(new_n261_));
  oai21  g105(.a(new_n261_), .b(new_n230_), .c(new_n259_), .O(new_n262_));
  inv1   g106(.a(new_n232_), .O(new_n263_));
  nand2  g107(.a(new_n228_), .b(x021), .O(new_n264_));
  aoi21  g108(.a(new_n264_), .b(new_n263_), .c(x069), .O(new_n265_));
  nand2  g109(.a(new_n260_), .b(new_n234_), .O(new_n266_));
  nand4  g110(.a(new_n266_), .b(new_n237_), .c(new_n231_), .d(new_n228_), .O(new_n267_));
  inv1   g111(.a(new_n267_), .O(new_n268_));
  oai21  g112(.a(new_n268_), .b(new_n265_), .c(x077), .O(new_n269_));
  nand3  g113(.a(new_n269_), .b(new_n262_), .c(new_n257_), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(x053), .O(new_n271_));
  inv1   g115(.a(x037), .O(new_n272_));
  nand2  g116(.a(new_n231_), .b(new_n228_), .O(new_n273_));
  nand2  g117(.a(new_n273_), .b(new_n263_), .O(new_n274_));
  nand3  g118(.a(new_n274_), .b(x077), .c(new_n272_), .O(new_n275_));
  nand2  g119(.a(new_n275_), .b(new_n271_), .O(new_n276_));
  inv1   g120(.a(x069), .O(new_n277_));
  oai22  g121(.a(new_n258_), .b(new_n272_), .c(new_n227_), .d(new_n229_), .O(new_n278_));
  nand3  g122(.a(new_n278_), .b(new_n277_), .c(new_n230_), .O(new_n279_));
  aoi22  g123(.a(new_n258_), .b(new_n229_), .c(new_n227_), .d(new_n272_), .O(new_n280_));
  nand2  g124(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  aoi21  g125(.a(new_n276_), .b(x085), .c(new_n281_), .O(new_n282_));
  aoi21  g126(.a(new_n282_), .b(new_n255_), .c(new_n225_), .O(z05));
