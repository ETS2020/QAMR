...
module FAU ( 
  ...
  oai21  g303(.a(new_n302_), .b(x118), .c(x038), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(x110), .O(new_n462_));
  inv1   g305(.a(x102), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(x062), .c(new_n293_), .O(new_n464_));
  nand3  g307(.a(x126), .b(new_n292_), .c(new_n286_), .O(new_n465_));
