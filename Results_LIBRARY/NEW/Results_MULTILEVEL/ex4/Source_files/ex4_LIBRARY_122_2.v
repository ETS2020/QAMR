...
module FAU ( 
  ...
  inv1   g070(.a(x037), .O(new_n227_));
  inv1   g071(.a(x069), .O(new_n228_));
  aoi21  g072(.a(new_n228_), .b(new_n227_), .c(x005), .O(new_n229_));
  ...
  aoi21  g082(.a(new_n238_), .b(new_n235_), .c(new_n230_), .O(new_n239_));
  oai21  g083(.a(new_n239_), .b(new_n229_), .c(new_n226_), .O(new_n240_));
  nand3  g084(.a(x085), .b(new_n228_), .c(new_n231_), .O(new_n241_));
  inv1   g085(.a(x005), .O(new_n242_));
  inv1   g086(.a(x101), .O(new_n243_));
  nand3  g087(.a(new_n243_), .b(x061), .c(new_n242_), .O(new_n244_));
  nand2  g088(.a(new_n244_), .b(new_n241_), .O(new_n245_));
  nand2  g089(.a(new_n245_), .b(x037), .O(new_n246_));
  inv1   g090(.a(x125), .O(new_n247_));
  nand2  g091(.a(new_n237_), .b(new_n236_), .O(new_n248_));
  nand4  g092(.a(new_n248_), .b(new_n234_), .c(x085), .d(new_n231_), .O(new_n249_));
  nand3  g093(.a(x093), .b(x069), .c(new_n242_), .O(new_n250_));
  nand2  g094(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  oai21  g095(.a(new_n247_), .b(new_n243_), .c(new_n251_), .O(new_n252_));
  nand2  g096(.a(x093), .b(x061), .O(new_n253_));
  oai21  g097(.a(new_n253_), .b(new_n231_), .c(new_n248_), .O(new_n254_));
  nand2  g098(.a(new_n233_), .b(x061), .O(new_n255_));
  nand2  g099(.a(x117), .b(x021), .O(new_n256_));
  inv1   g100(.a(x117), .O(new_n257_));
  nand2  g101(.a(new_n257_), .b(x109), .O(new_n258_));
  nand3  g102(.a(new_n258_), .b(new_n256_), .c(new_n255_), .O(new_n259_));
  nand2  g103(.a(new_n259_), .b(new_n247_), .O(new_n260_));
  nand3  g104(.a(new_n260_), .b(new_n254_), .c(x085), .O(new_n261_));
  inv1   g105(.a(new_n253_), .O(new_n262_));
  nor2   g106(.a(new_n262_), .b(new_n230_), .O(new_n263_));
  aoi22  g107(.a(new_n263_), .b(new_n228_), .c(new_n261_), .d(new_n242_), .O(new_n264_));
  nand4  g108(.a(new_n264_), .b(new_n252_), .c(new_n246_), .d(new_n240_), .O(new_n265_));
  nand2  g109(.a(new_n227_), .b(new_n236_), .O(new_n266_));
  nand3  g110(.a(new_n266_), .b(new_n228_), .c(new_n237_), .O(new_n267_));
  nand3  g111(.a(x085), .b(new_n227_), .c(new_n231_), .O(new_n268_));
  oai21  g112(.a(x085), .b(x005), .c(new_n268_), .O(new_n269_));
  nand2  g113(.a(new_n269_), .b(x013), .O(new_n270_));
  inv1   g114(.a(x053), .O(new_n271_));
  nand2  g115(.a(new_n231_), .b(x021), .O(new_n272_));
  aoi21  g116(.a(new_n272_), .b(new_n262_), .c(new_n230_), .O(new_n273_));
  oai21  g117(.a(new_n273_), .b(new_n271_), .c(new_n227_), .O(new_n274_));
  nand4  g118(.a(new_n274_), .b(new_n270_), .c(new_n267_), .d(x077), .O(new_n275_));
  aoi21  g119(.a(new_n265_), .b(x053), .c(new_n275_), .O(new_n276_));
  nor2   g120(.a(new_n276_), .b(new_n225_), .O(z05));
  ...
  oai21  g255(.a(new_n412_), .b(new_n227_), .c(x085), .O(new_n413_));
  inv1   g256(.a(x109), .O(new_n414_));
  nand2  g257(.a(new_n257_), .b(new_n414_), .O(new_n415_));
  oai22  g258(.a(new_n415_), .b(x101), .c(new_n228_), .d(new_n227_), .O(new_n416_));
  nand2  g259(.a(new_n226_), .b(x125), .O(new_n417_));
  nor2   g260(.a(new_n234_), .b(x029), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(new_n417_), .c(new_n416_), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(new_n412_), .c(new_n271_), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n413_), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(x005), .O(new_n422_));
  oai21  g265(.a(new_n262_), .b(new_n231_), .c(new_n237_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n415_), .O(new_n424_));
  aoi22  g267(.a(new_n247_), .b(new_n243_), .c(x093), .d(x061), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(x069), .c(x029), .O(new_n426_));
  nand2  g269(.a(new_n234_), .b(x069), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(new_n426_), .c(new_n424_), .O(new_n428_));
  nor2   g271(.a(new_n418_), .b(new_n227_), .O(new_n429_));
  aoi21  g272(.a(new_n428_), .b(new_n271_), .c(new_n429_), .O(new_n430_));
  nand2  g273(.a(x069), .b(x021), .O(new_n431_));
  oai21  g274(.a(new_n430_), .b(x085), .c(new_n431_), .O(new_n432_));
  nand2  g275(.a(x053), .b(x037), .O(new_n433_));
  nand3  g276(.a(x069), .b(new_n271_), .c(x021), .O(new_n434_));
  nand3  g277(.a(new_n434_), .b(new_n433_), .c(new_n236_), .O(new_n435_));
  aoi21  g278(.a(new_n432_), .b(new_n412_), .c(new_n435_), .O(new_n436_));
  aoi21  g279(.a(new_n436_), .b(new_n422_), .c(x045), .O(z13));
  nand2  g280(.a(x022), .b(x014), .O(new_n438_));
  oai21  g281(.a(new_n319_), .b(x030), .c(new_n438_), .O(new_n439_));
  ...
  oai21  g286(.a(new_n299_), .b(x110), .c(x038), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(x118), .O(new_n445_));
  inv1   g288(.a(x102), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(x062), .c(new_n289_), .O(new_n447_));
  nand3  g290(.a(x126), .b(new_n290_), .c(new_n283_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n307_), .O(new_n449_));
  aoi21  g292(.a(new_n447_), .b(new_n294_), .c(new_n449_), .O(new_n450_));
  nand4  g293(.a(new_n450_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n451_));
  nand4  g294(.a(x126), .b(new_n297_), .c(new_n294_), .d(x014), .O(new_n452_));
  inv1   g295(.a(new_n452_), .O(new_n453_));
  aoi21  g296(.a(new_n451_), .b(new_n315_), .c(new_n453_), .O(new_n454_));
  nand3  g297(.a(x086), .b(new_n294_), .c(new_n282_), .O(new_n455_));
  oai21  g298(.a(new_n454_), .b(x054), .c(new_n455_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(x006), .O(new_n457_));
  oai21  g300(.a(new_n323_), .b(new_n281_), .c(new_n283_), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n315_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n282_), .c(new_n441_), .O(new_n460_));
  nor2   g303(.a(new_n281_), .b(x022), .O(new_n461_));
  oai21  g304(.a(new_n461_), .b(new_n319_), .c(x070), .O(new_n462_));
  inv1   g305(.a(new_n440_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n438_), .c(new_n285_), .d(x030), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n462_), .c(x078), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n460_), .c(new_n280_), .O(new_n466_));
  nand2  g309(.a(new_n438_), .b(x030), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n311_), .O(new_n468_));
  nand3  g311(.a(new_n468_), .b(new_n315_), .c(x038), .O(new_n469_));
  ...
  aoi21  g317(.a(new_n470_), .b(new_n307_), .c(new_n474_), .O(new_n475_));
