// Benchmark "FAU" written by ABC on Tue Jul 28 06:49:33 2020
...
module FAU ( 
  ...
  oai22  g189(.a(new_n346_), .b(new_n344_), .c(new_n345_), .d(x064), .O(new_n347_));
  nand2  g190(.a(new_n347_), .b(new_n343_), .O(new_n348_));
  oai22  g191(.a(new_n346_), .b(x064), .c(new_n345_), .d(x032), .O(new_n349_));
  nand2  g192(.a(new_n349_), .b(new_n344_), .O(new_n350_));
  nor2   g193(.a(x112), .b(x104), .O(new_n351_));
  aoi21  g194(.a(x064), .b(x032), .c(new_n351_), .O(new_n352_));
  ...
  nor2   g198(.a(new_n355_), .b(new_n352_), .O(new_n356_));
  nand4  g199(.a(new_n356_), .b(new_n350_), .c(new_n348_), .d(new_n342_), .O(new_n357_));
  inv1   g200(.a(x104), .O(new_n358_));
  nand4  g201(.a(x120), .b(new_n358_), .c(x032), .d(new_n160_), .O(new_n359_));
  inv1   g202(.a(new_n359_), .O(new_n360_));
  aoi21  g203(.a(new_n357_), .b(new_n162_), .c(new_n360_), .O(new_n361_));
  nand3  g204(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n362_));
  oai21  g205(.a(new_n361_), .b(x072), .c(new_n362_), .O(new_n363_));
  ...
  nand2  g213(.a(new_n346_), .b(new_n345_), .O(new_n371_));
  nand4  g214(.a(new_n371_), .b(new_n369_), .c(new_n338_), .d(x024), .O(new_n372_));
  oai21  g215(.a(new_n370_), .b(new_n351_), .c(new_n372_), .O(new_n373_));
  ...
  nor2   g220(.a(new_n351_), .b(x080), .O(new_n378_));
  aoi21  g221(.a(new_n378_), .b(new_n162_), .c(x072), .O(new_n379_));
  nor2   g222(.a(new_n166_), .b(x008), .O(new_n380_));
  inv1   g223(.a(x064), .O(new_n381_));
  nor2   g224(.a(new_n381_), .b(x048), .O(new_n382_));
  aoi22  g225(.a(new_n382_), .b(new_n380_), .c(x048), .d(x032), .O(new_n383_));
  oai21  g226(.a(new_n379_), .b(new_n160_), .c(new_n383_), .O(new_n384_));
  aoi21  g227(.a(new_n377_), .b(new_n163_), .c(new_n384_), .O(new_n385_));
