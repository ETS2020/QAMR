...
module FAU ( 
  ...
  oai21  g304(.a(new_n302_), .b(x118), .c(x038), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(x110), .O(new_n463_));
  inv1   g306(.a(x102), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(x062), .c(new_n293_), .O(new_n465_));
  nand3  g308(.a(x126), .b(new_n292_), .c(new_n286_), .O(new_n466_));
