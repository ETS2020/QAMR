// Benchmark "FAU" written by ABC on Tue Jul 28 06:49:44 2020
...
module FAU ( 
  ...
  aoi22  g131(.a(new_n287_), .b(x030), .c(new_n285_), .d(new_n284_), .O(new_n288_));
  inv1   g132(.a(x038), .O(new_n289_));
  inv1   g133(.a(x070), .O(new_n290_));
  oai22  g134(.a(x126), .b(new_n290_), .c(x102), .d(new_n289_), .O(new_n291_));
  ...
  nand2  g140(.a(x118), .b(x022), .O(new_n297_));
  oai21  g141(.a(x118), .b(new_n296_), .c(new_n297_), .O(new_n298_));
  nand2  g142(.a(new_n298_), .b(new_n295_), .O(new_n299_));
  inv1   g143(.a(x086), .O(new_n300_));
  nor2   g144(.a(x102), .b(new_n290_), .O(new_n301_));
  aoi21  g145(.a(new_n301_), .b(x062), .c(new_n300_), .O(new_n302_));
  nand4  g146(.a(new_n302_), .b(new_n299_), .c(new_n294_), .d(new_n292_), .O(new_n303_));
  oai21  g147(.a(new_n303_), .b(new_n288_), .c(x078), .O(new_n304_));
  nand4  g148(.a(new_n295_), .b(x062), .c(x038), .d(new_n284_), .O(new_n305_));
  aoi21  g149(.a(new_n305_), .b(new_n304_), .c(new_n283_), .O(new_n306_));
  nand3  g150(.a(new_n300_), .b(x038), .c(x014), .O(new_n307_));
  inv1   g151(.a(new_n307_), .O(new_n308_));
  oai21  g152(.a(new_n308_), .b(new_n306_), .c(new_n282_), .O(new_n309_));
  inv1   g153(.a(x030), .O(new_n310_));
  nand3  g154(.a(x086), .b(x054), .c(new_n310_), .O(new_n311_));
  aoi21  g155(.a(new_n311_), .b(x022), .c(new_n289_), .O(new_n312_));
  nand3  g156(.a(new_n286_), .b(x086), .c(x054), .O(new_n313_));
  inv1   g157(.a(new_n313_), .O(new_n314_));
  oai21  g158(.a(new_n314_), .b(new_n312_), .c(new_n290_), .O(new_n315_));
  nor2   g159(.a(x094), .b(x062), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(x030), .c(x022), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n293_), .O(new_n318_));
  nand2  g162(.a(new_n285_), .b(new_n284_), .O(new_n319_));
  inv1   g163(.a(new_n316_), .O(new_n320_));
  nand2  g164(.a(x126), .b(x102), .O(new_n321_));
  nand4  g165(.a(new_n321_), .b(new_n320_), .c(new_n319_), .d(new_n310_), .O(new_n322_));
  aoi21  g166(.a(new_n322_), .b(new_n318_), .c(new_n283_), .O(new_n323_));
  nand2  g167(.a(new_n319_), .b(new_n310_), .O(new_n324_));
  aoi21  g168(.a(new_n324_), .b(new_n287_), .c(x038), .O(new_n325_));
  oai21  g169(.a(new_n325_), .b(new_n323_), .c(x086), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n315_), .O(new_n327_));
  nand3  g171(.a(new_n293_), .b(x086), .c(x054), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(x078), .O(new_n329_));
  nand2  g173(.a(new_n329_), .b(new_n284_), .O(new_n330_));
  nor2   g174(.a(x022), .b(new_n284_), .O(new_n331_));
  nor2   g175(.a(x070), .b(new_n283_), .O(new_n332_));
  aoi22  g176(.a(new_n332_), .b(new_n331_), .c(new_n283_), .d(new_n289_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n330_), .O(new_n334_));
  aoi21  g178(.a(new_n327_), .b(x078), .c(new_n334_), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(new_n309_), .c(new_n281_), .O(z06));
  ...
  oai21  g304(.a(new_n295_), .b(x110), .c(x038), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(x118), .O(new_n463_));
  inv1   g306(.a(x102), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(x062), .c(new_n296_), .O(new_n465_));
  inv1   g308(.a(x118), .O(new_n466_));
  nand3  g309(.a(x126), .b(new_n466_), .c(new_n285_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n300_), .O(new_n468_));
  aoi21  g311(.a(new_n465_), .b(new_n289_), .c(new_n468_), .O(new_n469_));
  nand4  g312(.a(new_n469_), .b(new_n463_), .c(new_n461_), .d(new_n457_), .O(new_n470_));
  inv1   g313(.a(x062), .O(new_n471_));
  nand4  g314(.a(x126), .b(new_n471_), .c(new_n289_), .d(x014), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n470_), .b(new_n455_), .c(new_n473_), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n289_), .c(new_n284_), .O(new_n475_));
  oai21  g318(.a(new_n474_), .b(x054), .c(new_n475_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x006), .O(new_n477_));
  nand3  g320(.a(new_n300_), .b(new_n283_), .c(x030), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n285_), .c(x038), .O(new_n479_));
  nor3   g322(.a(new_n316_), .b(x086), .c(x054), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n479_), .c(x070), .O(new_n481_));
  aoi21  g324(.a(new_n286_), .b(x030), .c(x022), .O(new_n482_));
  inv1   g325(.a(new_n458_), .O(new_n483_));
  nand4  g326(.a(new_n483_), .b(new_n456_), .c(new_n286_), .d(x030), .O(new_n484_));
  oai21  g327(.a(new_n482_), .b(new_n459_), .c(new_n484_), .O(new_n485_));
  nand2  g328(.a(new_n456_), .b(x030), .O(new_n486_));
  aoi21  g329(.a(new_n486_), .b(new_n316_), .c(new_n289_), .O(new_n487_));
  aoi21  g330(.a(new_n485_), .b(new_n283_), .c(new_n487_), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(x086), .c(new_n481_), .O(new_n489_));
  nor2   g332(.a(new_n459_), .b(x086), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n283_), .c(x078), .O(new_n491_));
  nor2   g334(.a(new_n285_), .b(x014), .O(new_n492_));
  nor2   g335(.a(new_n290_), .b(x054), .O(new_n493_));
  aoi22  g336(.a(new_n493_), .b(new_n492_), .c(x054), .d(x038), .O(new_n494_));
  oai21  g337(.a(new_n491_), .b(new_n284_), .c(new_n494_), .O(new_n495_));
  aoi21  g338(.a(new_n489_), .b(new_n455_), .c(new_n495_), .O(new_n496_));
