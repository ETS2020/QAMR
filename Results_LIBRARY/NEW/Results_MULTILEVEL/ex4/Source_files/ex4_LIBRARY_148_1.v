// Benchmark "FAU" written by ABC on Tue Jul 28 06:48:18 2020
...
module FAU ( 
  ...
  nand2  g277(.a(new_n232_), .b(x029), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n230_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n262_), .O(new_n437_));
  aoi21  g280(.a(new_n437_), .b(new_n229_), .c(new_n418_), .O(new_n438_));
  nor2   g281(.a(new_n228_), .b(x021), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(new_n266_), .c(x069), .O(new_n440_));
  inv1   g283(.a(new_n417_), .O(new_n441_));
  nand4  g284(.a(new_n441_), .b(new_n415_), .c(new_n232_), .d(x029), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(new_n440_), .c(x077), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n438_), .c(new_n227_), .O(new_n444_));
  nand2  g287(.a(new_n415_), .b(x029), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n258_), .O(new_n446_));
  nand3  g289(.a(new_n446_), .b(new_n262_), .c(x037), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n444_), .O(new_n448_));
  oai22  g291(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(x069), .c(x021), .O(new_n450_));
  aoi22  g293(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n450_), .O(new_n452_));
  aoi21  g295(.a(new_n448_), .b(new_n254_), .c(new_n452_), .O(new_n453_));
  ...
  nand3  g317(.a(new_n310_), .b(new_n283_), .c(x030), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n286_), .c(x038), .O(new_n476_));
  nor3   g319(.a(new_n314_), .b(x086), .c(x054), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n476_), .c(x070), .O(new_n478_));
  aoi21  g321(.a(new_n288_), .b(x030), .c(x022), .O(new_n479_));
  inv1   g322(.a(new_n457_), .O(new_n480_));
  nand4  g323(.a(new_n480_), .b(new_n455_), .c(new_n288_), .d(x030), .O(new_n481_));
  oai21  g324(.a(new_n479_), .b(new_n458_), .c(new_n481_), .O(new_n482_));
  nand2  g325(.a(new_n455_), .b(x030), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n314_), .c(new_n297_), .O(new_n484_));
  aoi21  g327(.a(new_n482_), .b(new_n283_), .c(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(x086), .c(new_n478_), .O(new_n486_));
  nor2   g329(.a(new_n458_), .b(x086), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n283_), .c(x078), .O(new_n488_));
  nor2   g331(.a(new_n286_), .b(x014), .O(new_n489_));
  nor2   g332(.a(new_n319_), .b(x054), .O(new_n490_));
  aoi22  g333(.a(new_n490_), .b(new_n489_), .c(x054), .d(x038), .O(new_n491_));
  oai21  g334(.a(new_n488_), .b(new_n285_), .c(new_n491_), .O(new_n492_));
  aoi21  g335(.a(new_n486_), .b(new_n318_), .c(new_n492_), .O(new_n493_));
