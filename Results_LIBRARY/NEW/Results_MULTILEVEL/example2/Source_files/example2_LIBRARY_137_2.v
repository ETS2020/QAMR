...
module FAU ( 
  ...
  nand4  g021(.a(x84), .b(new_n172_), .c(x82), .d(x80), .O(new_n173_));
  ...
  nand4  g095(.a(new_n188_), .b(x84), .c(x79), .d(new_n246_), .O(new_n247_));
  ...
  nand2  g207(.a(new_n187_), .b(new_n186_), .O(new_n360_));
  nand3  g208(.a(new_n360_), .b(new_n313_), .c(new_n153_), .O(new_n361_));
  oai21  g209(.a(new_n163_), .b(new_n162_), .c(x76), .O(new_n362_));
  nand2  g210(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  nand2  g211(.a(new_n363_), .b(x79), .O(new_n364_));
  aoi21  g212(.a(new_n163_), .b(new_n162_), .c(x01), .O(new_n365_));
  nand3  g213(.a(new_n365_), .b(new_n364_), .c(x00), .O(z56));
  inv1   g214(.a(x02), .O(new_n367_));
  nand4  g215(.a(x03), .b(new_n367_), .c(new_n153_), .d(x00), .O(new_n368_));
  inv1   g216(.a(new_n368_), .O(z57));
  nand4  g217(.a(new_n174_), .b(x79), .c(x78), .d(x04), .O(new_n370_));
  nand3  g218(.a(new_n159_), .b(new_n169_), .c(x40), .O(new_n371_));
  nand2  g219(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand2  g220(.a(new_n372_), .b(x77), .O(new_n373_));
  nand2  g221(.a(new_n186_), .b(x04), .O(new_n374_));
  nand2  g222(.a(new_n374_), .b(new_n154_), .O(new_n375_));
  aoi21  g223(.a(new_n375_), .b(new_n373_), .c(x01), .O(z58));
  nor2   g224(.a(new_n163_), .b(new_n161_), .O(new_n377_));
  oai21  g225(.a(new_n377_), .b(new_n159_), .c(x40), .O(new_n378_));
  nand2  g226(.a(new_n178_), .b(x79), .O(new_n379_));
  nand3  g227(.a(new_n379_), .b(x78), .c(x04), .O(new_n380_));
  nand2  g228(.a(new_n380_), .b(new_n378_), .O(new_n381_));
  nor2   g229(.a(x79), .b(x04), .O(new_n382_));
  aoi21  g230(.a(new_n381_), .b(x77), .c(new_n382_), .O(new_n383_));
  nor2   g231(.a(new_n383_), .b(x01), .O(z59));
  nor2   g232(.a(x79), .b(new_n161_), .O(new_n385_));
  nor2   g233(.a(x84), .b(new_n154_), .O(new_n386_));
  oai21  g234(.a(new_n386_), .b(new_n385_), .c(new_n162_), .O(new_n387_));
  nand3  g235(.a(new_n379_), .b(x77), .c(x04), .O(new_n388_));
  nand2  g236(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  nand2  g237(.a(new_n389_), .b(x78), .O(new_n390_));
  inv1   g238(.a(new_n187_), .O(new_n391_));
  aoi21  g239(.a(new_n386_), .b(new_n391_), .c(new_n382_), .O(new_n392_));
  aoi21  g240(.a(new_n392_), .b(new_n390_), .c(x01), .O(z60));
  nor2   g241(.a(new_n163_), .b(x04), .O(new_n394_));
  nor2   g242(.a(new_n313_), .b(x78), .O(new_n395_));
  oai21  g243(.a(new_n395_), .b(new_n394_), .c(x77), .O(new_n396_));
  nand3  g244(.a(x84), .b(x78), .c(new_n162_), .O(new_n397_));
  nand2  g245(.a(new_n397_), .b(new_n396_), .O(new_n398_));
  nand4  g246(.a(new_n398_), .b(x80), .c(x79), .d(new_n153_), .O(new_n399_));
  inv1   g247(.a(new_n399_), .O(z61));
  nor2   g248(.a(new_n313_), .b(new_n154_), .O(new_n401_));
  oai21  g249(.a(new_n385_), .b(new_n401_), .c(new_n162_), .O(new_n402_));
  nor2   g250(.a(new_n154_), .b(x04), .O(new_n403_));
  aoi21  g251(.a(new_n379_), .b(x04), .c(new_n403_), .O(new_n404_));
  oai21  g252(.a(new_n404_), .b(new_n162_), .c(new_n402_), .O(new_n405_));
  nand2  g253(.a(new_n405_), .b(x78), .O(new_n406_));
  nand2  g254(.a(new_n401_), .b(new_n391_), .O(new_n407_));
  aoi21  g255(.a(new_n407_), .b(new_n406_), .c(x01), .O(z62));
  nand4  g256(.a(new_n398_), .b(x82), .c(x79), .d(new_n153_), .O(new_n409_));
  inv1   g257(.a(new_n409_), .O(z63));
  nand3  g258(.a(new_n398_), .b(x83), .c(x79), .O(new_n411_));
  nand4  g259(.a(new_n154_), .b(x78), .c(new_n162_), .d(x04), .O(new_n412_));
  aoi21  g260(.a(new_n412_), .b(new_n411_), .c(x01), .O(z64));
  oai21  g261(.a(new_n162_), .b(new_n161_), .c(x78), .O(new_n414_));
  nand2  g262(.a(new_n414_), .b(new_n187_), .O(new_n415_));
  nand4  g263(.a(new_n415_), .b(x84), .c(x79), .d(new_n153_), .O(new_n416_));
