...
module FAU ( 
  ...
  nand2  g156(.a(new_n294_), .b(new_n292_), .O(new_n308_));
  nand4  g157(.a(new_n308_), .b(x78), .c(x77), .d(x58), .O(new_n309_));
  ...
  nand4  g165(.a(new_n295_), .b(x78), .c(x77), .d(x62), .O(new_n317_));
  nor3   g166(.a(new_n317_), .b(x04), .c(x01), .O(z44));
  nand4  g167(.a(new_n295_), .b(x78), .c(x77), .d(x63), .O(new_n319_));
