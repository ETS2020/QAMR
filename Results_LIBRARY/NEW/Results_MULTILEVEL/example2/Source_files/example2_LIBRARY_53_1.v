...
module FAU ( 
  ...
  nor2   g183(.a(new_n232_), .b(new_n154_), .O(new_n335_));
  nand3  g184(.a(new_n335_), .b(new_n163_), .c(x77), .O(new_n336_));
  ...
  nand2  g189(.a(new_n323_), .b(x09), .O(new_n341_));
  ...
  nand2  g195(.a(new_n323_), .b(x10), .O(new_n347_));
  ...
  nand2  g201(.a(new_n323_), .b(x11), .O(new_n353_));
  ...
  nand2  g207(.a(new_n323_), .b(x12), .O(new_n359_));
