// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:39 2020
...
module FAU ( 
  ...
  aoi21  g112(.a(new_n254_), .b(new_n251_), .c(new_n163_), .O(new_n264_));
  nand4  g113(.a(new_n264_), .b(x77), .c(x46), .d(new_n249_), .O(new_n265_));
