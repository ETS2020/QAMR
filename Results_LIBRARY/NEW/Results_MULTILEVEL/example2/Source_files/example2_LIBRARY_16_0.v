// Benchmark "FAU" written by ABC on Mon Jul 27 21:28:51 2020
...
module FAU ( 
  ...
  oai21  g058(.a(x40), .b(new_n208_), .c(new_n209_), .O(z14));
  ...
  nand3  g081(.a(x84), .b(x81), .c(x79), .O(new_n233_));
  oai21  g082(.a(x84), .b(x81), .c(new_n233_), .O(new_n234_));
  nand3  g083(.a(new_n234_), .b(new_n174_), .c(new_n232_), .O(new_n235_));
  ...
  nand3  g093(.a(new_n244_), .b(new_n153_), .c(x00), .O(z23));
  inv1   g094(.a(x43), .O(new_n246_));
  oai21  g095(.a(new_n163_), .b(new_n159_), .c(x79), .O(new_n247_));
  nand4  g096(.a(new_n247_), .b(new_n246_), .c(x05), .d(new_n160_), .O(new_n248_));
  nor2   g097(.a(new_n248_), .b(x01), .O(z24));
  inv1   g098(.a(x42), .O(new_n250_));
  xnor2a g099(.a(x82), .b(x81), .O(new_n251_));
  nand3  g100(.a(new_n251_), .b(x84), .c(x79), .O(new_n252_));
  inv1   g101(.a(x84), .O(new_n253_));
  xor2a  g102(.a(x82), .b(x81), .O(new_n254_));
  ...
  nand3  g107(.a(new_n258_), .b(new_n250_), .c(x05), .O(new_n259_));
  nor3   g108(.a(new_n259_), .b(x04), .c(x01), .O(z25));
  nand3  g109(.a(new_n258_), .b(x44), .c(new_n250_), .O(new_n261_));
  nor3   g110(.a(new_n261_), .b(x04), .c(x01), .O(z26));
  nand3  g111(.a(new_n258_), .b(x45), .c(new_n250_), .O(new_n263_));
  nor3   g112(.a(new_n263_), .b(x04), .c(x01), .O(z27));
  nand3  g113(.a(new_n258_), .b(x46), .c(new_n250_), .O(new_n265_));
  nor3   g114(.a(new_n265_), .b(x04), .c(x01), .O(z28));
  nand3  g115(.a(new_n258_), .b(x47), .c(new_n250_), .O(new_n267_));
  nor3   g116(.a(new_n267_), .b(x04), .c(x01), .O(z29));
  nand3  g117(.a(new_n258_), .b(x48), .c(new_n250_), .O(new_n269_));
  nor3   g118(.a(new_n269_), .b(x04), .c(x01), .O(z30));
  nand3  g119(.a(new_n258_), .b(x49), .c(new_n250_), .O(new_n271_));
  nor3   g120(.a(new_n271_), .b(x04), .c(x01), .O(z31));
  nand3  g121(.a(new_n258_), .b(x50), .c(new_n250_), .O(new_n273_));
  nor3   g122(.a(new_n273_), .b(x04), .c(x01), .O(z32));
  nand3  g123(.a(x84), .b(new_n238_), .c(x79), .O(new_n275_));
  oai21  g124(.a(x84), .b(new_n238_), .c(new_n275_), .O(new_n276_));
  nand3  g125(.a(new_n276_), .b(x42), .c(x05), .O(new_n277_));
  nand4  g126(.a(x84), .b(x79), .c(x51), .d(new_n250_), .O(new_n278_));
  nand2  g127(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  nand2  g128(.a(new_n279_), .b(new_n251_), .O(new_n280_));
  nand3  g129(.a(x84), .b(x83), .c(x79), .O(new_n281_));
  oai21  g130(.a(x84), .b(x83), .c(new_n281_), .O(new_n282_));
  ...
  nand4  g136(.a(new_n287_), .b(x78), .c(x77), .d(new_n160_), .O(new_n288_));
  nor2   g137(.a(new_n288_), .b(x01), .O(z33));
  aoi21  g138(.a(x83), .b(x42), .c(x84), .O(new_n290_));
  nand4  g139(.a(x84), .b(x83), .c(x79), .d(x42), .O(new_n291_));
  ...
  nand3  g143(.a(new_n294_), .b(x84), .c(x79), .O(new_n295_));
  nand3  g144(.a(new_n253_), .b(x83), .c(x42), .O(new_n296_));
  nand2  g145(.a(new_n296_), .b(new_n295_), .O(new_n297_));
  nand2  g146(.a(new_n297_), .b(new_n251_), .O(new_n298_));
  nand2  g147(.a(new_n298_), .b(new_n293_), .O(new_n299_));
  nand2  g148(.a(new_n299_), .b(x78), .O(new_n300_));
  nor2   g149(.a(new_n300_), .b(new_n159_), .O(new_n301_));
  nand3  g150(.a(new_n301_), .b(x52), .c(new_n160_), .O(new_n302_));
  nor2   g151(.a(new_n302_), .b(x01), .O(z34));
  nand3  g152(.a(new_n301_), .b(x53), .c(new_n160_), .O(new_n304_));
  nor2   g153(.a(new_n304_), .b(x01), .O(z35));
  nand3  g154(.a(new_n301_), .b(x54), .c(new_n160_), .O(new_n306_));
  nor2   g155(.a(new_n306_), .b(x01), .O(z36));
  nand3  g156(.a(new_n301_), .b(x55), .c(new_n160_), .O(new_n308_));
  nor2   g157(.a(new_n308_), .b(x01), .O(z37));
  nand3  g158(.a(new_n301_), .b(x56), .c(new_n160_), .O(new_n310_));
  nor2   g159(.a(new_n310_), .b(x01), .O(z38));
  nand3  g160(.a(new_n301_), .b(x57), .c(new_n160_), .O(new_n312_));
  nor2   g161(.a(new_n312_), .b(x01), .O(z39));
  nand3  g162(.a(new_n301_), .b(x58), .c(new_n160_), .O(new_n314_));
  nor2   g163(.a(new_n314_), .b(x01), .O(z40));
  nand3  g164(.a(new_n301_), .b(x59), .c(new_n160_), .O(new_n316_));
  nor2   g165(.a(new_n316_), .b(x01), .O(z41));
  nand3  g166(.a(new_n301_), .b(x60), .c(new_n160_), .O(new_n318_));
  nor2   g167(.a(new_n318_), .b(x01), .O(z42));
  nand3  g168(.a(new_n301_), .b(x61), .c(new_n160_), .O(new_n320_));
  nor2   g169(.a(new_n320_), .b(x01), .O(z43));
  nand3  g170(.a(new_n301_), .b(x62), .c(new_n160_), .O(new_n322_));
  nor2   g171(.a(new_n322_), .b(x01), .O(z44));
  nand3  g172(.a(new_n301_), .b(x63), .c(new_n160_), .O(new_n324_));
  nor2   g173(.a(new_n324_), .b(x01), .O(z45));
  nand3  g174(.a(new_n301_), .b(x64), .c(new_n160_), .O(new_n326_));
  nor2   g175(.a(new_n326_), .b(x01), .O(z46));
  nand2  g176(.a(x52), .b(x15), .O(new_n328_));
  inv1   g177(.a(x52), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x07), .O(new_n330_));
  aoi21  g179(.a(new_n330_), .b(new_n328_), .c(x79), .O(new_n331_));
  ...
  nand2  g194(.a(new_n329_), .b(x09), .O(new_n346_));
  ...
  nor4   g233(.a(new_n384_), .b(new_n253_), .c(new_n238_), .d(x82), .O(z55));
  inv1   g234(.a(x76), .O(new_n386_));
  inv1   g235(.a(new_n172_), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n171_), .O(new_n388_));
  nand4  g237(.a(new_n388_), .b(x84), .c(new_n380_), .d(new_n153_), .O(new_n389_));
  oai21  g238(.a(new_n166_), .b(new_n386_), .c(new_n389_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x79), .O(new_n391_));
  nor2   g240(.a(x84), .b(new_n380_), .O(new_n392_));
  inv1   g241(.a(new_n392_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(x78), .O(new_n394_));
  aoi22  g243(.a(new_n394_), .b(new_n159_), .c(new_n392_), .d(new_n172_), .O(new_n395_));
  nand4  g244(.a(new_n395_), .b(new_n391_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g245(.a(x02), .O(new_n397_));
  nand4  g246(.a(x03), .b(new_n397_), .c(new_n153_), .d(x00), .O(new_n398_));
  inv1   g247(.a(new_n398_), .O(z57));
  nand4  g248(.a(x80), .b(new_n236_), .c(x43), .d(new_n250_), .O(new_n400_));
  oai22  g249(.a(new_n400_), .b(new_n239_), .c(new_n250_), .d(x40), .O(new_n401_));
  nand4  g250(.a(new_n401_), .b(x79), .c(x78), .d(x04), .O(new_n402_));
  nor2   g251(.a(x79), .b(x78), .O(new_n403_));
  nand3  g252(.a(new_n403_), .b(new_n250_), .c(x40), .O(new_n404_));
  nand2  g253(.a(new_n404_), .b(new_n402_), .O(new_n405_));
  nand2  g254(.a(new_n405_), .b(x77), .O(new_n406_));
  oai21  g255(.a(new_n170_), .b(new_n160_), .c(new_n154_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n406_), .c(x01), .O(z58));
  oai21  g257(.a(new_n164_), .b(new_n403_), .c(x40), .O(new_n409_));
  oai21  g258(.a(new_n239_), .b(new_n237_), .c(new_n250_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(x79), .O(new_n411_));
  nand3  g260(.a(new_n411_), .b(x78), .c(x04), .O(new_n412_));
  nand2  g261(.a(new_n412_), .b(new_n409_), .O(new_n413_));
  nand2  g262(.a(new_n413_), .b(x77), .O(new_n414_));
  nand2  g263(.a(new_n154_), .b(new_n160_), .O(new_n415_));
  aoi21  g264(.a(new_n415_), .b(new_n414_), .c(x01), .O(z59));
  nand3  g265(.a(x84), .b(new_n380_), .c(x79), .O(new_n417_));
  nand2  g266(.a(new_n417_), .b(new_n393_), .O(new_n418_));
  nand2  g267(.a(new_n418_), .b(new_n388_), .O(new_n419_));
  nand3  g268(.a(new_n419_), .b(new_n415_), .c(new_n242_), .O(new_n420_));
  and2   g269(.a(new_n420_), .b(new_n153_), .O(z60));
  nand2  g270(.a(new_n388_), .b(new_n234_), .O(new_n422_));
  nand4  g271(.a(x79), .b(x78), .c(x77), .d(new_n160_), .O(new_n423_));
  nand2  g272(.a(new_n423_), .b(new_n422_), .O(new_n424_));
  nand3  g273(.a(new_n424_), .b(x80), .c(new_n153_), .O(new_n425_));
  inv1   g274(.a(new_n425_), .O(z61));
  nand2  g275(.a(new_n154_), .b(x04), .O(new_n427_));
  aoi21  g276(.a(new_n427_), .b(new_n233_), .c(x77), .O(new_n428_));
  nand2  g277(.a(new_n411_), .b(x04), .O(new_n429_));
  nand3  g278(.a(x81), .b(x79), .c(new_n160_), .O(new_n430_));
  aoi21  g279(.a(new_n430_), .b(new_n429_), .c(new_n159_), .O(new_n431_));
  oai21  g280(.a(new_n431_), .b(new_n428_), .c(x78), .O(new_n432_));
  inv1   g281(.a(new_n233_), .O(new_n433_));
  nand2  g282(.a(new_n433_), .b(new_n172_), .O(new_n434_));
  aoi21  g283(.a(new_n434_), .b(new_n432_), .c(x01), .O(z62));
  nand3  g284(.a(new_n424_), .b(x82), .c(new_n153_), .O(new_n436_));
  inv1   g285(.a(new_n436_), .O(z63));
  nand2  g286(.a(new_n424_), .b(x83), .O(new_n438_));
  nand4  g287(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n439_));
  aoi21  g288(.a(new_n439_), .b(new_n438_), .c(x01), .O(z64));
  nor2   g289(.a(new_n163_), .b(x04), .O(new_n441_));
  nor2   g290(.a(new_n380_), .b(x78), .O(new_n442_));
  oai21  g291(.a(new_n442_), .b(new_n441_), .c(x77), .O(new_n443_));
  nand3  g292(.a(x81), .b(x78), .c(new_n159_), .O(new_n444_));
