...
module FAU ( 
  ...
  nand3  g120(.a(x81), .b(x51), .c(new_n245_), .O(new_n272_));
  ...
  nand3  g125(.a(new_n248_), .b(x51), .c(new_n245_), .O(new_n277_));
  nand2  g126(.a(new_n277_), .b(new_n276_), .O(new_n278_));
  nand2  g127(.a(new_n278_), .b(new_n249_), .O(new_n279_));
  aoi21  g128(.a(new_n279_), .b(new_n274_), .c(new_n154_), .O(new_n280_));
  ...
  nand4  g220(.a(x78), .b(x77), .c(new_n238_), .d(new_n153_), .O(new_n372_));
  nor2   g221(.a(new_n372_), .b(x80), .O(new_n373_));
  nand2  g222(.a(new_n373_), .b(new_n248_), .O(new_n374_));
  nor4   g223(.a(new_n374_), .b(new_n371_), .c(new_n232_), .d(x82), .O(z55));
  ...
  nand4  g234(.a(x80), .b(new_n230_), .c(x43), .d(new_n245_), .O(new_n386_));
  oai22  g235(.a(new_n386_), .b(new_n233_), .c(new_n245_), .d(x40), .O(new_n387_));
  nand4  g236(.a(new_n387_), .b(x79), .c(x78), .d(x04), .O(new_n388_));
  nor2   g237(.a(x79), .b(x78), .O(new_n389_));
  nand3  g238(.a(new_n389_), .b(new_n245_), .c(x40), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n388_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(x77), .O(new_n392_));
  nand2  g241(.a(new_n166_), .b(x04), .O(new_n393_));
  ...
  nand2  g256(.a(new_n167_), .b(new_n166_), .O(new_n408_));
