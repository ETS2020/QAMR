// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:58 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n295_, new_n297_, new_n299_, new_n301_, new_n303_, new_n306_,
  ...
  nand4  g153(.a(new_n292_), .b(x78), .c(x77), .d(x59), .O(new_n306_));
  nor3   g154(.a(new_n306_), .b(x04), .c(x01), .O(z41));
  nand4  g155(.a(new_n292_), .b(x78), .c(x77), .d(x60), .O(new_n308_));
  nor3   g156(.a(new_n308_), .b(x04), .c(x01), .O(z42));
  nand4  g157(.a(new_n292_), .b(x78), .c(x77), .d(x61), .O(new_n310_));
  nor3   g158(.a(new_n310_), .b(x04), .c(x01), .O(z43));
  nand4  g159(.a(new_n292_), .b(x78), .c(x77), .d(x62), .O(new_n312_));
  nor3   g160(.a(new_n312_), .b(x04), .c(x01), .O(z44));
  nand4  g161(.a(new_n292_), .b(x78), .c(x77), .d(x63), .O(new_n314_));
  nor3   g162(.a(new_n314_), .b(x04), .c(x01), .O(z45));
  nand4  g163(.a(new_n292_), .b(x78), .c(x77), .d(x64), .O(new_n316_));
