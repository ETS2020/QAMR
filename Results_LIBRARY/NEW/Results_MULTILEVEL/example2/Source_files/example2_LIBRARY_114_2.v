...
module FAU ( 
  ...
  nand2  g187(.a(new_n336_), .b(x69), .O(new_n339_));
  nor2   g188(.a(x79), .b(new_n163_), .O(new_n340_));
  nand3  g189(.a(x52), .b(x17), .c(x04), .O(new_n341_));
  inv1   g190(.a(new_n341_), .O(new_n342_));
  nand3  g191(.a(new_n342_), .b(new_n340_), .c(new_n159_), .O(new_n343_));
  aoi21  g192(.a(new_n343_), .b(new_n339_), .c(x01), .O(z49));
  ...
  nand3  g277(.a(new_n340_), .b(new_n159_), .c(x04), .O(new_n429_));
