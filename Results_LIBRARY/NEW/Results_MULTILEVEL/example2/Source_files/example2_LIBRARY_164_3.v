...
module FAU ( 
  ...
  nand3  g078(.a(x81), .b(x80), .c(x43), .O(new_n230_));
  inv1   g079(.a(x83), .O(new_n231_));
  nand3  g080(.a(x84), .b(new_n231_), .c(x82), .O(new_n232_));
  oai21  g081(.a(new_n232_), .b(new_n230_), .c(x77), .O(new_n233_));
  oai21  g082(.a(new_n233_), .b(x42), .c(x79), .O(new_n234_));
  nand3  g083(.a(new_n234_), .b(x78), .c(x04), .O(new_n235_));
  aoi21  g084(.a(new_n235_), .b(new_n229_), .c(x01), .O(z22));
  ...
  nand3  g090(.a(new_n241_), .b(x05), .c(new_n237_), .O(new_n242_));
  ...
  nand4  g101(.a(new_n252_), .b(new_n244_), .c(x05), .d(new_n237_), .O(new_n253_));
  nor2   g102(.a(new_n253_), .b(x01), .O(z25));
  nand4  g103(.a(new_n252_), .b(x44), .c(new_n244_), .d(new_n237_), .O(new_n255_));
  nor2   g104(.a(new_n255_), .b(x01), .O(z26));
  nand4  g105(.a(new_n252_), .b(x45), .c(new_n244_), .d(new_n237_), .O(new_n257_));
  nor2   g106(.a(new_n257_), .b(x01), .O(z27));
  nand4  g107(.a(new_n252_), .b(x46), .c(new_n244_), .d(new_n237_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(x01), .O(z28));
  nand4  g109(.a(new_n252_), .b(x47), .c(new_n244_), .d(new_n237_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z29));
  nand4  g111(.a(new_n252_), .b(x48), .c(new_n244_), .d(new_n237_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(x01), .O(z30));
  nand4  g113(.a(new_n252_), .b(x49), .c(new_n244_), .d(new_n237_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(x01), .O(z31));
  nand4  g115(.a(new_n252_), .b(x50), .c(new_n244_), .d(new_n237_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z32));
  nand2  g117(.a(x83), .b(new_n247_), .O(new_n269_));
  nand2  g118(.a(new_n231_), .b(x81), .O(new_n270_));
  ...
  oai21  g138(.a(new_n269_), .b(new_n244_), .c(new_n289_), .O(new_n290_));
  nand2  g139(.a(new_n290_), .b(new_n245_), .O(new_n291_));
  aoi21  g140(.a(new_n291_), .b(new_n287_), .c(new_n154_), .O(new_n292_));
  ...
  nor4   g224(.a(new_n375_), .b(new_n371_), .c(new_n231_), .d(x82), .O(z55));
  nand2  g225(.a(new_n240_), .b(x76), .O(new_n377_));
  xnor2a g226(.a(x84), .b(x81), .O(new_n378_));
  aoi21  g227(.a(new_n167_), .b(new_n166_), .c(new_n378_), .O(new_n379_));
  ...
  nand3  g235(.a(x80), .b(x43), .c(new_n244_), .O(new_n387_));
  nand4  g236(.a(x84), .b(new_n231_), .c(x82), .d(x81), .O(new_n388_));
  oai22  g237(.a(new_n388_), .b(new_n387_), .c(new_n244_), .d(x40), .O(new_n389_));
  nand4  g238(.a(new_n389_), .b(x79), .c(x78), .d(x04), .O(new_n390_));
  nor2   g239(.a(x79), .b(x78), .O(new_n391_));
  nand3  g240(.a(new_n391_), .b(new_n244_), .c(x40), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(new_n390_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(x77), .O(new_n394_));
  nand2  g243(.a(new_n166_), .b(x04), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n154_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(new_n394_), .c(x01), .O(z58));
  nor2   g246(.a(new_n160_), .b(new_n237_), .O(new_n398_));
  oai21  g247(.a(new_n398_), .b(new_n391_), .c(x40), .O(new_n399_));
  oai21  g248(.a(new_n232_), .b(new_n230_), .c(new_n244_), .O(new_n400_));
  ...
  nand2  g253(.a(new_n154_), .b(new_n237_), .O(new_n405_));
  aoi21  g254(.a(new_n405_), .b(new_n404_), .c(x01), .O(z59));
  nand2  g255(.a(new_n379_), .b(x79), .O(new_n407_));
  nand3  g256(.a(new_n407_), .b(new_n405_), .c(new_n235_), .O(new_n408_));
  and2   g257(.a(new_n408_), .b(new_n153_), .O(z60));
  nand2  g258(.a(new_n167_), .b(new_n166_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(new_n228_), .O(new_n411_));
  oai21  g260(.a(new_n240_), .b(x04), .c(new_n411_), .O(new_n412_));
  ...
  oai21  g264(.a(x79), .b(new_n237_), .c(new_n415_), .O(new_n416_));
  nand2  g265(.a(new_n416_), .b(new_n159_), .O(new_n417_));
  nor3   g266(.a(new_n247_), .b(new_n154_), .c(x04), .O(new_n418_));
  aoi21  g267(.a(new_n401_), .b(x04), .c(new_n418_), .O(new_n419_));
  oai21  g268(.a(new_n419_), .b(new_n159_), .c(new_n417_), .O(new_n420_));
  nand2  g269(.a(new_n420_), .b(x78), .O(new_n421_));
  or2    g270(.a(new_n415_), .b(new_n167_), .O(new_n422_));
  ...
  nor2   g278(.a(new_n247_), .b(x78), .O(new_n430_));
