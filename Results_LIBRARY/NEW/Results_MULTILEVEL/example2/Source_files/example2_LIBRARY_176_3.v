...
module FAU ( 
  ...
  nand4  g172(.a(new_n228_), .b(x79), .c(new_n160_), .d(x77), .O(new_n324_));
  inv1   g173(.a(new_n324_), .O(new_n325_));
  nand2  g174(.a(new_n325_), .b(x75), .O(new_n326_));
  ...
  nand2  g180(.a(new_n325_), .b(x68), .O(new_n332_));
  ...
  nand2  g186(.a(new_n325_), .b(x69), .O(new_n338_));
  aoi21  g187(.a(new_n338_), .b(new_n337_), .c(x01), .O(z49));
  nand2  g188(.a(x52), .b(x18), .O(new_n340_));
  nand2  g189(.a(new_n320_), .b(x10), .O(new_n341_));
  ...
  nand2  g207(.a(new_n320_), .b(x13), .O(new_n359_));
  ...
  nand2  g213(.a(new_n320_), .b(x14), .O(new_n365_));
