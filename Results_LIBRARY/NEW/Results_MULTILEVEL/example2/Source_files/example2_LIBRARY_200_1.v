// Benchmark "FAU" written by ABC on Mon Jul 27 21:30:04 2020
...
module FAU ( 
  ...
  nor4   g107(.a(new_n253_), .b(x42), .c(x04), .d(x01), .O(z27));
  nand4  g108(.a(new_n254_), .b(x46), .c(new_n246_), .d(new_n238_), .O(new_n260_));
  nor2   g109(.a(new_n260_), .b(x01), .O(z28));
  nand4  g110(.a(new_n254_), .b(x47), .c(new_n246_), .d(new_n238_), .O(new_n262_));
  nor2   g111(.a(new_n262_), .b(x01), .O(z29));
  nand4  g112(.a(new_n254_), .b(x48), .c(new_n246_), .d(new_n238_), .O(new_n264_));
  nor2   g113(.a(new_n264_), .b(x01), .O(z30));
  nand4  g114(.a(new_n254_), .b(x49), .c(new_n246_), .d(new_n238_), .O(new_n266_));
  nor2   g115(.a(new_n266_), .b(x01), .O(z31));
  nand4  g116(.a(new_n254_), .b(x50), .c(new_n246_), .d(new_n238_), .O(new_n268_));
  nor2   g117(.a(new_n268_), .b(x01), .O(z32));
  nand2  g118(.a(x83), .b(new_n249_), .O(new_n270_));
  ...
  nand3  g122(.a(x81), .b(x51), .c(new_n246_), .O(new_n274_));
  ...
  nand3  g127(.a(new_n249_), .b(x51), .c(new_n246_), .O(new_n279_));
  ...
  oai22  g137(.a(new_n285_), .b(new_n249_), .c(new_n270_), .d(new_n246_), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n247_), .O(new_n290_));
