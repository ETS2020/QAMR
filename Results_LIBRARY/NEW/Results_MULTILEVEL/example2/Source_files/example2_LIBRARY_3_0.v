// Benchmark "FAU" written by ABC on Mon Jul 27 21:28:46 2020
...
module FAU ( 
  ...
  nand3  g236(.a(x79), .b(x42), .c(new_n152_), .O(new_n388_));
  nand4  g237(.a(x80), .b(new_n230_), .c(x43), .d(new_n246_), .O(new_n389_));
  oai21  g238(.a(new_n389_), .b(new_n233_), .c(new_n388_), .O(new_n390_));
  nand3  g239(.a(new_n390_), .b(x78), .c(x04), .O(new_n391_));
