...
module FAU ( 
  ...
  nand2  g091(.a(new_n154_), .b(new_n160_), .O(new_n243_));
  nand3  g092(.a(new_n243_), .b(new_n153_), .c(x00), .O(z23));
  nand2  g093(.a(new_n166_), .b(x05), .O(new_n245_));
  aoi21  g094(.a(new_n245_), .b(x79), .c(x43), .O(new_n246_));
  nand3  g095(.a(new_n246_), .b(new_n160_), .c(new_n153_), .O(new_n247_));
  ...
  nand2  g229(.a(new_n380_), .b(x76), .O(new_n381_));
  ...
  aoi21  g256(.a(new_n407_), .b(new_n243_), .c(x01), .O(z59));
  nand2  g257(.a(new_n384_), .b(x79), .O(new_n409_));
  nand3  g258(.a(new_n409_), .b(new_n243_), .c(new_n241_), .O(new_n410_));
  and2   g259(.a(new_n410_), .b(new_n153_), .O(z60));
  nand2  g260(.a(new_n172_), .b(new_n382_), .O(new_n412_));
  nand2  g261(.a(new_n412_), .b(new_n233_), .O(new_n413_));
  oai21  g262(.a(new_n380_), .b(x04), .c(new_n413_), .O(new_n414_));
  ...
  nand2  g268(.a(new_n404_), .b(x04), .O(new_n420_));
