...
module FAU ( 
  ...
  nand2  g222(.a(new_n373_), .b(new_n249_), .O(new_n374_));
  nor4   g223(.a(new_n374_), .b(new_n370_), .c(new_n232_), .d(x82), .O(z55));
  nand2  g224(.a(new_n242_), .b(x76), .O(new_n376_));
  inv1   g225(.a(new_n165_), .O(new_n377_));
  xnor2a g226(.a(x84), .b(x81), .O(new_n378_));
  aoi21  g227(.a(new_n167_), .b(new_n377_), .c(new_n378_), .O(new_n379_));
  nand2  g228(.a(new_n379_), .b(new_n153_), .O(new_n380_));
  nand2  g229(.a(new_n380_), .b(new_n376_), .O(new_n381_));
  ...
  nand4  g235(.a(x80), .b(new_n230_), .c(x43), .d(new_n246_), .O(new_n387_));
  oai22  g236(.a(new_n387_), .b(new_n233_), .c(new_n246_), .d(x40), .O(new_n388_));
  nand4  g237(.a(new_n388_), .b(x79), .c(x78), .d(x04), .O(new_n389_));
  nor2   g238(.a(x79), .b(x78), .O(new_n390_));
  nand3  g239(.a(new_n390_), .b(new_n246_), .c(x40), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(new_n389_), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(x77), .O(new_n393_));
  oai21  g242(.a(new_n165_), .b(new_n238_), .c(new_n154_), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n393_), .c(x01), .O(z58));
  nor2   g244(.a(new_n160_), .b(new_n238_), .O(new_n396_));
  oai21  g245(.a(new_n396_), .b(new_n390_), .c(x40), .O(new_n397_));
  oai21  g246(.a(new_n233_), .b(new_n231_), .c(new_n246_), .O(new_n398_));
  ...
  nand2  g251(.a(new_n154_), .b(new_n238_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n402_), .c(x01), .O(z59));
  nand2  g253(.a(new_n379_), .b(x79), .O(new_n405_));
  nand3  g254(.a(new_n405_), .b(new_n403_), .c(new_n236_), .O(new_n406_));
  and2   g255(.a(new_n406_), .b(new_n153_), .O(z60));
  nand2  g256(.a(new_n167_), .b(new_n377_), .O(new_n408_));
  nand2  g257(.a(new_n408_), .b(new_n228_), .O(new_n409_));
  oai21  g258(.a(new_n242_), .b(x04), .c(new_n409_), .O(new_n410_));
  ...
  nor2   g276(.a(new_n249_), .b(x78), .O(new_n428_));
