// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:09 2020
...
module FAU ( 
  ...
  nand3  g123(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  nand2  g124(.a(new_n237_), .b(new_n252_), .O(new_n276_));
  aoi21  g125(.a(new_n276_), .b(new_n275_), .c(new_n274_), .O(new_n277_));
  nor2   g126(.a(x81), .b(x42), .O(new_n278_));
  oai21  g127(.a(new_n278_), .b(new_n277_), .c(new_n253_), .O(new_n279_));
  nand3  g128(.a(x83), .b(new_n252_), .c(x42), .O(new_n280_));
  nand2  g129(.a(new_n237_), .b(x81), .O(new_n281_));
  aoi21  g130(.a(new_n281_), .b(new_n280_), .c(new_n274_), .O(new_n282_));
  nor2   g131(.a(new_n252_), .b(x42), .O(new_n283_));
  ...
  nor2   g136(.a(new_n237_), .b(new_n249_), .O(new_n288_));
  oai21  g137(.a(new_n288_), .b(x81), .c(new_n275_), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n253_), .O(new_n290_));
  oai21  g139(.a(new_n288_), .b(new_n252_), .c(new_n280_), .O(new_n291_));
  ...
  nand2  g224(.a(new_n375_), .b(new_n252_), .O(new_n376_));
  nor4   g225(.a(new_n376_), .b(new_n372_), .c(new_n237_), .d(x82), .O(z55));
  nand2  g226(.a(new_n245_), .b(x76), .O(new_n378_));
  inv1   g227(.a(new_n170_), .O(new_n379_));
  xnor2a g228(.a(x84), .b(x81), .O(new_n380_));
  aoi21  g229(.a(new_n172_), .b(new_n379_), .c(new_n380_), .O(new_n381_));
  ...
  aoi21  g233(.a(new_n163_), .b(new_n159_), .c(x01), .O(new_n385_));
  nand3  g234(.a(new_n385_), .b(new_n384_), .c(x00), .O(z56));
  inv1   g235(.a(x02), .O(new_n387_));
  nand4  g236(.a(x03), .b(new_n387_), .c(new_n153_), .d(x00), .O(new_n388_));
  inv1   g237(.a(new_n388_), .O(z57));
  nand4  g238(.a(x80), .b(new_n235_), .c(x43), .d(new_n249_), .O(new_n390_));
  oai22  g239(.a(new_n390_), .b(new_n238_), .c(new_n249_), .d(x40), .O(new_n391_));
  ...
  oai21  g245(.a(new_n170_), .b(new_n160_), .c(new_n154_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n396_), .c(x01), .O(z58));
  oai21  g247(.a(new_n164_), .b(new_n393_), .c(x40), .O(new_n399_));
  oai21  g248(.a(new_n238_), .b(new_n236_), .c(new_n249_), .O(new_n400_));
  ...
  nand2  g253(.a(new_n154_), .b(new_n160_), .O(new_n405_));
  aoi21  g254(.a(new_n405_), .b(new_n404_), .c(x01), .O(z59));
  nand2  g255(.a(new_n381_), .b(x79), .O(new_n407_));
  nand3  g256(.a(new_n407_), .b(new_n405_), .c(new_n241_), .O(new_n408_));
  and2   g257(.a(new_n408_), .b(new_n153_), .O(z60));
  nand2  g258(.a(new_n172_), .b(new_n379_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(new_n233_), .O(new_n411_));
  oai21  g260(.a(new_n245_), .b(x04), .c(new_n411_), .O(new_n412_));
  ...
  or2    g270(.a(new_n416_), .b(new_n172_), .O(new_n422_));
  ...
  nor2   g277(.a(new_n163_), .b(x04), .O(new_n429_));
  nor2   g278(.a(new_n252_), .b(x78), .O(new_n430_));
