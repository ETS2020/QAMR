// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:21 2020
...
module FAU ( 
  ...
  nand3  g120(.a(x83), .b(x81), .c(x42), .O(new_n272_));
  nand2  g121(.a(new_n232_), .b(new_n249_), .O(new_n273_));
  aoi21  g122(.a(new_n273_), .b(new_n272_), .c(new_n271_), .O(new_n274_));
  nor2   g123(.a(x81), .b(x42), .O(new_n275_));
  oai21  g124(.a(new_n275_), .b(new_n274_), .c(new_n250_), .O(new_n276_));
  nand3  g125(.a(x83), .b(new_n249_), .c(x42), .O(new_n277_));
  nand2  g126(.a(new_n232_), .b(x81), .O(new_n278_));
  aoi21  g127(.a(new_n278_), .b(new_n277_), .c(new_n271_), .O(new_n279_));
  nor2   g128(.a(new_n249_), .b(x42), .O(new_n280_));
  oai21  g129(.a(new_n280_), .b(new_n279_), .c(new_n247_), .O(new_n281_));
  aoi21  g130(.a(new_n281_), .b(new_n276_), .c(new_n154_), .O(new_n282_));
  nand4  g131(.a(new_n282_), .b(x78), .c(x77), .d(new_n238_), .O(new_n283_));
  nor2   g132(.a(new_n283_), .b(x01), .O(z33));
  nor2   g133(.a(new_n232_), .b(new_n246_), .O(new_n285_));
  oai21  g134(.a(new_n285_), .b(x81), .c(new_n272_), .O(new_n286_));
  nand2  g135(.a(new_n286_), .b(new_n250_), .O(new_n287_));
  oai21  g136(.a(new_n285_), .b(new_n249_), .c(new_n277_), .O(new_n288_));
  ...
  nor2   g171(.a(new_n322_), .b(new_n227_), .O(new_n323_));
  ...
  nand4  g178(.a(new_n228_), .b(x79), .c(new_n160_), .d(x77), .O(new_n330_));
  ...
  nand2  g221(.a(new_n372_), .b(new_n249_), .O(new_n373_));
  nor4   g222(.a(new_n373_), .b(new_n369_), .c(new_n232_), .d(x82), .O(z55));
  nand2  g223(.a(new_n242_), .b(x76), .O(new_n375_));
  inv1   g224(.a(new_n165_), .O(new_n376_));
  xnor2a g225(.a(x84), .b(x81), .O(new_n377_));
  aoi21  g226(.a(new_n167_), .b(new_n376_), .c(new_n377_), .O(new_n378_));
  ...
  nand4  g234(.a(x80), .b(new_n230_), .c(x43), .d(new_n246_), .O(new_n386_));
  oai22  g235(.a(new_n386_), .b(new_n233_), .c(new_n246_), .d(x40), .O(new_n387_));
  nand4  g236(.a(new_n387_), .b(x79), .c(x78), .d(x04), .O(new_n388_));
  nor2   g237(.a(x79), .b(x78), .O(new_n389_));
  nand3  g238(.a(new_n389_), .b(new_n246_), .c(x40), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n388_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(x77), .O(new_n392_));
  oai21  g241(.a(new_n165_), .b(new_n238_), .c(new_n154_), .O(new_n393_));
  aoi21  g242(.a(new_n393_), .b(new_n392_), .c(x01), .O(z58));
  nor2   g243(.a(new_n160_), .b(new_n238_), .O(new_n395_));
  oai21  g244(.a(new_n395_), .b(new_n389_), .c(x40), .O(new_n396_));
  oai21  g245(.a(new_n233_), .b(new_n231_), .c(new_n246_), .O(new_n397_));
  ...
  nand2  g250(.a(new_n154_), .b(new_n238_), .O(new_n402_));
  aoi21  g251(.a(new_n402_), .b(new_n401_), .c(x01), .O(z59));
  nand2  g252(.a(new_n378_), .b(x79), .O(new_n404_));
  nand3  g253(.a(new_n404_), .b(new_n402_), .c(new_n236_), .O(new_n405_));
  and2   g254(.a(new_n405_), .b(new_n153_), .O(z60));
  nand2  g255(.a(new_n167_), .b(new_n376_), .O(new_n407_));
  nand2  g256(.a(new_n407_), .b(new_n228_), .O(new_n408_));
  oai21  g257(.a(new_n242_), .b(x04), .c(new_n408_), .O(new_n409_));
  ...
  nor2   g275(.a(new_n249_), .b(x78), .O(new_n427_));
