// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:30 2020
...
module FAU ( 
  ...
  nand2  g164(.a(new_n294_), .b(new_n292_), .O(new_n316_));
  nand4  g165(.a(new_n316_), .b(x78), .c(x77), .d(x62), .O(new_n317_));
