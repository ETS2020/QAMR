...
module FAU ( 
  ...
  nor2   g174(.a(new_n325_), .b(new_n228_), .O(new_n326_));
  ...
  nor2   g181(.a(new_n228_), .b(new_n154_), .O(new_n333_));
  nand3  g182(.a(new_n333_), .b(new_n160_), .c(x77), .O(new_n334_));
  ...
  nand2  g187(.a(new_n321_), .b(x09), .O(new_n339_));
  ...
  nand2  g201(.a(new_n335_), .b(x71), .O(new_n353_));
  ...
  nand2  g224(.a(new_n375_), .b(new_n250_), .O(new_n376_));
  nor4   g225(.a(new_n376_), .b(new_n372_), .c(new_n233_), .d(x82), .O(z55));
  nand2  g226(.a(new_n243_), .b(x76), .O(new_n378_));
  inv1   g227(.a(new_n166_), .O(new_n379_));
  xnor2a g228(.a(x84), .b(x81), .O(new_n380_));
  aoi21  g229(.a(new_n168_), .b(new_n379_), .c(new_n380_), .O(new_n381_));
  ...
  nand4  g237(.a(x80), .b(new_n231_), .c(x43), .d(new_n247_), .O(new_n389_));
  oai22  g238(.a(new_n389_), .b(new_n234_), .c(new_n247_), .d(x40), .O(new_n390_));
  nand4  g239(.a(new_n390_), .b(x79), .c(x78), .d(x04), .O(new_n391_));
  nor2   g240(.a(x79), .b(x78), .O(new_n392_));
  nand3  g241(.a(new_n392_), .b(new_n247_), .c(x40), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(new_n391_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(x77), .O(new_n395_));
  oai21  g244(.a(new_n166_), .b(new_n239_), .c(new_n154_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(new_n395_), .c(x01), .O(z58));
  nor2   g246(.a(new_n160_), .b(new_n239_), .O(new_n398_));
  oai21  g247(.a(new_n398_), .b(new_n392_), .c(x40), .O(new_n399_));
  oai21  g248(.a(new_n234_), .b(new_n232_), .c(new_n247_), .O(new_n400_));
  ...
  nand2  g253(.a(new_n154_), .b(new_n239_), .O(new_n405_));
  ...
  nand2  g258(.a(new_n168_), .b(new_n379_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(new_n229_), .O(new_n411_));
  oai21  g260(.a(new_n243_), .b(x04), .c(new_n411_), .O(new_n412_));
  ...
  nor2   g278(.a(new_n250_), .b(x78), .O(new_n430_));
