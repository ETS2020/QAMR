...
module FAU ( 
  ...
  nand3  g076(.a(new_n227_), .b(new_n168_), .c(x79), .O(new_n228_));
  ...
  nor2   g088(.a(new_n160_), .b(new_n159_), .O(new_n240_));
  ...
  nand4  g179(.a(new_n227_), .b(x79), .c(new_n160_), .d(x77), .O(new_n331_));
  ...
  nand4  g235(.a(x80), .b(new_n229_), .c(x43), .d(new_n245_), .O(new_n387_));
  oai22  g236(.a(new_n387_), .b(new_n232_), .c(new_n245_), .d(x40), .O(new_n388_));
  ...
  oai21  g242(.a(new_n165_), .b(new_n237_), .c(new_n154_), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n393_), .c(x01), .O(z58));
  nor2   g244(.a(new_n160_), .b(new_n237_), .O(new_n396_));
  oai21  g245(.a(new_n396_), .b(new_n390_), .c(x40), .O(new_n397_));
  oai21  g246(.a(new_n232_), .b(new_n230_), .c(new_n245_), .O(new_n398_));
  ...
  nand2  g251(.a(new_n154_), .b(new_n237_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n402_), .c(x01), .O(z59));
  nand2  g253(.a(new_n379_), .b(x79), .O(new_n405_));
  nand3  g254(.a(new_n405_), .b(new_n403_), .c(new_n235_), .O(new_n406_));
  and2   g255(.a(new_n406_), .b(new_n153_), .O(z60));
  nand2  g256(.a(new_n167_), .b(new_n377_), .O(new_n408_));
  nand2  g257(.a(new_n408_), .b(new_n227_), .O(new_n409_));
  oai21  g258(.a(new_n241_), .b(x04), .c(new_n409_), .O(new_n410_));
  ...
  nand3  g265(.a(x81), .b(x79), .c(new_n237_), .O(new_n417_));
  ...
  nor2   g276(.a(new_n248_), .b(x78), .O(new_n428_));
