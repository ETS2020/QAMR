...
module FAU ( 
  ...
  nand2  g185(.a(new_n321_), .b(x09), .O(new_n337_));
  aoi21  g186(.a(new_n337_), .b(new_n336_), .c(x79), .O(new_n338_));
  nand4  g187(.a(new_n338_), .b(x78), .c(new_n159_), .d(x04), .O(new_n339_));
  inv1   g188(.a(new_n334_), .O(new_n340_));
  nand2  g189(.a(new_n340_), .b(x69), .O(new_n341_));
  aoi21  g190(.a(new_n341_), .b(new_n339_), .c(x01), .O(z49));
  ...
  nand2  g195(.a(new_n340_), .b(x70), .O(new_n347_));
  ...
  nand2  g201(.a(new_n340_), .b(x71), .O(new_n353_));
  ...
  nand2  g207(.a(new_n340_), .b(x72), .O(new_n359_));
  ...
  nand2  g213(.a(new_n340_), .b(x73), .O(new_n365_));
