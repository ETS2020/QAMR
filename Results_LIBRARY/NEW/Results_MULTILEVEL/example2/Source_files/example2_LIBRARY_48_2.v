...
module FAU ( 
  ...
  nand4  g176(.a(new_n228_), .b(x79), .c(new_n160_), .d(x77), .O(new_n328_));
  inv1   g177(.a(new_n328_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x68), .O(new_n330_));
  inv1   g179(.a(x08), .O(new_n331_));
  nor2   g180(.a(x52), .b(new_n331_), .O(new_n332_));
  nor2   g181(.a(x79), .b(new_n160_), .O(new_n333_));
  nand4  g182(.a(new_n333_), .b(new_n332_), .c(new_n159_), .d(x04), .O(new_n334_));
  ...
  nand2  g188(.a(new_n329_), .b(x69), .O(new_n340_));
  ...
  nand2  g194(.a(new_n329_), .b(x70), .O(new_n346_));
  ...
  nand2  g200(.a(new_n329_), .b(x71), .O(new_n352_));
  ...
  nand3  g274(.a(new_n333_), .b(new_n159_), .c(x04), .O(new_n426_));
