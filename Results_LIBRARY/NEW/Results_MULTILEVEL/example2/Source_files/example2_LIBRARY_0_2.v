// Benchmark "FAU" written by ABC on Mon Jul 27 21:28:45 2020
...
module FAU ( 
  ...
  nand4  g014(.a(x79), .b(new_n160_), .c(x77), .d(x66), .O(new_n166_));
  ...
  nand2  g170(.a(x79), .b(x67), .O(new_n322_));
  nand2  g171(.a(new_n322_), .b(new_n164_), .O(new_n323_));
  nand4  g172(.a(new_n323_), .b(new_n226_), .c(new_n160_), .d(x77), .O(new_n324_));
  ...
  nand2  g225(.a(new_n160_), .b(x77), .O(new_n377_));
  aoi21  g226(.a(new_n377_), .b(new_n165_), .c(new_n376_), .O(new_n378_));
  ...
  nand4  g234(.a(x80), .b(new_n228_), .c(x43), .d(new_n244_), .O(new_n386_));
  oai22  g235(.a(new_n386_), .b(new_n231_), .c(new_n244_), .d(x40), .O(new_n387_));
  nand4  g236(.a(new_n387_), .b(x79), .c(x78), .d(x04), .O(new_n388_));
  nor2   g237(.a(x79), .b(x78), .O(new_n389_));
  nand3  g238(.a(new_n389_), .b(new_n244_), .c(x40), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n388_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(x77), .O(new_n392_));
  nand2  g241(.a(new_n165_), .b(x04), .O(new_n393_));
  ...
  oai21  g245(.a(new_n396_), .b(new_n389_), .c(x40), .O(new_n397_));
  ...
  or2    g268(.a(new_n414_), .b(new_n377_), .O(new_n420_));
