...
module FAU ( 
  ...
  nand2  g146(.a(new_n294_), .b(new_n292_), .O(new_n298_));
  ...
  nand4  g151(.a(new_n295_), .b(x78), .c(x77), .d(x55), .O(new_n303_));
  ...
  nand4  g155(.a(new_n295_), .b(x78), .c(x77), .d(x57), .O(new_n307_));
