...
module FAU ( 
  ...
  nand2  g196(.a(new_n341_), .b(x70), .O(new_n348_));
  ...
  nand2  g202(.a(new_n341_), .b(x71), .O(new_n354_));
  ...
  nand2  g208(.a(new_n341_), .b(x72), .O(new_n360_));
  ...
  nand2  g214(.a(new_n341_), .b(x73), .O(new_n366_));
