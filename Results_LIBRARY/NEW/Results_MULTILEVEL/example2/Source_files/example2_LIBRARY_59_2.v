...
module FAU ( 
  ...
  nand2  g193(.a(new_n336_), .b(x70), .O(new_n345_));
  nor2   g194(.a(x79), .b(new_n163_), .O(new_n346_));
  nand3  g195(.a(x52), .b(x18), .c(x04), .O(new_n347_));
  inv1   g196(.a(new_n347_), .O(new_n348_));
  nand3  g197(.a(new_n348_), .b(new_n346_), .c(new_n159_), .O(new_n349_));
  ...
  nand3  g277(.a(new_n346_), .b(new_n159_), .c(x04), .O(new_n429_));
