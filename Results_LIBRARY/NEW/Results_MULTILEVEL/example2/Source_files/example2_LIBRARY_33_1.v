// Benchmark "FAU" written by ABC on Mon Jul 27 21:28:57 2020
...
module FAU ( 
  ...
  nand2  g090(.a(x78), .b(x77), .O(new_n242_));
  aoi21  g091(.a(new_n242_), .b(x79), .c(x43), .O(new_n243_));
  nand3  g092(.a(new_n243_), .b(x05), .c(new_n239_), .O(new_n244_));
  ...
  nand4  g103(.a(new_n254_), .b(new_n246_), .c(x05), .d(new_n239_), .O(new_n255_));
  nor2   g104(.a(new_n255_), .b(x01), .O(z25));
  nand4  g105(.a(new_n254_), .b(x44), .c(new_n246_), .d(new_n239_), .O(new_n257_));
  nor2   g106(.a(new_n257_), .b(x01), .O(z26));
  nand4  g107(.a(new_n254_), .b(x45), .c(new_n246_), .d(new_n239_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(x01), .O(z27));
  nand4  g109(.a(new_n254_), .b(x46), .c(new_n246_), .d(new_n239_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z28));
  nand4  g111(.a(new_n254_), .b(x47), .c(new_n246_), .d(new_n239_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(x01), .O(z29));
  nand4  g113(.a(new_n254_), .b(x48), .c(new_n246_), .d(new_n239_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(x01), .O(z30));
  nand4  g115(.a(new_n254_), .b(x49), .c(new_n246_), .d(new_n239_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z31));
  nand4  g117(.a(new_n254_), .b(x50), .c(new_n246_), .d(new_n239_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(x01), .O(z32));
  nand2  g119(.a(x83), .b(new_n249_), .O(new_n271_));
  nand2  g120(.a(new_n233_), .b(x81), .O(new_n272_));
  ...
  nand4  g132(.a(new_n283_), .b(x78), .c(x77), .d(new_n239_), .O(new_n284_));
  nor2   g133(.a(new_n284_), .b(x01), .O(z33));
  nor2   g134(.a(new_n233_), .b(new_n246_), .O(new_n286_));
  ...
  nor2   g173(.a(new_n324_), .b(new_n228_), .O(new_n325_));
  ...
  nand4  g180(.a(new_n229_), .b(x79), .c(new_n160_), .d(x77), .O(new_n332_));
  ...
  nor4   g224(.a(new_n375_), .b(new_n371_), .c(new_n233_), .d(x82), .O(z55));
  oai21  g225(.a(x79), .b(new_n159_), .c(new_n160_), .O(new_n377_));
  nand2  g226(.a(x79), .b(new_n159_), .O(new_n378_));
  nand4  g227(.a(new_n378_), .b(new_n377_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g228(.a(x02), .O(new_n380_));
  nand4  g229(.a(x03), .b(new_n380_), .c(new_n153_), .d(x00), .O(new_n381_));
  inv1   g230(.a(new_n381_), .O(z57));
  nand4  g231(.a(x80), .b(new_n231_), .c(x43), .d(new_n246_), .O(new_n383_));
  oai22  g232(.a(new_n383_), .b(new_n234_), .c(new_n246_), .d(x40), .O(new_n384_));
  nand4  g233(.a(new_n384_), .b(x79), .c(x78), .d(x04), .O(new_n385_));
  nor2   g234(.a(x79), .b(x78), .O(new_n386_));
  nand3  g235(.a(new_n386_), .b(new_n246_), .c(x40), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n385_), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(x77), .O(new_n389_));
  oai21  g238(.a(new_n165_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  aoi21  g239(.a(new_n390_), .b(new_n389_), .c(x01), .O(z58));
  nor2   g240(.a(new_n160_), .b(new_n239_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n386_), .c(x40), .O(new_n393_));
  oai21  g242(.a(new_n234_), .b(new_n232_), .c(new_n246_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(x79), .O(new_n395_));
  nand3  g244(.a(new_n395_), .b(x78), .c(x04), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(new_n393_), .O(new_n397_));
  nand2  g246(.a(new_n397_), .b(x77), .O(new_n398_));
  nand2  g247(.a(new_n154_), .b(new_n239_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n398_), .c(x01), .O(z59));
  xor2a  g249(.a(x84), .b(x81), .O(new_n401_));
  nand3  g250(.a(x79), .b(new_n160_), .c(x77), .O(new_n402_));
  inv1   g251(.a(new_n402_), .O(new_n403_));
  oai21  g252(.a(new_n403_), .b(new_n165_), .c(new_n401_), .O(new_n404_));
  nand3  g253(.a(new_n404_), .b(new_n399_), .c(new_n237_), .O(new_n405_));
  and2   g254(.a(new_n405_), .b(new_n153_), .O(z60));
  nor2   g255(.a(new_n167_), .b(new_n165_), .O(new_n407_));
  oai22  g256(.a(new_n407_), .b(new_n228_), .c(new_n242_), .d(x04), .O(new_n408_));
  nand4  g257(.a(new_n408_), .b(x80), .c(x79), .d(new_n153_), .O(new_n409_));
  inv1   g258(.a(new_n409_), .O(z61));
  nand2  g259(.a(new_n154_), .b(x04), .O(new_n411_));
  nand3  g260(.a(x84), .b(x81), .c(x79), .O(new_n412_));
  aoi21  g261(.a(new_n412_), .b(new_n411_), .c(x77), .O(new_n413_));
  nand2  g262(.a(new_n395_), .b(x04), .O(new_n414_));
  nand3  g263(.a(x81), .b(x79), .c(new_n239_), .O(new_n415_));
  aoi21  g264(.a(new_n415_), .b(new_n414_), .c(new_n159_), .O(new_n416_));
  oai21  g265(.a(new_n416_), .b(new_n413_), .c(x78), .O(new_n417_));
  ...
  nand4  g269(.a(new_n408_), .b(x82), .c(x79), .d(new_n153_), .O(new_n421_));
  inv1   g270(.a(new_n421_), .O(z63));
  nand3  g271(.a(new_n408_), .b(x83), .c(x79), .O(new_n423_));
