...
module FAU ( 
  ...
  nand2  g211(.a(new_n336_), .b(x73), .O(new_n363_));
  nor2   g212(.a(x79), .b(new_n163_), .O(new_n364_));
  inv1   g213(.a(x13), .O(new_n365_));
  nor2   g214(.a(x52), .b(new_n365_), .O(new_n366_));
  nand4  g215(.a(new_n366_), .b(new_n364_), .c(new_n159_), .d(x04), .O(new_n367_));
  ...
  nand3  g277(.a(new_n364_), .b(new_n159_), .c(x04), .O(new_n429_));
