...
module FAU ( 
  ...
  nor2   g077(.a(new_n228_), .b(new_n154_), .O(new_n229_));
  nand3  g078(.a(new_n229_), .b(new_n165_), .c(x75), .O(new_n230_));
  oai21  g079(.a(new_n230_), .b(x41), .c(new_n227_), .O(new_n231_));
  nand2  g080(.a(new_n231_), .b(x78), .O(new_n232_));
  inv1   g081(.a(x41), .O(new_n233_));
  nand3  g082(.a(new_n229_), .b(new_n167_), .c(x77), .O(new_n234_));
  inv1   g083(.a(new_n234_), .O(new_n235_));
  nand3  g084(.a(new_n235_), .b(x66), .c(new_n233_), .O(new_n236_));
  aoi21  g085(.a(new_n236_), .b(new_n232_), .c(x01), .O(z22));
  nand3  g086(.a(new_n154_), .b(x05), .c(new_n227_), .O(new_n238_));
  nand3  g087(.a(new_n238_), .b(new_n153_), .c(x00), .O(z23));
  nand3  g088(.a(x79), .b(x78), .c(x77), .O(new_n240_));
  nor2   g089(.a(x79), .b(x04), .O(new_n241_));
  inv1   g090(.a(new_n241_), .O(new_n242_));
  aoi21  g091(.a(new_n242_), .b(new_n240_), .c(x43), .O(new_n243_));
  nand3  g092(.a(new_n243_), .b(x05), .c(new_n153_), .O(new_n244_));
  ...
  aoi21  g101(.a(new_n252_), .b(new_n249_), .c(new_n154_), .O(new_n253_));
  nand4  g102(.a(new_n253_), .b(x78), .c(x77), .d(new_n247_), .O(new_n254_));
  nor3   g103(.a(new_n254_), .b(new_n246_), .c(x01), .O(z25));
  nand4  g104(.a(new_n253_), .b(x78), .c(x77), .d(x44), .O(new_n256_));
  nor3   g105(.a(new_n256_), .b(x42), .c(x01), .O(z26));
  nand4  g106(.a(new_n253_), .b(x78), .c(x77), .d(x45), .O(new_n258_));
  nor3   g107(.a(new_n258_), .b(x42), .c(x01), .O(z27));
  nand4  g108(.a(new_n253_), .b(x78), .c(x77), .d(x46), .O(new_n260_));
  nor3   g109(.a(new_n260_), .b(x42), .c(x01), .O(z28));
  nand4  g110(.a(new_n253_), .b(x78), .c(x77), .d(x47), .O(new_n262_));
  nor3   g111(.a(new_n262_), .b(x42), .c(x01), .O(z29));
  nand4  g112(.a(new_n253_), .b(x78), .c(x77), .d(x48), .O(new_n264_));
  nor3   g113(.a(new_n264_), .b(x42), .c(x01), .O(z30));
  nand4  g114(.a(new_n253_), .b(x78), .c(x77), .d(x49), .O(new_n266_));
  nor3   g115(.a(new_n266_), .b(x42), .c(x01), .O(z31));
  nand4  g116(.a(new_n253_), .b(x78), .c(x77), .d(x50), .O(new_n268_));
  nor3   g117(.a(new_n268_), .b(x42), .c(x01), .O(z32));
  xor2a  g118(.a(x83), .b(x81), .O(new_n270_));
  nand3  g119(.a(new_n270_), .b(x42), .c(x05), .O(new_n271_));
  nand3  g120(.a(x81), .b(x51), .c(new_n247_), .O(new_n272_));
  nand2  g121(.a(new_n272_), .b(new_n271_), .O(new_n273_));
  nand2  g122(.a(new_n273_), .b(new_n248_), .O(new_n274_));
  xnor2a g123(.a(x83), .b(x81), .O(new_n275_));
  nand3  g124(.a(new_n275_), .b(x42), .c(x05), .O(new_n276_));
  nand3  g125(.a(new_n250_), .b(x51), .c(new_n247_), .O(new_n277_));
  ...
  oai21  g134(.a(new_n285_), .b(new_n283_), .c(new_n251_), .O(new_n286_));
  aoi21  g135(.a(x83), .b(x42), .c(new_n250_), .O(new_n287_));
  nand3  g136(.a(x83), .b(new_n250_), .c(x42), .O(new_n288_));
  inv1   g137(.a(new_n288_), .O(new_n289_));
  oai21  g138(.a(new_n289_), .b(new_n287_), .c(new_n248_), .O(new_n290_));
  aoi21  g139(.a(new_n290_), .b(new_n286_), .c(new_n154_), .O(new_n291_));
  nand4  g140(.a(new_n291_), .b(x78), .c(x77), .d(x52), .O(new_n292_));
  nor2   g141(.a(new_n292_), .b(x01), .O(z34));
  nand4  g142(.a(new_n291_), .b(x78), .c(x77), .d(x53), .O(new_n294_));
  nor2   g143(.a(new_n294_), .b(x01), .O(z35));
  nand4  g144(.a(new_n291_), .b(x78), .c(x77), .d(x54), .O(new_n296_));
  nor2   g145(.a(new_n296_), .b(x01), .O(z36));
  nand4  g146(.a(new_n291_), .b(x78), .c(x77), .d(x55), .O(new_n298_));
  nor2   g147(.a(new_n298_), .b(x01), .O(z37));
  nand4  g148(.a(new_n291_), .b(x78), .c(x77), .d(x56), .O(new_n300_));
  nor2   g149(.a(new_n300_), .b(x01), .O(z38));
  nand4  g150(.a(new_n291_), .b(x78), .c(x77), .d(x57), .O(new_n302_));
  nor2   g151(.a(new_n302_), .b(x01), .O(z39));
  nand4  g152(.a(new_n291_), .b(x78), .c(x77), .d(x58), .O(new_n304_));
  nor2   g153(.a(new_n304_), .b(x01), .O(z40));
  nand4  g154(.a(new_n291_), .b(x78), .c(x77), .d(x59), .O(new_n306_));
  nor2   g155(.a(new_n306_), .b(x01), .O(z41));
  nand4  g156(.a(new_n291_), .b(x78), .c(x77), .d(x60), .O(new_n308_));
  nor2   g157(.a(new_n308_), .b(x01), .O(z42));
  nand4  g158(.a(new_n291_), .b(x78), .c(x77), .d(x61), .O(new_n310_));
  nor2   g159(.a(new_n310_), .b(x01), .O(z43));
  nand4  g160(.a(new_n291_), .b(x78), .c(x77), .d(x62), .O(new_n312_));
  nor2   g161(.a(new_n312_), .b(x01), .O(z44));
  nand4  g162(.a(new_n291_), .b(x78), .c(x77), .d(x63), .O(new_n314_));
  nor2   g163(.a(new_n314_), .b(x01), .O(z45));
  nand4  g164(.a(new_n291_), .b(x78), .c(x77), .d(x64), .O(new_n316_));
  ...
  nand4  g169(.a(new_n320_), .b(x78), .c(new_n165_), .d(x04), .O(new_n321_));
  nor2   g170(.a(x75), .b(x67), .O(new_n322_));
  nor2   g171(.a(new_n322_), .b(new_n228_), .O(new_n323_));
  nand4  g172(.a(new_n323_), .b(x79), .c(new_n167_), .d(x77), .O(new_n324_));
  ...
  nand4  g177(.a(new_n328_), .b(x78), .c(new_n165_), .d(x04), .O(new_n329_));
  nand2  g178(.a(new_n235_), .b(x68), .O(new_n330_));
  aoi21  g179(.a(new_n330_), .b(new_n329_), .c(x01), .O(z48));
  ...
  nand2  g184(.a(new_n235_), .b(x69), .O(new_n336_));
  ...
  nand4  g189(.a(new_n340_), .b(x78), .c(new_n165_), .d(x04), .O(new_n341_));
  nand2  g190(.a(new_n235_), .b(x70), .O(new_n342_));
  ...
  nand2  g196(.a(new_n235_), .b(x71), .O(new_n348_));
  ...
  nand2  g202(.a(new_n235_), .b(x72), .O(new_n354_));
  ...
  nand2  g208(.a(new_n235_), .b(x73), .O(new_n360_));
  ...
  nor2   g214(.a(new_n365_), .b(x01), .O(z54));
  inv1   g215(.a(x84), .O(new_n367_));
  inv1   g216(.a(x82), .O(new_n368_));
  nand4  g217(.a(x79), .b(x78), .c(x77), .d(new_n153_), .O(new_n369_));
  nor2   g218(.a(new_n369_), .b(x80), .O(new_n370_));
  nand4  g219(.a(new_n370_), .b(x83), .c(new_n368_), .d(new_n250_), .O(new_n371_));
  nor2   g220(.a(new_n371_), .b(new_n367_), .O(z55));
  nand2  g221(.a(x78), .b(x77), .O(new_n373_));
  nand2  g222(.a(new_n373_), .b(x76), .O(new_n374_));
  xor2a  g223(.a(x84), .b(x81), .O(new_n375_));
  nand2  g224(.a(new_n168_), .b(new_n166_), .O(new_n376_));
  nand3  g225(.a(new_n376_), .b(new_n375_), .c(new_n153_), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(new_n374_), .O(new_n378_));
  nand2  g227(.a(new_n378_), .b(x79), .O(new_n379_));
  nand4  g228(.a(new_n379_), .b(new_n160_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g229(.a(x02), .O(new_n381_));
  nand4  g230(.a(x03), .b(new_n381_), .c(new_n153_), .d(x00), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(z57));
  nand2  g232(.a(new_n247_), .b(x40), .O(new_n384_));
  oai21  g233(.a(new_n384_), .b(new_n168_), .c(x04), .O(new_n385_));
  nand2  g234(.a(new_n385_), .b(new_n154_), .O(new_n386_));
  nand3  g235(.a(x78), .b(new_n165_), .c(x04), .O(new_n387_));
  aoi21  g236(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  nand3  g237(.a(new_n154_), .b(new_n167_), .c(x40), .O(new_n389_));
  oai21  g238(.a(new_n167_), .b(new_n227_), .c(new_n389_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x77), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(new_n242_), .c(x01), .O(z59));
  and2   g241(.a(new_n375_), .b(x79), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(new_n165_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n227_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(x78), .O(new_n396_));
  nand3  g245(.a(new_n393_), .b(new_n167_), .c(x77), .O(new_n397_));
  and2   g246(.a(new_n397_), .b(new_n242_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n396_), .c(x01), .O(z60));
  oai21  g248(.a(new_n228_), .b(new_n159_), .c(new_n373_), .O(new_n400_));
  nand4  g249(.a(new_n400_), .b(x80), .c(x79), .d(new_n153_), .O(new_n401_));
  inv1   g250(.a(new_n401_), .O(z61));
  oai21  g251(.a(x84), .b(x77), .c(x81), .O(new_n403_));
  oai21  g252(.a(new_n403_), .b(new_n154_), .c(new_n227_), .O(new_n404_));
  nand2  g253(.a(new_n404_), .b(x78), .O(new_n405_));
  nand4  g254(.a(x84), .b(x81), .c(x79), .d(x77), .O(new_n406_));
  aoi21  g255(.a(new_n406_), .b(new_n405_), .c(x01), .O(z62));
  nand4  g256(.a(new_n400_), .b(x82), .c(x79), .d(new_n153_), .O(new_n408_));
  inv1   g257(.a(new_n408_), .O(z63));
  nand3  g258(.a(new_n400_), .b(x83), .c(x79), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n387_), .c(x01), .O(z64));
  oai21  g260(.a(x81), .b(x78), .c(x77), .O(new_n412_));
  oai21  g261(.a(new_n250_), .b(new_n167_), .c(new_n412_), .O(new_n413_));
  nand4  g262(.a(new_n413_), .b(x84), .c(x79), .d(new_n153_), .O(new_n414_));
  inv1   g263(.a(new_n414_), .O(z65));
endmodule
