...
module FAU ( 
  ...
  nor2   g175(.a(new_n232_), .b(new_n154_), .O(new_n327_));
  nand3  g176(.a(new_n327_), .b(new_n163_), .c(x77), .O(new_n328_));
  aoi21  g177(.a(new_n328_), .b(new_n326_), .c(x01), .O(z47));
  nand2  g178(.a(x52), .b(x16), .O(new_n330_));
  nand2  g179(.a(new_n323_), .b(x08), .O(new_n331_));
  aoi21  g180(.a(new_n331_), .b(new_n330_), .c(x79), .O(new_n332_));
  nand4  g181(.a(new_n332_), .b(x78), .c(new_n159_), .d(x04), .O(new_n333_));
  inv1   g182(.a(new_n328_), .O(new_n334_));
  nand2  g183(.a(new_n334_), .b(x68), .O(new_n335_));
  aoi21  g184(.a(new_n335_), .b(new_n333_), .c(x01), .O(z48));
  nand2  g185(.a(x52), .b(x17), .O(new_n337_));
  nand2  g186(.a(new_n323_), .b(x09), .O(new_n338_));
  ...
  nand2  g192(.a(new_n323_), .b(x10), .O(new_n344_));
  ...
  nand2  g198(.a(new_n323_), .b(x11), .O(new_n350_));
  ...
  nand2  g204(.a(new_n323_), .b(x12), .O(new_n356_));
  ...
  nand2  g210(.a(new_n323_), .b(x13), .O(new_n362_));
  ...
  nand2  g216(.a(new_n323_), .b(x14), .O(new_n368_));
