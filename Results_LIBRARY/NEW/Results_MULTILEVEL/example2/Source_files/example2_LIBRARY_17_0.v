...
module FAU ( 
  ...
  nor4   g095(.a(new_n246_), .b(new_n163_), .c(new_n159_), .d(x43), .O(z24));
  ...
  nor2   g136(.a(new_n237_), .b(new_n248_), .O(new_n288_));
  ...
  nand4  g222(.a(new_n245_), .b(x79), .c(x78), .d(x77), .O(new_n374_));
  nor2   g223(.a(new_n374_), .b(x80), .O(new_n375_));
  nand2  g224(.a(new_n375_), .b(new_n251_), .O(new_n376_));
  nor4   g225(.a(new_n376_), .b(new_n373_), .c(new_n237_), .d(x82), .O(z55));
  ...
  nand4  g239(.a(x80), .b(new_n235_), .c(x43), .d(new_n248_), .O(new_n391_));
  oai22  g240(.a(new_n391_), .b(new_n238_), .c(new_n248_), .d(x40), .O(new_n392_));
  ...
  oai21  g249(.a(new_n238_), .b(new_n236_), .c(new_n248_), .O(new_n401_));
