...
module FAU ( 
  ...
  nand4  g179(.a(new_n233_), .b(x79), .c(new_n163_), .d(x77), .O(new_n331_));
  inv1   g180(.a(new_n331_), .O(new_n332_));
  nand2  g181(.a(new_n332_), .b(x68), .O(new_n333_));
  nor2   g182(.a(x79), .b(new_n163_), .O(new_n334_));
  nand3  g183(.a(x52), .b(x16), .c(x04), .O(new_n335_));
  inv1   g184(.a(new_n335_), .O(new_n336_));
  nand3  g185(.a(new_n336_), .b(new_n334_), .c(new_n159_), .O(new_n337_));
  ...
  nand2  g191(.a(new_n332_), .b(x69), .O(new_n343_));
  ...
  nand2  g203(.a(new_n332_), .b(x71), .O(new_n355_));
  ...
  nand2  g209(.a(new_n332_), .b(x72), .O(new_n361_));
  ...
  nand2  g215(.a(new_n332_), .b(x73), .O(new_n367_));
  ...
  nand3  g277(.a(new_n334_), .b(new_n159_), .c(x04), .O(new_n429_));
