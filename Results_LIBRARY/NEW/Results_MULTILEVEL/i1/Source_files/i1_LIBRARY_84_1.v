// Benchmark "FAU" written by ABC on Mon Jul 27 17:44:52 2020
...
module FAU ( 
  ...
  nor2   g08(.a(x03), .b(x02), .O(new_n50_));
  nor2   g09(.a(x05), .b(x04), .O(new_n51_));
  ...
  nand2  g16(.a(new_n44_), .b(new_n43_), .O(new_n58_));
  inv1   g17(.a(x07), .O(new_n59_));
  nand3  g18(.a(new_n45_), .b(x19), .c(new_n59_), .O(new_n60_));
  ...
  buf1   g35(.a(x00), .O(z00));
  buf1   g36(.a(x20), .O(z03));
  buf1   g37(.a(x19), .O(z06));
  buf1   g38(.a(x11), .O(z08));
endmodule
