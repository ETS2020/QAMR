...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n65_, new_n66_, new_n69_, new_n70_, new_n72_, new_n73_,
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n52_), .d(x08), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n62_), .c(new_n42_), .O(z02));
  or2    g26(.a(x21), .b(x20), .O(z04));
  inv1   g27(.a(x10), .O(new_n69_));
  nand4  g28(.a(new_n65_), .b(x19), .c(new_n51_), .d(new_n49_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n63_), .c(new_n69_), .O(z05));
  oai21  g30(.a(x09), .b(new_n51_), .c(x07), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n75_));
  inv1   g34(.a(x00), .O(new_n76_));
  nor2   g35(.a(new_n61_), .b(new_n76_), .O(new_n77_));
  ...
  buf1   g52(.a(x00), .O(z00));
  buf1   g53(.a(x20), .O(z03));
  buf1   g54(.a(x11), .O(z08));
endmodule
