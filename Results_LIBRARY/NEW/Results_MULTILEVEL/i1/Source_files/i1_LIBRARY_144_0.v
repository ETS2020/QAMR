...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n66_, new_n67_, new_n68_, new_n72_, new_n73_, new_n75_, new_n77_,
  ...
  nand4  g09(.a(new_n50_), .b(new_n49_), .c(x09), .d(new_n43_), .O(new_n51_));
  ...
  inv1   g20(.a(x05), .O(new_n62_));
  inv1   g21(.a(x06), .O(new_n63_));
  nand4  g22(.a(new_n43_), .b(new_n63_), .c(new_n62_), .d(new_n47_), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n66_));
  inv1   g25(.a(x00), .O(new_n67_));
  nor2   g26(.a(new_n56_), .b(new_n67_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n42_), .O(z06));
  and2   g28(.a(x24), .b(x18), .O(z07));
  and2   g29(.a(x24), .b(x11), .O(z09));
  inv1   g30(.a(x14), .O(new_n72_));
  inv1   g31(.a(x22), .O(new_n73_));
  nor3   g32(.a(x24), .b(new_n73_), .c(new_n72_), .O(z10));
  inv1   g33(.a(x17), .O(new_n75_));
  nor3   g34(.a(x24), .b(new_n73_), .c(new_n75_), .O(z11));
  inv1   g35(.a(x23), .O(new_n77_));
  nor3   g36(.a(x24), .b(new_n77_), .c(new_n72_), .O(z12));
  nor3   g37(.a(x24), .b(new_n77_), .c(new_n75_), .O(z13));
  ...
  buf1   g43(.a(x00), .O(z00));
  buf1   g44(.a(x20), .O(z03));
  buf1   g45(.a(x10), .O(z05));
  buf1   g46(.a(x11), .O(z08));
endmodule
