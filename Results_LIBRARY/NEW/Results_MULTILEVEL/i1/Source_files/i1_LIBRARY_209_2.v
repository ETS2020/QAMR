// Benchmark "FAU" written by ABC on Mon Jul 27 17:45:14 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n74_, new_n75_, new_n79_, new_n80_, new_n82_, new_n84_, new_n87_,
    new_n89_, new_n90_;
  ...
  nand3  g26(.a(new_n61_), .b(x19), .c(new_n62_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n59_), .c(new_n67_), .O(z05));
  nand2  g28(.a(x08), .b(x07), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n47_), .c(new_n46_), .d(new_n54_), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n73_));
  inv1   g32(.a(x00), .O(new_n74_));
  nor2   g33(.a(new_n57_), .b(new_n74_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n42_), .O(z06));
  and2   g35(.a(x24), .b(x18), .O(z07));
  and2   g36(.a(x24), .b(x11), .O(z09));
  inv1   g37(.a(x14), .O(new_n79_));
  inv1   g38(.a(x22), .O(new_n80_));
  nor3   g39(.a(x24), .b(new_n80_), .c(new_n79_), .O(z10));
  inv1   g40(.a(x17), .O(new_n82_));
  nor3   g41(.a(x24), .b(new_n80_), .c(new_n82_), .O(z11));
  inv1   g42(.a(x23), .O(new_n84_));
  nor3   g43(.a(x24), .b(new_n84_), .c(new_n79_), .O(z12));
  nor3   g44(.a(x24), .b(new_n84_), .c(new_n82_), .O(z13));
  ...
  buf1   g50(.a(x00), .O(z00));
  buf1   g51(.a(x20), .O(z03));
  buf1   g52(.a(x11), .O(z08));
endmodule
