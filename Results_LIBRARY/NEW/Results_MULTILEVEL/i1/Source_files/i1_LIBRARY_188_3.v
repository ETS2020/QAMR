// Benchmark "FAU" written by ABC on Mon Jul 27 17:45:10 2020
...
module FAU ( 
  ...
  nand4  g17(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(new_n60_));
  inv1   g19(.a(x08), .O(new_n61_));
  nor2   g20(.a(x09), .b(new_n61_), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(new_n60_), .c(new_n55_), .d(new_n58_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n57_), .c(new_n42_), .O(z02));
  or2    g23(.a(x21), .b(x20), .O(z04));
  inv1   g24(.a(x10), .O(new_n66_));
  nand4  g25(.a(new_n55_), .b(x19), .c(new_n61_), .d(new_n58_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n59_), .c(new_n66_), .O(z05));
  inv1   g27(.a(x09), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n61_), .c(x07), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n73_));
  and2   g32(.a(new_n57_), .b(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n42_), .O(z06));
  ...
  buf1   g49(.a(x00), .O(z00));
  buf1   g50(.a(x20), .O(z03));
  buf1   g51(.a(x11), .O(z08));
endmodule
