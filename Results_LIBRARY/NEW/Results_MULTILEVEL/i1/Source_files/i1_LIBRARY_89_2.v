...
module FAU ( 
  ...
  nand3  g14(.a(new_n47_), .b(new_n46_), .c(new_n55_), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(x07), .c(x00), .O(new_n59_));
  nor2   g18(.a(x02), .b(x01), .O(new_n60_));
  nor3   g19(.a(x05), .b(x04), .c(x03), .O(new_n61_));
  nor2   g20(.a(x07), .b(x06), .O(new_n62_));
  inv1   g21(.a(x09), .O(new_n63_));
  nand3  g22(.a(x19), .b(new_n63_), .c(x08), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n62_), .c(new_n61_), .d(new_n60_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n59_), .O(z02));
  or2    g26(.a(x21), .b(x20), .O(z04));
  inv1   g27(.a(x10), .O(new_n69_));
  nand3  g28(.a(new_n60_), .b(new_n55_), .c(new_n45_), .O(new_n70_));
  nor2   g29(.a(new_n42_), .b(x08), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(z05));
  nand4  g32(.a(new_n62_), .b(new_n46_), .c(new_n55_), .d(new_n45_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(x02), .O(new_n75_));
  nand2  g34(.a(new_n57_), .b(x00), .O(new_n76_));
  aoi21  g35(.a(new_n75_), .b(new_n43_), .c(new_n76_), .O(new_n77_));
  nand2  g36(.a(x07), .b(x00), .O(new_n78_));
  oai21  g37(.a(new_n77_), .b(new_n42_), .c(new_n78_), .O(z06));
