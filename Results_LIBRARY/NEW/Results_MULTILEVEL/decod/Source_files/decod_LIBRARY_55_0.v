...
module FAU ( 
  ...
  nand4  g13(.a(x4), .b(new_n22_), .c(x2), .d(new_n32_), .O(new_n35_));
  ...
  nand4  g22(.a(x4), .b(new_n22_), .c(x2), .d(new_n41_), .O(new_n44_));
  inv1   g23(.a(new_n44_), .O(z09));
  nand4  g24(.a(x4), .b(x3), .c(new_n27_), .d(new_n41_), .O(new_n46_));
  inv1   g25(.a(new_n46_), .O(z10));
  nand4  g26(.a(x4), .b(new_n22_), .c(new_n27_), .d(new_n41_), .O(new_n48_));
