// Benchmark "FAU" written by ABC on Mon Jul 27 16:16:51 2020
...
module FAU ( 
  ...
  nand4  g23(.a(new_n24_), .b(x2), .c(new_n29_), .d(new_n37_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n36_), .O(z13));
  nand4  g25(.a(x4), .b(x3), .c(new_n42_), .d(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z14));
  nand4  g27(.a(x4), .b(new_n24_), .c(new_n42_), .d(new_n29_), .O(new_n53_));
