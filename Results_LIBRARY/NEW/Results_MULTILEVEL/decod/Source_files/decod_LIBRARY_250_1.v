...
module FAU ( 
  ...
  nand4  g16(.a(x4), .b(x3), .c(new_n27_), .d(new_n33_), .O(new_n38_));
  inv1   g17(.a(new_n38_), .O(z06));
  nand4  g18(.a(new_n30_), .b(new_n27_), .c(new_n33_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n24_), .O(z07));
  inv1   g20(.a(x0), .O(new_n43_));
  nand4  g21(.a(x4), .b(x2), .c(x1), .d(new_n43_), .O(new_n44_));
  inv1   g22(.a(new_n44_), .O(z09));
  nand4  g23(.a(x4), .b(new_n27_), .c(x1), .d(new_n43_), .O(new_n47_));
  inv1   g24(.a(new_n47_), .O(z11));
  nand4  g25(.a(x4), .b(x2), .c(new_n33_), .d(new_n43_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(z13));
  nand4  g27(.a(x4), .b(new_n27_), .c(new_n33_), .d(new_n43_), .O(new_n53_));
