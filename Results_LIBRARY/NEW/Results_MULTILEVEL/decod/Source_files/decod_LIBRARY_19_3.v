...
module FAU ( 
  ...
  nand4  g14(.a(new_n29_), .b(new_n28_), .c(new_n33_), .d(x0), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n27_), .O(z07));
  ...
  nand4  g21(.a(new_n29_), .b(new_n28_), .c(x1), .d(new_n41_), .O(new_n46_));
  ...
  nand4  g28(.a(new_n29_), .b(new_n28_), .c(new_n33_), .d(new_n41_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(new_n27_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z04));
  zero   g32(.O(z08));
  zero   g33(.O(z12));
