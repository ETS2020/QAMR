...
module FAU ( 
  ...
  nand4  g09(.a(new_n24_), .b(new_n28_), .c(x1), .d(x0), .O(new_n31_));
  ...
  nand4  g23(.a(new_n24_), .b(new_n28_), .c(x1), .d(new_n40_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n27_), .O(z11));
