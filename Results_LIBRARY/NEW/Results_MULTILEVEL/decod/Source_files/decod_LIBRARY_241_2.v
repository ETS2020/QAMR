// Benchmark "FAU" written by ABC on Mon Jul 27 16:17:12 2020
...
module FAU ( 
  ...
  inv1   g05(.a(x4), .O(new_n29_));
  inv1   g06(.a(x1), .O(new_n30_));
  nand4  g07(.a(x3), .b(x2), .c(new_n30_), .d(x0), .O(new_n31_));
  nor2   g08(.a(new_n31_), .b(new_n29_), .O(z04));
  nand4  g09(.a(new_n24_), .b(x2), .c(new_n30_), .d(x0), .O(new_n33_));
  nor2   g10(.a(new_n33_), .b(new_n29_), .O(z05));
  ...
  nand4  g21(.a(x3), .b(x2), .c(new_n30_), .d(new_n40_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n29_), .O(z12));
  nand4  g23(.a(new_n24_), .b(x2), .c(new_n30_), .d(new_n40_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n29_), .O(z13));
  nand4  g25(.a(x4), .b(x3), .c(new_n35_), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z14));
  nand4  g27(.a(x4), .b(new_n24_), .c(new_n35_), .d(new_n40_), .O(new_n53_));
