...
module FAU ( 
  ...
  nand2  g054(.a(new_n93_), .b(x22), .O(new_n101_));
  nand4  g055(.a(new_n74_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n102_));
  and2   g056(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n87_), .c(new_n100_), .O(z12));
  ...
  nor2   g066(.a(x18), .b(new_n112_), .O(new_n113_));
  aoi21  g067(.a(x18), .b(x05), .c(new_n113_), .O(new_n114_));
  aoi21  g068(.a(new_n109_), .b(new_n83_), .c(new_n63_), .O(new_n115_));
  nor2   g069(.a(x24), .b(x23), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n57_), .c(new_n54_), .O(new_n117_));
  nor2   g071(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  oai21  g073(.a(new_n114_), .b(x16), .c(new_n119_), .O(z14));
  ...
  nand2  g079(.a(new_n125_), .b(new_n54_), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n127_));
  nand2  g081(.a(new_n116_), .b(new_n57_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n92_), .c(x25), .O(new_n129_));
  ...
  nor2   g092(.a(x22), .b(x20), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n74_), .O(new_n140_));
  nand3  g094(.a(new_n116_), .b(new_n69_), .c(new_n66_), .O(new_n141_));
  nor2   g095(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  aoi21  g096(.a(new_n138_), .b(x26), .c(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n87_), .c(new_n136_), .O(z16));
  inv1   g098(.a(new_n141_), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n139_), .c(x19), .d(new_n72_), .O(new_n146_));
