...
module FAU ( 
  ...
  nor2   g078(.a(x18), .b(new_n124_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(x06), .c(new_n87_), .O(new_n126_));
  nand4  g080(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  aoi22  g082(.a(new_n128_), .b(new_n95_), .c(new_n120_), .d(x25), .O(new_n129_));
