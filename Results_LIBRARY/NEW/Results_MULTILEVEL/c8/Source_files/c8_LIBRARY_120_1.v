...
module FAU ( 
  ...
  oai21  g51(.a(new_n95_), .b(x22), .c(x16), .O(new_n98_));
  nor2   g52(.a(x18), .b(new_n57_), .O(new_n99_));
  aoi21  g53(.a(x18), .b(x03), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(x16), .c(new_n98_), .O(z12));
  ...
  nand2  g59(.a(new_n94_), .b(x23), .O(new_n106_));
  nor2   g60(.a(x23), .b(x21), .O(new_n107_));
  ...
  nor3   g68(.a(x24), .b(x23), .c(x21), .O(new_n115_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n107_), .c(new_n92_), .d(new_n72_), .O(new_n124_));
  ...
  aoi22  g87(.a(new_n133_), .b(new_n95_), .c(new_n124_), .d(x26), .O(new_n134_));
