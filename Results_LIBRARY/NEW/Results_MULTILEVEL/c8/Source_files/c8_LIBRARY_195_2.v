// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:52 2020
...
module FAU ( 
  ...
  nand3  g037(.a(x18), .b(new_n83_), .c(x01), .O(new_n84_));
  ...
  nand2  g042(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  ...
  oai21  g048(.a(new_n94_), .b(new_n83_), .c(new_n89_), .O(z11));
  ...
  oai21  g057(.a(new_n103_), .b(new_n83_), .c(new_n99_), .O(z12));
  ...
  aoi22  g063(.a(new_n109_), .b(new_n81_), .c(new_n102_), .d(x23), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n83_), .c(new_n108_), .O(z13));
  ...
  aoi21  g069(.a(new_n109_), .b(new_n81_), .c(new_n63_), .O(new_n116_));
  ...
  nand2  g078(.a(new_n124_), .b(new_n83_), .O(new_n125_));
  ...
  oai21  g082(.a(new_n128_), .b(new_n83_), .c(new_n125_), .O(z15));
  ...
  aoi21  g099(.a(new_n145_), .b(new_n144_), .c(new_n83_), .O(z17));
