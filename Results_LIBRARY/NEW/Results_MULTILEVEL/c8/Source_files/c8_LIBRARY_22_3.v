...
module FAU ( 
  ...
  nand3  g030(.a(x18), .b(new_n76_), .c(x00), .O(new_n77_));
  inv1   g031(.a(x18), .O(new_n78_));
  nand2  g032(.a(new_n78_), .b(x08), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(z09));
  ...
  nand2  g041(.a(new_n87_), .b(new_n84_), .O(z10));
  ...
  nand4  g048(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n95_));
  inv1   g049(.a(new_n95_), .O(new_n96_));
  aoi21  g050(.a(new_n94_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n76_), .c(new_n92_), .O(z11));
  ...
  nand3  g058(.a(new_n104_), .b(new_n74_), .c(new_n51_), .O(new_n105_));
  and2   g059(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g060(.a(new_n106_), .b(new_n76_), .c(new_n102_), .O(z12));
  ...
  aoi22  g066(.a(new_n112_), .b(new_n86_), .c(new_n105_), .d(x23), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n76_), .c(new_n111_), .O(z13));
  ...
  aoi21  g072(.a(new_n112_), .b(new_n86_), .c(new_n63_), .O(new_n119_));
  nor2   g073(.a(x24), .b(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n104_), .c(new_n93_), .d(new_n72_), .O(new_n121_));
  ...
  oai21  g085(.a(new_n131_), .b(new_n76_), .c(new_n128_), .O(z15));
  nand2  g086(.a(x18), .b(x07), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n69_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n76_), .O(new_n135_));
