...
module FAU ( 
  ...
  inv1   g49(.a(x17), .O(new_n96_));
  nor2   g50(.a(x21), .b(x20), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g52(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n96_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x22), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n72_), .c(new_n95_), .O(z12));
  ...
  nand3  g62(.a(new_n108_), .b(new_n87_), .c(new_n54_), .O(new_n109_));
  ...
  aoi22  g70(.a(new_n116_), .b(new_n89_), .c(new_n109_), .d(x24), .O(new_n117_));
  ...
  aoi21  g76(.a(new_n116_), .b(new_n89_), .c(new_n66_), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n108_), .c(new_n97_), .d(new_n96_), .O(new_n125_));
