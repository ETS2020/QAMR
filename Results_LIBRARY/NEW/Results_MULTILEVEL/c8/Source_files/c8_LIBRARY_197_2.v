...
module FAU ( 
  ...
  oai21  g043(.a(new_n89_), .b(x02), .c(new_n87_), .O(new_n90_));
  nor2   g044(.a(x20), .b(x19), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n72_), .O(new_n92_));
  ...
  oai21  g049(.a(new_n95_), .b(new_n87_), .c(new_n90_), .O(z11));
  ...
  nand4  g072(.a(new_n118_), .b(new_n102_), .c(new_n91_), .d(new_n72_), .O(new_n119_));
