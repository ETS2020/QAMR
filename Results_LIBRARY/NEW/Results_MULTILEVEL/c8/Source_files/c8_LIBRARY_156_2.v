...
module FAU ( 
  ...
  nand3  g037(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n84_));
  inv1   g038(.a(new_n84_), .O(new_n85_));
  oai21  g039(.a(new_n85_), .b(new_n83_), .c(x16), .O(new_n86_));
  oai21  g040(.a(new_n82_), .b(x16), .c(new_n86_), .O(z10));
  ...
  nand2  g047(.a(new_n93_), .b(new_n74_), .O(new_n94_));
  inv1   g048(.a(new_n94_), .O(new_n95_));
  aoi21  g049(.a(new_n84_), .b(x21), .c(new_n95_), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n88_), .c(new_n92_), .O(z11));
  inv1   g051(.a(x11), .O(new_n98_));
  nor2   g052(.a(x18), .b(new_n98_), .O(new_n99_));
  aoi21  g053(.a(x18), .b(x03), .c(new_n99_), .O(new_n100_));
  nor2   g054(.a(x22), .b(x21), .O(new_n101_));
  nand4  g055(.a(new_n101_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n102_));
  oai21  g056(.a(new_n95_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  oai21  g058(.a(new_n100_), .b(x16), .c(new_n104_), .O(z12));
  ...
  nand3  g063(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n110_));
  nor3   g064(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g065(.a(new_n111_), .b(new_n85_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n88_), .c(new_n109_), .O(z13));
  inv1   g067(.a(x13), .O(new_n114_));
  nor2   g068(.a(x18), .b(new_n114_), .O(new_n115_));
  aoi21  g069(.a(x18), .b(x05), .c(new_n115_), .O(new_n116_));
  aoi21  g070(.a(new_n111_), .b(new_n85_), .c(new_n63_), .O(new_n117_));
  nand3  g071(.a(new_n101_), .b(new_n63_), .c(new_n60_), .O(new_n118_));
  nor2   g072(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n117_), .c(x16), .O(new_n120_));
  oai21  g074(.a(new_n116_), .b(x16), .c(new_n120_), .O(z14));
  inv1   g075(.a(x14), .O(new_n122_));
  nor2   g076(.a(x18), .b(new_n122_), .O(new_n123_));
  aoi21  g077(.a(x18), .b(x06), .c(new_n123_), .O(new_n124_));
  nor2   g078(.a(new_n119_), .b(new_n66_), .O(new_n125_));
  nand4  g079(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n126_));
  nor2   g080(.a(new_n126_), .b(new_n94_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n125_), .c(x16), .O(new_n128_));
  oai21  g082(.a(new_n124_), .b(x16), .c(new_n128_), .O(z15));
  inv1   g083(.a(x15), .O(new_n130_));
  ...
  nand3  g087(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n60_), .c(x22), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n54_), .c(new_n51_), .d(new_n48_), .O(new_n136_));
  nand3  g090(.a(new_n101_), .b(new_n66_), .c(new_n63_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n84_), .c(x26), .O(new_n138_));
  oai21  g092(.a(new_n136_), .b(x17), .c(new_n138_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n133_), .O(z16));
  nor2   g095(.a(x26), .b(x25), .O(new_n142_));
  nor2   g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nor2   g097(.a(x24), .b(x22), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n93_), .O(new_n145_));
