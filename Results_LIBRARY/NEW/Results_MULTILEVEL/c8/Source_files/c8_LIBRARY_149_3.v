...
module FAU ( 
  ...
  nand3  g039(.a(new_n85_), .b(new_n76_), .c(x09), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n84_), .O(z10));
  ...
  aoi22  g065(.a(new_n111_), .b(new_n83_), .c(new_n104_), .d(x23), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n83_), .c(new_n63_), .O(new_n118_));
