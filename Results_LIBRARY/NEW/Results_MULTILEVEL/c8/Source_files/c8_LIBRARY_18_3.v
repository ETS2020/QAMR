...
module FAU ( 
  ...
  nor2   g49(.a(x21), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n72_), .O(new_n97_));
  nand4  g51(.a(new_n57_), .b(new_n54_), .c(new_n48_), .d(new_n72_), .O(new_n98_));
  ...
  nand3  g61(.a(new_n107_), .b(new_n74_), .c(new_n54_), .O(new_n108_));
  ...
  nor2   g89(.a(x22), .b(x21), .O(new_n136_));
