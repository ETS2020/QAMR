// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:39 2020
...
module FAU ( 
  ...
  oai21  g016(.a(new_n47_), .b(x13), .c(x24), .O(z05));
  ...
  nand2  g044(.a(new_n90_), .b(new_n70_), .O(new_n91_));
  nand4  g045(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n92_));
  ...
  nand2  g053(.a(new_n92_), .b(x22), .O(new_n100_));
  nor2   g054(.a(x22), .b(x21), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n72_), .c(new_n51_), .O(new_n102_));
  and2   g056(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n85_), .c(new_n99_), .O(z12));
  ...
  aoi22  g063(.a(new_n109_), .b(new_n82_), .c(new_n102_), .d(x23), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n85_), .c(new_n108_), .O(z13));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n82_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(x24), .b(x23), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n101_), .c(new_n90_), .d(new_n70_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n115_), .O(z14));
  ...
  nand4  g080(.a(new_n64_), .b(new_n116_), .c(new_n60_), .d(new_n57_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  aoi22  g082(.a(new_n128_), .b(new_n93_), .c(new_n119_), .d(x25), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n85_), .c(new_n126_), .O(z15));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n72_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x26), .O(new_n138_));
  nor3   g092(.a(x26), .b(x25), .c(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n135_), .c(new_n134_), .d(new_n72_), .O(new_n140_));
  ...
  aoi21  g100(.a(new_n146_), .b(new_n145_), .c(new_n85_), .O(z17));
