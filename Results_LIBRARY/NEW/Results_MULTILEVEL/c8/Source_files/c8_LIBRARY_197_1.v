...
module FAU ( 
  ...
  oai21  g41(.a(x18), .b(x10), .c(new_n87_), .O(new_n88_));
  nor2   g42(.a(x20), .b(x19), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n72_), .O(new_n90_));
  nand4  g44(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n91_));
  inv1   g45(.a(new_n91_), .O(new_n92_));
  aoi21  g46(.a(new_n90_), .b(x21), .c(new_n92_), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n87_), .c(new_n88_), .O(z11));
  ...
  nand2  g52(.a(new_n91_), .b(x22), .O(new_n99_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n89_), .d(new_n72_), .O(new_n117_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n92_), .c(new_n117_), .d(x25), .O(new_n127_));
