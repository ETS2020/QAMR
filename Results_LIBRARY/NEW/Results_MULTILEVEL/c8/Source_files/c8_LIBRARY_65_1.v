...
module FAU ( 
  ...
  nand2  g45(.a(new_n91_), .b(new_n80_), .O(new_n92_));
  nor2   g46(.a(x20), .b(x19), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n72_), .O(new_n94_));
  nand4  g48(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n94_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n80_), .c(new_n92_), .O(z11));
  inv1   g52(.a(x11), .O(new_n99_));
  nand2  g53(.a(x18), .b(x03), .O(new_n100_));
  ...
  oai21  g58(.a(new_n96_), .b(new_n57_), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n102_), .O(z12));
  inv1   g61(.a(x23), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(new_n108_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x16), .O(new_n110_));
  nor2   g64(.a(x18), .b(new_n60_), .O(new_n111_));
  aoi21  g65(.a(x18), .b(x04), .c(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(x16), .c(new_n110_), .O(z13));
  ...
  nor3   g71(.a(x24), .b(x22), .c(x21), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n86_), .c(new_n104_), .d(x24), .O(new_n119_));
  ...
  aoi21  g78(.a(new_n118_), .b(new_n86_), .c(new_n66_), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n103_), .c(new_n93_), .d(new_n72_), .O(new_n127_));
  ...
  nand4  g88(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n57_), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(new_n136_));
  aoi22  g90(.a(new_n136_), .b(new_n96_), .c(new_n127_), .d(x26), .O(new_n137_));
  oai21  g91(.a(new_n137_), .b(new_n80_), .c(new_n134_), .O(z16));
  nor2   g92(.a(x21), .b(x20), .O(new_n139_));
  nand4  g93(.a(new_n136_), .b(new_n139_), .c(x19), .d(new_n72_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n80_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
