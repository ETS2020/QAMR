// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:18 2020
...
module FAU ( 
  ...
  nand2  g053(.a(new_n96_), .b(x22), .O(new_n100_));
  nor2   g054(.a(x22), .b(x21), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n102_));
  and2   g056(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  inv1   g057(.a(x18), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n76_), .c(x11), .O(new_n105_));
  oai21  g059(.a(new_n103_), .b(new_n76_), .c(new_n105_), .O(z12));
  ...
  aoi22  g065(.a(new_n111_), .b(new_n87_), .c(new_n102_), .d(x23), .O(new_n112_));
  ...
  nand4  g073(.a(new_n119_), .b(new_n101_), .c(new_n94_), .d(new_n72_), .O(new_n120_));
  ...
  aoi22  g083(.a(new_n129_), .b(new_n97_), .c(new_n120_), .d(x25), .O(new_n130_));
