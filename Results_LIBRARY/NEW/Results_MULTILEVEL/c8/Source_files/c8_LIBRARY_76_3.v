...
module FAU ( 
  ...
  aoi21  g043(.a(new_n51_), .b(new_n72_), .c(new_n54_), .O(new_n90_));
  nand4  g044(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n91_));
  inv1   g045(.a(new_n91_), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  oai21  g047(.a(new_n89_), .b(x16), .c(new_n93_), .O(z11));
  ...
  nand2  g053(.a(new_n91_), .b(x22), .O(new_n100_));
  ...
  oai21  g057(.a(new_n103_), .b(new_n95_), .c(new_n99_), .O(z12));
  ...
  oai21  g064(.a(new_n110_), .b(new_n95_), .c(new_n108_), .O(z13));
  ...
  nand4  g072(.a(new_n118_), .b(new_n101_), .c(new_n117_), .d(new_n72_), .O(new_n119_));
  ...
  aoi22  g082(.a(new_n128_), .b(new_n92_), .c(new_n119_), .d(x25), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n95_), .c(new_n126_), .O(z15));
  ...
  nor2   g099(.a(x22), .b(x20), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n118_), .O(new_n147_));
  nand2  g101(.a(x27), .b(x17), .O(new_n148_));
  aoi21  g102(.a(new_n148_), .b(new_n147_), .c(new_n95_), .O(z17));
