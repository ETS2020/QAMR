...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n152_, new_n154_, new_n155_, new_n156_;
  ...
  aoi21  g045(.a(new_n57_), .b(new_n87_), .c(x21), .O(new_n92_));
  nand4  g046(.a(new_n92_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n93_));
  nor2   g047(.a(x20), .b(x19), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(x21), .c(x16), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n93_), .c(new_n91_), .O(z11));
  ...
  nand4  g059(.a(new_n105_), .b(new_n74_), .c(new_n51_), .d(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n104_), .c(new_n101_), .O(z12));
  ...
  aoi21  g065(.a(new_n102_), .b(new_n74_), .c(new_n60_), .O(new_n112_));
  nor2   g066(.a(x23), .b(x22), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n54_), .O(new_n114_));
  nor2   g068(.a(new_n114_), .b(new_n95_), .O(new_n115_));
  ...
  nor2   g076(.a(x23), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n74_), .c(new_n51_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x24), .O(new_n125_));
  nand4  g079(.a(new_n105_), .b(new_n84_), .c(new_n63_), .d(new_n60_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand2  g082(.a(x24), .b(x22), .O(new_n129_));
  ...
  nor3   g088(.a(x24), .b(x23), .c(x21), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n84_), .c(new_n66_), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n113_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(new_n103_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand2  g094(.a(x25), .b(x22), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n140_), .c(new_n134_), .O(z15));
  nand2  g096(.a(x18), .b(x07), .O(new_n143_));
  oai21  g097(.a(x18), .b(new_n69_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n87_), .O(new_n145_));
  nand4  g099(.a(new_n137_), .b(new_n123_), .c(new_n94_), .d(new_n72_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n113_), .c(new_n102_), .d(new_n74_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(x26), .b(x22), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n145_), .O(z16));
  nor2   g107(.a(new_n48_), .b(x17), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n148_), .c(new_n113_), .d(new_n102_), .O(new_n155_));
  nand2  g109(.a(x27), .b(x17), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n155_), .c(new_n87_), .O(z17));
