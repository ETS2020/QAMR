...
module FAU ( 
  ...
  nand2  g77(.a(new_n119_), .b(new_n103_), .O(new_n124_));
  nor2   g78(.a(x18), .b(new_n66_), .O(new_n125_));
  aoi21  g79(.a(x18), .b(x06), .c(new_n125_), .O(new_n126_));
  nand3  g80(.a(new_n92_), .b(new_n72_), .c(x16), .O(new_n127_));
  oai22  g81(.a(new_n127_), .b(new_n124_), .c(new_n126_), .d(x16), .O(z15));
  ...
  nand4  g86(.a(new_n69_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n133_));
  inv1   g87(.a(new_n133_), .O(new_n134_));
  aoi22  g88(.a(new_n134_), .b(new_n95_), .c(new_n120_), .d(x26), .O(new_n135_));
