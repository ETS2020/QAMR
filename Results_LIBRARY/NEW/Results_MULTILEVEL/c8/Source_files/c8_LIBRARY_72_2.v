// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:29 2020
...
module FAU ( 
  ...
  nand2  g42(.a(new_n88_), .b(new_n72_), .O(new_n89_));
  nand4  g43(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  aoi21  g45(.a(new_n89_), .b(x21), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(x18), .b(new_n87_), .c(x02), .O(new_n93_));
  oai21  g47(.a(new_n92_), .b(new_n87_), .c(new_n93_), .O(z11));
  ...
  nand2  g52(.a(new_n90_), .b(x22), .O(new_n99_));
  nor2   g53(.a(x22), .b(x21), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n74_), .c(new_n51_), .O(new_n101_));
  and2   g55(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n87_), .c(new_n98_), .O(z12));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n84_), .c(new_n101_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n87_), .c(new_n107_), .O(z13));
  ...
  aoi21  g68(.a(new_n108_), .b(new_n84_), .c(new_n63_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n88_), .d(new_n72_), .O(new_n117_));
  ...
  nand4  g78(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n91_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n87_), .c(new_n124_), .O(z15));
  ...
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n74_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x26), .O(new_n136_));
  nor3   g90(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n133_), .c(new_n132_), .d(new_n74_), .O(new_n138_));
