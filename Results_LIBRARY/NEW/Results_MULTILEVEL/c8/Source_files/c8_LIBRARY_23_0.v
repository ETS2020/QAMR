...
module FAU ( 
  ...
  or2    g034(.a(x18), .b(x09), .O(new_n81_));
  nand3  g035(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  ...
  nand2  g039(.a(new_n85_), .b(new_n82_), .O(z10));
  ...
  oai21  g049(.a(new_n95_), .b(new_n80_), .c(new_n90_), .O(z11));
  ...
  oai21  g058(.a(new_n104_), .b(new_n80_), .c(new_n100_), .O(z12));
  ...
  oai21  g083(.a(new_n129_), .b(new_n80_), .c(new_n126_), .O(z15));
