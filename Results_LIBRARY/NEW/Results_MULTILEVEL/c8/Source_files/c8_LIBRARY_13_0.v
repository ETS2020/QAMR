...
module FAU ( 
  ...
  oai21  g054(.a(new_n100_), .b(x03), .c(new_n76_), .O(new_n101_));
  nand2  g055(.a(new_n96_), .b(x22), .O(new_n102_));
  ...
  nand4  g073(.a(new_n119_), .b(new_n103_), .c(new_n94_), .d(new_n72_), .O(new_n120_));
