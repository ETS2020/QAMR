// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:22 2020
...
module FAU ( 
  ...
  oai21  g030(.a(x18), .b(x08), .c(new_n76_), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n75_), .O(z09));
  inv1   g032(.a(x09), .O(new_n79_));
  nor2   g033(.a(x18), .b(new_n79_), .O(new_n80_));
  aoi21  g034(.a(x18), .b(x01), .c(new_n80_), .O(new_n81_));
  nor2   g035(.a(new_n74_), .b(new_n51_), .O(new_n82_));
  ...
  nand2  g042(.a(new_n88_), .b(new_n76_), .O(new_n89_));
  ...
  oai21  g057(.a(new_n103_), .b(new_n76_), .c(new_n99_), .O(z12));
  ...
  aoi22  g063(.a(new_n109_), .b(new_n83_), .c(new_n102_), .d(x23), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n76_), .c(new_n108_), .O(z13));
  inv1   g065(.a(x13), .O(new_n112_));
  nand2  g066(.a(x18), .b(x05), .O(new_n113_));
  oai21  g067(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n76_), .O(new_n115_));
  aoi21  g069(.a(new_n109_), .b(new_n83_), .c(new_n63_), .O(new_n116_));
  nor2   g070(.a(x24), .b(x23), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n101_), .c(new_n90_), .d(new_n72_), .O(new_n118_));
  ...
  nand2  g078(.a(new_n124_), .b(new_n76_), .O(new_n125_));
  nand4  g079(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n126_));
  inv1   g080(.a(new_n126_), .O(new_n127_));
  aoi22  g081(.a(new_n127_), .b(new_n93_), .c(new_n118_), .d(x25), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n76_), .c(new_n125_), .O(z15));
  nand2  g083(.a(x18), .b(x07), .O(new_n130_));
  oai21  g084(.a(x18), .b(new_n69_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n76_), .O(new_n132_));
  ...
  aoi21  g099(.a(new_n145_), .b(new_n144_), .c(new_n76_), .O(z17));
