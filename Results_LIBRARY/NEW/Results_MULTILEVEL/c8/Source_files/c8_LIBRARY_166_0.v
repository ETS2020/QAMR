// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:46 2020
...
module FAU ( 
  ...
  oai21  g063(.a(new_n109_), .b(x04), .c(new_n76_), .O(new_n110_));
  nor3   g064(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g065(.a(new_n111_), .b(new_n87_), .c(new_n106_), .d(x23), .O(new_n112_));
  ...
  nand4  g073(.a(new_n119_), .b(new_n105_), .c(new_n94_), .d(new_n72_), .O(new_n120_));
