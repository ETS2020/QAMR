...
module FAU ( 
  ...
  oai21  g062(.a(new_n108_), .b(x04), .c(new_n87_), .O(new_n109_));
  nor3   g063(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g064(.a(new_n110_), .b(new_n84_), .c(new_n104_), .d(x23), .O(new_n111_));
  ...
  nand4  g072(.a(new_n118_), .b(new_n103_), .c(new_n92_), .d(new_n72_), .O(new_n119_));
