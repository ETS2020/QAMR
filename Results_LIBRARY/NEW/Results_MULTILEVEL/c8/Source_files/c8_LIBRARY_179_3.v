...
module FAU ( 
  ...
  aoi21  g038(.a(new_n54_), .b(x19), .c(x20), .O(new_n85_));
  nor2   g039(.a(new_n74_), .b(new_n51_), .O(new_n86_));
  aoi21  g040(.a(new_n85_), .b(new_n72_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g045(.a(new_n51_), .b(new_n72_), .c(new_n54_), .O(new_n92_));
  ...
  aoi22  g065(.a(new_n111_), .b(new_n110_), .c(new_n103_), .d(x23), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n110_), .c(new_n63_), .O(new_n118_));
  nor2   g072(.a(x20), .b(x19), .O(new_n119_));
  nor2   g073(.a(x24), .b(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n119_), .c(new_n102_), .d(new_n72_), .O(new_n121_));
  ...
  nor2   g101(.a(x22), .b(x20), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n120_), .O(new_n149_));
