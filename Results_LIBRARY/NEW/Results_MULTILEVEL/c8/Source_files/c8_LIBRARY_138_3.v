...
module FAU ( 
  ...
  nor2   g094(.a(x18), .b(x16), .O(new_n141_));
  aoi22  g095(.a(new_n141_), .b(x15), .c(x18), .d(x07), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(z16));
  nor2   g097(.a(new_n48_), .b(x17), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n137_), .c(new_n133_), .d(new_n132_), .O(new_n145_));
