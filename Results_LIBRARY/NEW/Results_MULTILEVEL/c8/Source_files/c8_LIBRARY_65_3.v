...
module FAU ( 
  ...
  aoi21  g050(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n87_), .c(new_n91_), .O(z11));
  ...
  aoi21  g055(.a(new_n60_), .b(x20), .c(x22), .O(new_n102_));
  nand4  g056(.a(new_n102_), .b(new_n54_), .c(new_n48_), .d(new_n72_), .O(new_n103_));
  nand2  g057(.a(new_n95_), .b(x22), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n101_), .O(z12));
  ...
  aoi21  g066(.a(new_n112_), .b(new_n74_), .c(new_n60_), .O(new_n113_));
  nor3   g067(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  and2   g068(.a(new_n114_), .b(new_n84_), .O(new_n115_));
  ...
  aoi21  g075(.a(new_n114_), .b(new_n84_), .c(new_n63_), .O(new_n122_));
  nor2   g076(.a(x24), .b(x23), .O(new_n123_));
  nand4  g077(.a(new_n123_), .b(new_n112_), .c(new_n92_), .d(new_n72_), .O(new_n124_));
  ...
  aoi22  g088(.a(new_n134_), .b(new_n96_), .c(new_n124_), .d(x25), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n87_), .c(new_n130_), .O(z15));
  ...
  nand4  g093(.a(new_n132_), .b(new_n131_), .c(new_n94_), .d(new_n74_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x26), .O(new_n141_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n131_), .c(new_n94_), .d(new_n74_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n142_), .c(new_n131_), .d(new_n94_), .O(new_n148_));
