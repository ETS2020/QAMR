...
module FAU ( 
  ...
  aoi21  g069(.a(new_n113_), .b(new_n87_), .c(new_n63_), .O(new_n116_));
  nor2   g070(.a(x24), .b(x23), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n105_), .c(new_n94_), .d(new_n72_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  inv1   g074(.a(x18), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n76_), .c(x13), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(z14));
  ...
  aoi22  g083(.a(new_n129_), .b(new_n97_), .c(new_n118_), .d(x25), .O(new_n130_));
