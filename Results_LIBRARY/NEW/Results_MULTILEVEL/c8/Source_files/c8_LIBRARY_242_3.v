...
module FAU ( 
  ...
  aoi22  g081(.a(new_n127_), .b(new_n97_), .c(new_n122_), .d(x25), .O(new_n128_));
  inv1   g082(.a(x18), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n76_), .c(x14), .O(new_n130_));
  oai21  g084(.a(new_n128_), .b(new_n76_), .c(new_n130_), .O(z15));
