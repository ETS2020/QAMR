...
module FAU ( 
  ...
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n74_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(x26), .O(new_n136_));
  nor3   g090(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n133_), .c(new_n132_), .d(new_n74_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand3  g094(.a(x18), .b(new_n87_), .c(x07), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(z16));
  nor2   g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n137_), .c(new_n133_), .d(new_n132_), .O(new_n144_));
