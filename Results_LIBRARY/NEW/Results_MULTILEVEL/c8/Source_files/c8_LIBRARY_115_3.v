// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:37 2020
...
module FAU ( 
  ...
  nand4  g045(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n92_));
  inv1   g046(.a(new_n92_), .O(new_n93_));
  aoi21  g047(.a(new_n91_), .b(x21), .c(new_n93_), .O(new_n94_));
  inv1   g048(.a(x18), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n76_), .c(x10), .O(new_n96_));
  oai21  g050(.a(new_n94_), .b(new_n76_), .c(new_n96_), .O(z11));
  inv1   g051(.a(x11), .O(new_n98_));
  nand2  g052(.a(x18), .b(x03), .O(new_n99_));
  oai21  g053(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n76_), .O(new_n101_));
  nand2  g055(.a(new_n92_), .b(x22), .O(new_n102_));
  ...
  oai21  g059(.a(new_n105_), .b(new_n76_), .c(new_n101_), .O(z12));
  inv1   g060(.a(x12), .O(new_n107_));
  nand2  g061(.a(x18), .b(x04), .O(new_n108_));
  oai21  g062(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n76_), .O(new_n110_));
  nor3   g064(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g065(.a(new_n111_), .b(new_n87_), .c(new_n104_), .d(x23), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n76_), .c(new_n110_), .O(z13));
  inv1   g067(.a(x13), .O(new_n114_));
  nand2  g068(.a(x18), .b(x05), .O(new_n115_));
  oai21  g069(.a(x18), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n76_), .O(new_n117_));
  aoi21  g071(.a(new_n111_), .b(new_n87_), .c(new_n63_), .O(new_n118_));
  nor2   g072(.a(x24), .b(x23), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n103_), .c(new_n90_), .d(new_n72_), .O(new_n120_));
  ...
  nand2  g080(.a(new_n126_), .b(new_n76_), .O(new_n127_));
  nand4  g081(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n93_), .c(new_n120_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n76_), .c(new_n127_), .O(z15));
  nand2  g085(.a(x18), .b(x07), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n69_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n76_), .O(new_n134_));
  nor2   g088(.a(x21), .b(x20), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n74_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x26), .O(new_n139_));
  nor3   g093(.a(x26), .b(x25), .c(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n136_), .c(new_n135_), .d(new_n74_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n134_), .O(z16));
  nor2   g098(.a(new_n48_), .b(x17), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n140_), .c(new_n136_), .d(new_n135_), .O(new_n146_));
  nand2  g100(.a(x27), .b(x17), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(new_n146_), .c(new_n76_), .O(z17));
