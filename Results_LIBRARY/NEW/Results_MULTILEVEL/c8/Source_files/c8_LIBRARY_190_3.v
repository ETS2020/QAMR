// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:51 2020
...
module FAU ( 
  ...
  aoi22  g46(.a(new_n92_), .b(new_n74_), .c(new_n84_), .d(x21), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n88_), .c(new_n91_), .O(z11));
  inv1   g48(.a(x11), .O(new_n95_));
  nand2  g49(.a(x18), .b(x03), .O(new_n96_));
  oai21  g50(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n88_), .O(new_n98_));
  nand2  g52(.a(new_n92_), .b(new_n74_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x22), .O(new_n100_));
  nor2   g54(.a(x22), .b(x21), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n102_));
  and2   g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n88_), .c(new_n98_), .O(z12));
  inv1   g58(.a(x12), .O(new_n105_));
  nand2  g59(.a(x18), .b(x04), .O(new_n106_));
  oai21  g60(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  nor2   g62(.a(x23), .b(x22), .O(new_n109_));
  inv1   g63(.a(new_n109_), .O(new_n110_));
  nor3   g64(.a(new_n110_), .b(new_n84_), .c(x21), .O(new_n111_));
  aoi21  g65(.a(new_n102_), .b(x23), .c(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n88_), .c(new_n108_), .O(z13));
  inv1   g67(.a(x13), .O(new_n114_));
  nor2   g68(.a(x18), .b(new_n114_), .O(new_n115_));
  aoi21  g69(.a(x18), .b(x05), .c(new_n115_), .O(new_n116_));
  nand4  g70(.a(new_n101_), .b(new_n85_), .c(new_n63_), .d(new_n60_), .O(new_n117_));
  oai21  g71(.a(new_n111_), .b(new_n63_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(x16), .O(new_n119_));
  oai21  g73(.a(new_n116_), .b(x16), .c(new_n119_), .O(z14));
  inv1   g74(.a(x14), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  oai21  g76(.a(x18), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n88_), .O(new_n124_));
  nand2  g78(.a(new_n69_), .b(x21), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(x22), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n128_));
  nand2  g82(.a(new_n117_), .b(x25), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n124_), .O(z15));
  inv1   g86(.a(x15), .O(new_n133_));
  nor2   g87(.a(x18), .b(new_n133_), .O(new_n134_));
  aoi21  g88(.a(x18), .b(x07), .c(new_n134_), .O(new_n135_));
  nand3  g89(.a(new_n109_), .b(new_n66_), .c(new_n63_), .O(new_n136_));
  oai21  g90(.a(new_n136_), .b(new_n84_), .c(x26), .O(new_n137_));
  nand4  g91(.a(new_n109_), .b(new_n69_), .c(new_n66_), .d(new_n63_), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(new_n99_), .c(new_n137_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  oai21  g94(.a(new_n135_), .b(x16), .c(new_n140_), .O(z16));
  nand3  g95(.a(new_n92_), .b(x19), .c(new_n72_), .O(new_n142_));
  or2    g96(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand2  g97(.a(x27), .b(x17), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n88_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
