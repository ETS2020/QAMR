...
module FAU ( 
  ...
  nand4  g070(.a(new_n74_), .b(new_n60_), .c(new_n54_), .d(new_n51_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x24), .O(new_n118_));
  nor2   g072(.a(x20), .b(x19), .O(new_n119_));
  nor2   g073(.a(x24), .b(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n102_), .c(new_n119_), .d(new_n72_), .O(new_n121_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n74_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x26), .O(new_n140_));
  nor3   g094(.a(x26), .b(x25), .c(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n137_), .c(new_n136_), .d(new_n74_), .O(new_n142_));
  ...
  aoi21  g102(.a(new_n148_), .b(new_n147_), .c(new_n87_), .O(z17));
