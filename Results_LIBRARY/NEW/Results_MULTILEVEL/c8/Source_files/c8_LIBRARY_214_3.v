// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:55 2020
...
module FAU ( 
  ...
  and2   g051(.a(x18), .b(x03), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(x11), .c(new_n87_), .O(new_n99_));
  ...
  oai21  g057(.a(new_n103_), .b(new_n87_), .c(new_n99_), .O(z12));
  ...
  aoi22  g063(.a(new_n109_), .b(new_n84_), .c(new_n102_), .d(x23), .O(new_n110_));
  ...
  nand4  g071(.a(new_n117_), .b(new_n101_), .c(new_n92_), .d(new_n72_), .O(new_n118_));
