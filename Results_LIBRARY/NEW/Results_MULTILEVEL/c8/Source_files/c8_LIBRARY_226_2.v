// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:57 2020
...
module FAU ( 
  ...
  aoi22  g61(.a(new_n107_), .b(new_n84_), .c(new_n104_), .d(x23), .O(new_n108_));
  nand3  g62(.a(x18), .b(new_n87_), .c(x04), .O(new_n109_));
  oai21  g63(.a(new_n108_), .b(new_n87_), .c(new_n109_), .O(z13));
  ...
  aoi21  g68(.a(new_n107_), .b(new_n84_), .c(new_n63_), .O(new_n115_));
