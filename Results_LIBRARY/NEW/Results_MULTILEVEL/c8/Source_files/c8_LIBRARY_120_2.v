...
module FAU ( 
  ...
  aoi22  g046(.a(new_n92_), .b(new_n75_), .c(new_n83_), .d(x21), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n87_), .c(new_n91_), .O(z11));
  ...
  oai21  g053(.a(new_n99_), .b(x20), .c(new_n48_), .O(new_n100_));
  nand3  g054(.a(new_n54_), .b(new_n48_), .c(new_n76_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(x22), .O(new_n102_));
  oai21  g056(.a(new_n100_), .b(x17), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g063(.a(new_n57_), .b(new_n54_), .c(new_n48_), .d(new_n76_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  nor2   g065(.a(x23), .b(x22), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n75_), .c(new_n54_), .O(new_n113_));
  ...
  nor3   g075(.a(x24), .b(x23), .c(x22), .O(new_n122_));
  aoi22  g076(.a(new_n122_), .b(new_n121_), .c(new_n113_), .d(x24), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n87_), .c(new_n120_), .O(z14));
  ...
  aoi21  g082(.a(new_n122_), .b(new_n121_), .c(new_n66_), .O(new_n129_));
  nor2   g083(.a(x21), .b(x19), .O(new_n130_));
  nor2   g084(.a(x25), .b(x24), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n112_), .c(new_n130_), .d(new_n76_), .O(new_n132_));
  ...
  aoi22  g095(.a(new_n141_), .b(new_n111_), .c(new_n132_), .d(x26), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n139_), .O(z16));
  nand4  g097(.a(new_n141_), .b(new_n99_), .c(x19), .d(new_n76_), .O(new_n144_));
