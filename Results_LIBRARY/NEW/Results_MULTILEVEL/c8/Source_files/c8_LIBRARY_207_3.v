...
module FAU ( 
  ...
  nand2  g46(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  aoi21  g48(.a(new_n91_), .b(x21), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n87_), .c(new_n90_), .O(z11));
  nand2  g50(.a(x18), .b(x03), .O(new_n97_));
  oai21  g51(.a(x18), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n87_), .O(new_n99_));
  nor3   g53(.a(x22), .b(x21), .c(x20), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n74_), .c(new_n93_), .d(x22), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n87_), .c(new_n99_), .O(z12));
  inv1   g56(.a(x12), .O(new_n103_));
  nand2  g57(.a(x18), .b(x04), .O(new_n104_));
  oai21  g58(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  nand2  g60(.a(new_n100_), .b(new_n74_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n84_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n87_), .c(new_n106_), .O(z13));
  inv1   g64(.a(x13), .O(new_n111_));
  nor2   g65(.a(x18), .b(new_n111_), .O(new_n112_));
  aoi21  g66(.a(x18), .b(x05), .c(new_n112_), .O(new_n113_));
  aoi21  g67(.a(new_n108_), .b(new_n84_), .c(new_n63_), .O(new_n114_));
  nor2   g68(.a(x22), .b(x21), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(new_n63_), .c(new_n60_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n91_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  oai21  g72(.a(new_n113_), .b(x16), .c(new_n118_), .O(z14));
  inv1   g73(.a(x14), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  oai21  g75(.a(x18), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n87_), .O(new_n123_));
  nand4  g77(.a(new_n115_), .b(new_n84_), .c(new_n63_), .d(new_n60_), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n66_), .c(new_n63_), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(new_n93_), .O(new_n127_));
  aoi21  g81(.a(new_n124_), .b(x25), .c(new_n127_), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n87_), .c(new_n123_), .O(z15));
  ...
  oai21  g86(.a(new_n126_), .b(new_n93_), .c(x26), .O(new_n133_));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nand3  g88(.a(new_n134_), .b(new_n125_), .c(new_n94_), .O(new_n135_));
  ...
  nand4  g92(.a(new_n51_), .b(x19), .c(new_n72_), .d(x16), .O(new_n139_));
  nor3   g93(.a(new_n139_), .b(x22), .c(x21), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n141_));
  nor2   g95(.a(new_n141_), .b(x26), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
