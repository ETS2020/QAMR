...
module FAU ( 
  ...
  nand3  g097(.a(new_n143_), .b(new_n76_), .c(x15), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(z16));
  nor2   g099(.a(new_n48_), .b(x17), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n139_), .c(new_n135_), .d(new_n134_), .O(new_n147_));
