...
module FAU ( 
  ...
  nand3  g036(.a(new_n51_), .b(new_n48_), .c(new_n76_), .O(new_n83_));
  oai21  g037(.a(new_n75_), .b(new_n51_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g045(.a(new_n75_), .b(new_n54_), .c(new_n51_), .O(new_n92_));
  inv1   g046(.a(new_n92_), .O(new_n93_));
  aoi21  g047(.a(new_n83_), .b(x21), .c(new_n93_), .O(new_n94_));
  ...
  nor3   g053(.a(x22), .b(x21), .c(x20), .O(new_n100_));
  aoi22  g054(.a(new_n100_), .b(new_n75_), .c(new_n92_), .d(x22), .O(new_n101_));
  oai21  g055(.a(new_n101_), .b(new_n87_), .c(new_n99_), .O(z12));
  ...
  nand3  g060(.a(new_n60_), .b(new_n57_), .c(new_n54_), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(new_n51_), .c(x19), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  aoi21  g063(.a(new_n109_), .b(new_n75_), .c(new_n60_), .O(new_n110_));
  aoi21  g064(.a(new_n108_), .b(new_n76_), .c(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n87_), .c(new_n106_), .O(z13));
  ...
  nand3  g071(.a(new_n117_), .b(new_n75_), .c(new_n54_), .O(new_n118_));
  nor3   g072(.a(x21), .b(x19), .c(x17), .O(new_n119_));
  nor3   g073(.a(x24), .b(x23), .c(x22), .O(new_n120_));
  aoi22  g074(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(x24), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n87_), .c(new_n116_), .O(z14));
  ...
  aoi21  g080(.a(new_n120_), .b(new_n119_), .c(new_n66_), .O(new_n127_));
  nor2   g081(.a(x21), .b(x19), .O(new_n128_));
  nor2   g082(.a(x25), .b(x24), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n128_), .c(new_n117_), .d(new_n76_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  nand4  g091(.a(new_n57_), .b(new_n54_), .c(new_n48_), .d(new_n76_), .O(new_n138_));
  ...
  aoi22  g095(.a(new_n141_), .b(new_n139_), .c(new_n130_), .d(x26), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n137_), .O(z16));
  nand4  g097(.a(new_n141_), .b(new_n109_), .c(x19), .d(new_n76_), .O(new_n144_));
