// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:20 2020
...
module FAU ( 
  ...
  oai21  g034(.a(x18), .b(x09), .c(new_n80_), .O(new_n81_));
  ...
  nand2  g038(.a(new_n84_), .b(new_n81_), .O(z10));
  ...
  oai21  g048(.a(new_n94_), .b(new_n80_), .c(new_n89_), .O(z11));
  ...
  oai21  g057(.a(new_n103_), .b(new_n80_), .c(new_n99_), .O(z12));
  ...
  nand2  g078(.a(new_n124_), .b(new_n80_), .O(new_n125_));
  ...
  oai21  g082(.a(new_n128_), .b(new_n80_), .c(new_n125_), .O(z15));
  nand2  g083(.a(x18), .b(x07), .O(new_n130_));
  oai21  g084(.a(x18), .b(new_n69_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n80_), .O(new_n132_));
