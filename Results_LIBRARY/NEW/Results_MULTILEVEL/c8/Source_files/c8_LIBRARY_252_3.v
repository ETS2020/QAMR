...
module FAU ( 
  ...
  nor2   g041(.a(x20), .b(x19), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n72_), .O(new_n89_));
  nand4  g043(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n90_));
  inv1   g044(.a(new_n90_), .O(new_n91_));
  aoi21  g045(.a(new_n89_), .b(x21), .c(new_n91_), .O(new_n92_));
  nor2   g046(.a(x18), .b(x16), .O(new_n93_));
  aoi22  g047(.a(new_n93_), .b(x10), .c(x18), .d(x02), .O(new_n94_));
  oai21  g048(.a(new_n92_), .b(new_n87_), .c(new_n94_), .O(z11));
  ...
  nand4  g071(.a(new_n117_), .b(new_n101_), .c(new_n88_), .d(new_n72_), .O(new_n118_));
  ...
  aoi22  g081(.a(new_n127_), .b(new_n91_), .c(new_n118_), .d(x25), .O(new_n128_));
