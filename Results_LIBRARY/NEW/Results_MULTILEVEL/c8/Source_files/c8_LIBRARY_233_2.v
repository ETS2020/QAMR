...
module FAU ( 
  ...
  nand2  g38(.a(new_n48_), .b(new_n76_), .O(new_n85_));
  ...
  nand3  g46(.a(new_n92_), .b(new_n48_), .c(new_n76_), .O(new_n93_));
  ...
  nand2  g53(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  nand4  g54(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n48_), .O(new_n101_));
  nor2   g55(.a(new_n101_), .b(x17), .O(new_n102_));
  aoi21  g56(.a(new_n92_), .b(new_n75_), .c(new_n57_), .O(new_n103_));
  ...
  nand4  g64(.a(new_n110_), .b(new_n51_), .c(new_n48_), .d(new_n76_), .O(new_n111_));
  nand3  g65(.a(new_n57_), .b(new_n54_), .c(new_n51_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n85_), .c(x23), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n109_), .O(z13));
  inv1   g70(.a(x13), .O(new_n117_));
  nand2  g71(.a(x18), .b(x05), .O(new_n118_));
  oai21  g72(.a(x18), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  aoi21  g74(.a(new_n110_), .b(new_n86_), .c(new_n63_), .O(new_n121_));
  nand3  g75(.a(new_n51_), .b(new_n48_), .c(new_n76_), .O(new_n122_));
  nand4  g76(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n120_), .O(z14));
  nand2  g80(.a(x18), .b(x06), .O(new_n127_));
  oai21  g81(.a(x18), .b(new_n66_), .c(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n80_), .O(new_n129_));
  nand4  g83(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n130_));
  inv1   g84(.a(new_n130_), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n51_), .c(new_n48_), .d(new_n76_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n129_), .O(z15));
  inv1   g88(.a(x15), .O(new_n135_));
  nand2  g89(.a(x18), .b(x07), .O(new_n136_));
  oai21  g90(.a(x18), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n80_), .O(new_n138_));
  oai21  g92(.a(new_n69_), .b(new_n80_), .c(new_n138_), .O(z16));
