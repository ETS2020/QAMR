...
module FAU ( 
  ...
  aoi22  g065(.a(new_n111_), .b(new_n84_), .c(new_n104_), .d(x23), .O(new_n112_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n87_), .c(new_n127_), .O(z15));
  nand2  g085(.a(x18), .b(x07), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n69_), .O(new_n133_));
