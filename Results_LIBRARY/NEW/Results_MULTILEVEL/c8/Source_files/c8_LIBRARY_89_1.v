// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:32 2020
...
module FAU ( 
  ...
  oai21  g67(.a(x18), .b(x13), .c(new_n87_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n84_), .c(new_n63_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n103_), .c(new_n92_), .d(new_n72_), .O(new_n117_));
