...
module FAU ( 
  ...
  nor2   g43(.a(x20), .b(x17), .O(new_n90_));
  nor2   g44(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n48_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n91_), .c(x16), .O(new_n95_));
  oai21  g49(.a(new_n89_), .b(x16), .c(new_n95_), .O(z11));
  ...
  nand4  g55(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n93_), .b(x22), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n97_), .c(new_n101_), .O(z12));
  ...
  nand2  g63(.a(new_n102_), .b(x23), .O(new_n110_));
  nor2   g64(.a(x23), .b(x22), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n90_), .c(new_n54_), .O(new_n112_));
  and2   g66(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n97_), .c(new_n109_), .O(z13));
  inv1   g68(.a(x13), .O(new_n115_));
  nand2  g69(.a(x18), .b(x05), .O(new_n116_));
  oai21  g70(.a(x18), .b(new_n115_), .c(new_n116_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n97_), .O(new_n118_));
  nor3   g72(.a(x21), .b(x20), .c(x17), .O(new_n119_));
  nor3   g73(.a(x24), .b(x23), .c(x22), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n119_), .c(new_n112_), .d(x24), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n97_), .c(new_n118_), .O(z14));
  inv1   g76(.a(x14), .O(new_n123_));
  nand2  g77(.a(x18), .b(x06), .O(new_n124_));
  oai21  g78(.a(x18), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n97_), .O(new_n126_));
  aoi21  g80(.a(new_n120_), .b(new_n119_), .c(new_n66_), .O(new_n127_));
  nor2   g81(.a(x25), .b(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n111_), .c(new_n92_), .d(new_n72_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n126_), .O(z15));
  inv1   g86(.a(x15), .O(new_n133_));
  nand2  g87(.a(x18), .b(x07), .O(new_n134_));
  oai21  g88(.a(x18), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n97_), .O(new_n136_));
  nand4  g90(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n137_));
  inv1   g91(.a(new_n137_), .O(new_n138_));
  aoi22  g92(.a(new_n138_), .b(new_n103_), .c(new_n129_), .d(x26), .O(new_n139_));
  oai21  g93(.a(new_n139_), .b(new_n97_), .c(new_n136_), .O(z16));
  nand3  g94(.a(x27), .b(x17), .c(x16), .O(new_n141_));
  inv1   g95(.a(new_n141_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
