// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:30 2020
...
module FAU ( 
  ...
  nor2   g43(.a(x18), .b(new_n89_), .O(new_n90_));
  aoi21  g44(.a(x18), .b(x02), .c(new_n90_), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n48_), .c(new_n72_), .O(new_n93_));
  oai21  g47(.a(new_n86_), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(x16), .O(new_n95_));
  oai21  g49(.a(new_n91_), .b(x16), .c(new_n95_), .O(z11));
  ...
  nand4  g54(.a(new_n100_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n101_));
  nand2  g55(.a(new_n92_), .b(new_n74_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x22), .O(new_n103_));
  ...
  nand4  g65(.a(new_n111_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n112_));
  nand3  g66(.a(new_n100_), .b(new_n74_), .c(new_n51_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x23), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n110_), .O(z13));
  inv1   g71(.a(x13), .O(new_n118_));
  nand2  g72(.a(x18), .b(x05), .O(new_n119_));
  oai21  g73(.a(x18), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n80_), .O(new_n121_));
  aoi21  g75(.a(new_n111_), .b(new_n86_), .c(new_n63_), .O(new_n122_));
  nand3  g76(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n123_));
  nand3  g77(.a(new_n100_), .b(new_n63_), .c(new_n60_), .O(new_n124_));
  nor2   g78(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n121_), .O(z14));
  nand2  g81(.a(x18), .b(x06), .O(new_n128_));
  oai21  g82(.a(x18), .b(new_n66_), .c(new_n128_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  nand3  g84(.a(new_n63_), .b(new_n60_), .c(new_n57_), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n54_), .c(new_n51_), .d(new_n48_), .O(new_n132_));
  nand2  g86(.a(new_n102_), .b(x25), .O(new_n133_));
  oai21  g87(.a(new_n132_), .b(x17), .c(new_n133_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n130_), .O(z15));
  inv1   g90(.a(x15), .O(new_n137_));
  nand2  g91(.a(x18), .b(x07), .O(new_n138_));
  oai21  g92(.a(x18), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n80_), .O(new_n140_));
  oai21  g94(.a(new_n69_), .b(new_n80_), .c(new_n140_), .O(z16));
  nand3  g95(.a(x27), .b(x17), .c(x16), .O(new_n142_));
  inv1   g96(.a(new_n142_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
