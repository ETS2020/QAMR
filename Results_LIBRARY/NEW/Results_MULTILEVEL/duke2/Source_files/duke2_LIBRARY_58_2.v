...
module FAU ( 
  ...
  oai21  g263(.a(x11), .b(new_n78_), .c(x15), .O(new_n315_));
  nand2  g264(.a(new_n64_), .b(x04), .O(new_n316_));
  nand3  g265(.a(new_n66_), .b(new_n55_), .c(new_n79_), .O(new_n317_));
  oai22  g266(.a(new_n317_), .b(new_n316_), .c(new_n315_), .d(new_n54_), .O(new_n318_));
  ...
  nand4  g281(.a(new_n329_), .b(x16), .c(x12), .d(new_n109_), .O(new_n333_));
  ...
  nand4  g300(.a(new_n215_), .b(new_n101_), .c(x15), .d(new_n89_), .O(new_n352_));
  ...
  nor3   g305(.a(new_n355_), .b(new_n172_), .c(new_n109_), .O(new_n357_));
  aoi21  g306(.a(new_n356_), .b(new_n109_), .c(new_n357_), .O(new_n358_));
  ...
  inv1   g414(.a(new_n110_), .O(new_n466_));
