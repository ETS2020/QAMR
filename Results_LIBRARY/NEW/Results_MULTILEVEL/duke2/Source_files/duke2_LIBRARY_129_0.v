...
module FAU ( 
  ...
  aoi22  g058(.a(new_n109_), .b(new_n73_), .c(new_n75_), .d(x05), .O(new_n110_));
  nand2  g059(.a(new_n56_), .b(new_n54_), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(x21), .c(x08), .O(new_n112_));
  oai21  g061(.a(new_n110_), .b(x15), .c(new_n112_), .O(new_n113_));
  ...
  nor2   g070(.a(new_n121_), .b(new_n109_), .O(new_n122_));
  ...
  nand3  g134(.a(new_n109_), .b(new_n73_), .c(x04), .O(new_n187_));
