...
module FAU ( 
  ...
  nand2  g066(.a(new_n54_), .b(new_n77_), .O(new_n118_));
  nand2  g067(.a(new_n66_), .b(x11), .O(new_n119_));
  ...
  nor3   g071(.a(new_n122_), .b(new_n52_), .c(new_n55_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n116_), .c(new_n57_), .O(new_n124_));
  nand4  g073(.a(new_n66_), .b(x15), .c(new_n86_), .d(new_n100_), .O(new_n125_));
  ...
  oai22  g140(.a(new_n191_), .b(new_n190_), .c(new_n187_), .d(new_n118_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(x06), .O(new_n193_));
  oai21  g142(.a(new_n118_), .b(new_n86_), .c(x13), .O(new_n194_));
  ...
  nand3  g177(.a(new_n228_), .b(new_n150_), .c(new_n72_), .O(new_n229_));
  ...
  nand3  g336(.a(new_n121_), .b(x19), .c(x15), .O(new_n388_));
  ...
  nand3  g446(.a(new_n117_), .b(x15), .c(new_n57_), .O(new_n498_));
