...
module FAU ( 
  ...
  nand3  g025(.a(new_n63_), .b(x10), .c(x04), .O(new_n77_));
  aoi21  g026(.a(new_n77_), .b(x10), .c(x21), .O(new_n78_));
  nand4  g027(.a(new_n78_), .b(new_n76_), .c(x11), .d(x08), .O(new_n79_));
  oai21  g028(.a(new_n79_), .b(x02), .c(new_n75_), .O(new_n80_));
  ...
  aoi21  g035(.a(new_n80_), .b(new_n55_), .c(new_n86_), .O(new_n87_));
  ...
  aoi22  g064(.a(x15), .b(new_n72_), .c(new_n88_), .d(x06), .O(new_n116_));
  ...
  nor2   g069(.a(new_n72_), .b(new_n57_), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n84_), .c(new_n88_), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(x04), .O(new_n123_));
  aoi22  g072(.a(new_n63_), .b(new_n112_), .c(new_n72_), .d(x05), .O(new_n124_));
  nand2  g073(.a(new_n55_), .b(new_n57_), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(x21), .c(x08), .O(new_n126_));
  oai21  g075(.a(new_n124_), .b(x15), .c(new_n126_), .O(new_n127_));
  ...
  oai21  g081(.a(new_n132_), .b(new_n119_), .c(new_n105_), .O(new_n133_));
  ...
  aoi21  g085(.a(x19), .b(new_n105_), .c(new_n54_), .O(new_n137_));
  ...
  aoi21  g090(.a(x09), .b(new_n81_), .c(new_n88_), .O(new_n142_));
  ...
  nand2  g112(.a(x21), .b(new_n88_), .O(new_n164_));
  inv1   g113(.a(x10), .O(new_n165_));
  nand4  g114(.a(new_n66_), .b(new_n165_), .c(x08), .d(new_n112_), .O(new_n166_));
  oai21  g115(.a(new_n164_), .b(new_n163_), .c(new_n166_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(x02), .O(new_n168_));
  nand2  g117(.a(x12), .b(new_n62_), .O(new_n169_));
  nand2  g118(.a(new_n63_), .b(x04), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n112_), .O(new_n172_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n76_), .c(new_n105_), .d(new_n54_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(x05), .O(z05));
  nand3  g129(.a(new_n63_), .b(new_n112_), .c(x04), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n173_), .O(new_n182_));
  nand3  g131(.a(new_n182_), .b(new_n73_), .c(new_n72_), .O(new_n183_));
  nand2  g132(.a(new_n77_), .b(x10), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(x11), .c(new_n81_), .O(new_n185_));
  nand3  g134(.a(new_n165_), .b(new_n112_), .c(x02), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n66_), .c(new_n76_), .d(x08), .O(new_n188_));
  ...
  nand3  g140(.a(new_n191_), .b(x18), .c(new_n53_), .O(new_n192_));
  nand3  g141(.a(new_n150_), .b(x15), .c(x00), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n192_), .c(x07), .O(new_n194_));
  nand3  g143(.a(new_n150_), .b(new_n55_), .c(x07), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n194_), .c(new_n57_), .O(new_n197_));
  nor2   g146(.a(new_n57_), .b(new_n62_), .O(new_n198_));
  nor2   g147(.a(x15), .b(x12), .O(new_n199_));
  nand3  g148(.a(new_n66_), .b(x18), .c(new_n53_), .O(new_n200_));
  inv1   g149(.a(new_n200_), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n199_), .c(new_n198_), .d(new_n98_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n197_), .c(x09), .O(z06));
  xnor2a g152(.a(x08), .b(x07), .O(new_n204_));
  nand3  g153(.a(new_n204_), .b(new_n148_), .c(new_n105_), .O(new_n205_));
  nand3  g154(.a(x16), .b(new_n55_), .c(x09), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n158_), .c(new_n205_), .O(new_n207_));
  nand3  g156(.a(new_n207_), .b(x18), .c(new_n53_), .O(new_n208_));
  inv1   g157(.a(new_n208_), .O(z07));
  nor2   g158(.a(x20), .b(new_n76_), .O(z08));
  nand2  g159(.a(new_n72_), .b(new_n112_), .O(new_n211_));
  nand3  g160(.a(new_n76_), .b(x08), .c(x02), .O(new_n212_));
  oai21  g161(.a(new_n211_), .b(x05), .c(new_n212_), .O(new_n213_));
  nand3  g162(.a(new_n213_), .b(new_n63_), .c(x04), .O(new_n214_));
  inv1   g163(.a(new_n214_), .O(new_n215_));
  nand3  g164(.a(x11), .b(new_n72_), .c(new_n81_), .O(new_n216_));
  nand4  g165(.a(new_n76_), .b(new_n165_), .c(x08), .d(x02), .O(new_n217_));
  nand2  g166(.a(new_n217_), .b(new_n216_), .O(new_n218_));
  nand2  g167(.a(new_n218_), .b(x06), .O(new_n219_));
  nand2  g168(.a(x12), .b(x10), .O(new_n220_));
  oai21  g169(.a(x10), .b(x06), .c(new_n220_), .O(new_n221_));
  nand4  g170(.a(new_n221_), .b(new_n76_), .c(x08), .d(x02), .O(new_n222_));
  aoi21  g171(.a(new_n222_), .b(new_n219_), .c(x05), .O(new_n223_));
  oai21  g172(.a(new_n223_), .b(new_n215_), .c(new_n66_), .O(new_n224_));
  nand3  g173(.a(new_n129_), .b(new_n72_), .c(x05), .O(new_n225_));
  nand2  g174(.a(new_n225_), .b(new_n224_), .O(new_n226_));
  nand2  g175(.a(new_n226_), .b(new_n105_), .O(new_n227_));
  nand4  g176(.a(new_n135_), .b(x08), .c(x05), .d(new_n62_), .O(new_n228_));
  aoi21  g177(.a(new_n228_), .b(new_n227_), .c(x07), .O(new_n229_));
  nor2   g178(.a(new_n129_), .b(new_n105_), .O(new_n230_));
  nand2  g179(.a(new_n230_), .b(new_n105_), .O(new_n231_));
  nand2  g180(.a(new_n231_), .b(x07), .O(new_n232_));
  nand2  g181(.a(new_n232_), .b(x12), .O(new_n233_));
  nand3  g182(.a(new_n233_), .b(x08), .c(x05), .O(new_n234_));
  inv1   g183(.a(new_n234_), .O(new_n235_));
  oai21  g184(.a(new_n235_), .b(new_n229_), .c(new_n55_), .O(new_n236_));
  inv1   g185(.a(new_n134_), .O(new_n237_));
  nand4  g186(.a(new_n237_), .b(x15), .c(new_n88_), .d(new_n57_), .O(new_n238_));
  oai22  g187(.a(new_n238_), .b(new_n81_), .c(new_n237_), .d(new_n57_), .O(new_n239_));
  nand3  g188(.a(new_n239_), .b(x08), .c(new_n54_), .O(new_n240_));
  aoi21  g189(.a(new_n240_), .b(new_n236_), .c(new_n52_), .O(new_n241_));
  nand4  g190(.a(new_n105_), .b(new_n54_), .c(new_n57_), .d(x04), .O(new_n242_));
  nor2   g191(.a(x21), .b(x18), .O(new_n243_));
  nand4  g192(.a(new_n243_), .b(new_n55_), .c(new_n76_), .d(x12), .O(new_n244_));
  nor2   g193(.a(new_n244_), .b(new_n242_), .O(new_n245_));
  oai21  g194(.a(new_n245_), .b(new_n241_), .c(new_n53_), .O(new_n246_));
  nand2  g195(.a(new_n150_), .b(new_n55_), .O(new_n247_));
  inv1   g196(.a(new_n247_), .O(new_n248_));
  nand3  g197(.a(new_n248_), .b(new_n105_), .c(new_n54_), .O(new_n249_));
  nand2  g198(.a(new_n249_), .b(new_n246_), .O(z09));
  inv1   g199(.a(new_n211_), .O(new_n251_));
  nand3  g200(.a(new_n251_), .b(new_n154_), .c(new_n55_), .O(new_n252_));
  nand2  g201(.a(new_n252_), .b(new_n153_), .O(new_n253_));
  nand2  g202(.a(new_n253_), .b(x05), .O(new_n254_));
  nand2  g203(.a(new_n251_), .b(new_n154_), .O(new_n255_));
  ...
  nor3   g207(.a(new_n129_), .b(new_n52_), .c(x17), .O(new_n259_));
  nand4  g208(.a(new_n259_), .b(new_n55_), .c(x08), .d(x05), .O(new_n260_));
  aoi21  g209(.a(new_n260_), .b(new_n151_), .c(new_n54_), .O(new_n261_));
  oai21  g210(.a(new_n261_), .b(new_n258_), .c(new_n105_), .O(new_n262_));
  nand2  g211(.a(new_n137_), .b(x05), .O(new_n263_));
  ...
  nand4  g216(.a(new_n105_), .b(x07), .c(new_n57_), .d(x01), .O(new_n268_));
  inv1   g217(.a(new_n268_), .O(new_n269_));
  nand4  g218(.a(new_n269_), .b(new_n52_), .c(new_n53_), .d(new_n55_), .O(new_n270_));
  inv1   g219(.a(new_n270_), .O(z11));
  nand3  g220(.a(new_n121_), .b(x15), .c(new_n88_), .O(new_n272_));
  nor2   g221(.a(x06), .b(x05), .O(new_n273_));
  nand4  g222(.a(new_n273_), .b(new_n55_), .c(x12), .d(new_n72_), .O(new_n274_));
  aoi21  g223(.a(new_n274_), .b(new_n272_), .c(x04), .O(new_n275_));
  inv1   g224(.a(new_n275_), .O(new_n276_));
  nand3  g225(.a(new_n76_), .b(x11), .c(x10), .O(new_n277_));
  oai21  g226(.a(new_n277_), .b(new_n82_), .c(new_n211_), .O(new_n278_));
  nand3  g227(.a(new_n278_), .b(new_n63_), .c(x04), .O(new_n279_));
  nand3  g228(.a(new_n76_), .b(new_n165_), .c(x08), .O(new_n280_));
  aoi21  g229(.a(new_n280_), .b(new_n163_), .c(new_n88_), .O(new_n281_));
  nand4  g230(.a(new_n88_), .b(new_n72_), .c(x06), .d(x02), .O(new_n282_));
  inv1   g231(.a(new_n282_), .O(new_n283_));
  aoi21  g232(.a(new_n281_), .b(new_n81_), .c(new_n283_), .O(new_n284_));
  aoi21  g233(.a(new_n284_), .b(new_n279_), .c(x15), .O(new_n285_));
  nand2  g234(.a(new_n89_), .b(new_n83_), .O(new_n286_));
  inv1   g235(.a(new_n286_), .O(new_n287_));
  oai21  g236(.a(new_n287_), .b(new_n285_), .c(new_n57_), .O(new_n288_));
  nand3  g237(.a(new_n199_), .b(new_n198_), .c(x08), .O(new_n289_));
  nand3  g238(.a(new_n289_), .b(new_n288_), .c(new_n276_), .O(new_n290_));
  nand4  g239(.a(new_n290_), .b(new_n66_), .c(x18), .d(new_n53_), .O(new_n291_));
  nand4  g240(.a(new_n150_), .b(x15), .c(new_n57_), .d(x00), .O(new_n292_));
  nand2  g241(.a(new_n292_), .b(new_n291_), .O(new_n293_));
  nand2  g242(.a(new_n293_), .b(new_n54_), .O(new_n294_));
  nor2   g243(.a(new_n54_), .b(x05), .O(new_n295_));
  nand2  g244(.a(new_n295_), .b(new_n248_), .O(new_n296_));
  aoi21  g245(.a(new_n296_), .b(new_n294_), .c(x09), .O(z12));
  nand2  g246(.a(x07), .b(x05), .O(new_n298_));
  nand4  g247(.a(new_n298_), .b(new_n52_), .c(x17), .d(new_n105_), .O(new_n299_));
  inv1   g248(.a(new_n299_), .O(z13));
  nand2  g249(.a(x21), .b(new_n105_), .O(new_n301_));
  nand3  g250(.a(new_n89_), .b(new_n57_), .c(new_n81_), .O(new_n302_));
  nand2  g251(.a(new_n199_), .b(new_n198_), .O(new_n303_));
  nand2  g252(.a(new_n303_), .b(new_n302_), .O(new_n304_));
  nand3  g253(.a(new_n304_), .b(new_n301_), .c(new_n54_), .O(new_n305_));
  nand3  g254(.a(new_n148_), .b(new_n129_), .c(x07), .O(new_n306_));
  nand2  g255(.a(new_n306_), .b(new_n305_), .O(new_n307_));
  nand3  g256(.a(new_n307_), .b(x18), .c(x08), .O(new_n308_));
  nand2  g257(.a(x11), .b(new_n81_), .O(new_n309_));
  oai21  g258(.a(new_n309_), .b(new_n81_), .c(x15), .O(new_n310_));
  ...
  nand4  g262(.a(new_n313_), .b(new_n52_), .c(new_n105_), .d(new_n57_), .O(new_n314_));
  ...
  nand4  g267(.a(new_n318_), .b(new_n52_), .c(new_n105_), .d(new_n57_), .O(new_n319_));
  nand2  g268(.a(new_n319_), .b(new_n316_), .O(z14));
  nand4  g269(.a(new_n55_), .b(new_n105_), .c(new_n54_), .d(x05), .O(new_n321_));
  nor3   g270(.a(new_n321_), .b(x18), .c(new_n53_), .O(z15));
  aoi21  g271(.a(new_n170_), .b(x10), .c(new_n81_), .O(new_n323_));
  nand4  g272(.a(new_n106_), .b(x12), .c(x11), .d(new_n81_), .O(new_n324_));
  inv1   g273(.a(new_n324_), .O(new_n325_));
  oai21  g274(.a(new_n325_), .b(new_n323_), .c(x06), .O(new_n326_));
  nand3  g275(.a(x16), .b(x12), .c(new_n112_), .O(new_n327_));
  nand3  g276(.a(new_n327_), .b(new_n77_), .c(x10), .O(new_n328_));
  nand3  g277(.a(new_n328_), .b(x11), .c(new_n81_), .O(new_n329_));
  nand2  g278(.a(new_n329_), .b(new_n326_), .O(new_n330_));
  nand4  g279(.a(new_n330_), .b(new_n66_), .c(new_n76_), .d(new_n105_), .O(new_n331_));
  nand2  g280(.a(new_n129_), .b(x09), .O(new_n332_));
  ...
  nand3  g288(.a(new_n88_), .b(x06), .c(x02), .O(new_n340_));
  nand3  g289(.a(x12), .b(new_n112_), .c(new_n62_), .O(new_n341_));
  ...
  aoi21  g294(.a(new_n345_), .b(new_n193_), .c(x07), .O(new_n346_));
  oai21  g295(.a(new_n346_), .b(new_n196_), .c(new_n57_), .O(new_n347_));
  nand4  g296(.a(new_n201_), .b(new_n100_), .c(x15), .d(new_n88_), .O(new_n348_));
  aoi21  g297(.a(new_n348_), .b(new_n347_), .c(x09), .O(z17));
  nor2   g298(.a(x06), .b(x04), .O(new_n350_));
  nand4  g299(.a(new_n350_), .b(x21), .c(x12), .d(new_n72_), .O(new_n351_));
  nand2  g300(.a(new_n351_), .b(new_n168_), .O(new_n352_));
  nand3  g301(.a(new_n352_), .b(new_n55_), .c(new_n76_), .O(new_n353_));
  nand3  g302(.a(x19), .b(x15), .c(new_n72_), .O(new_n354_));
  aoi21  g303(.a(new_n354_), .b(new_n353_), .c(new_n52_), .O(new_n355_));
  nand4  g304(.a(new_n355_), .b(new_n53_), .c(new_n105_), .d(new_n54_), .O(new_n356_));
  nor2   g305(.a(new_n356_), .b(x05), .O(z18));
  nand4  g306(.a(new_n140_), .b(x17), .c(new_n55_), .d(new_n105_), .O(new_n358_));
  nor2   g307(.a(new_n358_), .b(x18), .O(z19));
  inv1   g308(.a(new_n121_), .O(new_n360_));
  nand2  g309(.a(new_n278_), .b(new_n57_), .O(new_n361_));
  nand2  g310(.a(new_n361_), .b(new_n360_), .O(new_n362_));
  nand4  g311(.a(new_n362_), .b(new_n55_), .c(new_n63_), .d(x04), .O(new_n363_));
  aoi21  g312(.a(new_n363_), .b(new_n276_), .c(x21), .O(new_n364_));
  nand4  g313(.a(new_n171_), .b(x21), .c(new_n55_), .d(new_n76_), .O(new_n365_));
  inv1   g314(.a(new_n365_), .O(new_n366_));
  nand4  g315(.a(new_n366_), .b(new_n72_), .c(new_n112_), .d(new_n57_), .O(new_n367_));
  inv1   g316(.a(new_n367_), .O(new_n368_));
  oai21  g317(.a(new_n368_), .b(new_n364_), .c(x18), .O(new_n369_));
  nor2   g318(.a(new_n63_), .b(x05), .O(new_n370_));
  nand4  g319(.a(new_n370_), .b(new_n243_), .c(new_n67_), .d(x04), .O(new_n371_));
  aoi21  g320(.a(new_n371_), .b(new_n369_), .c(x09), .O(new_n372_));
  nand4  g321(.a(x18), .b(new_n55_), .c(new_n63_), .d(x09), .O(new_n373_));
  nor3   g322(.a(new_n373_), .b(new_n360_), .c(new_n62_), .O(new_n374_));
  oai21  g323(.a(new_n374_), .b(new_n372_), .c(new_n53_), .O(new_n375_));
  nor2   g324(.a(new_n375_), .b(x07), .O(z20));
  nor2   g325(.a(new_n55_), .b(x09), .O(new_n377_));
  nand2  g326(.a(new_n377_), .b(new_n251_), .O(new_n378_));
  nand3  g327(.a(new_n159_), .b(x08), .c(x06), .O(new_n379_));
  aoi21  g328(.a(new_n379_), .b(new_n378_), .c(x05), .O(new_n380_));
  nand3  g329(.a(new_n55_), .b(new_n105_), .c(new_n72_), .O(new_n381_));
  nor3   g330(.a(new_n381_), .b(new_n112_), .c(new_n57_), .O(new_n382_));
  oai21  g331(.a(new_n382_), .b(new_n380_), .c(new_n54_), .O(new_n383_));
  nand3  g332(.a(new_n377_), .b(new_n295_), .c(x08), .O(new_n384_));
  ...
  nand3  g336(.a(new_n377_), .b(new_n72_), .c(x06), .O(new_n388_));
  nand2  g337(.a(new_n159_), .b(x08), .O(new_n389_));
  aoi21  g338(.a(new_n389_), .b(new_n388_), .c(x05), .O(new_n390_));
  oai21  g339(.a(new_n390_), .b(new_n382_), .c(new_n54_), .O(new_n391_));
  aoi21  g340(.a(new_n230_), .b(new_n105_), .c(new_n55_), .O(new_n392_));
  ...
  nand4  g345(.a(new_n140_), .b(new_n55_), .c(x09), .d(x08), .O(new_n397_));
  nor3   g346(.a(new_n397_), .b(new_n52_), .c(x17), .O(z23));
  nand3  g347(.a(new_n121_), .b(x18), .c(new_n63_), .O(new_n399_));
  nand3  g348(.a(new_n370_), .b(new_n52_), .c(new_n76_), .O(new_n400_));
  nand2  g349(.a(new_n400_), .b(new_n399_), .O(new_n401_));
  nand3  g350(.a(new_n401_), .b(new_n55_), .c(x04), .O(new_n402_));
  nand3  g351(.a(x11), .b(new_n57_), .c(new_n81_), .O(new_n403_));
  nand3  g352(.a(new_n88_), .b(x05), .c(new_n62_), .O(new_n404_));
  ...
  nand4  g360(.a(new_n411_), .b(new_n295_), .c(x08), .d(x01), .O(new_n412_));
  nand2  g361(.a(new_n412_), .b(new_n410_), .O(new_n413_));
  nand3  g362(.a(new_n413_), .b(new_n53_), .c(new_n105_), .O(new_n414_));
  inv1   g363(.a(new_n414_), .O(z24));
  nand2  g364(.a(new_n377_), .b(new_n72_), .O(new_n416_));
  nand2  g365(.a(new_n416_), .b(new_n389_), .O(new_n417_));
  nand4  g366(.a(new_n417_), .b(x18), .c(new_n53_), .d(new_n54_), .O(new_n418_));
  nor2   g367(.a(new_n418_), .b(x05), .O(z25));
  aoi21  g368(.a(new_n66_), .b(new_n76_), .c(x20), .O(z26));
  nand3  g369(.a(x06), .b(new_n57_), .c(x02), .O(new_n421_));
  nor4   g370(.a(new_n421_), .b(x15), .c(x11), .d(x08), .O(new_n422_));
  oai21  g371(.a(new_n422_), .b(new_n275_), .c(new_n66_), .O(new_n423_));
  nand3  g372(.a(new_n130_), .b(new_n72_), .c(x05), .O(new_n424_));
  ...
  nand4  g384(.a(new_n435_), .b(new_n259_), .c(new_n159_), .d(new_n98_), .O(new_n436_));
  nand2  g385(.a(new_n436_), .b(new_n433_), .O(z27));
  nand4  g386(.a(new_n66_), .b(x11), .c(new_n105_), .d(new_n54_), .O(new_n438_));
  aoi21  g387(.a(new_n438_), .b(new_n105_), .c(x02), .O(new_n439_));
  nand2  g388(.a(new_n232_), .b(x11), .O(new_n440_));
  oai21  g389(.a(new_n440_), .b(new_n439_), .c(x15), .O(new_n441_));
  nand2  g390(.a(new_n88_), .b(new_n81_), .O(new_n442_));
  nand4  g391(.a(new_n442_), .b(new_n66_), .c(new_n55_), .d(new_n76_), .O(new_n443_));
  nor2   g392(.a(new_n443_), .b(new_n63_), .O(new_n444_));
  nand4  g393(.a(new_n444_), .b(x10), .c(new_n105_), .d(new_n54_), .O(new_n445_));
  aoi21  g394(.a(new_n445_), .b(new_n441_), .c(x05), .O(new_n446_));
  nor2   g395(.a(new_n134_), .b(x15), .O(new_n447_));
  nand4  g396(.a(new_n447_), .b(x12), .c(x05), .d(new_n62_), .O(new_n448_));
  nand3  g397(.a(x21), .b(x15), .c(new_n105_), .O(new_n449_));
  aoi21  g398(.a(new_n449_), .b(new_n448_), .c(x07), .O(new_n450_));
  oai21  g399(.a(new_n450_), .b(new_n446_), .c(x08), .O(new_n451_));
  nand4  g400(.a(new_n182_), .b(x21), .c(new_n55_), .d(new_n76_), .O(new_n452_));
  nand2  g401(.a(new_n129_), .b(x15), .O(new_n453_));
  aoi21  g402(.a(new_n453_), .b(new_n452_), .c(x09), .O(new_n454_));
  nand4  g403(.a(new_n454_), .b(new_n72_), .c(new_n54_), .d(new_n57_), .O(new_n455_));
  aoi21  g404(.a(new_n455_), .b(new_n451_), .c(new_n52_), .O(new_n456_));
  aoi21  g405(.a(x11), .b(x02), .c(x18), .O(new_n457_));
  nand4  g406(.a(new_n457_), .b(x15), .c(new_n105_), .d(x07), .O(new_n458_));
  ...
  nand4  g412(.a(new_n463_), .b(new_n52_), .c(x17), .d(new_n105_), .O(new_n464_));
