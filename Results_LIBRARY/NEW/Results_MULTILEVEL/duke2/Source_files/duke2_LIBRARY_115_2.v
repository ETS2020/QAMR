...
module FAU ( 
  ...
  nand4  g388(.a(new_n439_), .b(x06), .c(new_n57_), .d(x02), .O(new_n440_));
  aoi21  g389(.a(new_n440_), .b(new_n294_), .c(x21), .O(new_n441_));
  ...
  nand4  g393(.a(new_n149_), .b(x19), .c(x08), .d(x07), .O(new_n445_));
  ...
  nor2   g409(.a(new_n135_), .b(x15), .O(new_n461_));
  ...
  nand4  g414(.a(new_n202_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n466_));
  ...
  inv1   g423(.a(new_n334_), .O(new_n475_));
