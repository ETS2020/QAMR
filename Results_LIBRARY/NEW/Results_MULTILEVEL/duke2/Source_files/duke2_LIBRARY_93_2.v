...
module FAU ( 
  ...
  oai21  g285(.a(new_n172_), .b(x10), .c(new_n177_), .O(new_n337_));
  nand2  g286(.a(new_n337_), .b(x02), .O(new_n338_));
  oai22  g287(.a(x13), .b(new_n166_), .c(new_n89_), .d(x02), .O(new_n339_));
  ...
  nand3  g366(.a(new_n289_), .b(x18), .c(new_n63_), .O(new_n418_));
  ...
  nand4  g389(.a(new_n440_), .b(x06), .c(new_n57_), .d(x02), .O(new_n441_));
  aoi21  g390(.a(new_n441_), .b(new_n294_), .c(x21), .O(new_n442_));
  ...
  aoi21  g400(.a(new_n451_), .b(new_n448_), .c(x09), .O(z27));
  ...
  inv1   g424(.a(new_n334_), .O(new_n476_));
