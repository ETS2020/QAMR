...
module FAU ( 
  ...
  nor2   g49(.a(new_n45_), .b(new_n60_), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(new_n94_));
  inv1   g51(.a(x13), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(x12), .c(new_n68_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  nand3  g54(.a(new_n97_), .b(x02), .c(new_n60_), .O(new_n98_));
  ...
  oai21  g59(.a(new_n102_), .b(new_n98_), .c(new_n94_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n91_), .c(new_n59_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z09));
  inv1   g62(.a(x15), .O(new_n106_));
  inv1   g63(.a(x14), .O(new_n107_));
  nand4  g64(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n95_), .d(x12), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n91_), .c(x20), .d(x16), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(x22), .O(z10));
  nand4  g70(.a(new_n93_), .b(x21), .c(new_n92_), .d(new_n63_), .O(new_n114_));
  nand3  g71(.a(new_n99_), .b(x15), .c(new_n107_), .O(new_n115_));
  nor4   g72(.a(new_n115_), .b(x22), .c(x21), .d(new_n92_), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n97_), .c(x02), .d(new_n60_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n114_), .c(x00), .O(z11));
