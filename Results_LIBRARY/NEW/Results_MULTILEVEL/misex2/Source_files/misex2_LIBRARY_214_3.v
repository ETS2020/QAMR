...
module FAU ( 
  ...
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n93_), .d(new_n68_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g68(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n112_));
  nor2   g69(.a(new_n95_), .b(x13), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n91_), .c(x20), .d(new_n96_), .O(new_n114_));
