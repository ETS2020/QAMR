...
module FAU ( 
  ...
  nand4  g40(.a(new_n83_), .b(x04), .c(new_n82_), .d(x02), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(x06), .c(x05), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(new_n45_), .c(x17), .d(new_n81_), .O(new_n86_));
  ...
  nor2   g53(.a(new_n45_), .b(new_n60_), .O(new_n97_));
  nand3  g54(.a(new_n97_), .b(new_n96_), .c(new_n63_), .O(new_n98_));
  oai21  g55(.a(new_n95_), .b(new_n91_), .c(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n89_), .c(new_n88_), .d(new_n59_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nor3   g58(.a(new_n89_), .b(new_n88_), .c(x20), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n63_), .c(x18), .d(x01), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n68_), .O(new_n105_));
  ...
  nand4  g69(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n63_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n89_), .c(new_n59_), .O(new_n117_));
  ...
  nand2  g92(.a(new_n83_), .b(x02), .O(new_n136_));
