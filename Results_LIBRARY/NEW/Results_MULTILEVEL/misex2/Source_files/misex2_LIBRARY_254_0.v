// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:24 2020
...
module FAU ( 
  ...
  nand4  g24(.a(x10), .b(new_n46_), .c(x02), .d(x00), .O(new_n68_));
  nor3   g25(.a(new_n68_), .b(x12), .c(x11), .O(z04));
  nand4  g26(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(new_n56_), .O(z05));
  inv1   g28(.a(x11), .O(new_n72_));
  aoi21  g29(.a(x12), .b(new_n60_), .c(new_n72_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  ...
  nor2   g50(.a(x13), .b(x11), .O(new_n94_));
  ...
  nor3   g64(.a(x14), .b(x13), .c(x11), .O(new_n108_));
  nand3  g65(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n109_));
  nor3   g66(.a(new_n109_), .b(new_n98_), .c(new_n97_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n108_), .c(new_n93_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n107_), .c(x00), .O(z10));
  nand4  g69(.a(new_n101_), .b(x21), .c(new_n100_), .d(new_n63_), .O(new_n113_));
  nor2   g70(.a(new_n97_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n91_), .c(x20), .d(new_n98_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n95_), .c(new_n113_), .O(new_n116_));
