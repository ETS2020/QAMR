...
module FAU ( 
  ...
  nand2  g57(.a(new_n100_), .b(new_n63_), .O(new_n101_));
  ...
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n108_));
  nor3   g65(.a(new_n108_), .b(new_n95_), .c(x14), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n93_), .d(new_n68_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand3  g68(.a(x21), .b(new_n100_), .c(new_n63_), .O(new_n112_));
  nand4  g69(.a(new_n97_), .b(new_n91_), .c(new_n96_), .d(x15), .O(new_n113_));
  oai22  g70(.a(new_n113_), .b(new_n94_), .c(new_n112_), .d(new_n99_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n92_), .c(new_n59_), .O(new_n115_));
