// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:17 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n125_, new_n127_, new_n129_, new_n130_, new_n132_;
  ...
  nor2   g67(.a(x14), .b(x13), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n92_), .c(x20), .d(new_n103_), .O(new_n112_));
  oai22  g69(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n93_), .c(new_n59_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n60_), .c(new_n59_), .O(new_n121_));
  ...
  nand4  g83(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z14));
  aoi21  g85(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n129_));
  nand3  g86(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n59_), .c(new_n130_), .O(z15));
