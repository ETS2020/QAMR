...
module FAU ( 
  ...
  nor2   g55(.a(x21), .b(x20), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n81_), .c(x18), .d(x01), .O(new_n100_));
  oai21  g57(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n92_), .c(new_n59_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  inv1   g60(.a(x20), .O(new_n104_));
  nand4  g61(.a(new_n63_), .b(x22), .c(x21), .d(new_n104_), .O(new_n105_));
  nor2   g62(.a(x13), .b(new_n76_), .O(new_n106_));
  nand3  g63(.a(new_n92_), .b(x20), .c(x16), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n95_), .c(x14), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n106_), .c(new_n93_), .d(new_n68_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x00), .O(z10));
  nand4  g67(.a(new_n97_), .b(x20), .c(new_n96_), .d(x15), .O(new_n111_));
  nand3  g68(.a(new_n63_), .b(x21), .c(new_n104_), .O(new_n112_));
  oai21  g69(.a(new_n111_), .b(new_n94_), .c(new_n112_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n92_), .c(new_n59_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n81_), .b(x17), .c(new_n61_), .O(new_n119_));
