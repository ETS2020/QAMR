...
module FAU ( 
  ...
  nand3  g24(.a(x02), .b(x01), .c(x00), .O(new_n69_));
  nor3   g25(.a(new_n69_), .b(new_n56_), .c(new_n46_), .O(z05));
  inv1   g26(.a(new_n69_), .O(new_n71_));
  nand4  g27(.a(new_n71_), .b(x11), .c(x10), .d(new_n46_), .O(new_n72_));
  inv1   g28(.a(new_n72_), .O(z06));
  nand3  g29(.a(x02), .b(new_n60_), .c(x00), .O(new_n74_));
  ...
  nand4  g35(.a(new_n79_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n80_));
  ...
  nand4  g39(.a(new_n83_), .b(new_n45_), .c(x17), .d(new_n76_), .O(new_n84_));
  nor2   g40(.a(new_n84_), .b(new_n63_), .O(z08));
  ...
  nand4  g54(.a(new_n98_), .b(new_n87_), .c(new_n86_), .d(new_n59_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(z09));
  nor3   g56(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n63_), .c(x18), .d(x01), .O(new_n102_));
  inv1   g58(.a(x13), .O(new_n103_));
  nand4  g59(.a(new_n89_), .b(new_n103_), .c(x12), .d(new_n88_), .O(new_n104_));
  nor3   g60(.a(new_n92_), .b(new_n91_), .c(x14), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n87_), .c(new_n86_), .d(x20), .O(new_n106_));
  ...
  nand4  g66(.a(new_n110_), .b(new_n86_), .c(x20), .d(new_n92_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n104_), .c(new_n109_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n87_), .c(new_n59_), .O(new_n113_));
  ...
  nand3  g87(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n132_));
  inv1   g88(.a(new_n132_), .O(z17));
  zero   g89(.O(z04));
endmodule
