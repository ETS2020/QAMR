...
module FAU ( 
  ...
  nand4  g51(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n95_));
  ...
  nand3  g66(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n60_), .c(new_n59_), .O(new_n112_));
  ...
  nor2   g79(.a(new_n60_), .b(x00), .O(z16));
  nand3  g80(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n124_));
