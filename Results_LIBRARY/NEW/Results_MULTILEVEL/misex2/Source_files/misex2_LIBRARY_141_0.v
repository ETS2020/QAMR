// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:04 2020
...
module FAU ( 
  ...
  nand4  g43(.a(new_n86_), .b(new_n45_), .c(new_n82_), .d(new_n81_), .O(new_n87_));
  nor2   g44(.a(new_n87_), .b(new_n63_), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nor2   g47(.a(new_n61_), .b(x01), .O(new_n91_));
  ...
  nor2   g54(.a(new_n45_), .b(new_n60_), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n63_), .O(new_n99_));
  oai21  g56(.a(new_n96_), .b(new_n92_), .c(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n90_), .c(new_n89_), .d(new_n59_), .O(new_n101_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n90_), .c(new_n59_), .O(new_n118_));
  ...
  nand3  g81(.a(new_n124_), .b(new_n60_), .c(new_n59_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n121_), .c(x24), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(x09), .O(new_n127_));
  inv1   g84(.a(new_n127_), .O(z12));
  nand2  g85(.a(new_n47_), .b(x17), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(x19), .O(z13));
  nand4  g87(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  aoi21  g89(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n133_));
  nand3  g90(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n59_), .c(new_n134_), .O(z15));
  nor2   g92(.a(new_n60_), .b(x00), .O(z16));
