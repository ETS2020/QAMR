...
module FAU ( 
  ...
  oai21  g75(.a(x24), .b(x10), .c(x02), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(x01), .c(x00), .O(new_n120_));
  nand2  g77(.a(x23), .b(x19), .O(new_n121_));
  oai21  g78(.a(x19), .b(new_n44_), .c(new_n121_), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(new_n61_), .O(new_n123_));
  inv1   g80(.a(x24), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(x23), .c(x02), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g83(.a(new_n126_), .b(new_n60_), .c(new_n59_), .O(new_n127_));
  aoi21  g84(.a(new_n127_), .b(new_n120_), .c(new_n46_), .O(z12));
