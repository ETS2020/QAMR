...
module FAU ( 
  ...
  nor4   g12(.a(new_n52_), .b(x18), .c(x17), .d(x10), .O(z02));
  inv1   g13(.a(x00), .O(new_n57_));
  inv1   g14(.a(x01), .O(new_n58_));
  inv1   g15(.a(x02), .O(new_n59_));
  nand3  g16(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  ...
  nor3   g30(.a(new_n73_), .b(new_n58_), .c(new_n57_), .O(z06));
  ...
  nand4  g40(.a(new_n83_), .b(x02), .c(new_n58_), .d(new_n57_), .O(new_n84_));
  ...
  nor2   g48(.a(new_n59_), .b(x01), .O(new_n92_));
  ...
  nor2   g55(.a(new_n45_), .b(new_n58_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n61_), .O(new_n100_));
  oai21  g57(.a(new_n97_), .b(new_n93_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n91_), .c(new_n90_), .d(new_n57_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nor3   g60(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n61_), .c(x18), .d(x01), .O(new_n105_));
  nor2   g62(.a(x13), .b(new_n75_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n92_), .c(new_n66_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n61_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n91_), .c(new_n57_), .O(new_n116_));
  ...
  nand3  g77(.a(new_n61_), .b(x17), .c(new_n59_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n58_), .c(new_n57_), .O(new_n123_));
  ...
  nor4   g85(.a(new_n48_), .b(x18), .c(x17), .d(x10), .O(z14));
  aoi21  g86(.a(new_n71_), .b(x01), .c(new_n59_), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n59_), .c(new_n58_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n57_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n58_), .b(x00), .O(z16));
  nand3  g90(.a(x02), .b(new_n58_), .c(new_n57_), .O(new_n134_));
