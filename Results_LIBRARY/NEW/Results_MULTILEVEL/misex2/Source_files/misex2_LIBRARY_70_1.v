...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(x02), .c(x00), .O(new_n65_));
  ...
  aoi21  g31(.a(new_n74_), .b(new_n60_), .c(new_n68_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x10), .c(new_n46_), .d(x02), .O(new_n76_));
  nor2   g33(.a(new_n76_), .b(new_n59_), .O(z06));
  nand3  g34(.a(new_n74_), .b(x11), .c(x10), .O(new_n78_));
  ...
  nor3   g55(.a(new_n95_), .b(new_n92_), .c(x20), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(x22), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z10));
  nand2  g58(.a(new_n99_), .b(new_n93_), .O(new_n102_));
  ...
  nand3  g63(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n60_), .c(new_n59_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x24), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(x09), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(z12));
  nand2  g69(.a(new_n47_), .b(x17), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z13));
  nand4  g71(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z14));
  aoi21  g73(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n117_));
  nand3  g74(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n59_), .c(new_n118_), .O(z15));
  nand3  g76(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n120_));
