...
module FAU ( 
  ...
  nand3  g20(.a(new_n63_), .b(x18), .c(new_n62_), .O(new_n64_));
  nand3  g21(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  nand4  g22(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n66_));
  oai22  g23(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n49_), .O(z03));
  ...
  nor3   g29(.a(new_n69_), .b(new_n59_), .c(new_n46_), .O(z05));
  nand4  g30(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n48_), .c(new_n47_), .O(z06));
  ...
  nor3   g42(.a(new_n85_), .b(x06), .c(x05), .O(new_n86_));
  nand4  g43(.a(new_n86_), .b(x17), .c(new_n82_), .d(new_n81_), .O(new_n87_));
  nor2   g44(.a(new_n87_), .b(new_n63_), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nor2   g47(.a(new_n62_), .b(x01), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(x12), .c(new_n68_), .O(new_n92_));
  ...
  nor2   g54(.a(new_n45_), .b(new_n48_), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n63_), .O(new_n99_));
  oai21  g56(.a(new_n96_), .b(new_n92_), .c(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n90_), .c(new_n89_), .d(new_n47_), .O(new_n101_));
  ...
  nand2  g69(.a(new_n107_), .b(new_n91_), .O(new_n113_));
  nand4  g70(.a(new_n98_), .b(x21), .c(new_n97_), .d(new_n63_), .O(new_n114_));
  nor2   g71(.a(new_n93_), .b(x14), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n89_), .c(x20), .d(new_n94_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n113_), .c(new_n114_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n90_), .c(new_n47_), .O(new_n118_));
  ...
  nand3  g79(.a(new_n63_), .b(x17), .c(new_n62_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n48_), .c(new_n47_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n52_), .b(new_n45_), .c(new_n44_), .d(new_n59_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  aoi21  g89(.a(new_n59_), .b(x01), .c(new_n62_), .O(new_n133_));
  nand3  g90(.a(x19), .b(new_n62_), .c(new_n48_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n47_), .c(new_n134_), .O(z15));
  nor2   g92(.a(new_n48_), .b(x00), .O(z16));
  nand2  g93(.a(new_n84_), .b(x02), .O(new_n137_));
