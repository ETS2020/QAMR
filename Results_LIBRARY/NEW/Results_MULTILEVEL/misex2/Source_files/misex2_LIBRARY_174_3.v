// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:10 2020
...
module FAU ( 
  ...
  nand2  g17(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  ...
  nor3   g31(.a(new_n74_), .b(new_n73_), .c(new_n59_), .O(z06));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n73_), .d(new_n59_), .O(new_n85_));
  ...
  nand4  g51(.a(new_n67_), .b(x02), .c(new_n73_), .d(new_n59_), .O(new_n95_));
  ...
  nand3  g66(.a(new_n62_), .b(x17), .c(new_n60_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n73_), .c(new_n59_), .O(new_n112_));
  ...
  aoi21  g76(.a(new_n56_), .b(x01), .c(new_n60_), .O(new_n120_));
  nand3  g77(.a(x19), .b(new_n60_), .c(new_n73_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n59_), .c(new_n121_), .O(z15));
  nor2   g79(.a(new_n73_), .b(x00), .O(z16));
  nand3  g80(.a(x02), .b(new_n73_), .c(new_n59_), .O(new_n124_));
