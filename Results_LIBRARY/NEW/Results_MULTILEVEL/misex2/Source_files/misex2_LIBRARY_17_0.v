...
module FAU ( 
  ...
  nand4  g47(.a(new_n90_), .b(new_n63_), .c(x18), .d(new_n59_), .O(new_n91_));
  nor3   g48(.a(new_n91_), .b(x22), .c(x21), .O(z09));
  ...
  nor3   g55(.a(new_n91_), .b(x22), .c(new_n98_), .O(z11));
  nand2  g56(.a(x10), .b(x02), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(x01), .c(x00), .O(new_n101_));
  oai21  g58(.a(x19), .b(x02), .c(x23), .O(new_n102_));
  nand3  g59(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n103_));
  nand2  g60(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n60_), .c(new_n59_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n101_), .c(x24), .O(new_n106_));
  nand2  g63(.a(new_n106_), .b(x09), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(z12));
  nand2  g65(.a(new_n47_), .b(x17), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(x19), .O(z13));
  nand4  g67(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(x19), .O(z14));
  aoi21  g69(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n113_));
  nand3  g70(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n114_));
  oai21  g71(.a(new_n113_), .b(new_n59_), .c(new_n114_), .O(z15));
  nand3  g72(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n116_));
