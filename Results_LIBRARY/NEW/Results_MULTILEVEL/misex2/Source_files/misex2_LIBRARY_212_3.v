...
module FAU ( 
  ...
  nand3  g62(.a(new_n105_), .b(new_n93_), .c(new_n68_), .O(new_n106_));
  nor2   g63(.a(new_n95_), .b(x14), .O(new_n107_));
  nor2   g64(.a(x21), .b(new_n99_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n107_), .c(x16), .O(new_n109_));
  or2    g66(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nor3   g67(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n63_), .c(x18), .d(x01), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n110_), .c(x00), .O(z10));
  nand4  g70(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n114_));
  nand3  g71(.a(new_n108_), .b(new_n107_), .c(new_n96_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n106_), .c(new_n114_), .O(new_n116_));
