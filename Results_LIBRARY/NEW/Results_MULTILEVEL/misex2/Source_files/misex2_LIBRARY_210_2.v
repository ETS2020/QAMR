// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:16 2020
...
module FAU ( 
  ...
  nand3  g63(.a(new_n95_), .b(x12), .c(new_n68_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nor3   g65(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n109_));
  nand3  g66(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n109_), .c(new_n108_), .d(new_n93_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g70(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n114_));
  nor2   g71(.a(new_n96_), .b(x13), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n91_), .c(x20), .d(new_n97_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n94_), .c(new_n114_), .O(new_n117_));
