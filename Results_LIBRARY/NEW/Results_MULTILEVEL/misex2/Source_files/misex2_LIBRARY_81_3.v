...
module FAU ( 
  ...
  aoi21  g31(.a(new_n74_), .b(x09), .c(new_n68_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(x10), .c(x02), .d(x01), .O(new_n76_));
  ...
  nor2   g64(.a(x13), .b(new_n74_), .O(new_n108_));
  ...
  nand3  g74(.a(new_n117_), .b(new_n93_), .c(new_n59_), .O(new_n118_));
