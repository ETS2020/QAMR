...
module FAU ( 
  ...
  nand2  g79(.a(x23), .b(x19), .O(new_n123_));
  ...
  nand2  g83(.a(new_n126_), .b(new_n119_), .O(new_n127_));
  nor2   g84(.a(x01), .b(x00), .O(new_n128_));
  nand3  g85(.a(new_n128_), .b(x23), .c(x02), .O(new_n129_));
  aoi21  g86(.a(new_n129_), .b(new_n127_), .c(new_n46_), .O(z12));
  nand2  g87(.a(new_n47_), .b(x17), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z13));
  nand4  g89(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n133_));
  nor2   g90(.a(new_n133_), .b(x19), .O(z14));
  aoi21  g91(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n135_));
  nand3  g92(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n136_));
  oai21  g93(.a(new_n135_), .b(new_n59_), .c(new_n136_), .O(z15));
  nor2   g94(.a(new_n60_), .b(x00), .O(z16));
  nand2  g95(.a(new_n128_), .b(x02), .O(new_n139_));
