...
module FAU ( 
  ...
  nor2   g63(.a(x11), .b(new_n61_), .O(new_n107_));
  nand3  g64(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n108_));
  nor3   g65(.a(new_n108_), .b(new_n96_), .c(new_n95_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n97_), .d(x12), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g68(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n112_));
  nor2   g69(.a(x13), .b(new_n76_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n93_), .c(new_n68_), .O(new_n114_));
  nor2   g71(.a(new_n95_), .b(x14), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n91_), .c(x20), .d(new_n96_), .O(new_n116_));
  oai21  g73(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n92_), .c(new_n59_), .O(new_n118_));
  ...
  nand3  g93(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n137_));
