...
module FAU ( 
  ...
  nand3  g49(.a(z16), .b(new_n63_), .c(x18), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(x20), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n91_), .c(new_n90_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(z09));
  nor3   g53(.a(new_n93_), .b(new_n90_), .c(x20), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(x22), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(z10));
  nand2  g56(.a(new_n97_), .b(new_n91_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z11));
  nand2  g58(.a(x10), .b(x02), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x01), .c(x00), .O(new_n103_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n104_));
  nand3  g61(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n60_), .c(new_n59_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n103_), .c(x24), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(x09), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(z12));
  nand2  g67(.a(new_n47_), .b(x17), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(x19), .O(z13));
  nand4  g69(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n113_));
  nor2   g70(.a(new_n113_), .b(x19), .O(z14));
  aoi21  g71(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n115_));
  nand3  g72(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n116_));
  oai21  g73(.a(new_n115_), .b(new_n59_), .c(new_n116_), .O(z15));
  nand3  g74(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n118_));
