// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:13 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n123_, new_n125_, new_n127_, new_n129_, new_n130_, new_n133_;
  ...
  nand4  g16(.a(x12), .b(x11), .c(x10), .d(new_n59_), .O(new_n60_));
  oai22  g17(.a(new_n60_), .b(new_n58_), .c(new_n57_), .d(new_n47_), .O(z03));
  inv1   g18(.a(x11), .O(new_n62_));
  nand3  g19(.a(x02), .b(x01), .c(x00), .O(new_n63_));
  inv1   g20(.a(new_n63_), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(new_n62_), .c(x10), .d(new_n59_), .O(new_n65_));
  nor2   g22(.a(new_n65_), .b(x12), .O(z04));
  nor3   g23(.a(new_n63_), .b(new_n53_), .c(new_n59_), .O(z05));
  inv1   g24(.a(x00), .O(new_n68_));
  inv1   g25(.a(x01), .O(new_n69_));
  nand4  g26(.a(x11), .b(x10), .c(new_n59_), .d(x02), .O(new_n70_));
  nor3   g27(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z06));
  ...
  nand4  g37(.a(new_n80_), .b(x02), .c(new_n69_), .d(new_n68_), .O(new_n81_));
  inv1   g38(.a(new_n81_), .O(new_n82_));
  nand4  g39(.a(new_n82_), .b(new_n79_), .c(new_n78_), .d(x04), .O(new_n83_));
  nor2   g40(.a(new_n83_), .b(x07), .O(new_n84_));
  nand4  g41(.a(new_n84_), .b(new_n45_), .c(x17), .d(new_n77_), .O(new_n85_));
  ...
  nand3  g47(.a(new_n90_), .b(x12), .c(new_n62_), .O(new_n91_));
  ...
  nor2   g53(.a(new_n45_), .b(new_n69_), .O(new_n97_));
  nand3  g54(.a(new_n97_), .b(new_n96_), .c(new_n56_), .O(new_n98_));
  oai21  g55(.a(new_n95_), .b(new_n91_), .c(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n88_), .c(new_n87_), .d(new_n68_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nor3   g58(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n56_), .c(x18), .d(x01), .O(new_n103_));
  nor2   g60(.a(x13), .b(new_n72_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n90_), .c(new_n62_), .O(new_n105_));
  nor3   g62(.a(new_n93_), .b(new_n92_), .c(x14), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n88_), .c(new_n87_), .d(x20), .O(new_n107_));
  or2    g64(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n103_), .c(x00), .O(z10));
  nand4  g66(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n56_), .O(new_n110_));
  nor2   g67(.a(new_n92_), .b(x14), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n87_), .c(x20), .d(new_n93_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n105_), .c(new_n110_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n88_), .c(new_n68_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n56_), .b(x17), .c(new_n89_), .O(new_n119_));
  ...
  nand4  g81(.a(x17), .b(new_n89_), .c(new_n69_), .d(new_n68_), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z13));
  nand4  g83(.a(new_n48_), .b(new_n45_), .c(new_n44_), .d(new_n53_), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z14));
  aoi21  g85(.a(new_n53_), .b(x01), .c(new_n89_), .O(new_n129_));
  nand3  g86(.a(x19), .b(new_n89_), .c(new_n69_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n68_), .c(new_n130_), .O(z15));
  nor2   g88(.a(new_n69_), .b(x00), .O(z16));
  nand3  g89(.a(x02), .b(new_n69_), .c(new_n68_), .O(new_n133_));
