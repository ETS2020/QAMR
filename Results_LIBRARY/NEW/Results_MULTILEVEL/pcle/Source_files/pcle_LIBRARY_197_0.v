// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:25 2020
...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(x17), .c(x16), .d(x14), .O(new_n36_));
  ...
  nand3  g44(.a(x16), .b(x14), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n46_), .c(x17), .O(new_n74_));
  inv1   g46(.a(x17), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x16), .c(x14), .O(new_n76_));
  ...
  nand4  g54(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n53_), .c(new_n82_), .O(new_n84_));
