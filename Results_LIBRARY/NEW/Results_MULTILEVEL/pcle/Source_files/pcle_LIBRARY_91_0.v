...
module FAU ( 
  ...
  nand3  g28(.a(x14), .b(x12), .c(x11), .O(new_n57_));
  ...
  oai21  g37(.a(new_n65_), .b(new_n50_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x15), .c(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n50_), .c(new_n66_), .O(new_n69_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n50_), .c(x17), .O(new_n74_));
