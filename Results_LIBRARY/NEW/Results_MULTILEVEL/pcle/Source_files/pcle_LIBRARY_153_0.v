...
module FAU ( 
  ...
  nor2   g52(.a(new_n56_), .b(new_n48_), .O(new_n81_));
  nor2   g53(.a(x17), .b(new_n72_), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(new_n81_), .c(x15), .d(x12), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(new_n80_), .c(x11), .O(new_n84_));
