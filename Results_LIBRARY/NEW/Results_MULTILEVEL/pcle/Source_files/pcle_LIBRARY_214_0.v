...
module FAU ( 
  ...
  nand3  g45(.a(new_n40_), .b(x15), .c(x14), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(x13), .c(new_n45_), .O(new_n75_));
  nor2   g47(.a(new_n40_), .b(x12), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n75_), .c(x11), .O(new_n77_));
  nor2   g49(.a(new_n66_), .b(new_n60_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x11), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(x16), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  ...
  nor2   g58(.a(x17), .b(new_n40_), .O(new_n87_));
  ...
  nand3  g64(.a(new_n78_), .b(x17), .c(x16), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n57_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n40_), .b(new_n66_), .O(new_n95_));
