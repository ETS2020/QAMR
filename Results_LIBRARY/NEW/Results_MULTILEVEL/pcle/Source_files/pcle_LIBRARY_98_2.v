...
module FAU ( 
  ...
  nand3  g14(.a(x12), .b(new_n38_), .c(new_n31_), .O(new_n43_));
  oai21  g15(.a(x12), .b(new_n38_), .c(new_n43_), .O(new_n44_));
  ...
  nor2   g23(.a(new_n49_), .b(x12), .O(new_n52_));
  ...
  nand2  g27(.a(x13), .b(x11), .O(new_n56_));
  ...
  nor2   g32(.a(new_n58_), .b(x12), .O(new_n61_));
  ...
  inv1   g43(.a(x12), .O(new_n72_));
  nand2  g44(.a(x15), .b(new_n72_), .O(new_n73_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n56_), .c(x16), .O(new_n79_));
  ...
  nor2   g68(.a(new_n92_), .b(x12), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n96_), .c(x09), .O(new_n98_));
  nand2  g70(.a(x08), .b(x06), .O(new_n99_));
  oai21  g71(.a(new_n98_), .b(x08), .c(new_n99_), .O(z7));
  nand3  g72(.a(x17), .b(x16), .c(x15), .O(new_n101_));
  oai21  g73(.a(new_n101_), .b(new_n66_), .c(x18), .O(new_n102_));
  nor2   g74(.a(new_n81_), .b(new_n68_), .O(new_n103_));
  ...
  aoi21  g79(.a(new_n107_), .b(new_n102_), .c(x10), .O(new_n108_));
  nor2   g80(.a(new_n29_), .b(x12), .O(new_n109_));
  oai21  g81(.a(new_n109_), .b(new_n108_), .c(x09), .O(new_n110_));
  nand2  g82(.a(x08), .b(x07), .O(new_n111_));
  oai21  g83(.a(new_n110_), .b(x08), .c(new_n111_), .O(z8));
endmodule
