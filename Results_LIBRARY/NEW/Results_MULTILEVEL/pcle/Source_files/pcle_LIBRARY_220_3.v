// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:29 2020
...
module FAU ( 
  ...
  nand2  g34(.a(new_n62_), .b(new_n38_), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n47_), .c(new_n61_), .O(new_n64_));
  nand3  g36(.a(new_n61_), .b(x14), .c(x13), .O(new_n65_));
  nor2   g37(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n64_), .c(x09), .O(new_n67_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n30_), .c(new_n38_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n47_), .c(new_n70_), .O(new_n73_));
  nand3  g45(.a(x13), .b(x12), .c(x11), .O(new_n74_));
  nand3  g46(.a(new_n70_), .b(x15), .c(x14), .O(new_n75_));
  nor2   g47(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n73_), .c(x09), .O(new_n77_));
  nand2  g49(.a(x08), .b(x05), .O(new_n78_));
  oai21  g50(.a(new_n77_), .b(x08), .c(new_n78_), .O(z6));
  inv1   g51(.a(x17), .O(new_n80_));
  nand4  g52(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n81_));
  aoi22  g53(.a(new_n81_), .b(new_n38_), .c(new_n46_), .d(x13), .O(new_n82_));
  nand4  g54(.a(new_n80_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  oai22  g55(.a(new_n83_), .b(new_n74_), .c(new_n82_), .d(new_n80_), .O(new_n84_));
  nand3  g56(.a(new_n84_), .b(x09), .c(new_n32_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(z7));
  nand3  g59(.a(x17), .b(x16), .c(x15), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n62_), .c(new_n38_), .O(new_n89_));
  aoi21  g61(.a(new_n89_), .b(new_n47_), .c(new_n29_), .O(new_n90_));
  ...
  oai21  g65(.a(new_n93_), .b(new_n90_), .c(x09), .O(new_n94_));
