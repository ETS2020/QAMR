...
module FAU ( 
  ...
  nand2  g39(.a(x13), .b(x11), .O(new_n68_));
  nand2  g40(.a(x15), .b(x14), .O(new_n69_));
  oai21  g41(.a(new_n69_), .b(new_n68_), .c(x16), .O(new_n70_));
  ...
  oai21  g49(.a(new_n77_), .b(new_n68_), .c(x17), .O(new_n78_));
  ...
  oai21  g58(.a(new_n86_), .b(new_n79_), .c(x18), .O(new_n87_));
  nand4  g59(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n79_), .c(new_n87_), .O(new_n89_));
