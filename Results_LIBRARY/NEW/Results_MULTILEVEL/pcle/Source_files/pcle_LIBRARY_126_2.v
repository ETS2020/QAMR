// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:13 2020
...
module FAU ( 
  ...
  oai21  g24(.a(new_n31_), .b(new_n39_), .c(x12), .O(new_n53_));
  nand2  g25(.a(x14), .b(new_n30_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand4  g27(.a(new_n55_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n56_));
  ...
  oai21  g34(.a(new_n62_), .b(new_n46_), .c(new_n60_), .O(new_n63_));
  ...
  nand2  g38(.a(x15), .b(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n46_), .c(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  nand3  g41(.a(new_n69_), .b(x15), .c(x13), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n46_), .c(new_n68_), .O(new_n71_));
  ...
  nand3  g46(.a(x16), .b(x15), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n46_), .c(x17), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x16), .c(x15), .O(new_n78_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n59_), .c(x18), .O(new_n84_));
  nand4  g56(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n85_));
