// Benchmark "FAU" written by ABC on Mon Jul 27 18:13:53 2020
...
module FAU ( 
  ...
  aoi21  g09(.a(x17), .b(x10), .c(x11), .O(new_n38_));
  ...
  oai22  g53(.a(new_n81_), .b(new_n54_), .c(new_n79_), .d(x10), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(x09), .c(new_n30_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x06), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n83_), .O(z7));
  oai21  g57(.a(new_n78_), .b(new_n54_), .c(x18), .O(new_n86_));
  nor2   g58(.a(new_n72_), .b(new_n62_), .O(new_n87_));
  ...
  nor2   g62(.a(new_n29_), .b(x17), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n90_), .c(x09), .O(new_n92_));
  nand2  g64(.a(x08), .b(x07), .O(new_n93_));
  oai21  g65(.a(new_n92_), .b(x08), .c(new_n93_), .O(z8));
endmodule
