...
module FAU ( 
  ...
  nand2  g09(.a(x15), .b(x11), .O(new_n38_));
  ...
  oai21  g35(.a(new_n61_), .b(x11), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g43(.a(new_n71_), .b(new_n46_), .c(new_n69_), .O(new_n72_));
  ...
  nand3  g47(.a(x16), .b(x14), .c(x13), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n46_), .c(x17), .O(new_n77_));
  inv1   g49(.a(x17), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(x16), .c(x14), .O(new_n79_));
  ...
  nand4  g57(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n86_));
