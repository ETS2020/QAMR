...
module FAU ( 
  ...
  oai22  g37(.a(new_n65_), .b(new_n46_), .c(new_n64_), .d(new_n62_), .O(new_n66_));
  ...
  oai21  g42(.a(new_n70_), .b(new_n46_), .c(x16), .O(new_n71_));
  inv1   g43(.a(x16), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(x15), .c(x14), .O(new_n73_));
  oai22  g45(.a(new_n73_), .b(new_n55_), .c(new_n71_), .d(x08), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(new_n31_), .c(x09), .O(new_n75_));
  nand2  g47(.a(x08), .b(x05), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  inv1   g49(.a(x09), .O(new_n78_));
  oai21  g50(.a(new_n70_), .b(new_n46_), .c(x17), .O(new_n79_));
  inv1   g51(.a(x17), .O(new_n80_));
  and2   g52(.a(x15), .b(x14), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n56_), .c(new_n80_), .d(x16), .O(new_n82_));
  aoi21  g54(.a(new_n82_), .b(new_n79_), .c(x08), .O(new_n83_));
  nor2   g55(.a(new_n80_), .b(x16), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n83_), .c(new_n31_), .O(new_n85_));
  nand2  g57(.a(x08), .b(x06), .O(new_n86_));
  oai21  g58(.a(new_n85_), .b(new_n78_), .c(new_n86_), .O(z7));
  nand3  g59(.a(x17), .b(x15), .c(x14), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n55_), .c(x18), .O(new_n89_));
  nor2   g61(.a(new_n72_), .b(new_n62_), .O(new_n90_));
  nor2   g62(.a(x18), .b(new_n80_), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n90_), .c(new_n64_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n89_), .c(x08), .O(new_n93_));
  nor2   g65(.a(new_n29_), .b(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n93_), .c(new_n31_), .O(new_n95_));
  nand2  g67(.a(x08), .b(x07), .O(new_n96_));
  oai21  g68(.a(new_n95_), .b(new_n78_), .c(new_n96_), .O(z8));
endmodule
