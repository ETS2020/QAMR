...
module FAU ( 
  ...
  oai21  g24(.a(new_n53_), .b(new_n42_), .c(new_n51_), .O(new_n54_));
  ...
  oai21  g29(.a(new_n58_), .b(new_n42_), .c(x15), .O(new_n59_));
  inv1   g30(.a(x15), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x14), .c(x13), .O(new_n61_));
  oai21  g32(.a(new_n61_), .b(new_n42_), .c(new_n59_), .O(new_n62_));
  ...
  oai21  g37(.a(new_n66_), .b(new_n42_), .c(x16), .O(new_n67_));
  ...
  nand3  g45(.a(new_n32_), .b(x11), .c(new_n37_), .O(new_n75_));
  nor2   g46(.a(new_n68_), .b(new_n60_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(x14), .c(x13), .d(x12), .O(new_n77_));
  oai21  g48(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z7));
  nand2  g49(.a(x08), .b(x07), .O(new_n79_));
  nand3  g50(.a(new_n32_), .b(x18), .c(new_n37_), .O(new_n80_));
  nand2  g51(.a(new_n80_), .b(new_n79_), .O(z8));
  zero   g52(.O(z0));
endmodule
