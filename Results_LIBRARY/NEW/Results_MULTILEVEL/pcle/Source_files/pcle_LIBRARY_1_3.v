...
module FAU ( 
  ...
  nand4  g14(.a(new_n43_), .b(new_n33_), .c(x09), .d(new_n31_), .O(new_n44_));
  nand2  g15(.a(x08), .b(x02), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(new_n44_), .O(z3));
  nand2  g17(.a(x08), .b(x03), .O(new_n47_));
  nand2  g18(.a(x14), .b(new_n33_), .O(new_n48_));
  oai21  g19(.a(new_n48_), .b(new_n32_), .c(new_n47_), .O(z4));
  nand2  g20(.a(x08), .b(x04), .O(new_n50_));
  nand2  g21(.a(x15), .b(new_n33_), .O(new_n51_));
  oai21  g22(.a(new_n51_), .b(new_n32_), .c(new_n50_), .O(z5));
  nand2  g23(.a(x08), .b(x05), .O(new_n53_));
  nand2  g24(.a(x16), .b(new_n33_), .O(new_n54_));
  oai21  g25(.a(new_n54_), .b(new_n32_), .c(new_n53_), .O(z6));
  nand2  g26(.a(x08), .b(x06), .O(new_n56_));
  nand2  g27(.a(x17), .b(new_n33_), .O(new_n57_));
  oai21  g28(.a(new_n57_), .b(new_n32_), .c(new_n56_), .O(z7));
  nand2  g29(.a(x08), .b(x07), .O(new_n59_));
  nand2  g30(.a(x18), .b(new_n33_), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n32_), .c(new_n59_), .O(z8));
  zero   g32(.O(z0));
endmodule
