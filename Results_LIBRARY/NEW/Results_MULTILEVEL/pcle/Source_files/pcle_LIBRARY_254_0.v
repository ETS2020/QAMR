...
module FAU ( 
  ...
  nand2  g11(.a(x12), .b(new_n39_), .O(new_n40_));
  nand4  g12(.a(new_n40_), .b(new_n38_), .c(new_n31_), .d(new_n30_), .O(new_n41_));
  nand2  g13(.a(x08), .b(x00), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n41_), .O(z1));
  nand3  g15(.a(x12), .b(new_n38_), .c(x09), .O(new_n44_));
  oai21  g16(.a(x12), .b(new_n38_), .c(new_n44_), .O(new_n45_));
  ...
  nand2  g20(.a(x13), .b(new_n38_), .O(new_n49_));
  inv1   g21(.a(x13), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(x12), .c(x11), .O(new_n51_));
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n39_), .O(new_n52_));
  ...
  oai21  g36(.a(new_n63_), .b(x08), .c(new_n64_), .O(z4));
  ...
  inv1   g44(.a(x12), .O(new_n73_));
  nand2  g45(.a(x15), .b(new_n73_), .O(new_n74_));
  ...
  nand2  g49(.a(new_n77_), .b(new_n76_), .O(z5));
  nand2  g50(.a(x15), .b(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n57_), .c(x16), .O(new_n80_));
  ...
  nand2  g56(.a(new_n84_), .b(x09), .O(new_n85_));
  nand2  g57(.a(x16), .b(new_n73_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n31_), .c(new_n30_), .O(new_n88_));
  nand2  g60(.a(x08), .b(x05), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n88_), .O(z6));
  nand3  g62(.a(x16), .b(x15), .c(x14), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n57_), .c(x17), .O(new_n92_));
  inv1   g64(.a(x17), .O(new_n93_));
  inv1   g65(.a(new_n79_), .O(new_n94_));
  inv1   g66(.a(new_n81_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(x16), .O(new_n96_));
  aoi21  g68(.a(new_n96_), .b(new_n92_), .c(new_n39_), .O(new_n97_));
  nor2   g69(.a(new_n93_), .b(x12), .O(new_n98_));
  oai21  g70(.a(new_n98_), .b(new_n97_), .c(new_n31_), .O(new_n99_));
  nand2  g71(.a(x08), .b(x06), .O(new_n100_));
  oai21  g72(.a(new_n99_), .b(x08), .c(new_n100_), .O(z7));
  nand3  g73(.a(x17), .b(x16), .c(x15), .O(new_n102_));
  oai21  g74(.a(new_n102_), .b(new_n67_), .c(x18), .O(new_n103_));
  nor2   g75(.a(new_n82_), .b(new_n69_), .O(new_n104_));
  nand4  g76(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n105_));
  inv1   g77(.a(new_n105_), .O(new_n106_));
  nor2   g78(.a(x18), .b(new_n93_), .O(new_n107_));
  nand3  g79(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(new_n108_));
  aoi21  g80(.a(new_n108_), .b(new_n103_), .c(new_n39_), .O(new_n109_));
  nor2   g81(.a(new_n29_), .b(x12), .O(new_n110_));
  oai21  g82(.a(new_n110_), .b(new_n109_), .c(new_n31_), .O(new_n111_));
  nand2  g83(.a(x08), .b(x07), .O(new_n112_));
  oai21  g84(.a(new_n111_), .b(x08), .c(new_n112_), .O(z8));
endmodule
