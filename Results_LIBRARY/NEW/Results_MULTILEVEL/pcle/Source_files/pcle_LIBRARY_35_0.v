...
module FAU ( 
  ...
  nor2   g28(.a(new_n48_), .b(new_n49_), .O(new_n57_));
  inv1   g29(.a(new_n57_), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n40_), .c(new_n38_), .O(new_n59_));
  nand3  g31(.a(new_n50_), .b(new_n56_), .c(x13), .O(new_n60_));
  oai21  g32(.a(new_n59_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  ...
  nand3  g37(.a(new_n57_), .b(x14), .c(x11), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(x15), .O(new_n67_));
  nand3  g39(.a(new_n39_), .b(x14), .c(x13), .O(new_n68_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n65_), .c(x16), .O(new_n74_));
  nand2  g46(.a(new_n57_), .b(x11), .O(new_n75_));
