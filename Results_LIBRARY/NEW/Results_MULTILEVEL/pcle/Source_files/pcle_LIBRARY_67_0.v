...
module FAU ( 
  ...
  nand3  g17(.a(new_n41_), .b(new_n45_), .c(x11), .O(new_n46_));
  oai21  g18(.a(new_n45_), .b(x11), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g23(.a(x13), .b(new_n38_), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n38_), .c(new_n52_), .O(new_n53_));
  ...
  oai22  g41(.a(new_n69_), .b(new_n59_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  ...
  nor2   g45(.a(new_n66_), .b(new_n60_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n59_), .c(x16), .O(new_n76_));
  inv1   g48(.a(x16), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(x15), .c(x14), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n57_), .c(new_n76_), .O(new_n79_));
  ...
  nand4  g54(.a(new_n40_), .b(x16), .c(x15), .d(x14), .O(new_n83_));
  aoi21  g55(.a(new_n83_), .b(x13), .c(new_n45_), .O(new_n84_));
  nor2   g56(.a(new_n40_), .b(x12), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n84_), .c(x11), .O(new_n86_));
  nor2   g58(.a(new_n77_), .b(new_n66_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(x14), .c(x11), .O(new_n88_));
  ...
  nand3  g65(.a(new_n74_), .b(x17), .c(x16), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n57_), .c(x18), .O(new_n95_));
  nand4  g67(.a(new_n87_), .b(new_n68_), .c(new_n29_), .d(x17), .O(new_n96_));
