...
module FAU ( 
  ...
  aoi21  g11(.a(new_n39_), .b(new_n38_), .c(x11), .O(new_n40_));
  ...
  nand4  g43(.a(new_n39_), .b(x15), .c(x14), .d(x13), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x12), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(x11), .O(new_n74_));
  nor2   g46(.a(new_n64_), .b(new_n58_), .O(new_n75_));
  ...
  nor2   g55(.a(x17), .b(new_n39_), .O(new_n84_));
  nand2  g56(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  ...
  nor2   g63(.a(new_n39_), .b(new_n64_), .O(new_n92_));
