...
module FAU ( 
  ...
  aoi21  g09(.a(x16), .b(x10), .c(x11), .O(new_n38_));
  ...
  oai22  g45(.a(new_n73_), .b(new_n55_), .c(new_n71_), .d(x10), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x09), .c(new_n30_), .O(new_n75_));
  nand2  g47(.a(x08), .b(x05), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(z6));
  oai21  g49(.a(new_n70_), .b(new_n46_), .c(x17), .O(new_n78_));
  inv1   g50(.a(x17), .O(new_n79_));
  and2   g51(.a(x15), .b(x14), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n56_), .c(new_n79_), .d(x16), .O(new_n81_));
  aoi21  g53(.a(new_n81_), .b(new_n78_), .c(x10), .O(new_n82_));
  nor2   g54(.a(new_n79_), .b(x16), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n82_), .c(x09), .O(new_n84_));
  ...
  nor2   g64(.a(new_n29_), .b(x16), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n92_), .c(x09), .O(new_n94_));
