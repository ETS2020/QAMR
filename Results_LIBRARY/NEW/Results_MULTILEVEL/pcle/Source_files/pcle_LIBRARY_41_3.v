...
module FAU ( 
  ...
  nand2  g26(.a(x11), .b(new_n38_), .O(new_n55_));
  nand3  g27(.a(new_n31_), .b(x13), .c(x12), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n63_), .b(new_n61_), .c(new_n31_), .O(new_n64_));
  nand3  g36(.a(x15), .b(new_n31_), .c(new_n38_), .O(new_n65_));
  ...
  aoi21  g42(.a(x15), .b(x14), .c(x10), .O(new_n71_));
  inv1   g43(.a(new_n71_), .O(new_n72_));
  aoi21  g44(.a(new_n72_), .b(new_n54_), .c(new_n70_), .O(new_n73_));
  nand3  g45(.a(new_n70_), .b(x15), .c(x14), .O(new_n74_));
  nor2   g46(.a(new_n74_), .b(new_n53_), .O(new_n75_));
  ...
  aoi21  g52(.a(new_n80_), .b(x14), .c(new_n71_), .O(new_n81_));
  nand4  g53(.a(new_n79_), .b(x16), .c(x15), .d(x14), .O(new_n82_));
  oai22  g54(.a(new_n82_), .b(new_n53_), .c(new_n81_), .d(new_n79_), .O(new_n83_));
  nand3  g55(.a(new_n83_), .b(x09), .c(new_n32_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n84_), .O(z7));
  nand3  g58(.a(x17), .b(x16), .c(x13), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n46_), .c(x14), .O(new_n88_));
  aoi21  g60(.a(new_n88_), .b(new_n72_), .c(new_n29_), .O(new_n89_));
  ...
  oai21  g64(.a(new_n92_), .b(new_n89_), .c(x09), .O(new_n93_));
