...
module FAU ( 
  ...
  nand4  g11(.a(new_n39_), .b(new_n32_), .c(x09), .d(new_n38_), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n37_), .O(z1));
  xor2a  g13(.a(x12), .b(x11), .O(new_n42_));
  nand4  g14(.a(new_n42_), .b(new_n32_), .c(x09), .d(new_n38_), .O(new_n43_));
  ...
  nand4  g21(.a(new_n49_), .b(new_n32_), .c(x09), .d(new_n38_), .O(new_n50_));
  ...
  nand4  g28(.a(new_n56_), .b(new_n32_), .c(x09), .d(new_n38_), .O(new_n57_));
  ...
  nand4  g36(.a(new_n64_), .b(new_n32_), .c(x09), .d(new_n38_), .O(new_n65_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n32_), .c(x09), .O(new_n74_));
  nand2  g46(.a(x08), .b(x05), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n74_), .O(z6));
  inv1   g48(.a(x09), .O(new_n77_));
  oai21  g49(.a(new_n68_), .b(new_n46_), .c(x17), .O(new_n78_));
  inv1   g50(.a(x17), .O(new_n79_));
  nand4  g51(.a(new_n54_), .b(new_n79_), .c(x15), .d(x14), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n78_), .c(new_n71_), .O(new_n81_));
  nand3  g53(.a(x17), .b(new_n71_), .c(new_n38_), .O(new_n82_));
  inv1   g54(.a(new_n82_), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n81_), .c(new_n32_), .O(new_n84_));
  nand2  g56(.a(x08), .b(x06), .O(new_n85_));
  oai21  g57(.a(new_n84_), .b(new_n77_), .c(new_n85_), .O(z7));
  oai21  g58(.a(new_n79_), .b(new_n71_), .c(new_n38_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n69_), .c(new_n29_), .O(new_n88_));
  nand4  g60(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n60_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n88_), .c(new_n32_), .O(new_n91_));
  nand2  g63(.a(x08), .b(x07), .O(new_n92_));
  oai21  g64(.a(new_n91_), .b(new_n77_), .c(new_n92_), .O(z8));
endmodule
