// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:24 2020
...
module FAU ( 
  ...
  nand3  g26(.a(new_n54_), .b(x14), .c(new_n31_), .O(new_n55_));
  inv1   g27(.a(x14), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(x13), .O(new_n57_));
  oai21  g29(.a(new_n57_), .b(new_n46_), .c(new_n55_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(x09), .c(new_n30_), .O(new_n59_));
  ...
  nand3  g35(.a(new_n62_), .b(x14), .c(x13), .O(new_n64_));
  oai22  g36(.a(new_n64_), .b(new_n46_), .c(new_n63_), .d(new_n62_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n31_), .O(new_n66_));
  nand2  g38(.a(x15), .b(new_n56_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x09), .c(new_n30_), .O(new_n69_));
  nand2  g41(.a(x08), .b(x04), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g43(.a(x15), .b(x13), .O(new_n72_));
  ...
  nand2  g48(.a(new_n76_), .b(new_n31_), .O(new_n77_));
  nand2  g49(.a(x16), .b(new_n56_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(x09), .c(new_n30_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x05), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z6));
  nand3  g54(.a(x16), .b(x15), .c(x13), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n46_), .c(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  and2   g57(.a(x15), .b(x14), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n63_), .c(new_n85_), .d(x16), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(x10), .O(new_n88_));
  nor2   g60(.a(new_n85_), .b(x14), .O(new_n89_));
  oai21  g61(.a(new_n89_), .b(new_n88_), .c(x09), .O(new_n90_));
  nand2  g62(.a(x08), .b(x06), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(x08), .c(new_n91_), .O(z7));
  nand3  g64(.a(x17), .b(x16), .c(x15), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n54_), .c(x18), .O(new_n94_));
  nor2   g66(.a(new_n74_), .b(new_n62_), .O(new_n95_));
  nand4  g67(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n96_));
  inv1   g68(.a(new_n96_), .O(new_n97_));
  nor2   g69(.a(x18), .b(new_n85_), .O(new_n98_));
  nand3  g70(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(new_n99_));
  aoi21  g71(.a(new_n99_), .b(new_n94_), .c(x10), .O(new_n100_));
  nor2   g72(.a(new_n29_), .b(x14), .O(new_n101_));
