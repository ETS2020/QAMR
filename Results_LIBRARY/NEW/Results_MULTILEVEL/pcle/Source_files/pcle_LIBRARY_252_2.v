// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:34 2020
...
module FAU ( 
  ...
  nand4  g04(.a(x12), .b(x11), .c(new_n32_), .d(x09), .O(new_n33_));
  ...
  nand3  g10(.a(new_n38_), .b(new_n32_), .c(x09), .O(new_n39_));
  ...
  nand3  g20(.a(new_n48_), .b(new_n32_), .c(x09), .O(new_n49_));
  ...
  nand3  g27(.a(new_n55_), .b(new_n32_), .c(x09), .O(new_n56_));
  ...
  nand3  g35(.a(new_n63_), .b(new_n32_), .c(x09), .O(new_n64_));
  ...
  nand3  g43(.a(new_n71_), .b(new_n32_), .c(x09), .O(new_n72_));
  ...
  nand3  g51(.a(new_n79_), .b(new_n32_), .c(x09), .O(new_n80_));
  ...
  nand3  g59(.a(new_n87_), .b(new_n32_), .c(x09), .O(new_n88_));
