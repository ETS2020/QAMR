...
module FAU ( 
  ...
  nand4  g50(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n53_), .c(new_n78_), .O(new_n80_));
  ...
  nand4  g57(.a(new_n85_), .b(x13), .c(x12), .d(x11), .O(new_n86_));
