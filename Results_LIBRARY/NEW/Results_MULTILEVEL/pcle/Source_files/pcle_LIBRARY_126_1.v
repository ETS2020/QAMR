...
module FAU ( 
  ...
  oai21  g19(.a(new_n46_), .b(new_n30_), .c(new_n47_), .O(new_n48_));
  ...
  nand2  g23(.a(x13), .b(x11), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x14), .O(new_n53_));
  nand3  g25(.a(new_n46_), .b(new_n31_), .c(x13), .O(new_n54_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n52_), .c(x16), .O(new_n68_));
