// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:05 2020
...
module FAU ( 
  ...
  oai21  g32(.a(new_n60_), .b(new_n46_), .c(new_n58_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n62_));
  nand2  g34(.a(x08), .b(x04), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n62_), .O(z5));
  nand2  g36(.a(x15), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n46_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x15), .c(x13), .O(new_n68_));
  ...
  nand3  g44(.a(x16), .b(x15), .c(x13), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n46_), .c(x17), .O(new_n74_));
  inv1   g46(.a(x17), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(x16), .c(x15), .O(new_n76_));
  ...
  oai21  g53(.a(new_n81_), .b(new_n57_), .c(x18), .O(new_n82_));
  nand4  g54(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n57_), .c(new_n82_), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(new_n33_), .c(x09), .d(new_n32_), .O(new_n85_));
