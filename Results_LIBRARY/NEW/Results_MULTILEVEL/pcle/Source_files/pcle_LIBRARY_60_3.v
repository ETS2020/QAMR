...
module FAU ( 
  ...
  nor2   g49(.a(new_n62_), .b(new_n31_), .O(new_n78_));
  nor2   g50(.a(x17), .b(new_n70_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n53_), .c(new_n77_), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(new_n38_), .c(x09), .d(new_n32_), .O(new_n82_));
  ...
  nand4  g58(.a(x13), .b(x12), .c(x11), .d(new_n38_), .O(new_n87_));
  nand4  g59(.a(new_n78_), .b(new_n29_), .c(x17), .d(x16), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(x09), .c(new_n32_), .O(new_n90_));
