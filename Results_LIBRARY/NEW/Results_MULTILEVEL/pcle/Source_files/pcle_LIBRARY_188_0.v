...
module FAU ( 
  ...
  nand2  g51(.a(x14), .b(x13), .O(new_n80_));
  nand3  g52(.a(new_n39_), .b(x16), .c(x15), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n80_), .c(x12), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x11), .O(new_n83_));
  nand2  g55(.a(x13), .b(x11), .O(new_n84_));
  nor2   g56(.a(new_n74_), .b(new_n64_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n84_), .c(x17), .O(new_n87_));
  ...
  nand4  g65(.a(new_n85_), .b(new_n66_), .c(new_n29_), .d(x17), .O(new_n94_));
