// Benchmark "FAU" written by ABC on Mon Jul 27 17:23:49 2020
...
module FAU ( 
  ...
  nand4  g10(.a(x15), .b(new_n43_), .c(x12), .d(x08), .O(new_n52_));
  ...
  nand3  g21(.a(x10), .b(x08), .c(x01), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x14), .O(new_n64_));
  nand2  g23(.a(x15), .b(x08), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z13));
  inv1   g25(.a(x08), .O(new_n67_));
  nand2  g26(.a(x15), .b(new_n67_), .O(new_n68_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(z14));
  nand3  g29(.a(new_n48_), .b(x16), .c(new_n43_), .O(new_n71_));
  nand3  g30(.a(new_n60_), .b(x08), .c(x03), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z15));
  nand2  g32(.a(new_n48_), .b(x17), .O(new_n74_));
  nand3  g33(.a(new_n60_), .b(x08), .c(x04), .O(new_n75_));
