// Benchmark "FAU" written by ABC on Mon Jul 27 17:23:54 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n57_, new_n58_, new_n60_, new_n61_, new_n62_, new_n63_,
  ...
  nor3   g11(.a(new_n52_), .b(new_n49_), .c(x14), .O(z03));
  inv1   g12(.a(x18), .O(z04));
  nand2  g13(.a(x09), .b(x08), .O(z10));
  inv1   g14(.a(z10), .O(z09));
  nand2  g15(.a(new_n50_), .b(x13), .O(new_n57_));
  nand4  g16(.a(new_n49_), .b(x10), .c(x08), .d(x00), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(z12));
  ...
  nand2  g23(.a(new_n61_), .b(x15), .O(new_n65_));
