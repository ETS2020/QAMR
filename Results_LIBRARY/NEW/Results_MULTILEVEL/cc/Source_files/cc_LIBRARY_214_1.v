...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n58_, new_n60_, new_n61_, new_n62_, new_n63_,
  ...
  aoi21  g17(.a(new_n48_), .b(new_n58_), .c(new_n52_), .O(z12));
  inv1   g18(.a(x08), .O(new_n60_));
  inv1   g19(.a(x10), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(new_n43_), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(x15), .O(new_n63_));
  inv1   g22(.a(x01), .O(new_n64_));
  oai21  g23(.a(new_n53_), .b(new_n64_), .c(x14), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(z13));
  nand2  g25(.a(new_n53_), .b(x15), .O(new_n67_));
  nor2   g26(.a(x15), .b(new_n61_), .O(new_n68_));
