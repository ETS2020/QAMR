...
module FAU ( 
  ...
  nand2  g17(.a(x08), .b(x00), .O(new_n59_));
  nand3  g18(.a(new_n47_), .b(x12), .c(x10), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z12));
  inv1   g20(.a(x08), .O(new_n62_));
  inv1   g21(.a(x10), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(new_n43_), .O(new_n64_));
