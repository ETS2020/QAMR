...
module FAU ( 
  ...
  nand3  g37(.a(new_n60_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(z17));
  nand2  g39(.a(new_n48_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n60_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(z18));
  inv1   g42(.a(x07), .O(new_n84_));
  oai21  g43(.a(new_n47_), .b(x14), .c(new_n84_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x10), .c(x08), .O(new_n86_));
  aoi22  g45(.a(new_n53_), .b(x20), .c(x15), .d(x14), .O(new_n87_));
