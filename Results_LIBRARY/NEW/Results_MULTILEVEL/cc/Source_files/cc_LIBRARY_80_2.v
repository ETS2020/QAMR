...
module FAU ( 
  ...
  nand2  g21(.a(new_n43_), .b(new_n59_), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x15), .c(x08), .O(new_n64_));
  ...
  oai21  g38(.a(new_n53_), .b(x06), .c(x19), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n64_), .c(new_n52_), .O(z18));
