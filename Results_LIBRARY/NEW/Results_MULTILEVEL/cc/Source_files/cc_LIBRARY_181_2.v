...
module FAU ( 
  ...
  nand4  g23(.a(new_n64_), .b(x15), .c(x10), .d(x08), .O(new_n65_));
  ...
  nand2  g40(.a(x19), .b(x15), .O(new_n82_));
  oai21  g41(.a(x15), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x10), .c(x08), .O(new_n84_));
  nand2  g43(.a(new_n53_), .b(x19), .O(new_n85_));
