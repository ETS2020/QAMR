...
module FAU ( 
  ...
  oai21  g38(.a(x15), .b(new_n79_), .c(x19), .O(new_n80_));
  nor2   g39(.a(x15), .b(new_n79_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x06), .c(new_n59_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n52_), .O(z18));
