...
module FAU ( 
  ...
  oai21  g42(.a(x15), .b(new_n63_), .c(x20), .O(new_n84_));
  nor2   g43(.a(x15), .b(new_n63_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(x07), .c(new_n59_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n52_), .O(z19));
  buf    g46(.a(x19), .O(z05));
  buf    g47(.a(x15), .O(z06));
  buf    g48(.a(x17), .O(z07));
  buf    g49(.a(x16), .O(z08));
