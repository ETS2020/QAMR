...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n48_), .c(new_n59_), .O(z13));
  nand2  g25(.a(new_n43_), .b(x15), .O(new_n67_));
  nand3  g26(.a(new_n62_), .b(x08), .c(x02), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n67_), .c(new_n59_), .O(z14));
  nand3  g28(.a(new_n49_), .b(x08), .c(x03), .O(new_n70_));
  nand2  g29(.a(x16), .b(x15), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x10), .O(new_n73_));
  nand3  g32(.a(new_n43_), .b(x16), .c(new_n48_), .O(new_n74_));
