...
module FAU ( 
  ...
  oai21  g17(.a(new_n47_), .b(x14), .c(new_n58_), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(x10), .c(x08), .O(new_n60_));
  aoi22  g19(.a(new_n53_), .b(x13), .c(x15), .d(x14), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n60_), .c(new_n52_), .O(z12));
  inv1   g21(.a(x08), .O(new_n63_));
  inv1   g22(.a(x10), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(new_n65_));
  ...
  nor2   g29(.a(x15), .b(new_n64_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x08), .c(x02), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n70_), .c(new_n52_), .O(z14));
  nand3  g32(.a(new_n48_), .b(x16), .c(new_n43_), .O(new_n74_));
  ...
  nand3  g42(.a(new_n71_), .b(x08), .c(x06), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(z18));
  nand2  g44(.a(new_n48_), .b(x20), .O(new_n86_));
  nand3  g45(.a(new_n71_), .b(x08), .c(x07), .O(new_n87_));
