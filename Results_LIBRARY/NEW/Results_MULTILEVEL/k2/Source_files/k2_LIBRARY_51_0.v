...
module FAU ( 
  ...
  inv1   g1143(.a(x08), .O(new_n1235_));
  inv1   g1144(.a(new_n410_), .O(new_n1236_));
  nand4  g1145(.a(new_n407_), .b(new_n178_), .c(x22), .d(x16), .O(new_n1237_));
  aoi21  g1146(.a(new_n1237_), .b(new_n1236_), .c(new_n1235_), .O(new_n1238_));
  ...
  nand2  g1427(.a(x19), .b(x16), .O(new_n1519_));
  oai22  g1428(.a(new_n1519_), .b(x08), .c(x16), .d(x07), .O(new_n1520_));
  ...
  nor2   g1444(.a(new_n93_), .b(x08), .O(new_n1536_));
  nand4  g1445(.a(new_n1536_), .b(x28), .c(x20), .d(new_n98_), .O(new_n1537_));
  ...
  nand2  g1574(.a(new_n146_), .b(x08), .O(new_n1666_));
  nand3  g1575(.a(new_n1666_), .b(x19), .c(x16), .O(new_n1667_));
  inv1   g1576(.a(x07), .O(new_n1668_));
  oai21  g1577(.a(x21), .b(new_n1668_), .c(new_n1239_), .O(new_n1669_));
