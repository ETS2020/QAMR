...
module FAU ( 
  ...
  nand3  g08(.a(new_n22_), .b(new_n18_), .c(new_n15_), .O(z1));
  inv1   g09(.a(x1), .O(new_n24_));
  nor2   g10(.a(new_n24_), .b(x0), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(new_n15_), .O(z2));
  nand4  g12(.a(new_n18_), .b(new_n15_), .c(x1), .d(x0), .O(z3));
  nand4  g13(.a(new_n19_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z4));
  nand3  g14(.a(new_n22_), .b(new_n18_), .c(x2), .O(z5));
  nand4  g15(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
