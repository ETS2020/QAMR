// Benchmark "FAU" written by ABC on Mon Jul 27 17:15:31 2020
...
module FAU ( 
  ...
  nand4  g14(.a(new_n18_), .b(new_n17_), .c(new_n28_), .d(x2), .O(z4));
  nand4  g15(.a(new_n21_), .b(new_n17_), .c(new_n28_), .d(x2), .O(z5));
  nand4  g16(.a(new_n24_), .b(new_n17_), .c(new_n28_), .d(x2), .O(z6));
  nand4  g17(.a(new_n26_), .b(new_n17_), .c(new_n28_), .d(x2), .O(z7));
endmodule
