// Benchmark "FAU" written by ABC on Mon Jul 27 17:15:36 2020
...
module FAU ( 
  ...
  nor2   g14(.a(x5), .b(new_n16_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(x2), .c(new_n24_), .d(new_n21_), .O(z4));
  nand3  g16(.a(new_n29_), .b(new_n22_), .c(x2), .O(z5));
  nand3  g17(.a(new_n29_), .b(new_n25_), .c(x2), .O(z6));
  nand3  g18(.a(new_n29_), .b(new_n27_), .c(x2), .O(z7));
endmodule
