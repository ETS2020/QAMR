...
module FAU ( 
  ...
  nor2   g14(.a(x4), .b(new_n16_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n18_), .c(new_n28_), .d(x2), .O(z4));
  nand4  g16(.a(new_n29_), .b(new_n21_), .c(new_n28_), .d(x2), .O(z5));
  nand4  g17(.a(new_n29_), .b(new_n24_), .c(new_n28_), .d(x2), .O(z6));
  nand4  g18(.a(new_n29_), .b(new_n26_), .c(new_n28_), .d(x2), .O(z7));
endmodule
