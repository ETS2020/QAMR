...
module FAU ( 
  ...
  nand3  g084(.a(x19), .b(new_n83_), .c(x12), .O(new_n129_));
  nand3  g085(.a(new_n89_), .b(x17), .c(x14), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand4  g087(.a(x19), .b(x17), .c(new_n128_), .d(x11), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n131_), .c(x18), .O(new_n134_));
  nand4  g090(.a(new_n86_), .b(x17), .c(x16), .d(x13), .O(new_n135_));
  ...
  nand4  g096(.a(new_n140_), .b(x16), .c(new_n138_), .d(x10), .O(new_n141_));
  ...
  nand4  g102(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n86_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x17), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n138_), .O(new_n151_));
  inv1   g107(.a(x11), .O(new_n152_));
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n128_), .O(new_n153_));
  nand2  g109(.a(x19), .b(x12), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n83_), .O(new_n155_));
  nor2   g111(.a(x19), .b(x14), .O(new_n156_));
  nor2   g112(.a(new_n128_), .b(new_n138_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n140_), .c(new_n156_), .O(new_n158_));
  ...
  inv1   g133(.a(new_n148_), .O(new_n178_));
  xnor2a g134(.a(x31), .b(x30), .O(new_n179_));
  and2   g135(.a(new_n179_), .b(new_n158_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n155_), .c(new_n153_), .d(new_n151_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n178_), .c(x33), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n177_), .c(new_n172_), .O(new_n183_));
