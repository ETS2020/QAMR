...
module FAU ( 
  ...
  nand3  g098(.a(new_n134_), .b(x16), .c(new_n138_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n142_), .c(x30), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(z0), .c(x31), .O(new_n147_));
  nand2  g103(.a(new_n112_), .b(x27), .O(new_n148_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n133_), .c(new_n138_), .O(new_n152_));
  nand2  g108(.a(x17), .b(x11), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n131_), .c(new_n130_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n131_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n89_), .b(new_n157_), .c(new_n86_), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  nor2   g115(.a(new_n130_), .b(new_n138_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n134_), .c(new_n159_), .O(new_n161_));
  oai21  g117(.a(x30), .b(x29), .c(x31), .O(new_n162_));
  aoi21  g118(.a(new_n112_), .b(x28), .c(new_n162_), .O(new_n163_));
  ...
  nand4  g127(.a(new_n140_), .b(new_n171_), .c(new_n118_), .d(new_n107_), .O(new_n172_));
  nand2  g128(.a(x33), .b(x31), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n142_), .O(new_n175_));
  nand4  g131(.a(new_n144_), .b(new_n171_), .c(x31), .d(x30), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n118_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n123_), .c(x29), .O(new_n179_));
  aoi21  g135(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x17), .c(x16), .d(x15), .O(new_n181_));
  inv1   g137(.a(new_n160_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x17), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n182_), .c(new_n89_), .O(new_n184_));
  oai21  g140(.a(new_n183_), .b(new_n151_), .c(new_n138_), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n183_), .b(new_n186_), .c(new_n130_), .O(new_n187_));
  oai21  g143(.a(new_n86_), .b(new_n155_), .c(new_n83_), .O(new_n188_));
  nand2  g144(.a(new_n86_), .b(new_n157_), .O(new_n189_));
  ...
  nand3  g150(.a(new_n194_), .b(new_n179_), .c(new_n175_), .O(new_n195_));
