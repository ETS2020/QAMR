// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:18 2020
...
module FAU ( 
  ...
  oai21  g061(.a(new_n105_), .b(new_n78_), .c(new_n104_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n91_), .c(new_n77_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n76_), .c(new_n56_), .O(z6));
  nand3  g064(.a(new_n87_), .b(new_n84_), .c(new_n81_), .O(new_n109_));
  nand2  g065(.a(new_n57_), .b(x01), .O(new_n110_));
  nor4   g066(.a(new_n110_), .b(x31), .c(x26), .d(new_n76_), .O(new_n111_));
  oai21  g067(.a(new_n109_), .b(new_n88_), .c(new_n111_), .O(z7));
  inv1   g068(.a(new_n105_), .O(new_n113_));
  oai21  g069(.a(x30), .b(new_n97_), .c(new_n78_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x29), .O(new_n115_));
  oai21  g071(.a(new_n113_), .b(new_n104_), .c(new_n115_), .O(new_n116_));
  nand3  g072(.a(x19), .b(new_n85_), .c(x13), .O(new_n117_));
  inv1   g073(.a(x19), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x18), .c(x14), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n117_), .c(new_n82_), .O(new_n120_));
  nand4  g076(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n121_));
  ...
  nand3  g086(.a(x16), .b(new_n130_), .c(x10), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n125_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n116_), .c(z0), .d(x31), .O(new_n135_));
  oai21  g091(.a(x28), .b(x27), .c(x29), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n104_), .O(new_n137_));
  nand2  g093(.a(x16), .b(x10), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n125_), .c(new_n130_), .O(new_n139_));
  nor2   g095(.a(new_n118_), .b(new_n85_), .O(new_n140_));
  ...
  oai21  g100(.a(new_n118_), .b(new_n144_), .c(new_n85_), .O(new_n145_));
  inv1   g101(.a(x14), .O(new_n146_));
  nand2  g102(.a(new_n118_), .b(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n126_), .b(x16), .c(x15), .O(new_n148_));
  inv1   g104(.a(x31), .O(new_n149_));
  nor2   g105(.a(new_n104_), .b(new_n99_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(x28), .c(new_n149_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n148_), .c(new_n147_), .d(new_n145_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n143_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n142_), .c(new_n139_), .d(new_n137_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n135_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n77_), .c(x00), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(z8));
  aoi21  g114(.a(new_n127_), .b(new_n123_), .c(new_n130_), .O(new_n159_));
  nand3  g115(.a(new_n136_), .b(new_n149_), .c(new_n104_), .O(new_n160_));
  nand3  g116(.a(new_n113_), .b(x31), .c(x30), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  oai21  g118(.a(new_n132_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n118_), .b(x14), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(x18), .c(x17), .d(x16), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n130_), .O(new_n166_));
  nand2  g122(.a(new_n105_), .b(x31), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n168_), .c(new_n118_), .O(new_n170_));
  or2    g126(.a(new_n169_), .b(new_n138_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n169_), .b(new_n172_), .c(new_n124_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x12), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n82_), .O(new_n175_));
  nand2  g131(.a(new_n85_), .b(new_n144_), .O(new_n176_));
  nand2  g132(.a(new_n149_), .b(x30), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n176_), .c(new_n175_), .d(new_n173_), .O(new_n178_));
  aoi21  g134(.a(new_n171_), .b(new_n130_), .c(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n170_), .c(new_n167_), .d(new_n115_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n166_), .c(x33), .O(new_n181_));
  oai21  g137(.a(new_n163_), .b(x33), .c(new_n181_), .O(new_n182_));
