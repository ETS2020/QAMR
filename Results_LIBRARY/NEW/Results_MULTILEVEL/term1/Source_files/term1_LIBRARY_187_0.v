...
module FAU ( 
  ...
  nor4   g047(.a(new_n91_), .b(x27), .c(x26), .d(new_n77_), .O(z3));
  xnor2a g048(.a(x28), .b(x27), .O(new_n93_));
  nor4   g049(.a(new_n93_), .b(new_n91_), .c(x26), .d(new_n77_), .O(z4));
  inv1   g050(.a(x26), .O(new_n95_));
  inv1   g051(.a(x29), .O(new_n96_));
  and2   g052(.a(x28), .b(x27), .O(new_n97_));
  nand3  g053(.a(new_n96_), .b(x28), .c(x27), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n90_), .c(new_n58_), .d(new_n95_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n77_), .O(z5));
  ...
  nand4  g062(.a(new_n106_), .b(new_n90_), .c(new_n58_), .d(new_n95_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n77_), .O(z6));
  nor2   g064(.a(new_n104_), .b(new_n96_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n97_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x31), .O(new_n111_));
  nand4  g067(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n80_), .O(new_n112_));
  nor2   g068(.a(new_n57_), .b(new_n77_), .O(new_n113_));
  inv1   g069(.a(x31), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x30), .c(x29), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n97_), .c(x26), .O(new_n117_));
  ...
  nor2   g077(.a(new_n119_), .b(new_n96_), .O(new_n122_));
  ...
  nand2  g098(.a(new_n109_), .b(x27), .O(new_n143_));
  ...
  aoi21  g113(.a(new_n109_), .b(x28), .c(new_n157_), .O(new_n158_));
  ...
  nand4  g127(.a(new_n140_), .b(new_n166_), .c(new_n114_), .d(new_n104_), .O(new_n172_));
  ...
  nand3  g147(.a(new_n191_), .b(new_n95_), .c(x00), .O(new_n192_));
