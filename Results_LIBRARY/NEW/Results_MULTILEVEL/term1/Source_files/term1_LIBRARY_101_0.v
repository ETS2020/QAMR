...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(new_n90_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n86_), .c(new_n85_), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n89_), .b(new_n84_), .c(new_n82_), .O(new_n107_));
  ...
  nor3   g068(.a(x27), .b(x23), .c(x18), .O(new_n113_));
  ...
  nand4  g075(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(new_n120_));
  ...
  nand3  g087(.a(x19), .b(new_n85_), .c(x13), .O(new_n132_));
  ...
  nand3  g101(.a(x16), .b(new_n145_), .c(x10), .O(new_n146_));
  nor2   g102(.a(new_n85_), .b(new_n131_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x30), .c(x19), .O(new_n148_));
  ...
  nand3  g111(.a(x19), .b(new_n131_), .c(x12), .O(new_n156_));
  nand3  g112(.a(new_n133_), .b(x17), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n140_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x17), .c(new_n140_), .d(x11), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x15), .O(new_n161_));
  nor2   g117(.a(new_n133_), .b(new_n131_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(x16), .c(new_n145_), .d(x10), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n155_), .c(z0), .d(x31), .O(new_n165_));
  nand2  g121(.a(new_n98_), .b(new_n79_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x32), .c(x30), .O(new_n167_));
  oai21  g123(.a(new_n165_), .b(x30), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x29), .O(new_n169_));
  and2   g125(.a(x16), .b(x10), .O(new_n170_));
  nor2   g126(.a(new_n133_), .b(new_n85_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x17), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n170_), .c(x15), .O(new_n174_));
  nand3  g130(.a(new_n171_), .b(x17), .c(x11), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n140_), .O(new_n176_));
  nand2  g132(.a(new_n171_), .b(x12), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n131_), .O(new_n178_));
  inv1   g134(.a(x13), .O(new_n179_));
  oai21  g135(.a(new_n133_), .b(new_n179_), .c(new_n85_), .O(new_n180_));
  nor2   g136(.a(x19), .b(x14), .O(new_n181_));
  nor2   g137(.a(new_n140_), .b(new_n145_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n172_), .c(x31), .O(new_n184_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n154_), .c(new_n78_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n128_), .O(z8));
  inv1   g146(.a(x33), .O(new_n191_));
  aoi21  g147(.a(new_n142_), .b(new_n139_), .c(new_n145_), .O(new_n192_));
  oai21  g148(.a(new_n149_), .b(new_n192_), .c(new_n191_), .O(new_n193_));
  ...
  nand4  g153(.a(new_n164_), .b(new_n191_), .c(new_n123_), .d(new_n106_), .O(new_n198_));
  oai21  g154(.a(new_n191_), .b(new_n123_), .c(new_n198_), .O(new_n199_));
  aoi21  g155(.a(new_n133_), .b(x14), .c(new_n85_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(x17), .c(x16), .d(x15), .O(new_n201_));
  aoi21  g157(.a(new_n182_), .b(new_n147_), .c(x19), .O(new_n202_));
  aoi21  g158(.a(new_n170_), .b(new_n147_), .c(x15), .O(new_n203_));
  aoi21  g159(.a(new_n147_), .b(x11), .c(x16), .O(new_n204_));
  oai21  g160(.a(new_n85_), .b(new_n136_), .c(new_n131_), .O(new_n205_));
  nand2  g161(.a(new_n85_), .b(new_n179_), .O(new_n206_));
  ...
  aoi21  g165(.a(new_n209_), .b(new_n201_), .c(new_n191_), .O(new_n210_));
