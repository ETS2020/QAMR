// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:54 2020
...
module FAU ( 
  ...
  nand4  g090(.a(new_n134_), .b(new_n117_), .c(z0), .d(x31), .O(new_n135_));
  aoi21  g091(.a(new_n98_), .b(new_n79_), .c(new_n100_), .O(new_n136_));
  nand2  g092(.a(x16), .b(x10), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n127_), .c(new_n132_), .O(new_n138_));
  nand2  g094(.a(x17), .b(x11), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n125_), .c(new_n124_), .O(new_n140_));
  inv1   g096(.a(x12), .O(new_n141_));
  oai21  g097(.a(new_n125_), .b(new_n141_), .c(new_n83_), .O(new_n142_));
  aoi21  g098(.a(x19), .b(x13), .c(x18), .O(new_n143_));
  nor2   g099(.a(x19), .b(x14), .O(new_n144_));
  nand2  g100(.a(x16), .b(x15), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n127_), .c(x31), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n144_), .c(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n142_), .c(new_n140_), .d(new_n138_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n136_), .c(x32), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n135_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n78_), .c(x00), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(z8));
  inv1   g108(.a(x33), .O(new_n153_));
  nand4  g109(.a(new_n134_), .b(new_n116_), .c(new_n153_), .d(x31), .O(new_n154_));
  aoi21  g110(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(x17), .c(x16), .d(x15), .O(new_n156_));
  nor2   g112(.a(new_n86_), .b(new_n83_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n145_), .c(new_n89_), .O(new_n159_));
  oai21  g115(.a(new_n158_), .b(new_n137_), .c(new_n132_), .O(new_n160_));
  aoi21  g116(.a(new_n157_), .b(x11), .c(x16), .O(new_n161_));
  oai21  g117(.a(new_n86_), .b(new_n141_), .c(new_n83_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  nand2  g119(.a(new_n86_), .b(new_n163_), .O(new_n164_));
  nor2   g120(.a(new_n111_), .b(new_n100_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n116_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n161_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n160_), .c(new_n159_), .d(new_n156_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  oai21  g125(.a(new_n154_), .b(new_n100_), .c(new_n169_), .O(new_n170_));
