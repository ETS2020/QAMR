...
module FAU ( 
  ...
  nand2  g055(.a(x28), .b(new_n78_), .O(new_n100_));
  nand2  g056(.a(new_n79_), .b(x27), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n94_), .c(new_n58_), .d(new_n77_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n99_), .c(new_n56_), .O(z4));
  inv1   g060(.a(x29), .O(new_n105_));
  nor2   g061(.a(new_n79_), .b(new_n78_), .O(new_n106_));
  nand3  g062(.a(new_n105_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n105_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n58_), .d(new_n77_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n99_), .c(new_n56_), .O(z5));
  aoi21  g066(.a(new_n80_), .b(x29), .c(new_n79_), .O(new_n111_));
  oai21  g067(.a(new_n105_), .b(new_n78_), .c(x30), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n78_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n58_), .d(new_n77_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n99_), .c(new_n56_), .O(z6));
  nand3  g071(.a(new_n106_), .b(x30), .c(x29), .O(new_n116_));
  ...
  inv1   g075(.a(new_n106_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x30), .c(x29), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n77_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n99_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(z7));
  nand2  g081(.a(new_n80_), .b(x29), .O(new_n126_));
  nand2  g082(.a(new_n79_), .b(new_n78_), .O(new_n127_));
  nand2  g083(.a(x30), .b(new_n105_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(new_n126_), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n88_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n91_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n85_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n133_));
  ...
  oai21  g101(.a(new_n80_), .b(new_n79_), .c(new_n101_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x29), .O(new_n147_));
  nand2  g103(.a(x16), .b(x10), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n137_), .c(new_n142_), .O(new_n149_));
  nor2   g105(.a(new_n91_), .b(new_n88_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x17), .c(x11), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n136_), .O(new_n152_));
  aoi21  g108(.a(new_n150_), .b(x12), .c(x17), .O(new_n153_));
  aoi21  g109(.a(x19), .b(x13), .c(x18), .O(new_n154_));
  inv1   g110(.a(x14), .O(new_n155_));
  nand2  g111(.a(new_n91_), .b(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n138_), .b(x16), .c(x15), .O(new_n157_));
  aoi21  g113(.a(new_n80_), .b(new_n105_), .c(new_n121_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n154_), .c(new_n153_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n145_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n77_), .c(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  aoi21  g121(.a(new_n139_), .b(new_n135_), .c(new_n142_), .O(new_n166_));
  inv1   g122(.a(new_n143_), .O(new_n167_));
  nand3  g123(.a(new_n146_), .b(x31), .c(x29), .O(new_n168_));
  nand3  g124(.a(new_n121_), .b(new_n80_), .c(new_n105_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  oai21  g126(.a(new_n167_), .b(new_n166_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n91_), .b(x14), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x18), .c(x17), .d(x16), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n142_), .O(new_n174_));
  nand2  g130(.a(x16), .b(x15), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n91_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n148_), .c(new_n142_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n136_), .O(new_n180_));
  aoi21  g136(.a(x18), .b(x12), .c(x17), .O(new_n181_));
  oai21  g137(.a(x18), .b(x13), .c(new_n127_), .O(new_n182_));
  nand2  g138(.a(new_n121_), .b(x30), .O(new_n183_));
  nand2  g139(.a(x31), .b(new_n105_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n183_), .c(new_n126_), .O(new_n185_));
  nor3   g141(.a(new_n185_), .b(new_n182_), .c(new_n181_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n174_), .c(x33), .O(new_n188_));
  oai21  g144(.a(new_n171_), .b(x33), .c(new_n188_), .O(new_n189_));
