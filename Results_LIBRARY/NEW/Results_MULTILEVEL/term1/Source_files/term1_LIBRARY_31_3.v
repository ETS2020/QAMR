// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:53 2020
...
module FAU ( 
  ...
  nand2  g062(.a(x27), .b(new_n78_), .O(new_n107_));
  inv1   g063(.a(x30), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x29), .c(x28), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n107_), .c(new_n106_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n56_), .O(z6));
  nor2   g068(.a(new_n108_), .b(new_n98_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n100_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  nand4  g071(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n116_));
  nor2   g072(.a(new_n57_), .b(new_n56_), .O(new_n117_));
  inv1   g073(.a(new_n100_), .O(new_n118_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n108_), .c(x29), .d(new_n78_), .O(new_n127_));
  nor2   g083(.a(new_n125_), .b(new_n98_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n108_), .c(new_n127_), .O(new_n129_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(z0), .d(x31), .O(new_n145_));
  nand2  g101(.a(new_n113_), .b(x27), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nor3   g103(.a(x30), .b(x27), .c(x26), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n99_), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n138_), .c(x15), .O(new_n152_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n152_), .c(new_n78_), .O(new_n165_));
  nand2  g121(.a(new_n113_), .b(x28), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n149_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x32), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n145_), .c(new_n124_), .O(z8));
  inv1   g125(.a(new_n128_), .O(new_n170_));
  inv1   g126(.a(x33), .O(new_n171_));
  aoi21  g127(.a(new_n143_), .b(new_n141_), .c(x33), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n119_), .c(new_n108_), .d(new_n78_), .O(new_n173_));
  oai21  g129(.a(new_n171_), .b(new_n108_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand4  g131(.a(new_n144_), .b(new_n171_), .c(x31), .d(x30), .O(new_n176_));
  nand3  g132(.a(x33), .b(new_n119_), .c(new_n78_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n176_), .c(new_n125_), .O(new_n178_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n160_), .c(new_n89_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n150_), .c(new_n142_), .O(new_n183_));
  ...
  nand2  g144(.a(x31), .b(new_n108_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n188_), .c(new_n187_), .d(new_n185_), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n183_), .c(new_n182_), .d(new_n180_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(x33), .c(new_n78_), .O(new_n193_));
  inv1   g149(.a(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n178_), .b(x29), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n175_), .c(new_n124_), .O(z9));
endmodule
