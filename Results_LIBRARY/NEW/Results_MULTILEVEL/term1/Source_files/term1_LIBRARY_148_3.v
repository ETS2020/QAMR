...
module FAU ( 
  ...
  nand2  g072(.a(x24), .b(x20), .O(new_n117_));
  oai21  g073(.a(new_n91_), .b(new_n80_), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n90_), .c(new_n87_), .d(new_n116_), .O(new_n119_));
  ...
  aoi22  g117(.a(new_n161_), .b(new_n142_), .c(new_n133_), .d(new_n160_), .O(new_n162_));
  ...
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n122_), .d(new_n108_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n88_), .b(x13), .c(new_n133_), .O(new_n182_));
  ...
  nand2  g143(.a(new_n133_), .b(new_n160_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(new_n189_), .c(new_n81_), .O(new_n190_));
  oai21  g146(.a(new_n133_), .b(new_n156_), .c(new_n85_), .O(new_n191_));
