...
module FAU ( 
  ...
  nand3  g078(.a(new_n122_), .b(new_n107_), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n122_), .b(x29), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(z0), .c(x30), .O(new_n125_));
  ...
  oai22  g108(.a(new_n152_), .b(new_n134_), .c(x19), .d(x14), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n117_), .c(new_n107_), .O(new_n154_));
  ...
  nand4  g116(.a(new_n141_), .b(new_n160_), .c(x31), .d(x30), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n107_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n122_), .c(x29), .O(new_n164_));
  nand4  g120(.a(new_n141_), .b(new_n124_), .c(new_n160_), .d(new_n117_), .O(new_n165_));
  ...
  aoi21  g124(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(x17), .c(x16), .d(x15), .O(new_n170_));
  oai21  g126(.a(new_n117_), .b(new_n98_), .c(x30), .O(new_n171_));
  nand2  g127(.a(x18), .b(x17), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n152_), .c(new_n89_), .O(new_n173_));
  inv1   g129(.a(new_n172_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n143_), .c(x15), .O(new_n175_));
  aoi21  g131(.a(new_n174_), .b(x11), .c(x16), .O(new_n176_));
  aoi21  g132(.a(x18), .b(x12), .c(x17), .O(new_n177_));
  nand3  g133(.a(x31), .b(new_n99_), .c(new_n79_), .O(new_n178_));
  oai21  g134(.a(x18), .b(x13), .c(new_n178_), .O(new_n179_));
  nor4   g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .d(new_n175_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n173_), .c(new_n171_), .d(new_n170_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n168_), .c(new_n164_), .O(new_n183_));
