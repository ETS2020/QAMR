...
module FAU ( 
  ...
  nand4  g069(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n114_));
  nor2   g070(.a(new_n76_), .b(new_n56_), .O(new_n115_));
  inv1   g071(.a(new_n99_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n48_), .b(x02), .O(new_n119_));
  oai21  g075(.a(new_n118_), .b(new_n116_), .c(new_n119_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(x26), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(z7));
  ...
  nand2  g099(.a(new_n111_), .b(x27), .O(new_n144_));
  ...
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n82_), .O(new_n153_));
  nand2  g109(.a(x19), .b(x13), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n85_), .O(new_n155_));
  ...
  aoi21  g115(.a(new_n111_), .b(x28), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g123(.a(new_n124_), .b(x31), .c(x30), .d(x29), .O(new_n168_));
  inv1   g124(.a(new_n126_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n117_), .c(new_n106_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n142_), .c(new_n77_), .d(x00), .O(new_n172_));
