// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:15 2020
...
module FAU ( 
  ...
  nand2  g062(.a(x27), .b(x25), .O(new_n107_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n111_));
  ...
  nand2  g093(.a(new_n137_), .b(x17), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n135_), .c(x11), .O(new_n140_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n128_), .c(z0), .d(x31), .O(new_n146_));
  nand2  g102(.a(new_n113_), .b(x27), .O(new_n147_));
  oai21  g103(.a(x30), .b(x27), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n99_), .O(new_n149_));
  ...
  oai21  g108(.a(new_n152_), .b(new_n136_), .c(new_n135_), .O(new_n153_));
  inv1   g109(.a(x12), .O(new_n154_));
  oai21  g110(.a(new_n136_), .b(new_n154_), .c(new_n83_), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  oai21  g112(.a(new_n89_), .b(new_n156_), .c(new_n86_), .O(new_n157_));
  nor2   g113(.a(x19), .b(x14), .O(new_n158_));
  nor2   g114(.a(new_n135_), .b(new_n143_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n139_), .c(new_n158_), .O(new_n160_));
  oai21  g116(.a(x30), .b(x29), .c(x31), .O(new_n161_));
  aoi21  g117(.a(new_n113_), .b(x28), .c(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n160_), .c(new_n157_), .d(new_n155_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n153_), .c(new_n151_), .d(new_n149_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x32), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n146_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n78_), .c(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n145_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n119_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n125_), .c(x29), .O(new_n174_));
  inv1   g130(.a(new_n127_), .O(new_n175_));
  nand4  g131(.a(new_n145_), .b(new_n170_), .c(new_n119_), .d(new_n108_), .O(new_n176_));
  ...
  aoi21  g135(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x17), .c(x16), .d(x15), .O(new_n181_));
  inv1   g137(.a(new_n159_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x17), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n182_), .c(new_n89_), .O(new_n184_));
  oai21  g140(.a(new_n183_), .b(new_n150_), .c(new_n143_), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n183_), .b(new_n186_), .c(new_n135_), .O(new_n187_));
  oai21  g143(.a(new_n86_), .b(new_n154_), .c(new_n83_), .O(new_n188_));
  nand2  g144(.a(new_n86_), .b(new_n156_), .O(new_n189_));
