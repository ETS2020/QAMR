...
module FAU ( 
  ...
  nand2  g112(.a(new_n156_), .b(new_n138_), .O(new_n157_));
  ...
  nand4  g118(.a(new_n117_), .b(x19), .c(new_n86_), .d(x13), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n162_), .c(new_n83_), .O(new_n164_));
  nand2  g120(.a(new_n83_), .b(x12), .O(new_n165_));
  nand3  g121(.a(new_n117_), .b(x19), .c(x18), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n164_), .c(x16), .O(new_n168_));
  inv1   g124(.a(new_n166_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(x17), .c(new_n127_), .d(x11), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x15), .O(new_n172_));
  nor2   g128(.a(x31), .b(new_n89_), .O(new_n173_));
  nor2   g129(.a(new_n127_), .b(x15), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n173_), .c(new_n135_), .d(x10), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n161_), .c(new_n107_), .O(new_n177_));
  nand2  g133(.a(x33), .b(x31), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n177_), .c(new_n125_), .O(new_n179_));
  nand4  g135(.a(new_n137_), .b(new_n161_), .c(x31), .d(x30), .O(new_n180_));
  ...
  nand2  g141(.a(new_n150_), .b(new_n89_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n186_), .c(new_n185_), .d(new_n143_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n183_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n179_), .c(new_n78_), .O(new_n193_));
  nor2   g149(.a(new_n193_), .b(new_n160_), .O(z9));
endmodule
