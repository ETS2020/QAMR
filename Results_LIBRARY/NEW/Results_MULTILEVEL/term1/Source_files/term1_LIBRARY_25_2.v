...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n90_), .c(new_n87_), .d(x18), .O(new_n115_));
  ...
  nand3  g083(.a(x19), .b(new_n80_), .c(x13), .O(new_n128_));
  ...
  oai21  g111(.a(new_n88_), .b(new_n155_), .c(new_n80_), .O(new_n156_));
  ...
  aoi21  g134(.a(new_n88_), .b(x14), .c(new_n80_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n80_), .b(new_n153_), .c(new_n85_), .O(new_n187_));
  nand2  g143(.a(new_n80_), .b(new_n155_), .O(new_n188_));
