...
module FAU ( 
  ...
  nand3  g070(.a(x19), .b(new_n85_), .c(x13), .O(new_n115_));
  ...
  nand4  g086(.a(new_n130_), .b(new_n114_), .c(z0), .d(x31), .O(new_n131_));
  and2   g087(.a(x16), .b(x10), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n124_), .c(x15), .O(new_n133_));
  nand2  g089(.a(x19), .b(x18), .O(new_n134_));
  nand2  g090(.a(x17), .b(x11), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n134_), .c(new_n122_), .O(new_n136_));
  inv1   g092(.a(x12), .O(new_n137_));
  oai21  g093(.a(new_n134_), .b(new_n137_), .c(new_n82_), .O(new_n138_));
  inv1   g094(.a(x13), .O(new_n139_));
  oai21  g095(.a(new_n116_), .b(new_n139_), .c(new_n85_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x15), .O(new_n141_));
  oai22  g097(.a(new_n141_), .b(new_n123_), .c(x19), .d(x14), .O(new_n142_));
  nand3  g098(.a(x29), .b(new_n97_), .c(new_n78_), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  oai21  g100(.a(x30), .b(x29), .c(x31), .O(new_n145_));
  nor3   g101(.a(new_n145_), .b(new_n144_), .c(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n140_), .c(new_n138_), .d(new_n136_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n133_), .c(x32), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n131_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n77_), .c(x00), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(z8));
  inv1   g107(.a(x31), .O(new_n152_));
  inv1   g108(.a(x33), .O(new_n153_));
  nand4  g109(.a(new_n130_), .b(new_n113_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  aoi21  g110(.a(new_n116_), .b(x14), .c(new_n85_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(x17), .c(x16), .d(x15), .O(new_n156_));
  nand2  g112(.a(x18), .b(x17), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n141_), .c(new_n116_), .O(new_n158_));
  nand3  g114(.a(new_n132_), .b(x18), .c(x17), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n122_), .O(new_n161_));
  oai21  g117(.a(new_n85_), .b(new_n137_), .c(new_n82_), .O(new_n162_));
  nand2  g118(.a(new_n85_), .b(new_n139_), .O(new_n163_));
  nor2   g119(.a(x31), .b(x30), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n161_), .O(new_n165_));
  aoi21  g121(.a(new_n159_), .b(new_n128_), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n158_), .c(new_n156_), .d(new_n113_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x33), .O(new_n168_));
  oai21  g124(.a(new_n154_), .b(x30), .c(new_n168_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n77_), .c(x00), .O(new_n170_));
