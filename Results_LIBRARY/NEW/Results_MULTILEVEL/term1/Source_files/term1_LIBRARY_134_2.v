...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n86_), .c(new_n85_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n89_), .c(new_n84_), .d(new_n82_), .O(new_n100_));
  ...
  nand3  g063(.a(x29), .b(new_n86_), .c(new_n85_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n89_), .c(new_n84_), .O(new_n109_));
  ...
  nor2   g069(.a(new_n80_), .b(new_n85_), .O(new_n114_));
  nor3   g070(.a(new_n88_), .b(new_n83_), .c(new_n81_), .O(new_n115_));
  ...
  nand4  g079(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(new_n124_));
  ...
  oai21  g122(.a(new_n138_), .b(new_n166_), .c(new_n85_), .O(new_n167_));
  ...
  oai21  g153(.a(new_n85_), .b(new_n164_), .c(new_n136_), .O(new_n198_));
  nand2  g154(.a(new_n85_), .b(new_n166_), .O(new_n199_));
