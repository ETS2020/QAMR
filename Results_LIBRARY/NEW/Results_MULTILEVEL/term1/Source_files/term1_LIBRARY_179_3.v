...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n97_), .c(new_n59_), .d(new_n83_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n82_), .c(new_n57_), .O(z6));
  nor2   g072(.a(new_n112_), .b(new_n103_), .O(new_n117_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n123_), .d(new_n112_), .O(new_n180_));
