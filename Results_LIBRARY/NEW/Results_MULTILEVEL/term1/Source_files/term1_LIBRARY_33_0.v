...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n89_), .c(new_n58_), .d(new_n78_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n77_), .c(new_n56_), .O(z5));
  nand2  g058(.a(x29), .b(x28), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n85_), .c(new_n84_), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n88_), .b(new_n83_), .c(new_n81_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(x29), .d(x28), .O(new_n107_));
  ...
  and2   g066(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  nor3   g067(.a(x27), .b(x23), .c(x18), .O(new_n112_));
  ...
  nor2   g072(.a(new_n105_), .b(new_n96_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n98_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n88_), .b(new_n86_), .c(new_n83_), .d(new_n81_), .O(new_n120_));
  nor2   g076(.a(new_n57_), .b(new_n56_), .O(new_n121_));
  inv1   g077(.a(new_n98_), .O(new_n122_));
  ...
  nor2   g086(.a(new_n128_), .b(new_n96_), .O(new_n131_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n133_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n135_), .b(new_n162_), .c(new_n84_), .O(new_n163_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n123_), .d(new_n105_), .O(new_n182_));
  ...
  aoi21  g141(.a(new_n135_), .b(x14), .c(new_n84_), .O(new_n186_));
  ...
  oai21  g149(.a(new_n84_), .b(new_n160_), .c(new_n133_), .O(new_n194_));
  nand2  g150(.a(new_n84_), .b(new_n162_), .O(new_n195_));
