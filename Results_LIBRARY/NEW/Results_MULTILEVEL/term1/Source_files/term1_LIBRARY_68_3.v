...
module FAU ( 
  ...
  nand3  g059(.a(new_n88_), .b(new_n82_), .c(x16), .O(new_n104_));
  ...
  nand4  g102(.a(new_n143_), .b(x16), .c(new_n80_), .d(x10), .O(new_n147_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n142_), .c(new_n80_), .O(new_n154_));
  nand2  g110(.a(x17), .b(x11), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n140_), .c(new_n139_), .O(new_n156_));
  inv1   g112(.a(x12), .O(new_n157_));
  oai21  g113(.a(new_n140_), .b(new_n157_), .c(new_n130_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n133_), .b(new_n159_), .c(new_n131_), .O(new_n160_));
  nor2   g116(.a(x19), .b(x14), .O(new_n161_));
  nor2   g117(.a(new_n139_), .b(new_n80_), .O(new_n162_));
  ...
  oai21  g143(.a(new_n186_), .b(new_n153_), .c(new_n80_), .O(new_n188_));
