...
module FAU ( 
  ...
  nand4  g099(.a(new_n143_), .b(new_n141_), .c(x17), .d(x10), .O(new_n144_));
  ...
  aoi21  g110(.a(x15), .b(x12), .c(x17), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  oai21  g112(.a(new_n80_), .b(new_n156_), .c(new_n128_), .O(new_n157_));
  nand2  g113(.a(x19), .b(x10), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n80_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nand2  g116(.a(new_n130_), .b(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n141_), .b(x17), .c(x15), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n155_), .c(x16), .O(new_n164_));
  nand2  g120(.a(new_n141_), .b(x16), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n127_), .O(new_n166_));
  oai21  g122(.a(new_n130_), .b(new_n142_), .c(new_n128_), .O(new_n167_));
  nand3  g123(.a(x19), .b(x15), .c(x11), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n142_), .c(new_n119_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n166_), .d(new_n164_), .O(new_n170_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n184_), .c(new_n80_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n184_), .b(new_n189_), .c(new_n142_), .O(new_n190_));
  nand2  g146(.a(x18), .b(x12), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n127_), .O(new_n192_));
  nand2  g148(.a(new_n128_), .b(new_n156_), .O(new_n193_));
  xnor2a g149(.a(x31), .b(x30), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n193_), .c(new_n192_), .d(new_n190_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n188_), .c(new_n186_), .d(new_n183_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(x33), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n181_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n178_), .c(new_n78_), .O(new_n200_));
  nor2   g156(.a(new_n200_), .b(new_n124_), .O(z9));
endmodule
