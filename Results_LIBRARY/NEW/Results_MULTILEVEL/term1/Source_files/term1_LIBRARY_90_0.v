...
module FAU ( 
  ...
  inv1   g134(.a(new_n150_), .O(new_n179_));
  xnor2a g135(.a(x31), .b(x30), .O(new_n180_));
  and2   g136(.a(new_n180_), .b(new_n159_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n179_), .c(x33), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n178_), .c(new_n173_), .O(new_n184_));
