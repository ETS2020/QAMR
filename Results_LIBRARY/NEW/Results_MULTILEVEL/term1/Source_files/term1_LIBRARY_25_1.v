...
module FAU ( 
  ...
  oai21  g111(.a(new_n83_), .b(new_n155_), .c(new_n88_), .O(new_n156_));
  ...
  aoi21  g134(.a(new_n83_), .b(x14), .c(new_n88_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n88_), .b(new_n153_), .c(new_n80_), .O(new_n187_));
