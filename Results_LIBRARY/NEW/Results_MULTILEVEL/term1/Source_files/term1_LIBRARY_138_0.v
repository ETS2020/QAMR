...
module FAU ( 
  ...
  nor2   g087(.a(new_n131_), .b(x17), .O(new_n132_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n134_), .c(x11), .O(new_n138_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n127_), .c(z0), .d(x31), .O(new_n144_));
  ...
  nor2   g103(.a(new_n134_), .b(new_n141_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n135_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n131_), .c(new_n141_), .O(new_n152_));
  inv1   g108(.a(x11), .O(new_n153_));
  oai21  g109(.a(new_n131_), .b(new_n153_), .c(new_n134_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n86_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  aoi21  g113(.a(new_n148_), .b(new_n137_), .c(new_n157_), .O(new_n158_));
  ...
  nand4  g118(.a(new_n162_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n163_));
  ...
  nand4  g124(.a(new_n143_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  ...
  nand4  g129(.a(new_n143_), .b(new_n168_), .c(new_n118_), .d(new_n107_), .O(new_n174_));
  ...
  nand2  g135(.a(x18), .b(x16), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n141_), .c(new_n89_), .O(new_n181_));
  inv1   g137(.a(x10), .O(new_n182_));
  oai21  g138(.a(new_n180_), .b(new_n182_), .c(new_n141_), .O(new_n183_));
  oai21  g139(.a(new_n86_), .b(new_n153_), .c(new_n134_), .O(new_n184_));
  nand2  g140(.a(new_n86_), .b(new_n155_), .O(new_n185_));
