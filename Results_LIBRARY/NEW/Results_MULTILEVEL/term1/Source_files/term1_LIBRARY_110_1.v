...
module FAU ( 
  ...
  inv1   g057(.a(new_n80_), .O(new_n102_));
  ...
  inv1   g063(.a(new_n81_), .O(new_n108_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n105_), .c(x29), .O(new_n129_));
  nor2   g085(.a(new_n127_), .b(new_n95_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n105_), .c(new_n129_), .O(new_n131_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n131_), .c(z0), .d(x31), .O(new_n151_));
  ...
  oai21  g117(.a(new_n134_), .b(new_n161_), .c(new_n132_), .O(new_n162_));
  ...
  aoi21  g122(.a(new_n114_), .b(x28), .c(new_n166_), .O(new_n167_));
  ...
  nand3  g134(.a(new_n178_), .b(new_n128_), .c(x29), .O(new_n179_));
  inv1   g135(.a(new_n130_), .O(new_n180_));
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n122_), .d(new_n105_), .O(new_n181_));
  ...
  oai21  g148(.a(new_n132_), .b(new_n159_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n132_), .b(new_n161_), .O(new_n194_));
