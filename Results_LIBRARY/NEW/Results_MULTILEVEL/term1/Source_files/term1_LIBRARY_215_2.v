...
module FAU ( 
  ...
  nand4  g044(.a(new_n88_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n89_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n86_), .c(new_n87_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n101_));
  ...
  nand3  g063(.a(x29), .b(new_n87_), .c(new_n86_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n85_), .c(new_n83_), .O(new_n109_));
  ...
  nor3   g069(.a(new_n84_), .b(new_n82_), .c(new_n87_), .O(new_n114_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n122_));
  ...
  nand4  g089(.a(x30), .b(new_n86_), .c(x18), .d(x14), .O(new_n134_));
  ...
  nor2   g095(.a(new_n86_), .b(new_n132_), .O(new_n140_));
  ...
  oai21  g124(.a(new_n86_), .b(new_n168_), .c(new_n132_), .O(new_n169_));
  nand2  g125(.a(x16), .b(x15), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n141_), .c(x31), .O(new_n171_));
  aoi21  g127(.a(new_n86_), .b(new_n152_), .c(new_n171_), .O(new_n172_));
  ...
  nand4  g141(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nor2   g143(.a(x33), .b(x31), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n99_), .d(x18), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n185_), .c(new_n130_), .O(new_n190_));
  aoi21  g146(.a(new_n86_), .b(x14), .c(new_n132_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x17), .c(x16), .d(x15), .O(new_n192_));
  nand2  g148(.a(x18), .b(x17), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n170_), .c(new_n86_), .O(new_n194_));
  ...
  nand2  g156(.a(new_n132_), .b(new_n168_), .O(new_n201_));
