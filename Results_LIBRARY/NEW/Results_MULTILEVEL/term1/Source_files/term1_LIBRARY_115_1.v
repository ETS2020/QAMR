...
module FAU ( 
  ...
  nor2   g098(.a(new_n131_), .b(x17), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n126_), .c(x16), .O(new_n144_));
  ...
  nand3  g103(.a(new_n147_), .b(new_n142_), .c(x30), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n141_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(z0), .c(x31), .O(new_n150_));
  nand2  g106(.a(new_n112_), .b(x27), .O(new_n151_));
  oai21  g107(.a(x30), .b(x27), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n99_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n133_), .c(new_n138_), .O(new_n155_));
  nand2  g111(.a(x17), .b(x11), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n131_), .c(new_n130_), .O(new_n157_));
  inv1   g113(.a(x12), .O(new_n158_));
  oai21  g114(.a(new_n131_), .b(new_n158_), .c(new_n83_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n89_), .b(new_n160_), .c(new_n86_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nor2   g118(.a(new_n130_), .b(new_n138_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n134_), .c(new_n162_), .O(new_n164_));
  oai21  g120(.a(x30), .b(x29), .c(x31), .O(new_n165_));
  aoi21  g121(.a(new_n112_), .b(x28), .c(new_n165_), .O(new_n166_));
  ...
  nand4  g130(.a(new_n140_), .b(new_n174_), .c(new_n118_), .d(new_n107_), .O(new_n175_));
  ...
  nand4  g134(.a(new_n147_), .b(new_n174_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n118_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n123_), .c(x29), .O(new_n182_));
  aoi21  g138(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x17), .c(x16), .d(x15), .O(new_n184_));
  inv1   g140(.a(new_n163_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x17), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n185_), .c(new_n89_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n154_), .c(new_n138_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n186_), .b(new_n189_), .c(new_n130_), .O(new_n190_));
  oai21  g146(.a(new_n86_), .b(new_n158_), .c(new_n83_), .O(new_n191_));
  nand2  g147(.a(new_n86_), .b(new_n160_), .O(new_n192_));
  ...
  nand3  g153(.a(new_n197_), .b(new_n182_), .c(new_n178_), .O(new_n198_));
