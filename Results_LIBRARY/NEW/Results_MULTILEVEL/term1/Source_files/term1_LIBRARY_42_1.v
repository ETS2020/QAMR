...
module FAU ( 
  ...
  nand3  g081(.a(new_n125_), .b(new_n103_), .c(x29), .O(new_n126_));
  nor2   g082(.a(new_n124_), .b(new_n94_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n103_), .c(new_n126_), .O(new_n128_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(new_n82_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n134_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n128_), .c(z0), .d(x31), .O(new_n148_));
  ...
  oai21  g112(.a(new_n138_), .b(new_n156_), .c(new_n82_), .O(new_n157_));
  inv1   g113(.a(x13), .O(new_n158_));
  oai21  g114(.a(new_n131_), .b(new_n158_), .c(new_n129_), .O(new_n159_));
  ...
  aoi21  g119(.a(new_n111_), .b(x28), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g129(.a(x33), .b(new_n119_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n125_), .c(x29), .O(new_n176_));
  inv1   g132(.a(new_n127_), .O(new_n177_));
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n119_), .d(new_n103_), .O(new_n178_));
  ...
  oai21  g145(.a(new_n129_), .b(new_n156_), .c(new_n82_), .O(new_n190_));
  nand2  g146(.a(new_n129_), .b(new_n158_), .O(new_n191_));
