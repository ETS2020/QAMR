// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:55 2020
...
module FAU ( 
  ...
  nand3  g053(.a(x30), .b(x28), .c(x27), .O(new_n98_));
  ...
  oai21  g061(.a(new_n100_), .b(new_n105_), .c(x30), .O(new_n106_));
  ...
  nor2   g065(.a(new_n100_), .b(new_n105_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x31), .O(new_n112_));
  nand4  g068(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n113_));
  inv1   g069(.a(x31), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x29), .c(x28), .d(x27), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n78_), .c(x25), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n57_), .c(new_n56_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n113_), .c(new_n112_), .O(z7));
  ...
  nand3  g079(.a(x19), .b(new_n86_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n89_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n83_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n127_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n123_), .c(z0), .d(x31), .O(new_n139_));
  oai21  g095(.a(new_n110_), .b(new_n121_), .c(new_n79_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n131_), .c(new_n136_), .O(new_n142_));
  nand2  g098(.a(x19), .b(x18), .O(new_n143_));
  nand2  g099(.a(x17), .b(x11), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n130_), .O(new_n145_));
  inv1   g101(.a(x12), .O(new_n146_));
  oai21  g102(.a(new_n143_), .b(new_n146_), .c(new_n83_), .O(new_n147_));
  inv1   g103(.a(x13), .O(new_n148_));
  oai21  g104(.a(new_n89_), .b(new_n148_), .c(new_n86_), .O(new_n149_));
  nor2   g105(.a(x19), .b(x14), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n131_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nor2   g109(.a(new_n121_), .b(new_n100_), .O(new_n154_));
  oai21  g110(.a(x30), .b(x29), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n154_), .b(x27), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n153_), .c(new_n149_), .d(new_n147_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n145_), .c(new_n142_), .d(new_n140_), .O(new_n159_));
  ...
  aoi21  g119(.a(new_n133_), .b(new_n129_), .c(new_n136_), .O(new_n164_));
  inv1   g120(.a(new_n137_), .O(new_n165_));
  oai21  g121(.a(new_n121_), .b(new_n79_), .c(new_n105_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x31), .c(x29), .O(new_n167_));
  nand2  g123(.a(x29), .b(x27), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n114_), .c(new_n121_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  oai21  g126(.a(new_n165_), .b(new_n164_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n89_), .b(x14), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x18), .c(x17), .d(x16), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n136_), .O(new_n174_));
  nand2  g130(.a(new_n119_), .b(x31), .O(new_n175_));
  nor2   g131(.a(new_n86_), .b(new_n83_), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n151_), .c(new_n89_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n141_), .c(new_n136_), .O(new_n179_));
  aoi21  g135(.a(new_n176_), .b(x11), .c(x16), .O(new_n180_));
  oai21  g136(.a(new_n86_), .b(new_n146_), .c(new_n83_), .O(new_n181_));
  nand2  g137(.a(new_n86_), .b(new_n148_), .O(new_n182_));
  nand2  g138(.a(new_n114_), .b(x30), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .d(new_n122_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n179_), .c(new_n178_), .d(new_n175_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n174_), .c(x33), .O(new_n187_));
  oai21  g143(.a(new_n171_), .b(x33), .c(new_n187_), .O(new_n188_));
