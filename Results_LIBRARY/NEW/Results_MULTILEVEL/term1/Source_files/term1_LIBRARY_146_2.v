...
module FAU ( 
  ...
  inv1   g031(.a(x04), .O(new_n76_));
  inv1   g032(.a(x07), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(x06), .c(new_n50_), .O(new_n78_));
  oai21  g034(.a(new_n77_), .b(new_n50_), .c(new_n78_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n76_), .c(new_n57_), .O(new_n80_));
  nand3  g036(.a(x07), .b(x06), .c(new_n50_), .O(new_n81_));
  oai21  g037(.a(x07), .b(new_n50_), .c(new_n81_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(x04), .c(new_n47_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n69_), .O(new_n85_));
  nand3  g041(.a(new_n77_), .b(x05), .c(new_n47_), .O(new_n86_));
  oai21  g042(.a(new_n77_), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  nand3  g043(.a(new_n87_), .b(new_n76_), .c(new_n57_), .O(new_n88_));
  nand3  g044(.a(x07), .b(x05), .c(new_n47_), .O(new_n89_));
  oai21  g045(.a(x07), .b(new_n47_), .c(new_n89_), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(x04), .c(new_n50_), .O(new_n91_));
