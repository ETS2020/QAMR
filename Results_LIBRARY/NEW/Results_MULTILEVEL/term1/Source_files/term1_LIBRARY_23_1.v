...
module FAU ( 
  ...
  aoi21  g106(.a(new_n150_), .b(new_n148_), .c(x19), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n149_), .c(new_n141_), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  oai21  g111(.a(new_n149_), .b(new_n155_), .c(new_n135_), .O(new_n156_));
  nand2  g112(.a(x18), .b(x12), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n83_), .O(new_n158_));
  nor2   g114(.a(x18), .b(x13), .O(new_n159_));
  aoi21  g115(.a(new_n148_), .b(new_n137_), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n154_), .c(new_n152_), .d(new_n147_), .O(new_n165_));
  ...
  nand3  g125(.a(x32), .b(new_n89_), .c(new_n169_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n168_), .c(new_n123_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n143_), .b(new_n172_), .c(x31), .d(x30), .O(new_n173_));
  ...
  nand4  g133(.a(new_n143_), .b(new_n172_), .c(new_n118_), .d(new_n107_), .O(new_n178_));
  ...
  and2   g138(.a(new_n182_), .b(new_n160_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n151_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n181_), .c(new_n176_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n78_), .O(new_n187_));
  nor2   g143(.a(new_n172_), .b(new_n86_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n148_), .c(x17), .d(new_n169_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n187_), .c(new_n123_), .O(z9));
endmodule
