...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n84_), .c(new_n82_), .O(new_n93_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n92_), .c(new_n82_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n58_), .d(x29), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nand3  g063(.a(new_n94_), .b(new_n107_), .c(x28), .O(new_n108_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n90_), .c(new_n87_), .d(new_n82_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n100_), .O(new_n114_));
  nand2  g070(.a(new_n93_), .b(new_n107_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x30), .O(new_n117_));
  nor2   g073(.a(new_n80_), .b(new_n101_), .O(new_n118_));
  nor2   g074(.a(new_n91_), .b(new_n81_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x30), .O(new_n120_));
  ...
  nor2   g080(.a(new_n103_), .b(new_n107_), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n100_), .c(x31), .O(new_n127_));
  nand4  g083(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(new_n128_));
  nor2   g084(.a(new_n57_), .b(new_n56_), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x30), .c(x29), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n100_), .c(new_n78_), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n77_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(z7));
  nor2   g090(.a(x28), .b(x27), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n103_), .c(x29), .O(new_n137_));
  nor2   g093(.a(new_n135_), .b(new_n107_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n103_), .c(new_n137_), .O(new_n139_));
  nand3  g095(.a(x19), .b(new_n85_), .c(x13), .O(new_n140_));
  nand3  g096(.a(new_n88_), .b(x18), .c(x14), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(new_n101_), .O(new_n142_));
  nand4  g098(.a(x19), .b(x18), .c(new_n101_), .d(x12), .O(new_n143_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n139_), .c(z0), .d(x31), .O(new_n157_));
  inv1   g113(.a(x28), .O(new_n158_));
  nand2  g114(.a(new_n103_), .b(new_n79_), .O(new_n159_));
  oai21  g115(.a(new_n126_), .b(new_n79_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n149_), .c(new_n154_), .O(new_n163_));
  nand2  g119(.a(x17), .b(x11), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n147_), .c(new_n146_), .O(new_n165_));
  inv1   g121(.a(x12), .O(new_n166_));
  oai21  g122(.a(new_n147_), .b(new_n166_), .c(new_n101_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  oai21  g124(.a(new_n88_), .b(new_n168_), .c(new_n85_), .O(new_n169_));
  nor2   g125(.a(x19), .b(x14), .O(new_n170_));
  nor2   g126(.a(new_n146_), .b(new_n154_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n150_), .c(new_n170_), .O(new_n172_));
  oai21  g128(.a(x30), .b(x29), .c(x31), .O(new_n173_));
  aoi21  g129(.a(new_n125_), .b(x28), .c(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n169_), .d(new_n167_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n177_));
  ...
  nand2  g139(.a(x33), .b(new_n130_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n136_), .c(x29), .O(new_n186_));
  inv1   g142(.a(new_n138_), .O(new_n187_));
  nand4  g143(.a(new_n156_), .b(new_n182_), .c(new_n130_), .d(new_n103_), .O(new_n188_));
  ...
  aoi21  g147(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(x17), .c(x16), .d(x15), .O(new_n193_));
  inv1   g149(.a(new_n171_), .O(new_n194_));
  nand2  g150(.a(x18), .b(x17), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n194_), .c(new_n88_), .O(new_n196_));
  oai21  g152(.a(new_n195_), .b(new_n162_), .c(new_n154_), .O(new_n197_));
  inv1   g153(.a(x11), .O(new_n198_));
  oai21  g154(.a(new_n195_), .b(new_n198_), .c(new_n146_), .O(new_n199_));
  oai21  g155(.a(new_n85_), .b(new_n166_), .c(new_n101_), .O(new_n200_));
  nand2  g156(.a(new_n85_), .b(new_n168_), .O(new_n201_));
  xnor2a g157(.a(x31), .b(x30), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(new_n201_), .c(new_n200_), .d(new_n199_), .O(new_n203_));
  inv1   g159(.a(new_n203_), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(new_n197_), .c(new_n196_), .d(new_n193_), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(x33), .O(new_n206_));
  nand3  g162(.a(new_n206_), .b(new_n191_), .c(new_n186_), .O(new_n207_));
