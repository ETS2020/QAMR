...
module FAU ( 
  ...
  nand2  g016(.a(x02), .b(new_n60_), .O(new_n61_));
  oai21  g017(.a(x06), .b(x02), .c(new_n61_), .O(new_n62_));
  nand3  g018(.a(new_n62_), .b(x05), .c(new_n47_), .O(new_n63_));
  nand2  g019(.a(x05), .b(new_n47_), .O(new_n64_));
  nand4  g020(.a(new_n64_), .b(x06), .c(new_n50_), .d(new_n60_), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(new_n63_), .c(new_n59_), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n56_), .O(new_n67_));
  ...
  inv1   g028(.a(new_n64_), .O(new_n73_));
  nand3  g029(.a(new_n58_), .b(x06), .c(x05), .O(new_n74_));
  oai21  g030(.a(new_n73_), .b(x06), .c(new_n74_), .O(new_n75_));
  ...
  inv1   g040(.a(new_n57_), .O(new_n85_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n82_), .c(new_n60_), .O(z3));
  xor2a  g056(.a(x28), .b(x27), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n98_), .c(new_n85_), .d(new_n83_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n82_), .c(new_n60_), .O(z4));
  inv1   g059(.a(x29), .O(new_n104_));
  inv1   g060(.a(x28), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n84_), .O(new_n106_));
  nand3  g062(.a(new_n104_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n104_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n98_), .c(new_n85_), .d(new_n83_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n82_), .c(new_n60_), .O(z5));
  ...
  nand4  g071(.a(new_n115_), .b(new_n98_), .c(new_n85_), .d(new_n83_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n82_), .c(new_n60_), .O(z6));
  nor2   g073(.a(new_n113_), .b(new_n104_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n106_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x31), .O(new_n120_));
  nand4  g076(.a(new_n97_), .b(new_n94_), .c(new_n91_), .d(new_n88_), .O(new_n121_));
  nor2   g077(.a(new_n57_), .b(new_n60_), .O(new_n122_));
  inv1   g078(.a(new_n106_), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x30), .c(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n83_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n82_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n113_), .c(x29), .O(new_n131_));
  nor2   g087(.a(new_n129_), .b(new_n104_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n113_), .c(new_n131_), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n92_), .c(x13), .O(new_n134_));
  nand3  g090(.a(new_n95_), .b(x18), .c(x14), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n134_), .c(new_n89_), .O(new_n136_));
  nand4  g092(.a(x19), .b(x18), .c(new_n89_), .d(x12), .O(new_n137_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n140_), .c(x11), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n139_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(z0), .d(x31), .O(new_n151_));
  nand2  g107(.a(new_n118_), .b(x27), .O(new_n152_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n143_), .c(new_n148_), .O(new_n156_));
  nand2  g112(.a(x17), .b(x11), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n141_), .c(new_n140_), .O(new_n158_));
  inv1   g114(.a(x12), .O(new_n159_));
  oai21  g115(.a(new_n141_), .b(new_n159_), .c(new_n89_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n95_), .b(new_n161_), .c(new_n92_), .O(new_n162_));
  nor2   g118(.a(x19), .b(x14), .O(new_n163_));
  nor2   g119(.a(new_n140_), .b(new_n148_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n144_), .c(new_n163_), .O(new_n165_));
  oai21  g121(.a(x30), .b(x29), .c(x31), .O(new_n166_));
  aoi21  g122(.a(new_n118_), .b(x28), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n165_), .c(new_n162_), .d(new_n160_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x32), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n151_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n83_), .c(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  inv1   g130(.a(x33), .O(new_n175_));
  nand4  g131(.a(new_n150_), .b(new_n175_), .c(x31), .d(x30), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n124_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n130_), .c(x29), .O(new_n179_));
  inv1   g135(.a(new_n132_), .O(new_n180_));
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n124_), .d(new_n113_), .O(new_n181_));
  ...
  aoi21  g140(.a(new_n95_), .b(x14), .c(new_n92_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x17), .c(x16), .d(x15), .O(new_n186_));
  inv1   g142(.a(new_n164_), .O(new_n187_));
  nand2  g143(.a(x18), .b(x17), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n95_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n155_), .c(new_n148_), .O(new_n190_));
  inv1   g146(.a(x11), .O(new_n191_));
  oai21  g147(.a(new_n188_), .b(new_n191_), .c(new_n140_), .O(new_n192_));
  oai21  g148(.a(new_n92_), .b(new_n159_), .c(new_n89_), .O(new_n193_));
  nand2  g149(.a(new_n92_), .b(new_n161_), .O(new_n194_));
  ...
  nand3  g156(.a(new_n200_), .b(new_n83_), .c(x00), .O(new_n201_));
