...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n77_), .c(new_n56_), .O(z6));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x31), .O(new_n109_));
  nand4  g065(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(x29), .c(x28), .d(x27), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n78_), .c(x25), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n57_), .c(new_n56_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n110_), .c(new_n109_), .O(z7));
  inv1   g071(.a(x30), .O(new_n116_));
  nor2   g072(.a(x28), .b(x27), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n116_), .c(x29), .O(new_n119_));
  nor2   g075(.a(new_n117_), .b(new_n100_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n116_), .c(new_n119_), .O(new_n121_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n121_), .c(z0), .d(x31), .O(new_n139_));
  nor2   g095(.a(new_n116_), .b(new_n100_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x27), .O(new_n141_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n129_), .c(new_n128_), .O(new_n147_));
  inv1   g103(.a(x12), .O(new_n148_));
  oai21  g104(.a(new_n129_), .b(new_n148_), .c(new_n83_), .O(new_n149_));
  inv1   g105(.a(x13), .O(new_n150_));
  oai21  g106(.a(new_n89_), .b(new_n150_), .c(new_n86_), .O(new_n151_));
  nor2   g107(.a(x19), .b(x14), .O(new_n152_));
  nor2   g108(.a(new_n128_), .b(new_n136_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n132_), .c(new_n152_), .O(new_n154_));
  oai21  g110(.a(x30), .b(x29), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n140_), .b(x28), .c(new_n155_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n154_), .c(new_n151_), .d(new_n149_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n159_));
  ...
  nand4  g120(.a(new_n138_), .b(new_n164_), .c(x31), .d(x30), .O(new_n165_));
  nand2  g121(.a(x33), .b(new_n116_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n118_), .c(x29), .O(new_n168_));
  inv1   g124(.a(new_n120_), .O(new_n169_));
  nand4  g125(.a(new_n138_), .b(new_n164_), .c(new_n111_), .d(new_n116_), .O(new_n170_));
  ...
  aoi21  g129(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x17), .c(x16), .d(x15), .O(new_n175_));
  inv1   g131(.a(new_n153_), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n176_), .c(new_n89_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n144_), .c(new_n136_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n128_), .O(new_n181_));
  oai21  g137(.a(new_n86_), .b(new_n148_), .c(new_n83_), .O(new_n182_));
  nand2  g138(.a(new_n86_), .b(new_n150_), .O(new_n183_));
  nand2  g139(.a(new_n111_), .b(x30), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n181_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n179_), .c(new_n178_), .d(new_n175_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n173_), .c(new_n168_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n78_), .c(x00), .O(new_n190_));
