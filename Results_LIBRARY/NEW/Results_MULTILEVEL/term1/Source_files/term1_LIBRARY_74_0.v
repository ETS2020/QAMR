...
module FAU ( 
  ...
  nand2  g054(.a(x30), .b(new_n98_), .O(new_n99_));
  nand2  g055(.a(x28), .b(x27), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n92_), .O(new_n101_));
  nand4  g057(.a(new_n92_), .b(new_n98_), .c(x28), .d(x27), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n56_), .O(z5));
  nand2  g061(.a(new_n100_), .b(x30), .O(new_n106_));
  ...
  oai21  g069(.a(new_n100_), .b(new_n113_), .c(x31), .O(new_n114_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n100_), .c(new_n78_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n77_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n116_), .c(new_n115_), .d(new_n114_), .O(z7));
  inv1   g077(.a(x28), .O(new_n122_));
  nand2  g078(.a(new_n107_), .b(new_n79_), .O(new_n123_));
  oai21  g079(.a(new_n113_), .b(new_n79_), .c(new_n123_), .O(new_n124_));
  ...
  nand3  g086(.a(new_n130_), .b(x17), .c(x11), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  aoi21  g088(.a(new_n130_), .b(x12), .c(x17), .O(new_n133_));
  inv1   g089(.a(x13), .O(new_n134_));
  oai21  g090(.a(new_n89_), .b(new_n134_), .c(new_n86_), .O(new_n135_));
  inv1   g091(.a(x14), .O(new_n136_));
  nand2  g092(.a(new_n89_), .b(new_n136_), .O(new_n137_));
  inv1   g093(.a(new_n127_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x16), .c(x15), .O(new_n139_));
  aoi21  g095(.a(new_n112_), .b(x28), .c(new_n117_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n139_), .c(new_n137_), .d(new_n135_), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n133_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n132_), .c(new_n128_), .O(new_n143_));
  aoi21  g099(.a(new_n124_), .b(new_n122_), .c(new_n143_), .O(new_n144_));
  oai21  g100(.a(x28), .b(x27), .c(new_n107_), .O(new_n145_));
  nand3  g101(.a(x30), .b(new_n122_), .c(new_n79_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n145_), .c(x29), .O(new_n147_));
  ...
  nand3  g109(.a(new_n138_), .b(new_n129_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand4  g112(.a(new_n138_), .b(x16), .c(new_n125_), .d(x10), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n147_), .c(z0), .d(x31), .O(new_n159_));
  oai21  g115(.a(new_n144_), .b(z0), .c(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n78_), .c(x00), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(z8));
  inv1   g118(.a(x00), .O(new_n163_));
  nor2   g119(.a(x28), .b(x27), .O(new_n164_));
  aoi21  g120(.a(new_n157_), .b(new_n156_), .c(x33), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x31), .c(x30), .d(x29), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n107_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand2  g124(.a(x33), .b(x18), .O(new_n169_));
  nor2   g125(.a(x27), .b(x18), .O(new_n170_));
  nor2   g126(.a(x30), .b(x28), .O(new_n171_));
  nor2   g127(.a(x33), .b(x31), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(x13), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n169_), .c(new_n89_), .O(new_n174_));
  nand2  g130(.a(x33), .b(new_n136_), .O(new_n175_));
  nor2   g131(.a(x27), .b(x19), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n172_), .c(new_n171_), .d(x14), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n175_), .c(new_n86_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n174_), .c(x17), .O(new_n179_));
  nor3   g135(.a(x33), .b(x31), .c(x30), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n152_), .c(new_n164_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n129_), .O(new_n182_));
  nand2  g138(.a(new_n180_), .b(new_n164_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n154_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n182_), .c(x15), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  inv1   g142(.a(x10), .O(new_n187_));
  nor2   g143(.a(x15), .b(new_n187_), .O(new_n188_));
  nor2   g144(.a(new_n83_), .b(new_n129_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n188_), .c(new_n180_), .d(new_n130_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n186_), .c(x28), .O(new_n191_));
  nand2  g147(.a(x16), .b(x15), .O(new_n192_));
  nand2  g148(.a(x18), .b(x17), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n192_), .c(new_n89_), .O(new_n194_));
  oai21  g150(.a(new_n193_), .b(new_n126_), .c(new_n125_), .O(new_n195_));
  inv1   g151(.a(x11), .O(new_n196_));
  oai21  g152(.a(new_n193_), .b(new_n196_), .c(new_n129_), .O(new_n197_));
  nand2  g153(.a(new_n117_), .b(x30), .O(new_n198_));
  nand2  g154(.a(x18), .b(x12), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n83_), .O(new_n200_));
  nand2  g156(.a(new_n86_), .b(new_n134_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n200_), .c(new_n198_), .d(x29), .O(new_n202_));
  inv1   g158(.a(new_n202_), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n197_), .c(new_n195_), .d(new_n194_), .O(new_n204_));
  aoi22  g160(.a(new_n204_), .b(x33), .c(new_n191_), .d(new_n79_), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(new_n185_), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n168_), .c(new_n78_), .O(new_n207_));
  nor2   g163(.a(new_n207_), .b(new_n163_), .O(z9));
endmodule
