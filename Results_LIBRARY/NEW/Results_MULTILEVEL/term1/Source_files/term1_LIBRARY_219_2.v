...
module FAU ( 
  ...
  inv1   g123(.a(x00), .O(new_n168_));
  inv1   g124(.a(x33), .O(new_n169_));
  nand3  g125(.a(new_n142_), .b(new_n169_), .c(new_n118_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n107_), .c(new_n126_), .O(new_n171_));
  aoi21  g127(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x17), .c(x16), .d(x15), .O(new_n173_));
  nand3  g129(.a(new_n124_), .b(new_n118_), .c(x29), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n157_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n89_), .O(new_n178_));
  nand3  g134(.a(new_n176_), .b(x16), .c(x10), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n175_), .b(new_n180_), .c(new_n134_), .O(new_n181_));
  oai21  g137(.a(new_n86_), .b(new_n152_), .c(new_n83_), .O(new_n182_));
  nand2  g138(.a(new_n86_), .b(new_n154_), .O(new_n183_));
  nand2  g139(.a(x31), .b(new_n107_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n181_), .O(new_n185_));
  aoi21  g141(.a(new_n179_), .b(new_n140_), .c(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n178_), .c(new_n174_), .d(new_n173_), .O(new_n187_));
  and2   g143(.a(new_n187_), .b(x33), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n171_), .c(new_n78_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n168_), .O(z9));
endmodule
