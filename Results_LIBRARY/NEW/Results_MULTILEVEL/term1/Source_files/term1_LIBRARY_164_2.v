// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:37 2020
...
module FAU ( 
  ...
  nand2  g034(.a(x30), .b(x27), .O(new_n79_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n98_), .c(x29), .O(new_n100_));
  ...
  oai21  g062(.a(new_n101_), .b(new_n99_), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(x27), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n77_), .c(new_n56_), .O(z6));
  nand2  g066(.a(x29), .b(x28), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n98_), .c(x31), .O(new_n112_));
  ...
  nand3  g076(.a(new_n106_), .b(x29), .c(x28), .O(new_n121_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n122_), .c(z0), .d(x31), .O(new_n138_));
  oai21  g094(.a(new_n101_), .b(new_n98_), .c(x30), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n99_), .O(new_n140_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n129_), .O(new_n145_));
  ...
  nor2   g109(.a(new_n106_), .b(new_n101_), .O(new_n154_));
  ...
  aoi21  g119(.a(new_n132_), .b(new_n128_), .c(new_n135_), .O(new_n164_));
  inv1   g120(.a(new_n136_), .O(new_n165_));
  oai21  g121(.a(new_n106_), .b(new_n99_), .c(new_n98_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x31), .c(x29), .O(new_n167_));
  nand3  g123(.a(new_n111_), .b(new_n114_), .c(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  oai21  g125(.a(new_n165_), .b(new_n164_), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n89_), .b(x14), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x18), .c(x17), .d(x16), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n135_), .O(new_n173_));
  nand2  g129(.a(new_n119_), .b(x31), .O(new_n174_));
  nor2   g130(.a(new_n86_), .b(new_n83_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n151_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n141_), .c(new_n135_), .O(new_n178_));
  aoi21  g134(.a(new_n175_), .b(x11), .c(x16), .O(new_n179_));
  oai21  g135(.a(new_n86_), .b(new_n146_), .c(new_n83_), .O(new_n180_));
  nand2  g136(.a(new_n86_), .b(new_n148_), .O(new_n181_));
  nand2  g137(.a(new_n114_), .b(x30), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n121_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n178_), .c(new_n177_), .d(new_n174_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n173_), .c(x33), .O(new_n186_));
  oai21  g142(.a(new_n170_), .b(x33), .c(new_n186_), .O(new_n187_));
