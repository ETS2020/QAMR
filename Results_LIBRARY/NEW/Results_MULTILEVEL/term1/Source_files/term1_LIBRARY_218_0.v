// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:54 2020
...
module FAU ( 
  ...
  xor2a  g051(.a(x29), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n93_), .c(new_n78_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n77_), .c(new_n56_), .O(z5));
  inv1   g054(.a(x29), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n79_), .c(x30), .O(new_n100_));
  inv1   g056(.a(x30), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x29), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n79_), .c(new_n100_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n77_), .c(new_n56_), .O(z6));
  nand2  g061(.a(x30), .b(x29), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n79_), .c(x31), .O(new_n107_));
  nand4  g063(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n108_));
  inv1   g064(.a(x31), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(x30), .c(x29), .d(x27), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n78_), .c(x25), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n57_), .c(new_n56_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n108_), .c(new_n107_), .O(z7));
  nand2  g069(.a(x30), .b(new_n99_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n102_), .O(new_n115_));
  nand3  g071(.a(x19), .b(new_n86_), .c(x13), .O(new_n116_));
  nand3  g072(.a(new_n89_), .b(x18), .c(x14), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(new_n83_), .O(new_n118_));
  nand4  g074(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n119_));
  ...
  nand4  g084(.a(new_n124_), .b(x16), .c(new_n128_), .d(x10), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n115_), .c(z0), .d(x31), .O(new_n131_));
  nand2  g087(.a(x16), .b(x10), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n124_), .c(x15), .O(new_n134_));
  ...
  oai21  g096(.a(new_n89_), .b(new_n140_), .c(new_n86_), .O(new_n141_));
  nand2  g097(.a(x16), .b(x15), .O(new_n142_));
  oai22  g098(.a(new_n142_), .b(new_n123_), .c(x19), .d(x14), .O(new_n143_));
  nand2  g099(.a(new_n101_), .b(new_n99_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n106_), .c(x31), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n141_), .c(new_n139_), .d(new_n137_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n134_), .c(x32), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n131_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n78_), .c(x00), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(z8));
  inv1   g107(.a(x33), .O(new_n152_));
  nand3  g108(.a(x31), .b(x30), .c(x29), .O(new_n153_));
  nand3  g109(.a(new_n109_), .b(new_n101_), .c(new_n99_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n130_), .c(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n89_), .b(x14), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(x18), .c(x17), .d(x16), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n128_), .O(new_n159_));
  nand2  g115(.a(x18), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n142_), .c(new_n89_), .O(new_n161_));
  oai21  g117(.a(new_n160_), .b(new_n132_), .c(new_n128_), .O(new_n162_));
  inv1   g118(.a(x11), .O(new_n163_));
  oai21  g119(.a(new_n160_), .b(new_n163_), .c(new_n122_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  nand2  g121(.a(new_n109_), .b(x30), .O(new_n166_));
  nand2  g122(.a(new_n86_), .b(new_n140_), .O(new_n167_));
  nand2  g123(.a(x31), .b(new_n99_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n102_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n164_), .c(new_n162_), .d(new_n161_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n159_), .c(x33), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n156_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n78_), .c(x00), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(z9));
  nor3   g131(.a(new_n94_), .b(new_n77_), .c(new_n56_), .O(z4));
endmodule
