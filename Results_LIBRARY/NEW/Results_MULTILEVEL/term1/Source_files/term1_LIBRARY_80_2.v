...
module FAU ( 
  ...
  aoi21  g097(.a(new_n99_), .b(new_n79_), .c(new_n98_), .O(new_n142_));
  nand2  g098(.a(x16), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n133_), .c(new_n138_), .O(new_n144_));
  nand2  g100(.a(x17), .b(x11), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n131_), .c(new_n130_), .O(new_n146_));
  inv1   g102(.a(x12), .O(new_n147_));
  oai21  g103(.a(new_n131_), .b(new_n147_), .c(new_n83_), .O(new_n148_));
  aoi21  g104(.a(x19), .b(x13), .c(x18), .O(new_n149_));
  nor2   g105(.a(x19), .b(x14), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n133_), .c(x31), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n148_), .c(new_n146_), .d(new_n144_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n142_), .c(x32), .O(new_n155_));
  ...
  nand4  g115(.a(new_n140_), .b(new_n122_), .c(new_n159_), .d(x31), .O(new_n160_));
  aoi21  g116(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x17), .c(x16), .d(x15), .O(new_n162_));
  nor2   g118(.a(new_n86_), .b(new_n83_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n151_), .c(new_n89_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n143_), .c(new_n138_), .O(new_n166_));
  aoi21  g122(.a(new_n163_), .b(x11), .c(x16), .O(new_n167_));
  oai21  g123(.a(new_n86_), .b(new_n147_), .c(new_n83_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  nand2  g125(.a(new_n86_), .b(new_n169_), .O(new_n170_));
  nor2   g126(.a(new_n117_), .b(new_n98_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n168_), .d(new_n122_), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n167_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n166_), .c(new_n165_), .d(new_n162_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  oai21  g131(.a(new_n160_), .b(new_n98_), .c(new_n175_), .O(new_n176_));
