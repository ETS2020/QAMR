...
module FAU ( 
  ...
  nand2  g111(.a(new_n155_), .b(new_n86_), .O(new_n156_));
  inv1   g112(.a(x14), .O(new_n157_));
  nor2   g113(.a(new_n134_), .b(new_n142_), .O(new_n158_));
  aoi22  g114(.a(new_n158_), .b(new_n138_), .c(new_n89_), .d(new_n157_), .O(new_n159_));
