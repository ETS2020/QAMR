...
module FAU ( 
  ...
  nor3   g067(.a(x27), .b(x21), .c(x16), .O(new_n112_));
  ...
  nor2   g086(.a(new_n130_), .b(new_n95_), .O(new_n131_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(x30), .O(new_n140_));
  ...
  oai21  g099(.a(new_n140_), .b(new_n80_), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x15), .O(new_n145_));
  nor2   g101(.a(new_n80_), .b(x15), .O(new_n146_));
  nor2   g102(.a(new_n133_), .b(new_n132_), .O(new_n147_));
  nor2   g103(.a(new_n104_), .b(new_n135_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(x10), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(z0), .c(x31), .O(new_n151_));
  nand2  g107(.a(x32), .b(new_n104_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n151_), .c(new_n131_), .O(new_n153_));
  inv1   g109(.a(new_n130_), .O(new_n154_));
  oai21  g110(.a(new_n139_), .b(new_n137_), .c(x15), .O(new_n155_));
  inv1   g111(.a(x15), .O(new_n156_));
  nand3  g112(.a(new_n142_), .b(new_n156_), .c(x10), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n154_), .c(z0), .d(x31), .O(new_n159_));
  nand2  g115(.a(new_n96_), .b(new_n79_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(x32), .c(x30), .O(new_n161_));
  oai21  g117(.a(new_n159_), .b(x30), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x29), .O(new_n163_));
  and2   g119(.a(x16), .b(x10), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n142_), .c(x15), .O(new_n165_));
  nor2   g121(.a(new_n135_), .b(new_n133_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x17), .c(x11), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n80_), .O(new_n168_));
  nand2  g124(.a(new_n166_), .b(x12), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n132_), .O(new_n170_));
  inv1   g126(.a(x13), .O(new_n171_));
  oai21  g127(.a(new_n135_), .b(new_n171_), .c(new_n133_), .O(new_n172_));
  nor2   g128(.a(x19), .b(x14), .O(new_n173_));
  nand2  g129(.a(x16), .b(x15), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n141_), .c(x31), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n165_), .c(x32), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n163_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n153_), .c(new_n78_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n129_), .O(z8));
  inv1   g137(.a(x33), .O(new_n182_));
  nand3  g138(.a(new_n150_), .b(new_n182_), .c(x31), .O(new_n183_));
  nand2  g139(.a(x33), .b(new_n124_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n154_), .c(x29), .O(new_n186_));
  inv1   g142(.a(new_n131_), .O(new_n187_));
  nand4  g143(.a(new_n158_), .b(new_n182_), .c(new_n124_), .d(new_n104_), .O(new_n188_));
  oai21  g144(.a(new_n182_), .b(new_n124_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n135_), .b(x14), .c(new_n133_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(x17), .c(x16), .d(x15), .O(new_n191_));
  inv1   g147(.a(new_n174_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n147_), .c(x19), .O(new_n193_));
  aoi21  g149(.a(new_n164_), .b(new_n147_), .c(x15), .O(new_n194_));
  aoi21  g150(.a(new_n147_), .b(x11), .c(x16), .O(new_n195_));
  nand2  g151(.a(x18), .b(x12), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n132_), .O(new_n197_));
  nand2  g153(.a(new_n133_), .b(new_n171_), .O(new_n198_));
  xnor2a g154(.a(x31), .b(x30), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n198_), .c(new_n197_), .O(new_n200_));
  nor4   g156(.a(new_n200_), .b(new_n195_), .c(new_n194_), .d(new_n193_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n191_), .c(new_n182_), .O(new_n202_));
  aoi21  g158(.a(new_n189_), .b(new_n187_), .c(new_n202_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n186_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n78_), .c(x00), .O(new_n205_));
