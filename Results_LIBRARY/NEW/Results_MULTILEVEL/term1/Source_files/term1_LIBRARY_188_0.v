...
module FAU ( 
  ...
  oai21  g061(.a(new_n105_), .b(x02), .c(x03), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  oai21  g063(.a(new_n98_), .b(new_n99_), .c(new_n47_), .O(new_n108_));
  nand4  g064(.a(new_n105_), .b(x29), .c(x28), .d(new_n50_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g067(.a(x29), .b(x28), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x30), .c(new_n50_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n111_), .c(new_n107_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n92_), .c(new_n78_), .d(x25), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n56_), .O(z6));
  nor2   g072(.a(new_n105_), .b(new_n98_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n100_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n120_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n105_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n98_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n105_), .c(new_n130_), .O(new_n132_));
  nand3  g088(.a(x19), .b(new_n86_), .c(x13), .O(new_n133_));
  nand3  g089(.a(new_n89_), .b(x18), .c(x14), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n83_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n136_));
  ...
  oai21  g114(.a(new_n140_), .b(new_n158_), .c(new_n83_), .O(new_n159_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n123_), .d(new_n105_), .O(new_n180_));
  ...
  oai21  g147(.a(new_n86_), .b(new_n158_), .c(new_n83_), .O(new_n192_));
  nand2  g148(.a(new_n86_), .b(new_n160_), .O(new_n193_));
