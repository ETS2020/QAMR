// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:50 2020
...
module FAU ( 
  ...
  nand4  g082(.a(x30), .b(x19), .c(new_n86_), .d(x13), .O(new_n127_));
  ...
  nand3  g100(.a(x18), .b(new_n83_), .c(x12), .O(new_n145_));
  nand3  g101(.a(new_n86_), .b(x17), .c(x13), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n133_), .O(new_n147_));
  nand4  g103(.a(x18), .b(x17), .c(new_n133_), .d(x11), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n147_), .c(x15), .O(new_n150_));
  nand4  g106(.a(new_n138_), .b(x16), .c(new_n125_), .d(x10), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n150_), .c(new_n122_), .O(new_n152_));
  ...
  oai21  g111(.a(new_n153_), .b(new_n89_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x29), .O(new_n157_));
  and2   g113(.a(x16), .b(x10), .O(new_n158_));
  nor2   g114(.a(new_n89_), .b(new_n86_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x17), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n158_), .c(x15), .O(new_n162_));
  nand3  g118(.a(new_n159_), .b(x17), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n133_), .O(new_n164_));
  nand2  g120(.a(new_n159_), .b(x12), .O(new_n165_));
  ...
  nor2   g125(.a(new_n133_), .b(new_n125_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n161_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x31), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n162_), .c(x32), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n157_), .c(new_n144_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n78_), .c(x00), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  oai21  g135(.a(new_n140_), .b(new_n136_), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n117_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n117_), .c(new_n181_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n123_), .c(x29), .O(new_n183_));
  nand2  g139(.a(new_n151_), .b(new_n150_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n179_), .c(new_n117_), .d(new_n107_), .O(new_n185_));
  oai22  g141(.a(new_n185_), .b(new_n89_), .c(new_n179_), .d(new_n117_), .O(new_n186_));
  aoi21  g142(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x17), .c(x16), .d(x15), .O(new_n188_));
  aoi21  g144(.a(new_n170_), .b(new_n138_), .c(x19), .O(new_n189_));
  aoi21  g145(.a(new_n158_), .b(new_n138_), .c(x15), .O(new_n190_));
  aoi21  g146(.a(new_n138_), .b(x11), .c(x16), .O(new_n191_));
  oai21  g147(.a(new_n86_), .b(new_n129_), .c(new_n83_), .O(new_n192_));
  nand2  g148(.a(new_n86_), .b(new_n167_), .O(new_n193_));
  xnor2a g149(.a(x31), .b(x30), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n193_), .c(new_n192_), .O(new_n195_));
  nor4   g151(.a(new_n195_), .b(new_n191_), .c(new_n190_), .d(new_n189_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n188_), .c(new_n179_), .O(new_n197_));
  aoi21  g153(.a(new_n186_), .b(new_n124_), .c(new_n197_), .O(new_n198_));
