...
module FAU ( 
  ...
  nor2   g124(.a(new_n89_), .b(new_n83_), .O(new_n169_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n166_), .c(x18), .O(new_n174_));
  ...
  nand4  g134(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n179_));
  nor2   g135(.a(new_n89_), .b(x18), .O(new_n180_));
  ...
  nand3  g139(.a(x19), .b(new_n83_), .c(x12), .O(new_n184_));
  nand3  g140(.a(new_n89_), .b(x17), .c(x14), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n184_), .c(new_n136_), .O(new_n186_));
  nand4  g142(.a(x19), .b(x17), .c(new_n136_), .d(x11), .O(new_n187_));
  ...
  nand4  g147(.a(new_n191_), .b(x31), .c(x30), .d(x18), .O(new_n192_));
  ...
  nand4  g154(.a(new_n191_), .b(new_n118_), .c(new_n107_), .d(x18), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand2  g156(.a(new_n89_), .b(x14), .O(new_n201_));
  ...
  nand2  g159(.a(new_n203_), .b(x18), .O(new_n204_));
