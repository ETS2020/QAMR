...
module FAU ( 
  ...
  nand3  g091(.a(new_n135_), .b(x30), .c(x15), .O(new_n136_));
  ...
  nand3  g095(.a(new_n139_), .b(z0), .c(x31), .O(new_n140_));
  nand2  g096(.a(x32), .b(new_n107_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n124_), .O(new_n143_));
  aoi21  g099(.a(new_n134_), .b(new_n130_), .c(new_n122_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(z0), .c(x31), .d(new_n107_), .O(new_n145_));
  nand2  g101(.a(new_n99_), .b(new_n79_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x32), .c(x30), .O(new_n147_));
  oai21  g103(.a(new_n145_), .b(new_n137_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n137_), .b(x10), .c(new_n89_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x18), .c(x17), .d(x16), .O(new_n150_));
  nor2   g106(.a(new_n89_), .b(new_n86_), .O(new_n151_));
  nor2   g107(.a(new_n83_), .b(new_n131_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n151_), .c(x15), .O(new_n153_));
  and2   g109(.a(x17), .b(x11), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n151_), .c(x16), .O(new_n155_));
  aoi21  g111(.a(new_n151_), .b(x12), .c(x17), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n89_), .b(new_n157_), .c(new_n86_), .O(new_n158_));
  inv1   g114(.a(x14), .O(new_n159_));
  aoi21  g115(.a(new_n89_), .b(new_n159_), .c(new_n117_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nor4   g117(.a(new_n161_), .b(new_n156_), .c(new_n155_), .d(new_n153_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n150_), .c(z0), .O(new_n163_));
  aoi21  g119(.a(new_n148_), .b(x29), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n143_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n78_), .c(x00), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand3  g124(.a(new_n139_), .b(new_n168_), .c(x31), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n117_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n123_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n135_), .b(new_n168_), .c(new_n117_), .d(new_n107_), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(new_n137_), .c(new_n168_), .d(new_n117_), .O(new_n174_));
  oai21  g130(.a(x19), .b(new_n159_), .c(x15), .O(new_n175_));
  oai21  g131(.a(new_n89_), .b(x10), .c(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x18), .c(x17), .d(x16), .O(new_n177_));
  nor2   g133(.a(new_n86_), .b(new_n83_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(x16), .c(x19), .O(new_n179_));
  aoi21  g135(.a(new_n178_), .b(x11), .c(x16), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n83_), .O(new_n182_));
  nand2  g138(.a(new_n86_), .b(new_n157_), .O(new_n183_));
  xnor2a g139(.a(x31), .b(x30), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .O(new_n185_));
  nor4   g141(.a(new_n185_), .b(new_n180_), .c(new_n179_), .d(new_n153_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n177_), .c(new_n168_), .O(new_n187_));
  aoi21  g143(.a(new_n174_), .b(new_n124_), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n172_), .O(new_n189_));
