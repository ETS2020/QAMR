...
module FAU ( 
  ...
  nand4  g084(.a(new_n78_), .b(new_n83_), .c(x18), .d(x14), .O(new_n129_));
  ...
  nor2   g095(.a(x26), .b(new_n83_), .O(new_n140_));
  nor2   g096(.a(new_n135_), .b(x15), .O(new_n141_));
  nor2   g097(.a(new_n88_), .b(new_n80_), .O(new_n142_));
  ...
  oai21  g109(.a(new_n151_), .b(new_n153_), .c(new_n135_), .O(new_n154_));
  ...
  oai22  g114(.a(new_n158_), .b(new_n157_), .c(x19), .d(x14), .O(new_n159_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n148_), .c(new_n78_), .O(new_n164_));
  nand2  g120(.a(x15), .b(x13), .O(new_n165_));
  ...
  aoi21  g125(.a(new_n169_), .b(new_n145_), .c(new_n122_), .O(z8));
  ...
  nand4  g132(.a(new_n144_), .b(new_n171_), .c(new_n117_), .d(new_n106_), .O(new_n177_));
  nand3  g133(.a(x33), .b(x31), .c(new_n78_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n83_), .b(x14), .O(new_n180_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n149_), .c(new_n83_), .O(new_n184_));
  inv1   g140(.a(x10), .O(new_n185_));
  oai21  g141(.a(new_n183_), .b(new_n185_), .c(new_n149_), .O(new_n186_));
