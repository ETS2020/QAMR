...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n58_), .c(new_n79_), .d(new_n78_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n77_), .c(new_n56_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n58_), .d(new_n78_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n94_), .c(new_n58_), .d(new_n78_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n77_), .c(new_n56_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n58_), .d(new_n78_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n77_), .c(new_n56_), .O(z6));
  nor2   g069(.a(new_n109_), .b(new_n100_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n102_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x31), .O(new_n116_));
  nand2  g072(.a(new_n83_), .b(new_n81_), .O(new_n117_));
  nand2  g073(.a(new_n93_), .b(x20), .O(new_n118_));
  oai21  g074(.a(x20), .b(new_n80_), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n90_), .c(new_n87_), .d(new_n117_), .O(new_n120_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n109_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n100_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n109_), .c(new_n130_), .O(new_n132_));
  ...
  nand3  g098(.a(new_n142_), .b(new_n81_), .c(x11), .O(new_n143_));
  ...
  nand2  g104(.a(new_n114_), .b(x27), .O(new_n149_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n139_), .c(new_n81_), .O(new_n155_));
  inv1   g111(.a(x12), .O(new_n156_));
  oai21  g112(.a(new_n139_), .b(new_n156_), .c(new_n85_), .O(new_n157_));
  nand2  g113(.a(x19), .b(x13), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n88_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nor2   g116(.a(new_n81_), .b(new_n80_), .O(new_n161_));
  aoi22  g117(.a(new_n161_), .b(new_n142_), .c(new_n91_), .d(new_n160_), .O(new_n162_));
  oai21  g118(.a(x30), .b(x29), .c(x31), .O(new_n163_));
  aoi21  g119(.a(new_n114_), .b(x28), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g129(.a(x33), .b(new_n123_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n129_), .c(x29), .O(new_n176_));
  inv1   g132(.a(new_n131_), .O(new_n177_));
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n123_), .d(new_n109_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n88_), .b(x13), .c(new_n91_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x17), .c(x16), .d(x15), .O(new_n183_));
  inv1   g139(.a(new_n161_), .O(new_n184_));
  nand2  g140(.a(x19), .b(x17), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(new_n88_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n152_), .c(new_n80_), .O(new_n187_));
  nand2  g143(.a(new_n91_), .b(new_n160_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(new_n189_), .c(new_n81_), .O(new_n190_));
  oai21  g146(.a(new_n91_), .b(new_n156_), .c(new_n85_), .O(new_n191_));
  xnor2a g147(.a(x31), .b(x30), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n191_), .c(new_n190_), .d(new_n188_), .O(new_n193_));
