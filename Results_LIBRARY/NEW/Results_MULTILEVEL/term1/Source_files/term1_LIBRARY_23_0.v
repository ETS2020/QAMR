...
module FAU ( 
  ...
  nand2  g084(.a(new_n89_), .b(x18), .O(new_n129_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n147_), .c(x19), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n148_), .c(new_n140_), .O(new_n153_));
  inv1   g109(.a(x11), .O(new_n154_));
  oai21  g110(.a(new_n148_), .b(new_n154_), .c(new_n134_), .O(new_n155_));
  nand2  g111(.a(x18), .b(x12), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n83_), .O(new_n157_));
  nor2   g113(.a(x18), .b(x13), .O(new_n158_));
  aoi21  g114(.a(new_n147_), .b(new_n136_), .c(new_n158_), .O(new_n159_));
  oai21  g115(.a(x30), .b(x29), .c(x31), .O(new_n160_));
  aoi21  g116(.a(new_n112_), .b(x28), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n153_), .c(new_n151_), .d(new_n146_), .O(new_n164_));
  ...
  nand4  g125(.a(new_n142_), .b(new_n169_), .c(x31), .d(x30), .O(new_n170_));
  ...
  nand4  g130(.a(new_n142_), .b(new_n169_), .c(new_n118_), .d(new_n107_), .O(new_n175_));
  ...
  and2   g135(.a(new_n179_), .b(new_n159_), .O(new_n180_));
  ...
  nand3  g138(.a(new_n182_), .b(new_n178_), .c(new_n173_), .O(new_n183_));
