...
module FAU ( 
  ...
  nand2  g078(.a(new_n112_), .b(x27), .O(new_n123_));
  oai21  g079(.a(x30), .b(x27), .c(new_n123_), .O(new_n124_));
  ...
  nor2   g086(.a(new_n89_), .b(new_n86_), .O(new_n131_));
  ...
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n145_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n78_), .c(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  inv1   g120(.a(new_n146_), .O(new_n165_));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n159_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n118_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n165_), .c(x29), .O(new_n170_));
  nand2  g126(.a(new_n165_), .b(x29), .O(new_n171_));
  nand4  g127(.a(new_n159_), .b(new_n166_), .c(new_n118_), .d(new_n107_), .O(new_n172_));
  ...
  oai21  g136(.a(new_n179_), .b(new_n127_), .c(new_n126_), .O(new_n181_));
  ...
  nand2  g141(.a(new_n86_), .b(new_n135_), .O(new_n186_));
  ...
  nand3  g147(.a(new_n191_), .b(new_n175_), .c(new_n170_), .O(new_n192_));
