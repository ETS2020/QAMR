...
module FAU ( 
  ...
  xor2a  g077(.a(x30), .b(x27), .O(new_n122_));
  nand2  g078(.a(x30), .b(x28), .O(new_n123_));
  oai21  g079(.a(new_n122_), .b(x28), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x29), .O(new_n125_));
  nand4  g081(.a(z0), .b(x31), .c(x30), .d(x19), .O(new_n126_));
  nand2  g082(.a(new_n89_), .b(x14), .O(new_n127_));
  nand3  g083(.a(z0), .b(x31), .c(x30), .O(new_n128_));
  oai22  g084(.a(new_n128_), .b(new_n127_), .c(z0), .d(new_n89_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x18), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n86_), .c(x13), .O(new_n131_));
  or2    g087(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(new_n83_), .O(new_n133_));
  inv1   g089(.a(x12), .O(new_n134_));
  nor4   g090(.a(new_n126_), .b(new_n86_), .c(x17), .d(new_n134_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(x16), .O(new_n136_));
  inv1   g092(.a(x16), .O(new_n137_));
  nand4  g093(.a(x18), .b(x17), .c(new_n137_), .d(x11), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n126_), .c(new_n136_), .O(new_n139_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n134_), .c(new_n83_), .O(new_n149_));
  aoi21  g105(.a(x19), .b(x13), .c(x18), .O(new_n150_));
  nor2   g106(.a(x19), .b(x14), .O(new_n151_));
  oai21  g107(.a(x30), .b(x29), .c(x31), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n149_), .c(new_n147_), .d(new_n144_), .O(new_n154_));
  nand4  g110(.a(x17), .b(x16), .c(new_n141_), .d(x10), .O(new_n155_));
  nor3   g111(.a(new_n155_), .b(new_n148_), .c(new_n128_), .O(new_n156_));
  aoi21  g112(.a(new_n154_), .b(x32), .c(new_n156_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n140_), .c(new_n125_), .O(new_n158_));
  ...
  aoi21  g119(.a(new_n163_), .b(new_n131_), .c(new_n83_), .O(new_n164_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n137_), .c(x11), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x15), .O(new_n171_));
  nand4  g127(.a(new_n168_), .b(x16), .c(new_n141_), .d(x10), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n162_), .c(x31), .d(x30), .O(new_n174_));
  nand2  g130(.a(x33), .b(new_n117_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n161_), .c(x29), .O(new_n177_));
  nand2  g133(.a(new_n161_), .b(x29), .O(new_n178_));
  nand4  g134(.a(new_n173_), .b(new_n162_), .c(new_n117_), .d(new_n107_), .O(new_n179_));
  ...
  oai21  g143(.a(new_n142_), .b(new_n185_), .c(new_n141_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(new_n189_), .c(new_n137_), .O(new_n190_));
  oai21  g146(.a(new_n86_), .b(new_n134_), .c(new_n83_), .O(new_n191_));
  inv1   g147(.a(x13), .O(new_n192_));
  nand2  g148(.a(new_n86_), .b(new_n192_), .O(new_n193_));
  nand2  g149(.a(x31), .b(new_n107_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n193_), .c(new_n191_), .d(new_n190_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n188_), .c(new_n187_), .d(new_n184_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(x33), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n182_), .c(new_n177_), .O(new_n199_));
