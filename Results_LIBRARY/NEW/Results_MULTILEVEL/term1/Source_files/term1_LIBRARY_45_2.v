...
module FAU ( 
  ...
  nand4  g085(.a(x31), .b(new_n89_), .c(x18), .d(x14), .O(new_n130_));
  ...
  nand3  g094(.a(new_n138_), .b(new_n135_), .c(x11), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n134_), .c(new_n128_), .O(new_n140_));
  nand3  g096(.a(x16), .b(new_n128_), .c(x10), .O(new_n141_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n137_), .c(new_n128_), .O(new_n148_));
  nand3  g104(.a(new_n136_), .b(x17), .c(x11), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n135_), .O(new_n150_));
  nand2  g106(.a(new_n136_), .b(x12), .O(new_n151_));
  ...
  nor2   g111(.a(new_n135_), .b(new_n128_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n138_), .c(new_n155_), .O(new_n157_));
  ...
  oai21  g119(.a(new_n143_), .b(x32), .c(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n78_), .c(x00), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  oai21  g123(.a(new_n142_), .b(new_n140_), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n118_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n107_), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n124_), .c(x29), .O(new_n171_));
  nand2  g127(.a(x33), .b(x31), .O(new_n172_));
  nand4  g128(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nor2   g130(.a(x33), .b(x31), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n174_), .c(new_n107_), .d(x18), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n172_), .c(new_n126_), .O(new_n177_));
  aoi21  g133(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x17), .c(x16), .d(x15), .O(new_n179_));
  inv1   g135(.a(new_n156_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n180_), .c(new_n89_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n147_), .c(new_n128_), .O(new_n183_));
  inv1   g139(.a(x11), .O(new_n184_));
  oai21  g140(.a(new_n181_), .b(new_n184_), .c(new_n135_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x12), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n83_), .O(new_n187_));
  nand2  g143(.a(new_n86_), .b(new_n153_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n183_), .c(new_n182_), .d(new_n179_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(x33), .c(new_n177_), .O(new_n193_));
