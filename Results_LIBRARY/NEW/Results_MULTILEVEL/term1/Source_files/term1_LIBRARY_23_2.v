...
module FAU ( 
  ...
  aoi21  g078(.a(new_n99_), .b(new_n79_), .c(x30), .O(new_n123_));
  nand2  g079(.a(new_n99_), .b(new_n79_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x29), .O(new_n125_));
  aoi22  g081(.a(new_n125_), .b(x30), .c(new_n123_), .d(x29), .O(new_n126_));
  inv1   g082(.a(x16), .O(new_n127_));
  nand3  g083(.a(x18), .b(new_n83_), .c(x12), .O(new_n128_));
  nand3  g084(.a(new_n86_), .b(x17), .c(x13), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nand4  g086(.a(x18), .b(x17), .c(new_n127_), .d(x11), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x15), .O(new_n133_));
  inv1   g089(.a(x15), .O(new_n134_));
  nor2   g090(.a(new_n86_), .b(new_n83_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x16), .c(new_n134_), .d(x10), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n126_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(z0), .c(x31), .d(x19), .O(new_n138_));
  nand2  g094(.a(new_n86_), .b(x13), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x17), .c(x16), .d(x15), .O(new_n140_));
  nand2  g096(.a(new_n112_), .b(x27), .O(new_n141_));
  oai21  g097(.a(x30), .b(x27), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n99_), .O(new_n143_));
  nand2  g099(.a(x17), .b(x16), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n134_), .c(new_n86_), .O(new_n145_));
  inv1   g101(.a(new_n144_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x10), .c(x15), .O(new_n147_));
  nand2  g103(.a(x17), .b(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n127_), .O(new_n149_));
  inv1   g105(.a(x12), .O(new_n150_));
  aoi21  g106(.a(new_n83_), .b(new_n150_), .c(new_n89_), .O(new_n151_));
  nand2  g107(.a(new_n112_), .b(x28), .O(new_n152_));
  aoi21  g108(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n149_), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  ...
  aoi21  g116(.a(new_n136_), .b(new_n133_), .c(x33), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x31), .c(x30), .d(x19), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n118_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n124_), .c(x29), .O(new_n165_));
  nand4  g121(.a(new_n161_), .b(new_n118_), .c(new_n107_), .d(x19), .O(new_n166_));
  nand2  g122(.a(x33), .b(x31), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n125_), .O(new_n169_));
  inv1   g125(.a(new_n140_), .O(new_n170_));
  inv1   g126(.a(new_n147_), .O(new_n171_));
  xnor2a g127(.a(x31), .b(x30), .O(new_n172_));
  and2   g128(.a(new_n172_), .b(new_n151_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n149_), .c(new_n171_), .d(new_n145_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n170_), .c(x33), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n169_), .c(new_n165_), .O(new_n176_));
