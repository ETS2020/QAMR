...
module FAU ( 
  ...
  nand4  g080(.a(new_n124_), .b(new_n107_), .c(x29), .d(x00), .O(new_n125_));
  ...
  nand3  g099(.a(new_n107_), .b(new_n79_), .c(x00), .O(new_n144_));
  ...
  aoi21  g104(.a(new_n148_), .b(new_n136_), .c(x15), .O(new_n149_));
  ...
  oai22  g113(.a(new_n157_), .b(new_n135_), .c(x19), .d(x14), .O(new_n158_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n149_), .c(x00), .O(new_n162_));
  nand2  g118(.a(new_n113_), .b(x28), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n162_), .c(new_n146_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x32), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n143_), .c(x26), .O(z8));
  inv1   g122(.a(new_n126_), .O(new_n167_));
  inv1   g123(.a(x33), .O(new_n168_));
  aoi21  g124(.a(new_n141_), .b(new_n139_), .c(x33), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n118_), .c(new_n107_), .d(x00), .O(new_n170_));
  oai21  g126(.a(new_n168_), .b(new_n107_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand4  g128(.a(new_n142_), .b(new_n168_), .c(x31), .d(x30), .O(new_n173_));
  nand3  g129(.a(x33), .b(new_n118_), .c(x00), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n173_), .c(new_n123_), .O(new_n175_));
  ...
  oai21  g135(.a(new_n178_), .b(new_n147_), .c(new_n140_), .O(new_n180_));
  ...
  nand2  g141(.a(x31), .b(new_n107_), .O(new_n186_));
  ...
  nand3  g145(.a(new_n189_), .b(x33), .c(x00), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n175_), .b(x29), .c(new_n191_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n172_), .c(x26), .O(z9));
endmodule
