...
module FAU ( 
  ...
  nor2   g059(.a(new_n80_), .b(new_n83_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n88_), .c(new_n103_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n102_), .c(x30), .O(new_n106_));
  inv1   g062(.a(x30), .O(new_n107_));
  nand4  g063(.a(new_n89_), .b(new_n107_), .c(x29), .d(x28), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n79_), .c(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n56_), .O(z6));
  nor2   g067(.a(new_n107_), .b(new_n95_), .O(new_n112_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n115_), .c(new_n85_), .d(new_n82_), .O(new_n117_));
  ...
  nand3  g082(.a(new_n126_), .b(new_n107_), .c(x29), .O(new_n127_));
  nor2   g083(.a(new_n125_), .b(new_n95_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n107_), .c(new_n127_), .O(new_n129_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n96_), .O(new_n152_));
  ...
  oai21  g113(.a(new_n139_), .b(new_n157_), .c(new_n83_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n132_), .b(new_n159_), .c(new_n130_), .O(new_n160_));
  ...
  nand4  g134(.a(new_n148_), .b(new_n173_), .c(new_n120_), .d(new_n107_), .O(new_n179_));
  ...
  oai21  g146(.a(new_n130_), .b(new_n157_), .c(new_n83_), .O(new_n191_));
  nand2  g147(.a(new_n130_), .b(new_n159_), .O(new_n192_));
