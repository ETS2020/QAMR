...
module FAU ( 
  ...
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(z0), .O(new_n139_));
  nand2  g095(.a(x32), .b(x30), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(x30), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n124_), .c(x29), .O(new_n142_));
  nand2  g098(.a(new_n124_), .b(x29), .O(new_n143_));
  nand2  g099(.a(x32), .b(new_n107_), .O(new_n144_));
  oai21  g100(.a(new_n139_), .b(new_n107_), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g102(.a(new_n89_), .b(x14), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x18), .c(x17), .d(x16), .O(new_n148_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n125_), .O(new_n156_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n146_), .c(new_n142_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x31), .O(new_n165_));
  nand3  g121(.a(x32), .b(new_n117_), .c(new_n78_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n165_), .c(new_n122_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand2  g124(.a(new_n135_), .b(new_n131_), .O(new_n169_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n117_), .c(new_n107_), .d(new_n78_), .O(new_n173_));
  oai21  g129(.a(new_n168_), .b(new_n117_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n143_), .O(new_n175_));
  nand3  g131(.a(new_n172_), .b(x31), .c(x30), .O(new_n176_));
  nand3  g132(.a(x33), .b(new_n117_), .c(new_n78_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n176_), .c(new_n123_), .O(new_n178_));
  inv1   g134(.a(new_n159_), .O(new_n179_));
  aoi21  g135(.a(new_n117_), .b(x30), .c(new_n160_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n179_), .c(new_n158_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n156_), .c(new_n154_), .d(new_n150_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n78_), .O(new_n184_));
  nand2  g140(.a(x31), .b(new_n107_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n184_), .c(new_n168_), .O(new_n186_));
  aoi21  g142(.a(new_n178_), .b(x29), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n175_), .c(new_n122_), .O(z9));
endmodule
