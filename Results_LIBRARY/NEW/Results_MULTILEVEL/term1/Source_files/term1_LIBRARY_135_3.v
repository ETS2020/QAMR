...
module FAU ( 
  ...
  nor2   g115(.a(new_n133_), .b(new_n125_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n151_), .c(x13), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n86_), .O(new_n162_));
  inv1   g118(.a(new_n151_), .O(new_n163_));
  nand2  g119(.a(x16), .b(x10), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n125_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  oai21  g122(.a(new_n163_), .b(new_n166_), .c(new_n133_), .O(new_n167_));
  inv1   g123(.a(x12), .O(new_n168_));
  oai21  g124(.a(new_n89_), .b(new_n168_), .c(new_n83_), .O(new_n169_));
  nor2   g125(.a(x19), .b(x14), .O(new_n170_));
  nand3  g126(.a(x19), .b(x18), .c(x17), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n160_), .c(new_n170_), .O(new_n173_));
  oai21  g129(.a(x30), .b(x29), .c(x31), .O(new_n174_));
  aoi21  g130(.a(new_n112_), .b(x28), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n173_), .c(new_n169_), .d(new_n167_), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n165_), .c(new_n162_), .d(new_n159_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x32), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n156_), .O(new_n180_));
  ...
  nand2  g140(.a(new_n135_), .b(new_n132_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x15), .O(new_n186_));
  inv1   g142(.a(new_n141_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n184_), .c(new_n118_), .O(new_n189_));
  nand2  g145(.a(x33), .b(x31), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n189_), .c(new_n143_), .O(new_n191_));
  nand4  g147(.a(new_n153_), .b(new_n184_), .c(x31), .d(x30), .O(new_n192_));
  nand2  g148(.a(x33), .b(new_n118_), .O(new_n193_));
  oai21  g149(.a(new_n192_), .b(new_n86_), .c(new_n193_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n124_), .c(x29), .O(new_n195_));
  aoi21  g151(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(x17), .c(x16), .d(x15), .O(new_n197_));
  nand2  g153(.a(new_n160_), .b(new_n139_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n89_), .O(new_n199_));
  inv1   g155(.a(new_n139_), .O(new_n200_));
  oai21  g156(.a(new_n164_), .b(new_n200_), .c(new_n125_), .O(new_n201_));
  oai21  g157(.a(new_n200_), .b(new_n166_), .c(new_n133_), .O(new_n202_));
  oai21  g158(.a(new_n86_), .b(new_n168_), .c(new_n83_), .O(new_n203_));
  inv1   g159(.a(x13), .O(new_n204_));
  nand2  g160(.a(new_n86_), .b(new_n204_), .O(new_n205_));
  xnor2a g161(.a(x31), .b(x30), .O(new_n206_));
  nand4  g162(.a(new_n206_), .b(new_n205_), .c(new_n203_), .d(new_n202_), .O(new_n207_));
  inv1   g163(.a(new_n207_), .O(new_n208_));
  nand4  g164(.a(new_n208_), .b(new_n201_), .c(new_n199_), .d(new_n197_), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(x33), .O(new_n210_));
  nand2  g166(.a(new_n210_), .b(new_n195_), .O(new_n211_));
  oai21  g167(.a(new_n211_), .b(new_n191_), .c(new_n78_), .O(new_n212_));
  nor2   g168(.a(new_n212_), .b(new_n183_), .O(z9));
endmodule
