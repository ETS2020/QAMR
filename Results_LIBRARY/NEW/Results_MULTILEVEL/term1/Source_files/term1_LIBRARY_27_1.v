...
module FAU ( 
  ...
  nor3   g078(.a(new_n122_), .b(x30), .c(new_n98_), .O(new_n123_));
  aoi21  g079(.a(x30), .b(new_n98_), .c(new_n123_), .O(new_n124_));
  nand3  g080(.a(x30), .b(new_n99_), .c(new_n79_), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(x32), .c(new_n125_), .O(new_n126_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n135_), .c(x15), .O(new_n145_));
  ...
  oai22  g109(.a(new_n153_), .b(new_n134_), .c(x19), .d(x14), .O(new_n154_));
  nand2  g110(.a(new_n107_), .b(new_n98_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n113_), .c(x31), .O(new_n156_));
  ...
  inv1   g118(.a(new_n122_), .O(new_n163_));
  inv1   g119(.a(x33), .O(new_n164_));
  nand4  g120(.a(new_n141_), .b(new_n164_), .c(x31), .d(x30), .O(new_n165_));
  nand2  g121(.a(x33), .b(new_n117_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n163_), .c(x29), .O(new_n168_));
  nand2  g124(.a(new_n163_), .b(x29), .O(new_n169_));
  nand4  g125(.a(new_n141_), .b(new_n164_), .c(new_n117_), .d(new_n107_), .O(new_n170_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n153_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n143_), .c(new_n139_), .O(new_n178_));
  ...
  nand2  g138(.a(new_n86_), .b(new_n151_), .O(new_n183_));
  ...
  nand4  g142(.a(new_n186_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n187_));
