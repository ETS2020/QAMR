...
module FAU ( 
  ...
  nand2  g104(.a(x17), .b(x15), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n135_), .O(new_n150_));
  nand2  g106(.a(x17), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n148_), .c(new_n141_), .O(new_n152_));
  inv1   g108(.a(x12), .O(new_n153_));
  oai21  g109(.a(new_n148_), .b(new_n153_), .c(new_n83_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n86_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  nor2   g113(.a(new_n135_), .b(new_n141_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n137_), .c(new_n157_), .O(new_n159_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n164_));
  ...
  nand3  g124(.a(x32), .b(new_n135_), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n184_), .c(new_n182_), .d(new_n150_), .O(new_n192_));
  ...
  nand3  g151(.a(x33), .b(new_n135_), .c(new_n168_), .O(new_n196_));
