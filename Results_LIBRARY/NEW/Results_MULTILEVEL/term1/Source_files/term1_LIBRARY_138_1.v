...
module FAU ( 
  ...
  nor2   g105(.a(new_n135_), .b(new_n143_), .O(new_n150_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n136_), .c(new_n143_), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  oai21  g111(.a(new_n136_), .b(new_n155_), .c(new_n135_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n89_), .b(new_n157_), .c(new_n86_), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  aoi21  g115(.a(new_n150_), .b(new_n139_), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g120(.a(new_n164_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n165_));
  ...
  nand3  g125(.a(x32), .b(new_n83_), .c(new_n169_), .O(new_n170_));
  ...
  nand4  g133(.a(new_n145_), .b(new_n172_), .c(new_n118_), .d(new_n107_), .O(new_n178_));
  ...
  nand2  g139(.a(x18), .b(x16), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n143_), .c(new_n89_), .O(new_n185_));
  inv1   g141(.a(x10), .O(new_n186_));
  oai21  g142(.a(new_n184_), .b(new_n186_), .c(new_n143_), .O(new_n187_));
  oai21  g143(.a(new_n86_), .b(new_n155_), .c(new_n135_), .O(new_n188_));
  ...
  nand4  g148(.a(new_n192_), .b(new_n185_), .c(new_n183_), .d(new_n152_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n181_), .c(new_n176_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n78_), .O(new_n196_));
  nand3  g152(.a(x33), .b(new_n83_), .c(new_n169_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n196_), .c(new_n123_), .O(z9));
endmodule
