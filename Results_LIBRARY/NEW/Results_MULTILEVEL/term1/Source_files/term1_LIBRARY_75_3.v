...
module FAU ( 
  ...
  nand4  g067(.a(new_n58_), .b(new_n111_), .c(x29), .d(x28), .O(new_n112_));
  nand3  g068(.a(x29), .b(x28), .c(x27), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x30), .O(new_n114_));
  oai21  g070(.a(new_n112_), .b(new_n85_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n98_), .c(new_n84_), .d(x25), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n56_), .O(z6));
  nor2   g073(.a(new_n111_), .b(new_n104_), .O(new_n118_));
  ...
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n124_), .d(new_n111_), .O(new_n181_));
