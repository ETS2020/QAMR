...
module FAU ( 
  ...
  nor2   g087(.a(new_n89_), .b(new_n86_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n83_), .c(x12), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  inv1   g091(.a(x16), .O(new_n136_));
  nand2  g092(.a(new_n132_), .b(x17), .O(new_n137_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n128_), .c(z0), .d(x31), .O(new_n145_));
  ...
  nand3  g104(.a(new_n132_), .b(x17), .c(x16), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n142_), .O(new_n150_));
  nand2  g106(.a(new_n137_), .b(new_n136_), .O(new_n151_));
  oai21  g107(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand2  g109(.a(x18), .b(x14), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n89_), .O(new_n155_));
  nand2  g111(.a(new_n112_), .b(x28), .O(new_n156_));
  aoi21  g112(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n151_), .c(new_n150_), .d(new_n148_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n78_), .O(new_n161_));
  inv1   g117(.a(x10), .O(new_n162_));
  nand2  g118(.a(new_n142_), .b(new_n162_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  nand2  g120(.a(new_n136_), .b(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  inv1   g122(.a(x12), .O(new_n167_));
  nand2  g123(.a(new_n83_), .b(new_n167_), .O(new_n168_));
  nor2   g124(.a(new_n86_), .b(new_n83_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(x16), .c(x15), .O(new_n170_));
  inv1   g126(.a(x13), .O(new_n171_));
  nand2  g127(.a(new_n86_), .b(new_n171_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n170_), .c(new_n168_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n166_), .c(x19), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n161_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x32), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n145_), .c(new_n123_), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n179_));
  nor2   g135(.a(x19), .b(new_n86_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(x31), .d(x30), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(new_n179_), .c(new_n178_), .d(x31), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n78_), .O(new_n183_));
  nand3  g139(.a(x18), .b(new_n83_), .c(x12), .O(new_n184_));
  nand3  g140(.a(new_n86_), .b(x17), .c(x13), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n184_), .c(new_n136_), .O(new_n186_));
  nand4  g142(.a(x18), .b(x17), .c(new_n136_), .d(x11), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n186_), .c(x15), .O(new_n189_));
  nand4  g145(.a(new_n169_), .b(x16), .c(new_n142_), .d(x10), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n189_), .c(x33), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x31), .c(x30), .d(x19), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n183_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n125_), .c(x29), .O(new_n194_));
  inv1   g150(.a(new_n127_), .O(new_n195_));
  nand4  g151(.a(new_n180_), .b(new_n178_), .c(new_n118_), .d(new_n107_), .O(new_n196_));
  oai22  g152(.a(new_n196_), .b(new_n179_), .c(new_n178_), .d(new_n118_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n78_), .O(new_n198_));
  nand4  g154(.a(new_n191_), .b(new_n118_), .c(new_n107_), .d(x19), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand2  g156(.a(new_n86_), .b(x13), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(x17), .c(x16), .d(x15), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(new_n168_), .c(new_n165_), .d(new_n163_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(x19), .O(new_n204_));
  inv1   g160(.a(new_n150_), .O(new_n205_));
  xnor2a g161(.a(x31), .b(x30), .O(new_n206_));
  nand4  g162(.a(new_n206_), .b(new_n155_), .c(new_n152_), .d(new_n151_), .O(new_n207_));
  oai21  g163(.a(new_n207_), .b(new_n205_), .c(new_n78_), .O(new_n208_));
  aoi21  g164(.a(new_n208_), .b(new_n204_), .c(new_n178_), .O(new_n209_));
  aoi21  g165(.a(new_n200_), .b(new_n195_), .c(new_n209_), .O(new_n210_));
  aoi21  g166(.a(new_n210_), .b(new_n194_), .c(new_n123_), .O(z9));
endmodule
