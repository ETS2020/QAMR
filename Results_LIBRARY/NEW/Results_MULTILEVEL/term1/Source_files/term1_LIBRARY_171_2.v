...
module FAU ( 
  ...
  nand2  g099(.a(new_n89_), .b(x14), .O(new_n144_));
  ...
  nand2  g104(.a(new_n112_), .b(x27), .O(new_n149_));
  oai21  g105(.a(x30), .b(x27), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n99_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x15), .O(new_n152_));
  nand2  g108(.a(x18), .b(x17), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n89_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(new_n140_), .O(new_n156_));
  inv1   g112(.a(x11), .O(new_n157_));
  oai21  g113(.a(new_n153_), .b(new_n157_), .c(new_n134_), .O(new_n158_));
  ...
  nand2  g118(.a(new_n86_), .b(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n112_), .b(x28), .O(new_n164_));
  aoi21  g120(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n161_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n159_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n156_), .c(new_n154_), .d(new_n151_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n148_), .c(x32), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n143_), .O(new_n170_));
  ...
  nand4  g130(.a(new_n142_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  nand3  g131(.a(x33), .b(new_n118_), .c(new_n78_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n124_), .c(x29), .O(new_n178_));
  inv1   g134(.a(new_n126_), .O(new_n179_));
  nand4  g135(.a(new_n142_), .b(new_n174_), .c(new_n118_), .d(new_n107_), .O(new_n180_));
  nand3  g136(.a(x33), .b(x31), .c(new_n78_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  xnor2a g138(.a(x31), .b(x30), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n163_), .c(new_n161_), .d(new_n158_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n156_), .c(new_n154_), .d(new_n147_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x33), .c(new_n78_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n182_), .b(new_n179_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n178_), .c(new_n173_), .O(z9));
endmodule
