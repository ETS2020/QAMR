...
module FAU ( 
  ...
  oai21  g061(.a(new_n105_), .b(x29), .c(new_n99_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n107_));
  ...
  nand4  g066(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n111_));
  inv1   g067(.a(x31), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x29), .c(x28), .d(x27), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n78_), .c(x25), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n57_), .c(new_n56_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n111_), .c(new_n110_), .O(z7));
  oai21  g072(.a(x28), .b(x27), .c(x29), .O(new_n117_));
  nand3  g073(.a(x19), .b(new_n86_), .c(x13), .O(new_n118_));
  nand3  g074(.a(new_n89_), .b(x18), .c(x14), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(new_n83_), .O(new_n120_));
  nand4  g076(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n121_));
  ...
  nand4  g088(.a(new_n132_), .b(new_n117_), .c(z0), .d(x31), .O(new_n133_));
  oai21  g089(.a(x28), .b(x27), .c(x29), .O(new_n134_));
  nand2  g090(.a(x16), .b(x10), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n125_), .c(new_n130_), .O(new_n136_));
  nor2   g092(.a(new_n89_), .b(new_n86_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x17), .c(x11), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n124_), .O(new_n139_));
  aoi21  g095(.a(new_n137_), .b(x12), .c(x17), .O(new_n140_));
  inv1   g096(.a(x13), .O(new_n141_));
  oai21  g097(.a(new_n89_), .b(new_n141_), .c(new_n86_), .O(new_n142_));
  inv1   g098(.a(x14), .O(new_n143_));
  nand2  g099(.a(new_n89_), .b(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n126_), .b(x16), .c(x15), .O(new_n145_));
  nor2   g101(.a(new_n112_), .b(new_n105_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n142_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n140_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  oai21  g106(.a(new_n133_), .b(new_n105_), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n78_), .c(x00), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(z8));
  oai21  g109(.a(x28), .b(x27), .c(x31), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n100_), .c(x31), .d(x30), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n132_), .O(new_n156_));
  aoi21  g112(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(x17), .c(x16), .d(x15), .O(new_n158_));
  nand2  g114(.a(new_n117_), .b(x31), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n89_), .O(new_n162_));
  or2    g118(.a(new_n161_), .b(new_n135_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n161_), .b(new_n164_), .c(new_n124_), .O(new_n165_));
  nand2  g121(.a(x18), .b(x12), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n83_), .O(new_n167_));
  nand2  g123(.a(new_n86_), .b(new_n141_), .O(new_n168_));
  nand2  g124(.a(new_n112_), .b(x30), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n165_), .O(new_n170_));
  aoi21  g126(.a(new_n163_), .b(new_n130_), .c(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n162_), .c(new_n159_), .d(new_n158_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x33), .O(new_n173_));
  oai21  g129(.a(new_n156_), .b(x33), .c(new_n173_), .O(new_n174_));
