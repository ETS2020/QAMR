...
module FAU ( 
  ...
  nand2  g071(.a(new_n83_), .b(new_n81_), .O(new_n116_));
  oai21  g072(.a(new_n91_), .b(new_n80_), .c(new_n82_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n90_), .c(new_n87_), .d(new_n116_), .O(new_n118_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n81_), .c(x11), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n137_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x15), .O(new_n144_));
  nand4  g100(.a(new_n141_), .b(x16), .c(new_n80_), .d(x10), .O(new_n145_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n80_), .O(new_n152_));
  nand2  g108(.a(x17), .b(x11), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n138_), .c(new_n81_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n138_), .b(new_n155_), .c(new_n85_), .O(new_n156_));
  nand2  g112(.a(x19), .b(x13), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n88_), .O(new_n158_));
  inv1   g114(.a(x14), .O(new_n159_));
  nor2   g115(.a(new_n81_), .b(new_n80_), .O(new_n160_));
  aoi22  g116(.a(new_n160_), .b(new_n141_), .c(new_n132_), .d(new_n159_), .O(new_n161_));
  ...
  aoi21  g136(.a(new_n88_), .b(x13), .c(new_n132_), .O(new_n181_));
  ...
  oai21  g141(.a(new_n184_), .b(new_n151_), .c(new_n80_), .O(new_n186_));
  nand2  g142(.a(new_n132_), .b(new_n159_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n184_), .b(new_n188_), .c(new_n81_), .O(new_n189_));
  oai21  g145(.a(new_n132_), .b(new_n155_), .c(new_n85_), .O(new_n190_));
