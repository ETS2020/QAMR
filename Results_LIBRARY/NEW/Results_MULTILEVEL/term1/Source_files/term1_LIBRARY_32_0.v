...
module FAU ( 
  ...
  nand2  g077(.a(new_n99_), .b(new_n79_), .O(new_n122_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n83_), .c(x12), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n128_), .c(new_n124_), .O(new_n131_));
  inv1   g087(.a(x11), .O(new_n132_));
  nand2  g088(.a(new_n129_), .b(x17), .O(new_n133_));
  nor3   g089(.a(new_n133_), .b(x16), .c(new_n132_), .O(new_n134_));
  ...
  nand4  g095(.a(new_n139_), .b(z0), .c(x31), .d(x30), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nor2   g097(.a(z0), .b(x30), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(new_n123_), .O(new_n143_));
  nand3  g099(.a(new_n129_), .b(x17), .c(new_n124_), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n131_), .c(x15), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n138_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n122_), .c(z0), .d(x31), .O(new_n148_));
  nand2  g104(.a(new_n99_), .b(new_n79_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(x32), .c(x30), .O(new_n150_));
  oai21  g106(.a(new_n148_), .b(x30), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x29), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n137_), .c(x15), .O(new_n155_));
  nand3  g111(.a(new_n129_), .b(x17), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n124_), .O(new_n157_));
  nand2  g113(.a(new_n129_), .b(x12), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n83_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n89_), .b(new_n160_), .c(new_n86_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nand2  g118(.a(x16), .b(x15), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n133_), .c(x31), .O(new_n164_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n152_), .c(new_n143_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n78_), .c(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n139_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n117_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n122_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n147_), .b(new_n171_), .c(new_n117_), .d(new_n107_), .O(new_n176_));
  oai21  g132(.a(new_n171_), .b(new_n117_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n123_), .O(new_n178_));
  ...
  oai21  g138(.a(new_n181_), .b(new_n153_), .c(new_n136_), .O(new_n183_));
  oai21  g139(.a(new_n181_), .b(new_n132_), .c(new_n124_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n83_), .O(new_n186_));
  nand2  g142(.a(new_n86_), .b(new_n160_), .O(new_n187_));
  xnor2a g143(.a(x31), .b(x30), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n184_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n183_), .c(new_n182_), .d(new_n180_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n178_), .c(new_n175_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n78_), .c(x00), .O(new_n194_));
