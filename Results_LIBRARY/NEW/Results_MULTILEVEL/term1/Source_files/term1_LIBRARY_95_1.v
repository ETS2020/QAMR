...
module FAU ( 
  ...
  nand2  g078(.a(new_n99_), .b(new_n79_), .O(new_n123_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n130_), .c(x11), .O(new_n135_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n123_), .c(new_n107_), .d(x29), .O(new_n141_));
  nand2  g097(.a(new_n123_), .b(x29), .O(new_n142_));
  nand2  g098(.a(x19), .b(new_n86_), .O(new_n143_));
  aoi21  g099(.a(new_n125_), .b(new_n143_), .c(new_n83_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n128_), .c(x16), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n135_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x15), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n139_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n142_), .c(x30), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(z0), .c(x31), .O(new_n151_));
  nand2  g107(.a(new_n112_), .b(x27), .O(new_n152_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n133_), .c(new_n138_), .O(new_n156_));
  nand2  g112(.a(x17), .b(x11), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n131_), .c(new_n130_), .O(new_n158_));
  inv1   g114(.a(x12), .O(new_n159_));
  oai21  g115(.a(new_n131_), .b(new_n159_), .c(new_n83_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n89_), .b(new_n161_), .c(new_n86_), .O(new_n162_));
  nor2   g118(.a(x19), .b(x14), .O(new_n163_));
  nor2   g119(.a(new_n130_), .b(new_n138_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n134_), .c(new_n163_), .O(new_n165_));
  oai21  g121(.a(x30), .b(x29), .c(x31), .O(new_n166_));
  aoi21  g122(.a(new_n112_), .b(x28), .c(new_n166_), .O(new_n167_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n78_), .c(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  inv1   g130(.a(x33), .O(new_n175_));
  nand4  g131(.a(new_n140_), .b(new_n175_), .c(new_n118_), .d(new_n107_), .O(new_n176_));
  nand2  g132(.a(x33), .b(x31), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n142_), .O(new_n179_));
  nand4  g135(.a(new_n148_), .b(new_n175_), .c(x31), .d(x30), .O(new_n180_));
  ...
  aoi21  g139(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  inv1   g141(.a(new_n164_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n186_), .c(new_n89_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n155_), .c(new_n138_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n130_), .O(new_n191_));
  oai21  g147(.a(new_n86_), .b(new_n159_), .c(new_n83_), .O(new_n192_));
  nand2  g148(.a(new_n86_), .b(new_n161_), .O(new_n193_));
  ...
  nand3  g154(.a(new_n198_), .b(new_n183_), .c(new_n179_), .O(new_n199_));
