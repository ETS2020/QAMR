...
module FAU ( 
  ...
  nand3  g069(.a(x19), .b(new_n85_), .c(x13), .O(new_n114_));
  ...
  nand4  g073(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n118_));
  ...
  nand4  g085(.a(new_n129_), .b(z0), .c(x31), .d(new_n113_), .O(new_n130_));
  nand2  g086(.a(x32), .b(x30), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n112_), .c(x29), .O(new_n133_));
  nand2  g089(.a(new_n112_), .b(x29), .O(new_n134_));
  nand4  g090(.a(new_n129_), .b(z0), .c(x31), .d(x30), .O(new_n135_));
  nand2  g091(.a(x32), .b(new_n113_), .O(new_n136_));
  ...
  aoi21  g096(.a(new_n140_), .b(new_n123_), .c(x15), .O(new_n141_));
  nor2   g097(.a(new_n115_), .b(new_n85_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(x17), .c(x11), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n121_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x12), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n82_), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  oai21  g103(.a(new_n115_), .b(new_n147_), .c(new_n85_), .O(new_n148_));
  nor2   g104(.a(x19), .b(x14), .O(new_n149_));
  nand2  g105(.a(x16), .b(x15), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n122_), .c(x31), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n148_), .c(new_n146_), .d(new_n144_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n141_), .c(x32), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n138_), .c(new_n133_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n77_), .c(x00), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(z8));
  inv1   g113(.a(x33), .O(new_n158_));
  nand4  g114(.a(new_n129_), .b(new_n158_), .c(x31), .d(x30), .O(new_n159_));
  inv1   g115(.a(x31), .O(new_n160_));
  nand2  g116(.a(x33), .b(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n112_), .c(x29), .O(new_n163_));
  nand4  g119(.a(new_n129_), .b(new_n158_), .c(new_n160_), .d(new_n113_), .O(new_n164_));
  nand2  g120(.a(x33), .b(x31), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n134_), .O(new_n167_));
  aoi21  g123(.a(new_n115_), .b(x14), .c(new_n85_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x17), .c(x16), .d(x15), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n150_), .c(new_n115_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n139_), .c(new_n127_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n170_), .b(new_n173_), .c(new_n121_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x12), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n82_), .O(new_n176_));
  nand2  g132(.a(new_n85_), .b(new_n147_), .O(new_n177_));
  ...
  nand4  g136(.a(new_n180_), .b(new_n172_), .c(new_n171_), .d(new_n169_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n167_), .c(new_n163_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n77_), .c(x00), .O(new_n184_));
