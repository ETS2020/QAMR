...
module FAU ( 
  ...
  oai21  g078(.a(x32), .b(new_n99_), .c(new_n79_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n107_), .c(x29), .O(new_n124_));
  nand2  g080(.a(new_n99_), .b(new_n79_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x29), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(z0), .c(x30), .O(new_n127_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n128_), .c(x31), .O(new_n144_));
  oai21  g100(.a(new_n98_), .b(new_n99_), .c(new_n107_), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n136_), .c(new_n141_), .O(new_n147_));
  nor2   g103(.a(new_n89_), .b(new_n86_), .O(new_n148_));
  ...
  nand2  g110(.a(new_n89_), .b(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n137_), .b(x16), .c(x15), .O(new_n156_));
  aoi21  g112(.a(new_n112_), .b(x28), .c(new_n118_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n153_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n151_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n150_), .c(new_n147_), .d(new_n145_), .O(new_n160_));
  ...
  nand4  g121(.a(new_n143_), .b(new_n165_), .c(x31), .d(x30), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n118_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n125_), .c(x29), .O(new_n169_));
  nand4  g125(.a(new_n143_), .b(new_n165_), .c(new_n118_), .d(new_n107_), .O(new_n170_));
  nand2  g126(.a(x33), .b(x31), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n126_), .O(new_n173_));
  ...
  oai21  g134(.a(new_n177_), .b(new_n146_), .c(new_n141_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n135_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n83_), .O(new_n183_));
  nand2  g139(.a(new_n86_), .b(new_n152_), .O(new_n184_));
  ...
  nand4  g143(.a(new_n187_), .b(new_n179_), .c(new_n178_), .d(new_n175_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n173_), .c(new_n169_), .O(new_n190_));
