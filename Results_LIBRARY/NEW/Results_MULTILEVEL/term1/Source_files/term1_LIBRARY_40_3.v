...
module FAU ( 
  ...
  nor2   g054(.a(new_n98_), .b(new_n78_), .O(new_n99_));
  ...
  nor2   g061(.a(x30), .b(new_n97_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  ...
  nand4  g066(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n111_));
  nand3  g067(.a(new_n57_), .b(x25), .c(x01), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand3  g069(.a(new_n99_), .b(x30), .c(x29), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n113_), .c(new_n77_), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n111_), .O(z7));
  nand2  g073(.a(new_n98_), .b(new_n78_), .O(new_n118_));
  nand3  g074(.a(x19), .b(new_n85_), .c(x13), .O(new_n119_));
  nand3  g075(.a(new_n88_), .b(x18), .c(x14), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n119_), .c(new_n82_), .O(new_n121_));
  nand4  g077(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n122_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n118_), .c(z0), .d(x31), .O(new_n134_));
  and2   g090(.a(x16), .b(x10), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n127_), .c(x15), .O(new_n136_));
  nand2  g092(.a(x19), .b(x18), .O(new_n137_));
  nand2  g093(.a(x17), .b(x11), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n125_), .O(new_n139_));
  inv1   g095(.a(x12), .O(new_n140_));
  oai21  g096(.a(new_n137_), .b(new_n140_), .c(new_n82_), .O(new_n141_));
  inv1   g097(.a(x13), .O(new_n142_));
  oai21  g098(.a(new_n88_), .b(new_n142_), .c(new_n85_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x15), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(new_n126_), .c(x19), .d(x14), .O(new_n145_));
  nand3  g101(.a(new_n118_), .b(x31), .c(x29), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n143_), .c(new_n141_), .d(new_n139_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n136_), .c(x32), .O(new_n149_));
  oai21  g105(.a(new_n134_), .b(new_n97_), .c(new_n149_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n77_), .c(x00), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(z8));
  inv1   g108(.a(x33), .O(new_n153_));
  nand2  g109(.a(new_n118_), .b(x29), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n133_), .c(new_n153_), .d(new_n113_), .O(new_n155_));
  aoi21  g111(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(x17), .c(x16), .d(x15), .O(new_n157_));
  nand2  g113(.a(x18), .b(x17), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n144_), .c(new_n88_), .O(new_n159_));
  nand3  g115(.a(new_n135_), .b(x18), .c(x17), .O(new_n160_));
  inv1   g116(.a(x11), .O(new_n161_));
  oai21  g117(.a(new_n158_), .b(new_n161_), .c(new_n125_), .O(new_n162_));
  oai21  g118(.a(new_n85_), .b(new_n140_), .c(new_n82_), .O(new_n163_));
  nand2  g119(.a(new_n85_), .b(new_n142_), .O(new_n164_));
  nor2   g120(.a(x31), .b(x30), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n162_), .O(new_n166_));
  aoi21  g122(.a(new_n160_), .b(new_n131_), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x33), .O(new_n169_));
  oai21  g125(.a(new_n155_), .b(x30), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n77_), .c(x00), .O(new_n171_));
