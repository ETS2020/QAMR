...
module FAU ( 
  ...
  oai21  g061(.a(new_n100_), .b(new_n79_), .c(x28), .O(new_n106_));
  ...
  nor2   g065(.a(new_n100_), .b(new_n98_), .O(new_n110_));
  ...
  nand3  g076(.a(new_n105_), .b(x29), .c(x27), .O(new_n121_));
  ...
  oai21  g094(.a(new_n110_), .b(new_n105_), .c(new_n79_), .O(new_n139_));
  ...
  nor2   g106(.a(new_n150_), .b(new_n130_), .O(new_n151_));
  ...
  aoi21  g110(.a(new_n153_), .b(x27), .c(new_n154_), .O(new_n155_));
  ...
  aoi21  g118(.a(new_n132_), .b(new_n128_), .c(new_n135_), .O(new_n163_));
  inv1   g119(.a(new_n136_), .O(new_n164_));
  oai21  g120(.a(new_n105_), .b(new_n79_), .c(new_n98_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(x31), .c(x29), .O(new_n166_));
  nand2  g122(.a(x29), .b(x27), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n114_), .c(new_n105_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  oai21  g125(.a(new_n164_), .b(new_n163_), .c(new_n169_), .O(new_n170_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n150_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n140_), .c(new_n135_), .O(new_n178_));
  aoi21  g134(.a(new_n175_), .b(x11), .c(x16), .O(new_n179_));
  oai21  g135(.a(new_n86_), .b(new_n145_), .c(new_n83_), .O(new_n180_));
  nand2  g136(.a(new_n86_), .b(new_n147_), .O(new_n181_));
