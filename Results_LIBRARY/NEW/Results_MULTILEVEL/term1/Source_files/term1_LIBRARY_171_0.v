...
module FAU ( 
  ...
  nor2   g068(.a(new_n107_), .b(new_n98_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n112_), .c(x31), .O(new_n115_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n112_), .c(new_n78_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n77_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(z7));
  ...
  nand2  g099(.a(new_n107_), .b(new_n79_), .O(new_n144_));
  oai21  g100(.a(new_n114_), .b(new_n79_), .c(new_n144_), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n113_), .b(x28), .c(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n155_), .d(new_n153_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n151_), .c(new_n148_), .d(new_n146_), .O(new_n163_));
  ...
  aoi21  g123(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x17), .c(x16), .d(x15), .O(new_n169_));
  oai21  g125(.a(new_n126_), .b(x30), .c(new_n118_), .O(new_n170_));
  oai21  g126(.a(new_n123_), .b(new_n114_), .c(x31), .O(new_n171_));
  nand2  g127(.a(x18), .b(x17), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n157_), .c(x19), .O(new_n174_));
  oai21  g130(.a(new_n172_), .b(new_n147_), .c(new_n140_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n176_), .c(new_n134_), .O(new_n177_));
  oai21  g133(.a(new_n86_), .b(new_n152_), .c(new_n83_), .O(new_n178_));
  nand2  g134(.a(new_n86_), .b(new_n154_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n174_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n171_), .c(new_n170_), .d(new_n169_), .O(new_n182_));
