...
module FAU ( 
  ...
  nand3  g083(.a(x19), .b(new_n83_), .c(x13), .O(new_n128_));
  ...
  oai21  g111(.a(new_n88_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  ...
  aoi21  g134(.a(new_n88_), .b(x14), .c(new_n83_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n83_), .b(new_n153_), .c(new_n80_), .O(new_n187_));
  nand2  g143(.a(new_n83_), .b(new_n155_), .O(new_n188_));
