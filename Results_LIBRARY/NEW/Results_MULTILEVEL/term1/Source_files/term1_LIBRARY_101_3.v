...
module FAU ( 
  ...
  oai22  g106(.a(new_n150_), .b(new_n132_), .c(new_n86_), .d(new_n138_), .O(new_n151_));
  nand2  g107(.a(x18), .b(x10), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n138_), .O(new_n153_));
  nand2  g109(.a(new_n150_), .b(new_n132_), .O(new_n154_));
  nand2  g110(.a(x17), .b(x14), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n89_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  or2    g113(.a(new_n157_), .b(new_n150_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n156_), .c(new_n154_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x18), .O(new_n160_));
  oai22  g116(.a(x17), .b(x12), .c(x16), .d(x11), .O(new_n161_));
  nor2   g117(.a(x18), .b(x13), .O(new_n162_));
  nor3   g118(.a(new_n162_), .b(new_n161_), .c(new_n118_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n160_), .c(new_n153_), .d(new_n151_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x32), .O(new_n165_));
  oai21  g121(.a(new_n149_), .b(new_n145_), .c(new_n165_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n144_), .c(new_n78_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n123_), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  nand3  g125(.a(new_n140_), .b(new_n169_), .c(new_n118_), .O(new_n170_));
  nand2  g126(.a(x33), .b(x31), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(new_n145_), .O(new_n172_));
  nand4  g128(.a(new_n169_), .b(x31), .c(x30), .d(x19), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(new_n146_), .c(new_n169_), .d(x31), .O(new_n174_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n157_), .c(new_n89_), .O(new_n179_));
  nand2  g135(.a(x16), .b(x10), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n178_), .c(new_n138_), .O(new_n181_));
  inv1   g137(.a(new_n162_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n178_), .b(new_n183_), .c(new_n132_), .O(new_n184_));
  ...
  nand4  g145(.a(new_n189_), .b(new_n181_), .c(new_n179_), .d(new_n177_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n175_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n172_), .c(new_n78_), .O(new_n193_));
