...
module FAU ( 
  ...
  oai21  g114(.a(new_n158_), .b(new_n134_), .c(new_n149_), .O(new_n159_));
  nand2  g115(.a(x17), .b(x11), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n132_), .c(new_n125_), .O(new_n161_));
  inv1   g117(.a(x12), .O(new_n162_));
  oai21  g118(.a(new_n132_), .b(new_n162_), .c(new_n83_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  oai21  g120(.a(new_n89_), .b(new_n164_), .c(new_n86_), .O(new_n165_));
  nor2   g121(.a(x19), .b(x14), .O(new_n166_));
  nor2   g122(.a(new_n125_), .b(new_n149_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n135_), .c(new_n166_), .O(new_n168_));
  ...
  nand3  g135(.a(new_n144_), .b(new_n179_), .c(new_n118_), .O(new_n180_));
  nand2  g136(.a(x33), .b(x31), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n180_), .c(new_n146_), .O(new_n182_));
  nand4  g138(.a(new_n151_), .b(new_n179_), .c(x31), .d(x30), .O(new_n183_));
  oai22  g139(.a(new_n183_), .b(new_n125_), .c(new_n179_), .d(x31), .O(new_n184_));
  ...
  nand2  g143(.a(new_n167_), .b(new_n141_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n89_), .O(new_n189_));
  oai21  g145(.a(new_n158_), .b(new_n140_), .c(new_n149_), .O(new_n190_));
  inv1   g146(.a(x11), .O(new_n191_));
  oai21  g147(.a(new_n140_), .b(new_n191_), .c(new_n125_), .O(new_n192_));
  oai21  g148(.a(new_n86_), .b(new_n162_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n164_), .O(new_n194_));
  ...
  oai21  g156(.a(new_n200_), .b(new_n182_), .c(new_n78_), .O(new_n201_));
  nor2   g157(.a(new_n201_), .b(new_n178_), .O(z9));
endmodule
