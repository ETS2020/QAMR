...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n90_), .c(new_n87_), .d(x16), .O(new_n115_));
  ...
  nand3  g094(.a(new_n138_), .b(new_n80_), .c(x11), .O(new_n139_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n135_), .c(new_n80_), .O(new_n152_));
  inv1   g108(.a(x12), .O(new_n153_));
  oai21  g109(.a(new_n135_), .b(new_n153_), .c(new_n128_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n88_), .b(new_n155_), .c(new_n85_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  nor2   g113(.a(new_n80_), .b(new_n142_), .O(new_n158_));
  ...
  aoi21  g134(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n179_));
  ...
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n80_), .O(new_n186_));
  oai21  g142(.a(new_n85_), .b(new_n153_), .c(new_n128_), .O(new_n187_));
  nand2  g143(.a(new_n85_), .b(new_n155_), .O(new_n188_));
