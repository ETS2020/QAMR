...
module FAU ( 
  ...
  nand3  g080(.a(x19), .b(new_n83_), .c(x12), .O(new_n125_));
  nand3  g081(.a(new_n86_), .b(x17), .c(x14), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n125_), .c(new_n124_), .O(new_n127_));
  nand4  g083(.a(x19), .b(x17), .c(new_n124_), .d(x11), .O(new_n128_));
  ...
  oai21  g102(.a(x19), .b(x14), .c(new_n146_), .O(new_n147_));
  ...
  nand2  g121(.a(new_n86_), .b(x14), .O(new_n166_));
