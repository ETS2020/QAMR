...
module FAU ( 
  ...
  xor2a  g077(.a(x30), .b(x29), .O(new_n122_));
  ...
  nand2  g094(.a(new_n107_), .b(new_n79_), .O(new_n139_));
  nand4  g095(.a(x32), .b(x30), .c(x29), .d(x27), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(x28), .O(new_n141_));
  nand2  g097(.a(x16), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(new_n135_), .O(new_n143_));
  nor2   g099(.a(new_n89_), .b(new_n86_), .O(new_n144_));
  ...
  oai22  g106(.a(new_n150_), .b(new_n130_), .c(x19), .d(x14), .O(new_n151_));
  nand3  g107(.a(x30), .b(x29), .c(x28), .O(new_n152_));
  nand2  g108(.a(new_n107_), .b(new_n98_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(x31), .O(new_n154_));
  nor3   g110(.a(new_n154_), .b(new_n151_), .c(new_n149_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n148_), .c(new_n146_), .d(new_n143_), .O(new_n156_));
  ...
  nand4  g118(.a(new_n137_), .b(new_n162_), .c(x31), .d(x30), .O(new_n163_));
  nand2  g119(.a(x33), .b(new_n117_), .O(new_n164_));
  ...
  nand4  g123(.a(new_n137_), .b(new_n162_), .c(new_n117_), .d(new_n107_), .O(new_n168_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n150_), .c(new_n89_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n142_), .c(new_n135_), .O(new_n176_));
