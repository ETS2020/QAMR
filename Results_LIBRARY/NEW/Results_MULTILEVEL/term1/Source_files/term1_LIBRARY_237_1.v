...
module FAU ( 
  ...
  nor2   g069(.a(new_n57_), .b(new_n56_), .O(new_n114_));
  inv1   g070(.a(new_n100_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x30), .c(x29), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(new_n78_), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n77_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(z7));
  nand2  g076(.a(new_n99_), .b(new_n79_), .O(new_n121_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n129_), .c(new_n123_), .O(new_n134_));
  nand3  g090(.a(x16), .b(new_n123_), .c(x10), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  or2    g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n122_), .c(z0), .d(x31), .O(new_n138_));
  aoi21  g094(.a(new_n99_), .b(new_n79_), .c(new_n98_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x10), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n131_), .c(new_n123_), .O(new_n141_));
  nor2   g097(.a(new_n89_), .b(new_n86_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(x17), .c(x11), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n130_), .O(new_n144_));
  nand2  g100(.a(new_n142_), .b(x12), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n83_), .O(new_n146_));
  aoi21  g102(.a(x19), .b(x13), .c(x18), .O(new_n147_));
  nor2   g103(.a(x19), .b(x14), .O(new_n148_));
  nand2  g104(.a(x16), .b(x15), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n131_), .c(x31), .O(new_n150_));
  nor3   g106(.a(new_n150_), .b(new_n148_), .c(new_n147_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n139_), .c(x32), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n138_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n78_), .c(x00), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(z8));
  inv1   g112(.a(x33), .O(new_n157_));
  oai21  g113(.a(new_n136_), .b(new_n134_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g117(.a(x33), .b(new_n116_), .O(new_n162_));
  oai21  g118(.a(new_n158_), .b(new_n116_), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n121_), .c(x29), .O(new_n164_));
  nand2  g120(.a(new_n89_), .b(x14), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x18), .c(x17), .d(x16), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n123_), .O(new_n167_));
  nand2  g123(.a(x18), .b(x17), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n149_), .c(new_n89_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n140_), .c(new_n123_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n171_), .c(new_n130_), .O(new_n172_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n167_), .c(x33), .O(new_n177_));
