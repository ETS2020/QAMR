...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n24_), .c(new_n40_), .d(x12), .O(new_n42_));
  nor2   g21(.a(new_n22_), .b(new_n29_), .O(new_n43_));
  oai21  g22(.a(x06), .b(x04), .c(x05), .O(new_n44_));
  aoi21  g23(.a(new_n43_), .b(x12), .c(new_n44_), .O(new_n45_));
  oai21  g24(.a(new_n42_), .b(x09), .c(new_n45_), .O(z2));
  nand4  g25(.a(new_n41_), .b(new_n22_), .c(x03), .d(x02), .O(new_n47_));
  nor3   g26(.a(x13), .b(x12), .c(x11), .O(new_n48_));
  aoi22  g27(.a(new_n48_), .b(new_n26_), .c(new_n47_), .d(x13), .O(new_n49_));
  inv1   g28(.a(x07), .O(new_n50_));
  aoi21  g29(.a(new_n50_), .b(new_n29_), .c(new_n30_), .O(new_n51_));
  oai21  g30(.a(new_n49_), .b(new_n29_), .c(new_n51_), .O(z3));
