...
module FAU ( 
  ...
  aoi21  g05(.a(new_n26_), .b(x02), .c(new_n24_), .O(new_n27_));
  ...
  nand3  g11(.a(new_n32_), .b(new_n23_), .c(x03), .O(new_n33_));
  oai21  g12(.a(x09), .b(new_n25_), .c(x11), .O(new_n34_));
  nand3  g13(.a(new_n34_), .b(new_n33_), .c(x02), .O(new_n35_));
  nand2  g14(.a(new_n35_), .b(x04), .O(new_n36_));
  inv1   g15(.a(x01), .O(new_n37_));
  aoi21  g16(.a(new_n22_), .b(new_n37_), .c(new_n29_), .O(new_n38_));
  nand2  g17(.a(new_n38_), .b(new_n36_), .O(z1));
  nor2   g18(.a(x12), .b(x11), .O(new_n40_));
  aoi22  g19(.a(new_n40_), .b(new_n26_), .c(new_n33_), .d(x12), .O(new_n41_));
  inv1   g20(.a(x06), .O(new_n42_));
  aoi21  g21(.a(new_n42_), .b(new_n22_), .c(new_n29_), .O(new_n43_));
  oai21  g22(.a(new_n41_), .b(new_n22_), .c(new_n43_), .O(z2));
  inv1   g23(.a(x12), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n32_), .c(new_n23_), .d(x03), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n26_), .c(new_n46_), .d(x13), .O(new_n48_));
  inv1   g27(.a(x07), .O(new_n49_));
  aoi21  g28(.a(new_n49_), .b(new_n22_), .c(new_n29_), .O(new_n50_));
