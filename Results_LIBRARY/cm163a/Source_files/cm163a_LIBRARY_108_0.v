...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n38_, new_n39_, new_n41_, new_n43_, new_n44_;
  ...
  nand2  g14(.a(new_n31_), .b(new_n24_), .O(new_n36_));
  nand3  g15(.a(new_n36_), .b(x12), .c(x04), .O(new_n37_));
  inv1   g16(.a(x06), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(new_n22_), .c(new_n27_), .O(new_n39_));
  nand2  g18(.a(new_n39_), .b(new_n37_), .O(z2));
  aoi21  g19(.a(x13), .b(x04), .c(new_n27_), .O(new_n41_));
  oai21  g20(.a(x07), .b(x04), .c(new_n41_), .O(z3));
