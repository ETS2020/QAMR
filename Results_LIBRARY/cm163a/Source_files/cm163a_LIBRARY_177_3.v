...
module FAU ( 
  ...
  oai21  g20(.a(new_n34_), .b(new_n29_), .c(new_n41_), .O(new_n42_));
  ...
  aoi22  g26(.a(new_n47_), .b(new_n34_), .c(new_n41_), .d(x13), .O(new_n48_));
