...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(new_n32_), .c(new_n30_), .O(new_n54_));
  nand2  g26(.a(x08), .b(x03), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n54_), .O(z4));
  nand4  g28(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n57_));
  nand3  g29(.a(new_n57_), .b(x15), .c(x09), .O(new_n58_));
  inv1   g30(.a(new_n58_), .O(new_n59_));
  nand2  g31(.a(x14), .b(x13), .O(new_n60_));
  nor3   g32(.a(new_n60_), .b(new_n45_), .c(x15), .O(new_n61_));
  nor2   g33(.a(x10), .b(x08), .O(new_n62_));
  ...
  inv1   g37(.a(new_n62_), .O(new_n66_));
  nand2  g38(.a(new_n57_), .b(x16), .O(new_n67_));
  ...
  nor2   g42(.a(new_n68_), .b(x15), .O(new_n71_));
  aoi21  g43(.a(new_n70_), .b(x09), .c(new_n71_), .O(new_n72_));
  nand2  g44(.a(x08), .b(x05), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n66_), .c(new_n73_), .O(z6));
  nand3  g46(.a(x16), .b(x14), .c(x13), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n45_), .c(x17), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(x16), .c(x15), .d(x14), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n49_), .c(new_n76_), .O(new_n79_));
  nor2   g51(.a(new_n77_), .b(x15), .O(new_n80_));
  aoi21  g52(.a(new_n79_), .b(x09), .c(new_n80_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(new_n66_), .c(new_n82_), .O(z7));
  nand3  g55(.a(x17), .b(x16), .c(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n49_), .c(x18), .O(new_n85_));
  inv1   g57(.a(x18), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(x17), .c(x16), .d(x15), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n57_), .c(new_n85_), .O(new_n88_));
  nor2   g60(.a(new_n86_), .b(x15), .O(new_n89_));
  aoi21  g61(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  nand2  g62(.a(x08), .b(x07), .O(new_n91_));
  oai21  g63(.a(new_n90_), .b(new_n66_), .c(new_n91_), .O(z8));
endmodule
