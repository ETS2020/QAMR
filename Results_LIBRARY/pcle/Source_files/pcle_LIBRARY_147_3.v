...
module FAU ( 
  ...
  nand3  g54(.a(new_n32_), .b(x17), .c(x16), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n55_), .c(x18), .O(new_n84_));
  inv1   g56(.a(new_n62_), .O(new_n85_));
  nor2   g57(.a(x18), .b(new_n77_), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n85_), .c(x16), .d(x15), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n46_), .O(z8));
endmodule
