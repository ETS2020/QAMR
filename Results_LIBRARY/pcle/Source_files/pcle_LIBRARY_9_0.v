// Benchmark "FAU" written by ABC on Thu Jun 25 16:29:49 2020
...
module FAU ( 
  ...
  nand2  g51(.a(new_n79_), .b(new_n74_), .O(new_n80_));
  ...
  nand2  g61(.a(new_n89_), .b(new_n74_), .O(new_n90_));
