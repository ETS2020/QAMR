...
module FAU ( 
  ...
  nand4  g32(.a(new_n60_), .b(x14), .c(x13), .d(x12), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(x11), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x04), .O(new_n64_));
  oai21  g36(.a(new_n63_), .b(new_n44_), .c(new_n64_), .O(z5));
  inv1   g37(.a(new_n44_), .O(new_n66_));
  nand3  g38(.a(x15), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n47_), .c(x16), .O(new_n68_));
  ...
  nand3  g59(.a(new_n87_), .b(new_n85_), .c(new_n51_), .O(new_n88_));
