...
module FAU ( 
  ...
  nand2  g15(.a(new_n40_), .b(x09), .O(new_n44_));
  ...
  nand2  g20(.a(new_n34_), .b(new_n40_), .O(new_n49_));
  ...
  oai21  g35(.a(new_n62_), .b(new_n49_), .c(new_n63_), .O(z5));
  inv1   g36(.a(new_n49_), .O(new_n65_));
