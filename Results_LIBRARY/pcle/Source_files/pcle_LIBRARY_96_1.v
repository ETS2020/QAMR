...
module FAU ( 
  ...
  inv1   g30(.a(new_n45_), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  inv1   g32(.a(new_n53_), .O(new_n61_));
  nand3  g33(.a(new_n60_), .b(x14), .c(x13), .O(new_n62_));
  oai22  g34(.a(new_n62_), .b(new_n48_), .c(new_n61_), .d(new_n60_), .O(new_n63_));
  ...
  nand2  g56(.a(new_n84_), .b(new_n59_), .O(new_n85_));
