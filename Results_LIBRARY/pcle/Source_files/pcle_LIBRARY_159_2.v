...
module FAU ( 
  ...
  nor2   g40(.a(new_n68_), .b(x14), .O(new_n69_));
  aoi21  g41(.a(new_n67_), .b(x14), .c(new_n69_), .O(new_n70_));
  ...
  nand3  g51(.a(x17), .b(x15), .c(x14), .O(new_n80_));
  oai21  g52(.a(new_n80_), .b(new_n54_), .c(x18), .O(new_n81_));
  inv1   g53(.a(x18), .O(new_n82_));
  nand4  g54(.a(new_n82_), .b(x17), .c(x15), .d(x14), .O(new_n83_));
