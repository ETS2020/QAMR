...
module FAU ( 
  ...
  nand2  g45(.a(x16), .b(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n43_), .c(x14), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n67_), .c(new_n73_), .O(new_n76_));
  nand2  g48(.a(new_n73_), .b(x16), .O(new_n77_));
  nor3   g49(.a(new_n77_), .b(new_n66_), .c(new_n47_), .O(new_n78_));
  ...
  nand3  g54(.a(x17), .b(x16), .c(x13), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n43_), .c(x14), .O(new_n84_));
  aoi21  g56(.a(new_n84_), .b(new_n67_), .c(new_n82_), .O(new_n85_));
  nand4  g57(.a(new_n82_), .b(x17), .c(x16), .d(x15), .O(new_n86_));
  nor2   g58(.a(new_n86_), .b(new_n31_), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n85_), .c(new_n34_), .O(new_n88_));
