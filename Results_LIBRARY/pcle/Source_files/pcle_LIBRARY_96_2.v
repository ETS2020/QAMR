...
module FAU ( 
  ...
  nand3  g27(.a(new_n48_), .b(new_n55_), .c(x13), .O(new_n56_));
  ...
  nand2  g32(.a(x15), .b(new_n55_), .O(new_n61_));
  and2   g33(.a(new_n61_), .b(new_n54_), .O(new_n62_));
  ...
  aoi22  g39(.a(new_n67_), .b(new_n48_), .c(new_n65_), .d(x16), .O(new_n68_));
  nand2  g40(.a(x08), .b(x05), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(new_n45_), .c(new_n69_), .O(z6));
  oai21  g42(.a(new_n53_), .b(new_n29_), .c(x17), .O(new_n71_));
  inv1   g43(.a(x17), .O(new_n72_));
  inv1   g44(.a(new_n53_), .O(new_n73_));
  nand3  g45(.a(new_n73_), .b(new_n30_), .c(new_n72_), .O(new_n74_));
  ...
  nand3  g50(.a(x17), .b(x16), .c(x14), .O(new_n79_));
  oai21  g51(.a(new_n79_), .b(new_n53_), .c(x18), .O(new_n80_));
  inv1   g52(.a(x18), .O(new_n81_));
  nand4  g53(.a(new_n81_), .b(x17), .c(x16), .d(x14), .O(new_n82_));
