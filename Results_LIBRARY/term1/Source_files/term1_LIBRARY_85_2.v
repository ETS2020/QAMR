...
module FAU ( 
  ...
  nor2   g110(.a(z0), .b(x26), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n144_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n136_), .c(new_n112_), .O(z8));
  ...
  inv1   g141(.a(x26), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x00), .O(new_n187_));
  aoi21  g143(.a(new_n185_), .b(new_n162_), .c(new_n187_), .O(z9));
endmodule
