...
module FAU ( 
  ...
  nor2   g076(.a(x30), .b(new_n120_), .O(new_n121_));
  ...
  aoi21  g090(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  oai21  g092(.a(new_n119_), .b(new_n117_), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n131_), .b(new_n124_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(x30), .d(x16), .O(new_n140_));
  oai21  g096(.a(new_n136_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  nor2   g097(.a(x32), .b(new_n106_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  inv1   g099(.a(x11), .O(new_n144_));
  nor2   g100(.a(new_n115_), .b(new_n113_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x17), .c(x15), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(new_n120_), .O(new_n147_));
  nand2  g103(.a(x16), .b(x15), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n123_), .O(new_n149_));
  inv1   g105(.a(x15), .O(new_n150_));
  nand3  g106(.a(new_n145_), .b(x17), .c(x10), .O(new_n151_));
  and2   g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  aoi21  g108(.a(new_n145_), .b(x12), .c(x17), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n152_), .c(new_n149_), .O(new_n154_));
  ...
  oai21  g116(.a(new_n115_), .b(new_n160_), .c(new_n113_), .O(new_n161_));
  nand2  g117(.a(new_n108_), .b(x28), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nor3   g119(.a(new_n163_), .b(new_n159_), .c(new_n158_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n157_), .c(new_n154_), .d(new_n147_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x32), .O(new_n166_));
  inv1   g122(.a(x26), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x00), .O(new_n168_));
  aoi21  g124(.a(new_n166_), .b(new_n143_), .c(new_n168_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n106_), .O(new_n171_));
  ...
  nor2   g130(.a(x33), .b(new_n106_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n139_), .c(x30), .d(x16), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n106_), .O(new_n177_));
  ...
  nand2  g137(.a(new_n113_), .b(new_n160_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n181_), .c(new_n180_), .O(new_n183_));
  nand2  g139(.a(new_n115_), .b(x14), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n129_), .c(x16), .d(x15), .O(new_n185_));
  oai21  g141(.a(new_n148_), .b(new_n128_), .c(new_n115_), .O(new_n186_));
  nand2  g142(.a(x16), .b(x10), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n128_), .c(new_n150_), .O(new_n188_));
  oai21  g144(.a(new_n128_), .b(new_n144_), .c(new_n120_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n188_), .c(new_n186_), .d(new_n185_), .O(new_n190_));
  nor3   g146(.a(new_n190_), .b(new_n183_), .c(new_n179_), .O(new_n191_));
  nor2   g147(.a(new_n191_), .b(new_n170_), .O(new_n192_));
  aoi21  g148(.a(new_n178_), .b(new_n135_), .c(new_n192_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n174_), .c(new_n168_), .O(z9));
endmodule
