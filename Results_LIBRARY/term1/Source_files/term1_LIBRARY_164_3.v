...
module FAU ( 
  ...
  nand2  g075(.a(new_n114_), .b(x12), .O(new_n120_));
  inv1   g076(.a(x26), .O(new_n121_));
  nor2   g077(.a(new_n117_), .b(new_n115_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n119_), .c(x16), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n125_), .c(new_n113_), .O(new_n130_));
  nand3  g086(.a(x16), .b(new_n113_), .c(x10), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  nand2  g088(.a(new_n93_), .b(new_n92_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n98_), .c(x29), .O(new_n134_));
  ...
  nand2  g097(.a(new_n141_), .b(new_n93_), .O(new_n142_));
  oai21  g098(.a(new_n117_), .b(new_n114_), .c(new_n115_), .O(new_n143_));
  aoi21  g099(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n144_));
  and2   g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g101(.a(x19), .b(x12), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n114_), .c(new_n108_), .d(x28), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(new_n113_), .c(new_n127_), .d(new_n126_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n147_), .c(new_n145_), .d(new_n142_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n121_), .O(new_n151_));
  nor2   g107(.a(new_n126_), .b(new_n113_), .O(new_n152_));
  nor2   g108(.a(x15), .b(x10), .O(new_n153_));
  nor2   g109(.a(x16), .b(x11), .O(new_n154_));
  ...
  aoi21  g115(.a(new_n152_), .b(new_n122_), .c(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n114_), .c(new_n151_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n139_), .c(new_n112_), .O(z8));
  inv1   g119(.a(x33), .O(new_n164_));
  nand3  g120(.a(new_n152_), .b(new_n114_), .c(x12), .O(new_n165_));
  nand4  g121(.a(new_n122_), .b(new_n164_), .c(new_n106_), .d(new_n98_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n106_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n121_), .O(new_n168_));
  aoi21  g124(.a(new_n118_), .b(new_n116_), .c(new_n126_), .O(new_n169_));
  nand4  g125(.a(x19), .b(x18), .c(new_n126_), .d(x11), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(x15), .O(new_n172_));
  inv1   g128(.a(new_n131_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n122_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n164_), .O(new_n176_));
  nand3  g132(.a(new_n106_), .b(new_n98_), .c(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n176_), .c(new_n168_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n135_), .O(new_n179_));
  inv1   g135(.a(new_n135_), .O(new_n180_));
  nand4  g136(.a(new_n122_), .b(new_n164_), .c(x31), .d(x30), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(new_n165_), .c(new_n164_), .d(x31), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n121_), .O(new_n183_));
  nand3  g139(.a(x31), .b(x30), .c(x17), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n175_), .c(new_n164_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nand2  g143(.a(new_n152_), .b(x18), .O(new_n188_));
  aoi21  g144(.a(new_n117_), .b(x14), .c(new_n188_), .O(new_n189_));
  oai21  g145(.a(x18), .b(x13), .c(new_n155_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n189_), .c(x17), .O(new_n191_));
  nand2  g147(.a(new_n146_), .b(new_n114_), .O(new_n192_));
  xnor2a g148(.a(x31), .b(x30), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n149_), .c(new_n192_), .d(new_n143_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n121_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n191_), .c(new_n164_), .O(new_n196_));
  aoi21  g152(.a(new_n187_), .b(new_n180_), .c(new_n196_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n179_), .c(new_n112_), .O(z9));
endmodule
