...
module FAU ( 
  ...
  nand4  g044(.a(new_n88_), .b(new_n85_), .c(new_n81_), .d(new_n57_), .O(new_n89_));
  ...
  nand2  g053(.a(new_n85_), .b(new_n57_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n91_), .O(z5));
  inv1   g057(.a(x30), .O(new_n102_));
  oai21  g058(.a(new_n92_), .b(new_n94_), .c(x27), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(x27), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n99_), .c(new_n81_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z6));
  nor2   g062(.a(new_n92_), .b(new_n94_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n93_), .c(x31), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n95_), .b(new_n110_), .c(x29), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n109_), .c(new_n99_), .d(new_n81_), .O(z7));
  ...
  nand2  g087(.a(new_n107_), .b(new_n102_), .O(new_n132_));
  ...
  oai21  g091(.a(new_n92_), .b(new_n93_), .c(x30), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n94_), .O(new_n137_));
  ...
  oai21  g097(.a(new_n138_), .b(new_n141_), .c(new_n114_), .O(new_n142_));
  nand3  g098(.a(new_n125_), .b(x16), .c(x15), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(new_n137_), .O(new_n144_));
  ...
  aoi21  g103(.a(new_n102_), .b(new_n92_), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  oai21  g105(.a(new_n117_), .b(new_n149_), .c(new_n115_), .O(new_n150_));
  nand2  g106(.a(new_n107_), .b(x30), .O(new_n151_));
  ...
  oai21  g111(.a(new_n102_), .b(new_n94_), .c(new_n93_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x31), .c(x29), .O(new_n157_));
  nand3  g113(.a(new_n108_), .b(new_n110_), .c(new_n102_), .O(new_n158_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n123_), .O(new_n163_));
  nand4  g119(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n117_), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n145_), .c(new_n113_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n163_), .O(new_n167_));
  oai21  g123(.a(new_n115_), .b(new_n141_), .c(new_n114_), .O(new_n168_));
  nand2  g124(.a(new_n115_), .b(new_n149_), .O(new_n169_));
  nand2  g125(.a(new_n110_), .b(x30), .O(new_n170_));
  and2   g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  aoi21  g127(.a(new_n117_), .b(x14), .c(new_n164_), .O(new_n172_));
  aoi21  g128(.a(new_n130_), .b(x31), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n168_), .d(new_n132_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n167_), .c(x33), .O(new_n175_));
