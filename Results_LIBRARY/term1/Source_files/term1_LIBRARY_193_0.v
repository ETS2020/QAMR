...
module FAU ( 
  ...
  nand2  g072(.a(new_n116_), .b(x18), .O(new_n117_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(new_n122_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(new_n116_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n137_), .c(new_n112_), .O(new_n142_));
  ...
  inv1   g123(.a(new_n151_), .O(new_n168_));
  xnor2a g124(.a(x31), .b(x30), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n140_), .O(new_n170_));
  nand2  g126(.a(new_n142_), .b(new_n138_), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n146_), .c(new_n159_), .O(new_n173_));
  aoi21  g129(.a(new_n167_), .b(new_n164_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n163_), .c(new_n157_), .O(z9));
endmodule
