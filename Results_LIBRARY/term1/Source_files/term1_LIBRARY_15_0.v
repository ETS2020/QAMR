// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:44 2020
...
module FAU ( 
  ...
  nand4  g042(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n58_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nor2   g045(.a(new_n84_), .b(x26), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n83_), .d(new_n58_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z4));
  inv1   g048(.a(new_n83_), .O(new_n93_));
  ...
  nand2  g054(.a(new_n90_), .b(new_n58_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n98_), .c(new_n93_), .O(z5));
  inv1   g056(.a(new_n99_), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  nand2  g058(.a(new_n97_), .b(x29), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n97_), .b(new_n102_), .c(x29), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n102_), .c(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n101_), .c(new_n83_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z6));
  inv1   g064(.a(x15), .O(new_n109_));
  oai21  g065(.a(x21), .b(x16), .c(x20), .O(new_n110_));
  oai21  g066(.a(x20), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n82_), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand3  g069(.a(new_n104_), .b(new_n113_), .c(x30), .O(new_n114_));
  nor2   g070(.a(new_n102_), .b(new_n94_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n97_), .c(new_n113_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n114_), .c(new_n112_), .O(z7));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n127_), .c(new_n109_), .O(new_n132_));
  nand3  g088(.a(x16), .b(new_n109_), .c(x10), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g090(.a(new_n96_), .b(new_n95_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n102_), .c(x29), .O(new_n136_));
  ...
  nor2   g097(.a(new_n128_), .b(new_n109_), .O(new_n142_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n129_), .c(new_n109_), .O(new_n151_));
  nand2  g107(.a(new_n115_), .b(x27), .O(new_n152_));
  oai21  g108(.a(x30), .b(x27), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  oai21  g110(.a(x19), .b(x14), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n102_), .b(new_n94_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(x19), .b(x13), .c(x18), .O(new_n157_));
  aoi21  g113(.a(new_n115_), .b(x28), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g121(.a(new_n113_), .b(new_n102_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n113_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n137_), .O(new_n168_));
  inv1   g124(.a(new_n137_), .O(new_n169_));
  nand2  g125(.a(x31), .b(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n113_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n165_), .c(new_n171_), .O(new_n172_));
  aoi21  g128(.a(x18), .b(x12), .c(x17), .O(new_n173_));
  nand2  g129(.a(new_n113_), .b(x30), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n102_), .O(new_n175_));
  ...
  oai21  g140(.a(new_n184_), .b(new_n150_), .c(new_n109_), .O(new_n185_));
