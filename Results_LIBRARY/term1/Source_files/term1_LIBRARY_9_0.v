...
module FAU ( 
  ...
  nand2  g074(.a(new_n118_), .b(x11), .O(new_n119_));
  nand3  g075(.a(x19), .b(x18), .c(x17), .O(new_n120_));
  or2    g076(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n117_), .c(new_n108_), .O(new_n122_));
  inv1   g078(.a(x10), .O(new_n123_));
  nor4   g079(.a(new_n120_), .b(new_n118_), .c(x15), .d(new_n123_), .O(new_n124_));
  ...
  nor2   g087(.a(new_n112_), .b(new_n110_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x17), .c(x15), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n119_), .O(new_n135_));
  nand2  g091(.a(new_n133_), .b(new_n118_), .O(new_n136_));
  nand3  g092(.a(new_n132_), .b(x17), .c(x10), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n108_), .O(new_n138_));
  nand2  g094(.a(new_n132_), .b(x12), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n109_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n136_), .d(new_n135_), .O(new_n141_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n123_), .c(new_n108_), .O(new_n163_));
  oai21  g119(.a(new_n162_), .b(new_n108_), .c(new_n112_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n163_), .c(new_n136_), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  inv1   g122(.a(x14), .O(new_n167_));
  oai21  g123(.a(x19), .b(new_n167_), .c(x16), .O(new_n168_));
  oai21  g124(.a(new_n112_), .b(x11), .c(new_n168_), .O(new_n169_));
  nand3  g125(.a(x18), .b(x17), .c(x15), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n105_), .b(x30), .O(new_n172_));
  nand2  g128(.a(x18), .b(x12), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n109_), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n94_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n110_), .b(new_n176_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n175_), .c(new_n174_), .d(new_n172_), .O(new_n178_));
  aoi21  g134(.a(new_n171_), .b(new_n169_), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n166_), .c(new_n153_), .O(new_n180_));
  aoi21  g136(.a(new_n161_), .b(new_n158_), .c(new_n180_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n157_), .c(new_n151_), .O(z9));
endmodule
