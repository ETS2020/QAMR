...
module FAU ( 
  ...
  nand4  g073(.a(x19), .b(x18), .c(new_n112_), .d(x11), .O(new_n118_));
  ...
  and2   g085(.a(x31), .b(x17), .O(new_n130_));
  ...
  nand3  g110(.a(new_n106_), .b(new_n98_), .c(x17), .O(new_n155_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n138_), .c(new_n165_), .d(x17), .O(new_n167_));
