...
module FAU ( 
  ...
  nand2  g080(.a(new_n122_), .b(x17), .O(new_n125_));
  ...
  oai21  g089(.a(new_n127_), .b(new_n124_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n122_), .b(x12), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n113_), .O(new_n136_));
  inv1   g092(.a(x16), .O(new_n137_));
  nand3  g093(.a(new_n122_), .b(x17), .c(x15), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand3  g095(.a(new_n122_), .b(x17), .c(x10), .O(new_n140_));
  ...
  nor3   g099(.a(new_n125_), .b(new_n112_), .c(x11), .O(new_n144_));
  ...
  nand2  g103(.a(new_n108_), .b(x28), .O(new_n148_));
  nand2  g104(.a(x19), .b(x13), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n114_), .O(new_n150_));
  aoi21  g106(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n148_), .O(new_n152_));
  aoi21  g108(.a(new_n147_), .b(new_n93_), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g113(.a(new_n155_), .b(new_n134_), .c(new_n157_), .O(z8));
  ...
  inv1   g119(.a(new_n130_), .O(new_n164_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n150_), .c(new_n139_), .O(new_n169_));
  nand2  g125(.a(new_n141_), .b(new_n136_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n145_), .c(new_n159_), .O(new_n172_));
