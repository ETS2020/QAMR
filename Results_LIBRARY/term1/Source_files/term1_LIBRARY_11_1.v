...
module FAU ( 
  ...
  nand3  g115(.a(x32), .b(new_n116_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g129(.a(new_n117_), .b(new_n143_), .c(new_n125_), .O(new_n174_));
  ...
  nand4  g135(.a(new_n179_), .b(new_n145_), .c(x18), .d(x17), .O(new_n180_));
  nand3  g136(.a(x18), .b(x16), .c(x15), .O(new_n181_));
  nand3  g137(.a(x18), .b(x16), .c(x10), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n115_), .c(new_n181_), .d(new_n119_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n180_), .c(new_n140_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n178_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n172_), .c(new_n168_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n114_), .O(new_n187_));
  nand3  g143(.a(x33), .b(new_n116_), .c(new_n159_), .O(new_n188_));
