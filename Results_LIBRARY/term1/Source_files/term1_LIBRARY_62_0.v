// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:01 2020
...
module FAU ( 
  ...
  nand2  g087(.a(new_n112_), .b(x14), .O(new_n132_));
  nor2   g088(.a(new_n110_), .b(new_n109_), .O(new_n133_));
  ...
  nand2  g092(.a(new_n134_), .b(new_n112_), .O(new_n137_));
  ...
  aoi21  g104(.a(new_n94_), .b(new_n101_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(x18), .b(x12), .c(x17), .O(new_n150_));
  aoi21  g106(.a(new_n102_), .b(x28), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n145_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n142_), .c(x32), .O(new_n153_));
  nand2  g109(.a(new_n79_), .b(x00), .O(new_n154_));
  aoi21  g110(.a(new_n153_), .b(new_n131_), .c(new_n154_), .O(z8));
  inv1   g111(.a(x33), .O(new_n156_));
  oai21  g112(.a(new_n124_), .b(new_n122_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n105_), .b(new_n94_), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n105_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n127_), .O(new_n160_));
  inv1   g116(.a(new_n127_), .O(new_n161_));
  nand2  g117(.a(x31), .b(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n105_), .O(new_n163_));
  oai21  g119(.a(new_n162_), .b(new_n157_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n105_), .b(x30), .O(new_n165_));
  inv1   g121(.a(new_n150_), .O(new_n166_));
  nand2  g122(.a(x31), .b(new_n94_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n166_), .c(new_n147_), .d(new_n165_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n142_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n156_), .O(new_n170_));
  aoi21  g126(.a(new_n164_), .b(new_n161_), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n160_), .c(new_n154_), .O(z9));
endmodule
