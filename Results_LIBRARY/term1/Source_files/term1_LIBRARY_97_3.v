...
module FAU ( 
  ...
  nand4  g040(.a(new_n84_), .b(new_n82_), .c(new_n58_), .d(new_n77_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(z3));
  xor2a  g042(.a(x28), .b(x27), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n84_), .c(new_n82_), .d(new_n58_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z4));
  inv1   g045(.a(x29), .O(new_n90_));
  inv1   g046(.a(x28), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n77_), .O(new_n92_));
  xor2a  g048(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nor2   g049(.a(new_n83_), .b(new_n57_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n93_), .c(new_n81_), .O(z5));
  inv1   g052(.a(x30), .O(new_n97_));
  nand2  g053(.a(new_n92_), .b(x29), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n92_), .b(new_n97_), .c(x29), .O(new_n100_));
  oai21  g056(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n94_), .c(new_n82_), .O(new_n102_));
  ...
  nand2  g062(.a(new_n106_), .b(new_n92_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x31), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n105_), .c(new_n94_), .d(new_n82_), .O(z7));
  ...
  nand2  g082(.a(new_n91_), .b(new_n77_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n97_), .c(x29), .O(new_n128_));
  nand2  g084(.a(new_n127_), .b(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x30), .O(new_n130_));
  nand2  g086(.a(z0), .b(x31), .O(new_n131_));
  aoi21  g087(.a(new_n130_), .b(new_n128_), .c(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n126_), .b(new_n124_), .c(new_n132_), .O(new_n133_));
  nor2   g089(.a(new_n120_), .b(new_n110_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n122_), .O(new_n135_));
  nor2   g091(.a(new_n114_), .b(new_n112_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x17), .c(x11), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n120_), .O(new_n138_));
  ...
  oai21  g098(.a(new_n142_), .b(new_n121_), .c(new_n110_), .O(new_n143_));
  nand2  g099(.a(new_n106_), .b(x27), .O(new_n144_));
  oai21  g100(.a(x30), .b(x27), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  oai21  g102(.a(x19), .b(x14), .c(x31), .O(new_n147_));
  aoi21  g103(.a(new_n97_), .b(new_n90_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(x19), .b(x13), .c(x18), .O(new_n149_));
  aoi21  g105(.a(new_n106_), .b(x28), .c(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .d(new_n143_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n141_), .c(x32), .O(new_n152_));
  inv1   g108(.a(x26), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x00), .O(new_n154_));
  aoi21  g110(.a(new_n152_), .b(new_n133_), .c(new_n154_), .O(z8));
  inv1   g111(.a(x33), .O(new_n156_));
  oai21  g112(.a(new_n126_), .b(new_n124_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n104_), .b(new_n97_), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .d(new_n104_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n129_), .O(new_n160_));
  inv1   g116(.a(new_n129_), .O(new_n161_));
  nand2  g117(.a(x31), .b(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n104_), .O(new_n163_));
  oai21  g119(.a(new_n162_), .b(new_n157_), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  nand2  g121(.a(new_n104_), .b(x30), .O(new_n166_));
  nand2  g122(.a(x31), .b(new_n97_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  nand2  g124(.a(new_n112_), .b(new_n168_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n167_), .c(new_n166_), .O(new_n170_));
  nand2  g126(.a(new_n114_), .b(x14), .O(new_n171_));
  nor2   g127(.a(new_n112_), .b(new_n111_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n134_), .O(new_n173_));
  nand2  g129(.a(new_n172_), .b(new_n134_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n114_), .O(new_n175_));
  inv1   g131(.a(new_n172_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n142_), .c(new_n110_), .O(new_n177_));
  ...
  nor3   g136(.a(new_n180_), .b(new_n170_), .c(new_n165_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n156_), .O(new_n182_));
  aoi21  g138(.a(new_n164_), .b(new_n161_), .c(new_n182_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n160_), .c(new_n154_), .O(z9));
endmodule
