// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:46 2020
...
module FAU ( 
  ...
  nand3  g069(.a(x18), .b(new_n113_), .c(x12), .O(new_n114_));
  inv1   g070(.a(x18), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x17), .c(x13), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(new_n117_));
  nand4  g073(.a(x18), .b(x17), .c(new_n112_), .d(x11), .O(new_n118_));
  ...
  and2   g085(.a(x31), .b(x19), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n129_), .c(new_n124_), .d(z0), .O(new_n131_));
  nand2  g087(.a(new_n122_), .b(x11), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n112_), .O(new_n133_));
  nand3  g089(.a(new_n122_), .b(x16), .c(x10), .O(new_n134_));
  ...
  nand3  g102(.a(new_n122_), .b(x16), .c(x15), .O(new_n147_));
  ...
  nand3  g110(.a(new_n106_), .b(new_n98_), .c(x19), .O(new_n155_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n138_), .c(new_n165_), .d(x19), .O(new_n167_));
