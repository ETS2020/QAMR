// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:50 2020
...
module FAU ( 
  ...
  nor2   g092(.a(new_n117_), .b(new_n116_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(x11), .c(x16), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nor2   g095(.a(new_n125_), .b(new_n115_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n119_), .O(new_n142_));
  nand3  g098(.a(new_n137_), .b(x16), .c(x10), .O(new_n143_));
  ...
  aoi21  g102(.a(new_n140_), .b(new_n127_), .c(new_n146_), .O(new_n147_));
  ...
  xor2a  g128(.a(x31), .b(x30), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n152_), .O(new_n174_));
  aoi21  g130(.a(new_n143_), .b(new_n115_), .c(new_n138_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n174_), .c(new_n147_), .d(new_n142_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n172_), .c(new_n168_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n114_), .O(new_n179_));
  nor2   g135(.a(new_n163_), .b(new_n117_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n140_), .c(x17), .d(new_n159_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n113_), .O(z9));
endmodule
