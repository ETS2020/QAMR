// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:54 2020
...
module FAU ( 
  ...
  nand2  g091(.a(new_n116_), .b(x14), .O(new_n136_));
  nor2   g092(.a(new_n114_), .b(new_n113_), .O(new_n137_));
  ...
  nand2  g096(.a(new_n138_), .b(new_n116_), .O(new_n141_));
  nand3  g097(.a(new_n137_), .b(x16), .c(x10), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n112_), .O(new_n143_));
  nand2  g099(.a(new_n137_), .b(x11), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n122_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n141_), .d(new_n140_), .O(new_n146_));
  ...
  nand2  g106(.a(new_n114_), .b(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x31), .O(new_n152_));
  aoi21  g108(.a(new_n98_), .b(new_n91_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(x18), .b(x12), .c(x17), .O(new_n154_));
  aoi21  g110(.a(new_n108_), .b(x28), .c(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n153_), .c(new_n149_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n146_), .c(x32), .O(new_n157_));
  inv1   g113(.a(x26), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n135_), .c(new_n159_), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  oai21  g117(.a(new_n128_), .b(new_n126_), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n106_), .b(new_n98_), .O(new_n163_));
  nand3  g119(.a(x33), .b(x31), .c(x00), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n162_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n131_), .O(new_n166_));
  inv1   g122(.a(new_n131_), .O(new_n167_));
  nand2  g123(.a(x31), .b(x30), .O(new_n168_));
  nand3  g124(.a(x33), .b(new_n106_), .c(x00), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n162_), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n106_), .b(x30), .O(new_n171_));
  inv1   g127(.a(new_n154_), .O(new_n172_));
  nand2  g128(.a(x31), .b(new_n98_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n172_), .c(new_n151_), .d(new_n171_), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n146_), .O(new_n175_));
  nand2  g131(.a(x33), .b(x00), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  aoi21  g133(.a(new_n170_), .b(new_n167_), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n166_), .c(x26), .O(z9));
endmodule
