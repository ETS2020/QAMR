...
module FAU ( 
  ...
  nor2   g064(.a(new_n87_), .b(new_n83_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n81_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g067(.a(new_n106_), .b(new_n84_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n102_), .O(z6));
  nor3   g069(.a(new_n87_), .b(new_n80_), .c(new_n79_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n85_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n106_), .b(new_n116_), .c(x30), .O(new_n117_));
  nor2   g073(.a(new_n104_), .b(new_n98_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n100_), .c(new_n116_), .O(new_n119_));
  ...
  nand2  g094(.a(new_n99_), .b(new_n78_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n104_), .c(x29), .O(new_n140_));
  ...
  aoi21  g115(.a(new_n104_), .b(new_n98_), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(x19), .b(x13), .c(x18), .O(new_n161_));
  aoi21  g117(.a(new_n118_), .b(x28), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g124(.a(new_n116_), .b(new_n104_), .O(new_n169_));
  oai22  g125(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n116_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n141_), .O(new_n171_));
  inv1   g127(.a(new_n141_), .O(new_n172_));
  nand2  g128(.a(x31), .b(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n116_), .O(new_n174_));
  ...
  nand2  g135(.a(new_n124_), .b(new_n179_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n178_), .c(new_n177_), .O(new_n181_));
  nand2  g137(.a(new_n126_), .b(x14), .O(new_n182_));
  nor2   g138(.a(new_n124_), .b(new_n123_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n182_), .c(new_n146_), .O(new_n184_));
  nand2  g140(.a(new_n183_), .b(new_n146_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n126_), .O(new_n186_));
  inv1   g142(.a(new_n183_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n154_), .c(new_n122_), .O(new_n188_));
  nand2  g144(.a(new_n183_), .b(x11), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n132_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n186_), .d(new_n184_), .O(new_n191_));
  nor3   g147(.a(new_n191_), .b(new_n181_), .c(new_n176_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n167_), .O(new_n193_));
  aoi21  g149(.a(new_n175_), .b(new_n172_), .c(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n171_), .c(new_n165_), .O(z9));
endmodule
