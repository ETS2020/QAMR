...
module FAU ( 
  ...
  nand3  g067(.a(x16), .b(new_n111_), .c(x10), .O(new_n112_));
  ...
  nand3  g080(.a(new_n124_), .b(x17), .c(new_n123_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(x15), .c(new_n113_), .O(new_n127_));
  nand2  g083(.a(new_n92_), .b(new_n91_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(z0), .c(x31), .d(new_n97_), .O(new_n129_));
  nand2  g085(.a(new_n92_), .b(new_n91_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x32), .c(x30), .O(new_n131_));
  oai21  g087(.a(new_n129_), .b(new_n127_), .c(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x29), .O(new_n133_));
  nand2  g089(.a(new_n128_), .b(x29), .O(new_n134_));
  inv1   g090(.a(new_n110_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n123_), .c(x11), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n122_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(x15), .c(new_n113_), .O(new_n138_));
  nand3  g094(.a(z0), .b(x31), .c(x30), .O(new_n139_));
  nand2  g095(.a(x32), .b(new_n97_), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n138_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(x16), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n110_), .c(new_n111_), .O(new_n143_));
  inv1   g099(.a(x11), .O(new_n144_));
  nor2   g100(.a(new_n114_), .b(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n124_), .c(x16), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  oai21  g103(.a(new_n117_), .b(new_n147_), .c(new_n115_), .O(new_n148_));
  inv1   g104(.a(x14), .O(new_n149_));
  aoi21  g105(.a(new_n117_), .b(new_n149_), .c(new_n105_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g107(.a(new_n124_), .b(x12), .c(x17), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n110_), .O(new_n154_));
  nor4   g110(.a(new_n154_), .b(new_n152_), .c(new_n151_), .d(new_n146_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n143_), .c(z0), .O(new_n156_));
  aoi21  g112(.a(new_n141_), .b(new_n134_), .c(new_n156_), .O(new_n157_));
  inv1   g113(.a(x26), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n133_), .c(new_n159_), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n105_), .c(new_n97_), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n127_), .c(new_n161_), .d(new_n105_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n134_), .O(new_n164_));
  inv1   g120(.a(new_n134_), .O(new_n165_));
  nand3  g121(.a(new_n161_), .b(x31), .c(x30), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n105_), .O(new_n167_));
  oai21  g123(.a(new_n166_), .b(new_n138_), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n105_), .b(x30), .O(new_n169_));
  nand2  g125(.a(x31), .b(new_n97_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x12), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n114_), .O(new_n172_));
  nand2  g128(.a(new_n115_), .b(new_n147_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n172_), .c(new_n170_), .d(new_n169_), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n117_), .b(x14), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  or2    g133(.a(new_n177_), .b(new_n153_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand2  g136(.a(new_n178_), .b(new_n117_), .O(new_n181_));
  oai21  g137(.a(new_n177_), .b(new_n142_), .c(new_n111_), .O(new_n182_));
  oai21  g138(.a(new_n177_), .b(new_n144_), .c(new_n123_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .d(new_n180_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n175_), .c(new_n161_), .O(new_n186_));
  aoi21  g142(.a(new_n168_), .b(new_n165_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n164_), .c(new_n159_), .O(z9));
endmodule
