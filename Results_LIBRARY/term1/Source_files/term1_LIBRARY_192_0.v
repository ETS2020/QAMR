...
module FAU ( 
  ...
  nor2   g075(.a(new_n119_), .b(x17), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(x16), .O(new_n121_));
  inv1   g077(.a(x16), .O(new_n122_));
  inv1   g078(.a(new_n119_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x17), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(x11), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n121_), .c(new_n112_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n112_), .c(x10), .O(new_n128_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n119_), .c(new_n113_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n119_), .c(new_n112_), .O(new_n140_));
  inv1   g096(.a(x11), .O(new_n141_));
  oai21  g097(.a(new_n119_), .b(new_n141_), .c(new_n122_), .O(new_n142_));
  inv1   g098(.a(new_n137_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n125_), .O(new_n144_));
  ...
  oai21  g123(.a(new_n114_), .b(new_n141_), .c(new_n122_), .O(new_n168_));
  ...
  nand3  g130(.a(x18), .b(x16), .c(x15), .O(new_n175_));
  nand3  g131(.a(x18), .b(x16), .c(x10), .O(new_n176_));
