...
module FAU ( 
  ...
  nor3   g084(.a(new_n128_), .b(new_n127_), .c(new_n114_), .O(new_n129_));
  ...
  nand2  g092(.a(new_n108_), .b(x27), .O(new_n137_));
  oai21  g093(.a(x30), .b(x27), .c(new_n137_), .O(new_n138_));
  inv1   g094(.a(x16), .O(new_n139_));
  oai21  g095(.a(new_n117_), .b(new_n139_), .c(new_n115_), .O(new_n140_));
  aoi21  g096(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n141_));
  and2   g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g098(.a(x19), .b(x11), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(new_n139_), .c(new_n108_), .d(x28), .O(new_n144_));
  nand2  g100(.a(x17), .b(x16), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n127_), .c(new_n113_), .O(new_n146_));
  oai21  g102(.a(new_n127_), .b(new_n139_), .c(new_n114_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n144_), .c(new_n142_), .O(new_n150_));
  aoi21  g106(.a(new_n138_), .b(new_n93_), .c(new_n150_), .O(new_n151_));
  inv1   g107(.a(new_n127_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x17), .c(x15), .O(new_n153_));
  nor2   g109(.a(x15), .b(x10), .O(new_n154_));
  ...
  nand2  g116(.a(new_n160_), .b(x16), .O(new_n161_));
  oai21  g117(.a(new_n151_), .b(x26), .c(new_n161_), .O(new_n162_));
  ...
  nand3  g122(.a(new_n123_), .b(x15), .c(x11), .O(new_n167_));
  nand4  g123(.a(new_n152_), .b(new_n166_), .c(new_n106_), .d(new_n98_), .O(new_n168_));
  oai22  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n106_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  oai21  g126(.a(new_n121_), .b(new_n119_), .c(x15), .O(new_n171_));
  nand4  g127(.a(new_n152_), .b(x17), .c(new_n113_), .d(x10), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n166_), .O(new_n174_));
  nand3  g130(.a(new_n106_), .b(new_n98_), .c(x16), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(new_n170_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n132_), .O(new_n177_));
  inv1   g133(.a(new_n132_), .O(new_n178_));
  nand4  g134(.a(new_n152_), .b(new_n166_), .c(x31), .d(x30), .O(new_n179_));
  oai22  g135(.a(new_n179_), .b(new_n167_), .c(new_n166_), .d(x31), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n165_), .O(new_n181_));
  nand3  g137(.a(x31), .b(x30), .c(x16), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n173_), .c(new_n166_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand3  g141(.a(x18), .b(x17), .c(x15), .O(new_n186_));
  aoi21  g142(.a(new_n117_), .b(x14), .c(new_n186_), .O(new_n187_));
  oai21  g143(.a(x18), .b(x13), .c(new_n156_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(x16), .O(new_n189_));
  nand2  g145(.a(new_n143_), .b(new_n139_), .O(new_n190_));
  xnor2a g146(.a(x31), .b(x30), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n190_), .c(new_n140_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n148_), .c(new_n165_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n189_), .c(new_n166_), .O(new_n194_));
  aoi21  g150(.a(new_n185_), .b(new_n178_), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n177_), .c(new_n112_), .O(z9));
endmodule
