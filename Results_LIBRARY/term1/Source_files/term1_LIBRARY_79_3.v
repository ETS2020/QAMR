...
module FAU ( 
  ...
  nand4  g081(.a(new_n125_), .b(x17), .c(new_n123_), .d(x11), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n122_), .c(new_n113_), .O(new_n127_));
  nor2   g083(.a(new_n114_), .b(new_n123_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n113_), .c(x10), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n124_), .c(x26), .O(new_n130_));
  ...
  oai21  g092(.a(new_n130_), .b(new_n127_), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g097(.a(new_n117_), .b(new_n113_), .c(new_n115_), .O(new_n142_));
  aoi21  g098(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n143_));
  and2   g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g100(.a(x19), .b(x10), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n113_), .c(new_n108_), .d(x28), .O(new_n146_));
  nand2  g102(.a(x17), .b(x15), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n124_), .c(new_n123_), .O(new_n148_));
  oai21  g104(.a(new_n124_), .b(new_n113_), .c(new_n114_), .O(new_n149_));
  ...
  nor2   g110(.a(x17), .b(x12), .O(new_n155_));
  ...
  aoi21  g116(.a(new_n128_), .b(new_n125_), .c(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n113_), .c(new_n153_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n137_), .c(new_n112_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand4  g121(.a(new_n125_), .b(new_n165_), .c(new_n106_), .d(new_n98_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n129_), .c(new_n165_), .d(new_n106_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n138_), .O(new_n168_));
  nand2  g124(.a(new_n126_), .b(new_n122_), .O(new_n169_));
  ...
  nand2  g128(.a(new_n172_), .b(new_n133_), .O(new_n173_));
  inv1   g129(.a(new_n133_), .O(new_n174_));
  nand4  g130(.a(new_n125_), .b(new_n165_), .c(x31), .d(x30), .O(new_n175_));
  oai22  g131(.a(new_n175_), .b(new_n129_), .c(new_n165_), .d(x31), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n138_), .O(new_n177_));
  nand3  g133(.a(x31), .b(x30), .c(x15), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n169_), .c(new_n165_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand2  g137(.a(new_n128_), .b(x18), .O(new_n182_));
  aoi21  g138(.a(new_n117_), .b(x14), .c(new_n182_), .O(new_n183_));
  oai21  g139(.a(x18), .b(x13), .c(new_n156_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(x15), .O(new_n185_));
  nand2  g141(.a(new_n145_), .b(new_n113_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n186_), .c(new_n142_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n150_), .c(new_n138_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n185_), .c(new_n165_), .O(new_n190_));
  aoi21  g146(.a(new_n181_), .b(new_n174_), .c(new_n190_), .O(new_n191_));
