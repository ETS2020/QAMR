...
module FAU ( 
  ...
  nor2   g070(.a(new_n114_), .b(x18), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x13), .c(x00), .O(new_n116_));
  nand3  g072(.a(new_n114_), .b(x18), .c(x14), .O(new_n117_));
  ...
  nand2  g092(.a(x15), .b(x13), .O(new_n137_));
  nand3  g093(.a(x19), .b(x17), .c(x16), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(new_n139_));
  nand2  g095(.a(new_n108_), .b(x27), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nor2   g097(.a(x30), .b(x27), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(new_n93_), .O(new_n143_));
  oai21  g099(.a(x30), .b(x29), .c(x31), .O(new_n144_));
  aoi21  g100(.a(new_n108_), .b(x28), .c(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n143_), .c(new_n139_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x00), .O(new_n147_));
  nand4  g103(.a(x19), .b(x17), .c(x16), .d(x15), .O(new_n148_));
  nand2  g104(.a(x19), .b(x12), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n113_), .O(new_n150_));
  inv1   g106(.a(x14), .O(new_n151_));
  nand2  g107(.a(new_n114_), .b(new_n151_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .O(new_n153_));
  nand4  g109(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n112_), .O(new_n155_));
  nand3  g111(.a(x19), .b(x17), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n122_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n153_), .c(x18), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n147_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n135_), .c(x26), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand4  g119(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n164_));
  nand4  g120(.a(new_n115_), .b(new_n163_), .c(new_n106_), .d(new_n98_), .O(new_n165_));
  oai22  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n106_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x00), .O(new_n167_));
  nand3  g123(.a(x19), .b(new_n113_), .c(x12), .O(new_n168_));
  nand3  g124(.a(new_n114_), .b(x17), .c(x14), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n168_), .c(new_n122_), .O(new_n170_));
  nand4  g126(.a(x19), .b(x17), .c(new_n122_), .d(x11), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n170_), .c(x15), .O(new_n173_));
  inv1   g129(.a(new_n138_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n112_), .c(x10), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n163_), .O(new_n177_));
  nand3  g133(.a(new_n106_), .b(new_n98_), .c(x18), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n177_), .c(new_n167_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n131_), .O(new_n180_));
  inv1   g136(.a(new_n131_), .O(new_n181_));
  nand4  g137(.a(new_n115_), .b(new_n163_), .c(x31), .d(x30), .O(new_n182_));
  oai22  g138(.a(new_n182_), .b(new_n164_), .c(new_n163_), .d(x31), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x00), .O(new_n184_));
  nand3  g140(.a(x31), .b(x30), .c(x18), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n176_), .c(new_n163_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  xnor2a g144(.a(x31), .b(x30), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n139_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x00), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n159_), .c(new_n163_), .O(new_n192_));
  aoi21  g148(.a(new_n188_), .b(new_n181_), .c(new_n192_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n180_), .c(x26), .O(z9));
endmodule
