// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:45 2020
...
module FAU ( 
  ...
  oai21  g034(.a(new_n78_), .b(new_n77_), .c(x25), .O(new_n79_));
  ...
  and2   g039(.a(new_n83_), .b(new_n57_), .O(new_n84_));
  nor2   g040(.a(x26), .b(new_n56_), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n84_), .c(new_n76_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n85_), .c(new_n84_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  inv1   g046(.a(new_n83_), .O(new_n91_));
  inv1   g047(.a(x29), .O(new_n92_));
  inv1   g048(.a(x28), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  xor2a  g050(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g051(.a(new_n85_), .b(new_n57_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z5));
  nand2  g053(.a(new_n94_), .b(x29), .O(new_n98_));
  nor2   g054(.a(x30), .b(new_n92_), .O(new_n99_));
  aoi22  g055(.a(new_n99_), .b(new_n94_), .c(new_n98_), .d(x30), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n96_), .c(new_n91_), .O(z6));
  inv1   g057(.a(new_n77_), .O(new_n102_));
  inv1   g058(.a(new_n78_), .O(new_n103_));
  nand3  g059(.a(new_n82_), .b(new_n103_), .c(new_n102_), .O(new_n104_));
  inv1   g060(.a(x31), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x30), .O(new_n106_));
  or2    g062(.a(new_n106_), .b(new_n98_), .O(new_n107_));
  inv1   g063(.a(x30), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n94_), .O(new_n110_));
  nand3  g066(.a(new_n85_), .b(new_n57_), .c(x25), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(x31), .c(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n107_), .c(new_n104_), .O(z7));
  ...
  nand3  g073(.a(new_n80_), .b(x18), .c(x14), .O(new_n118_));
  ...
  nand2  g085(.a(new_n93_), .b(new_n76_), .O(new_n130_));
  ...
  nor2   g092(.a(new_n123_), .b(new_n114_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n125_), .O(new_n138_));
  nor2   g094(.a(new_n80_), .b(new_n116_), .O(new_n139_));
  ...
  nand2  g098(.a(new_n142_), .b(new_n115_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n141_), .c(new_n138_), .O(new_n144_));
  nand2  g100(.a(x16), .b(x10), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n124_), .c(new_n114_), .O(new_n146_));
  ...
  inv1   g105(.a(x14), .O(new_n150_));
  nand2  g106(.a(new_n80_), .b(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x31), .O(new_n152_));
  aoi21  g108(.a(new_n108_), .b(new_n92_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(x19), .b(x13), .c(x18), .O(new_n154_));
  aoi21  g110(.a(new_n109_), .b(x28), .c(new_n154_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n153_), .c(new_n149_), .d(new_n146_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n144_), .c(x32), .O(new_n157_));
  inv1   g113(.a(x26), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n136_), .c(new_n159_), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  oai21  g117(.a(new_n129_), .b(new_n127_), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n105_), .b(new_n108_), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n105_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  inv1   g121(.a(new_n132_), .O(new_n166_));
  nand2  g122(.a(x31), .b(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n105_), .O(new_n168_));
  oai21  g124(.a(new_n167_), .b(new_n162_), .c(new_n168_), .O(new_n169_));
  aoi21  g125(.a(x19), .b(x12), .c(x17), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n108_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n151_), .c(new_n106_), .O(new_n172_));
  nand2  g128(.a(new_n116_), .b(x13), .O(new_n173_));
  nor2   g129(.a(new_n80_), .b(new_n115_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n137_), .c(new_n173_), .O(new_n175_));
  nand2  g131(.a(new_n174_), .b(new_n137_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n116_), .O(new_n177_));
  inv1   g133(.a(new_n174_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n145_), .c(new_n114_), .O(new_n179_));
  nand2  g135(.a(new_n174_), .b(x11), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n123_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n179_), .c(new_n177_), .d(new_n175_), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n172_), .c(new_n170_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n161_), .O(new_n184_));
  aoi21  g140(.a(new_n169_), .b(new_n166_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n165_), .c(new_n159_), .O(z9));
endmodule
