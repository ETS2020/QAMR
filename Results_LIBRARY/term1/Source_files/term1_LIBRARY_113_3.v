...
module FAU ( 
  ...
  oai21  g021(.a(new_n65_), .b(x02), .c(new_n62_), .O(new_n66_));
  aoi21  g022(.a(new_n66_), .b(new_n64_), .c(x01), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n60_), .c(new_n55_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  nand4  g025(.a(x06), .b(x05), .c(new_n47_), .d(new_n50_), .O(new_n70_));
  nand2  g026(.a(new_n63_), .b(x02), .O(new_n71_));
  nand2  g027(.a(new_n65_), .b(new_n61_), .O(new_n72_));
  nand3  g028(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n56_), .O(new_n74_));
  nor2   g030(.a(new_n47_), .b(x02), .O(new_n75_));
  xor2a  g031(.a(x03), .b(x02), .O(new_n76_));
  aoi22  g032(.a(new_n76_), .b(x01), .c(new_n75_), .d(new_n65_), .O(new_n77_));
  ...
  aoi21  g037(.a(new_n79_), .b(new_n68_), .c(new_n81_), .O(z2));
  ...
  nand4  g046(.a(new_n90_), .b(new_n89_), .c(new_n87_), .d(new_n58_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nor2   g049(.a(new_n88_), .b(x26), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n93_), .c(new_n87_), .d(new_n58_), .O(new_n95_));
  ...
  nand2  g057(.a(new_n94_), .b(new_n58_), .O(new_n102_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n100_), .c(new_n112_), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n102_), .O(new_n116_));
