...
module FAU ( 
  ...
  nand4  g078(.a(new_n122_), .b(x17), .c(new_n121_), .d(x11), .O(new_n123_));
  ...
  and2   g085(.a(x31), .b(x15), .O(new_n130_));
  ...
  nand3  g089(.a(new_n122_), .b(x17), .c(x11), .O(new_n134_));
  ...
  nand3  g102(.a(new_n122_), .b(x17), .c(x16), .O(new_n147_));
  ...
  nand3  g110(.a(new_n106_), .b(new_n98_), .c(x15), .O(new_n155_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n138_), .c(new_n165_), .d(x15), .O(new_n167_));
