...
module FAU ( 
  ...
  nor4   g088(.a(new_n128_), .b(new_n125_), .c(x15), .d(new_n132_), .O(new_n133_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n126_), .c(new_n115_), .O(new_n140_));
  nand2  g096(.a(x17), .b(x11), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n126_), .c(new_n125_), .O(new_n142_));
  ...
  nand3  g114(.a(x32), .b(new_n115_), .c(new_n132_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n113_), .O(z8));
  inv1   g116(.a(new_n136_), .O(new_n161_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n136_), .O(new_n171_));
  nand2  g127(.a(new_n107_), .b(x30), .O(new_n172_));
  oai21  g128(.a(new_n117_), .b(new_n143_), .c(new_n116_), .O(new_n173_));
  nand2  g129(.a(x31), .b(new_n98_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  nand2  g131(.a(new_n117_), .b(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n174_), .c(new_n173_), .d(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n119_), .b(x14), .O(new_n178_));
  nor2   g134(.a(new_n117_), .b(new_n116_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n178_), .c(new_n145_), .O(new_n180_));
  aoi21  g136(.a(new_n179_), .b(x16), .c(x19), .O(new_n181_));
  aoi21  g137(.a(new_n179_), .b(x11), .c(x16), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n180_), .c(new_n140_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n177_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n171_), .c(new_n167_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n114_), .O(new_n187_));
  nand3  g143(.a(x33), .b(new_n115_), .c(new_n132_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n187_), .c(new_n113_), .O(z9));
endmodule
