...
module FAU ( 
  ...
  inv1   g070(.a(x13), .O(new_n115_));
  nor2   g071(.a(x18), .b(new_n115_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x19), .O(new_n117_));
  inv1   g073(.a(x19), .O(new_n118_));
  inv1   g074(.a(x26), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(x18), .d(x14), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n117_), .c(new_n114_), .O(new_n121_));
  nand4  g077(.a(x19), .b(x18), .c(new_n114_), .d(x12), .O(new_n122_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n124_), .c(new_n113_), .O(new_n129_));
  nand3  g085(.a(x16), .b(new_n113_), .c(x10), .O(new_n130_));
  ...
  oai21  g097(.a(new_n118_), .b(new_n141_), .c(new_n114_), .O(new_n142_));
  aoi21  g098(.a(new_n98_), .b(new_n91_), .c(new_n106_), .O(new_n143_));
  nand2  g099(.a(x18), .b(x14), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(new_n118_), .c(new_n108_), .d(x28), .O(new_n145_));
  nand4  g101(.a(x19), .b(x18), .c(x17), .d(x16), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n113_), .c(new_n126_), .d(new_n125_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(new_n142_), .O(new_n148_));
  aoi21  g104(.a(new_n140_), .b(new_n93_), .c(new_n148_), .O(new_n149_));
  nor2   g105(.a(new_n141_), .b(new_n114_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x16), .c(x15), .O(new_n151_));
  nor2   g107(.a(x15), .b(x10), .O(new_n152_));
  nor2   g108(.a(x16), .b(x11), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  aoi22  g111(.a(new_n141_), .b(new_n115_), .c(new_n114_), .d(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n154_), .c(new_n151_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x19), .O(new_n158_));
  oai21  g114(.a(new_n149_), .b(x26), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x32), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n138_), .c(new_n112_), .O(z8));
  inv1   g117(.a(x33), .O(new_n162_));
  nand4  g118(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n163_));
  nor2   g119(.a(x19), .b(new_n141_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n162_), .c(new_n106_), .d(new_n98_), .O(new_n165_));
  oai22  g121(.a(new_n165_), .b(new_n163_), .c(new_n162_), .d(new_n106_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n119_), .O(new_n167_));
  nand3  g123(.a(x18), .b(new_n114_), .c(x12), .O(new_n168_));
  nand3  g124(.a(new_n141_), .b(x17), .c(x13), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n168_), .c(new_n125_), .O(new_n170_));
  nand4  g126(.a(x18), .b(x17), .c(new_n125_), .d(x11), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n170_), .c(x15), .O(new_n173_));
  inv1   g129(.a(new_n130_), .O(new_n174_));
  nand2  g130(.a(new_n150_), .b(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n162_), .O(new_n177_));
  nand3  g133(.a(new_n106_), .b(new_n98_), .c(x19), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n177_), .c(new_n167_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n134_), .O(new_n180_));
  inv1   g136(.a(new_n134_), .O(new_n181_));
  nand4  g137(.a(new_n164_), .b(new_n162_), .c(x31), .d(x30), .O(new_n182_));
  oai22  g138(.a(new_n182_), .b(new_n163_), .c(new_n162_), .d(x31), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n119_), .O(new_n184_));
  nand3  g140(.a(x31), .b(x30), .c(x19), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n176_), .c(new_n162_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  nand3  g144(.a(x17), .b(x16), .c(x15), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n116_), .O(new_n190_));
  oai21  g146(.a(x17), .b(x12), .c(new_n154_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n190_), .c(x19), .O(new_n192_));
  nand2  g148(.a(new_n144_), .b(new_n118_), .O(new_n193_));
  xnor2a g149(.a(x31), .b(x30), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n147_), .c(new_n193_), .d(new_n142_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n119_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n192_), .c(new_n162_), .O(new_n197_));
  aoi21  g153(.a(new_n188_), .b(new_n181_), .c(new_n197_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n180_), .c(new_n112_), .O(z9));
endmodule
