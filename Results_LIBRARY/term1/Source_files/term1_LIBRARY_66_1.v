...
module FAU ( 
  ...
  nand3  g081(.a(x16), .b(new_n125_), .c(x10), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  ...
  oai21  g087(.a(new_n129_), .b(new_n91_), .c(x30), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(z0), .c(x31), .O(new_n134_));
  or2    g090(.a(new_n134_), .b(new_n128_), .O(new_n135_));
  nor2   g091(.a(new_n120_), .b(new_n125_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n122_), .O(new_n137_));
  nor2   g093(.a(new_n114_), .b(new_n112_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x17), .c(x11), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n120_), .O(new_n140_));
  nand2  g096(.a(new_n138_), .b(x12), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n111_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n140_), .c(new_n137_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n121_), .c(new_n125_), .O(new_n145_));
  nand2  g101(.a(new_n106_), .b(x27), .O(new_n146_));
  ...
  aoi21  g107(.a(new_n106_), .b(x28), .c(new_n151_), .O(new_n152_));
  ...
  oai21  g114(.a(new_n130_), .b(x33), .c(x29), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n98_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n128_), .c(new_n158_), .d(new_n98_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n105_), .O(new_n162_));
  nand3  g118(.a(new_n106_), .b(new_n158_), .c(x31), .O(new_n163_));
  nand2  g119(.a(x33), .b(new_n98_), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n128_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n129_), .b(x31), .O(new_n166_));
  nand2  g122(.a(x18), .b(x12), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n111_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  nand2  g125(.a(new_n112_), .b(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n168_), .c(new_n166_), .O(new_n171_));
  nand2  g127(.a(new_n114_), .b(x14), .O(new_n172_));
  nor2   g128(.a(new_n112_), .b(new_n111_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n136_), .O(new_n174_));
  nand2  g130(.a(new_n173_), .b(new_n136_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n114_), .O(new_n176_));
  inv1   g132(.a(new_n173_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n144_), .c(new_n125_), .O(new_n178_));
  ...
  nor2   g137(.a(new_n181_), .b(new_n171_), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n158_), .O(new_n183_));
  aoi21  g139(.a(new_n165_), .b(new_n130_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n162_), .c(new_n156_), .O(z9));
endmodule
