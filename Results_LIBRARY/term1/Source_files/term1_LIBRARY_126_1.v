...
module FAU ( 
  ...
  nand3  g085(.a(new_n129_), .b(new_n125_), .c(x11), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n124_), .c(new_n115_), .O(new_n131_));
  nand3  g087(.a(x16), .b(new_n115_), .c(x10), .O(new_n132_));
  ...
  nor2   g091(.a(new_n135_), .b(new_n91_), .O(new_n136_));
  oai22  g092(.a(new_n136_), .b(new_n98_), .c(new_n135_), .d(new_n102_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(z0), .c(x31), .O(new_n138_));
  nand2  g094(.a(x17), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n126_), .c(new_n125_), .O(new_n140_));
  nand2  g096(.a(x17), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n126_), .c(new_n115_), .O(new_n142_));
  inv1   g098(.a(x12), .O(new_n143_));
  oai21  g099(.a(new_n126_), .b(new_n143_), .c(new_n116_), .O(new_n144_));
  nor2   g100(.a(new_n125_), .b(new_n115_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n129_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n144_), .c(new_n142_), .d(new_n140_), .O(new_n147_));
  ...
  aoi21  g107(.a(new_n98_), .b(new_n91_), .c(new_n151_), .O(new_n152_));
  ...
  oai21  g112(.a(new_n138_), .b(new_n134_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n114_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  nand3  g115(.a(x32), .b(new_n125_), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n158_), .c(new_n113_), .O(z8));
  inv1   g117(.a(new_n136_), .O(new_n162_));
  inv1   g118(.a(x33), .O(new_n163_));
  oai21  g119(.a(new_n133_), .b(new_n131_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n107_), .b(new_n98_), .O(new_n165_));
  ...
  nand2  g125(.a(x33), .b(new_n107_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(new_n164_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n136_), .O(new_n172_));
  nand2  g128(.a(new_n107_), .b(x30), .O(new_n173_));
  oai21  g129(.a(new_n117_), .b(new_n143_), .c(new_n116_), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n98_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n117_), .b(new_n176_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n175_), .c(new_n174_), .d(new_n173_), .O(new_n178_));
  nand2  g134(.a(new_n119_), .b(x14), .O(new_n179_));
  nor2   g135(.a(new_n117_), .b(new_n116_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n179_), .c(new_n145_), .O(new_n181_));
  aoi21  g137(.a(new_n180_), .b(x15), .c(x19), .O(new_n182_));
  aoi21  g138(.a(new_n180_), .b(x10), .c(x15), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n181_), .c(new_n140_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n178_), .c(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n172_), .c(new_n168_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n114_), .O(new_n188_));
  nand3  g144(.a(x33), .b(new_n125_), .c(new_n159_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n188_), .c(new_n113_), .O(z9));
endmodule
