// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:04 2020
...
module FAU ( 
  ...
  nand3  g070(.a(x18), .b(new_n114_), .c(x12), .O(new_n115_));
  inv1   g071(.a(x18), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x17), .c(x13), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  nand4  g074(.a(x18), .b(x17), .c(new_n113_), .d(x11), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(x19), .O(new_n121_));
  inv1   g077(.a(x19), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(x18), .c(x17), .d(x14), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(new_n112_), .O(new_n124_));
  nor2   g080(.a(new_n122_), .b(new_n116_), .O(new_n125_));
  ...
  oai21  g090(.a(new_n128_), .b(new_n124_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n125_), .b(x12), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n114_), .O(new_n137_));
  nand4  g093(.a(x18), .b(x17), .c(x15), .d(x11), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n113_), .O(new_n139_));
  nand3  g095(.a(new_n125_), .b(x17), .c(x10), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n112_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n139_), .c(new_n137_), .O(new_n142_));
  nor2   g098(.a(x19), .b(x14), .O(new_n143_));
  nor3   g099(.a(new_n126_), .b(new_n113_), .c(new_n112_), .O(new_n144_));
  ...
  nand2  g104(.a(new_n108_), .b(x28), .O(new_n149_));
  aoi21  g105(.a(x19), .b(x13), .c(x18), .O(new_n150_));
  oai21  g106(.a(x30), .b(x29), .c(x31), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n148_), .d(new_n145_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n142_), .c(x32), .O(new_n154_));
  ...
  oai21  g114(.a(new_n128_), .b(new_n124_), .c(new_n158_), .O(new_n159_));
  ...
  inv1   g122(.a(new_n150_), .O(new_n167_));
  xnor2a g123(.a(x31), .b(x30), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n167_), .c(new_n139_), .O(new_n169_));
  nand2  g125(.a(new_n141_), .b(new_n137_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n145_), .c(new_n158_), .O(new_n172_));
  aoi21  g128(.a(new_n166_), .b(new_n163_), .c(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n162_), .c(new_n156_), .O(z9));
endmodule
