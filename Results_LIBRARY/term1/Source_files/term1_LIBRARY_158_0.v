...
module FAU ( 
  ...
  nand2  g087(.a(new_n109_), .b(x12), .O(new_n132_));
  nor2   g088(.a(new_n112_), .b(new_n110_), .O(new_n133_));
  ...
  nand2  g092(.a(new_n134_), .b(new_n109_), .O(new_n137_));
  ...
  nand2  g118(.a(x18), .b(x16), .O(new_n163_));
  ...
  oai21  g124(.a(x19), .b(new_n168_), .c(x17), .O(new_n169_));
  oai21  g125(.a(new_n112_), .b(x12), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(x18), .b(x16), .c(x15), .O(new_n171_));
  ...
  nand2  g133(.a(new_n110_), .b(new_n177_), .O(new_n178_));
