...
module FAU ( 
  ...
  nand3  g063(.a(new_n107_), .b(new_n99_), .c(new_n105_), .O(new_n108_));
  nand2  g064(.a(new_n107_), .b(new_n99_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x31), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n108_), .c(new_n95_), .d(new_n81_), .O(z7));
  ...
  oai21  g084(.a(x28), .b(x27), .c(new_n100_), .O(new_n129_));
  ...
  nand3  g090(.a(new_n124_), .b(x16), .c(x15), .O(new_n135_));
  ...
  aoi21  g104(.a(new_n106_), .b(new_n91_), .c(new_n148_), .O(new_n149_));
  ...
  nand2  g112(.a(new_n107_), .b(x31), .O(new_n157_));
  nand3  g113(.a(new_n105_), .b(new_n106_), .c(new_n91_), .O(new_n158_));
  ...
  aoi21  g117(.a(new_n116_), .b(x14), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n161_), .b(new_n116_), .c(new_n162_), .O(new_n163_));
  nor2   g119(.a(new_n114_), .b(new_n113_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x16), .c(x10), .O(new_n165_));
  nand2  g121(.a(new_n164_), .b(x11), .O(new_n166_));
  aoi22  g122(.a(new_n166_), .b(new_n122_), .c(new_n165_), .d(new_n112_), .O(new_n167_));
  aoi21  g123(.a(new_n130_), .b(new_n106_), .c(x31), .O(new_n168_));
  oai21  g124(.a(new_n114_), .b(new_n139_), .c(new_n113_), .O(new_n169_));
  oai21  g125(.a(new_n106_), .b(new_n91_), .c(x31), .O(new_n170_));
  ...
  nor2   g129(.a(new_n173_), .b(new_n168_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n167_), .c(new_n163_), .O(new_n175_));
  inv1   g131(.a(x27), .O(new_n176_));
  nand3  g132(.a(x31), .b(new_n144_), .c(new_n176_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n175_), .b(x33), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n160_), .c(new_n155_), .O(z9));
endmodule
