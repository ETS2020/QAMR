...
module FAU ( 
  ...
  nand4  g040(.a(new_n84_), .b(new_n81_), .c(new_n57_), .d(new_n76_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(z3));
  xor2a  g042(.a(x28), .b(x27), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n84_), .c(new_n81_), .d(new_n57_), .O(new_n88_));
  ...
  nand2  g049(.a(new_n84_), .b(new_n57_), .O(new_n94_));
  ...
  nor2   g061(.a(new_n96_), .b(new_n90_), .O(new_n106_));
  ...
  nand2  g082(.a(new_n91_), .b(new_n76_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n96_), .c(x29), .O(new_n128_));
  ...
  aoi21  g103(.a(new_n96_), .b(new_n90_), .c(new_n147_), .O(new_n148_));
  ...
  nand2  g108(.a(new_n82_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n133_), .c(new_n153_), .O(z8));
  inv1   g110(.a(x33), .O(new_n155_));
  oai21  g111(.a(new_n126_), .b(new_n124_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n104_), .b(new_n96_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n104_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n129_), .O(new_n159_));
  inv1   g115(.a(new_n129_), .O(new_n160_));
  nand2  g116(.a(x31), .b(x30), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n104_), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n156_), .c(new_n162_), .O(new_n163_));
  aoi21  g119(.a(x18), .b(x12), .c(x17), .O(new_n164_));
  nand2  g120(.a(new_n104_), .b(x30), .O(new_n165_));
  nand2  g121(.a(x31), .b(new_n96_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  nand2  g123(.a(new_n112_), .b(new_n167_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n166_), .c(new_n165_), .O(new_n169_));
  nand2  g125(.a(new_n114_), .b(x14), .O(new_n170_));
  nor2   g126(.a(new_n112_), .b(new_n111_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n170_), .c(new_n134_), .O(new_n172_));
  nand2  g128(.a(new_n171_), .b(new_n134_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n114_), .O(new_n174_));
  inv1   g130(.a(new_n171_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n142_), .c(new_n110_), .O(new_n176_));
