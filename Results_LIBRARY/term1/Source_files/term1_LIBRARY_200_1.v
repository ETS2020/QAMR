...
module FAU ( 
  ...
  aoi21  g054(.a(new_n98_), .b(new_n50_), .c(new_n47_), .O(new_n99_));
  nand2  g055(.a(new_n94_), .b(x29), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x30), .c(new_n50_), .O(new_n101_));
  ...
  or2    g062(.a(new_n106_), .b(new_n100_), .O(new_n107_));
  nor2   g063(.a(new_n98_), .b(new_n91_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n94_), .c(new_n105_), .O(new_n109_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n168_), .c(new_n106_), .O(new_n171_));
  nand2  g127(.a(new_n116_), .b(x14), .O(new_n172_));
  ...
  nand2  g131(.a(new_n175_), .b(new_n116_), .O(new_n176_));
  ...
  nor3   g137(.a(new_n181_), .b(new_n171_), .c(new_n167_), .O(new_n182_));
