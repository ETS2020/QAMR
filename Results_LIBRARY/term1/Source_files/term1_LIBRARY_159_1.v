// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:34 2020
...
module FAU ( 
  ...
  aoi21  g086(.a(new_n130_), .b(new_n126_), .c(new_n82_), .O(new_n131_));
  nand3  g087(.a(x16), .b(new_n82_), .c(x10), .O(new_n132_));
  ...
  nor2   g096(.a(new_n127_), .b(new_n82_), .O(new_n141_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n128_), .c(new_n82_), .O(new_n150_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n149_), .c(new_n82_), .O(new_n183_));
