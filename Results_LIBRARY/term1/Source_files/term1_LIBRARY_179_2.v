...
module FAU ( 
  ...
  inv1   g116(.a(x00), .O(new_n161_));
  inv1   g117(.a(x33), .O(new_n162_));
  oai21  g118(.a(new_n128_), .b(new_n126_), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n106_), .b(new_n98_), .O(new_n164_));
  nand3  g120(.a(x33), .b(x31), .c(new_n158_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n163_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n131_), .O(new_n167_));
  inv1   g123(.a(new_n131_), .O(new_n168_));
  nand2  g124(.a(x31), .b(x30), .O(new_n169_));
  nand3  g125(.a(x33), .b(new_n106_), .c(new_n158_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(new_n163_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n106_), .b(x30), .O(new_n172_));
  inv1   g128(.a(new_n154_), .O(new_n173_));
  nand2  g129(.a(x31), .b(new_n98_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n173_), .c(new_n151_), .d(new_n172_), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n146_), .O(new_n176_));
  nand2  g132(.a(x33), .b(new_n158_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  aoi21  g134(.a(new_n171_), .b(new_n168_), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n167_), .c(new_n161_), .O(z9));
endmodule
