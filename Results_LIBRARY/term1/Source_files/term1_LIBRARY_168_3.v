...
module FAU ( 
  ...
  nand4  g040(.a(new_n84_), .b(new_n82_), .c(new_n80_), .d(new_n78_), .O(new_n85_));
  ...
  nand3  g058(.a(new_n84_), .b(new_n82_), .c(x24), .O(new_n103_));
  ...
  oai21  g063(.a(new_n103_), .b(new_n77_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n99_), .b(new_n85_), .c(new_n104_), .d(x29), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n108_), .c(new_n101_), .O(z6));
  inv1   g066(.a(x31), .O(new_n111_));
  nand3  g067(.a(new_n106_), .b(new_n111_), .c(x30), .O(new_n112_));
  nand3  g068(.a(new_n99_), .b(x30), .c(x29), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(x31), .c(new_n101_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n112_), .c(new_n85_), .O(z7));
  ...
  nand4  g076(.a(new_n104_), .b(new_n120_), .c(x18), .d(x14), .O(new_n121_));
  ...
  aoi21  g089(.a(new_n98_), .b(new_n97_), .c(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n132_), .b(new_n130_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n98_), .b(new_n97_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x32), .c(x30), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x29), .O(new_n139_));
  aoi21  g095(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n140_));
  nand2  g096(.a(x32), .b(new_n104_), .O(new_n141_));
  nand4  g097(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nor2   g099(.a(new_n104_), .b(new_n118_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(z0), .d(x31), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n141_), .c(new_n140_), .O(new_n146_));
  nor2   g102(.a(new_n118_), .b(new_n117_), .O(new_n147_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n116_), .O(new_n155_));
  nand2  g111(.a(new_n147_), .b(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n126_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n153_), .c(x19), .O(new_n159_));
  nand4  g115(.a(new_n147_), .b(x16), .c(x15), .d(x14), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n120_), .c(new_n111_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(x32), .c(new_n146_), .O(new_n163_));
  inv1   g119(.a(x26), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x00), .O(new_n165_));
  aoi21  g121(.a(new_n163_), .b(new_n139_), .c(new_n165_), .O(z8));
  inv1   g122(.a(new_n140_), .O(new_n167_));
  nor2   g123(.a(x33), .b(x31), .O(new_n168_));
  oai21  g124(.a(new_n132_), .b(new_n130_), .c(new_n168_), .O(new_n169_));
  ...
  nand2  g128(.a(x33), .b(new_n111_), .O(new_n173_));
  nor2   g129(.a(x33), .b(new_n111_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n144_), .c(new_n143_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n173_), .c(new_n167_), .O(new_n176_));
  nand2  g132(.a(new_n111_), .b(x30), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n104_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n152_), .c(new_n150_), .d(new_n177_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n120_), .b(x14), .c(new_n148_), .O(new_n181_));
  aoi21  g137(.a(new_n148_), .b(new_n120_), .c(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n157_), .d(new_n155_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(x33), .c(new_n176_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n172_), .c(new_n165_), .O(z9));
endmodule
