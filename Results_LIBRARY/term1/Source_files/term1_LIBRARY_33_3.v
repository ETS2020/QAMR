// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:51 2020
...
module FAU ( 
  ...
  aoi21  g075(.a(new_n117_), .b(new_n115_), .c(new_n119_), .O(new_n120_));
  inv1   g076(.a(x17), .O(new_n121_));
  nor2   g077(.a(new_n116_), .b(new_n114_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n121_), .c(x12), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n120_), .c(x16), .O(new_n125_));
  inv1   g081(.a(x16), .O(new_n126_));
  nor2   g082(.a(x26), .b(new_n116_), .O(new_n127_));
  nand2  g083(.a(x18), .b(x17), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(x11), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n125_), .c(new_n113_), .O(new_n131_));
  nand3  g087(.a(x16), .b(new_n113_), .c(x10), .O(new_n132_));
  nand2  g088(.a(new_n129_), .b(new_n127_), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g090(.a(new_n93_), .b(new_n92_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n98_), .c(x29), .O(new_n136_));
  ...
  oai21  g096(.a(new_n134_), .b(new_n131_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n116_), .b(x14), .O(new_n142_));
  nor2   g098(.a(new_n126_), .b(new_n113_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n142_), .c(new_n129_), .O(new_n144_));
  nand2  g100(.a(new_n143_), .b(new_n129_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n116_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x10), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n128_), .c(new_n113_), .O(new_n148_));
  inv1   g104(.a(x11), .O(new_n149_));
  oai21  g105(.a(new_n128_), .b(new_n149_), .c(new_n126_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .d(new_n144_), .O(new_n151_));
  nand2  g107(.a(new_n108_), .b(x27), .O(new_n152_));
  oai21  g108(.a(x30), .b(x27), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n93_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  nand2  g111(.a(new_n114_), .b(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x31), .O(new_n157_));
  aoi21  g113(.a(new_n98_), .b(new_n91_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(x18), .b(x12), .c(x17), .O(new_n159_));
  aoi21  g115(.a(new_n108_), .b(x28), .c(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n158_), .c(new_n154_), .O(new_n161_));
  nor2   g117(.a(z0), .b(x26), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n151_), .c(new_n162_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n141_), .c(new_n112_), .O(z8));
  aoi21  g120(.a(new_n117_), .b(new_n115_), .c(new_n126_), .O(new_n165_));
  nand4  g121(.a(x19), .b(x18), .c(new_n126_), .d(x11), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n165_), .c(x15), .O(new_n168_));
  inv1   g124(.a(new_n132_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n122_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n168_), .c(x33), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n106_), .c(new_n98_), .d(x17), .O(new_n172_));
  nand2  g128(.a(x33), .b(x31), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n172_), .c(x26), .O(new_n174_));
  nand3  g130(.a(new_n143_), .b(new_n121_), .c(x12), .O(new_n175_));
  inv1   g131(.a(x33), .O(new_n176_));
  nand4  g132(.a(new_n122_), .b(new_n176_), .c(new_n106_), .d(new_n98_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n174_), .c(new_n137_), .O(new_n179_));
  inv1   g135(.a(new_n137_), .O(new_n180_));
  nand3  g136(.a(x31), .b(x30), .c(x17), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nor2   g138(.a(new_n176_), .b(x31), .O(new_n183_));
  aoi21  g139(.a(new_n182_), .b(new_n171_), .c(new_n183_), .O(new_n184_));
  inv1   g140(.a(new_n175_), .O(new_n185_));
  nor3   g141(.a(x33), .b(new_n106_), .c(new_n98_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n185_), .c(new_n122_), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(x26), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n106_), .b(x30), .O(new_n189_));
  inv1   g145(.a(new_n159_), .O(new_n190_));
  nand2  g146(.a(x31), .b(new_n98_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n156_), .d(new_n189_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n151_), .O(new_n193_));
  nor3   g149(.a(new_n193_), .b(new_n176_), .c(x26), .O(new_n194_));
  aoi21  g150(.a(new_n188_), .b(new_n180_), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n179_), .c(new_n112_), .O(z9));
endmodule
