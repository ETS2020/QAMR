...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n104_), .c(x30), .d(x29), .O(new_n105_));
  nand3  g061(.a(new_n93_), .b(x30), .c(x29), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(x31), .c(new_n95_), .O(new_n107_));
  ...
  nand2  g082(.a(new_n92_), .b(new_n91_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(z0), .c(x31), .O(new_n128_));
  oai21  g084(.a(x28), .b(x27), .c(x30), .O(new_n129_));
  ...
  nor2   g088(.a(new_n113_), .b(new_n111_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x17), .c(x11), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n119_), .O(new_n135_));
  nand2  g091(.a(new_n133_), .b(x12), .O(new_n136_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n120_), .c(new_n109_), .O(new_n140_));
  nand2  g096(.a(new_n127_), .b(x29), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n97_), .O(new_n142_));
  aoi21  g098(.a(x19), .b(x13), .c(x18), .O(new_n143_));
  oai21  g099(.a(x19), .b(x14), .c(x31), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n142_), .c(new_n140_), .O(new_n146_));
  ...
  nand2  g108(.a(new_n104_), .b(new_n97_), .O(new_n153_));
  oai22  g109(.a(new_n153_), .b(new_n152_), .c(new_n151_), .d(new_n97_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n141_), .O(new_n155_));
  inv1   g111(.a(new_n141_), .O(new_n156_));
  nand2  g112(.a(x31), .b(x30), .O(new_n157_));
  nand2  g113(.a(x33), .b(new_n104_), .O(new_n158_));
  oai21  g114(.a(new_n157_), .b(new_n152_), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n160_));
  aoi21  g116(.a(new_n113_), .b(x14), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(x18), .b(x12), .c(x17), .O(new_n162_));
  nor2   g118(.a(x18), .b(x13), .O(new_n163_));
  nor2   g119(.a(new_n104_), .b(x30), .O(new_n164_));
  nor4   g120(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n161_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  nand2  g122(.a(x18), .b(x17), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n166_), .c(new_n119_), .O(new_n168_));
  nand2  g124(.a(new_n160_), .b(new_n113_), .O(new_n169_));
  oai21  g125(.a(new_n167_), .b(new_n139_), .c(new_n109_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n165_), .c(new_n151_), .O(new_n173_));
  aoi21  g129(.a(new_n159_), .b(new_n156_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n155_), .c(new_n149_), .O(z9));
endmodule
