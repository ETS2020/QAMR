...
module FAU ( 
  ...
  xnor2a g047(.a(new_n91_), .b(x29), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n88_), .c(new_n58_), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n80_), .O(z5));
  inv1   g050(.a(x26), .O(new_n95_));
  nand4  g051(.a(x29), .b(x28), .c(x27), .d(new_n95_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n81_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z6));
  inv1   g055(.a(new_n80_), .O(new_n100_));
  nor2   g056(.a(x31), .b(x26), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n83_), .c(new_n100_), .d(new_n58_), .O(z7));
  oai21  g058(.a(x28), .b(x27), .c(x29), .O(new_n103_));
  ...
  nand3  g075(.a(x16), .b(new_n105_), .c(x10), .O(new_n120_));
  ...
  nand2  g080(.a(x32), .b(new_n104_), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(new_n104_), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n103_), .O(new_n127_));
  inv1   g083(.a(new_n103_), .O(new_n128_));
  nand2  g084(.a(x32), .b(x30), .O(new_n129_));
  oai21  g085(.a(new_n124_), .b(x30), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(x16), .b(x10), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n116_), .c(new_n105_), .O(new_n132_));
  nand2  g088(.a(x19), .b(x18), .O(new_n133_));
  nand2  g089(.a(x17), .b(x11), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n115_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  oai21  g092(.a(new_n109_), .b(new_n136_), .c(new_n107_), .O(new_n137_));
  inv1   g093(.a(x14), .O(new_n138_));
  aoi21  g094(.a(new_n109_), .b(new_n138_), .c(new_n122_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n137_), .c(new_n135_), .O(new_n140_));
  inv1   g096(.a(x12), .O(new_n141_));
  oai21  g097(.a(new_n133_), .b(new_n141_), .c(new_n106_), .O(new_n142_));
  nand3  g098(.a(new_n117_), .b(x16), .c(x15), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n132_), .c(z0), .O(new_n146_));
  aoi21  g102(.a(new_n130_), .b(new_n128_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n95_), .b(x00), .O(new_n148_));
  aoi21  g104(.a(new_n147_), .b(new_n127_), .c(new_n148_), .O(z8));
  inv1   g105(.a(x33), .O(new_n150_));
  oai21  g106(.a(new_n121_), .b(new_n119_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n122_), .b(new_n104_), .O(new_n152_));
  oai22  g108(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n122_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n103_), .O(new_n154_));
  nand2  g110(.a(x31), .b(x30), .O(new_n155_));
  nand2  g111(.a(x33), .b(new_n122_), .O(new_n156_));
  oai21  g112(.a(new_n155_), .b(new_n151_), .c(new_n156_), .O(new_n157_));
  oai21  g113(.a(new_n107_), .b(new_n141_), .c(new_n106_), .O(new_n158_));
  nand2  g114(.a(new_n122_), .b(x30), .O(new_n159_));
  nand2  g115(.a(new_n107_), .b(new_n136_), .O(new_n160_));
  nand2  g116(.a(x31), .b(new_n104_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n160_), .c(new_n159_), .d(new_n158_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nor2   g119(.a(new_n107_), .b(new_n106_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x16), .c(x15), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  oai21  g122(.a(x19), .b(new_n138_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n165_), .b(new_n109_), .O(new_n168_));
  inv1   g124(.a(new_n164_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n131_), .c(new_n105_), .O(new_n170_));
  nand2  g126(.a(new_n164_), .b(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n115_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n170_), .c(new_n168_), .d(new_n167_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n163_), .c(new_n150_), .O(new_n175_));
  aoi21  g131(.a(new_n157_), .b(new_n128_), .c(new_n175_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n154_), .c(new_n148_), .O(z9));
endmodule
