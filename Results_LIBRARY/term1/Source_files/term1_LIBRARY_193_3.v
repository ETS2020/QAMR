// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:47 2020
...
module FAU ( 
  ...
  nand4  g074(.a(new_n118_), .b(x19), .c(new_n117_), .d(x13), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n116_), .c(new_n114_), .O(new_n120_));
  nand3  g076(.a(new_n118_), .b(x19), .c(x18), .O(new_n121_));
  nand2  g077(.a(new_n114_), .b(x12), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  inv1   g081(.a(new_n121_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(x17), .c(new_n125_), .d(x11), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n124_), .c(new_n113_), .O(new_n128_));
  nand3  g084(.a(x16), .b(new_n113_), .c(x10), .O(new_n129_));
  nor2   g085(.a(new_n117_), .b(new_n114_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nor4   g087(.a(new_n131_), .b(new_n129_), .c(x26), .d(new_n115_), .O(new_n132_));
  ...
  nand2  g095(.a(new_n115_), .b(x14), .O(new_n140_));
  ...
  nand2  g099(.a(new_n141_), .b(new_n115_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n125_), .O(new_n148_));
  ...
  nand2  g109(.a(new_n117_), .b(new_n153_), .O(new_n154_));
  ...
  oai21  g119(.a(new_n132_), .b(new_n128_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n106_), .b(new_n98_), .O(new_n165_));
  nand3  g121(.a(x33), .b(x31), .c(new_n118_), .O(new_n166_));
  oai21  g122(.a(new_n165_), .b(new_n164_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n135_), .O(new_n168_));
  inv1   g124(.a(new_n135_), .O(new_n169_));
  nand2  g125(.a(x31), .b(x30), .O(new_n170_));
  nand3  g126(.a(x33), .b(new_n106_), .c(new_n118_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n164_), .c(new_n171_), .O(new_n172_));
  nand2  g128(.a(new_n106_), .b(x30), .O(new_n173_));
  inv1   g129(.a(new_n157_), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n98_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n174_), .c(new_n154_), .d(new_n173_), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n149_), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n118_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  aoi21  g135(.a(new_n172_), .b(new_n169_), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n168_), .c(new_n112_), .O(z9));
endmodule
