...
module FAU ( 
  ...
  oai21  g059(.a(new_n103_), .b(new_n98_), .c(new_n101_), .O(new_n104_));
  nor2   g060(.a(new_n96_), .b(new_n80_), .O(new_n105_));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n94_), .c(new_n108_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n96_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n109_), .c(new_n81_), .O(z7));
  ...
  or2    g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  oai22  g088(.a(new_n103_), .b(new_n93_), .c(new_n99_), .d(new_n102_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n132_), .c(z0), .d(x31), .O(new_n134_));
  nand2  g090(.a(new_n111_), .b(x27), .O(new_n135_));
  nand3  g091(.a(x32), .b(new_n102_), .c(new_n92_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(x28), .O(new_n137_));
  nor2   g093(.a(new_n125_), .b(new_n115_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n127_), .O(new_n139_));
  nor2   g095(.a(new_n119_), .b(new_n117_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x17), .c(x11), .O(new_n141_));
  nand2  g097(.a(new_n140_), .b(x12), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n116_), .c(new_n141_), .d(new_n125_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n126_), .c(new_n115_), .O(new_n145_));
  inv1   g101(.a(x14), .O(new_n146_));
  aoi21  g102(.a(new_n119_), .b(new_n146_), .c(new_n108_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  oai21  g105(.a(new_n119_), .b(new_n149_), .c(new_n117_), .O(new_n150_));
  oai21  g106(.a(new_n110_), .b(new_n93_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g117(.a(new_n108_), .b(new_n102_), .O(new_n162_));
  ...
  nand2  g121(.a(x33), .b(new_n108_), .O(new_n166_));
  oai21  g122(.a(new_n165_), .b(new_n161_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n108_), .b(x30), .O(new_n168_));
  nand2  g124(.a(x18), .b(x12), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n116_), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n102_), .O(new_n171_));
  nand2  g127(.a(new_n117_), .b(new_n149_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n168_), .O(new_n173_));
  nor2   g129(.a(new_n117_), .b(new_n116_), .O(new_n174_));
  ...
  nand2  g133(.a(new_n175_), .b(new_n119_), .O(new_n178_));
  inv1   g134(.a(new_n174_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n144_), .c(new_n115_), .O(new_n180_));
  nand2  g136(.a(new_n174_), .b(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n125_), .O(new_n182_));
