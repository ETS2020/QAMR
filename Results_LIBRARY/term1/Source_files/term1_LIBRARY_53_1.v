...
module FAU ( 
  ...
  nand2  g056(.a(x27), .b(x25), .O(new_n101_));
  nand3  g057(.a(new_n98_), .b(x29), .c(x28), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n98_), .O(new_n103_));
  nor2   g059(.a(x26), .b(new_n56_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n103_), .c(new_n81_), .d(new_n58_), .O(new_n105_));
