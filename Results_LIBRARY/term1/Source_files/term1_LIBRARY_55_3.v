// Benchmark "FAU" written by ABC on Thu Jun 25 19:57:59 2020
...
module FAU ( 
  ...
  nor2   g079(.a(new_n117_), .b(new_n115_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x17), .c(new_n123_), .d(x11), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n122_), .c(new_n113_), .O(new_n126_));
  inv1   g082(.a(x26), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x19), .c(x16), .O(new_n128_));
  nand2  g084(.a(x18), .b(x17), .O(new_n129_));
  nand2  g085(.a(new_n113_), .b(x10), .O(new_n130_));
  nor3   g086(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nand2  g087(.a(new_n93_), .b(new_n92_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n131_), .b(new_n126_), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n124_), .b(x17), .c(x16), .O(new_n139_));
  oai21  g095(.a(x19), .b(x14), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x15), .O(new_n141_));
  inv1   g097(.a(x11), .O(new_n142_));
  oai21  g098(.a(new_n129_), .b(new_n142_), .c(new_n123_), .O(new_n143_));
  nand4  g099(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n117_), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n129_), .c(new_n113_), .O(new_n147_));
  ...
  nand2  g108(.a(new_n115_), .b(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x31), .O(new_n154_));
  aoi21  g110(.a(new_n98_), .b(new_n91_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(x18), .b(x12), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n114_), .O(new_n157_));
  nand2  g113(.a(new_n108_), .b(x28), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n157_), .c(new_n155_), .d(new_n151_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n148_), .c(new_n127_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n141_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n138_), .c(new_n112_), .O(z8));
  inv1   g119(.a(x33), .O(new_n164_));
  nand4  g120(.a(x17), .b(x16), .c(new_n113_), .d(x10), .O(new_n165_));
  nand4  g121(.a(new_n124_), .b(new_n164_), .c(new_n106_), .d(new_n98_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n106_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n127_), .O(new_n168_));
  nand2  g124(.a(new_n125_), .b(new_n122_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n164_), .O(new_n170_));
  nand3  g126(.a(new_n106_), .b(new_n98_), .c(x15), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n134_), .O(new_n173_));
  inv1   g129(.a(new_n134_), .O(new_n174_));
  nand4  g130(.a(new_n124_), .b(new_n164_), .c(x31), .d(x30), .O(new_n175_));
  oai22  g131(.a(new_n175_), .b(new_n165_), .c(new_n164_), .d(x31), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n127_), .O(new_n177_));
  nand3  g133(.a(x31), .b(x30), .c(x15), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n169_), .c(new_n164_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  inv1   g137(.a(new_n144_), .O(new_n182_));
  nand2  g138(.a(new_n117_), .b(x14), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g140(.a(new_n106_), .b(x30), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n98_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n157_), .c(new_n153_), .d(new_n185_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n148_), .c(new_n127_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n184_), .c(new_n164_), .O(new_n189_));
  aoi21  g145(.a(new_n181_), .b(new_n174_), .c(new_n189_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n173_), .c(new_n112_), .O(z9));
endmodule
