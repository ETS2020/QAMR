...
module FAU ( 
  ...
  nand2  g042(.a(new_n84_), .b(x28), .O(new_n87_));
  inv1   g043(.a(x28), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(x27), .O(new_n89_));
  aoi21  g045(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n81_), .c(new_n58_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(z4));
  inv1   g048(.a(x27), .O(new_n93_));
  nor2   g049(.a(new_n88_), .b(new_n93_), .O(new_n94_));
  inv1   g050(.a(x26), .O(new_n95_));
  nand2  g051(.a(x29), .b(new_n95_), .O(new_n96_));
  ...
  nor2   g055(.a(new_n82_), .b(new_n57_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n80_), .O(z5));
  nand2  g058(.a(new_n94_), .b(x29), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x30), .c(new_n95_), .O(new_n104_));
  nor2   g060(.a(x30), .b(new_n97_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n94_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n100_), .c(new_n81_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x30), .O(new_n111_));
  or2    g067(.a(new_n111_), .b(new_n103_), .O(new_n112_));
  inv1   g068(.a(x30), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n97_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n94_), .c(new_n110_), .O(new_n115_));
  nor4   g071(.a(new_n115_), .b(new_n82_), .c(new_n57_), .d(x26), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n112_), .c(new_n81_), .O(z7));
  ...
  nand2  g094(.a(x30), .b(new_n95_), .O(new_n139_));
  oai21  g095(.a(new_n88_), .b(x26), .c(new_n93_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  aoi21  g097(.a(new_n88_), .b(new_n93_), .c(new_n97_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n139_), .c(new_n141_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n138_), .c(z0), .d(x31), .O(new_n144_));
  aoi22  g100(.a(new_n114_), .b(x27), .c(new_n84_), .d(new_n113_), .O(new_n145_));
  nor2   g101(.a(new_n128_), .b(new_n136_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n132_), .O(new_n147_));
  nand2  g103(.a(x17), .b(x11), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n129_), .c(new_n128_), .O(new_n149_));
  inv1   g105(.a(x12), .O(new_n150_));
  oai21  g106(.a(new_n129_), .b(new_n150_), .c(new_n119_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n147_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n131_), .c(new_n136_), .O(new_n154_));
  oai21  g110(.a(x19), .b(x14), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n113_), .b(new_n97_), .c(new_n155_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n122_), .b(new_n157_), .c(new_n120_), .O(new_n158_));
  nand2  g114(.a(new_n114_), .b(x28), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n152_), .c(new_n95_), .O(new_n161_));
  oai21  g117(.a(new_n145_), .b(x28), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n144_), .c(new_n118_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand2  g121(.a(new_n138_), .b(new_n165_), .O(new_n166_));
  nand2  g122(.a(x31), .b(x30), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(x31), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n140_), .c(x29), .O(new_n169_));
  nor2   g125(.a(x31), .b(x30), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n138_), .c(new_n165_), .O(new_n171_));
  nand2  g127(.a(x33), .b(x31), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(new_n142_), .O(new_n173_));
  oai21  g129(.a(new_n120_), .b(new_n150_), .c(new_n119_), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n113_), .O(new_n175_));
  nand2  g131(.a(new_n120_), .b(new_n157_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n175_), .c(new_n174_), .d(new_n111_), .O(new_n177_));
  ...
  nand2  g136(.a(new_n179_), .b(new_n146_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n122_), .O(new_n182_));
  inv1   g138(.a(new_n179_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n153_), .c(new_n136_), .O(new_n184_));
  ...
  nor2   g143(.a(new_n187_), .b(new_n177_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n165_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n173_), .c(new_n95_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n169_), .c(new_n118_), .O(z9));
endmodule
