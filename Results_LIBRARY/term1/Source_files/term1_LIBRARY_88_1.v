...
module FAU ( 
  ...
  aoi21  g044(.a(new_n81_), .b(new_n80_), .c(new_n88_), .O(new_n89_));
  ...
  inv1   g071(.a(new_n77_), .O(new_n116_));
  oai21  g072(.a(new_n78_), .b(new_n80_), .c(new_n81_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n87_), .c(new_n84_), .d(new_n116_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n111_), .b(new_n119_), .c(x30), .O(new_n120_));
  nor2   g076(.a(new_n109_), .b(new_n101_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n104_), .c(new_n119_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n106_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n118_), .O(z7));
  inv1   g080(.a(x15), .O(new_n125_));
  nand3  g081(.a(x19), .b(new_n85_), .c(x13), .O(new_n126_));
  nand3  g082(.a(new_n80_), .b(x18), .c(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n82_), .O(new_n128_));
  nand4  g084(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n129_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n131_), .c(new_n125_), .O(new_n136_));
  ...
  nor2   g101(.a(new_n132_), .b(new_n125_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n134_), .O(new_n147_));
  nor2   g103(.a(new_n80_), .b(new_n85_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(x17), .c(x11), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n132_), .O(new_n150_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n133_), .c(new_n125_), .O(new_n155_));
  ...
  aoi21  g117(.a(new_n121_), .b(x28), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n80_), .O(new_n187_));
  inv1   g143(.a(new_n184_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n154_), .c(new_n125_), .O(new_n189_));
