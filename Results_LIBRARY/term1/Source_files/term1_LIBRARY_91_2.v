...
module FAU ( 
  ...
  nand2  g105(.a(new_n109_), .b(x28), .O(new_n150_));
  aoi21  g106(.a(x19), .b(x13), .c(x18), .O(new_n151_));
  oai22  g107(.a(x30), .b(x29), .c(x19), .d(x14), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n149_), .d(new_n146_), .O(new_n154_));
  ...
  nand2  g113(.a(x32), .b(new_n107_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n113_), .O(z8));
  inv1   g115(.a(new_n134_), .O(new_n160_));
  inv1   g116(.a(x33), .O(new_n161_));
  oai21  g117(.a(new_n131_), .b(new_n129_), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n107_), .b(new_n98_), .O(new_n163_));
  nand3  g119(.a(x33), .b(x31), .c(new_n114_), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n162_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n160_), .O(new_n166_));
  nand3  g122(.a(x31), .b(x30), .c(new_n114_), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n107_), .O(new_n168_));
  oai21  g124(.a(new_n167_), .b(new_n162_), .c(new_n168_), .O(new_n169_));
  nand2  g125(.a(new_n107_), .b(x30), .O(new_n170_));
  nand2  g126(.a(new_n119_), .b(x14), .O(new_n171_));
  nor2   g127(.a(new_n117_), .b(new_n116_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n137_), .O(new_n173_));
  oai21  g129(.a(new_n117_), .b(new_n142_), .c(new_n116_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  aoi22  g131(.a(x31), .b(new_n98_), .c(new_n117_), .d(new_n175_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n174_), .c(new_n173_), .O(new_n177_));
  nand2  g133(.a(new_n172_), .b(x11), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n125_), .O(new_n179_));
  nand2  g135(.a(new_n172_), .b(new_n137_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n119_), .O(new_n181_));
  inv1   g137(.a(new_n172_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n145_), .c(new_n115_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n181_), .c(new_n179_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n177_), .c(new_n114_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n170_), .c(new_n161_), .O(new_n186_));
  aoi21  g142(.a(new_n169_), .b(new_n134_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n166_), .c(new_n113_), .O(z9));
endmodule
