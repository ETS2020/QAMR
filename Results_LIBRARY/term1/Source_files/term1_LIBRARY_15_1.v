...
module FAU ( 
  ...
  oai21  g065(.a(new_n79_), .b(new_n77_), .c(new_n78_), .O(new_n110_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n126_), .c(new_n77_), .O(new_n131_));
  nand3  g087(.a(x16), .b(new_n77_), .c(x10), .O(new_n132_));
  ...
  nor2   g096(.a(new_n127_), .b(new_n77_), .O(new_n141_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n128_), .c(new_n77_), .O(new_n150_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n149_), .c(new_n77_), .O(new_n184_));
