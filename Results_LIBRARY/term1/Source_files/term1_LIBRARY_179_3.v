...
module FAU ( 
  ...
  nand3  g116(.a(new_n106_), .b(new_n98_), .c(new_n155_), .O(new_n161_));
  ...
  nand3  g120(.a(x31), .b(x30), .c(new_n155_), .O(new_n165_));
  ...
  nand2  g127(.a(new_n114_), .b(new_n171_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n170_), .c(new_n169_), .O(new_n173_));
  nand2  g129(.a(new_n116_), .b(x14), .O(new_n174_));
  nor2   g130(.a(new_n114_), .b(new_n113_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n174_), .c(new_n136_), .O(new_n176_));
  nand2  g132(.a(new_n175_), .b(new_n136_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n116_), .O(new_n178_));
  inv1   g134(.a(new_n175_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n144_), .c(new_n112_), .O(new_n180_));
  ...
  aoi21  g142(.a(new_n186_), .b(new_n163_), .c(new_n158_), .O(z9));
endmodule
