...
module FAU ( 
  ...
  nor2   g057(.a(x30), .b(new_n91_), .O(new_n102_));
  ...
  nand4  g063(.a(new_n101_), .b(new_n107_), .c(x30), .d(x29), .O(new_n108_));
  inv1   g064(.a(x30), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n91_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n101_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x31), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n108_), .c(new_n95_), .d(new_n81_), .O(z7));
  ...
  oai21  g086(.a(x28), .b(x27), .c(new_n102_), .O(new_n131_));
  ...
  aoi21  g106(.a(new_n109_), .b(new_n91_), .c(new_n150_), .O(new_n151_));
  aoi21  g107(.a(x19), .b(x13), .c(x18), .O(new_n152_));
  aoi21  g108(.a(new_n110_), .b(x27), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g115(.a(new_n159_), .b(x28), .c(x27), .O(new_n160_));
  nand2  g116(.a(new_n110_), .b(x31), .O(new_n161_));
  nand4  g117(.a(new_n132_), .b(new_n159_), .c(new_n107_), .d(new_n109_), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n160_), .c(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n130_), .b(new_n128_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n99_), .b(x31), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  aoi22  g122(.a(new_n107_), .b(x30), .c(new_n116_), .d(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n116_), .b(new_n142_), .c(new_n115_), .O(new_n168_));
  nand2  g124(.a(new_n102_), .b(x28), .O(new_n169_));
