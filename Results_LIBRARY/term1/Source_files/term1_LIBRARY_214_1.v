// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:54 2020
...
module FAU ( 
  ...
  nand2  g085(.a(x30), .b(new_n91_), .O(new_n130_));
  oai21  g086(.a(new_n129_), .b(new_n102_), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(z0), .O(new_n132_));
  nand2  g088(.a(new_n129_), .b(x30), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n107_), .O(new_n134_));
  ...
  oai21  g102(.a(new_n116_), .b(new_n146_), .c(new_n114_), .O(new_n147_));
  aoi21  g103(.a(x30), .b(x29), .c(new_n107_), .O(new_n148_));
  inv1   g104(.a(x14), .O(new_n149_));
  aoi22  g105(.a(new_n98_), .b(new_n91_), .c(new_n116_), .d(new_n149_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n152_), .b(new_n135_), .c(new_n154_), .O(z8));
  nor2   g111(.a(new_n129_), .b(new_n91_), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  inv1   g113(.a(x33), .O(new_n158_));
  oai21  g114(.a(new_n128_), .b(new_n126_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n107_), .b(new_n98_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n107_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g118(.a(x31), .b(x30), .O(new_n163_));
  nand2  g119(.a(x33), .b(new_n107_), .O(new_n164_));
  ...
  nand2  g125(.a(new_n114_), .b(new_n146_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n166_), .O(new_n171_));
  nor2   g127(.a(new_n114_), .b(new_n113_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n136_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  oai21  g130(.a(x19), .b(new_n149_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n173_), .b(new_n116_), .O(new_n176_));
  inv1   g132(.a(new_n172_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n144_), .c(new_n112_), .O(new_n178_));
  nand2  g134(.a(new_n172_), .b(x11), .O(new_n179_));
  ...
  aoi21  g139(.a(new_n165_), .b(new_n156_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n162_), .c(new_n154_), .O(z9));
endmodule
