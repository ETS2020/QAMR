...
module FAU ( 
  ...
  nand3  g065(.a(x19), .b(new_n109_), .c(x12), .O(new_n110_));
  inv1   g066(.a(x19), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x17), .c(x14), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(new_n113_));
  nand4  g069(.a(x19), .b(x17), .c(new_n108_), .d(x11), .O(new_n114_));
  ...
  nand4  g074(.a(new_n118_), .b(x16), .c(new_n117_), .d(x10), .O(new_n119_));
  ...
  nand2  g082(.a(new_n118_), .b(x11), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n108_), .O(new_n128_));
  nand3  g084(.a(new_n118_), .b(x16), .c(x10), .O(new_n129_));
  ...
  aoi21  g094(.a(x19), .b(x12), .c(x17), .O(new_n139_));
  ...
  aoi21  g111(.a(x17), .b(x11), .c(x16), .O(new_n156_));
  ...
  nand3  g121(.a(new_n165_), .b(new_n140_), .c(x17), .O(new_n166_));
