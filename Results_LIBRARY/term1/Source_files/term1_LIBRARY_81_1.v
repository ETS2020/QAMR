// Benchmark "FAU" written by ABC on Thu Jun 25 19:58:08 2020
...
module FAU ( 
  ...
  aoi21  g033(.a(new_n77_), .b(new_n50_), .c(new_n47_), .O(new_n78_));
  ...
  nand4  g042(.a(new_n86_), .b(new_n84_), .c(new_n79_), .d(new_n76_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n86_), .c(new_n84_), .d(new_n79_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z4));
  inv1   g047(.a(x28), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n76_), .O(new_n93_));
  xor2a  g049(.a(new_n93_), .b(x29), .O(new_n94_));
  nor2   g050(.a(new_n85_), .b(new_n78_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n83_), .O(z5));
  inv1   g053(.a(x30), .O(new_n98_));
  nand2  g054(.a(new_n93_), .b(x29), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n93_), .b(new_n98_), .c(x29), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n95_), .c(new_n84_), .O(new_n103_));
  ...
  nor2   g063(.a(new_n98_), .b(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n93_), .O(new_n109_));
  nand3  g065(.a(new_n86_), .b(new_n57_), .c(new_n77_), .O(new_n110_));
  aoi21  g066(.a(new_n109_), .b(x31), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n106_), .c(new_n84_), .O(z7));
  ...
  nand2  g085(.a(new_n92_), .b(new_n76_), .O(new_n130_));
  ...
  aoi21  g106(.a(new_n98_), .b(new_n107_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n77_), .b(x00), .O(new_n156_));
  aoi21  g112(.a(new_n155_), .b(new_n136_), .c(new_n156_), .O(z8));
  inv1   g113(.a(x33), .O(new_n158_));
  oai21  g114(.a(new_n129_), .b(new_n127_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n105_), .b(new_n98_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n105_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n132_), .O(new_n162_));
  inv1   g118(.a(new_n132_), .O(new_n163_));
  nand2  g119(.a(x31), .b(x30), .O(new_n164_));
  nand2  g120(.a(x33), .b(new_n105_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n159_), .c(new_n165_), .O(new_n166_));
  aoi21  g122(.a(x18), .b(x12), .c(x17), .O(new_n167_));
  nand2  g123(.a(new_n105_), .b(x30), .O(new_n168_));
  nand2  g124(.a(x31), .b(new_n98_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  nand2  g126(.a(new_n115_), .b(new_n170_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n169_), .c(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n117_), .b(x14), .O(new_n173_));
  nor2   g129(.a(new_n115_), .b(new_n114_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n137_), .O(new_n175_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n145_), .c(new_n113_), .O(new_n179_));
