...
module FAU ( 
  ...
  nand2  g053(.a(new_n91_), .b(new_n58_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n97_), .c(new_n84_), .O(z5));
  oai21  g055(.a(x20), .b(x15), .c(x16), .O(new_n100_));
  ...
  oai21  g060(.a(new_n100_), .b(new_n83_), .c(new_n104_), .O(new_n105_));
  inv1   g061(.a(new_n84_), .O(new_n106_));
  nand4  g062(.a(new_n96_), .b(new_n106_), .c(new_n101_), .d(x29), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n98_), .O(z6));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n96_), .c(new_n109_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n98_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n110_), .c(new_n106_), .O(z7));
  ...
  nand2  g087(.a(new_n95_), .b(new_n78_), .O(new_n132_));
