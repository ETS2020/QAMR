...
module FAU ( 
  ...
  oai22  g035(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n80_));
  ...
  nand3  g075(.a(x19), .b(new_n82_), .c(x13), .O(new_n120_));
  ...
  nor2   g098(.a(new_n121_), .b(new_n82_), .O(new_n143_));
