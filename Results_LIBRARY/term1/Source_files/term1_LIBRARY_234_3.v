...
module FAU ( 
  ...
  oai21  g056(.a(new_n95_), .b(new_n94_), .c(x30), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x29), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n95_), .c(new_n101_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n98_), .c(new_n82_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z6));
  inv1   g062(.a(x20), .O(new_n107_));
  nand2  g063(.a(x21), .b(x15), .O(new_n108_));
  oai21  g064(.a(new_n77_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n81_), .O(new_n110_));
  ...
  oai21  g071(.a(new_n113_), .b(new_n95_), .c(x31), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n115_), .c(new_n110_), .d(new_n98_), .O(z7));
  nand2  g073(.a(new_n114_), .b(x27), .O(new_n118_));
  nand2  g074(.a(new_n102_), .b(new_n84_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x28), .O(new_n120_));
  nand4  g076(.a(x31), .b(x19), .c(x18), .d(x17), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  inv1   g078(.a(x10), .O(new_n123_));
  aoi22  g079(.a(new_n102_), .b(new_n94_), .c(x16), .d(new_n123_), .O(new_n124_));
  inv1   g080(.a(x16), .O(new_n125_));
  nand2  g081(.a(x15), .b(x11), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g083(.a(new_n114_), .b(x28), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n120_), .c(x32), .O(new_n130_));
  nor2   g086(.a(x28), .b(x27), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n94_), .O(new_n132_));
  oai22  g088(.a(new_n132_), .b(new_n102_), .c(new_n131_), .d(new_n103_), .O(new_n133_));
  oai21  g089(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n134_));
  nand2  g090(.a(x18), .b(x17), .O(new_n135_));
  nand3  g091(.a(z0), .b(x31), .c(x19), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n134_), .c(new_n133_), .O(new_n138_));
  nand2  g094(.a(new_n83_), .b(x00), .O(new_n139_));
  aoi21  g095(.a(new_n138_), .b(new_n130_), .c(new_n139_), .O(z8));
  inv1   g096(.a(x28), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n84_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x29), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n102_), .c(x31), .O(new_n144_));
  oai21  g100(.a(new_n131_), .b(new_n113_), .c(x31), .O(new_n145_));
  nand3  g101(.a(x19), .b(x18), .c(x17), .O(new_n146_));
  aoi21  g102(.a(x16), .b(new_n123_), .c(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n145_), .c(new_n127_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n144_), .c(x33), .O(new_n149_));
  nand3  g105(.a(new_n142_), .b(new_n114_), .c(x31), .O(new_n150_));
  nand2  g106(.a(new_n111_), .b(new_n102_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n132_), .c(new_n150_), .O(new_n152_));
  inv1   g108(.a(x33), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(x19), .c(x18), .d(x17), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n152_), .c(new_n134_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n149_), .c(new_n139_), .O(z9));
endmodule
