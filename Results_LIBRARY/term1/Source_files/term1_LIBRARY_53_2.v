...
module FAU ( 
  ...
  nor2   g050(.a(x29), .b(new_n92_), .O(new_n95_));
  aoi22  g051(.a(new_n95_), .b(x27), .c(new_n94_), .d(x29), .O(new_n96_));
  nand2  g052(.a(new_n88_), .b(new_n58_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n96_), .c(new_n80_), .O(z5));
  inv1   g054(.a(new_n97_), .O(new_n99_));
  nand3  g055(.a(x29), .b(x28), .c(x27), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n99_), .c(new_n81_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(z6));
  inv1   g058(.a(x29), .O(new_n103_));
  oai21  g059(.a(new_n94_), .b(new_n103_), .c(x31), .O(new_n104_));
  inv1   g060(.a(x31), .O(new_n105_));
  nand3  g061(.a(new_n93_), .b(new_n105_), .c(x29), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n104_), .c(new_n99_), .d(new_n81_), .O(z7));
  ...
  nand2  g081(.a(new_n92_), .b(new_n91_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n125_), .c(x29), .O(new_n127_));
  ...
  nand3  g088(.a(new_n120_), .b(x16), .c(x15), .O(new_n133_));
  ...
  nor2   g097(.a(new_n125_), .b(new_n103_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x27), .O(new_n143_));
  oai21  g099(.a(x30), .b(x27), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n92_), .O(new_n145_));
  oai21  g101(.a(x19), .b(x14), .c(x31), .O(new_n146_));
  aoi21  g102(.a(new_n125_), .b(new_n103_), .c(new_n146_), .O(new_n147_));
  aoi21  g103(.a(x19), .b(x13), .c(x18), .O(new_n148_));
  aoi21  g104(.a(new_n142_), .b(x28), .c(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n147_), .c(new_n145_), .d(new_n141_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n139_), .c(x32), .O(new_n151_));
  ...
  oai21  g111(.a(new_n124_), .b(new_n122_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n105_), .b(new_n125_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n105_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n128_), .O(new_n159_));
  inv1   g115(.a(new_n128_), .O(new_n160_));
  nand2  g116(.a(x31), .b(x30), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n125_), .O(new_n162_));
  oai21  g118(.a(new_n161_), .b(new_n156_), .c(new_n162_), .O(new_n163_));
  nand4  g119(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  aoi21  g120(.a(new_n112_), .b(x14), .c(new_n164_), .O(new_n165_));
  aoi21  g121(.a(x18), .b(x12), .c(x17), .O(new_n166_));
  nor2   g122(.a(x18), .b(x13), .O(new_n167_));
  nor2   g123(.a(x31), .b(new_n125_), .O(new_n168_));
  nor4   g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n165_), .O(new_n169_));
  inv1   g125(.a(x11), .O(new_n170_));
  nand2  g126(.a(x18), .b(x17), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n170_), .c(new_n118_), .O(new_n172_));
  nand2  g128(.a(new_n164_), .b(new_n112_), .O(new_n173_));
  oai21  g129(.a(new_n171_), .b(new_n140_), .c(new_n108_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n169_), .c(new_n155_), .O(new_n177_));
  aoi21  g133(.a(new_n163_), .b(new_n160_), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n159_), .c(new_n153_), .O(z9));
endmodule
