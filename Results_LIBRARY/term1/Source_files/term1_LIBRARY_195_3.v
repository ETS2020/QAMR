...
module FAU ( 
  ...
  nand3  g090(.a(z0), .b(x31), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(new_n133_), .b(new_n131_), .c(new_n135_), .O(new_n136_));
  ...
  nand2  g097(.a(new_n141_), .b(new_n123_), .O(new_n142_));
  nand2  g098(.a(new_n140_), .b(x12), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n114_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n108_), .b(x27), .O(new_n148_));
  ...
  aoi21  g112(.a(new_n156_), .b(new_n137_), .c(new_n112_), .O(z8));
  ...
  nand3  g130(.a(new_n174_), .b(new_n173_), .c(new_n138_), .O(new_n175_));
  nand2  g131(.a(new_n174_), .b(new_n138_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n117_), .O(new_n177_));
  inv1   g133(.a(new_n174_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n146_), .c(new_n113_), .O(new_n179_));
  ...
  nand2  g141(.a(new_n134_), .b(x00), .O(new_n186_));
  aoi21  g142(.a(new_n185_), .b(new_n162_), .c(new_n186_), .O(z9));
endmodule
