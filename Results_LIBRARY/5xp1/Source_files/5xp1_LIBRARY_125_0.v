...
module FAU ( 
  ...
  oai21  g39(.a(x5), .b(x0), .c(x1), .O(new_n57_));
  ...
  nand2  g83(.a(x5), .b(x3), .O(new_n101_));
  oai21  g84(.a(x5), .b(new_n18_), .c(new_n101_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x4), .O(new_n103_));
  nand2  g86(.a(new_n19_), .b(new_n38_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n100_), .O(new_n105_));
  aoi21  g88(.a(new_n105_), .b(x2), .c(new_n75_), .O(new_n106_));
  nand3  g89(.a(x3), .b(new_n37_), .c(new_n20_), .O(new_n107_));
  oai21  g90(.a(new_n106_), .b(new_n20_), .c(new_n107_), .O(z6));
  nand2  g91(.a(new_n93_), .b(new_n84_), .O(z7));
  nand2  g92(.a(new_n19_), .b(new_n31_), .O(new_n110_));
  oai21  g93(.a(new_n110_), .b(new_n38_), .c(new_n18_), .O(new_n111_));
  nand2  g94(.a(new_n111_), .b(new_n37_), .O(new_n112_));
  nor2   g95(.a(x1), .b(x0), .O(new_n113_));
  aoi21  g96(.a(new_n113_), .b(new_n110_), .c(new_n61_), .O(new_n114_));
  aoi21  g97(.a(new_n114_), .b(new_n112_), .c(x3), .O(z8));
  nand2  g98(.a(x5), .b(x4), .O(new_n116_));
  aoi21  g99(.a(new_n41_), .b(new_n30_), .c(new_n116_), .O(z9));
endmodule
