// Benchmark "FAU" written by ABC on Thu Jun 25 19:29:24 2020
...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n100_, new_n101_, new_n102_, new_n106_, new_n107_, new_n109_,
    new_n110_, new_n111_;
  ...
  oai21  g58(.a(new_n18_), .b(new_n31_), .c(new_n32_), .O(new_n76_));
  nand2  g59(.a(x6), .b(x3), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n31_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n76_), .c(new_n22_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n75_), .c(new_n48_), .O(new_n80_));
  ...
  nand2  g69(.a(new_n33_), .b(x2), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(new_n77_), .c(new_n48_), .O(new_n88_));
  oai21  g71(.a(new_n72_), .b(x0), .c(new_n74_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n88_), .c(x1), .O(new_n90_));
  nand2  g73(.a(x6), .b(new_n32_), .O(new_n91_));
  nand2  g74(.a(new_n18_), .b(x2), .O(new_n92_));
  nand2  g75(.a(new_n33_), .b(new_n48_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n31_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n90_), .O(z4));
  nand2  g79(.a(x3), .b(new_n32_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n31_), .c(new_n87_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  aoi21  g82(.a(new_n32_), .b(x1), .c(new_n33_), .O(new_n100_));
  nor2   g83(.a(x3), .b(x2), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n100_), .c(x0), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n99_), .O(z5));
  xor2a  g86(.a(new_n97_), .b(new_n31_), .O(z6));
  nand2  g87(.a(new_n97_), .b(new_n87_), .O(z7));
  nand3  g88(.a(new_n32_), .b(new_n31_), .c(x0), .O(new_n106_));
  aoi21  g89(.a(new_n32_), .b(x0), .c(new_n106_), .O(new_n107_));
  nor2   g90(.a(new_n107_), .b(x3), .O(z8));
  nand2  g91(.a(x2), .b(x1), .O(new_n109_));
  nor2   g92(.a(x6), .b(x0), .O(new_n110_));
  nand2  g93(.a(x5), .b(x4), .O(new_n111_));
  aoi21  g94(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(z9));
endmodule
