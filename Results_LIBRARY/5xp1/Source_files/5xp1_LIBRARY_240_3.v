...
module FAU ( 
  ...
  oai21  g23(.a(new_n19_), .b(x4), .c(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(x0), .O(new_n42_));
  aoi22  g25(.a(new_n29_), .b(new_n28_), .c(x6), .d(x4), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n39_), .O(z1));
  inv1   g27(.a(x1), .O(new_n45_));
  nand2  g28(.a(z8), .b(new_n21_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n20_), .c(x0), .O(new_n47_));
  nand3  g30(.a(x5), .b(x3), .c(x2), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n47_), .c(new_n45_), .O(new_n49_));
  nor2   g32(.a(x2), .b(x1), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n36_), .c(x6), .O(new_n51_));
  oai21  g34(.a(new_n19_), .b(new_n36_), .c(new_n51_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n49_), .c(new_n18_), .O(new_n53_));
  nor3   g36(.a(x6), .b(x5), .c(x3), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n29_), .c(new_n21_), .O(new_n55_));
  nor2   g38(.a(x6), .b(x5), .O(new_n56_));
  nor2   g39(.a(new_n19_), .b(x3), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(new_n58_));
  inv1   g41(.a(new_n50_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(x6), .c(x0), .O(new_n60_));
  oai21  g43(.a(new_n56_), .b(new_n29_), .c(new_n45_), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(new_n60_), .c(new_n58_), .d(new_n55_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(x4), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n53_), .O(z2));
  nand2  g47(.a(new_n27_), .b(new_n19_), .O(new_n65_));
  aoi21  g48(.a(new_n65_), .b(new_n20_), .c(new_n45_), .O(new_n66_));
  oai21  g49(.a(new_n21_), .b(new_n45_), .c(x5), .O(new_n67_));
  oai21  g50(.a(new_n26_), .b(new_n20_), .c(new_n67_), .O(new_n68_));
  oai21  g51(.a(new_n68_), .b(new_n66_), .c(new_n36_), .O(new_n69_));
  nand3  g52(.a(x5), .b(x2), .c(x1), .O(new_n70_));
  nand3  g53(.a(new_n56_), .b(new_n21_), .c(x0), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g55(.a(new_n40_), .b(new_n19_), .c(new_n45_), .O(new_n73_));
  nand3  g56(.a(x5), .b(x3), .c(x1), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(new_n36_), .O(new_n75_));
  aoi21  g58(.a(new_n72_), .b(z8), .c(new_n75_), .O(new_n76_));
  ...
  aoi21  g63(.a(new_n80_), .b(new_n46_), .c(x6), .O(new_n81_));
  ...
  oai21  g72(.a(new_n88_), .b(new_n45_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g83(.a(x3), .b(new_n21_), .c(new_n45_), .O(new_n101_));
  oai21  g84(.a(new_n100_), .b(new_n45_), .c(new_n101_), .O(z6));
