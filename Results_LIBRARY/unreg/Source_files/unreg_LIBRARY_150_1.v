// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:45 2020
...
module FAU ( 
  ...
  nor2   g059(.a(x18), .b(x11), .O(new_n112_));
  inv1   g060(.a(x29), .O(new_n113_));
  nand2  g061(.a(new_n58_), .b(new_n113_), .O(new_n114_));
  inv1   g062(.a(x28), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n57_), .O(new_n116_));
  oai21  g064(.a(new_n114_), .b(new_n112_), .c(new_n116_), .O(z08));
  inv1   g065(.a(x17), .O(new_n118_));
  nand2  g066(.a(new_n55_), .b(x10), .O(new_n119_));
  inv1   g067(.a(x30), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(x19), .c(x18), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  nand2  g071(.a(new_n113_), .b(new_n57_), .O(new_n124_));
  ...
  nand2  g077(.a(new_n120_), .b(new_n57_), .O(new_n130_));
