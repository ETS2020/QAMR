// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:26 2020
...
module FAU ( 
  ...
  nor2   g012(.a(x22), .b(new_n56_), .O(new_n65_));
  oai21  g013(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(new_n66_));
  ...
  nor2   g019(.a(x23), .b(new_n56_), .O(new_n72_));
  oai21  g020(.a(new_n72_), .b(new_n71_), .c(new_n53_), .O(new_n73_));
  ...
  nor2   g033(.a(x25), .b(new_n56_), .O(new_n86_));
  oai21  g034(.a(new_n86_), .b(new_n85_), .c(new_n53_), .O(new_n87_));
  ...
  nor2   g040(.a(x26), .b(new_n56_), .O(new_n93_));
  oai21  g041(.a(new_n93_), .b(new_n92_), .c(new_n53_), .O(new_n94_));
  ...
  nor2   g047(.a(x27), .b(new_n56_), .O(new_n100_));
  oai21  g048(.a(new_n100_), .b(new_n99_), .c(new_n53_), .O(new_n101_));
  ...
  nor2   g054(.a(x20), .b(new_n56_), .O(new_n107_));
  oai21  g055(.a(new_n107_), .b(new_n106_), .c(new_n53_), .O(new_n108_));
  ...
  nor2   g061(.a(x29), .b(new_n56_), .O(new_n114_));
  oai21  g062(.a(new_n114_), .b(new_n113_), .c(new_n53_), .O(new_n115_));
  ...
  nor2   g068(.a(x30), .b(new_n56_), .O(new_n121_));
  oai21  g069(.a(new_n121_), .b(new_n120_), .c(new_n53_), .O(new_n122_));
  inv1   g070(.a(x29), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n59_), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(new_n122_), .O(z09));
  inv1   g073(.a(x09), .O(new_n126_));
  nor2   g074(.a(x18), .b(new_n126_), .O(new_n127_));
  nor2   g075(.a(x31), .b(new_n56_), .O(new_n128_));
  oai21  g076(.a(new_n128_), .b(new_n127_), .c(new_n53_), .O(new_n129_));
  ...
  nor2   g082(.a(x24), .b(new_n56_), .O(new_n135_));
  oai21  g083(.a(new_n135_), .b(new_n134_), .c(new_n53_), .O(new_n136_));
  ...
  nor2   g088(.a(x18), .b(new_n140_), .O(new_n141_));
  nor2   g089(.a(x33), .b(new_n56_), .O(new_n142_));
  oai21  g090(.a(new_n142_), .b(new_n141_), .c(new_n53_), .O(new_n143_));
  ...
  nor2   g095(.a(x18), .b(new_n147_), .O(new_n148_));
  nor2   g096(.a(x34), .b(new_n56_), .O(new_n149_));
  oai21  g097(.a(new_n149_), .b(new_n148_), .c(new_n53_), .O(new_n150_));
  inv1   g098(.a(x33), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n59_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(z13));
  inv1   g101(.a(x13), .O(new_n154_));
  nor2   g102(.a(x18), .b(new_n154_), .O(new_n155_));
  nor2   g103(.a(x35), .b(new_n56_), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n155_), .c(new_n53_), .O(new_n157_));
  ...
  nor2   g109(.a(x18), .b(new_n161_), .O(new_n162_));
  nor2   g110(.a(x28), .b(new_n56_), .O(new_n163_));
  oai21  g111(.a(new_n163_), .b(new_n162_), .c(new_n53_), .O(new_n164_));
  inv1   g112(.a(x35), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(new_n59_), .O(new_n166_));
