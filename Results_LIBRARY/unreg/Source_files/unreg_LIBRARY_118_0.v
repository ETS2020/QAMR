// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:39 2020
...
module FAU ( 
  ...
  inv1   g052(.a(x17), .O(new_n105_));
  nand2  g053(.a(x19), .b(new_n105_), .O(new_n106_));
  aoi21  g054(.a(new_n55_), .b(x04), .c(new_n60_), .O(new_n107_));
