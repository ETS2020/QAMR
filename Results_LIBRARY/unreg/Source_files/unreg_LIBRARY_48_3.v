// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:27 2020
...
module FAU ( 
  ...
  nand2  g046(.a(x19), .b(new_n98_), .O(new_n99_));
  inv1   g047(.a(x27), .O(new_n100_));
  aoi21  g048(.a(new_n100_), .b(x18), .c(x05), .O(new_n101_));
  ...
  nand2  g054(.a(new_n100_), .b(new_n57_), .O(new_n107_));
