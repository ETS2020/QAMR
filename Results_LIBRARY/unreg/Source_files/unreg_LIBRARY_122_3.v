// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:40 2020
...
module FAU ( 
  ...
  nand2  g018(.a(x19), .b(new_n70_), .O(new_n71_));
  nor2   g019(.a(x18), .b(x01), .O(new_n72_));
  oai22  g020(.a(new_n72_), .b(new_n71_), .c(x22), .d(x19), .O(z02));
  nand3  g021(.a(x19), .b(x18), .c(x16), .O(new_n74_));
  inv1   g022(.a(x23), .O(new_n75_));
  nand3  g023(.a(new_n75_), .b(new_n55_), .c(x00), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g025(.a(new_n77_), .b(new_n70_), .O(new_n78_));
  nand2  g026(.a(new_n75_), .b(new_n57_), .O(new_n79_));
