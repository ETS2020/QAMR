...
module FAU ( 
  ...
  nand3  g048(.a(new_n100_), .b(x18), .c(new_n99_), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  ...
  nor2   g055(.a(x18), .b(new_n107_), .O(new_n108_));
  nor2   g056(.a(x20), .b(new_n55_), .O(new_n109_));
  oai21  g057(.a(new_n109_), .b(new_n108_), .c(new_n58_), .O(new_n110_));
  nand2  g058(.a(new_n100_), .b(new_n57_), .O(new_n111_));
