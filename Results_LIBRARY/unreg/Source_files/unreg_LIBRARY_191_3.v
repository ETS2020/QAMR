...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x03), .O(new_n53_));
  inv1   g001(.a(x17), .O(new_n54_));
  nand2  g002(.a(x19), .b(new_n54_), .O(new_n55_));
  oai22  g003(.a(new_n55_), .b(new_n53_), .c(x20), .d(x19), .O(z00));
  inv1   g004(.a(x18), .O(new_n57_));
  inv1   g005(.a(x21), .O(new_n58_));
  nand3  g006(.a(new_n58_), .b(new_n57_), .c(x02), .O(new_n59_));
  inv1   g007(.a(x22), .O(new_n60_));
  nand3  g008(.a(new_n60_), .b(x19), .c(x18), .O(new_n61_));
  nand2  g009(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g010(.a(new_n62_), .b(new_n54_), .O(new_n63_));
  inv1   g011(.a(x19), .O(new_n64_));
  nand2  g012(.a(new_n58_), .b(new_n64_), .O(new_n65_));
  nand2  g013(.a(new_n65_), .b(new_n63_), .O(z01));
  nor2   g014(.a(new_n64_), .b(x17), .O(new_n67_));
  inv1   g015(.a(x01), .O(new_n68_));
  nor2   g016(.a(x18), .b(new_n68_), .O(new_n69_));
  nor2   g017(.a(x23), .b(new_n57_), .O(new_n70_));
  oai21  g018(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(new_n71_));
  nand2  g019(.a(new_n60_), .b(new_n64_), .O(new_n72_));
  ...
  nand2  g024(.a(new_n76_), .b(new_n67_), .O(new_n77_));
