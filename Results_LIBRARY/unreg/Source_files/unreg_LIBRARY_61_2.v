// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:29 2020
...
module FAU ( 
  ...
  nand2  g063(.a(new_n115_), .b(x28), .O(z08));
  inv1   g064(.a(x10), .O(new_n117_));
  nor2   g065(.a(x18), .b(new_n117_), .O(new_n118_));
  nor2   g066(.a(x30), .b(new_n55_), .O(new_n119_));
  oai21  g067(.a(new_n119_), .b(new_n118_), .c(new_n58_), .O(new_n120_));
  inv1   g068(.a(x29), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n57_), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n120_), .O(z09));
  inv1   g071(.a(x09), .O(new_n124_));
  nor2   g072(.a(x18), .b(new_n124_), .O(new_n125_));
  nor2   g073(.a(x31), .b(new_n55_), .O(new_n126_));
  oai21  g074(.a(new_n126_), .b(new_n125_), .c(new_n58_), .O(new_n127_));
  inv1   g075(.a(x30), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n57_), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n127_), .O(z10));
  inv1   g078(.a(x08), .O(new_n131_));
  nor2   g079(.a(x18), .b(new_n131_), .O(new_n132_));
  nor2   g080(.a(x24), .b(new_n55_), .O(new_n133_));
  oai21  g081(.a(new_n133_), .b(new_n132_), .c(new_n58_), .O(new_n134_));
  inv1   g082(.a(x31), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n57_), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n134_), .O(z11));
  inv1   g085(.a(x15), .O(new_n138_));
  nor2   g086(.a(x18), .b(new_n138_), .O(new_n139_));
  nor2   g087(.a(x33), .b(new_n55_), .O(new_n140_));
  oai21  g088(.a(new_n140_), .b(new_n139_), .c(new_n58_), .O(new_n141_));
  inv1   g089(.a(x32), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n57_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n141_), .O(z12));
  inv1   g092(.a(x14), .O(new_n145_));
  nor2   g093(.a(x18), .b(new_n145_), .O(new_n146_));
  nor2   g094(.a(x34), .b(new_n55_), .O(new_n147_));
  oai21  g095(.a(new_n147_), .b(new_n146_), .c(new_n58_), .O(new_n148_));
  inv1   g096(.a(x33), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(new_n57_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n148_), .O(z13));
  inv1   g099(.a(x13), .O(new_n152_));
  nor2   g100(.a(x18), .b(new_n152_), .O(new_n153_));
  nor2   g101(.a(x35), .b(new_n55_), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(new_n153_), .c(new_n58_), .O(new_n155_));
  inv1   g103(.a(x34), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n57_), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(z14));
  inv1   g106(.a(x17), .O(new_n159_));
  nand4  g107(.a(x19), .b(new_n55_), .c(new_n159_), .d(x12), .O(new_n160_));
  oai21  g108(.a(x35), .b(x19), .c(new_n160_), .O(z15));
endmodule
