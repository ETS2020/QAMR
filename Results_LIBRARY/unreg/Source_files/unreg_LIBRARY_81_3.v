// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:33 2020
...
module FAU ( 
  ...
  nand2  g011(.a(x19), .b(new_n63_), .O(new_n64_));
  nor2   g012(.a(x18), .b(x02), .O(new_n65_));
  oai22  g013(.a(new_n65_), .b(new_n64_), .c(x21), .d(x19), .O(z01));
  inv1   g014(.a(x22), .O(new_n67_));
  nand3  g015(.a(new_n67_), .b(new_n55_), .c(x01), .O(new_n68_));
  inv1   g016(.a(x23), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(x19), .c(x18), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand2  g019(.a(new_n71_), .b(new_n63_), .O(new_n72_));
  nand2  g020(.a(new_n67_), .b(new_n57_), .O(new_n73_));
  ...
  nand2  g026(.a(new_n69_), .b(new_n57_), .O(new_n79_));
  nand2  g027(.a(new_n79_), .b(new_n78_), .O(z03));
  inv1   g028(.a(x07), .O(new_n81_));
  nor2   g029(.a(x18), .b(new_n81_), .O(new_n82_));
  nor2   g030(.a(x25), .b(new_n55_), .O(new_n83_));
  oai21  g031(.a(new_n83_), .b(new_n82_), .c(new_n58_), .O(new_n84_));
  inv1   g032(.a(x24), .O(new_n85_));
  nand2  g033(.a(new_n85_), .b(new_n57_), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(new_n84_), .O(z04));
  inv1   g035(.a(x06), .O(new_n88_));
  nor2   g036(.a(x18), .b(new_n88_), .O(new_n89_));
  nor2   g037(.a(x26), .b(new_n55_), .O(new_n90_));
  oai21  g038(.a(new_n90_), .b(new_n89_), .c(new_n58_), .O(new_n91_));
  inv1   g039(.a(x25), .O(new_n92_));
  nand2  g040(.a(new_n92_), .b(new_n57_), .O(new_n93_));
  nand2  g041(.a(new_n93_), .b(new_n91_), .O(z05));
  inv1   g042(.a(x05), .O(new_n95_));
  nor2   g043(.a(x18), .b(new_n95_), .O(new_n96_));
  nor2   g044(.a(x27), .b(new_n55_), .O(new_n97_));
  oai21  g045(.a(new_n97_), .b(new_n96_), .c(new_n58_), .O(new_n98_));
  inv1   g046(.a(x26), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n57_), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z06));
  inv1   g049(.a(x04), .O(new_n102_));
  nor2   g050(.a(x18), .b(new_n102_), .O(new_n103_));
  nor2   g051(.a(x20), .b(new_n55_), .O(new_n104_));
  oai21  g052(.a(new_n104_), .b(new_n103_), .c(new_n58_), .O(new_n105_));
  inv1   g053(.a(x27), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n57_), .O(new_n107_));
  nand2  g055(.a(new_n107_), .b(new_n105_), .O(z07));
  inv1   g056(.a(x11), .O(new_n109_));
  nor2   g057(.a(x18), .b(new_n109_), .O(new_n110_));
  nor2   g058(.a(x29), .b(new_n55_), .O(new_n111_));
  oai21  g059(.a(new_n111_), .b(new_n110_), .c(new_n58_), .O(new_n112_));
  inv1   g060(.a(x28), .O(new_n113_));
  nand2  g061(.a(new_n113_), .b(new_n57_), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n112_), .O(z08));
  inv1   g063(.a(x10), .O(new_n116_));
  nor2   g064(.a(x18), .b(new_n116_), .O(new_n117_));
  nor2   g065(.a(x30), .b(new_n55_), .O(new_n118_));
  oai21  g066(.a(new_n118_), .b(new_n117_), .c(new_n58_), .O(new_n119_));
  inv1   g067(.a(x29), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n57_), .O(new_n121_));
  nand2  g069(.a(new_n121_), .b(new_n119_), .O(z09));
  inv1   g070(.a(x09), .O(new_n123_));
  nor2   g071(.a(x18), .b(new_n123_), .O(new_n124_));
  nor2   g072(.a(x31), .b(new_n55_), .O(new_n125_));
  oai21  g073(.a(new_n125_), .b(new_n124_), .c(new_n58_), .O(new_n126_));
  inv1   g074(.a(x30), .O(new_n127_));
  nand2  g075(.a(new_n127_), .b(new_n57_), .O(new_n128_));
  nand2  g076(.a(new_n128_), .b(new_n126_), .O(z10));
  inv1   g077(.a(x08), .O(new_n130_));
  nor2   g078(.a(x18), .b(new_n130_), .O(new_n131_));
  nor2   g079(.a(x24), .b(new_n55_), .O(new_n132_));
  oai21  g080(.a(new_n132_), .b(new_n131_), .c(new_n58_), .O(new_n133_));
  inv1   g081(.a(x31), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n57_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n133_), .O(z11));
  inv1   g084(.a(x15), .O(new_n137_));
  nor2   g085(.a(x18), .b(new_n137_), .O(new_n138_));
  nor2   g086(.a(x33), .b(new_n55_), .O(new_n139_));
  oai21  g087(.a(new_n139_), .b(new_n138_), .c(new_n58_), .O(new_n140_));
  inv1   g088(.a(x32), .O(new_n141_));
  nand2  g089(.a(new_n141_), .b(new_n57_), .O(new_n142_));
  nand2  g090(.a(new_n142_), .b(new_n140_), .O(z12));
  inv1   g091(.a(x14), .O(new_n144_));
  nor2   g092(.a(x18), .b(new_n144_), .O(new_n145_));
  nor2   g093(.a(x34), .b(new_n55_), .O(new_n146_));
  oai21  g094(.a(new_n146_), .b(new_n145_), .c(new_n58_), .O(new_n147_));
  ...
  nor2   g100(.a(x35), .b(new_n55_), .O(new_n153_));
  oai21  g101(.a(new_n153_), .b(new_n152_), .c(new_n58_), .O(new_n154_));
  ...
  nor2   g107(.a(x28), .b(new_n55_), .O(new_n160_));
  oai21  g108(.a(new_n160_), .b(new_n159_), .c(new_n58_), .O(new_n161_));
  inv1   g109(.a(x35), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n57_), .O(new_n163_));
