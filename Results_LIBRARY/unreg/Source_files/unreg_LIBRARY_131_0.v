// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:41 2020
...
module FAU ( 
  ...
  inv1   g068(.a(new_n58_), .O(new_n121_));
  nand2  g069(.a(new_n55_), .b(x10), .O(new_n122_));
  inv1   g070(.a(x30), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(x18), .O(new_n124_));
  aoi21  g072(.a(new_n124_), .b(new_n122_), .c(new_n121_), .O(z09));
  ...
  nand2  g077(.a(new_n123_), .b(new_n57_), .O(new_n130_));
