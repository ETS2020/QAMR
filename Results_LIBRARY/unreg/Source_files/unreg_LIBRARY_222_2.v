...
module FAU ( 
  ...
  nor2   g055(.a(x20), .b(new_n54_), .O(new_n108_));
  oai21  g056(.a(new_n108_), .b(new_n107_), .c(new_n67_), .O(new_n109_));
  ...
  nor2   g062(.a(x29), .b(new_n54_), .O(new_n115_));
  oai21  g063(.a(new_n115_), .b(new_n114_), .c(new_n67_), .O(new_n116_));
  ...
  oai21  g070(.a(new_n122_), .b(new_n121_), .c(new_n67_), .O(new_n123_));
  ...
  nor2   g076(.a(x31), .b(new_n54_), .O(new_n129_));
  oai21  g077(.a(new_n129_), .b(new_n128_), .c(new_n67_), .O(new_n130_));
  ...
  nor2   g083(.a(x24), .b(new_n54_), .O(new_n136_));
  oai21  g084(.a(new_n136_), .b(new_n135_), .c(new_n67_), .O(new_n137_));
  ...
  oai21  g091(.a(new_n143_), .b(new_n142_), .c(new_n67_), .O(new_n144_));
  ...
  oai21  g098(.a(new_n150_), .b(new_n149_), .c(new_n67_), .O(new_n151_));
  ...
  nor2   g104(.a(x35), .b(new_n54_), .O(new_n157_));
  oai21  g105(.a(new_n157_), .b(new_n156_), .c(new_n67_), .O(new_n158_));
  ...
  oai21  g112(.a(new_n164_), .b(new_n163_), .c(new_n67_), .O(new_n165_));
  inv1   g113(.a(x35), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n60_), .O(new_n167_));
