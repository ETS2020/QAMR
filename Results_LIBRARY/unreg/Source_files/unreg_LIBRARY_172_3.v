// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:49 2020
...
module FAU ( 
  ...
  inv1   g031(.a(x17), .O(new_n84_));
  nand2  g032(.a(x19), .b(new_n84_), .O(new_n85_));
  inv1   g033(.a(x25), .O(new_n86_));
  aoi21  g034(.a(new_n86_), .b(x18), .c(x07), .O(new_n87_));
  oai22  g035(.a(new_n87_), .b(new_n85_), .c(x24), .d(x19), .O(z04));
  ...
  nand2  g040(.a(new_n86_), .b(new_n57_), .O(new_n93_));
