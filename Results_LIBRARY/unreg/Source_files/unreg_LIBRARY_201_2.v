// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:54 2020
...
module FAU ( 
  ...
  nor2   g103(.a(x35), .b(new_n55_), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n155_), .c(new_n58_), .O(new_n157_));
  inv1   g105(.a(x34), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n57_), .O(new_n159_));
  ...
  nand2  g113(.a(new_n165_), .b(new_n57_), .O(new_n166_));
