...
module FAU ( 
  ...
  nand3  g018(.a(x19), .b(new_n55_), .c(x01), .O(new_n71_));
  inv1   g019(.a(x23), .O(new_n72_));
  nand2  g020(.a(new_n72_), .b(x18), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  inv1   g023(.a(x22), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n57_), .O(new_n77_));
  nand2  g025(.a(new_n77_), .b(new_n75_), .O(z02));
  inv1   g026(.a(new_n58_), .O(new_n79_));
  nand2  g027(.a(x18), .b(x16), .O(new_n80_));
  nand2  g028(.a(new_n55_), .b(x00), .O(new_n81_));
  aoi21  g029(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z03));
