...
module FAU ( 
  ...
  nand2  g102(.a(new_n55_), .b(x13), .O(new_n155_));
  inv1   g103(.a(x35), .O(new_n156_));
  nand3  g104(.a(new_n156_), .b(x19), .c(x18), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  inv1   g107(.a(x34), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n57_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n159_), .O(z14));
  inv1   g110(.a(x12), .O(new_n163_));
  nor2   g111(.a(x18), .b(new_n163_), .O(new_n164_));
  nor2   g112(.a(x28), .b(new_n55_), .O(new_n165_));
  oai21  g113(.a(new_n165_), .b(new_n164_), .c(new_n58_), .O(new_n166_));
  nand2  g114(.a(new_n156_), .b(new_n57_), .O(new_n167_));
