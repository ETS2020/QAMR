...
module FAU ( 
  ...
  nand2  g067(.a(x19), .b(new_n119_), .O(new_n120_));
  nor2   g068(.a(x18), .b(x10), .O(new_n121_));
  oai22  g069(.a(new_n121_), .b(new_n120_), .c(x29), .d(x19), .O(z09));
  nand3  g070(.a(x19), .b(new_n55_), .c(x09), .O(new_n123_));
  ...
  nand2  g082(.a(new_n124_), .b(new_n57_), .O(new_n135_));
