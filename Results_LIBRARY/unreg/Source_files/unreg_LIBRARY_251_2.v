// Benchmark "FAU" written by ABC on Thu Jun 25 17:25:03 2020
...
module FAU ( 
  ...
  nand2  g060(.a(new_n55_), .b(x11), .O(new_n113_));
  ...
  nand2  g066(.a(new_n118_), .b(new_n57_), .O(new_n119_));
  ...
  nand2  g072(.a(new_n114_), .b(new_n57_), .O(new_n125_));
