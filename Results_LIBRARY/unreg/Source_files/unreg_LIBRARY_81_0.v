// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:32 2020
...
module FAU ( 
  ...
  nand3  g011(.a(x19), .b(new_n55_), .c(x02), .O(new_n64_));
  inv1   g012(.a(x22), .O(new_n65_));
  nand2  g013(.a(new_n65_), .b(x18), .O(new_n66_));
  nand2  g014(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(new_n63_), .O(new_n68_));
  inv1   g016(.a(x21), .O(new_n69_));
  nand2  g017(.a(new_n69_), .b(new_n57_), .O(new_n70_));
  nand2  g018(.a(new_n70_), .b(new_n68_), .O(z01));
  inv1   g019(.a(new_n58_), .O(new_n72_));
  nand2  g020(.a(new_n55_), .b(x01), .O(new_n73_));
  inv1   g021(.a(x23), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(x18), .O(new_n75_));
  aoi21  g023(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(z02));
  ...
  nand2  g028(.a(new_n74_), .b(new_n57_), .O(new_n81_));
