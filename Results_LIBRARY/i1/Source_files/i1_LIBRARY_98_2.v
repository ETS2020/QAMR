...
module FAU ( 
  ...
  nand2  g03(.a(x09), .b(new_n44_), .O(new_n45_));
  nor2   g04(.a(x02), .b(x01), .O(new_n46_));
  nor2   g05(.a(x04), .b(x03), .O(new_n47_));
  nand4  g06(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n43_), .O(new_n48_));
  aoi21  g07(.a(new_n48_), .b(x00), .c(new_n42_), .O(z01));
  inv1   g08(.a(x05), .O(new_n50_));
  nor2   g09(.a(x07), .b(x06), .O(new_n51_));
  nand4  g10(.a(new_n51_), .b(new_n47_), .c(new_n46_), .d(new_n50_), .O(new_n52_));
  and2   g11(.a(x19), .b(x00), .O(new_n53_));
  and2   g12(.a(new_n53_), .b(new_n52_), .O(z02));
  or2    g13(.a(x21), .b(x20), .O(z04));
  inv1   g14(.a(x10), .O(new_n56_));
  inv1   g15(.a(x07), .O(new_n57_));
  nand3  g16(.a(x19), .b(new_n44_), .c(new_n57_), .O(new_n58_));
  nor2   g17(.a(x06), .b(x05), .O(new_n59_));
  nand3  g18(.a(new_n47_), .b(new_n46_), .c(new_n59_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(z05));
