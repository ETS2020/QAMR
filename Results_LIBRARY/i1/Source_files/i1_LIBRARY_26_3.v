...
module FAU ( 
  ...
  nand3  g20(.a(new_n46_), .b(x08), .c(new_n44_), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n55_), .c(new_n49_), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n61_), .c(new_n42_), .O(z02));
  or2    g24(.a(x21), .b(x20), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  nand2  g26(.a(new_n46_), .b(x07), .O(new_n68_));
  nand3  g27(.a(new_n59_), .b(x19), .c(new_n45_), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n68_), .c(new_n58_), .d(new_n49_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n67_), .O(z05));
  nand3  g31(.a(new_n68_), .b(new_n55_), .c(new_n49_), .O(new_n73_));
  inv1   g32(.a(x00), .O(new_n74_));
  nor2   g33(.a(new_n60_), .b(new_n74_), .O(new_n75_));
