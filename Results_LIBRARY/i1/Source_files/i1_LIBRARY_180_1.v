...
module FAU ( 
  ...
  nand4  g10(.a(new_n47_), .b(new_n46_), .c(new_n51_), .d(new_n50_), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(x00), .O(new_n53_));
  inv1   g12(.a(x08), .O(new_n54_));
  nor2   g13(.a(x09), .b(new_n54_), .O(new_n55_));
  nand4  g14(.a(new_n47_), .b(new_n46_), .c(new_n55_), .d(new_n43_), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n53_), .c(new_n42_), .O(z02));
  or2    g16(.a(x21), .b(x20), .O(z04));
  inv1   g17(.a(x10), .O(new_n59_));
  nand2  g18(.a(new_n47_), .b(new_n46_), .O(new_n60_));
  nand4  g19(.a(new_n51_), .b(x19), .c(new_n54_), .d(new_n50_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z05));
