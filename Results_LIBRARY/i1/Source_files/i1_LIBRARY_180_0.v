// Benchmark "FAU" written by ABC on Thu Jun 25 17:26:20 2020
...
module FAU ( 
  ...
  nand4  g12(.a(new_n53_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(new_n52_), .c(new_n42_), .O(z02));
  ...
  nand3  g18(.a(new_n59_), .b(new_n50_), .c(x19), .O(new_n60_));
