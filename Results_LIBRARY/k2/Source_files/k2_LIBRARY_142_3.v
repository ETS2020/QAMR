...
module FAU ( 
  ...
  aoi21  g0708(.a(x37), .b(new_n642_), .c(x36), .O(new_n800_));
  nor2   g0709(.a(x32), .b(x31), .O(new_n801_));
  nor2   g0710(.a(x35), .b(x33), .O(new_n802_));
  ...
  nand4  g0780(.a(new_n645_), .b(new_n644_), .c(new_n643_), .d(new_n642_), .O(new_n872_));
