...
module FAU ( 
  ...
  oai21  g29(.a(x11), .b(new_n62_), .c(new_n63_), .O(new_n64_));
  nand2  g30(.a(new_n59_), .b(x10), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n61_), .O(z06));
  nand2  g32(.a(new_n59_), .b(x11), .O(new_n67_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n62_), .d(new_n58_), .O(new_n76_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n74_), .d(new_n62_), .O(new_n81_));
  ...
  nand3  g55(.a(new_n89_), .b(new_n63_), .c(new_n47_), .O(new_n90_));
