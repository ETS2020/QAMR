// Benchmark "FAU" written by ABC on Thu Jun 25 17:29:25 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n65_), .b(new_n63_), .c(new_n57_), .O(z07));
  nand2  g32(.a(new_n63_), .b(x12), .O(new_n67_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n68_), .c(new_n62_), .O(new_n73_));
