...
module FAU ( 
  ...
  nand3  g38(.a(new_n72_), .b(new_n49_), .c(x08), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n69_), .c(new_n62_), .O(z07));
  inv1   g40(.a(x12), .O(new_n75_));
  aoi21  g41(.a(new_n53_), .b(x04), .c(new_n71_), .O(new_n76_));
  oai21  g42(.a(new_n76_), .b(new_n75_), .c(new_n62_), .O(z08));
