...
module FAU ( 
  ...
  or2    g25(.a(new_n59_), .b(new_n55_), .O(z05));
  nor2   g26(.a(new_n55_), .b(new_n40_), .O(new_n61_));
  nand2  g27(.a(new_n57_), .b(x10), .O(new_n62_));
  inv1   g28(.a(x10), .O(new_n63_));
  inv1   g29(.a(new_n51_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x08), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(new_n56_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n62_), .c(new_n61_), .O(z06));
  nand2  g34(.a(new_n63_), .b(new_n56_), .O(new_n69_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n61_), .O(z07));
  ...
  nand4  g43(.a(new_n77_), .b(new_n76_), .c(new_n63_), .d(new_n56_), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n66_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n75_), .c(new_n61_), .O(z08));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n77_), .c(new_n76_), .d(new_n63_), .O(new_n83_));
