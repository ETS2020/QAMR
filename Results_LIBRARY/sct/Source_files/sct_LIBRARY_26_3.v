...
module FAU ( 
  ...
  aoi21  g42(.a(new_n67_), .b(new_n63_), .c(new_n71_), .O(new_n77_));
  nand4  g43(.a(x13), .b(new_n70_), .c(new_n62_), .d(new_n58_), .O(new_n78_));
  aoi21  g44(.a(x16), .b(x03), .c(new_n40_), .O(new_n79_));
  oai21  g45(.a(new_n78_), .b(new_n54_), .c(new_n79_), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  oai21  g47(.a(new_n76_), .b(new_n40_), .c(new_n81_), .O(z08));
  nand2  g48(.a(x16), .b(x03), .O(new_n83_));
  nand2  g49(.a(new_n68_), .b(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n76_), .d(x04), .O(z09));
  inv1   g51(.a(new_n73_), .O(new_n86_));
  nor2   g52(.a(new_n59_), .b(new_n45_), .O(new_n87_));
  oai21  g53(.a(new_n86_), .b(x00), .c(new_n87_), .O(new_n88_));
  nand2  g54(.a(new_n45_), .b(x14), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n40_), .O(z10));
  nor2   g56(.a(new_n75_), .b(x03), .O(new_n91_));
