...
module FAU ( 
  ...
  nand4  g42(.a(new_n65_), .b(new_n64_), .c(new_n76_), .d(new_n75_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n74_), .c(new_n62_), .O(z08));
  inv1   g44(.a(x13), .O(new_n79_));
  inv1   g45(.a(x10), .O(new_n80_));
  nand3  g46(.a(new_n76_), .b(new_n75_), .c(new_n80_), .O(new_n81_));
  aoi21  g47(.a(new_n53_), .b(x04), .c(new_n81_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n79_), .c(new_n62_), .O(z09));
  nand2  g49(.a(x08), .b(x07), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(x09), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n43_), .c(x06), .d(x00), .O(new_n86_));
  nand2  g52(.a(new_n44_), .b(x14), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(z10));
  aoi21  g54(.a(new_n54_), .b(new_n60_), .c(new_n40_), .O(z12));
  nor2   g55(.a(x13), .b(x12), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n53_), .c(new_n40_), .O(z13));
