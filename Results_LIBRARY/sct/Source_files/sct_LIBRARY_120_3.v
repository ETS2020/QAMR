// Benchmark "FAU" written by ABC on Thu Jun 25 17:29:05 2020
...
module FAU ( 
  ...
  nand3  g14(.a(new_n47_), .b(x06), .c(new_n43_), .O(new_n49_));
  inv1   g15(.a(new_n49_), .O(new_n50_));
  oai21  g16(.a(new_n50_), .b(new_n48_), .c(x02), .O(new_n51_));
  ...
  oai21  g24(.a(new_n56_), .b(new_n35_), .c(new_n58_), .O(new_n59_));
  ...
  oai21  g56(.a(new_n90_), .b(new_n70_), .c(new_n88_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  oai21  g58(.a(new_n44_), .b(new_n43_), .c(x04), .O(new_n93_));
  aoi21  g59(.a(new_n86_), .b(x13), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g64(.a(new_n98_), .b(new_n88_), .c(new_n96_), .O(new_n99_));
  nand2  g65(.a(new_n45_), .b(x14), .O(new_n100_));
  aoi21  g66(.a(new_n100_), .b(new_n99_), .c(new_n40_), .O(z10));
  aoi21  g67(.a(new_n88_), .b(new_n43_), .c(new_n40_), .O(z12));
