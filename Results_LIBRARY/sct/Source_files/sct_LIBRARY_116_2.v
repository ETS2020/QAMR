...
module FAU ( 
  ...
  nor2   g31(.a(x09), .b(new_n65_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n54_), .c(new_n64_), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n63_), .c(new_n62_), .O(z06));
  inv1   g34(.a(x11), .O(new_n69_));
  inv1   g35(.a(new_n60_), .O(new_n70_));
  oai21  g36(.a(new_n69_), .b(x10), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(new_n60_), .b(x11), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n62_), .O(z07));
  nand3  g39(.a(new_n66_), .b(new_n54_), .c(new_n69_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n69_), .c(new_n59_), .O(new_n77_));
  or2    g43(.a(new_n77_), .b(new_n55_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n62_), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n69_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n60_), .O(new_n82_));
  nor2   g48(.a(new_n44_), .b(x02), .O(new_n83_));
  aoi21  g49(.a(new_n82_), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  oai21  g50(.a(new_n77_), .b(new_n55_), .c(x13), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n81_), .b(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n70_), .c(new_n47_), .O(new_n90_));
