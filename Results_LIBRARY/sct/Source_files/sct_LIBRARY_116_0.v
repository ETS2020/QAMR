...
module FAU ( 
  ...
  nand3  g29(.a(new_n55_), .b(x10), .c(x04), .O(new_n64_));
  inv1   g30(.a(x10), .O(new_n65_));
  nor2   g31(.a(x09), .b(new_n58_), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(x07), .d(x06), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n64_), .c(new_n63_), .O(z06));
  inv1   g34(.a(x11), .O(new_n69_));
  aoi21  g35(.a(new_n55_), .b(x04), .c(x10), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z07));
  nand2  g37(.a(new_n62_), .b(x16), .O(new_n72_));
  nor2   g38(.a(x12), .b(new_n40_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(z08));
  nor2   g40(.a(x13), .b(new_n40_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n72_), .O(z09));
  nand2  g42(.a(x08), .b(x07), .O(new_n77_));
  nor2   g43(.a(new_n77_), .b(x09), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n47_), .c(x06), .d(x00), .O(new_n79_));
  nand2  g45(.a(new_n45_), .b(x14), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(new_n79_), .c(new_n40_), .O(z10));
  aoi21  g47(.a(new_n56_), .b(new_n43_), .c(new_n40_), .O(z12));
  nor2   g48(.a(x11), .b(x10), .O(new_n83_));
  aoi21  g49(.a(new_n83_), .b(new_n55_), .c(new_n40_), .O(z13));
