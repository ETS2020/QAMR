...
module FAU ( 
  ...
  nand3  g28(.a(new_n55_), .b(x10), .c(x04), .O(new_n63_));
  inv1   g29(.a(x10), .O(new_n64_));
  inv1   g30(.a(new_n59_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(new_n66_));
  oai21  g32(.a(new_n40_), .b(x02), .c(new_n43_), .O(new_n67_));
  aoi21  g33(.a(new_n67_), .b(x16), .c(new_n40_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n66_), .c(new_n63_), .O(z06));
  nand2  g35(.a(new_n64_), .b(new_n54_), .O(new_n70_));
  oai21  g36(.a(new_n70_), .b(new_n59_), .c(x11), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n65_), .c(new_n54_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(z07));
  nand2  g40(.a(new_n72_), .b(new_n54_), .O(new_n75_));
  oai21  g41(.a(new_n75_), .b(new_n59_), .c(x12), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n77_), .c(new_n64_), .d(new_n54_), .O(new_n79_));
  inv1   g45(.a(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n65_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n76_), .c(new_n68_), .O(z08));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n78_), .c(new_n77_), .d(new_n64_), .O(new_n84_));
  ...
  nand3  g62(.a(new_n55_), .b(new_n96_), .c(new_n64_), .O(new_n97_));
