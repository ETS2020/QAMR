...
module FAU ( 
  ...
  nand3  g29(.a(new_n63_), .b(new_n59_), .c(x08), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n65_), .b(new_n54_), .O(new_n66_));
  nand2  g32(.a(new_n60_), .b(x10), .O(new_n67_));
  nand3  g33(.a(new_n67_), .b(new_n66_), .c(new_n62_), .O(z06));
  nand2  g34(.a(new_n66_), .b(x11), .O(new_n69_));
  inv1   g35(.a(x11), .O(new_n70_));
  inv1   g36(.a(new_n55_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n70_), .c(new_n63_), .d(new_n59_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n69_), .c(new_n62_), .O(z07));
  nand2  g39(.a(new_n66_), .b(x12), .O(new_n74_));
  aoi21  g40(.a(x12), .b(new_n70_), .c(new_n51_), .O(new_n75_));
  ...
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n80_));
  nor2   g46(.a(new_n80_), .b(new_n60_), .O(new_n81_));
  nor2   g47(.a(new_n44_), .b(x02), .O(new_n82_));
  aoi21  g48(.a(new_n81_), .b(new_n47_), .c(new_n82_), .O(new_n83_));
  nand3  g49(.a(new_n78_), .b(new_n63_), .c(new_n59_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n55_), .c(x13), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(x04), .O(z09));
  inv1   g53(.a(new_n60_), .O(new_n88_));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n80_), .b(new_n89_), .O(new_n90_));
  ...
  nor2   g59(.a(new_n82_), .b(x03), .O(new_n94_));
