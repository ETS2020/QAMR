...
module FAU ( 
  ...
  nand3  g32(.a(new_n64_), .b(x08), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x11), .O(new_n68_));
  nor2   g34(.a(x11), .b(x10), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n63_), .c(new_n58_), .O(new_n70_));
  ...
  nand3  g41(.a(new_n64_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n73_), .c(new_n61_), .O(z08));
  inv1   g45(.a(x10), .O(new_n80_));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n75_), .c(new_n74_), .d(new_n80_), .O(new_n82_));
