// Benchmark "FAU" written by ABC on Thu Jun 25 17:28:57 2020
...
module FAU ( 
  ...
  nand4  g38(.a(new_n64_), .b(new_n63_), .c(new_n72_), .d(new_n68_), .O(new_n73_));
  ...
  nand4  g44(.a(new_n78_), .b(new_n58_), .c(new_n43_), .d(x02), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n54_), .O(new_n80_));
  inv1   g46(.a(x16), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(x02), .O(new_n82_));
  aoi21  g48(.a(new_n80_), .b(new_n77_), .c(new_n82_), .O(new_n83_));
  nand2  g49(.a(new_n73_), .b(x13), .O(new_n84_));
  ...
  aoi21  g54(.a(new_n44_), .b(x16), .c(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n78_), .b(new_n43_), .c(x02), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n76_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n89_), .c(new_n87_), .O(new_n92_));
  nand2  g58(.a(new_n46_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n40_), .O(z10));
  nor2   g60(.a(new_n82_), .b(x03), .O(new_n95_));
