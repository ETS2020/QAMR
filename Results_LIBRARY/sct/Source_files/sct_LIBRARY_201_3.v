...
module FAU ( 
  ...
  nand3  g43(.a(new_n70_), .b(x13), .c(new_n76_), .O(new_n78_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n40_), .c(new_n81_), .O(z08));
  nand2  g48(.a(x16), .b(x03), .O(new_n83_));
  nand2  g49(.a(new_n70_), .b(new_n76_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n54_), .c(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n75_), .d(x04), .O(z09));
  inv1   g52(.a(new_n72_), .O(new_n87_));
  ...
  nor2   g57(.a(new_n74_), .b(x03), .O(new_n92_));
