...
module FAU ( 
  ...
  aoi21  g057(.a(new_n117_), .b(x27), .c(x08), .O(new_n120_));
  aoi21  g058(.a(new_n82_), .b(x29), .c(new_n120_), .O(new_n121_));
  inv1   g059(.a(x09), .O(new_n122_));
  inv1   g060(.a(x30), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g062(.a(new_n121_), .b(new_n119_), .c(new_n124_), .O(z11));
  ...
  nand4  g084(.a(new_n131_), .b(new_n146_), .c(new_n123_), .d(x28), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  nand2  g086(.a(new_n143_), .b(z08), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n138_), .O(new_n150_));
  nand3  g088(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n77_), .O(new_n153_));
  nand2  g091(.a(new_n149_), .b(new_n128_), .O(new_n154_));
  ...
  oai22  g100(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n117_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  inv1   g102(.a(new_n75_), .O(new_n165_));
  nor2   g103(.a(new_n72_), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n165_), .c(new_n124_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n164_), .O(z18));
  oai21  g106(.a(new_n74_), .b(x27), .c(x35), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n117_), .O(new_n170_));
  aoi21  g108(.a(x35), .b(x27), .c(x08), .O(new_n171_));
  oai21  g109(.a(new_n117_), .b(x27), .c(x35), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n82_), .c(new_n171_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n170_), .c(new_n124_), .O(z20));
  aoi21  g112(.a(new_n121_), .b(new_n119_), .c(new_n124_), .O(z19));
endmodule
