...
module FAU ( 
  ...
  nand3  g018(.a(new_n64_), .b(new_n80_), .c(x04), .O(new_n81_));
  ...
  inv1   g044(.a(x36), .O(new_n107_));
  nand2  g045(.a(x39), .b(x05), .O(new_n108_));
  aoi21  g046(.a(new_n107_), .b(x28), .c(new_n108_), .O(new_n109_));
  inv1   g047(.a(x39), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n83_), .c(x07), .O(new_n111_));
  inv1   g049(.a(new_n111_), .O(new_n112_));
  oai21  g050(.a(new_n112_), .b(new_n109_), .c(x40), .O(new_n113_));
  nand2  g051(.a(new_n103_), .b(x36), .O(new_n114_));
  inv1   g052(.a(x40), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(x35), .c(new_n83_), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(x07), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n113_), .c(new_n64_), .O(new_n119_));
  inv1   g057(.a(x05), .O(new_n120_));
  inv1   g058(.a(new_n75_), .O(new_n121_));
  nand2  g059(.a(z08), .b(new_n121_), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n119_), .c(new_n66_), .O(new_n124_));
  ...
  nand2  g066(.a(new_n128_), .b(new_n80_), .O(new_n129_));
  oai21  g067(.a(new_n64_), .b(new_n66_), .c(new_n83_), .O(new_n130_));
  nand2  g068(.a(z08), .b(x29), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n130_), .c(new_n72_), .O(new_n132_));
  or2    g070(.a(x30), .b(x09), .O(new_n133_));
  aoi21  g071(.a(new_n132_), .b(new_n129_), .c(new_n133_), .O(z11));
  nand2  g072(.a(new_n85_), .b(new_n83_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(x27), .c(z08), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  nand2  g075(.a(x40), .b(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x04), .O(new_n140_));
  inv1   g078(.a(x10), .O(new_n141_));
  inv1   g079(.a(new_n138_), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n141_), .c(new_n85_), .d(new_n72_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n140_), .c(new_n137_), .O(z12));
  nor2   g082(.a(x36), .b(new_n83_), .O(new_n145_));
  inv1   g083(.a(x13), .O(new_n146_));
  nand4  g084(.a(x40), .b(x39), .c(new_n146_), .d(new_n66_), .O(new_n147_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n122_), .c(new_n151_), .O(z13));
  nand2  g092(.a(new_n145_), .b(new_n75_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n152_), .c(x40), .d(x39), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n149_), .O(new_n157_));
  nand2  g095(.a(new_n153_), .b(new_n139_), .O(new_n158_));
  aoi22  g096(.a(new_n75_), .b(new_n64_), .c(new_n85_), .d(new_n72_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n137_), .O(z14));
  ...
  nand2  g105(.a(new_n73_), .b(new_n64_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n131_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nor2   g108(.a(new_n64_), .b(x04), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n73_), .c(new_n133_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n170_), .O(z18));
  aoi21  g111(.a(z08), .b(x29), .c(new_n83_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n80_), .c(new_n64_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(x35), .c(new_n133_), .O(z20));
