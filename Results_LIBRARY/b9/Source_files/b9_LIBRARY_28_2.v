...
module FAU ( 
  ...
  aoi21  g011(.a(new_n73_), .b(x28), .c(new_n72_), .O(new_n74_));
  nor2   g012(.a(x32), .b(x30), .O(new_n75_));
  inv1   g013(.a(new_n75_), .O(new_n76_));
  oai21  g014(.a(new_n76_), .b(new_n74_), .c(x04), .O(z01));
  nor2   g015(.a(x27), .b(x08), .O(new_n78_));
  oai21  g016(.a(new_n78_), .b(x28), .c(x04), .O(new_n79_));
  ...
  nand2  g049(.a(x35), .b(new_n84_), .O(new_n112_));
  aoi21  g050(.a(new_n112_), .b(new_n73_), .c(new_n72_), .O(new_n113_));
  nor3   g051(.a(new_n75_), .b(new_n80_), .c(new_n109_), .O(new_n114_));
  aoi21  g052(.a(new_n113_), .b(new_n111_), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g057(.a(new_n119_), .b(new_n112_), .c(new_n118_), .O(new_n120_));
  inv1   g058(.a(x08), .O(new_n121_));
  inv1   g059(.a(new_n112_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(x27), .c(new_n64_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nor2   g062(.a(x30), .b(x09), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z11));
  aoi21  g065(.a(new_n63_), .b(new_n87_), .c(new_n72_), .O(new_n128_));
  oai21  g066(.a(x37), .b(x28), .c(x27), .O(new_n129_));
  nand2  g067(.a(z08), .b(new_n64_), .O(new_n130_));
  nor2   g068(.a(x37), .b(x35), .O(new_n131_));
  aoi22  g069(.a(new_n131_), .b(new_n80_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  oai21  g070(.a(new_n128_), .b(x10), .c(new_n132_), .O(z12));
  inv1   g071(.a(x13), .O(new_n134_));
  inv1   g072(.a(x39), .O(new_n135_));
  nor2   g073(.a(new_n135_), .b(x04), .O(new_n136_));
  nand2  g074(.a(x36), .b(x35), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x28), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n136_), .c(x40), .d(new_n134_), .O(new_n139_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n76_), .c(z08), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  inv1   g088(.a(x30), .O(new_n151_));
  inv1   g089(.a(x32), .O(new_n152_));
  nand4  g090(.a(new_n137_), .b(new_n152_), .c(new_n151_), .d(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  nand2  g092(.a(new_n148_), .b(z08), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(new_n143_), .O(new_n156_));
  nand3  g094(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n75_), .O(new_n159_));
  nand2  g097(.a(z08), .b(new_n134_), .O(new_n160_));
  aoi22  g098(.a(new_n160_), .b(new_n131_), .c(new_n155_), .d(new_n129_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n156_), .O(z14));
  ...
  oai21  g107(.a(new_n112_), .b(x27), .c(new_n118_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n125_), .c(new_n123_), .O(z18));
  oai21  g110(.a(new_n85_), .b(new_n72_), .c(new_n121_), .O(new_n173_));
  oai21  g111(.a(new_n84_), .b(x27), .c(x35), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n118_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n126_), .O(z20));
  aoi21  g114(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
