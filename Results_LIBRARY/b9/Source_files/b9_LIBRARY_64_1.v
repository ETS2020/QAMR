...
module FAU ( 
  ...
  nand2  g071(.a(x37), .b(x20), .O(new_n134_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n78_), .c(z08), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(z13));
  inv1   g080(.a(x30), .O(new_n143_));
  inv1   g081(.a(x32), .O(new_n144_));
  nand4  g082(.a(new_n129_), .b(new_n144_), .c(new_n143_), .d(x28), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n140_), .b(z08), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n146_), .c(x19), .d(x18), .O(new_n148_));
  oai21  g086(.a(x37), .b(x35), .c(x20), .O(new_n149_));
  nand2  g087(.a(new_n77_), .b(x28), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n147_), .c(new_n149_), .O(new_n152_));
  oai21  g090(.a(x37), .b(x28), .c(x27), .O(new_n153_));
  aoi22  g091(.a(new_n153_), .b(new_n147_), .c(new_n77_), .d(new_n72_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(new_n148_), .O(z14));
  ...
  oai21  g100(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n163_));
  ...
  nand2  g104(.a(new_n166_), .b(new_n120_), .O(new_n167_));
  oai21  g105(.a(new_n74_), .b(x27), .c(x35), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n117_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n124_), .O(z20));
