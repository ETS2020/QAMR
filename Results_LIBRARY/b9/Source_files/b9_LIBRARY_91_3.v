...
module FAU ( 
  ...
  aoi22  g012(.a(new_n74_), .b(new_n72_), .c(new_n73_), .d(x28), .O(new_n75_));
  ...
  inv1   g044(.a(new_n81_), .O(z08));
  nand4  g045(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  inv1   g046(.a(new_n108_), .O(z09));
  inv1   g047(.a(x05), .O(new_n110_));
  nand2  g048(.a(new_n81_), .b(x07), .O(new_n111_));
  oai21  g049(.a(new_n81_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  aoi21  g050(.a(new_n79_), .b(new_n73_), .c(new_n87_), .O(new_n113_));
  nor2   g051(.a(x32), .b(x30), .O(new_n114_));
  nor3   g052(.a(new_n114_), .b(new_n81_), .c(new_n110_), .O(new_n115_));
  aoi21  g053(.a(new_n113_), .b(new_n112_), .c(new_n115_), .O(new_n116_));
  nand3  g054(.a(x37), .b(x27), .c(x06), .O(new_n117_));
  oai21  g055(.a(new_n116_), .b(x04), .c(new_n117_), .O(z10));
  nand3  g056(.a(x40), .b(x39), .c(x29), .O(new_n119_));
  nand2  g057(.a(x27), .b(x04), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(x35), .c(x30), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(x28), .c(new_n119_), .O(new_n122_));
  inv1   g060(.a(x08), .O(new_n123_));
  nand2  g061(.a(x35), .b(x27), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(x04), .c(new_n72_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n78_), .O(new_n126_));
  ...
  oai21  g069(.a(new_n81_), .b(x04), .c(new_n131_), .O(new_n132_));
  ...
  nor2   g083(.a(new_n114_), .b(new_n81_), .O(new_n146_));
  nor2   g084(.a(x13), .b(x04), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n145_), .O(z13));
  nand2  g087(.a(new_n147_), .b(z08), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n131_), .O(new_n151_));
  inv1   g089(.a(x32), .O(new_n152_));
  nand3  g090(.a(new_n134_), .b(new_n152_), .c(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n150_), .c(new_n141_), .O(new_n155_));
  nand3  g093(.a(new_n88_), .b(new_n85_), .c(x28), .O(new_n156_));
  oai21  g094(.a(x30), .b(x27), .c(new_n156_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n155_), .c(new_n151_), .O(z14));
  ...
  oai21  g104(.a(new_n79_), .b(x27), .c(new_n119_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand4  g106(.a(x35), .b(new_n78_), .c(x27), .d(new_n64_), .O(new_n169_));
  nor2   g107(.a(x30), .b(x09), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(z18));
  nand2  g109(.a(new_n124_), .b(new_n123_), .O(new_n172_));
  nand2  g110(.a(new_n119_), .b(new_n85_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n72_), .O(new_n175_));
  nand3  g113(.a(new_n119_), .b(x28), .c(new_n87_), .O(new_n176_));
