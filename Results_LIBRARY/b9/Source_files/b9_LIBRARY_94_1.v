...
module FAU ( 
  ...
  nor2   g063(.a(new_n63_), .b(new_n72_), .O(new_n126_));
  nand2  g064(.a(new_n88_), .b(new_n74_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(x35), .c(x27), .O(new_n128_));
  ...
  nand4  g086(.a(new_n73_), .b(new_n148_), .c(new_n147_), .d(x28), .O(new_n149_));
  ...
  oai21  g090(.a(x35), .b(new_n74_), .c(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n77_), .O(new_n154_));
  nand2  g092(.a(new_n151_), .b(new_n128_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n152_), .O(z14));
  ...
  nand2  g105(.a(new_n167_), .b(new_n120_), .O(new_n168_));
