...
module FAU ( 
  ...
  oai21  g050(.a(x40), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  nand2  g052(.a(new_n76_), .b(x28), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n68_), .c(x07), .O(new_n116_));
  ...
  nand3  g068(.a(x40), .b(x29), .c(x08), .O(new_n131_));
  ...
  oai22  g074(.a(new_n66_), .b(new_n89_), .c(new_n69_), .d(x04), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  nor2   g076(.a(new_n68_), .b(x27), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n138_), .c(new_n71_), .O(new_n140_));
  oai21  g078(.a(x37), .b(x28), .c(x27), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n68_), .O(new_n142_));
  ...
  aoi21  g098(.a(x40), .b(new_n64_), .c(x35), .O(new_n161_));
  ...
  nand2  g119(.a(x40), .b(x29), .O(new_n182_));
  ...
  aoi21  g123(.a(new_n183_), .b(new_n68_), .c(new_n185_), .O(new_n186_));
