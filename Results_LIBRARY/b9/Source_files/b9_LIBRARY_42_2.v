// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:41 2020
...
module FAU ( 
  ...
  nor2   g021(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand2  g022(.a(new_n84_), .b(new_n82_), .O(z02));
  ...
  nor2   g047(.a(x36), .b(new_n75_), .O(new_n110_));
  nand2  g048(.a(new_n68_), .b(x07), .O(new_n111_));
  oai22  g049(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n76_), .O(new_n112_));
  inv1   g050(.a(x05), .O(new_n113_));
  nor3   g051(.a(new_n77_), .b(new_n68_), .c(new_n113_), .O(new_n114_));
  aoi21  g052(.a(new_n112_), .b(x27), .c(new_n114_), .O(new_n115_));
  nand3  g053(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g054(.a(new_n115_), .b(x04), .c(new_n116_), .O(z10));
  nand2  g055(.a(z08), .b(x29), .O(new_n118_));
  nor2   g056(.a(new_n74_), .b(new_n64_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(new_n80_), .c(new_n118_), .O(new_n120_));
  inv1   g058(.a(x08), .O(new_n121_));
  nand4  g059(.a(x35), .b(new_n75_), .c(x27), .d(new_n64_), .O(new_n122_));
  ...
  aoi21  g064(.a(new_n63_), .b(new_n88_), .c(new_n74_), .O(new_n127_));
  nor2   g065(.a(new_n66_), .b(new_n74_), .O(new_n128_));
  nor2   g066(.a(new_n68_), .b(x04), .O(new_n129_));
  oai22  g067(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(x10), .O(z12));
  ...
  oai21  g075(.a(new_n137_), .b(new_n66_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x27), .O(new_n139_));
  inv1   g077(.a(new_n77_), .O(new_n140_));
  nor2   g078(.a(x13), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n140_), .c(z08), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(z13));
  ...
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n137_), .O(new_n149_));
  ...
  oai21  g090(.a(new_n66_), .b(new_n74_), .c(new_n148_), .O(new_n153_));
  ...
  oai21  g099(.a(new_n80_), .b(x27), .c(new_n118_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n124_), .c(new_n122_), .O(z18));
  oai21  g102(.a(new_n86_), .b(new_n74_), .c(new_n121_), .O(new_n165_));
  oai21  g103(.a(new_n75_), .b(x27), .c(x35), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n118_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n125_), .O(z20));
  aoi21  g106(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z19));
endmodule
