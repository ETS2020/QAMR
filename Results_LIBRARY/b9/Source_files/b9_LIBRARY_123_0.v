...
module FAU ( 
  ...
  nand2  g047(.a(new_n77_), .b(new_n75_), .O(new_n110_));
  inv1   g048(.a(x07), .O(new_n111_));
  inv1   g049(.a(x39), .O(new_n112_));
  inv1   g050(.a(x40), .O(new_n113_));
  aoi21  g051(.a(new_n112_), .b(x27), .c(new_n113_), .O(new_n114_));
  nand4  g052(.a(x40), .b(x39), .c(x27), .d(x05), .O(new_n115_));
  oai21  g053(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  inv1   g054(.a(x05), .O(new_n117_));
  nor3   g055(.a(new_n79_), .b(new_n68_), .c(new_n117_), .O(new_n118_));
  aoi21  g056(.a(new_n116_), .b(new_n110_), .c(new_n118_), .O(new_n119_));
  nand3  g057(.a(x37), .b(x27), .c(x06), .O(new_n120_));
  oai21  g058(.a(new_n119_), .b(x04), .c(new_n120_), .O(z10));
  inv1   g059(.a(x08), .O(new_n122_));
  oai22  g060(.a(new_n77_), .b(x04), .c(new_n113_), .d(new_n122_), .O(new_n123_));
  nand2  g061(.a(x39), .b(x29), .O(new_n124_));
  inv1   g062(.a(x35), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(x28), .O(new_n126_));
  oai21  g064(.a(new_n74_), .b(new_n64_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n124_), .c(new_n84_), .O(new_n128_));
  inv1   g066(.a(x09), .O(new_n129_));
  inv1   g067(.a(x30), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  aoi21  g069(.a(new_n128_), .b(new_n123_), .c(new_n131_), .O(z11));
  oai22  g070(.a(new_n66_), .b(new_n74_), .c(new_n112_), .d(x04), .O(new_n133_));
  nor3   g071(.a(x37), .b(x36), .c(x35), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n74_), .c(new_n70_), .O(new_n135_));
  nand3  g073(.a(new_n87_), .b(new_n113_), .c(new_n89_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n133_), .O(z12));
  nand2  g075(.a(x36), .b(x35), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x28), .O(new_n139_));
  nor2   g077(.a(new_n113_), .b(x13), .O(new_n140_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n149_), .c(new_n130_), .d(x28), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  nand2  g089(.a(new_n146_), .b(z08), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n143_), .O(new_n153_));
  nand3  g091(.a(new_n89_), .b(new_n125_), .c(x28), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n79_), .O(new_n156_));
  aoi21  g094(.a(new_n146_), .b(x39), .c(x27), .O(new_n157_));
  aoi21  g095(.a(new_n152_), .b(new_n66_), .c(new_n157_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n156_), .c(new_n153_), .O(z14));
  ...
  aoi22  g104(.a(new_n126_), .b(new_n74_), .c(z08), .d(x29), .O(new_n167_));
  nor2   g105(.a(new_n74_), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n126_), .c(new_n131_), .O(new_n169_));
  oai21  g107(.a(new_n167_), .b(new_n122_), .c(new_n169_), .O(z18));
  oai21  g108(.a(new_n76_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n124_), .O(new_n172_));
  nand2  g110(.a(x35), .b(x27), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n122_), .c(new_n113_), .d(new_n125_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n131_), .O(z20));
  aoi21  g113(.a(new_n128_), .b(new_n123_), .c(new_n131_), .O(z19));
endmodule
