...
module FAU ( 
  ...
  nand3  g034(.a(new_n96_), .b(x40), .c(new_n72_), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(x39), .c(new_n74_), .O(new_n98_));
  ...
  aoi21  g070(.a(x40), .b(new_n64_), .c(new_n94_), .O(new_n133_));
  nor2   g071(.a(x39), .b(x37), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n133_), .c(new_n86_), .O(new_n135_));
  aoi21  g073(.a(new_n63_), .b(x39), .c(new_n72_), .O(new_n136_));
  ...
  aoi21  g085(.a(new_n96_), .b(x40), .c(new_n94_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n134_), .c(new_n86_), .O(new_n149_));
  nand3  g087(.a(x39), .b(new_n80_), .c(x28), .O(new_n150_));
