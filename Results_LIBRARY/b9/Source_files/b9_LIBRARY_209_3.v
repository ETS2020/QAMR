...
module FAU ( 
  ...
  nand3  g054(.a(x40), .b(x39), .c(x29), .O(new_n117_));
  nand2  g055(.a(x27), .b(x04), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n74_), .c(new_n86_), .O(new_n119_));
  nor2   g057(.a(x35), .b(x09), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n119_), .c(new_n117_), .O(new_n121_));
  inv1   g059(.a(x08), .O(new_n122_));
  nor2   g060(.a(new_n86_), .b(new_n72_), .O(new_n123_));
  oai21  g061(.a(x28), .b(x04), .c(x35), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(x09), .c(new_n124_), .O(new_n125_));
  ...
  nand4  g106(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n148_), .d(new_n166_), .O(z18));
  nand2  g108(.a(new_n117_), .b(new_n86_), .O(new_n171_));
  oai21  g109(.a(new_n123_), .b(x08), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n166_), .O(new_n173_));
  nand4  g111(.a(new_n117_), .b(x35), .c(x28), .d(new_n72_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(x30), .O(z20));
  aoi21  g113(.a(new_n126_), .b(new_n121_), .c(x30), .O(z19));
endmodule
