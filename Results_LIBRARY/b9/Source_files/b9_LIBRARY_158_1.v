...
module FAU ( 
  ...
  oai21  g023(.a(new_n85_), .b(new_n73_), .c(x27), .O(new_n86_));
  ...
  nor3   g050(.a(new_n82_), .b(new_n76_), .c(new_n112_), .O(new_n113_));
  oai21  g051(.a(new_n113_), .b(new_n111_), .c(new_n66_), .O(new_n114_));
  nand3  g052(.a(x37), .b(x27), .c(x06), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n114_), .O(z10));
  nand2  g054(.a(z08), .b(x29), .O(new_n117_));
  oai21  g055(.a(new_n73_), .b(x27), .c(x35), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x27), .c(new_n117_), .O(new_n119_));
  inv1   g057(.a(x09), .O(new_n120_));
  inv1   g058(.a(x30), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  aoi21  g060(.a(new_n119_), .b(x08), .c(new_n122_), .O(z11));
  inv1   g061(.a(x10), .O(new_n124_));
  nor3   g062(.a(x37), .b(x36), .c(x04), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n64_), .c(new_n124_), .O(new_n126_));
  oai21  g064(.a(x37), .b(x35), .c(x27), .O(new_n127_));
  nand2  g065(.a(z08), .b(new_n66_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g067(.a(new_n87_), .b(new_n73_), .c(x04), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n126_), .O(z12));
  ...
  nand3  g073(.a(new_n73_), .b(new_n135_), .c(new_n66_), .O(new_n136_));
  oai22  g074(.a(new_n136_), .b(new_n82_), .c(new_n134_), .d(new_n68_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x27), .O(new_n138_));
  nand4  g076(.a(z08), .b(new_n77_), .c(new_n135_), .d(new_n66_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(z13));
  oai21  g078(.a(new_n134_), .b(new_n127_), .c(new_n128_), .O(new_n141_));
  oai21  g079(.a(new_n77_), .b(new_n73_), .c(new_n135_), .O(new_n142_));
  inv1   g080(.a(new_n134_), .O(new_n143_));
  nand2  g081(.a(new_n87_), .b(new_n66_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  oai21  g084(.a(new_n76_), .b(x13), .c(new_n64_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n146_), .c(new_n141_), .d(new_n130_), .O(z14));
  ...
  nand3  g093(.a(x35), .b(new_n73_), .c(new_n64_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n117_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x08), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n121_), .c(new_n120_), .O(z18));
  inv1   g097(.a(x08), .O(new_n160_));
  oai21  g098(.a(new_n85_), .b(new_n64_), .c(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n118_), .b(new_n117_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n122_), .O(z20));
  aoi21  g101(.a(new_n119_), .b(x08), .c(new_n122_), .O(z19));
endmodule
