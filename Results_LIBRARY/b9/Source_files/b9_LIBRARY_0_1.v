// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:17 2020
...
module FAU ( 
  ...
  nand4  g085(.a(new_n135_), .b(new_n147_), .c(new_n125_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n144_), .c(x40), .d(x39), .O(new_n149_));
  oai21  g087(.a(x19), .b(x18), .c(new_n149_), .O(new_n150_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n77_), .c(new_n151_), .O(new_n155_));
  oai22  g093(.a(new_n129_), .b(new_n66_), .c(x13), .d(x04), .O(new_n156_));
  oai21  g094(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n150_), .O(z14));
