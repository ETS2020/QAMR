...
module FAU ( 
  ...
  nand3  g69(.a(new_n131_), .b(z08), .c(new_n74_), .O(new_n132_));
  oai21  g70(.a(new_n130_), .b(new_n66_), .c(new_n132_), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(x27), .O(new_n134_));
  nand3  g72(.a(new_n131_), .b(new_n78_), .c(z08), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n134_), .O(z13));
  inv1   g74(.a(x13), .O(new_n137_));
  nand2  g75(.a(new_n88_), .b(new_n137_), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(new_n129_), .c(x20), .O(new_n139_));
  aoi21  g77(.a(new_n139_), .b(x28), .c(new_n72_), .O(new_n140_));
  nand2  g78(.a(new_n131_), .b(z08), .O(new_n141_));
  nand2  g79(.a(new_n88_), .b(new_n86_), .O(new_n142_));
  nand4  g80(.a(new_n142_), .b(new_n129_), .c(x27), .d(x20), .O(new_n143_));
  nor2   g81(.a(x28), .b(new_n137_), .O(new_n144_));
  aoi22  g82(.a(new_n144_), .b(new_n88_), .c(new_n143_), .d(new_n141_), .O(new_n145_));
  oai21  g83(.a(new_n140_), .b(new_n78_), .c(new_n145_), .O(z14));
