...
module FAU ( 
  ...
  nand2  g058(.a(x39), .b(x04), .O(new_n121_));
  ...
  nor2   g073(.a(new_n128_), .b(x04), .O(new_n136_));
  nand2  g074(.a(x36), .b(x35), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x28), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n136_), .c(x40), .d(new_n135_), .O(new_n139_));
  ...
  nand4  g089(.a(new_n137_), .b(new_n151_), .c(new_n125_), .d(x28), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n148_), .c(x40), .d(x39), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n143_), .O(new_n154_));
  ...
  inv1   g105(.a(new_n75_), .O(new_n168_));
  ...
  oai21  g110(.a(new_n85_), .b(new_n72_), .c(new_n120_), .O(new_n173_));
