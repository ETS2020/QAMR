...
module FAU ( 
  ...
  oai21  g011(.a(new_n72_), .b(x28), .c(new_n73_), .O(new_n74_));
  ...
  nand3  g019(.a(new_n64_), .b(new_n81_), .c(x04), .O(new_n82_));
  nand4  g020(.a(new_n82_), .b(new_n80_), .c(x40), .d(x39), .O(z02));
  inv1   g021(.a(x28), .O(new_n84_));
  oai21  g022(.a(new_n72_), .b(new_n84_), .c(x27), .O(new_n85_));
  ...
  nand2  g045(.a(new_n73_), .b(x28), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(z08), .c(x05), .O(new_n109_));
  inv1   g047(.a(x07), .O(new_n110_));
  aoi21  g048(.a(x40), .b(x39), .c(new_n110_), .O(new_n111_));
  nand2  g049(.a(new_n111_), .b(new_n74_), .O(new_n112_));
  aoi21  g050(.a(new_n112_), .b(new_n109_), .c(new_n64_), .O(new_n113_));
  inv1   g051(.a(x05), .O(new_n114_));
  nor3   g052(.a(new_n104_), .b(new_n76_), .c(new_n114_), .O(new_n115_));
  oai21  g053(.a(new_n115_), .b(new_n113_), .c(new_n66_), .O(new_n116_));
  nand3  g054(.a(x37), .b(x27), .c(x06), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n116_), .O(z10));
  nand2  g056(.a(x39), .b(x04), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(x27), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n81_), .O(new_n121_));
  oai21  g059(.a(new_n64_), .b(new_n66_), .c(new_n84_), .O(new_n122_));
  nand2  g060(.a(z08), .b(x29), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n72_), .O(new_n124_));
  or2    g062(.a(x30), .b(x09), .O(new_n125_));
  aoi21  g063(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(z11));
  nand2  g064(.a(new_n86_), .b(new_n84_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x27), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n104_), .O(new_n129_));
  inv1   g067(.a(x39), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(x27), .c(new_n127_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x04), .O(new_n132_));
  inv1   g070(.a(x10), .O(new_n133_));
  nor2   g071(.a(new_n130_), .b(x27), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(new_n133_), .c(new_n86_), .d(new_n72_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n132_), .c(new_n129_), .O(z12));
  nor2   g074(.a(x13), .b(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n108_), .c(z08), .O(new_n138_));
  nor2   g076(.a(x19), .b(x18), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x20), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n68_), .c(new_n138_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x27), .O(new_n142_));
  inv1   g080(.a(new_n76_), .O(new_n143_));
  nand3  g081(.a(new_n137_), .b(z08), .c(new_n143_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(z13));
  nand3  g083(.a(new_n76_), .b(new_n73_), .c(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(new_n137_), .c(x40), .d(x39), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n140_), .O(new_n148_));
  oai21  g086(.a(x13), .b(x04), .c(new_n131_), .O(new_n149_));
  aoi22  g087(.a(new_n76_), .b(new_n64_), .c(new_n86_), .d(new_n72_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n129_), .O(z14));
  ...
  nor2   g096(.a(new_n72_), .b(x28), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n64_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n123_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x08), .O(new_n162_));
  nor2   g100(.a(new_n64_), .b(x04), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n159_), .c(new_n125_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(z18));
  aoi21  g103(.a(z08), .b(x29), .c(new_n84_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n81_), .c(new_n64_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x35), .c(new_n125_), .O(z20));
  aoi21  g106(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(z19));
endmodule
