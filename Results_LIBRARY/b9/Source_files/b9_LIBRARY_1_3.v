// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:18 2020
...
module FAU ( 
  ...
  aoi21  g059(.a(new_n121_), .b(new_n120_), .c(x28), .O(new_n122_));
  ...
  inv1   g101(.a(new_n75_), .O(new_n164_));
  ...
  oai21  g105(.a(new_n165_), .b(new_n117_), .c(new_n167_), .O(z18));
  nand2  g106(.a(new_n121_), .b(new_n86_), .O(new_n169_));
  aoi22  g107(.a(new_n118_), .b(new_n117_), .c(x28), .d(new_n72_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n169_), .c(new_n125_), .O(z20));
  aoi21  g109(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
