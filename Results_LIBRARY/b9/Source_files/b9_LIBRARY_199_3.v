// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:10 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n163_, new_n165_, new_n166_, new_n167_, new_n168_;
  ...
  nand4  g058(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n121_));
  ...
  aoi21  g063(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n126_));
  oai22  g064(.a(new_n82_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(x10), .c(new_n127_), .O(z12));
  nand2  g066(.a(x36), .b(x35), .O(new_n129_));
  inv1   g067(.a(x13), .O(new_n130_));
  nand4  g068(.a(x40), .b(x39), .c(new_n130_), .d(new_n64_), .O(new_n131_));
  aoi21  g069(.a(new_n129_), .b(x28), .c(new_n131_), .O(new_n132_));
  inv1   g070(.a(x19), .O(new_n133_));
  nand2  g071(.a(x37), .b(new_n133_), .O(new_n134_));
  inv1   g072(.a(x18), .O(new_n135_));
  nand2  g073(.a(x20), .b(new_n135_), .O(new_n136_));
  aoi21  g074(.a(new_n134_), .b(new_n86_), .c(new_n136_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n132_), .c(x27), .O(new_n138_));
  nor2   g076(.a(x13), .b(x04), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n78_), .c(z08), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(z13));
  inv1   g079(.a(x30), .O(new_n142_));
  inv1   g080(.a(x32), .O(new_n143_));
  nand4  g081(.a(new_n129_), .b(new_n143_), .c(new_n142_), .d(x28), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  nand2  g083(.a(new_n139_), .b(z08), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n136_), .O(new_n147_));
  oai21  g085(.a(x37), .b(x35), .c(new_n133_), .O(new_n148_));
  nand2  g086(.a(new_n77_), .b(x28), .O(new_n149_));
  inv1   g087(.a(new_n149_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n146_), .c(new_n148_), .O(new_n151_));
  oai21  g089(.a(x37), .b(x28), .c(x27), .O(new_n152_));
  aoi22  g090(.a(new_n152_), .b(new_n146_), .c(new_n77_), .d(new_n72_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(new_n147_), .O(z14));
  ...
  oai21  g099(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n123_), .c(new_n121_), .O(z18));
  nand2  g102(.a(x35), .b(x27), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n120_), .O(new_n166_));
  oai21  g104(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n117_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n124_), .O(z20));
