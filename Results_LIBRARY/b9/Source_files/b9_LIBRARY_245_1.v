...
module FAU ( 
  ...
  oai21  g015(.a(new_n77_), .b(x30), .c(x04), .O(z01));
  ...
  oai21  g024(.a(new_n74_), .b(new_n79_), .c(x27), .O(new_n87_));
  ...
  aoi21  g051(.a(new_n80_), .b(new_n113_), .c(new_n72_), .O(new_n114_));
  nor2   g052(.a(x32), .b(x30), .O(new_n115_));
  nor3   g053(.a(new_n115_), .b(new_n83_), .c(new_n110_), .O(new_n116_));
  ...
  nor2   g058(.a(new_n72_), .b(new_n64_), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(new_n80_), .c(new_n120_), .O(new_n122_));
  inv1   g060(.a(x08), .O(new_n123_));
  nand3  g061(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n124_));
  ...
  nor2   g083(.a(new_n115_), .b(new_n83_), .O(new_n146_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n73_), .c(new_n150_), .d(x28), .O(new_n151_));
  ...
  nand4  g092(.a(new_n88_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n155_));
  ...
  oai21  g104(.a(new_n80_), .b(x27), .c(new_n120_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n126_), .c(new_n124_), .O(z18));
  oai21  g107(.a(new_n74_), .b(new_n72_), .c(new_n123_), .O(new_n170_));
  oai21  g108(.a(new_n79_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n120_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n127_), .O(z20));
  aoi21  g111(.a(new_n125_), .b(new_n122_), .c(new_n127_), .O(z19));
endmodule
