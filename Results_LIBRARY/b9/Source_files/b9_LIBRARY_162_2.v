// Benchmark "FAU" written by ABC on Thu Jun 25 20:41:49 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n79_, new_n80_, new_n82_, new_n84_, new_n86_, new_n89_, new_n90_,
  ...
  aoi21  g21(.a(new_n82_), .b(x27), .c(z06), .O(new_n84_));
  ...
  nor3   g44(.a(new_n79_), .b(new_n72_), .c(new_n106_), .O(new_n107_));
  ...
  inv1   g48(.a(x29), .O(new_n111_));
  oai22  g49(.a(new_n79_), .b(new_n111_), .c(new_n82_), .d(x28), .O(new_n112_));
  ...
  inv1   g55(.a(x27), .O(new_n118_));
  inv1   g56(.a(x37), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  nor2   g58(.a(new_n120_), .b(x36), .O(new_n121_));
  nor2   g59(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  oai21  g60(.a(new_n122_), .b(x10), .c(new_n117_), .O(z12));
  inv1   g61(.a(x18), .O(new_n124_));
  inv1   g62(.a(x19), .O(new_n125_));
  nand4  g63(.a(new_n120_), .b(x20), .c(new_n125_), .d(new_n124_), .O(new_n126_));
  nor2   g64(.a(x13), .b(x04), .O(new_n127_));
  nand4  g65(.a(new_n127_), .b(z08), .c(x36), .d(x35), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g67(.a(new_n129_), .b(x27), .O(new_n130_));
  nor2   g68(.a(new_n79_), .b(new_n72_), .O(new_n131_));
  nand2  g69(.a(new_n127_), .b(new_n131_), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n130_), .O(z13));
  nand3  g71(.a(x20), .b(new_n125_), .c(new_n124_), .O(new_n134_));
  nand2  g72(.a(x36), .b(x35), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n72_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(new_n127_), .c(z08), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g76(.a(new_n132_), .b(new_n67_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n138_), .O(z14));
  ...
  inv1   g86(.a(x08), .O(new_n149_));
  oai21  g87(.a(new_n82_), .b(new_n118_), .c(new_n149_), .O(new_n150_));
  oai21  g88(.a(new_n75_), .b(x27), .c(x35), .O(new_n151_));
  oai21  g89(.a(new_n79_), .b(new_n111_), .c(new_n151_), .O(new_n152_));
  aoi21  g90(.a(new_n152_), .b(new_n150_), .c(new_n115_), .O(z20));
  aoi21  g91(.a(new_n112_), .b(x08), .c(new_n115_), .O(z19));
endmodule
