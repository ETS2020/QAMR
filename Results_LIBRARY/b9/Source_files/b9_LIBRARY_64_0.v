...
module FAU ( 
  ...
  nand3  g073(.a(new_n135_), .b(new_n127_), .c(x20), .O(new_n136_));
  ...
  nand2  g079(.a(new_n86_), .b(x28), .O(new_n142_));
  aoi21  g080(.a(new_n135_), .b(x37), .c(new_n142_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n72_), .c(new_n77_), .O(new_n144_));
  nand2  g082(.a(new_n135_), .b(x20), .O(new_n145_));
  inv1   g083(.a(x30), .O(new_n146_));
  inv1   g084(.a(x32), .O(new_n147_));
  nand4  g085(.a(new_n73_), .b(new_n147_), .c(new_n146_), .d(x28), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand2  g087(.a(new_n139_), .b(z08), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n145_), .O(new_n151_));
  nand2  g089(.a(new_n150_), .b(new_n128_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(new_n144_), .O(z14));
