...
module FAU ( 
  ...
  nor2   g072(.a(new_n128_), .b(x13), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n134_), .c(x40), .d(new_n64_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n149_), .c(new_n148_), .d(x28), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x39), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n140_), .O(new_n152_));
  nand4  g090(.a(x40), .b(x39), .c(new_n145_), .d(new_n64_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n72_), .O(new_n154_));
  nand3  g092(.a(x40), .b(new_n145_), .c(new_n64_), .O(new_n155_));
  ...
  nand4  g097(.a(new_n159_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(z14));
