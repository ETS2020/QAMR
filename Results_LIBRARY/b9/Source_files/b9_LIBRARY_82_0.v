...
module FAU ( 
  ...
  oai21  g066(.a(new_n73_), .b(new_n86_), .c(x28), .O(new_n129_));
  inv1   g067(.a(x40), .O(new_n130_));
  nor2   g068(.a(new_n130_), .b(x13), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n129_), .c(x39), .d(new_n64_), .O(new_n132_));
  nand2  g070(.a(new_n88_), .b(new_n74_), .O(new_n133_));
  ...
  nand4  g083(.a(new_n73_), .b(new_n145_), .c(new_n144_), .d(x28), .O(new_n146_));
  ...
  nand2  g087(.a(new_n133_), .b(x27), .O(new_n150_));
  oai21  g088(.a(x35), .b(new_n74_), .c(x27), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n77_), .c(new_n150_), .d(new_n148_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(z14));
