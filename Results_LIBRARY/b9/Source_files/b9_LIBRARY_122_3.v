...
module FAU ( 
  ...
  nor2   g024(.a(new_n86_), .b(x04), .O(new_n87_));
  nor2   g025(.a(x37), .b(new_n64_), .O(new_n88_));
  oai21  g026(.a(new_n88_), .b(new_n87_), .c(new_n74_), .O(new_n89_));
  inv1   g027(.a(x35), .O(new_n90_));
  oai21  g028(.a(x37), .b(new_n90_), .c(x27), .O(new_n91_));
  ...
  nand4  g033(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n95_), .O(z04));
  ...
  inv1   g048(.a(new_n82_), .O(z08));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n112_));
  inv1   g050(.a(new_n112_), .O(z09));
  inv1   g051(.a(x05), .O(new_n114_));
  nand2  g052(.a(new_n82_), .b(x07), .O(new_n115_));
  oai21  g053(.a(new_n82_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nor3   g054(.a(new_n77_), .b(new_n82_), .c(new_n114_), .O(new_n117_));
  aoi21  g055(.a(new_n116_), .b(new_n76_), .c(new_n117_), .O(new_n118_));
  ...
  nand4  g062(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nor2   g064(.a(x30), .b(x09), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  aoi21  g066(.a(new_n126_), .b(new_n123_), .c(new_n128_), .O(z11));
  aoi21  g067(.a(new_n63_), .b(new_n92_), .c(new_n72_), .O(new_n130_));
  nor2   g068(.a(new_n66_), .b(new_n72_), .O(new_n131_));
  nor2   g069(.a(new_n82_), .b(x04), .O(new_n132_));
  oai22  g070(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(x10), .O(z12));
  oai21  g071(.a(new_n73_), .b(new_n90_), .c(x28), .O(new_n134_));
  ...
  nand2  g086(.a(new_n146_), .b(z08), .O(new_n149_));
  oai21  g087(.a(new_n66_), .b(new_n72_), .c(new_n149_), .O(new_n150_));
  inv1   g088(.a(x30), .O(new_n151_));
  inv1   g089(.a(x32), .O(new_n152_));
  nand4  g090(.a(new_n73_), .b(new_n152_), .c(new_n151_), .d(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n149_), .c(new_n141_), .O(new_n155_));
  oai21  g093(.a(x35), .b(new_n74_), .c(x27), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n77_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n155_), .c(new_n150_), .O(z14));
  ...
  oai21  g103(.a(new_n75_), .b(x27), .c(new_n121_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n127_), .c(new_n125_), .O(z18));
  nand2  g106(.a(new_n86_), .b(new_n124_), .O(new_n169_));
  oai21  g107(.a(new_n74_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n121_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n128_), .O(z20));
  aoi21  g110(.a(new_n126_), .b(new_n123_), .c(new_n128_), .O(z19));
endmodule
