...
module FAU ( 
  ...
  oai21  g083(.a(x28), .b(x27), .c(x04), .O(new_n146_));
  inv1   g084(.a(x32), .O(new_n147_));
  nand4  g085(.a(new_n85_), .b(new_n147_), .c(new_n131_), .d(x28), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(z08), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n78_), .O(new_n150_));
  nand2  g088(.a(new_n143_), .b(x37), .O(new_n151_));
  nand3  g089(.a(new_n75_), .b(x28), .c(x20), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n141_), .O(new_n153_));
  aoi21  g091(.a(x27), .b(x20), .c(new_n141_), .O(new_n154_));
  aoi21  g092(.a(new_n153_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  nand2  g093(.a(new_n90_), .b(new_n85_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n143_), .c(x27), .O(new_n157_));
  nand2  g095(.a(x35), .b(x28), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(x36), .c(x27), .O(new_n159_));
  aoi22  g097(.a(new_n159_), .b(new_n75_), .c(new_n157_), .d(new_n135_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n155_), .c(new_n150_), .O(z14));
  ...
  nand2  g106(.a(new_n127_), .b(new_n72_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n123_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n128_), .c(new_n131_), .d(new_n130_), .O(z18));
  oai21  g110(.a(new_n85_), .b(new_n72_), .c(new_n126_), .O(new_n173_));
  oai21  g111(.a(new_n73_), .b(x27), .c(x35), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n123_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n132_), .O(z20));
  aoi21  g114(.a(new_n129_), .b(new_n125_), .c(new_n132_), .O(z19));
endmodule
