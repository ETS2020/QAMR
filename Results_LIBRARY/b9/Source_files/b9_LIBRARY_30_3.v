// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:35 2020
...
module FAU ( 
  ...
  nand4  g051(.a(x40), .b(x39), .c(x30), .d(x05), .O(new_n114_));
  ...
  nand4  g061(.a(new_n123_), .b(x35), .c(new_n74_), .d(x27), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  inv1   g063(.a(x09), .O(new_n126_));
  nand2  g064(.a(new_n77_), .b(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n121_), .c(new_n127_), .O(z11));
  nand3  g066(.a(x40), .b(x39), .c(new_n64_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n72_), .O(new_n130_));
  inv1   g068(.a(x10), .O(new_n131_));
  nor3   g069(.a(x37), .b(x36), .c(x35), .O(new_n132_));
  inv1   g070(.a(x40), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(x27), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n132_), .c(new_n131_), .O(new_n135_));
  oai21  g073(.a(new_n107_), .b(x04), .c(new_n66_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n130_), .O(z12));
  nand2  g075(.a(x36), .b(x35), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x28), .O(new_n139_));
  nor2   g077(.a(new_n133_), .b(x13), .O(new_n140_));
  ...
  nand3  g086(.a(new_n148_), .b(z08), .c(x30), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  nand3  g088(.a(x20), .b(new_n143_), .c(new_n142_), .O(new_n151_));
  nand3  g089(.a(new_n138_), .b(new_n77_), .c(x28), .O(new_n152_));
  ...
  nand4  g093(.a(x40), .b(x39), .c(new_n155_), .d(new_n64_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n72_), .O(new_n157_));
  inv1   g095(.a(x35), .O(new_n158_));
  nand3  g096(.a(new_n88_), .b(new_n158_), .c(x28), .O(new_n159_));
  oai21  g097(.a(x32), .b(x27), .c(new_n159_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n77_), .O(new_n161_));
  nand2  g099(.a(new_n148_), .b(z08), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n66_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n161_), .c(new_n157_), .d(new_n154_), .O(z14));
  ...
  nor2   g109(.a(new_n158_), .b(x28), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n72_), .c(z08), .d(x29), .O(new_n173_));
  nor2   g111(.a(new_n72_), .b(x04), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n127_), .O(new_n175_));
  oai21  g113(.a(new_n173_), .b(new_n122_), .c(new_n175_), .O(z18));
  oai21  g114(.a(new_n158_), .b(new_n72_), .c(new_n122_), .O(new_n177_));
  oai21  g115(.a(new_n74_), .b(x27), .c(x35), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n119_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n177_), .c(new_n127_), .O(z20));
  aoi21  g118(.a(new_n125_), .b(new_n121_), .c(new_n127_), .O(z19));
endmodule
