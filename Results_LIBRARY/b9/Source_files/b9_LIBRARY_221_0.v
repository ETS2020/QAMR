...
module FAU ( 
  ...
  nand2  g065(.a(new_n120_), .b(z08), .O(new_n128_));
  aoi22  g066(.a(new_n128_), .b(new_n72_), .c(new_n66_), .d(new_n65_), .O(new_n129_));
  oai21  g067(.a(new_n127_), .b(x10), .c(new_n129_), .O(z12));
  ...
  nand4  g085(.a(new_n131_), .b(new_n147_), .c(new_n124_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n144_), .c(x40), .d(x39), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n139_), .O(new_n150_));
  aoi22  g088(.a(new_n144_), .b(x39), .c(x35), .d(x28), .O(new_n151_));
  nand4  g089(.a(new_n85_), .b(new_n147_), .c(new_n124_), .d(x28), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n87_), .O(new_n154_));
  nand2  g092(.a(new_n78_), .b(z08), .O(new_n155_));
  nor2   g093(.a(new_n144_), .b(new_n133_), .O(new_n156_));
