...
module FAU ( 
  ...
  aoi21  g064(.a(new_n126_), .b(new_n68_), .c(new_n75_), .O(new_n127_));
  nor2   g065(.a(new_n86_), .b(x04), .O(new_n128_));
  oai22  g066(.a(new_n128_), .b(new_n72_), .c(new_n127_), .d(x10), .O(z12));
  ...
  nand4  g071(.a(new_n133_), .b(new_n131_), .c(x39), .d(new_n65_), .O(new_n134_));
  ...
  nand2  g092(.a(new_n149_), .b(new_n71_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n150_), .O(z14));
  ...
  oai21  g101(.a(new_n78_), .b(x27), .c(new_n117_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g104(.a(new_n151_), .b(new_n75_), .c(new_n120_), .O(new_n167_));
