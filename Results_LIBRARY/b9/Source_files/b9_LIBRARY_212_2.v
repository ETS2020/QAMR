...
module FAU ( 
  ...
  nand4  g083(.a(new_n78_), .b(z08), .c(new_n145_), .d(new_n64_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n144_), .O(z13));
  inv1   g085(.a(x35), .O(new_n148_));
  nand3  g086(.a(new_n87_), .b(new_n148_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n77_), .O(new_n151_));
  nand2  g089(.a(new_n137_), .b(x27), .O(new_n152_));
  nand2  g090(.a(x20), .b(new_n138_), .O(new_n153_));
  aoi22  g091(.a(new_n153_), .b(new_n134_), .c(new_n152_), .d(new_n106_), .O(new_n154_));
  inv1   g092(.a(x32), .O(new_n155_));
  nand4  g093(.a(new_n132_), .b(new_n155_), .c(new_n124_), .d(x28), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x39), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n140_), .O(new_n158_));
  nand2  g096(.a(new_n145_), .b(new_n64_), .O(new_n159_));
  oai21  g097(.a(new_n153_), .b(new_n72_), .c(x40), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n137_), .c(new_n139_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n158_), .c(new_n154_), .d(new_n151_), .O(z14));
  ...
  nor2   g108(.a(new_n148_), .b(x28), .O(new_n171_));
  aoi22  g109(.a(new_n171_), .b(new_n72_), .c(z08), .d(x29), .O(new_n172_));
  nor2   g110(.a(new_n72_), .b(x04), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n125_), .O(new_n174_));
  oai21  g112(.a(new_n172_), .b(new_n82_), .c(new_n174_), .O(z18));
  oai21  g113(.a(new_n148_), .b(new_n72_), .c(new_n82_), .O(new_n176_));
  oai21  g114(.a(new_n74_), .b(x27), .c(x35), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n117_), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n176_), .c(new_n125_), .O(z20));
  aoi21  g117(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
