// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:49 2020
...
module FAU ( 
  ...
  nand3  g079(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n142_));
  nand2  g080(.a(new_n129_), .b(x19), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n142_), .c(x27), .O(new_n144_));
  ...
  nand4  g086(.a(new_n129_), .b(new_n148_), .c(new_n147_), .d(x28), .O(new_n149_));
  inv1   g087(.a(new_n149_), .O(new_n150_));
  nand2  g088(.a(new_n139_), .b(z08), .O(new_n151_));
  oai22  g089(.a(new_n151_), .b(new_n150_), .c(new_n146_), .d(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand2  g091(.a(x27), .b(new_n153_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n66_), .c(new_n151_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n145_), .O(z14));
  ...
  oai21  g101(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g104(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n167_));
