...
module FAU ( 
  ...
  aoi21  g063(.a(x40), .b(new_n64_), .c(x37), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n125_), .c(new_n85_), .O(new_n127_));
  inv1   g065(.a(x10), .O(new_n128_));
  nor3   g066(.a(x37), .b(x36), .c(x35), .O(new_n129_));
  nor2   g067(.a(new_n125_), .b(x27), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  oai21  g069(.a(new_n106_), .b(x04), .c(new_n72_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n131_), .c(new_n127_), .O(z12));
  inv1   g071(.a(x13), .O(new_n134_));
  nor2   g072(.a(new_n125_), .b(x04), .O(new_n135_));
  ...
  aoi21  g087(.a(new_n147_), .b(x40), .c(x37), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n125_), .c(new_n85_), .O(new_n151_));
  inv1   g089(.a(x30), .O(new_n152_));
  inv1   g090(.a(x32), .O(new_n153_));
  nand4  g091(.a(new_n136_), .b(new_n153_), .c(new_n152_), .d(x28), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n147_), .c(z08), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n142_), .O(new_n156_));
  inv1   g094(.a(x35), .O(new_n157_));
  nand3  g095(.a(new_n87_), .b(new_n157_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n77_), .O(new_n160_));
  nand4  g098(.a(x40), .b(x39), .c(new_n134_), .d(new_n64_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n72_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n160_), .c(new_n156_), .d(new_n151_), .O(z14));
  ...
  oai21  g108(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g111(.a(new_n157_), .b(new_n72_), .c(new_n82_), .O(new_n174_));
  oai21  g112(.a(new_n74_), .b(x27), .c(x35), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n117_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(new_n123_), .O(z20));
  aoi21  g115(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
