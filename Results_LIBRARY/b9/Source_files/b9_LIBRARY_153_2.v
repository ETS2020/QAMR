...
module FAU ( 
  ...
  oai21  g013(.a(new_n75_), .b(x30), .c(x04), .O(z01));
  ...
  nor2   g057(.a(new_n86_), .b(new_n64_), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n78_), .c(new_n119_), .O(new_n121_));
  inv1   g059(.a(x08), .O(new_n122_));
  nand4  g060(.a(x35), .b(new_n73_), .c(x27), .d(new_n64_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nor2   g062(.a(x30), .b(x09), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  aoi21  g064(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(z11));
  aoi21  g065(.a(new_n63_), .b(new_n87_), .c(new_n86_), .O(new_n128_));
  inv1   g066(.a(new_n66_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x27), .O(new_n130_));
  oai21  g068(.a(new_n80_), .b(x04), .c(new_n130_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(x10), .c(new_n131_), .O(z12));
  oai21  g070(.a(new_n112_), .b(new_n84_), .c(x28), .O(new_n133_));
  ...
  nand2  g078(.a(new_n140_), .b(new_n129_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x27), .O(new_n143_));
  nor2   g081(.a(new_n114_), .b(new_n80_), .O(new_n144_));
  ...
  oai21  g086(.a(x36), .b(x32), .c(x35), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(x28), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n145_), .c(z08), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  nand3  g090(.a(new_n87_), .b(new_n84_), .c(x28), .O(new_n153_));
  oai21  g091(.a(x32), .b(x27), .c(new_n153_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  nand2  g093(.a(new_n145_), .b(z08), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n130_), .O(new_n157_));
  ...
  oai21  g103(.a(new_n78_), .b(x27), .c(new_n119_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n125_), .c(new_n123_), .O(z18));
  oai21  g106(.a(new_n84_), .b(new_n86_), .c(new_n122_), .O(new_n169_));
  oai21  g107(.a(new_n73_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n119_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n126_), .O(z20));
  aoi21  g110(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(z19));
endmodule
