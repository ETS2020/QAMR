...
module FAU ( 
  ...
  nand2  g048(.a(new_n106_), .b(new_n110_), .O(new_n111_));
  nor2   g049(.a(new_n77_), .b(new_n106_), .O(new_n112_));
  ...
  nand2  g078(.a(new_n85_), .b(new_n87_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nor2   g082(.a(x13), .b(x04), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n112_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n144_), .O(z13));
  nand3  g085(.a(x20), .b(new_n140_), .c(new_n139_), .O(new_n148_));
  inv1   g086(.a(x32), .O(new_n149_));
  nand4  g087(.a(new_n135_), .b(new_n149_), .c(new_n124_), .d(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n145_), .c(x40), .d(x39), .O(new_n151_));
  ...
  oai21  g109(.a(new_n154_), .b(new_n72_), .c(new_n119_), .O(new_n172_));
