...
module FAU ( 
  ...
  nand2  g067(.a(x39), .b(new_n64_), .O(new_n130_));
  ...
  nor2   g071(.a(new_n106_), .b(x04), .O(new_n134_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n132_), .O(z12));
  ...
  and2   g080(.a(x36), .b(x35), .O(new_n143_));
  ...
  nand3  g084(.a(new_n142_), .b(z08), .c(new_n77_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(z13));
  nand2  g086(.a(new_n140_), .b(x20), .O(new_n149_));
  oai21  g087(.a(new_n72_), .b(new_n128_), .c(new_n76_), .O(new_n150_));
  nand2  g088(.a(x39), .b(x13), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n134_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  oai21  g091(.a(new_n135_), .b(new_n76_), .c(new_n133_), .O(new_n154_));
  nand2  g092(.a(new_n130_), .b(new_n129_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x13), .c(new_n136_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(new_n153_), .O(z14));
  ...
  oai21  g102(.a(new_n74_), .b(x27), .c(new_n123_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  inv1   g104(.a(new_n74_), .O(new_n167_));
  nor2   g105(.a(new_n64_), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n167_), .c(new_n125_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n166_), .O(z18));
  oai21  g108(.a(new_n128_), .b(new_n64_), .c(new_n122_), .O(new_n171_));
  oai21  g109(.a(new_n73_), .b(x27), .c(x35), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n123_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n125_), .O(z20));
  aoi21  g112(.a(new_n124_), .b(new_n121_), .c(new_n125_), .O(z19));
endmodule
