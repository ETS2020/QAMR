...
module FAU ( 
  ...
  nor2   g066(.a(x27), .b(x10), .O(new_n129_));
  aoi21  g067(.a(new_n63_), .b(new_n88_), .c(new_n129_), .O(new_n130_));
  ...
  nand2  g093(.a(new_n151_), .b(new_n127_), .O(new_n156_));
  ...
  oai21  g105(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n168_));
