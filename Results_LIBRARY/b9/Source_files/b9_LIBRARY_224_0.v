// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:24 2020
...
module FAU ( 
  ...
  nor2   g055(.a(new_n72_), .b(x04), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n74_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  oai21  g058(.a(new_n72_), .b(new_n64_), .c(new_n74_), .O(new_n121_));
  nand2  g059(.a(z08), .b(x29), .O(new_n122_));
  nand2  g060(.a(z08), .b(x08), .O(new_n123_));
  aoi22  g061(.a(new_n123_), .b(new_n86_), .c(new_n122_), .d(new_n121_), .O(new_n124_));
  ...
  aoi21  g066(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n129_));
  inv1   g067(.a(new_n66_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x27), .O(new_n131_));
  oai21  g069(.a(new_n82_), .b(x04), .c(new_n131_), .O(new_n132_));
  ...
  nor2   g074(.a(new_n136_), .b(x13), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(new_n135_), .c(x39), .d(new_n64_), .O(new_n138_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n78_), .c(z08), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  inv1   g086(.a(x32), .O(new_n149_));
  nand4  g087(.a(new_n134_), .b(new_n149_), .c(new_n126_), .d(x28), .O(new_n150_));
  ...
  nand2  g094(.a(new_n152_), .b(new_n131_), .O(new_n157_));
  ...
  aoi21  g105(.a(new_n118_), .b(new_n166_), .c(new_n127_), .O(new_n168_));
  oai21  g106(.a(new_n167_), .b(new_n117_), .c(new_n168_), .O(z18));
  nor2   g107(.a(new_n74_), .b(x27), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n86_), .c(new_n82_), .O(new_n171_));
  inv1   g109(.a(x29), .O(new_n172_));
  aoi21  g110(.a(x35), .b(x27), .c(x08), .O(new_n173_));
  aoi21  g111(.a(new_n170_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n127_), .O(z20));
  aoi21  g113(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z19));
endmodule
