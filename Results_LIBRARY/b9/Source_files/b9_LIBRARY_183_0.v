...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n96_, new_n97_,
  ...
  nand2  g029(.a(new_n86_), .b(x27), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n89_), .c(new_n91_), .O(z04));
  ...
  oai21  g105(.a(new_n86_), .b(new_n72_), .c(new_n121_), .O(new_n168_));
