...
module FAU ( 
  ...
  nand2  g064(.a(z08), .b(new_n64_), .O(new_n127_));
  oai21  g065(.a(new_n66_), .b(new_n72_), .c(new_n127_), .O(new_n128_));
  ...
  aoi22  g094(.a(new_n156_), .b(new_n127_), .c(new_n155_), .d(new_n150_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n154_), .c(new_n151_), .O(z14));
  ...
  oai21  g103(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g106(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n169_));
  oai21  g107(.a(new_n74_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n117_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n124_), .O(z20));
  aoi21  g110(.a(new_n122_), .b(new_n119_), .c(new_n124_), .O(z19));
endmodule
