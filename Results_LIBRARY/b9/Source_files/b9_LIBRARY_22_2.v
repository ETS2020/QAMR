// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:30 2020
...
module FAU ( 
  ...
  oai21  g064(.a(new_n126_), .b(x37), .c(x40), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n85_), .O(new_n128_));
  ...
  oai21  g071(.a(new_n106_), .b(x04), .c(new_n72_), .O(new_n134_));
  ...
  nand4  g076(.a(new_n138_), .b(new_n126_), .c(x40), .d(new_n136_), .O(new_n139_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n78_), .c(z08), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z13));
  aoi21  g088(.a(new_n148_), .b(x39), .c(x37), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n131_), .c(new_n85_), .O(new_n152_));
  inv1   g090(.a(x30), .O(new_n153_));
  inv1   g091(.a(x32), .O(new_n154_));
  nand4  g092(.a(new_n137_), .b(new_n154_), .c(new_n153_), .d(x28), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n148_), .c(z08), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n143_), .O(new_n157_));
  inv1   g095(.a(x35), .O(new_n158_));
  nand3  g096(.a(new_n87_), .b(new_n158_), .c(x28), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x27), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n77_), .O(new_n161_));
  nor2   g099(.a(new_n131_), .b(new_n136_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n65_), .c(new_n72_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n161_), .c(new_n157_), .d(new_n152_), .O(z14));
  ...
  oai21  g109(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g112(.a(new_n158_), .b(new_n72_), .c(new_n82_), .O(new_n175_));
  oai21  g113(.a(new_n74_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n117_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n175_), .c(new_n123_), .O(z20));
  aoi21  g116(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
