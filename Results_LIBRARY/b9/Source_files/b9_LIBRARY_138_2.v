...
module FAU ( 
  ...
  aoi22  g062(.a(new_n63_), .b(new_n88_), .c(x40), .d(new_n72_), .O(new_n125_));
  oai22  g063(.a(new_n82_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n126_));
  ...
  oai21  g105(.a(new_n86_), .b(new_n72_), .c(new_n80_), .O(new_n168_));
