// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:40 2020
...
module FAU ( 
  ...
  nor2   g073(.a(new_n127_), .b(x13), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(new_n135_), .c(x39), .d(new_n64_), .O(new_n137_));
  nand2  g075(.a(new_n85_), .b(new_n87_), .O(new_n138_));
  ...
  nand4  g087(.a(new_n134_), .b(new_n149_), .c(new_n124_), .d(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n146_), .c(x40), .d(x39), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n141_), .O(new_n152_));
  oai21  g090(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n153_));
  inv1   g091(.a(x35), .O(new_n154_));
  nand3  g092(.a(new_n87_), .b(new_n154_), .c(x28), .O(new_n155_));
  ...
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n153_), .d(new_n152_), .O(z14));
  ...
  nor2   g104(.a(new_n154_), .b(x28), .O(new_n167_));
  ...
  oai21  g109(.a(new_n154_), .b(new_n72_), .c(new_n82_), .O(new_n172_));
