...
module FAU ( 
  ...
  nand2  g015(.a(x28), .b(x18), .O(new_n78_));
  ...
  nand2  g024(.a(x18), .b(x04), .O(new_n87_));
  ...
  oai21  g060(.a(new_n121_), .b(x04), .c(new_n122_), .O(z10));
  nand2  g061(.a(z08), .b(x29), .O(new_n124_));
  nor2   g062(.a(new_n72_), .b(new_n64_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n117_), .c(new_n124_), .O(new_n126_));
  inv1   g064(.a(x08), .O(new_n127_));
  nor2   g065(.a(new_n86_), .b(x28), .O(new_n128_));
  ...
  aoi21  g072(.a(new_n63_), .b(new_n91_), .c(new_n72_), .O(new_n135_));
  nor2   g073(.a(new_n66_), .b(new_n72_), .O(new_n136_));
  nor2   g074(.a(new_n82_), .b(x04), .O(new_n137_));
  oai22  g075(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(x10), .O(z12));
  inv1   g076(.a(new_n75_), .O(new_n139_));
  oai21  g077(.a(new_n116_), .b(new_n86_), .c(x28), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x27), .c(new_n139_), .O(new_n141_));
  inv1   g079(.a(x13), .O(new_n142_));
  nand4  g080(.a(x40), .b(x39), .c(new_n142_), .d(new_n64_), .O(new_n143_));
  nor2   g081(.a(x19), .b(x18), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(x37), .c(x27), .d(x20), .O(new_n145_));
  oai21  g083(.a(new_n143_), .b(new_n141_), .c(new_n145_), .O(z13));
  inv1   g084(.a(x18), .O(new_n147_));
  nand2  g085(.a(new_n91_), .b(new_n86_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(x27), .c(new_n147_), .O(new_n149_));
  nand2  g087(.a(new_n139_), .b(new_n64_), .O(new_n150_));
  aoi22  g088(.a(new_n150_), .b(new_n72_), .c(new_n149_), .d(new_n82_), .O(new_n151_));
  aoi21  g089(.a(new_n73_), .b(new_n72_), .c(new_n87_), .O(new_n152_));
  oai22  g090(.a(x37), .b(x18), .c(x36), .d(new_n86_), .O(new_n153_));
  inv1   g091(.a(x32), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n132_), .c(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n152_), .O(new_n157_));
  oai22  g095(.a(new_n78_), .b(new_n139_), .c(x37), .d(new_n64_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n86_), .O(new_n159_));
  nand4  g097(.a(new_n86_), .b(new_n154_), .c(new_n132_), .d(x28), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n137_), .O(new_n161_));
  inv1   g099(.a(x19), .O(new_n162_));
  nand2  g100(.a(x20), .b(new_n162_), .O(new_n163_));
  aoi22  g101(.a(new_n163_), .b(new_n161_), .c(new_n145_), .d(x13), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n159_), .c(new_n157_), .d(new_n151_), .O(z14));
  ...
  nand2  g110(.a(new_n128_), .b(new_n72_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n124_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n129_), .c(new_n132_), .d(new_n131_), .O(z18));
  oai21  g114(.a(new_n86_), .b(new_n72_), .c(new_n127_), .O(new_n177_));
  oai21  g115(.a(new_n73_), .b(x27), .c(x35), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n124_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n177_), .c(new_n133_), .O(z20));
  aoi21  g118(.a(new_n130_), .b(new_n126_), .c(new_n133_), .O(z19));
endmodule
