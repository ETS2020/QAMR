...
module FAU ( 
  ...
  oai21  g005(.a(x37), .b(x28), .c(x27), .O(new_n68_));
  oai21  g006(.a(new_n67_), .b(new_n64_), .c(new_n68_), .O(new_n69_));
  ...
  nor3   g049(.a(new_n83_), .b(new_n77_), .c(new_n109_), .O(new_n112_));
  ...
  oai21  g056(.a(new_n118_), .b(new_n75_), .c(new_n116_), .O(new_n119_));
  inv1   g057(.a(x08), .O(new_n120_));
  nand4  g058(.a(x35), .b(new_n74_), .c(x27), .d(new_n117_), .O(new_n121_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n88_), .c(new_n72_), .O(new_n127_));
  nand2  g065(.a(new_n86_), .b(new_n88_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x27), .O(new_n129_));
  oai21  g067(.a(new_n83_), .b(x04), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g090(.a(new_n88_), .b(new_n152_), .c(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n77_), .O(new_n155_));
  nand2  g093(.a(new_n150_), .b(new_n129_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n155_), .c(new_n151_), .O(z14));
  ...
  oai21  g102(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g105(.a(new_n152_), .b(new_n72_), .c(new_n120_), .O(new_n168_));
  oai21  g106(.a(new_n74_), .b(x27), .c(x35), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n116_), .O(new_n170_));
