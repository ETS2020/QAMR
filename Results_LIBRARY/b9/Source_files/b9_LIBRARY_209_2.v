...
module FAU ( 
  ...
  aoi21  g055(.a(x27), .b(x04), .c(x28), .O(new_n118_));
  oai21  g056(.a(new_n118_), .b(x09), .c(x35), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  inv1   g058(.a(x08), .O(new_n121_));
  inv1   g059(.a(x09), .O(new_n122_));
  nand3  g060(.a(new_n74_), .b(x27), .c(new_n64_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n120_), .c(x30), .O(z11));
  ...
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n140_), .O(new_n153_));
  ...
  nand2  g094(.a(new_n152_), .b(new_n130_), .O(new_n157_));
  ...
  nand4  g105(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n167_), .c(new_n148_), .d(new_n122_), .O(z18));
  oai21  g107(.a(x27), .b(x09), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n121_), .O(new_n171_));
  nand3  g109(.a(x28), .b(new_n72_), .c(new_n122_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x35), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n117_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(x30), .O(z20));
  aoi21  g113(.a(new_n126_), .b(new_n120_), .c(x30), .O(z19));
endmodule
