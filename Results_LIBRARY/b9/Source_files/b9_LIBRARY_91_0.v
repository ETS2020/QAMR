...
module FAU ( 
  ...
  oai21  g19(.a(new_n81_), .b(new_n79_), .c(x04), .O(new_n82_));
  ...
  oai21  g24(.a(new_n86_), .b(new_n80_), .c(x27), .O(new_n87_));
  inv1   g25(.a(x37), .O(new_n88_));
  nand2  g26(.a(new_n88_), .b(new_n74_), .O(new_n89_));
  ...
  aoi21  g46(.a(x35), .b(new_n80_), .c(x36), .O(new_n109_));
  ...
  nor3   g51(.a(new_n76_), .b(new_n68_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g60(.a(new_n122_), .b(new_n74_), .c(new_n70_), .O(new_n123_));
  oai22  g61(.a(new_n68_), .b(x04), .c(new_n66_), .d(new_n74_), .O(new_n124_));
  ...
  nand3  g66(.a(new_n128_), .b(x36), .c(x35), .O(new_n129_));
  oai22  g67(.a(new_n129_), .b(new_n68_), .c(new_n127_), .d(new_n66_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  nor2   g69(.a(new_n76_), .b(new_n68_), .O(new_n132_));
  nand2  g70(.a(new_n128_), .b(new_n132_), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(new_n131_), .O(z13));
  oai21  g72(.a(x37), .b(x35), .c(x27), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  oai21  g74(.a(new_n75_), .b(new_n86_), .c(new_n76_), .O(new_n137_));
  inv1   g75(.a(new_n137_), .O(new_n138_));
  nand2  g76(.a(new_n128_), .b(z08), .O(new_n139_));
  oai21  g77(.a(new_n139_), .b(new_n138_), .c(new_n127_), .O(new_n140_));
  nand3  g78(.a(new_n139_), .b(new_n88_), .c(new_n80_), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n140_), .c(new_n136_), .O(z14));
  ...
  nand3  g88(.a(new_n150_), .b(new_n119_), .c(new_n118_), .O(new_n151_));
  inv1   g89(.a(new_n151_), .O(z20));
  inv1   g90(.a(z18), .O(z19));
endmodule
