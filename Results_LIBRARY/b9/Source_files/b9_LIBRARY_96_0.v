// Benchmark "FAU" written by ABC on Thu Jun 25 20:41:12 2020
...
module FAU ( 
  ...
  aoi22  g062(.a(new_n63_), .b(new_n87_), .c(x39), .d(new_n72_), .O(new_n125_));
  ...
  nand4  g088(.a(x40), .b(x39), .c(new_n128_), .d(new_n64_), .O(new_n151_));
