...
module FAU ( 
  ...
  nand2  g019(.a(new_n74_), .b(x04), .O(new_n82_));
  inv1   g020(.a(x08), .O(new_n83_));
  nand3  g021(.a(x35), .b(new_n64_), .c(new_n83_), .O(new_n84_));
  nand3  g022(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z02));
  ...
  nand2  g046(.a(x36), .b(x27), .O(new_n109_));
  ...
  nor3   g051(.a(new_n80_), .b(new_n76_), .c(new_n113_), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(new_n112_), .c(new_n66_), .O(new_n115_));
  nand3  g053(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n115_), .O(z10));
  nand2  g055(.a(z08), .b(x29), .O(new_n118_));
  oai21  g056(.a(new_n73_), .b(x27), .c(x35), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x27), .c(new_n118_), .O(new_n120_));
  inv1   g058(.a(x09), .O(new_n121_));
  inv1   g059(.a(x30), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  aoi21  g061(.a(new_n120_), .b(x08), .c(new_n123_), .O(z11));
  inv1   g062(.a(x10), .O(new_n125_));
  nor3   g063(.a(x37), .b(x36), .c(x04), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n64_), .c(new_n125_), .O(new_n127_));
  oai21  g065(.a(x37), .b(x35), .c(x27), .O(new_n128_));
  nand2  g066(.a(z08), .b(new_n66_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g068(.a(new_n88_), .b(x35), .c(new_n73_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n127_), .O(z12));
  ...
  nand3  g074(.a(new_n73_), .b(new_n136_), .c(new_n66_), .O(new_n137_));
  oai22  g075(.a(new_n137_), .b(new_n80_), .c(new_n135_), .d(new_n68_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x27), .O(new_n139_));
  nand4  g077(.a(z08), .b(new_n77_), .c(new_n136_), .d(new_n66_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(z13));
  oai21  g079(.a(new_n135_), .b(new_n128_), .c(new_n129_), .O(new_n142_));
  oai21  g080(.a(new_n77_), .b(new_n73_), .c(new_n136_), .O(new_n143_));
  inv1   g081(.a(new_n135_), .O(new_n144_));
  nand2  g082(.a(new_n88_), .b(new_n66_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  oai21  g085(.a(new_n76_), .b(x13), .c(new_n64_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n147_), .c(new_n142_), .d(new_n131_), .O(z14));
  ...
  nand3  g094(.a(x35), .b(new_n73_), .c(new_n64_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n118_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x08), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n122_), .c(new_n121_), .O(z18));
  oai21  g098(.a(new_n86_), .b(new_n64_), .c(new_n83_), .O(new_n161_));
  nand2  g099(.a(new_n119_), .b(new_n118_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n161_), .c(new_n123_), .O(z20));
  aoi21  g101(.a(new_n120_), .b(x08), .c(new_n123_), .O(z19));
endmodule
