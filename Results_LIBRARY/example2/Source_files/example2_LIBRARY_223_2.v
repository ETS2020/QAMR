...
module FAU ( 
  ...
  nor2   g229(.a(x77), .b(new_n380_), .O(new_n381_));
  aoi21  g230(.a(new_n381_), .b(x79), .c(new_n242_), .O(new_n382_));
  nand2  g231(.a(new_n382_), .b(new_n379_), .O(z56));
  ...
  oai21  g242(.a(new_n367_), .b(new_n240_), .c(new_n154_), .O(new_n394_));
  ...
  nand2  g249(.a(new_n154_), .b(new_n240_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(new_n400_), .c(x01), .O(z59));
  and2   g251(.a(new_n401_), .b(new_n377_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n238_), .c(x01), .O(z60));
  inv1   g253(.a(new_n171_), .O(new_n405_));
  aoi22  g254(.a(new_n375_), .b(new_n227_), .c(new_n161_), .d(new_n240_), .O(new_n406_));
  nor3   g255(.a(new_n406_), .b(new_n405_), .c(new_n372_), .O(z61));
  nand3  g256(.a(x84), .b(x81), .c(x79), .O(new_n408_));
  oai21  g257(.a(x79), .b(new_n240_), .c(new_n408_), .O(new_n409_));
  nand2  g258(.a(new_n409_), .b(new_n159_), .O(new_n410_));
  nand2  g259(.a(new_n398_), .b(x79), .O(new_n411_));
  nand3  g260(.a(x81), .b(x79), .c(new_n240_), .O(new_n412_));
  ...
  nor3   g268(.a(new_n406_), .b(new_n405_), .c(new_n370_), .O(z63));
  ...
  nand2  g275(.a(new_n367_), .b(x81), .O(new_n427_));
  nand2  g276(.a(new_n171_), .b(x84), .O(new_n428_));
