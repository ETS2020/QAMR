...
module FAU ( 
  ...
  inv1   g185(.a(new_n167_), .O(new_n337_));
  nand4  g186(.a(new_n337_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n338_));
  aoi21  g187(.a(new_n336_), .b(new_n335_), .c(new_n338_), .O(z49));
  ...
  nand2  g192(.a(new_n332_), .b(x70), .O(new_n344_));
  ...
  nand2  g198(.a(new_n332_), .b(x71), .O(new_n350_));
  ...
  aoi21  g214(.a(new_n365_), .b(new_n364_), .c(new_n338_), .O(z54));
  ...
  oai21  g238(.a(new_n337_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g273(.a(new_n337_), .b(x81), .O(new_n425_));
