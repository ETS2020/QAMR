...
module FAU ( 
  ...
  inv1   g197(.a(new_n167_), .O(new_n349_));
  nand4  g198(.a(new_n349_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n350_));
  aoi21  g199(.a(new_n348_), .b(new_n347_), .c(new_n350_), .O(z51));
  ...
  nand2  g204(.a(new_n332_), .b(x72), .O(new_n356_));
  ...
  oai21  g238(.a(new_n349_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g273(.a(new_n349_), .b(x81), .O(new_n425_));
