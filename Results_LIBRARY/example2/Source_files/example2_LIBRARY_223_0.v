...
module FAU ( 
  ...
  nor2   g093(.a(new_n161_), .b(new_n154_), .O(new_n245_));
  ...
  and2   g139(.a(new_n290_), .b(new_n254_), .O(new_n291_));
  nand2  g140(.a(new_n287_), .b(x81), .O(new_n292_));
  nand2  g141(.a(new_n273_), .b(x42), .O(new_n293_));
  aoi21  g142(.a(new_n293_), .b(new_n292_), .c(new_n250_), .O(new_n294_));
  oai21  g143(.a(new_n294_), .b(new_n291_), .c(new_n283_), .O(new_n295_));
  nor3   g144(.a(new_n295_), .b(new_n247_), .c(new_n286_), .O(z34));
  ...
  nor3   g153(.a(new_n295_), .b(new_n247_), .c(new_n199_), .O(z39));
  nor3   g154(.a(new_n295_), .b(new_n247_), .c(new_n196_), .O(z40));
  nor3   g155(.a(new_n295_), .b(new_n247_), .c(new_n193_), .O(z41));
  nor3   g156(.a(new_n295_), .b(new_n247_), .c(new_n190_), .O(z42));
  nor3   g157(.a(new_n295_), .b(new_n247_), .c(new_n187_), .O(z43));
  nor3   g158(.a(new_n295_), .b(new_n247_), .c(new_n184_), .O(z44));
  nor3   g159(.a(new_n295_), .b(new_n247_), .c(new_n181_), .O(z45));
  nor3   g160(.a(new_n295_), .b(new_n247_), .c(new_n178_), .O(z46));
  ...
  oai21  g224(.a(new_n375_), .b(new_n154_), .c(x78), .O(new_n376_));
  aoi22  g225(.a(new_n376_), .b(new_n159_), .c(x79), .d(new_n160_), .O(new_n377_));
  nand3  g226(.a(x79), .b(new_n159_), .c(x76), .O(new_n378_));
  ...
  oai21  g238(.a(new_n366_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g245(.a(new_n154_), .b(new_n239_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n396_), .c(x01), .O(z59));
  nand2  g247(.a(new_n168_), .b(new_n167_), .O(new_n399_));
  nand3  g248(.a(new_n399_), .b(new_n374_), .c(x79), .O(new_n400_));
  and2   g249(.a(new_n400_), .b(new_n397_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g251(.a(new_n170_), .O(new_n403_));
  aoi22  g252(.a(new_n399_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n403_), .c(new_n371_), .O(z61));
  ...
  nand2  g264(.a(new_n415_), .b(new_n321_), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n414_), .c(x01), .O(z62));
  nor3   g266(.a(new_n404_), .b(new_n403_), .c(new_n369_), .O(z63));
  nand2  g267(.a(x83), .b(x79), .O(new_n419_));
  or2    g268(.a(new_n419_), .b(new_n404_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n317_), .c(x01), .O(z64));
  ...
  nand2  g273(.a(new_n366_), .b(x81), .O(new_n425_));
