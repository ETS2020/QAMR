// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:16 2020
...
module FAU ( 
  ...
  oai21  g190(.a(new_n287_), .b(x18), .c(new_n320_), .O(new_n342_));
  nand2  g191(.a(new_n333_), .b(x70), .O(new_n343_));
  ...
  nand2  g196(.a(new_n347_), .b(new_n320_), .O(new_n348_));
  nand2  g197(.a(new_n333_), .b(x71), .O(new_n349_));
  ...
  nand2  g202(.a(new_n353_), .b(new_n320_), .O(new_n354_));
  nand2  g203(.a(new_n333_), .b(x72), .O(new_n355_));
  ...
  nand2  g208(.a(new_n359_), .b(new_n320_), .O(new_n360_));
  nand2  g209(.a(new_n333_), .b(x73), .O(new_n361_));
  ...
  nand2  g269(.a(new_n420_), .b(new_n323_), .O(new_n421_));
  ...
  aoi21  g274(.a(new_n425_), .b(new_n319_), .c(x01), .O(z64));
