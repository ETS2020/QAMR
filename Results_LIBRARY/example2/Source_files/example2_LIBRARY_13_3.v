...
module FAU ( 
  ...
  nand3  g278(.a(new_n174_), .b(x82), .c(x77), .O(new_n430_));
  inv1   g279(.a(new_n430_), .O(new_n431_));
  and2   g280(.a(new_n431_), .b(new_n233_), .O(z63));
  nand2  g281(.a(new_n416_), .b(new_n415_), .O(new_n433_));
  nand3  g282(.a(new_n433_), .b(x83), .c(x79), .O(new_n434_));
  nand3  g283(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n435_));
  aoi21  g284(.a(new_n435_), .b(new_n434_), .c(x01), .O(z64));
  nor2   g285(.a(new_n171_), .b(x04), .O(new_n437_));
  nor2   g286(.a(new_n385_), .b(x78), .O(new_n438_));
  oai21  g287(.a(new_n438_), .b(new_n437_), .c(x77), .O(new_n439_));
  nand2  g288(.a(new_n382_), .b(x81), .O(new_n440_));
