...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n300_, new_n302_, new_n304_, new_n306_, new_n308_, new_n312_,
  ...
  nand4  g110(.a(new_n261_), .b(new_n251_), .c(new_n254_), .d(x05), .O(new_n262_));
  ...
  nand2  g128(.a(x51), .b(new_n254_), .O(new_n280_));
  oai22  g129(.a(new_n280_), .b(new_n257_), .c(new_n279_), .d(new_n278_), .O(new_n281_));
  ...
  inv1   g134(.a(new_n260_), .O(new_n286_));
  ...
  inv1   g138(.a(new_n251_), .O(new_n290_));
  aoi21  g139(.a(x83), .b(x42), .c(x81), .O(new_n291_));
  nand3  g140(.a(x83), .b(x81), .c(x42), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(new_n293_));
  oai21  g142(.a(new_n293_), .b(new_n291_), .c(new_n258_), .O(new_n294_));
  nand2  g143(.a(x83), .b(new_n257_), .O(new_n295_));
  oai21  g144(.a(new_n237_), .b(new_n254_), .c(x81), .O(new_n296_));
  oai21  g145(.a(new_n295_), .b(new_n254_), .c(new_n296_), .O(new_n297_));
  ...
  nor3   g149(.a(new_n300_), .b(new_n290_), .c(new_n289_), .O(z34));
  ...
  nor3   g158(.a(new_n300_), .b(new_n290_), .c(new_n206_), .O(z39));
  nor3   g159(.a(new_n300_), .b(new_n290_), .c(new_n203_), .O(z40));
  nand4  g160(.a(new_n251_), .b(x78), .c(x77), .d(x59), .O(new_n312_));
  aoi21  g161(.a(new_n298_), .b(new_n294_), .c(new_n312_), .O(z41));
  nor3   g162(.a(new_n300_), .b(new_n290_), .c(new_n197_), .O(z42));
  nor3   g163(.a(new_n300_), .b(new_n290_), .c(new_n194_), .O(z43));
  nor3   g164(.a(new_n300_), .b(new_n290_), .c(new_n191_), .O(z44));
  nor3   g165(.a(new_n300_), .b(new_n290_), .c(new_n188_), .O(z45));
  nor3   g166(.a(new_n300_), .b(new_n290_), .c(new_n185_), .O(z46));
  ...
  nand2  g218(.a(new_n289_), .b(x14), .O(new_n370_));
  ...
  nor4   g225(.a(new_n376_), .b(new_n295_), .c(new_n374_), .d(x82), .O(z55));
  ...
  oai21  g244(.a(new_n371_), .b(new_n160_), .c(new_n154_), .O(new_n396_));
  ...
  nand2  g257(.a(new_n173_), .b(x80), .O(new_n409_));
  ...
  nand2  g271(.a(new_n173_), .b(x82), .O(new_n423_));
  nor2   g272(.a(new_n423_), .b(new_n408_), .O(z63));
  nand2  g273(.a(x83), .b(x79), .O(new_n425_));
  or2    g274(.a(new_n425_), .b(new_n408_), .O(new_n426_));
