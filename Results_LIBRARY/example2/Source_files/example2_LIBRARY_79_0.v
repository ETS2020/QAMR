...
module FAU ( 
  ...
  nand3  g234(.a(x78), .b(x42), .c(new_n152_), .O(new_n386_));
  nand4  g235(.a(x80), .b(new_n231_), .c(x43), .d(new_n249_), .O(new_n387_));
  oai21  g236(.a(new_n387_), .b(new_n230_), .c(new_n386_), .O(new_n388_));
  nand3  g237(.a(new_n388_), .b(x79), .c(x04), .O(new_n389_));
  ...
  oai21  g242(.a(new_n367_), .b(new_n239_), .c(new_n154_), .O(new_n394_));
  ...
  aoi21  g252(.a(new_n377_), .b(x79), .c(new_n401_), .O(new_n404_));
  ...
  nor3   g257(.a(new_n408_), .b(new_n406_), .c(new_n372_), .O(z61));
  ...
  nand2  g268(.a(new_n419_), .b(new_n322_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n418_), .c(x01), .O(z62));
  nor3   g270(.a(new_n408_), .b(new_n406_), .c(new_n370_), .O(z63));
  nand2  g271(.a(x83), .b(x79), .O(new_n423_));
  or2    g272(.a(new_n423_), .b(new_n408_), .O(new_n424_));
  aoi21  g273(.a(new_n424_), .b(new_n318_), .c(x01), .O(z64));
  ...
  nand2  g277(.a(new_n367_), .b(x81), .O(new_n429_));
