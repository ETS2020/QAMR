...
module FAU ( 
  ...
  nor2   g146(.a(new_n297_), .b(new_n288_), .O(z34));
  ...
  nor2   g156(.a(new_n307_), .b(new_n297_), .O(z39));
  nand2  g157(.a(new_n247_), .b(x58), .O(new_n309_));
  nor2   g158(.a(new_n309_), .b(new_n297_), .O(z40));
  nand2  g159(.a(new_n247_), .b(x59), .O(new_n311_));
  nor2   g160(.a(new_n311_), .b(new_n297_), .O(z41));
  nand2  g161(.a(new_n247_), .b(x60), .O(new_n313_));
  nor2   g162(.a(new_n313_), .b(new_n297_), .O(z42));
  nand2  g163(.a(new_n247_), .b(x61), .O(new_n315_));
  nor2   g164(.a(new_n315_), .b(new_n297_), .O(z43));
  nand2  g165(.a(new_n247_), .b(x62), .O(new_n317_));
  nor2   g166(.a(new_n317_), .b(new_n297_), .O(z44));
  nand2  g167(.a(new_n247_), .b(x63), .O(new_n319_));
  nor2   g168(.a(new_n319_), .b(new_n297_), .O(z45));
  nand2  g169(.a(new_n247_), .b(x64), .O(new_n321_));
  nor2   g170(.a(new_n321_), .b(new_n297_), .O(z46));
