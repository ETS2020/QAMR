...
module FAU ( 
  ...
  aoi21  g229(.a(new_n171_), .b(new_n170_), .c(new_n380_), .O(new_n381_));
  ...
  nand3  g242(.a(new_n178_), .b(new_n253_), .c(x40), .O(new_n394_));
  ...
  aoi21  g247(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n399_));
  ...
  inv1   g256(.a(new_n173_), .O(new_n408_));
  nand2  g257(.a(new_n171_), .b(new_n170_), .O(new_n409_));
  aoi22  g258(.a(new_n409_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n410_));
  ...
  nand3  g275(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n427_));
  ...
  nand2  g281(.a(new_n173_), .b(x84), .O(new_n433_));
