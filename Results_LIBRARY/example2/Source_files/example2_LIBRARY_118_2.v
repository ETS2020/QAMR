// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:17 2020
...
module FAU ( 
  ...
  nand2  g195(.a(new_n332_), .b(x71), .O(new_n347_));
  nor2   g196(.a(x77), .b(new_n287_), .O(new_n348_));
  nand4  g197(.a(new_n348_), .b(new_n172_), .c(x19), .d(x04), .O(new_n349_));
  aoi21  g198(.a(new_n349_), .b(new_n347_), .c(x01), .O(z51));
