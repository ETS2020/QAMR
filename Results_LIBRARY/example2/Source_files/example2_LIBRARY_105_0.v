// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:12 2020
...
module FAU ( 
  ...
  inv1   g180(.a(new_n227_), .O(new_n332_));
  ...
  aoi21  g187(.a(new_n338_), .b(new_n320_), .c(new_n333_), .O(new_n339_));
  ...
  nand2  g192(.a(new_n343_), .b(new_n320_), .O(new_n344_));
  nand2  g193(.a(new_n333_), .b(x70), .O(new_n345_));
  ...
  nand2  g198(.a(new_n349_), .b(new_n320_), .O(new_n350_));
  nand2  g199(.a(new_n333_), .b(x71), .O(new_n351_));
  ...
  nand2  g204(.a(new_n355_), .b(new_n320_), .O(new_n356_));
  nand2  g205(.a(new_n333_), .b(x72), .O(new_n357_));
  ...
  nand3  g219(.a(new_n274_), .b(x84), .c(new_n370_), .O(new_n371_));
  inv1   g220(.a(x80), .O(new_n372_));
  nand4  g221(.a(new_n247_), .b(new_n161_), .c(new_n372_), .d(x79), .O(new_n373_));
  nor2   g222(.a(new_n373_), .b(new_n371_), .O(z55));
  nand2  g223(.a(new_n245_), .b(x76), .O(new_n375_));
  ...
  nand3  g230(.a(new_n381_), .b(new_n380_), .c(new_n243_), .O(z56));
  inv1   g231(.a(x02), .O(new_n383_));
  nand3  g232(.a(new_n243_), .b(x03), .c(new_n383_), .O(new_n384_));
  inv1   g233(.a(new_n384_), .O(z57));
  nand4  g234(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n386_));
  oai22  g235(.a(new_n386_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n387_));
  nand3  g236(.a(new_n387_), .b(new_n237_), .c(x79), .O(new_n388_));
  nor2   g237(.a(x79), .b(x78), .O(new_n389_));
  nand3  g238(.a(new_n389_), .b(new_n250_), .c(x40), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n388_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(x77), .O(new_n392_));
  oai21  g241(.a(new_n367_), .b(new_n240_), .c(new_n154_), .O(new_n393_));
  aoi21  g242(.a(new_n393_), .b(new_n392_), .c(x01), .O(z58));
  inv1   g243(.a(new_n389_), .O(new_n395_));
  aoi21  g244(.a(new_n236_), .b(new_n395_), .c(new_n152_), .O(new_n396_));
  oai21  g245(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(x79), .c(new_n236_), .O(new_n398_));
  ...
  nand2  g267(.a(new_n418_), .b(new_n323_), .O(new_n419_));
  ...
  aoi21  g272(.a(new_n423_), .b(new_n319_), .c(x01), .O(z64));
  nor2   g273(.a(new_n160_), .b(x04), .O(new_n425_));
  nor2   g274(.a(new_n254_), .b(x78), .O(new_n426_));
