...
module FAU ( 
  ...
  nand2  g017(.a(x77), .b(x66), .O(new_n169_));
  nand2  g018(.a(x78), .b(new_n159_), .O(new_n170_));
  oai21  g019(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  ...
  nor2   g177(.a(new_n328_), .b(new_n325_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(new_n232_), .O(new_n330_));
  aoi21  g179(.a(new_n330_), .b(new_n324_), .c(x01), .O(z47));
  inv1   g180(.a(x08), .O(new_n332_));
  nand2  g181(.a(x52), .b(x16), .O(new_n333_));
  oai21  g182(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g183(.a(new_n334_), .b(new_n323_), .O(new_n335_));
  inv1   g184(.a(new_n232_), .O(new_n336_));
  ...
  nand2  g191(.a(new_n342_), .b(new_n323_), .O(new_n343_));
  ...
  nand2  g197(.a(new_n348_), .b(new_n323_), .O(new_n349_));
  ...
  nand2  g203(.a(new_n354_), .b(new_n323_), .O(new_n355_));
  ...
  nand2  g209(.a(new_n360_), .b(new_n323_), .O(new_n361_));
  ...
  nand4  g226(.a(new_n250_), .b(new_n165_), .c(new_n377_), .d(x79), .O(new_n378_));
  nor2   g227(.a(new_n378_), .b(new_n376_), .O(z55));
  nand2  g228(.a(new_n248_), .b(x76), .O(new_n380_));
  xnor2a g229(.a(x84), .b(x81), .O(new_n381_));
  aoi21  g230(.a(new_n326_), .b(new_n170_), .c(new_n381_), .O(new_n382_));
  ...
  aoi21  g235(.a(new_n386_), .b(new_n164_), .c(new_n245_), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n385_), .O(z56));
  inv1   g237(.a(x02), .O(new_n389_));
  nand3  g238(.a(new_n246_), .b(x03), .c(new_n389_), .O(new_n390_));
  inv1   g239(.a(new_n390_), .O(z57));
  nand4  g240(.a(x80), .b(new_n238_), .c(x43), .d(new_n253_), .O(new_n392_));
  oai22  g241(.a(new_n392_), .b(new_n237_), .c(new_n253_), .d(x40), .O(new_n393_));
  nand3  g242(.a(new_n393_), .b(new_n235_), .c(x79), .O(new_n394_));
  nand3  g243(.a(new_n177_), .b(new_n253_), .c(x40), .O(new_n395_));
  ...
  aoi21  g248(.a(new_n163_), .b(new_n178_), .c(new_n152_), .O(new_n400_));
  oai21  g249(.a(new_n239_), .b(new_n237_), .c(new_n253_), .O(new_n401_));
  ...
  aoi21  g256(.a(new_n407_), .b(new_n242_), .c(x01), .O(z60));
  inv1   g257(.a(new_n172_), .O(new_n409_));
  nand2  g258(.a(new_n326_), .b(new_n170_), .O(new_n410_));
  aoi22  g259(.a(new_n410_), .b(new_n232_), .c(new_n165_), .d(new_n160_), .O(new_n411_));
