...
module FAU ( 
  ...
  nand3  g166(.a(new_n237_), .b(new_n154_), .c(new_n159_), .O(new_n318_));
  ...
  nand2  g173(.a(new_n324_), .b(new_n227_), .O(new_n325_));
  ...
  inv1   g179(.a(new_n227_), .O(new_n331_));
  ...
  nor2   g184(.a(x77), .b(new_n287_), .O(new_n336_));
  nand4  g185(.a(new_n336_), .b(new_n172_), .c(x17), .d(x04), .O(new_n337_));
  aoi21  g186(.a(new_n337_), .b(new_n335_), .c(x01), .O(z49));
  ...
  nand2  g191(.a(new_n332_), .b(x70), .O(new_n343_));
  ...
  nand2  g197(.a(new_n332_), .b(x71), .O(new_n349_));
  ...
  nand2  g203(.a(new_n332_), .b(x72), .O(new_n355_));
  ...
  nand2  g209(.a(new_n332_), .b(x73), .O(new_n361_));
  ...
  nand2  g265(.a(new_n416_), .b(new_n322_), .O(new_n417_));
