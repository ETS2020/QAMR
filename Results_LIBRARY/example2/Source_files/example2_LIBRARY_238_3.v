...
module FAU ( 
  ...
  and2   g177(.a(new_n328_), .b(new_n233_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x75), .O(new_n330_));
  ...
  nand2  g184(.a(new_n329_), .b(x68), .O(new_n336_));
  ...
  nand2  g190(.a(new_n329_), .b(x69), .O(new_n342_));
  ...
  nand2  g196(.a(new_n329_), .b(x70), .O(new_n348_));
  ...
  nand2  g202(.a(new_n329_), .b(x71), .O(new_n354_));
  ...
  nand2  g208(.a(new_n329_), .b(x72), .O(new_n360_));
  ...
  nand2  g269(.a(new_n420_), .b(new_n326_), .O(new_n421_));
