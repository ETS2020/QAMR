...
module FAU ( 
  ...
  nand2  g207(.a(new_n332_), .b(x73), .O(new_n359_));
  nor2   g208(.a(x77), .b(new_n287_), .O(new_n360_));
  nand4  g209(.a(new_n360_), .b(new_n172_), .c(x21), .d(x04), .O(new_n361_));
  aoi21  g210(.a(new_n361_), .b(new_n359_), .c(x01), .O(z53));
