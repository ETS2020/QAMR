// Benchmark "FAU" written by ABC on Thu Jun 25 19:52:48 2020
...
module FAU ( 
  ...
  nand4  g110(.a(new_n259_), .b(new_n247_), .c(x44), .d(new_n250_), .O(new_n262_));
  ...
  nand4  g118(.a(new_n257_), .b(new_n247_), .c(new_n233_), .d(x48), .O(new_n270_));
