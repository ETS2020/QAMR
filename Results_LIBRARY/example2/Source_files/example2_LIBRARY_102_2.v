...
module FAU ( 
  ...
  nand3  g195(.a(x78), .b(new_n286_), .c(x11), .O(new_n347_));
  nand2  g196(.a(new_n347_), .b(new_n346_), .O(new_n348_));
  nand4  g197(.a(new_n348_), .b(new_n154_), .c(new_n159_), .d(x04), .O(new_n349_));
  ...
  nand4  g203(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n355_));
  inv1   g204(.a(new_n355_), .O(new_n356_));
  nand2  g205(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g206(.a(new_n331_), .b(x72), .O(new_n358_));
  ...
  nand2  g211(.a(new_n362_), .b(new_n356_), .O(new_n363_));
  ...
  aoi21  g273(.a(new_n424_), .b(new_n355_), .c(x01), .O(z64));
