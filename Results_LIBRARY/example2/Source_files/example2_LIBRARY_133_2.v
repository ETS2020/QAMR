// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:24 2020
...
module FAU ( 
  ...
  inv1   g177(.a(new_n167_), .O(new_n329_));
  nand4  g178(.a(new_n329_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n330_));
  aoi21  g179(.a(new_n328_), .b(new_n327_), .c(new_n330_), .O(z48));
  ...
  inv1   g184(.a(new_n226_), .O(new_n336_));
  nor2   g185(.a(new_n323_), .b(new_n336_), .O(new_n337_));
  nand2  g186(.a(new_n337_), .b(x69), .O(new_n338_));
  aoi21  g187(.a(new_n338_), .b(new_n335_), .c(x01), .O(z49));
  ...
  nand2  g192(.a(new_n337_), .b(x70), .O(new_n344_));
  ...
  nand2  g198(.a(new_n337_), .b(x71), .O(new_n350_));
  ...
  nand2  g204(.a(new_n337_), .b(x72), .O(new_n356_));
  ...
  nand2  g210(.a(new_n337_), .b(x73), .O(new_n362_));
  aoi21  g211(.a(new_n362_), .b(new_n361_), .c(x01), .O(z53));
  nand2  g212(.a(x52), .b(x22), .O(new_n364_));
  nand2  g213(.a(new_n286_), .b(x14), .O(new_n365_));
  aoi21  g214(.a(new_n365_), .b(new_n364_), .c(new_n330_), .O(z54));
  inv1   g215(.a(x82), .O(new_n367_));
  nand3  g216(.a(new_n273_), .b(x84), .c(new_n367_), .O(new_n368_));
  ...
  oai21  g238(.a(new_n329_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nor3   g253(.a(new_n404_), .b(new_n402_), .c(new_n369_), .O(z61));
  ...
  nand2  g264(.a(new_n415_), .b(new_n322_), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n414_), .c(x01), .O(z62));
  nor3   g266(.a(new_n404_), .b(new_n402_), .c(new_n367_), .O(z63));
  ...
  nor2   g271(.a(new_n253_), .b(x78), .O(new_n423_));
  oai21  g272(.a(new_n423_), .b(new_n422_), .c(x77), .O(new_n424_));
  nand2  g273(.a(new_n329_), .b(x81), .O(new_n425_));
