...
module FAU ( 
  ...
  nor3   g152(.a(new_n296_), .b(new_n287_), .c(new_n199_), .O(z39));
  nor3   g153(.a(new_n296_), .b(new_n287_), .c(new_n196_), .O(z40));
  nor3   g154(.a(new_n296_), .b(new_n287_), .c(new_n193_), .O(z41));
  nor3   g155(.a(new_n296_), .b(new_n287_), .c(new_n190_), .O(z42));
  nor3   g156(.a(new_n296_), .b(new_n287_), .c(new_n187_), .O(z43));
  nor3   g157(.a(new_n296_), .b(new_n287_), .c(new_n184_), .O(z44));
  nor3   g158(.a(new_n296_), .b(new_n287_), .c(new_n181_), .O(z45));
  nor3   g159(.a(new_n296_), .b(new_n287_), .c(new_n178_), .O(z46));
  ...
  nand2  g212(.a(new_n286_), .b(x14), .O(new_n365_));
  ...
  nand3  g217(.a(new_n273_), .b(x84), .c(new_n369_), .O(new_n370_));
