// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:00 2020
...
module FAU ( 
  ...
  nand4  g105(.a(new_n256_), .b(new_n247_), .c(new_n229_), .d(x05), .O(new_n257_));
  inv1   g106(.a(new_n257_), .O(z25));
  nand4  g107(.a(new_n256_), .b(new_n247_), .c(x44), .d(new_n229_), .O(new_n259_));
  inv1   g108(.a(new_n259_), .O(z26));
  nand4  g109(.a(new_n256_), .b(new_n247_), .c(x45), .d(new_n229_), .O(new_n261_));
  inv1   g110(.a(new_n261_), .O(z27));
  nand4  g111(.a(new_n256_), .b(new_n247_), .c(x46), .d(new_n229_), .O(new_n263_));
  inv1   g112(.a(new_n263_), .O(z28));
  nand4  g113(.a(new_n256_), .b(new_n247_), .c(x47), .d(new_n229_), .O(new_n265_));
  inv1   g114(.a(new_n265_), .O(z29));
  nand4  g115(.a(new_n256_), .b(new_n247_), .c(x48), .d(new_n229_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z30));
  nand4  g117(.a(new_n256_), .b(new_n247_), .c(x49), .d(new_n229_), .O(new_n269_));
  inv1   g118(.a(new_n269_), .O(z31));
  nand4  g119(.a(new_n256_), .b(new_n247_), .c(x50), .d(new_n229_), .O(new_n271_));
  inv1   g120(.a(new_n271_), .O(z32));
  nor2   g121(.a(new_n230_), .b(x81), .O(new_n273_));
  nor2   g122(.a(x83), .b(new_n253_), .O(new_n274_));
  nor2   g123(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  nand2  g124(.a(x42), .b(x05), .O(new_n276_));
  nand2  g125(.a(x51), .b(new_n229_), .O(new_n277_));
  ...
  nand2  g132(.a(new_n247_), .b(new_n283_), .O(new_n284_));
  ...
  inv1   g215(.a(new_n166_), .O(new_n367_));
  nand4  g216(.a(new_n367_), .b(new_n152_), .c(x04), .d(new_n171_), .O(new_n368_));
  ...
  nand4  g221(.a(new_n247_), .b(new_n160_), .c(new_n372_), .d(x79), .O(new_n373_));
  ...
  nand4  g234(.a(x80), .b(new_n232_), .c(x43), .d(new_n229_), .O(new_n386_));
  oai22  g235(.a(new_n386_), .b(new_n231_), .c(new_n229_), .d(x40), .O(new_n387_));
  nor2   g236(.a(new_n152_), .b(new_n158_), .O(new_n388_));
  and2   g237(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  oai21  g238(.a(new_n389_), .b(new_n317_), .c(new_n238_), .O(new_n390_));
  nor2   g239(.a(x79), .b(x04), .O(new_n391_));
  inv1   g240(.a(new_n391_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n390_), .c(x01), .O(z58));
  oai21  g242(.a(new_n160_), .b(new_n237_), .c(new_n152_), .O(new_n394_));
  nand3  g243(.a(new_n234_), .b(x78), .c(new_n229_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n155_), .O(new_n396_));
  nand3  g245(.a(new_n396_), .b(x77), .c(x04), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n394_), .c(x01), .O(z59));
  aoi21  g247(.a(new_n377_), .b(x79), .c(new_n391_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n239_), .c(x01), .O(z60));
  inv1   g249(.a(new_n169_), .O(new_n401_));
  nand2  g250(.a(new_n167_), .b(new_n166_), .O(new_n402_));
  aoi22  g251(.a(new_n402_), .b(new_n226_), .c(new_n160_), .d(new_n237_), .O(new_n403_));
  nor3   g252(.a(new_n403_), .b(new_n401_), .c(new_n372_), .O(z61));
  nand3  g253(.a(x84), .b(x81), .c(x79), .O(new_n405_));
  oai21  g254(.a(x79), .b(new_n237_), .c(new_n405_), .O(new_n406_));
  nand2  g255(.a(new_n406_), .b(new_n158_), .O(new_n407_));
  oai21  g256(.a(new_n233_), .b(new_n231_), .c(new_n229_), .O(new_n408_));
  aoi21  g257(.a(new_n408_), .b(x79), .c(new_n237_), .O(new_n409_));
  nand3  g258(.a(x81), .b(x79), .c(new_n237_), .O(new_n410_));
  inv1   g259(.a(new_n410_), .O(new_n411_));
  oai21  g260(.a(new_n411_), .b(new_n409_), .c(x77), .O(new_n412_));
  nand2  g261(.a(new_n412_), .b(new_n407_), .O(new_n413_));
  nand2  g262(.a(new_n413_), .b(x78), .O(new_n414_));
  inv1   g263(.a(new_n405_), .O(new_n415_));
  nand2  g264(.a(new_n415_), .b(new_n322_), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n414_), .c(x01), .O(z62));
  nor3   g266(.a(new_n403_), .b(new_n401_), .c(new_n370_), .O(z63));
  nand2  g267(.a(x83), .b(x79), .O(new_n419_));
  or2    g268(.a(new_n419_), .b(new_n403_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n318_), .c(x01), .O(z64));
  nor2   g270(.a(new_n159_), .b(x04), .O(new_n422_));
  nor2   g271(.a(new_n253_), .b(x78), .O(new_n423_));
  oai21  g272(.a(new_n423_), .b(new_n422_), .c(x77), .O(new_n424_));
  nand2  g273(.a(new_n367_), .b(x81), .O(new_n425_));
  nand2  g274(.a(new_n169_), .b(x84), .O(new_n426_));
