...
module FAU ( 
  ...
  nand4  g015(.a(x79), .b(new_n160_), .c(x77), .d(x66), .O(new_n167_));
  oai21  g016(.a(new_n166_), .b(new_n165_), .c(new_n167_), .O(new_n168_));
  and2   g017(.a(new_n168_), .b(new_n153_), .O(z02));
  nand4  g018(.a(new_n154_), .b(x78), .c(x52), .d(new_n153_), .O(new_n170_));
  ...
  nand3  g074(.a(new_n225_), .b(new_n168_), .c(new_n224_), .O(new_n226_));
  ...
  nor3   g080(.a(new_n231_), .b(new_n159_), .c(x42), .O(new_n232_));
  ...
  nor2   g119(.a(new_n227_), .b(x81), .O(new_n271_));
  ...
  nor3   g152(.a(new_n294_), .b(new_n285_), .c(new_n197_), .O(z39));
  nor3   g153(.a(new_n294_), .b(new_n285_), .c(new_n194_), .O(z40));
  nor3   g154(.a(new_n294_), .b(new_n285_), .c(new_n191_), .O(z41));
  nor3   g155(.a(new_n294_), .b(new_n285_), .c(new_n188_), .O(z42));
  nor3   g156(.a(new_n294_), .b(new_n285_), .c(new_n185_), .O(z43));
  nor3   g157(.a(new_n294_), .b(new_n285_), .c(new_n182_), .O(z44));
  nor3   g158(.a(new_n294_), .b(new_n285_), .c(new_n179_), .O(z45));
  nor3   g159(.a(new_n294_), .b(new_n285_), .c(new_n176_), .O(z46));
  ...
  nand2  g164(.a(new_n315_), .b(new_n234_), .O(new_n316_));
  inv1   g165(.a(new_n316_), .O(new_n317_));
  nand2  g166(.a(new_n317_), .b(new_n314_), .O(new_n318_));
  nand2  g167(.a(x79), .b(x67), .O(new_n319_));
  nand2  g168(.a(new_n319_), .b(new_n165_), .O(new_n320_));
  nand2  g169(.a(new_n160_), .b(x77), .O(new_n321_));
  inv1   g170(.a(new_n321_), .O(new_n322_));
  nand3  g171(.a(new_n322_), .b(new_n320_), .c(new_n225_), .O(new_n323_));
  ...
  nand2  g177(.a(new_n322_), .b(x79), .O(new_n329_));
  inv1   g178(.a(new_n329_), .O(new_n330_));
  and2   g179(.a(new_n330_), .b(new_n225_), .O(new_n331_));
  ...
  nand2  g185(.a(new_n336_), .b(new_n317_), .O(new_n337_));
  ...
  nand2  g191(.a(new_n342_), .b(new_n317_), .O(new_n343_));
  ...
  nand2  g197(.a(new_n348_), .b(new_n317_), .O(new_n349_));
  ...
  nand2  g203(.a(new_n354_), .b(new_n317_), .O(new_n355_));
  ...
  nand3  g218(.a(new_n271_), .b(x84), .c(new_n369_), .O(new_n370_));
  inv1   g219(.a(x80), .O(new_n371_));
  nand4  g220(.a(new_n244_), .b(new_n161_), .c(new_n371_), .d(x79), .O(new_n372_));
  nor2   g221(.a(new_n372_), .b(new_n370_), .O(z55));
  nand2  g222(.a(new_n242_), .b(x76), .O(new_n374_));
  xnor2a g223(.a(x84), .b(x81), .O(new_n375_));
  aoi21  g224(.a(new_n321_), .b(new_n166_), .c(new_n375_), .O(new_n376_));
  ...
  oai21  g240(.a(new_n366_), .b(new_n237_), .c(new_n154_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n391_), .c(x01), .O(z58));
  inv1   g242(.a(new_n388_), .O(new_n394_));
  aoi21  g243(.a(new_n233_), .b(new_n394_), .c(new_n152_), .O(new_n395_));
  oai21  g244(.a(new_n230_), .b(new_n228_), .c(new_n247_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(x79), .c(new_n233_), .O(new_n397_));
  ...
  aoi21  g251(.a(new_n402_), .b(new_n235_), .c(x01), .O(z60));
  nand2  g252(.a(new_n321_), .b(new_n166_), .O(new_n404_));
  aoi22  g253(.a(new_n404_), .b(new_n225_), .c(new_n161_), .d(new_n237_), .O(new_n405_));
  ...
  oai21  g258(.a(x79), .b(new_n237_), .c(new_n409_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(new_n159_), .O(new_n411_));
  nand2  g260(.a(new_n396_), .b(x79), .O(new_n412_));
  ...
  or2    g271(.a(new_n422_), .b(new_n405_), .O(new_n423_));
  aoi21  g272(.a(new_n423_), .b(new_n316_), .c(x01), .O(z64));
  ...
  nand2  g277(.a(new_n406_), .b(x84), .O(new_n429_));
