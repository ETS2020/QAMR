// Benchmark "FAU" written by ABC on Thu Jun 25 19:52:36 2020
...
module FAU ( 
  ...
  nand4  g109(.a(new_n256_), .b(new_n246_), .c(x44), .d(new_n249_), .O(new_n261_));
  ...
  nand2  g121(.a(new_n258_), .b(new_n246_), .O(new_n273_));
