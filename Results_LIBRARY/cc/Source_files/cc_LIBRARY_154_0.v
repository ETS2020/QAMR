// Benchmark "FAU" written by ABC on Thu Jun 25 18:52:00 2020
...
module FAU ( 
  ...
  nand3  g17(.a(new_n46_), .b(x08), .c(x00), .O(new_n59_));
  ...
  nand3  g24(.a(new_n46_), .b(x08), .c(x02), .O(new_n66_));
  inv1   g25(.a(x08), .O(new_n67_));
  inv1   g26(.a(x10), .O(new_n68_));
  aoi21  g27(.a(x15), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n57_), .O(z14));
  nand3  g29(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n71_));
  nand3  g30(.a(new_n46_), .b(x08), .c(x03), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z15));
  nand2  g32(.a(new_n47_), .b(x17), .O(new_n74_));
  nand3  g33(.a(new_n46_), .b(x08), .c(x04), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z16));
  nand2  g35(.a(new_n47_), .b(x18), .O(new_n77_));
  nand3  g36(.a(new_n46_), .b(x08), .c(x05), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n57_), .O(z17));
  nand2  g38(.a(new_n47_), .b(x19), .O(new_n80_));
  nand3  g39(.a(new_n46_), .b(x08), .c(x06), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n57_), .O(z18));
  nand2  g41(.a(new_n47_), .b(x20), .O(new_n83_));
  nand3  g42(.a(new_n46_), .b(x08), .c(x07), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n57_), .O(z19));
  buf    g44(.a(x19), .O(z05));
  buf    g45(.a(x15), .O(z06));
  buf    g46(.a(x17), .O(z07));
  buf    g47(.a(x16), .O(z08));
