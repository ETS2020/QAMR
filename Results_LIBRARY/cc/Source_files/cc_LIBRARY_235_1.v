...
module FAU ( 
  ...
  aoi21  g32(.a(new_n47_), .b(z04), .c(new_n57_), .O(z17));
  nand2  g33(.a(new_n47_), .b(x19), .O(new_n75_));
  nand4  g34(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n57_), .O(z18));
  nand2  g36(.a(new_n47_), .b(x20), .O(new_n78_));
  nand4  g37(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n57_), .O(z19));
  buf    g39(.a(x19), .O(z05));
  buf    g40(.a(x15), .O(z06));
  buf    g41(.a(x17), .O(z07));
  buf    g42(.a(x16), .O(z08));
