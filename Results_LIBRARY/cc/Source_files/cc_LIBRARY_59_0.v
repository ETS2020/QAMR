...
module FAU ( 
  ...
  nand3  g16(.a(new_n48_), .b(x08), .c(x00), .O(new_n58_));
  inv1   g17(.a(x10), .O(new_n59_));
  nand2  g18(.a(new_n48_), .b(x08), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x13), .c(new_n59_), .O(new_n61_));
  ...
  nor2   g26(.a(x15), .b(new_n59_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n53_), .O(z14));
