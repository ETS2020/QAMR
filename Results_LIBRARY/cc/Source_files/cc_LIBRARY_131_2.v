...
module FAU ( 
  ...
  nand3  g16(.a(new_n46_), .b(x08), .c(x00), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z12));
  nand2  g18(.a(x08), .b(x01), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x14), .O(new_n61_));
  nand2  g20(.a(x15), .b(x08), .O(new_n62_));
  ...
  nand3  g27(.a(new_n46_), .b(x08), .c(x03), .O(new_n69_));
  ...
  nand3  g33(.a(new_n46_), .b(x08), .c(x05), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(z17));
  nand2  g35(.a(new_n47_), .b(x19), .O(new_n77_));
  nand3  g36(.a(new_n46_), .b(x08), .c(x06), .O(new_n78_));
