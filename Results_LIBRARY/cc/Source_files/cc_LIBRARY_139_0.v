...
module FAU ( 
  ...
  nand2  g31(.a(new_n60_), .b(x04), .O(new_n73_));
  inv1   g32(.a(x08), .O(new_n74_));
  nand2  g33(.a(new_n48_), .b(x10), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x17), .c(new_n74_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n53_), .O(z16));
