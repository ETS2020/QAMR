// Benchmark "FAU" written by ABC on Thu Jun 25 18:51:58 2020
...
module FAU ( 
  ...
  aoi21  g29(.a(new_n48_), .b(x08), .c(new_n70_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n59_), .c(new_n43_), .O(new_n72_));
  ...
  nand2  g36(.a(new_n49_), .b(x18), .O(new_n78_));
  nand3  g37(.a(new_n60_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z17));
  nand2  g39(.a(new_n49_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n60_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n53_), .O(z18));
  nand2  g42(.a(new_n49_), .b(x20), .O(new_n84_));
