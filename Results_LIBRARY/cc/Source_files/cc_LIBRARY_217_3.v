...
module FAU ( 
  ...
  oai21  g21(.a(new_n43_), .b(new_n62_), .c(x14), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n45_), .c(new_n58_), .O(z13));
  nand2  g23(.a(new_n43_), .b(x15), .O(new_n65_));
  nand4  g24(.a(new_n48_), .b(x10), .c(x08), .d(x02), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z14));
  aoi21  g26(.a(x10), .b(x08), .c(x14), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(x15), .c(x16), .O(new_n69_));
