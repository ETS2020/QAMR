// Benchmark "FAU" written by ABC on Thu Jun 25 18:51:40 2020
...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z14));
  nand3  g30(.a(new_n49_), .b(x16), .c(new_n43_), .O(new_n72_));
  nand3  g31(.a(new_n60_), .b(x08), .c(x03), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z15));
  inv1   g33(.a(x04), .O(new_n75_));
  nand2  g34(.a(x17), .b(x15), .O(new_n76_));
  oai21  g35(.a(x15), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n45_), .O(new_n78_));
  nand2  g37(.a(new_n44_), .b(x17), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n53_), .O(z16));
  nand2  g39(.a(new_n49_), .b(x18), .O(new_n81_));
  nand3  g40(.a(new_n60_), .b(x08), .c(x05), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n53_), .O(z17));
  nand2  g42(.a(new_n49_), .b(x19), .O(new_n84_));
  nand3  g43(.a(new_n60_), .b(x08), .c(x06), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n53_), .O(z18));
  nand2  g45(.a(new_n49_), .b(x20), .O(new_n87_));
  nand3  g46(.a(new_n60_), .b(x08), .c(x07), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n53_), .O(z19));
  buf    g48(.a(x19), .O(z05));
  buf    g49(.a(x15), .O(z06));
  buf    g50(.a(x17), .O(z07));
  buf    g51(.a(x16), .O(z08));
