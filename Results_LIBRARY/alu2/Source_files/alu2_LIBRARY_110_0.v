...
module FAU ( 
  ...
  nor2   g102(.a(new_n63_), .b(new_n78_), .O(new_n119_));
  nor3   g103(.a(x6), .b(x5), .c(x1), .O(new_n120_));
  ...
  oai21  g143(.a(new_n120_), .b(new_n18_), .c(x3), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n159_), .c(new_n30_), .O(new_n161_));
  oai21  g145(.a(x6), .b(new_n77_), .c(x5), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n18_), .O(new_n163_));
  nand2  g147(.a(new_n70_), .b(new_n77_), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n163_), .c(x1), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n161_), .c(new_n21_), .O(new_n166_));
  inv1   g150(.a(new_n104_), .O(new_n167_));
  nand2  g151(.a(x7), .b(x3), .O(new_n168_));
  oai22  g152(.a(new_n168_), .b(new_n167_), .c(new_n39_), .d(x1), .O(new_n169_));
  ...
  nor2   g171(.a(x4), .b(new_n78_), .O(new_n188_));
  nand2  g172(.a(new_n188_), .b(x7), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n71_), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n19_), .c(x0), .O(new_n191_));
  nand3  g175(.a(new_n38_), .b(new_n24_), .c(new_n18_), .O(new_n192_));
  nand3  g176(.a(new_n192_), .b(new_n191_), .c(new_n187_), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n185_), .c(x6), .O(new_n194_));
  nand2  g178(.a(new_n174_), .b(new_n19_), .O(new_n195_));
  aoi21  g179(.a(new_n195_), .b(x7), .c(x6), .O(new_n196_));
  aoi21  g180(.a(new_n63_), .b(new_n77_), .c(new_n78_), .O(new_n197_));
  nand3  g181(.a(new_n134_), .b(x3), .c(x2), .O(new_n198_));
  oai21  g182(.a(new_n197_), .b(x0), .c(new_n198_), .O(new_n199_));
  oai21  g183(.a(new_n199_), .b(new_n196_), .c(x4), .O(new_n200_));
  xnor2a g184(.a(x2), .b(x0), .O(new_n201_));
  nand3  g185(.a(new_n201_), .b(z2), .c(new_n30_), .O(new_n202_));
  oai21  g186(.a(x2), .b(new_n17_), .c(new_n78_), .O(new_n203_));
  ...
  aoi21  g191(.a(new_n128_), .b(x0), .c(new_n38_), .O(new_n208_));
  nand2  g192(.a(new_n204_), .b(new_n63_), .O(new_n209_));
  or2    g193(.a(new_n209_), .b(new_n208_), .O(new_n210_));
  nand3  g194(.a(new_n210_), .b(new_n207_), .c(new_n200_), .O(new_n211_));
  aoi21  g195(.a(x4), .b(x3), .c(x1), .O(new_n212_));
  nand3  g196(.a(z3), .b(x7), .c(new_n63_), .O(new_n213_));
  oai21  g197(.a(new_n212_), .b(new_n208_), .c(new_n213_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n24_), .O(new_n215_));
  aoi21  g199(.a(new_n168_), .b(x8), .c(x6), .O(new_n216_));
  oai21  g200(.a(new_n216_), .b(new_n44_), .c(new_n188_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(new_n215_), .O(new_n218_));
  aoi21  g202(.a(new_n211_), .b(x5), .c(new_n218_), .O(new_n219_));
  aoi21  g203(.a(new_n219_), .b(new_n194_), .c(new_n21_), .O(z4));
  and2   g204(.a(new_n201_), .b(z2), .O(z5));
endmodule
