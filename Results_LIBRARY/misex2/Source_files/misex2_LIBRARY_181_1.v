...
module FAU ( 
  ...
  nor2   g45(.a(new_n88_), .b(x15), .O(new_n89_));
  ...
  nand4  g56(.a(new_n99_), .b(new_n57_), .c(new_n88_), .d(x01), .O(new_n100_));
  inv1   g57(.a(x13), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(x12), .c(new_n62_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x16), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(x14), .O(new_n105_));
  nand3  g62(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n90_), .O(new_n108_));
  ...
  nand3  g69(.a(new_n95_), .b(x20), .c(new_n104_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n112_), .c(new_n103_), .d(new_n90_), .O(new_n115_));
  nand2  g72(.a(new_n96_), .b(new_n65_), .O(new_n116_));
  aoi21  g73(.a(new_n115_), .b(new_n110_), .c(new_n116_), .O(z11));
