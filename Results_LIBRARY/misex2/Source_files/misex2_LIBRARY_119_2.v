// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:16 2020
...
module FAU ( 
  ...
  nor2   g53(.a(new_n48_), .b(new_n66_), .O(new_n97_));
  ...
  aoi21  g58(.a(new_n98_), .b(new_n95_), .c(new_n101_), .O(z09));
  nor2   g59(.a(new_n100_), .b(new_n99_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n57_), .c(new_n96_), .d(x01), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n62_), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  nor2   g64(.a(new_n87_), .b(x14), .O(new_n108_));
  ...
  nand4  g69(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n49_), .O(new_n113_));
  nand3  g70(.a(new_n99_), .b(x20), .c(new_n88_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n108_), .c(new_n107_), .O(new_n116_));
  nand2  g73(.a(new_n100_), .b(new_n65_), .O(new_n117_));
