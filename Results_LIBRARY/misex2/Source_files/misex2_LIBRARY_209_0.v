// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:32 2020
...
module FAU ( 
  ...
  nand3  g46(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  nor2   g47(.a(new_n66_), .b(x00), .O(z16));
  nand2  g48(.a(z16), .b(new_n57_), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(new_n90_), .O(z09));
  nor2   g50(.a(x20), .b(new_n66_), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(new_n57_), .c(x22), .d(x21), .O(new_n95_));
  nand4  g52(.a(new_n89_), .b(new_n88_), .c(x20), .d(x16), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  nor2   g54(.a(new_n59_), .b(x01), .O(new_n98_));
  inv1   g55(.a(x13), .O(new_n99_));
  inv1   g56(.a(x14), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n99_), .c(x12), .d(new_n62_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n98_), .c(new_n97_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n95_), .c(x00), .O(z10));
  nand3  g61(.a(new_n94_), .b(new_n57_), .c(x21), .O(new_n105_));
  inv1   g62(.a(x16), .O(new_n106_));
  nand3  g63(.a(new_n88_), .b(x20), .c(new_n106_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n102_), .c(new_n98_), .O(new_n109_));
  nand2  g66(.a(new_n89_), .b(new_n65_), .O(new_n110_));
  aoi21  g67(.a(new_n109_), .b(new_n105_), .c(new_n110_), .O(z11));
  oai21  g68(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n114_));
  ...
  nor2   g76(.a(x19), .b(new_n47_), .O(new_n120_));
  and2   g77(.a(new_n120_), .b(new_n45_), .O(z13));
  nor2   g78(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g79(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n65_), .c(new_n124_), .O(z15));
