...
module FAU ( 
  ...
  nor3   g29(.a(new_n68_), .b(new_n54_), .c(new_n44_), .O(z05));
  nand2  g30(.a(x12), .b(x09), .O(new_n74_));
  nor2   g31(.a(new_n54_), .b(new_n59_), .O(new_n75_));
  nand4  g32(.a(new_n75_), .b(new_n74_), .c(new_n65_), .d(x11), .O(new_n76_));
  inv1   g33(.a(new_n76_), .O(z06));
  nand4  g34(.a(new_n70_), .b(x11), .c(x10), .d(x01), .O(new_n78_));
  ...
  nor2   g50(.a(new_n70_), .b(x11), .O(new_n94_));
  ...
  nor2   g59(.a(x20), .b(new_n64_), .O(new_n103_));
  ...
  nand2  g73(.a(new_n100_), .b(new_n63_), .O(new_n117_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z11));
  oai21  g75(.a(new_n54_), .b(new_n59_), .c(new_n65_), .O(new_n119_));
  ...
  nand3  g87(.a(x19), .b(new_n59_), .c(new_n64_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n63_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n64_), .b(x00), .O(z16));
