...
module FAU ( 
  ...
  nand2  g37(.a(new_n46_), .b(x02), .O(new_n81_));
  nand3  g38(.a(x19), .b(new_n49_), .c(x17), .O(new_n82_));
  nor3   g39(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(z08));
  inv1   g40(.a(x13), .O(new_n84_));
  inv1   g41(.a(x14), .O(new_n85_));
  nand4  g42(.a(new_n85_), .b(new_n84_), .c(x12), .d(new_n61_), .O(new_n86_));
  ...
  nor3   g47(.a(new_n90_), .b(new_n86_), .c(new_n81_), .O(z09));
  inv1   g48(.a(new_n81_), .O(z17));
  inv1   g49(.a(new_n86_), .O(new_n93_));
  nand4  g50(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(new_n93_), .c(z17), .d(x15), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z10));
  inv1   g54(.a(x16), .O(new_n98_));
  nand4  g55(.a(new_n88_), .b(new_n87_), .c(x20), .d(new_n98_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n93_), .c(z17), .d(x15), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z11));
  oai21  g59(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n103_));
  ...
  nand2  g67(.a(new_n46_), .b(new_n44_), .O(new_n111_));
  nor3   g68(.a(new_n111_), .b(x19), .c(new_n48_), .O(z13));
  ...
  oai21  g73(.a(new_n114_), .b(new_n58_), .c(new_n116_), .O(z15));
