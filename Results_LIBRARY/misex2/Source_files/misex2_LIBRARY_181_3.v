...
module FAU ( 
  ...
  nand3  g49(.a(new_n92_), .b(new_n88_), .c(new_n87_), .O(new_n93_));
  ...
  nand3  g57(.a(x22), .b(x21), .c(new_n100_), .O(new_n101_));
  nor2   g58(.a(new_n46_), .b(x00), .O(z16));
  nand3  g59(.a(z16), .b(new_n52_), .c(x18), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n101_), .O(z10));
  nand4  g61(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n105_));
  nand2  g62(.a(x20), .b(x15), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x21), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n88_), .c(new_n87_), .O(new_n108_));
