// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:06 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n111_, new_n113_, new_n116_, new_n117_;
  ...
  nand3  g45(.a(z16), .b(new_n57_), .c(new_n87_), .O(new_n89_));
  nor3   g46(.a(new_n89_), .b(x22), .c(x21), .O(z09));
  inv1   g47(.a(x21), .O(new_n91_));
  inv1   g48(.a(x22), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n57_), .c(new_n87_), .d(x01), .O(new_n94_));
  nand4  g51(.a(new_n92_), .b(new_n91_), .c(x20), .d(x15), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  nor2   g53(.a(new_n59_), .b(x01), .O(new_n97_));
  inv1   g54(.a(x13), .O(new_n98_));
  inv1   g55(.a(x14), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n98_), .c(x12), .d(new_n62_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n97_), .c(new_n96_), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n94_), .c(x00), .O(z10));
  nor3   g60(.a(new_n89_), .b(x22), .c(new_n91_), .O(z11));
  oai21  g61(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n105_));
  oai21  g62(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  nand3  g63(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n60_), .O(new_n109_));
  inv1   g66(.a(x24), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(x09), .O(new_n111_));
  aoi21  g68(.a(new_n109_), .b(new_n105_), .c(new_n111_), .O(z12));
  nor2   g69(.a(x19), .b(new_n47_), .O(new_n113_));
  and2   g70(.a(new_n113_), .b(new_n45_), .O(z13));
  nor2   g71(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g72(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n116_));
  nand3  g73(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n117_));
  oai21  g74(.a(new_n116_), .b(new_n65_), .c(new_n117_), .O(z15));
  inv1   g75(.a(new_n84_), .O(z17));
endmodule
