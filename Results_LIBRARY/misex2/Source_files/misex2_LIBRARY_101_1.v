...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n73_, new_n76_, new_n78_,
  ...
  nand4  g21(.a(x12), .b(x11), .c(x10), .d(x00), .O(new_n65_));
  oai22  g22(.a(new_n65_), .b(new_n64_), .c(new_n61_), .d(new_n58_), .O(z03));
  inv1   g23(.a(x00), .O(new_n67_));
  nor2   g24(.a(new_n62_), .b(new_n67_), .O(new_n68_));
  ...
  nor3   g31(.a(new_n69_), .b(new_n54_), .c(new_n44_), .O(z05));
  nand4  g32(.a(new_n68_), .b(x11), .c(x10), .d(new_n44_), .O(new_n76_));
  aoi21  g33(.a(new_n72_), .b(new_n59_), .c(new_n76_), .O(z06));
  nand4  g34(.a(new_n63_), .b(new_n72_), .c(x11), .d(x10), .O(new_n78_));
  ...
  nand2  g41(.a(new_n60_), .b(x02), .O(new_n85_));
  nand3  g42(.a(x19), .b(new_n48_), .c(x17), .O(new_n86_));
  nor3   g43(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(z08));
  inv1   g44(.a(x13), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x12), .c(new_n71_), .d(new_n62_), .O(new_n89_));
  ...
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n67_), .O(new_n99_));
  aoi21  g56(.a(new_n96_), .b(new_n94_), .c(new_n99_), .O(z09));
  nor2   g57(.a(new_n98_), .b(new_n97_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n57_), .c(new_n92_), .d(x01), .O(new_n102_));
  nor2   g59(.a(x11), .b(x01), .O(new_n103_));
  nand4  g60(.a(new_n98_), .b(new_n97_), .c(x20), .d(x16), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  inv1   g62(.a(x14), .O(new_n106_));
  nand4  g63(.a(x15), .b(new_n106_), .c(new_n88_), .d(x12), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n105_), .c(new_n103_), .O(new_n109_));
  ...
  nand3  g71(.a(new_n97_), .b(x20), .c(new_n114_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n113_), .c(new_n90_), .O(new_n117_));
  nand2  g74(.a(new_n98_), .b(new_n67_), .O(new_n118_));
  aoi21  g75(.a(new_n117_), .b(new_n111_), .c(new_n118_), .O(z11));
  oai21  g76(.a(new_n54_), .b(new_n59_), .c(new_n68_), .O(new_n120_));
  ...
  nand3  g88(.a(x19), .b(new_n59_), .c(new_n62_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(new_n67_), .c(new_n132_), .O(z15));
  nor2   g90(.a(new_n62_), .b(x00), .O(z16));
  inv1   g91(.a(new_n85_), .O(z17));
endmodule
