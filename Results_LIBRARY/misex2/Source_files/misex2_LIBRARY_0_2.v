...
module FAU ( 
  ...
  nor2   g49(.a(x11), .b(new_n59_), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n89_), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n57_), .c(new_n88_), .d(x01), .O(new_n102_));
  nand3  g59(.a(new_n62_), .b(x02), .c(new_n66_), .O(new_n103_));
  ...
  nand3  g69(.a(new_n97_), .b(x20), .c(new_n112_), .O(new_n113_));
