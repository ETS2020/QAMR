// Benchmark "FAU" written by ABC on Thu Jun 25 17:30:57 2020
...
module FAU ( 
  ...
  nand4  g43(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n87_));
  inv1   g44(.a(new_n87_), .O(new_n88_));
  nor2   g45(.a(x15), .b(x13), .O(new_n89_));
  inv1   g46(.a(x20), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(x16), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n94_), .b(new_n92_), .c(new_n97_), .O(z09));
  nor2   g55(.a(new_n96_), .b(new_n95_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n57_), .c(new_n90_), .d(x01), .O(new_n100_));
  nor2   g57(.a(new_n59_), .b(x01), .O(new_n101_));
  nand4  g58(.a(new_n96_), .b(new_n95_), .c(x20), .d(x16), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand4  g61(.a(x15), .b(new_n104_), .c(x12), .d(new_n62_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n103_), .c(new_n101_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n100_), .c(x00), .O(z10));
  nand4  g65(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  inv1   g66(.a(x15), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x13), .O(new_n111_));
  inv1   g68(.a(x16), .O(new_n112_));
  nand3  g69(.a(new_n95_), .b(x20), .c(new_n112_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n111_), .c(new_n88_), .O(new_n115_));
  nand2  g72(.a(new_n96_), .b(new_n65_), .O(new_n116_));
