...
module FAU ( 
  ...
  nor2   g42(.a(new_n85_), .b(x00), .O(z16));
  nand3  g43(.a(z16), .b(new_n59_), .c(new_n84_), .O(new_n87_));
  ...
  nand4  g48(.a(z16), .b(new_n59_), .c(x21), .d(new_n84_), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(new_n89_), .O(z10));
  nor2   g50(.a(new_n92_), .b(x22), .O(z11));
  oai21  g51(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n95_));
  ...
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n85_), .O(new_n108_));
