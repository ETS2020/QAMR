// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:36 2020
...
module FAU ( 
  ...
  nand4  g42(.a(x12), .b(new_n62_), .c(x02), .d(new_n46_), .O(new_n86_));
  inv1   g43(.a(new_n86_), .O(new_n87_));
  inv1   g44(.a(x20), .O(new_n88_));
  nor2   g45(.a(new_n88_), .b(x16), .O(new_n89_));
  nor3   g46(.a(x15), .b(x14), .c(x13), .O(new_n90_));
  nand3  g47(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(new_n91_));
  nor2   g48(.a(new_n51_), .b(new_n46_), .O(new_n92_));
  nor3   g49(.a(x21), .b(x20), .c(x19), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  inv1   g51(.a(x22), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n45_), .O(new_n96_));
  aoi21  g53(.a(new_n94_), .b(new_n91_), .c(new_n96_), .O(z09));
  nand4  g54(.a(new_n92_), .b(x22), .c(x21), .d(new_n52_), .O(new_n98_));
  nor2   g55(.a(new_n60_), .b(x01), .O(new_n99_));
  nand4  g56(.a(new_n95_), .b(x20), .c(x16), .d(x15), .O(new_n100_));
  ...
  nand3  g62(.a(new_n105_), .b(new_n101_), .c(new_n99_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n98_), .c(x00), .O(z10));
  nand3  g64(.a(x15), .b(new_n103_), .c(new_n102_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n89_), .c(new_n87_), .O(new_n110_));
  nand3  g67(.a(new_n92_), .b(x21), .c(new_n52_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n96_), .O(z11));
  oai21  g69(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n113_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g71(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n115_));
  ...
  nor4   g77(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g78(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n45_), .c(new_n124_), .O(z15));
