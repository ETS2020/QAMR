...
module FAU ( 
  ...
  nor3   g48(.a(new_n91_), .b(new_n88_), .c(new_n83_), .O(z09));
  nor2   g49(.a(x20), .b(x19), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(x22), .c(x18), .d(x01), .O(new_n94_));
  nand2  g51(.a(x02), .b(new_n46_), .O(new_n95_));
  inv1   g52(.a(x13), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(x12), .c(new_n62_), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  inv1   g55(.a(x15), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(x14), .O(new_n100_));
  nand4  g57(.a(new_n90_), .b(new_n89_), .c(x20), .d(x16), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n94_), .c(x00), .O(z10));
  nand3  g61(.a(new_n93_), .b(x18), .c(x01), .O(new_n105_));
  inv1   g62(.a(x16), .O(new_n106_));
  nand3  g63(.a(new_n89_), .b(x20), .c(new_n106_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n100_), .c(new_n98_), .O(new_n109_));
  nand2  g66(.a(new_n90_), .b(new_n45_), .O(new_n110_));
  aoi21  g67(.a(new_n109_), .b(new_n105_), .c(new_n110_), .O(z11));
  oai21  g68(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n112_));
  ...
  nor4   g76(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g77(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g78(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n122_));
  nand3  g79(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n45_), .c(new_n123_), .O(z15));
