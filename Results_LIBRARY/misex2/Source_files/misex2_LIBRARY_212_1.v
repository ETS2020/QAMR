...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n111_, new_n112_, new_n113_, new_n117_, new_n118_;
  ...
  nor2   g46(.a(new_n60_), .b(x01), .O(new_n90_));
  ...
  nand4  g58(.a(new_n101_), .b(x15), .c(x12), .d(new_n62_), .O(new_n102_));
  nand3  g59(.a(new_n98_), .b(x20), .c(x16), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n102_), .c(new_n83_), .O(z10));
  nand3  g61(.a(new_n98_), .b(x20), .c(new_n87_), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(new_n102_), .c(new_n83_), .O(z11));
  oai21  g63(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n107_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g65(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g67(.a(new_n110_), .b(new_n82_), .O(new_n111_));
  inv1   g68(.a(x24), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(x09), .O(new_n113_));
  aoi21  g70(.a(new_n111_), .b(new_n107_), .c(new_n113_), .O(z12));
  nor4   g71(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g72(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g73(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n117_));
  nand3  g74(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n118_));
  oai21  g75(.a(new_n117_), .b(new_n45_), .c(new_n118_), .O(z15));
  nor2   g76(.a(new_n46_), .b(x00), .O(z16));
