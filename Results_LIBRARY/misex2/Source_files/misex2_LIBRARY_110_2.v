...
module FAU ( 
  ...
  nand3  g44(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n88_));
  inv1   g45(.a(x13), .O(new_n89_));
  inv1   g46(.a(x14), .O(new_n90_));
  inv1   g47(.a(x15), .O(new_n91_));
  inv1   g48(.a(x16), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n89_), .O(new_n93_));
  nand4  g50(.a(x12), .b(new_n62_), .c(x02), .d(new_n45_), .O(new_n94_));
  nor3   g51(.a(new_n94_), .b(new_n93_), .c(new_n88_), .O(z09));
  nor2   g52(.a(x20), .b(x19), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(x22), .c(x18), .d(x01), .O(new_n97_));
  nand4  g54(.a(new_n87_), .b(new_n86_), .c(x20), .d(x16), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(new_n99_));
  nor2   g56(.a(x11), .b(new_n60_), .O(new_n100_));
  nand4  g57(.a(x15), .b(new_n90_), .c(new_n89_), .d(x12), .O(new_n101_));
  ...
  nand3  g61(.a(new_n96_), .b(x18), .c(x01), .O(new_n105_));
  nand3  g62(.a(new_n86_), .b(x20), .c(new_n92_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n102_), .c(new_n100_), .O(new_n108_));
  nand2  g65(.a(new_n87_), .b(new_n45_), .O(new_n109_));
  aoi21  g66(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  oai21  g67(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n111_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g69(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n82_), .O(new_n115_));
  inv1   g72(.a(x24), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(x09), .O(new_n117_));
  aoi21  g74(.a(new_n115_), .b(new_n111_), .c(new_n117_), .O(z12));
  nor4   g75(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g76(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g77(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n122_));
  oai21  g79(.a(new_n121_), .b(new_n45_), .c(new_n122_), .O(z15));
  nor2   g80(.a(new_n46_), .b(x00), .O(z16));
  inv1   g81(.a(new_n83_), .O(z17));
endmodule
