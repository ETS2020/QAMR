...
module FAU ( 
  ...
  nor2   g26(.a(new_n54_), .b(x09), .O(new_n70_));
  nand3  g27(.a(new_n70_), .b(new_n69_), .c(new_n62_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n65_), .O(z04));
  nor4   g29(.a(new_n65_), .b(new_n54_), .c(new_n44_), .d(new_n59_), .O(z05));
  nand2  g30(.a(x12), .b(new_n59_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(new_n70_), .c(new_n66_), .d(x11), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z06));
  inv1   g33(.a(x00), .O(new_n77_));
  inv1   g34(.a(x01), .O(new_n78_));
  nand2  g35(.a(x02), .b(new_n78_), .O(new_n79_));
  nand4  g36(.a(new_n63_), .b(new_n69_), .c(new_n44_), .d(x01), .O(new_n80_));
  ...
  inv1   g45(.a(new_n79_), .O(new_n89_));
  ...
  nor2   g50(.a(new_n69_), .b(x11), .O(new_n94_));
  ...
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n77_), .O(new_n101_));
  ...
  nor2   g63(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  nor2   g64(.a(new_n90_), .b(x14), .O(new_n108_));
  ...
  nand3  g70(.a(new_n99_), .b(x20), .c(new_n91_), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n108_), .c(new_n107_), .O(new_n116_));
  nand2  g73(.a(new_n100_), .b(new_n77_), .O(new_n117_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z11));
  oai21  g75(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n119_));
  ...
  nand3  g87(.a(x19), .b(new_n59_), .c(new_n78_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n77_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n78_), .b(x00), .O(z16));
  inv1   g90(.a(new_n86_), .O(z17));
endmodule
