...
module FAU ( 
  ...
  nand4  g54(.a(new_n97_), .b(new_n96_), .c(x18), .d(x01), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n65_), .O(new_n100_));
  aoi21  g57(.a(new_n98_), .b(new_n95_), .c(new_n100_), .O(z09));
  ...
  nand4  g64(.a(new_n99_), .b(new_n96_), .c(x20), .d(x16), .O(new_n108_));
  ...
  nand4  g68(.a(new_n97_), .b(x21), .c(x18), .d(x01), .O(new_n112_));
  nand3  g69(.a(new_n96_), .b(x20), .c(new_n88_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n107_), .c(new_n106_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n112_), .c(new_n100_), .O(z11));
