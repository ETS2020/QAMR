...
module FAU ( 
  ...
  oai21  g71(.a(x02), .b(new_n64_), .c(x10), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x00), .O(new_n117_));
  ...
  nor3   g80(.a(new_n46_), .b(x19), .c(new_n48_), .O(z13));
  oai21  g81(.a(new_n59_), .b(new_n44_), .c(x00), .O(new_n127_));
  nand3  g82(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n127_), .O(z15));
