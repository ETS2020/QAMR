// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:03 2020
...
module FAU ( 
  ...
  nor2   g46(.a(new_n89_), .b(x16), .O(new_n90_));
  nor3   g47(.a(x15), .b(x14), .c(x13), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  nor3   g49(.a(x21), .b(x20), .c(x19), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(x18), .c(x01), .O(new_n94_));
  inv1   g51(.a(x22), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n65_), .O(new_n96_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n96_), .O(z09));
  nand4  g54(.a(new_n57_), .b(x22), .c(x21), .d(new_n89_), .O(new_n98_));
  nor2   g55(.a(new_n59_), .b(x01), .O(new_n99_));
  ...
  nand3  g66(.a(new_n109_), .b(new_n90_), .c(new_n88_), .O(new_n110_));
  nand3  g67(.a(new_n57_), .b(x21), .c(new_n89_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n96_), .O(z11));
  oai21  g69(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n113_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g71(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n115_));
