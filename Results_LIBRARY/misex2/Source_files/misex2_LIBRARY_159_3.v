...
module FAU ( 
  ...
  nand4  g61(.a(x15), .b(x12), .c(new_n62_), .d(x02), .O(new_n105_));
  ...
  nand4  g65(.a(new_n95_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  nor2   g66(.a(new_n59_), .b(x01), .O(new_n110_));
  nand4  g67(.a(new_n97_), .b(x20), .c(new_n88_), .d(x15), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  inv1   g69(.a(x13), .O(new_n113_));
  inv1   g70(.a(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n113_), .c(x12), .d(new_n62_), .O(new_n115_));
  inv1   g72(.a(new_n115_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n112_), .c(new_n110_), .O(new_n117_));
  nand2  g74(.a(new_n98_), .b(new_n65_), .O(new_n118_));
  aoi21  g75(.a(new_n117_), .b(new_n109_), .c(new_n118_), .O(z11));
