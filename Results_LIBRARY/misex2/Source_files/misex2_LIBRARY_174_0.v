// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:26 2020
...
module FAU ( 
  ...
  nand3  g43(.a(z16), .b(new_n59_), .c(new_n85_), .O(new_n88_));
  nand2  g44(.a(x22), .b(x21), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n88_), .O(z10));
  nor2   g46(.a(new_n88_), .b(x22), .O(z11));
  ...
  nand3  g60(.a(x19), .b(new_n44_), .c(new_n86_), .O(new_n105_));
