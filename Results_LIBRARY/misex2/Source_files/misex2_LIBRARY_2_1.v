...
module FAU ( 
  ...
  aoi21  g57(.a(new_n98_), .b(new_n96_), .c(new_n100_), .O(z09));
  nand3  g58(.a(new_n92_), .b(x12), .c(new_n62_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x20), .O(new_n104_));
  nor2   g61(.a(x21), .b(new_n104_), .O(new_n105_));
  nand3  g62(.a(x16), .b(x15), .c(new_n93_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n91_), .O(new_n108_));
  nand4  g65(.a(new_n97_), .b(x22), .c(x18), .d(x01), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n108_), .c(x00), .O(z10));
  nand3  g67(.a(new_n88_), .b(x15), .c(new_n93_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n105_), .c(new_n103_), .d(new_n91_), .O(new_n113_));
  nor2   g70(.a(x22), .b(new_n99_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n57_), .c(new_n104_), .d(x01), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n113_), .c(x00), .O(z11));
  oai21  g73(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n60_), .O(new_n121_));
  ...
  aoi21  g84(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n128_));
  nand3  g85(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n65_), .c(new_n129_), .O(z15));
  nor2   g87(.a(new_n66_), .b(x00), .O(z16));
  inv1   g88(.a(new_n84_), .O(z17));
endmodule
