// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:25 2020
...
module FAU ( 
  ...
  nand4  g22(.a(x11), .b(x10), .c(new_n44_), .d(x02), .O(new_n66_));
  oai22  g23(.a(new_n66_), .b(new_n65_), .c(new_n61_), .d(new_n58_), .O(z03));
  nand2  g24(.a(new_n64_), .b(x02), .O(new_n69_));
  nor3   g25(.a(new_n69_), .b(new_n54_), .c(new_n44_), .O(z05));
  nand3  g26(.a(x11), .b(x10), .c(new_n44_), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n69_), .O(z06));
  nand3  g28(.a(x02), .b(new_n63_), .c(x00), .O(new_n73_));
  ...
  nand2  g34(.a(new_n60_), .b(x02), .O(new_n79_));
  nand3  g35(.a(x19), .b(new_n48_), .c(x17), .O(new_n80_));
  ...
  nand2  g41(.a(x02), .b(new_n63_), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  inv1   g43(.a(x11), .O(new_n88_));
  inv1   g44(.a(x13), .O(new_n89_));
  inv1   g45(.a(x14), .O(new_n90_));
  nand4  g46(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n88_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n87_), .c(new_n85_), .O(new_n93_));
  ...
  nor2   g55(.a(x20), .b(new_n63_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n57_), .c(x22), .d(x21), .O(new_n101_));
  nand3  g57(.a(new_n89_), .b(x12), .c(new_n88_), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nor2   g59(.a(new_n82_), .b(x14), .O(new_n104_));
  nand4  g60(.a(new_n97_), .b(new_n96_), .c(x20), .d(x16), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g64(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  nand3  g65(.a(new_n96_), .b(x20), .c(new_n83_), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n104_), .c(new_n103_), .O(new_n112_));
  nand2  g68(.a(new_n97_), .b(new_n62_), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g70(.a(new_n54_), .b(new_n59_), .c(new_n64_), .O(new_n115_));
  ...
  nand3  g82(.a(x19), .b(new_n59_), .c(new_n63_), .O(new_n127_));
  oai21  g83(.a(new_n126_), .b(new_n62_), .c(new_n127_), .O(z15));
  nor2   g84(.a(new_n63_), .b(x00), .O(z16));
  inv1   g85(.a(new_n79_), .O(z17));
  zero   g86(.O(z04));
endmodule
