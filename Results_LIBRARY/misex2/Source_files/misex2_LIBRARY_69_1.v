...
module FAU ( 
  ...
  nand3  g57(.a(new_n96_), .b(new_n93_), .c(x20), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  inv1   g60(.a(x14), .O(new_n104_));
  nand4  g61(.a(x16), .b(x15), .c(new_n104_), .d(new_n103_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n102_), .c(new_n88_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n100_), .c(x00), .O(z10));
  nand3  g65(.a(x15), .b(new_n104_), .c(new_n103_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n90_), .c(new_n88_), .O(new_n111_));
  nand4  g68(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n111_), .c(new_n97_), .O(z11));
  oai21  g70(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g72(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n116_));
  ...
  nor2   g78(.a(x19), .b(new_n47_), .O(new_n122_));
  and2   g79(.a(new_n122_), .b(new_n45_), .O(z13));
  nor2   g80(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g81(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n126_));
  oai21  g83(.a(new_n125_), .b(new_n65_), .c(new_n126_), .O(z15));
