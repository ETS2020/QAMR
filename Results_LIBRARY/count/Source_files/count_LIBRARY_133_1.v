...
module FAU ( 
  ...
  nand4  g024(.a(new_n69_), .b(new_n53_), .c(new_n52_), .d(x16), .O(new_n76_));
  ...
  and2   g032(.a(new_n63_), .b(x23), .O(new_n84_));
  ...
  oai21  g037(.a(new_n81_), .b(x19), .c(new_n64_), .O(new_n89_));
  ...
  nand3  g069(.a(new_n112_), .b(new_n81_), .c(new_n120_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n132_), .b(new_n91_), .c(new_n131_), .d(new_n90_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n53_), .O(new_n134_));
  aoi21  g083(.a(new_n134_), .b(new_n64_), .c(new_n130_), .O(new_n135_));
  nand2  g084(.a(new_n81_), .b(new_n64_), .O(new_n136_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n112_), .c(new_n91_), .d(new_n90_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n132_), .c(new_n101_), .d(new_n81_), .O(new_n155_));
  ...
  oai22  g107(.a(new_n158_), .b(new_n94_), .c(new_n156_), .d(new_n154_), .O(new_n159_));
  ...
  nand3  g114(.a(new_n132_), .b(new_n101_), .c(new_n81_), .O(new_n166_));
