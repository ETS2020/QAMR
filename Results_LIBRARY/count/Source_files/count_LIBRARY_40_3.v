...
module FAU ( 
  ...
  nand4  g147(.a(new_n148_), .b(new_n138_), .c(new_n124_), .d(new_n103_), .O(new_n199_));
  ...
  nand4  g159(.a(new_n210_), .b(new_n106_), .c(new_n170_), .d(new_n124_), .O(new_n211_));
  nand4  g160(.a(new_n163_), .b(new_n87_), .c(new_n138_), .d(new_n69_), .O(new_n212_));
  oai21  g161(.a(new_n212_), .b(new_n211_), .c(new_n53_), .O(new_n213_));
  aoi21  g162(.a(new_n213_), .b(new_n64_), .c(new_n195_), .O(new_n214_));
  nand2  g163(.a(new_n210_), .b(new_n195_), .O(new_n215_));
  nand3  g164(.a(new_n175_), .b(new_n151_), .c(new_n131_), .O(new_n216_));
  nor4   g165(.a(new_n216_), .b(new_n215_), .c(new_n107_), .d(new_n70_), .O(new_n217_));
