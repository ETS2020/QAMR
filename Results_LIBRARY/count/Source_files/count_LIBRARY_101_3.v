...
module FAU ( 
  ...
  oai21  g124(.a(new_n167_), .b(new_n152_), .c(new_n53_), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n64_), .c(new_n163_), .O(new_n177_));
  inv1   g126(.a(new_n98_), .O(new_n178_));
  nor2   g127(.a(x31), .b(x30), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n151_), .c(new_n131_), .d(new_n103_), .O(new_n180_));
  ...
  nand4  g135(.a(new_n179_), .b(new_n141_), .c(new_n148_), .d(new_n113_), .O(new_n187_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n190_), .c(new_n141_), .d(new_n126_), .O(new_n192_));
  ...
  nand4  g147(.a(new_n190_), .b(new_n151_), .c(new_n170_), .d(new_n124_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n127_), .c(new_n53_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n64_), .c(new_n198_), .O(new_n201_));
  nand2  g150(.a(new_n151_), .b(new_n131_), .O(new_n202_));
  ...
  nand4  g159(.a(new_n203_), .b(new_n179_), .c(new_n151_), .d(new_n124_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n127_), .c(new_n53_), .O(new_n212_));
