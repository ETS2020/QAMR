...
module FAU ( 
  ...
  nand3  g064(.a(new_n115_), .b(new_n89_), .c(new_n100_), .O(new_n116_));
  ...
  nand4  g071(.a(new_n122_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n125_), .c(new_n141_), .d(new_n99_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n122_), .c(new_n91_), .d(new_n63_), .O(new_n154_));
  ...
  nand4  g108(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n100_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n96_), .c(x32), .O(new_n161_));
  nand2  g110(.a(new_n142_), .b(new_n125_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n141_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n163_), .c(new_n91_), .d(new_n63_), .O(new_n167_));
  ...
  nand4  g121(.a(new_n164_), .b(new_n142_), .c(new_n125_), .d(new_n141_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n96_), .c(x33), .O(new_n174_));
  nor2   g123(.a(x33), .b(x32), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n151_), .c(new_n150_), .d(new_n115_), .O(new_n176_));
  ...
  nand4  g132(.a(new_n124_), .b(new_n87_), .c(new_n55_), .d(new_n69_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n176_), .c(x34), .O(new_n185_));
  nand2  g134(.a(new_n150_), .b(new_n115_), .O(new_n186_));
  ...
  inv1   g147(.a(x18), .O(new_n199_));
  oai21  g148(.a(x16), .b(x00), .c(new_n199_), .O(new_n200_));
  aoi21  g149(.a(x34), .b(x20), .c(new_n200_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n198_), .O(z15));
endmodule
