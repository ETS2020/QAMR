...
module FAU ( 
  ...
  nand3  g25(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n77_));
  ...
  nand4  g41(.a(new_n92_), .b(new_n91_), .c(new_n55_), .d(new_n83_), .O(new_n93_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n76_), .c(new_n55_), .d(new_n61_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n109_), .b(new_n84_), .c(new_n83_), .d(new_n69_), .O(new_n110_));
  inv1   g59(.a(x26), .O(new_n111_));
  aoi21  g60(.a(new_n55_), .b(new_n61_), .c(new_n111_), .O(new_n112_));
  aoi21  g61(.a(new_n110_), .b(new_n64_), .c(new_n112_), .O(new_n113_));
  inv1   g62(.a(x08), .O(new_n114_));
  aoi21  g63(.a(new_n58_), .b(new_n114_), .c(x18), .O(new_n115_));
  oai21  g64(.a(new_n113_), .b(new_n58_), .c(new_n115_), .O(z07));
