...
module FAU ( 
  ...
  nand4  g135(.a(new_n178_), .b(new_n145_), .c(new_n152_), .d(new_n117_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n119_), .c(new_n53_), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n64_), .c(new_n186_), .O(new_n189_));
  nor2   g138(.a(x32), .b(x31), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n167_), .c(new_n145_), .d(new_n130_), .O(new_n191_));
  nor2   g140(.a(new_n191_), .b(new_n101_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n189_), .c(x16), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n185_), .O(z13));
  inv1   g143(.a(x33), .O(new_n195_));
  nand4  g144(.a(new_n190_), .b(new_n155_), .c(new_n162_), .d(new_n128_), .O(new_n196_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n178_), .c(new_n155_), .d(new_n128_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n131_), .c(new_n53_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n64_), .c(new_n207_), .O(new_n210_));
  nand3  g159(.a(new_n200_), .b(new_n178_), .c(new_n207_), .O(new_n211_));
