...
module FAU ( 
  ...
  nand3  g052(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z05));
  inv1   g053(.a(x25), .O(new_n105_));
  nand2  g054(.a(new_n100_), .b(new_n53_), .O(new_n106_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n99_), .c(new_n105_), .O(new_n134_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n99_), .d(new_n77_), .O(new_n151_));
  ...
  nand3  g110(.a(new_n128_), .b(new_n99_), .c(new_n77_), .O(new_n162_));
  ...
  nor2   g126(.a(new_n177_), .b(new_n102_), .O(new_n178_));
