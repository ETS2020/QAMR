...
module FAU ( 
  ...
  nand4  g073(.a(new_n124_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n125_));
  ...
  nand4  g090(.a(new_n135_), .b(new_n110_), .c(new_n82_), .d(new_n55_), .O(new_n142_));
  nor2   g091(.a(x30), .b(x29), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n89_), .c(new_n55_), .O(new_n144_));
  inv1   g093(.a(x28), .O(new_n145_));
  nand4  g094(.a(new_n117_), .b(new_n76_), .c(new_n145_), .d(new_n99_), .O(new_n146_));
  nor2   g095(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  aoi21  g096(.a(new_n142_), .b(x30), .c(new_n147_), .O(new_n148_));
  nor2   g097(.a(new_n61_), .b(new_n58_), .O(new_n149_));
  inv1   g098(.a(x18), .O(new_n150_));
  oai21  g099(.a(x16), .b(x04), .c(new_n150_), .O(new_n151_));
  aoi21  g100(.a(new_n149_), .b(x30), .c(new_n151_), .O(new_n152_));
  oai21  g101(.a(new_n148_), .b(x20), .c(new_n152_), .O(z11));
  nor2   g102(.a(x26), .b(x25), .O(new_n154_));
  nand4  g103(.a(new_n143_), .b(new_n126_), .c(new_n154_), .d(new_n98_), .O(new_n155_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n124_), .c(new_n91_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n158_), .b(new_n157_), .c(new_n117_), .d(new_n99_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n90_), .c(x32), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n143_), .c(new_n126_), .d(new_n154_), .O(new_n170_));
  inv1   g119(.a(new_n170_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n91_), .O(new_n172_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n90_), .c(x33), .O(new_n178_));
  nor2   g127(.a(x33), .b(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n158_), .c(new_n157_), .d(new_n117_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n101_), .O(new_n182_));
  ...
  oai21  g136(.a(new_n180_), .b(new_n108_), .c(x34), .O(new_n188_));
  nand2  g137(.a(new_n157_), .b(new_n117_), .O(new_n189_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n190_), .c(new_n101_), .O(new_n199_));
