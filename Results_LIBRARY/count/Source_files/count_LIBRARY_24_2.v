...
module FAU ( 
  ...
  nand2  g045(.a(new_n55_), .b(new_n69_), .O(new_n97_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n87_), .c(new_n102_), .d(new_n101_), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n97_), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n100_), .c(new_n61_), .O(new_n105_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n89_), .c(new_n96_), .O(new_n123_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n130_));
  nor2   g079(.a(x28), .b(x27), .O(new_n131_));
  nor2   g080(.a(x26), .b(x23), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n131_), .c(new_n112_), .O(new_n133_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n115_), .c(new_n82_), .d(new_n63_), .O(new_n141_));
  oai21  g090(.a(new_n134_), .b(new_n139_), .c(new_n141_), .O(new_n142_));
  ...
  nand4  g095(.a(new_n111_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n147_));
  nor2   g096(.a(x26), .b(x25), .O(new_n148_));
  nor2   g097(.a(x30), .b(x29), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n131_), .c(new_n148_), .d(new_n87_), .O(new_n150_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n129_), .c(new_n91_), .O(new_n161_));
  ...
  nand4  g115(.a(new_n158_), .b(new_n157_), .c(new_n122_), .d(new_n96_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n90_), .c(x32), .O(new_n168_));
  nor2   g117(.a(x32), .b(x31), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n149_), .c(new_n131_), .d(new_n148_), .O(new_n170_));
  ...
  nor2   g127(.a(new_n103_), .b(new_n70_), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n158_), .c(new_n157_), .d(new_n122_), .O(new_n181_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n113_), .c(x34), .O(new_n189_));
  nand2  g138(.a(new_n157_), .b(new_n122_), .O(new_n190_));
