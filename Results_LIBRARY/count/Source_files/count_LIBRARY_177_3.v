...
module FAU ( 
  ...
  aoi21  g001(.a(new_n52_), .b(x17), .c(x19), .O(new_n53_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n76_), .c(new_n67_), .d(new_n55_), .O(new_n92_));
  ...
  nand4  g092(.a(new_n108_), .b(new_n67_), .c(new_n69_), .d(new_n55_), .O(new_n144_));
