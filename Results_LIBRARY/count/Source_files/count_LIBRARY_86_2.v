// Benchmark "FAU" written by ABC on Thu Jun 25 18:00:47 2020
...
module FAU ( 
  ...
  nand2  g055(.a(new_n55_), .b(new_n69_), .O(new_n107_));
  oai21  g056(.a(new_n107_), .b(new_n101_), .c(x26), .O(new_n108_));
  ...
  nand3  g061(.a(x26), .b(x20), .c(x16), .O(new_n113_));
  inv1   g062(.a(x08), .O(new_n114_));
  aoi21  g063(.a(new_n58_), .b(new_n114_), .c(x18), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(z07));
  ...
  nand3  g068(.a(new_n119_), .b(new_n89_), .c(new_n100_), .O(new_n120_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n117_), .c(new_n82_), .d(new_n63_), .O(new_n139_));
  ...
  nand4  g094(.a(new_n145_), .b(new_n129_), .c(new_n109_), .d(new_n99_), .O(new_n146_));
  ...
  oai21  g100(.a(new_n146_), .b(new_n88_), .c(x31), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  inv1   g104(.a(new_n155_), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n126_), .c(new_n91_), .d(new_n63_), .O(new_n157_));
  ...
  nand4  g111(.a(new_n154_), .b(new_n153_), .c(new_n119_), .d(new_n100_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n96_), .c(x32), .O(new_n164_));
  nand2  g113(.a(new_n145_), .b(new_n129_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nor2   g115(.a(x32), .b(x31), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n109_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n166_), .c(new_n91_), .d(new_n63_), .O(new_n170_));
  ...
  nand4  g124(.a(new_n167_), .b(new_n145_), .c(new_n129_), .d(new_n109_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n96_), .c(x33), .O(new_n177_));
  nor2   g126(.a(x33), .b(x32), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n154_), .c(new_n153_), .d(new_n119_), .O(new_n179_));
  ...
  nor2   g135(.a(x21), .b(x20), .O(new_n187_));
  nand4  g136(.a(new_n128_), .b(new_n87_), .c(new_n187_), .d(new_n55_), .O(new_n188_));
  oai21  g137(.a(new_n179_), .b(new_n188_), .c(x34), .O(new_n189_));
  nand2  g138(.a(new_n153_), .b(new_n119_), .O(new_n190_));
  ...
  nand3  g148(.a(new_n199_), .b(new_n191_), .c(new_n102_), .O(new_n200_));
