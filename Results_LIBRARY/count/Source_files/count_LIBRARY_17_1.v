...
module FAU ( 
  ...
  nand4  g135(.a(new_n177_), .b(new_n144_), .c(new_n151_), .d(new_n116_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n118_), .c(new_n53_), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n64_), .c(new_n186_), .O(new_n189_));
  nor2   g138(.a(x32), .b(x31), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n166_), .c(new_n144_), .d(new_n129_), .O(new_n191_));
  ...
  nand4  g146(.a(new_n190_), .b(new_n154_), .c(new_n161_), .d(new_n127_), .O(new_n198_));
  ...
  nand3  g150(.a(new_n201_), .b(new_n179_), .c(new_n134_), .O(new_n202_));
  nor2   g151(.a(new_n202_), .b(new_n110_), .O(new_n203_));
  ...
  oai21  g156(.a(new_n203_), .b(x34), .c(x16), .O(new_n208_));
