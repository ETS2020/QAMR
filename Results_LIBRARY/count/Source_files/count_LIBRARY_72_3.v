...
module FAU ( 
  ...
  nand2  g033(.a(new_n84_), .b(x20), .O(new_n85_));
  nand4  g034(.a(new_n85_), .b(new_n76_), .c(new_n55_), .d(new_n83_), .O(new_n86_));
  oai21  g035(.a(new_n78_), .b(new_n83_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g041(.a(new_n92_), .b(new_n55_), .c(new_n84_), .O(new_n93_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n84_), .c(new_n83_), .d(new_n101_), .O(new_n103_));
  ...
  nand3  g070(.a(new_n121_), .b(new_n94_), .c(new_n102_), .O(new_n122_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n94_), .c(new_n78_), .O(new_n129_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n114_), .c(new_n92_), .d(new_n63_), .O(new_n140_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n130_), .c(new_n147_), .d(new_n84_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n159_), .b(new_n128_), .c(new_n96_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n157_), .b(new_n156_), .c(new_n121_), .d(new_n102_), .O(new_n166_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n95_), .c(x33), .O(new_n177_));
