...
module FAU ( 
  ...
  nand3  g066(.a(new_n110_), .b(new_n77_), .c(new_n117_), .O(new_n118_));
  ...
  nor2   g072(.a(x18), .b(new_n58_), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n123_), .c(new_n121_), .O(z07));
  ...
  nand3  g082(.a(new_n133_), .b(new_n98_), .c(new_n107_), .O(new_n134_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n110_), .c(new_n88_), .d(new_n87_), .O(new_n141_));
  aoi21  g090(.a(new_n141_), .b(new_n53_), .c(new_n63_), .O(new_n142_));
  inv1   g091(.a(x26), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n110_), .c(new_n143_), .d(new_n117_), .O(new_n145_));
  oai22  g094(.a(new_n145_), .b(new_n132_), .c(new_n142_), .d(new_n140_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n128_), .c(new_n98_), .d(new_n77_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n53_), .c(new_n63_), .O(new_n153_));
  nor2   g102(.a(x29), .b(x28), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n122_), .c(new_n126_), .O(new_n155_));
  ...
  nand3  g111(.a(new_n128_), .b(new_n98_), .c(new_n77_), .O(new_n163_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n154_), .c(new_n133_), .d(new_n107_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n144_), .c(new_n151_), .d(new_n143_), .O(new_n185_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n166_), .c(new_n144_), .d(new_n128_), .O(new_n189_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n154_), .c(new_n161_), .d(new_n126_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n129_), .c(new_n53_), .O(new_n197_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n177_), .c(new_n154_), .d(new_n126_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n129_), .c(new_n53_), .O(new_n209_));
