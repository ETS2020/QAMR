...
module FAU ( 
  ...
  oai21  g036(.a(x16), .b(x11), .c(new_n87_), .O(new_n88_));
  aoi21  g037(.a(x23), .b(x20), .c(new_n88_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n99_), .c(new_n81_), .d(new_n98_), .O(new_n101_));
  ...
  nand3  g060(.a(new_n111_), .b(new_n83_), .c(new_n71_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n118_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n91_), .c(new_n76_), .d(new_n63_), .O(new_n127_));
  nor2   g076(.a(x28), .b(x27), .O(new_n128_));
  nor2   g077(.a(x26), .b(x23), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n108_), .O(new_n130_));
  nor2   g079(.a(new_n130_), .b(new_n118_), .O(new_n131_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n111_), .c(new_n137_), .d(new_n63_), .O(new_n139_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n128_), .c(new_n145_), .d(new_n99_), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n84_), .O(new_n148_));
  ...
  oai21  g101(.a(new_n147_), .b(new_n84_), .c(x31), .O(new_n153_));
