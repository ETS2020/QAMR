...
module FAU ( 
  ...
  nand4  g073(.a(new_n124_), .b(new_n89_), .c(new_n76_), .d(new_n55_), .O(new_n125_));
  ...
  aoi21  g081(.a(x28), .b(x20), .c(new_n132_), .O(new_n133_));
  oai21  g082(.a(new_n130_), .b(new_n58_), .c(new_n133_), .O(z09));
  inv1   g083(.a(x29), .O(new_n135_));
  nor3   g084(.a(x29), .b(x28), .c(x27), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n137_));
  oai21  g086(.a(new_n129_), .b(new_n135_), .c(new_n137_), .O(new_n138_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n124_), .c(new_n91_), .O(new_n156_));
  ...
  nand4  g110(.a(new_n153_), .b(new_n152_), .c(new_n117_), .d(new_n99_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n90_), .c(x32), .O(new_n163_));
  nor2   g112(.a(x32), .b(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n144_), .c(new_n126_), .d(new_n143_), .O(new_n165_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n90_), .c(x33), .O(new_n173_));
  nor2   g122(.a(x33), .b(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n153_), .c(new_n152_), .d(new_n117_), .O(new_n175_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n108_), .c(x34), .O(new_n183_));
  nand2  g132(.a(new_n152_), .b(new_n117_), .O(new_n184_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n185_), .c(new_n101_), .O(new_n194_));
