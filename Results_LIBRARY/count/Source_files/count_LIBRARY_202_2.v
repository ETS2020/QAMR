...
module FAU ( 
  ...
  oai21  g073(.a(new_n124_), .b(new_n118_), .c(x28), .O(new_n125_));
  nor3   g074(.a(x28), .b(x27), .c(x26), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n107_), .c(new_n82_), .d(new_n55_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n61_), .O(new_n129_));
  nand3  g078(.a(x28), .b(x20), .c(x16), .O(new_n130_));
  inv1   g079(.a(x06), .O(new_n131_));
  aoi21  g080(.a(new_n58_), .b(new_n131_), .c(x18), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n129_), .O(z09));
  nor3   g082(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n126_), .c(new_n76_), .d(new_n63_), .O(new_n135_));
  inv1   g084(.a(x27), .O(new_n136_));
  nor2   g085(.a(x26), .b(x25), .O(new_n137_));
  nor2   g086(.a(x29), .b(x28), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n98_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(new_n88_), .O(new_n140_));
  aoi21  g089(.a(new_n135_), .b(x29), .c(new_n140_), .O(new_n141_));
  ...
  nand4  g094(.a(new_n145_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n146_));
  nor2   g095(.a(x28), .b(x27), .O(new_n147_));
  nor2   g096(.a(x30), .b(x29), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n137_), .d(new_n98_), .O(new_n149_));
  ...
  oai21  g103(.a(new_n149_), .b(new_n88_), .c(x31), .O(new_n155_));
  ...
  nand3  g108(.a(new_n159_), .b(new_n156_), .c(new_n91_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n157_), .b(new_n138_), .c(new_n117_), .d(new_n99_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n90_), .c(x32), .O(new_n167_));
  nor2   g116(.a(x32), .b(x31), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n148_), .c(new_n147_), .d(new_n137_), .O(new_n169_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n157_), .c(new_n138_), .d(new_n117_), .O(new_n179_));
  ...
  nand2  g136(.a(new_n138_), .b(new_n117_), .O(new_n188_));
