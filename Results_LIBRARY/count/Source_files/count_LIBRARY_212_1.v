...
module FAU ( 
  ...
  nand4  g150(.a(new_n201_), .b(new_n179_), .c(new_n155_), .d(new_n133_), .O(new_n202_));
  nor3   g151(.a(new_n202_), .b(new_n109_), .c(new_n71_), .O(new_n203_));
  ...
  nand2  g156(.a(new_n145_), .b(new_n128_), .O(new_n208_));
  nand3  g157(.a(new_n174_), .b(new_n52_), .c(x16), .O(new_n209_));
  nor3   g158(.a(new_n209_), .b(new_n208_), .c(new_n99_), .O(new_n210_));
  nand4  g159(.a(new_n210_), .b(new_n201_), .c(new_n167_), .d(new_n63_), .O(new_n211_));
