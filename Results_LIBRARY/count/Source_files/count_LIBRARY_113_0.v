...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n98_, new_n100_, new_n102_, new_n104_, new_n106_;
  ...
  nor2   g27(.a(new_n78_), .b(new_n66_), .O(new_n79_));
  inv1   g28(.a(x23), .O(new_n80_));
  aoi21  g29(.a(new_n55_), .b(new_n61_), .c(new_n80_), .O(new_n81_));
  oai21  g30(.a(new_n81_), .b(new_n79_), .c(x16), .O(new_n82_));
  inv1   g31(.a(x11), .O(new_n83_));
  aoi21  g32(.a(new_n58_), .b(new_n83_), .c(x18), .O(new_n84_));
  nand2  g33(.a(new_n84_), .b(new_n82_), .O(z04));
  aoi21  g34(.a(x24), .b(x16), .c(x18), .O(new_n86_));
  oai21  g35(.a(x16), .b(x10), .c(new_n86_), .O(z05));
  aoi21  g36(.a(x25), .b(x16), .c(x18), .O(new_n88_));
  oai21  g37(.a(x16), .b(x09), .c(new_n88_), .O(z06));
  aoi21  g38(.a(x26), .b(x16), .c(x18), .O(new_n90_));
  oai21  g39(.a(x16), .b(x08), .c(new_n90_), .O(z07));
  aoi21  g40(.a(x27), .b(x16), .c(x18), .O(new_n92_));
  oai21  g41(.a(x16), .b(x07), .c(new_n92_), .O(z08));
  aoi21  g42(.a(x28), .b(x16), .c(x18), .O(new_n94_));
  oai21  g43(.a(x16), .b(x06), .c(new_n94_), .O(z09));
  aoi21  g44(.a(x29), .b(x16), .c(x18), .O(new_n96_));
  oai21  g45(.a(x16), .b(x05), .c(new_n96_), .O(z10));
  aoi21  g46(.a(x30), .b(x16), .c(x18), .O(new_n98_));
  oai21  g47(.a(x16), .b(x04), .c(new_n98_), .O(z11));
  aoi21  g48(.a(x31), .b(x16), .c(x18), .O(new_n100_));
  oai21  g49(.a(x16), .b(x03), .c(new_n100_), .O(z12));
  aoi21  g50(.a(x32), .b(x16), .c(x18), .O(new_n102_));
  oai21  g51(.a(x16), .b(x02), .c(new_n102_), .O(z13));
  aoi21  g52(.a(x33), .b(x16), .c(x18), .O(new_n104_));
  oai21  g53(.a(x16), .b(x01), .c(new_n104_), .O(z14));
  aoi21  g54(.a(x34), .b(x16), .c(x18), .O(new_n106_));
  oai21  g55(.a(x16), .b(x00), .c(new_n106_), .O(z15));
endmodule
