...
module FAU ( 
  ...
  nand3  g102(.a(new_n153_), .b(new_n117_), .c(new_n89_), .O(new_n154_));
  ...
  nand2  g109(.a(new_n154_), .b(new_n160_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n126_), .b(new_n96_), .c(new_n77_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n152_), .c(new_n53_), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n64_), .c(new_n166_), .O(new_n169_));
  nor2   g118(.a(x31), .b(x29), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n141_), .c(new_n117_), .O(new_n171_));
  nor3   g120(.a(new_n171_), .b(new_n88_), .c(new_n63_), .O(new_n172_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n131_), .c(new_n138_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n115_), .c(new_n53_), .O(new_n179_));
  aoi21  g128(.a(new_n179_), .b(new_n64_), .c(new_n177_), .O(new_n180_));
  nand2  g129(.a(new_n98_), .b(new_n64_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n151_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n131_), .c(new_n103_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n181_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n180_), .c(x16), .O(new_n187_));
  ...
  nand4  g140(.a(new_n182_), .b(new_n141_), .c(new_n148_), .d(new_n113_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n115_), .c(new_n53_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n64_), .c(new_n191_), .O(new_n194_));
  nor2   g143(.a(x33), .b(x32), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n170_), .c(new_n141_), .d(new_n126_), .O(new_n196_));
  nor2   g145(.a(new_n196_), .b(new_n181_), .O(new_n197_));
  ...
  nand4  g151(.a(new_n195_), .b(new_n151_), .c(new_n166_), .d(new_n124_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n127_), .c(new_n53_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n64_), .c(new_n202_), .O(new_n205_));
  nor2   g154(.a(x34), .b(x33), .O(new_n206_));
  nand3  g155(.a(new_n206_), .b(new_n184_), .c(new_n131_), .O(new_n207_));
