...
module FAU ( 
  ...
  oai21  g138(.a(new_n182_), .b(new_n109_), .c(x34), .O(new_n190_));
  nand2  g139(.a(new_n136_), .b(new_n118_), .O(new_n191_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n192_), .c(new_n102_), .O(new_n201_));
