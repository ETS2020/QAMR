...
module FAU ( 
  ...
  nand4  g039(.a(new_n90_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n91_));
  ...
  aoi21  g053(.a(new_n93_), .b(x25), .c(new_n104_), .O(new_n105_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n90_), .c(new_n71_), .O(new_n114_));
  ...
  nand3  g069(.a(new_n120_), .b(new_n92_), .c(new_n102_), .O(new_n121_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n113_), .c(new_n85_), .d(new_n63_), .O(new_n139_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n93_), .c(x33), .O(new_n175_));
