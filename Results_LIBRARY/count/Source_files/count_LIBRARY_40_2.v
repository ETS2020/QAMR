...
module FAU ( 
  ...
  oai21  g043(.a(new_n94_), .b(x19), .c(new_n64_), .O(new_n95_));
  ...
  nand3  g074(.a(new_n114_), .b(new_n85_), .c(new_n125_), .O(new_n126_));
  inv1   g075(.a(x26), .O(new_n127_));
  nand3  g076(.a(new_n55_), .b(new_n127_), .c(new_n61_), .O(new_n128_));
  aoi21  g077(.a(new_n126_), .b(new_n53_), .c(new_n128_), .O(new_n129_));
  ...
  oai22  g081(.a(new_n132_), .b(new_n130_), .c(new_n129_), .d(new_n124_), .O(new_n133_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n104_), .c(new_n127_), .O(new_n146_));
  ...
  nand3  g101(.a(new_n145_), .b(new_n114_), .c(new_n94_), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n53_), .c(new_n128_), .O(new_n154_));
  nor2   g103(.a(x29), .b(x28), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n117_), .c(new_n89_), .d(new_n124_), .O(new_n156_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n141_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n97_), .c(new_n53_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n139_), .c(new_n162_), .O(new_n165_));
  nor2   g114(.a(x30), .b(x29), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n145_), .c(new_n117_), .O(new_n167_));
  nor3   g116(.a(new_n167_), .b(new_n88_), .c(new_n63_), .O(new_n168_));
  ...
  nand3  g123(.a(new_n141_), .b(new_n96_), .c(new_n85_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n174_), .c(new_n53_), .O(new_n176_));
  ...
  nand3  g128(.a(new_n179_), .b(new_n155_), .c(new_n131_), .O(new_n180_));
  ...
  oai21  g136(.a(new_n187_), .b(new_n126_), .c(new_n53_), .O(new_n188_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n145_), .d(new_n190_), .O(new_n192_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n155_), .c(new_n162_), .d(new_n124_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n126_), .c(new_n53_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n139_), .c(new_n198_), .O(new_n201_));
  nor2   g150(.a(x27), .b(x26), .O(new_n202_));
  nor2   g151(.a(x33), .b(x32), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n179_), .c(new_n155_), .d(new_n202_), .O(new_n204_));
  ...
  nand4  g159(.a(new_n210_), .b(new_n191_), .c(new_n166_), .d(new_n145_), .O(new_n211_));
  nand2  g160(.a(new_n211_), .b(new_n127_), .O(new_n212_));
  nand2  g161(.a(new_n96_), .b(new_n108_), .O(new_n213_));
  nor2   g162(.a(new_n213_), .b(new_n78_), .O(new_n214_));
  nand2  g163(.a(new_n214_), .b(new_n212_), .O(new_n215_));
  nand4  g164(.a(new_n203_), .b(new_n166_), .c(new_n173_), .d(new_n138_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n142_), .c(x34), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n215_), .c(x19), .O(new_n218_));
  and2   g167(.a(new_n63_), .b(x34), .O(new_n219_));
