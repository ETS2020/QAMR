...
module FAU ( 
  ...
  nand3  g126(.a(new_n177_), .b(new_n131_), .c(new_n103_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n175_), .b(new_n141_), .c(new_n148_), .d(new_n113_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n115_), .c(new_n53_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n64_), .c(new_n184_), .O(new_n187_));
  nand4  g136(.a(new_n138_), .b(new_n124_), .c(new_n113_), .d(new_n103_), .O(new_n188_));
  nand4  g137(.a(new_n184_), .b(new_n170_), .c(new_n158_), .d(new_n148_), .O(new_n189_));
  nor2   g138(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  and2   g139(.a(new_n190_), .b(new_n98_), .O(new_n191_));
  ...
  nand4  g144(.a(new_n96_), .b(new_n77_), .c(new_n61_), .d(new_n52_), .O(new_n196_));
  inv1   g145(.a(new_n196_), .O(new_n197_));
  inv1   g146(.a(x34), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(x33), .O(new_n199_));
  nand3  g148(.a(new_n199_), .b(new_n197_), .c(new_n190_), .O(new_n200_));
  nor2   g149(.a(x32), .b(x31), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n151_), .c(new_n158_), .d(new_n124_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n127_), .c(x33), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n200_), .c(x19), .O(new_n204_));
  and2   g153(.a(new_n63_), .b(x33), .O(new_n205_));
  ...
  oai21  g158(.a(new_n202_), .b(new_n127_), .c(new_n53_), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n64_), .c(new_n198_), .O(new_n211_));
  nor2   g160(.a(x34), .b(x33), .O(new_n212_));
  nand4  g161(.a(new_n212_), .b(new_n177_), .c(new_n131_), .d(new_n184_), .O(new_n213_));
  nor2   g162(.a(new_n213_), .b(new_n107_), .O(new_n214_));
