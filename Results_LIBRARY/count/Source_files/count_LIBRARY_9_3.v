// Benchmark "FAU" written by ABC on Thu Jun 25 18:00:31 2020
...
module FAU ( 
  ...
  nand4  g092(.a(new_n143_), .b(new_n126_), .c(new_n142_), .d(new_n98_), .O(new_n144_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n143_), .c(new_n126_), .d(new_n142_), .O(new_n164_));
  ...
  nand2  g131(.a(new_n151_), .b(new_n117_), .O(new_n183_));
