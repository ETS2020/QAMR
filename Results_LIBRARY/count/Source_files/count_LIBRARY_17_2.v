...
module FAU ( 
  ...
  nand2  g123(.a(new_n130_), .b(new_n102_), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n152_), .O(new_n177_));
  nor4   g126(.a(new_n177_), .b(new_n175_), .c(new_n96_), .d(new_n63_), .O(new_n178_));
  ...
  inv1   g131(.a(new_n78_), .O(new_n183_));
  inv1   g132(.a(x32), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n171_), .c(new_n159_), .O(new_n185_));
  nand3  g134(.a(new_n148_), .b(new_n137_), .c(new_n123_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n125_), .c(new_n95_), .d(new_n183_), .O(new_n188_));
  nand4  g137(.a(new_n176_), .b(new_n149_), .c(new_n148_), .d(new_n112_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n114_), .c(x32), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(x19), .O(new_n191_));
  nor2   g140(.a(new_n64_), .b(new_n184_), .O(new_n192_));
  ...
  nand4  g145(.a(new_n137_), .b(new_n123_), .c(new_n112_), .d(new_n102_), .O(new_n197_));
  nand4  g146(.a(new_n184_), .b(new_n171_), .c(new_n159_), .d(new_n148_), .O(new_n198_));
  nor2   g147(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nand3  g148(.a(new_n199_), .b(new_n97_), .c(new_n64_), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(x33), .O(new_n201_));
  inv1   g150(.a(new_n177_), .O(new_n202_));
  nor2   g151(.a(x33), .b(x32), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n202_), .c(new_n130_), .d(new_n107_), .O(new_n204_));
  ...
  nand2  g159(.a(new_n61_), .b(new_n52_), .O(new_n211_));
  aoi21  g160(.a(x34), .b(new_n210_), .c(new_n211_), .O(new_n212_));
  nand3  g161(.a(new_n212_), .b(new_n199_), .c(new_n97_), .O(new_n213_));
  nor2   g162(.a(x32), .b(x31), .O(new_n214_));
  nand4  g163(.a(new_n214_), .b(new_n152_), .c(new_n159_), .d(new_n123_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n126_), .c(x34), .O(new_n216_));
  aoi21  g165(.a(new_n216_), .b(new_n213_), .c(x19), .O(new_n217_));
  and2   g166(.a(new_n63_), .b(x34), .O(new_n218_));
