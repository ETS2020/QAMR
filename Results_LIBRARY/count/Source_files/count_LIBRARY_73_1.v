...
module FAU ( 
  ...
  nand4  g117(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n168_), .O(new_n169_));
  inv1   g118(.a(new_n169_), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n155_), .c(new_n123_), .d(new_n98_), .O(new_n172_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n142_), .c(new_n125_), .d(new_n141_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n90_), .c(x33), .O(new_n182_));
  inv1   g131(.a(x33), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n171_), .c(new_n168_), .d(new_n123_), .O(new_n184_));
  inv1   g133(.a(new_n184_), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n157_), .c(new_n100_), .d(new_n71_), .O(new_n186_));
  ...
  nand2  g141(.a(new_n186_), .b(new_n192_), .O(new_n193_));
