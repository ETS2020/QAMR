...
module FAU ( 
  ...
  nand4  g066(.a(new_n117_), .b(new_n89_), .c(new_n76_), .d(new_n55_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x27), .O(new_n119_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g069(.a(new_n120_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(x16), .O(new_n123_));
  inv1   g072(.a(x18), .O(new_n124_));
  oai21  g073(.a(x16), .b(x07), .c(new_n124_), .O(new_n125_));
  aoi21  g074(.a(x27), .b(x20), .c(new_n125_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n123_), .O(z08));
  nor2   g076(.a(x28), .b(x27), .O(new_n128_));
  nor2   g077(.a(x26), .b(x23), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n107_), .O(new_n130_));
  nor2   g079(.a(new_n130_), .b(new_n81_), .O(new_n131_));
  aoi21  g080(.a(new_n121_), .b(x28), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n138_));
  oai21  g087(.a(new_n131_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n128_), .c(new_n117_), .d(new_n98_), .O(new_n145_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n120_), .c(new_n91_), .O(new_n156_));
  ...
  nand4  g111(.a(new_n153_), .b(new_n152_), .c(new_n162_), .d(new_n99_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n90_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n144_), .c(new_n128_), .d(new_n117_), .O(new_n166_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n153_), .c(new_n152_), .d(new_n162_), .O(new_n176_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n108_), .c(x34), .O(new_n184_));
  nand2  g133(.a(new_n152_), .b(new_n162_), .O(new_n185_));
