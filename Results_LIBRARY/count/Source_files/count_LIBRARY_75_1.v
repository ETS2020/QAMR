...
module FAU ( 
  ...
  aoi22  g039(.a(new_n90_), .b(new_n63_), .c(new_n86_), .d(x23), .O(new_n91_));
  ...
  aoi21  g053(.a(new_n104_), .b(new_n53_), .c(new_n68_), .O(new_n105_));
  nor2   g054(.a(x25), .b(x24), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n88_), .c(new_n71_), .O(new_n107_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n88_), .c(new_n125_), .d(new_n87_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  aoi21  g077(.a(new_n128_), .b(new_n63_), .c(new_n124_), .O(new_n129_));
  nand2  g078(.a(new_n77_), .b(new_n63_), .O(new_n130_));
  ...
  nor2   g087(.a(x17), .b(new_n58_), .O(new_n139_));
  nor2   g088(.a(x22), .b(x19), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n139_), .c(new_n96_), .d(new_n69_), .O(new_n141_));
  inv1   g090(.a(x06), .O(new_n142_));
  aoi21  g091(.a(new_n58_), .b(new_n142_), .c(x18), .O(new_n143_));
  oai21  g092(.a(new_n141_), .b(new_n138_), .c(new_n143_), .O(z09));
  inv1   g093(.a(x29), .O(new_n145_));
  nor2   g094(.a(x27), .b(x26), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n106_), .c(new_n88_), .d(new_n87_), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n53_), .c(new_n68_), .O(new_n148_));
  nor2   g097(.a(x29), .b(x27), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n106_), .c(new_n113_), .d(new_n114_), .O(new_n150_));
  oai22  g099(.a(new_n150_), .b(new_n130_), .c(new_n148_), .d(new_n145_), .O(new_n151_));
  ...
  nand2  g105(.a(new_n90_), .b(new_n63_), .O(new_n157_));
  nand4  g106(.a(new_n149_), .b(new_n126_), .c(new_n96_), .d(new_n77_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n53_), .c(new_n68_), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n117_), .c(new_n124_), .O(new_n161_));
  ...
  nand2  g116(.a(new_n160_), .b(new_n124_), .O(new_n168_));
  nand3  g117(.a(new_n126_), .b(new_n96_), .c(new_n77_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n168_), .c(new_n53_), .O(new_n170_));
  aoi21  g119(.a(new_n170_), .b(new_n63_), .c(new_n167_), .O(new_n171_));
  nor2   g120(.a(x31), .b(x30), .O(new_n172_));
  nand3  g121(.a(new_n172_), .b(new_n149_), .c(new_n117_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n157_), .O(new_n174_));
  ...
  nand3  g128(.a(new_n172_), .b(new_n146_), .c(new_n145_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n115_), .c(new_n53_), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n63_), .c(new_n179_), .O(new_n182_));
  nor2   g131(.a(x32), .b(x31), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n160_), .c(new_n131_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n97_), .O(new_n185_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n149_), .c(new_n156_), .d(new_n113_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n115_), .c(new_n53_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n63_), .c(new_n190_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n172_), .c(new_n149_), .d(new_n126_), .O(new_n195_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n160_), .c(new_n167_), .d(new_n124_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n127_), .c(new_n53_), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n63_), .c(new_n201_), .O(new_n204_));
  nor2   g153(.a(x34), .b(x33), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n183_), .c(new_n160_), .d(new_n146_), .O(new_n206_));
