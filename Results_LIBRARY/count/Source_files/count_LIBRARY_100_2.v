...
module FAU ( 
  ...
  nand3  g098(.a(new_n89_), .b(new_n76_), .c(new_n55_), .O(new_n150_));
  inv1   g099(.a(x28), .O(new_n151_));
  nand4  g100(.a(new_n143_), .b(new_n117_), .c(new_n151_), .d(new_n99_), .O(new_n152_));
  oai21  g101(.a(new_n152_), .b(new_n150_), .c(x31), .O(new_n153_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n154_), .c(new_n124_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n61_), .O(new_n161_));
  nand3  g110(.a(x31), .b(x20), .c(x16), .O(new_n162_));
  inv1   g111(.a(x03), .O(new_n163_));
  aoi21  g112(.a(new_n58_), .b(new_n163_), .c(x18), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n162_), .c(new_n161_), .O(z12));
  nand4  g114(.a(new_n156_), .b(new_n155_), .c(new_n117_), .d(new_n99_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n90_), .c(x32), .O(new_n167_));
  nor2   g116(.a(x32), .b(x31), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n143_), .c(new_n126_), .d(new_n142_), .O(new_n169_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n156_), .c(new_n155_), .d(new_n117_), .O(new_n179_));
  ...
  nand2  g136(.a(new_n155_), .b(new_n117_), .O(new_n188_));
