...
module FAU ( 
  ...
  nand3  g102(.a(new_n146_), .b(new_n89_), .c(new_n55_), .O(new_n154_));
  inv1   g103(.a(new_n154_), .O(new_n155_));
  inv1   g104(.a(x28), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n96_), .c(new_n69_), .O(new_n157_));
  nor2   g106(.a(new_n157_), .b(new_n126_), .O(new_n158_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n160_), .c(new_n117_), .d(new_n98_), .O(new_n162_));
  ...
  oai21  g114(.a(x16), .b(x03), .c(new_n165_), .O(new_n166_));
  aoi21  g115(.a(x31), .b(x20), .c(new_n166_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n164_), .O(z12));
  oai21  g117(.a(new_n162_), .b(new_n90_), .c(x32), .O(new_n169_));
  nor2   g118(.a(x32), .b(x31), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n146_), .c(new_n129_), .d(new_n145_), .O(new_n171_));
  inv1   g120(.a(new_n171_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n91_), .O(new_n173_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n90_), .c(x33), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n161_), .c(new_n160_), .d(new_n117_), .O(new_n181_));
  ...
  nand2  g138(.a(new_n160_), .b(new_n117_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  inv1   g140(.a(x30), .O(new_n192_));
  nand2  g141(.a(new_n153_), .b(new_n192_), .O(new_n193_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n191_), .c(new_n100_), .O(new_n199_));
