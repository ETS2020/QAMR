...
module FAU ( 
  ...
  nand3  g055(.a(new_n97_), .b(new_n66_), .c(new_n58_), .O(new_n107_));
  oai21  g056(.a(new_n99_), .b(new_n67_), .c(x26), .O(new_n108_));
  ...
  nand3  g065(.a(new_n97_), .b(new_n66_), .c(new_n58_), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n106_), .c(x27), .O(new_n118_));
  ...
  inv1   g072(.a(new_n99_), .O(new_n124_));
  nor3   g073(.a(x28), .b(x27), .c(x26), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n124_), .c(new_n68_), .O(new_n126_));
  inv1   g075(.a(x27), .O(new_n127_));
  nor2   g076(.a(x26), .b(x25), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n127_), .c(new_n84_), .d(new_n88_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n78_), .c(x28), .O(new_n130_));
  ...
  inv1   g085(.a(new_n107_), .O(new_n137_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n98_), .c(new_n105_), .d(new_n88_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n78_), .c(x29), .O(new_n142_));
  ...
  nand3  g097(.a(new_n148_), .b(new_n66_), .c(new_n58_), .O(new_n149_));
  inv1   g098(.a(x28), .O(new_n150_));
  nor2   g099(.a(x27), .b(x26), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n98_), .c(new_n97_), .d(new_n150_), .O(new_n152_));
  nor2   g101(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand4  g102(.a(new_n138_), .b(new_n136_), .c(new_n79_), .d(new_n60_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(x30), .c(new_n153_), .O(new_n155_));
  inv1   g104(.a(x04), .O(new_n156_));
  aoi21  g105(.a(new_n52_), .b(new_n156_), .c(x18), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n52_), .c(new_n157_), .O(z11));
  nand4  g107(.a(new_n97_), .b(new_n58_), .c(new_n86_), .d(new_n57_), .O(new_n159_));
  nand4  g108(.a(new_n148_), .b(new_n140_), .c(new_n98_), .d(new_n105_), .O(new_n160_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n150_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n114_), .c(new_n95_), .d(new_n60_), .O(new_n167_));
  ...
  nor2   g121(.a(new_n107_), .b(new_n106_), .O(new_n173_));
  nand4  g122(.a(new_n136_), .b(new_n97_), .c(new_n66_), .d(new_n58_), .O(new_n174_));
  nor2   g123(.a(x31), .b(x30), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n162_), .c(new_n150_), .d(new_n127_), .O(new_n176_));
  aoi22  g125(.a(new_n176_), .b(new_n173_), .c(new_n174_), .d(x32), .O(new_n177_));
  inv1   g126(.a(x02), .O(new_n178_));
  aoi21  g127(.a(new_n52_), .b(new_n178_), .c(x18), .O(new_n179_));
  oai21  g128(.a(new_n177_), .b(new_n52_), .c(new_n179_), .O(z13));
