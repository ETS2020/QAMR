...
module FAU ( 
  ...
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n97_), .O(new_n126_));
  ...
  nand4  g088(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n140_));
  nor2   g089(.a(x26), .b(x25), .O(new_n141_));
  nor2   g090(.a(x30), .b(x29), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n125_), .c(new_n141_), .d(new_n87_), .O(new_n143_));
  nor2   g092(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  aoi21  g093(.a(new_n134_), .b(x30), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x31), .O(new_n149_));
  nand4  g098(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n150_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n121_), .c(new_n151_), .d(new_n63_), .O(new_n158_));
  ...
  nand4  g114(.a(new_n165_), .b(new_n164_), .c(new_n114_), .d(new_n98_), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n90_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(x32), .c(x16), .O(new_n168_));
  inv1   g117(.a(x02), .O(new_n169_));
  aoi21  g118(.a(new_n58_), .b(new_n169_), .c(x18), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n168_), .O(z13));
  oai21  g120(.a(new_n166_), .b(new_n90_), .c(x33), .O(new_n172_));
  inv1   g121(.a(x27), .O(new_n173_));
  nand4  g122(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n173_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  inv1   g124(.a(x33), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n155_), .c(new_n123_), .d(new_n98_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n175_), .c(new_n151_), .d(new_n63_), .O(new_n179_));
  ...
  nor2   g133(.a(x33), .b(x31), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n142_), .c(new_n125_), .d(new_n141_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n90_), .c(x34), .O(new_n187_));
  inv1   g136(.a(x34), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n176_), .c(new_n173_), .d(new_n123_), .O(new_n189_));
  inv1   g138(.a(new_n189_), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n157_), .c(new_n100_), .d(new_n71_), .O(new_n191_));
