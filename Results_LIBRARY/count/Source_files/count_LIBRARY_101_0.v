...
module FAU ( 
  ...
  nand4  g033(.a(new_n84_), .b(new_n58_), .c(new_n83_), .d(new_n57_), .O(new_n85_));
  and2   g034(.a(new_n85_), .b(x24), .O(new_n86_));
  ...
  oai21  g042(.a(new_n88_), .b(new_n65_), .c(x25), .O(new_n94_));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n84_), .c(new_n66_), .d(new_n58_), .O(new_n96_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n84_), .c(new_n66_), .d(new_n58_), .O(new_n104_));
  ...
  nand4  g067(.a(new_n118_), .b(new_n87_), .c(new_n72_), .d(new_n60_), .O(new_n119_));
  nor2   g068(.a(x28), .b(x27), .O(new_n120_));
  nor2   g069(.a(x26), .b(x23), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n120_), .c(new_n95_), .O(new_n122_));
  ...
  oai21  g076(.a(new_n122_), .b(new_n77_), .c(x29), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n103_), .c(new_n78_), .d(new_n60_), .O(new_n130_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n120_), .c(new_n95_), .d(new_n136_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n85_), .O(new_n139_));
  aoi21  g088(.a(new_n130_), .b(x30), .c(new_n139_), .O(new_n140_));
  ...
  oai21  g095(.a(new_n144_), .b(new_n139_), .c(new_n146_), .O(z12));
  aoi21  g096(.a(x32), .b(x16), .c(x18), .O(new_n148_));
  oai21  g097(.a(x16), .b(x02), .c(new_n148_), .O(z13));
  aoi21  g098(.a(x33), .b(x16), .c(x18), .O(new_n150_));
  oai21  g099(.a(x16), .b(x01), .c(new_n150_), .O(z14));
  aoi21  g100(.a(x34), .b(x16), .c(x18), .O(new_n152_));
  oai21  g101(.a(x16), .b(x00), .c(new_n152_), .O(z15));
endmodule
