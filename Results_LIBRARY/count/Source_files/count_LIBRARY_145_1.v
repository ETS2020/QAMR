...
module FAU ( 
  ...
  aoi22  g029(.a(new_n80_), .b(new_n63_), .c(new_n70_), .d(x23), .O(new_n81_));
  ...
  nor3   g034(.a(x24), .b(x23), .c(x21), .O(new_n86_));
  ...
  aoi22  g053(.a(new_n104_), .b(new_n71_), .c(new_n94_), .d(x26), .O(new_n105_));
  ...
  oai21  g057(.a(new_n103_), .b(new_n70_), .c(x27), .O(new_n109_));
  ...
  nand4  g092(.a(new_n110_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n91_), .b(new_n101_), .c(new_n100_), .d(new_n69_), .O(new_n154_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n161_), .c(new_n104_), .d(new_n71_), .O(new_n190_));
