...
module FAU ( 
  ...
  nand4  g092(.a(new_n143_), .b(new_n108_), .c(new_n115_), .d(new_n87_), .O(new_n144_));
  ...
  nand4  g098(.a(new_n95_), .b(new_n77_), .c(new_n61_), .d(new_n52_), .O(new_n150_));
  inv1   g099(.a(x30), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(x29), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n143_), .c(new_n128_), .O(new_n153_));
  nand4  g102(.a(new_n143_), .b(new_n128_), .c(new_n95_), .d(new_n77_), .O(new_n154_));
  ...
  nor2   g106(.a(new_n64_), .b(new_n157_), .O(new_n158_));
  aoi21  g107(.a(new_n156_), .b(new_n53_), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g111(.a(new_n154_), .b(new_n53_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n64_), .c(new_n151_), .O(new_n164_));
  nand2  g113(.a(new_n89_), .b(new_n64_), .O(new_n165_));
  nor2   g114(.a(x30), .b(x29), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n143_), .c(new_n118_), .O(new_n167_));
  ...
  oai21  g123(.a(new_n174_), .b(new_n116_), .c(new_n53_), .O(new_n175_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n177_), .c(new_n133_), .d(new_n104_), .O(new_n179_));
  ...
  nand4  g134(.a(new_n178_), .b(new_n143_), .c(new_n157_), .d(new_n115_), .O(new_n186_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n166_), .c(new_n143_), .d(new_n128_), .O(new_n190_));
  ...
  nand4  g145(.a(new_n189_), .b(new_n177_), .c(new_n151_), .d(new_n125_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n129_), .c(new_n53_), .O(new_n198_));
  aoi21  g147(.a(new_n198_), .b(new_n64_), .c(new_n196_), .O(new_n199_));
  nand2  g148(.a(new_n177_), .b(new_n133_), .O(new_n200_));
  ...
  nand4  g157(.a(new_n201_), .b(new_n178_), .c(new_n177_), .d(new_n125_), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n129_), .c(new_n53_), .O(new_n210_));
