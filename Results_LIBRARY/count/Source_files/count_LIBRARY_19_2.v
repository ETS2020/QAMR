// Benchmark "FAU" written by ABC on Thu Jun 25 18:00:33 2020
...
module FAU ( 
  ...
  inv1   g129(.a(new_n101_), .O(new_n181_));
  nor3   g130(.a(x21), .b(x19), .c(x17), .O(new_n182_));
  nand2  g131(.a(new_n136_), .b(new_n118_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n155_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n184_), .c(new_n182_), .d(new_n181_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n180_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n61_), .O(new_n190_));
  nor2   g139(.a(new_n61_), .b(new_n58_), .O(new_n191_));
  inv1   g140(.a(x18), .O(new_n192_));
  oai21  g141(.a(x16), .b(x01), .c(new_n192_), .O(new_n193_));
  aoi21  g142(.a(new_n191_), .b(x33), .c(new_n193_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n190_), .O(z14));
  nand4  g144(.a(new_n185_), .b(new_n155_), .c(new_n136_), .d(new_n118_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n109_), .c(x34), .O(new_n197_));
  ...
  nand3  g154(.a(new_n205_), .b(new_n184_), .c(new_n102_), .O(new_n206_));
