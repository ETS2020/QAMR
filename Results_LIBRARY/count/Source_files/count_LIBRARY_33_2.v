...
module FAU ( 
  ...
  oai21  g033(.a(new_n84_), .b(new_n82_), .c(new_n61_), .O(new_n85_));
  nand3  g034(.a(x23), .b(x20), .c(x16), .O(new_n86_));
  ...
  aoi21  g039(.a(new_n83_), .b(new_n63_), .c(new_n90_), .O(new_n91_));
  nor2   g040(.a(x24), .b(x23), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n76_), .c(new_n55_), .d(new_n61_), .O(new_n93_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n90_), .c(new_n81_), .d(new_n99_), .O(new_n101_));
  ...
  nand3  g067(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n119_));
  nor2   g068(.a(x27), .b(x26), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n92_), .c(new_n100_), .O(new_n121_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n92_), .c(new_n76_), .d(new_n63_), .O(new_n128_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n112_), .c(new_n83_), .d(new_n63_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n108_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n145_));
  nor2   g094(.a(x26), .b(x25), .O(new_n146_));
  nor2   g095(.a(x30), .b(x29), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n129_), .c(new_n146_), .d(new_n90_), .O(new_n148_));
  ...
  nand4  g113(.a(new_n156_), .b(new_n155_), .c(new_n120_), .d(new_n100_), .O(new_n165_));
  ...
  nand3  g145(.a(new_n196_), .b(new_n188_), .c(new_n102_), .O(new_n197_));
