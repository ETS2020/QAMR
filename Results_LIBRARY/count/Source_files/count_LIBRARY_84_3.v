...
module FAU ( 
  ...
  nand4  g093(.a(new_n144_), .b(new_n126_), .c(new_n143_), .d(new_n98_), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  aoi21  g095(.a(new_n142_), .b(x30), .c(new_n146_), .O(new_n147_));
  inv1   g096(.a(x18), .O(new_n148_));
  oai21  g097(.a(x16), .b(x04), .c(new_n148_), .O(new_n149_));
  aoi21  g098(.a(x30), .b(x20), .c(new_n149_), .O(new_n150_));
  oai21  g099(.a(new_n147_), .b(new_n58_), .c(new_n150_), .O(z11));
  oai21  g100(.a(new_n145_), .b(new_n88_), .c(x31), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nor2   g102(.a(x31), .b(x30), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  inv1   g104(.a(new_n155_), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n124_), .c(new_n91_), .O(new_n157_));
  ...
  nand4  g111(.a(new_n154_), .b(new_n153_), .c(new_n117_), .d(new_n99_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n90_), .c(x32), .O(new_n164_));
  nor2   g113(.a(x32), .b(x31), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n144_), .c(new_n126_), .d(new_n143_), .O(new_n166_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n154_), .c(new_n153_), .d(new_n117_), .O(new_n176_));
  ...
  nand2  g133(.a(new_n153_), .b(new_n117_), .O(new_n185_));
