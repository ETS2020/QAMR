...
module FAU ( 
  ...
  nand2  g133(.a(new_n184_), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n139_), .b(new_n125_), .c(new_n114_), .d(new_n104_), .O(new_n186_));
  nand3  g135(.a(new_n171_), .b(new_n159_), .c(new_n149_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g137(.a(new_n188_), .b(new_n185_), .c(new_n183_), .O(new_n189_));
  nand4  g138(.a(new_n175_), .b(new_n142_), .c(new_n149_), .d(new_n114_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n116_), .c(x32), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(x19), .O(new_n192_));
  and2   g141(.a(new_n63_), .b(x32), .O(new_n193_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n116_), .c(new_n53_), .O(new_n198_));
  aoi21  g147(.a(new_n198_), .b(new_n64_), .c(new_n184_), .O(new_n199_));
  nand2  g148(.a(new_n152_), .b(new_n132_), .O(new_n200_));
  ...
  nand4  g157(.a(new_n201_), .b(new_n175_), .c(new_n152_), .d(new_n125_), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n128_), .c(new_n53_), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n64_), .c(new_n208_), .O(new_n211_));
  nand3  g160(.a(new_n201_), .b(new_n175_), .c(new_n208_), .O(new_n212_));
  nor3   g161(.a(new_n212_), .b(new_n200_), .c(new_n108_), .O(new_n213_));
