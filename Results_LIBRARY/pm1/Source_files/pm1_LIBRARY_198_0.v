// Benchmark "FAU" written by ABC on Thu Jun 25 16:34:41 2020
...
module FAU ( 
  ...
  nand3  g27(.a(new_n56_), .b(new_n54_), .c(z01), .O(z08));
  nand2  g28(.a(new_n56_), .b(x11), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(z09));
  inv1   g30(.a(x10), .O(new_n60_));
  nand3  g31(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  nand4  g32(.a(new_n61_), .b(x11), .c(new_n60_), .d(x09), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n55_), .O(z10));
  nand2  g34(.a(x01), .b(x00), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n62_), .O(z11));
  nand3  g36(.a(new_n56_), .b(x11), .c(new_n50_), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(z12));
endmodule
