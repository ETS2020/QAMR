...
module FAU ( 
  ...
  and2   g18(.a(z01), .b(x04), .O(new_n48_));
  ...
  nor2   g27(.a(new_n38_), .b(x09), .O(new_n57_));
  nor2   g28(.a(x12), .b(x11), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nand3  g30(.a(x12), .b(x11), .c(x09), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(x10), .O(z09));
  nand3  g32(.a(x11), .b(new_n52_), .c(x09), .O(new_n62_));
  nor3   g33(.a(new_n62_), .b(new_n54_), .c(new_n32_), .O(z10));
  nand4  g34(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand3  g35(.a(new_n32_), .b(new_n30_), .c(x00), .O(new_n65_));
  nand2  g36(.a(x11), .b(new_n52_), .O(new_n66_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z11));
  nand2  g38(.a(new_n52_), .b(x00), .O(new_n68_));
