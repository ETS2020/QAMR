// Benchmark "FAU" written by ABC on Thu Jun 25 16:34:57 2020
...
module FAU ( 
  ...
  nor2   g25(.a(x11), .b(new_n54_), .O(new_n55_));
  aoi21  g26(.a(new_n55_), .b(new_n32_), .c(new_n53_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(z01), .c(new_n50_), .d(x00), .O(z08));
  nand2  g28(.a(new_n55_), .b(new_n32_), .O(new_n58_));
  nand2  g29(.a(x12), .b(x11), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n58_), .c(x10), .O(z09));
  nand2  g31(.a(new_n51_), .b(x12), .O(new_n61_));
  nand3  g32(.a(x11), .b(new_n50_), .c(x09), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n61_), .O(z10));
  nand4  g34(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  nand3  g35(.a(new_n32_), .b(new_n30_), .c(x00), .O(new_n65_));
  nand2  g36(.a(x11), .b(new_n50_), .O(new_n66_));
  aoi21  g37(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z11));
  inv1   g38(.a(x09), .O(new_n68_));
  nand4  g39(.a(x12), .b(x11), .c(new_n50_), .d(new_n68_), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z12));
endmodule
