...
module FAU ( 
  ...
  oai21  g24(.a(new_n51_), .b(new_n38_), .c(new_n53_), .O(z08));
  inv1   g25(.a(x00), .O(new_n55_));
  nand2  g26(.a(x12), .b(x11), .O(new_n56_));
  inv1   g27(.a(x10), .O(new_n57_));
  nand3  g28(.a(new_n32_), .b(new_n31_), .c(new_n57_), .O(new_n58_));
  aoi21  g29(.a(new_n58_), .b(new_n56_), .c(new_n55_), .O(z09));
  ...
  aoi21  g36(.a(new_n65_), .b(new_n64_), .c(new_n52_), .O(z11));
  inv1   g37(.a(x09), .O(new_n67_));
  nand3  g38(.a(new_n53_), .b(x12), .c(new_n67_), .O(new_n68_));
