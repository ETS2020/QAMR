// Benchmark "FAU" written by ABC on Thu Jun 25 16:34:50 2020
...
module FAU ( 
  ...
  aoi21  g32(.a(new_n61_), .b(new_n56_), .c(new_n58_), .O(z09));
  nand2  g33(.a(new_n51_), .b(x12), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n57_), .c(x09), .d(x00), .O(new_n64_));
  ...
  nand3  g38(.a(x11), .b(new_n57_), .c(x00), .O(new_n68_));
  aoi21  g39(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(z11));
