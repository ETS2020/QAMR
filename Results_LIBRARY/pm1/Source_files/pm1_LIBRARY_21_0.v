...
module FAU ( 
  ...
  oai21  g32(.a(new_n61_), .b(new_n55_), .c(x00), .O(new_n62_));
  inv1   g33(.a(x09), .O(new_n63_));
  nand2  g34(.a(new_n53_), .b(new_n63_), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n62_), .c(x10), .O(z09));
  nand2  g36(.a(new_n51_), .b(x12), .O(new_n66_));
  nand3  g37(.a(new_n58_), .b(x11), .c(x09), .O(new_n67_));
  ...
  nand2  g41(.a(new_n58_), .b(x11), .O(new_n71_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z11));
  nor2   g43(.a(x10), .b(x09), .O(new_n73_));
