...
module FAU ( 
  ...
  nor2   g0062(.a(x30), .b(new_n138_), .O(new_n139_));
  ...
  oai21  g0330(.a(x30), .b(new_n138_), .c(new_n113_), .O(new_n407_));
  ...
  nor2   g0342(.a(x30), .b(new_n138_), .O(new_n419_));
  ...
  nor2   g0759(.a(x31), .b(x30), .O(new_n836_));
