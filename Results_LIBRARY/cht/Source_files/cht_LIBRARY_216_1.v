// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:36 2020
...
module FAU ( 
  ...
  inv1   g035(.a(x10), .O(new_n119_));
  nand3  g036(.a(x22), .b(new_n119_), .c(new_n103_), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z11));
  nand3  g038(.a(x24), .b(new_n119_), .c(x08), .O(new_n122_));
