...
module FAU ( 
  ...
  inv1   g039(.a(x10), .O(new_n123_));
  nand3  g040(.a(x23), .b(new_n123_), .c(new_n103_), .O(new_n124_));
  oai21  g041(.a(new_n122_), .b(new_n103_), .c(new_n124_), .O(z12));
  nand3  g042(.a(x25), .b(new_n123_), .c(x08), .O(new_n126_));
  oai21  g043(.a(new_n122_), .b(x08), .c(new_n126_), .O(z13));
