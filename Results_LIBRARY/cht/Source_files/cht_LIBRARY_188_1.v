...
module FAU ( 
  ...
  inv1   g102(.a(x10), .O(new_n186_));
  nand2  g103(.a(x42), .b(new_n186_), .O(new_n187_));
  nor2   g104(.a(new_n187_), .b(new_n177_), .O(z31));
  nand3  g105(.a(new_n177_), .b(x44), .c(new_n186_), .O(new_n189_));
