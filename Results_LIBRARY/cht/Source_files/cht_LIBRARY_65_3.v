...
module FAU ( 
  ...
  inv1   g079(.a(x10), .O(new_n163_));
  nand3  g080(.a(x36), .b(new_n163_), .c(new_n146_), .O(new_n164_));
  oai21  g081(.a(new_n162_), .b(new_n146_), .c(new_n164_), .O(z25));
  nand3  g082(.a(x38), .b(new_n163_), .c(x09), .O(new_n166_));
  oai21  g083(.a(new_n162_), .b(x09), .c(new_n166_), .O(z26));
