// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:44 2020
...
module FAU ( 
  ...
  inv1   g057(.a(x10), .O(new_n141_));
  nand3  g058(.a(x29), .b(new_n141_), .c(new_n103_), .O(new_n142_));
  oai21  g059(.a(new_n140_), .b(new_n103_), .c(new_n142_), .O(z18));
  nand2  g060(.a(x08), .b(x00), .O(new_n144_));
  oai22  g061(.a(new_n144_), .b(x10), .c(new_n140_), .d(x08), .O(z19));
