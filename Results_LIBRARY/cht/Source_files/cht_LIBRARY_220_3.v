...
module FAU ( 
  ...
  inv1   g109(.a(x10), .O(new_n193_));
  nand3  g110(.a(new_n175_), .b(x44), .c(new_n193_), .O(new_n194_));
  oai21  g111(.a(new_n175_), .b(new_n192_), .c(new_n194_), .O(z33));
  nand3  g112(.a(new_n177_), .b(x46), .c(new_n193_), .O(new_n196_));
  oai21  g113(.a(new_n177_), .b(new_n192_), .c(new_n196_), .O(z34));
