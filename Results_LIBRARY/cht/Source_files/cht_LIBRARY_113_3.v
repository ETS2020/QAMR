...
module FAU ( 
  ...
  nand2  g062(.a(new_n145_), .b(new_n143_), .O(z19));
  ...
  nor2   g085(.a(x14), .b(x10), .O(new_n169_));
  aoi22  g086(.a(new_n169_), .b(x39), .c(x14), .d(x00), .O(new_n170_));
  nand3  g087(.a(x38), .b(new_n144_), .c(new_n147_), .O(new_n171_));
  oai21  g088(.a(new_n170_), .b(new_n147_), .c(new_n171_), .O(z27));
  inv1   g089(.a(x14), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x39), .O(new_n175_));
  nor2   g092(.a(x14), .b(new_n147_), .O(new_n176_));
  ...
  nand3  g113(.a(new_n174_), .b(x46), .c(new_n144_), .O(new_n197_));
  nand2  g114(.a(new_n176_), .b(x00), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n197_), .O(z35));
endmodule
