...
module FAU ( 
  ...
  inv1   g108(.a(x10), .O(new_n192_));
  nand2  g109(.a(x44), .b(new_n192_), .O(new_n193_));
  nor2   g110(.a(new_n193_), .b(new_n177_), .O(z33));
  nand3  g111(.a(new_n177_), .b(x46), .c(new_n192_), .O(new_n195_));
