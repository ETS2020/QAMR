// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:28 2020
...
module FAU ( 
  ...
  inv1   g070(.a(x10), .O(new_n154_));
  nand3  g071(.a(x33), .b(new_n154_), .c(new_n146_), .O(new_n155_));
  oai21  g072(.a(new_n153_), .b(new_n146_), .c(new_n155_), .O(z22));
  nand3  g073(.a(x35), .b(new_n154_), .c(x09), .O(new_n157_));
  oai21  g074(.a(new_n153_), .b(x09), .c(new_n157_), .O(z23));
