...
module FAU ( 
  ...
  inv1   g103(.a(x10), .O(new_n187_));
  nand3  g104(.a(new_n175_), .b(x42), .c(new_n187_), .O(new_n188_));
  oai21  g105(.a(new_n175_), .b(new_n186_), .c(new_n188_), .O(z31));
  nand3  g106(.a(new_n177_), .b(x44), .c(new_n187_), .O(new_n190_));
  oai21  g107(.a(new_n177_), .b(new_n186_), .c(new_n190_), .O(z32));
