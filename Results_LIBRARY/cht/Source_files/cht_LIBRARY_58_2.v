// Benchmark "FAU" written by ABC on Thu Jun 25 19:30:35 2020
...
module FAU ( 
  ...
  nor2   g046(.a(new_n129_), .b(x10), .O(z19));
  ...
  nor2   g078(.a(x14), .b(new_n131_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(x40), .O(new_n163_));
  aoi21  g080(.a(new_n163_), .b(new_n161_), .c(x10), .O(z28));
  nand2  g081(.a(new_n160_), .b(x40), .O(new_n165_));
  nand2  g082(.a(new_n162_), .b(x41), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n165_), .c(x10), .O(z29));
  nand2  g084(.a(new_n160_), .b(x41), .O(new_n168_));
  nand2  g085(.a(new_n162_), .b(x42), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z30));
  nand2  g087(.a(new_n160_), .b(x42), .O(new_n171_));
  nand2  g088(.a(new_n162_), .b(x43), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n171_), .c(x10), .O(z31));
  nand2  g090(.a(new_n160_), .b(x43), .O(new_n174_));
  nand2  g091(.a(new_n162_), .b(x44), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z32));
  nand2  g093(.a(new_n160_), .b(x44), .O(new_n177_));
  nand2  g094(.a(new_n162_), .b(x45), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z33));
  nand2  g096(.a(new_n160_), .b(x45), .O(new_n180_));
  nand2  g097(.a(new_n162_), .b(x46), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z34));
  nand2  g099(.a(new_n160_), .b(x46), .O(new_n183_));
  nand2  g100(.a(new_n162_), .b(x00), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z35));
endmodule
