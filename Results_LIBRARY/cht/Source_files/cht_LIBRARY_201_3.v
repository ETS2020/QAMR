// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:30 2020
...
module FAU ( 
  ...
  nand3  g046(.a(x25), .b(new_n129_), .c(new_n103_), .O(new_n130_));
  oai21  g047(.a(new_n128_), .b(new_n103_), .c(new_n130_), .O(z14));
  nand3  g048(.a(x27), .b(new_n129_), .c(x08), .O(new_n132_));
  oai21  g049(.a(new_n128_), .b(x08), .c(new_n132_), .O(z15));
