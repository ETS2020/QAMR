...
module FAU ( 
  ...
  nand4  g28(.a(new_n49_), .b(new_n48_), .c(new_n73_), .d(new_n72_), .O(new_n74_));
  nor2   g29(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  nor2   g30(.a(x20), .b(new_n50_), .O(new_n76_));
  nor2   g31(.a(x22), .b(x21), .O(new_n77_));
  nand4  g32(.a(new_n77_), .b(new_n76_), .c(new_n49_), .d(x18), .O(new_n78_));
  ...
  nand2  g37(.a(new_n50_), .b(new_n82_), .O(new_n83_));
  nand3  g38(.a(x24), .b(x22), .c(x21), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(new_n85_));
  nor2   g40(.a(x25), .b(x24), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  aoi21  g42(.a(new_n85_), .b(new_n80_), .c(new_n87_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n79_), .O(z08));
  nor2   g44(.a(x15), .b(x07), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand3  g47(.a(new_n90_), .b(new_n54_), .c(new_n80_), .O(new_n93_));
  ...
  oai21  g52(.a(new_n82_), .b(new_n80_), .c(x19), .O(new_n98_));
  nor2   g53(.a(new_n82_), .b(new_n80_), .O(new_n99_));
  ...
  nand2  g61(.a(new_n73_), .b(x20), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n99_), .c(new_n72_), .d(x19), .O(new_n108_));
  nand2  g63(.a(new_n71_), .b(x21), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n106_), .O(z14));
  inv1   g65(.a(new_n102_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n77_), .c(new_n70_), .O(new_n112_));
  nand3  g67(.a(new_n99_), .b(new_n72_), .c(x19), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n106_), .O(z15));
  nand2  g70(.a(new_n112_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x22), .b(x20), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n111_), .c(new_n48_), .d(new_n72_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  nor2   g75(.a(new_n105_), .b(new_n75_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n120_), .O(z17));
  inv1   g77(.a(new_n71_), .O(new_n123_));
  nand4  g78(.a(new_n86_), .b(new_n77_), .c(new_n123_), .d(new_n48_), .O(new_n124_));
  oai21  g79(.a(new_n74_), .b(new_n71_), .c(x25), .O(new_n125_));
