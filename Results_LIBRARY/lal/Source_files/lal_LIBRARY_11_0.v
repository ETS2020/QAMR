// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:31 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n94_, new_n96_;
  ...
  nor2   g39(.a(new_n52_), .b(new_n51_), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n74_), .c(new_n58_), .d(x17), .O(z13));
  nor2   g41(.a(z09), .b(x07), .O(new_n87_));
  nor2   g42(.a(x21), .b(x15), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(z14));
  nor2   g44(.a(x22), .b(x15), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n87_), .O(z15));
  nor2   g46(.a(x23), .b(x15), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n87_), .O(z16));
  nor2   g48(.a(x24), .b(x15), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n87_), .O(z17));
  nor2   g50(.a(x25), .b(x15), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n87_), .O(z18));
  buf    g52(.a(x16), .O(z02));
endmodule
