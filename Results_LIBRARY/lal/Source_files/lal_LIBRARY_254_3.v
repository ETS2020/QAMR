...
module FAU ( 
  ...
  nand3  g68(.a(new_n113_), .b(new_n73_), .c(new_n71_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z15));
  nand2  g70(.a(new_n73_), .b(new_n71_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n103_), .c(x23), .O(new_n117_));
  inv1   g72(.a(x22), .O(new_n118_));
  nand3  g73(.a(new_n106_), .b(new_n48_), .c(new_n118_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n113_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n117_), .c(new_n111_), .O(z16));
