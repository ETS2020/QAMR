...
module FAU ( 
  ...
  nor2   g36(.a(new_n51_), .b(new_n50_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(x19), .O(new_n84_));
  nand3  g39(.a(new_n52_), .b(x18), .c(x17), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n84_), .c(new_n80_), .O(z12));
  oai21  g41(.a(new_n83_), .b(new_n52_), .c(x20), .O(new_n87_));
  nor2   g42(.a(x20), .b(new_n52_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n82_), .O(new_n89_));
  nand2  g44(.a(new_n74_), .b(new_n58_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n89_), .c(new_n87_), .O(z13));
  inv1   g47(.a(x21), .O(new_n93_));
  nand3  g48(.a(new_n88_), .b(new_n82_), .c(new_n93_), .O(new_n94_));
  nand2  g49(.a(new_n89_), .b(x21), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z14));
  nor4   g51(.a(new_n59_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n97_));
  nand3  g52(.a(new_n88_), .b(new_n82_), .c(x21), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n97_), .c(new_n74_), .d(new_n49_), .O(z15));
  inv1   g54(.a(x07), .O(new_n100_));
  inv1   g55(.a(x15), .O(new_n101_));
  inv1   g56(.a(x23), .O(new_n102_));
  nand4  g57(.a(new_n58_), .b(new_n102_), .c(new_n101_), .d(new_n100_), .O(z16));
  inv1   g58(.a(x24), .O(new_n104_));
  nand4  g59(.a(new_n58_), .b(new_n104_), .c(new_n101_), .d(new_n100_), .O(z17));
  nand4  g60(.a(new_n58_), .b(new_n48_), .c(new_n101_), .d(new_n100_), .O(z18));
  buf    g61(.a(x16), .O(z02));
endmodule
