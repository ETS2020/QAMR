...
module FAU ( 
  ...
  inv1   g11(.a(x15), .O(new_n57_));
  oai21  g12(.a(x07), .b(new_n56_), .c(new_n57_), .O(new_n58_));
  aoi21  g13(.a(new_n58_), .b(x05), .c(x07), .O(new_n59_));
  oai21  g14(.a(new_n55_), .b(x25), .c(new_n59_), .O(z01));
  nor2   g15(.a(new_n55_), .b(x25), .O(z03));
  ...
  nand4  g28(.a(new_n73_), .b(x19), .c(x18), .d(x17), .O(new_n74_));
  nor2   g29(.a(x22), .b(x21), .O(new_n75_));
  nand3  g30(.a(new_n75_), .b(new_n49_), .c(new_n48_), .O(new_n76_));
  nor2   g31(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand4  g32(.a(new_n75_), .b(new_n49_), .c(x19), .d(x18), .O(new_n78_));
  ...
  oai21  g40(.a(new_n85_), .b(new_n84_), .c(new_n81_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n80_), .O(new_n87_));
  aoi21  g42(.a(new_n85_), .b(new_n81_), .c(new_n73_), .O(new_n88_));
  nor2   g43(.a(x25), .b(x24), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(new_n48_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n87_), .c(new_n79_), .O(z08));
  nor2   g47(.a(x15), .b(x07), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(x05), .c(x04), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  oai21  g50(.a(x15), .b(x05), .c(x04), .O(new_n96_));
  nor2   g51(.a(x17), .b(x07), .O(new_n97_));
  and2   g52(.a(new_n97_), .b(new_n96_), .O(z10));
  ...
  nand2  g57(.a(new_n96_), .b(new_n99_), .O(new_n103_));
  oai21  g58(.a(new_n82_), .b(new_n80_), .c(x19), .O(new_n104_));
  nor2   g59(.a(new_n82_), .b(new_n80_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n83_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z12));
  nand2  g62(.a(new_n105_), .b(x19), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x20), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n94_), .c(new_n74_), .d(new_n93_), .O(z13));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n94_), .b(new_n93_), .O(new_n113_));
  aoi21  g68(.a(new_n74_), .b(x21), .c(new_n113_), .O(new_n114_));
  oai21  g69(.a(new_n112_), .b(new_n108_), .c(new_n114_), .O(z14));
  inv1   g70(.a(new_n113_), .O(new_n116_));
  oai21  g71(.a(new_n112_), .b(new_n108_), .c(x22), .O(new_n117_));
  inv1   g72(.a(new_n108_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n75_), .c(new_n73_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n116_), .O(z15));
  nand2  g75(.a(new_n75_), .b(new_n73_), .O(new_n121_));
  oai21  g76(.a(new_n121_), .b(new_n108_), .c(x23), .O(new_n122_));
  nand3  g77(.a(new_n111_), .b(new_n48_), .c(new_n52_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n118_), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n122_), .c(new_n116_), .O(z16));
  inv1   g81(.a(new_n77_), .O(new_n127_));
  oai21  g82(.a(new_n123_), .b(new_n108_), .c(x24), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n116_), .c(new_n127_), .O(z17));
  inv1   g84(.a(new_n74_), .O(new_n130_));
  nand4  g85(.a(new_n89_), .b(new_n75_), .c(new_n130_), .d(new_n48_), .O(new_n131_));
  nand2  g86(.a(new_n127_), .b(x25), .O(new_n132_));
  nand3  g87(.a(new_n132_), .b(new_n131_), .c(new_n116_), .O(z18));
  buf    g88(.a(x16), .O(z02));
endmodule
