// Benchmark "FAU" written by ABC on Thu Jun 25 18:08:16 2020
...
module FAU ( 
  ...
  nand3  g47(.a(new_n92_), .b(new_n56_), .c(new_n79_), .O(new_n93_));
  ...
  nand4  g59(.a(new_n104_), .b(new_n73_), .c(new_n58_), .d(new_n102_), .O(z13));
  nand2  g60(.a(new_n58_), .b(new_n102_), .O(new_n106_));
  ...
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n107_), .O(z14));
  inv1   g67(.a(new_n110_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n103_), .c(x22), .O(new_n114_));
  nand3  g69(.a(new_n109_), .b(new_n74_), .c(new_n72_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n107_), .O(z15));
  nand2  g71(.a(new_n74_), .b(new_n72_), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n103_), .c(x23), .O(new_n118_));
  nand3  g73(.a(new_n110_), .b(new_n48_), .c(new_n52_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n109_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n118_), .c(new_n107_), .O(z16));
  inv1   g77(.a(new_n76_), .O(new_n123_));
  oai21  g78(.a(new_n119_), .b(new_n103_), .c(x24), .O(new_n124_));
  oai21  g79(.a(new_n56_), .b(x07), .c(new_n92_), .O(new_n125_));
  inv1   g80(.a(new_n125_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(z17));
  inv1   g82(.a(new_n73_), .O(new_n128_));
  nand4  g83(.a(new_n88_), .b(new_n74_), .c(new_n128_), .d(new_n48_), .O(new_n129_));
  nand2  g84(.a(new_n123_), .b(x25), .O(new_n130_));
  nand3  g85(.a(new_n130_), .b(new_n129_), .c(new_n107_), .O(z18));
  buf    g86(.a(x16), .O(z02));
endmodule
