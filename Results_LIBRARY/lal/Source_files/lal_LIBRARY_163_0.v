...
module FAU ( 
  ...
  nand2  g28(.a(x18), .b(x17), .O(new_n74_));
  ...
  nand4  g37(.a(new_n82_), .b(new_n78_), .c(new_n77_), .d(x18), .O(new_n83_));
  ...
  oai21  g57(.a(new_n51_), .b(new_n50_), .c(new_n102_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z12));
  nand2  g59(.a(new_n74_), .b(x20), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n94_), .c(new_n76_), .d(new_n58_), .O(z13));
  nand2  g61(.a(new_n76_), .b(x21), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n75_), .O(new_n109_));
  ...
  inv1   g67(.a(new_n76_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n78_), .c(new_n77_), .O(new_n114_));
  aoi21  g69(.a(new_n109_), .b(x22), .c(new_n110_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(z15));
  nand2  g71(.a(new_n114_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n113_), .c(new_n77_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n111_), .O(z16));
  nand2  g75(.a(new_n119_), .b(x24), .O(new_n121_));
  nand4  g76(.a(new_n108_), .b(new_n79_), .c(new_n75_), .d(new_n78_), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n111_), .O(z17));
  oai21  g78(.a(new_n80_), .b(new_n76_), .c(x25), .O(new_n124_));
  inv1   g79(.a(new_n109_), .O(new_n125_));
  nand4  g80(.a(new_n118_), .b(new_n125_), .c(new_n48_), .d(new_n82_), .O(new_n126_));
