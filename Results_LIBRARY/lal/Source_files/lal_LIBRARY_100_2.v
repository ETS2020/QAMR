...
module FAU ( 
  ...
  nand2  g50(.a(x19), .b(x07), .O(new_n96_));
  ...
  nor2   g56(.a(new_n82_), .b(x07), .O(new_n102_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n102_), .O(new_n103_));
  nor2   g58(.a(new_n81_), .b(new_n79_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  nand2  g60(.a(new_n56_), .b(new_n95_), .O(new_n106_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n106_), .O(z12));
  nand2  g62(.a(new_n104_), .b(x19), .O(new_n108_));
