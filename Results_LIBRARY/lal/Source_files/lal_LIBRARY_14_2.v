// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:32 2020
...
module FAU ( 
  ...
  nand2  g50(.a(x19), .b(x15), .O(new_n96_));
  ...
  inv1   g56(.a(new_n58_), .O(new_n102_));
  nor2   g57(.a(new_n82_), .b(x15), .O(new_n103_));
  oai21  g58(.a(new_n81_), .b(new_n79_), .c(new_n103_), .O(new_n104_));
  nor2   g59(.a(new_n81_), .b(new_n79_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(z12));
  nand2  g62(.a(new_n105_), .b(x19), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x20), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n92_), .c(new_n73_), .d(new_n56_), .O(z13));
  nor2   g65(.a(x21), .b(x20), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand2  g67(.a(new_n92_), .b(new_n56_), .O(new_n113_));
  aoi21  g68(.a(new_n73_), .b(x21), .c(new_n113_), .O(new_n114_));
  ...
  nand3  g73(.a(new_n118_), .b(new_n74_), .c(new_n72_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n116_), .O(z15));
  nand2  g75(.a(new_n74_), .b(new_n72_), .O(new_n121_));
  ...
  inv1   g81(.a(new_n76_), .O(new_n127_));
  oai21  g82(.a(new_n123_), .b(new_n108_), .c(x24), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n116_), .c(new_n127_), .O(z17));
  inv1   g84(.a(new_n73_), .O(new_n130_));
  nand4  g85(.a(new_n88_), .b(new_n74_), .c(new_n130_), .d(new_n48_), .O(new_n131_));
