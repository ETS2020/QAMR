...
module FAU ( 
  ...
  nand4  g31(.a(new_n76_), .b(new_n75_), .c(new_n69_), .d(new_n73_), .O(new_n77_));
  ...
  nand2  g37(.a(x24), .b(x21), .O(new_n83_));
  ...
  oai21  g41(.a(new_n85_), .b(new_n73_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g47(.a(new_n90_), .b(new_n53_), .c(new_n80_), .O(new_n93_));
  ...
  nor2   g52(.a(new_n70_), .b(new_n80_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x19), .O(new_n100_));
  nand2  g55(.a(new_n98_), .b(new_n71_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z12));
  nand2  g57(.a(new_n90_), .b(new_n53_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nor2   g59(.a(x20), .b(new_n71_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand2  g61(.a(new_n74_), .b(x20), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(z13));
  inv1   g63(.a(x21), .O(new_n109_));
  nand3  g64(.a(new_n105_), .b(new_n98_), .c(new_n109_), .O(new_n110_));
  ...
  inv1   g68(.a(new_n106_), .O(new_n114_));
  oai21  g69(.a(new_n69_), .b(x21), .c(new_n114_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n104_), .O(z15));
  nand3  g71(.a(new_n69_), .b(new_n73_), .c(x19), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n99_), .c(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n75_), .c(new_n73_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n104_), .O(z16));
  nand2  g76(.a(new_n120_), .b(x24), .O(new_n122_));
  nand4  g77(.a(new_n105_), .b(new_n98_), .c(new_n76_), .d(new_n69_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n122_), .c(new_n104_), .O(z17));
  nand2  g79(.a(new_n77_), .b(x25), .O(new_n125_));
  nand4  g80(.a(new_n119_), .b(new_n114_), .c(new_n81_), .d(new_n49_), .O(new_n126_));
