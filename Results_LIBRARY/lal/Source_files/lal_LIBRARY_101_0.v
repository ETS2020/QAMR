...
module FAU ( 
  ...
  nor2   g10(.a(x07), .b(x05), .O(new_n56_));
  ...
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(x05), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  nand3  g48(.a(new_n56_), .b(new_n77_), .c(new_n91_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  xnor2a g50(.a(x18), .b(x17), .O(new_n96_));
  nand2  g51(.a(new_n56_), .b(new_n91_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n96_), .O(z11));
  oai21  g53(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n99_));
  nor2   g54(.a(new_n79_), .b(new_n77_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n80_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(z12));
  inv1   g57(.a(x05), .O(new_n103_));
  nand2  g58(.a(new_n100_), .b(x19), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nand2  g60(.a(new_n91_), .b(new_n90_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n71_), .d(new_n103_), .O(z13));
  ...
  nor2   g67(.a(new_n106_), .b(x05), .O(new_n113_));
