...
module FAU ( 
  ...
  nand3  g38(.a(new_n52_), .b(x18), .c(x17), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(new_n83_), .c(new_n80_), .O(z12));
  oai21  g40(.a(new_n82_), .b(new_n52_), .c(x20), .O(new_n86_));
  nand4  g41(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n86_), .c(new_n74_), .d(new_n58_), .O(z13));
  nand3  g43(.a(x19), .b(x18), .c(x17), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n74_), .c(new_n58_), .d(new_n49_), .O(z14));
  nor2   g46(.a(z09), .b(x07), .O(new_n92_));
  nor2   g47(.a(x22), .b(x15), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n92_), .O(z15));
  nor2   g49(.a(x23), .b(x15), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n92_), .O(z16));
  nor2   g51(.a(x24), .b(x15), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n92_), .O(z17));
  nor2   g53(.a(x25), .b(x15), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n92_), .O(z18));
  buf    g55(.a(x16), .O(z02));
endmodule
