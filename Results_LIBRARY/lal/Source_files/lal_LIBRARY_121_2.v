...
module FAU ( 
  ...
  nand3  g42(.a(new_n55_), .b(x18), .c(x17), .O(new_n88_));
  aoi21  g43(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(z12));
  nand2  g44(.a(new_n79_), .b(new_n60_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nor2   g46(.a(new_n54_), .b(new_n53_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n52_), .c(x19), .O(new_n93_));
  nand2  g48(.a(new_n92_), .b(x19), .O(new_n94_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n91_), .O(z16));
  nor2   g65(.a(new_n55_), .b(new_n54_), .O(new_n111_));
  nor2   g66(.a(x22), .b(x21), .O(new_n112_));
  nand3  g67(.a(new_n52_), .b(x19), .c(x18), .O(new_n113_));
  oai22  g68(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n85_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x17), .O(new_n115_));
  nand3  g70(.a(new_n108_), .b(new_n52_), .c(x17), .O(new_n116_));
  aoi21  g71(.a(new_n116_), .b(x24), .c(new_n90_), .O(new_n117_));
