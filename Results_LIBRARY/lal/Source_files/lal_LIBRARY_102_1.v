...
module FAU ( 
  ...
  nand2  g07(.a(x24), .b(x21), .O(new_n53_));
  ...
  aoi21  g44(.a(new_n80_), .b(new_n48_), .c(new_n89_), .O(new_n90_));
  ...
  nand2  g59(.a(new_n71_), .b(x20), .O(new_n105_));
  nor2   g60(.a(x20), .b(new_n82_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n102_), .O(new_n107_));
  nand2  g62(.a(new_n93_), .b(new_n55_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n105_), .O(z13));
  nand3  g65(.a(new_n102_), .b(new_n73_), .c(x19), .O(new_n111_));
  ...
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n93_), .d(new_n55_), .O(z15));
  nand4  g71(.a(new_n114_), .b(new_n93_), .c(new_n55_), .d(new_n48_), .O(z16));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  inv1   g73(.a(x21), .O(new_n119_));
  nand4  g74(.a(new_n106_), .b(new_n102_), .c(new_n74_), .d(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n109_), .O(z17));
  nand2  g76(.a(new_n75_), .b(x25), .O(new_n122_));
  inv1   g77(.a(new_n107_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n76_), .c(new_n80_), .d(new_n89_), .O(new_n124_));
