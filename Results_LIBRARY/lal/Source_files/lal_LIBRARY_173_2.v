...
module FAU ( 
  ...
  nand3  g50(.a(new_n56_), .b(new_n79_), .c(new_n95_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  inv1   g52(.a(new_n58_), .O(new_n98_));
  nand2  g53(.a(x18), .b(new_n79_), .O(new_n99_));
  inv1   g54(.a(x15), .O(new_n100_));
  nand3  g55(.a(new_n81_), .b(x17), .c(new_n100_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n99_), .c(new_n98_), .O(z11));
  nor2   g57(.a(new_n82_), .b(x18), .O(new_n103_));
  nor3   g58(.a(x19), .b(new_n81_), .c(new_n79_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n103_), .c(new_n100_), .O(new_n105_));
  nand2  g60(.a(x19), .b(new_n79_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n98_), .O(z12));
  nor2   g62(.a(new_n81_), .b(new_n79_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x19), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x20), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n92_), .c(new_n73_), .d(new_n56_), .O(z13));
  nor2   g66(.a(x21), .b(x20), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand2  g68(.a(new_n92_), .b(new_n56_), .O(new_n114_));
  aoi21  g69(.a(new_n73_), .b(x21), .c(new_n114_), .O(new_n115_));
  oai21  g70(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z14));
  inv1   g71(.a(new_n114_), .O(new_n117_));
  oai21  g72(.a(new_n113_), .b(new_n109_), .c(x22), .O(new_n118_));
  inv1   g73(.a(new_n109_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n74_), .c(new_n72_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(z15));
  nand2  g76(.a(new_n74_), .b(new_n72_), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n109_), .c(x23), .O(new_n123_));
  nand3  g78(.a(new_n112_), .b(new_n48_), .c(new_n52_), .O(new_n124_));
  inv1   g79(.a(new_n124_), .O(new_n125_));
  nand2  g80(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n123_), .c(new_n117_), .O(z16));
  inv1   g82(.a(new_n76_), .O(new_n128_));
  oai21  g83(.a(new_n124_), .b(new_n109_), .c(x24), .O(new_n129_));
  nand3  g84(.a(new_n129_), .b(new_n117_), .c(new_n128_), .O(z17));
  inv1   g85(.a(new_n73_), .O(new_n131_));
  nand4  g86(.a(new_n88_), .b(new_n74_), .c(new_n131_), .d(new_n48_), .O(new_n132_));
  nand2  g87(.a(new_n128_), .b(x25), .O(new_n133_));
  nand3  g88(.a(new_n133_), .b(new_n132_), .c(new_n117_), .O(z18));
  buf    g89(.a(x16), .O(z02));
endmodule
