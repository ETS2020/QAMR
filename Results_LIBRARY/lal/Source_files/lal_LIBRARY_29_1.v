// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:35 2020
...
module FAU ( 
  ...
  nand3  g33(.a(new_n74_), .b(new_n58_), .c(x18), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z11));
  nand3  g35(.a(new_n74_), .b(new_n58_), .c(x19), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z12));
