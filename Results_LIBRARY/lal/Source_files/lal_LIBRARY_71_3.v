...
module FAU ( 
  ...
  nand3  g51(.a(x18), .b(new_n77_), .c(new_n96_), .O(new_n97_));
  nand2  g52(.a(new_n79_), .b(x17), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n97_), .c(new_n95_), .O(z11));
  xor2a  g54(.a(x19), .b(x18), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x17), .O(new_n101_));
  nand3  g56(.a(x19), .b(new_n77_), .c(new_n96_), .O(new_n102_));
