...
module FAU ( 
  ...
  nor2   g32(.a(x24), .b(x21), .O(new_n78_));
  nand4  g33(.a(new_n78_), .b(new_n77_), .c(x19), .d(x17), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x25), .O(new_n80_));
  nand3  g35(.a(x24), .b(x22), .c(x21), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n49_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(x20), .O(new_n83_));
  inv1   g38(.a(x18), .O(new_n84_));
  inv1   g39(.a(x19), .O(new_n85_));
  nand4  g40(.a(x24), .b(x22), .c(x21), .d(new_n85_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n49_), .O(new_n87_));
  nand2  g42(.a(new_n49_), .b(new_n48_), .O(new_n88_));
  aoi22  g43(.a(new_n88_), .b(x23), .c(new_n87_), .d(new_n84_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n83_), .c(new_n80_), .O(z08));
  nor2   g45(.a(x15), .b(x07), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n58_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  inv1   g48(.a(x17), .O(new_n94_));
  nand3  g49(.a(new_n91_), .b(new_n57_), .c(new_n94_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  xnor2a g51(.a(x18), .b(x17), .O(new_n97_));
  nand2  g52(.a(new_n91_), .b(new_n57_), .O(new_n98_));
  nor2   g53(.a(new_n98_), .b(new_n97_), .O(z11));
  oai21  g54(.a(new_n84_), .b(new_n94_), .c(x19), .O(new_n100_));
  nor2   g55(.a(new_n84_), .b(new_n94_), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n85_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(z12));
  nand2  g58(.a(new_n73_), .b(x20), .O(new_n104_));
  nor2   g59(.a(x20), .b(new_n85_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand2  g61(.a(new_n91_), .b(new_n57_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(z13));
  nand2  g64(.a(new_n75_), .b(new_n74_), .O(new_n110_));
  nand2  g65(.a(new_n106_), .b(x21), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n91_), .d(new_n57_), .O(z14));
  nand4  g67(.a(new_n110_), .b(new_n91_), .c(new_n57_), .d(new_n53_), .O(z15));
  nand2  g68(.a(new_n110_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n74_), .c(new_n50_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n108_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  nand4  g73(.a(new_n105_), .b(new_n76_), .c(new_n101_), .d(new_n52_), .O(new_n119_));
