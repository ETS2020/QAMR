// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:42 2020
...
module FAU ( 
  ...
  nand3  g47(.a(new_n90_), .b(new_n77_), .c(new_n92_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xnor2a g49(.a(x18), .b(x17), .O(new_n95_));
  nand2  g50(.a(new_n90_), .b(new_n92_), .O(new_n96_));
  ...
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n71_), .O(z13));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  aoi21  g62(.a(new_n71_), .b(x21), .c(new_n96_), .O(new_n108_));
  oai21  g63(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z14));
  oai21  g64(.a(new_n107_), .b(new_n103_), .c(x22), .O(new_n110_));
  inv1   g65(.a(new_n103_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n72_), .c(new_n70_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n102_), .O(z15));
  nand2  g68(.a(new_n72_), .b(new_n70_), .O(new_n114_));
  oai21  g69(.a(new_n114_), .b(new_n103_), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n106_), .b(new_n48_), .c(new_n52_), .O(new_n116_));
  inv1   g71(.a(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n111_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n115_), .c(new_n102_), .O(z16));
  inv1   g74(.a(new_n74_), .O(new_n120_));
  oai21  g75(.a(new_n116_), .b(new_n103_), .c(x24), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n102_), .c(new_n120_), .O(z17));
  inv1   g77(.a(new_n71_), .O(new_n123_));
  nand4  g78(.a(new_n86_), .b(new_n72_), .c(new_n123_), .d(new_n48_), .O(new_n124_));
  nand2  g79(.a(new_n120_), .b(x25), .O(new_n125_));
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n102_), .O(z18));
  buf    g81(.a(x16), .O(z02));
endmodule
