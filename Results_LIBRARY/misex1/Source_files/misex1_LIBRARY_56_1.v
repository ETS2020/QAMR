...
module FAU ( 
  ...
  inv1   g22(.a(new_n22_), .O(new_n38_));
  ...
  oai21  g33(.a(new_n34_), .b(x3), .c(new_n27_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n17_), .c(new_n48_), .O(new_n50_));
  aoi21  g35(.a(new_n19_), .b(x2), .c(new_n18_), .O(new_n51_));
  ...
  oai21  g41(.a(new_n56_), .b(new_n48_), .c(new_n18_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z5));
  nand3  g43(.a(new_n41_), .b(x2), .c(new_n17_), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n48_), .c(new_n18_), .O(new_n61_));
  nand2  g46(.a(new_n51_), .b(new_n17_), .O(new_n62_));
