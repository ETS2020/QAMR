...
module FAU ( 
  ...
  aoi21  g15(.a(new_n22_), .b(x3), .c(new_n30_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x2), .c(new_n28_), .O(z1));
  ...
  oai21  g21(.a(new_n36_), .b(x2), .c(new_n20_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(x1), .O(new_n38_));
  oai21  g23(.a(new_n35_), .b(x1), .c(new_n38_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n21_), .O(new_n40_));
  nand3  g25(.a(new_n22_), .b(x3), .c(new_n16_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(z2));
  nand2  g27(.a(new_n36_), .b(new_n20_), .O(new_n43_));
  nand2  g28(.a(new_n16_), .b(x1), .O(new_n44_));
  aoi21  g29(.a(new_n43_), .b(x7), .c(new_n44_), .O(new_n45_));
  ...
  aoi21  g40(.a(new_n55_), .b(x2), .c(new_n34_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x3), .c(new_n25_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n21_), .c(new_n54_), .O(new_n58_));
  nand2  g43(.a(new_n20_), .b(x2), .O(new_n59_));
  aoi22  g44(.a(new_n59_), .b(new_n18_), .c(new_n30_), .d(new_n16_), .O(new_n60_));
