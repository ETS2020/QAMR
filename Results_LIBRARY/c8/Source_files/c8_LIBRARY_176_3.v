// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:10 2020
...
module FAU ( 
  ...
  and2   g54(.a(x18), .b(x04), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(x12), .c(new_n86_), .O(new_n102_));
  nand3  g56(.a(new_n98_), .b(new_n73_), .c(new_n51_), .O(new_n103_));
  ...
  nand4  g66(.a(new_n112_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n113_));
