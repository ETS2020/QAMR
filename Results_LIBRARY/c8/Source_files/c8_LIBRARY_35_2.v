...
module FAU ( 
  ...
  nand2  g81(.a(new_n124_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n122_), .c(new_n91_), .d(new_n73_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g86(.a(x18), .b(new_n86_), .c(x07), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n132_), .O(z16));
  nor2   g88(.a(new_n48_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n129_), .c(new_n122_), .d(new_n91_), .O(new_n136_));
