// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:28 2020
...
module FAU ( 
  ...
  nand2  g27(.a(new_n72_), .b(x00), .O(new_n74_));
  ...
  nand2  g33(.a(new_n72_), .b(x01), .O(new_n80_));
  ...
  nand2  g38(.a(new_n72_), .b(x02), .O(new_n85_));
  ...
  nand2  g43(.a(new_n72_), .b(x03), .O(new_n90_));
  ...
  nand2  g48(.a(new_n72_), .b(x04), .O(new_n95_));
  ...
  nand2  g55(.a(new_n72_), .b(x05), .O(new_n102_));
  ...
  nand2  g63(.a(new_n72_), .b(x06), .O(new_n110_));
  ...
  nand2  g70(.a(new_n72_), .b(x07), .O(new_n117_));
