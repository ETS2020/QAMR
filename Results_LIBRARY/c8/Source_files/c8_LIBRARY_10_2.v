...
module FAU ( 
  ...
  oai21  g056(.a(new_n94_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n100_), .O(z12));
  ...
  aoi22  g064(.a(new_n110_), .b(new_n84_), .c(new_n102_), .d(x23), .O(new_n111_));
  ...
  nand2  g074(.a(new_n120_), .b(new_n116_), .O(z14));
  ...
  nor2   g080(.a(new_n126_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x21), .b(x20), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n74_), .c(new_n57_), .O(new_n129_));
  nor2   g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nor3   g084(.a(x24), .b(x22), .c(x21), .O(new_n131_));
  aoi21  g085(.a(new_n131_), .b(new_n84_), .c(new_n66_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n125_), .O(z15));
  ...
  nand4  g092(.a(new_n126_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n139_));
  nand4  g093(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n57_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  aoi22  g095(.a(new_n141_), .b(new_n94_), .c(new_n139_), .d(x26), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n138_), .O(z16));
  nand4  g097(.a(new_n141_), .b(new_n128_), .c(x19), .d(new_n72_), .O(new_n144_));
