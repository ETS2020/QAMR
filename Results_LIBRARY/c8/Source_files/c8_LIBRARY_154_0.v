// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:03 2020
...
module FAU ( 
  ...
  inv1   g49(.a(x18), .O(new_n96_));
  oai21  g50(.a(new_n96_), .b(x03), .c(new_n75_), .O(new_n97_));
  nand2  g51(.a(new_n93_), .b(new_n73_), .O(new_n98_));
