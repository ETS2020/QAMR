...
module FAU ( 
  ...
  aoi21  g048(.a(new_n84_), .b(x21), .c(new_n94_), .O(new_n95_));
  ...
  aoi22  g055(.a(new_n101_), .b(new_n85_), .c(new_n93_), .d(x22), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n88_), .c(new_n100_), .O(z12));
  ...
  nor2   g063(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  aoi21  g064(.a(new_n108_), .b(x23), .c(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n88_), .c(new_n107_), .O(z13));
  ...
  nand4  g072(.a(new_n118_), .b(new_n117_), .c(new_n74_), .d(new_n57_), .O(new_n119_));
  oai21  g073(.a(new_n109_), .b(new_n84_), .c(x24), .O(new_n120_));
  ...
  nand4  g081(.a(new_n118_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n128_));
  ...
  oai21  g085(.a(new_n131_), .b(new_n88_), .c(new_n127_), .O(z15));
  ...
  nand2  g090(.a(x26), .b(new_n66_), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n117_), .d(new_n74_), .O(new_n138_));
  ...
  nor2   g098(.a(x26), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n117_), .O(new_n146_));
  nand2  g100(.a(x27), .b(x17), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(new_n146_), .c(new_n88_), .O(z17));
