...
module FAU ( 
  ...
  nor2   g33(.a(x18), .b(new_n51_), .O(new_n80_));
  aoi21  g34(.a(x18), .b(x01), .c(new_n80_), .O(new_n81_));
  nand2  g35(.a(new_n74_), .b(x16), .O(new_n82_));
  oai21  g36(.a(new_n81_), .b(x16), .c(new_n82_), .O(z10));
  ...
  nor2   g87(.a(x22), .b(x21), .O(new_n134_));
  nand4  g88(.a(new_n131_), .b(new_n134_), .c(x19), .d(new_n72_), .O(new_n135_));
  nand2  g89(.a(x27), .b(x17), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n135_), .c(new_n91_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
