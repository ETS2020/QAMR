...
module FAU ( 
  ...
  aoi21  g29(.a(new_n75_), .b(x08), .c(x00), .O(new_n76_));
  ...
  oai21  g46(.a(new_n92_), .b(new_n78_), .c(new_n89_), .O(z11));
  ...
  aoi22  g52(.a(new_n98_), .b(new_n84_), .c(new_n97_), .d(x22), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n78_), .c(new_n96_), .O(z12));
  nand2  g54(.a(x18), .b(x04), .O(new_n101_));
  oai21  g55(.a(x18), .b(new_n60_), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n78_), .O(new_n103_));
  nand3  g57(.a(new_n98_), .b(new_n73_), .c(new_n51_), .O(new_n104_));
  nor3   g58(.a(x23), .b(x22), .c(x21), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n84_), .c(new_n104_), .d(x23), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n78_), .c(new_n103_), .O(z13));
  inv1   g61(.a(x13), .O(new_n108_));
  nand2  g62(.a(x18), .b(x05), .O(new_n109_));
  oai21  g63(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n78_), .O(new_n111_));
  aoi21  g65(.a(new_n105_), .b(new_n84_), .c(new_n63_), .O(new_n112_));
  ...
  nand2  g73(.a(new_n119_), .b(new_n78_), .O(new_n120_));
  ...
  nand2  g83(.a(new_n129_), .b(new_n78_), .O(new_n130_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n78_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
