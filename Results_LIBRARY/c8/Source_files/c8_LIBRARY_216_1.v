...
module FAU ( 
  ...
  oai21  g33(.a(new_n74_), .b(x20), .c(x16), .O(new_n80_));
  nor2   g34(.a(x18), .b(new_n51_), .O(new_n81_));
  aoi21  g35(.a(x18), .b(x01), .c(new_n81_), .O(new_n82_));
  oai21  g36(.a(new_n82_), .b(x16), .c(new_n80_), .O(z10));
  inv1   g37(.a(x10), .O(new_n84_));
  nor2   g38(.a(x18), .b(new_n84_), .O(new_n85_));
  aoi21  g39(.a(x18), .b(x02), .c(new_n85_), .O(new_n86_));
  nor2   g40(.a(new_n74_), .b(new_n54_), .O(new_n87_));
  nor3   g41(.a(x21), .b(x19), .c(x17), .O(new_n88_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n54_), .O(new_n96_));
  nand4  g50(.a(new_n57_), .b(new_n54_), .c(new_n48_), .d(new_n72_), .O(new_n97_));
  ...
  nand3  g65(.a(new_n105_), .b(new_n74_), .c(new_n54_), .O(new_n112_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n105_), .c(new_n74_), .d(new_n54_), .O(new_n122_));
  ...
  nor2   g87(.a(x26), .b(x25), .O(new_n134_));
  nor3   g88(.a(x24), .b(x21), .c(x20), .O(new_n135_));
  nor2   g89(.a(new_n48_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n105_), .O(new_n137_));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n91_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
