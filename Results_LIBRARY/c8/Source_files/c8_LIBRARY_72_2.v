// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:39 2020
...
module FAU ( 
  ...
  aoi22  g055(.a(new_n101_), .b(new_n84_), .c(new_n93_), .d(x22), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n87_), .c(new_n100_), .O(z12));
  ...
  nand3  g061(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n108_));
  nor3   g062(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g063(.a(new_n109_), .b(new_n84_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n87_), .c(new_n107_), .O(z13));
  ...
  nand4  g071(.a(new_n117_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n118_));
  ...
  aoi22  g081(.a(new_n127_), .b(new_n94_), .c(new_n118_), .d(x25), .O(new_n128_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n133_), .d(new_n74_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n132_), .O(z16));
  nor2   g097(.a(x20), .b(new_n48_), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n138_), .c(new_n117_), .d(new_n101_), .O(new_n145_));
  aoi21  g099(.a(new_n145_), .b(new_n72_), .c(new_n87_), .O(z17));
