...
module FAU ( 
  ...
  nand2  g86(.a(new_n118_), .b(x26), .O(new_n133_));
  nor2   g87(.a(x21), .b(x20), .O(new_n134_));
  nor2   g88(.a(x23), .b(x22), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n74_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n132_), .O(z16));
  nor2   g94(.a(new_n48_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n142_));
