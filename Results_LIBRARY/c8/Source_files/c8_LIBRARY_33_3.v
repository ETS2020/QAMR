// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:27 2020
...
module FAU ( 
  ...
  nor3   g75(.a(x24), .b(x23), .c(x21), .O(new_n122_));
  aoi21  g76(.a(new_n122_), .b(new_n83_), .c(new_n66_), .O(new_n123_));
  nor2   g77(.a(x23), .b(x22), .O(new_n124_));
  nor2   g78(.a(x25), .b(x24), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n124_), .c(new_n91_), .d(new_n73_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n123_), .c(x16), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n121_), .O(z15));
  nand2  g83(.a(x18), .b(x07), .O(new_n130_));
  oai21  g84(.a(x18), .b(new_n69_), .c(new_n130_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n86_), .O(new_n132_));
  nand2  g86(.a(new_n126_), .b(x26), .O(new_n133_));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n124_), .c(new_n91_), .d(new_n73_), .O(new_n135_));
  ...
  nand4  g93(.a(new_n139_), .b(new_n134_), .c(new_n124_), .d(new_n91_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n86_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
