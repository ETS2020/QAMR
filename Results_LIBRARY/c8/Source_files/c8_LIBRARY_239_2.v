// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:28 2020
...
module FAU ( 
  ...
  nor2   g47(.a(x18), .b(new_n57_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(x03), .c(new_n86_), .O(new_n95_));
  nand2  g49(.a(new_n91_), .b(new_n73_), .O(new_n96_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n91_), .d(new_n73_), .O(new_n123_));
  ...
  nand4  g85(.a(new_n131_), .b(new_n121_), .c(new_n91_), .d(new_n73_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n131_), .c(new_n121_), .d(new_n91_), .O(new_n137_));
