...
module FAU ( 
  ...
  nand3  g097(.a(new_n117_), .b(new_n69_), .c(new_n66_), .O(new_n144_));
  nand3  g098(.a(new_n101_), .b(new_n51_), .c(x19), .O(new_n145_));
  nor4   g099(.a(new_n145_), .b(new_n144_), .c(x17), .d(new_n87_), .O(z17));
