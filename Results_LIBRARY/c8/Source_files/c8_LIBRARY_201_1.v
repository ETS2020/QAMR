// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:17 2020
...
module FAU ( 
  ...
  oai21  g81(.a(x18), .b(x15), .c(new_n86_), .O(new_n128_));
  nand2  g82(.a(new_n124_), .b(x26), .O(new_n129_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n122_), .c(new_n91_), .d(new_n73_), .O(new_n131_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n130_), .c(new_n122_), .d(new_n91_), .O(new_n136_));
