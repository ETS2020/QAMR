// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:11 2020
...
module FAU ( 
  ...
  nand2  g45(.a(new_n73_), .b(new_n51_), .O(new_n92_));
  nor2   g46(.a(x21), .b(x20), .O(new_n93_));
  aoi22  g47(.a(new_n93_), .b(new_n73_), .c(new_n92_), .d(x21), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n75_), .c(new_n91_), .O(z11));
  nand2  g49(.a(x18), .b(x03), .O(new_n96_));
  oai21  g50(.a(x18), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n75_), .O(new_n98_));
  nand2  g52(.a(new_n93_), .b(new_n73_), .O(new_n99_));
  nor2   g53(.a(x22), .b(x21), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n86_), .c(new_n99_), .d(x22), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n75_), .c(new_n98_), .O(z12));
  inv1   g56(.a(x18), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(x04), .c(new_n75_), .O(new_n104_));
  nand3  g58(.a(new_n100_), .b(new_n73_), .c(new_n51_), .O(new_n105_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n115_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n123_), .c(new_n93_), .d(new_n73_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n123_), .c(new_n93_), .d(new_n73_), .O(new_n134_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n133_), .c(new_n123_), .d(new_n93_), .O(new_n139_));
