// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:30 2020
...
module FAU ( 
  ...
  nor2   g40(.a(x18), .b(x10), .O(new_n87_));
  nand2  g41(.a(new_n86_), .b(x02), .O(new_n88_));
  ...
  oai22  g45(.a(new_n91_), .b(new_n86_), .c(new_n88_), .d(new_n87_), .O(z11));
  nand2  g46(.a(x18), .b(x03), .O(new_n93_));
  oai21  g47(.a(x18), .b(new_n57_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n86_), .O(new_n95_));
  ...
  oai21  g52(.a(new_n98_), .b(new_n86_), .c(new_n95_), .O(z12));
  ...
  nand2  g82(.a(new_n128_), .b(new_n86_), .O(new_n129_));
  ...
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n86_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
