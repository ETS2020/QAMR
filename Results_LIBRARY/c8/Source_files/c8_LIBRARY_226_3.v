...
module FAU ( 
  ...
  nor2   g36(.a(x16), .b(new_n82_), .O(new_n83_));
  inv1   g37(.a(x09), .O(new_n84_));
  nor2   g38(.a(x18), .b(new_n84_), .O(new_n85_));
  aoi21  g39(.a(new_n83_), .b(x18), .c(new_n85_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n81_), .O(z10));
  ...
  oai21  g48(.a(new_n94_), .b(new_n88_), .c(new_n91_), .O(z11));
  ...
  aoi22  g54(.a(new_n100_), .b(new_n80_), .c(new_n99_), .d(x22), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n88_), .c(new_n98_), .O(z12));
  ...
  aoi22  g61(.a(new_n107_), .b(new_n80_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n88_), .c(new_n105_), .O(z13));
  inv1   g63(.a(x13), .O(new_n110_));
  nand2  g64(.a(x18), .b(x05), .O(new_n111_));
  oai21  g65(.a(x18), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  aoi21  g67(.a(new_n107_), .b(new_n80_), .c(new_n63_), .O(new_n114_));
  ...
  nand2  g75(.a(new_n121_), .b(new_n88_), .O(new_n122_));
  ...
  nand2  g85(.a(new_n131_), .b(new_n88_), .O(new_n132_));
  ...
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n88_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
