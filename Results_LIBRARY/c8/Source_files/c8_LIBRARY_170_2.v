...
module FAU ( 
  ...
  nand2  g40(.a(new_n73_), .b(new_n51_), .O(new_n87_));
  nor2   g41(.a(x21), .b(x20), .O(new_n88_));
  aoi22  g42(.a(new_n88_), .b(new_n73_), .c(new_n87_), .d(x21), .O(new_n89_));
  nand3  g43(.a(x18), .b(new_n86_), .c(x02), .O(new_n90_));
  oai21  g44(.a(new_n89_), .b(new_n86_), .c(new_n90_), .O(z11));
  nand2  g45(.a(x18), .b(x03), .O(new_n92_));
  oai21  g46(.a(x18), .b(new_n57_), .c(new_n92_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n86_), .O(new_n94_));
  nand2  g48(.a(new_n88_), .b(new_n73_), .O(new_n95_));
  nor2   g49(.a(x22), .b(x21), .O(new_n96_));
  aoi22  g50(.a(new_n96_), .b(new_n83_), .c(new_n95_), .d(x22), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n86_), .c(new_n94_), .O(z12));
  ...
  aoi22  g57(.a(new_n103_), .b(new_n83_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n86_), .c(new_n101_), .O(z13));
  inv1   g59(.a(x13), .O(new_n106_));
  nand2  g60(.a(x18), .b(x05), .O(new_n107_));
  oai21  g61(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  aoi21  g63(.a(new_n103_), .b(new_n83_), .c(new_n63_), .O(new_n110_));
  ...
  nand2  g71(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  nand2  g72(.a(new_n112_), .b(x25), .O(new_n119_));
  nor2   g73(.a(x23), .b(x22), .O(new_n120_));
  nor2   g74(.a(x25), .b(x24), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n120_), .c(new_n88_), .d(new_n73_), .O(new_n122_));
  ...
  nand2  g81(.a(new_n127_), .b(new_n86_), .O(new_n128_));
  nand2  g82(.a(new_n122_), .b(x26), .O(new_n129_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n120_), .c(new_n88_), .d(new_n73_), .O(new_n131_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n130_), .c(new_n120_), .d(new_n88_), .O(new_n136_));
