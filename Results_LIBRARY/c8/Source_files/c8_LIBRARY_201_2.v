...
module FAU ( 
  ...
  nor2   g81(.a(x18), .b(new_n69_), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(x07), .c(new_n86_), .O(new_n129_));
  nand2  g83(.a(new_n124_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n122_), .c(new_n91_), .d(new_n73_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n131_), .c(new_n122_), .d(new_n91_), .O(new_n137_));
