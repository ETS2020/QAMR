// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:02 2020
...
module FAU ( 
  ...
  aoi21  g25(.a(x15), .b(x09), .c(new_n47_), .O(z08));
  ...
  nand2  g50(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  nand2  g51(.a(new_n92_), .b(new_n74_), .O(new_n98_));
  nor2   g52(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g53(.a(new_n99_), .b(new_n84_), .c(new_n98_), .d(x22), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n87_), .c(new_n97_), .O(z12));
  nand2  g55(.a(x18), .b(x04), .O(new_n102_));
  oai21  g56(.a(x18), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  nand3  g58(.a(new_n99_), .b(new_n74_), .c(new_n51_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n84_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n87_), .c(new_n104_), .O(z13));
  inv1   g62(.a(x13), .O(new_n109_));
  nand2  g63(.a(x18), .b(x05), .O(new_n110_));
  oai21  g64(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  aoi21  g66(.a(new_n106_), .b(new_n84_), .c(new_n63_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n99_), .c(new_n74_), .d(new_n51_), .O(new_n115_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n123_), .c(new_n92_), .d(new_n74_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n133_), .b(new_n123_), .c(new_n92_), .d(new_n74_), .O(new_n134_));
