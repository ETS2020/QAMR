...
module FAU ( 
  ...
  nand2  g73(.a(new_n116_), .b(x25), .O(new_n120_));
  nor2   g74(.a(x23), .b(x22), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n93_), .d(new_n73_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(x16), .O(new_n125_));
  inv1   g79(.a(x18), .O(new_n126_));
  nand3  g80(.a(new_n126_), .b(new_n75_), .c(x14), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n125_), .O(z15));
  ...
  nand2  g85(.a(new_n123_), .b(x26), .O(new_n132_));
  nor3   g86(.a(x26), .b(x25), .c(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n121_), .c(new_n93_), .d(new_n73_), .O(new_n134_));
  ...
  nand4  g92(.a(new_n138_), .b(new_n133_), .c(new_n121_), .d(new_n93_), .O(new_n139_));
