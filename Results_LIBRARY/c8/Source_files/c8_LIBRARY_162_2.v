...
module FAU ( 
  ...
  aoi21  g61(.a(new_n105_), .b(new_n83_), .c(new_n63_), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n110_));
  inv1   g64(.a(new_n110_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand3  g66(.a(x18), .b(new_n86_), .c(x05), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n112_), .O(z14));
