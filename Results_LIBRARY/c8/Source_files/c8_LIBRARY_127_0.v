...
module FAU ( 
  ...
  oai21  g35(.a(new_n81_), .b(x01), .c(new_n75_), .O(new_n82_));
  ...
  nand2  g42(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  ...
  oai21  g46(.a(new_n92_), .b(new_n75_), .c(new_n89_), .O(z11));
  nand2  g47(.a(x18), .b(x03), .O(new_n94_));
  oai21  g48(.a(x18), .b(new_n57_), .c(new_n94_), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n75_), .O(new_n96_));
  ...
  oai21  g53(.a(new_n99_), .b(new_n75_), .c(new_n96_), .O(z12));
  nand2  g54(.a(x18), .b(x04), .O(new_n101_));
  oai21  g55(.a(x18), .b(new_n60_), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n75_), .O(new_n103_));
