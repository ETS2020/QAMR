// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:22 2020
...
module FAU ( 
  ...
  inv1   g63(.a(x18), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(x05), .c(new_n75_), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n86_), .c(new_n63_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n114_));
  ...
  nand2  g73(.a(new_n119_), .b(new_n75_), .O(new_n120_));
  nand2  g74(.a(new_n114_), .b(x25), .O(new_n121_));
  nor2   g75(.a(x23), .b(x22), .O(new_n122_));
  nor2   g76(.a(x25), .b(x24), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n122_), .c(new_n93_), .d(new_n73_), .O(new_n124_));
  ...
  nand2  g83(.a(new_n129_), .b(new_n75_), .O(new_n130_));
  nand2  g84(.a(new_n124_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n122_), .c(new_n93_), .d(new_n73_), .O(new_n133_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n132_), .c(new_n122_), .d(new_n93_), .O(new_n138_));
  nand2  g92(.a(x27), .b(x17), .O(new_n139_));
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n75_), .O(z17));
  buf    g94(.a(x27), .O(z08));
endmodule
