...
module FAU ( 
  ...
  nand2  g86(.a(x26), .b(x16), .O(new_n133_));
  oai22  g87(.a(new_n133_), .b(new_n130_), .c(new_n132_), .d(x16), .O(z16));
  nand3  g88(.a(x27), .b(x17), .c(x16), .O(new_n135_));
  inv1   g89(.a(new_n135_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
