...
module FAU ( 
  ...
  nand2  g022(.a(x7), .b(new_n35_), .O(new_n37_));
  oai22  g023(.a(new_n37_), .b(new_n27_), .c(new_n36_), .d(new_n25_), .O(new_n38_));
  aoi21  g024(.a(new_n38_), .b(new_n34_), .c(new_n32_), .O(new_n39_));
  oai21  g025(.a(new_n23_), .b(new_n15_), .c(new_n39_), .O(z0));
  ...
  oai21  g033(.a(new_n43_), .b(new_n27_), .c(new_n47_), .O(new_n48_));
  ...
  oai21  g038(.a(new_n30_), .b(new_n26_), .c(x1), .O(new_n53_));
  nand2  g039(.a(new_n36_), .b(x8), .O(new_n54_));
  aoi21  g040(.a(new_n54_), .b(new_n37_), .c(x3), .O(new_n55_));
  nor2   g041(.a(new_n44_), .b(x4), .O(new_n56_));
  nand2  g042(.a(new_n56_), .b(x8), .O(new_n57_));
  inv1   g043(.a(new_n57_), .O(new_n58_));
  oai21  g044(.a(new_n58_), .b(new_n55_), .c(new_n53_), .O(new_n59_));
  nand2  g045(.a(x6), .b(new_n30_), .O(new_n60_));
  nand3  g046(.a(x8), .b(x5), .c(new_n28_), .O(new_n61_));
  aoi21  g047(.a(new_n61_), .b(new_n60_), .c(x2), .O(new_n62_));
  nor2   g048(.a(x6), .b(new_n26_), .O(new_n63_));
  nor2   g049(.a(new_n43_), .b(new_n24_), .O(new_n64_));
  ...
  oai21  g054(.a(new_n68_), .b(new_n67_), .c(new_n46_), .O(new_n69_));
  nand3  g055(.a(new_n69_), .b(new_n65_), .c(new_n59_), .O(new_n70_));
  inv1   g056(.a(new_n70_), .O(new_n71_));
  nand2  g057(.a(new_n71_), .b(new_n52_), .O(z1));
  nor2   g058(.a(x3), .b(new_n24_), .O(new_n73_));
  oai21  g059(.a(x7), .b(new_n16_), .c(new_n18_), .O(new_n74_));
  nand2  g060(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g061(.a(new_n56_), .b(x3), .O(new_n76_));
  aoi21  g062(.a(new_n76_), .b(new_n75_), .c(x2), .O(new_n77_));
  nand2  g063(.a(new_n44_), .b(x6), .O(new_n78_));
  aoi21  g064(.a(x7), .b(x6), .c(new_n35_), .O(new_n79_));
  nand2  g065(.a(x3), .b(new_n24_), .O(new_n80_));
  nand2  g066(.a(x4), .b(new_n28_), .O(new_n81_));
  oai22  g067(.a(new_n81_), .b(new_n78_), .c(new_n80_), .d(new_n79_), .O(new_n82_));
  oai21  g068(.a(new_n82_), .b(new_n77_), .c(new_n30_), .O(new_n83_));
  nand2  g069(.a(new_n45_), .b(x0), .O(new_n84_));
  and2   g070(.a(x7), .b(x6), .O(new_n85_));
  oai21  g071(.a(new_n85_), .b(new_n41_), .c(new_n30_), .O(new_n86_));
  aoi21  g072(.a(new_n86_), .b(new_n84_), .c(new_n28_), .O(new_n87_));
  nand2  g073(.a(new_n73_), .b(new_n16_), .O(new_n88_));
  nor2   g074(.a(new_n88_), .b(new_n41_), .O(new_n89_));
  oai21  g075(.a(new_n89_), .b(new_n87_), .c(x2), .O(new_n90_));
  aoi21  g076(.a(new_n44_), .b(x4), .c(x1), .O(new_n91_));
  oai21  g077(.a(new_n91_), .b(new_n56_), .c(x0), .O(new_n92_));
  nand2  g078(.a(x2), .b(x1), .O(new_n93_));
  nand3  g079(.a(new_n93_), .b(new_n44_), .c(new_n16_), .O(new_n94_));
  nand2  g080(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g081(.a(x7), .b(new_n16_), .c(x4), .d(new_n28_), .O(new_n96_));
  inv1   g082(.a(new_n96_), .O(new_n97_));
  aoi21  g083(.a(new_n95_), .b(x3), .c(new_n97_), .O(new_n98_));
  nand3  g084(.a(new_n98_), .b(new_n90_), .c(new_n83_), .O(new_n99_));
  nand2  g085(.a(new_n99_), .b(new_n33_), .O(new_n100_));
  aoi21  g086(.a(x3), .b(x1), .c(x0), .O(new_n101_));
  oai22  g087(.a(new_n101_), .b(new_n17_), .c(new_n18_), .d(new_n28_), .O(new_n102_));
  oai21  g088(.a(new_n42_), .b(x3), .c(x0), .O(new_n103_));
  nand3  g089(.a(new_n93_), .b(new_n44_), .c(new_n28_), .O(new_n104_));
  nand2  g090(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  oai21  g091(.a(new_n105_), .b(new_n102_), .c(new_n16_), .O(new_n106_));
  nor2   g092(.a(new_n85_), .b(new_n41_), .O(new_n107_));
  nor2   g093(.a(new_n107_), .b(new_n26_), .O(new_n108_));
  oai22  g094(.a(new_n79_), .b(x1), .c(new_n37_), .d(x2), .O(new_n109_));
  oai21  g095(.a(new_n109_), .b(new_n108_), .c(new_n28_), .O(new_n110_));
  nand2  g096(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  oai21  g097(.a(new_n56_), .b(new_n27_), .c(new_n45_), .O(new_n112_));
  ...
  nor3   g101(.a(new_n115_), .b(new_n60_), .c(new_n33_), .O(new_n116_));
  oai21  g102(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(new_n117_));
  nand2  g103(.a(new_n44_), .b(new_n26_), .O(new_n118_));
  ...
  nand2  g108(.a(new_n122_), .b(new_n100_), .O(z2));
  or2    g109(.a(new_n17_), .b(new_n24_), .O(new_n124_));
  aoi21  g110(.a(new_n124_), .b(new_n18_), .c(new_n19_), .O(new_n125_));
  oai21  g111(.a(new_n125_), .b(new_n22_), .c(new_n16_), .O(new_n126_));
  nand2  g112(.a(new_n56_), .b(new_n26_), .O(new_n127_));
  aoi21  g113(.a(new_n127_), .b(new_n33_), .c(x3), .O(new_n128_));
  nand3  g114(.a(new_n45_), .b(new_n34_), .c(new_n27_), .O(new_n129_));
  nand3  g115(.a(new_n129_), .b(new_n57_), .c(x6), .O(new_n130_));
