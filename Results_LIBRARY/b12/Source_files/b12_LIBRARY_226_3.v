// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:37 2020
...
module FAU ( 
  ...
  aoi21  g17(.a(new_n28_), .b(x03), .c(new_n41_), .O(new_n42_));
  nor2   g18(.a(x04), .b(x01), .O(new_n43_));
  oai21  g19(.a(new_n42_), .b(x01), .c(new_n43_), .O(new_n44_));
  oai21  g20(.a(x10), .b(x07), .c(new_n35_), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  nand3  g22(.a(new_n41_), .b(x09), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g28(.a(new_n46_), .b(new_n27_), .O(new_n53_));
  aoi21  g29(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(x02), .c(new_n50_), .O(new_n55_));
  oai21  g31(.a(new_n49_), .b(x00), .c(new_n55_), .O(z2));
  ...
  oai21  g36(.a(x11), .b(new_n46_), .c(new_n60_), .O(z4));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n41_), .d(new_n46_), .O(z5));
  inv1   g39(.a(x09), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n46_), .c(x03), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n25_), .c(new_n57_), .O(new_n66_));
  nand3  g42(.a(x09), .b(new_n35_), .c(new_n27_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n26_), .c(x07), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n50_), .O(new_n69_));
  nand3  g45(.a(x09), .b(new_n46_), .c(new_n35_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n25_), .c(x01), .O(new_n71_));
  aoi21  g47(.a(new_n64_), .b(x03), .c(x01), .O(new_n72_));
  nand2  g48(.a(new_n46_), .b(new_n25_), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x02), .O(new_n75_));
  oai21  g51(.a(new_n73_), .b(new_n72_), .c(new_n75_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n71_), .c(new_n57_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n69_), .c(x10), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n27_), .O(new_n79_));
  nand4  g55(.a(new_n41_), .b(new_n50_), .c(new_n46_), .d(x01), .O(new_n80_));
  ...
  nand2  g59(.a(new_n41_), .b(new_n46_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(new_n50_), .c(new_n84_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n82_), .O(z7));
  inv1   g62(.a(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g65(.a(new_n64_), .b(new_n57_), .c(new_n84_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(z8));
endmodule
