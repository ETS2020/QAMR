...
module FAU ( 
  ...
  nand4  g36(.a(new_n60_), .b(x13), .c(new_n45_), .d(new_n44_), .O(z5));
  nand2  g37(.a(new_n45_), .b(new_n44_), .O(new_n62_));
  oai21  g38(.a(new_n56_), .b(x03), .c(new_n30_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n57_), .c(new_n25_), .O(new_n64_));
  oai21  g40(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n30_), .b(new_n40_), .O(new_n66_));
  oai21  g42(.a(x08), .b(new_n40_), .c(new_n66_), .O(new_n67_));
  inv1   g43(.a(x14), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(x01), .c(new_n40_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  aoi21  g46(.a(new_n67_), .b(new_n65_), .c(new_n70_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n64_), .c(new_n62_), .O(z6));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n74_), .c(new_n62_), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n56_), .b(new_n40_), .c(new_n62_), .O(new_n84_));
