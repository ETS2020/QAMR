// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:06 2020
...
module FAU ( 
  ...
  aoi21  g21(.a(x07), .b(new_n34_), .c(x10), .O(new_n46_));
  ...
  aoi21  g32(.a(new_n56_), .b(new_n25_), .c(x08), .O(new_n57_));
  nand2  g33(.a(x09), .b(x00), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(new_n59_));
  ...
  oai22  g38(.a(x10), .b(new_n25_), .c(x09), .d(new_n34_), .O(new_n63_));
  nand2  g39(.a(new_n30_), .b(new_n54_), .O(new_n64_));
  oai21  g40(.a(x08), .b(new_n54_), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  aoi21  g42(.a(x09), .b(new_n34_), .c(x02), .O(new_n67_));
  oai21  g43(.a(new_n49_), .b(new_n54_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(x01), .b(new_n54_), .O(new_n69_));
  oai22  g45(.a(new_n69_), .b(x14), .c(new_n68_), .d(new_n67_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n41_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n66_), .c(x07), .O(z6));
  nand3  g48(.a(x09), .b(x03), .c(new_n30_), .O(new_n73_));
  nand4  g49(.a(new_n41_), .b(new_n49_), .c(new_n40_), .d(x02), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n41_), .b(new_n40_), .O(new_n77_));
  oai21  g53(.a(x07), .b(new_n25_), .c(x03), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n49_), .c(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n56_), .b(new_n54_), .c(new_n77_), .O(new_n84_));
