...
module FAU ( 
  ...
  nand3  g17(.a(new_n27_), .b(new_n35_), .c(new_n25_), .O(new_n42_));
  ...
  oai22  g37(.a(new_n61_), .b(new_n49_), .c(x03), .d(x01), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  aoi21  g39(.a(x14), .b(x02), .c(new_n25_), .O(new_n64_));
  aoi21  g40(.a(x03), .b(new_n31_), .c(x01), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n63_), .c(new_n59_), .O(z6));
  nand2  g43(.a(new_n60_), .b(new_n51_), .O(new_n68_));
  nand2  g44(.a(new_n39_), .b(new_n25_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(z7));
  nand4  g46(.a(new_n61_), .b(new_n56_), .c(new_n55_), .d(x03), .O(z8));
endmodule
