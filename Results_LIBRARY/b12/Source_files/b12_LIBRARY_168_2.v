...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(x03), .c(new_n30_), .O(new_n66_));
  oai21  g42(.a(new_n64_), .b(x01), .c(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n63_), .b(new_n56_), .c(new_n67_), .O(new_n68_));
  aoi21  g44(.a(x14), .b(x02), .c(x00), .O(new_n69_));
  nor2   g45(.a(x08), .b(new_n56_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(x01), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n68_), .c(new_n45_), .O(z6));
  ...
  nand4  g55(.a(new_n41_), .b(new_n65_), .c(new_n40_), .d(x00), .O(z8));
endmodule
