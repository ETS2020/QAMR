// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:17 2020
...
module FAU ( 
  ...
  oai21  g20(.a(x10), .b(x07), .c(new_n34_), .O(new_n45_));
  ...
  oai21  g36(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n30_), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x03), .c(new_n30_), .O(new_n64_));
  nor2   g40(.a(x14), .b(new_n30_), .O(new_n65_));
  aoi21  g41(.a(new_n64_), .b(new_n25_), .c(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n41_), .b(new_n40_), .c(new_n54_), .O(new_n67_));
  aoi21  g43(.a(new_n66_), .b(new_n62_), .c(new_n67_), .O(z6));
  nand4  g44(.a(x09), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n46_), .O(z7));
  inv1   g46(.a(x12), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x09), .O(new_n73_));
  nand2  g49(.a(new_n63_), .b(new_n54_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n46_), .O(z8));
endmodule
