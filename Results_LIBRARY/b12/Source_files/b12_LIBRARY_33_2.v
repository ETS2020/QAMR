...
module FAU ( 
  ...
  nand2  g19(.a(new_n40_), .b(new_n39_), .O(new_n44_));
  nand2  g20(.a(new_n44_), .b(new_n34_), .O(new_n45_));
  ...
  oai21  g38(.a(new_n57_), .b(x03), .c(new_n30_), .O(new_n63_));
  ...
  nand2  g42(.a(new_n30_), .b(new_n55_), .O(new_n67_));
  oai21  g43(.a(x08), .b(new_n55_), .c(new_n67_), .O(new_n68_));
  nor2   g44(.a(new_n25_), .b(x00), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(new_n65_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n64_), .c(new_n44_), .O(z6));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n73_), .c(new_n44_), .O(new_n78_));
  ...
  aoi21  g58(.a(new_n57_), .b(new_n55_), .c(new_n44_), .O(new_n83_));
