...
module FAU ( 
  ...
  nand4  g36(.a(x13), .b(new_n60_), .c(new_n40_), .d(new_n55_), .O(z5));
  inv1   g37(.a(x08), .O(new_n62_));
  nand2  g38(.a(new_n49_), .b(new_n62_), .O(new_n63_));
  ...
  nand2  g45(.a(new_n30_), .b(new_n55_), .O(new_n70_));
  oai21  g46(.a(new_n63_), .b(new_n55_), .c(new_n70_), .O(new_n71_));
  nor2   g47(.a(new_n25_), .b(x00), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n68_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n67_), .c(x07), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n30_), .O(new_n75_));
  nand2  g51(.a(new_n40_), .b(x02), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n63_), .c(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  nand2  g54(.a(x03), .b(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n49_), .b(new_n40_), .O(new_n80_));
  aoi21  g56(.a(new_n79_), .b(new_n62_), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(z7));
  nand2  g58(.a(new_n60_), .b(new_n30_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n79_), .c(x09), .O(new_n84_));
  aoi21  g60(.a(new_n65_), .b(new_n55_), .c(new_n80_), .O(new_n85_));
