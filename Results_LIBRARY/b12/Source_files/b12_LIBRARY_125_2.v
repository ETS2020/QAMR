...
module FAU ( 
  ...
  oai21  g20(.a(x09), .b(x07), .c(new_n41_), .O(new_n45_));
  ...
  oai21  g38(.a(x09), .b(x02), .c(new_n62_), .O(new_n63_));
  aoi21  g39(.a(x14), .b(x02), .c(x00), .O(new_n64_));
  nor2   g40(.a(x08), .b(new_n54_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(x01), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z6));
  nand3  g43(.a(new_n41_), .b(x08), .c(new_n40_), .O(z7));
  inv1   g44(.a(x09), .O(new_n69_));
  nand4  g45(.a(new_n41_), .b(new_n69_), .c(new_n40_), .d(x00), .O(z8));
endmodule
