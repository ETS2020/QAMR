// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:04 2020
...
module FAU ( 
  ...
  nand2  g55(.a(x03), .b(new_n27_), .O(new_n80_));
  nand4  g56(.a(new_n42_), .b(new_n64_), .c(new_n41_), .d(x01), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(new_n65_), .c(new_n81_), .O(new_n82_));
  ...
  oai21  g62(.a(new_n80_), .b(x12), .c(x09), .O(new_n87_));
