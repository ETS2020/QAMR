...
module FAU ( 
  ...
  aoi21  g34(.a(x12), .b(new_n56_), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  ...
  nand4  g53(.a(new_n41_), .b(new_n77_), .c(new_n40_), .d(x02), .O(new_n78_));
