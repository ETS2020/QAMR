...
module FAU ( 
  ...
  aoi21  g11(.a(new_n35_), .b(new_n29_), .c(x00), .O(z1));
  ...
  nand4  g17(.a(new_n41_), .b(new_n39_), .c(new_n31_), .d(new_n25_), .O(new_n42_));
  ...
  aoi22  g22(.a(new_n46_), .b(new_n25_), .c(new_n42_), .d(x02), .O(new_n47_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(new_n58_));
  ...
  oai21  g37(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n57_), .c(new_n25_), .O(new_n63_));
  inv1   g39(.a(x14), .O(new_n64_));
  oai21  g40(.a(x09), .b(new_n43_), .c(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n27_), .b(new_n54_), .O(new_n66_));
  ...
  aoi21  g57(.a(new_n56_), .b(new_n54_), .c(new_n39_), .O(new_n82_));
