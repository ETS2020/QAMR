...
module FAU ( 
  ...
  nand2  g21(.a(new_n41_), .b(new_n40_), .O(new_n46_));
  oai22  g22(.a(new_n46_), .b(new_n45_), .c(new_n40_), .d(x03), .O(new_n47_));
  aoi22  g23(.a(new_n47_), .b(new_n25_), .c(new_n44_), .d(x02), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand4  g25(.a(x09), .b(new_n49_), .c(new_n40_), .d(x00), .O(new_n50_));
  oai21  g26(.a(new_n41_), .b(x03), .c(new_n50_), .O(new_n51_));
  nor2   g27(.a(x07), .b(new_n30_), .O(new_n52_));
  aoi22  g28(.a(new_n52_), .b(new_n49_), .c(new_n51_), .d(new_n25_), .O(new_n53_));
  oai21  g29(.a(new_n48_), .b(x00), .c(new_n53_), .O(z2));
  inv1   g30(.a(x00), .O(new_n55_));
  aoi22  g31(.a(x12), .b(new_n55_), .c(x11), .d(x07), .O(z3));
  aoi21  g32(.a(x09), .b(x00), .c(x01), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(x08), .O(new_n58_));
  nand2  g34(.a(x09), .b(x00), .O(new_n59_));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n30_), .c(x01), .O(new_n65_));
  nand2  g41(.a(x14), .b(x02), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x01), .O(new_n67_));
  nand3  g43(.a(new_n45_), .b(x03), .c(new_n30_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n65_), .c(new_n55_), .O(new_n70_));
  nand3  g46(.a(new_n49_), .b(x02), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n41_), .O(new_n73_));
  nand2  g49(.a(new_n45_), .b(x03), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n64_), .c(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n49_), .c(x00), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n73_), .c(x07), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n30_), .O(new_n78_));
  nand3  g54(.a(new_n52_), .b(new_n41_), .c(new_n49_), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n49_), .c(new_n46_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n81_), .O(z7));
  inv1   g60(.a(x12), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n45_), .b(new_n55_), .c(new_n46_), .O(new_n88_));
