...
module FAU ( 
  ...
  nor2   g24(.a(new_n40_), .b(x03), .O(new_n49_));
  nor2   g25(.a(x08), .b(x07), .O(new_n50_));
  oai21  g26(.a(new_n49_), .b(new_n48_), .c(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n46_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n26_), .O(new_n53_));
  aoi21  g29(.a(new_n27_), .b(new_n26_), .c(x00), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n50_), .c(x02), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n53_), .O(z2));
  aoi22  g32(.a(x12), .b(new_n36_), .c(x11), .d(x07), .O(z3));
  nand2  g33(.a(x08), .b(x00), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n47_), .c(new_n39_), .O(new_n59_));
  ...
  oai21  g38(.a(new_n47_), .b(x03), .c(new_n37_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n58_), .c(new_n26_), .O(new_n64_));
  inv1   g40(.a(x14), .O(new_n65_));
  oai21  g41(.a(x09), .b(new_n30_), .c(new_n26_), .O(new_n66_));
  nand2  g42(.a(new_n37_), .b(new_n36_), .O(new_n67_));
  oai21  g43(.a(x08), .b(new_n36_), .c(new_n67_), .O(new_n68_));
  nor2   g44(.a(new_n26_), .b(x00), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(new_n65_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n64_), .c(new_n41_), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n37_), .O(new_n72_));
