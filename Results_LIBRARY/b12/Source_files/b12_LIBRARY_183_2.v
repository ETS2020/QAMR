...
module FAU ( 
  ...
  nand4  g48(.a(new_n44_), .b(new_n48_), .c(new_n43_), .d(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  aoi21  g51(.a(x03), .b(new_n36_), .c(x08), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n62_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(z7));
  inv1   g54(.a(x12), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n80_));
