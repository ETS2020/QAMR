...
module FAU ( 
  ...
  aoi21  g37(.a(x09), .b(new_n34_), .c(x02), .O(new_n63_));
  nand3  g38(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x01), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n59_), .O(new_n66_));
  inv1   g41(.a(x14), .O(new_n67_));
  nand2  g42(.a(new_n30_), .b(new_n56_), .O(new_n68_));
  oai21  g43(.a(x08), .b(new_n56_), .c(new_n68_), .O(new_n69_));
  nor2   g44(.a(new_n30_), .b(x00), .O(new_n70_));
  aoi22  g45(.a(new_n70_), .b(new_n67_), .c(new_n69_), .d(x01), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n66_), .c(new_n45_), .O(z6));
  nand2  g47(.a(x03), .b(new_n25_), .O(new_n73_));
  aoi21  g48(.a(new_n40_), .b(x02), .c(new_n73_), .O(new_n74_));
  nor2   g49(.a(new_n34_), .b(x01), .O(new_n75_));
  nor2   g50(.a(new_n58_), .b(x02), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n77_));
  oai21  g52(.a(new_n74_), .b(x08), .c(new_n77_), .O(z7));
  nand4  g53(.a(new_n41_), .b(new_n58_), .c(new_n40_), .d(x00), .O(z8));
  one    g54(.O(z5));
endmodule
