// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:45 2020
...
module FAU ( 
  ...
  aoi21  g35(.a(x09), .b(new_n25_), .c(new_n59_), .O(new_n60_));
  aoi21  g36(.a(new_n57_), .b(new_n59_), .c(new_n60_), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(x07), .c(new_n58_), .d(x11), .O(z3));
  inv1   g38(.a(x08), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x02), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(x09), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n41_), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  oai21  g43(.a(new_n63_), .b(x07), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(z4));
  inv1   g45(.a(new_n46_), .O(new_n70_));
  aoi21  g46(.a(x09), .b(new_n25_), .c(x07), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n67_), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n58_), .b(new_n41_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n70_), .d(x13), .O(z5));
  inv1   g50(.a(x09), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n25_), .c(new_n59_), .O(new_n77_));
  nor2   g53(.a(new_n75_), .b(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n26_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n77_), .c(new_n63_), .O(new_n81_));
  nand2  g57(.a(new_n76_), .b(new_n27_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(new_n83_));
  oai21  g59(.a(new_n78_), .b(x02), .c(new_n27_), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x02), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n81_), .c(new_n46_), .O(z6));
  nor2   g65(.a(new_n35_), .b(x01), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand4  g67(.a(new_n42_), .b(new_n63_), .c(new_n41_), .d(x01), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n25_), .O(new_n94_));
  oai21  g70(.a(x07), .b(new_n25_), .c(x03), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n63_), .c(new_n46_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n94_), .O(z7));
  nand3  g73(.a(new_n41_), .b(x02), .c(x00), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n90_), .c(new_n57_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(x02), .b(new_n27_), .O(new_n101_));
  oai21  g77(.a(new_n46_), .b(new_n101_), .c(x09), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n59_), .O(new_n103_));
  nand3  g79(.a(new_n103_), .b(new_n100_), .c(new_n70_), .O(z8));
endmodule
