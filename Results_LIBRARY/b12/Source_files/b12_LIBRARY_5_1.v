...
module FAU ( 
  ...
  nand2  g48(.a(new_n30_), .b(new_n72_), .O(new_n73_));
  oai21  g49(.a(x08), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nor2   g50(.a(new_n25_), .b(x00), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n70_), .c(new_n74_), .d(new_n71_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n69_), .c(new_n45_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n30_), .O(new_n78_));
  inv1   g54(.a(x08), .O(new_n79_));
  nand4  g55(.a(new_n41_), .b(new_n79_), .c(new_n40_), .d(x02), .O(new_n80_));
  ...
  aoi21  g59(.a(new_n83_), .b(new_n79_), .c(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n82_), .O(z7));
  nand2  g61(.a(new_n56_), .b(new_n30_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n83_), .c(x09), .O(new_n87_));
  aoi21  g63(.a(new_n66_), .b(new_n72_), .c(new_n45_), .O(new_n88_));
