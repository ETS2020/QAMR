// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:35 2020
...
module FAU ( 
  ...
  aoi21  g46(.a(x14), .b(x01), .c(new_n25_), .O(new_n71_));
  aoi21  g47(.a(new_n65_), .b(x03), .c(x01), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n68_), .c(x02), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n57_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n70_), .c(new_n46_), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n27_), .O(new_n76_));
  nand4  g52(.a(new_n42_), .b(new_n64_), .c(new_n41_), .d(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n25_), .O(new_n79_));
  oai21  g55(.a(x07), .b(new_n25_), .c(x03), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n64_), .c(new_n46_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n84_));
