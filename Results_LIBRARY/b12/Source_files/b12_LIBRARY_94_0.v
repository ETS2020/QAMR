...
module FAU ( 
  ...
  nor2   g35(.a(x01), .b(x00), .O(new_n60_));
  nor2   g36(.a(x08), .b(new_n52_), .O(new_n61_));
  oai22  g37(.a(new_n61_), .b(new_n60_), .c(new_n54_), .d(x02), .O(new_n62_));
  ...
  nor2   g42(.a(new_n54_), .b(x01), .O(new_n67_));
  nand4  g43(.a(new_n39_), .b(new_n42_), .c(new_n38_), .d(x01), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n67_), .c(new_n35_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n43_), .c(new_n39_), .d(new_n38_), .O(z7));
  nand3  g47(.a(new_n39_), .b(new_n38_), .c(new_n35_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n26_), .c(new_n32_), .O(new_n73_));
  oai21  g49(.a(new_n47_), .b(new_n29_), .c(x02), .O(new_n74_));
  nand4  g50(.a(new_n39_), .b(new_n54_), .c(new_n38_), .d(new_n32_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n52_), .O(new_n77_));
  inv1   g53(.a(x12), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n35_), .c(new_n32_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x09), .c(new_n59_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n77_), .O(z8));
endmodule
