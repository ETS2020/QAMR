// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:34 2020
...
module FAU ( 
  ...
  inv1   g59(.a(new_n46_), .O(new_n84_));
  inv1   g60(.a(x12), .O(new_n85_));
  nand3  g61(.a(x03), .b(new_n25_), .c(new_n27_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nor2   g63(.a(x07), .b(x00), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x09), .c(x12), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(z8));
endmodule
