// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:26 2020
...
module FAU ( 
  ...
  nand2  g53(.a(new_n77_), .b(new_n57_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n71_), .c(new_n46_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n27_), .O(new_n80_));
  nand4  g56(.a(new_n42_), .b(new_n64_), .c(new_n41_), .d(x01), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n84_), .b(new_n64_), .c(new_n46_), .O(new_n85_));
  ...
  aoi21  g65(.a(new_n65_), .b(new_n57_), .c(new_n46_), .O(new_n90_));
