// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:48 2020
...
module FAU ( 
  ...
  aoi21  g10(.a(new_n34_), .b(new_n28_), .c(x00), .O(z1));
  ...
  nand4  g17(.a(new_n41_), .b(new_n39_), .c(new_n30_), .d(new_n36_), .O(new_n42_));
  inv1   g18(.a(x03), .O(new_n43_));
  oai21  g19(.a(x10), .b(x07), .c(new_n43_), .O(new_n44_));
  nand3  g20(.a(new_n38_), .b(x09), .c(new_n37_), .O(new_n45_));
  nand2  g21(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi22  g22(.a(new_n46_), .b(new_n36_), .c(new_n42_), .d(x02), .O(new_n47_));
  ...
  nand2  g32(.a(new_n56_), .b(new_n37_), .O(new_n57_));
  ...
  aoi21  g39(.a(new_n63_), .b(new_n25_), .c(new_n54_), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n43_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x01), .c(new_n26_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  aoi21  g43(.a(new_n65_), .b(new_n25_), .c(x01), .O(new_n68_));
  nand2  g44(.a(x14), .b(x02), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x01), .O(new_n70_));
  oai21  g46(.a(new_n63_), .b(x02), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n54_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n67_), .c(new_n39_), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n36_), .O(new_n74_));
  nand4  g50(.a(new_n38_), .b(new_n61_), .c(new_n37_), .d(x01), .O(new_n75_));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n61_), .c(new_n39_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n25_), .d(new_n36_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n62_), .b(new_n54_), .c(new_n39_), .O(new_n84_));
