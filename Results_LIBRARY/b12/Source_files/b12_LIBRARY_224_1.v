...
module FAU ( 
  ...
  aoi21  g32(.a(x12), .b(new_n56_), .c(x11), .O(z3));
  nor2   g33(.a(x07), .b(new_n56_), .O(new_n58_));
  inv1   g34(.a(x08), .O(new_n59_));
  inv1   g35(.a(x09), .O(new_n60_));
  nor2   g36(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n58_), .c(x11), .O(z4));
  inv1   g38(.a(x11), .O(new_n63_));
  nor3   g39(.a(x12), .b(x07), .c(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n63_), .d(new_n41_), .O(z5));
  oai21  g41(.a(new_n60_), .b(x03), .c(new_n30_), .O(new_n66_));
  ...
  nand4  g52(.a(new_n41_), .b(new_n59_), .c(new_n40_), .d(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n25_), .O(new_n79_));
  nor2   g55(.a(x11), .b(x07), .O(new_n80_));
  nand2  g56(.a(x03), .b(new_n25_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n59_), .c(x10), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n30_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(x09), .O(new_n86_));
  aoi21  g62(.a(new_n60_), .b(new_n56_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n80_), .O(z8));
endmodule
