// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:27 2020
...
module FAU ( 
  ...
  nand4  g37(.a(new_n61_), .b(x13), .c(new_n46_), .d(new_n41_), .O(z5));
  inv1   g38(.a(x08), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nand3  g40(.a(new_n46_), .b(new_n64_), .c(x03), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n25_), .c(new_n56_), .O(new_n66_));
  nand3  g42(.a(x09), .b(new_n35_), .c(new_n27_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n26_), .c(x10), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n63_), .O(new_n69_));
  nand3  g45(.a(new_n46_), .b(x09), .c(new_n35_), .O(new_n70_));
  ...
  oai21  g52(.a(new_n76_), .b(new_n71_), .c(new_n56_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n69_), .c(x07), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n27_), .O(new_n79_));
  nand4  g55(.a(new_n46_), .b(new_n63_), .c(new_n41_), .d(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n46_), .b(new_n41_), .O(new_n83_));
  oai21  g59(.a(x07), .b(new_n25_), .c(x03), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n63_), .c(new_n83_), .O(new_n85_));
  ...
  aoi21  g65(.a(new_n64_), .b(new_n56_), .c(new_n83_), .O(new_n90_));
