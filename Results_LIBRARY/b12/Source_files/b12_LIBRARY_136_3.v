// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:55 2020
...
module FAU ( 
  ...
  nor2   g28(.a(x07), .b(new_n30_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n52_), .c(new_n50_), .O(new_n54_));
  ...
  nand3  g49(.a(new_n53_), .b(new_n41_), .c(new_n50_), .O(new_n74_));
