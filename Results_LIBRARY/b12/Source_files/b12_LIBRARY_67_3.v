...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n73_, new_n75_, new_n76_, new_n77_, new_n78_;
  ...
  nor2   g34(.a(x08), .b(x03), .O(new_n59_));
  nor3   g35(.a(new_n59_), .b(new_n58_), .c(new_n56_), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x07), .O(new_n62_));
  oai21  g38(.a(new_n60_), .b(x07), .c(new_n62_), .O(z4));
  nor2   g39(.a(x12), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  inv1   g41(.a(x08), .O(new_n66_));
  aoi21  g42(.a(new_n34_), .b(new_n25_), .c(new_n56_), .O(new_n67_));
  nor2   g43(.a(x09), .b(x02), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(x01), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(new_n70_));
  aoi21  g46(.a(x14), .b(x02), .c(new_n25_), .O(new_n71_));
  aoi21  g47(.a(new_n68_), .b(new_n34_), .c(x01), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n70_), .c(new_n45_), .O(z6));
  inv1   g50(.a(new_n45_), .O(new_n75_));
  nand3  g51(.a(new_n41_), .b(x02), .c(new_n25_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(x03), .c(x07), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x01), .c(new_n66_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n75_), .O(z7));
  nand4  g55(.a(new_n41_), .b(new_n58_), .c(new_n40_), .d(x00), .O(z8));
endmodule
