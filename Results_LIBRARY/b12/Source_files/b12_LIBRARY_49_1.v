// Benchmark "FAU" written by ABC on Thu Jun 25 19:36:22 2020
...
module FAU ( 
  ...
  aoi21  g34(.a(new_n56_), .b(x09), .c(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n56_), .c(new_n40_), .O(new_n60_));
  oai21  g36(.a(new_n57_), .b(x11), .c(new_n60_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n40_), .O(new_n63_));
  oai21  g39(.a(x11), .b(new_n40_), .c(new_n63_), .O(z4));
  inv1   g40(.a(new_n45_), .O(new_n65_));
  inv1   g41(.a(new_n57_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(new_n30_), .O(new_n68_));
  nor2   g44(.a(x09), .b(x07), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n66_), .c(new_n65_), .d(x13), .O(z5));
  nand2  g47(.a(new_n67_), .b(x03), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n25_), .c(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n25_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n30_), .O(new_n75_));
  oai21  g51(.a(new_n67_), .b(x03), .c(new_n30_), .O(new_n76_));
  inv1   g52(.a(x08), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x00), .O(new_n78_));
  oai21  g54(.a(x01), .b(x00), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(x02), .b(new_n58_), .O(new_n80_));
  oai22  g56(.a(new_n80_), .b(x14), .c(new_n78_), .d(new_n72_), .O(new_n81_));
  aoi21  g57(.a(new_n79_), .b(new_n76_), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n75_), .c(new_n45_), .O(z6));
  nor2   g59(.a(new_n34_), .b(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  nand2  g61(.a(new_n74_), .b(new_n65_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n30_), .O(new_n88_));
  oai21  g64(.a(x07), .b(new_n30_), .c(x03), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n77_), .c(new_n45_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z7));
  aoi21  g67(.a(x12), .b(new_n40_), .c(x02), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n58_), .c(new_n84_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g70(.a(new_n65_), .b(x02), .c(new_n25_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n56_), .c(x09), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n94_), .c(new_n65_), .O(z8));
endmodule
