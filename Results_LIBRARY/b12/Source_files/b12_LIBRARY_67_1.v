...
module FAU ( 
  ...
  nor2   g41(.a(x14), .b(new_n25_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n28_), .c(new_n57_), .O(new_n67_));
  inv1   g43(.a(x08), .O(new_n68_));
  oai21  g44(.a(x09), .b(new_n35_), .c(new_n25_), .O(new_n69_));
  nand2  g45(.a(new_n27_), .b(new_n57_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n57_), .c(new_n70_), .O(new_n71_));
  aoi22  g47(.a(new_n71_), .b(new_n69_), .c(new_n28_), .d(new_n68_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n67_), .c(new_n46_), .O(z6));
  inv1   g49(.a(x09), .O(new_n74_));
  nand4  g50(.a(new_n42_), .b(new_n68_), .c(new_n41_), .d(x02), .O(new_n75_));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n68_), .c(new_n46_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  nor3   g56(.a(x12), .b(x02), .c(x01), .O(new_n81_));
  aoi21  g57(.a(new_n74_), .b(new_n57_), .c(new_n46_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(new_n74_), .c(new_n82_), .O(z8));
endmodule
