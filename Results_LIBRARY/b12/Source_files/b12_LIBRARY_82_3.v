...
module FAU ( 
  ...
  aoi21  g44(.a(new_n68_), .b(new_n27_), .c(new_n57_), .O(new_n69_));
  ...
  aoi21  g48(.a(new_n68_), .b(new_n25_), .c(x01), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x02), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n70_), .c(new_n26_), .O(new_n76_));
  ...
  nand4  g55(.a(new_n42_), .b(new_n66_), .c(new_n41_), .d(x02), .O(new_n80_));
  ...
  nand2  g61(.a(new_n62_), .b(new_n25_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n83_), .c(x09), .O(new_n87_));
