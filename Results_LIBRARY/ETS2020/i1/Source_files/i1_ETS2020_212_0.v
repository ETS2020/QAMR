...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n58_, new_n61_, new_n62_, new_n63_, new_n70_, new_n72_, new_n74_,
    new_n76_, new_n77_;
  ...
  nor2   g18(.a(x08), .b(x07), .O(new_n62_));
  nand3  g19(.a(new_n62_), .b(new_n46_), .c(x19), .O(new_n63_));
  oai21  g20(.a(new_n63_), .b(new_n52_), .c(new_n61_), .O(z05));
  and2   g21(.a(x24), .b(x18), .O(z07));
  nand2  g22(.a(x23), .b(x14), .O(new_n70_));
  nor2   g23(.a(new_n70_), .b(x24), .O(z12));
  nand2  g24(.a(x23), .b(x17), .O(new_n72_));
  nor2   g25(.a(new_n72_), .b(x24), .O(z13));
  inv1   g26(.a(x16), .O(new_n74_));
  nor2   g27(.a(x24), .b(new_n74_), .O(z14));
  nor2   g28(.a(x13), .b(x12), .O(new_n76_));
  nor2   g29(.a(x15), .b(x14), .O(new_n77_));
  nand2  g30(.a(new_n77_), .b(new_n76_), .O(z15));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z08));
  zero   g34(.O(z09));
