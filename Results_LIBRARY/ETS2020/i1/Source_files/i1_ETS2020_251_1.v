// Benchmark "FAU" written by ABC on Tue Jun 23 01:16:12 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n58_, new_n62_, new_n63_, new_n64_, new_n70_, new_n72_, new_n74_,
  ...
  nand2  g21(.a(x22), .b(x17), .O(new_n70_));
  nor2   g22(.a(new_n70_), .b(x24), .O(z11));
  nand2  g23(.a(x23), .b(x14), .O(new_n72_));
  nor2   g24(.a(new_n72_), .b(x24), .O(z12));
  nand2  g25(.a(x23), .b(x17), .O(new_n74_));
  nor2   g26(.a(new_n74_), .b(x24), .O(z13));
  inv1   g27(.a(x16), .O(new_n76_));
  nor2   g28(.a(x24), .b(new_n76_), .O(z14));
  nor2   g29(.a(x13), .b(x12), .O(new_n78_));
  nor2   g30(.a(x15), .b(x14), .O(new_n79_));
  nand2  g31(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z01));
  zero   g34(.O(z03));
  zero   g35(.O(z04));
