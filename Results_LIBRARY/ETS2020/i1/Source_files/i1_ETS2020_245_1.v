...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n69_, new_n70_, new_n71_, new_n75_, new_n76_, new_n78_,
    new_n80_, new_n83_, new_n85_, new_n86_;
  ...
  nand3  g26(.a(new_n70_), .b(new_n60_), .c(x19), .O(new_n71_));
  oai21  g27(.a(new_n71_), .b(new_n50_), .c(new_n69_), .O(z05));
  and2   g28(.a(x24), .b(x18), .O(z07));
  and2   g29(.a(x24), .b(x11), .O(z09));
  inv1   g30(.a(x14), .O(new_n75_));
  inv1   g31(.a(x22), .O(new_n76_));
  nor3   g32(.a(x24), .b(new_n76_), .c(new_n75_), .O(z10));
  inv1   g33(.a(x17), .O(new_n78_));
  nor3   g34(.a(x24), .b(new_n76_), .c(new_n78_), .O(z11));
  inv1   g35(.a(x23), .O(new_n80_));
  nor3   g36(.a(x24), .b(new_n80_), .c(new_n75_), .O(z12));
  nor3   g37(.a(x24), .b(new_n80_), .c(new_n78_), .O(z13));
  inv1   g38(.a(x16), .O(new_n83_));
  nor2   g39(.a(x24), .b(new_n83_), .O(z14));
  nor2   g40(.a(x13), .b(x12), .O(new_n85_));
  nor2   g41(.a(x15), .b(x14), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n85_), .O(z15));
  zero   g43(.O(z00));
  zero   g44(.O(z03));
  zero   g45(.O(z04));
  buf    g46(.a(x19), .O(z06));
