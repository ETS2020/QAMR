...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n69_, new_n70_, new_n71_, new_n75_, new_n77_, new_n80_,
  ...
  nand2  g31(.a(x22), .b(x14), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(x24), .O(z10));
  nand2  g33(.a(x22), .b(x17), .O(new_n77_));
  nor2   g34(.a(new_n77_), .b(x24), .O(z11));
  nand2  g35(.a(x23), .b(x17), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(x24), .O(z13));
