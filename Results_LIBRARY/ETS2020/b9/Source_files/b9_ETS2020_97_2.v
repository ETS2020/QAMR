// Benchmark "FAU" written by ABC on Fri Jun 26 04:18:03 2020
...
module FAU ( 
  ...
  inv1   g092(.a(x24), .O(new_n157_));
  nand4  g093(.a(new_n157_), .b(x23), .c(x22), .d(x01), .O(new_n158_));
  inv1   g094(.a(new_n158_), .O(z17));
  oai21  g095(.a(new_n75_), .b(x27), .c(new_n113_), .O(new_n160_));
  nand2  g096(.a(new_n160_), .b(x08), .O(new_n161_));
  nand3  g097(.a(new_n161_), .b(new_n120_), .c(new_n118_), .O(z18));
  oai21  g098(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n163_));
  oai21  g099(.a(new_n74_), .b(x27), .c(x35), .O(new_n164_));
  nand2  g100(.a(new_n164_), .b(new_n113_), .O(new_n165_));
  aoi21  g101(.a(new_n165_), .b(new_n163_), .c(new_n121_), .O(z20));
  zero   g102(.O(z02));
  zero   g103(.O(z15));
