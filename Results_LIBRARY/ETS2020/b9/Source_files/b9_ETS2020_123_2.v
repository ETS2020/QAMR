...
module FAU ( 
  ...
  nand2  g47(.a(new_n78_), .b(new_n80_), .O(new_n112_));
  nand2  g48(.a(new_n112_), .b(x27), .O(new_n113_));
  oai21  g49(.a(new_n75_), .b(x04), .c(new_n113_), .O(new_n114_));
  oai21  g50(.a(new_n111_), .b(x10), .c(new_n114_), .O(z12));
  inv1   g51(.a(x35), .O(new_n116_));
  oai21  g52(.a(new_n65_), .b(new_n116_), .c(x28), .O(new_n117_));
  nor2   g53(.a(x13), .b(x04), .O(new_n118_));
  nand3  g54(.a(new_n118_), .b(new_n117_), .c(z08), .O(new_n119_));
  nor2   g55(.a(x19), .b(x18), .O(new_n120_));
  nand3  g56(.a(new_n120_), .b(new_n112_), .c(x20), .O(new_n121_));
  nand2  g57(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g58(.a(new_n122_), .b(x27), .O(new_n123_));
  nand3  g59(.a(new_n118_), .b(z08), .c(new_n70_), .O(new_n124_));
  nand2  g60(.a(new_n124_), .b(new_n123_), .O(z13));
  nand4  g61(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  inv1   g62(.a(new_n127_), .O(z15));
  nand2  g63(.a(x22), .b(x01), .O(new_n129_));
  nor2   g64(.a(new_n129_), .b(x23), .O(z16));
  inv1   g65(.a(x24), .O(new_n131_));
  nand4  g66(.a(new_n131_), .b(x23), .c(x22), .d(x01), .O(new_n132_));
  inv1   g67(.a(new_n132_), .O(z17));
  nand2  g68(.a(z08), .b(x29), .O(new_n134_));
  oai21  g69(.a(new_n67_), .b(x27), .c(new_n134_), .O(new_n135_));
  nand2  g70(.a(new_n135_), .b(x08), .O(new_n136_));
  inv1   g71(.a(x04), .O(new_n137_));
  nand4  g72(.a(x35), .b(new_n66_), .c(x27), .d(new_n137_), .O(new_n138_));
  nor2   g73(.a(x30), .b(x09), .O(new_n139_));
  nand3  g74(.a(new_n139_), .b(new_n138_), .c(new_n136_), .O(z18));
  inv1   g75(.a(new_n139_), .O(new_n141_));
  nor2   g76(.a(new_n64_), .b(new_n137_), .O(new_n142_));
  oai21  g77(.a(new_n142_), .b(new_n67_), .c(new_n134_), .O(new_n143_));
  inv1   g78(.a(x08), .O(new_n144_));
  nand2  g79(.a(new_n138_), .b(new_n144_), .O(new_n145_));
  aoi21  g80(.a(new_n145_), .b(new_n143_), .c(new_n141_), .O(z19));
  oai21  g81(.a(new_n116_), .b(new_n64_), .c(new_n144_), .O(new_n147_));
  oai21  g82(.a(new_n66_), .b(x27), .c(x35), .O(new_n148_));
  nand2  g83(.a(new_n148_), .b(new_n134_), .O(new_n149_));
  aoi21  g84(.a(new_n149_), .b(new_n147_), .c(new_n141_), .O(z20));
  zero   g85(.O(z00));
  zero   g86(.O(z11));
  zero   g87(.O(z14));
endmodule
