// Benchmark "FAU" written by ABC on Fri Jun 26 04:25:57 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    new_n70_, new_n86_, new_n89_, new_n90_;
  ...
  nand4  g11(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n86_));
  inv1   g12(.a(new_n86_), .O(z15));
  inv1   g13(.a(x24), .O(new_n89_));
  nand4  g14(.a(new_n89_), .b(x23), .c(x22), .d(x01), .O(new_n90_));
  inv1   g15(.a(new_n90_), .O(z17));
  zero   g16(.O(z01));
  zero   g17(.O(z02));
  zero   g18(.O(z03));
  zero   g19(.O(z04));
