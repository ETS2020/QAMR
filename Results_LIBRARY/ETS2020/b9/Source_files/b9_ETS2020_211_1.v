...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n97_, new_n102_,
  ...
  nand3  g25(.a(x40), .b(x39), .c(x29), .O(new_n102_));
  and2   g26(.a(x27), .b(x04), .O(new_n103_));
  inv1   g27(.a(x28), .O(new_n104_));
  nand2  g28(.a(x35), .b(new_n104_), .O(new_n105_));
  oai21  g29(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(new_n106_));
  inv1   g30(.a(x08), .O(new_n107_));
  nand2  g31(.a(x27), .b(new_n64_), .O(new_n108_));
  oai21  g32(.a(new_n108_), .b(new_n105_), .c(new_n107_), .O(new_n109_));
  or2    g33(.a(x30), .b(x09), .O(new_n110_));
  aoi21  g34(.a(new_n109_), .b(new_n106_), .c(new_n110_), .O(z19));
  zero   g35(.O(z01));
  zero   g36(.O(z02));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
