// Benchmark "FAU" written by ABC on Fri Jun 26 04:19:51 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n142_, new_n143_, new_n145_, new_n148_, new_n149_,
  ...
  inv1   g80(.a(x24), .O(new_n148_));
  nand4  g81(.a(new_n148_), .b(x23), .c(x22), .d(x01), .O(new_n149_));
  inv1   g82(.a(new_n149_), .O(z17));
  oai21  g83(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n151_));
  nand2  g84(.a(new_n151_), .b(x08), .O(new_n152_));
  nand3  g85(.a(new_n152_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g86(.a(new_n86_), .b(new_n72_), .c(new_n108_), .O(new_n154_));
  oai21  g87(.a(new_n74_), .b(x27), .c(x35), .O(new_n155_));
  nand2  g88(.a(new_n155_), .b(new_n105_), .O(new_n156_));
  aoi21  g89(.a(new_n156_), .b(new_n154_), .c(new_n112_), .O(z20));
  zero   g90(.O(z05));
  zero   g91(.O(z06));
  zero   g92(.O(z07));
  zero   g93(.O(z09));
  zero   g94(.O(z16));
  aoi21  g95(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
