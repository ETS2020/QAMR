...
module FAU ( 
  ...
  nand3  g27(.a(x40), .b(x39), .c(x29), .O(new_n103_));
  and2   g28(.a(x27), .b(x04), .O(new_n104_));
  inv1   g29(.a(x28), .O(new_n105_));
  nand2  g30(.a(x35), .b(new_n105_), .O(new_n106_));
  oai21  g31(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  inv1   g32(.a(x08), .O(new_n108_));
  nand2  g33(.a(x27), .b(new_n64_), .O(new_n109_));
  oai21  g34(.a(new_n109_), .b(new_n106_), .c(new_n108_), .O(new_n110_));
  or2    g35(.a(x30), .b(x09), .O(new_n111_));
  aoi21  g36(.a(new_n110_), .b(new_n107_), .c(new_n111_), .O(z19));
  zero   g37(.O(z01));
  zero   g38(.O(z02));
  zero   g39(.O(z03));
  zero   g40(.O(z04));
