...
module FAU ( 
  ...
  nand2  g38(.a(x27), .b(new_n99_), .O(new_n103_));
  oai21  g39(.a(new_n103_), .b(new_n67_), .c(new_n102_), .O(new_n104_));
  inv1   g40(.a(x09), .O(new_n105_));
  inv1   g41(.a(x30), .O(new_n106_));
  nand2  g42(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g43(.a(new_n104_), .b(new_n101_), .c(new_n107_), .O(z11));
  nor2   g44(.a(x36), .b(x35), .O(new_n109_));
  aoi21  g45(.a(new_n109_), .b(new_n80_), .c(new_n64_), .O(new_n110_));
  aoi21  g46(.a(x35), .b(x28), .c(x37), .O(new_n111_));
  nor2   g47(.a(new_n111_), .b(new_n64_), .O(new_n112_));
  nor2   g48(.a(new_n75_), .b(x04), .O(new_n113_));
  oai22  g49(.a(new_n113_), .b(new_n112_), .c(new_n110_), .d(x10), .O(z12));
  aoi21  g50(.a(x36), .b(x35), .c(new_n66_), .O(new_n115_));
  ...
  oai22  g55(.a(new_n119_), .b(new_n111_), .c(new_n117_), .d(new_n115_), .O(new_n120_));
  nand2  g56(.a(new_n120_), .b(x27), .O(new_n121_));
  nand3  g57(.a(new_n116_), .b(z08), .c(new_n70_), .O(new_n122_));
  nand2  g58(.a(new_n122_), .b(new_n121_), .O(z13));
  inv1   g59(.a(x32), .O(new_n124_));
  nand2  g60(.a(x36), .b(x35), .O(new_n125_));
  nand4  g61(.a(new_n125_), .b(new_n124_), .c(new_n106_), .d(x28), .O(new_n126_));
  inv1   g62(.a(new_n126_), .O(new_n127_));
  oai21  g63(.a(new_n127_), .b(new_n117_), .c(new_n119_), .O(new_n128_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n64_), .c(new_n117_), .O(new_n132_));
  ...
  oai21  g76(.a(new_n78_), .b(new_n64_), .c(new_n102_), .O(new_n142_));
  oai21  g77(.a(new_n66_), .b(x27), .c(x35), .O(new_n143_));
  nand2  g78(.a(new_n143_), .b(new_n98_), .O(new_n144_));
  aoi21  g79(.a(new_n144_), .b(new_n142_), .c(new_n107_), .O(z20));
  zero   g80(.O(z00));
  zero   g81(.O(z07));
  zero   g82(.O(z18));
  aoi21  g83(.a(new_n104_), .b(new_n101_), .c(new_n107_), .O(z19));
endmodule
