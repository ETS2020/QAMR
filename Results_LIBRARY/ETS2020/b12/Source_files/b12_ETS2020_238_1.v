// Benchmark "FAU" written by ABC on Tue Jun 23 04:24:28 2020
...
module FAU ( 
  ...
  nand3  g40(.a(x09), .b(x03), .c(new_n31_), .O(new_n66_));
  nand4  g41(.a(new_n41_), .b(new_n44_), .c(new_n40_), .d(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n35_), .O(new_n69_));
  nand2  g44(.a(x03), .b(new_n35_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n44_), .c(new_n57_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n69_), .O(z7));
  inv1   g47(.a(x12), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n31_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n70_), .c(x09), .O(new_n75_));
  aoi21  g50(.a(new_n51_), .b(new_n49_), .c(new_n57_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(z8));
  zero   g52(.O(z0));
endmodule
