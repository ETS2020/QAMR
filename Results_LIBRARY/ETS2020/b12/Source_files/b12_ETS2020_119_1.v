...
module FAU ( 
  ...
  aoi21  g29(.a(x09), .b(new_n27_), .c(x02), .O(new_n56_));
  nand3  g30(.a(new_n51_), .b(x03), .c(new_n31_), .O(new_n57_));
  oai21  g31(.a(new_n56_), .b(x01), .c(new_n57_), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(new_n52_), .O(new_n59_));
  nand2  g33(.a(new_n31_), .b(new_n49_), .O(new_n60_));
  oai21  g34(.a(x08), .b(new_n49_), .c(new_n60_), .O(new_n61_));
  inv1   g35(.a(x14), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x02), .c(new_n49_), .O(new_n63_));
  inv1   g37(.a(new_n63_), .O(new_n64_));
  aoi21  g38(.a(new_n61_), .b(x01), .c(new_n64_), .O(new_n65_));
  nand2  g39(.a(new_n41_), .b(new_n40_), .O(new_n66_));
  aoi21  g40(.a(new_n65_), .b(new_n59_), .c(new_n66_), .O(z6));
  nor2   g41(.a(x07), .b(new_n31_), .O(new_n68_));
  nand2  g42(.a(x03), .b(new_n35_), .O(new_n69_));
  oai21  g43(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(new_n70_));
  nor2   g44(.a(x02), .b(x01), .O(new_n71_));
  nor2   g45(.a(new_n51_), .b(new_n27_), .O(new_n72_));
  aoi21  g46(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n70_), .O(z7));
  inv1   g48(.a(x12), .O(new_n75_));
  nand3  g49(.a(new_n71_), .b(new_n75_), .c(x03), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(x09), .O(new_n77_));
  aoi21  g51(.a(new_n51_), .b(new_n49_), .c(new_n66_), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n77_), .O(z8));
  zero   g53(.O(z0));
  zero   g54(.O(z5));
endmodule
