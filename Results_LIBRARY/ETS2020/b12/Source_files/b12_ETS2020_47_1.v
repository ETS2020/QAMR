...
module FAU ( 
  ...
  nand2  g25(.a(x08), .b(x00), .O(new_n53_));
  aoi21  g26(.a(x09), .b(new_n27_), .c(x02), .O(new_n54_));
  inv1   g27(.a(x09), .O(new_n55_));
  nand3  g28(.a(new_n55_), .b(x03), .c(new_n31_), .O(new_n56_));
  oai21  g29(.a(new_n54_), .b(x01), .c(new_n56_), .O(new_n57_));
  nand2  g30(.a(new_n57_), .b(new_n53_), .O(new_n58_));
  nand2  g31(.a(new_n31_), .b(new_n49_), .O(new_n59_));
  oai21  g32(.a(x08), .b(new_n49_), .c(new_n59_), .O(new_n60_));
  inv1   g33(.a(x14), .O(new_n61_));
  nand3  g34(.a(new_n61_), .b(x02), .c(new_n49_), .O(new_n62_));
  inv1   g35(.a(new_n62_), .O(new_n63_));
  aoi21  g36(.a(new_n60_), .b(x01), .c(new_n63_), .O(new_n64_));
  nand2  g37(.a(new_n41_), .b(new_n40_), .O(new_n65_));
  aoi21  g38(.a(new_n64_), .b(new_n58_), .c(new_n65_), .O(z6));
  nand3  g39(.a(x09), .b(x03), .c(new_n31_), .O(new_n67_));
  nand4  g40(.a(new_n41_), .b(new_n44_), .c(new_n40_), .d(x02), .O(new_n68_));
  nand2  g41(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g42(.a(new_n69_), .b(new_n35_), .O(new_n70_));
  nand2  g43(.a(x03), .b(new_n35_), .O(new_n71_));
  aoi21  g44(.a(new_n71_), .b(new_n44_), .c(new_n65_), .O(new_n72_));
  nand2  g45(.a(new_n72_), .b(new_n70_), .O(z7));
  zero   g46(.O(z0));
  zero   g47(.O(z4));
  zero   g48(.O(z5));
  zero   g49(.O(z8));
