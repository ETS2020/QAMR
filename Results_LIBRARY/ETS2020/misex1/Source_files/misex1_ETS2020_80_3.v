...
module FAU ( 
  ...
  nand2  g15(.a(new_n24_), .b(x2), .O(new_n33_));
  oai21  g16(.a(x4), .b(x3), .c(x7), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n21_), .c(x1), .O(new_n35_));
  oai21  g18(.a(new_n27_), .b(new_n33_), .c(new_n35_), .O(new_n36_));
