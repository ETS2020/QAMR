...
module FAU ( 
  ...
  inv1   g17(.a(x00), .O(new_n50_));
  nor2   g18(.a(x10), .b(new_n50_), .O(new_n51_));
  oai21  g19(.a(x10), .b(new_n50_), .c(new_n32_), .O(new_n52_));
  nand2  g20(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  nand3  g21(.a(new_n44_), .b(new_n37_), .c(x04), .O(new_n54_));
  nand3  g22(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(z08));
  xnor2a g23(.a(x12), .b(x11), .O(new_n56_));
  and2   g24(.a(new_n56_), .b(new_n51_), .O(z09));
  nand3  g25(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  nand2  g26(.a(new_n58_), .b(x12), .O(new_n59_));
  inv1   g27(.a(x10), .O(new_n60_));
  nand4  g28(.a(x11), .b(new_n60_), .c(x09), .d(x00), .O(new_n61_));
  nor2   g29(.a(new_n61_), .b(new_n59_), .O(z10));
  nand4  g30(.a(new_n58_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nand2  g31(.a(new_n32_), .b(new_n30_), .O(new_n64_));
  nand3  g32(.a(x11), .b(new_n60_), .c(x00), .O(new_n65_));
