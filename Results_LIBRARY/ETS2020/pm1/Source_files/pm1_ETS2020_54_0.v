...
module FAU ( 
  ...
  xor2a  g12(.a(x12), .b(x11), .O(new_n45_));
  inv1   g13(.a(x10), .O(new_n46_));
  nand2  g14(.a(new_n46_), .b(x00), .O(new_n47_));
  nor2   g15(.a(new_n47_), .b(new_n45_), .O(z09));
  nand2  g16(.a(new_n39_), .b(x12), .O(new_n49_));
  nand4  g17(.a(x11), .b(new_n46_), .c(x09), .d(x00), .O(new_n50_));
  nor2   g18(.a(new_n50_), .b(new_n49_), .O(z10));
  nand4  g19(.a(new_n39_), .b(x12), .c(x09), .d(x01), .O(new_n52_));
  or2    g20(.a(x12), .b(x01), .O(new_n53_));
  nand3  g21(.a(x11), .b(new_n46_), .c(x00), .O(new_n54_));
  aoi21  g22(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(z11));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z08));
  zero   g26(.O(z12));
