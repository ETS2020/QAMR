// Benchmark "FAU" written by ABC on Tue Jun 23 00:42:42 2020
...
module FAU ( 
  ...
  inv1   g15(.a(x14), .O(new_n50_));
  nand2  g16(.a(x08), .b(x05), .O(new_n51_));
  oai21  g17(.a(new_n50_), .b(x08), .c(new_n51_), .O(z13));
  inv1   g18(.a(x15), .O(new_n53_));
  nand2  g19(.a(x08), .b(x06), .O(new_n54_));
  oai21  g20(.a(new_n53_), .b(x08), .c(new_n54_), .O(z14));
  inv1   g21(.a(x16), .O(new_n56_));
  nand2  g22(.a(x08), .b(x07), .O(new_n57_));
  oai21  g23(.a(new_n56_), .b(x08), .c(new_n57_), .O(z15));
  zero   g24(.O(z02));
  buf    g25(.a(x09), .O(z00));
  buf    g26(.a(x10), .O(z01));
  buf    g27(.a(x12), .O(z03));
