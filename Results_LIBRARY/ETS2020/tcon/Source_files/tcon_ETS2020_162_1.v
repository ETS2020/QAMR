// Benchmark "FAU" written by ABC on Tue Jun 23 00:43:13 2020
...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n42_, new_n43_, new_n45_,
    new_n46_, new_n49_, new_n50_, new_n52_, new_n53_;
  ...
  inv1   g12(.a(x15), .O(new_n49_));
  nand2  g13(.a(x08), .b(x06), .O(new_n50_));
  oai21  g14(.a(new_n49_), .b(x08), .c(new_n50_), .O(z14));
  inv1   g15(.a(x16), .O(new_n52_));
  nand2  g16(.a(x08), .b(x07), .O(new_n53_));
  oai21  g17(.a(new_n52_), .b(x08), .c(new_n53_), .O(z15));
  zero   g18(.O(z00));
  zero   g19(.O(z10));
  zero   g20(.O(z13));
  buf    g21(.a(x10), .O(z01));
