// Benchmark "FAU" written by ABC on Tue Jun 23 00:18:43 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n42_, new_n43_, new_n44_, new_n49_;
  ...
  nand3  g19(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n43_), .O(z11));
  nand2  g21(.a(new_n32_), .b(new_n42_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n44_), .O(z15));
  zero   g23(.O(z08));
  zero   g24(.O(z09));
  zero   g25(.O(z10));
  zero   g26(.O(z12));
