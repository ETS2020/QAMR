// Benchmark "FAU" written by ABC on Fri Jul 24 18:19:21 2020
...
module FAU ( 
  ...
  nand4  g080(.a(new_n56_), .b(x20), .c(x14), .d(x11), .O(new_n115_));
  nor2   g081(.a(new_n115_), .b(new_n66_), .O(new_n116_));
  nand4  g082(.a(new_n116_), .b(x06), .c(x03), .d(x01), .O(new_n117_));
  nand4  g083(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n118_));
  nor2   g084(.a(new_n118_), .b(x08), .O(new_n119_));
  nand4  g085(.a(new_n119_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n120_));
  nand2  g086(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g087(.a(new_n121_), .b(new_n39_), .O(new_n122_));
  nand2  g088(.a(new_n46_), .b(new_n37_), .O(new_n123_));
  nand4  g089(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n124_));
  nand3  g090(.a(new_n90_), .b(x14), .c(x11), .O(new_n125_));
  nand4  g091(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n126_));
  nand4  g092(.a(new_n71_), .b(new_n68_), .c(new_n36_), .d(new_n66_), .O(new_n127_));
  ...
  nand4  g096(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n131_));
  nand4  g097(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n132_));
  oai22  g098(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n124_), .O(new_n133_));
  nand3  g099(.a(new_n133_), .b(new_n46_), .c(new_n37_), .O(new_n134_));
  nand3  g100(.a(new_n134_), .b(new_n129_), .c(new_n122_), .O(z3));
  aoi21  g101(.a(new_n73_), .b(x04), .c(x17), .O(new_n136_));
  oai21  g102(.a(new_n136_), .b(x22), .c(new_n67_), .O(new_n137_));
  aoi21  g103(.a(new_n137_), .b(new_n69_), .c(x08), .O(new_n138_));
  nand2  g104(.a(x24), .b(x18), .O(new_n139_));
  nand3  g105(.a(new_n39_), .b(x15), .c(x13), .O(new_n140_));
  aoi21  g106(.a(new_n140_), .b(new_n139_), .c(new_n37_), .O(new_n141_));
  nand3  g107(.a(x24), .b(x18), .c(x13), .O(new_n142_));
  nand3  g108(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n143_));
  nand4  g109(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n144_));
  nand3  g110(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nor2   g111(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  aoi21  g112(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n147_));
  oai21  g113(.a(new_n147_), .b(new_n72_), .c(x09), .O(new_n148_));
  aoi21  g114(.a(new_n148_), .b(x16), .c(new_n66_), .O(new_n149_));
  oai22  g115(.a(new_n149_), .b(new_n146_), .c(new_n138_), .d(new_n49_), .O(z4));
  inv1   g116(.a(new_n49_), .O(z5));
  nand2  g117(.a(x20), .b(new_n68_), .O(new_n152_));
  nand2  g118(.a(new_n152_), .b(new_n35_), .O(new_n153_));
  aoi21  g119(.a(new_n153_), .b(new_n36_), .c(x03), .O(new_n154_));
  nand2  g120(.a(new_n71_), .b(x14), .O(new_n155_));
  nand2  g121(.a(new_n155_), .b(x06), .O(new_n156_));
  aoi21  g122(.a(new_n156_), .b(x11), .c(new_n34_), .O(new_n157_));
  oai22  g123(.a(new_n157_), .b(new_n146_), .c(new_n154_), .d(new_n49_), .O(z6));
  inv1   g124(.a(new_n146_), .O(z7));
  zero   g125(.O(z2));
endmodule
