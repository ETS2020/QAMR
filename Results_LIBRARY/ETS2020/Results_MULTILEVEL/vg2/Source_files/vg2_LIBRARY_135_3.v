...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n142_, new_n143_, new_n144_, new_n148_, new_n149_, new_n150_,
  ...
  nand2  g113(.a(x20), .b(new_n68_), .O(new_n148_));
  nand2  g114(.a(new_n148_), .b(new_n35_), .O(new_n149_));
  aoi21  g115(.a(new_n149_), .b(new_n36_), .c(x03), .O(new_n150_));
  nand2  g116(.a(new_n71_), .b(x14), .O(new_n151_));
  nand2  g117(.a(new_n151_), .b(x06), .O(new_n152_));
  aoi21  g118(.a(new_n152_), .b(x11), .c(new_n34_), .O(new_n153_));
  oai22  g119(.a(new_n153_), .b(new_n121_), .c(new_n150_), .d(new_n49_), .O(z6));
  inv1   g120(.a(new_n121_), .O(z7));
  zero   g121(.O(z4));
endmodule
