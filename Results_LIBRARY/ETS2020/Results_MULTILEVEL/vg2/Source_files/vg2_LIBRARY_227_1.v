...
module FAU ( 
  ...
  aoi21  g090(.a(new_n73_), .b(x04), .c(x17), .O(new_n125_));
  oai21  g091(.a(new_n125_), .b(x22), .c(new_n67_), .O(new_n126_));
  aoi21  g092(.a(new_n126_), .b(new_n69_), .c(x08), .O(new_n127_));
  aoi21  g093(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n128_));
  oai21  g094(.a(new_n128_), .b(new_n72_), .c(x09), .O(new_n129_));
  aoi21  g095(.a(new_n129_), .b(x16), .c(new_n66_), .O(new_n130_));
  oai22  g096(.a(new_n130_), .b(new_n120_), .c(new_n127_), .d(new_n49_), .O(z4));
  inv1   g097(.a(new_n49_), .O(z5));
  nand2  g098(.a(x20), .b(new_n68_), .O(new_n133_));
  nand2  g099(.a(new_n133_), .b(new_n35_), .O(new_n134_));
  aoi21  g100(.a(new_n134_), .b(new_n36_), .c(x03), .O(new_n135_));
  nand2  g101(.a(new_n71_), .b(x14), .O(new_n136_));
  nand2  g102(.a(new_n136_), .b(x06), .O(new_n137_));
  aoi21  g103(.a(new_n137_), .b(x11), .c(new_n34_), .O(new_n138_));
  oai22  g104(.a(new_n138_), .b(new_n120_), .c(new_n135_), .d(new_n49_), .O(z6));
  inv1   g105(.a(new_n120_), .O(z7));
  zero   g106(.O(z3));
endmodule
