...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(x08), .O(new_n59_));
  nand2  g08(.a(new_n59_), .b(x15), .O(new_n60_));
  inv1   g09(.a(x15), .O(new_n61_));
  nand4  g10(.a(new_n61_), .b(x10), .c(x08), .d(x02), .O(new_n62_));
  aoi21  g11(.a(new_n62_), .b(new_n60_), .c(new_n54_), .O(z14));
  zero   g12(.O(z01));
  zero   g13(.O(z02));
  zero   g14(.O(z03));
  zero   g15(.O(z05));
