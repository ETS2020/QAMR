...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n63_, new_n64_, new_n65_,
    new_n66_;
  ...
  nand4  g10(.a(new_n63_), .b(x10), .c(x08), .d(x07), .O(new_n66_));
  aoi21  g11(.a(new_n66_), .b(new_n65_), .c(new_n53_), .O(z19));
  zero   g12(.O(z01));
  zero   g13(.O(z02));
  zero   g14(.O(z03));
  zero   g15(.O(z06));
