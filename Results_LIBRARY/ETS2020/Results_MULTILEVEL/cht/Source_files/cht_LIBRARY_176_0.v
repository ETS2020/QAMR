...
module FAU ( 
  ...
  nand2  g66(.a(x34), .b(new_n145_), .O(new_n152_));
  nand2  g67(.a(x35), .b(x09), .O(new_n153_));
  aoi21  g68(.a(new_n153_), .b(new_n152_), .c(x10), .O(z23));
  nand2  g69(.a(x37), .b(new_n145_), .O(new_n157_));
  nand2  g70(.a(x38), .b(x09), .O(new_n158_));
  aoi21  g71(.a(new_n158_), .b(new_n157_), .c(x10), .O(z26));
  inv1   g72(.a(x39), .O(new_n160_));
  nand2  g73(.a(x14), .b(x00), .O(new_n161_));
  oai21  g74(.a(new_n160_), .b(x14), .c(new_n161_), .O(new_n162_));
  nand2  g75(.a(new_n162_), .b(x09), .O(new_n163_));
  nand2  g76(.a(x38), .b(new_n145_), .O(new_n164_));
  aoi21  g77(.a(new_n164_), .b(new_n163_), .c(x10), .O(z27));
  zero   g78(.O(z11));
  zero   g79(.O(z20));
  zero   g80(.O(z24));
  zero   g81(.O(z25));
