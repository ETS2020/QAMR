...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n144_, new_n145_, new_n149_, new_n150_, new_n156_, new_n157_,
    new_n158_;
  ...
  oai21  g60(.a(x14), .b(new_n136_), .c(x42), .O(new_n156_));
  inv1   g61(.a(x14), .O(new_n157_));
  nand3  g62(.a(x43), .b(new_n157_), .c(x09), .O(new_n158_));
  aoi21  g63(.a(new_n158_), .b(new_n156_), .c(x10), .O(z31));
  zero   g64(.O(z06));
  zero   g65(.O(z09));
  zero   g66(.O(z11));
  zero   g67(.O(z12));
