...
module FAU ( 
  ...
  nand3  g72(.a(x41), .b(new_n161_), .c(x09), .O(new_n164_));
  aoi21  g73(.a(new_n164_), .b(new_n163_), .c(x10), .O(z29));
  nand2  g74(.a(new_n162_), .b(x41), .O(new_n166_));
  nand3  g75(.a(x42), .b(new_n161_), .c(x09), .O(new_n167_));
  aoi21  g76(.a(new_n167_), .b(new_n166_), .c(x10), .O(z30));
  nand2  g77(.a(new_n162_), .b(x42), .O(new_n169_));
  nand3  g78(.a(x43), .b(new_n161_), .c(x09), .O(new_n170_));
  aoi21  g79(.a(new_n170_), .b(new_n169_), .c(x10), .O(z31));
  nand2  g80(.a(new_n162_), .b(x43), .O(new_n172_));
  nand3  g81(.a(x44), .b(new_n161_), .c(x09), .O(new_n173_));
  aoi21  g82(.a(new_n173_), .b(new_n172_), .c(x10), .O(z32));
  nand2  g83(.a(new_n162_), .b(x44), .O(new_n175_));
  nand3  g84(.a(x45), .b(new_n161_), .c(x09), .O(new_n176_));
  aoi21  g85(.a(new_n176_), .b(new_n175_), .c(x10), .O(z33));
  nand2  g86(.a(new_n162_), .b(x45), .O(new_n178_));
  nand3  g87(.a(x46), .b(new_n161_), .c(x09), .O(new_n179_));
  aoi21  g88(.a(new_n179_), .b(new_n178_), .c(x10), .O(z34));
  nand2  g89(.a(new_n162_), .b(x46), .O(new_n181_));
  nand3  g90(.a(new_n161_), .b(x09), .c(x00), .O(new_n182_));
