// Benchmark "FAU" written by ABC on Fri Jul 24 00:48:05 2020
...
module FAU ( 
  ...
  nand2  g34(.a(x29), .b(new_n90_), .O(new_n125_));
  nand2  g35(.a(x30), .b(x08), .O(new_n126_));
  aoi21  g36(.a(new_n126_), .b(new_n125_), .c(x10), .O(z18));
  ...
  nand2  g53(.a(x35), .b(new_n131_), .O(new_n144_));
  nand2  g54(.a(x36), .b(x09), .O(new_n145_));
  aoi21  g55(.a(new_n145_), .b(new_n144_), .c(x10), .O(z24));
  nand2  g56(.a(x36), .b(new_n131_), .O(new_n147_));
  nand2  g57(.a(x37), .b(x09), .O(new_n148_));
  aoi21  g58(.a(new_n148_), .b(new_n147_), .c(x10), .O(z25));
