...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n121_, new_n124_, new_n125_, new_n127_, new_n128_, new_n131_,
  ...
  nand2  g057(.a(x36), .b(new_n141_), .O(new_n148_));
  nand2  g058(.a(x37), .b(x09), .O(new_n149_));
  aoi21  g059(.a(new_n149_), .b(new_n148_), .c(x10), .O(z25));
  nand2  g060(.a(x37), .b(new_n141_), .O(new_n151_));
  ...
  nand2  g067(.a(x38), .b(new_n141_), .O(new_n158_));
