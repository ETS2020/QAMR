// Benchmark "FAU" written by ABC on Fri Jul 24 00:48:07 2020
...
module FAU ( 
  ...
  nand2  g57(.a(x33), .b(new_n140_), .O(new_n145_));
  nand2  g58(.a(x34), .b(x09), .O(new_n146_));
  aoi21  g59(.a(new_n146_), .b(new_n145_), .c(x10), .O(z22));
  nand2  g60(.a(x34), .b(new_n140_), .O(new_n148_));
