...
module FAU ( 
  ...
  nand2  g52(.a(x38), .b(new_n131_), .O(new_n148_));
  ...
  nand2  g62(.a(new_n151_), .b(x41), .O(new_n158_));
  nand3  g63(.a(x42), .b(new_n150_), .c(x09), .O(new_n159_));
  aoi21  g64(.a(new_n159_), .b(new_n158_), .c(x10), .O(z30));
  nand2  g65(.a(new_n151_), .b(x42), .O(new_n161_));
  nand3  g66(.a(x43), .b(new_n150_), .c(x09), .O(new_n162_));
  aoi21  g67(.a(new_n162_), .b(new_n161_), .c(x10), .O(z31));
  nand2  g68(.a(new_n151_), .b(x43), .O(new_n164_));
  nand3  g69(.a(x44), .b(new_n150_), .c(x09), .O(new_n165_));
  aoi21  g70(.a(new_n165_), .b(new_n164_), .c(x10), .O(z32));
  nand2  g71(.a(new_n151_), .b(x44), .O(new_n167_));
  nand3  g72(.a(x45), .b(new_n150_), .c(x09), .O(new_n168_));
  aoi21  g73(.a(new_n168_), .b(new_n167_), .c(x10), .O(z33));
  nand2  g74(.a(new_n151_), .b(x45), .O(new_n170_));
  nand3  g75(.a(x46), .b(new_n150_), .c(x09), .O(new_n171_));
  aoi21  g76(.a(new_n171_), .b(new_n170_), .c(x10), .O(z34));
  nand2  g77(.a(new_n151_), .b(x46), .O(new_n173_));
  nand3  g78(.a(new_n150_), .b(x09), .c(x00), .O(new_n174_));
