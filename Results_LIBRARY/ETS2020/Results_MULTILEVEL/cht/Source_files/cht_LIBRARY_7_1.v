...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n125_, new_n131_, new_n132_, new_n133_, new_n135_, new_n136_,
  ...
  nand3  g63(.a(x40), .b(new_n154_), .c(x09), .O(new_n157_));
  aoi21  g64(.a(new_n157_), .b(new_n156_), .c(x10), .O(z28));
  nand2  g65(.a(new_n155_), .b(x40), .O(new_n159_));
  nand3  g66(.a(x41), .b(new_n154_), .c(x09), .O(new_n160_));
  aoi21  g67(.a(new_n160_), .b(new_n159_), .c(x10), .O(z29));
  nand2  g68(.a(new_n155_), .b(x41), .O(new_n162_));
  nand3  g69(.a(x42), .b(new_n154_), .c(x09), .O(new_n163_));
  aoi21  g70(.a(new_n163_), .b(new_n162_), .c(x10), .O(z30));
  nand2  g71(.a(new_n155_), .b(x42), .O(new_n165_));
  nand3  g72(.a(x43), .b(new_n154_), .c(x09), .O(new_n166_));
  aoi21  g73(.a(new_n166_), .b(new_n165_), .c(x10), .O(z31));
  nand2  g74(.a(new_n155_), .b(x43), .O(new_n168_));
  nand3  g75(.a(x44), .b(new_n154_), .c(x09), .O(new_n169_));
  aoi21  g76(.a(new_n169_), .b(new_n168_), .c(x10), .O(z32));
  nand2  g77(.a(new_n155_), .b(x44), .O(new_n171_));
  nand3  g78(.a(x45), .b(new_n154_), .c(x09), .O(new_n172_));
  aoi21  g79(.a(new_n172_), .b(new_n171_), .c(x10), .O(z33));
  nand2  g80(.a(new_n155_), .b(x45), .O(new_n174_));
  nand3  g81(.a(x46), .b(new_n154_), .c(x09), .O(new_n175_));
  aoi21  g82(.a(new_n175_), .b(new_n174_), .c(x10), .O(z34));
  nand2  g83(.a(new_n155_), .b(x46), .O(new_n177_));
  nand3  g84(.a(new_n154_), .b(x09), .c(x00), .O(new_n178_));
