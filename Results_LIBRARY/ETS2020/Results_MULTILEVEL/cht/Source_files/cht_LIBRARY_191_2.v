...
module FAU ( 
  ...
  wire new_n90_, new_n91_, new_n92_, new_n94_, new_n95_, new_n97_, new_n98_,
    ...
    new_n129_, new_n133_, new_n134_, new_n137_, new_n138_, new_n141_,
  ...
  nand2  g38(.a(x34), .b(new_n127_), .O(new_n133_));
  nand2  g39(.a(x35), .b(x09), .O(new_n134_));
  aoi21  g40(.a(new_n134_), .b(new_n133_), .c(x10), .O(z23));
  nand2  g41(.a(x36), .b(new_n127_), .O(new_n137_));
  ...
  nand2  g48(.a(x38), .b(new_n127_), .O(new_n145_));
