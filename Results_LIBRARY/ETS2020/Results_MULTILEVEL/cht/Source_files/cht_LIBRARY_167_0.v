// Benchmark "FAU" written by ABC on Fri Jul 24 00:47:26 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n141_, new_n142_, new_n145_, new_n146_, new_n149_, new_n150_,
    new_n153_, new_n154_;
  ...
  nand2  g32(.a(x24), .b(new_n104_), .O(new_n119_));
  ...
  nand2  g38(.a(x26), .b(new_n104_), .O(new_n125_));
  nand2  g39(.a(x27), .b(x08), .O(new_n126_));
  aoi21  g40(.a(new_n126_), .b(new_n125_), .c(x10), .O(z15));
  nand2  g41(.a(x27), .b(new_n104_), .O(new_n128_));
  ...
  nand2  g51(.a(x30), .b(new_n104_), .O(new_n138_));
