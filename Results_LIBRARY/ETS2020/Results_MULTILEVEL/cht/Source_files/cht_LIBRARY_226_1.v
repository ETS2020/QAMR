...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n177_, new_n180_, new_n181_, new_n183_, new_n184_;
  ...
  nand2  g089(.a(new_n163_), .b(x45), .O(new_n180_));
  nand3  g090(.a(x46), .b(new_n162_), .c(x09), .O(new_n181_));
  aoi21  g091(.a(new_n181_), .b(new_n180_), .c(x10), .O(z34));
  nand2  g092(.a(new_n163_), .b(x46), .O(new_n183_));
  nand3  g093(.a(new_n162_), .b(x09), .c(x00), .O(new_n184_));
