...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n147_, new_n148_, new_n154_, new_n155_, new_n156_, new_n160_,
    new_n161_;
  ...
  nand2  g51(.a(x35), .b(new_n136_), .O(new_n143_));
  ...
  oai21  g57(.a(x14), .b(new_n136_), .c(x42), .O(new_n154_));
  inv1   g58(.a(x14), .O(new_n155_));
  nand3  g59(.a(x43), .b(new_n155_), .c(x09), .O(new_n156_));
  aoi21  g60(.a(new_n156_), .b(new_n154_), .c(x10), .O(z31));
  oai21  g61(.a(x14), .b(new_n136_), .c(x45), .O(new_n160_));
  nand3  g62(.a(x46), .b(new_n155_), .c(x09), .O(new_n161_));
