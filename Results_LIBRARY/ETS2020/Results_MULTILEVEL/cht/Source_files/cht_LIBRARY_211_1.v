...
module FAU ( 
  ...
  nand2  g092(.a(new_n165_), .b(x45), .O(new_n182_));
  nand3  g093(.a(x46), .b(new_n164_), .c(x09), .O(new_n183_));
  aoi21  g094(.a(new_n183_), .b(new_n182_), .c(x10), .O(z34));
  nand2  g095(.a(new_n165_), .b(x46), .O(new_n185_));
  nand3  g096(.a(new_n164_), .b(x09), .c(x00), .O(new_n186_));
