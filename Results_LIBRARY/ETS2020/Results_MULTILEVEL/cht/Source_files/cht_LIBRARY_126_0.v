...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n133_, new_n135_, new_n136_, new_n143_, new_n144_, new_n145_,
    new_n147_, new_n148_;
  ...
  inv1   g50(.a(x09), .O(new_n143_));
  nand2  g51(.a(x36), .b(new_n143_), .O(new_n144_));
  nand2  g52(.a(x37), .b(x09), .O(new_n145_));
  aoi21  g53(.a(new_n145_), .b(new_n144_), .c(x10), .O(z25));
  nand2  g54(.a(x37), .b(new_n143_), .O(new_n147_));
