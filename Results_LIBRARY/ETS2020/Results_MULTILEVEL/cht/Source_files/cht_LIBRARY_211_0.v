...
module FAU ( 
  ...
  oai21  g54(.a(x14), .b(new_n136_), .c(x42), .O(new_n152_));
  inv1   g55(.a(x14), .O(new_n153_));
  nand3  g56(.a(x43), .b(new_n153_), .c(x09), .O(new_n154_));
  aoi21  g57(.a(new_n154_), .b(new_n152_), .c(x10), .O(z31));
  zero   g58(.O(z06));
  zero   g59(.O(z07));
  zero   g60(.O(z10));
  zero   g61(.O(z11));
