// Benchmark "FAU" written by ABC on Fri Jul 24 00:46:18 2020
...
module FAU ( 
  ...
  nand2  g082(.a(x38), .b(new_n144_), .O(new_n168_));
  ...
  nand3  g087(.a(x40), .b(new_n170_), .c(x09), .O(new_n173_));
  aoi21  g088(.a(new_n173_), .b(new_n172_), .c(x10), .O(z28));
  nand2  g089(.a(new_n171_), .b(x40), .O(new_n175_));
  nand3  g090(.a(x41), .b(new_n170_), .c(x09), .O(new_n176_));
  aoi21  g091(.a(new_n176_), .b(new_n175_), .c(x10), .O(z29));
  nand2  g092(.a(new_n171_), .b(x41), .O(new_n178_));
  nand3  g093(.a(x42), .b(new_n170_), .c(x09), .O(new_n179_));
  aoi21  g094(.a(new_n179_), .b(new_n178_), .c(x10), .O(z30));
  nand2  g095(.a(new_n171_), .b(x42), .O(new_n181_));
  nand3  g096(.a(x43), .b(new_n170_), .c(x09), .O(new_n182_));
  aoi21  g097(.a(new_n182_), .b(new_n181_), .c(x10), .O(z31));
  nand2  g098(.a(new_n171_), .b(x43), .O(new_n184_));
  nand3  g099(.a(x44), .b(new_n170_), .c(x09), .O(new_n185_));
  aoi21  g100(.a(new_n185_), .b(new_n184_), .c(x10), .O(z32));
  nand2  g101(.a(new_n171_), .b(x44), .O(new_n187_));
  nand3  g102(.a(x45), .b(new_n170_), .c(x09), .O(new_n188_));
  aoi21  g103(.a(new_n188_), .b(new_n187_), .c(x10), .O(z33));
  nand2  g104(.a(new_n171_), .b(x45), .O(new_n190_));
  nand3  g105(.a(x46), .b(new_n170_), .c(x09), .O(new_n191_));
  aoi21  g106(.a(new_n191_), .b(new_n190_), .c(x10), .O(z34));
  nand2  g107(.a(new_n171_), .b(x46), .O(new_n193_));
  nand3  g108(.a(new_n170_), .b(x09), .c(x00), .O(new_n194_));
  aoi21  g109(.a(new_n194_), .b(new_n193_), .c(x10), .O(z35));
  zero   g110(.O(z10));
  zero   g111(.O(z26));
endmodule
