// Benchmark "FAU" written by ABC on Fri Jul 24 00:48:00 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n91_, new_n92_, new_n93_, new_n97_, new_n98_, new_n100_,
    new_n101_, new_n103_, new_n104_, new_n107_, new_n108_, new_n110_,
    ...
    new_n173_;
  inv1   g00(.a(x08), .O(new_n91_));
  nand2  g01(.a(x18), .b(new_n91_), .O(new_n92_));
  nand2  g02(.a(x19), .b(x08), .O(new_n93_));
  aoi21  g03(.a(new_n93_), .b(new_n92_), .c(x10), .O(z07));
  nand2  g04(.a(x21), .b(new_n91_), .O(new_n97_));
  nand2  g05(.a(x22), .b(x08), .O(new_n98_));
  aoi21  g06(.a(new_n98_), .b(new_n97_), .c(x10), .O(z10));
  nand2  g07(.a(x22), .b(new_n91_), .O(new_n100_));
  nand2  g08(.a(x23), .b(x08), .O(new_n101_));
  aoi21  g09(.a(new_n101_), .b(new_n100_), .c(x10), .O(z11));
  nand2  g10(.a(x23), .b(new_n91_), .O(new_n103_));
  nand2  g11(.a(x24), .b(x08), .O(new_n104_));
  aoi21  g12(.a(new_n104_), .b(new_n103_), .c(x10), .O(z12));
  nand2  g13(.a(x25), .b(new_n91_), .O(new_n107_));
  nand2  g14(.a(x26), .b(x08), .O(new_n108_));
  aoi21  g15(.a(new_n108_), .b(new_n107_), .c(x10), .O(z14));
  nand2  g16(.a(x26), .b(new_n91_), .O(new_n110_));
  nand2  g17(.a(x27), .b(x08), .O(new_n111_));
  aoi21  g18(.a(new_n111_), .b(new_n110_), .c(x10), .O(z15));
  nand2  g19(.a(x28), .b(new_n91_), .O(new_n114_));
  nand2  g20(.a(x29), .b(x08), .O(new_n115_));
  aoi21  g21(.a(new_n115_), .b(new_n114_), .c(x10), .O(z17));
  nand2  g22(.a(x29), .b(new_n91_), .O(new_n117_));
