...
module FAU ( 
  ...
  wire new_n90_, new_n91_, new_n92_, new_n94_, new_n95_, new_n97_, new_n98_,
    new_n100_, new_n101_, new_n105_, new_n106_, new_n110_, new_n111_,
  ...
  nand2  g22(.a(x08), .b(x00), .O(new_n118_));
  nand2  g23(.a(x30), .b(new_n90_), .O(new_n119_));
  aoi21  g24(.a(new_n119_), .b(new_n118_), .c(x10), .O(z19));
