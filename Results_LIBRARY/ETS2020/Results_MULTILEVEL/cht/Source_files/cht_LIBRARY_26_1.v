// Benchmark "FAU" written by ABC on Fri Jul 24 00:46:22 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n184_, new_n186_, new_n187_, new_n189_, new_n190_;
  ...
  nand2  g069(.a(x37), .b(new_n140_), .O(new_n157_));
  ...
  nand2  g076(.a(x38), .b(new_n140_), .O(new_n164_));
  ...
  nand3  g081(.a(x40), .b(new_n166_), .c(x09), .O(new_n169_));
  aoi21  g082(.a(new_n169_), .b(new_n168_), .c(x10), .O(z28));
  nand2  g083(.a(new_n167_), .b(x40), .O(new_n171_));
  nand3  g084(.a(x41), .b(new_n166_), .c(x09), .O(new_n172_));
  aoi21  g085(.a(new_n172_), .b(new_n171_), .c(x10), .O(z29));
  nand2  g086(.a(new_n167_), .b(x41), .O(new_n174_));
  nand3  g087(.a(x42), .b(new_n166_), .c(x09), .O(new_n175_));
  aoi21  g088(.a(new_n175_), .b(new_n174_), .c(x10), .O(z30));
  nand2  g089(.a(new_n167_), .b(x42), .O(new_n177_));
  nand3  g090(.a(x43), .b(new_n166_), .c(x09), .O(new_n178_));
  aoi21  g091(.a(new_n178_), .b(new_n177_), .c(x10), .O(z31));
  nand2  g092(.a(new_n167_), .b(x43), .O(new_n180_));
  nand3  g093(.a(x44), .b(new_n166_), .c(x09), .O(new_n181_));
  aoi21  g094(.a(new_n181_), .b(new_n180_), .c(x10), .O(z32));
  nand2  g095(.a(new_n167_), .b(x44), .O(new_n183_));
  nand3  g096(.a(x45), .b(new_n166_), .c(x09), .O(new_n184_));
  aoi21  g097(.a(new_n184_), .b(new_n183_), .c(x10), .O(z33));
  nand2  g098(.a(new_n167_), .b(x45), .O(new_n186_));
  nand3  g099(.a(x46), .b(new_n166_), .c(x09), .O(new_n187_));
  aoi21  g100(.a(new_n187_), .b(new_n186_), .c(x10), .O(z34));
  nand2  g101(.a(new_n167_), .b(x46), .O(new_n189_));
  nand3  g102(.a(new_n166_), .b(x09), .c(x00), .O(new_n190_));
  aoi21  g103(.a(new_n190_), .b(new_n189_), .c(x10), .O(z35));
  zero   g104(.O(z06));
  zero   g105(.O(z07));
  zero   g106(.O(z09));
  zero   g107(.O(z25));
