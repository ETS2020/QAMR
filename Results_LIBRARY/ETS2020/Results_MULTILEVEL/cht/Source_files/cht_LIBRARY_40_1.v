// Benchmark "FAU" written by ABC on Fri Jul 24 00:46:28 2020
...
module FAU ( 
  ...
  nand2  g023(.a(x21), .b(new_n105_), .O(new_n110_));
  ...
  nand2  g029(.a(x23), .b(new_n105_), .O(new_n116_));
  nand2  g030(.a(x24), .b(x08), .O(new_n117_));
  aoi21  g031(.a(new_n117_), .b(new_n116_), .c(x10), .O(z12));
  nand2  g032(.a(x24), .b(new_n105_), .O(new_n119_));
  nand2  g033(.a(x25), .b(x08), .O(new_n120_));
  aoi21  g034(.a(new_n120_), .b(new_n119_), .c(x10), .O(z13));
  nand2  g035(.a(x25), .b(new_n105_), .O(new_n122_));
  nand2  g036(.a(x26), .b(x08), .O(new_n123_));
  aoi21  g037(.a(new_n123_), .b(new_n122_), .c(x10), .O(z14));
  nand2  g038(.a(x27), .b(new_n105_), .O(new_n126_));
  nand2  g039(.a(x28), .b(x08), .O(new_n127_));
  aoi21  g040(.a(new_n127_), .b(new_n126_), .c(x10), .O(z16));
  nand2  g041(.a(x28), .b(new_n105_), .O(new_n129_));
  nand2  g042(.a(x29), .b(x08), .O(new_n130_));
  aoi21  g043(.a(new_n130_), .b(new_n129_), .c(x10), .O(z17));
  nand2  g044(.a(x29), .b(new_n105_), .O(new_n132_));
  nand2  g045(.a(x30), .b(x08), .O(new_n133_));
  aoi21  g046(.a(new_n133_), .b(new_n132_), .c(x10), .O(z18));
  nand2  g047(.a(x08), .b(x00), .O(new_n135_));
  nand2  g048(.a(x30), .b(new_n105_), .O(new_n136_));
  ...
  nand2  g073(.a(x38), .b(new_n138_), .O(new_n162_));
  ...
  nand3  g078(.a(x40), .b(new_n164_), .c(x09), .O(new_n167_));
  aoi21  g079(.a(new_n167_), .b(new_n166_), .c(x10), .O(z28));
  nand2  g080(.a(new_n165_), .b(x40), .O(new_n169_));
  nand3  g081(.a(x41), .b(new_n164_), .c(x09), .O(new_n170_));
  aoi21  g082(.a(new_n170_), .b(new_n169_), .c(x10), .O(z29));
  nand2  g083(.a(new_n165_), .b(x41), .O(new_n172_));
  nand3  g084(.a(x42), .b(new_n164_), .c(x09), .O(new_n173_));
  aoi21  g085(.a(new_n173_), .b(new_n172_), .c(x10), .O(z30));
  nand2  g086(.a(new_n165_), .b(x42), .O(new_n175_));
  nand3  g087(.a(x43), .b(new_n164_), .c(x09), .O(new_n176_));
  aoi21  g088(.a(new_n176_), .b(new_n175_), .c(x10), .O(z31));
  nand2  g089(.a(new_n165_), .b(x43), .O(new_n178_));
  nand3  g090(.a(x44), .b(new_n164_), .c(x09), .O(new_n179_));
  aoi21  g091(.a(new_n179_), .b(new_n178_), .c(x10), .O(z32));
  nand2  g092(.a(new_n165_), .b(x44), .O(new_n181_));
  nand3  g093(.a(x45), .b(new_n164_), .c(x09), .O(new_n182_));
  aoi21  g094(.a(new_n182_), .b(new_n181_), .c(x10), .O(z33));
  nand2  g095(.a(new_n165_), .b(x45), .O(new_n184_));
  nand3  g096(.a(x46), .b(new_n164_), .c(x09), .O(new_n185_));
  aoi21  g097(.a(new_n185_), .b(new_n184_), .c(x10), .O(z34));
  nand2  g098(.a(new_n165_), .b(x46), .O(new_n187_));
  nand3  g099(.a(new_n164_), .b(x09), .c(x00), .O(new_n188_));
  aoi21  g100(.a(new_n188_), .b(new_n187_), .c(x10), .O(z35));
  zero   g101(.O(z06));
  zero   g102(.O(z07));
  zero   g103(.O(z09));
  zero   g104(.O(z15));
