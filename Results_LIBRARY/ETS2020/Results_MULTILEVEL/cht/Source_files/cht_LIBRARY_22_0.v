...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n149_, new_n150_, new_n155_, new_n156_;
  ...
  nand2  g63(.a(x33), .b(new_n142_), .O(new_n149_));
  nand2  g64(.a(x34), .b(x09), .O(new_n150_));
  aoi21  g65(.a(new_n150_), .b(new_n149_), .c(x10), .O(z22));
  nand2  g66(.a(x37), .b(new_n142_), .O(new_n155_));
