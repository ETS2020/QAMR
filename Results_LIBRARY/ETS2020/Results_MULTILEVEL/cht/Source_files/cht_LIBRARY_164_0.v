...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n149_, new_n150_, new_n155_, new_n156_, new_n161_, new_n162_,
    new_n163_;
  ...
  inv1   g59(.a(x09), .O(new_n145_));
  nand2  g60(.a(x32), .b(new_n145_), .O(new_n146_));
  nand2  g61(.a(x33), .b(x09), .O(new_n147_));
  aoi21  g62(.a(new_n147_), .b(new_n146_), .c(x10), .O(z21));
  nand2  g63(.a(x33), .b(new_n145_), .O(new_n149_));
  nand2  g64(.a(x34), .b(x09), .O(new_n150_));
  aoi21  g65(.a(new_n150_), .b(new_n149_), .c(x10), .O(z22));
  nand2  g66(.a(x37), .b(new_n145_), .O(new_n155_));
  nand2  g67(.a(x38), .b(x09), .O(new_n156_));
  aoi21  g68(.a(new_n156_), .b(new_n155_), .c(x10), .O(z26));
  oai21  g69(.a(x14), .b(new_n145_), .c(x41), .O(new_n161_));
  inv1   g70(.a(x14), .O(new_n162_));
  nand3  g71(.a(x42), .b(new_n162_), .c(x09), .O(new_n163_));
  aoi21  g72(.a(new_n163_), .b(new_n161_), .c(x10), .O(z30));
  zero   g73(.O(z10));
  zero   g74(.O(z20));
  zero   g75(.O(z23));
  zero   g76(.O(z24));
