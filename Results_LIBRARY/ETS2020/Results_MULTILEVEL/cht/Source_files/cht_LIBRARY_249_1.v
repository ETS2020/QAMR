...
module FAU ( 
  ...
  nand2  g51(.a(x34), .b(new_n136_), .O(new_n142_));
  ...
  nand3  g66(.a(x40), .b(new_n156_), .c(x09), .O(new_n159_));
  aoi21  g67(.a(new_n159_), .b(new_n158_), .c(x10), .O(z28));
  nand2  g68(.a(new_n157_), .b(x40), .O(new_n161_));
  nand3  g69(.a(x41), .b(new_n156_), .c(x09), .O(new_n162_));
  aoi21  g70(.a(new_n162_), .b(new_n161_), .c(x10), .O(z29));
  nand2  g71(.a(new_n157_), .b(x41), .O(new_n164_));
  nand3  g72(.a(x42), .b(new_n156_), .c(x09), .O(new_n165_));
  aoi21  g73(.a(new_n165_), .b(new_n164_), .c(x10), .O(z30));
  nand2  g74(.a(new_n157_), .b(x42), .O(new_n167_));
  nand3  g75(.a(x43), .b(new_n156_), .c(x09), .O(new_n168_));
  aoi21  g76(.a(new_n168_), .b(new_n167_), .c(x10), .O(z31));
  nand2  g77(.a(new_n157_), .b(x43), .O(new_n170_));
  nand3  g78(.a(x44), .b(new_n156_), .c(x09), .O(new_n171_));
  aoi21  g79(.a(new_n171_), .b(new_n170_), .c(x10), .O(z32));
  nand2  g80(.a(new_n157_), .b(x44), .O(new_n173_));
  nand3  g81(.a(x45), .b(new_n156_), .c(x09), .O(new_n174_));
  aoi21  g82(.a(new_n174_), .b(new_n173_), .c(x10), .O(z33));
  nand2  g83(.a(new_n157_), .b(x45), .O(new_n176_));
  nand3  g84(.a(x46), .b(new_n156_), .c(x09), .O(new_n177_));
  aoi21  g85(.a(new_n177_), .b(new_n176_), .c(x10), .O(z34));
  nand2  g86(.a(new_n157_), .b(x46), .O(new_n179_));
  nand3  g87(.a(new_n156_), .b(x09), .c(x00), .O(new_n180_));
