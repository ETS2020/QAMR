...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n174_, new_n177_, new_n178_, new_n180_, new_n181_, new_n183_,
  ...
  nand2  g089(.a(new_n169_), .b(x42), .O(new_n177_));
  nand3  g090(.a(x43), .b(new_n168_), .c(x09), .O(new_n178_));
  aoi21  g091(.a(new_n178_), .b(new_n177_), .c(x10), .O(z31));
  nand2  g092(.a(new_n169_), .b(x43), .O(new_n180_));
  nand3  g093(.a(x44), .b(new_n168_), .c(x09), .O(new_n181_));
  aoi21  g094(.a(new_n181_), .b(new_n180_), .c(x10), .O(z32));
  nand2  g095(.a(new_n169_), .b(x44), .O(new_n183_));
  nand3  g096(.a(x45), .b(new_n168_), .c(x09), .O(new_n184_));
  aoi21  g097(.a(new_n184_), .b(new_n183_), .c(x10), .O(z33));
  nand2  g098(.a(new_n169_), .b(x45), .O(new_n186_));
  nand3  g099(.a(x46), .b(new_n168_), .c(x09), .O(new_n187_));
  aoi21  g100(.a(new_n187_), .b(new_n186_), .c(x10), .O(z34));
  nand2  g101(.a(new_n169_), .b(x46), .O(new_n189_));
  nand3  g102(.a(new_n168_), .b(x09), .c(x00), .O(new_n190_));
