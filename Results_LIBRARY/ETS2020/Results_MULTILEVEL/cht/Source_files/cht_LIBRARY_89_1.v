...
module FAU ( 
  ...
  nand2  g023(.a(x21), .b(new_n104_), .O(new_n110_));
  nand2  g024(.a(x22), .b(x08), .O(new_n111_));
  aoi21  g025(.a(new_n111_), .b(new_n110_), .c(x10), .O(z10));
  nand2  g026(.a(x22), .b(new_n104_), .O(new_n113_));
  ...
  nand2  g038(.a(x28), .b(new_n104_), .O(new_n127_));
  ...
  nand2  g060(.a(x37), .b(new_n136_), .O(new_n151_));
