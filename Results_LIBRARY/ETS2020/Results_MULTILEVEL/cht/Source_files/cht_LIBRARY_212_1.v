...
module FAU ( 
  ...
  nand3  g72(.a(x40), .b(new_n160_), .c(x09), .O(new_n163_));
  aoi21  g73(.a(new_n163_), .b(new_n162_), .c(x10), .O(z28));
  nand2  g74(.a(new_n161_), .b(x40), .O(new_n165_));
  nand3  g75(.a(x41), .b(new_n160_), .c(x09), .O(new_n166_));
  aoi21  g76(.a(new_n166_), .b(new_n165_), .c(x10), .O(z29));
  nand2  g77(.a(new_n161_), .b(x41), .O(new_n168_));
  nand3  g78(.a(x42), .b(new_n160_), .c(x09), .O(new_n169_));
  aoi21  g79(.a(new_n169_), .b(new_n168_), .c(x10), .O(z30));
  nand2  g80(.a(new_n161_), .b(x42), .O(new_n171_));
  nand3  g81(.a(x43), .b(new_n160_), .c(x09), .O(new_n172_));
  aoi21  g82(.a(new_n172_), .b(new_n171_), .c(x10), .O(z31));
  nand2  g83(.a(new_n161_), .b(x43), .O(new_n174_));
  nand3  g84(.a(x44), .b(new_n160_), .c(x09), .O(new_n175_));
  aoi21  g85(.a(new_n175_), .b(new_n174_), .c(x10), .O(z32));
  nand2  g86(.a(new_n161_), .b(x45), .O(new_n178_));
  nand3  g87(.a(x46), .b(new_n160_), .c(x09), .O(new_n179_));
  aoi21  g88(.a(new_n179_), .b(new_n178_), .c(x10), .O(z34));
  nand2  g89(.a(new_n161_), .b(x46), .O(new_n181_));
  nand3  g90(.a(new_n160_), .b(x09), .c(x00), .O(new_n182_));
