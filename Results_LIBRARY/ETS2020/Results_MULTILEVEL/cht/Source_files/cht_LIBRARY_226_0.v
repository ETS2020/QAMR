...
module FAU ( 
  ...
  oai21  g54(.a(x14), .b(new_n140_), .c(x44), .O(new_n154_));
  inv1   g55(.a(x14), .O(new_n155_));
  nand3  g56(.a(x45), .b(new_n155_), .c(x09), .O(new_n156_));
  aoi21  g57(.a(new_n156_), .b(new_n154_), .c(x10), .O(z33));
  zero   g58(.O(z06));
  zero   g59(.O(z07));
  zero   g60(.O(z11));
  zero   g61(.O(z13));
