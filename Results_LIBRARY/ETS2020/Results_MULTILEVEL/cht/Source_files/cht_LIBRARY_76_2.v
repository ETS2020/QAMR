// Benchmark "FAU" written by ABC on Fri Jul 24 00:46:45 2020
...
module FAU ( 
  ...
  inv1   g35(.a(x39), .O(new_n135_));
  nand2  g36(.a(x14), .b(x00), .O(new_n136_));
  oai21  g37(.a(new_n135_), .b(x14), .c(new_n136_), .O(new_n137_));
  nand2  g38(.a(new_n137_), .b(x09), .O(new_n138_));
  nand2  g39(.a(x38), .b(new_n126_), .O(new_n139_));
  aoi21  g40(.a(new_n139_), .b(new_n138_), .c(x10), .O(z27));
  inv1   g41(.a(x14), .O(new_n141_));
  nand2  g42(.a(new_n141_), .b(x09), .O(new_n142_));
  nand2  g43(.a(new_n142_), .b(x39), .O(new_n143_));
  nand3  g44(.a(x40), .b(new_n141_), .c(x09), .O(new_n144_));
  aoi21  g45(.a(new_n144_), .b(new_n143_), .c(x10), .O(z28));
  nand2  g46(.a(new_n142_), .b(x40), .O(new_n146_));
  nand3  g47(.a(x41), .b(new_n141_), .c(x09), .O(new_n147_));
  aoi21  g48(.a(new_n147_), .b(new_n146_), .c(x10), .O(z29));
  nand2  g49(.a(new_n142_), .b(x41), .O(new_n149_));
  nand3  g50(.a(x42), .b(new_n141_), .c(x09), .O(new_n150_));
  aoi21  g51(.a(new_n150_), .b(new_n149_), .c(x10), .O(z30));
  nand2  g52(.a(new_n142_), .b(x42), .O(new_n152_));
  nand3  g53(.a(x43), .b(new_n141_), .c(x09), .O(new_n153_));
  aoi21  g54(.a(new_n153_), .b(new_n152_), .c(x10), .O(z31));
  nand2  g55(.a(new_n142_), .b(x43), .O(new_n155_));
  nand3  g56(.a(x44), .b(new_n141_), .c(x09), .O(new_n156_));
  aoi21  g57(.a(new_n156_), .b(new_n155_), .c(x10), .O(z32));
  nand2  g58(.a(new_n142_), .b(x44), .O(new_n158_));
  nand3  g59(.a(x45), .b(new_n141_), .c(x09), .O(new_n159_));
  aoi21  g60(.a(new_n159_), .b(new_n158_), .c(x10), .O(z33));
  nand2  g61(.a(new_n142_), .b(x45), .O(new_n161_));
  nand3  g62(.a(x46), .b(new_n141_), .c(x09), .O(new_n162_));
  aoi21  g63(.a(new_n162_), .b(new_n161_), .c(x10), .O(z34));
  nand2  g64(.a(new_n142_), .b(x46), .O(new_n164_));
  nand3  g65(.a(new_n141_), .b(x09), .c(x00), .O(new_n165_));
  aoi21  g66(.a(new_n165_), .b(new_n164_), .c(x10), .O(z35));
  zero   g67(.O(z00));
  zero   g68(.O(z01));
  zero   g69(.O(z02));
  zero   g70(.O(z03));
