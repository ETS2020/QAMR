// Benchmark "FAU" written by ABC on Fri Jul 24 00:47:47 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n152_, new_n153_, new_n155_, new_n156_, new_n164_, new_n165_,
    new_n166_;
  ...
  oai21  g69(.a(x14), .b(new_n141_), .c(x44), .O(new_n164_));
  inv1   g70(.a(x14), .O(new_n165_));
  nand3  g71(.a(x45), .b(new_n165_), .c(x09), .O(new_n166_));
  aoi21  g72(.a(new_n166_), .b(new_n164_), .c(x10), .O(z33));
  zero   g73(.O(z09));
  zero   g74(.O(z11));
  zero   g75(.O(z15));
  zero   g76(.O(z20));
