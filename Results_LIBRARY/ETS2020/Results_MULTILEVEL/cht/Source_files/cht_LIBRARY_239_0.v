...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n149_, new_n150_, new_n152_, new_n153_, new_n157_, new_n158_;
  ...
  nand2  g63(.a(x33), .b(new_n144_), .O(new_n149_));
  nand2  g64(.a(x34), .b(x09), .O(new_n150_));
  aoi21  g65(.a(new_n150_), .b(new_n149_), .c(x10), .O(z22));
  nand2  g66(.a(x34), .b(new_n144_), .O(new_n152_));
  nand2  g67(.a(x35), .b(x09), .O(new_n153_));
  aoi21  g68(.a(new_n153_), .b(new_n152_), .c(x10), .O(z23));
  nand2  g69(.a(x37), .b(new_n144_), .O(new_n157_));
