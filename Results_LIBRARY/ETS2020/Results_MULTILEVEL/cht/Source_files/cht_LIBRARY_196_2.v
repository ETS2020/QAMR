...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n93_, new_n94_, new_n95_, new_n97_,
    ...
    new_n117_, new_n119_, new_n120_, new_n122_, new_n123_, new_n128_,
  ...
  nand3  g60(.a(x40), .b(new_n152_), .c(x09), .O(new_n155_));
  aoi21  g61(.a(new_n155_), .b(new_n154_), .c(x10), .O(z28));
  nand2  g62(.a(new_n153_), .b(x40), .O(new_n157_));
  nand3  g63(.a(x41), .b(new_n152_), .c(x09), .O(new_n158_));
  aoi21  g64(.a(new_n158_), .b(new_n157_), .c(x10), .O(z29));
  nand2  g65(.a(new_n153_), .b(x41), .O(new_n160_));
  nand3  g66(.a(x42), .b(new_n152_), .c(x09), .O(new_n161_));
  aoi21  g67(.a(new_n161_), .b(new_n160_), .c(x10), .O(z30));
  nand2  g68(.a(new_n153_), .b(x42), .O(new_n163_));
  nand3  g69(.a(x43), .b(new_n152_), .c(x09), .O(new_n164_));
  aoi21  g70(.a(new_n164_), .b(new_n163_), .c(x10), .O(z31));
  nand2  g71(.a(new_n153_), .b(x43), .O(new_n166_));
  nand3  g72(.a(x44), .b(new_n152_), .c(x09), .O(new_n167_));
  aoi21  g73(.a(new_n167_), .b(new_n166_), .c(x10), .O(z32));
  nand2  g74(.a(new_n153_), .b(x44), .O(new_n169_));
  nand3  g75(.a(x45), .b(new_n152_), .c(x09), .O(new_n170_));
  aoi21  g76(.a(new_n170_), .b(new_n169_), .c(x10), .O(z33));
  nand2  g77(.a(new_n153_), .b(x45), .O(new_n172_));
  nand3  g78(.a(x46), .b(new_n152_), .c(x09), .O(new_n173_));
  aoi21  g79(.a(new_n173_), .b(new_n172_), .c(x10), .O(z34));
  nand2  g80(.a(new_n153_), .b(x46), .O(new_n175_));
  nand3  g81(.a(new_n152_), .b(x09), .c(x00), .O(new_n176_));
