...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n177_, new_n179_, new_n180_, new_n183_, new_n184_;
  ...
  nand2  g063(.a(x36), .b(new_n142_), .O(new_n152_));
  nand2  g064(.a(x37), .b(x09), .O(new_n153_));
  aoi21  g065(.a(new_n153_), .b(new_n152_), .c(x10), .O(z25));
  nand2  g066(.a(x37), .b(new_n142_), .O(new_n155_));
  ...
  nand2  g073(.a(x38), .b(new_n142_), .O(new_n162_));
  ...
  nand2  g086(.a(new_n165_), .b(x43), .O(new_n176_));
  nand3  g087(.a(x44), .b(new_n164_), .c(x09), .O(new_n177_));
  aoi21  g088(.a(new_n177_), .b(new_n176_), .c(x10), .O(z32));
  nand2  g089(.a(new_n165_), .b(x44), .O(new_n179_));
  nand3  g090(.a(x45), .b(new_n164_), .c(x09), .O(new_n180_));
  aoi21  g091(.a(new_n180_), .b(new_n179_), .c(x10), .O(z33));
  nand2  g092(.a(new_n165_), .b(x46), .O(new_n183_));
  nand3  g093(.a(new_n164_), .b(x09), .c(x00), .O(new_n184_));
