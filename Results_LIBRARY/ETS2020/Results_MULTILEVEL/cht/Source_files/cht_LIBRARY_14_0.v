...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n137_, new_n138_, new_n143_, new_n144_, new_n149_, new_n150_,
    new_n151_;
  ...
  oai21  g51(.a(x14), .b(new_n136_), .c(x41), .O(new_n149_));
  inv1   g52(.a(x14), .O(new_n150_));
  nand3  g53(.a(x42), .b(new_n150_), .c(x09), .O(new_n151_));
  aoi21  g54(.a(new_n151_), .b(new_n149_), .c(x10), .O(z30));
  zero   g55(.O(z06));
  zero   g56(.O(z07));
  zero   g57(.O(z09));
  zero   g58(.O(z11));
