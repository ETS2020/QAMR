...
module FAU ( 
  ...
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  oai21  g39(.a(x11), .b(new_n49_), .c(new_n64_), .O(z4));
  nor2   g40(.a(x12), .b(x00), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x13), .c(new_n56_), .d(new_n49_), .O(z5));
  oai21  g42(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n68_));
  nor2   g43(.a(x02), .b(x00), .O(new_n69_));
  inv1   g44(.a(x00), .O(new_n70_));
  nor2   g45(.a(x08), .b(new_n70_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(new_n72_));
  oai21  g47(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n73_));
  nand2  g48(.a(x08), .b(x00), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n73_), .c(new_n25_), .O(new_n75_));
  inv1   g50(.a(x14), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x01), .c(new_n70_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(new_n56_), .c(new_n49_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n38_), .O(new_n81_));
  nand4  g56(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n25_), .O(new_n84_));
  aoi21  g59(.a(x03), .b(new_n25_), .c(x08), .O(new_n85_));
  nor2   g60(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n84_), .O(z7));
  inv1   g62(.a(x12), .O(new_n88_));
  nand4  g63(.a(new_n88_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g65(.a(new_n50_), .b(new_n70_), .c(x10), .O(new_n91_));
  nand3  g66(.a(new_n91_), .b(new_n90_), .c(new_n49_), .O(z8));
  zero   g67(.O(z3));
endmodule
