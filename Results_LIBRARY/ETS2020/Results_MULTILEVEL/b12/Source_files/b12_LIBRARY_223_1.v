...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n64_, new_n65_, new_n67_, new_n70_, new_n71_, new_n72_, new_n73_,
  ...
  nand3  g44(.a(x09), .b(x03), .c(new_n38_), .O(new_n70_));
  nand4  g45(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  aoi21  g48(.a(x03), .b(new_n25_), .c(x08), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(new_n47_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n73_), .O(z7));
  inv1   g51(.a(x12), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(x09), .O(new_n79_));
  aoi21  g54(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(new_n79_), .c(new_n49_), .O(z8));
  zero   g56(.O(z6));
endmodule
