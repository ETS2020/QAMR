...
module FAU ( 
  ...
  aoi21  g32(.a(new_n56_), .b(new_n38_), .c(x08), .O(new_n57_));
  ...
  oai21  g39(.a(x11), .b(new_n48_), .c(new_n63_), .O(z4));
  nor2   g40(.a(x12), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n54_), .d(new_n48_), .O(z5));
  ...
  oai21  g46(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n71_));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x01), .c(new_n60_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n54_), .c(new_n48_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  inv1   g54(.a(x12), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(x09), .O(new_n82_));
  aoi21  g57(.a(new_n49_), .b(new_n60_), .c(x10), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(new_n82_), .c(new_n48_), .O(z8));
  zero   g59(.O(z7));
endmodule
