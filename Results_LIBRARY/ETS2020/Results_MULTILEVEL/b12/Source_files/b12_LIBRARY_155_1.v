...
module FAU ( 
  ...
  nor2   g44(.a(x08), .b(new_n62_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  oai21  g46(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n72_));
  nand2  g47(.a(x08), .b(x00), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n72_), .c(new_n25_), .O(new_n74_));
  inv1   g49(.a(x14), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x01), .c(new_n62_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(new_n56_), .c(new_n49_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n38_), .O(new_n80_));
  nand4  g55(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n25_), .O(new_n83_));
  aoi21  g58(.a(x03), .b(new_n25_), .c(x08), .O(new_n84_));
  nor2   g59(.a(new_n84_), .b(new_n47_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n83_), .O(z7));
  inv1   g61(.a(x12), .O(new_n87_));
  nand4  g62(.a(new_n87_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n88_));
  nand2  g63(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi21  g64(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n90_));
  nand3  g65(.a(new_n90_), .b(new_n89_), .c(new_n49_), .O(z8));
  zero   g66(.O(z5));
endmodule
