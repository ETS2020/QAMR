...
module FAU ( 
  ...
  inv1   g04(.a(x24), .O(new_n99_));
  inv1   g05(.a(x26), .O(new_n100_));
  nand2  g06(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g07(.a(new_n101_), .b(new_n98_), .c(new_n97_), .O(new_n102_));
  inv1   g08(.a(x00), .O(new_n103_));
  nand4  g09(.a(x24), .b(x20), .c(x18), .d(new_n103_), .O(new_n104_));
  nand2  g10(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand4  g11(.a(new_n105_), .b(x30), .c(new_n96_), .d(x21), .O(new_n106_));
  nor2   g12(.a(new_n106_), .b(new_n95_), .O(z04));
