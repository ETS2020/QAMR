...
module FAU ( 
  ...
  wire new_n104_, new_n105_, new_n106_, new_n107_, new_n108_, new_n109_,
    ...
    new_n200_, new_n201_, new_n202_, new_n203_, new_n214_, new_n215_,
    new_n217_, new_n218_;
  ...
  aoi21  g101(.a(x28), .b(x18), .c(x30), .O(new_n214_));
  nand4  g102(.a(new_n214_), .b(x29), .c(x26), .d(x21), .O(new_n215_));
  nor3   g103(.a(new_n215_), .b(new_n115_), .c(x19), .O(z23));
  nor2   g104(.a(x19), .b(x18), .O(new_n217_));
  nand4  g105(.a(new_n217_), .b(x22), .c(new_n123_), .d(x20), .O(new_n218_));
  nor3   g106(.a(new_n218_), .b(new_n158_), .c(x29), .O(z24));
  zero   g107(.O(z00));
  zero   g108(.O(z01));
  zero   g109(.O(z02));
  zero   g110(.O(z03));
  ...
  zero   g146(.O(z42));
  zero   g147(.O(z43));
  nor3   g148(.a(new_n218_), .b(new_n158_), .c(x29), .O(z44));
endmodule
