...
module FAU ( 
  ...
  oai21  g122(.a(x24), .b(x22), .c(x30), .O(new_n254_));
  nor2   g123(.a(new_n254_), .b(x29), .O(new_n255_));
  nand4  g124(.a(new_n255_), .b(new_n116_), .c(x20), .d(new_n145_), .O(new_n256_));
  nor2   g125(.a(new_n256_), .b(x18), .O(z43));
  zero   g126(.O(z00));
  zero   g127(.O(z01));
  zero   g128(.O(z02));
  zero   g129(.O(z03));
  ...
  zero   g165(.O(z41));
  zero   g166(.O(z42));
  nor3   g167(.a(new_n118_), .b(new_n115_), .c(x29), .O(z44));
endmodule
