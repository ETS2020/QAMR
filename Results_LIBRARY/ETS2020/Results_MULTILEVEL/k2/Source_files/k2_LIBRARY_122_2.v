...
module FAU ( 
  ...
  inv1   g20(.a(x30), .O(new_n130_));
  inv1   g21(.a(x17), .O(new_n131_));
  nand4  g22(.a(x20), .b(new_n95_), .c(x18), .d(new_n131_), .O(new_n132_));
  nor2   g23(.a(new_n132_), .b(x21), .O(new_n133_));
  nand4  g24(.a(new_n133_), .b(x29), .c(new_n97_), .d(x26), .O(new_n134_));
  nor2   g25(.a(new_n134_), .b(new_n130_), .O(z20));
  inv1   g26(.a(x21), .O(new_n139_));
  nand4  g27(.a(new_n100_), .b(x22), .c(new_n139_), .d(x20), .O(new_n140_));
  nor3   g28(.a(new_n140_), .b(new_n130_), .c(x29), .O(z24));
  zero   g29(.O(z01));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
  zero   g32(.O(z04));
  ...
  zero   g68(.O(z42));
  zero   g69(.O(z43));
  nor3   g70(.a(new_n140_), .b(new_n130_), .c(x29), .O(z44));
endmodule
