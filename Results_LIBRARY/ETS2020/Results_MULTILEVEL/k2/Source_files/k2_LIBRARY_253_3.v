...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n1764_, new_n1765_, new_n1766_, new_n1767_, new_n1768_, new_n1772_,
    new_n1773_;
  ...
  nor3   g1678(.a(new_n1027_), .b(new_n127_), .c(x29), .O(new_n1772_));
  nand4  g1679(.a(new_n1772_), .b(new_n148_), .c(x20), .d(new_n98_), .O(new_n1773_));
  nor2   g1680(.a(new_n1773_), .b(x18), .O(z43));
  zero   g1681(.O(z02));
  zero   g1682(.O(z41));
  zero   g1683(.O(z42));
  nor3   g1684(.a(new_n1160_), .b(new_n127_), .c(x29), .O(z44));
endmodule
