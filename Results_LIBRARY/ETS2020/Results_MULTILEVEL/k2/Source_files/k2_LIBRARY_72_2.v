...
module FAU ( 
  ...
  nor3   g28(.a(x14), .b(x13), .c(x12), .O(new_n149_));
  nand2  g29(.a(new_n149_), .b(x21), .O(new_n150_));
  nor2   g30(.a(new_n150_), .b(x27), .O(new_n151_));
  nand2  g31(.a(new_n151_), .b(new_n129_), .O(new_n152_));
  nor3   g32(.a(new_n152_), .b(x30), .c(x29), .O(z32));
  zero   g33(.O(z00));
  zero   g34(.O(z01));
  zero   g35(.O(z02));
  zero   g36(.O(z03));
  ...
  zero   g72(.O(z42));
  zero   g73(.O(z43));
  nor3   g74(.a(new_n118_), .b(new_n115_), .c(x29), .O(z44));
endmodule
