// Benchmark "FAU" written by ABC on Sat Jul 25 02:41:24 2020
...
module FAU ( 
  ...
  wire new_n101_, new_n102_, new_n103_, new_n104_, new_n105_, new_n106_,
    ...
    new_n203_, new_n204_, new_n219_, new_n220_, new_n223_, new_n224_,
  ...
  nand3  g108(.a(new_n160_), .b(x20), .c(x19), .O(new_n223_));
  nand2  g109(.a(new_n104_), .b(x20), .O(new_n224_));
  nand3  g110(.a(new_n224_), .b(new_n108_), .c(new_n101_), .O(new_n225_));
  nand2  g111(.a(new_n225_), .b(new_n223_), .O(new_n226_));
  nand4  g112(.a(new_n226_), .b(x30), .c(new_n184_), .d(new_n109_), .O(new_n227_));
  nor2   g113(.a(new_n227_), .b(x21), .O(z26));
  zero   g114(.O(z00));
  zero   g115(.O(z01));
  zero   g116(.O(z02));
  zero   g117(.O(z03));
  ...
  zero   g153(.O(z42));
  zero   g154(.O(z43));
  nor3   g155(.a(new_n220_), .b(new_n195_), .c(x29), .O(z44));
endmodule
