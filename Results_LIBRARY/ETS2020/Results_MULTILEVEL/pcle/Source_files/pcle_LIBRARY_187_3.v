...
module FAU ( 
  ...
  oai21  g22(.a(new_n51_), .b(new_n49_), .c(new_n48_), .O(new_n52_));
  nand4  g23(.a(new_n52_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n53_));
  ...
  oai22  g30(.a(new_n59_), .b(new_n49_), .c(new_n58_), .d(new_n56_), .O(new_n60_));
  nand4  g31(.a(new_n60_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n61_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n47_), .c(new_n65_), .O(new_n68_));
  ...
  oai21  g43(.a(new_n72_), .b(new_n47_), .c(x17), .O(new_n73_));
  inv1   g44(.a(x17), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x16), .c(x15), .d(x14), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n47_), .c(new_n73_), .O(new_n76_));
  ...
  oai21  g51(.a(new_n80_), .b(new_n47_), .c(x18), .O(new_n81_));
  nor2   g52(.a(new_n66_), .b(new_n56_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(new_n58_), .c(new_n29_), .d(x17), .O(new_n83_));
