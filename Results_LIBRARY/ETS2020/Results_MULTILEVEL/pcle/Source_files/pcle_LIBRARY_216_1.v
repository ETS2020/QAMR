// Benchmark "FAU" written by ABC on Fri Jul 24 17:34:53 2020
...
module FAU ( 
  ...
  oai21  g42(.a(new_n71_), .b(new_n54_), .c(x17), .O(new_n72_));
  inv1   g43(.a(x17), .O(new_n73_));
  nand4  g44(.a(new_n73_), .b(x16), .c(x15), .d(x14), .O(new_n74_));
  oai21  g45(.a(new_n74_), .b(new_n54_), .c(new_n72_), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n76_));
  nand2  g47(.a(x08), .b(x06), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n76_), .O(z7));
  nand4  g49(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n79_));
  oai21  g50(.a(new_n79_), .b(new_n54_), .c(x18), .O(new_n80_));
  nor2   g51(.a(x18), .b(new_n73_), .O(new_n81_));
  nand4  g52(.a(new_n81_), .b(new_n64_), .c(x16), .d(x15), .O(new_n82_));
  nand2  g53(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand4  g54(.a(new_n83_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n84_));
  nand2  g55(.a(x08), .b(x07), .O(new_n85_));
  nand2  g56(.a(new_n85_), .b(new_n84_), .O(z8));
  zero   g57(.O(z6));
endmodule
