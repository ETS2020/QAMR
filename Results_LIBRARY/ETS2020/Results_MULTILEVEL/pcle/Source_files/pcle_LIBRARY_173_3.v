...
module FAU ( 
  ...
  nand3  g29(.a(new_n56_), .b(x14), .c(x13), .O(new_n59_));
  oai22  g30(.a(new_n59_), .b(new_n40_), .c(new_n58_), .d(new_n56_), .O(new_n60_));
  ...
  oai21  g43(.a(new_n72_), .b(new_n48_), .c(x17), .O(new_n73_));
  inv1   g44(.a(x17), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x16), .c(x15), .d(x14), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n48_), .c(new_n73_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n77_));
  nand2  g48(.a(x08), .b(x06), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n77_), .O(z7));
  nand4  g50(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n48_), .c(x18), .O(new_n81_));
  nor2   g52(.a(new_n66_), .b(new_n56_), .O(new_n82_));
  nor2   g53(.a(x18), .b(new_n74_), .O(new_n83_));
  nand3  g54(.a(new_n83_), .b(new_n82_), .c(new_n58_), .O(new_n84_));
  nand2  g55(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  nand4  g56(.a(new_n85_), .b(new_n32_), .c(x09), .d(new_n31_), .O(new_n86_));
