...
module FAU ( 
  ...
  nand3  g28(.a(new_n55_), .b(x14), .c(x13), .O(new_n58_));
  oai22  g29(.a(new_n58_), .b(new_n46_), .c(new_n57_), .d(new_n55_), .O(new_n59_));
  nand4  g30(.a(new_n59_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n60_));
  nand2  g31(.a(x08), .b(x04), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n60_), .O(z5));
  nand3  g33(.a(x15), .b(x14), .c(x13), .O(new_n63_));
  oai21  g34(.a(new_n63_), .b(new_n46_), .c(x16), .O(new_n64_));
  nand3  g35(.a(x13), .b(x12), .c(x11), .O(new_n65_));
  inv1   g36(.a(x16), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x15), .c(x14), .O(new_n67_));
  oai21  g38(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  ...
  oai21  g43(.a(new_n72_), .b(new_n65_), .c(x17), .O(new_n73_));
  inv1   g44(.a(x17), .O(new_n74_));
  nand4  g45(.a(new_n74_), .b(x16), .c(x15), .d(x14), .O(new_n75_));
  oai21  g46(.a(new_n75_), .b(new_n65_), .c(new_n73_), .O(new_n76_));
  nand4  g47(.a(new_n76_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n77_));
  nand2  g48(.a(x08), .b(x06), .O(new_n78_));
  nand2  g49(.a(new_n78_), .b(new_n77_), .O(z7));
  nand4  g50(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n80_));
  oai21  g51(.a(new_n80_), .b(new_n65_), .c(x18), .O(new_n81_));
  nor2   g52(.a(new_n66_), .b(new_n55_), .O(new_n82_));
  nand4  g53(.a(new_n82_), .b(new_n57_), .c(new_n29_), .d(x17), .O(new_n83_));
  nand2  g54(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand4  g55(.a(new_n84_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n85_));
