...
module FAU ( 
  ...
  nand3  g36(.a(new_n65_), .b(x15), .c(x14), .O(new_n66_));
  oai21  g37(.a(new_n66_), .b(new_n54_), .c(new_n64_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n68_));
  ...
  nand4  g51(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n81_));
  nor2   g52(.a(x18), .b(new_n73_), .O(new_n82_));
  nand3  g53(.a(new_n82_), .b(x16), .c(x15), .O(new_n83_));
  oai21  g54(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(new_n84_));
