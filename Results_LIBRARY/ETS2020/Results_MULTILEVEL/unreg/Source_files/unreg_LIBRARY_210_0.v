...
module FAU ( 
  ...
  nand2  g25(.a(new_n54_), .b(x06), .O(new_n80_));
  inv1   g26(.a(x26), .O(new_n81_));
  nand2  g27(.a(new_n81_), .b(x18), .O(new_n82_));
  nand2  g28(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand3  g29(.a(new_n83_), .b(x19), .c(new_n53_), .O(new_n84_));
  inv1   g30(.a(x25), .O(new_n85_));
  nand2  g31(.a(new_n85_), .b(new_n60_), .O(new_n86_));
  nand2  g32(.a(new_n86_), .b(new_n84_), .O(z05));
  nand2  g33(.a(new_n54_), .b(x05), .O(new_n88_));
  inv1   g34(.a(x27), .O(new_n89_));
  nand2  g35(.a(new_n89_), .b(x18), .O(new_n90_));
  nand2  g36(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand3  g37(.a(new_n91_), .b(x19), .c(new_n53_), .O(new_n92_));
  nand2  g38(.a(new_n81_), .b(new_n60_), .O(new_n93_));
  nand2  g39(.a(new_n93_), .b(new_n92_), .O(z06));
  nand2  g40(.a(new_n54_), .b(x04), .O(new_n95_));
  nand2  g41(.a(new_n61_), .b(x18), .O(new_n96_));
  nand2  g42(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g43(.a(new_n97_), .b(x19), .c(new_n53_), .O(new_n98_));
  nand2  g44(.a(new_n89_), .b(new_n60_), .O(new_n99_));
