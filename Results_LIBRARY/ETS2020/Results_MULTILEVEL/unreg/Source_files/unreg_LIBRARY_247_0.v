...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n102_, new_n103_, new_n104_, new_n111_, new_n112_, new_n113_,
  ...
  nand2  g52(.a(new_n54_), .b(x14), .O(new_n111_));
  inv1   g53(.a(x34), .O(new_n112_));
  nand2  g54(.a(new_n112_), .b(x18), .O(new_n113_));
  nand2  g55(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g56(.a(new_n114_), .b(x19), .c(new_n53_), .O(new_n115_));
  inv1   g57(.a(x33), .O(new_n116_));
  nand2  g58(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  nand2  g59(.a(new_n117_), .b(new_n115_), .O(z13));
  zero   g60(.O(z04));
  zero   g61(.O(z08));
  zero   g62(.O(z09));
  zero   g63(.O(z10));
