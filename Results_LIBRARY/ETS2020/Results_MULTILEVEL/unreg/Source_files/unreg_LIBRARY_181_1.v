// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:32 2020
...
module FAU ( 
  ...
  inv1   g58(.a(x35), .O(new_n119_));
  nand2  g59(.a(new_n119_), .b(new_n64_), .O(new_n120_));
  nand2  g60(.a(new_n120_), .b(new_n118_), .O(z15));
  zero   g61(.O(z00));
  zero   g62(.O(z01));
  zero   g63(.O(z02));
  zero   g64(.O(z03));
