// Benchmark "FAU" written by ABC on Fri Jul 24 17:34:37 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n58_), .b(x14), .O(new_n100_));
  inv1   g40(.a(x34), .O(new_n101_));
  nand2  g41(.a(new_n101_), .b(x18), .O(new_n102_));
  nand2  g42(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand3  g43(.a(new_n103_), .b(x19), .c(new_n57_), .O(new_n104_));
  inv1   g44(.a(x33), .O(new_n105_));
  nand2  g45(.a(new_n105_), .b(new_n64_), .O(new_n106_));
  nand2  g46(.a(new_n106_), .b(new_n104_), .O(z13));
  ...
  nand2  g52(.a(new_n101_), .b(new_n64_), .O(new_n113_));
  nand2  g53(.a(new_n113_), .b(new_n112_), .O(z14));
  nand2  g54(.a(new_n58_), .b(x12), .O(new_n115_));
  nand2  g55(.a(new_n76_), .b(x18), .O(new_n116_));
  nand2  g56(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g57(.a(new_n117_), .b(x19), .c(new_n57_), .O(new_n118_));
  nand2  g58(.a(new_n109_), .b(new_n64_), .O(new_n119_));
