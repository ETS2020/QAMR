...
module FAU ( 
  ...
  inv1   g44(.a(x26), .O(new_n98_));
  nand2  g45(.a(new_n98_), .b(new_n60_), .O(new_n99_));
  nand2  g46(.a(new_n99_), .b(new_n97_), .O(z06));
  nand2  g47(.a(new_n54_), .b(x04), .O(new_n101_));
  nand2  g48(.a(new_n61_), .b(x18), .O(new_n102_));
  nand2  g49(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g50(.a(new_n103_), .b(x19), .c(new_n53_), .O(new_n104_));
  nand2  g51(.a(new_n94_), .b(new_n60_), .O(new_n105_));
  nand2  g52(.a(new_n105_), .b(new_n104_), .O(z07));
  zero   g53(.O(z05));
  zero   g54(.O(z08));
  zero   g55(.O(z09));
  zero   g56(.O(z10));
