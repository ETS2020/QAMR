...
module FAU ( 
  ...
  nand2  g52(.a(new_n54_), .b(x15), .O(new_n110_));
  inv1   g53(.a(x33), .O(new_n111_));
  nand2  g54(.a(new_n111_), .b(x18), .O(new_n112_));
  nand2  g55(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g56(.a(new_n113_), .b(x19), .c(new_n53_), .O(new_n114_));
  inv1   g57(.a(x32), .O(new_n115_));
  nand2  g58(.a(new_n115_), .b(new_n60_), .O(new_n116_));
  nand2  g59(.a(new_n116_), .b(new_n114_), .O(z12));
  zero   g60(.O(z04));
  zero   g61(.O(z08));
  zero   g62(.O(z09));
  zero   g63(.O(z10));
