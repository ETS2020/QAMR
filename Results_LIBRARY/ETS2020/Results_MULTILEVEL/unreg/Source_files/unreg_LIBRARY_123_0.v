...
module FAU ( 
  ...
  nand2  g52(.a(new_n54_), .b(x11), .O(new_n106_));
  inv1   g53(.a(x29), .O(new_n107_));
  nand2  g54(.a(new_n107_), .b(x18), .O(new_n108_));
  nand2  g55(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand3  g56(.a(new_n109_), .b(x19), .c(new_n53_), .O(new_n110_));
  inv1   g57(.a(x28), .O(new_n111_));
  nand2  g58(.a(new_n111_), .b(new_n60_), .O(new_n112_));
  nand2  g59(.a(new_n112_), .b(new_n110_), .O(z08));
  zero   g60(.O(z04));
  zero   g61(.O(z09));
  zero   g62(.O(z10));
  zero   g63(.O(z11));
