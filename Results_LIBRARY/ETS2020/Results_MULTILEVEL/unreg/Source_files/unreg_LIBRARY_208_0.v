...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n108_, new_n109_, new_n110_, new_n117_, new_n118_, new_n119_,
  ...
  nand2  g59(.a(new_n54_), .b(x14), .O(new_n117_));
  inv1   g60(.a(x34), .O(new_n118_));
  nand2  g61(.a(new_n118_), .b(x18), .O(new_n119_));
  nand2  g62(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g63(.a(new_n120_), .b(x19), .c(new_n53_), .O(new_n121_));
  inv1   g64(.a(x33), .O(new_n122_));
  nand2  g65(.a(new_n122_), .b(new_n60_), .O(new_n123_));
  nand2  g66(.a(new_n123_), .b(new_n121_), .O(z13));
  zero   g67(.O(z08));
  zero   g68(.O(z09));
  zero   g69(.O(z10));
  zero   g70(.O(z11));
