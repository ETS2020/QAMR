...
module FAU ( 
  ...
  nand2  g52(.a(new_n54_), .b(x08), .O(new_n109_));
  inv1   g53(.a(x24), .O(new_n110_));
  nand2  g54(.a(new_n110_), .b(x18), .O(new_n111_));
  nand2  g55(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g56(.a(new_n112_), .b(x19), .c(new_n53_), .O(new_n113_));
  inv1   g57(.a(x31), .O(new_n114_));
  nand2  g58(.a(new_n114_), .b(new_n60_), .O(new_n115_));
  nand2  g59(.a(new_n115_), .b(new_n113_), .O(z11));
  zero   g60(.O(z04));
  zero   g61(.O(z08));
  zero   g62(.O(z09));
  zero   g63(.O(z10));
