...
module FAU ( 
  ...
  nand2  g33(.a(new_n58_), .b(x15), .O(new_n94_));
  inv1   g34(.a(x33), .O(new_n95_));
  nand2  g35(.a(new_n95_), .b(x18), .O(new_n96_));
  nand2  g36(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g37(.a(new_n97_), .b(x19), .c(new_n57_), .O(new_n98_));
  inv1   g38(.a(x32), .O(new_n99_));
  nand2  g39(.a(new_n99_), .b(new_n64_), .O(new_n100_));
  nand2  g40(.a(new_n100_), .b(new_n98_), .O(z12));
  nand2  g41(.a(new_n58_), .b(x14), .O(new_n102_));
  inv1   g42(.a(x34), .O(new_n103_));
  nand2  g43(.a(new_n103_), .b(x18), .O(new_n104_));
  nand2  g44(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand3  g45(.a(new_n105_), .b(x19), .c(new_n57_), .O(new_n106_));
  nand2  g46(.a(new_n95_), .b(new_n64_), .O(new_n107_));
  nand2  g47(.a(new_n107_), .b(new_n106_), .O(z13));
  nand2  g48(.a(new_n58_), .b(x13), .O(new_n109_));
  inv1   g49(.a(x35), .O(new_n110_));
  nand2  g50(.a(new_n110_), .b(x18), .O(new_n111_));
  nand2  g51(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g52(.a(new_n112_), .b(x19), .c(new_n57_), .O(new_n113_));
  nand2  g53(.a(new_n103_), .b(new_n64_), .O(new_n114_));
  nand2  g54(.a(new_n114_), .b(new_n113_), .O(z14));
  nand2  g55(.a(new_n58_), .b(x12), .O(new_n116_));
  nand2  g56(.a(new_n76_), .b(x18), .O(new_n117_));
  nand2  g57(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g58(.a(new_n118_), .b(x19), .c(new_n57_), .O(new_n119_));
  nand2  g59(.a(new_n110_), .b(new_n64_), .O(new_n120_));
