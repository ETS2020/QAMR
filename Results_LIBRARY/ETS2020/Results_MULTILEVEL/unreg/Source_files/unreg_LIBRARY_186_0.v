// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:34 2020
...
module FAU ( 
  ...
  nand2  g52(.a(new_n54_), .b(x09), .O(new_n108_));
  inv1   g53(.a(x31), .O(new_n109_));
  nand2  g54(.a(new_n109_), .b(x18), .O(new_n110_));
  nand2  g55(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g56(.a(new_n111_), .b(x19), .c(new_n53_), .O(new_n112_));
  inv1   g57(.a(x30), .O(new_n113_));
  nand2  g58(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  nand2  g59(.a(new_n114_), .b(new_n112_), .O(z10));
  zero   g60(.O(z04));
  zero   g61(.O(z08));
  zero   g62(.O(z09));
  zero   g63(.O(z11));
