...
module FAU ( 
  ...
  nand2  g40(.a(new_n62_), .b(x13), .O(new_n102_));
  inv1   g41(.a(x35), .O(new_n103_));
  nand2  g42(.a(new_n103_), .b(x18), .O(new_n104_));
  nand2  g43(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand3  g44(.a(new_n105_), .b(x19), .c(new_n61_), .O(new_n106_));
  inv1   g45(.a(x34), .O(new_n107_));
  nand2  g46(.a(new_n107_), .b(new_n68_), .O(new_n108_));
  nand2  g47(.a(new_n108_), .b(new_n106_), .O(z14));
  ...
  nand2  g52(.a(new_n103_), .b(new_n68_), .O(new_n114_));
