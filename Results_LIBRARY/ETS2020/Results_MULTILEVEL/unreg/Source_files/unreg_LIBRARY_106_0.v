...
module FAU ( 
  ...
  nand2  g59(.a(new_n54_), .b(x10), .O(new_n113_));
  inv1   g60(.a(x30), .O(new_n114_));
  nand2  g61(.a(new_n114_), .b(x18), .O(new_n115_));
  nand2  g62(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g63(.a(new_n116_), .b(x19), .c(new_n53_), .O(new_n117_));
  inv1   g64(.a(x29), .O(new_n118_));
  nand2  g65(.a(new_n118_), .b(new_n60_), .O(new_n119_));
  nand2  g66(.a(new_n119_), .b(new_n117_), .O(z09));
  zero   g67(.O(z08));
  zero   g68(.O(z10));
  zero   g69(.O(z11));
  zero   g70(.O(z12));
