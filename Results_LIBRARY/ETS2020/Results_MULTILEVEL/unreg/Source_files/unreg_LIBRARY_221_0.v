// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:50 2020
...
module FAU ( 
  ...
  nand2  g31(.a(new_n54_), .b(x06), .O(new_n85_));
  inv1   g32(.a(x26), .O(new_n86_));
  nand2  g33(.a(new_n86_), .b(x18), .O(new_n87_));
  nand2  g34(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand3  g35(.a(new_n88_), .b(x19), .c(new_n53_), .O(new_n89_));
  inv1   g36(.a(x25), .O(new_n90_));
  nand2  g37(.a(new_n90_), .b(new_n60_), .O(new_n91_));
  nand2  g38(.a(new_n91_), .b(new_n89_), .O(z05));
  nand2  g39(.a(new_n54_), .b(x05), .O(new_n93_));
  inv1   g40(.a(x27), .O(new_n94_));
  nand2  g41(.a(new_n94_), .b(x18), .O(new_n95_));
  nand2  g42(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand3  g43(.a(new_n96_), .b(x19), .c(new_n53_), .O(new_n97_));
  nand2  g44(.a(new_n86_), .b(new_n60_), .O(new_n98_));
  nand2  g45(.a(new_n98_), .b(new_n97_), .O(z06));
  nand2  g46(.a(new_n54_), .b(x04), .O(new_n100_));
  nand2  g47(.a(new_n61_), .b(x18), .O(new_n101_));
  nand2  g48(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g49(.a(new_n102_), .b(x19), .c(new_n53_), .O(new_n103_));
  nand2  g50(.a(new_n94_), .b(new_n60_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(new_n103_), .O(z07));
  nand2  g52(.a(new_n54_), .b(x10), .O(new_n107_));
  inv1   g53(.a(x30), .O(new_n108_));
  nand2  g54(.a(new_n108_), .b(x18), .O(new_n109_));
  nand2  g55(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand3  g56(.a(new_n110_), .b(x19), .c(new_n53_), .O(new_n111_));
  inv1   g57(.a(x29), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(new_n60_), .O(new_n113_));
  nand2  g59(.a(new_n113_), .b(new_n111_), .O(z09));
  zero   g60(.O(z04));
  zero   g61(.O(z08));
  zero   g62(.O(z10));
  zero   g63(.O(z11));
