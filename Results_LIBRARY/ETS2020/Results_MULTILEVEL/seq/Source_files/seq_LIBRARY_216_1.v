...
module FAU ( 
  ...
  aoi21  g1429(.a(new_n1506_), .b(new_n1504_), .c(x05), .O(new_n1507_));
  nor3   g1430(.a(new_n1507_), .b(new_n808_), .c(new_n292_), .O(new_n1508_));
  nor2   g1431(.a(new_n1508_), .b(x36), .O(new_n1509_));
