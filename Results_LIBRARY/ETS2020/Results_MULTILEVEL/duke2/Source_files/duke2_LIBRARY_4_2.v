...
module FAU ( 
  ...
  nand3  g342(.a(new_n260_), .b(x18), .c(new_n63_), .O(new_n396_));
  nand3  g343(.a(new_n367_), .b(new_n52_), .c(new_n79_), .O(new_n397_));
  nand2  g344(.a(new_n397_), .b(new_n396_), .O(new_n398_));
  nand3  g345(.a(new_n398_), .b(new_n55_), .c(x04), .O(new_n399_));
  nand3  g346(.a(x11), .b(new_n57_), .c(new_n78_), .O(new_n400_));
  nand3  g347(.a(new_n85_), .b(x05), .c(new_n62_), .O(new_n401_));
  ...
  nand4  g351(.a(x18), .b(new_n55_), .c(new_n73_), .d(new_n57_), .O(new_n405_));
  ...
  nand4  g355(.a(new_n408_), .b(new_n283_), .c(x08), .d(x01), .O(new_n409_));
  nand2  g356(.a(new_n409_), .b(new_n407_), .O(new_n410_));
  nand3  g357(.a(new_n410_), .b(new_n53_), .c(new_n72_), .O(new_n411_));
  inv1   g358(.a(new_n411_), .O(z24));
  nand2  g359(.a(new_n374_), .b(new_n73_), .O(new_n413_));
  ...
  aoi21  g363(.a(new_n66_), .b(new_n79_), .c(x20), .O(z26));
  nand3  g364(.a(x06), .b(new_n57_), .c(x02), .O(new_n418_));
  nor4   g365(.a(new_n418_), .b(x15), .c(x11), .d(x08), .O(new_n419_));
  oai21  g366(.a(new_n419_), .b(new_n265_), .c(new_n66_), .O(new_n420_));
  nand4  g367(.a(x19), .b(new_n55_), .c(new_n73_), .d(x05), .O(new_n421_));
  aoi21  g368(.a(new_n421_), .b(new_n420_), .c(x07), .O(new_n422_));
  nand4  g369(.a(new_n149_), .b(x19), .c(x08), .d(x07), .O(new_n423_));
  ...
  nand4  g379(.a(new_n432_), .b(new_n247_), .c(new_n160_), .d(new_n99_), .O(new_n433_));
  nand2  g380(.a(new_n433_), .b(new_n430_), .O(z27));
  nand4  g381(.a(new_n66_), .b(x11), .c(new_n72_), .d(new_n54_), .O(new_n435_));
  aoi21  g382(.a(new_n435_), .b(new_n72_), .c(x02), .O(new_n436_));
  nand2  g383(.a(new_n220_), .b(x11), .O(new_n437_));
  oai21  g384(.a(new_n437_), .b(new_n436_), .c(x15), .O(new_n438_));
  nand3  g385(.a(x13), .b(new_n85_), .c(new_n78_), .O(new_n439_));
  nand4  g386(.a(new_n439_), .b(new_n66_), .c(new_n55_), .d(new_n79_), .O(new_n440_));
  nor2   g387(.a(new_n440_), .b(new_n63_), .O(new_n441_));
  nand4  g388(.a(new_n441_), .b(x10), .c(new_n72_), .d(new_n54_), .O(new_n442_));
  aoi21  g389(.a(new_n442_), .b(new_n438_), .c(x05), .O(new_n443_));
  nor2   g390(.a(new_n135_), .b(x15), .O(new_n444_));
  nand4  g391(.a(new_n444_), .b(x12), .c(x05), .d(new_n62_), .O(new_n445_));
  nand3  g392(.a(x21), .b(x15), .c(new_n72_), .O(new_n446_));
  aoi21  g393(.a(new_n446_), .b(new_n445_), .c(x07), .O(new_n447_));
  oai21  g394(.a(new_n447_), .b(new_n443_), .c(x08), .O(new_n448_));
  nand3  g395(.a(x11), .b(x06), .c(new_n78_), .O(new_n449_));
  nand2  g396(.a(new_n449_), .b(new_n267_), .O(new_n450_));
  nand4  g397(.a(new_n450_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n451_));
  nand2  g398(.a(new_n116_), .b(x15), .O(new_n452_));
  aoi21  g399(.a(new_n452_), .b(new_n451_), .c(x09), .O(new_n453_));
  nand4  g400(.a(new_n453_), .b(new_n73_), .c(new_n54_), .d(new_n57_), .O(new_n454_));
  aoi21  g401(.a(new_n454_), .b(new_n448_), .c(new_n52_), .O(new_n455_));
  inv1   g402(.a(new_n110_), .O(new_n456_));
  nand3  g403(.a(new_n456_), .b(new_n52_), .c(x15), .O(new_n457_));
  nor4   g404(.a(new_n457_), .b(x09), .c(new_n54_), .d(x05), .O(new_n458_));
  oai21  g405(.a(new_n458_), .b(new_n455_), .c(new_n53_), .O(new_n459_));
  inv1   g406(.a(new_n309_), .O(new_n460_));
  inv1   g407(.a(new_n117_), .O(new_n461_));
  nand3  g408(.a(new_n461_), .b(x15), .c(new_n57_), .O(new_n462_));
  nand2  g409(.a(new_n462_), .b(new_n460_), .O(new_n463_));
  nand4  g410(.a(new_n463_), .b(new_n52_), .c(x17), .d(new_n72_), .O(new_n464_));
  nand2  g411(.a(new_n464_), .b(new_n459_), .O(z28));
  zero   g412(.O(z04));
  zero   g413(.O(z06));
endmodule
