...
module FAU ( 
  ...
  inv1   g10(.a(x07), .O(new_n75_));
  nand4  g11(.a(new_n63_), .b(new_n67_), .c(new_n75_), .d(x05), .O(new_n76_));
  nor3   g12(.a(new_n76_), .b(x18), .c(new_n64_), .O(z15));
  zero   g13(.O(z00));
  zero   g14(.O(z01));
  zero   g15(.O(z02));
  zero   g16(.O(z03));
