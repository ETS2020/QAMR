// Benchmark "FAU" written by ABC on Fri Jul 24 01:50:40 2020
...
module FAU ( 
  ...
  oai21  g196(.a(new_n247_), .b(x09), .c(x07), .O(new_n248_));
  ...
  oai21  g242(.a(new_n75_), .b(new_n109_), .c(new_n201_), .O(new_n294_));
  ...
  nand3  g249(.a(new_n214_), .b(new_n213_), .c(x08), .O(new_n301_));
  ...
  nand2  g263(.a(new_n214_), .b(new_n213_), .O(new_n315_));
  ...
  aoi22  g284(.a(x13), .b(new_n166_), .c(new_n63_), .d(x04), .O(new_n336_));
  oai21  g285(.a(new_n89_), .b(x02), .c(x13), .O(new_n337_));
  nand3  g286(.a(new_n337_), .b(new_n106_), .c(x12), .O(new_n338_));
  ...
  nand3  g290(.a(new_n341_), .b(new_n340_), .c(new_n189_), .O(new_n342_));
  nand4  g291(.a(new_n342_), .b(new_n66_), .c(new_n79_), .d(new_n72_), .O(new_n343_));
  nand2  g292(.a(new_n116_), .b(x09), .O(new_n344_));
  ...
  nand3  g301(.a(x12), .b(new_n109_), .c(new_n62_), .O(new_n353_));
  ...
  aoi21  g306(.a(new_n357_), .b(new_n208_), .c(x07), .O(new_n358_));
  oai21  g307(.a(new_n358_), .b(new_n211_), .c(new_n57_), .O(new_n359_));
  nand4  g308(.a(new_n216_), .b(new_n101_), .c(x15), .d(new_n89_), .O(new_n360_));
  ...
  oai21  g315(.a(new_n366_), .b(new_n63_), .c(new_n169_), .O(new_n367_));
  ...
  nand4  g321(.a(new_n141_), .b(x17), .c(new_n55_), .d(new_n72_), .O(new_n373_));
  ...
  nand2  g325(.a(new_n376_), .b(new_n227_), .O(new_n377_));
  ...
  nand3  g330(.a(new_n178_), .b(new_n55_), .c(new_n79_), .O(new_n382_));
  inv1   g331(.a(new_n382_), .O(new_n383_));
  nand4  g332(.a(new_n383_), .b(new_n73_), .c(new_n109_), .d(new_n57_), .O(new_n384_));
  ...
  nand4  g336(.a(new_n387_), .b(new_n259_), .c(new_n67_), .d(x04), .O(new_n388_));
  ...
  nand2  g343(.a(new_n394_), .b(new_n267_), .O(new_n395_));
  ...
  nand4  g353(.a(new_n141_), .b(new_n55_), .c(x09), .d(x08), .O(new_n406_));
  nor3   g354(.a(new_n406_), .b(new_n52_), .c(x17), .O(z23));
  nand3  g355(.a(new_n288_), .b(x18), .c(new_n63_), .O(new_n408_));
  nand3  g356(.a(new_n387_), .b(new_n52_), .c(new_n79_), .O(new_n409_));
  nand2  g357(.a(new_n409_), .b(new_n408_), .O(new_n410_));
  nand3  g358(.a(new_n410_), .b(new_n55_), .c(x04), .O(new_n411_));
  nand3  g359(.a(x11), .b(new_n57_), .c(new_n78_), .O(new_n412_));
  nand3  g360(.a(new_n89_), .b(x05), .c(new_n62_), .O(new_n413_));
  nand2  g361(.a(new_n413_), .b(new_n412_), .O(new_n414_));
  nand4  g362(.a(new_n414_), .b(x18), .c(x15), .d(x08), .O(new_n415_));
  aoi21  g363(.a(new_n415_), .b(new_n411_), .c(x21), .O(new_n416_));
  nand4  g364(.a(x18), .b(new_n55_), .c(new_n73_), .d(new_n57_), .O(new_n417_));
  inv1   g365(.a(new_n417_), .O(new_n418_));
  oai21  g366(.a(new_n418_), .b(new_n416_), .c(new_n54_), .O(new_n419_));
  nor2   g367(.a(x18), .b(x15), .O(new_n420_));
  nand4  g368(.a(new_n420_), .b(new_n307_), .c(x08), .d(x01), .O(new_n421_));
  nand2  g369(.a(new_n421_), .b(new_n419_), .O(new_n422_));
  nand3  g370(.a(new_n422_), .b(new_n53_), .c(new_n72_), .O(new_n423_));
  inv1   g371(.a(new_n423_), .O(z24));
  nand2  g372(.a(new_n160_), .b(x08), .O(new_n425_));
  nand2  g373(.a(new_n394_), .b(new_n73_), .O(new_n426_));
  ...
  oai21  g380(.a(new_n432_), .b(new_n292_), .c(new_n66_), .O(new_n433_));
  nand4  g381(.a(x19), .b(new_n55_), .c(new_n73_), .d(x05), .O(new_n434_));
  aoi21  g382(.a(new_n434_), .b(new_n433_), .c(x07), .O(new_n435_));
  nand4  g383(.a(new_n149_), .b(x19), .c(x08), .d(x07), .O(new_n436_));
  ...
  nand4  g393(.a(new_n445_), .b(new_n275_), .c(new_n160_), .d(new_n99_), .O(new_n446_));
  ...
  nand2  g397(.a(new_n248_), .b(x11), .O(new_n450_));
  ...
  nor2   g404(.a(new_n135_), .b(x15), .O(new_n457_));
  ...
  nand4  g409(.a(new_n202_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n462_));
  ...
  inv1   g418(.a(new_n333_), .O(new_n471_));
