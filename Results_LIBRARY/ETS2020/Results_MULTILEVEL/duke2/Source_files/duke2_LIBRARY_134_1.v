...
module FAU ( 
  ...
  wire new_n58_, new_n59_, new_n60_, new_n61_, new_n62_, new_n63_, new_n64_,
    ...
    new_n106_, new_n107_, new_n108_, new_n109_, new_n128_, new_n129_,
  ...
  inv1   g54(.a(x09), .O(new_n128_));
  nand4  g55(.a(x18), .b(new_n86_), .c(x08), .d(x05), .O(new_n129_));
  nand4  g56(.a(new_n98_), .b(new_n64_), .c(x12), .d(new_n58_), .O(new_n130_));
  nand2  g57(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g58(.a(new_n131_), .b(new_n101_), .c(x04), .O(new_n132_));
  nand3  g59(.a(x11), .b(new_n58_), .c(new_n65_), .O(new_n133_));
  nand3  g60(.a(new_n74_), .b(x05), .c(new_n72_), .O(new_n134_));
  nand2  g61(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand4  g62(.a(new_n135_), .b(x18), .c(x15), .d(x08), .O(new_n136_));
  aoi21  g63(.a(new_n136_), .b(new_n132_), .c(x21), .O(new_n137_));
  nand4  g64(.a(x18), .b(new_n101_), .c(new_n61_), .d(new_n58_), .O(new_n138_));
  inv1   g65(.a(new_n138_), .O(new_n139_));
  oai21  g66(.a(new_n139_), .b(new_n137_), .c(new_n105_), .O(new_n140_));
  nor2   g67(.a(new_n105_), .b(x05), .O(new_n141_));
  nor2   g68(.a(x18), .b(x15), .O(new_n142_));
  nand4  g69(.a(new_n142_), .b(new_n141_), .c(x08), .d(x01), .O(new_n143_));
  nand2  g70(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g71(.a(new_n144_), .b(new_n59_), .c(new_n128_), .O(new_n145_));
  inv1   g72(.a(new_n145_), .O(z24));
  zero   g73(.O(z00));
  zero   g74(.O(z01));
  zero   g75(.O(z02));
  zero   g76(.O(z03));
