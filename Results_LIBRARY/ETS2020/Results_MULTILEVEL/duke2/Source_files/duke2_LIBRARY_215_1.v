...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n66_, new_n67_, new_n87_, new_n88_;
  ...
  nor3   g18(.a(x09), .b(x07), .c(x05), .O(new_n87_));
  nand3  g19(.a(new_n87_), .b(x17), .c(new_n55_), .O(new_n88_));
  nor2   g20(.a(new_n88_), .b(x18), .O(z19));
  zero   g21(.O(z01));
  zero   g22(.O(z02));
  zero   g23(.O(z03));
  zero   g24(.O(z05));
