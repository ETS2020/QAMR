...
module FAU ( 
  ...
  wire new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n81_, new_n82_, new_n83_;
  ...
  nand4  g19(.a(new_n70_), .b(x07), .c(new_n59_), .d(x01), .O(new_n81_));
  inv1   g20(.a(new_n81_), .O(new_n82_));
  nand4  g21(.a(new_n82_), .b(new_n60_), .c(new_n56_), .d(new_n64_), .O(new_n83_));
  inv1   g22(.a(new_n83_), .O(z11));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z04));
