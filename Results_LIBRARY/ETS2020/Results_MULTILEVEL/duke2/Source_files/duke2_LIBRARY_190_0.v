// Benchmark "FAU" written by ABC on Fri Jul 24 01:50:33 2020
...
module FAU ( 
  ...
  nand4  g311(.a(new_n141_), .b(x17), .c(new_n55_), .d(new_n72_), .O(new_n364_));
  nor2   g312(.a(new_n364_), .b(x18), .O(z19));
  inv1   g313(.a(new_n289_), .O(new_n366_));
  nand4  g314(.a(new_n188_), .b(new_n79_), .c(x10), .d(x08), .O(new_n367_));
  nand2  g315(.a(new_n367_), .b(new_n227_), .O(new_n368_));
  nand2  g316(.a(new_n368_), .b(new_n57_), .O(new_n369_));
  nand2  g317(.a(new_n369_), .b(new_n366_), .O(new_n370_));
  nand4  g318(.a(new_n370_), .b(new_n55_), .c(new_n63_), .d(x04), .O(new_n371_));
  aoi21  g319(.a(new_n371_), .b(new_n294_), .c(x21), .O(new_n372_));
  nand3  g320(.a(new_n178_), .b(new_n55_), .c(new_n79_), .O(new_n373_));
  inv1   g321(.a(new_n373_), .O(new_n374_));
  nand4  g322(.a(new_n374_), .b(new_n73_), .c(new_n109_), .d(new_n57_), .O(new_n375_));
  inv1   g323(.a(new_n375_), .O(new_n376_));
  oai21  g324(.a(new_n376_), .b(new_n372_), .c(x18), .O(new_n377_));
  nor2   g325(.a(new_n63_), .b(x05), .O(new_n378_));
  nand4  g326(.a(new_n378_), .b(new_n260_), .c(new_n67_), .d(x04), .O(new_n379_));
  aoi21  g327(.a(new_n379_), .b(new_n377_), .c(x09), .O(new_n380_));
  nand4  g328(.a(x18), .b(new_n55_), .c(new_n63_), .d(x09), .O(new_n381_));
  nor3   g329(.a(new_n381_), .b(new_n366_), .c(new_n62_), .O(new_n382_));
  oai21  g330(.a(new_n382_), .b(new_n380_), .c(new_n53_), .O(new_n383_));
  nor2   g331(.a(new_n383_), .b(x07), .O(z20));
  nor2   g332(.a(new_n55_), .b(x09), .O(new_n385_));
  nand2  g333(.a(new_n385_), .b(new_n268_), .O(new_n386_));
  nand3  g334(.a(new_n160_), .b(x08), .c(x06), .O(new_n387_));
  aoi21  g335(.a(new_n387_), .b(new_n386_), .c(x05), .O(new_n388_));
  nand3  g336(.a(new_n55_), .b(new_n72_), .c(new_n73_), .O(new_n389_));
  nor3   g337(.a(new_n389_), .b(new_n109_), .c(new_n57_), .O(new_n390_));
  oai21  g338(.a(new_n390_), .b(new_n388_), .c(new_n54_), .O(new_n391_));
  nand3  g339(.a(new_n385_), .b(new_n308_), .c(x08), .O(new_n392_));
  nand2  g340(.a(new_n392_), .b(new_n391_), .O(new_n393_));
  nand3  g341(.a(new_n393_), .b(x18), .c(new_n53_), .O(new_n394_));
  inv1   g342(.a(new_n394_), .O(z21));
  nand3  g343(.a(new_n385_), .b(new_n73_), .c(x06), .O(new_n396_));
  nand2  g344(.a(new_n160_), .b(x08), .O(new_n397_));
  aoi21  g345(.a(new_n397_), .b(new_n396_), .c(x05), .O(new_n398_));
  oai21  g346(.a(new_n398_), .b(new_n390_), .c(new_n54_), .O(new_n399_));
  aoi21  g347(.a(new_n247_), .b(new_n72_), .c(new_n55_), .O(new_n400_));
  nand4  g348(.a(new_n400_), .b(x08), .c(x07), .d(new_n57_), .O(new_n401_));
  nand2  g349(.a(new_n401_), .b(new_n399_), .O(new_n402_));
  nand3  g350(.a(new_n402_), .b(x18), .c(new_n53_), .O(new_n403_));
  inv1   g351(.a(new_n403_), .O(z22));
  nand4  g352(.a(new_n141_), .b(new_n55_), .c(x09), .d(x08), .O(new_n405_));
  nor3   g353(.a(new_n405_), .b(new_n52_), .c(x17), .O(z23));
  nand3  g354(.a(new_n289_), .b(x18), .c(new_n63_), .O(new_n407_));
  nand3  g355(.a(new_n378_), .b(new_n52_), .c(new_n79_), .O(new_n408_));
  nand2  g356(.a(new_n408_), .b(new_n407_), .O(new_n409_));
  nand3  g357(.a(new_n409_), .b(new_n55_), .c(x04), .O(new_n410_));
  nand3  g358(.a(x11), .b(new_n57_), .c(new_n78_), .O(new_n411_));
  nand3  g359(.a(new_n89_), .b(x05), .c(new_n62_), .O(new_n412_));
  nand2  g360(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  nand4  g361(.a(new_n413_), .b(x18), .c(x15), .d(x08), .O(new_n414_));
  aoi21  g362(.a(new_n414_), .b(new_n410_), .c(x21), .O(new_n415_));
  nand4  g363(.a(x18), .b(new_n55_), .c(new_n73_), .d(new_n57_), .O(new_n416_));
  inv1   g364(.a(new_n416_), .O(new_n417_));
  oai21  g365(.a(new_n417_), .b(new_n415_), .c(new_n54_), .O(new_n418_));
  nor2   g366(.a(x18), .b(x15), .O(new_n419_));
  nand4  g367(.a(new_n419_), .b(new_n308_), .c(x08), .d(x01), .O(new_n420_));
  nand2  g368(.a(new_n420_), .b(new_n418_), .O(new_n421_));
  nand3  g369(.a(new_n421_), .b(new_n53_), .c(new_n72_), .O(new_n422_));
  inv1   g370(.a(new_n422_), .O(z24));
  nand2  g371(.a(new_n385_), .b(new_n73_), .O(new_n424_));
  nand2  g372(.a(new_n424_), .b(new_n397_), .O(new_n425_));
  nand4  g373(.a(new_n425_), .b(x18), .c(new_n53_), .d(new_n54_), .O(new_n426_));
  nor2   g374(.a(new_n426_), .b(x05), .O(z25));
  aoi21  g375(.a(new_n66_), .b(new_n79_), .c(x20), .O(z26));
  nand3  g376(.a(x06), .b(new_n57_), .c(x02), .O(new_n429_));
  nor4   g377(.a(new_n429_), .b(x15), .c(x11), .d(x08), .O(new_n430_));
  oai21  g378(.a(new_n430_), .b(new_n293_), .c(new_n66_), .O(new_n431_));
  nand4  g379(.a(x19), .b(new_n55_), .c(new_n73_), .d(x05), .O(new_n432_));
  aoi21  g380(.a(new_n432_), .b(new_n431_), .c(x07), .O(new_n433_));
  nand4  g381(.a(new_n149_), .b(x19), .c(x08), .d(x07), .O(new_n434_));
  inv1   g382(.a(new_n434_), .O(new_n435_));
  oai21  g383(.a(new_n435_), .b(new_n433_), .c(x18), .O(new_n436_));
  nand3  g384(.a(x15), .b(new_n54_), .c(x00), .O(new_n437_));
  oai21  g385(.a(x15), .b(new_n54_), .c(new_n437_), .O(new_n438_));
  nand4  g386(.a(new_n438_), .b(new_n52_), .c(x17), .d(new_n57_), .O(new_n439_));
  oai21  g387(.a(new_n436_), .b(x17), .c(new_n439_), .O(new_n440_));
  nand2  g388(.a(new_n440_), .b(new_n72_), .O(new_n441_));
  inv1   g389(.a(x03), .O(new_n442_));
  nor2   g390(.a(x05), .b(new_n442_), .O(new_n443_));
  nand4  g391(.a(new_n443_), .b(new_n276_), .c(new_n160_), .d(new_n99_), .O(new_n444_));
  nand2  g392(.a(new_n444_), .b(new_n441_), .O(z27));
  nand4  g393(.a(new_n66_), .b(x11), .c(new_n72_), .d(new_n54_), .O(new_n446_));
  aoi21  g394(.a(new_n446_), .b(new_n72_), .c(x02), .O(new_n447_));
  nand2  g395(.a(new_n249_), .b(x11), .O(new_n448_));
  oai21  g396(.a(new_n448_), .b(new_n447_), .c(x15), .O(new_n449_));
  nand3  g397(.a(x13), .b(new_n89_), .c(new_n78_), .O(new_n450_));
  nand4  g398(.a(new_n450_), .b(new_n66_), .c(new_n55_), .d(new_n79_), .O(new_n451_));
  nor2   g399(.a(new_n451_), .b(new_n63_), .O(new_n452_));
  nand4  g400(.a(new_n452_), .b(x10), .c(new_n72_), .d(new_n54_), .O(new_n453_));
  aoi21  g401(.a(new_n453_), .b(new_n449_), .c(x05), .O(new_n454_));
  nor2   g402(.a(new_n135_), .b(x15), .O(new_n455_));
  nand4  g403(.a(new_n455_), .b(x12), .c(x05), .d(new_n62_), .O(new_n456_));
  nand3  g404(.a(x21), .b(x15), .c(new_n72_), .O(new_n457_));
  aoi21  g405(.a(new_n457_), .b(new_n456_), .c(x07), .O(new_n458_));
  oai21  g406(.a(new_n458_), .b(new_n454_), .c(x08), .O(new_n459_));
  nand4  g407(.a(new_n202_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n460_));
  nand2  g408(.a(new_n116_), .b(x15), .O(new_n461_));
  aoi21  g409(.a(new_n461_), .b(new_n460_), .c(x09), .O(new_n462_));
  nand4  g410(.a(new_n462_), .b(new_n73_), .c(new_n54_), .d(new_n57_), .O(new_n463_));
  aoi21  g411(.a(new_n463_), .b(new_n459_), .c(new_n52_), .O(new_n464_));
  inv1   g412(.a(new_n110_), .O(new_n465_));
  nand3  g413(.a(new_n465_), .b(new_n52_), .c(x15), .O(new_n466_));
  nor4   g414(.a(new_n466_), .b(x09), .c(new_n54_), .d(x05), .O(new_n467_));
  oai21  g415(.a(new_n467_), .b(new_n464_), .c(new_n53_), .O(new_n468_));
  inv1   g416(.a(new_n334_), .O(new_n469_));
  inv1   g417(.a(new_n117_), .O(new_n470_));
  nand3  g418(.a(new_n470_), .b(x15), .c(new_n57_), .O(new_n471_));
  nand2  g419(.a(new_n471_), .b(new_n469_), .O(new_n472_));
  nand4  g420(.a(new_n472_), .b(new_n52_), .c(x17), .d(new_n72_), .O(new_n473_));
  nand2  g421(.a(new_n473_), .b(new_n468_), .O(z28));
  zero   g422(.O(z18));
endmodule
