...
module FAU ( 
  ...
  nand3  g234(.a(new_n286_), .b(x15), .c(new_n89_), .O(new_n287_));
  ...
  nand2  g253(.a(new_n305_), .b(new_n265_), .O(new_n306_));
  ...
  nand3  g259(.a(new_n90_), .b(new_n57_), .c(new_n78_), .O(new_n312_));
  nand2  g260(.a(new_n214_), .b(new_n213_), .O(new_n313_));
  nand2  g261(.a(new_n313_), .b(new_n312_), .O(new_n314_));
  nand3  g262(.a(new_n314_), .b(new_n311_), .c(new_n54_), .O(new_n315_));
  nand3  g263(.a(new_n149_), .b(new_n116_), .c(x07), .O(new_n316_));
  nand2  g264(.a(new_n316_), .b(new_n315_), .O(new_n317_));
  nand3  g265(.a(new_n317_), .b(x18), .c(x08), .O(new_n318_));
  nand2  g266(.a(x11), .b(new_n78_), .O(new_n319_));
  oai21  g267(.a(new_n319_), .b(new_n78_), .c(x15), .O(new_n320_));
  ...
  inv1   g320(.a(new_n286_), .O(new_n373_));
  ...
  aoi21  g326(.a(new_n378_), .b(new_n291_), .c(x21), .O(new_n379_));
  ...
  nand3  g346(.a(new_n392_), .b(new_n305_), .c(x08), .O(new_n399_));
  ...
  nand3  g361(.a(new_n286_), .b(x18), .c(new_n63_), .O(new_n414_));
  ...
  nand4  g374(.a(new_n426_), .b(new_n305_), .c(x08), .d(x01), .O(new_n427_));
  ...
  oai21  g385(.a(new_n437_), .b(new_n290_), .c(new_n66_), .O(new_n438_));
