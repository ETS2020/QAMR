// Benchmark "FAU" written by ABC on Fri Jul 24 01:50:20 2020
...
module FAU ( 
  ...
  aoi22  g282(.a(x13), .b(new_n166_), .c(new_n63_), .d(x04), .O(new_n335_));
  oai21  g283(.a(new_n89_), .b(x02), .c(x13), .O(new_n336_));
  nand3  g284(.a(new_n336_), .b(new_n106_), .c(x12), .O(new_n337_));
  oai21  g285(.a(new_n335_), .b(new_n78_), .c(new_n337_), .O(new_n338_));
  nand2  g286(.a(new_n338_), .b(x06), .O(new_n339_));
  nand4  g287(.a(new_n336_), .b(x16), .c(x12), .d(new_n109_), .O(new_n340_));
  nand3  g288(.a(new_n340_), .b(new_n339_), .c(new_n189_), .O(new_n341_));
  nand4  g289(.a(new_n341_), .b(new_n66_), .c(new_n79_), .d(new_n72_), .O(new_n342_));
  nand2  g290(.a(new_n116_), .b(x09), .O(new_n343_));
  aoi21  g291(.a(new_n343_), .b(new_n342_), .c(x15), .O(new_n344_));
  aoi21  g292(.a(new_n54_), .b(x02), .c(new_n55_), .O(new_n345_));
  aoi22  g293(.a(new_n345_), .b(x09), .c(new_n344_), .d(new_n54_), .O(new_n346_));
  nand4  g294(.a(new_n65_), .b(new_n55_), .c(x09), .d(x05), .O(new_n347_));
  oai21  g295(.a(new_n346_), .b(x05), .c(new_n347_), .O(new_n348_));
  nand4  g296(.a(new_n348_), .b(x18), .c(new_n53_), .d(x08), .O(new_n349_));
  inv1   g297(.a(new_n349_), .O(z16));
  nand3  g298(.a(new_n89_), .b(x06), .c(x02), .O(new_n351_));
  nand3  g299(.a(x12), .b(new_n109_), .c(new_n62_), .O(new_n352_));
  nand2  g300(.a(new_n352_), .b(new_n351_), .O(new_n353_));
  nand4  g301(.a(new_n353_), .b(new_n74_), .c(x18), .d(new_n53_), .O(new_n354_));
  inv1   g302(.a(new_n354_), .O(new_n355_));
  nand3  g303(.a(new_n355_), .b(new_n55_), .c(new_n73_), .O(new_n356_));
  aoi21  g304(.a(new_n356_), .b(new_n208_), .c(x07), .O(new_n357_));
  oai21  g305(.a(new_n357_), .b(new_n211_), .c(new_n57_), .O(new_n358_));
  nand4  g306(.a(new_n216_), .b(new_n101_), .c(x15), .d(new_n89_), .O(new_n359_));
  aoi21  g307(.a(new_n359_), .b(new_n358_), .c(x09), .O(z17));
  nand3  g308(.a(x21), .b(new_n73_), .c(new_n62_), .O(new_n361_));
  nand2  g309(.a(x10), .b(x08), .O(new_n362_));
  oai21  g310(.a(new_n362_), .b(new_n180_), .c(new_n361_), .O(new_n363_));
  nor3   g311(.a(new_n362_), .b(new_n173_), .c(new_n109_), .O(new_n364_));
  aoi21  g312(.a(new_n363_), .b(new_n109_), .c(new_n364_), .O(new_n365_));
  oai21  g313(.a(new_n365_), .b(new_n63_), .c(new_n169_), .O(new_n366_));
  nand3  g314(.a(new_n366_), .b(new_n55_), .c(new_n79_), .O(new_n367_));
  nand3  g315(.a(x19), .b(x15), .c(new_n73_), .O(new_n368_));
  aoi21  g316(.a(new_n368_), .b(new_n367_), .c(new_n52_), .O(new_n369_));
  nand4  g317(.a(new_n369_), .b(new_n53_), .c(new_n72_), .d(new_n54_), .O(new_n370_));
  nor2   g318(.a(new_n370_), .b(x05), .O(z18));
  nand4  g319(.a(new_n141_), .b(x17), .c(new_n55_), .d(new_n72_), .O(new_n372_));
  nor2   g320(.a(new_n372_), .b(x18), .O(z19));
  inv1   g321(.a(new_n289_), .O(new_n374_));
  nand4  g322(.a(new_n188_), .b(new_n79_), .c(x10), .d(x08), .O(new_n375_));
  nand2  g323(.a(new_n375_), .b(new_n227_), .O(new_n376_));
  nand2  g324(.a(new_n376_), .b(new_n57_), .O(new_n377_));
  nand2  g325(.a(new_n377_), .b(new_n374_), .O(new_n378_));
  nand4  g326(.a(new_n378_), .b(new_n55_), .c(new_n63_), .d(x04), .O(new_n379_));
  aoi21  g327(.a(new_n379_), .b(new_n294_), .c(x21), .O(new_n380_));
  nand3  g328(.a(new_n178_), .b(new_n55_), .c(new_n79_), .O(new_n381_));
  inv1   g329(.a(new_n381_), .O(new_n382_));
  nand4  g330(.a(new_n382_), .b(new_n73_), .c(new_n109_), .d(new_n57_), .O(new_n383_));
  inv1   g331(.a(new_n383_), .O(new_n384_));
  oai21  g332(.a(new_n384_), .b(new_n380_), .c(x18), .O(new_n385_));
  nor2   g333(.a(new_n63_), .b(x05), .O(new_n386_));
  nand4  g334(.a(new_n386_), .b(new_n260_), .c(new_n67_), .d(x04), .O(new_n387_));
  aoi21  g335(.a(new_n387_), .b(new_n385_), .c(x09), .O(new_n388_));
  nand4  g336(.a(x18), .b(new_n55_), .c(new_n63_), .d(x09), .O(new_n389_));
  nor3   g337(.a(new_n389_), .b(new_n374_), .c(new_n62_), .O(new_n390_));
  oai21  g338(.a(new_n390_), .b(new_n388_), .c(new_n53_), .O(new_n391_));
  nor2   g339(.a(new_n391_), .b(x07), .O(z20));
  nor2   g340(.a(new_n55_), .b(x09), .O(new_n393_));
  nand2  g341(.a(new_n393_), .b(new_n268_), .O(new_n394_));
  nand3  g342(.a(new_n160_), .b(x08), .c(x06), .O(new_n395_));
  aoi21  g343(.a(new_n395_), .b(new_n394_), .c(x05), .O(new_n396_));
  nand3  g344(.a(new_n55_), .b(new_n72_), .c(new_n73_), .O(new_n397_));
  nor3   g345(.a(new_n397_), .b(new_n109_), .c(new_n57_), .O(new_n398_));
  oai21  g346(.a(new_n398_), .b(new_n396_), .c(new_n54_), .O(new_n399_));
  nand3  g347(.a(new_n393_), .b(new_n308_), .c(x08), .O(new_n400_));
  nand2  g348(.a(new_n400_), .b(new_n399_), .O(new_n401_));
  nand3  g349(.a(new_n401_), .b(x18), .c(new_n53_), .O(new_n402_));
  inv1   g350(.a(new_n402_), .O(z21));
  nand3  g351(.a(new_n393_), .b(new_n73_), .c(x06), .O(new_n404_));
  nand2  g352(.a(new_n160_), .b(x08), .O(new_n405_));
  aoi21  g353(.a(new_n405_), .b(new_n404_), .c(x05), .O(new_n406_));
  oai21  g354(.a(new_n406_), .b(new_n398_), .c(new_n54_), .O(new_n407_));
  aoi21  g355(.a(new_n247_), .b(new_n72_), .c(new_n55_), .O(new_n408_));
  nand4  g356(.a(new_n408_), .b(x08), .c(x07), .d(new_n57_), .O(new_n409_));
  nand2  g357(.a(new_n409_), .b(new_n407_), .O(new_n410_));
  nand3  g358(.a(new_n410_), .b(x18), .c(new_n53_), .O(new_n411_));
  inv1   g359(.a(new_n411_), .O(z22));
  nand4  g360(.a(new_n141_), .b(new_n55_), .c(x09), .d(x08), .O(new_n413_));
  nor3   g361(.a(new_n413_), .b(new_n52_), .c(x17), .O(z23));
  nand3  g362(.a(new_n289_), .b(x18), .c(new_n63_), .O(new_n415_));
  nand3  g363(.a(new_n386_), .b(new_n52_), .c(new_n79_), .O(new_n416_));
  nand2  g364(.a(new_n416_), .b(new_n415_), .O(new_n417_));
  nand3  g365(.a(new_n417_), .b(new_n55_), .c(x04), .O(new_n418_));
  nand3  g366(.a(x11), .b(new_n57_), .c(new_n78_), .O(new_n419_));
  nand3  g367(.a(new_n89_), .b(x05), .c(new_n62_), .O(new_n420_));
  nand2  g368(.a(new_n420_), .b(new_n419_), .O(new_n421_));
  nand4  g369(.a(new_n421_), .b(x18), .c(x15), .d(x08), .O(new_n422_));
  aoi21  g370(.a(new_n422_), .b(new_n418_), .c(x21), .O(new_n423_));
  nand4  g371(.a(x18), .b(new_n55_), .c(new_n73_), .d(new_n57_), .O(new_n424_));
  inv1   g372(.a(new_n424_), .O(new_n425_));
  oai21  g373(.a(new_n425_), .b(new_n423_), .c(new_n54_), .O(new_n426_));
  nor2   g374(.a(x18), .b(x15), .O(new_n427_));
  nand4  g375(.a(new_n427_), .b(new_n308_), .c(x08), .d(x01), .O(new_n428_));
  nand2  g376(.a(new_n428_), .b(new_n426_), .O(new_n429_));
  nand3  g377(.a(new_n429_), .b(new_n53_), .c(new_n72_), .O(new_n430_));
  inv1   g378(.a(new_n430_), .O(z24));
  nand2  g379(.a(new_n393_), .b(new_n73_), .O(new_n432_));
  nand2  g380(.a(new_n432_), .b(new_n405_), .O(new_n433_));
  nand4  g381(.a(new_n433_), .b(x18), .c(new_n53_), .d(new_n54_), .O(new_n434_));
  nor2   g382(.a(new_n434_), .b(x05), .O(z25));
  aoi21  g383(.a(new_n66_), .b(new_n79_), .c(x20), .O(z26));
  nand3  g384(.a(x06), .b(new_n57_), .c(x02), .O(new_n437_));
  nor4   g385(.a(new_n437_), .b(x15), .c(x11), .d(x08), .O(new_n438_));
  oai21  g386(.a(new_n438_), .b(new_n293_), .c(new_n66_), .O(new_n439_));
  nand4  g387(.a(x19), .b(new_n55_), .c(new_n73_), .d(x05), .O(new_n440_));
  aoi21  g388(.a(new_n440_), .b(new_n439_), .c(x07), .O(new_n441_));
  nand4  g389(.a(new_n149_), .b(x19), .c(x08), .d(x07), .O(new_n442_));
  inv1   g390(.a(new_n442_), .O(new_n443_));
  oai21  g391(.a(new_n443_), .b(new_n441_), .c(x18), .O(new_n444_));
  nand3  g392(.a(x15), .b(new_n54_), .c(x00), .O(new_n445_));
  oai21  g393(.a(x15), .b(new_n54_), .c(new_n445_), .O(new_n446_));
  nand4  g394(.a(new_n446_), .b(new_n52_), .c(x17), .d(new_n57_), .O(new_n447_));
  oai21  g395(.a(new_n444_), .b(x17), .c(new_n447_), .O(new_n448_));
  nand2  g396(.a(new_n448_), .b(new_n72_), .O(new_n449_));
  inv1   g397(.a(x03), .O(new_n450_));
  nor2   g398(.a(x05), .b(new_n450_), .O(new_n451_));
  nand4  g399(.a(new_n451_), .b(new_n276_), .c(new_n160_), .d(new_n99_), .O(new_n452_));
  nand2  g400(.a(new_n452_), .b(new_n449_), .O(z27));
  nand4  g401(.a(new_n66_), .b(x11), .c(new_n72_), .d(new_n54_), .O(new_n454_));
  aoi21  g402(.a(new_n454_), .b(new_n72_), .c(x02), .O(new_n455_));
  nand2  g403(.a(new_n249_), .b(x11), .O(new_n456_));
  oai21  g404(.a(new_n456_), .b(new_n455_), .c(x15), .O(new_n457_));
  nand3  g405(.a(x13), .b(new_n89_), .c(new_n78_), .O(new_n458_));
  nand4  g406(.a(new_n458_), .b(new_n66_), .c(new_n55_), .d(new_n79_), .O(new_n459_));
  nor2   g407(.a(new_n459_), .b(new_n63_), .O(new_n460_));
  nand4  g408(.a(new_n460_), .b(x10), .c(new_n72_), .d(new_n54_), .O(new_n461_));
  aoi21  g409(.a(new_n461_), .b(new_n457_), .c(x05), .O(new_n462_));
  nor2   g410(.a(new_n135_), .b(x15), .O(new_n463_));
  nand4  g411(.a(new_n463_), .b(x12), .c(x05), .d(new_n62_), .O(new_n464_));
  nand3  g412(.a(x21), .b(x15), .c(new_n72_), .O(new_n465_));
  aoi21  g413(.a(new_n465_), .b(new_n464_), .c(x07), .O(new_n466_));
  oai21  g414(.a(new_n466_), .b(new_n462_), .c(x08), .O(new_n467_));
  nand4  g415(.a(new_n202_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n468_));
  nand2  g416(.a(new_n116_), .b(x15), .O(new_n469_));
  aoi21  g417(.a(new_n469_), .b(new_n468_), .c(x09), .O(new_n470_));
  nand4  g418(.a(new_n470_), .b(new_n73_), .c(new_n54_), .d(new_n57_), .O(new_n471_));
  aoi21  g419(.a(new_n471_), .b(new_n467_), .c(new_n52_), .O(new_n472_));
  inv1   g420(.a(new_n110_), .O(new_n473_));
  nand3  g421(.a(new_n473_), .b(new_n52_), .c(x15), .O(new_n474_));
  nor4   g422(.a(new_n474_), .b(x09), .c(new_n54_), .d(x05), .O(new_n475_));
  oai21  g423(.a(new_n475_), .b(new_n472_), .c(new_n53_), .O(new_n476_));
  inv1   g424(.a(new_n117_), .O(new_n477_));
  nand3  g425(.a(new_n477_), .b(x15), .c(new_n57_), .O(new_n478_));
  oai21  g426(.a(x07), .b(new_n57_), .c(new_n478_), .O(new_n479_));
  nand4  g427(.a(new_n479_), .b(new_n52_), .c(x17), .d(new_n72_), .O(new_n480_));
