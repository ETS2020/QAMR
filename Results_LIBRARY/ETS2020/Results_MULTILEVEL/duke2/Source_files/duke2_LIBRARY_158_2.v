...
module FAU ( 
  ...
  nand2  g365(.a(new_n395_), .b(new_n73_), .O(new_n418_));
  nand2  g366(.a(new_n418_), .b(new_n407_), .O(new_n419_));
  ...
  oai21  g372(.a(new_n424_), .b(new_n293_), .c(new_n66_), .O(new_n425_));
  nand4  g373(.a(x19), .b(new_n55_), .c(new_n73_), .d(x05), .O(new_n426_));
  ...
  nand4  g385(.a(new_n437_), .b(new_n276_), .c(new_n160_), .d(new_n99_), .O(new_n438_));
  nand2  g386(.a(new_n438_), .b(new_n435_), .O(z27));
  nand4  g387(.a(new_n66_), .b(x11), .c(new_n72_), .d(new_n54_), .O(new_n440_));
  aoi21  g388(.a(new_n440_), .b(new_n72_), .c(x02), .O(new_n441_));
  nand2  g389(.a(new_n249_), .b(x11), .O(new_n442_));
  oai21  g390(.a(new_n442_), .b(new_n441_), .c(x15), .O(new_n443_));
  nand3  g391(.a(x13), .b(new_n89_), .c(new_n78_), .O(new_n444_));
  nand4  g392(.a(new_n444_), .b(new_n66_), .c(new_n55_), .d(new_n79_), .O(new_n445_));
  nor2   g393(.a(new_n445_), .b(new_n63_), .O(new_n446_));
  nand4  g394(.a(new_n446_), .b(x10), .c(new_n72_), .d(new_n54_), .O(new_n447_));
  aoi21  g395(.a(new_n447_), .b(new_n443_), .c(x05), .O(new_n448_));
  nor2   g396(.a(new_n135_), .b(x15), .O(new_n449_));
  nand4  g397(.a(new_n449_), .b(x12), .c(x05), .d(new_n62_), .O(new_n450_));
  nand3  g398(.a(x21), .b(x15), .c(new_n72_), .O(new_n451_));
  aoi21  g399(.a(new_n451_), .b(new_n450_), .c(x07), .O(new_n452_));
  oai21  g400(.a(new_n452_), .b(new_n448_), .c(x08), .O(new_n453_));
  nand4  g401(.a(new_n202_), .b(x21), .c(new_n55_), .d(new_n79_), .O(new_n454_));
  nand2  g402(.a(new_n116_), .b(x15), .O(new_n455_));
  aoi21  g403(.a(new_n455_), .b(new_n454_), .c(x09), .O(new_n456_));
  nand4  g404(.a(new_n456_), .b(new_n73_), .c(new_n54_), .d(new_n57_), .O(new_n457_));
  ...
  inv1   g410(.a(new_n334_), .O(new_n463_));
  ...
  nand4  g414(.a(new_n466_), .b(new_n52_), .c(x17), .d(new_n72_), .O(new_n467_));
