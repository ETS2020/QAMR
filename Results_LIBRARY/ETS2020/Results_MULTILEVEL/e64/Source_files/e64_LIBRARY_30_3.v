...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n912_, new_n913_, new_n914_, new_n915_, new_n917_;
  ...
  nor2   g777(.a(x11), .b(x10), .O(new_n908_));
  nand4  g778(.a(new_n908_), .b(new_n152_), .c(new_n155_), .d(new_n154_), .O(new_n909_));
  nor2   g779(.a(new_n909_), .b(x25), .O(new_n910_));
  nand4  g780(.a(new_n910_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n911_));
  nor2   g781(.a(new_n911_), .b(x37), .O(new_n912_));
