...
module FAU ( 
  ...
  nor3   g432(.a(x14), .b(x11), .c(x10), .O(new_n590_));
  nand4  g433(.a(new_n590_), .b(new_n193_), .c(new_n192_), .d(new_n135_), .O(new_n591_));
  nor2   g434(.a(new_n591_), .b(x28), .O(new_n592_));
  nand4  g435(.a(new_n592_), .b(new_n142_), .c(new_n181_), .d(x29), .O(new_n593_));
  nor2   g436(.a(new_n593_), .b(x39), .O(new_n594_));
  nand4  g437(.a(new_n594_), .b(new_n155_), .c(new_n141_), .d(new_n159_), .O(new_n595_));
  nor2   g438(.a(new_n595_), .b(new_n156_), .O(new_n596_));
  nand4  g439(.a(new_n596_), .b(new_n153_), .c(new_n152_), .d(new_n214_), .O(new_n597_));
  nor2   g440(.a(new_n597_), .b(x60), .O(z62));
  zero   g441(.O(z00));
  zero   g442(.O(z01));
  zero   g443(.O(z02));
  zero   g444(.O(z03));
