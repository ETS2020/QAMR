...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n558_, new_n559_, new_n560_, new_n562_, new_n564_, new_n567_,
  ...
  nor4   g445(.a(new_n397_), .b(x39), .c(x37), .d(x35), .O(new_n583_));
  ...
  nor3   g452(.a(new_n470_), .b(x20), .c(new_n224_), .O(new_n590_));
  ...
  nand4  g457(.a(new_n594_), .b(new_n146_), .c(new_n304_), .d(new_n145_), .O(new_n595_));
  nor2   g458(.a(new_n595_), .b(x34), .O(new_n596_));
  nand4  g459(.a(new_n596_), .b(new_n142_), .c(new_n303_), .d(new_n184_), .O(new_n597_));
  ...
  nand4  g524(.a(new_n384_), .b(new_n139_), .c(new_n138_), .d(x49), .O(new_n662_));
  ...
  nand2  g631(.a(new_n388_), .b(x57), .O(new_n769_));
  ...
  and2   g635(.a(new_n384_), .b(x48), .O(new_n773_));
  ...
  nand4  g656(.a(new_n793_), .b(new_n138_), .c(new_n218_), .d(new_n375_), .O(new_n794_));
  ...
  nor3   g664(.a(new_n391_), .b(x64), .c(new_n214_), .O(z53));
  ...
  nor3   g668(.a(new_n397_), .b(x37), .c(new_n184_), .O(new_n806_));
  ...
  nor4   g675(.a(new_n419_), .b(x18), .c(x17), .d(x16), .O(new_n813_));
  ...
  nand4  g682(.a(new_n819_), .b(new_n142_), .c(new_n303_), .d(new_n184_), .O(new_n820_));
  ...
  nand4  g696(.a(new_n343_), .b(new_n138_), .c(new_n141_), .d(x40), .O(new_n836_));
  nor2   g697(.a(new_n836_), .b(x58), .O(z59));
  nand4  g698(.a(new_n153_), .b(new_n189_), .c(new_n157_), .d(x07), .O(new_n838_));
  nor2   g699(.a(new_n838_), .b(x14), .O(new_n839_));
  ...
  nor2   g707(.a(new_n846_), .b(x60), .O(z60));
