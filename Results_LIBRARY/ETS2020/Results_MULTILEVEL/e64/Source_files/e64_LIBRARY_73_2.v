...
module FAU ( 
  ...
  nand4  g421(.a(new_n161_), .b(new_n160_), .c(new_n165_), .d(x08), .O(new_n579_));
  inv1   g422(.a(new_n579_), .O(new_n580_));
  nand4  g423(.a(new_n580_), .b(new_n268_), .c(new_n211_), .d(new_n135_), .O(new_n581_));
  nor2   g424(.a(new_n581_), .b(x28), .O(new_n582_));
  nand4  g425(.a(new_n582_), .b(new_n142_), .c(new_n183_), .d(x29), .O(new_n583_));
  nor2   g426(.a(new_n583_), .b(x39), .O(new_n584_));
  nand4  g427(.a(new_n584_), .b(new_n154_), .c(new_n141_), .d(new_n158_), .O(new_n585_));
  nor2   g428(.a(new_n585_), .b(x47), .O(new_n586_));
  nand4  g429(.a(new_n586_), .b(new_n152_), .c(new_n151_), .d(new_n204_), .O(new_n587_));
  nor2   g430(.a(new_n587_), .b(x60), .O(z61));
  zero   g431(.O(z00));
  zero   g432(.O(z01));
  zero   g433(.O(z02));
  zero   g434(.O(z03));
