...
module FAU ( 
  ...
  nand4  g757(.a(new_n154_), .b(new_n153_), .c(new_n189_), .d(x08), .O(new_n889_));
  inv1   g758(.a(new_n889_), .O(new_n890_));
  nand4  g759(.a(new_n890_), .b(new_n187_), .c(new_n152_), .d(new_n155_), .O(new_n891_));
  nor2   g760(.a(new_n891_), .b(x28), .O(new_n892_));
  nand4  g761(.a(new_n892_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n893_));
  nor2   g762(.a(new_n893_), .b(x39), .O(new_n894_));
  nand4  g763(.a(new_n894_), .b(new_n220_), .c(new_n141_), .d(new_n144_), .O(new_n895_));
  nor2   g764(.a(new_n895_), .b(x47), .O(new_n896_));
  nand4  g765(.a(new_n896_), .b(new_n216_), .c(new_n136_), .d(new_n138_), .O(new_n897_));
  nor2   g766(.a(new_n897_), .b(x60), .O(z61));
  nand4  g767(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n899_));
  nor2   g768(.a(new_n899_), .b(x24), .O(new_n900_));
  nand4  g769(.a(new_n900_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n901_));
  ...
  nand4  g775(.a(new_n904_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n907_));
  nor2   g776(.a(new_n907_), .b(x60), .O(z63));
  nor2   g777(.a(new_n901_), .b(new_n185_), .O(new_n909_));
  nand4  g778(.a(new_n909_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n910_));
  nor2   g779(.a(new_n910_), .b(x43), .O(new_n911_));
  nand4  g780(.a(new_n911_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n912_));
