...
module FAU ( 
  ...
  nand3  g534(.a(new_n664_), .b(new_n148_), .c(new_n187_), .O(new_n665_));
  nor2   g535(.a(new_n665_), .b(x28), .O(new_n666_));
  nand3  g536(.a(new_n666_), .b(new_n185_), .c(x29), .O(new_n667_));
  ...
  nand4  g548(.a(new_n403_), .b(new_n139_), .c(new_n138_), .d(x49), .O(new_n680_));
  ...
  nor4   g600(.a(new_n667_), .b(x37), .c(x35), .d(new_n147_), .O(new_n732_));
  ...
  nand4  g609(.a(new_n639_), .b(new_n153_), .c(new_n189_), .d(x09), .O(new_n741_));
  ...
  nand3  g625(.a(new_n641_), .b(new_n150_), .c(x17), .O(new_n757_));
  ...
  nor4   g639(.a(new_n667_), .b(x34), .c(x33), .d(new_n145_), .O(new_n771_));
  ...
  nor3   g650(.a(new_n673_), .b(new_n217_), .c(x51), .O(new_n782_));
  ...
  nand2  g655(.a(new_n407_), .b(x57), .O(new_n787_));
  ...
  and2   g659(.a(new_n403_), .b(x48), .O(new_n791_));
  ...
  nand4  g680(.a(new_n811_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n812_));
  ...
  nor3   g688(.a(new_n410_), .b(x64), .c(new_n214_), .O(z53));
  nor2   g689(.a(new_n614_), .b(new_n135_), .O(new_n821_));
  nand4  g690(.a(new_n821_), .b(new_n132_), .c(new_n216_), .d(new_n136_), .O(new_n822_));
  nor2   g691(.a(new_n822_), .b(x62), .O(z54));
  nor3   g692(.a(new_n416_), .b(x37), .c(new_n184_), .O(new_n824_));
  ...
  nor4   g699(.a(new_n438_), .b(x18), .c(x17), .d(x16), .O(new_n831_));
