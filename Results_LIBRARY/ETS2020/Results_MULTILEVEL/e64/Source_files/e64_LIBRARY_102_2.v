// Benchmark "FAU" written by ABC on Fri Jul 24 02:47:36 2020
...
module FAU ( 
  ...
  nand4  g423(.a(new_n162_), .b(new_n161_), .c(new_n166_), .d(x08), .O(new_n580_));
  inv1   g424(.a(new_n580_), .O(new_n581_));
  nand4  g425(.a(new_n581_), .b(new_n269_), .c(new_n212_), .d(new_n135_), .O(new_n582_));
  nor2   g426(.a(new_n582_), .b(x28), .O(new_n583_));
  nand4  g427(.a(new_n583_), .b(new_n142_), .c(new_n184_), .d(x29), .O(new_n584_));
  nor2   g428(.a(new_n584_), .b(x39), .O(new_n585_));
  nand4  g429(.a(new_n585_), .b(new_n155_), .c(new_n141_), .d(new_n159_), .O(new_n586_));
  nor2   g430(.a(new_n586_), .b(x47), .O(new_n587_));
  nand4  g431(.a(new_n587_), .b(new_n153_), .c(new_n152_), .d(new_n205_), .O(new_n588_));
  nor2   g432(.a(new_n588_), .b(x60), .O(z61));
  zero   g433(.O(z00));
  zero   g434(.O(z01));
  zero   g435(.O(z02));
  zero   g436(.O(z03));
