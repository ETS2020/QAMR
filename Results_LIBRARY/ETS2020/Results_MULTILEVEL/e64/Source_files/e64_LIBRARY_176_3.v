...
module FAU ( 
  ...
  nand4  g755(.a(new_n154_), .b(new_n153_), .c(new_n189_), .d(x08), .O(new_n888_));
  inv1   g756(.a(new_n888_), .O(new_n889_));
  nand4  g757(.a(new_n889_), .b(new_n187_), .c(new_n152_), .d(new_n155_), .O(new_n890_));
  nor2   g758(.a(new_n890_), .b(x28), .O(new_n891_));
  nand4  g759(.a(new_n891_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n892_));
  nor2   g760(.a(new_n892_), .b(x39), .O(new_n893_));
  nand4  g761(.a(new_n893_), .b(new_n220_), .c(new_n141_), .d(new_n144_), .O(new_n894_));
  nor2   g762(.a(new_n894_), .b(x47), .O(new_n895_));
  nand4  g763(.a(new_n895_), .b(new_n216_), .c(new_n136_), .d(new_n138_), .O(new_n896_));
  nor2   g764(.a(new_n896_), .b(x60), .O(z61));
  nand4  g765(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n898_));
  nor2   g766(.a(new_n898_), .b(x24), .O(new_n899_));
  nand4  g767(.a(new_n899_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n900_));
  nor3   g768(.a(new_n900_), .b(x37), .c(x30), .O(new_n901_));
  nand4  g769(.a(new_n901_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n902_));
  nor2   g770(.a(new_n902_), .b(x46), .O(new_n903_));
  nand4  g771(.a(new_n903_), .b(new_n136_), .c(new_n138_), .d(x47), .O(new_n904_));
  nor3   g772(.a(new_n904_), .b(x60), .c(x58), .O(z62));
  nand4  g773(.a(new_n903_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n906_));
  nor2   g774(.a(new_n906_), .b(x60), .O(z63));
  nor2   g775(.a(new_n900_), .b(new_n185_), .O(new_n908_));
  nand4  g776(.a(new_n908_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n909_));
  nor2   g777(.a(new_n909_), .b(x43), .O(new_n910_));
  nand4  g778(.a(new_n910_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n911_));
  nor2   g779(.a(new_n911_), .b(x60), .O(z64));
  zero   g780(.O(z10));
  zero   g781(.O(z60));
