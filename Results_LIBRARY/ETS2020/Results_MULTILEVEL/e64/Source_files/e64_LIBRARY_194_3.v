...
module FAU ( 
  ...
  nand4  g548(.a(new_n666_), .b(new_n184_), .c(new_n147_), .d(x33), .O(new_n679_));
  ...
  nor3   g649(.a(new_n673_), .b(new_n217_), .c(x51), .O(new_n781_));
  ...
  nand2  g654(.a(new_n407_), .b(x57), .O(new_n786_));
  ...
  and2   g658(.a(new_n403_), .b(x48), .O(new_n790_));
  ...
  nand4  g679(.a(new_n810_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n811_));
  ...
  nor3   g687(.a(new_n410_), .b(x64), .c(new_n214_), .O(z53));
  nor2   g688(.a(new_n614_), .b(new_n135_), .O(new_n820_));
  nand4  g689(.a(new_n820_), .b(new_n132_), .c(new_n216_), .d(new_n136_), .O(new_n821_));
  nor2   g690(.a(new_n821_), .b(x62), .O(z54));
  nor3   g691(.a(new_n416_), .b(x37), .c(new_n184_), .O(new_n823_));
  ...
  nor4   g698(.a(new_n438_), .b(x18), .c(x17), .d(x16), .O(new_n830_));
