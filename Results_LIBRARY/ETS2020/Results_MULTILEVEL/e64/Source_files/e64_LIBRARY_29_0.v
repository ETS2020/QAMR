// Benchmark "FAU" written by ABC on Fri Jul 24 02:46:56 2020
...
module FAU ( 
  ...
  nand4  g279(.a(new_n353_), .b(new_n149_), .c(new_n187_), .d(x24), .O(new_n416_));
  ...
  nand4  g293(.a(new_n429_), .b(new_n142_), .c(new_n303_), .d(new_n184_), .O(new_n430_));
  ...
  nand4  g316(.a(new_n452_), .b(new_n142_), .c(new_n303_), .d(new_n184_), .O(new_n453_));
  ...
  nor4   g330(.a(new_n354_), .b(new_n186_), .c(x28), .d(new_n187_), .O(new_n467_));
  ...
  nor4   g335(.a(new_n356_), .b(x43), .c(x40), .d(x39), .O(new_n472_));
  ...
  nand4  g340(.a(new_n355_), .b(new_n141_), .c(new_n144_), .d(x39), .O(new_n479_));
  ...
  nand4  g347(.a(new_n488_), .b(new_n146_), .c(new_n304_), .d(new_n145_), .O(new_n489_));
  nor2   g348(.a(new_n489_), .b(x34), .O(new_n490_));
  nand4  g349(.a(new_n490_), .b(new_n142_), .c(new_n303_), .d(new_n184_), .O(new_n491_));
  ...
  nand4  g463(.a(new_n355_), .b(new_n138_), .c(new_n141_), .d(x40), .O(new_n618_));
  ...
  nand4  g475(.a(new_n154_), .b(new_n153_), .c(new_n189_), .d(x08), .O(new_n630_));
  inv1   g476(.a(new_n630_), .O(new_n631_));
  nand4  g477(.a(new_n631_), .b(new_n187_), .c(new_n152_), .d(new_n155_), .O(new_n632_));
  nor2   g478(.a(new_n632_), .b(x28), .O(new_n633_));
  nand4  g479(.a(new_n633_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n634_));
  nor2   g480(.a(new_n634_), .b(x39), .O(new_n635_));
  nand4  g481(.a(new_n635_), .b(new_n220_), .c(new_n141_), .d(new_n144_), .O(new_n636_));
  nor2   g482(.a(new_n636_), .b(x47), .O(new_n637_));
  nand4  g483(.a(new_n637_), .b(new_n216_), .c(new_n136_), .d(new_n138_), .O(new_n638_));
  nor2   g484(.a(new_n638_), .b(x60), .O(z61));
  nand4  g485(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n640_));
  nor2   g486(.a(new_n640_), .b(x24), .O(new_n641_));
  nand4  g487(.a(new_n641_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n642_));
  nor3   g488(.a(new_n642_), .b(x37), .c(x30), .O(new_n643_));
  nand4  g489(.a(new_n643_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n644_));
  nor2   g490(.a(new_n644_), .b(x46), .O(new_n645_));
  nand4  g491(.a(new_n645_), .b(new_n136_), .c(new_n138_), .d(x47), .O(new_n646_));
  nor3   g492(.a(new_n646_), .b(x60), .c(x58), .O(z62));
  nand4  g493(.a(new_n645_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n648_));
  nor2   g494(.a(new_n648_), .b(x60), .O(z63));
  nor2   g495(.a(new_n642_), .b(new_n185_), .O(new_n650_));
  nand4  g496(.a(new_n650_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n651_));
  nor2   g497(.a(new_n651_), .b(x43), .O(new_n652_));
  nand4  g498(.a(new_n652_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n653_));
  nor2   g499(.a(new_n653_), .b(x60), .O(z64));
  zero   g500(.O(z05));
  zero   g501(.O(z15));
  zero   g502(.O(z19));
  zero   g503(.O(z20));
