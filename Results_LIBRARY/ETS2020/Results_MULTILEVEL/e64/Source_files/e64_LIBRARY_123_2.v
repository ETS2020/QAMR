...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n144_, new_n145_,
    ...
    new_n525_, new_n529_, new_n530_, new_n531_, new_n533_, new_n534_,
    ...
    new_n614_, new_n615_, new_n616_, new_n617_, new_n620_, new_n621_,
  ...
  inv1   g299(.a(new_n425_), .O(new_n448_));
  nor3   g300(.a(new_n448_), .b(x10), .c(x09), .O(new_n449_));
  nand4  g301(.a(new_n449_), .b(new_n135_), .c(new_n158_), .d(new_n176_), .O(new_n450_));
  nor2   g302(.a(new_n450_), .b(x17), .O(new_n451_));
  nand4  g303(.a(new_n451_), .b(new_n159_), .c(new_n244_), .d(new_n243_), .O(new_n452_));
  nor2   g304(.a(new_n452_), .b(x25), .O(new_n453_));
  nand4  g305(.a(new_n453_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n454_));
  nor2   g306(.a(new_n454_), .b(x30), .O(new_n455_));
  nand4  g307(.a(new_n455_), .b(new_n241_), .c(new_n300_), .d(x33), .O(new_n456_));
  nor2   g308(.a(new_n456_), .b(x37), .O(new_n457_));
  nand4  g309(.a(new_n457_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n458_));
  nor2   g310(.a(new_n458_), .b(x42), .O(new_n459_));
  nand4  g311(.a(new_n459_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n460_));
  nor2   g312(.a(new_n460_), .b(x50), .O(new_n461_));
  nand4  g313(.a(new_n461_), .b(new_n149_), .c(new_n235_), .d(new_n271_), .O(new_n462_));
  nor2   g314(.a(new_n462_), .b(x58), .O(new_n463_));
  nand4  g315(.a(new_n463_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n464_));
  nor2   g316(.a(new_n464_), .b(x62), .O(z41));
  nand4  g317(.a(new_n262_), .b(new_n271_), .c(new_n238_), .d(x49), .O(new_n466_));
  nor2   g318(.a(new_n466_), .b(x53), .O(new_n467_));
  nand4  g319(.a(new_n467_), .b(new_n149_), .c(new_n235_), .d(new_n234_), .O(new_n468_));
  nor2   g320(.a(new_n468_), .b(x58), .O(new_n469_));
  nand4  g321(.a(new_n469_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n470_));
  nor2   g322(.a(new_n470_), .b(x62), .O(z42));
  inv1   g323(.a(x00), .O(new_n472_));
  nand4  g324(.a(new_n160_), .b(new_n246_), .c(x01), .d(new_n472_), .O(new_n473_));
  nor3   g325(.a(new_n473_), .b(x05), .c(x04), .O(new_n474_));
  nand4  g326(.a(new_n474_), .b(new_n162_), .c(new_n161_), .d(new_n245_), .O(new_n475_));
  nor3   g327(.a(new_n475_), .b(x10), .c(x09), .O(new_n476_));
  nand4  g328(.a(new_n476_), .b(new_n135_), .c(new_n158_), .d(new_n176_), .O(new_n477_));
  nor2   g329(.a(new_n477_), .b(x17), .O(new_n478_));
  nand4  g330(.a(new_n478_), .b(new_n159_), .c(new_n244_), .d(new_n243_), .O(new_n479_));
  nor2   g331(.a(new_n479_), .b(x25), .O(new_n480_));
  nand4  g332(.a(new_n480_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n481_));
  nor2   g333(.a(new_n481_), .b(x30), .O(new_n482_));
  nand4  g334(.a(new_n482_), .b(new_n300_), .c(new_n326_), .d(new_n242_), .O(new_n483_));
  nor2   g335(.a(new_n483_), .b(x35), .O(new_n484_));
  nand4  g336(.a(new_n484_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n485_));
  nor2   g337(.a(new_n485_), .b(x41), .O(new_n486_));
  nand4  g338(.a(new_n486_), .b(new_n240_), .c(new_n152_), .d(new_n239_), .O(new_n487_));
  nor2   g339(.a(new_n487_), .b(x46), .O(new_n488_));
  nand4  g340(.a(new_n488_), .b(new_n271_), .c(new_n238_), .d(new_n154_), .O(new_n489_));
  nor2   g341(.a(new_n489_), .b(x53), .O(new_n490_));
  nand4  g342(.a(new_n490_), .b(new_n149_), .c(new_n235_), .d(new_n234_), .O(new_n491_));
  nor2   g343(.a(new_n491_), .b(x58), .O(new_n492_));
  nand4  g344(.a(new_n492_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n493_));
  nor2   g345(.a(new_n493_), .b(x62), .O(z43));
  nand4  g346(.a(new_n425_), .b(new_n176_), .c(new_n177_), .d(x09), .O(new_n497_));
  nor2   g347(.a(new_n497_), .b(x14), .O(new_n498_));
  nand4  g348(.a(new_n498_), .b(new_n243_), .c(new_n301_), .d(new_n135_), .O(new_n499_));
  nor2   g349(.a(new_n499_), .b(x22), .O(new_n500_));
  nand4  g350(.a(new_n500_), .b(new_n157_), .c(new_n204_), .d(new_n159_), .O(new_n501_));
  nor2   g351(.a(new_n501_), .b(x28), .O(new_n502_));
  nand4  g352(.a(new_n502_), .b(new_n241_), .c(new_n195_), .d(x29), .O(new_n503_));
  nor2   g353(.a(new_n503_), .b(x37), .O(new_n504_));
  nand4  g354(.a(new_n504_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n505_));
  nor2   g355(.a(new_n505_), .b(x42), .O(new_n506_));
  nand4  g356(.a(new_n506_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n507_));
  nor2   g357(.a(new_n507_), .b(x50), .O(new_n508_));
  nand4  g358(.a(new_n508_), .b(new_n149_), .c(new_n235_), .d(new_n271_), .O(new_n509_));
  nor2   g359(.a(new_n509_), .b(x58), .O(new_n510_));
  nand4  g360(.a(new_n510_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n511_));
  nor2   g361(.a(new_n511_), .b(x62), .O(z46));
  nand3  g362(.a(new_n427_), .b(new_n243_), .c(x17), .O(new_n513_));
  nor2   g363(.a(new_n513_), .b(x22), .O(new_n514_));
  nand4  g364(.a(new_n514_), .b(new_n157_), .c(new_n204_), .d(new_n159_), .O(new_n515_));
  nor2   g365(.a(new_n515_), .b(x28), .O(new_n516_));
  nand4  g366(.a(new_n516_), .b(new_n241_), .c(new_n195_), .d(x29), .O(new_n517_));
  nor2   g367(.a(new_n517_), .b(x37), .O(new_n518_));
  nand4  g368(.a(new_n518_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n519_));
  nor2   g369(.a(new_n519_), .b(x42), .O(new_n520_));
  nand4  g370(.a(new_n520_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n521_));
  nor2   g371(.a(new_n521_), .b(x50), .O(new_n522_));
  nand4  g372(.a(new_n522_), .b(new_n149_), .c(new_n235_), .d(new_n271_), .O(new_n523_));
  nor2   g373(.a(new_n523_), .b(x58), .O(new_n524_));
  nand4  g374(.a(new_n524_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n525_));
  nor2   g375(.a(new_n525_), .b(x62), .O(z47));
  nand2  g376(.a(new_n266_), .b(x57), .O(new_n529_));
  nor2   g377(.a(new_n529_), .b(x58), .O(new_n530_));
  nand4  g378(.a(new_n530_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n531_));
  nor2   g379(.a(new_n531_), .b(x62), .O(z50));
  and2   g380(.a(new_n262_), .b(x48), .O(new_n533_));
  nand4  g381(.a(new_n533_), .b(new_n271_), .c(new_n238_), .d(new_n237_), .O(new_n534_));
  nor2   g382(.a(new_n534_), .b(x53), .O(new_n535_));
  nand4  g383(.a(new_n535_), .b(new_n149_), .c(new_n235_), .d(new_n234_), .O(new_n536_));
  nor2   g384(.a(new_n536_), .b(x58), .O(new_n537_));
  nand4  g385(.a(new_n537_), .b(new_n230_), .c(new_n151_), .d(new_n232_), .O(new_n538_));
  nor2   g386(.a(new_n538_), .b(x62), .O(z51));
  nor2   g387(.a(new_n253_), .b(new_n302_), .O(new_n540_));
  nand4  g388(.a(new_n540_), .b(new_n301_), .c(new_n135_), .d(new_n158_), .O(new_n541_));
  nor2   g389(.a(new_n541_), .b(x18), .O(new_n542_));
  nand4  g390(.a(new_n542_), .b(new_n204_), .c(new_n159_), .d(new_n244_), .O(new_n543_));
  nor2   g391(.a(new_n543_), .b(x26), .O(new_n544_));
  nand4  g392(.a(new_n544_), .b(new_n195_), .c(x29), .d(new_n138_), .O(new_n545_));
  nor2   g393(.a(new_n545_), .b(x31), .O(new_n546_));
  nand4  g394(.a(new_n546_), .b(new_n241_), .c(new_n300_), .d(new_n326_), .O(new_n547_));
  nor2   g395(.a(new_n547_), .b(x37), .O(new_n548_));
  nand4  g396(.a(new_n548_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n549_));
  nor2   g397(.a(new_n549_), .b(x42), .O(new_n550_));
  nand4  g398(.a(new_n550_), .b(new_n153_), .c(new_n240_), .d(new_n152_), .O(new_n551_));
  nor2   g399(.a(new_n551_), .b(x47), .O(new_n552_));
  nand4  g400(.a(new_n552_), .b(new_n238_), .c(new_n237_), .d(new_n236_), .O(new_n553_));
  nor2   g401(.a(new_n553_), .b(x51), .O(new_n554_));
  nand4  g402(.a(new_n554_), .b(new_n235_), .c(new_n234_), .d(new_n233_), .O(new_n555_));
  nor2   g403(.a(new_n555_), .b(x56), .O(new_n556_));
  nand4  g404(.a(new_n556_), .b(new_n232_), .c(new_n150_), .d(new_n231_), .O(new_n557_));
  nor2   g405(.a(new_n557_), .b(x60), .O(new_n558_));
  nand4  g406(.a(new_n558_), .b(new_n299_), .c(new_n217_), .d(new_n230_), .O(new_n559_));
  nor2   g407(.a(new_n559_), .b(x64), .O(z52));
  nor3   g408(.a(new_n269_), .b(x64), .c(new_n299_), .O(z53));
  nor2   g409(.a(new_n419_), .b(new_n235_), .O(new_n562_));
  nand4  g410(.a(new_n562_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n563_));
  nor2   g411(.a(new_n563_), .b(x62), .O(z54));
  nor3   g412(.a(new_n277_), .b(x37), .c(new_n241_), .O(new_n565_));
  nand4  g413(.a(new_n565_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n566_));
  nor2   g414(.a(new_n566_), .b(x43), .O(new_n567_));
  nand4  g415(.a(new_n567_), .b(new_n238_), .c(new_n154_), .d(new_n153_), .O(new_n568_));
  nor2   g416(.a(new_n568_), .b(x51), .O(new_n569_));
  nand4  g417(.a(new_n569_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n570_));
  nor2   g418(.a(new_n570_), .b(x62), .O(z55));
  inv1   g419(.a(x16), .O(new_n572_));
  nand4  g420(.a(new_n304_), .b(new_n301_), .c(new_n572_), .d(new_n135_), .O(new_n573_));
  nor2   g421(.a(new_n573_), .b(x18), .O(new_n574_));
  nand4  g422(.a(new_n574_), .b(new_n244_), .c(new_n327_), .d(x20), .O(new_n575_));
  nor2   g423(.a(new_n575_), .b(x24), .O(new_n576_));
  nand4  g424(.a(new_n576_), .b(new_n138_), .c(new_n157_), .d(new_n204_), .O(new_n577_));
  nor2   g425(.a(new_n577_), .b(new_n136_), .O(new_n578_));
  nand4  g426(.a(new_n578_), .b(new_n326_), .c(new_n242_), .d(new_n195_), .O(new_n579_));
  nor2   g427(.a(new_n579_), .b(x34), .O(new_n580_));
  nand4  g428(.a(new_n580_), .b(new_n144_), .c(new_n325_), .d(new_n241_), .O(new_n581_));
  nor2   g429(.a(new_n581_), .b(x39), .O(new_n582_));
  nand4  g430(.a(new_n582_), .b(new_n239_), .c(new_n175_), .d(new_n156_), .O(new_n583_));
  nor2   g431(.a(new_n583_), .b(x43), .O(new_n584_));
  nand4  g432(.a(new_n584_), .b(new_n154_), .c(new_n153_), .d(new_n240_), .O(new_n585_));
  nor2   g433(.a(new_n585_), .b(x48), .O(new_n586_));
  nand4  g434(.a(new_n586_), .b(new_n271_), .c(new_n238_), .d(new_n237_), .O(new_n587_));
  nor2   g435(.a(new_n587_), .b(x52), .O(new_n588_));
  nand4  g436(.a(new_n588_), .b(new_n235_), .c(new_n234_), .d(new_n233_), .O(new_n589_));
  nor2   g437(.a(new_n589_), .b(x56), .O(new_n590_));
  nand4  g438(.a(new_n590_), .b(new_n232_), .c(new_n150_), .d(new_n231_), .O(new_n591_));
  nor2   g439(.a(new_n591_), .b(x60), .O(new_n592_));
  nand4  g440(.a(new_n592_), .b(new_n299_), .c(new_n217_), .d(new_n230_), .O(new_n593_));
  nor2   g441(.a(new_n593_), .b(x64), .O(z56));
  nand4  g442(.a(new_n162_), .b(new_n161_), .c(new_n245_), .d(new_n160_), .O(new_n595_));
  inv1   g443(.a(new_n595_), .O(new_n596_));
  nand4  g444(.a(new_n596_), .b(new_n158_), .c(new_n176_), .d(new_n177_), .O(new_n597_));
  nor2   g445(.a(new_n597_), .b(x15), .O(new_n598_));
  nand4  g446(.a(new_n598_), .b(new_n159_), .c(new_n244_), .d(x18), .O(new_n599_));
  ...
  nand4  g450(.a(new_n602_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n603_));
  nor2   g451(.a(new_n603_), .b(x41), .O(new_n604_));
  nand4  g452(.a(new_n604_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n605_));
  nor2   g453(.a(new_n605_), .b(x50), .O(new_n606_));
  nand4  g454(.a(new_n606_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n607_));
  nor2   g455(.a(new_n607_), .b(x62), .O(z57));
  nand3  g456(.a(new_n598_), .b(new_n159_), .c(x22), .O(new_n609_));
  nor2   g457(.a(new_n609_), .b(x25), .O(new_n610_));
  nand4  g458(.a(new_n610_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n611_));
  nor2   g459(.a(new_n611_), .b(x30), .O(new_n612_));
  nand4  g460(.a(new_n612_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n613_));
  nor2   g461(.a(new_n613_), .b(x41), .O(new_n614_));
  nand4  g462(.a(new_n614_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n615_));
  nor2   g463(.a(new_n615_), .b(x50), .O(new_n616_));
  nand4  g464(.a(new_n616_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n617_));
  nor2   g465(.a(new_n617_), .b(x62), .O(z58));
  nand4  g466(.a(new_n176_), .b(new_n177_), .c(new_n162_), .d(x07), .O(new_n620_));
  nor2   g467(.a(new_n620_), .b(x14), .O(new_n621_));
  nand4  g468(.a(new_n621_), .b(new_n204_), .c(new_n159_), .d(new_n135_), .O(new_n622_));
  nor2   g469(.a(new_n622_), .b(x28), .O(new_n623_));
  nand4  g470(.a(new_n623_), .b(new_n144_), .c(new_n195_), .d(x29), .O(new_n624_));
  nor2   g471(.a(new_n624_), .b(x39), .O(new_n625_));
  nand4  g472(.a(new_n625_), .b(new_n153_), .c(new_n152_), .d(new_n156_), .O(new_n626_));
  nor2   g473(.a(new_n626_), .b(x47), .O(new_n627_));
  nand4  g474(.a(new_n627_), .b(new_n150_), .c(new_n149_), .d(new_n238_), .O(new_n628_));
  nor2   g475(.a(new_n628_), .b(x60), .O(z60));
  nand4  g476(.a(new_n158_), .b(new_n176_), .c(new_n177_), .d(x08), .O(new_n630_));
  inv1   g477(.a(new_n630_), .O(new_n631_));
  nand4  g478(.a(new_n631_), .b(new_n204_), .c(new_n159_), .d(new_n135_), .O(new_n632_));
  nor2   g479(.a(new_n632_), .b(x28), .O(new_n633_));
  nand4  g480(.a(new_n633_), .b(new_n144_), .c(new_n195_), .d(x29), .O(new_n634_));
  nor2   g481(.a(new_n634_), .b(x39), .O(new_n635_));
  nand4  g482(.a(new_n635_), .b(new_n153_), .c(new_n152_), .d(new_n156_), .O(new_n636_));
  nor2   g483(.a(new_n636_), .b(x47), .O(new_n637_));
  nand4  g484(.a(new_n637_), .b(new_n150_), .c(new_n149_), .d(new_n238_), .O(new_n638_));
  nor2   g485(.a(new_n638_), .b(x60), .O(z61));
  zero   g486(.O(z00));
  zero   g487(.O(z01));
  zero   g488(.O(z02));
  zero   g489(.O(z03));
