...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n611_, new_n612_, new_n613_, new_n616_, new_n617_, new_n618_,
  ...
  nand4  g274(.a(new_n414_), .b(new_n142_), .c(new_n302_), .d(new_n184_), .O(new_n415_));
  ...
  nand4  g297(.a(new_n437_), .b(new_n142_), .c(new_n302_), .d(new_n184_), .O(new_n438_));
  ...
  nand4  g328(.a(new_n473_), .b(new_n146_), .c(new_n303_), .d(new_n145_), .O(new_n474_));
  nor2   g329(.a(new_n474_), .b(x34), .O(new_n475_));
  nand4  g330(.a(new_n475_), .b(new_n142_), .c(new_n302_), .d(new_n184_), .O(new_n476_));
  ...
  nand4  g456(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n616_));
  nor2   g457(.a(new_n616_), .b(x24), .O(new_n617_));
  nand4  g458(.a(new_n617_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n618_));
  nor3   g459(.a(new_n618_), .b(x37), .c(x30), .O(new_n619_));
  nand4  g460(.a(new_n619_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n620_));
  nor2   g461(.a(new_n620_), .b(x46), .O(new_n621_));
  nand4  g462(.a(new_n621_), .b(new_n136_), .c(new_n138_), .d(x47), .O(new_n622_));
  nor3   g463(.a(new_n622_), .b(x60), .c(x58), .O(z62));
  nand4  g464(.a(new_n621_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n624_));
  nor2   g465(.a(new_n624_), .b(x60), .O(z63));
  nor2   g466(.a(new_n618_), .b(new_n185_), .O(new_n626_));
  nand4  g467(.a(new_n626_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n627_));
  nor2   g468(.a(new_n627_), .b(x43), .O(new_n628_));
  nand4  g469(.a(new_n628_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n629_));
  nor2   g470(.a(new_n629_), .b(x60), .O(z64));
  zero   g471(.O(z04));
  zero   g472(.O(z05));
  zero   g473(.O(z06));
  zero   g474(.O(z11));
