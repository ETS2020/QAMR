...
module FAU ( 
  ...
  nand4  g455(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n613_));
  nor2   g456(.a(new_n613_), .b(x24), .O(new_n614_));
  nand4  g457(.a(new_n614_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n615_));
  nor3   g458(.a(new_n615_), .b(x37), .c(x30), .O(new_n616_));
  nand4  g459(.a(new_n616_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n617_));
  nor2   g460(.a(new_n617_), .b(x46), .O(new_n618_));
  nand4  g461(.a(new_n618_), .b(new_n136_), .c(new_n138_), .d(x47), .O(new_n619_));
  nor3   g462(.a(new_n619_), .b(x60), .c(x58), .O(z62));
  nand4  g463(.a(new_n618_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n621_));
  nor2   g464(.a(new_n621_), .b(x60), .O(z63));
  nor2   g465(.a(new_n615_), .b(new_n185_), .O(new_n623_));
  nand4  g466(.a(new_n623_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n624_));
  nor2   g467(.a(new_n624_), .b(x43), .O(new_n625_));
  nand4  g468(.a(new_n625_), .b(new_n216_), .c(new_n138_), .d(new_n220_), .O(new_n626_));
  nor2   g469(.a(new_n626_), .b(x60), .O(z64));
  zero   g470(.O(z05));
  zero   g471(.O(z06));
  zero   g472(.O(z19));
  zero   g473(.O(z20));
