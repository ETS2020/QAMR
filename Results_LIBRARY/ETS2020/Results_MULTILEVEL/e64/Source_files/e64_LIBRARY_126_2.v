// Benchmark "FAU" written by ABC on Fri Jul 24 02:47:49 2020
...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n144_, new_n145_,
    ...
    new_n519_, new_n520_, new_n521_, new_n525_, new_n526_, new_n527_,
  ...
  nand4  g072(.a(new_n211_), .b(new_n155_), .c(new_n144_), .d(new_n195_), .O(new_n212_));
  nor2   g073(.a(new_n212_), .b(x40), .O(new_n213_));
  nand4  g074(.a(new_n213_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n214_));
  nor2   g075(.a(new_n214_), .b(x50), .O(new_n215_));
  nand4  g076(.a(new_n215_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n216_));
  ...
  nand4  g108(.a(new_n247_), .b(new_n155_), .c(new_n144_), .d(new_n230_), .O(new_n248_));
  nor3   g109(.a(new_n248_), .b(x41), .c(x40), .O(new_n249_));
  nand4  g110(.a(new_n249_), .b(new_n229_), .c(new_n152_), .d(new_n228_), .O(new_n250_));
  ...
  nand4  g116(.a(new_n255_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n256_));
  ...
  nand4  g132(.a(new_n271_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n272_));
  ...
  nand4  g142(.a(new_n281_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n282_));
  nor2   g143(.a(new_n282_), .b(x41), .O(new_n283_));
  nand4  g144(.a(new_n283_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n284_));
  nor2   g145(.a(new_n284_), .b(x50), .O(new_n285_));
  nand4  g146(.a(new_n285_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n286_));
  ...
  nand4  g164(.a(new_n303_), .b(new_n153_), .c(new_n229_), .d(new_n152_), .O(new_n304_));
  ...
  nand4  g170(.a(new_n309_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n310_));
  ...
  nand4  g195(.a(new_n334_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n335_));
  ...
  nand4  g205(.a(new_n350_), .b(new_n144_), .c(new_n314_), .d(new_n230_), .O(new_n351_));
  ...
  nand4  g215(.a(new_n360_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n361_));
  ...
  nand4  g228(.a(new_n373_), .b(new_n153_), .c(new_n229_), .d(new_n152_), .O(new_n374_));
  ...
  nand4  g234(.a(new_n379_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n380_));
  ...
  nand4  g239(.a(new_n386_), .b(new_n152_), .c(new_n144_), .d(x29), .O(new_n387_));
  nor2   g240(.a(new_n387_), .b(new_n150_), .O(z34));
  ...
  nand4  g249(.a(new_n396_), .b(new_n155_), .c(new_n144_), .d(new_n230_), .O(new_n397_));
  nor2   g250(.a(new_n397_), .b(x40), .O(new_n398_));
  nand4  g251(.a(new_n398_), .b(new_n153_), .c(new_n152_), .d(new_n175_), .O(new_n399_));
  ...
  nand4  g255(.a(new_n402_), .b(new_n219_), .c(new_n151_), .d(new_n150_), .O(new_n403_));
  nor2   g256(.a(new_n403_), .b(x62), .O(z35));
  nor4   g257(.a(new_n266_), .b(x39), .c(x37), .d(x35), .O(new_n405_));
  nand4  g258(.a(new_n405_), .b(new_n152_), .c(new_n175_), .d(new_n156_), .O(new_n406_));
  ...
  nand4  g262(.a(new_n409_), .b(x61), .c(new_n151_), .d(new_n150_), .O(new_n410_));
  ...
  nand4  g272(.a(new_n420_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n421_));
  nor3   g273(.a(new_n421_), .b(x42), .c(x41), .O(new_n422_));
  nand4  g274(.a(new_n422_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n423_));
  nor2   g275(.a(new_n423_), .b(x50), .O(new_n424_));
  nand4  g276(.a(new_n424_), .b(new_n149_), .c(new_n224_), .d(new_n260_), .O(new_n425_));
  nor2   g277(.a(new_n425_), .b(x58), .O(new_n426_));
  nand4  g278(.a(new_n426_), .b(new_n219_), .c(new_n151_), .d(x59), .O(new_n427_));
  nor2   g279(.a(new_n427_), .b(x62), .O(z38));
  nor2   g280(.a(new_n421_), .b(x41), .O(new_n429_));
  nand4  g281(.a(new_n429_), .b(new_n153_), .c(new_n152_), .d(x42), .O(new_n430_));
  ...
  nand4  g285(.a(new_n433_), .b(new_n219_), .c(new_n151_), .d(new_n150_), .O(new_n434_));
  ...
  nand4  g289(.a(new_n439_), .b(new_n149_), .c(new_n224_), .d(new_n223_), .O(new_n440_));
  nor2   g290(.a(new_n440_), .b(x58), .O(new_n441_));
  nand4  g291(.a(new_n441_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n442_));
  nor2   g292(.a(new_n442_), .b(x62), .O(z42));
  inv1   g293(.a(x09), .O(new_n444_));
  inv1   g294(.a(x00), .O(new_n445_));
  nand4  g295(.a(new_n160_), .b(new_n235_), .c(x01), .d(new_n445_), .O(new_n446_));
  nor3   g296(.a(new_n446_), .b(x05), .c(x04), .O(new_n447_));
  nand2  g297(.a(new_n447_), .b(new_n234_), .O(new_n448_));
  inv1   g298(.a(new_n448_), .O(new_n449_));
  nand4  g299(.a(new_n449_), .b(new_n444_), .c(new_n162_), .d(new_n161_), .O(new_n450_));
  nor2   g300(.a(new_n450_), .b(x10), .O(new_n451_));
  nand4  g301(.a(new_n451_), .b(new_n135_), .c(new_n158_), .d(new_n176_), .O(new_n452_));
  nor2   g302(.a(new_n452_), .b(x17), .O(new_n453_));
  nand4  g303(.a(new_n453_), .b(new_n159_), .c(new_n233_), .d(new_n232_), .O(new_n454_));
  nor2   g304(.a(new_n454_), .b(x25), .O(new_n455_));
  nand4  g305(.a(new_n455_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n456_));
  nor2   g306(.a(new_n456_), .b(x30), .O(new_n457_));
  nand4  g307(.a(new_n457_), .b(new_n289_), .c(new_n315_), .d(new_n231_), .O(new_n458_));
  nor2   g308(.a(new_n458_), .b(x35), .O(new_n459_));
  nand4  g309(.a(new_n459_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n460_));
  nor2   g310(.a(new_n460_), .b(x41), .O(new_n461_));
  nand4  g311(.a(new_n461_), .b(new_n229_), .c(new_n152_), .d(new_n228_), .O(new_n462_));
  nor2   g312(.a(new_n462_), .b(x46), .O(new_n463_));
  nand4  g313(.a(new_n463_), .b(new_n260_), .c(new_n227_), .d(new_n154_), .O(new_n464_));
  nor2   g314(.a(new_n464_), .b(x53), .O(new_n465_));
  nand4  g315(.a(new_n465_), .b(new_n149_), .c(new_n224_), .d(new_n223_), .O(new_n466_));
  nor2   g316(.a(new_n466_), .b(x58), .O(new_n467_));
  nand4  g317(.a(new_n467_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n468_));
  nor2   g318(.a(new_n468_), .b(x62), .O(z43));
  nand4  g319(.a(new_n236_), .b(new_n160_), .c(x02), .d(new_n445_), .O(new_n470_));
  nor3   g320(.a(new_n470_), .b(x06), .c(x05), .O(new_n471_));
  nand4  g321(.a(new_n471_), .b(new_n444_), .c(new_n162_), .d(new_n161_), .O(new_n472_));
  nor2   g322(.a(new_n472_), .b(x10), .O(new_n473_));
  nand4  g323(.a(new_n473_), .b(new_n135_), .c(new_n158_), .d(new_n176_), .O(new_n474_));
  nor2   g324(.a(new_n474_), .b(x17), .O(new_n475_));
  nand4  g325(.a(new_n475_), .b(new_n159_), .c(new_n233_), .d(new_n232_), .O(new_n476_));
  nor2   g326(.a(new_n476_), .b(x25), .O(new_n477_));
  nand4  g327(.a(new_n477_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n478_));
  nor2   g328(.a(new_n478_), .b(x30), .O(new_n479_));
  nand4  g329(.a(new_n479_), .b(new_n289_), .c(new_n315_), .d(new_n231_), .O(new_n480_));
  nor2   g330(.a(new_n480_), .b(x35), .O(new_n481_));
  nand4  g331(.a(new_n481_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n482_));
  nor2   g332(.a(new_n482_), .b(x41), .O(new_n483_));
  nand4  g333(.a(new_n483_), .b(new_n229_), .c(new_n152_), .d(new_n228_), .O(new_n484_));
  nor2   g334(.a(new_n484_), .b(x46), .O(new_n485_));
  nand4  g335(.a(new_n485_), .b(new_n260_), .c(new_n227_), .d(new_n154_), .O(new_n486_));
  nor2   g336(.a(new_n486_), .b(x53), .O(new_n487_));
  nand4  g337(.a(new_n487_), .b(new_n149_), .c(new_n224_), .d(new_n223_), .O(new_n488_));
  nor2   g338(.a(new_n488_), .b(x58), .O(new_n489_));
  nand4  g339(.a(new_n489_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n490_));
  nor2   g340(.a(new_n490_), .b(x62), .O(z44));
  nand4  g341(.a(new_n414_), .b(new_n176_), .c(new_n177_), .d(x09), .O(new_n493_));
  nor2   g342(.a(new_n493_), .b(x14), .O(new_n494_));
  nand4  g343(.a(new_n494_), .b(new_n232_), .c(new_n290_), .d(new_n135_), .O(new_n495_));
  nor2   g344(.a(new_n495_), .b(x22), .O(new_n496_));
  nand4  g345(.a(new_n496_), .b(new_n157_), .c(new_n206_), .d(new_n159_), .O(new_n497_));
  nor2   g346(.a(new_n497_), .b(x28), .O(new_n498_));
  nand4  g347(.a(new_n498_), .b(new_n230_), .c(new_n195_), .d(x29), .O(new_n499_));
  nor2   g348(.a(new_n499_), .b(x37), .O(new_n500_));
  nand4  g349(.a(new_n500_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n501_));
  nor2   g350(.a(new_n501_), .b(x42), .O(new_n502_));
  nand4  g351(.a(new_n502_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n503_));
  nor2   g352(.a(new_n503_), .b(x50), .O(new_n504_));
  nand4  g353(.a(new_n504_), .b(new_n149_), .c(new_n224_), .d(new_n260_), .O(new_n505_));
  nor2   g354(.a(new_n505_), .b(x58), .O(new_n506_));
  nand4  g355(.a(new_n506_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n507_));
  nor2   g356(.a(new_n507_), .b(x62), .O(z46));
  nand3  g357(.a(new_n416_), .b(new_n232_), .c(x17), .O(new_n509_));
  nor2   g358(.a(new_n509_), .b(x22), .O(new_n510_));
  nand4  g359(.a(new_n510_), .b(new_n157_), .c(new_n206_), .d(new_n159_), .O(new_n511_));
  nor2   g360(.a(new_n511_), .b(x28), .O(new_n512_));
  nand4  g361(.a(new_n512_), .b(new_n230_), .c(new_n195_), .d(x29), .O(new_n513_));
  nor2   g362(.a(new_n513_), .b(x37), .O(new_n514_));
  nand4  g363(.a(new_n514_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n515_));
  nor2   g364(.a(new_n515_), .b(x42), .O(new_n516_));
  nand4  g365(.a(new_n516_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n517_));
  nor2   g366(.a(new_n517_), .b(x50), .O(new_n518_));
  nand4  g367(.a(new_n518_), .b(new_n149_), .c(new_n224_), .d(new_n260_), .O(new_n519_));
  nor2   g368(.a(new_n519_), .b(x58), .O(new_n520_));
  nand4  g369(.a(new_n520_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n521_));
  nor2   g370(.a(new_n521_), .b(x62), .O(z47));
  nand2  g371(.a(new_n255_), .b(x57), .O(new_n525_));
  nor2   g372(.a(new_n525_), .b(x58), .O(new_n526_));
  nand4  g373(.a(new_n526_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n527_));
  nor2   g374(.a(new_n527_), .b(x62), .O(z50));
  and2   g375(.a(new_n251_), .b(x48), .O(new_n529_));
  nand4  g376(.a(new_n529_), .b(new_n260_), .c(new_n227_), .d(new_n226_), .O(new_n530_));
  nor2   g377(.a(new_n530_), .b(x53), .O(new_n531_));
  nand4  g378(.a(new_n531_), .b(new_n149_), .c(new_n224_), .d(new_n223_), .O(new_n532_));
  nor2   g379(.a(new_n532_), .b(x58), .O(new_n533_));
  nand4  g380(.a(new_n533_), .b(new_n219_), .c(new_n151_), .d(new_n221_), .O(new_n534_));
  nor2   g381(.a(new_n534_), .b(x62), .O(z51));
  nor2   g382(.a(new_n242_), .b(new_n291_), .O(new_n536_));
  nand4  g383(.a(new_n536_), .b(new_n290_), .c(new_n135_), .d(new_n158_), .O(new_n537_));
  nor2   g384(.a(new_n537_), .b(x18), .O(new_n538_));
  nand4  g385(.a(new_n538_), .b(new_n206_), .c(new_n159_), .d(new_n233_), .O(new_n539_));
  nor2   g386(.a(new_n539_), .b(x26), .O(new_n540_));
  nand4  g387(.a(new_n540_), .b(new_n195_), .c(x29), .d(new_n138_), .O(new_n541_));
  nor2   g388(.a(new_n541_), .b(x31), .O(new_n542_));
  nand4  g389(.a(new_n542_), .b(new_n230_), .c(new_n289_), .d(new_n315_), .O(new_n543_));
  nor2   g390(.a(new_n543_), .b(x37), .O(new_n544_));
  nand4  g391(.a(new_n544_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n545_));
  nor2   g392(.a(new_n545_), .b(x42), .O(new_n546_));
  nand4  g393(.a(new_n546_), .b(new_n153_), .c(new_n229_), .d(new_n152_), .O(new_n547_));
  nor2   g394(.a(new_n547_), .b(x47), .O(new_n548_));
  nand4  g395(.a(new_n548_), .b(new_n227_), .c(new_n226_), .d(new_n225_), .O(new_n549_));
  nor2   g396(.a(new_n549_), .b(x51), .O(new_n550_));
  nand4  g397(.a(new_n550_), .b(new_n224_), .c(new_n223_), .d(new_n222_), .O(new_n551_));
  nor2   g398(.a(new_n551_), .b(x56), .O(new_n552_));
  nand4  g399(.a(new_n552_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n553_));
  nor2   g400(.a(new_n553_), .b(x60), .O(new_n554_));
  nand4  g401(.a(new_n554_), .b(new_n288_), .c(new_n205_), .d(new_n219_), .O(new_n555_));
  nor2   g402(.a(new_n555_), .b(x64), .O(z52));
  nor3   g403(.a(new_n258_), .b(x64), .c(new_n288_), .O(z53));
  nor2   g404(.a(new_n408_), .b(new_n224_), .O(new_n558_));
  nand4  g405(.a(new_n558_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n559_));
  nor2   g406(.a(new_n559_), .b(x62), .O(z54));
  nor3   g407(.a(new_n266_), .b(x37), .c(new_n230_), .O(new_n561_));
  nand4  g408(.a(new_n561_), .b(new_n175_), .c(new_n156_), .d(new_n155_), .O(new_n562_));
  nor2   g409(.a(new_n562_), .b(x43), .O(new_n563_));
  nand4  g410(.a(new_n563_), .b(new_n227_), .c(new_n154_), .d(new_n153_), .O(new_n564_));
  nor2   g411(.a(new_n564_), .b(x51), .O(new_n565_));
  nand4  g412(.a(new_n565_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n566_));
  nor2   g413(.a(new_n566_), .b(x62), .O(z55));
  inv1   g414(.a(x16), .O(new_n568_));
  nand4  g415(.a(new_n293_), .b(new_n290_), .c(new_n568_), .d(new_n135_), .O(new_n569_));
  nor2   g416(.a(new_n569_), .b(x18), .O(new_n570_));
  nand4  g417(.a(new_n570_), .b(new_n233_), .c(new_n316_), .d(x20), .O(new_n571_));
  nor2   g418(.a(new_n571_), .b(x24), .O(new_n572_));
  nand4  g419(.a(new_n572_), .b(new_n138_), .c(new_n157_), .d(new_n206_), .O(new_n573_));
  nor2   g420(.a(new_n573_), .b(new_n136_), .O(new_n574_));
  nand4  g421(.a(new_n574_), .b(new_n315_), .c(new_n231_), .d(new_n195_), .O(new_n575_));
  nor2   g422(.a(new_n575_), .b(x34), .O(new_n576_));
  nand4  g423(.a(new_n576_), .b(new_n144_), .c(new_n314_), .d(new_n230_), .O(new_n577_));
  nor2   g424(.a(new_n577_), .b(x39), .O(new_n578_));
  nand4  g425(.a(new_n578_), .b(new_n228_), .c(new_n175_), .d(new_n156_), .O(new_n579_));
  nor2   g426(.a(new_n579_), .b(x43), .O(new_n580_));
  nand4  g427(.a(new_n580_), .b(new_n154_), .c(new_n153_), .d(new_n229_), .O(new_n581_));
  nor2   g428(.a(new_n581_), .b(x48), .O(new_n582_));
  nand4  g429(.a(new_n582_), .b(new_n260_), .c(new_n227_), .d(new_n226_), .O(new_n583_));
  nor2   g430(.a(new_n583_), .b(x52), .O(new_n584_));
  nand4  g431(.a(new_n584_), .b(new_n224_), .c(new_n223_), .d(new_n222_), .O(new_n585_));
  nor2   g432(.a(new_n585_), .b(x56), .O(new_n586_));
  nand4  g433(.a(new_n586_), .b(new_n221_), .c(new_n150_), .d(new_n220_), .O(new_n587_));
  nor2   g434(.a(new_n587_), .b(x60), .O(new_n588_));
  nand4  g435(.a(new_n588_), .b(new_n288_), .c(new_n205_), .d(new_n219_), .O(new_n589_));
  nor2   g436(.a(new_n589_), .b(x64), .O(z56));
  nand4  g437(.a(new_n162_), .b(new_n161_), .c(new_n234_), .d(new_n160_), .O(new_n591_));
  inv1   g438(.a(new_n591_), .O(new_n592_));
  nand4  g439(.a(new_n592_), .b(new_n158_), .c(new_n176_), .d(new_n177_), .O(new_n593_));
  nor2   g440(.a(new_n593_), .b(x15), .O(new_n594_));
  nand4  g441(.a(new_n594_), .b(new_n159_), .c(new_n233_), .d(x18), .O(new_n595_));
  nor2   g442(.a(new_n595_), .b(x25), .O(new_n596_));
  nand4  g443(.a(new_n596_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n597_));
  nor2   g444(.a(new_n597_), .b(x30), .O(new_n598_));
  nand4  g445(.a(new_n598_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n599_));
  nor2   g446(.a(new_n599_), .b(x41), .O(new_n600_));
  nand4  g447(.a(new_n600_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n601_));
  nor2   g448(.a(new_n601_), .b(x50), .O(new_n602_));
  nand4  g449(.a(new_n602_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n603_));
  nor2   g450(.a(new_n603_), .b(x62), .O(z57));
  nand3  g451(.a(new_n594_), .b(new_n159_), .c(x22), .O(new_n605_));
  nor2   g452(.a(new_n605_), .b(x25), .O(new_n606_));
  nand4  g453(.a(new_n606_), .b(x29), .c(new_n138_), .d(new_n157_), .O(new_n607_));
  nor2   g454(.a(new_n607_), .b(x30), .O(new_n608_));
  nand4  g455(.a(new_n608_), .b(new_n156_), .c(new_n155_), .d(new_n144_), .O(new_n609_));
  nor2   g456(.a(new_n609_), .b(x41), .O(new_n610_));
  nand4  g457(.a(new_n610_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n611_));
  nor2   g458(.a(new_n611_), .b(x50), .O(new_n612_));
  nand4  g459(.a(new_n612_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n613_));
  nor2   g460(.a(new_n613_), .b(x62), .O(z58));
  nand4  g461(.a(new_n176_), .b(new_n177_), .c(new_n162_), .d(x07), .O(new_n616_));
  nor2   g462(.a(new_n616_), .b(x14), .O(new_n617_));
  nand4  g463(.a(new_n617_), .b(new_n206_), .c(new_n159_), .d(new_n135_), .O(new_n618_));
  nor2   g464(.a(new_n618_), .b(x28), .O(new_n619_));
  nand4  g465(.a(new_n619_), .b(new_n144_), .c(new_n195_), .d(x29), .O(new_n620_));
  nor2   g466(.a(new_n620_), .b(x39), .O(new_n621_));
  nand4  g467(.a(new_n621_), .b(new_n153_), .c(new_n152_), .d(new_n156_), .O(new_n622_));
  nor2   g468(.a(new_n622_), .b(x47), .O(new_n623_));
  nand4  g469(.a(new_n623_), .b(new_n150_), .c(new_n149_), .d(new_n227_), .O(new_n624_));
  nor2   g470(.a(new_n624_), .b(x60), .O(z60));
  nand4  g471(.a(new_n158_), .b(new_n176_), .c(new_n177_), .d(x08), .O(new_n626_));
  inv1   g472(.a(new_n626_), .O(new_n627_));
  nand4  g473(.a(new_n627_), .b(new_n206_), .c(new_n159_), .d(new_n135_), .O(new_n628_));
  nor2   g474(.a(new_n628_), .b(x28), .O(new_n629_));
  nand4  g475(.a(new_n629_), .b(new_n144_), .c(new_n195_), .d(x29), .O(new_n630_));
  nor2   g476(.a(new_n630_), .b(x39), .O(new_n631_));
  nand4  g477(.a(new_n631_), .b(new_n153_), .c(new_n152_), .d(new_n156_), .O(new_n632_));
  nor2   g478(.a(new_n632_), .b(x47), .O(new_n633_));
  nand4  g479(.a(new_n633_), .b(new_n150_), .c(new_n149_), .d(new_n227_), .O(new_n634_));
