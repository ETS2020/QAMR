...
module FAU ( 
  ...
  nand4  g777(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n909_));
  nor2   g778(.a(new_n909_), .b(x24), .O(new_n910_));
  nand4  g779(.a(new_n910_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n911_));
  nor3   g780(.a(new_n911_), .b(x37), .c(x30), .O(new_n912_));
  nand4  g781(.a(new_n912_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n913_));
  nor2   g782(.a(new_n913_), .b(x46), .O(new_n914_));
  nand4  g783(.a(new_n914_), .b(new_n216_), .c(x56), .d(new_n138_), .O(new_n915_));
  nor2   g784(.a(new_n915_), .b(x60), .O(z63));
  nor2   g785(.a(new_n911_), .b(new_n185_), .O(new_n917_));
