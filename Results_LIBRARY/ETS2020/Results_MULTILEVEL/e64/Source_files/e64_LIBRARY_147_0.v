...
module FAU ( 
  ...
  nand4  g274(.a(new_n414_), .b(new_n142_), .c(new_n301_), .d(new_n184_), .O(new_n415_));
  ...
  nand4  g297(.a(new_n437_), .b(new_n142_), .c(new_n301_), .d(new_n184_), .O(new_n438_));
  ...
  nand4  g328(.a(new_n473_), .b(new_n146_), .c(new_n302_), .d(new_n145_), .O(new_n474_));
  nor2   g329(.a(new_n474_), .b(x34), .O(new_n475_));
  nand4  g330(.a(new_n475_), .b(new_n142_), .c(new_n301_), .d(new_n184_), .O(new_n476_));
