...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n178_, new_n179_, new_n185_, new_n188_, new_n198_, new_n199_,
    new_n200_, new_n201_;
  ...
  nand4  g50(.a(new_n124_), .b(new_n120_), .c(x51), .d(new_n131_), .O(new_n188_));
  nor2   g51(.a(new_n188_), .b(x53), .O(z38));
  nor2   g52(.a(new_n179_), .b(new_n141_), .O(z42));
  nor3   g53(.a(new_n178_), .b(new_n141_), .c(x52), .O(z43));
  inv1   g54(.a(x43), .O(new_n198_));
  nand4  g55(.a(x47), .b(new_n121_), .c(new_n198_), .d(x27), .O(new_n199_));
  nor3   g56(.a(new_n199_), .b(x49), .c(x48), .O(new_n200_));
  nand4  g57(.a(new_n200_), .b(new_n120_), .c(x51), .d(new_n131_), .O(new_n201_));
  ...
  zero   g97(.O(z47));
  zero   g98(.O(z49));
  nor2   g99(.a(new_n179_), .b(x53), .O(z45));
endmodule
