// Benchmark "FAU" written by ABC on Fri Jul 24 17:32:01 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1562_, new_n1563_, new_n1564_, new_n1565_, new_n1567_, new_n1572_,
  ...
  aoi21  g1463(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1572_));
  nand4  g1464(.a(new_n1572_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1573_));
  nand4  g1465(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1574_));
  nand2  g1466(.a(new_n1574_), .b(new_n1573_), .O(new_n1575_));
  nand2  g1467(.a(new_n1575_), .b(new_n118_), .O(new_n1576_));
  oai21  g1468(.a(new_n1430_), .b(new_n138_), .c(x51), .O(new_n1577_));
  nand2  g1469(.a(new_n655_), .b(x11), .O(new_n1578_));
  aoi21  g1470(.a(new_n1578_), .b(new_n1577_), .c(new_n167_), .O(new_n1579_));
  nand4  g1471(.a(new_n1579_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1580_));
  aoi21  g1472(.a(new_n1580_), .b(new_n1576_), .c(x52), .O(z40));
  nand4  g1473(.a(new_n1544_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1582_));
  nand3  g1474(.a(new_n1483_), .b(new_n432_), .c(new_n161_), .O(new_n1583_));
  aoi21  g1475(.a(new_n1583_), .b(new_n1582_), .c(x50), .O(z41));
  oai22  g1476(.a(new_n1451_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1587_));
  nand4  g1477(.a(new_n1587_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1588_));
  nor2   g1478(.a(new_n1588_), .b(x46), .O(z44));
  nand2  g1479(.a(new_n1528_), .b(x52), .O(new_n1591_));
  nor2   g1480(.a(new_n1591_), .b(new_n126_), .O(z46));
  nand2  g1481(.a(new_n807_), .b(new_n167_), .O(new_n1593_));
  inv1   g1482(.a(new_n1593_), .O(new_n1594_));
  nand4  g1483(.a(new_n1594_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1595_));
  nor2   g1484(.a(new_n1595_), .b(x46), .O(z47));
  nand4  g1485(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1597_));
  nor3   g1486(.a(new_n1597_), .b(x49), .c(x48), .O(new_n1598_));
  nand4  g1487(.a(new_n1598_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1599_));
  nor2   g1488(.a(new_n1599_), .b(x53), .O(z48));
  nand2  g1489(.a(new_n138_), .b(new_n107_), .O(new_n1601_));
  nand4  g1490(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1602_));
  oai21  g1491(.a(new_n1462_), .b(new_n1601_), .c(new_n1602_), .O(new_n1603_));
  nand2  g1492(.a(new_n1603_), .b(new_n115_), .O(new_n1604_));
  nand3  g1493(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1605_));
  inv1   g1494(.a(new_n1605_), .O(new_n1606_));
  nand2  g1495(.a(new_n1606_), .b(new_n1544_), .O(new_n1607_));
  aoi21  g1496(.a(new_n1607_), .b(new_n1604_), .c(x50), .O(new_n1608_));
  nor2   g1497(.a(new_n1605_), .b(new_n1031_), .O(new_n1609_));
  oai21  g1498(.a(new_n1609_), .b(new_n1608_), .c(new_n105_), .O(new_n1610_));
  nand3  g1499(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1611_));
  nand2  g1500(.a(new_n1611_), .b(new_n1610_), .O(z49));
  zero   g1501(.O(z14));
  zero   g1502(.O(z31));
  zero   g1503(.O(z37));
  zero   g1504(.O(z39));
