// Benchmark "FAU" written by ABC on Fri Jul 24 17:31:59 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1511_, new_n1513_, new_n1514_, new_n1515_, new_n1518_, new_n1519_,
    ...
    new_n1556_, new_n1557_, new_n1558_, new_n1560_, new_n1564_, new_n1565_,
    ...
    new_n1591_, new_n1594_, new_n1595_, new_n1596_, new_n1597_, new_n1598_,
  ...
  nand2  g1299(.a(new_n161_), .b(new_n118_), .O(new_n1404_));
  nand2  g1300(.a(new_n1404_), .b(new_n647_), .O(new_n1405_));
  nand4  g1301(.a(new_n1405_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1406_));
  aoi21  g1302(.a(new_n1406_), .b(new_n1403_), .c(x46), .O(new_n1407_));
  ...
  nand2  g1388(.a(new_n1380_), .b(new_n295_), .O(new_n1493_));
  ...
  aoi21  g1391(.a(new_n1492_), .b(new_n115_), .c(new_n1495_), .O(new_n1496_));
  nand4  g1392(.a(new_n1030_), .b(new_n275_), .c(new_n161_), .d(new_n108_), .O(new_n1497_));
  oai21  g1393(.a(new_n1496_), .b(x46), .c(new_n1497_), .O(z22));
  nand2  g1394(.a(new_n604_), .b(x50), .O(new_n1499_));
  ...
  oai22  g1398(.a(new_n634_), .b(new_n139_), .c(new_n271_), .d(new_n160_), .O(new_n1503_));
  nand4  g1399(.a(new_n1503_), .b(new_n126_), .c(x52), .d(x49), .O(new_n1504_));
  nor2   g1400(.a(new_n1504_), .b(x48), .O(z24));
  aoi21  g1401(.a(new_n700_), .b(new_n133_), .c(x50), .O(new_n1506_));
  ...
  oai22  g1405(.a(new_n1509_), .b(x46), .c(new_n1484_), .d(new_n1071_), .O(new_n1510_));
  ...
  inv1   g1416(.a(new_n1166_), .O(new_n1522_));
  ...
  oai21  g1420(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1526_));
  ...
  nand4  g1428(.a(new_n1393_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1534_));
  inv1   g1429(.a(new_n1534_), .O(new_n1535_));
  nand2  g1430(.a(new_n1535_), .b(x52), .O(new_n1536_));
  nor2   g1431(.a(new_n1536_), .b(x53), .O(z31));
  nand2  g1432(.a(new_n1356_), .b(x46), .O(new_n1538_));
  nand2  g1433(.a(new_n1379_), .b(new_n107_), .O(new_n1539_));
  oai22  g1434(.a(new_n1539_), .b(new_n1404_), .c(new_n1538_), .d(new_n647_), .O(new_n1540_));
  nand3  g1435(.a(new_n1540_), .b(x49), .c(new_n115_), .O(new_n1541_));
  inv1   g1436(.a(new_n1541_), .O(z32));
  nor2   g1437(.a(new_n1520_), .b(x53), .O(z33));
  oai21  g1438(.a(x53), .b(x48), .c(new_n109_), .O(new_n1544_));
  nand2  g1439(.a(new_n156_), .b(new_n105_), .O(new_n1545_));
  aoi21  g1440(.a(new_n1545_), .b(new_n1544_), .c(x51), .O(new_n1546_));
  nand4  g1441(.a(new_n1546_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1547_));
  nor2   g1442(.a(new_n1547_), .b(x46), .O(z34));
  nand3  g1443(.a(x52), .b(x48), .c(new_n115_), .O(new_n1549_));
  nand3  g1444(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1550_));
  aoi21  g1445(.a(new_n1550_), .b(new_n1549_), .c(new_n126_), .O(new_n1551_));
  nand4  g1446(.a(new_n1551_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1552_));
  oai21  g1447(.a(new_n1484_), .b(new_n1467_), .c(new_n1552_), .O(new_n1553_));
  nand2  g1448(.a(new_n1553_), .b(x49), .O(new_n1554_));
  nand2  g1449(.a(new_n420_), .b(new_n132_), .O(new_n1555_));
  nand4  g1450(.a(new_n1555_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1556_));
  inv1   g1451(.a(new_n1556_), .O(new_n1557_));
  nand3  g1452(.a(new_n1557_), .b(new_n115_), .c(new_n107_), .O(new_n1558_));
  nand2  g1453(.a(new_n1558_), .b(new_n1554_), .O(z35));
  nand3  g1454(.a(new_n1399_), .b(new_n118_), .c(new_n167_), .O(new_n1560_));
  nor3   g1455(.a(new_n1560_), .b(new_n126_), .c(new_n109_), .O(z36));
  nor3   g1456(.a(new_n1560_), .b(x53), .c(x52), .O(z37));
  nand2  g1457(.a(new_n1030_), .b(new_n172_), .O(new_n1564_));
  aoi21  g1458(.a(new_n1564_), .b(new_n271_), .c(new_n126_), .O(new_n1565_));
  nand4  g1459(.a(new_n1565_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1566_));
  nor3   g1460(.a(new_n1566_), .b(x47), .c(x46), .O(z39));
  aoi21  g1461(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1568_));
  nand4  g1462(.a(new_n1568_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1569_));
  nand4  g1463(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1570_));
  nand2  g1464(.a(new_n1570_), .b(new_n1569_), .O(new_n1571_));
  nand2  g1465(.a(new_n1571_), .b(new_n118_), .O(new_n1572_));
  oai21  g1466(.a(new_n1432_), .b(new_n138_), .c(x51), .O(new_n1573_));
  nand2  g1467(.a(new_n655_), .b(x11), .O(new_n1574_));
  aoi21  g1468(.a(new_n1574_), .b(new_n1573_), .c(new_n167_), .O(new_n1575_));
  nand4  g1469(.a(new_n1575_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1576_));
  aoi21  g1470(.a(new_n1576_), .b(new_n1572_), .c(x52), .O(z40));
  inv1   g1471(.a(new_n647_), .O(new_n1578_));
  nand4  g1472(.a(new_n1578_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1579_));
  nand3  g1473(.a(new_n1485_), .b(new_n432_), .c(new_n161_), .O(new_n1580_));
  aoi21  g1474(.a(new_n1580_), .b(new_n1579_), .c(x50), .O(z41));
  nor2   g1475(.a(new_n1536_), .b(new_n126_), .O(z42));
  nor3   g1476(.a(new_n1534_), .b(new_n126_), .c(x52), .O(z43));
  oai22  g1477(.a(new_n1453_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1584_));
  nand4  g1478(.a(new_n1584_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1585_));
  nor2   g1479(.a(new_n1585_), .b(x46), .O(z44));
  nand2  g1480(.a(new_n1519_), .b(x52), .O(new_n1587_));
  nor2   g1481(.a(new_n1587_), .b(new_n126_), .O(z46));
  nand2  g1482(.a(new_n807_), .b(new_n167_), .O(new_n1589_));
  inv1   g1483(.a(new_n1589_), .O(new_n1590_));
  nand4  g1484(.a(new_n1590_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1591_));
  nor2   g1485(.a(new_n1591_), .b(x46), .O(z47));
  nand2  g1486(.a(new_n138_), .b(new_n107_), .O(new_n1594_));
  nand4  g1487(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1595_));
  oai21  g1488(.a(new_n1464_), .b(new_n1594_), .c(new_n1595_), .O(new_n1596_));
  nand2  g1489(.a(new_n1596_), .b(new_n115_), .O(new_n1597_));
  nand3  g1490(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1598_));
  inv1   g1491(.a(new_n1598_), .O(new_n1599_));
  nand2  g1492(.a(new_n1599_), .b(new_n1578_), .O(new_n1600_));
  aoi21  g1493(.a(new_n1600_), .b(new_n1597_), .c(x50), .O(new_n1601_));
  nor2   g1494(.a(new_n1598_), .b(new_n1031_), .O(new_n1602_));
  oai21  g1495(.a(new_n1602_), .b(new_n1601_), .c(new_n105_), .O(new_n1603_));
  nand3  g1496(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1604_));
  nand2  g1497(.a(new_n1604_), .b(new_n1603_), .O(z49));
  zero   g1498(.O(z28));
  zero   g1499(.O(z38));
  zero   g1500(.O(z48));
  nor2   g1501(.a(new_n1536_), .b(x53), .O(z45));
endmodule
