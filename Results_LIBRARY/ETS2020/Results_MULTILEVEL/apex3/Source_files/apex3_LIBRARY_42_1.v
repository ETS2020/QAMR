// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:22 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n162_, new_n165_, new_n166_, new_n167_,
  ...
  nand4  g21(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n165_));
  inv1   g22(.a(new_n165_), .O(new_n166_));
  nand4  g23(.a(new_n166_), .b(x52), .c(x51), .d(x50), .O(new_n167_));
  nor2   g24(.a(new_n167_), .b(new_n153_), .O(z46));
  inv1   g25(.a(x43), .O(new_n170_));
  nand4  g26(.a(x47), .b(new_n121_), .c(new_n170_), .d(x27), .O(new_n171_));
  nor3   g27(.a(new_n171_), .b(x49), .c(x48), .O(new_n172_));
  nand4  g28(.a(new_n172_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n173_));
  nor2   g29(.a(new_n173_), .b(x53), .O(z48));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
  zero   g33(.O(z03));
  ...
  zero   g69(.O(z47));
  zero   g70(.O(z49));
  nor2   g71(.a(new_n147_), .b(x53), .O(z45));
endmodule
