// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:41 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1568_, new_n1569_, new_n1570_, new_n1571_, new_n1575_, new_n1577_,
  ...
  nand4  g1468(.a(new_n1401_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1575_));
  nor2   g1469(.a(new_n1575_), .b(x53), .O(z38));
  nand2  g1470(.a(new_n1030_), .b(new_n172_), .O(new_n1577_));
  aoi21  g1471(.a(new_n1577_), .b(new_n271_), .c(new_n126_), .O(new_n1578_));
  nand4  g1472(.a(new_n1578_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1579_));
  nor3   g1473(.a(new_n1579_), .b(x47), .c(x46), .O(z39));
  aoi21  g1474(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1581_));
  nand4  g1475(.a(new_n1581_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1582_));
  nand4  g1476(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1583_));
  nand2  g1477(.a(new_n1583_), .b(new_n1582_), .O(new_n1584_));
  nand2  g1478(.a(new_n1584_), .b(new_n118_), .O(new_n1585_));
  oai21  g1479(.a(new_n1433_), .b(new_n138_), .c(x51), .O(new_n1586_));
  nand2  g1480(.a(new_n655_), .b(x11), .O(new_n1587_));
  aoi21  g1481(.a(new_n1587_), .b(new_n1586_), .c(new_n167_), .O(new_n1588_));
  nand4  g1482(.a(new_n1588_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1589_));
  aoi21  g1483(.a(new_n1589_), .b(new_n1585_), .c(x52), .O(z40));
  nand4  g1484(.a(new_n1550_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1591_));
  nand3  g1485(.a(new_n1486_), .b(new_n432_), .c(new_n161_), .O(new_n1592_));
  aoi21  g1486(.a(new_n1592_), .b(new_n1591_), .c(x50), .O(z41));
  nor2   g1487(.a(new_n1548_), .b(new_n126_), .O(z42));
  nor3   g1488(.a(new_n1546_), .b(new_n126_), .c(x52), .O(z43));
  ...
  nand2  g1492(.a(new_n1531_), .b(x52), .O(new_n1599_));
  nor2   g1493(.a(new_n1599_), .b(new_n126_), .O(z46));
  nand2  g1494(.a(new_n807_), .b(new_n167_), .O(new_n1601_));
  inv1   g1495(.a(new_n1601_), .O(new_n1602_));
  nand4  g1496(.a(new_n1602_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1603_));
  nor2   g1497(.a(new_n1603_), .b(x46), .O(z47));
  nand4  g1498(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1605_));
  nor3   g1499(.a(new_n1605_), .b(x49), .c(x48), .O(new_n1606_));
  nand4  g1500(.a(new_n1606_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1607_));
  nor2   g1501(.a(new_n1607_), .b(x53), .O(z48));
  nand2  g1502(.a(new_n138_), .b(new_n107_), .O(new_n1609_));
  nand4  g1503(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1610_));
  oai21  g1504(.a(new_n1465_), .b(new_n1609_), .c(new_n1610_), .O(new_n1611_));
  nand2  g1505(.a(new_n1611_), .b(new_n115_), .O(new_n1612_));
  nand3  g1506(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1613_));
  inv1   g1507(.a(new_n1613_), .O(new_n1614_));
  nand2  g1508(.a(new_n1614_), .b(new_n1550_), .O(new_n1615_));
  aoi21  g1509(.a(new_n1615_), .b(new_n1612_), .c(x50), .O(new_n1616_));
  nor2   g1510(.a(new_n1613_), .b(new_n1031_), .O(new_n1617_));
  oai21  g1511(.a(new_n1617_), .b(new_n1616_), .c(new_n105_), .O(new_n1618_));
  nand3  g1512(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1619_));
  nand2  g1513(.a(new_n1619_), .b(new_n1618_), .O(z49));
  zero   g1514(.O(z36));
  zero   g1515(.O(z37));
