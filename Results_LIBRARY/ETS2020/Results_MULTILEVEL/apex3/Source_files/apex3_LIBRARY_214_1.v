// Benchmark "FAU" written by ABC on Fri Jul 24 17:34:07 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n156_, new_n158_, new_n164_, new_n167_,
    new_n168_, new_n169_;
  ...
  nand4  g19(.a(new_n124_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n158_));
  nor2   g20(.a(new_n158_), .b(x53), .O(z38));
  nor2   g21(.a(new_n147_), .b(new_n153_), .O(z42));
  nand4  g22(.a(new_n146_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n164_));
  nor2   g23(.a(new_n164_), .b(new_n153_), .O(z43));
  nand4  g24(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n167_));
  inv1   g25(.a(new_n167_), .O(new_n168_));
  nand4  g26(.a(new_n168_), .b(x52), .c(x51), .d(x50), .O(new_n169_));
  nor2   g27(.a(new_n169_), .b(new_n153_), .O(z46));
  zero   g28(.O(z00));
  zero   g29(.O(z01));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
  ...
  zero   g67(.O(z48));
  zero   g68(.O(z49));
  nor2   g69(.a(new_n147_), .b(x53), .O(z45));
endmodule
