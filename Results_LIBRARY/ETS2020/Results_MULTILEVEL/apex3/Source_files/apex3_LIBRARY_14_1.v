...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n141_, new_n147_, new_n148_, new_n149_, new_n152_, new_n153_,
  ...
  nand4  g15(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n147_));
  inv1   g16(.a(new_n147_), .O(new_n148_));
  nand4  g17(.a(new_n148_), .b(new_n120_), .c(x51), .d(x50), .O(new_n149_));
  nor2   g18(.a(new_n149_), .b(new_n136_), .O(z29));
  inv1   g19(.a(x48), .O(new_n152_));
  nand4  g20(.a(x49), .b(new_n152_), .c(new_n122_), .d(new_n121_), .O(new_n153_));
  inv1   g21(.a(new_n153_), .O(new_n154_));
  nand4  g22(.a(new_n154_), .b(x52), .c(x51), .d(new_n137_), .O(new_n155_));
  nor2   g23(.a(new_n155_), .b(x53), .O(z31));
  nand3  g24(.a(new_n124_), .b(new_n119_), .c(new_n137_), .O(new_n161_));
  nor3   g25(.a(new_n161_), .b(new_n136_), .c(new_n120_), .O(z36));
  nor3   g26(.a(new_n161_), .b(x53), .c(x52), .O(z37));
  nor2   g27(.a(new_n155_), .b(new_n136_), .O(z42));
  nand3  g28(.a(new_n154_), .b(x51), .c(new_n137_), .O(new_n169_));
  nor3   g29(.a(new_n169_), .b(new_n136_), .c(x52), .O(z43));
  ...
  nand4  g33(.a(new_n176_), .b(new_n120_), .c(x51), .d(new_n137_), .O(new_n177_));
