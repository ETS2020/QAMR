// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:26 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n148_, new_n149_, new_n150_, new_n151_, new_n157_, new_n165_,
  ...
  nand3  g19(.a(new_n124_), .b(new_n119_), .c(new_n147_), .O(new_n157_));
  nor3   g20(.a(new_n157_), .b(new_n135_), .c(new_n120_), .O(z36));
  nor3   g21(.a(new_n157_), .b(x53), .c(x52), .O(z37));
  nor2   g22(.a(new_n151_), .b(new_n135_), .O(z42));
  nand3  g23(.a(new_n150_), .b(x51), .c(new_n147_), .O(new_n165_));
  nor3   g24(.a(new_n165_), .b(new_n135_), .c(x52), .O(z43));
  ...
  nand4  g28(.a(new_n172_), .b(new_n120_), .c(x51), .d(new_n147_), .O(new_n173_));
  ...
  zero   g69(.O(z47));
  zero   g70(.O(z49));
  nor2   g71(.a(new_n151_), .b(x53), .O(z45));
endmodule
