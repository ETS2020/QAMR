...
module FAU ( 
  ...
  nand4  g14(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n150_));
  inv1   g15(.a(new_n150_), .O(new_n151_));
  nand4  g16(.a(new_n151_), .b(new_n120_), .c(x51), .d(x50), .O(new_n152_));
  nor2   g17(.a(new_n152_), .b(x53), .O(z33));
  inv1   g18(.a(x53), .O(new_n156_));
  nor2   g19(.a(new_n123_), .b(x50), .O(new_n157_));
  nand2  g20(.a(new_n157_), .b(new_n119_), .O(new_n158_));
  nor3   g21(.a(new_n158_), .b(new_n156_), .c(new_n120_), .O(z36));
  ...
  nor2   g25(.a(new_n147_), .b(new_n156_), .O(z42));
  nand3  g26(.a(new_n146_), .b(x51), .c(new_n143_), .O(new_n167_));
  nor3   g27(.a(new_n167_), .b(new_n156_), .c(x52), .O(z43));
