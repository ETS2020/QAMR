// Benchmark "FAU" written by ABC on Fri Jul 24 17:30:58 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1562_, new_n1563_, new_n1564_, new_n1566_, new_n1570_, new_n1571_,
    new_n1572_, new_n1575_, new_n1576_, new_n1580_, new_n1581_, new_n1584_,
  ...
  oai21  g1324(.a(x53), .b(new_n106_), .c(x51), .O(new_n1430_));
  ...
  aoi21  g1329(.a(new_n1429_), .b(new_n138_), .c(new_n1434_), .O(new_n1435_));
  ...
  nand3  g1405(.a(new_n1395_), .b(new_n138_), .c(x48), .O(new_n1511_));
  ...
  nand4  g1459(.a(new_n1395_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1566_));
  nor4   g1460(.a(new_n1566_), .b(new_n126_), .c(new_n109_), .d(x51), .O(z36));
  nor4   g1461(.a(new_n1566_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  nand2  g1462(.a(new_n1030_), .b(new_n172_), .O(new_n1570_));
  aoi21  g1463(.a(new_n1570_), .b(new_n271_), .c(new_n126_), .O(new_n1571_));
  nand4  g1464(.a(new_n1571_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1572_));
  nor3   g1465(.a(new_n1572_), .b(x47), .c(x46), .O(z39));
  nand4  g1466(.a(new_n1543_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1575_));
  nand3  g1467(.a(new_n1482_), .b(new_n432_), .c(new_n161_), .O(new_n1576_));
  aoi21  g1468(.a(new_n1576_), .b(new_n1575_), .c(x50), .O(z41));
  oai22  g1469(.a(new_n1450_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1580_));
  nand4  g1470(.a(new_n1580_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1581_));
  nor2   g1471(.a(new_n1581_), .b(x46), .O(z44));
  nand2  g1472(.a(new_n1527_), .b(x52), .O(new_n1584_));
  nor2   g1473(.a(new_n1584_), .b(new_n126_), .O(z46));
  nand2  g1474(.a(new_n807_), .b(new_n167_), .O(new_n1586_));
  inv1   g1475(.a(new_n1586_), .O(new_n1587_));
  nand4  g1476(.a(new_n1587_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1588_));
  nor2   g1477(.a(new_n1588_), .b(x46), .O(z47));
  nand4  g1478(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1590_));
  nor3   g1479(.a(new_n1590_), .b(x49), .c(x48), .O(new_n1591_));
  nand4  g1480(.a(new_n1591_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1592_));
  nor2   g1481(.a(new_n1592_), .b(x53), .O(z48));
  nand2  g1482(.a(new_n138_), .b(new_n107_), .O(new_n1594_));
  nand4  g1483(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1595_));
  oai21  g1484(.a(new_n1461_), .b(new_n1594_), .c(new_n1595_), .O(new_n1596_));
  nand2  g1485(.a(new_n1596_), .b(new_n115_), .O(new_n1597_));
  nand3  g1486(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1598_));
  inv1   g1487(.a(new_n1598_), .O(new_n1599_));
  nand2  g1488(.a(new_n1599_), .b(new_n1543_), .O(new_n1600_));
  aoi21  g1489(.a(new_n1600_), .b(new_n1597_), .c(x50), .O(new_n1601_));
  nor2   g1490(.a(new_n1598_), .b(new_n1031_), .O(new_n1602_));
  oai21  g1491(.a(new_n1602_), .b(new_n1601_), .c(new_n105_), .O(new_n1603_));
  nand3  g1492(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1604_));
  nand2  g1493(.a(new_n1604_), .b(new_n1603_), .O(z49));
  zero   g1494(.O(z14));
  zero   g1495(.O(z31));
  zero   g1496(.O(z37));
  zero   g1497(.O(z40));
