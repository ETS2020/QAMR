...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1532_, new_n1535_, new_n1536_, new_n1537_, new_n1539_, new_n1540_,
  ...
  oai21  g1061(.a(new_n126_), .b(new_n109_), .c(new_n167_), .O(new_n1166_));
  ...
  nand4  g1429(.a(new_n1395_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1535_));
  inv1   g1430(.a(new_n1535_), .O(new_n1536_));
  nand2  g1431(.a(new_n1536_), .b(x52), .O(new_n1537_));
  nor2   g1432(.a(new_n1537_), .b(x53), .O(z31));
  inv1   g1433(.a(new_n647_), .O(new_n1539_));
  nand3  g1434(.a(new_n1539_), .b(new_n1356_), .c(x46), .O(new_n1540_));
  nand3  g1435(.a(new_n1524_), .b(new_n1381_), .c(new_n107_), .O(new_n1541_));
  ...
  nor2   g1439(.a(new_n1532_), .b(x53), .O(z33));
  ...
  oai21  g1449(.a(new_n1485_), .b(new_n1468_), .c(new_n1554_), .O(new_n1555_));
  ...
  nor2   g1456(.a(new_n1400_), .b(x50), .O(new_n1562_));
  ...
  nand2  g1462(.a(new_n1030_), .b(new_n172_), .O(new_n1568_));
  ...
  nand4  g1468(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1574_));
  nand2  g1469(.a(new_n1574_), .b(new_n1573_), .O(new_n1575_));
  nand2  g1470(.a(new_n1575_), .b(new_n118_), .O(new_n1576_));
  oai21  g1471(.a(new_n1433_), .b(new_n138_), .c(x51), .O(new_n1577_));
  nand2  g1472(.a(new_n655_), .b(x11), .O(new_n1578_));
  ...
  nand3  g1477(.a(new_n1486_), .b(new_n432_), .c(new_n161_), .O(new_n1583_));
  ...
  oai22  g1481(.a(new_n1454_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1587_));
  nand4  g1482(.a(new_n1587_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1588_));
  nor2   g1483(.a(new_n1588_), .b(x46), .O(z44));
  nand2  g1484(.a(new_n1531_), .b(x52), .O(new_n1590_));
  nor2   g1485(.a(new_n1590_), .b(new_n126_), .O(z46));
  nand2  g1486(.a(new_n807_), .b(new_n167_), .O(new_n1592_));
  ...
  nand4  g1491(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1598_));
  oai21  g1492(.a(new_n1465_), .b(new_n1597_), .c(new_n1598_), .O(new_n1599_));
  ...
  nor2   g1498(.a(new_n1601_), .b(new_n1031_), .O(new_n1605_));
  oai21  g1499(.a(new_n1605_), .b(new_n1604_), .c(new_n105_), .O(new_n1606_));
  nand3  g1500(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1607_));
