...
module FAU ( 
  ...
  nor2   g23(.a(new_n123_), .b(x50), .O(new_n161_));
  nand2  g24(.a(new_n161_), .b(new_n119_), .O(new_n162_));
  nor3   g25(.a(new_n162_), .b(new_n160_), .c(new_n120_), .O(z36));
  nor3   g26(.a(new_n162_), .b(x53), .c(x52), .O(z37));
  nand3  g27(.a(new_n161_), .b(new_n120_), .c(x51), .O(new_n165_));
  nor2   g28(.a(new_n165_), .b(x53), .O(z38));
  nor2   g29(.a(new_n154_), .b(new_n160_), .O(z42));
  nand3  g30(.a(new_n153_), .b(x51), .c(new_n133_), .O(new_n171_));
  nor3   g31(.a(new_n171_), .b(new_n160_), .c(x52), .O(z43));
  inv1   g32(.a(x43), .O(new_n176_));
  nand4  g33(.a(x47), .b(new_n121_), .c(new_n176_), .d(x27), .O(new_n177_));
  nor3   g34(.a(new_n177_), .b(x49), .c(x48), .O(new_n178_));
  nand4  g35(.a(new_n178_), .b(new_n120_), .c(x51), .d(new_n133_), .O(new_n179_));
  nor2   g36(.a(new_n179_), .b(x53), .O(z48));
  zero   g37(.O(z00));
  zero   g38(.O(z01));
  zero   g39(.O(z02));
  zero   g40(.O(z03));
  ...
  zero   g75(.O(z47));
  zero   g76(.O(z49));
  nor2   g77(.a(new_n154_), .b(x53), .O(z45));
endmodule
