...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n162_, new_n163_, new_n164_, new_n165_, new_n170_, new_n175_,
  ...
  inv1   g21(.a(x49), .O(new_n160_));
  nand2  g22(.a(x51), .b(new_n143_), .O(new_n161_));
  inv1   g23(.a(x24), .O(new_n162_));
  nand3  g24(.a(new_n119_), .b(x50), .c(new_n162_), .O(new_n163_));
  aoi21  g25(.a(new_n163_), .b(new_n161_), .c(new_n153_), .O(new_n164_));
  nand4  g26(.a(new_n164_), .b(new_n120_), .c(new_n160_), .d(x48), .O(new_n165_));
  nor3   g27(.a(new_n165_), .b(x47), .c(x46), .O(z39));
  nor2   g28(.a(new_n147_), .b(new_n153_), .O(z42));
  nand3  g29(.a(new_n146_), .b(x51), .c(new_n143_), .O(new_n170_));
  nor3   g30(.a(new_n170_), .b(new_n153_), .c(x52), .O(z43));
  ...
  nand4  g34(.a(new_n177_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n178_));
  ...
  zero   g74(.O(z47));
  zero   g75(.O(z49));
  nor2   g76(.a(new_n147_), .b(x53), .O(z45));
endmodule
