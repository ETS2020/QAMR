...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1592_, new_n1596_, new_n1597_, new_n1600_, new_n1601_, new_n1602_,
  ...
  nand4  g1427(.a(new_n1531_), .b(new_n109_), .c(x51), .d(x50), .O(new_n1532_));
  ...
  nand2  g1493(.a(new_n807_), .b(new_n167_), .O(new_n1600_));
  inv1   g1494(.a(new_n1600_), .O(new_n1601_));
  nand4  g1495(.a(new_n1601_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1602_));
  nor2   g1496(.a(new_n1602_), .b(x46), .O(z47));
  nand4  g1497(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1604_));
  nor3   g1498(.a(new_n1604_), .b(x49), .c(x48), .O(new_n1605_));
  nand4  g1499(.a(new_n1605_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1606_));
  nor2   g1500(.a(new_n1606_), .b(x53), .O(z48));
  nand2  g1501(.a(new_n138_), .b(new_n107_), .O(new_n1608_));
  nand4  g1502(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1609_));
  oai21  g1503(.a(new_n1465_), .b(new_n1608_), .c(new_n1609_), .O(new_n1610_));
  nand2  g1504(.a(new_n1610_), .b(new_n115_), .O(new_n1611_));
  nand3  g1505(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1612_));
  inv1   g1506(.a(new_n1612_), .O(new_n1613_));
  nand2  g1507(.a(new_n1613_), .b(new_n1550_), .O(new_n1614_));
  aoi21  g1508(.a(new_n1614_), .b(new_n1611_), .c(x50), .O(new_n1615_));
  nor2   g1509(.a(new_n1612_), .b(new_n1031_), .O(new_n1616_));
  oai21  g1510(.a(new_n1616_), .b(new_n1615_), .c(new_n105_), .O(new_n1617_));
  nand3  g1511(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1618_));
  nand2  g1512(.a(new_n1618_), .b(new_n1617_), .O(z49));
  zero   g1513(.O(z38));
  zero   g1514(.O(z46));
