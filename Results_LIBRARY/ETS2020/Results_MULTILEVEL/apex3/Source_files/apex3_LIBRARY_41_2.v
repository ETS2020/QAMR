// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:21 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1585_, new_n1587_, new_n1588_, new_n1591_, new_n1592_, new_n1593_,
    new_n1595_, new_n1596_, new_n1599_, new_n1601_, new_n1602_, new_n1603_,
  ...
  nand4  g1483(.a(x49), .b(new_n105_), .c(new_n115_), .d(new_n107_), .O(new_n1591_));
  inv1   g1484(.a(new_n1591_), .O(new_n1592_));
  nand4  g1485(.a(new_n1592_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1593_));
  nor2   g1486(.a(new_n1593_), .b(new_n126_), .O(z43));
  oai22  g1487(.a(new_n1453_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1595_));
  nand4  g1488(.a(new_n1595_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1596_));
  nor2   g1489(.a(new_n1596_), .b(x46), .O(z44));
  nand2  g1490(.a(new_n1530_), .b(x52), .O(new_n1599_));
  nor2   g1491(.a(new_n1599_), .b(new_n126_), .O(z46));
  nand2  g1492(.a(new_n807_), .b(new_n167_), .O(new_n1601_));
  inv1   g1493(.a(new_n1601_), .O(new_n1602_));
  nand4  g1494(.a(new_n1602_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1603_));
  nor2   g1495(.a(new_n1603_), .b(x46), .O(z47));
  nand4  g1496(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1605_));
  nor3   g1497(.a(new_n1605_), .b(x49), .c(x48), .O(new_n1606_));
  nand4  g1498(.a(new_n1606_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1607_));
  nor2   g1499(.a(new_n1607_), .b(x53), .O(z48));
  nand2  g1500(.a(new_n138_), .b(new_n107_), .O(new_n1609_));
  nand4  g1501(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1610_));
  oai21  g1502(.a(new_n1464_), .b(new_n1609_), .c(new_n1610_), .O(new_n1611_));
  nand2  g1503(.a(new_n1611_), .b(new_n115_), .O(new_n1612_));
  nand3  g1504(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1613_));
  inv1   g1505(.a(new_n1613_), .O(new_n1614_));
  nand2  g1506(.a(new_n1614_), .b(new_n1546_), .O(new_n1615_));
  aoi21  g1507(.a(new_n1615_), .b(new_n1612_), .c(x50), .O(new_n1616_));
  nor2   g1508(.a(new_n1613_), .b(new_n1031_), .O(new_n1617_));
  oai21  g1509(.a(new_n1617_), .b(new_n1616_), .c(new_n105_), .O(new_n1618_));
  nand3  g1510(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1619_));
  nand2  g1511(.a(new_n1619_), .b(new_n1618_), .O(z49));
  zero   g1512(.O(z31));
  zero   g1513(.O(z37));
  zero   g1514(.O(z42));
  zero   g1515(.O(z45));
