// Benchmark "FAU" written by ABC on Fri Jul 24 17:31:47 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1474_, new_n1475_, new_n1476_, new_n1479_, new_n1480_, new_n1481_,
    ...
    new_n1562_, new_n1564_, new_n1568_, new_n1569_, new_n1570_, new_n1572_,
  ...
  nand2  g1372(.a(new_n730_), .b(x46), .O(new_n1479_));
  inv1   g1373(.a(new_n1479_), .O(new_n1480_));
  nand3  g1374(.a(new_n1480_), .b(new_n325_), .c(new_n199_), .O(new_n1481_));
  nand4  g1375(.a(new_n1346_), .b(new_n628_), .c(new_n156_), .d(new_n107_), .O(new_n1482_));
  aoi21  g1376(.a(new_n1482_), .b(new_n1481_), .c(new_n118_), .O(z21));
  oai21  g1377(.a(new_n585_), .b(new_n138_), .c(new_n1238_), .O(new_n1484_));
  nand3  g1378(.a(new_n1484_), .b(new_n126_), .c(new_n105_), .O(new_n1485_));
  nand4  g1379(.a(new_n468_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1486_));
  aoi21  g1380(.a(new_n1486_), .b(new_n1485_), .c(x52), .O(new_n1487_));
  nor2   g1381(.a(new_n1381_), .b(new_n1356_), .O(new_n1488_));
  inv1   g1382(.a(new_n1488_), .O(new_n1489_));
  nand4  g1383(.a(new_n1489_), .b(x53), .c(x52), .d(new_n118_), .O(new_n1490_));
  nor3   g1384(.a(new_n1490_), .b(new_n138_), .c(new_n115_), .O(new_n1491_));
  aoi21  g1385(.a(new_n1487_), .b(new_n115_), .c(new_n1491_), .O(new_n1492_));
  nand4  g1386(.a(new_n1030_), .b(new_n275_), .c(new_n161_), .d(new_n108_), .O(new_n1493_));
  oai21  g1387(.a(new_n1492_), .b(x46), .c(new_n1493_), .O(z22));
  nand2  g1388(.a(new_n604_), .b(x50), .O(new_n1495_));
  inv1   g1389(.a(new_n1495_), .O(new_n1496_));
  nand4  g1390(.a(new_n1496_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1497_));
  inv1   g1391(.a(new_n1497_), .O(z23));
  oai22  g1392(.a(new_n634_), .b(new_n139_), .c(new_n271_), .d(new_n160_), .O(new_n1499_));
  nand4  g1393(.a(new_n1499_), .b(new_n126_), .c(x52), .d(x49), .O(new_n1500_));
  nor2   g1394(.a(new_n1500_), .b(x48), .O(z24));
  aoi21  g1395(.a(new_n700_), .b(new_n133_), .c(x50), .O(new_n1502_));
  nand4  g1396(.a(new_n1502_), .b(x49), .c(x48), .d(new_n115_), .O(new_n1503_));
  nor2   g1397(.a(new_n1503_), .b(x46), .O(z25));
  nand4  g1398(.a(x53), .b(x50), .c(new_n138_), .d(x47), .O(new_n1505_));
  oai22  g1399(.a(new_n1505_), .b(x46), .c(new_n1479_), .d(new_n1071_), .O(new_n1506_));
  nand3  g1400(.a(new_n1506_), .b(x52), .c(new_n118_), .O(new_n1507_));
  inv1   g1401(.a(new_n1507_), .O(z26));
  nand3  g1402(.a(new_n1395_), .b(new_n138_), .c(x48), .O(new_n1509_));
  inv1   g1403(.a(new_n1509_), .O(new_n1510_));
  nand4  g1404(.a(new_n1510_), .b(new_n109_), .c(new_n118_), .d(new_n167_), .O(new_n1511_));
  nor2   g1405(.a(new_n1511_), .b(new_n126_), .O(z27));
  nand3  g1406(.a(new_n126_), .b(new_n167_), .c(new_n105_), .O(new_n1513_));
  aoi21  g1407(.a(new_n1513_), .b(new_n1488_), .c(new_n109_), .O(new_n1514_));
  nand2  g1408(.a(new_n1359_), .b(new_n199_), .O(new_n1515_));
  inv1   g1409(.a(new_n1515_), .O(new_n1516_));
  oai21  g1410(.a(new_n1516_), .b(new_n1514_), .c(x51), .O(new_n1517_));
  nor2   g1411(.a(new_n507_), .b(x51), .O(new_n1518_));
  nand2  g1412(.a(new_n1518_), .b(new_n1359_), .O(new_n1519_));
  aoi21  g1413(.a(new_n1519_), .b(new_n1517_), .c(new_n138_), .O(new_n1520_));
  nor3   g1414(.a(new_n647_), .b(new_n289_), .c(x48), .O(new_n1521_));
  oai21  g1415(.a(new_n1521_), .b(new_n1520_), .c(x47), .O(new_n1522_));
  nor2   g1416(.a(new_n1522_), .b(x46), .O(z28));
  nand3  g1417(.a(new_n122_), .b(x49), .c(x48), .O(new_n1524_));
  nor3   g1418(.a(new_n1524_), .b(new_n118_), .c(new_n167_), .O(new_n1525_));
  nand2  g1419(.a(new_n1525_), .b(new_n109_), .O(new_n1526_));
  nor2   g1420(.a(new_n1526_), .b(new_n126_), .O(z29));
  inv1   g1421(.a(new_n1166_), .O(new_n1528_));
  nand3  g1422(.a(new_n1528_), .b(x50), .c(new_n138_), .O(new_n1529_));
  oai21  g1423(.a(new_n286_), .b(new_n138_), .c(new_n1529_), .O(new_n1530_));
  nand2  g1424(.a(new_n1530_), .b(new_n107_), .O(new_n1531_));
  oai21  g1425(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1532_));
  nand3  g1426(.a(new_n1532_), .b(x49), .c(x46), .O(new_n1533_));
  aoi21  g1427(.a(new_n1533_), .b(new_n1531_), .c(x51), .O(new_n1534_));
  nand4  g1428(.a(new_n174_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1535_));
  nor2   g1429(.a(new_n1535_), .b(new_n107_), .O(new_n1536_));
  oai21  g1430(.a(new_n1536_), .b(new_n1534_), .c(new_n105_), .O(new_n1537_));
  nand4  g1431(.a(new_n283_), .b(new_n272_), .c(new_n156_), .d(x46), .O(new_n1538_));
  aoi21  g1432(.a(new_n1538_), .b(new_n1537_), .c(x47), .O(z30));
  inv1   g1433(.a(new_n647_), .O(new_n1541_));
  nand3  g1434(.a(new_n1541_), .b(new_n1356_), .c(x46), .O(new_n1542_));
  nand3  g1435(.a(new_n1518_), .b(new_n1381_), .c(new_n107_), .O(new_n1543_));
  nand2  g1436(.a(new_n1543_), .b(new_n1542_), .O(new_n1544_));
  nand3  g1437(.a(new_n1544_), .b(x49), .c(new_n115_), .O(new_n1545_));
  inv1   g1438(.a(new_n1545_), .O(z32));
  nor2   g1439(.a(new_n1526_), .b(x53), .O(z33));
  oai21  g1440(.a(x53), .b(x48), .c(new_n109_), .O(new_n1548_));
  nand2  g1441(.a(new_n156_), .b(new_n105_), .O(new_n1549_));
  aoi21  g1442(.a(new_n1549_), .b(new_n1548_), .c(x51), .O(new_n1550_));
  nand4  g1443(.a(new_n1550_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1551_));
  nor2   g1444(.a(new_n1551_), .b(x46), .O(z34));
  nand3  g1445(.a(x52), .b(x48), .c(new_n115_), .O(new_n1553_));
  nand3  g1446(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1554_));
  aoi21  g1447(.a(new_n1554_), .b(new_n1553_), .c(new_n126_), .O(new_n1555_));
  nand4  g1448(.a(new_n1555_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1556_));
  oai21  g1449(.a(new_n1479_), .b(new_n1465_), .c(new_n1556_), .O(new_n1557_));
  nand2  g1450(.a(new_n1557_), .b(x49), .O(new_n1558_));
  nand2  g1451(.a(new_n420_), .b(new_n132_), .O(new_n1559_));
  nand4  g1452(.a(new_n1559_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1560_));
  inv1   g1453(.a(new_n1560_), .O(new_n1561_));
  nand3  g1454(.a(new_n1561_), .b(new_n115_), .c(new_n107_), .O(new_n1562_));
  nand2  g1455(.a(new_n1562_), .b(new_n1558_), .O(z35));
  nand4  g1456(.a(new_n1395_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1564_));
  nor4   g1457(.a(new_n1564_), .b(new_n126_), .c(new_n109_), .d(x51), .O(z36));
  nor4   g1458(.a(new_n1564_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  nand2  g1459(.a(new_n1030_), .b(new_n172_), .O(new_n1568_));
  aoi21  g1460(.a(new_n1568_), .b(new_n271_), .c(new_n126_), .O(new_n1569_));
  nand4  g1461(.a(new_n1569_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1570_));
  nor3   g1462(.a(new_n1570_), .b(x47), .c(x46), .O(z39));
  ...
  nand4  g1473(.a(new_n1541_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1582_));
  nand3  g1474(.a(new_n1480_), .b(new_n432_), .c(new_n161_), .O(new_n1583_));
  ...
  nand2  g1479(.a(new_n1525_), .b(x52), .O(new_n1591_));
  ...
  nand2  g1495(.a(new_n1606_), .b(new_n1541_), .O(new_n1607_));
