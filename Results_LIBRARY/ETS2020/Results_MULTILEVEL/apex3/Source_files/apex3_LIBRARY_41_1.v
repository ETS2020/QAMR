// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:20 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n155_, new_n158_, new_n168_, new_n169_,
    new_n170_, new_n171_;
  ...
  inv1   g22(.a(x43), .O(new_n168_));
  nand4  g23(.a(x47), .b(new_n121_), .c(new_n168_), .d(x27), .O(new_n169_));
  nor3   g24(.a(new_n169_), .b(x49), .c(x48), .O(new_n170_));
  nand4  g25(.a(new_n170_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n171_));
  nor2   g26(.a(new_n171_), .b(x53), .O(z48));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z03));
