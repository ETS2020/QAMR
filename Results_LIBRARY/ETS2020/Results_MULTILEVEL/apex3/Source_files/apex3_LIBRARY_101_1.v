...
module FAU ( 
  ...
  wire new_n111_, new_n112_, new_n113_, new_n114_, new_n115_, new_n116_,
    ...
    new_n309_, new_n310_, new_n319_, new_n320_, new_n321_, new_n334_,
    new_n335_, new_n336_, new_n337_, new_n343_, new_n344_, new_n345_,
    new_n351_, new_n359_, new_n364_, new_n365_, new_n366_;
  ...
  nand4  g205(.a(x53), .b(x50), .c(new_n113_), .d(x47), .O(new_n334_));
  nand3  g206(.a(new_n141_), .b(new_n112_), .c(x46), .O(new_n335_));
  oai22  g207(.a(new_n335_), .b(new_n171_), .c(new_n334_), .d(x46), .O(new_n336_));
  nand3  g208(.a(new_n336_), .b(x52), .c(new_n115_), .O(new_n337_));
  inv1   g209(.a(new_n337_), .O(z26));
  nand4  g210(.a(x49), .b(new_n141_), .c(new_n112_), .d(new_n111_), .O(new_n343_));
  nor3   g211(.a(new_n343_), .b(new_n115_), .c(x50), .O(new_n344_));
  nand2  g212(.a(new_n344_), .b(x52), .O(new_n345_));
  nor2   g213(.a(new_n345_), .b(x53), .O(z31));
  nand3  g214(.a(new_n320_), .b(new_n115_), .c(new_n120_), .O(new_n351_));
  nor3   g215(.a(new_n351_), .b(new_n164_), .c(new_n188_), .O(z36));
  nor3   g216(.a(new_n351_), .b(x53), .c(x52), .O(z37));
  nor2   g217(.a(new_n345_), .b(new_n164_), .O(z42));
  nand2  g218(.a(new_n344_), .b(new_n188_), .O(new_n359_));
  nor2   g219(.a(new_n359_), .b(new_n164_), .O(z43));
  nand4  g220(.a(x47), .b(new_n111_), .c(new_n146_), .d(x27), .O(new_n364_));
  nor3   g221(.a(new_n364_), .b(x49), .c(x48), .O(new_n365_));
  nand4  g222(.a(new_n365_), .b(new_n188_), .c(x51), .d(new_n120_), .O(new_n366_));
  nor2   g223(.a(new_n366_), .b(x53), .O(z48));
  zero   g224(.O(z00));
  zero   g225(.O(z01));
  zero   g226(.O(z02));
  zero   g227(.O(z03));
  ...
  zero   g262(.O(z47));
  zero   g263(.O(z49));
  nor2   g264(.a(new_n345_), .b(x53), .O(z45));
endmodule
