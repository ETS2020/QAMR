...
module FAU ( 
  ...
  wire new_n106_, new_n107_, new_n108_, new_n109_, new_n110_, new_n111_,
    ...
    new_n245_, new_n246_, new_n256_, new_n257_, new_n258_, new_n267_,
    new_n268_, new_n269_, new_n275_, new_n276_, new_n279_, new_n285_,
  ...
  nand4  g130(.a(new_n167_), .b(x52), .c(x51), .d(x50), .O(new_n256_));
  inv1   g131(.a(new_n256_), .O(new_n257_));
  nand4  g132(.a(new_n257_), .b(new_n119_), .c(x47), .d(new_n243_), .O(new_n258_));
  inv1   g133(.a(new_n258_), .O(z23));
  nand4  g134(.a(x49), .b(new_n109_), .c(new_n106_), .d(new_n243_), .O(new_n267_));
  nor3   g135(.a(new_n267_), .b(new_n107_), .c(x50), .O(new_n268_));
  nand2  g136(.a(new_n268_), .b(x52), .O(new_n269_));
  nor2   g137(.a(new_n269_), .b(x53), .O(z31));
  nor2   g138(.a(new_n244_), .b(x50), .O(new_n275_));
  nand2  g139(.a(new_n275_), .b(new_n107_), .O(new_n276_));
  nor3   g140(.a(new_n276_), .b(new_n167_), .c(new_n114_), .O(z36));
  nor3   g141(.a(new_n276_), .b(x53), .c(x52), .O(z37));
  nand3  g142(.a(new_n275_), .b(new_n114_), .c(x51), .O(new_n279_));
  nor2   g143(.a(new_n279_), .b(x53), .O(z38));
  nor2   g144(.a(new_n269_), .b(new_n167_), .O(z42));
  nand2  g145(.a(new_n268_), .b(new_n114_), .O(new_n285_));
  nor2   g146(.a(new_n285_), .b(new_n167_), .O(z43));
  nand4  g147(.a(x47), .b(new_n243_), .c(new_n212_), .d(x27), .O(new_n290_));
  nor3   g148(.a(new_n290_), .b(x49), .c(x48), .O(new_n291_));
  nand4  g149(.a(new_n291_), .b(new_n114_), .c(x51), .d(new_n125_), .O(new_n292_));
  nor2   g150(.a(new_n292_), .b(x53), .O(z48));
  zero   g151(.O(z00));
  zero   g152(.O(z02));
  zero   g153(.O(z03));
  zero   g154(.O(z04));
  ...
  zero   g188(.O(z47));
  zero   g189(.O(z49));
  nor2   g190(.a(new_n269_), .b(x53), .O(z45));
endmodule
