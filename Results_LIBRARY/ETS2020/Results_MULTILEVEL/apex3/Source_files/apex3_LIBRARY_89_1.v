// Benchmark "FAU" written by ABC on Fri Jul 24 17:30:42 2020
...
module FAU ( 
  ...
  wire new_n111_, new_n112_, new_n113_, new_n114_, new_n115_, new_n116_,
    ...
    new_n340_, new_n341_, new_n347_, new_n348_, new_n351_, new_n357_,
  ...
  nor2   g209(.a(new_n319_), .b(x50), .O(new_n347_));
  nand2  g210(.a(new_n347_), .b(new_n115_), .O(new_n348_));
  nor3   g211(.a(new_n348_), .b(new_n164_), .c(new_n188_), .O(z36));
  nor3   g212(.a(new_n348_), .b(x53), .c(x52), .O(z37));
  nand3  g213(.a(new_n347_), .b(new_n188_), .c(x51), .O(new_n351_));
  nor2   g214(.a(new_n351_), .b(x53), .O(z38));
  nor2   g215(.a(new_n341_), .b(new_n164_), .O(z42));
  nand2  g216(.a(new_n340_), .b(new_n188_), .O(new_n357_));
  nor2   g217(.a(new_n357_), .b(new_n164_), .O(z43));
  nand4  g218(.a(x47), .b(new_n111_), .c(new_n146_), .d(x27), .O(new_n362_));
  nor3   g219(.a(new_n362_), .b(x49), .c(x48), .O(new_n363_));
  nand4  g220(.a(new_n363_), .b(new_n188_), .c(x51), .d(new_n120_), .O(new_n364_));
  nor2   g221(.a(new_n364_), .b(x53), .O(z48));
  zero   g222(.O(z00));
  zero   g223(.O(z01));
  zero   g224(.O(z02));
  zero   g225(.O(z03));
  ...
  zero   g260(.O(z47));
  zero   g261(.O(z49));
  nor2   g262(.a(new_n341_), .b(x53), .O(z45));
endmodule
