// Benchmark "FAU" written by ABC on Fri Jul 24 17:33:21 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1586_, new_n1590_, new_n1591_, new_n1595_, new_n1596_, new_n1597_,
  ...
  nand3  g1423(.a(new_n1528_), .b(x51), .c(x50), .O(new_n1529_));
  nor3   g1424(.a(new_n1529_), .b(new_n126_), .c(x52), .O(z29));
  ...
  oai21  g1443(.a(x53), .b(x48), .c(new_n109_), .O(new_n1551_));
  nand2  g1444(.a(new_n156_), .b(new_n105_), .O(new_n1552_));
  aoi21  g1445(.a(new_n1552_), .b(new_n1551_), .c(x51), .O(new_n1553_));
  nand4  g1446(.a(new_n1553_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1554_));
  nor2   g1447(.a(new_n1554_), .b(x46), .O(z34));
  nand3  g1448(.a(x52), .b(x48), .c(new_n115_), .O(new_n1556_));
  nand3  g1449(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1557_));
  aoi21  g1450(.a(new_n1557_), .b(new_n1556_), .c(new_n126_), .O(new_n1558_));
  nand4  g1451(.a(new_n1558_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1559_));
  oai21  g1452(.a(new_n1482_), .b(new_n1465_), .c(new_n1559_), .O(new_n1560_));
  nand2  g1453(.a(new_n1560_), .b(x49), .O(new_n1561_));
  nand2  g1454(.a(new_n420_), .b(new_n132_), .O(new_n1562_));
  nand4  g1455(.a(new_n1562_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1563_));
  inv1   g1456(.a(new_n1563_), .O(new_n1564_));
  nand3  g1457(.a(new_n1564_), .b(new_n115_), .c(new_n107_), .O(new_n1565_));
  nand2  g1458(.a(new_n1565_), .b(new_n1561_), .O(z35));
  nand4  g1459(.a(new_n1395_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1567_));
  nor4   g1460(.a(new_n1567_), .b(new_n126_), .c(new_n109_), .d(x51), .O(z36));
  nor4   g1461(.a(new_n1567_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  nand2  g1462(.a(new_n1030_), .b(new_n172_), .O(new_n1571_));
  aoi21  g1463(.a(new_n1571_), .b(new_n271_), .c(new_n126_), .O(new_n1572_));
  nand4  g1464(.a(new_n1572_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1573_));
  nor3   g1465(.a(new_n1573_), .b(x47), .c(x46), .O(z39));
  aoi21  g1466(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1575_));
  nand4  g1467(.a(new_n1575_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1576_));
  nand4  g1468(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1577_));
  nand2  g1469(.a(new_n1577_), .b(new_n1576_), .O(new_n1578_));
  nand2  g1470(.a(new_n1578_), .b(new_n118_), .O(new_n1579_));
  oai21  g1471(.a(new_n1430_), .b(new_n138_), .c(x51), .O(new_n1580_));
  nand2  g1472(.a(new_n655_), .b(x11), .O(new_n1581_));
  aoi21  g1473(.a(new_n1581_), .b(new_n1580_), .c(new_n167_), .O(new_n1582_));
  nand4  g1474(.a(new_n1582_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1583_));
  aoi21  g1475(.a(new_n1583_), .b(new_n1579_), .c(x52), .O(z40));
  nand4  g1476(.a(new_n1544_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1585_));
  nand3  g1477(.a(new_n1483_), .b(new_n432_), .c(new_n161_), .O(new_n1586_));
  aoi21  g1478(.a(new_n1586_), .b(new_n1585_), .c(x50), .O(z41));
  oai22  g1479(.a(new_n1451_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1590_));
  nand4  g1480(.a(new_n1590_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1591_));
  nor2   g1481(.a(new_n1591_), .b(x46), .O(z44));
  nor3   g1482(.a(new_n1529_), .b(new_n126_), .c(new_n109_), .O(z46));
  nand2  g1483(.a(new_n807_), .b(new_n167_), .O(new_n1595_));
  inv1   g1484(.a(new_n1595_), .O(new_n1596_));
  nand4  g1485(.a(new_n1596_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1597_));
  nor2   g1486(.a(new_n1597_), .b(x46), .O(z47));
  nand4  g1487(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1599_));
  nor3   g1488(.a(new_n1599_), .b(x49), .c(x48), .O(new_n1600_));
  nand4  g1489(.a(new_n1600_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1601_));
  nor2   g1490(.a(new_n1601_), .b(x53), .O(z48));
  nand2  g1491(.a(new_n138_), .b(new_n107_), .O(new_n1603_));
  nand4  g1492(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1604_));
  oai21  g1493(.a(new_n1462_), .b(new_n1603_), .c(new_n1604_), .O(new_n1605_));
  nand2  g1494(.a(new_n1605_), .b(new_n115_), .O(new_n1606_));
  nand3  g1495(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1607_));
  inv1   g1496(.a(new_n1607_), .O(new_n1608_));
  nand2  g1497(.a(new_n1608_), .b(new_n1544_), .O(new_n1609_));
  aoi21  g1498(.a(new_n1609_), .b(new_n1606_), .c(x50), .O(new_n1610_));
  nor2   g1499(.a(new_n1607_), .b(new_n1031_), .O(new_n1611_));
  oai21  g1500(.a(new_n1611_), .b(new_n1610_), .c(new_n105_), .O(new_n1612_));
  nand3  g1501(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1613_));
  nand2  g1502(.a(new_n1613_), .b(new_n1612_), .O(z49));
  zero   g1503(.O(z14));
  zero   g1504(.O(z31));
  zero   g1505(.O(z33));
  zero   g1506(.O(z37));
