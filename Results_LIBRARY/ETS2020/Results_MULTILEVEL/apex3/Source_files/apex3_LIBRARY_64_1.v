...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n275_, new_n293_, new_n294_, new_n295_, new_n301_, new_n309_,
  ...
  nand3  g163(.a(new_n274_), .b(new_n109_), .c(new_n119_), .O(new_n301_));
  nor3   g164(.a(new_n301_), .b(new_n110_), .c(new_n117_), .O(z36));
  nor3   g165(.a(new_n301_), .b(x53), .c(x52), .O(z37));
  nor2   g166(.a(new_n295_), .b(new_n110_), .O(z42));
  nand2  g167(.a(new_n294_), .b(new_n117_), .O(new_n309_));
  nor2   g168(.a(new_n309_), .b(new_n110_), .O(z43));
  nand4  g169(.a(x47), .b(new_n227_), .c(new_n205_), .d(x27), .O(new_n314_));
  nor3   g170(.a(new_n314_), .b(x49), .c(x48), .O(new_n315_));
  nand4  g171(.a(new_n315_), .b(new_n117_), .c(x51), .d(new_n119_), .O(new_n316_));
  nor2   g172(.a(new_n316_), .b(x53), .O(z48));
  zero   g173(.O(z00));
  zero   g174(.O(z01));
  zero   g175(.O(z03));
  zero   g176(.O(z04));
  ...
  zero   g212(.O(z47));
  zero   g213(.O(z49));
  nor2   g214(.a(new_n295_), .b(x53), .O(z45));
endmodule
