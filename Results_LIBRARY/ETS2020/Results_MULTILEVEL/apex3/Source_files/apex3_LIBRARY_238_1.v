...
module FAU ( 
  ...
  nor3   g22(.a(new_n159_), .b(new_n152_), .c(new_n120_), .O(z36));
  ...
  nor2   g26(.a(new_n147_), .b(new_n152_), .O(z42));
  nand3  g27(.a(new_n146_), .b(x51), .c(new_n143_), .O(new_n168_));
  nor3   g28(.a(new_n168_), .b(new_n152_), .c(x52), .O(z43));
  ...
  nand4  g32(.a(new_n175_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n176_));
