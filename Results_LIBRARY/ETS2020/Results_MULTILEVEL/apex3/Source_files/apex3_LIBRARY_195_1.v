...
module FAU ( 
  ...
  wire new_n111_, new_n112_, new_n113_, new_n114_, new_n115_, new_n116_,
    ...
    new_n330_, new_n331_, new_n332_, new_n333_, new_n334_, new_n345_,
    new_n346_, new_n347_, new_n353_, new_n361_, new_n366_, new_n367_,
    new_n368_;
  ...
  nor2   g189(.a(new_n164_), .b(x52), .O(new_n300_));
  or2    g190(.a(x11), .b(x10), .O(new_n301_));
  nand2  g191(.a(new_n189_), .b(new_n182_), .O(new_n302_));
  nor2   g192(.a(new_n302_), .b(new_n301_), .O(new_n303_));
  oai21  g193(.a(new_n303_), .b(new_n300_), .c(x50), .O(new_n304_));
  oai21  g194(.a(new_n164_), .b(new_n188_), .c(new_n120_), .O(new_n305_));
  nand2  g195(.a(new_n305_), .b(new_n304_), .O(new_n306_));
  nand3  g196(.a(new_n306_), .b(x49), .c(new_n141_), .O(new_n307_));
  nand2  g197(.a(new_n307_), .b(new_n299_), .O(new_n308_));
  nand3  g198(.a(new_n308_), .b(new_n115_), .c(x46), .O(new_n309_));
  nand2  g199(.a(new_n309_), .b(new_n283_), .O(new_n310_));
  nand2  g200(.a(new_n310_), .b(new_n112_), .O(new_n311_));
  nand2  g201(.a(new_n311_), .b(new_n247_), .O(z06));
  nand4  g202(.a(x49), .b(x48), .c(new_n112_), .d(new_n111_), .O(new_n320_));
  inv1   g203(.a(new_n320_), .O(new_n321_));
  nand4  g204(.a(new_n321_), .b(new_n188_), .c(new_n115_), .d(x50), .O(new_n322_));
  nor2   g205(.a(new_n322_), .b(x53), .O(z14));
  nor2   g206(.a(x48), .b(x47), .O(new_n330_));
  nand4  g207(.a(new_n330_), .b(new_n300_), .c(new_n142_), .d(x46), .O(new_n331_));
  inv1   g208(.a(new_n143_), .O(new_n332_));
  nor2   g209(.a(new_n141_), .b(new_n112_), .O(new_n333_));
  nand4  g210(.a(new_n333_), .b(new_n189_), .c(new_n332_), .d(new_n111_), .O(new_n334_));
  aoi21  g211(.a(new_n334_), .b(new_n331_), .c(new_n115_), .O(z21));
  nand4  g212(.a(x49), .b(new_n141_), .c(new_n112_), .d(new_n111_), .O(new_n345_));
  nor3   g213(.a(new_n345_), .b(new_n115_), .c(x50), .O(new_n346_));
  nand2  g214(.a(new_n346_), .b(x52), .O(new_n347_));
  nor2   g215(.a(new_n347_), .b(x53), .O(z31));
  nand3  g216(.a(new_n321_), .b(new_n115_), .c(new_n120_), .O(new_n353_));
  nor3   g217(.a(new_n353_), .b(new_n164_), .c(new_n188_), .O(z36));
  nor3   g218(.a(new_n353_), .b(x53), .c(x52), .O(z37));
  nor2   g219(.a(new_n347_), .b(new_n164_), .O(z42));
  nand2  g220(.a(new_n346_), .b(new_n188_), .O(new_n361_));
  nor2   g221(.a(new_n361_), .b(new_n164_), .O(z43));
  nand4  g222(.a(x47), .b(new_n111_), .c(new_n146_), .d(x27), .O(new_n366_));
  nor3   g223(.a(new_n366_), .b(x49), .c(x48), .O(new_n367_));
  nand4  g224(.a(new_n367_), .b(new_n188_), .c(x51), .d(new_n120_), .O(new_n368_));
  nor2   g225(.a(new_n368_), .b(x53), .O(z48));
  zero   g226(.O(z00));
  zero   g227(.O(z01));
  zero   g228(.O(z02));
  zero   g229(.O(z03));
  ...
  zero   g264(.O(z47));
  zero   g265(.O(z49));
  nor2   g266(.a(new_n347_), .b(x53), .O(z45));
endmodule
