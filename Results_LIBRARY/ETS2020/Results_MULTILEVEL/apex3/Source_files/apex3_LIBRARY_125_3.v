// Benchmark "FAU" written by ABC on Fri Jul 24 17:31:44 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1593_, new_n1596_, new_n1597_, new_n1600_, new_n1602_, new_n1603_,
    new_n1604_, new_n1606_, new_n1607_, new_n1608_, new_n1610_, new_n1611_,
  ...
  nand3  g1443(.a(new_n1524_), .b(new_n1381_), .c(new_n107_), .O(new_n1549_));
  ...
  nor2   g1447(.a(new_n1532_), .b(x53), .O(z33));
  ...
  oai21  g1457(.a(new_n1485_), .b(new_n1468_), .c(new_n1562_), .O(new_n1563_));
  ...
  nand2  g1464(.a(new_n1401_), .b(new_n167_), .O(new_n1571_));
  ...
  oai21  g1476(.a(new_n1433_), .b(new_n138_), .c(x51), .O(new_n1583_));
  ...
  nand3  g1482(.a(new_n1486_), .b(new_n432_), .c(new_n161_), .O(new_n1589_));
  aoi21  g1483(.a(new_n1589_), .b(new_n1588_), .c(x50), .O(z41));
  nand4  g1484(.a(new_n1395_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1591_));
  inv1   g1485(.a(new_n1591_), .O(new_n1592_));
  nand2  g1486(.a(new_n1592_), .b(x52), .O(new_n1593_));
  nor2   g1487(.a(new_n1593_), .b(new_n126_), .O(z42));
  nor3   g1488(.a(new_n1591_), .b(new_n126_), .c(x52), .O(z43));
  oai22  g1489(.a(new_n1454_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1596_));
  nand4  g1490(.a(new_n1596_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1597_));
  nor2   g1491(.a(new_n1597_), .b(x46), .O(z44));
  nor2   g1492(.a(new_n1593_), .b(x53), .O(z45));
  nand2  g1493(.a(new_n1531_), .b(x52), .O(new_n1600_));
  nor2   g1494(.a(new_n1600_), .b(new_n126_), .O(z46));
  nand2  g1495(.a(new_n807_), .b(new_n167_), .O(new_n1602_));
  inv1   g1496(.a(new_n1602_), .O(new_n1603_));
  nand4  g1497(.a(new_n1603_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1604_));
  nor2   g1498(.a(new_n1604_), .b(x46), .O(z47));
  nand4  g1499(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1606_));
  nor3   g1500(.a(new_n1606_), .b(x49), .c(x48), .O(new_n1607_));
  nand4  g1501(.a(new_n1607_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1608_));
  nor2   g1502(.a(new_n1608_), .b(x53), .O(z48));
  nand2  g1503(.a(new_n138_), .b(new_n107_), .O(new_n1610_));
  nand4  g1504(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1611_));
  oai21  g1505(.a(new_n1465_), .b(new_n1610_), .c(new_n1611_), .O(new_n1612_));
  nand2  g1506(.a(new_n1612_), .b(new_n115_), .O(new_n1613_));
  nand3  g1507(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1614_));
  inv1   g1508(.a(new_n1614_), .O(new_n1615_));
  nand2  g1509(.a(new_n1615_), .b(new_n1547_), .O(new_n1616_));
  aoi21  g1510(.a(new_n1616_), .b(new_n1613_), .c(x50), .O(new_n1617_));
  nor2   g1511(.a(new_n1614_), .b(new_n1031_), .O(new_n1618_));
  oai21  g1512(.a(new_n1618_), .b(new_n1617_), .c(new_n105_), .O(new_n1619_));
  nand3  g1513(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1620_));
  nand2  g1514(.a(new_n1620_), .b(new_n1619_), .O(z49));
  zero   g1515(.O(z31));
  zero   g1516(.O(z36));
endmodule
