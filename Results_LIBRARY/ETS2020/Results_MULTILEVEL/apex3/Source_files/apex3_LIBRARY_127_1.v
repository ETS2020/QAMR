...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    new_n125_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
  ...
  inv1   g08(.a(x50), .O(new_n132_));
  xor2a  g09(.a(x53), .b(x52), .O(new_n133_));
  nand4  g10(.a(new_n133_), .b(x51), .c(new_n132_), .d(x49), .O(new_n134_));
  inv1   g11(.a(new_n134_), .O(new_n135_));
  nand4  g12(.a(new_n135_), .b(x48), .c(new_n122_), .d(new_n121_), .O(new_n136_));
  inv1   g13(.a(new_n136_), .O(z20));
  ...
  nand4  g17(.a(new_n150_), .b(x52), .c(x51), .d(new_n132_), .O(new_n151_));
  nor2   g18(.a(new_n151_), .b(x53), .O(z31));
  inv1   g19(.a(x53), .O(new_n157_));
  nand3  g20(.a(new_n124_), .b(new_n119_), .c(new_n132_), .O(new_n158_));
  ...
  nand3  g24(.a(new_n150_), .b(x51), .c(new_n132_), .O(new_n166_));
  ...
  nand4  g29(.a(new_n173_), .b(new_n120_), .c(x51), .d(new_n132_), .O(new_n174_));
