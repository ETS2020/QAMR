...
module FAU ( 
  ...
  nand3  g1464(.a(new_n1401_), .b(new_n118_), .c(new_n167_), .O(new_n1570_));
  ...
  nor3   g1485(.a(new_n1543_), .b(new_n126_), .c(x52), .O(z43));
  oai22  g1486(.a(new_n1454_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1593_));
  nand4  g1487(.a(new_n1593_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1594_));
  nor2   g1488(.a(new_n1594_), .b(x46), .O(z44));
  nand2  g1489(.a(new_n1528_), .b(x52), .O(new_n1596_));
  nor2   g1490(.a(new_n1596_), .b(new_n126_), .O(z46));
  nand2  g1491(.a(new_n807_), .b(new_n167_), .O(new_n1598_));
  inv1   g1492(.a(new_n1598_), .O(new_n1599_));
  nand4  g1493(.a(new_n1599_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1600_));
  nor2   g1494(.a(new_n1600_), .b(x46), .O(z47));
  ...
  nand2  g1501(.a(new_n1608_), .b(new_n1547_), .O(new_n1609_));
  ...
  zero   g1508(.O(z38));
  zero   g1509(.O(z48));
  nor2   g1510(.a(new_n1545_), .b(x53), .O(z45));
endmodule
