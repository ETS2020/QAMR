...
module FAU ( 
  ...
  wire new_n107_, new_n108_, new_n109_, new_n110_, new_n111_, new_n112_,
    ...
    new_n275_, new_n289_, new_n290_, new_n291_, new_n296_, new_n297_,
    new_n298_, new_n304_, new_n312_, new_n317_, new_n318_, new_n319_;
  ...
  nand4  g159(.a(new_n113_), .b(x48), .c(new_n149_), .d(new_n227_), .O(new_n289_));
  inv1   g160(.a(new_n289_), .O(new_n290_));
  nand4  g161(.a(new_n290_), .b(new_n117_), .c(new_n109_), .d(new_n119_), .O(new_n291_));
  nor2   g162(.a(new_n291_), .b(new_n110_), .O(z27));
  nand4  g163(.a(x49), .b(new_n228_), .c(new_n149_), .d(new_n227_), .O(new_n296_));
  nor3   g164(.a(new_n296_), .b(new_n109_), .c(x50), .O(new_n297_));
  nand2  g165(.a(new_n297_), .b(x52), .O(new_n298_));
  nor2   g166(.a(new_n298_), .b(x53), .O(z31));
  nand3  g167(.a(new_n274_), .b(new_n109_), .c(new_n119_), .O(new_n304_));
  nor3   g168(.a(new_n304_), .b(new_n110_), .c(new_n117_), .O(z36));
  nor3   g169(.a(new_n304_), .b(x53), .c(x52), .O(z37));
  nor2   g170(.a(new_n298_), .b(new_n110_), .O(z42));
  nand2  g171(.a(new_n297_), .b(new_n117_), .O(new_n312_));
  nor2   g172(.a(new_n312_), .b(new_n110_), .O(z43));
  nand4  g173(.a(x47), .b(new_n227_), .c(new_n205_), .d(x27), .O(new_n317_));
  nor3   g174(.a(new_n317_), .b(x49), .c(x48), .O(new_n318_));
  nand4  g175(.a(new_n318_), .b(new_n117_), .c(x51), .d(new_n119_), .O(new_n319_));
  nor2   g176(.a(new_n319_), .b(x53), .O(z48));
  zero   g177(.O(z00));
  zero   g178(.O(z01));
  zero   g179(.O(z03));
  zero   g180(.O(z04));
  ...
  zero   g215(.O(z47));
  zero   g216(.O(z49));
  nor2   g217(.a(new_n298_), .b(x53), .O(z45));
endmodule
