// Benchmark "FAU" written by ABC on Fri Jul 24 17:32:55 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n159_, new_n162_, new_n168_, new_n173_, new_n174_, new_n175_,
    new_n176_;
  ...
  nor2   g20(.a(new_n123_), .b(x50), .O(new_n158_));
  nand2  g21(.a(new_n158_), .b(new_n119_), .O(new_n159_));
  nor3   g22(.a(new_n159_), .b(new_n139_), .c(new_n120_), .O(z36));
  nor3   g23(.a(new_n159_), .b(x53), .c(x52), .O(z37));
  nand3  g24(.a(new_n158_), .b(new_n120_), .c(x51), .O(new_n162_));
  nor2   g25(.a(new_n162_), .b(x53), .O(z38));
  nor2   g26(.a(new_n152_), .b(new_n139_), .O(z42));
  nand3  g27(.a(new_n151_), .b(x51), .c(new_n140_), .O(new_n168_));
  nor3   g28(.a(new_n168_), .b(new_n139_), .c(x52), .O(z43));
  inv1   g29(.a(x43), .O(new_n173_));
  nand4  g30(.a(x47), .b(new_n121_), .c(new_n173_), .d(x27), .O(new_n174_));
  nor3   g31(.a(new_n174_), .b(x49), .c(x48), .O(new_n175_));
  nand4  g32(.a(new_n175_), .b(new_n120_), .c(x51), .d(new_n140_), .O(new_n176_));
  nor2   g33(.a(new_n176_), .b(x53), .O(z48));
  zero   g34(.O(z00));
  zero   g35(.O(z01));
  zero   g36(.O(z02));
  zero   g37(.O(z03));
  ...
  zero   g72(.O(z47));
  zero   g73(.O(z49));
  nor2   g74(.a(new_n152_), .b(x53), .O(z45));
endmodule
