...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1591_, new_n1593_, new_n1594_, new_n1598_, new_n1599_, new_n1602_,
    new_n1603_, new_n1604_, new_n1607_, new_n1608_, new_n1609_, new_n1610_,
  ...
  nand2  g1496(.a(new_n807_), .b(new_n167_), .O(new_n1602_));
  inv1   g1497(.a(new_n1602_), .O(new_n1603_));
  nand4  g1498(.a(new_n1603_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1604_));
  nor2   g1499(.a(new_n1604_), .b(x46), .O(z47));
  nand2  g1500(.a(new_n138_), .b(new_n107_), .O(new_n1607_));
  nand4  g1501(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1608_));
  oai21  g1502(.a(new_n1465_), .b(new_n1607_), .c(new_n1608_), .O(new_n1609_));
  ...
  nand2  g1506(.a(new_n1612_), .b(new_n1550_), .O(new_n1613_));
  ...
  zero   g1512(.O(z46));
  zero   g1513(.O(z48));
  nor2   g1514(.a(new_n1548_), .b(x53), .O(z45));
endmodule
