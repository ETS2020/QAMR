// Benchmark "FAU" written by ABC on Fri Jul 24 17:32:43 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1539_, new_n1540_, new_n1541_, new_n1542_, new_n1543_, new_n1546_,
  ...
  inv1   g1440(.a(new_n647_), .O(new_n1546_));
  nand3  g1441(.a(new_n1546_), .b(new_n1356_), .c(x46), .O(new_n1547_));
  nand3  g1442(.a(new_n1523_), .b(new_n1381_), .c(new_n107_), .O(new_n1548_));
  ...
  nor2   g1446(.a(new_n1531_), .b(x53), .O(z33));
  ...
  oai21  g1456(.a(new_n1484_), .b(new_n1467_), .c(new_n1561_), .O(new_n1562_));
  ...
  nand2  g1463(.a(new_n1400_), .b(new_n167_), .O(new_n1569_));
  nor4   g1464(.a(new_n1569_), .b(new_n126_), .c(new_n109_), .d(x51), .O(z36));
  nor4   g1465(.a(new_n1569_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  ...
  oai21  g1475(.a(new_n1432_), .b(new_n138_), .c(x51), .O(new_n1582_));
  ...
  nand3  g1481(.a(new_n1485_), .b(new_n432_), .c(new_n161_), .O(new_n1588_));
  aoi21  g1482(.a(new_n1588_), .b(new_n1587_), .c(x50), .O(z41));
  oai22  g1483(.a(new_n1453_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1592_));
  nand4  g1484(.a(new_n1592_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1593_));
  nor2   g1485(.a(new_n1593_), .b(x46), .O(z44));
  nand2  g1486(.a(new_n1530_), .b(x52), .O(new_n1596_));
  nor2   g1487(.a(new_n1596_), .b(new_n126_), .O(z46));
  nand2  g1488(.a(new_n807_), .b(new_n167_), .O(new_n1598_));
  inv1   g1489(.a(new_n1598_), .O(new_n1599_));
  nand4  g1490(.a(new_n1599_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1600_));
  nor2   g1491(.a(new_n1600_), .b(x46), .O(z47));
  nand4  g1492(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1602_));
  nor3   g1493(.a(new_n1602_), .b(x49), .c(x48), .O(new_n1603_));
  nand4  g1494(.a(new_n1603_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1604_));
  nor2   g1495(.a(new_n1604_), .b(x53), .O(z48));
  nand2  g1496(.a(new_n138_), .b(new_n107_), .O(new_n1606_));
  nand4  g1497(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1607_));
  oai21  g1498(.a(new_n1464_), .b(new_n1606_), .c(new_n1607_), .O(new_n1608_));
  nand2  g1499(.a(new_n1608_), .b(new_n115_), .O(new_n1609_));
  nand3  g1500(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1610_));
  inv1   g1501(.a(new_n1610_), .O(new_n1611_));
  nand2  g1502(.a(new_n1611_), .b(new_n1546_), .O(new_n1612_));
  aoi21  g1503(.a(new_n1612_), .b(new_n1609_), .c(x50), .O(new_n1613_));
  nor2   g1504(.a(new_n1610_), .b(new_n1031_), .O(new_n1614_));
  oai21  g1505(.a(new_n1614_), .b(new_n1613_), .c(new_n105_), .O(new_n1615_));
  nand3  g1506(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1616_));
  nand2  g1507(.a(new_n1616_), .b(new_n1615_), .O(z49));
  zero   g1508(.O(z31));
  zero   g1509(.O(z37));
  zero   g1510(.O(z42));
  zero   g1511(.O(z43));
