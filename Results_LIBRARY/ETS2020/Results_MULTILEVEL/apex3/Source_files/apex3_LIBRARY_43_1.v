// Benchmark "FAU" written by ABC on Fri Jul 24 17:29:24 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n286_, new_n292_, new_n293_, new_n296_, new_n302_, new_n307_,
  ...
  nor2   g154(.a(new_n264_), .b(x50), .O(new_n292_));
  nand2  g155(.a(new_n292_), .b(new_n106_), .O(new_n293_));
  nor3   g156(.a(new_n293_), .b(new_n124_), .c(new_n110_), .O(z36));
  nor3   g157(.a(new_n293_), .b(x53), .c(x52), .O(z37));
  nand3  g158(.a(new_n292_), .b(new_n110_), .c(x51), .O(new_n296_));
  nor2   g159(.a(new_n296_), .b(x53), .O(z38));
  nor2   g160(.a(new_n286_), .b(new_n124_), .O(z42));
  nand2  g161(.a(new_n285_), .b(new_n110_), .O(new_n302_));
  nor2   g162(.a(new_n302_), .b(new_n124_), .O(z43));
  inv1   g163(.a(x43), .O(new_n307_));
  nand4  g164(.a(x47), .b(new_n107_), .c(new_n307_), .d(x27), .O(new_n308_));
  nor3   g165(.a(new_n308_), .b(x49), .c(x48), .O(new_n309_));
  nand4  g166(.a(new_n309_), .b(new_n110_), .c(x51), .d(new_n158_), .O(new_n310_));
  nor2   g167(.a(new_n310_), .b(x53), .O(z48));
  zero   g168(.O(z01));
  zero   g169(.O(z02));
  zero   g170(.O(z03));
  zero   g171(.O(z04));
  ...
  zero   g206(.O(z47));
  zero   g207(.O(z49));
  nor2   g208(.a(new_n286_), .b(x53), .O(z45));
endmodule
