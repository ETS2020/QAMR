...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n151_, new_n152_, new_n158_, new_n159_, new_n160_, new_n165_,
    new_n166_, new_n167_, new_n173_, new_n183_, new_n184_, new_n185_,
  ...
  nand4  g28(.a(new_n138_), .b(x48), .c(new_n122_), .d(new_n121_), .O(new_n158_));
  inv1   g29(.a(new_n158_), .O(new_n159_));
  nand4  g30(.a(new_n159_), .b(new_n120_), .c(new_n119_), .d(new_n136_), .O(new_n160_));
  nor2   g31(.a(new_n160_), .b(new_n135_), .O(z27));
  nor3   g32(.a(x48), .b(x47), .c(x46), .O(new_n165_));
  nand4  g33(.a(new_n165_), .b(x51), .c(new_n136_), .d(x49), .O(new_n166_));
  or2    g34(.a(new_n166_), .b(new_n120_), .O(new_n167_));
  nor2   g35(.a(new_n167_), .b(x53), .O(z31));
  nand3  g36(.a(new_n124_), .b(new_n119_), .c(new_n136_), .O(new_n173_));
  nor3   g37(.a(new_n173_), .b(new_n135_), .c(new_n120_), .O(z36));
  nor3   g38(.a(new_n173_), .b(x53), .c(x52), .O(z37));
  nor2   g39(.a(new_n167_), .b(new_n135_), .O(z42));
  nor3   g40(.a(new_n166_), .b(new_n135_), .c(x52), .O(z43));
  nand4  g41(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n183_));
  inv1   g42(.a(new_n183_), .O(new_n184_));
  nand4  g43(.a(new_n184_), .b(x52), .c(x51), .d(x50), .O(new_n185_));
  nor2   g44(.a(new_n185_), .b(new_n135_), .O(z46));
  inv1   g45(.a(x43), .O(new_n188_));
  nand4  g46(.a(x47), .b(new_n121_), .c(new_n188_), .d(x27), .O(new_n189_));
  nor3   g47(.a(new_n189_), .b(x49), .c(x48), .O(new_n190_));
  nand4  g48(.a(new_n190_), .b(new_n120_), .c(x51), .d(new_n136_), .O(new_n191_));
  nor2   g49(.a(new_n191_), .b(x53), .O(z48));
  zero   g50(.O(z00));
  zero   g51(.O(z01));
  zero   g52(.O(z02));
  zero   g53(.O(z03));
  ...
  zero   g87(.O(z47));
  zero   g88(.O(z49));
  nor2   g89(.a(new_n167_), .b(x53), .O(z45));
endmodule
