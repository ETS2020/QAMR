...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n151_, new_n152_, new_n162_, new_n163_, new_n164_, new_n167_,
    new_n168_, new_n169_, new_n173_, new_n185_, new_n186_, new_n187_,
    new_n188_;
  ...
  nand4  g32(.a(x49), .b(x48), .c(x47), .d(new_n121_), .O(new_n167_));
  inv1   g33(.a(new_n167_), .O(new_n168_));
  nand4  g34(.a(new_n168_), .b(new_n120_), .c(x51), .d(x50), .O(new_n169_));
  nor2   g35(.a(new_n169_), .b(x53), .O(z33));
  ...
  nor2   g39(.a(new_n164_), .b(new_n135_), .O(z42));
  nor3   g40(.a(new_n163_), .b(new_n135_), .c(x52), .O(z43));
  inv1   g41(.a(x43), .O(new_n185_));
  nand4  g42(.a(x47), .b(new_n121_), .c(new_n185_), .d(x27), .O(new_n186_));
  nor3   g43(.a(new_n186_), .b(x49), .c(x48), .O(new_n187_));
  nand4  g44(.a(new_n187_), .b(new_n120_), .c(x51), .d(new_n136_), .O(new_n188_));
  nor2   g45(.a(new_n188_), .b(x53), .O(z48));
  zero   g46(.O(z00));
  zero   g47(.O(z01));
  zero   g48(.O(z02));
  zero   g49(.O(z03));
  ...
  zero   g84(.O(z47));
  zero   g85(.O(z49));
  nor2   g86(.a(new_n164_), .b(x53), .O(z45));
endmodule
