// Benchmark "FAU" written by ABC on Fri Jul 24 17:31:10 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1503_, new_n1506_, new_n1507_, new_n1508_, new_n1510_, new_n1511_,
    ...
    new_n1539_, new_n1542_, new_n1543_, new_n1544_, new_n1545_, new_n1546_,
    new_n1549_, new_n1550_, new_n1551_, new_n1552_, new_n1554_, new_n1555_,
    new_n1556_, new_n1557_, new_n1558_, new_n1559_, new_n1560_, new_n1561_,
    new_n1562_, new_n1563_, new_n1565_, new_n1569_, new_n1570_, new_n1571_,
    new_n1573_, new_n1574_, new_n1575_, new_n1576_, new_n1577_, new_n1578_,
    new_n1579_, new_n1580_, new_n1581_, new_n1583_, new_n1584_, new_n1588_,
    new_n1589_, new_n1592_, new_n1594_, new_n1595_, new_n1596_, new_n1598_,
  ...
  nand4  g1399(.a(x53), .b(x50), .c(new_n138_), .d(x47), .O(new_n1506_));
  oai22  g1400(.a(new_n1506_), .b(x46), .c(new_n1482_), .d(new_n1071_), .O(new_n1507_));
  nand3  g1401(.a(new_n1507_), .b(x52), .c(new_n118_), .O(new_n1508_));
  inv1   g1402(.a(new_n1508_), .O(z26));
  nand3  g1403(.a(new_n1395_), .b(new_n138_), .c(x48), .O(new_n1510_));
  inv1   g1404(.a(new_n1510_), .O(new_n1511_));
  nand4  g1405(.a(new_n1511_), .b(new_n109_), .c(new_n118_), .d(new_n167_), .O(new_n1512_));
  nor2   g1406(.a(new_n1512_), .b(new_n126_), .O(z27));
  nand3  g1407(.a(new_n126_), .b(new_n167_), .c(new_n105_), .O(new_n1514_));
  aoi21  g1408(.a(new_n1514_), .b(new_n1491_), .c(new_n109_), .O(new_n1515_));
  nand2  g1409(.a(new_n1359_), .b(new_n199_), .O(new_n1516_));
  inv1   g1410(.a(new_n1516_), .O(new_n1517_));
  oai21  g1411(.a(new_n1517_), .b(new_n1515_), .c(x51), .O(new_n1518_));
  nor2   g1412(.a(new_n507_), .b(x51), .O(new_n1519_));
  nand2  g1413(.a(new_n1519_), .b(new_n1359_), .O(new_n1520_));
  aoi21  g1414(.a(new_n1520_), .b(new_n1518_), .c(new_n138_), .O(new_n1521_));
  nor3   g1415(.a(new_n647_), .b(new_n289_), .c(x48), .O(new_n1522_));
  oai21  g1416(.a(new_n1522_), .b(new_n1521_), .c(x47), .O(new_n1523_));
  nor2   g1417(.a(new_n1523_), .b(x46), .O(z28));
  nand3  g1418(.a(new_n122_), .b(x49), .c(x48), .O(new_n1525_));
  nor3   g1419(.a(new_n1525_), .b(new_n118_), .c(new_n167_), .O(new_n1526_));
  nand2  g1420(.a(new_n1526_), .b(new_n109_), .O(new_n1527_));
  nor2   g1421(.a(new_n1527_), .b(new_n126_), .O(z29));
  inv1   g1422(.a(new_n1166_), .O(new_n1529_));
  nand3  g1423(.a(new_n1529_), .b(x50), .c(new_n138_), .O(new_n1530_));
  oai21  g1424(.a(new_n286_), .b(new_n138_), .c(new_n1530_), .O(new_n1531_));
  nand2  g1425(.a(new_n1531_), .b(new_n107_), .O(new_n1532_));
  oai21  g1426(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1533_));
  nand3  g1427(.a(new_n1533_), .b(x49), .c(x46), .O(new_n1534_));
  aoi21  g1428(.a(new_n1534_), .b(new_n1532_), .c(x51), .O(new_n1535_));
  nand4  g1429(.a(new_n174_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1536_));
  nor2   g1430(.a(new_n1536_), .b(new_n107_), .O(new_n1537_));
  oai21  g1431(.a(new_n1537_), .b(new_n1535_), .c(new_n105_), .O(new_n1538_));
  nand4  g1432(.a(new_n283_), .b(new_n272_), .c(new_n156_), .d(x46), .O(new_n1539_));
  aoi21  g1433(.a(new_n1539_), .b(new_n1538_), .c(x47), .O(z30));
  inv1   g1434(.a(new_n647_), .O(new_n1542_));
  nand3  g1435(.a(new_n1542_), .b(new_n1356_), .c(x46), .O(new_n1543_));
  nand3  g1436(.a(new_n1519_), .b(new_n1381_), .c(new_n107_), .O(new_n1544_));
  nand2  g1437(.a(new_n1544_), .b(new_n1543_), .O(new_n1545_));
  nand3  g1438(.a(new_n1545_), .b(x49), .c(new_n115_), .O(new_n1546_));
  inv1   g1439(.a(new_n1546_), .O(z32));
  nor2   g1440(.a(new_n1527_), .b(x53), .O(z33));
  oai21  g1441(.a(x53), .b(x48), .c(new_n109_), .O(new_n1549_));
  nand2  g1442(.a(new_n156_), .b(new_n105_), .O(new_n1550_));
  aoi21  g1443(.a(new_n1550_), .b(new_n1549_), .c(x51), .O(new_n1551_));
  nand4  g1444(.a(new_n1551_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1552_));
  nor2   g1445(.a(new_n1552_), .b(x46), .O(z34));
  nand3  g1446(.a(x52), .b(x48), .c(new_n115_), .O(new_n1554_));
  nand3  g1447(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1555_));
  aoi21  g1448(.a(new_n1555_), .b(new_n1554_), .c(new_n126_), .O(new_n1556_));
  nand4  g1449(.a(new_n1556_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1557_));
  oai21  g1450(.a(new_n1482_), .b(new_n1465_), .c(new_n1557_), .O(new_n1558_));
  nand2  g1451(.a(new_n1558_), .b(x49), .O(new_n1559_));
  nand2  g1452(.a(new_n420_), .b(new_n132_), .O(new_n1560_));
  nand4  g1453(.a(new_n1560_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1561_));
  inv1   g1454(.a(new_n1561_), .O(new_n1562_));
  nand3  g1455(.a(new_n1562_), .b(new_n115_), .c(new_n107_), .O(new_n1563_));
  nand2  g1456(.a(new_n1563_), .b(new_n1559_), .O(z35));
  nand4  g1457(.a(new_n1395_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1565_));
  nor4   g1458(.a(new_n1565_), .b(new_n126_), .c(new_n109_), .d(x51), .O(z36));
  nor4   g1459(.a(new_n1565_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  nand2  g1460(.a(new_n1030_), .b(new_n172_), .O(new_n1569_));
  aoi21  g1461(.a(new_n1569_), .b(new_n271_), .c(new_n126_), .O(new_n1570_));
  nand4  g1462(.a(new_n1570_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1571_));
  nor3   g1463(.a(new_n1571_), .b(x47), .c(x46), .O(z39));
  aoi21  g1464(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1573_));
  nand4  g1465(.a(new_n1573_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1574_));
  nand4  g1466(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1575_));
  nand2  g1467(.a(new_n1575_), .b(new_n1574_), .O(new_n1576_));
  nand2  g1468(.a(new_n1576_), .b(new_n118_), .O(new_n1577_));
  oai21  g1469(.a(new_n1430_), .b(new_n138_), .c(x51), .O(new_n1578_));
  nand2  g1470(.a(new_n655_), .b(x11), .O(new_n1579_));
  aoi21  g1471(.a(new_n1579_), .b(new_n1578_), .c(new_n167_), .O(new_n1580_));
  nand4  g1472(.a(new_n1580_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1581_));
  aoi21  g1473(.a(new_n1581_), .b(new_n1577_), .c(x52), .O(z40));
  nand4  g1474(.a(new_n1542_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1583_));
  nand3  g1475(.a(new_n1483_), .b(new_n432_), .c(new_n161_), .O(new_n1584_));
  aoi21  g1476(.a(new_n1584_), .b(new_n1583_), .c(x50), .O(z41));
  oai22  g1477(.a(new_n1451_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1588_));
  nand4  g1478(.a(new_n1588_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1589_));
  nor2   g1479(.a(new_n1589_), .b(x46), .O(z44));
  nand2  g1480(.a(new_n1526_), .b(x52), .O(new_n1592_));
  ...
  nand2  g1496(.a(new_n1607_), .b(new_n1542_), .O(new_n1608_));
