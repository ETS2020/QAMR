...
module FAU ( 
  ...
  nor2   g17(.a(new_n147_), .b(new_n153_), .O(z42));
  nand3  g18(.a(new_n146_), .b(x51), .c(new_n143_), .O(new_n162_));
  nor3   g19(.a(new_n162_), .b(new_n153_), .c(x52), .O(z43));
  inv1   g20(.a(x43), .O(new_n167_));
  nand4  g21(.a(x47), .b(new_n121_), .c(new_n167_), .d(x27), .O(new_n168_));
  nor3   g22(.a(new_n168_), .b(x49), .c(x48), .O(new_n169_));
  nand4  g23(.a(new_n169_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n170_));
  nor2   g24(.a(new_n170_), .b(x53), .O(z48));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  zero   g27(.O(z02));
  zero   g28(.O(z03));
