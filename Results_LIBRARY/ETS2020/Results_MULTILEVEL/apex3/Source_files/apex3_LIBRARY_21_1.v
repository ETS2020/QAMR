// Benchmark "FAU" written by ABC on Fri Jul 24 17:28:48 2020
...
module FAU ( 
  ...
  nand4  g35(.a(new_n124_), .b(new_n120_), .c(x51), .d(new_n136_), .O(new_n173_));
  nor2   g36(.a(new_n173_), .b(x53), .O(z38));
  nor2   g37(.a(new_n164_), .b(new_n135_), .O(z42));
  nor3   g38(.a(new_n163_), .b(new_n135_), .c(x52), .O(z43));
  ...
  nand4  g42(.a(new_n185_), .b(new_n120_), .c(x51), .d(new_n136_), .O(new_n186_));
