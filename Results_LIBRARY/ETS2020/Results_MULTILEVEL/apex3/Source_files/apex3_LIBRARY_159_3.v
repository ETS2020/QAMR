// Benchmark "FAU" written by ABC on Fri Jul 24 17:32:42 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1396_, new_n1397_, new_n1398_, new_n1401_, new_n1402_, new_n1403_,
    ...
    new_n1568_, new_n1571_, new_n1574_, new_n1575_, new_n1576_, new_n1578_,
    new_n1579_, new_n1580_, new_n1581_, new_n1582_, new_n1583_, new_n1584_,
    new_n1585_, new_n1586_, new_n1588_, new_n1589_, new_n1592_, new_n1594_,
  ...
  nor2   g1290(.a(x47), .b(x46), .O(new_n1395_));
  nand3  g1291(.a(new_n1395_), .b(new_n138_), .c(new_n105_), .O(new_n1396_));
  ...
  oai21  g1295(.a(new_n284_), .b(new_n133_), .c(new_n652_), .O(new_n1401_));
  nand2  g1296(.a(new_n1401_), .b(x47), .O(new_n1402_));
  oai21  g1297(.a(new_n507_), .b(x51), .c(new_n647_), .O(new_n1403_));
  nand4  g1298(.a(new_n1403_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1404_));
  aoi21  g1299(.a(new_n1404_), .b(new_n1402_), .c(x46), .O(new_n1405_));
  nand4  g1300(.a(new_n129_), .b(x53), .c(new_n138_), .d(x48), .O(new_n1406_));
  nor3   g1301(.a(new_n1406_), .b(x47), .c(new_n107_), .O(new_n1407_));
  oai21  g1302(.a(new_n1407_), .b(new_n1405_), .c(new_n167_), .O(new_n1408_));
  nand2  g1303(.a(new_n776_), .b(new_n775_), .O(new_n1409_));
  nand2  g1304(.a(new_n1409_), .b(x51), .O(new_n1410_));
  aoi21  g1305(.a(x48), .b(new_n228_), .c(x53), .O(new_n1411_));
  nand4  g1306(.a(new_n1411_), .b(new_n118_), .c(new_n138_), .d(x46), .O(new_n1412_));
  aoi21  g1307(.a(new_n1412_), .b(new_n1410_), .c(new_n109_), .O(new_n1413_));
  oai21  g1308(.a(x53), .b(x04), .c(x52), .O(new_n1414_));
  nand4  g1309(.a(new_n1414_), .b(new_n118_), .c(new_n138_), .d(x48), .O(new_n1415_));
  nor2   g1310(.a(new_n1415_), .b(new_n107_), .O(new_n1416_));
  oai21  g1311(.a(new_n1416_), .b(new_n1413_), .c(new_n115_), .O(new_n1417_));
  nand3  g1312(.a(new_n283_), .b(new_n604_), .c(new_n107_), .O(new_n1418_));
  nand2  g1313(.a(new_n1418_), .b(new_n1417_), .O(new_n1419_));
  nand2  g1314(.a(new_n1419_), .b(x50), .O(new_n1420_));
  nand2  g1315(.a(new_n1420_), .b(new_n1408_), .O(z15));
  nand2  g1316(.a(new_n257_), .b(x50), .O(new_n1422_));
  nand2  g1317(.a(new_n441_), .b(new_n167_), .O(new_n1423_));
  aoi21  g1318(.a(new_n1423_), .b(new_n1422_), .c(new_n107_), .O(new_n1424_));
  nand2  g1319(.a(new_n257_), .b(new_n243_), .O(new_n1425_));
  inv1   g1320(.a(new_n1425_), .O(new_n1426_));
  oai21  g1321(.a(new_n1426_), .b(new_n1424_), .c(new_n115_), .O(new_n1427_));
  nand2  g1322(.a(new_n399_), .b(new_n122_), .O(new_n1428_));
  aoi21  g1323(.a(new_n1428_), .b(new_n1427_), .c(new_n109_), .O(new_n1429_));
  nand2  g1324(.a(new_n126_), .b(x11), .O(new_n1430_));
  nand2  g1325(.a(new_n1430_), .b(x51), .O(new_n1431_));
  oai21  g1326(.a(new_n118_), .b(x11), .c(new_n126_), .O(new_n1432_));
  aoi21  g1327(.a(new_n1432_), .b(new_n1431_), .c(x52), .O(new_n1433_));
  nand4  g1328(.a(new_n1433_), .b(x50), .c(x49), .d(x47), .O(new_n1434_));
  nor2   g1329(.a(new_n1434_), .b(x46), .O(new_n1435_));
  aoi21  g1330(.a(new_n1429_), .b(new_n138_), .c(new_n1435_), .O(new_n1436_));
  inv1   g1331(.a(new_n308_), .O(new_n1437_));
  nand4  g1332(.a(new_n1030_), .b(new_n1437_), .c(new_n156_), .d(new_n122_), .O(new_n1438_));
  oai21  g1333(.a(new_n1436_), .b(x48), .c(new_n1438_), .O(z16));
  inv1   g1334(.a(new_n972_), .O(new_n1440_));
  nand2  g1335(.a(new_n1440_), .b(new_n1064_), .O(new_n1441_));
  nand4  g1336(.a(new_n1441_), .b(x51), .c(new_n105_), .d(new_n107_), .O(new_n1442_));
  oai21  g1337(.a(new_n811_), .b(new_n427_), .c(new_n1442_), .O(new_n1443_));
  nand4  g1338(.a(new_n1443_), .b(x52), .c(new_n138_), .d(new_n115_), .O(new_n1444_));
  inv1   g1339(.a(new_n1444_), .O(z17));
  nand3  g1340(.a(new_n872_), .b(new_n126_), .c(x48), .O(new_n1446_));
  oai21  g1341(.a(new_n295_), .b(new_n186_), .c(new_n1446_), .O(new_n1447_));
  nand3  g1342(.a(new_n1447_), .b(x51), .c(new_n138_), .O(new_n1448_));
  oai21  g1343(.a(new_n395_), .b(new_n313_), .c(new_n1448_), .O(new_n1449_));
  nand3  g1344(.a(new_n1449_), .b(new_n115_), .c(x46), .O(new_n1450_));
  nor2   g1345(.a(new_n324_), .b(new_n110_), .O(new_n1451_));
  nand3  g1346(.a(new_n123_), .b(x48), .c(x23), .O(new_n1452_));
  oai21  g1347(.a(new_n1451_), .b(x48), .c(new_n1452_), .O(new_n1453_));
  nand4  g1348(.a(new_n1453_), .b(new_n126_), .c(x50), .d(new_n138_), .O(new_n1454_));
  inv1   g1349(.a(new_n1454_), .O(new_n1455_));
  nand3  g1350(.a(new_n1455_), .b(x47), .c(new_n107_), .O(new_n1456_));
  nand2  g1351(.a(new_n1456_), .b(new_n1450_), .O(z18));
  nand2  g1352(.a(new_n237_), .b(new_n236_), .O(new_n1458_));
  nand3  g1353(.a(new_n1458_), .b(x53), .c(x48), .O(new_n1459_));
  oai21  g1354(.a(new_n295_), .b(new_n162_), .c(new_n1459_), .O(new_n1460_));
  nand2  g1355(.a(new_n1460_), .b(x47), .O(new_n1461_));
  nand2  g1356(.a(new_n199_), .b(x51), .O(new_n1462_));
  nand2  g1357(.a(new_n1462_), .b(new_n629_), .O(new_n1463_));
  nand2  g1358(.a(new_n1463_), .b(x50), .O(new_n1464_));
  nand2  g1359(.a(new_n272_), .b(new_n156_), .O(new_n1465_));
  nand2  g1360(.a(new_n1465_), .b(new_n1464_), .O(new_n1466_));
  nand3  g1361(.a(new_n1466_), .b(new_n105_), .c(new_n115_), .O(new_n1467_));
  aoi21  g1362(.a(new_n1467_), .b(new_n1461_), .c(x49), .O(new_n1468_));
  nor4   g1363(.a(new_n585_), .b(new_n364_), .c(new_n179_), .d(x47), .O(new_n1469_));
  oai21  g1364(.a(new_n1469_), .b(new_n1468_), .c(new_n107_), .O(new_n1470_));
  nand3  g1365(.a(new_n786_), .b(new_n785_), .c(new_n117_), .O(new_n1471_));
  nand4  g1366(.a(new_n1471_), .b(x52), .c(new_n118_), .d(x50), .O(new_n1472_));
  oai21  g1367(.a(new_n133_), .b(x50), .c(new_n1472_), .O(new_n1473_));
  nand4  g1368(.a(new_n1473_), .b(new_n126_), .c(x49), .d(new_n105_), .O(new_n1474_));
  inv1   g1369(.a(new_n1474_), .O(new_n1475_));
  nand3  g1370(.a(new_n1475_), .b(new_n115_), .c(x46), .O(new_n1476_));
  nand2  g1371(.a(new_n1476_), .b(new_n1470_), .O(z19));
  nand4  g1372(.a(new_n180_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1478_));
  inv1   g1373(.a(new_n1478_), .O(new_n1479_));
  nand4  g1374(.a(new_n1479_), .b(x48), .c(new_n115_), .d(new_n107_), .O(new_n1480_));
  inv1   g1375(.a(new_n1480_), .O(z20));
  nand2  g1376(.a(new_n730_), .b(x46), .O(new_n1482_));
  inv1   g1377(.a(new_n1482_), .O(new_n1483_));
  nand3  g1378(.a(new_n1483_), .b(new_n325_), .c(new_n199_), .O(new_n1484_));
  nand4  g1379(.a(new_n1346_), .b(new_n628_), .c(new_n156_), .d(new_n107_), .O(new_n1485_));
  aoi21  g1380(.a(new_n1485_), .b(new_n1484_), .c(new_n118_), .O(z21));
  oai21  g1381(.a(new_n585_), .b(new_n138_), .c(new_n1238_), .O(new_n1487_));
  nand3  g1382(.a(new_n1487_), .b(new_n126_), .c(new_n105_), .O(new_n1488_));
  nand4  g1383(.a(new_n468_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1489_));
  aoi21  g1384(.a(new_n1489_), .b(new_n1488_), .c(x52), .O(new_n1490_));
  nor2   g1385(.a(new_n1381_), .b(new_n1356_), .O(new_n1491_));
  inv1   g1386(.a(new_n1491_), .O(new_n1492_));
  nand4  g1387(.a(new_n1492_), .b(x53), .c(x52), .d(new_n118_), .O(new_n1493_));
  nor3   g1388(.a(new_n1493_), .b(new_n138_), .c(new_n115_), .O(new_n1494_));
  aoi21  g1389(.a(new_n1490_), .b(new_n115_), .c(new_n1494_), .O(new_n1495_));
  nand4  g1390(.a(new_n1030_), .b(new_n275_), .c(new_n161_), .d(new_n108_), .O(new_n1496_));
  oai21  g1391(.a(new_n1495_), .b(x46), .c(new_n1496_), .O(z22));
  nand2  g1392(.a(new_n604_), .b(x50), .O(new_n1498_));
  inv1   g1393(.a(new_n1498_), .O(new_n1499_));
  nand4  g1394(.a(new_n1499_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1500_));
  inv1   g1395(.a(new_n1500_), .O(z23));
  oai22  g1396(.a(new_n634_), .b(new_n139_), .c(new_n271_), .d(new_n160_), .O(new_n1502_));
  nand4  g1397(.a(new_n1502_), .b(new_n126_), .c(x52), .d(x49), .O(new_n1503_));
  nor2   g1398(.a(new_n1503_), .b(x48), .O(z24));
  aoi21  g1399(.a(new_n700_), .b(new_n133_), .c(x50), .O(new_n1505_));
  nand4  g1400(.a(new_n1505_), .b(x49), .c(x48), .d(new_n115_), .O(new_n1506_));
  nor2   g1401(.a(new_n1506_), .b(x46), .O(z25));
  nand4  g1402(.a(x53), .b(x50), .c(new_n138_), .d(x47), .O(new_n1508_));
  oai22  g1403(.a(new_n1508_), .b(x46), .c(new_n1482_), .d(new_n1071_), .O(new_n1509_));
  nand3  g1404(.a(new_n1509_), .b(x52), .c(new_n118_), .O(new_n1510_));
  inv1   g1405(.a(new_n1510_), .O(z26));
  nand3  g1406(.a(new_n1395_), .b(new_n138_), .c(x48), .O(new_n1512_));
  inv1   g1407(.a(new_n1512_), .O(new_n1513_));
  nand4  g1408(.a(new_n1513_), .b(new_n109_), .c(new_n118_), .d(new_n167_), .O(new_n1514_));
  nor2   g1409(.a(new_n1514_), .b(new_n126_), .O(z27));
  nand3  g1410(.a(new_n126_), .b(new_n167_), .c(new_n105_), .O(new_n1516_));
  aoi21  g1411(.a(new_n1516_), .b(new_n1491_), .c(new_n109_), .O(new_n1517_));
  nand2  g1412(.a(new_n1359_), .b(new_n199_), .O(new_n1518_));
  inv1   g1413(.a(new_n1518_), .O(new_n1519_));
  oai21  g1414(.a(new_n1519_), .b(new_n1517_), .c(x51), .O(new_n1520_));
  nor2   g1415(.a(new_n507_), .b(x51), .O(new_n1521_));
  nand2  g1416(.a(new_n1521_), .b(new_n1359_), .O(new_n1522_));
  aoi21  g1417(.a(new_n1522_), .b(new_n1520_), .c(new_n138_), .O(new_n1523_));
  nor3   g1418(.a(new_n647_), .b(new_n289_), .c(x48), .O(new_n1524_));
  oai21  g1419(.a(new_n1524_), .b(new_n1523_), .c(x47), .O(new_n1525_));
  nor2   g1420(.a(new_n1525_), .b(x46), .O(z28));
  nand3  g1421(.a(new_n122_), .b(x49), .c(x48), .O(new_n1527_));
  nor3   g1422(.a(new_n1527_), .b(new_n118_), .c(new_n167_), .O(new_n1528_));
  nand2  g1423(.a(new_n1528_), .b(new_n109_), .O(new_n1529_));
  nor2   g1424(.a(new_n1529_), .b(new_n126_), .O(z29));
  inv1   g1425(.a(new_n1166_), .O(new_n1531_));
  nand3  g1426(.a(new_n1531_), .b(x50), .c(new_n138_), .O(new_n1532_));
  oai21  g1427(.a(new_n286_), .b(new_n138_), .c(new_n1532_), .O(new_n1533_));
  nand2  g1428(.a(new_n1533_), .b(new_n107_), .O(new_n1534_));
  oai21  g1429(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1535_));
  nand3  g1430(.a(new_n1535_), .b(x49), .c(x46), .O(new_n1536_));
  aoi21  g1431(.a(new_n1536_), .b(new_n1534_), .c(x51), .O(new_n1537_));
  nand4  g1432(.a(new_n174_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1538_));
  nor2   g1433(.a(new_n1538_), .b(new_n107_), .O(new_n1539_));
  oai21  g1434(.a(new_n1539_), .b(new_n1537_), .c(new_n105_), .O(new_n1540_));
  nand4  g1435(.a(new_n283_), .b(new_n272_), .c(new_n156_), .d(x46), .O(new_n1541_));
  aoi21  g1436(.a(new_n1541_), .b(new_n1540_), .c(x47), .O(z30));
  nand4  g1437(.a(new_n1395_), .b(new_n167_), .c(x49), .d(new_n105_), .O(new_n1543_));
  nor2   g1438(.a(new_n1543_), .b(new_n118_), .O(new_n1544_));
  nand2  g1439(.a(new_n1544_), .b(x52), .O(new_n1545_));
  nor2   g1440(.a(new_n1545_), .b(x53), .O(z31));
  inv1   g1441(.a(new_n647_), .O(new_n1547_));
  nand3  g1442(.a(new_n1547_), .b(new_n1356_), .c(x46), .O(new_n1548_));
  nand3  g1443(.a(new_n1521_), .b(new_n1381_), .c(new_n107_), .O(new_n1549_));
  nand2  g1444(.a(new_n1549_), .b(new_n1548_), .O(new_n1550_));
  nand3  g1445(.a(new_n1550_), .b(x49), .c(new_n115_), .O(new_n1551_));
  inv1   g1446(.a(new_n1551_), .O(z32));
  nor2   g1447(.a(new_n1529_), .b(x53), .O(z33));
  oai21  g1448(.a(x53), .b(x48), .c(new_n109_), .O(new_n1554_));
  nand2  g1449(.a(new_n156_), .b(new_n105_), .O(new_n1555_));
  aoi21  g1450(.a(new_n1555_), .b(new_n1554_), .c(x51), .O(new_n1556_));
  nand4  g1451(.a(new_n1556_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1557_));
  nor2   g1452(.a(new_n1557_), .b(x46), .O(z34));
  nand3  g1453(.a(x52), .b(x48), .c(new_n115_), .O(new_n1559_));
  nand3  g1454(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1560_));
  aoi21  g1455(.a(new_n1560_), .b(new_n1559_), .c(new_n126_), .O(new_n1561_));
  nand4  g1456(.a(new_n1561_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1562_));
  oai21  g1457(.a(new_n1482_), .b(new_n1465_), .c(new_n1562_), .O(new_n1563_));
  nand2  g1458(.a(new_n1563_), .b(x49), .O(new_n1564_));
  nand2  g1459(.a(new_n420_), .b(new_n132_), .O(new_n1565_));
  nand4  g1460(.a(new_n1565_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1566_));
  inv1   g1461(.a(new_n1566_), .O(new_n1567_));
  nand3  g1462(.a(new_n1567_), .b(new_n115_), .c(new_n107_), .O(new_n1568_));
  nand2  g1463(.a(new_n1568_), .b(new_n1564_), .O(z35));
  nand4  g1464(.a(new_n1395_), .b(new_n167_), .c(x49), .d(x48), .O(new_n1571_));
  nor4   g1465(.a(new_n1571_), .b(x53), .c(x52), .d(x51), .O(z37));
  nor4   g1466(.a(new_n1571_), .b(x53), .c(x52), .d(new_n118_), .O(z38));
  nand2  g1467(.a(new_n1030_), .b(new_n172_), .O(new_n1574_));
  aoi21  g1468(.a(new_n1574_), .b(new_n271_), .c(new_n126_), .O(new_n1575_));
  nand4  g1469(.a(new_n1575_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1576_));
  nor3   g1470(.a(new_n1576_), .b(x47), .c(x46), .O(z39));
  aoi21  g1471(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1578_));
  nand4  g1472(.a(new_n1578_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1579_));
  nand4  g1473(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1580_));
  nand2  g1474(.a(new_n1580_), .b(new_n1579_), .O(new_n1581_));
  nand2  g1475(.a(new_n1581_), .b(new_n118_), .O(new_n1582_));
  oai21  g1476(.a(new_n1430_), .b(new_n138_), .c(x51), .O(new_n1583_));
  nand2  g1477(.a(new_n655_), .b(x11), .O(new_n1584_));
  aoi21  g1478(.a(new_n1584_), .b(new_n1583_), .c(new_n167_), .O(new_n1585_));
  nand4  g1479(.a(new_n1585_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1586_));
  aoi21  g1480(.a(new_n1586_), .b(new_n1582_), .c(x52), .O(z40));
  nand4  g1481(.a(new_n1547_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1588_));
  nand3  g1482(.a(new_n1483_), .b(new_n432_), .c(new_n161_), .O(new_n1589_));
  aoi21  g1483(.a(new_n1589_), .b(new_n1588_), .c(x50), .O(z41));
  nor2   g1484(.a(new_n1545_), .b(new_n126_), .O(z42));
  nand2  g1485(.a(new_n1544_), .b(new_n109_), .O(new_n1592_));
  nor2   g1486(.a(new_n1592_), .b(new_n126_), .O(z43));
  oai22  g1487(.a(new_n1451_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1594_));
  nand4  g1488(.a(new_n1594_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1595_));
  nor2   g1489(.a(new_n1595_), .b(x46), .O(z44));
  nand2  g1490(.a(new_n1528_), .b(x52), .O(new_n1597_));
  nor2   g1491(.a(new_n1597_), .b(new_n126_), .O(z46));
  nand2  g1492(.a(new_n807_), .b(new_n167_), .O(new_n1599_));
  inv1   g1493(.a(new_n1599_), .O(new_n1600_));
  nand4  g1494(.a(new_n1600_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1601_));
  nor2   g1495(.a(new_n1601_), .b(x46), .O(z47));
  nand4  g1496(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1603_));
  nor3   g1497(.a(new_n1603_), .b(x49), .c(x48), .O(new_n1604_));
  nand4  g1498(.a(new_n1604_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1605_));
  nor2   g1499(.a(new_n1605_), .b(x53), .O(z48));
  nand2  g1500(.a(new_n138_), .b(new_n107_), .O(new_n1607_));
  nand4  g1501(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1608_));
  oai21  g1502(.a(new_n1462_), .b(new_n1607_), .c(new_n1608_), .O(new_n1609_));
  nand2  g1503(.a(new_n1609_), .b(new_n115_), .O(new_n1610_));
  nand3  g1504(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1611_));
  inv1   g1505(.a(new_n1611_), .O(new_n1612_));
  nand2  g1506(.a(new_n1612_), .b(new_n1547_), .O(new_n1613_));
  aoi21  g1507(.a(new_n1613_), .b(new_n1610_), .c(x50), .O(new_n1614_));
  nor2   g1508(.a(new_n1611_), .b(new_n1031_), .O(new_n1615_));
  oai21  g1509(.a(new_n1615_), .b(new_n1614_), .c(new_n105_), .O(new_n1616_));
  nand3  g1510(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1617_));
  nand2  g1511(.a(new_n1617_), .b(new_n1616_), .O(z49));
  zero   g1512(.O(z14));
  zero   g1513(.O(z36));
  nor2   g1514(.a(new_n1545_), .b(x53), .O(z45));
endmodule
