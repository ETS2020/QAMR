// Benchmark "FAU" written by ABC on Fri Jul 24 17:28:30 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1502_, new_n1503_, new_n1505_, new_n1506_, new_n1509_, new_n1510_,
    ...
    new_n1603_, new_n1606_, new_n1607_, new_n1608_, new_n1609_, new_n1610_,
  ...
  nand4  g1403(.a(x53), .b(x50), .c(new_n138_), .d(x47), .O(new_n1509_));
  oai22  g1404(.a(new_n1509_), .b(x46), .c(new_n1485_), .d(new_n1071_), .O(new_n1510_));
  nand3  g1405(.a(new_n1510_), .b(x52), .c(new_n118_), .O(new_n1511_));
  inv1   g1406(.a(new_n1511_), .O(z26));
  nand4  g1407(.a(new_n138_), .b(x48), .c(new_n115_), .d(new_n107_), .O(new_n1513_));
  inv1   g1408(.a(new_n1513_), .O(new_n1514_));
  nand4  g1409(.a(new_n1514_), .b(new_n109_), .c(new_n118_), .d(new_n167_), .O(new_n1515_));
  nor2   g1410(.a(new_n1515_), .b(new_n126_), .O(z27));
  nand3  g1411(.a(new_n126_), .b(new_n167_), .c(new_n105_), .O(new_n1517_));
  aoi21  g1412(.a(new_n1517_), .b(new_n1494_), .c(new_n109_), .O(new_n1518_));
  nand2  g1413(.a(new_n1359_), .b(new_n199_), .O(new_n1519_));
  inv1   g1414(.a(new_n1519_), .O(new_n1520_));
  oai21  g1415(.a(new_n1520_), .b(new_n1518_), .c(x51), .O(new_n1521_));
  nor2   g1416(.a(new_n507_), .b(x51), .O(new_n1522_));
  nand2  g1417(.a(new_n1522_), .b(new_n1359_), .O(new_n1523_));
  aoi21  g1418(.a(new_n1523_), .b(new_n1521_), .c(new_n138_), .O(new_n1524_));
  nor3   g1419(.a(new_n647_), .b(new_n289_), .c(x48), .O(new_n1525_));
  oai21  g1420(.a(new_n1525_), .b(new_n1524_), .c(x47), .O(new_n1526_));
  nor2   g1421(.a(new_n1526_), .b(x46), .O(z28));
  nand3  g1422(.a(new_n122_), .b(x49), .c(x48), .O(new_n1528_));
  nor3   g1423(.a(new_n1528_), .b(new_n118_), .c(new_n167_), .O(new_n1529_));
  nand2  g1424(.a(new_n1529_), .b(new_n109_), .O(new_n1530_));
  nor2   g1425(.a(new_n1530_), .b(new_n126_), .O(z29));
  inv1   g1426(.a(new_n1166_), .O(new_n1532_));
  nand3  g1427(.a(new_n1532_), .b(x50), .c(new_n138_), .O(new_n1533_));
  oai21  g1428(.a(new_n286_), .b(new_n138_), .c(new_n1533_), .O(new_n1534_));
  nand2  g1429(.a(new_n1534_), .b(new_n107_), .O(new_n1535_));
  oai21  g1430(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1536_));
  nand3  g1431(.a(new_n1536_), .b(x49), .c(x46), .O(new_n1537_));
  aoi21  g1432(.a(new_n1537_), .b(new_n1535_), .c(x51), .O(new_n1538_));
  nand4  g1433(.a(new_n174_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1539_));
  nor2   g1434(.a(new_n1539_), .b(new_n107_), .O(new_n1540_));
  oai21  g1435(.a(new_n1540_), .b(new_n1538_), .c(new_n105_), .O(new_n1541_));
  nand4  g1436(.a(new_n283_), .b(new_n272_), .c(new_n156_), .d(x46), .O(new_n1542_));
  aoi21  g1437(.a(new_n1542_), .b(new_n1541_), .c(x47), .O(z30));
  nand4  g1438(.a(new_n1395_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1544_));
  inv1   g1439(.a(new_n1544_), .O(new_n1545_));
  nand2  g1440(.a(new_n1545_), .b(x52), .O(new_n1546_));
  nor2   g1441(.a(new_n1546_), .b(x53), .O(z31));
  inv1   g1442(.a(new_n647_), .O(new_n1548_));
  nand3  g1443(.a(new_n1548_), .b(new_n1356_), .c(x46), .O(new_n1549_));
  nand3  g1444(.a(new_n1522_), .b(new_n1381_), .c(new_n107_), .O(new_n1550_));
  nand2  g1445(.a(new_n1550_), .b(new_n1549_), .O(new_n1551_));
  nand3  g1446(.a(new_n1551_), .b(x49), .c(new_n115_), .O(new_n1552_));
  inv1   g1447(.a(new_n1552_), .O(z32));
  nor2   g1448(.a(new_n1530_), .b(x53), .O(z33));
  oai21  g1449(.a(x53), .b(x48), .c(new_n109_), .O(new_n1555_));
  nand2  g1450(.a(new_n156_), .b(new_n105_), .O(new_n1556_));
  aoi21  g1451(.a(new_n1556_), .b(new_n1555_), .c(x51), .O(new_n1557_));
  nand4  g1452(.a(new_n1557_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1558_));
  nor2   g1453(.a(new_n1558_), .b(x46), .O(z34));
  nand3  g1454(.a(x52), .b(x48), .c(new_n115_), .O(new_n1560_));
  nand3  g1455(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1561_));
  aoi21  g1456(.a(new_n1561_), .b(new_n1560_), .c(new_n126_), .O(new_n1562_));
  nand4  g1457(.a(new_n1562_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1563_));
  oai21  g1458(.a(new_n1485_), .b(new_n1468_), .c(new_n1563_), .O(new_n1564_));
  nand2  g1459(.a(new_n1564_), .b(x49), .O(new_n1565_));
  nand2  g1460(.a(new_n420_), .b(new_n132_), .O(new_n1566_));
  nand4  g1461(.a(new_n1566_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1567_));
  inv1   g1462(.a(new_n1567_), .O(new_n1568_));
  nand3  g1463(.a(new_n1568_), .b(new_n115_), .c(new_n107_), .O(new_n1569_));
  nand2  g1464(.a(new_n1569_), .b(new_n1565_), .O(z35));
  nor2   g1465(.a(new_n1400_), .b(x50), .O(new_n1571_));
  nand2  g1466(.a(new_n1571_), .b(new_n118_), .O(new_n1572_));
  nor3   g1467(.a(new_n1572_), .b(new_n126_), .c(new_n109_), .O(z36));
  nor3   g1468(.a(new_n1572_), .b(x53), .c(x52), .O(z37));
  nand3  g1469(.a(new_n1571_), .b(new_n109_), .c(x51), .O(new_n1575_));
  nor2   g1470(.a(new_n1575_), .b(x53), .O(z38));
  ...
  nand4  g1485(.a(new_n1548_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1591_));
  nand3  g1486(.a(new_n1486_), .b(new_n432_), .c(new_n161_), .O(new_n1592_));
  aoi21  g1487(.a(new_n1592_), .b(new_n1591_), .c(x50), .O(z41));
  nor2   g1488(.a(new_n1546_), .b(new_n126_), .O(z42));
  nor3   g1489(.a(new_n1544_), .b(new_n126_), .c(x52), .O(z43));
  ...
  nand2  g1493(.a(new_n1529_), .b(x52), .O(new_n1599_));
  ...
  nand2  g1499(.a(new_n138_), .b(new_n107_), .O(new_n1606_));
  nand4  g1500(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1607_));
  oai21  g1501(.a(new_n1465_), .b(new_n1606_), .c(new_n1607_), .O(new_n1608_));
  nand2  g1502(.a(new_n1608_), .b(new_n115_), .O(new_n1609_));
  nand3  g1503(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1610_));
  inv1   g1504(.a(new_n1610_), .O(new_n1611_));
  nand2  g1505(.a(new_n1611_), .b(new_n1548_), .O(new_n1612_));
  aoi21  g1506(.a(new_n1612_), .b(new_n1609_), .c(x50), .O(new_n1613_));
  nor2   g1507(.a(new_n1610_), .b(new_n1031_), .O(new_n1614_));
  oai21  g1508(.a(new_n1614_), .b(new_n1613_), .c(new_n105_), .O(new_n1615_));
  nand3  g1509(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1616_));
  nand2  g1510(.a(new_n1616_), .b(new_n1615_), .O(z49));
  zero   g1511(.O(z25));
  zero   g1512(.O(z48));
  nor2   g1513(.a(new_n1546_), .b(x53), .O(z45));
endmodule
