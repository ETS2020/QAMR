...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n286_, new_n292_, new_n300_, new_n305_, new_n306_, new_n307_,
    new_n308_;
  ...
  inv1   g160(.a(x43), .O(new_n305_));
  nand4  g161(.a(x47), .b(new_n107_), .c(new_n305_), .d(x27), .O(new_n306_));
  nor3   g162(.a(new_n306_), .b(x49), .c(x48), .O(new_n307_));
  nand4  g163(.a(new_n307_), .b(new_n110_), .c(x51), .d(new_n158_), .O(new_n308_));
  nor2   g164(.a(new_n308_), .b(x53), .O(z48));
  zero   g165(.O(z01));
  zero   g166(.O(z02));
  zero   g167(.O(z03));
  zero   g168(.O(z04));
  ...
  zero   g204(.O(z47));
  zero   g205(.O(z49));
  nor2   g206(.a(new_n286_), .b(x53), .O(z45));
endmodule
