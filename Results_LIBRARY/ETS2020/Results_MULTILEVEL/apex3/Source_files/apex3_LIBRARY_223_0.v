...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1592_, new_n1596_, new_n1597_, new_n1599_, new_n1603_, new_n1604_,
  ...
  nand2  g1495(.a(new_n138_), .b(new_n107_), .O(new_n1603_));
  nand4  g1496(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1604_));
  oai21  g1497(.a(new_n1465_), .b(new_n1603_), .c(new_n1604_), .O(new_n1605_));
  nand2  g1498(.a(new_n1605_), .b(new_n115_), .O(new_n1606_));
  nand3  g1499(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1607_));
  inv1   g1500(.a(new_n1607_), .O(new_n1608_));
  nand2  g1501(.a(new_n1608_), .b(new_n1550_), .O(new_n1609_));
  aoi21  g1502(.a(new_n1609_), .b(new_n1606_), .c(x50), .O(new_n1610_));
  nor2   g1503(.a(new_n1607_), .b(new_n1031_), .O(new_n1611_));
  oai21  g1504(.a(new_n1611_), .b(new_n1610_), .c(new_n105_), .O(new_n1612_));
  nand3  g1505(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1613_));
  nand2  g1506(.a(new_n1613_), .b(new_n1612_), .O(z49));
  zero   g1507(.O(z38));
  zero   g1508(.O(z47));
  zero   g1509(.O(z48));
  nor2   g1510(.a(new_n1548_), .b(x53), .O(z45));
endmodule
