...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n162_, new_n166_, new_n167_, new_n168_,
  ...
  nand4  g21(.a(new_n153_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n166_));
  nor2   g22(.a(new_n166_), .b(x49), .O(new_n167_));
  nand3  g23(.a(new_n167_), .b(x48), .c(new_n122_), .O(new_n168_));
  nor2   g24(.a(new_n168_), .b(x46), .O(z47));
