...
module FAU ( 
  ...
  nand2  g1497(.a(new_n138_), .b(new_n107_), .O(new_n1605_));
  nand4  g1498(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1606_));
  oai21  g1499(.a(new_n1465_), .b(new_n1605_), .c(new_n1606_), .O(new_n1607_));
  nand2  g1500(.a(new_n1607_), .b(new_n115_), .O(new_n1608_));
  nand3  g1501(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1609_));
  inv1   g1502(.a(new_n1609_), .O(new_n1610_));
  nand2  g1503(.a(new_n1610_), .b(new_n1550_), .O(new_n1611_));
  aoi21  g1504(.a(new_n1611_), .b(new_n1608_), .c(x50), .O(new_n1612_));
  nor2   g1505(.a(new_n1609_), .b(new_n1031_), .O(new_n1613_));
  oai21  g1506(.a(new_n1613_), .b(new_n1612_), .c(new_n105_), .O(new_n1614_));
  nand3  g1507(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1615_));
  nand2  g1508(.a(new_n1615_), .b(new_n1614_), .O(z49));
  zero   g1509(.O(z38));
  zero   g1510(.O(z46));
  zero   g1511(.O(z48));
