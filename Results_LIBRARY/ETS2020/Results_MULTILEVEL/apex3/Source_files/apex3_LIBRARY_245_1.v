...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n178_, new_n179_, new_n185_, new_n198_, new_n199_, new_n200_,
    new_n201_;
  ...
  inv1   g52(.a(x43), .O(new_n198_));
  nand4  g53(.a(x47), .b(new_n121_), .c(new_n198_), .d(x27), .O(new_n199_));
  nor3   g54(.a(new_n199_), .b(x49), .c(x48), .O(new_n200_));
  nand4  g55(.a(new_n200_), .b(new_n120_), .c(x51), .d(new_n131_), .O(new_n201_));
  nor2   g56(.a(new_n201_), .b(x53), .O(z48));
  zero   g57(.O(z00));
  zero   g58(.O(z01));
  zero   g59(.O(z02));
  zero   g60(.O(z03));
