// Benchmark "FAU" written by ABC on Fri Jul 24 17:33:49 2020
...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n155_, new_n158_, new_n164_, new_n166_,
  ...
  inv1   g24(.a(x49), .O(new_n166_));
  xnor2a g25(.a(x52), .b(x51), .O(new_n167_));
  nand4  g26(.a(x53), .b(x52), .c(new_n119_), .d(new_n143_), .O(new_n168_));
  oai21  g27(.a(new_n167_), .b(new_n143_), .c(new_n168_), .O(new_n169_));
  nand4  g28(.a(new_n169_), .b(new_n166_), .c(x48), .d(new_n122_), .O(new_n170_));
  nor2   g29(.a(new_n170_), .b(x46), .O(z44));
  ...
  nand4  g33(.a(new_n176_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n177_));
  ...
  zero   g73(.O(z47));
  zero   g74(.O(z49));
  nor2   g75(.a(new_n147_), .b(x53), .O(z45));
endmodule
