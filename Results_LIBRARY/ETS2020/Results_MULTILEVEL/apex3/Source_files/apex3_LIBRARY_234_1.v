...
module FAU ( 
  ...
  wire new_n111_, new_n112_, new_n113_, new_n114_, new_n115_, new_n116_,
    ...
    new_n309_, new_n310_, new_n319_, new_n320_, new_n321_, new_n323_,
    new_n324_, new_n325_, new_n326_, new_n327_, new_n328_, new_n329_,
    new_n330_, new_n331_, new_n332_, new_n333_, new_n334_, new_n335_,
    new_n336_, new_n337_, new_n338_, new_n339_, new_n340_, new_n341_,
    new_n342_, new_n343_, new_n344_, new_n345_, new_n346_, new_n347_,
    new_n348_, new_n365_, new_n366_, new_n367_, new_n373_, new_n374_,
    new_n377_, new_n383_, new_n388_, new_n389_, new_n390_;
  ...
  nor2   g205(.a(x49), .b(new_n141_), .O(new_n323_));
  nand3  g206(.a(new_n323_), .b(new_n188_), .c(x51), .O(new_n324_));
  nand2  g207(.a(new_n324_), .b(new_n190_), .O(new_n325_));
  nand2  g208(.a(new_n325_), .b(x47), .O(new_n326_));
  nand3  g209(.a(x53), .b(x52), .c(x51), .O(new_n327_));
  nand3  g210(.a(new_n164_), .b(new_n188_), .c(new_n115_), .O(new_n328_));
  nand2  g211(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand4  g212(.a(new_n329_), .b(new_n113_), .c(x48), .d(new_n112_), .O(new_n330_));
  aoi21  g213(.a(new_n330_), .b(new_n326_), .c(x46), .O(new_n331_));
  xnor2a g214(.a(x52), .b(x51), .O(new_n332_));
  nand4  g215(.a(new_n332_), .b(x53), .c(new_n113_), .d(x48), .O(new_n333_));
  nor3   g216(.a(new_n333_), .b(x47), .c(new_n111_), .O(new_n334_));
  oai21  g217(.a(new_n334_), .b(new_n331_), .c(new_n120_), .O(new_n335_));
  nand2  g218(.a(new_n249_), .b(new_n248_), .O(new_n336_));
  nand2  g219(.a(new_n336_), .b(x51), .O(new_n337_));
  inv1   g220(.a(x04), .O(new_n338_));
  aoi21  g221(.a(x48), .b(new_n338_), .c(x53), .O(new_n339_));
  nand4  g222(.a(new_n339_), .b(new_n115_), .c(new_n113_), .d(x46), .O(new_n340_));
  aoi21  g223(.a(new_n340_), .b(new_n337_), .c(new_n188_), .O(new_n341_));
  oai21  g224(.a(x53), .b(x04), .c(x52), .O(new_n342_));
  nand4  g225(.a(new_n342_), .b(new_n115_), .c(new_n113_), .d(x48), .O(new_n343_));
  nor2   g226(.a(new_n343_), .b(new_n111_), .O(new_n344_));
  oai21  g227(.a(new_n344_), .b(new_n341_), .c(new_n112_), .O(new_n345_));
  nand4  g228(.a(new_n323_), .b(new_n189_), .c(x51), .d(new_n111_), .O(new_n346_));
  nand2  g229(.a(new_n346_), .b(new_n345_), .O(new_n347_));
  nand2  g230(.a(new_n347_), .b(x50), .O(new_n348_));
  nand2  g231(.a(new_n348_), .b(new_n335_), .O(z15));
  nand4  g232(.a(x49), .b(new_n141_), .c(new_n112_), .d(new_n111_), .O(new_n365_));
  nor3   g233(.a(new_n365_), .b(new_n115_), .c(x50), .O(new_n366_));
  nand2  g234(.a(new_n366_), .b(x52), .O(new_n367_));
  nor2   g235(.a(new_n367_), .b(x53), .O(z31));
  nor2   g236(.a(new_n319_), .b(x50), .O(new_n373_));
  nand2  g237(.a(new_n373_), .b(new_n115_), .O(new_n374_));
  nor3   g238(.a(new_n374_), .b(new_n164_), .c(new_n188_), .O(z36));
  nor3   g239(.a(new_n374_), .b(x53), .c(x52), .O(z37));
  nand3  g240(.a(new_n373_), .b(new_n188_), .c(x51), .O(new_n377_));
  nor2   g241(.a(new_n377_), .b(x53), .O(z38));
  nor2   g242(.a(new_n367_), .b(new_n164_), .O(z42));
  nand2  g243(.a(new_n366_), .b(new_n188_), .O(new_n383_));
  nor2   g244(.a(new_n383_), .b(new_n164_), .O(z43));
  nand4  g245(.a(x47), .b(new_n111_), .c(new_n146_), .d(x27), .O(new_n388_));
  nor3   g246(.a(new_n388_), .b(x49), .c(x48), .O(new_n389_));
  nand4  g247(.a(new_n389_), .b(new_n188_), .c(x51), .d(new_n120_), .O(new_n390_));
  nor2   g248(.a(new_n390_), .b(x53), .O(z48));
  zero   g249(.O(z00));
  zero   g250(.O(z01));
  zero   g251(.O(z02));
  zero   g252(.O(z03));
  ...
  zero   g286(.O(z47));
  zero   g287(.O(z49));
  nor2   g288(.a(new_n367_), .b(x53), .O(z45));
endmodule
