...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n153_, new_n154_, new_n155_, new_n158_, new_n164_, new_n168_,
  ...
  nand4  g24(.a(new_n153_), .b(new_n120_), .c(x51), .d(new_n143_), .O(new_n168_));
  nor2   g25(.a(new_n168_), .b(x49), .O(new_n169_));
  nand3  g26(.a(new_n169_), .b(x48), .c(new_n122_), .O(new_n170_));
  nor2   g27(.a(new_n170_), .b(x46), .O(z47));
