// Benchmark "FAU" written by ABC on Fri Jul 24 17:31:54 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1396_, new_n1397_, new_n1400_, new_n1401_, new_n1402_, new_n1403_,
    ...
    new_n1539_, new_n1540_, new_n1543_, new_n1544_, new_n1545_, new_n1546_,
    new_n1547_, new_n1550_, new_n1551_, new_n1552_, new_n1553_, new_n1555_,
    new_n1556_, new_n1557_, new_n1558_, new_n1559_, new_n1560_, new_n1561_,
    new_n1562_, new_n1563_, new_n1564_, new_n1568_, new_n1569_, new_n1570_,
    new_n1572_, new_n1573_, new_n1574_, new_n1576_, new_n1577_, new_n1578_,
    new_n1579_, new_n1580_, new_n1581_, new_n1582_, new_n1583_, new_n1584_,
    new_n1586_, new_n1587_, new_n1591_, new_n1592_, new_n1595_, new_n1597_,
    new_n1598_, new_n1599_, new_n1601_, new_n1602_, new_n1603_, new_n1605_,
    new_n1606_, new_n1607_, new_n1608_, new_n1609_, new_n1610_, new_n1611_,
    new_n1612_, new_n1613_, new_n1614_, new_n1615_;
  ...
  nand4  g1290(.a(new_n138_), .b(new_n105_), .c(new_n115_), .d(new_n107_), .O(new_n1395_));
  ...
  oai21  g1294(.a(new_n284_), .b(new_n133_), .c(new_n652_), .O(new_n1400_));
  nand2  g1295(.a(new_n1400_), .b(x47), .O(new_n1401_));
  oai21  g1296(.a(new_n507_), .b(x51), .c(new_n647_), .O(new_n1402_));
  nand4  g1297(.a(new_n1402_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1403_));
  aoi21  g1298(.a(new_n1403_), .b(new_n1401_), .c(x46), .O(new_n1404_));
  ...
  nor2   g1384(.a(new_n1381_), .b(new_n1356_), .O(new_n1490_));
  inv1   g1385(.a(new_n1490_), .O(new_n1491_));
  nand4  g1386(.a(new_n1491_), .b(x53), .c(x52), .d(new_n118_), .O(new_n1492_));
  nor3   g1387(.a(new_n1492_), .b(new_n138_), .c(new_n115_), .O(new_n1493_));
  aoi21  g1388(.a(new_n1489_), .b(new_n115_), .c(new_n1493_), .O(new_n1494_));
  nand4  g1389(.a(new_n1030_), .b(new_n275_), .c(new_n161_), .d(new_n108_), .O(new_n1495_));
  oai21  g1390(.a(new_n1494_), .b(x46), .c(new_n1495_), .O(z22));
  nand2  g1391(.a(new_n604_), .b(x50), .O(new_n1497_));
  inv1   g1392(.a(new_n1497_), .O(new_n1498_));
  nand4  g1393(.a(new_n1498_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1499_));
  inv1   g1394(.a(new_n1499_), .O(z23));
  oai22  g1395(.a(new_n634_), .b(new_n139_), .c(new_n271_), .d(new_n160_), .O(new_n1501_));
  nand4  g1396(.a(new_n1501_), .b(new_n126_), .c(x52), .d(x49), .O(new_n1502_));
  nor2   g1397(.a(new_n1502_), .b(x48), .O(z24));
  aoi21  g1398(.a(new_n700_), .b(new_n133_), .c(x50), .O(new_n1504_));
  nand4  g1399(.a(new_n1504_), .b(x49), .c(x48), .d(new_n115_), .O(new_n1505_));
  nor2   g1400(.a(new_n1505_), .b(x46), .O(z25));
  nand4  g1401(.a(x53), .b(x50), .c(new_n138_), .d(x47), .O(new_n1507_));
  oai22  g1402(.a(new_n1507_), .b(x46), .c(new_n1481_), .d(new_n1071_), .O(new_n1508_));
  nand3  g1403(.a(new_n1508_), .b(x52), .c(new_n118_), .O(new_n1509_));
  inv1   g1404(.a(new_n1509_), .O(z26));
  nand4  g1405(.a(new_n138_), .b(x48), .c(new_n115_), .d(new_n107_), .O(new_n1511_));
  inv1   g1406(.a(new_n1511_), .O(new_n1512_));
  nand4  g1407(.a(new_n1512_), .b(new_n109_), .c(new_n118_), .d(new_n167_), .O(new_n1513_));
  nor2   g1408(.a(new_n1513_), .b(new_n126_), .O(z27));
  nand3  g1409(.a(new_n126_), .b(new_n167_), .c(new_n105_), .O(new_n1515_));
  aoi21  g1410(.a(new_n1515_), .b(new_n1490_), .c(new_n109_), .O(new_n1516_));
  nand2  g1411(.a(new_n1359_), .b(new_n199_), .O(new_n1517_));
  inv1   g1412(.a(new_n1517_), .O(new_n1518_));
  oai21  g1413(.a(new_n1518_), .b(new_n1516_), .c(x51), .O(new_n1519_));
  nor2   g1414(.a(new_n507_), .b(x51), .O(new_n1520_));
  nand2  g1415(.a(new_n1520_), .b(new_n1359_), .O(new_n1521_));
  aoi21  g1416(.a(new_n1521_), .b(new_n1519_), .c(new_n138_), .O(new_n1522_));
  nor3   g1417(.a(new_n647_), .b(new_n289_), .c(x48), .O(new_n1523_));
  oai21  g1418(.a(new_n1523_), .b(new_n1522_), .c(x47), .O(new_n1524_));
  nor2   g1419(.a(new_n1524_), .b(x46), .O(z28));
  nand3  g1420(.a(new_n122_), .b(x49), .c(x48), .O(new_n1526_));
  nor3   g1421(.a(new_n1526_), .b(new_n118_), .c(new_n167_), .O(new_n1527_));
  nand2  g1422(.a(new_n1527_), .b(new_n109_), .O(new_n1528_));
  nor2   g1423(.a(new_n1528_), .b(new_n126_), .O(z29));
  inv1   g1424(.a(new_n1166_), .O(new_n1530_));
  nand3  g1425(.a(new_n1530_), .b(x50), .c(new_n138_), .O(new_n1531_));
  oai21  g1426(.a(new_n286_), .b(new_n138_), .c(new_n1531_), .O(new_n1532_));
  nand2  g1427(.a(new_n1532_), .b(new_n107_), .O(new_n1533_));
  oai21  g1428(.a(new_n507_), .b(new_n167_), .c(new_n186_), .O(new_n1534_));
  nand3  g1429(.a(new_n1534_), .b(x49), .c(x46), .O(new_n1535_));
  aoi21  g1430(.a(new_n1535_), .b(new_n1533_), .c(x51), .O(new_n1536_));
  nand4  g1431(.a(new_n174_), .b(x51), .c(new_n167_), .d(x49), .O(new_n1537_));
  nor2   g1432(.a(new_n1537_), .b(new_n107_), .O(new_n1538_));
  oai21  g1433(.a(new_n1538_), .b(new_n1536_), .c(new_n105_), .O(new_n1539_));
  nand4  g1434(.a(new_n283_), .b(new_n272_), .c(new_n156_), .d(x46), .O(new_n1540_));
  aoi21  g1435(.a(new_n1540_), .b(new_n1539_), .c(x47), .O(z30));
  inv1   g1436(.a(new_n647_), .O(new_n1543_));
  nand3  g1437(.a(new_n1543_), .b(new_n1356_), .c(x46), .O(new_n1544_));
  nand3  g1438(.a(new_n1520_), .b(new_n1381_), .c(new_n107_), .O(new_n1545_));
  nand2  g1439(.a(new_n1545_), .b(new_n1544_), .O(new_n1546_));
  nand3  g1440(.a(new_n1546_), .b(x49), .c(new_n115_), .O(new_n1547_));
  inv1   g1441(.a(new_n1547_), .O(z32));
  nor2   g1442(.a(new_n1528_), .b(x53), .O(z33));
  oai21  g1443(.a(x53), .b(x48), .c(new_n109_), .O(new_n1550_));
  nand2  g1444(.a(new_n156_), .b(new_n105_), .O(new_n1551_));
  aoi21  g1445(.a(new_n1551_), .b(new_n1550_), .c(x51), .O(new_n1552_));
  nand4  g1446(.a(new_n1552_), .b(new_n167_), .c(x49), .d(x47), .O(new_n1553_));
  nor2   g1447(.a(new_n1553_), .b(x46), .O(z34));
  nand3  g1448(.a(x52), .b(x48), .c(new_n115_), .O(new_n1555_));
  nand3  g1449(.a(new_n109_), .b(new_n105_), .c(x47), .O(new_n1556_));
  aoi21  g1450(.a(new_n1556_), .b(new_n1555_), .c(new_n126_), .O(new_n1557_));
  nand4  g1451(.a(new_n1557_), .b(new_n118_), .c(x50), .d(new_n107_), .O(new_n1558_));
  oai21  g1452(.a(new_n1481_), .b(new_n1464_), .c(new_n1558_), .O(new_n1559_));
  nand2  g1453(.a(new_n1559_), .b(x49), .O(new_n1560_));
  nand2  g1454(.a(new_n420_), .b(new_n132_), .O(new_n1561_));
  nand4  g1455(.a(new_n1561_), .b(new_n126_), .c(new_n138_), .d(x48), .O(new_n1562_));
  inv1   g1456(.a(new_n1562_), .O(new_n1563_));
  nand3  g1457(.a(new_n1563_), .b(new_n115_), .c(new_n107_), .O(new_n1564_));
  nand2  g1458(.a(new_n1564_), .b(new_n1560_), .O(z35));
  nand4  g1459(.a(x49), .b(x48), .c(new_n115_), .d(new_n107_), .O(new_n1568_));
  inv1   g1460(.a(new_n1568_), .O(new_n1569_));
  nand4  g1461(.a(new_n1569_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1570_));
  nor2   g1462(.a(new_n1570_), .b(x53), .O(z38));
  nand2  g1463(.a(new_n1030_), .b(new_n172_), .O(new_n1572_));
  aoi21  g1464(.a(new_n1572_), .b(new_n271_), .c(new_n126_), .O(new_n1573_));
  nand4  g1465(.a(new_n1573_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1574_));
  nor3   g1466(.a(new_n1574_), .b(x47), .c(x46), .O(z39));
  aoi21  g1467(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1576_));
  nand4  g1468(.a(new_n1576_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1577_));
  nand4  g1469(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1578_));
  nand2  g1470(.a(new_n1578_), .b(new_n1577_), .O(new_n1579_));
  nand2  g1471(.a(new_n1579_), .b(new_n118_), .O(new_n1580_));
  oai21  g1472(.a(new_n1429_), .b(new_n138_), .c(x51), .O(new_n1581_));
  nand2  g1473(.a(new_n655_), .b(x11), .O(new_n1582_));
  aoi21  g1474(.a(new_n1582_), .b(new_n1581_), .c(new_n167_), .O(new_n1583_));
  nand4  g1475(.a(new_n1583_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1584_));
  aoi21  g1476(.a(new_n1584_), .b(new_n1580_), .c(x52), .O(z40));
  nand4  g1477(.a(new_n1543_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1586_));
  nand3  g1478(.a(new_n1482_), .b(new_n432_), .c(new_n161_), .O(new_n1587_));
  aoi21  g1479(.a(new_n1587_), .b(new_n1586_), .c(x50), .O(z41));
  oai22  g1480(.a(new_n1450_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1591_));
  nand4  g1481(.a(new_n1591_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1592_));
  nor2   g1482(.a(new_n1592_), .b(x46), .O(z44));
  nand2  g1483(.a(new_n1527_), .b(x52), .O(new_n1595_));
  nor2   g1484(.a(new_n1595_), .b(new_n126_), .O(z46));
  nand2  g1485(.a(new_n807_), .b(new_n167_), .O(new_n1597_));
  inv1   g1486(.a(new_n1597_), .O(new_n1598_));
  nand4  g1487(.a(new_n1598_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1599_));
  nor2   g1488(.a(new_n1599_), .b(x46), .O(z47));
  nand4  g1489(.a(x47), .b(new_n107_), .c(new_n375_), .d(x27), .O(new_n1601_));
  nor3   g1490(.a(new_n1601_), .b(x49), .c(x48), .O(new_n1602_));
  nand4  g1491(.a(new_n1602_), .b(new_n109_), .c(x51), .d(new_n167_), .O(new_n1603_));
  nor2   g1492(.a(new_n1603_), .b(x53), .O(z48));
  nand2  g1493(.a(new_n138_), .b(new_n107_), .O(new_n1605_));
  nand4  g1494(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1606_));
  oai21  g1495(.a(new_n1461_), .b(new_n1605_), .c(new_n1606_), .O(new_n1607_));
  nand2  g1496(.a(new_n1607_), .b(new_n115_), .O(new_n1608_));
  nand3  g1497(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1609_));
  inv1   g1498(.a(new_n1609_), .O(new_n1610_));
  nand2  g1499(.a(new_n1610_), .b(new_n1543_), .O(new_n1611_));
  aoi21  g1500(.a(new_n1611_), .b(new_n1608_), .c(x50), .O(new_n1612_));
  nor2   g1501(.a(new_n1609_), .b(new_n1031_), .O(new_n1613_));
  oai21  g1502(.a(new_n1613_), .b(new_n1612_), .c(new_n105_), .O(new_n1614_));
  nand3  g1503(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1615_));
  nand2  g1504(.a(new_n1615_), .b(new_n1614_), .O(z49));
  zero   g1505(.O(z14));
  zero   g1506(.O(z31));
  zero   g1507(.O(z36));
  zero   g1508(.O(z37));
