// Benchmark "FAU" written by ABC on Fri Jul 24 17:34:38 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1569_, new_n1573_, new_n1574_, new_n1575_, new_n1577_, new_n1578_,
    new_n1579_, new_n1580_, new_n1581_, new_n1582_, new_n1583_, new_n1584_,
    new_n1585_, new_n1587_, new_n1588_, new_n1592_, new_n1593_, new_n1595_,
    new_n1597_, new_n1598_, new_n1599_, new_n1602_, new_n1603_, new_n1604_,
  ...
  nand3  g1463(.a(new_n1401_), .b(new_n118_), .c(new_n167_), .O(new_n1569_));
  nor3   g1464(.a(new_n1569_), .b(new_n126_), .c(new_n109_), .O(z36));
  nor3   g1465(.a(new_n1569_), .b(x53), .c(x52), .O(z37));
  nand2  g1466(.a(new_n1030_), .b(new_n172_), .O(new_n1573_));
  aoi21  g1467(.a(new_n1573_), .b(new_n271_), .c(new_n126_), .O(new_n1574_));
  nand4  g1468(.a(new_n1574_), .b(new_n109_), .c(new_n138_), .d(x48), .O(new_n1575_));
  nor3   g1469(.a(new_n1575_), .b(x47), .c(x46), .O(z39));
  aoi21  g1470(.a(x53), .b(new_n105_), .c(new_n167_), .O(new_n1577_));
  nand4  g1471(.a(new_n1577_), .b(x49), .c(x47), .d(new_n107_), .O(new_n1578_));
  nand4  g1472(.a(new_n972_), .b(new_n726_), .c(new_n138_), .d(x46), .O(new_n1579_));
  nand2  g1473(.a(new_n1579_), .b(new_n1578_), .O(new_n1580_));
  nand2  g1474(.a(new_n1580_), .b(new_n118_), .O(new_n1581_));
  oai21  g1475(.a(new_n1433_), .b(new_n138_), .c(x51), .O(new_n1582_));
  nand2  g1476(.a(new_n655_), .b(x11), .O(new_n1583_));
  aoi21  g1477(.a(new_n1583_), .b(new_n1582_), .c(new_n167_), .O(new_n1584_));
  nand4  g1478(.a(new_n1584_), .b(new_n105_), .c(x47), .d(new_n107_), .O(new_n1585_));
  aoi21  g1479(.a(new_n1585_), .b(new_n1581_), .c(x52), .O(z40));
  nand4  g1480(.a(new_n1550_), .b(new_n138_), .c(x47), .d(new_n107_), .O(new_n1587_));
  nand3  g1481(.a(new_n1486_), .b(new_n432_), .c(new_n161_), .O(new_n1588_));
  aoi21  g1482(.a(new_n1588_), .b(new_n1587_), .c(x50), .O(z41));
  nor2   g1483(.a(new_n1548_), .b(new_n126_), .O(z42));
  nor3   g1484(.a(new_n1546_), .b(new_n126_), .c(x52), .O(z43));
  oai22  g1485(.a(new_n1454_), .b(new_n167_), .c(new_n585_), .d(new_n186_), .O(new_n1592_));
  nand4  g1486(.a(new_n1592_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1593_));
  nor2   g1487(.a(new_n1593_), .b(x46), .O(z44));
  nand2  g1488(.a(new_n1531_), .b(x52), .O(new_n1595_));
  nor2   g1489(.a(new_n1595_), .b(new_n126_), .O(z46));
  nand2  g1490(.a(new_n807_), .b(new_n167_), .O(new_n1597_));
  inv1   g1491(.a(new_n1597_), .O(new_n1598_));
  nand4  g1492(.a(new_n1598_), .b(new_n138_), .c(x48), .d(new_n115_), .O(new_n1599_));
  nor2   g1493(.a(new_n1599_), .b(x46), .O(z47));
  nand2  g1494(.a(new_n138_), .b(new_n107_), .O(new_n1602_));
  nand4  g1495(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1603_));
  oai21  g1496(.a(new_n1465_), .b(new_n1602_), .c(new_n1603_), .O(new_n1604_));
  nand2  g1497(.a(new_n1604_), .b(new_n115_), .O(new_n1605_));
  nand3  g1498(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1606_));
  inv1   g1499(.a(new_n1606_), .O(new_n1607_));
  nand2  g1500(.a(new_n1607_), .b(new_n1550_), .O(new_n1608_));
  aoi21  g1501(.a(new_n1608_), .b(new_n1605_), .c(x50), .O(new_n1609_));
  nor2   g1502(.a(new_n1606_), .b(new_n1031_), .O(new_n1610_));
  oai21  g1503(.a(new_n1610_), .b(new_n1609_), .c(new_n105_), .O(new_n1611_));
  nand3  g1504(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1612_));
  nand2  g1505(.a(new_n1612_), .b(new_n1611_), .O(z49));
  zero   g1506(.O(z34));
  zero   g1507(.O(z38));
  zero   g1508(.O(z48));
  nor2   g1509(.a(new_n1548_), .b(x53), .O(z45));
endmodule
