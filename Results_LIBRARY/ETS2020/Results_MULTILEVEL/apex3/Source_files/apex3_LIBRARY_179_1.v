...
module FAU ( 
  ...
  wire new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n124_,
    ...
    new_n147_, new_n148_, new_n154_, new_n155_, new_n156_, new_n165_,
  ...
  nand4  g28(.a(new_n131_), .b(x52), .c(x51), .d(x50), .O(new_n154_));
  inv1   g29(.a(new_n154_), .O(new_n155_));
  nand4  g30(.a(new_n155_), .b(new_n130_), .c(x47), .d(new_n121_), .O(new_n156_));
  inv1   g31(.a(new_n156_), .O(z23));
  inv1   g32(.a(x50), .O(new_n165_));
  nor3   g33(.a(x48), .b(x47), .c(x46), .O(new_n166_));
  nand4  g34(.a(new_n166_), .b(x51), .c(new_n165_), .d(x49), .O(new_n167_));
  or2    g35(.a(new_n167_), .b(new_n120_), .O(new_n168_));
  nor2   g36(.a(new_n168_), .b(x53), .O(z31));
  nand3  g37(.a(new_n124_), .b(new_n119_), .c(new_n165_), .O(new_n174_));
  nor3   g38(.a(new_n174_), .b(new_n131_), .c(new_n120_), .O(z36));
  nor3   g39(.a(new_n174_), .b(x53), .c(x52), .O(z37));
  nor2   g40(.a(new_n168_), .b(new_n131_), .O(z42));
  nor3   g41(.a(new_n167_), .b(new_n131_), .c(x52), .O(z43));
  inv1   g42(.a(x43), .O(new_n186_));
  nand4  g43(.a(x47), .b(new_n121_), .c(new_n186_), .d(x27), .O(new_n187_));
  nor3   g44(.a(new_n187_), .b(x49), .c(x48), .O(new_n188_));
  nand4  g45(.a(new_n188_), .b(new_n120_), .c(x51), .d(new_n165_), .O(new_n189_));
  nor2   g46(.a(new_n189_), .b(x53), .O(z48));
  zero   g47(.O(z00));
  zero   g48(.O(z01));
  zero   g49(.O(z02));
  zero   g50(.O(z03));
