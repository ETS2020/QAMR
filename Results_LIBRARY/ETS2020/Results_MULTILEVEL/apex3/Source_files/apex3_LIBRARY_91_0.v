// Benchmark "FAU" written by ABC on Fri Jul 24 17:30:46 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1603_, new_n1604_, new_n1605_, new_n1608_, new_n1609_, new_n1610_,
  ...
  nand2  g1502(.a(new_n138_), .b(new_n107_), .O(new_n1608_));
  nand4  g1503(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1609_));
  oai21  g1504(.a(new_n1465_), .b(new_n1608_), .c(new_n1609_), .O(new_n1610_));
  nand2  g1505(.a(new_n1610_), .b(new_n115_), .O(new_n1611_));
  nand3  g1506(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1612_));
  inv1   g1507(.a(new_n1612_), .O(new_n1613_));
  nand2  g1508(.a(new_n1613_), .b(new_n1550_), .O(new_n1614_));
  aoi21  g1509(.a(new_n1614_), .b(new_n1611_), .c(x50), .O(new_n1615_));
  nor2   g1510(.a(new_n1612_), .b(new_n1031_), .O(new_n1616_));
  oai21  g1511(.a(new_n1616_), .b(new_n1615_), .c(new_n105_), .O(new_n1617_));
  nand3  g1512(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1618_));
  nand2  g1513(.a(new_n1618_), .b(new_n1617_), .O(z49));
  zero   g1514(.O(z48));
  nor2   g1515(.a(new_n1548_), .b(x53), .O(z45));
endmodule
