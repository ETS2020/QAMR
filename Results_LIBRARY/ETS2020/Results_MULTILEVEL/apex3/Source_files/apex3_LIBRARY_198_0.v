// Benchmark "FAU" written by ABC on Fri Jul 24 17:33:47 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1595_, new_n1596_, new_n1599_, new_n1600_, new_n1601_, new_n1604_,
  ...
  nand4  g1423(.a(new_n1528_), .b(new_n109_), .c(x51), .d(x50), .O(new_n1529_));
  ...
  nand2  g1496(.a(new_n138_), .b(new_n107_), .O(new_n1604_));
  nand4  g1497(.a(new_n923_), .b(x52), .c(x49), .d(x46), .O(new_n1605_));
  oai21  g1498(.a(new_n1465_), .b(new_n1604_), .c(new_n1605_), .O(new_n1606_));
  nand2  g1499(.a(new_n1606_), .b(new_n115_), .O(new_n1607_));
  nand3  g1500(.a(new_n138_), .b(x47), .c(new_n107_), .O(new_n1608_));
  inv1   g1501(.a(new_n1608_), .O(new_n1609_));
  nand2  g1502(.a(new_n1609_), .b(new_n1547_), .O(new_n1610_));
  aoi21  g1503(.a(new_n1610_), .b(new_n1607_), .c(x50), .O(new_n1611_));
  nor2   g1504(.a(new_n1608_), .b(new_n1031_), .O(new_n1612_));
  oai21  g1505(.a(new_n1612_), .b(new_n1611_), .c(new_n105_), .O(new_n1613_));
  nand3  g1506(.a(new_n1032_), .b(new_n283_), .c(new_n108_), .O(new_n1614_));
  nand2  g1507(.a(new_n1614_), .b(new_n1613_), .O(z49));
  zero   g1508(.O(z27));
  zero   g1509(.O(z46));
  zero   g1510(.O(z48));
  nor2   g1511(.a(new_n1545_), .b(x53), .O(z45));
endmodule
