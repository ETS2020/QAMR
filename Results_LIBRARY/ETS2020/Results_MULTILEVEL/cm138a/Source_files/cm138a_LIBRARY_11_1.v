// Benchmark "FAU" written by ABC on Fri Jul 24 00:19:46 2020
...
module FAU ( 
  ...
  nor2   g14(.a(new_n25_), .b(x0), .O(new_n30_));
  nand4  g15(.a(new_n30_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g16(.a(new_n26_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z7));
  zero   g17(.O(z2));
endmodule
