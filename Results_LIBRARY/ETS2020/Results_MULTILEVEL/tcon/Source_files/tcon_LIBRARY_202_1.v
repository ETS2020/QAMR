// Benchmark "FAU" written by ABC on Fri Jul 24 17:28:19 2020
...
module FAU ( 
  ...
  inv1   g18(.a(x15), .O(new_n55_));
  nand2  g19(.a(x08), .b(x06), .O(new_n56_));
  oai21  g20(.a(new_n55_), .b(x08), .c(new_n56_), .O(z14));
  inv1   g21(.a(x16), .O(new_n58_));
  nand2  g22(.a(x08), .b(x07), .O(new_n59_));
  oai21  g23(.a(new_n58_), .b(x08), .c(new_n59_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z06));
  buf    g27(.a(x09), .O(z00));
