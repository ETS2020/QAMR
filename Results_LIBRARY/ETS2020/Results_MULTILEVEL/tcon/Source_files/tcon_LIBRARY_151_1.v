// Benchmark "FAU" written by ABC on Fri Jul 24 17:27:57 2020
...
module FAU ( 
  ...
  wire new_n37_, new_n38_, new_n40_, new_n41_, new_n43_, new_n44_, new_n46_,
    new_n47_, new_n50_, new_n51_, new_n53_, new_n54_, new_n56_, new_n57_;
  ...
  inv1   g18(.a(x16), .O(new_n56_));
  nand2  g19(.a(x08), .b(x07), .O(new_n57_));
  oai21  g20(.a(new_n56_), .b(x08), .c(new_n57_), .O(z15));
  zero   g21(.O(z01));
  zero   g22(.O(z04));
  zero   g23(.O(z05));
  zero   g24(.O(z12));
