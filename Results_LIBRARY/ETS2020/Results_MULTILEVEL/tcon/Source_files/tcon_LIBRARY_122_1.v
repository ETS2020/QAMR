// Benchmark "FAU" written by ABC on Fri Jul 24 17:27:44 2020
...
module FAU ( 
  ...
  inv1   g15(.a(x16), .O(new_n54_));
  nand2  g16(.a(x08), .b(x07), .O(new_n55_));
  oai21  g17(.a(new_n54_), .b(x08), .c(new_n55_), .O(z15));
  zero   g18(.O(z01));
  zero   g19(.O(z04));
  zero   g20(.O(z06));
  zero   g21(.O(z08));
