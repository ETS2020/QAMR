// Benchmark "FAU" written by ABC on Fri Jul 24 17:27:22 2020
...
module FAU ( 
  ...
  inv1   g12(.a(x13), .O(new_n48_));
  nand2  g13(.a(x08), .b(x04), .O(new_n49_));
  oai21  g14(.a(new_n48_), .b(x08), .c(new_n49_), .O(z12));
  inv1   g15(.a(x14), .O(new_n51_));
  nand2  g16(.a(x08), .b(x05), .O(new_n52_));
  oai21  g17(.a(new_n51_), .b(x08), .c(new_n52_), .O(z13));
  inv1   g18(.a(x15), .O(new_n54_));
  nand2  g19(.a(x08), .b(x06), .O(new_n55_));
  oai21  g20(.a(new_n54_), .b(x08), .c(new_n55_), .O(z14));
  inv1   g21(.a(x16), .O(new_n57_));
  nand2  g22(.a(x08), .b(x07), .O(new_n58_));
  oai21  g23(.a(new_n57_), .b(x08), .c(new_n58_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z07));
  buf    g26(.a(x09), .O(z00));
  buf    g27(.a(x11), .O(z02));
