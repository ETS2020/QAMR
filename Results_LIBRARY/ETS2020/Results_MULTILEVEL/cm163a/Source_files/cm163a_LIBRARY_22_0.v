...
module FAU ( 
  ...
  nand2  g11(.a(new_n33_), .b(new_n23_), .O(new_n34_));
  nor3   g12(.a(x12), .b(x11), .c(x09), .O(new_n35_));
  aoi22  g13(.a(new_n35_), .b(new_n23_), .c(new_n34_), .d(x12), .O(new_n36_));
  inv1   g14(.a(x06), .O(new_n37_));
  aoi21  g15(.a(new_n37_), .b(new_n28_), .c(new_n29_), .O(new_n38_));
  oai21  g16(.a(new_n36_), .b(new_n28_), .c(new_n38_), .O(z2));
  inv1   g17(.a(new_n24_), .O(new_n40_));
  nor2   g18(.a(x12), .b(x11), .O(new_n41_));
  nand4  g19(.a(new_n41_), .b(new_n22_), .c(x03), .d(x02), .O(new_n42_));
  ...
  aoi21  g23(.a(new_n45_), .b(new_n28_), .c(new_n29_), .O(new_n46_));
  oai21  g24(.a(new_n44_), .b(new_n28_), .c(new_n46_), .O(z3));
