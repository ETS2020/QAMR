...
module FAU ( 
  ...
  nand2  g29(.a(x08), .b(x04), .O(new_n80_));
  nand2  g30(.a(x20), .b(x19), .O(new_n81_));
  nand4  g31(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n82_));
  nand3  g32(.a(new_n82_), .b(x22), .c(x21), .O(new_n83_));
  oai21  g33(.a(new_n83_), .b(new_n81_), .c(x23), .O(new_n84_));
  inv1   g34(.a(x22), .O(new_n85_));
  nor2   g35(.a(x23), .b(new_n85_), .O(new_n86_));
  nand2  g36(.a(new_n86_), .b(x21), .O(new_n87_));
  oai21  g37(.a(new_n87_), .b(new_n81_), .c(new_n84_), .O(new_n88_));
  nand4  g38(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n80_), .O(z13));
