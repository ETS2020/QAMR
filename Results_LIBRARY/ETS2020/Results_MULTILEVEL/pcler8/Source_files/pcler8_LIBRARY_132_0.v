...
module FAU ( 
  ...
  nand4  g67(.a(new_n112_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n113_));
  ...
  nor2   g73(.a(new_n109_), .b(new_n100_), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nor2   g75(.a(x26), .b(new_n121_), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n92_), .c(new_n120_), .d(new_n65_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n119_), .O(new_n124_));
