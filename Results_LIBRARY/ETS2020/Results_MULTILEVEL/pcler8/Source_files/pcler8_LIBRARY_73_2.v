...
module FAU ( 
  ...
  nand3  g37(.a(new_n86_), .b(new_n85_), .c(x21), .O(new_n87_));
  nand2  g38(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand4  g39(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n79_), .O(z12));
  nand2  g41(.a(x08), .b(x04), .O(new_n91_));
  nand4  g42(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n92_));
  nand3  g43(.a(new_n92_), .b(x22), .c(x21), .O(new_n93_));
  oai21  g44(.a(new_n93_), .b(new_n80_), .c(x23), .O(new_n94_));
  inv1   g45(.a(x23), .O(new_n95_));
  nand4  g46(.a(new_n86_), .b(new_n95_), .c(x22), .d(x21), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand4  g48(.a(new_n97_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n91_), .O(z13));
  nand3  g50(.a(x21), .b(x20), .c(x19), .O(new_n100_));
  nand3  g51(.a(x26), .b(x25), .c(x16), .O(new_n101_));
  nand3  g52(.a(new_n101_), .b(x23), .c(x22), .O(new_n102_));
  oai21  g53(.a(new_n102_), .b(new_n100_), .c(x24), .O(new_n103_));
  inv1   g54(.a(new_n100_), .O(new_n104_));
  nor2   g55(.a(x24), .b(new_n95_), .O(new_n105_));
  nand3  g56(.a(new_n105_), .b(new_n104_), .c(x22), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n108_));
  oai21  g59(.a(new_n46_), .b(new_n61_), .c(new_n108_), .O(z14));
  nand2  g60(.a(x26), .b(x17), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(x24), .c(x23), .d(x22), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n100_), .c(x25), .O(new_n112_));
  inv1   g63(.a(x25), .O(new_n113_));
  nor2   g64(.a(new_n95_), .b(new_n85_), .O(new_n114_));
  nand4  g65(.a(new_n114_), .b(new_n104_), .c(new_n113_), .d(x24), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n117_));
  oai21  g68(.a(new_n46_), .b(new_n63_), .c(new_n117_), .O(z15));
  zero   g69(.O(z03));
  zero   g70(.O(z04));
  zero   g71(.O(z05));
  zero   g72(.O(z08));
