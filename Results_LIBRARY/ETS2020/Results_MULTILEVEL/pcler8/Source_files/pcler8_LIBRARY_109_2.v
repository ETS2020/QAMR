// Benchmark "FAU" written by ABC on Fri Jul 24 18:06:51 2020
...
module FAU ( 
  ...
  nand2  g29(.a(x26), .b(x17), .O(new_n82_));
  nand4  g30(.a(new_n82_), .b(x24), .c(x23), .d(x22), .O(new_n83_));
  oai21  g31(.a(new_n83_), .b(new_n81_), .c(x25), .O(new_n84_));
  inv1   g32(.a(new_n81_), .O(new_n85_));
  inv1   g33(.a(x24), .O(new_n86_));
  nor2   g34(.a(x25), .b(new_n86_), .O(new_n87_));
  nand4  g35(.a(new_n87_), .b(new_n85_), .c(x23), .d(x22), .O(new_n88_));
