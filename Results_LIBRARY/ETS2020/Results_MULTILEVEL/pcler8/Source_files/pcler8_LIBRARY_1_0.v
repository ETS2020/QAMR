...
module FAU ( 
  ...
  nand3  g52(.a(new_n96_), .b(new_n70_), .c(x21), .O(new_n97_));
  ...
  inv1   g74(.a(x18), .O(new_n120_));
  nand4  g75(.a(x21), .b(x20), .c(x19), .d(new_n120_), .O(new_n121_));
  nand4  g76(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g77(.a(new_n122_), .b(new_n121_), .c(x26), .O(new_n123_));
  nor2   g78(.a(new_n113_), .b(new_n104_), .O(new_n124_));
  inv1   g79(.a(x25), .O(new_n125_));
  nor2   g80(.a(x26), .b(new_n125_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n96_), .c(new_n124_), .d(new_n71_), .O(new_n127_));
