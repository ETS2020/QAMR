...
module FAU ( 
  ...
  oai21  g39(.a(new_n89_), .b(new_n77_), .c(x23), .O(new_n90_));
  inv1   g40(.a(x23), .O(new_n91_));
  nand4  g41(.a(new_n82_), .b(new_n91_), .c(x22), .d(x21), .O(new_n92_));
  nand2  g42(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand4  g43(.a(new_n93_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n87_), .O(z13));
  ...
  nand3  g49(.a(new_n82_), .b(x22), .c(x21), .O(new_n102_));
  ...
  nand2  g53(.a(new_n105_), .b(new_n63_), .O(z16));
  zero   g54(.O(z01));
  zero   g55(.O(z02));
  zero   g56(.O(z05));
  zero   g57(.O(z07));
