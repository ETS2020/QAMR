// Benchmark "FAU" written by ABC on Fri Jul 24 18:06:32 2020
...
module FAU ( 
  ...
  nand4  g27(.a(new_n71_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n72_));
  oai21  g28(.a(new_n46_), .b(new_n54_), .c(new_n72_), .O(z09));
  ...
  oai21  g33(.a(x20), .b(new_n74_), .c(new_n77_), .O(new_n78_));
  nand4  g34(.a(new_n78_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n56_), .O(z10));
  ...
  oai21  g39(.a(new_n83_), .b(new_n74_), .c(x21), .O(new_n84_));
  ...
  oai21  g44(.a(new_n46_), .b(new_n58_), .c(new_n88_), .O(z11));
  nand2  g45(.a(x20), .b(x19), .O(new_n90_));
  nand2  g46(.a(x23), .b(x14), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n82_), .c(x21), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n90_), .c(x22), .O(new_n93_));
  inv1   g49(.a(x22), .O(new_n94_));
  inv1   g50(.a(new_n90_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n94_), .c(x21), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n98_));
  oai21  g54(.a(new_n46_), .b(new_n60_), .c(new_n98_), .O(z12));
  ...
  inv1   g67(.a(new_n108_), .O(new_n112_));
  nor2   g68(.a(x24), .b(new_n103_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(x22), .O(new_n114_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n108_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nor2   g77(.a(new_n103_), .b(new_n94_), .O(new_n122_));
  nand4  g78(.a(new_n112_), .b(new_n122_), .c(new_n121_), .d(x24), .O(new_n123_));
