...
module FAU ( 
  ...
  nand2  g46(.a(x08), .b(x06), .O(new_n97_));
  ...
  nor2   g52(.a(new_n91_), .b(new_n82_), .O(new_n103_));
  nand3  g53(.a(new_n103_), .b(new_n102_), .c(x24), .O(new_n104_));
  oai21  g54(.a(new_n104_), .b(new_n98_), .c(new_n101_), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n97_), .O(z15));
  inv1   g57(.a(x18), .O(new_n108_));
  nand4  g58(.a(x21), .b(x20), .c(x19), .d(new_n108_), .O(new_n109_));
  nand4  g59(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n110_));
  oai21  g60(.a(new_n110_), .b(new_n109_), .c(x26), .O(new_n111_));
  nand3  g61(.a(new_n83_), .b(x22), .c(x21), .O(new_n112_));
  nand4  g62(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n113_));
  oai21  g63(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n64_), .O(z16));
  zero   g66(.O(z01));
  zero   g67(.O(z06));
  zero   g68(.O(z07));
  zero   g69(.O(z09));
