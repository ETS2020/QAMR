...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n46_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_, new_n59_,
  ...
  nand2  g24(.a(x08), .b(x01), .O(new_n71_));
  nand3  g25(.a(x22), .b(x21), .c(x12), .O(new_n72_));
  oai21  g26(.a(new_n72_), .b(new_n67_), .c(x19), .O(new_n73_));
  nand2  g27(.a(new_n73_), .b(x20), .O(new_n74_));
  inv1   g28(.a(x20), .O(new_n75_));
  nand2  g29(.a(new_n75_), .b(x19), .O(new_n76_));
  nand2  g30(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand4  g31(.a(new_n77_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n71_), .O(z10));
  inv1   g33(.a(x19), .O(new_n80_));
  nand3  g34(.a(x23), .b(x22), .c(x13), .O(new_n81_));
  nand3  g35(.a(x26), .b(x25), .c(x24), .O(new_n82_));
  oai21  g36(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n80_), .c(x21), .O(new_n84_));
  nand3  g38(.a(new_n63_), .b(x20), .c(x19), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n49_), .O(z11));
  nand2  g42(.a(x20), .b(x19), .O(new_n89_));
  nand2  g43(.a(x23), .b(x14), .O(new_n90_));
  oai21  g44(.a(new_n90_), .b(new_n82_), .c(x21), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n89_), .c(x22), .O(new_n92_));
  inv1   g46(.a(new_n89_), .O(new_n93_));
  nand3  g47(.a(new_n93_), .b(new_n64_), .c(x21), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g49(.a(new_n95_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n51_), .O(z12));
  nand4  g51(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(x22), .c(x21), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n89_), .c(x23), .O(new_n100_));
  inv1   g54(.a(x23), .O(new_n101_));
  nand4  g55(.a(new_n93_), .b(new_n101_), .c(x22), .d(x21), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g57(.a(new_n103_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n53_), .O(z13));
  ...
  nand2  g68(.a(new_n114_), .b(new_n55_), .O(z14));
  ...
  nor2   g73(.a(new_n101_), .b(new_n64_), .O(new_n120_));
  ...
  nor2   g82(.a(new_n110_), .b(new_n101_), .O(new_n129_));
  nor2   g83(.a(x26), .b(new_n119_), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n93_), .c(new_n129_), .d(new_n65_), .O(new_n131_));
