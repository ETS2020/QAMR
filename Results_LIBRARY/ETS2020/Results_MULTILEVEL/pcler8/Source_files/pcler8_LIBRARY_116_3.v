...
module FAU ( 
  ...
  nor2   g78(.a(new_n105_), .b(new_n70_), .O(new_n124_));
  ...
  nand4  g89(.a(new_n134_), .b(new_n97_), .c(new_n133_), .d(new_n71_), .O(new_n135_));
