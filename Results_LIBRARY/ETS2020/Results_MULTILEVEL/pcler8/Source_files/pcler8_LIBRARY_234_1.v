...
module FAU ( 
  ...
  nor2   g11(.a(new_n46_), .b(new_n56_), .O(z03));
  inv1   g12(.a(x03), .O(new_n58_));
  nor2   g13(.a(new_n46_), .b(new_n58_), .O(z04));
  inv1   g14(.a(x04), .O(new_n60_));
  nor2   g15(.a(new_n46_), .b(new_n60_), .O(z05));
  ...
  nand4  g47(.a(x21), .b(x20), .c(x19), .d(new_n98_), .O(new_n99_));
  nand4  g48(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n100_));
  oai21  g49(.a(new_n100_), .b(new_n99_), .c(x26), .O(new_n101_));
  nand3  g50(.a(new_n83_), .b(x22), .c(x21), .O(new_n102_));
  nand4  g51(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n103_));
  oai21  g52(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand4  g53(.a(new_n104_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n105_));
  nand2  g54(.a(new_n105_), .b(new_n64_), .O(z16));
  zero   g55(.O(z02));
  zero   g56(.O(z06));
  zero   g57(.O(z07));
  zero   g58(.O(z09));
