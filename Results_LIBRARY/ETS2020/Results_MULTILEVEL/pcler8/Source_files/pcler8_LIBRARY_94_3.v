// Benchmark "FAU" written by ABC on Fri Jul 24 18:06:47 2020
...
module FAU ( 
  ...
  nor2   g71(.a(new_n116_), .b(new_n70_), .O(new_n117_));
  nand4  g72(.a(new_n107_), .b(new_n117_), .c(new_n115_), .d(x24), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n114_), .O(new_n119_));
  ...
  nor2   g80(.a(new_n106_), .b(new_n116_), .O(new_n126_));
  nor2   g81(.a(x26), .b(new_n115_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n96_), .c(new_n126_), .d(new_n71_), .O(new_n128_));
