// Benchmark "FAU" written by ABC on Fri Jul 24 18:06:55 2020
...
module FAU ( 
  ...
  nand2  g47(.a(x08), .b(x07), .O(new_n99_));
  inv1   g48(.a(x18), .O(new_n100_));
  nand4  g49(.a(x21), .b(x20), .c(x19), .d(new_n100_), .O(new_n101_));
  nand4  g50(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n102_));
  oai21  g51(.a(new_n102_), .b(new_n101_), .c(x26), .O(new_n103_));
  nand4  g52(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n104_));
  and2   g53(.a(x24), .b(x23), .O(new_n105_));
  nand3  g54(.a(new_n105_), .b(new_n45_), .c(x25), .O(new_n106_));
  oai21  g55(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(new_n107_));
  nand4  g56(.a(new_n107_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n99_), .O(z16));
  zero   g58(.O(z03));
  zero   g59(.O(z04));
  zero   g60(.O(z05));
  zero   g61(.O(z08));
