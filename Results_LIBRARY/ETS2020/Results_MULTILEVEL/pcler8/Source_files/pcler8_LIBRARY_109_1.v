...
module FAU ( 
  ...
  nand2  g45(.a(x08), .b(x05), .O(new_n96_));
  nand3  g46(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  nand3  g47(.a(x26), .b(x25), .c(x16), .O(new_n98_));
  nand3  g48(.a(new_n98_), .b(x23), .c(x22), .O(new_n99_));
  oai21  g49(.a(new_n99_), .b(new_n97_), .c(x24), .O(new_n100_));
  nor2   g50(.a(x24), .b(new_n91_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(x22), .O(new_n102_));
  oai21  g52(.a(new_n102_), .b(new_n97_), .c(new_n100_), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n96_), .O(z14));
  inv1   g55(.a(x18), .O(new_n107_));
  nand4  g56(.a(x21), .b(x20), .c(x19), .d(new_n107_), .O(new_n108_));
  nand4  g57(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n109_));
  oai21  g58(.a(new_n109_), .b(new_n108_), .c(x26), .O(new_n110_));
  nand3  g59(.a(new_n83_), .b(x22), .c(x21), .O(new_n111_));
  nand4  g60(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n112_));
  oai21  g61(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand4  g62(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n64_), .O(z16));
  zero   g64(.O(z01));
  zero   g65(.O(z02));
  zero   g66(.O(z06));
  zero   g67(.O(z07));
