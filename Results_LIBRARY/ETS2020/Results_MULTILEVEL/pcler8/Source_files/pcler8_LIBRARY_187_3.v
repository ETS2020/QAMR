// Benchmark "FAU" written by ABC on Fri Jul 24 18:07:16 2020
...
module FAU ( 
  ...
  nand2  g42(.a(x20), .b(x19), .O(new_n89_));
  nand4  g43(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(x22), .c(x21), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n89_), .c(x23), .O(new_n92_));
  inv1   g46(.a(x23), .O(new_n93_));
  inv1   g47(.a(new_n89_), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n93_), .c(x22), .d(x21), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n53_), .O(z13));
  nand3  g52(.a(x21), .b(x20), .c(x19), .O(new_n99_));
  nand3  g53(.a(x26), .b(x25), .c(x16), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(x23), .c(x22), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n99_), .c(x24), .O(new_n102_));
  inv1   g56(.a(x24), .O(new_n103_));
  inv1   g57(.a(new_n99_), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n103_), .c(x23), .d(x22), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n55_), .O(z14));
  nand2  g62(.a(x26), .b(x17), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(x24), .c(x23), .d(x22), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n99_), .c(x25), .O(new_n111_));
  inv1   g65(.a(x25), .O(new_n112_));
  nor2   g66(.a(new_n93_), .b(new_n64_), .O(new_n113_));
  nand4  g67(.a(new_n104_), .b(new_n113_), .c(new_n112_), .d(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n57_), .O(z15));
  inv1   g71(.a(x18), .O(new_n118_));
  nand4  g72(.a(x21), .b(x20), .c(x19), .d(new_n118_), .O(new_n119_));
  nand4  g73(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n119_), .c(x26), .O(new_n121_));
  nor2   g75(.a(new_n103_), .b(new_n93_), .O(new_n122_));
  nor2   g76(.a(x26), .b(new_n112_), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n94_), .c(new_n122_), .d(new_n65_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n62_), .c(x09), .d(new_n61_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n59_), .O(z16));
  zero   g81(.O(z00));
  zero   g82(.O(z12));
endmodule
