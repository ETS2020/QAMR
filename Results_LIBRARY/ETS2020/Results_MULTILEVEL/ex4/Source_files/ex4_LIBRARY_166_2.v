// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:33 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n264_, new_n265_, new_n266_, new_n274_, new_n275_, new_n276_,
  ...
  oai22  g110(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n274_));
  nand3  g111(.a(new_n274_), .b(x084), .c(x004), .O(new_n275_));
  oai22  g112(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n276_));
  nand3  g113(.a(new_n276_), .b(x068), .c(x020), .O(new_n277_));
  aoi22  g114(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n278_));
  nand3  g115(.a(new_n278_), .b(new_n277_), .c(new_n275_), .O(new_n279_));
  and2   g116(.a(new_n279_), .b(new_n197_), .O(z12));
  inv1   g117(.a(x077), .O(new_n281_));
  nand2  g118(.a(x021), .b(x013), .O(new_n282_));
  oai21  g119(.a(new_n252_), .b(x029), .c(new_n282_), .O(new_n283_));
  nor2   g120(.a(x125), .b(x101), .O(new_n284_));
  nor2   g121(.a(x117), .b(x109), .O(new_n285_));
  oai21  g122(.a(new_n284_), .b(x093), .c(new_n285_), .O(new_n286_));
  nand2  g123(.a(new_n286_), .b(new_n242_), .O(new_n287_));
  oai21  g124(.a(new_n230_), .b(x109), .c(x037), .O(new_n288_));
  nand2  g125(.a(new_n288_), .b(x117), .O(new_n289_));
  inv1   g126(.a(x101), .O(new_n290_));
  oai21  g127(.a(new_n290_), .b(x061), .c(new_n225_), .O(new_n291_));
  nand3  g128(.a(x125), .b(new_n223_), .c(new_n215_), .O(new_n292_));
  nand2  g129(.a(new_n292_), .b(new_n238_), .O(new_n293_));
  aoi21  g130(.a(new_n291_), .b(new_n224_), .c(new_n293_), .O(new_n294_));
  nand4  g131(.a(new_n294_), .b(new_n289_), .c(new_n287_), .d(new_n283_), .O(new_n295_));
  nand4  g132(.a(x125), .b(new_n228_), .c(new_n224_), .d(x013), .O(new_n296_));
  inv1   g133(.a(new_n296_), .O(new_n297_));
  aoi21  g134(.a(new_n295_), .b(new_n281_), .c(new_n297_), .O(new_n298_));
  nand3  g135(.a(x085), .b(new_n224_), .c(new_n214_), .O(new_n299_));
  oai21  g136(.a(new_n298_), .b(x053), .c(new_n299_), .O(new_n300_));
  nand2  g137(.a(new_n300_), .b(x005), .O(new_n301_));
  nand2  g138(.a(new_n217_), .b(x029), .O(new_n302_));
  nand2  g139(.a(new_n302_), .b(new_n215_), .O(new_n303_));
  nand2  g140(.a(new_n303_), .b(new_n281_), .O(new_n304_));
  aoi21  g141(.a(new_n304_), .b(new_n214_), .c(new_n285_), .O(new_n305_));
  nor2   g142(.a(new_n213_), .b(x021), .O(new_n306_));
  oai21  g143(.a(new_n306_), .b(new_n252_), .c(x069), .O(new_n307_));
  inv1   g144(.a(new_n284_), .O(new_n308_));
  nand4  g145(.a(new_n308_), .b(new_n282_), .c(new_n217_), .d(x029), .O(new_n309_));
  aoi21  g146(.a(new_n309_), .b(new_n307_), .c(x077), .O(new_n310_));
  oai21  g147(.a(new_n310_), .b(new_n305_), .c(new_n212_), .O(new_n311_));
  nand2  g148(.a(new_n282_), .b(x029), .O(new_n312_));
  nand2  g149(.a(new_n312_), .b(new_n248_), .O(new_n313_));
  nand3  g150(.a(new_n313_), .b(new_n281_), .c(x037), .O(new_n314_));
  nand2  g151(.a(new_n314_), .b(new_n311_), .O(new_n315_));
  oai22  g152(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n316_));
  nand3  g153(.a(new_n316_), .b(x069), .c(x021), .O(new_n317_));
  aoi22  g154(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n318_));
  nand2  g155(.a(new_n318_), .b(new_n317_), .O(new_n319_));
  aoi21  g156(.a(new_n315_), .b(new_n238_), .c(new_n319_), .O(new_n320_));
  aoi21  g157(.a(new_n320_), .b(new_n301_), .c(x045), .O(z13));
  zero   g158(.O(z00));
  zero   g159(.O(z06));
  zero   g160(.O(z07));
  zero   g161(.O(z08));
