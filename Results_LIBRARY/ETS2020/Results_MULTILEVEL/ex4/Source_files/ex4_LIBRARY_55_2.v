...
module FAU ( 
  ...
  inv1   g159(.a(x078), .O(new_n322_));
  nand2  g160(.a(x022), .b(x014), .O(new_n323_));
  inv1   g161(.a(x062), .O(new_n324_));
  inv1   g162(.a(x094), .O(new_n325_));
  nand2  g163(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  oai21  g164(.a(new_n326_), .b(x030), .c(new_n323_), .O(new_n327_));
  inv1   g165(.a(x070), .O(new_n328_));
  nor2   g166(.a(x126), .b(x102), .O(new_n329_));
  nor2   g167(.a(x118), .b(x110), .O(new_n330_));
  oai21  g168(.a(new_n329_), .b(x094), .c(new_n330_), .O(new_n331_));
  nand2  g169(.a(new_n331_), .b(new_n328_), .O(new_n332_));
  inv1   g170(.a(x126), .O(new_n333_));
  oai21  g171(.a(new_n333_), .b(x110), .c(x038), .O(new_n334_));
  nand2  g172(.a(new_n334_), .b(x118), .O(new_n335_));
  inv1   g173(.a(x038), .O(new_n336_));
  inv1   g174(.a(x102), .O(new_n337_));
  inv1   g175(.a(x110), .O(new_n338_));
  oai21  g176(.a(new_n337_), .b(x062), .c(new_n338_), .O(new_n339_));
  inv1   g177(.a(x086), .O(new_n340_));
  inv1   g178(.a(x022), .O(new_n341_));
  inv1   g179(.a(x118), .O(new_n342_));
  nand3  g180(.a(x126), .b(new_n342_), .c(new_n341_), .O(new_n343_));
  nand2  g181(.a(new_n343_), .b(new_n340_), .O(new_n344_));
  aoi21  g182(.a(new_n339_), .b(new_n336_), .c(new_n344_), .O(new_n345_));
  nand4  g183(.a(new_n345_), .b(new_n335_), .c(new_n332_), .d(new_n327_), .O(new_n346_));
  nand4  g184(.a(x126), .b(new_n324_), .c(new_n336_), .d(x014), .O(new_n347_));
  inv1   g185(.a(new_n347_), .O(new_n348_));
  aoi21  g186(.a(new_n346_), .b(new_n322_), .c(new_n348_), .O(new_n349_));
  inv1   g187(.a(x014), .O(new_n350_));
  nand3  g188(.a(x086), .b(new_n336_), .c(new_n350_), .O(new_n351_));
  oai21  g189(.a(new_n349_), .b(x054), .c(new_n351_), .O(new_n352_));
  nand2  g190(.a(new_n352_), .b(x006), .O(new_n353_));
  nand2  g191(.a(x094), .b(x062), .O(new_n354_));
  nand2  g192(.a(new_n354_), .b(x030), .O(new_n355_));
  nand2  g193(.a(new_n355_), .b(new_n341_), .O(new_n356_));
  nand2  g194(.a(new_n356_), .b(new_n322_), .O(new_n357_));
  aoi21  g195(.a(new_n357_), .b(new_n350_), .c(new_n330_), .O(new_n358_));
  inv1   g196(.a(x030), .O(new_n359_));
  nor2   g197(.a(new_n359_), .b(x022), .O(new_n360_));
  oai21  g198(.a(new_n360_), .b(new_n326_), .c(x070), .O(new_n361_));
  inv1   g199(.a(new_n329_), .O(new_n362_));
  nand4  g200(.a(new_n354_), .b(new_n362_), .c(new_n323_), .d(x030), .O(new_n363_));
  aoi21  g201(.a(new_n363_), .b(new_n361_), .c(x078), .O(new_n364_));
  nor2   g202(.a(new_n364_), .b(new_n358_), .O(new_n365_));
  nand2  g203(.a(new_n323_), .b(x030), .O(new_n366_));
  nand3  g204(.a(new_n366_), .b(new_n325_), .c(new_n324_), .O(new_n367_));
  nand3  g205(.a(new_n367_), .b(new_n322_), .c(x038), .O(new_n368_));
  oai21  g206(.a(new_n365_), .b(x054), .c(new_n368_), .O(new_n369_));
  oai22  g207(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n370_));
  nand3  g208(.a(new_n370_), .b(x070), .c(x022), .O(new_n371_));
  aoi22  g209(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n372_));
  nand2  g210(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  aoi21  g211(.a(new_n369_), .b(new_n340_), .c(new_n373_), .O(new_n374_));
  aoi21  g212(.a(new_n374_), .b(new_n353_), .c(x046), .O(z14));
  zero   g213(.O(z00));
  zero   g214(.O(z04));
  zero   g215(.O(z06));
  zero   g216(.O(z07));
