// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:43 2020
...
module FAU ( 
  ...
  aoi22  g235(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n396_));
  nand3  g236(.a(new_n396_), .b(new_n395_), .c(new_n393_), .O(new_n397_));
  and2   g237(.a(new_n397_), .b(new_n212_), .O(z12));
  inv1   g238(.a(x077), .O(new_n399_));
  nand2  g239(.a(x021), .b(x013), .O(new_n400_));
  oai21  g240(.a(new_n267_), .b(x029), .c(new_n400_), .O(new_n401_));
  nor2   g241(.a(x125), .b(x101), .O(new_n402_));
  nor2   g242(.a(x117), .b(x109), .O(new_n403_));
  oai21  g243(.a(new_n402_), .b(x093), .c(new_n403_), .O(new_n404_));
  nand2  g244(.a(new_n404_), .b(new_n257_), .O(new_n405_));
  oai21  g245(.a(new_n245_), .b(x109), .c(x037), .O(new_n406_));
  nand2  g246(.a(new_n406_), .b(x117), .O(new_n407_));
  inv1   g247(.a(x101), .O(new_n408_));
  oai21  g248(.a(new_n408_), .b(x061), .c(new_n240_), .O(new_n409_));
  nand3  g249(.a(x125), .b(new_n238_), .c(new_n230_), .O(new_n410_));
  nand2  g250(.a(new_n410_), .b(new_n253_), .O(new_n411_));
  aoi21  g251(.a(new_n409_), .b(new_n239_), .c(new_n411_), .O(new_n412_));
  nand4  g252(.a(new_n412_), .b(new_n407_), .c(new_n405_), .d(new_n401_), .O(new_n413_));
  nand4  g253(.a(x125), .b(new_n243_), .c(new_n239_), .d(x013), .O(new_n414_));
  inv1   g254(.a(new_n414_), .O(new_n415_));
  aoi21  g255(.a(new_n413_), .b(new_n399_), .c(new_n415_), .O(new_n416_));
  nand3  g256(.a(x085), .b(new_n239_), .c(new_n229_), .O(new_n417_));
  oai21  g257(.a(new_n416_), .b(x053), .c(new_n417_), .O(new_n418_));
  nand2  g258(.a(new_n418_), .b(x005), .O(new_n419_));
  nand2  g259(.a(new_n232_), .b(x029), .O(new_n420_));
  nand2  g260(.a(new_n420_), .b(new_n230_), .O(new_n421_));
  nand2  g261(.a(new_n421_), .b(new_n399_), .O(new_n422_));
  aoi21  g262(.a(new_n422_), .b(new_n229_), .c(new_n403_), .O(new_n423_));
  nor2   g263(.a(new_n228_), .b(x021), .O(new_n424_));
  oai21  g264(.a(new_n424_), .b(new_n267_), .c(x069), .O(new_n425_));
  inv1   g265(.a(new_n402_), .O(new_n426_));
  nand4  g266(.a(new_n426_), .b(new_n400_), .c(new_n232_), .d(x029), .O(new_n427_));
  aoi21  g267(.a(new_n427_), .b(new_n425_), .c(x077), .O(new_n428_));
  oai21  g268(.a(new_n428_), .b(new_n423_), .c(new_n227_), .O(new_n429_));
  nand2  g269(.a(new_n400_), .b(x029), .O(new_n430_));
  nand2  g270(.a(new_n430_), .b(new_n263_), .O(new_n431_));
  nand3  g271(.a(new_n431_), .b(new_n399_), .c(x037), .O(new_n432_));
  nand2  g272(.a(new_n432_), .b(new_n429_), .O(new_n433_));
  oai22  g273(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n434_));
  nand3  g274(.a(new_n434_), .b(x069), .c(x021), .O(new_n435_));
  aoi22  g275(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n436_));
  nand2  g276(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  aoi21  g277(.a(new_n433_), .b(new_n253_), .c(new_n437_), .O(new_n438_));
  aoi21  g278(.a(new_n438_), .b(new_n419_), .c(x045), .O(z13));
  nand2  g279(.a(x022), .b(x014), .O(new_n440_));
  oai21  g280(.a(new_n324_), .b(x030), .c(new_n440_), .O(new_n441_));
  nor2   g281(.a(x126), .b(x102), .O(new_n442_));
  nor2   g282(.a(x118), .b(x110), .O(new_n443_));
  oai21  g283(.a(new_n442_), .b(x094), .c(new_n443_), .O(new_n444_));
  nand2  g284(.a(new_n444_), .b(new_n321_), .O(new_n445_));
  oai21  g285(.a(new_n304_), .b(x110), .c(x038), .O(new_n446_));
  nand2  g286(.a(new_n446_), .b(x118), .O(new_n447_));
  inv1   g287(.a(x102), .O(new_n448_));
  oai21  g288(.a(new_n448_), .b(x062), .c(new_n294_), .O(new_n449_));
  nand3  g289(.a(x126), .b(new_n295_), .c(new_n288_), .O(new_n450_));
  nand2  g290(.a(new_n450_), .b(new_n312_), .O(new_n451_));
  aoi21  g291(.a(new_n449_), .b(new_n299_), .c(new_n451_), .O(new_n452_));
  nand4  g292(.a(new_n452_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n453_));
  nand4  g293(.a(x126), .b(new_n302_), .c(new_n299_), .d(x014), .O(new_n454_));
  inv1   g294(.a(new_n454_), .O(new_n455_));
  aoi21  g295(.a(new_n453_), .b(new_n320_), .c(new_n455_), .O(new_n456_));
  nand3  g296(.a(x086), .b(new_n299_), .c(new_n287_), .O(new_n457_));
  oai21  g297(.a(new_n456_), .b(x054), .c(new_n457_), .O(new_n458_));
  nand2  g298(.a(new_n458_), .b(x006), .O(new_n459_));
  nand2  g299(.a(new_n290_), .b(x030), .O(new_n460_));
  nand2  g300(.a(new_n460_), .b(new_n288_), .O(new_n461_));
  nand2  g301(.a(new_n461_), .b(new_n320_), .O(new_n462_));
  aoi21  g302(.a(new_n462_), .b(new_n287_), .c(new_n443_), .O(new_n463_));
  nor2   g303(.a(new_n286_), .b(x022), .O(new_n464_));
  oai21  g304(.a(new_n464_), .b(new_n324_), .c(x070), .O(new_n465_));
  inv1   g305(.a(new_n442_), .O(new_n466_));
  nand4  g306(.a(new_n466_), .b(new_n440_), .c(new_n290_), .d(x030), .O(new_n467_));
  aoi21  g307(.a(new_n467_), .b(new_n465_), .c(x078), .O(new_n468_));
  oai21  g308(.a(new_n468_), .b(new_n463_), .c(new_n285_), .O(new_n469_));
  nand2  g309(.a(new_n440_), .b(x030), .O(new_n470_));
  nand2  g310(.a(new_n470_), .b(new_n316_), .O(new_n471_));
  nand3  g311(.a(new_n471_), .b(new_n320_), .c(x038), .O(new_n472_));
  nand2  g312(.a(new_n472_), .b(new_n469_), .O(new_n473_));
  oai22  g313(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n474_));
  nand3  g314(.a(new_n474_), .b(x070), .c(x022), .O(new_n475_));
  aoi22  g315(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n476_));
  nand2  g316(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  aoi21  g317(.a(new_n473_), .b(new_n312_), .c(new_n477_), .O(new_n478_));
  aoi21  g318(.a(new_n478_), .b(new_n459_), .c(x046), .O(z14));
  zero   g319(.O(z07));
  zero   g320(.O(z09));
  zero   g321(.O(z10));
  zero   g322(.O(z11));
