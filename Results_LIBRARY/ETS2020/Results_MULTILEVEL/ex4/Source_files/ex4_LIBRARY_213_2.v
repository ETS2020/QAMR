...
module FAU ( 
  ...
  inv1   g103(.a(new_n265_), .O(new_n266_));
  nor2   g104(.a(new_n266_), .b(x042), .O(z10));
  oai22  g105(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n268_));
  nand3  g106(.a(new_n268_), .b(x083), .c(x003), .O(new_n269_));
  oai22  g107(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n270_));
  nand3  g108(.a(new_n270_), .b(x067), .c(x019), .O(new_n271_));
  aoi22  g109(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n272_));
  nand3  g110(.a(new_n272_), .b(new_n271_), .c(new_n269_), .O(new_n273_));
  and2   g111(.a(new_n273_), .b(new_n172_), .O(z11));
