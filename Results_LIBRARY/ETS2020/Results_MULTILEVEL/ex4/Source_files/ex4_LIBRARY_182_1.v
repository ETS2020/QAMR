// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:51 2020
...
module FAU ( 
  ...
  oai22  g173(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n333_));
  nand3  g174(.a(new_n333_), .b(x082), .c(x002), .O(new_n334_));
  oai22  g175(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n335_));
  nand3  g176(.a(new_n335_), .b(x066), .c(x018), .O(new_n336_));
  aoi22  g177(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n337_));
  nand3  g178(.a(new_n337_), .b(new_n336_), .c(new_n334_), .O(new_n338_));
  and2   g179(.a(new_n338_), .b(new_n186_), .O(z10));
  oai22  g180(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n340_));
  nand3  g181(.a(new_n340_), .b(x083), .c(x003), .O(new_n341_));
  oai22  g182(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n342_));
  nand3  g183(.a(new_n342_), .b(x067), .c(x019), .O(new_n343_));
  aoi22  g184(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n344_));
  nand3  g185(.a(new_n344_), .b(new_n343_), .c(new_n341_), .O(new_n345_));
  and2   g186(.a(new_n345_), .b(new_n199_), .O(z11));
  oai22  g187(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n347_));
  nand3  g188(.a(new_n347_), .b(x084), .c(x004), .O(new_n348_));
  oai22  g189(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n349_));
  nand3  g190(.a(new_n349_), .b(x068), .c(x020), .O(new_n350_));
  aoi22  g191(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n351_));
  nand3  g192(.a(new_n351_), .b(new_n350_), .c(new_n348_), .O(new_n352_));
  and2   g193(.a(new_n352_), .b(new_n212_), .O(z12));
  nand2  g194(.a(x022), .b(x014), .O(new_n355_));
  oai21  g195(.a(new_n267_), .b(x030), .c(new_n355_), .O(new_n356_));
  nor2   g196(.a(x126), .b(x102), .O(new_n357_));
  nor2   g197(.a(x118), .b(x110), .O(new_n358_));
  oai21  g198(.a(new_n357_), .b(x094), .c(new_n358_), .O(new_n359_));
  nand2  g199(.a(new_n359_), .b(new_n264_), .O(new_n360_));
  oai21  g200(.a(new_n247_), .b(x110), .c(x038), .O(new_n361_));
  nand2  g201(.a(new_n361_), .b(x118), .O(new_n362_));
  inv1   g202(.a(x102), .O(new_n363_));
  oai21  g203(.a(new_n363_), .b(x062), .c(new_n237_), .O(new_n364_));
  nand3  g204(.a(x126), .b(new_n238_), .c(new_n231_), .O(new_n365_));
  nand2  g205(.a(new_n365_), .b(new_n255_), .O(new_n366_));
  aoi21  g206(.a(new_n364_), .b(new_n242_), .c(new_n366_), .O(new_n367_));
  nand4  g207(.a(new_n367_), .b(new_n362_), .c(new_n360_), .d(new_n356_), .O(new_n368_));
  nand4  g208(.a(x126), .b(new_n245_), .c(new_n242_), .d(x014), .O(new_n369_));
  inv1   g209(.a(new_n369_), .O(new_n370_));
  aoi21  g210(.a(new_n368_), .b(new_n263_), .c(new_n370_), .O(new_n371_));
  nand3  g211(.a(x086), .b(new_n242_), .c(new_n230_), .O(new_n372_));
  oai21  g212(.a(new_n371_), .b(x054), .c(new_n372_), .O(new_n373_));
  nand2  g213(.a(new_n373_), .b(x006), .O(new_n374_));
  nand2  g214(.a(new_n233_), .b(x030), .O(new_n375_));
  nand2  g215(.a(new_n375_), .b(new_n231_), .O(new_n376_));
  nand2  g216(.a(new_n376_), .b(new_n263_), .O(new_n377_));
  aoi21  g217(.a(new_n377_), .b(new_n230_), .c(new_n358_), .O(new_n378_));
  nor2   g218(.a(new_n229_), .b(x022), .O(new_n379_));
  oai21  g219(.a(new_n379_), .b(new_n267_), .c(x070), .O(new_n380_));
  inv1   g220(.a(new_n357_), .O(new_n381_));
  nand4  g221(.a(new_n381_), .b(new_n355_), .c(new_n233_), .d(x030), .O(new_n382_));
  aoi21  g222(.a(new_n382_), .b(new_n380_), .c(x078), .O(new_n383_));
  oai21  g223(.a(new_n383_), .b(new_n378_), .c(new_n228_), .O(new_n384_));
  nand2  g224(.a(new_n355_), .b(x030), .O(new_n385_));
  nand2  g225(.a(new_n385_), .b(new_n259_), .O(new_n386_));
  nand3  g226(.a(new_n386_), .b(new_n263_), .c(x038), .O(new_n387_));
  nand2  g227(.a(new_n387_), .b(new_n384_), .O(new_n388_));
  oai22  g228(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n389_));
  nand3  g229(.a(new_n389_), .b(x070), .c(x022), .O(new_n390_));
  aoi22  g230(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n391_));
  nand2  g231(.a(new_n391_), .b(new_n390_), .O(new_n392_));
  aoi21  g232(.a(new_n388_), .b(new_n255_), .c(new_n392_), .O(new_n393_));
  aoi21  g233(.a(new_n393_), .b(new_n374_), .c(x046), .O(z14));
  zero   g234(.O(z05));
  zero   g235(.O(z07));
  zero   g236(.O(z09));
  zero   g237(.O(z13));
