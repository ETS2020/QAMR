// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:02 2020
...
module FAU ( 
  ...
  nor2   g220(.a(new_n380_), .b(x043), .O(z11));
  oai22  g221(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n382_));
  nand3  g222(.a(new_n382_), .b(x084), .c(x004), .O(new_n383_));
  oai22  g223(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n384_));
  nand3  g224(.a(new_n384_), .b(x068), .c(x020), .O(new_n385_));
  aoi22  g225(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n386_));
  nand3  g226(.a(new_n386_), .b(new_n385_), .c(new_n383_), .O(new_n387_));
  and2   g227(.a(new_n387_), .b(new_n188_), .O(z12));
