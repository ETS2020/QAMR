// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:00 2020
...
module FAU ( 
  ...
  inv1   g148(.a(x078), .O(new_n312_));
  nand2  g149(.a(x022), .b(x014), .O(new_n313_));
  inv1   g150(.a(x062), .O(new_n314_));
  inv1   g151(.a(x094), .O(new_n315_));
  nand2  g152(.a(new_n315_), .b(new_n314_), .O(new_n316_));
  oai21  g153(.a(new_n316_), .b(x030), .c(new_n313_), .O(new_n317_));
  inv1   g154(.a(x070), .O(new_n318_));
  nor2   g155(.a(x126), .b(x102), .O(new_n319_));
  nor2   g156(.a(x118), .b(x110), .O(new_n320_));
  oai21  g157(.a(new_n319_), .b(x094), .c(new_n320_), .O(new_n321_));
  nand2  g158(.a(new_n321_), .b(new_n318_), .O(new_n322_));
  inv1   g159(.a(x126), .O(new_n323_));
  oai21  g160(.a(new_n323_), .b(x110), .c(x038), .O(new_n324_));
  nand2  g161(.a(new_n324_), .b(x118), .O(new_n325_));
  inv1   g162(.a(x038), .O(new_n326_));
  inv1   g163(.a(x102), .O(new_n327_));
  inv1   g164(.a(x110), .O(new_n328_));
  oai21  g165(.a(new_n327_), .b(x062), .c(new_n328_), .O(new_n329_));
  inv1   g166(.a(x086), .O(new_n330_));
  inv1   g167(.a(x022), .O(new_n331_));
  inv1   g168(.a(x118), .O(new_n332_));
  nand3  g169(.a(x126), .b(new_n332_), .c(new_n331_), .O(new_n333_));
  nand2  g170(.a(new_n333_), .b(new_n330_), .O(new_n334_));
  aoi21  g171(.a(new_n329_), .b(new_n326_), .c(new_n334_), .O(new_n335_));
  nand4  g172(.a(new_n335_), .b(new_n325_), .c(new_n322_), .d(new_n317_), .O(new_n336_));
  nand4  g173(.a(x126), .b(new_n314_), .c(new_n326_), .d(x014), .O(new_n337_));
  inv1   g174(.a(new_n337_), .O(new_n338_));
  aoi21  g175(.a(new_n336_), .b(new_n312_), .c(new_n338_), .O(new_n339_));
  inv1   g176(.a(x014), .O(new_n340_));
  nand3  g177(.a(x086), .b(new_n326_), .c(new_n340_), .O(new_n341_));
  oai21  g178(.a(new_n339_), .b(x054), .c(new_n341_), .O(new_n342_));
  nand2  g179(.a(new_n342_), .b(x006), .O(new_n343_));
  nand2  g180(.a(x094), .b(x062), .O(new_n344_));
  nand2  g181(.a(new_n344_), .b(x030), .O(new_n345_));
  nand2  g182(.a(new_n345_), .b(new_n331_), .O(new_n346_));
  nand2  g183(.a(new_n346_), .b(new_n312_), .O(new_n347_));
  aoi21  g184(.a(new_n347_), .b(new_n340_), .c(new_n320_), .O(new_n348_));
  inv1   g185(.a(x030), .O(new_n349_));
  nor2   g186(.a(new_n349_), .b(x022), .O(new_n350_));
  oai21  g187(.a(new_n350_), .b(new_n316_), .c(x070), .O(new_n351_));
  inv1   g188(.a(new_n319_), .O(new_n352_));
  nand4  g189(.a(new_n344_), .b(new_n352_), .c(new_n313_), .d(x030), .O(new_n353_));
  aoi21  g190(.a(new_n353_), .b(new_n351_), .c(x078), .O(new_n354_));
  nor2   g191(.a(new_n354_), .b(new_n348_), .O(new_n355_));
  nand2  g192(.a(new_n313_), .b(x030), .O(new_n356_));
  nand3  g193(.a(new_n356_), .b(new_n315_), .c(new_n314_), .O(new_n357_));
  nand3  g194(.a(new_n357_), .b(new_n312_), .c(x038), .O(new_n358_));
  oai21  g195(.a(new_n355_), .b(x054), .c(new_n358_), .O(new_n359_));
  ...
  aoi21  g200(.a(new_n359_), .b(new_n330_), .c(new_n363_), .O(new_n364_));
  aoi21  g201(.a(new_n364_), .b(new_n343_), .c(x046), .O(z14));
  zero   g202(.O(z00));
  zero   g203(.O(z03));
  zero   g204(.O(z04));
  zero   g205(.O(z06));
