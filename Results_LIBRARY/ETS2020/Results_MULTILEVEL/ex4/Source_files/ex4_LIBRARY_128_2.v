// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:48 2020
...
module FAU ( 
  ...
  oai22  g105(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n269_));
  nand3  g106(.a(new_n269_), .b(x084), .c(x004), .O(new_n270_));
  oai22  g107(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n271_));
  nand3  g108(.a(new_n271_), .b(x068), .c(x020), .O(new_n272_));
  aoi22  g109(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n273_));
  nand3  g110(.a(new_n273_), .b(new_n272_), .c(new_n270_), .O(new_n274_));
  and2   g111(.a(new_n274_), .b(new_n185_), .O(z12));
