// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:40 2020
...
module FAU ( 
  ...
  inv1   g206(.a(new_n367_), .O(new_n368_));
  nor2   g207(.a(new_n368_), .b(x043), .O(z11));
  oai22  g208(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n370_));
  nand3  g209(.a(new_n370_), .b(x084), .c(x004), .O(new_n371_));
  oai22  g210(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n372_));
  nand3  g211(.a(new_n372_), .b(x068), .c(x020), .O(new_n373_));
  aoi22  g212(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n374_));
  nand3  g213(.a(new_n374_), .b(new_n373_), .c(new_n371_), .O(new_n375_));
  and2   g214(.a(new_n375_), .b(new_n176_), .O(z12));
