// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:12 2020
...
module FAU ( 
  ...
  oai22  g110(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n271_));
  nand3  g111(.a(new_n271_), .b(x081), .c(x001), .O(new_n272_));
  oai22  g112(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n273_));
  nand3  g113(.a(new_n273_), .b(x065), .c(x017), .O(new_n274_));
  aoi22  g114(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n275_));
  nand3  g115(.a(new_n275_), .b(new_n274_), .c(new_n272_), .O(new_n276_));
  and2   g116(.a(new_n276_), .b(new_n158_), .O(z09));
  oai22  g117(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n278_));
  nand3  g118(.a(new_n278_), .b(x082), .c(x002), .O(new_n279_));
  oai22  g119(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n280_));
  nand3  g120(.a(new_n280_), .b(x066), .c(x018), .O(new_n281_));
  aoi22  g121(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n282_));
  nand3  g122(.a(new_n282_), .b(new_n281_), .c(new_n279_), .O(new_n283_));
  and2   g123(.a(new_n283_), .b(new_n171_), .O(z10));
  oai22  g124(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n285_));
  nand3  g125(.a(new_n285_), .b(x083), .c(x003), .O(new_n286_));
  oai22  g126(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n287_));
  nand3  g127(.a(new_n287_), .b(x067), .c(x019), .O(new_n288_));
  aoi22  g128(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n289_));
  nand3  g129(.a(new_n289_), .b(new_n288_), .c(new_n286_), .O(new_n290_));
  and2   g130(.a(new_n290_), .b(new_n184_), .O(z11));
  oai22  g131(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n292_));
  nand3  g132(.a(new_n292_), .b(x084), .c(x004), .O(new_n293_));
  oai22  g133(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n294_));
  nand3  g134(.a(new_n294_), .b(x068), .c(x020), .O(new_n295_));
  aoi22  g135(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n296_));
  nand3  g136(.a(new_n296_), .b(new_n295_), .c(new_n293_), .O(new_n297_));
  and2   g137(.a(new_n297_), .b(new_n197_), .O(z12));
  inv1   g138(.a(x077), .O(new_n299_));
  nand2  g139(.a(x021), .b(x013), .O(new_n300_));
  oai21  g140(.a(new_n252_), .b(x029), .c(new_n300_), .O(new_n301_));
  nor2   g141(.a(x125), .b(x101), .O(new_n302_));
  nor2   g142(.a(x117), .b(x109), .O(new_n303_));
  oai21  g143(.a(new_n302_), .b(x093), .c(new_n303_), .O(new_n304_));
  nand2  g144(.a(new_n304_), .b(new_n242_), .O(new_n305_));
  oai21  g145(.a(new_n230_), .b(x109), .c(x037), .O(new_n306_));
  nand2  g146(.a(new_n306_), .b(x117), .O(new_n307_));
  inv1   g147(.a(x101), .O(new_n308_));
  oai21  g148(.a(new_n308_), .b(x061), .c(new_n225_), .O(new_n309_));
  nand3  g149(.a(x125), .b(new_n223_), .c(new_n215_), .O(new_n310_));
  nand2  g150(.a(new_n310_), .b(new_n238_), .O(new_n311_));
  aoi21  g151(.a(new_n309_), .b(new_n224_), .c(new_n311_), .O(new_n312_));
  nand4  g152(.a(new_n312_), .b(new_n307_), .c(new_n305_), .d(new_n301_), .O(new_n313_));
  nand4  g153(.a(x125), .b(new_n228_), .c(new_n224_), .d(x013), .O(new_n314_));
  inv1   g154(.a(new_n314_), .O(new_n315_));
  aoi21  g155(.a(new_n313_), .b(new_n299_), .c(new_n315_), .O(new_n316_));
  nand3  g156(.a(x085), .b(new_n224_), .c(new_n214_), .O(new_n317_));
  oai21  g157(.a(new_n316_), .b(x053), .c(new_n317_), .O(new_n318_));
  nand2  g158(.a(new_n318_), .b(x005), .O(new_n319_));
  nand2  g159(.a(new_n217_), .b(x029), .O(new_n320_));
  nand2  g160(.a(new_n320_), .b(new_n215_), .O(new_n321_));
  nand2  g161(.a(new_n321_), .b(new_n299_), .O(new_n322_));
  aoi21  g162(.a(new_n322_), .b(new_n214_), .c(new_n303_), .O(new_n323_));
  nor2   g163(.a(new_n213_), .b(x021), .O(new_n324_));
  oai21  g164(.a(new_n324_), .b(new_n252_), .c(x069), .O(new_n325_));
  inv1   g165(.a(new_n302_), .O(new_n326_));
  nand4  g166(.a(new_n326_), .b(new_n300_), .c(new_n217_), .d(x029), .O(new_n327_));
  aoi21  g167(.a(new_n327_), .b(new_n325_), .c(x077), .O(new_n328_));
  oai21  g168(.a(new_n328_), .b(new_n323_), .c(new_n212_), .O(new_n329_));
  nand2  g169(.a(new_n300_), .b(x029), .O(new_n330_));
  nand2  g170(.a(new_n330_), .b(new_n248_), .O(new_n331_));
  nand3  g171(.a(new_n331_), .b(new_n299_), .c(x037), .O(new_n332_));
  nand2  g172(.a(new_n332_), .b(new_n329_), .O(new_n333_));
  oai22  g173(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n334_));
  nand3  g174(.a(new_n334_), .b(x069), .c(x021), .O(new_n335_));
  aoi22  g175(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n336_));
  nand2  g176(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  aoi21  g177(.a(new_n333_), .b(new_n238_), .c(new_n337_), .O(new_n338_));
  aoi21  g178(.a(new_n338_), .b(new_n319_), .c(x045), .O(z13));
  zero   g179(.O(z00));
  zero   g180(.O(z06));
  zero   g181(.O(z07));
  zero   g182(.O(z08));
