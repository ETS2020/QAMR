...
module FAU ( 
  ...
  oai22  g162(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n324_));
  nand3  g163(.a(new_n324_), .b(x084), .c(x004), .O(new_n325_));
  oai22  g164(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n326_));
  nand3  g165(.a(new_n326_), .b(x068), .c(x020), .O(new_n327_));
  aoi22  g166(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n328_));
  nand3  g167(.a(new_n328_), .b(new_n327_), .c(new_n325_), .O(new_n329_));
  and2   g168(.a(new_n329_), .b(new_n188_), .O(z12));
