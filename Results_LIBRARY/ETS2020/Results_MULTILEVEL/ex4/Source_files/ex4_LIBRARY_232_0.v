// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:49 2020
...
module FAU ( 
  ...
  nor2   g239(.a(new_n397_), .b(x043), .O(z11));
  oai22  g240(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n399_));
  nand3  g241(.a(new_n399_), .b(x084), .c(x004), .O(new_n400_));
  oai22  g242(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n401_));
  nand3  g243(.a(new_n401_), .b(x068), .c(x020), .O(new_n402_));
  aoi22  g244(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n403_));
  nand3  g245(.a(new_n403_), .b(new_n402_), .c(new_n400_), .O(new_n404_));
  and2   g246(.a(new_n404_), .b(new_n200_), .O(z12));
