...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n298_, new_n299_, new_n300_, new_n301_, new_n302_, new_n308_,
  ...
  nand2  g142(.a(x022), .b(x014), .O(new_n308_));
  oai21  g143(.a(new_n231_), .b(x030), .c(new_n308_), .O(new_n309_));
  nor2   g144(.a(x126), .b(x102), .O(new_n310_));
  nor2   g145(.a(x118), .b(x110), .O(new_n311_));
  oai21  g146(.a(new_n310_), .b(x094), .c(new_n311_), .O(new_n312_));
  nand2  g147(.a(new_n312_), .b(new_n228_), .O(new_n313_));
  oai21  g148(.a(new_n211_), .b(x110), .c(x038), .O(new_n314_));
  nand2  g149(.a(new_n314_), .b(x118), .O(new_n315_));
  inv1   g150(.a(x102), .O(new_n316_));
  oai21  g151(.a(new_n316_), .b(x062), .c(new_n201_), .O(new_n317_));
  nand3  g152(.a(x126), .b(new_n202_), .c(new_n195_), .O(new_n318_));
  nand2  g153(.a(new_n318_), .b(new_n219_), .O(new_n319_));
  aoi21  g154(.a(new_n317_), .b(new_n206_), .c(new_n319_), .O(new_n320_));
  nand4  g155(.a(new_n320_), .b(new_n315_), .c(new_n313_), .d(new_n309_), .O(new_n321_));
  nand4  g156(.a(x126), .b(new_n209_), .c(new_n206_), .d(x014), .O(new_n322_));
  inv1   g157(.a(new_n322_), .O(new_n323_));
  aoi21  g158(.a(new_n321_), .b(new_n227_), .c(new_n323_), .O(new_n324_));
  nand3  g159(.a(x086), .b(new_n206_), .c(new_n194_), .O(new_n325_));
  oai21  g160(.a(new_n324_), .b(x054), .c(new_n325_), .O(new_n326_));
  nand2  g161(.a(new_n326_), .b(x006), .O(new_n327_));
  nand2  g162(.a(new_n197_), .b(x030), .O(new_n328_));
  nand2  g163(.a(new_n328_), .b(new_n195_), .O(new_n329_));
  nand2  g164(.a(new_n329_), .b(new_n227_), .O(new_n330_));
  aoi21  g165(.a(new_n330_), .b(new_n194_), .c(new_n311_), .O(new_n331_));
  nor2   g166(.a(new_n193_), .b(x022), .O(new_n332_));
  oai21  g167(.a(new_n332_), .b(new_n231_), .c(x070), .O(new_n333_));
  inv1   g168(.a(new_n310_), .O(new_n334_));
  nand4  g169(.a(new_n334_), .b(new_n308_), .c(new_n197_), .d(x030), .O(new_n335_));
  aoi21  g170(.a(new_n335_), .b(new_n333_), .c(x078), .O(new_n336_));
  oai21  g171(.a(new_n336_), .b(new_n331_), .c(new_n192_), .O(new_n337_));
  nand2  g172(.a(new_n308_), .b(x030), .O(new_n338_));
  nand2  g173(.a(new_n338_), .b(new_n223_), .O(new_n339_));
  nand3  g174(.a(new_n339_), .b(new_n227_), .c(x038), .O(new_n340_));
  nand2  g175(.a(new_n340_), .b(new_n337_), .O(new_n341_));
  oai22  g176(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n342_));
  nand3  g177(.a(new_n342_), .b(x070), .c(x022), .O(new_n343_));
  aoi22  g178(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n344_));
  nand2  g179(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  aoi21  g180(.a(new_n341_), .b(new_n219_), .c(new_n345_), .O(new_n346_));
  aoi21  g181(.a(new_n346_), .b(new_n327_), .c(x046), .O(z14));
  zero   g182(.O(z01));
  zero   g183(.O(z02));
  zero   g184(.O(z03));
  zero   g185(.O(z05));
