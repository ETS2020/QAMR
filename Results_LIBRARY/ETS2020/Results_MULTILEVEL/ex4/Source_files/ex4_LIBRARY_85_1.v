...
module FAU ( 
  ...
  oai22  g162(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n323_));
  nand3  g163(.a(new_n323_), .b(x083), .c(x003), .O(new_n324_));
  oai22  g164(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n325_));
  nand3  g165(.a(new_n325_), .b(x067), .c(x019), .O(new_n326_));
  aoi22  g166(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n327_));
  nand3  g167(.a(new_n327_), .b(new_n326_), .c(new_n324_), .O(new_n328_));
  inv1   g168(.a(new_n328_), .O(new_n329_));
  nor2   g169(.a(new_n329_), .b(x043), .O(z11));
  oai22  g170(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n331_));
  nand3  g171(.a(new_n331_), .b(x084), .c(x004), .O(new_n332_));
  oai22  g172(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n333_));
  nand3  g173(.a(new_n333_), .b(x068), .c(x020), .O(new_n334_));
  aoi22  g174(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n335_));
  nand3  g175(.a(new_n335_), .b(new_n334_), .c(new_n332_), .O(new_n336_));
  and2   g176(.a(new_n336_), .b(new_n188_), .O(z12));
