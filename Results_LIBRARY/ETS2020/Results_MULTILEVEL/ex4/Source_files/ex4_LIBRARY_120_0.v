// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:39 2020
...
module FAU ( 
  ...
  and2   g218(.a(new_n377_), .b(new_n186_), .O(z10));
  oai22  g219(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n379_));
  nand3  g220(.a(new_n379_), .b(x083), .c(x003), .O(new_n380_));
  oai22  g221(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n381_));
  nand3  g222(.a(new_n381_), .b(x067), .c(x019), .O(new_n382_));
  aoi22  g223(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n383_));
  nand3  g224(.a(new_n383_), .b(new_n382_), .c(new_n380_), .O(new_n384_));
  inv1   g225(.a(new_n384_), .O(new_n385_));
  nor2   g226(.a(new_n385_), .b(x043), .O(z11));
  oai22  g227(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n387_));
  nand3  g228(.a(new_n387_), .b(x084), .c(x004), .O(new_n388_));
  oai22  g229(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n389_));
  nand3  g230(.a(new_n389_), .b(x068), .c(x020), .O(new_n390_));
  aoi22  g231(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n391_));
  nand3  g232(.a(new_n391_), .b(new_n390_), .c(new_n388_), .O(new_n392_));
  inv1   g233(.a(new_n392_), .O(new_n393_));
  nor2   g234(.a(new_n393_), .b(x044), .O(z12));
