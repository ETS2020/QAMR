// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:24 2020
...
module FAU ( 
  ...
  oai22  g231(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n391_));
  nand3  g232(.a(new_n391_), .b(x083), .c(x003), .O(new_n392_));
  oai22  g233(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n393_));
  nand3  g234(.a(new_n393_), .b(x067), .c(x019), .O(new_n394_));
  aoi22  g235(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n395_));
  nand3  g236(.a(new_n395_), .b(new_n394_), .c(new_n392_), .O(new_n396_));
  and2   g237(.a(new_n396_), .b(new_n199_), .O(z11));
  oai22  g238(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n398_));
  nand3  g239(.a(new_n398_), .b(x084), .c(x004), .O(new_n399_));
  oai22  g240(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n400_));
  nand3  g241(.a(new_n400_), .b(x068), .c(x020), .O(new_n401_));
  aoi22  g242(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n402_));
  nand3  g243(.a(new_n402_), .b(new_n401_), .c(new_n399_), .O(new_n403_));
  and2   g244(.a(new_n403_), .b(new_n212_), .O(z12));
  inv1   g245(.a(x077), .O(new_n405_));
  nand2  g246(.a(x021), .b(x013), .O(new_n406_));
  oai21  g247(.a(new_n267_), .b(x029), .c(new_n406_), .O(new_n407_));
  nor2   g248(.a(x125), .b(x101), .O(new_n408_));
  nor2   g249(.a(x117), .b(x109), .O(new_n409_));
  oai21  g250(.a(new_n408_), .b(x093), .c(new_n409_), .O(new_n410_));
  nand2  g251(.a(new_n410_), .b(new_n257_), .O(new_n411_));
  oai21  g252(.a(new_n245_), .b(x109), .c(x037), .O(new_n412_));
  nand2  g253(.a(new_n412_), .b(x117), .O(new_n413_));
  inv1   g254(.a(x101), .O(new_n414_));
  oai21  g255(.a(new_n414_), .b(x061), .c(new_n240_), .O(new_n415_));
  nand3  g256(.a(x125), .b(new_n238_), .c(new_n230_), .O(new_n416_));
  nand2  g257(.a(new_n416_), .b(new_n253_), .O(new_n417_));
  aoi21  g258(.a(new_n415_), .b(new_n239_), .c(new_n417_), .O(new_n418_));
  nand4  g259(.a(new_n418_), .b(new_n413_), .c(new_n411_), .d(new_n407_), .O(new_n419_));
  nand4  g260(.a(x125), .b(new_n243_), .c(new_n239_), .d(x013), .O(new_n420_));
  inv1   g261(.a(new_n420_), .O(new_n421_));
  aoi21  g262(.a(new_n419_), .b(new_n405_), .c(new_n421_), .O(new_n422_));
  nand3  g263(.a(x085), .b(new_n239_), .c(new_n229_), .O(new_n423_));
  oai21  g264(.a(new_n422_), .b(x053), .c(new_n423_), .O(new_n424_));
  nand2  g265(.a(new_n424_), .b(x005), .O(new_n425_));
  nand2  g266(.a(new_n232_), .b(x029), .O(new_n426_));
  nand2  g267(.a(new_n426_), .b(new_n230_), .O(new_n427_));
  nand2  g268(.a(new_n427_), .b(new_n405_), .O(new_n428_));
  aoi21  g269(.a(new_n428_), .b(new_n229_), .c(new_n409_), .O(new_n429_));
  nor2   g270(.a(new_n228_), .b(x021), .O(new_n430_));
  oai21  g271(.a(new_n430_), .b(new_n267_), .c(x069), .O(new_n431_));
  inv1   g272(.a(new_n408_), .O(new_n432_));
  nand4  g273(.a(new_n432_), .b(new_n406_), .c(new_n232_), .d(x029), .O(new_n433_));
  aoi21  g274(.a(new_n433_), .b(new_n431_), .c(x077), .O(new_n434_));
  oai21  g275(.a(new_n434_), .b(new_n429_), .c(new_n227_), .O(new_n435_));
  nand2  g276(.a(new_n406_), .b(x029), .O(new_n436_));
  nand2  g277(.a(new_n436_), .b(new_n263_), .O(new_n437_));
  nand3  g278(.a(new_n437_), .b(new_n405_), .c(x037), .O(new_n438_));
  nand2  g279(.a(new_n438_), .b(new_n435_), .O(new_n439_));
  oai22  g280(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n440_));
  nand3  g281(.a(new_n440_), .b(x069), .c(x021), .O(new_n441_));
  aoi22  g282(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n442_));
  nand2  g283(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  aoi21  g284(.a(new_n439_), .b(new_n253_), .c(new_n443_), .O(new_n444_));
  aoi21  g285(.a(new_n444_), .b(new_n425_), .c(x045), .O(z13));
  nand2  g286(.a(x022), .b(x014), .O(new_n446_));
  oai21  g287(.a(new_n324_), .b(x030), .c(new_n446_), .O(new_n447_));
  nor2   g288(.a(x126), .b(x102), .O(new_n448_));
  nor2   g289(.a(x118), .b(x110), .O(new_n449_));
  oai21  g290(.a(new_n448_), .b(x094), .c(new_n449_), .O(new_n450_));
  nand2  g291(.a(new_n450_), .b(new_n321_), .O(new_n451_));
  oai21  g292(.a(new_n304_), .b(x110), .c(x038), .O(new_n452_));
  nand2  g293(.a(new_n452_), .b(x118), .O(new_n453_));
  inv1   g294(.a(x102), .O(new_n454_));
  oai21  g295(.a(new_n454_), .b(x062), .c(new_n294_), .O(new_n455_));
  nand3  g296(.a(x126), .b(new_n295_), .c(new_n288_), .O(new_n456_));
  nand2  g297(.a(new_n456_), .b(new_n312_), .O(new_n457_));
  aoi21  g298(.a(new_n455_), .b(new_n299_), .c(new_n457_), .O(new_n458_));
  nand4  g299(.a(new_n458_), .b(new_n453_), .c(new_n451_), .d(new_n447_), .O(new_n459_));
  nand4  g300(.a(x126), .b(new_n302_), .c(new_n299_), .d(x014), .O(new_n460_));
  inv1   g301(.a(new_n460_), .O(new_n461_));
  aoi21  g302(.a(new_n459_), .b(new_n320_), .c(new_n461_), .O(new_n462_));
  nand3  g303(.a(x086), .b(new_n299_), .c(new_n287_), .O(new_n463_));
  oai21  g304(.a(new_n462_), .b(x054), .c(new_n463_), .O(new_n464_));
  nand2  g305(.a(new_n464_), .b(x006), .O(new_n465_));
  nand2  g306(.a(new_n290_), .b(x030), .O(new_n466_));
  nand2  g307(.a(new_n466_), .b(new_n288_), .O(new_n467_));
  nand2  g308(.a(new_n467_), .b(new_n320_), .O(new_n468_));
  aoi21  g309(.a(new_n468_), .b(new_n287_), .c(new_n449_), .O(new_n469_));
  nor2   g310(.a(new_n286_), .b(x022), .O(new_n470_));
  oai21  g311(.a(new_n470_), .b(new_n324_), .c(x070), .O(new_n471_));
  inv1   g312(.a(new_n448_), .O(new_n472_));
  nand4  g313(.a(new_n472_), .b(new_n446_), .c(new_n290_), .d(x030), .O(new_n473_));
  aoi21  g314(.a(new_n473_), .b(new_n471_), .c(x078), .O(new_n474_));
  oai21  g315(.a(new_n474_), .b(new_n469_), .c(new_n285_), .O(new_n475_));
  nand2  g316(.a(new_n446_), .b(x030), .O(new_n476_));
  nand2  g317(.a(new_n476_), .b(new_n316_), .O(new_n477_));
  nand3  g318(.a(new_n477_), .b(new_n320_), .c(x038), .O(new_n478_));
  nand2  g319(.a(new_n478_), .b(new_n475_), .O(new_n479_));
  oai22  g320(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n480_));
  nand3  g321(.a(new_n480_), .b(x070), .c(x022), .O(new_n481_));
  aoi22  g322(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n482_));
  nand2  g323(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  aoi21  g324(.a(new_n479_), .b(new_n312_), .c(new_n483_), .O(new_n484_));
  aoi21  g325(.a(new_n484_), .b(new_n465_), .c(x046), .O(z14));
  zero   g326(.O(z07));
  zero   g327(.O(z09));
  zero   g328(.O(z10));
  zero   g329(.O(z15));
