// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:22 2020
...
module FAU ( 
  ...
  oai22  g200(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n363_));
  nand3  g201(.a(new_n363_), .b(x084), .c(x004), .O(new_n364_));
  oai22  g202(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n365_));
  nand3  g203(.a(new_n365_), .b(x068), .c(x020), .O(new_n366_));
  aoi22  g204(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n367_));
  nand3  g205(.a(new_n367_), .b(new_n366_), .c(new_n364_), .O(new_n368_));
  inv1   g206(.a(new_n368_), .O(new_n369_));
  nor2   g207(.a(new_n369_), .b(x044), .O(z12));
