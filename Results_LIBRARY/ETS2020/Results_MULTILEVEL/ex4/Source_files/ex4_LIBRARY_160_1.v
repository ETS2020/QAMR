// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:25 2020
...
module FAU ( 
  ...
  oai22  g163(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n325_));
  nand3  g164(.a(new_n325_), .b(x084), .c(x004), .O(new_n326_));
  oai22  g165(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n327_));
  nand3  g166(.a(new_n327_), .b(x068), .c(x020), .O(new_n328_));
  aoi22  g167(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n329_));
  nand3  g168(.a(new_n329_), .b(new_n328_), .c(new_n326_), .O(new_n330_));
  and2   g169(.a(new_n330_), .b(new_n188_), .O(z12));
