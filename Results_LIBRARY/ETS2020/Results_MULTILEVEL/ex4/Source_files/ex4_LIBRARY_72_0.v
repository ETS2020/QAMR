// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:44 2020
...
module FAU ( 
  ...
  oai22  g231(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n390_));
  nand3  g232(.a(new_n390_), .b(x082), .c(x002), .O(new_n391_));
  oai22  g233(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n392_));
  nand3  g234(.a(new_n392_), .b(x066), .c(x018), .O(new_n393_));
  aoi22  g235(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n394_));
  nand3  g236(.a(new_n394_), .b(new_n393_), .c(new_n391_), .O(new_n395_));
  and2   g237(.a(new_n395_), .b(new_n186_), .O(z10));
  oai22  g238(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n397_));
  nand3  g239(.a(new_n397_), .b(x083), .c(x003), .O(new_n398_));
  oai22  g240(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n399_));
  nand3  g241(.a(new_n399_), .b(x067), .c(x019), .O(new_n400_));
  aoi22  g242(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n401_));
  nand3  g243(.a(new_n401_), .b(new_n400_), .c(new_n398_), .O(new_n402_));
  and2   g244(.a(new_n402_), .b(new_n199_), .O(z11));
  oai22  g245(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n404_));
  nand3  g246(.a(new_n404_), .b(x084), .c(x004), .O(new_n405_));
  oai22  g247(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n406_));
  nand3  g248(.a(new_n406_), .b(x068), .c(x020), .O(new_n407_));
  aoi22  g249(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n408_));
  nand3  g250(.a(new_n408_), .b(new_n407_), .c(new_n405_), .O(new_n409_));
  and2   g251(.a(new_n409_), .b(new_n212_), .O(z12));
  inv1   g252(.a(x077), .O(new_n411_));
  nand2  g253(.a(x021), .b(x013), .O(new_n412_));
  oai21  g254(.a(new_n267_), .b(x029), .c(new_n412_), .O(new_n413_));
  nor2   g255(.a(x125), .b(x101), .O(new_n414_));
  nor2   g256(.a(x117), .b(x109), .O(new_n415_));
  oai21  g257(.a(new_n414_), .b(x093), .c(new_n415_), .O(new_n416_));
  nand2  g258(.a(new_n416_), .b(new_n257_), .O(new_n417_));
  oai21  g259(.a(new_n245_), .b(x109), .c(x037), .O(new_n418_));
  nand2  g260(.a(new_n418_), .b(x117), .O(new_n419_));
  inv1   g261(.a(x101), .O(new_n420_));
  oai21  g262(.a(new_n420_), .b(x061), .c(new_n240_), .O(new_n421_));
  nand3  g263(.a(x125), .b(new_n238_), .c(new_n230_), .O(new_n422_));
  nand2  g264(.a(new_n422_), .b(new_n253_), .O(new_n423_));
  aoi21  g265(.a(new_n421_), .b(new_n239_), .c(new_n423_), .O(new_n424_));
  nand4  g266(.a(new_n424_), .b(new_n419_), .c(new_n417_), .d(new_n413_), .O(new_n425_));
  nand4  g267(.a(x125), .b(new_n243_), .c(new_n239_), .d(x013), .O(new_n426_));
  inv1   g268(.a(new_n426_), .O(new_n427_));
  aoi21  g269(.a(new_n425_), .b(new_n411_), .c(new_n427_), .O(new_n428_));
  nand3  g270(.a(x085), .b(new_n239_), .c(new_n229_), .O(new_n429_));
  oai21  g271(.a(new_n428_), .b(x053), .c(new_n429_), .O(new_n430_));
  nand2  g272(.a(new_n430_), .b(x005), .O(new_n431_));
  nand2  g273(.a(new_n232_), .b(x029), .O(new_n432_));
  nand2  g274(.a(new_n432_), .b(new_n230_), .O(new_n433_));
  nand2  g275(.a(new_n433_), .b(new_n411_), .O(new_n434_));
  aoi21  g276(.a(new_n434_), .b(new_n229_), .c(new_n415_), .O(new_n435_));
  nor2   g277(.a(new_n228_), .b(x021), .O(new_n436_));
  oai21  g278(.a(new_n436_), .b(new_n267_), .c(x069), .O(new_n437_));
  inv1   g279(.a(new_n414_), .O(new_n438_));
  nand4  g280(.a(new_n438_), .b(new_n412_), .c(new_n232_), .d(x029), .O(new_n439_));
  aoi21  g281(.a(new_n439_), .b(new_n437_), .c(x077), .O(new_n440_));
  oai21  g282(.a(new_n440_), .b(new_n435_), .c(new_n227_), .O(new_n441_));
  nand2  g283(.a(new_n412_), .b(x029), .O(new_n442_));
  nand2  g284(.a(new_n442_), .b(new_n263_), .O(new_n443_));
  nand3  g285(.a(new_n443_), .b(new_n411_), .c(x037), .O(new_n444_));
  nand2  g286(.a(new_n444_), .b(new_n441_), .O(new_n445_));
  oai22  g287(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n446_));
  nand3  g288(.a(new_n446_), .b(x069), .c(x021), .O(new_n447_));
  aoi22  g289(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n448_));
  nand2  g290(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  aoi21  g291(.a(new_n445_), .b(new_n253_), .c(new_n449_), .O(new_n450_));
  aoi21  g292(.a(new_n450_), .b(new_n431_), .c(x045), .O(z13));
  nand2  g293(.a(x022), .b(x014), .O(new_n452_));
  oai21  g294(.a(new_n324_), .b(x030), .c(new_n452_), .O(new_n453_));
  nor2   g295(.a(x126), .b(x102), .O(new_n454_));
  nor2   g296(.a(x118), .b(x110), .O(new_n455_));
  oai21  g297(.a(new_n454_), .b(x094), .c(new_n455_), .O(new_n456_));
  nand2  g298(.a(new_n456_), .b(new_n321_), .O(new_n457_));
  oai21  g299(.a(new_n304_), .b(x110), .c(x038), .O(new_n458_));
  nand2  g300(.a(new_n458_), .b(x118), .O(new_n459_));
  inv1   g301(.a(x102), .O(new_n460_));
  oai21  g302(.a(new_n460_), .b(x062), .c(new_n294_), .O(new_n461_));
  nand3  g303(.a(x126), .b(new_n295_), .c(new_n288_), .O(new_n462_));
  nand2  g304(.a(new_n462_), .b(new_n312_), .O(new_n463_));
  aoi21  g305(.a(new_n461_), .b(new_n299_), .c(new_n463_), .O(new_n464_));
  nand4  g306(.a(new_n464_), .b(new_n459_), .c(new_n457_), .d(new_n453_), .O(new_n465_));
  nand4  g307(.a(x126), .b(new_n302_), .c(new_n299_), .d(x014), .O(new_n466_));
  inv1   g308(.a(new_n466_), .O(new_n467_));
  aoi21  g309(.a(new_n465_), .b(new_n320_), .c(new_n467_), .O(new_n468_));
  nand3  g310(.a(x086), .b(new_n299_), .c(new_n287_), .O(new_n469_));
  oai21  g311(.a(new_n468_), .b(x054), .c(new_n469_), .O(new_n470_));
  nand2  g312(.a(new_n470_), .b(x006), .O(new_n471_));
  nand2  g313(.a(new_n290_), .b(x030), .O(new_n472_));
  nand2  g314(.a(new_n472_), .b(new_n288_), .O(new_n473_));
  nand2  g315(.a(new_n473_), .b(new_n320_), .O(new_n474_));
  aoi21  g316(.a(new_n474_), .b(new_n287_), .c(new_n455_), .O(new_n475_));
  nor2   g317(.a(new_n286_), .b(x022), .O(new_n476_));
  oai21  g318(.a(new_n476_), .b(new_n324_), .c(x070), .O(new_n477_));
  inv1   g319(.a(new_n454_), .O(new_n478_));
  nand4  g320(.a(new_n478_), .b(new_n452_), .c(new_n290_), .d(x030), .O(new_n479_));
  aoi21  g321(.a(new_n479_), .b(new_n477_), .c(x078), .O(new_n480_));
  oai21  g322(.a(new_n480_), .b(new_n475_), .c(new_n285_), .O(new_n481_));
  nand2  g323(.a(new_n452_), .b(x030), .O(new_n482_));
  nand2  g324(.a(new_n482_), .b(new_n316_), .O(new_n483_));
  nand3  g325(.a(new_n483_), .b(new_n320_), .c(x038), .O(new_n484_));
  nand2  g326(.a(new_n484_), .b(new_n481_), .O(new_n485_));
  oai22  g327(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n486_));
  nand3  g328(.a(new_n486_), .b(x070), .c(x022), .O(new_n487_));
  aoi22  g329(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n488_));
  nand2  g330(.a(new_n488_), .b(new_n487_), .O(new_n489_));
  aoi21  g331(.a(new_n485_), .b(new_n312_), .c(new_n489_), .O(new_n490_));
  aoi21  g332(.a(new_n490_), .b(new_n471_), .c(x046), .O(z14));
  zero   g333(.O(z07));
  zero   g334(.O(z09));
  zero   g335(.O(z15));
  zero   g336(.O(z16));
