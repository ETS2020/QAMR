...
module FAU ( 
  ...
  and2   g158(.a(new_n320_), .b(new_n172_), .O(z11));
  inv1   g159(.a(x077), .O(new_n323_));
  nand2  g160(.a(x021), .b(x013), .O(new_n324_));
  oai21  g161(.a(new_n240_), .b(x029), .c(new_n324_), .O(new_n325_));
  nor2   g162(.a(x125), .b(x101), .O(new_n326_));
  nor2   g163(.a(x117), .b(x109), .O(new_n327_));
  oai21  g164(.a(new_n326_), .b(x093), .c(new_n327_), .O(new_n328_));
  nand2  g165(.a(new_n328_), .b(new_n230_), .O(new_n329_));
  oai21  g166(.a(new_n218_), .b(x109), .c(x037), .O(new_n330_));
  nand2  g167(.a(new_n330_), .b(x117), .O(new_n331_));
  inv1   g168(.a(x101), .O(new_n332_));
  oai21  g169(.a(new_n332_), .b(x061), .c(new_n213_), .O(new_n333_));
  nand3  g170(.a(x125), .b(new_n211_), .c(new_n203_), .O(new_n334_));
  nand2  g171(.a(new_n334_), .b(new_n226_), .O(new_n335_));
  aoi21  g172(.a(new_n333_), .b(new_n212_), .c(new_n335_), .O(new_n336_));
  nand4  g173(.a(new_n336_), .b(new_n331_), .c(new_n329_), .d(new_n325_), .O(new_n337_));
  nand4  g174(.a(x125), .b(new_n216_), .c(new_n212_), .d(x013), .O(new_n338_));
  inv1   g175(.a(new_n338_), .O(new_n339_));
  aoi21  g176(.a(new_n337_), .b(new_n323_), .c(new_n339_), .O(new_n340_));
  nand3  g177(.a(x085), .b(new_n212_), .c(new_n202_), .O(new_n341_));
  oai21  g178(.a(new_n340_), .b(x053), .c(new_n341_), .O(new_n342_));
  nand2  g179(.a(new_n342_), .b(x005), .O(new_n343_));
  nand2  g180(.a(new_n205_), .b(x029), .O(new_n344_));
  nand2  g181(.a(new_n344_), .b(new_n203_), .O(new_n345_));
  nand2  g182(.a(new_n345_), .b(new_n323_), .O(new_n346_));
  aoi21  g183(.a(new_n346_), .b(new_n202_), .c(new_n327_), .O(new_n347_));
  nor2   g184(.a(new_n201_), .b(x021), .O(new_n348_));
  oai21  g185(.a(new_n348_), .b(new_n240_), .c(x069), .O(new_n349_));
  inv1   g186(.a(new_n326_), .O(new_n350_));
  nand4  g187(.a(new_n350_), .b(new_n324_), .c(new_n205_), .d(x029), .O(new_n351_));
  aoi21  g188(.a(new_n351_), .b(new_n349_), .c(x077), .O(new_n352_));
  oai21  g189(.a(new_n352_), .b(new_n347_), .c(new_n200_), .O(new_n353_));
  nand2  g190(.a(new_n324_), .b(x029), .O(new_n354_));
  nand2  g191(.a(new_n354_), .b(new_n236_), .O(new_n355_));
  nand3  g192(.a(new_n355_), .b(new_n323_), .c(x037), .O(new_n356_));
  ...
  aoi21  g198(.a(new_n357_), .b(new_n226_), .c(new_n361_), .O(new_n362_));
  aoi21  g199(.a(new_n362_), .b(new_n343_), .c(x045), .O(z13));
  zero   g200(.O(z00));
  zero   g201(.O(z02));
  zero   g202(.O(z06));
  zero   g203(.O(z07));
