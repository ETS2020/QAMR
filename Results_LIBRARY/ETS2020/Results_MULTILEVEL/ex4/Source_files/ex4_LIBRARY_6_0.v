// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:29 2020
...
module FAU ( 
  ...
  nor2   g225(.a(new_n383_), .b(x041), .O(z09));
  oai22  g226(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n385_));
  nand3  g227(.a(new_n385_), .b(x082), .c(x002), .O(new_n386_));
  oai22  g228(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n387_));
  nand3  g229(.a(new_n387_), .b(x066), .c(x018), .O(new_n388_));
  aoi22  g230(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n389_));
  nand3  g231(.a(new_n389_), .b(new_n388_), .c(new_n386_), .O(new_n390_));
  and2   g232(.a(new_n390_), .b(new_n174_), .O(z10));
