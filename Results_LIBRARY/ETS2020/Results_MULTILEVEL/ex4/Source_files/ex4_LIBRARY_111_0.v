// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:28 2020
...
module FAU ( 
  ...
  nor2   g199(.a(new_n359_), .b(x041), .O(z09));
  oai22  g200(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n361_));
  nand3  g201(.a(new_n361_), .b(x082), .c(x002), .O(new_n362_));
  oai22  g202(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n363_));
  nand3  g203(.a(new_n363_), .b(x066), .c(x018), .O(new_n364_));
  aoi22  g204(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n365_));
  nand3  g205(.a(new_n365_), .b(new_n364_), .c(new_n362_), .O(new_n366_));
  inv1   g206(.a(new_n366_), .O(new_n367_));
  nor2   g207(.a(new_n367_), .b(x042), .O(z10));
  oai22  g208(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n369_));
  nand3  g209(.a(new_n369_), .b(x083), .c(x003), .O(new_n370_));
  oai22  g210(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n371_));
  nand3  g211(.a(new_n371_), .b(x067), .c(x019), .O(new_n372_));
  aoi22  g212(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n373_));
  nand3  g213(.a(new_n373_), .b(new_n372_), .c(new_n370_), .O(new_n374_));
  inv1   g214(.a(new_n374_), .O(new_n375_));
  nor2   g215(.a(new_n375_), .b(x043), .O(z11));
  inv1   g216(.a(x077), .O(new_n378_));
  nand2  g217(.a(x021), .b(x013), .O(new_n379_));
  oai21  g218(.a(new_n231_), .b(x029), .c(new_n379_), .O(new_n380_));
  nor2   g219(.a(x125), .b(x101), .O(new_n381_));
  nor2   g220(.a(x117), .b(x109), .O(new_n382_));
  oai21  g221(.a(new_n381_), .b(x093), .c(new_n382_), .O(new_n383_));
  nand2  g222(.a(new_n383_), .b(new_n221_), .O(new_n384_));
  oai21  g223(.a(new_n209_), .b(x109), .c(x037), .O(new_n385_));
  nand2  g224(.a(new_n385_), .b(x117), .O(new_n386_));
  inv1   g225(.a(x101), .O(new_n387_));
  oai21  g226(.a(new_n387_), .b(x061), .c(new_n204_), .O(new_n388_));
  nand3  g227(.a(x125), .b(new_n202_), .c(new_n194_), .O(new_n389_));
  nand2  g228(.a(new_n389_), .b(new_n217_), .O(new_n390_));
  aoi21  g229(.a(new_n388_), .b(new_n203_), .c(new_n390_), .O(new_n391_));
  nand4  g230(.a(new_n391_), .b(new_n386_), .c(new_n384_), .d(new_n380_), .O(new_n392_));
  nand4  g231(.a(x125), .b(new_n207_), .c(new_n203_), .d(x013), .O(new_n393_));
  inv1   g232(.a(new_n393_), .O(new_n394_));
  aoi21  g233(.a(new_n392_), .b(new_n378_), .c(new_n394_), .O(new_n395_));
  nand3  g234(.a(x085), .b(new_n203_), .c(new_n193_), .O(new_n396_));
  oai21  g235(.a(new_n395_), .b(x053), .c(new_n396_), .O(new_n397_));
  nand2  g236(.a(new_n397_), .b(x005), .O(new_n398_));
  nand2  g237(.a(new_n196_), .b(x029), .O(new_n399_));
  nand2  g238(.a(new_n399_), .b(new_n194_), .O(new_n400_));
  nand2  g239(.a(new_n400_), .b(new_n378_), .O(new_n401_));
  aoi21  g240(.a(new_n401_), .b(new_n193_), .c(new_n382_), .O(new_n402_));
  nor2   g241(.a(new_n192_), .b(x021), .O(new_n403_));
  oai21  g242(.a(new_n403_), .b(new_n231_), .c(x069), .O(new_n404_));
  inv1   g243(.a(new_n381_), .O(new_n405_));
  nand4  g244(.a(new_n405_), .b(new_n379_), .c(new_n196_), .d(x029), .O(new_n406_));
  aoi21  g245(.a(new_n406_), .b(new_n404_), .c(x077), .O(new_n407_));
  oai21  g246(.a(new_n407_), .b(new_n402_), .c(new_n191_), .O(new_n408_));
  nand2  g247(.a(new_n379_), .b(x029), .O(new_n409_));
  nand2  g248(.a(new_n409_), .b(new_n227_), .O(new_n410_));
  nand3  g249(.a(new_n410_), .b(new_n378_), .c(x037), .O(new_n411_));
  nand2  g250(.a(new_n411_), .b(new_n408_), .O(new_n412_));
  oai22  g251(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n413_));
  nand3  g252(.a(new_n413_), .b(x069), .c(x021), .O(new_n414_));
  aoi22  g253(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n415_));
  nand2  g254(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  aoi21  g255(.a(new_n412_), .b(new_n217_), .c(new_n416_), .O(new_n417_));
  aoi21  g256(.a(new_n417_), .b(new_n398_), .c(x045), .O(z13));
  nand2  g257(.a(x022), .b(x014), .O(new_n419_));
  oai21  g258(.a(new_n288_), .b(x030), .c(new_n419_), .O(new_n420_));
  nor2   g259(.a(x126), .b(x102), .O(new_n421_));
  nor2   g260(.a(x118), .b(x110), .O(new_n422_));
  oai21  g261(.a(new_n421_), .b(x094), .c(new_n422_), .O(new_n423_));
  nand2  g262(.a(new_n423_), .b(new_n285_), .O(new_n424_));
  oai21  g263(.a(new_n268_), .b(x110), .c(x038), .O(new_n425_));
  nand2  g264(.a(new_n425_), .b(x118), .O(new_n426_));
  inv1   g265(.a(x102), .O(new_n427_));
  oai21  g266(.a(new_n427_), .b(x062), .c(new_n258_), .O(new_n428_));
  nand3  g267(.a(x126), .b(new_n259_), .c(new_n252_), .O(new_n429_));
  nand2  g268(.a(new_n429_), .b(new_n276_), .O(new_n430_));
  aoi21  g269(.a(new_n428_), .b(new_n263_), .c(new_n430_), .O(new_n431_));
  nand4  g270(.a(new_n431_), .b(new_n426_), .c(new_n424_), .d(new_n420_), .O(new_n432_));
  nand4  g271(.a(x126), .b(new_n266_), .c(new_n263_), .d(x014), .O(new_n433_));
  inv1   g272(.a(new_n433_), .O(new_n434_));
  aoi21  g273(.a(new_n432_), .b(new_n284_), .c(new_n434_), .O(new_n435_));
  nand3  g274(.a(x086), .b(new_n263_), .c(new_n251_), .O(new_n436_));
  oai21  g275(.a(new_n435_), .b(x054), .c(new_n436_), .O(new_n437_));
  nand2  g276(.a(new_n437_), .b(x006), .O(new_n438_));
  nand2  g277(.a(new_n254_), .b(x030), .O(new_n439_));
  nand2  g278(.a(new_n439_), .b(new_n252_), .O(new_n440_));
  nand2  g279(.a(new_n440_), .b(new_n284_), .O(new_n441_));
  aoi21  g280(.a(new_n441_), .b(new_n251_), .c(new_n422_), .O(new_n442_));
  nor2   g281(.a(new_n250_), .b(x022), .O(new_n443_));
  oai21  g282(.a(new_n443_), .b(new_n288_), .c(x070), .O(new_n444_));
  inv1   g283(.a(new_n421_), .O(new_n445_));
  nand4  g284(.a(new_n445_), .b(new_n419_), .c(new_n254_), .d(x030), .O(new_n446_));
  aoi21  g285(.a(new_n446_), .b(new_n444_), .c(x078), .O(new_n447_));
  oai21  g286(.a(new_n447_), .b(new_n442_), .c(new_n249_), .O(new_n448_));
  nand2  g287(.a(new_n419_), .b(x030), .O(new_n449_));
  nand2  g288(.a(new_n449_), .b(new_n280_), .O(new_n450_));
  nand3  g289(.a(new_n450_), .b(new_n284_), .c(x038), .O(new_n451_));
  nand2  g290(.a(new_n451_), .b(new_n448_), .O(new_n452_));
  oai22  g291(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n453_));
  nand3  g292(.a(new_n453_), .b(x070), .c(x022), .O(new_n454_));
  aoi22  g293(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n455_));
  nand2  g294(.a(new_n455_), .b(new_n454_), .O(new_n456_));
  aoi21  g295(.a(new_n452_), .b(new_n276_), .c(new_n456_), .O(new_n457_));
  aoi21  g296(.a(new_n457_), .b(new_n438_), .c(x046), .O(z14));
  zero   g297(.O(z01));
  zero   g298(.O(z02));
  zero   g299(.O(z03));
  zero   g300(.O(z07));
