...
module FAU ( 
  ...
  nor2   g149(.a(new_n310_), .b(x042), .O(z10));
  nand2  g150(.a(x022), .b(x014), .O(new_n315_));
  oai21  g151(.a(new_n231_), .b(x030), .c(new_n315_), .O(new_n316_));
  nor2   g152(.a(x126), .b(x102), .O(new_n317_));
  nor2   g153(.a(x118), .b(x110), .O(new_n318_));
  oai21  g154(.a(new_n317_), .b(x094), .c(new_n318_), .O(new_n319_));
  nand2  g155(.a(new_n319_), .b(new_n228_), .O(new_n320_));
  oai21  g156(.a(new_n211_), .b(x110), .c(x038), .O(new_n321_));
  nand2  g157(.a(new_n321_), .b(x118), .O(new_n322_));
  inv1   g158(.a(x102), .O(new_n323_));
  oai21  g159(.a(new_n323_), .b(x062), .c(new_n201_), .O(new_n324_));
  nand3  g160(.a(x126), .b(new_n202_), .c(new_n195_), .O(new_n325_));
  nand2  g161(.a(new_n325_), .b(new_n219_), .O(new_n326_));
  aoi21  g162(.a(new_n324_), .b(new_n206_), .c(new_n326_), .O(new_n327_));
  nand4  g163(.a(new_n327_), .b(new_n322_), .c(new_n320_), .d(new_n316_), .O(new_n328_));
  nand4  g164(.a(x126), .b(new_n209_), .c(new_n206_), .d(x014), .O(new_n329_));
  inv1   g165(.a(new_n329_), .O(new_n330_));
  aoi21  g166(.a(new_n328_), .b(new_n227_), .c(new_n330_), .O(new_n331_));
  nand3  g167(.a(x086), .b(new_n206_), .c(new_n194_), .O(new_n332_));
  oai21  g168(.a(new_n331_), .b(x054), .c(new_n332_), .O(new_n333_));
  nand2  g169(.a(new_n333_), .b(x006), .O(new_n334_));
  nand2  g170(.a(new_n197_), .b(x030), .O(new_n335_));
  nand2  g171(.a(new_n335_), .b(new_n195_), .O(new_n336_));
  nand2  g172(.a(new_n336_), .b(new_n227_), .O(new_n337_));
  aoi21  g173(.a(new_n337_), .b(new_n194_), .c(new_n318_), .O(new_n338_));
  nor2   g174(.a(new_n193_), .b(x022), .O(new_n339_));
  oai21  g175(.a(new_n339_), .b(new_n231_), .c(x070), .O(new_n340_));
  inv1   g176(.a(new_n317_), .O(new_n341_));
  nand4  g177(.a(new_n341_), .b(new_n315_), .c(new_n197_), .d(x030), .O(new_n342_));
  aoi21  g178(.a(new_n342_), .b(new_n340_), .c(x078), .O(new_n343_));
  oai21  g179(.a(new_n343_), .b(new_n338_), .c(new_n192_), .O(new_n344_));
  nand2  g180(.a(new_n315_), .b(x030), .O(new_n345_));
  nand2  g181(.a(new_n345_), .b(new_n223_), .O(new_n346_));
  nand3  g182(.a(new_n346_), .b(new_n227_), .c(x038), .O(new_n347_));
  nand2  g183(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  oai22  g184(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n349_));
  nand3  g185(.a(new_n349_), .b(x070), .c(x022), .O(new_n350_));
  aoi22  g186(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n351_));
  nand2  g187(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  aoi21  g188(.a(new_n348_), .b(new_n219_), .c(new_n352_), .O(new_n353_));
  aoi21  g189(.a(new_n353_), .b(new_n334_), .c(x046), .O(z14));
  zero   g190(.O(z01));
  zero   g191(.O(z02));
  zero   g192(.O(z03));
  zero   g193(.O(z05));
