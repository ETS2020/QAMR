...
module FAU ( 
  ...
  oai22  g168(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n330_));
  nand3  g169(.a(new_n330_), .b(x084), .c(x004), .O(new_n331_));
  oai22  g170(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n332_));
  nand3  g171(.a(new_n332_), .b(x068), .c(x020), .O(new_n333_));
  aoi22  g172(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n334_));
  nand3  g173(.a(new_n334_), .b(new_n333_), .c(new_n331_), .O(new_n335_));
  and2   g174(.a(new_n335_), .b(new_n200_), .O(z12));
