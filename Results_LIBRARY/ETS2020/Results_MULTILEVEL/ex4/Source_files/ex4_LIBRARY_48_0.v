// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:17 2020
...
module FAU ( 
  ...
  oai22  g216(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(x084), .c(x004), .O(new_n378_));
  oai22  g218(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n379_));
  nand3  g219(.a(new_n379_), .b(x068), .c(x020), .O(new_n380_));
  aoi22  g220(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n381_));
  nand3  g221(.a(new_n381_), .b(new_n380_), .c(new_n378_), .O(new_n382_));
  and2   g222(.a(new_n382_), .b(new_n176_), .O(z12));
