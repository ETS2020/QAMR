...
module FAU ( 
  ...
  and2   g224(.a(new_n383_), .b(new_n186_), .O(z10));
  ...
  and2   g231(.a(new_n390_), .b(new_n199_), .O(z11));
  oai22  g232(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n392_));
  nand3  g233(.a(new_n392_), .b(x084), .c(x004), .O(new_n393_));
  oai22  g234(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n394_));
  nand3  g235(.a(new_n394_), .b(x068), .c(x020), .O(new_n395_));
  aoi22  g236(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n396_));
  nand3  g237(.a(new_n396_), .b(new_n395_), .c(new_n393_), .O(new_n397_));
  inv1   g238(.a(new_n397_), .O(new_n398_));
  nor2   g239(.a(new_n398_), .b(x044), .O(z12));
