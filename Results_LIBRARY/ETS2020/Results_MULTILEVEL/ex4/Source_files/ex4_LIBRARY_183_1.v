...
module FAU ( 
  ...
  oai22  g149(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n312_));
  nand3  g150(.a(new_n312_), .b(x084), .c(x004), .O(new_n313_));
  oai22  g151(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n314_));
  nand3  g152(.a(new_n314_), .b(x068), .c(x020), .O(new_n315_));
  aoi22  g153(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n316_));
  nand3  g154(.a(new_n316_), .b(new_n315_), .c(new_n313_), .O(new_n317_));
  inv1   g155(.a(new_n317_), .O(new_n318_));
  nor2   g156(.a(new_n318_), .b(x044), .O(z12));
