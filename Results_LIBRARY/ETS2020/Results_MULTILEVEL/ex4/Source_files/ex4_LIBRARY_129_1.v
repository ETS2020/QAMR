// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:50 2020
...
module FAU ( 
  ...
  nand2  g187(.a(x022), .b(x014), .O(new_n349_));
  oai21  g188(.a(new_n267_), .b(x030), .c(new_n349_), .O(new_n350_));
  nor2   g189(.a(x126), .b(x102), .O(new_n351_));
  nor2   g190(.a(x118), .b(x110), .O(new_n352_));
  oai21  g191(.a(new_n351_), .b(x094), .c(new_n352_), .O(new_n353_));
  nand2  g192(.a(new_n353_), .b(new_n264_), .O(new_n354_));
  oai21  g193(.a(new_n247_), .b(x110), .c(x038), .O(new_n355_));
  nand2  g194(.a(new_n355_), .b(x118), .O(new_n356_));
  inv1   g195(.a(x102), .O(new_n357_));
  oai21  g196(.a(new_n357_), .b(x062), .c(new_n237_), .O(new_n358_));
  nand3  g197(.a(x126), .b(new_n238_), .c(new_n231_), .O(new_n359_));
  nand2  g198(.a(new_n359_), .b(new_n255_), .O(new_n360_));
  aoi21  g199(.a(new_n358_), .b(new_n242_), .c(new_n360_), .O(new_n361_));
  nand4  g200(.a(new_n361_), .b(new_n356_), .c(new_n354_), .d(new_n350_), .O(new_n362_));
  nand4  g201(.a(x126), .b(new_n245_), .c(new_n242_), .d(x014), .O(new_n363_));
  inv1   g202(.a(new_n363_), .O(new_n364_));
  aoi21  g203(.a(new_n362_), .b(new_n263_), .c(new_n364_), .O(new_n365_));
  nand3  g204(.a(x086), .b(new_n242_), .c(new_n230_), .O(new_n366_));
  oai21  g205(.a(new_n365_), .b(x054), .c(new_n366_), .O(new_n367_));
  nand2  g206(.a(new_n367_), .b(x006), .O(new_n368_));
  nand2  g207(.a(new_n233_), .b(x030), .O(new_n369_));
  nand2  g208(.a(new_n369_), .b(new_n231_), .O(new_n370_));
  nand2  g209(.a(new_n370_), .b(new_n263_), .O(new_n371_));
  aoi21  g210(.a(new_n371_), .b(new_n230_), .c(new_n352_), .O(new_n372_));
  nor2   g211(.a(new_n229_), .b(x022), .O(new_n373_));
  oai21  g212(.a(new_n373_), .b(new_n267_), .c(x070), .O(new_n374_));
  inv1   g213(.a(new_n351_), .O(new_n375_));
  nand4  g214(.a(new_n375_), .b(new_n349_), .c(new_n233_), .d(x030), .O(new_n376_));
  aoi21  g215(.a(new_n376_), .b(new_n374_), .c(x078), .O(new_n377_));
  oai21  g216(.a(new_n377_), .b(new_n372_), .c(new_n228_), .O(new_n378_));
  nand2  g217(.a(new_n349_), .b(x030), .O(new_n379_));
  nand2  g218(.a(new_n379_), .b(new_n259_), .O(new_n380_));
  nand3  g219(.a(new_n380_), .b(new_n263_), .c(x038), .O(new_n381_));
  nand2  g220(.a(new_n381_), .b(new_n378_), .O(new_n382_));
  oai22  g221(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n383_));
  nand3  g222(.a(new_n383_), .b(x070), .c(x022), .O(new_n384_));
  aoi22  g223(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n385_));
  nand2  g224(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  aoi21  g225(.a(new_n382_), .b(new_n255_), .c(new_n386_), .O(new_n387_));
  aoi21  g226(.a(new_n387_), .b(new_n368_), .c(x046), .O(z14));
  zero   g227(.O(z05));
  zero   g228(.O(z07));
  zero   g229(.O(z11));
  zero   g230(.O(z12));
