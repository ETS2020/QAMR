...
module FAU ( 
  ...
  and2   g168(.a(new_n328_), .b(new_n187_), .O(z11));
  nand2  g169(.a(x022), .b(x014), .O(new_n332_));
  oai21  g170(.a(new_n243_), .b(x030), .c(new_n332_), .O(new_n333_));
  nor2   g171(.a(x126), .b(x102), .O(new_n334_));
  nor2   g172(.a(x118), .b(x110), .O(new_n335_));
  oai21  g173(.a(new_n334_), .b(x094), .c(new_n335_), .O(new_n336_));
  nand2  g174(.a(new_n336_), .b(new_n240_), .O(new_n337_));
  oai21  g175(.a(new_n223_), .b(x110), .c(x038), .O(new_n338_));
  nand2  g176(.a(new_n338_), .b(x118), .O(new_n339_));
  inv1   g177(.a(x102), .O(new_n340_));
  oai21  g178(.a(new_n340_), .b(x062), .c(new_n213_), .O(new_n341_));
  nand3  g179(.a(x126), .b(new_n214_), .c(new_n207_), .O(new_n342_));
  nand2  g180(.a(new_n342_), .b(new_n231_), .O(new_n343_));
  aoi21  g181(.a(new_n341_), .b(new_n218_), .c(new_n343_), .O(new_n344_));
  nand4  g182(.a(new_n344_), .b(new_n339_), .c(new_n337_), .d(new_n333_), .O(new_n345_));
  nand4  g183(.a(x126), .b(new_n221_), .c(new_n218_), .d(x014), .O(new_n346_));
  inv1   g184(.a(new_n346_), .O(new_n347_));
  aoi21  g185(.a(new_n345_), .b(new_n239_), .c(new_n347_), .O(new_n348_));
  nand3  g186(.a(x086), .b(new_n218_), .c(new_n206_), .O(new_n349_));
  oai21  g187(.a(new_n348_), .b(x054), .c(new_n349_), .O(new_n350_));
  nand2  g188(.a(new_n350_), .b(x006), .O(new_n351_));
  nand2  g189(.a(new_n209_), .b(x030), .O(new_n352_));
  nand2  g190(.a(new_n352_), .b(new_n207_), .O(new_n353_));
  nand2  g191(.a(new_n353_), .b(new_n239_), .O(new_n354_));
  aoi21  g192(.a(new_n354_), .b(new_n206_), .c(new_n335_), .O(new_n355_));
  nor2   g193(.a(new_n205_), .b(x022), .O(new_n356_));
  oai21  g194(.a(new_n356_), .b(new_n243_), .c(x070), .O(new_n357_));
  inv1   g195(.a(new_n334_), .O(new_n358_));
  nand4  g196(.a(new_n358_), .b(new_n332_), .c(new_n209_), .d(x030), .O(new_n359_));
  aoi21  g197(.a(new_n359_), .b(new_n357_), .c(x078), .O(new_n360_));
  oai21  g198(.a(new_n360_), .b(new_n355_), .c(new_n204_), .O(new_n361_));
  nand2  g199(.a(new_n332_), .b(x030), .O(new_n362_));
  nand2  g200(.a(new_n362_), .b(new_n235_), .O(new_n363_));
  nand3  g201(.a(new_n363_), .b(new_n239_), .c(x038), .O(new_n364_));
  nand2  g202(.a(new_n364_), .b(new_n361_), .O(new_n365_));
  oai22  g203(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n366_));
  nand3  g204(.a(new_n366_), .b(x070), .c(x022), .O(new_n367_));
  aoi22  g205(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n368_));
  nand2  g206(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  aoi21  g207(.a(new_n365_), .b(new_n231_), .c(new_n369_), .O(new_n370_));
  aoi21  g208(.a(new_n370_), .b(new_n351_), .c(x046), .O(z14));
  zero   g209(.O(z02));
  zero   g210(.O(z04));
  zero   g211(.O(z05));
  zero   g212(.O(z07));
