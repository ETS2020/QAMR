...
module FAU ( 
  ...
  nor2   g161(.a(new_n321_), .b(x042), .O(z10));
  ...
  nand2  g170(.a(x022), .b(x014), .O(new_n333_));
  oai21  g171(.a(new_n243_), .b(x030), .c(new_n333_), .O(new_n334_));
  nor2   g172(.a(x126), .b(x102), .O(new_n335_));
  nor2   g173(.a(x118), .b(x110), .O(new_n336_));
  oai21  g174(.a(new_n335_), .b(x094), .c(new_n336_), .O(new_n337_));
  nand2  g175(.a(new_n337_), .b(new_n240_), .O(new_n338_));
  oai21  g176(.a(new_n223_), .b(x110), .c(x038), .O(new_n339_));
  nand2  g177(.a(new_n339_), .b(x118), .O(new_n340_));
  inv1   g178(.a(x102), .O(new_n341_));
  oai21  g179(.a(new_n341_), .b(x062), .c(new_n213_), .O(new_n342_));
  nand3  g180(.a(x126), .b(new_n214_), .c(new_n207_), .O(new_n343_));
  nand2  g181(.a(new_n343_), .b(new_n231_), .O(new_n344_));
  aoi21  g182(.a(new_n342_), .b(new_n218_), .c(new_n344_), .O(new_n345_));
  nand4  g183(.a(new_n345_), .b(new_n340_), .c(new_n338_), .d(new_n334_), .O(new_n346_));
  nand4  g184(.a(x126), .b(new_n221_), .c(new_n218_), .d(x014), .O(new_n347_));
  inv1   g185(.a(new_n347_), .O(new_n348_));
  aoi21  g186(.a(new_n346_), .b(new_n239_), .c(new_n348_), .O(new_n349_));
  nand3  g187(.a(x086), .b(new_n218_), .c(new_n206_), .O(new_n350_));
  oai21  g188(.a(new_n349_), .b(x054), .c(new_n350_), .O(new_n351_));
  nand2  g189(.a(new_n351_), .b(x006), .O(new_n352_));
  nand2  g190(.a(new_n209_), .b(x030), .O(new_n353_));
  nand2  g191(.a(new_n353_), .b(new_n207_), .O(new_n354_));
  nand2  g192(.a(new_n354_), .b(new_n239_), .O(new_n355_));
  aoi21  g193(.a(new_n355_), .b(new_n206_), .c(new_n336_), .O(new_n356_));
  nor2   g194(.a(new_n205_), .b(x022), .O(new_n357_));
  oai21  g195(.a(new_n357_), .b(new_n243_), .c(x070), .O(new_n358_));
  inv1   g196(.a(new_n335_), .O(new_n359_));
  nand4  g197(.a(new_n359_), .b(new_n333_), .c(new_n209_), .d(x030), .O(new_n360_));
  aoi21  g198(.a(new_n360_), .b(new_n358_), .c(x078), .O(new_n361_));
  oai21  g199(.a(new_n361_), .b(new_n356_), .c(new_n204_), .O(new_n362_));
  nand2  g200(.a(new_n333_), .b(x030), .O(new_n363_));
  nand2  g201(.a(new_n363_), .b(new_n235_), .O(new_n364_));
  nand3  g202(.a(new_n364_), .b(new_n239_), .c(x038), .O(new_n365_));
  nand2  g203(.a(new_n365_), .b(new_n362_), .O(new_n366_));
  oai22  g204(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n367_));
  nand3  g205(.a(new_n367_), .b(x070), .c(x022), .O(new_n368_));
  aoi22  g206(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n369_));
  nand2  g207(.a(new_n369_), .b(new_n368_), .O(new_n370_));
  aoi21  g208(.a(new_n366_), .b(new_n231_), .c(new_n370_), .O(new_n371_));
  aoi21  g209(.a(new_n371_), .b(new_n352_), .c(x046), .O(z14));
  zero   g210(.O(z02));
  zero   g211(.O(z03));
  zero   g212(.O(z05));
  zero   g213(.O(z07));
