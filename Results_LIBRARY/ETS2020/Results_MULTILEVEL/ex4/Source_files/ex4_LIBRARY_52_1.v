// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:21 2020
...
module FAU ( 
  ...
  nor2   g154(.a(new_n315_), .b(x042), .O(z10));
  oai22  g155(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n317_));
  nand3  g156(.a(new_n317_), .b(x083), .c(x003), .O(new_n318_));
  oai22  g157(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n319_));
  nand3  g158(.a(new_n319_), .b(x067), .c(x019), .O(new_n320_));
  aoi22  g159(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n321_));
  nand3  g160(.a(new_n321_), .b(new_n320_), .c(new_n318_), .O(new_n322_));
  and2   g161(.a(new_n322_), .b(new_n175_), .O(z11));
