// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:39 2020
...
module FAU ( 
  ...
  inv1   g208(.a(x077), .O(new_n371_));
  nand2  g209(.a(x021), .b(x013), .O(new_n372_));
  oai21  g210(.a(new_n231_), .b(x029), .c(new_n372_), .O(new_n373_));
  nor2   g211(.a(x125), .b(x101), .O(new_n374_));
  nor2   g212(.a(x117), .b(x109), .O(new_n375_));
  oai21  g213(.a(new_n374_), .b(x093), .c(new_n375_), .O(new_n376_));
  nand2  g214(.a(new_n376_), .b(new_n221_), .O(new_n377_));
  oai21  g215(.a(new_n209_), .b(x109), .c(x037), .O(new_n378_));
  nand2  g216(.a(new_n378_), .b(x117), .O(new_n379_));
  inv1   g217(.a(x101), .O(new_n380_));
  oai21  g218(.a(new_n380_), .b(x061), .c(new_n204_), .O(new_n381_));
  nand3  g219(.a(x125), .b(new_n202_), .c(new_n194_), .O(new_n382_));
  nand2  g220(.a(new_n382_), .b(new_n217_), .O(new_n383_));
  aoi21  g221(.a(new_n381_), .b(new_n203_), .c(new_n383_), .O(new_n384_));
  nand4  g222(.a(new_n384_), .b(new_n379_), .c(new_n377_), .d(new_n373_), .O(new_n385_));
  nand4  g223(.a(x125), .b(new_n207_), .c(new_n203_), .d(x013), .O(new_n386_));
  inv1   g224(.a(new_n386_), .O(new_n387_));
  aoi21  g225(.a(new_n385_), .b(new_n371_), .c(new_n387_), .O(new_n388_));
  nand3  g226(.a(x085), .b(new_n203_), .c(new_n193_), .O(new_n389_));
  oai21  g227(.a(new_n388_), .b(x053), .c(new_n389_), .O(new_n390_));
  nand2  g228(.a(new_n390_), .b(x005), .O(new_n391_));
  nand2  g229(.a(new_n196_), .b(x029), .O(new_n392_));
  nand2  g230(.a(new_n392_), .b(new_n194_), .O(new_n393_));
  nand2  g231(.a(new_n393_), .b(new_n371_), .O(new_n394_));
  aoi21  g232(.a(new_n394_), .b(new_n193_), .c(new_n375_), .O(new_n395_));
  nor2   g233(.a(new_n192_), .b(x021), .O(new_n396_));
  oai21  g234(.a(new_n396_), .b(new_n231_), .c(x069), .O(new_n397_));
  inv1   g235(.a(new_n374_), .O(new_n398_));
  nand4  g236(.a(new_n398_), .b(new_n372_), .c(new_n196_), .d(x029), .O(new_n399_));
  aoi21  g237(.a(new_n399_), .b(new_n397_), .c(x077), .O(new_n400_));
  oai21  g238(.a(new_n400_), .b(new_n395_), .c(new_n191_), .O(new_n401_));
  nand2  g239(.a(new_n372_), .b(x029), .O(new_n402_));
  nand2  g240(.a(new_n402_), .b(new_n227_), .O(new_n403_));
  nand3  g241(.a(new_n403_), .b(new_n371_), .c(x037), .O(new_n404_));
  nand2  g242(.a(new_n404_), .b(new_n401_), .O(new_n405_));
  oai22  g243(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n406_));
  nand3  g244(.a(new_n406_), .b(x069), .c(x021), .O(new_n407_));
  aoi22  g245(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n408_));
  nand2  g246(.a(new_n408_), .b(new_n407_), .O(new_n409_));
  aoi21  g247(.a(new_n405_), .b(new_n217_), .c(new_n409_), .O(new_n410_));
  aoi21  g248(.a(new_n410_), .b(new_n391_), .c(x045), .O(z13));
  nand2  g249(.a(x022), .b(x014), .O(new_n412_));
  oai21  g250(.a(new_n288_), .b(x030), .c(new_n412_), .O(new_n413_));
  nor2   g251(.a(x126), .b(x102), .O(new_n414_));
  nor2   g252(.a(x118), .b(x110), .O(new_n415_));
  oai21  g253(.a(new_n414_), .b(x094), .c(new_n415_), .O(new_n416_));
  nand2  g254(.a(new_n416_), .b(new_n285_), .O(new_n417_));
  oai21  g255(.a(new_n268_), .b(x110), .c(x038), .O(new_n418_));
  nand2  g256(.a(new_n418_), .b(x118), .O(new_n419_));
  inv1   g257(.a(x102), .O(new_n420_));
  oai21  g258(.a(new_n420_), .b(x062), .c(new_n258_), .O(new_n421_));
  nand3  g259(.a(x126), .b(new_n259_), .c(new_n252_), .O(new_n422_));
  nand2  g260(.a(new_n422_), .b(new_n276_), .O(new_n423_));
  aoi21  g261(.a(new_n421_), .b(new_n263_), .c(new_n423_), .O(new_n424_));
  nand4  g262(.a(new_n424_), .b(new_n419_), .c(new_n417_), .d(new_n413_), .O(new_n425_));
  nand4  g263(.a(x126), .b(new_n266_), .c(new_n263_), .d(x014), .O(new_n426_));
  inv1   g264(.a(new_n426_), .O(new_n427_));
  aoi21  g265(.a(new_n425_), .b(new_n284_), .c(new_n427_), .O(new_n428_));
  nand3  g266(.a(x086), .b(new_n263_), .c(new_n251_), .O(new_n429_));
  oai21  g267(.a(new_n428_), .b(x054), .c(new_n429_), .O(new_n430_));
  nand2  g268(.a(new_n430_), .b(x006), .O(new_n431_));
  nand2  g269(.a(new_n254_), .b(x030), .O(new_n432_));
  nand2  g270(.a(new_n432_), .b(new_n252_), .O(new_n433_));
  nand2  g271(.a(new_n433_), .b(new_n284_), .O(new_n434_));
  aoi21  g272(.a(new_n434_), .b(new_n251_), .c(new_n415_), .O(new_n435_));
  nor2   g273(.a(new_n250_), .b(x022), .O(new_n436_));
  oai21  g274(.a(new_n436_), .b(new_n288_), .c(x070), .O(new_n437_));
  inv1   g275(.a(new_n414_), .O(new_n438_));
  nand4  g276(.a(new_n438_), .b(new_n412_), .c(new_n254_), .d(x030), .O(new_n439_));
  aoi21  g277(.a(new_n439_), .b(new_n437_), .c(x078), .O(new_n440_));
  oai21  g278(.a(new_n440_), .b(new_n435_), .c(new_n249_), .O(new_n441_));
  nand2  g279(.a(new_n412_), .b(x030), .O(new_n442_));
  nand2  g280(.a(new_n442_), .b(new_n280_), .O(new_n443_));
  nand3  g281(.a(new_n443_), .b(new_n284_), .c(x038), .O(new_n444_));
  nand2  g282(.a(new_n444_), .b(new_n441_), .O(new_n445_));
  oai22  g283(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n446_));
  nand3  g284(.a(new_n446_), .b(x070), .c(x022), .O(new_n447_));
  aoi22  g285(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n448_));
  nand2  g286(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  aoi21  g287(.a(new_n445_), .b(new_n276_), .c(new_n449_), .O(new_n450_));
  aoi21  g288(.a(new_n450_), .b(new_n431_), .c(x046), .O(z14));
  zero   g289(.O(z01));
  zero   g290(.O(z02));
  zero   g291(.O(z03));
  zero   g292(.O(z07));
