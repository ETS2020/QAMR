...
module FAU ( 
  ...
  oai22  g165(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n326_));
  nand3  g166(.a(new_n326_), .b(x082), .c(x002), .O(new_n327_));
  oai22  g167(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n328_));
  nand3  g168(.a(new_n328_), .b(x066), .c(x018), .O(new_n329_));
  aoi22  g169(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n330_));
  nand3  g170(.a(new_n330_), .b(new_n329_), .c(new_n327_), .O(new_n331_));
  and2   g171(.a(new_n331_), .b(new_n171_), .O(z10));
  inv1   g172(.a(x077), .O(new_n335_));
  nand2  g173(.a(x021), .b(x013), .O(new_n336_));
  oai21  g174(.a(new_n252_), .b(x029), .c(new_n336_), .O(new_n337_));
  nor2   g175(.a(x125), .b(x101), .O(new_n338_));
  nor2   g176(.a(x117), .b(x109), .O(new_n339_));
  oai21  g177(.a(new_n338_), .b(x093), .c(new_n339_), .O(new_n340_));
  nand2  g178(.a(new_n340_), .b(new_n242_), .O(new_n341_));
  oai21  g179(.a(new_n230_), .b(x109), .c(x037), .O(new_n342_));
  nand2  g180(.a(new_n342_), .b(x117), .O(new_n343_));
  inv1   g181(.a(x101), .O(new_n344_));
  oai21  g182(.a(new_n344_), .b(x061), .c(new_n225_), .O(new_n345_));
  nand3  g183(.a(x125), .b(new_n223_), .c(new_n215_), .O(new_n346_));
  nand2  g184(.a(new_n346_), .b(new_n238_), .O(new_n347_));
  aoi21  g185(.a(new_n345_), .b(new_n224_), .c(new_n347_), .O(new_n348_));
  nand4  g186(.a(new_n348_), .b(new_n343_), .c(new_n341_), .d(new_n337_), .O(new_n349_));
  nand4  g187(.a(x125), .b(new_n228_), .c(new_n224_), .d(x013), .O(new_n350_));
  inv1   g188(.a(new_n350_), .O(new_n351_));
  aoi21  g189(.a(new_n349_), .b(new_n335_), .c(new_n351_), .O(new_n352_));
  nand3  g190(.a(x085), .b(new_n224_), .c(new_n214_), .O(new_n353_));
  oai21  g191(.a(new_n352_), .b(x053), .c(new_n353_), .O(new_n354_));
  nand2  g192(.a(new_n354_), .b(x005), .O(new_n355_));
  nand2  g193(.a(new_n217_), .b(x029), .O(new_n356_));
  nand2  g194(.a(new_n356_), .b(new_n215_), .O(new_n357_));
  nand2  g195(.a(new_n357_), .b(new_n335_), .O(new_n358_));
  aoi21  g196(.a(new_n358_), .b(new_n214_), .c(new_n339_), .O(new_n359_));
  nor2   g197(.a(new_n213_), .b(x021), .O(new_n360_));
  oai21  g198(.a(new_n360_), .b(new_n252_), .c(x069), .O(new_n361_));
  inv1   g199(.a(new_n338_), .O(new_n362_));
  nand4  g200(.a(new_n362_), .b(new_n336_), .c(new_n217_), .d(x029), .O(new_n363_));
  aoi21  g201(.a(new_n363_), .b(new_n361_), .c(x077), .O(new_n364_));
  oai21  g202(.a(new_n364_), .b(new_n359_), .c(new_n212_), .O(new_n365_));
  nand2  g203(.a(new_n336_), .b(x029), .O(new_n366_));
  nand2  g204(.a(new_n366_), .b(new_n248_), .O(new_n367_));
  nand3  g205(.a(new_n367_), .b(new_n335_), .c(x037), .O(new_n368_));
  ...
  aoi21  g211(.a(new_n369_), .b(new_n238_), .c(new_n373_), .O(new_n374_));
  aoi21  g212(.a(new_n374_), .b(new_n355_), .c(x045), .O(z13));
  zero   g213(.O(z00));
  zero   g214(.O(z07));
  zero   g215(.O(z08));
  zero   g216(.O(z09));
