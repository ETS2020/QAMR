...
module FAU ( 
  ...
  oai22  g233(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n393_));
  nand3  g234(.a(new_n393_), .b(x084), .c(x004), .O(new_n394_));
  oai22  g235(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n395_));
  nand3  g236(.a(new_n395_), .b(x068), .c(x020), .O(new_n396_));
  aoi22  g237(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n397_));
  nand3  g238(.a(new_n397_), .b(new_n396_), .c(new_n394_), .O(new_n398_));
  and2   g239(.a(new_n398_), .b(new_n200_), .O(z12));
