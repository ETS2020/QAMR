...
module FAU ( 
  ...
  and2   g153(.a(new_n314_), .b(new_n174_), .O(z10));
  oai22  g154(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n316_));
  nand3  g155(.a(new_n316_), .b(x083), .c(x003), .O(new_n317_));
  oai22  g156(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n318_));
  nand3  g157(.a(new_n318_), .b(x067), .c(x019), .O(new_n319_));
  aoi22  g158(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n320_));
  nand3  g159(.a(new_n320_), .b(new_n319_), .c(new_n317_), .O(new_n321_));
  inv1   g160(.a(new_n321_), .O(new_n322_));
  nor2   g161(.a(new_n322_), .b(x043), .O(z11));
