// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:16 2020
...
module FAU ( 
  ...
  inv1   g103(.a(new_n266_), .O(new_n267_));
  nor2   g104(.a(new_n267_), .b(x043), .O(z11));
  inv1   g105(.a(x077), .O(new_n270_));
  nand2  g106(.a(x021), .b(x013), .O(new_n271_));
  oai21  g107(.a(new_n240_), .b(x029), .c(new_n271_), .O(new_n272_));
  nor2   g108(.a(x125), .b(x101), .O(new_n273_));
  nor2   g109(.a(x117), .b(x109), .O(new_n274_));
  oai21  g110(.a(new_n273_), .b(x093), .c(new_n274_), .O(new_n275_));
  nand2  g111(.a(new_n275_), .b(new_n230_), .O(new_n276_));
  oai21  g112(.a(new_n218_), .b(x109), .c(x037), .O(new_n277_));
  nand2  g113(.a(new_n277_), .b(x117), .O(new_n278_));
  inv1   g114(.a(x101), .O(new_n279_));
  oai21  g115(.a(new_n279_), .b(x061), .c(new_n213_), .O(new_n280_));
  nand3  g116(.a(x125), .b(new_n211_), .c(new_n203_), .O(new_n281_));
  nand2  g117(.a(new_n281_), .b(new_n226_), .O(new_n282_));
  aoi21  g118(.a(new_n280_), .b(new_n212_), .c(new_n282_), .O(new_n283_));
  nand4  g119(.a(new_n283_), .b(new_n278_), .c(new_n276_), .d(new_n272_), .O(new_n284_));
  nand4  g120(.a(x125), .b(new_n216_), .c(new_n212_), .d(x013), .O(new_n285_));
  inv1   g121(.a(new_n285_), .O(new_n286_));
  aoi21  g122(.a(new_n284_), .b(new_n270_), .c(new_n286_), .O(new_n287_));
  nand3  g123(.a(x085), .b(new_n212_), .c(new_n202_), .O(new_n288_));
  oai21  g124(.a(new_n287_), .b(x053), .c(new_n288_), .O(new_n289_));
  nand2  g125(.a(new_n289_), .b(x005), .O(new_n290_));
  nand2  g126(.a(new_n205_), .b(x029), .O(new_n291_));
  nand2  g127(.a(new_n291_), .b(new_n203_), .O(new_n292_));
  nand2  g128(.a(new_n292_), .b(new_n270_), .O(new_n293_));
  aoi21  g129(.a(new_n293_), .b(new_n202_), .c(new_n274_), .O(new_n294_));
  nor2   g130(.a(new_n201_), .b(x021), .O(new_n295_));
  oai21  g131(.a(new_n295_), .b(new_n240_), .c(x069), .O(new_n296_));
  inv1   g132(.a(new_n273_), .O(new_n297_));
  nand4  g133(.a(new_n297_), .b(new_n271_), .c(new_n205_), .d(x029), .O(new_n298_));
  aoi21  g134(.a(new_n298_), .b(new_n296_), .c(x077), .O(new_n299_));
  oai21  g135(.a(new_n299_), .b(new_n294_), .c(new_n200_), .O(new_n300_));
  nand2  g136(.a(new_n271_), .b(x029), .O(new_n301_));
  nand2  g137(.a(new_n301_), .b(new_n236_), .O(new_n302_));
  nand3  g138(.a(new_n302_), .b(new_n270_), .c(x037), .O(new_n303_));
  nand2  g139(.a(new_n303_), .b(new_n300_), .O(new_n304_));
  oai22  g140(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n305_));
  nand3  g141(.a(new_n305_), .b(x069), .c(x021), .O(new_n306_));
  aoi22  g142(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n307_));
  nand2  g143(.a(new_n307_), .b(new_n306_), .O(new_n308_));
  aoi21  g144(.a(new_n304_), .b(new_n226_), .c(new_n308_), .O(new_n309_));
  aoi21  g145(.a(new_n309_), .b(new_n290_), .c(x045), .O(z13));
  zero   g146(.O(z00));
  zero   g147(.O(z03));
  zero   g148(.O(z06));
  zero   g149(.O(z07));
