// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:37 2020
...
module FAU ( 
  ...
  oai22  g225(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n385_));
  nand3  g226(.a(new_n385_), .b(x083), .c(x003), .O(new_n386_));
  oai22  g227(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n387_));
  nand3  g228(.a(new_n387_), .b(x067), .c(x019), .O(new_n388_));
  aoi22  g229(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n389_));
  nand3  g230(.a(new_n389_), .b(new_n388_), .c(new_n386_), .O(new_n390_));
  and2   g231(.a(new_n390_), .b(new_n187_), .O(z11));
  inv1   g232(.a(x077), .O(new_n393_));
  nand2  g233(.a(x021), .b(x013), .O(new_n394_));
  oai21  g234(.a(new_n255_), .b(x029), .c(new_n394_), .O(new_n395_));
  nor2   g235(.a(x125), .b(x101), .O(new_n396_));
  nor2   g236(.a(x117), .b(x109), .O(new_n397_));
  oai21  g237(.a(new_n396_), .b(x093), .c(new_n397_), .O(new_n398_));
  nand2  g238(.a(new_n398_), .b(new_n245_), .O(new_n399_));
  oai21  g239(.a(new_n233_), .b(x109), .c(x037), .O(new_n400_));
  nand2  g240(.a(new_n400_), .b(x117), .O(new_n401_));
  inv1   g241(.a(x101), .O(new_n402_));
  oai21  g242(.a(new_n402_), .b(x061), .c(new_n228_), .O(new_n403_));
  nand3  g243(.a(x125), .b(new_n226_), .c(new_n218_), .O(new_n404_));
  nand2  g244(.a(new_n404_), .b(new_n241_), .O(new_n405_));
  aoi21  g245(.a(new_n403_), .b(new_n227_), .c(new_n405_), .O(new_n406_));
  nand4  g246(.a(new_n406_), .b(new_n401_), .c(new_n399_), .d(new_n395_), .O(new_n407_));
  nand4  g247(.a(x125), .b(new_n231_), .c(new_n227_), .d(x013), .O(new_n408_));
  inv1   g248(.a(new_n408_), .O(new_n409_));
  aoi21  g249(.a(new_n407_), .b(new_n393_), .c(new_n409_), .O(new_n410_));
  nand3  g250(.a(x085), .b(new_n227_), .c(new_n217_), .O(new_n411_));
  oai21  g251(.a(new_n410_), .b(x053), .c(new_n411_), .O(new_n412_));
  nand2  g252(.a(new_n412_), .b(x005), .O(new_n413_));
  nand2  g253(.a(new_n220_), .b(x029), .O(new_n414_));
  nand2  g254(.a(new_n414_), .b(new_n218_), .O(new_n415_));
  nand2  g255(.a(new_n415_), .b(new_n393_), .O(new_n416_));
  aoi21  g256(.a(new_n416_), .b(new_n217_), .c(new_n397_), .O(new_n417_));
  nor2   g257(.a(new_n216_), .b(x021), .O(new_n418_));
  oai21  g258(.a(new_n418_), .b(new_n255_), .c(x069), .O(new_n419_));
  inv1   g259(.a(new_n396_), .O(new_n420_));
  nand4  g260(.a(new_n420_), .b(new_n394_), .c(new_n220_), .d(x029), .O(new_n421_));
  aoi21  g261(.a(new_n421_), .b(new_n419_), .c(x077), .O(new_n422_));
  oai21  g262(.a(new_n422_), .b(new_n417_), .c(new_n215_), .O(new_n423_));
  nand2  g263(.a(new_n394_), .b(x029), .O(new_n424_));
  nand2  g264(.a(new_n424_), .b(new_n251_), .O(new_n425_));
  nand3  g265(.a(new_n425_), .b(new_n393_), .c(x037), .O(new_n426_));
  nand2  g266(.a(new_n426_), .b(new_n423_), .O(new_n427_));
  oai22  g267(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n428_));
  nand3  g268(.a(new_n428_), .b(x069), .c(x021), .O(new_n429_));
  aoi22  g269(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n430_));
  nand2  g270(.a(new_n430_), .b(new_n429_), .O(new_n431_));
  aoi21  g271(.a(new_n427_), .b(new_n241_), .c(new_n431_), .O(new_n432_));
  aoi21  g272(.a(new_n432_), .b(new_n413_), .c(x045), .O(z13));
  nand2  g273(.a(x022), .b(x014), .O(new_n434_));
  oai21  g274(.a(new_n312_), .b(x030), .c(new_n434_), .O(new_n435_));
  nor2   g275(.a(x126), .b(x102), .O(new_n436_));
  nor2   g276(.a(x118), .b(x110), .O(new_n437_));
  oai21  g277(.a(new_n436_), .b(x094), .c(new_n437_), .O(new_n438_));
  nand2  g278(.a(new_n438_), .b(new_n309_), .O(new_n439_));
  oai21  g279(.a(new_n292_), .b(x110), .c(x038), .O(new_n440_));
  nand2  g280(.a(new_n440_), .b(x118), .O(new_n441_));
  inv1   g281(.a(x102), .O(new_n442_));
  oai21  g282(.a(new_n442_), .b(x062), .c(new_n282_), .O(new_n443_));
  nand3  g283(.a(x126), .b(new_n283_), .c(new_n276_), .O(new_n444_));
  nand2  g284(.a(new_n444_), .b(new_n300_), .O(new_n445_));
  aoi21  g285(.a(new_n443_), .b(new_n287_), .c(new_n445_), .O(new_n446_));
  nand4  g286(.a(new_n446_), .b(new_n441_), .c(new_n439_), .d(new_n435_), .O(new_n447_));
  nand4  g287(.a(x126), .b(new_n290_), .c(new_n287_), .d(x014), .O(new_n448_));
  inv1   g288(.a(new_n448_), .O(new_n449_));
  aoi21  g289(.a(new_n447_), .b(new_n308_), .c(new_n449_), .O(new_n450_));
  nand3  g290(.a(x086), .b(new_n287_), .c(new_n275_), .O(new_n451_));
  oai21  g291(.a(new_n450_), .b(x054), .c(new_n451_), .O(new_n452_));
  nand2  g292(.a(new_n452_), .b(x006), .O(new_n453_));
  nand2  g293(.a(new_n278_), .b(x030), .O(new_n454_));
  nand2  g294(.a(new_n454_), .b(new_n276_), .O(new_n455_));
  nand2  g295(.a(new_n455_), .b(new_n308_), .O(new_n456_));
  aoi21  g296(.a(new_n456_), .b(new_n275_), .c(new_n437_), .O(new_n457_));
  nor2   g297(.a(new_n274_), .b(x022), .O(new_n458_));
  oai21  g298(.a(new_n458_), .b(new_n312_), .c(x070), .O(new_n459_));
  inv1   g299(.a(new_n436_), .O(new_n460_));
  nand4  g300(.a(new_n460_), .b(new_n434_), .c(new_n278_), .d(x030), .O(new_n461_));
  aoi21  g301(.a(new_n461_), .b(new_n459_), .c(x078), .O(new_n462_));
  oai21  g302(.a(new_n462_), .b(new_n457_), .c(new_n273_), .O(new_n463_));
  nand2  g303(.a(new_n434_), .b(x030), .O(new_n464_));
  nand2  g304(.a(new_n464_), .b(new_n304_), .O(new_n465_));
  nand3  g305(.a(new_n465_), .b(new_n308_), .c(x038), .O(new_n466_));
  nand2  g306(.a(new_n466_), .b(new_n463_), .O(new_n467_));
  oai22  g307(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n468_));
  nand3  g308(.a(new_n468_), .b(x070), .c(x022), .O(new_n469_));
  aoi22  g309(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n470_));
  nand2  g310(.a(new_n470_), .b(new_n469_), .O(new_n471_));
  aoi21  g311(.a(new_n467_), .b(new_n300_), .c(new_n471_), .O(new_n472_));
  aoi21  g312(.a(new_n472_), .b(new_n453_), .c(x046), .O(z14));
  zero   g313(.O(z02));
  zero   g314(.O(z07));
  zero   g315(.O(z10));
  zero   g316(.O(z12));
