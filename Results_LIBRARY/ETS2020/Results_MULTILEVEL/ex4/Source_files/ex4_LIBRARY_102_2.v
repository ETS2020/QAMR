// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:18 2020
...
module FAU ( 
  ...
  wire new_n159_, new_n160_, new_n161_, new_n162_, new_n163_, new_n164_,
    ...
    new_n250_, new_n251_, new_n252_, new_n253_, new_n257_, new_n258_,
  ...
  oai22  g092(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n257_));
  nand3  g093(.a(new_n257_), .b(x084), .c(x004), .O(new_n258_));
  oai22  g094(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n259_));
  nand3  g095(.a(new_n259_), .b(x068), .c(x020), .O(new_n260_));
  aoi22  g096(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n261_));
  nand3  g097(.a(new_n261_), .b(new_n260_), .c(new_n258_), .O(new_n262_));
  inv1   g098(.a(new_n262_), .O(new_n263_));
  nor2   g099(.a(new_n263_), .b(x044), .O(z12));
  inv1   g100(.a(x077), .O(new_n265_));
  nand2  g101(.a(x021), .b(x013), .O(new_n266_));
  oai21  g102(.a(new_n228_), .b(x029), .c(new_n266_), .O(new_n267_));
  nor2   g103(.a(x125), .b(x101), .O(new_n268_));
  nor2   g104(.a(x117), .b(x109), .O(new_n269_));
  oai21  g105(.a(new_n268_), .b(x093), .c(new_n269_), .O(new_n270_));
  nand2  g106(.a(new_n270_), .b(new_n218_), .O(new_n271_));
  oai21  g107(.a(new_n206_), .b(x109), .c(x037), .O(new_n272_));
  nand2  g108(.a(new_n272_), .b(x117), .O(new_n273_));
  inv1   g109(.a(x101), .O(new_n274_));
  oai21  g110(.a(new_n274_), .b(x061), .c(new_n201_), .O(new_n275_));
  nand3  g111(.a(x125), .b(new_n199_), .c(new_n191_), .O(new_n276_));
  nand2  g112(.a(new_n276_), .b(new_n214_), .O(new_n277_));
  aoi21  g113(.a(new_n275_), .b(new_n200_), .c(new_n277_), .O(new_n278_));
  nand4  g114(.a(new_n278_), .b(new_n273_), .c(new_n271_), .d(new_n267_), .O(new_n279_));
  nand4  g115(.a(x125), .b(new_n204_), .c(new_n200_), .d(x013), .O(new_n280_));
  inv1   g116(.a(new_n280_), .O(new_n281_));
  aoi21  g117(.a(new_n279_), .b(new_n265_), .c(new_n281_), .O(new_n282_));
  nand3  g118(.a(x085), .b(new_n200_), .c(new_n190_), .O(new_n283_));
  oai21  g119(.a(new_n282_), .b(x053), .c(new_n283_), .O(new_n284_));
  nand2  g120(.a(new_n284_), .b(x005), .O(new_n285_));
  nand2  g121(.a(new_n193_), .b(x029), .O(new_n286_));
  nand2  g122(.a(new_n286_), .b(new_n191_), .O(new_n287_));
  nand2  g123(.a(new_n287_), .b(new_n265_), .O(new_n288_));
  aoi21  g124(.a(new_n288_), .b(new_n190_), .c(new_n269_), .O(new_n289_));
  nor2   g125(.a(new_n189_), .b(x021), .O(new_n290_));
  oai21  g126(.a(new_n290_), .b(new_n228_), .c(x069), .O(new_n291_));
  inv1   g127(.a(new_n268_), .O(new_n292_));
  nand4  g128(.a(new_n292_), .b(new_n266_), .c(new_n193_), .d(x029), .O(new_n293_));
  aoi21  g129(.a(new_n293_), .b(new_n291_), .c(x077), .O(new_n294_));
  oai21  g130(.a(new_n294_), .b(new_n289_), .c(new_n188_), .O(new_n295_));
  nand2  g131(.a(new_n266_), .b(x029), .O(new_n296_));
  nand2  g132(.a(new_n296_), .b(new_n224_), .O(new_n297_));
  nand3  g133(.a(new_n297_), .b(new_n265_), .c(x037), .O(new_n298_));
  nand2  g134(.a(new_n298_), .b(new_n295_), .O(new_n299_));
  oai22  g135(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n300_));
  nand3  g136(.a(new_n300_), .b(x069), .c(x021), .O(new_n301_));
  aoi22  g137(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n302_));
  nand2  g138(.a(new_n302_), .b(new_n301_), .O(new_n303_));
  aoi21  g139(.a(new_n299_), .b(new_n214_), .c(new_n303_), .O(new_n304_));
  aoi21  g140(.a(new_n304_), .b(new_n285_), .c(x045), .O(z13));
  zero   g141(.O(z00));
  zero   g142(.O(z01));
  zero   g143(.O(z04));
  zero   g144(.O(z06));
