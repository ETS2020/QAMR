// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:43 2020
...
module FAU ( 
  ...
  inv1   g090(.a(new_n254_), .O(new_n255_));
  nor2   g091(.a(new_n255_), .b(x043), .O(z11));
  inv1   g092(.a(x077), .O(new_n258_));
  nand2  g093(.a(x021), .b(x013), .O(new_n259_));
  oai21  g094(.a(new_n228_), .b(x029), .c(new_n259_), .O(new_n260_));
  nor2   g095(.a(x125), .b(x101), .O(new_n261_));
  nor2   g096(.a(x117), .b(x109), .O(new_n262_));
  oai21  g097(.a(new_n261_), .b(x093), .c(new_n262_), .O(new_n263_));
  nand2  g098(.a(new_n263_), .b(new_n218_), .O(new_n264_));
  oai21  g099(.a(new_n206_), .b(x109), .c(x037), .O(new_n265_));
  nand2  g100(.a(new_n265_), .b(x117), .O(new_n266_));
  inv1   g101(.a(x101), .O(new_n267_));
  oai21  g102(.a(new_n267_), .b(x061), .c(new_n201_), .O(new_n268_));
  nand3  g103(.a(x125), .b(new_n199_), .c(new_n191_), .O(new_n269_));
  nand2  g104(.a(new_n269_), .b(new_n214_), .O(new_n270_));
  aoi21  g105(.a(new_n268_), .b(new_n200_), .c(new_n270_), .O(new_n271_));
  nand4  g106(.a(new_n271_), .b(new_n266_), .c(new_n264_), .d(new_n260_), .O(new_n272_));
  nand4  g107(.a(x125), .b(new_n204_), .c(new_n200_), .d(x013), .O(new_n273_));
  inv1   g108(.a(new_n273_), .O(new_n274_));
  aoi21  g109(.a(new_n272_), .b(new_n258_), .c(new_n274_), .O(new_n275_));
  nand3  g110(.a(x085), .b(new_n200_), .c(new_n190_), .O(new_n276_));
  oai21  g111(.a(new_n275_), .b(x053), .c(new_n276_), .O(new_n277_));
  nand2  g112(.a(new_n277_), .b(x005), .O(new_n278_));
  nand2  g113(.a(new_n193_), .b(x029), .O(new_n279_));
  nand2  g114(.a(new_n279_), .b(new_n191_), .O(new_n280_));
  nand2  g115(.a(new_n280_), .b(new_n258_), .O(new_n281_));
  aoi21  g116(.a(new_n281_), .b(new_n190_), .c(new_n262_), .O(new_n282_));
  nor2   g117(.a(new_n189_), .b(x021), .O(new_n283_));
  oai21  g118(.a(new_n283_), .b(new_n228_), .c(x069), .O(new_n284_));
  inv1   g119(.a(new_n261_), .O(new_n285_));
  nand4  g120(.a(new_n285_), .b(new_n259_), .c(new_n193_), .d(x029), .O(new_n286_));
  aoi21  g121(.a(new_n286_), .b(new_n284_), .c(x077), .O(new_n287_));
  oai21  g122(.a(new_n287_), .b(new_n282_), .c(new_n188_), .O(new_n288_));
  nand2  g123(.a(new_n259_), .b(x029), .O(new_n289_));
  nand2  g124(.a(new_n289_), .b(new_n224_), .O(new_n290_));
  nand3  g125(.a(new_n290_), .b(new_n258_), .c(x037), .O(new_n291_));
  nand2  g126(.a(new_n291_), .b(new_n288_), .O(new_n292_));
  oai22  g127(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n293_));
  nand3  g128(.a(new_n293_), .b(x069), .c(x021), .O(new_n294_));
  aoi22  g129(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n295_));
  nand2  g130(.a(new_n295_), .b(new_n294_), .O(new_n296_));
  aoi21  g131(.a(new_n292_), .b(new_n214_), .c(new_n296_), .O(new_n297_));
  aoi21  g132(.a(new_n297_), .b(new_n278_), .c(x045), .O(z13));
  zero   g133(.O(z00));
  zero   g134(.O(z03));
  zero   g135(.O(z04));
  zero   g136(.O(z06));
