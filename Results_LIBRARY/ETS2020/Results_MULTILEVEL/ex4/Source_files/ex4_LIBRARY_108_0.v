// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:25 2020
...
module FAU ( 
  ...
  aoi22  g209(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n370_));
  nand3  g210(.a(new_n370_), .b(new_n369_), .c(new_n367_), .O(new_n371_));
  inv1   g211(.a(new_n371_), .O(new_n372_));
  nor2   g212(.a(new_n372_), .b(x042), .O(z10));
  oai22  g213(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n374_));
  nand3  g214(.a(new_n374_), .b(x083), .c(x003), .O(new_n375_));
  oai22  g215(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n376_));
  nand3  g216(.a(new_n376_), .b(x067), .c(x019), .O(new_n377_));
  aoi22  g217(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n378_));
  nand3  g218(.a(new_n378_), .b(new_n377_), .c(new_n375_), .O(new_n379_));
  and2   g219(.a(new_n379_), .b(new_n175_), .O(z11));
  oai22  g220(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n381_));
  nand3  g221(.a(new_n381_), .b(x084), .c(x004), .O(new_n382_));
  oai22  g222(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n383_));
  nand3  g223(.a(new_n383_), .b(x068), .c(x020), .O(new_n384_));
  aoi22  g224(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n385_));
  nand3  g225(.a(new_n385_), .b(new_n384_), .c(new_n382_), .O(new_n386_));
  and2   g226(.a(new_n386_), .b(new_n188_), .O(z12));
  inv1   g227(.a(x077), .O(new_n388_));
  nand2  g228(.a(x021), .b(x013), .O(new_n389_));
  oai21  g229(.a(new_n243_), .b(x029), .c(new_n389_), .O(new_n390_));
  nor2   g230(.a(x125), .b(x101), .O(new_n391_));
  nor2   g231(.a(x117), .b(x109), .O(new_n392_));
  oai21  g232(.a(new_n391_), .b(x093), .c(new_n392_), .O(new_n393_));
  nand2  g233(.a(new_n393_), .b(new_n233_), .O(new_n394_));
  oai21  g234(.a(new_n221_), .b(x109), .c(x037), .O(new_n395_));
  nand2  g235(.a(new_n395_), .b(x117), .O(new_n396_));
  inv1   g236(.a(x101), .O(new_n397_));
  oai21  g237(.a(new_n397_), .b(x061), .c(new_n216_), .O(new_n398_));
  nand3  g238(.a(x125), .b(new_n214_), .c(new_n206_), .O(new_n399_));
  nand2  g239(.a(new_n399_), .b(new_n229_), .O(new_n400_));
  aoi21  g240(.a(new_n398_), .b(new_n215_), .c(new_n400_), .O(new_n401_));
  nand4  g241(.a(new_n401_), .b(new_n396_), .c(new_n394_), .d(new_n390_), .O(new_n402_));
  nand4  g242(.a(x125), .b(new_n219_), .c(new_n215_), .d(x013), .O(new_n403_));
  inv1   g243(.a(new_n403_), .O(new_n404_));
  aoi21  g244(.a(new_n402_), .b(new_n388_), .c(new_n404_), .O(new_n405_));
  nand3  g245(.a(x085), .b(new_n215_), .c(new_n205_), .O(new_n406_));
  oai21  g246(.a(new_n405_), .b(x053), .c(new_n406_), .O(new_n407_));
  nand2  g247(.a(new_n407_), .b(x005), .O(new_n408_));
  nand2  g248(.a(new_n208_), .b(x029), .O(new_n409_));
  nand2  g249(.a(new_n409_), .b(new_n206_), .O(new_n410_));
  nand2  g250(.a(new_n410_), .b(new_n388_), .O(new_n411_));
  aoi21  g251(.a(new_n411_), .b(new_n205_), .c(new_n392_), .O(new_n412_));
  nor2   g252(.a(new_n204_), .b(x021), .O(new_n413_));
  oai21  g253(.a(new_n413_), .b(new_n243_), .c(x069), .O(new_n414_));
  inv1   g254(.a(new_n391_), .O(new_n415_));
  nand4  g255(.a(new_n415_), .b(new_n389_), .c(new_n208_), .d(x029), .O(new_n416_));
  aoi21  g256(.a(new_n416_), .b(new_n414_), .c(x077), .O(new_n417_));
  oai21  g257(.a(new_n417_), .b(new_n412_), .c(new_n203_), .O(new_n418_));
  nand2  g258(.a(new_n389_), .b(x029), .O(new_n419_));
  nand2  g259(.a(new_n419_), .b(new_n239_), .O(new_n420_));
  nand3  g260(.a(new_n420_), .b(new_n388_), .c(x037), .O(new_n421_));
  nand2  g261(.a(new_n421_), .b(new_n418_), .O(new_n422_));
  oai22  g262(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n423_));
  nand3  g263(.a(new_n423_), .b(x069), .c(x021), .O(new_n424_));
  aoi22  g264(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n425_));
  nand2  g265(.a(new_n425_), .b(new_n424_), .O(new_n426_));
  aoi21  g266(.a(new_n422_), .b(new_n229_), .c(new_n426_), .O(new_n427_));
  aoi21  g267(.a(new_n427_), .b(new_n408_), .c(x045), .O(z13));
  nand2  g268(.a(x022), .b(x014), .O(new_n429_));
  oai21  g269(.a(new_n300_), .b(x030), .c(new_n429_), .O(new_n430_));
  nor2   g270(.a(x126), .b(x102), .O(new_n431_));
  nor2   g271(.a(x118), .b(x110), .O(new_n432_));
  oai21  g272(.a(new_n431_), .b(x094), .c(new_n432_), .O(new_n433_));
  nand2  g273(.a(new_n433_), .b(new_n297_), .O(new_n434_));
  oai21  g274(.a(new_n280_), .b(x110), .c(x038), .O(new_n435_));
  nand2  g275(.a(new_n435_), .b(x118), .O(new_n436_));
  inv1   g276(.a(x102), .O(new_n437_));
  oai21  g277(.a(new_n437_), .b(x062), .c(new_n270_), .O(new_n438_));
  nand3  g278(.a(x126), .b(new_n271_), .c(new_n264_), .O(new_n439_));
  nand2  g279(.a(new_n439_), .b(new_n288_), .O(new_n440_));
  aoi21  g280(.a(new_n438_), .b(new_n275_), .c(new_n440_), .O(new_n441_));
  nand4  g281(.a(new_n441_), .b(new_n436_), .c(new_n434_), .d(new_n430_), .O(new_n442_));
  nand4  g282(.a(x126), .b(new_n278_), .c(new_n275_), .d(x014), .O(new_n443_));
  inv1   g283(.a(new_n443_), .O(new_n444_));
  aoi21  g284(.a(new_n442_), .b(new_n296_), .c(new_n444_), .O(new_n445_));
  nand3  g285(.a(x086), .b(new_n275_), .c(new_n263_), .O(new_n446_));
  oai21  g286(.a(new_n445_), .b(x054), .c(new_n446_), .O(new_n447_));
  nand2  g287(.a(new_n447_), .b(x006), .O(new_n448_));
  nand2  g288(.a(new_n266_), .b(x030), .O(new_n449_));
  nand2  g289(.a(new_n449_), .b(new_n264_), .O(new_n450_));
  nand2  g290(.a(new_n450_), .b(new_n296_), .O(new_n451_));
  aoi21  g291(.a(new_n451_), .b(new_n263_), .c(new_n432_), .O(new_n452_));
  nor2   g292(.a(new_n262_), .b(x022), .O(new_n453_));
  oai21  g293(.a(new_n453_), .b(new_n300_), .c(x070), .O(new_n454_));
  inv1   g294(.a(new_n431_), .O(new_n455_));
  nand4  g295(.a(new_n455_), .b(new_n429_), .c(new_n266_), .d(x030), .O(new_n456_));
  aoi21  g296(.a(new_n456_), .b(new_n454_), .c(x078), .O(new_n457_));
  oai21  g297(.a(new_n457_), .b(new_n452_), .c(new_n261_), .O(new_n458_));
  nand2  g298(.a(new_n429_), .b(x030), .O(new_n459_));
  nand2  g299(.a(new_n459_), .b(new_n292_), .O(new_n460_));
  nand3  g300(.a(new_n460_), .b(new_n296_), .c(x038), .O(new_n461_));
  nand2  g301(.a(new_n461_), .b(new_n458_), .O(new_n462_));
  oai22  g302(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n463_));
  nand3  g303(.a(new_n463_), .b(x070), .c(x022), .O(new_n464_));
  aoi22  g304(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n465_));
  nand2  g305(.a(new_n465_), .b(new_n464_), .O(new_n466_));
  aoi21  g306(.a(new_n462_), .b(new_n288_), .c(new_n466_), .O(new_n467_));
  aoi21  g307(.a(new_n467_), .b(new_n448_), .c(x046), .O(z14));
  zero   g308(.O(z01));
  zero   g309(.O(z02));
  zero   g310(.O(z07));
  zero   g311(.O(z09));
