// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:05 2020
...
module FAU ( 
  ...
  oai22  g192(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n354_));
  nand3  g193(.a(new_n354_), .b(x082), .c(x002), .O(new_n355_));
  oai22  g194(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n356_));
  nand3  g195(.a(new_n356_), .b(x066), .c(x018), .O(new_n357_));
  aoi22  g196(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n358_));
  nand3  g197(.a(new_n358_), .b(new_n357_), .c(new_n355_), .O(new_n359_));
  inv1   g198(.a(new_n359_), .O(new_n360_));
  nor2   g199(.a(new_n360_), .b(x042), .O(z10));
  oai22  g200(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n362_));
  nand3  g201(.a(new_n362_), .b(x083), .c(x003), .O(new_n363_));
  oai22  g202(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n364_));
  nand3  g203(.a(new_n364_), .b(x067), .c(x019), .O(new_n365_));
  aoi22  g204(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n366_));
  nand3  g205(.a(new_n366_), .b(new_n365_), .c(new_n363_), .O(new_n367_));
  and2   g206(.a(new_n367_), .b(new_n175_), .O(z11));
  oai22  g207(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n369_));
  nand3  g208(.a(new_n369_), .b(x084), .c(x004), .O(new_n370_));
  oai22  g209(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n371_));
  nand3  g210(.a(new_n371_), .b(x068), .c(x020), .O(new_n372_));
  aoi22  g211(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n373_));
  nand3  g212(.a(new_n373_), .b(new_n372_), .c(new_n370_), .O(new_n374_));
  inv1   g213(.a(new_n374_), .O(new_n375_));
  nor2   g214(.a(new_n375_), .b(x044), .O(z12));
  inv1   g215(.a(x077), .O(new_n377_));
  nand2  g216(.a(x021), .b(x013), .O(new_n378_));
  oai21  g217(.a(new_n231_), .b(x029), .c(new_n378_), .O(new_n379_));
  nor2   g218(.a(x125), .b(x101), .O(new_n380_));
  nor2   g219(.a(x117), .b(x109), .O(new_n381_));
  oai21  g220(.a(new_n380_), .b(x093), .c(new_n381_), .O(new_n382_));
  nand2  g221(.a(new_n382_), .b(new_n221_), .O(new_n383_));
  oai21  g222(.a(new_n209_), .b(x109), .c(x037), .O(new_n384_));
  nand2  g223(.a(new_n384_), .b(x117), .O(new_n385_));
  inv1   g224(.a(x101), .O(new_n386_));
  oai21  g225(.a(new_n386_), .b(x061), .c(new_n204_), .O(new_n387_));
  nand3  g226(.a(x125), .b(new_n202_), .c(new_n194_), .O(new_n388_));
  nand2  g227(.a(new_n388_), .b(new_n217_), .O(new_n389_));
  aoi21  g228(.a(new_n387_), .b(new_n203_), .c(new_n389_), .O(new_n390_));
  nand4  g229(.a(new_n390_), .b(new_n385_), .c(new_n383_), .d(new_n379_), .O(new_n391_));
  nand4  g230(.a(x125), .b(new_n207_), .c(new_n203_), .d(x013), .O(new_n392_));
  inv1   g231(.a(new_n392_), .O(new_n393_));
  aoi21  g232(.a(new_n391_), .b(new_n377_), .c(new_n393_), .O(new_n394_));
  nand3  g233(.a(x085), .b(new_n203_), .c(new_n193_), .O(new_n395_));
  oai21  g234(.a(new_n394_), .b(x053), .c(new_n395_), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(x005), .O(new_n397_));
  nand2  g236(.a(new_n196_), .b(x029), .O(new_n398_));
  nand2  g237(.a(new_n398_), .b(new_n194_), .O(new_n399_));
  nand2  g238(.a(new_n399_), .b(new_n377_), .O(new_n400_));
  aoi21  g239(.a(new_n400_), .b(new_n193_), .c(new_n381_), .O(new_n401_));
  nor2   g240(.a(new_n192_), .b(x021), .O(new_n402_));
  oai21  g241(.a(new_n402_), .b(new_n231_), .c(x069), .O(new_n403_));
  inv1   g242(.a(new_n380_), .O(new_n404_));
  nand4  g243(.a(new_n404_), .b(new_n378_), .c(new_n196_), .d(x029), .O(new_n405_));
  aoi21  g244(.a(new_n405_), .b(new_n403_), .c(x077), .O(new_n406_));
  oai21  g245(.a(new_n406_), .b(new_n401_), .c(new_n191_), .O(new_n407_));
  nand2  g246(.a(new_n378_), .b(x029), .O(new_n408_));
  nand2  g247(.a(new_n408_), .b(new_n227_), .O(new_n409_));
  nand3  g248(.a(new_n409_), .b(new_n377_), .c(x037), .O(new_n410_));
  nand2  g249(.a(new_n410_), .b(new_n407_), .O(new_n411_));
  oai22  g250(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n412_));
  nand3  g251(.a(new_n412_), .b(x069), .c(x021), .O(new_n413_));
  aoi22  g252(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n414_));
  nand2  g253(.a(new_n414_), .b(new_n413_), .O(new_n415_));
  aoi21  g254(.a(new_n411_), .b(new_n217_), .c(new_n415_), .O(new_n416_));
  aoi21  g255(.a(new_n416_), .b(new_n397_), .c(x045), .O(z13));
  nand2  g256(.a(x022), .b(x014), .O(new_n418_));
  oai21  g257(.a(new_n288_), .b(x030), .c(new_n418_), .O(new_n419_));
  nor2   g258(.a(x126), .b(x102), .O(new_n420_));
  nor2   g259(.a(x118), .b(x110), .O(new_n421_));
  oai21  g260(.a(new_n420_), .b(x094), .c(new_n421_), .O(new_n422_));
  nand2  g261(.a(new_n422_), .b(new_n285_), .O(new_n423_));
  oai21  g262(.a(new_n268_), .b(x110), .c(x038), .O(new_n424_));
  nand2  g263(.a(new_n424_), .b(x118), .O(new_n425_));
  inv1   g264(.a(x102), .O(new_n426_));
  oai21  g265(.a(new_n426_), .b(x062), .c(new_n258_), .O(new_n427_));
  nand3  g266(.a(x126), .b(new_n259_), .c(new_n252_), .O(new_n428_));
  nand2  g267(.a(new_n428_), .b(new_n276_), .O(new_n429_));
  aoi21  g268(.a(new_n427_), .b(new_n263_), .c(new_n429_), .O(new_n430_));
  nand4  g269(.a(new_n430_), .b(new_n425_), .c(new_n423_), .d(new_n419_), .O(new_n431_));
  nand4  g270(.a(x126), .b(new_n266_), .c(new_n263_), .d(x014), .O(new_n432_));
  inv1   g271(.a(new_n432_), .O(new_n433_));
  aoi21  g272(.a(new_n431_), .b(new_n284_), .c(new_n433_), .O(new_n434_));
  nand3  g273(.a(x086), .b(new_n263_), .c(new_n251_), .O(new_n435_));
  oai21  g274(.a(new_n434_), .b(x054), .c(new_n435_), .O(new_n436_));
  nand2  g275(.a(new_n436_), .b(x006), .O(new_n437_));
  nand2  g276(.a(new_n254_), .b(x030), .O(new_n438_));
  nand2  g277(.a(new_n438_), .b(new_n252_), .O(new_n439_));
  nand2  g278(.a(new_n439_), .b(new_n284_), .O(new_n440_));
  aoi21  g279(.a(new_n440_), .b(new_n251_), .c(new_n421_), .O(new_n441_));
  nor2   g280(.a(new_n250_), .b(x022), .O(new_n442_));
  oai21  g281(.a(new_n442_), .b(new_n288_), .c(x070), .O(new_n443_));
  inv1   g282(.a(new_n420_), .O(new_n444_));
  nand4  g283(.a(new_n444_), .b(new_n418_), .c(new_n254_), .d(x030), .O(new_n445_));
  aoi21  g284(.a(new_n445_), .b(new_n443_), .c(x078), .O(new_n446_));
  oai21  g285(.a(new_n446_), .b(new_n441_), .c(new_n249_), .O(new_n447_));
  nand2  g286(.a(new_n418_), .b(x030), .O(new_n448_));
  nand2  g287(.a(new_n448_), .b(new_n280_), .O(new_n449_));
  nand3  g288(.a(new_n449_), .b(new_n284_), .c(x038), .O(new_n450_));
  nand2  g289(.a(new_n450_), .b(new_n447_), .O(new_n451_));
  oai22  g290(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n452_));
  nand3  g291(.a(new_n452_), .b(x070), .c(x022), .O(new_n453_));
  aoi22  g292(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n454_));
  nand2  g293(.a(new_n454_), .b(new_n453_), .O(new_n455_));
  aoi21  g294(.a(new_n451_), .b(new_n276_), .c(new_n455_), .O(new_n456_));
  aoi21  g295(.a(new_n456_), .b(new_n437_), .c(x046), .O(z14));
  zero   g296(.O(z01));
  zero   g297(.O(z02));
  zero   g298(.O(z04));
  zero   g299(.O(z07));
