...
module FAU ( 
  ...
  and2   g211(.a(new_n372_), .b(new_n187_), .O(z11));
  oai22  g212(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n374_));
  nand3  g213(.a(new_n374_), .b(x084), .c(x004), .O(new_n375_));
  oai22  g214(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n376_));
  nand3  g215(.a(new_n376_), .b(x068), .c(x020), .O(new_n377_));
  aoi22  g216(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n378_));
  nand3  g217(.a(new_n378_), .b(new_n377_), .c(new_n375_), .O(new_n379_));
  inv1   g218(.a(new_n379_), .O(new_n380_));
  nor2   g219(.a(new_n380_), .b(x044), .O(z12));
