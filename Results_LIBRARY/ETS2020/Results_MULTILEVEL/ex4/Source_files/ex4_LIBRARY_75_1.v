// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:47 2020
...
module FAU ( 
  ...
  nor2   g167(.a(new_n327_), .b(x042), .O(z10));
  oai22  g168(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n329_));
  nand3  g169(.a(new_n329_), .b(x083), .c(x003), .O(new_n330_));
  oai22  g170(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n331_));
  nand3  g171(.a(new_n331_), .b(x067), .c(x019), .O(new_n332_));
  aoi22  g172(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n333_));
  nand3  g173(.a(new_n333_), .b(new_n332_), .c(new_n330_), .O(new_n334_));
  and2   g174(.a(new_n334_), .b(new_n187_), .O(z11));
