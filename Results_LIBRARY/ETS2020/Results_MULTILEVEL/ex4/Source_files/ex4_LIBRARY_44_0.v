// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:12 2020
...
module FAU ( 
  ...
  and2   g219(.a(new_n379_), .b(new_n187_), .O(z11));
  inv1   g220(.a(x077), .O(new_n382_));
  nand2  g221(.a(x021), .b(x013), .O(new_n383_));
  oai21  g222(.a(new_n243_), .b(x029), .c(new_n383_), .O(new_n384_));
  nor2   g223(.a(x125), .b(x101), .O(new_n385_));
  nor2   g224(.a(x117), .b(x109), .O(new_n386_));
  oai21  g225(.a(new_n385_), .b(x093), .c(new_n386_), .O(new_n387_));
  nand2  g226(.a(new_n387_), .b(new_n233_), .O(new_n388_));
  oai21  g227(.a(new_n221_), .b(x109), .c(x037), .O(new_n389_));
  nand2  g228(.a(new_n389_), .b(x117), .O(new_n390_));
  inv1   g229(.a(x101), .O(new_n391_));
  oai21  g230(.a(new_n391_), .b(x061), .c(new_n216_), .O(new_n392_));
  nand3  g231(.a(x125), .b(new_n214_), .c(new_n206_), .O(new_n393_));
  nand2  g232(.a(new_n393_), .b(new_n229_), .O(new_n394_));
  aoi21  g233(.a(new_n392_), .b(new_n215_), .c(new_n394_), .O(new_n395_));
  nand4  g234(.a(new_n395_), .b(new_n390_), .c(new_n388_), .d(new_n384_), .O(new_n396_));
  nand4  g235(.a(x125), .b(new_n219_), .c(new_n215_), .d(x013), .O(new_n397_));
  inv1   g236(.a(new_n397_), .O(new_n398_));
  aoi21  g237(.a(new_n396_), .b(new_n382_), .c(new_n398_), .O(new_n399_));
  nand3  g238(.a(x085), .b(new_n215_), .c(new_n205_), .O(new_n400_));
  oai21  g239(.a(new_n399_), .b(x053), .c(new_n400_), .O(new_n401_));
  nand2  g240(.a(new_n401_), .b(x005), .O(new_n402_));
  nand2  g241(.a(new_n208_), .b(x029), .O(new_n403_));
  nand2  g242(.a(new_n403_), .b(new_n206_), .O(new_n404_));
  nand2  g243(.a(new_n404_), .b(new_n382_), .O(new_n405_));
  aoi21  g244(.a(new_n405_), .b(new_n205_), .c(new_n386_), .O(new_n406_));
  nor2   g245(.a(new_n204_), .b(x021), .O(new_n407_));
  oai21  g246(.a(new_n407_), .b(new_n243_), .c(x069), .O(new_n408_));
  inv1   g247(.a(new_n385_), .O(new_n409_));
  nand4  g248(.a(new_n409_), .b(new_n383_), .c(new_n208_), .d(x029), .O(new_n410_));
  aoi21  g249(.a(new_n410_), .b(new_n408_), .c(x077), .O(new_n411_));
  oai21  g250(.a(new_n411_), .b(new_n406_), .c(new_n203_), .O(new_n412_));
  nand2  g251(.a(new_n383_), .b(x029), .O(new_n413_));
  nand2  g252(.a(new_n413_), .b(new_n239_), .O(new_n414_));
  nand3  g253(.a(new_n414_), .b(new_n382_), .c(x037), .O(new_n415_));
  nand2  g254(.a(new_n415_), .b(new_n412_), .O(new_n416_));
  oai22  g255(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n417_));
  nand3  g256(.a(new_n417_), .b(x069), .c(x021), .O(new_n418_));
  aoi22  g257(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n419_));
  nand2  g258(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  aoi21  g259(.a(new_n416_), .b(new_n229_), .c(new_n420_), .O(new_n421_));
  aoi21  g260(.a(new_n421_), .b(new_n402_), .c(x045), .O(z13));
  nand2  g261(.a(x022), .b(x014), .O(new_n423_));
  oai21  g262(.a(new_n300_), .b(x030), .c(new_n423_), .O(new_n424_));
  nor2   g263(.a(x126), .b(x102), .O(new_n425_));
  nor2   g264(.a(x118), .b(x110), .O(new_n426_));
  oai21  g265(.a(new_n425_), .b(x094), .c(new_n426_), .O(new_n427_));
  nand2  g266(.a(new_n427_), .b(new_n297_), .O(new_n428_));
  oai21  g267(.a(new_n280_), .b(x110), .c(x038), .O(new_n429_));
  nand2  g268(.a(new_n429_), .b(x118), .O(new_n430_));
  inv1   g269(.a(x102), .O(new_n431_));
  oai21  g270(.a(new_n431_), .b(x062), .c(new_n270_), .O(new_n432_));
  nand3  g271(.a(x126), .b(new_n271_), .c(new_n264_), .O(new_n433_));
  nand2  g272(.a(new_n433_), .b(new_n288_), .O(new_n434_));
  aoi21  g273(.a(new_n432_), .b(new_n275_), .c(new_n434_), .O(new_n435_));
  nand4  g274(.a(new_n435_), .b(new_n430_), .c(new_n428_), .d(new_n424_), .O(new_n436_));
  nand4  g275(.a(x126), .b(new_n278_), .c(new_n275_), .d(x014), .O(new_n437_));
  inv1   g276(.a(new_n437_), .O(new_n438_));
  aoi21  g277(.a(new_n436_), .b(new_n296_), .c(new_n438_), .O(new_n439_));
  nand3  g278(.a(x086), .b(new_n275_), .c(new_n263_), .O(new_n440_));
  oai21  g279(.a(new_n439_), .b(x054), .c(new_n440_), .O(new_n441_));
  nand2  g280(.a(new_n441_), .b(x006), .O(new_n442_));
  nand2  g281(.a(new_n266_), .b(x030), .O(new_n443_));
  nand2  g282(.a(new_n443_), .b(new_n264_), .O(new_n444_));
  nand2  g283(.a(new_n444_), .b(new_n296_), .O(new_n445_));
  aoi21  g284(.a(new_n445_), .b(new_n263_), .c(new_n426_), .O(new_n446_));
  nor2   g285(.a(new_n262_), .b(x022), .O(new_n447_));
  oai21  g286(.a(new_n447_), .b(new_n300_), .c(x070), .O(new_n448_));
  inv1   g287(.a(new_n425_), .O(new_n449_));
  nand4  g288(.a(new_n449_), .b(new_n423_), .c(new_n266_), .d(x030), .O(new_n450_));
  aoi21  g289(.a(new_n450_), .b(new_n448_), .c(x078), .O(new_n451_));
  oai21  g290(.a(new_n451_), .b(new_n446_), .c(new_n261_), .O(new_n452_));
  nand2  g291(.a(new_n423_), .b(x030), .O(new_n453_));
  nand2  g292(.a(new_n453_), .b(new_n292_), .O(new_n454_));
  nand3  g293(.a(new_n454_), .b(new_n296_), .c(x038), .O(new_n455_));
  ...
  aoi22  g297(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n459_));
  nand2  g298(.a(new_n459_), .b(new_n458_), .O(new_n460_));
  aoi21  g299(.a(new_n456_), .b(new_n288_), .c(new_n460_), .O(new_n461_));
  aoi21  g300(.a(new_n461_), .b(new_n442_), .c(x046), .O(z14));
  zero   g301(.O(z02));
  zero   g302(.O(z04));
  zero   g303(.O(z07));
  zero   g304(.O(z09));
