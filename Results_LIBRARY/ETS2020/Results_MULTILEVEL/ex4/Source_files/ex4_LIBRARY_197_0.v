// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:08 2020
...
module FAU ( 
  ...
  oai22  g160(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n321_));
  nand3  g161(.a(new_n321_), .b(x082), .c(x002), .O(new_n322_));
  oai22  g162(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n323_));
  nand3  g163(.a(new_n323_), .b(x066), .c(x018), .O(new_n324_));
  aoi22  g164(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n325_));
  nand3  g165(.a(new_n325_), .b(new_n324_), .c(new_n322_), .O(new_n326_));
  and2   g166(.a(new_n326_), .b(new_n186_), .O(z10));
  ...
  and2   g173(.a(new_n333_), .b(new_n199_), .O(z11));
  ...
  inv1   g180(.a(new_n340_), .O(new_n341_));
  nor2   g181(.a(new_n341_), .b(x044), .O(z12));
  inv1   g182(.a(x077), .O(new_n343_));
  nand2  g183(.a(x021), .b(x013), .O(new_n344_));
  inv1   g184(.a(x061), .O(new_n345_));
  inv1   g185(.a(x093), .O(new_n346_));
  nand2  g186(.a(new_n346_), .b(new_n345_), .O(new_n347_));
  oai21  g187(.a(new_n347_), .b(x029), .c(new_n344_), .O(new_n348_));
  inv1   g188(.a(x069), .O(new_n349_));
  ...
  nand2  g192(.a(new_n352_), .b(new_n349_), .O(new_n353_));
  inv1   g193(.a(x125), .O(new_n354_));
  oai21  g194(.a(new_n354_), .b(x109), .c(x037), .O(new_n355_));
  nand2  g195(.a(new_n355_), .b(x117), .O(new_n356_));
  inv1   g196(.a(x037), .O(new_n357_));
  inv1   g197(.a(x101), .O(new_n358_));
  inv1   g198(.a(x109), .O(new_n359_));
  oai21  g199(.a(new_n358_), .b(x061), .c(new_n359_), .O(new_n360_));
  inv1   g200(.a(x085), .O(new_n361_));
  inv1   g201(.a(x021), .O(new_n362_));
  inv1   g202(.a(x117), .O(new_n363_));
  nand3  g203(.a(x125), .b(new_n363_), .c(new_n362_), .O(new_n364_));
  nand2  g204(.a(new_n364_), .b(new_n361_), .O(new_n365_));
  aoi21  g205(.a(new_n360_), .b(new_n357_), .c(new_n365_), .O(new_n366_));
  nand4  g206(.a(new_n366_), .b(new_n356_), .c(new_n353_), .d(new_n348_), .O(new_n367_));
  nand4  g207(.a(x125), .b(new_n345_), .c(new_n357_), .d(x013), .O(new_n368_));
  inv1   g208(.a(new_n368_), .O(new_n369_));
  aoi21  g209(.a(new_n367_), .b(new_n343_), .c(new_n369_), .O(new_n370_));
  inv1   g210(.a(x013), .O(new_n371_));
  nand3  g211(.a(x085), .b(new_n357_), .c(new_n371_), .O(new_n372_));
  oai21  g212(.a(new_n370_), .b(x053), .c(new_n372_), .O(new_n373_));
  nand2  g213(.a(new_n373_), .b(x005), .O(new_n374_));
  nand2  g214(.a(x093), .b(x061), .O(new_n375_));
  nand2  g215(.a(new_n375_), .b(x029), .O(new_n376_));
  nand2  g216(.a(new_n376_), .b(new_n362_), .O(new_n377_));
  nand2  g217(.a(new_n377_), .b(new_n343_), .O(new_n378_));
  aoi21  g218(.a(new_n378_), .b(new_n371_), .c(new_n351_), .O(new_n379_));
  inv1   g219(.a(x029), .O(new_n380_));
  nor2   g220(.a(new_n380_), .b(x021), .O(new_n381_));
  oai21  g221(.a(new_n381_), .b(new_n347_), .c(x069), .O(new_n382_));
  inv1   g222(.a(new_n350_), .O(new_n383_));
  nand4  g223(.a(new_n375_), .b(new_n383_), .c(new_n344_), .d(x029), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n382_), .c(x077), .O(new_n385_));
  nor2   g225(.a(new_n385_), .b(new_n379_), .O(new_n386_));
  nand2  g226(.a(new_n344_), .b(x029), .O(new_n387_));
  nand3  g227(.a(new_n387_), .b(new_n346_), .c(new_n345_), .O(new_n388_));
  nand3  g228(.a(new_n388_), .b(new_n343_), .c(x037), .O(new_n389_));
  oai21  g229(.a(new_n386_), .b(x053), .c(new_n389_), .O(new_n390_));
  oai22  g230(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n391_));
  nand3  g231(.a(new_n391_), .b(x069), .c(x021), .O(new_n392_));
  aoi22  g232(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n393_));
  nand2  g233(.a(new_n393_), .b(new_n392_), .O(new_n394_));
  aoi21  g234(.a(new_n390_), .b(new_n361_), .c(new_n394_), .O(new_n395_));
  aoi21  g235(.a(new_n395_), .b(new_n374_), .c(x045), .O(z13));
  nand2  g236(.a(x022), .b(x014), .O(new_n397_));
  oai21  g237(.a(new_n255_), .b(x030), .c(new_n397_), .O(new_n398_));
  nor2   g238(.a(x126), .b(x102), .O(new_n399_));
  nor2   g239(.a(x118), .b(x110), .O(new_n400_));
  oai21  g240(.a(new_n399_), .b(x094), .c(new_n400_), .O(new_n401_));
  nand2  g241(.a(new_n401_), .b(new_n252_), .O(new_n402_));
  oai21  g242(.a(new_n235_), .b(x110), .c(x038), .O(new_n403_));
  nand2  g243(.a(new_n403_), .b(x118), .O(new_n404_));
  inv1   g244(.a(x102), .O(new_n405_));
  oai21  g245(.a(new_n405_), .b(x062), .c(new_n225_), .O(new_n406_));
  nand3  g246(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n407_));
  nand2  g247(.a(new_n407_), .b(new_n243_), .O(new_n408_));
  aoi21  g248(.a(new_n406_), .b(new_n230_), .c(new_n408_), .O(new_n409_));
  nand4  g249(.a(new_n409_), .b(new_n404_), .c(new_n402_), .d(new_n398_), .O(new_n410_));
  nand4  g250(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n411_));
  inv1   g251(.a(new_n411_), .O(new_n412_));
  aoi21  g252(.a(new_n410_), .b(new_n251_), .c(new_n412_), .O(new_n413_));
  nand3  g253(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n414_));
  oai21  g254(.a(new_n413_), .b(x054), .c(new_n414_), .O(new_n415_));
  nand2  g255(.a(new_n415_), .b(x006), .O(new_n416_));
  nand2  g256(.a(new_n221_), .b(x030), .O(new_n417_));
  nand2  g257(.a(new_n417_), .b(new_n219_), .O(new_n418_));
  nand2  g258(.a(new_n418_), .b(new_n251_), .O(new_n419_));
  aoi21  g259(.a(new_n419_), .b(new_n218_), .c(new_n400_), .O(new_n420_));
  nor2   g260(.a(new_n217_), .b(x022), .O(new_n421_));
  oai21  g261(.a(new_n421_), .b(new_n255_), .c(x070), .O(new_n422_));
  inv1   g262(.a(new_n399_), .O(new_n423_));
  nand4  g263(.a(new_n423_), .b(new_n397_), .c(new_n221_), .d(x030), .O(new_n424_));
  aoi21  g264(.a(new_n424_), .b(new_n422_), .c(x078), .O(new_n425_));
  oai21  g265(.a(new_n425_), .b(new_n420_), .c(new_n216_), .O(new_n426_));
  nand2  g266(.a(new_n397_), .b(x030), .O(new_n427_));
  nand2  g267(.a(new_n427_), .b(new_n247_), .O(new_n428_));
  nand3  g268(.a(new_n428_), .b(new_n251_), .c(x038), .O(new_n429_));
  nand2  g269(.a(new_n429_), .b(new_n426_), .O(new_n430_));
  oai22  g270(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n431_));
  nand3  g271(.a(new_n431_), .b(x070), .c(x022), .O(new_n432_));
  aoi22  g272(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n433_));
  nand2  g273(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  aoi21  g274(.a(new_n430_), .b(new_n243_), .c(new_n434_), .O(new_n435_));
  aoi21  g275(.a(new_n435_), .b(new_n416_), .c(x046), .O(z14));
  zero   g276(.O(z04));
  zero   g277(.O(z05));
  zero   g278(.O(z07));
  zero   g279(.O(z09));
