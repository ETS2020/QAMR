// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:54 2020
...
module FAU ( 
  ...
  inv1   g104(.a(x077), .O(new_n269_));
  nand2  g105(.a(x021), .b(x013), .O(new_n270_));
  oai21  g106(.a(new_n240_), .b(x029), .c(new_n270_), .O(new_n271_));
  nor2   g107(.a(x125), .b(x101), .O(new_n272_));
  nor2   g108(.a(x117), .b(x109), .O(new_n273_));
  oai21  g109(.a(new_n272_), .b(x093), .c(new_n273_), .O(new_n274_));
  nand2  g110(.a(new_n274_), .b(new_n230_), .O(new_n275_));
  oai21  g111(.a(new_n218_), .b(x109), .c(x037), .O(new_n276_));
  nand2  g112(.a(new_n276_), .b(x117), .O(new_n277_));
  inv1   g113(.a(x101), .O(new_n278_));
  oai21  g114(.a(new_n278_), .b(x061), .c(new_n213_), .O(new_n279_));
  nand3  g115(.a(x125), .b(new_n211_), .c(new_n203_), .O(new_n280_));
  nand2  g116(.a(new_n280_), .b(new_n226_), .O(new_n281_));
  aoi21  g117(.a(new_n279_), .b(new_n212_), .c(new_n281_), .O(new_n282_));
  nand4  g118(.a(new_n282_), .b(new_n277_), .c(new_n275_), .d(new_n271_), .O(new_n283_));
  nand4  g119(.a(x125), .b(new_n216_), .c(new_n212_), .d(x013), .O(new_n284_));
  inv1   g120(.a(new_n284_), .O(new_n285_));
  aoi21  g121(.a(new_n283_), .b(new_n269_), .c(new_n285_), .O(new_n286_));
  nand3  g122(.a(x085), .b(new_n212_), .c(new_n202_), .O(new_n287_));
  oai21  g123(.a(new_n286_), .b(x053), .c(new_n287_), .O(new_n288_));
  nand2  g124(.a(new_n288_), .b(x005), .O(new_n289_));
  nand2  g125(.a(new_n205_), .b(x029), .O(new_n290_));
  nand2  g126(.a(new_n290_), .b(new_n203_), .O(new_n291_));
  nand2  g127(.a(new_n291_), .b(new_n269_), .O(new_n292_));
  aoi21  g128(.a(new_n292_), .b(new_n202_), .c(new_n273_), .O(new_n293_));
  nor2   g129(.a(new_n201_), .b(x021), .O(new_n294_));
  oai21  g130(.a(new_n294_), .b(new_n240_), .c(x069), .O(new_n295_));
  inv1   g131(.a(new_n272_), .O(new_n296_));
  nand4  g132(.a(new_n296_), .b(new_n270_), .c(new_n205_), .d(x029), .O(new_n297_));
  aoi21  g133(.a(new_n297_), .b(new_n295_), .c(x077), .O(new_n298_));
  oai21  g134(.a(new_n298_), .b(new_n293_), .c(new_n200_), .O(new_n299_));
  nand2  g135(.a(new_n270_), .b(x029), .O(new_n300_));
  nand2  g136(.a(new_n300_), .b(new_n236_), .O(new_n301_));
  nand3  g137(.a(new_n301_), .b(new_n269_), .c(x037), .O(new_n302_));
  nand2  g138(.a(new_n302_), .b(new_n299_), .O(new_n303_));
  oai22  g139(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n304_));
  nand3  g140(.a(new_n304_), .b(x069), .c(x021), .O(new_n305_));
  aoi22  g141(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n306_));
  nand2  g142(.a(new_n306_), .b(new_n305_), .O(new_n307_));
  aoi21  g143(.a(new_n303_), .b(new_n226_), .c(new_n307_), .O(new_n308_));
  aoi21  g144(.a(new_n308_), .b(new_n289_), .c(x045), .O(z13));
  zero   g145(.O(z00));
  zero   g146(.O(z04));
  zero   g147(.O(z06));
  zero   g148(.O(z07));
