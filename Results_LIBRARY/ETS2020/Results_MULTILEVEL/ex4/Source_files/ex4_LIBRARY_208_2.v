...
module FAU ( 
  ...
  inv1   g165(.a(x078), .O(new_n328_));
  nand2  g166(.a(x022), .b(x014), .O(new_n329_));
  inv1   g167(.a(x062), .O(new_n330_));
  inv1   g168(.a(x094), .O(new_n331_));
  nand2  g169(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  oai21  g170(.a(new_n332_), .b(x030), .c(new_n329_), .O(new_n333_));
  inv1   g171(.a(x070), .O(new_n334_));
  ...
  nand2  g175(.a(new_n337_), .b(new_n334_), .O(new_n338_));
  inv1   g176(.a(x126), .O(new_n339_));
  oai21  g177(.a(new_n339_), .b(x110), .c(x038), .O(new_n340_));
  nand2  g178(.a(new_n340_), .b(x118), .O(new_n341_));
  inv1   g179(.a(x038), .O(new_n342_));
  inv1   g180(.a(x102), .O(new_n343_));
  inv1   g181(.a(x110), .O(new_n344_));
  oai21  g182(.a(new_n343_), .b(x062), .c(new_n344_), .O(new_n345_));
  inv1   g183(.a(x086), .O(new_n346_));
  inv1   g184(.a(x022), .O(new_n347_));
  inv1   g185(.a(x118), .O(new_n348_));
  nand3  g186(.a(x126), .b(new_n348_), .c(new_n347_), .O(new_n349_));
  nand2  g187(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  aoi21  g188(.a(new_n345_), .b(new_n342_), .c(new_n350_), .O(new_n351_));
  nand4  g189(.a(new_n351_), .b(new_n341_), .c(new_n338_), .d(new_n333_), .O(new_n352_));
  nand4  g190(.a(x126), .b(new_n330_), .c(new_n342_), .d(x014), .O(new_n353_));
  inv1   g191(.a(new_n353_), .O(new_n354_));
  aoi21  g192(.a(new_n352_), .b(new_n328_), .c(new_n354_), .O(new_n355_));
  inv1   g193(.a(x014), .O(new_n356_));
  nand3  g194(.a(x086), .b(new_n342_), .c(new_n356_), .O(new_n357_));
  oai21  g195(.a(new_n355_), .b(x054), .c(new_n357_), .O(new_n358_));
  nand2  g196(.a(new_n358_), .b(x006), .O(new_n359_));
  nand2  g197(.a(x094), .b(x062), .O(new_n360_));
  nand2  g198(.a(new_n360_), .b(x030), .O(new_n361_));
  nand2  g199(.a(new_n361_), .b(new_n347_), .O(new_n362_));
  nand2  g200(.a(new_n362_), .b(new_n328_), .O(new_n363_));
  aoi21  g201(.a(new_n363_), .b(new_n356_), .c(new_n336_), .O(new_n364_));
  inv1   g202(.a(x030), .O(new_n365_));
  nor2   g203(.a(new_n365_), .b(x022), .O(new_n366_));
  oai21  g204(.a(new_n366_), .b(new_n332_), .c(x070), .O(new_n367_));
  inv1   g205(.a(new_n335_), .O(new_n368_));
  nand4  g206(.a(new_n360_), .b(new_n368_), .c(new_n329_), .d(x030), .O(new_n369_));
  aoi21  g207(.a(new_n369_), .b(new_n367_), .c(x078), .O(new_n370_));
  nor2   g208(.a(new_n370_), .b(new_n364_), .O(new_n371_));
  nand2  g209(.a(new_n329_), .b(x030), .O(new_n372_));
  nand3  g210(.a(new_n372_), .b(new_n331_), .c(new_n330_), .O(new_n373_));
  nand3  g211(.a(new_n373_), .b(new_n328_), .c(x038), .O(new_n374_));
  oai21  g212(.a(new_n371_), .b(x054), .c(new_n374_), .O(new_n375_));
  ...
  aoi21  g217(.a(new_n375_), .b(new_n346_), .c(new_n379_), .O(new_n380_));
