...
module FAU ( 
  ...
  and2   g116(.a(new_n277_), .b(new_n183_), .O(z10));
  ...
  and2   g123(.a(new_n284_), .b(new_n196_), .O(z11));
  ...
  nor2   g131(.a(new_n292_), .b(x044), .O(z12));
  inv1   g132(.a(x077), .O(new_n294_));
  nand2  g133(.a(x021), .b(x013), .O(new_n295_));
  oai21  g134(.a(new_n252_), .b(x029), .c(new_n295_), .O(new_n296_));
  nor2   g135(.a(x125), .b(x101), .O(new_n297_));
  nor2   g136(.a(x117), .b(x109), .O(new_n298_));
  oai21  g137(.a(new_n297_), .b(x093), .c(new_n298_), .O(new_n299_));
  nand2  g138(.a(new_n299_), .b(new_n242_), .O(new_n300_));
  oai21  g139(.a(new_n230_), .b(x109), .c(x037), .O(new_n301_));
  nand2  g140(.a(new_n301_), .b(x117), .O(new_n302_));
  inv1   g141(.a(x101), .O(new_n303_));
  oai21  g142(.a(new_n303_), .b(x061), .c(new_n225_), .O(new_n304_));
  nand3  g143(.a(x125), .b(new_n223_), .c(new_n215_), .O(new_n305_));
  nand2  g144(.a(new_n305_), .b(new_n238_), .O(new_n306_));
  aoi21  g145(.a(new_n304_), .b(new_n224_), .c(new_n306_), .O(new_n307_));
  nand4  g146(.a(new_n307_), .b(new_n302_), .c(new_n300_), .d(new_n296_), .O(new_n308_));
  nand4  g147(.a(x125), .b(new_n228_), .c(new_n224_), .d(x013), .O(new_n309_));
  inv1   g148(.a(new_n309_), .O(new_n310_));
  aoi21  g149(.a(new_n308_), .b(new_n294_), .c(new_n310_), .O(new_n311_));
  nand3  g150(.a(x085), .b(new_n224_), .c(new_n214_), .O(new_n312_));
  oai21  g151(.a(new_n311_), .b(x053), .c(new_n312_), .O(new_n313_));
  nand2  g152(.a(new_n313_), .b(x005), .O(new_n314_));
  nand2  g153(.a(new_n217_), .b(x029), .O(new_n315_));
  nand2  g154(.a(new_n315_), .b(new_n215_), .O(new_n316_));
  nand2  g155(.a(new_n316_), .b(new_n294_), .O(new_n317_));
  aoi21  g156(.a(new_n317_), .b(new_n214_), .c(new_n298_), .O(new_n318_));
  nor2   g157(.a(new_n213_), .b(x021), .O(new_n319_));
  oai21  g158(.a(new_n319_), .b(new_n252_), .c(x069), .O(new_n320_));
  inv1   g159(.a(new_n297_), .O(new_n321_));
  nand4  g160(.a(new_n321_), .b(new_n295_), .c(new_n217_), .d(x029), .O(new_n322_));
  aoi21  g161(.a(new_n322_), .b(new_n320_), .c(x077), .O(new_n323_));
  oai21  g162(.a(new_n323_), .b(new_n318_), .c(new_n212_), .O(new_n324_));
  nand2  g163(.a(new_n295_), .b(x029), .O(new_n325_));
  nand2  g164(.a(new_n325_), .b(new_n248_), .O(new_n326_));
  nand3  g165(.a(new_n326_), .b(new_n294_), .c(x037), .O(new_n327_));
  nand2  g166(.a(new_n327_), .b(new_n324_), .O(new_n328_));
  oai22  g167(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n329_));
  nand3  g168(.a(new_n329_), .b(x069), .c(x021), .O(new_n330_));
  aoi22  g169(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n331_));
  nand2  g170(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  aoi21  g171(.a(new_n328_), .b(new_n238_), .c(new_n332_), .O(new_n333_));
  aoi21  g172(.a(new_n333_), .b(new_n314_), .c(x045), .O(z13));
  zero   g173(.O(z04));
  zero   g174(.O(z06));
  zero   g175(.O(z07));
  zero   g176(.O(z08));
