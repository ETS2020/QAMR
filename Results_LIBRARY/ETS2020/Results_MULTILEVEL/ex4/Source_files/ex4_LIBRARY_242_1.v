// Benchmark "FAU" written by ABC on Sat Jul 25 09:10:00 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n182_, new_n183_, new_n184_, new_n190_, new_n191_, new_n192_,
  ...
  and2   g140(.a(new_n301_), .b(new_n173_), .O(z09));
  oai22  g141(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n303_));
  nand3  g142(.a(new_n303_), .b(x082), .c(x002), .O(new_n304_));
  oai22  g143(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n305_));
  nand3  g144(.a(new_n305_), .b(x066), .c(x018), .O(new_n306_));
  aoi22  g145(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n307_));
  nand3  g146(.a(new_n307_), .b(new_n306_), .c(new_n304_), .O(new_n308_));
  inv1   g147(.a(new_n308_), .O(new_n309_));
  nor2   g148(.a(new_n309_), .b(x042), .O(z10));
