// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:50 2020
...
module FAU ( 
  ...
  oai22  g149(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n311_));
  nand3  g150(.a(new_n311_), .b(x083), .c(x003), .O(new_n312_));
  oai22  g151(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n313_));
  nand3  g152(.a(new_n313_), .b(x067), .c(x019), .O(new_n314_));
  aoi22  g153(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n315_));
  nand3  g154(.a(new_n315_), .b(new_n314_), .c(new_n312_), .O(new_n316_));
  inv1   g155(.a(new_n316_), .O(new_n317_));
  nor2   g156(.a(new_n317_), .b(x043), .O(z11));
  oai22  g157(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n319_));
  nand3  g158(.a(new_n319_), .b(x084), .c(x004), .O(new_n320_));
  oai22  g159(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n321_));
  nand3  g160(.a(new_n321_), .b(x068), .c(x020), .O(new_n322_));
  aoi22  g161(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n323_));
  nand3  g162(.a(new_n323_), .b(new_n322_), .c(new_n320_), .O(new_n324_));
  inv1   g163(.a(new_n324_), .O(new_n325_));
  nor2   g164(.a(new_n325_), .b(x044), .O(z12));
  nand2  g165(.a(x022), .b(x014), .O(new_n328_));
  oai21  g166(.a(new_n231_), .b(x030), .c(new_n328_), .O(new_n329_));
  ...
  nand2  g170(.a(new_n332_), .b(new_n228_), .O(new_n333_));
  oai21  g171(.a(new_n211_), .b(x110), .c(x038), .O(new_n334_));
  nand2  g172(.a(new_n334_), .b(x118), .O(new_n335_));
  inv1   g173(.a(x102), .O(new_n336_));
  oai21  g174(.a(new_n336_), .b(x062), .c(new_n201_), .O(new_n337_));
  nand3  g175(.a(x126), .b(new_n202_), .c(new_n195_), .O(new_n338_));
  nand2  g176(.a(new_n338_), .b(new_n219_), .O(new_n339_));
  aoi21  g177(.a(new_n337_), .b(new_n206_), .c(new_n339_), .O(new_n340_));
  nand4  g178(.a(new_n340_), .b(new_n335_), .c(new_n333_), .d(new_n329_), .O(new_n341_));
  nand4  g179(.a(x126), .b(new_n209_), .c(new_n206_), .d(x014), .O(new_n342_));
  inv1   g180(.a(new_n342_), .O(new_n343_));
  aoi21  g181(.a(new_n341_), .b(new_n227_), .c(new_n343_), .O(new_n344_));
  nand3  g182(.a(x086), .b(new_n206_), .c(new_n194_), .O(new_n345_));
  oai21  g183(.a(new_n344_), .b(x054), .c(new_n345_), .O(new_n346_));
  nand2  g184(.a(new_n346_), .b(x006), .O(new_n347_));
  nand2  g185(.a(new_n197_), .b(x030), .O(new_n348_));
  nand2  g186(.a(new_n348_), .b(new_n195_), .O(new_n349_));
  nand2  g187(.a(new_n349_), .b(new_n227_), .O(new_n350_));
  aoi21  g188(.a(new_n350_), .b(new_n194_), .c(new_n331_), .O(new_n351_));
  nor2   g189(.a(new_n193_), .b(x022), .O(new_n352_));
  oai21  g190(.a(new_n352_), .b(new_n231_), .c(x070), .O(new_n353_));
  inv1   g191(.a(new_n330_), .O(new_n354_));
  nand4  g192(.a(new_n354_), .b(new_n328_), .c(new_n197_), .d(x030), .O(new_n355_));
  aoi21  g193(.a(new_n355_), .b(new_n353_), .c(x078), .O(new_n356_));
  oai21  g194(.a(new_n356_), .b(new_n351_), .c(new_n192_), .O(new_n357_));
  nand2  g195(.a(new_n328_), .b(x030), .O(new_n358_));
  nand2  g196(.a(new_n358_), .b(new_n223_), .O(new_n359_));
  nand3  g197(.a(new_n359_), .b(new_n227_), .c(x038), .O(new_n360_));
  nand2  g198(.a(new_n360_), .b(new_n357_), .O(new_n361_));
  oai22  g199(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n362_));
  nand3  g200(.a(new_n362_), .b(x070), .c(x022), .O(new_n363_));
  aoi22  g201(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n364_));
  nand2  g202(.a(new_n364_), .b(new_n363_), .O(new_n365_));
  aoi21  g203(.a(new_n361_), .b(new_n219_), .c(new_n365_), .O(new_n366_));
  aoi21  g204(.a(new_n366_), .b(new_n347_), .c(x046), .O(z14));
  zero   g205(.O(z01));
  zero   g206(.O(z03));
  zero   g207(.O(z04));
  zero   g208(.O(z05));
