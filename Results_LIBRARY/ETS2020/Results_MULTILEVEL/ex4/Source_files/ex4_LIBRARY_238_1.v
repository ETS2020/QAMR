// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:56 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n195_, new_n196_, new_n197_, new_n202_, new_n203_, new_n204_,
  ...
  and2   g153(.a(new_n313_), .b(new_n173_), .O(z09));
  ...
  and2   g160(.a(new_n320_), .b(new_n186_), .O(z10));
  oai22  g161(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n322_));
  nand3  g162(.a(new_n322_), .b(x083), .c(x003), .O(new_n323_));
  oai22  g163(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n324_));
  nand3  g164(.a(new_n324_), .b(x067), .c(x019), .O(new_n325_));
  aoi22  g165(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n326_));
  nand3  g166(.a(new_n326_), .b(new_n325_), .c(new_n323_), .O(new_n327_));
  inv1   g167(.a(new_n327_), .O(new_n328_));
  nor2   g168(.a(new_n328_), .b(x043), .O(z11));
  oai22  g169(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n330_));
  nand3  g170(.a(new_n330_), .b(x084), .c(x004), .O(new_n331_));
  oai22  g171(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n332_));
  nand3  g172(.a(new_n332_), .b(x068), .c(x020), .O(new_n333_));
  aoi22  g173(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n334_));
  nand3  g174(.a(new_n334_), .b(new_n333_), .c(new_n331_), .O(new_n335_));
  inv1   g175(.a(new_n335_), .O(new_n336_));
  nor2   g176(.a(new_n336_), .b(x044), .O(z12));
  nand2  g177(.a(x022), .b(x014), .O(new_n339_));
  oai21  g178(.a(new_n243_), .b(x030), .c(new_n339_), .O(new_n340_));
  ...
  nand2  g182(.a(new_n343_), .b(new_n240_), .O(new_n344_));
  oai21  g183(.a(new_n223_), .b(x110), .c(x038), .O(new_n345_));
  nand2  g184(.a(new_n345_), .b(x118), .O(new_n346_));
  inv1   g185(.a(x102), .O(new_n347_));
  oai21  g186(.a(new_n347_), .b(x062), .c(new_n213_), .O(new_n348_));
  nand3  g187(.a(x126), .b(new_n214_), .c(new_n207_), .O(new_n349_));
  nand2  g188(.a(new_n349_), .b(new_n231_), .O(new_n350_));
  aoi21  g189(.a(new_n348_), .b(new_n218_), .c(new_n350_), .O(new_n351_));
  nand4  g190(.a(new_n351_), .b(new_n346_), .c(new_n344_), .d(new_n340_), .O(new_n352_));
  nand4  g191(.a(x126), .b(new_n221_), .c(new_n218_), .d(x014), .O(new_n353_));
  inv1   g192(.a(new_n353_), .O(new_n354_));
  aoi21  g193(.a(new_n352_), .b(new_n239_), .c(new_n354_), .O(new_n355_));
  nand3  g194(.a(x086), .b(new_n218_), .c(new_n206_), .O(new_n356_));
  oai21  g195(.a(new_n355_), .b(x054), .c(new_n356_), .O(new_n357_));
  nand2  g196(.a(new_n357_), .b(x006), .O(new_n358_));
  nand2  g197(.a(new_n209_), .b(x030), .O(new_n359_));
  nand2  g198(.a(new_n359_), .b(new_n207_), .O(new_n360_));
  nand2  g199(.a(new_n360_), .b(new_n239_), .O(new_n361_));
  aoi21  g200(.a(new_n361_), .b(new_n206_), .c(new_n342_), .O(new_n362_));
  nor2   g201(.a(new_n205_), .b(x022), .O(new_n363_));
  oai21  g202(.a(new_n363_), .b(new_n243_), .c(x070), .O(new_n364_));
  inv1   g203(.a(new_n341_), .O(new_n365_));
  nand4  g204(.a(new_n365_), .b(new_n339_), .c(new_n209_), .d(x030), .O(new_n366_));
  aoi21  g205(.a(new_n366_), .b(new_n364_), .c(x078), .O(new_n367_));
  oai21  g206(.a(new_n367_), .b(new_n362_), .c(new_n204_), .O(new_n368_));
  nand2  g207(.a(new_n339_), .b(x030), .O(new_n369_));
  nand2  g208(.a(new_n369_), .b(new_n235_), .O(new_n370_));
  nand3  g209(.a(new_n370_), .b(new_n239_), .c(x038), .O(new_n371_));
  nand2  g210(.a(new_n371_), .b(new_n368_), .O(new_n372_));
  oai22  g211(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n373_));
  nand3  g212(.a(new_n373_), .b(x070), .c(x022), .O(new_n374_));
  aoi22  g213(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n375_));
  nand2  g214(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  aoi21  g215(.a(new_n372_), .b(new_n231_), .c(new_n376_), .O(new_n377_));
  aoi21  g216(.a(new_n377_), .b(new_n358_), .c(x046), .O(z14));
  zero   g217(.O(z03));
  zero   g218(.O(z04));
  zero   g219(.O(z05));
  zero   g220(.O(z07));
