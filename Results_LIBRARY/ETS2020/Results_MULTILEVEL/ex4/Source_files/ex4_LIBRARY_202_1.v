...
module FAU ( 
  ...
  oai22  g147(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n310_));
  nand3  g148(.a(new_n310_), .b(x083), .c(x003), .O(new_n311_));
  oai22  g149(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n312_));
  nand3  g150(.a(new_n312_), .b(x067), .c(x019), .O(new_n313_));
  aoi22  g151(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n314_));
  nand3  g152(.a(new_n314_), .b(new_n313_), .c(new_n311_), .O(new_n315_));
  and2   g153(.a(new_n315_), .b(new_n175_), .O(z11));
  ...
  and2   g160(.a(new_n322_), .b(new_n188_), .O(z12));
  nand2  g161(.a(x022), .b(x014), .O(new_n325_));
  oai21  g162(.a(new_n243_), .b(x030), .c(new_n325_), .O(new_n326_));
  nor2   g163(.a(x126), .b(x102), .O(new_n327_));
  nor2   g164(.a(x118), .b(x110), .O(new_n328_));
  oai21  g165(.a(new_n327_), .b(x094), .c(new_n328_), .O(new_n329_));
  nand2  g166(.a(new_n329_), .b(new_n240_), .O(new_n330_));
  oai21  g167(.a(new_n223_), .b(x110), .c(x038), .O(new_n331_));
  nand2  g168(.a(new_n331_), .b(x118), .O(new_n332_));
  inv1   g169(.a(x102), .O(new_n333_));
  oai21  g170(.a(new_n333_), .b(x062), .c(new_n213_), .O(new_n334_));
  nand3  g171(.a(x126), .b(new_n214_), .c(new_n207_), .O(new_n335_));
  nand2  g172(.a(new_n335_), .b(new_n231_), .O(new_n336_));
  aoi21  g173(.a(new_n334_), .b(new_n218_), .c(new_n336_), .O(new_n337_));
  nand4  g174(.a(new_n337_), .b(new_n332_), .c(new_n330_), .d(new_n326_), .O(new_n338_));
  nand4  g175(.a(x126), .b(new_n221_), .c(new_n218_), .d(x014), .O(new_n339_));
  inv1   g176(.a(new_n339_), .O(new_n340_));
  aoi21  g177(.a(new_n338_), .b(new_n239_), .c(new_n340_), .O(new_n341_));
  nand3  g178(.a(x086), .b(new_n218_), .c(new_n206_), .O(new_n342_));
  oai21  g179(.a(new_n341_), .b(x054), .c(new_n342_), .O(new_n343_));
  nand2  g180(.a(new_n343_), .b(x006), .O(new_n344_));
  nand2  g181(.a(new_n209_), .b(x030), .O(new_n345_));
  nand2  g182(.a(new_n345_), .b(new_n207_), .O(new_n346_));
  nand2  g183(.a(new_n346_), .b(new_n239_), .O(new_n347_));
  aoi21  g184(.a(new_n347_), .b(new_n206_), .c(new_n328_), .O(new_n348_));
  nor2   g185(.a(new_n205_), .b(x022), .O(new_n349_));
  oai21  g186(.a(new_n349_), .b(new_n243_), .c(x070), .O(new_n350_));
  inv1   g187(.a(new_n327_), .O(new_n351_));
  nand4  g188(.a(new_n351_), .b(new_n325_), .c(new_n209_), .d(x030), .O(new_n352_));
  aoi21  g189(.a(new_n352_), .b(new_n350_), .c(x078), .O(new_n353_));
  oai21  g190(.a(new_n353_), .b(new_n348_), .c(new_n204_), .O(new_n354_));
  nand2  g191(.a(new_n325_), .b(x030), .O(new_n355_));
  nand2  g192(.a(new_n355_), .b(new_n235_), .O(new_n356_));
  nand3  g193(.a(new_n356_), .b(new_n239_), .c(x038), .O(new_n357_));
  nand2  g194(.a(new_n357_), .b(new_n354_), .O(new_n358_));
  oai22  g195(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n359_));
  nand3  g196(.a(new_n359_), .b(x070), .c(x022), .O(new_n360_));
  aoi22  g197(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n361_));
  nand2  g198(.a(new_n361_), .b(new_n360_), .O(new_n362_));
  aoi21  g199(.a(new_n358_), .b(new_n231_), .c(new_n362_), .O(new_n363_));
  aoi21  g200(.a(new_n363_), .b(new_n344_), .c(x046), .O(z14));
  zero   g201(.O(z01));
  zero   g202(.O(z02));
  zero   g203(.O(z05));
  zero   g204(.O(z07));
