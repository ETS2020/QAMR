...
module FAU ( 
  ...
  nor2   g157(.a(new_n319_), .b(x044), .O(z12));
  nand2  g158(.a(x022), .b(x014), .O(new_n322_));
  oai21  g159(.a(new_n231_), .b(x030), .c(new_n322_), .O(new_n323_));
  nor2   g160(.a(x126), .b(x102), .O(new_n324_));
  nor2   g161(.a(x118), .b(x110), .O(new_n325_));
  oai21  g162(.a(new_n324_), .b(x094), .c(new_n325_), .O(new_n326_));
  nand2  g163(.a(new_n326_), .b(new_n228_), .O(new_n327_));
  oai21  g164(.a(new_n211_), .b(x110), .c(x038), .O(new_n328_));
  nand2  g165(.a(new_n328_), .b(x118), .O(new_n329_));
  inv1   g166(.a(x102), .O(new_n330_));
  oai21  g167(.a(new_n330_), .b(x062), .c(new_n201_), .O(new_n331_));
  nand3  g168(.a(x126), .b(new_n202_), .c(new_n195_), .O(new_n332_));
  nand2  g169(.a(new_n332_), .b(new_n219_), .O(new_n333_));
  aoi21  g170(.a(new_n331_), .b(new_n206_), .c(new_n333_), .O(new_n334_));
  nand4  g171(.a(new_n334_), .b(new_n329_), .c(new_n327_), .d(new_n323_), .O(new_n335_));
  nand4  g172(.a(x126), .b(new_n209_), .c(new_n206_), .d(x014), .O(new_n336_));
  inv1   g173(.a(new_n336_), .O(new_n337_));
  aoi21  g174(.a(new_n335_), .b(new_n227_), .c(new_n337_), .O(new_n338_));
  nand3  g175(.a(x086), .b(new_n206_), .c(new_n194_), .O(new_n339_));
  oai21  g176(.a(new_n338_), .b(x054), .c(new_n339_), .O(new_n340_));
  nand2  g177(.a(new_n340_), .b(x006), .O(new_n341_));
  nand2  g178(.a(new_n197_), .b(x030), .O(new_n342_));
  nand2  g179(.a(new_n342_), .b(new_n195_), .O(new_n343_));
  nand2  g180(.a(new_n343_), .b(new_n227_), .O(new_n344_));
  aoi21  g181(.a(new_n344_), .b(new_n194_), .c(new_n325_), .O(new_n345_));
  nor2   g182(.a(new_n193_), .b(x022), .O(new_n346_));
  oai21  g183(.a(new_n346_), .b(new_n231_), .c(x070), .O(new_n347_));
  inv1   g184(.a(new_n324_), .O(new_n348_));
  nand4  g185(.a(new_n348_), .b(new_n322_), .c(new_n197_), .d(x030), .O(new_n349_));
  aoi21  g186(.a(new_n349_), .b(new_n347_), .c(x078), .O(new_n350_));
  oai21  g187(.a(new_n350_), .b(new_n345_), .c(new_n192_), .O(new_n351_));
  nand2  g188(.a(new_n322_), .b(x030), .O(new_n352_));
  nand2  g189(.a(new_n352_), .b(new_n223_), .O(new_n353_));
  nand3  g190(.a(new_n353_), .b(new_n227_), .c(x038), .O(new_n354_));
  nand2  g191(.a(new_n354_), .b(new_n351_), .O(new_n355_));
  oai22  g192(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n356_));
  nand3  g193(.a(new_n356_), .b(x070), .c(x022), .O(new_n357_));
  aoi22  g194(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n358_));
  nand2  g195(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  aoi21  g196(.a(new_n355_), .b(new_n219_), .c(new_n359_), .O(new_n360_));
  aoi21  g197(.a(new_n360_), .b(new_n341_), .c(x046), .O(z14));
  zero   g198(.O(z01));
  zero   g199(.O(z02));
  zero   g200(.O(z04));
  zero   g201(.O(z05));
