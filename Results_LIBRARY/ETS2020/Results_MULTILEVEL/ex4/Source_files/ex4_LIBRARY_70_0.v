// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:42 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n363_, new_n367_, new_n368_, new_n369_, new_n370_, new_n371_,
  ...
  oai22  g205(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n367_));
  nand3  g206(.a(new_n367_), .b(x083), .c(x003), .O(new_n368_));
  oai22  g207(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n369_));
  nand3  g208(.a(new_n369_), .b(x067), .c(x019), .O(new_n370_));
  aoi22  g209(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n371_));
  nand3  g210(.a(new_n371_), .b(new_n370_), .c(new_n368_), .O(new_n372_));
  and2   g211(.a(new_n372_), .b(new_n175_), .O(z11));
  inv1   g212(.a(x077), .O(new_n375_));
  nand2  g213(.a(x021), .b(x013), .O(new_n376_));
  oai21  g214(.a(new_n243_), .b(x029), .c(new_n376_), .O(new_n377_));
  nor2   g215(.a(x125), .b(x101), .O(new_n378_));
  nor2   g216(.a(x117), .b(x109), .O(new_n379_));
  oai21  g217(.a(new_n378_), .b(x093), .c(new_n379_), .O(new_n380_));
  nand2  g218(.a(new_n380_), .b(new_n233_), .O(new_n381_));
  oai21  g219(.a(new_n221_), .b(x109), .c(x037), .O(new_n382_));
  nand2  g220(.a(new_n382_), .b(x117), .O(new_n383_));
  inv1   g221(.a(x101), .O(new_n384_));
  oai21  g222(.a(new_n384_), .b(x061), .c(new_n216_), .O(new_n385_));
  nand3  g223(.a(x125), .b(new_n214_), .c(new_n206_), .O(new_n386_));
  nand2  g224(.a(new_n386_), .b(new_n229_), .O(new_n387_));
  aoi21  g225(.a(new_n385_), .b(new_n215_), .c(new_n387_), .O(new_n388_));
  nand4  g226(.a(new_n388_), .b(new_n383_), .c(new_n381_), .d(new_n377_), .O(new_n389_));
  nand4  g227(.a(x125), .b(new_n219_), .c(new_n215_), .d(x013), .O(new_n390_));
  inv1   g228(.a(new_n390_), .O(new_n391_));
  aoi21  g229(.a(new_n389_), .b(new_n375_), .c(new_n391_), .O(new_n392_));
  nand3  g230(.a(x085), .b(new_n215_), .c(new_n205_), .O(new_n393_));
  oai21  g231(.a(new_n392_), .b(x053), .c(new_n393_), .O(new_n394_));
  nand2  g232(.a(new_n394_), .b(x005), .O(new_n395_));
  nand2  g233(.a(new_n208_), .b(x029), .O(new_n396_));
  nand2  g234(.a(new_n396_), .b(new_n206_), .O(new_n397_));
  nand2  g235(.a(new_n397_), .b(new_n375_), .O(new_n398_));
  aoi21  g236(.a(new_n398_), .b(new_n205_), .c(new_n379_), .O(new_n399_));
  nor2   g237(.a(new_n204_), .b(x021), .O(new_n400_));
  oai21  g238(.a(new_n400_), .b(new_n243_), .c(x069), .O(new_n401_));
  inv1   g239(.a(new_n378_), .O(new_n402_));
  nand4  g240(.a(new_n402_), .b(new_n376_), .c(new_n208_), .d(x029), .O(new_n403_));
  aoi21  g241(.a(new_n403_), .b(new_n401_), .c(x077), .O(new_n404_));
  oai21  g242(.a(new_n404_), .b(new_n399_), .c(new_n203_), .O(new_n405_));
  nand2  g243(.a(new_n376_), .b(x029), .O(new_n406_));
  nand2  g244(.a(new_n406_), .b(new_n239_), .O(new_n407_));
  nand3  g245(.a(new_n407_), .b(new_n375_), .c(x037), .O(new_n408_));
  nand2  g246(.a(new_n408_), .b(new_n405_), .O(new_n409_));
  oai22  g247(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n410_));
  nand3  g248(.a(new_n410_), .b(x069), .c(x021), .O(new_n411_));
  aoi22  g249(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n412_));
  nand2  g250(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  aoi21  g251(.a(new_n409_), .b(new_n229_), .c(new_n413_), .O(new_n414_));
  aoi21  g252(.a(new_n414_), .b(new_n395_), .c(x045), .O(z13));
  nand2  g253(.a(x022), .b(x014), .O(new_n416_));
  oai21  g254(.a(new_n300_), .b(x030), .c(new_n416_), .O(new_n417_));
  nor2   g255(.a(x126), .b(x102), .O(new_n418_));
  nor2   g256(.a(x118), .b(x110), .O(new_n419_));
  oai21  g257(.a(new_n418_), .b(x094), .c(new_n419_), .O(new_n420_));
  nand2  g258(.a(new_n420_), .b(new_n297_), .O(new_n421_));
  oai21  g259(.a(new_n280_), .b(x110), .c(x038), .O(new_n422_));
  nand2  g260(.a(new_n422_), .b(x118), .O(new_n423_));
  inv1   g261(.a(x102), .O(new_n424_));
  oai21  g262(.a(new_n424_), .b(x062), .c(new_n270_), .O(new_n425_));
  nand3  g263(.a(x126), .b(new_n271_), .c(new_n264_), .O(new_n426_));
  nand2  g264(.a(new_n426_), .b(new_n288_), .O(new_n427_));
  aoi21  g265(.a(new_n425_), .b(new_n275_), .c(new_n427_), .O(new_n428_));
  nand4  g266(.a(new_n428_), .b(new_n423_), .c(new_n421_), .d(new_n417_), .O(new_n429_));
  nand4  g267(.a(x126), .b(new_n278_), .c(new_n275_), .d(x014), .O(new_n430_));
  inv1   g268(.a(new_n430_), .O(new_n431_));
  aoi21  g269(.a(new_n429_), .b(new_n296_), .c(new_n431_), .O(new_n432_));
  nand3  g270(.a(x086), .b(new_n275_), .c(new_n263_), .O(new_n433_));
  oai21  g271(.a(new_n432_), .b(x054), .c(new_n433_), .O(new_n434_));
  nand2  g272(.a(new_n434_), .b(x006), .O(new_n435_));
  nand2  g273(.a(new_n266_), .b(x030), .O(new_n436_));
  nand2  g274(.a(new_n436_), .b(new_n264_), .O(new_n437_));
  nand2  g275(.a(new_n437_), .b(new_n296_), .O(new_n438_));
  aoi21  g276(.a(new_n438_), .b(new_n263_), .c(new_n419_), .O(new_n439_));
  nor2   g277(.a(new_n262_), .b(x022), .O(new_n440_));
  oai21  g278(.a(new_n440_), .b(new_n300_), .c(x070), .O(new_n441_));
  inv1   g279(.a(new_n418_), .O(new_n442_));
  nand4  g280(.a(new_n442_), .b(new_n416_), .c(new_n266_), .d(x030), .O(new_n443_));
  aoi21  g281(.a(new_n443_), .b(new_n441_), .c(x078), .O(new_n444_));
  oai21  g282(.a(new_n444_), .b(new_n439_), .c(new_n261_), .O(new_n445_));
  nand2  g283(.a(new_n416_), .b(x030), .O(new_n446_));
  nand2  g284(.a(new_n446_), .b(new_n292_), .O(new_n447_));
  nand3  g285(.a(new_n447_), .b(new_n296_), .c(x038), .O(new_n448_));
  nand2  g286(.a(new_n448_), .b(new_n445_), .O(new_n449_));
  oai22  g287(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n450_));
  nand3  g288(.a(new_n450_), .b(x070), .c(x022), .O(new_n451_));
  aoi22  g289(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n452_));
  nand2  g290(.a(new_n452_), .b(new_n451_), .O(new_n453_));
  aoi21  g291(.a(new_n449_), .b(new_n288_), .c(new_n453_), .O(new_n454_));
  aoi21  g292(.a(new_n454_), .b(new_n435_), .c(x046), .O(z14));
  zero   g293(.O(z01));
  zero   g294(.O(z02));
  zero   g295(.O(z07));
  zero   g296(.O(z09));
