// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:36 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n252_, new_n253_, new_n254_, new_n262_, new_n263_, new_n264_,
  ...
  oai22  g097(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n262_));
  nand3  g098(.a(new_n262_), .b(x084), .c(x004), .O(new_n263_));
  oai22  g099(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n264_));
  nand3  g100(.a(new_n264_), .b(x068), .c(x020), .O(new_n265_));
  aoi22  g101(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n266_));
  nand3  g102(.a(new_n266_), .b(new_n265_), .c(new_n263_), .O(new_n267_));
  and2   g103(.a(new_n267_), .b(new_n185_), .O(z12));
