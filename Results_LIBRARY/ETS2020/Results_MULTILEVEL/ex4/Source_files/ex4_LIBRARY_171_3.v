// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:38 2020
...
module FAU ( 
  ...
  and2   g231(.a(new_n389_), .b(new_n186_), .O(z10));
  oai22  g232(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n391_));
  nand3  g233(.a(new_n391_), .b(x083), .c(x003), .O(new_n392_));
  oai22  g234(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n393_));
  nand3  g235(.a(new_n393_), .b(x067), .c(x019), .O(new_n394_));
  aoi22  g236(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n395_));
  nand3  g237(.a(new_n395_), .b(new_n394_), .c(new_n392_), .O(new_n396_));
  and2   g238(.a(new_n396_), .b(new_n199_), .O(z11));
  oai22  g239(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n398_));
  nand3  g240(.a(new_n398_), .b(x084), .c(x004), .O(new_n399_));
  oai22  g241(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n400_));
  nand3  g242(.a(new_n400_), .b(x068), .c(x020), .O(new_n401_));
  aoi22  g243(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n402_));
  nand3  g244(.a(new_n402_), .b(new_n401_), .c(new_n399_), .O(new_n403_));
  inv1   g245(.a(new_n403_), .O(new_n404_));
  nor2   g246(.a(new_n404_), .b(x044), .O(z12));
  inv1   g247(.a(x077), .O(new_n406_));
  nand2  g248(.a(x021), .b(x013), .O(new_n407_));
  oai21  g249(.a(new_n255_), .b(x029), .c(new_n407_), .O(new_n408_));
  nor2   g250(.a(x125), .b(x101), .O(new_n409_));
  nor2   g251(.a(x117), .b(x109), .O(new_n410_));
  oai21  g252(.a(new_n409_), .b(x093), .c(new_n410_), .O(new_n411_));
  nand2  g253(.a(new_n411_), .b(new_n245_), .O(new_n412_));
  oai21  g254(.a(new_n233_), .b(x109), .c(x037), .O(new_n413_));
  nand2  g255(.a(new_n413_), .b(x117), .O(new_n414_));
  inv1   g256(.a(x101), .O(new_n415_));
  oai21  g257(.a(new_n415_), .b(x061), .c(new_n228_), .O(new_n416_));
  nand3  g258(.a(x125), .b(new_n226_), .c(new_n218_), .O(new_n417_));
  nand2  g259(.a(new_n417_), .b(new_n241_), .O(new_n418_));
  aoi21  g260(.a(new_n416_), .b(new_n227_), .c(new_n418_), .O(new_n419_));
  nand4  g261(.a(new_n419_), .b(new_n414_), .c(new_n412_), .d(new_n408_), .O(new_n420_));
  nand4  g262(.a(x125), .b(new_n231_), .c(new_n227_), .d(x013), .O(new_n421_));
  inv1   g263(.a(new_n421_), .O(new_n422_));
  aoi21  g264(.a(new_n420_), .b(new_n406_), .c(new_n422_), .O(new_n423_));
  nand3  g265(.a(x085), .b(new_n227_), .c(new_n217_), .O(new_n424_));
  oai21  g266(.a(new_n423_), .b(x053), .c(new_n424_), .O(new_n425_));
  nand2  g267(.a(new_n425_), .b(x005), .O(new_n426_));
  nand2  g268(.a(new_n220_), .b(x029), .O(new_n427_));
  nand2  g269(.a(new_n427_), .b(new_n218_), .O(new_n428_));
  nand2  g270(.a(new_n428_), .b(new_n406_), .O(new_n429_));
  aoi21  g271(.a(new_n429_), .b(new_n217_), .c(new_n410_), .O(new_n430_));
  nor2   g272(.a(new_n216_), .b(x021), .O(new_n431_));
  oai21  g273(.a(new_n431_), .b(new_n255_), .c(x069), .O(new_n432_));
  inv1   g274(.a(new_n409_), .O(new_n433_));
  nand4  g275(.a(new_n433_), .b(new_n407_), .c(new_n220_), .d(x029), .O(new_n434_));
  aoi21  g276(.a(new_n434_), .b(new_n432_), .c(x077), .O(new_n435_));
  oai21  g277(.a(new_n435_), .b(new_n430_), .c(new_n215_), .O(new_n436_));
  nand2  g278(.a(new_n407_), .b(x029), .O(new_n437_));
  nand2  g279(.a(new_n437_), .b(new_n251_), .O(new_n438_));
  nand3  g280(.a(new_n438_), .b(new_n406_), .c(x037), .O(new_n439_));
  nand2  g281(.a(new_n439_), .b(new_n436_), .O(new_n440_));
  oai22  g282(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n441_));
  nand3  g283(.a(new_n441_), .b(x069), .c(x021), .O(new_n442_));
  aoi22  g284(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n443_));
  nand2  g285(.a(new_n443_), .b(new_n442_), .O(new_n444_));
  aoi21  g286(.a(new_n440_), .b(new_n241_), .c(new_n444_), .O(new_n445_));
  aoi21  g287(.a(new_n445_), .b(new_n426_), .c(x045), .O(z13));
  nand2  g288(.a(x022), .b(x014), .O(new_n447_));
  oai21  g289(.a(new_n312_), .b(x030), .c(new_n447_), .O(new_n448_));
  nor2   g290(.a(x126), .b(x102), .O(new_n449_));
  nor2   g291(.a(x118), .b(x110), .O(new_n450_));
  oai21  g292(.a(new_n449_), .b(x094), .c(new_n450_), .O(new_n451_));
  nand2  g293(.a(new_n451_), .b(new_n309_), .O(new_n452_));
  oai21  g294(.a(new_n292_), .b(x110), .c(x038), .O(new_n453_));
  nand2  g295(.a(new_n453_), .b(x118), .O(new_n454_));
  inv1   g296(.a(x102), .O(new_n455_));
  oai21  g297(.a(new_n455_), .b(x062), .c(new_n282_), .O(new_n456_));
  nand3  g298(.a(x126), .b(new_n283_), .c(new_n276_), .O(new_n457_));
  nand2  g299(.a(new_n457_), .b(new_n300_), .O(new_n458_));
  aoi21  g300(.a(new_n456_), .b(new_n287_), .c(new_n458_), .O(new_n459_));
  nand4  g301(.a(new_n459_), .b(new_n454_), .c(new_n452_), .d(new_n448_), .O(new_n460_));
  nand4  g302(.a(x126), .b(new_n290_), .c(new_n287_), .d(x014), .O(new_n461_));
  inv1   g303(.a(new_n461_), .O(new_n462_));
  aoi21  g304(.a(new_n460_), .b(new_n308_), .c(new_n462_), .O(new_n463_));
  nand3  g305(.a(x086), .b(new_n287_), .c(new_n275_), .O(new_n464_));
  oai21  g306(.a(new_n463_), .b(x054), .c(new_n464_), .O(new_n465_));
  nand2  g307(.a(new_n465_), .b(x006), .O(new_n466_));
  nand2  g308(.a(new_n278_), .b(x030), .O(new_n467_));
  nand2  g309(.a(new_n467_), .b(new_n276_), .O(new_n468_));
  nand2  g310(.a(new_n468_), .b(new_n308_), .O(new_n469_));
  aoi21  g311(.a(new_n469_), .b(new_n275_), .c(new_n450_), .O(new_n470_));
  nor2   g312(.a(new_n274_), .b(x022), .O(new_n471_));
  oai21  g313(.a(new_n471_), .b(new_n312_), .c(x070), .O(new_n472_));
  inv1   g314(.a(new_n449_), .O(new_n473_));
  nand4  g315(.a(new_n473_), .b(new_n447_), .c(new_n278_), .d(x030), .O(new_n474_));
  aoi21  g316(.a(new_n474_), .b(new_n472_), .c(x078), .O(new_n475_));
  oai21  g317(.a(new_n475_), .b(new_n470_), .c(new_n273_), .O(new_n476_));
  nand2  g318(.a(new_n447_), .b(x030), .O(new_n477_));
  nand2  g319(.a(new_n477_), .b(new_n304_), .O(new_n478_));
  nand3  g320(.a(new_n478_), .b(new_n308_), .c(x038), .O(new_n479_));
  nand2  g321(.a(new_n479_), .b(new_n476_), .O(new_n480_));
  oai22  g322(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n481_));
  nand3  g323(.a(new_n481_), .b(x070), .c(x022), .O(new_n482_));
  aoi22  g324(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n483_));
  nand2  g325(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  aoi21  g326(.a(new_n480_), .b(new_n300_), .c(new_n484_), .O(new_n485_));
  aoi21  g327(.a(new_n485_), .b(new_n466_), .c(x046), .O(z14));
  zero   g328(.O(z04));
  zero   g329(.O(z07));
  zero   g330(.O(z15));
  zero   g331(.O(z16));
