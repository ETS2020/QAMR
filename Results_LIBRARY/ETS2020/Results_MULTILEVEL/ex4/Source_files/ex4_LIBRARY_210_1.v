// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:23 2020
...
module FAU ( 
  ...
  oai22  g174(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n335_));
  nand3  g175(.a(new_n335_), .b(x084), .c(x004), .O(new_n336_));
  oai22  g176(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n337_));
  nand3  g177(.a(new_n337_), .b(x068), .c(x020), .O(new_n338_));
  aoi22  g178(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n339_));
  nand3  g179(.a(new_n339_), .b(new_n338_), .c(new_n336_), .O(new_n340_));
  and2   g180(.a(new_n340_), .b(new_n200_), .O(z12));
  nand2  g181(.a(x022), .b(x014), .O(new_n343_));
  oai21  g182(.a(new_n255_), .b(x030), .c(new_n343_), .O(new_n344_));
  nor2   g183(.a(x126), .b(x102), .O(new_n345_));
  nor2   g184(.a(x118), .b(x110), .O(new_n346_));
  oai21  g185(.a(new_n345_), .b(x094), .c(new_n346_), .O(new_n347_));
  nand2  g186(.a(new_n347_), .b(new_n252_), .O(new_n348_));
  oai21  g187(.a(new_n235_), .b(x110), .c(x038), .O(new_n349_));
  nand2  g188(.a(new_n349_), .b(x118), .O(new_n350_));
  inv1   g189(.a(x102), .O(new_n351_));
  oai21  g190(.a(new_n351_), .b(x062), .c(new_n225_), .O(new_n352_));
  nand3  g191(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n353_));
  nand2  g192(.a(new_n353_), .b(new_n243_), .O(new_n354_));
  aoi21  g193(.a(new_n352_), .b(new_n230_), .c(new_n354_), .O(new_n355_));
  nand4  g194(.a(new_n355_), .b(new_n350_), .c(new_n348_), .d(new_n344_), .O(new_n356_));
  nand4  g195(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n357_));
  inv1   g196(.a(new_n357_), .O(new_n358_));
  aoi21  g197(.a(new_n356_), .b(new_n251_), .c(new_n358_), .O(new_n359_));
  nand3  g198(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n360_));
  oai21  g199(.a(new_n359_), .b(x054), .c(new_n360_), .O(new_n361_));
  nand2  g200(.a(new_n361_), .b(x006), .O(new_n362_));
  nand2  g201(.a(new_n221_), .b(x030), .O(new_n363_));
  nand2  g202(.a(new_n363_), .b(new_n219_), .O(new_n364_));
  nand2  g203(.a(new_n364_), .b(new_n251_), .O(new_n365_));
  aoi21  g204(.a(new_n365_), .b(new_n218_), .c(new_n346_), .O(new_n366_));
  nor2   g205(.a(new_n217_), .b(x022), .O(new_n367_));
  oai21  g206(.a(new_n367_), .b(new_n255_), .c(x070), .O(new_n368_));
  inv1   g207(.a(new_n345_), .O(new_n369_));
  nand4  g208(.a(new_n369_), .b(new_n343_), .c(new_n221_), .d(x030), .O(new_n370_));
  aoi21  g209(.a(new_n370_), .b(new_n368_), .c(x078), .O(new_n371_));
  oai21  g210(.a(new_n371_), .b(new_n366_), .c(new_n216_), .O(new_n372_));
  nand2  g211(.a(new_n343_), .b(x030), .O(new_n373_));
  nand2  g212(.a(new_n373_), .b(new_n247_), .O(new_n374_));
  nand3  g213(.a(new_n374_), .b(new_n251_), .c(x038), .O(new_n375_));
  nand2  g214(.a(new_n375_), .b(new_n372_), .O(new_n376_));
  oai22  g215(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n377_));
  nand3  g216(.a(new_n377_), .b(x070), .c(x022), .O(new_n378_));
  aoi22  g217(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n379_));
  nand2  g218(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  aoi21  g219(.a(new_n376_), .b(new_n243_), .c(new_n380_), .O(new_n381_));
  aoi21  g220(.a(new_n381_), .b(new_n362_), .c(x046), .O(z14));
  zero   g221(.O(z03));
  zero   g222(.O(z05));
  zero   g223(.O(z07));
  zero   g224(.O(z11));
