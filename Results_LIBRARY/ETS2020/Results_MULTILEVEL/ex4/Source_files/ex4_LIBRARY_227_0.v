...
module FAU ( 
  ...
  oai22  g212(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n373_));
  nand3  g213(.a(new_n373_), .b(x083), .c(x003), .O(new_n374_));
  oai22  g214(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n375_));
  nand3  g215(.a(new_n375_), .b(x067), .c(x019), .O(new_n376_));
  aoi22  g216(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(new_n376_), .c(new_n374_), .O(new_n378_));
  inv1   g218(.a(new_n378_), .O(new_n379_));
  nor2   g219(.a(new_n379_), .b(x043), .O(z11));
