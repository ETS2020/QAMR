// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:41 2020
...
module FAU ( 
  ...
  nor2   g162(.a(new_n322_), .b(x042), .O(z10));
  oai22  g163(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n324_));
  nand3  g164(.a(new_n324_), .b(x083), .c(x003), .O(new_n325_));
  oai22  g165(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n326_));
  nand3  g166(.a(new_n326_), .b(x067), .c(x019), .O(new_n327_));
  aoi22  g167(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n328_));
  nand3  g168(.a(new_n328_), .b(new_n327_), .c(new_n325_), .O(new_n329_));
  and2   g169(.a(new_n329_), .b(new_n175_), .O(z11));
