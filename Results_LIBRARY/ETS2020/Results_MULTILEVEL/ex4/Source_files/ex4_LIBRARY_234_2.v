// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:51 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n264_, new_n265_, new_n266_, new_n273_, new_n274_, new_n275_,
  ...
  oai22  g110(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n273_));
  nand3  g111(.a(new_n273_), .b(x083), .c(x003), .O(new_n274_));
  oai22  g112(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n275_));
  nand3  g113(.a(new_n275_), .b(x067), .c(x019), .O(new_n276_));
  aoi22  g114(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n277_));
  nand3  g115(.a(new_n277_), .b(new_n276_), .c(new_n274_), .O(new_n278_));
  and2   g116(.a(new_n278_), .b(new_n184_), .O(z11));
  oai22  g117(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n280_));
  nand3  g118(.a(new_n280_), .b(x084), .c(x004), .O(new_n281_));
  oai22  g119(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n282_));
  nand3  g120(.a(new_n282_), .b(x068), .c(x020), .O(new_n283_));
  aoi22  g121(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n284_));
  nand3  g122(.a(new_n284_), .b(new_n283_), .c(new_n281_), .O(new_n285_));
  and2   g123(.a(new_n285_), .b(new_n197_), .O(z12));
  inv1   g124(.a(x077), .O(new_n287_));
  nand2  g125(.a(x021), .b(x013), .O(new_n288_));
  oai21  g126(.a(new_n252_), .b(x029), .c(new_n288_), .O(new_n289_));
  nor2   g127(.a(x125), .b(x101), .O(new_n290_));
  nor2   g128(.a(x117), .b(x109), .O(new_n291_));
  oai21  g129(.a(new_n290_), .b(x093), .c(new_n291_), .O(new_n292_));
  nand2  g130(.a(new_n292_), .b(new_n242_), .O(new_n293_));
  oai21  g131(.a(new_n230_), .b(x109), .c(x037), .O(new_n294_));
  nand2  g132(.a(new_n294_), .b(x117), .O(new_n295_));
  inv1   g133(.a(x101), .O(new_n296_));
  oai21  g134(.a(new_n296_), .b(x061), .c(new_n225_), .O(new_n297_));
  nand3  g135(.a(x125), .b(new_n223_), .c(new_n215_), .O(new_n298_));
  nand2  g136(.a(new_n298_), .b(new_n238_), .O(new_n299_));
  aoi21  g137(.a(new_n297_), .b(new_n224_), .c(new_n299_), .O(new_n300_));
  nand4  g138(.a(new_n300_), .b(new_n295_), .c(new_n293_), .d(new_n289_), .O(new_n301_));
  nand4  g139(.a(x125), .b(new_n228_), .c(new_n224_), .d(x013), .O(new_n302_));
  inv1   g140(.a(new_n302_), .O(new_n303_));
  aoi21  g141(.a(new_n301_), .b(new_n287_), .c(new_n303_), .O(new_n304_));
  nand3  g142(.a(x085), .b(new_n224_), .c(new_n214_), .O(new_n305_));
  oai21  g143(.a(new_n304_), .b(x053), .c(new_n305_), .O(new_n306_));
  nand2  g144(.a(new_n306_), .b(x005), .O(new_n307_));
  nand2  g145(.a(new_n217_), .b(x029), .O(new_n308_));
  nand2  g146(.a(new_n308_), .b(new_n215_), .O(new_n309_));
  nand2  g147(.a(new_n309_), .b(new_n287_), .O(new_n310_));
  aoi21  g148(.a(new_n310_), .b(new_n214_), .c(new_n291_), .O(new_n311_));
  nor2   g149(.a(new_n213_), .b(x021), .O(new_n312_));
  oai21  g150(.a(new_n312_), .b(new_n252_), .c(x069), .O(new_n313_));
  inv1   g151(.a(new_n290_), .O(new_n314_));
  nand4  g152(.a(new_n314_), .b(new_n288_), .c(new_n217_), .d(x029), .O(new_n315_));
  aoi21  g153(.a(new_n315_), .b(new_n313_), .c(x077), .O(new_n316_));
  oai21  g154(.a(new_n316_), .b(new_n311_), .c(new_n212_), .O(new_n317_));
  nand2  g155(.a(new_n288_), .b(x029), .O(new_n318_));
  nand2  g156(.a(new_n318_), .b(new_n248_), .O(new_n319_));
  nand3  g157(.a(new_n319_), .b(new_n287_), .c(x037), .O(new_n320_));
  nand2  g158(.a(new_n320_), .b(new_n317_), .O(new_n321_));
  oai22  g159(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n322_));
  nand3  g160(.a(new_n322_), .b(x069), .c(x021), .O(new_n323_));
  aoi22  g161(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n324_));
  nand2  g162(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  aoi21  g163(.a(new_n321_), .b(new_n238_), .c(new_n325_), .O(new_n326_));
  aoi21  g164(.a(new_n326_), .b(new_n307_), .c(x045), .O(z13));
  zero   g165(.O(z00));
  zero   g166(.O(z06));
  zero   g167(.O(z07));
  zero   g168(.O(z08));
