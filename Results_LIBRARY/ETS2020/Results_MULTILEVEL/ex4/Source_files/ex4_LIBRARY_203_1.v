// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:15 2020
...
module FAU ( 
  ...
  oai22  g150(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n312_));
  nand3  g151(.a(new_n312_), .b(x083), .c(x003), .O(new_n313_));
  oai22  g152(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n314_));
  nand3  g153(.a(new_n314_), .b(x067), .c(x019), .O(new_n315_));
  aoi22  g154(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n316_));
  nand3  g155(.a(new_n316_), .b(new_n315_), .c(new_n313_), .O(new_n317_));
  inv1   g156(.a(new_n317_), .O(new_n318_));
  nor2   g157(.a(new_n318_), .b(x043), .O(z11));
  oai22  g158(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n320_));
  nand3  g159(.a(new_n320_), .b(x084), .c(x004), .O(new_n321_));
  oai22  g160(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n322_));
  nand3  g161(.a(new_n322_), .b(x068), .c(x020), .O(new_n323_));
  aoi22  g162(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n324_));
  nand3  g163(.a(new_n324_), .b(new_n323_), .c(new_n321_), .O(new_n325_));
  and2   g164(.a(new_n325_), .b(new_n176_), .O(z12));
