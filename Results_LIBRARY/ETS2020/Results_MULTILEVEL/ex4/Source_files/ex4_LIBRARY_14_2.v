// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:39 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n252_, new_n253_, new_n254_, new_n261_, new_n262_, new_n263_,
  ...
  oai22  g097(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n261_));
  nand3  g098(.a(new_n261_), .b(x083), .c(x003), .O(new_n262_));
  oai22  g099(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n263_));
  nand3  g100(.a(new_n263_), .b(x067), .c(x019), .O(new_n264_));
  aoi22  g101(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n265_));
  nand3  g102(.a(new_n265_), .b(new_n264_), .c(new_n262_), .O(new_n266_));
  and2   g103(.a(new_n266_), .b(new_n184_), .O(z11));
  ...
  inv1   g110(.a(new_n273_), .O(new_n274_));
  nor2   g111(.a(new_n274_), .b(x044), .O(z12));
  inv1   g112(.a(x077), .O(new_n276_));
  nand2  g113(.a(x021), .b(x013), .O(new_n277_));
  oai21  g114(.a(new_n240_), .b(x029), .c(new_n277_), .O(new_n278_));
  nor2   g115(.a(x125), .b(x101), .O(new_n279_));
  nor2   g116(.a(x117), .b(x109), .O(new_n280_));
  oai21  g117(.a(new_n279_), .b(x093), .c(new_n280_), .O(new_n281_));
  nand2  g118(.a(new_n281_), .b(new_n230_), .O(new_n282_));
  oai21  g119(.a(new_n218_), .b(x109), .c(x037), .O(new_n283_));
  nand2  g120(.a(new_n283_), .b(x117), .O(new_n284_));
  inv1   g121(.a(x101), .O(new_n285_));
  oai21  g122(.a(new_n285_), .b(x061), .c(new_n213_), .O(new_n286_));
  nand3  g123(.a(x125), .b(new_n211_), .c(new_n203_), .O(new_n287_));
  nand2  g124(.a(new_n287_), .b(new_n226_), .O(new_n288_));
  aoi21  g125(.a(new_n286_), .b(new_n212_), .c(new_n288_), .O(new_n289_));
  nand4  g126(.a(new_n289_), .b(new_n284_), .c(new_n282_), .d(new_n278_), .O(new_n290_));
  nand4  g127(.a(x125), .b(new_n216_), .c(new_n212_), .d(x013), .O(new_n291_));
  inv1   g128(.a(new_n291_), .O(new_n292_));
  aoi21  g129(.a(new_n290_), .b(new_n276_), .c(new_n292_), .O(new_n293_));
  nand3  g130(.a(x085), .b(new_n212_), .c(new_n202_), .O(new_n294_));
  oai21  g131(.a(new_n293_), .b(x053), .c(new_n294_), .O(new_n295_));
  nand2  g132(.a(new_n295_), .b(x005), .O(new_n296_));
  nand2  g133(.a(new_n205_), .b(x029), .O(new_n297_));
  nand2  g134(.a(new_n297_), .b(new_n203_), .O(new_n298_));
  nand2  g135(.a(new_n298_), .b(new_n276_), .O(new_n299_));
  aoi21  g136(.a(new_n299_), .b(new_n202_), .c(new_n280_), .O(new_n300_));
  nor2   g137(.a(new_n201_), .b(x021), .O(new_n301_));
  oai21  g138(.a(new_n301_), .b(new_n240_), .c(x069), .O(new_n302_));
  inv1   g139(.a(new_n279_), .O(new_n303_));
  nand4  g140(.a(new_n303_), .b(new_n277_), .c(new_n205_), .d(x029), .O(new_n304_));
  aoi21  g141(.a(new_n304_), .b(new_n302_), .c(x077), .O(new_n305_));
  oai21  g142(.a(new_n305_), .b(new_n300_), .c(new_n200_), .O(new_n306_));
  nand2  g143(.a(new_n277_), .b(x029), .O(new_n307_));
  nand2  g144(.a(new_n307_), .b(new_n236_), .O(new_n308_));
  nand3  g145(.a(new_n308_), .b(new_n276_), .c(x037), .O(new_n309_));
  nand2  g146(.a(new_n309_), .b(new_n306_), .O(new_n310_));
  oai22  g147(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n311_));
  nand3  g148(.a(new_n311_), .b(x069), .c(x021), .O(new_n312_));
  aoi22  g149(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n313_));
  nand2  g150(.a(new_n313_), .b(new_n312_), .O(new_n314_));
  aoi21  g151(.a(new_n310_), .b(new_n226_), .c(new_n314_), .O(new_n315_));
  aoi21  g152(.a(new_n315_), .b(new_n296_), .c(x045), .O(z13));
  zero   g153(.O(z00));
  zero   g154(.O(z04));
  zero   g155(.O(z06));
  zero   g156(.O(z07));
