// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:31 2020
...
module FAU ( 
  ...
  inv1   g110(.a(new_n272_), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(x043), .O(z11));
  oai22  g112(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n275_));
  nand3  g113(.a(new_n275_), .b(x084), .c(x004), .O(new_n276_));
  oai22  g114(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n277_));
  nand3  g115(.a(new_n277_), .b(x068), .c(x020), .O(new_n278_));
  aoi22  g116(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n279_));
  nand3  g117(.a(new_n279_), .b(new_n278_), .c(new_n276_), .O(new_n280_));
  and2   g118(.a(new_n280_), .b(new_n185_), .O(z12));
