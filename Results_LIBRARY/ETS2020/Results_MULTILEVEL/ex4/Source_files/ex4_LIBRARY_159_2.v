// Benchmark "FAU" written by ABC on Sat Jul 25 09:08:24 2020
...
module FAU ( 
  ...
  inv1   g091(.a(x077), .O(new_n257_));
  nand2  g092(.a(x021), .b(x013), .O(new_n258_));
  oai21  g093(.a(new_n228_), .b(x029), .c(new_n258_), .O(new_n259_));
  nor2   g094(.a(x125), .b(x101), .O(new_n260_));
  nor2   g095(.a(x117), .b(x109), .O(new_n261_));
  oai21  g096(.a(new_n260_), .b(x093), .c(new_n261_), .O(new_n262_));
  nand2  g097(.a(new_n262_), .b(new_n218_), .O(new_n263_));
  oai21  g098(.a(new_n206_), .b(x109), .c(x037), .O(new_n264_));
  nand2  g099(.a(new_n264_), .b(x117), .O(new_n265_));
  inv1   g100(.a(x101), .O(new_n266_));
  oai21  g101(.a(new_n266_), .b(x061), .c(new_n201_), .O(new_n267_));
  nand3  g102(.a(x125), .b(new_n199_), .c(new_n191_), .O(new_n268_));
  nand2  g103(.a(new_n268_), .b(new_n214_), .O(new_n269_));
  aoi21  g104(.a(new_n267_), .b(new_n200_), .c(new_n269_), .O(new_n270_));
  nand4  g105(.a(new_n270_), .b(new_n265_), .c(new_n263_), .d(new_n259_), .O(new_n271_));
  nand4  g106(.a(x125), .b(new_n204_), .c(new_n200_), .d(x013), .O(new_n272_));
  inv1   g107(.a(new_n272_), .O(new_n273_));
  aoi21  g108(.a(new_n271_), .b(new_n257_), .c(new_n273_), .O(new_n274_));
  nand3  g109(.a(x085), .b(new_n200_), .c(new_n190_), .O(new_n275_));
  oai21  g110(.a(new_n274_), .b(x053), .c(new_n275_), .O(new_n276_));
  nand2  g111(.a(new_n276_), .b(x005), .O(new_n277_));
  nand2  g112(.a(new_n193_), .b(x029), .O(new_n278_));
  nand2  g113(.a(new_n278_), .b(new_n191_), .O(new_n279_));
  nand2  g114(.a(new_n279_), .b(new_n257_), .O(new_n280_));
  aoi21  g115(.a(new_n280_), .b(new_n190_), .c(new_n261_), .O(new_n281_));
  nor2   g116(.a(new_n189_), .b(x021), .O(new_n282_));
  oai21  g117(.a(new_n282_), .b(new_n228_), .c(x069), .O(new_n283_));
  inv1   g118(.a(new_n260_), .O(new_n284_));
  nand4  g119(.a(new_n284_), .b(new_n258_), .c(new_n193_), .d(x029), .O(new_n285_));
  aoi21  g120(.a(new_n285_), .b(new_n283_), .c(x077), .O(new_n286_));
  oai21  g121(.a(new_n286_), .b(new_n281_), .c(new_n188_), .O(new_n287_));
  nand2  g122(.a(new_n258_), .b(x029), .O(new_n288_));
  nand2  g123(.a(new_n288_), .b(new_n224_), .O(new_n289_));
  nand3  g124(.a(new_n289_), .b(new_n257_), .c(x037), .O(new_n290_));
  nand2  g125(.a(new_n290_), .b(new_n287_), .O(new_n291_));
  oai22  g126(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n292_));
  nand3  g127(.a(new_n292_), .b(x069), .c(x021), .O(new_n293_));
  aoi22  g128(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n294_));
  nand2  g129(.a(new_n294_), .b(new_n293_), .O(new_n295_));
  aoi21  g130(.a(new_n291_), .b(new_n214_), .c(new_n295_), .O(new_n296_));
  aoi21  g131(.a(new_n296_), .b(new_n277_), .c(x045), .O(z13));
  zero   g132(.O(z00));
  zero   g133(.O(z03));
  zero   g134(.O(z04));
  zero   g135(.O(z06));
