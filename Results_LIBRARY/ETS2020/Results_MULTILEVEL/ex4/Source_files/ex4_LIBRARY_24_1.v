// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:50 2020
...
module FAU ( 
  ...
  oai22  g175(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n336_));
  nand3  g176(.a(new_n336_), .b(x084), .c(x004), .O(new_n337_));
  oai22  g177(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n338_));
  nand3  g178(.a(new_n338_), .b(x068), .c(x020), .O(new_n339_));
  aoi22  g179(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n340_));
  nand3  g180(.a(new_n340_), .b(new_n339_), .c(new_n337_), .O(new_n341_));
  and2   g181(.a(new_n341_), .b(new_n200_), .O(z12));
  nand2  g182(.a(x022), .b(x014), .O(new_n344_));
  oai21  g183(.a(new_n255_), .b(x030), .c(new_n344_), .O(new_n345_));
  nor2   g184(.a(x126), .b(x102), .O(new_n346_));
  nor2   g185(.a(x118), .b(x110), .O(new_n347_));
  oai21  g186(.a(new_n346_), .b(x094), .c(new_n347_), .O(new_n348_));
  nand2  g187(.a(new_n348_), .b(new_n252_), .O(new_n349_));
  oai21  g188(.a(new_n235_), .b(x110), .c(x038), .O(new_n350_));
  nand2  g189(.a(new_n350_), .b(x118), .O(new_n351_));
  inv1   g190(.a(x102), .O(new_n352_));
  oai21  g191(.a(new_n352_), .b(x062), .c(new_n225_), .O(new_n353_));
  nand3  g192(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n354_));
  nand2  g193(.a(new_n354_), .b(new_n243_), .O(new_n355_));
  aoi21  g194(.a(new_n353_), .b(new_n230_), .c(new_n355_), .O(new_n356_));
  nand4  g195(.a(new_n356_), .b(new_n351_), .c(new_n349_), .d(new_n345_), .O(new_n357_));
  nand4  g196(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n358_));
  inv1   g197(.a(new_n358_), .O(new_n359_));
  aoi21  g198(.a(new_n357_), .b(new_n251_), .c(new_n359_), .O(new_n360_));
  nand3  g199(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n361_));
  oai21  g200(.a(new_n360_), .b(x054), .c(new_n361_), .O(new_n362_));
  nand2  g201(.a(new_n362_), .b(x006), .O(new_n363_));
  nand2  g202(.a(new_n221_), .b(x030), .O(new_n364_));
  nand2  g203(.a(new_n364_), .b(new_n219_), .O(new_n365_));
  nand2  g204(.a(new_n365_), .b(new_n251_), .O(new_n366_));
  aoi21  g205(.a(new_n366_), .b(new_n218_), .c(new_n347_), .O(new_n367_));
  nor2   g206(.a(new_n217_), .b(x022), .O(new_n368_));
  oai21  g207(.a(new_n368_), .b(new_n255_), .c(x070), .O(new_n369_));
  inv1   g208(.a(new_n346_), .O(new_n370_));
  nand4  g209(.a(new_n370_), .b(new_n344_), .c(new_n221_), .d(x030), .O(new_n371_));
  aoi21  g210(.a(new_n371_), .b(new_n369_), .c(x078), .O(new_n372_));
  oai21  g211(.a(new_n372_), .b(new_n367_), .c(new_n216_), .O(new_n373_));
  nand2  g212(.a(new_n344_), .b(x030), .O(new_n374_));
  nand2  g213(.a(new_n374_), .b(new_n247_), .O(new_n375_));
  nand3  g214(.a(new_n375_), .b(new_n251_), .c(x038), .O(new_n376_));
  nand2  g215(.a(new_n376_), .b(new_n373_), .O(new_n377_));
  oai22  g216(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n378_));
  nand3  g217(.a(new_n378_), .b(x070), .c(x022), .O(new_n379_));
  aoi22  g218(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n380_));
  nand2  g219(.a(new_n380_), .b(new_n379_), .O(new_n381_));
  aoi21  g220(.a(new_n377_), .b(new_n243_), .c(new_n381_), .O(new_n382_));
  aoi21  g221(.a(new_n382_), .b(new_n363_), .c(x046), .O(z14));
  zero   g222(.O(z01));
  zero   g223(.O(z05));
  zero   g224(.O(z07));
  zero   g225(.O(z11));
