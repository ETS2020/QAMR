...
module FAU ( 
  ...
  nand2  g220(.a(x022), .b(x014), .O(new_n383_));
  oai21  g221(.a(new_n300_), .b(x030), .c(new_n383_), .O(new_n384_));
  nor2   g222(.a(x126), .b(x102), .O(new_n385_));
  nor2   g223(.a(x118), .b(x110), .O(new_n386_));
  oai21  g224(.a(new_n385_), .b(x094), .c(new_n386_), .O(new_n387_));
  nand2  g225(.a(new_n387_), .b(new_n297_), .O(new_n388_));
  oai21  g226(.a(new_n280_), .b(x110), .c(x038), .O(new_n389_));
  nand2  g227(.a(new_n389_), .b(x118), .O(new_n390_));
  inv1   g228(.a(x102), .O(new_n391_));
  oai21  g229(.a(new_n391_), .b(x062), .c(new_n270_), .O(new_n392_));
  nand3  g230(.a(x126), .b(new_n271_), .c(new_n264_), .O(new_n393_));
  nand2  g231(.a(new_n393_), .b(new_n288_), .O(new_n394_));
  aoi21  g232(.a(new_n392_), .b(new_n275_), .c(new_n394_), .O(new_n395_));
  nand4  g233(.a(new_n395_), .b(new_n390_), .c(new_n388_), .d(new_n384_), .O(new_n396_));
  nand4  g234(.a(x126), .b(new_n278_), .c(new_n275_), .d(x014), .O(new_n397_));
  inv1   g235(.a(new_n397_), .O(new_n398_));
  aoi21  g236(.a(new_n396_), .b(new_n296_), .c(new_n398_), .O(new_n399_));
  nand3  g237(.a(x086), .b(new_n275_), .c(new_n263_), .O(new_n400_));
  oai21  g238(.a(new_n399_), .b(x054), .c(new_n400_), .O(new_n401_));
  nand2  g239(.a(new_n401_), .b(x006), .O(new_n402_));
  nand2  g240(.a(new_n266_), .b(x030), .O(new_n403_));
  nand2  g241(.a(new_n403_), .b(new_n264_), .O(new_n404_));
  nand2  g242(.a(new_n404_), .b(new_n296_), .O(new_n405_));
  aoi21  g243(.a(new_n405_), .b(new_n263_), .c(new_n386_), .O(new_n406_));
  nor2   g244(.a(new_n262_), .b(x022), .O(new_n407_));
  oai21  g245(.a(new_n407_), .b(new_n300_), .c(x070), .O(new_n408_));
  inv1   g246(.a(new_n385_), .O(new_n409_));
  nand4  g247(.a(new_n409_), .b(new_n383_), .c(new_n266_), .d(x030), .O(new_n410_));
  aoi21  g248(.a(new_n410_), .b(new_n408_), .c(x078), .O(new_n411_));
  oai21  g249(.a(new_n411_), .b(new_n406_), .c(new_n261_), .O(new_n412_));
  nand2  g250(.a(new_n383_), .b(x030), .O(new_n413_));
  nand2  g251(.a(new_n413_), .b(new_n292_), .O(new_n414_));
  nand3  g252(.a(new_n414_), .b(new_n296_), .c(x038), .O(new_n415_));
  nand2  g253(.a(new_n415_), .b(new_n412_), .O(new_n416_));
  oai22  g254(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n417_));
  nand3  g255(.a(new_n417_), .b(x070), .c(x022), .O(new_n418_));
  aoi22  g256(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n419_));
  nand2  g257(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  aoi21  g258(.a(new_n416_), .b(new_n288_), .c(new_n420_), .O(new_n421_));
  aoi21  g259(.a(new_n421_), .b(new_n402_), .c(x046), .O(z14));
  zero   g260(.O(z01));
  zero   g261(.O(z03));
  zero   g262(.O(z07));
  zero   g263(.O(z11));
