// Benchmark "FAU" written by ABC on Sat Jul 25 09:09:40 2020
...
module FAU ( 
  ...
  and2   g097(.a(new_n260_), .b(new_n172_), .O(z11));
  inv1   g098(.a(x077), .O(new_n263_));
  nand2  g099(.a(x021), .b(x013), .O(new_n264_));
  oai21  g100(.a(new_n228_), .b(x029), .c(new_n264_), .O(new_n265_));
  nor2   g101(.a(x125), .b(x101), .O(new_n266_));
  nor2   g102(.a(x117), .b(x109), .O(new_n267_));
  oai21  g103(.a(new_n266_), .b(x093), .c(new_n267_), .O(new_n268_));
  nand2  g104(.a(new_n268_), .b(new_n218_), .O(new_n269_));
  oai21  g105(.a(new_n206_), .b(x109), .c(x037), .O(new_n270_));
  nand2  g106(.a(new_n270_), .b(x117), .O(new_n271_));
  inv1   g107(.a(x101), .O(new_n272_));
  oai21  g108(.a(new_n272_), .b(x061), .c(new_n201_), .O(new_n273_));
  nand3  g109(.a(x125), .b(new_n199_), .c(new_n191_), .O(new_n274_));
  nand2  g110(.a(new_n274_), .b(new_n214_), .O(new_n275_));
  aoi21  g111(.a(new_n273_), .b(new_n200_), .c(new_n275_), .O(new_n276_));
  nand4  g112(.a(new_n276_), .b(new_n271_), .c(new_n269_), .d(new_n265_), .O(new_n277_));
  nand4  g113(.a(x125), .b(new_n204_), .c(new_n200_), .d(x013), .O(new_n278_));
  inv1   g114(.a(new_n278_), .O(new_n279_));
  aoi21  g115(.a(new_n277_), .b(new_n263_), .c(new_n279_), .O(new_n280_));
  nand3  g116(.a(x085), .b(new_n200_), .c(new_n190_), .O(new_n281_));
  oai21  g117(.a(new_n280_), .b(x053), .c(new_n281_), .O(new_n282_));
  nand2  g118(.a(new_n282_), .b(x005), .O(new_n283_));
  nand2  g119(.a(new_n193_), .b(x029), .O(new_n284_));
  nand2  g120(.a(new_n284_), .b(new_n191_), .O(new_n285_));
  nand2  g121(.a(new_n285_), .b(new_n263_), .O(new_n286_));
  aoi21  g122(.a(new_n286_), .b(new_n190_), .c(new_n267_), .O(new_n287_));
  nor2   g123(.a(new_n189_), .b(x021), .O(new_n288_));
  oai21  g124(.a(new_n288_), .b(new_n228_), .c(x069), .O(new_n289_));
  inv1   g125(.a(new_n266_), .O(new_n290_));
  nand4  g126(.a(new_n290_), .b(new_n264_), .c(new_n193_), .d(x029), .O(new_n291_));
  aoi21  g127(.a(new_n291_), .b(new_n289_), .c(x077), .O(new_n292_));
  oai21  g128(.a(new_n292_), .b(new_n287_), .c(new_n188_), .O(new_n293_));
  nand2  g129(.a(new_n264_), .b(x029), .O(new_n294_));
  nand2  g130(.a(new_n294_), .b(new_n224_), .O(new_n295_));
  nand3  g131(.a(new_n295_), .b(new_n263_), .c(x037), .O(new_n296_));
  nand2  g132(.a(new_n296_), .b(new_n293_), .O(new_n297_));
  oai22  g133(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n298_));
  nand3  g134(.a(new_n298_), .b(x069), .c(x021), .O(new_n299_));
  aoi22  g135(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n300_));
  nand2  g136(.a(new_n300_), .b(new_n299_), .O(new_n301_));
  aoi21  g137(.a(new_n297_), .b(new_n214_), .c(new_n301_), .O(new_n302_));
  aoi21  g138(.a(new_n302_), .b(new_n283_), .c(x045), .O(z13));
  zero   g139(.O(z00));
  zero   g140(.O(z01));
  zero   g141(.O(z04));
  zero   g142(.O(z06));
