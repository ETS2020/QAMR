// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:55 2020
...
module FAU ( 
  ...
  inv1   g090(.a(new_n252_), .O(new_n253_));
  nor2   g091(.a(new_n253_), .b(x041), .O(z09));
  oai22  g092(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n255_));
  nand3  g093(.a(new_n255_), .b(x082), .c(x002), .O(new_n256_));
  oai22  g094(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n257_));
  nand3  g095(.a(new_n257_), .b(x066), .c(x018), .O(new_n258_));
  aoi22  g096(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n259_));
  nand3  g097(.a(new_n259_), .b(new_n258_), .c(new_n256_), .O(new_n260_));
  and2   g098(.a(new_n260_), .b(new_n159_), .O(z10));
  oai22  g099(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n262_));
  nand3  g100(.a(new_n262_), .b(x083), .c(x003), .O(new_n263_));
  oai22  g101(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n264_));
  nand3  g102(.a(new_n264_), .b(x067), .c(x019), .O(new_n265_));
  aoi22  g103(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n266_));
  nand3  g104(.a(new_n266_), .b(new_n265_), .c(new_n263_), .O(new_n267_));
  and2   g105(.a(new_n267_), .b(new_n172_), .O(z11));
  oai22  g106(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n269_));
  nand3  g107(.a(new_n269_), .b(x084), .c(x004), .O(new_n270_));
  oai22  g108(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n271_));
  nand3  g109(.a(new_n271_), .b(x068), .c(x020), .O(new_n272_));
  aoi22  g110(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n273_));
  nand3  g111(.a(new_n273_), .b(new_n272_), .c(new_n270_), .O(new_n274_));
  inv1   g112(.a(new_n274_), .O(new_n275_));
  nor2   g113(.a(new_n275_), .b(x044), .O(z12));
  inv1   g114(.a(x077), .O(new_n277_));
  nand2  g115(.a(x021), .b(x013), .O(new_n278_));
  oai21  g116(.a(new_n228_), .b(x029), .c(new_n278_), .O(new_n279_));
  nor2   g117(.a(x125), .b(x101), .O(new_n280_));
  nor2   g118(.a(x117), .b(x109), .O(new_n281_));
  oai21  g119(.a(new_n280_), .b(x093), .c(new_n281_), .O(new_n282_));
  nand2  g120(.a(new_n282_), .b(new_n218_), .O(new_n283_));
  oai21  g121(.a(new_n206_), .b(x109), .c(x037), .O(new_n284_));
  nand2  g122(.a(new_n284_), .b(x117), .O(new_n285_));
  inv1   g123(.a(x101), .O(new_n286_));
  oai21  g124(.a(new_n286_), .b(x061), .c(new_n201_), .O(new_n287_));
  nand3  g125(.a(x125), .b(new_n199_), .c(new_n191_), .O(new_n288_));
  nand2  g126(.a(new_n288_), .b(new_n214_), .O(new_n289_));
  aoi21  g127(.a(new_n287_), .b(new_n200_), .c(new_n289_), .O(new_n290_));
  nand4  g128(.a(new_n290_), .b(new_n285_), .c(new_n283_), .d(new_n279_), .O(new_n291_));
  nand4  g129(.a(x125), .b(new_n204_), .c(new_n200_), .d(x013), .O(new_n292_));
  inv1   g130(.a(new_n292_), .O(new_n293_));
  aoi21  g131(.a(new_n291_), .b(new_n277_), .c(new_n293_), .O(new_n294_));
  nand3  g132(.a(x085), .b(new_n200_), .c(new_n190_), .O(new_n295_));
  oai21  g133(.a(new_n294_), .b(x053), .c(new_n295_), .O(new_n296_));
  nand2  g134(.a(new_n296_), .b(x005), .O(new_n297_));
  nand2  g135(.a(new_n193_), .b(x029), .O(new_n298_));
  nand2  g136(.a(new_n298_), .b(new_n191_), .O(new_n299_));
  nand2  g137(.a(new_n299_), .b(new_n277_), .O(new_n300_));
  aoi21  g138(.a(new_n300_), .b(new_n190_), .c(new_n281_), .O(new_n301_));
  nor2   g139(.a(new_n189_), .b(x021), .O(new_n302_));
  oai21  g140(.a(new_n302_), .b(new_n228_), .c(x069), .O(new_n303_));
  inv1   g141(.a(new_n280_), .O(new_n304_));
  nand4  g142(.a(new_n304_), .b(new_n278_), .c(new_n193_), .d(x029), .O(new_n305_));
  aoi21  g143(.a(new_n305_), .b(new_n303_), .c(x077), .O(new_n306_));
  oai21  g144(.a(new_n306_), .b(new_n301_), .c(new_n188_), .O(new_n307_));
  nand2  g145(.a(new_n278_), .b(x029), .O(new_n308_));
  nand2  g146(.a(new_n308_), .b(new_n224_), .O(new_n309_));
  nand3  g147(.a(new_n309_), .b(new_n277_), .c(x037), .O(new_n310_));
  nand2  g148(.a(new_n310_), .b(new_n307_), .O(new_n311_));
  oai22  g149(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n312_));
  nand3  g150(.a(new_n312_), .b(x069), .c(x021), .O(new_n313_));
  aoi22  g151(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n314_));
  nand2  g152(.a(new_n314_), .b(new_n313_), .O(new_n315_));
  aoi21  g153(.a(new_n311_), .b(new_n214_), .c(new_n315_), .O(new_n316_));
  aoi21  g154(.a(new_n316_), .b(new_n297_), .c(x045), .O(z13));
  zero   g155(.O(z00));
  zero   g156(.O(z01));
  zero   g157(.O(z04));
  zero   g158(.O(z06));
