...
module FAU ( 
  ...
  oai22  g180(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n341_));
  nand3  g181(.a(new_n341_), .b(x084), .c(x004), .O(new_n342_));
  oai22  g182(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n343_));
  nand3  g183(.a(new_n343_), .b(x068), .c(x020), .O(new_n344_));
  aoi22  g184(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n345_));
  nand3  g185(.a(new_n345_), .b(new_n344_), .c(new_n342_), .O(new_n346_));
  and2   g186(.a(new_n346_), .b(new_n212_), .O(z12));
