...
module FAU ( 
  ...
  oai22  g155(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n318_));
  nand3  g156(.a(new_n318_), .b(x084), .c(x004), .O(new_n319_));
  oai22  g157(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n320_));
  nand3  g158(.a(new_n320_), .b(x068), .c(x020), .O(new_n321_));
  aoi22  g159(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n322_));
  nand3  g160(.a(new_n322_), .b(new_n321_), .c(new_n319_), .O(new_n323_));
  and2   g161(.a(new_n323_), .b(new_n188_), .O(z12));
