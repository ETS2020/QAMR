...
module FAU ( 
  ...
  oai21  g222(.a(new_n300_), .b(x030), .c(new_n384_), .O(new_n385_));
  ...
  nand2  g226(.a(new_n388_), .b(new_n297_), .O(new_n389_));
  oai21  g227(.a(new_n280_), .b(x110), .c(x038), .O(new_n390_));
  nand2  g228(.a(new_n390_), .b(x118), .O(new_n391_));
  inv1   g229(.a(x102), .O(new_n392_));
  oai21  g230(.a(new_n392_), .b(x062), .c(new_n270_), .O(new_n393_));
  nand3  g231(.a(x126), .b(new_n271_), .c(new_n264_), .O(new_n394_));
  nand2  g232(.a(new_n394_), .b(new_n288_), .O(new_n395_));
  aoi21  g233(.a(new_n393_), .b(new_n275_), .c(new_n395_), .O(new_n396_));
  nand4  g234(.a(new_n396_), .b(new_n391_), .c(new_n389_), .d(new_n385_), .O(new_n397_));
  nand4  g235(.a(x126), .b(new_n278_), .c(new_n275_), .d(x014), .O(new_n398_));
  inv1   g236(.a(new_n398_), .O(new_n399_));
  aoi21  g237(.a(new_n397_), .b(new_n296_), .c(new_n399_), .O(new_n400_));
  nand3  g238(.a(x086), .b(new_n275_), .c(new_n263_), .O(new_n401_));
  oai21  g239(.a(new_n400_), .b(x054), .c(new_n401_), .O(new_n402_));
  nand2  g240(.a(new_n402_), .b(x006), .O(new_n403_));
  nand2  g241(.a(new_n266_), .b(x030), .O(new_n404_));
  nand2  g242(.a(new_n404_), .b(new_n264_), .O(new_n405_));
  nand2  g243(.a(new_n405_), .b(new_n296_), .O(new_n406_));
  aoi21  g244(.a(new_n406_), .b(new_n263_), .c(new_n387_), .O(new_n407_));
  nor2   g245(.a(new_n262_), .b(x022), .O(new_n408_));
  oai21  g246(.a(new_n408_), .b(new_n300_), .c(x070), .O(new_n409_));
  inv1   g247(.a(new_n386_), .O(new_n410_));
  nand4  g248(.a(new_n410_), .b(new_n384_), .c(new_n266_), .d(x030), .O(new_n411_));
  aoi21  g249(.a(new_n411_), .b(new_n409_), .c(x078), .O(new_n412_));
  oai21  g250(.a(new_n412_), .b(new_n407_), .c(new_n261_), .O(new_n413_));
  nand2  g251(.a(new_n384_), .b(x030), .O(new_n414_));
  nand2  g252(.a(new_n414_), .b(new_n292_), .O(new_n415_));
  nand3  g253(.a(new_n415_), .b(new_n296_), .c(x038), .O(new_n416_));
  ...
  aoi21  g259(.a(new_n417_), .b(new_n288_), .c(new_n421_), .O(new_n422_));
