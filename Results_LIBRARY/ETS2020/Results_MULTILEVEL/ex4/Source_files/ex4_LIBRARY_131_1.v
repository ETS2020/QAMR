// Benchmark "FAU" written by ABC on Sat Jul 25 09:07:52 2020
...
module FAU ( 
  ...
  nand2  g163(.a(x022), .b(x014), .O(new_n327_));
  oai21  g164(.a(new_n243_), .b(x030), .c(new_n327_), .O(new_n328_));
  nor2   g165(.a(x126), .b(x102), .O(new_n329_));
  nor2   g166(.a(x118), .b(x110), .O(new_n330_));
  oai21  g167(.a(new_n329_), .b(x094), .c(new_n330_), .O(new_n331_));
  nand2  g168(.a(new_n331_), .b(new_n240_), .O(new_n332_));
  oai21  g169(.a(new_n223_), .b(x110), .c(x038), .O(new_n333_));
  nand2  g170(.a(new_n333_), .b(x118), .O(new_n334_));
  inv1   g171(.a(x102), .O(new_n335_));
  oai21  g172(.a(new_n335_), .b(x062), .c(new_n213_), .O(new_n336_));
  nand3  g173(.a(x126), .b(new_n214_), .c(new_n207_), .O(new_n337_));
  nand2  g174(.a(new_n337_), .b(new_n231_), .O(new_n338_));
  aoi21  g175(.a(new_n336_), .b(new_n218_), .c(new_n338_), .O(new_n339_));
  nand4  g176(.a(new_n339_), .b(new_n334_), .c(new_n332_), .d(new_n328_), .O(new_n340_));
  nand4  g177(.a(x126), .b(new_n221_), .c(new_n218_), .d(x014), .O(new_n341_));
  inv1   g178(.a(new_n341_), .O(new_n342_));
  aoi21  g179(.a(new_n340_), .b(new_n239_), .c(new_n342_), .O(new_n343_));
  nand3  g180(.a(x086), .b(new_n218_), .c(new_n206_), .O(new_n344_));
  oai21  g181(.a(new_n343_), .b(x054), .c(new_n344_), .O(new_n345_));
  nand2  g182(.a(new_n345_), .b(x006), .O(new_n346_));
  nand2  g183(.a(new_n209_), .b(x030), .O(new_n347_));
  nand2  g184(.a(new_n347_), .b(new_n207_), .O(new_n348_));
  nand2  g185(.a(new_n348_), .b(new_n239_), .O(new_n349_));
  aoi21  g186(.a(new_n349_), .b(new_n206_), .c(new_n330_), .O(new_n350_));
  nor2   g187(.a(new_n205_), .b(x022), .O(new_n351_));
  oai21  g188(.a(new_n351_), .b(new_n243_), .c(x070), .O(new_n352_));
  inv1   g189(.a(new_n329_), .O(new_n353_));
  nand4  g190(.a(new_n353_), .b(new_n327_), .c(new_n209_), .d(x030), .O(new_n354_));
  aoi21  g191(.a(new_n354_), .b(new_n352_), .c(x078), .O(new_n355_));
  oai21  g192(.a(new_n355_), .b(new_n350_), .c(new_n204_), .O(new_n356_));
  nand2  g193(.a(new_n327_), .b(x030), .O(new_n357_));
  nand2  g194(.a(new_n357_), .b(new_n235_), .O(new_n358_));
  nand3  g195(.a(new_n358_), .b(new_n239_), .c(x038), .O(new_n359_));
  nand2  g196(.a(new_n359_), .b(new_n356_), .O(new_n360_));
  oai22  g197(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n361_));
  nand3  g198(.a(new_n361_), .b(x070), .c(x022), .O(new_n362_));
  aoi22  g199(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n363_));
  nand2  g200(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  aoi21  g201(.a(new_n360_), .b(new_n231_), .c(new_n364_), .O(new_n365_));
  aoi21  g202(.a(new_n365_), .b(new_n346_), .c(x046), .O(z14));
  zero   g203(.O(z01));
  zero   g204(.O(z02));
  zero   g205(.O(z05));
  zero   g206(.O(z07));
