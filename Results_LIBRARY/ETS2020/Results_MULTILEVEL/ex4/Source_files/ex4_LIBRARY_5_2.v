// Benchmark "FAU" written by ABC on Sat Jul 25 09:05:28 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n240_, new_n241_, new_n242_, new_n250_, new_n251_, new_n252_,
  ...
  oai22  g084(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n250_));
  nand3  g085(.a(new_n250_), .b(x084), .c(x004), .O(new_n251_));
  oai22  g086(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n252_));
  nand3  g087(.a(new_n252_), .b(x068), .c(x020), .O(new_n253_));
  aoi22  g088(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n254_));
  nand3  g089(.a(new_n254_), .b(new_n253_), .c(new_n251_), .O(new_n255_));
  inv1   g090(.a(new_n255_), .O(new_n256_));
  nor2   g091(.a(new_n256_), .b(x044), .O(z12));
