// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:37 2020
...
module FAU ( 
  ...
  oai22  g167(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n328_));
  nand3  g168(.a(new_n328_), .b(x083), .c(x003), .O(new_n329_));
  oai22  g169(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n330_));
  nand3  g170(.a(new_n330_), .b(x067), .c(x019), .O(new_n331_));
  aoi22  g171(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n332_));
  nand3  g172(.a(new_n332_), .b(new_n331_), .c(new_n329_), .O(new_n333_));
  inv1   g173(.a(new_n333_), .O(new_n334_));
  nor2   g174(.a(new_n334_), .b(x043), .O(z11));
  nand2  g175(.a(x022), .b(x014), .O(new_n338_));
  oai21  g176(.a(new_n255_), .b(x030), .c(new_n338_), .O(new_n339_));
  nor2   g177(.a(x126), .b(x102), .O(new_n340_));
  nor2   g178(.a(x118), .b(x110), .O(new_n341_));
  oai21  g179(.a(new_n340_), .b(x094), .c(new_n341_), .O(new_n342_));
  nand2  g180(.a(new_n342_), .b(new_n252_), .O(new_n343_));
  oai21  g181(.a(new_n235_), .b(x110), .c(x038), .O(new_n344_));
  nand2  g182(.a(new_n344_), .b(x118), .O(new_n345_));
  inv1   g183(.a(x102), .O(new_n346_));
  oai21  g184(.a(new_n346_), .b(x062), .c(new_n225_), .O(new_n347_));
  nand3  g185(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n348_));
  nand2  g186(.a(new_n348_), .b(new_n243_), .O(new_n349_));
  aoi21  g187(.a(new_n347_), .b(new_n230_), .c(new_n349_), .O(new_n350_));
  nand4  g188(.a(new_n350_), .b(new_n345_), .c(new_n343_), .d(new_n339_), .O(new_n351_));
  nand4  g189(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n352_));
  inv1   g190(.a(new_n352_), .O(new_n353_));
  aoi21  g191(.a(new_n351_), .b(new_n251_), .c(new_n353_), .O(new_n354_));
  nand3  g192(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n355_));
  oai21  g193(.a(new_n354_), .b(x054), .c(new_n355_), .O(new_n356_));
  nand2  g194(.a(new_n356_), .b(x006), .O(new_n357_));
  nand2  g195(.a(new_n221_), .b(x030), .O(new_n358_));
  nand2  g196(.a(new_n358_), .b(new_n219_), .O(new_n359_));
  nand2  g197(.a(new_n359_), .b(new_n251_), .O(new_n360_));
  aoi21  g198(.a(new_n360_), .b(new_n218_), .c(new_n341_), .O(new_n361_));
  nor2   g199(.a(new_n217_), .b(x022), .O(new_n362_));
  oai21  g200(.a(new_n362_), .b(new_n255_), .c(x070), .O(new_n363_));
  inv1   g201(.a(new_n340_), .O(new_n364_));
  nand4  g202(.a(new_n364_), .b(new_n338_), .c(new_n221_), .d(x030), .O(new_n365_));
  aoi21  g203(.a(new_n365_), .b(new_n363_), .c(x078), .O(new_n366_));
  oai21  g204(.a(new_n366_), .b(new_n361_), .c(new_n216_), .O(new_n367_));
  nand2  g205(.a(new_n338_), .b(x030), .O(new_n368_));
  nand2  g206(.a(new_n368_), .b(new_n247_), .O(new_n369_));
  nand3  g207(.a(new_n369_), .b(new_n251_), .c(x038), .O(new_n370_));
  nand2  g208(.a(new_n370_), .b(new_n367_), .O(new_n371_));
  oai22  g209(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n372_));
  nand3  g210(.a(new_n372_), .b(x070), .c(x022), .O(new_n373_));
  aoi22  g211(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n374_));
  nand2  g212(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  aoi21  g213(.a(new_n371_), .b(new_n243_), .c(new_n375_), .O(new_n376_));
  aoi21  g214(.a(new_n376_), .b(new_n357_), .c(x046), .O(z14));
  zero   g215(.O(z03));
  zero   g216(.O(z05));
  zero   g217(.O(z07));
  zero   g218(.O(z10));
