// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:28 2020
...
module FAU ( 
  ...
  aoi22  g222(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n382_));
  nand3  g223(.a(new_n382_), .b(new_n381_), .c(new_n379_), .O(new_n383_));
  inv1   g224(.a(new_n383_), .O(new_n384_));
  nor2   g225(.a(new_n384_), .b(x042), .O(z10));
  oai22  g226(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n386_));
  nand3  g227(.a(new_n386_), .b(x083), .c(x003), .O(new_n387_));
  oai22  g228(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n388_));
  nand3  g229(.a(new_n388_), .b(x067), .c(x019), .O(new_n389_));
  aoi22  g230(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n390_));
  nand3  g231(.a(new_n390_), .b(new_n389_), .c(new_n387_), .O(new_n391_));
  and2   g232(.a(new_n391_), .b(new_n187_), .O(z11));
  inv1   g233(.a(x077), .O(new_n394_));
  nand2  g234(.a(x021), .b(x013), .O(new_n395_));
  oai21  g235(.a(new_n255_), .b(x029), .c(new_n395_), .O(new_n396_));
  nor2   g236(.a(x125), .b(x101), .O(new_n397_));
  nor2   g237(.a(x117), .b(x109), .O(new_n398_));
  oai21  g238(.a(new_n397_), .b(x093), .c(new_n398_), .O(new_n399_));
  nand2  g239(.a(new_n399_), .b(new_n245_), .O(new_n400_));
  oai21  g240(.a(new_n233_), .b(x109), .c(x037), .O(new_n401_));
  nand2  g241(.a(new_n401_), .b(x117), .O(new_n402_));
  inv1   g242(.a(x101), .O(new_n403_));
  oai21  g243(.a(new_n403_), .b(x061), .c(new_n228_), .O(new_n404_));
  nand3  g244(.a(x125), .b(new_n226_), .c(new_n218_), .O(new_n405_));
  nand2  g245(.a(new_n405_), .b(new_n241_), .O(new_n406_));
  aoi21  g246(.a(new_n404_), .b(new_n227_), .c(new_n406_), .O(new_n407_));
  nand4  g247(.a(new_n407_), .b(new_n402_), .c(new_n400_), .d(new_n396_), .O(new_n408_));
  nand4  g248(.a(x125), .b(new_n231_), .c(new_n227_), .d(x013), .O(new_n409_));
  inv1   g249(.a(new_n409_), .O(new_n410_));
  aoi21  g250(.a(new_n408_), .b(new_n394_), .c(new_n410_), .O(new_n411_));
  nand3  g251(.a(x085), .b(new_n227_), .c(new_n217_), .O(new_n412_));
  oai21  g252(.a(new_n411_), .b(x053), .c(new_n412_), .O(new_n413_));
  nand2  g253(.a(new_n413_), .b(x005), .O(new_n414_));
  nand2  g254(.a(new_n220_), .b(x029), .O(new_n415_));
  nand2  g255(.a(new_n415_), .b(new_n218_), .O(new_n416_));
  nand2  g256(.a(new_n416_), .b(new_n394_), .O(new_n417_));
  aoi21  g257(.a(new_n417_), .b(new_n217_), .c(new_n398_), .O(new_n418_));
  nor2   g258(.a(new_n216_), .b(x021), .O(new_n419_));
  oai21  g259(.a(new_n419_), .b(new_n255_), .c(x069), .O(new_n420_));
  inv1   g260(.a(new_n397_), .O(new_n421_));
  nand4  g261(.a(new_n421_), .b(new_n395_), .c(new_n220_), .d(x029), .O(new_n422_));
  aoi21  g262(.a(new_n422_), .b(new_n420_), .c(x077), .O(new_n423_));
  oai21  g263(.a(new_n423_), .b(new_n418_), .c(new_n215_), .O(new_n424_));
  nand2  g264(.a(new_n395_), .b(x029), .O(new_n425_));
  nand2  g265(.a(new_n425_), .b(new_n251_), .O(new_n426_));
  nand3  g266(.a(new_n426_), .b(new_n394_), .c(x037), .O(new_n427_));
  ...
  aoi21  g272(.a(new_n428_), .b(new_n241_), .c(new_n432_), .O(new_n433_));
  aoi21  g273(.a(new_n433_), .b(new_n414_), .c(x045), .O(z13));
  nand2  g274(.a(x022), .b(x014), .O(new_n435_));
  oai21  g275(.a(new_n312_), .b(x030), .c(new_n435_), .O(new_n436_));
  nor2   g276(.a(x126), .b(x102), .O(new_n437_));
  nor2   g277(.a(x118), .b(x110), .O(new_n438_));
  oai21  g278(.a(new_n437_), .b(x094), .c(new_n438_), .O(new_n439_));
  nand2  g279(.a(new_n439_), .b(new_n309_), .O(new_n440_));
  oai21  g280(.a(new_n292_), .b(x110), .c(x038), .O(new_n441_));
  nand2  g281(.a(new_n441_), .b(x118), .O(new_n442_));
  inv1   g282(.a(x102), .O(new_n443_));
  oai21  g283(.a(new_n443_), .b(x062), .c(new_n282_), .O(new_n444_));
  nand3  g284(.a(x126), .b(new_n283_), .c(new_n276_), .O(new_n445_));
  nand2  g285(.a(new_n445_), .b(new_n300_), .O(new_n446_));
  aoi21  g286(.a(new_n444_), .b(new_n287_), .c(new_n446_), .O(new_n447_));
  nand4  g287(.a(new_n447_), .b(new_n442_), .c(new_n440_), .d(new_n436_), .O(new_n448_));
  nand4  g288(.a(x126), .b(new_n290_), .c(new_n287_), .d(x014), .O(new_n449_));
  inv1   g289(.a(new_n449_), .O(new_n450_));
  aoi21  g290(.a(new_n448_), .b(new_n308_), .c(new_n450_), .O(new_n451_));
  nand3  g291(.a(x086), .b(new_n287_), .c(new_n275_), .O(new_n452_));
  oai21  g292(.a(new_n451_), .b(x054), .c(new_n452_), .O(new_n453_));
  nand2  g293(.a(new_n453_), .b(x006), .O(new_n454_));
  nand2  g294(.a(new_n278_), .b(x030), .O(new_n455_));
  nand2  g295(.a(new_n455_), .b(new_n276_), .O(new_n456_));
  nand2  g296(.a(new_n456_), .b(new_n308_), .O(new_n457_));
  aoi21  g297(.a(new_n457_), .b(new_n275_), .c(new_n438_), .O(new_n458_));
  nor2   g298(.a(new_n274_), .b(x022), .O(new_n459_));
  oai21  g299(.a(new_n459_), .b(new_n312_), .c(x070), .O(new_n460_));
  inv1   g300(.a(new_n437_), .O(new_n461_));
  nand4  g301(.a(new_n461_), .b(new_n435_), .c(new_n278_), .d(x030), .O(new_n462_));
  aoi21  g302(.a(new_n462_), .b(new_n460_), .c(x078), .O(new_n463_));
  oai21  g303(.a(new_n463_), .b(new_n458_), .c(new_n273_), .O(new_n464_));
  nand2  g304(.a(new_n435_), .b(x030), .O(new_n465_));
  nand2  g305(.a(new_n465_), .b(new_n304_), .O(new_n466_));
  nand3  g306(.a(new_n466_), .b(new_n308_), .c(x038), .O(new_n467_));
  ...
  aoi22  g310(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n471_));
  nand2  g311(.a(new_n471_), .b(new_n470_), .O(new_n472_));
  aoi21  g312(.a(new_n468_), .b(new_n300_), .c(new_n472_), .O(new_n473_));
  aoi21  g313(.a(new_n473_), .b(new_n454_), .c(x046), .O(z14));
  zero   g314(.O(z02));
  zero   g315(.O(z07));
  zero   g316(.O(z09));
  zero   g317(.O(z12));
