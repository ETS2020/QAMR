...
module FAU ( 
  ...
  nand2  g167(.a(x022), .b(x014), .O(new_n331_));
  oai21  g168(.a(new_n255_), .b(x030), .c(new_n331_), .O(new_n332_));
  nor2   g169(.a(x126), .b(x102), .O(new_n333_));
  nor2   g170(.a(x118), .b(x110), .O(new_n334_));
  oai21  g171(.a(new_n333_), .b(x094), .c(new_n334_), .O(new_n335_));
  nand2  g172(.a(new_n335_), .b(new_n252_), .O(new_n336_));
  oai21  g173(.a(new_n235_), .b(x110), .c(x038), .O(new_n337_));
  nand2  g174(.a(new_n337_), .b(x118), .O(new_n338_));
  inv1   g175(.a(x102), .O(new_n339_));
  oai21  g176(.a(new_n339_), .b(x062), .c(new_n225_), .O(new_n340_));
  nand3  g177(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n341_));
  nand2  g178(.a(new_n341_), .b(new_n243_), .O(new_n342_));
  aoi21  g179(.a(new_n340_), .b(new_n230_), .c(new_n342_), .O(new_n343_));
  nand4  g180(.a(new_n343_), .b(new_n338_), .c(new_n336_), .d(new_n332_), .O(new_n344_));
  nand4  g181(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n345_));
  inv1   g182(.a(new_n345_), .O(new_n346_));
  aoi21  g183(.a(new_n344_), .b(new_n251_), .c(new_n346_), .O(new_n347_));
  nand3  g184(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n348_));
  oai21  g185(.a(new_n347_), .b(x054), .c(new_n348_), .O(new_n349_));
  nand2  g186(.a(new_n349_), .b(x006), .O(new_n350_));
  nand2  g187(.a(new_n221_), .b(x030), .O(new_n351_));
  nand2  g188(.a(new_n351_), .b(new_n219_), .O(new_n352_));
  nand2  g189(.a(new_n352_), .b(new_n251_), .O(new_n353_));
  aoi21  g190(.a(new_n353_), .b(new_n218_), .c(new_n334_), .O(new_n354_));
  nor2   g191(.a(new_n217_), .b(x022), .O(new_n355_));
  oai21  g192(.a(new_n355_), .b(new_n255_), .c(x070), .O(new_n356_));
  inv1   g193(.a(new_n333_), .O(new_n357_));
  nand4  g194(.a(new_n357_), .b(new_n331_), .c(new_n221_), .d(x030), .O(new_n358_));
  aoi21  g195(.a(new_n358_), .b(new_n356_), .c(x078), .O(new_n359_));
  oai21  g196(.a(new_n359_), .b(new_n354_), .c(new_n216_), .O(new_n360_));
  nand2  g197(.a(new_n331_), .b(x030), .O(new_n361_));
  nand2  g198(.a(new_n361_), .b(new_n247_), .O(new_n362_));
  nand3  g199(.a(new_n362_), .b(new_n251_), .c(x038), .O(new_n363_));
  nand2  g200(.a(new_n363_), .b(new_n360_), .O(new_n364_));
  oai22  g201(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n365_));
  nand3  g202(.a(new_n365_), .b(x070), .c(x022), .O(new_n366_));
  aoi22  g203(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n367_));
  nand2  g204(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  aoi21  g205(.a(new_n364_), .b(new_n243_), .c(new_n368_), .O(new_n369_));
  aoi21  g206(.a(new_n369_), .b(new_n350_), .c(x046), .O(z14));
  zero   g207(.O(z01));
  zero   g208(.O(z05));
  zero   g209(.O(z07));
  zero   g210(.O(z09));
