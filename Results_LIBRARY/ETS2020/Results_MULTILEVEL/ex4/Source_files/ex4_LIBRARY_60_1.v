// Benchmark "FAU" written by ABC on Sat Jul 25 09:06:30 2020
...
module FAU ( 
  ...
  and2   g166(.a(new_n326_), .b(new_n174_), .O(z10));
  oai22  g167(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n329_));
  nand3  g168(.a(new_n329_), .b(x084), .c(x004), .O(new_n330_));
  oai22  g169(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n331_));
  nand3  g170(.a(new_n331_), .b(x068), .c(x020), .O(new_n332_));
  aoi22  g171(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n333_));
  nand3  g172(.a(new_n333_), .b(new_n332_), .c(new_n330_), .O(new_n334_));
  and2   g173(.a(new_n334_), .b(new_n200_), .O(z12));
  nand2  g174(.a(x022), .b(x014), .O(new_n337_));
  oai21  g175(.a(new_n255_), .b(x030), .c(new_n337_), .O(new_n338_));
  nor2   g176(.a(x126), .b(x102), .O(new_n339_));
  nor2   g177(.a(x118), .b(x110), .O(new_n340_));
  oai21  g178(.a(new_n339_), .b(x094), .c(new_n340_), .O(new_n341_));
  nand2  g179(.a(new_n341_), .b(new_n252_), .O(new_n342_));
  oai21  g180(.a(new_n235_), .b(x110), .c(x038), .O(new_n343_));
  nand2  g181(.a(new_n343_), .b(x118), .O(new_n344_));
  inv1   g182(.a(x102), .O(new_n345_));
  oai21  g183(.a(new_n345_), .b(x062), .c(new_n225_), .O(new_n346_));
  nand3  g184(.a(x126), .b(new_n226_), .c(new_n219_), .O(new_n347_));
  nand2  g185(.a(new_n347_), .b(new_n243_), .O(new_n348_));
  aoi21  g186(.a(new_n346_), .b(new_n230_), .c(new_n348_), .O(new_n349_));
  nand4  g187(.a(new_n349_), .b(new_n344_), .c(new_n342_), .d(new_n338_), .O(new_n350_));
  nand4  g188(.a(x126), .b(new_n233_), .c(new_n230_), .d(x014), .O(new_n351_));
  inv1   g189(.a(new_n351_), .O(new_n352_));
  aoi21  g190(.a(new_n350_), .b(new_n251_), .c(new_n352_), .O(new_n353_));
  nand3  g191(.a(x086), .b(new_n230_), .c(new_n218_), .O(new_n354_));
  oai21  g192(.a(new_n353_), .b(x054), .c(new_n354_), .O(new_n355_));
  nand2  g193(.a(new_n355_), .b(x006), .O(new_n356_));
  nand2  g194(.a(new_n221_), .b(x030), .O(new_n357_));
  nand2  g195(.a(new_n357_), .b(new_n219_), .O(new_n358_));
  nand2  g196(.a(new_n358_), .b(new_n251_), .O(new_n359_));
  aoi21  g197(.a(new_n359_), .b(new_n218_), .c(new_n340_), .O(new_n360_));
  nor2   g198(.a(new_n217_), .b(x022), .O(new_n361_));
  oai21  g199(.a(new_n361_), .b(new_n255_), .c(x070), .O(new_n362_));
  inv1   g200(.a(new_n339_), .O(new_n363_));
  nand4  g201(.a(new_n363_), .b(new_n337_), .c(new_n221_), .d(x030), .O(new_n364_));
  aoi21  g202(.a(new_n364_), .b(new_n362_), .c(x078), .O(new_n365_));
  oai21  g203(.a(new_n365_), .b(new_n360_), .c(new_n216_), .O(new_n366_));
  nand2  g204(.a(new_n337_), .b(x030), .O(new_n367_));
  nand2  g205(.a(new_n367_), .b(new_n247_), .O(new_n368_));
  nand3  g206(.a(new_n368_), .b(new_n251_), .c(x038), .O(new_n369_));
  nand2  g207(.a(new_n369_), .b(new_n366_), .O(new_n370_));
  ...
  aoi21  g212(.a(new_n370_), .b(new_n243_), .c(new_n374_), .O(new_n375_));
  aoi21  g213(.a(new_n375_), .b(new_n356_), .c(x046), .O(z14));
  zero   g214(.O(z01));
  zero   g215(.O(z05));
  zero   g216(.O(z07));
  zero   g217(.O(z09));
