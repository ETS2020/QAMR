// Benchmark "FAU" written by ABC on Sat Jul 25 20:45:06 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n411_, new_n412_, new_n413_, new_n414_, new_n415_, new_n423_,
  ...
  inv1   g243(.a(x64), .O(new_n338_));
  nand2  g244(.a(new_n230_), .b(x22), .O(new_n339_));
  nand2  g245(.a(x74), .b(x17), .O(new_n340_));
  nand2  g246(.a(new_n228_), .b(x18), .O(new_n341_));
  aoi21  g247(.a(new_n341_), .b(new_n340_), .c(x73), .O(new_n342_));
  nand3  g248(.a(new_n228_), .b(x73), .c(x16), .O(new_n343_));
  inv1   g249(.a(new_n343_), .O(new_n344_));
  oai21  g250(.a(new_n344_), .b(new_n342_), .c(x72), .O(new_n345_));
  nand2  g251(.a(x74), .b(x19), .O(new_n346_));
  nand2  g252(.a(new_n228_), .b(x20), .O(new_n347_));
  aoi21  g253(.a(new_n347_), .b(new_n346_), .c(new_n227_), .O(new_n348_));
  nand3  g254(.a(x74), .b(new_n227_), .c(x21), .O(new_n349_));
  inv1   g255(.a(new_n349_), .O(new_n350_));
  oai21  g256(.a(new_n350_), .b(new_n348_), .c(new_n226_), .O(new_n351_));
  nand3  g257(.a(new_n351_), .b(new_n345_), .c(new_n339_), .O(new_n352_));
  nand2  g258(.a(new_n352_), .b(new_n147_), .O(new_n353_));
  nand2  g259(.a(new_n230_), .b(x54), .O(new_n354_));
  nand2  g260(.a(x74), .b(x49), .O(new_n355_));
  nand2  g261(.a(new_n228_), .b(x50), .O(new_n356_));
  aoi21  g262(.a(new_n356_), .b(new_n355_), .c(x73), .O(new_n357_));
  nand3  g263(.a(new_n228_), .b(x73), .c(x48), .O(new_n358_));
  inv1   g264(.a(new_n358_), .O(new_n359_));
  oai21  g265(.a(new_n359_), .b(new_n357_), .c(x72), .O(new_n360_));
  nand2  g266(.a(x74), .b(x51), .O(new_n361_));
  nand2  g267(.a(new_n228_), .b(x52), .O(new_n362_));
  aoi21  g268(.a(new_n362_), .b(new_n361_), .c(new_n227_), .O(new_n363_));
  nand3  g269(.a(x74), .b(new_n227_), .c(x53), .O(new_n364_));
  inv1   g270(.a(new_n364_), .O(new_n365_));
  oai21  g271(.a(new_n365_), .b(new_n363_), .c(new_n226_), .O(new_n366_));
  nand3  g272(.a(new_n366_), .b(new_n360_), .c(new_n354_), .O(new_n367_));
  nand3  g273(.a(new_n367_), .b(x71), .c(x70), .O(new_n368_));
  nand2  g274(.a(new_n368_), .b(new_n353_), .O(new_n369_));
  nand3  g275(.a(new_n369_), .b(x69), .c(new_n144_), .O(new_n370_));
  nand3  g276(.a(new_n367_), .b(new_n131_), .c(new_n111_), .O(new_n371_));
  inv1   g277(.a(new_n371_), .O(new_n372_));
  nand3  g278(.a(new_n372_), .b(new_n155_), .c(x68), .O(new_n373_));
  aoi21  g279(.a(new_n373_), .b(new_n370_), .c(new_n143_), .O(new_n374_));
  inv1   g280(.a(x00), .O(new_n375_));
  nand4  g281(.a(new_n181_), .b(new_n180_), .c(new_n186_), .d(new_n271_), .O(new_n376_));
  oai21  g282(.a(new_n376_), .b(x07), .c(new_n100_), .O(new_n377_));
  nand2  g283(.a(x06), .b(new_n375_), .O(new_n378_));
  oai21  g284(.a(new_n377_), .b(new_n375_), .c(new_n378_), .O(new_n379_));
  nand3  g285(.a(new_n379_), .b(x71), .c(new_n111_), .O(new_n380_));
  nand4  g286(.a(new_n205_), .b(new_n204_), .c(new_n210_), .d(new_n282_), .O(new_n381_));
  oai21  g287(.a(new_n381_), .b(x39), .c(new_n120_), .O(new_n382_));
  nand2  g288(.a(x38), .b(new_n158_), .O(new_n383_));
  oai21  g289(.a(new_n382_), .b(new_n158_), .c(new_n383_), .O(new_n384_));
  nand3  g290(.a(new_n384_), .b(new_n131_), .c(x70), .O(new_n385_));
  nand2  g291(.a(new_n385_), .b(new_n380_), .O(new_n386_));
  nand4  g292(.a(new_n386_), .b(new_n155_), .c(x68), .d(new_n143_), .O(new_n387_));
  inv1   g293(.a(new_n387_), .O(new_n388_));
  oai21  g294(.a(new_n388_), .b(new_n374_), .c(new_n94_), .O(new_n389_));
  nand3  g295(.a(new_n386_), .b(new_n155_), .c(x68), .O(new_n390_));
  inv1   g296(.a(new_n390_), .O(new_n391_));
  nand4  g297(.a(new_n391_), .b(new_n93_), .c(new_n92_), .d(x65), .O(new_n392_));
  nand2  g298(.a(new_n392_), .b(new_n389_), .O(new_n393_));
  nand2  g299(.a(new_n393_), .b(new_n338_), .O(new_n394_));
  nand2  g300(.a(new_n156_), .b(x06), .O(new_n395_));
  inv1   g301(.a(x22), .O(new_n396_));
  oai22  g302(.a(new_n159_), .b(new_n396_), .c(new_n131_), .d(new_n120_), .O(new_n397_));
  nand2  g303(.a(new_n397_), .b(x70), .O(new_n398_));
  nand3  g304(.a(new_n136_), .b(x69), .c(x54), .O(new_n399_));
  nand3  g305(.a(new_n399_), .b(new_n398_), .c(new_n395_), .O(new_n400_));
  nand2  g306(.a(new_n400_), .b(x67), .O(new_n401_));
  nand3  g307(.a(new_n369_), .b(x69), .c(new_n93_), .O(new_n402_));
  aoi21  g308(.a(new_n402_), .b(new_n401_), .c(x68), .O(new_n403_));
  nand2  g309(.a(new_n367_), .b(new_n93_), .O(new_n404_));
  nand2  g310(.a(x67), .b(x38), .O(new_n405_));
  nand2  g311(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  nand4  g312(.a(new_n406_), .b(new_n131_), .c(new_n111_), .d(new_n155_), .O(new_n407_));
  nor2   g313(.a(new_n407_), .b(new_n144_), .O(new_n408_));
  oai21  g314(.a(new_n408_), .b(new_n403_), .c(new_n92_), .O(new_n409_));
  nand2  g315(.a(new_n400_), .b(new_n144_), .O(new_n410_));
  nand3  g316(.a(new_n164_), .b(x68), .c(x38), .O(new_n411_));
  nand2  g317(.a(new_n411_), .b(new_n410_), .O(new_n412_));
  nand3  g318(.a(new_n412_), .b(new_n93_), .c(x66), .O(new_n413_));
  nand2  g319(.a(new_n413_), .b(new_n409_), .O(new_n414_));
  nand3  g320(.a(new_n414_), .b(new_n143_), .c(x64), .O(new_n415_));
  nand2  g321(.a(new_n415_), .b(new_n394_), .O(z06));
  oai21  g322(.a(x15), .b(x14), .c(new_n190_), .O(new_n423_));
  oai21  g323(.a(new_n181_), .b(new_n375_), .c(x13), .O(new_n424_));
  oai21  g324(.a(new_n423_), .b(new_n375_), .c(new_n424_), .O(new_n425_));
  nand3  g325(.a(new_n425_), .b(x71), .c(new_n143_), .O(new_n426_));
  nand2  g326(.a(new_n230_), .b(x61), .O(new_n427_));
  nand2  g327(.a(x74), .b(x56), .O(new_n428_));
  nand2  g328(.a(new_n228_), .b(x57), .O(new_n429_));
  aoi21  g329(.a(new_n429_), .b(new_n428_), .c(x73), .O(new_n430_));
  nand3  g330(.a(new_n228_), .b(x73), .c(x53), .O(new_n431_));
  inv1   g331(.a(new_n431_), .O(new_n432_));
  oai21  g332(.a(new_n432_), .b(new_n430_), .c(x72), .O(new_n433_));
  nand2  g333(.a(x74), .b(x58), .O(new_n434_));
  nand2  g334(.a(new_n228_), .b(x59), .O(new_n435_));
  aoi21  g335(.a(new_n435_), .b(new_n434_), .c(new_n227_), .O(new_n436_));
  nand3  g336(.a(x74), .b(new_n227_), .c(x60), .O(new_n437_));
  inv1   g337(.a(new_n437_), .O(new_n438_));
  oai21  g338(.a(new_n438_), .b(new_n436_), .c(new_n226_), .O(new_n439_));
  nand3  g339(.a(new_n439_), .b(new_n433_), .c(new_n427_), .O(new_n440_));
  nand3  g340(.a(new_n440_), .b(new_n131_), .c(x65), .O(new_n441_));
  nand2  g341(.a(new_n441_), .b(new_n426_), .O(new_n442_));
  nand3  g342(.a(new_n442_), .b(new_n155_), .c(x68), .O(new_n443_));
  nand2  g343(.a(new_n230_), .b(x29), .O(new_n444_));
  nand2  g344(.a(x74), .b(x24), .O(new_n445_));
  nand2  g345(.a(new_n228_), .b(x25), .O(new_n446_));
  aoi21  g346(.a(new_n446_), .b(new_n445_), .c(x73), .O(new_n447_));
  nand3  g347(.a(new_n228_), .b(x73), .c(x21), .O(new_n448_));
  inv1   g348(.a(new_n448_), .O(new_n449_));
  oai21  g349(.a(new_n449_), .b(new_n447_), .c(x72), .O(new_n450_));
  nand2  g350(.a(x74), .b(x26), .O(new_n451_));
  nand2  g351(.a(new_n228_), .b(x27), .O(new_n452_));
  aoi21  g352(.a(new_n452_), .b(new_n451_), .c(new_n227_), .O(new_n453_));
  nand3  g353(.a(x74), .b(new_n227_), .c(x28), .O(new_n454_));
  inv1   g354(.a(new_n454_), .O(new_n455_));
  oai21  g355(.a(new_n455_), .b(new_n453_), .c(new_n226_), .O(new_n456_));
  nand3  g356(.a(new_n456_), .b(new_n450_), .c(new_n444_), .O(new_n457_));
  nand3  g357(.a(new_n457_), .b(x71), .c(x69), .O(new_n458_));
  inv1   g358(.a(new_n458_), .O(new_n459_));
  nand3  g359(.a(new_n459_), .b(new_n144_), .c(x65), .O(new_n460_));
  aoi21  g360(.a(new_n460_), .b(new_n443_), .c(x70), .O(new_n461_));
  inv1   g361(.a(x29), .O(new_n462_));
  nand2  g362(.a(x71), .b(x61), .O(new_n463_));
  oai21  g363(.a(x71), .b(new_n462_), .c(new_n463_), .O(new_n464_));
  nand2  g364(.a(new_n464_), .b(new_n230_), .O(new_n465_));
  nand2  g365(.a(new_n439_), .b(new_n433_), .O(new_n466_));
  nand2  g366(.a(new_n466_), .b(x71), .O(new_n467_));
  nand2  g367(.a(new_n456_), .b(new_n450_), .O(new_n468_));
  nand2  g368(.a(new_n468_), .b(new_n131_), .O(new_n469_));
  nand3  g369(.a(new_n469_), .b(new_n467_), .c(new_n465_), .O(new_n470_));
  nand4  g370(.a(new_n470_), .b(x69), .c(new_n144_), .d(x65), .O(new_n471_));
  nor2   g371(.a(new_n205_), .b(x45), .O(new_n472_));
  nand2  g372(.a(new_n472_), .b(x32), .O(new_n473_));
  oai21  g373(.a(new_n205_), .b(new_n158_), .c(x45), .O(new_n474_));
  aoi21  g374(.a(new_n474_), .b(new_n473_), .c(x71), .O(new_n475_));
  nand4  g375(.a(new_n475_), .b(new_n155_), .c(x68), .d(new_n143_), .O(new_n476_));
  aoi21  g376(.a(new_n476_), .b(new_n471_), .c(new_n111_), .O(new_n477_));
  oai21  g377(.a(new_n477_), .b(new_n461_), .c(new_n94_), .O(new_n478_));
  nand3  g378(.a(new_n425_), .b(x71), .c(new_n111_), .O(new_n479_));
  nand2  g379(.a(new_n475_), .b(x70), .O(new_n480_));
  nand2  g380(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  nand4  g381(.a(new_n481_), .b(new_n155_), .c(x68), .d(new_n93_), .O(new_n482_));
  inv1   g382(.a(new_n482_), .O(new_n483_));
  nand3  g383(.a(new_n483_), .b(new_n92_), .c(x65), .O(new_n484_));
  nand2  g384(.a(new_n484_), .b(new_n478_), .O(new_n485_));
  nand2  g385(.a(new_n485_), .b(new_n338_), .O(new_n486_));
  nand2  g386(.a(new_n156_), .b(x13), .O(new_n487_));
  oai22  g387(.a(new_n159_), .b(new_n462_), .c(new_n131_), .d(new_n214_), .O(new_n488_));
  nand2  g388(.a(new_n488_), .b(x70), .O(new_n489_));
  nand3  g389(.a(new_n136_), .b(x69), .c(x61), .O(new_n490_));
  nand3  g390(.a(new_n490_), .b(new_n489_), .c(new_n487_), .O(new_n491_));
  nand2  g391(.a(new_n491_), .b(x67), .O(new_n492_));
  nand2  g392(.a(new_n457_), .b(new_n147_), .O(new_n493_));
  nand3  g393(.a(new_n440_), .b(x71), .c(x70), .O(new_n494_));
  nand2  g394(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand3  g395(.a(new_n495_), .b(x69), .c(new_n93_), .O(new_n496_));
  aoi21  g396(.a(new_n496_), .b(new_n492_), .c(x68), .O(new_n497_));
  nand2  g397(.a(new_n440_), .b(new_n93_), .O(new_n498_));
  nand2  g398(.a(x67), .b(x45), .O(new_n499_));
  nand2  g399(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  nand4  g400(.a(new_n500_), .b(new_n131_), .c(new_n111_), .d(new_n155_), .O(new_n501_));
  nor2   g401(.a(new_n501_), .b(new_n144_), .O(new_n502_));
  oai21  g402(.a(new_n502_), .b(new_n497_), .c(new_n92_), .O(new_n503_));
  nand2  g403(.a(new_n491_), .b(new_n144_), .O(new_n504_));
  nand3  g404(.a(new_n164_), .b(x68), .c(x45), .O(new_n505_));
  nand2  g405(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  nand3  g406(.a(new_n506_), .b(new_n93_), .c(x66), .O(new_n507_));
  nand2  g407(.a(new_n507_), .b(new_n503_), .O(new_n508_));
  nand3  g408(.a(new_n508_), .b(new_n143_), .c(x64), .O(new_n509_));
  nand2  g409(.a(new_n509_), .b(new_n486_), .O(z13));
  zero   g410(.O(z03));
  zero   g411(.O(z04));
  zero   g412(.O(z05));
  zero   g413(.O(z07));
