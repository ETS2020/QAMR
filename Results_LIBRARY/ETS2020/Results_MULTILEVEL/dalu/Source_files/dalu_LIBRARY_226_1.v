...
module FAU ( 
  ...
  nand2  g1056(.a(new_n153_), .b(x15), .O(new_n1149_));
  inv1   g1057(.a(x31), .O(new_n1150_));
  inv1   g1058(.a(x47), .O(new_n1151_));
  oai22  g1059(.a(new_n156_), .b(new_n1150_), .c(new_n126_), .d(new_n1151_), .O(new_n1152_));
  nand2  g1060(.a(new_n1152_), .b(x70), .O(new_n1153_));
  nand3  g1061(.a(new_n131_), .b(x69), .c(x63), .O(new_n1154_));
  nand3  g1062(.a(new_n1154_), .b(new_n1153_), .c(new_n1149_), .O(new_n1155_));
  nand2  g1063(.a(new_n1155_), .b(x67), .O(new_n1156_));
  nand2  g1064(.a(new_n214_), .b(x31), .O(new_n1157_));
  aoi21  g1065(.a(new_n1090_), .b(new_n1089_), .c(x73), .O(new_n1158_));
  ...
  aoi21  g1078(.a(new_n1075_), .b(new_n1074_), .c(x73), .O(new_n1171_));
  ...
  inv1   g1105(.a(x15), .O(new_n1198_));
  oai22  g1106(.a(new_n127_), .b(new_n1151_), .c(new_n109_), .d(new_n1198_), .O(new_n1199_));
  nand4  g1107(.a(new_n1199_), .b(new_n136_), .c(new_n135_), .d(x65), .O(new_n1200_));
  nand2  g1108(.a(new_n1200_), .b(new_n1197_), .O(new_n1201_));
  nand2  g1109(.a(new_n1201_), .b(new_n409_), .O(new_n1202_));
  nand2  g1110(.a(new_n238_), .b(x47), .O(new_n1203_));
  nand3  g1111(.a(new_n1181_), .b(new_n136_), .c(new_n135_), .O(new_n1204_));
  aoi21  g1112(.a(new_n1204_), .b(new_n1203_), .c(x71), .O(new_n1205_));
  nand4  g1113(.a(new_n1205_), .b(new_n108_), .c(new_n140_), .d(x64), .O(new_n1206_));
  nand2  g1114(.a(new_n1206_), .b(new_n1202_), .O(new_n1207_));
  nand3  g1115(.a(new_n1207_), .b(new_n152_), .c(x68), .O(new_n1208_));
  oai21  g1116(.a(new_n1191_), .b(x68), .c(new_n1208_), .O(z15));
  zero   g1117(.O(z14));
endmodule
