// Benchmark "FAU" written by ABC on Sat Jul 25 20:48:48 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n329_, new_n330_, new_n331_, new_n332_, new_n333_, new_n343_,
  ...
  inv1   g243(.a(x64), .O(new_n343_));
  inv1   g244(.a(x00), .O(new_n344_));
  oai21  g245(.a(new_n194_), .b(new_n344_), .c(x11), .O(new_n345_));
  nand3  g246(.a(new_n193_), .b(new_n107_), .c(x00), .O(new_n346_));
  nand2  g247(.a(new_n346_), .b(new_n345_), .O(new_n347_));
  nand3  g248(.a(new_n347_), .b(x71), .c(new_n143_), .O(new_n348_));
  nand2  g249(.a(new_n230_), .b(x59), .O(new_n349_));
  nand2  g250(.a(x74), .b(x54), .O(new_n350_));
  nand2  g251(.a(new_n228_), .b(x55), .O(new_n351_));
  aoi21  g252(.a(new_n351_), .b(new_n350_), .c(x73), .O(new_n352_));
  nand3  g253(.a(new_n228_), .b(x73), .c(x51), .O(new_n353_));
  inv1   g254(.a(new_n353_), .O(new_n354_));
  oai21  g255(.a(new_n354_), .b(new_n352_), .c(x72), .O(new_n355_));
  nand2  g256(.a(x74), .b(x56), .O(new_n356_));
  nand2  g257(.a(new_n228_), .b(x57), .O(new_n357_));
  aoi21  g258(.a(new_n357_), .b(new_n356_), .c(new_n227_), .O(new_n358_));
  nand3  g259(.a(x74), .b(new_n227_), .c(x58), .O(new_n359_));
  inv1   g260(.a(new_n359_), .O(new_n360_));
  oai21  g261(.a(new_n360_), .b(new_n358_), .c(new_n226_), .O(new_n361_));
  nand3  g262(.a(new_n361_), .b(new_n355_), .c(new_n349_), .O(new_n362_));
  nand3  g263(.a(new_n362_), .b(new_n131_), .c(x65), .O(new_n363_));
  nand2  g264(.a(new_n363_), .b(new_n348_), .O(new_n364_));
  nand3  g265(.a(new_n364_), .b(new_n155_), .c(x68), .O(new_n365_));
  nand2  g266(.a(new_n230_), .b(x27), .O(new_n366_));
  nand2  g267(.a(x74), .b(x22), .O(new_n367_));
  nand2  g268(.a(new_n228_), .b(x23), .O(new_n368_));
  aoi21  g269(.a(new_n368_), .b(new_n367_), .c(x73), .O(new_n369_));
  nand3  g270(.a(new_n228_), .b(x73), .c(x19), .O(new_n370_));
  inv1   g271(.a(new_n370_), .O(new_n371_));
  oai21  g272(.a(new_n371_), .b(new_n369_), .c(x72), .O(new_n372_));
  nand2  g273(.a(x74), .b(x24), .O(new_n373_));
  nand2  g274(.a(new_n228_), .b(x25), .O(new_n374_));
  aoi21  g275(.a(new_n374_), .b(new_n373_), .c(new_n227_), .O(new_n375_));
  nand3  g276(.a(x74), .b(new_n227_), .c(x26), .O(new_n376_));
  inv1   g277(.a(new_n376_), .O(new_n377_));
  oai21  g278(.a(new_n377_), .b(new_n375_), .c(new_n226_), .O(new_n378_));
  nand3  g279(.a(new_n378_), .b(new_n372_), .c(new_n366_), .O(new_n379_));
  nand3  g280(.a(new_n379_), .b(x71), .c(x69), .O(new_n380_));
  inv1   g281(.a(new_n380_), .O(new_n381_));
  nand3  g282(.a(new_n381_), .b(new_n144_), .c(x65), .O(new_n382_));
  aoi21  g283(.a(new_n382_), .b(new_n365_), .c(x70), .O(new_n383_));
  inv1   g284(.a(x27), .O(new_n384_));
  nand2  g285(.a(x71), .b(x59), .O(new_n385_));
  oai21  g286(.a(x71), .b(new_n384_), .c(new_n385_), .O(new_n386_));
  nand2  g287(.a(new_n386_), .b(new_n230_), .O(new_n387_));
  nand2  g288(.a(new_n361_), .b(new_n355_), .O(new_n388_));
  nand2  g289(.a(new_n388_), .b(x71), .O(new_n389_));
  nand2  g290(.a(new_n378_), .b(new_n372_), .O(new_n390_));
  nand2  g291(.a(new_n390_), .b(new_n131_), .O(new_n391_));
  nand3  g292(.a(new_n391_), .b(new_n389_), .c(new_n387_), .O(new_n392_));
  nand4  g293(.a(new_n392_), .b(x69), .c(new_n144_), .d(x65), .O(new_n393_));
  oai21  g294(.a(new_n218_), .b(new_n158_), .c(x43), .O(new_n394_));
  nand3  g295(.a(new_n217_), .b(new_n127_), .c(x32), .O(new_n395_));
  aoi21  g296(.a(new_n395_), .b(new_n394_), .c(x71), .O(new_n396_));
  nand4  g297(.a(new_n396_), .b(new_n155_), .c(x68), .d(new_n143_), .O(new_n397_));
  aoi21  g298(.a(new_n397_), .b(new_n393_), .c(new_n111_), .O(new_n398_));
  oai21  g299(.a(new_n398_), .b(new_n383_), .c(new_n94_), .O(new_n399_));
  nand3  g300(.a(new_n347_), .b(x71), .c(new_n111_), .O(new_n400_));
  nand2  g301(.a(new_n396_), .b(x70), .O(new_n401_));
  nand2  g302(.a(new_n401_), .b(new_n400_), .O(new_n402_));
  nand4  g303(.a(new_n402_), .b(new_n155_), .c(x68), .d(new_n93_), .O(new_n403_));
  inv1   g304(.a(new_n403_), .O(new_n404_));
  nand3  g305(.a(new_n404_), .b(new_n92_), .c(x65), .O(new_n405_));
  nand2  g306(.a(new_n405_), .b(new_n399_), .O(new_n406_));
  nand2  g307(.a(new_n406_), .b(new_n343_), .O(new_n407_));
  nand2  g308(.a(new_n156_), .b(x11), .O(new_n408_));
  oai22  g309(.a(new_n159_), .b(new_n384_), .c(new_n131_), .d(new_n127_), .O(new_n409_));
  nand2  g310(.a(new_n409_), .b(x70), .O(new_n410_));
  nand3  g311(.a(new_n136_), .b(x69), .c(x59), .O(new_n411_));
  nand3  g312(.a(new_n411_), .b(new_n410_), .c(new_n408_), .O(new_n412_));
  nand2  g313(.a(new_n412_), .b(x67), .O(new_n413_));
  nand2  g314(.a(new_n379_), .b(new_n147_), .O(new_n414_));
  nand3  g315(.a(new_n362_), .b(x71), .c(x70), .O(new_n415_));
  nand2  g316(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  nand3  g317(.a(new_n416_), .b(x69), .c(new_n93_), .O(new_n417_));
  aoi21  g318(.a(new_n417_), .b(new_n413_), .c(x68), .O(new_n418_));
  nand2  g319(.a(new_n362_), .b(new_n93_), .O(new_n419_));
  nand2  g320(.a(x67), .b(x43), .O(new_n420_));
  nand2  g321(.a(new_n420_), .b(new_n419_), .O(new_n421_));
  nand4  g322(.a(new_n421_), .b(new_n131_), .c(new_n111_), .d(new_n155_), .O(new_n422_));
  nor2   g323(.a(new_n422_), .b(new_n144_), .O(new_n423_));
  oai21  g324(.a(new_n423_), .b(new_n418_), .c(new_n92_), .O(new_n424_));
  nand2  g325(.a(new_n412_), .b(new_n144_), .O(new_n425_));
  nand3  g326(.a(new_n164_), .b(x68), .c(x43), .O(new_n426_));
  nand2  g327(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  nand3  g328(.a(new_n427_), .b(new_n93_), .c(x66), .O(new_n428_));
  nand2  g329(.a(new_n428_), .b(new_n424_), .O(new_n429_));
  nand3  g330(.a(new_n429_), .b(new_n143_), .c(x64), .O(new_n430_));
  nand2  g331(.a(new_n430_), .b(new_n407_), .O(z11));
  oai21  g332(.a(x15), .b(x14), .c(new_n190_), .O(new_n433_));
  oai21  g333(.a(new_n181_), .b(new_n344_), .c(x13), .O(new_n434_));
  oai21  g334(.a(new_n433_), .b(new_n344_), .c(new_n434_), .O(new_n435_));
  nand3  g335(.a(new_n435_), .b(x71), .c(new_n143_), .O(new_n436_));
  nand2  g336(.a(new_n230_), .b(x61), .O(new_n437_));
  aoi21  g337(.a(new_n357_), .b(new_n356_), .c(x73), .O(new_n438_));
  nand3  g338(.a(new_n228_), .b(x73), .c(x53), .O(new_n439_));
  inv1   g339(.a(new_n439_), .O(new_n440_));
  oai21  g340(.a(new_n440_), .b(new_n438_), .c(x72), .O(new_n441_));
  nand2  g341(.a(x74), .b(x58), .O(new_n442_));
  nand2  g342(.a(new_n228_), .b(x59), .O(new_n443_));
  aoi21  g343(.a(new_n443_), .b(new_n442_), .c(new_n227_), .O(new_n444_));
  nand3  g344(.a(x74), .b(new_n227_), .c(x60), .O(new_n445_));
  inv1   g345(.a(new_n445_), .O(new_n446_));
  oai21  g346(.a(new_n446_), .b(new_n444_), .c(new_n226_), .O(new_n447_));
  nand3  g347(.a(new_n447_), .b(new_n441_), .c(new_n437_), .O(new_n448_));
  nand3  g348(.a(new_n448_), .b(new_n131_), .c(x65), .O(new_n449_));
  nand2  g349(.a(new_n449_), .b(new_n436_), .O(new_n450_));
  nand3  g350(.a(new_n450_), .b(new_n155_), .c(x68), .O(new_n451_));
  nand2  g351(.a(new_n230_), .b(x29), .O(new_n452_));
  aoi21  g352(.a(new_n374_), .b(new_n373_), .c(x73), .O(new_n453_));
  nand3  g353(.a(new_n228_), .b(x73), .c(x21), .O(new_n454_));
  inv1   g354(.a(new_n454_), .O(new_n455_));
  oai21  g355(.a(new_n455_), .b(new_n453_), .c(x72), .O(new_n456_));
  nand2  g356(.a(x74), .b(x26), .O(new_n457_));
  nand2  g357(.a(new_n228_), .b(x27), .O(new_n458_));
  aoi21  g358(.a(new_n458_), .b(new_n457_), .c(new_n227_), .O(new_n459_));
  nand3  g359(.a(x74), .b(new_n227_), .c(x28), .O(new_n460_));
  inv1   g360(.a(new_n460_), .O(new_n461_));
  oai21  g361(.a(new_n461_), .b(new_n459_), .c(new_n226_), .O(new_n462_));
  nand3  g362(.a(new_n462_), .b(new_n456_), .c(new_n452_), .O(new_n463_));
  nand3  g363(.a(new_n463_), .b(x71), .c(x69), .O(new_n464_));
  inv1   g364(.a(new_n464_), .O(new_n465_));
  nand3  g365(.a(new_n465_), .b(new_n144_), .c(x65), .O(new_n466_));
  aoi21  g366(.a(new_n466_), .b(new_n451_), .c(x70), .O(new_n467_));
  inv1   g367(.a(x29), .O(new_n468_));
  nand2  g368(.a(x71), .b(x61), .O(new_n469_));
  oai21  g369(.a(x71), .b(new_n468_), .c(new_n469_), .O(new_n470_));
  nand2  g370(.a(new_n470_), .b(new_n230_), .O(new_n471_));
  nand2  g371(.a(new_n447_), .b(new_n441_), .O(new_n472_));
  nand2  g372(.a(new_n472_), .b(x71), .O(new_n473_));
  nand2  g373(.a(new_n462_), .b(new_n456_), .O(new_n474_));
  nand2  g374(.a(new_n474_), .b(new_n131_), .O(new_n475_));
  nand3  g375(.a(new_n475_), .b(new_n473_), .c(new_n471_), .O(new_n476_));
  nand4  g376(.a(new_n476_), .b(x69), .c(new_n144_), .d(x65), .O(new_n477_));
  nor2   g377(.a(new_n205_), .b(x45), .O(new_n478_));
  nand2  g378(.a(new_n478_), .b(x32), .O(new_n479_));
  oai21  g379(.a(new_n205_), .b(new_n158_), .c(x45), .O(new_n480_));
  aoi21  g380(.a(new_n480_), .b(new_n479_), .c(x71), .O(new_n481_));
  nand4  g381(.a(new_n481_), .b(new_n155_), .c(x68), .d(new_n143_), .O(new_n482_));
  aoi21  g382(.a(new_n482_), .b(new_n477_), .c(new_n111_), .O(new_n483_));
  oai21  g383(.a(new_n483_), .b(new_n467_), .c(new_n94_), .O(new_n484_));
  nand3  g384(.a(new_n435_), .b(x71), .c(new_n111_), .O(new_n485_));
  nand2  g385(.a(new_n481_), .b(x70), .O(new_n486_));
  nand2  g386(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  nand4  g387(.a(new_n487_), .b(new_n155_), .c(x68), .d(new_n93_), .O(new_n488_));
  inv1   g388(.a(new_n488_), .O(new_n489_));
  nand3  g389(.a(new_n489_), .b(new_n92_), .c(x65), .O(new_n490_));
  nand2  g390(.a(new_n490_), .b(new_n484_), .O(new_n491_));
  nand2  g391(.a(new_n491_), .b(new_n343_), .O(new_n492_));
  nand2  g392(.a(new_n156_), .b(x13), .O(new_n493_));
  oai22  g393(.a(new_n159_), .b(new_n468_), .c(new_n131_), .d(new_n214_), .O(new_n494_));
  nand2  g394(.a(new_n494_), .b(x70), .O(new_n495_));
  nand3  g395(.a(new_n136_), .b(x69), .c(x61), .O(new_n496_));
  nand3  g396(.a(new_n496_), .b(new_n495_), .c(new_n493_), .O(new_n497_));
  nand2  g397(.a(new_n497_), .b(x67), .O(new_n498_));
  nand2  g398(.a(new_n463_), .b(new_n147_), .O(new_n499_));
  nand3  g399(.a(new_n448_), .b(x71), .c(x70), .O(new_n500_));
  nand2  g400(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand3  g401(.a(new_n501_), .b(x69), .c(new_n93_), .O(new_n502_));
  aoi21  g402(.a(new_n502_), .b(new_n498_), .c(x68), .O(new_n503_));
  nand2  g403(.a(new_n448_), .b(new_n93_), .O(new_n504_));
  nand2  g404(.a(x67), .b(x45), .O(new_n505_));
  nand2  g405(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  nand4  g406(.a(new_n506_), .b(new_n131_), .c(new_n111_), .d(new_n155_), .O(new_n507_));
  nor2   g407(.a(new_n507_), .b(new_n144_), .O(new_n508_));
  oai21  g408(.a(new_n508_), .b(new_n503_), .c(new_n92_), .O(new_n509_));
  nand2  g409(.a(new_n497_), .b(new_n144_), .O(new_n510_));
  nand3  g410(.a(new_n164_), .b(x68), .c(x45), .O(new_n511_));
  nand2  g411(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  nand3  g412(.a(new_n512_), .b(new_n93_), .c(x66), .O(new_n513_));
  nand2  g413(.a(new_n513_), .b(new_n509_), .O(new_n514_));
  nand3  g414(.a(new_n514_), .b(new_n143_), .c(x64), .O(new_n515_));
  nand2  g415(.a(new_n515_), .b(new_n492_), .O(z13));
  zero   g416(.O(z03));
  zero   g417(.O(z04));
  zero   g418(.O(z05));
  zero   g419(.O(z06));
