...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n329_, new_n330_, new_n331_, new_n332_, new_n333_, new_n339_,
    ...
    new_n412_, new_n413_, new_n414_, new_n415_, new_n416_, new_n423_,
  ...
  inv1   g243(.a(x64), .O(new_n339_));
  nand2  g244(.a(new_n230_), .b(x23), .O(new_n340_));
  nand3  g245(.a(new_n228_), .b(x73), .c(x16), .O(new_n341_));
  inv1   g246(.a(new_n341_), .O(new_n342_));
  nand2  g247(.a(x74), .b(x18), .O(new_n343_));
  nand2  g248(.a(new_n228_), .b(x19), .O(new_n344_));
  aoi21  g249(.a(new_n344_), .b(new_n343_), .c(x73), .O(new_n345_));
  oai21  g250(.a(new_n345_), .b(new_n342_), .c(x72), .O(new_n346_));
  nand2  g251(.a(x74), .b(x20), .O(new_n347_));
  nand2  g252(.a(new_n228_), .b(x21), .O(new_n348_));
  aoi21  g253(.a(new_n348_), .b(new_n347_), .c(new_n227_), .O(new_n349_));
  nand3  g254(.a(x74), .b(new_n227_), .c(x22), .O(new_n350_));
  inv1   g255(.a(new_n350_), .O(new_n351_));
  oai21  g256(.a(new_n351_), .b(new_n349_), .c(new_n226_), .O(new_n352_));
  nand3  g257(.a(new_n352_), .b(new_n346_), .c(new_n340_), .O(new_n353_));
  nand2  g258(.a(new_n353_), .b(new_n147_), .O(new_n354_));
  nand2  g259(.a(new_n230_), .b(x55), .O(new_n355_));
  nand3  g260(.a(new_n228_), .b(x73), .c(x48), .O(new_n356_));
  inv1   g261(.a(new_n356_), .O(new_n357_));
  nand2  g262(.a(x74), .b(x50), .O(new_n358_));
  nand2  g263(.a(new_n228_), .b(x51), .O(new_n359_));
  aoi21  g264(.a(new_n359_), .b(new_n358_), .c(x73), .O(new_n360_));
  oai21  g265(.a(new_n360_), .b(new_n357_), .c(x72), .O(new_n361_));
  nand2  g266(.a(x74), .b(x52), .O(new_n362_));
  nand2  g267(.a(new_n228_), .b(x53), .O(new_n363_));
  aoi21  g268(.a(new_n363_), .b(new_n362_), .c(new_n227_), .O(new_n364_));
  nand3  g269(.a(x74), .b(new_n227_), .c(x54), .O(new_n365_));
  inv1   g270(.a(new_n365_), .O(new_n366_));
  oai21  g271(.a(new_n366_), .b(new_n364_), .c(new_n226_), .O(new_n367_));
  nand3  g272(.a(new_n367_), .b(new_n361_), .c(new_n355_), .O(new_n368_));
  nand3  g273(.a(new_n368_), .b(x71), .c(x70), .O(new_n369_));
  nand2  g274(.a(new_n369_), .b(new_n354_), .O(new_n370_));
  nand3  g275(.a(new_n370_), .b(x69), .c(new_n144_), .O(new_n371_));
  nand3  g276(.a(new_n368_), .b(new_n131_), .c(new_n111_), .O(new_n372_));
  inv1   g277(.a(new_n372_), .O(new_n373_));
  nand3  g278(.a(new_n373_), .b(new_n155_), .c(x68), .O(new_n374_));
  aoi21  g279(.a(new_n374_), .b(new_n371_), .c(new_n143_), .O(new_n375_));
  inv1   g280(.a(x00), .O(new_n376_));
  nand4  g281(.a(new_n181_), .b(new_n180_), .c(new_n186_), .d(new_n271_), .O(new_n377_));
  oai21  g282(.a(new_n377_), .b(x06), .c(new_n101_), .O(new_n378_));
  nand2  g283(.a(x07), .b(new_n376_), .O(new_n379_));
  oai21  g284(.a(new_n378_), .b(new_n376_), .c(new_n379_), .O(new_n380_));
  nand3  g285(.a(new_n380_), .b(x71), .c(new_n111_), .O(new_n381_));
  nand4  g286(.a(new_n205_), .b(new_n204_), .c(new_n210_), .d(new_n282_), .O(new_n382_));
  oai21  g287(.a(new_n382_), .b(x38), .c(new_n121_), .O(new_n383_));
  nand2  g288(.a(x39), .b(new_n158_), .O(new_n384_));
  oai21  g289(.a(new_n383_), .b(new_n158_), .c(new_n384_), .O(new_n385_));
  nand3  g290(.a(new_n385_), .b(new_n131_), .c(x70), .O(new_n386_));
  nand2  g291(.a(new_n386_), .b(new_n381_), .O(new_n387_));
  nand4  g292(.a(new_n387_), .b(new_n155_), .c(x68), .d(new_n143_), .O(new_n388_));
  inv1   g293(.a(new_n388_), .O(new_n389_));
  oai21  g294(.a(new_n389_), .b(new_n375_), .c(new_n94_), .O(new_n390_));
  nand3  g295(.a(new_n387_), .b(new_n155_), .c(x68), .O(new_n391_));
  inv1   g296(.a(new_n391_), .O(new_n392_));
  nand4  g297(.a(new_n392_), .b(new_n93_), .c(new_n92_), .d(x65), .O(new_n393_));
  nand2  g298(.a(new_n393_), .b(new_n390_), .O(new_n394_));
  nand2  g299(.a(new_n394_), .b(new_n339_), .O(new_n395_));
  nand2  g300(.a(new_n156_), .b(x07), .O(new_n396_));
  inv1   g301(.a(x23), .O(new_n397_));
  oai22  g302(.a(new_n159_), .b(new_n397_), .c(new_n131_), .d(new_n121_), .O(new_n398_));
  nand2  g303(.a(new_n398_), .b(x70), .O(new_n399_));
  nand3  g304(.a(new_n136_), .b(x69), .c(x55), .O(new_n400_));
  nand3  g305(.a(new_n400_), .b(new_n399_), .c(new_n396_), .O(new_n401_));
  nand2  g306(.a(new_n401_), .b(x67), .O(new_n402_));
  nand3  g307(.a(new_n370_), .b(x69), .c(new_n93_), .O(new_n403_));
  aoi21  g308(.a(new_n403_), .b(new_n402_), .c(x68), .O(new_n404_));
  nand2  g309(.a(new_n368_), .b(new_n93_), .O(new_n405_));
  nand2  g310(.a(x67), .b(x39), .O(new_n406_));
  nand2  g311(.a(new_n406_), .b(new_n405_), .O(new_n407_));
  nand4  g312(.a(new_n407_), .b(new_n131_), .c(new_n111_), .d(new_n155_), .O(new_n408_));
  nor2   g313(.a(new_n408_), .b(new_n144_), .O(new_n409_));
  oai21  g314(.a(new_n409_), .b(new_n404_), .c(new_n92_), .O(new_n410_));
  nand2  g315(.a(new_n401_), .b(new_n144_), .O(new_n411_));
  nand3  g316(.a(new_n164_), .b(x68), .c(x39), .O(new_n412_));
  nand2  g317(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  nand3  g318(.a(new_n413_), .b(new_n93_), .c(x66), .O(new_n414_));
  nand2  g319(.a(new_n414_), .b(new_n410_), .O(new_n415_));
  nand3  g320(.a(new_n415_), .b(new_n143_), .c(x64), .O(new_n416_));
  nand2  g321(.a(new_n416_), .b(new_n395_), .O(z07));
  oai21  g322(.a(x15), .b(x14), .c(new_n190_), .O(new_n423_));
  oai21  g323(.a(new_n181_), .b(new_n376_), .c(x13), .O(new_n424_));
  oai21  g324(.a(new_n423_), .b(new_n376_), .c(new_n424_), .O(new_n425_));
  ...
  nand2  g385(.a(new_n485_), .b(new_n339_), .O(new_n486_));
