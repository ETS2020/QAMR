// Benchmark "FAU" written by ABC on Sat Jul 25 20:47:29 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n413_, new_n414_, new_n420_, new_n421_, new_n422_, new_n423_,
  ...
  oai22  g146(.a(new_n237_), .b(new_n147_), .c(new_n232_), .d(new_n225_), .O(new_n238_));
  nand4  g147(.a(new_n238_), .b(new_n130_), .c(new_n110_), .d(x65), .O(new_n239_));
  inv1   g148(.a(new_n239_), .O(new_n240_));
  oai21  g149(.a(new_n240_), .b(new_n224_), .c(new_n156_), .O(new_n241_));
  inv1   g150(.a(x17), .O(new_n242_));
  oai22  g151(.a(new_n150_), .b(new_n225_), .c(new_n149_), .d(new_n242_), .O(new_n243_));
  nand2  g152(.a(new_n243_), .b(new_n231_), .O(new_n244_));
  nand2  g153(.a(new_n236_), .b(new_n151_), .O(new_n245_));
  nand2  g154(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  nand4  g155(.a(new_n246_), .b(x69), .c(new_n145_), .d(x65), .O(new_n247_));
  oai21  g156(.a(new_n241_), .b(new_n145_), .c(new_n247_), .O(new_n248_));
  nand2  g157(.a(new_n223_), .b(new_n199_), .O(new_n249_));
  nand4  g158(.a(new_n249_), .b(new_n156_), .c(x68), .d(new_n140_), .O(new_n250_));
  nor3   g159(.a(new_n250_), .b(x66), .c(new_n144_), .O(new_n251_));
  aoi21  g160(.a(new_n248_), .b(new_n93_), .c(new_n251_), .O(new_n252_));
  nand2  g161(.a(new_n157_), .b(x01), .O(new_n253_));
  oai22  g162(.a(new_n160_), .b(new_n242_), .c(new_n130_), .d(new_n114_), .O(new_n254_));
  nor2   g163(.a(new_n156_), .b(new_n225_), .O(new_n255_));
  aoi22  g164(.a(new_n255_), .b(new_n135_), .c(new_n254_), .d(x70), .O(new_n256_));
  nand2  g165(.a(new_n256_), .b(new_n253_), .O(new_n257_));
  nor3   g166(.a(new_n166_), .b(new_n145_), .c(new_n114_), .O(new_n258_));
  aoi21  g167(.a(new_n257_), .b(new_n145_), .c(new_n258_), .O(new_n259_));
  nand3  g168(.a(new_n243_), .b(x69), .c(new_n145_), .O(new_n260_));
  nand3  g169(.a(new_n165_), .b(x68), .c(x49), .O(new_n261_));
  aoi21  g170(.a(new_n261_), .b(new_n260_), .c(new_n232_), .O(new_n262_));
  aoi21  g171(.a(new_n170_), .b(new_n169_), .c(new_n237_), .O(new_n263_));
  oai21  g172(.a(new_n263_), .b(new_n262_), .c(new_n140_), .O(new_n264_));
  oai22  g173(.a(new_n264_), .b(x66), .c(new_n259_), .d(new_n155_), .O(new_n265_));
  nand3  g174(.a(new_n265_), .b(new_n144_), .c(x64), .O(new_n266_));
  oai21  g175(.a(new_n252_), .b(x64), .c(new_n266_), .O(z01));
  nor2   g176(.a(x05), .b(x04), .O(new_n268_));
  nand4  g177(.a(new_n176_), .b(new_n268_), .c(new_n99_), .d(new_n96_), .O(new_n269_));
  oai21  g178(.a(new_n269_), .b(new_n183_), .c(x00), .O(new_n270_));
  nand2  g179(.a(new_n270_), .b(x02), .O(new_n271_));
  inv1   g180(.a(x04), .O(new_n272_));
  nand3  g181(.a(new_n187_), .b(new_n272_), .c(new_n96_), .O(new_n273_));
  nor2   g182(.a(new_n273_), .b(new_n102_), .O(new_n274_));
  nand3  g183(.a(new_n274_), .b(new_n195_), .c(new_n190_), .O(new_n275_));
  nand3  g184(.a(new_n275_), .b(new_n95_), .c(x00), .O(new_n276_));
  nand2  g185(.a(new_n276_), .b(new_n271_), .O(new_n277_));
  nand3  g186(.a(new_n277_), .b(x71), .c(new_n110_), .O(new_n278_));
  nor2   g187(.a(x37), .b(x36), .O(new_n279_));
  nand4  g188(.a(new_n200_), .b(new_n279_), .c(new_n119_), .d(new_n116_), .O(new_n280_));
  oai21  g189(.a(new_n280_), .b(new_n207_), .c(x32), .O(new_n281_));
  nand2  g190(.a(new_n281_), .b(x34), .O(new_n282_));
  inv1   g191(.a(x36), .O(new_n283_));
  nand3  g192(.a(new_n211_), .b(new_n283_), .c(new_n116_), .O(new_n284_));
  nor2   g193(.a(new_n284_), .b(new_n122_), .O(new_n285_));
  nand3  g194(.a(new_n285_), .b(new_n219_), .c(new_n214_), .O(new_n286_));
  nand3  g195(.a(new_n286_), .b(new_n115_), .c(x32), .O(new_n287_));
  nand2  g196(.a(new_n287_), .b(new_n282_), .O(new_n288_));
  nand3  g197(.a(new_n288_), .b(new_n130_), .c(x70), .O(new_n289_));
  ...
  nand4  g206(.a(new_n297_), .b(new_n130_), .c(new_n110_), .d(x65), .O(new_n298_));
  inv1   g207(.a(new_n298_), .O(new_n299_));
  oai21  g208(.a(new_n299_), .b(new_n290_), .c(new_n156_), .O(new_n300_));
  ...
  nand2  g213(.a(new_n304_), .b(new_n148_), .O(new_n305_));
  nand3  g214(.a(new_n297_), .b(x71), .c(x70), .O(new_n306_));
  nand2  g215(.a(new_n306_), .b(new_n305_), .O(new_n307_));
  nand4  g216(.a(new_n307_), .b(x69), .c(new_n145_), .d(x65), .O(new_n308_));
  oai21  g217(.a(new_n300_), .b(new_n145_), .c(new_n308_), .O(new_n309_));
  nand2  g218(.a(new_n289_), .b(new_n278_), .O(new_n310_));
  nand4  g219(.a(new_n310_), .b(new_n156_), .c(x68), .d(new_n140_), .O(new_n311_));
  nor3   g220(.a(new_n311_), .b(x66), .c(new_n144_), .O(new_n312_));
  aoi21  g221(.a(new_n309_), .b(new_n93_), .c(new_n312_), .O(new_n313_));
  nand2  g222(.a(new_n157_), .b(x02), .O(new_n314_));
  inv1   g223(.a(x18), .O(new_n315_));
  oai22  g224(.a(new_n160_), .b(new_n315_), .c(new_n130_), .d(new_n115_), .O(new_n316_));
  nand2  g225(.a(new_n316_), .b(x70), .O(new_n317_));
  nand3  g226(.a(new_n135_), .b(x69), .c(x50), .O(new_n318_));
  nand3  g227(.a(new_n318_), .b(new_n317_), .c(new_n314_), .O(new_n319_));
  nand2  g228(.a(new_n319_), .b(x67), .O(new_n320_));
  nand3  g229(.a(new_n307_), .b(x69), .c(new_n140_), .O(new_n321_));
  aoi21  g230(.a(new_n321_), .b(new_n320_), .c(x68), .O(new_n322_));
  nand2  g231(.a(new_n297_), .b(new_n140_), .O(new_n323_));
  nand2  g232(.a(x67), .b(x34), .O(new_n324_));
  nand2  g233(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand4  g234(.a(new_n325_), .b(new_n130_), .c(new_n110_), .d(new_n156_), .O(new_n326_));
  nor2   g235(.a(new_n326_), .b(new_n145_), .O(new_n327_));
  oai21  g236(.a(new_n327_), .b(new_n322_), .c(new_n139_), .O(new_n328_));
  nand2  g237(.a(new_n319_), .b(new_n145_), .O(new_n329_));
  nand3  g238(.a(new_n165_), .b(x68), .c(x34), .O(new_n330_));
  nand2  g239(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand3  g240(.a(new_n331_), .b(new_n140_), .c(x66), .O(new_n332_));
  nand2  g241(.a(new_n332_), .b(new_n328_), .O(new_n333_));
  nand3  g242(.a(new_n333_), .b(new_n144_), .c(x64), .O(new_n334_));
  oai21  g243(.a(new_n313_), .b(x64), .c(new_n334_), .O(z02));
  inv1   g244(.a(x64), .O(new_n341_));
  nand2  g245(.a(new_n183_), .b(x00), .O(new_n342_));
  nand2  g246(.a(new_n342_), .b(x08), .O(new_n343_));
  nand3  g247(.a(new_n183_), .b(new_n101_), .c(x00), .O(new_n344_));
  nand2  g248(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  nand3  g249(.a(new_n345_), .b(x71), .c(new_n110_), .O(new_n346_));
  nand2  g250(.a(new_n207_), .b(x32), .O(new_n347_));
  nand2  g251(.a(new_n347_), .b(x40), .O(new_n348_));
  nand3  g252(.a(new_n207_), .b(new_n121_), .c(x32), .O(new_n349_));
  nand2  g253(.a(new_n349_), .b(new_n348_), .O(new_n350_));
  nand3  g254(.a(new_n350_), .b(new_n130_), .c(x70), .O(new_n351_));
  nand2  g255(.a(new_n351_), .b(new_n346_), .O(new_n352_));
  nand2  g256(.a(new_n352_), .b(new_n144_), .O(new_n353_));
  nand2  g257(.a(new_n231_), .b(x56), .O(new_n354_));
  nand2  g258(.a(x74), .b(x51), .O(new_n355_));
  nand2  g259(.a(new_n229_), .b(x52), .O(new_n356_));
  aoi21  g260(.a(new_n356_), .b(new_n355_), .c(x73), .O(new_n357_));
  nand3  g261(.a(new_n229_), .b(x73), .c(x48), .O(new_n358_));
  inv1   g262(.a(new_n358_), .O(new_n359_));
  oai21  g263(.a(new_n359_), .b(new_n357_), .c(x72), .O(new_n360_));
  nand2  g264(.a(x74), .b(x53), .O(new_n361_));
  nand2  g265(.a(new_n229_), .b(x54), .O(new_n362_));
  aoi21  g266(.a(new_n362_), .b(new_n361_), .c(new_n228_), .O(new_n363_));
  nand3  g267(.a(x74), .b(new_n228_), .c(x55), .O(new_n364_));
  inv1   g268(.a(new_n364_), .O(new_n365_));
  oai21  g269(.a(new_n365_), .b(new_n363_), .c(new_n227_), .O(new_n366_));
  nand3  g270(.a(new_n366_), .b(new_n360_), .c(new_n354_), .O(new_n367_));
  nand4  g271(.a(new_n367_), .b(new_n130_), .c(new_n110_), .d(x65), .O(new_n368_));
  nand2  g272(.a(new_n368_), .b(new_n353_), .O(new_n369_));
  nand3  g273(.a(new_n369_), .b(new_n156_), .c(x68), .O(new_n370_));
  nand2  g274(.a(new_n231_), .b(x24), .O(new_n371_));
  nand2  g275(.a(x74), .b(x19), .O(new_n372_));
  nand2  g276(.a(new_n229_), .b(x20), .O(new_n373_));
  aoi21  g277(.a(new_n373_), .b(new_n372_), .c(x73), .O(new_n374_));
  nand3  g278(.a(new_n229_), .b(x73), .c(x16), .O(new_n375_));
  inv1   g279(.a(new_n375_), .O(new_n376_));
  oai21  g280(.a(new_n376_), .b(new_n374_), .c(x72), .O(new_n377_));
  nand2  g281(.a(x74), .b(x21), .O(new_n378_));
  nand2  g282(.a(new_n229_), .b(x22), .O(new_n379_));
  aoi21  g283(.a(new_n379_), .b(new_n378_), .c(new_n228_), .O(new_n380_));
  nand3  g284(.a(x74), .b(new_n228_), .c(x23), .O(new_n381_));
  inv1   g285(.a(new_n381_), .O(new_n382_));
  oai21  g286(.a(new_n382_), .b(new_n380_), .c(new_n227_), .O(new_n383_));
  nand3  g287(.a(new_n383_), .b(new_n377_), .c(new_n371_), .O(new_n384_));
  nand2  g288(.a(new_n384_), .b(new_n148_), .O(new_n385_));
  nand3  g289(.a(new_n367_), .b(x71), .c(x70), .O(new_n386_));
  nand2  g290(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  nand4  g291(.a(new_n387_), .b(x69), .c(new_n145_), .d(x65), .O(new_n388_));
  aoi21  g292(.a(new_n388_), .b(new_n370_), .c(new_n92_), .O(new_n389_));
  aoi21  g293(.a(new_n351_), .b(new_n346_), .c(x69), .O(new_n390_));
  nand4  g294(.a(new_n390_), .b(x68), .c(new_n140_), .d(new_n139_), .O(new_n391_));
  nor2   g295(.a(new_n391_), .b(new_n144_), .O(new_n392_));
  oai21  g296(.a(new_n392_), .b(new_n389_), .c(new_n341_), .O(new_n393_));
  nand2  g297(.a(new_n157_), .b(x08), .O(new_n394_));
  inv1   g298(.a(x24), .O(new_n395_));
  oai22  g299(.a(new_n160_), .b(new_n395_), .c(new_n130_), .d(new_n121_), .O(new_n396_));
  nand2  g300(.a(new_n396_), .b(x70), .O(new_n397_));
  nand3  g301(.a(new_n135_), .b(x69), .c(x56), .O(new_n398_));
  nand3  g302(.a(new_n398_), .b(new_n397_), .c(new_n394_), .O(new_n399_));
  nand2  g303(.a(new_n399_), .b(x67), .O(new_n400_));
  nand3  g304(.a(new_n387_), .b(x69), .c(new_n140_), .O(new_n401_));
  aoi21  g305(.a(new_n401_), .b(new_n400_), .c(x68), .O(new_n402_));
  nand2  g306(.a(new_n367_), .b(new_n140_), .O(new_n403_));
  nand2  g307(.a(x67), .b(x40), .O(new_n404_));
  nand2  g308(.a(new_n404_), .b(new_n403_), .O(new_n405_));
  nand4  g309(.a(new_n405_), .b(new_n130_), .c(new_n110_), .d(new_n156_), .O(new_n406_));
  nor2   g310(.a(new_n406_), .b(new_n145_), .O(new_n407_));
  oai21  g311(.a(new_n407_), .b(new_n402_), .c(new_n139_), .O(new_n408_));
  nand2  g312(.a(new_n399_), .b(new_n145_), .O(new_n409_));
  nand3  g313(.a(new_n165_), .b(x68), .c(x40), .O(new_n410_));
  nand2  g314(.a(new_n410_), .b(new_n409_), .O(new_n411_));
  nand3  g315(.a(new_n411_), .b(new_n140_), .c(x66), .O(new_n412_));
  nand2  g316(.a(new_n412_), .b(new_n408_), .O(new_n413_));
  nand3  g317(.a(new_n413_), .b(new_n144_), .c(x64), .O(new_n414_));
  nand2  g318(.a(new_n414_), .b(new_n393_), .O(z08));
  inv1   g319(.a(x00), .O(new_n420_));
  oai21  g320(.a(x15), .b(x14), .c(new_n191_), .O(new_n421_));
  oai21  g321(.a(new_n182_), .b(new_n420_), .c(x13), .O(new_n422_));
  oai21  g322(.a(new_n421_), .b(new_n420_), .c(new_n422_), .O(new_n423_));
  nand3  g323(.a(new_n423_), .b(x71), .c(new_n144_), .O(new_n424_));
  ...
  nand3  g338(.a(new_n438_), .b(new_n130_), .c(x65), .O(new_n439_));
  nand2  g339(.a(new_n439_), .b(new_n424_), .O(new_n440_));
  nand3  g340(.a(new_n440_), .b(new_n156_), .c(x68), .O(new_n441_));
  ...
  nand3  g357(.a(new_n457_), .b(new_n145_), .c(x65), .O(new_n458_));
  ...
  nand2  g366(.a(new_n466_), .b(new_n130_), .O(new_n467_));
  nand3  g367(.a(new_n467_), .b(new_n465_), .c(new_n463_), .O(new_n468_));
  nand4  g368(.a(new_n468_), .b(x69), .c(new_n145_), .d(x65), .O(new_n469_));
  nor2   g369(.a(new_n206_), .b(x45), .O(new_n470_));
  nand2  g370(.a(new_n470_), .b(x32), .O(new_n471_));
  oai21  g371(.a(new_n206_), .b(new_n159_), .c(x45), .O(new_n472_));
  aoi21  g372(.a(new_n472_), .b(new_n471_), .c(x71), .O(new_n473_));
  nand4  g373(.a(new_n473_), .b(new_n156_), .c(x68), .d(new_n144_), .O(new_n474_));
  aoi21  g374(.a(new_n474_), .b(new_n469_), .c(new_n110_), .O(new_n475_));
  oai21  g375(.a(new_n475_), .b(new_n459_), .c(new_n93_), .O(new_n476_));
  nand3  g376(.a(new_n423_), .b(x71), .c(new_n110_), .O(new_n477_));
  nand2  g377(.a(new_n473_), .b(x70), .O(new_n478_));
  nand2  g378(.a(new_n478_), .b(new_n477_), .O(new_n479_));
  nand4  g379(.a(new_n479_), .b(new_n156_), .c(x68), .d(new_n140_), .O(new_n480_));
  inv1   g380(.a(new_n480_), .O(new_n481_));
  nand3  g381(.a(new_n481_), .b(new_n139_), .c(x65), .O(new_n482_));
  nand2  g382(.a(new_n482_), .b(new_n476_), .O(new_n483_));
  nand2  g383(.a(new_n483_), .b(new_n341_), .O(new_n484_));
  nand2  g384(.a(new_n157_), .b(x13), .O(new_n485_));
  oai22  g385(.a(new_n160_), .b(new_n460_), .c(new_n130_), .d(new_n215_), .O(new_n486_));
  nand2  g386(.a(new_n486_), .b(x70), .O(new_n487_));
  nand3  g387(.a(new_n135_), .b(x69), .c(x61), .O(new_n488_));
  nand3  g388(.a(new_n488_), .b(new_n487_), .c(new_n485_), .O(new_n489_));
  nand2  g389(.a(new_n489_), .b(x67), .O(new_n490_));
  nand2  g390(.a(new_n455_), .b(new_n148_), .O(new_n491_));
  nand3  g391(.a(new_n438_), .b(x71), .c(x70), .O(new_n492_));
  nand2  g392(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  nand3  g393(.a(new_n493_), .b(x69), .c(new_n140_), .O(new_n494_));
  aoi21  g394(.a(new_n494_), .b(new_n490_), .c(x68), .O(new_n495_));
  nand2  g395(.a(new_n438_), .b(new_n140_), .O(new_n496_));
  nand2  g396(.a(x67), .b(x45), .O(new_n497_));
  nand2  g397(.a(new_n497_), .b(new_n496_), .O(new_n498_));
  nand4  g398(.a(new_n498_), .b(new_n130_), .c(new_n110_), .d(new_n156_), .O(new_n499_));
  nor2   g399(.a(new_n499_), .b(new_n145_), .O(new_n500_));
  oai21  g400(.a(new_n500_), .b(new_n495_), .c(new_n139_), .O(new_n501_));
  nand2  g401(.a(new_n489_), .b(new_n145_), .O(new_n502_));
  nand3  g402(.a(new_n165_), .b(x68), .c(x45), .O(new_n503_));
  nand2  g403(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  nand3  g404(.a(new_n504_), .b(new_n140_), .c(x66), .O(new_n505_));
  nand2  g405(.a(new_n505_), .b(new_n501_), .O(new_n506_));
  nand3  g406(.a(new_n506_), .b(new_n144_), .c(x64), .O(new_n507_));
