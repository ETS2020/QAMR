...
module FAU ( 
  ...
  wire new_n106_, new_n107_, new_n108_, new_n109_, new_n110_, new_n111_,
    ...
    new_n232_, new_n233_, new_n243_, new_n244_, new_n262_, new_n263_,
  ...
  inv1   g036(.a(x03), .O(new_n142_));
  inv1   g037(.a(x05), .O(new_n143_));
  nand2  g038(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  aoi21  g039(.a(new_n144_), .b(new_n124_), .c(x30), .O(new_n145_));
  oai21  g040(.a(new_n145_), .b(x18), .c(new_n141_), .O(new_n146_));
  nand2  g041(.a(new_n146_), .b(new_n125_), .O(new_n147_));
  oai21  g042(.a(new_n118_), .b(new_n124_), .c(x18), .O(new_n148_));
  nand3  g043(.a(new_n148_), .b(new_n108_), .c(x28), .O(new_n149_));
  nand2  g044(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g045(.a(x30), .b(new_n125_), .c(x22), .O(new_n151_));
  nor3   g046(.a(new_n151_), .b(new_n124_), .c(x18), .O(new_n152_));
  aoi21  g047(.a(new_n150_), .b(new_n139_), .c(new_n152_), .O(new_n153_));
  aoi21  g048(.a(new_n153_), .b(new_n138_), .c(new_n107_), .O(new_n154_));
  and2   g049(.a(x24), .b(x20), .O(new_n155_));
  xor2a  g050(.a(x20), .b(x02), .O(new_n156_));
  nand3  g051(.a(new_n156_), .b(new_n142_), .c(x00), .O(new_n157_));
  nand2  g052(.a(new_n142_), .b(x02), .O(new_n158_));
  nand3  g053(.a(new_n158_), .b(x20), .c(x06), .O(new_n159_));
  aoi21  g054(.a(new_n159_), .b(new_n157_), .c(new_n125_), .O(new_n160_));
  oai21  g055(.a(new_n160_), .b(new_n155_), .c(new_n139_), .O(new_n161_));
  ...
  oai21  g070(.a(new_n175_), .b(new_n154_), .c(new_n106_), .O(new_n176_));
  ...
  inv1   g132(.a(x15), .O(new_n262_));
  nand4  g133(.a(new_n109_), .b(new_n262_), .c(new_n143_), .d(x00), .O(new_n263_));
  inv1   g134(.a(new_n263_), .O(new_n264_));
  nand4  g135(.a(new_n264_), .b(x21), .c(x20), .d(x19), .O(new_n265_));
  inv1   g136(.a(new_n265_), .O(new_n266_));
  nand4  g137(.a(new_n266_), .b(new_n107_), .c(new_n125_), .d(x22), .O(new_n267_));
  nor2   g138(.a(new_n267_), .b(new_n108_), .O(z41));
  zero   g139(.O(z00));
  zero   g140(.O(z01));
  zero   g141(.O(z02));
  zero   g142(.O(z03));
  ...
  zero   g178(.O(z42));
  zero   g179(.O(z43));
  nor3   g180(.a(new_n244_), .b(new_n108_), .c(x29), .O(z44));
endmodule
