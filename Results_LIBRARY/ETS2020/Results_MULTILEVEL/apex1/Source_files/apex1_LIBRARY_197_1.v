// Benchmark "FAU" written by ABC on Fri Jul 24 09:42:17 2020
...
module FAU ( 
  ...
  wire new_n106_, new_n107_, new_n108_, new_n109_, new_n110_, new_n111_,
    ...
    new_n232_, new_n233_, new_n243_, new_n244_, new_n264_, new_n265_,
    new_n266_;
  ...
  oai21  g132(.a(x24), .b(x22), .c(x30), .O(new_n264_));
  nor2   g133(.a(new_n264_), .b(x29), .O(new_n265_));
  nand4  g134(.a(new_n265_), .b(new_n106_), .c(x20), .d(new_n139_), .O(new_n266_));
  nor2   g135(.a(new_n266_), .b(x18), .O(z43));
  zero   g136(.O(z00));
  zero   g137(.O(z01));
  zero   g138(.O(z02));
  zero   g139(.O(z03));
  ...
  zero   g175(.O(z41));
  zero   g176(.O(z42));
  nor3   g177(.a(new_n244_), .b(new_n108_), .c(x29), .O(z44));
endmodule
