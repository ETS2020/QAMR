// Benchmark "FAU" written by ABC on Fri Jul 24 09:39:44 2020
...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n1771_, new_n1772_, new_n1773_, new_n1776_, new_n1777_, new_n1779_;
  ...
  nand4  g1685(.a(new_n102_), .b(x22), .c(new_n148_), .d(x20), .O(new_n1779_));
  nor3   g1686(.a(new_n1779_), .b(new_n127_), .c(x29), .O(z44));
  zero   g1687(.O(z02));
  zero   g1688(.O(z24));
  zero   g1689(.O(z42));
endmodule
