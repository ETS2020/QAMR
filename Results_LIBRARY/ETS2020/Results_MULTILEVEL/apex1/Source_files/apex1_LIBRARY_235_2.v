...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n1705_, new_n1706_, new_n1709_, new_n1710_;
  ...
  nor3   g1614(.a(new_n1016_), .b(new_n125_), .c(x29), .O(new_n1709_));
  nand4  g1615(.a(new_n1709_), .b(new_n146_), .c(x20), .d(new_n98_), .O(new_n1710_));
  nor2   g1616(.a(new_n1710_), .b(x18), .O(z43));
  zero   g1617(.O(z02));
  zero   g1618(.O(z24));
  zero   g1619(.O(z36));
  zero   g1620(.O(z42));
