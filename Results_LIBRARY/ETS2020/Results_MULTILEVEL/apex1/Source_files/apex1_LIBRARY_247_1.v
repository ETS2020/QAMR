// Benchmark "FAU" written by ABC on Fri Jul 24 09:43:23 2020
...
module FAU ( 
  ...
  wire new_n97_, new_n98_, new_n99_, new_n100_, new_n101_, new_n102_,
    ...
    new_n157_, new_n158_, new_n159_, new_n160_, new_n176_, new_n177_,
    new_n178_, new_n182_, new_n183_;
  ...
  nand4  g065(.a(new_n110_), .b(x20), .c(new_n98_), .d(x18), .O(new_n176_));
  inv1   g066(.a(new_n176_), .O(new_n177_));
  nand4  g067(.a(new_n177_), .b(x29), .c(x28), .d(x26), .O(new_n178_));
  nor2   g068(.a(new_n178_), .b(x30), .O(z21));
  nor2   g069(.a(x19), .b(x18), .O(new_n182_));
  nand4  g070(.a(new_n182_), .b(x22), .c(new_n110_), .d(x20), .O(new_n183_));
  nor3   g071(.a(new_n183_), .b(new_n127_), .c(x29), .O(z24));
  zero   g072(.O(z00));
  zero   g073(.O(z01));
  zero   g074(.O(z02));
  zero   g075(.O(z03));
  ...
  zero   g111(.O(z42));
  zero   g112(.O(z43));
  nor3   g113(.a(new_n183_), .b(new_n127_), .c(x29), .O(z44));
endmodule
