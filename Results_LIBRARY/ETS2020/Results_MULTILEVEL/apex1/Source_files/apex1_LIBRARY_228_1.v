// Benchmark "FAU" written by ABC on Fri Jul 24 09:42:57 2020
...
module FAU ( 
  ...
  wire new_n104_, new_n105_, new_n106_, new_n107_, new_n108_, new_n109_,
    ...
    new_n200_, new_n201_, new_n202_, new_n203_, new_n212_, new_n213_,
    new_n214_, new_n218_, new_n219_;
  ...
  nand4  g101(.a(new_n123_), .b(x20), .c(new_n111_), .d(x18), .O(new_n212_));
  inv1   g102(.a(new_n212_), .O(new_n213_));
  nand4  g103(.a(new_n213_), .b(x29), .c(x28), .d(x26), .O(new_n214_));
  nor2   g104(.a(new_n214_), .b(x30), .O(z21));
  nor2   g105(.a(x19), .b(x18), .O(new_n218_));
  nand4  g106(.a(new_n218_), .b(x22), .c(new_n123_), .d(x20), .O(new_n219_));
  nor3   g107(.a(new_n219_), .b(new_n158_), .c(x29), .O(z24));
  zero   g108(.O(z00));
  zero   g109(.O(z01));
  zero   g110(.O(z02));
  zero   g111(.O(z03));
  ...
  zero   g147(.O(z42));
  zero   g148(.O(z43));
  nor3   g149(.a(new_n219_), .b(new_n158_), .c(x29), .O(z44));
endmodule
