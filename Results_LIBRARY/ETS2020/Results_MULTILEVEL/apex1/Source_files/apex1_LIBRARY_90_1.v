...
module FAU ( 
  ...
  wire new_n115_, new_n116_, new_n117_, new_n118_, new_n122_, new_n123_,
    ...
    new_n148_, new_n149_, new_n150_, new_n167_, new_n168_, new_n169_;
  ...
  oai21  g35(.a(x24), .b(x22), .c(x30), .O(new_n167_));
  nor2   g36(.a(new_n167_), .b(x29), .O(new_n168_));
  nand3  g37(.a(new_n168_), .b(new_n116_), .c(x20), .O(new_n169_));
  nor3   g38(.a(new_n169_), .b(x19), .c(x18), .O(z43));
  zero   g39(.O(z00));
  zero   g40(.O(z01));
  zero   g41(.O(z02));
  zero   g42(.O(z03));
  ...
  zero   g78(.O(z41));
  zero   g79(.O(z42));
  nor3   g80(.a(new_n118_), .b(new_n115_), .c(x29), .O(z44));
endmodule
