...
module FAU ( 
  ...
  inv1   g066(.a(x05), .O(new_n196_));
  inv1   g067(.a(x15), .O(new_n197_));
  nand4  g068(.a(new_n134_), .b(new_n197_), .c(new_n196_), .d(x00), .O(new_n198_));
  nor3   g069(.a(new_n198_), .b(new_n135_), .c(new_n175_), .O(new_n199_));
  nand4  g070(.a(new_n199_), .b(new_n140_), .c(x22), .d(x21), .O(new_n200_));
  nor3   g071(.a(new_n200_), .b(new_n115_), .c(x29), .O(z41));
  zero   g072(.O(z00));
  zero   g073(.O(z01));
  zero   g074(.O(z02));
  zero   g075(.O(z03));
  ...
  zero   g111(.O(z42));
  zero   g112(.O(z43));
  nor3   g113(.a(new_n118_), .b(new_n115_), .c(x29), .O(z44));
endmodule
