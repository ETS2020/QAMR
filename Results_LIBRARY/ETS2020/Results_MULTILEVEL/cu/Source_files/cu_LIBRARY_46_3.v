...
module FAU ( 
  ...
  aoi21  g33(.a(new_n59_), .b(new_n56_), .c(new_n40_), .O(new_n60_));
  ...
  nand4  g39(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n66_));
  ...
  nand3  g46(.a(new_n73_), .b(x06), .c(new_n26_), .O(new_n74_));
