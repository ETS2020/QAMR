// Benchmark "FAU" written by ABC on Fri Jul 24 00:29:47 2020
...
module FAU ( 
  ...
  nand4  g42(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n70_));
