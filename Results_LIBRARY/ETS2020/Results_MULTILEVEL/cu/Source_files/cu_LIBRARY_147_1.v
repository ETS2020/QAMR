...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_;
  ...
  nand3  g10(.a(new_n30_), .b(new_n42_), .c(x02), .O(new_n43_));
  inv1   g11(.a(x12), .O(new_n44_));
  nand4  g12(.a(x13), .b(new_n44_), .c(x05), .d(new_n32_), .O(new_n45_));
  nand2  g13(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand3  g14(.a(new_n46_), .b(x04), .c(new_n33_), .O(new_n47_));
