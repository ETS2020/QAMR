...
module FAU ( 
  ...
  nor3   g21(.a(x02), .b(new_n41_), .c(new_n47_), .O(new_n48_));
  ...
  nand4  g38(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n65_));
