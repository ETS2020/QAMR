...
module FAU ( 
  ...
  nand4  g29(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n56_));
  nor2   g30(.a(new_n56_), .b(x02), .O(z07));
  nand3  g31(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n58_));
  inv1   g32(.a(x12), .O(new_n59_));
  nand4  g33(.a(x13), .b(new_n59_), .c(x05), .d(new_n27_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n65_), .b(x06), .c(new_n26_), .O(new_n66_));
  inv1   g40(.a(new_n66_), .O(z10));
  zero   g41(.O(z06));
endmodule
