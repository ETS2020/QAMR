...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n74_, new_n75_, new_n76_, new_n77_, new_n83_,
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n89_, new_n90_,
    new_n91_, new_n93_, new_n95_, new_n97_, new_n98_;
  ...
  nand3  g30(.a(new_n74_), .b(x11), .c(x10), .O(new_n75_));
  oai21  g31(.a(new_n75_), .b(x09), .c(x01), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(x02), .c(x00), .O(new_n77_));
  inv1   g33(.a(new_n77_), .O(z07));
  inv1   g34(.a(x24), .O(new_n83_));
  nand2  g35(.a(x10), .b(x02), .O(new_n84_));
  nand3  g36(.a(new_n84_), .b(x01), .c(x00), .O(new_n85_));
  oai21  g37(.a(x19), .b(x02), .c(x23), .O(new_n86_));
  nand3  g38(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n87_));
  nand2  g39(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g40(.a(new_n88_), .b(new_n60_), .c(new_n59_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nand3  g42(.a(new_n90_), .b(new_n83_), .c(x09), .O(new_n91_));
  inv1   g43(.a(new_n91_), .O(z12));
  nand2  g44(.a(new_n47_), .b(x17), .O(new_n93_));
  nor2   g45(.a(new_n93_), .b(x19), .O(z13));
  nand4  g46(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n95_));
  nor2   g47(.a(new_n95_), .b(x19), .O(z14));
  aoi21  g48(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n97_));
  nand3  g49(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n98_));
  oai21  g50(.a(new_n97_), .b(new_n59_), .c(new_n98_), .O(z15));
  nor2   g51(.a(new_n60_), .b(x00), .O(z16));
  zero   g52(.O(z06));
  zero   g53(.O(z08));
  zero   g54(.O(z09));
  zero   g55(.O(z10));
