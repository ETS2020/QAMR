...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n78_, new_n79_, new_n80_,
  ...
  nand4  g34(.a(x12), .b(new_n68_), .c(x02), .d(new_n60_), .O(new_n80_));
  inv1   g35(.a(x15), .O(new_n81_));
  inv1   g36(.a(x16), .O(new_n82_));
  nor2   g37(.a(x14), .b(x13), .O(new_n83_));
  nand4  g38(.a(new_n83_), .b(x20), .c(new_n82_), .d(new_n81_), .O(new_n84_));
  inv1   g39(.a(x20), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n63_), .c(x18), .d(x01), .O(new_n86_));
  oai21  g41(.a(new_n84_), .b(new_n80_), .c(new_n86_), .O(new_n87_));
  nand4  g42(.a(new_n87_), .b(new_n79_), .c(new_n78_), .d(new_n59_), .O(new_n88_));
  ...
  nand3  g62(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n110_));
  inv1   g63(.a(new_n110_), .O(z17));
  zero   g64(.O(z07));
  zero   g65(.O(z08));
  zero   g66(.O(z10));
  zero   g67(.O(z11));
