...
module FAU ( 
  ...
  nand2  g41(.a(x10), .b(x02), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(x01), .c(x00), .O(new_n90_));
  oai21  g43(.a(x19), .b(x02), .c(x23), .O(new_n91_));
  nand3  g44(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n92_));
  nand2  g45(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g46(.a(new_n93_), .b(new_n60_), .c(new_n59_), .O(new_n94_));
  aoi21  g47(.a(new_n94_), .b(new_n90_), .c(x24), .O(new_n95_));
  nand2  g48(.a(new_n95_), .b(x09), .O(new_n96_));
  inv1   g49(.a(new_n96_), .O(z12));
  nand2  g50(.a(new_n47_), .b(x17), .O(new_n98_));
  nor2   g51(.a(new_n98_), .b(x19), .O(z13));
  nand4  g52(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n100_));
  nor2   g53(.a(new_n100_), .b(x19), .O(z14));
  aoi21  g54(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n102_));
  nand3  g55(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n103_));
  oai21  g56(.a(new_n102_), .b(new_n59_), .c(new_n103_), .O(z15));
  nor2   g57(.a(new_n60_), .b(x00), .O(z16));
  nand3  g58(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n106_));
  inv1   g59(.a(new_n106_), .O(z17));
  zero   g60(.O(z07));
  zero   g61(.O(z09));
  zero   g62(.O(z10));
  zero   g63(.O(z11));
