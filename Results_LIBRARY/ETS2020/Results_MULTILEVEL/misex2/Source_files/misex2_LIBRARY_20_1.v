// Benchmark "FAU" written by ABC on Fri Jul 24 17:37:32 2020
...
module FAU ( 
  ...
  nand2  g49(.a(x10), .b(x02), .O(new_n100_));
  nand3  g50(.a(new_n100_), .b(x01), .c(x00), .O(new_n101_));
  oai21  g51(.a(x19), .b(x02), .c(x23), .O(new_n102_));
  nand3  g52(.a(new_n56_), .b(x17), .c(new_n73_), .O(new_n103_));
  nand2  g53(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g54(.a(new_n104_), .b(new_n62_), .c(new_n61_), .O(new_n105_));
  aoi21  g55(.a(new_n105_), .b(new_n101_), .c(x24), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(x09), .O(new_n107_));
  inv1   g57(.a(new_n107_), .O(z12));
  nand3  g58(.a(new_n73_), .b(new_n62_), .c(new_n61_), .O(new_n110_));
  nor4   g59(.a(new_n110_), .b(x17), .c(x10), .d(x09), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n58_), .O(new_n112_));
  nor2   g61(.a(new_n112_), .b(x19), .O(z14));
  zero   g62(.O(z00));
  zero   g63(.O(z01));
  zero   g64(.O(z02));
  zero   g65(.O(z03));
