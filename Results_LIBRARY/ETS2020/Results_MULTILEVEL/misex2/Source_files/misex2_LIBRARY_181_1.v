...
module FAU ( 
  ...
  nand3  g53(.a(new_n69_), .b(new_n58_), .c(new_n57_), .O(new_n106_));
  nor4   g54(.a(new_n106_), .b(x17), .c(x10), .d(x09), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  nor2   g56(.a(new_n108_), .b(x19), .O(z14));
  nor2   g57(.a(new_n58_), .b(x00), .O(z16));
  zero   g58(.O(z00));
  zero   g59(.O(z01));
  zero   g60(.O(z02));
  zero   g61(.O(z03));
