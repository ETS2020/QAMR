// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:18 2020
...
module FAU ( 
  ...
  nor3   g39(.a(new_n84_), .b(new_n83_), .c(x20), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n63_), .c(x18), .d(x01), .O(new_n86_));
  inv1   g41(.a(x13), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(x12), .c(new_n68_), .O(new_n88_));
  nor3   g43(.a(new_n88_), .b(new_n61_), .c(x01), .O(new_n89_));
  nand2  g44(.a(x16), .b(x15), .O(new_n90_));
  nand3  g45(.a(new_n84_), .b(new_n83_), .c(x20), .O(new_n91_));
  nor3   g46(.a(new_n91_), .b(new_n90_), .c(x14), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  aoi21  g48(.a(new_n93_), .b(new_n86_), .c(x00), .O(z10));
  inv1   g49(.a(x24), .O(new_n96_));
  nand2  g50(.a(x10), .b(x02), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(x01), .c(x00), .O(new_n98_));
  oai21  g52(.a(x19), .b(x02), .c(x23), .O(new_n99_));
  nand3  g53(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n60_), .c(new_n59_), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n96_), .c(x09), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(z12));
  nand2  g59(.a(new_n47_), .b(x17), .O(new_n106_));
  nor2   g60(.a(new_n106_), .b(x19), .O(z13));
  nand4  g61(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n108_));
  nor2   g62(.a(new_n108_), .b(x19), .O(z14));
  aoi21  g63(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n110_));
  nand3  g64(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n59_), .c(new_n111_), .O(z15));
  nor2   g66(.a(new_n60_), .b(x00), .O(z16));
  zero   g67(.O(z08));
  zero   g68(.O(z09));
  zero   g69(.O(z11));
  zero   g70(.O(z17));
