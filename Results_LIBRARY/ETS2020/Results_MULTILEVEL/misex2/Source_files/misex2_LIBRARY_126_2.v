...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n70_, new_n72_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
  ...
  nand3  g15(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  inv1   g16(.a(x19), .O(new_n61_));
  nand3  g17(.a(new_n61_), .b(x18), .c(new_n44_), .O(new_n62_));
  nand3  g18(.a(x02), .b(x01), .c(x00), .O(new_n63_));
  nand4  g19(.a(x12), .b(x11), .c(x10), .d(new_n46_), .O(new_n64_));
  oai22  g20(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(new_n60_), .O(z03));
  nand3  g21(.a(x02), .b(x01), .c(x00), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(new_n67_));
  nand3  g23(.a(new_n67_), .b(x10), .c(new_n46_), .O(new_n68_));
  nor3   g24(.a(new_n68_), .b(x12), .c(x11), .O(z04));
  inv1   g25(.a(x10), .O(new_n70_));
  nor3   g26(.a(new_n66_), .b(new_n70_), .c(new_n46_), .O(z05));
  nand4  g27(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n72_));
  nor3   g28(.a(new_n72_), .b(new_n58_), .c(new_n57_), .O(z06));
  ...
  nand3  g33(.a(new_n61_), .b(x17), .c(new_n59_), .O(new_n83_));
  nand2  g34(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g35(.a(new_n84_), .b(new_n58_), .c(new_n57_), .O(new_n85_));
  ...
  nand4  g41(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n70_), .O(new_n91_));
  nor2   g42(.a(new_n91_), .b(x19), .O(z14));
  aoi21  g43(.a(new_n70_), .b(x01), .c(new_n59_), .O(new_n93_));
  nand3  g44(.a(x19), .b(new_n59_), .c(new_n58_), .O(new_n94_));
  oai21  g45(.a(new_n93_), .b(new_n57_), .c(new_n94_), .O(z15));
  nor2   g46(.a(new_n58_), .b(x00), .O(z16));
  nand3  g47(.a(x02), .b(new_n58_), .c(new_n57_), .O(new_n97_));
