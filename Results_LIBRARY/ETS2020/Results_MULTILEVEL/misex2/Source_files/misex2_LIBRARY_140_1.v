...
module FAU ( 
  ...
  nand2  g44(.a(x10), .b(x02), .O(new_n96_));
  nand3  g45(.a(new_n96_), .b(x01), .c(x00), .O(new_n97_));
  oai21  g46(.a(x19), .b(x02), .c(x23), .O(new_n98_));
  nand3  g47(.a(new_n52_), .b(x17), .c(new_n69_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand3  g49(.a(new_n100_), .b(new_n58_), .c(new_n57_), .O(new_n101_));
  aoi21  g50(.a(new_n101_), .b(new_n97_), .c(x24), .O(new_n102_));
  nand2  g51(.a(new_n102_), .b(x09), .O(new_n103_));
  inv1   g52(.a(new_n103_), .O(z12));
  nor2   g53(.a(new_n58_), .b(x00), .O(z16));
  nand3  g54(.a(x02), .b(new_n58_), .c(new_n57_), .O(new_n109_));
  inv1   g55(.a(new_n109_), .O(z17));
  zero   g56(.O(z00));
  zero   g57(.O(z01));
  zero   g58(.O(z02));
  zero   g59(.O(z03));
