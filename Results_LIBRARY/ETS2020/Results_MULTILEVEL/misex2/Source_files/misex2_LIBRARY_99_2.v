...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n90_, new_n93_,
    new_n94_;
  ...
  aoi21  g43(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n93_));
  nand3  g44(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n94_));
  oai21  g45(.a(new_n93_), .b(new_n59_), .c(new_n94_), .O(z15));
  nor2   g46(.a(new_n60_), .b(x00), .O(z16));
  zero   g47(.O(z07));
  zero   g48(.O(z08));
  zero   g49(.O(z09));
  zero   g50(.O(z10));
