...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n73_, new_n74_, new_n75_, new_n76_, new_n82_, new_n83_,
  ...
  inv1   g33(.a(x24), .O(new_n82_));
  nand2  g34(.a(x10), .b(x02), .O(new_n83_));
  nand3  g35(.a(new_n83_), .b(x01), .c(x00), .O(new_n84_));
  oai21  g36(.a(x19), .b(x02), .c(x23), .O(new_n85_));
  nand3  g37(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n86_));
  nand2  g38(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g39(.a(new_n87_), .b(new_n47_), .c(new_n46_), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand3  g41(.a(new_n89_), .b(new_n82_), .c(x09), .O(new_n90_));
  inv1   g42(.a(new_n90_), .O(z12));
  nand4  g43(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n93_));
  nor2   g44(.a(new_n93_), .b(x19), .O(z14));
  aoi21  g45(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n95_));
  nand3  g46(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n96_));
  oai21  g47(.a(new_n95_), .b(new_n46_), .c(new_n96_), .O(z15));
