...
module FAU ( 
  ...
  nand4  g30(.a(new_n77_), .b(x21), .c(new_n76_), .d(new_n52_), .O(new_n83_));
  inv1   g31(.a(x13), .O(new_n84_));
  nand4  g32(.a(new_n70_), .b(new_n84_), .c(x12), .d(new_n68_), .O(new_n85_));
  nor2   g33(.a(new_n72_), .b(x14), .O(new_n86_));
  nand4  g34(.a(new_n86_), .b(new_n66_), .c(x20), .d(new_n73_), .O(new_n87_));
  oai21  g35(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n88_));
  nand3  g36(.a(new_n88_), .b(new_n67_), .c(new_n57_), .O(new_n89_));
  inv1   g37(.a(new_n89_), .O(z11));
  nor2   g38(.a(new_n58_), .b(x00), .O(z16));
  nand3  g39(.a(x02), .b(new_n58_), .c(new_n57_), .O(new_n96_));
