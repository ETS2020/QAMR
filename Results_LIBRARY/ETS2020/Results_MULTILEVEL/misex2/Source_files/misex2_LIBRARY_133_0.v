// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:16 2020
...
module FAU ( 
  ...
  nand4  g77(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(x19), .O(z14));
  aoi21  g79(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n124_));
  nand3  g80(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n125_));
  oai21  g81(.a(new_n124_), .b(new_n59_), .c(new_n125_), .O(z15));
  nor2   g82(.a(new_n60_), .b(x00), .O(z16));
  nand3  g83(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n128_));
