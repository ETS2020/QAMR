...
module FAU ( 
  ...
  nand3  g55(.a(new_n59_), .b(x17), .c(new_n45_), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g57(.a(new_n106_), .b(new_n65_), .c(new_n64_), .O(new_n107_));
  aoi21  g58(.a(new_n107_), .b(new_n103_), .c(x24), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(x09), .O(new_n109_));
  inv1   g60(.a(new_n109_), .O(z12));
  nor2   g61(.a(new_n65_), .b(x00), .O(z16));
  nand2  g62(.a(new_n46_), .b(x02), .O(new_n115_));
  inv1   g63(.a(new_n115_), .O(z17));
  zero   g64(.O(z00));
  zero   g65(.O(z02));
  zero   g66(.O(z03));
  zero   g67(.O(z04));
