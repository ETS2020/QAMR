// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:23 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n79_, new_n80_, new_n81_,
  ...
  nor3   g34(.a(new_n80_), .b(new_n79_), .c(x20), .O(new_n81_));
  nand4  g35(.a(new_n81_), .b(new_n63_), .c(x18), .d(x01), .O(new_n82_));
  inv1   g36(.a(x13), .O(new_n83_));
  nand3  g37(.a(new_n83_), .b(x12), .c(new_n68_), .O(new_n84_));
  nor3   g38(.a(new_n84_), .b(new_n61_), .c(x01), .O(new_n85_));
  nand2  g39(.a(x16), .b(x15), .O(new_n86_));
  nand3  g40(.a(new_n80_), .b(new_n79_), .c(x20), .O(new_n87_));
  nor3   g41(.a(new_n87_), .b(new_n86_), .c(x14), .O(new_n88_));
  nand2  g42(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  aoi21  g43(.a(new_n89_), .b(new_n82_), .c(x00), .O(z10));
  inv1   g44(.a(x24), .O(new_n92_));
  nand2  g45(.a(x10), .b(x02), .O(new_n93_));
  nand3  g46(.a(new_n93_), .b(x01), .c(x00), .O(new_n94_));
  oai21  g47(.a(x19), .b(x02), .c(x23), .O(new_n95_));
  nand3  g48(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n96_));
  nand2  g49(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g50(.a(new_n97_), .b(new_n60_), .c(new_n59_), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nand3  g52(.a(new_n99_), .b(new_n92_), .c(x09), .O(new_n100_));
  inv1   g53(.a(new_n100_), .O(z12));
  nand2  g54(.a(new_n47_), .b(x17), .O(new_n102_));
  nor2   g55(.a(new_n102_), .b(x19), .O(z13));
  nand4  g56(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n104_));
  nor2   g57(.a(new_n104_), .b(x19), .O(z14));
  aoi21  g58(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n106_));
  nand3  g59(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n107_));
  oai21  g60(.a(new_n106_), .b(new_n59_), .c(new_n107_), .O(z15));
  nor2   g61(.a(new_n60_), .b(x00), .O(z16));
  zero   g62(.O(z07));
  zero   g63(.O(z08));
  zero   g64(.O(z09));
  zero   g65(.O(z11));
