// Benchmark "FAU" written by ABC on Fri Jul 24 17:37:47 2020
...
module FAU ( 
  ...
  inv1   g36(.a(x24), .O(new_n84_));
  nand2  g37(.a(x10), .b(x02), .O(new_n85_));
  nand3  g38(.a(new_n85_), .b(x01), .c(x00), .O(new_n86_));
  oai21  g39(.a(x19), .b(x02), .c(x23), .O(new_n87_));
  nand3  g40(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n88_));
  nand2  g41(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(new_n60_), .c(new_n59_), .O(new_n90_));
  nand2  g43(.a(new_n90_), .b(new_n86_), .O(new_n91_));
  nand3  g44(.a(new_n91_), .b(new_n84_), .c(x09), .O(new_n92_));
  inv1   g45(.a(new_n92_), .O(z12));
  nand2  g46(.a(new_n47_), .b(x17), .O(new_n94_));
  nor2   g47(.a(new_n94_), .b(x19), .O(z13));
  nand4  g48(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n96_));
  nor2   g49(.a(new_n96_), .b(x19), .O(z14));
  aoi21  g50(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n98_));
  nand3  g51(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n99_));
  oai21  g52(.a(new_n98_), .b(new_n59_), .c(new_n99_), .O(z15));
  nor2   g53(.a(new_n60_), .b(x00), .O(z16));
  nand3  g54(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(z17));
  zero   g56(.O(z08));
  zero   g57(.O(z09));
  zero   g58(.O(z10));
  zero   g59(.O(z11));
