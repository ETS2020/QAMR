...
module FAU ( 
  ...
  nand4  g30(.a(new_n80_), .b(new_n56_), .c(x18), .d(x01), .O(new_n81_));
  oai21  g31(.a(new_n79_), .b(new_n75_), .c(new_n81_), .O(new_n82_));
  nand4  g32(.a(new_n82_), .b(new_n71_), .c(new_n70_), .d(new_n61_), .O(new_n83_));
  inv1   g33(.a(new_n83_), .O(z09));
  nor3   g34(.a(new_n71_), .b(new_n70_), .c(x20), .O(new_n85_));
  nand4  g35(.a(new_n85_), .b(new_n56_), .c(x18), .d(x01), .O(new_n86_));
  inv1   g36(.a(x13), .O(new_n87_));
  nand3  g37(.a(new_n87_), .b(x12), .c(new_n72_), .O(new_n88_));
  inv1   g38(.a(new_n88_), .O(new_n89_));
  nor3   g39(.a(new_n77_), .b(new_n76_), .c(x14), .O(new_n90_));
  nand3  g40(.a(new_n71_), .b(new_n70_), .c(x20), .O(new_n91_));
  inv1   g41(.a(new_n91_), .O(new_n92_));
  nand4  g42(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n74_), .O(new_n93_));
  aoi21  g43(.a(new_n93_), .b(new_n86_), .c(x00), .O(z10));
  nor2   g44(.a(new_n62_), .b(x00), .O(z16));
  zero   g45(.O(z00));
  zero   g46(.O(z01));
  zero   g47(.O(z02));
  zero   g48(.O(z03));
