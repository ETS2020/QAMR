...
module FAU ( 
  ...
  nand4  g61(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n106_));
  nor2   g62(.a(x13), .b(new_n76_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n93_), .c(new_n68_), .O(new_n108_));
  nor2   g64(.a(new_n95_), .b(x14), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n91_), .c(x20), .d(new_n96_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n92_), .c(new_n59_), .O(new_n112_));
  ...
  nand3  g72(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n60_), .c(new_n59_), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n115_), .c(x24), .O(new_n120_));
  ...
  nand4  g80(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n125_));
  nor2   g81(.a(new_n125_), .b(x19), .O(z14));
  aoi21  g82(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n127_));
  nand3  g83(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n128_));
  oai21  g84(.a(new_n127_), .b(new_n59_), .c(new_n128_), .O(z15));
  nor2   g85(.a(new_n60_), .b(x00), .O(z16));
  nand3  g86(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n131_));
