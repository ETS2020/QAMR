// Benchmark "FAU" written by ABC on Fri Jul 24 17:37:57 2020
...
module FAU ( 
  ...
  nand2  g70(.a(new_n47_), .b(x17), .O(new_n116_));
  nor2   g71(.a(new_n116_), .b(x19), .O(z13));
  nand4  g72(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(x19), .O(z14));
  aoi21  g74(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n120_));
  nand3  g75(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n121_));
  oai21  g76(.a(new_n120_), .b(new_n59_), .c(new_n121_), .O(z15));
  nor2   g77(.a(new_n60_), .b(x00), .O(z16));
  nand3  g78(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n124_));
