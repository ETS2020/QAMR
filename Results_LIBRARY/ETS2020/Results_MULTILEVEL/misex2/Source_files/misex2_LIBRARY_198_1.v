// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:36 2020
...
module FAU ( 
  ...
  nand3  g44(.a(new_n69_), .b(new_n58_), .c(new_n57_), .O(new_n98_));
  nor4   g45(.a(new_n98_), .b(x17), .c(x10), .d(x09), .O(new_n99_));
  nand2  g46(.a(new_n99_), .b(new_n54_), .O(new_n100_));
  nor2   g47(.a(new_n100_), .b(x19), .O(z14));
  nor2   g48(.a(new_n58_), .b(x00), .O(z16));
  zero   g49(.O(z00));
  zero   g50(.O(z01));
  zero   g51(.O(z02));
  zero   g52(.O(z03));
