...
module FAU ( 
  ...
  wire new_n50_, new_n51_, new_n52_, new_n53_, new_n55_, new_n56_, new_n57_,
    ...
    new_n97_, new_n98_, new_n99_, new_n100_, new_n107_;
  ...
  nand3  g06(.a(new_n55_), .b(x11), .c(x10), .O(new_n56_));
  oai21  g07(.a(new_n56_), .b(x09), .c(x01), .O(new_n57_));
  nand3  g08(.a(new_n57_), .b(x02), .c(x00), .O(new_n58_));
  inv1   g09(.a(new_n58_), .O(z07));
  inv1   g10(.a(x19), .O(new_n60_));
  inv1   g11(.a(x08), .O(new_n61_));
  inv1   g12(.a(x18), .O(new_n62_));
  inv1   g13(.a(x05), .O(new_n63_));
  inv1   g14(.a(x06), .O(new_n64_));
  inv1   g15(.a(x03), .O(new_n65_));
  nand4  g16(.a(new_n65_), .b(x02), .c(new_n51_), .d(new_n50_), .O(new_n66_));
  inv1   g17(.a(new_n66_), .O(new_n67_));
  nand4  g18(.a(new_n67_), .b(new_n64_), .c(new_n63_), .d(x04), .O(new_n68_));
  nor2   g19(.a(new_n68_), .b(x07), .O(new_n69_));
  nand4  g20(.a(new_n69_), .b(new_n62_), .c(x17), .d(new_n61_), .O(new_n70_));
  nor2   g21(.a(new_n70_), .b(new_n60_), .O(z08));
  ...
  nor2   g33(.a(new_n62_), .b(new_n51_), .O(new_n83_));
  nand3  g34(.a(new_n83_), .b(new_n82_), .c(new_n60_), .O(new_n84_));
  oai21  g35(.a(new_n81_), .b(new_n77_), .c(new_n84_), .O(new_n85_));
  nand4  g36(.a(new_n85_), .b(new_n73_), .c(new_n72_), .d(new_n50_), .O(new_n86_));
  inv1   g37(.a(new_n86_), .O(z09));
  nor3   g38(.a(new_n73_), .b(new_n72_), .c(x20), .O(new_n88_));
  nand4  g39(.a(new_n88_), .b(new_n60_), .c(x18), .d(x01), .O(new_n89_));
  nor2   g40(.a(x13), .b(new_n55_), .O(new_n90_));
  ...
  nand4  g46(.a(new_n83_), .b(x21), .c(new_n82_), .d(new_n60_), .O(new_n96_));
  ...
  nand3  g50(.a(new_n99_), .b(new_n73_), .c(new_n50_), .O(new_n100_));
  inv1   g51(.a(new_n100_), .O(z11));
  nand3  g52(.a(x02), .b(new_n51_), .c(new_n50_), .O(new_n107_));
  inv1   g53(.a(new_n107_), .O(z17));
  zero   g54(.O(z00));
  zero   g55(.O(z01));
  zero   g56(.O(z02));
  zero   g57(.O(z03));
