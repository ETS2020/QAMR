// Benchmark "FAU" written by ABC on Fri Jul 24 17:37:31 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n117_, new_n120_, new_n123_, new_n124_, new_n127_;
  ...
  aoi21  g77(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n123_));
  nand3  g78(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n124_));
  oai21  g79(.a(new_n123_), .b(new_n59_), .c(new_n124_), .O(z15));
  nor2   g80(.a(new_n60_), .b(x00), .O(z16));
  nand3  g81(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n127_));
