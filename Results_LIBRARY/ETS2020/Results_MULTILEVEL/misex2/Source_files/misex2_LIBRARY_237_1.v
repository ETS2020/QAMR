...
module FAU ( 
  ...
  wire new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
    ...
    new_n97_, new_n98_, new_n102_, new_n103_, new_n104_, new_n108_;
  ...
  nand3  g49(.a(new_n73_), .b(new_n62_), .c(new_n61_), .O(new_n102_));
  nor4   g50(.a(new_n102_), .b(x17), .c(x10), .d(x09), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n58_), .O(new_n104_));
  nor2   g52(.a(new_n104_), .b(x19), .O(z14));
  nand3  g53(.a(x02), .b(new_n62_), .c(new_n61_), .O(new_n108_));
  inv1   g54(.a(new_n108_), .O(z17));
  zero   g55(.O(z00));
  zero   g56(.O(z01));
  zero   g57(.O(z02));
  zero   g58(.O(z03));
