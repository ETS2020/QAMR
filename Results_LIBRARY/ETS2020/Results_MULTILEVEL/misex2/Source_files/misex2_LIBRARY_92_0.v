...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n62_, new_n63_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_,
  ...
  nand3  g26(.a(new_n70_), .b(x11), .c(x10), .O(new_n71_));
  oai21  g27(.a(new_n71_), .b(x09), .c(x01), .O(new_n72_));
  nand3  g28(.a(new_n72_), .b(x02), .c(x00), .O(new_n73_));
  ...
  nand4  g35(.a(new_n79_), .b(x02), .c(new_n67_), .d(new_n66_), .O(new_n80_));
  ...
  nor2   g51(.a(new_n45_), .b(new_n67_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n95_), .c(new_n75_), .O(new_n97_));
  oai21  g53(.a(new_n94_), .b(new_n90_), .c(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n87_), .c(new_n86_), .d(new_n66_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(z09));
  nor3   g56(.a(new_n87_), .b(new_n86_), .c(x20), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n75_), .c(x18), .d(x01), .O(new_n102_));
  nor2   g58(.a(x13), .b(new_n70_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n89_), .c(new_n60_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n75_), .O(new_n109_));
  ...
  nand3  g68(.a(new_n112_), .b(new_n87_), .c(new_n66_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n75_), .b(x17), .c(new_n88_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n67_), .c(new_n66_), .O(new_n120_));
  ...
  aoi21  g83(.a(new_n56_), .b(x01), .c(new_n88_), .O(new_n128_));
  nand3  g84(.a(x19), .b(new_n88_), .c(new_n67_), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n66_), .c(new_n129_), .O(z15));
  nor2   g86(.a(new_n67_), .b(x00), .O(z16));
  nand3  g87(.a(x02), .b(new_n67_), .c(new_n66_), .O(new_n132_));
