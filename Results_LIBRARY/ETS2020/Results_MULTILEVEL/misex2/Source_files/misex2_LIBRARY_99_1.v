...
module FAU ( 
  ...
  inv1   g49(.a(x17), .O(new_n101_));
  nand3  g50(.a(new_n73_), .b(new_n62_), .c(new_n61_), .O(new_n102_));
  nor3   g51(.a(new_n102_), .b(x19), .c(new_n101_), .O(z13));
  nor3   g52(.a(new_n102_), .b(x10), .c(x09), .O(new_n104_));
  nand3  g53(.a(new_n104_), .b(new_n58_), .c(new_n101_), .O(new_n105_));
  nor2   g54(.a(new_n105_), .b(x19), .O(z14));
  nand3  g55(.a(x02), .b(new_n62_), .c(new_n61_), .O(new_n109_));
  inv1   g56(.a(new_n109_), .O(z17));
  zero   g57(.O(z00));
  zero   g58(.O(z01));
  zero   g59(.O(z02));
  zero   g60(.O(z03));
