// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:00 2020
...
module FAU ( 
  ...
  wire new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
    ...
    new_n104_, new_n105_, new_n106_, new_n107_, new_n113_;
  ...
  nand3  g58(.a(x02), .b(new_n62_), .c(new_n61_), .O(new_n113_));
  inv1   g59(.a(new_n113_), .O(z17));
  zero   g60(.O(z00));
  zero   g61(.O(z01));
  zero   g62(.O(z02));
  zero   g63(.O(z03));
