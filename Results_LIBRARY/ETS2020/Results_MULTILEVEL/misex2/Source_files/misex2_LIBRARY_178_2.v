...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n90_, new_n92_, new_n93_,
    new_n96_;
  ...
  inv1   g30(.a(x24), .O(new_n79_));
  nand2  g31(.a(x10), .b(x02), .O(new_n80_));
  nand3  g32(.a(new_n80_), .b(x01), .c(x00), .O(new_n81_));
  oai21  g33(.a(x19), .b(x02), .c(x23), .O(new_n82_));
  nand3  g34(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n83_));
  nand2  g35(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g36(.a(new_n84_), .b(new_n47_), .c(new_n46_), .O(new_n85_));
  nand2  g37(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  nand3  g38(.a(new_n86_), .b(new_n79_), .c(x09), .O(new_n87_));
  inv1   g39(.a(new_n87_), .O(z12));
  nand4  g40(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n90_));
  nor2   g41(.a(new_n90_), .b(x19), .O(z14));
  aoi21  g42(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n92_));
  nand3  g43(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n93_));
  oai21  g44(.a(new_n92_), .b(new_n46_), .c(new_n93_), .O(z15));
  nor2   g45(.a(new_n47_), .b(x00), .O(z16));
  nand3  g46(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n96_));
