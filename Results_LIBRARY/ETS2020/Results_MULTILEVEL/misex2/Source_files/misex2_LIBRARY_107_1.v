// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:08 2020
...
module FAU ( 
  ...
  nor2   g49(.a(new_n62_), .b(x00), .O(z16));
  nand3  g50(.a(x02), .b(new_n62_), .c(new_n61_), .O(new_n105_));
  inv1   g51(.a(new_n105_), .O(z17));
  zero   g52(.O(z00));
  zero   g53(.O(z01));
  zero   g54(.O(z02));
  zero   g55(.O(z03));
