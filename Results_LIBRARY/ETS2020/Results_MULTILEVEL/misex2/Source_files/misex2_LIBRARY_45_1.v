...
module FAU ( 
  ...
  nand4  g35(.a(new_n81_), .b(x21), .c(new_n80_), .d(new_n56_), .O(new_n87_));
  nor2   g36(.a(x13), .b(new_n51_), .O(new_n88_));
  nand3  g37(.a(new_n88_), .b(new_n74_), .c(new_n72_), .O(new_n89_));
  nor2   g38(.a(new_n76_), .b(x14), .O(new_n90_));
  nand4  g39(.a(new_n90_), .b(new_n70_), .c(x20), .d(new_n77_), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n89_), .c(new_n87_), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n71_), .c(new_n61_), .O(new_n93_));
