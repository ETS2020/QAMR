// Benchmark "FAU" written by ABC on Fri Jul 24 17:38:04 2020
...
module FAU ( 
  ...
  nor2   g48(.a(new_n48_), .b(x01), .O(new_n92_));
  nand3  g49(.a(new_n92_), .b(x12), .c(new_n67_), .O(new_n93_));
  ...
  nand3  g63(.a(new_n106_), .b(new_n92_), .c(new_n67_), .O(new_n107_));
  nor3   g64(.a(new_n95_), .b(new_n94_), .c(x14), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n91_), .c(new_n90_), .d(x20), .O(new_n109_));
  or2    g66(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n105_), .c(x00), .O(z10));
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n62_), .O(new_n112_));
  nor2   g69(.a(new_n94_), .b(x14), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n90_), .c(x20), .d(new_n95_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n107_), .c(new_n112_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n91_), .c(new_n46_), .O(new_n116_));
  ...
  nand3  g77(.a(new_n62_), .b(x17), .c(new_n48_), .O(new_n121_));
  ...
  nand4  g83(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(x19), .O(z14));
  aoi21  g85(.a(new_n58_), .b(x01), .c(new_n48_), .O(new_n130_));
  nand3  g86(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n131_));
  oai21  g87(.a(new_n130_), .b(new_n46_), .c(new_n131_), .O(z15));
  nor2   g88(.a(new_n47_), .b(x00), .O(z16));
  nand3  g89(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n134_));
