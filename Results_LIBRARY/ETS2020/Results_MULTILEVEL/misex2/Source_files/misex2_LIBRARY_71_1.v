// Benchmark "FAU" written by ABC on Fri Jul 24 17:37:55 2020
...
module FAU ( 
  ...
  wire new_n51_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n58_,
    ...
    new_n97_, new_n98_, new_n103_, new_n104_, new_n105_, new_n108_;
  ...
  inv1   g49(.a(x10), .O(new_n103_));
  aoi21  g50(.a(new_n103_), .b(x01), .c(new_n73_), .O(new_n104_));
  nand3  g51(.a(x19), .b(new_n73_), .c(new_n62_), .O(new_n105_));
  oai21  g52(.a(new_n104_), .b(new_n61_), .c(new_n105_), .O(z15));
