...
module FAU ( 
  ...
  and2   g39(.a(x18), .b(x01), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(x21), .c(new_n85_), .d(new_n63_), .O(new_n87_));
  nor2   g41(.a(new_n61_), .b(x01), .O(new_n88_));
  nor2   g42(.a(x13), .b(new_n76_), .O(new_n89_));
  ...
  nor2   g47(.a(x21), .b(new_n85_), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n90_), .c(new_n87_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n84_), .c(new_n59_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(z11));
  inv1   g52(.a(x24), .O(new_n99_));
  nand2  g53(.a(x10), .b(x02), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(x01), .c(x00), .O(new_n101_));
  oai21  g55(.a(x19), .b(x02), .c(x23), .O(new_n102_));
  nand3  g56(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n60_), .c(new_n59_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n99_), .c(x09), .O(new_n107_));
  inv1   g61(.a(new_n107_), .O(z12));
  nand2  g62(.a(new_n47_), .b(x17), .O(new_n109_));
  nor2   g63(.a(new_n109_), .b(x19), .O(z13));
  nand4  g64(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n111_));
  nor2   g65(.a(new_n111_), .b(x19), .O(z14));
  aoi21  g66(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n113_));
  nand3  g67(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n59_), .c(new_n114_), .O(z15));
  nor2   g69(.a(new_n60_), .b(x00), .O(z16));
  nand3  g70(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n117_));
