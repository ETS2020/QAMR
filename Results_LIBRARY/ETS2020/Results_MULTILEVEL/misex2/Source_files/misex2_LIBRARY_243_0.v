...
module FAU ( 
  ...
  nor2   g47(.a(new_n61_), .b(x01), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(x12), .c(new_n68_), .O(new_n93_));
  ...
  nand4  g67(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n63_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n115_), .b(new_n91_), .c(new_n59_), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(z11));
  nand2  g73(.a(new_n47_), .b(x17), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(x19), .O(z13));
  nand4  g75(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n121_));
