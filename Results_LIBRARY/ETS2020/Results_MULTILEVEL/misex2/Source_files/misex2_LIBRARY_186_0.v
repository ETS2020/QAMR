...
module FAU ( 
  ...
  nand4  g29(.a(x11), .b(x10), .c(new_n46_), .d(x02), .O(new_n74_));
  nor3   g30(.a(new_n74_), .b(new_n60_), .c(new_n59_), .O(z06));
  inv1   g31(.a(x12), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(x11), .c(x10), .O(new_n77_));
  oai21  g33(.a(new_n77_), .b(x09), .c(x01), .O(new_n78_));
  ...
  nand4  g40(.a(new_n84_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n85_));
  ...
  nor2   g45(.a(new_n89_), .b(new_n63_), .O(z08));
  inv1   g46(.a(x21), .O(new_n91_));
  inv1   g47(.a(x22), .O(new_n92_));
  nor2   g48(.a(new_n61_), .b(x01), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(x12), .c(new_n68_), .O(new_n94_));
  ...
  nand4  g58(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n59_), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(z09));
  nor3   g60(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n63_), .c(x18), .d(x01), .O(new_n106_));
  nor2   g62(.a(x13), .b(new_n76_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n93_), .c(new_n68_), .O(new_n108_));
  nor3   g64(.a(new_n96_), .b(new_n95_), .c(x14), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n92_), .c(new_n91_), .d(x20), .O(new_n110_));
  or2    g66(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g68(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n113_));
  nor2   g69(.a(new_n95_), .b(x14), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n91_), .c(x20), .d(new_n96_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n108_), .c(new_n113_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n92_), .c(new_n59_), .O(new_n117_));
  ...
  nand3  g77(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n122_));
  ...
  nand2  g83(.a(new_n47_), .b(x17), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(x19), .O(z13));
  nand4  g85(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n130_));
  nor2   g86(.a(new_n130_), .b(x19), .O(z14));
  aoi21  g87(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n132_));
  nand3  g88(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n133_));
  oai21  g89(.a(new_n132_), .b(new_n59_), .c(new_n133_), .O(z15));
