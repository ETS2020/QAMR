...
module FAU ( 
  ...
  nand2  g47(.a(x10), .b(x02), .O(new_n98_));
  nand3  g48(.a(new_n98_), .b(x01), .c(x00), .O(new_n99_));
  oai21  g49(.a(x19), .b(x02), .c(x23), .O(new_n100_));
  nand3  g50(.a(new_n56_), .b(x17), .c(new_n71_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g52(.a(new_n102_), .b(new_n51_), .c(new_n50_), .O(new_n103_));
  aoi21  g53(.a(new_n103_), .b(new_n99_), .c(x24), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(x09), .O(new_n105_));
  inv1   g55(.a(new_n105_), .O(z12));
  zero   g56(.O(z00));
  zero   g57(.O(z01));
  zero   g58(.O(z02));
  zero   g59(.O(z03));
