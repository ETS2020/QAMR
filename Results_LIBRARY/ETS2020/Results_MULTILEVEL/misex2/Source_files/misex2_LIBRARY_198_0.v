...
module FAU ( 
  ...
  aoi21  g86(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n131_));
  nand3  g87(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  oai21  g88(.a(new_n131_), .b(new_n59_), .c(new_n132_), .O(z15));
  nor2   g89(.a(new_n60_), .b(x00), .O(z16));
  nand3  g90(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n135_));
