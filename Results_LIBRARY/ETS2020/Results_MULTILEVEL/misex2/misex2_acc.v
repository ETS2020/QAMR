...
module FAU ( 
  ...
  inv1   g25(.a(new_n63_), .O(new_n69_));
  ...
  nor3   g30(.a(new_n73_), .b(new_n70_), .c(new_n69_), .O(z04));
  nor3   g31(.a(new_n70_), .b(new_n54_), .c(new_n44_), .O(z05));
  nor3   g32(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z06));
  nand3  g33(.a(new_n63_), .b(new_n72_), .c(x11), .O(new_n77_));
  ...
  nor2   g49(.a(new_n72_), .b(x11), .O(new_n93_));
  ...
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n64_), .O(new_n100_));
  aoi21  g57(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z09));
  nor2   g58(.a(x20), .b(new_n65_), .O(new_n102_));
  ...
  nand2  g72(.a(new_n99_), .b(new_n64_), .O(new_n116_));
  aoi21  g73(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(z11));
  oai21  g74(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n118_));
  ...
  nand3  g86(.a(x19), .b(new_n59_), .c(new_n65_), .O(new_n130_));
