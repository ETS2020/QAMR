...
module FAU ( 
  ...
  nand3  g069(.a(x5), .b(new_n24_), .c(new_n19_), .O(new_n87_));
  oai21  g070(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(new_n88_));
  nand2  g071(.a(new_n88_), .b(new_n35_), .O(new_n89_));
  nand4  g072(.a(new_n18_), .b(new_n24_), .c(new_n23_), .d(x0), .O(new_n90_));
  ...
  oai21  g100(.a(new_n117_), .b(new_n24_), .c(x1), .O(new_n118_));
  ...
  nand3  g104(.a(new_n31_), .b(x5), .c(x4), .O(new_n123_));
  inv1   g105(.a(new_n123_), .O(z9));
  zero   g106(.O(z8));
endmodule
