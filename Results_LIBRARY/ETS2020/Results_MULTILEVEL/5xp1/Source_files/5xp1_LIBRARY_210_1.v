// Benchmark "FAU" written by ABC on Fri Jul 24 00:34:48 2020
...
module FAU ( 
  ...
  nor2   g088(.a(x3), .b(new_n23_), .O(new_n106_));
  ...
  oai21  g092(.a(new_n107_), .b(x0), .c(new_n109_), .O(z5));
  ...
  nand2  g101(.a(new_n105_), .b(new_n35_), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n118_), .O(z6));
  nand3  g103(.a(new_n31_), .b(x5), .c(x4), .O(new_n122_));
  inv1   g104(.a(new_n122_), .O(z9));
  zero   g105(.O(z7));
endmodule
