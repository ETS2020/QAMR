...
module FAU ( 
  ...
  nand2  g76(.a(x3), .b(new_n23_), .O(new_n95_));
  nand2  g77(.a(z8), .b(x2), .O(new_n96_));
  oai21  g78(.a(new_n95_), .b(new_n35_), .c(new_n96_), .O(new_n97_));
  nand2  g79(.a(new_n97_), .b(new_n19_), .O(new_n98_));
  aoi21  g80(.a(x3), .b(x1), .c(x2), .O(new_n99_));
  oai21  g81(.a(new_n99_), .b(new_n29_), .c(x0), .O(new_n100_));
  nand2  g82(.a(new_n100_), .b(new_n98_), .O(z5));
  nor2   g83(.a(x5), .b(new_n34_), .O(new_n102_));
  nor2   g84(.a(x6), .b(x4), .O(new_n103_));
  oai21  g85(.a(new_n103_), .b(new_n102_), .c(x0), .O(new_n104_));
  aoi21  g86(.a(x6), .b(new_n34_), .c(new_n18_), .O(new_n105_));
  oai21  g87(.a(x5), .b(x0), .c(new_n22_), .O(new_n106_));
  oai21  g88(.a(new_n106_), .b(new_n105_), .c(x3), .O(new_n107_));
  aoi21  g89(.a(new_n107_), .b(new_n104_), .c(new_n23_), .O(new_n108_));
  oai21  g90(.a(new_n108_), .b(z8), .c(x1), .O(new_n109_));
  nand3  g91(.a(x3), .b(new_n23_), .c(new_n35_), .O(new_n110_));
  nand2  g92(.a(new_n110_), .b(new_n109_), .O(z6));
  nand2  g93(.a(new_n96_), .b(new_n95_), .O(z7));
