// Benchmark "FAU" written by ABC on Fri Jul 24 00:35:02 2020
...
module FAU ( 
  ...
  nor2   g087(.a(x5), .b(new_n34_), .O(new_n106_));
  nor2   g088(.a(x6), .b(x4), .O(new_n107_));
  oai21  g089(.a(new_n107_), .b(new_n106_), .c(x0), .O(new_n108_));
  aoi21  g090(.a(x6), .b(new_n34_), .c(new_n18_), .O(new_n109_));
  oai21  g091(.a(x5), .b(x0), .c(new_n22_), .O(new_n110_));
  oai21  g092(.a(new_n110_), .b(new_n109_), .c(x3), .O(new_n111_));
  aoi21  g093(.a(new_n111_), .b(new_n108_), .c(new_n23_), .O(new_n112_));
  oai21  g094(.a(new_n112_), .b(z8), .c(x1), .O(new_n113_));
  nand3  g095(.a(x3), .b(new_n23_), .c(new_n35_), .O(new_n114_));
  nand2  g096(.a(new_n114_), .b(new_n113_), .O(z6));
  nand2  g097(.a(z8), .b(x2), .O(new_n116_));
  nand2  g098(.a(new_n116_), .b(new_n99_), .O(z7));
  nand3  g099(.a(new_n31_), .b(x5), .c(x4), .O(new_n118_));
  inv1   g100(.a(new_n118_), .O(z9));
  zero   g101(.O(z5));
endmodule
