...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n194_, new_n195_, new_n201_, new_n202_, new_n205_, new_n206_,
    new_n207_, new_n208_, new_n209_, new_n210_, new_n211_, new_n212_,
    new_n213_, new_n214_, new_n216_, new_n218_, new_n220_, new_n223_,
    new_n225_, new_n227_, new_n232_, new_n233_, new_n234_, new_n235_,
  ...
  aoi21  g065(.a(x83), .b(x42), .c(x81), .O(new_n232_));
  nand3  g066(.a(x83), .b(x81), .c(x42), .O(new_n233_));
  inv1   g067(.a(new_n233_), .O(new_n234_));
  oai21  g068(.a(new_n234_), .b(new_n232_), .c(new_n209_), .O(new_n235_));
  nand2  g069(.a(x83), .b(x42), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g071(.a(x83), .b(new_n208_), .c(x42), .O(new_n238_));
  nand2  g072(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g073(.a(new_n239_), .b(new_n206_), .O(new_n240_));
  aoi21  g074(.a(new_n240_), .b(new_n235_), .c(new_n156_), .O(new_n241_));
  nand4  g075(.a(new_n241_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g076(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g077(.a(new_n241_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g078(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g079(.a(new_n241_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g080(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g081(.a(new_n241_), .b(x78), .c(x77), .d(x57), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z39));
  nand4  g083(.a(new_n241_), .b(x78), .c(x77), .d(x60), .O(new_n252_));
  nor3   g084(.a(new_n252_), .b(x04), .c(x01), .O(z42));
  nand4  g085(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g086(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g087(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g088(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g089(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g090(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g091(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
