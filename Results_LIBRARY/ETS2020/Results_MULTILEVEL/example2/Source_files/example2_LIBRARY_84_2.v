...
module FAU ( 
  ...
  nand4  g092(.a(new_n242_), .b(x47), .c(new_n234_), .d(new_n228_), .O(new_n251_));
  nor2   g093(.a(new_n251_), .b(x01), .O(z29));
  nand4  g094(.a(new_n242_), .b(x48), .c(new_n234_), .d(new_n228_), .O(new_n253_));
  nor2   g095(.a(new_n253_), .b(x01), .O(z30));
  nand4  g096(.a(new_n242_), .b(x49), .c(new_n234_), .d(new_n228_), .O(new_n255_));
  nor2   g097(.a(new_n255_), .b(x01), .O(z31));
  nand4  g098(.a(new_n242_), .b(x50), .c(new_n234_), .d(new_n228_), .O(new_n257_));
  ...
  nor2   g115(.a(new_n221_), .b(new_n234_), .O(new_n274_));
