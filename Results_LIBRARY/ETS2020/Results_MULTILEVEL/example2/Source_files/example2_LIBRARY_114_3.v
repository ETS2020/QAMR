...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n293_, new_n295_, new_n297_, new_n299_, new_n302_,
  ...
  nand4  g164(.a(new_n223_), .b(x79), .c(new_n160_), .d(x77), .O(new_n323_));
  ...
  nand2  g207(.a(new_n365_), .b(new_n244_), .O(new_n366_));
  nor4   g208(.a(new_n366_), .b(new_n362_), .c(new_n227_), .d(x82), .O(z55));
  nand2  g209(.a(new_n237_), .b(x76), .O(new_n368_));
  ...
  nand4  g220(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n379_));
  oai22  g221(.a(new_n379_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n380_));
  nand4  g222(.a(new_n380_), .b(x79), .c(x78), .d(x04), .O(new_n381_));
  nor2   g223(.a(x79), .b(x78), .O(new_n382_));
  nand3  g224(.a(new_n382_), .b(new_n241_), .c(x40), .O(new_n383_));
  nand2  g225(.a(new_n383_), .b(new_n381_), .O(new_n384_));
  nand2  g226(.a(new_n384_), .b(x77), .O(new_n385_));
  oai21  g227(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n386_));
  aoi21  g228(.a(new_n386_), .b(new_n385_), .c(x01), .O(z58));
  nor2   g229(.a(new_n160_), .b(new_n233_), .O(new_n388_));
  oai21  g230(.a(new_n388_), .b(new_n382_), .c(x40), .O(new_n389_));
  oai21  g231(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n390_));
  ...
  nand2  g236(.a(new_n154_), .b(new_n233_), .O(new_n395_));
  aoi21  g237(.a(new_n395_), .b(new_n394_), .c(x01), .O(z59));
  nand2  g238(.a(new_n371_), .b(x79), .O(new_n397_));
  nand3  g239(.a(new_n397_), .b(new_n395_), .c(new_n231_), .O(new_n398_));
  and2   g240(.a(new_n398_), .b(new_n153_), .O(z60));
  nand2  g241(.a(new_n167_), .b(new_n369_), .O(new_n400_));
  nand2  g242(.a(new_n400_), .b(new_n223_), .O(new_n401_));
  oai21  g243(.a(new_n237_), .b(x04), .c(new_n401_), .O(new_n402_));
  ...
  nand3  g250(.a(x81), .b(x79), .c(new_n233_), .O(new_n409_));
  ...
  nor2   g261(.a(new_n244_), .b(x78), .O(new_n420_));
