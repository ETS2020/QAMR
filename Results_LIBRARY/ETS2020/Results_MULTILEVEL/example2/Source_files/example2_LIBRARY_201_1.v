...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n295_, new_n296_, new_n297_, new_n298_, new_n305_, new_n306_,
  ...
  nand4  g118(.a(new_n266_), .b(x78), .c(x77), .d(x62), .O(new_n286_));
  nor3   g119(.a(new_n286_), .b(x04), .c(x01), .O(z44));
  nand4  g120(.a(new_n266_), .b(x78), .c(x77), .d(x63), .O(new_n288_));
  nor3   g121(.a(new_n288_), .b(x04), .c(x01), .O(z45));
  nand2  g122(.a(x52), .b(x15), .O(new_n291_));
  inv1   g123(.a(x52), .O(new_n292_));
  nand2  g124(.a(new_n292_), .b(x07), .O(new_n293_));
  aoi21  g125(.a(new_n293_), .b(new_n291_), .c(x79), .O(new_n294_));
  nand4  g126(.a(new_n294_), .b(x78), .c(new_n159_), .d(x04), .O(new_n295_));
  nor2   g127(.a(x75), .b(x67), .O(new_n296_));
  nor2   g128(.a(new_n296_), .b(new_n215_), .O(new_n297_));
  nand4  g129(.a(new_n297_), .b(x79), .c(new_n160_), .d(x77), .O(new_n298_));
  aoi21  g130(.a(new_n298_), .b(new_n295_), .c(x01), .O(z47));
  nand2  g131(.a(x52), .b(x21), .O(new_n305_));
  nand2  g132(.a(new_n292_), .b(x13), .O(new_n306_));
  aoi21  g133(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g134(.a(new_n307_), .b(x78), .c(new_n159_), .d(x04), .O(new_n308_));
  nor2   g135(.a(new_n215_), .b(new_n154_), .O(new_n309_));
  nand4  g136(.a(new_n309_), .b(new_n160_), .c(x77), .d(x73), .O(new_n310_));
  aoi21  g137(.a(new_n310_), .b(new_n308_), .c(x01), .O(z53));
  ...
  nand2  g142(.a(new_n316_), .b(new_n242_), .O(new_n317_));
  ...
  nand4  g155(.a(x80), .b(new_n218_), .c(x43), .d(new_n247_), .O(new_n330_));
  oai22  g156(.a(new_n330_), .b(new_n221_), .c(new_n247_), .d(x40), .O(new_n331_));
  nand4  g157(.a(new_n331_), .b(x79), .c(x78), .d(x04), .O(new_n332_));
  nor2   g158(.a(x79), .b(x78), .O(new_n333_));
  nand3  g159(.a(new_n333_), .b(new_n247_), .c(x40), .O(new_n334_));
  ...
  oai21  g166(.a(new_n221_), .b(new_n219_), .c(new_n247_), .O(new_n341_));
  ...
  nor2   g196(.a(new_n242_), .b(x78), .O(new_n371_));
