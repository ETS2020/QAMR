...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n259_, new_n262_, new_n265_, new_n266_, new_n267_, new_n268_,
  ...
  nor2   g123(.a(new_n228_), .b(new_n242_), .O(new_n281_));
  nand3  g124(.a(x83), .b(x81), .c(x42), .O(new_n282_));
  oai21  g125(.a(new_n281_), .b(x81), .c(new_n282_), .O(new_n283_));
  nand2  g126(.a(new_n283_), .b(new_n246_), .O(new_n284_));
  oai22  g127(.a(new_n281_), .b(new_n245_), .c(new_n265_), .d(new_n242_), .O(new_n285_));
  nand2  g128(.a(new_n285_), .b(new_n243_), .O(new_n286_));
  aoi21  g129(.a(new_n286_), .b(new_n284_), .c(new_n154_), .O(new_n287_));
  nand4  g130(.a(new_n287_), .b(x78), .c(x77), .d(x53), .O(new_n288_));
  nor3   g131(.a(new_n288_), .b(x04), .c(x01), .O(z35));
  nand4  g132(.a(new_n287_), .b(x78), .c(x77), .d(x55), .O(new_n291_));
  nor3   g133(.a(new_n291_), .b(x04), .c(x01), .O(z37));
  nand4  g134(.a(new_n287_), .b(x78), .c(x77), .d(x56), .O(new_n293_));
  nor3   g135(.a(new_n293_), .b(x04), .c(x01), .O(z38));
  nand4  g136(.a(new_n287_), .b(x78), .c(x77), .d(x57), .O(new_n295_));
  nor3   g137(.a(new_n295_), .b(x04), .c(x01), .O(z39));
  nand4  g138(.a(new_n287_), .b(x78), .c(x77), .d(x58), .O(new_n297_));
  nor3   g139(.a(new_n297_), .b(x04), .c(x01), .O(z40));
  nand4  g140(.a(new_n287_), .b(x78), .c(x77), .d(x59), .O(new_n299_));
  nor3   g141(.a(new_n299_), .b(x04), .c(x01), .O(z41));
  nand4  g142(.a(new_n287_), .b(x78), .c(x77), .d(x60), .O(new_n301_));
  nor3   g143(.a(new_n301_), .b(x04), .c(x01), .O(z42));
  nand4  g144(.a(new_n287_), .b(x78), .c(x77), .d(x61), .O(new_n303_));
  nor3   g145(.a(new_n303_), .b(x04), .c(x01), .O(z43));
  nand4  g146(.a(new_n287_), .b(x78), .c(x77), .d(x62), .O(new_n305_));
  nor3   g147(.a(new_n305_), .b(x04), .c(x01), .O(z44));
  nand4  g148(.a(new_n287_), .b(x78), .c(x77), .d(x63), .O(new_n307_));
  nor3   g149(.a(new_n307_), .b(x04), .c(x01), .O(z45));
  nand4  g150(.a(new_n287_), .b(x78), .c(x77), .d(x64), .O(new_n309_));
