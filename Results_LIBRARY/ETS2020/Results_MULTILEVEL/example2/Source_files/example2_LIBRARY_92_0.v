...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n220_, new_n222_, new_n224_, new_n227_, new_n229_, new_n234_,
  ...
  oai21  g072(.a(new_n236_), .b(new_n234_), .c(new_n213_), .O(new_n237_));
  nand2  g073(.a(x83), .b(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g075(.a(x83), .b(new_n212_), .c(x42), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g077(.a(new_n241_), .b(new_n210_), .O(new_n242_));
  ...
  nand4  g085(.a(new_n243_), .b(x78), .c(x77), .d(x59), .O(new_n253_));
  nor3   g086(.a(new_n253_), .b(x04), .c(x01), .O(z41));
  nand4  g087(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n255_));
  nor3   g088(.a(new_n255_), .b(x04), .c(x01), .O(z42));
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g090(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g091(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n259_));
  nor3   g092(.a(new_n259_), .b(x04), .c(x01), .O(z44));
  nand4  g093(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n261_));
  nor3   g094(.a(new_n261_), .b(x04), .c(x01), .O(z45));
  nand4  g095(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n263_));
