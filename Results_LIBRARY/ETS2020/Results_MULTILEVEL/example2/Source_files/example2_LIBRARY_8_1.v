...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n296_, new_n299_, new_n302_, new_n305_, new_n306_,
  ...
  nand4  g097(.a(new_n245_), .b(x47), .c(new_n237_), .d(new_n231_), .O(new_n254_));
  nor2   g098(.a(new_n254_), .b(x01), .O(z29));
  nand4  g099(.a(new_n245_), .b(x48), .c(new_n237_), .d(new_n231_), .O(new_n256_));
  nor2   g100(.a(new_n256_), .b(x01), .O(z30));
  nand4  g101(.a(new_n245_), .b(x49), .c(new_n237_), .d(new_n231_), .O(new_n258_));
  ...
  nand4  g166(.a(x80), .b(new_n222_), .c(x43), .d(new_n237_), .O(new_n336_));
  oai22  g167(.a(new_n336_), .b(new_n225_), .c(new_n237_), .d(x40), .O(new_n337_));
  nand4  g168(.a(new_n337_), .b(x79), .c(x78), .d(x04), .O(new_n338_));
  nor2   g169(.a(x79), .b(x78), .O(new_n339_));
  nand3  g170(.a(new_n339_), .b(new_n237_), .c(x40), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n338_), .O(new_n341_));
  nand2  g172(.a(new_n341_), .b(x77), .O(new_n342_));
  oai21  g173(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n343_));
  aoi21  g174(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g175(.a(new_n160_), .b(new_n231_), .O(new_n345_));
  oai21  g176(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g177(.a(new_n225_), .b(new_n223_), .c(new_n237_), .O(new_n347_));
  ...
  nand2  g182(.a(new_n154_), .b(new_n231_), .O(new_n352_));
  aoi21  g183(.a(new_n352_), .b(new_n351_), .c(x01), .O(z59));
  nand2  g184(.a(new_n330_), .b(x79), .O(new_n354_));
  nand3  g185(.a(new_n354_), .b(new_n352_), .c(new_n228_), .O(new_n355_));
  and2   g186(.a(new_n355_), .b(new_n153_), .O(z60));
  nand2  g187(.a(new_n167_), .b(new_n328_), .O(new_n357_));
  nand2  g188(.a(new_n357_), .b(new_n220_), .O(new_n358_));
  oai21  g189(.a(new_n233_), .b(x04), .c(new_n358_), .O(new_n359_));
  ...
  nand3  g196(.a(x81), .b(x79), .c(new_n231_), .O(new_n366_));
  ...
  nor2   g207(.a(new_n240_), .b(x78), .O(new_n377_));
