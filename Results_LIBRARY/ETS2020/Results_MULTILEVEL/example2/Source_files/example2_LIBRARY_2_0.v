...
module FAU ( 
  ...
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x60), .O(new_n256_));
  nor3   g091(.a(new_n256_), .b(x04), .c(x01), .O(z42));
  nand4  g092(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n258_));
  nor3   g093(.a(new_n258_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n242_), .b(x78), .c(x77), .d(x62), .O(new_n260_));
  nor3   g095(.a(new_n260_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n262_));
  nor3   g097(.a(new_n262_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n264_));
