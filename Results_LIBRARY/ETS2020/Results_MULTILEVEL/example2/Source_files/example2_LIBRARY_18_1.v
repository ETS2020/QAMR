...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n228_, new_n240_, new_n241_, new_n242_, new_n243_, new_n244_,
  ...
  inv1   g074(.a(x04), .O(new_n240_));
  xnor2a g075(.a(x84), .b(x82), .O(new_n241_));
  inv1   g076(.a(x81), .O(new_n242_));
  nand2  g077(.a(x83), .b(new_n242_), .O(new_n243_));
  nand2  g078(.a(new_n224_), .b(x81), .O(new_n244_));
  nand2  g079(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  nand3  g080(.a(new_n245_), .b(x42), .c(x05), .O(new_n246_));
  inv1   g081(.a(x42), .O(new_n247_));
  nand3  g082(.a(x81), .b(x51), .c(new_n247_), .O(new_n248_));
  nand2  g083(.a(new_n248_), .b(new_n246_), .O(new_n249_));
  nand2  g084(.a(new_n249_), .b(new_n241_), .O(new_n250_));
  xor2a  g085(.a(x84), .b(x82), .O(new_n251_));
  xnor2a g086(.a(x83), .b(x81), .O(new_n252_));
  nand3  g087(.a(new_n252_), .b(x42), .c(x05), .O(new_n253_));
  nand3  g088(.a(new_n242_), .b(x51), .c(new_n247_), .O(new_n254_));
  nand2  g089(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  nand2  g090(.a(new_n255_), .b(new_n251_), .O(new_n256_));
  aoi21  g091(.a(new_n256_), .b(new_n250_), .c(new_n154_), .O(new_n257_));
  nand4  g092(.a(new_n257_), .b(x78), .c(x77), .d(new_n240_), .O(new_n258_));
  nor2   g093(.a(new_n258_), .b(x01), .O(z33));
  nor2   g094(.a(new_n224_), .b(new_n247_), .O(new_n260_));
  nand3  g095(.a(x83), .b(x81), .c(x42), .O(new_n261_));
  oai21  g096(.a(new_n260_), .b(x81), .c(new_n261_), .O(new_n262_));
  nand2  g097(.a(new_n262_), .b(new_n251_), .O(new_n263_));
  oai22  g098(.a(new_n260_), .b(new_n242_), .c(new_n243_), .d(new_n247_), .O(new_n264_));
  nand2  g099(.a(new_n264_), .b(new_n241_), .O(new_n265_));
  aoi21  g100(.a(new_n265_), .b(new_n263_), .c(new_n154_), .O(new_n266_));
  ...
  nand4  g109(.a(new_n266_), .b(x78), .c(x77), .d(x56), .O(new_n275_));
  nor3   g110(.a(new_n275_), .b(x04), .c(x01), .O(z38));
  nand4  g111(.a(new_n266_), .b(x78), .c(x77), .d(x57), .O(new_n277_));
  nor3   g112(.a(new_n277_), .b(x04), .c(x01), .O(z39));
  nand4  g113(.a(new_n266_), .b(x78), .c(x77), .d(x59), .O(new_n280_));
  nor3   g114(.a(new_n280_), .b(x04), .c(x01), .O(z41));
  nand4  g115(.a(new_n266_), .b(x78), .c(x77), .d(x60), .O(new_n282_));
  nor3   g116(.a(new_n282_), .b(x04), .c(x01), .O(z42));
  nand4  g117(.a(new_n266_), .b(x78), .c(x77), .d(x61), .O(new_n284_));
  nor3   g118(.a(new_n284_), .b(x04), .c(x01), .O(z43));
  nand4  g119(.a(new_n266_), .b(x78), .c(x77), .d(x63), .O(new_n287_));
  nor3   g120(.a(new_n287_), .b(x04), .c(x01), .O(z45));
  nand2  g121(.a(x52), .b(x15), .O(new_n290_));
  inv1   g122(.a(x52), .O(new_n291_));
  nand2  g123(.a(new_n291_), .b(x07), .O(new_n292_));
  aoi21  g124(.a(new_n292_), .b(new_n290_), .c(x79), .O(new_n293_));
  nand4  g125(.a(new_n293_), .b(x78), .c(new_n159_), .d(x04), .O(new_n294_));
  nor2   g126(.a(x75), .b(x67), .O(new_n295_));
  nor2   g127(.a(new_n295_), .b(new_n219_), .O(new_n296_));
  nand4  g128(.a(new_n296_), .b(x79), .c(new_n160_), .d(x77), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n294_), .c(x01), .O(z47));
  inv1   g130(.a(x84), .O(new_n306_));
  nor2   g131(.a(x04), .b(x01), .O(new_n307_));
  nand4  g132(.a(new_n307_), .b(x79), .c(x78), .d(x77), .O(new_n308_));
  nor2   g133(.a(new_n308_), .b(x80), .O(new_n309_));
  nand2  g134(.a(new_n309_), .b(new_n242_), .O(new_n310_));
  nor4   g135(.a(new_n310_), .b(new_n306_), .c(new_n224_), .d(x82), .O(z55));
  nor2   g136(.a(new_n160_), .b(new_n159_), .O(new_n312_));
  inv1   g137(.a(new_n312_), .O(new_n313_));
  nand2  g138(.a(new_n313_), .b(x76), .O(new_n314_));
  inv1   g139(.a(new_n165_), .O(new_n315_));
  xnor2a g140(.a(x84), .b(x81), .O(new_n316_));
  aoi21  g141(.a(new_n167_), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g142(.a(new_n317_), .b(new_n153_), .O(new_n318_));
  nand2  g143(.a(new_n318_), .b(new_n314_), .O(new_n319_));
  nand2  g144(.a(new_n319_), .b(x79), .O(new_n320_));
  nand4  g145(.a(new_n320_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g146(.a(x02), .O(new_n322_));
  nand4  g147(.a(x03), .b(new_n322_), .c(new_n153_), .d(x00), .O(new_n323_));
  inv1   g148(.a(new_n323_), .O(z57));
  nand4  g149(.a(x80), .b(new_n222_), .c(x43), .d(new_n247_), .O(new_n325_));
  oai22  g150(.a(new_n325_), .b(new_n225_), .c(new_n247_), .d(x40), .O(new_n326_));
  nand4  g151(.a(new_n326_), .b(x79), .c(x78), .d(x04), .O(new_n327_));
  nor2   g152(.a(x79), .b(x78), .O(new_n328_));
  nand3  g153(.a(new_n328_), .b(new_n247_), .c(x40), .O(new_n329_));
  nand2  g154(.a(new_n329_), .b(new_n327_), .O(new_n330_));
  nand2  g155(.a(new_n330_), .b(x77), .O(new_n331_));
  oai21  g156(.a(new_n165_), .b(new_n240_), .c(new_n154_), .O(new_n332_));
  aoi21  g157(.a(new_n332_), .b(new_n331_), .c(x01), .O(z58));
  nor2   g158(.a(new_n160_), .b(new_n240_), .O(new_n334_));
  oai21  g159(.a(new_n334_), .b(new_n328_), .c(x40), .O(new_n335_));
  oai21  g160(.a(new_n225_), .b(new_n223_), .c(new_n247_), .O(new_n336_));
  ...
  nand2  g165(.a(new_n154_), .b(new_n240_), .O(new_n341_));
  aoi21  g166(.a(new_n341_), .b(new_n340_), .c(x01), .O(z59));
  nand2  g167(.a(new_n317_), .b(x79), .O(new_n343_));
  nand3  g168(.a(new_n343_), .b(new_n341_), .c(new_n228_), .O(new_n344_));
  and2   g169(.a(new_n344_), .b(new_n153_), .O(z60));
  nand2  g170(.a(new_n167_), .b(new_n315_), .O(new_n346_));
  nand2  g171(.a(new_n346_), .b(new_n220_), .O(new_n347_));
  oai21  g172(.a(new_n313_), .b(x04), .c(new_n347_), .O(new_n348_));
  nand4  g173(.a(new_n348_), .b(x80), .c(x79), .d(new_n153_), .O(new_n349_));
  inv1   g174(.a(new_n349_), .O(z61));
  nand2  g175(.a(new_n154_), .b(x04), .O(new_n351_));
  ...
  nand3  g179(.a(x81), .b(x79), .c(new_n240_), .O(new_n355_));
  aoi21  g180(.a(new_n355_), .b(new_n354_), .c(new_n159_), .O(new_n356_));
  oai21  g181(.a(new_n356_), .b(new_n353_), .c(x78), .O(new_n357_));
  or2    g182(.a(new_n352_), .b(new_n167_), .O(new_n358_));
  aoi21  g183(.a(new_n358_), .b(new_n357_), .c(x01), .O(z62));
  nand4  g184(.a(new_n348_), .b(x82), .c(x79), .d(new_n153_), .O(new_n360_));
  inv1   g185(.a(new_n360_), .O(z63));
  nand3  g186(.a(new_n348_), .b(x83), .c(x79), .O(new_n362_));
  nand4  g187(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n363_));
