...
module FAU ( 
  ...
  nand4  g098(.a(new_n248_), .b(x47), .c(new_n240_), .d(new_n232_), .O(new_n255_));
  nor2   g099(.a(new_n255_), .b(x01), .O(z29));
  nand4  g100(.a(new_n248_), .b(x48), .c(new_n240_), .d(new_n232_), .O(new_n257_));
  ...
  nor2   g121(.a(new_n226_), .b(new_n240_), .O(new_n279_));
  nand3  g122(.a(x83), .b(x81), .c(x42), .O(new_n280_));
  oai21  g123(.a(new_n279_), .b(x81), .c(new_n280_), .O(new_n281_));
  nand2  g124(.a(new_n281_), .b(new_n244_), .O(new_n282_));
  oai22  g125(.a(new_n279_), .b(new_n243_), .c(new_n263_), .d(new_n240_), .O(new_n283_));
  nand2  g126(.a(new_n283_), .b(new_n241_), .O(new_n284_));
  ...
  nand4  g140(.a(new_n285_), .b(x78), .c(x77), .d(x61), .O(new_n300_));
  ...
  nor2   g254(.a(new_n243_), .b(x78), .O(new_n416_));
