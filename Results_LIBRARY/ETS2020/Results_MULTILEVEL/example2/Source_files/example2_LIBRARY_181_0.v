...
module FAU ( 
  ...
  aoi21  g061(.a(x83), .b(x42), .c(x81), .O(new_n228_));
  nand3  g062(.a(x83), .b(x81), .c(x42), .O(new_n229_));
  inv1   g063(.a(new_n229_), .O(new_n230_));
  oai21  g064(.a(new_n230_), .b(new_n228_), .c(new_n210_), .O(new_n231_));
  nand2  g065(.a(x83), .b(x42), .O(new_n232_));
  nand2  g066(.a(new_n232_), .b(x81), .O(new_n233_));
  nand3  g067(.a(x83), .b(new_n209_), .c(x42), .O(new_n234_));
  nand2  g068(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g069(.a(new_n235_), .b(new_n207_), .O(new_n236_));
  aoi21  g070(.a(new_n236_), .b(new_n231_), .c(new_n156_), .O(new_n237_));
  nand4  g071(.a(new_n237_), .b(x78), .c(x77), .d(x52), .O(new_n238_));
  nor3   g072(.a(new_n238_), .b(x04), .c(x01), .O(z34));
  nand4  g073(.a(new_n237_), .b(x78), .c(x77), .d(x54), .O(new_n241_));
  nor3   g074(.a(new_n241_), .b(x04), .c(x01), .O(z36));
  nand4  g075(.a(new_n237_), .b(x78), .c(x77), .d(x55), .O(new_n243_));
  nor3   g076(.a(new_n243_), .b(x04), .c(x01), .O(z37));
  nand4  g077(.a(new_n237_), .b(x78), .c(x77), .d(x56), .O(new_n245_));
  ...
  nor2   g140(.a(new_n209_), .b(x78), .O(new_n321_));
