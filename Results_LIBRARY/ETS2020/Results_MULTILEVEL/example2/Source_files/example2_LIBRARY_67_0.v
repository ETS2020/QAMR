...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n194_, new_n195_, new_n201_, new_n202_, new_n208_, new_n209_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n219_, new_n221_, new_n224_, new_n227_,
    ...
    new_n301_, new_n302_, new_n307_, new_n308_, new_n317_, new_n318_,
  ...
  nand4  g057(.a(new_n216_), .b(x50), .c(new_n208_), .d(new_n201_), .O(new_n224_));
  ...
  oai21  g062(.a(new_n229_), .b(new_n227_), .c(new_n212_), .O(new_n230_));
  nand2  g063(.a(x83), .b(x42), .O(new_n231_));
  nand2  g064(.a(new_n231_), .b(x81), .O(new_n232_));
  nand3  g065(.a(x83), .b(new_n211_), .c(x42), .O(new_n233_));
  nand2  g066(.a(new_n233_), .b(new_n232_), .O(new_n234_));
  nand2  g067(.a(new_n234_), .b(new_n209_), .O(new_n235_));
  ...
  nand4  g071(.a(new_n236_), .b(x78), .c(x77), .d(x54), .O(new_n240_));
  nor3   g072(.a(new_n240_), .b(x04), .c(x01), .O(z36));
  nand4  g073(.a(new_n236_), .b(x78), .c(x77), .d(x55), .O(new_n242_));
  nor3   g074(.a(new_n242_), .b(x04), .c(x01), .O(z37));
  nand4  g075(.a(new_n236_), .b(x78), .c(x77), .d(x56), .O(new_n244_));
  ...
  nor2   g136(.a(new_n268_), .b(x04), .O(new_n317_));
  nor2   g137(.a(new_n211_), .b(x78), .O(new_n318_));
  oai21  g138(.a(new_n318_), .b(new_n317_), .c(x77), .O(new_n319_));
  nand3  g139(.a(x81), .b(x78), .c(new_n262_), .O(new_n320_));
