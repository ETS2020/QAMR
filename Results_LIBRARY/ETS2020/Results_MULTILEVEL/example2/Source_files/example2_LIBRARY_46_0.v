...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n222_, new_n224_, new_n230_, new_n231_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
    new_n240_, new_n243_, new_n245_, new_n247_, new_n250_, new_n254_,
    ...
    new_n325_, new_n326_, new_n333_, new_n334_, new_n335_, new_n336_,
    new_n337_, new_n338_;
  ...
  oai21  g066(.a(new_n232_), .b(new_n230_), .c(new_n215_), .O(new_n233_));
  nand2  g067(.a(x83), .b(x42), .O(new_n234_));
  nand2  g068(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g069(.a(x83), .b(new_n214_), .c(x42), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(new_n212_), .O(new_n238_));
  aoi21  g072(.a(new_n238_), .b(new_n233_), .c(new_n156_), .O(new_n239_));
  nand4  g073(.a(new_n239_), .b(x78), .c(x77), .d(x52), .O(new_n240_));
  nor3   g074(.a(new_n240_), .b(x04), .c(x01), .O(z34));
  nand4  g075(.a(new_n239_), .b(x78), .c(x77), .d(x54), .O(new_n243_));
  nor3   g076(.a(new_n243_), .b(x04), .c(x01), .O(z36));
  nand4  g077(.a(new_n239_), .b(x78), .c(x77), .d(x55), .O(new_n245_));
  nor3   g078(.a(new_n245_), .b(x04), .c(x01), .O(z37));
  nand4  g079(.a(new_n239_), .b(x78), .c(x77), .d(x56), .O(new_n247_));
  nor3   g080(.a(new_n247_), .b(x04), .c(x01), .O(z38));
  nand4  g081(.a(new_n239_), .b(x78), .c(x77), .d(x58), .O(new_n250_));
  nor3   g082(.a(new_n250_), .b(x04), .c(x01), .O(z40));
  nand4  g083(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g084(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g085(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g086(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g087(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g088(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g089(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
  ...
  nor2   g138(.a(x79), .b(x78), .O(new_n314_));
  nor2   g139(.a(new_n269_), .b(new_n205_), .O(new_n315_));
  oai21  g140(.a(new_n315_), .b(new_n314_), .c(x40), .O(new_n316_));
  inv1   g141(.a(x74), .O(new_n317_));
  nand3  g142(.a(x80), .b(new_n317_), .c(x43), .O(new_n318_));
  inv1   g143(.a(x83), .O(new_n319_));
  nand4  g144(.a(x84), .b(new_n319_), .c(x82), .d(x81), .O(new_n320_));
  oai21  g145(.a(new_n320_), .b(new_n318_), .c(new_n211_), .O(new_n321_));
  nand2  g146(.a(new_n321_), .b(x79), .O(new_n322_));
  nand3  g147(.a(new_n322_), .b(x78), .c(x04), .O(new_n323_));
  nand2  g148(.a(new_n323_), .b(new_n316_), .O(new_n324_));
  nand2  g149(.a(new_n324_), .b(x77), .O(new_n325_));
  nand2  g150(.a(new_n156_), .b(new_n205_), .O(new_n326_));
  aoi21  g151(.a(new_n326_), .b(new_n325_), .c(x01), .O(z59));
  nor2   g152(.a(new_n269_), .b(x04), .O(new_n333_));
  nor2   g153(.a(new_n214_), .b(x78), .O(new_n334_));
  oai21  g154(.a(new_n334_), .b(new_n333_), .c(x77), .O(new_n335_));
  nand3  g155(.a(x81), .b(x78), .c(new_n263_), .O(new_n336_));
  nand2  g156(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  nand4  g157(.a(new_n337_), .b(x84), .c(x79), .d(new_n155_), .O(new_n338_));
  inv1   g158(.a(new_n338_), .O(z65));
  zero   g159(.O(z00));
  zero   g160(.O(z01));
  zero   g161(.O(z02));
  zero   g162(.O(z12));
