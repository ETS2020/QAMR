...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n307_, new_n308_, new_n313_, new_n314_, new_n323_, new_n324_,
  ...
  nand4  g059(.a(new_n217_), .b(x44), .c(new_n209_), .d(new_n205_), .O(new_n220_));
  nor2   g060(.a(new_n220_), .b(x01), .O(z26));
  nand4  g061(.a(new_n217_), .b(x45), .c(new_n209_), .d(new_n205_), .O(new_n222_));
  nor2   g062(.a(new_n222_), .b(x01), .O(z27));
  nand4  g063(.a(new_n217_), .b(x46), .c(new_n209_), .d(new_n205_), .O(new_n224_));
  nor2   g064(.a(new_n224_), .b(x01), .O(z28));
  nand4  g065(.a(new_n217_), .b(x47), .c(new_n209_), .d(new_n205_), .O(new_n226_));
  nor2   g066(.a(new_n226_), .b(x01), .O(z29));
  nand4  g067(.a(new_n217_), .b(x48), .c(new_n209_), .d(new_n205_), .O(new_n228_));
  nor2   g068(.a(new_n228_), .b(x01), .O(z30));
  nand4  g069(.a(new_n217_), .b(x49), .c(new_n209_), .d(new_n205_), .O(new_n230_));
  nor2   g070(.a(new_n230_), .b(x01), .O(z31));
  nand4  g071(.a(new_n217_), .b(x50), .c(new_n209_), .d(new_n205_), .O(new_n232_));
  nor2   g072(.a(new_n232_), .b(x01), .O(z32));
  aoi21  g073(.a(x83), .b(x42), .c(x81), .O(new_n235_));
  nand3  g074(.a(x83), .b(x81), .c(x42), .O(new_n236_));
  inv1   g075(.a(new_n236_), .O(new_n237_));
  oai21  g076(.a(new_n237_), .b(new_n235_), .c(new_n213_), .O(new_n238_));
  nand2  g077(.a(x83), .b(x42), .O(new_n239_));
  nand2  g078(.a(new_n239_), .b(x81), .O(new_n240_));
  nand3  g079(.a(x83), .b(new_n212_), .c(x42), .O(new_n241_));
  nand2  g080(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g081(.a(new_n242_), .b(new_n210_), .O(new_n243_));
  aoi21  g082(.a(new_n243_), .b(new_n238_), .c(new_n156_), .O(new_n244_));
  nand4  g083(.a(new_n244_), .b(x78), .c(x77), .d(x52), .O(new_n245_));
  nor3   g084(.a(new_n245_), .b(x04), .c(x01), .O(z34));
  nand4  g085(.a(new_n244_), .b(x78), .c(x77), .d(x54), .O(new_n248_));
  nor3   g086(.a(new_n248_), .b(x04), .c(x01), .O(z36));
  nand4  g087(.a(new_n244_), .b(x78), .c(x77), .d(x55), .O(new_n250_));
  nor3   g088(.a(new_n250_), .b(x04), .c(x01), .O(z37));
  nand4  g089(.a(new_n244_), .b(x78), .c(x77), .d(x56), .O(new_n252_));
  nor3   g090(.a(new_n252_), .b(x04), .c(x01), .O(z38));
  nand4  g091(.a(new_n244_), .b(x78), .c(x77), .d(x58), .O(new_n255_));
  nor3   g092(.a(new_n255_), .b(x04), .c(x01), .O(z40));
  nand4  g093(.a(new_n244_), .b(x78), .c(x77), .d(x60), .O(new_n258_));
  nor3   g094(.a(new_n258_), .b(x04), .c(x01), .O(z42));
  nand4  g095(.a(new_n244_), .b(x78), .c(x77), .d(x61), .O(new_n260_));
  nor3   g096(.a(new_n260_), .b(x04), .c(x01), .O(z43));
  nand4  g097(.a(new_n244_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g099(.a(new_n244_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  inv1   g143(.a(x02), .O(new_n313_));
  nand4  g144(.a(x03), .b(new_n313_), .c(new_n155_), .d(x00), .O(new_n314_));
  inv1   g145(.a(new_n314_), .O(z57));
  nor2   g146(.a(new_n274_), .b(x04), .O(new_n323_));
  nor2   g147(.a(new_n212_), .b(x78), .O(new_n324_));
  oai21  g148(.a(new_n324_), .b(new_n323_), .c(x77), .O(new_n325_));
  nand3  g149(.a(x81), .b(x78), .c(new_n268_), .O(new_n326_));
  nand2  g150(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand4  g151(.a(new_n327_), .b(x84), .c(x79), .d(new_n155_), .O(new_n328_));
  inv1   g152(.a(new_n328_), .O(z65));
  zero   g153(.O(z00));
  zero   g154(.O(z01));
  zero   g155(.O(z02));
  zero   g156(.O(z12));
