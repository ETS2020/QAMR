...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n223_, new_n225_, new_n227_, new_n229_, new_n233_, new_n234_,
    new_n235_, new_n236_, new_n237_, new_n238_, new_n239_, new_n240_,
    new_n241_, new_n242_, new_n243_, new_n245_, new_n247_, new_n249_,
    new_n251_, new_n253_, new_n257_, new_n260_, new_n262_, new_n265_,
  ...
  nand4  g066(.a(new_n216_), .b(x50), .c(new_n208_), .d(new_n203_), .O(new_n229_));
  ...
  oai21  g071(.a(new_n235_), .b(new_n233_), .c(new_n212_), .O(new_n236_));
  nand2  g072(.a(x83), .b(x42), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g074(.a(x83), .b(new_n211_), .c(x42), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n209_), .O(new_n241_));
  aoi21  g077(.a(new_n241_), .b(new_n236_), .c(new_n156_), .O(new_n242_));
  nand4  g078(.a(new_n242_), .b(x78), .c(x77), .d(x53), .O(new_n243_));
  nor3   g079(.a(new_n243_), .b(x04), .c(x01), .O(z35));
  nand4  g080(.a(new_n242_), .b(x78), .c(x77), .d(x54), .O(new_n245_));
  nor3   g081(.a(new_n245_), .b(x04), .c(x01), .O(z36));
  nand4  g082(.a(new_n242_), .b(x78), .c(x77), .d(x55), .O(new_n247_));
  nor3   g083(.a(new_n247_), .b(x04), .c(x01), .O(z37));
  nand4  g084(.a(new_n242_), .b(x78), .c(x77), .d(x56), .O(new_n249_));
  ...
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g091(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g092(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g094(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  nor2   g138(.a(new_n271_), .b(x04), .O(new_n318_));
  nor2   g139(.a(new_n211_), .b(x78), .O(new_n319_));
  oai21  g140(.a(new_n319_), .b(new_n318_), .c(x77), .O(new_n320_));
  nand3  g141(.a(x81), .b(x78), .c(new_n265_), .O(new_n321_));
