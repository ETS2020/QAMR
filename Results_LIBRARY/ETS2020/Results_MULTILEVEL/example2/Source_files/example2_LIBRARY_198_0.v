...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n221_, new_n223_, new_n225_, new_n227_, new_n229_, new_n234_,
  ...
  oai21  g072(.a(new_n236_), .b(new_n234_), .c(new_n214_), .O(new_n237_));
  nand2  g073(.a(x83), .b(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g075(.a(x83), .b(new_n213_), .c(x42), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g077(.a(new_n241_), .b(new_n211_), .O(new_n242_));
  ...
  nand4  g085(.a(new_n243_), .b(x78), .c(x77), .d(x57), .O(new_n251_));
  ...
  nor2   g139(.a(new_n272_), .b(x04), .O(new_n319_));
  nor2   g140(.a(new_n213_), .b(x78), .O(new_n320_));
  oai21  g141(.a(new_n320_), .b(new_n319_), .c(x77), .O(new_n321_));
  nand3  g142(.a(x81), .b(x78), .c(new_n266_), .O(new_n322_));
