...
module FAU ( 
  ...
  nand4  g062(.a(new_n221_), .b(x48), .c(new_n213_), .d(new_n207_), .O(new_n226_));
  nor2   g063(.a(new_n226_), .b(x01), .O(z30));
  nand4  g064(.a(new_n221_), .b(x49), .c(new_n213_), .d(new_n207_), .O(new_n228_));
  nor2   g065(.a(new_n228_), .b(x01), .O(z31));
  nand4  g066(.a(new_n221_), .b(x50), .c(new_n213_), .d(new_n207_), .O(new_n230_));
