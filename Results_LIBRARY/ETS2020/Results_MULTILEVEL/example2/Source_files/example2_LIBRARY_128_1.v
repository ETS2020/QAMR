// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:36 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n278_, new_n280_, new_n282_, new_n284_, new_n289_, new_n291_,
  ...
  nand4  g086(.a(new_n239_), .b(x48), .c(new_n231_), .d(new_n225_), .O(new_n248_));
  ...
  nor2   g105(.a(new_n218_), .b(new_n231_), .O(new_n269_));
  ...
  nand4  g142(.a(new_n314_), .b(x78), .c(new_n159_), .d(x04), .O(new_n315_));
  ...
  nand2  g148(.a(new_n320_), .b(new_n234_), .O(new_n321_));
  nor4   g149(.a(new_n321_), .b(new_n317_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g150(.a(new_n227_), .b(x76), .O(new_n323_));
  inv1   g151(.a(new_n165_), .O(new_n324_));
  xnor2a g152(.a(x84), .b(x81), .O(new_n325_));
  aoi21  g153(.a(new_n167_), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g154(.a(new_n326_), .b(new_n153_), .O(new_n327_));
  nand2  g155(.a(new_n327_), .b(new_n323_), .O(new_n328_));
  nand2  g156(.a(new_n328_), .b(x79), .O(new_n329_));
  nand4  g157(.a(new_n329_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g158(.a(x02), .O(new_n331_));
  nand4  g159(.a(x03), .b(new_n331_), .c(new_n153_), .d(x00), .O(new_n332_));
  inv1   g160(.a(new_n332_), .O(z57));
  nand4  g161(.a(x80), .b(new_n216_), .c(x43), .d(new_n231_), .O(new_n334_));
  oai22  g162(.a(new_n334_), .b(new_n219_), .c(new_n231_), .d(x40), .O(new_n335_));
  nand4  g163(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g164(.a(x79), .b(x78), .O(new_n337_));
  nand3  g165(.a(new_n337_), .b(new_n231_), .c(x40), .O(new_n338_));
  nand2  g166(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g167(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g168(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n341_));
  aoi21  g169(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g170(.a(new_n160_), .b(new_n225_), .O(new_n343_));
  oai21  g171(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g172(.a(new_n219_), .b(new_n217_), .c(new_n231_), .O(new_n345_));
  ...
  nand2  g177(.a(new_n154_), .b(new_n225_), .O(new_n350_));
  aoi21  g178(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g179(.a(new_n326_), .b(x79), .O(new_n352_));
  nand3  g180(.a(new_n352_), .b(new_n350_), .c(new_n222_), .O(new_n353_));
  and2   g181(.a(new_n353_), .b(new_n153_), .O(z60));
  nand2  g182(.a(new_n167_), .b(new_n324_), .O(new_n355_));
  nand2  g183(.a(new_n355_), .b(new_n214_), .O(new_n356_));
  oai21  g184(.a(new_n227_), .b(x04), .c(new_n356_), .O(new_n357_));
  nand4  g185(.a(new_n357_), .b(x80), .c(x79), .d(new_n153_), .O(new_n358_));
  inv1   g186(.a(new_n358_), .O(z61));
  nand2  g187(.a(new_n154_), .b(x04), .O(new_n360_));
  ...
  nand3  g191(.a(x81), .b(x79), .c(new_n225_), .O(new_n364_));
  aoi21  g192(.a(new_n364_), .b(new_n363_), .c(new_n159_), .O(new_n365_));
  oai21  g193(.a(new_n365_), .b(new_n362_), .c(x78), .O(new_n366_));
  or2    g194(.a(new_n361_), .b(new_n167_), .O(new_n367_));
  aoi21  g195(.a(new_n367_), .b(new_n366_), .c(x01), .O(z62));
  nand4  g196(.a(new_n357_), .b(x82), .c(x79), .d(new_n153_), .O(new_n369_));
  inv1   g197(.a(new_n369_), .O(z63));
  nand3  g198(.a(new_n357_), .b(x83), .c(x79), .O(new_n371_));
  nand4  g199(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n372_));
