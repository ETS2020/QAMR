...
module FAU ( 
  ...
  nand2  g197(.a(new_n358_), .b(new_n235_), .O(new_n359_));
  nor4   g198(.a(new_n359_), .b(new_n355_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g199(.a(new_n228_), .b(x76), .O(new_n361_));
  ...
  nand4  g210(.a(x80), .b(new_n217_), .c(x43), .d(new_n232_), .O(new_n372_));
  oai22  g211(.a(new_n372_), .b(new_n220_), .c(new_n232_), .d(x40), .O(new_n373_));
  nand4  g212(.a(new_n373_), .b(x79), .c(x78), .d(x04), .O(new_n374_));
  nor2   g213(.a(x79), .b(x78), .O(new_n375_));
  nand3  g214(.a(new_n375_), .b(new_n232_), .c(x40), .O(new_n376_));
  nand2  g215(.a(new_n376_), .b(new_n374_), .O(new_n377_));
  nand2  g216(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g217(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n379_));
  aoi21  g218(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g219(.a(new_n160_), .b(new_n226_), .O(new_n381_));
  oai21  g220(.a(new_n381_), .b(new_n375_), .c(x40), .O(new_n382_));
  oai21  g221(.a(new_n220_), .b(new_n218_), .c(new_n232_), .O(new_n383_));
  ...
  nand2  g226(.a(new_n154_), .b(new_n226_), .O(new_n388_));
  aoi21  g227(.a(new_n388_), .b(new_n387_), .c(x01), .O(z59));
  nand2  g228(.a(new_n364_), .b(x79), .O(new_n390_));
  nand3  g229(.a(new_n390_), .b(new_n388_), .c(new_n223_), .O(new_n391_));
  and2   g230(.a(new_n391_), .b(new_n153_), .O(z60));
  nand2  g231(.a(new_n167_), .b(new_n362_), .O(new_n393_));
  nand2  g232(.a(new_n393_), .b(new_n215_), .O(new_n394_));
  oai21  g233(.a(new_n228_), .b(x04), .c(new_n394_), .O(new_n395_));
  ...
  nand3  g240(.a(x81), .b(x79), .c(new_n226_), .O(new_n402_));
