...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n246_, new_n249_, new_n251_, new_n253_, new_n257_, new_n259_,
  ...
  nand4  g069(.a(new_n220_), .b(x49), .c(new_n212_), .d(new_n207_), .O(new_n231_));
  nor2   g070(.a(new_n231_), .b(x01), .O(z31));
  nand4  g071(.a(new_n220_), .b(x50), .c(new_n212_), .d(new_n207_), .O(new_n233_));
  nor2   g072(.a(new_n233_), .b(x01), .O(z32));
  aoi21  g073(.a(x83), .b(x42), .c(x81), .O(new_n236_));
  nand3  g074(.a(x83), .b(x81), .c(x42), .O(new_n237_));
  inv1   g075(.a(new_n237_), .O(new_n238_));
  oai21  g076(.a(new_n238_), .b(new_n236_), .c(new_n216_), .O(new_n239_));
  nand2  g077(.a(x83), .b(x42), .O(new_n240_));
  nand2  g078(.a(new_n240_), .b(x81), .O(new_n241_));
  nand3  g079(.a(x83), .b(new_n215_), .c(x42), .O(new_n242_));
  nand2  g080(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  nand2  g081(.a(new_n243_), .b(new_n213_), .O(new_n244_));
  aoi21  g082(.a(new_n244_), .b(new_n239_), .c(new_n154_), .O(new_n245_));
  nand4  g083(.a(new_n245_), .b(x78), .c(x77), .d(x52), .O(new_n246_));
  nor3   g084(.a(new_n246_), .b(x04), .c(x01), .O(z34));
  nand4  g085(.a(new_n245_), .b(x78), .c(x77), .d(x54), .O(new_n249_));
  nor3   g086(.a(new_n249_), .b(x04), .c(x01), .O(z36));
  nand4  g087(.a(new_n245_), .b(x78), .c(x77), .d(x55), .O(new_n251_));
  nor3   g088(.a(new_n251_), .b(x04), .c(x01), .O(z37));
  nand4  g089(.a(new_n245_), .b(x78), .c(x77), .d(x56), .O(new_n253_));
  nor3   g090(.a(new_n253_), .b(x04), .c(x01), .O(z38));
  nand4  g091(.a(new_n245_), .b(x78), .c(x77), .d(x59), .O(new_n257_));
  nor3   g092(.a(new_n257_), .b(x04), .c(x01), .O(z41));
  nand4  g093(.a(new_n245_), .b(x78), .c(x77), .d(x60), .O(new_n259_));
  nor3   g094(.a(new_n259_), .b(x04), .c(x01), .O(z42));
  nand4  g095(.a(new_n245_), .b(x78), .c(x77), .d(x61), .O(new_n261_));
  nor3   g096(.a(new_n261_), .b(x04), .c(x01), .O(z43));
  nand4  g097(.a(new_n245_), .b(x78), .c(x77), .d(x62), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z44));
  nand4  g099(.a(new_n245_), .b(x78), .c(x77), .d(x63), .O(new_n265_));
  nor3   g100(.a(new_n265_), .b(x04), .c(x01), .O(z45));
  nand4  g101(.a(new_n245_), .b(x78), .c(x77), .d(x64), .O(new_n267_));
  ...
  nor2   g154(.a(new_n215_), .b(x78), .O(new_n330_));
