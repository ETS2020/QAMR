...
module FAU ( 
  ...
  nand2  g196(.a(new_n358_), .b(new_n239_), .O(new_n359_));
  nor4   g197(.a(new_n359_), .b(new_n355_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g198(.a(new_n232_), .b(x76), .O(new_n361_));
  ...
  nand4  g209(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n372_));
  oai22  g210(.a(new_n372_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n373_));
  ...
  oai21  g216(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n379_));
  aoi21  g217(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g218(.a(new_n160_), .b(new_n228_), .O(new_n381_));
  oai21  g219(.a(new_n381_), .b(new_n375_), .c(x40), .O(new_n382_));
  oai21  g220(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n383_));
  ...
  nand2  g225(.a(new_n154_), .b(new_n228_), .O(new_n388_));
  ...
  nand3  g239(.a(x81), .b(x79), .c(new_n228_), .O(new_n402_));
