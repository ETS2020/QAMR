...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n292_, new_n295_, new_n297_, new_n299_, new_n302_, new_n306_,
  ...
  nor4   g201(.a(new_n362_), .b(new_n358_), .c(new_n225_), .d(x82), .O(z55));
  ...
  nand4  g210(.a(x80), .b(new_n223_), .c(x43), .d(new_n238_), .O(new_n373_));
  oai22  g211(.a(new_n373_), .b(new_n226_), .c(new_n238_), .d(x40), .O(new_n374_));
  ...
  oai21  g217(.a(new_n165_), .b(new_n232_), .c(new_n154_), .O(new_n380_));
  aoi21  g218(.a(new_n380_), .b(new_n379_), .c(x01), .O(z58));
  nor2   g219(.a(new_n160_), .b(new_n232_), .O(new_n382_));
  oai21  g220(.a(new_n382_), .b(new_n376_), .c(x40), .O(new_n383_));
  oai21  g221(.a(new_n226_), .b(new_n224_), .c(new_n238_), .O(new_n384_));
  ...
  nand3  g240(.a(x81), .b(x79), .c(new_n232_), .O(new_n403_));
