...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n290_, new_n292_, new_n297_, new_n299_, new_n301_,
  ...
  nand4  g143(.a(new_n287_), .b(x78), .c(x77), .d(x60), .O(new_n301_));
  ...
  nand4  g215(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n376_));
  oai22  g216(.a(new_n376_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n377_));
  nand4  g217(.a(new_n377_), .b(x79), .c(x78), .d(x04), .O(new_n378_));
  nor2   g218(.a(x79), .b(x78), .O(new_n379_));
  nand3  g219(.a(new_n379_), .b(new_n241_), .c(x40), .O(new_n380_));
  ...
  oai21  g226(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n387_));
  ...
  nand3  g234(.a(new_n394_), .b(new_n392_), .c(new_n231_), .O(new_n395_));
  and2   g235(.a(new_n395_), .b(new_n153_), .O(z60));
  nand2  g236(.a(new_n167_), .b(new_n368_), .O(new_n397_));
  nand2  g237(.a(new_n397_), .b(new_n223_), .O(new_n398_));
  oai21  g238(.a(new_n237_), .b(x04), .c(new_n398_), .O(new_n399_));
  ...
  nor2   g256(.a(new_n244_), .b(x78), .O(new_n417_));
