...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n177_, new_n178_, new_n183_, new_n184_, new_n186_,
    ...
    new_n282_, new_n283_, new_n284_, new_n286_, new_n288_, new_n291_,
    new_n294_, new_n296_, new_n298_, new_n301_, new_n305_, new_n306_,
  ...
  nand4  g131(.a(new_n283_), .b(x78), .c(x77), .d(x54), .O(new_n288_));
  nor3   g132(.a(new_n288_), .b(x04), .c(x01), .O(z36));
  nand4  g133(.a(new_n283_), .b(x78), .c(x77), .d(x56), .O(new_n291_));
  nor3   g134(.a(new_n291_), .b(x04), .c(x01), .O(z38));
  nand4  g135(.a(new_n283_), .b(x78), .c(x77), .d(x58), .O(new_n294_));
  nor3   g136(.a(new_n294_), .b(x04), .c(x01), .O(z40));
  nand4  g137(.a(new_n283_), .b(x78), .c(x77), .d(x59), .O(new_n296_));
  nor3   g138(.a(new_n296_), .b(x04), .c(x01), .O(z41));
  nand4  g139(.a(new_n283_), .b(x78), .c(x77), .d(x60), .O(new_n298_));
  nor3   g140(.a(new_n298_), .b(x04), .c(x01), .O(z42));
  nand4  g141(.a(new_n283_), .b(x78), .c(x77), .d(x62), .O(new_n301_));
  ...
  nand4  g156(.a(new_n219_), .b(x79), .c(new_n160_), .d(x77), .O(new_n318_));
  ...
  nor4   g200(.a(new_n361_), .b(new_n357_), .c(new_n223_), .d(x82), .O(z55));
  ...
  nand4  g212(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n374_));
  oai22  g213(.a(new_n374_), .b(new_n224_), .c(new_n237_), .d(x40), .O(new_n375_));
  ...
  oai21  g219(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n381_));
  aoi21  g220(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  nor2   g221(.a(new_n160_), .b(new_n229_), .O(new_n383_));
  oai21  g222(.a(new_n383_), .b(new_n377_), .c(x40), .O(new_n384_));
  oai21  g223(.a(new_n224_), .b(new_n222_), .c(new_n237_), .O(new_n385_));
  ...
  nand3  g242(.a(x81), .b(x79), .c(new_n229_), .O(new_n404_));
