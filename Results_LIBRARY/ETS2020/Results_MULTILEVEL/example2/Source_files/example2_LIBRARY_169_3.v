...
module FAU ( 
  ...
  nor2   g155(.a(new_n313_), .b(new_n218_), .O(new_n314_));
  ...
  nand4  g162(.a(new_n219_), .b(x79), .c(new_n160_), .d(x77), .O(new_n321_));
  ...
  nand2  g205(.a(new_n363_), .b(new_n240_), .O(new_n364_));
  nor4   g206(.a(new_n364_), .b(new_n360_), .c(new_n223_), .d(x82), .O(z55));
  nand2  g207(.a(new_n233_), .b(x76), .O(new_n366_));
  ...
  nand4  g218(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n377_));
  oai22  g219(.a(new_n377_), .b(new_n224_), .c(new_n237_), .d(x40), .O(new_n378_));
  nand4  g220(.a(new_n378_), .b(x79), .c(x78), .d(x04), .O(new_n379_));
  nor2   g221(.a(x79), .b(x78), .O(new_n380_));
  nand3  g222(.a(new_n380_), .b(new_n237_), .c(x40), .O(new_n381_));
  nand2  g223(.a(new_n381_), .b(new_n379_), .O(new_n382_));
  nand2  g224(.a(new_n382_), .b(x77), .O(new_n383_));
  oai21  g225(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n384_));
  aoi21  g226(.a(new_n384_), .b(new_n383_), .c(x01), .O(z58));
  nor2   g227(.a(new_n160_), .b(new_n229_), .O(new_n386_));
  oai21  g228(.a(new_n386_), .b(new_n380_), .c(x40), .O(new_n387_));
  oai21  g229(.a(new_n224_), .b(new_n222_), .c(new_n237_), .O(new_n388_));
  ...
  nand2  g234(.a(new_n154_), .b(new_n229_), .O(new_n393_));
  aoi21  g235(.a(new_n393_), .b(new_n392_), .c(x01), .O(z59));
  nand2  g236(.a(new_n369_), .b(x79), .O(new_n395_));
  nand3  g237(.a(new_n395_), .b(new_n393_), .c(new_n227_), .O(new_n396_));
  and2   g238(.a(new_n396_), .b(new_n153_), .O(z60));
  nand2  g239(.a(new_n167_), .b(new_n367_), .O(new_n398_));
  nand2  g240(.a(new_n398_), .b(new_n219_), .O(new_n399_));
  oai21  g241(.a(new_n233_), .b(x04), .c(new_n399_), .O(new_n400_));
  ...
  nand3  g248(.a(x81), .b(x79), .c(new_n229_), .O(new_n407_));
  ...
  nor2   g259(.a(new_n240_), .b(x78), .O(new_n418_));
