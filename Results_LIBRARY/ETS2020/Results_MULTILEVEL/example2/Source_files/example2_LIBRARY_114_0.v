...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n211_, new_n212_, new_n217_, new_n218_, new_n219_, new_n220_,
    new_n221_, new_n222_, new_n223_, new_n224_, new_n225_, new_n226_,
    new_n228_, new_n231_, new_n234_, new_n237_, new_n238_, new_n239_,
    new_n240_, new_n241_, new_n242_, new_n243_, new_n244_, new_n245_,
    new_n246_, new_n247_, new_n249_, new_n251_, new_n253_, new_n256_,
    ...
    new_n314_, new_n315_, new_n316_, new_n317_, new_n329_, new_n330_,
  ...
  nand2  g058(.a(new_n218_), .b(x81), .O(new_n219_));
  inv1   g059(.a(x81), .O(new_n220_));
  xor2a  g060(.a(x84), .b(x82), .O(new_n221_));
  nand2  g061(.a(new_n221_), .b(new_n220_), .O(new_n222_));
  nand2  g062(.a(new_n222_), .b(new_n219_), .O(new_n223_));
  nand4  g063(.a(new_n223_), .b(x79), .c(x78), .d(x77), .O(new_n224_));
  inv1   g064(.a(new_n224_), .O(new_n225_));
  nand4  g065(.a(new_n225_), .b(x45), .c(new_n217_), .d(new_n211_), .O(new_n226_));
  nor2   g066(.a(new_n226_), .b(x01), .O(z27));
  nand4  g067(.a(new_n225_), .b(x46), .c(new_n217_), .d(new_n211_), .O(new_n228_));
  nor2   g068(.a(new_n228_), .b(x01), .O(z28));
  nand4  g069(.a(new_n225_), .b(x48), .c(new_n217_), .d(new_n211_), .O(new_n231_));
  nor2   g070(.a(new_n231_), .b(x01), .O(z30));
  nand4  g071(.a(new_n225_), .b(x50), .c(new_n217_), .d(new_n211_), .O(new_n234_));
  ...
  oai21  g076(.a(new_n239_), .b(new_n237_), .c(new_n221_), .O(new_n240_));
  nand2  g077(.a(x83), .b(x42), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g079(.a(x83), .b(new_n220_), .c(x42), .O(new_n243_));
  nand2  g080(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g081(.a(new_n244_), .b(new_n218_), .O(new_n245_));
  ...
  nand4  g091(.a(new_n246_), .b(x78), .c(x77), .d(x57), .O(new_n256_));
  nor3   g092(.a(new_n256_), .b(x04), .c(x01), .O(z39));
  nand4  g093(.a(new_n246_), .b(x78), .c(x77), .d(x59), .O(new_n259_));
  nor3   g094(.a(new_n259_), .b(x04), .c(x01), .O(z41));
  nand4  g095(.a(new_n246_), .b(x78), .c(x77), .d(x60), .O(new_n261_));
  nor3   g096(.a(new_n261_), .b(x04), .c(x01), .O(z42));
  nand4  g097(.a(new_n246_), .b(x78), .c(x77), .d(x61), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z43));
  nand4  g099(.a(new_n246_), .b(x78), .c(x77), .d(x62), .O(new_n265_));
  nor3   g100(.a(new_n265_), .b(x04), .c(x01), .O(z44));
  nand4  g101(.a(new_n246_), .b(x78), .c(x77), .d(x63), .O(new_n267_));
  nor3   g102(.a(new_n267_), .b(x04), .c(x01), .O(z45));
  nand4  g103(.a(new_n246_), .b(x78), .c(x77), .d(x64), .O(new_n269_));
  nor3   g104(.a(new_n269_), .b(x04), .c(x01), .O(z46));
  inv1   g105(.a(x77), .O(new_n272_));
  nand2  g106(.a(x52), .b(x16), .O(new_n273_));
  inv1   g107(.a(x52), .O(new_n274_));
  nand2  g108(.a(new_n274_), .b(x08), .O(new_n275_));
  aoi21  g109(.a(new_n275_), .b(new_n273_), .c(x79), .O(new_n276_));
  nand4  g110(.a(new_n276_), .b(x78), .c(new_n272_), .d(x04), .O(new_n277_));
  inv1   g111(.a(x78), .O(new_n278_));
  xnor2a g112(.a(x84), .b(x81), .O(new_n279_));
  nand4  g113(.a(new_n279_), .b(x79), .c(new_n278_), .d(x77), .O(new_n280_));
  inv1   g114(.a(new_n280_), .O(new_n281_));
  nand2  g115(.a(new_n281_), .b(x68), .O(new_n282_));
  aoi21  g116(.a(new_n282_), .b(new_n277_), .c(x01), .O(z48));
  nand2  g117(.a(x52), .b(x17), .O(new_n284_));
  nand2  g118(.a(new_n274_), .b(x09), .O(new_n285_));
  aoi21  g119(.a(new_n285_), .b(new_n284_), .c(x79), .O(new_n286_));
  nand4  g120(.a(new_n286_), .b(x78), .c(new_n272_), .d(x04), .O(new_n287_));
  nand2  g121(.a(new_n281_), .b(x69), .O(new_n288_));
  aoi21  g122(.a(new_n288_), .b(new_n287_), .c(x01), .O(z49));
  nand2  g123(.a(x52), .b(x18), .O(new_n290_));
  nand2  g124(.a(new_n274_), .b(x10), .O(new_n291_));
  aoi21  g125(.a(new_n291_), .b(new_n290_), .c(x79), .O(new_n292_));
  nand4  g126(.a(new_n292_), .b(x78), .c(new_n272_), .d(x04), .O(new_n293_));
  nand2  g127(.a(new_n281_), .b(x70), .O(new_n294_));
  aoi21  g128(.a(new_n294_), .b(new_n293_), .c(x01), .O(z50));
  nand2  g129(.a(x52), .b(x19), .O(new_n296_));
  nand2  g130(.a(new_n274_), .b(x11), .O(new_n297_));
  aoi21  g131(.a(new_n297_), .b(new_n296_), .c(x79), .O(new_n298_));
  nand4  g132(.a(new_n298_), .b(x78), .c(new_n272_), .d(x04), .O(new_n299_));
  nand2  g133(.a(new_n281_), .b(x71), .O(new_n300_));
  aoi21  g134(.a(new_n300_), .b(new_n299_), .c(x01), .O(z51));
  nand2  g135(.a(x52), .b(x20), .O(new_n302_));
  nand2  g136(.a(new_n274_), .b(x12), .O(new_n303_));
  aoi21  g137(.a(new_n303_), .b(new_n302_), .c(x79), .O(new_n304_));
  nand4  g138(.a(new_n304_), .b(x78), .c(new_n272_), .d(x04), .O(new_n305_));
  nand2  g139(.a(new_n281_), .b(x72), .O(new_n306_));
  aoi21  g140(.a(new_n306_), .b(new_n305_), .c(x01), .O(z52));
  nand2  g141(.a(x52), .b(x21), .O(new_n308_));
  nand2  g142(.a(new_n274_), .b(x13), .O(new_n309_));
  aoi21  g143(.a(new_n309_), .b(new_n308_), .c(x79), .O(new_n310_));
  nand4  g144(.a(new_n310_), .b(x78), .c(new_n272_), .d(x04), .O(new_n311_));
  nand2  g145(.a(new_n281_), .b(x73), .O(new_n312_));
  aoi21  g146(.a(new_n312_), .b(new_n311_), .c(x01), .O(z53));
  nand2  g147(.a(x52), .b(x22), .O(new_n314_));
  nand2  g148(.a(new_n274_), .b(x14), .O(new_n315_));
  aoi21  g149(.a(new_n315_), .b(new_n314_), .c(x79), .O(new_n316_));
  nand4  g150(.a(new_n316_), .b(x78), .c(new_n272_), .d(x04), .O(new_n317_));
  nor2   g151(.a(new_n317_), .b(x01), .O(z54));
  nor2   g152(.a(new_n278_), .b(x04), .O(new_n329_));
  nor2   g153(.a(new_n220_), .b(x78), .O(new_n330_));
  oai21  g154(.a(new_n330_), .b(new_n329_), .c(x77), .O(new_n331_));
  nand3  g155(.a(x81), .b(x78), .c(new_n272_), .O(new_n332_));
  nand2  g156(.a(new_n332_), .b(new_n331_), .O(new_n333_));
  nand4  g157(.a(new_n333_), .b(x84), .c(x79), .d(new_n153_), .O(new_n334_));
  inv1   g158(.a(new_n334_), .O(z65));
  zero   g159(.O(z01));
  zero   g160(.O(z02));
  zero   g161(.O(z12));
  zero   g162(.O(z13));
