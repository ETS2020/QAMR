...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n203_, new_n205_, new_n206_, new_n208_, new_n209_, new_n212_,
    ...
    new_n289_, new_n291_, new_n293_, new_n296_, new_n298_, new_n302_,
    new_n305_, new_n307_, new_n309_, new_n310_, new_n311_, new_n312_,
    new_n313_, new_n314_, new_n315_, new_n316_, new_n325_, new_n326_,
  ...
  nor2   g155(.a(new_n314_), .b(new_n222_), .O(new_n315_));
  nand4  g156(.a(new_n315_), .b(x79), .c(new_n160_), .d(x77), .O(new_n316_));
  aoi21  g157(.a(new_n316_), .b(new_n313_), .c(x01), .O(z47));
  inv1   g158(.a(x84), .O(new_n325_));
  nor2   g159(.a(x04), .b(x01), .O(new_n326_));
  nand4  g160(.a(new_n326_), .b(x79), .c(x78), .d(x77), .O(new_n327_));
  nor2   g161(.a(new_n327_), .b(x80), .O(new_n328_));
  nand2  g162(.a(new_n328_), .b(new_n244_), .O(new_n329_));
  nor4   g163(.a(new_n329_), .b(new_n325_), .c(new_n227_), .d(x82), .O(z55));
  nand2  g164(.a(new_n237_), .b(x76), .O(new_n331_));
  inv1   g165(.a(new_n165_), .O(new_n332_));
  xnor2a g166(.a(x84), .b(x81), .O(new_n333_));
  aoi21  g167(.a(new_n167_), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g168(.a(new_n334_), .b(new_n153_), .O(new_n335_));
  nand2  g169(.a(new_n335_), .b(new_n331_), .O(new_n336_));
  nand2  g170(.a(new_n336_), .b(x79), .O(new_n337_));
  nand4  g171(.a(new_n337_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g172(.a(x02), .O(new_n339_));
  nand4  g173(.a(x03), .b(new_n339_), .c(new_n153_), .d(x00), .O(new_n340_));
  inv1   g174(.a(new_n340_), .O(z57));
  nand4  g175(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n342_));
  oai22  g176(.a(new_n342_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n343_));
  nand4  g177(.a(new_n343_), .b(x79), .c(x78), .d(x04), .O(new_n344_));
  nor2   g178(.a(x79), .b(x78), .O(new_n345_));
  nand3  g179(.a(new_n345_), .b(new_n241_), .c(x40), .O(new_n346_));
  nand2  g180(.a(new_n346_), .b(new_n344_), .O(new_n347_));
  nand2  g181(.a(new_n347_), .b(x77), .O(new_n348_));
  oai21  g182(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n349_));
  aoi21  g183(.a(new_n349_), .b(new_n348_), .c(x01), .O(z58));
  nor2   g184(.a(new_n160_), .b(new_n233_), .O(new_n351_));
  oai21  g185(.a(new_n351_), .b(new_n345_), .c(x40), .O(new_n352_));
  oai21  g186(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n353_));
  nand2  g187(.a(new_n353_), .b(x79), .O(new_n354_));
  nand3  g188(.a(new_n354_), .b(x78), .c(x04), .O(new_n355_));
  nand2  g189(.a(new_n355_), .b(new_n352_), .O(new_n356_));
  nand2  g190(.a(new_n356_), .b(x77), .O(new_n357_));
  nand2  g191(.a(new_n154_), .b(new_n233_), .O(new_n358_));
  aoi21  g192(.a(new_n358_), .b(new_n357_), .c(x01), .O(z59));
  nand2  g193(.a(new_n334_), .b(x79), .O(new_n360_));
  nand3  g194(.a(new_n360_), .b(new_n358_), .c(new_n231_), .O(new_n361_));
  and2   g195(.a(new_n361_), .b(new_n153_), .O(z60));
  nand2  g196(.a(new_n167_), .b(new_n332_), .O(new_n363_));
  nand2  g197(.a(new_n363_), .b(new_n223_), .O(new_n364_));
  oai21  g198(.a(new_n237_), .b(x04), .c(new_n364_), .O(new_n365_));
  nand4  g199(.a(new_n365_), .b(x80), .c(x79), .d(new_n153_), .O(new_n366_));
  inv1   g200(.a(new_n366_), .O(z61));
  nand2  g201(.a(new_n154_), .b(x04), .O(new_n368_));
  nand3  g202(.a(x84), .b(x81), .c(x79), .O(new_n369_));
  aoi21  g203(.a(new_n369_), .b(new_n368_), .c(x77), .O(new_n370_));
  nand2  g204(.a(new_n354_), .b(x04), .O(new_n371_));
  nand3  g205(.a(x81), .b(x79), .c(new_n233_), .O(new_n372_));
  aoi21  g206(.a(new_n372_), .b(new_n371_), .c(new_n159_), .O(new_n373_));
  oai21  g207(.a(new_n373_), .b(new_n370_), .c(x78), .O(new_n374_));
  or2    g208(.a(new_n369_), .b(new_n167_), .O(new_n375_));
  aoi21  g209(.a(new_n375_), .b(new_n374_), .c(x01), .O(z62));
  nand4  g210(.a(new_n365_), .b(x82), .c(x79), .d(new_n153_), .O(new_n377_));
  inv1   g211(.a(new_n377_), .O(z63));
  nand3  g212(.a(new_n365_), .b(x83), .c(x79), .O(new_n379_));
  nand4  g213(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n380_));
  aoi21  g214(.a(new_n380_), .b(new_n379_), .c(x01), .O(z64));
  zero   g215(.O(z03));
  zero   g216(.O(z11));
  zero   g217(.O(z18));
  zero   g218(.O(z31));
