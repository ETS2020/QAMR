...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n184_, new_n188_, new_n189_, new_n191_, new_n192_, new_n194_,
    ...
    new_n295_, new_n298_, new_n303_, new_n304_, new_n305_, new_n306_,
  ...
  nand4  g129(.a(new_n283_), .b(x78), .c(x77), .d(x54), .O(new_n287_));
  ...
  nand2  g195(.a(new_n358_), .b(new_n240_), .O(new_n359_));
  nor4   g196(.a(new_n359_), .b(new_n355_), .c(new_n223_), .d(x82), .O(z55));
  nand2  g197(.a(new_n233_), .b(x76), .O(new_n361_));
  ...
  nand4  g208(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n372_));
  oai22  g209(.a(new_n372_), .b(new_n224_), .c(new_n237_), .d(x40), .O(new_n373_));
  nand4  g210(.a(new_n373_), .b(x79), .c(x78), .d(x04), .O(new_n374_));
  nor2   g211(.a(x79), .b(x78), .O(new_n375_));
  nand3  g212(.a(new_n375_), .b(new_n237_), .c(x40), .O(new_n376_));
  nand2  g213(.a(new_n376_), .b(new_n374_), .O(new_n377_));
  nand2  g214(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g215(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n379_));
  aoi21  g216(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g217(.a(new_n160_), .b(new_n229_), .O(new_n381_));
  oai21  g218(.a(new_n381_), .b(new_n375_), .c(x40), .O(new_n382_));
  oai21  g219(.a(new_n224_), .b(new_n222_), .c(new_n237_), .O(new_n383_));
  ...
  nand2  g224(.a(new_n154_), .b(new_n229_), .O(new_n388_));
  aoi21  g225(.a(new_n388_), .b(new_n387_), .c(x01), .O(z59));
  nand2  g226(.a(new_n364_), .b(x79), .O(new_n390_));
  nand3  g227(.a(new_n390_), .b(new_n388_), .c(new_n227_), .O(new_n391_));
  and2   g228(.a(new_n391_), .b(new_n153_), .O(z60));
  nand2  g229(.a(new_n167_), .b(new_n362_), .O(new_n393_));
  nand2  g230(.a(new_n393_), .b(new_n219_), .O(new_n394_));
  oai21  g231(.a(new_n233_), .b(x04), .c(new_n394_), .O(new_n395_));
  ...
  nand3  g238(.a(x81), .b(x79), .c(new_n229_), .O(new_n402_));
