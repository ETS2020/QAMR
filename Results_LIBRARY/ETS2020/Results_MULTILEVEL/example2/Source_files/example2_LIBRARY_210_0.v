...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n246_, new_n247_, new_n250_, new_n252_, new_n254_, new_n257_,
  ...
  nand4  g070(.a(new_n222_), .b(x48), .c(new_n214_), .d(new_n209_), .O(new_n231_));
  nor2   g071(.a(new_n231_), .b(x01), .O(z30));
  nand4  g072(.a(new_n222_), .b(x50), .c(new_n214_), .d(new_n209_), .O(new_n234_));
  ...
  oai21  g077(.a(new_n239_), .b(new_n237_), .c(new_n218_), .O(new_n240_));
  nand2  g078(.a(x83), .b(x42), .O(new_n241_));
  nand2  g079(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g080(.a(x83), .b(new_n217_), .c(x42), .O(new_n243_));
  nand2  g081(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g082(.a(new_n244_), .b(new_n215_), .O(new_n245_));
  ...
  nand4  g092(.a(new_n246_), .b(x78), .c(x77), .d(x58), .O(new_n257_));
  ...
  nand4  g100(.a(new_n246_), .b(x78), .c(x77), .d(x63), .O(new_n266_));
  nor3   g101(.a(new_n266_), .b(x04), .c(x01), .O(z45));
  nand4  g102(.a(new_n246_), .b(x78), .c(x77), .d(x64), .O(new_n268_));
