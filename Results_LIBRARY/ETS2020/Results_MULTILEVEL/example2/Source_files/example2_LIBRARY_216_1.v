...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n289_, new_n291_, new_n295_, new_n297_,
  ...
  nand4  g138(.a(new_n279_), .b(x78), .c(x77), .d(x64), .O(new_n301_));
  ...
  nand2  g153(.a(new_n322_), .b(new_n239_), .O(new_n323_));
  ...
  nand4  g163(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n334_));
  oai22  g164(.a(new_n334_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n335_));
  nand4  g165(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g166(.a(x79), .b(x78), .O(new_n337_));
  nand3  g167(.a(new_n337_), .b(new_n236_), .c(x40), .O(new_n338_));
  nand2  g168(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g169(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g170(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n341_));
  aoi21  g171(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g172(.a(new_n160_), .b(new_n228_), .O(new_n343_));
  oai21  g173(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g174(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n345_));
  ...
  nand2  g179(.a(new_n154_), .b(new_n228_), .O(new_n350_));
  aoi21  g180(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g181(.a(new_n328_), .b(x79), .O(new_n352_));
  nand3  g182(.a(new_n352_), .b(new_n350_), .c(new_n226_), .O(new_n353_));
  and2   g183(.a(new_n353_), .b(new_n153_), .O(z60));
  nand2  g184(.a(new_n167_), .b(new_n326_), .O(new_n355_));
  nand2  g185(.a(new_n355_), .b(new_n218_), .O(new_n356_));
  oai21  g186(.a(new_n232_), .b(x04), .c(new_n356_), .O(new_n357_));
  ...
  nand3  g193(.a(x81), .b(x79), .c(new_n228_), .O(new_n364_));
  ...
  nand3  g198(.a(new_n357_), .b(x83), .c(x79), .O(new_n370_));
  nand4  g199(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n371_));
  aoi21  g200(.a(new_n371_), .b(new_n370_), .c(x01), .O(z64));
  nor2   g201(.a(new_n160_), .b(x04), .O(new_n373_));
  nor2   g202(.a(new_n239_), .b(x78), .O(new_n374_));
  oai21  g203(.a(new_n374_), .b(new_n373_), .c(x77), .O(new_n375_));
  nand3  g204(.a(x81), .b(x78), .c(new_n159_), .O(new_n376_));
  nand2  g205(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand4  g206(.a(new_n377_), .b(x84), .c(x79), .d(new_n153_), .O(new_n378_));
  inv1   g207(.a(new_n378_), .O(z65));
  zero   g208(.O(z05));
  zero   g209(.O(z14));
  zero   g210(.O(z16));
  zero   g211(.O(z18));
