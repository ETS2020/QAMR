...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n240_, new_n243_, new_n245_, new_n248_, new_n250_, new_n252_,
  ...
  nand4  g080(.a(new_n239_), .b(x78), .c(x77), .d(x57), .O(new_n248_));
  nor3   g081(.a(new_n248_), .b(x04), .c(x01), .O(z39));
  nand4  g082(.a(new_n239_), .b(x78), .c(x77), .d(x58), .O(new_n250_));
  nor3   g083(.a(new_n250_), .b(x04), .c(x01), .O(z40));
