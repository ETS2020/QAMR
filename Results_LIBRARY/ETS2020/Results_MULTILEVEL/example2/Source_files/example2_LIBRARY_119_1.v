...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n244_, new_n248_, new_n250_, new_n252_, new_n255_,
  ...
  nand4  g094(.a(new_n243_), .b(x50), .c(new_n235_), .d(new_n229_), .O(new_n255_));
  ...
  nor2   g111(.a(new_n222_), .b(new_n235_), .O(new_n273_));
  nand3  g112(.a(x83), .b(x81), .c(x42), .O(new_n274_));
  oai21  g113(.a(new_n273_), .b(x81), .c(new_n274_), .O(new_n275_));
  nand2  g114(.a(new_n275_), .b(new_n239_), .O(new_n276_));
  oai22  g115(.a(new_n273_), .b(new_n238_), .c(new_n257_), .d(new_n235_), .O(new_n277_));
  nand2  g116(.a(new_n277_), .b(new_n236_), .O(new_n278_));
  ...
  nand4  g126(.a(new_n279_), .b(x78), .c(x77), .d(x61), .O(new_n292_));
  nor3   g127(.a(new_n292_), .b(x04), .c(x01), .O(z43));
  nand4  g128(.a(new_n279_), .b(x78), .c(x77), .d(x62), .O(new_n294_));
  nor3   g129(.a(new_n294_), .b(x04), .c(x01), .O(z44));
  nand4  g130(.a(new_n279_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  ...
  nand2  g145(.a(new_n318_), .b(new_n238_), .O(new_n319_));
  ...
  nand4  g155(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n330_));
  oai22  g156(.a(new_n330_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n331_));
  nand4  g157(.a(new_n331_), .b(x79), .c(x78), .d(x04), .O(new_n332_));
  nor2   g158(.a(x79), .b(x78), .O(new_n333_));
  nand3  g159(.a(new_n333_), .b(new_n235_), .c(x40), .O(new_n334_));
  ...
  oai21  g166(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n341_));
