...
module FAU ( 
  ...
  inv1   g071(.a(x83), .O(new_n235_));
  nor2   g072(.a(new_n235_), .b(new_n213_), .O(new_n236_));
  nand3  g073(.a(x83), .b(x81), .c(x42), .O(new_n237_));
  oai21  g074(.a(new_n236_), .b(x81), .c(new_n237_), .O(new_n238_));
  nand2  g075(.a(new_n238_), .b(new_n217_), .O(new_n239_));
  nand3  g076(.a(x83), .b(new_n216_), .c(x42), .O(new_n240_));
  oai21  g077(.a(new_n236_), .b(new_n216_), .c(new_n240_), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(new_n214_), .O(new_n242_));
  aoi21  g079(.a(new_n242_), .b(new_n239_), .c(new_n154_), .O(new_n243_));
  ...
  nand4  g090(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g091(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g092(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g093(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g095(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g097(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  nand4  g148(.a(x03), .b(new_n317_), .c(new_n153_), .d(x00), .O(new_n318_));
  inv1   g149(.a(new_n318_), .O(z57));
  nand2  g150(.a(new_n154_), .b(x04), .O(new_n324_));
  nand3  g151(.a(x84), .b(x81), .c(x79), .O(new_n325_));
  aoi21  g152(.a(new_n325_), .b(new_n324_), .c(x77), .O(new_n326_));
  inv1   g153(.a(x74), .O(new_n327_));
  nand3  g154(.a(x80), .b(new_n327_), .c(x43), .O(new_n328_));
  nand4  g155(.a(x84), .b(new_n235_), .c(x82), .d(x81), .O(new_n329_));
  oai21  g156(.a(new_n329_), .b(new_n328_), .c(new_n213_), .O(new_n330_));
  nand2  g157(.a(new_n330_), .b(x79), .O(new_n331_));
  nand2  g158(.a(new_n331_), .b(x04), .O(new_n332_));
  nand3  g159(.a(x81), .b(x79), .c(new_n207_), .O(new_n333_));
  aoi21  g160(.a(new_n333_), .b(new_n332_), .c(new_n268_), .O(new_n334_));
  oai21  g161(.a(new_n334_), .b(new_n326_), .c(x78), .O(new_n335_));
  inv1   g162(.a(new_n325_), .O(new_n336_));
  nand3  g163(.a(new_n336_), .b(new_n274_), .c(x77), .O(new_n337_));
  aoi21  g164(.a(new_n337_), .b(new_n335_), .c(x01), .O(z62));
  nor2   g165(.a(new_n274_), .b(x04), .O(new_n341_));
  nor2   g166(.a(new_n216_), .b(x78), .O(new_n342_));
  oai21  g167(.a(new_n342_), .b(new_n341_), .c(x77), .O(new_n343_));
  nand3  g168(.a(x81), .b(x78), .c(new_n268_), .O(new_n344_));
  nand2  g169(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  nand4  g170(.a(new_n345_), .b(x84), .c(x79), .d(new_n153_), .O(new_n346_));
  inv1   g171(.a(new_n346_), .O(z65));
  zero   g172(.O(z01));
  zero   g173(.O(z02));
  zero   g174(.O(z10));
  zero   g175(.O(z13));
