...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n279_, new_n281_, new_n284_, new_n287_, new_n289_, new_n291_,
  ...
  nand4  g081(.a(new_n238_), .b(x46), .c(new_n230_), .d(new_n222_), .O(new_n243_));
  nor2   g082(.a(new_n243_), .b(x01), .O(z28));
  nand4  g083(.a(new_n238_), .b(x47), .c(new_n230_), .d(new_n222_), .O(new_n245_));
  nor2   g084(.a(new_n245_), .b(x01), .O(z29));
  nand4  g085(.a(new_n238_), .b(x48), .c(new_n230_), .d(new_n222_), .O(new_n247_));
  nor2   g086(.a(new_n247_), .b(x01), .O(z30));
  nand4  g087(.a(new_n238_), .b(x50), .c(new_n230_), .d(new_n222_), .O(new_n250_));
  nor2   g088(.a(new_n250_), .b(x01), .O(z32));
  nand2  g089(.a(x83), .b(new_n233_), .O(new_n252_));
  nand2  g090(.a(new_n216_), .b(x81), .O(new_n253_));
  ...
  nand4  g102(.a(new_n264_), .b(x78), .c(x77), .d(new_n222_), .O(new_n265_));
  nor2   g103(.a(new_n265_), .b(x01), .O(z33));
  nor2   g104(.a(new_n216_), .b(new_n230_), .O(new_n267_));
  nand3  g105(.a(x83), .b(x81), .c(x42), .O(new_n268_));
  oai21  g106(.a(new_n267_), .b(x81), .c(new_n268_), .O(new_n269_));
  nand2  g107(.a(new_n269_), .b(new_n234_), .O(new_n270_));
  oai22  g108(.a(new_n267_), .b(new_n233_), .c(new_n252_), .d(new_n230_), .O(new_n271_));
  nand2  g109(.a(new_n271_), .b(new_n231_), .O(new_n272_));
  aoi21  g110(.a(new_n272_), .b(new_n270_), .c(new_n154_), .O(new_n273_));
  nand4  g111(.a(new_n273_), .b(x78), .c(x77), .d(x52), .O(new_n274_));
  nor3   g112(.a(new_n274_), .b(x04), .c(x01), .O(z34));
  nand4  g113(.a(new_n273_), .b(x78), .c(x77), .d(x54), .O(new_n277_));
  nor3   g114(.a(new_n277_), .b(x04), .c(x01), .O(z36));
  nand4  g115(.a(new_n273_), .b(x78), .c(x77), .d(x55), .O(new_n279_));
  nor3   g116(.a(new_n279_), .b(x04), .c(x01), .O(z37));
  nand4  g117(.a(new_n273_), .b(x78), .c(x77), .d(x56), .O(new_n281_));
  nor3   g118(.a(new_n281_), .b(x04), .c(x01), .O(z38));
  nand4  g119(.a(new_n273_), .b(x78), .c(x77), .d(x58), .O(new_n284_));
  nor3   g120(.a(new_n284_), .b(x04), .c(x01), .O(z40));
  nand4  g121(.a(new_n273_), .b(x78), .c(x77), .d(x60), .O(new_n287_));
  nor3   g122(.a(new_n287_), .b(x04), .c(x01), .O(z42));
  nand4  g123(.a(new_n273_), .b(x78), .c(x77), .d(x61), .O(new_n289_));
  nor3   g124(.a(new_n289_), .b(x04), .c(x01), .O(z43));
  nand4  g125(.a(new_n273_), .b(x78), .c(x77), .d(x62), .O(new_n291_));
  ...
  nor2   g133(.a(new_n300_), .b(new_n211_), .O(new_n301_));
  nand4  g134(.a(new_n301_), .b(x79), .c(new_n160_), .d(x77), .O(new_n302_));
  aoi21  g135(.a(new_n302_), .b(new_n299_), .c(x01), .O(z47));
  inv1   g136(.a(x84), .O(new_n311_));
  nor2   g137(.a(x04), .b(x01), .O(new_n312_));
  nand4  g138(.a(new_n312_), .b(x79), .c(x78), .d(x77), .O(new_n313_));
  nor2   g139(.a(new_n313_), .b(x80), .O(new_n314_));
  nand2  g140(.a(new_n314_), .b(new_n233_), .O(new_n315_));
  nor4   g141(.a(new_n315_), .b(new_n311_), .c(new_n216_), .d(x82), .O(z55));
  nand2  g142(.a(new_n226_), .b(x76), .O(new_n317_));
  inv1   g143(.a(new_n165_), .O(new_n318_));
  xnor2a g144(.a(x84), .b(x81), .O(new_n319_));
  aoi21  g145(.a(new_n167_), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g146(.a(new_n320_), .b(new_n153_), .O(new_n321_));
  nand2  g147(.a(new_n321_), .b(new_n317_), .O(new_n322_));
  nand2  g148(.a(new_n322_), .b(x79), .O(new_n323_));
  nand4  g149(.a(new_n323_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g150(.a(x80), .b(new_n214_), .c(x43), .d(new_n230_), .O(new_n326_));
  oai22  g151(.a(new_n326_), .b(new_n217_), .c(new_n230_), .d(x40), .O(new_n327_));
  nand4  g152(.a(new_n327_), .b(x79), .c(x78), .d(x04), .O(new_n328_));
  nor2   g153(.a(x79), .b(x78), .O(new_n329_));
  nand3  g154(.a(new_n329_), .b(new_n230_), .c(x40), .O(new_n330_));
  nand2  g155(.a(new_n330_), .b(new_n328_), .O(new_n331_));
  nand2  g156(.a(new_n331_), .b(x77), .O(new_n332_));
  oai21  g157(.a(new_n165_), .b(new_n222_), .c(new_n154_), .O(new_n333_));
  aoi21  g158(.a(new_n333_), .b(new_n332_), .c(x01), .O(z58));
  nor2   g159(.a(new_n160_), .b(new_n222_), .O(new_n335_));
  oai21  g160(.a(new_n335_), .b(new_n329_), .c(x40), .O(new_n336_));
  oai21  g161(.a(new_n217_), .b(new_n215_), .c(new_n230_), .O(new_n337_));
  ...
  nand3  g180(.a(x81), .b(x79), .c(new_n222_), .O(new_n356_));
  ...
  nor2   g191(.a(new_n233_), .b(x78), .O(new_n367_));
