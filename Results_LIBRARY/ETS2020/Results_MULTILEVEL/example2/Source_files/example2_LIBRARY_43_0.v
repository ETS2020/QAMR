...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n174_, new_n175_, new_n181_, new_n182_, new_n184_, new_n185_,
  ...
  nand4  g088(.a(new_n236_), .b(x78), .c(x77), .d(x64), .O(new_n258_));
  ...
  nor2   g136(.a(new_n207_), .b(x78), .O(new_n317_));
