...
module FAU ( 
  ...
  nand4  g060(.a(new_n215_), .b(x48), .c(new_n207_), .d(new_n206_), .O(new_n224_));
  nor2   g061(.a(new_n224_), .b(x01), .O(z30));
  nand4  g062(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n206_), .O(new_n227_));
  ...
  oai21  g067(.a(new_n232_), .b(new_n230_), .c(new_n211_), .O(new_n233_));
  nand2  g068(.a(x83), .b(x42), .O(new_n234_));
  nand2  g069(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g070(.a(x83), .b(new_n210_), .c(x42), .O(new_n236_));
  nand2  g071(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g072(.a(new_n237_), .b(new_n208_), .O(new_n238_));
