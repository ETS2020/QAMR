...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n289_, new_n291_, new_n293_, new_n297_,
  ...
  nand4  g128(.a(new_n281_), .b(x78), .c(x77), .d(x57), .O(new_n289_));
  nor3   g129(.a(new_n289_), .b(x04), .c(x01), .O(z39));
  nand4  g130(.a(new_n281_), .b(x78), .c(x77), .d(x58), .O(new_n291_));
  nor3   g131(.a(new_n291_), .b(x04), .c(x01), .O(z40));
  nand4  g132(.a(new_n281_), .b(x78), .c(x77), .d(x59), .O(new_n293_));
  nor3   g133(.a(new_n293_), .b(x04), .c(x01), .O(z41));
  nand4  g134(.a(new_n281_), .b(x78), .c(x77), .d(x62), .O(new_n297_));
  nor3   g135(.a(new_n297_), .b(x04), .c(x01), .O(z44));
  nand4  g136(.a(new_n281_), .b(x78), .c(x77), .d(x63), .O(new_n299_));
