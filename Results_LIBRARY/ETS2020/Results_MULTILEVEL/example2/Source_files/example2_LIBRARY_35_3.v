...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n202_, new_n206_, new_n207_, new_n210_, new_n211_, new_n213_,
  ...
  nand4  g144(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n303_));
  nor3   g145(.a(new_n303_), .b(x04), .c(x01), .O(z44));
  nand4  g146(.a(new_n284_), .b(x78), .c(x77), .d(x63), .O(new_n305_));
