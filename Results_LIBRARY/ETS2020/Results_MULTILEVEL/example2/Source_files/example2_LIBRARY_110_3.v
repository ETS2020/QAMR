...
module FAU ( 
  ...
  nand4  g150(.a(new_n290_), .b(x78), .c(x77), .d(x60), .O(new_n305_));
  nor3   g151(.a(new_n305_), .b(x04), .c(x01), .O(z42));
  nand4  g152(.a(new_n290_), .b(x78), .c(x77), .d(x61), .O(new_n307_));
  nor3   g153(.a(new_n307_), .b(x04), .c(x01), .O(z43));
  nand4  g154(.a(new_n290_), .b(x78), .c(x77), .d(x62), .O(new_n309_));
