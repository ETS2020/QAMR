...
module FAU ( 
  ...
  inv1   g157(.a(new_n165_), .O(new_n326_));
  xnor2a g158(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g159(.a(new_n167_), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  ...
  nand4  g163(.a(new_n331_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g164(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n334_));
  oai22  g165(.a(new_n334_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n335_));
  nand4  g166(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g167(.a(x79), .b(x78), .O(new_n337_));
  nand3  g168(.a(new_n337_), .b(new_n233_), .c(x40), .O(new_n338_));
  nand2  g169(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g170(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g171(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n341_));
  aoi21  g172(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g173(.a(new_n160_), .b(new_n225_), .O(new_n343_));
  oai21  g174(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g175(.a(new_n220_), .b(new_n218_), .c(new_n233_), .O(new_n345_));
  ...
  nand2  g180(.a(new_n154_), .b(new_n225_), .O(new_n350_));
  aoi21  g181(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g182(.a(new_n328_), .b(x79), .O(new_n352_));
  nand3  g183(.a(new_n352_), .b(new_n350_), .c(new_n223_), .O(new_n353_));
  and2   g184(.a(new_n353_), .b(new_n153_), .O(z60));
  nand2  g185(.a(new_n167_), .b(new_n326_), .O(new_n355_));
  nand2  g186(.a(new_n355_), .b(new_n215_), .O(new_n356_));
  ...
  nand3  g194(.a(x81), .b(x79), .c(new_n225_), .O(new_n364_));
  ...
  nor2   g205(.a(new_n236_), .b(x78), .O(new_n375_));
