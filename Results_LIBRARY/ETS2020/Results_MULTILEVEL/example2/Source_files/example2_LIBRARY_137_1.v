...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n277_, new_n280_, new_n282_, new_n286_, new_n288_,
    new_n291_, new_n293_, new_n295_, new_n298_, new_n299_, new_n300_,
    new_n301_, new_n302_, new_n303_, new_n304_, new_n305_, new_n312_,
  ...
  nand4  g087(.a(new_n242_), .b(x48), .c(new_n234_), .d(new_n227_), .O(new_n249_));
  nor2   g088(.a(new_n249_), .b(x01), .O(z30));
  nand4  g089(.a(new_n242_), .b(x49), .c(new_n234_), .d(new_n227_), .O(new_n251_));
  ...
  nand4  g121(.a(new_n276_), .b(x78), .c(x77), .d(x58), .O(new_n286_));
  nor3   g122(.a(new_n286_), .b(x04), .c(x01), .O(z40));
  nand4  g123(.a(new_n276_), .b(x78), .c(x77), .d(x59), .O(new_n288_));
  ...
  nand2  g140(.a(x52), .b(x21), .O(new_n312_));
  nand2  g141(.a(new_n299_), .b(x13), .O(new_n313_));
  aoi21  g142(.a(new_n313_), .b(new_n312_), .c(x79), .O(new_n314_));
  nand4  g143(.a(new_n314_), .b(x78), .c(new_n159_), .d(x04), .O(new_n315_));
  nor2   g144(.a(new_n215_), .b(new_n154_), .O(new_n316_));
  nand4  g145(.a(new_n316_), .b(new_n160_), .c(x77), .d(x73), .O(new_n317_));
  aoi21  g146(.a(new_n317_), .b(new_n315_), .c(x01), .O(z53));
  inv1   g147(.a(x84), .O(new_n320_));
  nor2   g148(.a(x04), .b(x01), .O(new_n321_));
  nand4  g149(.a(new_n321_), .b(x79), .c(x78), .d(x77), .O(new_n322_));
  nor2   g150(.a(new_n322_), .b(x80), .O(new_n323_));
  nand2  g151(.a(new_n323_), .b(new_n237_), .O(new_n324_));
  nor4   g152(.a(new_n324_), .b(new_n320_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g153(.a(new_n229_), .b(x76), .O(new_n326_));
  inv1   g154(.a(new_n165_), .O(new_n327_));
  xnor2a g155(.a(x84), .b(x81), .O(new_n328_));
  aoi21  g156(.a(new_n167_), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g157(.a(new_n329_), .b(new_n153_), .O(new_n330_));
  nand2  g158(.a(new_n330_), .b(new_n326_), .O(new_n331_));
  nand2  g159(.a(new_n331_), .b(x79), .O(new_n332_));
  nand4  g160(.a(new_n332_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g161(.a(x80), .b(new_n218_), .c(x43), .d(new_n234_), .O(new_n335_));
  oai22  g162(.a(new_n335_), .b(new_n221_), .c(new_n234_), .d(x40), .O(new_n336_));
  nand4  g163(.a(new_n336_), .b(x79), .c(x78), .d(x04), .O(new_n337_));
  nor2   g164(.a(x79), .b(x78), .O(new_n338_));
  nand3  g165(.a(new_n338_), .b(new_n234_), .c(x40), .O(new_n339_));
  nand2  g166(.a(new_n339_), .b(new_n337_), .O(new_n340_));
  nand2  g167(.a(new_n340_), .b(x77), .O(new_n341_));
  oai21  g168(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n342_));
  aoi21  g169(.a(new_n342_), .b(new_n341_), .c(x01), .O(z58));
  nor2   g170(.a(new_n160_), .b(new_n227_), .O(new_n344_));
  oai21  g171(.a(new_n344_), .b(new_n338_), .c(x40), .O(new_n345_));
  oai21  g172(.a(new_n221_), .b(new_n219_), .c(new_n234_), .O(new_n346_));
  nand2  g173(.a(new_n346_), .b(x79), .O(new_n347_));
  nand3  g174(.a(new_n347_), .b(x78), .c(x04), .O(new_n348_));
  nand2  g175(.a(new_n348_), .b(new_n345_), .O(new_n349_));
  nand2  g176(.a(new_n349_), .b(x77), .O(new_n350_));
  nand2  g177(.a(new_n154_), .b(new_n227_), .O(new_n351_));
  aoi21  g178(.a(new_n351_), .b(new_n350_), .c(x01), .O(z59));
  nand2  g179(.a(new_n329_), .b(x79), .O(new_n353_));
  nand3  g180(.a(new_n353_), .b(new_n351_), .c(new_n224_), .O(new_n354_));
  and2   g181(.a(new_n354_), .b(new_n153_), .O(z60));
  nand2  g182(.a(new_n167_), .b(new_n327_), .O(new_n356_));
  nand2  g183(.a(new_n356_), .b(new_n216_), .O(new_n357_));
  oai21  g184(.a(new_n229_), .b(x04), .c(new_n357_), .O(new_n358_));
  nand4  g185(.a(new_n358_), .b(x80), .c(x79), .d(new_n153_), .O(new_n359_));
  inv1   g186(.a(new_n359_), .O(z61));
  nand2  g187(.a(new_n154_), .b(x04), .O(new_n361_));
  nand3  g188(.a(x84), .b(x81), .c(x79), .O(new_n362_));
  aoi21  g189(.a(new_n362_), .b(new_n361_), .c(x77), .O(new_n363_));
  nand2  g190(.a(new_n347_), .b(x04), .O(new_n364_));
  nand3  g191(.a(x81), .b(x79), .c(new_n227_), .O(new_n365_));
  aoi21  g192(.a(new_n365_), .b(new_n364_), .c(new_n159_), .O(new_n366_));
  oai21  g193(.a(new_n366_), .b(new_n363_), .c(x78), .O(new_n367_));
  or2    g194(.a(new_n362_), .b(new_n167_), .O(new_n368_));
  aoi21  g195(.a(new_n368_), .b(new_n367_), .c(x01), .O(z62));
  nand4  g196(.a(new_n358_), .b(x82), .c(x79), .d(new_n153_), .O(new_n370_));
  inv1   g197(.a(new_n370_), .O(z63));
  nand3  g198(.a(new_n358_), .b(x83), .c(x79), .O(new_n372_));
  nand4  g199(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n373_));
  aoi21  g200(.a(new_n373_), .b(new_n372_), .c(x01), .O(z64));
  zero   g201(.O(z05));
  zero   g202(.O(z08));
  zero   g203(.O(z10));
  zero   g204(.O(z16));
