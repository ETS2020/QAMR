...
module FAU ( 
  ...
  inv1   g145(.a(x02), .O(new_n316_));
  nand4  g146(.a(x03), .b(new_n316_), .c(new_n155_), .d(x00), .O(new_n317_));
  inv1   g147(.a(new_n317_), .O(z57));
  nor2   g148(.a(new_n273_), .b(x04), .O(new_n326_));
  nor2   g149(.a(new_n216_), .b(x78), .O(new_n327_));
  oai21  g150(.a(new_n327_), .b(new_n326_), .c(x77), .O(new_n328_));
  nand3  g151(.a(x81), .b(x78), .c(new_n267_), .O(new_n329_));
  nand2  g152(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  nand4  g153(.a(new_n330_), .b(x84), .c(x79), .d(new_n155_), .O(new_n331_));
