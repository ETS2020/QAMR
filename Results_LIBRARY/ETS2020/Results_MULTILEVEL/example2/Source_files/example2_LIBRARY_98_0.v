...
module FAU ( 
  ...
  nand4  g069(.a(new_n217_), .b(x50), .c(new_n209_), .d(new_n205_), .O(new_n231_));
  ...
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x58), .O(new_n254_));
  nor3   g090(.a(new_n254_), .b(x04), .c(x01), .O(z40));
  ...
  nor2   g152(.a(new_n212_), .b(x78), .O(new_n328_));
