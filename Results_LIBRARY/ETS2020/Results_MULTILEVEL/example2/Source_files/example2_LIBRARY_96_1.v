...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n244_, new_n247_, new_n249_, new_n251_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n271_, new_n272_, new_n273_, new_n274_, new_n275_, new_n276_,
    new_n277_, new_n278_, new_n280_, new_n284_, new_n286_, new_n288_,
  ...
  nor2   g070(.a(new_n154_), .b(new_n153_), .O(new_n228_));
  inv1   g071(.a(new_n228_), .O(new_n229_));
  aoi21  g072(.a(new_n229_), .b(x79), .c(x43), .O(new_n230_));
  nand3  g073(.a(new_n230_), .b(x05), .c(new_n227_), .O(new_n231_));
  nor2   g074(.a(new_n231_), .b(x01), .O(z24));
  inv1   g075(.a(x42), .O(new_n233_));
  xnor2a g076(.a(x84), .b(x82), .O(new_n234_));
  nand2  g077(.a(new_n234_), .b(x81), .O(new_n235_));
  inv1   g078(.a(x81), .O(new_n236_));
  xor2a  g079(.a(x84), .b(x82), .O(new_n237_));
  nand2  g080(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g081(.a(new_n238_), .b(new_n235_), .O(new_n239_));
  nand4  g082(.a(new_n239_), .b(x79), .c(x78), .d(x77), .O(new_n240_));
  inv1   g083(.a(new_n240_), .O(new_n241_));
  nand4  g084(.a(new_n241_), .b(new_n233_), .c(x05), .d(new_n227_), .O(new_n242_));
  nor2   g085(.a(new_n242_), .b(x01), .O(z25));
  nand4  g086(.a(new_n241_), .b(x44), .c(new_n233_), .d(new_n227_), .O(new_n244_));
  nor2   g087(.a(new_n244_), .b(x01), .O(z26));
  nand4  g088(.a(new_n241_), .b(x46), .c(new_n233_), .d(new_n227_), .O(new_n247_));
  nor2   g089(.a(new_n247_), .b(x01), .O(z28));
  nand4  g090(.a(new_n241_), .b(x47), .c(new_n233_), .d(new_n227_), .O(new_n249_));
  nor2   g091(.a(new_n249_), .b(x01), .O(z29));
  nand4  g092(.a(new_n241_), .b(x48), .c(new_n233_), .d(new_n227_), .O(new_n251_));
  nor2   g093(.a(new_n251_), .b(x01), .O(z30));
  nand2  g094(.a(x83), .b(new_n236_), .O(new_n255_));
  ...
  nand3  g098(.a(x81), .b(x51), .c(new_n233_), .O(new_n259_));
  nand2  g099(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g100(.a(new_n260_), .b(new_n234_), .O(new_n261_));
  xnor2a g101(.a(x83), .b(x81), .O(new_n262_));
  nand3  g102(.a(new_n262_), .b(x42), .c(x05), .O(new_n263_));
  nand3  g103(.a(new_n236_), .b(x51), .c(new_n233_), .O(new_n264_));
  nand2  g104(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g105(.a(new_n265_), .b(new_n237_), .O(new_n266_));
  aoi21  g106(.a(new_n266_), .b(new_n261_), .c(new_n156_), .O(new_n267_));
  nand4  g107(.a(new_n267_), .b(x78), .c(x77), .d(new_n227_), .O(new_n268_));
  nor2   g108(.a(new_n268_), .b(x01), .O(z33));
  nor2   g109(.a(new_n220_), .b(new_n233_), .O(new_n271_));
  nand3  g110(.a(x83), .b(x81), .c(x42), .O(new_n272_));
  oai21  g111(.a(new_n271_), .b(x81), .c(new_n272_), .O(new_n273_));
  nand2  g112(.a(new_n273_), .b(new_n237_), .O(new_n274_));
  oai22  g113(.a(new_n271_), .b(new_n236_), .c(new_n255_), .d(new_n233_), .O(new_n275_));
  nand2  g114(.a(new_n275_), .b(new_n234_), .O(new_n276_));
  ...
  nand4  g120(.a(new_n277_), .b(x78), .c(x77), .d(x57), .O(new_n284_));
  nor3   g121(.a(new_n284_), .b(x04), .c(x01), .O(z39));
  nand4  g122(.a(new_n277_), .b(x78), .c(x77), .d(x58), .O(new_n286_));
  nor3   g123(.a(new_n286_), .b(x04), .c(x01), .O(z40));
  nand4  g124(.a(new_n277_), .b(x78), .c(x77), .d(x59), .O(new_n288_));
  nor3   g125(.a(new_n288_), .b(x04), .c(x01), .O(z41));
  nand4  g126(.a(new_n277_), .b(x78), .c(x77), .d(x60), .O(new_n290_));
  nor3   g127(.a(new_n290_), .b(x04), .c(x01), .O(z42));
  nand4  g128(.a(new_n277_), .b(x78), .c(x77), .d(x61), .O(new_n292_));
  nor3   g129(.a(new_n292_), .b(x04), .c(x01), .O(z43));
  nand4  g130(.a(new_n277_), .b(x78), .c(x77), .d(x62), .O(new_n294_));
  nor3   g131(.a(new_n294_), .b(x04), .c(x01), .O(z44));
  nand4  g132(.a(new_n277_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  nor3   g133(.a(new_n296_), .b(x04), .c(x01), .O(z45));
  nand4  g134(.a(new_n277_), .b(x78), .c(x77), .d(x64), .O(new_n298_));
  nor3   g135(.a(new_n298_), .b(x04), .c(x01), .O(z46));
  ...
  nand4  g140(.a(new_n303_), .b(x78), .c(new_n153_), .d(x04), .O(new_n304_));
  nor2   g141(.a(x75), .b(x67), .O(new_n305_));
  nor2   g142(.a(new_n305_), .b(new_n215_), .O(new_n306_));
  nand4  g143(.a(new_n306_), .b(x79), .c(new_n154_), .d(x77), .O(new_n307_));
  ...
  nand2  g149(.a(new_n319_), .b(new_n236_), .O(new_n320_));
  nor4   g150(.a(new_n320_), .b(new_n316_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g151(.a(new_n229_), .b(x76), .O(new_n322_));
  inv1   g152(.a(new_n161_), .O(new_n323_));
  xnor2a g153(.a(x84), .b(x81), .O(new_n324_));
  aoi21  g154(.a(new_n163_), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g155(.a(new_n325_), .b(new_n159_), .O(new_n326_));
  nand2  g156(.a(new_n326_), .b(new_n322_), .O(new_n327_));
  nand2  g157(.a(new_n327_), .b(x79), .O(new_n328_));
  nand4  g158(.a(new_n328_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  nand4  g159(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n331_));
  oai22  g160(.a(new_n331_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n332_));
  nand4  g161(.a(new_n332_), .b(x79), .c(x78), .d(x04), .O(new_n333_));
  nor2   g162(.a(x79), .b(x78), .O(new_n334_));
  nand3  g163(.a(new_n334_), .b(new_n233_), .c(x40), .O(new_n335_));
  nand2  g164(.a(new_n335_), .b(new_n333_), .O(new_n336_));
  nand2  g165(.a(new_n336_), .b(x77), .O(new_n337_));
  oai21  g166(.a(new_n161_), .b(new_n227_), .c(new_n156_), .O(new_n338_));
  aoi21  g167(.a(new_n338_), .b(new_n337_), .c(x01), .O(z58));
  nor2   g168(.a(new_n154_), .b(new_n227_), .O(new_n340_));
  oai21  g169(.a(new_n340_), .b(new_n334_), .c(x40), .O(new_n341_));
  oai21  g170(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n342_));
  ...
  nand2  g175(.a(new_n156_), .b(new_n227_), .O(new_n347_));
  aoi21  g176(.a(new_n347_), .b(new_n346_), .c(x01), .O(z59));
  nand2  g177(.a(new_n325_), .b(x79), .O(new_n349_));
  nand3  g178(.a(new_n349_), .b(new_n347_), .c(new_n224_), .O(new_n350_));
  and2   g179(.a(new_n350_), .b(new_n159_), .O(z60));
  nand2  g180(.a(new_n163_), .b(new_n323_), .O(new_n352_));
  nand2  g181(.a(new_n352_), .b(new_n216_), .O(new_n353_));
  oai21  g182(.a(new_n229_), .b(x04), .c(new_n353_), .O(new_n354_));
  nand4  g183(.a(new_n354_), .b(x80), .c(x79), .d(new_n159_), .O(new_n355_));
  inv1   g184(.a(new_n355_), .O(z61));
  nand2  g185(.a(new_n156_), .b(x04), .O(new_n357_));
  ...
  nand3  g189(.a(x81), .b(x79), .c(new_n227_), .O(new_n361_));
  aoi21  g190(.a(new_n361_), .b(new_n360_), .c(new_n153_), .O(new_n362_));
  oai21  g191(.a(new_n362_), .b(new_n359_), .c(x78), .O(new_n363_));
  or2    g192(.a(new_n358_), .b(new_n163_), .O(new_n364_));
  aoi21  g193(.a(new_n364_), .b(new_n363_), .c(x01), .O(z62));
  nand4  g194(.a(new_n354_), .b(x82), .c(x79), .d(new_n159_), .O(new_n366_));
  inv1   g195(.a(new_n366_), .O(z63));
  nand3  g196(.a(new_n354_), .b(x83), .c(x79), .O(new_n368_));
  nand4  g197(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n369_));
  aoi21  g198(.a(new_n369_), .b(new_n368_), .c(x01), .O(z64));
  nor2   g199(.a(new_n154_), .b(x04), .O(new_n371_));
  nor2   g200(.a(new_n236_), .b(x78), .O(new_n372_));
  oai21  g201(.a(new_n372_), .b(new_n371_), .c(x77), .O(new_n373_));
  nand3  g202(.a(x81), .b(x78), .c(new_n153_), .O(new_n374_));
  nand2  g203(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  nand4  g204(.a(new_n375_), .b(x84), .c(x79), .d(new_n159_), .O(new_n376_));
