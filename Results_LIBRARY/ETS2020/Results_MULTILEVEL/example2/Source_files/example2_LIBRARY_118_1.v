...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n246_, new_n248_, new_n250_, new_n252_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n279_, new_n281_, new_n283_, new_n287_,
    new_n289_, new_n292_, new_n294_, new_n296_, new_n299_, new_n300_,
  ...
  nand4  g089(.a(new_n240_), .b(x47), .c(new_n232_), .d(new_n224_), .O(new_n248_));
  nor2   g090(.a(new_n248_), .b(x01), .O(z29));
  nand4  g091(.a(new_n240_), .b(x48), .c(new_n232_), .d(new_n224_), .O(new_n250_));
  nor2   g092(.a(new_n250_), .b(x01), .O(z30));
  nand4  g093(.a(new_n240_), .b(x49), .c(new_n232_), .d(new_n224_), .O(new_n252_));
  nor2   g094(.a(new_n252_), .b(x01), .O(z31));
  nand2  g095(.a(x83), .b(new_n235_), .O(new_n255_));
  nand2  g096(.a(new_n218_), .b(x81), .O(new_n256_));
  nand2  g097(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand3  g098(.a(new_n257_), .b(x42), .c(x05), .O(new_n258_));
  nand3  g099(.a(x81), .b(x51), .c(new_n232_), .O(new_n259_));
  nand2  g100(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g101(.a(new_n260_), .b(new_n233_), .O(new_n261_));
  xnor2a g102(.a(x83), .b(x81), .O(new_n262_));
  nand3  g103(.a(new_n262_), .b(x42), .c(x05), .O(new_n263_));
  nand3  g104(.a(new_n235_), .b(x51), .c(new_n232_), .O(new_n264_));
  nand2  g105(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g106(.a(new_n265_), .b(new_n236_), .O(new_n266_));
  aoi21  g107(.a(new_n266_), .b(new_n261_), .c(new_n156_), .O(new_n267_));
  nand4  g108(.a(new_n267_), .b(x78), .c(x77), .d(new_n224_), .O(new_n268_));
  nor2   g109(.a(new_n268_), .b(x01), .O(z33));
  nor2   g110(.a(new_n218_), .b(new_n232_), .O(new_n270_));
  nand3  g111(.a(x83), .b(x81), .c(x42), .O(new_n271_));
  oai21  g112(.a(new_n270_), .b(x81), .c(new_n271_), .O(new_n272_));
  nand2  g113(.a(new_n272_), .b(new_n236_), .O(new_n273_));
  oai22  g114(.a(new_n270_), .b(new_n235_), .c(new_n255_), .d(new_n232_), .O(new_n274_));
  nand2  g115(.a(new_n274_), .b(new_n233_), .O(new_n275_));
  aoi21  g116(.a(new_n275_), .b(new_n273_), .c(new_n156_), .O(new_n276_));
  nand4  g117(.a(new_n276_), .b(x78), .c(x77), .d(x52), .O(new_n277_));
  nor3   g118(.a(new_n277_), .b(x04), .c(x01), .O(z34));
  nand4  g119(.a(new_n276_), .b(x78), .c(x77), .d(x53), .O(new_n279_));
  nor3   g120(.a(new_n279_), .b(x04), .c(x01), .O(z35));
  nand4  g121(.a(new_n276_), .b(x78), .c(x77), .d(x54), .O(new_n281_));
  nor3   g122(.a(new_n281_), .b(x04), .c(x01), .O(z36));
  nand4  g123(.a(new_n276_), .b(x78), .c(x77), .d(x55), .O(new_n283_));
  nor3   g124(.a(new_n283_), .b(x04), .c(x01), .O(z37));
  nand4  g125(.a(new_n276_), .b(x78), .c(x77), .d(x58), .O(new_n287_));
  nor3   g126(.a(new_n287_), .b(x04), .c(x01), .O(z40));
  nand4  g127(.a(new_n276_), .b(x78), .c(x77), .d(x59), .O(new_n289_));
  nor3   g128(.a(new_n289_), .b(x04), .c(x01), .O(z41));
  nand4  g129(.a(new_n276_), .b(x78), .c(x77), .d(x61), .O(new_n292_));
  nor3   g130(.a(new_n292_), .b(x04), .c(x01), .O(z43));
  nand4  g131(.a(new_n276_), .b(x78), .c(x77), .d(x62), .O(new_n294_));
  nor3   g132(.a(new_n294_), .b(x04), .c(x01), .O(z44));
  nand4  g133(.a(new_n276_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  nor3   g134(.a(new_n296_), .b(x04), .c(x01), .O(z45));
  ...
  nand2  g144(.a(x52), .b(x22), .O(new_n314_));
  nand2  g145(.a(new_n300_), .b(x14), .O(new_n315_));
  aoi21  g146(.a(new_n315_), .b(new_n314_), .c(x79), .O(new_n316_));
  nand4  g147(.a(new_n316_), .b(x78), .c(new_n153_), .d(x04), .O(new_n317_));
  nor2   g148(.a(new_n317_), .b(x01), .O(z54));
  ...
  nand2  g153(.a(new_n322_), .b(new_n235_), .O(new_n323_));
  nor4   g154(.a(new_n323_), .b(new_n319_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g155(.a(new_n228_), .b(x76), .O(new_n325_));
  inv1   g156(.a(new_n161_), .O(new_n326_));
  xnor2a g157(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g158(.a(new_n163_), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g159(.a(new_n328_), .b(new_n159_), .O(new_n329_));
  nand2  g160(.a(new_n329_), .b(new_n325_), .O(new_n330_));
  nand2  g161(.a(new_n330_), .b(x79), .O(new_n331_));
  nand4  g162(.a(new_n331_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  nand4  g163(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n334_));
  oai22  g164(.a(new_n334_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n335_));
  nand4  g165(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g166(.a(x79), .b(x78), .O(new_n337_));
  nand3  g167(.a(new_n337_), .b(new_n232_), .c(x40), .O(new_n338_));
  nand2  g168(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g169(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g170(.a(new_n161_), .b(new_n224_), .c(new_n156_), .O(new_n341_));
  aoi21  g171(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g172(.a(new_n154_), .b(new_n224_), .O(new_n343_));
  oai21  g173(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g174(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n345_));
  ...
  nand2  g179(.a(new_n156_), .b(new_n224_), .O(new_n350_));
  aoi21  g180(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g181(.a(new_n328_), .b(x79), .O(new_n352_));
  nand3  g182(.a(new_n352_), .b(new_n350_), .c(new_n222_), .O(new_n353_));
  and2   g183(.a(new_n353_), .b(new_n159_), .O(z60));
  nand2  g184(.a(new_n163_), .b(new_n326_), .O(new_n355_));
  nand2  g185(.a(new_n355_), .b(new_n214_), .O(new_n356_));
  oai21  g186(.a(new_n228_), .b(x04), .c(new_n356_), .O(new_n357_));
  nand4  g187(.a(new_n357_), .b(x80), .c(x79), .d(new_n159_), .O(new_n358_));
  inv1   g188(.a(new_n358_), .O(z61));
  nand2  g189(.a(new_n156_), .b(x04), .O(new_n360_));
  ...
  nand3  g193(.a(x81), .b(x79), .c(new_n224_), .O(new_n364_));
  aoi21  g194(.a(new_n364_), .b(new_n363_), .c(new_n153_), .O(new_n365_));
  oai21  g195(.a(new_n365_), .b(new_n362_), .c(x78), .O(new_n366_));
  or2    g196(.a(new_n361_), .b(new_n163_), .O(new_n367_));
  aoi21  g197(.a(new_n367_), .b(new_n366_), .c(x01), .O(z62));
  nand4  g198(.a(new_n357_), .b(x82), .c(x79), .d(new_n159_), .O(new_n369_));
  inv1   g199(.a(new_n369_), .O(z63));
  nand3  g200(.a(new_n357_), .b(x83), .c(x79), .O(new_n371_));
  nand4  g201(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n372_));
  aoi21  g202(.a(new_n372_), .b(new_n371_), .c(x01), .O(z64));
  nor2   g203(.a(new_n154_), .b(x04), .O(new_n374_));
  nor2   g204(.a(new_n235_), .b(x78), .O(new_n375_));
  oai21  g205(.a(new_n375_), .b(new_n374_), .c(x77), .O(new_n376_));
  nand3  g206(.a(x81), .b(x78), .c(new_n153_), .O(new_n377_));
  nand2  g207(.a(new_n377_), .b(new_n376_), .O(new_n378_));
  nand4  g208(.a(new_n378_), .b(x84), .c(x79), .d(new_n159_), .O(new_n379_));
