...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n287_, new_n290_, new_n292_, new_n297_, new_n300_,
  ...
  nand4  g126(.a(new_n281_), .b(x78), .c(x77), .d(x56), .O(new_n287_));
  ...
  nand4  g132(.a(new_n281_), .b(x78), .c(x77), .d(x63), .O(new_n297_));
  ...
  nand2  g190(.a(new_n355_), .b(new_n238_), .O(new_n356_));
  nor4   g191(.a(new_n356_), .b(new_n352_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g192(.a(new_n231_), .b(x76), .O(new_n358_));
  ...
  nand4  g203(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n369_));
  oai22  g204(.a(new_n369_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n370_));
  nand4  g205(.a(new_n370_), .b(x79), .c(x78), .d(x04), .O(new_n371_));
  nor2   g206(.a(x79), .b(x78), .O(new_n372_));
  nand3  g207(.a(new_n372_), .b(new_n235_), .c(x40), .O(new_n373_));
  nand2  g208(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand2  g209(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g210(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n376_));
  aoi21  g211(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  nor2   g212(.a(new_n160_), .b(new_n229_), .O(new_n378_));
  oai21  g213(.a(new_n378_), .b(new_n372_), .c(x40), .O(new_n379_));
  oai21  g214(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n380_));
  ...
  nand2  g219(.a(new_n154_), .b(new_n229_), .O(new_n385_));
  ...
  oai21  g226(.a(new_n231_), .b(x04), .c(new_n391_), .O(new_n392_));
  ...
  nand3  g233(.a(x81), .b(x79), .c(new_n229_), .O(new_n399_));
