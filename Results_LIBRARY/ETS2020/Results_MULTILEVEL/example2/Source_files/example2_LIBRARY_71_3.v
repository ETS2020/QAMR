...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n301_, new_n304_, new_n306_, new_n309_, new_n311_, new_n312_,
  ...
  nand4  g151(.a(new_n287_), .b(x78), .c(x77), .d(x64), .O(new_n309_));
  ...
  nor2   g159(.a(new_n316_), .b(new_n223_), .O(new_n317_));
  ...
  nand4  g166(.a(new_n224_), .b(x79), .c(new_n160_), .d(x77), .O(new_n324_));
  ...
  nand2  g209(.a(new_n366_), .b(new_n245_), .O(new_n367_));
  nor4   g210(.a(new_n367_), .b(new_n363_), .c(new_n228_), .d(x82), .O(z55));
  nand2  g211(.a(new_n238_), .b(x76), .O(new_n369_));
  ...
  nand4  g222(.a(x80), .b(new_n226_), .c(x43), .d(new_n242_), .O(new_n380_));
  oai22  g223(.a(new_n380_), .b(new_n229_), .c(new_n242_), .d(x40), .O(new_n381_));
  nand4  g224(.a(new_n381_), .b(x79), .c(x78), .d(x04), .O(new_n382_));
  nor2   g225(.a(x79), .b(x78), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n242_), .c(x40), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n382_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(x77), .O(new_n386_));
  oai21  g229(.a(new_n165_), .b(new_n234_), .c(new_n154_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  nor2   g231(.a(new_n160_), .b(new_n234_), .O(new_n389_));
  oai21  g232(.a(new_n389_), .b(new_n383_), .c(x40), .O(new_n390_));
  oai21  g233(.a(new_n229_), .b(new_n227_), .c(new_n242_), .O(new_n391_));
  ...
  nand2  g238(.a(new_n154_), .b(new_n234_), .O(new_n396_));
  aoi21  g239(.a(new_n396_), .b(new_n395_), .c(x01), .O(z59));
  nand2  g240(.a(new_n372_), .b(x79), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n396_), .c(new_n232_), .O(new_n399_));
  and2   g242(.a(new_n399_), .b(new_n153_), .O(z60));
  nand2  g243(.a(new_n167_), .b(new_n370_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n224_), .O(new_n402_));
  oai21  g245(.a(new_n238_), .b(x04), .c(new_n402_), .O(new_n403_));
  ...
  nand3  g252(.a(x81), .b(x79), .c(new_n234_), .O(new_n410_));
  ...
  nor2   g263(.a(new_n245_), .b(x78), .O(new_n421_));
