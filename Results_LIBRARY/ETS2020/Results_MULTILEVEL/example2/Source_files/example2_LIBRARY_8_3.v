// Benchmark "FAU" written by ABC on Fri Jul 24 22:40:29 2020
...
module FAU ( 
  ...
  nand4  g142(.a(new_n284_), .b(x78), .c(x77), .d(x60), .O(new_n300_));
  nor3   g143(.a(new_n300_), .b(x04), .c(x01), .O(z42));
  nand4  g144(.a(new_n284_), .b(x78), .c(x77), .d(x61), .O(new_n302_));
  nor3   g145(.a(new_n302_), .b(x04), .c(x01), .O(z43));
  nand4  g146(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n304_));
  nor3   g147(.a(new_n304_), .b(x04), .c(x01), .O(z44));
  nand4  g148(.a(new_n284_), .b(x78), .c(x77), .d(x64), .O(new_n307_));
