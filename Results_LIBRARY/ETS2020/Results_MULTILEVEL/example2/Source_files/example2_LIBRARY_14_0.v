...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n180_, new_n181_, new_n183_, new_n184_, new_n189_, new_n190_,
  ...
  nand4  g061(.a(new_n219_), .b(x45), .c(new_n211_), .d(new_n207_), .O(new_n223_));
  nor2   g062(.a(new_n223_), .b(x01), .O(z27));
  nand4  g063(.a(new_n219_), .b(x46), .c(new_n211_), .d(new_n207_), .O(new_n225_));
  nor2   g064(.a(new_n225_), .b(x01), .O(z28));
  nand4  g065(.a(new_n219_), .b(x47), .c(new_n211_), .d(new_n207_), .O(new_n227_));
  ...
  aoi21  g071(.a(x83), .b(x42), .c(x81), .O(new_n237_));
  nand3  g072(.a(x83), .b(x81), .c(x42), .O(new_n238_));
  inv1   g073(.a(new_n238_), .O(new_n239_));
  oai21  g074(.a(new_n239_), .b(new_n237_), .c(new_n215_), .O(new_n240_));
  nand2  g075(.a(x83), .b(x42), .O(new_n241_));
  nand2  g076(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g077(.a(x83), .b(new_n214_), .c(x42), .O(new_n243_));
  nand2  g078(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g079(.a(new_n244_), .b(new_n212_), .O(new_n245_));
  aoi21  g080(.a(new_n245_), .b(new_n240_), .c(new_n154_), .O(new_n246_));
  nand4  g081(.a(new_n246_), .b(x78), .c(x77), .d(x54), .O(new_n247_));
  nor3   g082(.a(new_n247_), .b(x04), .c(x01), .O(z36));
  nand4  g083(.a(new_n246_), .b(x78), .c(x77), .d(x55), .O(new_n249_));
  nor3   g084(.a(new_n249_), .b(x04), .c(x01), .O(z37));
  nand4  g085(.a(new_n246_), .b(x78), .c(x77), .d(x56), .O(new_n251_));
  nor3   g086(.a(new_n251_), .b(x04), .c(x01), .O(z38));
  nand4  g087(.a(new_n246_), .b(x78), .c(x77), .d(x57), .O(new_n253_));
  nor3   g088(.a(new_n253_), .b(x04), .c(x01), .O(z39));
  nand4  g089(.a(new_n246_), .b(x78), .c(x77), .d(x58), .O(new_n255_));
  nor3   g090(.a(new_n255_), .b(x04), .c(x01), .O(z40));
  nand4  g091(.a(new_n246_), .b(x78), .c(x77), .d(x60), .O(new_n258_));
  nor3   g092(.a(new_n258_), .b(x04), .c(x01), .O(z42));
  nand4  g093(.a(new_n246_), .b(x78), .c(x77), .d(x61), .O(new_n260_));
  nor3   g094(.a(new_n260_), .b(x04), .c(x01), .O(z43));
  nand4  g095(.a(new_n246_), .b(x78), .c(x77), .d(x62), .O(new_n262_));
  nor3   g096(.a(new_n262_), .b(x04), .c(x01), .O(z44));
  nand4  g097(.a(new_n246_), .b(x78), .c(x77), .d(x63), .O(new_n264_));
  nor3   g098(.a(new_n264_), .b(x04), .c(x01), .O(z45));
  nand4  g099(.a(new_n246_), .b(x78), .c(x77), .d(x64), .O(new_n266_));
  ...
  inv1   g148(.a(x02), .O(new_n318_));
  nand4  g149(.a(x03), .b(new_n318_), .c(new_n153_), .d(x00), .O(new_n319_));
  inv1   g150(.a(new_n319_), .O(z57));
  nor2   g151(.a(new_n275_), .b(x04), .O(new_n328_));
  nor2   g152(.a(new_n214_), .b(x78), .O(new_n329_));
  oai21  g153(.a(new_n329_), .b(new_n328_), .c(x77), .O(new_n330_));
  nand3  g154(.a(x81), .b(x78), .c(new_n269_), .O(new_n331_));
  nand2  g155(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand4  g156(.a(new_n332_), .b(x84), .c(x79), .d(new_n153_), .O(new_n333_));
  inv1   g157(.a(new_n333_), .O(z65));
  zero   g158(.O(z01));
  zero   g159(.O(z02));
  zero   g160(.O(z12));
  zero   g161(.O(z13));
