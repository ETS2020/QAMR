...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n293_, new_n295_, new_n297_, new_n299_, new_n303_, new_n306_,
  ...
  nand4  g141(.a(new_n282_), .b(x78), .c(x77), .d(x60), .O(new_n299_));
  ...
  nor4   g159(.a(new_n326_), .b(new_n322_), .c(new_n223_), .d(x82), .O(z55));
  ...
  nand4  g168(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n337_));
  oai22  g169(.a(new_n337_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n338_));
  nand4  g170(.a(new_n338_), .b(x79), .c(x78), .d(x04), .O(new_n339_));
  nor2   g171(.a(x79), .b(x78), .O(new_n340_));
  nand3  g172(.a(new_n340_), .b(new_n236_), .c(x40), .O(new_n341_));
  nand2  g173(.a(new_n341_), .b(new_n339_), .O(new_n342_));
  nand2  g174(.a(new_n342_), .b(x77), .O(new_n343_));
  oai21  g175(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n344_));
  aoi21  g176(.a(new_n344_), .b(new_n343_), .c(x01), .O(z58));
  nor2   g177(.a(new_n160_), .b(new_n230_), .O(new_n346_));
  oai21  g178(.a(new_n346_), .b(new_n340_), .c(x40), .O(new_n347_));
  oai21  g179(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n348_));
  ...
  nand2  g184(.a(new_n154_), .b(new_n230_), .O(new_n353_));
  aoi21  g185(.a(new_n353_), .b(new_n352_), .c(x01), .O(z59));
  nand2  g186(.a(new_n331_), .b(x79), .O(new_n355_));
  nand3  g187(.a(new_n355_), .b(new_n353_), .c(new_n227_), .O(new_n356_));
  and2   g188(.a(new_n356_), .b(new_n153_), .O(z60));
  nand2  g189(.a(new_n167_), .b(new_n329_), .O(new_n358_));
  nand2  g190(.a(new_n358_), .b(new_n219_), .O(new_n359_));
  ...
  nand2  g194(.a(new_n154_), .b(x04), .O(new_n363_));
  nand3  g195(.a(x84), .b(x81), .c(x79), .O(new_n364_));
  aoi21  g196(.a(new_n364_), .b(new_n363_), .c(x77), .O(new_n365_));
  nand2  g197(.a(new_n349_), .b(x04), .O(new_n366_));
  nand3  g198(.a(x81), .b(x79), .c(new_n230_), .O(new_n367_));
  aoi21  g199(.a(new_n367_), .b(new_n366_), .c(new_n159_), .O(new_n368_));
  oai21  g200(.a(new_n368_), .b(new_n365_), .c(x78), .O(new_n369_));
  or2    g201(.a(new_n364_), .b(new_n167_), .O(new_n370_));
  aoi21  g202(.a(new_n370_), .b(new_n369_), .c(x01), .O(z62));
  nand4  g203(.a(new_n360_), .b(x82), .c(x79), .d(new_n153_), .O(new_n372_));
  inv1   g204(.a(new_n372_), .O(z63));
  nand3  g205(.a(new_n360_), .b(x83), .c(x79), .O(new_n374_));
  nand4  g206(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n375_));
  aoi21  g207(.a(new_n375_), .b(new_n374_), .c(x01), .O(z64));
  zero   g208(.O(z03));
  zero   g209(.O(z14));
  zero   g210(.O(z16));
  zero   g211(.O(z19));
