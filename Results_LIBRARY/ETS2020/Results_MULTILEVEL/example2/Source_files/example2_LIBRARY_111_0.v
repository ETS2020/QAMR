...
module FAU ( 
  ...
  nand4  g065(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n203_), .O(new_n229_));
  ...
  oai21  g070(.a(new_n234_), .b(new_n232_), .c(new_n211_), .O(new_n235_));
  nand2  g071(.a(x83), .b(x42), .O(new_n236_));
  nand2  g072(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g073(.a(x83), .b(new_n210_), .c(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(new_n208_), .O(new_n240_));
  aoi21  g076(.a(new_n240_), .b(new_n235_), .c(new_n154_), .O(new_n241_));
  ...
  nand4  g087(.a(new_n241_), .b(x78), .c(x77), .d(x58), .O(new_n253_));
