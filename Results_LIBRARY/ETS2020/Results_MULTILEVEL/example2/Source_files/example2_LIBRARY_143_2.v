...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n295_, new_n299_, new_n301_, new_n304_, new_n305_, new_n306_,
  ...
  nand4  g137(.a(new_n282_), .b(x78), .c(x77), .d(x62), .O(new_n299_));
  nor3   g138(.a(new_n299_), .b(x04), .c(x01), .O(z44));
  nand4  g139(.a(new_n282_), .b(x78), .c(x77), .d(x63), .O(new_n301_));
  ...
  nand2  g197(.a(new_n359_), .b(new_n239_), .O(new_n360_));
  nor4   g198(.a(new_n360_), .b(new_n356_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g199(.a(new_n232_), .b(x76), .O(new_n362_));
  ...
  inv1   g207(.a(x02), .O(new_n370_));
  nand4  g208(.a(x03), .b(new_n370_), .c(new_n153_), .d(x00), .O(new_n371_));
  inv1   g209(.a(new_n371_), .O(z57));
  nand4  g210(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n373_));
  oai22  g211(.a(new_n373_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n374_));
  nand4  g212(.a(new_n374_), .b(x79), .c(x78), .d(x04), .O(new_n375_));
  nor2   g213(.a(x79), .b(x78), .O(new_n376_));
  nand3  g214(.a(new_n376_), .b(new_n236_), .c(x40), .O(new_n377_));
  nand2  g215(.a(new_n377_), .b(new_n375_), .O(new_n378_));
  nand2  g216(.a(new_n378_), .b(x77), .O(new_n379_));
  oai21  g217(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n380_));
  aoi21  g218(.a(new_n380_), .b(new_n379_), .c(x01), .O(z58));
  nor2   g219(.a(new_n160_), .b(new_n228_), .O(new_n382_));
  oai21  g220(.a(new_n382_), .b(new_n376_), .c(x40), .O(new_n383_));
  oai21  g221(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n384_));
  ...
  nand2  g226(.a(new_n154_), .b(new_n228_), .O(new_n389_));
  aoi21  g227(.a(new_n389_), .b(new_n388_), .c(x01), .O(z59));
  nand2  g228(.a(new_n365_), .b(x79), .O(new_n391_));
  nand3  g229(.a(new_n391_), .b(new_n389_), .c(new_n226_), .O(new_n392_));
  and2   g230(.a(new_n392_), .b(new_n153_), .O(z60));
  nand2  g231(.a(new_n167_), .b(new_n363_), .O(new_n394_));
  nand2  g232(.a(new_n394_), .b(new_n218_), .O(new_n395_));
  oai21  g233(.a(new_n232_), .b(x04), .c(new_n395_), .O(new_n396_));
  ...
  nand3  g240(.a(x81), .b(x79), .c(new_n228_), .O(new_n403_));
  ...
  nor2   g251(.a(new_n239_), .b(x78), .O(new_n414_));
