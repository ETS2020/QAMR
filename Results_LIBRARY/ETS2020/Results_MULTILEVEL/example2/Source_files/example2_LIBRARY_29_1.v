...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n197_, new_n198_, new_n204_, new_n205_, new_n207_, new_n208_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n223_,
    new_n224_, new_n225_, new_n226_, new_n227_, new_n229_, new_n230_,
    new_n231_, new_n232_, new_n233_, new_n234_, new_n235_, new_n236_,
    new_n237_, new_n238_, new_n240_, new_n242_, new_n244_, new_n246_,
    ...
    new_n290_, new_n292_, new_n294_, new_n306_, new_n307_, new_n308_,
  ...
  nand4  g077(.a(new_n237_), .b(new_n229_), .c(x05), .d(new_n223_), .O(new_n238_));
  nor2   g078(.a(new_n238_), .b(x01), .O(z25));
  nand4  g079(.a(new_n237_), .b(x44), .c(new_n229_), .d(new_n223_), .O(new_n240_));
  nor2   g080(.a(new_n240_), .b(x01), .O(z26));
  nand4  g081(.a(new_n237_), .b(x45), .c(new_n229_), .d(new_n223_), .O(new_n242_));
  nor2   g082(.a(new_n242_), .b(x01), .O(z27));
  nand4  g083(.a(new_n237_), .b(x46), .c(new_n229_), .d(new_n223_), .O(new_n244_));
  nor2   g084(.a(new_n244_), .b(x01), .O(z28));
  nand4  g085(.a(new_n237_), .b(x47), .c(new_n229_), .d(new_n223_), .O(new_n246_));
  nor2   g086(.a(new_n246_), .b(x01), .O(z29));
  nand4  g087(.a(new_n237_), .b(x49), .c(new_n229_), .d(new_n223_), .O(new_n249_));
  nor2   g088(.a(new_n249_), .b(x01), .O(z31));
  nand4  g089(.a(new_n237_), .b(x50), .c(new_n229_), .d(new_n223_), .O(new_n251_));
  nor2   g090(.a(new_n251_), .b(x01), .O(z32));
  nand2  g091(.a(x83), .b(new_n232_), .O(new_n253_));
  nand2  g092(.a(new_n216_), .b(x81), .O(new_n254_));
  ...
  nand4  g104(.a(new_n265_), .b(x78), .c(x77), .d(new_n223_), .O(new_n266_));
  nor2   g105(.a(new_n266_), .b(x01), .O(z33));
  nor2   g106(.a(new_n216_), .b(new_n229_), .O(new_n268_));
  ...
  nand4  g119(.a(new_n274_), .b(x78), .c(x77), .d(x55), .O(new_n281_));
  nor3   g120(.a(new_n281_), .b(x04), .c(x01), .O(z37));
  nand4  g121(.a(new_n274_), .b(x78), .c(x77), .d(x56), .O(new_n283_));
  nor3   g122(.a(new_n283_), .b(x04), .c(x01), .O(z38));
  nand4  g123(.a(new_n274_), .b(x78), .c(x77), .d(x57), .O(new_n285_));
  nor3   g124(.a(new_n285_), .b(x04), .c(x01), .O(z39));
  nand4  g125(.a(new_n274_), .b(x78), .c(x77), .d(x58), .O(new_n287_));
  nor3   g126(.a(new_n287_), .b(x04), .c(x01), .O(z40));
  nand4  g127(.a(new_n274_), .b(x78), .c(x77), .d(x60), .O(new_n290_));
  nor3   g128(.a(new_n290_), .b(x04), .c(x01), .O(z42));
  nand4  g129(.a(new_n274_), .b(x78), .c(x77), .d(x61), .O(new_n292_));
  nor3   g130(.a(new_n292_), .b(x04), .c(x01), .O(z43));
  nand4  g131(.a(new_n274_), .b(x78), .c(x77), .d(x62), .O(new_n294_));
  nor3   g132(.a(new_n294_), .b(x04), .c(x01), .O(z44));
  inv1   g133(.a(x84), .O(new_n306_));
  nor2   g134(.a(x04), .b(x01), .O(new_n307_));
  nand4  g135(.a(new_n307_), .b(x79), .c(x78), .d(x77), .O(new_n308_));
  nor2   g136(.a(new_n308_), .b(x80), .O(new_n309_));
  nand2  g137(.a(new_n309_), .b(new_n232_), .O(new_n310_));
  nor4   g138(.a(new_n310_), .b(new_n306_), .c(new_n216_), .d(x82), .O(z55));
  nand2  g139(.a(new_n225_), .b(x76), .O(new_n312_));
  inv1   g140(.a(new_n165_), .O(new_n313_));
  xnor2a g141(.a(x84), .b(x81), .O(new_n314_));
  aoi21  g142(.a(new_n167_), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand2  g143(.a(new_n315_), .b(new_n153_), .O(new_n316_));
  nand2  g144(.a(new_n316_), .b(new_n312_), .O(new_n317_));
  nand2  g145(.a(new_n317_), .b(x79), .O(new_n318_));
  nand4  g146(.a(new_n318_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g147(.a(x80), .b(new_n214_), .c(x43), .d(new_n229_), .O(new_n321_));
  oai22  g148(.a(new_n321_), .b(new_n217_), .c(new_n229_), .d(x40), .O(new_n322_));
  nand4  g149(.a(new_n322_), .b(x79), .c(x78), .d(x04), .O(new_n323_));
  nor2   g150(.a(x79), .b(x78), .O(new_n324_));
  nand3  g151(.a(new_n324_), .b(new_n229_), .c(x40), .O(new_n325_));
  nand2  g152(.a(new_n325_), .b(new_n323_), .O(new_n326_));
  nand2  g153(.a(new_n326_), .b(x77), .O(new_n327_));
  oai21  g154(.a(new_n165_), .b(new_n223_), .c(new_n154_), .O(new_n328_));
  aoi21  g155(.a(new_n328_), .b(new_n327_), .c(x01), .O(z58));
  nor2   g156(.a(new_n160_), .b(new_n223_), .O(new_n330_));
  oai21  g157(.a(new_n330_), .b(new_n324_), .c(x40), .O(new_n331_));
  oai21  g158(.a(new_n217_), .b(new_n215_), .c(new_n229_), .O(new_n332_));
  nand2  g159(.a(new_n332_), .b(x79), .O(new_n333_));
  nand3  g160(.a(new_n333_), .b(x78), .c(x04), .O(new_n334_));
  nand2  g161(.a(new_n334_), .b(new_n331_), .O(new_n335_));
  nand2  g162(.a(new_n335_), .b(x77), .O(new_n336_));
  nand2  g163(.a(new_n154_), .b(new_n223_), .O(new_n337_));
  aoi21  g164(.a(new_n337_), .b(new_n336_), .c(x01), .O(z59));
  nand2  g165(.a(new_n315_), .b(x79), .O(new_n339_));
  nand3  g166(.a(new_n339_), .b(new_n337_), .c(new_n220_), .O(new_n340_));
  and2   g167(.a(new_n340_), .b(new_n153_), .O(z60));
  nand2  g168(.a(new_n167_), .b(new_n313_), .O(new_n342_));
  nand2  g169(.a(new_n342_), .b(new_n212_), .O(new_n343_));
  oai21  g170(.a(new_n225_), .b(x04), .c(new_n343_), .O(new_n344_));
  nand4  g171(.a(new_n344_), .b(x80), .c(x79), .d(new_n153_), .O(new_n345_));
  inv1   g172(.a(new_n345_), .O(z61));
  nand2  g173(.a(new_n154_), .b(x04), .O(new_n347_));
  nand3  g174(.a(x84), .b(x81), .c(x79), .O(new_n348_));
  aoi21  g175(.a(new_n348_), .b(new_n347_), .c(x77), .O(new_n349_));
  nand2  g176(.a(new_n333_), .b(x04), .O(new_n350_));
  nand3  g177(.a(x81), .b(x79), .c(new_n223_), .O(new_n351_));
  aoi21  g178(.a(new_n351_), .b(new_n350_), .c(new_n159_), .O(new_n352_));
  oai21  g179(.a(new_n352_), .b(new_n349_), .c(x78), .O(new_n353_));
  or2    g180(.a(new_n348_), .b(new_n167_), .O(new_n354_));
  aoi21  g181(.a(new_n354_), .b(new_n353_), .c(x01), .O(z62));
  nand4  g182(.a(new_n344_), .b(x82), .c(x79), .d(new_n153_), .O(new_n356_));
  inv1   g183(.a(new_n356_), .O(z63));
  nand3  g184(.a(new_n344_), .b(x83), .c(x79), .O(new_n358_));
  nand4  g185(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n359_));
  aoi21  g186(.a(new_n359_), .b(new_n358_), .c(x01), .O(z64));
  zero   g187(.O(z05));
  zero   g188(.O(z10));
  zero   g189(.O(z11));
  zero   g190(.O(z14));
