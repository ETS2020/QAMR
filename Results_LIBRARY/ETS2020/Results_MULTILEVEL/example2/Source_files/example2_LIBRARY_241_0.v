...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n247_, new_n249_, new_n251_, new_n253_, new_n255_, new_n258_,
  ...
  oai21  g074(.a(new_n237_), .b(new_n235_), .c(new_n217_), .O(new_n238_));
  nand2  g075(.a(x83), .b(x42), .O(new_n239_));
  nand2  g076(.a(new_n239_), .b(x81), .O(new_n240_));
  nand3  g077(.a(x83), .b(new_n216_), .c(x42), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g079(.a(new_n242_), .b(new_n214_), .O(new_n243_));
  ...
  nand4  g083(.a(new_n244_), .b(x78), .c(x77), .d(x53), .O(new_n247_));
  nor3   g084(.a(new_n247_), .b(x04), .c(x01), .O(z35));
  nand4  g085(.a(new_n244_), .b(x78), .c(x77), .d(x54), .O(new_n249_));
  nor3   g086(.a(new_n249_), .b(x04), .c(x01), .O(z36));
  nand4  g087(.a(new_n244_), .b(x78), .c(x77), .d(x55), .O(new_n251_));
  nor3   g088(.a(new_n251_), .b(x04), .c(x01), .O(z37));
  nand4  g089(.a(new_n244_), .b(x78), .c(x77), .d(x56), .O(new_n253_));
  nor3   g090(.a(new_n253_), .b(x04), .c(x01), .O(z38));
  nand4  g091(.a(new_n244_), .b(x78), .c(x77), .d(x57), .O(new_n255_));
  nor3   g092(.a(new_n255_), .b(x04), .c(x01), .O(z39));
  nand4  g093(.a(new_n244_), .b(x78), .c(x77), .d(x59), .O(new_n258_));
  nor3   g094(.a(new_n258_), .b(x04), .c(x01), .O(z41));
  nand4  g095(.a(new_n244_), .b(x78), .c(x77), .d(x60), .O(new_n260_));
  nor3   g096(.a(new_n260_), .b(x04), .c(x01), .O(z42));
  nand4  g097(.a(new_n244_), .b(x78), .c(x77), .d(x61), .O(new_n262_));
  nor3   g098(.a(new_n262_), .b(x04), .c(x01), .O(z43));
  nand4  g099(.a(new_n244_), .b(x78), .c(x77), .d(x62), .O(new_n264_));
  nor3   g100(.a(new_n264_), .b(x04), .c(x01), .O(z44));
  nand4  g101(.a(new_n244_), .b(x78), .c(x77), .d(x63), .O(new_n266_));
  nor3   g102(.a(new_n266_), .b(x04), .c(x01), .O(z45));
  nand4  g103(.a(new_n244_), .b(x78), .c(x77), .d(x64), .O(new_n268_));
