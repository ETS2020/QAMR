...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n221_, new_n223_, new_n225_, new_n227_, new_n230_, new_n235_,
  ...
  aoi21  g069(.a(x83), .b(x42), .c(x81), .O(new_n235_));
  nand3  g070(.a(x83), .b(x81), .c(x42), .O(new_n236_));
  inv1   g071(.a(new_n236_), .O(new_n237_));
  oai21  g072(.a(new_n237_), .b(new_n235_), .c(new_n214_), .O(new_n238_));
  nand2  g073(.a(x83), .b(x42), .O(new_n239_));
  nand2  g074(.a(new_n239_), .b(x81), .O(new_n240_));
  nand3  g075(.a(x83), .b(new_n213_), .c(x42), .O(new_n241_));
  nand2  g076(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g077(.a(new_n242_), .b(new_n211_), .O(new_n243_));
  aoi21  g078(.a(new_n243_), .b(new_n238_), .c(new_n156_), .O(new_n244_));
  nand4  g079(.a(new_n244_), .b(x78), .c(x77), .d(x54), .O(new_n245_));
  nor3   g080(.a(new_n245_), .b(x04), .c(x01), .O(z36));
  nand4  g081(.a(new_n244_), .b(x78), .c(x77), .d(x55), .O(new_n247_));
  nor3   g082(.a(new_n247_), .b(x04), .c(x01), .O(z37));
  nand4  g083(.a(new_n244_), .b(x78), .c(x77), .d(x56), .O(new_n249_));
  nor3   g084(.a(new_n249_), .b(x04), .c(x01), .O(z38));
  nand4  g085(.a(new_n244_), .b(x78), .c(x77), .d(x60), .O(new_n254_));
  nor3   g086(.a(new_n254_), .b(x04), .c(x01), .O(z42));
  nand4  g087(.a(new_n244_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g088(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g089(.a(new_n244_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g090(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g091(.a(new_n244_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g092(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g093(.a(new_n244_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  nand4  g143(.a(x03), .b(new_n314_), .c(new_n155_), .d(x00), .O(new_n315_));
  inv1   g144(.a(new_n315_), .O(z57));
  nor2   g145(.a(new_n271_), .b(x04), .O(new_n324_));
  nor2   g146(.a(new_n213_), .b(x78), .O(new_n325_));
