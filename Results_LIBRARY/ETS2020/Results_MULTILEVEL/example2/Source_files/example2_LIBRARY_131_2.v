...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n194_, new_n196_, new_n197_, new_n201_, new_n202_, new_n204_,
  ...
  nand4  g132(.a(new_n285_), .b(x78), .c(x77), .d(x55), .O(new_n290_));
  ...
  nand4  g142(.a(new_n285_), .b(x78), .c(x77), .d(x64), .O(new_n304_));
  ...
  nand4  g157(.a(new_n221_), .b(x79), .c(new_n160_), .d(x77), .O(new_n319_));
  ...
  nand2  g195(.a(new_n357_), .b(new_n242_), .O(new_n358_));
  nor4   g196(.a(new_n358_), .b(new_n354_), .c(new_n225_), .d(x82), .O(z55));
  nand2  g197(.a(new_n235_), .b(x76), .O(new_n360_));
  ...
  nand4  g208(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n371_));
  oai22  g209(.a(new_n371_), .b(new_n226_), .c(new_n239_), .d(x40), .O(new_n372_));
  nand4  g210(.a(new_n372_), .b(x79), .c(x78), .d(x04), .O(new_n373_));
  nor2   g211(.a(x79), .b(x78), .O(new_n374_));
  nand3  g212(.a(new_n374_), .b(new_n239_), .c(x40), .O(new_n375_));
  nand2  g213(.a(new_n375_), .b(new_n373_), .O(new_n376_));
  nand2  g214(.a(new_n376_), .b(x77), .O(new_n377_));
  oai21  g215(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n378_));
  aoi21  g216(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g217(.a(new_n160_), .b(new_n231_), .O(new_n380_));
  oai21  g218(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g219(.a(new_n226_), .b(new_n224_), .c(new_n239_), .O(new_n382_));
  ...
  nand2  g224(.a(new_n154_), .b(new_n231_), .O(new_n387_));
  aoi21  g225(.a(new_n387_), .b(new_n386_), .c(x01), .O(z59));
  nand2  g226(.a(new_n363_), .b(x79), .O(new_n389_));
  nand3  g227(.a(new_n389_), .b(new_n387_), .c(new_n229_), .O(new_n390_));
  and2   g228(.a(new_n390_), .b(new_n153_), .O(z60));
  nand2  g229(.a(new_n167_), .b(new_n361_), .O(new_n392_));
  nand2  g230(.a(new_n392_), .b(new_n221_), .O(new_n393_));
  oai21  g231(.a(new_n235_), .b(x04), .c(new_n393_), .O(new_n394_));
  ...
  nand3  g238(.a(x81), .b(x79), .c(new_n231_), .O(new_n401_));
  ...
  nor2   g249(.a(new_n242_), .b(x78), .O(new_n412_));
