...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n266_, new_n268_, new_n270_, new_n272_, new_n274_, new_n277_,
    new_n278_, new_n279_, new_n280_, new_n281_, new_n282_, new_n283_,
    new_n284_, new_n285_, new_n286_, new_n287_, new_n289_, new_n290_,
    new_n291_, new_n292_, new_n293_, new_n295_, new_n296_, new_n297_,
    new_n298_, new_n299_, new_n301_, new_n302_, new_n303_, new_n304_,
    new_n305_, new_n307_, new_n308_, new_n309_, new_n310_, new_n311_,
    new_n313_, new_n314_, new_n315_, new_n316_, new_n317_, new_n330_,
  ...
  inv1   g109(.a(x77), .O(new_n277_));
  nand2  g110(.a(x52), .b(x16), .O(new_n278_));
  inv1   g111(.a(x52), .O(new_n279_));
  nand2  g112(.a(new_n279_), .b(x08), .O(new_n280_));
  aoi21  g113(.a(new_n280_), .b(new_n278_), .c(x79), .O(new_n281_));
  nand4  g114(.a(new_n281_), .b(x78), .c(new_n277_), .d(x04), .O(new_n282_));
  inv1   g115(.a(x78), .O(new_n283_));
  xnor2a g116(.a(x84), .b(x81), .O(new_n284_));
  nand4  g117(.a(new_n284_), .b(x79), .c(new_n283_), .d(x77), .O(new_n285_));
  inv1   g118(.a(new_n285_), .O(new_n286_));
  nand2  g119(.a(new_n286_), .b(x68), .O(new_n287_));
  aoi21  g120(.a(new_n287_), .b(new_n282_), .c(x01), .O(z48));
  nand2  g121(.a(x52), .b(x17), .O(new_n289_));
  nand2  g122(.a(new_n279_), .b(x09), .O(new_n290_));
  aoi21  g123(.a(new_n290_), .b(new_n289_), .c(x79), .O(new_n291_));
  nand4  g124(.a(new_n291_), .b(x78), .c(new_n277_), .d(x04), .O(new_n292_));
  nand2  g125(.a(new_n286_), .b(x69), .O(new_n293_));
  aoi21  g126(.a(new_n293_), .b(new_n292_), .c(x01), .O(z49));
  nand2  g127(.a(x52), .b(x18), .O(new_n295_));
  nand2  g128(.a(new_n279_), .b(x10), .O(new_n296_));
  aoi21  g129(.a(new_n296_), .b(new_n295_), .c(x79), .O(new_n297_));
  nand4  g130(.a(new_n297_), .b(x78), .c(new_n277_), .d(x04), .O(new_n298_));
  nand2  g131(.a(new_n286_), .b(x70), .O(new_n299_));
  aoi21  g132(.a(new_n299_), .b(new_n298_), .c(x01), .O(z50));
  nand2  g133(.a(x52), .b(x19), .O(new_n301_));
  nand2  g134(.a(new_n279_), .b(x11), .O(new_n302_));
  aoi21  g135(.a(new_n302_), .b(new_n301_), .c(x79), .O(new_n303_));
  nand4  g136(.a(new_n303_), .b(x78), .c(new_n277_), .d(x04), .O(new_n304_));
  nand2  g137(.a(new_n286_), .b(x71), .O(new_n305_));
  aoi21  g138(.a(new_n305_), .b(new_n304_), .c(x01), .O(z51));
  nand2  g139(.a(x52), .b(x20), .O(new_n307_));
  nand2  g140(.a(new_n279_), .b(x12), .O(new_n308_));
  aoi21  g141(.a(new_n308_), .b(new_n307_), .c(x79), .O(new_n309_));
  nand4  g142(.a(new_n309_), .b(x78), .c(new_n277_), .d(x04), .O(new_n310_));
  nand2  g143(.a(new_n286_), .b(x72), .O(new_n311_));
  aoi21  g144(.a(new_n311_), .b(new_n310_), .c(x01), .O(z52));
  nand2  g145(.a(x52), .b(x21), .O(new_n313_));
  nand2  g146(.a(new_n279_), .b(x13), .O(new_n314_));
  aoi21  g147(.a(new_n314_), .b(new_n313_), .c(x79), .O(new_n315_));
  nand4  g148(.a(new_n315_), .b(x78), .c(new_n277_), .d(x04), .O(new_n316_));
  nand2  g149(.a(new_n286_), .b(x73), .O(new_n317_));
  aoi21  g150(.a(new_n317_), .b(new_n316_), .c(x01), .O(z53));
  nor2   g151(.a(new_n283_), .b(x04), .O(new_n330_));
  nor2   g152(.a(new_n210_), .b(x78), .O(new_n331_));
  oai21  g153(.a(new_n331_), .b(new_n330_), .c(x77), .O(new_n332_));
  nand3  g154(.a(x81), .b(x78), .c(new_n277_), .O(new_n333_));
  nand2  g155(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  nand4  g156(.a(new_n334_), .b(x84), .c(x79), .d(new_n155_), .O(new_n335_));
  inv1   g157(.a(new_n335_), .O(z65));
  zero   g158(.O(z00));
  zero   g159(.O(z01));
  zero   g160(.O(z02));
  zero   g161(.O(z07));
