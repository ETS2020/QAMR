...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n285_, new_n287_, new_n290_, new_n293_, new_n295_, new_n297_,
  ...
  nand4  g090(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n229_), .O(new_n249_));
  nor2   g091(.a(new_n249_), .b(x01), .O(z28));
  nand4  g092(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n229_), .O(new_n251_));
  ...
  nand4  g126(.a(new_n278_), .b(x78), .c(x77), .d(x56), .O(new_n287_));
  ...
  nand4  g130(.a(new_n278_), .b(x78), .c(x77), .d(x60), .O(new_n293_));
  nor3   g131(.a(new_n293_), .b(x04), .c(x01), .O(z42));
  nand4  g132(.a(new_n278_), .b(x78), .c(x77), .d(x61), .O(new_n295_));
  nor3   g133(.a(new_n295_), .b(x04), .c(x01), .O(z43));
  nand4  g134(.a(new_n278_), .b(x78), .c(x77), .d(x62), .O(new_n297_));
  nor3   g135(.a(new_n297_), .b(x04), .c(x01), .O(z44));
  nand4  g136(.a(new_n278_), .b(x78), .c(x77), .d(x63), .O(new_n299_));
  ...
  nor2   g202(.a(new_n238_), .b(x78), .O(new_n374_));
