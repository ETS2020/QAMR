...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n225_, new_n230_, new_n231_, new_n232_, new_n233_, new_n234_,
  ...
  oai21  g066(.a(new_n232_), .b(new_n230_), .c(new_n209_), .O(new_n233_));
  nand2  g067(.a(x83), .b(x42), .O(new_n234_));
  nand2  g068(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g069(.a(x83), .b(new_n208_), .c(x42), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(new_n206_), .O(new_n238_));
  ...
  nand4  g079(.a(new_n239_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g080(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g081(.a(new_n239_), .b(x78), .c(x77), .d(x57), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z39));
  nand4  g083(.a(new_n239_), .b(x78), .c(x77), .d(x60), .O(new_n252_));
  nor3   g084(.a(new_n252_), .b(x04), .c(x01), .O(z42));
  nand4  g085(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g086(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g087(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g088(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g089(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g090(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g091(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
  ...
  nor2   g144(.a(new_n208_), .b(x78), .O(new_n323_));
