...
module FAU ( 
  ...
  nor2   g121(.a(new_n225_), .b(new_n239_), .O(new_n280_));
  nand3  g122(.a(x83), .b(x81), .c(x42), .O(new_n281_));
  oai21  g123(.a(new_n280_), .b(x81), .c(new_n281_), .O(new_n282_));
  nand2  g124(.a(new_n282_), .b(new_n243_), .O(new_n283_));
  oai22  g125(.a(new_n280_), .b(new_n242_), .c(new_n263_), .d(new_n239_), .O(new_n284_));
  nand2  g126(.a(new_n284_), .b(new_n240_), .O(new_n285_));
  aoi21  g127(.a(new_n285_), .b(new_n283_), .c(new_n154_), .O(new_n286_));
  nand4  g128(.a(new_n286_), .b(x78), .c(x77), .d(x54), .O(new_n287_));
  nor3   g129(.a(new_n287_), .b(x04), .c(x01), .O(z36));
  nand4  g130(.a(new_n286_), .b(x78), .c(x77), .d(x56), .O(new_n290_));
  nor3   g131(.a(new_n290_), .b(x04), .c(x01), .O(z38));
  nand4  g132(.a(new_n286_), .b(x78), .c(x77), .d(x57), .O(new_n292_));
  nor3   g133(.a(new_n292_), .b(x04), .c(x01), .O(z39));
  nand4  g134(.a(new_n286_), .b(x78), .c(x77), .d(x58), .O(new_n294_));
  nor3   g135(.a(new_n294_), .b(x04), .c(x01), .O(z40));
  nand4  g136(.a(new_n286_), .b(x78), .c(x77), .d(x59), .O(new_n296_));
  nor3   g137(.a(new_n296_), .b(x04), .c(x01), .O(z41));
  nand4  g138(.a(new_n286_), .b(x78), .c(x77), .d(x60), .O(new_n298_));
  nor3   g139(.a(new_n298_), .b(x04), .c(x01), .O(z42));
  nand4  g140(.a(new_n286_), .b(x78), .c(x77), .d(x64), .O(new_n303_));
