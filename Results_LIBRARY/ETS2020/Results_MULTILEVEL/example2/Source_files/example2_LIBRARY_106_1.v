...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n277_, new_n279_, new_n281_, new_n284_, new_n286_,
    new_n288_, new_n292_, new_n295_, new_n298_, new_n299_, new_n300_,
  ...
  nand4  g121(.a(new_n276_), .b(x78), .c(x77), .d(x56), .O(new_n284_));
  ...
  nand4  g127(.a(new_n276_), .b(x78), .c(x77), .d(x61), .O(new_n292_));
  nor3   g128(.a(new_n292_), .b(x04), .c(x01), .O(z43));
  nand4  g129(.a(new_n276_), .b(x78), .c(x77), .d(x63), .O(new_n295_));
  ...
  nor2   g137(.a(new_n303_), .b(new_n215_), .O(new_n304_));
  nand4  g138(.a(new_n304_), .b(x79), .c(new_n160_), .d(x77), .O(new_n305_));
  aoi21  g139(.a(new_n305_), .b(new_n302_), .c(x01), .O(z47));
  inv1   g140(.a(x84), .O(new_n314_));
  nor2   g141(.a(x04), .b(x01), .O(new_n315_));
  nand4  g142(.a(new_n315_), .b(x79), .c(x78), .d(x77), .O(new_n316_));
  nor2   g143(.a(new_n316_), .b(x80), .O(new_n317_));
  nand2  g144(.a(new_n317_), .b(new_n236_), .O(new_n318_));
  nor4   g145(.a(new_n318_), .b(new_n314_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g146(.a(new_n229_), .b(x76), .O(new_n320_));
  inv1   g147(.a(new_n165_), .O(new_n321_));
  xnor2a g148(.a(x84), .b(x81), .O(new_n322_));
  aoi21  g149(.a(new_n167_), .b(new_n321_), .c(new_n322_), .O(new_n323_));
  nand2  g150(.a(new_n323_), .b(new_n153_), .O(new_n324_));
  nand2  g151(.a(new_n324_), .b(new_n320_), .O(new_n325_));
  nand2  g152(.a(new_n325_), .b(x79), .O(new_n326_));
  nand4  g153(.a(new_n326_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g154(.a(x02), .O(new_n328_));
  nand4  g155(.a(x03), .b(new_n328_), .c(new_n153_), .d(x00), .O(new_n329_));
  inv1   g156(.a(new_n329_), .O(z57));
  nand4  g157(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n331_));
  oai22  g158(.a(new_n331_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n332_));
  nand4  g159(.a(new_n332_), .b(x79), .c(x78), .d(x04), .O(new_n333_));
  nor2   g160(.a(x79), .b(x78), .O(new_n334_));
  nand3  g161(.a(new_n334_), .b(new_n233_), .c(x40), .O(new_n335_));
  nand2  g162(.a(new_n335_), .b(new_n333_), .O(new_n336_));
  nand2  g163(.a(new_n336_), .b(x77), .O(new_n337_));
  oai21  g164(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n338_));
  aoi21  g165(.a(new_n338_), .b(new_n337_), .c(x01), .O(z58));
  nor2   g166(.a(new_n160_), .b(new_n227_), .O(new_n340_));
  oai21  g167(.a(new_n340_), .b(new_n334_), .c(x40), .O(new_n341_));
  oai21  g168(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n342_));
  ...
  nand2  g173(.a(new_n154_), .b(new_n227_), .O(new_n347_));
  aoi21  g174(.a(new_n347_), .b(new_n346_), .c(x01), .O(z59));
  nand2  g175(.a(new_n323_), .b(x79), .O(new_n349_));
  nand3  g176(.a(new_n349_), .b(new_n347_), .c(new_n224_), .O(new_n350_));
  and2   g177(.a(new_n350_), .b(new_n153_), .O(z60));
  nand2  g178(.a(new_n167_), .b(new_n321_), .O(new_n352_));
  nand2  g179(.a(new_n352_), .b(new_n216_), .O(new_n353_));
  oai21  g180(.a(new_n229_), .b(x04), .c(new_n353_), .O(new_n354_));
  ...
  nand3  g187(.a(x81), .b(x79), .c(new_n227_), .O(new_n361_));
  ...
  nor2   g194(.a(new_n160_), .b(x04), .O(new_n369_));
  nor2   g195(.a(new_n236_), .b(x78), .O(new_n370_));
  oai21  g196(.a(new_n370_), .b(new_n369_), .c(x77), .O(new_n371_));
  nand3  g197(.a(x81), .b(x78), .c(new_n159_), .O(new_n372_));
  nand2  g198(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  nand4  g199(.a(new_n373_), .b(x84), .c(x79), .d(new_n153_), .O(new_n374_));
  inv1   g200(.a(new_n374_), .O(z65));
  zero   g201(.O(z05));
  zero   g202(.O(z09));
  zero   g203(.O(z11));
  zero   g204(.O(z15));
