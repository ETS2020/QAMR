...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n284_, new_n287_, new_n289_, new_n291_, new_n293_,
  ...
  nand4  g127(.a(new_n281_), .b(x78), .c(x77), .d(x55), .O(new_n287_));
  ...
  nor2   g153(.a(new_n312_), .b(new_n217_), .O(new_n313_));
  ...
  nand4  g160(.a(new_n218_), .b(x79), .c(new_n160_), .d(x77), .O(new_n320_));
  ...
  nor4   g204(.a(new_n363_), .b(new_n359_), .c(new_n222_), .d(x82), .O(z55));
  ...
  nand4  g216(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n377_));
  ...
  oai21  g223(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n383_));
  aoi21  g224(.a(new_n383_), .b(new_n382_), .c(x01), .O(z58));
  nor2   g225(.a(new_n160_), .b(new_n228_), .O(new_n385_));
  oai21  g226(.a(new_n385_), .b(new_n379_), .c(x40), .O(new_n386_));
  oai21  g227(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n387_));
  ...
  nand3  g246(.a(x81), .b(x79), .c(new_n228_), .O(new_n406_));
