...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n296_, new_n297_, new_n298_, new_n306_, new_n307_, new_n308_,
  ...
  nand2  g120(.a(x52), .b(x16), .O(new_n293_));
  nand2  g121(.a(new_n285_), .b(x08), .O(new_n294_));
  aoi21  g122(.a(new_n294_), .b(new_n293_), .c(x79), .O(new_n295_));
  nand4  g123(.a(new_n295_), .b(x78), .c(new_n159_), .d(x04), .O(new_n296_));
  nor2   g124(.a(new_n209_), .b(new_n154_), .O(new_n297_));
  nand4  g125(.a(new_n297_), .b(new_n160_), .c(x77), .d(x68), .O(new_n298_));
  aoi21  g126(.a(new_n298_), .b(new_n296_), .c(x01), .O(z48));
  ...
  nand2  g131(.a(new_n309_), .b(new_n236_), .O(new_n310_));
  nor4   g132(.a(new_n310_), .b(new_n306_), .c(new_n214_), .d(x82), .O(z55));
  nand2  g133(.a(new_n223_), .b(x76), .O(new_n312_));
  ...
  nand4  g144(.a(x80), .b(new_n212_), .c(x43), .d(new_n241_), .O(new_n323_));
  oai22  g145(.a(new_n323_), .b(new_n215_), .c(new_n241_), .d(x40), .O(new_n324_));
  nand4  g146(.a(new_n324_), .b(x79), .c(x78), .d(x04), .O(new_n325_));
  nor2   g147(.a(x79), .b(x78), .O(new_n326_));
  nand3  g148(.a(new_n326_), .b(new_n241_), .c(x40), .O(new_n327_));
  nand2  g149(.a(new_n327_), .b(new_n325_), .O(new_n328_));
  nand2  g150(.a(new_n328_), .b(x77), .O(new_n329_));
  oai21  g151(.a(new_n165_), .b(new_n221_), .c(new_n154_), .O(new_n330_));
  aoi21  g152(.a(new_n330_), .b(new_n329_), .c(x01), .O(z58));
  nor2   g153(.a(new_n160_), .b(new_n221_), .O(new_n332_));
  oai21  g154(.a(new_n332_), .b(new_n326_), .c(x40), .O(new_n333_));
  oai21  g155(.a(new_n215_), .b(new_n213_), .c(new_n241_), .O(new_n334_));
  ...
  nand2  g160(.a(new_n154_), .b(new_n221_), .O(new_n339_));
  aoi21  g161(.a(new_n339_), .b(new_n338_), .c(x01), .O(z59));
  nand2  g162(.a(new_n315_), .b(x79), .O(new_n341_));
  nand3  g163(.a(new_n341_), .b(new_n339_), .c(new_n218_), .O(new_n342_));
  and2   g164(.a(new_n342_), .b(new_n153_), .O(z60));
  nand2  g165(.a(new_n167_), .b(new_n313_), .O(new_n344_));
  nand2  g166(.a(new_n344_), .b(new_n210_), .O(new_n345_));
  oai21  g167(.a(new_n223_), .b(x04), .c(new_n345_), .O(new_n346_));
  ...
  nand3  g174(.a(x81), .b(x79), .c(new_n221_), .O(new_n353_));
