...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n177_, new_n178_, new_n180_, new_n181_, new_n187_,
    ...
    new_n289_, new_n291_, new_n294_, new_n297_, new_n299_, new_n300_,
  ...
  nand4  g126(.a(new_n275_), .b(x78), .c(x77), .d(x59), .O(new_n289_));
  nor3   g127(.a(new_n289_), .b(x04), .c(x01), .O(z41));
  nand4  g128(.a(new_n275_), .b(x78), .c(x77), .d(x60), .O(new_n291_));
  ...
  nor2   g243(.a(new_n160_), .b(x04), .O(new_n408_));
  nor2   g244(.a(new_n233_), .b(x78), .O(new_n409_));
  oai21  g245(.a(new_n409_), .b(new_n408_), .c(x77), .O(new_n410_));
  nand3  g246(.a(x81), .b(x78), .c(new_n159_), .O(new_n411_));
  nand2  g247(.a(new_n411_), .b(new_n410_), .O(new_n412_));
  nand4  g248(.a(new_n412_), .b(x84), .c(x79), .d(new_n153_), .O(new_n413_));
  inv1   g249(.a(new_n413_), .O(z65));
  zero   g250(.O(z04));
  zero   g251(.O(z08));
  zero   g252(.O(z09));
  zero   g253(.O(z10));
