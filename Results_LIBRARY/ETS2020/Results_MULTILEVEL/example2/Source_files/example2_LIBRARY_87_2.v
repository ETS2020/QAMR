...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n293_, new_n295_, new_n297_, new_n299_, new_n304_, new_n306_,
  ...
  nor2   g123(.a(new_n226_), .b(new_n240_), .O(new_n280_));
  ...
  oai22  g127(.a(new_n280_), .b(new_n243_), .c(new_n264_), .d(new_n240_), .O(new_n284_));
  nand2  g128(.a(new_n284_), .b(new_n241_), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(new_n283_), .c(new_n154_), .O(new_n286_));
  nand4  g130(.a(new_n286_), .b(x78), .c(x77), .d(x53), .O(new_n287_));
  nor3   g131(.a(new_n287_), .b(x04), .c(x01), .O(z35));
  nand4  g132(.a(new_n286_), .b(x78), .c(x77), .d(x54), .O(new_n289_));
  nor3   g133(.a(new_n289_), .b(x04), .c(x01), .O(z36));
  nand4  g134(.a(new_n286_), .b(x78), .c(x77), .d(x57), .O(new_n293_));
  nor3   g135(.a(new_n293_), .b(x04), .c(x01), .O(z39));
  nand4  g136(.a(new_n286_), .b(x78), .c(x77), .d(x58), .O(new_n295_));
  nor3   g137(.a(new_n295_), .b(x04), .c(x01), .O(z40));
  nand4  g138(.a(new_n286_), .b(x78), .c(x77), .d(x59), .O(new_n297_));
  nor3   g139(.a(new_n297_), .b(x04), .c(x01), .O(z41));
  nand4  g140(.a(new_n286_), .b(x78), .c(x77), .d(x60), .O(new_n299_));
  nor3   g141(.a(new_n299_), .b(x04), .c(x01), .O(z42));
  nand4  g142(.a(new_n286_), .b(x78), .c(x77), .d(x64), .O(new_n304_));
  ...
  nor2   g150(.a(new_n311_), .b(new_n221_), .O(new_n312_));
  ...
  nand4  g157(.a(new_n222_), .b(x79), .c(new_n160_), .d(x77), .O(new_n319_));
  ...
  nand2  g200(.a(new_n361_), .b(new_n243_), .O(new_n362_));
  nor4   g201(.a(new_n362_), .b(new_n358_), .c(new_n226_), .d(x82), .O(z55));
  nand2  g202(.a(new_n236_), .b(x76), .O(new_n364_));
  ...
  nand4  g211(.a(x03), .b(new_n372_), .c(new_n153_), .d(x00), .O(new_n373_));
  inv1   g212(.a(new_n373_), .O(z57));
  nand4  g213(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n375_));
  oai22  g214(.a(new_n375_), .b(new_n227_), .c(new_n240_), .d(x40), .O(new_n376_));
  nand4  g215(.a(new_n376_), .b(x79), .c(x78), .d(x04), .O(new_n377_));
  nor2   g216(.a(x79), .b(x78), .O(new_n378_));
  nand3  g217(.a(new_n378_), .b(new_n240_), .c(x40), .O(new_n379_));
  nand2  g218(.a(new_n379_), .b(new_n377_), .O(new_n380_));
  nand2  g219(.a(new_n380_), .b(x77), .O(new_n381_));
  oai21  g220(.a(new_n165_), .b(new_n232_), .c(new_n154_), .O(new_n382_));
  aoi21  g221(.a(new_n382_), .b(new_n381_), .c(x01), .O(z58));
  nor2   g222(.a(new_n160_), .b(new_n232_), .O(new_n384_));
  oai21  g223(.a(new_n384_), .b(new_n378_), .c(x40), .O(new_n385_));
  oai21  g224(.a(new_n227_), .b(new_n225_), .c(new_n240_), .O(new_n386_));
  nand2  g225(.a(new_n386_), .b(x79), .O(new_n387_));
  nand3  g226(.a(new_n387_), .b(x78), .c(x04), .O(new_n388_));
  nand2  g227(.a(new_n388_), .b(new_n385_), .O(new_n389_));
  nand2  g228(.a(new_n389_), .b(x77), .O(new_n390_));
  nand2  g229(.a(new_n154_), .b(new_n232_), .O(new_n391_));
  aoi21  g230(.a(new_n391_), .b(new_n390_), .c(x01), .O(z59));
  nand2  g231(.a(new_n367_), .b(x79), .O(new_n393_));
  nand3  g232(.a(new_n393_), .b(new_n391_), .c(new_n230_), .O(new_n394_));
  and2   g233(.a(new_n394_), .b(new_n153_), .O(z60));
  nand2  g234(.a(new_n167_), .b(new_n365_), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(new_n222_), .O(new_n397_));
  oai21  g236(.a(new_n236_), .b(x04), .c(new_n397_), .O(new_n398_));
  nand4  g237(.a(new_n398_), .b(x80), .c(x79), .d(new_n153_), .O(new_n399_));
  inv1   g238(.a(new_n399_), .O(z61));
  nand2  g239(.a(new_n154_), .b(x04), .O(new_n401_));
  nand3  g240(.a(x84), .b(x81), .c(x79), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n401_), .c(x77), .O(new_n403_));
  nand2  g242(.a(new_n387_), .b(x04), .O(new_n404_));
  nand3  g243(.a(x81), .b(x79), .c(new_n232_), .O(new_n405_));
  aoi21  g244(.a(new_n405_), .b(new_n404_), .c(new_n159_), .O(new_n406_));
  oai21  g245(.a(new_n406_), .b(new_n403_), .c(x78), .O(new_n407_));
  or2    g246(.a(new_n402_), .b(new_n167_), .O(new_n408_));
  aoi21  g247(.a(new_n408_), .b(new_n407_), .c(x01), .O(z62));
  nand4  g248(.a(new_n398_), .b(x82), .c(x79), .d(new_n153_), .O(new_n410_));
  inv1   g249(.a(new_n410_), .O(z63));
  nand3  g250(.a(new_n398_), .b(x83), .c(x79), .O(new_n412_));
  nand4  g251(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n413_));
  aoi21  g252(.a(new_n413_), .b(new_n412_), .c(x01), .O(z64));
  zero   g253(.O(z06));
  zero   g254(.O(z08));
  zero   g255(.O(z14));
  zero   g256(.O(z30));
