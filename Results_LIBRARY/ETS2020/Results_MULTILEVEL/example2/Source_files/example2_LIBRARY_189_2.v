...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n277_, new_n279_, new_n281_, new_n285_, new_n288_,
  ...
  nor2   g108(.a(new_n218_), .b(new_n232_), .O(new_n270_));
  ...
  nand4  g121(.a(new_n276_), .b(x78), .c(x77), .d(x57), .O(new_n285_));
  ...
  nand4  g125(.a(new_n276_), .b(x78), .c(x77), .d(x62), .O(new_n292_));
  ...
  nand4  g200(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n367_));
  oai22  g201(.a(new_n367_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n368_));
  ...
  oai21  g207(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n374_));
  aoi21  g208(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nor2   g209(.a(new_n160_), .b(new_n224_), .O(new_n376_));
  oai21  g210(.a(new_n376_), .b(new_n370_), .c(x40), .O(new_n377_));
  oai21  g211(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n378_));
  ...
  nand2  g216(.a(new_n154_), .b(new_n224_), .O(new_n383_));
  ...
  nand3  g230(.a(x81), .b(x79), .c(new_n224_), .O(new_n397_));
  ...
  nor2   g241(.a(new_n235_), .b(x78), .O(new_n408_));
