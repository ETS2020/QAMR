...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n248_, new_n249_, new_n251_, new_n253_, new_n256_, new_n258_,
  ...
  nand4  g067(.a(new_n219_), .b(x47), .c(new_n211_), .d(new_n207_), .O(new_n228_));
  nor2   g068(.a(new_n228_), .b(x01), .O(z29));
  nand4  g069(.a(new_n219_), .b(x48), .c(new_n211_), .d(new_n207_), .O(new_n230_));
  nor2   g070(.a(new_n230_), .b(x01), .O(z30));
  nand4  g071(.a(new_n219_), .b(x49), .c(new_n211_), .d(new_n207_), .O(new_n232_));
  nor2   g072(.a(new_n232_), .b(x01), .O(z31));
  nand4  g073(.a(new_n219_), .b(x50), .c(new_n211_), .d(new_n207_), .O(new_n234_));
  nor2   g074(.a(new_n234_), .b(x01), .O(z32));
  aoi21  g075(.a(x83), .b(x42), .c(x81), .O(new_n239_));
  nand3  g076(.a(x83), .b(x81), .c(x42), .O(new_n240_));
  inv1   g077(.a(new_n240_), .O(new_n241_));
  oai21  g078(.a(new_n241_), .b(new_n239_), .c(new_n215_), .O(new_n242_));
  nand2  g079(.a(x83), .b(x42), .O(new_n243_));
  nand2  g080(.a(new_n243_), .b(x81), .O(new_n244_));
  nand3  g081(.a(x83), .b(new_n214_), .c(x42), .O(new_n245_));
  nand2  g082(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  nand2  g083(.a(new_n246_), .b(new_n212_), .O(new_n247_));
  aoi21  g084(.a(new_n247_), .b(new_n242_), .c(new_n154_), .O(new_n248_));
  nand4  g085(.a(new_n248_), .b(x78), .c(x77), .d(x54), .O(new_n249_));
  nor3   g086(.a(new_n249_), .b(x04), .c(x01), .O(z36));
  nand4  g087(.a(new_n248_), .b(x78), .c(x77), .d(x55), .O(new_n251_));
  nor3   g088(.a(new_n251_), .b(x04), .c(x01), .O(z37));
  nand4  g089(.a(new_n248_), .b(x78), .c(x77), .d(x56), .O(new_n253_));
  nor3   g090(.a(new_n253_), .b(x04), .c(x01), .O(z38));
  nand4  g091(.a(new_n248_), .b(x78), .c(x77), .d(x58), .O(new_n256_));
  nor3   g092(.a(new_n256_), .b(x04), .c(x01), .O(z40));
  nand4  g093(.a(new_n248_), .b(x78), .c(x77), .d(x59), .O(new_n258_));
  nor3   g094(.a(new_n258_), .b(x04), .c(x01), .O(z41));
  nand4  g095(.a(new_n248_), .b(x78), .c(x77), .d(x60), .O(new_n260_));
  nor3   g096(.a(new_n260_), .b(x04), .c(x01), .O(z42));
  nand4  g097(.a(new_n248_), .b(x78), .c(x77), .d(x61), .O(new_n262_));
  nor3   g098(.a(new_n262_), .b(x04), .c(x01), .O(z43));
  nand4  g099(.a(new_n248_), .b(x78), .c(x77), .d(x62), .O(new_n264_));
  nor3   g100(.a(new_n264_), .b(x04), .c(x01), .O(z44));
  nand4  g101(.a(new_n248_), .b(x78), .c(x77), .d(x63), .O(new_n266_));
  nor3   g102(.a(new_n266_), .b(x04), .c(x01), .O(z45));
  nand4  g103(.a(new_n248_), .b(x78), .c(x77), .d(x64), .O(new_n268_));
  ...
  nor2   g156(.a(new_n214_), .b(x78), .O(new_n331_));
