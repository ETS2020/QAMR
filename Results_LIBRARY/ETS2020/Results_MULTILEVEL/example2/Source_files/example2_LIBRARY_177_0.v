...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n242_, new_n244_, new_n246_, new_n250_, new_n252_, new_n254_,
  ...
  nand4  g059(.a(new_n217_), .b(x48), .c(new_n209_), .d(new_n208_), .O(new_n224_));
  nor2   g060(.a(new_n224_), .b(x01), .O(z30));
  nand4  g061(.a(new_n217_), .b(x49), .c(new_n209_), .d(new_n208_), .O(new_n226_));
  nor2   g062(.a(new_n226_), .b(x01), .O(z31));
  aoi21  g063(.a(x83), .b(x42), .c(x81), .O(new_n232_));
  nand3  g064(.a(x83), .b(x81), .c(x42), .O(new_n233_));
  inv1   g065(.a(new_n233_), .O(new_n234_));
  oai21  g066(.a(new_n234_), .b(new_n232_), .c(new_n213_), .O(new_n235_));
  nand2  g067(.a(x83), .b(x42), .O(new_n236_));
  nand2  g068(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g069(.a(x83), .b(new_n212_), .c(x42), .O(new_n238_));
  nand2  g070(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g071(.a(new_n239_), .b(new_n210_), .O(new_n240_));
  aoi21  g072(.a(new_n240_), .b(new_n235_), .c(new_n156_), .O(new_n241_));
  nand4  g073(.a(new_n241_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g074(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g075(.a(new_n241_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g076(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g077(.a(new_n241_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g078(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g079(.a(new_n241_), .b(x78), .c(x77), .d(x59), .O(new_n250_));
  nor3   g080(.a(new_n250_), .b(x04), .c(x01), .O(z41));
  nand4  g081(.a(new_n241_), .b(x78), .c(x77), .d(x60), .O(new_n252_));
  nor3   g082(.a(new_n252_), .b(x04), .c(x01), .O(z42));
  nand4  g083(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g084(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g085(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g086(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g087(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g088(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g089(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
  ...
  nor2   g139(.a(new_n212_), .b(x78), .O(new_n321_));
