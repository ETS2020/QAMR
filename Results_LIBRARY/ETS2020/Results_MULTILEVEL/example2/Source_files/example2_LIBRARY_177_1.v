...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n298_, new_n300_, new_n303_, new_n305_, new_n306_,
  ...
  nand4  g099(.a(new_n246_), .b(x50), .c(new_n238_), .d(new_n230_), .O(new_n258_));
  ...
  nor2   g116(.a(new_n224_), .b(new_n238_), .O(new_n275_));
  nand3  g117(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  oai21  g118(.a(new_n275_), .b(x81), .c(new_n276_), .O(new_n277_));
  nand2  g119(.a(new_n277_), .b(new_n242_), .O(new_n278_));
  oai22  g120(.a(new_n275_), .b(new_n241_), .c(new_n260_), .d(new_n238_), .O(new_n279_));
  nand2  g121(.a(new_n279_), .b(new_n239_), .O(new_n280_));
  ...
  nand4  g129(.a(new_n281_), .b(x78), .c(x77), .d(x55), .O(new_n288_));
  nor3   g130(.a(new_n288_), .b(x04), .c(x01), .O(z37));
  nand4  g131(.a(new_n281_), .b(x78), .c(x77), .d(x56), .O(new_n290_));
  nor3   g132(.a(new_n290_), .b(x04), .c(x01), .O(z38));
  nand4  g133(.a(new_n281_), .b(x78), .c(x77), .d(x57), .O(new_n292_));
  nor3   g134(.a(new_n292_), .b(x04), .c(x01), .O(z39));
  nand4  g135(.a(new_n281_), .b(x78), .c(x77), .d(x58), .O(new_n294_));
  ...
  nand2  g158(.a(new_n234_), .b(x76), .O(new_n327_));
  ...
  nand4  g169(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n338_));
  oai22  g170(.a(new_n338_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n339_));
  ...
  oai21  g176(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n345_));
  aoi21  g177(.a(new_n345_), .b(new_n344_), .c(x01), .O(z58));
  nor2   g178(.a(new_n160_), .b(new_n230_), .O(new_n347_));
  oai21  g179(.a(new_n347_), .b(new_n341_), .c(x40), .O(new_n348_));
  oai21  g180(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n349_));
  ...
  nand2  g185(.a(new_n154_), .b(new_n230_), .O(new_n354_));
  ...
  oai21  g192(.a(new_n234_), .b(x04), .c(new_n360_), .O(new_n361_));
