...
module FAU ( 
  ...
  nand4  g061(.a(new_n214_), .b(x49), .c(new_n206_), .d(new_n201_), .O(new_n225_));
  nor2   g062(.a(new_n225_), .b(x01), .O(z31));
  nand4  g063(.a(new_n214_), .b(x50), .c(new_n206_), .d(new_n201_), .O(new_n227_));
  ...
  oai21  g068(.a(new_n232_), .b(new_n230_), .c(new_n210_), .O(new_n233_));
  nand2  g069(.a(x83), .b(x42), .O(new_n234_));
  nand2  g070(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g071(.a(x83), .b(new_n209_), .c(x42), .O(new_n236_));
  nand2  g072(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(new_n207_), .O(new_n238_));
  ...
  nand4  g077(.a(new_n239_), .b(x78), .c(x77), .d(x53), .O(new_n242_));
  nor3   g078(.a(new_n242_), .b(x04), .c(x01), .O(z35));
  nand4  g079(.a(new_n239_), .b(x78), .c(x77), .d(x54), .O(new_n244_));
  nor3   g080(.a(new_n244_), .b(x04), .c(x01), .O(z36));
  nand4  g081(.a(new_n239_), .b(x78), .c(x77), .d(x55), .O(new_n246_));
  nor3   g082(.a(new_n246_), .b(x04), .c(x01), .O(z37));
  nand4  g083(.a(new_n239_), .b(x78), .c(x77), .d(x56), .O(new_n248_));
  nor3   g084(.a(new_n248_), .b(x04), .c(x01), .O(z38));
  nand4  g085(.a(new_n239_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g086(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g087(.a(new_n239_), .b(x78), .c(x77), .d(x59), .O(new_n253_));
  nor3   g088(.a(new_n253_), .b(x04), .c(x01), .O(z41));
  nand4  g089(.a(new_n239_), .b(x78), .c(x77), .d(x60), .O(new_n255_));
  nor3   g090(.a(new_n255_), .b(x04), .c(x01), .O(z42));
  nand4  g091(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g092(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g093(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n259_));
  nor3   g094(.a(new_n259_), .b(x04), .c(x01), .O(z44));
  nand4  g095(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n261_));
  nor3   g096(.a(new_n261_), .b(x04), .c(x01), .O(z45));
  nand4  g097(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z46));
  inv1   g099(.a(x77), .O(new_n266_));
  nand2  g100(.a(x52), .b(x16), .O(new_n267_));
  inv1   g101(.a(x52), .O(new_n268_));
  nand2  g102(.a(new_n268_), .b(x08), .O(new_n269_));
  aoi21  g103(.a(new_n269_), .b(new_n267_), .c(x79), .O(new_n270_));
  nand4  g104(.a(new_n270_), .b(x78), .c(new_n266_), .d(x04), .O(new_n271_));
  inv1   g105(.a(x78), .O(new_n272_));
  xnor2a g106(.a(x84), .b(x81), .O(new_n273_));
  nand4  g107(.a(new_n273_), .b(x79), .c(new_n272_), .d(x77), .O(new_n274_));
  inv1   g108(.a(new_n274_), .O(new_n275_));
  nand2  g109(.a(new_n275_), .b(x68), .O(new_n276_));
  aoi21  g110(.a(new_n276_), .b(new_n271_), .c(x01), .O(z48));
  nand2  g111(.a(x52), .b(x17), .O(new_n278_));
  nand2  g112(.a(new_n268_), .b(x09), .O(new_n279_));
  aoi21  g113(.a(new_n279_), .b(new_n278_), .c(x79), .O(new_n280_));
  nand4  g114(.a(new_n280_), .b(x78), .c(new_n266_), .d(x04), .O(new_n281_));
  nand2  g115(.a(new_n275_), .b(x69), .O(new_n282_));
  aoi21  g116(.a(new_n282_), .b(new_n281_), .c(x01), .O(z49));
  nand2  g117(.a(x52), .b(x18), .O(new_n284_));
  nand2  g118(.a(new_n268_), .b(x10), .O(new_n285_));
  aoi21  g119(.a(new_n285_), .b(new_n284_), .c(x79), .O(new_n286_));
  nand4  g120(.a(new_n286_), .b(x78), .c(new_n266_), .d(x04), .O(new_n287_));
  nand2  g121(.a(new_n275_), .b(x70), .O(new_n288_));
  aoi21  g122(.a(new_n288_), .b(new_n287_), .c(x01), .O(z50));
  nand2  g123(.a(x52), .b(x19), .O(new_n290_));
  nand2  g124(.a(new_n268_), .b(x11), .O(new_n291_));
  aoi21  g125(.a(new_n291_), .b(new_n290_), .c(x79), .O(new_n292_));
  nand4  g126(.a(new_n292_), .b(x78), .c(new_n266_), .d(x04), .O(new_n293_));
  nand2  g127(.a(new_n275_), .b(x71), .O(new_n294_));
  aoi21  g128(.a(new_n294_), .b(new_n293_), .c(x01), .O(z51));
  nand2  g129(.a(x52), .b(x20), .O(new_n296_));
  nand2  g130(.a(new_n268_), .b(x12), .O(new_n297_));
  aoi21  g131(.a(new_n297_), .b(new_n296_), .c(x79), .O(new_n298_));
  nand4  g132(.a(new_n298_), .b(x78), .c(new_n266_), .d(x04), .O(new_n299_));
  nand2  g133(.a(new_n275_), .b(x72), .O(new_n300_));
  aoi21  g134(.a(new_n300_), .b(new_n299_), .c(x01), .O(z52));
  nand2  g135(.a(x52), .b(x21), .O(new_n302_));
  nand2  g136(.a(new_n268_), .b(x13), .O(new_n303_));
  aoi21  g137(.a(new_n303_), .b(new_n302_), .c(x79), .O(new_n304_));
  nand4  g138(.a(new_n304_), .b(x78), .c(new_n266_), .d(x04), .O(new_n305_));
  nand2  g139(.a(new_n275_), .b(x73), .O(new_n306_));
  aoi21  g140(.a(new_n306_), .b(new_n305_), .c(x01), .O(z53));
  nand2  g141(.a(x52), .b(x22), .O(new_n308_));
  nand2  g142(.a(new_n268_), .b(x14), .O(new_n309_));
  aoi21  g143(.a(new_n309_), .b(new_n308_), .c(x79), .O(new_n310_));
  nand4  g144(.a(new_n310_), .b(x78), .c(new_n266_), .d(x04), .O(new_n311_));
  nor2   g145(.a(new_n311_), .b(x01), .O(z54));
  inv1   g146(.a(x02), .O(new_n315_));
  nand4  g147(.a(x03), .b(new_n315_), .c(new_n155_), .d(x00), .O(new_n316_));
  inv1   g148(.a(new_n316_), .O(z57));
  nor2   g149(.a(new_n272_), .b(x04), .O(new_n325_));
  nor2   g150(.a(new_n209_), .b(x78), .O(new_n326_));
  oai21  g151(.a(new_n326_), .b(new_n325_), .c(x77), .O(new_n327_));
  nand3  g152(.a(x81), .b(x78), .c(new_n266_), .O(new_n328_));
