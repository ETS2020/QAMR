...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n230_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
  ...
  inv1   g074(.a(x42), .O(new_n235_));
  xnor2a g075(.a(x84), .b(x82), .O(new_n236_));
  nand2  g076(.a(new_n236_), .b(x81), .O(new_n237_));
  inv1   g077(.a(x81), .O(new_n238_));
  xor2a  g078(.a(x84), .b(x82), .O(new_n239_));
  nand2  g079(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g080(.a(new_n240_), .b(new_n237_), .O(new_n241_));
  nand4  g081(.a(new_n241_), .b(x79), .c(x78), .d(x77), .O(new_n242_));
  inv1   g082(.a(new_n242_), .O(new_n243_));
  nand4  g083(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n224_), .O(new_n244_));
  nor2   g084(.a(new_n244_), .b(x01), .O(z28));
  nand4  g085(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n224_), .O(new_n246_));
  nor2   g086(.a(new_n246_), .b(x01), .O(z29));
  nand4  g087(.a(new_n243_), .b(x48), .c(new_n235_), .d(new_n224_), .O(new_n248_));
  nor2   g088(.a(new_n248_), .b(x01), .O(z30));
  nand4  g089(.a(new_n243_), .b(x49), .c(new_n235_), .d(new_n224_), .O(new_n250_));
  nor2   g090(.a(new_n250_), .b(x01), .O(z31));
  nand2  g091(.a(x83), .b(new_n238_), .O(new_n253_));
  ...
  nand3  g095(.a(x81), .b(x51), .c(new_n235_), .O(new_n257_));
  nand2  g096(.a(new_n257_), .b(new_n256_), .O(new_n258_));
  nand2  g097(.a(new_n258_), .b(new_n236_), .O(new_n259_));
  xnor2a g098(.a(x83), .b(x81), .O(new_n260_));
  nand3  g099(.a(new_n260_), .b(x42), .c(x05), .O(new_n261_));
  nand3  g100(.a(new_n238_), .b(x51), .c(new_n235_), .O(new_n262_));
  nand2  g101(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  nand2  g102(.a(new_n263_), .b(new_n239_), .O(new_n264_));
  aoi21  g103(.a(new_n264_), .b(new_n259_), .c(new_n156_), .O(new_n265_));
  nand4  g104(.a(new_n265_), .b(x78), .c(x77), .d(new_n224_), .O(new_n266_));
  nor2   g105(.a(new_n266_), .b(x01), .O(z33));
  nor2   g106(.a(new_n218_), .b(new_n235_), .O(new_n269_));
  nand3  g107(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  oai21  g108(.a(new_n269_), .b(x81), .c(new_n270_), .O(new_n271_));
  nand2  g109(.a(new_n271_), .b(new_n239_), .O(new_n272_));
  oai22  g110(.a(new_n269_), .b(new_n238_), .c(new_n253_), .d(new_n235_), .O(new_n273_));
  nand2  g111(.a(new_n273_), .b(new_n236_), .O(new_n274_));
  aoi21  g112(.a(new_n274_), .b(new_n272_), .c(new_n156_), .O(new_n275_));
  nand4  g113(.a(new_n275_), .b(x78), .c(x77), .d(x53), .O(new_n276_));
  nor3   g114(.a(new_n276_), .b(x04), .c(x01), .O(z35));
  nand4  g115(.a(new_n275_), .b(x78), .c(x77), .d(x54), .O(new_n278_));
  nor3   g116(.a(new_n278_), .b(x04), .c(x01), .O(z36));
  nand4  g117(.a(new_n275_), .b(x78), .c(x77), .d(x55), .O(new_n280_));
  nor3   g118(.a(new_n280_), .b(x04), .c(x01), .O(z37));
  nand4  g119(.a(new_n275_), .b(x78), .c(x77), .d(x56), .O(new_n282_));
  ...
  nand4  g133(.a(new_n275_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  ...
  nand4  g164(.a(x03), .b(new_n333_), .c(new_n159_), .d(x00), .O(new_n334_));
  inv1   g165(.a(new_n334_), .O(z57));
  nand4  g166(.a(x80), .b(new_n216_), .c(x43), .d(new_n235_), .O(new_n336_));
  oai22  g167(.a(new_n336_), .b(new_n219_), .c(new_n235_), .d(x40), .O(new_n337_));
  nand4  g168(.a(new_n337_), .b(x79), .c(x78), .d(x04), .O(new_n338_));
  nor2   g169(.a(x79), .b(x78), .O(new_n339_));
  nand3  g170(.a(new_n339_), .b(new_n235_), .c(x40), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n338_), .O(new_n341_));
  nand2  g172(.a(new_n341_), .b(x77), .O(new_n342_));
  oai21  g173(.a(new_n161_), .b(new_n224_), .c(new_n156_), .O(new_n343_));
  aoi21  g174(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g175(.a(new_n154_), .b(new_n224_), .O(new_n345_));
  oai21  g176(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g177(.a(new_n219_), .b(new_n217_), .c(new_n235_), .O(new_n347_));
  ...
  nand2  g182(.a(new_n156_), .b(new_n224_), .O(new_n352_));
  aoi21  g183(.a(new_n352_), .b(new_n351_), .c(x01), .O(z59));
  nand2  g184(.a(new_n328_), .b(x79), .O(new_n354_));
  nand3  g185(.a(new_n354_), .b(new_n352_), .c(new_n222_), .O(new_n355_));
  and2   g186(.a(new_n355_), .b(new_n159_), .O(z60));
  nand2  g187(.a(new_n163_), .b(new_n326_), .O(new_n357_));
  nand2  g188(.a(new_n357_), .b(new_n214_), .O(new_n358_));
  oai21  g189(.a(new_n228_), .b(x04), .c(new_n358_), .O(new_n359_));
  nand4  g190(.a(new_n359_), .b(x80), .c(x79), .d(new_n159_), .O(new_n360_));
  inv1   g191(.a(new_n360_), .O(z61));
  nand2  g192(.a(new_n156_), .b(x04), .O(new_n362_));
  ...
  nand3  g196(.a(x81), .b(x79), .c(new_n224_), .O(new_n366_));
  aoi21  g197(.a(new_n366_), .b(new_n365_), .c(new_n153_), .O(new_n367_));
  oai21  g198(.a(new_n367_), .b(new_n364_), .c(x78), .O(new_n368_));
  or2    g199(.a(new_n363_), .b(new_n163_), .O(new_n369_));
  aoi21  g200(.a(new_n369_), .b(new_n368_), .c(x01), .O(z62));
  nand4  g201(.a(new_n359_), .b(x82), .c(x79), .d(new_n159_), .O(new_n371_));
  inv1   g202(.a(new_n371_), .O(z63));
  nand3  g203(.a(new_n359_), .b(x83), .c(x79), .O(new_n373_));
  nand4  g204(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n374_));
  aoi21  g205(.a(new_n374_), .b(new_n373_), .c(x01), .O(z64));
  nor2   g206(.a(new_n154_), .b(x04), .O(new_n376_));
  nor2   g207(.a(new_n238_), .b(x78), .O(new_n377_));
  oai21  g208(.a(new_n377_), .b(new_n376_), .c(x77), .O(new_n378_));
  nand3  g209(.a(x81), .b(x78), .c(new_n153_), .O(new_n379_));
  nand2  g210(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  nand4  g211(.a(new_n380_), .b(x84), .c(x79), .d(new_n159_), .O(new_n381_));
  inv1   g212(.a(new_n381_), .O(z65));
  zero   g213(.O(z00));
  zero   g214(.O(z06));
  zero   g215(.O(z08));
  zero   g216(.O(z13));
