...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n248_, new_n250_, new_n255_, new_n257_, new_n259_, new_n261_,
    ...
    new_n314_, new_n325_, new_n326_, new_n327_, new_n328_, new_n329_,
  ...
  nand4  g087(.a(new_n244_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  nor3   g088(.a(new_n255_), .b(x04), .c(x01), .O(z41));
  nand4  g089(.a(new_n244_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g090(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g091(.a(new_n244_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g092(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g093(.a(new_n244_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g094(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g095(.a(new_n244_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g096(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g097(.a(new_n244_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  xor2a  g106(.a(x84), .b(x81), .O(new_n275_));
  nor2   g107(.a(new_n275_), .b(new_n154_), .O(new_n276_));
  nand3  g108(.a(new_n276_), .b(new_n274_), .c(x77), .O(new_n277_));
  inv1   g109(.a(new_n277_), .O(new_n278_));
  nand2  g110(.a(new_n278_), .b(x68), .O(new_n279_));
  aoi21  g111(.a(new_n279_), .b(new_n273_), .c(x01), .O(z48));
  nand2  g112(.a(x52), .b(x17), .O(new_n281_));
  nand2  g113(.a(new_n270_), .b(x09), .O(new_n282_));
  aoi21  g114(.a(new_n282_), .b(new_n281_), .c(x79), .O(new_n283_));
  nand4  g115(.a(new_n283_), .b(x78), .c(new_n268_), .d(x04), .O(new_n284_));
  nand2  g116(.a(new_n278_), .b(x69), .O(new_n285_));
  aoi21  g117(.a(new_n285_), .b(new_n284_), .c(x01), .O(z49));
  nand2  g118(.a(x52), .b(x18), .O(new_n287_));
  nand2  g119(.a(new_n270_), .b(x10), .O(new_n288_));
  aoi21  g120(.a(new_n288_), .b(new_n287_), .c(x79), .O(new_n289_));
  nand4  g121(.a(new_n289_), .b(x78), .c(new_n268_), .d(x04), .O(new_n290_));
  nand2  g122(.a(new_n278_), .b(x70), .O(new_n291_));
  aoi21  g123(.a(new_n291_), .b(new_n290_), .c(x01), .O(z50));
  nand2  g124(.a(x52), .b(x19), .O(new_n293_));
  nand2  g125(.a(new_n270_), .b(x11), .O(new_n294_));
  aoi21  g126(.a(new_n294_), .b(new_n293_), .c(x79), .O(new_n295_));
  nand4  g127(.a(new_n295_), .b(x78), .c(new_n268_), .d(x04), .O(new_n296_));
  nand2  g128(.a(new_n278_), .b(x71), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n296_), .c(x01), .O(z51));
  nand2  g130(.a(x52), .b(x20), .O(new_n299_));
  nand2  g131(.a(new_n270_), .b(x12), .O(new_n300_));
  aoi21  g132(.a(new_n300_), .b(new_n299_), .c(x79), .O(new_n301_));
  nand4  g133(.a(new_n301_), .b(x78), .c(new_n268_), .d(x04), .O(new_n302_));
  nand2  g134(.a(new_n278_), .b(x72), .O(new_n303_));
  aoi21  g135(.a(new_n303_), .b(new_n302_), .c(x01), .O(z52));
  nand2  g136(.a(x52), .b(x21), .O(new_n305_));
  nand2  g137(.a(new_n270_), .b(x13), .O(new_n306_));
  aoi21  g138(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g139(.a(new_n307_), .b(x78), .c(new_n268_), .d(x04), .O(new_n308_));
  nand2  g140(.a(new_n278_), .b(x73), .O(new_n309_));
  aoi21  g141(.a(new_n309_), .b(new_n308_), .c(x01), .O(z53));
  nand2  g142(.a(x52), .b(x22), .O(new_n311_));
  nand2  g143(.a(new_n270_), .b(x14), .O(new_n312_));
  aoi21  g144(.a(new_n312_), .b(new_n311_), .c(x79), .O(new_n313_));
  nand4  g145(.a(new_n313_), .b(x78), .c(new_n268_), .d(x04), .O(new_n314_));
  nor2   g146(.a(new_n314_), .b(x01), .O(z54));
  xnor2a g147(.a(x78), .b(x77), .O(new_n325_));
  nand3  g148(.a(x78), .b(x77), .c(new_n207_), .O(new_n326_));
  oai21  g149(.a(new_n325_), .b(new_n275_), .c(new_n326_), .O(new_n327_));
  nand3  g150(.a(new_n327_), .b(x83), .c(x79), .O(new_n328_));
  nand4  g151(.a(new_n154_), .b(x78), .c(new_n268_), .d(x04), .O(new_n329_));
  aoi21  g152(.a(new_n329_), .b(new_n328_), .c(x01), .O(z64));
  nor2   g153(.a(new_n274_), .b(x04), .O(new_n331_));
  nor2   g154(.a(new_n215_), .b(x78), .O(new_n332_));
  oai21  g155(.a(new_n332_), .b(new_n331_), .c(x77), .O(new_n333_));
  nand3  g156(.a(x81), .b(x78), .c(new_n268_), .O(new_n334_));
  nand2  g157(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  nand4  g158(.a(new_n335_), .b(x84), .c(x79), .d(new_n153_), .O(new_n336_));
  inv1   g159(.a(new_n336_), .O(z65));
  zero   g160(.O(z01));
  zero   g161(.O(z02));
  zero   g162(.O(z07));
  zero   g163(.O(z12));
