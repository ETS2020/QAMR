...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n275_, new_n278_, new_n280_, new_n282_, new_n285_, new_n287_,
  ...
  nor2   g092(.a(new_n218_), .b(new_n246_), .O(new_n260_));
  nand3  g093(.a(x83), .b(x81), .c(x42), .O(new_n261_));
  oai21  g094(.a(new_n260_), .b(x81), .c(new_n261_), .O(new_n262_));
  nand2  g095(.a(new_n262_), .b(new_n250_), .O(new_n263_));
  oai22  g096(.a(new_n260_), .b(new_n241_), .c(new_n242_), .d(new_n246_), .O(new_n264_));
  nand2  g097(.a(new_n264_), .b(new_n240_), .O(new_n265_));
  aoi21  g098(.a(new_n265_), .b(new_n263_), .c(new_n154_), .O(new_n266_));
  nand4  g099(.a(new_n266_), .b(x78), .c(x77), .d(x53), .O(new_n267_));
  nor3   g100(.a(new_n267_), .b(x04), .c(x01), .O(z35));
  nand4  g101(.a(new_n266_), .b(x78), .c(x77), .d(x54), .O(new_n269_));
  nor3   g102(.a(new_n269_), .b(x04), .c(x01), .O(z36));
  nand4  g103(.a(new_n266_), .b(x78), .c(x77), .d(x55), .O(new_n271_));
  nor3   g104(.a(new_n271_), .b(x04), .c(x01), .O(z37));
  nand4  g105(.a(new_n266_), .b(x78), .c(x77), .d(x56), .O(new_n273_));
  nor3   g106(.a(new_n273_), .b(x04), .c(x01), .O(z38));
  nand4  g107(.a(new_n266_), .b(x78), .c(x77), .d(x57), .O(new_n275_));
  nor3   g108(.a(new_n275_), .b(x04), .c(x01), .O(z39));
  nand4  g109(.a(new_n266_), .b(x78), .c(x77), .d(x59), .O(new_n278_));
  nor3   g110(.a(new_n278_), .b(x04), .c(x01), .O(z41));
  nand4  g111(.a(new_n266_), .b(x78), .c(x77), .d(x60), .O(new_n280_));
  nor3   g112(.a(new_n280_), .b(x04), .c(x01), .O(z42));
  nand4  g113(.a(new_n266_), .b(x78), .c(x77), .d(x61), .O(new_n282_));
  nor3   g114(.a(new_n282_), .b(x04), .c(x01), .O(z43));
  ...
  nor2   g125(.a(new_n294_), .b(new_n213_), .O(new_n295_));
  ...
  nand2  g132(.a(new_n308_), .b(new_n241_), .O(new_n309_));
  nor4   g133(.a(new_n309_), .b(new_n305_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g134(.a(new_n228_), .b(x76), .O(new_n311_));
  inv1   g135(.a(new_n165_), .O(new_n312_));
  xnor2a g136(.a(x84), .b(x81), .O(new_n313_));
  aoi21  g137(.a(new_n167_), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand2  g138(.a(new_n314_), .b(new_n153_), .O(new_n315_));
  nand2  g139(.a(new_n315_), .b(new_n311_), .O(new_n316_));
  nand2  g140(.a(new_n316_), .b(x79), .O(new_n317_));
  nand4  g141(.a(new_n317_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g142(.a(x02), .O(new_n319_));
  nand4  g143(.a(x03), .b(new_n319_), .c(new_n153_), .d(x00), .O(new_n320_));
  inv1   g144(.a(new_n320_), .O(z57));
  nand4  g145(.a(x80), .b(new_n216_), .c(x43), .d(new_n246_), .O(new_n322_));
  oai22  g146(.a(new_n322_), .b(new_n219_), .c(new_n246_), .d(x40), .O(new_n323_));
  nand4  g147(.a(new_n323_), .b(x79), .c(x78), .d(x04), .O(new_n324_));
  nor2   g148(.a(x79), .b(x78), .O(new_n325_));
  nand3  g149(.a(new_n325_), .b(new_n246_), .c(x40), .O(new_n326_));
  nand2  g150(.a(new_n326_), .b(new_n324_), .O(new_n327_));
  nand2  g151(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g152(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n329_));
  aoi21  g153(.a(new_n329_), .b(new_n328_), .c(x01), .O(z58));
  nor2   g154(.a(new_n160_), .b(new_n224_), .O(new_n331_));
  oai21  g155(.a(new_n331_), .b(new_n325_), .c(x40), .O(new_n332_));
  oai21  g156(.a(new_n219_), .b(new_n217_), .c(new_n246_), .O(new_n333_));
  ...
  nand2  g161(.a(new_n154_), .b(new_n224_), .O(new_n338_));
  aoi21  g162(.a(new_n338_), .b(new_n337_), .c(x01), .O(z59));
  nand2  g163(.a(new_n314_), .b(x79), .O(new_n340_));
  nand3  g164(.a(new_n340_), .b(new_n338_), .c(new_n222_), .O(new_n341_));
  and2   g165(.a(new_n341_), .b(new_n153_), .O(z60));
  nand2  g166(.a(new_n167_), .b(new_n312_), .O(new_n343_));
  nand2  g167(.a(new_n343_), .b(new_n214_), .O(new_n344_));
  oai21  g168(.a(new_n228_), .b(x04), .c(new_n344_), .O(new_n345_));
  nand4  g169(.a(new_n345_), .b(x80), .c(x79), .d(new_n153_), .O(new_n346_));
  inv1   g170(.a(new_n346_), .O(z61));
  nand2  g171(.a(new_n154_), .b(x04), .O(new_n348_));
  ...
  nand3  g175(.a(x81), .b(x79), .c(new_n224_), .O(new_n352_));
  aoi21  g176(.a(new_n352_), .b(new_n351_), .c(new_n159_), .O(new_n353_));
  oai21  g177(.a(new_n353_), .b(new_n350_), .c(x78), .O(new_n354_));
  or2    g178(.a(new_n349_), .b(new_n167_), .O(new_n355_));
  aoi21  g179(.a(new_n355_), .b(new_n354_), .c(x01), .O(z62));
  nand4  g180(.a(new_n345_), .b(x82), .c(x79), .d(new_n153_), .O(new_n357_));
  inv1   g181(.a(new_n357_), .O(z63));
  nand3  g182(.a(new_n345_), .b(x83), .c(x79), .O(new_n359_));
  nand4  g183(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n360_));
