...
module FAU ( 
  ...
  nand4  g129(.a(new_n282_), .b(x78), .c(x77), .d(x57), .O(new_n290_));
  nor3   g130(.a(new_n290_), .b(x04), .c(x01), .O(z39));
  nand4  g131(.a(new_n282_), .b(x78), .c(x77), .d(x58), .O(new_n292_));
  nor3   g132(.a(new_n292_), .b(x04), .c(x01), .O(z40));
  nand4  g133(.a(new_n282_), .b(x78), .c(x77), .d(x59), .O(new_n294_));
  nor3   g134(.a(new_n294_), .b(x04), .c(x01), .O(z41));
  nand4  g135(.a(new_n282_), .b(x78), .c(x77), .d(x60), .O(new_n296_));
  ...
  nand4  g206(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n371_));
  oai22  g207(.a(new_n371_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n372_));
  ...
  oai21  g213(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n378_));
  aoi21  g214(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g215(.a(new_n160_), .b(new_n230_), .O(new_n380_));
  oai21  g216(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g217(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n382_));
  ...
  nand2  g222(.a(new_n154_), .b(new_n230_), .O(new_n387_));
  ...
  nand3  g236(.a(x81), .b(x79), .c(new_n230_), .O(new_n401_));
