...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n252_, new_n254_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n283_, new_n285_, new_n287_, new_n290_, new_n292_, new_n294_,
  ...
  nor2   g114(.a(new_n223_), .b(new_n237_), .O(new_n274_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  oai21  g116(.a(new_n274_), .b(x81), .c(new_n275_), .O(new_n276_));
  nand2  g117(.a(new_n276_), .b(new_n241_), .O(new_n277_));
  oai22  g118(.a(new_n274_), .b(new_n240_), .c(new_n259_), .d(new_n237_), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n238_), .O(new_n279_));
