// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:35 2020
...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n222_, new_n224_, new_n226_, new_n228_, new_n230_, new_n235_,
  ...
  aoi21  g070(.a(x83), .b(x42), .c(x81), .O(new_n235_));
  nand3  g071(.a(x83), .b(x81), .c(x42), .O(new_n236_));
  inv1   g072(.a(new_n236_), .O(new_n237_));
  oai21  g073(.a(new_n237_), .b(new_n235_), .c(new_n211_), .O(new_n238_));
  nand2  g074(.a(x83), .b(x42), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(x81), .O(new_n240_));
  nand3  g076(.a(x83), .b(new_n210_), .c(x42), .O(new_n241_));
  nand2  g077(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g078(.a(new_n242_), .b(new_n208_), .O(new_n243_));
  aoi21  g079(.a(new_n243_), .b(new_n238_), .c(new_n156_), .O(new_n244_));
  nand4  g080(.a(new_n244_), .b(x78), .c(x77), .d(x54), .O(new_n245_));
  nor3   g081(.a(new_n245_), .b(x04), .c(x01), .O(z36));
  nand4  g082(.a(new_n244_), .b(x78), .c(x77), .d(x55), .O(new_n247_));
  nor3   g083(.a(new_n247_), .b(x04), .c(x01), .O(z37));
  nand4  g084(.a(new_n244_), .b(x78), .c(x77), .d(x56), .O(new_n249_));
  nor3   g085(.a(new_n249_), .b(x04), .c(x01), .O(z38));
  nand4  g086(.a(new_n244_), .b(x78), .c(x77), .d(x57), .O(new_n251_));
  nor3   g087(.a(new_n251_), .b(x04), .c(x01), .O(z39));
  nand4  g088(.a(new_n244_), .b(x78), .c(x77), .d(x58), .O(new_n253_));
  nor3   g089(.a(new_n253_), .b(x04), .c(x01), .O(z40));
  nand4  g090(.a(new_n244_), .b(x78), .c(x77), .d(x60), .O(new_n256_));
  nor3   g091(.a(new_n256_), .b(x04), .c(x01), .O(z42));
  nand4  g092(.a(new_n244_), .b(x78), .c(x77), .d(x61), .O(new_n258_));
  nor3   g093(.a(new_n258_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n244_), .b(x78), .c(x77), .d(x62), .O(new_n260_));
  nor3   g095(.a(new_n260_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n244_), .b(x78), .c(x77), .d(x63), .O(new_n262_));
  nor3   g097(.a(new_n262_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n244_), .b(x78), .c(x77), .d(x64), .O(new_n264_));
