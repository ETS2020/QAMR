...
module FAU ( 
  ...
  nand4  g053(.a(new_n216_), .b(x79), .c(x78), .d(x77), .O(new_n217_));
  inv1   g054(.a(new_n217_), .O(new_n218_));
  nand4  g055(.a(new_n218_), .b(x45), .c(new_n210_), .d(new_n209_), .O(new_n219_));
  nor2   g056(.a(new_n219_), .b(x01), .O(z27));
  nand4  g057(.a(new_n218_), .b(x46), .c(new_n210_), .d(new_n209_), .O(new_n221_));
  nor2   g058(.a(new_n221_), .b(x01), .O(z28));
  nand4  g059(.a(new_n218_), .b(x47), .c(new_n210_), .d(new_n209_), .O(new_n223_));
  nor2   g060(.a(new_n223_), .b(x01), .O(z29));
  nand4  g061(.a(new_n218_), .b(x48), .c(new_n210_), .d(new_n209_), .O(new_n225_));
  nor2   g062(.a(new_n225_), .b(x01), .O(z30));
  nand4  g063(.a(new_n218_), .b(x49), .c(new_n210_), .d(new_n209_), .O(new_n227_));
  nor2   g064(.a(new_n227_), .b(x01), .O(z31));
  nand4  g065(.a(new_n218_), .b(x50), .c(new_n210_), .d(new_n209_), .O(new_n229_));
  ...
  nor2   g152(.a(new_n213_), .b(x78), .O(new_n328_));
