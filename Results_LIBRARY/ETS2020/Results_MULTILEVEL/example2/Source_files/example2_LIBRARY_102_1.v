...
module FAU ( 
  ...
  nand4  g124(.a(new_n278_), .b(x78), .c(x77), .d(x56), .O(new_n286_));
  ...
  nand4  g164(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n335_));
  oai22  g165(.a(new_n335_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n336_));
  ...
  oai21  g175(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n346_));
