// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:41 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n244_, new_n245_, new_n246_, new_n247_, new_n254_,
  ...
  nand2  g098(.a(new_n224_), .b(x81), .O(new_n259_));
  ...
  nor2   g112(.a(new_n224_), .b(new_n238_), .O(new_n275_));
  nand3  g113(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  oai21  g114(.a(new_n275_), .b(x81), .c(new_n276_), .O(new_n277_));
  nand2  g115(.a(new_n277_), .b(new_n242_), .O(new_n278_));
  oai22  g116(.a(new_n275_), .b(new_n241_), .c(new_n258_), .d(new_n238_), .O(new_n279_));
  nand2  g117(.a(new_n279_), .b(new_n239_), .O(new_n280_));
  aoi21  g118(.a(new_n280_), .b(new_n278_), .c(new_n154_), .O(new_n281_));
  nand4  g119(.a(new_n281_), .b(x78), .c(x77), .d(x54), .O(new_n282_));
  nor3   g120(.a(new_n282_), .b(x04), .c(x01), .O(z36));
  nand4  g121(.a(new_n281_), .b(x78), .c(x77), .d(x57), .O(new_n286_));
  nor3   g122(.a(new_n286_), .b(x04), .c(x01), .O(z39));
  nand4  g123(.a(new_n281_), .b(x78), .c(x77), .d(x58), .O(new_n288_));
  nor3   g124(.a(new_n288_), .b(x04), .c(x01), .O(z40));
  nand4  g125(.a(new_n281_), .b(x78), .c(x77), .d(x59), .O(new_n290_));
  nor3   g126(.a(new_n290_), .b(x04), .c(x01), .O(z41));
  nand4  g127(.a(new_n281_), .b(x78), .c(x77), .d(x61), .O(new_n293_));
  nor3   g128(.a(new_n293_), .b(x04), .c(x01), .O(z43));
  nand4  g129(.a(new_n281_), .b(x78), .c(x77), .d(x62), .O(new_n295_));
  nor3   g130(.a(new_n295_), .b(x04), .c(x01), .O(z44));
  nand4  g131(.a(new_n281_), .b(x78), .c(x77), .d(x63), .O(new_n297_));
  nor3   g132(.a(new_n297_), .b(x04), .c(x01), .O(z45));
  nand4  g133(.a(new_n281_), .b(x78), .c(x77), .d(x64), .O(new_n299_));
  nor3   g134(.a(new_n299_), .b(x04), .c(x01), .O(z46));
  ...
  nand2  g171(.a(new_n302_), .b(x13), .O(new_n338_));
  aoi21  g172(.a(new_n338_), .b(new_n337_), .c(x79), .O(new_n339_));
  nand4  g173(.a(new_n339_), .b(x78), .c(new_n159_), .d(x04), .O(new_n340_));
  nand2  g174(.a(new_n315_), .b(x73), .O(new_n341_));
  aoi21  g175(.a(new_n341_), .b(new_n340_), .c(x01), .O(z53));
  nand2  g176(.a(x52), .b(x22), .O(new_n343_));
  nand2  g177(.a(new_n302_), .b(x14), .O(new_n344_));
  aoi21  g178(.a(new_n344_), .b(new_n343_), .c(x79), .O(new_n345_));
  nand4  g179(.a(new_n345_), .b(x78), .c(new_n159_), .d(x04), .O(new_n346_));
  nor2   g180(.a(new_n346_), .b(x01), .O(z54));
  inv1   g181(.a(x84), .O(new_n348_));
  nor2   g182(.a(x04), .b(x01), .O(new_n349_));
  nand4  g183(.a(new_n349_), .b(x79), .c(x78), .d(x77), .O(new_n350_));
  nor2   g184(.a(new_n350_), .b(x80), .O(new_n351_));
  nand2  g185(.a(new_n351_), .b(new_n241_), .O(new_n352_));
  nor4   g186(.a(new_n352_), .b(new_n348_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g187(.a(new_n234_), .b(x76), .O(new_n354_));
  inv1   g188(.a(new_n165_), .O(new_n355_));
  xnor2a g189(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g190(.a(new_n167_), .b(new_n355_), .c(new_n356_), .O(new_n357_));
  nand2  g191(.a(new_n357_), .b(new_n153_), .O(new_n358_));
  nand2  g192(.a(new_n358_), .b(new_n354_), .O(new_n359_));
  nand2  g193(.a(new_n359_), .b(x79), .O(new_n360_));
  nand4  g194(.a(new_n360_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g195(.a(x02), .O(new_n362_));
  nand4  g196(.a(x03), .b(new_n362_), .c(new_n153_), .d(x00), .O(new_n363_));
  inv1   g197(.a(new_n363_), .O(z57));
  nand4  g198(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n365_));
  oai22  g199(.a(new_n365_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n366_));
  nand4  g200(.a(new_n366_), .b(x79), .c(x78), .d(x04), .O(new_n367_));
  nor2   g201(.a(x79), .b(x78), .O(new_n368_));
  nand3  g202(.a(new_n368_), .b(new_n238_), .c(x40), .O(new_n369_));
  nand2  g203(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g204(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g205(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n372_));
  aoi21  g206(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  nor2   g207(.a(new_n160_), .b(new_n230_), .O(new_n374_));
  oai21  g208(.a(new_n374_), .b(new_n368_), .c(x40), .O(new_n375_));
  oai21  g209(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n376_));
  nand2  g210(.a(new_n376_), .b(x79), .O(new_n377_));
  nand3  g211(.a(new_n377_), .b(x78), .c(x04), .O(new_n378_));
  nand2  g212(.a(new_n378_), .b(new_n375_), .O(new_n379_));
  nand2  g213(.a(new_n379_), .b(x77), .O(new_n380_));
  nand2  g214(.a(new_n154_), .b(new_n230_), .O(new_n381_));
  aoi21  g215(.a(new_n381_), .b(new_n380_), .c(x01), .O(z59));
  nand2  g216(.a(new_n357_), .b(x79), .O(new_n383_));
  nand3  g217(.a(new_n383_), .b(new_n381_), .c(new_n228_), .O(new_n384_));
  and2   g218(.a(new_n384_), .b(new_n153_), .O(z60));
  nand2  g219(.a(new_n167_), .b(new_n355_), .O(new_n386_));
  nand2  g220(.a(new_n386_), .b(new_n220_), .O(new_n387_));
  oai21  g221(.a(new_n234_), .b(x04), .c(new_n387_), .O(new_n388_));
  nand4  g222(.a(new_n388_), .b(x80), .c(x79), .d(new_n153_), .O(new_n389_));
  inv1   g223(.a(new_n389_), .O(z61));
  nand2  g224(.a(new_n154_), .b(x04), .O(new_n391_));
  nand3  g225(.a(x84), .b(x81), .c(x79), .O(new_n392_));
  aoi21  g226(.a(new_n392_), .b(new_n391_), .c(x77), .O(new_n393_));
  nand2  g227(.a(new_n377_), .b(x04), .O(new_n394_));
  nand3  g228(.a(x81), .b(x79), .c(new_n230_), .O(new_n395_));
  aoi21  g229(.a(new_n395_), .b(new_n394_), .c(new_n159_), .O(new_n396_));
  oai21  g230(.a(new_n396_), .b(new_n393_), .c(x78), .O(new_n397_));
  or2    g231(.a(new_n392_), .b(new_n167_), .O(new_n398_));
  aoi21  g232(.a(new_n398_), .b(new_n397_), .c(x01), .O(z62));
  nand4  g233(.a(new_n388_), .b(x82), .c(x79), .d(new_n153_), .O(new_n400_));
  inv1   g234(.a(new_n400_), .O(z63));
  nand3  g235(.a(new_n388_), .b(x83), .c(x79), .O(new_n402_));
  nand4  g236(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n403_));
  aoi21  g237(.a(new_n403_), .b(new_n402_), .c(x01), .O(z64));
  nor2   g238(.a(new_n160_), .b(x04), .O(new_n405_));
  nor2   g239(.a(new_n241_), .b(x78), .O(new_n406_));
  oai21  g240(.a(new_n406_), .b(new_n405_), .c(x77), .O(new_n407_));
  nand3  g241(.a(x81), .b(x78), .c(new_n159_), .O(new_n408_));
  nand2  g242(.a(new_n408_), .b(new_n407_), .O(new_n409_));
  nand4  g243(.a(new_n409_), .b(x84), .c(x79), .d(new_n153_), .O(new_n410_));
  inv1   g244(.a(new_n410_), .O(z65));
  zero   g245(.O(z06));
  zero   g246(.O(z07));
  zero   g247(.O(z15));
  zero   g248(.O(z21));
