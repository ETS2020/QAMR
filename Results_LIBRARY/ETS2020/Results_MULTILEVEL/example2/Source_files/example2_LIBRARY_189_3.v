...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n289_, new_n291_, new_n294_, new_n296_, new_n298_,
    new_n300_, new_n302_, new_n304_, new_n306_, new_n309_, new_n312_,
  ...
  nand4  g107(.a(new_n250_), .b(x48), .c(new_n242_), .d(new_n234_), .O(new_n261_));
  nor2   g108(.a(new_n261_), .b(x01), .O(z30));
  nand4  g109(.a(new_n250_), .b(x49), .c(new_n242_), .d(new_n234_), .O(new_n263_));
  nor2   g110(.a(new_n263_), .b(x01), .O(z31));
  nand4  g111(.a(new_n250_), .b(x50), .c(new_n242_), .d(new_n234_), .O(new_n265_));
  nor2   g112(.a(new_n265_), .b(x01), .O(z32));
  nand2  g113(.a(x83), .b(new_n245_), .O(new_n267_));
  nand2  g114(.a(new_n228_), .b(x81), .O(new_n268_));
  nand2  g115(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand3  g116(.a(new_n269_), .b(x42), .c(x05), .O(new_n270_));
  nand3  g117(.a(x81), .b(x51), .c(new_n242_), .O(new_n271_));
  nand2  g118(.a(new_n271_), .b(new_n270_), .O(new_n272_));
  nand2  g119(.a(new_n272_), .b(new_n243_), .O(new_n273_));
  xnor2a g120(.a(x83), .b(x81), .O(new_n274_));
  nand3  g121(.a(new_n274_), .b(x42), .c(x05), .O(new_n275_));
  nand3  g122(.a(new_n245_), .b(x51), .c(new_n242_), .O(new_n276_));
  nand2  g123(.a(new_n276_), .b(new_n275_), .O(new_n277_));
  nand2  g124(.a(new_n277_), .b(new_n246_), .O(new_n278_));
  aoi21  g125(.a(new_n278_), .b(new_n273_), .c(new_n154_), .O(new_n279_));
  nand4  g126(.a(new_n279_), .b(x78), .c(x77), .d(new_n234_), .O(new_n280_));
  nor2   g127(.a(new_n280_), .b(x01), .O(z33));
  nor2   g128(.a(new_n228_), .b(new_n242_), .O(new_n282_));
  nand3  g129(.a(x83), .b(x81), .c(x42), .O(new_n283_));
  oai21  g130(.a(new_n282_), .b(x81), .c(new_n283_), .O(new_n284_));
  nand2  g131(.a(new_n284_), .b(new_n246_), .O(new_n285_));
  oai22  g132(.a(new_n282_), .b(new_n245_), .c(new_n267_), .d(new_n242_), .O(new_n286_));
  nand2  g133(.a(new_n286_), .b(new_n243_), .O(new_n287_));
  aoi21  g134(.a(new_n287_), .b(new_n285_), .c(new_n154_), .O(new_n288_));
  nand4  g135(.a(new_n288_), .b(x78), .c(x77), .d(x52), .O(new_n289_));
  nor3   g136(.a(new_n289_), .b(x04), .c(x01), .O(z34));
  nand4  g137(.a(new_n288_), .b(x78), .c(x77), .d(x53), .O(new_n291_));
  nor3   g138(.a(new_n291_), .b(x04), .c(x01), .O(z35));
  nand4  g139(.a(new_n288_), .b(x78), .c(x77), .d(x55), .O(new_n294_));
  nor3   g140(.a(new_n294_), .b(x04), .c(x01), .O(z37));
  nand4  g141(.a(new_n288_), .b(x78), .c(x77), .d(x56), .O(new_n296_));
  nor3   g142(.a(new_n296_), .b(x04), .c(x01), .O(z38));
  nand4  g143(.a(new_n288_), .b(x78), .c(x77), .d(x57), .O(new_n298_));
  nor3   g144(.a(new_n298_), .b(x04), .c(x01), .O(z39));
  nand4  g145(.a(new_n288_), .b(x78), .c(x77), .d(x58), .O(new_n300_));
  nor3   g146(.a(new_n300_), .b(x04), .c(x01), .O(z40));
  nand4  g147(.a(new_n288_), .b(x78), .c(x77), .d(x59), .O(new_n302_));
  nor3   g148(.a(new_n302_), .b(x04), .c(x01), .O(z41));
  nand4  g149(.a(new_n288_), .b(x78), .c(x77), .d(x60), .O(new_n304_));
  nor3   g150(.a(new_n304_), .b(x04), .c(x01), .O(z42));
  nand4  g151(.a(new_n288_), .b(x78), .c(x77), .d(x61), .O(new_n306_));
  nor3   g152(.a(new_n306_), .b(x04), .c(x01), .O(z43));
  nand4  g153(.a(new_n288_), .b(x78), .c(x77), .d(x63), .O(new_n309_));
  ...
  nor2   g161(.a(new_n317_), .b(new_n223_), .O(new_n318_));
  ...
  nand4  g168(.a(new_n224_), .b(x79), .c(new_n160_), .d(x77), .O(new_n325_));
  ...
  nand2  g211(.a(new_n367_), .b(new_n245_), .O(new_n368_));
  nor4   g212(.a(new_n368_), .b(new_n364_), .c(new_n228_), .d(x82), .O(z55));
  nand2  g213(.a(new_n238_), .b(x76), .O(new_n370_));
  ...
  nand4  g224(.a(x80), .b(new_n226_), .c(x43), .d(new_n242_), .O(new_n381_));
  oai22  g225(.a(new_n381_), .b(new_n229_), .c(new_n242_), .d(x40), .O(new_n382_));
  nand4  g226(.a(new_n382_), .b(x79), .c(x78), .d(x04), .O(new_n383_));
  nor2   g227(.a(x79), .b(x78), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(new_n242_), .c(x40), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n383_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(x77), .O(new_n387_));
  oai21  g231(.a(new_n165_), .b(new_n234_), .c(new_n154_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n387_), .c(x01), .O(z58));
  nor2   g233(.a(new_n160_), .b(new_n234_), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n384_), .c(x40), .O(new_n391_));
  oai21  g235(.a(new_n229_), .b(new_n227_), .c(new_n242_), .O(new_n392_));
  ...
  nand2  g240(.a(new_n154_), .b(new_n234_), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n396_), .c(x01), .O(z59));
  nand2  g242(.a(new_n373_), .b(x79), .O(new_n399_));
  nand3  g243(.a(new_n399_), .b(new_n397_), .c(new_n232_), .O(new_n400_));
  and2   g244(.a(new_n400_), .b(new_n153_), .O(z60));
  nand2  g245(.a(new_n167_), .b(new_n371_), .O(new_n402_));
  nand2  g246(.a(new_n402_), .b(new_n224_), .O(new_n403_));
  oai21  g247(.a(new_n238_), .b(x04), .c(new_n403_), .O(new_n404_));
  ...
  nand3  g254(.a(x81), .b(x79), .c(new_n234_), .O(new_n411_));
  ...
  nor2   g265(.a(new_n245_), .b(x78), .O(new_n422_));
