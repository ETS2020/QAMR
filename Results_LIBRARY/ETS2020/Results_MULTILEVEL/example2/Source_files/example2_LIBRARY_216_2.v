...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n290_, new_n292_, new_n298_, new_n299_, new_n300_,
  ...
  nand4  g088(.a(new_n241_), .b(x47), .c(new_n233_), .d(new_n227_), .O(new_n249_));
  nor2   g089(.a(new_n249_), .b(x01), .O(z29));
  nand4  g090(.a(new_n241_), .b(x48), .c(new_n233_), .d(new_n227_), .O(new_n251_));
  ...
  nand4  g122(.a(new_n279_), .b(x78), .c(x77), .d(x56), .O(new_n285_));
  ...
  nand4  g128(.a(new_n279_), .b(x78), .c(x77), .d(x60), .O(new_n292_));
  nor3   g129(.a(new_n292_), .b(x04), .c(x01), .O(z42));
  ...
  nand2  g186(.a(new_n353_), .b(new_n236_), .O(new_n354_));
  nor4   g187(.a(new_n354_), .b(new_n350_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g188(.a(new_n229_), .b(x76), .O(new_n356_));
  ...
  nand4  g199(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n367_));
  oai22  g200(.a(new_n367_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n368_));
  nand4  g201(.a(new_n368_), .b(x79), .c(x78), .d(x04), .O(new_n369_));
  nor2   g202(.a(x79), .b(x78), .O(new_n370_));
  nand3  g203(.a(new_n370_), .b(new_n233_), .c(x40), .O(new_n371_));
  nand2  g204(.a(new_n371_), .b(new_n369_), .O(new_n372_));
  nand2  g205(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g206(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n374_));
  aoi21  g207(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nor2   g208(.a(new_n160_), .b(new_n227_), .O(new_n376_));
  oai21  g209(.a(new_n376_), .b(new_n370_), .c(x40), .O(new_n377_));
  oai21  g210(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n378_));
  ...
  nand2  g215(.a(new_n154_), .b(new_n227_), .O(new_n383_));
  ...
  oai21  g222(.a(new_n229_), .b(x04), .c(new_n389_), .O(new_n390_));
  ...
  nand3  g229(.a(x81), .b(x79), .c(new_n227_), .O(new_n397_));
