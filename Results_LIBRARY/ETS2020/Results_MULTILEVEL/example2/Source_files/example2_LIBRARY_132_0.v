...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n240_, new_n241_, new_n244_, new_n246_, new_n252_, new_n254_,
    ...
    new_n308_, new_n309_, new_n313_, new_n314_, new_n322_, new_n323_,
  ...
  nand4  g053(.a(new_n213_), .b(x44), .c(new_n205_), .d(new_n201_), .O(new_n216_));
  nor2   g054(.a(new_n216_), .b(x01), .O(z26));
  nand4  g055(.a(new_n213_), .b(x45), .c(new_n205_), .d(new_n201_), .O(new_n218_));
  nor2   g056(.a(new_n218_), .b(x01), .O(z27));
  nand4  g057(.a(new_n213_), .b(x46), .c(new_n205_), .d(new_n201_), .O(new_n220_));
  nor2   g058(.a(new_n220_), .b(x01), .O(z28));
  nand4  g059(.a(new_n213_), .b(x47), .c(new_n205_), .d(new_n201_), .O(new_n222_));
  nor2   g060(.a(new_n222_), .b(x01), .O(z29));
  nand4  g061(.a(new_n213_), .b(x48), .c(new_n205_), .d(new_n201_), .O(new_n224_));
  nor2   g062(.a(new_n224_), .b(x01), .O(z30));
  nand4  g063(.a(new_n213_), .b(x49), .c(new_n205_), .d(new_n201_), .O(new_n226_));
  nor2   g064(.a(new_n226_), .b(x01), .O(z31));
  nand4  g065(.a(new_n213_), .b(x50), .c(new_n205_), .d(new_n201_), .O(new_n228_));
  nor2   g066(.a(new_n228_), .b(x01), .O(z32));
  aoi21  g067(.a(x83), .b(x42), .c(x81), .O(new_n231_));
  nand3  g068(.a(x83), .b(x81), .c(x42), .O(new_n232_));
  inv1   g069(.a(new_n232_), .O(new_n233_));
  oai21  g070(.a(new_n233_), .b(new_n231_), .c(new_n209_), .O(new_n234_));
  nand2  g071(.a(x83), .b(x42), .O(new_n235_));
  nand2  g072(.a(new_n235_), .b(x81), .O(new_n236_));
  nand3  g073(.a(x83), .b(new_n208_), .c(x42), .O(new_n237_));
  nand2  g074(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g075(.a(new_n238_), .b(new_n206_), .O(new_n239_));
  aoi21  g076(.a(new_n239_), .b(new_n234_), .c(new_n156_), .O(new_n240_));
  nand4  g077(.a(new_n240_), .b(x78), .c(x77), .d(x52), .O(new_n241_));
  nor3   g078(.a(new_n241_), .b(x04), .c(x01), .O(z34));
  nand4  g079(.a(new_n240_), .b(x78), .c(x77), .d(x54), .O(new_n244_));
  nor3   g080(.a(new_n244_), .b(x04), .c(x01), .O(z36));
  nand4  g081(.a(new_n240_), .b(x78), .c(x77), .d(x55), .O(new_n246_));
  nor3   g082(.a(new_n246_), .b(x04), .c(x01), .O(z37));
  nand4  g083(.a(new_n240_), .b(x78), .c(x77), .d(x60), .O(new_n252_));
  nor3   g084(.a(new_n252_), .b(x04), .c(x01), .O(z42));
  nand4  g085(.a(new_n240_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g086(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g087(.a(new_n240_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g088(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g089(.a(new_n240_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g090(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g091(.a(new_n240_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
  ...
  xnor2a g144(.a(x78), .b(x77), .O(new_n322_));
  nand3  g145(.a(x78), .b(x77), .c(new_n201_), .O(new_n323_));
  oai21  g146(.a(new_n322_), .b(new_n270_), .c(new_n323_), .O(new_n324_));
  nand3  g147(.a(new_n324_), .b(x83), .c(x79), .O(new_n325_));
  nand4  g148(.a(new_n156_), .b(x78), .c(new_n263_), .d(x04), .O(new_n326_));
  aoi21  g149(.a(new_n326_), .b(new_n325_), .c(x01), .O(z64));
  nor2   g150(.a(new_n269_), .b(x04), .O(new_n328_));
  nor2   g151(.a(new_n208_), .b(x78), .O(new_n329_));
  oai21  g152(.a(new_n329_), .b(new_n328_), .c(x77), .O(new_n330_));
  nand3  g153(.a(x81), .b(x78), .c(new_n263_), .O(new_n331_));
  nand2  g154(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand4  g155(.a(new_n332_), .b(x84), .c(x79), .d(new_n155_), .O(new_n333_));
