...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n277_, new_n279_, new_n281_, new_n284_, new_n287_, new_n288_,
  ...
  nor2   g089(.a(new_n216_), .b(new_n244_), .O(new_n257_));
  nand3  g090(.a(x83), .b(x81), .c(x42), .O(new_n258_));
  oai21  g091(.a(new_n257_), .b(x81), .c(new_n258_), .O(new_n259_));
  nand2  g092(.a(new_n259_), .b(new_n248_), .O(new_n260_));
  oai22  g093(.a(new_n257_), .b(new_n239_), .c(new_n240_), .d(new_n244_), .O(new_n261_));
  nand2  g094(.a(new_n261_), .b(new_n238_), .O(new_n262_));
  aoi21  g095(.a(new_n262_), .b(new_n260_), .c(new_n154_), .O(new_n263_));
  nand4  g096(.a(new_n263_), .b(x78), .c(x77), .d(x52), .O(new_n264_));
  nor3   g097(.a(new_n264_), .b(x04), .c(x01), .O(z34));
  nand4  g098(.a(new_n263_), .b(x78), .c(x77), .d(x53), .O(new_n266_));
  nor3   g099(.a(new_n266_), .b(x04), .c(x01), .O(z35));
  nand4  g100(.a(new_n263_), .b(x78), .c(x77), .d(x54), .O(new_n268_));
  nor3   g101(.a(new_n268_), .b(x04), .c(x01), .O(z36));
  nand4  g102(.a(new_n263_), .b(x78), .c(x77), .d(x55), .O(new_n270_));
  nor3   g103(.a(new_n270_), .b(x04), .c(x01), .O(z37));
  nand4  g104(.a(new_n263_), .b(x78), .c(x77), .d(x56), .O(new_n272_));
  nor3   g105(.a(new_n272_), .b(x04), .c(x01), .O(z38));
  nand4  g106(.a(new_n263_), .b(x78), .c(x77), .d(x57), .O(new_n274_));
  nor3   g107(.a(new_n274_), .b(x04), .c(x01), .O(z39));
  nand4  g108(.a(new_n263_), .b(x78), .c(x77), .d(x59), .O(new_n277_));
  nor3   g109(.a(new_n277_), .b(x04), .c(x01), .O(z41));
  nand4  g110(.a(new_n263_), .b(x78), .c(x77), .d(x60), .O(new_n279_));
  nor3   g111(.a(new_n279_), .b(x04), .c(x01), .O(z42));
  nand4  g112(.a(new_n263_), .b(x78), .c(x77), .d(x61), .O(new_n281_));
  nor3   g113(.a(new_n281_), .b(x04), .c(x01), .O(z43));
  nand4  g114(.a(new_n263_), .b(x78), .c(x77), .d(x63), .O(new_n284_));
  nor3   g115(.a(new_n284_), .b(x04), .c(x01), .O(z45));
