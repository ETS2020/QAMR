// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:10 2020
...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n222_, new_n224_, new_n226_, new_n228_, new_n234_, new_n235_,
  ...
  aoi21  g068(.a(x83), .b(x42), .c(x81), .O(new_n234_));
  nand3  g069(.a(x83), .b(x81), .c(x42), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(new_n236_));
  oai21  g071(.a(new_n236_), .b(new_n234_), .c(new_n211_), .O(new_n237_));
  nand2  g072(.a(x83), .b(x42), .O(new_n238_));
  nand2  g073(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g074(.a(x83), .b(new_n210_), .c(x42), .O(new_n240_));
  nand2  g075(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g076(.a(new_n241_), .b(new_n208_), .O(new_n242_));
  aoi21  g077(.a(new_n242_), .b(new_n237_), .c(new_n156_), .O(new_n243_));
  nand4  g078(.a(new_n243_), .b(x78), .c(x77), .d(x54), .O(new_n244_));
  nor3   g079(.a(new_n244_), .b(x04), .c(x01), .O(z36));
  nand4  g080(.a(new_n243_), .b(x78), .c(x77), .d(x55), .O(new_n246_));
  nor3   g081(.a(new_n246_), .b(x04), .c(x01), .O(z37));
  nand4  g082(.a(new_n243_), .b(x78), .c(x77), .d(x56), .O(new_n248_));
  nor3   g083(.a(new_n248_), .b(x04), .c(x01), .O(z38));
  nand4  g084(.a(new_n243_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g085(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g086(.a(new_n243_), .b(x78), .c(x77), .d(x58), .O(new_n252_));
  nor3   g087(.a(new_n252_), .b(x04), .c(x01), .O(z40));
  nand4  g088(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n255_));
  nor3   g089(.a(new_n255_), .b(x04), .c(x01), .O(z42));
  nand4  g090(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g091(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g092(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n259_));
  nor3   g093(.a(new_n259_), .b(x04), .c(x01), .O(z44));
  nand4  g094(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n261_));
  nor3   g095(.a(new_n261_), .b(x04), .c(x01), .O(z45));
  nand4  g096(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n263_));
  ...
  nand2  g110(.a(x52), .b(x17), .O(new_n278_));
  nand2  g111(.a(new_n268_), .b(x09), .O(new_n279_));
  aoi21  g112(.a(new_n279_), .b(new_n278_), .c(x79), .O(new_n280_));
  nand4  g113(.a(new_n280_), .b(x78), .c(new_n266_), .d(x04), .O(new_n281_));
  nand2  g114(.a(new_n275_), .b(x69), .O(new_n282_));
  aoi21  g115(.a(new_n282_), .b(new_n281_), .c(x01), .O(z49));
  nand2  g116(.a(x52), .b(x18), .O(new_n284_));
  nand2  g117(.a(new_n268_), .b(x10), .O(new_n285_));
  aoi21  g118(.a(new_n285_), .b(new_n284_), .c(x79), .O(new_n286_));
  nand4  g119(.a(new_n286_), .b(x78), .c(new_n266_), .d(x04), .O(new_n287_));
  nand2  g120(.a(new_n275_), .b(x70), .O(new_n288_));
  aoi21  g121(.a(new_n288_), .b(new_n287_), .c(x01), .O(z50));
  nand2  g122(.a(x52), .b(x19), .O(new_n290_));
  nand2  g123(.a(new_n268_), .b(x11), .O(new_n291_));
  aoi21  g124(.a(new_n291_), .b(new_n290_), .c(x79), .O(new_n292_));
  nand4  g125(.a(new_n292_), .b(x78), .c(new_n266_), .d(x04), .O(new_n293_));
  nand2  g126(.a(new_n275_), .b(x71), .O(new_n294_));
  aoi21  g127(.a(new_n294_), .b(new_n293_), .c(x01), .O(z51));
  nand2  g128(.a(x52), .b(x20), .O(new_n296_));
  nand2  g129(.a(new_n268_), .b(x12), .O(new_n297_));
  aoi21  g130(.a(new_n297_), .b(new_n296_), .c(x79), .O(new_n298_));
  nand4  g131(.a(new_n298_), .b(x78), .c(new_n266_), .d(x04), .O(new_n299_));
  nand2  g132(.a(new_n275_), .b(x72), .O(new_n300_));
  aoi21  g133(.a(new_n300_), .b(new_n299_), .c(x01), .O(z52));
  nand2  g134(.a(x52), .b(x21), .O(new_n302_));
  nand2  g135(.a(new_n268_), .b(x13), .O(new_n303_));
  aoi21  g136(.a(new_n303_), .b(new_n302_), .c(x79), .O(new_n304_));
  nand4  g137(.a(new_n304_), .b(x78), .c(new_n266_), .d(x04), .O(new_n305_));
  nand2  g138(.a(new_n275_), .b(x73), .O(new_n306_));
  aoi21  g139(.a(new_n306_), .b(new_n305_), .c(x01), .O(z53));
  nand2  g140(.a(x52), .b(x22), .O(new_n308_));
  nand2  g141(.a(new_n268_), .b(x14), .O(new_n309_));
  aoi21  g142(.a(new_n309_), .b(new_n308_), .c(x79), .O(new_n310_));
  nand4  g143(.a(new_n310_), .b(x78), .c(new_n266_), .d(x04), .O(new_n311_));
  nor2   g144(.a(new_n311_), .b(x01), .O(z54));
  inv1   g145(.a(x02), .O(new_n315_));
  nand4  g146(.a(x03), .b(new_n315_), .c(new_n155_), .d(x00), .O(new_n316_));
  inv1   g147(.a(new_n316_), .O(z57));
  nor2   g148(.a(new_n272_), .b(x04), .O(new_n325_));
  nor2   g149(.a(new_n210_), .b(x78), .O(new_n326_));
  oai21  g150(.a(new_n326_), .b(new_n325_), .c(x77), .O(new_n327_));
  nand3  g151(.a(x81), .b(x78), .c(new_n266_), .O(new_n328_));
  nand2  g152(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand4  g153(.a(new_n329_), .b(x84), .c(x79), .d(new_n155_), .O(new_n330_));
  inv1   g154(.a(new_n330_), .O(z65));
  zero   g155(.O(z00));
  zero   g156(.O(z01));
  zero   g157(.O(z02));
  zero   g158(.O(z12));
