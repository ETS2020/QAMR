...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n237_, new_n238_, new_n239_, new_n240_, new_n244_, new_n246_,
    new_n248_, new_n250_, new_n252_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n278_, new_n280_, new_n282_, new_n285_, new_n289_,
  ...
  nand4  g084(.a(new_n239_), .b(x47), .c(new_n231_), .d(new_n225_), .O(new_n246_));
  ...
  nor4   g146(.a(new_n318_), .b(new_n314_), .c(new_n218_), .d(x82), .O(z55));
  ...
  nand4  g155(.a(x80), .b(new_n216_), .c(x43), .d(new_n231_), .O(new_n329_));
  oai22  g156(.a(new_n329_), .b(new_n219_), .c(new_n231_), .d(x40), .O(new_n330_));
  nand4  g157(.a(new_n330_), .b(x79), .c(x78), .d(x04), .O(new_n331_));
  nor2   g158(.a(x79), .b(x78), .O(new_n332_));
  nand3  g159(.a(new_n332_), .b(new_n231_), .c(x40), .O(new_n333_));
  nand2  g160(.a(new_n333_), .b(new_n331_), .O(new_n334_));
  nand2  g161(.a(new_n334_), .b(x77), .O(new_n335_));
  oai21  g162(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n336_));
  aoi21  g163(.a(new_n336_), .b(new_n335_), .c(x01), .O(z58));
  nor2   g164(.a(new_n160_), .b(new_n225_), .O(new_n338_));
  oai21  g165(.a(new_n338_), .b(new_n332_), .c(x40), .O(new_n339_));
  oai21  g166(.a(new_n219_), .b(new_n217_), .c(new_n231_), .O(new_n340_));
  ...
  nand2  g171(.a(new_n154_), .b(new_n225_), .O(new_n345_));
  aoi21  g172(.a(new_n345_), .b(new_n344_), .c(x01), .O(z59));
  nand2  g173(.a(new_n323_), .b(x79), .O(new_n347_));
  nand3  g174(.a(new_n347_), .b(new_n345_), .c(new_n222_), .O(new_n348_));
  and2   g175(.a(new_n348_), .b(new_n153_), .O(z60));
  nand2  g176(.a(new_n167_), .b(new_n321_), .O(new_n350_));
  nand2  g177(.a(new_n350_), .b(new_n214_), .O(new_n351_));
  oai21  g178(.a(new_n227_), .b(x04), .c(new_n351_), .O(new_n352_));
  ...
  nand3  g185(.a(x81), .b(x79), .c(new_n225_), .O(new_n359_));
  ...
  nor2   g195(.a(new_n160_), .b(x04), .O(new_n369_));
  nor2   g196(.a(new_n234_), .b(x78), .O(new_n370_));
  oai21  g197(.a(new_n370_), .b(new_n369_), .c(x77), .O(new_n371_));
  nand3  g198(.a(x81), .b(x78), .c(new_n159_), .O(new_n372_));
  nand2  g199(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  nand4  g200(.a(new_n373_), .b(x84), .c(x79), .d(new_n153_), .O(new_n374_));
  inv1   g201(.a(new_n374_), .O(z65));
  zero   g202(.O(z05));
  zero   g203(.O(z06));
  zero   g204(.O(z09));
  zero   g205(.O(z10));
