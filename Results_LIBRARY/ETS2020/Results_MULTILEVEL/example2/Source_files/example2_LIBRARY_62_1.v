...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n237_, new_n238_, new_n239_, new_n243_, new_n246_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n274_, new_n276_, new_n278_,
    new_n280_, new_n282_, new_n284_, new_n286_, new_n289_, new_n292_,
  ...
  nand4  g083(.a(new_n238_), .b(x48), .c(new_n230_), .d(new_n222_), .O(new_n246_));
  ...
  nand4  g098(.a(new_n262_), .b(x78), .c(x77), .d(new_n222_), .O(new_n263_));
  ...
  nand4  g119(.a(new_n271_), .b(x78), .c(x77), .d(x58), .O(new_n284_));
  nor3   g120(.a(new_n284_), .b(x04), .c(x01), .O(z40));
  nand4  g121(.a(new_n271_), .b(x78), .c(x77), .d(x59), .O(new_n286_));
  ...
  nand4  g127(.a(new_n271_), .b(x78), .c(x77), .d(x64), .O(new_n294_));
