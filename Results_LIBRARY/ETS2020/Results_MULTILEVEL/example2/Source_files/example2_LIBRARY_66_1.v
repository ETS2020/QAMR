...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n298_, new_n300_, new_n302_, new_n312_, new_n313_, new_n314_,
  ...
  nor2   g116(.a(new_n224_), .b(new_n237_), .O(new_n276_));
  nand3  g117(.a(x83), .b(x81), .c(x42), .O(new_n277_));
  oai21  g118(.a(new_n276_), .b(x81), .c(new_n277_), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n241_), .O(new_n279_));
  oai22  g120(.a(new_n276_), .b(new_n240_), .c(new_n260_), .d(new_n237_), .O(new_n280_));
  nand2  g121(.a(new_n280_), .b(new_n238_), .O(new_n281_));
  ...
  nand4  g129(.a(new_n282_), .b(x78), .c(x77), .d(x56), .O(new_n289_));
  ...
  nand4  g135(.a(new_n282_), .b(x78), .c(x77), .d(x62), .O(new_n298_));
  ...
  inv1   g141(.a(x84), .O(new_n312_));
  nor2   g142(.a(x04), .b(x01), .O(new_n313_));
  nand4  g143(.a(new_n313_), .b(x79), .c(x78), .d(x77), .O(new_n314_));
  nor2   g144(.a(new_n314_), .b(x80), .O(new_n315_));
  nand2  g145(.a(new_n315_), .b(new_n240_), .O(new_n316_));
  nor4   g146(.a(new_n316_), .b(new_n312_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g147(.a(new_n233_), .b(x76), .O(new_n318_));
  inv1   g148(.a(new_n165_), .O(new_n319_));
  xnor2a g149(.a(x84), .b(x81), .O(new_n320_));
  aoi21  g150(.a(new_n167_), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g151(.a(new_n321_), .b(new_n153_), .O(new_n322_));
  nand2  g152(.a(new_n322_), .b(new_n318_), .O(new_n323_));
  nand2  g153(.a(new_n323_), .b(x79), .O(new_n324_));
  nand4  g154(.a(new_n324_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g155(.a(x02), .O(new_n326_));
  nand4  g156(.a(x03), .b(new_n326_), .c(new_n153_), .d(x00), .O(new_n327_));
  inv1   g157(.a(new_n327_), .O(z57));
  nand4  g158(.a(x80), .b(new_n222_), .c(x43), .d(new_n237_), .O(new_n329_));
  oai22  g159(.a(new_n329_), .b(new_n225_), .c(new_n237_), .d(x40), .O(new_n330_));
  nand4  g160(.a(new_n330_), .b(x79), .c(x78), .d(x04), .O(new_n331_));
  nor2   g161(.a(x79), .b(x78), .O(new_n332_));
  nand3  g162(.a(new_n332_), .b(new_n237_), .c(x40), .O(new_n333_));
  nand2  g163(.a(new_n333_), .b(new_n331_), .O(new_n334_));
  nand2  g164(.a(new_n334_), .b(x77), .O(new_n335_));
  oai21  g165(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n336_));
  aoi21  g166(.a(new_n336_), .b(new_n335_), .c(x01), .O(z58));
  nor2   g167(.a(new_n160_), .b(new_n231_), .O(new_n338_));
  oai21  g168(.a(new_n338_), .b(new_n332_), .c(x40), .O(new_n339_));
  oai21  g169(.a(new_n225_), .b(new_n223_), .c(new_n237_), .O(new_n340_));
  nand2  g170(.a(new_n340_), .b(x79), .O(new_n341_));
  nand3  g171(.a(new_n341_), .b(x78), .c(x04), .O(new_n342_));
  nand2  g172(.a(new_n342_), .b(new_n339_), .O(new_n343_));
  nand2  g173(.a(new_n343_), .b(x77), .O(new_n344_));
  nand2  g174(.a(new_n154_), .b(new_n231_), .O(new_n345_));
  aoi21  g175(.a(new_n345_), .b(new_n344_), .c(x01), .O(z59));
  nand2  g176(.a(new_n321_), .b(x79), .O(new_n347_));
  nand3  g177(.a(new_n347_), .b(new_n345_), .c(new_n228_), .O(new_n348_));
  and2   g178(.a(new_n348_), .b(new_n153_), .O(z60));
  nand2  g179(.a(new_n167_), .b(new_n319_), .O(new_n350_));
  nand2  g180(.a(new_n350_), .b(new_n220_), .O(new_n351_));
  oai21  g181(.a(new_n233_), .b(x04), .c(new_n351_), .O(new_n352_));
  nand4  g182(.a(new_n352_), .b(x80), .c(x79), .d(new_n153_), .O(new_n353_));
  inv1   g183(.a(new_n353_), .O(z61));
  nand2  g184(.a(new_n154_), .b(x04), .O(new_n355_));
  nand3  g185(.a(x84), .b(x81), .c(x79), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n355_), .c(x77), .O(new_n357_));
  nand2  g187(.a(new_n341_), .b(x04), .O(new_n358_));
  nand3  g188(.a(x81), .b(x79), .c(new_n231_), .O(new_n359_));
  aoi21  g189(.a(new_n359_), .b(new_n358_), .c(new_n159_), .O(new_n360_));
  oai21  g190(.a(new_n360_), .b(new_n357_), .c(x78), .O(new_n361_));
  or2    g191(.a(new_n356_), .b(new_n167_), .O(new_n362_));
  aoi21  g192(.a(new_n362_), .b(new_n361_), .c(x01), .O(z62));
  nand4  g193(.a(new_n352_), .b(x82), .c(x79), .d(new_n153_), .O(new_n364_));
  inv1   g194(.a(new_n364_), .O(z63));
  nand3  g195(.a(new_n352_), .b(x83), .c(x79), .O(new_n366_));
  nand4  g196(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n367_));
  aoi21  g197(.a(new_n367_), .b(new_n366_), .c(x01), .O(z64));
  nor2   g198(.a(new_n160_), .b(x04), .O(new_n369_));
  nor2   g199(.a(new_n240_), .b(x78), .O(new_n370_));
  oai21  g200(.a(new_n370_), .b(new_n369_), .c(x77), .O(new_n371_));
  nand3  g201(.a(x81), .b(x78), .c(new_n159_), .O(new_n372_));
  nand2  g202(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  nand4  g203(.a(new_n373_), .b(x84), .c(x79), .d(new_n153_), .O(new_n374_));
  inv1   g204(.a(new_n374_), .O(z65));
  zero   g205(.O(z05));
  zero   g206(.O(z09));
  zero   g207(.O(z14));
  zero   g208(.O(z19));
