...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n177_, new_n178_, new_n183_, new_n184_, new_n187_, new_n188_,
    ...
    new_n272_, new_n275_, new_n277_, new_n279_, new_n281_, new_n284_,
  ...
  inv1   g044(.a(x41), .O(new_n206_));
  xor2a  g045(.a(x84), .b(x81), .O(new_n207_));
  inv1   g046(.a(new_n207_), .O(new_n208_));
  nand4  g047(.a(new_n208_), .b(new_n168_), .c(x79), .d(new_n206_), .O(new_n209_));
  ...
  inv1   g056(.a(x04), .O(new_n219_));
  nor2   g057(.a(new_n160_), .b(new_n159_), .O(new_n220_));
  inv1   g058(.a(new_n220_), .O(new_n221_));
  aoi21  g059(.a(new_n221_), .b(x79), .c(x43), .O(new_n222_));
  nand3  g060(.a(new_n222_), .b(x05), .c(new_n219_), .O(new_n223_));
  nor2   g061(.a(new_n223_), .b(x01), .O(z24));
  inv1   g062(.a(x42), .O(new_n225_));
  xnor2a g063(.a(x84), .b(x82), .O(new_n226_));
  nand2  g064(.a(new_n226_), .b(x81), .O(new_n227_));
  inv1   g065(.a(x81), .O(new_n228_));
  xor2a  g066(.a(x84), .b(x82), .O(new_n229_));
  nand2  g067(.a(new_n229_), .b(new_n228_), .O(new_n230_));
  nand2  g068(.a(new_n230_), .b(new_n227_), .O(new_n231_));
  nand4  g069(.a(new_n231_), .b(x79), .c(x78), .d(x77), .O(new_n232_));
  inv1   g070(.a(new_n232_), .O(new_n233_));
  nand4  g071(.a(new_n233_), .b(new_n225_), .c(x05), .d(new_n219_), .O(new_n234_));
  nor2   g072(.a(new_n234_), .b(x01), .O(z25));
  nand4  g073(.a(new_n233_), .b(x46), .c(new_n225_), .d(new_n219_), .O(new_n238_));
  nor2   g074(.a(new_n238_), .b(x01), .O(z28));
  nand4  g075(.a(new_n233_), .b(x48), .c(new_n225_), .d(new_n219_), .O(new_n241_));
  nor2   g076(.a(new_n241_), .b(x01), .O(z30));
  nand4  g077(.a(new_n233_), .b(x49), .c(new_n225_), .d(new_n219_), .O(new_n243_));
  nor2   g078(.a(new_n243_), .b(x01), .O(z31));
  nand4  g079(.a(new_n233_), .b(x50), .c(new_n225_), .d(new_n219_), .O(new_n245_));
  nor2   g080(.a(new_n245_), .b(x01), .O(z32));
  nand2  g081(.a(x83), .b(new_n228_), .O(new_n247_));
  ...
  nand3  g085(.a(x81), .b(x51), .c(new_n225_), .O(new_n251_));
  nand2  g086(.a(new_n251_), .b(new_n250_), .O(new_n252_));
  nand2  g087(.a(new_n252_), .b(new_n226_), .O(new_n253_));
  xnor2a g088(.a(x83), .b(x81), .O(new_n254_));
  nand3  g089(.a(new_n254_), .b(x42), .c(x05), .O(new_n255_));
  nand3  g090(.a(new_n228_), .b(x51), .c(new_n225_), .O(new_n256_));
  nand2  g091(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand2  g092(.a(new_n257_), .b(new_n229_), .O(new_n258_));
  aoi21  g093(.a(new_n258_), .b(new_n253_), .c(new_n154_), .O(new_n259_));
  nand4  g094(.a(new_n259_), .b(x78), .c(x77), .d(new_n219_), .O(new_n260_));
  nor2   g095(.a(new_n260_), .b(x01), .O(z33));
  nor2   g096(.a(new_n212_), .b(new_n225_), .O(new_n263_));
  nand3  g097(.a(x83), .b(x81), .c(x42), .O(new_n264_));
  oai21  g098(.a(new_n263_), .b(x81), .c(new_n264_), .O(new_n265_));
  nand2  g099(.a(new_n265_), .b(new_n229_), .O(new_n266_));
  oai22  g100(.a(new_n263_), .b(new_n228_), .c(new_n247_), .d(new_n225_), .O(new_n267_));
  nand2  g101(.a(new_n267_), .b(new_n226_), .O(new_n268_));
  aoi21  g102(.a(new_n268_), .b(new_n266_), .c(new_n154_), .O(new_n269_));
  nand4  g103(.a(new_n269_), .b(x78), .c(x77), .d(x53), .O(new_n270_));
  nor3   g104(.a(new_n270_), .b(x04), .c(x01), .O(z35));
  nand4  g105(.a(new_n269_), .b(x78), .c(x77), .d(x54), .O(new_n272_));
  nor3   g106(.a(new_n272_), .b(x04), .c(x01), .O(z36));
  nand4  g107(.a(new_n269_), .b(x78), .c(x77), .d(x56), .O(new_n275_));
  nor3   g108(.a(new_n275_), .b(x04), .c(x01), .O(z38));
  nand4  g109(.a(new_n269_), .b(x78), .c(x77), .d(x57), .O(new_n277_));
  nor3   g110(.a(new_n277_), .b(x04), .c(x01), .O(z39));
  nand4  g111(.a(new_n269_), .b(x78), .c(x77), .d(x58), .O(new_n279_));
  nor3   g112(.a(new_n279_), .b(x04), .c(x01), .O(z40));
  nand4  g113(.a(new_n269_), .b(x78), .c(x77), .d(x59), .O(new_n281_));
  nor3   g114(.a(new_n281_), .b(x04), .c(x01), .O(z41));
  nand4  g115(.a(new_n269_), .b(x78), .c(x77), .d(x61), .O(new_n284_));
  nor3   g116(.a(new_n284_), .b(x04), .c(x01), .O(z43));
  nand4  g117(.a(new_n269_), .b(x78), .c(x77), .d(x63), .O(new_n287_));
  nor3   g118(.a(new_n287_), .b(x04), .c(x01), .O(z45));
  nand4  g119(.a(new_n269_), .b(x78), .c(x77), .d(x64), .O(new_n289_));
  nor3   g120(.a(new_n289_), .b(x04), .c(x01), .O(z46));
  ...
  nand4  g125(.a(new_n294_), .b(x78), .c(new_n159_), .d(x04), .O(new_n295_));
  nor2   g126(.a(x75), .b(x67), .O(new_n296_));
  nor2   g127(.a(new_n296_), .b(new_n207_), .O(new_n297_));
  nand4  g128(.a(new_n297_), .b(x79), .c(new_n160_), .d(x77), .O(new_n298_));
  ...
  nand2  g134(.a(new_n310_), .b(new_n228_), .O(new_n311_));
  nor4   g135(.a(new_n311_), .b(new_n307_), .c(new_n212_), .d(x82), .O(z55));
  nand2  g136(.a(new_n221_), .b(x76), .O(new_n313_));
  ...
  nand4  g144(.a(x80), .b(new_n210_), .c(x43), .d(new_n225_), .O(new_n322_));
  oai22  g145(.a(new_n322_), .b(new_n213_), .c(new_n225_), .d(x40), .O(new_n323_));
  nand4  g146(.a(new_n323_), .b(x79), .c(x78), .d(x04), .O(new_n324_));
  nor2   g147(.a(x79), .b(x78), .O(new_n325_));
  nand3  g148(.a(new_n325_), .b(new_n225_), .c(x40), .O(new_n326_));
  nand2  g149(.a(new_n326_), .b(new_n324_), .O(new_n327_));
  nand2  g150(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g151(.a(new_n165_), .b(new_n219_), .c(new_n154_), .O(new_n329_));
  aoi21  g152(.a(new_n329_), .b(new_n328_), .c(x01), .O(z58));
  nor2   g153(.a(new_n160_), .b(new_n219_), .O(new_n331_));
  oai21  g154(.a(new_n331_), .b(new_n325_), .c(x40), .O(new_n332_));
  oai21  g155(.a(new_n213_), .b(new_n211_), .c(new_n225_), .O(new_n333_));
  ...
  nand2  g160(.a(new_n154_), .b(new_n219_), .O(new_n338_));
  aoi21  g161(.a(new_n338_), .b(new_n337_), .c(x01), .O(z59));
  nand2  g162(.a(new_n316_), .b(x79), .O(new_n340_));
  nand3  g163(.a(new_n340_), .b(new_n338_), .c(new_n216_), .O(new_n341_));
  and2   g164(.a(new_n341_), .b(new_n153_), .O(z60));
  nand2  g165(.a(new_n167_), .b(new_n314_), .O(new_n343_));
  nand2  g166(.a(new_n343_), .b(new_n208_), .O(new_n344_));
  oai21  g167(.a(new_n221_), .b(x04), .c(new_n344_), .O(new_n345_));
  ...
  nand3  g174(.a(x81), .b(x79), .c(new_n219_), .O(new_n352_));
  ...
  nor2   g185(.a(new_n228_), .b(x78), .O(new_n363_));
