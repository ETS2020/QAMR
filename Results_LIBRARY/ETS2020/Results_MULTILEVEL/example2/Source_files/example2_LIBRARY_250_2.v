...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n293_, new_n295_, new_n297_, new_n301_, new_n304_, new_n306_,
  ...
  nand4  g101(.a(new_n249_), .b(x49), .c(new_n241_), .d(new_n233_), .O(new_n259_));
  nor2   g102(.a(new_n259_), .b(x01), .O(z31));
  nand4  g103(.a(new_n249_), .b(x50), .c(new_n241_), .d(new_n233_), .O(new_n261_));
  ...
  nor2   g120(.a(new_n227_), .b(new_n241_), .O(new_n278_));
  ...
  nand4  g133(.a(new_n284_), .b(x78), .c(x77), .d(x57), .O(new_n293_));
  ...
  nand4  g139(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n301_));
  nor3   g140(.a(new_n301_), .b(x04), .c(x01), .O(z44));
  nand4  g141(.a(new_n284_), .b(x78), .c(x77), .d(x64), .O(new_n304_));
  ...
  nand2  g199(.a(new_n361_), .b(new_n244_), .O(new_n362_));
  nor4   g200(.a(new_n362_), .b(new_n358_), .c(new_n227_), .d(x82), .O(z55));
  nand2  g201(.a(new_n237_), .b(x76), .O(new_n364_));
  ...
  nand4  g209(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n373_));
  oai22  g210(.a(new_n373_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n374_));
  nand4  g211(.a(new_n374_), .b(x79), .c(x78), .d(x04), .O(new_n375_));
  nor2   g212(.a(x79), .b(x78), .O(new_n376_));
  nand3  g213(.a(new_n376_), .b(new_n241_), .c(x40), .O(new_n377_));
  ...
  oai21  g220(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n384_));
  ...
  nand2  g227(.a(new_n367_), .b(x79), .O(new_n391_));
  nand3  g228(.a(new_n391_), .b(new_n389_), .c(new_n231_), .O(new_n392_));
  and2   g229(.a(new_n392_), .b(new_n153_), .O(z60));
  nand2  g230(.a(new_n167_), .b(new_n365_), .O(new_n394_));
  nand2  g231(.a(new_n394_), .b(new_n223_), .O(new_n395_));
  oai21  g232(.a(new_n237_), .b(x04), .c(new_n395_), .O(new_n396_));
  ...
  nor2   g250(.a(new_n244_), .b(x78), .O(new_n414_));
