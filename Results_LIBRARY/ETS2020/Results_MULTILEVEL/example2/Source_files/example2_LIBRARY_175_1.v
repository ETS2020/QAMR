...
module FAU ( 
  ...
  nor2   g093(.a(new_n220_), .b(new_n247_), .O(new_n261_));
  nand3  g094(.a(x83), .b(x81), .c(x42), .O(new_n262_));
  oai21  g095(.a(new_n261_), .b(x81), .c(new_n262_), .O(new_n263_));
  nand2  g096(.a(new_n263_), .b(new_n251_), .O(new_n264_));
  oai22  g097(.a(new_n261_), .b(new_n242_), .c(new_n243_), .d(new_n247_), .O(new_n265_));
  nand2  g098(.a(new_n265_), .b(new_n241_), .O(new_n266_));
  aoi21  g099(.a(new_n266_), .b(new_n264_), .c(new_n154_), .O(new_n267_));
  nand4  g100(.a(new_n267_), .b(x78), .c(x77), .d(x53), .O(new_n268_));
  nor3   g101(.a(new_n268_), .b(x04), .c(x01), .O(z35));
  nand4  g102(.a(new_n267_), .b(x78), .c(x77), .d(x54), .O(new_n270_));
  nor3   g103(.a(new_n270_), .b(x04), .c(x01), .O(z36));
  nand4  g104(.a(new_n267_), .b(x78), .c(x77), .d(x55), .O(new_n272_));
  nor3   g105(.a(new_n272_), .b(x04), .c(x01), .O(z37));
  nand4  g106(.a(new_n267_), .b(x78), .c(x77), .d(x56), .O(new_n274_));
  nor3   g107(.a(new_n274_), .b(x04), .c(x01), .O(z38));
  nand4  g108(.a(new_n267_), .b(x78), .c(x77), .d(x57), .O(new_n276_));
  nor3   g109(.a(new_n276_), .b(x04), .c(x01), .O(z39));
  nand4  g110(.a(new_n267_), .b(x78), .c(x77), .d(x59), .O(new_n279_));
  nor3   g111(.a(new_n279_), .b(x04), .c(x01), .O(z41));
  nand4  g112(.a(new_n267_), .b(x78), .c(x77), .d(x60), .O(new_n281_));
  nor3   g113(.a(new_n281_), .b(x04), .c(x01), .O(z42));
  nand4  g114(.a(new_n267_), .b(x78), .c(x77), .d(x61), .O(new_n283_));
  nor3   g115(.a(new_n283_), .b(x04), .c(x01), .O(z43));
  nand4  g116(.a(new_n267_), .b(x78), .c(x77), .d(x63), .O(new_n286_));
  ...
  nor2   g124(.a(new_n294_), .b(new_n215_), .O(new_n295_));
  ...
  nand2  g131(.a(new_n308_), .b(new_n242_), .O(new_n309_));
  nor4   g132(.a(new_n309_), .b(new_n305_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g133(.a(new_n229_), .b(x76), .O(new_n311_));
  inv1   g134(.a(new_n165_), .O(new_n312_));
  xnor2a g135(.a(x84), .b(x81), .O(new_n313_));
  aoi21  g136(.a(new_n167_), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  ...
  nand4  g144(.a(x80), .b(new_n218_), .c(x43), .d(new_n247_), .O(new_n322_));
  oai22  g145(.a(new_n322_), .b(new_n221_), .c(new_n247_), .d(x40), .O(new_n323_));
  nand4  g146(.a(new_n323_), .b(x79), .c(x78), .d(x04), .O(new_n324_));
  nor2   g147(.a(x79), .b(x78), .O(new_n325_));
  nand3  g148(.a(new_n325_), .b(new_n247_), .c(x40), .O(new_n326_));
  nand2  g149(.a(new_n326_), .b(new_n324_), .O(new_n327_));
  nand2  g150(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g151(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n329_));
  aoi21  g152(.a(new_n329_), .b(new_n328_), .c(x01), .O(z58));
  nor2   g153(.a(new_n160_), .b(new_n227_), .O(new_n331_));
  oai21  g154(.a(new_n331_), .b(new_n325_), .c(x40), .O(new_n332_));
  oai21  g155(.a(new_n221_), .b(new_n219_), .c(new_n247_), .O(new_n333_));
  ...
  nand2  g160(.a(new_n154_), .b(new_n227_), .O(new_n338_));
  aoi21  g161(.a(new_n338_), .b(new_n337_), .c(x01), .O(z59));
  nand2  g162(.a(new_n314_), .b(x79), .O(new_n340_));
  nand3  g163(.a(new_n340_), .b(new_n338_), .c(new_n224_), .O(new_n341_));
  and2   g164(.a(new_n341_), .b(new_n153_), .O(z60));
  nand2  g165(.a(new_n167_), .b(new_n312_), .O(new_n343_));
  nand2  g166(.a(new_n343_), .b(new_n216_), .O(new_n344_));
  oai21  g167(.a(new_n229_), .b(x04), .c(new_n344_), .O(new_n345_));
  ...
  nor2   g184(.a(new_n160_), .b(x04), .O(new_n362_));
  nor2   g185(.a(new_n242_), .b(x78), .O(new_n363_));
  oai21  g186(.a(new_n363_), .b(new_n362_), .c(x77), .O(new_n364_));
  nand3  g187(.a(x81), .b(x78), .c(new_n159_), .O(new_n365_));
  nand2  g188(.a(new_n365_), .b(new_n364_), .O(new_n366_));
  nand4  g189(.a(new_n366_), .b(x84), .c(x79), .d(new_n153_), .O(new_n367_));
