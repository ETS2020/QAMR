...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n174_, new_n175_, new_n180_, new_n181_, new_n183_, new_n184_,
    new_n186_, new_n187_, new_n189_, new_n190_, new_n192_, new_n193_,
    new_n195_, new_n196_, new_n201_, new_n202_, new_n207_, new_n208_,
    ...
    new_n242_, new_n244_, new_n247_, new_n251_, new_n253_, new_n255_,
  ...
  nand4  g055(.a(new_n215_), .b(x47), .c(new_n207_), .d(new_n201_), .O(new_n220_));
  nor2   g056(.a(new_n220_), .b(x01), .O(z29));
  nand4  g057(.a(new_n215_), .b(x48), .c(new_n207_), .d(new_n201_), .O(new_n222_));
  nor2   g058(.a(new_n222_), .b(x01), .O(z30));
  nand4  g059(.a(new_n215_), .b(x49), .c(new_n207_), .d(new_n201_), .O(new_n224_));
  nor2   g060(.a(new_n224_), .b(x01), .O(z31));
  nand4  g061(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n201_), .O(new_n226_));
  nor2   g062(.a(new_n226_), .b(x01), .O(z32));
  aoi21  g063(.a(x83), .b(x42), .c(x81), .O(new_n230_));
  nand3  g064(.a(x83), .b(x81), .c(x42), .O(new_n231_));
  inv1   g065(.a(new_n231_), .O(new_n232_));
  oai21  g066(.a(new_n232_), .b(new_n230_), .c(new_n211_), .O(new_n233_));
  nand2  g067(.a(x83), .b(x42), .O(new_n234_));
  nand2  g068(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g069(.a(x83), .b(new_n210_), .c(x42), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(new_n208_), .O(new_n238_));
  aoi21  g072(.a(new_n238_), .b(new_n233_), .c(new_n156_), .O(new_n239_));
  nand4  g073(.a(new_n239_), .b(x78), .c(x77), .d(x53), .O(new_n240_));
  nor3   g074(.a(new_n240_), .b(x04), .c(x01), .O(z35));
  nand4  g075(.a(new_n239_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g076(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g077(.a(new_n239_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g078(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g079(.a(new_n239_), .b(x78), .c(x77), .d(x57), .O(new_n247_));
  nor3   g080(.a(new_n247_), .b(x04), .c(x01), .O(z39));
  nand4  g081(.a(new_n239_), .b(x78), .c(x77), .d(x60), .O(new_n251_));
  nor3   g082(.a(new_n251_), .b(x04), .c(x01), .O(z42));
  nand4  g083(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n253_));
  nor3   g084(.a(new_n253_), .b(x04), .c(x01), .O(z43));
  nand4  g085(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n255_));
  nor3   g086(.a(new_n255_), .b(x04), .c(x01), .O(z44));
  nand4  g087(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n257_));
  nor3   g088(.a(new_n257_), .b(x04), .c(x01), .O(z45));
  nand4  g089(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n259_));
  ...
  nor2   g138(.a(new_n268_), .b(x04), .O(new_n319_));
  nor2   g139(.a(new_n210_), .b(x78), .O(new_n320_));
  oai21  g140(.a(new_n320_), .b(new_n319_), .c(x77), .O(new_n321_));
  nand3  g141(.a(x81), .b(x78), .c(new_n262_), .O(new_n322_));
