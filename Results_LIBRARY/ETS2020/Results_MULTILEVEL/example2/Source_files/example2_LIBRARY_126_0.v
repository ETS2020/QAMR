...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n193_, new_n194_, new_n196_, new_n197_, new_n201_, new_n202_,
  ...
  oai21  g072(.a(new_n235_), .b(new_n233_), .c(new_n215_), .O(new_n236_));
  nand2  g073(.a(x83), .b(x42), .O(new_n237_));
  nand2  g074(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g075(.a(x83), .b(new_n214_), .c(x42), .O(new_n239_));
  nand2  g076(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g077(.a(new_n240_), .b(new_n212_), .O(new_n241_));
  ...
  nand4  g089(.a(new_n242_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  nor3   g090(.a(new_n255_), .b(x04), .c(x01), .O(z41));
  nand4  g091(.a(new_n242_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g092(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g093(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g094(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g095(.a(new_n242_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g096(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g097(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g099(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  nor2   g151(.a(new_n274_), .b(x04), .O(new_n327_));
  nor2   g152(.a(new_n214_), .b(x78), .O(new_n328_));
  oai21  g153(.a(new_n328_), .b(new_n327_), .c(x77), .O(new_n329_));
  nand3  g154(.a(x81), .b(x78), .c(new_n268_), .O(new_n330_));
  nand2  g155(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand4  g156(.a(new_n331_), .b(x84), .c(x79), .d(new_n155_), .O(new_n332_));
  inv1   g157(.a(new_n332_), .O(z65));
  zero   g158(.O(z00));
  zero   g159(.O(z01));
  zero   g160(.O(z02));
  zero   g161(.O(z12));
