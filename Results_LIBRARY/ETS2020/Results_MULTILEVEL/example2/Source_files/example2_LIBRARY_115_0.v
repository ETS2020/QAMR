...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n241_, new_n243_, new_n245_, new_n248_, new_n251_, new_n253_,
  ...
  oai21  g065(.a(new_n231_), .b(new_n229_), .c(new_n213_), .O(new_n232_));
  nand2  g066(.a(x83), .b(x42), .O(new_n233_));
  nand2  g067(.a(new_n233_), .b(x81), .O(new_n234_));
  nand3  g068(.a(x83), .b(new_n212_), .c(x42), .O(new_n235_));
  nand2  g069(.a(new_n235_), .b(new_n234_), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(new_n210_), .O(new_n237_));
  ...
  nand4  g082(.a(new_n238_), .b(x78), .c(x77), .d(x59), .O(new_n251_));
  nor3   g083(.a(new_n251_), .b(x04), .c(x01), .O(z41));
