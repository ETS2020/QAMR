...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n254_, new_n256_, new_n259_, new_n261_, new_n264_, new_n265_,
  ...
  nand4  g090(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n259_));
  nor3   g091(.a(new_n259_), .b(x04), .c(x01), .O(z45));
  nand4  g092(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n261_));
