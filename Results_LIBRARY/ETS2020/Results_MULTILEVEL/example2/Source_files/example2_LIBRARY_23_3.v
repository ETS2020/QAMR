...
module FAU ( 
  ...
  nand4  g141(.a(new_n284_), .b(x78), .c(x77), .d(x60), .O(new_n300_));
  nor3   g142(.a(new_n300_), .b(x04), .c(x01), .O(z42));
  nand4  g143(.a(new_n284_), .b(x78), .c(x77), .d(x61), .O(new_n302_));
  nor3   g144(.a(new_n302_), .b(x04), .c(x01), .O(z43));
  nand4  g145(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n304_));
  nor3   g146(.a(new_n304_), .b(x04), .c(x01), .O(z44));
  nand4  g147(.a(new_n284_), .b(x78), .c(x77), .d(x63), .O(new_n306_));
  nor3   g148(.a(new_n306_), .b(x04), .c(x01), .O(z45));
  nand4  g149(.a(new_n284_), .b(x78), .c(x77), .d(x64), .O(new_n308_));
