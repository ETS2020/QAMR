...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n251_, new_n253_, new_n256_, new_n259_, new_n261_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n284_, new_n285_, new_n287_, new_n290_,
    new_n292_, new_n294_, new_n296_, new_n298_, new_n301_, new_n303_,
  ...
  nand4  g101(.a(new_n248_), .b(x49), .c(new_n240_), .d(new_n232_), .O(new_n259_));
  nor2   g102(.a(new_n259_), .b(x01), .O(z31));
  nand4  g103(.a(new_n248_), .b(x50), .c(new_n240_), .d(new_n232_), .O(new_n261_));
  nor2   g104(.a(new_n261_), .b(x01), .O(z32));
  nand2  g105(.a(x83), .b(new_n243_), .O(new_n263_));
  ...
  nand3  g109(.a(x81), .b(x51), .c(new_n240_), .O(new_n267_));
  nand2  g110(.a(new_n267_), .b(new_n266_), .O(new_n268_));
  nand2  g111(.a(new_n268_), .b(new_n241_), .O(new_n269_));
  xnor2a g112(.a(x83), .b(x81), .O(new_n270_));
  nand3  g113(.a(new_n270_), .b(x42), .c(x05), .O(new_n271_));
  nand3  g114(.a(new_n243_), .b(x51), .c(new_n240_), .O(new_n272_));
  nand2  g115(.a(new_n272_), .b(new_n271_), .O(new_n273_));
  nand2  g116(.a(new_n273_), .b(new_n244_), .O(new_n274_));
  aoi21  g117(.a(new_n274_), .b(new_n269_), .c(new_n154_), .O(new_n275_));
  nand4  g118(.a(new_n275_), .b(x78), .c(x77), .d(new_n232_), .O(new_n276_));
  nor2   g119(.a(new_n276_), .b(x01), .O(z33));
  nor2   g120(.a(new_n226_), .b(new_n240_), .O(new_n278_));
  nand3  g121(.a(x83), .b(x81), .c(x42), .O(new_n279_));
  oai21  g122(.a(new_n278_), .b(x81), .c(new_n279_), .O(new_n280_));
  nand2  g123(.a(new_n280_), .b(new_n244_), .O(new_n281_));
  oai22  g124(.a(new_n278_), .b(new_n243_), .c(new_n263_), .d(new_n240_), .O(new_n282_));
  nand2  g125(.a(new_n282_), .b(new_n241_), .O(new_n283_));
  ...
  nand4  g141(.a(new_n284_), .b(x78), .c(x77), .d(x61), .O(new_n301_));
  nor3   g142(.a(new_n301_), .b(x04), .c(x01), .O(z43));
  nand4  g143(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n303_));
  nor3   g144(.a(new_n303_), .b(x04), .c(x01), .O(z44));
  nand4  g145(.a(new_n284_), .b(x78), .c(x77), .d(x63), .O(new_n305_));
  nor3   g146(.a(new_n305_), .b(x04), .c(x01), .O(z45));
  nand4  g147(.a(new_n284_), .b(x78), .c(x77), .d(x64), .O(new_n307_));
