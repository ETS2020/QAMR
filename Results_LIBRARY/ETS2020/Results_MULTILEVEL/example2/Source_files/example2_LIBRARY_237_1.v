...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n244_, new_n247_, new_n250_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n279_, new_n281_, new_n283_, new_n286_, new_n289_,
  ...
  nand4  g087(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n226_), .O(new_n247_));
  nor2   g088(.a(new_n247_), .b(x01), .O(z28));
  nand4  g089(.a(new_n243_), .b(x48), .c(new_n235_), .d(new_n226_), .O(new_n250_));
  nor2   g090(.a(new_n250_), .b(x01), .O(z30));
  nand2  g091(.a(x83), .b(new_n238_), .O(new_n254_));
  ...
  nand3  g095(.a(x81), .b(x51), .c(new_n235_), .O(new_n258_));
  nand2  g096(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g097(.a(new_n259_), .b(new_n236_), .O(new_n260_));
  xnor2a g098(.a(x83), .b(x81), .O(new_n261_));
  nand3  g099(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g100(.a(new_n238_), .b(x51), .c(new_n235_), .O(new_n263_));
  nand2  g101(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  nand2  g102(.a(new_n264_), .b(new_n239_), .O(new_n265_));
  ...
  nor2   g106(.a(new_n220_), .b(new_n235_), .O(new_n269_));
  ...
  oai22  g110(.a(new_n269_), .b(new_n238_), .c(new_n254_), .d(new_n235_), .O(new_n273_));
  ...
  nand4  g115(.a(new_n275_), .b(x78), .c(x77), .d(x54), .O(new_n279_));
  ...
  nand4  g123(.a(new_n275_), .b(x78), .c(x77), .d(x60), .O(new_n289_));
  nor3   g124(.a(new_n289_), .b(x04), .c(x01), .O(z42));
  nand4  g125(.a(new_n275_), .b(x78), .c(x77), .d(x61), .O(new_n291_));
  ...
  nand4  g156(.a(x80), .b(new_n218_), .c(x43), .d(new_n235_), .O(new_n330_));
  oai22  g157(.a(new_n330_), .b(new_n221_), .c(new_n235_), .d(x40), .O(new_n331_));
  nand4  g158(.a(new_n331_), .b(x79), .c(x78), .d(x04), .O(new_n332_));
  nor2   g159(.a(x79), .b(x78), .O(new_n333_));
  nand3  g160(.a(new_n333_), .b(new_n235_), .c(x40), .O(new_n334_));
  nand2  g161(.a(new_n334_), .b(new_n332_), .O(new_n335_));
  nand2  g162(.a(new_n335_), .b(x77), .O(new_n336_));
  oai21  g163(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n337_));
  aoi21  g164(.a(new_n337_), .b(new_n336_), .c(x01), .O(z58));
  nor2   g165(.a(new_n160_), .b(new_n226_), .O(new_n339_));
  oai21  g166(.a(new_n339_), .b(new_n333_), .c(x40), .O(new_n340_));
  oai21  g167(.a(new_n221_), .b(new_n219_), .c(new_n235_), .O(new_n341_));
  ...
  nand2  g172(.a(new_n154_), .b(new_n226_), .O(new_n346_));
  ...
  oai21  g179(.a(new_n230_), .b(x04), .c(new_n352_), .O(new_n353_));
  ...
  nand3  g186(.a(x81), .b(x79), .c(new_n226_), .O(new_n360_));
  ...
  nor2   g197(.a(new_n238_), .b(x78), .O(new_n371_));
