...
module FAU ( 
  ...
  nand4  g155(.a(new_n288_), .b(x78), .c(x77), .d(x63), .O(new_n310_));
  nor3   g156(.a(new_n310_), .b(x04), .c(x01), .O(z45));
  nand4  g157(.a(new_n288_), .b(x78), .c(x77), .d(x64), .O(new_n312_));
  ...
  nor2   g268(.a(new_n160_), .b(x04), .O(new_n423_));
  nor2   g269(.a(new_n245_), .b(x78), .O(new_n424_));
  oai21  g270(.a(new_n424_), .b(new_n423_), .c(x77), .O(new_n425_));
  nand3  g271(.a(x81), .b(x78), .c(new_n159_), .O(new_n426_));
  nand2  g272(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  nand4  g273(.a(new_n427_), .b(x84), .c(x79), .d(new_n153_), .O(new_n428_));
  inv1   g274(.a(new_n428_), .O(z65));
  zero   g275(.O(z11));
  zero   g276(.O(z15));
  zero   g277(.O(z36));
endmodule
