...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n240_, new_n243_, new_n245_, new_n247_, new_n249_, new_n252_,
  ...
  nand4  g076(.a(new_n239_), .b(x78), .c(x77), .d(x54), .O(new_n243_));
  nor3   g077(.a(new_n243_), .b(x04), .c(x01), .O(z36));
  nand4  g078(.a(new_n239_), .b(x78), .c(x77), .d(x55), .O(new_n245_));
  nor3   g079(.a(new_n245_), .b(x04), .c(x01), .O(z37));
  nand4  g080(.a(new_n239_), .b(x78), .c(x77), .d(x56), .O(new_n247_));
  ...
  inv1   g096(.a(x77), .O(new_n264_));
  nand2  g097(.a(x52), .b(x15), .O(new_n265_));
  inv1   g098(.a(x52), .O(new_n266_));
  nand2  g099(.a(new_n266_), .b(x07), .O(new_n267_));
  aoi21  g100(.a(new_n267_), .b(new_n265_), .c(x79), .O(new_n268_));
  nand4  g101(.a(new_n268_), .b(x78), .c(new_n264_), .d(x04), .O(new_n269_));
  inv1   g102(.a(x78), .O(new_n270_));
  xor2a  g103(.a(x84), .b(x81), .O(new_n271_));
  nor2   g104(.a(x75), .b(x67), .O(new_n272_));
  nor2   g105(.a(new_n272_), .b(new_n271_), .O(new_n273_));
  nand4  g106(.a(new_n273_), .b(x79), .c(new_n270_), .d(x77), .O(new_n274_));
  aoi21  g107(.a(new_n274_), .b(new_n269_), .c(x01), .O(z47));
  nand2  g108(.a(x52), .b(x16), .O(new_n276_));
  nand2  g109(.a(new_n266_), .b(x08), .O(new_n277_));
  aoi21  g110(.a(new_n277_), .b(new_n276_), .c(x79), .O(new_n278_));
  nand4  g111(.a(new_n278_), .b(x78), .c(new_n264_), .d(x04), .O(new_n279_));
  nor2   g112(.a(new_n271_), .b(new_n156_), .O(new_n280_));
  nand3  g113(.a(new_n280_), .b(new_n270_), .c(x77), .O(new_n281_));
  inv1   g114(.a(new_n281_), .O(new_n282_));
  nand2  g115(.a(new_n282_), .b(x68), .O(new_n283_));
  aoi21  g116(.a(new_n283_), .b(new_n279_), .c(x01), .O(z48));
  nand2  g117(.a(x52), .b(x17), .O(new_n285_));
  nand2  g118(.a(new_n266_), .b(x09), .O(new_n286_));
  aoi21  g119(.a(new_n286_), .b(new_n285_), .c(x79), .O(new_n287_));
  nand4  g120(.a(new_n287_), .b(x78), .c(new_n264_), .d(x04), .O(new_n288_));
  nand2  g121(.a(new_n282_), .b(x69), .O(new_n289_));
  aoi21  g122(.a(new_n289_), .b(new_n288_), .c(x01), .O(z49));
  nand2  g123(.a(x52), .b(x18), .O(new_n291_));
  nand2  g124(.a(new_n266_), .b(x10), .O(new_n292_));
  aoi21  g125(.a(new_n292_), .b(new_n291_), .c(x79), .O(new_n293_));
  nand4  g126(.a(new_n293_), .b(x78), .c(new_n264_), .d(x04), .O(new_n294_));
  nand2  g127(.a(new_n282_), .b(x70), .O(new_n295_));
  aoi21  g128(.a(new_n295_), .b(new_n294_), .c(x01), .O(z50));
  nand2  g129(.a(x52), .b(x19), .O(new_n297_));
  nand2  g130(.a(new_n266_), .b(x11), .O(new_n298_));
  aoi21  g131(.a(new_n298_), .b(new_n297_), .c(x79), .O(new_n299_));
  nand4  g132(.a(new_n299_), .b(x78), .c(new_n264_), .d(x04), .O(new_n300_));
  nand2  g133(.a(new_n282_), .b(x71), .O(new_n301_));
  aoi21  g134(.a(new_n301_), .b(new_n300_), .c(x01), .O(z51));
  nand2  g135(.a(x52), .b(x20), .O(new_n303_));
  nand2  g136(.a(new_n266_), .b(x12), .O(new_n304_));
  aoi21  g137(.a(new_n304_), .b(new_n303_), .c(x79), .O(new_n305_));
  nand4  g138(.a(new_n305_), .b(x78), .c(new_n264_), .d(x04), .O(new_n306_));
  nand2  g139(.a(new_n282_), .b(x72), .O(new_n307_));
  aoi21  g140(.a(new_n307_), .b(new_n306_), .c(x01), .O(z52));
  nand2  g141(.a(x52), .b(x21), .O(new_n309_));
  nand2  g142(.a(new_n266_), .b(x13), .O(new_n310_));
  aoi21  g143(.a(new_n310_), .b(new_n309_), .c(x79), .O(new_n311_));
  nand4  g144(.a(new_n311_), .b(x78), .c(new_n264_), .d(x04), .O(new_n312_));
  nand2  g145(.a(new_n282_), .b(x73), .O(new_n313_));
  aoi21  g146(.a(new_n313_), .b(new_n312_), .c(x01), .O(z53));
  nand2  g147(.a(x52), .b(x22), .O(new_n315_));
  nand2  g148(.a(new_n266_), .b(x14), .O(new_n316_));
  aoi21  g149(.a(new_n316_), .b(new_n315_), .c(x79), .O(new_n317_));
  nand4  g150(.a(new_n317_), .b(x78), .c(new_n264_), .d(x04), .O(new_n318_));
  nor2   g151(.a(new_n318_), .b(x01), .O(z54));
  nor2   g152(.a(new_n270_), .b(x04), .O(new_n330_));
  nor2   g153(.a(new_n212_), .b(x78), .O(new_n331_));
  oai21  g154(.a(new_n331_), .b(new_n330_), .c(x77), .O(new_n332_));
  nand3  g155(.a(x81), .b(x78), .c(new_n264_), .O(new_n333_));
  nand2  g156(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  nand4  g157(.a(new_n334_), .b(x84), .c(x79), .d(new_n155_), .O(new_n335_));
  inv1   g158(.a(new_n335_), .O(z65));
  zero   g159(.O(z00));
  zero   g160(.O(z01));
  zero   g161(.O(z02));
  zero   g162(.O(z11));
