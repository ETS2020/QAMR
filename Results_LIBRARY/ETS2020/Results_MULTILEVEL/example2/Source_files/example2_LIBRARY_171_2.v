...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n284_, new_n285_, new_n288_, new_n291_,
    new_n293_, new_n295_, new_n297_, new_n299_, new_n302_, new_n304_,
  ...
  nand4  g130(.a(new_n284_), .b(x78), .c(x77), .d(x54), .O(new_n288_));
  nor3   g131(.a(new_n288_), .b(x04), .c(x01), .O(z36));
  nand4  g132(.a(new_n284_), .b(x78), .c(x77), .d(x56), .O(new_n291_));
  ...
  nand4  g140(.a(new_n284_), .b(x78), .c(x77), .d(x60), .O(new_n299_));
  nor3   g141(.a(new_n299_), .b(x04), .c(x01), .O(z42));
