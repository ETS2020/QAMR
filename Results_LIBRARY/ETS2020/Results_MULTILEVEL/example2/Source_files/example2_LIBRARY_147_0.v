...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n307_, new_n308_, new_n321_, new_n322_, new_n323_, new_n324_,
    new_n325_, new_n326_;
  ...
  nand4  g061(.a(new_n219_), .b(x47), .c(new_n211_), .d(new_n205_), .O(new_n224_));
  nor2   g062(.a(new_n224_), .b(x01), .O(z29));
  nand4  g063(.a(new_n219_), .b(x48), .c(new_n211_), .d(new_n205_), .O(new_n226_));
  nor2   g064(.a(new_n226_), .b(x01), .O(z30));
  nand4  g065(.a(new_n219_), .b(x49), .c(new_n211_), .d(new_n205_), .O(new_n228_));
  nor2   g066(.a(new_n228_), .b(x01), .O(z31));
  nand4  g067(.a(new_n219_), .b(x50), .c(new_n211_), .d(new_n205_), .O(new_n230_));
  ...
  aoi21  g078(.a(new_n242_), .b(new_n237_), .c(new_n156_), .O(new_n243_));
  nand4  g079(.a(new_n243_), .b(x78), .c(x77), .d(x53), .O(new_n244_));
  nor3   g080(.a(new_n244_), .b(x04), .c(x01), .O(z35));
  nand4  g081(.a(new_n243_), .b(x78), .c(x77), .d(x54), .O(new_n246_));
  nor3   g082(.a(new_n246_), .b(x04), .c(x01), .O(z36));
  nand4  g083(.a(new_n243_), .b(x78), .c(x77), .d(x55), .O(new_n248_));
  nor3   g084(.a(new_n248_), .b(x04), .c(x01), .O(z37));
  nand4  g085(.a(new_n243_), .b(x78), .c(x77), .d(x56), .O(new_n250_));
  nor3   g086(.a(new_n250_), .b(x04), .c(x01), .O(z38));
  nand4  g087(.a(new_n243_), .b(x78), .c(x77), .d(x57), .O(new_n252_));
  nor3   g088(.a(new_n252_), .b(x04), .c(x01), .O(z39));
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  nor3   g090(.a(new_n255_), .b(x04), .c(x01), .O(z41));
  nand4  g091(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g092(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g093(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g094(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g095(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g096(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g097(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g098(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g099(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  nor2   g143(.a(new_n274_), .b(x04), .O(new_n321_));
  nor2   g144(.a(new_n214_), .b(x78), .O(new_n322_));
  oai21  g145(.a(new_n322_), .b(new_n321_), .c(x77), .O(new_n323_));
  nand3  g146(.a(x81), .b(x78), .c(new_n268_), .O(new_n324_));
  nand2  g147(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand4  g148(.a(new_n325_), .b(x84), .c(x79), .d(new_n155_), .O(new_n326_));
  inv1   g149(.a(new_n326_), .O(z65));
  zero   g150(.O(z00));
  zero   g151(.O(z01));
  zero   g152(.O(z02));
  zero   g153(.O(z12));
