...
module FAU ( 
  ...
  nand4  g119(.a(new_n270_), .b(x78), .c(x77), .d(x62), .O(new_n287_));
  nor3   g120(.a(new_n287_), .b(x04), .c(x01), .O(z44));
  ...
  nand2  g138(.a(new_n312_), .b(new_n230_), .O(new_n313_));
  nor4   g139(.a(new_n313_), .b(new_n309_), .c(new_n214_), .d(x82), .O(z55));
  nand2  g140(.a(new_n223_), .b(x76), .O(new_n315_));
  ...
  nand4  g151(.a(x80), .b(new_n212_), .c(x43), .d(new_n227_), .O(new_n326_));
  oai22  g152(.a(new_n326_), .b(new_n215_), .c(new_n227_), .d(x40), .O(new_n327_));
  nand4  g153(.a(new_n327_), .b(x79), .c(x78), .d(x04), .O(new_n328_));
  nor2   g154(.a(x79), .b(x78), .O(new_n329_));
  nand3  g155(.a(new_n329_), .b(new_n227_), .c(x40), .O(new_n330_));
  nand2  g156(.a(new_n330_), .b(new_n328_), .O(new_n331_));
  nand2  g157(.a(new_n331_), .b(x77), .O(new_n332_));
  oai21  g158(.a(new_n161_), .b(new_n221_), .c(new_n156_), .O(new_n333_));
  aoi21  g159(.a(new_n333_), .b(new_n332_), .c(x01), .O(z58));
  nor2   g160(.a(new_n154_), .b(new_n221_), .O(new_n335_));
  oai21  g161(.a(new_n335_), .b(new_n329_), .c(x40), .O(new_n336_));
  oai21  g162(.a(new_n215_), .b(new_n213_), .c(new_n227_), .O(new_n337_));
  ...
  nand2  g167(.a(new_n156_), .b(new_n221_), .O(new_n342_));
  ...
  oai21  g174(.a(new_n223_), .b(x04), .c(new_n348_), .O(new_n349_));
  ...
  nand3  g181(.a(x81), .b(x79), .c(new_n221_), .O(new_n356_));
