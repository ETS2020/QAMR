// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:35 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n247_, new_n249_, new_n251_, new_n253_, new_n255_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n281_, new_n283_,
    new_n287_, new_n290_, new_n292_, new_n294_, new_n296_, new_n298_,
    new_n301_, new_n302_, new_n303_, new_n304_, new_n305_, new_n306_,
    new_n307_, new_n308_, new_n317_, new_n318_, new_n319_, new_n320_,
  ...
  nand4  g087(.a(new_n242_), .b(x46), .c(new_n234_), .d(new_n226_), .O(new_n247_));
  nor2   g088(.a(new_n247_), .b(x01), .O(z28));
  nand4  g089(.a(new_n242_), .b(x47), .c(new_n234_), .d(new_n226_), .O(new_n249_));
  nor2   g090(.a(new_n249_), .b(x01), .O(z29));
  nand4  g091(.a(new_n242_), .b(x48), .c(new_n234_), .d(new_n226_), .O(new_n251_));
  nor2   g092(.a(new_n251_), .b(x01), .O(z30));
  nand4  g093(.a(new_n242_), .b(x49), .c(new_n234_), .d(new_n226_), .O(new_n253_));
  ...
  nand4  g127(.a(new_n278_), .b(x78), .c(x77), .d(x59), .O(new_n290_));
  nor3   g128(.a(new_n290_), .b(x04), .c(x01), .O(z41));
  nand4  g129(.a(new_n278_), .b(x78), .c(x77), .d(x60), .O(new_n292_));
  nor3   g130(.a(new_n292_), .b(x04), .c(x01), .O(z42));
  nand4  g131(.a(new_n278_), .b(x78), .c(x77), .d(x61), .O(new_n294_));
  nor3   g132(.a(new_n294_), .b(x04), .c(x01), .O(z43));
  nand4  g133(.a(new_n278_), .b(x78), .c(x77), .d(x62), .O(new_n296_));
  nor3   g134(.a(new_n296_), .b(x04), .c(x01), .O(z44));
  nand4  g135(.a(new_n278_), .b(x78), .c(x77), .d(x63), .O(new_n298_));
  nor3   g136(.a(new_n298_), .b(x04), .c(x01), .O(z45));
  ...
  nor2   g143(.a(new_n306_), .b(new_n215_), .O(new_n307_));
  nand4  g144(.a(new_n307_), .b(x79), .c(new_n160_), .d(x77), .O(new_n308_));
  aoi21  g145(.a(new_n308_), .b(new_n305_), .c(x01), .O(z47));
  inv1   g146(.a(x84), .O(new_n317_));
  nor2   g147(.a(x04), .b(x01), .O(new_n318_));
  nand4  g148(.a(new_n318_), .b(x79), .c(x78), .d(x77), .O(new_n319_));
  nor2   g149(.a(new_n319_), .b(x80), .O(new_n320_));
  nand2  g150(.a(new_n320_), .b(new_n237_), .O(new_n321_));
  nor4   g151(.a(new_n321_), .b(new_n317_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g152(.a(new_n230_), .b(x76), .O(new_n323_));
  inv1   g153(.a(new_n165_), .O(new_n324_));
  xnor2a g154(.a(x84), .b(x81), .O(new_n325_));
  aoi21  g155(.a(new_n167_), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g156(.a(new_n326_), .b(new_n153_), .O(new_n327_));
  nand2  g157(.a(new_n327_), .b(new_n323_), .O(new_n328_));
  nand2  g158(.a(new_n328_), .b(x79), .O(new_n329_));
  nand4  g159(.a(new_n329_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g160(.a(x80), .b(new_n218_), .c(x43), .d(new_n234_), .O(new_n332_));
  oai22  g161(.a(new_n332_), .b(new_n221_), .c(new_n234_), .d(x40), .O(new_n333_));
  nand4  g162(.a(new_n333_), .b(x79), .c(x78), .d(x04), .O(new_n334_));
  nor2   g163(.a(x79), .b(x78), .O(new_n335_));
  nand3  g164(.a(new_n335_), .b(new_n234_), .c(x40), .O(new_n336_));
  nand2  g165(.a(new_n336_), .b(new_n334_), .O(new_n337_));
  nand2  g166(.a(new_n337_), .b(x77), .O(new_n338_));
  oai21  g167(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n339_));
  aoi21  g168(.a(new_n339_), .b(new_n338_), .c(x01), .O(z58));
  nor2   g169(.a(new_n160_), .b(new_n226_), .O(new_n341_));
  oai21  g170(.a(new_n341_), .b(new_n335_), .c(x40), .O(new_n342_));
  oai21  g171(.a(new_n221_), .b(new_n219_), .c(new_n234_), .O(new_n343_));
  nand2  g172(.a(new_n343_), .b(x79), .O(new_n344_));
  nand3  g173(.a(new_n344_), .b(x78), .c(x04), .O(new_n345_));
  nand2  g174(.a(new_n345_), .b(new_n342_), .O(new_n346_));
  nand2  g175(.a(new_n346_), .b(x77), .O(new_n347_));
  nand2  g176(.a(new_n154_), .b(new_n226_), .O(new_n348_));
  aoi21  g177(.a(new_n348_), .b(new_n347_), .c(x01), .O(z59));
  nand2  g178(.a(new_n326_), .b(x79), .O(new_n350_));
  nand3  g179(.a(new_n350_), .b(new_n348_), .c(new_n224_), .O(new_n351_));
  and2   g180(.a(new_n351_), .b(new_n153_), .O(z60));
  nand2  g181(.a(new_n167_), .b(new_n324_), .O(new_n353_));
  nand2  g182(.a(new_n353_), .b(new_n216_), .O(new_n354_));
  oai21  g183(.a(new_n230_), .b(x04), .c(new_n354_), .O(new_n355_));
  nand4  g184(.a(new_n355_), .b(x80), .c(x79), .d(new_n153_), .O(new_n356_));
  inv1   g185(.a(new_n356_), .O(z61));
  nand2  g186(.a(new_n154_), .b(x04), .O(new_n358_));
  nand3  g187(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  aoi21  g188(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand2  g189(.a(new_n344_), .b(x04), .O(new_n361_));
  nand3  g190(.a(x81), .b(x79), .c(new_n226_), .O(new_n362_));
  aoi21  g191(.a(new_n362_), .b(new_n361_), .c(new_n159_), .O(new_n363_));
  oai21  g192(.a(new_n363_), .b(new_n360_), .c(x78), .O(new_n364_));
  or2    g193(.a(new_n359_), .b(new_n167_), .O(new_n365_));
  aoi21  g194(.a(new_n365_), .b(new_n364_), .c(x01), .O(z62));
  nand4  g195(.a(new_n355_), .b(x82), .c(x79), .d(new_n153_), .O(new_n367_));
  inv1   g196(.a(new_n367_), .O(z63));
  nand3  g197(.a(new_n355_), .b(x83), .c(x79), .O(new_n369_));
  nand4  g198(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n370_));
  aoi21  g199(.a(new_n370_), .b(new_n369_), .c(x01), .O(z64));
  nor2   g200(.a(new_n160_), .b(x04), .O(new_n372_));
  nor2   g201(.a(new_n237_), .b(x78), .O(new_n373_));
  oai21  g202(.a(new_n373_), .b(new_n372_), .c(x77), .O(new_n374_));
  nand3  g203(.a(x81), .b(x78), .c(new_n159_), .O(new_n375_));
  nand2  g204(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand4  g205(.a(new_n376_), .b(x84), .c(x79), .d(new_n153_), .O(new_n377_));
  inv1   g206(.a(new_n377_), .O(z65));
  zero   g207(.O(z05));
  zero   g208(.O(z08));
  zero   g209(.O(z09));
  zero   g210(.O(z14));
