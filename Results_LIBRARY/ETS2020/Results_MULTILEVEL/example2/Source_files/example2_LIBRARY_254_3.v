...
module FAU ( 
  ...
  nand4  g164(.a(new_n222_), .b(x79), .c(new_n160_), .d(x77), .O(new_n324_));
  ...
  nand2  g201(.a(new_n360_), .b(new_n243_), .O(new_n361_));
  nor4   g202(.a(new_n361_), .b(new_n357_), .c(new_n226_), .d(x82), .O(z55));
  nand2  g203(.a(new_n236_), .b(x76), .O(new_n363_));
  ...
  nand4  g214(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n374_));
  oai22  g215(.a(new_n374_), .b(new_n227_), .c(new_n240_), .d(x40), .O(new_n375_));
  nand4  g216(.a(new_n375_), .b(x79), .c(x78), .d(x04), .O(new_n376_));
  nor2   g217(.a(x79), .b(x78), .O(new_n377_));
  nand3  g218(.a(new_n377_), .b(new_n240_), .c(x40), .O(new_n378_));
  nand2  g219(.a(new_n378_), .b(new_n376_), .O(new_n379_));
  nand2  g220(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g221(.a(new_n165_), .b(new_n232_), .c(new_n154_), .O(new_n381_));
  aoi21  g222(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  nor2   g223(.a(new_n160_), .b(new_n232_), .O(new_n383_));
  oai21  g224(.a(new_n383_), .b(new_n377_), .c(x40), .O(new_n384_));
  oai21  g225(.a(new_n227_), .b(new_n225_), .c(new_n240_), .O(new_n385_));
  nand2  g226(.a(new_n385_), .b(x79), .O(new_n386_));
  nand3  g227(.a(new_n386_), .b(x78), .c(x04), .O(new_n387_));
  nand2  g228(.a(new_n387_), .b(new_n384_), .O(new_n388_));
  nand2  g229(.a(new_n388_), .b(x77), .O(new_n389_));
  nand2  g230(.a(new_n154_), .b(new_n232_), .O(new_n390_));
  aoi21  g231(.a(new_n390_), .b(new_n389_), .c(x01), .O(z59));
  nand2  g232(.a(new_n366_), .b(x79), .O(new_n392_));
  nand3  g233(.a(new_n392_), .b(new_n390_), .c(new_n230_), .O(new_n393_));
  and2   g234(.a(new_n393_), .b(new_n153_), .O(z60));
  nand2  g235(.a(new_n167_), .b(new_n364_), .O(new_n395_));
  nand2  g236(.a(new_n395_), .b(new_n222_), .O(new_n396_));
  oai21  g237(.a(new_n236_), .b(x04), .c(new_n396_), .O(new_n397_));
  nand4  g238(.a(new_n397_), .b(x80), .c(x79), .d(new_n153_), .O(new_n398_));
  inv1   g239(.a(new_n398_), .O(z61));
  nand2  g240(.a(new_n154_), .b(x04), .O(new_n400_));
  nand3  g241(.a(x84), .b(x81), .c(x79), .O(new_n401_));
  aoi21  g242(.a(new_n401_), .b(new_n400_), .c(x77), .O(new_n402_));
  nand2  g243(.a(new_n386_), .b(x04), .O(new_n403_));
  nand3  g244(.a(x81), .b(x79), .c(new_n232_), .O(new_n404_));
  aoi21  g245(.a(new_n404_), .b(new_n403_), .c(new_n159_), .O(new_n405_));
  oai21  g246(.a(new_n405_), .b(new_n402_), .c(x78), .O(new_n406_));
  or2    g247(.a(new_n401_), .b(new_n167_), .O(new_n407_));
  aoi21  g248(.a(new_n407_), .b(new_n406_), .c(x01), .O(z62));
  nand4  g249(.a(new_n397_), .b(x82), .c(x79), .d(new_n153_), .O(new_n409_));
  inv1   g250(.a(new_n409_), .O(z63));
  nand3  g251(.a(new_n397_), .b(x83), .c(x79), .O(new_n411_));
  nand4  g252(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n412_));
  aoi21  g253(.a(new_n412_), .b(new_n411_), .c(x01), .O(z64));
  nor2   g254(.a(new_n160_), .b(x04), .O(new_n414_));
  nor2   g255(.a(new_n243_), .b(x78), .O(new_n415_));
  oai21  g256(.a(new_n415_), .b(new_n414_), .c(x77), .O(new_n416_));
  nand3  g257(.a(x81), .b(x78), .c(new_n159_), .O(new_n417_));
  nand2  g258(.a(new_n417_), .b(new_n416_), .O(new_n418_));
  nand4  g259(.a(new_n418_), .b(x84), .c(x79), .d(new_n153_), .O(new_n419_));
  inv1   g260(.a(new_n419_), .O(z65));
  zero   g261(.O(z03));
  zero   g262(.O(z04));
  zero   g263(.O(z11));
  zero   g264(.O(z15));
