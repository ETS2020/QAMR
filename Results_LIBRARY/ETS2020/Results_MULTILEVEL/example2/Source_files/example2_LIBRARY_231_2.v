...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n177_, new_n178_, new_n180_, new_n181_, new_n185_,
    ...
    new_n287_, new_n289_, new_n291_, new_n297_, new_n299_, new_n300_,
  ...
  nand4  g202(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n368_));
  oai22  g203(.a(new_n368_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n369_));
  ...
  oai21  g209(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n375_));
  aoi21  g210(.a(new_n375_), .b(new_n374_), .c(x01), .O(z58));
  nor2   g211(.a(new_n160_), .b(new_n225_), .O(new_n377_));
  oai21  g212(.a(new_n377_), .b(new_n371_), .c(x40), .O(new_n378_));
  oai21  g213(.a(new_n220_), .b(new_n218_), .c(new_n233_), .O(new_n379_));
  ...
  nand3  g232(.a(x81), .b(x79), .c(new_n225_), .O(new_n398_));
