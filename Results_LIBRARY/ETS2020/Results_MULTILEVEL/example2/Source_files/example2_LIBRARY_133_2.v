...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n269_, new_n275_, new_n276_, new_n277_, new_n278_, new_n279_,
    new_n280_, new_n281_, new_n282_, new_n284_, new_n286_, new_n289_,
  ...
  inv1   g037(.a(x33), .O(new_n195_));
  nand2  g038(.a(x50), .b(x40), .O(new_n196_));
  oai21  g039(.a(x40), .b(new_n195_), .c(new_n196_), .O(z15));
  ...
  nand4  g089(.a(new_n240_), .b(x48), .c(new_n232_), .d(new_n224_), .O(new_n250_));
  nor2   g090(.a(new_n250_), .b(x01), .O(z30));
  nand4  g091(.a(new_n240_), .b(x49), .c(new_n232_), .d(new_n224_), .O(new_n252_));
  nor2   g092(.a(new_n252_), .b(x01), .O(z31));
  nand4  g093(.a(new_n240_), .b(x50), .c(new_n232_), .d(new_n224_), .O(new_n254_));
  nor2   g094(.a(new_n254_), .b(x01), .O(z32));
  nand2  g095(.a(x83), .b(new_n235_), .O(new_n256_));
  nand2  g096(.a(new_n218_), .b(x81), .O(new_n257_));
  ...
  nand4  g108(.a(new_n268_), .b(x78), .c(x77), .d(new_n224_), .O(new_n269_));
  nor2   g109(.a(new_n269_), .b(x01), .O(z33));
  nor2   g110(.a(new_n218_), .b(new_n232_), .O(new_n275_));
  nand3  g111(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  oai21  g112(.a(new_n275_), .b(x81), .c(new_n276_), .O(new_n277_));
  nand2  g113(.a(new_n277_), .b(new_n236_), .O(new_n278_));
  oai22  g114(.a(new_n275_), .b(new_n235_), .c(new_n256_), .d(new_n232_), .O(new_n279_));
  nand2  g115(.a(new_n279_), .b(new_n233_), .O(new_n280_));
  aoi21  g116(.a(new_n280_), .b(new_n278_), .c(new_n154_), .O(new_n281_));
  nand4  g117(.a(new_n281_), .b(x78), .c(x77), .d(x56), .O(new_n282_));
  nor3   g118(.a(new_n282_), .b(x04), .c(x01), .O(z38));
  nand4  g119(.a(new_n281_), .b(x78), .c(x77), .d(x57), .O(new_n284_));
  nor3   g120(.a(new_n284_), .b(x04), .c(x01), .O(z39));
  nand4  g121(.a(new_n281_), .b(x78), .c(x77), .d(x58), .O(new_n286_));
  nor3   g122(.a(new_n286_), .b(x04), .c(x01), .O(z40));
  nand4  g123(.a(new_n281_), .b(x78), .c(x77), .d(x60), .O(new_n289_));
  nor3   g124(.a(new_n289_), .b(x04), .c(x01), .O(z42));
  nand4  g125(.a(new_n281_), .b(x78), .c(x77), .d(x62), .O(new_n292_));
  nor3   g126(.a(new_n292_), .b(x04), .c(x01), .O(z44));
