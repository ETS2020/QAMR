...
module FAU ( 
  ...
  nand4  g141(.a(new_n290_), .b(x78), .c(x77), .d(x56), .O(new_n297_));
  nor3   g142(.a(new_n297_), .b(x04), .c(x01), .O(z38));
  nand4  g143(.a(new_n290_), .b(x78), .c(x77), .d(x57), .O(new_n299_));
  nor3   g144(.a(new_n299_), .b(x04), .c(x01), .O(z39));
  nand4  g145(.a(new_n290_), .b(x78), .c(x77), .d(x58), .O(new_n301_));
  nor3   g146(.a(new_n301_), .b(x04), .c(x01), .O(z40));
  nand4  g147(.a(new_n290_), .b(x78), .c(x77), .d(x59), .O(new_n303_));
  nor3   g148(.a(new_n303_), .b(x04), .c(x01), .O(z41));
  nand4  g149(.a(new_n290_), .b(x78), .c(x77), .d(x60), .O(new_n305_));
  nor3   g150(.a(new_n305_), .b(x04), .c(x01), .O(z42));
  nand4  g151(.a(new_n290_), .b(x78), .c(x77), .d(x61), .O(new_n307_));
  nor3   g152(.a(new_n307_), .b(x04), .c(x01), .O(z43));
  nand4  g153(.a(new_n290_), .b(x78), .c(x77), .d(x62), .O(new_n309_));
