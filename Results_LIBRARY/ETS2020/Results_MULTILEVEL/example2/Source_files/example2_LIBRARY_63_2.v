...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n295_, new_n297_, new_n300_, new_n304_, new_n305_, new_n306_,
  ...
  nor2   g071(.a(new_n160_), .b(new_n159_), .O(new_n230_));
  inv1   g072(.a(new_n230_), .O(new_n231_));
  aoi21  g073(.a(new_n231_), .b(x79), .c(x43), .O(new_n232_));
  nand3  g074(.a(new_n232_), .b(x05), .c(new_n229_), .O(new_n233_));
  nor2   g075(.a(new_n233_), .b(x01), .O(z24));
  ...
  nand4  g085(.a(new_n243_), .b(new_n235_), .c(x05), .d(new_n229_), .O(new_n244_));
  nor2   g086(.a(new_n244_), .b(x01), .O(z25));
  nand4  g087(.a(new_n243_), .b(x44), .c(new_n235_), .d(new_n229_), .O(new_n246_));
  nor2   g088(.a(new_n246_), .b(x01), .O(z26));
  nand4  g089(.a(new_n243_), .b(x45), .c(new_n235_), .d(new_n229_), .O(new_n248_));
  nor2   g090(.a(new_n248_), .b(x01), .O(z27));
  nand4  g091(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n229_), .O(new_n250_));
  nor2   g092(.a(new_n250_), .b(x01), .O(z28));
  nand4  g093(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n229_), .O(new_n252_));
  nor2   g094(.a(new_n252_), .b(x01), .O(z29));
  nand4  g095(.a(new_n243_), .b(x49), .c(new_n235_), .d(new_n229_), .O(new_n255_));
  nor2   g096(.a(new_n255_), .b(x01), .O(z31));
  nand4  g097(.a(new_n243_), .b(x50), .c(new_n235_), .d(new_n229_), .O(new_n257_));
  nor2   g098(.a(new_n257_), .b(x01), .O(z32));
  nand2  g099(.a(x83), .b(new_n238_), .O(new_n259_));
  ...
  nand3  g103(.a(x81), .b(x51), .c(new_n235_), .O(new_n263_));
  ...
  nand3  g108(.a(new_n238_), .b(x51), .c(new_n235_), .O(new_n268_));
  nand2  g109(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand2  g110(.a(new_n269_), .b(new_n239_), .O(new_n270_));
  aoi21  g111(.a(new_n270_), .b(new_n265_), .c(new_n154_), .O(new_n271_));
  nand4  g112(.a(new_n271_), .b(x78), .c(x77), .d(new_n229_), .O(new_n272_));
  nor2   g113(.a(new_n272_), .b(x01), .O(z33));
  nor2   g114(.a(new_n222_), .b(new_n235_), .O(new_n274_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  oai21  g116(.a(new_n274_), .b(x81), .c(new_n275_), .O(new_n276_));
  nand2  g117(.a(new_n276_), .b(new_n239_), .O(new_n277_));
  oai22  g118(.a(new_n274_), .b(new_n238_), .c(new_n259_), .d(new_n235_), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n236_), .O(new_n279_));
  ...
  nand4  g131(.a(new_n280_), .b(x78), .c(x77), .d(x57), .O(new_n291_));
  nor3   g132(.a(new_n291_), .b(x04), .c(x01), .O(z39));
  nand4  g133(.a(new_n280_), .b(x78), .c(x77), .d(x58), .O(new_n293_));
  nor3   g134(.a(new_n293_), .b(x04), .c(x01), .O(z40));
  nand4  g135(.a(new_n280_), .b(x78), .c(x77), .d(x59), .O(new_n295_));
  nor3   g136(.a(new_n295_), .b(x04), .c(x01), .O(z41));
  nand4  g137(.a(new_n280_), .b(x78), .c(x77), .d(x60), .O(new_n297_));
  nor3   g138(.a(new_n297_), .b(x04), .c(x01), .O(z42));
  nand4  g139(.a(new_n280_), .b(x78), .c(x77), .d(x62), .O(new_n300_));
  ...
  nor2   g147(.a(new_n309_), .b(new_n217_), .O(new_n310_));
  ...
  nand2  g151(.a(new_n305_), .b(x08), .O(new_n314_));
  aoi21  g152(.a(new_n314_), .b(new_n313_), .c(x79), .O(new_n315_));
  nand4  g153(.a(new_n315_), .b(x78), .c(new_n159_), .d(x04), .O(new_n316_));
  nand4  g154(.a(new_n218_), .b(x79), .c(new_n160_), .d(x77), .O(new_n317_));
  inv1   g155(.a(new_n317_), .O(new_n318_));
  nand2  g156(.a(new_n318_), .b(x68), .O(new_n319_));
  aoi21  g157(.a(new_n319_), .b(new_n316_), .c(x01), .O(z48));
  nand2  g158(.a(x52), .b(x17), .O(new_n321_));
  nand2  g159(.a(new_n305_), .b(x09), .O(new_n322_));
  aoi21  g160(.a(new_n322_), .b(new_n321_), .c(x79), .O(new_n323_));
  nand4  g161(.a(new_n323_), .b(x78), .c(new_n159_), .d(x04), .O(new_n324_));
  nand2  g162(.a(new_n318_), .b(x69), .O(new_n325_));
  aoi21  g163(.a(new_n325_), .b(new_n324_), .c(x01), .O(z49));
  nand2  g164(.a(x52), .b(x18), .O(new_n327_));
  nand2  g165(.a(new_n305_), .b(x10), .O(new_n328_));
  aoi21  g166(.a(new_n328_), .b(new_n327_), .c(x79), .O(new_n329_));
  nand4  g167(.a(new_n329_), .b(x78), .c(new_n159_), .d(x04), .O(new_n330_));
  nand2  g168(.a(new_n318_), .b(x70), .O(new_n331_));
  aoi21  g169(.a(new_n331_), .b(new_n330_), .c(x01), .O(z50));
  nand2  g170(.a(x52), .b(x19), .O(new_n333_));
  nand2  g171(.a(new_n305_), .b(x11), .O(new_n334_));
  aoi21  g172(.a(new_n334_), .b(new_n333_), .c(x79), .O(new_n335_));
  nand4  g173(.a(new_n335_), .b(x78), .c(new_n159_), .d(x04), .O(new_n336_));
  nand2  g174(.a(new_n318_), .b(x71), .O(new_n337_));
  aoi21  g175(.a(new_n337_), .b(new_n336_), .c(x01), .O(z51));
  nand2  g176(.a(x52), .b(x20), .O(new_n339_));
  nand2  g177(.a(new_n305_), .b(x12), .O(new_n340_));
  aoi21  g178(.a(new_n340_), .b(new_n339_), .c(x79), .O(new_n341_));
  nand4  g179(.a(new_n341_), .b(x78), .c(new_n159_), .d(x04), .O(new_n342_));
  nand2  g180(.a(new_n318_), .b(x72), .O(new_n343_));
  aoi21  g181(.a(new_n343_), .b(new_n342_), .c(x01), .O(z52));
  nand2  g182(.a(x52), .b(x21), .O(new_n345_));
  nand2  g183(.a(new_n305_), .b(x13), .O(new_n346_));
  aoi21  g184(.a(new_n346_), .b(new_n345_), .c(x79), .O(new_n347_));
  nand4  g185(.a(new_n347_), .b(x78), .c(new_n159_), .d(x04), .O(new_n348_));
  nand2  g186(.a(new_n318_), .b(x73), .O(new_n349_));
  aoi21  g187(.a(new_n349_), .b(new_n348_), .c(x01), .O(z53));
  nand2  g188(.a(x52), .b(x22), .O(new_n351_));
  nand2  g189(.a(new_n305_), .b(x14), .O(new_n352_));
  aoi21  g190(.a(new_n352_), .b(new_n351_), .c(x79), .O(new_n353_));
  nand4  g191(.a(new_n353_), .b(x78), .c(new_n159_), .d(x04), .O(new_n354_));
  nor2   g192(.a(new_n354_), .b(x01), .O(z54));
  inv1   g193(.a(x84), .O(new_n356_));
  nor2   g194(.a(x04), .b(x01), .O(new_n357_));
  nand4  g195(.a(new_n357_), .b(x79), .c(x78), .d(x77), .O(new_n358_));
  nor2   g196(.a(new_n358_), .b(x80), .O(new_n359_));
  nand2  g197(.a(new_n359_), .b(new_n238_), .O(new_n360_));
  nor4   g198(.a(new_n360_), .b(new_n356_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g199(.a(new_n231_), .b(x76), .O(new_n362_));
  inv1   g200(.a(new_n165_), .O(new_n363_));
  xnor2a g201(.a(x84), .b(x81), .O(new_n364_));
  aoi21  g202(.a(new_n167_), .b(new_n363_), .c(new_n364_), .O(new_n365_));
  nand2  g203(.a(new_n365_), .b(new_n153_), .O(new_n366_));
  nand2  g204(.a(new_n366_), .b(new_n362_), .O(new_n367_));
  nand2  g205(.a(new_n367_), .b(x79), .O(new_n368_));
  nand4  g206(.a(new_n368_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g207(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n371_));
  oai22  g208(.a(new_n371_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n372_));
  nand4  g209(.a(new_n372_), .b(x79), .c(x78), .d(x04), .O(new_n373_));
  nor2   g210(.a(x79), .b(x78), .O(new_n374_));
  nand3  g211(.a(new_n374_), .b(new_n235_), .c(x40), .O(new_n375_));
  nand2  g212(.a(new_n375_), .b(new_n373_), .O(new_n376_));
  nand2  g213(.a(new_n376_), .b(x77), .O(new_n377_));
  oai21  g214(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n378_));
  aoi21  g215(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g216(.a(new_n160_), .b(new_n229_), .O(new_n380_));
  oai21  g217(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g218(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n382_));
  ...
  nand2  g223(.a(new_n154_), .b(new_n229_), .O(new_n387_));
  aoi21  g224(.a(new_n387_), .b(new_n386_), .c(x01), .O(z59));
  nand2  g225(.a(new_n365_), .b(x79), .O(new_n389_));
  nand3  g226(.a(new_n389_), .b(new_n387_), .c(new_n226_), .O(new_n390_));
  and2   g227(.a(new_n390_), .b(new_n153_), .O(z60));
  nand2  g228(.a(new_n167_), .b(new_n363_), .O(new_n392_));
  nand2  g229(.a(new_n392_), .b(new_n218_), .O(new_n393_));
  oai21  g230(.a(new_n231_), .b(x04), .c(new_n393_), .O(new_n394_));
  ...
  nand3  g237(.a(x81), .b(x79), .c(new_n229_), .O(new_n401_));
