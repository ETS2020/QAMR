...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n291_, new_n295_, new_n297_, new_n299_, new_n301_,
  ...
  nand4  g105(.a(new_n250_), .b(x49), .c(new_n242_), .d(new_n234_), .O(new_n261_));
  nor2   g106(.a(new_n261_), .b(x01), .O(z31));
  nand4  g107(.a(new_n250_), .b(x50), .c(new_n242_), .d(new_n234_), .O(new_n263_));
  ...
  nand4  g145(.a(new_n286_), .b(x78), .c(x77), .d(x64), .O(new_n306_));
  ...
  nand2  g203(.a(new_n363_), .b(new_n245_), .O(new_n364_));
  nor4   g204(.a(new_n364_), .b(new_n360_), .c(new_n228_), .d(x82), .O(z55));
  nand2  g205(.a(new_n238_), .b(x76), .O(new_n366_));
  ...
  nand4  g216(.a(x80), .b(new_n226_), .c(x43), .d(new_n242_), .O(new_n377_));
  oai22  g217(.a(new_n377_), .b(new_n229_), .c(new_n242_), .d(x40), .O(new_n378_));
  nand4  g218(.a(new_n378_), .b(x79), .c(x78), .d(x04), .O(new_n379_));
  nor2   g219(.a(x79), .b(x78), .O(new_n380_));
  nand3  g220(.a(new_n380_), .b(new_n242_), .c(x40), .O(new_n381_));
  nand2  g221(.a(new_n381_), .b(new_n379_), .O(new_n382_));
  nand2  g222(.a(new_n382_), .b(x77), .O(new_n383_));
  oai21  g223(.a(new_n165_), .b(new_n234_), .c(new_n154_), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n383_), .c(x01), .O(z58));
  nor2   g225(.a(new_n160_), .b(new_n234_), .O(new_n386_));
  oai21  g226(.a(new_n386_), .b(new_n380_), .c(x40), .O(new_n387_));
  oai21  g227(.a(new_n229_), .b(new_n227_), .c(new_n242_), .O(new_n388_));
  ...
  nand2  g232(.a(new_n154_), .b(new_n234_), .O(new_n393_));
  ...
  oai21  g239(.a(new_n238_), .b(x04), .c(new_n399_), .O(new_n400_));
  ...
  nand3  g246(.a(x81), .b(x79), .c(new_n234_), .O(new_n407_));
  ...
  nor2   g257(.a(new_n245_), .b(x78), .O(new_n418_));
