...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n168_, new_n172_, new_n173_, new_n176_, new_n177_, new_n180_,
    ...
    new_n238_, new_n239_, new_n243_, new_n245_, new_n247_, new_n250_,
  ...
  nand4  g082(.a(new_n238_), .b(x48), .c(new_n230_), .d(new_n221_), .O(new_n245_));
  nor2   g083(.a(new_n245_), .b(x01), .O(z30));
  nand4  g084(.a(new_n238_), .b(x49), .c(new_n230_), .d(new_n221_), .O(new_n247_));
  nor2   g085(.a(new_n247_), .b(x01), .O(z31));
  nand2  g086(.a(x83), .b(new_n233_), .O(new_n250_));
  ...
  nand3  g090(.a(x81), .b(x51), .c(new_n230_), .O(new_n254_));
  nand2  g091(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  nand2  g092(.a(new_n255_), .b(new_n231_), .O(new_n256_));
  xnor2a g093(.a(x83), .b(x81), .O(new_n257_));
  nand3  g094(.a(new_n257_), .b(x42), .c(x05), .O(new_n258_));
  nand3  g095(.a(new_n233_), .b(x51), .c(new_n230_), .O(new_n259_));
  ...
  nor2   g101(.a(new_n215_), .b(new_n230_), .O(new_n265_));
  nand3  g102(.a(x83), .b(x81), .c(x42), .O(new_n266_));
  oai21  g103(.a(new_n265_), .b(x81), .c(new_n266_), .O(new_n267_));
  nand2  g104(.a(new_n267_), .b(new_n234_), .O(new_n268_));
  oai22  g105(.a(new_n265_), .b(new_n233_), .c(new_n250_), .d(new_n230_), .O(new_n269_));
  nand2  g106(.a(new_n269_), .b(new_n231_), .O(new_n270_));
  ...
  nand4  g116(.a(new_n271_), .b(x78), .c(x77), .d(x59), .O(new_n283_));
  nor3   g117(.a(new_n283_), .b(x04), .c(x01), .O(z41));
  nand4  g118(.a(new_n271_), .b(x78), .c(x77), .d(x60), .O(new_n285_));
  ...
  nand4  g126(.a(new_n271_), .b(x78), .c(x77), .d(x64), .O(new_n293_));
