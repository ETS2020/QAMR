...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n250_, new_n252_, new_n256_, new_n258_, new_n261_, new_n263_,
  ...
  nand4  g061(.a(new_n221_), .b(x47), .c(new_n213_), .d(new_n207_), .O(new_n225_));
  nor2   g062(.a(new_n225_), .b(x01), .O(z29));
  nand4  g063(.a(new_n221_), .b(x48), .c(new_n213_), .d(new_n207_), .O(new_n227_));
  nor2   g064(.a(new_n227_), .b(x01), .O(z30));
  nand4  g065(.a(new_n221_), .b(x49), .c(new_n213_), .d(new_n207_), .O(new_n229_));
  ...
  nor2   g140(.a(new_n216_), .b(x78), .O(new_n321_));
