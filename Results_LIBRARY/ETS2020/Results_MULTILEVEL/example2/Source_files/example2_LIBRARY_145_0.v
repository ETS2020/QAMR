...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n201_, new_n202_, new_n207_, new_n208_, new_n212_, new_n213_,
  ...
  nand4  g065(.a(new_n220_), .b(x47), .c(new_n212_), .d(new_n207_), .O(new_n227_));
  nor2   g066(.a(new_n227_), .b(x01), .O(z29));
  nand4  g067(.a(new_n220_), .b(x48), .c(new_n212_), .d(new_n207_), .O(new_n229_));
  nor2   g068(.a(new_n229_), .b(x01), .O(z30));
  aoi21  g069(.a(x83), .b(x42), .c(x81), .O(new_n236_));
  nand3  g070(.a(x83), .b(x81), .c(x42), .O(new_n237_));
  inv1   g071(.a(new_n237_), .O(new_n238_));
  oai21  g072(.a(new_n238_), .b(new_n236_), .c(new_n216_), .O(new_n239_));
  nand2  g073(.a(x83), .b(x42), .O(new_n240_));
  nand2  g074(.a(new_n240_), .b(x81), .O(new_n241_));
  nand3  g075(.a(x83), .b(new_n215_), .c(x42), .O(new_n242_));
  nand2  g076(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  nand2  g077(.a(new_n243_), .b(new_n213_), .O(new_n244_));
  aoi21  g078(.a(new_n244_), .b(new_n239_), .c(new_n154_), .O(new_n245_));
  nand4  g079(.a(new_n245_), .b(x78), .c(x77), .d(x54), .O(new_n246_));
  nor3   g080(.a(new_n246_), .b(x04), .c(x01), .O(z36));
  nand4  g081(.a(new_n245_), .b(x78), .c(x77), .d(x55), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z37));
  nand4  g083(.a(new_n245_), .b(x78), .c(x77), .d(x56), .O(new_n250_));
  nor3   g084(.a(new_n250_), .b(x04), .c(x01), .O(z38));
  nand4  g085(.a(new_n245_), .b(x78), .c(x77), .d(x57), .O(new_n252_));
  nor3   g086(.a(new_n252_), .b(x04), .c(x01), .O(z39));
  nand4  g087(.a(new_n245_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  nor3   g088(.a(new_n255_), .b(x04), .c(x01), .O(z41));
  nand4  g089(.a(new_n245_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g090(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g091(.a(new_n245_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g092(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g093(.a(new_n245_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g094(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g095(.a(new_n245_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g096(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g097(.a(new_n245_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  ...
  nor2   g146(.a(new_n274_), .b(x04), .O(new_n325_));
  nor2   g147(.a(new_n215_), .b(x78), .O(new_n326_));
  oai21  g148(.a(new_n326_), .b(new_n325_), .c(x77), .O(new_n327_));
  nand3  g149(.a(x81), .b(x78), .c(new_n268_), .O(new_n328_));
  nand2  g150(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand4  g151(.a(new_n329_), .b(x84), .c(x79), .d(new_n153_), .O(new_n330_));
  inv1   g152(.a(new_n330_), .O(z65));
  zero   g153(.O(z01));
  zero   g154(.O(z02));
  zero   g155(.O(z11));
  zero   g156(.O(z12));
