...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n246_, new_n248_, new_n251_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n279_, new_n281_, new_n285_, new_n287_, new_n289_,
  ...
  nand4  g090(.a(new_n240_), .b(x49), .c(new_n232_), .d(new_n224_), .O(new_n251_));
  nor2   g091(.a(new_n251_), .b(x01), .O(z31));
  nand2  g092(.a(x83), .b(new_n235_), .O(new_n254_));
  ...
  nand3  g096(.a(x81), .b(x51), .c(new_n232_), .O(new_n258_));
  nand2  g097(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g098(.a(new_n259_), .b(new_n233_), .O(new_n260_));
  xnor2a g099(.a(x83), .b(x81), .O(new_n261_));
  nand3  g100(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g101(.a(new_n235_), .b(x51), .c(new_n232_), .O(new_n263_));
  nand2  g102(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  nand2  g103(.a(new_n264_), .b(new_n236_), .O(new_n265_));
  aoi21  g104(.a(new_n265_), .b(new_n260_), .c(new_n154_), .O(new_n266_));
  nand4  g105(.a(new_n266_), .b(x78), .c(x77), .d(new_n224_), .O(new_n267_));
  nor2   g106(.a(new_n267_), .b(x01), .O(z33));
  nor2   g107(.a(new_n218_), .b(new_n232_), .O(new_n269_));
  nand3  g108(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  oai21  g109(.a(new_n269_), .b(x81), .c(new_n270_), .O(new_n271_));
  nand2  g110(.a(new_n271_), .b(new_n236_), .O(new_n272_));
  oai22  g111(.a(new_n269_), .b(new_n235_), .c(new_n254_), .d(new_n232_), .O(new_n273_));
  nand2  g112(.a(new_n273_), .b(new_n233_), .O(new_n274_));
  ...
  nand4  g118(.a(new_n275_), .b(x78), .c(x77), .d(x55), .O(new_n281_));
  ...
  nand2  g141(.a(x52), .b(x22), .O(new_n313_));
  nand2  g142(.a(new_n299_), .b(x14), .O(new_n314_));
  aoi21  g143(.a(new_n314_), .b(new_n313_), .c(x79), .O(new_n315_));
  nand4  g144(.a(new_n315_), .b(x78), .c(new_n159_), .d(x04), .O(new_n316_));
  nor2   g145(.a(new_n316_), .b(x01), .O(z54));
  inv1   g146(.a(x84), .O(new_n318_));
  nor2   g147(.a(x04), .b(x01), .O(new_n319_));
  nand4  g148(.a(new_n319_), .b(x79), .c(x78), .d(x77), .O(new_n320_));
  nor2   g149(.a(new_n320_), .b(x80), .O(new_n321_));
  nand2  g150(.a(new_n321_), .b(new_n235_), .O(new_n322_));
  nor4   g151(.a(new_n322_), .b(new_n318_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g152(.a(new_n228_), .b(x76), .O(new_n324_));
  inv1   g153(.a(new_n165_), .O(new_n325_));
  xnor2a g154(.a(x84), .b(x81), .O(new_n326_));
  aoi21  g155(.a(new_n167_), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g156(.a(new_n327_), .b(new_n153_), .O(new_n328_));
  nand2  g157(.a(new_n328_), .b(new_n324_), .O(new_n329_));
  nand2  g158(.a(new_n329_), .b(x79), .O(new_n330_));
  nand4  g159(.a(new_n330_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g160(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n333_));
  oai22  g161(.a(new_n333_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n334_));
  nand4  g162(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g163(.a(x79), .b(x78), .O(new_n336_));
  nand3  g164(.a(new_n336_), .b(new_n232_), .c(x40), .O(new_n337_));
  nand2  g165(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g166(.a(new_n338_), .b(x77), .O(new_n339_));
  oai21  g167(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n340_));
  aoi21  g168(.a(new_n340_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g169(.a(new_n160_), .b(new_n224_), .O(new_n342_));
  oai21  g170(.a(new_n342_), .b(new_n336_), .c(x40), .O(new_n343_));
  oai21  g171(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n344_));
  nand2  g172(.a(new_n344_), .b(x79), .O(new_n345_));
  nand3  g173(.a(new_n345_), .b(x78), .c(x04), .O(new_n346_));
  nand2  g174(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand2  g175(.a(new_n347_), .b(x77), .O(new_n348_));
  nand2  g176(.a(new_n154_), .b(new_n224_), .O(new_n349_));
  aoi21  g177(.a(new_n349_), .b(new_n348_), .c(x01), .O(z59));
  nand2  g178(.a(new_n327_), .b(x79), .O(new_n351_));
  nand3  g179(.a(new_n351_), .b(new_n349_), .c(new_n222_), .O(new_n352_));
  and2   g180(.a(new_n352_), .b(new_n153_), .O(z60));
  nand2  g181(.a(new_n167_), .b(new_n325_), .O(new_n354_));
  nand2  g182(.a(new_n354_), .b(new_n214_), .O(new_n355_));
  oai21  g183(.a(new_n228_), .b(x04), .c(new_n355_), .O(new_n356_));
  nand4  g184(.a(new_n356_), .b(x80), .c(x79), .d(new_n153_), .O(new_n357_));
  inv1   g185(.a(new_n357_), .O(z61));
  nand2  g186(.a(new_n154_), .b(x04), .O(new_n359_));
  nand3  g187(.a(x84), .b(x81), .c(x79), .O(new_n360_));
  aoi21  g188(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  nand2  g189(.a(new_n345_), .b(x04), .O(new_n362_));
  nand3  g190(.a(x81), .b(x79), .c(new_n224_), .O(new_n363_));
  aoi21  g191(.a(new_n363_), .b(new_n362_), .c(new_n159_), .O(new_n364_));
  oai21  g192(.a(new_n364_), .b(new_n361_), .c(x78), .O(new_n365_));
  or2    g193(.a(new_n360_), .b(new_n167_), .O(new_n366_));
  aoi21  g194(.a(new_n366_), .b(new_n365_), .c(x01), .O(z62));
  nand4  g195(.a(new_n356_), .b(x82), .c(x79), .d(new_n153_), .O(new_n368_));
  inv1   g196(.a(new_n368_), .O(z63));
  nand3  g197(.a(new_n356_), .b(x83), .c(x79), .O(new_n370_));
  nand4  g198(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n371_));
  aoi21  g199(.a(new_n371_), .b(new_n370_), .c(x01), .O(z64));
  nor2   g200(.a(new_n160_), .b(x04), .O(new_n373_));
  nor2   g201(.a(new_n235_), .b(x78), .O(new_n374_));
  oai21  g202(.a(new_n374_), .b(new_n373_), .c(x77), .O(new_n375_));
  nand3  g203(.a(x81), .b(x78), .c(new_n159_), .O(new_n376_));
  nand2  g204(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand4  g205(.a(new_n377_), .b(x84), .c(x79), .d(new_n153_), .O(new_n378_));
  inv1   g206(.a(new_n378_), .O(z65));
  zero   g207(.O(z05));
  zero   g208(.O(z06));
  zero   g209(.O(z08));
  zero   g210(.O(z09));
