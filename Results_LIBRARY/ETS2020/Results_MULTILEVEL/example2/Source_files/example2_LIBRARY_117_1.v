...
module FAU ( 
  ...
  nor2   g117(.a(new_n222_), .b(new_n236_), .O(new_n276_));
  nand3  g118(.a(x83), .b(x81), .c(x42), .O(new_n277_));
  oai21  g119(.a(new_n276_), .b(x81), .c(new_n277_), .O(new_n278_));
  nand2  g120(.a(new_n278_), .b(new_n240_), .O(new_n279_));
  oai22  g121(.a(new_n276_), .b(new_n239_), .c(new_n260_), .d(new_n236_), .O(new_n280_));
  nand2  g122(.a(new_n280_), .b(new_n237_), .O(new_n281_));
  ...
  nand4  g128(.a(new_n282_), .b(x78), .c(x77), .d(x55), .O(new_n287_));
  ...
  nand2  g157(.a(new_n324_), .b(new_n239_), .O(new_n325_));
  nor4   g158(.a(new_n325_), .b(new_n321_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g159(.a(new_n232_), .b(x76), .O(new_n327_));
  ...
  nand4  g167(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n336_));
  oai22  g168(.a(new_n336_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n337_));
  ...
  oai21  g174(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n343_));
  aoi21  g175(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g176(.a(new_n160_), .b(new_n228_), .O(new_n345_));
  oai21  g177(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g178(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n347_));
  ...
  nand2  g183(.a(new_n154_), .b(new_n228_), .O(new_n352_));
  ...
  oai21  g190(.a(new_n232_), .b(x04), .c(new_n358_), .O(new_n359_));
  ...
  nand3  g197(.a(x81), .b(x79), .c(new_n228_), .O(new_n366_));
