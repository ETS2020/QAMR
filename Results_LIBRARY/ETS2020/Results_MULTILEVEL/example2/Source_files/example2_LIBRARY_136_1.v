...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n184_, new_n188_, new_n189_, new_n192_, new_n193_, new_n196_,
    ...
    new_n286_, new_n289_, new_n292_, new_n296_, new_n299_, new_n300_,
  ...
  nand2  g143(.a(new_n300_), .b(x12), .O(new_n313_));
  aoi21  g144(.a(new_n313_), .b(new_n312_), .c(x79), .O(new_n314_));
  nand4  g145(.a(new_n314_), .b(x78), .c(new_n159_), .d(x04), .O(new_n315_));
  nor2   g146(.a(new_n214_), .b(new_n154_), .O(new_n316_));
  nand4  g147(.a(new_n316_), .b(new_n160_), .c(x77), .d(x72), .O(new_n317_));
  aoi21  g148(.a(new_n317_), .b(new_n315_), .c(x01), .O(z52));
  ...
  nand2  g153(.a(new_n324_), .b(new_n235_), .O(new_n325_));
  nor4   g154(.a(new_n325_), .b(new_n321_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g155(.a(new_n228_), .b(x76), .O(new_n327_));
  ...
  nand4  g166(.a(x80), .b(new_n217_), .c(x43), .d(new_n232_), .O(new_n338_));
  oai22  g167(.a(new_n338_), .b(new_n220_), .c(new_n232_), .d(x40), .O(new_n339_));
  nand4  g168(.a(new_n339_), .b(x79), .c(x78), .d(x04), .O(new_n340_));
  nor2   g169(.a(x79), .b(x78), .O(new_n341_));
  nand3  g170(.a(new_n341_), .b(new_n232_), .c(x40), .O(new_n342_));
  nand2  g171(.a(new_n342_), .b(new_n340_), .O(new_n343_));
  nand2  g172(.a(new_n343_), .b(x77), .O(new_n344_));
  oai21  g173(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n345_));
  aoi21  g174(.a(new_n345_), .b(new_n344_), .c(x01), .O(z58));
  nor2   g175(.a(new_n160_), .b(new_n226_), .O(new_n347_));
  oai21  g176(.a(new_n347_), .b(new_n341_), .c(x40), .O(new_n348_));
  oai21  g177(.a(new_n220_), .b(new_n218_), .c(new_n232_), .O(new_n349_));
  ...
  nand2  g182(.a(new_n154_), .b(new_n226_), .O(new_n354_));
  aoi21  g183(.a(new_n354_), .b(new_n353_), .c(x01), .O(z59));
  nand2  g184(.a(new_n330_), .b(x79), .O(new_n356_));
  nand3  g185(.a(new_n356_), .b(new_n354_), .c(new_n223_), .O(new_n357_));
  and2   g186(.a(new_n357_), .b(new_n153_), .O(z60));
  nand2  g187(.a(new_n167_), .b(new_n328_), .O(new_n359_));
  nand2  g188(.a(new_n359_), .b(new_n215_), .O(new_n360_));
  oai21  g189(.a(new_n228_), .b(x04), .c(new_n360_), .O(new_n361_));
  ...
  nand3  g196(.a(x81), .b(x79), .c(new_n226_), .O(new_n368_));
