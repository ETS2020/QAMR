...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n286_, new_n290_, new_n292_, new_n294_, new_n296_, new_n300_,
  ...
  nand4  g125(.a(new_n277_), .b(x78), .c(x77), .d(x56), .O(new_n286_));
  ...
  nand2  g148(.a(new_n319_), .b(new_n239_), .O(new_n320_));
  ...
  nand4  g159(.a(x03), .b(new_n330_), .c(new_n153_), .d(x00), .O(new_n331_));
  inv1   g160(.a(new_n331_), .O(z57));
  nand4  g161(.a(x80), .b(new_n218_), .c(x43), .d(new_n236_), .O(new_n333_));
  oai22  g162(.a(new_n333_), .b(new_n221_), .c(new_n236_), .d(x40), .O(new_n334_));
  nand4  g163(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g164(.a(x79), .b(x78), .O(new_n336_));
  nand3  g165(.a(new_n336_), .b(new_n236_), .c(x40), .O(new_n337_));
  nand2  g166(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g167(.a(new_n338_), .b(x77), .O(new_n339_));
  oai21  g168(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n340_));
  aoi21  g169(.a(new_n340_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g170(.a(new_n160_), .b(new_n226_), .O(new_n342_));
  oai21  g171(.a(new_n342_), .b(new_n336_), .c(x40), .O(new_n343_));
  oai21  g172(.a(new_n221_), .b(new_n219_), .c(new_n236_), .O(new_n344_));
  ...
  nand2  g177(.a(new_n154_), .b(new_n226_), .O(new_n349_));
  aoi21  g178(.a(new_n349_), .b(new_n348_), .c(x01), .O(z59));
  nand2  g179(.a(new_n325_), .b(x79), .O(new_n351_));
  nand3  g180(.a(new_n351_), .b(new_n349_), .c(new_n224_), .O(new_n352_));
  and2   g181(.a(new_n352_), .b(new_n153_), .O(z60));
  nand2  g182(.a(new_n167_), .b(new_n323_), .O(new_n354_));
  nand2  g183(.a(new_n354_), .b(new_n216_), .O(new_n355_));
  oai21  g184(.a(new_n230_), .b(x04), .c(new_n355_), .O(new_n356_));
  ...
  nand3  g191(.a(x81), .b(x79), .c(new_n226_), .O(new_n363_));
