...
module FAU ( 
  ...
  nand4  g086(.a(new_n242_), .b(x78), .c(x77), .d(x56), .O(new_n250_));
  nor3   g087(.a(new_n250_), .b(x04), .c(x01), .O(z38));
  nand4  g088(.a(new_n242_), .b(x78), .c(x77), .d(x57), .O(new_n252_));
  nor3   g089(.a(new_n252_), .b(x04), .c(x01), .O(z39));
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x58), .O(new_n254_));
  nor3   g091(.a(new_n254_), .b(x04), .c(x01), .O(z40));
  ...
  inv1   g149(.a(x02), .O(new_n317_));
  nand4  g150(.a(x03), .b(new_n317_), .c(new_n155_), .d(x00), .O(new_n318_));
  inv1   g151(.a(new_n318_), .O(z57));
  nor2   g152(.a(new_n274_), .b(x04), .O(new_n327_));
  nor2   g153(.a(new_n210_), .b(x78), .O(new_n328_));
  oai21  g154(.a(new_n328_), .b(new_n327_), .c(x77), .O(new_n329_));
  nand3  g155(.a(x81), .b(x78), .c(new_n268_), .O(new_n330_));
  nand2  g156(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand4  g157(.a(new_n331_), .b(x84), .c(x79), .d(new_n155_), .O(new_n332_));
  inv1   g158(.a(new_n332_), .O(z65));
  zero   g159(.O(z00));
  zero   g160(.O(z01));
  zero   g161(.O(z02));
  zero   g162(.O(z12));
