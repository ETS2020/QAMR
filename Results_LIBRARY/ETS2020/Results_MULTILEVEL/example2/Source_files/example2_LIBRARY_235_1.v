// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:36 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n289_, new_n293_, new_n295_, new_n297_,
  ...
  nand4  g088(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n229_), .O(new_n248_));
  ...
  nand4  g096(.a(new_n243_), .b(x50), .c(new_n235_), .d(new_n229_), .O(new_n256_));
  ...
  nor2   g113(.a(new_n222_), .b(new_n235_), .O(new_n273_));
  ...
  nand2  g151(.a(new_n321_), .b(new_n238_), .O(new_n322_));
  ...
  nand4  g161(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n333_));
  oai22  g162(.a(new_n333_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n334_));
  nand4  g163(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g164(.a(x79), .b(x78), .O(new_n336_));
  nand3  g165(.a(new_n336_), .b(new_n235_), .c(x40), .O(new_n337_));
  nand2  g166(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g167(.a(new_n338_), .b(x77), .O(new_n339_));
  oai21  g168(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n340_));
  aoi21  g169(.a(new_n340_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g170(.a(new_n160_), .b(new_n229_), .O(new_n342_));
  oai21  g171(.a(new_n342_), .b(new_n336_), .c(x40), .O(new_n343_));
  oai21  g172(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n344_));
  nand2  g173(.a(new_n344_), .b(x79), .O(new_n345_));
  nand3  g174(.a(new_n345_), .b(x78), .c(x04), .O(new_n346_));
  nand2  g175(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand2  g176(.a(new_n347_), .b(x77), .O(new_n348_));
  nand2  g177(.a(new_n154_), .b(new_n229_), .O(new_n349_));
  aoi21  g178(.a(new_n349_), .b(new_n348_), .c(x01), .O(z59));
  nand2  g179(.a(new_n327_), .b(x79), .O(new_n351_));
  nand3  g180(.a(new_n351_), .b(new_n349_), .c(new_n226_), .O(new_n352_));
  and2   g181(.a(new_n352_), .b(new_n153_), .O(z60));
  nand2  g182(.a(new_n167_), .b(new_n325_), .O(new_n354_));
  nand2  g183(.a(new_n354_), .b(new_n218_), .O(new_n355_));
  oai21  g184(.a(new_n231_), .b(x04), .c(new_n355_), .O(new_n356_));
  nand4  g185(.a(new_n356_), .b(x80), .c(x79), .d(new_n153_), .O(new_n357_));
  inv1   g186(.a(new_n357_), .O(z61));
  nand2  g187(.a(new_n154_), .b(x04), .O(new_n359_));
  nand3  g188(.a(x84), .b(x81), .c(x79), .O(new_n360_));
  aoi21  g189(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  nand2  g190(.a(new_n345_), .b(x04), .O(new_n362_));
  nand3  g191(.a(x81), .b(x79), .c(new_n229_), .O(new_n363_));
  aoi21  g192(.a(new_n363_), .b(new_n362_), .c(new_n159_), .O(new_n364_));
  oai21  g193(.a(new_n364_), .b(new_n361_), .c(x78), .O(new_n365_));
  or2    g194(.a(new_n360_), .b(new_n167_), .O(new_n366_));
  aoi21  g195(.a(new_n366_), .b(new_n365_), .c(x01), .O(z62));
  nand4  g196(.a(new_n356_), .b(x82), .c(x79), .d(new_n153_), .O(new_n368_));
  inv1   g197(.a(new_n368_), .O(z63));
  nand3  g198(.a(new_n356_), .b(x83), .c(x79), .O(new_n370_));
  nand4  g199(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n371_));
  aoi21  g200(.a(new_n371_), .b(new_n370_), .c(x01), .O(z64));
  zero   g201(.O(z06));
  zero   g202(.O(z15));
  zero   g203(.O(z16));
  zero   g204(.O(z18));
