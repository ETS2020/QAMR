...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n257_, new_n261_, new_n263_, new_n265_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n278_, new_n279_, new_n280_,
    new_n282_, new_n283_, new_n284_, new_n285_, new_n286_, new_n287_,
    new_n288_, new_n289_, new_n291_, new_n295_, new_n297_, new_n299_,
  ...
  nand4  g106(.a(new_n252_), .b(x48), .c(new_n244_), .d(new_n236_), .O(new_n261_));
  nor2   g107(.a(new_n261_), .b(x01), .O(z30));
  nand4  g108(.a(new_n252_), .b(x49), .c(new_n244_), .d(new_n236_), .O(new_n263_));
  nor2   g109(.a(new_n263_), .b(x01), .O(z31));
  nand4  g110(.a(new_n252_), .b(x50), .c(new_n244_), .d(new_n236_), .O(new_n265_));
  nor2   g111(.a(new_n265_), .b(x01), .O(z32));
  nand2  g112(.a(x83), .b(new_n247_), .O(new_n267_));
  nand2  g113(.a(new_n230_), .b(x81), .O(new_n268_));
  nand2  g114(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand3  g115(.a(new_n269_), .b(x42), .c(x05), .O(new_n270_));
  nand3  g116(.a(x81), .b(x51), .c(new_n244_), .O(new_n271_));
  ...
  nand3  g121(.a(new_n247_), .b(x51), .c(new_n244_), .O(new_n276_));
  ...
  nand4  g125(.a(new_n279_), .b(x78), .c(x77), .d(new_n236_), .O(new_n280_));
  nor2   g126(.a(new_n280_), .b(x01), .O(z33));
  nor2   g127(.a(new_n230_), .b(new_n244_), .O(new_n282_));
  ...
  oai22  g131(.a(new_n282_), .b(new_n247_), .c(new_n267_), .d(new_n244_), .O(new_n286_));
  nand2  g132(.a(new_n286_), .b(new_n245_), .O(new_n287_));
