...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n199_, new_n200_, new_n204_, new_n205_, new_n207_,
    ...
    new_n245_, new_n250_, new_n252_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n278_, new_n280_, new_n283_, new_n285_, new_n287_,
    new_n289_, new_n291_, new_n294_, new_n298_, new_n299_, new_n300_,
  ...
  nand4  g087(.a(new_n240_), .b(x49), .c(new_n232_), .d(new_n226_), .O(new_n250_));
  nor2   g088(.a(new_n250_), .b(x01), .O(z31));
  nand4  g089(.a(new_n240_), .b(x50), .c(new_n232_), .d(new_n226_), .O(new_n252_));
  nor2   g090(.a(new_n252_), .b(x01), .O(z32));
  nand2  g091(.a(x83), .b(new_n235_), .O(new_n254_));
  ...
  nand3  g095(.a(x81), .b(x51), .c(new_n232_), .O(new_n258_));
  nand2  g096(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g097(.a(new_n259_), .b(new_n233_), .O(new_n260_));
  xnor2a g098(.a(x83), .b(x81), .O(new_n261_));
  nand3  g099(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g100(.a(new_n235_), .b(x51), .c(new_n232_), .O(new_n263_));
  ...
  nand4  g104(.a(new_n266_), .b(x78), .c(x77), .d(new_n226_), .O(new_n267_));
  nor2   g105(.a(new_n267_), .b(x01), .O(z33));
  nor2   g106(.a(new_n219_), .b(new_n232_), .O(new_n269_));
  nand3  g107(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  oai21  g108(.a(new_n269_), .b(x81), .c(new_n270_), .O(new_n271_));
  nand2  g109(.a(new_n271_), .b(new_n236_), .O(new_n272_));
  oai22  g110(.a(new_n269_), .b(new_n235_), .c(new_n254_), .d(new_n232_), .O(new_n273_));
  nand2  g111(.a(new_n273_), .b(new_n233_), .O(new_n274_));
  ...
  nand4  g127(.a(new_n275_), .b(x78), .c(x77), .d(x60), .O(new_n291_));
  ...
  nand4  g144(.a(new_n215_), .b(x79), .c(new_n160_), .d(x77), .O(new_n311_));
  ...
  nand2  g187(.a(new_n353_), .b(new_n235_), .O(new_n354_));
  nor4   g188(.a(new_n354_), .b(new_n350_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g189(.a(new_n228_), .b(x76), .O(new_n356_));
  ...
  nand4  g200(.a(x80), .b(new_n217_), .c(x43), .d(new_n232_), .O(new_n367_));
  oai22  g201(.a(new_n367_), .b(new_n220_), .c(new_n232_), .d(x40), .O(new_n368_));
  nand4  g202(.a(new_n368_), .b(x79), .c(x78), .d(x04), .O(new_n369_));
  nor2   g203(.a(x79), .b(x78), .O(new_n370_));
  nand3  g204(.a(new_n370_), .b(new_n232_), .c(x40), .O(new_n371_));
  nand2  g205(.a(new_n371_), .b(new_n369_), .O(new_n372_));
  nand2  g206(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g207(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n374_));
  aoi21  g208(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nor2   g209(.a(new_n160_), .b(new_n226_), .O(new_n376_));
  oai21  g210(.a(new_n376_), .b(new_n370_), .c(x40), .O(new_n377_));
  oai21  g211(.a(new_n220_), .b(new_n218_), .c(new_n232_), .O(new_n378_));
  ...
  nand2  g216(.a(new_n154_), .b(new_n226_), .O(new_n383_));
  aoi21  g217(.a(new_n383_), .b(new_n382_), .c(x01), .O(z59));
  nand2  g218(.a(new_n359_), .b(x79), .O(new_n385_));
  nand3  g219(.a(new_n385_), .b(new_n383_), .c(new_n223_), .O(new_n386_));
  and2   g220(.a(new_n386_), .b(new_n153_), .O(z60));
  nand2  g221(.a(new_n167_), .b(new_n357_), .O(new_n388_));
  nand2  g222(.a(new_n388_), .b(new_n215_), .O(new_n389_));
  oai21  g223(.a(new_n228_), .b(x04), .c(new_n389_), .O(new_n390_));
  ...
  nand3  g230(.a(x81), .b(x79), .c(new_n226_), .O(new_n397_));
