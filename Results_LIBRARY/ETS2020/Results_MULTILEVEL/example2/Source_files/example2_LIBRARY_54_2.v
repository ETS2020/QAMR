...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n277_, new_n278_, new_n279_, new_n280_, new_n282_, new_n286_,
    new_n288_, new_n290_, new_n292_, new_n296_, new_n299_, new_n300_,
  ...
  xnor2a g077(.a(x84), .b(x82), .O(new_n236_));
  ...
  nand2  g082(.a(new_n240_), .b(new_n237_), .O(new_n241_));
  nand4  g083(.a(new_n241_), .b(x79), .c(x78), .d(x77), .O(new_n242_));
  inv1   g084(.a(new_n242_), .O(new_n243_));
  nand4  g085(.a(new_n243_), .b(x44), .c(new_n235_), .d(new_n226_), .O(new_n244_));
  nor2   g086(.a(new_n244_), .b(x01), .O(z26));
  nand4  g087(.a(new_n243_), .b(x45), .c(new_n235_), .d(new_n226_), .O(new_n246_));
  nor2   g088(.a(new_n246_), .b(x01), .O(z27));
  nand4  g089(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n226_), .O(new_n248_));
  nor2   g090(.a(new_n248_), .b(x01), .O(z28));
  nand4  g091(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n226_), .O(new_n250_));
  nor2   g092(.a(new_n250_), .b(x01), .O(z29));
  nand4  g093(.a(new_n243_), .b(x49), .c(new_n235_), .d(new_n226_), .O(new_n253_));
  nor2   g094(.a(new_n253_), .b(x01), .O(z31));
  nand4  g095(.a(new_n243_), .b(x50), .c(new_n235_), .d(new_n226_), .O(new_n255_));
  nor2   g096(.a(new_n255_), .b(x01), .O(z32));
  nand2  g097(.a(x83), .b(new_n238_), .O(new_n257_));
  ...
  nand3  g101(.a(x81), .b(x51), .c(new_n235_), .O(new_n261_));
  ...
  nand3  g106(.a(new_n238_), .b(x51), .c(new_n235_), .O(new_n266_));
  nand2  g107(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  nand2  g108(.a(new_n267_), .b(new_n239_), .O(new_n268_));
  ...
  nor2   g112(.a(new_n220_), .b(new_n235_), .O(new_n273_));
  nand3  g113(.a(x83), .b(x81), .c(x42), .O(new_n274_));
  oai21  g114(.a(new_n273_), .b(x81), .c(new_n274_), .O(new_n275_));
  nand2  g115(.a(new_n275_), .b(new_n239_), .O(new_n276_));
  oai22  g116(.a(new_n273_), .b(new_n238_), .c(new_n257_), .d(new_n235_), .O(new_n277_));
  nand2  g117(.a(new_n277_), .b(new_n236_), .O(new_n278_));
  aoi21  g118(.a(new_n278_), .b(new_n276_), .c(new_n154_), .O(new_n279_));
  nand4  g119(.a(new_n279_), .b(x78), .c(x77), .d(x53), .O(new_n280_));
  nor3   g120(.a(new_n280_), .b(x04), .c(x01), .O(z35));
  nand4  g121(.a(new_n279_), .b(x78), .c(x77), .d(x54), .O(new_n282_));
  nor3   g122(.a(new_n282_), .b(x04), .c(x01), .O(z36));
  nand4  g123(.a(new_n279_), .b(x78), .c(x77), .d(x57), .O(new_n286_));
  nor3   g124(.a(new_n286_), .b(x04), .c(x01), .O(z39));
  nand4  g125(.a(new_n279_), .b(x78), .c(x77), .d(x58), .O(new_n288_));
  nor3   g126(.a(new_n288_), .b(x04), .c(x01), .O(z40));
  nand4  g127(.a(new_n279_), .b(x78), .c(x77), .d(x59), .O(new_n290_));
  nor3   g128(.a(new_n290_), .b(x04), .c(x01), .O(z41));
  nand4  g129(.a(new_n279_), .b(x78), .c(x77), .d(x60), .O(new_n292_));
  nor3   g130(.a(new_n292_), .b(x04), .c(x01), .O(z42));
  nand4  g131(.a(new_n279_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  ...
  nand2  g151(.a(new_n300_), .b(x10), .O(new_n318_));
  ...
  nand2  g157(.a(new_n300_), .b(x11), .O(new_n324_));
  ...
  nand2  g162(.a(x52), .b(x20), .O(new_n329_));
  nand2  g163(.a(new_n300_), .b(x12), .O(new_n330_));
  aoi21  g164(.a(new_n330_), .b(new_n329_), .c(x79), .O(new_n331_));
  nand4  g165(.a(new_n331_), .b(x78), .c(new_n159_), .d(x04), .O(new_n332_));
  nand2  g166(.a(new_n313_), .b(x72), .O(new_n333_));
  aoi21  g167(.a(new_n333_), .b(new_n332_), .c(x01), .O(z52));
  nand2  g168(.a(x52), .b(x21), .O(new_n335_));
  nand2  g169(.a(new_n300_), .b(x13), .O(new_n336_));
  aoi21  g170(.a(new_n336_), .b(new_n335_), .c(x79), .O(new_n337_));
  nand4  g171(.a(new_n337_), .b(x78), .c(new_n159_), .d(x04), .O(new_n338_));
  nand2  g172(.a(new_n313_), .b(x73), .O(new_n339_));
  aoi21  g173(.a(new_n339_), .b(new_n338_), .c(x01), .O(z53));
  nand2  g174(.a(x52), .b(x22), .O(new_n341_));
  nand2  g175(.a(new_n300_), .b(x14), .O(new_n342_));
  aoi21  g176(.a(new_n342_), .b(new_n341_), .c(x79), .O(new_n343_));
  nand4  g177(.a(new_n343_), .b(x78), .c(new_n159_), .d(x04), .O(new_n344_));
  nor2   g178(.a(new_n344_), .b(x01), .O(z54));
  inv1   g179(.a(x84), .O(new_n346_));
  nor2   g180(.a(x04), .b(x01), .O(new_n347_));
  nand4  g181(.a(new_n347_), .b(x79), .c(x78), .d(x77), .O(new_n348_));
  nor2   g182(.a(new_n348_), .b(x80), .O(new_n349_));
  nand2  g183(.a(new_n349_), .b(new_n238_), .O(new_n350_));
  nor4   g184(.a(new_n350_), .b(new_n346_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g185(.a(new_n230_), .b(x76), .O(new_n352_));
  inv1   g186(.a(new_n165_), .O(new_n353_));
  xnor2a g187(.a(x84), .b(x81), .O(new_n354_));
  aoi21  g188(.a(new_n167_), .b(new_n353_), .c(new_n354_), .O(new_n355_));
  ...
  nand4  g192(.a(new_n358_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g193(.a(x02), .O(new_n360_));
  nand4  g194(.a(x03), .b(new_n360_), .c(new_n153_), .d(x00), .O(new_n361_));
  inv1   g195(.a(new_n361_), .O(z57));
  nand4  g196(.a(x80), .b(new_n218_), .c(x43), .d(new_n235_), .O(new_n363_));
  oai22  g197(.a(new_n363_), .b(new_n221_), .c(new_n235_), .d(x40), .O(new_n364_));
  nand4  g198(.a(new_n364_), .b(x79), .c(x78), .d(x04), .O(new_n365_));
  nor2   g199(.a(x79), .b(x78), .O(new_n366_));
  nand3  g200(.a(new_n366_), .b(new_n235_), .c(x40), .O(new_n367_));
  nand2  g201(.a(new_n367_), .b(new_n365_), .O(new_n368_));
  nand2  g202(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g203(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n370_));
  aoi21  g204(.a(new_n370_), .b(new_n369_), .c(x01), .O(z58));
  nor2   g205(.a(new_n160_), .b(new_n226_), .O(new_n372_));
  oai21  g206(.a(new_n372_), .b(new_n366_), .c(x40), .O(new_n373_));
  oai21  g207(.a(new_n221_), .b(new_n219_), .c(new_n235_), .O(new_n374_));
  nand2  g208(.a(new_n374_), .b(x79), .O(new_n375_));
  nand3  g209(.a(new_n375_), .b(x78), .c(x04), .O(new_n376_));
  nand2  g210(.a(new_n376_), .b(new_n373_), .O(new_n377_));
  nand2  g211(.a(new_n377_), .b(x77), .O(new_n378_));
  nand2  g212(.a(new_n154_), .b(new_n226_), .O(new_n379_));
  aoi21  g213(.a(new_n379_), .b(new_n378_), .c(x01), .O(z59));
  nand2  g214(.a(new_n355_), .b(x79), .O(new_n381_));
  nand3  g215(.a(new_n381_), .b(new_n379_), .c(new_n224_), .O(new_n382_));
  and2   g216(.a(new_n382_), .b(new_n153_), .O(z60));
  nand2  g217(.a(new_n167_), .b(new_n353_), .O(new_n384_));
  nand2  g218(.a(new_n384_), .b(new_n216_), .O(new_n385_));
  oai21  g219(.a(new_n230_), .b(x04), .c(new_n385_), .O(new_n386_));
  nand4  g220(.a(new_n386_), .b(x80), .c(x79), .d(new_n153_), .O(new_n387_));
  inv1   g221(.a(new_n387_), .O(z61));
  nand2  g222(.a(new_n154_), .b(x04), .O(new_n389_));
  nand3  g223(.a(x84), .b(x81), .c(x79), .O(new_n390_));
  aoi21  g224(.a(new_n390_), .b(new_n389_), .c(x77), .O(new_n391_));
  nand2  g225(.a(new_n375_), .b(x04), .O(new_n392_));
  nand3  g226(.a(x81), .b(x79), .c(new_n226_), .O(new_n393_));
  aoi21  g227(.a(new_n393_), .b(new_n392_), .c(new_n159_), .O(new_n394_));
  oai21  g228(.a(new_n394_), .b(new_n391_), .c(x78), .O(new_n395_));
  or2    g229(.a(new_n390_), .b(new_n167_), .O(new_n396_));
  aoi21  g230(.a(new_n396_), .b(new_n395_), .c(x01), .O(z62));
  nand4  g231(.a(new_n386_), .b(x82), .c(x79), .d(new_n153_), .O(new_n398_));
  inv1   g232(.a(new_n398_), .O(z63));
  nand3  g233(.a(new_n386_), .b(x83), .c(x79), .O(new_n400_));
  nand4  g234(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n401_));
  aoi21  g235(.a(new_n401_), .b(new_n400_), .c(x01), .O(z64));
  nor2   g236(.a(new_n160_), .b(x04), .O(new_n403_));
  nor2   g237(.a(new_n238_), .b(x78), .O(new_n404_));
  oai21  g238(.a(new_n404_), .b(new_n403_), .c(x77), .O(new_n405_));
  nand3  g239(.a(x81), .b(x78), .c(new_n159_), .O(new_n406_));
  nand2  g240(.a(new_n406_), .b(new_n405_), .O(new_n407_));
  nand4  g241(.a(new_n407_), .b(x84), .c(x79), .d(new_n153_), .O(new_n408_));
  inv1   g242(.a(new_n408_), .O(z65));
  zero   g243(.O(z06));
  zero   g244(.O(z07));
  zero   g245(.O(z08));
  zero   g246(.O(z14));
