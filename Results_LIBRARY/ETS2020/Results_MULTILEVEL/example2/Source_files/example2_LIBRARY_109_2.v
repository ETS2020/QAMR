...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n182_, new_n183_, new_n185_, new_n186_, new_n188_,
    ...
    new_n285_, new_n289_, new_n291_, new_n293_, new_n297_, new_n299_,
  ...
  nand4  g124(.a(new_n280_), .b(x78), .c(x77), .d(x55), .O(new_n285_));
  ...
  nor2   g142(.a(new_n306_), .b(new_n216_), .O(new_n307_));
  ...
  nand4  g149(.a(new_n217_), .b(x79), .c(new_n160_), .d(x77), .O(new_n314_));
  ...
  nand2  g192(.a(new_n356_), .b(new_n238_), .O(new_n357_));
  nor4   g193(.a(new_n357_), .b(new_n353_), .c(new_n221_), .d(x82), .O(z55));
  nand2  g194(.a(new_n231_), .b(x76), .O(new_n359_));
  ...
  nand4  g205(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n370_));
  oai22  g206(.a(new_n370_), .b(new_n222_), .c(new_n235_), .d(x40), .O(new_n371_));
  nand4  g207(.a(new_n371_), .b(x79), .c(x78), .d(x04), .O(new_n372_));
  nor2   g208(.a(x79), .b(x78), .O(new_n373_));
  nand3  g209(.a(new_n373_), .b(new_n235_), .c(x40), .O(new_n374_));
  nand2  g210(.a(new_n374_), .b(new_n372_), .O(new_n375_));
  nand2  g211(.a(new_n375_), .b(x77), .O(new_n376_));
  oai21  g212(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n377_));
  aoi21  g213(.a(new_n377_), .b(new_n376_), .c(x01), .O(z58));
  nor2   g214(.a(new_n160_), .b(new_n227_), .O(new_n379_));
  oai21  g215(.a(new_n379_), .b(new_n373_), .c(x40), .O(new_n380_));
  oai21  g216(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n381_));
  ...
  nand2  g221(.a(new_n154_), .b(new_n227_), .O(new_n386_));
  aoi21  g222(.a(new_n386_), .b(new_n385_), .c(x01), .O(z59));
  nand2  g223(.a(new_n362_), .b(x79), .O(new_n388_));
  nand3  g224(.a(new_n388_), .b(new_n386_), .c(new_n225_), .O(new_n389_));
  and2   g225(.a(new_n389_), .b(new_n153_), .O(z60));
  nand2  g226(.a(new_n167_), .b(new_n360_), .O(new_n391_));
  nand2  g227(.a(new_n391_), .b(new_n217_), .O(new_n392_));
  oai21  g228(.a(new_n231_), .b(x04), .c(new_n392_), .O(new_n393_));
  ...
  nand3  g235(.a(x81), .b(x79), .c(new_n227_), .O(new_n400_));
