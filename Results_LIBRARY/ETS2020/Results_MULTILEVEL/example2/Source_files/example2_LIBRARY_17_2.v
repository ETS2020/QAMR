...
module FAU ( 
  ...
  nand4  g216(.a(x80), .b(new_n222_), .c(x43), .d(new_n237_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n225_), .c(new_n237_), .d(x40), .O(new_n377_));
  ...
  oai21  g227(.a(new_n225_), .b(new_n223_), .c(new_n237_), .O(new_n387_));
  ...
  nand3  g235(.a(new_n394_), .b(new_n392_), .c(new_n228_), .O(new_n395_));
  and2   g236(.a(new_n395_), .b(new_n153_), .O(z60));
  nand2  g237(.a(new_n167_), .b(new_n366_), .O(new_n397_));
  nand2  g238(.a(new_n397_), .b(new_n220_), .O(new_n398_));
