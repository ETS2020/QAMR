...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n285_, new_n288_, new_n291_, new_n293_, new_n295_, new_n297_,
  ...
  nand3  g076(.a(new_n232_), .b(x05), .c(new_n229_), .O(new_n233_));
  ...
  nand4  g087(.a(new_n243_), .b(new_n235_), .c(x05), .d(new_n229_), .O(new_n244_));
  nor2   g088(.a(new_n244_), .b(x01), .O(z25));
  nand4  g089(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n229_), .O(new_n248_));
  nor2   g090(.a(new_n248_), .b(x01), .O(z28));
  nand4  g091(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n229_), .O(new_n250_));
  nor2   g092(.a(new_n250_), .b(x01), .O(z29));
  nand4  g093(.a(new_n243_), .b(x48), .c(new_n235_), .d(new_n229_), .O(new_n252_));
  nor2   g094(.a(new_n252_), .b(x01), .O(z30));
  nand4  g095(.a(new_n243_), .b(x49), .c(new_n235_), .d(new_n229_), .O(new_n254_));
  nor2   g096(.a(new_n254_), .b(x01), .O(z31));
  nand2  g097(.a(x83), .b(new_n238_), .O(new_n257_));
  nand2  g098(.a(new_n222_), .b(x81), .O(new_n258_));
  ...
  aoi21  g109(.a(new_n268_), .b(new_n263_), .c(new_n156_), .O(new_n269_));
  nand4  g110(.a(new_n269_), .b(x78), .c(x77), .d(new_n229_), .O(new_n270_));
  nor2   g111(.a(new_n270_), .b(x01), .O(z33));
  nor2   g112(.a(new_n222_), .b(new_n235_), .O(new_n272_));
  nand3  g113(.a(x83), .b(x81), .c(x42), .O(new_n273_));
  oai21  g114(.a(new_n272_), .b(x81), .c(new_n273_), .O(new_n274_));
  nand2  g115(.a(new_n274_), .b(new_n239_), .O(new_n275_));
  oai22  g116(.a(new_n272_), .b(new_n238_), .c(new_n257_), .d(new_n235_), .O(new_n276_));
  nand2  g117(.a(new_n276_), .b(new_n236_), .O(new_n277_));
  aoi21  g118(.a(new_n277_), .b(new_n275_), .c(new_n156_), .O(new_n278_));
  ...
  nand4  g145(.a(new_n306_), .b(x78), .c(new_n153_), .d(x04), .O(new_n307_));
  nor2   g146(.a(x75), .b(x67), .O(new_n308_));
  nor2   g147(.a(new_n308_), .b(new_n217_), .O(new_n309_));
  nand4  g148(.a(new_n309_), .b(x79), .c(new_n154_), .d(x77), .O(new_n310_));
  aoi21  g149(.a(new_n310_), .b(new_n307_), .c(x01), .O(z47));
  nand2  g150(.a(x52), .b(x22), .O(new_n318_));
  nand2  g151(.a(new_n304_), .b(x14), .O(new_n319_));
  aoi21  g152(.a(new_n319_), .b(new_n318_), .c(x79), .O(new_n320_));
  nand4  g153(.a(new_n320_), .b(x78), .c(new_n153_), .d(x04), .O(new_n321_));
  nor2   g154(.a(new_n321_), .b(x01), .O(z54));
  inv1   g155(.a(x84), .O(new_n323_));
  nor2   g156(.a(x04), .b(x01), .O(new_n324_));
  nand4  g157(.a(new_n324_), .b(x79), .c(x78), .d(x77), .O(new_n325_));
  nor2   g158(.a(new_n325_), .b(x80), .O(new_n326_));
  nand2  g159(.a(new_n326_), .b(new_n238_), .O(new_n327_));
  nor4   g160(.a(new_n327_), .b(new_n323_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g161(.a(new_n231_), .b(x76), .O(new_n329_));
  inv1   g162(.a(new_n161_), .O(new_n330_));
  xnor2a g163(.a(x84), .b(x81), .O(new_n331_));
  aoi21  g164(.a(new_n163_), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g165(.a(new_n332_), .b(new_n159_), .O(new_n333_));
  nand2  g166(.a(new_n333_), .b(new_n329_), .O(new_n334_));
  nand2  g167(.a(new_n334_), .b(x79), .O(new_n335_));
  nand4  g168(.a(new_n335_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  inv1   g169(.a(x02), .O(new_n337_));
  nand4  g170(.a(x03), .b(new_n337_), .c(new_n159_), .d(x00), .O(new_n338_));
  inv1   g171(.a(new_n338_), .O(z57));
  nand4  g172(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n340_));
  oai22  g173(.a(new_n340_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n341_));
  nand4  g174(.a(new_n341_), .b(x79), .c(x78), .d(x04), .O(new_n342_));
  nor2   g175(.a(x79), .b(x78), .O(new_n343_));
  nand3  g176(.a(new_n343_), .b(new_n235_), .c(x40), .O(new_n344_));
  nand2  g177(.a(new_n344_), .b(new_n342_), .O(new_n345_));
  nand2  g178(.a(new_n345_), .b(x77), .O(new_n346_));
  oai21  g179(.a(new_n161_), .b(new_n229_), .c(new_n156_), .O(new_n347_));
  aoi21  g180(.a(new_n347_), .b(new_n346_), .c(x01), .O(z58));
  nor2   g181(.a(new_n154_), .b(new_n229_), .O(new_n349_));
  oai21  g182(.a(new_n349_), .b(new_n343_), .c(x40), .O(new_n350_));
  oai21  g183(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n351_));
  nand2  g184(.a(new_n351_), .b(x79), .O(new_n352_));
  nand3  g185(.a(new_n352_), .b(x78), .c(x04), .O(new_n353_));
  nand2  g186(.a(new_n353_), .b(new_n350_), .O(new_n354_));
  nand2  g187(.a(new_n354_), .b(x77), .O(new_n355_));
  nand2  g188(.a(new_n156_), .b(new_n229_), .O(new_n356_));
  aoi21  g189(.a(new_n356_), .b(new_n355_), .c(x01), .O(z59));
  nand2  g190(.a(new_n332_), .b(x79), .O(new_n358_));
  nand3  g191(.a(new_n358_), .b(new_n356_), .c(new_n226_), .O(new_n359_));
  and2   g192(.a(new_n359_), .b(new_n159_), .O(z60));
  nand2  g193(.a(new_n163_), .b(new_n330_), .O(new_n361_));
  nand2  g194(.a(new_n361_), .b(new_n218_), .O(new_n362_));
  oai21  g195(.a(new_n231_), .b(x04), .c(new_n362_), .O(new_n363_));
  nand4  g196(.a(new_n363_), .b(x80), .c(x79), .d(new_n159_), .O(new_n364_));
  inv1   g197(.a(new_n364_), .O(z61));
  nand2  g198(.a(new_n156_), .b(x04), .O(new_n366_));
  nand3  g199(.a(x84), .b(x81), .c(x79), .O(new_n367_));
  aoi21  g200(.a(new_n367_), .b(new_n366_), .c(x77), .O(new_n368_));
  nand2  g201(.a(new_n352_), .b(x04), .O(new_n369_));
  nand3  g202(.a(x81), .b(x79), .c(new_n229_), .O(new_n370_));
  aoi21  g203(.a(new_n370_), .b(new_n369_), .c(new_n153_), .O(new_n371_));
  oai21  g204(.a(new_n371_), .b(new_n368_), .c(x78), .O(new_n372_));
  or2    g205(.a(new_n367_), .b(new_n163_), .O(new_n373_));
  aoi21  g206(.a(new_n373_), .b(new_n372_), .c(x01), .O(z62));
  nand4  g207(.a(new_n363_), .b(x82), .c(x79), .d(new_n159_), .O(new_n375_));
  inv1   g208(.a(new_n375_), .O(z63));
  nand3  g209(.a(new_n363_), .b(x83), .c(x79), .O(new_n377_));
  nand4  g210(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n378_));
  aoi21  g211(.a(new_n378_), .b(new_n377_), .c(x01), .O(z64));
  nor2   g212(.a(new_n154_), .b(x04), .O(new_n380_));
  nor2   g213(.a(new_n238_), .b(x78), .O(new_n381_));
  oai21  g214(.a(new_n381_), .b(new_n380_), .c(x77), .O(new_n382_));
  nand3  g215(.a(x81), .b(x78), .c(new_n153_), .O(new_n383_));
  nand2  g216(.a(new_n383_), .b(new_n382_), .O(new_n384_));
  nand4  g217(.a(new_n384_), .b(x84), .c(x79), .d(new_n159_), .O(new_n385_));
  inv1   g218(.a(new_n385_), .O(z65));
  zero   g219(.O(z00));
  zero   g220(.O(z05));
  zero   g221(.O(z14));
  zero   g222(.O(z19));
