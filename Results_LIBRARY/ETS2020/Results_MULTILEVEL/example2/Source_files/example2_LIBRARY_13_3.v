...
module FAU ( 
  ...
  nand4  g101(.a(new_n248_), .b(x47), .c(new_n240_), .d(new_n234_), .O(new_n257_));
  nor2   g102(.a(new_n257_), .b(x01), .O(z29));
  nand4  g103(.a(new_n248_), .b(x48), .c(new_n240_), .d(new_n234_), .O(new_n259_));
  nor2   g104(.a(new_n259_), .b(x01), .O(z30));
  nand4  g105(.a(new_n248_), .b(x49), .c(new_n240_), .d(new_n234_), .O(new_n261_));
  nor2   g106(.a(new_n261_), .b(x01), .O(z31));
  nand4  g107(.a(new_n248_), .b(x50), .c(new_n240_), .d(new_n234_), .O(new_n263_));
  ...
  nor2   g124(.a(new_n227_), .b(new_n240_), .O(new_n280_));
  ...
  nand4  g220(.a(x80), .b(new_n225_), .c(x43), .d(new_n240_), .O(new_n379_));
  oai22  g221(.a(new_n379_), .b(new_n228_), .c(new_n240_), .d(x40), .O(new_n380_));
  ...
  oai21  g231(.a(new_n228_), .b(new_n226_), .c(new_n240_), .O(new_n390_));
