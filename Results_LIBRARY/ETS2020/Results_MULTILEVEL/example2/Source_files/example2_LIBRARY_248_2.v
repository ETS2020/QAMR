...
module FAU ( 
  ...
  nand4  g213(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n375_));
  oai22  g214(.a(new_n375_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n376_));
  ...
  oai21  g224(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n386_));
  ...
  nand3  g232(.a(new_n393_), .b(new_n391_), .c(new_n231_), .O(new_n394_));
  and2   g233(.a(new_n394_), .b(new_n153_), .O(z60));
  nand2  g234(.a(new_n167_), .b(new_n367_), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(new_n223_), .O(new_n397_));
