...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n250_, new_n252_, new_n254_, new_n258_, new_n260_,
    new_n262_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n280_, new_n281_, new_n282_,
    new_n283_, new_n284_, new_n285_, new_n286_, new_n287_, new_n289_,
    new_n291_, new_n293_, new_n296_, new_n298_, new_n300_, new_n303_,
  ...
  nor2   g122(.a(new_n227_), .b(new_n241_), .O(new_n280_));
  nand3  g123(.a(x83), .b(x81), .c(x42), .O(new_n281_));
  oai21  g124(.a(new_n280_), .b(x81), .c(new_n281_), .O(new_n282_));
  nand2  g125(.a(new_n282_), .b(new_n245_), .O(new_n283_));
  oai22  g126(.a(new_n280_), .b(new_n244_), .c(new_n264_), .d(new_n241_), .O(new_n284_));
  nand2  g127(.a(new_n284_), .b(new_n242_), .O(new_n285_));
  ...
  nand4  g131(.a(new_n286_), .b(x78), .c(x77), .d(x54), .O(new_n289_));
  nor3   g132(.a(new_n289_), .b(x04), .c(x01), .O(z36));
  nand4  g133(.a(new_n286_), .b(x78), .c(x77), .d(x55), .O(new_n291_));
  ...
  nand4  g137(.a(new_n286_), .b(x78), .c(x77), .d(x58), .O(new_n296_));
  nor3   g138(.a(new_n296_), .b(x04), .c(x01), .O(z40));
  nand4  g139(.a(new_n286_), .b(x78), .c(x77), .d(x59), .O(new_n298_));
  nor3   g140(.a(new_n298_), .b(x04), .c(x01), .O(z41));
  nand4  g141(.a(new_n286_), .b(x78), .c(x77), .d(x60), .O(new_n300_));
  ...
  nand4  g162(.a(new_n223_), .b(x79), .c(new_n160_), .d(x77), .O(new_n322_));
  ...
  nand2  g205(.a(new_n364_), .b(new_n244_), .O(new_n365_));
  nor4   g206(.a(new_n365_), .b(new_n361_), .c(new_n227_), .d(x82), .O(z55));
  nand2  g207(.a(new_n237_), .b(x76), .O(new_n367_));
  ...
  nand4  g218(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n378_));
  oai22  g219(.a(new_n378_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n379_));
  nand4  g220(.a(new_n379_), .b(x79), .c(x78), .d(x04), .O(new_n380_));
  nor2   g221(.a(x79), .b(x78), .O(new_n381_));
  nand3  g222(.a(new_n381_), .b(new_n241_), .c(x40), .O(new_n382_));
  nand2  g223(.a(new_n382_), .b(new_n380_), .O(new_n383_));
  nand2  g224(.a(new_n383_), .b(x77), .O(new_n384_));
  oai21  g225(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n385_));
  aoi21  g226(.a(new_n385_), .b(new_n384_), .c(x01), .O(z58));
  nor2   g227(.a(new_n160_), .b(new_n233_), .O(new_n387_));
  oai21  g228(.a(new_n387_), .b(new_n381_), .c(x40), .O(new_n388_));
  oai21  g229(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n389_));
  ...
  nand2  g234(.a(new_n154_), .b(new_n233_), .O(new_n394_));
  aoi21  g235(.a(new_n394_), .b(new_n393_), .c(x01), .O(z59));
  nand2  g236(.a(new_n370_), .b(x79), .O(new_n396_));
  nand3  g237(.a(new_n396_), .b(new_n394_), .c(new_n231_), .O(new_n397_));
  and2   g238(.a(new_n397_), .b(new_n153_), .O(z60));
  nand2  g239(.a(new_n167_), .b(new_n368_), .O(new_n399_));
  nand2  g240(.a(new_n399_), .b(new_n223_), .O(new_n400_));
  oai21  g241(.a(new_n237_), .b(x04), .c(new_n400_), .O(new_n401_));
  ...
  nand3  g248(.a(x81), .b(x79), .c(new_n233_), .O(new_n408_));
  ...
  nor2   g259(.a(new_n244_), .b(x78), .O(new_n419_));
