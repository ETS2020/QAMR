...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n194_, new_n196_, new_n197_, new_n199_, new_n200_, new_n206_,
  ...
  nand4  g088(.a(new_n243_), .b(x45), .c(new_n235_), .d(new_n227_), .O(new_n247_));
  ...
  nand3  g184(.a(new_n353_), .b(new_n351_), .c(new_n225_), .O(new_n354_));
  and2   g185(.a(new_n354_), .b(new_n153_), .O(z60));
  nand2  g186(.a(new_n167_), .b(new_n327_), .O(new_n356_));
  nand2  g187(.a(new_n356_), .b(new_n217_), .O(new_n357_));
  oai21  g188(.a(new_n231_), .b(x04), .c(new_n357_), .O(new_n358_));
  ...
  nand3  g195(.a(x81), .b(x79), .c(new_n227_), .O(new_n365_));
