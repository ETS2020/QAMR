...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n250_, new_n253_, new_n255_, new_n258_, new_n260_,
    new_n262_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n284_, new_n285_, new_n286_, new_n288_,
    new_n290_, new_n293_, new_n295_, new_n297_, new_n299_, new_n302_,
  ...
  nand4  g097(.a(new_n249_), .b(x45), .c(new_n241_), .d(new_n233_), .O(new_n253_));
  nor2   g098(.a(new_n253_), .b(x01), .O(z27));
  nand4  g099(.a(new_n249_), .b(x46), .c(new_n241_), .d(new_n233_), .O(new_n255_));
  nor2   g100(.a(new_n255_), .b(x01), .O(z28));
  nand4  g101(.a(new_n249_), .b(x48), .c(new_n241_), .d(new_n233_), .O(new_n258_));
  ...
  nand4  g145(.a(new_n285_), .b(x78), .c(x77), .d(x63), .O(new_n305_));
