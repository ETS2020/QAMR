...
module FAU ( 
  ...
  nand4  g112(.a(new_n266_), .b(x78), .c(x77), .d(x60), .O(new_n281_));
  nor3   g113(.a(new_n281_), .b(x04), .c(x01), .O(z42));
  nand4  g114(.a(new_n266_), .b(x78), .c(x77), .d(x61), .O(new_n283_));
  nor3   g115(.a(new_n283_), .b(x04), .c(x01), .O(z43));
  nand4  g116(.a(new_n266_), .b(x78), .c(x77), .d(x63), .O(new_n286_));
