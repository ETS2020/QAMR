...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n178_, new_n180_, new_n181_, new_n184_, new_n185_, new_n188_,
    ...
    new_n237_, new_n241_, new_n243_, new_n245_, new_n247_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n274_, new_n276_, new_n278_,
    new_n281_, new_n284_, new_n286_, new_n288_, new_n290_, new_n292_,
    new_n294_, new_n296_, new_n297_, new_n298_, new_n299_, new_n300_,
    new_n301_, new_n302_, new_n303_, new_n311_, new_n312_, new_n313_,
  ...
  nor2   g062(.a(new_n154_), .b(new_n153_), .O(new_n223_));
  inv1   g063(.a(new_n223_), .O(new_n224_));
  aoi21  g064(.a(new_n224_), .b(x79), .c(x43), .O(new_n225_));
  nand3  g065(.a(new_n225_), .b(x05), .c(new_n222_), .O(new_n226_));
  ...
  nand4  g076(.a(new_n236_), .b(new_n228_), .c(x05), .d(new_n222_), .O(new_n237_));
  nor2   g077(.a(new_n237_), .b(x01), .O(z25));
  nand4  g078(.a(new_n236_), .b(x46), .c(new_n228_), .d(new_n222_), .O(new_n241_));
  nor2   g079(.a(new_n241_), .b(x01), .O(z28));
  nand4  g080(.a(new_n236_), .b(x47), .c(new_n228_), .d(new_n222_), .O(new_n243_));
  nor2   g081(.a(new_n243_), .b(x01), .O(z29));
  nand4  g082(.a(new_n236_), .b(x48), .c(new_n228_), .d(new_n222_), .O(new_n245_));
  nor2   g083(.a(new_n245_), .b(x01), .O(z30));
  nand4  g084(.a(new_n236_), .b(x49), .c(new_n228_), .d(new_n222_), .O(new_n247_));
  ...
  nand4  g099(.a(new_n262_), .b(x78), .c(x77), .d(new_n222_), .O(new_n263_));
  nor2   g100(.a(new_n263_), .b(x01), .O(z33));
  nor2   g101(.a(new_n215_), .b(new_n228_), .O(new_n265_));
  ...
  aoi21  g107(.a(new_n270_), .b(new_n268_), .c(new_n156_), .O(new_n271_));
  ...
  nand4  g114(.a(new_n271_), .b(x78), .c(x77), .d(x55), .O(new_n278_));
  nor3   g115(.a(new_n278_), .b(x04), .c(x01), .O(z37));
  nand4  g116(.a(new_n271_), .b(x78), .c(x77), .d(x57), .O(new_n281_));
  ...
  nand4  g120(.a(new_n271_), .b(x78), .c(x77), .d(x60), .O(new_n286_));
  nor3   g121(.a(new_n286_), .b(x04), .c(x01), .O(z42));
  nand4  g122(.a(new_n271_), .b(x78), .c(x77), .d(x61), .O(new_n288_));
  nor3   g123(.a(new_n288_), .b(x04), .c(x01), .O(z43));
  nand4  g124(.a(new_n271_), .b(x78), .c(x77), .d(x62), .O(new_n290_));
  nor3   g125(.a(new_n290_), .b(x04), .c(x01), .O(z44));
  nand4  g126(.a(new_n271_), .b(x78), .c(x77), .d(x63), .O(new_n292_));
  nor3   g127(.a(new_n292_), .b(x04), .c(x01), .O(z45));
  nand4  g128(.a(new_n271_), .b(x78), .c(x77), .d(x64), .O(new_n294_));
  ...
  nand4  g134(.a(new_n299_), .b(x78), .c(new_n153_), .d(x04), .O(new_n300_));
  nor2   g135(.a(x75), .b(x67), .O(new_n301_));
  nor2   g136(.a(new_n301_), .b(new_n210_), .O(new_n302_));
  nand4  g137(.a(new_n302_), .b(x79), .c(new_n154_), .d(x77), .O(new_n303_));
  aoi21  g138(.a(new_n303_), .b(new_n300_), .c(x01), .O(z47));
  nand2  g139(.a(x52), .b(x22), .O(new_n311_));
  nand2  g140(.a(new_n297_), .b(x14), .O(new_n312_));
  aoi21  g141(.a(new_n312_), .b(new_n311_), .c(x79), .O(new_n313_));
  nand4  g142(.a(new_n313_), .b(x78), .c(new_n153_), .d(x04), .O(new_n314_));
  nor2   g143(.a(new_n314_), .b(x01), .O(z54));
  inv1   g144(.a(x84), .O(new_n316_));
  nor2   g145(.a(x04), .b(x01), .O(new_n317_));
  nand4  g146(.a(new_n317_), .b(x79), .c(x78), .d(x77), .O(new_n318_));
  nor2   g147(.a(new_n318_), .b(x80), .O(new_n319_));
  nand2  g148(.a(new_n319_), .b(new_n231_), .O(new_n320_));
  nor4   g149(.a(new_n320_), .b(new_n316_), .c(new_n215_), .d(x82), .O(z55));
  nand2  g150(.a(new_n224_), .b(x76), .O(new_n322_));
  inv1   g151(.a(new_n161_), .O(new_n323_));
  xnor2a g152(.a(x84), .b(x81), .O(new_n324_));
  aoi21  g153(.a(new_n163_), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g154(.a(new_n325_), .b(new_n159_), .O(new_n326_));
  nand2  g155(.a(new_n326_), .b(new_n322_), .O(new_n327_));
  nand2  g156(.a(new_n327_), .b(x79), .O(new_n328_));
  nand4  g157(.a(new_n328_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  inv1   g158(.a(x02), .O(new_n330_));
  nand4  g159(.a(x03), .b(new_n330_), .c(new_n159_), .d(x00), .O(new_n331_));
  inv1   g160(.a(new_n331_), .O(z57));
  nand4  g161(.a(x80), .b(new_n213_), .c(x43), .d(new_n228_), .O(new_n333_));
  oai22  g162(.a(new_n333_), .b(new_n216_), .c(new_n228_), .d(x40), .O(new_n334_));
  nand4  g163(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g164(.a(x79), .b(x78), .O(new_n336_));
  nand3  g165(.a(new_n336_), .b(new_n228_), .c(x40), .O(new_n337_));
  nand2  g166(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g167(.a(new_n338_), .b(x77), .O(new_n339_));
  oai21  g168(.a(new_n161_), .b(new_n222_), .c(new_n156_), .O(new_n340_));
  aoi21  g169(.a(new_n340_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g170(.a(new_n154_), .b(new_n222_), .O(new_n342_));
  oai21  g171(.a(new_n342_), .b(new_n336_), .c(x40), .O(new_n343_));
  oai21  g172(.a(new_n216_), .b(new_n214_), .c(new_n228_), .O(new_n344_));
  ...
  nand2  g177(.a(new_n156_), .b(new_n222_), .O(new_n349_));
  aoi21  g178(.a(new_n349_), .b(new_n348_), .c(x01), .O(z59));
  nand2  g179(.a(new_n325_), .b(x79), .O(new_n351_));
  nand3  g180(.a(new_n351_), .b(new_n349_), .c(new_n219_), .O(new_n352_));
  and2   g181(.a(new_n352_), .b(new_n159_), .O(z60));
  nand2  g182(.a(new_n163_), .b(new_n323_), .O(new_n354_));
  nand2  g183(.a(new_n354_), .b(new_n211_), .O(new_n355_));
  oai21  g184(.a(new_n224_), .b(x04), .c(new_n355_), .O(new_n356_));
  nand4  g185(.a(new_n356_), .b(x80), .c(x79), .d(new_n159_), .O(new_n357_));
  inv1   g186(.a(new_n357_), .O(z61));
  nand2  g187(.a(new_n156_), .b(x04), .O(new_n359_));
  ...
  nand3  g191(.a(x81), .b(x79), .c(new_n222_), .O(new_n363_));
  aoi21  g192(.a(new_n363_), .b(new_n362_), .c(new_n153_), .O(new_n364_));
  oai21  g193(.a(new_n364_), .b(new_n361_), .c(x78), .O(new_n365_));
  or2    g194(.a(new_n360_), .b(new_n163_), .O(new_n366_));
  aoi21  g195(.a(new_n366_), .b(new_n365_), .c(x01), .O(z62));
  nand4  g196(.a(new_n356_), .b(x82), .c(x79), .d(new_n159_), .O(new_n368_));
  inv1   g197(.a(new_n368_), .O(z63));
  nand3  g198(.a(new_n356_), .b(x83), .c(x79), .O(new_n370_));
  nand4  g199(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n371_));
  aoi21  g200(.a(new_n371_), .b(new_n370_), .c(x01), .O(z64));
  nor2   g201(.a(new_n154_), .b(x04), .O(new_n373_));
  nor2   g202(.a(new_n231_), .b(x78), .O(new_n374_));
  oai21  g203(.a(new_n374_), .b(new_n373_), .c(x77), .O(new_n375_));
  nand3  g204(.a(x81), .b(x78), .c(new_n153_), .O(new_n376_));
  nand2  g205(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand4  g206(.a(new_n377_), .b(x84), .c(x79), .d(new_n159_), .O(new_n378_));
