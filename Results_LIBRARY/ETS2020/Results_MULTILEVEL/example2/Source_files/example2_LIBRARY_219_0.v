// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:27 2020
...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n241_, new_n243_, new_n245_, new_n247_, new_n253_, new_n255_,
  ...
  oai21  g066(.a(new_n231_), .b(new_n229_), .c(new_n211_), .O(new_n232_));
  nand2  g067(.a(x83), .b(x42), .O(new_n233_));
  nand2  g068(.a(new_n233_), .b(x81), .O(new_n234_));
  nand3  g069(.a(x83), .b(new_n210_), .c(x42), .O(new_n235_));
  nand2  g070(.a(new_n235_), .b(new_n234_), .O(new_n236_));
  nand2  g071(.a(new_n236_), .b(new_n208_), .O(new_n237_));
  ...
  nand4  g083(.a(new_n238_), .b(x78), .c(x77), .d(x61), .O(new_n253_));
  nor3   g084(.a(new_n253_), .b(x04), .c(x01), .O(z43));
  nand4  g085(.a(new_n238_), .b(x78), .c(x77), .d(x62), .O(new_n255_));
  nor3   g086(.a(new_n255_), .b(x04), .c(x01), .O(z44));
  nand4  g087(.a(new_n238_), .b(x78), .c(x77), .d(x63), .O(new_n257_));
  nor3   g088(.a(new_n257_), .b(x04), .c(x01), .O(z45));
  nand4  g089(.a(new_n238_), .b(x78), .c(x77), .d(x64), .O(new_n259_));
  ...
  nor2   g142(.a(new_n210_), .b(x78), .O(new_n322_));
