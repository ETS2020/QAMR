...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n285_, new_n287_, new_n290_, new_n293_,
  ...
  nand4  g132(.a(new_n282_), .b(x78), .c(x77), .d(x56), .O(new_n290_));
  ...
  nand4  g211(.a(x03), .b(new_n371_), .c(new_n153_), .d(x00), .O(new_n372_));
  inv1   g212(.a(new_n372_), .O(z57));
  nand4  g213(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n374_));
  oai22  g214(.a(new_n374_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n375_));
  nand4  g215(.a(new_n375_), .b(x79), .c(x78), .d(x04), .O(new_n376_));
  nor2   g216(.a(x79), .b(x78), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(new_n236_), .c(x40), .O(new_n378_));
  nand2  g218(.a(new_n378_), .b(new_n376_), .O(new_n379_));
  nand2  g219(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g220(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n381_));
  aoi21  g221(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  nor2   g222(.a(new_n160_), .b(new_n228_), .O(new_n383_));
  oai21  g223(.a(new_n383_), .b(new_n377_), .c(x40), .O(new_n384_));
  oai21  g224(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n385_));
  ...
  nand2  g229(.a(new_n154_), .b(new_n228_), .O(new_n390_));
  aoi21  g230(.a(new_n390_), .b(new_n389_), .c(x01), .O(z59));
  nand2  g231(.a(new_n366_), .b(x79), .O(new_n392_));
  nand3  g232(.a(new_n392_), .b(new_n390_), .c(new_n226_), .O(new_n393_));
  and2   g233(.a(new_n393_), .b(new_n153_), .O(z60));
  nand2  g234(.a(new_n167_), .b(new_n364_), .O(new_n395_));
  nand2  g235(.a(new_n395_), .b(new_n218_), .O(new_n396_));
  oai21  g236(.a(new_n232_), .b(x04), .c(new_n396_), .O(new_n397_));
  ...
  nand3  g243(.a(x81), .b(x79), .c(new_n228_), .O(new_n404_));
  ...
  nor2   g254(.a(new_n239_), .b(x78), .O(new_n415_));
