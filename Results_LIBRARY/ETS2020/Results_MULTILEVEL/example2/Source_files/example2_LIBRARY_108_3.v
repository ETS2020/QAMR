...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n300_, new_n302_, new_n305_, new_n308_, new_n310_, new_n312_,
  ...
  nand4  g150(.a(new_n289_), .b(x78), .c(x77), .d(x63), .O(new_n308_));
  nor3   g151(.a(new_n308_), .b(x04), .c(x01), .O(z45));
  nand4  g152(.a(new_n289_), .b(x78), .c(x77), .d(x64), .O(new_n310_));
  ...
  nor2   g160(.a(new_n317_), .b(new_n225_), .O(new_n318_));
  ...
  nand4  g167(.a(new_n226_), .b(x79), .c(new_n160_), .d(x77), .O(new_n325_));
  ...
  nand2  g210(.a(new_n367_), .b(new_n247_), .O(new_n368_));
  nor4   g211(.a(new_n368_), .b(new_n364_), .c(new_n230_), .d(x82), .O(z55));
  nand2  g212(.a(new_n240_), .b(x76), .O(new_n370_));
  ...
  nand4  g223(.a(x80), .b(new_n228_), .c(x43), .d(new_n244_), .O(new_n381_));
  oai22  g224(.a(new_n381_), .b(new_n231_), .c(new_n244_), .d(x40), .O(new_n382_));
  nand4  g225(.a(new_n382_), .b(x79), .c(x78), .d(x04), .O(new_n383_));
  nor2   g226(.a(x79), .b(x78), .O(new_n384_));
  nand3  g227(.a(new_n384_), .b(new_n244_), .c(x40), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n383_), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(x77), .O(new_n387_));
  oai21  g230(.a(new_n165_), .b(new_n236_), .c(new_n154_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n387_), .c(x01), .O(z58));
  nor2   g232(.a(new_n160_), .b(new_n236_), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n384_), .c(x40), .O(new_n391_));
  oai21  g234(.a(new_n231_), .b(new_n229_), .c(new_n244_), .O(new_n392_));
  ...
  nand2  g239(.a(new_n154_), .b(new_n236_), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n396_), .c(x01), .O(z59));
  nand2  g241(.a(new_n373_), .b(x79), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(new_n397_), .c(new_n234_), .O(new_n400_));
  and2   g243(.a(new_n400_), .b(new_n153_), .O(z60));
  nand2  g244(.a(new_n167_), .b(new_n371_), .O(new_n402_));
  nand2  g245(.a(new_n402_), .b(new_n226_), .O(new_n403_));
  oai21  g246(.a(new_n240_), .b(x04), .c(new_n403_), .O(new_n404_));
  ...
  nand3  g253(.a(x81), .b(x79), .c(new_n236_), .O(new_n411_));
  ...
  nor2   g264(.a(new_n247_), .b(x78), .O(new_n422_));
