...
module FAU ( 
  ...
  nand4  g067(.a(new_n221_), .b(x50), .c(new_n213_), .d(new_n207_), .O(new_n231_));
  ...
  oai21  g072(.a(new_n236_), .b(new_n234_), .c(new_n217_), .O(new_n237_));
  nand2  g073(.a(x83), .b(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g075(.a(x83), .b(new_n216_), .c(x42), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g077(.a(new_n241_), .b(new_n214_), .O(new_n242_));
  ...
  nor2   g152(.a(new_n216_), .b(x78), .O(new_n329_));
