...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n290_, new_n292_, new_n295_,
  ...
  nor2   g115(.a(new_n222_), .b(new_n235_), .O(new_n274_));
  ...
  nand4  g128(.a(new_n280_), .b(x78), .c(x77), .d(x55), .O(new_n287_));
  nor3   g129(.a(new_n287_), .b(x04), .c(x01), .O(z37));
  ...
  nand4  g134(.a(new_n280_), .b(x78), .c(x77), .d(x60), .O(new_n295_));
  nor3   g135(.a(new_n295_), .b(x04), .c(x01), .O(z42));
  nand4  g136(.a(new_n280_), .b(x78), .c(x77), .d(x62), .O(new_n298_));
  ...
  nand4  g153(.a(new_n218_), .b(x79), .c(new_n160_), .d(x77), .O(new_n316_));
  ...
  nor4   g197(.a(new_n359_), .b(new_n355_), .c(new_n222_), .d(x82), .O(z55));
  ...
  nand4  g209(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n372_));
  oai22  g210(.a(new_n372_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n373_));
  ...
  oai21  g216(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n379_));
  aoi21  g217(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g218(.a(new_n160_), .b(new_n229_), .O(new_n381_));
  oai21  g219(.a(new_n381_), .b(new_n375_), .c(x40), .O(new_n382_));
  oai21  g220(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n383_));
  ...
  nand3  g239(.a(x81), .b(x79), .c(new_n229_), .O(new_n402_));
