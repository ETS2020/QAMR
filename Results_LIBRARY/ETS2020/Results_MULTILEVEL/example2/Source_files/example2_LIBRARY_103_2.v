...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n284_, new_n286_, new_n291_, new_n293_, new_n295_,
  ...
  nor2   g116(.a(new_n223_), .b(new_n236_), .O(new_n275_));
  ...
  nand4  g203(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n369_));
  oai22  g204(.a(new_n369_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n370_));
  ...
  oai21  g210(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n376_));
  aoi21  g211(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  nor2   g212(.a(new_n160_), .b(new_n230_), .O(new_n378_));
  oai21  g213(.a(new_n378_), .b(new_n372_), .c(x40), .O(new_n379_));
  oai21  g214(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n380_));
  ...
  nand3  g233(.a(x81), .b(x79), .c(new_n230_), .O(new_n399_));
