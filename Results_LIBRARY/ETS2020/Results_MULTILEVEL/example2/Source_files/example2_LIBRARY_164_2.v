...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n287_, new_n289_, new_n291_, new_n293_, new_n296_, new_n299_,
  ...
  nand4  g135(.a(new_n278_), .b(x78), .c(x77), .d(x64), .O(new_n299_));
  ...
  nand4  g203(.a(x80), .b(new_n218_), .c(x43), .d(new_n234_), .O(new_n368_));
  oai22  g204(.a(new_n368_), .b(new_n221_), .c(new_n234_), .d(x40), .O(new_n369_));
  nand4  g205(.a(new_n369_), .b(x79), .c(x78), .d(x04), .O(new_n370_));
  nor2   g206(.a(x79), .b(x78), .O(new_n371_));
  nand3  g207(.a(new_n371_), .b(new_n234_), .c(x40), .O(new_n372_));
  nand2  g208(.a(new_n372_), .b(new_n370_), .O(new_n373_));
  nand2  g209(.a(new_n373_), .b(x77), .O(new_n374_));
  oai21  g210(.a(new_n165_), .b(new_n226_), .c(new_n154_), .O(new_n375_));
  aoi21  g211(.a(new_n375_), .b(new_n374_), .c(x01), .O(z58));
  nor2   g212(.a(new_n160_), .b(new_n226_), .O(new_n377_));
  oai21  g213(.a(new_n377_), .b(new_n371_), .c(x40), .O(new_n378_));
  oai21  g214(.a(new_n221_), .b(new_n219_), .c(new_n234_), .O(new_n379_));
  ...
  nand2  g219(.a(new_n154_), .b(new_n226_), .O(new_n384_));
  ...
  nand2  g224(.a(new_n167_), .b(new_n360_), .O(new_n389_));
  nand2  g225(.a(new_n389_), .b(new_n216_), .O(new_n390_));
  oai21  g226(.a(new_n230_), .b(x04), .c(new_n390_), .O(new_n391_));
  ...
  nand3  g233(.a(x81), .b(x79), .c(new_n226_), .O(new_n398_));
