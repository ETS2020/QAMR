...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n237_, new_n238_, new_n239_, new_n240_, new_n244_, new_n247_,
    new_n250_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n276_,
    new_n278_, new_n280_, new_n284_, new_n288_, new_n290_, new_n292_,
    new_n295_, new_n296_, new_n297_, new_n298_, new_n299_, new_n300_,
    new_n301_, new_n302_, new_n311_, new_n312_, new_n313_, new_n314_,
  ...
  nand4  g082(.a(new_n239_), .b(x46), .c(new_n231_), .d(new_n225_), .O(new_n244_));
  nor2   g083(.a(new_n244_), .b(x01), .O(z28));
  nand4  g084(.a(new_n239_), .b(x48), .c(new_n231_), .d(new_n225_), .O(new_n247_));
  nor2   g085(.a(new_n247_), .b(x01), .O(z30));
  nand4  g086(.a(new_n239_), .b(x50), .c(new_n231_), .d(new_n225_), .O(new_n250_));
  nor2   g087(.a(new_n250_), .b(x01), .O(z32));
  nand2  g088(.a(x83), .b(new_n234_), .O(new_n252_));
  nand2  g089(.a(new_n218_), .b(x81), .O(new_n253_));
  ...
  nand4  g101(.a(new_n264_), .b(x78), .c(x77), .d(new_n225_), .O(new_n265_));
  nor2   g102(.a(new_n265_), .b(x01), .O(z33));
  nor2   g103(.a(new_n218_), .b(new_n231_), .O(new_n267_));
  ...
  nand4  g116(.a(new_n273_), .b(x78), .c(x77), .d(x55), .O(new_n280_));
  nor3   g117(.a(new_n280_), .b(x04), .c(x01), .O(z37));
  nand4  g118(.a(new_n273_), .b(x78), .c(x77), .d(x58), .O(new_n284_));
  nor3   g119(.a(new_n284_), .b(x04), .c(x01), .O(z40));
  nand4  g120(.a(new_n273_), .b(x78), .c(x77), .d(x61), .O(new_n288_));
  nor3   g121(.a(new_n288_), .b(x04), .c(x01), .O(z43));
  nand4  g122(.a(new_n273_), .b(x78), .c(x77), .d(x62), .O(new_n290_));
  nor3   g123(.a(new_n290_), .b(x04), .c(x01), .O(z44));
  nand4  g124(.a(new_n273_), .b(x78), .c(x77), .d(x63), .O(new_n292_));
  nor3   g125(.a(new_n292_), .b(x04), .c(x01), .O(z45));
  nand2  g126(.a(x52), .b(x15), .O(new_n295_));
  inv1   g127(.a(x52), .O(new_n296_));
  nand2  g128(.a(new_n296_), .b(x07), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n295_), .c(x79), .O(new_n298_));
  nand4  g130(.a(new_n298_), .b(x78), .c(new_n159_), .d(x04), .O(new_n299_));
  nor2   g131(.a(x75), .b(x67), .O(new_n300_));
  nor2   g132(.a(new_n300_), .b(new_n213_), .O(new_n301_));
  nand4  g133(.a(new_n301_), .b(x79), .c(new_n160_), .d(x77), .O(new_n302_));
  aoi21  g134(.a(new_n302_), .b(new_n299_), .c(x01), .O(z47));
  inv1   g135(.a(x84), .O(new_n311_));
  nor2   g136(.a(x04), .b(x01), .O(new_n312_));
  nand4  g137(.a(new_n312_), .b(x79), .c(x78), .d(x77), .O(new_n313_));
  nor2   g138(.a(new_n313_), .b(x80), .O(new_n314_));
  nand2  g139(.a(new_n314_), .b(new_n234_), .O(new_n315_));
  nor4   g140(.a(new_n315_), .b(new_n311_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g141(.a(new_n227_), .b(x76), .O(new_n317_));
  inv1   g142(.a(new_n165_), .O(new_n318_));
  xnor2a g143(.a(x84), .b(x81), .O(new_n319_));
  aoi21  g144(.a(new_n167_), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g145(.a(new_n320_), .b(new_n153_), .O(new_n321_));
  nand2  g146(.a(new_n321_), .b(new_n317_), .O(new_n322_));
  nand2  g147(.a(new_n322_), .b(x79), .O(new_n323_));
  nand4  g148(.a(new_n323_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g149(.a(x02), .O(new_n325_));
  nand4  g150(.a(x03), .b(new_n325_), .c(new_n153_), .d(x00), .O(new_n326_));
  inv1   g151(.a(new_n326_), .O(z57));
  nand4  g152(.a(x80), .b(new_n216_), .c(x43), .d(new_n231_), .O(new_n328_));
  oai22  g153(.a(new_n328_), .b(new_n219_), .c(new_n231_), .d(x40), .O(new_n329_));
  nand4  g154(.a(new_n329_), .b(x79), .c(x78), .d(x04), .O(new_n330_));
  nor2   g155(.a(x79), .b(x78), .O(new_n331_));
  nand3  g156(.a(new_n331_), .b(new_n231_), .c(x40), .O(new_n332_));
  nand2  g157(.a(new_n332_), .b(new_n330_), .O(new_n333_));
  nand2  g158(.a(new_n333_), .b(x77), .O(new_n334_));
  oai21  g159(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n335_));
  aoi21  g160(.a(new_n335_), .b(new_n334_), .c(x01), .O(z58));
  nor2   g161(.a(new_n160_), .b(new_n225_), .O(new_n337_));
  oai21  g162(.a(new_n337_), .b(new_n331_), .c(x40), .O(new_n338_));
  oai21  g163(.a(new_n219_), .b(new_n217_), .c(new_n231_), .O(new_n339_));
  nand2  g164(.a(new_n339_), .b(x79), .O(new_n340_));
  nand3  g165(.a(new_n340_), .b(x78), .c(x04), .O(new_n341_));
  nand2  g166(.a(new_n341_), .b(new_n338_), .O(new_n342_));
  nand2  g167(.a(new_n342_), .b(x77), .O(new_n343_));
  nand2  g168(.a(new_n154_), .b(new_n225_), .O(new_n344_));
  aoi21  g169(.a(new_n344_), .b(new_n343_), .c(x01), .O(z59));
  nand2  g170(.a(new_n320_), .b(x79), .O(new_n346_));
  nand3  g171(.a(new_n346_), .b(new_n344_), .c(new_n222_), .O(new_n347_));
  and2   g172(.a(new_n347_), .b(new_n153_), .O(z60));
  nand2  g173(.a(new_n167_), .b(new_n318_), .O(new_n349_));
  nand2  g174(.a(new_n349_), .b(new_n214_), .O(new_n350_));
  oai21  g175(.a(new_n227_), .b(x04), .c(new_n350_), .O(new_n351_));
  nand4  g176(.a(new_n351_), .b(x80), .c(x79), .d(new_n153_), .O(new_n352_));
  inv1   g177(.a(new_n352_), .O(z61));
  nand2  g178(.a(new_n154_), .b(x04), .O(new_n354_));
  nand3  g179(.a(x84), .b(x81), .c(x79), .O(new_n355_));
  aoi21  g180(.a(new_n355_), .b(new_n354_), .c(x77), .O(new_n356_));
  nand2  g181(.a(new_n340_), .b(x04), .O(new_n357_));
  nand3  g182(.a(x81), .b(x79), .c(new_n225_), .O(new_n358_));
  aoi21  g183(.a(new_n358_), .b(new_n357_), .c(new_n159_), .O(new_n359_));
  oai21  g184(.a(new_n359_), .b(new_n356_), .c(x78), .O(new_n360_));
  or2    g185(.a(new_n355_), .b(new_n167_), .O(new_n361_));
  aoi21  g186(.a(new_n361_), .b(new_n360_), .c(x01), .O(z62));
  nand4  g187(.a(new_n351_), .b(x82), .c(x79), .d(new_n153_), .O(new_n363_));
  inv1   g188(.a(new_n363_), .O(z63));
  nand3  g189(.a(new_n351_), .b(x83), .c(x79), .O(new_n365_));
  nand4  g190(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n366_));
  aoi21  g191(.a(new_n366_), .b(new_n365_), .c(x01), .O(z64));
  nor2   g192(.a(new_n160_), .b(x04), .O(new_n368_));
  nor2   g193(.a(new_n234_), .b(x78), .O(new_n369_));
  oai21  g194(.a(new_n369_), .b(new_n368_), .c(x77), .O(new_n370_));
  nand3  g195(.a(x81), .b(x78), .c(new_n159_), .O(new_n371_));
  nand2  g196(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand4  g197(.a(new_n372_), .b(x84), .c(x79), .d(new_n153_), .O(new_n373_));
  inv1   g198(.a(new_n373_), .O(z65));
  zero   g199(.O(z05));
  zero   g200(.O(z06));
  zero   g201(.O(z08));
  zero   g202(.O(z10));
