...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n290_, new_n293_, new_n296_, new_n298_, new_n302_, new_n304_,
    new_n306_, new_n308_, new_n309_, new_n310_, new_n311_, new_n312_,
    new_n313_, new_n314_, new_n315_, new_n323_, new_n324_, new_n325_,
  ...
  nand4  g099(.a(new_n249_), .b(x46), .c(new_n241_), .d(new_n235_), .O(new_n255_));
  nor2   g100(.a(new_n255_), .b(x01), .O(z28));
  nand4  g101(.a(new_n249_), .b(x47), .c(new_n241_), .d(new_n235_), .O(new_n257_));
  nor2   g102(.a(new_n257_), .b(x01), .O(z29));
  nand4  g103(.a(new_n249_), .b(x48), .c(new_n241_), .d(new_n235_), .O(new_n259_));
  nor2   g104(.a(new_n259_), .b(x01), .O(z30));
  nand4  g105(.a(new_n249_), .b(x50), .c(new_n241_), .d(new_n235_), .O(new_n262_));
  nor2   g106(.a(new_n262_), .b(x01), .O(z32));
  nand2  g107(.a(x83), .b(new_n244_), .O(new_n264_));
  nand2  g108(.a(new_n228_), .b(x81), .O(new_n265_));
  ...
  nand4  g120(.a(new_n276_), .b(x78), .c(x77), .d(new_n235_), .O(new_n277_));
  nor2   g121(.a(new_n277_), .b(x01), .O(z33));
  nor2   g122(.a(new_n228_), .b(new_n241_), .O(new_n279_));
  ...
  nand4  g141(.a(new_n285_), .b(x78), .c(x77), .d(x62), .O(new_n302_));
  ...
  nand2  g157(.a(new_n309_), .b(x14), .O(new_n324_));
  aoi21  g158(.a(new_n324_), .b(new_n323_), .c(x79), .O(new_n325_));
  nand4  g159(.a(new_n325_), .b(x78), .c(new_n159_), .d(x04), .O(new_n326_));
  nor2   g160(.a(new_n326_), .b(x01), .O(z54));
  inv1   g161(.a(x84), .O(new_n328_));
  nor2   g162(.a(x04), .b(x01), .O(new_n329_));
  nand4  g163(.a(new_n329_), .b(x79), .c(x78), .d(x77), .O(new_n330_));
  nor2   g164(.a(new_n330_), .b(x80), .O(new_n331_));
  nand2  g165(.a(new_n331_), .b(new_n244_), .O(new_n332_));
  nor4   g166(.a(new_n332_), .b(new_n328_), .c(new_n228_), .d(x82), .O(z55));
  nand2  g167(.a(new_n237_), .b(x76), .O(new_n334_));
  inv1   g168(.a(new_n165_), .O(new_n335_));
  xnor2a g169(.a(x84), .b(x81), .O(new_n336_));
  aoi21  g170(.a(new_n167_), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g171(.a(new_n337_), .b(new_n153_), .O(new_n338_));
  nand2  g172(.a(new_n338_), .b(new_n334_), .O(new_n339_));
  nand2  g173(.a(new_n339_), .b(x79), .O(new_n340_));
  nand4  g174(.a(new_n340_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g175(.a(x80), .b(new_n226_), .c(x43), .d(new_n241_), .O(new_n343_));
  oai22  g176(.a(new_n343_), .b(new_n229_), .c(new_n241_), .d(x40), .O(new_n344_));
  nand4  g177(.a(new_n344_), .b(x79), .c(x78), .d(x04), .O(new_n345_));
  nor2   g178(.a(x79), .b(x78), .O(new_n346_));
  nand3  g179(.a(new_n346_), .b(new_n241_), .c(x40), .O(new_n347_));
  nand2  g180(.a(new_n347_), .b(new_n345_), .O(new_n348_));
  nand2  g181(.a(new_n348_), .b(x77), .O(new_n349_));
  oai21  g182(.a(new_n165_), .b(new_n235_), .c(new_n154_), .O(new_n350_));
  aoi21  g183(.a(new_n350_), .b(new_n349_), .c(x01), .O(z58));
  nor2   g184(.a(new_n160_), .b(new_n235_), .O(new_n352_));
  oai21  g185(.a(new_n352_), .b(new_n346_), .c(x40), .O(new_n353_));
  oai21  g186(.a(new_n229_), .b(new_n227_), .c(new_n241_), .O(new_n354_));
  nand2  g187(.a(new_n354_), .b(x79), .O(new_n355_));
  nand3  g188(.a(new_n355_), .b(x78), .c(x04), .O(new_n356_));
  nand2  g189(.a(new_n356_), .b(new_n353_), .O(new_n357_));
  nand2  g190(.a(new_n357_), .b(x77), .O(new_n358_));
  nand2  g191(.a(new_n154_), .b(new_n235_), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(new_n358_), .c(x01), .O(z59));
  nand2  g193(.a(new_n337_), .b(x79), .O(new_n361_));
  nand3  g194(.a(new_n361_), .b(new_n359_), .c(new_n232_), .O(new_n362_));
  and2   g195(.a(new_n362_), .b(new_n153_), .O(z60));
  nand2  g196(.a(new_n167_), .b(new_n335_), .O(new_n364_));
  nand2  g197(.a(new_n364_), .b(new_n224_), .O(new_n365_));
  oai21  g198(.a(new_n237_), .b(x04), .c(new_n365_), .O(new_n366_));
  nand4  g199(.a(new_n366_), .b(x80), .c(x79), .d(new_n153_), .O(new_n367_));
  inv1   g200(.a(new_n367_), .O(z61));
  nand2  g201(.a(new_n154_), .b(x04), .O(new_n369_));
  nand3  g202(.a(x84), .b(x81), .c(x79), .O(new_n370_));
  aoi21  g203(.a(new_n370_), .b(new_n369_), .c(x77), .O(new_n371_));
  nand2  g204(.a(new_n355_), .b(x04), .O(new_n372_));
  nand3  g205(.a(x81), .b(x79), .c(new_n235_), .O(new_n373_));
  aoi21  g206(.a(new_n373_), .b(new_n372_), .c(new_n159_), .O(new_n374_));
  oai21  g207(.a(new_n374_), .b(new_n371_), .c(x78), .O(new_n375_));
  or2    g208(.a(new_n370_), .b(new_n167_), .O(new_n376_));
  aoi21  g209(.a(new_n376_), .b(new_n375_), .c(x01), .O(z62));
  nand4  g210(.a(new_n366_), .b(x82), .c(x79), .d(new_n153_), .O(new_n378_));
  inv1   g211(.a(new_n378_), .O(z63));
  nand3  g212(.a(new_n366_), .b(x83), .c(x79), .O(new_n380_));
  nand4  g213(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n381_));
  aoi21  g214(.a(new_n381_), .b(new_n380_), .c(x01), .O(z64));
  zero   g215(.O(z16));
  zero   g216(.O(z18));
  zero   g217(.O(z23));
  zero   g218(.O(z27));
