...
module FAU ( 
  ...
  inv1   g047(.a(x38), .O(new_n204_));
  nand2  g048(.a(x45), .b(x40), .O(new_n205_));
  oai21  g049(.a(x40), .b(new_n204_), .c(new_n205_), .O(z20));
  ...
  nand4  g066(.a(new_n221_), .b(x46), .c(new_n213_), .d(new_n209_), .O(new_n227_));
  nor2   g067(.a(new_n227_), .b(x01), .O(z28));
  nand4  g068(.a(new_n221_), .b(x47), .c(new_n213_), .d(new_n209_), .O(new_n229_));
  ...
  nor2   g155(.a(new_n216_), .b(x78), .O(new_n331_));
