// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:57 2020
...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n241_, new_n243_, new_n245_, new_n247_, new_n250_, new_n254_,
  ...
  nand4  g083(.a(new_n238_), .b(x78), .c(x77), .d(x58), .O(new_n250_));
  nor3   g084(.a(new_n250_), .b(x04), .c(x01), .O(z40));
  ...
  nand2  g135(.a(x52), .b(x22), .O(new_n305_));
  nand2  g136(.a(new_n265_), .b(x14), .O(new_n306_));
  aoi21  g137(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g138(.a(new_n307_), .b(x78), .c(new_n263_), .d(x04), .O(new_n308_));
  nor2   g139(.a(new_n308_), .b(x01), .O(z54));
  inv1   g140(.a(x02), .O(new_n312_));
  nand4  g141(.a(x03), .b(new_n312_), .c(new_n155_), .d(x00), .O(new_n313_));
  inv1   g142(.a(new_n313_), .O(z57));
  nor2   g143(.a(new_n269_), .b(x04), .O(new_n322_));
  nor2   g144(.a(new_n209_), .b(x78), .O(new_n323_));
  oai21  g145(.a(new_n323_), .b(new_n322_), .c(x77), .O(new_n324_));
  nand3  g146(.a(x81), .b(x78), .c(new_n263_), .O(new_n325_));
  nand2  g147(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  nand4  g148(.a(new_n326_), .b(x84), .c(x79), .d(new_n155_), .O(new_n327_));
  inv1   g149(.a(new_n327_), .O(z65));
  zero   g150(.O(z00));
  zero   g151(.O(z01));
  zero   g152(.O(z02));
  zero   g153(.O(z07));
