...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n176_, new_n180_, new_n181_, new_n185_, new_n186_, new_n188_,
  ...
  nor2   g114(.a(new_n219_), .b(new_n233_), .O(new_n274_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  oai21  g116(.a(new_n274_), .b(x81), .c(new_n275_), .O(new_n276_));
  nand2  g117(.a(new_n276_), .b(new_n237_), .O(new_n277_));
  oai22  g118(.a(new_n274_), .b(new_n236_), .c(new_n258_), .d(new_n233_), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n234_), .O(new_n279_));
