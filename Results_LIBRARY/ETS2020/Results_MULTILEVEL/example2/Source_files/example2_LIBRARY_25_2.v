...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n199_, new_n200_, new_n203_, new_n204_, new_n206_,
    ...
    new_n283_, new_n285_, new_n290_, new_n292_, new_n294_, new_n298_,
  ...
  nand4  g134(.a(new_n280_), .b(x78), .c(x77), .d(x63), .O(new_n298_));
  nor3   g135(.a(new_n298_), .b(x04), .c(x01), .O(z45));
  nand4  g136(.a(new_n280_), .b(x78), .c(x77), .d(x64), .O(new_n300_));
  ...
  nand2  g194(.a(new_n357_), .b(new_n238_), .O(new_n358_));
  nor4   g195(.a(new_n358_), .b(new_n354_), .c(new_n221_), .d(x82), .O(z55));
  nand2  g196(.a(new_n231_), .b(x76), .O(new_n360_));
  ...
  nand4  g207(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n371_));
  oai22  g208(.a(new_n371_), .b(new_n222_), .c(new_n235_), .d(x40), .O(new_n372_));
  ...
  oai21  g214(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n378_));
  aoi21  g215(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g216(.a(new_n160_), .b(new_n227_), .O(new_n380_));
  oai21  g217(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g218(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n382_));
  ...
  nand2  g223(.a(new_n154_), .b(new_n227_), .O(new_n387_));
  ...
  nand3  g237(.a(x81), .b(x79), .c(new_n227_), .O(new_n401_));
  ...
  nor2   g248(.a(new_n238_), .b(x78), .O(new_n412_));
