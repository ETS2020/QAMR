...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n196_, new_n198_, new_n199_, new_n201_, new_n202_, new_n205_,
  ...
  nand4  g125(.a(new_n279_), .b(x78), .c(x77), .d(x55), .O(new_n286_));
  nor3   g126(.a(new_n286_), .b(x04), .c(x01), .O(z37));
  nand4  g127(.a(new_n279_), .b(x78), .c(x77), .d(x56), .O(new_n288_));
  nor3   g128(.a(new_n288_), .b(x04), .c(x01), .O(z38));
  nand4  g129(.a(new_n279_), .b(x78), .c(x77), .d(x57), .O(new_n290_));
  nor3   g130(.a(new_n290_), .b(x04), .c(x01), .O(z39));
  nand4  g131(.a(new_n279_), .b(x78), .c(x77), .d(x58), .O(new_n292_));
  nor3   g132(.a(new_n292_), .b(x04), .c(x01), .O(z40));
  nand4  g133(.a(new_n279_), .b(x78), .c(x77), .d(x59), .O(new_n294_));
  nor3   g134(.a(new_n294_), .b(x04), .c(x01), .O(z41));
  nand4  g135(.a(new_n279_), .b(x78), .c(x77), .d(x60), .O(new_n296_));
