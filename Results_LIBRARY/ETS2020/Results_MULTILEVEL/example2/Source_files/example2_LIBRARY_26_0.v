...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n314_, new_n315_, new_n327_, new_n328_, new_n329_, new_n330_,
    new_n331_, new_n332_;
  ...
  nand4  g060(.a(new_n212_), .b(x50), .c(new_n204_), .d(new_n199_), .O(new_n225_));
  nor2   g061(.a(new_n225_), .b(x01), .O(z32));
  aoi21  g062(.a(x83), .b(x42), .c(x81), .O(new_n228_));
  nand3  g063(.a(x83), .b(x81), .c(x42), .O(new_n229_));
  inv1   g064(.a(new_n229_), .O(new_n230_));
  oai21  g065(.a(new_n230_), .b(new_n228_), .c(new_n208_), .O(new_n231_));
  nand2  g066(.a(x83), .b(x42), .O(new_n232_));
  nand2  g067(.a(new_n232_), .b(x81), .O(new_n233_));
  nand3  g068(.a(x83), .b(new_n207_), .c(x42), .O(new_n234_));
  nand2  g069(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g070(.a(new_n235_), .b(new_n205_), .O(new_n236_));
  aoi21  g071(.a(new_n236_), .b(new_n231_), .c(new_n156_), .O(new_n237_));
  nand4  g072(.a(new_n237_), .b(x78), .c(x77), .d(x52), .O(new_n238_));
  nor3   g073(.a(new_n238_), .b(x04), .c(x01), .O(z34));
  nand4  g074(.a(new_n237_), .b(x78), .c(x77), .d(x54), .O(new_n241_));
  nor3   g075(.a(new_n241_), .b(x04), .c(x01), .O(z36));
  nand4  g076(.a(new_n237_), .b(x78), .c(x77), .d(x55), .O(new_n243_));
  nor3   g077(.a(new_n243_), .b(x04), .c(x01), .O(z37));
  nand4  g078(.a(new_n237_), .b(x78), .c(x77), .d(x56), .O(new_n245_));
  ...
  nand4  g082(.a(new_n237_), .b(x78), .c(x77), .d(x60), .O(new_n251_));
  nor3   g083(.a(new_n251_), .b(x04), .c(x01), .O(z42));
  nand4  g084(.a(new_n237_), .b(x78), .c(x77), .d(x61), .O(new_n253_));
  nor3   g085(.a(new_n253_), .b(x04), .c(x01), .O(z43));
  nand4  g086(.a(new_n237_), .b(x78), .c(x77), .d(x62), .O(new_n255_));
  nor3   g087(.a(new_n255_), .b(x04), .c(x01), .O(z44));
  nand4  g088(.a(new_n237_), .b(x78), .c(x77), .d(x63), .O(new_n257_));
  nor3   g089(.a(new_n257_), .b(x04), .c(x01), .O(z45));
  nand4  g090(.a(new_n237_), .b(x78), .c(x77), .d(x64), .O(new_n259_));
  ...
  nor2   g148(.a(new_n267_), .b(x04), .O(new_n327_));
  nor2   g149(.a(new_n207_), .b(x78), .O(new_n328_));
  oai21  g150(.a(new_n328_), .b(new_n327_), .c(x77), .O(new_n329_));
  nand3  g151(.a(x81), .b(x78), .c(new_n261_), .O(new_n330_));
  nand2  g152(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand4  g153(.a(new_n331_), .b(x84), .c(x79), .d(new_n155_), .O(new_n332_));
  inv1   g154(.a(new_n332_), .O(z65));
  zero   g155(.O(z00));
  zero   g156(.O(z01));
  zero   g157(.O(z02));
  zero   g158(.O(z10));
