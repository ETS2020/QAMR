...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n216_, new_n217_, new_n219_, new_n221_, new_n223_, new_n227_,
    ...
    new_n311_, new_n317_, new_n318_, new_n319_, new_n320_, new_n321_,
  ...
  nand4  g057(.a(new_n216_), .b(x49), .c(new_n208_), .d(new_n201_), .O(new_n223_));
  nor2   g058(.a(new_n223_), .b(x01), .O(z31));
  inv1   g059(.a(x83), .O(new_n227_));
  nor2   g060(.a(new_n227_), .b(new_n208_), .O(new_n228_));
  nand3  g061(.a(x83), .b(x81), .c(x42), .O(new_n229_));
  oai21  g062(.a(new_n228_), .b(x81), .c(new_n229_), .O(new_n230_));
  nand2  g063(.a(new_n230_), .b(new_n212_), .O(new_n231_));
  nand3  g064(.a(x83), .b(new_n211_), .c(x42), .O(new_n232_));
  oai21  g065(.a(new_n228_), .b(new_n211_), .c(new_n232_), .O(new_n233_));
  nand2  g066(.a(new_n233_), .b(new_n209_), .O(new_n234_));
  aoi21  g067(.a(new_n234_), .b(new_n231_), .c(new_n156_), .O(new_n235_));
  nand4  g068(.a(new_n235_), .b(x78), .c(x77), .d(x52), .O(new_n236_));
  nor3   g069(.a(new_n236_), .b(x04), .c(x01), .O(z34));
  nand4  g070(.a(new_n235_), .b(x78), .c(x77), .d(x53), .O(new_n238_));
  nor3   g071(.a(new_n238_), .b(x04), .c(x01), .O(z35));
  nand4  g072(.a(new_n235_), .b(x78), .c(x77), .d(x54), .O(new_n240_));
  nor3   g073(.a(new_n240_), .b(x04), .c(x01), .O(z36));
  nand4  g074(.a(new_n235_), .b(x78), .c(x77), .d(x55), .O(new_n242_));
  nor3   g075(.a(new_n242_), .b(x04), .c(x01), .O(z37));
  nand4  g076(.a(new_n235_), .b(x78), .c(x77), .d(x56), .O(new_n244_));
  nor3   g077(.a(new_n244_), .b(x04), .c(x01), .O(z38));
  nand4  g078(.a(new_n235_), .b(x78), .c(x77), .d(x58), .O(new_n247_));
  nor3   g079(.a(new_n247_), .b(x04), .c(x01), .O(z40));
  ...
  nand4  g138(.a(x03), .b(new_n310_), .c(new_n155_), .d(x00), .O(new_n311_));
  inv1   g139(.a(new_n311_), .O(z57));
  nand2  g140(.a(new_n156_), .b(x04), .O(new_n317_));
  nand3  g141(.a(x84), .b(x81), .c(x79), .O(new_n318_));
  aoi21  g142(.a(new_n318_), .b(new_n317_), .c(x77), .O(new_n319_));
  inv1   g143(.a(x74), .O(new_n320_));
  nand3  g144(.a(x80), .b(new_n320_), .c(x43), .O(new_n321_));
  nand4  g145(.a(x84), .b(new_n227_), .c(x82), .d(x81), .O(new_n322_));
  oai21  g146(.a(new_n322_), .b(new_n321_), .c(new_n208_), .O(new_n323_));
  nand2  g147(.a(new_n323_), .b(x79), .O(new_n324_));
  nand2  g148(.a(new_n324_), .b(x04), .O(new_n325_));
  nand3  g149(.a(x81), .b(x79), .c(new_n201_), .O(new_n326_));
  aoi21  g150(.a(new_n326_), .b(new_n325_), .c(new_n261_), .O(new_n327_));
  oai21  g151(.a(new_n327_), .b(new_n319_), .c(x78), .O(new_n328_));
  inv1   g152(.a(new_n318_), .O(new_n329_));
  nand3  g153(.a(new_n329_), .b(new_n267_), .c(x77), .O(new_n330_));
  aoi21  g154(.a(new_n330_), .b(new_n328_), .c(x01), .O(z62));
  nor2   g155(.a(new_n267_), .b(x04), .O(new_n334_));
  nor2   g156(.a(new_n211_), .b(x78), .O(new_n335_));
  oai21  g157(.a(new_n335_), .b(new_n334_), .c(x77), .O(new_n336_));
  nand3  g158(.a(x81), .b(x78), .c(new_n261_), .O(new_n337_));
  nand2  g159(.a(new_n337_), .b(new_n336_), .O(new_n338_));
  nand4  g160(.a(new_n338_), .b(x84), .c(x79), .d(new_n155_), .O(new_n339_));
  inv1   g161(.a(new_n339_), .O(z65));
  zero   g162(.O(z00));
  zero   g163(.O(z01));
  zero   g164(.O(z02));
  zero   g165(.O(z07));
