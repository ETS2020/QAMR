...
module FAU ( 
  ...
  nor2   g182(.a(new_n160_), .b(x04), .O(new_n360_));
  nor2   g183(.a(new_n239_), .b(x78), .O(new_n361_));
  oai21  g184(.a(new_n361_), .b(new_n360_), .c(x77), .O(new_n362_));
  nand3  g185(.a(x81), .b(x78), .c(new_n159_), .O(new_n363_));
  nand2  g186(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  nand4  g187(.a(new_n364_), .b(x84), .c(x79), .d(new_n153_), .O(new_n365_));
  inv1   g188(.a(new_n365_), .O(z65));
  zero   g189(.O(z06));
  zero   g190(.O(z08));
  zero   g191(.O(z09));
  zero   g192(.O(z10));
