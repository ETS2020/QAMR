...
module FAU ( 
  ...
  nor2   g186(.a(new_n160_), .b(x04), .O(new_n363_));
  nor2   g187(.a(new_n242_), .b(x78), .O(new_n364_));
  oai21  g188(.a(new_n364_), .b(new_n363_), .c(x77), .O(new_n365_));
  nand3  g189(.a(x81), .b(x78), .c(new_n159_), .O(new_n366_));
  nand2  g190(.a(new_n366_), .b(new_n365_), .O(new_n367_));
  nand4  g191(.a(new_n367_), .b(x84), .c(x79), .d(new_n153_), .O(new_n368_));
  inv1   g192(.a(new_n368_), .O(z65));
  zero   g193(.O(z06));
  zero   g194(.O(z09));
  zero   g195(.O(z10));
  zero   g196(.O(z16));
