...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n195_, new_n196_, new_n201_, new_n202_, new_n208_, new_n209_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n219_, new_n221_, new_n226_, new_n227_,
  ...
  inv1   g042(.a(x42), .O(new_n208_));
  xnor2a g043(.a(x84), .b(x82), .O(new_n209_));
  nand2  g044(.a(new_n209_), .b(x81), .O(new_n210_));
  inv1   g045(.a(x81), .O(new_n211_));
  xor2a  g046(.a(x84), .b(x82), .O(new_n212_));
  nand2  g047(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand2  g048(.a(new_n213_), .b(new_n210_), .O(new_n214_));
  nand4  g049(.a(new_n214_), .b(x79), .c(x78), .d(x77), .O(new_n215_));
  inv1   g050(.a(new_n215_), .O(new_n216_));
  nand4  g051(.a(new_n216_), .b(x46), .c(new_n208_), .d(new_n201_), .O(new_n217_));
  nor2   g052(.a(new_n217_), .b(x01), .O(z28));
  nand4  g053(.a(new_n216_), .b(x47), .c(new_n208_), .d(new_n201_), .O(new_n219_));
  nor2   g054(.a(new_n219_), .b(x01), .O(z29));
  nand4  g055(.a(new_n216_), .b(x48), .c(new_n208_), .d(new_n201_), .O(new_n221_));
  ...
  oai21  g060(.a(new_n228_), .b(new_n226_), .c(new_n212_), .O(new_n229_));
  nand2  g061(.a(x83), .b(x42), .O(new_n230_));
  nand2  g062(.a(new_n230_), .b(x81), .O(new_n231_));
  nand3  g063(.a(x83), .b(new_n211_), .c(x42), .O(new_n232_));
  nand2  g064(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand2  g065(.a(new_n233_), .b(new_n209_), .O(new_n234_));
  ...
  nand4  g075(.a(new_n235_), .b(x78), .c(x77), .d(x60), .O(new_n248_));
  nor3   g076(.a(new_n248_), .b(x04), .c(x01), .O(z42));
  nand4  g077(.a(new_n235_), .b(x78), .c(x77), .d(x61), .O(new_n250_));
  nor3   g078(.a(new_n250_), .b(x04), .c(x01), .O(z43));
  nand4  g079(.a(new_n235_), .b(x78), .c(x77), .d(x62), .O(new_n252_));
  nor3   g080(.a(new_n252_), .b(x04), .c(x01), .O(z44));
  nand4  g081(.a(new_n235_), .b(x78), .c(x77), .d(x63), .O(new_n254_));
  nor3   g082(.a(new_n254_), .b(x04), .c(x01), .O(z45));
  nand4  g083(.a(new_n235_), .b(x78), .c(x77), .d(x64), .O(new_n256_));
  nor3   g084(.a(new_n256_), .b(x04), .c(x01), .O(z46));
  inv1   g085(.a(x77), .O(new_n259_));
  nand2  g086(.a(x52), .b(x16), .O(new_n260_));
  inv1   g087(.a(x52), .O(new_n261_));
  nand2  g088(.a(new_n261_), .b(x08), .O(new_n262_));
  aoi21  g089(.a(new_n262_), .b(new_n260_), .c(x79), .O(new_n263_));
  nand4  g090(.a(new_n263_), .b(x78), .c(new_n259_), .d(x04), .O(new_n264_));
  inv1   g091(.a(x78), .O(new_n265_));
  xnor2a g092(.a(x84), .b(x81), .O(new_n266_));
  nand4  g093(.a(new_n266_), .b(x79), .c(new_n265_), .d(x77), .O(new_n267_));
  ...
  nand2  g098(.a(new_n261_), .b(x09), .O(new_n272_));
  aoi21  g099(.a(new_n272_), .b(new_n271_), .c(x79), .O(new_n273_));
  nand4  g100(.a(new_n273_), .b(x78), .c(new_n259_), .d(x04), .O(new_n274_));
  nand2  g101(.a(new_n268_), .b(x69), .O(new_n275_));
  aoi21  g102(.a(new_n275_), .b(new_n274_), .c(x01), .O(z49));
  nand2  g103(.a(x52), .b(x18), .O(new_n277_));
  nand2  g104(.a(new_n261_), .b(x10), .O(new_n278_));
  aoi21  g105(.a(new_n278_), .b(new_n277_), .c(x79), .O(new_n279_));
  nand4  g106(.a(new_n279_), .b(x78), .c(new_n259_), .d(x04), .O(new_n280_));
  nand2  g107(.a(new_n268_), .b(x70), .O(new_n281_));
  aoi21  g108(.a(new_n281_), .b(new_n280_), .c(x01), .O(z50));
  nand2  g109(.a(x52), .b(x19), .O(new_n283_));
  nand2  g110(.a(new_n261_), .b(x11), .O(new_n284_));
  aoi21  g111(.a(new_n284_), .b(new_n283_), .c(x79), .O(new_n285_));
  nand4  g112(.a(new_n285_), .b(x78), .c(new_n259_), .d(x04), .O(new_n286_));
  nand2  g113(.a(new_n268_), .b(x71), .O(new_n287_));
  aoi21  g114(.a(new_n287_), .b(new_n286_), .c(x01), .O(z51));
  nand2  g115(.a(x52), .b(x20), .O(new_n289_));
  nand2  g116(.a(new_n261_), .b(x12), .O(new_n290_));
  aoi21  g117(.a(new_n290_), .b(new_n289_), .c(x79), .O(new_n291_));
  nand4  g118(.a(new_n291_), .b(x78), .c(new_n259_), .d(x04), .O(new_n292_));
  nand2  g119(.a(new_n268_), .b(x72), .O(new_n293_));
  aoi21  g120(.a(new_n293_), .b(new_n292_), .c(x01), .O(z52));
  nand2  g121(.a(x52), .b(x21), .O(new_n295_));
  nand2  g122(.a(new_n261_), .b(x13), .O(new_n296_));
  aoi21  g123(.a(new_n296_), .b(new_n295_), .c(x79), .O(new_n297_));
  nand4  g124(.a(new_n297_), .b(x78), .c(new_n259_), .d(x04), .O(new_n298_));
  nand2  g125(.a(new_n268_), .b(x73), .O(new_n299_));
  aoi21  g126(.a(new_n299_), .b(new_n298_), .c(x01), .O(z53));
  nand2  g127(.a(x52), .b(x22), .O(new_n301_));
  nand2  g128(.a(new_n261_), .b(x14), .O(new_n302_));
  aoi21  g129(.a(new_n302_), .b(new_n301_), .c(x79), .O(new_n303_));
  nand4  g130(.a(new_n303_), .b(x78), .c(new_n259_), .d(x04), .O(new_n304_));
  nor2   g131(.a(new_n304_), .b(x01), .O(z54));
  inv1   g132(.a(x02), .O(new_n308_));
  nand4  g133(.a(x03), .b(new_n308_), .c(new_n155_), .d(x00), .O(new_n309_));
  inv1   g134(.a(new_n309_), .O(z57));
  nor2   g135(.a(new_n265_), .b(x04), .O(new_n318_));
  nor2   g136(.a(new_n211_), .b(x78), .O(new_n319_));
  oai21  g137(.a(new_n319_), .b(new_n318_), .c(x77), .O(new_n320_));
  nand3  g138(.a(x81), .b(x78), .c(new_n259_), .O(new_n321_));
  nand2  g139(.a(new_n321_), .b(new_n320_), .O(new_n322_));
  nand4  g140(.a(new_n322_), .b(x84), .c(x79), .d(new_n155_), .O(new_n323_));
  inv1   g141(.a(new_n323_), .O(z65));
  zero   g142(.O(z00));
  zero   g143(.O(z01));
  zero   g144(.O(z02));
  zero   g145(.O(z06));
