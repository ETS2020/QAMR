// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:46 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n204_, new_n205_, new_n211_, new_n212_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n224_, new_n227_, new_n228_, new_n229_,
    new_n230_, new_n231_, new_n233_, new_n234_, new_n235_, new_n236_,
    new_n237_, new_n238_, new_n239_, new_n240_, new_n241_, new_n242_,
    new_n245_, new_n247_, new_n251_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n278_, new_n281_, new_n283_, new_n286_, new_n288_,
  ...
  nand4  g117(.a(new_n275_), .b(x78), .c(x77), .d(x55), .O(new_n281_));
  nor3   g118(.a(new_n281_), .b(x04), .c(x01), .O(z37));
  nand4  g119(.a(new_n275_), .b(x78), .c(x77), .d(x56), .O(new_n283_));
  ...
  nand4  g129(.a(new_n275_), .b(x78), .c(x77), .d(x62), .O(new_n294_));
  nor3   g130(.a(new_n294_), .b(x04), .c(x01), .O(z44));
  nand4  g131(.a(new_n275_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  ...
  nand4  g159(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n332_));
  oai22  g160(.a(new_n332_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n333_));
  nand4  g161(.a(new_n333_), .b(x79), .c(x78), .d(x04), .O(new_n334_));
  nor2   g162(.a(x79), .b(x78), .O(new_n335_));
  nand3  g163(.a(new_n335_), .b(new_n233_), .c(x40), .O(new_n336_));
  nand2  g164(.a(new_n336_), .b(new_n334_), .O(new_n337_));
  nand2  g165(.a(new_n337_), .b(x77), .O(new_n338_));
  oai21  g166(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n339_));
  aoi21  g167(.a(new_n339_), .b(new_n338_), .c(x01), .O(z58));
  nor2   g168(.a(new_n160_), .b(new_n227_), .O(new_n341_));
  oai21  g169(.a(new_n341_), .b(new_n335_), .c(x40), .O(new_n342_));
  oai21  g170(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n343_));
  nand2  g171(.a(new_n343_), .b(x79), .O(new_n344_));
  nand3  g172(.a(new_n344_), .b(x78), .c(x04), .O(new_n345_));
  nand2  g173(.a(new_n345_), .b(new_n342_), .O(new_n346_));
  nand2  g174(.a(new_n346_), .b(x77), .O(new_n347_));
  nand2  g175(.a(new_n154_), .b(new_n227_), .O(new_n348_));
  aoi21  g176(.a(new_n348_), .b(new_n347_), .c(x01), .O(z59));
  nand2  g177(.a(new_n324_), .b(x79), .O(new_n350_));
  nand3  g178(.a(new_n350_), .b(new_n348_), .c(new_n224_), .O(new_n351_));
  and2   g179(.a(new_n351_), .b(new_n153_), .O(z60));
  nand2  g180(.a(new_n167_), .b(new_n322_), .O(new_n353_));
  nand2  g181(.a(new_n353_), .b(new_n216_), .O(new_n354_));
  oai21  g182(.a(new_n229_), .b(x04), .c(new_n354_), .O(new_n355_));
  nand4  g183(.a(new_n355_), .b(x80), .c(x79), .d(new_n153_), .O(new_n356_));
  inv1   g184(.a(new_n356_), .O(z61));
  nand2  g185(.a(new_n154_), .b(x04), .O(new_n358_));
  nand3  g186(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  aoi21  g187(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand2  g188(.a(new_n344_), .b(x04), .O(new_n361_));
  nand3  g189(.a(x81), .b(x79), .c(new_n227_), .O(new_n362_));
  aoi21  g190(.a(new_n362_), .b(new_n361_), .c(new_n159_), .O(new_n363_));
  oai21  g191(.a(new_n363_), .b(new_n360_), .c(x78), .O(new_n364_));
  or2    g192(.a(new_n359_), .b(new_n167_), .O(new_n365_));
  aoi21  g193(.a(new_n365_), .b(new_n364_), .c(x01), .O(z62));
  nand4  g194(.a(new_n355_), .b(x82), .c(x79), .d(new_n153_), .O(new_n367_));
  inv1   g195(.a(new_n367_), .O(z63));
  nand3  g196(.a(new_n355_), .b(x83), .c(x79), .O(new_n369_));
  nand4  g197(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n370_));
  aoi21  g198(.a(new_n370_), .b(new_n369_), .c(x01), .O(z64));
  nor2   g199(.a(new_n160_), .b(x04), .O(new_n372_));
  nor2   g200(.a(new_n236_), .b(x78), .O(new_n373_));
  oai21  g201(.a(new_n373_), .b(new_n372_), .c(x77), .O(new_n374_));
  nand3  g202(.a(x81), .b(x78), .c(new_n159_), .O(new_n375_));
  nand2  g203(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand4  g204(.a(new_n376_), .b(x84), .c(x79), .d(new_n153_), .O(new_n377_));
  inv1   g205(.a(new_n377_), .O(z65));
  zero   g206(.O(z05));
  zero   g207(.O(z11));
  zero   g208(.O(z17));
  zero   g209(.O(z18));
