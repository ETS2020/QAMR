// Benchmark "FAU" written by ABC on Fri Jul 24 22:40:24 2020
...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n223_, new_n225_, new_n227_, new_n233_, new_n234_, new_n235_,
  ...
  nand4  g064(.a(new_n216_), .b(x49), .c(new_n208_), .d(new_n203_), .O(new_n227_));
  nor2   g065(.a(new_n227_), .b(x01), .O(z31));
  aoi21  g066(.a(x83), .b(x42), .c(x81), .O(new_n233_));
  nand3  g067(.a(x83), .b(x81), .c(x42), .O(new_n234_));
  inv1   g068(.a(new_n234_), .O(new_n235_));
  oai21  g069(.a(new_n235_), .b(new_n233_), .c(new_n212_), .O(new_n236_));
  nand2  g070(.a(x83), .b(x42), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g072(.a(x83), .b(new_n211_), .c(x42), .O(new_n239_));
  nand2  g073(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g074(.a(new_n240_), .b(new_n209_), .O(new_n241_));
  ...
  nor2   g145(.a(new_n211_), .b(x78), .O(new_n324_));
