...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n222_, new_n224_, new_n226_, new_n232_, new_n233_, new_n234_,
    new_n235_, new_n236_, new_n237_, new_n238_, new_n239_, new_n240_,
    new_n241_, new_n242_, new_n244_, new_n246_, new_n248_, new_n250_,
    new_n253_, new_n256_, new_n258_, new_n260_, new_n262_, new_n265_,
  ...
  aoi21  g066(.a(x83), .b(x42), .c(x81), .O(new_n232_));
  nand3  g067(.a(x83), .b(x81), .c(x42), .O(new_n233_));
  inv1   g068(.a(new_n233_), .O(new_n234_));
  oai21  g069(.a(new_n234_), .b(new_n232_), .c(new_n211_), .O(new_n235_));
  nand2  g070(.a(x83), .b(x42), .O(new_n236_));
  nand2  g071(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g072(.a(x83), .b(new_n210_), .c(x42), .O(new_n238_));
  nand2  g073(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g074(.a(new_n239_), .b(new_n208_), .O(new_n240_));
  aoi21  g075(.a(new_n240_), .b(new_n235_), .c(new_n156_), .O(new_n241_));
  nand4  g076(.a(new_n241_), .b(x78), .c(x77), .d(x53), .O(new_n242_));
  nor3   g077(.a(new_n242_), .b(x04), .c(x01), .O(z35));
  nand4  g078(.a(new_n241_), .b(x78), .c(x77), .d(x54), .O(new_n244_));
  nor3   g079(.a(new_n244_), .b(x04), .c(x01), .O(z36));
  nand4  g080(.a(new_n241_), .b(x78), .c(x77), .d(x55), .O(new_n246_));
  nor3   g081(.a(new_n246_), .b(x04), .c(x01), .O(z37));
  nand4  g082(.a(new_n241_), .b(x78), .c(x77), .d(x56), .O(new_n248_));
  nor3   g083(.a(new_n248_), .b(x04), .c(x01), .O(z38));
  nand4  g084(.a(new_n241_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g085(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g086(.a(new_n241_), .b(x78), .c(x77), .d(x59), .O(new_n253_));
  nor3   g087(.a(new_n253_), .b(x04), .c(x01), .O(z41));
  nand4  g088(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g089(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g090(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g091(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g092(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g094(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  nor2   g143(.a(new_n271_), .b(x04), .O(new_n322_));
  nor2   g144(.a(new_n210_), .b(x78), .O(new_n323_));
  oai21  g145(.a(new_n323_), .b(new_n322_), .c(x77), .O(new_n324_));
  nand3  g146(.a(x81), .b(x78), .c(new_n265_), .O(new_n325_));
