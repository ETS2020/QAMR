...
module FAU ( 
  ...
  nand4  g127(.a(new_n280_), .b(x78), .c(x77), .d(x56), .O(new_n288_));
  nor3   g128(.a(new_n288_), .b(x04), .c(x01), .O(z38));
  nand4  g129(.a(new_n280_), .b(x78), .c(x77), .d(x57), .O(new_n290_));
  ...
  nand4  g137(.a(new_n280_), .b(x78), .c(x77), .d(x63), .O(new_n300_));
  ...
  nand2  g152(.a(new_n322_), .b(new_n239_), .O(new_n323_));
  nor4   g153(.a(new_n323_), .b(new_n319_), .c(new_n223_), .d(x82), .O(z55));
  nand2  g154(.a(new_n232_), .b(x76), .O(new_n325_));
  ...
  nand4  g162(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n334_));
  oai22  g163(.a(new_n334_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n335_));
  nand4  g164(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g165(.a(x79), .b(x78), .O(new_n337_));
  nand3  g166(.a(new_n337_), .b(new_n236_), .c(x40), .O(new_n338_));
  nand2  g167(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g168(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g169(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n341_));
  aoi21  g170(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g171(.a(new_n160_), .b(new_n230_), .O(new_n343_));
  oai21  g172(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g173(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n345_));
  ...
  nand2  g178(.a(new_n154_), .b(new_n230_), .O(new_n350_));
  aoi21  g179(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g180(.a(new_n328_), .b(x79), .O(new_n352_));
  nand3  g181(.a(new_n352_), .b(new_n350_), .c(new_n227_), .O(new_n353_));
  and2   g182(.a(new_n353_), .b(new_n153_), .O(z60));
  nand2  g183(.a(new_n167_), .b(new_n326_), .O(new_n355_));
  nand2  g184(.a(new_n355_), .b(new_n219_), .O(new_n356_));
  oai21  g185(.a(new_n232_), .b(x04), .c(new_n356_), .O(new_n357_));
  ...
  nand3  g192(.a(x81), .b(x79), .c(new_n230_), .O(new_n364_));
