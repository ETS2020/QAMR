...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n284_, new_n286_, new_n291_, new_n293_,
  ...
  nand4  g136(.a(new_n283_), .b(x78), .c(x77), .d(x60), .O(new_n297_));
  nor3   g137(.a(new_n297_), .b(x04), .c(x01), .O(z42));
  nand4  g138(.a(new_n283_), .b(x78), .c(x77), .d(x61), .O(new_n299_));
  nor3   g139(.a(new_n299_), .b(x04), .c(x01), .O(z43));
  nand4  g140(.a(new_n283_), .b(x78), .c(x77), .d(x63), .O(new_n302_));
  nor3   g141(.a(new_n302_), .b(x04), .c(x01), .O(z45));
  nand4  g142(.a(new_n283_), .b(x78), .c(x77), .d(x64), .O(new_n304_));
  ...
  nand4  g213(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n375_));
  oai22  g214(.a(new_n375_), .b(new_n226_), .c(new_n239_), .d(x40), .O(new_n376_));
  nand4  g215(.a(new_n376_), .b(x79), .c(x78), .d(x04), .O(new_n377_));
  nor2   g216(.a(x79), .b(x78), .O(new_n378_));
  nand3  g217(.a(new_n378_), .b(new_n239_), .c(x40), .O(new_n379_));
  nand2  g218(.a(new_n379_), .b(new_n377_), .O(new_n380_));
  nand2  g219(.a(new_n380_), .b(x77), .O(new_n381_));
  oai21  g220(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n382_));
  aoi21  g221(.a(new_n382_), .b(new_n381_), .c(x01), .O(z58));
  nor2   g222(.a(new_n160_), .b(new_n231_), .O(new_n384_));
  oai21  g223(.a(new_n384_), .b(new_n378_), .c(x40), .O(new_n385_));
  oai21  g224(.a(new_n226_), .b(new_n224_), .c(new_n239_), .O(new_n386_));
  ...
  nand2  g229(.a(new_n154_), .b(new_n231_), .O(new_n391_));
  aoi21  g230(.a(new_n391_), .b(new_n390_), .c(x01), .O(z59));
  nand2  g231(.a(new_n367_), .b(x79), .O(new_n393_));
  nand3  g232(.a(new_n393_), .b(new_n391_), .c(new_n229_), .O(new_n394_));
  and2   g233(.a(new_n394_), .b(new_n153_), .O(z60));
  nand2  g234(.a(new_n167_), .b(new_n365_), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(new_n221_), .O(new_n397_));
  oai21  g236(.a(new_n235_), .b(x04), .c(new_n397_), .O(new_n398_));
  ...
  nand3  g243(.a(x81), .b(x79), .c(new_n231_), .O(new_n405_));
  ...
  nor2   g254(.a(new_n242_), .b(x78), .O(new_n416_));
