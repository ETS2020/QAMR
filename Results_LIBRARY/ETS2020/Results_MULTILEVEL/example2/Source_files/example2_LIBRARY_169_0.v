...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n246_, new_n249_, new_n251_, new_n254_, new_n258_, new_n259_,
  ...
  nand4  g050(.a(new_n212_), .b(x46), .c(new_n204_), .d(new_n199_), .O(new_n216_));
  nor2   g051(.a(new_n216_), .b(x01), .O(z28));
  nand4  g052(.a(new_n212_), .b(x47), .c(new_n204_), .d(new_n199_), .O(new_n218_));
  nor2   g053(.a(new_n218_), .b(x01), .O(z29));
  nand4  g054(.a(new_n212_), .b(x48), .c(new_n204_), .d(new_n199_), .O(new_n220_));
  nor2   g055(.a(new_n220_), .b(x01), .O(z30));
  nand4  g056(.a(new_n212_), .b(x49), .c(new_n204_), .d(new_n199_), .O(new_n222_));
  ...
  oai21  g061(.a(new_n228_), .b(new_n226_), .c(new_n208_), .O(new_n229_));
  nand2  g062(.a(x83), .b(x42), .O(new_n230_));
  nand2  g063(.a(new_n230_), .b(x81), .O(new_n231_));
  nand3  g064(.a(x83), .b(new_n207_), .c(x42), .O(new_n232_));
  nand2  g065(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand2  g066(.a(new_n233_), .b(new_n205_), .O(new_n234_));
  ...
  nand4  g076(.a(new_n235_), .b(x78), .c(x77), .d(x58), .O(new_n246_));
  nor3   g077(.a(new_n246_), .b(x04), .c(x01), .O(z40));
  nand4  g078(.a(new_n235_), .b(x78), .c(x77), .d(x60), .O(new_n249_));
  nor3   g079(.a(new_n249_), .b(x04), .c(x01), .O(z42));
  nand4  g080(.a(new_n235_), .b(x78), .c(x77), .d(x61), .O(new_n251_));
  ...
  inv1   g126(.a(x02), .O(new_n303_));
  nand4  g127(.a(x03), .b(new_n303_), .c(new_n155_), .d(x00), .O(new_n304_));
  inv1   g128(.a(new_n304_), .O(z57));
  nor2   g129(.a(new_n264_), .b(x04), .O(new_n313_));
  nor2   g130(.a(new_n207_), .b(x78), .O(new_n314_));
  oai21  g131(.a(new_n314_), .b(new_n313_), .c(x77), .O(new_n315_));
  nand3  g132(.a(x81), .b(x78), .c(new_n258_), .O(new_n316_));
  nand2  g133(.a(new_n316_), .b(new_n315_), .O(new_n317_));
  nand4  g134(.a(new_n317_), .b(x84), .c(x79), .d(new_n155_), .O(new_n318_));
  inv1   g135(.a(new_n318_), .O(z65));
  zero   g136(.O(z00));
  zero   g137(.O(z01));
  zero   g138(.O(z02));
  zero   g139(.O(z07));
