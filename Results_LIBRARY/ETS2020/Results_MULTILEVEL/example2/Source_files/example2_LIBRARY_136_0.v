...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n194_, new_n195_, new_n199_, new_n200_, new_n203_, new_n204_,
  ...
  nand4  g084(.a(new_n240_), .b(x78), .c(x77), .d(x56), .O(new_n249_));
  nor3   g085(.a(new_n249_), .b(x04), .c(x01), .O(z38));
  nand4  g086(.a(new_n240_), .b(x78), .c(x77), .d(x57), .O(new_n251_));
  ...
  nor2   g148(.a(new_n211_), .b(x78), .O(new_n325_));
