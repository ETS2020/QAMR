...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n237_, new_n238_, new_n239_, new_n240_, new_n245_, new_n247_,
    ...
    new_n318_, new_n319_, new_n320_, new_n321_, new_n322_, new_n327_,
  ...
  nand4  g083(.a(new_n239_), .b(x47), .c(new_n231_), .d(new_n225_), .O(new_n245_));
  ...
  nand4  g089(.a(new_n239_), .b(x50), .c(new_n231_), .d(new_n225_), .O(new_n251_));
  ...
  nor2   g106(.a(new_n218_), .b(new_n231_), .O(new_n268_));
  nand3  g107(.a(x83), .b(x81), .c(x42), .O(new_n269_));
  oai21  g108(.a(new_n268_), .b(x81), .c(new_n269_), .O(new_n270_));
  nand2  g109(.a(new_n270_), .b(new_n235_), .O(new_n271_));
  oai22  g110(.a(new_n268_), .b(new_n234_), .c(new_n253_), .d(new_n231_), .O(new_n272_));
  nand2  g111(.a(new_n272_), .b(new_n232_), .O(new_n273_));
  aoi21  g112(.a(new_n273_), .b(new_n271_), .c(new_n156_), .O(new_n274_));
  ...
  nand2  g143(.a(new_n299_), .b(x09), .O(new_n309_));
  aoi21  g144(.a(new_n309_), .b(new_n308_), .c(x79), .O(new_n310_));
  nand4  g145(.a(new_n310_), .b(x78), .c(new_n153_), .d(x04), .O(new_n311_));
  nand4  g146(.a(new_n214_), .b(x79), .c(new_n154_), .d(x77), .O(new_n312_));
  inv1   g147(.a(new_n312_), .O(new_n313_));
  nand2  g148(.a(new_n313_), .b(x69), .O(new_n314_));
  aoi21  g149(.a(new_n314_), .b(new_n311_), .c(x01), .O(z49));
  nand2  g150(.a(x52), .b(x20), .O(new_n318_));
  nand2  g151(.a(new_n299_), .b(x12), .O(new_n319_));
  aoi21  g152(.a(new_n319_), .b(new_n318_), .c(x79), .O(new_n320_));
  nand4  g153(.a(new_n320_), .b(x78), .c(new_n153_), .d(x04), .O(new_n321_));
  nand2  g154(.a(new_n313_), .b(x72), .O(new_n322_));
  aoi21  g155(.a(new_n322_), .b(new_n321_), .c(x01), .O(z52));
  nand2  g156(.a(new_n227_), .b(x76), .O(new_n327_));
  inv1   g157(.a(new_n161_), .O(new_n328_));
  xnor2a g158(.a(x84), .b(x81), .O(new_n329_));
  aoi21  g159(.a(new_n163_), .b(new_n328_), .c(new_n329_), .O(new_n330_));
  nand2  g160(.a(new_n330_), .b(new_n159_), .O(new_n331_));
  nand2  g161(.a(new_n331_), .b(new_n327_), .O(new_n332_));
  nand2  g162(.a(new_n332_), .b(x79), .O(new_n333_));
  nand4  g163(.a(new_n333_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  nand4  g164(.a(x80), .b(new_n216_), .c(x43), .d(new_n231_), .O(new_n336_));
  oai22  g165(.a(new_n336_), .b(new_n219_), .c(new_n231_), .d(x40), .O(new_n337_));
  nand4  g166(.a(new_n337_), .b(x79), .c(x78), .d(x04), .O(new_n338_));
  nor2   g167(.a(x79), .b(x78), .O(new_n339_));
  nand3  g168(.a(new_n339_), .b(new_n231_), .c(x40), .O(new_n340_));
  nand2  g169(.a(new_n340_), .b(new_n338_), .O(new_n341_));
  nand2  g170(.a(new_n341_), .b(x77), .O(new_n342_));
  oai21  g171(.a(new_n161_), .b(new_n225_), .c(new_n156_), .O(new_n343_));
  aoi21  g172(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g173(.a(new_n154_), .b(new_n225_), .O(new_n345_));
  oai21  g174(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g175(.a(new_n219_), .b(new_n217_), .c(new_n231_), .O(new_n347_));
  ...
  nand2  g180(.a(new_n156_), .b(new_n225_), .O(new_n352_));
  aoi21  g181(.a(new_n352_), .b(new_n351_), .c(x01), .O(z59));
  nand2  g182(.a(new_n330_), .b(x79), .O(new_n354_));
  nand3  g183(.a(new_n354_), .b(new_n352_), .c(new_n222_), .O(new_n355_));
  and2   g184(.a(new_n355_), .b(new_n159_), .O(z60));
  nand2  g185(.a(new_n163_), .b(new_n328_), .O(new_n357_));
  nand2  g186(.a(new_n357_), .b(new_n214_), .O(new_n358_));
  oai21  g187(.a(new_n227_), .b(x04), .c(new_n358_), .O(new_n359_));
  nand4  g188(.a(new_n359_), .b(x80), .c(x79), .d(new_n159_), .O(new_n360_));
  inv1   g189(.a(new_n360_), .O(z61));
  nand2  g190(.a(new_n156_), .b(x04), .O(new_n362_));
  ...
  nand3  g194(.a(x81), .b(x79), .c(new_n225_), .O(new_n366_));
  aoi21  g195(.a(new_n366_), .b(new_n365_), .c(new_n153_), .O(new_n367_));
  oai21  g196(.a(new_n367_), .b(new_n364_), .c(x78), .O(new_n368_));
  or2    g197(.a(new_n363_), .b(new_n163_), .O(new_n369_));
  aoi21  g198(.a(new_n369_), .b(new_n368_), .c(x01), .O(z62));
  nand4  g199(.a(new_n359_), .b(x82), .c(x79), .d(new_n159_), .O(new_n371_));
  inv1   g200(.a(new_n371_), .O(z63));
  nand3  g201(.a(new_n359_), .b(x83), .c(x79), .O(new_n373_));
  nand4  g202(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n374_));
  aoi21  g203(.a(new_n374_), .b(new_n373_), .c(x01), .O(z64));
  nor2   g204(.a(new_n154_), .b(x04), .O(new_n376_));
  nor2   g205(.a(new_n234_), .b(x78), .O(new_n377_));
  oai21  g206(.a(new_n377_), .b(new_n376_), .c(x77), .O(new_n378_));
  nand3  g207(.a(x81), .b(x78), .c(new_n153_), .O(new_n379_));
  nand2  g208(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  nand4  g209(.a(new_n380_), .b(x84), .c(x79), .d(new_n159_), .O(new_n381_));
  inv1   g210(.a(new_n381_), .O(z65));
  zero   g211(.O(z00));
  zero   g212(.O(z05));
  zero   g213(.O(z09));
  zero   g214(.O(z13));
