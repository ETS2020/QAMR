...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    ...
    z42, z43, z44, z45, z46, z47, z48, z49, z50, z51, z52, z53, z54, z55,
    z56, z57, z58, z59, z60, z61, z62, z63, z64, z65;
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n163_, new_n164_,
    ...
    new_n220_, new_n223_, new_n225_, new_n227_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
    new_n240_, new_n241_, new_n242_, new_n245_, new_n248_, new_n250_,
  ...
  oai21  g070(.a(new_n234_), .b(new_n232_), .c(new_n213_), .O(new_n235_));
  nand2  g071(.a(x83), .b(x42), .O(new_n236_));
  nand2  g072(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g073(.a(x83), .b(new_n212_), .c(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(new_n210_), .O(new_n240_));
  ...
  nand4  g081(.a(new_n241_), .b(x78), .c(x77), .d(x56), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z38));
  nand4  g083(.a(new_n241_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g084(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g085(.a(new_n241_), .b(x78), .c(x77), .d(x60), .O(new_n254_));
  nor3   g086(.a(new_n254_), .b(x04), .c(x01), .O(z42));
  nand4  g087(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g088(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g089(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g090(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g091(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g092(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g093(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  nor2   g142(.a(new_n271_), .b(x04), .O(new_n322_));
  nor2   g143(.a(new_n212_), .b(x78), .O(new_n323_));
  oai21  g144(.a(new_n323_), .b(new_n322_), .c(x77), .O(new_n324_));
  nand3  g145(.a(x81), .b(x78), .c(new_n265_), .O(new_n325_));
