...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n286_, new_n288_, new_n290_, new_n292_, new_n294_,
  ...
  nand4  g125(.a(new_n280_), .b(x78), .c(x77), .d(x55), .O(new_n286_));
  ...
  nand4  g133(.a(new_n280_), .b(x78), .c(x77), .d(x59), .O(new_n294_));
  nor3   g134(.a(new_n294_), .b(x04), .c(x01), .O(z41));
  nand4  g135(.a(new_n280_), .b(x78), .c(x77), .d(x60), .O(new_n296_));
  ...
  nand4  g139(.a(new_n280_), .b(x78), .c(x77), .d(x64), .O(new_n302_));
