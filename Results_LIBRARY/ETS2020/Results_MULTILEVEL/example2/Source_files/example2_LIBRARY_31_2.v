// Benchmark "FAU" written by ABC on Fri Jul 24 22:40:42 2020
...
module FAU ( 
  ...
  nand4  g131(.a(new_n285_), .b(x78), .c(x77), .d(x54), .O(new_n289_));
  nor3   g132(.a(new_n289_), .b(x04), .c(x01), .O(z36));
  nand4  g133(.a(new_n285_), .b(x78), .c(x77), .d(x56), .O(new_n292_));
  ...
  nand4  g139(.a(new_n285_), .b(x78), .c(x77), .d(x60), .O(new_n299_));
  nor3   g140(.a(new_n299_), .b(x04), .c(x01), .O(z42));
  nand4  g141(.a(new_n285_), .b(x78), .c(x77), .d(x61), .O(new_n301_));
  nor3   g142(.a(new_n301_), .b(x04), .c(x01), .O(z43));
  nand4  g143(.a(new_n285_), .b(x78), .c(x77), .d(x62), .O(new_n303_));
