...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n292_, new_n295_, new_n297_, new_n299_, new_n302_, new_n305_,
  ...
  nand4  g097(.a(new_n246_), .b(x46), .c(new_n238_), .d(new_n230_), .O(new_n253_));
  nor2   g098(.a(new_n253_), .b(x01), .O(z28));
  nand4  g099(.a(new_n246_), .b(x47), .c(new_n238_), .d(new_n230_), .O(new_n255_));
  nor2   g100(.a(new_n255_), .b(x01), .O(z29));
  nand4  g101(.a(new_n246_), .b(x48), .c(new_n238_), .d(new_n230_), .O(new_n257_));
  nor2   g102(.a(new_n257_), .b(x01), .O(z30));
  nand4  g103(.a(new_n246_), .b(x49), .c(new_n238_), .d(new_n230_), .O(new_n259_));
  nor2   g104(.a(new_n259_), .b(x01), .O(z31));
  nand4  g105(.a(new_n246_), .b(x50), .c(new_n238_), .d(new_n230_), .O(new_n261_));
  nor2   g106(.a(new_n261_), .b(x01), .O(z32));
  nand2  g107(.a(x83), .b(new_n241_), .O(new_n263_));
  nand2  g108(.a(new_n224_), .b(x81), .O(new_n264_));
  nand2  g109(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand3  g110(.a(new_n265_), .b(x42), .c(x05), .O(new_n266_));
  nand3  g111(.a(x81), .b(x51), .c(new_n238_), .O(new_n267_));
  nand2  g112(.a(new_n267_), .b(new_n266_), .O(new_n268_));
  nand2  g113(.a(new_n268_), .b(new_n239_), .O(new_n269_));
  xnor2a g114(.a(x83), .b(x81), .O(new_n270_));
  nand3  g115(.a(new_n270_), .b(x42), .c(x05), .O(new_n271_));
  nand3  g116(.a(new_n241_), .b(x51), .c(new_n238_), .O(new_n272_));
  nand2  g117(.a(new_n272_), .b(new_n271_), .O(new_n273_));
  nand2  g118(.a(new_n273_), .b(new_n242_), .O(new_n274_));
  aoi21  g119(.a(new_n274_), .b(new_n269_), .c(new_n154_), .O(new_n275_));
  nand4  g120(.a(new_n275_), .b(x78), .c(x77), .d(new_n230_), .O(new_n276_));
  nor2   g121(.a(new_n276_), .b(x01), .O(z33));
  nor2   g122(.a(new_n224_), .b(new_n238_), .O(new_n278_));
  nand3  g123(.a(x83), .b(x81), .c(x42), .O(new_n279_));
  oai21  g124(.a(new_n278_), .b(x81), .c(new_n279_), .O(new_n280_));
  nand2  g125(.a(new_n280_), .b(new_n242_), .O(new_n281_));
  oai22  g126(.a(new_n278_), .b(new_n241_), .c(new_n263_), .d(new_n238_), .O(new_n282_));
  nand2  g127(.a(new_n282_), .b(new_n239_), .O(new_n283_));
  aoi21  g128(.a(new_n283_), .b(new_n281_), .c(new_n154_), .O(new_n284_));
  nand4  g129(.a(new_n284_), .b(x78), .c(x77), .d(x52), .O(new_n285_));
  nor3   g130(.a(new_n285_), .b(x04), .c(x01), .O(z34));
  nand4  g131(.a(new_n284_), .b(x78), .c(x77), .d(x53), .O(new_n287_));
  nor3   g132(.a(new_n287_), .b(x04), .c(x01), .O(z35));
  nand4  g133(.a(new_n284_), .b(x78), .c(x77), .d(x54), .O(new_n289_));
  nor3   g134(.a(new_n289_), .b(x04), .c(x01), .O(z36));
  nand4  g135(.a(new_n284_), .b(x78), .c(x77), .d(x56), .O(new_n292_));
  nor3   g136(.a(new_n292_), .b(x04), .c(x01), .O(z38));
  nand4  g137(.a(new_n284_), .b(x78), .c(x77), .d(x58), .O(new_n295_));
  nor3   g138(.a(new_n295_), .b(x04), .c(x01), .O(z40));
  nand4  g139(.a(new_n284_), .b(x78), .c(x77), .d(x59), .O(new_n297_));
  nor3   g140(.a(new_n297_), .b(x04), .c(x01), .O(z41));
  nand4  g141(.a(new_n284_), .b(x78), .c(x77), .d(x60), .O(new_n299_));
  nor3   g142(.a(new_n299_), .b(x04), .c(x01), .O(z42));
  nand4  g143(.a(new_n284_), .b(x78), .c(x77), .d(x62), .O(new_n302_));
  nor3   g144(.a(new_n302_), .b(x04), .c(x01), .O(z44));
  nand4  g145(.a(new_n284_), .b(x78), .c(x77), .d(x64), .O(new_n305_));
  ...
  nor2   g153(.a(new_n312_), .b(new_n219_), .O(new_n313_));
  ...
  nand4  g160(.a(new_n220_), .b(x79), .c(new_n160_), .d(x77), .O(new_n320_));
  ...
  nand2  g203(.a(new_n362_), .b(new_n241_), .O(new_n363_));
  nor4   g204(.a(new_n363_), .b(new_n359_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g205(.a(new_n234_), .b(x76), .O(new_n365_));
  ...
  nand4  g213(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n374_));
  oai22  g214(.a(new_n374_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n375_));
  nand4  g215(.a(new_n375_), .b(x79), .c(x78), .d(x04), .O(new_n376_));
  nor2   g216(.a(x79), .b(x78), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(new_n238_), .c(x40), .O(new_n378_));
  nand2  g218(.a(new_n378_), .b(new_n376_), .O(new_n379_));
  nand2  g219(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g220(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n381_));
  aoi21  g221(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  nor2   g222(.a(new_n160_), .b(new_n230_), .O(new_n383_));
  oai21  g223(.a(new_n383_), .b(new_n377_), .c(x40), .O(new_n384_));
  oai21  g224(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n385_));
  nand2  g225(.a(new_n385_), .b(x79), .O(new_n386_));
  nand3  g226(.a(new_n386_), .b(x78), .c(x04), .O(new_n387_));
  nand2  g227(.a(new_n387_), .b(new_n384_), .O(new_n388_));
  nand2  g228(.a(new_n388_), .b(x77), .O(new_n389_));
  nand2  g229(.a(new_n154_), .b(new_n230_), .O(new_n390_));
  aoi21  g230(.a(new_n390_), .b(new_n389_), .c(x01), .O(z59));
  nand2  g231(.a(new_n368_), .b(x79), .O(new_n392_));
  nand3  g232(.a(new_n392_), .b(new_n390_), .c(new_n228_), .O(new_n393_));
  and2   g233(.a(new_n393_), .b(new_n153_), .O(z60));
  nand2  g234(.a(new_n167_), .b(new_n366_), .O(new_n395_));
  nand2  g235(.a(new_n395_), .b(new_n220_), .O(new_n396_));
  oai21  g236(.a(new_n234_), .b(x04), .c(new_n396_), .O(new_n397_));
  nand4  g237(.a(new_n397_), .b(x80), .c(x79), .d(new_n153_), .O(new_n398_));
  inv1   g238(.a(new_n398_), .O(z61));
  nand2  g239(.a(new_n154_), .b(x04), .O(new_n400_));
  nand3  g240(.a(x84), .b(x81), .c(x79), .O(new_n401_));
  aoi21  g241(.a(new_n401_), .b(new_n400_), .c(x77), .O(new_n402_));
  nand2  g242(.a(new_n386_), .b(x04), .O(new_n403_));
  nand3  g243(.a(x81), .b(x79), .c(new_n230_), .O(new_n404_));
  aoi21  g244(.a(new_n404_), .b(new_n403_), .c(new_n159_), .O(new_n405_));
  oai21  g245(.a(new_n405_), .b(new_n402_), .c(x78), .O(new_n406_));
  or2    g246(.a(new_n401_), .b(new_n167_), .O(new_n407_));
  aoi21  g247(.a(new_n407_), .b(new_n406_), .c(x01), .O(z62));
  nand4  g248(.a(new_n397_), .b(x82), .c(x79), .d(new_n153_), .O(new_n409_));
  inv1   g249(.a(new_n409_), .O(z63));
  nand3  g250(.a(new_n397_), .b(x83), .c(x79), .O(new_n411_));
  nand4  g251(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n412_));
  aoi21  g252(.a(new_n412_), .b(new_n411_), .c(x01), .O(z64));
  nor2   g253(.a(new_n160_), .b(x04), .O(new_n414_));
  nor2   g254(.a(new_n241_), .b(x78), .O(new_n415_));
  oai21  g255(.a(new_n415_), .b(new_n414_), .c(x77), .O(new_n416_));
  nand3  g256(.a(x81), .b(x78), .c(new_n159_), .O(new_n417_));
  nand2  g257(.a(new_n417_), .b(new_n416_), .O(new_n418_));
  nand4  g258(.a(new_n418_), .b(x84), .c(x79), .d(new_n153_), .O(new_n419_));
  inv1   g259(.a(new_n419_), .O(z65));
  zero   g260(.O(z05));
  zero   g261(.O(z07));
  zero   g262(.O(z08));
  zero   g263(.O(z17));
