...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n214_, new_n215_, new_n216_, new_n217_, new_n219_, new_n223_,
    new_n226_, new_n229_, new_n230_, new_n231_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
    new_n242_, new_n245_, new_n250_, new_n252_, new_n254_, new_n256_,
  ...
  nand4  g058(.a(new_n216_), .b(x48), .c(new_n208_), .d(new_n203_), .O(new_n223_));
  nor2   g059(.a(new_n223_), .b(x01), .O(z30));
  nand4  g060(.a(new_n216_), .b(x50), .c(new_n208_), .d(new_n203_), .O(new_n226_));
  ...
  nand4  g076(.a(new_n238_), .b(x78), .c(x77), .d(x56), .O(new_n245_));
  nor3   g077(.a(new_n245_), .b(x04), .c(x01), .O(z38));
  nand4  g078(.a(new_n238_), .b(x78), .c(x77), .d(x60), .O(new_n250_));
  nor3   g079(.a(new_n250_), .b(x04), .c(x01), .O(z42));
  nand4  g080(.a(new_n238_), .b(x78), .c(x77), .d(x61), .O(new_n252_));
  nor3   g081(.a(new_n252_), .b(x04), .c(x01), .O(z43));
  nand4  g082(.a(new_n238_), .b(x78), .c(x77), .d(x62), .O(new_n254_));
  nor3   g083(.a(new_n254_), .b(x04), .c(x01), .O(z44));
  nand4  g084(.a(new_n238_), .b(x78), .c(x77), .d(x63), .O(new_n256_));
  nor3   g085(.a(new_n256_), .b(x04), .c(x01), .O(z45));
  nand4  g086(.a(new_n238_), .b(x78), .c(x77), .d(x64), .O(new_n258_));
  nor3   g087(.a(new_n258_), .b(x04), .c(x01), .O(z46));
  inv1   g088(.a(x77), .O(new_n261_));
  nand2  g089(.a(x52), .b(x16), .O(new_n262_));
  inv1   g090(.a(x52), .O(new_n263_));
  nand2  g091(.a(new_n263_), .b(x08), .O(new_n264_));
  aoi21  g092(.a(new_n264_), .b(new_n262_), .c(x79), .O(new_n265_));
  nand4  g093(.a(new_n265_), .b(x78), .c(new_n261_), .d(x04), .O(new_n266_));
  inv1   g094(.a(x78), .O(new_n267_));
  xnor2a g095(.a(x84), .b(x81), .O(new_n268_));
  nand4  g096(.a(new_n268_), .b(x79), .c(new_n267_), .d(x77), .O(new_n269_));
  inv1   g097(.a(new_n269_), .O(new_n270_));
  nand2  g098(.a(new_n270_), .b(x68), .O(new_n271_));
  aoi21  g099(.a(new_n271_), .b(new_n266_), .c(x01), .O(z48));
  nand2  g100(.a(x52), .b(x17), .O(new_n273_));
  nand2  g101(.a(new_n263_), .b(x09), .O(new_n274_));
  aoi21  g102(.a(new_n274_), .b(new_n273_), .c(x79), .O(new_n275_));
  nand4  g103(.a(new_n275_), .b(x78), .c(new_n261_), .d(x04), .O(new_n276_));
  nand2  g104(.a(new_n270_), .b(x69), .O(new_n277_));
  aoi21  g105(.a(new_n277_), .b(new_n276_), .c(x01), .O(z49));
  nand2  g106(.a(x52), .b(x18), .O(new_n279_));
  nand2  g107(.a(new_n263_), .b(x10), .O(new_n280_));
  aoi21  g108(.a(new_n280_), .b(new_n279_), .c(x79), .O(new_n281_));
  nand4  g109(.a(new_n281_), .b(x78), .c(new_n261_), .d(x04), .O(new_n282_));
  nand2  g110(.a(new_n270_), .b(x70), .O(new_n283_));
  aoi21  g111(.a(new_n283_), .b(new_n282_), .c(x01), .O(z50));
  nand2  g112(.a(x52), .b(x19), .O(new_n285_));
  nand2  g113(.a(new_n263_), .b(x11), .O(new_n286_));
  aoi21  g114(.a(new_n286_), .b(new_n285_), .c(x79), .O(new_n287_));
  nand4  g115(.a(new_n287_), .b(x78), .c(new_n261_), .d(x04), .O(new_n288_));
  nand2  g116(.a(new_n270_), .b(x71), .O(new_n289_));
  aoi21  g117(.a(new_n289_), .b(new_n288_), .c(x01), .O(z51));
  nand2  g118(.a(x52), .b(x20), .O(new_n291_));
  nand2  g119(.a(new_n263_), .b(x12), .O(new_n292_));
  aoi21  g120(.a(new_n292_), .b(new_n291_), .c(x79), .O(new_n293_));
  nand4  g121(.a(new_n293_), .b(x78), .c(new_n261_), .d(x04), .O(new_n294_));
  nand2  g122(.a(new_n270_), .b(x72), .O(new_n295_));
  aoi21  g123(.a(new_n295_), .b(new_n294_), .c(x01), .O(z52));
  nand2  g124(.a(x52), .b(x21), .O(new_n297_));
  nand2  g125(.a(new_n263_), .b(x13), .O(new_n298_));
  aoi21  g126(.a(new_n298_), .b(new_n297_), .c(x79), .O(new_n299_));
  nand4  g127(.a(new_n299_), .b(x78), .c(new_n261_), .d(x04), .O(new_n300_));
  nand2  g128(.a(new_n270_), .b(x73), .O(new_n301_));
  aoi21  g129(.a(new_n301_), .b(new_n300_), .c(x01), .O(z53));
  inv1   g130(.a(x02), .O(new_n306_));
  nand4  g131(.a(x03), .b(new_n306_), .c(new_n155_), .d(x00), .O(new_n307_));
  inv1   g132(.a(new_n307_), .O(z57));
  nor2   g133(.a(new_n267_), .b(x04), .O(new_n316_));
  nor2   g134(.a(new_n211_), .b(x78), .O(new_n317_));
  oai21  g135(.a(new_n317_), .b(new_n316_), .c(x77), .O(new_n318_));
  nand3  g136(.a(x81), .b(x78), .c(new_n261_), .O(new_n319_));
