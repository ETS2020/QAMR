// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:01 2020
...
module FAU ( 
  ...
  nand4  g058(.a(new_n217_), .b(x48), .c(new_n209_), .d(new_n203_), .O(new_n223_));
  nor2   g059(.a(new_n223_), .b(x01), .O(z30));
  nand4  g060(.a(new_n217_), .b(x49), .c(new_n209_), .d(new_n203_), .O(new_n225_));
  nor2   g061(.a(new_n225_), .b(x01), .O(z31));
  ...
  nand4  g086(.a(new_n239_), .b(x78), .c(x77), .d(x59), .O(new_n253_));
  nor3   g087(.a(new_n253_), .b(x04), .c(x01), .O(z41));
  nand4  g088(.a(new_n239_), .b(x78), .c(x77), .d(x60), .O(new_n255_));
  nor3   g089(.a(new_n255_), .b(x04), .c(x01), .O(z42));
  nand4  g090(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  ...
  nor2   g149(.a(new_n212_), .b(x78), .O(new_n326_));
