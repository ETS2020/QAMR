...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n246_, new_n249_, new_n251_, new_n253_, new_n255_, new_n257_,
  ...
  nand4  g091(.a(new_n245_), .b(x78), .c(x77), .d(x57), .O(new_n255_));
  nor3   g092(.a(new_n255_), .b(x04), .c(x01), .O(z39));
  nand4  g093(.a(new_n245_), .b(x78), .c(x77), .d(x58), .O(new_n257_));
