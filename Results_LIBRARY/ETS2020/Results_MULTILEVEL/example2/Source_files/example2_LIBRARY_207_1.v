...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n177_, new_n178_, new_n183_, new_n184_, new_n186_, new_n187_,
    ...
    new_n285_, new_n287_, new_n289_, new_n292_, new_n294_, new_n296_,
    new_n298_, new_n300_, new_n302_, new_n311_, new_n312_, new_n313_,
  ...
  nand4  g086(.a(new_n240_), .b(x45), .c(new_n232_), .d(new_n224_), .O(new_n245_));
  nor2   g087(.a(new_n245_), .b(x01), .O(z27));
  nand4  g088(.a(new_n240_), .b(x46), .c(new_n232_), .d(new_n224_), .O(new_n247_));
  nor2   g089(.a(new_n247_), .b(x01), .O(z28));
  nand4  g090(.a(new_n240_), .b(x47), .c(new_n232_), .d(new_n224_), .O(new_n249_));
  nor2   g091(.a(new_n249_), .b(x01), .O(z29));
  nand4  g092(.a(new_n240_), .b(x48), .c(new_n232_), .d(new_n224_), .O(new_n251_));
  nor2   g093(.a(new_n251_), .b(x01), .O(z30));
  nand4  g094(.a(new_n240_), .b(x49), .c(new_n232_), .d(new_n224_), .O(new_n253_));
  nor2   g095(.a(new_n253_), .b(x01), .O(z31));
  nand4  g096(.a(new_n240_), .b(x50), .c(new_n232_), .d(new_n224_), .O(new_n255_));
  nor2   g097(.a(new_n255_), .b(x01), .O(z32));
  nand2  g098(.a(x83), .b(new_n235_), .O(new_n257_));
  nand2  g099(.a(new_n218_), .b(x81), .O(new_n258_));
  ...
  nand4  g111(.a(new_n269_), .b(x78), .c(x77), .d(new_n224_), .O(new_n270_));
  nor2   g112(.a(new_n270_), .b(x01), .O(z33));
  nor2   g113(.a(new_n218_), .b(new_n232_), .O(new_n272_));
  ...
  aoi21  g119(.a(new_n277_), .b(new_n275_), .c(new_n154_), .O(new_n278_));
  ...
  nand4  g126(.a(new_n278_), .b(x78), .c(x77), .d(x55), .O(new_n285_));
  nor3   g127(.a(new_n285_), .b(x04), .c(x01), .O(z37));
  nand4  g128(.a(new_n278_), .b(x78), .c(x77), .d(x56), .O(new_n287_));
  nor3   g129(.a(new_n287_), .b(x04), .c(x01), .O(z38));
  nand4  g130(.a(new_n278_), .b(x78), .c(x77), .d(x57), .O(new_n289_));
  nor3   g131(.a(new_n289_), .b(x04), .c(x01), .O(z39));
  nand4  g132(.a(new_n278_), .b(x78), .c(x77), .d(x59), .O(new_n292_));
  nor3   g133(.a(new_n292_), .b(x04), .c(x01), .O(z41));
  nand4  g134(.a(new_n278_), .b(x78), .c(x77), .d(x60), .O(new_n294_));
  nor3   g135(.a(new_n294_), .b(x04), .c(x01), .O(z42));
  nand4  g136(.a(new_n278_), .b(x78), .c(x77), .d(x61), .O(new_n296_));
  nor3   g137(.a(new_n296_), .b(x04), .c(x01), .O(z43));
  nand4  g138(.a(new_n278_), .b(x78), .c(x77), .d(x62), .O(new_n298_));
  nor3   g139(.a(new_n298_), .b(x04), .c(x01), .O(z44));
  nand4  g140(.a(new_n278_), .b(x78), .c(x77), .d(x63), .O(new_n300_));
  nor3   g141(.a(new_n300_), .b(x04), .c(x01), .O(z45));
  nand4  g142(.a(new_n278_), .b(x78), .c(x77), .d(x64), .O(new_n302_));
  nor3   g143(.a(new_n302_), .b(x04), .c(x01), .O(z46));
  nand2  g144(.a(x52), .b(x22), .O(new_n311_));
  inv1   g145(.a(x52), .O(new_n312_));
  nand2  g146(.a(new_n312_), .b(x14), .O(new_n313_));
  aoi21  g147(.a(new_n313_), .b(new_n311_), .c(x79), .O(new_n314_));
  nand4  g148(.a(new_n314_), .b(x78), .c(new_n159_), .d(x04), .O(new_n315_));
  nor2   g149(.a(new_n315_), .b(x01), .O(z54));
  inv1   g150(.a(x84), .O(new_n317_));
  nor2   g151(.a(x04), .b(x01), .O(new_n318_));
  nand4  g152(.a(new_n318_), .b(x79), .c(x78), .d(x77), .O(new_n319_));
  nor2   g153(.a(new_n319_), .b(x80), .O(new_n320_));
  nand2  g154(.a(new_n320_), .b(new_n235_), .O(new_n321_));
  nor4   g155(.a(new_n321_), .b(new_n317_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g156(.a(new_n228_), .b(x76), .O(new_n323_));
  inv1   g157(.a(new_n165_), .O(new_n324_));
  xnor2a g158(.a(x84), .b(x81), .O(new_n325_));
  aoi21  g159(.a(new_n167_), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g160(.a(new_n326_), .b(new_n153_), .O(new_n327_));
  nand2  g161(.a(new_n327_), .b(new_n323_), .O(new_n328_));
  nand2  g162(.a(new_n328_), .b(x79), .O(new_n329_));
  nand4  g163(.a(new_n329_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g164(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n332_));
  oai22  g165(.a(new_n332_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n333_));
  nand4  g166(.a(new_n333_), .b(x79), .c(x78), .d(x04), .O(new_n334_));
  nor2   g167(.a(x79), .b(x78), .O(new_n335_));
  nand3  g168(.a(new_n335_), .b(new_n232_), .c(x40), .O(new_n336_));
  nand2  g169(.a(new_n336_), .b(new_n334_), .O(new_n337_));
  nand2  g170(.a(new_n337_), .b(x77), .O(new_n338_));
  oai21  g171(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n339_));
  aoi21  g172(.a(new_n339_), .b(new_n338_), .c(x01), .O(z58));
  nor2   g173(.a(new_n160_), .b(new_n224_), .O(new_n341_));
  oai21  g174(.a(new_n341_), .b(new_n335_), .c(x40), .O(new_n342_));
  oai21  g175(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n343_));
  nand2  g176(.a(new_n343_), .b(x79), .O(new_n344_));
  nand3  g177(.a(new_n344_), .b(x78), .c(x04), .O(new_n345_));
  nand2  g178(.a(new_n345_), .b(new_n342_), .O(new_n346_));
  nand2  g179(.a(new_n346_), .b(x77), .O(new_n347_));
  nand2  g180(.a(new_n154_), .b(new_n224_), .O(new_n348_));
  aoi21  g181(.a(new_n348_), .b(new_n347_), .c(x01), .O(z59));
  nand2  g182(.a(new_n326_), .b(x79), .O(new_n350_));
  nand3  g183(.a(new_n350_), .b(new_n348_), .c(new_n222_), .O(new_n351_));
  and2   g184(.a(new_n351_), .b(new_n153_), .O(z60));
  nand2  g185(.a(new_n167_), .b(new_n324_), .O(new_n353_));
  nand2  g186(.a(new_n353_), .b(new_n214_), .O(new_n354_));
  oai21  g187(.a(new_n228_), .b(x04), .c(new_n354_), .O(new_n355_));
  nand4  g188(.a(new_n355_), .b(x80), .c(x79), .d(new_n153_), .O(new_n356_));
  inv1   g189(.a(new_n356_), .O(z61));
  nand2  g190(.a(new_n154_), .b(x04), .O(new_n358_));
  nand3  g191(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand2  g193(.a(new_n344_), .b(x04), .O(new_n361_));
  nand3  g194(.a(x81), .b(x79), .c(new_n224_), .O(new_n362_));
  aoi21  g195(.a(new_n362_), .b(new_n361_), .c(new_n159_), .O(new_n363_));
  oai21  g196(.a(new_n363_), .b(new_n360_), .c(x78), .O(new_n364_));
  or2    g197(.a(new_n359_), .b(new_n167_), .O(new_n365_));
  aoi21  g198(.a(new_n365_), .b(new_n364_), .c(x01), .O(z62));
  nand4  g199(.a(new_n355_), .b(x82), .c(x79), .d(new_n153_), .O(new_n367_));
  inv1   g200(.a(new_n367_), .O(z63));
  nand3  g201(.a(new_n355_), .b(x83), .c(x79), .O(new_n369_));
  nand4  g202(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n370_));
  aoi21  g203(.a(new_n370_), .b(new_n369_), .c(x01), .O(z64));
  nor2   g204(.a(new_n160_), .b(x04), .O(new_n372_));
  nor2   g205(.a(new_n235_), .b(x78), .O(new_n373_));
  oai21  g206(.a(new_n373_), .b(new_n372_), .c(x77), .O(new_n374_));
  nand3  g207(.a(x81), .b(x78), .c(new_n159_), .O(new_n375_));
  nand2  g208(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand4  g209(.a(new_n376_), .b(x84), .c(x79), .d(new_n153_), .O(new_n377_));
  inv1   g210(.a(new_n377_), .O(z65));
  zero   g211(.O(z05));
  zero   g212(.O(z06));
  zero   g213(.O(z08));
  zero   g214(.O(z09));
