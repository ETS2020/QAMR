...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n201_, new_n202_, new_n207_, new_n208_, new_n214_, new_n215_,
  ...
  nand4  g087(.a(new_n242_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  ...
  nand2  g098(.a(x52), .b(x15), .O(new_n267_));
  inv1   g099(.a(x52), .O(new_n268_));
  nand2  g100(.a(new_n268_), .b(x07), .O(new_n269_));
  ...
  xor2a  g104(.a(x84), .b(x81), .O(new_n273_));
  nor2   g105(.a(x75), .b(x67), .O(new_n274_));
  nor2   g106(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  nand4  g107(.a(new_n275_), .b(x79), .c(new_n272_), .d(x77), .O(new_n276_));
  aoi21  g108(.a(new_n276_), .b(new_n271_), .c(x01), .O(z47));
  nand2  g109(.a(x52), .b(x16), .O(new_n278_));
  nand2  g110(.a(new_n268_), .b(x08), .O(new_n279_));
  aoi21  g111(.a(new_n279_), .b(new_n278_), .c(x79), .O(new_n280_));
  nand4  g112(.a(new_n280_), .b(x78), .c(new_n266_), .d(x04), .O(new_n281_));
  nor2   g113(.a(new_n273_), .b(new_n154_), .O(new_n282_));
  nand3  g114(.a(new_n282_), .b(new_n272_), .c(x77), .O(new_n283_));
  inv1   g115(.a(new_n283_), .O(new_n284_));
  nand2  g116(.a(new_n284_), .b(x68), .O(new_n285_));
  aoi21  g117(.a(new_n285_), .b(new_n281_), .c(x01), .O(z48));
  nand2  g118(.a(x52), .b(x17), .O(new_n287_));
  nand2  g119(.a(new_n268_), .b(x09), .O(new_n288_));
  aoi21  g120(.a(new_n288_), .b(new_n287_), .c(x79), .O(new_n289_));
  nand4  g121(.a(new_n289_), .b(x78), .c(new_n266_), .d(x04), .O(new_n290_));
  nand2  g122(.a(new_n284_), .b(x69), .O(new_n291_));
  aoi21  g123(.a(new_n291_), .b(new_n290_), .c(x01), .O(z49));
  nand2  g124(.a(x52), .b(x18), .O(new_n293_));
  nand2  g125(.a(new_n268_), .b(x10), .O(new_n294_));
  aoi21  g126(.a(new_n294_), .b(new_n293_), .c(x79), .O(new_n295_));
  nand4  g127(.a(new_n295_), .b(x78), .c(new_n266_), .d(x04), .O(new_n296_));
  nand2  g128(.a(new_n284_), .b(x70), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n296_), .c(x01), .O(z50));
  nand2  g130(.a(x52), .b(x19), .O(new_n299_));
  nand2  g131(.a(new_n268_), .b(x11), .O(new_n300_));
  aoi21  g132(.a(new_n300_), .b(new_n299_), .c(x79), .O(new_n301_));
  nand4  g133(.a(new_n301_), .b(x78), .c(new_n266_), .d(x04), .O(new_n302_));
  nand2  g134(.a(new_n284_), .b(x71), .O(new_n303_));
  aoi21  g135(.a(new_n303_), .b(new_n302_), .c(x01), .O(z51));
  nand2  g136(.a(x52), .b(x20), .O(new_n305_));
  nand2  g137(.a(new_n268_), .b(x12), .O(new_n306_));
  aoi21  g138(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g139(.a(new_n307_), .b(x78), .c(new_n266_), .d(x04), .O(new_n308_));
  nand2  g140(.a(new_n284_), .b(x72), .O(new_n309_));
  aoi21  g141(.a(new_n309_), .b(new_n308_), .c(x01), .O(z52));
  nand2  g142(.a(x52), .b(x21), .O(new_n311_));
  nand2  g143(.a(new_n268_), .b(x13), .O(new_n312_));
  aoi21  g144(.a(new_n312_), .b(new_n311_), .c(x79), .O(new_n313_));
  nand4  g145(.a(new_n313_), .b(x78), .c(new_n266_), .d(x04), .O(new_n314_));
  nand2  g146(.a(new_n284_), .b(x73), .O(new_n315_));
  aoi21  g147(.a(new_n315_), .b(new_n314_), .c(x01), .O(z53));
  nand2  g148(.a(x52), .b(x22), .O(new_n317_));
  nand2  g149(.a(new_n268_), .b(x14), .O(new_n318_));
  aoi21  g150(.a(new_n318_), .b(new_n317_), .c(x79), .O(new_n319_));
  nand4  g151(.a(new_n319_), .b(x78), .c(new_n266_), .d(x04), .O(new_n320_));
  nor2   g152(.a(new_n320_), .b(x01), .O(z54));
  inv1   g153(.a(x02), .O(new_n324_));
  nand4  g154(.a(x03), .b(new_n324_), .c(new_n153_), .d(x00), .O(new_n325_));
  inv1   g155(.a(new_n325_), .O(z57));
  nor2   g156(.a(new_n272_), .b(x04), .O(new_n334_));
  nor2   g157(.a(new_n217_), .b(x78), .O(new_n335_));
  oai21  g158(.a(new_n335_), .b(new_n334_), .c(x77), .O(new_n336_));
  nand3  g159(.a(x81), .b(x78), .c(new_n266_), .O(new_n337_));
  nand2  g160(.a(new_n337_), .b(new_n336_), .O(new_n338_));
  nand4  g161(.a(new_n338_), .b(x84), .c(x79), .d(new_n153_), .O(new_n339_));
  inv1   g162(.a(new_n339_), .O(z65));
  zero   g163(.O(z01));
  zero   g164(.O(z02));
  zero   g165(.O(z09));
  zero   g166(.O(z12));
