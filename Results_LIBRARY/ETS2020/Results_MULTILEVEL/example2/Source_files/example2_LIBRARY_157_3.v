// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:52 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n292_, new_n295_, new_n297_, new_n299_, new_n302_,
  ...
  nand4  g135(.a(new_n286_), .b(x78), .c(x77), .d(x55), .O(new_n292_));
  nor3   g136(.a(new_n292_), .b(x04), .c(x01), .O(z37));
  ...
  nand4  g143(.a(new_n286_), .b(x78), .c(x77), .d(x61), .O(new_n302_));
  nor3   g144(.a(new_n302_), .b(x04), .c(x01), .O(z43));
  nand4  g145(.a(new_n286_), .b(x78), .c(x77), .d(x62), .O(new_n304_));
  nor3   g146(.a(new_n304_), .b(x04), .c(x01), .O(z44));
  nand4  g147(.a(new_n286_), .b(x78), .c(x77), .d(x63), .O(new_n306_));
  nor3   g148(.a(new_n306_), .b(x04), .c(x01), .O(z45));
  nand4  g149(.a(new_n286_), .b(x78), .c(x77), .d(x64), .O(new_n308_));
