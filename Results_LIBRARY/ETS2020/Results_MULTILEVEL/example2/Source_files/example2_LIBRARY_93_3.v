...
module FAU ( 
  ...
  nand4  g152(.a(new_n290_), .b(x78), .c(x77), .d(x62), .O(new_n308_));
  nor3   g153(.a(new_n308_), .b(x04), .c(x01), .O(z44));
  nand4  g154(.a(new_n290_), .b(x78), .c(x77), .d(x63), .O(new_n310_));
  nor3   g155(.a(new_n310_), .b(x04), .c(x01), .O(z45));
  nand4  g156(.a(new_n290_), .b(x78), .c(x77), .d(x64), .O(new_n312_));
