...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n214_, new_n216_, new_n218_, new_n220_, new_n222_, new_n225_,
    ...
    new_n311_, new_n312_, new_n319_, new_n320_, new_n321_, new_n322_,
  ...
  nand4  g048(.a(new_n213_), .b(x44), .c(new_n205_), .d(new_n204_), .O(new_n214_));
  nor2   g049(.a(new_n214_), .b(x01), .O(z26));
  nand4  g050(.a(new_n213_), .b(x45), .c(new_n205_), .d(new_n204_), .O(new_n216_));
  nor2   g051(.a(new_n216_), .b(x01), .O(z27));
  nand4  g052(.a(new_n213_), .b(x46), .c(new_n205_), .d(new_n204_), .O(new_n218_));
  nor2   g053(.a(new_n218_), .b(x01), .O(z28));
  nand4  g054(.a(new_n213_), .b(x47), .c(new_n205_), .d(new_n204_), .O(new_n220_));
  nor2   g055(.a(new_n220_), .b(x01), .O(z29));
  nand4  g056(.a(new_n213_), .b(x48), .c(new_n205_), .d(new_n204_), .O(new_n222_));
  nor2   g057(.a(new_n222_), .b(x01), .O(z30));
  nand4  g058(.a(new_n213_), .b(x50), .c(new_n205_), .d(new_n204_), .O(new_n225_));
  ...
  oai21  g063(.a(new_n230_), .b(new_n228_), .c(new_n209_), .O(new_n231_));
  nand2  g064(.a(x83), .b(x42), .O(new_n232_));
  nand2  g065(.a(new_n232_), .b(x81), .O(new_n233_));
  nand3  g066(.a(x83), .b(new_n208_), .c(x42), .O(new_n234_));
  nand2  g067(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g068(.a(new_n235_), .b(new_n206_), .O(new_n236_));
  ...
  nand4  g072(.a(new_n237_), .b(x78), .c(x77), .d(x53), .O(new_n240_));
  nor3   g073(.a(new_n240_), .b(x04), .c(x01), .O(z35));
  nand4  g074(.a(new_n237_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g075(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g076(.a(new_n237_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g077(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g078(.a(new_n237_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g079(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g080(.a(new_n237_), .b(x78), .c(x77), .d(x57), .O(new_n248_));
  nor3   g081(.a(new_n248_), .b(x04), .c(x01), .O(z39));
  nand4  g082(.a(new_n237_), .b(x78), .c(x77), .d(x58), .O(new_n250_));
  nor3   g083(.a(new_n250_), .b(x04), .c(x01), .O(z40));
  nand4  g084(.a(new_n237_), .b(x78), .c(x77), .d(x59), .O(new_n252_));
  nor3   g085(.a(new_n252_), .b(x04), .c(x01), .O(z41));
  nand4  g086(.a(new_n237_), .b(x78), .c(x77), .d(x60), .O(new_n254_));
  nor3   g087(.a(new_n254_), .b(x04), .c(x01), .O(z42));
  nand4  g088(.a(new_n237_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g089(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g090(.a(new_n237_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g091(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g092(.a(new_n237_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g094(.a(new_n237_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  xor2a  g103(.a(x84), .b(x81), .O(new_n272_));
  nor2   g104(.a(new_n272_), .b(new_n154_), .O(new_n273_));
  nand3  g105(.a(new_n273_), .b(new_n271_), .c(x77), .O(new_n274_));
  inv1   g106(.a(new_n274_), .O(new_n275_));
  nand2  g107(.a(new_n275_), .b(x68), .O(new_n276_));
  aoi21  g108(.a(new_n276_), .b(new_n270_), .c(x01), .O(z48));
  nand2  g109(.a(x52), .b(x17), .O(new_n278_));
  nand2  g110(.a(new_n267_), .b(x09), .O(new_n279_));
  aoi21  g111(.a(new_n279_), .b(new_n278_), .c(x79), .O(new_n280_));
  nand4  g112(.a(new_n280_), .b(x78), .c(new_n265_), .d(x04), .O(new_n281_));
  nand2  g113(.a(new_n275_), .b(x69), .O(new_n282_));
  aoi21  g114(.a(new_n282_), .b(new_n281_), .c(x01), .O(z49));
  nand2  g115(.a(x52), .b(x18), .O(new_n284_));
  nand2  g116(.a(new_n267_), .b(x10), .O(new_n285_));
  aoi21  g117(.a(new_n285_), .b(new_n284_), .c(x79), .O(new_n286_));
  nand4  g118(.a(new_n286_), .b(x78), .c(new_n265_), .d(x04), .O(new_n287_));
  nand2  g119(.a(new_n275_), .b(x70), .O(new_n288_));
  aoi21  g120(.a(new_n288_), .b(new_n287_), .c(x01), .O(z50));
  nand2  g121(.a(x52), .b(x19), .O(new_n290_));
  nand2  g122(.a(new_n267_), .b(x11), .O(new_n291_));
  aoi21  g123(.a(new_n291_), .b(new_n290_), .c(x79), .O(new_n292_));
  nand4  g124(.a(new_n292_), .b(x78), .c(new_n265_), .d(x04), .O(new_n293_));
  nand2  g125(.a(new_n275_), .b(x71), .O(new_n294_));
  aoi21  g126(.a(new_n294_), .b(new_n293_), .c(x01), .O(z51));
  nand2  g127(.a(x52), .b(x20), .O(new_n296_));
  nand2  g128(.a(new_n267_), .b(x12), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n296_), .c(x79), .O(new_n298_));
  nand4  g130(.a(new_n298_), .b(x78), .c(new_n265_), .d(x04), .O(new_n299_));
  nand2  g131(.a(new_n275_), .b(x72), .O(new_n300_));
  aoi21  g132(.a(new_n300_), .b(new_n299_), .c(x01), .O(z52));
  nand2  g133(.a(x52), .b(x21), .O(new_n302_));
  nand2  g134(.a(new_n267_), .b(x13), .O(new_n303_));
  aoi21  g135(.a(new_n303_), .b(new_n302_), .c(x79), .O(new_n304_));
  nand4  g136(.a(new_n304_), .b(x78), .c(new_n265_), .d(x04), .O(new_n305_));
  nand2  g137(.a(new_n275_), .b(x73), .O(new_n306_));
  aoi21  g138(.a(new_n306_), .b(new_n305_), .c(x01), .O(z53));
  inv1   g139(.a(x02), .O(new_n311_));
  nand4  g140(.a(x03), .b(new_n311_), .c(new_n153_), .d(x00), .O(new_n312_));
  inv1   g141(.a(new_n312_), .O(z57));
  xnor2a g142(.a(x78), .b(x77), .O(new_n319_));
  nand3  g143(.a(x78), .b(x77), .c(new_n204_), .O(new_n320_));
  oai21  g144(.a(new_n319_), .b(new_n272_), .c(new_n320_), .O(new_n321_));
  nand4  g145(.a(new_n321_), .b(x82), .c(x79), .d(new_n153_), .O(new_n322_));
  inv1   g146(.a(new_n322_), .O(z63));
  nor2   g147(.a(new_n271_), .b(x04), .O(new_n325_));
  nor2   g148(.a(new_n208_), .b(x78), .O(new_n326_));
  oai21  g149(.a(new_n326_), .b(new_n325_), .c(x77), .O(new_n327_));
  nand3  g150(.a(x81), .b(x78), .c(new_n265_), .O(new_n328_));
  nand2  g151(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand4  g152(.a(new_n329_), .b(x84), .c(x79), .d(new_n153_), .O(new_n330_));
