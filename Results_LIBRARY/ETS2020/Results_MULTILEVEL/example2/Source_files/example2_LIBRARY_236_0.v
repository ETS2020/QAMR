...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
  ...
  oai21  g074(.a(new_n237_), .b(new_n235_), .c(new_n216_), .O(new_n238_));
  nand2  g075(.a(x83), .b(x42), .O(new_n239_));
  nand2  g076(.a(new_n239_), .b(x81), .O(new_n240_));
  nand3  g077(.a(x83), .b(new_n215_), .c(x42), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g079(.a(new_n242_), .b(new_n213_), .O(new_n243_));
  ...
  nor2   g156(.a(new_n215_), .b(x78), .O(new_n331_));
