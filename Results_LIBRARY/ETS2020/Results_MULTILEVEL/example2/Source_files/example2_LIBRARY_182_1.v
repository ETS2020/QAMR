...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n288_, new_n290_, new_n293_, new_n296_,
  ...
  nand2  g156(.a(new_n325_), .b(new_n238_), .O(new_n326_));
  nor4   g157(.a(new_n326_), .b(new_n322_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g158(.a(new_n231_), .b(x76), .O(new_n328_));
  ...
  nand4  g167(.a(x03), .b(new_n336_), .c(new_n153_), .d(x00), .O(new_n337_));
  inv1   g168(.a(new_n337_), .O(z57));
  nand4  g169(.a(x80), .b(new_n220_), .c(x43), .d(new_n235_), .O(new_n339_));
  oai22  g170(.a(new_n339_), .b(new_n223_), .c(new_n235_), .d(x40), .O(new_n340_));
  nand4  g171(.a(new_n340_), .b(x79), .c(x78), .d(x04), .O(new_n341_));
  nor2   g172(.a(x79), .b(x78), .O(new_n342_));
  nand3  g173(.a(new_n342_), .b(new_n235_), .c(x40), .O(new_n343_));
  nand2  g174(.a(new_n343_), .b(new_n341_), .O(new_n344_));
  nand2  g175(.a(new_n344_), .b(x77), .O(new_n345_));
  oai21  g176(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n346_));
  aoi21  g177(.a(new_n346_), .b(new_n345_), .c(x01), .O(z58));
  nor2   g178(.a(new_n160_), .b(new_n229_), .O(new_n348_));
  oai21  g179(.a(new_n348_), .b(new_n342_), .c(x40), .O(new_n349_));
  oai21  g180(.a(new_n223_), .b(new_n221_), .c(new_n235_), .O(new_n350_));
  nand2  g181(.a(new_n350_), .b(x79), .O(new_n351_));
  nand3  g182(.a(new_n351_), .b(x78), .c(x04), .O(new_n352_));
  nand2  g183(.a(new_n352_), .b(new_n349_), .O(new_n353_));
  nand2  g184(.a(new_n353_), .b(x77), .O(new_n354_));
  nand2  g185(.a(new_n154_), .b(new_n229_), .O(new_n355_));
  aoi21  g186(.a(new_n355_), .b(new_n354_), .c(x01), .O(z59));
  nand2  g187(.a(new_n331_), .b(x79), .O(new_n357_));
  nand3  g188(.a(new_n357_), .b(new_n355_), .c(new_n226_), .O(new_n358_));
  and2   g189(.a(new_n358_), .b(new_n153_), .O(z60));
  nand2  g190(.a(new_n167_), .b(new_n329_), .O(new_n360_));
  nand2  g191(.a(new_n360_), .b(new_n218_), .O(new_n361_));
  oai21  g192(.a(new_n231_), .b(x04), .c(new_n361_), .O(new_n362_));
  nand4  g193(.a(new_n362_), .b(x80), .c(x79), .d(new_n153_), .O(new_n363_));
  inv1   g194(.a(new_n363_), .O(z61));
  nand2  g195(.a(new_n154_), .b(x04), .O(new_n365_));
  nand3  g196(.a(x84), .b(x81), .c(x79), .O(new_n366_));
  aoi21  g197(.a(new_n366_), .b(new_n365_), .c(x77), .O(new_n367_));
  nand2  g198(.a(new_n351_), .b(x04), .O(new_n368_));
  nand3  g199(.a(x81), .b(x79), .c(new_n229_), .O(new_n369_));
  aoi21  g200(.a(new_n369_), .b(new_n368_), .c(new_n159_), .O(new_n370_));
  oai21  g201(.a(new_n370_), .b(new_n367_), .c(x78), .O(new_n371_));
  or2    g202(.a(new_n366_), .b(new_n167_), .O(new_n372_));
  aoi21  g203(.a(new_n372_), .b(new_n371_), .c(x01), .O(z62));
  nand4  g204(.a(new_n362_), .b(x82), .c(x79), .d(new_n153_), .O(new_n374_));
  inv1   g205(.a(new_n374_), .O(z63));
  nand3  g206(.a(new_n362_), .b(x83), .c(x79), .O(new_n376_));
  nand4  g207(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n377_));
  aoi21  g208(.a(new_n377_), .b(new_n376_), .c(x01), .O(z64));
  nor2   g209(.a(new_n160_), .b(x04), .O(new_n379_));
  nor2   g210(.a(new_n238_), .b(x78), .O(new_n380_));
  oai21  g211(.a(new_n380_), .b(new_n379_), .c(x77), .O(new_n381_));
  nand3  g212(.a(x81), .b(x78), .c(new_n159_), .O(new_n382_));
  nand2  g213(.a(new_n382_), .b(new_n381_), .O(new_n383_));
  nand4  g214(.a(new_n383_), .b(x84), .c(x79), .d(new_n153_), .O(new_n384_));
  inv1   g215(.a(new_n384_), .O(z65));
  zero   g216(.O(z05));
  zero   g217(.O(z08));
  zero   g218(.O(z09));
  zero   g219(.O(z16));
