...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n214_, new_n216_, new_n219_, new_n221_, new_n224_, new_n227_,
    new_n228_, new_n229_, new_n230_, new_n231_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n239_, new_n241_,
    new_n243_, new_n245_, new_n249_, new_n252_, new_n254_, new_n257_,
  ...
  nand4  g051(.a(new_n213_), .b(x45), .c(new_n205_), .d(new_n204_), .O(new_n216_));
  ...
  nand4  g057(.a(new_n213_), .b(x50), .c(new_n205_), .d(new_n204_), .O(new_n224_));
  nor2   g058(.a(new_n224_), .b(x01), .O(z32));
  ...
  nand4  g085(.a(new_n236_), .b(x78), .c(x77), .d(x64), .O(new_n257_));
  ...
  nor2   g138(.a(new_n208_), .b(x78), .O(new_n320_));
