...
module FAU ( 
  ...
  wire new_n156_, new_n157_, new_n158_, new_n160_, new_n161_, new_n164_,
    ...
    new_n194_, new_n196_, new_n197_, new_n202_, new_n203_, new_n207_,
    new_n208_, new_n209_, new_n210_, new_n211_, new_n212_, new_n213_,
    new_n214_, new_n215_, new_n216_, new_n218_, new_n220_, new_n222_,
    new_n224_, new_n230_, new_n231_, new_n232_, new_n233_, new_n234_,
    new_n235_, new_n236_, new_n237_, new_n238_, new_n239_, new_n240_,
    new_n242_, new_n244_, new_n246_, new_n249_, new_n251_, new_n253_,
  ...
  nand4  g052(.a(new_n215_), .b(x44), .c(new_n207_), .d(new_n202_), .O(new_n216_));
  nor2   g053(.a(new_n216_), .b(x01), .O(z26));
  nand4  g054(.a(new_n215_), .b(x45), .c(new_n207_), .d(new_n202_), .O(new_n218_));
  nor2   g055(.a(new_n218_), .b(x01), .O(z27));
  nand4  g056(.a(new_n215_), .b(x46), .c(new_n207_), .d(new_n202_), .O(new_n220_));
  nor2   g057(.a(new_n220_), .b(x01), .O(z28));
  nand4  g058(.a(new_n215_), .b(x47), .c(new_n207_), .d(new_n202_), .O(new_n222_));
  nor2   g059(.a(new_n222_), .b(x01), .O(z29));
  nand4  g060(.a(new_n215_), .b(x48), .c(new_n207_), .d(new_n202_), .O(new_n224_));
  nor2   g061(.a(new_n224_), .b(x01), .O(z30));
  aoi21  g062(.a(x83), .b(x42), .c(x81), .O(new_n230_));
  nand3  g063(.a(x83), .b(x81), .c(x42), .O(new_n231_));
  inv1   g064(.a(new_n231_), .O(new_n232_));
  oai21  g065(.a(new_n232_), .b(new_n230_), .c(new_n211_), .O(new_n233_));
  nand2  g066(.a(x83), .b(x42), .O(new_n234_));
  nand2  g067(.a(new_n234_), .b(x81), .O(new_n235_));
  nand3  g068(.a(x83), .b(new_n210_), .c(x42), .O(new_n236_));
  nand2  g069(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g070(.a(new_n237_), .b(new_n208_), .O(new_n238_));
  aoi21  g071(.a(new_n238_), .b(new_n233_), .c(new_n157_), .O(new_n239_));
  nand4  g072(.a(new_n239_), .b(x78), .c(x77), .d(x53), .O(new_n240_));
  nor3   g073(.a(new_n240_), .b(x04), .c(x01), .O(z35));
  nand4  g074(.a(new_n239_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g075(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g076(.a(new_n239_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g077(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g078(.a(new_n239_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g079(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g080(.a(new_n239_), .b(x78), .c(x77), .d(x58), .O(new_n249_));
  nor3   g081(.a(new_n249_), .b(x04), .c(x01), .O(z40));
  nand4  g082(.a(new_n239_), .b(x78), .c(x77), .d(x59), .O(new_n251_));
  nor3   g083(.a(new_n251_), .b(x04), .c(x01), .O(z41));
  nand4  g084(.a(new_n239_), .b(x78), .c(x77), .d(x60), .O(new_n253_));
  nor3   g085(.a(new_n253_), .b(x04), .c(x01), .O(z42));
  nand4  g086(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n255_));
  nor3   g087(.a(new_n255_), .b(x04), .c(x01), .O(z43));
  nand4  g088(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n257_));
  ...
  nand4  g142(.a(x03), .b(new_n313_), .c(new_n156_), .d(x00), .O(new_n314_));
  ...
  nand4  g149(.a(new_n327_), .b(x84), .c(x79), .d(new_n156_), .O(new_n328_));
