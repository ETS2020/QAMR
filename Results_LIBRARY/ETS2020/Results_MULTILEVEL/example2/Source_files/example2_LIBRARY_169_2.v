...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n289_, new_n291_, new_n293_, new_n297_, new_n299_,
  ...
  nand4  g104(.a(new_n252_), .b(x46), .c(new_n244_), .d(new_n236_), .O(new_n258_));
  ...
  nand4  g150(.a(new_n288_), .b(x78), .c(x77), .d(x64), .O(new_n309_));
  ...
  nor2   g158(.a(new_n316_), .b(new_n225_), .O(new_n317_));
  ...
  nand4  g165(.a(new_n226_), .b(x79), .c(new_n160_), .d(x77), .O(new_n324_));
  ...
  nand2  g208(.a(new_n366_), .b(new_n247_), .O(new_n367_));
  nor4   g209(.a(new_n367_), .b(new_n363_), .c(new_n230_), .d(x82), .O(z55));
  nand2  g210(.a(new_n240_), .b(x76), .O(new_n369_));
  ...
  nand4  g221(.a(x80), .b(new_n228_), .c(x43), .d(new_n244_), .O(new_n380_));
  oai22  g222(.a(new_n380_), .b(new_n231_), .c(new_n244_), .d(x40), .O(new_n381_));
  ...
  oai21  g228(.a(new_n165_), .b(new_n236_), .c(new_n154_), .O(new_n387_));
  aoi21  g229(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  nor2   g230(.a(new_n160_), .b(new_n236_), .O(new_n389_));
  oai21  g231(.a(new_n389_), .b(new_n383_), .c(x40), .O(new_n390_));
  oai21  g232(.a(new_n231_), .b(new_n229_), .c(new_n244_), .O(new_n391_));
  ...
  nand2  g237(.a(new_n154_), .b(new_n236_), .O(new_n396_));
  aoi21  g238(.a(new_n396_), .b(new_n395_), .c(x01), .O(z59));
  nand2  g239(.a(new_n372_), .b(x79), .O(new_n398_));
  nand3  g240(.a(new_n398_), .b(new_n396_), .c(new_n234_), .O(new_n399_));
  and2   g241(.a(new_n399_), .b(new_n153_), .O(z60));
  nand2  g242(.a(new_n167_), .b(new_n370_), .O(new_n401_));
  nand2  g243(.a(new_n401_), .b(new_n226_), .O(new_n402_));
  oai21  g244(.a(new_n240_), .b(x04), .c(new_n402_), .O(new_n403_));
  ...
  nand3  g251(.a(x81), .b(x79), .c(new_n236_), .O(new_n410_));
  ...
  nor2   g262(.a(new_n247_), .b(x78), .O(new_n421_));
