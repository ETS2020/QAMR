// Benchmark "FAU" written by ABC on Fri Jul 24 22:42:31 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n196_, new_n197_, new_n200_, new_n201_, new_n204_, new_n205_,
    ...
    new_n283_, new_n287_, new_n290_, new_n292_, new_n294_, new_n296_,
  ...
  nand4  g093(.a(new_n244_), .b(x47), .c(new_n236_), .d(new_n228_), .O(new_n252_));
  ...
  nor2   g116(.a(new_n222_), .b(new_n236_), .O(new_n276_));
  ...
  nand4  g125(.a(new_n282_), .b(x78), .c(x77), .d(x56), .O(new_n287_));
  nor3   g126(.a(new_n287_), .b(x04), .c(x01), .O(z38));
  nand4  g127(.a(new_n282_), .b(x78), .c(x77), .d(x58), .O(new_n290_));
  nor3   g128(.a(new_n290_), .b(x04), .c(x01), .O(z40));
  nand4  g129(.a(new_n282_), .b(x78), .c(x77), .d(x59), .O(new_n292_));
  nor3   g130(.a(new_n292_), .b(x04), .c(x01), .O(z41));
  nand4  g131(.a(new_n282_), .b(x78), .c(x77), .d(x60), .O(new_n294_));
  nor3   g132(.a(new_n294_), .b(x04), .c(x01), .O(z42));
  nand4  g133(.a(new_n282_), .b(x78), .c(x77), .d(x61), .O(new_n296_));
  nor3   g134(.a(new_n296_), .b(x04), .c(x01), .O(z43));
  nand4  g135(.a(new_n282_), .b(x78), .c(x77), .d(x64), .O(new_n300_));
  ...
  nor2   g246(.a(new_n160_), .b(x04), .O(new_n411_));
  nor2   g247(.a(new_n239_), .b(x78), .O(new_n412_));
  oai21  g248(.a(new_n412_), .b(new_n411_), .c(x77), .O(new_n413_));
  nand3  g249(.a(x81), .b(x78), .c(new_n159_), .O(new_n414_));
  nand2  g250(.a(new_n414_), .b(new_n413_), .O(new_n415_));
  nand4  g251(.a(new_n415_), .b(x84), .c(x79), .d(new_n153_), .O(new_n416_));
  inv1   g252(.a(new_n416_), .O(z65));
  zero   g253(.O(z03));
  zero   g254(.O(z04));
  zero   g255(.O(z05));
  zero   g256(.O(z06));
