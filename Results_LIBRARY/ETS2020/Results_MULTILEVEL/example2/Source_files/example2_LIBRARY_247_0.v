...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n240_, new_n241_, new_n243_, new_n245_, new_n247_, new_n250_,
  ...
  nand4  g062(.a(new_n216_), .b(x49), .c(new_n208_), .d(new_n203_), .O(new_n226_));
  nor2   g063(.a(new_n226_), .b(x01), .O(z31));
  nand4  g064(.a(new_n216_), .b(x50), .c(new_n208_), .d(new_n203_), .O(new_n228_));
  nor2   g065(.a(new_n228_), .b(x01), .O(z32));
  aoi21  g066(.a(x83), .b(x42), .c(x81), .O(new_n231_));
  nand3  g067(.a(x83), .b(x81), .c(x42), .O(new_n232_));
  inv1   g068(.a(new_n232_), .O(new_n233_));
  oai21  g069(.a(new_n233_), .b(new_n231_), .c(new_n212_), .O(new_n234_));
  nand2  g070(.a(x83), .b(x42), .O(new_n235_));
  nand2  g071(.a(new_n235_), .b(x81), .O(new_n236_));
  nand3  g072(.a(x83), .b(new_n211_), .c(x42), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(new_n209_), .O(new_n239_));
  aoi21  g075(.a(new_n239_), .b(new_n234_), .c(new_n156_), .O(new_n240_));
  nand4  g076(.a(new_n240_), .b(x78), .c(x77), .d(x52), .O(new_n241_));
  nor3   g077(.a(new_n241_), .b(x04), .c(x01), .O(z34));
  nand4  g078(.a(new_n240_), .b(x78), .c(x77), .d(x53), .O(new_n243_));
  nor3   g079(.a(new_n243_), .b(x04), .c(x01), .O(z35));
  nand4  g080(.a(new_n240_), .b(x78), .c(x77), .d(x54), .O(new_n245_));
  nor3   g081(.a(new_n245_), .b(x04), .c(x01), .O(z36));
  nand4  g082(.a(new_n240_), .b(x78), .c(x77), .d(x55), .O(new_n247_));
  nor3   g083(.a(new_n247_), .b(x04), .c(x01), .O(z37));
  nand4  g084(.a(new_n240_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g085(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g086(.a(new_n240_), .b(x78), .c(x77), .d(x59), .O(new_n253_));
  nor3   g087(.a(new_n253_), .b(x04), .c(x01), .O(z41));
  nand4  g088(.a(new_n240_), .b(x78), .c(x77), .d(x60), .O(new_n255_));
  nor3   g089(.a(new_n255_), .b(x04), .c(x01), .O(z42));
  nand4  g090(.a(new_n240_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g091(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g092(.a(new_n240_), .b(x78), .c(x77), .d(x62), .O(new_n259_));
  nor3   g093(.a(new_n259_), .b(x04), .c(x01), .O(z44));
  nand4  g094(.a(new_n240_), .b(x78), .c(x77), .d(x63), .O(new_n261_));
  nor3   g095(.a(new_n261_), .b(x04), .c(x01), .O(z45));
  nand4  g096(.a(new_n240_), .b(x78), .c(x77), .d(x64), .O(new_n263_));
  ...
  nand2  g135(.a(new_n268_), .b(x14), .O(new_n304_));
  aoi21  g136(.a(new_n304_), .b(new_n303_), .c(x79), .O(new_n305_));
  nand4  g137(.a(new_n305_), .b(x78), .c(new_n266_), .d(x04), .O(new_n306_));
  nor2   g138(.a(new_n306_), .b(x01), .O(z54));
  inv1   g139(.a(x02), .O(new_n310_));
  nand4  g140(.a(x03), .b(new_n310_), .c(new_n155_), .d(x00), .O(new_n311_));
  inv1   g141(.a(new_n311_), .O(z57));
  nor2   g142(.a(new_n272_), .b(x04), .O(new_n320_));
  nor2   g143(.a(new_n211_), .b(x78), .O(new_n321_));
  oai21  g144(.a(new_n321_), .b(new_n320_), .c(x77), .O(new_n322_));
  nand3  g145(.a(x81), .b(x78), .c(new_n266_), .O(new_n323_));
  nand2  g146(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  nand4  g147(.a(new_n324_), .b(x84), .c(x79), .d(new_n155_), .O(new_n325_));
  inv1   g148(.a(new_n325_), .O(z65));
  zero   g149(.O(z00));
  zero   g150(.O(z01));
  zero   g151(.O(z02));
  zero   g152(.O(z09));
