...
module FAU ( 
  ...
  nand2  g154(.a(new_n306_), .b(x13), .O(new_n320_));
  aoi21  g155(.a(new_n320_), .b(new_n319_), .c(x79), .O(new_n321_));
  nand4  g156(.a(new_n321_), .b(x78), .c(new_n159_), .d(x04), .O(new_n322_));
  nor2   g157(.a(new_n217_), .b(new_n154_), .O(new_n323_));
  nand4  g158(.a(new_n323_), .b(new_n160_), .c(x77), .d(x73), .O(new_n324_));
  aoi21  g159(.a(new_n324_), .b(new_n322_), .c(x01), .O(z53));
  nand2  g160(.a(x52), .b(x22), .O(new_n326_));
  nand2  g161(.a(new_n306_), .b(x14), .O(new_n327_));
  aoi21  g162(.a(new_n327_), .b(new_n326_), .c(x79), .O(new_n328_));
  nand4  g163(.a(new_n328_), .b(x78), .c(new_n159_), .d(x04), .O(new_n329_));
  nor2   g164(.a(new_n329_), .b(x01), .O(z54));
  inv1   g165(.a(x84), .O(new_n331_));
  nor2   g166(.a(x04), .b(x01), .O(new_n332_));
  nand4  g167(.a(new_n332_), .b(x79), .c(x78), .d(x77), .O(new_n333_));
  nor2   g168(.a(new_n333_), .b(x80), .O(new_n334_));
  nand2  g169(.a(new_n334_), .b(new_n239_), .O(new_n335_));
  nor4   g170(.a(new_n335_), .b(new_n331_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g171(.a(new_n232_), .b(x76), .O(new_n337_));
  inv1   g172(.a(new_n165_), .O(new_n338_));
  xnor2a g173(.a(x84), .b(x81), .O(new_n339_));
  aoi21  g174(.a(new_n167_), .b(new_n338_), .c(new_n339_), .O(new_n340_));
  nand2  g175(.a(new_n340_), .b(new_n153_), .O(new_n341_));
  nand2  g176(.a(new_n341_), .b(new_n337_), .O(new_n342_));
  nand2  g177(.a(new_n342_), .b(x79), .O(new_n343_));
  nand4  g178(.a(new_n343_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g179(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n346_));
  oai22  g180(.a(new_n346_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n347_));
  nand4  g181(.a(new_n347_), .b(x79), .c(x78), .d(x04), .O(new_n348_));
  nor2   g182(.a(x79), .b(x78), .O(new_n349_));
  nand3  g183(.a(new_n349_), .b(new_n236_), .c(x40), .O(new_n350_));
  nand2  g184(.a(new_n350_), .b(new_n348_), .O(new_n351_));
  nand2  g185(.a(new_n351_), .b(x77), .O(new_n352_));
  oai21  g186(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n353_));
  aoi21  g187(.a(new_n353_), .b(new_n352_), .c(x01), .O(z58));
  nor2   g188(.a(new_n160_), .b(new_n228_), .O(new_n355_));
  oai21  g189(.a(new_n355_), .b(new_n349_), .c(x40), .O(new_n356_));
  oai21  g190(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n357_));
  nand2  g191(.a(new_n357_), .b(x79), .O(new_n358_));
  nand3  g192(.a(new_n358_), .b(x78), .c(x04), .O(new_n359_));
  nand2  g193(.a(new_n359_), .b(new_n356_), .O(new_n360_));
  nand2  g194(.a(new_n360_), .b(x77), .O(new_n361_));
  nand2  g195(.a(new_n154_), .b(new_n228_), .O(new_n362_));
  aoi21  g196(.a(new_n362_), .b(new_n361_), .c(x01), .O(z59));
  nand2  g197(.a(new_n340_), .b(x79), .O(new_n364_));
  nand3  g198(.a(new_n364_), .b(new_n362_), .c(new_n226_), .O(new_n365_));
  and2   g199(.a(new_n365_), .b(new_n153_), .O(z60));
  nand2  g200(.a(new_n167_), .b(new_n338_), .O(new_n367_));
  nand2  g201(.a(new_n367_), .b(new_n218_), .O(new_n368_));
  oai21  g202(.a(new_n232_), .b(x04), .c(new_n368_), .O(new_n369_));
  nand4  g203(.a(new_n369_), .b(x80), .c(x79), .d(new_n153_), .O(new_n370_));
  inv1   g204(.a(new_n370_), .O(z61));
  nand2  g205(.a(new_n154_), .b(x04), .O(new_n372_));
  nand3  g206(.a(x84), .b(x81), .c(x79), .O(new_n373_));
  aoi21  g207(.a(new_n373_), .b(new_n372_), .c(x77), .O(new_n374_));
  nand2  g208(.a(new_n358_), .b(x04), .O(new_n375_));
  nand3  g209(.a(x81), .b(x79), .c(new_n228_), .O(new_n376_));
  aoi21  g210(.a(new_n376_), .b(new_n375_), .c(new_n159_), .O(new_n377_));
  oai21  g211(.a(new_n377_), .b(new_n374_), .c(x78), .O(new_n378_));
  or2    g212(.a(new_n373_), .b(new_n167_), .O(new_n379_));
  aoi21  g213(.a(new_n379_), .b(new_n378_), .c(x01), .O(z62));
  nand4  g214(.a(new_n369_), .b(x82), .c(x79), .d(new_n153_), .O(new_n381_));
  inv1   g215(.a(new_n381_), .O(z63));
  nand3  g216(.a(new_n369_), .b(x83), .c(x79), .O(new_n383_));
  nand4  g217(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n384_));
  aoi21  g218(.a(new_n384_), .b(new_n383_), .c(x01), .O(z64));
  ...
  nand3  g222(.a(x81), .b(x78), .c(new_n159_), .O(new_n389_));
  nand2  g223(.a(new_n389_), .b(new_n388_), .O(new_n390_));
  nand4  g224(.a(new_n390_), .b(x84), .c(x79), .d(new_n153_), .O(new_n391_));
  inv1   g225(.a(new_n391_), .O(z65));
  zero   g226(.O(z05));
  zero   g227(.O(z06));
  zero   g228(.O(z09));
  zero   g229(.O(z14));
