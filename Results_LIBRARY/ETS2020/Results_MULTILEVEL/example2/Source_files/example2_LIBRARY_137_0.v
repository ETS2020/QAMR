...
module FAU ( 
  ...
  nand4  g143(.a(x03), .b(new_n312_), .c(new_n155_), .d(x00), .O(new_n313_));
  inv1   g144(.a(new_n313_), .O(z57));
  nor2   g145(.a(new_n274_), .b(x04), .O(new_n322_));
  nor2   g146(.a(new_n212_), .b(x78), .O(new_n323_));
  ...
  nand4  g150(.a(new_n326_), .b(x84), .c(x79), .d(new_n155_), .O(new_n327_));
