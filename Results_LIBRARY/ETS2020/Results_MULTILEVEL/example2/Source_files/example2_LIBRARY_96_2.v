...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n290_, new_n292_, new_n294_, new_n299_, new_n300_,
  ...
  nand4  g087(.a(new_n240_), .b(x46), .c(new_n232_), .d(new_n224_), .O(new_n247_));
  nor2   g088(.a(new_n247_), .b(x01), .O(z28));
  nand4  g089(.a(new_n240_), .b(x47), .c(new_n232_), .d(new_n224_), .O(new_n249_));
  ...
  nor2   g139(.a(new_n304_), .b(new_n213_), .O(new_n305_));
  ...
  nand4  g146(.a(new_n214_), .b(x79), .c(new_n160_), .d(x77), .O(new_n312_));
  ...
  nor4   g190(.a(new_n355_), .b(new_n351_), .c(new_n218_), .d(x82), .O(z55));
  ...
  nand4  g202(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n368_));
  oai22  g203(.a(new_n368_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n369_));
  nand4  g204(.a(new_n369_), .b(x79), .c(x78), .d(x04), .O(new_n370_));
  nor2   g205(.a(x79), .b(x78), .O(new_n371_));
  nand3  g206(.a(new_n371_), .b(new_n232_), .c(x40), .O(new_n372_));
  nand2  g207(.a(new_n372_), .b(new_n370_), .O(new_n373_));
  nand2  g208(.a(new_n373_), .b(x77), .O(new_n374_));
  oai21  g209(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n375_));
  aoi21  g210(.a(new_n375_), .b(new_n374_), .c(x01), .O(z58));
  nor2   g211(.a(new_n160_), .b(new_n224_), .O(new_n377_));
  oai21  g212(.a(new_n377_), .b(new_n371_), .c(x40), .O(new_n378_));
  oai21  g213(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n379_));
  ...
  nand2  g218(.a(new_n154_), .b(new_n224_), .O(new_n384_));
  aoi21  g219(.a(new_n384_), .b(new_n383_), .c(x01), .O(z59));
  nand2  g220(.a(new_n360_), .b(x79), .O(new_n386_));
  nand3  g221(.a(new_n386_), .b(new_n384_), .c(new_n222_), .O(new_n387_));
  and2   g222(.a(new_n387_), .b(new_n153_), .O(z60));
  nand2  g223(.a(new_n167_), .b(new_n358_), .O(new_n389_));
  nand2  g224(.a(new_n389_), .b(new_n214_), .O(new_n390_));
  oai21  g225(.a(new_n228_), .b(x04), .c(new_n390_), .O(new_n391_));
  ...
  nand3  g232(.a(x81), .b(x79), .c(new_n224_), .O(new_n398_));
