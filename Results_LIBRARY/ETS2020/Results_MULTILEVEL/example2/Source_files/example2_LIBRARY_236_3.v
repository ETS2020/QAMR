...
module FAU ( 
  ...
  nand4  g104(.a(new_n250_), .b(x49), .c(new_n242_), .d(new_n234_), .O(new_n261_));
  nor2   g105(.a(new_n261_), .b(x01), .O(z31));
  nand4  g106(.a(new_n250_), .b(x50), .c(new_n242_), .d(new_n234_), .O(new_n263_));
  nor2   g107(.a(new_n263_), .b(x01), .O(z32));
