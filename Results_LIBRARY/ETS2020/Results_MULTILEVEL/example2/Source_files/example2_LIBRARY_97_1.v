...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n167_, new_n169_, new_n173_, new_n174_, new_n179_, new_n180_,
    ...
    new_n237_, new_n239_, new_n241_, new_n243_, new_n246_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n274_, new_n276_, new_n280_,
    new_n282_, new_n284_, new_n287_, new_n289_, new_n293_, new_n294_,
  ...
  xnor2a g069(.a(x84), .b(x82), .O(new_n229_));
  nand2  g070(.a(new_n229_), .b(x81), .O(new_n230_));
  inv1   g071(.a(x81), .O(new_n231_));
  xor2a  g072(.a(x84), .b(x82), .O(new_n232_));
  nand2  g073(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand2  g074(.a(new_n233_), .b(new_n230_), .O(new_n234_));
  nand4  g075(.a(new_n234_), .b(x79), .c(x78), .d(x77), .O(new_n235_));
  inv1   g076(.a(new_n235_), .O(new_n236_));
  nand4  g077(.a(new_n236_), .b(new_n228_), .c(x05), .d(new_n220_), .O(new_n237_));
  nor2   g078(.a(new_n237_), .b(x01), .O(z25));
  nand4  g079(.a(new_n236_), .b(x44), .c(new_n228_), .d(new_n220_), .O(new_n239_));
  nor2   g080(.a(new_n239_), .b(x01), .O(z26));
  nand4  g081(.a(new_n236_), .b(x45), .c(new_n228_), .d(new_n220_), .O(new_n241_));
  nor2   g082(.a(new_n241_), .b(x01), .O(z27));
  nand4  g083(.a(new_n236_), .b(x46), .c(new_n228_), .d(new_n220_), .O(new_n243_));
  nor2   g084(.a(new_n243_), .b(x01), .O(z28));
  nand4  g085(.a(new_n236_), .b(x48), .c(new_n228_), .d(new_n220_), .O(new_n246_));
  nor2   g086(.a(new_n246_), .b(x01), .O(z30));
  nand2  g087(.a(x83), .b(new_n231_), .O(new_n250_));
  nand2  g088(.a(new_n214_), .b(x81), .O(new_n251_));
  nand2  g089(.a(new_n251_), .b(new_n250_), .O(new_n252_));
  nand3  g090(.a(new_n252_), .b(x42), .c(x05), .O(new_n253_));
  nand3  g091(.a(x81), .b(x51), .c(new_n228_), .O(new_n254_));
  nand2  g092(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  nand2  g093(.a(new_n255_), .b(new_n229_), .O(new_n256_));
  xnor2a g094(.a(x83), .b(x81), .O(new_n257_));
  nand3  g095(.a(new_n257_), .b(x42), .c(x05), .O(new_n258_));
  nand3  g096(.a(new_n231_), .b(x51), .c(new_n228_), .O(new_n259_));
  nand2  g097(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g098(.a(new_n260_), .b(new_n232_), .O(new_n261_));
  aoi21  g099(.a(new_n261_), .b(new_n256_), .c(new_n156_), .O(new_n262_));
  nand4  g100(.a(new_n262_), .b(x78), .c(x77), .d(new_n220_), .O(new_n263_));
  nor2   g101(.a(new_n263_), .b(x01), .O(z33));
  nor2   g102(.a(new_n214_), .b(new_n228_), .O(new_n265_));
  nand3  g103(.a(x83), .b(x81), .c(x42), .O(new_n266_));
  oai21  g104(.a(new_n265_), .b(x81), .c(new_n266_), .O(new_n267_));
  nand2  g105(.a(new_n267_), .b(new_n232_), .O(new_n268_));
  oai22  g106(.a(new_n265_), .b(new_n231_), .c(new_n250_), .d(new_n228_), .O(new_n269_));
  nand2  g107(.a(new_n269_), .b(new_n229_), .O(new_n270_));
  aoi21  g108(.a(new_n270_), .b(new_n268_), .c(new_n156_), .O(new_n271_));
  nand4  g109(.a(new_n271_), .b(x78), .c(x77), .d(x52), .O(new_n272_));
  nor3   g110(.a(new_n272_), .b(x04), .c(x01), .O(z34));
  nand4  g111(.a(new_n271_), .b(x78), .c(x77), .d(x53), .O(new_n274_));
  nor3   g112(.a(new_n274_), .b(x04), .c(x01), .O(z35));
  nand4  g113(.a(new_n271_), .b(x78), .c(x77), .d(x54), .O(new_n276_));
  nor3   g114(.a(new_n276_), .b(x04), .c(x01), .O(z36));
  nand4  g115(.a(new_n271_), .b(x78), .c(x77), .d(x57), .O(new_n280_));
  nor3   g116(.a(new_n280_), .b(x04), .c(x01), .O(z39));
  nand4  g117(.a(new_n271_), .b(x78), .c(x77), .d(x58), .O(new_n282_));
  nor3   g118(.a(new_n282_), .b(x04), .c(x01), .O(z40));
  nand4  g119(.a(new_n271_), .b(x78), .c(x77), .d(x59), .O(new_n284_));
  nor3   g120(.a(new_n284_), .b(x04), .c(x01), .O(z41));
  nand4  g121(.a(new_n271_), .b(x78), .c(x77), .d(x61), .O(new_n287_));
  nor3   g122(.a(new_n287_), .b(x04), .c(x01), .O(z43));
  nand4  g123(.a(new_n271_), .b(x78), .c(x77), .d(x62), .O(new_n289_));
  ...
  nand4  g129(.a(new_n296_), .b(x78), .c(new_n153_), .d(x04), .O(new_n297_));
  nor2   g130(.a(x75), .b(x67), .O(new_n298_));
  nor2   g131(.a(new_n298_), .b(new_n209_), .O(new_n299_));
  nand4  g132(.a(new_n299_), .b(x79), .c(new_n154_), .d(x77), .O(new_n300_));
  ...
  nand2  g138(.a(new_n312_), .b(new_n231_), .O(new_n313_));
  nor4   g139(.a(new_n313_), .b(new_n309_), .c(new_n214_), .d(x82), .O(z55));
  nand2  g140(.a(new_n224_), .b(x76), .O(new_n315_));
  inv1   g141(.a(new_n161_), .O(new_n316_));
  xnor2a g142(.a(x84), .b(x81), .O(new_n317_));
  aoi21  g143(.a(new_n163_), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand2  g144(.a(new_n318_), .b(new_n159_), .O(new_n319_));
  nand2  g145(.a(new_n319_), .b(new_n315_), .O(new_n320_));
  nand2  g146(.a(new_n320_), .b(x79), .O(new_n321_));
  nand4  g147(.a(new_n321_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  inv1   g148(.a(x02), .O(new_n323_));
  nand4  g149(.a(x03), .b(new_n323_), .c(new_n159_), .d(x00), .O(new_n324_));
  inv1   g150(.a(new_n324_), .O(z57));
  nand4  g151(.a(x80), .b(new_n212_), .c(x43), .d(new_n228_), .O(new_n326_));
  oai22  g152(.a(new_n326_), .b(new_n215_), .c(new_n228_), .d(x40), .O(new_n327_));
  nand4  g153(.a(new_n327_), .b(x79), .c(x78), .d(x04), .O(new_n328_));
  nor2   g154(.a(x79), .b(x78), .O(new_n329_));
  nand3  g155(.a(new_n329_), .b(new_n228_), .c(x40), .O(new_n330_));
  nand2  g156(.a(new_n330_), .b(new_n328_), .O(new_n331_));
  nand2  g157(.a(new_n331_), .b(x77), .O(new_n332_));
  oai21  g158(.a(new_n161_), .b(new_n220_), .c(new_n156_), .O(new_n333_));
  aoi21  g159(.a(new_n333_), .b(new_n332_), .c(x01), .O(z58));
  nor2   g160(.a(new_n154_), .b(new_n220_), .O(new_n335_));
  oai21  g161(.a(new_n335_), .b(new_n329_), .c(x40), .O(new_n336_));
  oai21  g162(.a(new_n215_), .b(new_n213_), .c(new_n228_), .O(new_n337_));
  ...
  nand2  g167(.a(new_n156_), .b(new_n220_), .O(new_n342_));
  aoi21  g168(.a(new_n342_), .b(new_n341_), .c(x01), .O(z59));
  nand2  g169(.a(new_n318_), .b(x79), .O(new_n344_));
  nand3  g170(.a(new_n344_), .b(new_n342_), .c(new_n218_), .O(new_n345_));
  and2   g171(.a(new_n345_), .b(new_n159_), .O(z60));
  nand2  g172(.a(new_n163_), .b(new_n316_), .O(new_n347_));
  nand2  g173(.a(new_n347_), .b(new_n210_), .O(new_n348_));
  oai21  g174(.a(new_n224_), .b(x04), .c(new_n348_), .O(new_n349_));
  nand4  g175(.a(new_n349_), .b(x80), .c(x79), .d(new_n159_), .O(new_n350_));
  inv1   g176(.a(new_n350_), .O(z61));
  nand2  g177(.a(new_n156_), .b(x04), .O(new_n352_));
  ...
  nand3  g181(.a(x81), .b(x79), .c(new_n220_), .O(new_n356_));
  aoi21  g182(.a(new_n356_), .b(new_n355_), .c(new_n153_), .O(new_n357_));
  oai21  g183(.a(new_n357_), .b(new_n354_), .c(x78), .O(new_n358_));
  or2    g184(.a(new_n353_), .b(new_n163_), .O(new_n359_));
  aoi21  g185(.a(new_n359_), .b(new_n358_), .c(x01), .O(z62));
  nand4  g186(.a(new_n349_), .b(x82), .c(x79), .d(new_n159_), .O(new_n361_));
  inv1   g187(.a(new_n361_), .O(z63));
  nand3  g188(.a(new_n349_), .b(x83), .c(x79), .O(new_n363_));
  nand4  g189(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n364_));
  aoi21  g190(.a(new_n364_), .b(new_n363_), .c(x01), .O(z64));
  nor2   g191(.a(new_n154_), .b(x04), .O(new_n366_));
  nor2   g192(.a(new_n231_), .b(x78), .O(new_n367_));
  oai21  g193(.a(new_n367_), .b(new_n366_), .c(x77), .O(new_n368_));
  nand3  g194(.a(x81), .b(x78), .c(new_n153_), .O(new_n369_));
  nand2  g195(.a(new_n369_), .b(new_n368_), .O(new_n370_));
  nand4  g196(.a(new_n370_), .b(x84), .c(x79), .d(new_n159_), .O(new_n371_));
  inv1   g197(.a(new_n371_), .O(z65));
  zero   g198(.O(z00));
  zero   g199(.O(z05));
  zero   g200(.O(z06));
  zero   g201(.O(z08));
