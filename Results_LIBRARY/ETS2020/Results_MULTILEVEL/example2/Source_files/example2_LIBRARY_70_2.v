...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n284_, new_n286_, new_n289_, new_n292_, new_n294_,
    new_n296_, new_n299_, new_n302_, new_n304_, new_n305_, new_n306_,
  ...
  nand4  g098(.a(new_n244_), .b(x49), .c(new_n236_), .d(new_n228_), .O(new_n256_));
  nor2   g099(.a(new_n256_), .b(x01), .O(z31));
  nand4  g100(.a(new_n244_), .b(x50), .c(new_n236_), .d(new_n228_), .O(new_n258_));
  nor2   g101(.a(new_n258_), .b(x01), .O(z32));
  nand2  g102(.a(x83), .b(new_n239_), .O(new_n260_));
  ...
  nand3  g106(.a(x81), .b(x51), .c(new_n236_), .O(new_n264_));
  nand2  g107(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g108(.a(new_n265_), .b(new_n237_), .O(new_n266_));
  xnor2a g109(.a(x83), .b(x81), .O(new_n267_));
  nand3  g110(.a(new_n267_), .b(x42), .c(x05), .O(new_n268_));
  nand3  g111(.a(new_n239_), .b(x51), .c(new_n236_), .O(new_n269_));
  nand2  g112(.a(new_n269_), .b(new_n268_), .O(new_n270_));
  nand2  g113(.a(new_n270_), .b(new_n240_), .O(new_n271_));
  aoi21  g114(.a(new_n271_), .b(new_n266_), .c(new_n154_), .O(new_n272_));
  nand4  g115(.a(new_n272_), .b(x78), .c(x77), .d(new_n228_), .O(new_n273_));
  nor2   g116(.a(new_n273_), .b(x01), .O(z33));
  nor2   g117(.a(new_n222_), .b(new_n236_), .O(new_n275_));
  nand3  g118(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  oai21  g119(.a(new_n275_), .b(x81), .c(new_n276_), .O(new_n277_));
  nand2  g120(.a(new_n277_), .b(new_n240_), .O(new_n278_));
  oai22  g121(.a(new_n275_), .b(new_n239_), .c(new_n260_), .d(new_n236_), .O(new_n279_));
  nand2  g122(.a(new_n279_), .b(new_n237_), .O(new_n280_));
  ...
  nand4  g130(.a(new_n281_), .b(x78), .c(x77), .d(x56), .O(new_n289_));
  ...
  nand4  g138(.a(new_n281_), .b(x78), .c(x77), .d(x62), .O(new_n299_));
