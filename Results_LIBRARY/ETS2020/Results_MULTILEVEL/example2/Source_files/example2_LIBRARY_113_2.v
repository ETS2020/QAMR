...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n252_, new_n254_, new_n257_, new_n259_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n285_, new_n287_, new_n289_, new_n292_,
    new_n294_, new_n296_, new_n298_, new_n304_, new_n305_, new_n306_,
  ...
  nand2  g197(.a(new_n359_), .b(new_n240_), .O(new_n360_));
  nor4   g198(.a(new_n360_), .b(new_n356_), .c(new_n223_), .d(x82), .O(z55));
  nand2  g199(.a(new_n233_), .b(x76), .O(new_n362_));
  ...
  nand4  g210(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n373_));
  oai22  g211(.a(new_n373_), .b(new_n224_), .c(new_n237_), .d(x40), .O(new_n374_));
  nand4  g212(.a(new_n374_), .b(x79), .c(x78), .d(x04), .O(new_n375_));
  nor2   g213(.a(x79), .b(x78), .O(new_n376_));
  nand3  g214(.a(new_n376_), .b(new_n237_), .c(x40), .O(new_n377_));
  nand2  g215(.a(new_n377_), .b(new_n375_), .O(new_n378_));
  nand2  g216(.a(new_n378_), .b(x77), .O(new_n379_));
  oai21  g217(.a(new_n165_), .b(new_n229_), .c(new_n154_), .O(new_n380_));
  aoi21  g218(.a(new_n380_), .b(new_n379_), .c(x01), .O(z58));
  nor2   g219(.a(new_n160_), .b(new_n229_), .O(new_n382_));
  oai21  g220(.a(new_n382_), .b(new_n376_), .c(x40), .O(new_n383_));
  oai21  g221(.a(new_n224_), .b(new_n222_), .c(new_n237_), .O(new_n384_));
  ...
  nand2  g226(.a(new_n154_), .b(new_n229_), .O(new_n389_));
  ...
  oai21  g233(.a(new_n233_), .b(x04), .c(new_n395_), .O(new_n396_));
  ...
  nand3  g240(.a(x81), .b(x79), .c(new_n229_), .O(new_n403_));
  ...
  nor2   g251(.a(new_n240_), .b(x78), .O(new_n414_));
