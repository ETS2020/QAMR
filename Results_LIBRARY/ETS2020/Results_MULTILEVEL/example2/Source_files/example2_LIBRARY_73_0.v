...
module FAU ( 
  ...
  oai21  g076(.a(new_n239_), .b(new_n237_), .c(new_n214_), .O(new_n240_));
  nand2  g077(.a(x83), .b(x42), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g079(.a(x83), .b(new_n213_), .c(x42), .O(new_n243_));
  nand2  g080(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g081(.a(new_n244_), .b(new_n211_), .O(new_n245_));
  aoi21  g082(.a(new_n245_), .b(new_n240_), .c(new_n156_), .O(new_n246_));
