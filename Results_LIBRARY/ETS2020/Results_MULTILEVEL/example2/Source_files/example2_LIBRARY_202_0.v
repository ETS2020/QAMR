...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n172_, new_n173_, new_n177_, new_n178_, new_n181_, new_n182_,
  ...
  nand4  g138(.a(x03), .b(new_n310_), .c(new_n153_), .d(x00), .O(new_n311_));
  inv1   g139(.a(new_n311_), .O(z57));
  nor2   g140(.a(new_n271_), .b(x04), .O(new_n320_));
  nor2   g141(.a(new_n210_), .b(x78), .O(new_n321_));
  oai21  g142(.a(new_n321_), .b(new_n320_), .c(x77), .O(new_n322_));
  nand3  g143(.a(x81), .b(x78), .c(new_n265_), .O(new_n323_));
  nand2  g144(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  nand4  g145(.a(new_n324_), .b(x84), .c(x79), .d(new_n153_), .O(new_n325_));
