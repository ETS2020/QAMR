...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n214_, new_n215_, new_n216_, new_n217_, new_n220_, new_n222_,
    ...
    new_n301_, new_n302_, new_n303_, new_n316_, new_n317_, new_n318_,
  ...
  nand4  g056(.a(new_n216_), .b(x46), .c(new_n208_), .d(new_n203_), .O(new_n220_));
  nor2   g057(.a(new_n220_), .b(x01), .O(z28));
  nand4  g058(.a(new_n216_), .b(x47), .c(new_n208_), .d(new_n203_), .O(new_n222_));
  nor2   g059(.a(new_n222_), .b(x01), .O(z29));
  nand4  g060(.a(new_n216_), .b(x48), .c(new_n208_), .d(new_n203_), .O(new_n224_));
  ...
  oai21  g065(.a(new_n231_), .b(new_n229_), .c(new_n212_), .O(new_n232_));
  nand2  g066(.a(x83), .b(x42), .O(new_n233_));
  nand2  g067(.a(new_n233_), .b(x81), .O(new_n234_));
  nand3  g068(.a(x83), .b(new_n211_), .c(x42), .O(new_n235_));
  nand2  g069(.a(new_n235_), .b(new_n234_), .O(new_n236_));
  nand2  g070(.a(new_n236_), .b(new_n209_), .O(new_n237_));
  ...
  nor2   g134(.a(new_n269_), .b(x04), .O(new_n316_));
  nor2   g135(.a(new_n211_), .b(x78), .O(new_n317_));
  oai21  g136(.a(new_n317_), .b(new_n316_), .c(x77), .O(new_n318_));
  nand3  g137(.a(x81), .b(x78), .c(new_n263_), .O(new_n319_));
  nand2  g138(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  nand4  g139(.a(new_n320_), .b(x84), .c(x79), .d(new_n155_), .O(new_n321_));
  inv1   g140(.a(new_n321_), .O(z65));
  zero   g141(.O(z00));
  zero   g142(.O(z01));
  zero   g143(.O(z02));
  zero   g144(.O(z05));
