// Benchmark "FAU" written by ABC on Fri Jul 24 22:41:12 2020
...
module FAU ( 
  ...
  nand4  g116(.a(new_n270_), .b(x78), .c(x77), .d(x59), .O(new_n283_));
  nor3   g117(.a(new_n283_), .b(x04), .c(x01), .O(z41));
  nand4  g118(.a(new_n270_), .b(x78), .c(x77), .d(x60), .O(new_n285_));
  nor3   g119(.a(new_n285_), .b(x04), .c(x01), .O(z42));
  nand4  g120(.a(new_n270_), .b(x78), .c(x77), .d(x61), .O(new_n287_));
  nor3   g121(.a(new_n287_), .b(x04), .c(x01), .O(z43));
  nand4  g122(.a(new_n270_), .b(x78), .c(x77), .d(x62), .O(new_n289_));
  nor3   g123(.a(new_n289_), .b(x04), .c(x01), .O(z44));
  nand4  g124(.a(new_n270_), .b(x78), .c(x77), .d(x63), .O(new_n291_));
  nor3   g125(.a(new_n291_), .b(x04), .c(x01), .O(z45));
  nand4  g126(.a(new_n270_), .b(x78), .c(x77), .d(x64), .O(new_n293_));
  nor3   g127(.a(new_n293_), .b(x04), .c(x01), .O(z46));
  nand2  g128(.a(x52), .b(x15), .O(new_n295_));
  inv1   g129(.a(x52), .O(new_n296_));
  nand2  g130(.a(new_n296_), .b(x07), .O(new_n297_));
  aoi21  g131(.a(new_n297_), .b(new_n295_), .c(x79), .O(new_n298_));
  nand4  g132(.a(new_n298_), .b(x78), .c(new_n153_), .d(x04), .O(new_n299_));
  nor2   g133(.a(x75), .b(x67), .O(new_n300_));
  nor2   g134(.a(new_n300_), .b(new_n210_), .O(new_n301_));
  nand4  g135(.a(new_n301_), .b(x79), .c(new_n154_), .d(x77), .O(new_n302_));
  aoi21  g136(.a(new_n302_), .b(new_n299_), .c(x01), .O(z47));
  ...
  nand2  g141(.a(new_n314_), .b(new_n233_), .O(new_n315_));
  nor4   g142(.a(new_n315_), .b(new_n311_), .c(new_n215_), .d(x82), .O(z55));
  nand2  g143(.a(new_n225_), .b(x76), .O(new_n317_));
  ...
  nand4  g154(.a(x80), .b(new_n213_), .c(x43), .d(new_n230_), .O(new_n328_));
  oai22  g155(.a(new_n328_), .b(new_n216_), .c(new_n230_), .d(x40), .O(new_n329_));
  nand4  g156(.a(new_n329_), .b(x79), .c(x78), .d(x04), .O(new_n330_));
  nor2   g157(.a(x79), .b(x78), .O(new_n331_));
  nand3  g158(.a(new_n331_), .b(new_n230_), .c(x40), .O(new_n332_));
  nand2  g159(.a(new_n332_), .b(new_n330_), .O(new_n333_));
  nand2  g160(.a(new_n333_), .b(x77), .O(new_n334_));
  oai21  g161(.a(new_n161_), .b(new_n221_), .c(new_n156_), .O(new_n335_));
  aoi21  g162(.a(new_n335_), .b(new_n334_), .c(x01), .O(z58));
  nor2   g163(.a(new_n154_), .b(new_n221_), .O(new_n337_));
  oai21  g164(.a(new_n337_), .b(new_n331_), .c(x40), .O(new_n338_));
  oai21  g165(.a(new_n216_), .b(new_n214_), .c(new_n230_), .O(new_n339_));
  ...
  nand2  g170(.a(new_n156_), .b(new_n221_), .O(new_n344_));
  aoi21  g171(.a(new_n344_), .b(new_n343_), .c(x01), .O(z59));
  nand2  g172(.a(new_n320_), .b(x79), .O(new_n346_));
  nand3  g173(.a(new_n346_), .b(new_n344_), .c(new_n219_), .O(new_n347_));
  and2   g174(.a(new_n347_), .b(new_n159_), .O(z60));
  nand2  g175(.a(new_n163_), .b(new_n318_), .O(new_n349_));
  nand2  g176(.a(new_n349_), .b(new_n211_), .O(new_n350_));
  oai21  g177(.a(new_n225_), .b(x04), .c(new_n350_), .O(new_n351_));
  ...
  nand3  g184(.a(x81), .b(x79), .c(new_n221_), .O(new_n358_));
  ...
  nor2   g194(.a(new_n154_), .b(x04), .O(new_n368_));
  nor2   g195(.a(new_n233_), .b(x78), .O(new_n369_));
  oai21  g196(.a(new_n369_), .b(new_n368_), .c(x77), .O(new_n370_));
  nand3  g197(.a(x81), .b(x78), .c(new_n153_), .O(new_n371_));
  nand2  g198(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand4  g199(.a(new_n372_), .b(x84), .c(x79), .d(new_n159_), .O(new_n373_));
  inv1   g200(.a(new_n373_), .O(z65));
  zero   g201(.O(z00));
  zero   g202(.O(z03));
  zero   g203(.O(z06));
  zero   g204(.O(z08));
