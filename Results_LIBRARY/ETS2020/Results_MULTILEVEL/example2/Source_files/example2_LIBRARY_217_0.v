...
module FAU ( 
  ...
  nand4  g056(.a(new_n217_), .b(x47), .c(new_n209_), .d(new_n203_), .O(new_n221_));
  ...
  nor2   g141(.a(new_n270_), .b(x04), .O(new_n321_));
  nor2   g142(.a(new_n212_), .b(x78), .O(new_n322_));
  oai21  g143(.a(new_n322_), .b(new_n321_), .c(x77), .O(new_n323_));
  nand3  g144(.a(x81), .b(x78), .c(new_n264_), .O(new_n324_));
