...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n185_, new_n188_, new_n189_, new_n194_, new_n195_, new_n197_,
    ...
    new_n243_, new_n244_, new_n246_, new_n249_, new_n251_, new_n254_,
    new_n256_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n274_, new_n275_, new_n276_,
    new_n277_, new_n278_, new_n279_, new_n280_, new_n281_, new_n283_,
    new_n285_, new_n288_, new_n290_, new_n292_, new_n294_, new_n296_,
  ...
  nor2   g113(.a(new_n221_), .b(new_n235_), .O(new_n274_));
  ...
  oai22  g117(.a(new_n274_), .b(new_n238_), .c(new_n258_), .d(new_n235_), .O(new_n278_));
  nand2  g118(.a(new_n278_), .b(new_n236_), .O(new_n279_));
  ...
  nand4  g134(.a(new_n280_), .b(x78), .c(x77), .d(x61), .O(new_n296_));
  ...
  nand4  g138(.a(new_n280_), .b(x78), .c(x77), .d(x63), .O(new_n300_));
  nor3   g139(.a(new_n300_), .b(x04), .c(x01), .O(z45));
  nand4  g140(.a(new_n280_), .b(x78), .c(x77), .d(x64), .O(new_n302_));
  ...
  nand2  g155(.a(new_n323_), .b(new_n238_), .O(new_n324_));
  nor4   g156(.a(new_n324_), .b(new_n320_), .c(new_n221_), .d(x82), .O(z55));
  nand2  g157(.a(new_n231_), .b(x76), .O(new_n326_));
  xor2a  g158(.a(x84), .b(x81), .O(new_n327_));
  inv1   g159(.a(new_n165_), .O(new_n328_));
  nand2  g160(.a(new_n167_), .b(new_n328_), .O(new_n329_));
  nand3  g161(.a(new_n329_), .b(new_n327_), .c(new_n153_), .O(new_n330_));
  ...
  nand4  g165(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n335_));
  oai22  g166(.a(new_n335_), .b(new_n222_), .c(new_n235_), .d(x40), .O(new_n336_));
  nand4  g167(.a(new_n336_), .b(x79), .c(x78), .d(x04), .O(new_n337_));
  nor2   g168(.a(x79), .b(x78), .O(new_n338_));
  nand3  g169(.a(new_n338_), .b(new_n235_), .c(x40), .O(new_n339_));
  nand2  g170(.a(new_n339_), .b(new_n337_), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(x77), .O(new_n341_));
  oai21  g172(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n342_));
  aoi21  g173(.a(new_n342_), .b(new_n341_), .c(x01), .O(z58));
  nor2   g174(.a(new_n160_), .b(new_n227_), .O(new_n344_));
  oai21  g175(.a(new_n344_), .b(new_n338_), .c(x40), .O(new_n345_));
  oai21  g176(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n346_));
  ...
  nand2  g181(.a(new_n154_), .b(new_n227_), .O(new_n351_));
  aoi21  g182(.a(new_n351_), .b(new_n350_), .c(x01), .O(z59));
  nand2  g183(.a(new_n329_), .b(new_n217_), .O(new_n354_));
  oai21  g184(.a(new_n231_), .b(x04), .c(new_n354_), .O(new_n355_));
  ...
  nand2  g190(.a(new_n347_), .b(x04), .O(new_n361_));
  ...
  nor2   g201(.a(new_n160_), .b(x04), .O(new_n372_));
  nor2   g202(.a(new_n238_), .b(x78), .O(new_n373_));
  oai21  g203(.a(new_n373_), .b(new_n372_), .c(x77), .O(new_n374_));
  nand3  g204(.a(x81), .b(x78), .c(new_n159_), .O(new_n375_));
  nand2  g205(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand4  g206(.a(new_n376_), .b(x84), .c(x79), .d(new_n153_), .O(new_n377_));
  inv1   g207(.a(new_n377_), .O(z65));
  zero   g208(.O(z03));
  zero   g209(.O(z05));
  zero   g210(.O(z10));
  zero   g211(.O(z12));
