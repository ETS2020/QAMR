...
module FAU ( 
  ...
  nand4  g059(.a(new_n218_), .b(x46), .c(new_n210_), .d(new_n205_), .O(new_n222_));
  nor2   g060(.a(new_n222_), .b(x01), .O(z28));
  nand4  g061(.a(new_n218_), .b(x47), .c(new_n210_), .d(new_n205_), .O(new_n224_));
  nor2   g062(.a(new_n224_), .b(x01), .O(z29));
  nand4  g063(.a(new_n218_), .b(x48), .c(new_n210_), .d(new_n205_), .O(new_n226_));
  nor2   g064(.a(new_n226_), .b(x01), .O(z30));
  nand4  g065(.a(new_n218_), .b(x50), .c(new_n210_), .d(new_n205_), .O(new_n229_));
  ...
  nand4  g089(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n257_));
  nor3   g090(.a(new_n257_), .b(x04), .c(x01), .O(z43));
  nand4  g091(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n259_));
  nor3   g092(.a(new_n259_), .b(x04), .c(x01), .O(z44));
  nand4  g093(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n261_));
  nor3   g094(.a(new_n261_), .b(x04), .c(x01), .O(z45));
  nand4  g095(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n263_));
