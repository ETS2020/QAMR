...
module FAU ( 
  ...
  nor2   g166(.a(new_n320_), .b(new_n224_), .O(new_n321_));
  ...
  nand4  g173(.a(new_n225_), .b(x79), .c(new_n160_), .d(x77), .O(new_n328_));
  ...
  nand2  g216(.a(new_n370_), .b(new_n246_), .O(new_n371_));
  nor4   g217(.a(new_n371_), .b(new_n367_), .c(new_n229_), .d(x82), .O(z55));
  nand2  g218(.a(new_n239_), .b(x76), .O(new_n373_));
  ...
  nand4  g229(.a(x80), .b(new_n227_), .c(x43), .d(new_n243_), .O(new_n384_));
  oai22  g230(.a(new_n384_), .b(new_n230_), .c(new_n243_), .d(x40), .O(new_n385_));
  nand4  g231(.a(new_n385_), .b(x79), .c(x78), .d(x04), .O(new_n386_));
  nor2   g232(.a(x79), .b(x78), .O(new_n387_));
  nand3  g233(.a(new_n387_), .b(new_n243_), .c(x40), .O(new_n388_));
  nand2  g234(.a(new_n388_), .b(new_n386_), .O(new_n389_));
  nand2  g235(.a(new_n389_), .b(x77), .O(new_n390_));
  oai21  g236(.a(new_n165_), .b(new_n235_), .c(new_n154_), .O(new_n391_));
  aoi21  g237(.a(new_n391_), .b(new_n390_), .c(x01), .O(z58));
  nor2   g238(.a(new_n160_), .b(new_n235_), .O(new_n393_));
  oai21  g239(.a(new_n393_), .b(new_n387_), .c(x40), .O(new_n394_));
  oai21  g240(.a(new_n230_), .b(new_n228_), .c(new_n243_), .O(new_n395_));
  ...
  nand2  g245(.a(new_n154_), .b(new_n235_), .O(new_n400_));
  aoi21  g246(.a(new_n400_), .b(new_n399_), .c(x01), .O(z59));
  nand2  g247(.a(new_n376_), .b(x79), .O(new_n402_));
  nand3  g248(.a(new_n402_), .b(new_n400_), .c(new_n233_), .O(new_n403_));
  and2   g249(.a(new_n403_), .b(new_n153_), .O(z60));
  nand2  g250(.a(new_n167_), .b(new_n374_), .O(new_n405_));
  nand2  g251(.a(new_n405_), .b(new_n225_), .O(new_n406_));
  oai21  g252(.a(new_n239_), .b(x04), .c(new_n406_), .O(new_n407_));
  ...
  nand3  g259(.a(x81), .b(x79), .c(new_n235_), .O(new_n414_));
  ...
  nor2   g270(.a(new_n246_), .b(x78), .O(new_n425_));
