...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n223_, new_n225_, new_n231_, new_n232_, new_n233_, new_n234_,
  ...
  aoi21  g064(.a(x83), .b(x42), .c(x81), .O(new_n231_));
  nand3  g065(.a(x83), .b(x81), .c(x42), .O(new_n232_));
  inv1   g066(.a(new_n232_), .O(new_n233_));
  oai21  g067(.a(new_n233_), .b(new_n231_), .c(new_n212_), .O(new_n234_));
  nand2  g068(.a(x83), .b(x42), .O(new_n235_));
  nand2  g069(.a(new_n235_), .b(x81), .O(new_n236_));
  nand3  g070(.a(x83), .b(new_n211_), .c(x42), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g072(.a(new_n238_), .b(new_n209_), .O(new_n239_));
  aoi21  g073(.a(new_n239_), .b(new_n234_), .c(new_n156_), .O(new_n240_));
  nand4  g074(.a(new_n240_), .b(x78), .c(x77), .d(x53), .O(new_n241_));
  nor3   g075(.a(new_n241_), .b(x04), .c(x01), .O(z35));
  nand4  g076(.a(new_n240_), .b(x78), .c(x77), .d(x54), .O(new_n243_));
  nor3   g077(.a(new_n243_), .b(x04), .c(x01), .O(z36));
  nand4  g078(.a(new_n240_), .b(x78), .c(x77), .d(x55), .O(new_n245_));
  nor3   g079(.a(new_n245_), .b(x04), .c(x01), .O(z37));
  nand4  g080(.a(new_n240_), .b(x78), .c(x77), .d(x56), .O(new_n247_));
  nor3   g081(.a(new_n247_), .b(x04), .c(x01), .O(z38));
  nand4  g082(.a(new_n240_), .b(x78), .c(x77), .d(x57), .O(new_n249_));
  nor3   g083(.a(new_n249_), .b(x04), .c(x01), .O(z39));
  nand4  g084(.a(new_n240_), .b(x78), .c(x77), .d(x60), .O(new_n253_));
  nor3   g085(.a(new_n253_), .b(x04), .c(x01), .O(z42));
  nand4  g086(.a(new_n240_), .b(x78), .c(x77), .d(x61), .O(new_n255_));
  nor3   g087(.a(new_n255_), .b(x04), .c(x01), .O(z43));
  nand4  g088(.a(new_n240_), .b(x78), .c(x77), .d(x62), .O(new_n257_));
  nor3   g089(.a(new_n257_), .b(x04), .c(x01), .O(z44));
  nand4  g090(.a(new_n240_), .b(x78), .c(x77), .d(x63), .O(new_n259_));
  nor3   g091(.a(new_n259_), .b(x04), .c(x01), .O(z45));
  nand4  g092(.a(new_n240_), .b(x78), .c(x77), .d(x64), .O(new_n261_));
