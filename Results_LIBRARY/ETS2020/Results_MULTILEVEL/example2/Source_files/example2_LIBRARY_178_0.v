...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n331_, new_n332_, new_n339_, new_n340_, new_n341_, new_n342_,
    new_n343_, new_n344_;
  ...
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n256_));
  nor3   g090(.a(new_n256_), .b(x04), .c(x01), .O(z42));
  nand4  g091(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n258_));
  nor3   g092(.a(new_n258_), .b(x04), .c(x01), .O(z43));
  nand4  g093(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n260_));
  nor3   g094(.a(new_n260_), .b(x04), .c(x01), .O(z44));
  nand4  g095(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n262_));
  nor3   g096(.a(new_n262_), .b(x04), .c(x01), .O(z45));
  nand4  g097(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n264_));
  ...
  nor2   g149(.a(x79), .b(x78), .O(new_n320_));
  nor2   g150(.a(new_n273_), .b(new_n205_), .O(new_n321_));
  oai21  g151(.a(new_n321_), .b(new_n320_), .c(x40), .O(new_n322_));
  inv1   g152(.a(x74), .O(new_n323_));
  nand3  g153(.a(x80), .b(new_n323_), .c(x43), .O(new_n324_));
  inv1   g154(.a(x83), .O(new_n325_));
  nand4  g155(.a(x84), .b(new_n325_), .c(x82), .d(x81), .O(new_n326_));
  oai21  g156(.a(new_n326_), .b(new_n324_), .c(new_n210_), .O(new_n327_));
  nand2  g157(.a(new_n327_), .b(x79), .O(new_n328_));
  nand3  g158(.a(new_n328_), .b(x78), .c(x04), .O(new_n329_));
  nand2  g159(.a(new_n329_), .b(new_n322_), .O(new_n330_));
  nand2  g160(.a(new_n330_), .b(x77), .O(new_n331_));
  nand2  g161(.a(new_n156_), .b(new_n205_), .O(new_n332_));
  aoi21  g162(.a(new_n332_), .b(new_n331_), .c(x01), .O(z59));
  nor2   g163(.a(new_n273_), .b(x04), .O(new_n339_));
  nor2   g164(.a(new_n213_), .b(x78), .O(new_n340_));
  oai21  g165(.a(new_n340_), .b(new_n339_), .c(x77), .O(new_n341_));
  nand3  g166(.a(x81), .b(x78), .c(new_n267_), .O(new_n342_));
  nand2  g167(.a(new_n342_), .b(new_n341_), .O(new_n343_));
  nand4  g168(.a(new_n343_), .b(x84), .c(x79), .d(new_n155_), .O(new_n344_));
  inv1   g169(.a(new_n344_), .O(z65));
  zero   g170(.O(z00));
  zero   g171(.O(z01));
  zero   g172(.O(z02));
  zero   g173(.O(z12));
