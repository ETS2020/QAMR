...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n297_, new_n301_, new_n303_, new_n304_, new_n305_, new_n306_,
  ...
  inv1   g061(.a(x41), .O(new_n217_));
  xor2a  g062(.a(x84), .b(x81), .O(new_n218_));
  inv1   g063(.a(new_n218_), .O(new_n219_));
  nand4  g064(.a(new_n219_), .b(new_n164_), .c(x79), .d(new_n217_), .O(new_n220_));
  inv1   g065(.a(x74), .O(new_n221_));
  nand3  g066(.a(x80), .b(new_n221_), .c(x43), .O(new_n222_));
  inv1   g067(.a(x83), .O(new_n223_));
  nand4  g068(.a(x84), .b(new_n223_), .c(x82), .d(x81), .O(new_n224_));
  oai21  g069(.a(new_n224_), .b(new_n222_), .c(x77), .O(new_n225_));
  oai21  g070(.a(new_n225_), .b(x42), .c(x79), .O(new_n226_));
  nand3  g071(.a(new_n226_), .b(x78), .c(x04), .O(new_n227_));
  aoi21  g072(.a(new_n227_), .b(new_n220_), .c(x01), .O(z22));
  inv1   g073(.a(x04), .O(new_n229_));
  nand3  g074(.a(new_n156_), .b(x05), .c(new_n229_), .O(new_n230_));
  nand3  g075(.a(new_n230_), .b(new_n159_), .c(x00), .O(z23));
  nor2   g076(.a(new_n154_), .b(new_n153_), .O(new_n232_));
  inv1   g077(.a(new_n232_), .O(new_n233_));
  aoi21  g078(.a(new_n233_), .b(x79), .c(x43), .O(new_n234_));
  nand3  g079(.a(new_n234_), .b(x05), .c(new_n229_), .O(new_n235_));
  nor2   g080(.a(new_n235_), .b(x01), .O(z24));
  inv1   g081(.a(x42), .O(new_n237_));
  xnor2a g082(.a(x84), .b(x82), .O(new_n238_));
  nand2  g083(.a(new_n238_), .b(x81), .O(new_n239_));
  inv1   g084(.a(x81), .O(new_n240_));
  xor2a  g085(.a(x84), .b(x82), .O(new_n241_));
  nand2  g086(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand2  g087(.a(new_n242_), .b(new_n239_), .O(new_n243_));
  nand4  g088(.a(new_n243_), .b(x79), .c(x78), .d(x77), .O(new_n244_));
  inv1   g089(.a(new_n244_), .O(new_n245_));
  nand4  g090(.a(new_n245_), .b(new_n237_), .c(x05), .d(new_n229_), .O(new_n246_));
  nor2   g091(.a(new_n246_), .b(x01), .O(z25));
  nand4  g092(.a(new_n245_), .b(x44), .c(new_n237_), .d(new_n229_), .O(new_n248_));
  nor2   g093(.a(new_n248_), .b(x01), .O(z26));
  nand4  g094(.a(new_n245_), .b(x45), .c(new_n237_), .d(new_n229_), .O(new_n250_));
  nor2   g095(.a(new_n250_), .b(x01), .O(z27));
  nand4  g096(.a(new_n245_), .b(x48), .c(new_n237_), .d(new_n229_), .O(new_n254_));
  nor2   g097(.a(new_n254_), .b(x01), .O(z30));
  nand4  g098(.a(new_n245_), .b(x49), .c(new_n237_), .d(new_n229_), .O(new_n256_));
  nor2   g099(.a(new_n256_), .b(x01), .O(z31));
  nand2  g100(.a(x83), .b(new_n240_), .O(new_n259_));
  nand2  g101(.a(new_n223_), .b(x81), .O(new_n260_));
  nand2  g102(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand3  g103(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g104(.a(x81), .b(x51), .c(new_n237_), .O(new_n263_));
  ...
  nand3  g109(.a(new_n240_), .b(x51), .c(new_n237_), .O(new_n268_));
  nand2  g110(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand2  g111(.a(new_n269_), .b(new_n241_), .O(new_n270_));
  aoi21  g112(.a(new_n270_), .b(new_n265_), .c(new_n156_), .O(new_n271_));
  nand4  g113(.a(new_n271_), .b(x78), .c(x77), .d(new_n229_), .O(new_n272_));
  nor2   g114(.a(new_n272_), .b(x01), .O(z33));
  nor2   g115(.a(new_n223_), .b(new_n237_), .O(new_n274_));
  ...
  oai22  g119(.a(new_n274_), .b(new_n240_), .c(new_n259_), .d(new_n237_), .O(new_n278_));
  nand2  g120(.a(new_n278_), .b(new_n238_), .O(new_n279_));
  aoi21  g121(.a(new_n279_), .b(new_n277_), .c(new_n156_), .O(new_n280_));
  ...
  nand4  g136(.a(new_n280_), .b(x78), .c(x77), .d(x61), .O(new_n297_));
  ...
  nand4  g144(.a(new_n306_), .b(x78), .c(new_n153_), .d(x04), .O(new_n307_));
  nor2   g145(.a(x75), .b(x67), .O(new_n308_));
  nor2   g146(.a(new_n308_), .b(new_n218_), .O(new_n309_));
  nand4  g147(.a(new_n309_), .b(x79), .c(new_n154_), .d(x77), .O(new_n310_));
  ...
  nand4  g152(.a(new_n314_), .b(x78), .c(new_n153_), .d(x04), .O(new_n315_));
  nand4  g153(.a(new_n219_), .b(x79), .c(new_n154_), .d(x77), .O(new_n316_));
  ...
  nand4  g160(.a(new_n322_), .b(x78), .c(new_n153_), .d(x04), .O(new_n323_));
  ...
  nand4  g166(.a(new_n328_), .b(x78), .c(new_n153_), .d(x04), .O(new_n329_));
  ...
  nand4  g172(.a(new_n334_), .b(x78), .c(new_n153_), .d(x04), .O(new_n335_));
  ...
  nand4  g178(.a(new_n340_), .b(x78), .c(new_n153_), .d(x04), .O(new_n341_));
  ...
  nand4  g184(.a(new_n346_), .b(x78), .c(new_n153_), .d(x04), .O(new_n347_));
  ...
  nand4  g190(.a(new_n352_), .b(x78), .c(new_n153_), .d(x04), .O(new_n353_));
  ...
  nand2  g196(.a(new_n358_), .b(new_n240_), .O(new_n359_));
  nor4   g197(.a(new_n359_), .b(new_n355_), .c(new_n223_), .d(x82), .O(z55));
  nand2  g198(.a(new_n233_), .b(x76), .O(new_n361_));
  inv1   g199(.a(new_n161_), .O(new_n362_));
  xnor2a g200(.a(x84), .b(x81), .O(new_n363_));
  aoi21  g201(.a(new_n163_), .b(new_n362_), .c(new_n363_), .O(new_n364_));
  nand2  g202(.a(new_n364_), .b(new_n159_), .O(new_n365_));
  nand2  g203(.a(new_n365_), .b(new_n361_), .O(new_n366_));
  nand2  g204(.a(new_n366_), .b(x79), .O(new_n367_));
  nand4  g205(.a(new_n367_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  inv1   g206(.a(x02), .O(new_n369_));
  nand4  g207(.a(x03), .b(new_n369_), .c(new_n159_), .d(x00), .O(new_n370_));
  ...
  oai21  g216(.a(new_n161_), .b(new_n229_), .c(new_n156_), .O(new_n379_));
  aoi21  g217(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g218(.a(new_n154_), .b(new_n229_), .O(new_n381_));
  ...
  nand2  g225(.a(new_n156_), .b(new_n229_), .O(new_n388_));
  ...
  and2   g229(.a(new_n391_), .b(new_n159_), .O(z60));
  nand2  g230(.a(new_n163_), .b(new_n362_), .O(new_n393_));
  nand2  g231(.a(new_n393_), .b(new_n219_), .O(new_n394_));
  oai21  g232(.a(new_n233_), .b(x04), .c(new_n394_), .O(new_n395_));
  nand4  g233(.a(new_n395_), .b(x80), .c(x79), .d(new_n159_), .O(new_n396_));
  inv1   g234(.a(new_n396_), .O(z61));
  nand2  g235(.a(new_n156_), .b(x04), .O(new_n398_));
  ...
  aoi21  g240(.a(new_n402_), .b(new_n401_), .c(new_n153_), .O(new_n403_));
  oai21  g241(.a(new_n403_), .b(new_n400_), .c(x78), .O(new_n404_));
  or2    g242(.a(new_n399_), .b(new_n163_), .O(new_n405_));
  aoi21  g243(.a(new_n405_), .b(new_n404_), .c(x01), .O(z62));
  nand4  g244(.a(new_n395_), .b(x82), .c(x79), .d(new_n159_), .O(new_n407_));
  inv1   g245(.a(new_n407_), .O(z63));
  nand3  g246(.a(new_n395_), .b(x83), .c(x79), .O(new_n409_));
  nand4  g247(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n410_));
  aoi21  g248(.a(new_n410_), .b(new_n409_), .c(x01), .O(z64));
  nor2   g249(.a(new_n154_), .b(x04), .O(new_n412_));
  nor2   g250(.a(new_n240_), .b(x78), .O(new_n413_));
  oai21  g251(.a(new_n413_), .b(new_n412_), .c(x77), .O(new_n414_));
  nand3  g252(.a(x81), .b(x78), .c(new_n153_), .O(new_n415_));
  nand2  g253(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  nand4  g254(.a(new_n416_), .b(x84), .c(x79), .d(new_n159_), .O(new_n417_));
