...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n196_, new_n198_, new_n199_, new_n202_, new_n203_, new_n207_,
  ...
  nand2  g077(.a(new_n219_), .b(x81), .O(new_n244_));
  ...
  nand4  g091(.a(new_n257_), .b(x78), .c(x77), .d(new_n225_), .O(new_n258_));
  nor2   g092(.a(new_n258_), .b(x01), .O(z33));
  nor2   g093(.a(new_n219_), .b(new_n247_), .O(new_n260_));
  ...
  nor2   g126(.a(new_n295_), .b(new_n214_), .O(new_n296_));
  ...
  nor4   g134(.a(new_n310_), .b(new_n306_), .c(new_n219_), .d(x82), .O(z55));
  ...
  nand4  g146(.a(x80), .b(new_n217_), .c(x43), .d(new_n247_), .O(new_n323_));
  oai22  g147(.a(new_n323_), .b(new_n220_), .c(new_n247_), .d(x40), .O(new_n324_));
  ...
  oai21  g153(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n330_));
  aoi21  g154(.a(new_n330_), .b(new_n329_), .c(x01), .O(z58));
  nor2   g155(.a(new_n160_), .b(new_n225_), .O(new_n332_));
  oai21  g156(.a(new_n332_), .b(new_n326_), .c(x40), .O(new_n333_));
  oai21  g157(.a(new_n220_), .b(new_n218_), .c(new_n247_), .O(new_n334_));
  ...
  nand3  g176(.a(x81), .b(x79), .c(new_n225_), .O(new_n353_));
