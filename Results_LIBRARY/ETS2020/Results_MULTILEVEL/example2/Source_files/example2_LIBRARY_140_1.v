...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n288_, new_n291_, new_n295_, new_n297_,
  ...
  nand4  g090(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n227_), .O(new_n249_));
  nor2   g091(.a(new_n249_), .b(x01), .O(z28));
  nand4  g092(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n227_), .O(new_n251_));
  ...
  nand4  g128(.a(new_n279_), .b(x78), .c(x77), .d(x56), .O(new_n288_));
