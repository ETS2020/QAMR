...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n224_, new_n227_, new_n232_, new_n233_, new_n234_, new_n235_,
    new_n236_, new_n237_, new_n238_, new_n239_, new_n240_, new_n241_,
    new_n242_, new_n245_, new_n249_, new_n251_, new_n253_, new_n255_,
    ...
    new_n301_, new_n302_, new_n315_, new_n316_, new_n317_, new_n318_,
    new_n319_, new_n320_;
  ...
  aoi21  g064(.a(x83), .b(x42), .c(x81), .O(new_n232_));
  nand3  g065(.a(x83), .b(x81), .c(x42), .O(new_n233_));
  inv1   g066(.a(new_n233_), .O(new_n234_));
  oai21  g067(.a(new_n234_), .b(new_n232_), .c(new_n213_), .O(new_n235_));
  nand2  g068(.a(x83), .b(x42), .O(new_n236_));
  nand2  g069(.a(new_n236_), .b(x81), .O(new_n237_));
  nand3  g070(.a(x83), .b(new_n212_), .c(x42), .O(new_n238_));
  nand2  g071(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand2  g072(.a(new_n239_), .b(new_n210_), .O(new_n240_));
  aoi21  g073(.a(new_n240_), .b(new_n235_), .c(new_n156_), .O(new_n241_));
  nand4  g074(.a(new_n241_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g075(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g076(.a(new_n241_), .b(x78), .c(x77), .d(x56), .O(new_n245_));
  nor3   g077(.a(new_n245_), .b(x04), .c(x01), .O(z38));
  nand4  g078(.a(new_n241_), .b(x78), .c(x77), .d(x59), .O(new_n249_));
  nor3   g079(.a(new_n249_), .b(x04), .c(x01), .O(z41));
  nand4  g080(.a(new_n241_), .b(x78), .c(x77), .d(x60), .O(new_n251_));
  nor3   g081(.a(new_n251_), .b(x04), .c(x01), .O(z42));
  nand4  g082(.a(new_n241_), .b(x78), .c(x77), .d(x61), .O(new_n253_));
  nor3   g083(.a(new_n253_), .b(x04), .c(x01), .O(z43));
  nand4  g084(.a(new_n241_), .b(x78), .c(x77), .d(x62), .O(new_n255_));
  nor3   g085(.a(new_n255_), .b(x04), .c(x01), .O(z44));
  nand4  g086(.a(new_n241_), .b(x78), .c(x77), .d(x63), .O(new_n257_));
  nor3   g087(.a(new_n257_), .b(x04), .c(x01), .O(z45));
  nand4  g088(.a(new_n241_), .b(x78), .c(x77), .d(x64), .O(new_n259_));
  ...
  nor2   g132(.a(new_n268_), .b(x04), .O(new_n315_));
  nor2   g133(.a(new_n212_), .b(x78), .O(new_n316_));
  oai21  g134(.a(new_n316_), .b(new_n315_), .c(x77), .O(new_n317_));
  nand3  g135(.a(x81), .b(x78), .c(new_n262_), .O(new_n318_));
