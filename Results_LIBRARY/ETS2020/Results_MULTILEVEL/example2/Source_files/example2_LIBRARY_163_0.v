...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n199_, new_n200_, new_n207_, new_n208_, new_n209_, new_n210_,
    new_n211_, new_n212_, new_n213_, new_n214_, new_n215_, new_n216_,
    new_n218_, new_n220_, new_n222_, new_n225_, new_n226_, new_n227_,
    new_n228_, new_n229_, new_n230_, new_n231_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n238_, new_n240_, new_n242_, new_n246_,
  ...
  inv1   g039(.a(x42), .O(new_n207_));
  xnor2a g040(.a(x84), .b(x82), .O(new_n208_));
  nand2  g041(.a(new_n208_), .b(x81), .O(new_n209_));
  inv1   g042(.a(x81), .O(new_n210_));
  xor2a  g043(.a(x84), .b(x82), .O(new_n211_));
  nand2  g044(.a(new_n211_), .b(new_n210_), .O(new_n212_));
  nand2  g045(.a(new_n212_), .b(new_n209_), .O(new_n213_));
  nand4  g046(.a(new_n213_), .b(x79), .c(x78), .d(x77), .O(new_n214_));
  inv1   g047(.a(new_n214_), .O(new_n215_));
  nand4  g048(.a(new_n215_), .b(x47), .c(new_n207_), .d(new_n199_), .O(new_n216_));
  nor2   g049(.a(new_n216_), .b(x01), .O(z29));
  nand4  g050(.a(new_n215_), .b(x48), .c(new_n207_), .d(new_n199_), .O(new_n218_));
  nor2   g051(.a(new_n218_), .b(x01), .O(z30));
  nand4  g052(.a(new_n215_), .b(x49), .c(new_n207_), .d(new_n199_), .O(new_n220_));
  nor2   g053(.a(new_n220_), .b(x01), .O(z31));
  nand4  g054(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n199_), .O(new_n222_));
  ...
  oai21  g059(.a(new_n227_), .b(new_n225_), .c(new_n211_), .O(new_n228_));
  nand2  g060(.a(x83), .b(x42), .O(new_n229_));
  nand2  g061(.a(new_n229_), .b(x81), .O(new_n230_));
  nand3  g062(.a(x83), .b(new_n210_), .c(x42), .O(new_n231_));
  nand2  g063(.a(new_n231_), .b(new_n230_), .O(new_n232_));
  nand2  g064(.a(new_n232_), .b(new_n208_), .O(new_n233_));
  aoi21  g065(.a(new_n233_), .b(new_n228_), .c(new_n156_), .O(new_n234_));
  nand4  g066(.a(new_n234_), .b(x78), .c(x77), .d(x52), .O(new_n235_));
  nor3   g067(.a(new_n235_), .b(x04), .c(x01), .O(z34));
  nand4  g068(.a(new_n234_), .b(x78), .c(x77), .d(x54), .O(new_n238_));
  nor3   g069(.a(new_n238_), .b(x04), .c(x01), .O(z36));
  nand4  g070(.a(new_n234_), .b(x78), .c(x77), .d(x55), .O(new_n240_));
  nor3   g071(.a(new_n240_), .b(x04), .c(x01), .O(z37));
  nand4  g072(.a(new_n234_), .b(x78), .c(x77), .d(x56), .O(new_n242_));
  nor3   g073(.a(new_n242_), .b(x04), .c(x01), .O(z38));
  nand4  g074(.a(new_n234_), .b(x78), .c(x77), .d(x59), .O(new_n246_));
  nor3   g075(.a(new_n246_), .b(x04), .c(x01), .O(z41));
  nand4  g076(.a(new_n234_), .b(x78), .c(x77), .d(x60), .O(new_n248_));
  nor3   g077(.a(new_n248_), .b(x04), .c(x01), .O(z42));
  nand4  g078(.a(new_n234_), .b(x78), .c(x77), .d(x61), .O(new_n250_));
  nor3   g079(.a(new_n250_), .b(x04), .c(x01), .O(z43));
  nand4  g080(.a(new_n234_), .b(x78), .c(x77), .d(x62), .O(new_n252_));
  nor3   g081(.a(new_n252_), .b(x04), .c(x01), .O(z44));
  nand4  g082(.a(new_n234_), .b(x78), .c(x77), .d(x63), .O(new_n254_));
  nor3   g083(.a(new_n254_), .b(x04), .c(x01), .O(z45));
  nand4  g084(.a(new_n234_), .b(x78), .c(x77), .d(x64), .O(new_n256_));
  ...
  nor2   g134(.a(new_n210_), .b(x78), .O(new_n317_));
