...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n240_, new_n241_, new_n244_, new_n246_, new_n248_, new_n250_,
  ...
  nand4  g063(.a(new_n216_), .b(x50), .c(new_n208_), .d(new_n203_), .O(new_n228_));
  ...
  nand4  g077(.a(new_n240_), .b(x78), .c(x77), .d(x54), .O(new_n244_));
  nor3   g078(.a(new_n244_), .b(x04), .c(x01), .O(z36));
  nand4  g079(.a(new_n240_), .b(x78), .c(x77), .d(x55), .O(new_n246_));
  nor3   g080(.a(new_n246_), .b(x04), .c(x01), .O(z37));
  nand4  g081(.a(new_n240_), .b(x78), .c(x77), .d(x56), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z38));
  nand4  g083(.a(new_n240_), .b(x78), .c(x77), .d(x57), .O(new_n250_));
  nor3   g084(.a(new_n250_), .b(x04), .c(x01), .O(z39));
  nand4  g085(.a(new_n240_), .b(x78), .c(x77), .d(x61), .O(new_n255_));
  nor3   g086(.a(new_n255_), .b(x04), .c(x01), .O(z43));
  nand4  g087(.a(new_n240_), .b(x78), .c(x77), .d(x62), .O(new_n257_));
  nor3   g088(.a(new_n257_), .b(x04), .c(x01), .O(z44));
  nand4  g089(.a(new_n240_), .b(x78), .c(x77), .d(x63), .O(new_n259_));
  nor3   g090(.a(new_n259_), .b(x04), .c(x01), .O(z45));
  nand4  g091(.a(new_n240_), .b(x78), .c(x77), .d(x64), .O(new_n261_));
  nor3   g092(.a(new_n261_), .b(x04), .c(x01), .O(z46));
  inv1   g093(.a(x77), .O(new_n264_));
  nand2  g094(.a(x52), .b(x16), .O(new_n265_));
  inv1   g095(.a(x52), .O(new_n266_));
  nand2  g096(.a(new_n266_), .b(x08), .O(new_n267_));
  aoi21  g097(.a(new_n267_), .b(new_n265_), .c(x79), .O(new_n268_));
  nand4  g098(.a(new_n268_), .b(x78), .c(new_n264_), .d(x04), .O(new_n269_));
  inv1   g099(.a(x78), .O(new_n270_));
  xnor2a g100(.a(x84), .b(x81), .O(new_n271_));
  nand4  g101(.a(new_n271_), .b(x79), .c(new_n270_), .d(x77), .O(new_n272_));
  inv1   g102(.a(new_n272_), .O(new_n273_));
  nand2  g103(.a(new_n273_), .b(x68), .O(new_n274_));
  aoi21  g104(.a(new_n274_), .b(new_n269_), .c(x01), .O(z48));
  nand2  g105(.a(x52), .b(x17), .O(new_n276_));
  nand2  g106(.a(new_n266_), .b(x09), .O(new_n277_));
  aoi21  g107(.a(new_n277_), .b(new_n276_), .c(x79), .O(new_n278_));
  nand4  g108(.a(new_n278_), .b(x78), .c(new_n264_), .d(x04), .O(new_n279_));
  nand2  g109(.a(new_n273_), .b(x69), .O(new_n280_));
  aoi21  g110(.a(new_n280_), .b(new_n279_), .c(x01), .O(z49));
  nand2  g111(.a(x52), .b(x18), .O(new_n282_));
  nand2  g112(.a(new_n266_), .b(x10), .O(new_n283_));
  aoi21  g113(.a(new_n283_), .b(new_n282_), .c(x79), .O(new_n284_));
  nand4  g114(.a(new_n284_), .b(x78), .c(new_n264_), .d(x04), .O(new_n285_));
  nand2  g115(.a(new_n273_), .b(x70), .O(new_n286_));
  aoi21  g116(.a(new_n286_), .b(new_n285_), .c(x01), .O(z50));
  nand2  g117(.a(x52), .b(x19), .O(new_n288_));
  nand2  g118(.a(new_n266_), .b(x11), .O(new_n289_));
  aoi21  g119(.a(new_n289_), .b(new_n288_), .c(x79), .O(new_n290_));
  nand4  g120(.a(new_n290_), .b(x78), .c(new_n264_), .d(x04), .O(new_n291_));
  nand2  g121(.a(new_n273_), .b(x71), .O(new_n292_));
  aoi21  g122(.a(new_n292_), .b(new_n291_), .c(x01), .O(z51));
  nand2  g123(.a(x52), .b(x20), .O(new_n294_));
  nand2  g124(.a(new_n266_), .b(x12), .O(new_n295_));
  aoi21  g125(.a(new_n295_), .b(new_n294_), .c(x79), .O(new_n296_));
  nand4  g126(.a(new_n296_), .b(x78), .c(new_n264_), .d(x04), .O(new_n297_));
  nand2  g127(.a(new_n273_), .b(x72), .O(new_n298_));
  aoi21  g128(.a(new_n298_), .b(new_n297_), .c(x01), .O(z52));
  nand2  g129(.a(x52), .b(x21), .O(new_n300_));
  nand2  g130(.a(new_n266_), .b(x13), .O(new_n301_));
  aoi21  g131(.a(new_n301_), .b(new_n300_), .c(x79), .O(new_n302_));
  nand4  g132(.a(new_n302_), .b(x78), .c(new_n264_), .d(x04), .O(new_n303_));
  nand2  g133(.a(new_n273_), .b(x73), .O(new_n304_));
  aoi21  g134(.a(new_n304_), .b(new_n303_), .c(x01), .O(z53));
  nand2  g135(.a(x52), .b(x22), .O(new_n306_));
  nand2  g136(.a(new_n266_), .b(x14), .O(new_n307_));
  aoi21  g137(.a(new_n307_), .b(new_n306_), .c(x79), .O(new_n308_));
  nand4  g138(.a(new_n308_), .b(x78), .c(new_n264_), .d(x04), .O(new_n309_));
  nor2   g139(.a(new_n309_), .b(x01), .O(z54));
  inv1   g140(.a(x02), .O(new_n313_));
  nand4  g141(.a(x03), .b(new_n313_), .c(new_n153_), .d(x00), .O(new_n314_));
  inv1   g142(.a(new_n314_), .O(z57));
  nor2   g143(.a(new_n270_), .b(x04), .O(new_n323_));
  nor2   g144(.a(new_n211_), .b(x78), .O(new_n324_));
  oai21  g145(.a(new_n324_), .b(new_n323_), .c(x77), .O(new_n325_));
  nand3  g146(.a(x81), .b(x78), .c(new_n264_), .O(new_n326_));
  nand2  g147(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand4  g148(.a(new_n327_), .b(x84), .c(x79), .d(new_n153_), .O(new_n328_));
