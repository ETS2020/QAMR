...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n283_, new_n285_, new_n288_, new_n290_, new_n293_, new_n295_,
  ...
  inv1   g060(.a(x41), .O(new_n216_));
  xor2a  g061(.a(x84), .b(x81), .O(new_n217_));
  inv1   g062(.a(new_n217_), .O(new_n218_));
  nand4  g063(.a(new_n218_), .b(new_n164_), .c(x79), .d(new_n216_), .O(new_n219_));
  inv1   g064(.a(x74), .O(new_n220_));
  nand3  g065(.a(x80), .b(new_n220_), .c(x43), .O(new_n221_));
  inv1   g066(.a(x83), .O(new_n222_));
  nand4  g067(.a(x84), .b(new_n222_), .c(x82), .d(x81), .O(new_n223_));
  oai21  g068(.a(new_n223_), .b(new_n221_), .c(x77), .O(new_n224_));
  oai21  g069(.a(new_n224_), .b(x42), .c(x79), .O(new_n225_));
  nand3  g070(.a(new_n225_), .b(x78), .c(x04), .O(new_n226_));
  aoi21  g071(.a(new_n226_), .b(new_n219_), .c(x01), .O(z22));
  inv1   g072(.a(x04), .O(new_n228_));
  nand3  g073(.a(new_n156_), .b(x05), .c(new_n228_), .O(new_n229_));
  nand3  g074(.a(new_n229_), .b(new_n159_), .c(x00), .O(z23));
  nor2   g075(.a(new_n154_), .b(new_n153_), .O(new_n231_));
  inv1   g076(.a(new_n231_), .O(new_n232_));
  aoi21  g077(.a(new_n232_), .b(x79), .c(x43), .O(new_n233_));
  nand3  g078(.a(new_n233_), .b(x05), .c(new_n228_), .O(new_n234_));
  nor2   g079(.a(new_n234_), .b(x01), .O(z24));
  inv1   g080(.a(x42), .O(new_n236_));
  xnor2a g081(.a(x84), .b(x82), .O(new_n237_));
  nand2  g082(.a(new_n237_), .b(x81), .O(new_n238_));
  inv1   g083(.a(x81), .O(new_n239_));
  xor2a  g084(.a(x84), .b(x82), .O(new_n240_));
  nand2  g085(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g086(.a(new_n241_), .b(new_n238_), .O(new_n242_));
  nand4  g087(.a(new_n242_), .b(x79), .c(x78), .d(x77), .O(new_n243_));
  inv1   g088(.a(new_n243_), .O(new_n244_));
  nand4  g089(.a(new_n244_), .b(new_n236_), .c(x05), .d(new_n228_), .O(new_n245_));
  nor2   g090(.a(new_n245_), .b(x01), .O(z25));
  nand4  g091(.a(new_n244_), .b(x45), .c(new_n236_), .d(new_n228_), .O(new_n248_));
  nor2   g092(.a(new_n248_), .b(x01), .O(z27));
  nand4  g093(.a(new_n244_), .b(x47), .c(new_n236_), .d(new_n228_), .O(new_n251_));
  nor2   g094(.a(new_n251_), .b(x01), .O(z29));
  nand4  g095(.a(new_n244_), .b(x48), .c(new_n236_), .d(new_n228_), .O(new_n253_));
  nor2   g096(.a(new_n253_), .b(x01), .O(z30));
  nand4  g097(.a(new_n244_), .b(x49), .c(new_n236_), .d(new_n228_), .O(new_n255_));
  nor2   g098(.a(new_n255_), .b(x01), .O(z31));
  nand4  g099(.a(new_n244_), .b(x50), .c(new_n236_), .d(new_n228_), .O(new_n257_));
  nor2   g100(.a(new_n257_), .b(x01), .O(z32));
  nand2  g101(.a(x83), .b(new_n239_), .O(new_n259_));
  nand2  g102(.a(new_n222_), .b(x81), .O(new_n260_));
  nand2  g103(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand3  g104(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g105(.a(x81), .b(x51), .c(new_n236_), .O(new_n263_));
  nand2  g106(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  nand2  g107(.a(new_n264_), .b(new_n237_), .O(new_n265_));
  xnor2a g108(.a(x83), .b(x81), .O(new_n266_));
  nand3  g109(.a(new_n266_), .b(x42), .c(x05), .O(new_n267_));
  nand3  g110(.a(new_n239_), .b(x51), .c(new_n236_), .O(new_n268_));
  nand2  g111(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand2  g112(.a(new_n269_), .b(new_n240_), .O(new_n270_));
  ...
  nor2   g116(.a(new_n222_), .b(new_n236_), .O(new_n274_));
  nand3  g117(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  oai21  g118(.a(new_n274_), .b(x81), .c(new_n275_), .O(new_n276_));
  nand2  g119(.a(new_n276_), .b(new_n240_), .O(new_n277_));
  oai22  g120(.a(new_n274_), .b(new_n239_), .c(new_n259_), .d(new_n236_), .O(new_n278_));
  nand2  g121(.a(new_n278_), .b(new_n237_), .O(new_n279_));
  ...
  nand4  g131(.a(new_n280_), .b(x78), .c(x77), .d(x57), .O(new_n290_));
  nor3   g132(.a(new_n290_), .b(x04), .c(x01), .O(z39));
  ...
  nand4  g137(.a(new_n280_), .b(x78), .c(x77), .d(x64), .O(new_n300_));
  ...
  nor2   g145(.a(new_n307_), .b(new_n217_), .O(new_n308_));
  ...
  nand4  g152(.a(new_n218_), .b(x79), .c(new_n154_), .d(x77), .O(new_n315_));
  ...
  nand2  g195(.a(new_n357_), .b(new_n239_), .O(new_n358_));
  nor4   g196(.a(new_n358_), .b(new_n354_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g197(.a(new_n232_), .b(x76), .O(new_n360_));
  ...
  nand4  g206(.a(x03), .b(new_n368_), .c(new_n159_), .d(x00), .O(new_n369_));
  inv1   g207(.a(new_n369_), .O(z57));
  nand4  g208(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n371_));
  oai22  g209(.a(new_n371_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n372_));
  nand4  g210(.a(new_n372_), .b(x79), .c(x78), .d(x04), .O(new_n373_));
  nor2   g211(.a(x79), .b(x78), .O(new_n374_));
  nand3  g212(.a(new_n374_), .b(new_n236_), .c(x40), .O(new_n375_));
  nand2  g213(.a(new_n375_), .b(new_n373_), .O(new_n376_));
  nand2  g214(.a(new_n376_), .b(x77), .O(new_n377_));
  oai21  g215(.a(new_n161_), .b(new_n228_), .c(new_n156_), .O(new_n378_));
  aoi21  g216(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g217(.a(new_n154_), .b(new_n228_), .O(new_n380_));
  oai21  g218(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g219(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n382_));
  ...
  nand2  g224(.a(new_n156_), .b(new_n228_), .O(new_n387_));
  aoi21  g225(.a(new_n387_), .b(new_n386_), .c(x01), .O(z59));
  nand2  g226(.a(new_n363_), .b(x79), .O(new_n389_));
  nand3  g227(.a(new_n389_), .b(new_n387_), .c(new_n226_), .O(new_n390_));
  and2   g228(.a(new_n390_), .b(new_n159_), .O(z60));
  nand2  g229(.a(new_n163_), .b(new_n361_), .O(new_n392_));
  nand2  g230(.a(new_n392_), .b(new_n218_), .O(new_n393_));
  oai21  g231(.a(new_n232_), .b(x04), .c(new_n393_), .O(new_n394_));
  nand4  g232(.a(new_n394_), .b(x80), .c(x79), .d(new_n159_), .O(new_n395_));
  inv1   g233(.a(new_n395_), .O(z61));
  nand2  g234(.a(new_n156_), .b(x04), .O(new_n397_));
  ...
  nand3  g238(.a(x81), .b(x79), .c(new_n228_), .O(new_n401_));
  aoi21  g239(.a(new_n401_), .b(new_n400_), .c(new_n153_), .O(new_n402_));
  oai21  g240(.a(new_n402_), .b(new_n399_), .c(x78), .O(new_n403_));
  or2    g241(.a(new_n398_), .b(new_n163_), .O(new_n404_));
  aoi21  g242(.a(new_n404_), .b(new_n403_), .c(x01), .O(z62));
  nand4  g243(.a(new_n394_), .b(x82), .c(x79), .d(new_n159_), .O(new_n406_));
  inv1   g244(.a(new_n406_), .O(z63));
  nand3  g245(.a(new_n394_), .b(x83), .c(x79), .O(new_n408_));
  nand4  g246(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n409_));
