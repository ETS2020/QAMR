...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n219_, new_n222_, new_n224_, new_n227_, new_n230_, new_n233_,
  ...
  inv1   g045(.a(x38), .O(new_n202_));
  nand2  g046(.a(x45), .b(x40), .O(new_n203_));
  oai21  g047(.a(x40), .b(new_n202_), .c(new_n203_), .O(z20));
  inv1   g048(.a(x04), .O(new_n209_));
  inv1   g049(.a(x42), .O(new_n210_));
  xnor2a g050(.a(x84), .b(x82), .O(new_n211_));
  nand2  g051(.a(new_n211_), .b(x81), .O(new_n212_));
  inv1   g052(.a(x81), .O(new_n213_));
  xor2a  g053(.a(x84), .b(x82), .O(new_n214_));
  nand2  g054(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  nand2  g055(.a(new_n215_), .b(new_n212_), .O(new_n216_));
  nand4  g056(.a(new_n216_), .b(x79), .c(x78), .d(x77), .O(new_n217_));
  inv1   g057(.a(new_n217_), .O(new_n218_));
  nand4  g058(.a(new_n218_), .b(new_n210_), .c(x05), .d(new_n209_), .O(new_n219_));
  nor2   g059(.a(new_n219_), .b(x01), .O(z25));
  nand4  g060(.a(new_n218_), .b(x45), .c(new_n210_), .d(new_n209_), .O(new_n222_));
  nor2   g061(.a(new_n222_), .b(x01), .O(z27));
  nand4  g062(.a(new_n218_), .b(x46), .c(new_n210_), .d(new_n209_), .O(new_n224_));
  nor2   g063(.a(new_n224_), .b(x01), .O(z28));
  nand4  g064(.a(new_n218_), .b(x48), .c(new_n210_), .d(new_n209_), .O(new_n227_));
  nor2   g065(.a(new_n227_), .b(x01), .O(z30));
  nand4  g066(.a(new_n218_), .b(x50), .c(new_n210_), .d(new_n209_), .O(new_n230_));
  nor2   g067(.a(new_n230_), .b(x01), .O(z32));
  aoi21  g068(.a(x83), .b(x42), .c(x81), .O(new_n233_));
  nand3  g069(.a(x83), .b(x81), .c(x42), .O(new_n234_));
  inv1   g070(.a(new_n234_), .O(new_n235_));
  oai21  g071(.a(new_n235_), .b(new_n233_), .c(new_n214_), .O(new_n236_));
  nand2  g072(.a(x83), .b(x42), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g074(.a(x83), .b(new_n213_), .c(x42), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n211_), .O(new_n241_));
  ...
  nand4  g084(.a(new_n242_), .b(x78), .c(x77), .d(x56), .O(new_n250_));
  nor3   g085(.a(new_n250_), .b(x04), .c(x01), .O(z38));
  nand4  g086(.a(new_n242_), .b(x78), .c(x77), .d(x57), .O(new_n252_));
  nor3   g087(.a(new_n252_), .b(x04), .c(x01), .O(z39));
  nand4  g088(.a(new_n242_), .b(x78), .c(x77), .d(x59), .O(new_n255_));
  nor3   g089(.a(new_n255_), .b(x04), .c(x01), .O(z41));
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x60), .O(new_n257_));
  nor3   g091(.a(new_n257_), .b(x04), .c(x01), .O(z42));
  nand4  g092(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n259_));
  nor3   g093(.a(new_n259_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n242_), .b(x78), .c(x77), .d(x62), .O(new_n261_));
  nor3   g095(.a(new_n261_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n263_));
  nor3   g097(.a(new_n263_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n265_));
  nor3   g099(.a(new_n265_), .b(x04), .c(x01), .O(z46));
  inv1   g100(.a(x77), .O(new_n268_));
