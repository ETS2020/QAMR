...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n162_, new_n163_,
    ...
    new_n220_, new_n221_, new_n224_, new_n226_, new_n228_, new_n233_,
    ...
    new_n308_, new_n309_, new_n310_, new_n322_, new_n323_, new_n324_,
  ...
  nand4  g060(.a(new_n220_), .b(x44), .c(new_n212_), .d(new_n207_), .O(new_n221_));
  nor2   g061(.a(new_n221_), .b(x01), .O(z26));
  nand4  g062(.a(new_n220_), .b(x46), .c(new_n212_), .d(new_n207_), .O(new_n224_));
  nor2   g063(.a(new_n224_), .b(x01), .O(z28));
  nand4  g064(.a(new_n220_), .b(x47), .c(new_n212_), .d(new_n207_), .O(new_n226_));
  nor2   g065(.a(new_n226_), .b(x01), .O(z29));
  nand4  g066(.a(new_n220_), .b(x48), .c(new_n212_), .d(new_n207_), .O(new_n228_));
  nor2   g067(.a(new_n228_), .b(x01), .O(z30));
  aoi21  g068(.a(x83), .b(x42), .c(x81), .O(new_n233_));
  nand3  g069(.a(x83), .b(x81), .c(x42), .O(new_n234_));
  inv1   g070(.a(new_n234_), .O(new_n235_));
  oai21  g071(.a(new_n235_), .b(new_n233_), .c(new_n216_), .O(new_n236_));
  nand2  g072(.a(x83), .b(x42), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g074(.a(x83), .b(new_n215_), .c(x42), .O(new_n239_));
  nand2  g075(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n213_), .O(new_n241_));
  ...
  nand4  g082(.a(new_n242_), .b(x78), .c(x77), .d(x56), .O(new_n249_));
  nor3   g083(.a(new_n249_), .b(x04), .c(x01), .O(z38));
  nand4  g084(.a(new_n242_), .b(x78), .c(x77), .d(x60), .O(new_n254_));
  nor3   g085(.a(new_n254_), .b(x04), .c(x01), .O(z42));
  nand4  g086(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g087(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g088(.a(new_n242_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g089(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g091(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g092(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
  ...
  nand2  g136(.a(x52), .b(x22), .O(new_n307_));
  nand2  g137(.a(new_n267_), .b(x14), .O(new_n308_));
  aoi21  g138(.a(new_n308_), .b(new_n307_), .c(x79), .O(new_n309_));
  nand4  g139(.a(new_n309_), .b(x78), .c(new_n265_), .d(x04), .O(new_n310_));
  nor2   g140(.a(new_n310_), .b(x01), .O(z54));
  nor2   g141(.a(new_n271_), .b(x04), .O(new_n322_));
  nor2   g142(.a(new_n215_), .b(x78), .O(new_n323_));
  oai21  g143(.a(new_n323_), .b(new_n322_), .c(x77), .O(new_n324_));
  nand3  g144(.a(x81), .b(x78), .c(new_n265_), .O(new_n325_));
  nand2  g145(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  nand4  g146(.a(new_n326_), .b(x84), .c(x79), .d(new_n155_), .O(new_n327_));
