...
module FAU ( 
  ...
  nor2   g123(.a(new_n226_), .b(new_n239_), .O(new_n279_));
  ...
  nand4  g216(.a(x80), .b(new_n224_), .c(x43), .d(new_n239_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n227_), .c(new_n239_), .d(x40), .O(new_n377_));
  ...
  oai21  g223(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n383_));
  aoi21  g224(.a(new_n383_), .b(new_n382_), .c(x01), .O(z58));
  nor2   g225(.a(new_n160_), .b(new_n233_), .O(new_n385_));
  oai21  g226(.a(new_n385_), .b(new_n379_), .c(x40), .O(new_n386_));
  oai21  g227(.a(new_n227_), .b(new_n225_), .c(new_n239_), .O(new_n387_));
  ...
  nand2  g232(.a(new_n154_), .b(new_n233_), .O(new_n392_));
  ...
  nand3  g246(.a(x81), .b(x79), .c(new_n233_), .O(new_n406_));
