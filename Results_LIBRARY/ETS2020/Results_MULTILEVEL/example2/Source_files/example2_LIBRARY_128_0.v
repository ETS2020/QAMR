...
module FAU ( 
  ...
  nand4  g092(.a(new_n239_), .b(x78), .c(x77), .d(x61), .O(new_n258_));
  nor3   g093(.a(new_n258_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n239_), .b(x78), .c(x77), .d(x62), .O(new_n260_));
  nor3   g095(.a(new_n260_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n239_), .b(x78), .c(x77), .d(x63), .O(new_n262_));
  nor3   g097(.a(new_n262_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n239_), .b(x78), .c(x77), .d(x64), .O(new_n264_));
  ...
  nor2   g147(.a(new_n273_), .b(x04), .O(new_n324_));
  nor2   g148(.a(new_n212_), .b(x78), .O(new_n325_));
  oai21  g149(.a(new_n325_), .b(new_n324_), .c(x77), .O(new_n326_));
  nand3  g150(.a(x81), .b(x78), .c(new_n267_), .O(new_n327_));
  nand2  g151(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  nand4  g152(.a(new_n328_), .b(x84), .c(x79), .d(new_n155_), .O(new_n329_));
  inv1   g153(.a(new_n329_), .O(z65));
  zero   g154(.O(z00));
  zero   g155(.O(z01));
  zero   g156(.O(z02));
  zero   g157(.O(z08));
