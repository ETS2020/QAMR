...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n177_, new_n178_, new_n180_, new_n181_, new_n186_, new_n187_,
    ...
    new_n284_, new_n287_, new_n289_, new_n291_, new_n293_, new_n297_,
  ...
  nand2  g082(.a(new_n241_), .b(new_n238_), .O(new_n242_));
  nand4  g083(.a(new_n242_), .b(x79), .c(x78), .d(x77), .O(new_n243_));
  inv1   g084(.a(new_n243_), .O(new_n244_));
  nand4  g085(.a(new_n244_), .b(x44), .c(new_n236_), .d(new_n229_), .O(new_n245_));
  nor2   g086(.a(new_n245_), .b(x01), .O(z26));
  nand4  g087(.a(new_n244_), .b(x45), .c(new_n236_), .d(new_n229_), .O(new_n247_));
  nor2   g088(.a(new_n247_), .b(x01), .O(z27));
  nand4  g089(.a(new_n244_), .b(x46), .c(new_n236_), .d(new_n229_), .O(new_n249_));
  nor2   g090(.a(new_n249_), .b(x01), .O(z28));
  nand4  g091(.a(new_n244_), .b(x47), .c(new_n236_), .d(new_n229_), .O(new_n251_));
  nor2   g092(.a(new_n251_), .b(x01), .O(z29));
  nand4  g093(.a(new_n244_), .b(x48), .c(new_n236_), .d(new_n229_), .O(new_n253_));
  nor2   g094(.a(new_n253_), .b(x01), .O(z30));
  nand4  g095(.a(new_n244_), .b(x49), .c(new_n236_), .d(new_n229_), .O(new_n255_));
  nor2   g096(.a(new_n255_), .b(x01), .O(z31));
  nand4  g097(.a(new_n244_), .b(x50), .c(new_n236_), .d(new_n229_), .O(new_n257_));
  ...
  nand4  g125(.a(new_n280_), .b(x78), .c(x77), .d(x56), .O(new_n287_));
  nor3   g126(.a(new_n287_), .b(x04), .c(x01), .O(z38));
  nand4  g127(.a(new_n280_), .b(x78), .c(x77), .d(x57), .O(new_n289_));
  nor3   g128(.a(new_n289_), .b(x04), .c(x01), .O(z39));
  nand4  g129(.a(new_n280_), .b(x78), .c(x77), .d(x58), .O(new_n291_));
  nor3   g130(.a(new_n291_), .b(x04), .c(x01), .O(z40));
  nand4  g131(.a(new_n280_), .b(x78), .c(x77), .d(x59), .O(new_n293_));
  ...
  nand2  g195(.a(new_n231_), .b(x76), .O(new_n360_));
  ...
  oai21  g229(.a(new_n231_), .b(x04), .c(new_n393_), .O(new_n394_));
