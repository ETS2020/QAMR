...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n307_, new_n308_, new_n316_, new_n317_, new_n318_, new_n319_,
  ...
  nor2   g112(.a(new_n224_), .b(new_n238_), .O(new_n273_));
  ...
  nand2  g144(.a(x52), .b(x22), .O(new_n316_));
  nand2  g145(.a(new_n302_), .b(x14), .O(new_n317_));
  aoi21  g146(.a(new_n317_), .b(new_n316_), .c(x79), .O(new_n318_));
  nand4  g147(.a(new_n318_), .b(x78), .c(new_n159_), .d(x04), .O(new_n319_));
  nor2   g148(.a(new_n319_), .b(x01), .O(z54));
  inv1   g149(.a(x84), .O(new_n321_));
  nor2   g150(.a(x04), .b(x01), .O(new_n322_));
  nand4  g151(.a(new_n322_), .b(x79), .c(x78), .d(x77), .O(new_n323_));
  nor2   g152(.a(new_n323_), .b(x80), .O(new_n324_));
  nand2  g153(.a(new_n324_), .b(new_n241_), .O(new_n325_));
  nor4   g154(.a(new_n325_), .b(new_n321_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g155(.a(new_n234_), .b(x76), .O(new_n327_));
  inv1   g156(.a(new_n165_), .O(new_n328_));
  xnor2a g157(.a(x84), .b(x81), .O(new_n329_));
  aoi21  g158(.a(new_n167_), .b(new_n328_), .c(new_n329_), .O(new_n330_));
  nand2  g159(.a(new_n330_), .b(new_n153_), .O(new_n331_));
  nand2  g160(.a(new_n331_), .b(new_n327_), .O(new_n332_));
  nand2  g161(.a(new_n332_), .b(x79), .O(new_n333_));
  nand4  g162(.a(new_n333_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g163(.a(x02), .O(new_n335_));
  nand4  g164(.a(x03), .b(new_n335_), .c(new_n153_), .d(x00), .O(new_n336_));
  inv1   g165(.a(new_n336_), .O(z57));
  nand4  g166(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n338_));
  oai22  g167(.a(new_n338_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n339_));
  nand4  g168(.a(new_n339_), .b(x79), .c(x78), .d(x04), .O(new_n340_));
  nor2   g169(.a(x79), .b(x78), .O(new_n341_));
  nand3  g170(.a(new_n341_), .b(new_n238_), .c(x40), .O(new_n342_));
  nand2  g171(.a(new_n342_), .b(new_n340_), .O(new_n343_));
  nand2  g172(.a(new_n343_), .b(x77), .O(new_n344_));
  oai21  g173(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n345_));
  aoi21  g174(.a(new_n345_), .b(new_n344_), .c(x01), .O(z58));
  nor2   g175(.a(new_n160_), .b(new_n230_), .O(new_n347_));
  oai21  g176(.a(new_n347_), .b(new_n341_), .c(x40), .O(new_n348_));
  oai21  g177(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n349_));
  nand2  g178(.a(new_n349_), .b(x79), .O(new_n350_));
  nand3  g179(.a(new_n350_), .b(x78), .c(x04), .O(new_n351_));
  nand2  g180(.a(new_n351_), .b(new_n348_), .O(new_n352_));
  nand2  g181(.a(new_n352_), .b(x77), .O(new_n353_));
  nand2  g182(.a(new_n154_), .b(new_n230_), .O(new_n354_));
  aoi21  g183(.a(new_n354_), .b(new_n353_), .c(x01), .O(z59));
  nand2  g184(.a(new_n330_), .b(x79), .O(new_n356_));
  nand3  g185(.a(new_n356_), .b(new_n354_), .c(new_n228_), .O(new_n357_));
  and2   g186(.a(new_n357_), .b(new_n153_), .O(z60));
  nand2  g187(.a(new_n167_), .b(new_n328_), .O(new_n359_));
  nand2  g188(.a(new_n359_), .b(new_n220_), .O(new_n360_));
  oai21  g189(.a(new_n234_), .b(x04), .c(new_n360_), .O(new_n361_));
  nand4  g190(.a(new_n361_), .b(x80), .c(x79), .d(new_n153_), .O(new_n362_));
  inv1   g191(.a(new_n362_), .O(z61));
  nand2  g192(.a(new_n154_), .b(x04), .O(new_n364_));
  nand3  g193(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  aoi21  g194(.a(new_n365_), .b(new_n364_), .c(x77), .O(new_n366_));
  nand2  g195(.a(new_n350_), .b(x04), .O(new_n367_));
  nand3  g196(.a(x81), .b(x79), .c(new_n230_), .O(new_n368_));
  aoi21  g197(.a(new_n368_), .b(new_n367_), .c(new_n159_), .O(new_n369_));
  oai21  g198(.a(new_n369_), .b(new_n366_), .c(x78), .O(new_n370_));
  or2    g199(.a(new_n365_), .b(new_n167_), .O(new_n371_));
  aoi21  g200(.a(new_n371_), .b(new_n370_), .c(x01), .O(z62));
  nand4  g201(.a(new_n361_), .b(x82), .c(x79), .d(new_n153_), .O(new_n373_));
  inv1   g202(.a(new_n373_), .O(z63));
  nand3  g203(.a(new_n361_), .b(x83), .c(x79), .O(new_n375_));
  nand4  g204(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n376_));
  aoi21  g205(.a(new_n376_), .b(new_n375_), .c(x01), .O(z64));
  nor2   g206(.a(new_n160_), .b(x04), .O(new_n378_));
  nor2   g207(.a(new_n241_), .b(x78), .O(new_n379_));
  oai21  g208(.a(new_n379_), .b(new_n378_), .c(x77), .O(new_n380_));
  nand3  g209(.a(x81), .b(x78), .c(new_n159_), .O(new_n381_));
  nand2  g210(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  nand4  g211(.a(new_n382_), .b(x84), .c(x79), .d(new_n153_), .O(new_n383_));
  inv1   g212(.a(new_n383_), .O(z65));
  zero   g213(.O(z05));
  zero   g214(.O(z06));
  zero   g215(.O(z14));
  zero   g216(.O(z16));
