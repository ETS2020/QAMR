...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n237_, new_n239_, new_n241_, new_n243_, new_n246_, new_n248_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n275_, new_n277_,
    new_n280_, new_n282_, new_n284_, new_n288_, new_n290_, new_n292_,
    new_n295_, new_n296_, new_n297_, new_n298_, new_n299_, new_n300_,
    new_n301_, new_n302_, new_n305_, new_n306_, new_n307_, new_n308_,
    new_n309_, new_n310_, new_n317_, new_n318_, new_n319_, new_n320_,
  ...
  nand4  g087(.a(new_n236_), .b(x49), .c(new_n228_), .d(new_n220_), .O(new_n248_));
  nor2   g088(.a(new_n248_), .b(x01), .O(z31));
  nand2  g089(.a(x83), .b(new_n231_), .O(new_n251_));
  nand2  g090(.a(new_n214_), .b(x81), .O(new_n252_));
  nand2  g091(.a(new_n252_), .b(new_n251_), .O(new_n253_));
  nand3  g092(.a(new_n253_), .b(x42), .c(x05), .O(new_n254_));
  nand3  g093(.a(x81), .b(x51), .c(new_n228_), .O(new_n255_));
  nand2  g094(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand2  g095(.a(new_n256_), .b(new_n229_), .O(new_n257_));
  xnor2a g096(.a(x83), .b(x81), .O(new_n258_));
  nand3  g097(.a(new_n258_), .b(x42), .c(x05), .O(new_n259_));
  nand3  g098(.a(new_n231_), .b(x51), .c(new_n228_), .O(new_n260_));
  nand2  g099(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand2  g100(.a(new_n261_), .b(new_n232_), .O(new_n262_));
  aoi21  g101(.a(new_n262_), .b(new_n257_), .c(new_n156_), .O(new_n263_));
  nand4  g102(.a(new_n263_), .b(x78), .c(x77), .d(new_n220_), .O(new_n264_));
  nor2   g103(.a(new_n264_), .b(x01), .O(z33));
  nor2   g104(.a(new_n214_), .b(new_n228_), .O(new_n266_));
  nand3  g105(.a(x83), .b(x81), .c(x42), .O(new_n267_));
  oai21  g106(.a(new_n266_), .b(x81), .c(new_n267_), .O(new_n268_));
  nand2  g107(.a(new_n268_), .b(new_n232_), .O(new_n269_));
  oai22  g108(.a(new_n266_), .b(new_n231_), .c(new_n251_), .d(new_n228_), .O(new_n270_));
  nand2  g109(.a(new_n270_), .b(new_n229_), .O(new_n271_));
  aoi21  g110(.a(new_n271_), .b(new_n269_), .c(new_n156_), .O(new_n272_));
  nand4  g111(.a(new_n272_), .b(x78), .c(x77), .d(x52), .O(new_n273_));
  nor3   g112(.a(new_n273_), .b(x04), .c(x01), .O(z34));
  nand4  g113(.a(new_n272_), .b(x78), .c(x77), .d(x53), .O(new_n275_));
  nor3   g114(.a(new_n275_), .b(x04), .c(x01), .O(z35));
  nand4  g115(.a(new_n272_), .b(x78), .c(x77), .d(x54), .O(new_n277_));
  nor3   g116(.a(new_n277_), .b(x04), .c(x01), .O(z36));
  nand4  g117(.a(new_n272_), .b(x78), .c(x77), .d(x56), .O(new_n280_));
  nor3   g118(.a(new_n280_), .b(x04), .c(x01), .O(z38));
  nand4  g119(.a(new_n272_), .b(x78), .c(x77), .d(x57), .O(new_n282_));
  nor3   g120(.a(new_n282_), .b(x04), .c(x01), .O(z39));
  nand4  g121(.a(new_n272_), .b(x78), .c(x77), .d(x58), .O(new_n284_));
  nor3   g122(.a(new_n284_), .b(x04), .c(x01), .O(z40));
  nand4  g123(.a(new_n272_), .b(x78), .c(x77), .d(x61), .O(new_n288_));
  nor3   g124(.a(new_n288_), .b(x04), .c(x01), .O(z43));
  nand4  g125(.a(new_n272_), .b(x78), .c(x77), .d(x62), .O(new_n290_));
  nor3   g126(.a(new_n290_), .b(x04), .c(x01), .O(z44));
  nand4  g127(.a(new_n272_), .b(x78), .c(x77), .d(x63), .O(new_n292_));
  nor3   g128(.a(new_n292_), .b(x04), .c(x01), .O(z45));
  nand2  g129(.a(x52), .b(x15), .O(new_n295_));
  inv1   g130(.a(x52), .O(new_n296_));
  nand2  g131(.a(new_n296_), .b(x07), .O(new_n297_));
  aoi21  g132(.a(new_n297_), .b(new_n295_), .c(x79), .O(new_n298_));
  nand4  g133(.a(new_n298_), .b(x78), .c(new_n153_), .d(x04), .O(new_n299_));
  nor2   g134(.a(x75), .b(x67), .O(new_n300_));
  nor2   g135(.a(new_n300_), .b(new_n209_), .O(new_n301_));
  nand4  g136(.a(new_n301_), .b(x79), .c(new_n154_), .d(x77), .O(new_n302_));
  aoi21  g137(.a(new_n302_), .b(new_n299_), .c(x01), .O(z47));
  nand2  g138(.a(x52), .b(x17), .O(new_n305_));
  nand2  g139(.a(new_n296_), .b(x09), .O(new_n306_));
  aoi21  g140(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g141(.a(new_n307_), .b(x78), .c(new_n153_), .d(x04), .O(new_n308_));
  nor2   g142(.a(new_n209_), .b(new_n156_), .O(new_n309_));
  nand4  g143(.a(new_n309_), .b(new_n154_), .c(x77), .d(x69), .O(new_n310_));
  aoi21  g144(.a(new_n310_), .b(new_n308_), .c(x01), .O(z49));
  ...
  nand2  g149(.a(new_n320_), .b(new_n231_), .O(new_n321_));
  nor4   g150(.a(new_n321_), .b(new_n317_), .c(new_n214_), .d(x82), .O(z55));
  nand2  g151(.a(new_n224_), .b(x76), .O(new_n323_));
  ...
  nand4  g162(.a(x80), .b(new_n212_), .c(x43), .d(new_n228_), .O(new_n334_));
  oai22  g163(.a(new_n334_), .b(new_n215_), .c(new_n228_), .d(x40), .O(new_n335_));
  nand4  g164(.a(new_n335_), .b(x79), .c(x78), .d(x04), .O(new_n336_));
  nor2   g165(.a(x79), .b(x78), .O(new_n337_));
  nand3  g166(.a(new_n337_), .b(new_n228_), .c(x40), .O(new_n338_));
  nand2  g167(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  nand2  g168(.a(new_n339_), .b(x77), .O(new_n340_));
  oai21  g169(.a(new_n161_), .b(new_n220_), .c(new_n156_), .O(new_n341_));
  aoi21  g170(.a(new_n341_), .b(new_n340_), .c(x01), .O(z58));
  nor2   g171(.a(new_n154_), .b(new_n220_), .O(new_n343_));
  oai21  g172(.a(new_n343_), .b(new_n337_), .c(x40), .O(new_n344_));
  oai21  g173(.a(new_n215_), .b(new_n213_), .c(new_n228_), .O(new_n345_));
  ...
  nand2  g178(.a(new_n156_), .b(new_n220_), .O(new_n350_));
  aoi21  g179(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g180(.a(new_n326_), .b(x79), .O(new_n352_));
  nand3  g181(.a(new_n352_), .b(new_n350_), .c(new_n218_), .O(new_n353_));
  and2   g182(.a(new_n353_), .b(new_n159_), .O(z60));
  nand2  g183(.a(new_n163_), .b(new_n324_), .O(new_n355_));
  nand2  g184(.a(new_n355_), .b(new_n210_), .O(new_n356_));
  oai21  g185(.a(new_n224_), .b(x04), .c(new_n356_), .O(new_n357_));
  ...
  nand3  g192(.a(x81), .b(x79), .c(new_n220_), .O(new_n364_));
  ...
  nor2   g203(.a(new_n231_), .b(x78), .O(new_n375_));
