...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n185_, new_n189_, new_n190_, new_n192_, new_n193_, new_n197_,
    ...
    new_n244_, new_n246_, new_n250_, new_n252_, new_n254_, new_n256_,
    ...
    new_n288_, new_n291_, new_n293_, new_n298_, new_n299_, new_n300_,
  ...
  nand4  g089(.a(new_n241_), .b(x48), .c(new_n233_), .d(new_n225_), .O(new_n250_));
  ...
  nor2   g110(.a(new_n219_), .b(new_n233_), .O(new_n272_));
  ...
  nand4  g119(.a(new_n278_), .b(x78), .c(x77), .d(x55), .O(new_n282_));
  nor3   g120(.a(new_n282_), .b(x04), .c(x01), .O(z37));
  nand4  g121(.a(new_n278_), .b(x78), .c(x77), .d(x56), .O(new_n284_));
  ...
  nand4  g129(.a(new_n278_), .b(x78), .c(x77), .d(x61), .O(new_n293_));
  ...
  nand2  g187(.a(new_n353_), .b(new_n236_), .O(new_n354_));
  nor4   g188(.a(new_n354_), .b(new_n350_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g189(.a(new_n229_), .b(x76), .O(new_n356_));
  ...
  nand4  g200(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n367_));
  oai22  g201(.a(new_n367_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n368_));
  nand4  g202(.a(new_n368_), .b(x79), .c(x78), .d(x04), .O(new_n369_));
  nor2   g203(.a(x79), .b(x78), .O(new_n370_));
  nand3  g204(.a(new_n370_), .b(new_n233_), .c(x40), .O(new_n371_));
  ...
  oai21  g211(.a(new_n220_), .b(new_n218_), .c(new_n233_), .O(new_n378_));
  ...
  oai21  g223(.a(new_n229_), .b(x04), .c(new_n389_), .O(new_n390_));
  ...
  nor2   g241(.a(new_n236_), .b(x78), .O(new_n408_));
