...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n357_, new_n358_, new_n361_, new_n363_, new_n364_, new_n366_,
  ...
  nand2  g071(.a(x78), .b(x77), .O(new_n229_));
  aoi21  g072(.a(new_n229_), .b(x79), .c(x43), .O(new_n230_));
  nand3  g073(.a(new_n230_), .b(x05), .c(new_n226_), .O(new_n231_));
  ...
  nand4  g084(.a(new_n241_), .b(new_n233_), .c(x05), .d(new_n226_), .O(new_n242_));
  nor2   g085(.a(new_n242_), .b(x01), .O(z25));
  nand4  g086(.a(new_n241_), .b(x44), .c(new_n233_), .d(new_n226_), .O(new_n244_));
  nor2   g087(.a(new_n244_), .b(x01), .O(z26));
  nand4  g088(.a(new_n241_), .b(x46), .c(new_n233_), .d(new_n226_), .O(new_n247_));
  nor2   g089(.a(new_n247_), .b(x01), .O(z28));
  nand4  g090(.a(new_n241_), .b(x47), .c(new_n233_), .d(new_n226_), .O(new_n249_));
  nor2   g091(.a(new_n249_), .b(x01), .O(z29));
  nand4  g092(.a(new_n241_), .b(x48), .c(new_n233_), .d(new_n226_), .O(new_n251_));
  nor2   g093(.a(new_n251_), .b(x01), .O(z30));
  xor2a  g094(.a(x83), .b(x81), .O(new_n255_));
  nand3  g095(.a(new_n255_), .b(x42), .c(x05), .O(new_n256_));
  nand3  g096(.a(x81), .b(x51), .c(new_n233_), .O(new_n257_));
  nand2  g097(.a(new_n257_), .b(new_n256_), .O(new_n258_));
  nand2  g098(.a(new_n258_), .b(new_n234_), .O(new_n259_));
  xnor2a g099(.a(x83), .b(x81), .O(new_n260_));
  nand3  g100(.a(new_n260_), .b(x42), .c(x05), .O(new_n261_));
  nand3  g101(.a(new_n236_), .b(x51), .c(new_n233_), .O(new_n262_));
  nand2  g102(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  nand2  g103(.a(new_n263_), .b(new_n237_), .O(new_n264_));
  aoi21  g104(.a(new_n264_), .b(new_n259_), .c(new_n154_), .O(new_n265_));
  nand4  g105(.a(new_n265_), .b(x78), .c(x77), .d(new_n226_), .O(new_n266_));
  nor2   g106(.a(new_n266_), .b(x01), .O(z33));
  aoi21  g107(.a(x83), .b(x42), .c(x81), .O(new_n269_));
  nand3  g108(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  inv1   g109(.a(new_n270_), .O(new_n271_));
  oai21  g110(.a(new_n271_), .b(new_n269_), .c(new_n237_), .O(new_n272_));
  nand2  g111(.a(x83), .b(x42), .O(new_n273_));
  nand2  g112(.a(new_n273_), .b(x81), .O(new_n274_));
  nand3  g113(.a(x83), .b(new_n236_), .c(x42), .O(new_n275_));
  nand2  g114(.a(new_n275_), .b(new_n274_), .O(new_n276_));
  nand2  g115(.a(new_n276_), .b(new_n234_), .O(new_n277_));
  aoi21  g116(.a(new_n277_), .b(new_n272_), .c(new_n154_), .O(new_n278_));
  ...
  nor4   g155(.a(new_n323_), .b(new_n319_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g156(.a(new_n229_), .b(x76), .O(new_n325_));
  xnor2a g157(.a(x84), .b(x81), .O(new_n326_));
  aoi21  g158(.a(new_n167_), .b(new_n166_), .c(new_n326_), .O(new_n327_));
  nand2  g159(.a(new_n327_), .b(new_n153_), .O(new_n328_));
  nand2  g160(.a(new_n328_), .b(new_n325_), .O(new_n329_));
  nand2  g161(.a(new_n329_), .b(x79), .O(new_n330_));
  nand4  g162(.a(new_n330_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g163(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n333_));
  oai22  g164(.a(new_n333_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n334_));
  nand4  g165(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g166(.a(x79), .b(x78), .O(new_n336_));
  nand3  g167(.a(new_n336_), .b(new_n233_), .c(x40), .O(new_n337_));
  nand2  g168(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g169(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g170(.a(new_n166_), .b(x04), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n154_), .O(new_n341_));
  aoi21  g172(.a(new_n341_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g173(.a(new_n160_), .b(new_n226_), .O(new_n343_));
  oai21  g174(.a(new_n343_), .b(new_n336_), .c(x40), .O(new_n344_));
  oai21  g175(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n345_));
  ...
  nand2  g180(.a(new_n154_), .b(new_n226_), .O(new_n350_));
  aoi21  g181(.a(new_n350_), .b(new_n349_), .c(x01), .O(z59));
  nand2  g182(.a(new_n327_), .b(x79), .O(new_n352_));
  nand3  g183(.a(new_n352_), .b(new_n350_), .c(new_n224_), .O(new_n353_));
  and2   g184(.a(new_n353_), .b(new_n153_), .O(z60));
  nand2  g185(.a(new_n167_), .b(new_n166_), .O(new_n355_));
  nand2  g186(.a(new_n355_), .b(new_n216_), .O(new_n356_));
  oai21  g187(.a(new_n229_), .b(x04), .c(new_n356_), .O(new_n357_));
  nand4  g188(.a(new_n357_), .b(x80), .c(x79), .d(new_n153_), .O(new_n358_));
  inv1   g189(.a(new_n358_), .O(z61));
  nand4  g190(.a(new_n357_), .b(x82), .c(x79), .d(new_n153_), .O(new_n361_));
  inv1   g191(.a(new_n361_), .O(z63));
  nand3  g192(.a(new_n357_), .b(x83), .c(x79), .O(new_n363_));
  nand4  g193(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n364_));
  aoi21  g194(.a(new_n364_), .b(new_n363_), .c(x01), .O(z64));
  nor2   g195(.a(new_n160_), .b(x04), .O(new_n366_));
  nor2   g196(.a(new_n236_), .b(x78), .O(new_n367_));
  oai21  g197(.a(new_n367_), .b(new_n366_), .c(x77), .O(new_n368_));
  nand3  g198(.a(x81), .b(x78), .c(new_n159_), .O(new_n369_));
  nand2  g199(.a(new_n369_), .b(new_n368_), .O(new_n370_));
  nand4  g200(.a(new_n370_), .b(x84), .c(x79), .d(new_n153_), .O(new_n371_));
  inv1   g201(.a(new_n371_), .O(z65));
  zero   g202(.O(z05));
  zero   g203(.O(z08));
  zero   g204(.O(z09));
  zero   g205(.O(z12));
