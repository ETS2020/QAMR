...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n293_, new_n295_, new_n298_, new_n304_, new_n305_, new_n306_,
  ...
  nand2  g191(.a(new_n355_), .b(new_n243_), .O(new_n356_));
  nor4   g192(.a(new_n356_), .b(new_n352_), .c(new_n226_), .d(x82), .O(z55));
  nand2  g193(.a(new_n236_), .b(x76), .O(new_n358_));
  ...
  nand4  g204(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n369_));
  oai22  g205(.a(new_n369_), .b(new_n227_), .c(new_n240_), .d(x40), .O(new_n370_));
  nand4  g206(.a(new_n370_), .b(x79), .c(x78), .d(x04), .O(new_n371_));
  nor2   g207(.a(x79), .b(x78), .O(new_n372_));
  nand3  g208(.a(new_n372_), .b(new_n240_), .c(x40), .O(new_n373_));
  nand2  g209(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand2  g210(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g211(.a(new_n165_), .b(new_n232_), .c(new_n154_), .O(new_n376_));
  aoi21  g212(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  nor2   g213(.a(new_n160_), .b(new_n232_), .O(new_n378_));
  oai21  g214(.a(new_n378_), .b(new_n372_), .c(x40), .O(new_n379_));
  oai21  g215(.a(new_n227_), .b(new_n225_), .c(new_n240_), .O(new_n380_));
  ...
  nand2  g220(.a(new_n154_), .b(new_n232_), .O(new_n385_));
  aoi21  g221(.a(new_n385_), .b(new_n384_), .c(x01), .O(z59));
  nand2  g222(.a(new_n361_), .b(x79), .O(new_n387_));
  nand3  g223(.a(new_n387_), .b(new_n385_), .c(new_n230_), .O(new_n388_));
  and2   g224(.a(new_n388_), .b(new_n153_), .O(z60));
  nand2  g225(.a(new_n167_), .b(new_n359_), .O(new_n390_));
  nand2  g226(.a(new_n390_), .b(new_n222_), .O(new_n391_));
  oai21  g227(.a(new_n236_), .b(x04), .c(new_n391_), .O(new_n392_));
  ...
  nand3  g234(.a(x81), .b(x79), .c(new_n232_), .O(new_n399_));
  ...
  nor2   g245(.a(new_n243_), .b(x78), .O(new_n410_));
