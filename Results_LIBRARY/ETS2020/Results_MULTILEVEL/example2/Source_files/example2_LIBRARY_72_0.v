...
module FAU ( 
  ...
  aoi21  g071(.a(x83), .b(x42), .c(x81), .O(new_n234_));
  nand3  g072(.a(x83), .b(x81), .c(x42), .O(new_n235_));
  inv1   g073(.a(new_n235_), .O(new_n236_));
  oai21  g074(.a(new_n236_), .b(new_n234_), .c(new_n213_), .O(new_n237_));
  nand2  g075(.a(x83), .b(x42), .O(new_n238_));
  nand2  g076(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g077(.a(x83), .b(new_n212_), .c(x42), .O(new_n240_));
  nand2  g078(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g079(.a(new_n241_), .b(new_n210_), .O(new_n242_));
  aoi21  g080(.a(new_n242_), .b(new_n237_), .c(new_n156_), .O(new_n243_));
  nand4  g081(.a(new_n243_), .b(x78), .c(x77), .d(x52), .O(new_n244_));
  nor3   g082(.a(new_n244_), .b(x04), .c(x01), .O(z34));
  nand4  g083(.a(new_n243_), .b(x78), .c(x77), .d(x54), .O(new_n247_));
  nor3   g084(.a(new_n247_), .b(x04), .c(x01), .O(z36));
  nand4  g085(.a(new_n243_), .b(x78), .c(x77), .d(x55), .O(new_n249_));
  nor3   g086(.a(new_n249_), .b(x04), .c(x01), .O(z37));
  nand4  g087(.a(new_n243_), .b(x78), .c(x77), .d(x56), .O(new_n251_));
