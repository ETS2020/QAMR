...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n199_, new_n200_, new_n203_, new_n204_, new_n207_,
    new_n208_, new_n210_, new_n211_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n225_, new_n226_, new_n228_, new_n229_,
    new_n230_, new_n231_, new_n233_, new_n234_, new_n235_, new_n236_,
    new_n237_, new_n238_, new_n239_, new_n240_, new_n241_, new_n242_,
    new_n244_, new_n246_, new_n248_, new_n252_, new_n254_, new_n256_,
  ...
  nor2   g110(.a(new_n219_), .b(new_n233_), .O(new_n275_));
  nand3  g111(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  oai21  g112(.a(new_n275_), .b(x81), .c(new_n276_), .O(new_n277_));
  nand2  g113(.a(new_n277_), .b(new_n237_), .O(new_n278_));
  oai22  g114(.a(new_n275_), .b(new_n236_), .c(new_n256_), .d(new_n233_), .O(new_n279_));
  nand2  g115(.a(new_n279_), .b(new_n234_), .O(new_n280_));
  ...
  nand4  g125(.a(new_n281_), .b(x78), .c(x77), .d(x61), .O(new_n291_));
  ...
  nand4  g140(.a(new_n215_), .b(x79), .c(new_n160_), .d(x77), .O(new_n309_));
  ...
  nand2  g183(.a(new_n351_), .b(new_n236_), .O(new_n352_));
  nor4   g184(.a(new_n352_), .b(new_n348_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g185(.a(new_n229_), .b(x76), .O(new_n354_));
  ...
  nand4  g196(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n365_));
  oai22  g197(.a(new_n365_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n366_));
  nand4  g198(.a(new_n366_), .b(x79), .c(x78), .d(x04), .O(new_n367_));
  nor2   g199(.a(x79), .b(x78), .O(new_n368_));
  nand3  g200(.a(new_n368_), .b(new_n233_), .c(x40), .O(new_n369_));
  nand2  g201(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g202(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g203(.a(new_n165_), .b(new_n225_), .c(new_n154_), .O(new_n372_));
  aoi21  g204(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  nor2   g205(.a(new_n160_), .b(new_n225_), .O(new_n374_));
  oai21  g206(.a(new_n374_), .b(new_n368_), .c(x40), .O(new_n375_));
  oai21  g207(.a(new_n220_), .b(new_n218_), .c(new_n233_), .O(new_n376_));
  ...
  nand2  g212(.a(new_n154_), .b(new_n225_), .O(new_n381_));
  aoi21  g213(.a(new_n381_), .b(new_n380_), .c(x01), .O(z59));
  nand2  g214(.a(new_n357_), .b(x79), .O(new_n383_));
  nand3  g215(.a(new_n383_), .b(new_n381_), .c(new_n223_), .O(new_n384_));
  and2   g216(.a(new_n384_), .b(new_n153_), .O(z60));
  nand2  g217(.a(new_n167_), .b(new_n355_), .O(new_n386_));
  nand2  g218(.a(new_n386_), .b(new_n215_), .O(new_n387_));
  oai21  g219(.a(new_n229_), .b(x04), .c(new_n387_), .O(new_n388_));
  ...
  nand3  g226(.a(x81), .b(x79), .c(new_n225_), .O(new_n395_));
  ...
  nor2   g237(.a(new_n236_), .b(x78), .O(new_n406_));
