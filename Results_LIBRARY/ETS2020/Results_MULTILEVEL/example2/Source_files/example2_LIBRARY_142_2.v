...
module FAU ( 
  ...
  nand4  g084(.a(new_n238_), .b(x46), .c(new_n230_), .d(new_n224_), .O(new_n245_));
  nor2   g085(.a(new_n245_), .b(x01), .O(z28));
  nand4  g086(.a(new_n238_), .b(x47), .c(new_n230_), .d(new_n224_), .O(new_n247_));
  nor2   g087(.a(new_n247_), .b(x01), .O(z29));
  nand4  g088(.a(new_n238_), .b(x49), .c(new_n230_), .d(new_n224_), .O(new_n250_));
  nor2   g089(.a(new_n250_), .b(x01), .O(z31));
  nand4  g090(.a(new_n238_), .b(x50), .c(new_n230_), .d(new_n224_), .O(new_n252_));
  nor2   g091(.a(new_n252_), .b(x01), .O(z32));
  nand2  g092(.a(x83), .b(new_n233_), .O(new_n254_));
  nand2  g093(.a(new_n217_), .b(x81), .O(new_n255_));
  ...
  nor2   g107(.a(new_n217_), .b(new_n230_), .O(new_n269_));
  ...
  nand4  g120(.a(new_n275_), .b(x78), .c(x77), .d(x56), .O(new_n283_));
  ...
  nand2  g139(.a(x52), .b(x16), .O(new_n306_));
  nand2  g140(.a(new_n298_), .b(x08), .O(new_n307_));
  aoi21  g141(.a(new_n307_), .b(new_n306_), .c(x79), .O(new_n308_));
  nand4  g142(.a(new_n308_), .b(x78), .c(new_n159_), .d(x04), .O(new_n309_));
  nand4  g143(.a(new_n213_), .b(x79), .c(new_n160_), .d(x77), .O(new_n310_));
  inv1   g144(.a(new_n310_), .O(new_n311_));
  nand2  g145(.a(new_n311_), .b(x68), .O(new_n312_));
  aoi21  g146(.a(new_n312_), .b(new_n309_), .c(x01), .O(z48));
  nand2  g147(.a(x52), .b(x17), .O(new_n314_));
  nand2  g148(.a(new_n298_), .b(x09), .O(new_n315_));
  aoi21  g149(.a(new_n315_), .b(new_n314_), .c(x79), .O(new_n316_));
  nand4  g150(.a(new_n316_), .b(x78), .c(new_n159_), .d(x04), .O(new_n317_));
  nand2  g151(.a(new_n311_), .b(x69), .O(new_n318_));
  aoi21  g152(.a(new_n318_), .b(new_n317_), .c(x01), .O(z49));
  nand2  g153(.a(x52), .b(x18), .O(new_n320_));
  nand2  g154(.a(new_n298_), .b(x10), .O(new_n321_));
  aoi21  g155(.a(new_n321_), .b(new_n320_), .c(x79), .O(new_n322_));
  nand4  g156(.a(new_n322_), .b(x78), .c(new_n159_), .d(x04), .O(new_n323_));
  nand2  g157(.a(new_n311_), .b(x70), .O(new_n324_));
  aoi21  g158(.a(new_n324_), .b(new_n323_), .c(x01), .O(z50));
  nand2  g159(.a(x52), .b(x19), .O(new_n326_));
  nand2  g160(.a(new_n298_), .b(x11), .O(new_n327_));
  aoi21  g161(.a(new_n327_), .b(new_n326_), .c(x79), .O(new_n328_));
  nand4  g162(.a(new_n328_), .b(x78), .c(new_n159_), .d(x04), .O(new_n329_));
  nand2  g163(.a(new_n311_), .b(x71), .O(new_n330_));
  aoi21  g164(.a(new_n330_), .b(new_n329_), .c(x01), .O(z51));
  nand2  g165(.a(x52), .b(x20), .O(new_n332_));
  nand2  g166(.a(new_n298_), .b(x12), .O(new_n333_));
  aoi21  g167(.a(new_n333_), .b(new_n332_), .c(x79), .O(new_n334_));
  nand4  g168(.a(new_n334_), .b(x78), .c(new_n159_), .d(x04), .O(new_n335_));
  nand2  g169(.a(new_n311_), .b(x72), .O(new_n336_));
  aoi21  g170(.a(new_n336_), .b(new_n335_), .c(x01), .O(z52));
  nand2  g171(.a(x52), .b(x21), .O(new_n338_));
  nand2  g172(.a(new_n298_), .b(x13), .O(new_n339_));
  aoi21  g173(.a(new_n339_), .b(new_n338_), .c(x79), .O(new_n340_));
  nand4  g174(.a(new_n340_), .b(x78), .c(new_n159_), .d(x04), .O(new_n341_));
  nand2  g175(.a(new_n311_), .b(x73), .O(new_n342_));
  aoi21  g176(.a(new_n342_), .b(new_n341_), .c(x01), .O(z53));
  nand2  g177(.a(x52), .b(x22), .O(new_n344_));
  nand2  g178(.a(new_n298_), .b(x14), .O(new_n345_));
  aoi21  g179(.a(new_n345_), .b(new_n344_), .c(x79), .O(new_n346_));
  nand4  g180(.a(new_n346_), .b(x78), .c(new_n159_), .d(x04), .O(new_n347_));
  nor2   g181(.a(new_n347_), .b(x01), .O(z54));
  inv1   g182(.a(x84), .O(new_n349_));
  nor2   g183(.a(x04), .b(x01), .O(new_n350_));
  nand4  g184(.a(new_n350_), .b(x79), .c(x78), .d(x77), .O(new_n351_));
  nor2   g185(.a(new_n351_), .b(x80), .O(new_n352_));
  nand2  g186(.a(new_n352_), .b(new_n233_), .O(new_n353_));
  nor4   g187(.a(new_n353_), .b(new_n349_), .c(new_n217_), .d(x82), .O(z55));
  nand2  g188(.a(new_n226_), .b(x76), .O(new_n355_));
  inv1   g189(.a(new_n165_), .O(new_n356_));
  xnor2a g190(.a(x84), .b(x81), .O(new_n357_));
  aoi21  g191(.a(new_n167_), .b(new_n356_), .c(new_n357_), .O(new_n358_));
  nand2  g192(.a(new_n358_), .b(new_n153_), .O(new_n359_));
  nand2  g193(.a(new_n359_), .b(new_n355_), .O(new_n360_));
  nand2  g194(.a(new_n360_), .b(x79), .O(new_n361_));
  nand4  g195(.a(new_n361_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g196(.a(x02), .O(new_n363_));
  nand4  g197(.a(x03), .b(new_n363_), .c(new_n153_), .d(x00), .O(new_n364_));
  inv1   g198(.a(new_n364_), .O(z57));
  nand4  g199(.a(x80), .b(new_n215_), .c(x43), .d(new_n230_), .O(new_n366_));
  oai22  g200(.a(new_n366_), .b(new_n218_), .c(new_n230_), .d(x40), .O(new_n367_));
  nand4  g201(.a(new_n367_), .b(x79), .c(x78), .d(x04), .O(new_n368_));
  nor2   g202(.a(x79), .b(x78), .O(new_n369_));
  nand3  g203(.a(new_n369_), .b(new_n230_), .c(x40), .O(new_n370_));
  nand2  g204(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g205(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g206(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n373_));
  aoi21  g207(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  nor2   g208(.a(new_n160_), .b(new_n224_), .O(new_n375_));
  oai21  g209(.a(new_n375_), .b(new_n369_), .c(x40), .O(new_n376_));
  oai21  g210(.a(new_n218_), .b(new_n216_), .c(new_n230_), .O(new_n377_));
  ...
  nand2  g215(.a(new_n154_), .b(new_n224_), .O(new_n382_));
  aoi21  g216(.a(new_n382_), .b(new_n381_), .c(x01), .O(z59));
  nand2  g217(.a(new_n358_), .b(x79), .O(new_n384_));
  nand3  g218(.a(new_n384_), .b(new_n382_), .c(new_n221_), .O(new_n385_));
  and2   g219(.a(new_n385_), .b(new_n153_), .O(z60));
  nand2  g220(.a(new_n167_), .b(new_n356_), .O(new_n387_));
  nand2  g221(.a(new_n387_), .b(new_n213_), .O(new_n388_));
  oai21  g222(.a(new_n226_), .b(x04), .c(new_n388_), .O(new_n389_));
  ...
  nand3  g229(.a(x81), .b(x79), .c(new_n224_), .O(new_n396_));
