...
module FAU ( 
  ...
  nand4  g144(.a(new_n286_), .b(x78), .c(x77), .d(x60), .O(new_n302_));
  nor3   g145(.a(new_n302_), .b(x04), .c(x01), .O(z42));
  nand4  g146(.a(new_n286_), .b(x78), .c(x77), .d(x61), .O(new_n304_));
  nor3   g147(.a(new_n304_), .b(x04), .c(x01), .O(z43));
  nand4  g148(.a(new_n286_), .b(x78), .c(x77), .d(x62), .O(new_n306_));
  nor3   g149(.a(new_n306_), .b(x04), .c(x01), .O(z44));
  nand4  g150(.a(new_n286_), .b(x78), .c(x77), .d(x63), .O(new_n308_));
  nor3   g151(.a(new_n308_), .b(x04), .c(x01), .O(z45));
  nand4  g152(.a(new_n286_), .b(x78), .c(x77), .d(x64), .O(new_n310_));
