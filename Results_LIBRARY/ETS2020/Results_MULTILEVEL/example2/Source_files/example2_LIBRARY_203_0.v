...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n307_, new_n320_, new_n321_, new_n322_, new_n323_, new_n324_,
    new_n325_;
  ...
  nor2   g141(.a(new_n273_), .b(x04), .O(new_n320_));
  nor2   g142(.a(new_n214_), .b(x78), .O(new_n321_));
  oai21  g143(.a(new_n321_), .b(new_n320_), .c(x77), .O(new_n322_));
  nand3  g144(.a(x81), .b(x78), .c(new_n267_), .O(new_n323_));
  nand2  g145(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  nand4  g146(.a(new_n324_), .b(x84), .c(x79), .d(new_n155_), .O(new_n325_));
  inv1   g147(.a(new_n325_), .O(z65));
  zero   g148(.O(z00));
  zero   g149(.O(z01));
  zero   g150(.O(z02));
  zero   g151(.O(z12));
