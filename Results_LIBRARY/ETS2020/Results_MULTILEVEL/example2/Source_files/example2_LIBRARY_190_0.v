...
module FAU ( 
  ...
  nand4  g059(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n201_), .O(new_n225_));
  nor2   g060(.a(new_n225_), .b(x01), .O(z32));
  aoi21  g061(.a(x83), .b(x42), .c(x81), .O(new_n228_));
  nand3  g062(.a(x83), .b(x81), .c(x42), .O(new_n229_));
  inv1   g063(.a(new_n229_), .O(new_n230_));
  oai21  g064(.a(new_n230_), .b(new_n228_), .c(new_n211_), .O(new_n231_));
  nand2  g065(.a(x83), .b(x42), .O(new_n232_));
  nand2  g066(.a(new_n232_), .b(x81), .O(new_n233_));
  nand3  g067(.a(x83), .b(new_n210_), .c(x42), .O(new_n234_));
  nand2  g068(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g069(.a(new_n235_), .b(new_n208_), .O(new_n236_));
  ...
  nand4  g073(.a(new_n237_), .b(x78), .c(x77), .d(x53), .O(new_n240_));
  nor3   g074(.a(new_n240_), .b(x04), .c(x01), .O(z35));
  nand4  g075(.a(new_n237_), .b(x78), .c(x77), .d(x54), .O(new_n242_));
  nor3   g076(.a(new_n242_), .b(x04), .c(x01), .O(z36));
  nand4  g077(.a(new_n237_), .b(x78), .c(x77), .d(x55), .O(new_n244_));
  nor3   g078(.a(new_n244_), .b(x04), .c(x01), .O(z37));
  nand4  g079(.a(new_n237_), .b(x78), .c(x77), .d(x56), .O(new_n246_));
  nor3   g080(.a(new_n246_), .b(x04), .c(x01), .O(z38));
  nand4  g081(.a(new_n237_), .b(x78), .c(x77), .d(x57), .O(new_n248_));
  nor3   g082(.a(new_n248_), .b(x04), .c(x01), .O(z39));
  nand4  g083(.a(new_n237_), .b(x78), .c(x77), .d(x59), .O(new_n251_));
  nor3   g084(.a(new_n251_), .b(x04), .c(x01), .O(z41));
  nand4  g085(.a(new_n237_), .b(x78), .c(x77), .d(x60), .O(new_n253_));
  nor3   g086(.a(new_n253_), .b(x04), .c(x01), .O(z42));
  nand4  g087(.a(new_n237_), .b(x78), .c(x77), .d(x61), .O(new_n255_));
  nor3   g088(.a(new_n255_), .b(x04), .c(x01), .O(z43));
  nand4  g089(.a(new_n237_), .b(x78), .c(x77), .d(x62), .O(new_n257_));
  nor3   g090(.a(new_n257_), .b(x04), .c(x01), .O(z44));
  nand4  g091(.a(new_n237_), .b(x78), .c(x77), .d(x63), .O(new_n259_));
  nor3   g092(.a(new_n259_), .b(x04), .c(x01), .O(z45));
  nand4  g093(.a(new_n237_), .b(x78), .c(x77), .d(x64), .O(new_n261_));
  ...
  nor2   g142(.a(new_n270_), .b(x04), .O(new_n321_));
  nor2   g143(.a(new_n210_), .b(x78), .O(new_n322_));
  oai21  g144(.a(new_n322_), .b(new_n321_), .c(x77), .O(new_n323_));
  nand3  g145(.a(x81), .b(x78), .c(new_n264_), .O(new_n324_));
  nand2  g146(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand4  g147(.a(new_n325_), .b(x84), .c(x79), .d(new_n155_), .O(new_n326_));
  inv1   g148(.a(new_n326_), .O(z65));
  zero   g149(.O(z00));
  zero   g150(.O(z01));
  zero   g151(.O(z02));
  zero   g152(.O(z12));
