...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n251_, new_n253_, new_n255_, new_n259_, new_n261_,
  ...
  nor2   g156(.a(new_n314_), .b(new_n221_), .O(new_n315_));
  ...
  nand4  g163(.a(new_n222_), .b(x79), .c(new_n160_), .d(x77), .O(new_n322_));
  ...
  nand2  g206(.a(new_n364_), .b(new_n243_), .O(new_n365_));
  nor4   g207(.a(new_n365_), .b(new_n361_), .c(new_n226_), .d(x82), .O(z55));
  nand2  g208(.a(new_n236_), .b(x76), .O(new_n367_));
  ...
  nand4  g219(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n378_));
  oai22  g220(.a(new_n378_), .b(new_n227_), .c(new_n240_), .d(x40), .O(new_n379_));
  nand4  g221(.a(new_n379_), .b(x79), .c(x78), .d(x04), .O(new_n380_));
  nor2   g222(.a(x79), .b(x78), .O(new_n381_));
  nand3  g223(.a(new_n381_), .b(new_n240_), .c(x40), .O(new_n382_));
  nand2  g224(.a(new_n382_), .b(new_n380_), .O(new_n383_));
  nand2  g225(.a(new_n383_), .b(x77), .O(new_n384_));
  oai21  g226(.a(new_n165_), .b(new_n232_), .c(new_n154_), .O(new_n385_));
  aoi21  g227(.a(new_n385_), .b(new_n384_), .c(x01), .O(z58));
  nor2   g228(.a(new_n160_), .b(new_n232_), .O(new_n387_));
  oai21  g229(.a(new_n387_), .b(new_n381_), .c(x40), .O(new_n388_));
  oai21  g230(.a(new_n227_), .b(new_n225_), .c(new_n240_), .O(new_n389_));
  ...
  nand2  g235(.a(new_n154_), .b(new_n232_), .O(new_n394_));
  aoi21  g236(.a(new_n394_), .b(new_n393_), .c(x01), .O(z59));
  nand2  g237(.a(new_n370_), .b(x79), .O(new_n396_));
  nand3  g238(.a(new_n396_), .b(new_n394_), .c(new_n230_), .O(new_n397_));
  and2   g239(.a(new_n397_), .b(new_n153_), .O(z60));
  nand2  g240(.a(new_n167_), .b(new_n368_), .O(new_n399_));
  nand2  g241(.a(new_n399_), .b(new_n222_), .O(new_n400_));
  oai21  g242(.a(new_n236_), .b(x04), .c(new_n400_), .O(new_n401_));
  ...
  nand3  g249(.a(x81), .b(x79), .c(new_n232_), .O(new_n408_));
  ...
  nor2   g260(.a(new_n243_), .b(x78), .O(new_n419_));
