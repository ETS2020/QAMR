...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n230_, new_n231_, new_n240_, new_n241_, new_n242_, new_n243_,
  ...
  inv1   g074(.a(x42), .O(new_n240_));
  xnor2a g075(.a(x84), .b(x82), .O(new_n241_));
  nand2  g076(.a(new_n241_), .b(x81), .O(new_n242_));
  inv1   g077(.a(x81), .O(new_n243_));
  xor2a  g078(.a(x84), .b(x82), .O(new_n244_));
  nand2  g079(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  nand2  g080(.a(new_n245_), .b(new_n242_), .O(new_n246_));
  nand4  g081(.a(new_n246_), .b(x79), .c(x78), .d(x77), .O(new_n247_));
  inv1   g082(.a(new_n247_), .O(new_n248_));
  nand4  g083(.a(new_n248_), .b(x50), .c(new_n240_), .d(new_n227_), .O(new_n249_));
  nor2   g084(.a(new_n249_), .b(x01), .O(z32));
  nand2  g085(.a(x83), .b(new_n243_), .O(new_n251_));
  nand2  g086(.a(new_n220_), .b(x81), .O(new_n252_));
  nand2  g087(.a(new_n252_), .b(new_n251_), .O(new_n253_));
  nand3  g088(.a(new_n253_), .b(x42), .c(x05), .O(new_n254_));
  nand3  g089(.a(x81), .b(x51), .c(new_n240_), .O(new_n255_));
  nand2  g090(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand2  g091(.a(new_n256_), .b(new_n241_), .O(new_n257_));
  xnor2a g092(.a(x83), .b(x81), .O(new_n258_));
  nand3  g093(.a(new_n258_), .b(x42), .c(x05), .O(new_n259_));
  nand3  g094(.a(new_n243_), .b(x51), .c(new_n240_), .O(new_n260_));
  nand2  g095(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand2  g096(.a(new_n261_), .b(new_n244_), .O(new_n262_));
  aoi21  g097(.a(new_n262_), .b(new_n257_), .c(new_n154_), .O(new_n263_));
  nand4  g098(.a(new_n263_), .b(x78), .c(x77), .d(new_n227_), .O(new_n264_));
  nor2   g099(.a(new_n264_), .b(x01), .O(z33));
  nor2   g100(.a(new_n220_), .b(new_n240_), .O(new_n266_));
  nand3  g101(.a(x83), .b(x81), .c(x42), .O(new_n267_));
  oai21  g102(.a(new_n266_), .b(x81), .c(new_n267_), .O(new_n268_));
  nand2  g103(.a(new_n268_), .b(new_n244_), .O(new_n269_));
  oai22  g104(.a(new_n266_), .b(new_n243_), .c(new_n251_), .d(new_n240_), .O(new_n270_));
  nand2  g105(.a(new_n270_), .b(new_n241_), .O(new_n271_));
  aoi21  g106(.a(new_n271_), .b(new_n269_), .c(new_n154_), .O(new_n272_));
  nand4  g107(.a(new_n272_), .b(x78), .c(x77), .d(x52), .O(new_n273_));
  nor3   g108(.a(new_n273_), .b(x04), .c(x01), .O(z34));
  nand4  g109(.a(new_n272_), .b(x78), .c(x77), .d(x53), .O(new_n275_));
  nor3   g110(.a(new_n275_), .b(x04), .c(x01), .O(z35));
  nand4  g111(.a(new_n272_), .b(x78), .c(x77), .d(x54), .O(new_n277_));
  nor3   g112(.a(new_n277_), .b(x04), .c(x01), .O(z36));
  nand4  g113(.a(new_n272_), .b(x78), .c(x77), .d(x55), .O(new_n279_));
  nor3   g114(.a(new_n279_), .b(x04), .c(x01), .O(z37));
  nand4  g115(.a(new_n272_), .b(x78), .c(x77), .d(x56), .O(new_n281_));
  nor3   g116(.a(new_n281_), .b(x04), .c(x01), .O(z38));
  nand4  g117(.a(new_n272_), .b(x78), .c(x77), .d(x57), .O(new_n283_));
  nor3   g118(.a(new_n283_), .b(x04), .c(x01), .O(z39));
  nand4  g119(.a(new_n272_), .b(x78), .c(x77), .d(x59), .O(new_n286_));
  nor3   g120(.a(new_n286_), .b(x04), .c(x01), .O(z41));
  nand4  g121(.a(new_n272_), .b(x78), .c(x77), .d(x60), .O(new_n288_));
  nor3   g122(.a(new_n288_), .b(x04), .c(x01), .O(z42));
  nand4  g123(.a(new_n272_), .b(x78), .c(x77), .d(x61), .O(new_n290_));
  nor3   g124(.a(new_n290_), .b(x04), .c(x01), .O(z43));
  nand4  g125(.a(new_n272_), .b(x78), .c(x77), .d(x63), .O(new_n293_));
  ...
  nand2  g140(.a(new_n315_), .b(new_n243_), .O(new_n316_));
  ...
  nand4  g150(.a(x80), .b(new_n218_), .c(x43), .d(new_n240_), .O(new_n327_));
  oai22  g151(.a(new_n327_), .b(new_n221_), .c(new_n240_), .d(x40), .O(new_n328_));
  nand4  g152(.a(new_n328_), .b(x79), .c(x78), .d(x04), .O(new_n329_));
  nor2   g153(.a(x79), .b(x78), .O(new_n330_));
  nand3  g154(.a(new_n330_), .b(new_n240_), .c(x40), .O(new_n331_));
  ...
  oai21  g161(.a(new_n221_), .b(new_n219_), .c(new_n240_), .O(new_n338_));
