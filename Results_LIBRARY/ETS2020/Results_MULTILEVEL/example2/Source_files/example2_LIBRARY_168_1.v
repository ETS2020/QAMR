...
module FAU ( 
  ...
  inv1   g073(.a(x42), .O(new_n236_));
  xnor2a g074(.a(x84), .b(x82), .O(new_n237_));
  nand2  g075(.a(new_n237_), .b(x81), .O(new_n238_));
  inv1   g076(.a(x81), .O(new_n239_));
  xor2a  g077(.a(x84), .b(x82), .O(new_n240_));
  nand2  g078(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g079(.a(new_n241_), .b(new_n238_), .O(new_n242_));
  nand4  g080(.a(new_n242_), .b(x79), .c(x78), .d(x77), .O(new_n243_));
  inv1   g081(.a(new_n243_), .O(new_n244_));
  nand4  g082(.a(new_n244_), .b(x47), .c(new_n236_), .d(new_n224_), .O(new_n245_));
  nor2   g083(.a(new_n245_), .b(x01), .O(z29));
  nand2  g084(.a(x83), .b(new_n239_), .O(new_n250_));
  nand2  g085(.a(new_n218_), .b(x81), .O(new_n251_));
  nand2  g086(.a(new_n251_), .b(new_n250_), .O(new_n252_));
  nand3  g087(.a(new_n252_), .b(x42), .c(x05), .O(new_n253_));
  nand3  g088(.a(x81), .b(x51), .c(new_n236_), .O(new_n254_));
  nand2  g089(.a(new_n254_), .b(new_n253_), .O(new_n255_));
  nand2  g090(.a(new_n255_), .b(new_n237_), .O(new_n256_));
  xnor2a g091(.a(x83), .b(x81), .O(new_n257_));
  nand3  g092(.a(new_n257_), .b(x42), .c(x05), .O(new_n258_));
  nand3  g093(.a(new_n239_), .b(x51), .c(new_n236_), .O(new_n259_));
  nand2  g094(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g095(.a(new_n260_), .b(new_n240_), .O(new_n261_));
  aoi21  g096(.a(new_n261_), .b(new_n256_), .c(new_n154_), .O(new_n262_));
  nand4  g097(.a(new_n262_), .b(x78), .c(x77), .d(new_n224_), .O(new_n263_));
  nor2   g098(.a(new_n263_), .b(x01), .O(z33));
  nor2   g099(.a(new_n218_), .b(new_n236_), .O(new_n265_));
  nand3  g100(.a(x83), .b(x81), .c(x42), .O(new_n266_));
  oai21  g101(.a(new_n265_), .b(x81), .c(new_n266_), .O(new_n267_));
  nand2  g102(.a(new_n267_), .b(new_n240_), .O(new_n268_));
  oai22  g103(.a(new_n265_), .b(new_n239_), .c(new_n250_), .d(new_n236_), .O(new_n269_));
  nand2  g104(.a(new_n269_), .b(new_n237_), .O(new_n270_));
  aoi21  g105(.a(new_n270_), .b(new_n268_), .c(new_n154_), .O(new_n271_));
  nand4  g106(.a(new_n271_), .b(x78), .c(x77), .d(x52), .O(new_n272_));
  nor3   g107(.a(new_n272_), .b(x04), .c(x01), .O(z34));
  nand4  g108(.a(new_n271_), .b(x78), .c(x77), .d(x53), .O(new_n274_));
  nor3   g109(.a(new_n274_), .b(x04), .c(x01), .O(z35));
  nand4  g110(.a(new_n271_), .b(x78), .c(x77), .d(x54), .O(new_n276_));
  nor3   g111(.a(new_n276_), .b(x04), .c(x01), .O(z36));
  nand4  g112(.a(new_n271_), .b(x78), .c(x77), .d(x55), .O(new_n278_));
  nor3   g113(.a(new_n278_), .b(x04), .c(x01), .O(z37));
  nand4  g114(.a(new_n271_), .b(x78), .c(x77), .d(x56), .O(new_n280_));
  nor3   g115(.a(new_n280_), .b(x04), .c(x01), .O(z38));
  nand4  g116(.a(new_n271_), .b(x78), .c(x77), .d(x57), .O(new_n282_));
  nor3   g117(.a(new_n282_), .b(x04), .c(x01), .O(z39));
  nand4  g118(.a(new_n271_), .b(x78), .c(x77), .d(x58), .O(new_n284_));
  nor3   g119(.a(new_n284_), .b(x04), .c(x01), .O(z40));
  nand4  g120(.a(new_n271_), .b(x78), .c(x77), .d(x59), .O(new_n286_));
  nor3   g121(.a(new_n286_), .b(x04), .c(x01), .O(z41));
  nand4  g122(.a(new_n271_), .b(x78), .c(x77), .d(x60), .O(new_n288_));
  nor3   g123(.a(new_n288_), .b(x04), .c(x01), .O(z42));
  nand4  g124(.a(new_n271_), .b(x78), .c(x77), .d(x61), .O(new_n290_));
  nor3   g125(.a(new_n290_), .b(x04), .c(x01), .O(z43));
  nand4  g126(.a(new_n271_), .b(x78), .c(x77), .d(x63), .O(new_n293_));
  nor3   g127(.a(new_n293_), .b(x04), .c(x01), .O(z45));
  nand4  g128(.a(new_n271_), .b(x78), .c(x77), .d(x64), .O(new_n295_));
  ...
  nor2   g136(.a(new_n302_), .b(new_n213_), .O(new_n303_));
  ...
  nand2  g143(.a(new_n316_), .b(new_n239_), .O(new_n317_));
  nor4   g144(.a(new_n317_), .b(new_n313_), .c(new_n218_), .d(x82), .O(z55));
  nand2  g145(.a(new_n228_), .b(x76), .O(new_n319_));
  ...
  nand4  g156(.a(x80), .b(new_n216_), .c(x43), .d(new_n236_), .O(new_n330_));
  oai22  g157(.a(new_n330_), .b(new_n219_), .c(new_n236_), .d(x40), .O(new_n331_));
  nand4  g158(.a(new_n331_), .b(x79), .c(x78), .d(x04), .O(new_n332_));
  nor2   g159(.a(x79), .b(x78), .O(new_n333_));
  nand3  g160(.a(new_n333_), .b(new_n236_), .c(x40), .O(new_n334_));
  nand2  g161(.a(new_n334_), .b(new_n332_), .O(new_n335_));
  nand2  g162(.a(new_n335_), .b(x77), .O(new_n336_));
  oai21  g163(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n337_));
  aoi21  g164(.a(new_n337_), .b(new_n336_), .c(x01), .O(z58));
  nor2   g165(.a(new_n160_), .b(new_n224_), .O(new_n339_));
  oai21  g166(.a(new_n339_), .b(new_n333_), .c(x40), .O(new_n340_));
  oai21  g167(.a(new_n219_), .b(new_n217_), .c(new_n236_), .O(new_n341_));
  ...
  nand2  g172(.a(new_n154_), .b(new_n224_), .O(new_n346_));
  aoi21  g173(.a(new_n346_), .b(new_n345_), .c(x01), .O(z59));
  nand2  g174(.a(new_n322_), .b(x79), .O(new_n348_));
  nand3  g175(.a(new_n348_), .b(new_n346_), .c(new_n222_), .O(new_n349_));
  and2   g176(.a(new_n349_), .b(new_n153_), .O(z60));
  nand2  g177(.a(new_n167_), .b(new_n320_), .O(new_n351_));
  nand2  g178(.a(new_n351_), .b(new_n214_), .O(new_n352_));
  oai21  g179(.a(new_n228_), .b(x04), .c(new_n352_), .O(new_n353_));
  ...
  nand3  g186(.a(x81), .b(x79), .c(new_n224_), .O(new_n360_));
