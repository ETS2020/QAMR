...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n250_, new_n253_, new_n255_, new_n257_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n285_, new_n287_, new_n289_, new_n292_,
    new_n294_, new_n298_, new_n301_, new_n303_, new_n305_, new_n306_,
    ...
    new_n370_, new_n371_, new_n373_, new_n375_, new_n376_;
  ...
  nand4  g096(.a(new_n247_), .b(x46), .c(new_n239_), .d(new_n231_), .O(new_n253_));
  ...
  nand4  g130(.a(new_n282_), .b(x78), .c(x77), .d(x55), .O(new_n289_));
  nor3   g131(.a(new_n289_), .b(x04), .c(x01), .O(z37));
  ...
  nand4  g136(.a(new_n282_), .b(x78), .c(x77), .d(x61), .O(new_n298_));
  nor3   g137(.a(new_n298_), .b(x04), .c(x01), .O(z43));
  nand4  g138(.a(new_n282_), .b(x78), .c(x77), .d(x63), .O(new_n301_));
  nor3   g139(.a(new_n301_), .b(x04), .c(x01), .O(z45));
  nand4  g140(.a(new_n282_), .b(x78), .c(x77), .d(x64), .O(new_n303_));
  ...
  nand2  g155(.a(new_n324_), .b(new_n242_), .O(new_n325_));
  nor4   g156(.a(new_n325_), .b(new_n321_), .c(new_n225_), .d(x82), .O(z55));
  nand2  g157(.a(new_n235_), .b(x76), .O(new_n327_));
  ...
  nand4  g166(.a(x03), .b(new_n335_), .c(new_n153_), .d(x00), .O(new_n336_));
  inv1   g167(.a(new_n336_), .O(z57));
  nand4  g168(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n338_));
  oai22  g169(.a(new_n338_), .b(new_n226_), .c(new_n239_), .d(x40), .O(new_n339_));
  nand4  g170(.a(new_n339_), .b(x79), .c(x78), .d(x04), .O(new_n340_));
  nor2   g171(.a(x79), .b(x78), .O(new_n341_));
  nand3  g172(.a(new_n341_), .b(new_n239_), .c(x40), .O(new_n342_));
  nand2  g173(.a(new_n342_), .b(new_n340_), .O(new_n343_));
  nand2  g174(.a(new_n343_), .b(x77), .O(new_n344_));
  oai21  g175(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n345_));
  aoi21  g176(.a(new_n345_), .b(new_n344_), .c(x01), .O(z58));
  nor2   g177(.a(new_n160_), .b(new_n231_), .O(new_n347_));
  oai21  g178(.a(new_n347_), .b(new_n341_), .c(x40), .O(new_n348_));
  oai21  g179(.a(new_n226_), .b(new_n224_), .c(new_n239_), .O(new_n349_));
  ...
  nand2  g184(.a(new_n154_), .b(new_n231_), .O(new_n354_));
  aoi21  g185(.a(new_n354_), .b(new_n353_), .c(x01), .O(z59));
  nand2  g186(.a(new_n330_), .b(x79), .O(new_n356_));
  nand3  g187(.a(new_n356_), .b(new_n354_), .c(new_n229_), .O(new_n357_));
  and2   g188(.a(new_n357_), .b(new_n153_), .O(z60));
  nand2  g189(.a(new_n167_), .b(new_n328_), .O(new_n359_));
  nand2  g190(.a(new_n359_), .b(new_n221_), .O(new_n360_));
  oai21  g191(.a(new_n235_), .b(x04), .c(new_n360_), .O(new_n361_));
  nand4  g192(.a(new_n361_), .b(x80), .c(x79), .d(new_n153_), .O(new_n362_));
  inv1   g193(.a(new_n362_), .O(z61));
  nand2  g194(.a(new_n154_), .b(x04), .O(new_n364_));
  ...
  nand3  g198(.a(x81), .b(x79), .c(new_n231_), .O(new_n368_));
  aoi21  g199(.a(new_n368_), .b(new_n367_), .c(new_n159_), .O(new_n369_));
  oai21  g200(.a(new_n369_), .b(new_n366_), .c(x78), .O(new_n370_));
  or2    g201(.a(new_n365_), .b(new_n167_), .O(new_n371_));
  aoi21  g202(.a(new_n371_), .b(new_n370_), .c(x01), .O(z62));
  nand4  g203(.a(new_n361_), .b(x82), .c(x79), .d(new_n153_), .O(new_n373_));
  inv1   g204(.a(new_n373_), .O(z63));
  nand3  g205(.a(new_n361_), .b(x83), .c(x79), .O(new_n375_));
  nand4  g206(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n376_));
