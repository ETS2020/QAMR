...
module FAU ( 
  ...
  nor2   g165(.a(new_n319_), .b(new_n222_), .O(new_n320_));
  ...
  nand4  g172(.a(new_n223_), .b(x79), .c(new_n160_), .d(x77), .O(new_n327_));
  ...
  nand2  g215(.a(new_n369_), .b(new_n244_), .O(new_n370_));
  nor4   g216(.a(new_n370_), .b(new_n366_), .c(new_n227_), .d(x82), .O(z55));
  nand2  g217(.a(new_n237_), .b(x76), .O(new_n372_));
  ...
  nand4  g228(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n383_));
  oai22  g229(.a(new_n383_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n384_));
  nand4  g230(.a(new_n384_), .b(x79), .c(x78), .d(x04), .O(new_n385_));
  nor2   g231(.a(x79), .b(x78), .O(new_n386_));
  nand3  g232(.a(new_n386_), .b(new_n241_), .c(x40), .O(new_n387_));
  nand2  g233(.a(new_n387_), .b(new_n385_), .O(new_n388_));
  nand2  g234(.a(new_n388_), .b(x77), .O(new_n389_));
  oai21  g235(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n390_));
  aoi21  g236(.a(new_n390_), .b(new_n389_), .c(x01), .O(z58));
  nor2   g237(.a(new_n160_), .b(new_n233_), .O(new_n392_));
  oai21  g238(.a(new_n392_), .b(new_n386_), .c(x40), .O(new_n393_));
  oai21  g239(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n394_));
  ...
  nand2  g244(.a(new_n154_), .b(new_n233_), .O(new_n399_));
  aoi21  g245(.a(new_n399_), .b(new_n398_), .c(x01), .O(z59));
  nand2  g246(.a(new_n375_), .b(x79), .O(new_n401_));
  nand3  g247(.a(new_n401_), .b(new_n399_), .c(new_n231_), .O(new_n402_));
  and2   g248(.a(new_n402_), .b(new_n153_), .O(z60));
  nand2  g249(.a(new_n167_), .b(new_n373_), .O(new_n404_));
  nand2  g250(.a(new_n404_), .b(new_n223_), .O(new_n405_));
  oai21  g251(.a(new_n237_), .b(x04), .c(new_n405_), .O(new_n406_));
  ...
  nand3  g258(.a(x81), .b(x79), .c(new_n233_), .O(new_n413_));
  ...
  nor2   g269(.a(new_n244_), .b(x78), .O(new_n424_));
