...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n240_, new_n241_, new_n244_, new_n246_, new_n249_, new_n252_,
  ...
  nand4  g064(.a(new_n217_), .b(x50), .c(new_n209_), .d(new_n203_), .O(new_n228_));
  ...
  oai21  g069(.a(new_n233_), .b(new_n231_), .c(new_n213_), .O(new_n234_));
  nand2  g070(.a(x83), .b(x42), .O(new_n235_));
  nand2  g071(.a(new_n235_), .b(x81), .O(new_n236_));
  nand3  g072(.a(x83), .b(new_n212_), .c(x42), .O(new_n237_));
  nand2  g073(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(new_n210_), .O(new_n239_));
  ...
  nand4  g084(.a(new_n240_), .b(x78), .c(x77), .d(x59), .O(new_n252_));
  nor3   g085(.a(new_n252_), .b(x04), .c(x01), .O(z41));
  nand4  g086(.a(new_n240_), .b(x78), .c(x77), .d(x60), .O(new_n254_));
  nor3   g087(.a(new_n254_), .b(x04), .c(x01), .O(z42));
  nand4  g088(.a(new_n240_), .b(x78), .c(x77), .d(x61), .O(new_n256_));
  nor3   g089(.a(new_n256_), .b(x04), .c(x01), .O(z43));
  nand4  g090(.a(new_n240_), .b(x78), .c(x77), .d(x62), .O(new_n258_));
  nor3   g091(.a(new_n258_), .b(x04), .c(x01), .O(z44));
  nand4  g092(.a(new_n240_), .b(x78), .c(x77), .d(x63), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z45));
  nand4  g094(.a(new_n240_), .b(x78), .c(x77), .d(x64), .O(new_n262_));
