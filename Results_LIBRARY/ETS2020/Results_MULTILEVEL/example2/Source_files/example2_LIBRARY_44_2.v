...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n285_, new_n287_, new_n289_, new_n293_,
    new_n295_, new_n297_, new_n302_, new_n304_, new_n305_, new_n306_,
  ...
  nand4  g128(.a(new_n282_), .b(x78), .c(x77), .d(x53), .O(new_n285_));
  nor3   g129(.a(new_n285_), .b(x04), .c(x01), .O(z35));
  nand4  g130(.a(new_n282_), .b(x78), .c(x77), .d(x54), .O(new_n287_));
  nor3   g131(.a(new_n287_), .b(x04), .c(x01), .O(z36));
  nand4  g132(.a(new_n282_), .b(x78), .c(x77), .d(x55), .O(new_n289_));
  nor3   g133(.a(new_n289_), .b(x04), .c(x01), .O(z37));
  ...
  nand4  g140(.a(new_n282_), .b(x78), .c(x77), .d(x64), .O(new_n302_));
  ...
  nand4  g155(.a(new_n218_), .b(x79), .c(new_n160_), .d(x77), .O(new_n317_));
  ...
  nand2  g198(.a(new_n359_), .b(new_n239_), .O(new_n360_));
  nor4   g199(.a(new_n360_), .b(new_n356_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g200(.a(new_n232_), .b(x76), .O(new_n362_));
  ...
  nand4  g211(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n373_));
  oai22  g212(.a(new_n373_), .b(new_n223_), .c(new_n236_), .d(x40), .O(new_n374_));
  nand4  g213(.a(new_n374_), .b(x79), .c(x78), .d(x04), .O(new_n375_));
  nor2   g214(.a(x79), .b(x78), .O(new_n376_));
  nand3  g215(.a(new_n376_), .b(new_n236_), .c(x40), .O(new_n377_));
  nand2  g216(.a(new_n377_), .b(new_n375_), .O(new_n378_));
  nand2  g217(.a(new_n378_), .b(x77), .O(new_n379_));
  oai21  g218(.a(new_n165_), .b(new_n228_), .c(new_n154_), .O(new_n380_));
  aoi21  g219(.a(new_n380_), .b(new_n379_), .c(x01), .O(z58));
  nor2   g220(.a(new_n160_), .b(new_n228_), .O(new_n382_));
  oai21  g221(.a(new_n382_), .b(new_n376_), .c(x40), .O(new_n383_));
  oai21  g222(.a(new_n223_), .b(new_n221_), .c(new_n236_), .O(new_n384_));
  ...
  nand2  g227(.a(new_n154_), .b(new_n228_), .O(new_n389_));
  aoi21  g228(.a(new_n389_), .b(new_n388_), .c(x01), .O(z59));
  nand2  g229(.a(new_n365_), .b(x79), .O(new_n391_));
  nand3  g230(.a(new_n391_), .b(new_n389_), .c(new_n226_), .O(new_n392_));
  and2   g231(.a(new_n392_), .b(new_n153_), .O(z60));
  nand2  g232(.a(new_n167_), .b(new_n363_), .O(new_n394_));
  nand2  g233(.a(new_n394_), .b(new_n218_), .O(new_n395_));
  oai21  g234(.a(new_n232_), .b(x04), .c(new_n395_), .O(new_n396_));
  ...
  nand3  g241(.a(x81), .b(x79), .c(new_n228_), .O(new_n403_));
