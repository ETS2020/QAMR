...
module FAU ( 
  ...
  nand4  g124(.a(new_n280_), .b(x78), .c(x77), .d(x56), .O(new_n286_));
  nor3   g125(.a(new_n286_), .b(x04), .c(x01), .O(z38));
  nand4  g126(.a(new_n280_), .b(x78), .c(x77), .d(x57), .O(new_n288_));
  nor3   g127(.a(new_n288_), .b(x04), .c(x01), .O(z39));
  nand4  g128(.a(new_n280_), .b(x78), .c(x77), .d(x58), .O(new_n290_));
  nor3   g129(.a(new_n290_), .b(x04), .c(x01), .O(z40));
  nand4  g130(.a(new_n280_), .b(x78), .c(x77), .d(x59), .O(new_n292_));
  nor3   g131(.a(new_n292_), .b(x04), .c(x01), .O(z41));
  nand4  g132(.a(new_n280_), .b(x78), .c(x77), .d(x61), .O(new_n295_));
