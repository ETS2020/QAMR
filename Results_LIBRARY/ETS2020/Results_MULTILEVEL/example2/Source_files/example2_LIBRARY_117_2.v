...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n286_, new_n289_, new_n291_, new_n294_, new_n298_, new_n300_,
  ...
  nand4  g123(.a(new_n280_), .b(x78), .c(x77), .d(x56), .O(new_n286_));
  nor3   g124(.a(new_n286_), .b(x04), .c(x01), .O(z38));
  nand4  g125(.a(new_n280_), .b(x78), .c(x77), .d(x58), .O(new_n289_));
  nor3   g126(.a(new_n289_), .b(x04), .c(x01), .O(z40));
  nand4  g127(.a(new_n280_), .b(x78), .c(x77), .d(x59), .O(new_n291_));
  nor3   g128(.a(new_n291_), .b(x04), .c(x01), .O(z41));
  nand4  g129(.a(new_n280_), .b(x78), .c(x77), .d(x61), .O(new_n294_));
  nor3   g130(.a(new_n294_), .b(x04), .c(x01), .O(z43));
  nand4  g131(.a(new_n280_), .b(x78), .c(x77), .d(x64), .O(new_n298_));
  nor3   g132(.a(new_n298_), .b(x04), .c(x01), .O(z46));
  ...
  nor2   g242(.a(new_n160_), .b(x04), .O(new_n409_));
  nor2   g243(.a(new_n239_), .b(x78), .O(new_n410_));
  oai21  g244(.a(new_n410_), .b(new_n409_), .c(x77), .O(new_n411_));
  nand3  g245(.a(x81), .b(x78), .c(new_n159_), .O(new_n412_));
  nand2  g246(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  nand4  g247(.a(new_n413_), .b(x84), .c(x79), .d(new_n153_), .O(new_n414_));
  inv1   g248(.a(new_n414_), .O(z65));
  zero   g249(.O(z03));
  zero   g250(.O(z05));
  zero   g251(.O(z08));
  zero   g252(.O(z10));
