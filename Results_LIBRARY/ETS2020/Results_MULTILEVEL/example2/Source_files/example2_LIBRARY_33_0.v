...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n200_, new_n201_, new_n203_, new_n204_, new_n212_, new_n213_,
    new_n214_, new_n215_, new_n216_, new_n217_, new_n218_, new_n219_,
    new_n220_, new_n221_, new_n222_, new_n224_, new_n226_, new_n228_,
    new_n230_, new_n237_, new_n238_, new_n239_, new_n240_, new_n241_,
  ...
  nand4  g064(.a(new_n221_), .b(x46), .c(new_n213_), .d(new_n212_), .O(new_n226_));
  nor2   g065(.a(new_n226_), .b(x01), .O(z28));
  nand4  g066(.a(new_n221_), .b(x47), .c(new_n213_), .d(new_n212_), .O(new_n228_));
  nor2   g067(.a(new_n228_), .b(x01), .O(z29));
  nand4  g068(.a(new_n221_), .b(x48), .c(new_n213_), .d(new_n212_), .O(new_n230_));
  nor2   g069(.a(new_n230_), .b(x01), .O(z30));
  aoi21  g070(.a(x83), .b(x42), .c(x81), .O(new_n237_));
  nand3  g071(.a(x83), .b(x81), .c(x42), .O(new_n238_));
  inv1   g072(.a(new_n238_), .O(new_n239_));
  oai21  g073(.a(new_n239_), .b(new_n237_), .c(new_n217_), .O(new_n240_));
  nand2  g074(.a(x83), .b(x42), .O(new_n241_));
  nand2  g075(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g076(.a(x83), .b(new_n216_), .c(x42), .O(new_n243_));
  nand2  g077(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g078(.a(new_n244_), .b(new_n214_), .O(new_n245_));
  aoi21  g079(.a(new_n245_), .b(new_n240_), .c(new_n154_), .O(new_n246_));
  nand4  g080(.a(new_n246_), .b(x78), .c(x77), .d(x54), .O(new_n247_));
  nor3   g081(.a(new_n247_), .b(x04), .c(x01), .O(z36));
  nand4  g082(.a(new_n246_), .b(x78), .c(x77), .d(x55), .O(new_n249_));
  nor3   g083(.a(new_n249_), .b(x04), .c(x01), .O(z37));
  nand4  g084(.a(new_n246_), .b(x78), .c(x77), .d(x56), .O(new_n251_));
  nor3   g085(.a(new_n251_), .b(x04), .c(x01), .O(z38));
  nand4  g086(.a(new_n246_), .b(x78), .c(x77), .d(x57), .O(new_n253_));
  nor3   g087(.a(new_n253_), .b(x04), .c(x01), .O(z39));
  nand4  g088(.a(new_n246_), .b(x78), .c(x77), .d(x59), .O(new_n256_));
  nor3   g089(.a(new_n256_), .b(x04), .c(x01), .O(z41));
  nand4  g090(.a(new_n246_), .b(x78), .c(x77), .d(x60), .O(new_n258_));
  nor3   g091(.a(new_n258_), .b(x04), .c(x01), .O(z42));
  nand4  g092(.a(new_n246_), .b(x78), .c(x77), .d(x61), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z43));
  nand4  g094(.a(new_n246_), .b(x78), .c(x77), .d(x62), .O(new_n262_));
  nor3   g095(.a(new_n262_), .b(x04), .c(x01), .O(z44));
  nand4  g096(.a(new_n246_), .b(x78), .c(x77), .d(x63), .O(new_n264_));
  nor3   g097(.a(new_n264_), .b(x04), .c(x01), .O(z45));
  nand4  g098(.a(new_n246_), .b(x78), .c(x77), .d(x64), .O(new_n266_));
  ...
  nor2   g148(.a(new_n216_), .b(x78), .O(new_n327_));
