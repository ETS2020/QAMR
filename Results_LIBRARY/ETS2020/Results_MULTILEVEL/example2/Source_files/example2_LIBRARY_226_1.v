...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n277_, new_n280_, new_n282_, new_n284_, new_n286_,
    new_n288_, new_n290_, new_n293_, new_n295_, new_n297_, new_n300_,
  ...
  nand4  g117(.a(new_n276_), .b(x78), .c(x77), .d(x54), .O(new_n280_));
  nor3   g118(.a(new_n280_), .b(x04), .c(x01), .O(z36));
  nand4  g119(.a(new_n276_), .b(x78), .c(x77), .d(x55), .O(new_n282_));
  ...
  nand4  g133(.a(new_n276_), .b(x78), .c(x77), .d(x63), .O(new_n297_));
  ...
  nor2   g141(.a(new_n305_), .b(new_n215_), .O(new_n306_));
  nand4  g142(.a(new_n306_), .b(x79), .c(new_n160_), .d(x77), .O(new_n307_));
  aoi21  g143(.a(new_n307_), .b(new_n304_), .c(x01), .O(z47));
  nand2  g144(.a(x52), .b(x22), .O(new_n315_));
  nand2  g145(.a(new_n301_), .b(x14), .O(new_n316_));
  aoi21  g146(.a(new_n316_), .b(new_n315_), .c(x79), .O(new_n317_));
  nand4  g147(.a(new_n317_), .b(x78), .c(new_n159_), .d(x04), .O(new_n318_));
  nor2   g148(.a(new_n318_), .b(x01), .O(z54));
  inv1   g149(.a(x84), .O(new_n320_));
  nor2   g150(.a(x04), .b(x01), .O(new_n321_));
  nand4  g151(.a(new_n321_), .b(x79), .c(x78), .d(x77), .O(new_n322_));
  nor2   g152(.a(new_n322_), .b(x80), .O(new_n323_));
  nand2  g153(.a(new_n323_), .b(new_n236_), .O(new_n324_));
  nor4   g154(.a(new_n324_), .b(new_n320_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g155(.a(new_n229_), .b(x76), .O(new_n326_));
  inv1   g156(.a(new_n165_), .O(new_n327_));
  xnor2a g157(.a(x84), .b(x81), .O(new_n328_));
  aoi21  g158(.a(new_n167_), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g159(.a(new_n329_), .b(new_n153_), .O(new_n330_));
  nand2  g160(.a(new_n330_), .b(new_n326_), .O(new_n331_));
  nand2  g161(.a(new_n331_), .b(x79), .O(new_n332_));
  nand4  g162(.a(new_n332_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g163(.a(x02), .O(new_n334_));
  nand4  g164(.a(x03), .b(new_n334_), .c(new_n153_), .d(x00), .O(new_n335_));
  inv1   g165(.a(new_n335_), .O(z57));
  nand4  g166(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n337_));
  oai22  g167(.a(new_n337_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n338_));
  nand4  g168(.a(new_n338_), .b(x79), .c(x78), .d(x04), .O(new_n339_));
  nor2   g169(.a(x79), .b(x78), .O(new_n340_));
  nand3  g170(.a(new_n340_), .b(new_n233_), .c(x40), .O(new_n341_));
  nand2  g171(.a(new_n341_), .b(new_n339_), .O(new_n342_));
  nand2  g172(.a(new_n342_), .b(x77), .O(new_n343_));
  oai21  g173(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n344_));
  aoi21  g174(.a(new_n344_), .b(new_n343_), .c(x01), .O(z58));
  nor2   g175(.a(new_n160_), .b(new_n227_), .O(new_n346_));
  oai21  g176(.a(new_n346_), .b(new_n340_), .c(x40), .O(new_n347_));
  oai21  g177(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n348_));
  ...
  nand2  g182(.a(new_n154_), .b(new_n227_), .O(new_n353_));
  aoi21  g183(.a(new_n353_), .b(new_n352_), .c(x01), .O(z59));
  nand2  g184(.a(new_n329_), .b(x79), .O(new_n355_));
  nand3  g185(.a(new_n355_), .b(new_n353_), .c(new_n224_), .O(new_n356_));
  and2   g186(.a(new_n356_), .b(new_n153_), .O(z60));
  nand2  g187(.a(new_n167_), .b(new_n327_), .O(new_n358_));
  nand2  g188(.a(new_n358_), .b(new_n216_), .O(new_n359_));
  oai21  g189(.a(new_n229_), .b(x04), .c(new_n359_), .O(new_n360_));
  ...
  nand3  g196(.a(x81), .b(x79), .c(new_n227_), .O(new_n367_));
