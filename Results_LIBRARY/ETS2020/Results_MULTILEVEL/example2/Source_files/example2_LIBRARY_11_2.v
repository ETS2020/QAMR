...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n287_, new_n289_, new_n291_, new_n293_, new_n295_, new_n298_,
  ...
  nand4  g122(.a(new_n279_), .b(x78), .c(x77), .d(x54), .O(new_n283_));
  ...
  nand2  g189(.a(new_n353_), .b(new_n238_), .O(new_n354_));
  nor4   g190(.a(new_n354_), .b(new_n350_), .c(new_n221_), .d(x82), .O(z55));
  nand2  g191(.a(new_n231_), .b(x76), .O(new_n356_));
  ...
  nand4  g202(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n367_));
  oai22  g203(.a(new_n367_), .b(new_n222_), .c(new_n235_), .d(x40), .O(new_n368_));
  nand4  g204(.a(new_n368_), .b(x79), .c(x78), .d(x04), .O(new_n369_));
  nor2   g205(.a(x79), .b(x78), .O(new_n370_));
  nand3  g206(.a(new_n370_), .b(new_n235_), .c(x40), .O(new_n371_));
  nand2  g207(.a(new_n371_), .b(new_n369_), .O(new_n372_));
  nand2  g208(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g209(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n374_));
  aoi21  g210(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nor2   g211(.a(new_n160_), .b(new_n227_), .O(new_n376_));
  oai21  g212(.a(new_n376_), .b(new_n370_), .c(x40), .O(new_n377_));
  oai21  g213(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n378_));
  ...
  nand2  g218(.a(new_n154_), .b(new_n227_), .O(new_n383_));
  aoi21  g219(.a(new_n383_), .b(new_n382_), .c(x01), .O(z59));
  nand2  g220(.a(new_n359_), .b(x79), .O(new_n385_));
  nand3  g221(.a(new_n385_), .b(new_n383_), .c(new_n225_), .O(new_n386_));
  and2   g222(.a(new_n386_), .b(new_n153_), .O(z60));
  nand2  g223(.a(new_n167_), .b(new_n357_), .O(new_n388_));
  nand2  g224(.a(new_n388_), .b(new_n217_), .O(new_n389_));
  oai21  g225(.a(new_n231_), .b(x04), .c(new_n389_), .O(new_n390_));
  ...
  nand3  g232(.a(x81), .b(x79), .c(new_n227_), .O(new_n397_));
  ...
  nor2   g242(.a(new_n160_), .b(x04), .O(new_n407_));
  nor2   g243(.a(new_n238_), .b(x78), .O(new_n408_));
  oai21  g244(.a(new_n408_), .b(new_n407_), .c(x77), .O(new_n409_));
  nand3  g245(.a(x81), .b(x78), .c(new_n159_), .O(new_n410_));
  nand2  g246(.a(new_n410_), .b(new_n409_), .O(new_n411_));
  nand4  g247(.a(new_n411_), .b(x84), .c(x79), .d(new_n153_), .O(new_n412_));
  inv1   g248(.a(new_n412_), .O(z65));
  zero   g249(.O(z03));
  zero   g250(.O(z05));
  zero   g251(.O(z08));
  zero   g252(.O(z11));
