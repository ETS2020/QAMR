...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n251_, new_n253_, new_n255_, new_n257_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n285_, new_n287_, new_n289_, new_n293_,
    new_n297_, new_n300_, new_n302_, new_n304_, new_n305_, new_n306_,
  ...
  nor2   g118(.a(new_n224_), .b(new_n238_), .O(new_n276_));
  nand3  g119(.a(x83), .b(x81), .c(x42), .O(new_n277_));
  oai21  g120(.a(new_n276_), .b(x81), .c(new_n277_), .O(new_n278_));
  nand2  g121(.a(new_n278_), .b(new_n242_), .O(new_n279_));
  oai22  g122(.a(new_n276_), .b(new_n241_), .c(new_n261_), .d(new_n238_), .O(new_n280_));
  nand2  g123(.a(new_n280_), .b(new_n239_), .O(new_n281_));
  ...
  nand4  g135(.a(new_n282_), .b(x78), .c(x77), .d(x61), .O(new_n297_));
  nor3   g136(.a(new_n297_), .b(x04), .c(x01), .O(z43));
  nand4  g137(.a(new_n282_), .b(x78), .c(x77), .d(x63), .O(new_n300_));
  nor3   g138(.a(new_n300_), .b(x04), .c(x01), .O(z45));
  nand4  g139(.a(new_n282_), .b(x78), .c(x77), .d(x64), .O(new_n302_));
  ...
  nand4  g165(.a(x03), .b(new_n334_), .c(new_n153_), .d(x00), .O(new_n335_));
  inv1   g166(.a(new_n335_), .O(z57));
  nand4  g167(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n337_));
  oai22  g168(.a(new_n337_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n338_));
  nand4  g169(.a(new_n338_), .b(x79), .c(x78), .d(x04), .O(new_n339_));
  nor2   g170(.a(x79), .b(x78), .O(new_n340_));
  nand3  g171(.a(new_n340_), .b(new_n238_), .c(x40), .O(new_n341_));
  nand2  g172(.a(new_n341_), .b(new_n339_), .O(new_n342_));
  nand2  g173(.a(new_n342_), .b(x77), .O(new_n343_));
  oai21  g174(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n344_));
  aoi21  g175(.a(new_n344_), .b(new_n343_), .c(x01), .O(z58));
  nor2   g176(.a(new_n160_), .b(new_n230_), .O(new_n346_));
  oai21  g177(.a(new_n346_), .b(new_n340_), .c(x40), .O(new_n347_));
  oai21  g178(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n348_));
  nand2  g179(.a(new_n348_), .b(x79), .O(new_n349_));
  nand3  g180(.a(new_n349_), .b(x78), .c(x04), .O(new_n350_));
  nand2  g181(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  nand2  g182(.a(new_n351_), .b(x77), .O(new_n352_));
  nand2  g183(.a(new_n154_), .b(new_n230_), .O(new_n353_));
  aoi21  g184(.a(new_n353_), .b(new_n352_), .c(x01), .O(z59));
  nand2  g185(.a(new_n329_), .b(x79), .O(new_n355_));
  nand3  g186(.a(new_n355_), .b(new_n353_), .c(new_n228_), .O(new_n356_));
  and2   g187(.a(new_n356_), .b(new_n153_), .O(z60));
  nand2  g188(.a(new_n167_), .b(new_n327_), .O(new_n358_));
  nand2  g189(.a(new_n358_), .b(new_n220_), .O(new_n359_));
  oai21  g190(.a(new_n234_), .b(x04), .c(new_n359_), .O(new_n360_));
  nand4  g191(.a(new_n360_), .b(x80), .c(x79), .d(new_n153_), .O(new_n361_));
  inv1   g192(.a(new_n361_), .O(z61));
  nand2  g193(.a(new_n154_), .b(x04), .O(new_n363_));
  nand3  g194(.a(x84), .b(x81), .c(x79), .O(new_n364_));
  aoi21  g195(.a(new_n364_), .b(new_n363_), .c(x77), .O(new_n365_));
  nand2  g196(.a(new_n349_), .b(x04), .O(new_n366_));
  nand3  g197(.a(x81), .b(x79), .c(new_n230_), .O(new_n367_));
  aoi21  g198(.a(new_n367_), .b(new_n366_), .c(new_n159_), .O(new_n368_));
  oai21  g199(.a(new_n368_), .b(new_n365_), .c(x78), .O(new_n369_));
  or2    g200(.a(new_n364_), .b(new_n167_), .O(new_n370_));
  aoi21  g201(.a(new_n370_), .b(new_n369_), .c(x01), .O(z62));
  nand4  g202(.a(new_n360_), .b(x82), .c(x79), .d(new_n153_), .O(new_n372_));
  inv1   g203(.a(new_n372_), .O(z63));
  nand3  g204(.a(new_n360_), .b(x83), .c(x79), .O(new_n374_));
  nand4  g205(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n375_));
  aoi21  g206(.a(new_n375_), .b(new_n374_), .c(x01), .O(z64));
  zero   g207(.O(z11));
  zero   g208(.O(z18));
  zero   g209(.O(z19));
  zero   g210(.O(z20));
