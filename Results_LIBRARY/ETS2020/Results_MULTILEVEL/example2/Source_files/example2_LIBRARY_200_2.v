...
module FAU ( 
  ...
  nand4  g210(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n373_));
  oai22  g211(.a(new_n373_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n374_));
  ...
  oai21  g221(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n384_));
  ...
  nand3  g229(.a(new_n391_), .b(new_n389_), .c(new_n227_), .O(new_n392_));
  and2   g230(.a(new_n392_), .b(new_n153_), .O(z60));
  nand2  g231(.a(new_n167_), .b(new_n363_), .O(new_n394_));
  nand2  g232(.a(new_n394_), .b(new_n219_), .O(new_n395_));
