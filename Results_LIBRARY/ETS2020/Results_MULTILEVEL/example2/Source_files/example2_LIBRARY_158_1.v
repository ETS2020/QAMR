...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n159_,
    ...
    new_n190_, new_n191_, new_n193_, new_n194_, new_n201_, new_n202_,
    ...
    new_n272_, new_n274_, new_n276_, new_n280_, new_n282_, new_n284_,
  ...
  nand4  g071(.a(new_n231_), .b(x45), .c(new_n223_), .d(new_n217_), .O(new_n235_));
  nor2   g072(.a(new_n235_), .b(x01), .O(z27));
  nand4  g073(.a(new_n231_), .b(x46), .c(new_n223_), .d(new_n217_), .O(new_n237_));
  nor2   g074(.a(new_n237_), .b(x01), .O(z28));
  nand4  g075(.a(new_n231_), .b(x47), .c(new_n223_), .d(new_n217_), .O(new_n239_));
  nor2   g076(.a(new_n239_), .b(x01), .O(z29));
  nand4  g077(.a(new_n231_), .b(x48), .c(new_n223_), .d(new_n217_), .O(new_n241_));
  nor2   g078(.a(new_n241_), .b(x01), .O(z30));
  nand4  g079(.a(new_n231_), .b(x49), .c(new_n223_), .d(new_n217_), .O(new_n243_));
  nor2   g080(.a(new_n243_), .b(x01), .O(z31));
  nand4  g081(.a(new_n231_), .b(x50), .c(new_n223_), .d(new_n217_), .O(new_n245_));
  nor2   g082(.a(new_n245_), .b(x01), .O(z32));
  nand2  g083(.a(x83), .b(new_n226_), .O(new_n247_));
  nand2  g084(.a(new_n210_), .b(x81), .O(new_n248_));
  nand2  g085(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand3  g086(.a(new_n249_), .b(x42), .c(x05), .O(new_n250_));
  nand3  g087(.a(x81), .b(x51), .c(new_n223_), .O(new_n251_));
  nand2  g088(.a(new_n251_), .b(new_n250_), .O(new_n252_));
  nand2  g089(.a(new_n252_), .b(new_n224_), .O(new_n253_));
  xnor2a g090(.a(x83), .b(x81), .O(new_n254_));
  nand3  g091(.a(new_n254_), .b(x42), .c(x05), .O(new_n255_));
  nand3  g092(.a(new_n226_), .b(x51), .c(new_n223_), .O(new_n256_));
  nand2  g093(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand2  g094(.a(new_n257_), .b(new_n227_), .O(new_n258_));
  aoi21  g095(.a(new_n258_), .b(new_n253_), .c(new_n156_), .O(new_n259_));
  nand4  g096(.a(new_n259_), .b(x78), .c(x77), .d(new_n217_), .O(new_n260_));
  nor2   g097(.a(new_n260_), .b(x01), .O(z33));
  nor2   g098(.a(new_n210_), .b(new_n223_), .O(new_n263_));
  nand3  g099(.a(x83), .b(x81), .c(x42), .O(new_n264_));
  oai21  g100(.a(new_n263_), .b(x81), .c(new_n264_), .O(new_n265_));
  nand2  g101(.a(new_n265_), .b(new_n227_), .O(new_n266_));
  oai22  g102(.a(new_n263_), .b(new_n226_), .c(new_n247_), .d(new_n223_), .O(new_n267_));
  nand2  g103(.a(new_n267_), .b(new_n224_), .O(new_n268_));
  aoi21  g104(.a(new_n268_), .b(new_n266_), .c(new_n156_), .O(new_n269_));
  nand4  g105(.a(new_n269_), .b(x78), .c(x77), .d(x53), .O(new_n270_));
  nor3   g106(.a(new_n270_), .b(x04), .c(x01), .O(z35));
  nand4  g107(.a(new_n269_), .b(x78), .c(x77), .d(x54), .O(new_n272_));
  nor3   g108(.a(new_n272_), .b(x04), .c(x01), .O(z36));
  nand4  g109(.a(new_n269_), .b(x78), .c(x77), .d(x55), .O(new_n274_));
  nor3   g110(.a(new_n274_), .b(x04), .c(x01), .O(z37));
  nand4  g111(.a(new_n269_), .b(x78), .c(x77), .d(x56), .O(new_n276_));
  nor3   g112(.a(new_n276_), .b(x04), .c(x01), .O(z38));
  nand4  g113(.a(new_n269_), .b(x78), .c(x77), .d(x59), .O(new_n280_));
  nor3   g114(.a(new_n280_), .b(x04), .c(x01), .O(z41));
  nand4  g115(.a(new_n269_), .b(x78), .c(x77), .d(x60), .O(new_n282_));
  nor3   g116(.a(new_n282_), .b(x04), .c(x01), .O(z42));
  nand4  g117(.a(new_n269_), .b(x78), .c(x77), .d(x61), .O(new_n284_));
  nor3   g118(.a(new_n284_), .b(x04), .c(x01), .O(z43));
  nand4  g119(.a(new_n269_), .b(x78), .c(x77), .d(x62), .O(new_n286_));
  nor3   g120(.a(new_n286_), .b(x04), .c(x01), .O(z44));
  nand4  g121(.a(new_n269_), .b(x78), .c(x77), .d(x63), .O(new_n288_));
  nor3   g122(.a(new_n288_), .b(x04), .c(x01), .O(z45));
  ...
  nand2  g136(.a(new_n310_), .b(new_n226_), .O(new_n311_));
  nor4   g137(.a(new_n311_), .b(new_n307_), .c(new_n210_), .d(x82), .O(z55));
  nand2  g138(.a(new_n219_), .b(x76), .O(new_n313_));
  inv1   g139(.a(new_n161_), .O(new_n314_));
  xnor2a g140(.a(x84), .b(x81), .O(new_n315_));
  aoi21  g141(.a(new_n163_), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g142(.a(new_n316_), .b(new_n159_), .O(new_n317_));
  nand2  g143(.a(new_n317_), .b(new_n313_), .O(new_n318_));
  nand2  g144(.a(new_n318_), .b(x79), .O(new_n319_));
  nand4  g145(.a(new_n319_), .b(new_n155_), .c(new_n159_), .d(x00), .O(z56));
  inv1   g146(.a(x02), .O(new_n321_));
  nand4  g147(.a(x03), .b(new_n321_), .c(new_n159_), .d(x00), .O(new_n322_));
  inv1   g148(.a(new_n322_), .O(z57));
  nand4  g149(.a(x80), .b(new_n208_), .c(x43), .d(new_n223_), .O(new_n324_));
  oai22  g150(.a(new_n324_), .b(new_n211_), .c(new_n223_), .d(x40), .O(new_n325_));
  nand4  g151(.a(new_n325_), .b(x79), .c(x78), .d(x04), .O(new_n326_));
  nor2   g152(.a(x79), .b(x78), .O(new_n327_));
  nand3  g153(.a(new_n327_), .b(new_n223_), .c(x40), .O(new_n328_));
  nand2  g154(.a(new_n328_), .b(new_n326_), .O(new_n329_));
  nand2  g155(.a(new_n329_), .b(x77), .O(new_n330_));
  oai21  g156(.a(new_n161_), .b(new_n217_), .c(new_n156_), .O(new_n331_));
  aoi21  g157(.a(new_n331_), .b(new_n330_), .c(x01), .O(z58));
  nor2   g158(.a(new_n154_), .b(new_n217_), .O(new_n333_));
  oai21  g159(.a(new_n333_), .b(new_n327_), .c(x40), .O(new_n334_));
  oai21  g160(.a(new_n211_), .b(new_n209_), .c(new_n223_), .O(new_n335_));
  ...
  nand2  g165(.a(new_n156_), .b(new_n217_), .O(new_n340_));
  aoi21  g166(.a(new_n340_), .b(new_n339_), .c(x01), .O(z59));
  nand2  g167(.a(new_n316_), .b(x79), .O(new_n342_));
  nand3  g168(.a(new_n342_), .b(new_n340_), .c(new_n214_), .O(new_n343_));
  and2   g169(.a(new_n343_), .b(new_n159_), .O(z60));
  nand2  g170(.a(new_n163_), .b(new_n314_), .O(new_n345_));
  nand2  g171(.a(new_n345_), .b(new_n206_), .O(new_n346_));
  oai21  g172(.a(new_n219_), .b(x04), .c(new_n346_), .O(new_n347_));
  nand4  g173(.a(new_n347_), .b(x80), .c(x79), .d(new_n159_), .O(new_n348_));
  inv1   g174(.a(new_n348_), .O(z61));
  nand2  g175(.a(new_n156_), .b(x04), .O(new_n350_));
  ...
  nand3  g179(.a(x81), .b(x79), .c(new_n217_), .O(new_n354_));
  aoi21  g180(.a(new_n354_), .b(new_n353_), .c(new_n153_), .O(new_n355_));
  oai21  g181(.a(new_n355_), .b(new_n352_), .c(x78), .O(new_n356_));
  or2    g182(.a(new_n351_), .b(new_n163_), .O(new_n357_));
  aoi21  g183(.a(new_n357_), .b(new_n356_), .c(x01), .O(z62));
  nand4  g184(.a(new_n347_), .b(x82), .c(x79), .d(new_n159_), .O(new_n359_));
  inv1   g185(.a(new_n359_), .O(z63));
  nand3  g186(.a(new_n347_), .b(x83), .c(x79), .O(new_n361_));
  nand4  g187(.a(new_n156_), .b(x78), .c(new_n153_), .d(x04), .O(new_n362_));
