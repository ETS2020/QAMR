...
module FAU ( 
  ...
  nand4  g089(.a(new_n243_), .b(x46), .c(new_n235_), .d(new_n229_), .O(new_n249_));
  nor2   g090(.a(new_n249_), .b(x01), .O(z28));
  nand4  g091(.a(new_n243_), .b(x47), .c(new_n235_), .d(new_n229_), .O(new_n251_));
  nor2   g092(.a(new_n251_), .b(x01), .O(z29));
  nand4  g093(.a(new_n243_), .b(x48), .c(new_n235_), .d(new_n229_), .O(new_n253_));
  ...
  nand4  g135(.a(new_n280_), .b(x78), .c(x77), .d(x62), .O(new_n298_));
  ...
  nor2   g247(.a(new_n238_), .b(x78), .O(new_n412_));
