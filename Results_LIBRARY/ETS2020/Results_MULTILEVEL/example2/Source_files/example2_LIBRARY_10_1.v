...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n285_, new_n287_, new_n293_, new_n295_, new_n297_, new_n300_,
  ...
  nand4  g159(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n331_));
  oai22  g160(.a(new_n331_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n332_));
  nand4  g161(.a(new_n332_), .b(x79), .c(x78), .d(x04), .O(new_n333_));
  nor2   g162(.a(x79), .b(x78), .O(new_n334_));
  nand3  g163(.a(new_n334_), .b(new_n232_), .c(x40), .O(new_n335_));
  nand2  g164(.a(new_n335_), .b(new_n333_), .O(new_n336_));
  nand2  g165(.a(new_n336_), .b(x77), .O(new_n337_));
  oai21  g166(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n338_));
  aoi21  g167(.a(new_n338_), .b(new_n337_), .c(x01), .O(z58));
  nor2   g168(.a(new_n160_), .b(new_n224_), .O(new_n340_));
  oai21  g169(.a(new_n340_), .b(new_n334_), .c(x40), .O(new_n341_));
  oai21  g170(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n342_));
  ...
  nand2  g175(.a(new_n154_), .b(new_n224_), .O(new_n347_));
  aoi21  g176(.a(new_n347_), .b(new_n346_), .c(x01), .O(z59));
  nand2  g177(.a(new_n325_), .b(x79), .O(new_n349_));
  nand3  g178(.a(new_n349_), .b(new_n347_), .c(new_n222_), .O(new_n350_));
  and2   g179(.a(new_n350_), .b(new_n153_), .O(z60));
  nand2  g180(.a(new_n167_), .b(new_n323_), .O(new_n352_));
  nand2  g181(.a(new_n352_), .b(new_n214_), .O(new_n353_));
  oai21  g182(.a(new_n228_), .b(x04), .c(new_n353_), .O(new_n354_));
  ...
  nand3  g189(.a(x81), .b(x79), .c(new_n224_), .O(new_n361_));
  ...
  nor2   g199(.a(new_n160_), .b(x04), .O(new_n371_));
  nor2   g200(.a(new_n235_), .b(x78), .O(new_n372_));
  oai21  g201(.a(new_n372_), .b(new_n371_), .c(x77), .O(new_n373_));
  nand3  g202(.a(x81), .b(x78), .c(new_n159_), .O(new_n374_));
  nand2  g203(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  nand4  g204(.a(new_n375_), .b(x84), .c(x79), .d(new_n153_), .O(new_n376_));
  inv1   g205(.a(new_n376_), .O(z65));
  zero   g206(.O(z05));
  zero   g207(.O(z06));
  zero   g208(.O(z10));
  zero   g209(.O(z13));
