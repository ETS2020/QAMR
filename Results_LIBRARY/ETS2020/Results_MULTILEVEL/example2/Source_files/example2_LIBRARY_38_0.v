...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n234_, new_n235_, new_n236_, new_n237_, new_n240_, new_n243_,
  ...
  oai21  g062(.a(new_n229_), .b(new_n227_), .c(new_n211_), .O(new_n230_));
  nand2  g063(.a(x83), .b(x42), .O(new_n231_));
  nand2  g064(.a(new_n231_), .b(x81), .O(new_n232_));
  nand3  g065(.a(x83), .b(new_n210_), .c(x42), .O(new_n233_));
  nand2  g066(.a(new_n233_), .b(new_n232_), .O(new_n234_));
  nand2  g067(.a(new_n234_), .b(new_n208_), .O(new_n235_));
  ...
  nand4  g073(.a(new_n236_), .b(x78), .c(x77), .d(x56), .O(new_n243_));
  nor3   g074(.a(new_n243_), .b(x04), .c(x01), .O(z38));
  nand4  g075(.a(new_n236_), .b(x78), .c(x77), .d(x57), .O(new_n245_));
  nor3   g076(.a(new_n245_), .b(x04), .c(x01), .O(z39));
  nand4  g077(.a(new_n236_), .b(x78), .c(x77), .d(x59), .O(new_n248_));
