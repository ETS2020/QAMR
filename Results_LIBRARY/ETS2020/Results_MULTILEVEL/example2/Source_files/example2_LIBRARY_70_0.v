...
module FAU ( 
  ...
  oai21  g074(.a(new_n236_), .b(new_n234_), .c(new_n214_), .O(new_n237_));
  nand2  g075(.a(x83), .b(x42), .O(new_n238_));
  nand2  g076(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g077(.a(x83), .b(new_n213_), .c(x42), .O(new_n240_));
  nand2  g078(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g079(.a(new_n241_), .b(new_n211_), .O(new_n242_));
  ...
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x57), .O(new_n253_));
  nor3   g090(.a(new_n253_), .b(x04), .c(x01), .O(z39));
  nand4  g091(.a(new_n243_), .b(x78), .c(x77), .d(x58), .O(new_n255_));
  nor3   g092(.a(new_n255_), .b(x04), .c(x01), .O(z40));
  nand4  g093(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n258_));
  nor3   g094(.a(new_n258_), .b(x04), .c(x01), .O(z42));
  nand4  g095(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n260_));
  nor3   g096(.a(new_n260_), .b(x04), .c(x01), .O(z43));
  nand4  g097(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n262_));
  nor3   g098(.a(new_n262_), .b(x04), .c(x01), .O(z44));
  nand4  g099(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n264_));
  nor3   g100(.a(new_n264_), .b(x04), .c(x01), .O(z45));
  nand4  g101(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n266_));
  ...
  nor2   g153(.a(new_n275_), .b(x04), .O(new_n328_));
  nor2   g154(.a(new_n213_), .b(x78), .O(new_n329_));
  oai21  g155(.a(new_n329_), .b(new_n328_), .c(x77), .O(new_n330_));
  nand3  g156(.a(x81), .b(x78), .c(new_n269_), .O(new_n331_));
  nand2  g157(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand4  g158(.a(new_n332_), .b(x84), .c(x79), .d(new_n155_), .O(new_n333_));
  inv1   g159(.a(new_n333_), .O(z65));
  zero   g160(.O(z00));
  zero   g161(.O(z01));
  zero   g162(.O(z02));
  zero   g163(.O(z12));
