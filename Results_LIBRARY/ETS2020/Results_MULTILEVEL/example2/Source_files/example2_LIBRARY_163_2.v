...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n251_, new_n253_, new_n255_, new_n258_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n277_, new_n278_, new_n279_, new_n280_, new_n281_, new_n282_,
    new_n283_, new_n284_, new_n288_, new_n290_, new_n292_, new_n294_,
  ...
  nor2   g117(.a(new_n225_), .b(new_n238_), .O(new_n277_));
  nand3  g118(.a(x83), .b(x81), .c(x42), .O(new_n278_));
  oai21  g119(.a(new_n277_), .b(x81), .c(new_n278_), .O(new_n279_));
  nand2  g120(.a(new_n279_), .b(new_n242_), .O(new_n280_));
  oai22  g121(.a(new_n277_), .b(new_n241_), .c(new_n261_), .d(new_n238_), .O(new_n281_));
  nand2  g122(.a(new_n281_), .b(new_n239_), .O(new_n282_));
  ...
  nand4  g126(.a(new_n283_), .b(x78), .c(x77), .d(x56), .O(new_n288_));
  nor3   g127(.a(new_n288_), .b(x04), .c(x01), .O(z38));
  nand4  g128(.a(new_n283_), .b(x78), .c(x77), .d(x57), .O(new_n290_));
  ...
  nand4  g134(.a(new_n283_), .b(x78), .c(x77), .d(x60), .O(new_n296_));
  ...
  nand2  g194(.a(new_n358_), .b(new_n241_), .O(new_n359_));
  nor4   g195(.a(new_n359_), .b(new_n355_), .c(new_n225_), .d(x82), .O(z55));
  nand2  g196(.a(new_n234_), .b(x76), .O(new_n361_));
  ...
  nand4  g207(.a(x80), .b(new_n223_), .c(x43), .d(new_n238_), .O(new_n372_));
  oai22  g208(.a(new_n372_), .b(new_n226_), .c(new_n238_), .d(x40), .O(new_n373_));
  nand4  g209(.a(new_n373_), .b(x79), .c(x78), .d(x04), .O(new_n374_));
  nor2   g210(.a(x79), .b(x78), .O(new_n375_));
  nand3  g211(.a(new_n375_), .b(new_n238_), .c(x40), .O(new_n376_));
  ...
  oai21  g218(.a(new_n226_), .b(new_n224_), .c(new_n238_), .O(new_n383_));
  ...
  oai21  g230(.a(new_n234_), .b(x04), .c(new_n394_), .O(new_n395_));
  ...
  nor2   g248(.a(new_n241_), .b(x78), .O(new_n413_));
