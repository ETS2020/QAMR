...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n284_, new_n285_, new_n286_, new_n290_, new_n292_,
    new_n294_, new_n296_, new_n298_, new_n303_, new_n305_, new_n306_,
    ...
    new_n406_, new_n407_, new_n409_, new_n411_, new_n412_;
  ...
  nor2   g121(.a(new_n225_), .b(new_n239_), .O(new_n279_));
  ...
  nand4  g130(.a(new_n285_), .b(x78), .c(x77), .d(x56), .O(new_n290_));
  nor3   g131(.a(new_n290_), .b(x04), .c(x01), .O(z38));
  nand4  g132(.a(new_n285_), .b(x78), .c(x77), .d(x57), .O(new_n292_));
  ...
  nand4  g138(.a(new_n285_), .b(x78), .c(x77), .d(x60), .O(new_n298_));
  nor3   g139(.a(new_n298_), .b(x04), .c(x01), .O(z42));
  nand4  g140(.a(new_n285_), .b(x78), .c(x77), .d(x64), .O(new_n303_));
  nor3   g141(.a(new_n303_), .b(x04), .c(x01), .O(z46));
  ...
  nand2  g198(.a(new_n360_), .b(new_n242_), .O(new_n361_));
  nor4   g199(.a(new_n361_), .b(new_n357_), .c(new_n225_), .d(x82), .O(z55));
  nand2  g200(.a(new_n235_), .b(x76), .O(new_n363_));
  ...
  nand4  g209(.a(x03), .b(new_n371_), .c(new_n153_), .d(x00), .O(new_n372_));
  inv1   g210(.a(new_n372_), .O(z57));
  nand4  g211(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n374_));
  oai22  g212(.a(new_n374_), .b(new_n226_), .c(new_n239_), .d(x40), .O(new_n375_));
  nand4  g213(.a(new_n375_), .b(x79), .c(x78), .d(x04), .O(new_n376_));
  nor2   g214(.a(x79), .b(x78), .O(new_n377_));
  nand3  g215(.a(new_n377_), .b(new_n239_), .c(x40), .O(new_n378_));
  nand2  g216(.a(new_n378_), .b(new_n376_), .O(new_n379_));
  nand2  g217(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g218(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n381_));
  aoi21  g219(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  nor2   g220(.a(new_n160_), .b(new_n231_), .O(new_n383_));
  oai21  g221(.a(new_n383_), .b(new_n377_), .c(x40), .O(new_n384_));
  oai21  g222(.a(new_n226_), .b(new_n224_), .c(new_n239_), .O(new_n385_));
  nand2  g223(.a(new_n385_), .b(x79), .O(new_n386_));
  nand3  g224(.a(new_n386_), .b(x78), .c(x04), .O(new_n387_));
  nand2  g225(.a(new_n387_), .b(new_n384_), .O(new_n388_));
  nand2  g226(.a(new_n388_), .b(x77), .O(new_n389_));
  nand2  g227(.a(new_n154_), .b(new_n231_), .O(new_n390_));
  aoi21  g228(.a(new_n390_), .b(new_n389_), .c(x01), .O(z59));
  nand2  g229(.a(new_n366_), .b(x79), .O(new_n392_));
  nand3  g230(.a(new_n392_), .b(new_n390_), .c(new_n229_), .O(new_n393_));
  and2   g231(.a(new_n393_), .b(new_n153_), .O(z60));
  nand2  g232(.a(new_n167_), .b(new_n364_), .O(new_n395_));
  nand2  g233(.a(new_n395_), .b(new_n221_), .O(new_n396_));
  oai21  g234(.a(new_n235_), .b(x04), .c(new_n396_), .O(new_n397_));
  nand4  g235(.a(new_n397_), .b(x80), .c(x79), .d(new_n153_), .O(new_n398_));
  inv1   g236(.a(new_n398_), .O(z61));
  nand2  g237(.a(new_n154_), .b(x04), .O(new_n400_));
  nand3  g238(.a(x84), .b(x81), .c(x79), .O(new_n401_));
  aoi21  g239(.a(new_n401_), .b(new_n400_), .c(x77), .O(new_n402_));
  nand2  g240(.a(new_n386_), .b(x04), .O(new_n403_));
  nand3  g241(.a(x81), .b(x79), .c(new_n231_), .O(new_n404_));
  aoi21  g242(.a(new_n404_), .b(new_n403_), .c(new_n159_), .O(new_n405_));
  oai21  g243(.a(new_n405_), .b(new_n402_), .c(x78), .O(new_n406_));
  or2    g244(.a(new_n401_), .b(new_n167_), .O(new_n407_));
  aoi21  g245(.a(new_n407_), .b(new_n406_), .c(x01), .O(z62));
  nand4  g246(.a(new_n397_), .b(x82), .c(x79), .d(new_n153_), .O(new_n409_));
  inv1   g247(.a(new_n409_), .O(z63));
  nand3  g248(.a(new_n397_), .b(x83), .c(x79), .O(new_n411_));
  nand4  g249(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n412_));
  aoi21  g250(.a(new_n412_), .b(new_n411_), .c(x01), .O(z64));
  zero   g251(.O(z03));
  zero   g252(.O(z07));
  zero   g253(.O(z10));
  zero   g254(.O(z11));
