...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n166_, new_n167_, new_n168_, new_n169_, new_n171_, new_n178_,
    ...
    new_n286_, new_n289_, new_n291_, new_n295_, new_n299_, new_n300_,
  ...
  inv1   g021(.a(x27), .O(new_n178_));
  nand2  g022(.a(x61), .b(x40), .O(new_n179_));
  oai21  g023(.a(x40), .b(new_n178_), .c(new_n179_), .O(z09));
  ...
  nand4  g131(.a(new_n278_), .b(x78), .c(x77), .d(x62), .O(new_n295_));
  ...
  nor2   g239(.a(new_n160_), .b(x04), .O(new_n406_));
  nor2   g240(.a(new_n235_), .b(x78), .O(new_n407_));
  oai21  g241(.a(new_n407_), .b(new_n406_), .c(x77), .O(new_n408_));
  nand3  g242(.a(x81), .b(x78), .c(new_n159_), .O(new_n409_));
  nand2  g243(.a(new_n409_), .b(new_n408_), .O(new_n410_));
  nand4  g244(.a(new_n410_), .b(x84), .c(x79), .d(new_n153_), .O(new_n411_));
  inv1   g245(.a(new_n411_), .O(z65));
  zero   g246(.O(z04));
  zero   g247(.O(z05));
  zero   g248(.O(z06));
  zero   g249(.O(z07));
