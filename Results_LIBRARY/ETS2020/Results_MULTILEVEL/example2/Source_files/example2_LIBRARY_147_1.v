...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n253_, new_n255_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n283_, new_n285_, new_n290_, new_n293_, new_n295_, new_n297_,
  ...
  nand4  g095(.a(new_n246_), .b(x47), .c(new_n238_), .d(new_n230_), .O(new_n253_));
  nor2   g096(.a(new_n253_), .b(x01), .O(z29));
  nand4  g097(.a(new_n246_), .b(x48), .c(new_n238_), .d(new_n230_), .O(new_n255_));
  nor2   g098(.a(new_n255_), .b(x01), .O(z30));
  nand2  g099(.a(x83), .b(new_n241_), .O(new_n259_));
  nand2  g100(.a(new_n224_), .b(x81), .O(new_n260_));
  nand2  g101(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand3  g102(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g103(.a(x81), .b(x51), .c(new_n238_), .O(new_n263_));
  ...
  nand3  g108(.a(new_n241_), .b(x51), .c(new_n238_), .O(new_n268_));
  nand2  g109(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand2  g110(.a(new_n269_), .b(new_n242_), .O(new_n270_));
  ...
  nor2   g114(.a(new_n224_), .b(new_n238_), .O(new_n274_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  oai21  g116(.a(new_n274_), .b(x81), .c(new_n275_), .O(new_n276_));
  nand2  g117(.a(new_n276_), .b(new_n242_), .O(new_n277_));
  oai22  g118(.a(new_n274_), .b(new_n241_), .c(new_n259_), .d(new_n238_), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n239_), .O(new_n279_));
  ...
  nand4  g129(.a(new_n280_), .b(x78), .c(x77), .d(x60), .O(new_n293_));
  nor3   g130(.a(new_n293_), .b(x04), .c(x01), .O(z42));
  nand4  g131(.a(new_n280_), .b(x78), .c(x77), .d(x61), .O(new_n295_));
  nor3   g132(.a(new_n295_), .b(x04), .c(x01), .O(z43));
  ...
  nor2   g143(.a(new_n307_), .b(new_n219_), .O(new_n308_));
  nand4  g144(.a(new_n308_), .b(x79), .c(new_n160_), .d(x77), .O(new_n309_));
  aoi21  g145(.a(new_n309_), .b(new_n306_), .c(x01), .O(z47));
  nand2  g146(.a(x52), .b(x22), .O(new_n317_));
  nand2  g147(.a(new_n303_), .b(x14), .O(new_n318_));
  aoi21  g148(.a(new_n318_), .b(new_n317_), .c(x79), .O(new_n319_));
  nand4  g149(.a(new_n319_), .b(x78), .c(new_n159_), .d(x04), .O(new_n320_));
  nor2   g150(.a(new_n320_), .b(x01), .O(z54));
  inv1   g151(.a(x84), .O(new_n322_));
  nor2   g152(.a(x04), .b(x01), .O(new_n323_));
  nand4  g153(.a(new_n323_), .b(x79), .c(x78), .d(x77), .O(new_n324_));
  nor2   g154(.a(new_n324_), .b(x80), .O(new_n325_));
  nand2  g155(.a(new_n325_), .b(new_n241_), .O(new_n326_));
  nor4   g156(.a(new_n326_), .b(new_n322_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g157(.a(new_n234_), .b(x76), .O(new_n328_));
  inv1   g158(.a(new_n165_), .O(new_n329_));
  xnor2a g159(.a(x84), .b(x81), .O(new_n330_));
  aoi21  g160(.a(new_n167_), .b(new_n329_), .c(new_n330_), .O(new_n331_));
  nand2  g161(.a(new_n331_), .b(new_n153_), .O(new_n332_));
  nand2  g162(.a(new_n332_), .b(new_n328_), .O(new_n333_));
  nand2  g163(.a(new_n333_), .b(x79), .O(new_n334_));
  nand4  g164(.a(new_n334_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g165(.a(x02), .O(new_n336_));
  nand4  g166(.a(x03), .b(new_n336_), .c(new_n153_), .d(x00), .O(new_n337_));
  inv1   g167(.a(new_n337_), .O(z57));
  nand4  g168(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n339_));
  oai22  g169(.a(new_n339_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n340_));
  nand4  g170(.a(new_n340_), .b(x79), .c(x78), .d(x04), .O(new_n341_));
  nor2   g171(.a(x79), .b(x78), .O(new_n342_));
  nand3  g172(.a(new_n342_), .b(new_n238_), .c(x40), .O(new_n343_));
  nand2  g173(.a(new_n343_), .b(new_n341_), .O(new_n344_));
  nand2  g174(.a(new_n344_), .b(x77), .O(new_n345_));
  oai21  g175(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n346_));
  aoi21  g176(.a(new_n346_), .b(new_n345_), .c(x01), .O(z58));
  nor2   g177(.a(new_n160_), .b(new_n230_), .O(new_n348_));
  oai21  g178(.a(new_n348_), .b(new_n342_), .c(x40), .O(new_n349_));
  oai21  g179(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n350_));
  nand2  g180(.a(new_n350_), .b(x79), .O(new_n351_));
  nand3  g181(.a(new_n351_), .b(x78), .c(x04), .O(new_n352_));
  nand2  g182(.a(new_n352_), .b(new_n349_), .O(new_n353_));
  nand2  g183(.a(new_n353_), .b(x77), .O(new_n354_));
  nand2  g184(.a(new_n154_), .b(new_n230_), .O(new_n355_));
  aoi21  g185(.a(new_n355_), .b(new_n354_), .c(x01), .O(z59));
  nand2  g186(.a(new_n331_), .b(x79), .O(new_n357_));
  nand3  g187(.a(new_n357_), .b(new_n355_), .c(new_n228_), .O(new_n358_));
  and2   g188(.a(new_n358_), .b(new_n153_), .O(z60));
  nand2  g189(.a(new_n167_), .b(new_n329_), .O(new_n360_));
  nand2  g190(.a(new_n360_), .b(new_n220_), .O(new_n361_));
  oai21  g191(.a(new_n234_), .b(x04), .c(new_n361_), .O(new_n362_));
  nand4  g192(.a(new_n362_), .b(x80), .c(x79), .d(new_n153_), .O(new_n363_));
  inv1   g193(.a(new_n363_), .O(z61));
  nand2  g194(.a(new_n154_), .b(x04), .O(new_n365_));
  nand3  g195(.a(x84), .b(x81), .c(x79), .O(new_n366_));
  aoi21  g196(.a(new_n366_), .b(new_n365_), .c(x77), .O(new_n367_));
  nand2  g197(.a(new_n351_), .b(x04), .O(new_n368_));
  nand3  g198(.a(x81), .b(x79), .c(new_n230_), .O(new_n369_));
  aoi21  g199(.a(new_n369_), .b(new_n368_), .c(new_n159_), .O(new_n370_));
  oai21  g200(.a(new_n370_), .b(new_n367_), .c(x78), .O(new_n371_));
  or2    g201(.a(new_n366_), .b(new_n167_), .O(new_n372_));
  aoi21  g202(.a(new_n372_), .b(new_n371_), .c(x01), .O(z62));
  nand4  g203(.a(new_n362_), .b(x82), .c(x79), .d(new_n153_), .O(new_n374_));
  inv1   g204(.a(new_n374_), .O(z63));
  nand3  g205(.a(new_n362_), .b(x83), .c(x79), .O(new_n376_));
  nand4  g206(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n377_));
  aoi21  g207(.a(new_n377_), .b(new_n376_), .c(x01), .O(z64));
  nor2   g208(.a(new_n160_), .b(x04), .O(new_n379_));
  nor2   g209(.a(new_n241_), .b(x78), .O(new_n380_));
  oai21  g210(.a(new_n380_), .b(new_n379_), .c(x77), .O(new_n381_));
  nand3  g211(.a(x81), .b(x78), .c(new_n159_), .O(new_n382_));
  nand2  g212(.a(new_n382_), .b(new_n381_), .O(new_n383_));
  nand4  g213(.a(new_n383_), .b(x84), .c(x79), .d(new_n153_), .O(new_n384_));
  inv1   g214(.a(new_n384_), .O(z65));
  zero   g215(.O(z05));
  zero   g216(.O(z06));
  zero   g217(.O(z14));
  zero   g218(.O(z16));
