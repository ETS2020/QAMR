...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n277_, new_n278_, new_n280_, new_n283_, new_n285_,
  ...
  nor2   g110(.a(new_n218_), .b(new_n232_), .O(new_n271_));
  ...
  nand4  g139(.a(new_n277_), .b(x78), .c(x77), .d(x64), .O(new_n301_));
  ...
  nor2   g147(.a(new_n308_), .b(new_n213_), .O(new_n309_));
  ...
  nand4  g154(.a(new_n214_), .b(x79), .c(new_n160_), .d(x77), .O(new_n316_));
  ...
  nor4   g198(.a(new_n359_), .b(new_n355_), .c(new_n218_), .d(x82), .O(z55));
  ...
  nand4  g210(.a(x80), .b(new_n216_), .c(x43), .d(new_n232_), .O(new_n372_));
  oai22  g211(.a(new_n372_), .b(new_n219_), .c(new_n232_), .d(x40), .O(new_n373_));
  ...
  oai21  g217(.a(new_n165_), .b(new_n224_), .c(new_n154_), .O(new_n379_));
  aoi21  g218(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nor2   g219(.a(new_n160_), .b(new_n224_), .O(new_n381_));
  oai21  g220(.a(new_n381_), .b(new_n375_), .c(x40), .O(new_n382_));
  oai21  g221(.a(new_n219_), .b(new_n217_), .c(new_n232_), .O(new_n383_));
  ...
  nand3  g240(.a(x81), .b(x79), .c(new_n224_), .O(new_n402_));
  ...
  nor2   g251(.a(new_n235_), .b(x78), .O(new_n413_));
