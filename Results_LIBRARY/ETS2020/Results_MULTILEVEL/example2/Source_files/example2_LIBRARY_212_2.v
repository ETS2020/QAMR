...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n290_, new_n293_, new_n296_, new_n298_, new_n300_, new_n302_,
  ...
  nand4  g216(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n226_), .c(new_n239_), .d(x40), .O(new_n377_));
  nand4  g218(.a(new_n377_), .b(x79), .c(x78), .d(x04), .O(new_n378_));
  nor2   g219(.a(x79), .b(x78), .O(new_n379_));
  nand3  g220(.a(new_n379_), .b(new_n239_), .c(x40), .O(new_n380_));
  nand2  g221(.a(new_n380_), .b(new_n378_), .O(new_n381_));
  nand2  g222(.a(new_n381_), .b(x77), .O(new_n382_));
  oai21  g223(.a(new_n165_), .b(new_n231_), .c(new_n154_), .O(new_n383_));
  aoi21  g224(.a(new_n383_), .b(new_n382_), .c(x01), .O(z58));
  nor2   g225(.a(new_n160_), .b(new_n231_), .O(new_n385_));
  oai21  g226(.a(new_n385_), .b(new_n379_), .c(x40), .O(new_n386_));
  oai21  g227(.a(new_n226_), .b(new_n224_), .c(new_n239_), .O(new_n387_));
  ...
  nand2  g232(.a(new_n154_), .b(new_n231_), .O(new_n392_));
  aoi21  g233(.a(new_n392_), .b(new_n391_), .c(x01), .O(z59));
  nand2  g234(.a(new_n370_), .b(x79), .O(new_n394_));
  nand3  g235(.a(new_n394_), .b(new_n392_), .c(new_n229_), .O(new_n395_));
  and2   g236(.a(new_n395_), .b(new_n153_), .O(z60));
  nand2  g237(.a(new_n167_), .b(new_n368_), .O(new_n397_));
  nand2  g238(.a(new_n397_), .b(new_n221_), .O(new_n398_));
  oai21  g239(.a(new_n235_), .b(x04), .c(new_n398_), .O(new_n399_));
  ...
  nand3  g246(.a(x81), .b(x79), .c(new_n231_), .O(new_n406_));
  ...
  nor2   g257(.a(new_n242_), .b(x78), .O(new_n417_));
