...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n213_, new_n214_, new_n217_, new_n221_, new_n223_, new_n227_,
    new_n228_, new_n229_, new_n230_, new_n231_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n239_, new_n241_,
    new_n243_, new_n246_, new_n250_, new_n252_, new_n254_, new_n256_,
  ...
  nand4  g055(.a(new_n213_), .b(x48), .c(new_n205_), .d(new_n201_), .O(new_n221_));
  nor2   g056(.a(new_n221_), .b(x01), .O(z30));
  nand4  g057(.a(new_n213_), .b(x49), .c(new_n205_), .d(new_n201_), .O(new_n223_));
  ...
  nand4  g077(.a(new_n236_), .b(x78), .c(x77), .d(x57), .O(new_n246_));
  nor3   g078(.a(new_n246_), .b(x04), .c(x01), .O(z39));
  nand4  g079(.a(new_n236_), .b(x78), .c(x77), .d(x60), .O(new_n250_));
  nor3   g080(.a(new_n250_), .b(x04), .c(x01), .O(z42));
  nand4  g081(.a(new_n236_), .b(x78), .c(x77), .d(x61), .O(new_n252_));
  nor3   g082(.a(new_n252_), .b(x04), .c(x01), .O(z43));
  nand4  g083(.a(new_n236_), .b(x78), .c(x77), .d(x62), .O(new_n254_));
  nor3   g084(.a(new_n254_), .b(x04), .c(x01), .O(z44));
  nand4  g085(.a(new_n236_), .b(x78), .c(x77), .d(x63), .O(new_n256_));
  nor3   g086(.a(new_n256_), .b(x04), .c(x01), .O(z45));
  nand4  g087(.a(new_n236_), .b(x78), .c(x77), .d(x64), .O(new_n258_));
  nor3   g088(.a(new_n258_), .b(x04), .c(x01), .O(z46));
  inv1   g089(.a(x77), .O(new_n261_));
  nand2  g090(.a(x52), .b(x16), .O(new_n262_));
  inv1   g091(.a(x52), .O(new_n263_));
  nand2  g092(.a(new_n263_), .b(x08), .O(new_n264_));
  aoi21  g093(.a(new_n264_), .b(new_n262_), .c(x79), .O(new_n265_));
  nand4  g094(.a(new_n265_), .b(x78), .c(new_n261_), .d(x04), .O(new_n266_));
  inv1   g095(.a(x78), .O(new_n267_));
  xnor2a g096(.a(x84), .b(x81), .O(new_n268_));
  nand4  g097(.a(new_n268_), .b(x79), .c(new_n267_), .d(x77), .O(new_n269_));
  inv1   g098(.a(new_n269_), .O(new_n270_));
  nand2  g099(.a(new_n270_), .b(x68), .O(new_n271_));
  aoi21  g100(.a(new_n271_), .b(new_n266_), .c(x01), .O(z48));
  nand2  g101(.a(x52), .b(x17), .O(new_n273_));
  nand2  g102(.a(new_n263_), .b(x09), .O(new_n274_));
  aoi21  g103(.a(new_n274_), .b(new_n273_), .c(x79), .O(new_n275_));
  nand4  g104(.a(new_n275_), .b(x78), .c(new_n261_), .d(x04), .O(new_n276_));
  nand2  g105(.a(new_n270_), .b(x69), .O(new_n277_));
  aoi21  g106(.a(new_n277_), .b(new_n276_), .c(x01), .O(z49));
  nand2  g107(.a(x52), .b(x18), .O(new_n279_));
  nand2  g108(.a(new_n263_), .b(x10), .O(new_n280_));
  aoi21  g109(.a(new_n280_), .b(new_n279_), .c(x79), .O(new_n281_));
  nand4  g110(.a(new_n281_), .b(x78), .c(new_n261_), .d(x04), .O(new_n282_));
  nand2  g111(.a(new_n270_), .b(x70), .O(new_n283_));
  aoi21  g112(.a(new_n283_), .b(new_n282_), .c(x01), .O(z50));
  nand2  g113(.a(x52), .b(x19), .O(new_n285_));
  nand2  g114(.a(new_n263_), .b(x11), .O(new_n286_));
  aoi21  g115(.a(new_n286_), .b(new_n285_), .c(x79), .O(new_n287_));
  nand4  g116(.a(new_n287_), .b(x78), .c(new_n261_), .d(x04), .O(new_n288_));
  nand2  g117(.a(new_n270_), .b(x71), .O(new_n289_));
  aoi21  g118(.a(new_n289_), .b(new_n288_), .c(x01), .O(z51));
  nand2  g119(.a(x52), .b(x20), .O(new_n291_));
  nand2  g120(.a(new_n263_), .b(x12), .O(new_n292_));
  aoi21  g121(.a(new_n292_), .b(new_n291_), .c(x79), .O(new_n293_));
  nand4  g122(.a(new_n293_), .b(x78), .c(new_n261_), .d(x04), .O(new_n294_));
  nand2  g123(.a(new_n270_), .b(x72), .O(new_n295_));
  aoi21  g124(.a(new_n295_), .b(new_n294_), .c(x01), .O(z52));
  nand2  g125(.a(x52), .b(x21), .O(new_n297_));
  nand2  g126(.a(new_n263_), .b(x13), .O(new_n298_));
  aoi21  g127(.a(new_n298_), .b(new_n297_), .c(x79), .O(new_n299_));
  nand4  g128(.a(new_n299_), .b(x78), .c(new_n261_), .d(x04), .O(new_n300_));
  nand2  g129(.a(new_n270_), .b(x73), .O(new_n301_));
  aoi21  g130(.a(new_n301_), .b(new_n300_), .c(x01), .O(z53));
  nand2  g131(.a(x52), .b(x22), .O(new_n303_));
  nand2  g132(.a(new_n263_), .b(x14), .O(new_n304_));
  aoi21  g133(.a(new_n304_), .b(new_n303_), .c(x79), .O(new_n305_));
  nand4  g134(.a(new_n305_), .b(x78), .c(new_n261_), .d(x04), .O(new_n306_));
  nor2   g135(.a(new_n306_), .b(x01), .O(z54));
  inv1   g136(.a(x02), .O(new_n310_));
  nand4  g137(.a(x03), .b(new_n310_), .c(new_n155_), .d(x00), .O(new_n311_));
  inv1   g138(.a(new_n311_), .O(z57));
  nor2   g139(.a(new_n267_), .b(x04), .O(new_n320_));
  nor2   g140(.a(new_n208_), .b(x78), .O(new_n321_));
  oai21  g141(.a(new_n321_), .b(new_n320_), .c(x77), .O(new_n322_));
  nand3  g142(.a(x81), .b(x78), .c(new_n261_), .O(new_n323_));
  nand2  g143(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  nand4  g144(.a(new_n324_), .b(x84), .c(x79), .d(new_n155_), .O(new_n325_));
