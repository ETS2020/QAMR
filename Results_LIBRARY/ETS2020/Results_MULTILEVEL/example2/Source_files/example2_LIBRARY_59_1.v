// Benchmark "FAU" written by ABC on Fri Jul 24 22:40:57 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n229_, new_n231_, new_n232_, new_n233_, new_n234_, new_n242_,
    new_n243_, new_n244_, new_n245_, new_n246_, new_n247_, new_n248_,
    new_n249_, new_n250_, new_n251_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n278_, new_n280_, new_n282_, new_n284_, new_n287_,
    new_n289_, new_n291_, new_n293_, new_n296_, new_n299_, new_n300_,
  ...
  inv1   g079(.a(x42), .O(new_n242_));
  xnor2a g080(.a(x84), .b(x82), .O(new_n243_));
  nand2  g081(.a(new_n243_), .b(x81), .O(new_n244_));
  inv1   g082(.a(x81), .O(new_n245_));
  xor2a  g083(.a(x84), .b(x82), .O(new_n246_));
  nand2  g084(.a(new_n246_), .b(new_n245_), .O(new_n247_));
  nand2  g085(.a(new_n247_), .b(new_n244_), .O(new_n248_));
  nand4  g086(.a(new_n248_), .b(x79), .c(x78), .d(x77), .O(new_n249_));
  inv1   g087(.a(new_n249_), .O(new_n250_));
  nand4  g088(.a(new_n250_), .b(x49), .c(new_n242_), .d(new_n228_), .O(new_n251_));
  nor2   g089(.a(new_n251_), .b(x01), .O(z31));
  nand2  g090(.a(x83), .b(new_n245_), .O(new_n254_));
  nand2  g091(.a(new_n222_), .b(x81), .O(new_n255_));
  nand2  g092(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand3  g093(.a(new_n256_), .b(x42), .c(x05), .O(new_n257_));
  nand3  g094(.a(x81), .b(x51), .c(new_n242_), .O(new_n258_));
  nand2  g095(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g096(.a(new_n259_), .b(new_n243_), .O(new_n260_));
  xnor2a g097(.a(x83), .b(x81), .O(new_n261_));
  nand3  g098(.a(new_n261_), .b(x42), .c(x05), .O(new_n262_));
  nand3  g099(.a(new_n245_), .b(x51), .c(new_n242_), .O(new_n263_));
  nand2  g100(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  nand2  g101(.a(new_n264_), .b(new_n246_), .O(new_n265_));
  aoi21  g102(.a(new_n265_), .b(new_n260_), .c(new_n154_), .O(new_n266_));
  nand4  g103(.a(new_n266_), .b(x78), .c(x77), .d(new_n228_), .O(new_n267_));
  nor2   g104(.a(new_n267_), .b(x01), .O(z33));
  nor2   g105(.a(new_n222_), .b(new_n242_), .O(new_n269_));
  nand3  g106(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  oai21  g107(.a(new_n269_), .b(x81), .c(new_n270_), .O(new_n271_));
  nand2  g108(.a(new_n271_), .b(new_n246_), .O(new_n272_));
  oai22  g109(.a(new_n269_), .b(new_n245_), .c(new_n254_), .d(new_n242_), .O(new_n273_));
  nand2  g110(.a(new_n273_), .b(new_n243_), .O(new_n274_));
  aoi21  g111(.a(new_n274_), .b(new_n272_), .c(new_n154_), .O(new_n275_));
  nand4  g112(.a(new_n275_), .b(x78), .c(x77), .d(x52), .O(new_n276_));
  nor3   g113(.a(new_n276_), .b(x04), .c(x01), .O(z34));
  nand4  g114(.a(new_n275_), .b(x78), .c(x77), .d(x53), .O(new_n278_));
  nor3   g115(.a(new_n278_), .b(x04), .c(x01), .O(z35));
  nand4  g116(.a(new_n275_), .b(x78), .c(x77), .d(x54), .O(new_n280_));
  nor3   g117(.a(new_n280_), .b(x04), .c(x01), .O(z36));
  nand4  g118(.a(new_n275_), .b(x78), .c(x77), .d(x55), .O(new_n282_));
  nor3   g119(.a(new_n282_), .b(x04), .c(x01), .O(z37));
  nand4  g120(.a(new_n275_), .b(x78), .c(x77), .d(x56), .O(new_n284_));
  nor3   g121(.a(new_n284_), .b(x04), .c(x01), .O(z38));
  nand4  g122(.a(new_n275_), .b(x78), .c(x77), .d(x58), .O(new_n287_));
  nor3   g123(.a(new_n287_), .b(x04), .c(x01), .O(z40));
  nand4  g124(.a(new_n275_), .b(x78), .c(x77), .d(x59), .O(new_n289_));
  nor3   g125(.a(new_n289_), .b(x04), .c(x01), .O(z41));
  nand4  g126(.a(new_n275_), .b(x78), .c(x77), .d(x60), .O(new_n291_));
  nor3   g127(.a(new_n291_), .b(x04), .c(x01), .O(z42));
  nand4  g128(.a(new_n275_), .b(x78), .c(x77), .d(x61), .O(new_n293_));
  nor3   g129(.a(new_n293_), .b(x04), .c(x01), .O(z43));
  nand4  g130(.a(new_n275_), .b(x78), .c(x77), .d(x63), .O(new_n296_));
  ...
  inv1   g141(.a(x84), .O(new_n315_));
  nor2   g142(.a(x04), .b(x01), .O(new_n316_));
  nand4  g143(.a(new_n316_), .b(x79), .c(x78), .d(x77), .O(new_n317_));
  nor2   g144(.a(new_n317_), .b(x80), .O(new_n318_));
  nand2  g145(.a(new_n318_), .b(new_n245_), .O(new_n319_));
  nor4   g146(.a(new_n319_), .b(new_n315_), .c(new_n222_), .d(x82), .O(z55));
  nand2  g147(.a(new_n232_), .b(x76), .O(new_n321_));
  inv1   g148(.a(new_n165_), .O(new_n322_));
  xnor2a g149(.a(x84), .b(x81), .O(new_n323_));
  aoi21  g150(.a(new_n167_), .b(new_n322_), .c(new_n323_), .O(new_n324_));
  nand2  g151(.a(new_n324_), .b(new_n153_), .O(new_n325_));
  nand2  g152(.a(new_n325_), .b(new_n321_), .O(new_n326_));
  nand2  g153(.a(new_n326_), .b(x79), .O(new_n327_));
  nand4  g154(.a(new_n327_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g155(.a(x02), .O(new_n329_));
  nand4  g156(.a(x03), .b(new_n329_), .c(new_n153_), .d(x00), .O(new_n330_));
  inv1   g157(.a(new_n330_), .O(z57));
  nand4  g158(.a(x80), .b(new_n220_), .c(x43), .d(new_n242_), .O(new_n332_));
  oai22  g159(.a(new_n332_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n333_));
  nand4  g160(.a(new_n333_), .b(x79), .c(x78), .d(x04), .O(new_n334_));
  nand4  g161(.a(new_n154_), .b(new_n160_), .c(new_n242_), .d(x40), .O(new_n335_));
  ...
  nand2  g166(.a(new_n324_), .b(x79), .O(new_n341_));
  nand2  g167(.a(new_n154_), .b(new_n228_), .O(new_n342_));
  nand3  g168(.a(new_n342_), .b(new_n341_), .c(new_n226_), .O(new_n343_));
  and2   g169(.a(new_n343_), .b(new_n153_), .O(z60));
  nand2  g170(.a(new_n167_), .b(new_n322_), .O(new_n345_));
  nand2  g171(.a(new_n345_), .b(new_n218_), .O(new_n346_));
  oai21  g172(.a(new_n232_), .b(x04), .c(new_n346_), .O(new_n347_));
  ...
  oai21  g178(.a(new_n223_), .b(new_n221_), .c(new_n242_), .O(new_n353_));
  nand2  g179(.a(new_n353_), .b(x79), .O(new_n354_));
  nand2  g180(.a(new_n354_), .b(x04), .O(new_n355_));
  nand3  g181(.a(x81), .b(x79), .c(new_n228_), .O(new_n356_));
  aoi21  g182(.a(new_n356_), .b(new_n355_), .c(new_n159_), .O(new_n357_));
  oai21  g183(.a(new_n357_), .b(new_n352_), .c(x78), .O(new_n358_));
  or2    g184(.a(new_n351_), .b(new_n167_), .O(new_n359_));
  aoi21  g185(.a(new_n359_), .b(new_n358_), .c(x01), .O(z62));
  nand4  g186(.a(new_n347_), .b(x82), .c(x79), .d(new_n153_), .O(new_n361_));
  inv1   g187(.a(new_n361_), .O(z63));
  nand3  g188(.a(new_n347_), .b(x83), .c(x79), .O(new_n363_));
