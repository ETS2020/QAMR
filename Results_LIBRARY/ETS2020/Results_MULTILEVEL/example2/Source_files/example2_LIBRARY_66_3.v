...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n257_, new_n259_, new_n263_, new_n265_, new_n267_, new_n268_,
  ...
  nand4  g140(.a(new_n288_), .b(x78), .c(x77), .d(x55), .O(new_n295_));
  nor3   g141(.a(new_n295_), .b(x04), .c(x01), .O(z37));
  nand4  g142(.a(new_n288_), .b(x78), .c(x77), .d(x56), .O(new_n297_));
  nor3   g143(.a(new_n297_), .b(x04), .c(x01), .O(z38));
  nand4  g144(.a(new_n288_), .b(x78), .c(x77), .d(x57), .O(new_n299_));
  nor3   g145(.a(new_n299_), .b(x04), .c(x01), .O(z39));
  nand4  g146(.a(new_n288_), .b(x78), .c(x77), .d(x58), .O(new_n301_));
  nor3   g147(.a(new_n301_), .b(x04), .c(x01), .O(z40));
  nand4  g148(.a(new_n288_), .b(x78), .c(x77), .d(x59), .O(new_n303_));
  nor3   g149(.a(new_n303_), .b(x04), .c(x01), .O(z41));
  nand4  g150(.a(new_n288_), .b(x78), .c(x77), .d(x60), .O(new_n305_));
  nor3   g151(.a(new_n305_), .b(x04), .c(x01), .O(z42));
  nand4  g152(.a(new_n288_), .b(x78), .c(x77), .d(x61), .O(new_n307_));
  nor3   g153(.a(new_n307_), .b(x04), .c(x01), .O(z43));
  nand4  g154(.a(new_n288_), .b(x78), .c(x77), .d(x62), .O(new_n309_));
  nor3   g155(.a(new_n309_), .b(x04), .c(x01), .O(z44));
  nand4  g156(.a(new_n288_), .b(x78), .c(x77), .d(x63), .O(new_n311_));
  nor3   g157(.a(new_n311_), .b(x04), .c(x01), .O(z45));
  nand4  g158(.a(new_n288_), .b(x78), .c(x77), .d(x64), .O(new_n313_));
