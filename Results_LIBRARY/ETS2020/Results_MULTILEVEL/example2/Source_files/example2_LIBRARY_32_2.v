...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n292_, new_n295_, new_n297_, new_n301_, new_n303_, new_n306_,
  ...
  nand4  g134(.a(new_n285_), .b(x78), .c(x77), .d(x56), .O(new_n292_));
  ...
  nand4  g140(.a(new_n285_), .b(x78), .c(x77), .d(x62), .O(new_n301_));
  nor3   g141(.a(new_n301_), .b(x04), .c(x01), .O(z44));
  nand4  g142(.a(new_n285_), .b(x78), .c(x77), .d(x63), .O(new_n303_));
  ...
  nand4  g213(.a(x80), .b(new_n224_), .c(x43), .d(new_n239_), .O(new_n375_));
  oai22  g214(.a(new_n375_), .b(new_n227_), .c(new_n239_), .d(x40), .O(new_n376_));
  ...
  oai21  g220(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n382_));
  aoi21  g221(.a(new_n382_), .b(new_n381_), .c(x01), .O(z58));
  nor2   g222(.a(new_n160_), .b(new_n233_), .O(new_n384_));
  oai21  g223(.a(new_n384_), .b(new_n378_), .c(x40), .O(new_n385_));
  oai21  g224(.a(new_n227_), .b(new_n225_), .c(new_n239_), .O(new_n386_));
  ...
  nand2  g229(.a(new_n154_), .b(new_n233_), .O(new_n391_));
  ...
  nand3  g243(.a(x81), .b(x79), .c(new_n233_), .O(new_n405_));
