...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n278_, new_n279_, new_n281_, new_n285_, new_n290_, new_n292_,
    new_n294_, new_n296_, new_n297_, new_n298_, new_n299_, new_n300_,
    new_n301_, new_n302_, new_n303_, new_n308_, new_n309_, new_n310_,
    new_n311_, new_n312_, new_n313_, new_n318_, new_n319_, new_n320_,
  ...
  nor2   g108(.a(new_n220_), .b(new_n233_), .O(new_n272_));
  nand3  g109(.a(x83), .b(x81), .c(x42), .O(new_n273_));
  oai21  g110(.a(new_n272_), .b(x81), .c(new_n273_), .O(new_n274_));
  nand2  g111(.a(new_n274_), .b(new_n237_), .O(new_n275_));
  oai22  g112(.a(new_n272_), .b(new_n236_), .c(new_n255_), .d(new_n233_), .O(new_n276_));
  nand2  g113(.a(new_n276_), .b(new_n234_), .O(new_n277_));
  aoi21  g114(.a(new_n277_), .b(new_n275_), .c(new_n154_), .O(new_n278_));
  nand4  g115(.a(new_n278_), .b(x78), .c(x77), .d(x54), .O(new_n279_));
  nor3   g116(.a(new_n279_), .b(x04), .c(x01), .O(z36));
  nand4  g117(.a(new_n278_), .b(x78), .c(x77), .d(x55), .O(new_n281_));
  nor3   g118(.a(new_n281_), .b(x04), .c(x01), .O(z37));
  nand4  g119(.a(new_n278_), .b(x78), .c(x77), .d(x58), .O(new_n285_));
  nor3   g120(.a(new_n285_), .b(x04), .c(x01), .O(z40));
  nand4  g121(.a(new_n278_), .b(x78), .c(x77), .d(x62), .O(new_n290_));
  nor3   g122(.a(new_n290_), .b(x04), .c(x01), .O(z44));
  nand4  g123(.a(new_n278_), .b(x78), .c(x77), .d(x63), .O(new_n292_));
  nor3   g124(.a(new_n292_), .b(x04), .c(x01), .O(z45));
  nand4  g125(.a(new_n278_), .b(x78), .c(x77), .d(x64), .O(new_n294_));
  ...
  nand2  g137(.a(new_n297_), .b(x11), .O(new_n309_));
  aoi21  g138(.a(new_n309_), .b(new_n308_), .c(x79), .O(new_n310_));
  nand4  g139(.a(new_n310_), .b(x78), .c(new_n159_), .d(x04), .O(new_n311_));
  nor2   g140(.a(new_n215_), .b(new_n154_), .O(new_n312_));
  nand4  g141(.a(new_n312_), .b(new_n160_), .c(x77), .d(x71), .O(new_n313_));
  aoi21  g142(.a(new_n313_), .b(new_n311_), .c(x01), .O(z51));
  inv1   g143(.a(x84), .O(new_n318_));
  nor2   g144(.a(x04), .b(x01), .O(new_n319_));
  nand4  g145(.a(new_n319_), .b(x79), .c(x78), .d(x77), .O(new_n320_));
  nor2   g146(.a(new_n320_), .b(x80), .O(new_n321_));
  nand2  g147(.a(new_n321_), .b(new_n236_), .O(new_n322_));
  nor4   g148(.a(new_n322_), .b(new_n318_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g149(.a(new_n229_), .b(x76), .O(new_n324_));
  inv1   g150(.a(new_n165_), .O(new_n325_));
  xnor2a g151(.a(x84), .b(x81), .O(new_n326_));
  aoi21  g152(.a(new_n167_), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g153(.a(new_n327_), .b(new_n153_), .O(new_n328_));
  nand2  g154(.a(new_n328_), .b(new_n324_), .O(new_n329_));
  nand2  g155(.a(new_n329_), .b(x79), .O(new_n330_));
  nand4  g156(.a(new_n330_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g157(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n333_));
  oai22  g158(.a(new_n333_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n334_));
  nand4  g159(.a(new_n334_), .b(x79), .c(x78), .d(x04), .O(new_n335_));
  nor2   g160(.a(x79), .b(x78), .O(new_n336_));
  nand3  g161(.a(new_n336_), .b(new_n233_), .c(x40), .O(new_n337_));
  nand2  g162(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g163(.a(new_n338_), .b(x77), .O(new_n339_));
  oai21  g164(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n340_));
  aoi21  g165(.a(new_n340_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g166(.a(new_n160_), .b(new_n227_), .O(new_n342_));
  oai21  g167(.a(new_n342_), .b(new_n336_), .c(x40), .O(new_n343_));
  oai21  g168(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n344_));
  nand2  g169(.a(new_n344_), .b(x79), .O(new_n345_));
  nand3  g170(.a(new_n345_), .b(x78), .c(x04), .O(new_n346_));
  nand2  g171(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand2  g172(.a(new_n347_), .b(x77), .O(new_n348_));
  nand2  g173(.a(new_n154_), .b(new_n227_), .O(new_n349_));
  aoi21  g174(.a(new_n349_), .b(new_n348_), .c(x01), .O(z59));
  nand2  g175(.a(new_n327_), .b(x79), .O(new_n351_));
  nand3  g176(.a(new_n351_), .b(new_n349_), .c(new_n224_), .O(new_n352_));
  and2   g177(.a(new_n352_), .b(new_n153_), .O(z60));
  nand2  g178(.a(new_n167_), .b(new_n325_), .O(new_n354_));
  nand2  g179(.a(new_n354_), .b(new_n216_), .O(new_n355_));
  oai21  g180(.a(new_n229_), .b(x04), .c(new_n355_), .O(new_n356_));
  nand4  g181(.a(new_n356_), .b(x80), .c(x79), .d(new_n153_), .O(new_n357_));
  inv1   g182(.a(new_n357_), .O(z61));
  nand2  g183(.a(new_n154_), .b(x04), .O(new_n359_));
  nand3  g184(.a(x84), .b(x81), .c(x79), .O(new_n360_));
  aoi21  g185(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  nand2  g186(.a(new_n345_), .b(x04), .O(new_n362_));
  nand3  g187(.a(x81), .b(x79), .c(new_n227_), .O(new_n363_));
  aoi21  g188(.a(new_n363_), .b(new_n362_), .c(new_n159_), .O(new_n364_));
  oai21  g189(.a(new_n364_), .b(new_n361_), .c(x78), .O(new_n365_));
  or2    g190(.a(new_n360_), .b(new_n167_), .O(new_n366_));
  aoi21  g191(.a(new_n366_), .b(new_n365_), .c(x01), .O(z62));
  nand4  g192(.a(new_n356_), .b(x82), .c(x79), .d(new_n153_), .O(new_n368_));
  inv1   g193(.a(new_n368_), .O(z63));
  nand3  g194(.a(new_n356_), .b(x83), .c(x79), .O(new_n370_));
  nand4  g195(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n371_));
  aoi21  g196(.a(new_n371_), .b(new_n370_), .c(x01), .O(z64));
  nor2   g197(.a(new_n160_), .b(x04), .O(new_n373_));
  nor2   g198(.a(new_n236_), .b(x78), .O(new_n374_));
  oai21  g199(.a(new_n374_), .b(new_n373_), .c(x77), .O(new_n375_));
  nand3  g200(.a(x81), .b(x78), .c(new_n159_), .O(new_n376_));
  nand2  g201(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand4  g202(.a(new_n377_), .b(x84), .c(x79), .d(new_n153_), .O(new_n378_));
  inv1   g203(.a(new_n378_), .O(z65));
  zero   g204(.O(z05));
  zero   g205(.O(z06));
  zero   g206(.O(z08));
  zero   g207(.O(z10));
