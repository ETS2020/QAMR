...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n193_, new_n195_, new_n196_, new_n198_, new_n199_, new_n203_,
    ...
    new_n249_, new_n250_, new_n252_, new_n254_, new_n257_, new_n260_,
  ...
  nand4  g101(.a(new_n249_), .b(x47), .c(new_n241_), .d(new_n233_), .O(new_n257_));
  ...
  nand4  g143(.a(new_n285_), .b(x78), .c(x77), .d(x60), .O(new_n301_));
  nor3   g144(.a(new_n301_), .b(x04), .c(x01), .O(z42));
  nand4  g145(.a(new_n285_), .b(x78), .c(x77), .d(x61), .O(new_n303_));
  nor3   g146(.a(new_n303_), .b(x04), .c(x01), .O(z43));
  nand4  g147(.a(new_n285_), .b(x78), .c(x77), .d(x62), .O(new_n305_));
  nor3   g148(.a(new_n305_), .b(x04), .c(x01), .O(z44));
  nand4  g149(.a(new_n285_), .b(x78), .c(x77), .d(x63), .O(new_n307_));
  nor3   g150(.a(new_n307_), .b(x04), .c(x01), .O(z45));
  nand4  g151(.a(new_n285_), .b(x78), .c(x77), .d(x64), .O(new_n309_));
  ...
  nand4  g222(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n380_));
  oai22  g223(.a(new_n380_), .b(new_n228_), .c(new_n241_), .d(x40), .O(new_n381_));
  nand4  g224(.a(new_n381_), .b(x79), .c(x78), .d(x04), .O(new_n382_));
  nor2   g225(.a(x79), .b(x78), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n241_), .c(x40), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n382_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(x77), .O(new_n386_));
  oai21  g229(.a(new_n165_), .b(new_n233_), .c(new_n154_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  nor2   g231(.a(new_n160_), .b(new_n233_), .O(new_n389_));
  oai21  g232(.a(new_n389_), .b(new_n383_), .c(x40), .O(new_n390_));
  oai21  g233(.a(new_n228_), .b(new_n226_), .c(new_n241_), .O(new_n391_));
  ...
  nand2  g238(.a(new_n154_), .b(new_n233_), .O(new_n396_));
  aoi21  g239(.a(new_n396_), .b(new_n395_), .c(x01), .O(z59));
  nand2  g240(.a(new_n372_), .b(x79), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n396_), .c(new_n231_), .O(new_n399_));
  and2   g242(.a(new_n399_), .b(new_n153_), .O(z60));
  nand2  g243(.a(new_n167_), .b(new_n370_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n223_), .O(new_n402_));
  oai21  g245(.a(new_n237_), .b(x04), .c(new_n402_), .O(new_n403_));
  ...
  nand3  g252(.a(x81), .b(x79), .c(new_n233_), .O(new_n410_));
  ...
  nor2   g263(.a(new_n244_), .b(x78), .O(new_n421_));
