...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n186_, new_n187_, new_n189_, new_n190_, new_n196_, new_n197_,
    ...
    new_n278_, new_n283_, new_n286_, new_n292_, new_n293_, new_n294_,
  ...
  nand4  g117(.a(new_n273_), .b(x78), .c(x77), .d(x58), .O(new_n283_));
  nor3   g118(.a(new_n283_), .b(x04), .c(x01), .O(z40));
  nand4  g119(.a(new_n273_), .b(x78), .c(x77), .d(x60), .O(new_n286_));
  ...
  nand2  g136(.a(new_n226_), .b(x76), .O(new_n314_));
  ...
  nand4  g144(.a(x80), .b(new_n214_), .c(x43), .d(new_n230_), .O(new_n323_));
  oai22  g145(.a(new_n323_), .b(new_n217_), .c(new_n230_), .d(x40), .O(new_n324_));
  nand4  g146(.a(new_n324_), .b(x79), .c(x78), .d(x04), .O(new_n325_));
  nor2   g147(.a(x79), .b(x78), .O(new_n326_));
  nand3  g148(.a(new_n326_), .b(new_n230_), .c(x40), .O(new_n327_));
  nand2  g149(.a(new_n327_), .b(new_n325_), .O(new_n328_));
  nand2  g150(.a(new_n328_), .b(x77), .O(new_n329_));
  oai21  g151(.a(new_n165_), .b(new_n222_), .c(new_n154_), .O(new_n330_));
  aoi21  g152(.a(new_n330_), .b(new_n329_), .c(x01), .O(z58));
  nor2   g153(.a(new_n160_), .b(new_n222_), .O(new_n332_));
  oai21  g154(.a(new_n332_), .b(new_n326_), .c(x40), .O(new_n333_));
  oai21  g155(.a(new_n217_), .b(new_n215_), .c(new_n230_), .O(new_n334_));
  ...
  nand2  g160(.a(new_n154_), .b(new_n222_), .O(new_n339_));
  aoi21  g161(.a(new_n339_), .b(new_n338_), .c(x01), .O(z59));
  nand2  g162(.a(new_n317_), .b(x79), .O(new_n341_));
  nand3  g163(.a(new_n341_), .b(new_n339_), .c(new_n220_), .O(new_n342_));
  and2   g164(.a(new_n342_), .b(new_n153_), .O(z60));
  nand2  g165(.a(new_n167_), .b(new_n315_), .O(new_n344_));
  nand2  g166(.a(new_n344_), .b(new_n212_), .O(new_n345_));
  oai21  g167(.a(new_n226_), .b(x04), .c(new_n345_), .O(new_n346_));
  ...
  nand3  g174(.a(x81), .b(x79), .c(new_n222_), .O(new_n353_));
  ...
  nor2   g185(.a(new_n233_), .b(x78), .O(new_n364_));
