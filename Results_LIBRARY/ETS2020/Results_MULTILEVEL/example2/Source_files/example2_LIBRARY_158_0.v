...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n202_, new_n203_, new_n207_, new_n208_, new_n212_, new_n213_,
    new_n214_, new_n215_, new_n216_, new_n217_, new_n218_, new_n219_,
    new_n220_, new_n221_, new_n224_, new_n226_, new_n228_, new_n231_,
  ...
  inv1   g023(.a(x31), .O(new_n181_));
  nand2  g024(.a(x57), .b(x40), .O(new_n182_));
  oai21  g025(.a(x40), .b(new_n181_), .c(new_n182_), .O(z13));
  ...
  inv1   g044(.a(x38), .O(new_n202_));
  nand2  g045(.a(x45), .b(x40), .O(new_n203_));
  oai21  g046(.a(x40), .b(new_n202_), .c(new_n203_), .O(z20));
  ...
  nand4  g061(.a(new_n220_), .b(x46), .c(new_n212_), .d(new_n207_), .O(new_n224_));
  nor2   g062(.a(new_n224_), .b(x01), .O(z28));
  nand4  g063(.a(new_n220_), .b(x47), .c(new_n212_), .d(new_n207_), .O(new_n226_));
  ...
  nand4  g067(.a(new_n220_), .b(x50), .c(new_n212_), .d(new_n207_), .O(new_n231_));
  ...
  oai21  g072(.a(new_n236_), .b(new_n234_), .c(new_n216_), .O(new_n237_));
  nand2  g073(.a(x83), .b(x42), .O(new_n238_));
  nand2  g074(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g075(.a(x83), .b(new_n215_), .c(x42), .O(new_n240_));
  nand2  g076(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g077(.a(new_n241_), .b(new_n213_), .O(new_n242_));
  ...
  nand4  g089(.a(new_n243_), .b(x78), .c(x77), .d(x58), .O(new_n255_));
  nor3   g090(.a(new_n255_), .b(x04), .c(x01), .O(z40));
  nand4  g091(.a(new_n243_), .b(x78), .c(x77), .d(x60), .O(new_n258_));
  nor3   g092(.a(new_n258_), .b(x04), .c(x01), .O(z42));
  nand4  g093(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n260_));
  nor3   g094(.a(new_n260_), .b(x04), .c(x01), .O(z43));
  nand4  g095(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n262_));
  nor3   g096(.a(new_n262_), .b(x04), .c(x01), .O(z44));
  nand4  g097(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n264_));
  nor3   g098(.a(new_n264_), .b(x04), .c(x01), .O(z45));
  nand4  g099(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n266_));
  nor3   g100(.a(new_n266_), .b(x04), .c(x01), .O(z46));
  inv1   g101(.a(x77), .O(new_n269_));
  nand2  g102(.a(x52), .b(x16), .O(new_n270_));
  inv1   g103(.a(x52), .O(new_n271_));
  nand2  g104(.a(new_n271_), .b(x08), .O(new_n272_));
  aoi21  g105(.a(new_n272_), .b(new_n270_), .c(x79), .O(new_n273_));
  nand4  g106(.a(new_n273_), .b(x78), .c(new_n269_), .d(x04), .O(new_n274_));
  inv1   g107(.a(x78), .O(new_n275_));
  xnor2a g108(.a(x84), .b(x81), .O(new_n276_));
  nand4  g109(.a(new_n276_), .b(x79), .c(new_n275_), .d(x77), .O(new_n277_));
  inv1   g110(.a(new_n277_), .O(new_n278_));
  nand2  g111(.a(new_n278_), .b(x68), .O(new_n279_));
  aoi21  g112(.a(new_n279_), .b(new_n274_), .c(x01), .O(z48));
  nand2  g113(.a(x52), .b(x17), .O(new_n281_));
  nand2  g114(.a(new_n271_), .b(x09), .O(new_n282_));
  aoi21  g115(.a(new_n282_), .b(new_n281_), .c(x79), .O(new_n283_));
  nand4  g116(.a(new_n283_), .b(x78), .c(new_n269_), .d(x04), .O(new_n284_));
  nand2  g117(.a(new_n278_), .b(x69), .O(new_n285_));
  aoi21  g118(.a(new_n285_), .b(new_n284_), .c(x01), .O(z49));
  nand2  g119(.a(x52), .b(x18), .O(new_n287_));
  nand2  g120(.a(new_n271_), .b(x10), .O(new_n288_));
  aoi21  g121(.a(new_n288_), .b(new_n287_), .c(x79), .O(new_n289_));
  nand4  g122(.a(new_n289_), .b(x78), .c(new_n269_), .d(x04), .O(new_n290_));
  nand2  g123(.a(new_n278_), .b(x70), .O(new_n291_));
  aoi21  g124(.a(new_n291_), .b(new_n290_), .c(x01), .O(z50));
  nand2  g125(.a(x52), .b(x19), .O(new_n293_));
  nand2  g126(.a(new_n271_), .b(x11), .O(new_n294_));
  aoi21  g127(.a(new_n294_), .b(new_n293_), .c(x79), .O(new_n295_));
  nand4  g128(.a(new_n295_), .b(x78), .c(new_n269_), .d(x04), .O(new_n296_));
  nand2  g129(.a(new_n278_), .b(x71), .O(new_n297_));
  aoi21  g130(.a(new_n297_), .b(new_n296_), .c(x01), .O(z51));
  nand2  g131(.a(x52), .b(x20), .O(new_n299_));
  nand2  g132(.a(new_n271_), .b(x12), .O(new_n300_));
  aoi21  g133(.a(new_n300_), .b(new_n299_), .c(x79), .O(new_n301_));
  nand4  g134(.a(new_n301_), .b(x78), .c(new_n269_), .d(x04), .O(new_n302_));
  nand2  g135(.a(new_n278_), .b(x72), .O(new_n303_));
  aoi21  g136(.a(new_n303_), .b(new_n302_), .c(x01), .O(z52));
  nand2  g137(.a(x52), .b(x21), .O(new_n305_));
  nand2  g138(.a(new_n271_), .b(x13), .O(new_n306_));
  aoi21  g139(.a(new_n306_), .b(new_n305_), .c(x79), .O(new_n307_));
  nand4  g140(.a(new_n307_), .b(x78), .c(new_n269_), .d(x04), .O(new_n308_));
  nand2  g141(.a(new_n278_), .b(x73), .O(new_n309_));
  aoi21  g142(.a(new_n309_), .b(new_n308_), .c(x01), .O(z53));
  nand2  g143(.a(x52), .b(x22), .O(new_n311_));
  nand2  g144(.a(new_n271_), .b(x14), .O(new_n312_));
  aoi21  g145(.a(new_n312_), .b(new_n311_), .c(x79), .O(new_n313_));
  nand4  g146(.a(new_n313_), .b(x78), .c(new_n269_), .d(x04), .O(new_n314_));
  nor2   g147(.a(new_n314_), .b(x01), .O(z54));
  nor2   g148(.a(new_n275_), .b(x04), .O(new_n326_));
  nor2   g149(.a(new_n215_), .b(x78), .O(new_n327_));
  oai21  g150(.a(new_n327_), .b(new_n326_), .c(x77), .O(new_n328_));
  nand3  g151(.a(x81), .b(x78), .c(new_n269_), .O(new_n329_));
  nand2  g152(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  nand4  g153(.a(new_n330_), .b(x84), .c(x79), .d(new_n153_), .O(new_n331_));
  inv1   g154(.a(new_n331_), .O(z65));
  zero   g155(.O(z01));
  zero   g156(.O(z02));
  zero   g157(.O(z07));
  zero   g158(.O(z10));
