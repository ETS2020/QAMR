...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n246_, new_n248_, new_n250_, new_n252_, new_n254_, new_n258_,
    ...
    new_n307_, new_n308_, new_n309_, new_n310_, new_n311_, new_n324_,
  ...
  aoi21  g074(.a(x83), .b(x42), .c(x81), .O(new_n236_));
  nand3  g075(.a(x83), .b(x81), .c(x42), .O(new_n237_));
  inv1   g076(.a(new_n237_), .O(new_n238_));
  oai21  g077(.a(new_n238_), .b(new_n236_), .c(new_n215_), .O(new_n239_));
  nand2  g078(.a(x83), .b(x42), .O(new_n240_));
  nand2  g079(.a(new_n240_), .b(x81), .O(new_n241_));
  nand3  g080(.a(x83), .b(new_n214_), .c(x42), .O(new_n242_));
  nand2  g081(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  nand2  g082(.a(new_n243_), .b(new_n212_), .O(new_n244_));
  aoi21  g083(.a(new_n244_), .b(new_n239_), .c(new_n156_), .O(new_n245_));
  nand4  g084(.a(new_n245_), .b(x78), .c(x77), .d(x52), .O(new_n246_));
  nor3   g085(.a(new_n246_), .b(x04), .c(x01), .O(z34));
  nand4  g086(.a(new_n245_), .b(x78), .c(x77), .d(x53), .O(new_n248_));
  nor3   g087(.a(new_n248_), .b(x04), .c(x01), .O(z35));
  nand4  g088(.a(new_n245_), .b(x78), .c(x77), .d(x54), .O(new_n250_));
  nor3   g089(.a(new_n250_), .b(x04), .c(x01), .O(z36));
  nand4  g090(.a(new_n245_), .b(x78), .c(x77), .d(x55), .O(new_n252_));
  nor3   g091(.a(new_n252_), .b(x04), .c(x01), .O(z37));
  nand4  g092(.a(new_n245_), .b(x78), .c(x77), .d(x56), .O(new_n254_));
  nor3   g093(.a(new_n254_), .b(x04), .c(x01), .O(z38));
  nand4  g094(.a(new_n245_), .b(x78), .c(x77), .d(x59), .O(new_n258_));
  nor3   g095(.a(new_n258_), .b(x04), .c(x01), .O(z41));
  nand4  g096(.a(new_n245_), .b(x78), .c(x77), .d(x60), .O(new_n260_));
  nor3   g097(.a(new_n260_), .b(x04), .c(x01), .O(z42));
  nand4  g098(.a(new_n245_), .b(x78), .c(x77), .d(x61), .O(new_n262_));
  nor3   g099(.a(new_n262_), .b(x04), .c(x01), .O(z43));
  nand4  g100(.a(new_n245_), .b(x78), .c(x77), .d(x62), .O(new_n264_));
  nor3   g101(.a(new_n264_), .b(x04), .c(x01), .O(z44));
  nand4  g102(.a(new_n245_), .b(x78), .c(x77), .d(x63), .O(new_n266_));
  nor3   g103(.a(new_n266_), .b(x04), .c(x01), .O(z45));
  nand4  g104(.a(new_n245_), .b(x78), .c(x77), .d(x64), .O(new_n268_));
  ...
  nor2   g148(.a(new_n277_), .b(x04), .O(new_n324_));
  nor2   g149(.a(new_n214_), .b(x78), .O(new_n325_));
  oai21  g150(.a(new_n325_), .b(new_n324_), .c(x77), .O(new_n326_));
  nand3  g151(.a(x81), .b(x78), .c(new_n271_), .O(new_n327_));
  nand2  g152(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  nand4  g153(.a(new_n328_), .b(x84), .c(x79), .d(new_n155_), .O(new_n329_));
  inv1   g154(.a(new_n329_), .O(z65));
  zero   g155(.O(z00));
  zero   g156(.O(z01));
  zero   g157(.O(z02));
  zero   g158(.O(z10));
