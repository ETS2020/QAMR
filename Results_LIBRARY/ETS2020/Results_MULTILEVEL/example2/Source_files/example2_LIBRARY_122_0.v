...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n221_, new_n222_, new_n224_, new_n226_, new_n229_, new_n231_,
    new_n234_, new_n235_, new_n236_, new_n237_, new_n238_, new_n239_,
    new_n240_, new_n241_, new_n242_, new_n243_, new_n244_, new_n246_,
    new_n248_, new_n250_, new_n252_, new_n258_, new_n260_, new_n262_,
  ...
  nand4  g068(.a(new_n221_), .b(x50), .c(new_n213_), .d(new_n207_), .O(new_n231_));
  nor2   g069(.a(new_n231_), .b(x01), .O(z32));
  aoi21  g070(.a(x83), .b(x42), .c(x81), .O(new_n234_));
  nand3  g071(.a(x83), .b(x81), .c(x42), .O(new_n235_));
  inv1   g072(.a(new_n235_), .O(new_n236_));
  oai21  g073(.a(new_n236_), .b(new_n234_), .c(new_n217_), .O(new_n237_));
  nand2  g074(.a(x83), .b(x42), .O(new_n238_));
  nand2  g075(.a(new_n238_), .b(x81), .O(new_n239_));
  nand3  g076(.a(x83), .b(new_n216_), .c(x42), .O(new_n240_));
  nand2  g077(.a(new_n240_), .b(new_n239_), .O(new_n241_));
  nand2  g078(.a(new_n241_), .b(new_n214_), .O(new_n242_));
  aoi21  g079(.a(new_n242_), .b(new_n237_), .c(new_n156_), .O(new_n243_));
  nand4  g080(.a(new_n243_), .b(x78), .c(x77), .d(x52), .O(new_n244_));
  nor3   g081(.a(new_n244_), .b(x04), .c(x01), .O(z34));
  nand4  g082(.a(new_n243_), .b(x78), .c(x77), .d(x53), .O(new_n246_));
  nor3   g083(.a(new_n246_), .b(x04), .c(x01), .O(z35));
  nand4  g084(.a(new_n243_), .b(x78), .c(x77), .d(x54), .O(new_n248_));
  nor3   g085(.a(new_n248_), .b(x04), .c(x01), .O(z36));
  nand4  g086(.a(new_n243_), .b(x78), .c(x77), .d(x55), .O(new_n250_));
  nor3   g087(.a(new_n250_), .b(x04), .c(x01), .O(z37));
  nand4  g088(.a(new_n243_), .b(x78), .c(x77), .d(x56), .O(new_n252_));
  nor3   g089(.a(new_n252_), .b(x04), .c(x01), .O(z38));
  nand4  g090(.a(new_n243_), .b(x78), .c(x77), .d(x61), .O(new_n258_));
  nor3   g091(.a(new_n258_), .b(x04), .c(x01), .O(z43));
  nand4  g092(.a(new_n243_), .b(x78), .c(x77), .d(x62), .O(new_n260_));
  nor3   g093(.a(new_n260_), .b(x04), .c(x01), .O(z44));
  nand4  g094(.a(new_n243_), .b(x78), .c(x77), .d(x63), .O(new_n262_));
  nor3   g095(.a(new_n262_), .b(x04), .c(x01), .O(z45));
  nand4  g096(.a(new_n243_), .b(x78), .c(x77), .d(x64), .O(new_n264_));
  ...
  xor2a  g105(.a(x84), .b(x81), .O(new_n274_));
  nor2   g106(.a(new_n274_), .b(new_n156_), .O(new_n275_));
  nand3  g107(.a(new_n275_), .b(new_n273_), .c(x77), .O(new_n276_));
  inv1   g108(.a(new_n276_), .O(new_n277_));
  nand2  g109(.a(new_n277_), .b(x68), .O(new_n278_));
  aoi21  g110(.a(new_n278_), .b(new_n272_), .c(x01), .O(z48));
  nand2  g111(.a(x52), .b(x17), .O(new_n280_));
  nand2  g112(.a(new_n269_), .b(x09), .O(new_n281_));
  aoi21  g113(.a(new_n281_), .b(new_n280_), .c(x79), .O(new_n282_));
  nand4  g114(.a(new_n282_), .b(x78), .c(new_n267_), .d(x04), .O(new_n283_));
  nand2  g115(.a(new_n277_), .b(x69), .O(new_n284_));
  aoi21  g116(.a(new_n284_), .b(new_n283_), .c(x01), .O(z49));
  nand2  g117(.a(x52), .b(x18), .O(new_n286_));
  nand2  g118(.a(new_n269_), .b(x10), .O(new_n287_));
  aoi21  g119(.a(new_n287_), .b(new_n286_), .c(x79), .O(new_n288_));
  nand4  g120(.a(new_n288_), .b(x78), .c(new_n267_), .d(x04), .O(new_n289_));
  nand2  g121(.a(new_n277_), .b(x70), .O(new_n290_));
  aoi21  g122(.a(new_n290_), .b(new_n289_), .c(x01), .O(z50));
  nand2  g123(.a(x52), .b(x19), .O(new_n292_));
  nand2  g124(.a(new_n269_), .b(x11), .O(new_n293_));
  aoi21  g125(.a(new_n293_), .b(new_n292_), .c(x79), .O(new_n294_));
  nand4  g126(.a(new_n294_), .b(x78), .c(new_n267_), .d(x04), .O(new_n295_));
  nand2  g127(.a(new_n277_), .b(x71), .O(new_n296_));
  aoi21  g128(.a(new_n296_), .b(new_n295_), .c(x01), .O(z51));
  nand2  g129(.a(x52), .b(x20), .O(new_n298_));
  nand2  g130(.a(new_n269_), .b(x12), .O(new_n299_));
  aoi21  g131(.a(new_n299_), .b(new_n298_), .c(x79), .O(new_n300_));
  nand4  g132(.a(new_n300_), .b(x78), .c(new_n267_), .d(x04), .O(new_n301_));
  nand2  g133(.a(new_n277_), .b(x72), .O(new_n302_));
  aoi21  g134(.a(new_n302_), .b(new_n301_), .c(x01), .O(z52));
  nand2  g135(.a(x52), .b(x21), .O(new_n304_));
  nand2  g136(.a(new_n269_), .b(x13), .O(new_n305_));
  aoi21  g137(.a(new_n305_), .b(new_n304_), .c(x79), .O(new_n306_));
  nand4  g138(.a(new_n306_), .b(x78), .c(new_n267_), .d(x04), .O(new_n307_));
  nand2  g139(.a(new_n277_), .b(x73), .O(new_n308_));
  aoi21  g140(.a(new_n308_), .b(new_n307_), .c(x01), .O(z53));
  nand2  g141(.a(x52), .b(x22), .O(new_n310_));
  nand2  g142(.a(new_n269_), .b(x14), .O(new_n311_));
  aoi21  g143(.a(new_n311_), .b(new_n310_), .c(x79), .O(new_n312_));
  nand4  g144(.a(new_n312_), .b(x78), .c(new_n267_), .d(x04), .O(new_n313_));
  nor2   g145(.a(new_n313_), .b(x01), .O(z54));
  inv1   g146(.a(x02), .O(new_n317_));
  nand4  g147(.a(x03), .b(new_n317_), .c(new_n155_), .d(x00), .O(new_n318_));
  inv1   g148(.a(new_n318_), .O(z57));
  xnor2a g149(.a(x78), .b(x77), .O(new_n323_));
  nand3  g150(.a(x78), .b(x77), .c(new_n207_), .O(new_n324_));
  oai21  g151(.a(new_n323_), .b(new_n274_), .c(new_n324_), .O(new_n325_));
  nand4  g152(.a(new_n325_), .b(x80), .c(x79), .d(new_n155_), .O(new_n326_));
  inv1   g153(.a(new_n326_), .O(z61));
  nor2   g154(.a(new_n273_), .b(x04), .O(new_n331_));
  nor2   g155(.a(new_n216_), .b(x78), .O(new_n332_));
  oai21  g156(.a(new_n332_), .b(new_n331_), .c(x77), .O(new_n333_));
  nand3  g157(.a(x81), .b(x78), .c(new_n267_), .O(new_n334_));
  nand2  g158(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  nand4  g159(.a(new_n335_), .b(x84), .c(x79), .d(new_n155_), .O(new_n336_));
  inv1   g160(.a(new_n336_), .O(z65));
  zero   g161(.O(z00));
  zero   g162(.O(z01));
  zero   g163(.O(z02));
  zero   g164(.O(z10));
