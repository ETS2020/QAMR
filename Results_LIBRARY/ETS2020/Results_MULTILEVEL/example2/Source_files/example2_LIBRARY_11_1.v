...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n245_, new_n247_, new_n249_, new_n251_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n279_, new_n281_, new_n283_, new_n285_,
    new_n289_, new_n291_, new_n293_, new_n295_, new_n299_, new_n300_,
  ...
  nand4  g085(.a(new_n241_), .b(x45), .c(new_n233_), .d(new_n227_), .O(new_n245_));
  ...
  nand4  g091(.a(new_n241_), .b(x48), .c(new_n233_), .d(new_n227_), .O(new_n251_));
  ...
  nor2   g108(.a(new_n220_), .b(new_n233_), .O(new_n270_));
  nand3  g109(.a(x83), .b(x81), .c(x42), .O(new_n271_));
  oai21  g110(.a(new_n270_), .b(x81), .c(new_n271_), .O(new_n272_));
  nand2  g111(.a(new_n272_), .b(new_n237_), .O(new_n273_));
  oai22  g112(.a(new_n270_), .b(new_n236_), .c(new_n255_), .d(new_n233_), .O(new_n274_));
  nand2  g113(.a(new_n274_), .b(new_n234_), .O(new_n275_));
  ...
  nand4  g125(.a(new_n276_), .b(x78), .c(x77), .d(x59), .O(new_n289_));
  nor3   g126(.a(new_n289_), .b(x04), .c(x01), .O(z41));
  nand4  g127(.a(new_n276_), .b(x78), .c(x77), .d(x60), .O(new_n291_));
  nor3   g128(.a(new_n291_), .b(x04), .c(x01), .O(z42));
  nand4  g129(.a(new_n276_), .b(x78), .c(x77), .d(x61), .O(new_n293_));
  nor3   g130(.a(new_n293_), .b(x04), .c(x01), .O(z43));
  ...
  nand2  g142(.a(x52), .b(x22), .O(new_n314_));
  nand2  g143(.a(new_n300_), .b(x14), .O(new_n315_));
  aoi21  g144(.a(new_n315_), .b(new_n314_), .c(x79), .O(new_n316_));
  nand4  g145(.a(new_n316_), .b(x78), .c(new_n159_), .d(x04), .O(new_n317_));
  nor2   g146(.a(new_n317_), .b(x01), .O(z54));
  inv1   g147(.a(x84), .O(new_n319_));
  nor2   g148(.a(x04), .b(x01), .O(new_n320_));
  nand4  g149(.a(new_n320_), .b(x79), .c(x78), .d(x77), .O(new_n321_));
  nor2   g150(.a(new_n321_), .b(x80), .O(new_n322_));
  nand2  g151(.a(new_n322_), .b(new_n236_), .O(new_n323_));
  nor4   g152(.a(new_n323_), .b(new_n319_), .c(new_n220_), .d(x82), .O(z55));
  nand2  g153(.a(new_n229_), .b(x76), .O(new_n325_));
  inv1   g154(.a(new_n165_), .O(new_n326_));
  xnor2a g155(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g156(.a(new_n167_), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g157(.a(new_n328_), .b(new_n153_), .O(new_n329_));
  nand2  g158(.a(new_n329_), .b(new_n325_), .O(new_n330_));
  nand2  g159(.a(new_n330_), .b(x79), .O(new_n331_));
  nand4  g160(.a(new_n331_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g161(.a(x02), .O(new_n333_));
  nand4  g162(.a(x03), .b(new_n333_), .c(new_n153_), .d(x00), .O(new_n334_));
  inv1   g163(.a(new_n334_), .O(z57));
  nand4  g164(.a(x80), .b(new_n218_), .c(x43), .d(new_n233_), .O(new_n336_));
  oai22  g165(.a(new_n336_), .b(new_n221_), .c(new_n233_), .d(x40), .O(new_n337_));
  nand4  g166(.a(new_n337_), .b(x79), .c(x78), .d(x04), .O(new_n338_));
  nor2   g167(.a(x79), .b(x78), .O(new_n339_));
  nand3  g168(.a(new_n339_), .b(new_n233_), .c(x40), .O(new_n340_));
  nand2  g169(.a(new_n340_), .b(new_n338_), .O(new_n341_));
  nand2  g170(.a(new_n341_), .b(x77), .O(new_n342_));
  oai21  g171(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n343_));
  aoi21  g172(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g173(.a(new_n160_), .b(new_n227_), .O(new_n345_));
  oai21  g174(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g175(.a(new_n221_), .b(new_n219_), .c(new_n233_), .O(new_n347_));
  nand2  g176(.a(new_n347_), .b(x79), .O(new_n348_));
  nand3  g177(.a(new_n348_), .b(x78), .c(x04), .O(new_n349_));
  nand2  g178(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  nand2  g179(.a(new_n350_), .b(x77), .O(new_n351_));
  nand2  g180(.a(new_n154_), .b(new_n227_), .O(new_n352_));
  aoi21  g181(.a(new_n352_), .b(new_n351_), .c(x01), .O(z59));
  nand2  g182(.a(new_n328_), .b(x79), .O(new_n354_));
  nand3  g183(.a(new_n354_), .b(new_n352_), .c(new_n224_), .O(new_n355_));
  and2   g184(.a(new_n355_), .b(new_n153_), .O(z60));
  nand2  g185(.a(new_n167_), .b(new_n326_), .O(new_n357_));
  nand2  g186(.a(new_n357_), .b(new_n216_), .O(new_n358_));
  oai21  g187(.a(new_n229_), .b(x04), .c(new_n358_), .O(new_n359_));
  nand4  g188(.a(new_n359_), .b(x80), .c(x79), .d(new_n153_), .O(new_n360_));
  inv1   g189(.a(new_n360_), .O(z61));
  nand2  g190(.a(new_n154_), .b(x04), .O(new_n362_));
  nand3  g191(.a(x84), .b(x81), .c(x79), .O(new_n363_));
  aoi21  g192(.a(new_n363_), .b(new_n362_), .c(x77), .O(new_n364_));
  nand2  g193(.a(new_n348_), .b(x04), .O(new_n365_));
  nand3  g194(.a(x81), .b(x79), .c(new_n227_), .O(new_n366_));
  aoi21  g195(.a(new_n366_), .b(new_n365_), .c(new_n159_), .O(new_n367_));
  oai21  g196(.a(new_n367_), .b(new_n364_), .c(x78), .O(new_n368_));
  or2    g197(.a(new_n363_), .b(new_n167_), .O(new_n369_));
  aoi21  g198(.a(new_n369_), .b(new_n368_), .c(x01), .O(z62));
  nand4  g199(.a(new_n359_), .b(x82), .c(x79), .d(new_n153_), .O(new_n371_));
  inv1   g200(.a(new_n371_), .O(z63));
  nand3  g201(.a(new_n359_), .b(x83), .c(x79), .O(new_n373_));
  nand4  g202(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n374_));
  aoi21  g203(.a(new_n374_), .b(new_n373_), .c(x01), .O(z64));
  zero   g204(.O(z06));
  zero   g205(.O(z09));
  zero   g206(.O(z10));
  zero   g207(.O(z14));
