...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n223_, new_n225_, new_n228_, new_n233_, new_n234_, new_n235_,
    new_n236_, new_n237_, new_n238_, new_n239_, new_n240_, new_n241_,
    new_n242_, new_n243_, new_n245_, new_n247_, new_n249_, new_n253_,
    ...
    new_n308_, new_n309_, new_n313_, new_n314_, new_n317_, new_n318_,
    new_n319_, new_n320_, new_n321_, new_n322_, new_n323_, new_n324_,
    new_n325_, new_n326_, new_n327_, new_n328_, new_n329_, new_n336_,
  ...
  nand4  g054(.a(new_n214_), .b(x44), .c(new_n206_), .d(new_n205_), .O(new_n217_));
  nor2   g055(.a(new_n217_), .b(x01), .O(z26));
  nand4  g056(.a(new_n214_), .b(x45), .c(new_n206_), .d(new_n205_), .O(new_n219_));
  nor2   g057(.a(new_n219_), .b(x01), .O(z27));
  nand4  g058(.a(new_n214_), .b(x46), .c(new_n206_), .d(new_n205_), .O(new_n221_));
  nor2   g059(.a(new_n221_), .b(x01), .O(z28));
  nand4  g060(.a(new_n214_), .b(x47), .c(new_n206_), .d(new_n205_), .O(new_n223_));
  nor2   g061(.a(new_n223_), .b(x01), .O(z29));
  nand4  g062(.a(new_n214_), .b(x48), .c(new_n206_), .d(new_n205_), .O(new_n225_));
  nor2   g063(.a(new_n225_), .b(x01), .O(z30));
  nand4  g064(.a(new_n214_), .b(x50), .c(new_n206_), .d(new_n205_), .O(new_n228_));
  nor2   g065(.a(new_n228_), .b(x01), .O(z32));
  aoi21  g066(.a(x83), .b(x42), .c(x81), .O(new_n233_));
  nand3  g067(.a(x83), .b(x81), .c(x42), .O(new_n234_));
  inv1   g068(.a(new_n234_), .O(new_n235_));
  oai21  g069(.a(new_n235_), .b(new_n233_), .c(new_n210_), .O(new_n236_));
  nand2  g070(.a(x83), .b(x42), .O(new_n237_));
  nand2  g071(.a(new_n237_), .b(x81), .O(new_n238_));
  nand3  g072(.a(x83), .b(new_n209_), .c(x42), .O(new_n239_));
  nand2  g073(.a(new_n239_), .b(new_n238_), .O(new_n240_));
  nand2  g074(.a(new_n240_), .b(new_n207_), .O(new_n241_));
  aoi21  g075(.a(new_n241_), .b(new_n236_), .c(new_n156_), .O(new_n242_));
  nand4  g076(.a(new_n242_), .b(x78), .c(x77), .d(x54), .O(new_n243_));
  nor3   g077(.a(new_n243_), .b(x04), .c(x01), .O(z36));
  nand4  g078(.a(new_n242_), .b(x78), .c(x77), .d(x55), .O(new_n245_));
  nor3   g079(.a(new_n245_), .b(x04), .c(x01), .O(z37));
  nand4  g080(.a(new_n242_), .b(x78), .c(x77), .d(x56), .O(new_n247_));
  nor3   g081(.a(new_n247_), .b(x04), .c(x01), .O(z38));
  nand4  g082(.a(new_n242_), .b(x78), .c(x77), .d(x57), .O(new_n249_));
  nor3   g083(.a(new_n249_), .b(x04), .c(x01), .O(z39));
  nand4  g084(.a(new_n242_), .b(x78), .c(x77), .d(x60), .O(new_n253_));
  nor3   g085(.a(new_n253_), .b(x04), .c(x01), .O(z42));
  nand4  g086(.a(new_n242_), .b(x78), .c(x77), .d(x61), .O(new_n255_));
  nor3   g087(.a(new_n255_), .b(x04), .c(x01), .O(z43));
  nand4  g088(.a(new_n242_), .b(x78), .c(x77), .d(x62), .O(new_n257_));
  nor3   g089(.a(new_n257_), .b(x04), .c(x01), .O(z44));
  nand4  g090(.a(new_n242_), .b(x78), .c(x77), .d(x63), .O(new_n259_));
  nor3   g091(.a(new_n259_), .b(x04), .c(x01), .O(z45));
  nand4  g092(.a(new_n242_), .b(x78), .c(x77), .d(x64), .O(new_n261_));
  ...
  nor2   g144(.a(x79), .b(x78), .O(new_n317_));
  nor2   g145(.a(new_n270_), .b(new_n205_), .O(new_n318_));
  oai21  g146(.a(new_n318_), .b(new_n317_), .c(x40), .O(new_n319_));
  inv1   g147(.a(x74), .O(new_n320_));
  nand3  g148(.a(x80), .b(new_n320_), .c(x43), .O(new_n321_));
  inv1   g149(.a(x83), .O(new_n322_));
  nand4  g150(.a(x84), .b(new_n322_), .c(x82), .d(x81), .O(new_n323_));
  oai21  g151(.a(new_n323_), .b(new_n321_), .c(new_n206_), .O(new_n324_));
  nand2  g152(.a(new_n324_), .b(x79), .O(new_n325_));
  nand3  g153(.a(new_n325_), .b(x78), .c(x04), .O(new_n326_));
  nand2  g154(.a(new_n326_), .b(new_n319_), .O(new_n327_));
  nand2  g155(.a(new_n327_), .b(x77), .O(new_n328_));
  nand2  g156(.a(new_n156_), .b(new_n205_), .O(new_n329_));
  aoi21  g157(.a(new_n329_), .b(new_n328_), .c(x01), .O(z59));
  nor2   g158(.a(new_n270_), .b(x04), .O(new_n336_));
  nor2   g159(.a(new_n209_), .b(x78), .O(new_n337_));
  oai21  g160(.a(new_n337_), .b(new_n336_), .c(x77), .O(new_n338_));
  nand3  g161(.a(x81), .b(x78), .c(new_n264_), .O(new_n339_));
  nand2  g162(.a(new_n339_), .b(new_n338_), .O(new_n340_));
  nand4  g163(.a(new_n340_), .b(x84), .c(x79), .d(new_n155_), .O(new_n341_));
  inv1   g164(.a(new_n341_), .O(z65));
  zero   g165(.O(z00));
  zero   g166(.O(z01));
  zero   g167(.O(z02));
  zero   g168(.O(z12));
