...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n289_, new_n292_, new_n294_,
  ...
  nand4  g093(.a(new_n246_), .b(x46), .c(new_n238_), .d(new_n230_), .O(new_n251_));
  ...
  nand4  g099(.a(new_n246_), .b(x49), .c(new_n238_), .d(new_n230_), .O(new_n257_));
  ...
  nand2  g152(.a(new_n322_), .b(new_n241_), .O(new_n323_));
  nor4   g153(.a(new_n323_), .b(new_n319_), .c(new_n224_), .d(x82), .O(z55));
  nand2  g154(.a(new_n234_), .b(x76), .O(new_n325_));
  ...
  nand4  g165(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n336_));
  oai22  g166(.a(new_n336_), .b(new_n225_), .c(new_n238_), .d(x40), .O(new_n337_));
  ...
  oai21  g172(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n343_));
  aoi21  g173(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  nor2   g174(.a(new_n160_), .b(new_n230_), .O(new_n345_));
  oai21  g175(.a(new_n345_), .b(new_n339_), .c(x40), .O(new_n346_));
  oai21  g176(.a(new_n225_), .b(new_n223_), .c(new_n238_), .O(new_n347_));
  ...
  nand3  g195(.a(x81), .b(x79), .c(new_n230_), .O(new_n366_));
  ...
  nor2   g206(.a(new_n241_), .b(x78), .O(new_n377_));
