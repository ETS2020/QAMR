...
module FAU ( 
  ...
  nor2   g147(.a(new_n309_), .b(new_n218_), .O(new_n310_));
  ...
  nand4  g154(.a(new_n219_), .b(x79), .c(new_n160_), .d(x77), .O(new_n317_));
  ...
  nor4   g198(.a(new_n360_), .b(new_n356_), .c(new_n223_), .d(x82), .O(z55));
  ...
  nand4  g207(.a(x80), .b(new_n221_), .c(x43), .d(new_n236_), .O(new_n371_));
  oai22  g208(.a(new_n371_), .b(new_n224_), .c(new_n236_), .d(x40), .O(new_n372_));
  nand4  g209(.a(new_n372_), .b(x79), .c(x78), .d(x04), .O(new_n373_));
  nor2   g210(.a(x79), .b(x78), .O(new_n374_));
  nand3  g211(.a(new_n374_), .b(new_n236_), .c(x40), .O(new_n375_));
  nand2  g212(.a(new_n375_), .b(new_n373_), .O(new_n376_));
  nand2  g213(.a(new_n376_), .b(x77), .O(new_n377_));
  oai21  g214(.a(new_n165_), .b(new_n230_), .c(new_n154_), .O(new_n378_));
  aoi21  g215(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nor2   g216(.a(new_n160_), .b(new_n230_), .O(new_n380_));
  oai21  g217(.a(new_n380_), .b(new_n374_), .c(x40), .O(new_n381_));
  oai21  g218(.a(new_n224_), .b(new_n222_), .c(new_n236_), .O(new_n382_));
  ...
  nand2  g223(.a(new_n154_), .b(new_n230_), .O(new_n387_));
  aoi21  g224(.a(new_n387_), .b(new_n386_), .c(x01), .O(z59));
  nand2  g225(.a(new_n365_), .b(x79), .O(new_n389_));
  nand3  g226(.a(new_n389_), .b(new_n387_), .c(new_n227_), .O(new_n390_));
  and2   g227(.a(new_n390_), .b(new_n153_), .O(z60));
  nand2  g228(.a(new_n167_), .b(new_n363_), .O(new_n392_));
  nand2  g229(.a(new_n392_), .b(new_n219_), .O(new_n393_));
  oai21  g230(.a(new_n232_), .b(x04), .c(new_n393_), .O(new_n394_));
  ...
  nand3  g237(.a(x81), .b(x79), .c(new_n230_), .O(new_n401_));
  ...
  nor2   g248(.a(new_n239_), .b(x78), .O(new_n412_));
