...
module FAU ( 
  ...
  nor2   g108(.a(new_n219_), .b(new_n233_), .O(new_n270_));
  ...
  nand4  g129(.a(new_n276_), .b(x78), .c(x77), .d(x59), .O(new_n291_));
  nor3   g130(.a(new_n291_), .b(x04), .c(x01), .O(z41));
  nand4  g131(.a(new_n276_), .b(x78), .c(x77), .d(x60), .O(new_n293_));
  nor3   g132(.a(new_n293_), .b(x04), .c(x01), .O(z42));
  nand4  g133(.a(new_n276_), .b(x78), .c(x77), .d(x61), .O(new_n295_));
  nor3   g134(.a(new_n295_), .b(x04), .c(x01), .O(z43));
  nand4  g135(.a(new_n276_), .b(x78), .c(x77), .d(x62), .O(new_n297_));
  nor3   g136(.a(new_n297_), .b(x04), .c(x01), .O(z44));
  nand4  g137(.a(new_n276_), .b(x78), .c(x77), .d(x63), .O(new_n299_));
  nor3   g138(.a(new_n299_), .b(x04), .c(x01), .O(z45));
  nand4  g139(.a(new_n276_), .b(x78), .c(x77), .d(x64), .O(new_n301_));
  ...
  nand2  g154(.a(new_n322_), .b(new_n236_), .O(new_n323_));
  nor4   g155(.a(new_n323_), .b(new_n319_), .c(new_n219_), .d(x82), .O(z55));
  nand2  g156(.a(new_n229_), .b(x76), .O(new_n325_));
  inv1   g157(.a(new_n164_), .O(new_n326_));
  inv1   g158(.a(new_n166_), .O(new_n327_));
  xnor2a g159(.a(x84), .b(x81), .O(new_n328_));
  aoi21  g160(.a(new_n327_), .b(new_n326_), .c(new_n328_), .O(new_n329_));
  nand2  g161(.a(new_n329_), .b(new_n153_), .O(new_n330_));
  nand2  g162(.a(new_n330_), .b(new_n325_), .O(new_n331_));
  nand2  g163(.a(new_n331_), .b(x79), .O(new_n332_));
  nand4  g164(.a(new_n332_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g165(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n335_));
  oai22  g166(.a(new_n335_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n336_));
  nand4  g167(.a(new_n336_), .b(x79), .c(x78), .d(x04), .O(new_n337_));
  nor2   g168(.a(x79), .b(x78), .O(new_n338_));
  nand3  g169(.a(new_n338_), .b(new_n233_), .c(x40), .O(new_n339_));
  nand2  g170(.a(new_n339_), .b(new_n337_), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(x77), .O(new_n341_));
  oai21  g172(.a(new_n164_), .b(new_n225_), .c(new_n154_), .O(new_n342_));
  aoi21  g173(.a(new_n342_), .b(new_n341_), .c(x01), .O(z58));
  nor2   g174(.a(new_n160_), .b(new_n225_), .O(new_n344_));
  oai21  g175(.a(new_n344_), .b(new_n338_), .c(x40), .O(new_n345_));
  oai21  g176(.a(new_n220_), .b(new_n218_), .c(new_n233_), .O(new_n346_));
  ...
  nand2  g186(.a(new_n154_), .b(x04), .O(new_n357_));
  nand3  g187(.a(x84), .b(x81), .c(x79), .O(new_n358_));
  aoi21  g188(.a(new_n358_), .b(new_n357_), .c(x77), .O(new_n359_));
  nand2  g189(.a(new_n347_), .b(x04), .O(new_n360_));
  nand3  g190(.a(x81), .b(x79), .c(new_n225_), .O(new_n361_));
  aoi21  g191(.a(new_n361_), .b(new_n360_), .c(new_n159_), .O(new_n362_));
  oai21  g192(.a(new_n362_), .b(new_n359_), .c(x78), .O(new_n363_));
  inv1   g193(.a(new_n358_), .O(new_n364_));
  nand2  g194(.a(new_n364_), .b(new_n166_), .O(new_n365_));
  aoi21  g195(.a(new_n365_), .b(new_n363_), .c(x01), .O(z62));
  nor2   g196(.a(new_n166_), .b(new_n164_), .O(new_n367_));
  oai22  g197(.a(new_n367_), .b(new_n214_), .c(new_n229_), .d(x04), .O(new_n368_));
  nand4  g198(.a(new_n368_), .b(x82), .c(x79), .d(new_n153_), .O(new_n369_));
  inv1   g199(.a(new_n369_), .O(z63));
  nand3  g200(.a(new_n368_), .b(x83), .c(x79), .O(new_n371_));
  ...
  nor2   g204(.a(new_n236_), .b(x78), .O(new_n375_));
