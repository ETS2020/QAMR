...
module FAU ( 
  ...
  wire new_n155_, new_n156_, new_n157_, new_n159_, new_n161_, new_n162_,
    ...
    new_n219_, new_n222_, new_n224_, new_n226_, new_n228_, new_n230_,
  ...
  nand4  g059(.a(new_n218_), .b(x45), .c(new_n210_), .d(new_n201_), .O(new_n222_));
  nor2   g060(.a(new_n222_), .b(x01), .O(z27));
  nand4  g061(.a(new_n218_), .b(x46), .c(new_n210_), .d(new_n201_), .O(new_n224_));
  nor2   g062(.a(new_n224_), .b(x01), .O(z28));
  nand4  g063(.a(new_n218_), .b(x47), .c(new_n210_), .d(new_n201_), .O(new_n226_));
  nor2   g064(.a(new_n226_), .b(x01), .O(z29));
  nand4  g065(.a(new_n218_), .b(x48), .c(new_n210_), .d(new_n201_), .O(new_n228_));
  nor2   g066(.a(new_n228_), .b(x01), .O(z30));
  nand4  g067(.a(new_n218_), .b(x49), .c(new_n210_), .d(new_n201_), .O(new_n230_));
  nor2   g068(.a(new_n230_), .b(x01), .O(z31));
  nand4  g069(.a(new_n218_), .b(x50), .c(new_n210_), .d(new_n201_), .O(new_n232_));
  ...
  oai21  g074(.a(new_n239_), .b(new_n237_), .c(new_n214_), .O(new_n240_));
  nand2  g075(.a(x83), .b(x42), .O(new_n241_));
  nand2  g076(.a(new_n241_), .b(x81), .O(new_n242_));
  nand3  g077(.a(x83), .b(new_n213_), .c(x42), .O(new_n243_));
  nand2  g078(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g079(.a(new_n244_), .b(new_n211_), .O(new_n245_));
  aoi21  g080(.a(new_n245_), .b(new_n240_), .c(new_n156_), .O(new_n246_));
