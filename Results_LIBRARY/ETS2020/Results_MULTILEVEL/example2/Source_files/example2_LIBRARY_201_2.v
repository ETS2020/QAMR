...
module FAU ( 
  ...
  nor2   g117(.a(new_n221_), .b(new_n235_), .O(new_n275_));
  ...
  nor4   g193(.a(new_n355_), .b(new_n351_), .c(new_n221_), .d(x82), .O(z55));
  ...
  nand4  g202(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n366_));
  oai22  g203(.a(new_n366_), .b(new_n222_), .c(new_n235_), .d(x40), .O(new_n367_));
  nand4  g204(.a(new_n367_), .b(x79), .c(x78), .d(x04), .O(new_n368_));
  nor2   g205(.a(x79), .b(x78), .O(new_n369_));
  nand3  g206(.a(new_n369_), .b(new_n235_), .c(x40), .O(new_n370_));
  nand2  g207(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g208(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g209(.a(new_n165_), .b(new_n227_), .c(new_n154_), .O(new_n373_));
  aoi21  g210(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  nor2   g211(.a(new_n160_), .b(new_n227_), .O(new_n375_));
  oai21  g212(.a(new_n375_), .b(new_n369_), .c(x40), .O(new_n376_));
  oai21  g213(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n377_));
  nand2  g214(.a(new_n377_), .b(x79), .O(new_n378_));
  nand3  g215(.a(new_n378_), .b(x78), .c(x04), .O(new_n379_));
  nand2  g216(.a(new_n379_), .b(new_n376_), .O(new_n380_));
  nand2  g217(.a(new_n380_), .b(x77), .O(new_n381_));
  nand2  g218(.a(new_n154_), .b(new_n227_), .O(new_n382_));
  aoi21  g219(.a(new_n382_), .b(new_n381_), .c(x01), .O(z59));
  nand2  g220(.a(new_n360_), .b(x79), .O(new_n384_));
  nand3  g221(.a(new_n384_), .b(new_n382_), .c(new_n225_), .O(new_n385_));
  and2   g222(.a(new_n385_), .b(new_n153_), .O(z60));
  nand2  g223(.a(new_n167_), .b(new_n358_), .O(new_n387_));
  nand2  g224(.a(new_n387_), .b(new_n217_), .O(new_n388_));
  oai21  g225(.a(new_n231_), .b(x04), .c(new_n388_), .O(new_n389_));
  nand4  g226(.a(new_n389_), .b(x80), .c(x79), .d(new_n153_), .O(new_n390_));
  inv1   g227(.a(new_n390_), .O(z61));
  nand2  g228(.a(new_n154_), .b(x04), .O(new_n392_));
  nand3  g229(.a(x84), .b(x81), .c(x79), .O(new_n393_));
  aoi21  g230(.a(new_n393_), .b(new_n392_), .c(x77), .O(new_n394_));
  nand2  g231(.a(new_n378_), .b(x04), .O(new_n395_));
  nand3  g232(.a(x81), .b(x79), .c(new_n227_), .O(new_n396_));
  aoi21  g233(.a(new_n396_), .b(new_n395_), .c(new_n159_), .O(new_n397_));
  oai21  g234(.a(new_n397_), .b(new_n394_), .c(x78), .O(new_n398_));
  or2    g235(.a(new_n393_), .b(new_n167_), .O(new_n399_));
  aoi21  g236(.a(new_n399_), .b(new_n398_), .c(x01), .O(z62));
  nand4  g237(.a(new_n389_), .b(x82), .c(x79), .d(new_n153_), .O(new_n401_));
  inv1   g238(.a(new_n401_), .O(z63));
  nand3  g239(.a(new_n389_), .b(x83), .c(x79), .O(new_n403_));
  nand4  g240(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n404_));
  aoi21  g241(.a(new_n404_), .b(new_n403_), .c(x01), .O(z64));
  zero   g242(.O(z04));
  zero   g243(.O(z05));
  zero   g244(.O(z07));
  zero   g245(.O(z08));
