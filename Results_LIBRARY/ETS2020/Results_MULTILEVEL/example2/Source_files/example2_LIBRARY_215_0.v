...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n194_, new_n195_, new_n201_, new_n202_, new_n207_, new_n208_,
    new_n209_, new_n210_, new_n211_, new_n212_, new_n213_, new_n214_,
    new_n215_, new_n216_, new_n218_, new_n220_, new_n222_, new_n225_,
  ...
  inv1   g038(.a(x04), .O(new_n201_));
  nand3  g039(.a(new_n154_), .b(x05), .c(new_n201_), .O(new_n202_));
  nand3  g040(.a(new_n202_), .b(new_n153_), .c(x00), .O(z23));
  ...
  nand4  g050(.a(new_n215_), .b(x45), .c(new_n207_), .d(new_n201_), .O(new_n216_));
  nor2   g051(.a(new_n216_), .b(x01), .O(z27));
  nand4  g052(.a(new_n215_), .b(x46), .c(new_n207_), .d(new_n201_), .O(new_n218_));
  nor2   g053(.a(new_n218_), .b(x01), .O(z28));
  nand4  g054(.a(new_n215_), .b(x47), .c(new_n207_), .d(new_n201_), .O(new_n220_));
  nor2   g055(.a(new_n220_), .b(x01), .O(z29));
  nand4  g056(.a(new_n215_), .b(x48), .c(new_n207_), .d(new_n201_), .O(new_n222_));
  nor2   g057(.a(new_n222_), .b(x01), .O(z30));
  nand4  g058(.a(new_n215_), .b(x50), .c(new_n207_), .d(new_n201_), .O(new_n225_));
  ...
  oai21  g063(.a(new_n230_), .b(new_n228_), .c(new_n211_), .O(new_n231_));
  nand2  g064(.a(x83), .b(x42), .O(new_n232_));
  nand2  g065(.a(new_n232_), .b(x81), .O(new_n233_));
  nand3  g066(.a(x83), .b(new_n210_), .c(x42), .O(new_n234_));
  nand2  g067(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g068(.a(new_n235_), .b(new_n208_), .O(new_n236_));
  aoi21  g069(.a(new_n236_), .b(new_n231_), .c(new_n154_), .O(new_n237_));
  nand4  g070(.a(new_n237_), .b(x78), .c(x77), .d(x52), .O(new_n238_));
  nor3   g071(.a(new_n238_), .b(x04), .c(x01), .O(z34));
  nand4  g072(.a(new_n237_), .b(x78), .c(x77), .d(x54), .O(new_n241_));
  nor3   g073(.a(new_n241_), .b(x04), .c(x01), .O(z36));
  nand4  g074(.a(new_n237_), .b(x78), .c(x77), .d(x55), .O(new_n243_));
  nor3   g075(.a(new_n243_), .b(x04), .c(x01), .O(z37));
  nand4  g076(.a(new_n237_), .b(x78), .c(x77), .d(x56), .O(new_n245_));
  nor3   g077(.a(new_n245_), .b(x04), .c(x01), .O(z38));
  nand4  g078(.a(new_n237_), .b(x78), .c(x77), .d(x57), .O(new_n247_));
  nor3   g079(.a(new_n247_), .b(x04), .c(x01), .O(z39));
  nand4  g080(.a(new_n237_), .b(x78), .c(x77), .d(x59), .O(new_n250_));
  nor3   g081(.a(new_n250_), .b(x04), .c(x01), .O(z41));
  nand4  g082(.a(new_n237_), .b(x78), .c(x77), .d(x60), .O(new_n252_));
  nor3   g083(.a(new_n252_), .b(x04), .c(x01), .O(z42));
  nand4  g084(.a(new_n237_), .b(x78), .c(x77), .d(x61), .O(new_n254_));
  nor3   g085(.a(new_n254_), .b(x04), .c(x01), .O(z43));
  nand4  g086(.a(new_n237_), .b(x78), .c(x77), .d(x62), .O(new_n256_));
  nor3   g087(.a(new_n256_), .b(x04), .c(x01), .O(z44));
  nand4  g088(.a(new_n237_), .b(x78), .c(x77), .d(x63), .O(new_n258_));
  nor3   g089(.a(new_n258_), .b(x04), .c(x01), .O(z45));
  nand4  g090(.a(new_n237_), .b(x78), .c(x77), .d(x64), .O(new_n260_));
  ...
  inv1   g134(.a(x02), .O(new_n308_));
  nand4  g135(.a(x03), .b(new_n308_), .c(new_n153_), .d(x00), .O(new_n309_));
  inv1   g136(.a(new_n309_), .O(z57));
  nor2   g137(.a(new_n269_), .b(x04), .O(new_n318_));
  nor2   g138(.a(new_n210_), .b(x78), .O(new_n319_));
  oai21  g139(.a(new_n319_), .b(new_n318_), .c(x77), .O(new_n320_));
  nand3  g140(.a(x81), .b(x78), .c(new_n263_), .O(new_n321_));
  nand2  g141(.a(new_n321_), .b(new_n320_), .O(new_n322_));
  nand4  g142(.a(new_n322_), .b(x84), .c(x79), .d(new_n153_), .O(new_n323_));
  inv1   g143(.a(new_n323_), .O(z65));
  zero   g144(.O(z01));
  zero   g145(.O(z02));
  zero   g146(.O(z09));
  zero   g147(.O(z11));
