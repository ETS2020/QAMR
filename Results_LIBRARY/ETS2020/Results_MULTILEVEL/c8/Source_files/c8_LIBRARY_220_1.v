...
module FAU ( 
  ...
  oai21  g32(.a(x18), .b(new_n55_), .c(new_n81_), .O(new_n82_));
  nand2  g33(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nor2   g34(.a(x21), .b(x20), .O(new_n84_));
  nand2  g35(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  nor3   g36(.a(x22), .b(x21), .c(x20), .O(new_n86_));
  aoi22  g37(.a(new_n86_), .b(new_n72_), .c(new_n85_), .d(x22), .O(new_n87_));
  oai21  g38(.a(new_n87_), .b(new_n80_), .c(new_n83_), .O(z12));
  nand2  g39(.a(x18), .b(x04), .O(new_n89_));
  oai21  g40(.a(x18), .b(new_n58_), .c(new_n89_), .O(new_n90_));
  nand2  g41(.a(new_n90_), .b(new_n80_), .O(new_n91_));
  nor2   g42(.a(x22), .b(x21), .O(new_n92_));
  nand3  g43(.a(new_n92_), .b(new_n72_), .c(new_n51_), .O(new_n93_));
  nor3   g44(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g46(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(x23), .O(new_n96_));
  oai21  g47(.a(new_n96_), .b(new_n80_), .c(new_n91_), .O(z13));
  ...
  aoi21  g52(.a(new_n95_), .b(new_n94_), .c(new_n61_), .O(new_n102_));
  nor2   g53(.a(x20), .b(x19), .O(new_n103_));
  nor2   g54(.a(x24), .b(x23), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n103_), .c(new_n92_), .d(new_n70_), .O(new_n105_));
  inv1   g56(.a(new_n105_), .O(new_n106_));
  oai21  g57(.a(new_n106_), .b(new_n102_), .c(x16), .O(new_n107_));
  ...
  nand4  g65(.a(new_n114_), .b(new_n113_), .c(new_n84_), .d(new_n72_), .O(new_n115_));
  ...
  oai21  g70(.a(x18), .b(new_n67_), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g74(.a(new_n123_), .b(new_n113_), .c(new_n84_), .d(new_n72_), .O(new_n124_));
  ...
  nand4  g79(.a(new_n128_), .b(new_n123_), .c(new_n113_), .d(new_n84_), .O(new_n129_));
  nand2  g80(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g81(.a(new_n130_), .b(new_n129_), .c(new_n80_), .O(z17));
  zero   g82(.O(z02));
  zero   g83(.O(z10));
  zero   g84(.O(z11));
  buf    g85(.a(x27), .O(z08));
