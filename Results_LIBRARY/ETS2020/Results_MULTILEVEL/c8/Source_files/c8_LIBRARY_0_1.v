// Benchmark "FAU" written by ABC on Fri Jul 24 00:49:42 2020
...
module FAU ( 
  ...
  nand2  g49(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi21  g51(.a(new_n101_), .b(new_n83_), .c(new_n61_), .O(new_n102_));
  nor2   g52(.a(x20), .b(x19), .O(new_n103_));
  nor2   g53(.a(x22), .b(x21), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n71_), .O(new_n106_));
  inv1   g56(.a(new_n106_), .O(new_n107_));
  oai21  g57(.a(new_n107_), .b(new_n102_), .c(x16), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n100_), .O(z14));
  nand2  g59(.a(x18), .b(x06), .O(new_n110_));
  oai21  g60(.a(x18), .b(new_n64_), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  nand2  g62(.a(new_n106_), .b(x25), .O(new_n113_));
  nor2   g63(.a(x23), .b(x22), .O(new_n114_));
  nor2   g64(.a(x25), .b(x24), .O(new_n115_));
  nand4  g65(.a(new_n115_), .b(new_n114_), .c(new_n91_), .d(new_n73_), .O(new_n116_));
  ...
  oai21  g70(.a(x18), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  nand2  g71(.a(new_n121_), .b(new_n87_), .O(new_n122_));
  nand2  g72(.a(new_n116_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n114_), .c(new_n91_), .d(new_n73_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n91_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n87_), .O(z17));
  zero   g82(.O(z02));
  zero   g83(.O(z08));
  zero   g84(.O(z11));
  zero   g85(.O(z13));
