...
module FAU ( 
  ...
  oai21  g39(.a(x18), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nor2   g41(.a(x20), .b(x19), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n71_), .O(new_n91_));
  nor2   g43(.a(x21), .b(x20), .O(new_n92_));
  aoi22  g44(.a(new_n92_), .b(new_n73_), .c(new_n91_), .d(x21), .O(new_n93_));
  oai21  g45(.a(new_n93_), .b(new_n86_), .c(new_n89_), .O(z11));
  nand2  g46(.a(x18), .b(x04), .O(new_n96_));
  oai21  g47(.a(x18), .b(new_n58_), .c(new_n96_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n86_), .O(new_n98_));
  ...
  oai21  g53(.a(new_n102_), .b(new_n86_), .c(new_n98_), .O(z13));
  ...
  nand4  g60(.a(new_n109_), .b(new_n99_), .c(new_n90_), .d(new_n71_), .O(new_n110_));
  ...
  oai21  g65(.a(x18), .b(new_n64_), .c(new_n114_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n86_), .O(new_n116_));
  nand2  g67(.a(new_n110_), .b(x25), .O(new_n117_));
  nor2   g68(.a(x23), .b(x22), .O(new_n118_));
  nor2   g69(.a(x25), .b(x24), .O(new_n119_));
  nand4  g70(.a(new_n119_), .b(new_n118_), .c(new_n92_), .d(new_n73_), .O(new_n120_));
  ...
  oai21  g75(.a(x18), .b(new_n67_), .c(new_n124_), .O(new_n125_));
  nand2  g76(.a(new_n125_), .b(new_n86_), .O(new_n126_));
  nand2  g77(.a(new_n120_), .b(x26), .O(new_n127_));
  nor3   g78(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g79(.a(new_n128_), .b(new_n118_), .c(new_n92_), .d(new_n73_), .O(new_n129_));
  ...
  nand4  g84(.a(new_n133_), .b(new_n128_), .c(new_n118_), .d(new_n92_), .O(new_n134_));
  nand2  g85(.a(x27), .b(x17), .O(new_n135_));
  aoi21  g86(.a(new_n135_), .b(new_n134_), .c(new_n86_), .O(z17));
  zero   g87(.O(z03));
  zero   g88(.O(z08));
  zero   g89(.O(z12));
endmodule
