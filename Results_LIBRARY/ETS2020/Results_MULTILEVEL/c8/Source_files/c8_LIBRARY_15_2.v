...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n52_, new_n58_, new_n59_, new_n61_,
  ...
  nor2   g14(.a(x18), .b(new_n47_), .O(new_n66_));
  aoi21  g15(.a(x18), .b(x00), .c(new_n66_), .O(new_n67_));
  oai21  g16(.a(new_n67_), .b(x16), .c(new_n65_), .O(z09));
  ...
  oai21  g22(.a(new_n64_), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nand2  g23(.a(new_n74_), .b(x16), .O(new_n75_));
  oai21  g24(.a(new_n71_), .b(x16), .c(new_n75_), .O(z10));
  inv1   g25(.a(x16), .O(new_n77_));
  nand2  g26(.a(x18), .b(x02), .O(new_n78_));
  oai21  g27(.a(x18), .b(new_n51_), .c(new_n78_), .O(new_n79_));
  nand2  g28(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nor2   g29(.a(x21), .b(x20), .O(new_n81_));
  aoi22  g30(.a(new_n81_), .b(new_n64_), .c(new_n73_), .d(x21), .O(new_n82_));
  oai21  g31(.a(new_n82_), .b(new_n77_), .c(new_n80_), .O(z11));
  ...
  nand4  g53(.a(new_n107_), .b(new_n102_), .c(new_n98_), .d(new_n81_), .O(new_n108_));
  nand2  g54(.a(x27), .b(x17), .O(new_n109_));
  aoi21  g55(.a(new_n109_), .b(new_n108_), .c(new_n77_), .O(z17));
  zero   g56(.O(z01));
  zero   g57(.O(z03));
  zero   g58(.O(z04));
  zero   g59(.O(z05));
