...
module FAU ( 
  ...
  oai21  g36(.a(x18), .b(new_n54_), .c(new_n84_), .O(new_n85_));
  nand2  g37(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nor2   g38(.a(x20), .b(x19), .O(new_n87_));
  nand2  g39(.a(new_n87_), .b(new_n68_), .O(new_n88_));
  nor2   g40(.a(x21), .b(x20), .O(new_n89_));
  aoi22  g41(.a(new_n89_), .b(new_n70_), .c(new_n88_), .d(x21), .O(new_n90_));
  oai21  g42(.a(new_n90_), .b(new_n83_), .c(new_n86_), .O(z11));
  ...
  nand3  g48(.a(new_n97_), .b(new_n70_), .c(new_n51_), .O(new_n98_));
  nor3   g49(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g50(.a(new_n99_), .b(new_n80_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g51(.a(new_n100_), .b(new_n83_), .c(new_n96_), .O(z13));
  inv1   g52(.a(x13), .O(new_n102_));
  nand2  g53(.a(x18), .b(x05), .O(new_n103_));
  oai21  g54(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g55(.a(new_n104_), .b(new_n83_), .O(new_n105_));
  aoi21  g56(.a(new_n99_), .b(new_n80_), .c(new_n59_), .O(new_n106_));
  nor2   g57(.a(x24), .b(x23), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n97_), .c(new_n87_), .d(new_n68_), .O(new_n108_));
  ...
  nand2  g64(.a(new_n113_), .b(new_n83_), .O(new_n114_));
  nand2  g65(.a(new_n108_), .b(x25), .O(new_n115_));
  nor2   g66(.a(x23), .b(x22), .O(new_n116_));
  nor2   g67(.a(x25), .b(x24), .O(new_n117_));
  nand4  g68(.a(new_n117_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n118_));
  ...
  nand2  g74(.a(new_n123_), .b(new_n83_), .O(new_n124_));
  nand2  g75(.a(new_n118_), .b(x26), .O(new_n125_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand4  g77(.a(new_n126_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n127_));
  ...
  nand4  g82(.a(new_n131_), .b(new_n126_), .c(new_n116_), .d(new_n89_), .O(new_n132_));
  nand2  g83(.a(x27), .b(x17), .O(new_n133_));
  aoi21  g84(.a(new_n133_), .b(new_n132_), .c(new_n83_), .O(z17));
  zero   g85(.O(z03));
  zero   g86(.O(z04));
  zero   g87(.O(z12));
  buf    g88(.a(x27), .O(z08));
