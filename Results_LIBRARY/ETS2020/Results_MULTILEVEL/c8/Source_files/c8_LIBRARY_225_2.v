...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n50_, new_n56_, new_n57_, new_n59_, new_n60_, new_n61_,
  ...
  oai21  g25(.a(x18), .b(new_n49_), .c(new_n77_), .O(new_n78_));
  nand2  g26(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nor2   g27(.a(x21), .b(x20), .O(new_n80_));
  aoi22  g28(.a(new_n80_), .b(new_n62_), .c(new_n72_), .d(x21), .O(new_n81_));
  oai21  g29(.a(new_n81_), .b(new_n76_), .c(new_n79_), .O(z11));
  ...
  nand2  g34(.a(new_n80_), .b(new_n62_), .O(new_n87_));
  ...
  nand4  g43(.a(new_n98_), .b(new_n97_), .c(new_n80_), .d(new_n62_), .O(new_n99_));
  nand2  g44(.a(new_n99_), .b(x26), .O(new_n100_));
  nor3   g45(.a(x26), .b(x25), .c(x24), .O(new_n101_));
  nand4  g46(.a(new_n101_), .b(new_n97_), .c(new_n80_), .d(new_n62_), .O(new_n102_));
  ...
  nand4  g51(.a(new_n106_), .b(new_n101_), .c(new_n97_), .d(new_n80_), .O(new_n107_));
