...
module FAU ( 
  ...
  inv1   g42(.a(x21), .O(new_n91_));
  nand4  g43(.a(new_n91_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n92_));
  nand2  g44(.a(new_n92_), .b(x22), .O(new_n93_));
  nor2   g45(.a(x22), .b(x21), .O(new_n94_));
  nand3  g46(.a(new_n94_), .b(new_n72_), .c(new_n51_), .O(new_n95_));
  and2   g47(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  oai21  g48(.a(new_n96_), .b(new_n86_), .c(new_n90_), .O(z12));
  inv1   g49(.a(x12), .O(new_n98_));
  nand2  g50(.a(x18), .b(x04), .O(new_n99_));
  oai21  g51(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g54(.a(new_n102_), .b(new_n82_), .c(new_n95_), .d(x23), .O(new_n103_));
  oai21  g55(.a(new_n103_), .b(new_n86_), .c(new_n101_), .O(z13));
  inv1   g56(.a(x13), .O(new_n105_));
  nand2  g57(.a(x18), .b(x05), .O(new_n106_));
  oai21  g58(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g59(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  aoi21  g60(.a(new_n102_), .b(new_n82_), .c(new_n61_), .O(new_n109_));
  nor2   g61(.a(x20), .b(x19), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n94_), .c(new_n110_), .d(new_n70_), .O(new_n112_));
  inv1   g64(.a(new_n112_), .O(new_n113_));
  oai21  g65(.a(new_n113_), .b(new_n109_), .c(x16), .O(new_n114_));
  ...
  inv1   g71(.a(new_n92_), .O(new_n120_));
  nand4  g72(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n121_));
  inv1   g73(.a(new_n121_), .O(new_n122_));
  aoi22  g74(.a(new_n122_), .b(new_n120_), .c(new_n112_), .d(x25), .O(new_n123_));
  oai21  g75(.a(new_n123_), .b(new_n86_), .c(new_n119_), .O(z15));
  nand2  g76(.a(x18), .b(x07), .O(new_n125_));
  oai21  g77(.a(x18), .b(new_n67_), .c(new_n125_), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(new_n86_), .O(new_n127_));
  nor2   g79(.a(x21), .b(x20), .O(new_n128_));
  nor2   g80(.a(x23), .b(x22), .O(new_n129_));
  nor2   g81(.a(x25), .b(x24), .O(new_n130_));
  nand4  g82(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n72_), .O(new_n131_));
  nand2  g83(.a(new_n131_), .b(x26), .O(new_n132_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n133_));
  nand4  g85(.a(new_n133_), .b(new_n129_), .c(new_n128_), .d(new_n72_), .O(new_n134_));
  nand2  g86(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g87(.a(new_n135_), .b(x16), .O(new_n136_));
  nand2  g88(.a(new_n136_), .b(new_n127_), .O(z16));
  zero   g89(.O(z02));
  zero   g90(.O(z11));
  zero   g91(.O(z17));
  buf    g92(.a(x27), .O(z08));
