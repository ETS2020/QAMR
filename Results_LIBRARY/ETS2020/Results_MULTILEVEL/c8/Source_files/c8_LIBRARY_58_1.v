...
module FAU ( 
  ...
  nand2  g47(.a(new_n98_), .b(new_n86_), .O(new_n99_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi21  g49(.a(new_n100_), .b(new_n82_), .c(new_n59_), .O(new_n101_));
  nor2   g50(.a(x20), .b(x19), .O(new_n102_));
  nor2   g51(.a(x22), .b(x21), .O(new_n103_));
  nor2   g52(.a(x24), .b(x23), .O(new_n104_));
  nand4  g53(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n69_), .O(new_n105_));
  inv1   g54(.a(new_n105_), .O(new_n106_));
  oai21  g55(.a(new_n106_), .b(new_n101_), .c(x16), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n99_), .O(z14));
  nand2  g57(.a(x18), .b(x06), .O(new_n109_));
  oai21  g58(.a(x18), .b(new_n62_), .c(new_n109_), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n86_), .O(new_n111_));
  nand2  g60(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g61(.a(x23), .b(x22), .O(new_n113_));
  nor2   g62(.a(x25), .b(x24), .O(new_n114_));
  nand4  g63(.a(new_n114_), .b(new_n113_), .c(new_n90_), .d(new_n71_), .O(new_n115_));
  ...
  oai21  g68(.a(x18), .b(new_n65_), .c(new_n119_), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n86_), .O(new_n121_));
  nand2  g70(.a(new_n115_), .b(x26), .O(new_n122_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g72(.a(new_n123_), .b(new_n113_), .c(new_n90_), .d(new_n71_), .O(new_n124_));
  ...
  nand4  g77(.a(new_n128_), .b(new_n123_), .c(new_n113_), .d(new_n90_), .O(new_n129_));
  nand2  g78(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g79(.a(new_n130_), .b(new_n129_), .c(new_n86_), .O(z17));
  zero   g80(.O(z01));
  zero   g81(.O(z02));
  zero   g82(.O(z08));
  zero   g83(.O(z11));
