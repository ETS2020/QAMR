...
module FAU ( 
  ...
  oai21  g40(.a(x18), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nor2   g42(.a(x21), .b(x20), .O(new_n91_));
  nand2  g43(.a(new_n91_), .b(new_n73_), .O(new_n92_));
  nor3   g44(.a(x22), .b(x21), .c(x20), .O(new_n93_));
  aoi22  g45(.a(new_n93_), .b(new_n73_), .c(new_n92_), .d(x22), .O(new_n94_));
  oai21  g46(.a(new_n94_), .b(new_n87_), .c(new_n90_), .O(z12));
  nand2  g47(.a(x18), .b(x04), .O(new_n96_));
  oai21  g48(.a(x18), .b(new_n58_), .c(new_n96_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n87_), .O(new_n98_));
  nor2   g50(.a(x22), .b(x21), .O(new_n99_));
  nand3  g51(.a(new_n99_), .b(new_n73_), .c(new_n49_), .O(new_n100_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g53(.a(new_n101_), .b(new_n83_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g54(.a(new_n102_), .b(new_n87_), .c(new_n98_), .O(z13));
  inv1   g55(.a(x13), .O(new_n104_));
  nand2  g56(.a(x18), .b(x05), .O(new_n105_));
  oai21  g57(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g58(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  aoi21  g59(.a(new_n101_), .b(new_n83_), .c(new_n61_), .O(new_n108_));
  nor2   g60(.a(x20), .b(x19), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n99_), .c(new_n109_), .d(new_n70_), .O(new_n111_));
  inv1   g63(.a(new_n111_), .O(new_n112_));
  oai21  g64(.a(new_n112_), .b(new_n108_), .c(x16), .O(new_n113_));
  ...
  nand2  g68(.a(new_n116_), .b(new_n87_), .O(new_n117_));
  nand2  g69(.a(new_n111_), .b(x25), .O(new_n118_));
  nor2   g70(.a(x23), .b(x22), .O(new_n119_));
  nor2   g71(.a(x25), .b(x24), .O(new_n120_));
  nand4  g72(.a(new_n120_), .b(new_n119_), .c(new_n91_), .d(new_n73_), .O(new_n121_));
  ...
  oai21  g77(.a(x18), .b(new_n67_), .c(new_n125_), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(new_n87_), .O(new_n127_));
  nand2  g79(.a(new_n121_), .b(x26), .O(new_n128_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g81(.a(new_n129_), .b(new_n119_), .c(new_n91_), .d(new_n73_), .O(new_n130_));
  ...
  nor2   g85(.a(new_n71_), .b(x17), .O(new_n134_));
  nand4  g86(.a(new_n134_), .b(new_n129_), .c(new_n119_), .d(new_n91_), .O(new_n135_));
  nand2  g87(.a(x27), .b(x17), .O(new_n136_));
  aoi21  g88(.a(new_n136_), .b(new_n135_), .c(new_n87_), .O(z17));
  zero   g89(.O(z00));
  zero   g90(.O(z11));
  buf    g91(.a(x27), .O(z08));
endmodule
