...
module FAU ( 
  ...
  oai21  g63(.a(x18), .b(new_n64_), .c(new_n113_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n85_), .O(new_n115_));
  nand2  g65(.a(new_n109_), .b(x25), .O(new_n116_));
  nor2   g66(.a(x23), .b(x22), .O(new_n117_));
  nor2   g67(.a(x25), .b(x24), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n117_), .c(new_n89_), .d(new_n71_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g71(.a(new_n121_), .b(new_n115_), .O(z15));
  inv1   g72(.a(x15), .O(new_n123_));
  nand2  g73(.a(x18), .b(x07), .O(new_n124_));
  oai21  g74(.a(x18), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  nand2  g75(.a(new_n125_), .b(new_n85_), .O(new_n126_));
  nand2  g76(.a(new_n119_), .b(x26), .O(new_n127_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g78(.a(new_n128_), .b(new_n117_), .c(new_n89_), .d(new_n71_), .O(new_n129_));
  ...
  nand4  g83(.a(new_n133_), .b(new_n128_), .c(new_n117_), .d(new_n89_), .O(new_n134_));
