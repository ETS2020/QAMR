...
module FAU ( 
  ...
  nand2  g54(.a(x18), .b(x06), .O(new_n104_));
  oai21  g55(.a(x18), .b(new_n64_), .c(new_n104_), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  nor2   g57(.a(x24), .b(x23), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n98_), .c(new_n89_), .d(new_n70_), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(x25), .O(new_n109_));
  nor2   g60(.a(x23), .b(x22), .O(new_n110_));
  nor2   g61(.a(x25), .b(x24), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n110_), .c(new_n91_), .d(new_n72_), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(new_n106_), .O(z15));
  nand2  g66(.a(x18), .b(x07), .O(new_n116_));
  oai21  g67(.a(x18), .b(new_n67_), .c(new_n116_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(new_n85_), .O(new_n118_));
  nand2  g69(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g70(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g71(.a(new_n120_), .b(new_n110_), .c(new_n91_), .d(new_n72_), .O(new_n121_));
  nand2  g72(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g73(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g74(.a(new_n123_), .b(new_n118_), .O(z16));
  nor2   g75(.a(new_n48_), .b(x17), .O(new_n125_));
  nand4  g76(.a(new_n125_), .b(new_n120_), .c(new_n110_), .d(new_n91_), .O(new_n126_));
  nand2  g77(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g78(.a(new_n127_), .b(new_n126_), .c(new_n85_), .O(z17));
  zero   g79(.O(z03));
  zero   g80(.O(z12));
  zero   g81(.O(z14));
  buf    g82(.a(x27), .O(z08));
