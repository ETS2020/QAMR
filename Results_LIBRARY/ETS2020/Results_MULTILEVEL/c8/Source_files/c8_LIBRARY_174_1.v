// Benchmark "FAU" written by ABC on Fri Jul 24 00:50:37 2020
...
module FAU ( 
  ...
  nand2  g40(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nor2   g41(.a(x21), .b(x20), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n72_), .O(new_n91_));
  nor3   g43(.a(x22), .b(x21), .c(x20), .O(new_n92_));
  aoi22  g44(.a(new_n92_), .b(new_n72_), .c(new_n91_), .d(x22), .O(new_n93_));
  oai21  g45(.a(new_n93_), .b(new_n86_), .c(new_n89_), .O(z12));
  nand2  g46(.a(x18), .b(x04), .O(new_n95_));
  oai21  g47(.a(x18), .b(new_n58_), .c(new_n95_), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  ...
  oai21  g53(.a(new_n101_), .b(new_n86_), .c(new_n97_), .O(z13));
  inv1   g54(.a(x13), .O(new_n103_));
  nand2  g55(.a(x18), .b(x05), .O(new_n104_));
  oai21  g56(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(new_n86_), .O(new_n106_));
  aoi21  g58(.a(new_n100_), .b(new_n82_), .c(new_n61_), .O(new_n107_));
  nor2   g59(.a(x20), .b(x19), .O(new_n108_));
  nor2   g60(.a(x24), .b(x23), .O(new_n109_));
  nand4  g61(.a(new_n109_), .b(new_n98_), .c(new_n108_), .d(new_n70_), .O(new_n110_));
  inv1   g62(.a(new_n110_), .O(new_n111_));
  oai21  g63(.a(new_n111_), .b(new_n107_), .c(x16), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(new_n106_), .O(z14));
  nand2  g65(.a(x18), .b(x06), .O(new_n114_));
  oai21  g66(.a(x18), .b(new_n64_), .c(new_n114_), .O(new_n115_));
  nand2  g67(.a(new_n115_), .b(new_n86_), .O(new_n116_));
  nand2  g68(.a(new_n110_), .b(x25), .O(new_n117_));
  nor2   g69(.a(x23), .b(x22), .O(new_n118_));
  nor2   g70(.a(x25), .b(x24), .O(new_n119_));
  nand4  g71(.a(new_n119_), .b(new_n118_), .c(new_n90_), .d(new_n72_), .O(new_n120_));
  ...
  oai21  g76(.a(x18), .b(new_n67_), .c(new_n124_), .O(new_n125_));
  nand2  g77(.a(new_n125_), .b(new_n86_), .O(new_n126_));
  nand2  g78(.a(new_n120_), .b(x26), .O(new_n127_));
  nor3   g79(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g80(.a(new_n128_), .b(new_n118_), .c(new_n90_), .d(new_n72_), .O(new_n129_));
  ...
  nand4  g85(.a(new_n133_), .b(new_n128_), .c(new_n118_), .d(new_n90_), .O(new_n134_));
  nand2  g86(.a(x27), .b(x17), .O(new_n135_));
  aoi21  g87(.a(new_n135_), .b(new_n134_), .c(new_n86_), .O(z17));
  zero   g88(.O(z02));
  zero   g89(.O(z11));
  buf    g90(.a(x27), .O(z08));
endmodule
