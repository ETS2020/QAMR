...
module FAU ( 
  ...
  nand2  g35(.a(new_n90_), .b(new_n78_), .O(new_n91_));
  nor2   g36(.a(x23), .b(x22), .O(new_n92_));
  nor2   g37(.a(x25), .b(x24), .O(new_n93_));
  nand4  g38(.a(new_n93_), .b(new_n92_), .c(new_n82_), .d(new_n64_), .O(new_n94_));
  nand2  g39(.a(new_n94_), .b(x26), .O(new_n95_));
  nor3   g40(.a(x26), .b(x25), .c(x24), .O(new_n96_));
  nand4  g41(.a(new_n96_), .b(new_n92_), .c(new_n82_), .d(new_n64_), .O(new_n97_));
  nand2  g42(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  nand2  g43(.a(new_n98_), .b(x16), .O(new_n99_));
  nand2  g44(.a(new_n99_), .b(new_n91_), .O(z16));
  nor2   g45(.a(new_n62_), .b(x17), .O(new_n101_));
  nand4  g46(.a(new_n101_), .b(new_n96_), .c(new_n92_), .d(new_n82_), .O(new_n102_));
  nand2  g47(.a(x27), .b(x17), .O(new_n103_));
  aoi21  g48(.a(new_n103_), .b(new_n102_), .c(new_n78_), .O(z17));
  zero   g49(.O(z00));
  zero   g50(.O(z01));
  zero   g51(.O(z04));
  zero   g52(.O(z05));
