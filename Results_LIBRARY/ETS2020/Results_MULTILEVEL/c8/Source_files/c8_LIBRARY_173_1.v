...
module FAU ( 
  ...
  nand2  g35(.a(new_n85_), .b(new_n73_), .O(new_n86_));
  nor3   g36(.a(x22), .b(x21), .c(x20), .O(new_n87_));
  aoi22  g37(.a(new_n87_), .b(new_n73_), .c(new_n86_), .d(x22), .O(new_n88_));
  ...
  nor3   g44(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g46(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(x23), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n81_), .c(new_n92_), .O(z13));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n95_), .c(new_n61_), .O(new_n103_));
  nor2   g53(.a(x20), .b(x19), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n104_), .c(new_n93_), .d(new_n71_), .O(new_n106_));
  ...
  nand4  g65(.a(new_n115_), .b(new_n114_), .c(new_n85_), .d(new_n73_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n124_), .b(new_n114_), .c(new_n85_), .d(new_n73_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n85_), .O(new_n130_));
