...
module FAU ( 
  ...
  nand3  g25(.a(new_n75_), .b(new_n48_), .c(new_n64_), .O(new_n76_));
  ...
  oai21  g31(.a(x18), .b(new_n52_), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g36(.a(x18), .b(x07), .O(new_n91_));
  oai21  g37(.a(x18), .b(new_n61_), .c(new_n91_), .O(new_n92_));
  nand2  g38(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  nor2   g39(.a(x23), .b(x22), .O(new_n94_));
  nor2   g40(.a(x25), .b(x24), .O(new_n95_));
  nand4  g41(.a(new_n95_), .b(new_n94_), .c(new_n84_), .d(new_n66_), .O(new_n96_));
  nand2  g42(.a(new_n96_), .b(x26), .O(new_n97_));
  nor3   g43(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  nand4  g44(.a(new_n98_), .b(new_n94_), .c(new_n84_), .d(new_n66_), .O(new_n99_));
  nand2  g45(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand2  g46(.a(new_n100_), .b(x16), .O(new_n101_));
  nand2  g47(.a(new_n101_), .b(new_n93_), .O(z16));
  nor2   g48(.a(new_n48_), .b(x17), .O(new_n103_));
  nand4  g49(.a(new_n103_), .b(new_n98_), .c(new_n94_), .d(new_n84_), .O(new_n104_));
  nand2  g50(.a(x27), .b(x17), .O(new_n105_));
  aoi21  g51(.a(new_n105_), .b(new_n104_), .c(new_n80_), .O(z17));
  zero   g52(.O(z01));
  zero   g53(.O(z04));
  zero   g54(.O(z05));
  zero   g55(.O(z06));
