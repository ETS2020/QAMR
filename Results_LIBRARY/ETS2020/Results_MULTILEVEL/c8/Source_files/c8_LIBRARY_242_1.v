// Benchmark "FAU" written by ABC on Fri Jul 24 00:50:58 2020
...
module FAU ( 
  ...
  nand2  g56(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  nor2   g57(.a(x20), .b(x19), .O(new_n108_));
  nor2   g58(.a(x24), .b(x23), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n99_), .c(new_n108_), .d(new_n71_), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(x25), .O(new_n111_));
  nor2   g61(.a(x23), .b(x22), .O(new_n112_));
  nor2   g62(.a(x25), .b(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n112_), .c(new_n91_), .d(new_n73_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n107_), .O(z15));
  nand2  g67(.a(x18), .b(x07), .O(new_n118_));
  oai21  g68(.a(x18), .b(new_n67_), .c(new_n118_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(new_n87_), .O(new_n120_));
  nand2  g70(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g72(.a(new_n122_), .b(new_n112_), .c(new_n91_), .d(new_n73_), .O(new_n123_));
  ...
  nor2   g76(.a(new_n48_), .b(x17), .O(new_n127_));
  nand4  g77(.a(new_n127_), .b(new_n122_), .c(new_n112_), .d(new_n91_), .O(new_n128_));
  nand2  g78(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g79(.a(new_n129_), .b(new_n128_), .c(new_n87_), .O(z17));
  zero   g80(.O(z02));
  zero   g81(.O(z08));
  zero   g82(.O(z11));
  zero   g83(.O(z14));
