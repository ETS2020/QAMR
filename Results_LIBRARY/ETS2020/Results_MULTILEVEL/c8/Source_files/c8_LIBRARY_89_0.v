...
module FAU ( 
  ...
  nor2   g70(.a(x23), .b(x22), .O(new_n122_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nor2   g72(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g73(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g74(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g75(.a(new_n126_), .b(new_n125_), .c(new_n73_), .O(z17));
  zero   g76(.O(z07));
  zero   g77(.O(z08));
  zero   g78(.O(z09));
  zero   g79(.O(z10));
