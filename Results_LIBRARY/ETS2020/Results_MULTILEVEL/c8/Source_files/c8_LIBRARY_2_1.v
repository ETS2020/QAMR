...
module FAU ( 
  ...
  oai21  g36(.a(x18), .b(new_n55_), .c(new_n86_), .O(new_n87_));
  nand2  g37(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nor2   g38(.a(x21), .b(x20), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n71_), .O(new_n90_));
  nor3   g40(.a(x22), .b(x21), .c(x20), .O(new_n91_));
  aoi22  g41(.a(new_n91_), .b(new_n71_), .c(new_n90_), .d(x22), .O(new_n92_));
  oai21  g42(.a(new_n92_), .b(new_n85_), .c(new_n88_), .O(z12));
  nand2  g43(.a(x18), .b(x04), .O(new_n94_));
  oai21  g44(.a(x18), .b(new_n58_), .c(new_n94_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n85_), .O(new_n96_));
  nor2   g46(.a(x22), .b(x21), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n71_), .c(new_n51_), .O(new_n98_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g49(.a(new_n99_), .b(new_n81_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g50(.a(new_n100_), .b(new_n85_), .c(new_n96_), .O(z13));
  inv1   g51(.a(x13), .O(new_n102_));
  nand2  g52(.a(x18), .b(x05), .O(new_n103_));
  oai21  g53(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n85_), .O(new_n105_));
  aoi21  g55(.a(new_n99_), .b(new_n81_), .c(new_n61_), .O(new_n106_));
  nor2   g56(.a(x20), .b(x19), .O(new_n107_));
  nor2   g57(.a(x24), .b(x23), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n97_), .c(new_n107_), .d(new_n69_), .O(new_n109_));
  inv1   g59(.a(new_n109_), .O(new_n110_));
  oai21  g60(.a(new_n110_), .b(new_n106_), .c(x16), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n105_), .O(z14));
  inv1   g62(.a(x14), .O(new_n113_));
  nand2  g63(.a(x18), .b(x06), .O(new_n114_));
  oai21  g64(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n85_), .O(new_n116_));
  nand2  g66(.a(new_n109_), .b(x25), .O(new_n117_));
  nor2   g67(.a(x23), .b(x22), .O(new_n118_));
  nor2   g68(.a(x25), .b(x24), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n118_), .c(new_n89_), .d(new_n71_), .O(new_n120_));
  ...
  nand2  g75(.a(new_n125_), .b(new_n85_), .O(new_n126_));
  nand2  g76(.a(new_n120_), .b(x26), .O(new_n127_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g78(.a(new_n128_), .b(new_n118_), .c(new_n89_), .d(new_n71_), .O(new_n129_));
  ...
  nand4  g83(.a(new_n133_), .b(new_n128_), .c(new_n118_), .d(new_n89_), .O(new_n134_));
  nand2  g84(.a(x27), .b(x17), .O(new_n135_));
  aoi21  g85(.a(new_n135_), .b(new_n134_), .c(new_n85_), .O(z17));
  zero   g86(.O(z02));
  zero   g87(.O(z06));
  zero   g88(.O(z08));
  zero   g89(.O(z11));
