...
module FAU ( 
  ...
  aoi22  g37(.a(new_n86_), .b(new_n74_), .c(new_n85_), .d(x22), .O(new_n87_));
  ...
  nand3  g43(.a(new_n92_), .b(new_n74_), .c(new_n51_), .O(new_n93_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g45(.a(new_n94_), .b(new_n76_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n80_), .c(new_n91_), .O(z13));
  ...
  aoi21  g51(.a(new_n94_), .b(new_n76_), .c(new_n61_), .O(new_n101_));
  inv1   g52(.a(x17), .O(new_n102_));
  nor2   g53(.a(x20), .b(x19), .O(new_n103_));
  nor2   g54(.a(x24), .b(x23), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n92_), .c(new_n103_), .d(new_n102_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n114_), .b(new_n113_), .c(new_n84_), .d(new_n74_), .O(new_n115_));
  ...
  nand4  g74(.a(new_n123_), .b(new_n113_), .c(new_n84_), .d(new_n74_), .O(new_n124_));
