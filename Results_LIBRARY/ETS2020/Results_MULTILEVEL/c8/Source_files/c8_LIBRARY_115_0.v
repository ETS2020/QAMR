...
module FAU ( 
  ...
  nor2   g39(.a(x19), .b(x17), .O(new_n89_));
  nor2   g40(.a(x22), .b(x21), .O(new_n90_));
  nand3  g41(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(new_n91_));
  and2   g42(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  oai21  g43(.a(new_n92_), .b(new_n72_), .c(new_n87_), .O(z12));
  inv1   g44(.a(x12), .O(new_n94_));
  nand2  g45(.a(x18), .b(x04), .O(new_n95_));
  oai21  g46(.a(x18), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n72_), .O(new_n97_));
  nor3   g48(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  nor3   g49(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g50(.a(new_n99_), .b(new_n98_), .c(new_n91_), .d(x23), .O(new_n100_));
  oai21  g51(.a(new_n100_), .b(new_n72_), .c(new_n97_), .O(z13));
  inv1   g52(.a(x13), .O(new_n102_));
  nand2  g53(.a(x18), .b(x05), .O(new_n103_));
  oai21  g54(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g55(.a(new_n104_), .b(new_n72_), .O(new_n105_));
  aoi21  g56(.a(new_n99_), .b(new_n98_), .c(new_n63_), .O(new_n106_));
  nor2   g57(.a(x24), .b(x23), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n90_), .c(new_n78_), .d(new_n77_), .O(new_n108_));
  ...
  nand2  g65(.a(new_n114_), .b(new_n72_), .O(new_n115_));
  nand4  g66(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(new_n117_));
  aoi22  g68(.a(new_n117_), .b(new_n81_), .c(new_n108_), .d(x25), .O(new_n118_));
  oai21  g69(.a(new_n118_), .b(new_n72_), .c(new_n115_), .O(z15));
  inv1   g70(.a(x15), .O(new_n120_));
  nand2  g71(.a(x18), .b(x07), .O(new_n121_));
  oai21  g72(.a(x18), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g73(.a(new_n122_), .b(new_n72_), .O(new_n123_));
  nor2   g74(.a(x21), .b(x20), .O(new_n124_));
  nor2   g75(.a(x23), .b(x22), .O(new_n125_));
  nor2   g76(.a(x25), .b(x24), .O(new_n126_));
  nand4  g77(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n89_), .O(new_n127_));
  nand2  g78(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g79(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g80(.a(new_n129_), .b(new_n125_), .c(new_n124_), .d(new_n89_), .O(new_n130_));
  nand2  g81(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g82(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g83(.a(new_n132_), .b(new_n123_), .O(z16));
  zero   g84(.O(z07));
  zero   g85(.O(z09));
  zero   g86(.O(z10));
  zero   g87(.O(z17));
