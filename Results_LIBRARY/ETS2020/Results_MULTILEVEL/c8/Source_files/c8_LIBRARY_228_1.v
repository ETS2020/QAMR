...
module FAU ( 
  ...
  nor2   g42(.a(x21), .b(x20), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n73_), .O(new_n93_));
  nor3   g44(.a(x22), .b(x21), .c(x20), .O(new_n94_));
  aoi22  g45(.a(new_n94_), .b(new_n73_), .c(new_n93_), .d(x22), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n87_), .c(new_n91_), .O(z12));
  ...
  nand4  g52(.a(new_n73_), .b(new_n55_), .c(new_n101_), .d(new_n51_), .O(new_n102_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g54(.a(new_n103_), .b(new_n83_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g55(.a(new_n104_), .b(new_n87_), .c(new_n100_), .O(z13));
  ...
  nand3  g61(.a(new_n51_), .b(new_n48_), .c(new_n71_), .O(new_n111_));
  nand4  g62(.a(new_n61_), .b(new_n58_), .c(new_n55_), .d(new_n101_), .O(new_n112_));
  ...
  nand2  g68(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nor2   g69(.a(x23), .b(x22), .O(new_n120_));
  nor2   g70(.a(x25), .b(x24), .O(new_n121_));
  nand4  g71(.a(new_n121_), .b(new_n120_), .c(new_n92_), .d(new_n73_), .O(new_n122_));
  nand2  g72(.a(new_n122_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n120_), .c(new_n92_), .d(new_n73_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n120_), .d(new_n92_), .O(new_n130_));
