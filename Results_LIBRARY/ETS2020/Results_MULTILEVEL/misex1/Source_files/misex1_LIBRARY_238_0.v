// Benchmark "FAU" written by ABC on Fri Jul 24 17:26:01 2020
...
module FAU ( 
  ...
  nand4  g07(.a(x3), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n24_));
  nor2   g08(.a(x5), .b(new_n16_), .O(new_n25_));
  nor2   g09(.a(x6), .b(x2), .O(new_n26_));
  oai21  g10(.a(new_n26_), .b(new_n25_), .c(new_n20_), .O(new_n27_));
  inv1   g11(.a(x4), .O(new_n28_));
  oai21  g12(.a(new_n28_), .b(x2), .c(new_n20_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(x1), .O(new_n30_));
  oai21  g14(.a(new_n27_), .b(x1), .c(new_n30_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n17_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n24_), .O(z2));
  nand2  g17(.a(new_n19_), .b(x0), .O(new_n34_));
  oai21  g18(.a(x4), .b(x3), .c(x7), .O(new_n35_));
  ...
  aoi21  g29(.a(new_n45_), .b(x2), .c(new_n26_), .O(new_n46_));
  oai21  g30(.a(x5), .b(x3), .c(x2), .O(new_n47_));
  oai21  g31(.a(new_n46_), .b(x3), .c(new_n47_), .O(new_n48_));
  ...
  nor2   g38(.a(new_n47_), .b(x0), .O(new_n55_));
