...
module FAU ( 
  ...
  nand3  g45(.a(new_n45_), .b(x2), .c(new_n17_), .O(new_n62_));
  inv1   g46(.a(new_n62_), .O(new_n63_));
  oai21  g47(.a(new_n63_), .b(new_n51_), .c(new_n19_), .O(new_n64_));
  oai21  g48(.a(x4), .b(x2), .c(new_n20_), .O(new_n65_));
  nand3  g49(.a(new_n65_), .b(x1), .c(new_n17_), .O(new_n66_));
