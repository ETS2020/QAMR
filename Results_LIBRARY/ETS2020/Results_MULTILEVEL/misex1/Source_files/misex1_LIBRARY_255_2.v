// Benchmark "FAU" written by ABC on Fri Jul 24 17:26:09 2020
...
module FAU ( 
  ...
  nand3  g30(.a(new_n23_), .b(x2), .c(new_n19_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n17_), .O(new_n48_));
  nand2  g33(.a(new_n20_), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n43_), .c(new_n48_), .O(z3));
  aoi21  g35(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n52_));
  nand3  g36(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n53_));
  inv1   g37(.a(new_n53_), .O(new_n54_));
  oai21  g38(.a(new_n54_), .b(new_n52_), .c(new_n17_), .O(new_n55_));
  nand2  g39(.a(x3), .b(new_n16_), .O(new_n56_));
  aoi21  g40(.a(new_n49_), .b(new_n56_), .c(new_n17_), .O(new_n57_));
  nor3   g41(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n58_));
  oai21  g42(.a(new_n58_), .b(new_n57_), .c(new_n19_), .O(new_n59_));
  nand2  g43(.a(new_n59_), .b(new_n55_), .O(z5));
  nand3  g44(.a(new_n23_), .b(x2), .c(new_n17_), .O(new_n61_));
  inv1   g45(.a(new_n61_), .O(new_n62_));
  oai21  g46(.a(new_n62_), .b(new_n57_), .c(new_n19_), .O(new_n63_));
  oai21  g47(.a(x4), .b(x2), .c(new_n20_), .O(new_n64_));
  nand3  g48(.a(new_n64_), .b(x1), .c(new_n17_), .O(new_n65_));
  nand2  g49(.a(new_n65_), .b(new_n63_), .O(z6));
  zero   g50(.O(z4));
endmodule
