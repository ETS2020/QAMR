...
module FAU ( 
  ...
  nand4  g45(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n81_));
  nand2  g46(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand4  g47(.a(new_n82_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n83_));
  inv1   g48(.a(new_n83_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(x07), .c(x06), .O(new_n85_));
  inv1   g50(.a(x14), .O(new_n86_));
  or2    g51(.a(new_n44_), .b(new_n86_), .O(new_n87_));
  aoi21  g52(.a(new_n87_), .b(new_n85_), .c(new_n40_), .O(z10));
  nand2  g53(.a(x16), .b(new_n35_), .O(new_n89_));
  aoi21  g54(.a(new_n89_), .b(new_n56_), .c(new_n40_), .O(z12));
