...
module FAU ( 
  ...
  nand3  g35(.a(new_n70_), .b(new_n69_), .c(new_n61_), .O(new_n71_));
  oai21  g36(.a(new_n71_), .b(new_n59_), .c(x12), .O(new_n72_));
  inv1   g37(.a(x12), .O(new_n73_));
  inv1   g38(.a(new_n59_), .O(new_n74_));
  nand4  g39(.a(new_n65_), .b(new_n74_), .c(new_n73_), .d(new_n70_), .O(new_n75_));
  nand4  g40(.a(new_n75_), .b(new_n72_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g41(.a(x13), .O(new_n77_));
  nand4  g42(.a(new_n44_), .b(new_n77_), .c(new_n73_), .d(new_n70_), .O(new_n78_));
  nor2   g43(.a(new_n78_), .b(x10), .O(new_n79_));
  nand4  g44(.a(new_n79_), .b(new_n61_), .c(x08), .d(x07), .O(new_n80_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n73_), .c(new_n70_), .d(new_n69_), .O(new_n89_));
  ...
  aoi21  g61(.a(new_n81_), .b(new_n56_), .c(new_n40_), .O(z12));
