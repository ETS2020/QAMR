...
module FAU ( 
  ...
  oai21  g22(.a(new_n40_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand2  g23(.a(new_n58_), .b(x16), .O(new_n59_));
  inv1   g24(.a(x09), .O(new_n60_));
  nand3  g25(.a(new_n51_), .b(new_n60_), .c(x08), .O(new_n61_));
  nand2  g26(.a(new_n61_), .b(x10), .O(new_n62_));
  nor2   g27(.a(x10), .b(x09), .O(new_n63_));
  nand3  g28(.a(new_n63_), .b(new_n51_), .c(x08), .O(new_n64_));
  nand4  g29(.a(new_n64_), .b(new_n62_), .c(new_n59_), .d(x04), .O(z06));
  nand2  g30(.a(new_n64_), .b(x11), .O(new_n66_));
  inv1   g31(.a(x10), .O(new_n67_));
  inv1   g32(.a(x11), .O(new_n68_));
  nand3  g33(.a(x08), .b(x07), .c(x06), .O(new_n69_));
  inv1   g34(.a(new_n69_), .O(new_n70_));
  nand4  g35(.a(new_n70_), .b(new_n68_), .c(new_n67_), .d(new_n60_), .O(new_n71_));
  nand4  g36(.a(new_n71_), .b(new_n66_), .c(new_n59_), .d(x04), .O(z07));
  nand2  g37(.a(new_n71_), .b(x12), .O(new_n73_));
  inv1   g38(.a(x12), .O(new_n74_));
  nand4  g39(.a(new_n70_), .b(new_n63_), .c(new_n74_), .d(new_n68_), .O(new_n75_));
  nand4  g40(.a(new_n75_), .b(new_n73_), .c(new_n59_), .d(x04), .O(z08));
  inv1   g41(.a(x13), .O(new_n77_));
  nand4  g42(.a(new_n44_), .b(new_n77_), .c(new_n74_), .d(new_n68_), .O(new_n78_));
  ...
  oai21  g46(.a(new_n80_), .b(new_n43_), .c(new_n81_), .O(new_n82_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n74_), .c(new_n68_), .d(new_n67_), .O(new_n89_));
  nand2  g54(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand4  g55(.a(new_n90_), .b(new_n44_), .c(new_n60_), .d(x08), .O(new_n91_));
  ...
  aoi21  g61(.a(new_n81_), .b(new_n57_), .c(new_n40_), .O(z12));
