// Benchmark "FAU" written by ABC on Fri Jul 24 01:46:56 2020
...
module FAU ( 
  ...
  nand2  g100(.a(x22), .b(x01), .O(new_n165_));
  nor2   g101(.a(new_n165_), .b(x23), .O(z16));
  inv1   g102(.a(x23), .O(new_n167_));
  nor3   g103(.a(new_n165_), .b(x24), .c(new_n167_), .O(z17));
  oai21  g104(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n169_));
  nand2  g105(.a(new_n169_), .b(x08), .O(new_n170_));
  nand4  g106(.a(new_n170_), .b(new_n132_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g107(.a(new_n128_), .O(new_n172_));
  oai21  g108(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n173_));
  aoi21  g109(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n174_));
  oai21  g110(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g111(.a(new_n175_), .b(new_n81_), .c(new_n127_), .O(new_n176_));
  inv1   g112(.a(new_n176_), .O(z20));
  zero   g113(.O(z09));
  zero   g114(.O(z15));
  inv1   g115(.a(new_n135_), .O(z19));
endmodule
