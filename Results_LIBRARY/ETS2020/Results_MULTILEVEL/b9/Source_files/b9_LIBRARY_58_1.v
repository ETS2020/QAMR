...
module FAU ( 
  ...
  nand2  g032(.a(new_n71_), .b(x27), .O(new_n96_));
  aoi21  g033(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n97_));
  nand2  g034(.a(new_n97_), .b(new_n96_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(z06));
  inv1   g036(.a(z06), .O(z05));
  inv1   g037(.a(x03), .O(new_n101_));
  inv1   g038(.a(x31), .O(new_n102_));
  inv1   g039(.a(x33), .O(new_n103_));
  nand2  g040(.a(x17), .b(new_n63_), .O(new_n104_));
  inv1   g041(.a(x00), .O(new_n105_));
  oai21  g042(.a(x25), .b(new_n105_), .c(x38), .O(new_n106_));
  nand4  g043(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n102_), .O(new_n107_));
  inv1   g044(.a(x14), .O(new_n108_));
  inv1   g045(.a(x25), .O(new_n109_));
  nand3  g046(.a(x38), .b(new_n109_), .c(new_n105_), .O(new_n110_));
  nand2  g047(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  aoi21  g048(.a(new_n111_), .b(new_n107_), .c(new_n101_), .O(z07));
  nand4  g049(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n113_));
  inv1   g050(.a(new_n113_), .O(z09));
