// Benchmark "FAU" written by ABC on Fri Jul 24 01:46:34 2020
...
module FAU ( 
  ...
  oai21  g106(.a(new_n84_), .b(x27), .c(new_n129_), .O(new_n170_));
  nand2  g107(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g108(.a(new_n171_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g109(.a(new_n129_), .O(new_n173_));
  oai21  g110(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n174_));
  aoi21  g111(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g112(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  nand3  g113(.a(new_n176_), .b(new_n81_), .c(new_n128_), .O(new_n177_));
