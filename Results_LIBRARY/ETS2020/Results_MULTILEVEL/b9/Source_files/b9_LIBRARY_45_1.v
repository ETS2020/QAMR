...
module FAU ( 
  ...
  nand2  g070(.a(x27), .b(new_n65_), .O(new_n133_));
  ...
  inv1   g108(.a(new_n129_), .O(new_n172_));
  oai21  g109(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n173_));
  aoi21  g110(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n174_));
  oai21  g111(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g112(.a(new_n175_), .b(new_n81_), .c(new_n128_), .O(new_n176_));
  inv1   g113(.a(new_n176_), .O(z20));
  zero   g114(.O(z18));
  inv1   g115(.a(new_n136_), .O(z19));
endmodule
