...
module FAU ( 
  ...
  nand3  g085(.a(new_n122_), .b(new_n139_), .c(new_n65_), .O(new_n149_));
  ...
  oai21  g095(.a(new_n73_), .b(new_n64_), .c(new_n154_), .O(new_n159_));
  nand3  g096(.a(new_n159_), .b(new_n158_), .c(new_n155_), .O(z14));
  nand2  g097(.a(x22), .b(x01), .O(new_n162_));
  nor2   g098(.a(new_n162_), .b(x23), .O(z16));
  inv1   g099(.a(x23), .O(new_n164_));
  nor3   g100(.a(new_n162_), .b(x24), .c(new_n164_), .O(z17));
  oai21  g101(.a(new_n84_), .b(x27), .c(new_n129_), .O(new_n166_));
  nand2  g102(.a(new_n166_), .b(x08), .O(new_n167_));
  nand4  g103(.a(new_n167_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g104(.a(new_n129_), .O(new_n169_));
  oai21  g105(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n170_));
  aoi21  g106(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n171_));
  oai21  g107(.a(new_n171_), .b(new_n169_), .c(new_n170_), .O(new_n172_));
  nand3  g108(.a(new_n172_), .b(new_n81_), .c(new_n128_), .O(new_n173_));
  inv1   g109(.a(new_n173_), .O(z20));
  zero   g110(.O(z12));
  zero   g111(.O(z15));
  inv1   g112(.a(new_n136_), .O(z19));
endmodule
