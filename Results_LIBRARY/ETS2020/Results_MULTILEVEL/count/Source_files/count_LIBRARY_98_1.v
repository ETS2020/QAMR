...
module FAU ( 
  ...
  nand4  g053(.a(new_n104_), .b(new_n86_), .c(new_n69_), .d(new_n55_), .O(new_n105_));
  ...
  nand2  g066(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n86_), .c(new_n125_), .d(new_n85_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  aoi21  g077(.a(new_n128_), .b(new_n64_), .c(new_n124_), .O(new_n129_));
  nand3  g078(.a(new_n75_), .b(new_n55_), .c(new_n61_), .O(new_n130_));
  nor2   g079(.a(x27), .b(x26), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n94_), .c(new_n101_), .O(new_n132_));
  ...
  oai21  g088(.a(new_n139_), .b(new_n87_), .c(new_n53_), .O(new_n140_));
  ...
  nand2  g099(.a(new_n88_), .b(new_n64_), .O(new_n151_));
  nand4  g100(.a(new_n143_), .b(new_n126_), .c(new_n94_), .d(new_n75_), .O(new_n152_));
  ...
  oai21  g111(.a(new_n162_), .b(new_n95_), .c(new_n53_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n64_), .c(new_n161_), .O(new_n164_));
  ...
  inv1   g120(.a(x32), .O(new_n173_));
  nor2   g121(.a(x31), .b(x30), .O(new_n174_));
  nand4  g122(.a(new_n174_), .b(new_n143_), .c(new_n150_), .d(new_n111_), .O(new_n175_));
  oai21  g123(.a(new_n175_), .b(new_n113_), .c(new_n53_), .O(new_n176_));
  aoi21  g124(.a(new_n176_), .b(new_n64_), .c(new_n173_), .O(new_n177_));
  nor2   g125(.a(x32), .b(x31), .O(new_n178_));
  nand4  g126(.a(new_n178_), .b(new_n165_), .c(new_n143_), .d(new_n126_), .O(new_n179_));
  nor3   g127(.a(new_n179_), .b(new_n95_), .c(new_n63_), .O(new_n180_));
  oai21  g128(.a(new_n180_), .b(new_n177_), .c(x16), .O(new_n181_));
  inv1   g129(.a(x02), .O(new_n182_));
  aoi21  g130(.a(new_n58_), .b(new_n182_), .c(x18), .O(new_n183_));
  nand2  g131(.a(new_n183_), .b(new_n181_), .O(z13));
  inv1   g132(.a(x33), .O(new_n185_));
  nand4  g133(.a(new_n178_), .b(new_n154_), .c(new_n161_), .d(new_n124_), .O(new_n186_));
  oai21  g134(.a(new_n186_), .b(new_n127_), .c(new_n53_), .O(new_n187_));
  aoi21  g135(.a(new_n187_), .b(new_n64_), .c(new_n185_), .O(new_n188_));
  nand2  g136(.a(new_n154_), .b(new_n131_), .O(new_n189_));
  nor2   g137(.a(x33), .b(x32), .O(new_n190_));
  nand2  g138(.a(new_n190_), .b(new_n174_), .O(new_n191_));
  nor3   g139(.a(new_n191_), .b(new_n189_), .c(new_n105_), .O(new_n192_));
  oai21  g140(.a(new_n192_), .b(new_n188_), .c(x16), .O(new_n193_));
  inv1   g141(.a(x01), .O(new_n194_));
  aoi21  g142(.a(new_n58_), .b(new_n194_), .c(x18), .O(new_n195_));
  nand2  g143(.a(new_n195_), .b(new_n193_), .O(z14));
  inv1   g144(.a(x34), .O(new_n197_));
  nand4  g145(.a(new_n190_), .b(new_n174_), .c(new_n154_), .d(new_n124_), .O(new_n198_));
  oai21  g146(.a(new_n198_), .b(new_n127_), .c(new_n53_), .O(new_n199_));
  aoi21  g147(.a(new_n199_), .b(new_n64_), .c(new_n197_), .O(new_n200_));
  nand4  g148(.a(new_n174_), .b(new_n197_), .c(new_n185_), .d(new_n173_), .O(new_n201_));
  nor3   g149(.a(new_n201_), .b(new_n189_), .c(new_n105_), .O(new_n202_));
  oai21  g150(.a(new_n202_), .b(new_n200_), .c(x16), .O(new_n203_));
  inv1   g151(.a(x00), .O(new_n204_));
  aoi21  g152(.a(new_n58_), .b(new_n204_), .c(x18), .O(new_n205_));
  nand2  g153(.a(new_n205_), .b(new_n203_), .O(z15));
  zero   g154(.O(z12));
endmodule
