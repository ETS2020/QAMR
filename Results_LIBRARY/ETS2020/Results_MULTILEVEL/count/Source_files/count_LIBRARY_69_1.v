...
module FAU ( 
  ...
  nand3  g065(.a(new_n106_), .b(new_n77_), .c(new_n116_), .O(new_n117_));
  ...
  nor2   g073(.a(new_n124_), .b(new_n70_), .O(new_n125_));
  ...
  nand4  g079(.a(new_n121_), .b(new_n87_), .c(new_n120_), .d(new_n69_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n53_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n64_), .c(new_n130_), .O(new_n133_));
  nand3  g082(.a(new_n77_), .b(new_n55_), .c(new_n61_), .O(new_n134_));
  nor2   g083(.a(x27), .b(x26), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n95_), .c(new_n102_), .O(new_n136_));
  ...
  nand2  g091(.a(new_n135_), .b(new_n106_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n88_), .c(new_n53_), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n64_), .c(new_n142_), .O(new_n145_));
  nand2  g094(.a(new_n106_), .b(new_n116_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n89_), .b(new_n64_), .O(new_n155_));
  nand4  g104(.a(new_n147_), .b(new_n121_), .c(new_n95_), .d(new_n77_), .O(new_n156_));
  ...
  oai22  g108(.a(new_n159_), .b(new_n155_), .c(new_n157_), .d(new_n154_), .O(new_n160_));
  ...
  nand3  g114(.a(new_n158_), .b(new_n121_), .c(new_n130_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n103_), .c(new_n53_), .O(new_n167_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n158_), .c(new_n135_), .d(new_n102_), .O(new_n181_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n169_), .c(new_n147_), .d(new_n121_), .O(new_n192_));
  ...
  nor2   g147(.a(x33), .b(x32), .O(new_n200_));
  nand4  g148(.a(new_n200_), .b(new_n180_), .c(new_n158_), .d(new_n130_), .O(new_n201_));
  oai21  g149(.a(new_n201_), .b(new_n131_), .c(new_n53_), .O(new_n202_));
  aoi21  g150(.a(new_n202_), .b(new_n64_), .c(new_n199_), .O(new_n203_));
  nor3   g151(.a(x34), .b(x33), .c(x32), .O(new_n204_));
  nand4  g152(.a(new_n204_), .b(new_n180_), .c(new_n158_), .d(new_n135_), .O(new_n205_));
  nor2   g153(.a(new_n205_), .b(new_n109_), .O(new_n206_));
  oai21  g154(.a(new_n206_), .b(new_n203_), .c(x16), .O(new_n207_));
  inv1   g155(.a(x00), .O(new_n208_));
  aoi21  g156(.a(new_n58_), .b(new_n208_), .c(x18), .O(new_n209_));
  nand2  g157(.a(new_n209_), .b(new_n207_), .O(z15));
  zero   g158(.O(z14));
endmodule
