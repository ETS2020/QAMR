// Benchmark "FAU" written by ABC on Fri Jul 24 01:35:32 2020
...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_,
    ...
    new_n210_, new_n211_, new_n212_, new_n214_, new_n218_, new_n219_;
  ...
  inv1   g198(.a(new_n214_), .O(z2));
  nor2   g199(.a(x2), .b(x0), .O(new_n218_));
  nor2   g200(.a(new_n218_), .b(new_n97_), .O(new_n219_));
  nor2   g201(.a(new_n219_), .b(new_n214_), .O(z5));
  zero   g202(.O(z3));
  zero   g203(.O(z4));
endmodule
