// Benchmark "FAU" written by ABC on Fri Jul 24 01:35:34 2020
...
module FAU ( 
  ...
  xnor2a g201(.a(x3), .b(x1), .O(z2));
  nor2   g202(.a(new_n109_), .b(new_n141_), .O(z3));
  oai21  g203(.a(new_n17_), .b(x4), .c(new_n29_), .O(new_n220_));
  nand2  g204(.a(x4), .b(new_n48_), .O(new_n221_));
  nand3  g205(.a(new_n97_), .b(x7), .c(new_n49_), .O(new_n222_));
  nand3  g206(.a(new_n222_), .b(new_n221_), .c(new_n220_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(new_n37_), .O(new_n224_));
  nand3  g208(.a(new_n210_), .b(x2), .c(x0), .O(new_n225_));
  nand3  g209(.a(x6), .b(new_n29_), .c(new_n48_), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n225_), .c(x7), .O(new_n227_));
  nor2   g211(.a(new_n166_), .b(x0), .O(new_n228_));
  oai21  g212(.a(new_n228_), .b(new_n227_), .c(new_n141_), .O(new_n229_));
  oai21  g213(.a(x2), .b(new_n48_), .c(new_n141_), .O(new_n230_));
  nand4  g214(.a(new_n230_), .b(x7), .c(x6), .d(new_n49_), .O(new_n231_));
  nand3  g215(.a(new_n231_), .b(new_n229_), .c(new_n224_), .O(new_n232_));
  nand2  g216(.a(new_n232_), .b(new_n109_), .O(new_n233_));
  oai21  g217(.a(x6), .b(x2), .c(x0), .O(new_n234_));
  nand2  g218(.a(new_n234_), .b(new_n141_), .O(new_n235_));
  oai21  g219(.a(new_n192_), .b(new_n37_), .c(new_n25_), .O(new_n236_));
  aoi21  g220(.a(new_n236_), .b(new_n235_), .c(new_n49_), .O(new_n237_));
  oai21  g221(.a(x8), .b(x4), .c(new_n61_), .O(new_n238_));
  nand3  g222(.a(new_n238_), .b(new_n29_), .c(new_n48_), .O(new_n239_));
  nand2  g223(.a(new_n97_), .b(new_n78_), .O(new_n240_));
  aoi21  g224(.a(new_n240_), .b(new_n239_), .c(new_n109_), .O(new_n241_));
  aoi21  g225(.a(new_n241_), .b(x1), .c(new_n237_), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(new_n233_), .O(new_n243_));
  nand2  g227(.a(new_n243_), .b(x5), .O(new_n244_));
  aoi21  g228(.a(x7), .b(x2), .c(new_n17_), .O(new_n245_));
  aoi21  g229(.a(x4), .b(x3), .c(x1), .O(new_n246_));
  nand3  g230(.a(x7), .b(x4), .c(x3), .O(new_n247_));
  inv1   g231(.a(new_n247_), .O(new_n248_));
  oai22  g232(.a(x8), .b(x4), .c(x7), .d(x2), .O(new_n249_));
  oai21  g233(.a(new_n249_), .b(new_n248_), .c(x6), .O(new_n250_));
  oai21  g234(.a(new_n246_), .b(new_n245_), .c(new_n250_), .O(new_n251_));
  nand2  g235(.a(new_n251_), .b(new_n20_), .O(new_n252_));
  nand2  g236(.a(new_n167_), .b(x1), .O(new_n253_));
  nand3  g237(.a(new_n17_), .b(x6), .c(new_n109_), .O(new_n254_));
  aoi21  g238(.a(new_n254_), .b(new_n253_), .c(new_n25_), .O(new_n255_));
  nor2   g239(.a(x6), .b(new_n141_), .O(new_n256_));
  aoi22  g240(.a(new_n256_), .b(new_n120_), .c(new_n255_), .d(new_n49_), .O(new_n257_));
  aoi21  g241(.a(new_n257_), .b(new_n252_), .c(new_n48_), .O(new_n258_));
  nand3  g242(.a(new_n200_), .b(new_n37_), .c(x3), .O(new_n259_));
  nand2  g243(.a(new_n83_), .b(x4), .O(new_n260_));
  aoi21  g244(.a(new_n260_), .b(new_n259_), .c(new_n25_), .O(new_n261_));
  nand2  g245(.a(new_n78_), .b(new_n109_), .O(new_n262_));
  ...
  nand2  g249(.a(new_n78_), .b(new_n48_), .O(new_n266_));
  nand2  g250(.a(new_n17_), .b(x3), .O(new_n267_));
  aoi21  g251(.a(new_n267_), .b(new_n266_), .c(new_n29_), .O(new_n268_));
  nand3  g252(.a(new_n78_), .b(x3), .c(new_n141_), .O(new_n269_));
  inv1   g253(.a(new_n269_), .O(new_n270_));
  oai21  g254(.a(new_n270_), .b(new_n268_), .c(x4), .O(new_n271_));
  nand2  g255(.a(new_n120_), .b(x6), .O(new_n272_));
  ...
  aoi21  g260(.a(new_n276_), .b(new_n244_), .c(new_n18_), .O(z4));
  zero   g261(.O(z5));
endmodule
