...
module FAU ( 
  ...
  nand4  g48(.a(new_n59_), .b(new_n51_), .c(new_n94_), .d(new_n48_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n59_), .c(new_n94_), .d(new_n48_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(z11));
  nand3  g53(.a(new_n53_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g54(.a(new_n85_), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  nand4  g55(.a(new_n101_), .b(new_n59_), .c(new_n94_), .d(new_n48_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(z12));
  nand2  g57(.a(new_n86_), .b(new_n85_), .O(new_n104_));
  ...
  nand3  g64(.a(new_n110_), .b(new_n85_), .c(x19), .O(new_n111_));
  ...
  nand3  g77(.a(new_n59_), .b(new_n94_), .c(new_n48_), .O(new_n124_));
