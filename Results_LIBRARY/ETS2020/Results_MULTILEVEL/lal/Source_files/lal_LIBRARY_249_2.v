...
module FAU ( 
  ...
  nor2   g12(.a(new_n62_), .b(x07), .O(new_n63_));
  nand2  g13(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  inv1   g14(.a(new_n64_), .O(z09));
  inv1   g15(.a(x20), .O(new_n70_));
  nand4  g16(.a(new_n70_), .b(x19), .c(x18), .d(x17), .O(new_n71_));
  nand2  g17(.a(new_n71_), .b(x21), .O(new_n72_));
  nor2   g18(.a(x15), .b(x07), .O(new_n73_));
  nor2   g19(.a(x21), .b(x20), .O(new_n74_));
  nand4  g20(.a(new_n74_), .b(x19), .c(x18), .d(x17), .O(new_n75_));
  nand4  g21(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(new_n62_), .O(z14));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z03));
  zero   g25(.O(z07));
