...
module FAU ( 
  ...
  nand2  g76(.a(new_n89_), .b(x25), .O(new_n123_));
  nor3   g77(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n123_), .c(new_n108_), .d(new_n59_), .O(z18));
  zero   g80(.O(z17));
  buf    g81(.a(x16), .O(z02));
endmodule
