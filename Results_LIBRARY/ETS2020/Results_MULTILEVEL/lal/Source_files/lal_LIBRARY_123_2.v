...
module FAU ( 
  ...
  nand2  g12(.a(x05), .b(x04), .O(new_n65_));
  xor2a  g13(.a(x18), .b(x17), .O(new_n66_));
  nand4  g14(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n63_), .O(new_n67_));
  inv1   g15(.a(new_n67_), .O(z11));
  zero   g16(.O(z00));
  zero   g17(.O(z01));
  zero   g18(.O(z03));
  zero   g19(.O(z07));
