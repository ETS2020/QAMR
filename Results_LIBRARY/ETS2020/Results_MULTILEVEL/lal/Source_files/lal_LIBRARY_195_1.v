...
module FAU ( 
  ...
  oai21  g46(.a(new_n80_), .b(new_n53_), .c(new_n94_), .O(new_n95_));
  nand4  g47(.a(new_n95_), .b(new_n59_), .c(new_n88_), .d(new_n48_), .O(new_n96_));
  inv1   g48(.a(new_n96_), .O(z12));
  nand2  g49(.a(new_n81_), .b(new_n80_), .O(new_n98_));
  ...
  nand3  g56(.a(new_n104_), .b(new_n80_), .c(x19), .O(new_n105_));
  ...
  nand3  g60(.a(new_n108_), .b(new_n82_), .c(new_n50_), .O(new_n109_));
  ...
  nand3  g66(.a(new_n83_), .b(new_n75_), .c(new_n77_), .O(new_n115_));
  ...
  nand2  g72(.a(new_n84_), .b(x25), .O(new_n121_));
  nor3   g73(.a(x25), .b(x24), .c(x23), .O(new_n122_));
  nand4  g74(.a(new_n122_), .b(new_n82_), .c(new_n81_), .d(new_n80_), .O(new_n123_));
