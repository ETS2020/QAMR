...
module FAU ( 
  ...
  inv1   g10(.a(x07), .O(new_n64_));
  inv1   g11(.a(x15), .O(new_n65_));
  nand2  g12(.a(x05), .b(x04), .O(new_n66_));
  nand2  g13(.a(x18), .b(x17), .O(new_n67_));
  nand2  g14(.a(new_n67_), .b(x19), .O(new_n68_));
  inv1   g15(.a(x19), .O(new_n69_));
  nand3  g16(.a(new_n69_), .b(x18), .c(x17), .O(new_n70_));
  nand2  g17(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand4  g18(.a(new_n71_), .b(new_n66_), .c(new_n65_), .d(new_n64_), .O(new_n72_));
  inv1   g19(.a(new_n72_), .O(z12));
  zero   g20(.O(z00));
  zero   g21(.O(z01));
  zero   g22(.O(z03));
  zero   g23(.O(z07));
