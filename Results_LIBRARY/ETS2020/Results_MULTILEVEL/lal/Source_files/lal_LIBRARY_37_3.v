...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n98_, new_n99_, new_n101_, new_n102_, new_n103_, new_n107_,
  ...
  nand3  g60(.a(new_n107_), .b(new_n85_), .c(x19), .O(new_n108_));
  nand2  g61(.a(new_n108_), .b(x22), .O(new_n109_));
  nor2   g62(.a(x15), .b(x07), .O(new_n110_));
  nand3  g63(.a(x19), .b(x18), .c(x17), .O(new_n111_));
  inv1   g64(.a(new_n111_), .O(new_n112_));
  nand3  g65(.a(new_n112_), .b(new_n87_), .c(new_n50_), .O(new_n113_));
  nand4  g66(.a(new_n113_), .b(new_n110_), .c(new_n109_), .d(new_n59_), .O(z15));
  nand2  g67(.a(new_n113_), .b(x23), .O(new_n115_));
  nor2   g68(.a(x23), .b(x22), .O(new_n116_));
  nand3  g69(.a(new_n116_), .b(new_n112_), .c(new_n107_), .O(new_n117_));
  nand4  g70(.a(new_n117_), .b(new_n115_), .c(new_n110_), .d(new_n59_), .O(z16));
  ...
  nand3  g74(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n122_));
  aoi21  g75(.a(new_n117_), .b(x24), .c(new_n122_), .O(new_n123_));
  nand2  g76(.a(new_n123_), .b(new_n121_), .O(z17));
  nand2  g77(.a(new_n89_), .b(x25), .O(new_n125_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g79(.a(new_n126_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n127_));
  nand4  g80(.a(new_n127_), .b(new_n125_), .c(new_n110_), .d(new_n59_), .O(z18));
  zero   g81(.O(z13));
  zero   g82(.O(z14));
  buf    g83(.a(x16), .O(z02));
endmodule
