...
module FAU ( 
  ...
  nand4  g40(.a(new_n59_), .b(new_n51_), .c(new_n88_), .d(new_n48_), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(z10));
  xor2a  g42(.a(x18), .b(x17), .O(new_n91_));
  nand4  g43(.a(new_n91_), .b(new_n59_), .c(new_n88_), .d(new_n48_), .O(new_n92_));
  inv1   g44(.a(new_n92_), .O(z11));
  nand3  g45(.a(new_n53_), .b(x18), .c(x17), .O(new_n94_));
  oai21  g46(.a(new_n79_), .b(new_n53_), .c(new_n94_), .O(new_n95_));
  nand4  g47(.a(new_n95_), .b(new_n59_), .c(new_n88_), .d(new_n48_), .O(new_n96_));
  inv1   g48(.a(new_n96_), .O(z12));
  nand2  g49(.a(new_n80_), .b(new_n79_), .O(new_n98_));
  ...
  nand3  g56(.a(new_n104_), .b(new_n79_), .c(x19), .O(new_n105_));
  ...
  nand3  g60(.a(new_n108_), .b(new_n81_), .c(new_n50_), .O(new_n109_));
