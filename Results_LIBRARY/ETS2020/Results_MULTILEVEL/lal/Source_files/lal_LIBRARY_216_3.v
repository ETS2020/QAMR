// Benchmark "FAU" written by ABC on Fri Jul 24 18:32:45 2020
...
module FAU ( 
  ...
  nand2  g55(.a(new_n86_), .b(new_n85_), .O(new_n102_));
  nand3  g56(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x20), .O(new_n104_));
  nor2   g58(.a(x15), .b(x07), .O(new_n105_));
  nand4  g59(.a(new_n105_), .b(new_n104_), .c(new_n102_), .d(new_n59_), .O(z13));
  nand2  g60(.a(new_n102_), .b(x21), .O(new_n107_));
  nor2   g61(.a(x21), .b(x20), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n85_), .c(x19), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n107_), .c(new_n105_), .d(new_n59_), .O(z14));
  nand2  g64(.a(new_n109_), .b(x22), .O(new_n111_));
  inv1   g65(.a(new_n103_), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n87_), .c(new_n50_), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n111_), .c(new_n105_), .d(new_n59_), .O(z15));
  nand2  g68(.a(new_n113_), .b(x23), .O(new_n115_));
  nor2   g69(.a(x23), .b(x22), .O(new_n116_));
  nand3  g70(.a(new_n116_), .b(new_n108_), .c(new_n112_), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n115_), .c(new_n105_), .d(new_n59_), .O(z16));
  nand3  g72(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(x20), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(x19), .c(x18), .d(x17), .O(new_n121_));
  nand3  g75(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n122_));
  aoi21  g76(.a(new_n117_), .b(x24), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n121_), .O(z17));
  nand2  g78(.a(new_n89_), .b(x25), .O(new_n125_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n125_), .c(new_n105_), .d(new_n59_), .O(z18));
  zero   g82(.O(z12));
  buf    g83(.a(x16), .O(z02));
endmodule
