...
module FAU ( 
  ...
  nand3  g74(.a(new_n119_), .b(new_n111_), .c(new_n115_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n108_), .d(new_n59_), .O(z16));
  nand3  g76(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n122_));
  nor2   g77(.a(new_n122_), .b(x20), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(x19), .c(x18), .d(x17), .O(new_n124_));
  nand3  g79(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n125_));
  ...
  nand4  g84(.a(new_n129_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n108_), .d(new_n59_), .O(z18));
  buf    g86(.a(x16), .O(z02));
endmodule
