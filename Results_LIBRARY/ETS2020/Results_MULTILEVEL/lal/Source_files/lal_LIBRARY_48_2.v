...
module FAU ( 
  ...
  inv1   g10(.a(x20), .O(new_n66_));
  nand4  g11(.a(new_n66_), .b(x19), .c(x18), .d(x17), .O(new_n67_));
  nand2  g12(.a(new_n67_), .b(x21), .O(new_n68_));
  nor2   g13(.a(x15), .b(x07), .O(new_n69_));
  nand2  g14(.a(x05), .b(x04), .O(new_n70_));
  nor2   g15(.a(x21), .b(x20), .O(new_n71_));
  nand4  g16(.a(new_n71_), .b(x19), .c(x18), .d(x17), .O(new_n72_));
  nand4  g17(.a(new_n72_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(z14));
  zero   g18(.O(z00));
  zero   g19(.O(z01));
  zero   g20(.O(z03));
  zero   g21(.O(z07));
