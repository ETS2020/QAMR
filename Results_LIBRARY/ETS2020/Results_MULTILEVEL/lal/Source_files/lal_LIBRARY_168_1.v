// Benchmark "FAU" written by ABC on Fri Jul 24 18:32:29 2020
...
module FAU ( 
  ...
  nand2  g57(.a(new_n105_), .b(x22), .O(new_n106_));
  inv1   g58(.a(new_n99_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n80_), .c(new_n50_), .O(new_n108_));
  nand4  g60(.a(new_n108_), .b(new_n106_), .c(new_n101_), .d(new_n59_), .O(z15));
  nand2  g61(.a(new_n108_), .b(x23), .O(new_n110_));
  nor2   g62(.a(x23), .b(x22), .O(new_n111_));
  nand3  g63(.a(new_n111_), .b(new_n104_), .c(new_n107_), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(new_n110_), .c(new_n101_), .d(new_n59_), .O(z16));
  ...
  nand3  g68(.a(new_n59_), .b(new_n86_), .c(new_n48_), .O(new_n117_));
  ...
  nand4  g74(.a(new_n122_), .b(new_n120_), .c(new_n101_), .d(new_n59_), .O(z18));
  zero   g75(.O(z04));
  zero   g76(.O(z06));
  zero   g77(.O(z14));
  buf    g78(.a(x16), .O(z02));
