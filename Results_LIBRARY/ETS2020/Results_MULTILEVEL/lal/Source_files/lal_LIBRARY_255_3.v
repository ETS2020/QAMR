...
module FAU ( 
  ...
  nand2  g59(.a(new_n86_), .b(new_n85_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(x21), .O(new_n107_));
  nor2   g61(.a(x15), .b(x07), .O(new_n108_));
  nor2   g62(.a(x21), .b(x20), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n85_), .c(x19), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n59_), .O(z14));
  ...
  nand4  g69(.a(new_n115_), .b(new_n112_), .c(new_n108_), .d(new_n59_), .O(z15));
  nand2  g70(.a(new_n115_), .b(x23), .O(new_n117_));
  nor2   g71(.a(x23), .b(x22), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n114_), .c(new_n109_), .O(new_n119_));
