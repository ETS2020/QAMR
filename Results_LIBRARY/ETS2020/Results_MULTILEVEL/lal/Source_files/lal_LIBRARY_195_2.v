...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n62_,
  ...
  nand2  g10(.a(x05), .b(x04), .O(new_n64_));
  xor2a  g11(.a(x18), .b(x17), .O(new_n65_));
  nand4  g12(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n62_), .O(new_n66_));
  inv1   g13(.a(new_n66_), .O(z11));
  zero   g14(.O(z00));
  zero   g15(.O(z01));
  zero   g16(.O(z03));
  zero   g17(.O(z06));
