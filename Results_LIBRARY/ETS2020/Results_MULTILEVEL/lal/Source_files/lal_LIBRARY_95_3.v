// Benchmark "FAU" written by ABC on Fri Jul 24 18:32:05 2020
...
module FAU ( 
  ...
  nand4  g53(.a(new_n98_), .b(new_n59_), .c(new_n93_), .d(new_n48_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z11));
  nand3  g55(.a(new_n53_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g56(.a(new_n85_), .b(new_n53_), .c(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n59_), .c(new_n93_), .d(new_n48_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z12));
  nand2  g59(.a(new_n86_), .b(new_n85_), .O(new_n105_));
  nand3  g60(.a(x19), .b(x18), .c(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x20), .O(new_n107_));
  nor2   g62(.a(x15), .b(x07), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n105_), .d(new_n59_), .O(z13));
  nor2   g64(.a(x21), .b(x20), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n85_), .c(x19), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x22), .O(new_n113_));
  inv1   g67(.a(new_n106_), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n87_), .c(new_n50_), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n113_), .c(new_n108_), .d(new_n59_), .O(z15));
  nand2  g70(.a(new_n115_), .b(x23), .O(new_n117_));
  nor2   g71(.a(x23), .b(x22), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n111_), .c(new_n114_), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n117_), .c(new_n108_), .d(new_n59_), .O(z16));
  nand3  g74(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n121_));
  nor2   g75(.a(new_n121_), .b(x20), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(x19), .c(x18), .d(x17), .O(new_n123_));
  nand3  g77(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n124_));
  aoi21  g78(.a(new_n119_), .b(x24), .c(new_n124_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n123_), .O(z17));
  nand2  g80(.a(new_n89_), .b(x25), .O(new_n127_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n127_), .c(new_n108_), .d(new_n59_), .O(z18));
  zero   g84(.O(z14));
  buf    g85(.a(x16), .O(z02));
endmodule
