...
module FAU ( 
  ...
  nand3  g10(.a(x19), .b(x18), .c(x17), .O(new_n65_));
  nand2  g11(.a(new_n65_), .b(x20), .O(new_n66_));
  nor2   g12(.a(x15), .b(x07), .O(new_n67_));
  inv1   g13(.a(x20), .O(new_n68_));
  nand4  g14(.a(new_n68_), .b(x19), .c(x18), .d(x17), .O(new_n69_));
  nand2  g15(.a(x05), .b(x04), .O(new_n70_));
  nand4  g16(.a(new_n70_), .b(new_n69_), .c(new_n67_), .d(new_n66_), .O(z13));
  zero   g17(.O(z00));
  zero   g18(.O(z01));
  zero   g19(.O(z03));
  zero   g20(.O(z07));
