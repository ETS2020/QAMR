...
module FAU ( 
  ...
  nand2  g68(.a(new_n87_), .b(new_n50_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n106_), .c(x23), .O(new_n116_));
  inv1   g70(.a(new_n106_), .O(new_n117_));
  nor2   g71(.a(x23), .b(x22), .O(new_n118_));
  nand3  g72(.a(new_n118_), .b(new_n111_), .c(new_n117_), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n116_), .c(new_n108_), .d(new_n59_), .O(z16));
