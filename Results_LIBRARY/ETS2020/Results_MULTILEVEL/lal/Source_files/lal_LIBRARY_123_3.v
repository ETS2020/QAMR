...
module FAU ( 
  ...
  nand3  g52(.a(new_n53_), .b(x18), .c(x17), .O(new_n99_));
  oai21  g53(.a(new_n85_), .b(new_n53_), .c(new_n99_), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n59_), .c(new_n93_), .d(new_n48_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(z12));
  nand2  g56(.a(new_n86_), .b(new_n85_), .O(new_n103_));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(x20), .O(new_n105_));
  nor2   g59(.a(x15), .b(x07), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n105_), .c(new_n103_), .d(new_n59_), .O(z13));
  nand2  g61(.a(new_n103_), .b(x21), .O(new_n108_));
  nor2   g62(.a(x21), .b(x20), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n85_), .c(x19), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n108_), .c(new_n106_), .d(new_n59_), .O(z14));
  nand2  g65(.a(new_n110_), .b(x22), .O(new_n112_));
  inv1   g66(.a(new_n104_), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n87_), .c(new_n50_), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n112_), .c(new_n106_), .d(new_n59_), .O(z15));
  nand2  g69(.a(new_n114_), .b(x23), .O(new_n116_));
  nor2   g70(.a(x23), .b(x22), .O(new_n117_));
  nand3  g71(.a(new_n117_), .b(new_n109_), .c(new_n113_), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n59_), .O(z16));
  nand3  g73(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(x20), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(x19), .c(x18), .d(x17), .O(new_n122_));
  nand3  g76(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n123_));
  aoi21  g77(.a(new_n118_), .b(x24), .c(new_n123_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n122_), .O(z17));
  nand2  g79(.a(new_n89_), .b(x25), .O(new_n126_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n126_), .c(new_n106_), .d(new_n59_), .O(z18));
  zero   g83(.O(z11));
  buf    g84(.a(x16), .O(z02));
endmodule
