...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18;
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n65_,
  ...
  nand4  g09(.a(new_n65_), .b(x19), .c(x18), .d(x17), .O(new_n66_));
  nand2  g10(.a(new_n66_), .b(x21), .O(new_n67_));
  nor2   g11(.a(x15), .b(x07), .O(new_n68_));
  nand2  g12(.a(x05), .b(x04), .O(new_n69_));
  nor2   g13(.a(x21), .b(x20), .O(new_n70_));
  nand4  g14(.a(new_n70_), .b(x19), .c(x18), .d(x17), .O(new_n71_));
  nand4  g15(.a(new_n71_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(z14));
  zero   g16(.O(z00));
  zero   g17(.O(z01));
  zero   g18(.O(z03));
  zero   g19(.O(z06));
