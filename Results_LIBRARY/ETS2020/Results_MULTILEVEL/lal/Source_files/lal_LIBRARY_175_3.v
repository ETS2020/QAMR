// Benchmark "FAU" written by ABC on Fri Jul 24 18:32:31 2020
...
module FAU ( 
  ...
  nand3  g66(.a(new_n111_), .b(new_n85_), .c(x19), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n108_), .d(new_n59_), .O(z14));
  nand2  g68(.a(new_n112_), .b(x22), .O(new_n114_));
  inv1   g69(.a(new_n106_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n87_), .c(new_n50_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n108_), .d(new_n59_), .O(z15));
  ...
  nand3  g76(.a(new_n122_), .b(new_n111_), .c(new_n115_), .O(new_n123_));
  nand3  g77(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n124_));
  aoi21  g78(.a(new_n123_), .b(x24), .c(new_n124_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n121_), .O(z17));
