...
module FAU ( 
  ...
  nand2  g083(.a(new_n113_), .b(x10), .O(new_n128_));
  nor3   g084(.a(new_n128_), .b(new_n124_), .c(new_n123_), .O(new_n129_));
  nor2   g085(.a(x32), .b(new_n106_), .O(new_n130_));
  ...
  nand3  g093(.a(new_n137_), .b(x17), .c(x16), .O(new_n138_));
  ...
  aoi21  g108(.a(new_n152_), .b(new_n145_), .c(z0), .O(new_n153_));
  ...
  nand2  g121(.a(new_n106_), .b(x30), .O(new_n166_));
