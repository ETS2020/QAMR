// Benchmark "FAU" written by ABC on Fri Jul 24 21:44:24 2020
...
module FAU ( 
  ...
  nand2  g101(.a(new_n112_), .b(x27), .O(new_n146_));
  oai21  g102(.a(x30), .b(x27), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n99_), .O(new_n148_));
  ...
  oai21  g109(.a(new_n135_), .b(new_n153_), .c(new_n83_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n86_), .O(new_n156_));
  ...
  nand4  g130(.a(new_n144_), .b(new_n169_), .c(new_n118_), .d(new_n107_), .O(new_n175_));
  ...
  oai21  g142(.a(new_n86_), .b(new_n153_), .c(new_n83_), .O(new_n187_));
  nand2  g143(.a(new_n86_), .b(new_n155_), .O(new_n188_));
