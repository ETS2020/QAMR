...
module FAU ( 
  ...
  nand2  g077(.a(new_n99_), .b(new_n79_), .O(new_n123_));
  inv1   g078(.a(x33), .O(new_n124_));
  nand3  g079(.a(x19), .b(new_n86_), .c(x13), .O(new_n125_));
  nand3  g080(.a(new_n89_), .b(x18), .c(x14), .O(new_n126_));
  aoi21  g081(.a(new_n126_), .b(new_n125_), .c(new_n83_), .O(new_n127_));
  nand4  g082(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n128_));
  inv1   g083(.a(new_n128_), .O(new_n129_));
  oai21  g084(.a(new_n129_), .b(new_n127_), .c(x16), .O(new_n130_));
  inv1   g085(.a(x16), .O(new_n131_));
  nand3  g086(.a(x19), .b(x18), .c(x17), .O(new_n132_));
  inv1   g087(.a(new_n132_), .O(new_n133_));
  nand3  g088(.a(new_n133_), .b(new_n131_), .c(x11), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand2  g090(.a(new_n135_), .b(x15), .O(new_n136_));
  inv1   g091(.a(x15), .O(new_n137_));
  nand4  g092(.a(new_n133_), .b(x16), .c(new_n137_), .d(x10), .O(new_n138_));
  nand2  g093(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand4  g094(.a(new_n139_), .b(new_n124_), .c(x31), .d(x30), .O(new_n140_));
  nand2  g095(.a(x33), .b(new_n117_), .O(new_n141_));
  nand2  g096(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand3  g097(.a(new_n142_), .b(new_n123_), .c(x29), .O(new_n143_));
  nand2  g098(.a(new_n123_), .b(x29), .O(new_n144_));
  nand4  g099(.a(new_n139_), .b(new_n124_), .c(new_n117_), .d(new_n107_), .O(new_n145_));
  nand2  g100(.a(x33), .b(x31), .O(new_n146_));
  nand2  g101(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g102(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  aoi21  g103(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n149_));
  nand4  g104(.a(new_n149_), .b(x17), .c(x16), .d(x15), .O(new_n150_));
  nand2  g105(.a(x16), .b(x15), .O(new_n151_));
  nand2  g106(.a(x18), .b(x17), .O(new_n152_));
  oai21  g107(.a(new_n152_), .b(new_n151_), .c(new_n89_), .O(new_n153_));
  nand2  g108(.a(x16), .b(x10), .O(new_n154_));
  oai21  g109(.a(new_n154_), .b(new_n152_), .c(new_n137_), .O(new_n155_));
  inv1   g110(.a(x11), .O(new_n156_));
  oai21  g111(.a(new_n152_), .b(new_n156_), .c(new_n131_), .O(new_n157_));
  nand2  g112(.a(x18), .b(x12), .O(new_n158_));
  nand2  g113(.a(new_n158_), .b(new_n83_), .O(new_n159_));
  inv1   g114(.a(x13), .O(new_n160_));
  nand2  g115(.a(new_n86_), .b(new_n160_), .O(new_n161_));
  xnor2a g116(.a(x31), .b(x30), .O(new_n162_));
  nand4  g117(.a(new_n162_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n163_));
  inv1   g118(.a(new_n163_), .O(new_n164_));
  nand4  g119(.a(new_n164_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(new_n165_));
  nand2  g120(.a(new_n165_), .b(x33), .O(new_n166_));
  nand3  g121(.a(new_n166_), .b(new_n148_), .c(new_n143_), .O(new_n167_));
  nand3  g122(.a(new_n167_), .b(new_n78_), .c(x00), .O(new_n168_));
  inv1   g123(.a(new_n168_), .O(z9));
  zero   g124(.O(z8));
endmodule
