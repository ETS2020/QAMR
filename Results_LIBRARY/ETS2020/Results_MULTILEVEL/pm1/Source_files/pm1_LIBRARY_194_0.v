// Benchmark "FAU" written by ABC on Fri Jul 24 17:43:22 2020
...
module FAU ( 
  ...
  nand4  g29(.a(new_n53_), .b(new_n46_), .c(x09), .d(x04), .O(new_n59_));
  ...
  nand4  g36(.a(new_n53_), .b(x12), .c(x11), .d(new_n51_), .O(new_n66_));
  ...
  nand4  g42(.a(x11), .b(new_n51_), .c(new_n65_), .d(x00), .O(new_n72_));
