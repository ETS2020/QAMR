...
module FAU ( 
  ...
  nand4  g32(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  oai21  g33(.a(x12), .b(x01), .c(new_n65_), .O(new_n66_));
  nand4  g34(.a(new_n66_), .b(x11), .c(new_n51_), .d(x00), .O(new_n67_));
  inv1   g35(.a(new_n67_), .O(z11));
  inv1   g36(.a(x09), .O(new_n69_));
  nand4  g37(.a(x11), .b(new_n51_), .c(new_n69_), .d(x00), .O(new_n70_));
  nor2   g38(.a(new_n70_), .b(new_n52_), .O(z12));
  zero   g39(.O(z05));
  zero   g40(.O(z07));
  zero   g41(.O(z10));
endmodule
