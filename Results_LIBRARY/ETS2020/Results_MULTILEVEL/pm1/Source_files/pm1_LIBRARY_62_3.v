// Benchmark "FAU" written by ABC on Fri Jul 24 17:42:24 2020
...
module FAU ( 
  ...
  nand4  g15(.a(new_n35_), .b(x04), .c(x03), .d(x02), .O(new_n46_));
  ...
  aoi21  g24(.a(new_n51_), .b(new_n34_), .c(new_n54_), .O(new_n55_));
  nand4  g25(.a(new_n55_), .b(new_n35_), .c(new_n50_), .d(x00), .O(z08));
  inv1   g26(.a(x00), .O(new_n58_));
  inv1   g27(.a(x09), .O(new_n59_));
  nand4  g28(.a(new_n52_), .b(x12), .c(x11), .d(new_n50_), .O(new_n60_));
  nor3   g29(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z10));
  nand4  g30(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g31(.a(new_n51_), .b(new_n30_), .O(new_n63_));
  nand2  g32(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand4  g33(.a(new_n64_), .b(x11), .c(new_n50_), .d(x00), .O(new_n65_));
  inv1   g34(.a(new_n65_), .O(z11));
  nand4  g35(.a(x11), .b(new_n50_), .c(new_n59_), .d(x00), .O(new_n67_));
  nor2   g36(.a(new_n67_), .b(new_n51_), .O(z12));
  zero   g37(.O(z04));
  zero   g38(.O(z09));
endmodule
