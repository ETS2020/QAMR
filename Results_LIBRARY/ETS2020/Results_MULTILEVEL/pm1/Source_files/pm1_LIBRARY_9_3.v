...
module FAU ( 
  ...
  nand4  g29(.a(new_n52_), .b(x12), .c(x11), .d(new_n50_), .O(new_n60_));
  nor3   g30(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z10));
  nand4  g31(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g32(.a(new_n51_), .b(new_n30_), .O(new_n63_));
  ...
  nand4  g36(.a(x11), .b(new_n50_), .c(new_n59_), .d(x00), .O(new_n67_));
  nor2   g37(.a(new_n67_), .b(new_n51_), .O(z12));
  zero   g38(.O(z09));
endmodule
