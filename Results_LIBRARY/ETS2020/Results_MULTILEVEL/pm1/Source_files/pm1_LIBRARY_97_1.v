// Benchmark "FAU" written by ABC on Fri Jul 24 17:42:40 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n53_), .b(new_n34_), .O(new_n54_));
  nand3  g24(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand4  g25(.a(new_n55_), .b(new_n46_), .c(x09), .d(x04), .O(new_n56_));
  nand3  g26(.a(new_n56_), .b(x12), .c(x11), .O(new_n57_));
  nand2  g27(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  nand3  g28(.a(new_n58_), .b(new_n52_), .c(x00), .O(new_n59_));
  inv1   g29(.a(new_n59_), .O(z09));
  inv1   g30(.a(x00), .O(new_n61_));
  inv1   g31(.a(x09), .O(new_n62_));
  nand4  g32(.a(new_n55_), .b(x12), .c(x11), .d(new_n52_), .O(new_n63_));
  nor3   g33(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z10));
  nand4  g34(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  oai21  g35(.a(x12), .b(x01), .c(new_n65_), .O(new_n66_));
  nand4  g36(.a(new_n66_), .b(x11), .c(new_n52_), .d(x00), .O(new_n67_));
  inv1   g37(.a(new_n67_), .O(z11));
  nand4  g38(.a(x11), .b(new_n52_), .c(new_n62_), .d(x00), .O(new_n69_));
  nor2   g39(.a(new_n69_), .b(new_n53_), .O(z12));
  zero   g40(.O(z08));
endmodule
