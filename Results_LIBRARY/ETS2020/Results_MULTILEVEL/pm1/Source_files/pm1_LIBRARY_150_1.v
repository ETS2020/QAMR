...
module FAU ( 
  ...
  nand4  g30(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  oai21  g31(.a(x12), .b(x01), .c(new_n62_), .O(new_n63_));
  nand4  g32(.a(new_n63_), .b(x11), .c(new_n52_), .d(x00), .O(new_n64_));
  inv1   g33(.a(new_n64_), .O(z11));
  inv1   g34(.a(x09), .O(new_n66_));
  nand4  g35(.a(x11), .b(new_n52_), .c(new_n66_), .d(x00), .O(new_n67_));
  nor2   g36(.a(new_n67_), .b(new_n53_), .O(z12));
  zero   g37(.O(z08));
  zero   g38(.O(z10));
endmodule
