// Benchmark "FAU" written by ABC on Fri Jul 24 17:42:22 2020
...
module FAU ( 
  ...
  nand3  g19(.a(x04), .b(x03), .c(x02), .O(new_n51_));
  nand3  g20(.a(x12), .b(x11), .c(x09), .O(new_n52_));
  nor2   g21(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  aoi21  g22(.a(new_n50_), .b(new_n34_), .c(new_n53_), .O(new_n54_));
  nand4  g23(.a(new_n54_), .b(new_n35_), .c(new_n49_), .d(x00), .O(z08));
  nand2  g24(.a(new_n50_), .b(new_n34_), .O(new_n56_));
  nand4  g25(.a(new_n51_), .b(new_n44_), .c(x09), .d(x04), .O(new_n57_));
  nand3  g26(.a(new_n57_), .b(x12), .c(x11), .O(new_n58_));
  nand2  g27(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand3  g28(.a(new_n59_), .b(new_n49_), .c(x00), .O(new_n60_));
  inv1   g29(.a(new_n60_), .O(z09));
  inv1   g30(.a(x00), .O(new_n62_));
  inv1   g31(.a(x09), .O(new_n63_));
  nand4  g32(.a(new_n51_), .b(x12), .c(x11), .d(new_n49_), .O(new_n64_));
  nor3   g33(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z10));
  nand4  g34(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  oai21  g35(.a(x12), .b(x01), .c(new_n66_), .O(new_n67_));
  nand4  g36(.a(new_n67_), .b(x11), .c(new_n49_), .d(x00), .O(new_n68_));
  inv1   g37(.a(new_n68_), .O(z11));
  nand4  g38(.a(x11), .b(new_n49_), .c(new_n63_), .d(x00), .O(new_n70_));
  nor2   g39(.a(new_n70_), .b(new_n50_), .O(z12));
  zero   g40(.O(z03));
  zero   g41(.O(z04));
endmodule
