...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n172_, new_n173_, new_n174_, new_n175_,
  ...
  nand2  g014(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  ...
  nand4  g020(.a(new_n101_), .b(x6), .c(x5), .d(new_n76_), .O(new_n102_));
  nor2   g021(.a(new_n102_), .b(new_n84_), .O(z13));
  nand2  g022(.a(new_n93_), .b(x3), .O(new_n105_));
  inv1   g023(.a(new_n105_), .O(new_n106_));
  nand4  g024(.a(new_n106_), .b(x6), .c(x5), .d(new_n76_), .O(new_n107_));
  nor2   g025(.a(new_n107_), .b(new_n84_), .O(z15));
  nor4   g026(.a(new_n88_), .b(x7), .c(new_n83_), .d(x5), .O(z25));
  nand2  g027(.a(new_n93_), .b(new_n75_), .O(new_n120_));
  inv1   g028(.a(new_n120_), .O(new_n121_));
  nand4  g029(.a(new_n121_), .b(x6), .c(new_n74_), .d(new_n76_), .O(new_n122_));
  ...
  nand2  g040(.a(new_n136_), .b(new_n74_), .O(new_n137_));
  oai21  g041(.a(new_n83_), .b(new_n128_), .c(new_n74_), .O(new_n138_));
  nor2   g042(.a(new_n84_), .b(new_n74_), .O(new_n139_));
  aoi21  g043(.a(new_n138_), .b(new_n84_), .c(new_n139_), .O(new_n140_));
  nand3  g044(.a(new_n140_), .b(new_n137_), .c(new_n130_), .O(new_n141_));
  nand2  g045(.a(new_n141_), .b(new_n76_), .O(new_n142_));
  oai21  g046(.a(x3), .b(new_n86_), .c(new_n128_), .O(new_n143_));
  nand2  g047(.a(new_n75_), .b(x1), .O(new_n144_));
  nand3  g048(.a(new_n74_), .b(new_n86_), .c(x0), .O(new_n145_));
  ...
  oai21  g052(.a(new_n75_), .b(new_n86_), .c(x0), .O(new_n149_));
  nand3  g053(.a(new_n75_), .b(new_n86_), .c(new_n128_), .O(new_n150_));
  aoi21  g054(.a(new_n150_), .b(new_n149_), .c(new_n85_), .O(new_n151_));
  inv1   g055(.a(new_n151_), .O(new_n152_));
  aoi21  g056(.a(x6), .b(new_n76_), .c(new_n75_), .O(new_n153_));
  ...
  nand3  g067(.a(x4), .b(x3), .c(new_n128_), .O(new_n172_));
  nor2   g068(.a(x1), .b(new_n128_), .O(new_n173_));
  aoi21  g069(.a(x4), .b(new_n75_), .c(new_n74_), .O(new_n174_));
  oai21  g070(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(new_n175_));
  nand2  g071(.a(new_n175_), .b(new_n85_), .O(new_n176_));
  nand2  g072(.a(x4), .b(x2), .O(new_n177_));
  nand3  g073(.a(x7), .b(x1), .c(x0), .O(new_n178_));
  oai21  g074(.a(new_n177_), .b(x0), .c(new_n178_), .O(new_n179_));
  nand2  g075(.a(new_n179_), .b(x3), .O(new_n180_));
  nand2  g076(.a(x4), .b(new_n75_), .O(new_n181_));
  nand3  g077(.a(x6), .b(new_n74_), .c(new_n76_), .O(new_n182_));
  aoi21  g078(.a(new_n182_), .b(new_n181_), .c(x0), .O(new_n183_));
  nor4   g079(.a(new_n131_), .b(new_n77_), .c(x5), .d(new_n128_), .O(new_n184_));
  oai21  g080(.a(new_n184_), .b(new_n183_), .c(x2), .O(new_n185_));
  nor2   g081(.a(x7), .b(new_n83_), .O(new_n186_));
  oai21  g082(.a(new_n186_), .b(new_n129_), .c(x0), .O(new_n187_));
  nand2  g083(.a(new_n84_), .b(new_n83_), .O(new_n188_));
  aoi22  g084(.a(new_n188_), .b(x5), .c(new_n129_), .d(new_n128_), .O(new_n189_));
  aoi21  g085(.a(new_n189_), .b(new_n187_), .c(x4), .O(new_n190_));
  aoi21  g086(.a(x4), .b(x0), .c(new_n190_), .O(new_n191_));
  nand4  g087(.a(new_n191_), .b(new_n185_), .c(new_n180_), .d(new_n176_), .O(z42));
  zero   g088(.O(z00));
  zero   g089(.O(z01));
  zero   g090(.O(z03));
  zero   g091(.O(z04));
