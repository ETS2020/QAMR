...
module FAU ( 
  ...
  nand3  g067(.a(new_n76_), .b(new_n83_), .c(x1), .O(new_n192_));
  nand2  g068(.a(new_n192_), .b(new_n75_), .O(new_n193_));
  oai21  g069(.a(x1), .b(new_n128_), .c(x4), .O(new_n194_));
  nand2  g070(.a(new_n76_), .b(x1), .O(new_n195_));
  nand3  g071(.a(x2), .b(new_n86_), .c(x0), .O(new_n196_));
  nand3  g072(.a(new_n196_), .b(new_n195_), .c(new_n194_), .O(new_n197_));
  nand2  g073(.a(new_n197_), .b(x3), .O(new_n198_));
  aoi21  g074(.a(x2), .b(new_n128_), .c(x3), .O(new_n199_));
  nand3  g075(.a(x4), .b(new_n85_), .c(x0), .O(new_n200_));
  inv1   g076(.a(new_n200_), .O(new_n201_));
  oai21  g077(.a(new_n201_), .b(new_n199_), .c(new_n86_), .O(new_n202_));
  oai21  g078(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n203_));
  nand2  g079(.a(new_n203_), .b(new_n128_), .O(new_n204_));
  nand4  g080(.a(new_n204_), .b(new_n202_), .c(new_n198_), .d(new_n193_), .O(z62));
  zero   g081(.O(z00));
  zero   g082(.O(z01));
  zero   g083(.O(z03));
  zero   g084(.O(z04));
