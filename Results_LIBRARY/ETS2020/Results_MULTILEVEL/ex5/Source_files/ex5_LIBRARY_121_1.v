...
module FAU ( 
  ...
  nand3  g069(.a(x3), .b(new_n86_), .c(new_n87_), .O(new_n191_));
  nand2  g070(.a(new_n191_), .b(new_n145_), .O(new_n192_));
  aoi21  g071(.a(new_n192_), .b(x0), .c(new_n85_), .O(new_n193_));
  ...
  oai21  g076(.a(new_n75_), .b(x2), .c(new_n129_), .O(new_n198_));
  nand2  g077(.a(new_n198_), .b(new_n74_), .O(new_n199_));
  nor2   g078(.a(new_n75_), .b(new_n129_), .O(new_n200_));
  aoi21  g079(.a(x5), .b(new_n74_), .c(x0), .O(new_n201_));
  oai21  g080(.a(new_n201_), .b(new_n200_), .c(new_n86_), .O(new_n202_));
  nand3  g081(.a(new_n202_), .b(new_n199_), .c(new_n197_), .O(new_n203_));
  nand2  g082(.a(new_n203_), .b(new_n87_), .O(new_n204_));
  nand3  g083(.a(x4), .b(x3), .c(x2), .O(new_n205_));
  aoi21  g084(.a(new_n205_), .b(new_n87_), .c(x0), .O(new_n206_));
