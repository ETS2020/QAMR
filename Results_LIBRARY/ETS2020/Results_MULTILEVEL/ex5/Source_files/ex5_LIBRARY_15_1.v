...
module FAU ( 
  ...
  oai21  g061(.a(x5), .b(x2), .c(x0), .O(new_n169_));
  nand2  g062(.a(new_n169_), .b(x1), .O(new_n170_));
  nand4  g063(.a(new_n83_), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n171_));
  oai21  g064(.a(x7), .b(new_n83_), .c(new_n171_), .O(new_n172_));
  nand3  g065(.a(new_n172_), .b(new_n76_), .c(new_n75_), .O(new_n173_));
  oai21  g066(.a(new_n75_), .b(x0), .c(new_n173_), .O(new_n174_));
  nand2  g067(.a(new_n174_), .b(x3), .O(new_n175_));
  nand2  g068(.a(new_n124_), .b(x2), .O(new_n176_));
  nand2  g069(.a(new_n176_), .b(new_n75_), .O(new_n177_));
  nand2  g070(.a(new_n177_), .b(x0), .O(new_n178_));
  nand2  g071(.a(new_n124_), .b(new_n75_), .O(new_n179_));
  nand3  g072(.a(x4), .b(new_n74_), .c(x2), .O(new_n180_));
  aoi21  g073(.a(new_n180_), .b(new_n179_), .c(x0), .O(new_n181_));
  aoi21  g074(.a(new_n76_), .b(new_n74_), .c(x7), .O(new_n182_));
  oai21  g075(.a(new_n84_), .b(new_n83_), .c(x6), .O(new_n183_));
  oai21  g076(.a(new_n182_), .b(new_n83_), .c(new_n183_), .O(new_n184_));
  aoi21  g077(.a(new_n184_), .b(new_n75_), .c(new_n181_), .O(new_n185_));
  nand4  g078(.a(new_n185_), .b(new_n178_), .c(new_n175_), .d(new_n170_), .O(z44));
  zero   g079(.O(z00));
  zero   g080(.O(z01));
  zero   g081(.O(z03));
  zero   g082(.O(z04));
