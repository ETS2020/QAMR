// Benchmark "FAU" written by ABC on Sat Jul 25 01:39:50 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n148_, new_n149_, new_n156_, new_n157_, new_n160_, new_n161_,
  ...
  and2   g044(.a(new_n141_), .b(x4), .O(new_n142_));
  nor2   g045(.a(x5), .b(new_n86_), .O(new_n143_));
  oai21  g046(.a(new_n143_), .b(new_n142_), .c(new_n85_), .O(new_n144_));
  ...
  aoi21  g053(.a(new_n139_), .b(new_n138_), .c(new_n75_), .O(new_n156_));
  oai21  g054(.a(new_n156_), .b(new_n143_), .c(new_n85_), .O(new_n157_));
  nand4  g055(.a(new_n157_), .b(new_n149_), .c(new_n147_), .d(new_n137_), .O(z38));
  nand3  g056(.a(x2), .b(new_n86_), .c(new_n123_), .O(new_n160_));
  nand3  g057(.a(x4), .b(new_n85_), .c(x1), .O(new_n161_));
  nand4  g058(.a(new_n84_), .b(new_n76_), .c(x5), .d(new_n75_), .O(new_n162_));
  nand3  g059(.a(new_n162_), .b(new_n161_), .c(new_n160_), .O(new_n163_));
  nand2  g060(.a(new_n163_), .b(new_n74_), .O(new_n164_));
  nand2  g061(.a(x6), .b(new_n75_), .O(new_n165_));
  oai21  g062(.a(new_n165_), .b(new_n74_), .c(x2), .O(new_n166_));
  nand2  g063(.a(new_n166_), .b(x1), .O(new_n167_));
  and2   g064(.a(x7), .b(x6), .O(new_n168_));
  nand4  g065(.a(new_n168_), .b(new_n75_), .c(x3), .d(new_n86_), .O(new_n169_));
  aoi21  g066(.a(new_n169_), .b(x6), .c(new_n85_), .O(new_n170_));
  oai21  g067(.a(new_n168_), .b(x4), .c(new_n85_), .O(new_n171_));
  nor2   g068(.a(new_n171_), .b(x1), .O(new_n172_));
  oai21  g069(.a(new_n172_), .b(new_n170_), .c(x0), .O(new_n173_));
  nand3  g070(.a(new_n84_), .b(x6), .c(x3), .O(new_n174_));
  oai21  g071(.a(x6), .b(x0), .c(new_n174_), .O(new_n175_));
  nand2  g072(.a(new_n175_), .b(new_n75_), .O(new_n176_));
  nand3  g073(.a(new_n176_), .b(new_n173_), .c(new_n167_), .O(new_n177_));
  nand2  g074(.a(new_n177_), .b(new_n83_), .O(new_n178_));
  nand3  g075(.a(new_n84_), .b(x6), .c(new_n75_), .O(new_n179_));
  oai21  g076(.a(new_n75_), .b(new_n85_), .c(new_n179_), .O(new_n180_));
  nand2  g077(.a(new_n180_), .b(x0), .O(new_n181_));
  nand2  g078(.a(x4), .b(x3), .O(new_n182_));
  nand2  g079(.a(new_n182_), .b(x0), .O(new_n183_));
  nand2  g080(.a(new_n183_), .b(x1), .O(new_n184_));
  oai22  g081(.a(new_n182_), .b(x2), .c(new_n84_), .d(x4), .O(new_n185_));
  nand2  g082(.a(new_n185_), .b(new_n123_), .O(new_n186_));
  nand3  g083(.a(new_n84_), .b(new_n76_), .c(new_n74_), .O(new_n187_));
  nand3  g084(.a(new_n187_), .b(x5), .c(new_n75_), .O(new_n188_));
  nand4  g085(.a(new_n188_), .b(new_n186_), .c(new_n184_), .d(new_n181_), .O(new_n189_));
  inv1   g086(.a(new_n189_), .O(new_n190_));
  nand3  g087(.a(new_n190_), .b(new_n178_), .c(new_n164_), .O(z40));
  zero   g088(.O(z00));
  zero   g089(.O(z01));
  zero   g090(.O(z03));
  zero   g091(.O(z04));
