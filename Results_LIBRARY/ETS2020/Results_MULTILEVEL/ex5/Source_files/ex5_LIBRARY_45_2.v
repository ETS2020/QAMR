// Benchmark "FAU" written by ABC on Sat Jul 25 01:39:57 2020
...
module FAU ( 
  ...
  nand3  g076(.a(new_n114_), .b(new_n76_), .c(x2), .O(new_n152_));
  ...
  nand3  g105(.a(new_n181_), .b(new_n109_), .c(new_n76_), .O(new_n182_));
  ...
  nand4  g192(.a(new_n268_), .b(new_n81_), .c(new_n104_), .d(new_n95_), .O(new_n269_));
  nor2   g193(.a(new_n77_), .b(new_n104_), .O(new_n270_));
  ...
  nand2  g205(.a(new_n81_), .b(new_n104_), .O(new_n283_));
  ...
  nor2   g279(.a(new_n109_), .b(new_n77_), .O(new_n357_));
  ...
  nand2  g289(.a(new_n366_), .b(new_n104_), .O(new_n367_));
  ...
  inv1   g320(.a(new_n109_), .O(new_n398_));
  ...
  nand2  g342(.a(new_n419_), .b(new_n104_), .O(new_n420_));
  ...
  nor2   g370(.a(new_n104_), .b(x0), .O(new_n448_));
  ...
  nand4  g386(.a(new_n86_), .b(new_n76_), .c(new_n104_), .d(new_n94_), .O(new_n464_));
  ...
  nor2   g393(.a(new_n114_), .b(x6), .O(new_n471_));
  ...
  nand2  g402(.a(new_n104_), .b(x1), .O(new_n480_));
  ...
  oai21  g426(.a(new_n503_), .b(new_n499_), .c(new_n104_), .O(new_n504_));
  ...
  nand2  g437(.a(new_n184_), .b(new_n104_), .O(new_n515_));
  ...
  oai21  g456(.a(new_n267_), .b(new_n104_), .c(new_n76_), .O(new_n534_));
  ...
  nand4  g460(.a(new_n109_), .b(new_n78_), .c(x3), .d(new_n104_), .O(new_n538_));
  ...
  oai21  g475(.a(new_n73_), .b(x4), .c(new_n104_), .O(new_n553_));
  ...
  nand3  g480(.a(new_n557_), .b(new_n104_), .c(new_n95_), .O(new_n558_));
  ...
  oai21  g495(.a(new_n572_), .b(new_n571_), .c(new_n104_), .O(new_n573_));
  aoi21  g496(.a(new_n573_), .b(new_n570_), .c(x1), .O(new_n574_));
  oai22  g497(.a(new_n480_), .b(new_n363_), .c(new_n453_), .d(new_n104_), .O(new_n575_));
  ...
  oai22  g501(.a(new_n578_), .b(new_n500_), .c(x5), .d(new_n104_), .O(new_n579_));
  ...
  nand2  g505(.a(new_n582_), .b(new_n104_), .O(new_n583_));
  ...
  nand2  g523(.a(new_n600_), .b(new_n104_), .O(new_n601_));
  aoi21  g524(.a(new_n254_), .b(new_n94_), .c(new_n343_), .O(new_n602_));
  oai21  g525(.a(new_n602_), .b(new_n104_), .c(new_n601_), .O(new_n603_));
  ...
  oai21  g536(.a(new_n104_), .b(x0), .c(new_n468_), .O(new_n614_));
  ...
  nand2  g542(.a(new_n104_), .b(x0), .O(new_n620_));
  ...
  oai21  g549(.a(x4), .b(new_n95_), .c(new_n104_), .O(new_n627_));
  ...
  nand3  g556(.a(new_n633_), .b(new_n104_), .c(new_n95_), .O(new_n634_));
  ...
  nand3  g561(.a(new_n638_), .b(new_n104_), .c(new_n95_), .O(new_n639_));
  ...
  oai21  g570(.a(new_n233_), .b(x4), .c(new_n104_), .O(new_n648_));
  ...
  oai21  g581(.a(new_n78_), .b(new_n104_), .c(new_n81_), .O(new_n659_));
  ...
  nand3  g587(.a(new_n243_), .b(new_n109_), .c(new_n104_), .O(new_n665_));
  ...
  nand2  g602(.a(new_n311_), .b(new_n109_), .O(new_n680_));
  ...
  nand2  g617(.a(new_n694_), .b(new_n104_), .O(new_n695_));
  ...
  oai21  g635(.a(new_n572_), .b(new_n381_), .c(new_n104_), .O(new_n713_));
