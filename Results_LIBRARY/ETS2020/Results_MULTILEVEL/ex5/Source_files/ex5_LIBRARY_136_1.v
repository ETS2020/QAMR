...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n148_, new_n149_, new_n150_, new_n157_, new_n158_, new_n180_,
  ...
  nand4  g053(.a(new_n150_), .b(new_n147_), .c(new_n144_), .d(new_n137_), .O(z32));
  aoi21  g054(.a(new_n139_), .b(new_n138_), .c(new_n75_), .O(new_n157_));
  oai21  g055(.a(new_n157_), .b(new_n143_), .c(new_n85_), .O(new_n158_));
  nand4  g056(.a(new_n158_), .b(new_n150_), .c(new_n147_), .d(new_n137_), .O(z38));
  nor2   g057(.a(new_n83_), .b(x4), .O(new_n180_));
  nor2   g058(.a(x7), .b(x6), .O(new_n181_));
  nor2   g059(.a(new_n75_), .b(new_n85_), .O(new_n182_));
  aoi22  g060(.a(new_n182_), .b(new_n123_), .c(new_n181_), .d(new_n180_), .O(new_n183_));
  nand2  g061(.a(new_n86_), .b(x0), .O(new_n184_));
  nand2  g062(.a(x4), .b(new_n85_), .O(new_n185_));
  oai22  g063(.a(new_n185_), .b(new_n184_), .c(new_n84_), .d(x4), .O(new_n186_));
  nand2  g064(.a(new_n186_), .b(x5), .O(new_n187_));
  oai21  g065(.a(new_n148_), .b(new_n123_), .c(new_n84_), .O(new_n188_));
  nor2   g066(.a(new_n85_), .b(x0), .O(new_n189_));
  nand3  g067(.a(x7), .b(x6), .c(x2), .O(new_n190_));
  oai21  g068(.a(x6), .b(x2), .c(new_n190_), .O(new_n191_));
  nand3  g069(.a(new_n191_), .b(new_n86_), .c(x0), .O(new_n192_));
  nand3  g070(.a(x6), .b(x2), .c(x1), .O(new_n193_));
  aoi21  g071(.a(new_n193_), .b(new_n192_), .c(x4), .O(new_n194_));
  oai21  g072(.a(new_n194_), .b(new_n189_), .c(new_n83_), .O(new_n195_));
  inv1   g073(.a(new_n185_), .O(new_n196_));
  nor2   g074(.a(new_n148_), .b(new_n86_), .O(new_n197_));
  aoi21  g075(.a(new_n196_), .b(new_n123_), .c(new_n197_), .O(new_n198_));
  nand2  g076(.a(new_n198_), .b(new_n195_), .O(new_n199_));
  nand3  g077(.a(new_n83_), .b(x2), .c(x1), .O(new_n200_));
  oai21  g078(.a(new_n185_), .b(x1), .c(new_n200_), .O(new_n201_));
  nand2  g079(.a(new_n201_), .b(new_n123_), .O(new_n202_));
  oai21  g080(.a(new_n75_), .b(new_n86_), .c(new_n123_), .O(new_n203_));
  nand2  g081(.a(new_n203_), .b(new_n85_), .O(new_n204_));
  nand2  g082(.a(new_n75_), .b(x2), .O(new_n205_));
  nand3  g083(.a(x7), .b(x6), .c(new_n83_), .O(new_n206_));
  oai21  g084(.a(new_n206_), .b(new_n205_), .c(x1), .O(new_n207_));
  nand2  g085(.a(new_n207_), .b(x0), .O(new_n208_));
  nand3  g086(.a(new_n208_), .b(new_n204_), .c(new_n202_), .O(new_n209_));
  nand2  g087(.a(new_n209_), .b(new_n74_), .O(new_n210_));
  nand2  g088(.a(new_n126_), .b(new_n75_), .O(new_n211_));
  nand4  g089(.a(new_n211_), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n212_));
  nand3  g090(.a(new_n76_), .b(new_n75_), .c(new_n123_), .O(new_n213_));
  nand2  g091(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nand2  g092(.a(new_n214_), .b(new_n83_), .O(new_n215_));
  nand2  g093(.a(new_n215_), .b(new_n210_), .O(new_n216_));
  aoi21  g094(.a(new_n199_), .b(x3), .c(new_n216_), .O(new_n217_));
  nand4  g095(.a(new_n217_), .b(new_n188_), .c(new_n187_), .d(new_n183_), .O(z59));
  zero   g096(.O(z00));
  zero   g097(.O(z01));
  zero   g098(.O(z03));
  zero   g099(.O(z04));
