...
module FAU ( 
  ...
  nand3  g047(.a(new_n95_), .b(x3), .c(x2), .O(new_n121_));
  inv1   g048(.a(new_n121_), .O(new_n122_));
  nand4  g049(.a(new_n122_), .b(x6), .c(x5), .d(new_n77_), .O(new_n123_));
  nor2   g050(.a(new_n123_), .b(new_n86_), .O(z15));
  ...
  nor3   g055(.a(new_n117_), .b(x5), .c(new_n77_), .O(z17));
  ...
  nand2  g059(.a(new_n118_), .b(new_n76_), .O(new_n133_));
