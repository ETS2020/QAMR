// Benchmark "FAU" written by ABC on Sat Jul 25 01:41:06 2020
...
module FAU ( 
  ...
  wire new_n72_, new_n73_, new_n76_, new_n77_, new_n78_, new_n79_, new_n81_,
    ...
    new_n146_, new_n150_, new_n151_, new_n153_, new_n154_, new_n155_,
  ...
  inv1   g085(.a(new_n133_), .O(new_n161_));
  nand4  g086(.a(new_n161_), .b(new_n78_), .c(new_n81_), .d(new_n77_), .O(new_n162_));
  nor2   g087(.a(new_n162_), .b(new_n86_), .O(z29));
  ...
  nand3  g108(.a(new_n184_), .b(new_n113_), .c(new_n76_), .O(new_n185_));
  ...
  oai21  g125(.a(new_n197_), .b(new_n108_), .c(new_n201_), .O(new_n202_));
  ...
  nor3   g132(.a(new_n208_), .b(x5), .c(new_n108_), .O(new_n209_));
  ...
  nand3  g167(.a(x5), .b(x4), .c(new_n108_), .O(new_n244_));
  ...
  nor2   g186(.a(new_n108_), .b(new_n94_), .O(new_n263_));
  oai21  g187(.a(new_n222_), .b(new_n263_), .c(new_n76_), .O(new_n264_));
  ...
  nand4  g195(.a(new_n271_), .b(new_n81_), .c(new_n108_), .d(new_n95_), .O(new_n272_));
  nor2   g196(.a(new_n77_), .b(new_n108_), .O(new_n273_));
  ...
  nand2  g208(.a(new_n81_), .b(new_n108_), .O(new_n286_));
  ...
  aoi21  g217(.a(x6), .b(new_n108_), .c(x0), .O(new_n295_));
  ...
  aoi21  g225(.a(new_n302_), .b(new_n300_), .c(new_n108_), .O(new_n303_));
  ...
  nand2  g235(.a(x4), .b(new_n108_), .O(new_n313_));
  ...
  aoi21  g246(.a(new_n323_), .b(x6), .c(new_n108_), .O(new_n324_));
  nand3  g247(.a(new_n271_), .b(new_n108_), .c(new_n95_), .O(new_n325_));
  ...
  nand2  g276(.a(new_n353_), .b(new_n108_), .O(new_n354_));
  ...
  nor2   g282(.a(new_n113_), .b(new_n77_), .O(new_n360_));
  ...
  nand2  g292(.a(new_n369_), .b(new_n108_), .O(new_n370_));
  ...
  nor2   g311(.a(new_n168_), .b(new_n263_), .O(new_n389_));
  ...
  inv1   g323(.a(new_n113_), .O(new_n401_));
  ...
  nand2  g345(.a(new_n422_), .b(new_n108_), .O(new_n423_));
  ...
  nor2   g373(.a(new_n108_), .b(x0), .O(new_n451_));
  ...
  nand4  g389(.a(new_n86_), .b(new_n76_), .c(new_n108_), .d(new_n94_), .O(new_n467_));
  ...
  nand2  g405(.a(new_n108_), .b(x1), .O(new_n483_));
  ...
  oai21  g429(.a(new_n506_), .b(new_n502_), .c(new_n108_), .O(new_n507_));
  ...
  nand2  g440(.a(new_n187_), .b(new_n108_), .O(new_n518_));
  ...
  oai21  g459(.a(new_n270_), .b(new_n108_), .c(new_n76_), .O(new_n537_));
  ...
  nand4  g463(.a(new_n113_), .b(new_n78_), .c(x3), .d(new_n108_), .O(new_n541_));
  ...
  oai21  g478(.a(new_n73_), .b(x4), .c(new_n108_), .O(new_n556_));
  ...
  nand3  g483(.a(new_n560_), .b(new_n108_), .c(new_n95_), .O(new_n561_));
  ...
  nand2  g487(.a(new_n195_), .b(new_n113_), .O(new_n565_));
  ...
  oai21  g498(.a(new_n575_), .b(new_n574_), .c(new_n108_), .O(new_n576_));
  aoi21  g499(.a(new_n576_), .b(new_n573_), .c(x1), .O(new_n577_));
  oai22  g500(.a(new_n483_), .b(new_n366_), .c(new_n456_), .d(new_n108_), .O(new_n578_));
  ...
  oai22  g504(.a(new_n581_), .b(new_n503_), .c(x5), .d(new_n108_), .O(new_n582_));
  ...
  nand2  g526(.a(new_n603_), .b(new_n108_), .O(new_n604_));
  aoi21  g527(.a(new_n257_), .b(new_n94_), .c(new_n346_), .O(new_n605_));
  oai21  g528(.a(new_n605_), .b(new_n108_), .c(new_n604_), .O(new_n606_));
  ...
  oai21  g539(.a(new_n108_), .b(x0), .c(new_n471_), .O(new_n617_));
  ...
  nand2  g545(.a(new_n108_), .b(x0), .O(new_n623_));
  ...
  oai21  g552(.a(x4), .b(new_n95_), .c(new_n108_), .O(new_n630_));
  ...
  oai21  g573(.a(new_n236_), .b(x4), .c(new_n108_), .O(new_n651_));
  ...
  oai21  g584(.a(new_n78_), .b(new_n108_), .c(new_n81_), .O(new_n662_));
  ...
  nand3  g590(.a(new_n246_), .b(new_n113_), .c(new_n108_), .O(new_n668_));
  ...
  nand2  g605(.a(new_n314_), .b(new_n113_), .O(new_n683_));
  ...
  nand2  g620(.a(new_n697_), .b(new_n108_), .O(new_n698_));
  ...
  oai21  g638(.a(new_n575_), .b(new_n384_), .c(new_n108_), .O(new_n716_));
