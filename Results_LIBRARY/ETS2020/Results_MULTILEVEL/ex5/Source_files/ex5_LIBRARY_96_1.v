...
module FAU ( 
  ...
  nor2   g023(.a(new_n103_), .b(new_n81_), .O(z13));
  ...
  nor2   g027(.a(new_n108_), .b(new_n81_), .O(z15));
  ...
  nand4  g031(.a(new_n122_), .b(x6), .c(new_n85_), .d(new_n75_), .O(new_n123_));
  ...
  nand2  g042(.a(new_n137_), .b(new_n85_), .O(new_n138_));
  oai21  g043(.a(new_n76_), .b(new_n129_), .c(new_n85_), .O(new_n139_));
  nor2   g044(.a(new_n81_), .b(new_n85_), .O(new_n140_));
  aoi21  g045(.a(new_n139_), .b(new_n81_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g050(.a(new_n85_), .b(new_n87_), .c(x0), .O(new_n146_));
