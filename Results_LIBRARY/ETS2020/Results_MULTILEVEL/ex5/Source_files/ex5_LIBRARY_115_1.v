...
module FAU ( 
  ...
  nand2  g022(.a(new_n96_), .b(x3), .O(new_n105_));
  ...
  nand2  g027(.a(new_n96_), .b(new_n74_), .O(new_n120_));
  ...
  oai21  g032(.a(new_n128_), .b(x7), .c(new_n90_), .O(new_n129_));
  ...
  oai21  g040(.a(new_n76_), .b(new_n90_), .c(new_n83_), .O(new_n137_));
  ...
  oai21  g045(.a(x3), .b(new_n86_), .c(new_n90_), .O(new_n142_));
  ...
  nand3  g052(.a(new_n74_), .b(new_n86_), .c(new_n90_), .O(new_n149_));
  ...
  oai21  g056(.a(new_n152_), .b(new_n90_), .c(x1), .O(new_n153_));
