...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n107_, new_n111_, new_n112_, new_n122_, new_n123_, new_n124_,
  ...
  oai21  g044(.a(new_n76_), .b(new_n130_), .c(new_n83_), .O(new_n140_));
  ...
  oai21  g049(.a(x3), .b(new_n86_), .c(new_n130_), .O(new_n145_));
  ...
  nand3  g056(.a(new_n74_), .b(new_n86_), .c(new_n130_), .O(new_n152_));
