...
module FAU ( 
  ...
  nand2  g019(.a(new_n93_), .b(x3), .O(new_n102_));
  inv1   g020(.a(new_n102_), .O(new_n103_));
  nand4  g021(.a(new_n103_), .b(x6), .c(x5), .d(new_n75_), .O(new_n104_));
  nor2   g022(.a(new_n104_), .b(new_n84_), .O(z15));
  nor4   g023(.a(new_n88_), .b(x7), .c(new_n76_), .d(x5), .O(z25));
  inv1   g024(.a(x0), .O(new_n116_));
  nor3   g025(.a(x3), .b(new_n85_), .c(new_n116_), .O(new_n117_));
  nand4  g026(.a(new_n117_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n118_));
  nor2   g027(.a(new_n118_), .b(new_n84_), .O(z26));
  nand2  g028(.a(new_n93_), .b(new_n74_), .O(new_n120_));
  inv1   g029(.a(new_n120_), .O(new_n121_));
  nand4  g030(.a(new_n121_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n122_));
  nor2   g031(.a(new_n122_), .b(x7), .O(z27));
  nor2   g032(.a(x6), .b(x5), .O(new_n128_));
  oai21  g033(.a(new_n128_), .b(x7), .c(new_n116_), .O(new_n129_));
  ...
  oai21  g041(.a(new_n76_), .b(new_n116_), .c(new_n83_), .O(new_n137_));
  ...
  oai21  g046(.a(x3), .b(new_n86_), .c(new_n116_), .O(new_n142_));
  ...
  nand3  g053(.a(new_n74_), .b(new_n86_), .c(new_n116_), .O(new_n149_));
  ...
  oai21  g057(.a(new_n152_), .b(new_n116_), .c(x1), .O(new_n153_));
