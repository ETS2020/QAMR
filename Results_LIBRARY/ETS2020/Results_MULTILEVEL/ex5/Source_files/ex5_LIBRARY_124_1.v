// Benchmark "FAU" written by ABC on Sat Jul 25 01:40:55 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n107_, new_n119_, new_n120_, new_n121_, new_n123_, new_n124_,
  ...
  inv1   g027(.a(x0), .O(new_n119_));
  nor3   g028(.a(x3), .b(new_n85_), .c(new_n119_), .O(new_n120_));
  nand4  g029(.a(new_n120_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n121_));
  nor2   g030(.a(new_n121_), .b(new_n84_), .O(z26));
  ...
  oai21  g036(.a(new_n131_), .b(x7), .c(new_n119_), .O(new_n132_));
  ...
  oai21  g044(.a(new_n76_), .b(new_n119_), .c(new_n83_), .O(new_n140_));
  ...
  oai21  g049(.a(x3), .b(new_n86_), .c(new_n119_), .O(new_n145_));
  ...
  nand3  g056(.a(new_n74_), .b(new_n86_), .c(new_n119_), .O(new_n152_));
  ...
  oai21  g060(.a(new_n155_), .b(new_n119_), .c(x1), .O(new_n156_));
