...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n99_, new_n100_, new_n103_, new_n104_, new_n105_, new_n112_,
    new_n113_, new_n114_, new_n126_, new_n127_, new_n128_, new_n129_,
  ...
  nand4  g024(.a(x3), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n112_));
  inv1   g025(.a(new_n112_), .O(new_n113_));
  nand4  g026(.a(new_n113_), .b(new_n76_), .c(new_n83_), .d(new_n75_), .O(new_n114_));
  inv1   g027(.a(new_n114_), .O(z21));
