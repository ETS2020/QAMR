...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n180_, new_n181_, new_n182_, new_n183_,
  ...
  nand2  g067(.a(x3), .b(x2), .O(new_n180_));
  nor2   g068(.a(new_n131_), .b(x5), .O(new_n181_));
  nand3  g069(.a(new_n181_), .b(new_n75_), .c(new_n85_), .O(new_n182_));
  aoi21  g070(.a(new_n182_), .b(new_n180_), .c(x1), .O(new_n183_));
  inv1   g071(.a(new_n129_), .O(new_n184_));
  nand3  g072(.a(new_n184_), .b(new_n75_), .c(x3), .O(new_n185_));
  oai21  g073(.a(new_n185_), .b(new_n183_), .c(x0), .O(new_n186_));
  nor2   g074(.a(x6), .b(x3), .O(new_n187_));
  aoi21  g075(.a(new_n187_), .b(new_n84_), .c(new_n83_), .O(new_n188_));
  oai21  g076(.a(new_n76_), .b(x2), .c(new_n128_), .O(new_n189_));
  aoi21  g077(.a(new_n189_), .b(new_n135_), .c(x5), .O(new_n190_));
  oai21  g078(.a(new_n190_), .b(new_n188_), .c(new_n75_), .O(new_n191_));
  oai21  g079(.a(new_n84_), .b(x4), .c(new_n128_), .O(new_n192_));
  nand3  g080(.a(new_n192_), .b(new_n191_), .c(new_n186_), .O(z50));
  zero   g081(.O(z00));
  zero   g082(.O(z01));
  zero   g083(.O(z03));
  zero   g084(.O(z04));
