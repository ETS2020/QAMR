...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n160_, new_n161_, new_n162_, new_n163_, new_n164_, new_n189_,
  ...
  nand3  g063(.a(new_n76_), .b(new_n83_), .c(x1), .O(new_n189_));
  nand2  g064(.a(new_n189_), .b(new_n75_), .O(new_n190_));
  oai21  g065(.a(x1), .b(new_n125_), .c(x4), .O(new_n191_));
  nand2  g066(.a(new_n76_), .b(x1), .O(new_n192_));
  nand3  g067(.a(x2), .b(new_n86_), .c(x0), .O(new_n193_));
  nand3  g068(.a(new_n193_), .b(new_n192_), .c(new_n191_), .O(new_n194_));
  nand2  g069(.a(new_n194_), .b(x3), .O(new_n195_));
  aoi21  g070(.a(x2), .b(new_n125_), .c(x3), .O(new_n196_));
  nand3  g071(.a(x4), .b(new_n85_), .c(x0), .O(new_n197_));
  inv1   g072(.a(new_n197_), .O(new_n198_));
  oai21  g073(.a(new_n198_), .b(new_n196_), .c(new_n86_), .O(new_n199_));
  oai21  g074(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n200_));
  nand2  g075(.a(new_n200_), .b(new_n125_), .O(new_n201_));
  nand4  g076(.a(new_n201_), .b(new_n199_), .c(new_n195_), .d(new_n190_), .O(z62));
  zero   g077(.O(z00));
  zero   g078(.O(z01));
  zero   g079(.O(z03));
  zero   g080(.O(z04));
