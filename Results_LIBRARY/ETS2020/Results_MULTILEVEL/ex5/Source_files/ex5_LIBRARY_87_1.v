...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n105_, new_n106_, new_n109_, new_n110_, new_n111_, new_n124_,
    new_n125_, new_n126_, new_n132_, new_n133_, new_n134_, new_n135_,
  ...
  nand3  g023(.a(new_n87_), .b(x3), .c(new_n85_), .O(new_n104_));
  inv1   g024(.a(new_n104_), .O(new_n105_));
  nand4  g025(.a(new_n105_), .b(x6), .c(x5), .d(new_n75_), .O(new_n106_));
  nor2   g026(.a(new_n106_), .b(new_n84_), .O(z13));
  ...
  nand2  g032(.a(new_n97_), .b(new_n74_), .O(new_n124_));
  inv1   g033(.a(new_n124_), .O(new_n125_));
  nand4  g034(.a(new_n125_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n126_));
  nor2   g035(.a(new_n126_), .b(x7), .O(z27));
  nor2   g036(.a(x6), .b(x5), .O(new_n132_));
  oai21  g037(.a(new_n132_), .b(x7), .c(new_n91_), .O(new_n133_));
  ...
  oai21  g045(.a(new_n76_), .b(new_n91_), .c(new_n83_), .O(new_n141_));
  ...
  oai21  g050(.a(x3), .b(new_n86_), .c(new_n91_), .O(new_n146_));
  ...
  nand3  g057(.a(new_n74_), .b(new_n86_), .c(new_n91_), .O(new_n153_));
  ...
  oai21  g061(.a(new_n156_), .b(new_n91_), .c(x1), .O(new_n157_));
