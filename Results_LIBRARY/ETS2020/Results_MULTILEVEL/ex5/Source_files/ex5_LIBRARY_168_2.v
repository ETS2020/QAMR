...
module FAU ( 
  ...
  nand3  g156(.a(x5), .b(x4), .c(new_n104_), .O(new_n235_));
  ...
  aoi21  g163(.a(new_n241_), .b(x4), .c(new_n148_), .O(new_n242_));
  ...
  nor2   g175(.a(new_n104_), .b(new_n94_), .O(new_n254_));
  ...
  nand4  g184(.a(new_n262_), .b(new_n81_), .c(new_n104_), .d(new_n95_), .O(new_n263_));
  nor2   g185(.a(new_n77_), .b(new_n104_), .O(new_n264_));
  ...
  nand2  g197(.a(new_n81_), .b(new_n104_), .O(new_n277_));
  ...
  aoi21  g206(.a(x6), .b(new_n104_), .c(x0), .O(new_n286_));
  ...
  aoi21  g214(.a(new_n293_), .b(new_n291_), .c(new_n104_), .O(new_n294_));
  ...
  nand2  g224(.a(x4), .b(new_n104_), .O(new_n304_));
  ...
  aoi21  g235(.a(new_n314_), .b(x6), .c(new_n104_), .O(new_n315_));
  nand3  g236(.a(new_n262_), .b(new_n104_), .c(new_n95_), .O(new_n316_));
  ...
  nand2  g265(.a(new_n344_), .b(new_n104_), .O(new_n345_));
  ...
  inv1   g269(.a(new_n148_), .O(new_n349_));
  nand2  g270(.a(new_n239_), .b(x0), .O(new_n350_));
  nor2   g271(.a(new_n109_), .b(new_n77_), .O(new_n351_));
  ...
  nand2  g281(.a(new_n360_), .b(new_n104_), .O(new_n361_));
  ...
  inv1   g312(.a(new_n109_), .O(new_n392_));
  ...
  nand2  g334(.a(new_n413_), .b(new_n104_), .O(new_n414_));
  ...
  nor2   g362(.a(new_n104_), .b(x0), .O(new_n442_));
  ...
  nand4  g378(.a(new_n86_), .b(new_n76_), .c(new_n104_), .d(new_n94_), .O(new_n458_));
  ...
  nor2   g385(.a(new_n148_), .b(x6), .O(new_n465_));
  ...
  nand2  g394(.a(new_n104_), .b(x1), .O(new_n474_));
  ...
  oai21  g418(.a(new_n497_), .b(new_n493_), .c(new_n104_), .O(new_n498_));
  ...
  nand2  g429(.a(new_n178_), .b(new_n104_), .O(new_n509_));
  ...
  oai21  g448(.a(new_n261_), .b(new_n104_), .c(new_n76_), .O(new_n528_));
  ...
  nand4  g452(.a(new_n109_), .b(new_n78_), .c(x3), .d(new_n104_), .O(new_n532_));
  ...
  oai21  g467(.a(new_n73_), .b(x4), .c(new_n104_), .O(new_n547_));
  ...
  nand3  g472(.a(new_n551_), .b(new_n104_), .c(new_n95_), .O(new_n552_));
  ...
  oai21  g487(.a(new_n566_), .b(new_n565_), .c(new_n104_), .O(new_n567_));
  aoi21  g488(.a(new_n567_), .b(new_n564_), .c(x1), .O(new_n568_));
  oai22  g489(.a(new_n474_), .b(new_n357_), .c(new_n447_), .d(new_n104_), .O(new_n569_));
  ...
  oai22  g493(.a(new_n572_), .b(new_n494_), .c(x5), .d(new_n104_), .O(new_n573_));
  ...
  nand2  g497(.a(new_n576_), .b(new_n104_), .O(new_n577_));
  ...
  nand2  g515(.a(new_n594_), .b(new_n104_), .O(new_n595_));
  aoi21  g516(.a(new_n248_), .b(new_n94_), .c(new_n337_), .O(new_n596_));
  oai21  g517(.a(new_n596_), .b(new_n104_), .c(new_n595_), .O(new_n597_));
  ...
  oai21  g528(.a(new_n104_), .b(x0), .c(new_n462_), .O(new_n608_));
  ...
  nand2  g534(.a(new_n104_), .b(x0), .O(new_n614_));
  ...
  oai21  g541(.a(x4), .b(new_n95_), .c(new_n104_), .O(new_n621_));
  ...
  nand3  g548(.a(new_n627_), .b(new_n104_), .c(new_n95_), .O(new_n628_));
  ...
  nand3  g553(.a(new_n632_), .b(new_n104_), .c(new_n95_), .O(new_n633_));
  ...
  oai21  g562(.a(new_n227_), .b(x4), .c(new_n104_), .O(new_n642_));
  ...
  oai21  g573(.a(new_n78_), .b(new_n104_), .c(new_n81_), .O(new_n653_));
  ...
  nand3  g579(.a(new_n237_), .b(new_n109_), .c(new_n104_), .O(new_n659_));
  ...
  nand2  g594(.a(new_n305_), .b(new_n109_), .O(new_n674_));
  ...
  nand2  g609(.a(new_n688_), .b(new_n104_), .O(new_n689_));
  ...
  oai21  g627(.a(new_n566_), .b(new_n375_), .c(new_n104_), .O(new_n707_));
