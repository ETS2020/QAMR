...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n99_, new_n102_, new_n103_, new_n104_, new_n108_, new_n109_,
  ...
  nor4   g025(.a(new_n87_), .b(x7), .c(new_n80_), .d(x5), .O(z25));
  inv1   g026(.a(x0), .O(new_n124_));
  nor2   g027(.a(x6), .b(x5), .O(new_n125_));
  oai21  g028(.a(new_n125_), .b(x7), .c(new_n124_), .O(new_n126_));
  nand2  g029(.a(x7), .b(x6), .O(new_n127_));
  oai21  g030(.a(x6), .b(x3), .c(new_n127_), .O(new_n128_));
  nand4  g031(.a(new_n128_), .b(new_n82_), .c(new_n85_), .d(x0), .O(new_n129_));
  oai21  g032(.a(new_n82_), .b(new_n85_), .c(x7), .O(new_n130_));
  nand3  g033(.a(new_n130_), .b(x6), .c(x3), .O(new_n131_));
  nand2  g034(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g035(.a(new_n132_), .b(new_n79_), .O(new_n133_));
  oai21  g036(.a(new_n80_), .b(new_n124_), .c(new_n79_), .O(new_n134_));
  nor2   g037(.a(new_n81_), .b(new_n79_), .O(new_n135_));
  aoi21  g038(.a(new_n134_), .b(new_n81_), .c(new_n135_), .O(new_n136_));
  nand3  g039(.a(new_n136_), .b(new_n133_), .c(new_n126_), .O(new_n137_));
  nand2  g040(.a(new_n137_), .b(new_n84_), .O(new_n138_));
  oai21  g041(.a(x3), .b(new_n85_), .c(new_n124_), .O(new_n139_));
  nand2  g042(.a(new_n83_), .b(x1), .O(new_n140_));
  nand3  g043(.a(new_n79_), .b(new_n85_), .c(x0), .O(new_n141_));
  nand3  g044(.a(new_n141_), .b(new_n140_), .c(new_n139_), .O(new_n142_));
  nand2  g045(.a(new_n142_), .b(x4), .O(new_n143_));
  oai21  g046(.a(x5), .b(new_n85_), .c(new_n143_), .O(new_n144_));
  oai21  g047(.a(new_n83_), .b(new_n85_), .c(x0), .O(new_n145_));
  nand3  g048(.a(new_n83_), .b(new_n85_), .c(new_n124_), .O(new_n146_));
  aoi21  g049(.a(new_n146_), .b(new_n145_), .c(new_n82_), .O(new_n147_));
  inv1   g050(.a(new_n147_), .O(new_n148_));
  aoi21  g051(.a(x6), .b(new_n84_), .c(new_n83_), .O(new_n149_));
  oai21  g052(.a(new_n149_), .b(new_n124_), .c(x1), .O(new_n150_));
  nand2  g053(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g054(.a(new_n144_), .b(new_n82_), .c(new_n151_), .O(new_n152_));
  nand2  g055(.a(new_n152_), .b(new_n138_), .O(z32));
  nor2   g056(.a(x5), .b(new_n85_), .O(new_n159_));
