...
module FAU ( 
  ...
  wire new_n72_, new_n73_, new_n76_, new_n77_, new_n78_, new_n79_, new_n81_,
    ...
    new_n121_, new_n122_, new_n123_, new_n127_, new_n129_, new_n130_,
  ...
  nand2  g041(.a(new_n115_), .b(new_n108_), .O(new_n116_));
  inv1   g042(.a(new_n116_), .O(new_n117_));
  nand3  g043(.a(new_n117_), .b(new_n77_), .c(x3), .O(new_n118_));
  nor4   g044(.a(new_n118_), .b(new_n86_), .c(new_n78_), .d(new_n81_), .O(z14));
  nand3  g045(.a(new_n96_), .b(x3), .c(new_n108_), .O(new_n121_));
  inv1   g046(.a(new_n121_), .O(new_n122_));
  nand4  g047(.a(new_n122_), .b(x6), .c(x5), .d(new_n77_), .O(new_n123_));
  nor2   g048(.a(new_n123_), .b(new_n86_), .O(z16));
  nor3   g049(.a(new_n116_), .b(x5), .c(new_n77_), .O(z17));
  ...
  nand2  g053(.a(new_n117_), .b(new_n76_), .O(new_n129_));
  ...
  nand3  g076(.a(new_n115_), .b(x3), .c(x2), .O(new_n153_));
  ...
  nand3  g101(.a(new_n178_), .b(new_n115_), .c(new_n76_), .O(new_n179_));
  ...
  nor2   g275(.a(new_n115_), .b(new_n77_), .O(new_n354_));
  ...
  inv1   g316(.a(new_n115_), .O(new_n395_));
  ...
  nand4  g456(.a(new_n115_), .b(new_n78_), .c(x3), .d(new_n108_), .O(new_n535_));
  ...
  nand2  g480(.a(new_n189_), .b(new_n115_), .O(new_n559_));
  ...
  nand3  g583(.a(new_n240_), .b(new_n115_), .c(new_n108_), .O(new_n662_));
  ...
  nand2  g598(.a(new_n308_), .b(new_n115_), .O(new_n677_));
