// Benchmark "FAU" written by ABC on Sat Jul 25 01:39:58 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n96_, new_n100_, new_n101_, new_n102_, new_n104_, new_n105_,
    new_n106_, new_n108_, new_n109_, new_n110_, new_n123_, new_n124_,
  ...
  nand4  g022(.a(x3), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n104_));
  inv1   g023(.a(new_n104_), .O(new_n105_));
  nand4  g024(.a(new_n105_), .b(x6), .c(x5), .d(new_n75_), .O(new_n106_));
  nor2   g025(.a(new_n106_), .b(new_n84_), .O(z14));
