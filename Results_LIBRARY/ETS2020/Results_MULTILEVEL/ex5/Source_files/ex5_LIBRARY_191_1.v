...
module FAU ( 
  ...
  nand4  g020(.a(x3), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n102_));
  inv1   g021(.a(new_n102_), .O(new_n103_));
  nand4  g022(.a(new_n103_), .b(x6), .c(x5), .d(new_n75_), .O(new_n104_));
  nor2   g023(.a(new_n104_), .b(new_n84_), .O(z14));
