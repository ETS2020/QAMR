...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n168_, new_n185_, new_n186_, new_n187_,
  ...
  nand2  g068(.a(x4), .b(x2), .O(new_n185_));
  nand2  g069(.a(new_n83_), .b(x2), .O(new_n186_));
  nand3  g070(.a(x7), .b(x6), .c(x5), .O(new_n187_));
  nand2  g071(.a(new_n75_), .b(new_n85_), .O(new_n188_));
  oai21  g072(.a(new_n188_), .b(new_n187_), .c(new_n186_), .O(new_n189_));
  nand2  g073(.a(new_n189_), .b(x1), .O(new_n190_));
  aoi21  g074(.a(new_n190_), .b(new_n185_), .c(x3), .O(new_n191_));
  oai21  g075(.a(new_n83_), .b(x4), .c(new_n85_), .O(new_n192_));
  nand4  g076(.a(new_n83_), .b(x4), .c(x2), .d(new_n86_), .O(new_n193_));
  aoi21  g077(.a(new_n193_), .b(new_n192_), .c(new_n74_), .O(new_n194_));
  oai21  g078(.a(new_n194_), .b(new_n191_), .c(new_n128_), .O(new_n195_));
  nand2  g079(.a(new_n74_), .b(new_n85_), .O(new_n196_));
  nand3  g080(.a(x5), .b(x3), .c(x2), .O(new_n197_));
  xor2a  g081(.a(x3), .b(x2), .O(new_n198_));
  nand4  g082(.a(new_n198_), .b(x7), .c(x6), .d(x5), .O(new_n199_));
  oai21  g083(.a(new_n199_), .b(new_n128_), .c(new_n129_), .O(new_n200_));
  nand2  g084(.a(new_n200_), .b(new_n75_), .O(new_n201_));
  nand3  g085(.a(new_n201_), .b(new_n197_), .c(new_n196_), .O(new_n202_));
  nand2  g086(.a(new_n202_), .b(new_n86_), .O(new_n203_));
  oai21  g087(.a(new_n84_), .b(new_n76_), .c(x5), .O(new_n204_));
  oai21  g088(.a(x6), .b(x0), .c(new_n83_), .O(new_n205_));
  nand2  g089(.a(new_n205_), .b(new_n204_), .O(new_n206_));
  nand3  g090(.a(x7), .b(x3), .c(x1), .O(new_n207_));
  aoi21  g091(.a(new_n207_), .b(new_n75_), .c(new_n128_), .O(new_n208_));
  aoi21  g092(.a(new_n206_), .b(new_n75_), .c(new_n208_), .O(new_n209_));
  nand3  g093(.a(new_n209_), .b(new_n203_), .c(new_n195_), .O(z54));
  zero   g094(.O(z00));
  zero   g095(.O(z01));
  zero   g096(.O(z03));
  zero   g097(.O(z04));
