...
module FAU ( 
  ...
  oai21  g036(.a(new_n131_), .b(x7), .c(new_n126_), .O(new_n132_));
  ...
  oai21  g044(.a(new_n76_), .b(new_n126_), .c(new_n83_), .O(new_n140_));
  ...
  oai21  g049(.a(x3), .b(new_n86_), .c(new_n126_), .O(new_n145_));
  ...
  nand3  g056(.a(new_n74_), .b(new_n86_), .c(new_n126_), .O(new_n152_));
  ...
  oai21  g060(.a(new_n155_), .b(new_n126_), .c(x1), .O(new_n156_));
