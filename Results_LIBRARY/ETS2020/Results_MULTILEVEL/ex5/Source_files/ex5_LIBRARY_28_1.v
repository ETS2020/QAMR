...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n168_, new_n180_, new_n181_, new_n182_,
    new_n183_, new_n184_, new_n185_, new_n186_, new_n187_, new_n188_,
    new_n189_, new_n190_, new_n191_, new_n203_, new_n204_, new_n205_,
  ...
  oai21  g069(.a(new_n130_), .b(x4), .c(x0), .O(new_n180_));
  nand4  g070(.a(new_n84_), .b(new_n76_), .c(x5), .d(new_n75_), .O(new_n181_));
  oai21  g071(.a(x2), .b(x1), .c(new_n181_), .O(new_n182_));
  nand2  g072(.a(new_n182_), .b(new_n74_), .O(new_n183_));
  oai21  g073(.a(new_n83_), .b(x3), .c(new_n85_), .O(new_n184_));
  nand3  g074(.a(x4), .b(x3), .c(x2), .O(new_n185_));
  nand3  g075(.a(new_n185_), .b(new_n184_), .c(new_n86_), .O(new_n186_));
  nand2  g076(.a(new_n186_), .b(new_n116_), .O(new_n187_));
  oai21  g077(.a(new_n84_), .b(new_n83_), .c(x6), .O(new_n188_));
  aoi21  g078(.a(new_n76_), .b(x3), .c(x7), .O(new_n189_));
  oai21  g079(.a(new_n189_), .b(new_n83_), .c(new_n188_), .O(new_n190_));
  nand2  g080(.a(new_n190_), .b(new_n75_), .O(new_n191_));
  nand4  g081(.a(new_n191_), .b(new_n187_), .c(new_n183_), .d(new_n180_), .O(z49));
  nand3  g082(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n203_));
  nand2  g083(.a(new_n203_), .b(new_n145_), .O(new_n204_));
  aoi21  g084(.a(new_n204_), .b(x0), .c(new_n84_), .O(new_n205_));
  nand3  g085(.a(new_n205_), .b(x6), .c(x5), .O(new_n206_));
  nand2  g086(.a(new_n206_), .b(new_n75_), .O(new_n207_));
  xnor2a g087(.a(x3), .b(x0), .O(new_n208_));
  nand2  g088(.a(new_n208_), .b(x2), .O(new_n209_));
  oai21  g089(.a(new_n75_), .b(x2), .c(new_n116_), .O(new_n210_));
  nand2  g090(.a(new_n210_), .b(new_n74_), .O(new_n211_));
  nor2   g091(.a(new_n75_), .b(new_n116_), .O(new_n212_));
  aoi21  g092(.a(x5), .b(new_n74_), .c(x0), .O(new_n213_));
  oai21  g093(.a(new_n213_), .b(new_n212_), .c(new_n85_), .O(new_n214_));
  nand3  g094(.a(new_n214_), .b(new_n211_), .c(new_n209_), .O(new_n215_));
  nand2  g095(.a(new_n215_), .b(new_n86_), .O(new_n216_));
  aoi21  g096(.a(new_n185_), .b(new_n86_), .c(x0), .O(new_n217_));
  nand2  g097(.a(x7), .b(x0), .O(new_n218_));
  aoi21  g098(.a(new_n218_), .b(new_n75_), .c(new_n74_), .O(new_n219_));
  aoi21  g099(.a(new_n219_), .b(x1), .c(new_n217_), .O(new_n220_));
  nand3  g100(.a(new_n220_), .b(new_n216_), .c(new_n207_), .O(z60));
  zero   g101(.O(z00));
  zero   g102(.O(z01));
  zero   g103(.O(z03));
  zero   g104(.O(z04));
