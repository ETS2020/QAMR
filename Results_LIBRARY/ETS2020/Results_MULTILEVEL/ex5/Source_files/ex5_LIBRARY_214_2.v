...
module FAU ( 
  ...
  nand3  g058(.a(new_n90_), .b(new_n76_), .c(new_n108_), .O(new_n133_));
  nor2   g059(.a(new_n133_), .b(new_n77_), .O(z19));
  nand2  g060(.a(new_n123_), .b(new_n76_), .O(new_n135_));
  inv1   g061(.a(new_n135_), .O(new_n136_));
  nand4  g062(.a(new_n136_), .b(new_n78_), .c(new_n81_), .d(new_n77_), .O(new_n137_));
  inv1   g063(.a(new_n137_), .O(z20));
  inv1   g064(.a(new_n124_), .O(new_n139_));
  nand3  g065(.a(new_n139_), .b(new_n78_), .c(new_n81_), .O(new_n140_));
  inv1   g066(.a(new_n140_), .O(z21));
  nand2  g067(.a(new_n123_), .b(new_n77_), .O(new_n142_));
  inv1   g068(.a(new_n142_), .O(new_n143_));
  nand4  g069(.a(new_n143_), .b(x7), .c(x6), .d(new_n81_), .O(new_n144_));
  inv1   g070(.a(new_n144_), .O(z22));
  nand3  g071(.a(new_n90_), .b(x3), .c(new_n108_), .O(new_n146_));
  nor2   g072(.a(new_n146_), .b(new_n81_), .O(z23));
  inv1   g073(.a(new_n133_), .O(new_n148_));
  nand3  g074(.a(new_n148_), .b(new_n81_), .c(new_n77_), .O(new_n149_));
  nor3   g075(.a(new_n149_), .b(x7), .c(new_n78_), .O(z24));
  nor3   g076(.a(x3), .b(new_n108_), .c(new_n94_), .O(new_n152_));
  ...
  nand3  g083(.a(new_n113_), .b(x3), .c(x2), .O(new_n159_));
  ...
  nor3   g087(.a(new_n149_), .b(new_n86_), .c(x6), .O(z29));
