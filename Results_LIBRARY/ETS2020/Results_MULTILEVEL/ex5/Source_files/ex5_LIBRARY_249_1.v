...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n160_, new_n161_, new_n162_, new_n178_, new_n179_, new_n180_,
  ...
  nor2   g061(.a(new_n85_), .b(x0), .O(new_n178_));
  aoi21  g062(.a(new_n74_), .b(new_n123_), .c(x2), .O(new_n179_));
  oai21  g063(.a(new_n179_), .b(new_n178_), .c(x1), .O(new_n180_));
  nand4  g064(.a(x3), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n181_));
  nand4  g065(.a(new_n181_), .b(new_n180_), .c(x7), .d(x6), .O(new_n182_));
  nand4  g066(.a(new_n76_), .b(x3), .c(new_n86_), .d(x0), .O(new_n183_));
  nand2  g067(.a(new_n183_), .b(x3), .O(new_n184_));
  nand2  g068(.a(new_n184_), .b(new_n85_), .O(new_n185_));
  aoi21  g069(.a(new_n185_), .b(new_n76_), .c(x5), .O(new_n186_));
  aoi21  g070(.a(new_n182_), .b(x5), .c(new_n186_), .O(new_n187_));
  xnor2a g071(.a(x3), .b(x0), .O(new_n188_));
  nand2  g072(.a(new_n188_), .b(x2), .O(new_n189_));
  aoi21  g073(.a(x3), .b(new_n123_), .c(new_n75_), .O(new_n190_));
  aoi21  g074(.a(x5), .b(new_n74_), .c(x0), .O(new_n191_));
  oai21  g075(.a(new_n191_), .b(new_n190_), .c(new_n85_), .O(new_n192_));
  aoi21  g076(.a(new_n192_), .b(new_n189_), .c(x1), .O(new_n193_));
  nor2   g077(.a(x3), .b(new_n123_), .O(new_n194_));
  aoi21  g078(.a(x5), .b(new_n75_), .c(new_n74_), .O(new_n195_));
  aoi21  g079(.a(new_n195_), .b(new_n123_), .c(new_n194_), .O(new_n196_));
  nand4  g080(.a(x4), .b(new_n74_), .c(new_n85_), .d(x1), .O(new_n197_));
  oai21  g081(.a(new_n196_), .b(new_n85_), .c(new_n197_), .O(new_n198_));
  nor2   g082(.a(new_n198_), .b(new_n193_), .O(new_n199_));
  oai21  g083(.a(new_n187_), .b(x4), .c(new_n199_), .O(z53));
  zero   g084(.O(z00));
  zero   g085(.O(z01));
  zero   g086(.O(z03));
  zero   g087(.O(z04));
