...
module FAU ( 
  ...
  nand2  g057(.a(new_n116_), .b(new_n76_), .O(new_n132_));
  ...
  nand3  g076(.a(new_n119_), .b(new_n76_), .c(x2), .O(new_n152_));
  ...
  aoi21  g171(.a(new_n247_), .b(x4), .c(new_n119_), .O(new_n248_));
  ...
  inv1   g277(.a(new_n119_), .O(new_n355_));
  ...
  nor2   g393(.a(new_n119_), .b(x6), .O(new_n471_));
