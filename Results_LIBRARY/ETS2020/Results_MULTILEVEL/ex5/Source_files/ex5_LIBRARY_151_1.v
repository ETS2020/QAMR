...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n80_, new_n81_, new_n85_,
    ...
    new_n166_, new_n167_, new_n168_, new_n184_, new_n185_, new_n186_,
  ...
  nand4  g031(.a(new_n122_), .b(x6), .c(new_n80_), .d(new_n75_), .O(new_n123_));
  ...
  nand2  g042(.a(new_n137_), .b(new_n80_), .O(new_n138_));
  oai21  g043(.a(new_n76_), .b(new_n129_), .c(new_n80_), .O(new_n139_));
  nor2   g044(.a(new_n85_), .b(new_n80_), .O(new_n140_));
  ...
  nand3  g050(.a(new_n80_), .b(new_n87_), .c(x0), .O(new_n146_));
  ...
  nor2   g069(.a(new_n86_), .b(x0), .O(new_n184_));
  aoi21  g070(.a(new_n74_), .b(new_n129_), .c(x2), .O(new_n185_));
  oai21  g071(.a(new_n185_), .b(new_n184_), .c(x1), .O(new_n186_));
  nand4  g072(.a(x3), .b(new_n86_), .c(new_n87_), .d(x0), .O(new_n187_));
  nand4  g073(.a(new_n187_), .b(new_n186_), .c(x7), .d(x6), .O(new_n188_));
  nand4  g074(.a(new_n76_), .b(x3), .c(new_n87_), .d(x0), .O(new_n189_));
  nand2  g075(.a(new_n189_), .b(x3), .O(new_n190_));
  nand2  g076(.a(new_n190_), .b(new_n86_), .O(new_n191_));
  aoi21  g077(.a(new_n191_), .b(new_n76_), .c(x5), .O(new_n192_));
  aoi21  g078(.a(new_n188_), .b(x5), .c(new_n192_), .O(new_n193_));
  xnor2a g079(.a(x3), .b(x0), .O(new_n194_));
  nand2  g080(.a(new_n194_), .b(x2), .O(new_n195_));
  aoi21  g081(.a(x3), .b(new_n129_), .c(new_n75_), .O(new_n196_));
  aoi21  g082(.a(x5), .b(new_n74_), .c(x0), .O(new_n197_));
  oai21  g083(.a(new_n197_), .b(new_n196_), .c(new_n86_), .O(new_n198_));
  aoi21  g084(.a(new_n198_), .b(new_n195_), .c(x1), .O(new_n199_));
  nor2   g085(.a(x3), .b(new_n129_), .O(new_n200_));
  aoi21  g086(.a(x5), .b(new_n75_), .c(new_n74_), .O(new_n201_));
  aoi21  g087(.a(new_n201_), .b(new_n129_), .c(new_n200_), .O(new_n202_));
  nand4  g088(.a(x4), .b(new_n74_), .c(new_n86_), .d(x1), .O(new_n203_));
  oai21  g089(.a(new_n202_), .b(new_n86_), .c(new_n203_), .O(new_n204_));
  nor2   g090(.a(new_n204_), .b(new_n199_), .O(new_n205_));
  oai21  g091(.a(new_n193_), .b(x4), .c(new_n205_), .O(z53));
  zero   g092(.O(z00));
  zero   g093(.O(z01));
  zero   g094(.O(z03));
  zero   g095(.O(z05));
