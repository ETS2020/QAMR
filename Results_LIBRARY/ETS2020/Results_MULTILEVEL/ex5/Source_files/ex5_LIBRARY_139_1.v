...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n96_, new_n102_, new_n103_, new_n104_, new_n114_, new_n115_,
  ...
  inv1   g022(.a(x0), .O(new_n114_));
  nand4  g023(.a(new_n74_), .b(new_n85_), .c(new_n86_), .d(new_n114_), .O(new_n115_));
  inv1   g024(.a(new_n115_), .O(new_n116_));
  nand4  g025(.a(new_n116_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n117_));
  nor2   g026(.a(new_n117_), .b(x7), .O(z24));
  nor4   g027(.a(new_n88_), .b(x7), .c(new_n76_), .d(x5), .O(z25));
  nand2  g028(.a(new_n93_), .b(new_n74_), .O(new_n121_));
  inv1   g029(.a(new_n121_), .O(new_n122_));
  nand4  g030(.a(new_n122_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n123_));
  nor2   g031(.a(new_n123_), .b(x7), .O(z27));
  nor2   g032(.a(x6), .b(x5), .O(new_n129_));
  oai21  g033(.a(new_n129_), .b(x7), .c(new_n114_), .O(new_n130_));
  ...
  oai21  g041(.a(new_n76_), .b(new_n114_), .c(new_n83_), .O(new_n138_));
  ...
  oai21  g046(.a(x3), .b(new_n86_), .c(new_n114_), .O(new_n143_));
  ...
  nand3  g053(.a(new_n74_), .b(new_n86_), .c(new_n114_), .O(new_n150_));
  ...
  oai21  g057(.a(new_n153_), .b(new_n114_), .c(x1), .O(new_n154_));
