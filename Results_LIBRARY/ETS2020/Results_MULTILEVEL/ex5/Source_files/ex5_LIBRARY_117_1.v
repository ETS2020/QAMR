...
module FAU ( 
  ...
  nand3  g061(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n185_));
  nand2  g062(.a(new_n185_), .b(new_n139_), .O(new_n186_));
  aoi21  g063(.a(new_n186_), .b(x0), .c(new_n84_), .O(new_n187_));
  nand3  g064(.a(new_n187_), .b(x6), .c(x5), .O(new_n188_));
  nand2  g065(.a(new_n188_), .b(new_n75_), .O(new_n189_));
  xnor2a g066(.a(x3), .b(x0), .O(new_n190_));
  nand2  g067(.a(new_n190_), .b(x2), .O(new_n191_));
  oai21  g068(.a(new_n75_), .b(x2), .c(new_n123_), .O(new_n192_));
  nand2  g069(.a(new_n192_), .b(new_n74_), .O(new_n193_));
  nor2   g070(.a(new_n75_), .b(new_n123_), .O(new_n194_));
  aoi21  g071(.a(x5), .b(new_n74_), .c(x0), .O(new_n195_));
  oai21  g072(.a(new_n195_), .b(new_n194_), .c(new_n85_), .O(new_n196_));
  nand3  g073(.a(new_n196_), .b(new_n193_), .c(new_n191_), .O(new_n197_));
  nand2  g074(.a(new_n197_), .b(new_n86_), .O(new_n198_));
  nand3  g075(.a(x4), .b(x3), .c(x2), .O(new_n199_));
  aoi21  g076(.a(new_n199_), .b(new_n86_), .c(x0), .O(new_n200_));
  nand2  g077(.a(x7), .b(x0), .O(new_n201_));
  aoi21  g078(.a(new_n201_), .b(new_n75_), .c(new_n74_), .O(new_n202_));
  aoi21  g079(.a(new_n202_), .b(x1), .c(new_n200_), .O(new_n203_));
  nand3  g080(.a(new_n203_), .b(new_n198_), .c(new_n189_), .O(z60));
  zero   g081(.O(z00));
  zero   g082(.O(z01));
  zero   g083(.O(z03));
  zero   g084(.O(z04));
