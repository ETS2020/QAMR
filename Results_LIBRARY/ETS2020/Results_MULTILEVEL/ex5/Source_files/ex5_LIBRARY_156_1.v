...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n96_, new_n102_, new_n103_, new_n104_, new_n108_, new_n109_,
  ...
  nor2   g022(.a(x1), .b(x0), .O(new_n108_));
  nand4  g023(.a(new_n108_), .b(x4), .c(x3), .d(x2), .O(new_n109_));
  nor2   g024(.a(new_n109_), .b(x5), .O(z18));
  nor4   g025(.a(new_n88_), .b(x7), .c(new_n76_), .d(x5), .O(z25));
  inv1   g026(.a(x0), .O(new_n118_));
  nor3   g027(.a(x3), .b(new_n85_), .c(new_n118_), .O(new_n119_));
  nand4  g028(.a(new_n119_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n120_));
  nor2   g029(.a(new_n120_), .b(new_n84_), .O(z26));
  ...
  oai21  g035(.a(new_n130_), .b(x7), .c(new_n118_), .O(new_n131_));
  ...
  oai21  g043(.a(new_n76_), .b(new_n118_), .c(new_n83_), .O(new_n139_));
  ...
  oai21  g048(.a(x3), .b(new_n86_), .c(new_n118_), .O(new_n144_));
  ...
  nand3  g055(.a(new_n74_), .b(new_n86_), .c(new_n118_), .O(new_n151_));
  ...
  oai21  g059(.a(new_n154_), .b(new_n118_), .c(x1), .O(new_n155_));
