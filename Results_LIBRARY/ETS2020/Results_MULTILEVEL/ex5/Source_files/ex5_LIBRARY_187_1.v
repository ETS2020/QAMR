// Benchmark "FAU" written by ABC on Sat Jul 25 01:41:42 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n99_, new_n100_, new_n103_, new_n104_, new_n105_, new_n109_,
    new_n110_, new_n125_, new_n126_, new_n127_, new_n128_, new_n129_,
  ...
  nor2   g024(.a(x1), .b(x0), .O(new_n109_));
  nand4  g025(.a(new_n109_), .b(x4), .c(x3), .d(x2), .O(new_n110_));
  nor2   g026(.a(new_n110_), .b(x5), .O(z18));
  nor4   g027(.a(new_n88_), .b(x7), .c(new_n76_), .d(x5), .O(z25));
  inv1   g028(.a(x0), .O(new_n125_));
  nor2   g029(.a(x6), .b(x5), .O(new_n126_));
  oai21  g030(.a(new_n126_), .b(x7), .c(new_n125_), .O(new_n127_));
  ...
  oai21  g038(.a(new_n76_), .b(new_n125_), .c(new_n83_), .O(new_n135_));
  ...
  oai21  g043(.a(x3), .b(new_n86_), .c(new_n125_), .O(new_n140_));
  ...
  nand3  g050(.a(new_n74_), .b(new_n86_), .c(new_n125_), .O(new_n147_));
  ...
  oai21  g054(.a(new_n150_), .b(new_n125_), .c(x1), .O(new_n151_));
