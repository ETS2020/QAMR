...
module FAU ( 
  ...
  oai21  g030(.a(new_n126_), .b(x7), .c(new_n90_), .O(new_n127_));
  ...
  oai21  g038(.a(new_n76_), .b(new_n90_), .c(new_n83_), .O(new_n135_));
  ...
  oai21  g043(.a(x3), .b(new_n86_), .c(new_n90_), .O(new_n140_));
  ...
  nand3  g050(.a(new_n74_), .b(new_n86_), .c(new_n90_), .O(new_n147_));
  ...
  oai21  g054(.a(new_n150_), .b(new_n90_), .c(x1), .O(new_n151_));
