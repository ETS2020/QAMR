...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n148_, new_n149_, new_n156_, new_n157_, new_n176_, new_n177_,
  ...
  nand2  g056(.a(x5), .b(new_n74_), .O(new_n176_));
  nand3  g057(.a(new_n176_), .b(new_n86_), .c(x0), .O(new_n177_));
  nand3  g058(.a(x5), .b(x1), .c(new_n123_), .O(new_n178_));
  aoi21  g059(.a(new_n178_), .b(new_n177_), .c(x2), .O(new_n179_));
  nand3  g060(.a(new_n83_), .b(x3), .c(x2), .O(new_n180_));
  nor3   g061(.a(new_n180_), .b(x1), .c(new_n123_), .O(new_n181_));
  oai21  g062(.a(new_n181_), .b(new_n179_), .c(x7), .O(new_n182_));
  nor2   g063(.a(x7), .b(new_n83_), .O(new_n183_));
  oai22  g064(.a(x7), .b(new_n74_), .c(new_n85_), .d(x0), .O(new_n184_));
  aoi21  g065(.a(new_n184_), .b(new_n83_), .c(new_n183_), .O(new_n185_));
  aoi21  g066(.a(new_n185_), .b(new_n182_), .c(new_n76_), .O(new_n186_));
  nand2  g067(.a(new_n76_), .b(x5), .O(new_n187_));
  nor2   g068(.a(new_n87_), .b(x6), .O(new_n188_));
  aoi21  g069(.a(new_n74_), .b(new_n85_), .c(new_n188_), .O(new_n189_));
  oai21  g070(.a(new_n189_), .b(x5), .c(new_n187_), .O(new_n190_));
  oai21  g071(.a(new_n190_), .b(new_n186_), .c(new_n75_), .O(new_n191_));
  nand2  g072(.a(new_n85_), .b(x0), .O(new_n192_));
  nand3  g073(.a(new_n192_), .b(x5), .c(new_n86_), .O(new_n193_));
  nand3  g074(.a(x7), .b(x1), .c(x0), .O(new_n194_));
  nand2  g075(.a(x5), .b(new_n75_), .O(new_n195_));
  nand3  g076(.a(new_n195_), .b(x2), .c(new_n123_), .O(new_n196_));
  nand3  g077(.a(new_n196_), .b(new_n194_), .c(new_n193_), .O(new_n197_));
  nand2  g078(.a(new_n197_), .b(x3), .O(new_n198_));
  oai21  g079(.a(new_n143_), .b(x4), .c(x2), .O(new_n199_));
  oai21  g080(.a(x4), .b(new_n86_), .c(new_n85_), .O(new_n200_));
  nand3  g081(.a(new_n200_), .b(new_n199_), .c(new_n123_), .O(new_n201_));
  nand2  g082(.a(new_n201_), .b(new_n74_), .O(new_n202_));
  nor2   g083(.a(x1), .b(x0), .O(new_n203_));
  nor2   g084(.a(x5), .b(x2), .O(new_n204_));
  aoi22  g085(.a(new_n204_), .b(new_n203_), .c(x4), .d(x0), .O(new_n205_));
  nand3  g086(.a(new_n205_), .b(new_n202_), .c(new_n198_), .O(new_n206_));
  inv1   g087(.a(new_n206_), .O(new_n207_));
  nand2  g088(.a(new_n207_), .b(new_n191_), .O(z56));
  zero   g089(.O(z00));
  zero   g090(.O(z01));
  zero   g091(.O(z03));
  zero   g092(.O(z04));
