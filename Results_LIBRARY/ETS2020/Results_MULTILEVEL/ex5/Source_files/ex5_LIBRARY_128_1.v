...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n208_, new_n209_, new_n210_, new_n227_, new_n228_, new_n229_,
  ...
  oai21  g087(.a(x5), .b(x2), .c(x0), .O(new_n194_));
  nand2  g088(.a(new_n194_), .b(x1), .O(new_n195_));
  nand4  g089(.a(new_n83_), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n196_));
  oai21  g090(.a(x7), .b(new_n83_), .c(new_n196_), .O(new_n197_));
  nand3  g091(.a(new_n197_), .b(new_n76_), .c(new_n75_), .O(new_n198_));
  oai21  g092(.a(new_n75_), .b(x0), .c(new_n198_), .O(new_n199_));
  nand2  g093(.a(new_n199_), .b(x3), .O(new_n200_));
  nand2  g094(.a(new_n124_), .b(x2), .O(new_n201_));
  nand2  g095(.a(new_n201_), .b(new_n75_), .O(new_n202_));
  nand2  g096(.a(new_n202_), .b(x0), .O(new_n203_));
  nand2  g097(.a(new_n124_), .b(new_n75_), .O(new_n204_));
  nand3  g098(.a(x4), .b(new_n74_), .c(x2), .O(new_n205_));
  aoi21  g099(.a(new_n205_), .b(new_n204_), .c(x0), .O(new_n206_));
  aoi21  g100(.a(new_n76_), .b(new_n74_), .c(x7), .O(new_n207_));
  oai21  g101(.a(new_n84_), .b(new_n83_), .c(x6), .O(new_n208_));
  oai21  g102(.a(new_n207_), .b(new_n83_), .c(new_n208_), .O(new_n209_));
  aoi21  g103(.a(new_n209_), .b(new_n75_), .c(new_n206_), .O(new_n210_));
  nand4  g104(.a(new_n210_), .b(new_n203_), .c(new_n200_), .d(new_n195_), .O(z44));
  nand3  g105(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n227_));
  nand2  g106(.a(new_n227_), .b(new_n139_), .O(new_n228_));
  aoi21  g107(.a(new_n228_), .b(x0), .c(new_n84_), .O(new_n229_));
  nand3  g108(.a(new_n229_), .b(x6), .c(x5), .O(new_n230_));
  nand2  g109(.a(new_n230_), .b(new_n75_), .O(new_n231_));
  xnor2a g110(.a(x3), .b(x0), .O(new_n232_));
  nand2  g111(.a(new_n232_), .b(x2), .O(new_n233_));
  oai21  g112(.a(new_n75_), .b(x2), .c(new_n123_), .O(new_n234_));
  nand2  g113(.a(new_n234_), .b(new_n74_), .O(new_n235_));
  nor2   g114(.a(new_n75_), .b(new_n123_), .O(new_n236_));
  aoi21  g115(.a(x5), .b(new_n74_), .c(x0), .O(new_n237_));
  oai21  g116(.a(new_n237_), .b(new_n236_), .c(new_n85_), .O(new_n238_));
  nand3  g117(.a(new_n238_), .b(new_n235_), .c(new_n233_), .O(new_n239_));
  nand2  g118(.a(new_n239_), .b(new_n86_), .O(new_n240_));
  nand3  g119(.a(x4), .b(x3), .c(x2), .O(new_n241_));
  aoi21  g120(.a(new_n241_), .b(new_n86_), .c(x0), .O(new_n242_));
  nand2  g121(.a(x7), .b(x0), .O(new_n243_));
  aoi21  g122(.a(new_n243_), .b(new_n75_), .c(new_n74_), .O(new_n244_));
  aoi21  g123(.a(new_n244_), .b(x1), .c(new_n242_), .O(new_n245_));
  nand3  g124(.a(new_n245_), .b(new_n240_), .c(new_n231_), .O(z60));
  zero   g125(.O(z00));
  zero   g126(.O(z01));
  zero   g127(.O(z03));
  zero   g128(.O(z04));
