...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n154_, new_n160_, new_n161_, new_n162_, new_n163_, new_n164_,
  ...
  nand2  g055(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  aoi21  g056(.a(new_n145_), .b(new_n85_), .c(new_n153_), .O(new_n154_));
  nand2  g057(.a(new_n154_), .b(new_n139_), .O(z32));
  nand4  g058(.a(new_n84_), .b(x6), .c(new_n74_), .d(x1), .O(new_n160_));
  nand4  g059(.a(new_n160_), .b(new_n84_), .c(x6), .d(new_n83_), .O(new_n161_));
  nand2  g060(.a(new_n161_), .b(new_n75_), .O(new_n162_));
  oai21  g061(.a(x5), .b(new_n75_), .c(x3), .O(new_n163_));
  nand3  g062(.a(new_n163_), .b(x2), .c(new_n86_), .O(new_n164_));
  oai21  g063(.a(new_n74_), .b(new_n85_), .c(x4), .O(new_n165_));
  nand3  g064(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  nand2  g065(.a(new_n166_), .b(new_n125_), .O(new_n167_));
  nor2   g066(.a(new_n85_), .b(new_n125_), .O(new_n168_));
  nor2   g067(.a(x2), .b(x1), .O(new_n169_));
  oai21  g068(.a(new_n169_), .b(new_n168_), .c(new_n74_), .O(new_n170_));
  oai21  g069(.a(new_n83_), .b(x4), .c(new_n84_), .O(new_n171_));
  nand2  g070(.a(new_n171_), .b(x1), .O(new_n172_));
  nor2   g071(.a(new_n128_), .b(x5), .O(new_n173_));
  nand4  g072(.a(new_n173_), .b(new_n75_), .c(x2), .d(new_n86_), .O(new_n174_));
  aoi21  g073(.a(new_n174_), .b(new_n172_), .c(new_n74_), .O(new_n175_));
  nand2  g074(.a(new_n128_), .b(new_n75_), .O(new_n176_));
  nand4  g075(.a(new_n176_), .b(new_n83_), .c(new_n85_), .d(new_n86_), .O(new_n177_));
  oai21  g076(.a(new_n75_), .b(new_n85_), .c(new_n177_), .O(new_n178_));
  oai21  g077(.a(new_n178_), .b(new_n175_), .c(x0), .O(new_n179_));
  nand3  g078(.a(x5), .b(x2), .c(new_n86_), .O(new_n180_));
  oai21  g079(.a(new_n150_), .b(new_n86_), .c(new_n180_), .O(new_n181_));
  nor2   g080(.a(x4), .b(x1), .O(new_n182_));
  aoi22  g081(.a(new_n182_), .b(new_n126_), .c(new_n181_), .d(x3), .O(new_n183_));
  nand4  g082(.a(new_n183_), .b(new_n179_), .c(new_n170_), .d(new_n167_), .O(z37));
  nor2   g083(.a(x5), .b(new_n86_), .O(new_n185_));
  nand2  g084(.a(new_n141_), .b(new_n140_), .O(new_n186_));
  aoi21  g085(.a(new_n186_), .b(x4), .c(new_n185_), .O(new_n187_));
  oai21  g086(.a(new_n187_), .b(x2), .c(new_n152_), .O(new_n188_));
  nor2   g087(.a(new_n188_), .b(new_n148_), .O(new_n189_));
  nand2  g088(.a(new_n189_), .b(new_n139_), .O(z38));
  zero   g089(.O(z00));
  zero   g090(.O(z01));
  zero   g091(.O(z03));
  zero   g092(.O(z04));
