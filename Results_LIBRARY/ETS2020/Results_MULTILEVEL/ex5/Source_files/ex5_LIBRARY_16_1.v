// Benchmark "FAU" written by ABC on Sat Jul 25 01:39:36 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n160_, new_n161_, new_n162_, new_n187_, new_n188_, new_n189_,
  ...
  nand3  g061(.a(new_n76_), .b(new_n83_), .c(x1), .O(new_n187_));
  nand2  g062(.a(new_n187_), .b(new_n75_), .O(new_n188_));
  oai21  g063(.a(x1), .b(new_n123_), .c(x4), .O(new_n189_));
  nand2  g064(.a(new_n76_), .b(x1), .O(new_n190_));
  nand3  g065(.a(x2), .b(new_n86_), .c(x0), .O(new_n191_));
  nand3  g066(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  nand2  g067(.a(new_n192_), .b(x3), .O(new_n193_));
  aoi21  g068(.a(x2), .b(new_n123_), .c(x3), .O(new_n194_));
  nand3  g069(.a(x4), .b(new_n85_), .c(x0), .O(new_n195_));
  inv1   g070(.a(new_n195_), .O(new_n196_));
  oai21  g071(.a(new_n196_), .b(new_n194_), .c(new_n86_), .O(new_n197_));
  oai21  g072(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n198_));
  nand2  g073(.a(new_n198_), .b(new_n123_), .O(new_n199_));
  nand4  g074(.a(new_n199_), .b(new_n197_), .c(new_n193_), .d(new_n188_), .O(z62));
  zero   g075(.O(z00));
  zero   g076(.O(z01));
  zero   g077(.O(z03));
  zero   g078(.O(z04));
