...
module FAU ( 
  ...
  nand2  g048(.a(new_n145_), .b(x4), .O(new_n146_));
  oai21  g049(.a(x5), .b(new_n85_), .c(new_n146_), .O(new_n147_));
  oai21  g050(.a(new_n83_), .b(new_n85_), .c(x0), .O(new_n148_));
  nand3  g051(.a(new_n83_), .b(new_n85_), .c(new_n127_), .O(new_n149_));
  aoi21  g052(.a(new_n149_), .b(new_n148_), .c(new_n82_), .O(new_n150_));
  ...
  nand2  g056(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g057(.a(new_n147_), .b(new_n82_), .c(new_n154_), .O(new_n155_));
  nand2  g058(.a(new_n155_), .b(new_n141_), .O(z32));
  nor2   g059(.a(x5), .b(new_n85_), .O(new_n162_));
  nand2  g060(.a(new_n143_), .b(new_n142_), .O(new_n163_));
  aoi21  g061(.a(new_n163_), .b(x4), .c(new_n162_), .O(new_n164_));
  oai21  g062(.a(new_n164_), .b(x2), .c(new_n153_), .O(new_n165_));
  nor2   g063(.a(new_n165_), .b(new_n150_), .O(new_n166_));
  nand2  g064(.a(new_n166_), .b(new_n141_), .O(z38));
  zero   g065(.O(z00));
  zero   g066(.O(z01));
  zero   g067(.O(z02));
  zero   g068(.O(z03));
