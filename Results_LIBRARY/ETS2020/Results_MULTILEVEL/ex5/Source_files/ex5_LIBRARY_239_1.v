...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n184_, new_n185_, new_n186_, new_n199_, new_n200_, new_n201_,
  ...
  nand2  g076(.a(x3), .b(x2), .O(new_n174_));
  oai21  g077(.a(x2), .b(x1), .c(new_n174_), .O(new_n175_));
  nand2  g078(.a(new_n175_), .b(new_n128_), .O(new_n176_));
  ...
  nor2   g087(.a(new_n131_), .b(x5), .O(new_n199_));
  nand3  g088(.a(new_n199_), .b(new_n75_), .c(new_n85_), .O(new_n200_));
  aoi21  g089(.a(new_n200_), .b(new_n174_), .c(x1), .O(new_n201_));
  inv1   g090(.a(new_n129_), .O(new_n202_));
  nand3  g091(.a(new_n202_), .b(new_n75_), .c(x3), .O(new_n203_));
  oai21  g092(.a(new_n203_), .b(new_n201_), .c(x0), .O(new_n204_));
  nor2   g093(.a(x6), .b(x3), .O(new_n205_));
  aoi21  g094(.a(new_n205_), .b(new_n84_), .c(new_n83_), .O(new_n206_));
  oai21  g095(.a(new_n76_), .b(x2), .c(new_n128_), .O(new_n207_));
  aoi21  g096(.a(new_n207_), .b(new_n135_), .c(x5), .O(new_n208_));
  oai21  g097(.a(new_n208_), .b(new_n206_), .c(new_n75_), .O(new_n209_));
  oai21  g098(.a(new_n84_), .b(x4), .c(new_n128_), .O(new_n210_));
  nand3  g099(.a(new_n210_), .b(new_n209_), .c(new_n204_), .O(z50));
  zero   g100(.O(z00));
  zero   g101(.O(z01));
  zero   g102(.O(z03));
  zero   g103(.O(z04));
