...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n119_, new_n122_, new_n123_, new_n124_, new_n125_, new_n129_,
  ...
  inv1   g027(.a(x0), .O(new_n122_));
  nand4  g028(.a(new_n74_), .b(new_n85_), .c(new_n86_), .d(new_n122_), .O(new_n123_));
  inv1   g029(.a(new_n123_), .O(new_n124_));
  nand4  g030(.a(new_n124_), .b(new_n76_), .c(new_n83_), .d(new_n75_), .O(new_n125_));
  nor2   g031(.a(new_n125_), .b(new_n84_), .O(z29));
  nor2   g032(.a(x6), .b(x5), .O(new_n129_));
  oai21  g033(.a(new_n129_), .b(x7), .c(new_n122_), .O(new_n130_));
  ...
  oai21  g041(.a(new_n76_), .b(new_n122_), .c(new_n83_), .O(new_n138_));
  ...
  oai21  g046(.a(x3), .b(new_n86_), .c(new_n122_), .O(new_n143_));
  ...
  nand3  g053(.a(new_n74_), .b(new_n86_), .c(new_n122_), .O(new_n150_));
  ...
  oai21  g057(.a(new_n153_), .b(new_n122_), .c(x1), .O(new_n154_));
