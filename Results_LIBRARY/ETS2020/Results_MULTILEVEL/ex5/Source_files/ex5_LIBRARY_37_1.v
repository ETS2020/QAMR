...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n154_, new_n161_, new_n162_, new_n163_, new_n164_, new_n174_,
  ...
  aoi21  g060(.a(new_n74_), .b(x1), .c(new_n128_), .O(new_n162_));
  nor2   g061(.a(new_n162_), .b(new_n75_), .O(new_n163_));
  oai21  g062(.a(new_n163_), .b(new_n161_), .c(new_n85_), .O(new_n164_));
  nand4  g063(.a(new_n164_), .b(new_n154_), .c(new_n152_), .d(new_n142_), .O(z38));
  nand2  g064(.a(new_n74_), .b(x2), .O(new_n174_));
  nand3  g065(.a(new_n174_), .b(x7), .c(x0), .O(new_n175_));
  nand4  g066(.a(new_n84_), .b(new_n74_), .c(new_n85_), .d(new_n128_), .O(new_n176_));
  aoi21  g067(.a(new_n176_), .b(new_n175_), .c(x1), .O(new_n177_));
  aoi21  g068(.a(x3), .b(x1), .c(new_n128_), .O(new_n178_));
  oai22  g069(.a(new_n178_), .b(new_n85_), .c(x7), .d(new_n74_), .O(new_n179_));
  oai21  g070(.a(new_n179_), .b(new_n177_), .c(x6), .O(new_n180_));
  oai21  g071(.a(new_n86_), .b(x0), .c(new_n76_), .O(new_n181_));
  aoi21  g072(.a(new_n181_), .b(new_n180_), .c(x5), .O(new_n182_));
  nand2  g073(.a(new_n85_), .b(new_n86_), .O(new_n183_));
  nand2  g074(.a(new_n139_), .b(x3), .O(new_n184_));
  oai21  g075(.a(new_n184_), .b(new_n183_), .c(x7), .O(new_n185_));
  nand3  g076(.a(new_n185_), .b(x6), .c(x0), .O(new_n186_));
  oai21  g077(.a(new_n76_), .b(new_n128_), .c(x5), .O(new_n187_));
  nand2  g078(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  oai21  g079(.a(new_n188_), .b(new_n182_), .c(new_n75_), .O(new_n189_));
  nand2  g080(.a(new_n85_), .b(x1), .O(new_n190_));
  nor2   g081(.a(x1), .b(x0), .O(new_n191_));
  nand4  g082(.a(new_n191_), .b(x4), .c(x3), .d(x2), .O(new_n192_));
  aoi21  g083(.a(new_n192_), .b(new_n190_), .c(x5), .O(new_n193_));
  inv1   g084(.a(new_n163_), .O(new_n194_));
  nor2   g085(.a(new_n74_), .b(new_n86_), .O(new_n195_));
  aoi21  g086(.a(new_n74_), .b(x0), .c(new_n195_), .O(new_n196_));
  aoi21  g087(.a(new_n196_), .b(new_n194_), .c(x2), .O(new_n197_));
  aoi21  g088(.a(new_n74_), .b(x2), .c(x4), .O(new_n198_));
  nand2  g089(.a(x5), .b(x3), .O(new_n199_));
  oai21  g090(.a(x3), .b(x0), .c(new_n199_), .O(new_n200_));
  nand3  g091(.a(new_n200_), .b(x2), .c(new_n86_), .O(new_n201_));
  oai21  g092(.a(new_n198_), .b(new_n128_), .c(new_n201_), .O(new_n202_));
  nor3   g093(.a(new_n202_), .b(new_n197_), .c(new_n193_), .O(new_n203_));
  nand2  g094(.a(new_n203_), .b(new_n189_), .O(z47));
  zero   g095(.O(z00));
  zero   g096(.O(z01));
  zero   g097(.O(z03));
  zero   g098(.O(z04));
