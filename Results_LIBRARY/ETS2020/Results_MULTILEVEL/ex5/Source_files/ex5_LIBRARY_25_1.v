// Benchmark "FAU" written by ABC on Sat Jul 25 01:39:42 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n101_, new_n102_, new_n118_, new_n119_, new_n120_, new_n123_,
  ...
  inv1   g021(.a(x0), .O(new_n118_));
  nor4   g022(.a(x3), .b(new_n85_), .c(new_n86_), .d(new_n118_), .O(new_n119_));
  nand4  g023(.a(new_n119_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n120_));
  nor2   g024(.a(new_n120_), .b(new_n84_), .O(z30));
  nor2   g025(.a(x6), .b(x5), .O(new_n123_));
  oai21  g026(.a(new_n123_), .b(x7), .c(new_n118_), .O(new_n124_));
  ...
  oai21  g034(.a(new_n76_), .b(new_n118_), .c(new_n83_), .O(new_n132_));
  nor2   g035(.a(new_n84_), .b(new_n83_), .O(new_n133_));
  aoi21  g036(.a(new_n132_), .b(new_n84_), .c(new_n133_), .O(new_n134_));
  nand3  g037(.a(new_n134_), .b(new_n131_), .c(new_n124_), .O(new_n135_));
  nand2  g038(.a(new_n135_), .b(new_n75_), .O(new_n136_));
  oai21  g039(.a(x3), .b(new_n86_), .c(new_n118_), .O(new_n137_));
  nand2  g040(.a(new_n74_), .b(x1), .O(new_n138_));
  nand3  g041(.a(new_n83_), .b(new_n86_), .c(x0), .O(new_n139_));
  ...
  oai21  g045(.a(new_n74_), .b(new_n86_), .c(x0), .O(new_n143_));
  nand3  g046(.a(new_n74_), .b(new_n86_), .c(new_n118_), .O(new_n144_));
  aoi21  g047(.a(new_n144_), .b(new_n143_), .c(new_n85_), .O(new_n145_));
  inv1   g048(.a(new_n145_), .O(new_n146_));
  aoi21  g049(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n147_));
  oai21  g050(.a(new_n147_), .b(new_n118_), .c(x1), .O(new_n148_));
