...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n96_, new_n99_, new_n100_, new_n101_, new_n103_, new_n104_,
  ...
  inv1   g035(.a(x0), .O(new_n129_));
  nor4   g036(.a(x3), .b(new_n85_), .c(new_n86_), .d(new_n129_), .O(new_n130_));
  nand4  g037(.a(new_n130_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n131_));
  nor2   g038(.a(new_n131_), .b(new_n84_), .O(z30));
  nor2   g039(.a(x6), .b(x5), .O(new_n134_));
  oai21  g040(.a(new_n134_), .b(x7), .c(new_n129_), .O(new_n135_));
  ...
  oai21  g048(.a(new_n76_), .b(new_n129_), .c(new_n83_), .O(new_n143_));
  ...
  oai21  g053(.a(x3), .b(new_n86_), .c(new_n129_), .O(new_n148_));
  ...
  nand3  g060(.a(new_n74_), .b(new_n86_), .c(new_n129_), .O(new_n155_));
  ...
  oai21  g064(.a(new_n158_), .b(new_n129_), .c(x1), .O(new_n159_));
  ...
  oai21  g081(.a(new_n75_), .b(x2), .c(new_n129_), .O(new_n202_));
  nand2  g082(.a(new_n202_), .b(new_n74_), .O(new_n203_));
  nor2   g083(.a(new_n75_), .b(new_n129_), .O(new_n204_));
