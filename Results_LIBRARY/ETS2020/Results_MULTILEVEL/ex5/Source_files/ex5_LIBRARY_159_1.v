...
module FAU ( 
  ...
  wire new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    ...
    new_n99_, new_n102_, new_n103_, new_n104_, new_n118_, new_n119_,
    new_n120_, new_n125_, new_n126_, new_n127_, new_n128_, new_n129_,
  ...
  nand4  g023(.a(x3), .b(x2), .c(new_n85_), .d(x0), .O(new_n118_));
  inv1   g024(.a(new_n118_), .O(new_n119_));
  nand4  g025(.a(new_n119_), .b(x6), .c(new_n79_), .d(new_n84_), .O(new_n120_));
  nor2   g026(.a(new_n120_), .b(new_n81_), .O(z28));
  ...
  oai21  g033(.a(new_n82_), .b(new_n85_), .c(x7), .O(new_n131_));
  nand3  g034(.a(new_n131_), .b(x6), .c(x3), .O(new_n132_));
  nand2  g035(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g036(.a(new_n133_), .b(new_n79_), .O(new_n134_));
  oai21  g037(.a(new_n80_), .b(new_n125_), .c(new_n79_), .O(new_n135_));
  nor2   g038(.a(new_n81_), .b(new_n79_), .O(new_n136_));
  aoi21  g039(.a(new_n135_), .b(new_n81_), .c(new_n136_), .O(new_n137_));
  nand3  g040(.a(new_n137_), .b(new_n134_), .c(new_n127_), .O(new_n138_));
  nand2  g041(.a(new_n138_), .b(new_n84_), .O(new_n139_));
  oai21  g042(.a(x3), .b(new_n85_), .c(new_n125_), .O(new_n140_));
  nand2  g043(.a(new_n83_), .b(x1), .O(new_n141_));
  nand3  g044(.a(new_n79_), .b(new_n85_), .c(x0), .O(new_n142_));
  nand3  g045(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  nand2  g046(.a(new_n143_), .b(x4), .O(new_n144_));
  oai21  g047(.a(x5), .b(new_n85_), .c(new_n144_), .O(new_n145_));
  oai21  g048(.a(new_n83_), .b(new_n85_), .c(x0), .O(new_n146_));
  nand3  g049(.a(new_n83_), .b(new_n85_), .c(new_n125_), .O(new_n147_));
  aoi21  g050(.a(new_n147_), .b(new_n146_), .c(new_n82_), .O(new_n148_));
  inv1   g051(.a(new_n148_), .O(new_n149_));
  aoi21  g052(.a(x6), .b(new_n84_), .c(new_n83_), .O(new_n150_));
  oai21  g053(.a(new_n150_), .b(new_n125_), .c(x1), .O(new_n151_));
  nand2  g054(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  aoi21  g055(.a(new_n145_), .b(new_n82_), .c(new_n152_), .O(new_n153_));
  nand2  g056(.a(new_n153_), .b(new_n139_), .O(z32));
  nor2   g057(.a(x5), .b(new_n85_), .O(new_n160_));
