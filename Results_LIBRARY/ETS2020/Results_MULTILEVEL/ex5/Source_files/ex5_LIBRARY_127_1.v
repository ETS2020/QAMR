...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n107_, new_n108_, new_n120_, new_n121_, new_n128_, new_n129_,
  ...
  nor3   g029(.a(x3), .b(new_n85_), .c(new_n90_), .O(new_n120_));
  nand4  g030(.a(new_n120_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n121_));
  nor2   g031(.a(new_n121_), .b(new_n84_), .O(z26));
  nor2   g032(.a(x6), .b(x5), .O(new_n128_));
  oai21  g033(.a(new_n128_), .b(x7), .c(new_n90_), .O(new_n129_));
