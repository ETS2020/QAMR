...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n111_, new_n125_, new_n126_, new_n127_, new_n128_, new_n129_,
  ...
  inv1   g024(.a(x0), .O(new_n110_));
  nand4  g025(.a(new_n74_), .b(new_n85_), .c(new_n86_), .d(new_n110_), .O(new_n111_));
  nor2   g026(.a(new_n111_), .b(new_n75_), .O(z19));
  nor4   g027(.a(new_n88_), .b(x7), .c(new_n76_), .d(x5), .O(z25));
  nor2   g028(.a(x6), .b(x5), .O(new_n125_));
  oai21  g029(.a(new_n125_), .b(x7), .c(new_n110_), .O(new_n126_));
  ...
  oai21  g037(.a(new_n76_), .b(new_n110_), .c(new_n83_), .O(new_n134_));
  ...
  oai21  g042(.a(x3), .b(new_n86_), .c(new_n110_), .O(new_n139_));
  ...
  oai21  g047(.a(x5), .b(new_n86_), .c(new_n143_), .O(new_n144_));
  oai21  g048(.a(new_n74_), .b(new_n86_), .c(x0), .O(new_n145_));
  nand3  g049(.a(new_n74_), .b(new_n86_), .c(new_n110_), .O(new_n146_));
  aoi21  g050(.a(new_n146_), .b(new_n145_), .c(new_n85_), .O(new_n147_));
  inv1   g051(.a(new_n147_), .O(new_n148_));
  aoi21  g052(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n149_));
  oai21  g053(.a(new_n149_), .b(new_n110_), .c(x1), .O(new_n150_));
  nand2  g054(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g055(.a(new_n144_), .b(new_n85_), .c(new_n151_), .O(new_n152_));
  nand2  g056(.a(new_n152_), .b(new_n138_), .O(z32));
  nor2   g057(.a(x5), .b(new_n86_), .O(new_n159_));
