...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n191_, new_n192_, new_n193_, new_n194_,
  ...
  nor2   g067(.a(x5), .b(x0), .O(new_n191_));
  nand2  g068(.a(new_n84_), .b(x5), .O(new_n192_));
  nand4  g069(.a(new_n83_), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n193_));
  aoi21  g070(.a(new_n193_), .b(new_n192_), .c(new_n74_), .O(new_n194_));
  oai21  g071(.a(new_n194_), .b(new_n191_), .c(new_n76_), .O(new_n195_));
  aoi21  g072(.a(x7), .b(x5), .c(x6), .O(new_n196_));
  nand2  g073(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g074(.a(new_n197_), .b(new_n75_), .O(new_n198_));
  aoi21  g075(.a(new_n86_), .b(x0), .c(new_n75_), .O(new_n199_));
  nor2   g076(.a(x6), .b(new_n86_), .O(new_n200_));
  oai21  g077(.a(new_n200_), .b(new_n199_), .c(x3), .O(new_n201_));
  oai21  g078(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n202_));
  nand2  g079(.a(new_n202_), .b(new_n128_), .O(new_n203_));
  nand3  g080(.a(new_n74_), .b(new_n85_), .c(new_n86_), .O(new_n204_));
  nand2  g081(.a(x4), .b(new_n86_), .O(new_n205_));
  oai21  g082(.a(new_n205_), .b(x2), .c(x3), .O(new_n206_));
  nand2  g083(.a(new_n206_), .b(x0), .O(new_n207_));
  nand4  g084(.a(new_n207_), .b(new_n204_), .c(new_n203_), .d(new_n201_), .O(new_n208_));
  inv1   g085(.a(new_n208_), .O(new_n209_));
  nand2  g086(.a(new_n209_), .b(new_n198_), .O(z61));
  zero   g087(.O(z00));
  zero   g088(.O(z01));
  zero   g089(.O(z03));
  zero   g090(.O(z04));
