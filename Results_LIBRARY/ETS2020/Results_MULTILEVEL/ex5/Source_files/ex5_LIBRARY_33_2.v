...
module FAU ( 
  ...
  wire new_n72_, new_n73_, new_n76_, new_n77_, new_n78_, new_n79_, new_n81_,
    ...
    new_n119_, new_n120_, new_n121_, new_n127_, new_n129_, new_n130_,
  ...
  nor3   g049(.a(new_n119_), .b(x5), .c(new_n77_), .O(z17));
  nor3   g050(.a(new_n91_), .b(x5), .c(new_n77_), .O(z18));
  nand3  g051(.a(new_n90_), .b(new_n76_), .c(new_n108_), .O(new_n127_));
  nor2   g052(.a(new_n127_), .b(new_n77_), .O(z19));
  nand2  g053(.a(new_n120_), .b(new_n76_), .O(new_n129_));
  inv1   g054(.a(new_n129_), .O(new_n130_));
  nand4  g055(.a(new_n130_), .b(new_n78_), .c(new_n81_), .d(new_n77_), .O(new_n131_));
  inv1   g056(.a(new_n131_), .O(z20));
  inv1   g057(.a(new_n121_), .O(new_n133_));
  nand3  g058(.a(new_n133_), .b(new_n78_), .c(new_n81_), .O(new_n134_));
  inv1   g059(.a(new_n134_), .O(z21));
  nand2  g060(.a(new_n120_), .b(new_n77_), .O(new_n136_));
  inv1   g061(.a(new_n136_), .O(new_n137_));
  nand4  g062(.a(new_n137_), .b(x7), .c(x6), .d(new_n81_), .O(new_n138_));
  inv1   g063(.a(new_n138_), .O(z22));
  nand3  g064(.a(new_n90_), .b(x3), .c(new_n108_), .O(new_n140_));
  nor2   g065(.a(new_n140_), .b(new_n81_), .O(z23));
  inv1   g066(.a(new_n127_), .O(new_n142_));
  nand3  g067(.a(new_n142_), .b(new_n81_), .c(new_n77_), .O(new_n143_));
  nor3   g068(.a(new_n143_), .b(x7), .c(new_n78_), .O(z24));
  nor3   g069(.a(x3), .b(new_n108_), .c(new_n94_), .O(new_n146_));
  nand4  g070(.a(new_n146_), .b(x6), .c(new_n81_), .d(new_n77_), .O(new_n147_));
  nor2   g071(.a(new_n147_), .b(new_n86_), .O(z26));
  nand3  g072(.a(new_n103_), .b(new_n76_), .c(x2), .O(new_n149_));
  ...
  nor3   g080(.a(new_n143_), .b(new_n86_), .c(x6), .O(z29));
  ...
  nand2  g087(.a(x3), .b(new_n108_), .O(new_n164_));
  ...
  nor2   g093(.a(x6), .b(new_n108_), .O(new_n170_));
  ...
  nand3  g101(.a(new_n178_), .b(new_n113_), .c(new_n76_), .O(new_n179_));
  aoi21  g102(.a(new_n179_), .b(new_n177_), .c(new_n108_), .O(new_n180_));
  nand2  g103(.a(x5), .b(new_n76_), .O(new_n181_));
  nand4  g104(.a(new_n181_), .b(x7), .c(new_n108_), .d(new_n95_), .O(new_n182_));
  ...
  oai21  g118(.a(new_n191_), .b(new_n108_), .c(new_n195_), .O(new_n196_));
  ...
  nor3   g125(.a(new_n202_), .b(x5), .c(new_n108_), .O(new_n203_));
  ...
  nand3  g160(.a(x5), .b(x4), .c(new_n108_), .O(new_n238_));
  ...
  aoi21  g167(.a(new_n244_), .b(x4), .c(new_n103_), .O(new_n245_));
  ...
  nor2   g179(.a(new_n108_), .b(new_n94_), .O(new_n257_));
  ...
  nand4  g188(.a(new_n265_), .b(new_n81_), .c(new_n108_), .d(new_n95_), .O(new_n266_));
  nor2   g189(.a(new_n77_), .b(new_n108_), .O(new_n267_));
  ...
  nand2  g201(.a(new_n81_), .b(new_n108_), .O(new_n280_));
  ...
  aoi21  g210(.a(x6), .b(new_n108_), .c(x0), .O(new_n289_));
  ...
  aoi21  g218(.a(new_n296_), .b(new_n294_), .c(new_n108_), .O(new_n297_));
  ...
  nand2  g228(.a(x4), .b(new_n108_), .O(new_n307_));
  ...
  aoi21  g239(.a(new_n317_), .b(x6), .c(new_n108_), .O(new_n318_));
  nand3  g240(.a(new_n265_), .b(new_n108_), .c(new_n95_), .O(new_n319_));
  ...
  nand2  g269(.a(new_n347_), .b(new_n108_), .O(new_n348_));
  ...
  oai21  g422(.a(new_n500_), .b(new_n496_), .c(new_n108_), .O(new_n501_));
  ...
  nand2  g433(.a(new_n181_), .b(new_n108_), .O(new_n512_));
  ...
  oai21  g452(.a(new_n264_), .b(new_n108_), .c(new_n76_), .O(new_n531_));
  ...
  nand4  g456(.a(new_n113_), .b(new_n78_), .c(x3), .d(new_n108_), .O(new_n535_));
  ...
  oai21  g471(.a(new_n73_), .b(x4), .c(new_n108_), .O(new_n550_));
  ...
  nand3  g476(.a(new_n554_), .b(new_n108_), .c(new_n95_), .O(new_n555_));
  ...
  oai21  g491(.a(new_n569_), .b(new_n568_), .c(new_n108_), .O(new_n570_));
  aoi21  g492(.a(new_n570_), .b(new_n567_), .c(x1), .O(new_n571_));
  oai22  g493(.a(new_n477_), .b(new_n360_), .c(new_n450_), .d(new_n108_), .O(new_n572_));
  ...
  oai22  g497(.a(new_n575_), .b(new_n497_), .c(x5), .d(new_n108_), .O(new_n576_));
  ...
  nand2  g501(.a(new_n579_), .b(new_n108_), .O(new_n580_));
  ...
  nand2  g519(.a(new_n597_), .b(new_n108_), .O(new_n598_));
  aoi21  g520(.a(new_n251_), .b(new_n94_), .c(new_n340_), .O(new_n599_));
  oai21  g521(.a(new_n599_), .b(new_n108_), .c(new_n598_), .O(new_n600_));
  ...
  oai21  g532(.a(new_n108_), .b(x0), .c(new_n465_), .O(new_n611_));
  ...
  nand2  g538(.a(new_n108_), .b(x0), .O(new_n617_));
  ...
  oai21  g545(.a(x4), .b(new_n95_), .c(new_n108_), .O(new_n624_));
  ...
  nand3  g552(.a(new_n630_), .b(new_n108_), .c(new_n95_), .O(new_n631_));
  ...
  nand3  g557(.a(new_n635_), .b(new_n108_), .c(new_n95_), .O(new_n636_));
  ...
  oai21  g566(.a(new_n230_), .b(x4), .c(new_n108_), .O(new_n645_));
  ...
  oai21  g577(.a(new_n78_), .b(new_n108_), .c(new_n81_), .O(new_n656_));
  ...
  nand3  g583(.a(new_n240_), .b(new_n113_), .c(new_n108_), .O(new_n662_));
  ...
  nand2  g598(.a(new_n308_), .b(new_n113_), .O(new_n677_));
  ...
  nand2  g613(.a(new_n691_), .b(new_n108_), .O(new_n692_));
  ...
  oai21  g631(.a(new_n569_), .b(new_n378_), .c(new_n108_), .O(new_n710_));
