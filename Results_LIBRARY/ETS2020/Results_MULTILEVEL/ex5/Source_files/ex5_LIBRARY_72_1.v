...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n154_, new_n161_, new_n162_, new_n165_, new_n166_, new_n167_,
  ...
  aoi21  g059(.a(new_n144_), .b(new_n143_), .c(new_n75_), .O(new_n161_));
  oai21  g060(.a(new_n161_), .b(new_n148_), .c(new_n85_), .O(new_n162_));
  nand4  g061(.a(new_n162_), .b(new_n154_), .c(new_n152_), .d(new_n142_), .O(z38));
  nand3  g062(.a(x2), .b(new_n86_), .c(new_n128_), .O(new_n165_));
  nand3  g063(.a(x4), .b(new_n85_), .c(x1), .O(new_n166_));
  nand4  g064(.a(new_n84_), .b(new_n76_), .c(x5), .d(new_n75_), .O(new_n167_));
  nand3  g065(.a(new_n167_), .b(new_n166_), .c(new_n165_), .O(new_n168_));
  nand2  g066(.a(new_n168_), .b(new_n74_), .O(new_n169_));
  nand2  g067(.a(x6), .b(new_n75_), .O(new_n170_));
  oai21  g068(.a(new_n170_), .b(new_n74_), .c(x2), .O(new_n171_));
  nand2  g069(.a(new_n171_), .b(x1), .O(new_n172_));
  and2   g070(.a(x7), .b(x6), .O(new_n173_));
  nand4  g071(.a(new_n173_), .b(new_n75_), .c(x3), .d(new_n86_), .O(new_n174_));
  aoi21  g072(.a(new_n174_), .b(x6), .c(new_n85_), .O(new_n175_));
  oai21  g073(.a(new_n173_), .b(x4), .c(new_n85_), .O(new_n176_));
  nor2   g074(.a(new_n176_), .b(x1), .O(new_n177_));
  oai21  g075(.a(new_n177_), .b(new_n175_), .c(x0), .O(new_n178_));
  nand3  g076(.a(new_n84_), .b(x6), .c(x3), .O(new_n179_));
  oai21  g077(.a(x6), .b(x0), .c(new_n179_), .O(new_n180_));
  nand2  g078(.a(new_n180_), .b(new_n75_), .O(new_n181_));
  nand3  g079(.a(new_n181_), .b(new_n178_), .c(new_n172_), .O(new_n182_));
  nand2  g080(.a(new_n182_), .b(new_n83_), .O(new_n183_));
  nand3  g081(.a(new_n84_), .b(x6), .c(new_n75_), .O(new_n184_));
  oai21  g082(.a(new_n75_), .b(new_n85_), .c(new_n184_), .O(new_n185_));
  nand2  g083(.a(new_n185_), .b(x0), .O(new_n186_));
  nand2  g084(.a(x4), .b(x3), .O(new_n187_));
  nand2  g085(.a(new_n187_), .b(x0), .O(new_n188_));
  nand2  g086(.a(new_n188_), .b(x1), .O(new_n189_));
  oai22  g087(.a(new_n187_), .b(x2), .c(new_n84_), .d(x4), .O(new_n190_));
  nand2  g088(.a(new_n190_), .b(new_n128_), .O(new_n191_));
  nand3  g089(.a(new_n84_), .b(new_n76_), .c(new_n74_), .O(new_n192_));
  nand3  g090(.a(new_n192_), .b(x5), .c(new_n75_), .O(new_n193_));
  nand4  g091(.a(new_n193_), .b(new_n191_), .c(new_n189_), .d(new_n186_), .O(new_n194_));
  inv1   g092(.a(new_n194_), .O(new_n195_));
  nand3  g093(.a(new_n195_), .b(new_n183_), .c(new_n169_), .O(z40));
  zero   g094(.O(z00));
  zero   g095(.O(z01));
  zero   g096(.O(z03));
  zero   g097(.O(z04));
