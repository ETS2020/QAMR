...
module FAU ( 
  ...
  nand3  g063(.a(x5), .b(x3), .c(x1), .O(new_n168_));
  nor2   g064(.a(new_n128_), .b(x5), .O(new_n169_));
  nand3  g065(.a(new_n169_), .b(new_n85_), .c(new_n86_), .O(new_n170_));
  aoi21  g066(.a(new_n170_), .b(new_n168_), .c(new_n125_), .O(new_n171_));
  oai21  g067(.a(x7), .b(x5), .c(new_n125_), .O(new_n172_));
  nand3  g068(.a(new_n84_), .b(x6), .c(x3), .O(new_n173_));
  oai21  g069(.a(x6), .b(x1), .c(new_n173_), .O(new_n174_));
  nand2  g070(.a(new_n174_), .b(new_n83_), .O(new_n175_));
  nand2  g071(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  oai21  g072(.a(new_n176_), .b(new_n171_), .c(new_n75_), .O(new_n177_));
  nand2  g073(.a(x3), .b(x2), .O(new_n178_));
  nand3  g074(.a(new_n83_), .b(x4), .c(new_n85_), .O(new_n179_));
  aoi21  g075(.a(new_n179_), .b(new_n178_), .c(new_n125_), .O(new_n180_));
  aoi21  g076(.a(x2), .b(x0), .c(x3), .O(new_n181_));
  oai21  g077(.a(new_n181_), .b(new_n180_), .c(new_n86_), .O(new_n182_));
  inv1   g078(.a(new_n87_), .O(new_n183_));
  nand3  g079(.a(x7), .b(x3), .c(x1), .O(new_n184_));
  oai21  g080(.a(x3), .b(new_n85_), .c(new_n184_), .O(new_n185_));
  nand2  g081(.a(new_n185_), .b(x0), .O(new_n186_));
  aoi21  g082(.a(new_n86_), .b(x0), .c(new_n75_), .O(new_n187_));
  nor2   g083(.a(x6), .b(new_n86_), .O(new_n188_));
  oai21  g084(.a(new_n188_), .b(new_n187_), .c(x3), .O(new_n189_));
  nand3  g085(.a(new_n189_), .b(new_n186_), .c(new_n183_), .O(new_n190_));
  inv1   g086(.a(new_n190_), .O(new_n191_));
  nand3  g087(.a(new_n191_), .b(new_n182_), .c(new_n177_), .O(z41));
  zero   g088(.O(z00));
  zero   g089(.O(z01));
  zero   g090(.O(z03));
  zero   g091(.O(z04));
