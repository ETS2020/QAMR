...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n82_, new_n83_, new_n85_,
    ...
    new_n107_, new_n119_, new_n120_, new_n121_, new_n128_, new_n129_,
  ...
  inv1   g028(.a(x0), .O(new_n119_));
  nor3   g029(.a(x3), .b(new_n87_), .c(new_n119_), .O(new_n120_));
  nand4  g030(.a(new_n120_), .b(x6), .c(new_n85_), .d(new_n75_), .O(new_n121_));
  nor2   g031(.a(new_n121_), .b(new_n86_), .O(z26));
  nor2   g032(.a(x6), .b(x5), .O(new_n128_));
  oai21  g033(.a(new_n128_), .b(x7), .c(new_n119_), .O(new_n129_));
  nand2  g034(.a(x7), .b(x6), .O(new_n130_));
  oai21  g035(.a(x6), .b(x3), .c(new_n130_), .O(new_n131_));
  nand4  g036(.a(new_n131_), .b(new_n87_), .c(new_n88_), .d(x0), .O(new_n132_));
  oai21  g037(.a(new_n87_), .b(new_n88_), .c(x7), .O(new_n133_));
  nand3  g038(.a(new_n133_), .b(x6), .c(x3), .O(new_n134_));
  nand2  g039(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g040(.a(new_n135_), .b(new_n85_), .O(new_n136_));
  oai21  g041(.a(new_n76_), .b(new_n119_), .c(new_n85_), .O(new_n137_));
  nor2   g042(.a(new_n86_), .b(new_n85_), .O(new_n138_));
  aoi21  g043(.a(new_n137_), .b(new_n86_), .c(new_n138_), .O(new_n139_));
  nand3  g044(.a(new_n139_), .b(new_n136_), .c(new_n129_), .O(new_n140_));
  nand2  g045(.a(new_n140_), .b(new_n75_), .O(new_n141_));
  oai21  g046(.a(x3), .b(new_n88_), .c(new_n119_), .O(new_n142_));
  nand2  g047(.a(new_n74_), .b(x1), .O(new_n143_));
  nand3  g048(.a(new_n85_), .b(new_n88_), .c(x0), .O(new_n144_));
  nand3  g049(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nand2  g050(.a(new_n145_), .b(x4), .O(new_n146_));
  oai21  g051(.a(x5), .b(new_n88_), .c(new_n146_), .O(new_n147_));
  oai21  g052(.a(new_n74_), .b(new_n88_), .c(x0), .O(new_n148_));
  nand3  g053(.a(new_n74_), .b(new_n88_), .c(new_n119_), .O(new_n149_));
  aoi21  g054(.a(new_n149_), .b(new_n148_), .c(new_n87_), .O(new_n150_));
  inv1   g055(.a(new_n150_), .O(new_n151_));
  aoi21  g056(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n152_));
  oai21  g057(.a(new_n152_), .b(new_n119_), .c(x1), .O(new_n153_));
  nand2  g058(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g059(.a(new_n147_), .b(new_n87_), .c(new_n154_), .O(new_n155_));
  nand2  g060(.a(new_n155_), .b(new_n141_), .O(z32));
  nor2   g061(.a(x5), .b(new_n88_), .O(new_n162_));
