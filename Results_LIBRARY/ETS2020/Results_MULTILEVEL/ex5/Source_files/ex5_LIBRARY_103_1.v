...
module FAU ( 
  ...
  nand3  g067(.a(x5), .b(x3), .c(x1), .O(new_n171_));
  nor2   g068(.a(new_n131_), .b(x5), .O(new_n172_));
  nand3  g069(.a(new_n172_), .b(new_n85_), .c(new_n86_), .O(new_n173_));
  aoi21  g070(.a(new_n173_), .b(new_n171_), .c(new_n128_), .O(new_n174_));
  oai21  g071(.a(x7), .b(x5), .c(new_n128_), .O(new_n175_));
  nand3  g072(.a(new_n84_), .b(x6), .c(x3), .O(new_n176_));
  oai21  g073(.a(x6), .b(x1), .c(new_n176_), .O(new_n177_));
  nand2  g074(.a(new_n177_), .b(new_n83_), .O(new_n178_));
  nand2  g075(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  oai21  g076(.a(new_n179_), .b(new_n174_), .c(new_n75_), .O(new_n180_));
  nand2  g077(.a(x3), .b(x2), .O(new_n181_));
  nand3  g078(.a(new_n83_), .b(x4), .c(new_n85_), .O(new_n182_));
  aoi21  g079(.a(new_n182_), .b(new_n181_), .c(new_n128_), .O(new_n183_));
  aoi21  g080(.a(x2), .b(x0), .c(x3), .O(new_n184_));
  oai21  g081(.a(new_n184_), .b(new_n183_), .c(new_n86_), .O(new_n185_));
  inv1   g082(.a(new_n87_), .O(new_n186_));
  nand3  g083(.a(x7), .b(x3), .c(x1), .O(new_n187_));
  oai21  g084(.a(x3), .b(new_n85_), .c(new_n187_), .O(new_n188_));
  nand2  g085(.a(new_n188_), .b(x0), .O(new_n189_));
  aoi21  g086(.a(new_n86_), .b(x0), .c(new_n75_), .O(new_n190_));
  nor2   g087(.a(x6), .b(new_n86_), .O(new_n191_));
  oai21  g088(.a(new_n191_), .b(new_n190_), .c(x3), .O(new_n192_));
  nand3  g089(.a(new_n192_), .b(new_n189_), .c(new_n186_), .O(new_n193_));
  inv1   g090(.a(new_n193_), .O(new_n194_));
  nand3  g091(.a(new_n194_), .b(new_n185_), .c(new_n180_), .O(z41));
  zero   g092(.O(z00));
  zero   g093(.O(z01));
  zero   g094(.O(z03));
  zero   g095(.O(z04));
