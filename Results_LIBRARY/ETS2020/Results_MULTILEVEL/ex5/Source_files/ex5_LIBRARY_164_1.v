// Benchmark "FAU" written by ABC on Sat Jul 25 01:41:25 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n99_, new_n100_, new_n103_, new_n104_, new_n105_, new_n117_,
    new_n118_, new_n119_, new_n126_, new_n127_, new_n128_, new_n129_,
  ...
  inv1   g025(.a(x0), .O(new_n117_));
  nor3   g026(.a(x3), .b(new_n85_), .c(new_n117_), .O(new_n118_));
  nand4  g027(.a(new_n118_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n119_));
  nor2   g028(.a(new_n119_), .b(new_n84_), .O(z26));
  nor2   g029(.a(x6), .b(x5), .O(new_n126_));
  oai21  g030(.a(new_n126_), .b(x7), .c(new_n117_), .O(new_n127_));
  nand2  g031(.a(x7), .b(x6), .O(new_n128_));
  oai21  g032(.a(x6), .b(x3), .c(new_n128_), .O(new_n129_));
  nand4  g033(.a(new_n129_), .b(new_n85_), .c(new_n86_), .d(x0), .O(new_n130_));
  oai21  g034(.a(new_n85_), .b(new_n86_), .c(x7), .O(new_n131_));
  nand3  g035(.a(new_n131_), .b(x6), .c(x3), .O(new_n132_));
  nand2  g036(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g037(.a(new_n133_), .b(new_n83_), .O(new_n134_));
  oai21  g038(.a(new_n76_), .b(new_n117_), .c(new_n83_), .O(new_n135_));
  nor2   g039(.a(new_n84_), .b(new_n83_), .O(new_n136_));
  aoi21  g040(.a(new_n135_), .b(new_n84_), .c(new_n136_), .O(new_n137_));
  nand3  g041(.a(new_n137_), .b(new_n134_), .c(new_n127_), .O(new_n138_));
  nand2  g042(.a(new_n138_), .b(new_n75_), .O(new_n139_));
  oai21  g043(.a(x3), .b(new_n86_), .c(new_n117_), .O(new_n140_));
  nand2  g044(.a(new_n74_), .b(x1), .O(new_n141_));
  nand3  g045(.a(new_n83_), .b(new_n86_), .c(x0), .O(new_n142_));
  nand3  g046(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  nand2  g047(.a(new_n143_), .b(x4), .O(new_n144_));
  oai21  g048(.a(x5), .b(new_n86_), .c(new_n144_), .O(new_n145_));
  oai21  g049(.a(new_n74_), .b(new_n86_), .c(x0), .O(new_n146_));
  nand3  g050(.a(new_n74_), .b(new_n86_), .c(new_n117_), .O(new_n147_));
  aoi21  g051(.a(new_n147_), .b(new_n146_), .c(new_n85_), .O(new_n148_));
  inv1   g052(.a(new_n148_), .O(new_n149_));
  aoi21  g053(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n150_));
  oai21  g054(.a(new_n150_), .b(new_n117_), .c(x1), .O(new_n151_));
  ...
  nor2   g058(.a(x5), .b(new_n86_), .O(new_n160_));
