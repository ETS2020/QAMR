...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n79_, new_n84_, new_n85_,
    ...
    new_n166_, new_n167_, new_n168_, new_n169_, new_n186_, new_n187_,
  ...
  nand2  g034(.a(new_n76_), .b(new_n84_), .O(new_n130_));
  nand2  g035(.a(new_n130_), .b(new_n85_), .O(new_n131_));
  nand2  g036(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g037(.a(x7), .b(x6), .O(new_n133_));
  oai21  g038(.a(x6), .b(x3), .c(new_n133_), .O(new_n134_));
  nand4  g039(.a(new_n134_), .b(new_n86_), .c(new_n87_), .d(x0), .O(new_n135_));
  oai21  g040(.a(new_n86_), .b(new_n87_), .c(x7), .O(new_n136_));
  nand3  g041(.a(new_n136_), .b(x6), .c(x3), .O(new_n137_));
  nand2  g042(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g043(.a(new_n138_), .b(new_n84_), .O(new_n139_));
  oai21  g044(.a(new_n76_), .b(new_n129_), .c(new_n84_), .O(new_n140_));
  nor2   g045(.a(new_n85_), .b(new_n84_), .O(new_n141_));
  aoi21  g046(.a(new_n140_), .b(new_n85_), .c(new_n141_), .O(new_n142_));
  nand3  g047(.a(new_n142_), .b(new_n139_), .c(new_n132_), .O(new_n143_));
  nand2  g048(.a(new_n143_), .b(new_n75_), .O(new_n144_));
  oai21  g049(.a(x3), .b(new_n87_), .c(new_n129_), .O(new_n145_));
  nand2  g050(.a(new_n74_), .b(x1), .O(new_n146_));
  nand3  g051(.a(new_n84_), .b(new_n87_), .c(x0), .O(new_n147_));
  nand3  g052(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  nand2  g053(.a(new_n148_), .b(x4), .O(new_n149_));
  oai21  g054(.a(x5), .b(new_n87_), .c(new_n149_), .O(new_n150_));
  oai21  g055(.a(new_n74_), .b(new_n87_), .c(x0), .O(new_n151_));
  nand3  g056(.a(new_n74_), .b(new_n87_), .c(new_n129_), .O(new_n152_));
  aoi21  g057(.a(new_n152_), .b(new_n151_), .c(new_n86_), .O(new_n153_));
  ...
  aoi21  g062(.a(new_n150_), .b(new_n86_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g070(.a(x4), .b(x2), .O(new_n186_));
  nand2  g071(.a(new_n84_), .b(x2), .O(new_n187_));
  nand3  g072(.a(x7), .b(x6), .c(x5), .O(new_n188_));
  nand2  g073(.a(new_n75_), .b(new_n86_), .O(new_n189_));
  oai21  g074(.a(new_n189_), .b(new_n188_), .c(new_n187_), .O(new_n190_));
  nand2  g075(.a(new_n190_), .b(x1), .O(new_n191_));
  aoi21  g076(.a(new_n191_), .b(new_n186_), .c(x3), .O(new_n192_));
  oai21  g077(.a(new_n84_), .b(x4), .c(new_n86_), .O(new_n193_));
  nand4  g078(.a(new_n84_), .b(x4), .c(x2), .d(new_n87_), .O(new_n194_));
  aoi21  g079(.a(new_n194_), .b(new_n193_), .c(new_n74_), .O(new_n195_));
  oai21  g080(.a(new_n195_), .b(new_n192_), .c(new_n129_), .O(new_n196_));
  nand2  g081(.a(new_n74_), .b(new_n86_), .O(new_n197_));
  nand3  g082(.a(x5), .b(x3), .c(x2), .O(new_n198_));
  xor2a  g083(.a(x3), .b(x2), .O(new_n199_));
  nand4  g084(.a(new_n199_), .b(x7), .c(x6), .d(x5), .O(new_n200_));
  oai21  g085(.a(new_n200_), .b(new_n129_), .c(new_n130_), .O(new_n201_));
  nand2  g086(.a(new_n201_), .b(new_n75_), .O(new_n202_));
  nand3  g087(.a(new_n202_), .b(new_n198_), .c(new_n197_), .O(new_n203_));
  nand2  g088(.a(new_n203_), .b(new_n87_), .O(new_n204_));
  oai21  g089(.a(new_n85_), .b(new_n76_), .c(x5), .O(new_n205_));
  oai21  g090(.a(x6), .b(x0), .c(new_n84_), .O(new_n206_));
  nand2  g091(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand3  g092(.a(x7), .b(x3), .c(x1), .O(new_n208_));
  aoi21  g093(.a(new_n208_), .b(new_n75_), .c(new_n129_), .O(new_n209_));
  aoi21  g094(.a(new_n207_), .b(new_n75_), .c(new_n209_), .O(new_n210_));
  nand3  g095(.a(new_n210_), .b(new_n204_), .c(new_n196_), .O(z54));
  zero   g096(.O(z00));
  zero   g097(.O(z01));
  zero   g098(.O(z04));
  zero   g099(.O(z05));
