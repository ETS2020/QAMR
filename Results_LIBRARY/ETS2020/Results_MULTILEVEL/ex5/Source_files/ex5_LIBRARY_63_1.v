...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n107_, new_n109_, new_n110_, new_n111_, new_n123_, new_n124_,
  ...
  nand4  g026(.a(x3), .b(new_n85_), .c(x1), .d(x0), .O(new_n109_));
  inv1   g027(.a(new_n109_), .O(new_n110_));
  nand4  g028(.a(new_n110_), .b(x6), .c(x5), .d(new_n75_), .O(new_n111_));
  nor2   g029(.a(new_n111_), .b(new_n84_), .O(z16));
