...
module FAU ( 
  ...
  nor2   g054(.a(x3), .b(x1), .O(new_n151_));
  nand2  g055(.a(new_n151_), .b(new_n128_), .O(new_n152_));
  aoi21  g056(.a(new_n152_), .b(new_n150_), .c(new_n85_), .O(new_n153_));
  inv1   g057(.a(new_n153_), .O(new_n154_));
  aoi21  g058(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n155_));
  oai21  g059(.a(new_n155_), .b(new_n128_), .c(x1), .O(new_n156_));
  nand2  g060(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  aoi21  g061(.a(new_n149_), .b(new_n85_), .c(new_n157_), .O(new_n158_));
  nand2  g062(.a(new_n158_), .b(new_n143_), .O(z32));
  nor2   g063(.a(x5), .b(new_n86_), .O(new_n165_));
  nand2  g064(.a(new_n145_), .b(new_n144_), .O(new_n166_));
  aoi21  g065(.a(new_n166_), .b(x4), .c(new_n165_), .O(new_n167_));
  oai21  g066(.a(new_n167_), .b(x2), .c(new_n156_), .O(new_n168_));
  nor2   g067(.a(new_n168_), .b(new_n153_), .O(new_n169_));
  nand2  g068(.a(new_n169_), .b(new_n143_), .O(z38));
  oai21  g069(.a(new_n84_), .b(new_n74_), .c(x0), .O(new_n180_));
  nand2  g070(.a(new_n180_), .b(x1), .O(new_n181_));
  aoi21  g071(.a(new_n83_), .b(x3), .c(new_n151_), .O(new_n182_));
  nor2   g072(.a(new_n182_), .b(x0), .O(new_n183_));
  nand2  g073(.a(x5), .b(x3), .O(new_n184_));
  oai22  g074(.a(new_n184_), .b(x1), .c(x3), .d(new_n128_), .O(new_n185_));
  oai21  g075(.a(new_n185_), .b(new_n183_), .c(x2), .O(new_n186_));
  nand3  g076(.a(x7), .b(x6), .c(x5), .O(new_n187_));
  inv1   g077(.a(new_n187_), .O(new_n188_));
  nand4  g078(.a(new_n188_), .b(new_n75_), .c(x3), .d(new_n86_), .O(new_n189_));
  aoi21  g079(.a(new_n189_), .b(x3), .c(new_n128_), .O(new_n190_));
  oai21  g080(.a(new_n190_), .b(new_n151_), .c(new_n85_), .O(new_n191_));
  aoi21  g081(.a(new_n129_), .b(new_n75_), .c(new_n128_), .O(new_n192_));
  oai21  g082(.a(new_n84_), .b(new_n76_), .c(x5), .O(new_n193_));
  oai21  g083(.a(new_n76_), .b(x5), .c(new_n193_), .O(new_n194_));
  aoi21  g084(.a(new_n194_), .b(new_n75_), .c(new_n192_), .O(new_n195_));
  nand4  g085(.a(new_n195_), .b(new_n191_), .c(new_n186_), .d(new_n181_), .O(z48));
  zero   g086(.O(z00));
  zero   g087(.O(z01));
  zero   g088(.O(z03));
  zero   g089(.O(z04));
