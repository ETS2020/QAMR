...
module FAU ( 
  ...
  nand4  g032(.a(new_n128_), .b(new_n86_), .c(new_n87_), .d(x0), .O(new_n129_));
  oai21  g033(.a(new_n86_), .b(new_n87_), .c(x7), .O(new_n130_));
  nand3  g034(.a(new_n130_), .b(x6), .c(x3), .O(new_n131_));
  nand2  g035(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g036(.a(new_n132_), .b(new_n85_), .O(new_n133_));
  oai21  g037(.a(new_n76_), .b(new_n124_), .c(new_n85_), .O(new_n134_));
  nor2   g038(.a(new_n81_), .b(new_n85_), .O(new_n135_));
  aoi21  g039(.a(new_n134_), .b(new_n81_), .c(new_n135_), .O(new_n136_));
  nand3  g040(.a(new_n136_), .b(new_n133_), .c(new_n126_), .O(new_n137_));
  nand2  g041(.a(new_n137_), .b(new_n75_), .O(new_n138_));
  oai21  g042(.a(x3), .b(new_n87_), .c(new_n124_), .O(new_n139_));
  nand2  g043(.a(new_n74_), .b(x1), .O(new_n140_));
  nand3  g044(.a(new_n85_), .b(new_n87_), .c(x0), .O(new_n141_));
  nand3  g045(.a(new_n141_), .b(new_n140_), .c(new_n139_), .O(new_n142_));
  nand2  g046(.a(new_n142_), .b(x4), .O(new_n143_));
  oai21  g047(.a(x5), .b(new_n87_), .c(new_n143_), .O(new_n144_));
  oai21  g048(.a(new_n74_), .b(new_n87_), .c(x0), .O(new_n145_));
  nand3  g049(.a(new_n74_), .b(new_n87_), .c(new_n124_), .O(new_n146_));
  aoi21  g050(.a(new_n146_), .b(new_n145_), .c(new_n86_), .O(new_n147_));
  inv1   g051(.a(new_n147_), .O(new_n148_));
  aoi21  g052(.a(x6), .b(new_n75_), .c(new_n74_), .O(new_n149_));
  oai21  g053(.a(new_n149_), .b(new_n124_), .c(x1), .O(new_n150_));
  nand2  g054(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g055(.a(new_n144_), .b(new_n86_), .c(new_n151_), .O(new_n152_));
  nand2  g056(.a(new_n152_), .b(new_n138_), .O(z32));
  nor2   g057(.a(x5), .b(new_n87_), .O(new_n159_));
  nand2  g058(.a(new_n140_), .b(new_n139_), .O(new_n160_));
  aoi21  g059(.a(new_n160_), .b(x4), .c(new_n159_), .O(new_n161_));
  oai21  g060(.a(new_n161_), .b(x2), .c(new_n150_), .O(new_n162_));
  nor2   g061(.a(new_n162_), .b(new_n147_), .O(new_n163_));
  nand2  g062(.a(new_n163_), .b(new_n138_), .O(z38));
  zero   g063(.O(z00));
  zero   g064(.O(z01));
  zero   g065(.O(z03));
  zero   g066(.O(z04));
