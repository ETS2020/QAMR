// Benchmark "FAU" written by ABC on Sat Jul 25 01:40:32 2020
...
module FAU ( 
  ...
  nand3  g034(.a(new_n95_), .b(new_n77_), .c(x2), .O(new_n106_));
  inv1   g035(.a(new_n106_), .O(new_n107_));
  nand4  g036(.a(new_n107_), .b(x7), .c(x6), .d(x5), .O(new_n108_));
  inv1   g037(.a(new_n108_), .O(z10));
  nand3  g038(.a(new_n99_), .b(new_n76_), .c(new_n93_), .O(new_n110_));
  inv1   g039(.a(new_n110_), .O(new_n111_));
  nand4  g040(.a(new_n111_), .b(x6), .c(x5), .d(new_n77_), .O(new_n112_));
  nor2   g041(.a(new_n112_), .b(new_n86_), .O(z11));
  nor2   g042(.a(x1), .b(new_n98_), .O(new_n114_));
  nand3  g043(.a(new_n114_), .b(new_n76_), .c(x2), .O(new_n115_));
  inv1   g044(.a(new_n115_), .O(new_n116_));
  nand4  g045(.a(new_n116_), .b(x6), .c(x5), .d(new_n77_), .O(new_n117_));
  nor2   g046(.a(new_n117_), .b(new_n86_), .O(z12));
  nand3  g047(.a(new_n95_), .b(x3), .c(new_n93_), .O(new_n119_));
  inv1   g048(.a(new_n119_), .O(new_n120_));
  nand4  g049(.a(new_n120_), .b(x6), .c(x5), .d(new_n77_), .O(new_n121_));
  nor2   g050(.a(new_n121_), .b(new_n86_), .O(z13));
  nand2  g051(.a(new_n114_), .b(new_n93_), .O(new_n123_));
  inv1   g052(.a(new_n123_), .O(new_n124_));
  nand3  g053(.a(new_n124_), .b(new_n77_), .c(x3), .O(new_n125_));
  nor4   g054(.a(new_n125_), .b(new_n86_), .c(new_n78_), .d(new_n81_), .O(z14));
  nand3  g055(.a(new_n95_), .b(x3), .c(x2), .O(new_n127_));
  inv1   g056(.a(new_n127_), .O(new_n128_));
  nand4  g057(.a(new_n128_), .b(x6), .c(x5), .d(new_n77_), .O(new_n129_));
  nor2   g058(.a(new_n129_), .b(new_n86_), .O(z15));
  nand3  g059(.a(new_n99_), .b(x3), .c(new_n93_), .O(new_n131_));
  inv1   g060(.a(new_n131_), .O(new_n132_));
  nand4  g061(.a(new_n132_), .b(x6), .c(x5), .d(new_n77_), .O(new_n133_));
  nor2   g062(.a(new_n133_), .b(new_n86_), .O(z16));
  nor3   g063(.a(new_n123_), .b(x5), .c(new_n77_), .O(z17));
  nor3   g064(.a(new_n91_), .b(x5), .c(new_n77_), .O(z18));
  nand3  g065(.a(new_n90_), .b(new_n76_), .c(new_n93_), .O(new_n137_));
  nor2   g066(.a(new_n137_), .b(new_n77_), .O(z19));
  nand2  g067(.a(new_n124_), .b(new_n76_), .O(new_n139_));
  inv1   g068(.a(new_n139_), .O(new_n140_));
  nand4  g069(.a(new_n140_), .b(new_n78_), .c(new_n81_), .d(new_n77_), .O(new_n141_));
  inv1   g070(.a(new_n141_), .O(z20));
  inv1   g071(.a(new_n125_), .O(new_n143_));
  nand3  g072(.a(new_n143_), .b(new_n78_), .c(new_n81_), .O(new_n144_));
  ...
  nand3  g078(.a(new_n90_), .b(x3), .c(new_n93_), .O(new_n150_));
  nor2   g079(.a(new_n150_), .b(new_n81_), .O(z23));
  inv1   g080(.a(new_n137_), .O(new_n152_));
  nand3  g081(.a(new_n152_), .b(new_n81_), .c(new_n77_), .O(new_n153_));
  nor3   g082(.a(new_n153_), .b(x7), .c(new_n78_), .O(z24));
  nor4   g083(.a(new_n96_), .b(x7), .c(new_n78_), .d(x5), .O(z25));
  nor3   g084(.a(x3), .b(new_n93_), .c(new_n98_), .O(new_n156_));
  nand4  g085(.a(new_n156_), .b(x6), .c(new_n81_), .d(new_n77_), .O(new_n157_));
  nor2   g086(.a(new_n157_), .b(new_n86_), .O(z26));
  nand3  g087(.a(new_n114_), .b(x3), .c(x2), .O(new_n160_));
  ...
  nor3   g091(.a(new_n153_), .b(new_n86_), .c(x6), .O(z29));
  ...
  nand3  g143(.a(new_n192_), .b(new_n114_), .c(new_n76_), .O(new_n216_));
  ...
  nor2   g321(.a(new_n114_), .b(new_n77_), .O(new_n394_));
  ...
  nand4  g496(.a(new_n114_), .b(new_n78_), .c(x3), .d(new_n93_), .O(new_n569_));
  ...
  nand2  g520(.a(new_n226_), .b(new_n114_), .O(new_n593_));
  ...
  nand3  g622(.a(new_n277_), .b(new_n114_), .c(new_n93_), .O(new_n695_));
  ...
  nand2  g637(.a(new_n348_), .b(new_n114_), .O(new_n710_));
