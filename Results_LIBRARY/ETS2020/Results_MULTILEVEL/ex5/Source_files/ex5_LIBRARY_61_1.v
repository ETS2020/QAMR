// Benchmark "FAU" written by ABC on Sat Jul 25 01:40:09 2020
...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n107_, new_n120_, new_n121_, new_n122_, new_n124_, new_n125_,
    new_n126_, new_n131_, new_n132_, new_n133_, new_n134_, new_n135_,
    new_n136_, new_n137_, new_n138_, new_n139_, new_n140_, new_n141_,
    new_n142_, new_n143_, new_n144_, new_n145_, new_n146_, new_n147_,
    new_n148_, new_n149_, new_n150_, new_n151_, new_n152_, new_n153_,
    new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    new_n166_, new_n167_, new_n168_, new_n169_, new_n170_, new_n193_,
  ...
  nand4  g031(.a(x3), .b(x2), .c(new_n86_), .d(x0), .O(new_n124_));
  inv1   g032(.a(new_n124_), .O(new_n125_));
  nand4  g033(.a(new_n125_), .b(x6), .c(new_n83_), .d(new_n75_), .O(new_n126_));
  nor2   g034(.a(new_n126_), .b(new_n84_), .O(z28));
  ...
  nand3  g057(.a(new_n74_), .b(new_n86_), .c(new_n131_), .O(new_n153_));
  ...
  nand3  g071(.a(x3), .b(new_n85_), .c(new_n86_), .O(new_n193_));
  nand2  g072(.a(new_n193_), .b(new_n147_), .O(new_n194_));
  aoi21  g073(.a(new_n194_), .b(x0), .c(new_n84_), .O(new_n195_));
  nand3  g074(.a(new_n195_), .b(x6), .c(x5), .O(new_n196_));
  nand2  g075(.a(new_n196_), .b(new_n75_), .O(new_n197_));
  xnor2a g076(.a(x3), .b(x0), .O(new_n198_));
  nand2  g077(.a(new_n198_), .b(x2), .O(new_n199_));
  oai21  g078(.a(new_n75_), .b(x2), .c(new_n131_), .O(new_n200_));
  nand2  g079(.a(new_n200_), .b(new_n74_), .O(new_n201_));
  nor2   g080(.a(new_n75_), .b(new_n131_), .O(new_n202_));
  aoi21  g081(.a(x5), .b(new_n74_), .c(x0), .O(new_n203_));
  oai21  g082(.a(new_n203_), .b(new_n202_), .c(new_n85_), .O(new_n204_));
  nand3  g083(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  nand2  g084(.a(new_n205_), .b(new_n86_), .O(new_n206_));
  nand3  g085(.a(x4), .b(x3), .c(x2), .O(new_n207_));
  aoi21  g086(.a(new_n207_), .b(new_n86_), .c(x0), .O(new_n208_));
  nand2  g087(.a(x7), .b(x0), .O(new_n209_));
  aoi21  g088(.a(new_n209_), .b(new_n75_), .c(new_n74_), .O(new_n210_));
  aoi21  g089(.a(new_n210_), .b(x1), .c(new_n208_), .O(new_n211_));
  nand3  g090(.a(new_n211_), .b(new_n206_), .c(new_n197_), .O(z60));
  zero   g091(.O(z00));
  zero   g092(.O(z01));
  zero   g093(.O(z03));
  zero   g094(.O(z04));
