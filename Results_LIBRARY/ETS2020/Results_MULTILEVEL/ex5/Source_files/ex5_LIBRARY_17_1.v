...
module FAU ( 
  ...
  wire new_n74_, new_n75_, new_n76_, new_n77_, new_n83_, new_n84_, new_n85_,
    ...
    new_n179_, new_n185_, new_n186_, new_n187_;
  ...
  and2   g042(.a(x7), .b(x5), .O(new_n139_));
  ...
  nand2  g052(.a(new_n148_), .b(new_n85_), .O(new_n149_));
  ...
  nand4  g058(.a(new_n154_), .b(new_n152_), .c(new_n149_), .d(new_n142_), .O(z32));
  nand3  g059(.a(new_n83_), .b(x3), .c(x1), .O(new_n156_));
  nand4  g060(.a(new_n139_), .b(new_n74_), .c(new_n86_), .d(x0), .O(new_n157_));
  aoi21  g061(.a(new_n157_), .b(new_n156_), .c(new_n85_), .O(new_n158_));
  nand2  g062(.a(x5), .b(new_n74_), .O(new_n159_));
  nand4  g063(.a(new_n159_), .b(x7), .c(new_n85_), .d(new_n86_), .O(new_n160_));
  aoi21  g064(.a(new_n160_), .b(x7), .c(new_n128_), .O(new_n161_));
  oai21  g065(.a(new_n161_), .b(new_n158_), .c(x6), .O(new_n162_));
  oai21  g066(.a(x5), .b(x0), .c(new_n76_), .O(new_n163_));
  nand2  g067(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g068(.a(new_n164_), .b(new_n75_), .O(new_n165_));
  nand2  g069(.a(new_n74_), .b(new_n85_), .O(new_n166_));
  nand2  g070(.a(new_n166_), .b(new_n75_), .O(new_n167_));
  nand2  g071(.a(new_n167_), .b(x0), .O(new_n168_));
  oai21  g072(.a(new_n74_), .b(x2), .c(x0), .O(new_n169_));
  nand2  g073(.a(new_n169_), .b(x1), .O(new_n170_));
  nand2  g074(.a(new_n74_), .b(x2), .O(new_n171_));
  nand3  g075(.a(x5), .b(x3), .c(new_n85_), .O(new_n172_));
  aoi21  g076(.a(new_n172_), .b(new_n171_), .c(x0), .O(new_n173_));
  nand3  g077(.a(x5), .b(x3), .c(x2), .O(new_n174_));
  nand2  g078(.a(new_n174_), .b(new_n166_), .O(new_n175_));
  oai21  g079(.a(new_n175_), .b(new_n173_), .c(new_n86_), .O(new_n176_));
  nand3  g080(.a(new_n83_), .b(x3), .c(new_n128_), .O(new_n177_));
  nand4  g081(.a(new_n177_), .b(new_n176_), .c(new_n170_), .d(new_n168_), .O(new_n178_));
  inv1   g082(.a(new_n178_), .O(new_n179_));
  nand2  g083(.a(new_n179_), .b(new_n165_), .O(z33));
  nor2   g084(.a(x5), .b(new_n86_), .O(new_n185_));
  aoi21  g085(.a(new_n144_), .b(new_n143_), .c(new_n75_), .O(new_n186_));
  oai21  g086(.a(new_n186_), .b(new_n185_), .c(new_n85_), .O(new_n187_));
  nand4  g087(.a(new_n187_), .b(new_n154_), .c(new_n152_), .d(new_n142_), .O(z38));
  zero   g088(.O(z00));
  zero   g089(.O(z01));
  zero   g090(.O(z03));
  zero   g091(.O(z04));
