// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:30 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n74_, new_n79_, new_n81_, new_n83_, new_n86_, new_n88_, new_n89_;
  ...
  nand2  g37(.a(x22), .b(x17), .O(new_n81_));
  nor2   g38(.a(new_n81_), .b(x24), .O(z11));
  nand2  g39(.a(x23), .b(x14), .O(new_n83_));
  nor2   g40(.a(new_n83_), .b(x24), .O(z12));
