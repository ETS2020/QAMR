...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n81_, new_n84_, new_n87_, new_n89_, new_n90_;
  ...
  nand2  g34(.a(x22), .b(x14), .O(new_n81_));
  nor2   g35(.a(new_n81_), .b(x24), .O(z10));
  nand2  g36(.a(x23), .b(x14), .O(new_n84_));
  nor2   g37(.a(new_n84_), .b(x24), .O(z12));
  inv1   g38(.a(x16), .O(new_n87_));
  nor2   g39(.a(x24), .b(new_n87_), .O(z14));
  nor2   g40(.a(x15), .b(x14), .O(new_n89_));
  nor2   g41(.a(x13), .b(x12), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g43(.O(z00));
  zero   g44(.O(z03));
  zero   g45(.O(z04));
  zero   g46(.O(z07));
