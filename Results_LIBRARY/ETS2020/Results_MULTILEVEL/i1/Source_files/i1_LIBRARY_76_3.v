...
module FAU ( 
  ...
  nor3   g37(.a(x24), .b(new_n80_), .c(new_n79_), .O(z10));
  inv1   g38(.a(x17), .O(new_n82_));
  nor3   g39(.a(x24), .b(new_n80_), .c(new_n82_), .O(z11));
  inv1   g40(.a(x23), .O(new_n84_));
  nor3   g41(.a(x24), .b(new_n84_), .c(new_n79_), .O(z12));
  nor3   g42(.a(x24), .b(new_n84_), .c(new_n82_), .O(z13));
  inv1   g43(.a(x16), .O(new_n87_));
  nor2   g44(.a(x24), .b(new_n87_), .O(z14));
  nor2   g45(.a(x15), .b(x14), .O(new_n89_));
  nor2   g46(.a(x13), .b(x12), .O(new_n90_));
  nand2  g47(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g48(.O(z03));
  zero   g49(.O(z09));
  buf    g50(.a(x00), .O(z00));
  buf    g51(.a(x11), .O(z08));
