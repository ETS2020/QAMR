// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:21 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n79_, new_n82_, new_n85_, new_n87_, new_n88_;
  ...
  nand2  g35(.a(x22), .b(x14), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(x24), .O(z10));
  nand2  g37(.a(x23), .b(x14), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(x24), .O(z12));
  inv1   g39(.a(x16), .O(new_n85_));
  nor2   g40(.a(x24), .b(new_n85_), .O(z14));
  nor2   g41(.a(x15), .b(x14), .O(new_n87_));
  nor2   g42(.a(x13), .b(x12), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(z15));
  zero   g44(.O(z00));
  zero   g45(.O(z04));
  zero   g46(.O(z11));
  zero   g47(.O(z13));
