...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n81_, new_n85_, new_n87_, new_n89_, new_n90_;
  ...
  nand4  g26(.a(new_n62_), .b(x19), .c(new_n63_), .d(new_n49_), .O(new_n70_));
  oai21  g27(.a(new_n70_), .b(new_n60_), .c(new_n69_), .O(z05));
  nand3  g28(.a(new_n57_), .b(new_n47_), .c(new_n55_), .O(new_n72_));
  inv1   g29(.a(new_n72_), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n74_));
  inv1   g31(.a(x00), .O(new_n75_));
  nor2   g32(.a(new_n58_), .b(new_n75_), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(new_n74_), .c(new_n43_), .O(z06));
  and2   g34(.a(x24), .b(x18), .O(z07));
  and2   g35(.a(x24), .b(x11), .O(z09));
  nand2  g36(.a(x22), .b(x14), .O(new_n81_));
  nor2   g37(.a(new_n81_), .b(x24), .O(z10));
  nand2  g38(.a(x23), .b(x17), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(x24), .O(z13));
  inv1   g40(.a(x16), .O(new_n87_));
  nor2   g41(.a(x24), .b(new_n87_), .O(z14));
  nor2   g42(.a(x15), .b(x14), .O(new_n89_));
  nor2   g43(.a(x13), .b(x12), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g45(.O(z00));
  zero   g46(.O(z03));
  zero   g47(.O(z08));
  zero   g48(.O(z11));
