...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n80_, new_n82_, new_n84_, new_n88_, new_n89_;
  ...
  nand2  g35(.a(x22), .b(x14), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(x24), .O(z10));
  nand2  g37(.a(x22), .b(x17), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(x24), .O(z11));
  nand2  g39(.a(x23), .b(x14), .O(new_n84_));
  nor2   g40(.a(new_n84_), .b(x24), .O(z12));
  nor2   g41(.a(x15), .b(x14), .O(new_n88_));
  nor2   g42(.a(x13), .b(x12), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n88_), .O(z15));
  zero   g44(.O(z00));
  zero   g45(.O(z04));
  zero   g46(.O(z08));
  zero   g47(.O(z13));
