...
module FAU ( 
  ...
  nand4  g25(.a(new_n61_), .b(x19), .c(new_n62_), .d(new_n48_), .O(new_n69_));
  oai21  g26(.a(new_n69_), .b(new_n59_), .c(new_n68_), .O(z05));
  nand3  g27(.a(new_n56_), .b(new_n46_), .c(new_n54_), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n73_));
  inv1   g30(.a(x00), .O(new_n74_));
  nor2   g31(.a(new_n57_), .b(new_n74_), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n73_), .c(new_n42_), .O(z06));
  and2   g33(.a(x24), .b(x18), .O(z07));
  and2   g34(.a(x24), .b(x11), .O(z09));
  nand2  g35(.a(x23), .b(x17), .O(new_n82_));
  nor2   g36(.a(new_n82_), .b(x24), .O(z13));
  nor2   g37(.a(x15), .b(x14), .O(new_n85_));
  nor2   g38(.a(x13), .b(x12), .O(new_n86_));
