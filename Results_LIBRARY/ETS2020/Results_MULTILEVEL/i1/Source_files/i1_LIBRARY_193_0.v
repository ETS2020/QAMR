// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:24 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n79_, new_n81_, new_n83_, new_n86_;
  ...
  nand2  g36(.a(x22), .b(x17), .O(new_n81_));
  nor2   g37(.a(new_n81_), .b(x24), .O(z11));
