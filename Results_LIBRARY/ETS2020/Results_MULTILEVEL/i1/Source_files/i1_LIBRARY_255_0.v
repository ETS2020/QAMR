// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:42 2020
...
module FAU ( 
  ...
  inv1   g34(.a(x14), .O(new_n78_));
  inv1   g35(.a(x22), .O(new_n79_));
  nor3   g36(.a(x24), .b(new_n79_), .c(new_n78_), .O(z10));
  inv1   g37(.a(x17), .O(new_n81_));
  nor3   g38(.a(x24), .b(new_n79_), .c(new_n81_), .O(z11));
  inv1   g39(.a(x23), .O(new_n83_));
  nor3   g40(.a(x24), .b(new_n83_), .c(new_n78_), .O(z12));
  nor3   g41(.a(x24), .b(new_n83_), .c(new_n81_), .O(z13));
  zero   g42(.O(z04));
  zero   g43(.O(z07));
  zero   g44(.O(z14));
  zero   g45(.O(z15));
