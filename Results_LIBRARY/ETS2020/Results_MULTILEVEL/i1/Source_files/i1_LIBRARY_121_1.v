// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:03 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n75_, new_n82_, new_n85_, new_n86_;
  ...
  nand2  g36(.a(x23), .b(x17), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(x24), .O(z13));
  nor2   g38(.a(x15), .b(x14), .O(new_n85_));
  nor2   g39(.a(x13), .b(x12), .O(new_n86_));
