...
module FAU ( 
  ...
  nand2  g33(.a(x22), .b(x14), .O(new_n80_));
  nor2   g34(.a(new_n80_), .b(x24), .O(z10));
  nand2  g35(.a(x23), .b(x14), .O(new_n83_));
  nor2   g36(.a(new_n83_), .b(x24), .O(z12));
  nand2  g37(.a(x23), .b(x17), .O(new_n85_));
  nor2   g38(.a(new_n85_), .b(x24), .O(z13));
  inv1   g39(.a(x16), .O(new_n87_));
  nor2   g40(.a(x24), .b(new_n87_), .O(z14));
  nor2   g41(.a(x15), .b(x14), .O(new_n89_));
  nor2   g42(.a(x13), .b(x12), .O(new_n90_));
  nand2  g43(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g44(.O(z00));
  zero   g45(.O(z04));
  zero   g46(.O(z07));
  zero   g47(.O(z08));
