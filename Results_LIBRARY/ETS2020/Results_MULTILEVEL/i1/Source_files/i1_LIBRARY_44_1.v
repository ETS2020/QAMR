// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:33 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n80_, new_n82_, new_n84_, new_n86_;
  ...
  nand2  g34(.a(x22), .b(x17), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(x24), .O(z11));
  nand2  g36(.a(x23), .b(x14), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(x24), .O(z12));
  nand2  g38(.a(x23), .b(x17), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(x24), .O(z13));
  inv1   g40(.a(x16), .O(new_n86_));
  nor2   g41(.a(x24), .b(new_n86_), .O(z14));
  zero   g42(.O(z00));
  zero   g43(.O(z04));
  zero   g44(.O(z09));
  zero   g45(.O(z10));
