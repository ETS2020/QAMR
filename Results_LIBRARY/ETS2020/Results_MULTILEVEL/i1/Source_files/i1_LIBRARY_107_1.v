...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n78_, new_n80_,
  ...
  nand4  g20(.a(new_n57_), .b(x19), .c(new_n58_), .d(new_n51_), .O(new_n64_));
  oai21  g21(.a(new_n64_), .b(new_n55_), .c(new_n63_), .O(z05));
  inv1   g22(.a(x05), .O(new_n66_));
  inv1   g23(.a(x06), .O(new_n67_));
  nand4  g24(.a(new_n51_), .b(new_n67_), .c(new_n66_), .d(new_n54_), .O(new_n68_));
  inv1   g25(.a(new_n68_), .O(new_n69_));
  nand4  g26(.a(new_n69_), .b(new_n53_), .c(new_n52_), .d(new_n45_), .O(new_n70_));
  inv1   g27(.a(x00), .O(new_n71_));
  nor2   g28(.a(new_n49_), .b(new_n71_), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(new_n70_), .c(new_n44_), .O(z06));
  and2   g30(.a(x24), .b(x18), .O(z07));
  nand2  g31(.a(x23), .b(x14), .O(new_n78_));
  nor2   g32(.a(new_n78_), .b(x24), .O(z12));
  nand2  g33(.a(x23), .b(x17), .O(new_n80_));
  nor2   g34(.a(new_n80_), .b(x24), .O(z13));
  inv1   g35(.a(x16), .O(new_n82_));
  nor2   g36(.a(x24), .b(new_n82_), .O(z14));
  nor2   g37(.a(x15), .b(x14), .O(new_n84_));
  nor2   g38(.a(x13), .b(x12), .O(new_n85_));
