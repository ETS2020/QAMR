...
module FAU ( 
  ...
  nor3   g35(.a(x24), .b(new_n80_), .c(new_n79_), .O(z10));
  inv1   g36(.a(x17), .O(new_n82_));
  nor3   g37(.a(x24), .b(new_n80_), .c(new_n82_), .O(z11));
  inv1   g38(.a(x23), .O(new_n84_));
  nor3   g39(.a(x24), .b(new_n84_), .c(new_n79_), .O(z12));
  nor3   g40(.a(x24), .b(new_n84_), .c(new_n82_), .O(z13));
