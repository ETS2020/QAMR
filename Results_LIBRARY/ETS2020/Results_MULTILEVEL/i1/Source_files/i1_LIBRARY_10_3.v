...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n75_, new_n80_, new_n82_, new_n84_, new_n87_, new_n88_;
  ...
  nand2  g36(.a(x22), .b(x17), .O(new_n80_));
  nor2   g37(.a(new_n80_), .b(x24), .O(z11));
  nand2  g38(.a(x23), .b(x14), .O(new_n82_));
  nor2   g39(.a(new_n82_), .b(x24), .O(z12));
