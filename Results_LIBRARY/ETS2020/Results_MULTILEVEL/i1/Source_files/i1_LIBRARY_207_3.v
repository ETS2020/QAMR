...
module FAU ( 
  ...
  inv1   g35(.a(x14), .O(new_n78_));
  inv1   g36(.a(x22), .O(new_n79_));
  nor3   g37(.a(x24), .b(new_n79_), .c(new_n78_), .O(z10));
  inv1   g38(.a(x17), .O(new_n81_));
  nor3   g39(.a(x24), .b(new_n79_), .c(new_n81_), .O(z11));
  inv1   g40(.a(x23), .O(new_n83_));
  nor3   g41(.a(x24), .b(new_n83_), .c(new_n78_), .O(z12));
  nor3   g42(.a(x24), .b(new_n83_), .c(new_n81_), .O(z13));
  inv1   g43(.a(x16), .O(new_n86_));
  nor2   g44(.a(x24), .b(new_n86_), .O(z14));
  nor2   g45(.a(x15), .b(x14), .O(new_n88_));
  nor2   g46(.a(x13), .b(x12), .O(new_n89_));
  nand2  g47(.a(new_n89_), .b(new_n88_), .O(z15));
  zero   g48(.O(z09));
  buf    g49(.a(x00), .O(z00));
  buf    g50(.a(x20), .O(z03));
  buf    g51(.a(x11), .O(z08));
