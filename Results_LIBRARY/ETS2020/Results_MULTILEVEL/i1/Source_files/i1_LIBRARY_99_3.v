...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n75_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n89_;
  ...
  nand2  g35(.a(x22), .b(x17), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(x24), .O(z11));
  nand2  g37(.a(x23), .b(x14), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(x24), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n84_));
  nor2   g40(.a(new_n84_), .b(x24), .O(z13));
  inv1   g41(.a(x16), .O(new_n86_));
  nor2   g42(.a(x24), .b(new_n86_), .O(z14));
  nor2   g43(.a(x15), .b(x14), .O(new_n88_));
  nor2   g44(.a(x13), .b(x12), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n88_), .O(z15));
  zero   g46(.O(z03));
  zero   g47(.O(z09));
  zero   g48(.O(z10));
  buf    g49(.a(x00), .O(z00));
