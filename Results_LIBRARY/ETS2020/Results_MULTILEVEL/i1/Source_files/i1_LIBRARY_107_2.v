...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    new_n49_, new_n50_, new_n51_, new_n52_, new_n62_, new_n64_, new_n67_,
    new_n70_, new_n71_;
  ...
  nand2  g17(.a(x22), .b(x17), .O(new_n64_));
  nor2   g18(.a(new_n64_), .b(x24), .O(z11));
  nand2  g19(.a(x23), .b(x17), .O(new_n67_));
  nor2   g20(.a(new_n67_), .b(x24), .O(z13));
