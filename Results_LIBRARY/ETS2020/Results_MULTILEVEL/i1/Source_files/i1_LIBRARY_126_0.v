// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:04 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n79_, new_n80_, new_n82_, new_n84_;
  ...
  nor3   g36(.a(x24), .b(new_n80_), .c(new_n79_), .O(z10));
  inv1   g37(.a(x17), .O(new_n82_));
  nor3   g38(.a(x24), .b(new_n80_), .c(new_n82_), .O(z11));
  inv1   g39(.a(x23), .O(new_n84_));
  nor3   g40(.a(x24), .b(new_n84_), .c(new_n79_), .O(z12));
  nor3   g41(.a(x24), .b(new_n84_), .c(new_n82_), .O(z13));
  zero   g42(.O(z00));
  zero   g43(.O(z04));
  zero   g44(.O(z07));
  zero   g45(.O(z14));
