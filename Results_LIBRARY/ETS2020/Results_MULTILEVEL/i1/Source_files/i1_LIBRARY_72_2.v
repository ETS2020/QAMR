...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    new_n49_, new_n50_, new_n51_, new_n52_, new_n61_, new_n64_, new_n67_,
    new_n69_, new_n70_;
  ...
  nand2  g15(.a(x22), .b(x14), .O(new_n61_));
  nor2   g16(.a(new_n61_), .b(x24), .O(z10));
  nand2  g17(.a(x23), .b(x14), .O(new_n64_));
  nor2   g18(.a(new_n64_), .b(x24), .O(z12));
  inv1   g19(.a(x16), .O(new_n67_));
  nor2   g20(.a(x24), .b(new_n67_), .O(z14));
  nor2   g21(.a(x15), .b(x14), .O(new_n69_));
  nor2   g22(.a(x13), .b(x12), .O(new_n70_));
  nand2  g23(.a(new_n70_), .b(new_n69_), .O(z15));
  zero   g24(.O(z02));
  zero   g25(.O(z03));
  zero   g26(.O(z05));
  zero   g27(.O(z06));
