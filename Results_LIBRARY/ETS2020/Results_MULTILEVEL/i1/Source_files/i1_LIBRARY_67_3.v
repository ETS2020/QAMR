// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:43 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n71_, new_n72_, new_n73_, new_n74_,
    new_n75_, new_n80_, new_n82_, new_n84_, new_n87_, new_n89_, new_n90_;
  ...
  nand4  g26(.a(new_n61_), .b(x19), .c(new_n62_), .d(new_n48_), .O(new_n69_));
  oai21  g27(.a(new_n69_), .b(new_n59_), .c(new_n68_), .O(z05));
  nand3  g28(.a(new_n56_), .b(new_n46_), .c(new_n54_), .O(new_n71_));
  inv1   g29(.a(new_n71_), .O(new_n72_));
  nand4  g30(.a(new_n72_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n73_));
  inv1   g31(.a(x00), .O(new_n74_));
  nor2   g32(.a(new_n57_), .b(new_n74_), .O(new_n75_));
  aoi21  g33(.a(new_n75_), .b(new_n73_), .c(new_n42_), .O(z06));
  and2   g34(.a(x24), .b(x18), .O(z07));
  and2   g35(.a(x24), .b(x11), .O(z09));
  nand2  g36(.a(x22), .b(x14), .O(new_n80_));
  nor2   g37(.a(new_n80_), .b(x24), .O(z10));
  nand2  g38(.a(x22), .b(x17), .O(new_n82_));
  nor2   g39(.a(new_n82_), .b(x24), .O(z11));
  nand2  g40(.a(x23), .b(x14), .O(new_n84_));
  nor2   g41(.a(new_n84_), .b(x24), .O(z12));
  inv1   g42(.a(x16), .O(new_n87_));
  nor2   g43(.a(x24), .b(new_n87_), .O(z14));
  nor2   g44(.a(x15), .b(x14), .O(new_n89_));
  nor2   g45(.a(x13), .b(x12), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g47(.O(z03));
  zero   g48(.O(z08));
  zero   g49(.O(z13));
  buf    g50(.a(x00), .O(z00));
