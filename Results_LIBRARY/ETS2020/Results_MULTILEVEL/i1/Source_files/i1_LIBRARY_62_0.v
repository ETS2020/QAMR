// Benchmark "FAU" written by ABC on Fri Jul 24 17:35:41 2020
...
module FAU ( 
  ...
  nand2  g34(.a(x22), .b(x14), .O(new_n79_));
  nor2   g35(.a(new_n79_), .b(x24), .O(z10));
  nand2  g36(.a(x23), .b(x14), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(x24), .O(z12));
  inv1   g38(.a(x16), .O(new_n85_));
  nor2   g39(.a(x24), .b(new_n85_), .O(z14));
  nor2   g40(.a(x15), .b(x14), .O(new_n87_));
  nor2   g41(.a(x13), .b(x12), .O(new_n88_));
