// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:31 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n80_, new_n83_, new_n85_, new_n87_, new_n89_, new_n90_;
  ...
  nand2  g37(.a(x23), .b(x14), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(x24), .O(z12));
  nand2  g39(.a(x23), .b(x17), .O(new_n85_));
  nor2   g40(.a(new_n85_), .b(x24), .O(z13));
  inv1   g41(.a(x16), .O(new_n87_));
  nor2   g42(.a(x24), .b(new_n87_), .O(z14));
  nor2   g43(.a(x15), .b(x14), .O(new_n89_));
  nor2   g44(.a(x13), .b(x12), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n89_), .O(z15));
  zero   g46(.O(z00));
  zero   g47(.O(z08));
  zero   g48(.O(z09));
  zero   g49(.O(z11));
