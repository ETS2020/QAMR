...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n75_, new_n80_, new_n83_, new_n85_, new_n88_, new_n89_;
  ...
  nand2  g38(.a(x23), .b(x14), .O(new_n83_));
  nor2   g39(.a(new_n83_), .b(x24), .O(z12));
  nand2  g40(.a(x23), .b(x17), .O(new_n85_));
  nor2   g41(.a(new_n85_), .b(x24), .O(z13));
  nor2   g42(.a(x15), .b(x14), .O(new_n88_));
  nor2   g43(.a(x13), .b(x12), .O(new_n89_));
