// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:11 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n80_, new_n83_, new_n87_, new_n88_;
  ...
  nand2  g34(.a(x22), .b(x14), .O(new_n80_));
  nor2   g35(.a(new_n80_), .b(x24), .O(z10));
  nand2  g36(.a(x23), .b(x14), .O(new_n83_));
  nor2   g37(.a(new_n83_), .b(x24), .O(z12));
  nor2   g38(.a(x15), .b(x14), .O(new_n87_));
  nor2   g39(.a(x13), .b(x12), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n87_), .O(z15));
  zero   g41(.O(z00));
  zero   g42(.O(z04));
  zero   g43(.O(z07));
  zero   g44(.O(z08));
