...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n80_, new_n81_, new_n83_, new_n85_, new_n88_;
  ...
  inv1   g35(.a(x14), .O(new_n80_));
  inv1   g36(.a(x22), .O(new_n81_));
  nor3   g37(.a(x24), .b(new_n81_), .c(new_n80_), .O(z10));
  inv1   g38(.a(x17), .O(new_n83_));
  nor3   g39(.a(x24), .b(new_n81_), .c(new_n83_), .O(z11));
  inv1   g40(.a(x23), .O(new_n85_));
  nor3   g41(.a(x24), .b(new_n85_), .c(new_n80_), .O(z12));
  nor3   g42(.a(x24), .b(new_n85_), .c(new_n83_), .O(z13));
  inv1   g43(.a(x16), .O(new_n88_));
  nor2   g44(.a(x24), .b(new_n88_), .O(z14));
  zero   g45(.O(z00));
  zero   g46(.O(z04));
  zero   g47(.O(z08));
  zero   g48(.O(z15));
