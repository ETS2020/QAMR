...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n68_, new_n69_, new_n70_, new_n71_, new_n72_, new_n79_, new_n81_,
    new_n83_, new_n84_;
  ...
  nand3  g19(.a(new_n60_), .b(x08), .c(new_n48_), .O(new_n61_));
  nor3   g20(.a(new_n61_), .b(x06), .c(x05), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(new_n59_), .c(new_n44_), .d(new_n43_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n58_), .c(new_n42_), .O(z02));
  or2    g23(.a(x21), .b(x20), .O(z04));
  nand3  g24(.a(new_n56_), .b(new_n46_), .c(new_n54_), .O(new_n68_));
  inv1   g25(.a(new_n68_), .O(new_n69_));
  nand4  g26(.a(new_n69_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n70_));
  inv1   g27(.a(x00), .O(new_n71_));
  nor2   g28(.a(new_n57_), .b(new_n71_), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(new_n70_), .c(new_n42_), .O(z06));
