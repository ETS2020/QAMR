...
module FAU ( 
  ...
  nand2  g35(.a(x22), .b(x17), .O(new_n79_));
  nor2   g36(.a(new_n79_), .b(x24), .O(z11));
  nand2  g37(.a(x23), .b(x17), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(x24), .O(z13));
  inv1   g39(.a(x16), .O(new_n84_));
  nor2   g40(.a(x24), .b(new_n84_), .O(z14));
  zero   g41(.O(z04));
  zero   g42(.O(z10));
  zero   g43(.O(z12));
  zero   g44(.O(z15));
