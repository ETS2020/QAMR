...
module FAU ( 
  ...
  nand4  g25(.a(new_n62_), .b(x19), .c(new_n63_), .d(new_n49_), .O(new_n69_));
  oai21  g26(.a(new_n69_), .b(new_n60_), .c(new_n68_), .O(z05));
  nand3  g27(.a(new_n57_), .b(new_n47_), .c(new_n55_), .O(new_n71_));
  inv1   g28(.a(new_n71_), .O(new_n72_));
  nand4  g29(.a(new_n72_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n73_));
  inv1   g30(.a(x00), .O(new_n74_));
  nor2   g31(.a(new_n58_), .b(new_n74_), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n73_), .c(new_n43_), .O(z06));
  and2   g33(.a(x24), .b(x11), .O(z09));
  inv1   g34(.a(x14), .O(new_n80_));
  inv1   g35(.a(x22), .O(new_n81_));
  nor3   g36(.a(x24), .b(new_n81_), .c(new_n80_), .O(z10));
  inv1   g37(.a(x17), .O(new_n83_));
  nor3   g38(.a(x24), .b(new_n81_), .c(new_n83_), .O(z11));
  inv1   g39(.a(x23), .O(new_n85_));
  nor3   g40(.a(x24), .b(new_n85_), .c(new_n80_), .O(z12));
  nor3   g41(.a(x24), .b(new_n85_), .c(new_n83_), .O(z13));
  inv1   g42(.a(x16), .O(new_n88_));
  nor2   g43(.a(x24), .b(new_n88_), .O(z14));
  nor2   g44(.a(x15), .b(x14), .O(new_n90_));
  nor2   g45(.a(x13), .b(x12), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n90_), .O(z15));
  zero   g47(.O(z00));
  zero   g48(.O(z04));
  zero   g49(.O(z07));
  zero   g50(.O(z08));
