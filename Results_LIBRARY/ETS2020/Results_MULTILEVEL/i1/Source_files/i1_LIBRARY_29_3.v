...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n81_, new_n82_, new_n84_, new_n86_, new_n89_, new_n91_,
    new_n92_;
  ...
  nor3   g38(.a(x24), .b(new_n82_), .c(new_n81_), .O(z10));
  inv1   g39(.a(x17), .O(new_n84_));
  nor3   g40(.a(x24), .b(new_n82_), .c(new_n84_), .O(z11));
  inv1   g41(.a(x23), .O(new_n86_));
  nor3   g42(.a(x24), .b(new_n86_), .c(new_n81_), .O(z12));
  nor3   g43(.a(x24), .b(new_n86_), .c(new_n84_), .O(z13));
  inv1   g44(.a(x16), .O(new_n89_));
  nor2   g45(.a(x24), .b(new_n89_), .O(z14));
  nor2   g46(.a(x15), .b(x14), .O(new_n91_));
  nor2   g47(.a(x13), .b(x12), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n91_), .O(z15));
  zero   g49(.O(z00));
  zero   g50(.O(z03));
  zero   g51(.O(z08));
endmodule
