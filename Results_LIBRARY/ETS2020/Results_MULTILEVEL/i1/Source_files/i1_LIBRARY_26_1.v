...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n74_, new_n82_, new_n84_, new_n86_, new_n87_;
  ...
  nand2  g34(.a(x23), .b(x17), .O(new_n82_));
  nor2   g35(.a(new_n82_), .b(x24), .O(z13));
  inv1   g36(.a(x16), .O(new_n84_));
  nor2   g37(.a(x24), .b(new_n84_), .O(z14));
  nor2   g38(.a(x15), .b(x14), .O(new_n86_));
  nor2   g39(.a(x13), .b(x12), .O(new_n87_));
  nand2  g40(.a(new_n87_), .b(new_n86_), .O(z15));
  zero   g41(.O(z04));
  zero   g42(.O(z08));
  zero   g43(.O(z09));
  zero   g44(.O(z10));
