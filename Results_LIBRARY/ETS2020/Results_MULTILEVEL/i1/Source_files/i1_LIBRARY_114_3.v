...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n74_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_, new_n88_;
  ...
  nand2  g36(.a(x22), .b(x17), .O(new_n79_));
  nor2   g37(.a(new_n79_), .b(x24), .O(z11));
  nand2  g38(.a(x23), .b(x14), .O(new_n81_));
  nor2   g39(.a(new_n81_), .b(x24), .O(z12));
  nand2  g40(.a(x23), .b(x17), .O(new_n83_));
  nor2   g41(.a(new_n83_), .b(x24), .O(z13));
  inv1   g42(.a(x16), .O(new_n85_));
  nor2   g43(.a(x24), .b(new_n85_), .O(z14));
  nor2   g44(.a(x15), .b(x14), .O(new_n87_));
  nor2   g45(.a(x13), .b(x12), .O(new_n88_));
  nand2  g46(.a(new_n88_), .b(new_n87_), .O(z15));
  zero   g47(.O(z10));
  buf    g48(.a(x00), .O(z00));
  buf    g49(.a(x20), .O(z03));
  buf    g50(.a(x11), .O(z08));
