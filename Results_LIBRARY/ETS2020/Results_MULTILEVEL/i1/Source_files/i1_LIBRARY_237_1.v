...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n82_, new_n84_, new_n86_, new_n88_, new_n89_;
  ...
  nand4  g25(.a(new_n62_), .b(x19), .c(new_n63_), .d(new_n49_), .O(new_n70_));
  oai21  g26(.a(new_n70_), .b(new_n60_), .c(new_n69_), .O(z05));
  nand3  g27(.a(new_n57_), .b(new_n47_), .c(new_n55_), .O(new_n72_));
  inv1   g28(.a(new_n72_), .O(new_n73_));
  nand4  g29(.a(new_n73_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n74_));
  inv1   g30(.a(x00), .O(new_n75_));
  nor2   g31(.a(new_n58_), .b(new_n75_), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n74_), .c(new_n43_), .O(z06));
  and2   g33(.a(x24), .b(x18), .O(z07));
  and2   g34(.a(x24), .b(x11), .O(z09));
  nand2  g35(.a(x23), .b(x14), .O(new_n82_));
  nor2   g36(.a(new_n82_), .b(x24), .O(z12));
  nand2  g37(.a(x23), .b(x17), .O(new_n84_));
  nor2   g38(.a(new_n84_), .b(x24), .O(z13));
  inv1   g39(.a(x16), .O(new_n86_));
  nor2   g40(.a(x24), .b(new_n86_), .O(z14));
