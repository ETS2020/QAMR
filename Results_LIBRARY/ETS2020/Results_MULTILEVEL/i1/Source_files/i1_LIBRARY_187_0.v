// Benchmark "FAU" written by ABC on Fri Jul 24 17:36:22 2020
...
module FAU ( 
  ...
  nor2   g39(.a(x15), .b(x14), .O(new_n87_));
  nor2   g40(.a(x13), .b(x12), .O(new_n88_));
  nand2  g41(.a(new_n88_), .b(new_n87_), .O(z15));
  zero   g42(.O(z00));
  zero   g43(.O(z07));
  zero   g44(.O(z08));
  zero   g45(.O(z11));
