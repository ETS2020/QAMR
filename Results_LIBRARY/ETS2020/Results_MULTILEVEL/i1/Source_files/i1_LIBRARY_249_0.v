...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n81_, new_n83_, new_n86_;
  ...
  nand2  g35(.a(x22), .b(x14), .O(new_n81_));
  nor2   g36(.a(new_n81_), .b(x24), .O(z10));
  nand2  g37(.a(x22), .b(x17), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(x24), .O(z11));
  nand2  g39(.a(x23), .b(x17), .O(new_n86_));
  nor2   g40(.a(new_n86_), .b(x24), .O(z13));
  zero   g41(.O(z00));
  zero   g42(.O(z03));
  zero   g43(.O(z07));
  zero   g44(.O(z08));
