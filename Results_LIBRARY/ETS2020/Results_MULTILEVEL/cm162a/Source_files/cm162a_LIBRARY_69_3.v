...
module FAU ( 
  ...
  inv1   g21(.a(x10), .O(new_n42_));
  inv1   g22(.a(x11), .O(new_n43_));
  inv1   g23(.a(x12), .O(new_n44_));
  nand4  g24(.a(new_n44_), .b(new_n43_), .c(new_n42_), .d(new_n24_), .O(new_n45_));
  aoi21  g25(.a(new_n45_), .b(new_n22_), .c(new_n21_), .O(new_n46_));
  nor3   g26(.a(x11), .b(x10), .c(x08), .O(new_n47_));
  aoi21  g27(.a(new_n47_), .b(new_n25_), .c(new_n44_), .O(new_n48_));
  aoi21  g28(.a(new_n46_), .b(x02), .c(new_n48_), .O(new_n49_));
  inv1   g29(.a(x07), .O(new_n50_));
  aoi21  g30(.a(new_n50_), .b(new_n20_), .c(new_n29_), .O(new_n51_));
  oai21  g31(.a(new_n49_), .b(new_n20_), .c(new_n51_), .O(z3));
  zero   g32(.O(z2));
  zero   g33(.O(z4));
endmodule
