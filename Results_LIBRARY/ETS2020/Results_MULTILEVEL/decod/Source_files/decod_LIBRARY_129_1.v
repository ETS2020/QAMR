// Benchmark "FAU" written by ABC on Thu Jul 23 21:06:40 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n38_, new_n40_, new_n41_, new_n43_, new_n46_,
  ...
  nand4  g22(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n40_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n23_), .O(z11));
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n40_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z12));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n40_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n23_), .O(z14));
  nand4  g30(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n54_));
