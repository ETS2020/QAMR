...
module FAU ( 
  ...
  nand4  g10(.a(x3), .b(new_n25_), .c(new_n31_), .d(x0), .O(new_n35_));
  nor2   g11(.a(new_n35_), .b(new_n24_), .O(z06));
  nand4  g12(.a(new_n28_), .b(new_n25_), .c(new_n31_), .d(x0), .O(new_n37_));
  ...
  nand4  g23(.a(x3), .b(x2), .c(new_n31_), .d(new_n39_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n24_), .O(z12));
  nand4  g25(.a(new_n28_), .b(x2), .c(new_n31_), .d(new_n39_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n24_), .O(z13));
  nand4  g27(.a(x3), .b(new_n25_), .c(new_n31_), .d(new_n39_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n24_), .O(z14));
  nand4  g29(.a(new_n28_), .b(new_n25_), .c(new_n31_), .d(new_n39_), .O(new_n54_));
