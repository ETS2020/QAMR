// Benchmark "FAU" written by ABC on Thu Jul 23 21:06:21 2020
...
module FAU ( 
  ...
  nand4  g26(.a(x3), .b(x2), .c(new_n32_), .d(new_n40_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z12));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n40_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z13));
  nand4  g30(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n23_), .O(z14));
  nand4  g32(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n40_), .O(new_n55_));
