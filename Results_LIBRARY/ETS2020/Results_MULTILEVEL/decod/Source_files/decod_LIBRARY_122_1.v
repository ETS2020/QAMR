...
module FAU ( 
  ...
  nand4  g24(.a(x3), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z12));
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n39_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n39_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n23_), .O(z14));
  nand4  g30(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n39_), .O(new_n54_));
