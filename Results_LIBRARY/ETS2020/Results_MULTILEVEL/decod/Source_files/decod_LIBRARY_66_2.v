// Benchmark "FAU" written by ABC on Thu Jul 23 21:06:30 2020
...
module FAU ( 
  ...
  nand4  g25(.a(x3), .b(new_n25_), .c(new_n32_), .d(new_n39_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n24_), .O(z14));
  nand4  g27(.a(new_n28_), .b(new_n25_), .c(new_n32_), .d(new_n39_), .O(new_n53_));
