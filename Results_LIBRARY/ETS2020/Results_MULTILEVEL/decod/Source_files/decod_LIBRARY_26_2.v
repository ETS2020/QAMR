// Benchmark "FAU" written by ABC on Thu Jul 23 21:06:23 2020
...
module FAU ( 
  ...
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z11));
  nand4  g25(.a(x3), .b(x2), .c(new_n33_), .d(new_n40_), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n23_), .O(z12));
  ...
  nor2   g30(.a(new_n53_), .b(new_n23_), .O(z14));
  nand4  g31(.a(new_n29_), .b(new_n26_), .c(new_n33_), .d(new_n40_), .O(new_n55_));
  nor2   g32(.a(new_n55_), .b(new_n23_), .O(z15));
  zero   g33(.O(z00));
  zero   g34(.O(z04));
endmodule
