// Benchmark "FAU" written by ABC on Thu Jul 23 21:06:35 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n27_, new_n28_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n38_, new_n41_, new_n42_, new_n44_, new_n46_,
  ...
  nand4  g18(.a(new_n22_), .b(x2), .c(x1), .d(new_n41_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z09));
  nand4  g20(.a(x3), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n23_), .O(z10));
  nand4  g22(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n46_));
  ...
  nand4  g26(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n50_));
  nor2   g27(.a(new_n50_), .b(new_n23_), .O(z13));
  nand4  g28(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n23_), .O(z14));
  nand4  g30(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n54_));
