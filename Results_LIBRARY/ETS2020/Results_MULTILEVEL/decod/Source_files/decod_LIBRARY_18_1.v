...
module FAU ( 
  ...
  nand4  g22(.a(x3), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n23_), .O(z10));
  nand4  g24(.a(new_n22_), .b(new_n27_), .c(x1), .d(new_n41_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z11));
  nand4  g26(.a(x3), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n49_));
  nor2   g27(.a(new_n49_), .b(new_n23_), .O(z12));
  nand4  g28(.a(new_n22_), .b(x2), .c(new_n32_), .d(new_n41_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n23_), .O(z13));
  nand4  g30(.a(x3), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n53_));
  nor2   g31(.a(new_n53_), .b(new_n23_), .O(z14));
  nand4  g32(.a(new_n22_), .b(new_n27_), .c(new_n32_), .d(new_n41_), .O(new_n55_));
