// Benchmark "FAU" written by ABC on Tue Jun 23 02:05:38 2020
...
module FAU ( 
  ...
  nand2  g24(.a(x08), .b(x07), .O(new_n71_));
  inv1   g25(.a(new_n71_), .O(z08));
  nand4  g26(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n73_));
  nand4  g27(.a(x22), .b(x21), .c(x20), .d(x11), .O(new_n74_));
  nor2   g28(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nor2   g29(.a(new_n75_), .b(new_n54_), .O(new_n76_));
  inv1   g30(.a(x10), .O(new_n77_));
  nand2  g31(.a(new_n53_), .b(new_n77_), .O(new_n78_));
  oai22  g32(.a(new_n78_), .b(new_n76_), .c(new_n59_), .d(new_n58_), .O(z09));
  nand3  g33(.a(x22), .b(x21), .c(x12), .O(new_n80_));
  oai21  g34(.a(new_n80_), .b(new_n73_), .c(x19), .O(new_n81_));
  nor2   g35(.a(x20), .b(new_n54_), .O(new_n82_));
  aoi21  g36(.a(new_n81_), .b(x20), .c(new_n82_), .O(new_n83_));
  oai22  g37(.a(new_n83_), .b(new_n78_), .c(new_n59_), .d(new_n61_), .O(z10));
  nand3  g38(.a(x26), .b(x25), .c(x24), .O(new_n85_));
  nand3  g39(.a(x23), .b(x22), .c(x13), .O(new_n86_));
  nand2  g40(.a(x20), .b(x19), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  oai21  g42(.a(new_n86_), .b(new_n85_), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(new_n87_), .b(x21), .O(new_n90_));
  aoi21  g44(.a(new_n89_), .b(x21), .c(new_n90_), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n78_), .c(new_n63_), .O(z11));
  nand2  g46(.a(x23), .b(x14), .O(new_n93_));
  nand3  g47(.a(x21), .b(x20), .c(x19), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n93_), .b(new_n85_), .c(new_n95_), .O(new_n96_));
  nand4  g50(.a(new_n47_), .b(x21), .c(x20), .d(x19), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n96_), .b(x22), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n78_), .c(new_n65_), .O(z12));
  ...
  nand3  g58(.a(new_n48_), .b(x22), .c(x21), .O(new_n105_));
  nor2   g59(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  aoi21  g60(.a(new_n104_), .b(x23), .c(new_n106_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n78_), .c(new_n67_), .O(z13));
  nand4  g62(.a(x25), .b(x24), .c(x21), .d(x20), .O(new_n111_));
  inv1   g63(.a(new_n111_), .O(new_n112_));
  nor2   g64(.a(new_n54_), .b(x18), .O(new_n113_));
  nand3  g65(.a(new_n113_), .b(new_n112_), .c(new_n49_), .O(new_n114_));
  ...
  oai21  g71(.a(new_n119_), .b(new_n78_), .c(new_n71_), .O(z16));
  zero   g72(.O(z06));
  zero   g73(.O(z07));
  zero   g74(.O(z14));
  zero   g75(.O(z15));
