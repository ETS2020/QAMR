// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:28 2020
...
module FAU ( 
  ...
  nor2   g54(.a(x33), .b(new_n67_), .O(new_n112_));
  ...
  nor2   g61(.a(x35), .b(new_n67_), .O(new_n120_));
  ...
  nor2   g68(.a(x28), .b(new_n67_), .O(new_n127_));
