...
module FAU ( 
  ...
  wire new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_,
    ...
    new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_, new_n92_,
  ...
  nor2   g33(.a(x33), .b(new_n67_), .O(new_n94_));
  ...
  nor2   g40(.a(x34), .b(new_n67_), .O(new_n101_));
  ...
  nor2   g47(.a(x35), .b(new_n67_), .O(new_n108_));
  ...
  nor2   g54(.a(x28), .b(new_n67_), .O(new_n115_));
