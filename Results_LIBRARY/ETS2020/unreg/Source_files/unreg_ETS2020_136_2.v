...
module FAU ( 
  ...
  nor2   g26(.a(x31), .b(new_n57_), .O(new_n86_));
  oai21  g27(.a(new_n86_), .b(new_n85_), .c(new_n60_), .O(new_n87_));
  inv1   g28(.a(x30), .O(new_n88_));
  nand2  g29(.a(new_n88_), .b(new_n59_), .O(new_n89_));
  ...
  nor2   g40(.a(x34), .b(new_n57_), .O(new_n101_));
  oai21  g41(.a(new_n101_), .b(new_n100_), .c(new_n60_), .O(new_n102_));
  inv1   g42(.a(x33), .O(new_n103_));
  nand2  g43(.a(new_n103_), .b(new_n59_), .O(new_n104_));
