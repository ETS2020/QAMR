// Benchmark "FAU" written by ABC on Tue Jun 23 07:17:19 2020
...
module FAU ( 
  ...
  nand4  g060(.a(new_n113_), .b(new_n80_), .c(new_n67_), .d(new_n56_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n99_), .c(new_n73_), .d(new_n56_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n98_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n131_));
  ...
  nand4  g100(.a(new_n153_), .b(new_n133_), .c(new_n116_), .d(new_n132_), .O(new_n154_));
  inv1   g101(.a(new_n154_), .O(new_n155_));
  nand2  g102(.a(new_n155_), .b(new_n82_), .O(new_n156_));
  ...
  oai21  g108(.a(new_n154_), .b(new_n81_), .c(x33), .O(new_n162_));
  nor2   g109(.a(x33), .b(x32), .O(new_n163_));
  nand4  g110(.a(new_n163_), .b(new_n142_), .c(new_n141_), .d(new_n106_), .O(new_n164_));
  inv1   g111(.a(new_n164_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n91_), .O(new_n166_));
  ...
  nand4  g118(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n54_), .O(new_n172_));
  oai21  g119(.a(new_n164_), .b(new_n172_), .c(x34), .O(new_n173_));
  nand2  g120(.a(new_n141_), .b(new_n106_), .O(new_n174_));
