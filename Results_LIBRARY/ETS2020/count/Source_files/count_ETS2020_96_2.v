// Benchmark "FAU" written by ABC on Tue Jun 23 07:16:26 2020
...
module FAU ( 
  ...
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n112_), .d(new_n93_), .O(new_n159_));
  oai21  g107(.a(new_n159_), .b(new_n89_), .c(x32), .O(new_n160_));
  nand2  g108(.a(new_n139_), .b(new_n121_), .O(new_n161_));
  inv1   g109(.a(new_n161_), .O(new_n162_));
  nor2   g110(.a(x32), .b(x31), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n138_), .O(new_n164_));
  inv1   g112(.a(new_n164_), .O(new_n165_));
  nand4  g113(.a(new_n165_), .b(new_n162_), .c(new_n148_), .d(new_n63_), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(new_n160_), .O(new_n167_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n139_), .c(new_n121_), .d(new_n138_), .O(new_n172_));
  oai21  g120(.a(new_n172_), .b(new_n89_), .c(x33), .O(new_n173_));
  nor2   g121(.a(x33), .b(x32), .O(new_n174_));
  nand4  g122(.a(new_n174_), .b(new_n150_), .c(new_n149_), .d(new_n112_), .O(new_n175_));
  inv1   g123(.a(new_n175_), .O(new_n176_));
  nand2  g124(.a(new_n176_), .b(new_n95_), .O(new_n177_));
  nand2  g125(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g126(.a(new_n178_), .b(x16), .O(new_n179_));
  inv1   g127(.a(x01), .O(new_n180_));
  aoi21  g128(.a(new_n58_), .b(new_n180_), .c(x18), .O(new_n181_));
  nand2  g129(.a(new_n181_), .b(new_n179_), .O(z14));
  oai21  g130(.a(new_n175_), .b(new_n103_), .c(x34), .O(new_n183_));
  nand2  g131(.a(new_n149_), .b(new_n112_), .O(new_n184_));
  inv1   g132(.a(new_n184_), .O(new_n185_));
  inv1   g133(.a(x30), .O(new_n186_));
  inv1   g134(.a(x31), .O(new_n187_));
  nand2  g135(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  inv1   g136(.a(x32), .O(new_n189_));
  inv1   g137(.a(x33), .O(new_n190_));
  inv1   g138(.a(x34), .O(new_n191_));
  nand3  g139(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  nor2   g140(.a(new_n192_), .b(new_n188_), .O(new_n193_));
  nand3  g141(.a(new_n193_), .b(new_n185_), .c(new_n95_), .O(new_n194_));
  nand2  g142(.a(new_n194_), .b(new_n183_), .O(new_n195_));
  nand2  g143(.a(new_n195_), .b(x16), .O(new_n196_));
  inv1   g144(.a(x00), .O(new_n197_));
  aoi21  g145(.a(new_n58_), .b(new_n197_), .c(x18), .O(new_n198_));
  nand2  g146(.a(new_n198_), .b(new_n196_), .O(z15));
  zero   g147(.O(z05));
endmodule
