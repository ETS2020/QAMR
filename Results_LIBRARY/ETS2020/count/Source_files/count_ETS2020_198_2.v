...
module FAU ( 
  ...
  nand4  g065(.a(new_n117_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n118_));
  ...
  aoi21  g073(.a(new_n59_), .b(new_n125_), .c(x18), .O(new_n126_));
  oai21  g074(.a(new_n124_), .b(new_n59_), .c(new_n126_), .O(z09));
  oai21  g075(.a(new_n122_), .b(new_n77_), .c(x29), .O(new_n128_));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g077(.a(new_n129_), .b(new_n103_), .c(new_n78_), .d(new_n56_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(x16), .O(new_n132_));
  inv1   g080(.a(x05), .O(new_n133_));
  aoi21  g081(.a(new_n59_), .b(new_n133_), .c(x18), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n132_), .O(z10));
  nand4  g083(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n136_));
  ...
  aoi21  g090(.a(new_n59_), .b(new_n142_), .c(x18), .O(new_n143_));
  oai21  g091(.a(new_n141_), .b(new_n59_), .c(new_n143_), .O(z11));
  ...
  nand4  g101(.a(new_n153_), .b(new_n117_), .c(new_n147_), .d(new_n56_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n145_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g104(.a(x03), .O(new_n157_));
  aoi21  g105(.a(new_n59_), .b(new_n157_), .c(x18), .O(new_n158_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n166_), .c(new_n147_), .d(new_n56_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(new_n163_), .O(new_n171_));
  nand2  g119(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g120(.a(x02), .O(new_n173_));
  aoi21  g121(.a(new_n59_), .b(new_n173_), .c(x18), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n59_), .b(new_n185_), .c(x18), .O(new_n186_));
