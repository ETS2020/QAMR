...
module FAU ( 
  ...
  inv1   g069(.a(x26), .O(new_n122_));
  nor2   g070(.a(x28), .b(x27), .O(new_n123_));
  nand4  g071(.a(new_n123_), .b(new_n103_), .c(new_n122_), .d(new_n93_), .O(new_n124_));
  ...
  nand4  g088(.a(new_n140_), .b(new_n123_), .c(new_n139_), .d(new_n83_), .O(new_n141_));
  ...
  nand2  g107(.a(new_n140_), .b(new_n123_), .O(new_n160_));
  inv1   g108(.a(x31), .O(new_n161_));
  inv1   g109(.a(x32), .O(new_n162_));
  nand4  g110(.a(new_n162_), .b(new_n161_), .c(new_n122_), .d(new_n94_), .O(new_n163_));
  nor2   g111(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n87_), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(new_n159_), .O(new_n166_));
  nand2  g114(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g115(.a(x02), .O(new_n168_));
  aoi21  g116(.a(new_n58_), .b(new_n168_), .c(x18), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n167_), .O(z13));
  nor2   g118(.a(x33), .b(x32), .O(new_n172_));
  nand4  g119(.a(new_n172_), .b(new_n149_), .c(new_n148_), .d(new_n113_), .O(new_n173_));
  oai21  g120(.a(new_n173_), .b(new_n104_), .c(x34), .O(new_n174_));
  nand2  g121(.a(new_n148_), .b(new_n113_), .O(new_n175_));
  inv1   g122(.a(new_n175_), .O(new_n176_));
  inv1   g123(.a(x30), .O(new_n177_));
  nand2  g124(.a(new_n161_), .b(new_n177_), .O(new_n178_));
  inv1   g125(.a(x33), .O(new_n179_));
  inv1   g126(.a(x34), .O(new_n180_));
  nand3  g127(.a(new_n180_), .b(new_n179_), .c(new_n162_), .O(new_n181_));
  nor2   g128(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  nand3  g129(.a(new_n182_), .b(new_n176_), .c(new_n96_), .O(new_n183_));
  nand2  g130(.a(new_n183_), .b(new_n174_), .O(new_n184_));
