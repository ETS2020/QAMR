...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n590_, new_n592_, new_n593_, new_n594_, new_n598_, new_n599_,
  ...
  nor2   g454(.a(x10), .b(new_n476_), .O(new_n598_));
  nand4  g455(.a(new_n598_), .b(new_n339_), .c(new_n308_), .d(new_n170_), .O(new_n599_));
  nand3  g456(.a(new_n406_), .b(new_n330_), .c(new_n319_), .O(new_n600_));
  nand2  g457(.a(new_n324_), .b(new_n190_), .O(new_n601_));
  nand2  g458(.a(new_n157_), .b(new_n151_), .O(new_n602_));
  nor4   g459(.a(new_n602_), .b(new_n601_), .c(new_n600_), .d(new_n599_), .O(z61));
  nand3  g460(.a(new_n297_), .b(new_n319_), .c(x47), .O(new_n604_));
  nor2   g461(.a(new_n604_), .b(new_n348_), .O(new_n605_));
  nand3  g462(.a(new_n605_), .b(new_n132_), .c(new_n184_), .O(new_n606_));
  nor3   g463(.a(new_n606_), .b(new_n349_), .c(new_n344_), .O(z62));
  zero   g464(.O(z05));
  zero   g465(.O(z07));
  zero   g466(.O(z09));
  zero   g467(.O(z15));
