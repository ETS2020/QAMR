...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n478_, new_n487_, new_n488_, new_n489_, new_n490_, new_n492_,
    new_n493_, new_n494_, new_n495_, new_n497_;
  ...
  inv1   g327(.a(new_n348_), .O(new_n487_));
  nor2   g328(.a(new_n303_), .b(new_n298_), .O(new_n488_));
  nor4   g329(.a(new_n273_), .b(x60), .c(x50), .d(new_n188_), .O(new_n489_));
  nand4  g330(.a(new_n489_), .b(new_n488_), .c(new_n487_), .d(new_n300_), .O(new_n490_));
  inv1   g331(.a(new_n490_), .O(z62));
  inv1   g332(.a(x60), .O(new_n492_));
  nand4  g333(.a(new_n492_), .b(new_n354_), .c(x56), .d(new_n166_), .O(new_n493_));
  inv1   g334(.a(new_n493_), .O(new_n494_));
  nand4  g335(.a(new_n494_), .b(new_n488_), .c(new_n487_), .d(new_n300_), .O(new_n495_));
  inv1   g336(.a(new_n495_), .O(z63));
  nand4  g337(.a(new_n350_), .b(new_n487_), .c(new_n316_), .d(x30), .O(new_n497_));
  nor3   g338(.a(new_n497_), .b(new_n303_), .c(new_n298_), .O(z64));
  zero   g339(.O(z00));
  zero   g340(.O(z01));
  zero   g341(.O(z07));
  zero   g342(.O(z08));
