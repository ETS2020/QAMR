...
module FAU ( 
  ...
  nand4  g08(.a(x11), .b(new_n29_), .c(x03), .d(x02), .O(new_n30_));
  ...
  nand2  g15(.a(x08), .b(x03), .O(new_n39_));
  nand3  g16(.a(x15), .b(x14), .c(x10), .O(new_n40_));
  nor2   g17(.a(new_n40_), .b(new_n39_), .O(z4));
  zero   g18(.O(z2));
  zero   g19(.O(z3));
endmodule
