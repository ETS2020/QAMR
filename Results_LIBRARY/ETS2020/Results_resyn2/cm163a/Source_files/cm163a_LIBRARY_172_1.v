// Benchmark "FAU" written by ABC on Fri Jul 24 21:14:57 2020
...
module FAU ( 
  ...
  nand2  g09(.a(x08), .b(x03), .O(new_n34_));
  nand3  g10(.a(x15), .b(x14), .c(x10), .O(new_n35_));
  nor2   g11(.a(new_n35_), .b(new_n34_), .O(z4));
  zero   g12(.O(z1));
  zero   g13(.O(z2));
  zero   g14(.O(z3));
endmodule
