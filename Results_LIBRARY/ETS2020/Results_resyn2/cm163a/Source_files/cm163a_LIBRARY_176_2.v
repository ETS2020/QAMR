...
module FAU ( 
  ...
  nand4  g15(.a(new_n30_), .b(x12), .c(x03), .d(x02), .O(new_n37_));
  inv1   g16(.a(x12), .O(new_n38_));
  nand2  g17(.a(new_n31_), .b(new_n38_), .O(new_n39_));
  ...
  nand2  g22(.a(x08), .b(x03), .O(new_n45_));
  nand3  g23(.a(x15), .b(x14), .c(x10), .O(new_n46_));
  nor2   g24(.a(new_n46_), .b(new_n45_), .O(z4));
  zero   g25(.O(z3));
endmodule
