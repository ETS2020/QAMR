...
module FAU ( 
  ...
  inv1   g48(.a(x29), .O(new_n113_));
  oai22  g49(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n113_), .O(new_n114_));
  nand2  g50(.a(x27), .b(new_n65_), .O(new_n115_));
  nor2   g51(.a(x30), .b(x09), .O(new_n116_));
  oai21  g52(.a(new_n115_), .b(new_n75_), .c(new_n116_), .O(new_n117_));
  aoi21  g53(.a(new_n114_), .b(x08), .c(new_n117_), .O(z11));
  nand2  g54(.a(x36), .b(x35), .O(new_n119_));
  nand2  g55(.a(new_n119_), .b(x28), .O(new_n120_));
  nor2   g56(.a(x13), .b(x04), .O(new_n121_));
  nand3  g57(.a(new_n121_), .b(new_n120_), .c(z08), .O(new_n122_));
  nor2   g58(.a(x19), .b(x18), .O(new_n123_));
  nand2  g59(.a(new_n123_), .b(x20), .O(new_n124_));
  oai21  g60(.a(new_n124_), .b(new_n63_), .c(new_n122_), .O(new_n125_));
  nand2  g61(.a(new_n125_), .b(x27), .O(new_n126_));
  nand2  g62(.a(new_n121_), .b(new_n106_), .O(new_n127_));
  nand2  g63(.a(new_n127_), .b(new_n126_), .O(z13));
  nand2  g64(.a(new_n121_), .b(z08), .O(new_n129_));
  nand3  g65(.a(new_n119_), .b(new_n105_), .c(x28), .O(new_n130_));
  inv1   g66(.a(new_n130_), .O(new_n131_));
  oai21  g67(.a(new_n131_), .b(new_n129_), .c(new_n124_), .O(new_n132_));
  aoi21  g68(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n133_));
  oai22  g69(.a(new_n133_), .b(new_n129_), .c(new_n63_), .d(new_n72_), .O(new_n134_));
  nand2  g70(.a(new_n134_), .b(new_n132_), .O(z14));
