// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:54 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n101_,
    new_n102_, new_n103_, new_n104_, new_n107_, new_n108_, new_n109_,
    new_n110_, new_n111_, new_n112_, new_n113_, new_n116_, new_n119_,
    new_n120_;
  ...
  nor2   g35(.a(new_n73_), .b(new_n71_), .O(new_n101_));
  aoi22  g36(.a(new_n75_), .b(z08), .c(new_n101_), .d(x07), .O(new_n102_));
  oai21  g37(.a(new_n80_), .b(x05), .c(new_n63_), .O(new_n103_));
  nand3  g38(.a(x37), .b(x27), .c(x06), .O(new_n104_));
  oai21  g39(.a(new_n103_), .b(new_n102_), .c(new_n104_), .O(z10));
  aoi21  g40(.a(x36), .b(x35), .c(new_n72_), .O(new_n107_));
  nor2   g41(.a(x13), .b(x04), .O(new_n108_));
  nand2  g42(.a(new_n108_), .b(z08), .O(new_n109_));
  nor2   g43(.a(x19), .b(x18), .O(new_n110_));
  nand2  g44(.a(new_n110_), .b(x20), .O(new_n111_));
  oai22  g45(.a(new_n111_), .b(new_n66_), .c(new_n109_), .d(new_n107_), .O(new_n112_));
  nor2   g46(.a(new_n109_), .b(new_n74_), .O(new_n113_));
  aoi21  g47(.a(new_n112_), .b(x27), .c(new_n113_), .O(z14));
  inv1   g48(.a(z14), .O(z13));
  nand4  g49(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n116_));
  inv1   g50(.a(new_n116_), .O(z15));
  inv1   g51(.a(x24), .O(new_n119_));
  nand4  g52(.a(new_n119_), .b(x23), .c(x22), .d(x01), .O(new_n120_));
  inv1   g53(.a(new_n120_), .O(z17));
  zero   g54(.O(z03));
  zero   g55(.O(z04));
  zero   g56(.O(z09));
  zero   g57(.O(z11));
