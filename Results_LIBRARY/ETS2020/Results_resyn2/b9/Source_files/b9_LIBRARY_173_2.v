...
module FAU ( 
  ...
  inv1   g72(.a(x08), .O(new_n138_));
  nand2  g73(.a(z08), .b(x29), .O(new_n139_));
  aoi21  g74(.a(new_n139_), .b(new_n75_), .c(new_n138_), .O(new_n140_));
  nand2  g75(.a(new_n139_), .b(x27), .O(new_n141_));
  nand2  g76(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand4  g77(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n143_));
  nor2   g78(.a(x30), .b(x09), .O(new_n144_));
  nand3  g79(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(z18));
  nand2  g80(.a(x35), .b(x27), .O(new_n147_));
  nand2  g81(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nor2   g82(.a(new_n148_), .b(new_n140_), .O(z20));
  zero   g83(.O(z03));
  zero   g84(.O(z04));
  zero   g85(.O(z11));
  zero   g86(.O(z19));
