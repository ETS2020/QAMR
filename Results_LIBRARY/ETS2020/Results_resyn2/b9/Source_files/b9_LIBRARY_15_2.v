...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n122_, new_n124_, new_n126_, new_n132_, new_n133_, new_n134_,
    new_n135_;
  ...
  inv1   g62(.a(x29), .O(new_n132_));
  oai21  g63(.a(new_n83_), .b(new_n132_), .c(new_n75_), .O(new_n133_));
  nor2   g64(.a(x30), .b(x09), .O(new_n134_));
  oai21  g65(.a(new_n113_), .b(new_n72_), .c(new_n134_), .O(new_n135_));
  aoi21  g66(.a(new_n133_), .b(x08), .c(new_n135_), .O(z20));
  zero   g67(.O(z03));
  zero   g68(.O(z04));
  zero   g69(.O(z11));
  zero   g70(.O(z16));
