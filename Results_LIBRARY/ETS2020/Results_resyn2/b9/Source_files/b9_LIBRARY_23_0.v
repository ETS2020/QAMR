...
module FAU ( 
  ...
  aoi22  g37(.a(z08), .b(new_n75_), .c(new_n101_), .d(x07), .O(new_n102_));
  ...
  nand2  g51(.a(new_n116_), .b(z08), .O(new_n117_));
  aoi21  g52(.a(x36), .b(x35), .c(new_n72_), .O(new_n118_));
  nor2   g53(.a(x19), .b(x18), .O(new_n119_));
  nand2  g54(.a(new_n119_), .b(x20), .O(new_n120_));
  oai22  g55(.a(new_n120_), .b(new_n67_), .c(new_n117_), .d(new_n118_), .O(new_n121_));
  nand2  g56(.a(new_n121_), .b(x27), .O(new_n122_));
  oai21  g57(.a(new_n117_), .b(new_n74_), .c(new_n122_), .O(z13));
  nand2  g58(.a(new_n118_), .b(new_n74_), .O(new_n124_));
  inv1   g59(.a(new_n124_), .O(new_n125_));
  oai21  g60(.a(new_n125_), .b(new_n117_), .c(new_n120_), .O(new_n126_));
  nand2  g61(.a(new_n72_), .b(x27), .O(new_n127_));
  and2   g62(.a(new_n127_), .b(new_n74_), .O(new_n128_));
  oai22  g63(.a(new_n128_), .b(new_n117_), .c(new_n67_), .d(new_n71_), .O(new_n129_));
  nand2  g64(.a(new_n129_), .b(new_n126_), .O(z14));
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n131_));
  inv1   g66(.a(new_n131_), .O(z15));
  nand2  g67(.a(x22), .b(x01), .O(new_n133_));
  nor2   g68(.a(new_n133_), .b(x23), .O(z16));
  inv1   g69(.a(x24), .O(new_n135_));
  nand4  g70(.a(new_n135_), .b(x23), .c(x22), .d(x01), .O(new_n136_));
  inv1   g71(.a(new_n136_), .O(z17));
  inv1   g72(.a(z11), .O(z18));
  oai21  g73(.a(new_n78_), .b(new_n71_), .c(new_n112_), .O(new_n139_));
  nor2   g74(.a(new_n139_), .b(new_n109_), .O(z20));
  zero   g75(.O(z02));
  zero   g76(.O(z09));
  zero   g77(.O(z12));
  aoi21  g78(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(z19));
endmodule
