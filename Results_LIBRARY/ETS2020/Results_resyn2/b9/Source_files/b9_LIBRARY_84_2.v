...
module FAU ( 
  ...
  oai22  g24(.a(new_n86_), .b(new_n84_), .c(new_n85_), .d(x27), .O(new_n87_));
  nand2  g25(.a(new_n87_), .b(x21), .O(z03));
  nand2  g26(.a(new_n86_), .b(new_n85_), .O(z05));
  ...
  nor2   g42(.a(new_n73_), .b(new_n71_), .O(new_n106_));
  aoi22  g43(.a(new_n75_), .b(z08), .c(new_n106_), .d(x07), .O(new_n107_));
  oai21  g44(.a(new_n80_), .b(x05), .c(new_n63_), .O(new_n108_));
  nand3  g45(.a(x37), .b(x27), .c(x06), .O(new_n109_));
  oai21  g46(.a(new_n108_), .b(new_n107_), .c(new_n109_), .O(z10));
  aoi21  g47(.a(x36), .b(x35), .c(new_n72_), .O(new_n112_));
  nor2   g48(.a(x13), .b(x04), .O(new_n113_));
  nand2  g49(.a(new_n113_), .b(z08), .O(new_n114_));
  nor2   g50(.a(x19), .b(x18), .O(new_n115_));
  nand2  g51(.a(new_n115_), .b(x20), .O(new_n116_));
  oai22  g52(.a(new_n116_), .b(new_n66_), .c(new_n114_), .d(new_n112_), .O(new_n117_));
  nor2   g53(.a(new_n114_), .b(new_n74_), .O(new_n118_));
  aoi21  g54(.a(new_n117_), .b(x27), .c(new_n118_), .O(z14));
  inv1   g55(.a(z14), .O(z13));
  nand4  g56(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n121_));
  inv1   g57(.a(new_n121_), .O(z15));
  nand2  g58(.a(x22), .b(x01), .O(new_n123_));
  nor2   g59(.a(new_n123_), .b(x23), .O(z16));
  inv1   g60(.a(x24), .O(new_n125_));
  nand4  g61(.a(new_n125_), .b(x23), .c(x22), .d(x01), .O(new_n126_));
  inv1   g62(.a(new_n126_), .O(z17));
  zero   g63(.O(z04));
  zero   g64(.O(z11));
  zero   g65(.O(z18));
  zero   g66(.O(z19));
