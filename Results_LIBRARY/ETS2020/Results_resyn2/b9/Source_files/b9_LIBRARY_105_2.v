...
module FAU ( 
  ...
  nand2  g38(.a(z08), .b(x05), .O(new_n103_));
  inv1   g39(.a(new_n103_), .O(new_n104_));
  and2   g40(.a(new_n80_), .b(x07), .O(new_n105_));
  aoi22  g41(.a(new_n105_), .b(new_n102_), .c(new_n104_), .d(new_n75_), .O(new_n106_));
  nand3  g42(.a(x37), .b(x27), .c(x06), .O(new_n107_));
  oai21  g43(.a(new_n106_), .b(x04), .c(new_n107_), .O(z10));
  aoi21  g44(.a(x36), .b(x35), .c(new_n72_), .O(new_n111_));
  inv1   g45(.a(x13), .O(new_n112_));
  nand2  g46(.a(new_n65_), .b(new_n112_), .O(new_n113_));
  nor2   g47(.a(x19), .b(x18), .O(new_n114_));
  nand2  g48(.a(new_n114_), .b(x20), .O(new_n115_));
  oai22  g49(.a(new_n115_), .b(new_n66_), .c(new_n113_), .d(new_n111_), .O(new_n116_));
  nor2   g50(.a(new_n113_), .b(new_n74_), .O(new_n117_));
  aoi21  g51(.a(new_n116_), .b(x27), .c(new_n117_), .O(z14));
