...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n122_, new_n123_, new_n124_, new_n127_, new_n129_, new_n132_,
    new_n134_, new_n135_;
  ...
  nand2  g66(.a(new_n109_), .b(new_n108_), .O(new_n132_));
  nand3  g67(.a(new_n111_), .b(new_n110_), .c(new_n132_), .O(z18));
  nand2  g68(.a(x35), .b(x27), .O(new_n134_));
  nand2  g69(.a(new_n134_), .b(new_n111_), .O(new_n135_));
  nor2   g70(.a(new_n135_), .b(new_n108_), .O(z20));
  zero   g71(.O(z01));
  zero   g72(.O(z10));
  zero   g73(.O(z17));
  aoi21  g74(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(z19));
endmodule
