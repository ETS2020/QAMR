...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n123_, new_n125_, new_n127_, new_n129_, new_n130_, new_n134_,
  ...
  aoi21  g38(.a(new_n78_), .b(new_n77_), .c(new_n83_), .O(new_n104_));
  inv1   g39(.a(x07), .O(new_n105_));
  nand2  g40(.a(new_n83_), .b(new_n105_), .O(new_n106_));
  aoi21  g41(.a(new_n106_), .b(new_n76_), .c(new_n104_), .O(new_n107_));
  oai21  g42(.a(new_n83_), .b(x05), .c(new_n65_), .O(new_n108_));
  nand3  g43(.a(x37), .b(x27), .c(x06), .O(new_n109_));
  oai21  g44(.a(new_n108_), .b(new_n107_), .c(new_n109_), .O(z10));
  inv1   g45(.a(x35), .O(new_n112_));
  oai21  g46(.a(new_n73_), .b(new_n112_), .c(x28), .O(new_n113_));
  nor2   g47(.a(x13), .b(x04), .O(new_n114_));
  nand3  g48(.a(new_n114_), .b(new_n113_), .c(z08), .O(new_n115_));
  inv1   g49(.a(new_n63_), .O(new_n116_));
  nor2   g50(.a(x19), .b(x18), .O(new_n117_));
  nand3  g51(.a(new_n117_), .b(new_n116_), .c(x20), .O(new_n118_));
  nand2  g52(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g53(.a(new_n119_), .b(x27), .O(new_n120_));
  nand2  g54(.a(new_n114_), .b(new_n104_), .O(new_n121_));
  nand2  g55(.a(new_n121_), .b(new_n120_), .O(z13));
  inv1   g56(.a(new_n121_), .O(new_n123_));
  aoi21  g57(.a(new_n119_), .b(x27), .c(new_n123_), .O(z14));
  nand4  g58(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n125_));
  inv1   g59(.a(new_n125_), .O(z15));
  nand2  g60(.a(x22), .b(x01), .O(new_n127_));
  nor2   g61(.a(new_n127_), .b(x23), .O(z16));
  inv1   g62(.a(x24), .O(new_n129_));
  nand4  g63(.a(new_n129_), .b(x23), .c(x22), .d(x01), .O(new_n130_));
  inv1   g64(.a(new_n130_), .O(z17));
  inv1   g65(.a(x29), .O(new_n134_));
  oai21  g66(.a(new_n83_), .b(new_n134_), .c(new_n75_), .O(new_n135_));
  nor2   g67(.a(x30), .b(x09), .O(new_n136_));
  oai21  g68(.a(new_n112_), .b(new_n72_), .c(new_n136_), .O(new_n137_));
  aoi21  g69(.a(new_n135_), .b(x08), .c(new_n137_), .O(z20));
  zero   g70(.O(z03));
  zero   g71(.O(z04));
  zero   g72(.O(z09));
  zero   g73(.O(z11));
