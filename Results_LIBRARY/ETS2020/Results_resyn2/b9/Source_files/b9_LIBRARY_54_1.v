// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:28 2020
...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n102_, new_n103_, new_n104_, new_n105_, new_n110_, new_n112_,
  ...
  nand4  g38(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n110_));
  inv1   g39(.a(new_n110_), .O(z15));
  nand2  g40(.a(x22), .b(x01), .O(new_n112_));
  nor2   g41(.a(new_n112_), .b(x23), .O(z16));
  inv1   g42(.a(x24), .O(new_n114_));
  nand4  g43(.a(new_n114_), .b(x23), .c(x22), .d(x01), .O(new_n115_));
  inv1   g44(.a(new_n115_), .O(z17));
