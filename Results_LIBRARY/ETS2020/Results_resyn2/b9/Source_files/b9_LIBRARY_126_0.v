...
module FAU ( 
  ...
  aoi21  g40(.a(new_n70_), .b(new_n69_), .c(new_n103_), .O(new_n105_));
  aoi21  g41(.a(new_n104_), .b(new_n68_), .c(new_n105_), .O(new_n106_));
  nand3  g42(.a(x37), .b(x27), .c(x06), .O(new_n107_));
  oai21  g43(.a(new_n106_), .b(x04), .c(new_n107_), .O(z10));
  inv1   g44(.a(x08), .O(new_n109_));
  nand3  g45(.a(x40), .b(x39), .c(x29), .O(new_n110_));
  aoi21  g46(.a(new_n110_), .b(new_n67_), .c(new_n109_), .O(new_n111_));
  nand2  g47(.a(new_n110_), .b(x27), .O(new_n112_));
  inv1   g48(.a(x04), .O(new_n113_));
  nand4  g49(.a(x35), .b(new_n66_), .c(x27), .d(new_n113_), .O(new_n114_));
  nor2   g50(.a(x30), .b(x09), .O(new_n115_));
  nand2  g51(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g52(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z11));
  nand2  g53(.a(x22), .b(x01), .O(new_n122_));
  nor2   g54(.a(new_n122_), .b(x23), .O(z16));
  inv1   g55(.a(x24), .O(new_n124_));
  nand4  g56(.a(new_n124_), .b(x23), .c(x22), .d(x01), .O(new_n125_));
  inv1   g57(.a(new_n125_), .O(z17));
  inv1   g58(.a(z11), .O(z18));
  oai21  g59(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n128_));
  nor2   g60(.a(new_n128_), .b(new_n111_), .O(z20));
  zero   g61(.O(z00));
  zero   g62(.O(z08));
  zero   g63(.O(z12));
  zero   g64(.O(z13));
