...
module FAU ( 
  ...
  nand2  g65(.a(x22), .b(x01), .O(new_n131_));
  nor2   g66(.a(new_n131_), .b(x23), .O(z16));
  inv1   g67(.a(x24), .O(new_n133_));
  nand4  g68(.a(new_n133_), .b(x23), .c(x22), .d(x01), .O(new_n134_));
  inv1   g69(.a(new_n134_), .O(z17));
  inv1   g70(.a(z11), .O(z18));
  oai21  g71(.a(new_n78_), .b(new_n71_), .c(new_n112_), .O(new_n137_));
  nor2   g72(.a(new_n137_), .b(new_n109_), .O(z20));
  zero   g73(.O(z02));
  zero   g74(.O(z09));
  zero   g75(.O(z15));
  aoi21  g76(.a(new_n110_), .b(new_n109_), .c(new_n113_), .O(z19));
endmodule
