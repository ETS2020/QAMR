...
module FAU ( 
  ...
  nand2  g66(.a(x35), .b(x27), .O(new_n133_));
  nand2  g67(.a(new_n133_), .b(new_n111_), .O(new_n134_));
  nor2   g68(.a(new_n134_), .b(new_n108_), .O(z20));
  zero   g69(.O(z01));
  zero   g70(.O(z10));
  zero   g71(.O(z16));
  zero   g72(.O(z17));
  aoi21  g73(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(z19));
endmodule
