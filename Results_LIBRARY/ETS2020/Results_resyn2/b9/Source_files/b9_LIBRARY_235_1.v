...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n114_, new_n115_, new_n116_, new_n122_, new_n126_;
  ...
  oai21  g54(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n126_));
  nor2   g55(.a(new_n126_), .b(new_n111_), .O(z20));
  zero   g56(.O(z00));
  zero   g57(.O(z05));
  zero   g58(.O(z06));
  zero   g59(.O(z08));
  ...
  zero   g63(.O(z15));
  zero   g64(.O(z17));
  aoi21  g65(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
