...
module FAU ( 
  ...
  nand2  g34(.a(x40), .b(x39), .O(new_n100_));
  inv1   g35(.a(new_n100_), .O(new_n101_));
  nor2   g36(.a(new_n73_), .b(new_n71_), .O(new_n102_));
  aoi22  g37(.a(new_n75_), .b(new_n101_), .c(new_n102_), .d(x07), .O(new_n103_));
  oai21  g38(.a(new_n100_), .b(x05), .c(new_n63_), .O(new_n104_));
  nand3  g39(.a(x37), .b(x27), .c(x06), .O(new_n105_));
  oai21  g40(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(z10));
  inv1   g41(.a(x08), .O(new_n107_));
  nand2  g42(.a(x35), .b(new_n72_), .O(new_n108_));
  nand2  g43(.a(new_n101_), .b(x29), .O(new_n109_));
  aoi21  g44(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  nand2  g45(.a(new_n109_), .b(x27), .O(new_n111_));
  nand4  g46(.a(x35), .b(new_n72_), .c(x27), .d(new_n63_), .O(new_n112_));
  nor2   g47(.a(x30), .b(x09), .O(new_n113_));
  nand2  g48(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  aoi21  g49(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(z11));
  nor2   g50(.a(x13), .b(x04), .O(new_n116_));
  nand2  g51(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  aoi21  g52(.a(x36), .b(x35), .c(new_n72_), .O(new_n118_));
  nor2   g53(.a(x19), .b(x18), .O(new_n119_));
  nand2  g54(.a(new_n119_), .b(x20), .O(new_n120_));
  oai22  g55(.a(new_n120_), .b(new_n66_), .c(new_n117_), .d(new_n118_), .O(new_n121_));
  ...
  oai22  g63(.a(new_n128_), .b(new_n117_), .c(new_n66_), .d(new_n71_), .O(new_n129_));
  ...
  oai21  g73(.a(new_n78_), .b(new_n71_), .c(new_n113_), .O(new_n139_));
  nor2   g74(.a(new_n139_), .b(new_n110_), .O(z20));
  zero   g75(.O(z02));
  zero   g76(.O(z08));
  zero   g77(.O(z09));
