...
module FAU ( 
  ...
  aoi22  g07(.a(new_n69_), .b(x27), .c(new_n64_), .d(x10), .O(z12));
  ...
  nor2   g37(.a(new_n74_), .b(new_n72_), .O(new_n102_));
  aoi22  g38(.a(new_n76_), .b(z08), .c(new_n102_), .d(x07), .O(new_n103_));
  oai21  g39(.a(new_n63_), .b(x05), .c(new_n67_), .O(new_n104_));
  ...
  aoi21  g44(.a(x36), .b(x35), .c(new_n73_), .O(new_n110_));
  inv1   g45(.a(x13), .O(new_n111_));
  nand2  g46(.a(new_n64_), .b(new_n111_), .O(new_n112_));
  oai22  g47(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n65_), .O(new_n113_));
  nand2  g48(.a(new_n113_), .b(x27), .O(new_n114_));
  or2    g49(.a(new_n112_), .b(new_n75_), .O(new_n115_));
  nand2  g50(.a(new_n115_), .b(new_n114_), .O(z13));
  nand4  g51(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n118_));
  inv1   g52(.a(new_n118_), .O(z15));
  nand2  g53(.a(x22), .b(x01), .O(new_n120_));
  nor2   g54(.a(new_n120_), .b(x23), .O(z16));
  inv1   g55(.a(x24), .O(new_n122_));
  nand4  g56(.a(new_n122_), .b(x23), .c(x22), .d(x01), .O(new_n123_));
  inv1   g57(.a(new_n123_), .O(z17));
  zero   g58(.O(z03));
  zero   g59(.O(z04));
  zero   g60(.O(z11));
  zero   g61(.O(z14));
