...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n122_, new_n123_, new_n126_, new_n128_, new_n131_, new_n133_,
    new_n134_;
  ...
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n131_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n131_), .O(z18));
  nand2  g66(.a(x35), .b(x27), .O(new_n133_));
  nand2  g67(.a(new_n133_), .b(new_n110_), .O(new_n134_));
  nor2   g68(.a(new_n134_), .b(new_n107_), .O(z20));
  zero   g69(.O(z01));
  zero   g70(.O(z09));
  zero   g71(.O(z10));
  zero   g72(.O(z17));
