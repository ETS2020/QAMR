...
module FAU ( 
  ...
  nand3  g31(.a(x40), .b(x39), .c(x29), .O(new_n99_));
  ...
  nand4  g39(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n110_));
  inv1   g40(.a(new_n110_), .O(z15));
  ...
  oai21  g47(.a(new_n79_), .b(new_n64_), .c(new_n104_), .O(new_n118_));
  nor2   g48(.a(new_n118_), .b(new_n100_), .O(z20));
  zero   g49(.O(z00));
  zero   g50(.O(z05));
  zero   g51(.O(z07));
  zero   g52(.O(z08));
