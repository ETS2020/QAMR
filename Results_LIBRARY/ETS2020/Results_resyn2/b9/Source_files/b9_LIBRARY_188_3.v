...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n133_, new_n135_, new_n137_, new_n138_;
  ...
  inv1   g61(.a(x08), .O(new_n127_));
  nand2  g62(.a(z08), .b(x29), .O(new_n128_));
  aoi21  g63(.a(new_n128_), .b(new_n75_), .c(new_n127_), .O(new_n129_));
  nand2  g64(.a(new_n128_), .b(x27), .O(new_n130_));
  nand2  g65(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g66(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n132_));
  nor2   g67(.a(x30), .b(x09), .O(new_n133_));
  nand3  g68(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(z18));
  nand2  g69(.a(new_n133_), .b(new_n132_), .O(new_n135_));
  aoi21  g70(.a(new_n130_), .b(new_n129_), .c(new_n135_), .O(z19));
  nand2  g71(.a(x35), .b(x27), .O(new_n137_));
  nand2  g72(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nor2   g73(.a(new_n138_), .b(new_n129_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z10));
  zero   g76(.O(z11));
endmodule
