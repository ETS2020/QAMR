...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n79_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_, new_n94_,
  ...
  inv1   g26(.a(new_n83_), .O(z08));
  nor2   g27(.a(x32), .b(x30), .O(new_n94_));
  nor2   g28(.a(new_n94_), .b(new_n83_), .O(new_n95_));
  ...
  nand2  g35(.a(x36), .b(x35), .O(new_n103_));
  nand2  g36(.a(new_n103_), .b(x28), .O(new_n104_));
  nor2   g37(.a(x13), .b(x04), .O(new_n105_));
  nand3  g38(.a(new_n105_), .b(new_n104_), .c(z08), .O(new_n106_));
  nor2   g39(.a(x19), .b(x18), .O(new_n107_));
  nand2  g40(.a(new_n107_), .b(x20), .O(new_n108_));
  oai21  g41(.a(new_n108_), .b(new_n63_), .c(new_n106_), .O(new_n109_));
  nand2  g42(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g43(.a(new_n105_), .b(new_n95_), .O(new_n111_));
  nand2  g44(.a(new_n111_), .b(new_n110_), .O(z13));
  nand2  g45(.a(new_n105_), .b(z08), .O(new_n113_));
  nand3  g46(.a(new_n103_), .b(new_n94_), .c(x28), .O(new_n114_));
  inv1   g47(.a(new_n114_), .O(new_n115_));
  oai21  g48(.a(new_n115_), .b(new_n113_), .c(new_n108_), .O(new_n116_));
  aoi21  g49(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n117_));
  oai22  g50(.a(new_n117_), .b(new_n113_), .c(new_n63_), .d(new_n72_), .O(new_n118_));
  nand2  g51(.a(new_n118_), .b(new_n116_), .O(z14));
  ...
  oai22  g57(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n125_), .O(new_n126_));
  nand2  g58(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g59(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n128_));
  nor2   g60(.a(x30), .b(x09), .O(new_n129_));
  nand3  g61(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(z18));
  zero   g62(.O(z03));
  zero   g63(.O(z04));
  zero   g64(.O(z07));
  zero   g65(.O(z09));
