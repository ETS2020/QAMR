...
module FAU ( 
  ...
  inv1   g24(.a(x25), .O(new_n88_));
  nand2  g25(.a(new_n88_), .b(x00), .O(new_n89_));
  inv1   g26(.a(x14), .O(new_n90_));
  nand2  g27(.a(x25), .b(new_n90_), .O(new_n91_));
  nand3  g28(.a(new_n91_), .b(new_n89_), .c(x38), .O(new_n92_));
  inv1   g29(.a(x17), .O(new_n93_));
  nor2   g30(.a(new_n93_), .b(x15), .O(new_n94_));
  or2    g31(.a(x33), .b(x31), .O(new_n95_));
  oai21  g32(.a(new_n95_), .b(new_n94_), .c(x14), .O(new_n96_));
  nand3  g33(.a(new_n96_), .b(new_n92_), .c(x03), .O(new_n97_));
  inv1   g34(.a(new_n97_), .O(z07));
  ...
  aoi21  g38(.a(new_n70_), .b(new_n69_), .c(new_n102_), .O(new_n104_));
  ...
  nand3  g43(.a(x40), .b(x39), .c(x29), .O(new_n109_));
  aoi21  g44(.a(new_n109_), .b(new_n67_), .c(new_n108_), .O(new_n110_));
  nand2  g45(.a(new_n109_), .b(x27), .O(new_n111_));
  inv1   g46(.a(x04), .O(new_n112_));
  nand4  g47(.a(x35), .b(new_n66_), .c(x27), .d(new_n112_), .O(new_n113_));
  nor2   g48(.a(x30), .b(x09), .O(new_n114_));
  nand2  g49(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g50(.a(new_n111_), .b(new_n110_), .c(new_n115_), .O(z11));
  ...
  oai21  g57(.a(new_n79_), .b(new_n64_), .c(new_n114_), .O(new_n127_));
  nor2   g58(.a(new_n127_), .b(new_n110_), .O(z20));
  zero   g59(.O(z00));
  zero   g60(.O(z08));
  zero   g61(.O(z09));
  zero   g62(.O(z12));
