...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n102_, new_n103_, new_n104_, new_n105_, new_n111_, new_n115_;
  ...
  inv1   g40(.a(z11), .O(z18));
  oai21  g41(.a(new_n79_), .b(new_n64_), .c(new_n104_), .O(new_n115_));
  nor2   g42(.a(new_n115_), .b(new_n100_), .O(z20));
  zero   g43(.O(z00));
  zero   g44(.O(z05));
  zero   g45(.O(z06));
  zero   g46(.O(z07));
  ...
  zero   g52(.O(z15));
  zero   g53(.O(z17));
  aoi21  g54(.a(new_n101_), .b(new_n100_), .c(new_n105_), .O(z19));
endmodule
