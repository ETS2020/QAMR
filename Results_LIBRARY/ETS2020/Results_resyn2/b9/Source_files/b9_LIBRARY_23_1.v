...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n109_, new_n110_, new_n111_, new_n112_, new_n117_, new_n119_,
    new_n120_, new_n123_;
  ...
  nand3  g40(.a(x40), .b(x39), .c(new_n103_), .O(new_n108_));
  inv1   g41(.a(new_n108_), .O(new_n109_));
  nor2   g42(.a(x36), .b(x35), .O(new_n110_));
  aoi21  g43(.a(x35), .b(x28), .c(x37), .O(new_n111_));
  oai21  g44(.a(new_n110_), .b(new_n108_), .c(new_n111_), .O(new_n112_));
  aoi22  g45(.a(new_n112_), .b(x27), .c(new_n109_), .d(x10), .O(z12));
  nand2  g46(.a(x22), .b(x01), .O(new_n117_));
  nor2   g47(.a(new_n117_), .b(x23), .O(z16));
  inv1   g48(.a(x24), .O(new_n119_));
  nand4  g49(.a(new_n119_), .b(x23), .c(x22), .d(x01), .O(new_n120_));
  inv1   g50(.a(new_n120_), .O(z17));
  inv1   g51(.a(z11), .O(z18));
  oai21  g52(.a(new_n79_), .b(new_n64_), .c(new_n105_), .O(new_n123_));
  nor2   g53(.a(new_n123_), .b(new_n101_), .O(z20));
  zero   g54(.O(z00));
  zero   g55(.O(z05));
  zero   g56(.O(z06));
  zero   g57(.O(z07));
  ...
  zero   g60(.O(z14));
  zero   g61(.O(z15));
  aoi21  g62(.a(new_n102_), .b(new_n101_), .c(new_n106_), .O(z19));
endmodule
