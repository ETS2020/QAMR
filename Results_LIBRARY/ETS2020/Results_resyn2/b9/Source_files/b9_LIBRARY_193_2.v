...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n117_, new_n119_, new_n121_, new_n125_, new_n126_, new_n127_,
    new_n128_, new_n129_;
  ...
  inv1   g56(.a(x29), .O(new_n125_));
  oai22  g57(.a(new_n77_), .b(x27), .c(new_n80_), .d(new_n125_), .O(new_n126_));
  nand2  g58(.a(x27), .b(new_n63_), .O(new_n127_));
  nor2   g59(.a(x30), .b(x09), .O(new_n128_));
  oai21  g60(.a(new_n127_), .b(new_n77_), .c(new_n128_), .O(new_n129_));
  aoi21  g61(.a(new_n126_), .b(x08), .c(new_n129_), .O(z19));
  zero   g62(.O(z03));
  zero   g63(.O(z04));
  zero   g64(.O(z11));
  zero   g65(.O(z13));
