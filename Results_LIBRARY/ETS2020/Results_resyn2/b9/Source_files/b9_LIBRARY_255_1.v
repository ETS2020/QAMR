...
module FAU ( 
  ...
  nand2  g36(.a(x27), .b(new_n103_), .O(new_n104_));
  nor2   g37(.a(x30), .b(x09), .O(new_n105_));
  oai21  g38(.a(new_n104_), .b(new_n67_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g47(.a(new_n79_), .b(new_n64_), .c(new_n105_), .O(new_n119_));
  nor2   g48(.a(new_n119_), .b(new_n101_), .O(z20));
  zero   g49(.O(z00));
  zero   g50(.O(z05));
  zero   g51(.O(z06));
  zero   g52(.O(z07));
