// Benchmark "FAU" written by ABC on Fri Jul 24 22:25:01 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n80_, new_n81_, new_n82_, new_n91_, new_n92_, new_n93_, new_n94_,
    new_n97_, new_n98_, new_n99_, new_n100_, new_n101_, new_n102_,
    new_n103_, new_n106_, new_n108_;
  ...
  nor2   g24(.a(new_n73_), .b(new_n71_), .O(new_n91_));
  aoi22  g25(.a(new_n75_), .b(z08), .c(new_n91_), .d(x07), .O(new_n92_));
  oai21  g26(.a(new_n80_), .b(x05), .c(new_n63_), .O(new_n93_));
  nand3  g27(.a(x37), .b(x27), .c(x06), .O(new_n94_));
  oai21  g28(.a(new_n93_), .b(new_n92_), .c(new_n94_), .O(z10));
  aoi21  g29(.a(x36), .b(x35), .c(new_n72_), .O(new_n97_));
  nor2   g30(.a(x13), .b(x04), .O(new_n98_));
  nand2  g31(.a(new_n98_), .b(z08), .O(new_n99_));
  nor2   g32(.a(x19), .b(x18), .O(new_n100_));
  nand2  g33(.a(new_n100_), .b(x20), .O(new_n101_));
  oai22  g34(.a(new_n101_), .b(new_n66_), .c(new_n99_), .d(new_n97_), .O(new_n102_));
  nor2   g35(.a(new_n99_), .b(new_n74_), .O(new_n103_));
  aoi21  g36(.a(new_n102_), .b(x27), .c(new_n103_), .O(z14));
  inv1   g37(.a(z14), .O(z13));
  nand4  g38(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n106_));
  inv1   g39(.a(new_n106_), .O(z15));
  nand2  g40(.a(x22), .b(x01), .O(new_n108_));
  nor2   g41(.a(new_n108_), .b(x23), .O(z16));
  zero   g42(.O(z03));
  zero   g43(.O(z04));
  zero   g44(.O(z07));
  zero   g45(.O(z09));
