...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n122_, new_n124_, new_n126_, new_n128_, new_n133_, new_n134_,
    new_n135_, new_n136_;
  ...
  inv1   g64(.a(x29), .O(new_n133_));
  oai21  g65(.a(new_n83_), .b(new_n133_), .c(new_n75_), .O(new_n134_));
  nor2   g66(.a(x30), .b(x09), .O(new_n135_));
  oai21  g67(.a(new_n113_), .b(new_n72_), .c(new_n135_), .O(new_n136_));
  aoi21  g68(.a(new_n134_), .b(x08), .c(new_n136_), .O(z20));
  zero   g69(.O(z03));
  zero   g70(.O(z04));
  zero   g71(.O(z11));
  zero   g72(.O(z17));
