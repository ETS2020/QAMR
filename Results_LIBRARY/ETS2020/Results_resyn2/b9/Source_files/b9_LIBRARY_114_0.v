...
module FAU ( 
  ...
  nand4  g67(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n131_));
  inv1   g68(.a(new_n131_), .O(z15));
  nand2  g69(.a(x22), .b(x01), .O(new_n133_));
  nor2   g70(.a(new_n133_), .b(x23), .O(z16));
  inv1   g71(.a(x24), .O(new_n135_));
  nand4  g72(.a(new_n135_), .b(x23), .c(x22), .d(x01), .O(new_n136_));
  inv1   g73(.a(new_n136_), .O(z17));
  inv1   g74(.a(z11), .O(z18));
  oai21  g75(.a(new_n78_), .b(new_n71_), .c(new_n113_), .O(new_n139_));
  nor2   g76(.a(new_n139_), .b(new_n110_), .O(z20));
  zero   g77(.O(z02));
  aoi21  g78(.a(new_n111_), .b(new_n110_), .c(new_n114_), .O(z19));
endmodule
