...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n122_, new_n123_, new_n124_, new_n127_, new_n130_, new_n131_,
  ...
  nand2  g67(.a(new_n109_), .b(new_n108_), .O(new_n133_));
  nand3  g68(.a(new_n111_), .b(new_n110_), .c(new_n133_), .O(z18));
  nand2  g69(.a(x35), .b(x27), .O(new_n135_));
  nand2  g70(.a(new_n135_), .b(new_n111_), .O(new_n136_));
  nor2   g71(.a(new_n136_), .b(new_n108_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z10));
  zero   g74(.O(z16));
  aoi21  g75(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(z19));
endmodule
