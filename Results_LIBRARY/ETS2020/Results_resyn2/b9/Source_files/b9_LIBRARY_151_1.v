...
module FAU ( 
  ...
  nor2   g44(.a(x19), .b(x18), .O(new_n114_));
  nand2  g45(.a(new_n114_), .b(x20), .O(new_n115_));
  inv1   g46(.a(x13), .O(new_n116_));
  nand2  g47(.a(x36), .b(x35), .O(new_n117_));
  nand3  g48(.a(new_n117_), .b(new_n74_), .c(x28), .O(new_n118_));
  nand3  g49(.a(new_n118_), .b(new_n65_), .c(new_n116_), .O(new_n119_));
  nand2  g50(.a(new_n119_), .b(new_n115_), .O(new_n120_));
  oai21  g51(.a(x28), .b(new_n71_), .c(new_n74_), .O(new_n121_));
  nand3  g52(.a(new_n121_), .b(new_n65_), .c(new_n116_), .O(new_n122_));
  oai21  g53(.a(new_n66_), .b(new_n71_), .c(new_n122_), .O(new_n123_));
  nand2  g54(.a(new_n123_), .b(new_n120_), .O(z14));
  nand2  g55(.a(x22), .b(x01), .O(new_n126_));
  nor2   g56(.a(new_n126_), .b(x23), .O(z16));
  inv1   g57(.a(x24), .O(new_n128_));
  nand4  g58(.a(new_n128_), .b(x23), .c(x22), .d(x01), .O(new_n129_));
  inv1   g59(.a(new_n129_), .O(z17));
  inv1   g60(.a(z11), .O(z18));
  oai21  g61(.a(new_n84_), .b(new_n71_), .c(new_n109_), .O(new_n132_));
  nor2   g62(.a(new_n132_), .b(new_n106_), .O(z20));
  zero   g63(.O(z05));
  zero   g64(.O(z06));
  zero   g65(.O(z07));
  zero   g66(.O(z08));
  ...
  zero   g69(.O(z13));
  zero   g70(.O(z15));
  aoi21  g71(.a(new_n107_), .b(new_n106_), .c(new_n110_), .O(z19));
endmodule
