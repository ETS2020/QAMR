...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n121_, new_n122_, new_n126_, new_n128_, new_n130_, new_n131_,
    new_n134_;
  ...
  nand3  g51(.a(x40), .b(x39), .c(new_n113_), .O(new_n118_));
  inv1   g52(.a(new_n118_), .O(new_n119_));
  nor2   g53(.a(x36), .b(x35), .O(new_n120_));
  aoi21  g54(.a(x35), .b(x28), .c(x37), .O(new_n121_));
  oai21  g55(.a(new_n120_), .b(new_n118_), .c(new_n121_), .O(new_n122_));
  aoi22  g56(.a(new_n122_), .b(x27), .c(new_n119_), .d(x10), .O(z12));
  nand4  g57(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n126_));
  inv1   g58(.a(new_n126_), .O(z15));
  ...
  oai21  g65(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n134_));
  nor2   g66(.a(new_n134_), .b(new_n111_), .O(z20));
  zero   g67(.O(z00));
  zero   g68(.O(z05));
  zero   g69(.O(z06));
  zero   g70(.O(z08));
  zero   g71(.O(z13));
  zero   g72(.O(z14));
  aoi21  g73(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
