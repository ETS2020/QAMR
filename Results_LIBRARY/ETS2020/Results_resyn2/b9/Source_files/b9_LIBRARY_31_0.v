...
module FAU ( 
  ...
  nand2  g38(.a(new_n75_), .b(x07), .O(new_n102_));
  nand3  g39(.a(x40), .b(x39), .c(x05), .O(new_n103_));
  nand2  g40(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g41(.a(new_n70_), .b(new_n69_), .c(new_n103_), .O(new_n105_));
  ...
  aoi21  g47(.a(new_n110_), .b(new_n67_), .c(new_n109_), .O(new_n111_));
  nand2  g48(.a(new_n110_), .b(x27), .O(new_n112_));
  inv1   g49(.a(x04), .O(new_n113_));
  nand4  g50(.a(x35), .b(new_n66_), .c(x27), .d(new_n113_), .O(new_n114_));
  nor2   g51(.a(x30), .b(x09), .O(new_n115_));
  nand2  g52(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g53(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z11));
  ...
  nand2  g59(.a(new_n112_), .b(new_n111_), .O(new_n127_));
  nand3  g60(.a(new_n115_), .b(new_n114_), .c(new_n127_), .O(z18));
  oai21  g61(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n129_));
  nor2   g62(.a(new_n129_), .b(new_n111_), .O(z20));
  zero   g63(.O(z00));
  zero   g64(.O(z12));
  zero   g65(.O(z13));
  zero   g66(.O(z14));
