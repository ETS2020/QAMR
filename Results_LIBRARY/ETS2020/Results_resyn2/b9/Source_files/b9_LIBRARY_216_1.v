// Benchmark "FAU" written by ABC on Fri Jul 24 22:25:07 2020
...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n114_, new_n115_, new_n116_, new_n122_, new_n124_, new_n125_,
    new_n128_;
  ...
  oai21  g57(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n128_));
  nor2   g58(.a(new_n128_), .b(new_n111_), .O(z20));
  zero   g59(.O(z00));
  zero   g60(.O(z05));
  zero   g61(.O(z06));
  zero   g62(.O(z08));
  ...
  zero   g65(.O(z14));
  zero   g66(.O(z15));
  aoi21  g67(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
