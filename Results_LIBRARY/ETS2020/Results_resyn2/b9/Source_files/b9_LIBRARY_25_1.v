...
module FAU ( 
  ...
  nand2  g29(.a(new_n93_), .b(x00), .O(new_n94_));
  inv1   g30(.a(x14), .O(new_n95_));
  nand2  g31(.a(x25), .b(new_n95_), .O(new_n96_));
  nand3  g32(.a(new_n96_), .b(new_n94_), .c(x38), .O(new_n97_));
  inv1   g33(.a(x17), .O(new_n98_));
  nor2   g34(.a(new_n98_), .b(x15), .O(new_n99_));
  or2    g35(.a(x33), .b(x31), .O(new_n100_));
  oai21  g36(.a(new_n100_), .b(new_n99_), .c(x14), .O(new_n101_));
  nand3  g37(.a(new_n101_), .b(new_n97_), .c(x03), .O(new_n102_));
  inv1   g38(.a(new_n102_), .O(z07));
  inv1   g39(.a(new_n80_), .O(z08));
  nor2   g40(.a(new_n73_), .b(new_n71_), .O(new_n106_));
  nand2  g41(.a(z08), .b(x05), .O(new_n107_));
  inv1   g42(.a(new_n107_), .O(new_n108_));
  and2   g43(.a(new_n80_), .b(x07), .O(new_n109_));
  aoi22  g44(.a(new_n109_), .b(new_n106_), .c(new_n108_), .d(new_n75_), .O(new_n110_));
  ...
  aoi21  g49(.a(new_n114_), .b(new_n77_), .c(new_n113_), .O(new_n115_));
  nand2  g50(.a(new_n114_), .b(x27), .O(new_n116_));
  nand4  g51(.a(x35), .b(new_n72_), .c(x27), .d(new_n63_), .O(new_n117_));
  nor2   g52(.a(x30), .b(x09), .O(new_n118_));
  nand2  g53(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g54(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(z11));
  ...
  oai21  g63(.a(new_n84_), .b(new_n71_), .c(new_n118_), .O(new_n131_));
  nor2   g64(.a(new_n131_), .b(new_n115_), .O(z20));
  zero   g65(.O(z05));
  zero   g66(.O(z06));
  zero   g67(.O(z09));
  zero   g68(.O(z13));
  zero   g69(.O(z14));
  aoi21  g70(.a(new_n116_), .b(new_n115_), .c(new_n119_), .O(z19));
endmodule
