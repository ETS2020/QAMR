...
module FAU ( 
  ...
  nand2  g64(.a(x22), .b(x01), .O(new_n129_));
  nor2   g65(.a(new_n129_), .b(x23), .O(z16));
  inv1   g66(.a(x24), .O(new_n131_));
  nand4  g67(.a(new_n131_), .b(x23), .c(x22), .d(x01), .O(new_n132_));
  inv1   g68(.a(new_n132_), .O(z17));
  nand2  g69(.a(new_n109_), .b(new_n108_), .O(new_n134_));
  nand3  g70(.a(new_n111_), .b(new_n110_), .c(new_n134_), .O(z18));
  nand2  g71(.a(x35), .b(x27), .O(new_n136_));
  nand2  g72(.a(new_n136_), .b(new_n111_), .O(new_n137_));
  nor2   g73(.a(new_n137_), .b(new_n108_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z10));
  aoi21  g76(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(z19));
endmodule
