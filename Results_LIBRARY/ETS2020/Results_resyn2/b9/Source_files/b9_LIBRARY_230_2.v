...
module FAU ( 
  ...
  inv1   g72(.a(x29), .O(new_n139_));
  oai22  g73(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n139_), .O(new_n140_));
  nand2  g74(.a(x27), .b(new_n65_), .O(new_n141_));
  nor2   g75(.a(x30), .b(x09), .O(new_n142_));
  oai21  g76(.a(new_n141_), .b(new_n75_), .c(new_n142_), .O(new_n143_));
  aoi21  g77(.a(new_n140_), .b(x08), .c(new_n143_), .O(z19));
  zero   g78(.O(z03));
  zero   g79(.O(z04));
  zero   g80(.O(z11));
  zero   g81(.O(z18));
