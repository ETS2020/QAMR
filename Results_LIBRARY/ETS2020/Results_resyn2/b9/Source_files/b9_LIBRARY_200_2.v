...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n79_, new_n80_, new_n81_, new_n82_, new_n90_, new_n92_, new_n93_,
  ...
  aoi22  g27(.a(z08), .b(new_n75_), .c(new_n92_), .d(x07), .O(new_n93_));
  ...
  aoi21  g31(.a(x36), .b(x35), .c(new_n72_), .O(new_n99_));
  nor2   g32(.a(x13), .b(x04), .O(new_n100_));
  nand2  g33(.a(new_n100_), .b(z08), .O(new_n101_));
  nor2   g34(.a(x19), .b(x18), .O(new_n102_));
  nand2  g35(.a(new_n102_), .b(x20), .O(new_n103_));
  oai22  g36(.a(new_n103_), .b(new_n67_), .c(new_n101_), .d(new_n99_), .O(new_n104_));
  nor2   g37(.a(new_n101_), .b(new_n74_), .O(new_n105_));
  aoi21  g38(.a(new_n104_), .b(x27), .c(new_n105_), .O(z14));
  inv1   g39(.a(z14), .O(z13));
  nand2  g40(.a(x22), .b(x01), .O(new_n109_));
  nor2   g41(.a(new_n109_), .b(x23), .O(z16));
  zero   g42(.O(z03));
  zero   g43(.O(z04));
  zero   g44(.O(z07));
  zero   g45(.O(z11));
