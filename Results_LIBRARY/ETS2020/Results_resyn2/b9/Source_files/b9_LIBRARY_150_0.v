...
module FAU ( 
  ...
  nand2  g60(.a(new_n125_), .b(x20), .O(new_n126_));
  inv1   g61(.a(x13), .O(new_n127_));
  nand2  g62(.a(x36), .b(x35), .O(new_n128_));
  nand3  g63(.a(new_n128_), .b(new_n74_), .c(x28), .O(new_n129_));
  nand3  g64(.a(new_n129_), .b(new_n65_), .c(new_n127_), .O(new_n130_));
  nand2  g65(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  oai21  g66(.a(x28), .b(new_n71_), .c(new_n74_), .O(new_n132_));
  nand3  g67(.a(new_n132_), .b(new_n65_), .c(new_n127_), .O(new_n133_));
  oai21  g68(.a(new_n66_), .b(new_n71_), .c(new_n133_), .O(new_n134_));
  nand2  g69(.a(new_n134_), .b(new_n131_), .O(z14));
  ...
  oai21  g76(.a(new_n84_), .b(new_n71_), .c(new_n120_), .O(new_n143_));
  nor2   g77(.a(new_n143_), .b(new_n117_), .O(z20));
  zero   g78(.O(z08));
  zero   g79(.O(z12));
  zero   g80(.O(z13));
  zero   g81(.O(z15));
  aoi21  g82(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
