// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:39 2020
...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n113_, new_n115_, new_n116_, new_n118_, new_n120_;
  ...
  nand2  g48(.a(new_n102_), .b(new_n101_), .O(new_n118_));
  nand3  g49(.a(new_n105_), .b(new_n104_), .c(new_n118_), .O(z18));
  oai21  g50(.a(new_n79_), .b(new_n64_), .c(new_n105_), .O(new_n120_));
  nor2   g51(.a(new_n120_), .b(new_n101_), .O(z20));
  zero   g52(.O(z00));
  zero   g53(.O(z05));
  zero   g54(.O(z06));
  zero   g55(.O(z07));
  ...
  zero   g57(.O(z13));
  zero   g58(.O(z14));
  aoi21  g59(.a(new_n102_), .b(new_n101_), .c(new_n106_), .O(z19));
endmodule
