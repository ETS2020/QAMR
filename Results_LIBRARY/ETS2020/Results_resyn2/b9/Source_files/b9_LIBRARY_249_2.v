...
module FAU ( 
  ...
  nand2  g53(.a(x22), .b(x01), .O(new_n119_));
  nor2   g54(.a(new_n119_), .b(x23), .O(z16));
  inv1   g55(.a(x24), .O(new_n121_));
  nand4  g56(.a(new_n121_), .b(x23), .c(x22), .d(x01), .O(new_n122_));
  inv1   g57(.a(new_n122_), .O(z17));
  zero   g58(.O(z03));
  zero   g59(.O(z04));
  zero   g60(.O(z11));
  zero   g61(.O(z18));
