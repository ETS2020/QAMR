// Benchmark "FAU" written by ABC on Fri Jul 24 22:25:08 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n129_, new_n131_, new_n136_, new_n137_, new_n138_, new_n139_,
    new_n140_;
  ...
  nor2   g40(.a(x32), .b(x30), .O(new_n105_));
  nor2   g41(.a(new_n105_), .b(new_n83_), .O(new_n106_));
  inv1   g42(.a(x07), .O(new_n107_));
  nand2  g43(.a(new_n83_), .b(new_n107_), .O(new_n108_));
  aoi21  g44(.a(new_n108_), .b(new_n76_), .c(new_n106_), .O(new_n109_));
  oai21  g45(.a(new_n83_), .b(x05), .c(new_n65_), .O(new_n110_));
  nand3  g46(.a(x37), .b(x27), .c(x06), .O(new_n111_));
  oai21  g47(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(z10));
  nand2  g48(.a(x36), .b(x35), .O(new_n114_));
  nand2  g49(.a(new_n114_), .b(x28), .O(new_n115_));
  nor2   g50(.a(x13), .b(x04), .O(new_n116_));
  nand3  g51(.a(new_n116_), .b(new_n115_), .c(z08), .O(new_n117_));
  nor2   g52(.a(x19), .b(x18), .O(new_n118_));
  nand2  g53(.a(new_n118_), .b(x20), .O(new_n119_));
  oai21  g54(.a(new_n119_), .b(new_n63_), .c(new_n117_), .O(new_n120_));
  nand2  g55(.a(new_n120_), .b(x27), .O(new_n121_));
  nand2  g56(.a(new_n116_), .b(new_n106_), .O(new_n122_));
  nand2  g57(.a(new_n122_), .b(new_n121_), .O(z13));
  nand2  g58(.a(new_n116_), .b(z08), .O(new_n124_));
  nand3  g59(.a(new_n114_), .b(new_n105_), .c(x28), .O(new_n125_));
  inv1   g60(.a(new_n125_), .O(new_n126_));
  oai21  g61(.a(new_n126_), .b(new_n124_), .c(new_n119_), .O(new_n127_));
  aoi21  g62(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n128_));
  oai22  g63(.a(new_n128_), .b(new_n124_), .c(new_n63_), .d(new_n72_), .O(new_n129_));
  nand2  g64(.a(new_n129_), .b(new_n127_), .O(z14));
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n131_));
  inv1   g66(.a(new_n131_), .O(z15));
  inv1   g67(.a(x29), .O(new_n136_));
  oai22  g68(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n136_), .O(new_n137_));
  nand2  g69(.a(x27), .b(new_n65_), .O(new_n138_));
  nor2   g70(.a(x30), .b(x09), .O(new_n139_));
  oai21  g71(.a(new_n138_), .b(new_n75_), .c(new_n139_), .O(new_n140_));
  aoi21  g72(.a(new_n137_), .b(x08), .c(new_n140_), .O(z19));
  zero   g73(.O(z03));
  zero   g74(.O(z04));
  zero   g75(.O(z11));
  zero   g76(.O(z16));
