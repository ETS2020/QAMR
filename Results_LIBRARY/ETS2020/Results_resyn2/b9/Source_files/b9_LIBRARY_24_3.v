// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:20 2020
...
module FAU ( 
  ...
  inv1   g55(.a(x29), .O(new_n118_));
  oai22  g56(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n118_), .O(new_n119_));
  inv1   g57(.a(x09), .O(new_n120_));
  nand4  g58(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n121_));
  nand3  g59(.a(new_n121_), .b(new_n77_), .c(new_n120_), .O(new_n122_));
  aoi21  g60(.a(new_n119_), .b(x08), .c(new_n122_), .O(z11));
  nand2  g61(.a(x36), .b(x35), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(x28), .O(new_n125_));
  nor2   g63(.a(x13), .b(x04), .O(new_n126_));
  ...
  oai21  g67(.a(new_n129_), .b(new_n63_), .c(new_n127_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  nand2  g69(.a(new_n126_), .b(new_n111_), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n131_), .O(z13));
  nand2  g71(.a(new_n126_), .b(z08), .O(new_n134_));
  nand3  g72(.a(new_n124_), .b(new_n110_), .c(x28), .O(new_n135_));
  inv1   g73(.a(new_n135_), .O(new_n136_));
  oai21  g74(.a(new_n136_), .b(new_n134_), .c(new_n129_), .O(new_n137_));
  aoi21  g75(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n138_));
  oai22  g76(.a(new_n138_), .b(new_n134_), .c(new_n63_), .d(new_n72_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(z14));
  nand4  g78(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n141_));
  inv1   g79(.a(new_n141_), .O(z15));
  inv1   g80(.a(z11), .O(z18));
  zero   g81(.O(z16));
  zero   g82(.O(z17));
  zero   g83(.O(z20));
