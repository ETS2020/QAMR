...
module FAU ( 
  ...
  inv1   g71(.a(new_n134_), .O(z17));
  nand2  g72(.a(new_n112_), .b(new_n111_), .O(new_n136_));
  nand3  g73(.a(new_n114_), .b(new_n113_), .c(new_n136_), .O(z18));
  nand2  g74(.a(x35), .b(x27), .O(new_n138_));
  nand2  g75(.a(new_n138_), .b(new_n114_), .O(new_n139_));
  nor2   g76(.a(new_n139_), .b(new_n111_), .O(z20));
  zero   g77(.O(z10));
