...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n114_, new_n115_, new_n116_, new_n121_, new_n123_, new_n127_;
  ...
  oai21  g56(.a(new_n79_), .b(new_n64_), .c(new_n115_), .O(new_n127_));
  nor2   g57(.a(new_n127_), .b(new_n111_), .O(z20));
  zero   g58(.O(z00));
  zero   g59(.O(z05));
  zero   g60(.O(z06));
  zero   g61(.O(z08));
  ...
  zero   g64(.O(z14));
  zero   g65(.O(z17));
  aoi21  g66(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
