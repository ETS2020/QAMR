...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n131_, new_n134_, new_n136_, new_n137_;
  ...
  nand2  g46(.a(z08), .b(x29), .O(new_n110_));
  aoi21  g47(.a(new_n110_), .b(new_n75_), .c(new_n109_), .O(new_n111_));
  nand2  g48(.a(new_n110_), .b(x27), .O(new_n112_));
  nand4  g49(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n113_));
  nor2   g50(.a(x30), .b(x09), .O(new_n114_));
  nand2  g51(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g52(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(z11));
  aoi21  g53(.a(x36), .b(x35), .c(new_n74_), .O(new_n117_));
  nor2   g54(.a(x13), .b(x04), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(z08), .O(new_n119_));
  nand2  g56(.a(new_n86_), .b(new_n88_), .O(new_n120_));
  ...
  nand2  g62(.a(new_n125_), .b(new_n77_), .O(new_n126_));
  nand2  g63(.a(new_n126_), .b(new_n124_), .O(z13));
  aoi22  g64(.a(new_n123_), .b(x27), .c(new_n125_), .d(new_n77_), .O(z14));
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n129_));
  inv1   g66(.a(new_n129_), .O(z15));
  nand2  g67(.a(x22), .b(x01), .O(new_n131_));
  nor2   g68(.a(new_n131_), .b(x23), .O(z16));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n134_));
  nand3  g70(.a(new_n114_), .b(new_n113_), .c(new_n134_), .O(z18));
  nand2  g71(.a(x35), .b(x27), .O(new_n136_));
  nand2  g72(.a(new_n136_), .b(new_n114_), .O(new_n137_));
  nor2   g73(.a(new_n137_), .b(new_n111_), .O(z20));
  zero   g74(.O(z10));
  zero   g75(.O(z17));
  aoi21  g76(.a(new_n112_), .b(new_n111_), .c(new_n115_), .O(z19));
endmodule
