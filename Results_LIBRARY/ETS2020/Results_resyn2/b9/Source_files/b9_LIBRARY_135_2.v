...
module FAU ( 
  ...
  nand2  g36(.a(x36), .b(x35), .O(new_n104_));
  nand2  g37(.a(new_n104_), .b(x28), .O(new_n105_));
  nor2   g38(.a(x13), .b(x04), .O(new_n106_));
  nand3  g39(.a(new_n106_), .b(new_n105_), .c(z08), .O(new_n107_));
  nor2   g40(.a(x19), .b(x18), .O(new_n108_));
  nand2  g41(.a(new_n108_), .b(x20), .O(new_n109_));
  oai21  g42(.a(new_n109_), .b(new_n63_), .c(new_n107_), .O(new_n110_));
  nand2  g43(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g44(.a(new_n106_), .b(z08), .O(new_n112_));
  inv1   g45(.a(new_n112_), .O(new_n113_));
  nand2  g46(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  nand2  g47(.a(new_n114_), .b(new_n111_), .O(z13));
  aoi22  g48(.a(new_n110_), .b(x27), .c(new_n113_), .d(new_n77_), .O(z14));
