...
module FAU ( 
  ...
  nand2  g45(.a(x27), .b(new_n65_), .O(new_n110_));
  nor2   g46(.a(x30), .b(x09), .O(new_n111_));
  oai21  g47(.a(new_n110_), .b(new_n75_), .c(new_n111_), .O(new_n112_));
  ...
  nand2  g67(.a(x35), .b(x27), .O(new_n134_));
  nand2  g68(.a(new_n134_), .b(new_n111_), .O(new_n135_));
  nor2   g69(.a(new_n135_), .b(new_n108_), .O(z20));
  zero   g70(.O(z01));
  zero   g71(.O(z10));
  zero   g72(.O(z16));
  zero   g73(.O(z18));
