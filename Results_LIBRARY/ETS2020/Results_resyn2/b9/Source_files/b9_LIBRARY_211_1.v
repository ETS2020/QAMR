...
module FAU ( 
  ...
  nand2  g34(.a(new_n75_), .b(x07), .O(new_n101_));
  nand3  g35(.a(x40), .b(x39), .c(x05), .O(new_n102_));
  nand2  g36(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n102_), .O(new_n104_));
  ...
  inv1   g57(.a(z11), .O(z18));
  oai21  g58(.a(new_n79_), .b(new_n64_), .c(new_n114_), .O(new_n128_));
  nor2   g59(.a(new_n128_), .b(new_n110_), .O(z20));
  zero   g60(.O(z00));
  zero   g61(.O(z06));
  zero   g62(.O(z08));
  zero   g63(.O(z09));
