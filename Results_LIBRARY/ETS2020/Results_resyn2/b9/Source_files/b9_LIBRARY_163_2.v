...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n71_,
    ...
    new_n103_, new_n104_, new_n107_, new_n110_, new_n111_;
  ...
  inv1   g42(.a(x24), .O(new_n110_));
  nand4  g43(.a(new_n110_), .b(x23), .c(x22), .d(x01), .O(new_n111_));
  inv1   g44(.a(new_n111_), .O(z17));
  zero   g45(.O(z03));
  zero   g46(.O(z04));
  zero   g47(.O(z07));
  zero   g48(.O(z11));
