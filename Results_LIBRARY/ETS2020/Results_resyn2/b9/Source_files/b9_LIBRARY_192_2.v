...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n129_, new_n131_, new_n134_, new_n135_, new_n138_, new_n139_,
  ...
  inv1   g70(.a(x29), .O(new_n138_));
  oai22  g71(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n138_), .O(new_n139_));
  nand2  g72(.a(x27), .b(new_n65_), .O(new_n140_));
  nor2   g73(.a(x30), .b(x09), .O(new_n141_));
  oai21  g74(.a(new_n140_), .b(new_n75_), .c(new_n141_), .O(new_n142_));
  aoi21  g75(.a(new_n139_), .b(x08), .c(new_n142_), .O(z19));
  zero   g76(.O(z03));
  zero   g77(.O(z04));
  zero   g78(.O(z11));
  zero   g79(.O(z16));
