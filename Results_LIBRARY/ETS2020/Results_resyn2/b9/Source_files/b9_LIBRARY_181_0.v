...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n120_, new_n121_, new_n127_, new_n129_, new_n130_, new_n133_;
  ...
  nor2   g43(.a(new_n73_), .b(new_n71_), .O(new_n107_));
  inv1   g44(.a(new_n80_), .O(new_n108_));
  nand2  g45(.a(new_n108_), .b(x05), .O(new_n109_));
  inv1   g46(.a(new_n109_), .O(new_n110_));
  and2   g47(.a(new_n80_), .b(x07), .O(new_n111_));
  aoi22  g48(.a(new_n111_), .b(new_n107_), .c(new_n110_), .d(new_n75_), .O(new_n112_));
  nand3  g49(.a(x37), .b(x27), .c(x06), .O(new_n113_));
  oai21  g50(.a(new_n112_), .b(x04), .c(new_n113_), .O(z10));
  inv1   g51(.a(x08), .O(new_n115_));
  nand2  g52(.a(new_n108_), .b(x29), .O(new_n116_));
  aoi21  g53(.a(new_n116_), .b(new_n77_), .c(new_n115_), .O(new_n117_));
  nand2  g54(.a(new_n116_), .b(x27), .O(new_n118_));
  nand4  g55(.a(x35), .b(new_n72_), .c(x27), .d(new_n63_), .O(new_n119_));
  nor2   g56(.a(x30), .b(x09), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g58(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z11));
  nand2  g59(.a(x22), .b(x01), .O(new_n127_));
  nor2   g60(.a(new_n127_), .b(x23), .O(z16));
  inv1   g61(.a(x24), .O(new_n129_));
  nand4  g62(.a(new_n129_), .b(x23), .c(x22), .d(x01), .O(new_n130_));
  inv1   g63(.a(new_n130_), .O(z17));
  inv1   g64(.a(z11), .O(z18));
  oai21  g65(.a(new_n84_), .b(new_n71_), .c(new_n120_), .O(new_n133_));
  nor2   g66(.a(new_n133_), .b(new_n117_), .O(z20));
  zero   g67(.O(z08));
  zero   g68(.O(z12));
  zero   g69(.O(z13));
  zero   g70(.O(z14));
  zero   g71(.O(z15));
  aoi21  g72(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
