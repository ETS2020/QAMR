// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:53 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n75_), .b(x07), .O(new_n91_));
  nand3  g24(.a(x40), .b(x39), .c(x05), .O(new_n92_));
  nand2  g25(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  aoi21  g26(.a(new_n70_), .b(new_n69_), .c(new_n92_), .O(new_n94_));
  aoi21  g27(.a(new_n93_), .b(new_n68_), .c(new_n94_), .O(new_n95_));
  nand3  g28(.a(x37), .b(x27), .c(x06), .O(new_n96_));
  oai21  g29(.a(new_n95_), .b(x04), .c(new_n96_), .O(z10));
  inv1   g30(.a(x08), .O(new_n98_));
  nand2  g31(.a(z08), .b(x29), .O(new_n99_));
  aoi21  g32(.a(new_n99_), .b(new_n67_), .c(new_n98_), .O(new_n100_));
  nand2  g33(.a(new_n99_), .b(x27), .O(new_n101_));
  inv1   g34(.a(x04), .O(new_n102_));
  nand4  g35(.a(x35), .b(new_n66_), .c(x27), .d(new_n102_), .O(new_n103_));
  nor2   g36(.a(x30), .b(x09), .O(new_n104_));
  nand2  g37(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi21  g38(.a(new_n101_), .b(new_n100_), .c(new_n105_), .O(z11));
  ...
  nand2  g44(.a(new_n101_), .b(new_n100_), .O(new_n116_));
  nand3  g45(.a(new_n104_), .b(new_n103_), .c(new_n116_), .O(z18));
  oai21  g46(.a(new_n79_), .b(new_n64_), .c(new_n104_), .O(new_n118_));
  nor2   g47(.a(new_n118_), .b(new_n100_), .O(z20));
  zero   g48(.O(z00));
  zero   g49(.O(z05));
  zero   g50(.O(z06));
  zero   g51(.O(z07));
  ...
  zero   g55(.O(z14));
  zero   g56(.O(z15));
  aoi21  g57(.a(new_n101_), .b(new_n100_), .c(new_n105_), .O(z19));
endmodule
