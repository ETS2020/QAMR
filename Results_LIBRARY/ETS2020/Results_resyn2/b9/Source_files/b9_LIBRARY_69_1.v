// Benchmark "FAU" written by ABC on Fri Jul 24 22:24:31 2020
...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n102_, new_n103_, new_n104_, new_n110_, new_n112_, new_n113_;
  ...
  inv1   g31(.a(x29), .O(new_n99_));
  oai22  g32(.a(new_n75_), .b(new_n99_), .c(new_n67_), .d(x27), .O(new_n100_));
  inv1   g33(.a(x09), .O(new_n101_));
  inv1   g34(.a(x04), .O(new_n102_));
  nand4  g35(.a(x35), .b(new_n66_), .c(x27), .d(new_n102_), .O(new_n103_));
  nand3  g36(.a(new_n103_), .b(new_n69_), .c(new_n101_), .O(new_n104_));
  aoi21  g37(.a(new_n100_), .b(x08), .c(new_n104_), .O(z11));
  nand2  g38(.a(x22), .b(x01), .O(new_n110_));
  nor2   g39(.a(new_n110_), .b(x23), .O(z16));
  inv1   g40(.a(x24), .O(new_n112_));
  nand4  g41(.a(new_n112_), .b(x23), .c(x22), .d(x01), .O(new_n113_));
  inv1   g42(.a(new_n113_), .O(z17));
  ...
  zero   g52(.O(z15));
  zero   g53(.O(z20));
  aoi21  g54(.a(new_n100_), .b(x08), .c(new_n104_), .O(z19));
endmodule
