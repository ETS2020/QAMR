...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n120_, new_n121_, new_n126_, new_n128_, new_n130_, new_n131_,
    new_n134_;
  ...
  nand4  g59(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n126_));
  inv1   g60(.a(new_n126_), .O(z15));
  nand2  g61(.a(x22), .b(x01), .O(new_n128_));
  nor2   g62(.a(new_n128_), .b(x23), .O(z16));
  inv1   g63(.a(x24), .O(new_n130_));
  nand4  g64(.a(new_n130_), .b(x23), .c(x22), .d(x01), .O(new_n131_));
  inv1   g65(.a(new_n131_), .O(z17));
  inv1   g66(.a(z11), .O(z18));
  oai21  g67(.a(new_n84_), .b(new_n71_), .c(new_n120_), .O(new_n134_));
  nor2   g68(.a(new_n134_), .b(new_n117_), .O(z20));
  zero   g69(.O(z08));
  zero   g70(.O(z12));
  zero   g71(.O(z13));
  zero   g72(.O(z14));
  aoi21  g73(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
