...
module FAU ( 
  ...
  nand4  g34(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n100_));
  inv1   g35(.a(new_n100_), .O(z09));
  nand2  g36(.a(new_n75_), .b(x07), .O(new_n102_));
  nand3  g37(.a(x40), .b(x39), .c(x05), .O(new_n103_));
  nand2  g38(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  aoi21  g39(.a(new_n70_), .b(new_n69_), .c(new_n103_), .O(new_n105_));
  aoi21  g40(.a(new_n104_), .b(new_n68_), .c(new_n105_), .O(new_n106_));
  nand3  g41(.a(x37), .b(x27), .c(x06), .O(new_n107_));
  oai21  g42(.a(new_n106_), .b(x04), .c(new_n107_), .O(z10));
  inv1   g43(.a(x08), .O(new_n109_));
  nand2  g44(.a(z08), .b(x29), .O(new_n110_));
  aoi21  g45(.a(new_n110_), .b(new_n67_), .c(new_n109_), .O(new_n111_));
  nand2  g46(.a(new_n110_), .b(x27), .O(new_n112_));
  inv1   g47(.a(x04), .O(new_n113_));
  nand4  g48(.a(x35), .b(new_n66_), .c(x27), .d(new_n113_), .O(new_n114_));
  nor2   g49(.a(x30), .b(x09), .O(new_n115_));
  nand2  g50(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  aoi21  g51(.a(new_n112_), .b(new_n111_), .c(new_n116_), .O(z11));
  ...
  nand2  g57(.a(new_n112_), .b(new_n111_), .O(new_n127_));
  nand3  g58(.a(new_n115_), .b(new_n114_), .c(new_n127_), .O(z18));
