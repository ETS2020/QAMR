// Benchmark "FAU" written by ABC on Fri Jul 24 20:26:44 2020
...
module FAU ( 
  ...
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n42_, new_n43_, new_n45_,
    new_n46_, new_n48_, new_n49_, new_n52_, new_n53_, new_n55_, new_n56_;
  ...
  inv1   g18(.a(x07), .O(new_n55_));
  nor2   g19(.a(x16), .b(x08), .O(new_n56_));
  aoi21  g20(.a(x08), .b(new_n55_), .c(new_n56_), .O(z15));
  zero   g21(.O(z00));
  zero   g22(.O(z02));
  zero   g23(.O(z13));
