...
module FAU ( 
  ...
  nor2   g07(.a(x12), .b(x08), .O(new_n42_));
  aoi21  g08(.a(x08), .b(new_n41_), .c(new_n42_), .O(z11));
  ...
  nor2   g16(.a(x15), .b(x08), .O(new_n51_));
  aoi21  g17(.a(x08), .b(new_n50_), .c(new_n51_), .O(z14));
  inv1   g18(.a(x07), .O(new_n53_));
  nor2   g19(.a(x16), .b(x08), .O(new_n54_));
  aoi21  g20(.a(x08), .b(new_n53_), .c(new_n54_), .O(z15));
  zero   g21(.O(z09));
