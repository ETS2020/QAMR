...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n40_, new_n41_, new_n43_, new_n44_, new_n49_, new_n50_, new_n53_,
    new_n54_;
  ...
  inv1   g09(.a(x07), .O(new_n53_));
  nor2   g10(.a(x16), .b(x08), .O(new_n54_));
  aoi21  g11(.a(x08), .b(new_n53_), .c(new_n54_), .O(z15));
  zero   g12(.O(z00));
  zero   g13(.O(z03));
  zero   g14(.O(z04));
  zero   g15(.O(z05));
