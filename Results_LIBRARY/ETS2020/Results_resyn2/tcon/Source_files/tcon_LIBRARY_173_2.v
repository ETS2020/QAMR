// Benchmark "FAU" written by ABC on Fri Jul 24 20:27:28 2020
...
module FAU ( 
  ...
  inv1   g12(.a(x05), .O(new_n50_));
  nor2   g13(.a(x14), .b(x08), .O(new_n51_));
  aoi21  g14(.a(x08), .b(new_n50_), .c(new_n51_), .O(z13));
