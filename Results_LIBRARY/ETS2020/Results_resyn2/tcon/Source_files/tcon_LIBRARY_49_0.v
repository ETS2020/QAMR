...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n36_, new_n37_, new_n39_, new_n40_, new_n44_, new_n45_, new_n49_,
    new_n50_;
  ...
  inv1   g09(.a(x07), .O(new_n49_));
  nor2   g10(.a(x16), .b(x08), .O(new_n50_));
  aoi21  g11(.a(x08), .b(new_n49_), .c(new_n50_), .O(z15));
  zero   g12(.O(z01));
  zero   g13(.O(z03));
  zero   g14(.O(z10));
  zero   g15(.O(z11));
