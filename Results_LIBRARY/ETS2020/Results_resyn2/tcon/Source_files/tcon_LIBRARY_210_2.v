// Benchmark "FAU" written by ABC on Fri Jul 24 20:27:39 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n40_, new_n41_, new_n43_, new_n44_, new_n47_,
    new_n48_;
  ...
  nor2   g04(.a(x13), .b(x08), .O(new_n41_));
  aoi21  g05(.a(x08), .b(new_n40_), .c(new_n41_), .O(z12));
  inv1   g06(.a(x05), .O(new_n43_));
  nor2   g07(.a(x14), .b(x08), .O(new_n44_));
  aoi21  g08(.a(x08), .b(new_n43_), .c(new_n44_), .O(z13));
  inv1   g09(.a(x07), .O(new_n47_));
  nor2   g10(.a(x16), .b(x08), .O(new_n48_));
  aoi21  g11(.a(x08), .b(new_n47_), .c(new_n48_), .O(z15));
  zero   g12(.O(z09));
  zero   g13(.O(z10));
  zero   g14(.O(z11));
  zero   g15(.O(z14));
  buf1   g16(.a(x09), .O(z00));
