...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n36_, new_n37_, new_n42_, new_n43_, new_n45_, new_n46_, new_n48_,
    new_n49_;
  inv1   g00(.a(x01), .O(new_n36_));
  nor2   g01(.a(x10), .b(x08), .O(new_n37_));
  aoi21  g02(.a(x08), .b(new_n36_), .c(new_n37_), .O(z09));
  inv1   g03(.a(x05), .O(new_n42_));
  nor2   g04(.a(x14), .b(x08), .O(new_n43_));
  aoi21  g05(.a(x08), .b(new_n42_), .c(new_n43_), .O(z13));
