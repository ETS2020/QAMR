...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_, new_n29_,
    ...
    new_n38_;
  nand2  g00(.a(x13), .b(x09), .O(new_n23_));
  nor2   g01(.a(x10), .b(x08), .O(new_n24_));
  nor2   g02(.a(x12), .b(x11), .O(new_n25_));
  nand2  g03(.a(new_n25_), .b(new_n24_), .O(new_n26_));
  nand2  g04(.a(x04), .b(x02), .O(new_n27_));
  aoi21  g05(.a(new_n26_), .b(new_n23_), .c(new_n27_), .O(new_n28_));
