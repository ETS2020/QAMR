// Benchmark "FAU" written by ABC on Sat Jul 25 00:05:20 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n86_,
  ...
  or2    g34(.a(x28), .b(x27), .O(new_n80_));
  nand2  g35(.a(x28), .b(x27), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z4));
  nand3  g38(.a(x29), .b(x28), .c(x27), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(x31), .O(new_n87_));
  inv1   g40(.a(new_n86_), .O(new_n88_));
  xor2a  g41(.a(x31), .b(x30), .O(new_n89_));
  nand2  g42(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand3  g43(.a(new_n90_), .b(new_n87_), .c(new_n79_), .O(z7));
  ...
  oai21  g49(.a(new_n96_), .b(new_n69_), .c(new_n92_), .O(new_n97_));
  ...
  oai21  g55(.a(new_n102_), .b(new_n69_), .c(new_n93_), .O(new_n103_));
  aoi21  g56(.a(x19), .b(x13), .c(x18), .O(new_n104_));
  aoi21  g57(.a(new_n69_), .b(x14), .c(new_n94_), .O(new_n105_));
  ...
  aoi21  g72(.a(new_n69_), .b(new_n119_), .c(z0), .O(new_n120_));
  ...
  xor2a  g91(.a(new_n116_), .b(new_n69_), .O(new_n139_));
