// Benchmark "FAU" written by ABC on Sat Jul 25 00:05:32 2020
...
module FAU ( 
  ...
  nand3  g43(.a(new_n89_), .b(x18), .c(x14), .O(new_n90_));
  inv1   g44(.a(x18), .O(new_n91_));
  nand3  g45(.a(x19), .b(new_n91_), .c(x13), .O(new_n92_));
  aoi21  g46(.a(new_n92_), .b(new_n90_), .c(new_n54_), .O(new_n93_));
  nand4  g47(.a(x19), .b(x18), .c(new_n54_), .d(x12), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n93_), .c(x16), .O(new_n96_));
  inv1   g50(.a(x16), .O(new_n97_));
  nand3  g51(.a(x18), .b(x17), .c(x11), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(x19), .c(new_n97_), .O(new_n100_));
  aoi21  g54(.a(new_n100_), .b(new_n96_), .c(new_n88_), .O(new_n101_));
  nand4  g55(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n102_));
  nor3   g56(.a(new_n102_), .b(new_n89_), .c(x15), .O(new_n103_));
  nand2  g57(.a(new_n71_), .b(x29), .O(new_n104_));
  aoi21  g58(.a(x31), .b(x30), .c(new_n104_), .O(new_n105_));
  inv1   g59(.a(x31), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n81_), .O(new_n107_));
  aoi21  g61(.a(new_n107_), .b(new_n104_), .c(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n103_), .b(new_n101_), .c(new_n108_), .O(new_n109_));
  nand2  g63(.a(x18), .b(x12), .O(new_n110_));
  oai21  g64(.a(x18), .b(x13), .c(x17), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n102_), .O(new_n114_));
  nand4  g68(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n115_));
  aoi21  g69(.a(new_n115_), .b(new_n89_), .c(new_n47_), .O(new_n116_));
  nand2  g70(.a(new_n89_), .b(x14), .O(new_n117_));
  inv1   g71(.a(new_n115_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g73(.a(new_n98_), .b(new_n97_), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n119_), .c(new_n116_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n114_), .c(new_n108_), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n62_), .c(x00), .O(new_n124_));
  aoi21  g78(.a(new_n109_), .b(new_n47_), .c(new_n124_), .O(z9));
  zero   g79(.O(z2));
  zero   g80(.O(z8));
endmodule
