...
module FAU ( 
  ...
  wire new_n72_, new_n73_, new_n74_, new_n77_, new_n78_, new_n79_, new_n80_,
    ...
    new_n100_, new_n101_, new_n102_, new_n103_, new_n105_, new_n108_,
  ...
  nand2  g024(.a(x1), .b(new_n92_), .O(new_n98_));
  ...
  nor4   g032(.a(new_n105_), .b(new_n101_), .c(new_n78_), .d(new_n94_), .O(z08));
  ...
  nor2   g038(.a(x1), .b(new_n92_), .O(new_n114_));
  nand2  g039(.a(new_n114_), .b(x2), .O(new_n115_));
  nor2   g040(.a(new_n115_), .b(new_n103_), .O(z12));
  inv1   g041(.a(new_n87_), .O(new_n117_));
  nor3   g042(.a(new_n101_), .b(new_n100_), .c(new_n117_), .O(z13));
  nand2  g043(.a(new_n114_), .b(new_n97_), .O(new_n119_));
  nor3   g044(.a(new_n119_), .b(new_n101_), .c(new_n117_), .O(z14));
  nand2  g045(.a(new_n97_), .b(x1), .O(new_n122_));
  nor4   g046(.a(new_n122_), .b(new_n111_), .c(new_n86_), .d(new_n92_), .O(z16));
  ...
  nor3   g058(.a(new_n119_), .b(new_n74_), .c(x3), .O(z20));
  inv1   g059(.a(new_n73_), .O(new_n136_));
  nor3   g060(.a(new_n119_), .b(new_n117_), .c(new_n136_), .O(z21));
  nor2   g061(.a(new_n79_), .b(x5), .O(new_n138_));
  nor2   g062(.a(x2), .b(x1), .O(new_n139_));
  nand3  g063(.a(new_n139_), .b(new_n138_), .c(x7), .O(new_n140_));
  nor3   g064(.a(new_n140_), .b(x4), .c(new_n92_), .O(z22));
  nor2   g065(.a(new_n105_), .b(x3), .O(new_n145_));
  inv1   g066(.a(new_n145_), .O(new_n146_));
  nand2  g067(.a(x7), .b(new_n72_), .O(new_n147_));
  inv1   g068(.a(new_n147_), .O(new_n148_));
  nand2  g069(.a(new_n148_), .b(new_n138_), .O(new_n149_));
  nor2   g070(.a(new_n149_), .b(new_n146_), .O(z26));
  nand2  g071(.a(new_n138_), .b(new_n80_), .O(new_n151_));
  nor3   g072(.a(new_n151_), .b(new_n108_), .c(new_n78_), .O(z27));
  nand2  g073(.a(x3), .b(x2), .O(new_n153_));
  inv1   g074(.a(new_n153_), .O(new_n154_));
  nand2  g075(.a(new_n154_), .b(new_n114_), .O(new_n155_));
  nor2   g076(.a(new_n155_), .b(new_n149_), .O(z28));
  inv1   g077(.a(new_n132_), .O(new_n157_));
  nor2   g078(.a(x1), .b(x0), .O(new_n158_));
  inv1   g079(.a(new_n158_), .O(new_n159_));
  nor4   g080(.a(new_n159_), .b(new_n147_), .c(new_n157_), .d(new_n136_), .O(z29));
  nor3   g081(.a(new_n149_), .b(new_n146_), .c(new_n94_), .O(z30));
  ...
  nand3  g103(.a(new_n182_), .b(new_n114_), .c(new_n97_), .O(new_n183_));
  nand4  g104(.a(new_n183_), .b(new_n180_), .c(new_n177_), .d(new_n175_), .O(new_n184_));
  nand2  g105(.a(new_n184_), .b(new_n72_), .O(new_n185_));
  nor2   g106(.a(new_n114_), .b(new_n86_), .O(new_n186_));
  nor2   g107(.a(new_n186_), .b(new_n97_), .O(new_n187_));
  ...
  nor2   g132(.a(x3), .b(new_n97_), .O(new_n212_));
  ...
  oai21  g146(.a(new_n97_), .b(new_n92_), .c(new_n94_), .O(new_n226_));
  ...
  nand2  g155(.a(new_n109_), .b(new_n72_), .O(new_n235_));
  ...
  oai21  g159(.a(new_n125_), .b(new_n97_), .c(x4), .O(new_n239_));
  nand2  g160(.a(new_n151_), .b(new_n72_), .O(new_n240_));
  inv1   g161(.a(new_n139_), .O(new_n241_));
  nand2  g162(.a(new_n241_), .b(new_n86_), .O(new_n242_));
  nand3  g163(.a(new_n242_), .b(new_n240_), .c(new_n239_), .O(new_n243_));
  nand2  g164(.a(new_n243_), .b(new_n92_), .O(new_n244_));
  aoi21  g165(.a(new_n157_), .b(new_n74_), .c(x1), .O(new_n245_));
  nand2  g166(.a(new_n188_), .b(x1), .O(new_n246_));
  nand3  g167(.a(x5), .b(x2), .c(new_n94_), .O(new_n247_));
  aoi21  g168(.a(new_n247_), .b(new_n246_), .c(new_n86_), .O(new_n248_));
  nor3   g169(.a(new_n248_), .b(new_n245_), .c(new_n145_), .O(new_n249_));
  nand3  g170(.a(new_n249_), .b(new_n244_), .c(new_n238_), .O(z37));
  nor2   g171(.a(x5), .b(new_n94_), .O(new_n251_));
  oai21  g172(.a(new_n251_), .b(new_n193_), .c(new_n97_), .O(new_n252_));
  nand3  g173(.a(new_n252_), .b(new_n191_), .c(new_n185_), .O(z38));
  nand2  g174(.a(new_n110_), .b(new_n97_), .O(new_n254_));
  nand2  g175(.a(new_n125_), .b(x0), .O(new_n255_));
  oai21  g176(.a(new_n255_), .b(new_n254_), .c(new_n84_), .O(new_n256_));
  nand2  g177(.a(new_n256_), .b(new_n72_), .O(z39));
  nand2  g178(.a(new_n235_), .b(new_n139_), .O(new_n258_));
  oai21  g179(.a(new_n87_), .b(new_n79_), .c(x2), .O(new_n259_));
  aoi21  g180(.a(new_n259_), .b(new_n258_), .c(new_n92_), .O(new_n260_));
  oai21  g181(.a(new_n87_), .b(new_n97_), .c(x1), .O(new_n261_));
  nand3  g182(.a(new_n219_), .b(new_n169_), .c(new_n72_), .O(new_n262_));
  nand2  g183(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  oai21  g184(.a(new_n263_), .b(new_n260_), .c(new_n171_), .O(new_n264_));
  nor2   g185(.a(x7), .b(x5), .O(new_n265_));
  nand2  g186(.a(new_n265_), .b(new_n132_), .O(new_n266_));
  nand2  g187(.a(x4), .b(new_n97_), .O(new_n267_));
  nand4  g188(.a(new_n267_), .b(new_n147_), .c(new_n232_), .d(x3), .O(new_n268_));
  aoi21  g189(.a(new_n268_), .b(new_n266_), .c(x0), .O(new_n269_));
  nor2   g190(.a(new_n267_), .b(new_n128_), .O(new_n270_));
  oai21  g191(.a(new_n270_), .b(new_n269_), .c(new_n94_), .O(new_n271_));
  nand4  g192(.a(new_n176_), .b(new_n171_), .c(new_n72_), .d(x0), .O(new_n272_));
  nand2  g193(.a(new_n272_), .b(new_n271_), .O(new_n273_));
  nand2  g194(.a(new_n273_), .b(new_n264_), .O(z40));
  nand2  g195(.a(new_n204_), .b(x5), .O(new_n275_));
  aoi21  g196(.a(new_n275_), .b(new_n140_), .c(new_n92_), .O(new_n276_));
  oai22  g197(.a(new_n265_), .b(x0), .c(new_n220_), .d(x5), .O(new_n277_));
  oai21  g198(.a(new_n277_), .b(new_n276_), .c(new_n72_), .O(new_n278_));
  aoi21  g199(.a(new_n157_), .b(new_n89_), .c(new_n94_), .O(new_n279_));
  nand3  g200(.a(x5), .b(x3), .c(new_n94_), .O(new_n280_));
  or2    g201(.a(new_n280_), .b(x2), .O(new_n281_));
  inv1   g202(.a(new_n281_), .O(new_n282_));
  oai21  g203(.a(new_n282_), .b(new_n279_), .c(x0), .O(new_n283_));
  nand3  g204(.a(new_n105_), .b(new_n87_), .c(new_n94_), .O(new_n284_));
  nand2  g205(.a(new_n284_), .b(new_n283_), .O(new_n285_));
  nand2  g206(.a(new_n285_), .b(new_n278_), .O(z41));
  inv1   g207(.a(new_n138_), .O(new_n287_));
  nand3  g208(.a(new_n223_), .b(new_n114_), .c(x7), .O(new_n288_));
  oai21  g209(.a(new_n288_), .b(new_n287_), .c(new_n81_), .O(new_n289_));
  ...
  nand3  g216(.a(new_n148_), .b(new_n138_), .c(new_n94_), .O(new_n297_));
  ...
  oai21  g235(.a(new_n217_), .b(x5), .c(new_n176_), .O(new_n316_));
  nand2  g236(.a(new_n80_), .b(x0), .O(new_n317_));
  oai21  g237(.a(new_n317_), .b(new_n181_), .c(x5), .O(new_n318_));
  inv1   g238(.a(new_n192_), .O(new_n319_));
  nand3  g239(.a(new_n319_), .b(new_n88_), .c(new_n97_), .O(new_n320_));
  nand2  g240(.a(new_n320_), .b(new_n318_), .O(new_n321_));
  aoi21  g241(.a(new_n316_), .b(x0), .c(new_n321_), .O(new_n322_));
  nand2  g242(.a(x5), .b(new_n92_), .O(new_n323_));
  nand3  g243(.a(new_n80_), .b(x3), .c(x0), .O(new_n324_));
  aoi21  g244(.a(new_n324_), .b(new_n323_), .c(new_n94_), .O(new_n325_));
  aoi21  g245(.a(new_n323_), .b(new_n167_), .c(new_n86_), .O(new_n326_));
  oai21  g246(.a(new_n326_), .b(new_n325_), .c(new_n72_), .O(new_n327_));
  oai21  g247(.a(new_n157_), .b(new_n98_), .c(new_n327_), .O(new_n328_));
  oai21  g248(.a(new_n322_), .b(x4), .c(new_n328_), .O(z46));
  nand2  g249(.a(new_n310_), .b(new_n101_), .O(new_n331_));
  ...
  oai22  g259(.a(new_n340_), .b(new_n254_), .c(new_n339_), .d(new_n310_), .O(new_n341_));
  ...
  oai21  g268(.a(new_n117_), .b(new_n171_), .c(new_n192_), .O(new_n351_));
  ...
  aoi21  g274(.a(new_n356_), .b(new_n110_), .c(new_n171_), .O(new_n357_));
  oai21  g275(.a(new_n336_), .b(new_n186_), .c(new_n287_), .O(new_n358_));
  oai21  g276(.a(new_n358_), .b(new_n357_), .c(new_n72_), .O(new_n359_));
  nand2  g277(.a(new_n359_), .b(new_n354_), .O(z53));
  nand2  g278(.a(new_n254_), .b(x5), .O(new_n361_));
  nand2  g279(.a(new_n232_), .b(new_n97_), .O(new_n362_));
  ...
  nand2  g288(.a(new_n109_), .b(x5), .O(new_n371_));
  ...
  nand2  g294(.a(new_n350_), .b(new_n117_), .O(new_n377_));
  ...
  nor2   g299(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  nor4   g300(.a(new_n299_), .b(new_n232_), .c(new_n109_), .d(new_n105_), .O(new_n383_));
  oai21  g301(.a(new_n383_), .b(new_n382_), .c(new_n379_), .O(z55));
  ...
  nand2  g306(.a(new_n323_), .b(new_n95_), .O(new_n389_));
  nand3  g307(.a(new_n389_), .b(new_n159_), .c(new_n97_), .O(new_n390_));
  nand2  g308(.a(new_n98_), .b(new_n79_), .O(new_n391_));
  ...
  nand4  g318(.a(new_n400_), .b(new_n241_), .c(new_n72_), .d(new_n92_), .O(new_n401_));
  ...
  inv1   g322(.a(new_n267_), .O(new_n405_));
  nand2  g323(.a(new_n79_), .b(new_n97_), .O(new_n406_));
  ...
  aoi21  g330(.a(new_n157_), .b(new_n232_), .c(new_n299_), .O(new_n413_));
  ...
  nand4  g338(.a(new_n223_), .b(new_n114_), .c(x7), .d(x6), .O(new_n421_));
  ...
  nand3  g346(.a(new_n428_), .b(new_n247_), .c(new_n122_), .O(new_n429_));
  ...
  nand4  g354(.a(new_n79_), .b(new_n97_), .c(new_n94_), .d(x0), .O(new_n437_));
  ...
  oai21  g358(.a(new_n267_), .b(x0), .c(new_n246_), .O(new_n441_));
  ...
  aoi22  g364(.a(new_n446_), .b(new_n97_), .c(new_n445_), .d(new_n92_), .O(new_n447_));
  ...
  nand3  g369(.a(new_n114_), .b(x6), .c(new_n97_), .O(new_n452_));
  ...
  nor3   g374(.a(new_n446_), .b(new_n101_), .c(x1), .O(new_n457_));
  aoi22  g375(.a(new_n457_), .b(new_n385_), .c(new_n294_), .d(new_n319_), .O(z60));
