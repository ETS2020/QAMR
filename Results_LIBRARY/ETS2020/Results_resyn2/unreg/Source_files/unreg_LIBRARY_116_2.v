...
module FAU ( 
  ...
  nand2  g11(.a(new_n66_), .b(new_n54_), .O(new_n67_));
  nand2  g12(.a(x25), .b(x18), .O(new_n68_));
  inv1   g13(.a(x07), .O(new_n69_));
  nand2  g14(.a(new_n60_), .b(new_n69_), .O(new_n70_));
  nand4  g15(.a(new_n70_), .b(new_n68_), .c(x19), .d(new_n57_), .O(new_n71_));
  ...
  nand2  g32(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  nand2  g33(.a(x31), .b(x18), .O(new_n92_));
  inv1   g34(.a(x09), .O(new_n93_));
  nand2  g35(.a(new_n60_), .b(new_n93_), .O(new_n94_));
  nand4  g36(.a(new_n94_), .b(new_n92_), .c(x19), .d(new_n57_), .O(new_n95_));
