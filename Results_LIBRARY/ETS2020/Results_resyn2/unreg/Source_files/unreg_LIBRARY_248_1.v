// Benchmark "FAU" written by ABC on Fri Jul 24 21:14:36 2020
...
module FAU ( 
  ...
  nand2  g46(.a(new_n101_), .b(new_n54_), .O(new_n102_));
  nand2  g47(.a(x30), .b(x18), .O(new_n103_));
  inv1   g48(.a(x10), .O(new_n104_));
  nand2  g49(.a(new_n60_), .b(new_n104_), .O(new_n105_));
  nand4  g50(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n57_), .O(new_n106_));
  nand2  g51(.a(new_n106_), .b(new_n102_), .O(z09));
  inv1   g52(.a(x30), .O(new_n108_));
  nand2  g53(.a(new_n108_), .b(new_n54_), .O(new_n109_));
  nand2  g54(.a(x31), .b(x18), .O(new_n110_));
  inv1   g55(.a(x09), .O(new_n111_));
  nand2  g56(.a(new_n60_), .b(new_n111_), .O(new_n112_));
  nand4  g57(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n57_), .O(new_n113_));
  nand2  g58(.a(new_n113_), .b(new_n109_), .O(z10));
  inv1   g59(.a(x31), .O(new_n115_));
  nand2  g60(.a(new_n115_), .b(new_n54_), .O(new_n116_));
  nand2  g61(.a(x24), .b(x18), .O(new_n117_));
  inv1   g62(.a(x08), .O(new_n118_));
  nand2  g63(.a(new_n60_), .b(new_n118_), .O(new_n119_));
  nand4  g64(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n57_), .O(new_n120_));
  nand2  g65(.a(new_n120_), .b(new_n116_), .O(z11));
  inv1   g66(.a(x34), .O(new_n124_));
  nand2  g67(.a(new_n124_), .b(new_n54_), .O(new_n125_));
  nand2  g68(.a(x35), .b(x18), .O(new_n126_));
  inv1   g69(.a(x13), .O(new_n127_));
  nand2  g70(.a(new_n60_), .b(new_n127_), .O(new_n128_));
  nand4  g71(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n57_), .O(new_n129_));
  nand2  g72(.a(new_n129_), .b(new_n125_), .O(z14));
  inv1   g73(.a(x35), .O(new_n131_));
  nand2  g74(.a(new_n131_), .b(new_n54_), .O(new_n132_));
  nand2  g75(.a(x28), .b(x18), .O(new_n133_));
  inv1   g76(.a(x12), .O(new_n134_));
  nand2  g77(.a(new_n60_), .b(new_n134_), .O(new_n135_));
  nand4  g78(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n57_), .O(new_n136_));
