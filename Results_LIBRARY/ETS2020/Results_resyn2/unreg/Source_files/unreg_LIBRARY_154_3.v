...
module FAU ( 
  ...
  nand2  g33(.a(new_n87_), .b(new_n53_), .O(new_n88_));
  nand2  g34(.a(x27), .b(x18), .O(new_n89_));
  inv1   g35(.a(x05), .O(new_n90_));
  nand2  g36(.a(new_n59_), .b(new_n90_), .O(new_n91_));
  nand4  g37(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n56_), .O(new_n92_));
  nand2  g38(.a(new_n92_), .b(new_n88_), .O(z06));
  inv1   g39(.a(x27), .O(new_n94_));
  nand2  g40(.a(new_n94_), .b(new_n53_), .O(new_n95_));
  nand2  g41(.a(x20), .b(x18), .O(new_n96_));
  inv1   g42(.a(x04), .O(new_n97_));
  nand2  g43(.a(new_n59_), .b(new_n97_), .O(new_n98_));
  nand4  g44(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n56_), .O(new_n99_));
  ...
  inv1   g60(.a(x30), .O(new_n115_));
  nand2  g61(.a(new_n115_), .b(new_n53_), .O(new_n116_));
  nand2  g62(.a(x31), .b(x18), .O(new_n117_));
  inv1   g63(.a(x09), .O(new_n118_));
  nand2  g64(.a(new_n59_), .b(new_n118_), .O(new_n119_));
  nand4  g65(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n56_), .O(new_n120_));
  nand2  g66(.a(new_n120_), .b(new_n116_), .O(z10));
  inv1   g67(.a(x31), .O(new_n122_));
  nand2  g68(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  nand2  g69(.a(x24), .b(x18), .O(new_n124_));
  inv1   g70(.a(x08), .O(new_n125_));
  nand2  g71(.a(new_n59_), .b(new_n125_), .O(new_n126_));
  nand4  g72(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n56_), .O(new_n127_));
  nand2  g73(.a(new_n127_), .b(new_n123_), .O(z11));
  inv1   g74(.a(x32), .O(new_n129_));
  nand2  g75(.a(new_n129_), .b(new_n53_), .O(new_n130_));
  nand2  g76(.a(x33), .b(x18), .O(new_n131_));
  inv1   g77(.a(x15), .O(new_n132_));
  nand2  g78(.a(new_n59_), .b(new_n132_), .O(new_n133_));
  nand4  g79(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n56_), .O(new_n134_));
  nand2  g80(.a(new_n134_), .b(new_n130_), .O(z12));
  inv1   g81(.a(x33), .O(new_n136_));
  nand2  g82(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  nand2  g83(.a(x34), .b(x18), .O(new_n138_));
  inv1   g84(.a(x14), .O(new_n139_));
  nand2  g85(.a(new_n59_), .b(new_n139_), .O(new_n140_));
  nand4  g86(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n56_), .O(new_n141_));
  nand2  g87(.a(new_n141_), .b(new_n137_), .O(z13));
  zero   g88(.O(z01));
  zero   g89(.O(z05));
  zero   g90(.O(z14));
  zero   g91(.O(z15));
