...
module FAU ( 
  ...
  nand2  g011(.a(new_n64_), .b(new_n53_), .O(new_n65_));
  nand2  g012(.a(x23), .b(x18), .O(new_n66_));
  inv1   g013(.a(x01), .O(new_n67_));
  nand2  g014(.a(new_n59_), .b(new_n67_), .O(new_n68_));
  nand4  g015(.a(new_n68_), .b(new_n66_), .c(x19), .d(new_n56_), .O(new_n69_));
  nand2  g016(.a(new_n69_), .b(new_n65_), .O(z02));
  inv1   g017(.a(x23), .O(new_n71_));
  nand2  g018(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  inv1   g019(.a(x16), .O(new_n73_));
  nand2  g020(.a(x18), .b(new_n73_), .O(new_n74_));
  inv1   g021(.a(x00), .O(new_n75_));
  nand2  g022(.a(new_n59_), .b(new_n75_), .O(new_n76_));
  nand4  g023(.a(new_n76_), .b(new_n74_), .c(x19), .d(new_n56_), .O(new_n77_));
  nand2  g024(.a(new_n77_), .b(new_n72_), .O(z03));
  inv1   g025(.a(x24), .O(new_n79_));
  nand2  g026(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  nand2  g027(.a(x25), .b(x18), .O(new_n81_));
  inv1   g028(.a(x07), .O(new_n82_));
  nand2  g029(.a(new_n59_), .b(new_n82_), .O(new_n83_));
  nand4  g030(.a(new_n83_), .b(new_n81_), .c(x19), .d(new_n56_), .O(new_n84_));
