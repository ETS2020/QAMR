...
module FAU ( 
  ...
  nand2  g68(.a(new_n121_), .b(new_n54_), .O(new_n122_));
  nand2  g69(.a(x31), .b(x18), .O(new_n123_));
  inv1   g70(.a(x09), .O(new_n124_));
  nand2  g71(.a(new_n60_), .b(new_n124_), .O(new_n125_));
  nand4  g72(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n57_), .O(new_n126_));
