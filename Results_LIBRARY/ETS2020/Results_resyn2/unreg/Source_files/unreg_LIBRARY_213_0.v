...
module FAU ( 
  ...
  inv1   g46(.a(x26), .O(new_n99_));
  nand2  g47(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  nand2  g48(.a(x27), .b(x18), .O(new_n101_));
  inv1   g49(.a(x05), .O(new_n102_));
  nand2  g50(.a(new_n59_), .b(new_n102_), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n101_), .c(x19), .d(new_n56_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n100_), .O(z06));
  inv1   g53(.a(x27), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  nand2  g55(.a(x20), .b(x18), .O(new_n108_));
  inv1   g56(.a(x04), .O(new_n109_));
  nand2  g57(.a(new_n59_), .b(new_n109_), .O(new_n110_));
  nand4  g58(.a(new_n110_), .b(new_n108_), .c(x19), .d(new_n56_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n107_), .O(z07));
  inv1   g60(.a(x28), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nand2  g62(.a(x29), .b(x18), .O(new_n115_));
  inv1   g63(.a(x11), .O(new_n116_));
  nand2  g64(.a(new_n59_), .b(new_n116_), .O(new_n117_));
  nand4  g65(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n56_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n114_), .O(z08));
  inv1   g67(.a(x29), .O(new_n120_));
  nand2  g68(.a(new_n120_), .b(new_n53_), .O(new_n121_));
  nand2  g69(.a(x30), .b(x18), .O(new_n122_));
  inv1   g70(.a(x10), .O(new_n123_));
  nand2  g71(.a(new_n59_), .b(new_n123_), .O(new_n124_));
  nand4  g72(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n56_), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(new_n121_), .O(z09));
