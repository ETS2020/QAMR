...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n86_, new_n87_, new_n88_, new_n89_, new_n90_, new_n91_, new_n98_,
  ...
  nand2  g40(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  nand2  g41(.a(x24), .b(x18), .O(new_n100_));
  inv1   g42(.a(x08), .O(new_n101_));
  nand2  g43(.a(new_n59_), .b(new_n101_), .O(new_n102_));
  nand4  g44(.a(new_n102_), .b(new_n100_), .c(x19), .d(new_n56_), .O(new_n103_));
  nand2  g45(.a(new_n103_), .b(new_n99_), .O(z11));
  inv1   g46(.a(x32), .O(new_n105_));
  nand2  g47(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  nand2  g48(.a(x33), .b(x18), .O(new_n107_));
  inv1   g49(.a(x15), .O(new_n108_));
  nand2  g50(.a(new_n59_), .b(new_n108_), .O(new_n109_));
  nand4  g51(.a(new_n109_), .b(new_n107_), .c(x19), .d(new_n56_), .O(new_n110_));
