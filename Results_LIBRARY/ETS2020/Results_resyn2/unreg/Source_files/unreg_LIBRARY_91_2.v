...
module FAU ( 
  ...
  nand2  g67(.a(new_n124_), .b(new_n55_), .O(new_n125_));
  nand2  g68(.a(x35), .b(x18), .O(new_n126_));
  inv1   g69(.a(x13), .O(new_n127_));
  nand2  g70(.a(new_n61_), .b(new_n127_), .O(new_n128_));
  nand4  g71(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n58_), .O(new_n129_));
