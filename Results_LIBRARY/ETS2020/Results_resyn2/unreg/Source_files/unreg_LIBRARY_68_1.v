...
module FAU ( 
  ...
  nand2  g89(.a(new_n143_), .b(new_n54_), .O(new_n144_));
  nand2  g90(.a(x35), .b(x18), .O(new_n145_));
  inv1   g91(.a(x13), .O(new_n146_));
  nand2  g92(.a(new_n60_), .b(new_n146_), .O(new_n147_));
  nand4  g93(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n57_), .O(new_n148_));
