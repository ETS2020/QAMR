...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n103_, new_n104_, new_n105_, new_n106_, new_n107_, new_n113_,
  ...
  nand2  g54(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nand2  g55(.a(x35), .b(x18), .O(new_n115_));
  inv1   g56(.a(x13), .O(new_n116_));
  nand2  g57(.a(new_n59_), .b(new_n116_), .O(new_n117_));
  nand4  g58(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n56_), .O(new_n118_));
  nand2  g59(.a(new_n118_), .b(new_n114_), .O(z14));
  inv1   g60(.a(x35), .O(new_n120_));
  nand2  g61(.a(new_n120_), .b(new_n53_), .O(new_n121_));
  nand2  g62(.a(x28), .b(x18), .O(new_n122_));
  inv1   g63(.a(x12), .O(new_n123_));
  nand2  g64(.a(new_n59_), .b(new_n123_), .O(new_n124_));
  nand4  g65(.a(new_n124_), .b(new_n122_), .c(x19), .d(new_n56_), .O(new_n125_));
