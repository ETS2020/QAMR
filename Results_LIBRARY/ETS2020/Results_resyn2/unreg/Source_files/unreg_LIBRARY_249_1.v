...
module FAU ( 
  ...
  inv1   g74(.a(x30), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  nand2  g76(.a(x31), .b(x18), .O(new_n129_));
  inv1   g77(.a(x09), .O(new_n130_));
  nand2  g78(.a(new_n59_), .b(new_n130_), .O(new_n131_));
  nand4  g79(.a(new_n131_), .b(new_n129_), .c(x19), .d(new_n56_), .O(new_n132_));
  nand2  g80(.a(new_n132_), .b(new_n128_), .O(z10));
