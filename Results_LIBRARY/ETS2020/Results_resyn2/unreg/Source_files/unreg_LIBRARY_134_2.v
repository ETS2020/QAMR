...
module FAU ( 
  ...
  nand2  g46(.a(new_n103_), .b(new_n55_), .O(new_n104_));
  nand2  g47(.a(x24), .b(x18), .O(new_n105_));
  inv1   g48(.a(x08), .O(new_n106_));
  nand2  g49(.a(new_n61_), .b(new_n106_), .O(new_n107_));
  nand4  g50(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n58_), .O(new_n108_));
