// Benchmark "FAU" written by ABC on Fri Jul 24 21:14:33 2020
...
module FAU ( 
  ...
  nand2  g25(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  nand2  g26(.a(x26), .b(x18), .O(new_n81_));
  inv1   g27(.a(x06), .O(new_n82_));
  nand2  g28(.a(new_n59_), .b(new_n82_), .O(new_n83_));
  nand4  g29(.a(new_n83_), .b(new_n81_), .c(x19), .d(new_n56_), .O(new_n84_));
  ...
  nand2  g81(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  nand2  g82(.a(x35), .b(x18), .O(new_n138_));
  inv1   g83(.a(x13), .O(new_n139_));
  nand2  g84(.a(new_n59_), .b(new_n139_), .O(new_n140_));
  nand4  g85(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n56_), .O(new_n141_));
