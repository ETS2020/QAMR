...
module FAU ( 
  ...
  nand2  g47(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  nand2  g48(.a(x33), .b(x18), .O(new_n107_));
  inv1   g49(.a(x15), .O(new_n108_));
  nand2  g50(.a(new_n61_), .b(new_n108_), .O(new_n109_));
  nand4  g51(.a(new_n109_), .b(new_n107_), .c(x19), .d(new_n58_), .O(new_n110_));
  nand2  g52(.a(new_n110_), .b(new_n106_), .O(z12));
  inv1   g53(.a(x33), .O(new_n112_));
  nand2  g54(.a(new_n112_), .b(new_n55_), .O(new_n113_));
  nand2  g55(.a(x34), .b(x18), .O(new_n114_));
  inv1   g56(.a(x14), .O(new_n115_));
  nand2  g57(.a(new_n61_), .b(new_n115_), .O(new_n116_));
  nand4  g58(.a(new_n116_), .b(new_n114_), .c(x19), .d(new_n58_), .O(new_n117_));
  nand2  g59(.a(new_n117_), .b(new_n113_), .O(z13));
  inv1   g60(.a(x34), .O(new_n119_));
  nand2  g61(.a(new_n119_), .b(new_n55_), .O(new_n120_));
  nand2  g62(.a(x35), .b(x18), .O(new_n121_));
  inv1   g63(.a(x13), .O(new_n122_));
  nand2  g64(.a(new_n61_), .b(new_n122_), .O(new_n123_));
  nand4  g65(.a(new_n123_), .b(new_n121_), .c(x19), .d(new_n58_), .O(new_n124_));
