...
module FAU ( 
  ...
  nand2  g33(.a(new_n88_), .b(new_n54_), .O(new_n89_));
  nand2  g34(.a(x20), .b(x18), .O(new_n90_));
  inv1   g35(.a(x04), .O(new_n91_));
  nand2  g36(.a(new_n60_), .b(new_n91_), .O(new_n92_));
  nand4  g37(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n57_), .O(new_n93_));
  ...
  nand2  g54(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nand2  g55(.a(x34), .b(x18), .O(new_n114_));
  inv1   g56(.a(x14), .O(new_n115_));
  nand2  g57(.a(new_n60_), .b(new_n115_), .O(new_n116_));
  nand4  g58(.a(new_n116_), .b(new_n114_), .c(x19), .d(new_n57_), .O(new_n117_));
