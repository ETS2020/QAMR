...
module FAU ( 
  ...
  nand2  g74(.a(new_n131_), .b(new_n55_), .O(new_n132_));
  nand2  g75(.a(x28), .b(x18), .O(new_n133_));
  inv1   g76(.a(x12), .O(new_n134_));
  nand2  g77(.a(new_n61_), .b(new_n134_), .O(new_n135_));
  nand4  g78(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n58_), .O(new_n136_));
