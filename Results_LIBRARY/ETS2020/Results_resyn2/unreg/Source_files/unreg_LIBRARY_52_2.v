...
module FAU ( 
  ...
  nand2  g32(.a(new_n89_), .b(new_n57_), .O(new_n90_));
  nand2  g33(.a(x30), .b(x18), .O(new_n91_));
  inv1   g34(.a(x10), .O(new_n92_));
  nand2  g35(.a(new_n63_), .b(new_n92_), .O(new_n93_));
  nand4  g36(.a(new_n93_), .b(new_n91_), .c(x19), .d(new_n60_), .O(new_n94_));
  nand2  g37(.a(new_n94_), .b(new_n90_), .O(z09));
  inv1   g38(.a(x30), .O(new_n96_));
  nand2  g39(.a(new_n96_), .b(new_n57_), .O(new_n97_));
  nand2  g40(.a(x31), .b(x18), .O(new_n98_));
  inv1   g41(.a(x09), .O(new_n99_));
  nand2  g42(.a(new_n63_), .b(new_n99_), .O(new_n100_));
  nand4  g43(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n60_), .O(new_n101_));
