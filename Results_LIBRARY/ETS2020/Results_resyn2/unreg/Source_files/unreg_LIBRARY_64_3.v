// Benchmark "FAU" written by ABC on Fri Jul 24 21:13:59 2020
...
module FAU ( 
  ...
  nand2  g11(.a(new_n65_), .b(new_n53_), .O(new_n66_));
  inv1   g12(.a(x16), .O(new_n67_));
  nand2  g13(.a(x18), .b(new_n67_), .O(new_n68_));
  inv1   g14(.a(x00), .O(new_n69_));
  nand2  g15(.a(new_n59_), .b(new_n69_), .O(new_n70_));
  nand4  g16(.a(new_n70_), .b(new_n68_), .c(x19), .d(new_n56_), .O(new_n71_));
  nand2  g17(.a(new_n71_), .b(new_n66_), .O(z03));
  inv1   g18(.a(x24), .O(new_n73_));
  nand2  g19(.a(new_n73_), .b(new_n53_), .O(new_n74_));
  nand2  g20(.a(x25), .b(x18), .O(new_n75_));
  inv1   g21(.a(x07), .O(new_n76_));
  nand2  g22(.a(new_n59_), .b(new_n76_), .O(new_n77_));
  nand4  g23(.a(new_n77_), .b(new_n75_), .c(x19), .d(new_n56_), .O(new_n78_));
  nand2  g24(.a(new_n78_), .b(new_n74_), .O(z04));
  inv1   g25(.a(x26), .O(new_n81_));
  nand2  g26(.a(new_n81_), .b(new_n53_), .O(new_n82_));
  nand2  g27(.a(x27), .b(x18), .O(new_n83_));
  inv1   g28(.a(x05), .O(new_n84_));
  nand2  g29(.a(new_n59_), .b(new_n84_), .O(new_n85_));
  nand4  g30(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n56_), .O(new_n86_));
  ...
  nand2  g40(.a(new_n95_), .b(new_n53_), .O(new_n96_));
  nand2  g41(.a(x29), .b(x18), .O(new_n97_));
  inv1   g42(.a(x11), .O(new_n98_));
  nand2  g43(.a(new_n59_), .b(new_n98_), .O(new_n99_));
  nand4  g44(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n56_), .O(new_n100_));
  nand2  g45(.a(new_n100_), .b(new_n96_), .O(z08));
  inv1   g46(.a(x29), .O(new_n102_));
  nand2  g47(.a(new_n102_), .b(new_n53_), .O(new_n103_));
  nand2  g48(.a(x30), .b(x18), .O(new_n104_));
  inv1   g49(.a(x10), .O(new_n105_));
  nand2  g50(.a(new_n59_), .b(new_n105_), .O(new_n106_));
  nand4  g51(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n56_), .O(new_n107_));
  nand2  g52(.a(new_n107_), .b(new_n103_), .O(z09));
  inv1   g53(.a(x30), .O(new_n109_));
  nand2  g54(.a(new_n109_), .b(new_n53_), .O(new_n110_));
  nand2  g55(.a(x31), .b(x18), .O(new_n111_));
  inv1   g56(.a(x09), .O(new_n112_));
  nand2  g57(.a(new_n59_), .b(new_n112_), .O(new_n113_));
  nand4  g58(.a(new_n113_), .b(new_n111_), .c(x19), .d(new_n56_), .O(new_n114_));
  nand2  g59(.a(new_n114_), .b(new_n110_), .O(z10));
  inv1   g60(.a(x31), .O(new_n116_));
  nand2  g61(.a(new_n116_), .b(new_n53_), .O(new_n117_));
  nand2  g62(.a(x24), .b(x18), .O(new_n118_));
  inv1   g63(.a(x08), .O(new_n119_));
  nand2  g64(.a(new_n59_), .b(new_n119_), .O(new_n120_));
  nand4  g65(.a(new_n120_), .b(new_n118_), .c(x19), .d(new_n56_), .O(new_n121_));
