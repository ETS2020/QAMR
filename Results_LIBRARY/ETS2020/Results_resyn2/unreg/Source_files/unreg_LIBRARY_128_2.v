// Benchmark "FAU" written by ABC on Fri Jul 24 21:14:12 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n96_), .b(new_n55_), .O(new_n97_));
  nand2  g40(.a(x31), .b(x18), .O(new_n98_));
  inv1   g41(.a(x09), .O(new_n99_));
  nand2  g42(.a(new_n61_), .b(new_n99_), .O(new_n100_));
  nand4  g43(.a(new_n100_), .b(new_n98_), .c(x19), .d(new_n58_), .O(new_n101_));
  nand2  g44(.a(new_n101_), .b(new_n97_), .O(z10));
  inv1   g45(.a(x32), .O(new_n104_));
  nand2  g46(.a(new_n104_), .b(new_n55_), .O(new_n105_));
  nand2  g47(.a(x33), .b(x18), .O(new_n106_));
  inv1   g48(.a(x15), .O(new_n107_));
  nand2  g49(.a(new_n61_), .b(new_n107_), .O(new_n108_));
  nand4  g50(.a(new_n108_), .b(new_n106_), .c(x19), .d(new_n58_), .O(new_n109_));
  nand2  g51(.a(new_n109_), .b(new_n105_), .O(z12));
  inv1   g52(.a(x33), .O(new_n111_));
  nand2  g53(.a(new_n111_), .b(new_n55_), .O(new_n112_));
  nand2  g54(.a(x34), .b(x18), .O(new_n113_));
  inv1   g55(.a(x14), .O(new_n114_));
  nand2  g56(.a(new_n61_), .b(new_n114_), .O(new_n115_));
  nand4  g57(.a(new_n115_), .b(new_n113_), .c(x19), .d(new_n58_), .O(new_n116_));
  nand2  g58(.a(new_n116_), .b(new_n112_), .O(z13));
  inv1   g59(.a(x34), .O(new_n118_));
  nand2  g60(.a(new_n118_), .b(new_n55_), .O(new_n119_));
  nand2  g61(.a(x35), .b(x18), .O(new_n120_));
  inv1   g62(.a(x13), .O(new_n121_));
  nand2  g63(.a(new_n61_), .b(new_n121_), .O(new_n122_));
  nand4  g64(.a(new_n122_), .b(new_n120_), .c(x19), .d(new_n58_), .O(new_n123_));
