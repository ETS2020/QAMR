...
module FAU ( 
  ...
  nand2  g81(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  nand2  g82(.a(x35), .b(x18), .O(new_n138_));
  inv1   g83(.a(x13), .O(new_n139_));
  nand2  g84(.a(new_n60_), .b(new_n139_), .O(new_n140_));
  nand4  g85(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n57_), .O(new_n141_));
