...
module FAU ( 
  ...
  nand2  g68(.a(new_n124_), .b(new_n54_), .O(new_n125_));
  nand2  g69(.a(x34), .b(x18), .O(new_n126_));
  inv1   g70(.a(x14), .O(new_n127_));
  nand2  g71(.a(new_n60_), .b(new_n127_), .O(new_n128_));
  nand4  g72(.a(new_n128_), .b(new_n126_), .c(x19), .d(new_n57_), .O(new_n129_));
