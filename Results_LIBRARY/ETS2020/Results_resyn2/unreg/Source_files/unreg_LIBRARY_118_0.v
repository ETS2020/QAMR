...
module FAU ( 
  ...
  nand2  g18(.a(new_n71_), .b(new_n54_), .O(new_n72_));
  inv1   g19(.a(x16), .O(new_n73_));
  nand2  g20(.a(x18), .b(new_n73_), .O(new_n74_));
  inv1   g21(.a(x00), .O(new_n75_));
  nand2  g22(.a(new_n60_), .b(new_n75_), .O(new_n76_));
  nand4  g23(.a(new_n76_), .b(new_n74_), .c(x19), .d(new_n57_), .O(new_n77_));
  nand2  g24(.a(new_n77_), .b(new_n72_), .O(z03));
  inv1   g25(.a(x24), .O(new_n79_));
  nand2  g26(.a(new_n79_), .b(new_n54_), .O(new_n80_));
  nand2  g27(.a(x25), .b(x18), .O(new_n81_));
  inv1   g28(.a(x07), .O(new_n82_));
  nand2  g29(.a(new_n60_), .b(new_n82_), .O(new_n83_));
  nand4  g30(.a(new_n83_), .b(new_n81_), .c(x19), .d(new_n57_), .O(new_n84_));
  nand2  g31(.a(new_n84_), .b(new_n80_), .O(z04));
  inv1   g32(.a(x25), .O(new_n86_));
  nand2  g33(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  nand2  g34(.a(x26), .b(x18), .O(new_n88_));
  inv1   g35(.a(x06), .O(new_n89_));
  nand2  g36(.a(new_n60_), .b(new_n89_), .O(new_n90_));
  nand4  g37(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n57_), .O(new_n91_));
  nand2  g38(.a(new_n91_), .b(new_n87_), .O(z05));
  inv1   g39(.a(x26), .O(new_n93_));
  nand2  g40(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  nand2  g41(.a(x27), .b(x18), .O(new_n95_));
  inv1   g42(.a(x05), .O(new_n96_));
  nand2  g43(.a(new_n60_), .b(new_n96_), .O(new_n97_));
  nand4  g44(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n57_), .O(new_n98_));
  nand2  g45(.a(new_n98_), .b(new_n94_), .O(z06));
  inv1   g46(.a(x27), .O(new_n100_));
  nand2  g47(.a(new_n100_), .b(new_n54_), .O(new_n101_));
  nand2  g48(.a(x20), .b(x18), .O(new_n102_));
  inv1   g49(.a(x04), .O(new_n103_));
  nand2  g50(.a(new_n60_), .b(new_n103_), .O(new_n104_));
  nand4  g51(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n57_), .O(new_n105_));
  nand2  g52(.a(new_n105_), .b(new_n101_), .O(z07));
  inv1   g53(.a(x28), .O(new_n107_));
  nand2  g54(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  nand2  g55(.a(x29), .b(x18), .O(new_n109_));
  inv1   g56(.a(x11), .O(new_n110_));
  nand2  g57(.a(new_n60_), .b(new_n110_), .O(new_n111_));
  nand4  g58(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n57_), .O(new_n112_));
  nand2  g59(.a(new_n112_), .b(new_n108_), .O(z08));
  inv1   g60(.a(x29), .O(new_n114_));
  nand2  g61(.a(new_n114_), .b(new_n54_), .O(new_n115_));
  nand2  g62(.a(x30), .b(x18), .O(new_n116_));
  inv1   g63(.a(x10), .O(new_n117_));
  nand2  g64(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  nand4  g65(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n57_), .O(new_n119_));
  ...
  nand2  g75(.a(new_n130_), .b(new_n54_), .O(new_n131_));
  nand2  g76(.a(x34), .b(x18), .O(new_n132_));
  inv1   g77(.a(x14), .O(new_n133_));
  nand2  g78(.a(new_n60_), .b(new_n133_), .O(new_n134_));
  nand4  g79(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n57_), .O(new_n135_));
  nand2  g80(.a(new_n135_), .b(new_n131_), .O(z13));
  inv1   g81(.a(x34), .O(new_n137_));
  nand2  g82(.a(new_n137_), .b(new_n54_), .O(new_n138_));
  nand2  g83(.a(x35), .b(x18), .O(new_n139_));
  inv1   g84(.a(x13), .O(new_n140_));
  nand2  g85(.a(new_n60_), .b(new_n140_), .O(new_n141_));
  nand4  g86(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n57_), .O(new_n142_));
  nand2  g87(.a(new_n142_), .b(new_n138_), .O(z14));
  inv1   g88(.a(x35), .O(new_n144_));
  nand2  g89(.a(new_n144_), .b(new_n54_), .O(new_n145_));
  nand2  g90(.a(x28), .b(x18), .O(new_n146_));
  inv1   g91(.a(x12), .O(new_n147_));
  nand2  g92(.a(new_n60_), .b(new_n147_), .O(new_n148_));
  nand4  g93(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n57_), .O(new_n149_));
