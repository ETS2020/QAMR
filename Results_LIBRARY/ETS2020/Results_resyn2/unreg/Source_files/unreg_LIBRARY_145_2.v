...
module FAU ( 
  ...
  inv1   g81(.a(x32), .O(new_n135_));
  nand2  g82(.a(new_n135_), .b(new_n53_), .O(new_n136_));
  nand2  g83(.a(x33), .b(x18), .O(new_n137_));
  inv1   g84(.a(x15), .O(new_n138_));
  nand2  g85(.a(new_n59_), .b(new_n138_), .O(new_n139_));
  nand4  g86(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n56_), .O(new_n140_));
  nand2  g87(.a(new_n140_), .b(new_n136_), .O(z12));
  inv1   g88(.a(x33), .O(new_n142_));
  nand2  g89(.a(new_n142_), .b(new_n53_), .O(new_n143_));
  nand2  g90(.a(x34), .b(x18), .O(new_n144_));
  inv1   g91(.a(x14), .O(new_n145_));
  nand2  g92(.a(new_n59_), .b(new_n145_), .O(new_n146_));
  nand4  g93(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n56_), .O(new_n147_));
  nand2  g94(.a(new_n147_), .b(new_n143_), .O(z13));
  zero   g95(.O(z01));
  zero   g96(.O(z14));
  zero   g97(.O(z15));
endmodule
