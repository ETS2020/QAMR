...
module FAU ( 
  ...
  nand2  g11(.a(new_n67_), .b(new_n57_), .O(new_n68_));
  nand2  g12(.a(x26), .b(x18), .O(new_n69_));
  inv1   g13(.a(x06), .O(new_n70_));
  nand2  g14(.a(new_n63_), .b(new_n70_), .O(new_n71_));
  nand4  g15(.a(new_n71_), .b(new_n69_), .c(x19), .d(new_n60_), .O(new_n72_));
  nand2  g16(.a(new_n72_), .b(new_n68_), .O(z05));
  inv1   g17(.a(x26), .O(new_n74_));
  nand2  g18(.a(new_n74_), .b(new_n57_), .O(new_n75_));
  nand2  g19(.a(x27), .b(x18), .O(new_n76_));
  inv1   g20(.a(x05), .O(new_n77_));
  nand2  g21(.a(new_n63_), .b(new_n77_), .O(new_n78_));
  nand4  g22(.a(new_n78_), .b(new_n76_), .c(x19), .d(new_n60_), .O(new_n79_));
  nand2  g23(.a(new_n79_), .b(new_n75_), .O(z06));
  inv1   g24(.a(x27), .O(new_n81_));
  nand2  g25(.a(new_n81_), .b(new_n57_), .O(new_n82_));
  nand2  g26(.a(x20), .b(x18), .O(new_n83_));
  inv1   g27(.a(x04), .O(new_n84_));
  nand2  g28(.a(new_n63_), .b(new_n84_), .O(new_n85_));
  nand4  g29(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n60_), .O(new_n86_));
  nand2  g30(.a(new_n86_), .b(new_n82_), .O(z07));
  inv1   g31(.a(x28), .O(new_n88_));
  nand2  g32(.a(new_n88_), .b(new_n57_), .O(new_n89_));
  nand2  g33(.a(x29), .b(x18), .O(new_n90_));
  inv1   g34(.a(x11), .O(new_n91_));
  nand2  g35(.a(new_n63_), .b(new_n91_), .O(new_n92_));
  nand4  g36(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n60_), .O(new_n93_));
  nand2  g37(.a(new_n93_), .b(new_n89_), .O(z08));
  inv1   g38(.a(x29), .O(new_n95_));
  nand2  g39(.a(new_n95_), .b(new_n57_), .O(new_n96_));
  nand2  g40(.a(x30), .b(x18), .O(new_n97_));
  inv1   g41(.a(x10), .O(new_n98_));
  nand2  g42(.a(new_n63_), .b(new_n98_), .O(new_n99_));
  nand4  g43(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n60_), .O(new_n100_));
  nand2  g44(.a(new_n100_), .b(new_n96_), .O(z09));
  inv1   g45(.a(x30), .O(new_n102_));
  nand2  g46(.a(new_n102_), .b(new_n57_), .O(new_n103_));
  nand2  g47(.a(x31), .b(x18), .O(new_n104_));
  inv1   g48(.a(x09), .O(new_n105_));
  nand2  g49(.a(new_n63_), .b(new_n105_), .O(new_n106_));
  nand4  g50(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n60_), .O(new_n107_));
  nand2  g51(.a(new_n107_), .b(new_n103_), .O(z10));
  inv1   g52(.a(x32), .O(new_n110_));
  nand2  g53(.a(new_n110_), .b(new_n57_), .O(new_n111_));
  nand2  g54(.a(x33), .b(x18), .O(new_n112_));
  inv1   g55(.a(x15), .O(new_n113_));
  nand2  g56(.a(new_n63_), .b(new_n113_), .O(new_n114_));
  nand4  g57(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n60_), .O(new_n115_));
  nand2  g58(.a(new_n115_), .b(new_n111_), .O(z12));
  inv1   g59(.a(x33), .O(new_n117_));
  nand2  g60(.a(new_n117_), .b(new_n57_), .O(new_n118_));
  nand2  g61(.a(x34), .b(x18), .O(new_n119_));
  inv1   g62(.a(x14), .O(new_n120_));
  nand2  g63(.a(new_n63_), .b(new_n120_), .O(new_n121_));
  nand4  g64(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n60_), .O(new_n122_));
  nand2  g65(.a(new_n122_), .b(new_n118_), .O(z13));
  inv1   g66(.a(x35), .O(new_n125_));
  nand2  g67(.a(new_n125_), .b(new_n57_), .O(new_n126_));
  nand2  g68(.a(x28), .b(x18), .O(new_n127_));
  inv1   g69(.a(x12), .O(new_n128_));
  nand2  g70(.a(new_n63_), .b(new_n128_), .O(new_n129_));
  nand4  g71(.a(new_n129_), .b(new_n127_), .c(x19), .d(new_n60_), .O(new_n130_));
