// Benchmark "FAU" written by ABC on Fri Jul 24 21:13:51 2020
...
module FAU ( 
  ...
  nand2  g82(.a(new_n138_), .b(new_n55_), .O(new_n139_));
  nand2  g83(.a(x28), .b(x18), .O(new_n140_));
  inv1   g84(.a(x12), .O(new_n141_));
  nand2  g85(.a(new_n61_), .b(new_n141_), .O(new_n142_));
  nand4  g86(.a(new_n142_), .b(new_n140_), .c(x19), .d(new_n58_), .O(new_n143_));
