...
module FAU ( 
  ...
  inv1   g38(.a(x28), .O(new_n94_));
  nand2  g39(.a(new_n94_), .b(new_n55_), .O(new_n95_));
  nand2  g40(.a(x29), .b(x18), .O(new_n96_));
  inv1   g41(.a(x11), .O(new_n97_));
  nand2  g42(.a(new_n61_), .b(new_n97_), .O(new_n98_));
  nand4  g43(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n58_), .O(new_n99_));
  nand2  g44(.a(new_n99_), .b(new_n95_), .O(z08));
  inv1   g45(.a(x29), .O(new_n101_));
  nand2  g46(.a(new_n101_), .b(new_n55_), .O(new_n102_));
  nand2  g47(.a(x30), .b(x18), .O(new_n103_));
  inv1   g48(.a(x10), .O(new_n104_));
  nand2  g49(.a(new_n61_), .b(new_n104_), .O(new_n105_));
  nand4  g50(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n58_), .O(new_n106_));
  nand2  g51(.a(new_n106_), .b(new_n102_), .O(z09));
  inv1   g52(.a(x30), .O(new_n108_));
  nand2  g53(.a(new_n108_), .b(new_n55_), .O(new_n109_));
  nand2  g54(.a(x31), .b(x18), .O(new_n110_));
  inv1   g55(.a(x09), .O(new_n111_));
  nand2  g56(.a(new_n61_), .b(new_n111_), .O(new_n112_));
  nand4  g57(.a(new_n112_), .b(new_n110_), .c(x19), .d(new_n58_), .O(new_n113_));
  nand2  g58(.a(new_n113_), .b(new_n109_), .O(z10));
  inv1   g59(.a(x31), .O(new_n115_));
  nand2  g60(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  nand2  g61(.a(x24), .b(x18), .O(new_n117_));
  inv1   g62(.a(x08), .O(new_n118_));
  nand2  g63(.a(new_n61_), .b(new_n118_), .O(new_n119_));
  nand4  g64(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n58_), .O(new_n120_));
  nand2  g65(.a(new_n120_), .b(new_n116_), .O(z11));
  inv1   g66(.a(x32), .O(new_n122_));
  nand2  g67(.a(new_n122_), .b(new_n55_), .O(new_n123_));
  nand2  g68(.a(x33), .b(x18), .O(new_n124_));
  inv1   g69(.a(x15), .O(new_n125_));
  nand2  g70(.a(new_n61_), .b(new_n125_), .O(new_n126_));
  nand4  g71(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n58_), .O(new_n127_));
  nand2  g72(.a(new_n127_), .b(new_n123_), .O(z12));
  inv1   g73(.a(x33), .O(new_n129_));
  nand2  g74(.a(new_n129_), .b(new_n55_), .O(new_n130_));
  nand2  g75(.a(x34), .b(x18), .O(new_n131_));
  inv1   g76(.a(x14), .O(new_n132_));
  nand2  g77(.a(new_n61_), .b(new_n132_), .O(new_n133_));
  nand4  g78(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n58_), .O(new_n134_));
  nand2  g79(.a(new_n134_), .b(new_n130_), .O(z13));
  inv1   g80(.a(x34), .O(new_n136_));
  nand2  g81(.a(new_n136_), .b(new_n55_), .O(new_n137_));
  nand2  g82(.a(x35), .b(x18), .O(new_n138_));
  inv1   g83(.a(x13), .O(new_n139_));
  nand2  g84(.a(new_n61_), .b(new_n139_), .O(new_n140_));
  nand4  g85(.a(new_n140_), .b(new_n138_), .c(x19), .d(new_n58_), .O(new_n141_));
  nand2  g86(.a(new_n141_), .b(new_n137_), .O(z14));
  inv1   g87(.a(x35), .O(new_n143_));
  nand2  g88(.a(new_n143_), .b(new_n55_), .O(new_n144_));
  nand2  g89(.a(x28), .b(x18), .O(new_n145_));
  inv1   g90(.a(x12), .O(new_n146_));
  nand2  g91(.a(new_n61_), .b(new_n146_), .O(new_n147_));
  nand4  g92(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n58_), .O(new_n148_));
