...
module FAU ( 
  ...
  nand2  g47(.a(new_n103_), .b(new_n55_), .O(new_n104_));
  nand2  g48(.a(x31), .b(x18), .O(new_n105_));
  inv1   g49(.a(x09), .O(new_n106_));
  nand2  g50(.a(new_n61_), .b(new_n106_), .O(new_n107_));
  nand4  g51(.a(new_n107_), .b(new_n105_), .c(x19), .d(new_n58_), .O(new_n108_));
  nand2  g52(.a(new_n108_), .b(new_n104_), .O(z10));
  inv1   g53(.a(x31), .O(new_n110_));
  nand2  g54(.a(new_n110_), .b(new_n55_), .O(new_n111_));
  nand2  g55(.a(x24), .b(x18), .O(new_n112_));
  inv1   g56(.a(x08), .O(new_n113_));
  nand2  g57(.a(new_n61_), .b(new_n113_), .O(new_n114_));
  nand4  g58(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n58_), .O(new_n115_));
  nand2  g59(.a(new_n115_), .b(new_n111_), .O(z11));
  inv1   g60(.a(x32), .O(new_n117_));
  nand2  g61(.a(new_n117_), .b(new_n55_), .O(new_n118_));
  nand2  g62(.a(x33), .b(x18), .O(new_n119_));
  inv1   g63(.a(x15), .O(new_n120_));
  nand2  g64(.a(new_n61_), .b(new_n120_), .O(new_n121_));
  nand4  g65(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n58_), .O(new_n122_));
  ...
  nand2  g75(.a(new_n131_), .b(new_n55_), .O(new_n132_));
  nand2  g76(.a(x35), .b(x18), .O(new_n133_));
  inv1   g77(.a(x13), .O(new_n134_));
  nand2  g78(.a(new_n61_), .b(new_n134_), .O(new_n135_));
  nand4  g79(.a(new_n135_), .b(new_n133_), .c(x19), .d(new_n58_), .O(new_n136_));
