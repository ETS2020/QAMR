...
module FAU ( 
  ...
  nand2  g67(.a(new_n123_), .b(new_n54_), .O(new_n124_));
  nand2  g68(.a(x34), .b(x18), .O(new_n125_));
  inv1   g69(.a(x14), .O(new_n126_));
  nand2  g70(.a(new_n60_), .b(new_n126_), .O(new_n127_));
  nand4  g71(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n57_), .O(new_n128_));
