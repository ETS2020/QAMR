...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n86_, new_n87_, new_n88_, new_n89_, new_n90_, new_n91_, new_n95_,
  ...
  inv1   g60(.a(x33), .O(new_n118_));
  nand2  g61(.a(new_n118_), .b(new_n54_), .O(new_n119_));
  nand2  g62(.a(x34), .b(x18), .O(new_n120_));
  inv1   g63(.a(x14), .O(new_n121_));
  nand2  g64(.a(new_n60_), .b(new_n121_), .O(new_n122_));
  nand4  g65(.a(new_n122_), .b(new_n120_), .c(x19), .d(new_n57_), .O(new_n123_));
  nand2  g66(.a(new_n123_), .b(new_n119_), .O(z13));
