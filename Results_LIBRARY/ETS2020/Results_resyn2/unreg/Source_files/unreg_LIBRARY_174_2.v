...
module FAU ( 
  ...
  nand2  g54(.a(new_n113_), .b(new_n55_), .O(new_n114_));
  nand2  g55(.a(x35), .b(x18), .O(new_n115_));
  inv1   g56(.a(x13), .O(new_n116_));
  nand2  g57(.a(new_n61_), .b(new_n116_), .O(new_n117_));
  nand4  g58(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n58_), .O(new_n118_));
