...
module FAU ( 
  ...
  nand2  g74(.a(new_n130_), .b(new_n54_), .O(new_n131_));
  nand2  g75(.a(x35), .b(x18), .O(new_n132_));
  inv1   g76(.a(x13), .O(new_n133_));
  nand2  g77(.a(new_n60_), .b(new_n133_), .O(new_n134_));
  nand4  g78(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n57_), .O(new_n135_));
  nand2  g79(.a(new_n135_), .b(new_n131_), .O(z14));
  inv1   g80(.a(x35), .O(new_n137_));
  nand2  g81(.a(new_n137_), .b(new_n54_), .O(new_n138_));
  nand2  g82(.a(x28), .b(x18), .O(new_n139_));
  inv1   g83(.a(x12), .O(new_n140_));
  nand2  g84(.a(new_n60_), .b(new_n140_), .O(new_n141_));
  nand4  g85(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n57_), .O(new_n142_));
