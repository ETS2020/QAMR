...
module FAU ( 
  ...
  nand2  g11(.a(new_n68_), .b(new_n57_), .O(new_n69_));
  nand2  g12(.a(x27), .b(x18), .O(new_n70_));
  inv1   g13(.a(x05), .O(new_n71_));
  nand2  g14(.a(new_n63_), .b(new_n71_), .O(new_n72_));
  nand4  g15(.a(new_n72_), .b(new_n70_), .c(x19), .d(new_n60_), .O(new_n73_));
  nand2  g16(.a(new_n73_), .b(new_n69_), .O(z06));
  inv1   g17(.a(x27), .O(new_n75_));
  nand2  g18(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  nand2  g19(.a(x20), .b(x18), .O(new_n77_));
  inv1   g20(.a(x04), .O(new_n78_));
  nand2  g21(.a(new_n63_), .b(new_n78_), .O(new_n79_));
  nand4  g22(.a(new_n79_), .b(new_n77_), .c(x19), .d(new_n60_), .O(new_n80_));
  nand2  g23(.a(new_n80_), .b(new_n76_), .O(z07));
  inv1   g24(.a(x28), .O(new_n82_));
  nand2  g25(.a(new_n82_), .b(new_n57_), .O(new_n83_));
  nand2  g26(.a(x29), .b(x18), .O(new_n84_));
  inv1   g27(.a(x11), .O(new_n85_));
  nand2  g28(.a(new_n63_), .b(new_n85_), .O(new_n86_));
  nand4  g29(.a(new_n86_), .b(new_n84_), .c(x19), .d(new_n60_), .O(new_n87_));
  nand2  g30(.a(new_n87_), .b(new_n83_), .O(z08));
  inv1   g31(.a(x30), .O(new_n90_));
  nand2  g32(.a(new_n90_), .b(new_n57_), .O(new_n91_));
  nand2  g33(.a(x31), .b(x18), .O(new_n92_));
  inv1   g34(.a(x09), .O(new_n93_));
  nand2  g35(.a(new_n63_), .b(new_n93_), .O(new_n94_));
  nand4  g36(.a(new_n94_), .b(new_n92_), .c(x19), .d(new_n60_), .O(new_n95_));
  nand2  g37(.a(new_n95_), .b(new_n91_), .O(z10));
  inv1   g38(.a(x32), .O(new_n98_));
  nand2  g39(.a(new_n98_), .b(new_n57_), .O(new_n99_));
  nand2  g40(.a(x33), .b(x18), .O(new_n100_));
  inv1   g41(.a(x15), .O(new_n101_));
  nand2  g42(.a(new_n63_), .b(new_n101_), .O(new_n102_));
  nand4  g43(.a(new_n102_), .b(new_n100_), .c(x19), .d(new_n60_), .O(new_n103_));
  nand2  g44(.a(new_n103_), .b(new_n99_), .O(z12));
  inv1   g45(.a(x33), .O(new_n105_));
  nand2  g46(.a(new_n105_), .b(new_n57_), .O(new_n106_));
  nand2  g47(.a(x34), .b(x18), .O(new_n107_));
  inv1   g48(.a(x14), .O(new_n108_));
  nand2  g49(.a(new_n63_), .b(new_n108_), .O(new_n109_));
  nand4  g50(.a(new_n109_), .b(new_n107_), .c(x19), .d(new_n60_), .O(new_n110_));
