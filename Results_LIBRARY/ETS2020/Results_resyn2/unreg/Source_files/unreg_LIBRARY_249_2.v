...
module FAU ( 
  ...
  nand2  g53(.a(new_n110_), .b(new_n54_), .O(new_n111_));
  nand2  g54(.a(x33), .b(x18), .O(new_n112_));
  inv1   g55(.a(x15), .O(new_n113_));
  nand2  g56(.a(new_n60_), .b(new_n113_), .O(new_n114_));
  nand4  g57(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n57_), .O(new_n115_));
  nand2  g58(.a(new_n115_), .b(new_n111_), .O(z12));
  inv1   g59(.a(x33), .O(new_n117_));
  nand2  g60(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nand2  g61(.a(x34), .b(x18), .O(new_n119_));
  inv1   g62(.a(x14), .O(new_n120_));
  nand2  g63(.a(new_n60_), .b(new_n120_), .O(new_n121_));
  nand4  g64(.a(new_n121_), .b(new_n119_), .c(x19), .d(new_n57_), .O(new_n122_));
