...
module FAU ( 
  ...
  nand2  g75(.a(new_n128_), .b(new_n54_), .O(new_n129_));
  nand2  g76(.a(x24), .b(x18), .O(new_n130_));
  inv1   g77(.a(x08), .O(new_n131_));
  nand2  g78(.a(new_n60_), .b(new_n131_), .O(new_n132_));
  nand4  g79(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n57_), .O(new_n133_));
