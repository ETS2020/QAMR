...
module FAU ( 
  ...
  nand2  g026(.a(new_n80_), .b(new_n54_), .O(new_n81_));
  nand2  g027(.a(x26), .b(x18), .O(new_n82_));
  inv1   g028(.a(x06), .O(new_n83_));
  nand2  g029(.a(new_n60_), .b(new_n83_), .O(new_n84_));
  nand4  g030(.a(new_n84_), .b(new_n82_), .c(x19), .d(new_n57_), .O(new_n85_));
  nand2  g031(.a(new_n85_), .b(new_n81_), .O(z05));
  inv1   g032(.a(x26), .O(new_n87_));
  nand2  g033(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  nand2  g034(.a(x27), .b(x18), .O(new_n89_));
  inv1   g035(.a(x05), .O(new_n90_));
  nand2  g036(.a(new_n60_), .b(new_n90_), .O(new_n91_));
  nand4  g037(.a(new_n91_), .b(new_n89_), .c(x19), .d(new_n57_), .O(new_n92_));
