...
module FAU ( 
  ...
  wire new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n131_, new_n132_, new_n133_, new_n134_, new_n135_;
  ...
  nand2  g26(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  nand2  g27(.a(x27), .b(x18), .O(new_n83_));
  inv1   g28(.a(x05), .O(new_n84_));
  nand2  g29(.a(new_n61_), .b(new_n84_), .O(new_n85_));
  nand4  g30(.a(new_n85_), .b(new_n83_), .c(x19), .d(new_n58_), .O(new_n86_));
  nand2  g31(.a(new_n86_), .b(new_n82_), .O(z06));
  inv1   g32(.a(x27), .O(new_n88_));
  nand2  g33(.a(new_n88_), .b(new_n55_), .O(new_n89_));
  nand2  g34(.a(x20), .b(x18), .O(new_n90_));
  inv1   g35(.a(x04), .O(new_n91_));
  nand2  g36(.a(new_n61_), .b(new_n91_), .O(new_n92_));
  nand4  g37(.a(new_n92_), .b(new_n90_), .c(x19), .d(new_n58_), .O(new_n93_));
  nand2  g38(.a(new_n93_), .b(new_n89_), .O(z07));
  inv1   g39(.a(x28), .O(new_n95_));
  nand2  g40(.a(new_n95_), .b(new_n55_), .O(new_n96_));
  nand2  g41(.a(x29), .b(x18), .O(new_n97_));
  inv1   g42(.a(x11), .O(new_n98_));
  nand2  g43(.a(new_n61_), .b(new_n98_), .O(new_n99_));
  nand4  g44(.a(new_n99_), .b(new_n97_), .c(x19), .d(new_n58_), .O(new_n100_));
  nand2  g45(.a(new_n100_), .b(new_n96_), .O(z08));
  inv1   g46(.a(x29), .O(new_n102_));
  nand2  g47(.a(new_n102_), .b(new_n55_), .O(new_n103_));
  nand2  g48(.a(x30), .b(x18), .O(new_n104_));
  inv1   g49(.a(x10), .O(new_n105_));
  nand2  g50(.a(new_n61_), .b(new_n105_), .O(new_n106_));
  nand4  g51(.a(new_n106_), .b(new_n104_), .c(x19), .d(new_n58_), .O(new_n107_));
  ...
  nand2  g68(.a(new_n123_), .b(new_n55_), .O(new_n124_));
  nand2  g69(.a(x33), .b(x18), .O(new_n125_));
  inv1   g70(.a(x15), .O(new_n126_));
  nand2  g71(.a(new_n61_), .b(new_n126_), .O(new_n127_));
  nand4  g72(.a(new_n127_), .b(new_n125_), .c(x19), .d(new_n58_), .O(new_n128_));
  nand2  g73(.a(new_n128_), .b(new_n124_), .O(z12));
  inv1   g74(.a(x33), .O(new_n130_));
  nand2  g75(.a(new_n130_), .b(new_n55_), .O(new_n131_));
  nand2  g76(.a(x34), .b(x18), .O(new_n132_));
  inv1   g77(.a(x14), .O(new_n133_));
  nand2  g78(.a(new_n61_), .b(new_n133_), .O(new_n134_));
  nand4  g79(.a(new_n134_), .b(new_n132_), .c(x19), .d(new_n58_), .O(new_n135_));
