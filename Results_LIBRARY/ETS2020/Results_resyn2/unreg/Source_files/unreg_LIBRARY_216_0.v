...
module FAU ( 
  ...
  nand2  g68(.a(new_n125_), .b(new_n53_), .O(new_n126_));
  nand2  g69(.a(x35), .b(x18), .O(new_n127_));
  inv1   g70(.a(x13), .O(new_n128_));
  nand2  g71(.a(new_n59_), .b(new_n128_), .O(new_n129_));
  nand4  g72(.a(new_n129_), .b(new_n127_), .c(x19), .d(new_n56_), .O(new_n130_));
