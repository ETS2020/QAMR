...
module FAU ( 
  ...
  nand2  g033(.a(new_n86_), .b(new_n53_), .O(new_n87_));
  nand2  g034(.a(x26), .b(x18), .O(new_n88_));
  inv1   g035(.a(x06), .O(new_n89_));
  nand2  g036(.a(new_n59_), .b(new_n89_), .O(new_n90_));
  nand4  g037(.a(new_n90_), .b(new_n88_), .c(x19), .d(new_n56_), .O(new_n91_));
  nand2  g038(.a(new_n91_), .b(new_n87_), .O(z05));
  inv1   g039(.a(x26), .O(new_n93_));
  nand2  g040(.a(new_n93_), .b(new_n53_), .O(new_n94_));
  nand2  g041(.a(x27), .b(x18), .O(new_n95_));
  inv1   g042(.a(x05), .O(new_n96_));
  nand2  g043(.a(new_n59_), .b(new_n96_), .O(new_n97_));
  nand4  g044(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n56_), .O(new_n98_));
  ...
  nand2  g089(.a(new_n142_), .b(new_n53_), .O(new_n143_));
  nand2  g090(.a(x34), .b(x18), .O(new_n144_));
  inv1   g091(.a(x14), .O(new_n145_));
  nand2  g092(.a(new_n59_), .b(new_n145_), .O(new_n146_));
  nand4  g093(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n56_), .O(new_n147_));
  ...
  nand2  g099(.a(new_n59_), .b(new_n152_), .O(new_n153_));
  nand4  g100(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n56_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n150_), .O(z14));
  inv1   g102(.a(x35), .O(new_n156_));
  nand2  g103(.a(new_n156_), .b(new_n53_), .O(new_n157_));
  nand2  g104(.a(x28), .b(x18), .O(new_n158_));
  inv1   g105(.a(x12), .O(new_n159_));
  nand2  g106(.a(new_n59_), .b(new_n159_), .O(new_n160_));
  nand4  g107(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n56_), .O(new_n161_));
