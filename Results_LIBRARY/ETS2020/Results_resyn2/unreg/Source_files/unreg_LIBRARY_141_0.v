...
module FAU ( 
  ...
  nand2  g61(.a(new_n118_), .b(new_n53_), .O(new_n119_));
  nand2  g62(.a(x34), .b(x18), .O(new_n120_));
  inv1   g63(.a(x14), .O(new_n121_));
  nand2  g64(.a(new_n59_), .b(new_n121_), .O(new_n122_));
  nand4  g65(.a(new_n122_), .b(new_n120_), .c(x19), .d(new_n56_), .O(new_n123_));
