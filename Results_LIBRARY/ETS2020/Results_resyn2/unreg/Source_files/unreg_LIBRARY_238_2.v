...
module FAU ( 
  ...
  nand2  g39(.a(new_n94_), .b(new_n53_), .O(new_n95_));
  nand2  g40(.a(x29), .b(x18), .O(new_n96_));
  inv1   g41(.a(x11), .O(new_n97_));
  nand2  g42(.a(new_n59_), .b(new_n97_), .O(new_n98_));
  nand4  g43(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n56_), .O(new_n99_));
  nand2  g44(.a(new_n99_), .b(new_n95_), .O(z08));
  inv1   g45(.a(x29), .O(new_n101_));
  nand2  g46(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  nand2  g47(.a(x30), .b(x18), .O(new_n103_));
  inv1   g48(.a(x10), .O(new_n104_));
  nand2  g49(.a(new_n59_), .b(new_n104_), .O(new_n105_));
  nand4  g50(.a(new_n105_), .b(new_n103_), .c(x19), .d(new_n56_), .O(new_n106_));
