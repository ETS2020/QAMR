...
module FAU ( 
  ...
  nand2  g46(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  nand2  g47(.a(x20), .b(x18), .O(new_n101_));
  inv1   g48(.a(x04), .O(new_n102_));
  nand2  g49(.a(new_n59_), .b(new_n102_), .O(new_n103_));
  nand4  g50(.a(new_n103_), .b(new_n101_), .c(x19), .d(new_n56_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(new_n100_), .O(z07));
