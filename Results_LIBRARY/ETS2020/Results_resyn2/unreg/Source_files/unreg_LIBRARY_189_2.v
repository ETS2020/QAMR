...
module FAU ( 
  ...
  nand2  g32(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  nand2  g33(.a(x31), .b(x18), .O(new_n92_));
  inv1   g34(.a(x09), .O(new_n93_));
  nand2  g35(.a(new_n61_), .b(new_n93_), .O(new_n94_));
  nand4  g36(.a(new_n94_), .b(new_n92_), .c(x19), .d(new_n58_), .O(new_n95_));
  ...
  nand2  g67(.a(new_n125_), .b(new_n55_), .O(new_n126_));
  nand2  g68(.a(x28), .b(x18), .O(new_n127_));
  inv1   g69(.a(x12), .O(new_n128_));
  nand2  g70(.a(new_n61_), .b(new_n128_), .O(new_n129_));
  nand4  g71(.a(new_n129_), .b(new_n127_), .c(x19), .d(new_n58_), .O(new_n130_));
