...
module FAU ( 
  ...
  nand2  g040(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  nand2  g041(.a(x27), .b(x18), .O(new_n95_));
  inv1   g042(.a(x05), .O(new_n96_));
  nand2  g043(.a(new_n60_), .b(new_n96_), .O(new_n97_));
  nand4  g044(.a(new_n97_), .b(new_n95_), .c(x19), .d(new_n57_), .O(new_n98_));
  nand2  g045(.a(new_n98_), .b(new_n94_), .O(z06));
  inv1   g046(.a(x27), .O(new_n100_));
  nand2  g047(.a(new_n100_), .b(new_n54_), .O(new_n101_));
  nand2  g048(.a(x20), .b(x18), .O(new_n102_));
  inv1   g049(.a(x04), .O(new_n103_));
  nand2  g050(.a(new_n60_), .b(new_n103_), .O(new_n104_));
  nand4  g051(.a(new_n104_), .b(new_n102_), .c(x19), .d(new_n57_), .O(new_n105_));
  nand2  g052(.a(new_n105_), .b(new_n101_), .O(z07));
  inv1   g053(.a(x28), .O(new_n107_));
  nand2  g054(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  nand2  g055(.a(x29), .b(x18), .O(new_n109_));
  inv1   g056(.a(x11), .O(new_n110_));
  nand2  g057(.a(new_n60_), .b(new_n110_), .O(new_n111_));
  nand4  g058(.a(new_n111_), .b(new_n109_), .c(x19), .d(new_n57_), .O(new_n112_));
  nand2  g059(.a(new_n112_), .b(new_n108_), .O(z08));
  inv1   g060(.a(x29), .O(new_n114_));
  nand2  g061(.a(new_n114_), .b(new_n54_), .O(new_n115_));
  nand2  g062(.a(x30), .b(x18), .O(new_n116_));
  inv1   g063(.a(x10), .O(new_n117_));
  nand2  g064(.a(new_n60_), .b(new_n117_), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n116_), .c(x19), .d(new_n57_), .O(new_n119_));
  nand2  g066(.a(new_n119_), .b(new_n115_), .O(z09));
  inv1   g067(.a(x30), .O(new_n121_));
  nand2  g068(.a(new_n121_), .b(new_n54_), .O(new_n122_));
  nand2  g069(.a(x31), .b(x18), .O(new_n123_));
  inv1   g070(.a(x09), .O(new_n124_));
  nand2  g071(.a(new_n60_), .b(new_n124_), .O(new_n125_));
  nand4  g072(.a(new_n125_), .b(new_n123_), .c(x19), .d(new_n57_), .O(new_n126_));
  nand2  g073(.a(new_n126_), .b(new_n122_), .O(z10));
  inv1   g074(.a(x31), .O(new_n128_));
  nand2  g075(.a(new_n128_), .b(new_n54_), .O(new_n129_));
  nand2  g076(.a(x24), .b(x18), .O(new_n130_));
  inv1   g077(.a(x08), .O(new_n131_));
  nand2  g078(.a(new_n60_), .b(new_n131_), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n130_), .c(x19), .d(new_n57_), .O(new_n133_));
  nand2  g080(.a(new_n133_), .b(new_n129_), .O(z11));
  inv1   g081(.a(x32), .O(new_n135_));
  nand2  g082(.a(new_n135_), .b(new_n54_), .O(new_n136_));
  nand2  g083(.a(x33), .b(x18), .O(new_n137_));
  inv1   g084(.a(x15), .O(new_n138_));
  nand2  g085(.a(new_n60_), .b(new_n138_), .O(new_n139_));
  nand4  g086(.a(new_n139_), .b(new_n137_), .c(x19), .d(new_n57_), .O(new_n140_));
  nand2  g087(.a(new_n140_), .b(new_n136_), .O(z12));
  inv1   g088(.a(x33), .O(new_n142_));
  nand2  g089(.a(new_n142_), .b(new_n54_), .O(new_n143_));
  nand2  g090(.a(x34), .b(x18), .O(new_n144_));
  inv1   g091(.a(x14), .O(new_n145_));
  nand2  g092(.a(new_n60_), .b(new_n145_), .O(new_n146_));
  nand4  g093(.a(new_n146_), .b(new_n144_), .c(x19), .d(new_n57_), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(new_n143_), .O(z13));
  inv1   g095(.a(x34), .O(new_n149_));
  nand2  g096(.a(new_n149_), .b(new_n54_), .O(new_n150_));
  nand2  g097(.a(x35), .b(x18), .O(new_n151_));
  inv1   g098(.a(x13), .O(new_n152_));
  nand2  g099(.a(new_n60_), .b(new_n152_), .O(new_n153_));
  nand4  g100(.a(new_n153_), .b(new_n151_), .c(x19), .d(new_n57_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n150_), .O(z14));
  inv1   g102(.a(x35), .O(new_n156_));
  nand2  g103(.a(new_n156_), .b(new_n54_), .O(new_n157_));
  nand2  g104(.a(x28), .b(x18), .O(new_n158_));
  inv1   g105(.a(x12), .O(new_n159_));
  nand2  g106(.a(new_n60_), .b(new_n159_), .O(new_n160_));
  nand4  g107(.a(new_n160_), .b(new_n158_), .c(x19), .d(new_n57_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n157_), .O(z15));
  zero   g109(.O(z00));
endmodule
