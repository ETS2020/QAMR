...
module FAU ( 
  ...
  nand2  g67(.a(new_n122_), .b(new_n54_), .O(new_n123_));
  nand2  g68(.a(x33), .b(x18), .O(new_n124_));
  inv1   g69(.a(x15), .O(new_n125_));
  nand2  g70(.a(new_n60_), .b(new_n125_), .O(new_n126_));
  nand4  g71(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n57_), .O(new_n127_));
  nand2  g72(.a(new_n127_), .b(new_n123_), .O(z12));
  inv1   g73(.a(x33), .O(new_n129_));
  nand2  g74(.a(new_n129_), .b(new_n54_), .O(new_n130_));
  nand2  g75(.a(x34), .b(x18), .O(new_n131_));
  inv1   g76(.a(x14), .O(new_n132_));
  nand2  g77(.a(new_n60_), .b(new_n132_), .O(new_n133_));
  nand4  g78(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n57_), .O(new_n134_));
