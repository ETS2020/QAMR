...
module FAU ( 
  ...
  inv1   g38(.a(x26), .O(new_n92_));
  nand2  g39(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  nand2  g40(.a(x27), .b(x18), .O(new_n94_));
  inv1   g41(.a(x05), .O(new_n95_));
  nand2  g42(.a(new_n59_), .b(new_n95_), .O(new_n96_));
  nand4  g43(.a(new_n96_), .b(new_n94_), .c(x19), .d(new_n56_), .O(new_n97_));
  nand2  g44(.a(new_n97_), .b(new_n93_), .O(z06));
