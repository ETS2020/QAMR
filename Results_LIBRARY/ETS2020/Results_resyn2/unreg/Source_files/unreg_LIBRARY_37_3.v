...
module FAU ( 
  ...
  nand2  g82(.a(new_n137_), .b(new_n55_), .O(new_n138_));
  nand2  g83(.a(x35), .b(x18), .O(new_n139_));
  inv1   g84(.a(x13), .O(new_n140_));
  nand2  g85(.a(new_n61_), .b(new_n140_), .O(new_n141_));
  nand4  g86(.a(new_n141_), .b(new_n139_), .c(x19), .d(new_n58_), .O(new_n142_));
  nand2  g87(.a(new_n142_), .b(new_n138_), .O(z14));
  inv1   g88(.a(x35), .O(new_n144_));
  nand2  g89(.a(new_n144_), .b(new_n55_), .O(new_n145_));
  nand2  g90(.a(x28), .b(x18), .O(new_n146_));
  inv1   g91(.a(x12), .O(new_n147_));
  nand2  g92(.a(new_n61_), .b(new_n147_), .O(new_n148_));
  nand4  g93(.a(new_n148_), .b(new_n146_), .c(x19), .d(new_n58_), .O(new_n149_));
