// Benchmark "FAU" written by ABC on Fri Jul 24 21:14:01 2020
...
module FAU ( 
  ...
  nand2  g61(.a(new_n115_), .b(new_n54_), .O(new_n116_));
  nand2  g62(.a(x31), .b(x18), .O(new_n117_));
  inv1   g63(.a(x09), .O(new_n118_));
  nand2  g64(.a(new_n60_), .b(new_n118_), .O(new_n119_));
  nand4  g65(.a(new_n119_), .b(new_n117_), .c(x19), .d(new_n57_), .O(new_n120_));
  nand2  g66(.a(new_n120_), .b(new_n116_), .O(z10));
  inv1   g67(.a(x31), .O(new_n122_));
  nand2  g68(.a(new_n122_), .b(new_n54_), .O(new_n123_));
  nand2  g69(.a(x24), .b(x18), .O(new_n124_));
  inv1   g70(.a(x08), .O(new_n125_));
  nand2  g71(.a(new_n60_), .b(new_n125_), .O(new_n126_));
  nand4  g72(.a(new_n126_), .b(new_n124_), .c(x19), .d(new_n57_), .O(new_n127_));
  nand2  g73(.a(new_n127_), .b(new_n123_), .O(z11));
  inv1   g74(.a(x32), .O(new_n129_));
  nand2  g75(.a(new_n129_), .b(new_n54_), .O(new_n130_));
  nand2  g76(.a(x33), .b(x18), .O(new_n131_));
  inv1   g77(.a(x15), .O(new_n132_));
  nand2  g78(.a(new_n60_), .b(new_n132_), .O(new_n133_));
  nand4  g79(.a(new_n133_), .b(new_n131_), .c(x19), .d(new_n57_), .O(new_n134_));
