...
module FAU ( 
  ...
  inv1   g88(.a(x34), .O(new_n143_));
  nand2  g89(.a(new_n143_), .b(new_n53_), .O(new_n144_));
  nand2  g90(.a(x35), .b(x18), .O(new_n145_));
  inv1   g91(.a(x13), .O(new_n146_));
  nand2  g92(.a(new_n59_), .b(new_n146_), .O(new_n147_));
  nand4  g93(.a(new_n147_), .b(new_n145_), .c(x19), .d(new_n56_), .O(new_n148_));
  nand2  g94(.a(new_n148_), .b(new_n144_), .O(z14));
  zero   g95(.O(z05));
  zero   g96(.O(z08));
  zero   g97(.O(z15));
endmodule
