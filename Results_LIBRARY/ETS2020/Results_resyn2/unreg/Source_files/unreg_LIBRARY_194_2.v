...
module FAU ( 
  ...
  nand2  g46(.a(new_n105_), .b(new_n53_), .O(new_n106_));
  nand2  g47(.a(x34), .b(x18), .O(new_n107_));
  inv1   g48(.a(x14), .O(new_n108_));
  nand2  g49(.a(new_n59_), .b(new_n108_), .O(new_n109_));
  nand4  g50(.a(new_n109_), .b(new_n107_), .c(x19), .d(new_n56_), .O(new_n110_));
  nand2  g51(.a(new_n110_), .b(new_n106_), .O(z13));
  inv1   g52(.a(x35), .O(new_n113_));
  nand2  g53(.a(new_n113_), .b(new_n53_), .O(new_n114_));
  nand2  g54(.a(x28), .b(x18), .O(new_n115_));
  inv1   g55(.a(x12), .O(new_n116_));
  nand2  g56(.a(new_n59_), .b(new_n116_), .O(new_n117_));
  nand4  g57(.a(new_n117_), .b(new_n115_), .c(x19), .d(new_n56_), .O(new_n118_));
