...
module FAU ( 
  ...
  nand2  g39(.a(new_n94_), .b(new_n54_), .O(new_n95_));
  nand2  g40(.a(x29), .b(x18), .O(new_n96_));
  inv1   g41(.a(x11), .O(new_n97_));
  nand2  g42(.a(new_n60_), .b(new_n97_), .O(new_n98_));
  nand4  g43(.a(new_n98_), .b(new_n96_), .c(x19), .d(new_n57_), .O(new_n99_));
  ...
  nand2  g60(.a(new_n119_), .b(new_n54_), .O(new_n120_));
  nand2  g61(.a(x28), .b(x18), .O(new_n121_));
  inv1   g62(.a(x12), .O(new_n122_));
  nand2  g63(.a(new_n60_), .b(new_n122_), .O(new_n123_));
  nand4  g64(.a(new_n123_), .b(new_n121_), .c(x19), .d(new_n57_), .O(new_n124_));
