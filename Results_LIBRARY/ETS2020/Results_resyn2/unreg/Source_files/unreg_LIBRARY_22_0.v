...
module FAU ( 
  ...
  nand2  g75(.a(new_n132_), .b(new_n53_), .O(new_n133_));
  nand2  g76(.a(x28), .b(x18), .O(new_n134_));
  inv1   g77(.a(x12), .O(new_n135_));
  nand2  g78(.a(new_n59_), .b(new_n135_), .O(new_n136_));
  nand4  g79(.a(new_n136_), .b(new_n134_), .c(x19), .d(new_n56_), .O(new_n137_));
