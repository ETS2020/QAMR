...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n53_, new_n56_, new_n58_, new_n60_, new_n63_, new_n65_,
  ...
  nand2  g38(.a(x08), .b(x04), .O(new_n87_));
  nand2  g39(.a(new_n81_), .b(x15), .O(new_n88_));
  inv1   g40(.a(x23), .O(new_n89_));
  nor2   g41(.a(new_n82_), .b(new_n89_), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  aoi21  g43(.a(new_n82_), .b(new_n89_), .c(new_n52_), .O(new_n92_));
  nand2  g44(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g45(.a(new_n93_), .b(new_n87_), .O(z13));
