...
module FAU ( 
  ...
  nor2   g20(.a(new_n51_), .b(new_n45_), .O(new_n69_));
  and2   g21(.a(x21), .b(x12), .O(new_n70_));
  aoi21  g22(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  inv1   g23(.a(new_n50_), .O(new_n72_));
  or2    g24(.a(x20), .b(x19), .O(new_n73_));
  nand2  g25(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g26(.a(new_n74_), .b(new_n71_), .c(new_n55_), .O(z10));
  aoi21  g27(.a(new_n69_), .b(x13), .c(new_n46_), .O(new_n76_));
  inv1   g28(.a(x21), .O(new_n77_));
  nand2  g29(.a(new_n68_), .b(new_n77_), .O(new_n78_));
  nand2  g30(.a(new_n78_), .b(new_n72_), .O(new_n79_));
  oai21  g31(.a(new_n79_), .b(new_n76_), .c(new_n57_), .O(z11));
  inv1   g32(.a(new_n51_), .O(new_n81_));
  ...
  nand2  g37(.a(new_n46_), .b(new_n85_), .O(new_n86_));
  nand2  g38(.a(new_n86_), .b(new_n72_), .O(new_n87_));
  oai21  g39(.a(new_n87_), .b(new_n84_), .c(new_n59_), .O(z12));
  nand4  g40(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  inv1   g42(.a(x23), .O(new_n91_));
  aoi21  g43(.a(new_n82_), .b(new_n91_), .c(new_n50_), .O(new_n92_));
  nand2  g44(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand2  g45(.a(new_n93_), .b(new_n61_), .O(z13));
  nand3  g46(.a(x26), .b(x25), .c(x16), .O(new_n95_));
  nand3  g47(.a(new_n95_), .b(new_n47_), .c(x24), .O(new_n96_));
  inv1   g48(.a(x24), .O(new_n97_));
  oai21  g49(.a(new_n46_), .b(new_n45_), .c(new_n97_), .O(new_n98_));
  nand3  g50(.a(new_n98_), .b(new_n96_), .c(new_n72_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n63_), .O(z14));
  zero   g52(.O(z01));
  zero   g53(.O(z07));
  zero   g54(.O(z08));
  zero   g55(.O(z09));
