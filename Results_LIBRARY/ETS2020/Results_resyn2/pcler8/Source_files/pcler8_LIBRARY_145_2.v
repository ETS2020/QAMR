// Benchmark "FAU" written by ABC on Fri Jul 24 22:02:14 2020
...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n53_, new_n56_, new_n58_, new_n61_, new_n63_, new_n65_,
  ...
  nand2  g32(.a(x08), .b(x03), .O(new_n81_));
  ...
  oai21  g37(.a(new_n48_), .b(x22), .c(new_n73_), .O(new_n86_));
  oai21  g38(.a(new_n86_), .b(new_n85_), .c(new_n81_), .O(z12));
