...
module FAU ( 
  ...
  and2   g10(.a(x08), .b(x04), .O(z05));
  nand2  g11(.a(x08), .b(x05), .O(new_n58_));
  inv1   g12(.a(new_n58_), .O(z06));
  nand2  g13(.a(x08), .b(x06), .O(new_n60_));
  inv1   g14(.a(new_n60_), .O(z07));
  nand2  g15(.a(x08), .b(x07), .O(new_n62_));
  inv1   g16(.a(new_n62_), .O(z08));
  inv1   g17(.a(x19), .O(new_n64_));
  nand2  g18(.a(x22), .b(x21), .O(new_n65_));
  nor2   g19(.a(new_n46_), .b(new_n65_), .O(new_n66_));
  and2   g20(.a(x20), .b(x11), .O(new_n67_));
  aoi21  g21(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(new_n68_));
  oai21  g22(.a(new_n68_), .b(new_n49_), .c(new_n51_), .O(z09));
  nand2  g23(.a(x20), .b(x19), .O(new_n70_));
  aoi21  g24(.a(new_n66_), .b(x12), .c(new_n70_), .O(new_n71_));
  inv1   g25(.a(new_n49_), .O(new_n72_));
  inv1   g26(.a(x20), .O(new_n73_));
  nand2  g27(.a(new_n73_), .b(new_n64_), .O(new_n74_));
  nand2  g28(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  oai21  g29(.a(new_n75_), .b(new_n71_), .c(new_n53_), .O(z10));
  nand2  g30(.a(x08), .b(x03), .O(new_n78_));
  ...
  nand2  g36(.a(new_n83_), .b(new_n72_), .O(new_n84_));
  oai21  g37(.a(new_n84_), .b(new_n80_), .c(new_n78_), .O(z12));
  ...
  nand3  g45(.a(new_n93_), .b(new_n89_), .c(new_n72_), .O(new_n94_));
  nand2  g46(.a(new_n94_), .b(new_n58_), .O(z14));
  ...
  nand3  g51(.a(new_n99_), .b(new_n97_), .c(new_n72_), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n60_), .O(z15));
  ...
  nand2  g57(.a(new_n105_), .b(new_n72_), .O(new_n106_));
  oai21  g58(.a(new_n106_), .b(new_n102_), .c(new_n62_), .O(z16));
  zero   g59(.O(z03));
  zero   g60(.O(z04));
  zero   g61(.O(z11));
  zero   g62(.O(z13));
