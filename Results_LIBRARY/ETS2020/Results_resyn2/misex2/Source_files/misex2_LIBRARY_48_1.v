...
module FAU ( 
  ...
  nand3  g50(.a(new_n93_), .b(new_n90_), .c(new_n87_), .O(new_n94_));
  ...
  inv1   g57(.a(new_n96_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(x22), .c(x21), .O(new_n102_));
  nand2  g59(.a(x16), .b(x15), .O(new_n103_));
  nand3  g60(.a(new_n98_), .b(new_n97_), .c(x20), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n90_), .c(new_n87_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n102_), .c(x00), .O(z10));
  nand2  g64(.a(new_n70_), .b(new_n71_), .O(new_n109_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n86_), .O(new_n111_));
  ...
  nor2   g72(.a(new_n111_), .b(new_n47_), .O(z13));
  nor2   g73(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g74(.a(new_n57_), .b(x01), .c(new_n86_), .O(new_n119_));
  nand3  g75(.a(x19), .b(new_n86_), .c(new_n46_), .O(new_n120_));
