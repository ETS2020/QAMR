...
module FAU ( 
  ...
  nor2   g43(.a(x20), .b(new_n46_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n64_), .c(x22), .d(x21), .O(new_n89_));
  nand2  g45(.a(x02), .b(new_n46_), .O(new_n90_));
  inv1   g46(.a(x13), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(x12), .c(new_n67_), .O(new_n92_));
  nor2   g48(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  inv1   g49(.a(x14), .O(new_n94_));
  inv1   g50(.a(x21), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(x20), .c(x15), .d(new_n94_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  inv1   g53(.a(x16), .O(new_n98_));
  nor2   g54(.a(x22), .b(new_n98_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n97_), .c(new_n93_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n89_), .c(x00), .O(z10));
  nand3  g57(.a(new_n88_), .b(new_n64_), .c(x21), .O(new_n102_));
  nand3  g58(.a(new_n97_), .b(new_n93_), .c(new_n98_), .O(new_n103_));
  inv1   g59(.a(x22), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n45_), .O(new_n105_));
  aoi21  g61(.a(new_n103_), .b(new_n102_), .c(new_n105_), .O(z11));
  nand2  g62(.a(new_n71_), .b(new_n72_), .O(new_n107_));
  ...
  nand2  g67(.a(new_n111_), .b(new_n83_), .O(new_n112_));
  inv1   g68(.a(x24), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(x09), .O(new_n114_));
  aoi21  g70(.a(new_n112_), .b(new_n107_), .c(new_n114_), .O(z12));
