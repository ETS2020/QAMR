...
module FAU ( 
  ...
  nand3  g07(.a(x20), .b(new_n58_), .c(new_n57_), .O(new_n59_));
  inv1   g08(.a(new_n59_), .O(new_n60_));
  inv1   g09(.a(x02), .O(new_n61_));
  nor2   g10(.a(new_n61_), .b(x01), .O(new_n62_));
  inv1   g11(.a(x11), .O(new_n63_));
  inv1   g12(.a(x13), .O(new_n64_));
  inv1   g13(.a(x14), .O(new_n65_));
  nand4  g14(.a(new_n65_), .b(new_n64_), .c(x12), .d(new_n63_), .O(new_n66_));
  inv1   g15(.a(new_n66_), .O(new_n67_));
  nand3  g16(.a(new_n67_), .b(new_n62_), .c(new_n60_), .O(new_n68_));
  nor2   g17(.a(x20), .b(x19), .O(new_n69_));
  nand3  g18(.a(new_n69_), .b(x18), .c(x01), .O(new_n70_));
  inv1   g19(.a(x22), .O(new_n71_));
  nor2   g20(.a(x21), .b(x00), .O(new_n72_));
  nand2  g21(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  aoi21  g22(.a(new_n70_), .b(new_n68_), .c(new_n73_), .O(z09));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
