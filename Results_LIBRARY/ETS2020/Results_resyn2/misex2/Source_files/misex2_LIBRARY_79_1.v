...
module FAU ( 
  ...
  nand2  g28(.a(new_n62_), .b(x09), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n71_), .O(z05));
  nand4  g30(.a(new_n68_), .b(x11), .c(x10), .d(new_n44_), .O(new_n75_));
  ...
  nand2  g42(.a(x02), .b(new_n61_), .O(new_n87_));
  ...
  nor2   g47(.a(new_n85_), .b(x16), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  inv1   g49(.a(x21), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n94_), .c(new_n60_), .O(new_n96_));
  aoi21  g52(.a(new_n93_), .b(new_n86_), .c(new_n96_), .O(z09));
  inv1   g53(.a(new_n86_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(x22), .c(x21), .O(new_n99_));
  inv1   g55(.a(x14), .O(new_n100_));
  nand4  g56(.a(new_n94_), .b(x20), .c(x15), .d(new_n100_), .O(new_n101_));
  ...
  nand2  g62(.a(new_n95_), .b(new_n60_), .O(new_n107_));
  nand2  g63(.a(new_n98_), .b(x21), .O(new_n108_));
  nand3  g64(.a(new_n102_), .b(new_n90_), .c(new_n103_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(z11));
  nand2  g66(.a(new_n71_), .b(new_n62_), .O(new_n111_));
  ...
  nand3  g77(.a(x19), .b(new_n45_), .c(new_n61_), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n60_), .c(new_n122_), .O(z15));
