// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:33 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n99_, new_n100_, new_n104_, new_n105_,
    ...
    new_n143_, new_n145_, new_n146_, new_n149_, new_n150_, new_n154_,
  ...
  nor2   g059(.a(x37), .b(new_n135_), .O(new_n149_));
  oai21  g060(.a(x36), .b(x09), .c(new_n86_), .O(new_n150_));
  ...
  oai21  g066(.a(x14), .b(new_n135_), .c(new_n157_), .O(new_n158_));
  nand3  g067(.a(new_n158_), .b(new_n156_), .c(new_n86_), .O(new_n159_));
  inv1   g068(.a(new_n159_), .O(z28));
  inv1   g069(.a(x41), .O(new_n161_));
  nand3  g070(.a(new_n161_), .b(new_n154_), .c(x09), .O(new_n162_));
  oai21  g071(.a(x14), .b(new_n135_), .c(new_n155_), .O(new_n163_));
  nand3  g072(.a(new_n163_), .b(new_n162_), .c(new_n86_), .O(new_n164_));
  inv1   g073(.a(new_n164_), .O(z29));
  inv1   g074(.a(x42), .O(new_n166_));
  nand3  g075(.a(new_n166_), .b(new_n154_), .c(x09), .O(new_n167_));
  oai21  g076(.a(x14), .b(new_n135_), .c(new_n161_), .O(new_n168_));
  nand3  g077(.a(new_n168_), .b(new_n167_), .c(new_n86_), .O(new_n169_));
  inv1   g078(.a(new_n169_), .O(z30));
  inv1   g079(.a(x43), .O(new_n171_));
  nand3  g080(.a(new_n171_), .b(new_n154_), .c(x09), .O(new_n172_));
  oai21  g081(.a(x14), .b(new_n135_), .c(new_n166_), .O(new_n173_));
  nand3  g082(.a(new_n173_), .b(new_n172_), .c(new_n86_), .O(new_n174_));
  inv1   g083(.a(new_n174_), .O(z31));
  inv1   g084(.a(x44), .O(new_n176_));
  nand3  g085(.a(new_n176_), .b(new_n154_), .c(x09), .O(new_n177_));
  oai21  g086(.a(x14), .b(new_n135_), .c(new_n171_), .O(new_n178_));
  nand3  g087(.a(new_n178_), .b(new_n177_), .c(new_n86_), .O(new_n179_));
  inv1   g088(.a(new_n179_), .O(z32));
  inv1   g089(.a(x45), .O(new_n181_));
  nand3  g090(.a(new_n181_), .b(new_n154_), .c(x09), .O(new_n182_));
  oai21  g091(.a(x14), .b(new_n135_), .c(new_n176_), .O(new_n183_));
  nand3  g092(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
  inv1   g093(.a(new_n184_), .O(z33));
  inv1   g094(.a(x46), .O(new_n186_));
  nand3  g095(.a(new_n186_), .b(new_n154_), .c(x09), .O(new_n187_));
  oai21  g096(.a(x14), .b(new_n135_), .c(new_n181_), .O(new_n188_));
  nand3  g097(.a(new_n188_), .b(new_n187_), .c(new_n86_), .O(new_n189_));
  inv1   g098(.a(new_n189_), .O(z34));
  nand3  g099(.a(new_n154_), .b(x09), .c(new_n132_), .O(new_n191_));
  oai21  g100(.a(x14), .b(new_n135_), .c(new_n186_), .O(new_n192_));
  nand3  g101(.a(new_n192_), .b(new_n191_), .c(new_n86_), .O(new_n193_));
