...
module FAU ( 
  ...
  inv1   g087(.a(x43), .O(new_n176_));
  nand3  g088(.a(new_n176_), .b(new_n160_), .c(x09), .O(new_n177_));
  inv1   g089(.a(x42), .O(new_n178_));
  oai21  g090(.a(x14), .b(new_n137_), .c(new_n178_), .O(new_n179_));
  nand3  g091(.a(new_n179_), .b(new_n177_), .c(new_n85_), .O(new_n180_));
  inv1   g092(.a(new_n180_), .O(z31));
  inv1   g093(.a(x44), .O(new_n182_));
  nand3  g094(.a(new_n182_), .b(new_n160_), .c(x09), .O(new_n183_));
  oai21  g095(.a(x14), .b(new_n137_), .c(new_n176_), .O(new_n184_));
  ...
  oai21  g100(.a(x14), .b(new_n137_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g105(.a(x14), .b(new_n137_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g109(.a(x14), .b(new_n137_), .c(new_n192_), .O(new_n198_));
