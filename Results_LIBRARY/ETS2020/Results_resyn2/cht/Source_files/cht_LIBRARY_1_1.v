...
module FAU ( 
  ...
  nor2   g062(.a(x37), .b(new_n140_), .O(new_n151_));
  ...
  oai21  g069(.a(x14), .b(new_n140_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g074(.a(x14), .b(new_n140_), .c(new_n157_), .O(new_n165_));
  ...
  oai21  g079(.a(x14), .b(new_n140_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g084(.a(x14), .b(new_n140_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g089(.a(x14), .b(new_n140_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g094(.a(x14), .b(new_n140_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g099(.a(x14), .b(new_n140_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g103(.a(x14), .b(new_n140_), .c(new_n188_), .O(new_n194_));
