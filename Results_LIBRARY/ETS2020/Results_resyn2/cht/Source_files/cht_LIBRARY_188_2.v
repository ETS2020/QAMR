...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n124_, new_n125_, new_n129_, new_n130_, new_n134_, new_n135_,
  ...
  aoi21  g61(.a(x39), .b(new_n152_), .c(new_n134_), .O(new_n153_));
