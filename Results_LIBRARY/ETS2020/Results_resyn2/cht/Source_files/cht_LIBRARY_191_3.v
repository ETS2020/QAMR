...
module FAU ( 
  ...
  aoi21  g079(.a(x39), .b(new_n164_), .c(new_n143_), .O(new_n165_));
  ...
  oai21  g085(.a(x14), .b(new_n143_), .c(new_n170_), .O(new_n171_));
  ...
  oai21  g090(.a(x14), .b(new_n143_), .c(new_n168_), .O(new_n176_));
  ...
  oai21  g095(.a(x14), .b(new_n143_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g100(.a(x14), .b(new_n143_), .c(new_n179_), .O(new_n186_));
  ...
  oai21  g105(.a(x14), .b(new_n143_), .c(new_n184_), .O(new_n191_));
  ...
  oai21  g110(.a(x14), .b(new_n143_), .c(new_n189_), .O(new_n196_));
  ...
  oai21  g115(.a(x14), .b(new_n143_), .c(new_n194_), .O(new_n201_));
  nand3  g116(.a(new_n201_), .b(new_n200_), .c(new_n85_), .O(new_n202_));
  inv1   g117(.a(new_n202_), .O(z34));
  nand3  g118(.a(new_n164_), .b(x09), .c(new_n140_), .O(new_n204_));
  oai21  g119(.a(x14), .b(new_n143_), .c(new_n199_), .O(new_n205_));
