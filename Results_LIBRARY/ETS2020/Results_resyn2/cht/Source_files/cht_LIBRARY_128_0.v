...
module FAU ( 
  ...
  inv1   g031(.a(x09), .O(new_n127_));
  nor2   g032(.a(x34), .b(new_n127_), .O(new_n128_));
  oai21  g033(.a(x33), .b(x09), .c(new_n88_), .O(new_n129_));
  nor2   g034(.a(new_n129_), .b(new_n128_), .O(z22));
  nor2   g035(.a(x35), .b(new_n127_), .O(new_n131_));
  oai21  g036(.a(x34), .b(x09), .c(new_n88_), .O(new_n132_));
  nor2   g037(.a(new_n132_), .b(new_n131_), .O(z23));
  nor2   g038(.a(x36), .b(new_n127_), .O(new_n134_));
  oai21  g039(.a(x35), .b(x09), .c(new_n88_), .O(new_n135_));
  nor2   g040(.a(new_n135_), .b(new_n134_), .O(z24));
  nor2   g041(.a(x38), .b(new_n127_), .O(new_n138_));
  ...
  aoi21  g046(.a(x39), .b(new_n142_), .c(new_n127_), .O(new_n143_));
  ...
  oai21  g052(.a(x14), .b(new_n127_), .c(new_n148_), .O(new_n149_));
  ...
  oai21  g057(.a(x14), .b(new_n127_), .c(new_n146_), .O(new_n154_));
  ...
  oai21  g062(.a(x14), .b(new_n127_), .c(new_n152_), .O(new_n159_));
  ...
  oai21  g067(.a(x14), .b(new_n127_), .c(new_n157_), .O(new_n164_));
  ...
  oai21  g072(.a(x14), .b(new_n127_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g077(.a(x14), .b(new_n127_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g082(.a(x14), .b(new_n127_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g086(.a(x14), .b(new_n127_), .c(new_n177_), .O(new_n183_));
