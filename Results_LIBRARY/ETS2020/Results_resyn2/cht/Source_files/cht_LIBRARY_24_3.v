...
module FAU ( 
  ...
  nor2   g065(.a(x38), .b(new_n135_), .O(new_n154_));
  oai21  g066(.a(x37), .b(x09), .c(new_n86_), .O(new_n155_));
  nor2   g067(.a(new_n155_), .b(new_n154_), .O(z26));
  nand2  g068(.a(x14), .b(x00), .O(new_n157_));
  inv1   g069(.a(x14), .O(new_n158_));
  aoi21  g070(.a(x39), .b(new_n158_), .c(new_n135_), .O(new_n159_));
  oai21  g071(.a(x38), .b(x09), .c(new_n86_), .O(new_n160_));
  ...
  oai21  g076(.a(x14), .b(new_n135_), .c(new_n164_), .O(new_n165_));
  nand3  g077(.a(new_n165_), .b(new_n163_), .c(new_n86_), .O(new_n166_));
  inv1   g078(.a(new_n166_), .O(z28));
  inv1   g079(.a(x41), .O(new_n168_));
  nand3  g080(.a(new_n168_), .b(new_n158_), .c(x09), .O(new_n169_));
  oai21  g081(.a(x14), .b(new_n135_), .c(new_n162_), .O(new_n170_));
  nand3  g082(.a(new_n170_), .b(new_n169_), .c(new_n86_), .O(new_n171_));
  inv1   g083(.a(new_n171_), .O(z29));
  inv1   g084(.a(x42), .O(new_n173_));
  nand3  g085(.a(new_n173_), .b(new_n158_), .c(x09), .O(new_n174_));
  oai21  g086(.a(x14), .b(new_n135_), .c(new_n168_), .O(new_n175_));
  nand3  g087(.a(new_n175_), .b(new_n174_), .c(new_n86_), .O(new_n176_));
  inv1   g088(.a(new_n176_), .O(z30));
  inv1   g089(.a(x43), .O(new_n178_));
  nand3  g090(.a(new_n178_), .b(new_n158_), .c(x09), .O(new_n179_));
  oai21  g091(.a(x14), .b(new_n135_), .c(new_n173_), .O(new_n180_));
  nand3  g092(.a(new_n180_), .b(new_n179_), .c(new_n86_), .O(new_n181_));
  inv1   g093(.a(new_n181_), .O(z31));
  inv1   g094(.a(x44), .O(new_n183_));
  nand3  g095(.a(new_n183_), .b(new_n158_), .c(x09), .O(new_n184_));
  oai21  g096(.a(x14), .b(new_n135_), .c(new_n178_), .O(new_n185_));
  nand3  g097(.a(new_n185_), .b(new_n184_), .c(new_n86_), .O(new_n186_));
  inv1   g098(.a(new_n186_), .O(z32));
  inv1   g099(.a(x45), .O(new_n188_));
  nand3  g100(.a(new_n188_), .b(new_n158_), .c(x09), .O(new_n189_));
  oai21  g101(.a(x14), .b(new_n135_), .c(new_n183_), .O(new_n190_));
  nand3  g102(.a(new_n190_), .b(new_n189_), .c(new_n86_), .O(new_n191_));
  inv1   g103(.a(new_n191_), .O(z33));
  inv1   g104(.a(x46), .O(new_n193_));
  nand3  g105(.a(new_n193_), .b(new_n158_), .c(x09), .O(new_n194_));
  oai21  g106(.a(x14), .b(new_n135_), .c(new_n188_), .O(new_n195_));
  nand3  g107(.a(new_n195_), .b(new_n194_), .c(new_n86_), .O(new_n196_));
  inv1   g108(.a(new_n196_), .O(z34));
  nand3  g109(.a(new_n158_), .b(x09), .c(new_n132_), .O(new_n198_));
  oai21  g110(.a(x14), .b(new_n135_), .c(new_n193_), .O(new_n199_));
  nand3  g111(.a(new_n199_), .b(new_n198_), .c(new_n86_), .O(new_n200_));
