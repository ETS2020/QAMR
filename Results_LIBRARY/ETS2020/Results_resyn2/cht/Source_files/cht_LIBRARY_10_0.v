...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n97_, new_n98_,
  ...
  inv1   g007(.a(x20), .O(new_n97_));
  oai21  g008(.a(x19), .b(x08), .c(new_n85_), .O(new_n98_));
  aoi21  g009(.a(new_n97_), .b(x08), .c(new_n98_), .O(z08));
  ...
  oai21  g039(.a(x31), .b(x09), .c(new_n85_), .O(new_n131_));
  ...
  aoi21  g058(.a(x39), .b(new_n150_), .c(new_n129_), .O(new_n151_));
  ...
  oai21  g064(.a(x14), .b(new_n129_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g069(.a(x14), .b(new_n129_), .c(new_n154_), .O(new_n162_));
  ...
  oai21  g074(.a(x14), .b(new_n129_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g079(.a(x14), .b(new_n129_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g084(.a(x14), .b(new_n129_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g089(.a(x14), .b(new_n129_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g094(.a(x14), .b(new_n129_), .c(new_n180_), .O(new_n187_));
  nand3  g095(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g096(.a(new_n188_), .O(z34));
  nand3  g097(.a(new_n150_), .b(x09), .c(new_n126_), .O(new_n190_));
  oai21  g098(.a(x14), .b(new_n129_), .c(new_n185_), .O(new_n191_));
