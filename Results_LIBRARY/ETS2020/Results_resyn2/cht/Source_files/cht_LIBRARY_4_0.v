...
module FAU ( 
  ...
  oai21  g008(.a(x16), .b(x07), .c(new_n85_), .O(new_n95_));
  ...
  nor2   g050(.a(x36), .b(new_n133_), .O(new_n142_));
  ...
  nor2   g056(.a(x38), .b(new_n133_), .O(new_n148_));
  ...
  aoi21  g061(.a(x39), .b(new_n152_), .c(new_n133_), .O(new_n153_));
  ...
  oai21  g067(.a(x14), .b(new_n133_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g072(.a(x14), .b(new_n133_), .c(new_n156_), .O(new_n164_));
  ...
  oai21  g077(.a(x14), .b(new_n133_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g082(.a(x14), .b(new_n133_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g087(.a(x14), .b(new_n133_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g092(.a(x14), .b(new_n133_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g097(.a(x14), .b(new_n133_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g101(.a(x14), .b(new_n133_), .c(new_n187_), .O(new_n193_));
