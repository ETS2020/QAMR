...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n127_, new_n128_, new_n130_, new_n131_, new_n137_, new_n138_,
  ...
  aoi21  g055(.a(x39), .b(new_n148_), .c(new_n137_), .O(new_n149_));
  ...
  oai21  g061(.a(x14), .b(new_n137_), .c(new_n154_), .O(new_n155_));
  ...
  oai21  g066(.a(x14), .b(new_n137_), .c(new_n152_), .O(new_n160_));
  ...
  oai21  g071(.a(x14), .b(new_n137_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g076(.a(x14), .b(new_n137_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g081(.a(x14), .b(new_n137_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g086(.a(x14), .b(new_n137_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g091(.a(x14), .b(new_n137_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g095(.a(x14), .b(new_n137_), .c(new_n183_), .O(new_n189_));
