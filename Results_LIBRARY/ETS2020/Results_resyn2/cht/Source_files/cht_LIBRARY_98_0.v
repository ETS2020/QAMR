...
module FAU ( 
  ...
  oai21  g057(.a(x35), .b(x09), .c(new_n86_), .O(new_n147_));
  ...
  oai21  g063(.a(x37), .b(x09), .c(new_n86_), .O(new_n153_));
  ...
  oai21  g068(.a(x38), .b(x09), .c(new_n86_), .O(new_n158_));
  ...
  nand3  g074(.a(new_n163_), .b(new_n161_), .c(new_n86_), .O(new_n164_));
  ...
  nand3  g079(.a(new_n168_), .b(new_n167_), .c(new_n86_), .O(new_n169_));
  ...
  nand3  g084(.a(new_n173_), .b(new_n172_), .c(new_n86_), .O(new_n174_));
  ...
  nand3  g089(.a(new_n178_), .b(new_n177_), .c(new_n86_), .O(new_n179_));
  ...
  nand3  g094(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
  ...
  nand3  g099(.a(new_n188_), .b(new_n187_), .c(new_n86_), .O(new_n189_));
  ...
  nand3  g104(.a(new_n193_), .b(new_n192_), .c(new_n86_), .O(new_n194_));
  ...
  nand3  g108(.a(new_n197_), .b(new_n196_), .c(new_n86_), .O(new_n198_));
