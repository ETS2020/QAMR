...
module FAU ( 
  ...
  nor2   g047(.a(x36), .b(new_n131_), .O(new_n140_));
  oai21  g048(.a(x35), .b(x09), .c(new_n87_), .O(new_n141_));
  nor2   g049(.a(new_n141_), .b(new_n140_), .O(z24));
  ...
  nor2   g053(.a(x38), .b(new_n131_), .O(new_n146_));
  oai21  g054(.a(x37), .b(x09), .c(new_n87_), .O(new_n147_));
  nor2   g055(.a(new_n147_), .b(new_n146_), .O(z26));
  nand2  g056(.a(x14), .b(x00), .O(new_n149_));
  inv1   g057(.a(x14), .O(new_n150_));
  aoi21  g058(.a(x39), .b(new_n150_), .c(new_n131_), .O(new_n151_));
  oai21  g059(.a(x38), .b(x09), .c(new_n87_), .O(new_n152_));
  ...
  oai21  g064(.a(x14), .b(new_n131_), .c(new_n156_), .O(new_n157_));
  nand3  g065(.a(new_n157_), .b(new_n155_), .c(new_n87_), .O(new_n158_));
  inv1   g066(.a(new_n158_), .O(z28));
  inv1   g067(.a(x41), .O(new_n160_));
  nand3  g068(.a(new_n160_), .b(new_n150_), .c(x09), .O(new_n161_));
  oai21  g069(.a(x14), .b(new_n131_), .c(new_n154_), .O(new_n162_));
  nand3  g070(.a(new_n162_), .b(new_n161_), .c(new_n87_), .O(new_n163_));
  inv1   g071(.a(new_n163_), .O(z29));
  inv1   g072(.a(x42), .O(new_n165_));
  nand3  g073(.a(new_n165_), .b(new_n150_), .c(x09), .O(new_n166_));
  oai21  g074(.a(x14), .b(new_n131_), .c(new_n160_), .O(new_n167_));
  nand3  g075(.a(new_n167_), .b(new_n166_), .c(new_n87_), .O(new_n168_));
  inv1   g076(.a(new_n168_), .O(z30));
  inv1   g077(.a(x43), .O(new_n170_));
  nand3  g078(.a(new_n170_), .b(new_n150_), .c(x09), .O(new_n171_));
  oai21  g079(.a(x14), .b(new_n131_), .c(new_n165_), .O(new_n172_));
  nand3  g080(.a(new_n172_), .b(new_n171_), .c(new_n87_), .O(new_n173_));
  inv1   g081(.a(new_n173_), .O(z31));
  inv1   g082(.a(x44), .O(new_n175_));
  nand3  g083(.a(new_n175_), .b(new_n150_), .c(x09), .O(new_n176_));
  oai21  g084(.a(x14), .b(new_n131_), .c(new_n170_), .O(new_n177_));
  nand3  g085(.a(new_n177_), .b(new_n176_), .c(new_n87_), .O(new_n178_));
  inv1   g086(.a(new_n178_), .O(z32));
  inv1   g087(.a(x45), .O(new_n180_));
  nand3  g088(.a(new_n180_), .b(new_n150_), .c(x09), .O(new_n181_));
  oai21  g089(.a(x14), .b(new_n131_), .c(new_n175_), .O(new_n182_));
  nand3  g090(.a(new_n182_), .b(new_n181_), .c(new_n87_), .O(new_n183_));
  inv1   g091(.a(new_n183_), .O(z33));
  inv1   g092(.a(x46), .O(new_n185_));
  nand3  g093(.a(new_n185_), .b(new_n150_), .c(x09), .O(new_n186_));
  oai21  g094(.a(x14), .b(new_n131_), .c(new_n180_), .O(new_n187_));
  nand3  g095(.a(new_n187_), .b(new_n186_), .c(new_n87_), .O(new_n188_));
  inv1   g096(.a(new_n188_), .O(z34));
  nand3  g097(.a(new_n150_), .b(x09), .c(new_n128_), .O(new_n190_));
  oai21  g098(.a(x14), .b(new_n131_), .c(new_n185_), .O(new_n191_));
  nand3  g099(.a(new_n191_), .b(new_n190_), .c(new_n87_), .O(new_n192_));
