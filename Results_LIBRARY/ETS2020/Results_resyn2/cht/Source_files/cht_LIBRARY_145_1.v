...
module FAU ( 
  ...
  inv1   g073(.a(x44), .O(new_n168_));
  nand3  g074(.a(new_n168_), .b(new_n150_), .c(x09), .O(new_n169_));
  inv1   g075(.a(x43), .O(new_n170_));
  oai21  g076(.a(x14), .b(new_n135_), .c(new_n170_), .O(new_n171_));
  nand3  g077(.a(new_n171_), .b(new_n169_), .c(new_n85_), .O(new_n172_));
  inv1   g078(.a(new_n172_), .O(z32));
  inv1   g079(.a(x45), .O(new_n174_));
  nand3  g080(.a(new_n174_), .b(new_n150_), .c(x09), .O(new_n175_));
  oai21  g081(.a(x14), .b(new_n135_), .c(new_n168_), .O(new_n176_));
  nand3  g082(.a(new_n176_), .b(new_n175_), .c(new_n85_), .O(new_n177_));
  ...
  nand3  g087(.a(new_n181_), .b(new_n180_), .c(new_n85_), .O(new_n182_));
  ...
  nand3  g091(.a(new_n185_), .b(new_n184_), .c(new_n85_), .O(new_n186_));
