...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n149_, new_n156_, new_n157_, new_n158_, new_n159_, new_n160_,
  ...
  oai21  g069(.a(x14), .b(new_n141_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g074(.a(x14), .b(new_n141_), .c(new_n157_), .O(new_n165_));
  ...
  oai21  g079(.a(x14), .b(new_n141_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g084(.a(x14), .b(new_n141_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g089(.a(x14), .b(new_n141_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g094(.a(x14), .b(new_n141_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g099(.a(x14), .b(new_n141_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g103(.a(x14), .b(new_n141_), .c(new_n188_), .O(new_n194_));
