...
module FAU ( 
  ...
  aoi21  g052(.a(x39), .b(new_n146_), .c(new_n125_), .O(new_n147_));
  ...
  oai21  g058(.a(x14), .b(new_n125_), .c(new_n152_), .O(new_n153_));
  ...
  oai21  g063(.a(x14), .b(new_n125_), .c(new_n150_), .O(new_n158_));
  ...
  oai21  g068(.a(x14), .b(new_n125_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g073(.a(x14), .b(new_n125_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g078(.a(x14), .b(new_n125_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g083(.a(x14), .b(new_n125_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g088(.a(x14), .b(new_n125_), .c(new_n176_), .O(new_n183_));
  nand3  g089(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
  inv1   g090(.a(new_n184_), .O(z34));
  nand3  g091(.a(new_n146_), .b(x09), .c(new_n122_), .O(new_n186_));
  oai21  g092(.a(x14), .b(new_n125_), .c(new_n181_), .O(new_n187_));
