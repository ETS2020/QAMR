...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n124_, new_n125_, new_n128_, new_n129_, new_n133_, new_n134_,
  ...
  oai21  g65(.a(x38), .b(x09), .c(new_n87_), .O(new_n156_));
