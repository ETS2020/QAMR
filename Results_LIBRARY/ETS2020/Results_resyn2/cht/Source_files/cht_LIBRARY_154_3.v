...
module FAU ( 
  ...
  nand3  g110(.a(new_n162_), .b(x09), .c(new_n138_), .O(new_n198_));
  inv1   g111(.a(x46), .O(new_n199_));
  oai21  g112(.a(x14), .b(new_n141_), .c(new_n199_), .O(new_n200_));
