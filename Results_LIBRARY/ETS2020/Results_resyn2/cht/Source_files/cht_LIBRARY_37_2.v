...
module FAU ( 
  ...
  oai21  g26(.a(x22), .b(x08), .c(new_n85_), .O(new_n113_));
  ...
  inv1   g31(.a(x25), .O(new_n118_));
  oai21  g32(.a(x24), .b(x08), .c(new_n85_), .O(new_n119_));
  aoi21  g33(.a(new_n118_), .b(x08), .c(new_n119_), .O(z13));
  ...
  aoi21  g67(.a(x39), .b(new_n156_), .c(new_n135_), .O(new_n157_));
