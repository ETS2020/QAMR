...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n97_, new_n98_, new_n100_, new_n101_, new_n107_, new_n108_,
    ...
    new_n139_, new_n141_, new_n142_, new_n146_, new_n147_, new_n148_,
  ...
  oai21  g017(.a(x23), .b(x08), .c(new_n85_), .O(new_n108_));
  ...
  nor2   g038(.a(x33), .b(new_n127_), .O(new_n131_));
  oai21  g039(.a(x32), .b(x09), .c(new_n85_), .O(new_n132_));
  nor2   g040(.a(new_n132_), .b(new_n131_), .O(z21));
  nor2   g041(.a(x34), .b(new_n127_), .O(new_n134_));
  ...
  oai21  g054(.a(x14), .b(new_n127_), .c(new_n149_), .O(new_n150_));
  ...
  oai21  g059(.a(x14), .b(new_n127_), .c(new_n147_), .O(new_n155_));
  ...
  oai21  g064(.a(x14), .b(new_n127_), .c(new_n153_), .O(new_n160_));
  ...
  oai21  g069(.a(x14), .b(new_n127_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g074(.a(x14), .b(new_n127_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g079(.a(x14), .b(new_n127_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g084(.a(x14), .b(new_n127_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g088(.a(x14), .b(new_n127_), .c(new_n178_), .O(new_n184_));
