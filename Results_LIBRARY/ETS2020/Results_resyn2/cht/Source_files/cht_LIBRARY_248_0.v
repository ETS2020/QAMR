...
module FAU ( 
  ...
  aoi21  g052(.a(x39), .b(new_n146_), .c(new_n132_), .O(new_n147_));
  ...
  oai21  g058(.a(x14), .b(new_n132_), .c(new_n152_), .O(new_n153_));
  ...
  oai21  g063(.a(x14), .b(new_n132_), .c(new_n150_), .O(new_n158_));
  ...
  oai21  g068(.a(x14), .b(new_n132_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g073(.a(x14), .b(new_n132_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g078(.a(x14), .b(new_n132_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g083(.a(x14), .b(new_n132_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g088(.a(x14), .b(new_n132_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g092(.a(x14), .b(new_n132_), .c(new_n181_), .O(new_n187_));
