...
module FAU ( 
  ...
  oai21  g084(.a(x14), .b(new_n138_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g089(.a(x14), .b(new_n138_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g094(.a(x14), .b(new_n138_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g099(.a(x14), .b(new_n138_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g103(.a(x14), .b(new_n138_), .c(new_n188_), .O(new_n194_));
