...
module FAU ( 
  ...
  oai21  g036(.a(x33), .b(x09), .c(new_n86_), .O(new_n131_));
  ...
  oai21  g042(.a(x37), .b(x09), .c(new_n86_), .O(new_n139_));
  ...
  oai21  g047(.a(x38), .b(x09), .c(new_n86_), .O(new_n144_));
  ...
  nand3  g053(.a(new_n149_), .b(new_n147_), .c(new_n86_), .O(new_n150_));
  ...
  nand3  g058(.a(new_n154_), .b(new_n153_), .c(new_n86_), .O(new_n155_));
  ...
  nand3  g063(.a(new_n159_), .b(new_n158_), .c(new_n86_), .O(new_n160_));
  ...
  nand3  g068(.a(new_n164_), .b(new_n163_), .c(new_n86_), .O(new_n165_));
  ...
  nand3  g073(.a(new_n169_), .b(new_n168_), .c(new_n86_), .O(new_n170_));
  ...
  nand3  g078(.a(new_n174_), .b(new_n173_), .c(new_n86_), .O(new_n175_));
  ...
  nand3  g083(.a(new_n179_), .b(new_n178_), .c(new_n86_), .O(new_n180_));
  ...
  nand3  g087(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
