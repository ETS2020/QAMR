...
module FAU ( 
  ...
  oai21  g083(.a(x38), .b(x09), .c(new_n86_), .O(new_n168_));
  ...
  nand3  g089(.a(new_n173_), .b(new_n171_), .c(new_n86_), .O(new_n174_));
  ...
  nand3  g094(.a(new_n178_), .b(new_n177_), .c(new_n86_), .O(new_n179_));
  ...
  nand3  g099(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
  ...
  nand3  g104(.a(new_n188_), .b(new_n187_), .c(new_n86_), .O(new_n189_));
  ...
  nand3  g109(.a(new_n193_), .b(new_n192_), .c(new_n86_), .O(new_n194_));
  ...
  nand3  g114(.a(new_n198_), .b(new_n197_), .c(new_n86_), .O(new_n199_));
  ...
  nand3  g119(.a(new_n203_), .b(new_n202_), .c(new_n86_), .O(new_n204_));
  ...
  nand3  g123(.a(new_n207_), .b(new_n206_), .c(new_n86_), .O(new_n208_));
