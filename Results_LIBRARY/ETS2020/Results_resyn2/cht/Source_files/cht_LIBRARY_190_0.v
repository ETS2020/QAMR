...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n98_, new_n99_, new_n104_, new_n105_,
  ...
  aoi21  g064(.a(x39), .b(new_n154_), .c(new_n135_), .O(new_n155_));
  ...
  oai21  g070(.a(x14), .b(new_n135_), .c(new_n160_), .O(new_n161_));
  ...
  oai21  g075(.a(x14), .b(new_n135_), .c(new_n158_), .O(new_n166_));
  ...
  oai21  g080(.a(x14), .b(new_n135_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g085(.a(x14), .b(new_n135_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g090(.a(x14), .b(new_n135_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g095(.a(x14), .b(new_n135_), .c(new_n179_), .O(new_n186_));
  ...
  oai21  g100(.a(x14), .b(new_n135_), .c(new_n184_), .O(new_n191_));
  ...
  oai21  g104(.a(x14), .b(new_n135_), .c(new_n189_), .O(new_n195_));
