...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n108_, new_n109_, new_n112_, new_n113_, new_n116_, new_n117_,
  ...
  oai21  g008(.a(x15), .b(x07), .c(new_n85_), .O(new_n94_));
  ...
  aoi21  g055(.a(x39), .b(new_n148_), .c(new_n131_), .O(new_n149_));
  ...
  oai21  g061(.a(x14), .b(new_n131_), .c(new_n154_), .O(new_n155_));
  ...
  oai21  g066(.a(x14), .b(new_n131_), .c(new_n152_), .O(new_n160_));
  ...
  oai21  g071(.a(x14), .b(new_n131_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g076(.a(x14), .b(new_n131_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g081(.a(x14), .b(new_n131_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g086(.a(x14), .b(new_n131_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g091(.a(x14), .b(new_n131_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g095(.a(x14), .b(new_n131_), .c(new_n183_), .O(new_n189_));
