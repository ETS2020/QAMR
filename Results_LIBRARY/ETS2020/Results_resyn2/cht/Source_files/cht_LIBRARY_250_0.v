...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n126_, new_n127_, new_n130_, new_n131_, new_n136_, new_n137_,
  ...
  nor2   g047(.a(x38), .b(new_n136_), .O(new_n142_));
  ...
  aoi21  g052(.a(x39), .b(new_n146_), .c(new_n136_), .O(new_n147_));
  ...
  oai21  g058(.a(x14), .b(new_n136_), .c(new_n152_), .O(new_n153_));
  ...
  oai21  g063(.a(x14), .b(new_n136_), .c(new_n150_), .O(new_n158_));
  ...
  oai21  g068(.a(x14), .b(new_n136_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g073(.a(x14), .b(new_n136_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g078(.a(x14), .b(new_n136_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g083(.a(x14), .b(new_n136_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g088(.a(x14), .b(new_n136_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g092(.a(x14), .b(new_n136_), .c(new_n181_), .O(new_n187_));
