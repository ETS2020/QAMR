// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:42 2020
...
module FAU ( 
  ...
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    ...
    new_n128_, new_n129_, new_n131_, new_n132_, new_n133_, new_n137_,
  ...
  oai21  g035(.a(x29), .b(x08), .c(new_n88_), .O(new_n126_));
  ...
  nor2   g044(.a(x35), .b(new_n131_), .O(new_n137_));
  oai21  g045(.a(x34), .b(x09), .c(new_n88_), .O(new_n138_));
  nor2   g046(.a(new_n138_), .b(new_n137_), .O(z23));
  nor2   g047(.a(x38), .b(new_n131_), .O(new_n142_));
  oai21  g048(.a(x37), .b(x09), .c(new_n88_), .O(new_n143_));
  ...
  oai21  g053(.a(x38), .b(x09), .c(new_n88_), .O(new_n148_));
  ...
  nand3  g059(.a(new_n153_), .b(new_n151_), .c(new_n88_), .O(new_n154_));
  ...
  nand3  g064(.a(new_n158_), .b(new_n157_), .c(new_n88_), .O(new_n159_));
  ...
  nand3  g069(.a(new_n163_), .b(new_n162_), .c(new_n88_), .O(new_n164_));
  ...
  nand3  g074(.a(new_n168_), .b(new_n167_), .c(new_n88_), .O(new_n169_));
  ...
  nand3  g079(.a(new_n173_), .b(new_n172_), .c(new_n88_), .O(new_n174_));
  ...
  nand3  g084(.a(new_n178_), .b(new_n177_), .c(new_n88_), .O(new_n179_));
  ...
  nand3  g089(.a(new_n183_), .b(new_n182_), .c(new_n88_), .O(new_n184_));
  ...
  nand3  g093(.a(new_n187_), .b(new_n186_), .c(new_n88_), .O(new_n188_));
