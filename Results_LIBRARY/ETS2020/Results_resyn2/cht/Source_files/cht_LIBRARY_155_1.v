...
module FAU ( 
  ...
  nand2  g056(.a(x38), .b(new_n131_), .O(new_n149_));
  nand2  g057(.a(x14), .b(new_n128_), .O(new_n150_));
  ...
  oai21  g065(.a(x14), .b(new_n131_), .c(new_n152_), .O(new_n158_));
  ...
  oai21  g070(.a(x14), .b(new_n131_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g075(.a(x14), .b(new_n131_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g080(.a(x14), .b(new_n131_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g085(.a(x14), .b(new_n131_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g090(.a(x14), .b(new_n131_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g095(.a(x14), .b(new_n131_), .c(new_n181_), .O(new_n188_));
  nand3  g096(.a(new_n188_), .b(new_n187_), .c(new_n85_), .O(new_n189_));
  inv1   g097(.a(new_n189_), .O(z34));
  nand3  g098(.a(new_n151_), .b(x09), .c(new_n128_), .O(new_n191_));
  oai21  g099(.a(x14), .b(new_n131_), .c(new_n186_), .O(new_n192_));
