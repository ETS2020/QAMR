...
module FAU ( 
  ...
  oai21  g38(.a(x27), .b(x08), .c(new_n86_), .O(new_n126_));
  aoi21  g39(.a(new_n125_), .b(x08), .c(new_n126_), .O(z16));
  inv1   g40(.a(x29), .O(new_n128_));
  oai21  g41(.a(x28), .b(x08), .c(new_n86_), .O(new_n129_));
  ...
  oai21  g51(.a(x33), .b(x09), .c(new_n86_), .O(new_n141_));
  nor2   g52(.a(new_n141_), .b(new_n140_), .O(z22));
  nor2   g53(.a(x35), .b(new_n133_), .O(new_n143_));
  oai21  g54(.a(x34), .b(x09), .c(new_n86_), .O(new_n144_));
