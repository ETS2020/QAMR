...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n104_, new_n105_, new_n107_, new_n108_, new_n111_, new_n112_,
    ...
    new_n144_, new_n147_, new_n148_, new_n150_, new_n151_, new_n153_,
  ...
  inv1   g34(.a(x27), .O(new_n122_));
  oai21  g35(.a(x26), .b(x08), .c(new_n85_), .O(new_n123_));
  aoi21  g36(.a(new_n122_), .b(x08), .c(new_n123_), .O(z15));
  ...
  inv1   g67(.a(x45), .O(new_n163_));
  nand3  g68(.a(new_n163_), .b(new_n154_), .c(x09), .O(new_n164_));
  inv1   g69(.a(x44), .O(new_n165_));
  oai21  g70(.a(x14), .b(new_n133_), .c(new_n165_), .O(new_n166_));
  nand3  g71(.a(new_n166_), .b(new_n164_), .c(new_n85_), .O(new_n167_));
  inv1   g72(.a(new_n167_), .O(z33));
  zero   g73(.O(z03));
  zero   g74(.O(z09));
  zero   g75(.O(z11));
  zero   g76(.O(z13));
