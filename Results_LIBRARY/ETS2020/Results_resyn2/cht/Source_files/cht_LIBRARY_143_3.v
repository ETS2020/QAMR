...
module FAU ( 
  ...
  inv1   g097(.a(x43), .O(new_n185_));
  oai21  g098(.a(x14), .b(new_n139_), .c(new_n185_), .O(new_n186_));
  nand3  g099(.a(new_n186_), .b(new_n184_), .c(new_n85_), .O(new_n187_));
  inv1   g100(.a(new_n187_), .O(z32));
  inv1   g101(.a(x45), .O(new_n189_));
  nand3  g102(.a(new_n189_), .b(new_n162_), .c(x09), .O(new_n190_));
  oai21  g103(.a(x14), .b(new_n139_), .c(new_n183_), .O(new_n191_));
  ...
  oai21  g108(.a(x14), .b(new_n139_), .c(new_n189_), .O(new_n196_));
  nand3  g109(.a(new_n196_), .b(new_n195_), .c(new_n85_), .O(new_n197_));
  inv1   g110(.a(new_n197_), .O(z34));
  nand3  g111(.a(new_n162_), .b(x09), .c(new_n136_), .O(new_n199_));
  oai21  g112(.a(x14), .b(new_n139_), .c(new_n194_), .O(new_n200_));
