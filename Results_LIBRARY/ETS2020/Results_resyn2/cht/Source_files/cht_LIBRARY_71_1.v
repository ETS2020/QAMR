...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n95_, new_n96_,
    ...
    new_n135_, new_n136_, new_n137_, new_n139_, new_n140_, new_n144_,
    new_n145_, new_n147_, new_n148_, new_n152_, new_n153_, new_n154_,
  ...
  oai21  g041(.a(x29), .b(x08), .c(new_n87_), .O(new_n130_));
  aoi21  g042(.a(new_n129_), .b(x08), .c(new_n130_), .O(z18));
  inv1   g043(.a(x00), .O(new_n132_));
  oai21  g044(.a(x30), .b(x08), .c(new_n87_), .O(new_n133_));
  aoi21  g045(.a(x08), .b(new_n132_), .c(new_n133_), .O(z19));
  inv1   g046(.a(x09), .O(new_n135_));
  nor2   g047(.a(x32), .b(new_n135_), .O(new_n136_));
  oai21  g048(.a(x31), .b(x09), .c(new_n87_), .O(new_n137_));
  nor2   g049(.a(new_n137_), .b(new_n136_), .O(z20));
  nor2   g050(.a(x33), .b(new_n135_), .O(new_n139_));
  oai21  g051(.a(x32), .b(x09), .c(new_n87_), .O(new_n140_));
  nor2   g052(.a(new_n140_), .b(new_n139_), .O(z21));
  nor2   g053(.a(x36), .b(new_n135_), .O(new_n144_));
  oai21  g054(.a(x35), .b(x09), .c(new_n87_), .O(new_n145_));
  nor2   g055(.a(new_n145_), .b(new_n144_), .O(z24));
  nor2   g056(.a(x37), .b(new_n135_), .O(new_n147_));
  oai21  g057(.a(x36), .b(x09), .c(new_n87_), .O(new_n148_));
  ...
  oai21  g063(.a(x14), .b(new_n135_), .c(new_n155_), .O(new_n156_));
  nand3  g064(.a(new_n156_), .b(new_n154_), .c(new_n87_), .O(new_n157_));
  inv1   g065(.a(new_n157_), .O(z28));
  inv1   g066(.a(x41), .O(new_n159_));
  nand3  g067(.a(new_n159_), .b(new_n152_), .c(x09), .O(new_n160_));
  oai21  g068(.a(x14), .b(new_n135_), .c(new_n153_), .O(new_n161_));
  nand3  g069(.a(new_n161_), .b(new_n160_), .c(new_n87_), .O(new_n162_));
  inv1   g070(.a(new_n162_), .O(z29));
  inv1   g071(.a(x42), .O(new_n164_));
  nand3  g072(.a(new_n164_), .b(new_n152_), .c(x09), .O(new_n165_));
  oai21  g073(.a(x14), .b(new_n135_), .c(new_n159_), .O(new_n166_));
  nand3  g074(.a(new_n166_), .b(new_n165_), .c(new_n87_), .O(new_n167_));
  inv1   g075(.a(new_n167_), .O(z30));
  inv1   g076(.a(x43), .O(new_n169_));
  nand3  g077(.a(new_n169_), .b(new_n152_), .c(x09), .O(new_n170_));
  oai21  g078(.a(x14), .b(new_n135_), .c(new_n164_), .O(new_n171_));
  nand3  g079(.a(new_n171_), .b(new_n170_), .c(new_n87_), .O(new_n172_));
  inv1   g080(.a(new_n172_), .O(z31));
  inv1   g081(.a(x44), .O(new_n174_));
  nand3  g082(.a(new_n174_), .b(new_n152_), .c(x09), .O(new_n175_));
  oai21  g083(.a(x14), .b(new_n135_), .c(new_n169_), .O(new_n176_));
  nand3  g084(.a(new_n176_), .b(new_n175_), .c(new_n87_), .O(new_n177_));
  inv1   g085(.a(new_n177_), .O(z32));
  inv1   g086(.a(x45), .O(new_n179_));
  nand3  g087(.a(new_n179_), .b(new_n152_), .c(x09), .O(new_n180_));
  oai21  g088(.a(x14), .b(new_n135_), .c(new_n174_), .O(new_n181_));
  nand3  g089(.a(new_n181_), .b(new_n180_), .c(new_n87_), .O(new_n182_));
  inv1   g090(.a(new_n182_), .O(z33));
  inv1   g091(.a(x46), .O(new_n184_));
  nand3  g092(.a(new_n184_), .b(new_n152_), .c(x09), .O(new_n185_));
  oai21  g093(.a(x14), .b(new_n135_), .c(new_n179_), .O(new_n186_));
  nand3  g094(.a(new_n186_), .b(new_n185_), .c(new_n87_), .O(new_n187_));
  inv1   g095(.a(new_n187_), .O(z34));
  nand3  g096(.a(new_n152_), .b(x09), .c(new_n132_), .O(new_n189_));
  oai21  g097(.a(x14), .b(new_n135_), .c(new_n184_), .O(new_n190_));
  nand3  g098(.a(new_n190_), .b(new_n189_), .c(new_n87_), .O(new_n191_));
