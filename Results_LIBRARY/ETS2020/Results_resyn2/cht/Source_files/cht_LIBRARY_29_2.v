...
module FAU ( 
  ...
  inv1   g76(.a(x42), .O(new_n166_));
  nand3  g77(.a(new_n166_), .b(new_n160_), .c(x09), .O(new_n167_));
  inv1   g78(.a(x41), .O(new_n168_));
  oai21  g79(.a(x14), .b(new_n137_), .c(new_n168_), .O(new_n169_));
  nand3  g80(.a(new_n169_), .b(new_n167_), .c(new_n85_), .O(new_n170_));
  inv1   g81(.a(new_n170_), .O(z30));
  zero   g82(.O(z10));
  zero   g83(.O(z11));
  zero   g84(.O(z16));
  zero   g85(.O(z19));
