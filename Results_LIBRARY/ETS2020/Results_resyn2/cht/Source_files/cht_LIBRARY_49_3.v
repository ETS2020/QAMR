...
module FAU ( 
  ...
  oai21  g080(.a(x38), .b(x09), .c(new_n86_), .O(new_n166_));
  ...
  nand3  g086(.a(new_n171_), .b(new_n169_), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g091(.a(new_n176_), .b(new_n175_), .c(new_n86_), .O(new_n177_));
  ...
  nand3  g096(.a(new_n181_), .b(new_n180_), .c(new_n86_), .O(new_n182_));
  ...
  nand3  g101(.a(new_n186_), .b(new_n185_), .c(new_n86_), .O(new_n187_));
  ...
  nand3  g106(.a(new_n191_), .b(new_n190_), .c(new_n86_), .O(new_n192_));
  ...
  nand3  g111(.a(new_n196_), .b(new_n195_), .c(new_n86_), .O(new_n197_));
  ...
  nand3  g116(.a(new_n201_), .b(new_n200_), .c(new_n86_), .O(new_n202_));
  ...
  nand3  g120(.a(new_n205_), .b(new_n204_), .c(new_n86_), .O(new_n206_));
