...
module FAU ( 
  ...
  oai21  g069(.a(x14), .b(new_n138_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g074(.a(x14), .b(new_n138_), .c(new_n157_), .O(new_n165_));
  ...
  oai21  g079(.a(x14), .b(new_n138_), .c(new_n163_), .O(new_n170_));
  nand3  g080(.a(new_n170_), .b(new_n169_), .c(new_n85_), .O(new_n171_));
  inv1   g081(.a(new_n171_), .O(z30));
  inv1   g082(.a(x44), .O(new_n174_));
  nand3  g083(.a(new_n174_), .b(new_n156_), .c(x09), .O(new_n175_));
  inv1   g084(.a(x43), .O(new_n176_));
  oai21  g085(.a(x14), .b(new_n138_), .c(new_n176_), .O(new_n177_));
  nand3  g086(.a(new_n177_), .b(new_n175_), .c(new_n85_), .O(new_n178_));
  inv1   g087(.a(new_n178_), .O(z32));
  inv1   g088(.a(x45), .O(new_n180_));
  nand3  g089(.a(new_n180_), .b(new_n156_), .c(x09), .O(new_n181_));
  oai21  g090(.a(x14), .b(new_n138_), .c(new_n174_), .O(new_n182_));
  nand3  g091(.a(new_n182_), .b(new_n181_), .c(new_n85_), .O(new_n183_));
  inv1   g092(.a(new_n183_), .O(z33));
  inv1   g093(.a(x46), .O(new_n185_));
  nand3  g094(.a(new_n185_), .b(new_n156_), .c(x09), .O(new_n186_));
  oai21  g095(.a(x14), .b(new_n138_), .c(new_n180_), .O(new_n187_));
  nand3  g096(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g097(.a(new_n188_), .O(z34));
  nand3  g098(.a(new_n156_), .b(x09), .c(new_n134_), .O(new_n190_));
  oai21  g099(.a(x14), .b(new_n138_), .c(new_n185_), .O(new_n191_));
  nand3  g100(.a(new_n191_), .b(new_n190_), .c(new_n85_), .O(new_n192_));
  inv1   g101(.a(new_n192_), .O(z35));
  zero   g102(.O(z04));
  zero   g103(.O(z10));
  zero   g104(.O(z11));
  zero   g105(.O(z15));
