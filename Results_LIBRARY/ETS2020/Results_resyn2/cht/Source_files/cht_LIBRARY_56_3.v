// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:00 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n112_, new_n113_, new_n117_, new_n118_, new_n120_, new_n121_,
    new_n123_, new_n124_, new_n126_, new_n127_, new_n129_, new_n130_,
    new_n132_, new_n133_, new_n135_, new_n136_, new_n138_, new_n139_,
    new_n141_, new_n142_, new_n143_, new_n145_, new_n146_, new_n150_,
  ...
  nor2   g062(.a(x36), .b(new_n141_), .O(new_n150_));
  oai21  g063(.a(x35), .b(x09), .c(new_n85_), .O(new_n151_));
  ...
  nor2   g068(.a(x38), .b(new_n141_), .O(new_n156_));
  oai21  g069(.a(x37), .b(x09), .c(new_n85_), .O(new_n157_));
  nor2   g070(.a(new_n157_), .b(new_n156_), .O(z26));
  nand2  g071(.a(x14), .b(x00), .O(new_n159_));
  inv1   g072(.a(x14), .O(new_n160_));
  aoi21  g073(.a(x39), .b(new_n160_), .c(new_n141_), .O(new_n161_));
  oai21  g074(.a(x38), .b(x09), .c(new_n85_), .O(new_n162_));
  ...
  oai21  g079(.a(x14), .b(new_n141_), .c(new_n166_), .O(new_n167_));
  nand3  g080(.a(new_n167_), .b(new_n165_), .c(new_n85_), .O(new_n168_));
  inv1   g081(.a(new_n168_), .O(z28));
  inv1   g082(.a(x41), .O(new_n170_));
  nand3  g083(.a(new_n170_), .b(new_n160_), .c(x09), .O(new_n171_));
  oai21  g084(.a(x14), .b(new_n141_), .c(new_n164_), .O(new_n172_));
  nand3  g085(.a(new_n172_), .b(new_n171_), .c(new_n85_), .O(new_n173_));
  inv1   g086(.a(new_n173_), .O(z29));
  inv1   g087(.a(x42), .O(new_n175_));
  nand3  g088(.a(new_n175_), .b(new_n160_), .c(x09), .O(new_n176_));
  oai21  g089(.a(x14), .b(new_n141_), .c(new_n170_), .O(new_n177_));
  nand3  g090(.a(new_n177_), .b(new_n176_), .c(new_n85_), .O(new_n178_));
  inv1   g091(.a(new_n178_), .O(z30));
  inv1   g092(.a(x43), .O(new_n180_));
  nand3  g093(.a(new_n180_), .b(new_n160_), .c(x09), .O(new_n181_));
  oai21  g094(.a(x14), .b(new_n141_), .c(new_n175_), .O(new_n182_));
  nand3  g095(.a(new_n182_), .b(new_n181_), .c(new_n85_), .O(new_n183_));
  inv1   g096(.a(new_n183_), .O(z31));
  inv1   g097(.a(x44), .O(new_n185_));
  nand3  g098(.a(new_n185_), .b(new_n160_), .c(x09), .O(new_n186_));
  oai21  g099(.a(x14), .b(new_n141_), .c(new_n180_), .O(new_n187_));
  nand3  g100(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g101(.a(new_n188_), .O(z32));
  inv1   g102(.a(x45), .O(new_n190_));
  nand3  g103(.a(new_n190_), .b(new_n160_), .c(x09), .O(new_n191_));
  oai21  g104(.a(x14), .b(new_n141_), .c(new_n185_), .O(new_n192_));
  nand3  g105(.a(new_n192_), .b(new_n191_), .c(new_n85_), .O(new_n193_));
  inv1   g106(.a(new_n193_), .O(z33));
  inv1   g107(.a(x46), .O(new_n195_));
  nand3  g108(.a(new_n195_), .b(new_n160_), .c(x09), .O(new_n196_));
  oai21  g109(.a(x14), .b(new_n141_), .c(new_n190_), .O(new_n197_));
  nand3  g110(.a(new_n197_), .b(new_n196_), .c(new_n85_), .O(new_n198_));
  inv1   g111(.a(new_n198_), .O(z34));
  nand3  g112(.a(new_n160_), .b(x09), .c(new_n138_), .O(new_n200_));
  oai21  g113(.a(x14), .b(new_n141_), .c(new_n195_), .O(new_n201_));
  nand3  g114(.a(new_n201_), .b(new_n200_), .c(new_n85_), .O(new_n202_));
