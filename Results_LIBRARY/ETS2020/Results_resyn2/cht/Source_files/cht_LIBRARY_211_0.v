...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n96_, new_n97_,
  ...
  inv1   g34(.a(x09), .O(new_n130_));
  nor2   g35(.a(x35), .b(new_n130_), .O(new_n131_));
  oai21  g36(.a(x34), .b(x09), .c(new_n85_), .O(new_n132_));
  nor2   g37(.a(new_n132_), .b(new_n131_), .O(z23));
  nor2   g38(.a(x38), .b(new_n130_), .O(new_n136_));
  oai21  g39(.a(x37), .b(x09), .c(new_n85_), .O(new_n137_));
  nor2   g40(.a(new_n137_), .b(new_n136_), .O(z26));
  nand2  g41(.a(x14), .b(x00), .O(new_n139_));
  inv1   g42(.a(x14), .O(new_n140_));
  aoi21  g43(.a(x39), .b(new_n140_), .c(new_n130_), .O(new_n141_));
  oai21  g44(.a(x38), .b(x09), .c(new_n85_), .O(new_n142_));
  ...
  oai21  g49(.a(x14), .b(new_n130_), .c(new_n146_), .O(new_n147_));
  nand3  g50(.a(new_n147_), .b(new_n145_), .c(new_n85_), .O(new_n148_));
  inv1   g51(.a(new_n148_), .O(z28));
  inv1   g52(.a(x41), .O(new_n150_));
  nand3  g53(.a(new_n150_), .b(new_n140_), .c(x09), .O(new_n151_));
  oai21  g54(.a(x14), .b(new_n130_), .c(new_n144_), .O(new_n152_));
  nand3  g55(.a(new_n152_), .b(new_n151_), .c(new_n85_), .O(new_n153_));
  inv1   g56(.a(new_n153_), .O(z29));
  inv1   g57(.a(x42), .O(new_n155_));
  nand3  g58(.a(new_n155_), .b(new_n140_), .c(x09), .O(new_n156_));
  oai21  g59(.a(x14), .b(new_n130_), .c(new_n150_), .O(new_n157_));
  nand3  g60(.a(new_n157_), .b(new_n156_), .c(new_n85_), .O(new_n158_));
  inv1   g61(.a(new_n158_), .O(z30));
  inv1   g62(.a(x43), .O(new_n160_));
  nand3  g63(.a(new_n160_), .b(new_n140_), .c(x09), .O(new_n161_));
  oai21  g64(.a(x14), .b(new_n130_), .c(new_n155_), .O(new_n162_));
  nand3  g65(.a(new_n162_), .b(new_n161_), .c(new_n85_), .O(new_n163_));
  inv1   g66(.a(new_n163_), .O(z31));
  inv1   g67(.a(x44), .O(new_n165_));
  nand3  g68(.a(new_n165_), .b(new_n140_), .c(x09), .O(new_n166_));
  oai21  g69(.a(x14), .b(new_n130_), .c(new_n160_), .O(new_n167_));
  nand3  g70(.a(new_n167_), .b(new_n166_), .c(new_n85_), .O(new_n168_));
  inv1   g71(.a(new_n168_), .O(z32));
  inv1   g72(.a(x45), .O(new_n170_));
  nand3  g73(.a(new_n170_), .b(new_n140_), .c(x09), .O(new_n171_));
  oai21  g74(.a(x14), .b(new_n130_), .c(new_n165_), .O(new_n172_));
  nand3  g75(.a(new_n172_), .b(new_n171_), .c(new_n85_), .O(new_n173_));
  inv1   g76(.a(new_n173_), .O(z33));
  inv1   g77(.a(x46), .O(new_n175_));
  nand3  g78(.a(new_n175_), .b(new_n140_), .c(x09), .O(new_n176_));
  oai21  g79(.a(x14), .b(new_n130_), .c(new_n170_), .O(new_n177_));
  nand3  g80(.a(new_n177_), .b(new_n176_), .c(new_n85_), .O(new_n178_));
  inv1   g81(.a(new_n178_), .O(z34));
  nand3  g82(.a(new_n140_), .b(x09), .c(new_n124_), .O(new_n180_));
  oai21  g83(.a(x14), .b(new_n130_), .c(new_n175_), .O(new_n181_));
  nand3  g84(.a(new_n181_), .b(new_n180_), .c(new_n85_), .O(new_n182_));
