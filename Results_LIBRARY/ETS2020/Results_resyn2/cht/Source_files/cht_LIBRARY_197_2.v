...
module FAU ( 
  ...
  oai21  g26(.a(x23), .b(x08), .c(new_n87_), .O(new_n114_));
  aoi21  g27(.a(new_n113_), .b(x08), .c(new_n114_), .O(z12));
  inv1   g28(.a(x25), .O(new_n116_));
  oai21  g29(.a(x24), .b(x08), .c(new_n87_), .O(new_n117_));
  ...
  oai21  g35(.a(x27), .b(x08), .c(new_n87_), .O(new_n124_));
  aoi21  g36(.a(new_n123_), .b(x08), .c(new_n124_), .O(z16));
  inv1   g37(.a(x29), .O(new_n126_));
  oai21  g38(.a(x28), .b(x08), .c(new_n87_), .O(new_n127_));
