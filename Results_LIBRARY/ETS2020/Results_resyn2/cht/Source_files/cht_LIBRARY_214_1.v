...
module FAU ( 
  ...
  nand2  g065(.a(x38), .b(new_n139_), .O(new_n155_));
  nand2  g066(.a(x14), .b(new_n136_), .O(new_n156_));
  inv1   g067(.a(x14), .O(new_n157_));
  inv1   g068(.a(x39), .O(new_n158_));
  nand2  g069(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g070(.a(new_n159_), .b(new_n156_), .c(x09), .O(new_n160_));
  aoi21  g071(.a(new_n160_), .b(new_n155_), .c(x10), .O(z27));
  inv1   g072(.a(x40), .O(new_n162_));
  nand3  g073(.a(new_n162_), .b(new_n157_), .c(x09), .O(new_n163_));
  oai21  g074(.a(x14), .b(new_n139_), .c(new_n158_), .O(new_n164_));
  nand3  g075(.a(new_n164_), .b(new_n163_), .c(new_n85_), .O(new_n165_));
  inv1   g076(.a(new_n165_), .O(z28));
  inv1   g077(.a(x41), .O(new_n167_));
  nand3  g078(.a(new_n167_), .b(new_n157_), .c(x09), .O(new_n168_));
  oai21  g079(.a(x14), .b(new_n139_), .c(new_n162_), .O(new_n169_));
  nand3  g080(.a(new_n169_), .b(new_n168_), .c(new_n85_), .O(new_n170_));
  inv1   g081(.a(new_n170_), .O(z29));
  inv1   g082(.a(x42), .O(new_n172_));
  nand3  g083(.a(new_n172_), .b(new_n157_), .c(x09), .O(new_n173_));
  oai21  g084(.a(x14), .b(new_n139_), .c(new_n167_), .O(new_n174_));
  nand3  g085(.a(new_n174_), .b(new_n173_), .c(new_n85_), .O(new_n175_));
  inv1   g086(.a(new_n175_), .O(z30));
  inv1   g087(.a(x43), .O(new_n177_));
  nand3  g088(.a(new_n177_), .b(new_n157_), .c(x09), .O(new_n178_));
  oai21  g089(.a(x14), .b(new_n139_), .c(new_n172_), .O(new_n179_));
  nand3  g090(.a(new_n179_), .b(new_n178_), .c(new_n85_), .O(new_n180_));
  inv1   g091(.a(new_n180_), .O(z31));
  inv1   g092(.a(x44), .O(new_n182_));
  nand3  g093(.a(new_n182_), .b(new_n157_), .c(x09), .O(new_n183_));
  oai21  g094(.a(x14), .b(new_n139_), .c(new_n177_), .O(new_n184_));
  nand3  g095(.a(new_n184_), .b(new_n183_), .c(new_n85_), .O(new_n185_));
  inv1   g096(.a(new_n185_), .O(z32));
  inv1   g097(.a(x45), .O(new_n187_));
  nand3  g098(.a(new_n187_), .b(new_n157_), .c(x09), .O(new_n188_));
  oai21  g099(.a(x14), .b(new_n139_), .c(new_n182_), .O(new_n189_));
  nand3  g100(.a(new_n189_), .b(new_n188_), .c(new_n85_), .O(new_n190_));
  inv1   g101(.a(new_n190_), .O(z33));
  inv1   g102(.a(x46), .O(new_n192_));
  nand3  g103(.a(new_n192_), .b(new_n157_), .c(x09), .O(new_n193_));
  oai21  g104(.a(x14), .b(new_n139_), .c(new_n187_), .O(new_n194_));
  nand3  g105(.a(new_n194_), .b(new_n193_), .c(new_n85_), .O(new_n195_));
  inv1   g106(.a(new_n195_), .O(z34));
  nand3  g107(.a(new_n157_), .b(x09), .c(new_n136_), .O(new_n197_));
  oai21  g108(.a(x14), .b(new_n139_), .c(new_n192_), .O(new_n198_));
  nand3  g109(.a(new_n198_), .b(new_n197_), .c(new_n85_), .O(new_n199_));
  inv1   g110(.a(new_n199_), .O(z35));
  zero   g111(.O(z03));
  zero   g112(.O(z14));
  zero   g113(.O(z18));
  zero   g114(.O(z21));
