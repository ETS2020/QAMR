...
module FAU ( 
  ...
  oai21  g060(.a(x14), .b(new_n138_), .c(new_n153_), .O(new_n154_));
  ...
  oai21  g065(.a(x14), .b(new_n138_), .c(new_n151_), .O(new_n159_));
  ...
  oai21  g070(.a(x14), .b(new_n138_), .c(new_n157_), .O(new_n164_));
  ...
  oai21  g075(.a(x14), .b(new_n138_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g080(.a(x14), .b(new_n138_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g085(.a(x14), .b(new_n138_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g090(.a(x14), .b(new_n138_), .c(new_n177_), .O(new_n184_));
  nand3  g091(.a(new_n184_), .b(new_n183_), .c(new_n85_), .O(new_n185_));
  inv1   g092(.a(new_n185_), .O(z34));
  nand3  g093(.a(new_n150_), .b(x09), .c(new_n134_), .O(new_n187_));
  oai21  g094(.a(x14), .b(new_n138_), .c(new_n182_), .O(new_n188_));
