...
module FAU ( 
  ...
  nand2  g59(.a(x38), .b(new_n133_), .O(new_n151_));
  inv1   g60(.a(x00), .O(new_n152_));
  nand2  g61(.a(x14), .b(new_n152_), .O(new_n153_));
  inv1   g62(.a(x14), .O(new_n154_));
  inv1   g63(.a(x39), .O(new_n155_));
  nand2  g64(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g65(.a(new_n156_), .b(new_n153_), .c(x09), .O(new_n157_));
  aoi21  g66(.a(new_n157_), .b(new_n151_), .c(x10), .O(z27));
  zero   g67(.O(z10));
  zero   g68(.O(z11));
  zero   g69(.O(z13));
  zero   g70(.O(z15));
