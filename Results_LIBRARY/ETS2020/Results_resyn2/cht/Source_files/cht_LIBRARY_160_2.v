...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n115_, new_n116_, new_n118_, new_n119_, new_n125_, new_n126_,
  ...
  oai21  g35(.a(x29), .b(x08), .c(new_n86_), .O(new_n126_));
  ...
  aoi21  g55(.a(x39), .b(new_n148_), .c(new_n130_), .O(new_n149_));
