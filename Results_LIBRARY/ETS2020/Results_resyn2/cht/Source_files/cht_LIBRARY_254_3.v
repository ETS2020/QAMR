...
module FAU ( 
  ...
  aoi21  g076(.a(x39), .b(new_n162_), .c(new_n143_), .O(new_n163_));
  ...
  oai21  g082(.a(x14), .b(new_n143_), .c(new_n168_), .O(new_n169_));
  ...
  oai21  g087(.a(x14), .b(new_n143_), .c(new_n166_), .O(new_n174_));
  ...
  oai21  g092(.a(x14), .b(new_n143_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g097(.a(x14), .b(new_n143_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g102(.a(x14), .b(new_n143_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g107(.a(x14), .b(new_n143_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g112(.a(x14), .b(new_n143_), .c(new_n192_), .O(new_n199_));
  nand3  g113(.a(new_n199_), .b(new_n198_), .c(new_n85_), .O(new_n200_));
  inv1   g114(.a(new_n200_), .O(z34));
  nand3  g115(.a(new_n162_), .b(x09), .c(new_n140_), .O(new_n202_));
  oai21  g116(.a(x14), .b(new_n143_), .c(new_n197_), .O(new_n203_));
