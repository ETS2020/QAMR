...
module FAU ( 
  ...
  aoi21  g067(.a(x39), .b(new_n156_), .c(new_n141_), .O(new_n157_));
  ...
  oai21  g073(.a(x14), .b(new_n141_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g078(.a(x14), .b(new_n141_), .c(new_n160_), .O(new_n168_));
  ...
  oai21  g083(.a(x14), .b(new_n141_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g088(.a(x14), .b(new_n141_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g093(.a(x14), .b(new_n141_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g098(.a(x14), .b(new_n141_), .c(new_n181_), .O(new_n188_));
  ...
  oai21  g103(.a(x14), .b(new_n141_), .c(new_n186_), .O(new_n193_));
  nand3  g104(.a(new_n193_), .b(new_n192_), .c(new_n85_), .O(new_n194_));
  inv1   g105(.a(new_n194_), .O(z34));
  nand3  g106(.a(new_n156_), .b(x09), .c(new_n136_), .O(new_n196_));
  oai21  g107(.a(x14), .b(new_n141_), .c(new_n191_), .O(new_n197_));
