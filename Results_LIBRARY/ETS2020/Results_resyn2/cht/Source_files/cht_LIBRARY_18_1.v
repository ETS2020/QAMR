...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n149_, new_n151_, new_n152_, new_n155_, new_n156_, new_n160_,
  ...
  oai21  g075(.a(x14), .b(new_n141_), .c(new_n163_), .O(new_n164_));
  ...
  oai21  g080(.a(x14), .b(new_n141_), .c(new_n161_), .O(new_n169_));
  ...
  oai21  g085(.a(x14), .b(new_n141_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g090(.a(x14), .b(new_n141_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g095(.a(x14), .b(new_n141_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g100(.a(x14), .b(new_n141_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g105(.a(x14), .b(new_n141_), .c(new_n187_), .O(new_n194_));
  ...
  oai21  g109(.a(x14), .b(new_n141_), .c(new_n192_), .O(new_n198_));
