...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n96_, new_n97_,
  ...
  oai21  g008(.a(x18), .b(x08), .c(new_n86_), .O(new_n97_));
  aoi21  g009(.a(new_n96_), .b(x08), .c(new_n97_), .O(z07));
  inv1   g010(.a(x21), .O(new_n100_));
  oai21  g011(.a(x20), .b(x08), .c(new_n86_), .O(new_n101_));
  ...
  aoi21  g052(.a(x39), .b(new_n146_), .c(new_n131_), .O(new_n147_));
  ...
  oai21  g058(.a(x14), .b(new_n131_), .c(new_n152_), .O(new_n153_));
  ...
  oai21  g063(.a(x14), .b(new_n131_), .c(new_n150_), .O(new_n158_));
  ...
  oai21  g068(.a(x14), .b(new_n131_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g073(.a(x14), .b(new_n131_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g078(.a(x14), .b(new_n131_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g083(.a(x14), .b(new_n131_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g088(.a(x14), .b(new_n131_), .c(new_n176_), .O(new_n183_));
  nand3  g089(.a(new_n183_), .b(new_n182_), .c(new_n86_), .O(new_n184_));
  inv1   g090(.a(new_n184_), .O(z34));
  nand3  g091(.a(new_n146_), .b(x09), .c(new_n126_), .O(new_n186_));
  oai21  g092(.a(x14), .b(new_n131_), .c(new_n181_), .O(new_n187_));
