...
module FAU ( 
  ...
  inv1   g73(.a(x46), .O(new_n168_));
  nand3  g74(.a(new_n168_), .b(new_n158_), .c(x09), .O(new_n169_));
  inv1   g75(.a(x45), .O(new_n170_));
  oai21  g76(.a(x14), .b(new_n137_), .c(new_n170_), .O(new_n171_));
  nand3  g77(.a(new_n171_), .b(new_n169_), .c(new_n85_), .O(new_n172_));
  inv1   g78(.a(new_n172_), .O(z34));
  zero   g79(.O(z11));
  zero   g80(.O(z13));
  zero   g81(.O(z18));
  zero   g82(.O(z19));
