...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n142_, new_n143_, new_n144_, new_n146_, new_n147_, new_n154_,
  ...
  oai21  g066(.a(x14), .b(new_n142_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g071(.a(x14), .b(new_n142_), .c(new_n155_), .O(new_n163_));
  ...
  oai21  g076(.a(x14), .b(new_n142_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g081(.a(x14), .b(new_n142_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g086(.a(x14), .b(new_n142_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g091(.a(x14), .b(new_n142_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g096(.a(x14), .b(new_n142_), .c(new_n181_), .O(new_n188_));
  nand3  g097(.a(new_n188_), .b(new_n187_), .c(new_n86_), .O(new_n189_));
  inv1   g098(.a(new_n189_), .O(z34));
  nand3  g099(.a(new_n154_), .b(x09), .c(new_n138_), .O(new_n191_));
  oai21  g100(.a(x14), .b(new_n142_), .c(new_n186_), .O(new_n192_));
