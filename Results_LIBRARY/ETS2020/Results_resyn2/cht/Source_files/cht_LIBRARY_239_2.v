...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n160_, new_n169_, new_n170_, new_n171_, new_n172_, new_n173_;
  ...
  inv1   g73(.a(x00), .O(new_n169_));
  nand3  g74(.a(new_n158_), .b(x09), .c(new_n169_), .O(new_n170_));
  inv1   g75(.a(x46), .O(new_n171_));
  oai21  g76(.a(x14), .b(new_n135_), .c(new_n171_), .O(new_n172_));
  nand3  g77(.a(new_n172_), .b(new_n170_), .c(new_n85_), .O(new_n173_));
  inv1   g78(.a(new_n173_), .O(z35));
  zero   g79(.O(z05));
  zero   g80(.O(z11));
  zero   g81(.O(z14));
  zero   g82(.O(z16));
