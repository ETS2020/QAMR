...
module FAU ( 
  ...
  oai21  g072(.a(x14), .b(new_n137_), .c(new_n161_), .O(new_n162_));
  ...
  oai21  g077(.a(x14), .b(new_n137_), .c(new_n159_), .O(new_n167_));
  ...
  oai21  g082(.a(x14), .b(new_n137_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g087(.a(x14), .b(new_n137_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g092(.a(x14), .b(new_n137_), .c(new_n175_), .O(new_n182_));
