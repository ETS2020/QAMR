...
module FAU ( 
  ...
  inv1   g76(.a(x43), .O(new_n167_));
  nand3  g77(.a(new_n167_), .b(new_n160_), .c(x09), .O(new_n168_));
  inv1   g78(.a(x42), .O(new_n169_));
  oai21  g79(.a(x14), .b(new_n137_), .c(new_n169_), .O(new_n170_));
  nand3  g80(.a(new_n170_), .b(new_n168_), .c(new_n85_), .O(new_n171_));
  inv1   g81(.a(new_n171_), .O(z31));
  zero   g82(.O(z03));
  zero   g83(.O(z09));
  zero   g84(.O(z11));
  zero   g85(.O(z19));
