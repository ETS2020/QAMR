...
module FAU ( 
  ...
  inv1   g67(.a(x43), .O(new_n161_));
  nand3  g68(.a(new_n161_), .b(new_n154_), .c(x09), .O(new_n162_));
  inv1   g69(.a(x42), .O(new_n163_));
  oai21  g70(.a(x14), .b(new_n133_), .c(new_n163_), .O(new_n164_));
  nand3  g71(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(new_n165_));
  inv1   g72(.a(new_n165_), .O(z31));
  zero   g73(.O(z01));
  zero   g74(.O(z03));
  zero   g75(.O(z09));
  zero   g76(.O(z13));
