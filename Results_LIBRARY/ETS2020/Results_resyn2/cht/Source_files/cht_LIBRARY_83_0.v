...
module FAU ( 
  ...
  oai21  g023(.a(x25), .b(x08), .c(new_n87_), .O(new_n114_));
  ...
  oai21  g048(.a(x36), .b(x09), .c(new_n87_), .O(new_n142_));
  nor2   g049(.a(new_n142_), .b(new_n141_), .O(z25));
  nor2   g050(.a(x38), .b(new_n131_), .O(new_n144_));
  oai21  g051(.a(x37), .b(x09), .c(new_n87_), .O(new_n145_));
  ...
  oai21  g056(.a(x38), .b(x09), .c(new_n87_), .O(new_n150_));
  ...
  nand3  g062(.a(new_n155_), .b(new_n153_), .c(new_n87_), .O(new_n156_));
  ...
  nand3  g067(.a(new_n160_), .b(new_n159_), .c(new_n87_), .O(new_n161_));
  ...
  nand3  g072(.a(new_n165_), .b(new_n164_), .c(new_n87_), .O(new_n166_));
  ...
  nand3  g077(.a(new_n170_), .b(new_n169_), .c(new_n87_), .O(new_n171_));
  ...
  nand3  g082(.a(new_n175_), .b(new_n174_), .c(new_n87_), .O(new_n176_));
  ...
  nand3  g087(.a(new_n180_), .b(new_n179_), .c(new_n87_), .O(new_n181_));
  ...
  nand3  g092(.a(new_n185_), .b(new_n184_), .c(new_n87_), .O(new_n186_));
  ...
  nand3  g096(.a(new_n189_), .b(new_n188_), .c(new_n87_), .O(new_n190_));
