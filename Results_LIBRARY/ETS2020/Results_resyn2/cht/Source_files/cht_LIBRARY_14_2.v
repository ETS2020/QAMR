...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n115_, new_n116_, new_n120_, new_n121_, new_n123_, new_n124_,
    new_n126_, new_n127_, new_n129_, new_n130_, new_n133_, new_n134_,
    new_n135_, new_n137_, new_n138_, new_n142_, new_n143_, new_n145_,
  ...
  inv1   g31(.a(x27), .O(new_n120_));
  oai21  g32(.a(x26), .b(x08), .c(new_n85_), .O(new_n121_));
  aoi21  g33(.a(new_n120_), .b(x08), .c(new_n121_), .O(z15));
  ...
  nor2   g50(.a(x36), .b(new_n133_), .O(new_n142_));
  oai21  g51(.a(x35), .b(x09), .c(new_n85_), .O(new_n143_));
  ...
  inv1   g64(.a(x40), .O(new_n156_));
  nand3  g65(.a(new_n156_), .b(new_n152_), .c(x09), .O(new_n157_));
  inv1   g66(.a(x39), .O(new_n158_));
  oai21  g67(.a(x14), .b(new_n133_), .c(new_n158_), .O(new_n159_));
  nand3  g68(.a(new_n159_), .b(new_n157_), .c(new_n85_), .O(new_n160_));
  inv1   g69(.a(new_n160_), .O(z28));
  zero   g70(.O(z03));
  zero   g71(.O(z05));
  zero   g72(.O(z11));
  zero   g73(.O(z13));
