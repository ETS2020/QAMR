...
module FAU ( 
  ...
  oai21  g026(.a(x23), .b(x08), .c(new_n88_), .O(new_n114_));
  aoi21  g027(.a(new_n113_), .b(x08), .c(new_n114_), .O(z12));
  inv1   g028(.a(x25), .O(new_n116_));
  oai21  g029(.a(x24), .b(x08), .c(new_n88_), .O(new_n117_));
  ...
  nand3  g082(.a(new_n173_), .b(new_n172_), .c(new_n88_), .O(new_n174_));
  ...
  nand3  g087(.a(new_n178_), .b(new_n177_), .c(new_n88_), .O(new_n179_));
  ...
  nand3  g092(.a(new_n183_), .b(new_n182_), .c(new_n88_), .O(new_n184_));
  ...
  nand3  g097(.a(new_n188_), .b(new_n187_), .c(new_n88_), .O(new_n189_));
  ...
  nand3  g101(.a(new_n192_), .b(new_n191_), .c(new_n88_), .O(new_n193_));
