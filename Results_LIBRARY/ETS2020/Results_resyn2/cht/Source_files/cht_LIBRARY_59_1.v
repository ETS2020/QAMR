...
module FAU ( 
  ...
  oai21  g060(.a(x14), .b(new_n134_), .c(new_n153_), .O(new_n154_));
  ...
  oai21  g065(.a(x14), .b(new_n134_), .c(new_n151_), .O(new_n159_));
  ...
  oai21  g070(.a(x14), .b(new_n134_), .c(new_n157_), .O(new_n164_));
  ...
  oai21  g075(.a(x14), .b(new_n134_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g080(.a(x14), .b(new_n134_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g085(.a(x14), .b(new_n134_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g090(.a(x14), .b(new_n134_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g094(.a(x14), .b(new_n134_), .c(new_n182_), .O(new_n188_));
