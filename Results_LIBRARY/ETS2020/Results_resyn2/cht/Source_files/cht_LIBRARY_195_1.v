...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n135_, new_n137_, new_n138_, new_n140_, new_n141_, new_n148_,
  ...
  oai21  g057(.a(x14), .b(new_n133_), .c(new_n151_), .O(new_n152_));
  ...
  oai21  g062(.a(x14), .b(new_n133_), .c(new_n149_), .O(new_n157_));
  ...
  oai21  g067(.a(x14), .b(new_n133_), .c(new_n155_), .O(new_n162_));
  ...
  oai21  g072(.a(x14), .b(new_n133_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g077(.a(x14), .b(new_n133_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g082(.a(x14), .b(new_n133_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g087(.a(x14), .b(new_n133_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g091(.a(x14), .b(new_n133_), .c(new_n180_), .O(new_n186_));
