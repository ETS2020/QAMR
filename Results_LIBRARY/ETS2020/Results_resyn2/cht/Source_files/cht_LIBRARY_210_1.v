...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n142_, new_n144_, new_n145_, new_n148_, new_n149_, new_n154_,
  ...
  oai21  g060(.a(x35), .b(x09), .c(new_n87_), .O(new_n149_));
  ...
  nand3  g067(.a(new_n158_), .b(new_n156_), .c(new_n87_), .O(new_n159_));
  ...
  nand3  g072(.a(new_n163_), .b(new_n162_), .c(new_n87_), .O(new_n164_));
  ...
  nand3  g077(.a(new_n168_), .b(new_n167_), .c(new_n87_), .O(new_n169_));
  ...
  nand3  g082(.a(new_n173_), .b(new_n172_), .c(new_n87_), .O(new_n174_));
  ...
  nand3  g087(.a(new_n178_), .b(new_n177_), .c(new_n87_), .O(new_n179_));
  ...
  nand3  g092(.a(new_n183_), .b(new_n182_), .c(new_n87_), .O(new_n184_));
  ...
  nand3  g097(.a(new_n188_), .b(new_n187_), .c(new_n87_), .O(new_n189_));
  ...
  nand3  g101(.a(new_n192_), .b(new_n191_), .c(new_n87_), .O(new_n193_));
