// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:55 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n106_, new_n107_, new_n111_, new_n112_, new_n118_, new_n119_,
  ...
  oai21  g26(.a(x28), .b(x08), .c(new_n85_), .O(new_n119_));
  aoi21  g27(.a(new_n118_), .b(x08), .c(new_n119_), .O(z17));
  inv1   g28(.a(x30), .O(new_n121_));
  oai21  g29(.a(x29), .b(x08), .c(new_n85_), .O(new_n122_));
  ...
  inv1   g55(.a(x42), .O(new_n152_));
  nand3  g56(.a(new_n152_), .b(new_n146_), .c(x09), .O(new_n153_));
  inv1   g57(.a(x41), .O(new_n154_));
  oai21  g58(.a(x14), .b(new_n125_), .c(new_n154_), .O(new_n155_));
  nand3  g59(.a(new_n155_), .b(new_n153_), .c(new_n85_), .O(new_n156_));
  inv1   g60(.a(new_n156_), .O(z30));
  zero   g61(.O(z01));
  zero   g62(.O(z03));
  zero   g63(.O(z05));
  zero   g64(.O(z10));
