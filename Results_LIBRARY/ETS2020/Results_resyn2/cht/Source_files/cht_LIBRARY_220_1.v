...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n116_, new_n117_, new_n121_, new_n122_, new_n126_, new_n127_,
  ...
  oai21  g051(.a(x14), .b(new_n130_), .c(new_n147_), .O(new_n148_));
  ...
  oai21  g056(.a(x14), .b(new_n130_), .c(new_n145_), .O(new_n153_));
  ...
  oai21  g061(.a(x14), .b(new_n130_), .c(new_n151_), .O(new_n158_));
  ...
  oai21  g066(.a(x14), .b(new_n130_), .c(new_n156_), .O(new_n163_));
  ...
  oai21  g071(.a(x14), .b(new_n130_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g076(.a(x14), .b(new_n130_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g081(.a(x14), .b(new_n130_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g085(.a(x14), .b(new_n130_), .c(new_n176_), .O(new_n182_));
