...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n128_, new_n129_, new_n135_, new_n136_, new_n137_, new_n140_,
  ...
  inv1   g040(.a(x09), .O(new_n135_));
  nor2   g041(.a(x36), .b(new_n135_), .O(new_n136_));
  oai21  g042(.a(x35), .b(x09), .c(new_n85_), .O(new_n137_));
  nor2   g043(.a(new_n137_), .b(new_n136_), .O(z24));
  nor2   g044(.a(x38), .b(new_n135_), .O(new_n140_));
  ...
  aoi21  g049(.a(x39), .b(new_n144_), .c(new_n135_), .O(new_n145_));
  ...
  oai21  g055(.a(x14), .b(new_n135_), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g060(.a(x14), .b(new_n135_), .c(new_n148_), .O(new_n156_));
  ...
  oai21  g065(.a(x14), .b(new_n135_), .c(new_n154_), .O(new_n161_));
  ...
  oai21  g070(.a(x14), .b(new_n135_), .c(new_n159_), .O(new_n166_));
  ...
  oai21  g075(.a(x14), .b(new_n135_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g080(.a(x14), .b(new_n135_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g085(.a(x14), .b(new_n135_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g089(.a(x14), .b(new_n135_), .c(new_n179_), .O(new_n185_));
