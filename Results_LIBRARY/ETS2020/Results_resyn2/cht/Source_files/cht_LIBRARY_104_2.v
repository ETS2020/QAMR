...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n106_, new_n107_, new_n111_, new_n112_, new_n115_, new_n116_,
    new_n118_, new_n119_, new_n123_, new_n124_, new_n127_, new_n128_,
  ...
  inv1   g28(.a(x27), .O(new_n118_));
  oai21  g29(.a(x26), .b(x08), .c(new_n85_), .O(new_n119_));
  aoi21  g30(.a(new_n118_), .b(x08), .c(new_n119_), .O(z15));
  inv1   g31(.a(x30), .O(new_n123_));
  oai21  g32(.a(x29), .b(x08), .c(new_n85_), .O(new_n124_));
  aoi21  g33(.a(new_n123_), .b(x08), .c(new_n124_), .O(z18));
  inv1   g34(.a(x09), .O(new_n127_));
  nor2   g35(.a(x32), .b(new_n127_), .O(new_n128_));
  oai21  g36(.a(x31), .b(x09), .c(new_n85_), .O(new_n129_));
  ...
  oai21  g56(.a(x38), .b(x09), .c(new_n85_), .O(new_n150_));
