...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n128_, new_n129_, new_n134_, new_n135_, new_n136_, new_n138_,
  ...
  oai21  g011(.a(x20), .b(x08), .c(new_n85_), .O(new_n101_));
  ...
  aoi21  g055(.a(x39), .b(new_n148_), .c(new_n134_), .O(new_n149_));
  ...
  oai21  g061(.a(x14), .b(new_n134_), .c(new_n154_), .O(new_n155_));
  ...
  oai21  g066(.a(x14), .b(new_n134_), .c(new_n152_), .O(new_n160_));
  ...
  oai21  g071(.a(x14), .b(new_n134_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g076(.a(x14), .b(new_n134_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g081(.a(x14), .b(new_n134_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g086(.a(x14), .b(new_n134_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g091(.a(x14), .b(new_n134_), .c(new_n178_), .O(new_n185_));
  nand3  g092(.a(new_n185_), .b(new_n184_), .c(new_n85_), .O(new_n186_));
  inv1   g093(.a(new_n186_), .O(z34));
  nand3  g094(.a(new_n148_), .b(x09), .c(new_n128_), .O(new_n188_));
  oai21  g095(.a(x14), .b(new_n134_), .c(new_n183_), .O(new_n189_));
