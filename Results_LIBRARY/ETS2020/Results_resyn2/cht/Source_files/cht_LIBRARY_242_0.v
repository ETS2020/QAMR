...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n120_, new_n121_, new_n124_, new_n125_, new_n129_, new_n130_,
  ...
  inv1   g034(.a(x09), .O(new_n129_));
  nor2   g035(.a(x34), .b(new_n129_), .O(new_n130_));
  oai21  g036(.a(x33), .b(x09), .c(new_n85_), .O(new_n131_));
  nor2   g037(.a(new_n131_), .b(new_n130_), .O(z22));
  nor2   g038(.a(x35), .b(new_n129_), .O(new_n133_));
  oai21  g039(.a(x34), .b(x09), .c(new_n85_), .O(new_n134_));
  nor2   g040(.a(new_n134_), .b(new_n133_), .O(z23));
  nor2   g041(.a(x38), .b(new_n129_), .O(new_n138_));
  oai21  g042(.a(x37), .b(x09), .c(new_n85_), .O(new_n139_));
  nor2   g043(.a(new_n139_), .b(new_n138_), .O(z26));
  nand2  g044(.a(x14), .b(x00), .O(new_n141_));
  inv1   g045(.a(x14), .O(new_n142_));
  aoi21  g046(.a(x39), .b(new_n142_), .c(new_n129_), .O(new_n143_));
  oai21  g047(.a(x38), .b(x09), .c(new_n85_), .O(new_n144_));
  ...
  oai21  g052(.a(x14), .b(new_n129_), .c(new_n148_), .O(new_n149_));
  nand3  g053(.a(new_n149_), .b(new_n147_), .c(new_n85_), .O(new_n150_));
  inv1   g054(.a(new_n150_), .O(z28));
  inv1   g055(.a(x41), .O(new_n152_));
  nand3  g056(.a(new_n152_), .b(new_n142_), .c(x09), .O(new_n153_));
  oai21  g057(.a(x14), .b(new_n129_), .c(new_n146_), .O(new_n154_));
  nand3  g058(.a(new_n154_), .b(new_n153_), .c(new_n85_), .O(new_n155_));
  inv1   g059(.a(new_n155_), .O(z29));
  inv1   g060(.a(x42), .O(new_n157_));
  nand3  g061(.a(new_n157_), .b(new_n142_), .c(x09), .O(new_n158_));
  oai21  g062(.a(x14), .b(new_n129_), .c(new_n152_), .O(new_n159_));
  nand3  g063(.a(new_n159_), .b(new_n158_), .c(new_n85_), .O(new_n160_));
  inv1   g064(.a(new_n160_), .O(z30));
  inv1   g065(.a(x43), .O(new_n162_));
  nand3  g066(.a(new_n162_), .b(new_n142_), .c(x09), .O(new_n163_));
  oai21  g067(.a(x14), .b(new_n129_), .c(new_n157_), .O(new_n164_));
  nand3  g068(.a(new_n164_), .b(new_n163_), .c(new_n85_), .O(new_n165_));
  inv1   g069(.a(new_n165_), .O(z31));
  inv1   g070(.a(x44), .O(new_n167_));
  nand3  g071(.a(new_n167_), .b(new_n142_), .c(x09), .O(new_n168_));
  oai21  g072(.a(x14), .b(new_n129_), .c(new_n162_), .O(new_n169_));
  nand3  g073(.a(new_n169_), .b(new_n168_), .c(new_n85_), .O(new_n170_));
  inv1   g074(.a(new_n170_), .O(z32));
  inv1   g075(.a(x45), .O(new_n172_));
  nand3  g076(.a(new_n172_), .b(new_n142_), .c(x09), .O(new_n173_));
  oai21  g077(.a(x14), .b(new_n129_), .c(new_n167_), .O(new_n174_));
  nand3  g078(.a(new_n174_), .b(new_n173_), .c(new_n85_), .O(new_n175_));
  inv1   g079(.a(new_n175_), .O(z33));
  inv1   g080(.a(x46), .O(new_n177_));
  nand3  g081(.a(new_n177_), .b(new_n142_), .c(x09), .O(new_n178_));
  oai21  g082(.a(x14), .b(new_n129_), .c(new_n172_), .O(new_n179_));
  nand3  g083(.a(new_n179_), .b(new_n178_), .c(new_n85_), .O(new_n180_));
  inv1   g084(.a(new_n180_), .O(z34));
  nand3  g085(.a(new_n142_), .b(x09), .c(new_n124_), .O(new_n182_));
  oai21  g086(.a(x14), .b(new_n129_), .c(new_n177_), .O(new_n183_));
  nand3  g087(.a(new_n183_), .b(new_n182_), .c(new_n85_), .O(new_n184_));
