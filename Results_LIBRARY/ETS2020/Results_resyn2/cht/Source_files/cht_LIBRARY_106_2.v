...
module FAU ( 
  ...
  inv1   g40(.a(x09), .O(new_n132_));
  nor2   g41(.a(x33), .b(new_n132_), .O(new_n133_));
  oai21  g42(.a(x32), .b(x09), .c(new_n85_), .O(new_n134_));
  nor2   g43(.a(new_n134_), .b(new_n133_), .O(z21));
  nor2   g44(.a(x34), .b(new_n132_), .O(new_n136_));
  oai21  g45(.a(x33), .b(x09), .c(new_n85_), .O(new_n137_));
  nor2   g46(.a(new_n137_), .b(new_n136_), .O(z22));
  nor2   g47(.a(x35), .b(new_n132_), .O(new_n139_));
  oai21  g48(.a(x34), .b(x09), .c(new_n85_), .O(new_n140_));
  nor2   g49(.a(new_n140_), .b(new_n139_), .O(z23));
  nor2   g50(.a(x36), .b(new_n132_), .O(new_n142_));
  oai21  g51(.a(x35), .b(x09), .c(new_n85_), .O(new_n143_));
  nor2   g52(.a(new_n143_), .b(new_n142_), .O(z24));
  nor2   g53(.a(x37), .b(new_n132_), .O(new_n145_));
  oai21  g54(.a(x36), .b(x09), .c(new_n85_), .O(new_n146_));
  nor2   g55(.a(new_n146_), .b(new_n145_), .O(z25));
  nor2   g56(.a(x38), .b(new_n132_), .O(new_n148_));
  ...
  aoi21  g61(.a(x39), .b(new_n152_), .c(new_n132_), .O(new_n153_));
