...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n136_, new_n138_, new_n139_, new_n142_, new_n143_, new_n146_,
  ...
  oai21  g048(.a(x33), .b(x09), .c(new_n86_), .O(new_n139_));
  nor2   g049(.a(new_n139_), .b(new_n138_), .O(z22));
  nor2   g050(.a(x36), .b(new_n134_), .O(new_n142_));
  oai21  g051(.a(x35), .b(x09), .c(new_n86_), .O(new_n143_));
  nor2   g052(.a(new_n143_), .b(new_n142_), .O(z24));
  nor2   g053(.a(x38), .b(new_n134_), .O(new_n146_));
  ...
  aoi21  g058(.a(x39), .b(new_n150_), .c(new_n134_), .O(new_n151_));
  ...
  oai21  g064(.a(x14), .b(new_n134_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g069(.a(x14), .b(new_n134_), .c(new_n154_), .O(new_n162_));
  ...
  oai21  g074(.a(x14), .b(new_n134_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g079(.a(x14), .b(new_n134_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g084(.a(x14), .b(new_n134_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g089(.a(x14), .b(new_n134_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g094(.a(x14), .b(new_n134_), .c(new_n180_), .O(new_n187_));
  ...
  oai21  g098(.a(x14), .b(new_n134_), .c(new_n185_), .O(new_n191_));
