...
module FAU ( 
  ...
  oai21  g35(.a(x26), .b(x08), .c(new_n86_), .O(new_n123_));
  aoi21  g36(.a(new_n122_), .b(x08), .c(new_n123_), .O(z15));
  inv1   g37(.a(x29), .O(new_n126_));
  oai21  g38(.a(x28), .b(x08), .c(new_n86_), .O(new_n127_));
  ...
  oai21  g62(.a(x38), .b(x09), .c(new_n86_), .O(new_n154_));
