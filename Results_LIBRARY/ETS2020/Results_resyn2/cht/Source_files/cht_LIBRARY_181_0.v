...
module FAU ( 
  ...
  oai21  g011(.a(x19), .b(x08), .c(new_n87_), .O(new_n100_));
  ...
  oai21  g038(.a(x29), .b(x08), .c(new_n87_), .O(new_n128_));
  ...
  oai21  g048(.a(x34), .b(x09), .c(new_n87_), .O(new_n140_));
  nor2   g049(.a(new_n140_), .b(new_n139_), .O(z23));
  nor2   g050(.a(x36), .b(new_n135_), .O(new_n142_));
  oai21  g051(.a(x35), .b(x09), .c(new_n87_), .O(new_n143_));
