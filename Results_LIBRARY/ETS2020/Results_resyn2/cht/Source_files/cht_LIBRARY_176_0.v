// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:32 2020
...
module FAU ( 
  ...
  aoi21  g058(.a(x39), .b(new_n150_), .c(new_n132_), .O(new_n151_));
  ...
  oai21  g064(.a(x14), .b(new_n132_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g069(.a(x14), .b(new_n132_), .c(new_n154_), .O(new_n162_));
  ...
  oai21  g074(.a(x14), .b(new_n132_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g079(.a(x14), .b(new_n132_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g084(.a(x14), .b(new_n132_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g089(.a(x14), .b(new_n132_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g094(.a(x14), .b(new_n132_), .c(new_n180_), .O(new_n187_));
  ...
  oai21  g098(.a(x14), .b(new_n132_), .c(new_n185_), .O(new_n191_));
