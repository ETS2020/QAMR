...
module FAU ( 
  ...
  nand3  g097(.a(new_n156_), .b(x09), .c(new_n138_), .O(new_n189_));
  inv1   g098(.a(x46), .O(new_n190_));
  oai21  g099(.a(x14), .b(new_n142_), .c(new_n190_), .O(new_n191_));
  nand3  g100(.a(new_n191_), .b(new_n189_), .c(new_n85_), .O(new_n192_));
