...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n144_, new_n149_, new_n150_, new_n151_, new_n152_, new_n153_,
  ...
  nand2  g056(.a(x38), .b(new_n136_), .O(new_n149_));
  nand2  g057(.a(x14), .b(new_n132_), .O(new_n150_));
  inv1   g058(.a(x14), .O(new_n151_));
  inv1   g059(.a(x39), .O(new_n152_));
  nand2  g060(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g061(.a(new_n153_), .b(new_n150_), .c(x09), .O(new_n154_));
  aoi21  g062(.a(new_n154_), .b(new_n149_), .c(x10), .O(z27));
  inv1   g063(.a(x40), .O(new_n156_));
  nand3  g064(.a(new_n156_), .b(new_n151_), .c(x09), .O(new_n157_));
  oai21  g065(.a(x14), .b(new_n136_), .c(new_n152_), .O(new_n158_));
  nand3  g066(.a(new_n158_), .b(new_n157_), .c(new_n85_), .O(new_n159_));
  inv1   g067(.a(new_n159_), .O(z28));
  inv1   g068(.a(x41), .O(new_n161_));
  nand3  g069(.a(new_n161_), .b(new_n151_), .c(x09), .O(new_n162_));
  oai21  g070(.a(x14), .b(new_n136_), .c(new_n156_), .O(new_n163_));
  nand3  g071(.a(new_n163_), .b(new_n162_), .c(new_n85_), .O(new_n164_));
  inv1   g072(.a(new_n164_), .O(z29));
  inv1   g073(.a(x42), .O(new_n166_));
  nand3  g074(.a(new_n166_), .b(new_n151_), .c(x09), .O(new_n167_));
  oai21  g075(.a(x14), .b(new_n136_), .c(new_n161_), .O(new_n168_));
  nand3  g076(.a(new_n168_), .b(new_n167_), .c(new_n85_), .O(new_n169_));
  inv1   g077(.a(new_n169_), .O(z30));
  inv1   g078(.a(x43), .O(new_n171_));
  nand3  g079(.a(new_n171_), .b(new_n151_), .c(x09), .O(new_n172_));
  oai21  g080(.a(x14), .b(new_n136_), .c(new_n166_), .O(new_n173_));
  nand3  g081(.a(new_n173_), .b(new_n172_), .c(new_n85_), .O(new_n174_));
  inv1   g082(.a(new_n174_), .O(z31));
  inv1   g083(.a(x44), .O(new_n176_));
  nand3  g084(.a(new_n176_), .b(new_n151_), .c(x09), .O(new_n177_));
  oai21  g085(.a(x14), .b(new_n136_), .c(new_n171_), .O(new_n178_));
  nand3  g086(.a(new_n178_), .b(new_n177_), .c(new_n85_), .O(new_n179_));
  inv1   g087(.a(new_n179_), .O(z32));
  inv1   g088(.a(x45), .O(new_n181_));
  nand3  g089(.a(new_n181_), .b(new_n151_), .c(x09), .O(new_n182_));
  oai21  g090(.a(x14), .b(new_n136_), .c(new_n176_), .O(new_n183_));
  nand3  g091(.a(new_n183_), .b(new_n182_), .c(new_n85_), .O(new_n184_));
  inv1   g092(.a(new_n184_), .O(z33));
  inv1   g093(.a(x46), .O(new_n186_));
  nand3  g094(.a(new_n186_), .b(new_n151_), .c(x09), .O(new_n187_));
  oai21  g095(.a(x14), .b(new_n136_), .c(new_n181_), .O(new_n188_));
  nand3  g096(.a(new_n188_), .b(new_n187_), .c(new_n85_), .O(new_n189_));
  inv1   g097(.a(new_n189_), .O(z34));
  nand3  g098(.a(new_n151_), .b(x09), .c(new_n132_), .O(new_n191_));
  oai21  g099(.a(x14), .b(new_n136_), .c(new_n186_), .O(new_n192_));
  nand3  g100(.a(new_n192_), .b(new_n191_), .c(new_n85_), .O(new_n193_));
  inv1   g101(.a(new_n193_), .O(z35));
  zero   g102(.O(z01));
  zero   g103(.O(z08));
  zero   g104(.O(z09));
  zero   g105(.O(z11));
