// Benchmark "FAU" written by ABC on Fri Jul 24 20:40:57 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n128_, new_n129_, new_n132_, new_n133_, new_n134_, new_n137_,
    new_n138_, new_n141_, new_n142_, new_n146_, new_n147_, new_n148_,
  ...
  oai21  g042(.a(x32), .b(x09), .c(new_n85_), .O(new_n134_));
  nor2   g043(.a(new_n134_), .b(new_n133_), .O(z21));
  nor2   g044(.a(x35), .b(new_n132_), .O(new_n137_));
  oai21  g045(.a(x34), .b(x09), .c(new_n85_), .O(new_n138_));
  nor2   g046(.a(new_n138_), .b(new_n137_), .O(z23));
  nor2   g047(.a(x37), .b(new_n132_), .O(new_n141_));
  ...
  oai21  g054(.a(x14), .b(new_n132_), .c(new_n149_), .O(new_n150_));
  ...
  oai21  g059(.a(x14), .b(new_n132_), .c(new_n147_), .O(new_n155_));
  ...
  oai21  g064(.a(x14), .b(new_n132_), .c(new_n153_), .O(new_n160_));
  ...
  oai21  g069(.a(x14), .b(new_n132_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g074(.a(x14), .b(new_n132_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g079(.a(x14), .b(new_n132_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g084(.a(x14), .b(new_n132_), .c(new_n173_), .O(new_n180_));
  nand3  g085(.a(new_n180_), .b(new_n179_), .c(new_n85_), .O(new_n181_));
  inv1   g086(.a(new_n181_), .O(z34));
  nand3  g087(.a(new_n146_), .b(x09), .c(new_n128_), .O(new_n183_));
  oai21  g088(.a(x14), .b(new_n132_), .c(new_n178_), .O(new_n184_));
