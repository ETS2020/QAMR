...
module FAU ( 
  ...
  oai21  g050(.a(x38), .b(x09), .c(new_n86_), .O(new_n146_));
  ...
  nand3  g056(.a(new_n151_), .b(new_n149_), .c(new_n86_), .O(new_n152_));
  ...
  nand3  g061(.a(new_n156_), .b(new_n155_), .c(new_n86_), .O(new_n157_));
  ...
  nand3  g066(.a(new_n161_), .b(new_n160_), .c(new_n86_), .O(new_n162_));
  ...
  nand3  g071(.a(new_n166_), .b(new_n165_), .c(new_n86_), .O(new_n167_));
  ...
  nand3  g076(.a(new_n171_), .b(new_n170_), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g081(.a(new_n176_), .b(new_n175_), .c(new_n86_), .O(new_n177_));
  ...
  nand3  g086(.a(new_n181_), .b(new_n180_), .c(new_n86_), .O(new_n182_));
  ...
  nand3  g090(.a(new_n185_), .b(new_n184_), .c(new_n86_), .O(new_n186_));
