...
module FAU ( 
  ...
  inv1   g102(.a(x46), .O(new_n191_));
  nand3  g103(.a(new_n191_), .b(new_n160_), .c(x09), .O(new_n192_));
  inv1   g104(.a(x45), .O(new_n193_));
  oai21  g105(.a(x14), .b(new_n137_), .c(new_n193_), .O(new_n194_));
  nand3  g106(.a(new_n194_), .b(new_n192_), .c(new_n85_), .O(new_n195_));
  inv1   g107(.a(new_n195_), .O(z34));
  nand3  g108(.a(new_n160_), .b(x09), .c(new_n134_), .O(new_n197_));
  oai21  g109(.a(x14), .b(new_n137_), .c(new_n191_), .O(new_n198_));
  nand3  g110(.a(new_n198_), .b(new_n197_), .c(new_n85_), .O(new_n199_));
  inv1   g111(.a(new_n199_), .O(z35));
  zero   g112(.O(z10));
  zero   g113(.O(z15));
  zero   g114(.O(z17));
  zero   g115(.O(z18));
