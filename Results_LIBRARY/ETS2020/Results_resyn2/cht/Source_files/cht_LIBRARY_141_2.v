...
module FAU ( 
  ...
  inv1   g64(.a(x45), .O(new_n161_));
  nand3  g65(.a(new_n161_), .b(new_n152_), .c(x09), .O(new_n162_));
  inv1   g66(.a(x44), .O(new_n163_));
  oai21  g67(.a(x14), .b(new_n131_), .c(new_n163_), .O(new_n164_));
  nand3  g68(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(new_n165_));
  inv1   g69(.a(new_n165_), .O(z33));
  zero   g70(.O(z01));
  zero   g71(.O(z03));
  zero   g72(.O(z05));
  zero   g73(.O(z11));
