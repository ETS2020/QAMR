...
module FAU ( 
  ...
  aoi21  g070(.a(x39), .b(new_n158_), .c(new_n139_), .O(new_n159_));
  ...
  oai21  g076(.a(x14), .b(new_n139_), .c(new_n164_), .O(new_n165_));
  ...
  oai21  g081(.a(x14), .b(new_n139_), .c(new_n162_), .O(new_n170_));
  ...
  oai21  g086(.a(x14), .b(new_n139_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g091(.a(x14), .b(new_n139_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g096(.a(x14), .b(new_n139_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g101(.a(x14), .b(new_n139_), .c(new_n183_), .O(new_n190_));
  ...
  oai21  g106(.a(x14), .b(new_n139_), .c(new_n188_), .O(new_n195_));
  nand3  g107(.a(new_n195_), .b(new_n194_), .c(new_n85_), .O(new_n196_));
  inv1   g108(.a(new_n196_), .O(z34));
  nand3  g109(.a(new_n158_), .b(x09), .c(new_n136_), .O(new_n198_));
  oai21  g110(.a(x14), .b(new_n139_), .c(new_n193_), .O(new_n199_));
