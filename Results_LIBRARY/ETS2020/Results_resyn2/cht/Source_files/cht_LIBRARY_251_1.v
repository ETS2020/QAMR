// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:59 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n122_, new_n123_, new_n127_, new_n128_, new_n130_, new_n131_,
  ...
  oai21  g038(.a(x24), .b(x08), .c(new_n86_), .O(new_n123_));
  ...
  nand3  g073(.a(new_n162_), .b(new_n160_), .c(new_n86_), .O(new_n163_));
  ...
  nand3  g078(.a(new_n167_), .b(new_n166_), .c(new_n86_), .O(new_n168_));
  ...
  nand3  g083(.a(new_n172_), .b(new_n171_), .c(new_n86_), .O(new_n173_));
  ...
  nand3  g088(.a(new_n177_), .b(new_n176_), .c(new_n86_), .O(new_n178_));
  ...
  nand3  g093(.a(new_n182_), .b(new_n181_), .c(new_n86_), .O(new_n183_));
  ...
  nand3  g098(.a(new_n187_), .b(new_n186_), .c(new_n86_), .O(new_n188_));
  ...
  nand3  g103(.a(new_n192_), .b(new_n191_), .c(new_n86_), .O(new_n193_));
  ...
  nand3  g107(.a(new_n196_), .b(new_n195_), .c(new_n86_), .O(new_n197_));
