...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n153_, new_n155_, new_n156_, new_n157_, new_n158_, new_n166_,
  ...
  inv1   g70(.a(x46), .O(new_n166_));
  nand3  g71(.a(new_n166_), .b(new_n156_), .c(x09), .O(new_n167_));
  inv1   g72(.a(x45), .O(new_n168_));
  oai21  g73(.a(x14), .b(new_n133_), .c(new_n168_), .O(new_n169_));
  nand3  g74(.a(new_n169_), .b(new_n167_), .c(new_n85_), .O(new_n170_));
  inv1   g75(.a(new_n170_), .O(z34));
  zero   g76(.O(z03));
  zero   g77(.O(z05));
  zero   g78(.O(z13));
  zero   g79(.O(z15));
