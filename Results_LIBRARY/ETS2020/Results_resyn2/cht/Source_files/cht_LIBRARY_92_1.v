...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n141_, new_n145_, new_n146_, new_n148_, new_n149_, new_n154_,
  ...
  oai21  g081(.a(x14), .b(new_n139_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g086(.a(x14), .b(new_n139_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g091(.a(x14), .b(new_n139_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g096(.a(x14), .b(new_n139_), .c(new_n181_), .O(new_n188_));
  ...
  oai21  g100(.a(x14), .b(new_n139_), .c(new_n186_), .O(new_n192_));
