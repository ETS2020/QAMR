...
module FAU ( 
  ...
  oai21  g063(.a(x14), .b(new_n133_), .c(new_n155_), .O(new_n156_));
  ...
  oai21  g068(.a(x14), .b(new_n133_), .c(new_n153_), .O(new_n161_));
  ...
  oai21  g073(.a(x14), .b(new_n133_), .c(new_n159_), .O(new_n166_));
  ...
  oai21  g078(.a(x14), .b(new_n133_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g083(.a(x14), .b(new_n133_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g088(.a(x14), .b(new_n133_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g093(.a(x14), .b(new_n133_), .c(new_n179_), .O(new_n186_));
  nand3  g094(.a(new_n186_), .b(new_n185_), .c(new_n85_), .O(new_n187_));
  inv1   g095(.a(new_n187_), .O(z34));
  nand3  g096(.a(new_n152_), .b(x09), .c(new_n130_), .O(new_n189_));
  oai21  g097(.a(x14), .b(new_n133_), .c(new_n184_), .O(new_n190_));
