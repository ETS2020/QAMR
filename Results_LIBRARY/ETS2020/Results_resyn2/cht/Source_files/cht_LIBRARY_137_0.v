...
module FAU ( 
  ...
  oai21  g057(.a(x37), .b(x09), .c(new_n87_), .O(new_n149_));
  ...
  oai21  g062(.a(x38), .b(x09), .c(new_n87_), .O(new_n154_));
  ...
  nand3  g068(.a(new_n159_), .b(new_n157_), .c(new_n87_), .O(new_n160_));
  ...
  nand3  g073(.a(new_n164_), .b(new_n163_), .c(new_n87_), .O(new_n165_));
  ...
  nand3  g078(.a(new_n169_), .b(new_n168_), .c(new_n87_), .O(new_n170_));
  ...
  nand3  g083(.a(new_n174_), .b(new_n173_), .c(new_n87_), .O(new_n175_));
  ...
  nand3  g088(.a(new_n179_), .b(new_n178_), .c(new_n87_), .O(new_n180_));
  ...
  nand3  g093(.a(new_n184_), .b(new_n183_), .c(new_n87_), .O(new_n185_));
  ...
  nand3  g098(.a(new_n189_), .b(new_n188_), .c(new_n87_), .O(new_n190_));
  ...
  nand3  g102(.a(new_n193_), .b(new_n192_), .c(new_n87_), .O(new_n194_));
