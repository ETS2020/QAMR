...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n98_, new_n99_, new_n105_, new_n106_,
  ...
  aoi21  g049(.a(x39), .b(new_n144_), .c(new_n132_), .O(new_n145_));
  ...
  oai21  g055(.a(x14), .b(new_n132_), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g060(.a(x14), .b(new_n132_), .c(new_n148_), .O(new_n156_));
  ...
  oai21  g065(.a(x14), .b(new_n132_), .c(new_n154_), .O(new_n161_));
  ...
  oai21  g070(.a(x14), .b(new_n132_), .c(new_n159_), .O(new_n166_));
  ...
  oai21  g075(.a(x14), .b(new_n132_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g080(.a(x14), .b(new_n132_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g085(.a(x14), .b(new_n132_), .c(new_n174_), .O(new_n181_));
  nand3  g086(.a(new_n181_), .b(new_n180_), .c(new_n85_), .O(new_n182_));
  inv1   g087(.a(new_n182_), .O(z34));
  nand3  g088(.a(new_n144_), .b(x09), .c(new_n126_), .O(new_n184_));
  oai21  g089(.a(x14), .b(new_n132_), .c(new_n179_), .O(new_n185_));
