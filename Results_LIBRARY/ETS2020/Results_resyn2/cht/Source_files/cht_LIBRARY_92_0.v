...
module FAU ( 
  ...
  aoi21  g061(.a(x39), .b(new_n152_), .c(new_n134_), .O(new_n153_));
  ...
  oai21  g067(.a(x14), .b(new_n134_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g072(.a(x14), .b(new_n134_), .c(new_n156_), .O(new_n164_));
  ...
  oai21  g077(.a(x14), .b(new_n134_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g082(.a(x14), .b(new_n134_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g087(.a(x14), .b(new_n134_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g092(.a(x14), .b(new_n134_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g097(.a(x14), .b(new_n134_), .c(new_n182_), .O(new_n189_));
  nand3  g098(.a(new_n189_), .b(new_n188_), .c(new_n85_), .O(new_n190_));
  inv1   g099(.a(new_n190_), .O(z34));
  nand3  g100(.a(new_n152_), .b(x09), .c(new_n130_), .O(new_n192_));
  oai21  g101(.a(x14), .b(new_n134_), .c(new_n187_), .O(new_n193_));
