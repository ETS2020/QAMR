// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:08 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n137_, new_n138_, new_n139_, new_n143_, new_n144_, new_n146_,
  ...
  nor2   g050(.a(x37), .b(new_n137_), .O(new_n143_));
  oai21  g051(.a(x36), .b(x09), .c(new_n85_), .O(new_n144_));
  nor2   g052(.a(new_n144_), .b(new_n143_), .O(z25));
  nor2   g053(.a(x38), .b(new_n137_), .O(new_n146_));
  ...
  aoi21  g058(.a(x39), .b(new_n150_), .c(new_n137_), .O(new_n151_));
  ...
  oai21  g064(.a(x14), .b(new_n137_), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g069(.a(x14), .b(new_n137_), .c(new_n154_), .O(new_n162_));
  ...
  oai21  g074(.a(x14), .b(new_n137_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g079(.a(x14), .b(new_n137_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g084(.a(x14), .b(new_n137_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g089(.a(x14), .b(new_n137_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g094(.a(x14), .b(new_n137_), .c(new_n180_), .O(new_n187_));
  nand3  g095(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g096(.a(new_n188_), .O(z34));
  nand3  g097(.a(new_n150_), .b(x09), .c(new_n132_), .O(new_n190_));
  oai21  g098(.a(x14), .b(new_n137_), .c(new_n185_), .O(new_n191_));
