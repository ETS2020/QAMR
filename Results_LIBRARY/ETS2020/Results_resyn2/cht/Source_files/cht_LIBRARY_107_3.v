// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:11 2020
...
module FAU ( 
  ...
  nand3  g110(.a(new_n162_), .b(x09), .c(new_n136_), .O(new_n198_));
  inv1   g111(.a(x46), .O(new_n199_));
  oai21  g112(.a(x14), .b(new_n139_), .c(new_n199_), .O(new_n200_));
  nand3  g113(.a(new_n200_), .b(new_n198_), .c(new_n86_), .O(new_n201_));
