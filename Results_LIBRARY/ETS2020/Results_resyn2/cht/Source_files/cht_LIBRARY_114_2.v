...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n116_, new_n117_, new_n121_, new_n122_, new_n125_, new_n126_,
  ...
  inv1   g31(.a(x28), .O(new_n121_));
  oai21  g32(.a(x27), .b(x08), .c(new_n85_), .O(new_n122_));
  aoi21  g33(.a(new_n121_), .b(x08), .c(new_n122_), .O(z16));
  ...
  aoi21  g61(.a(x39), .b(new_n152_), .c(new_n129_), .O(new_n153_));
