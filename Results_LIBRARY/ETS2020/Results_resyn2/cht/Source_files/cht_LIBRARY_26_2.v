...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n103_, new_n104_, new_n106_, new_n107_, new_n112_, new_n113_,
  ...
  inv1   g76(.a(x40), .O(new_n164_));
  nand3  g77(.a(new_n164_), .b(new_n160_), .c(x09), .O(new_n165_));
  inv1   g78(.a(x39), .O(new_n166_));
  oai21  g79(.a(x14), .b(new_n137_), .c(new_n166_), .O(new_n167_));
  nand3  g80(.a(new_n167_), .b(new_n165_), .c(new_n85_), .O(new_n168_));
  inv1   g81(.a(new_n168_), .O(z28));
  zero   g82(.O(z08));
  zero   g83(.O(z09));
  zero   g84(.O(z10));
  zero   g85(.O(z19));
