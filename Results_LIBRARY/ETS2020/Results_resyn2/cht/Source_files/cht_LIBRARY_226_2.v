...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n123_, new_n124_, new_n129_, new_n130_, new_n134_, new_n135_,
    new_n136_, new_n140_, new_n141_, new_n143_, new_n144_, new_n146_,
  ...
  oai21  g41(.a(x29), .b(x08), .c(new_n86_), .O(new_n130_));
  aoi21  g42(.a(new_n129_), .b(x08), .c(new_n130_), .O(z18));
  inv1   g43(.a(x09), .O(new_n134_));
  nor2   g44(.a(x33), .b(new_n134_), .O(new_n135_));
  oai21  g45(.a(x32), .b(x09), .c(new_n86_), .O(new_n136_));
  nor2   g46(.a(new_n136_), .b(new_n135_), .O(z21));
  nor2   g47(.a(x36), .b(new_n134_), .O(new_n140_));
  oai21  g48(.a(x35), .b(x09), .c(new_n86_), .O(new_n141_));
  nor2   g49(.a(new_n141_), .b(new_n140_), .O(z24));
  nor2   g50(.a(x37), .b(new_n134_), .O(new_n143_));
  oai21  g51(.a(x36), .b(x09), .c(new_n86_), .O(new_n144_));
  nor2   g52(.a(new_n144_), .b(new_n143_), .O(z25));
  nor2   g53(.a(x38), .b(new_n134_), .O(new_n146_));
  ...
  aoi21  g58(.a(x39), .b(new_n150_), .c(new_n134_), .O(new_n151_));
