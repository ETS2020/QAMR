...
module FAU ( 
  ...
  nand3  g085(.a(new_n174_), .b(new_n158_), .c(x09), .O(new_n175_));
  inv1   g086(.a(x42), .O(new_n176_));
  oai21  g087(.a(x14), .b(new_n137_), .c(new_n176_), .O(new_n177_));
  nand3  g088(.a(new_n177_), .b(new_n175_), .c(new_n85_), .O(new_n178_));
  inv1   g089(.a(new_n178_), .O(z31));
  inv1   g090(.a(x44), .O(new_n180_));
  nand3  g091(.a(new_n180_), .b(new_n158_), .c(x09), .O(new_n181_));
  oai21  g092(.a(x14), .b(new_n137_), .c(new_n174_), .O(new_n182_));
  ...
  oai21  g097(.a(x14), .b(new_n137_), .c(new_n180_), .O(new_n187_));
  ...
  oai21  g102(.a(x14), .b(new_n137_), .c(new_n185_), .O(new_n192_));
  nand3  g103(.a(new_n192_), .b(new_n191_), .c(new_n85_), .O(new_n193_));
  inv1   g104(.a(new_n193_), .O(z34));
  nand3  g105(.a(new_n158_), .b(x09), .c(new_n134_), .O(new_n195_));
  oai21  g106(.a(x14), .b(new_n137_), .c(new_n190_), .O(new_n196_));
