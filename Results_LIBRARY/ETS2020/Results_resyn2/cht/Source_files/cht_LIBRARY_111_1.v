// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:12 2020
...
module FAU ( 
  ...
  inv1   g078(.a(x42), .O(new_n168_));
  nand3  g079(.a(new_n168_), .b(new_n160_), .c(x09), .O(new_n169_));
  inv1   g080(.a(x41), .O(new_n170_));
  oai21  g081(.a(x14), .b(new_n141_), .c(new_n170_), .O(new_n171_));
  nand3  g082(.a(new_n171_), .b(new_n169_), .c(new_n85_), .O(new_n172_));
  inv1   g083(.a(new_n172_), .O(z30));
  inv1   g084(.a(x43), .O(new_n174_));
  nand3  g085(.a(new_n174_), .b(new_n160_), .c(x09), .O(new_n175_));
  oai21  g086(.a(x14), .b(new_n141_), .c(new_n168_), .O(new_n176_));
  nand3  g087(.a(new_n176_), .b(new_n175_), .c(new_n85_), .O(new_n177_));
  inv1   g088(.a(new_n177_), .O(z31));
  inv1   g089(.a(x44), .O(new_n179_));
  nand3  g090(.a(new_n179_), .b(new_n160_), .c(x09), .O(new_n180_));
  oai21  g091(.a(x14), .b(new_n141_), .c(new_n174_), .O(new_n181_));
  nand3  g092(.a(new_n181_), .b(new_n180_), .c(new_n85_), .O(new_n182_));
  inv1   g093(.a(new_n182_), .O(z32));
  inv1   g094(.a(x45), .O(new_n184_));
  nand3  g095(.a(new_n184_), .b(new_n160_), .c(x09), .O(new_n185_));
  oai21  g096(.a(x14), .b(new_n141_), .c(new_n179_), .O(new_n186_));
  nand3  g097(.a(new_n186_), .b(new_n185_), .c(new_n85_), .O(new_n187_));
  inv1   g098(.a(new_n187_), .O(z33));
  inv1   g099(.a(x46), .O(new_n189_));
  nand3  g100(.a(new_n189_), .b(new_n160_), .c(x09), .O(new_n190_));
  oai21  g101(.a(x14), .b(new_n141_), .c(new_n184_), .O(new_n191_));
  nand3  g102(.a(new_n191_), .b(new_n190_), .c(new_n85_), .O(new_n192_));
  inv1   g103(.a(new_n192_), .O(z34));
  nand3  g104(.a(new_n160_), .b(x09), .c(new_n138_), .O(new_n194_));
  oai21  g105(.a(x14), .b(new_n141_), .c(new_n189_), .O(new_n195_));
  nand3  g106(.a(new_n195_), .b(new_n194_), .c(new_n85_), .O(new_n196_));
  inv1   g107(.a(new_n196_), .O(z35));
  zero   g108(.O(z01));
  zero   g109(.O(z15));
  zero   g110(.O(z24));
  zero   g111(.O(z26));
