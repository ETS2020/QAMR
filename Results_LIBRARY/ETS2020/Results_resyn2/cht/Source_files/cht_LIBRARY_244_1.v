...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n137_, new_n139_, new_n140_, new_n146_, new_n147_, new_n148_,
  ...
  oai21  g054(.a(x14), .b(new_n131_), .c(new_n149_), .O(new_n150_));
  ...
  oai21  g059(.a(x14), .b(new_n131_), .c(new_n147_), .O(new_n155_));
  ...
  oai21  g064(.a(x14), .b(new_n131_), .c(new_n153_), .O(new_n160_));
  ...
  oai21  g069(.a(x14), .b(new_n131_), .c(new_n158_), .O(new_n165_));
  ...
  oai21  g074(.a(x14), .b(new_n131_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g079(.a(x14), .b(new_n131_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g084(.a(x14), .b(new_n131_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g088(.a(x14), .b(new_n131_), .c(new_n178_), .O(new_n184_));
