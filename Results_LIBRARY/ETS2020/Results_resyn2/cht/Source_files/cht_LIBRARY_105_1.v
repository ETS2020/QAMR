...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    new_n94_, new_n95_, new_n99_, new_n100_, new_n104_, new_n105_,
    ...
    new_n143_, new_n146_, new_n147_, new_n149_, new_n150_, new_n154_,
  ...
  nor2   g059(.a(x37), .b(new_n138_), .O(new_n149_));
  ...
  oai21  g066(.a(x14), .b(new_n138_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g071(.a(x14), .b(new_n138_), .c(new_n155_), .O(new_n163_));
  ...
  oai21  g076(.a(x14), .b(new_n138_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g081(.a(x14), .b(new_n138_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g086(.a(x14), .b(new_n138_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g091(.a(x14), .b(new_n138_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g096(.a(x14), .b(new_n138_), .c(new_n181_), .O(new_n188_));
  nand3  g097(.a(new_n188_), .b(new_n187_), .c(new_n85_), .O(new_n189_));
  inv1   g098(.a(new_n189_), .O(z34));
  nand3  g099(.a(new_n154_), .b(x09), .c(new_n134_), .O(new_n191_));
  oai21  g100(.a(x14), .b(new_n138_), .c(new_n186_), .O(new_n192_));
