...
module FAU ( 
  ...
  inv1   g43(.a(x26), .O(new_n127_));
  oai21  g44(.a(x25), .b(x08), .c(new_n85_), .O(new_n128_));
  aoi21  g45(.a(new_n127_), .b(x08), .c(new_n128_), .O(z14));
  inv1   g46(.a(x27), .O(new_n130_));
  oai21  g47(.a(x26), .b(x08), .c(new_n85_), .O(new_n131_));
  aoi21  g48(.a(new_n130_), .b(x08), .c(new_n131_), .O(z15));
  inv1   g49(.a(x28), .O(new_n133_));
  oai21  g50(.a(x27), .b(x08), .c(new_n85_), .O(new_n134_));
  aoi21  g51(.a(new_n133_), .b(x08), .c(new_n134_), .O(z16));
  inv1   g52(.a(x29), .O(new_n136_));
  oai21  g53(.a(x28), .b(x08), .c(new_n85_), .O(new_n137_));
  aoi21  g54(.a(new_n136_), .b(x08), .c(new_n137_), .O(z17));
  ...
  inv1   g82(.a(x40), .O(new_n168_));
  nand3  g83(.a(new_n168_), .b(new_n164_), .c(x09), .O(new_n169_));
  inv1   g84(.a(x39), .O(new_n170_));
  oai21  g85(.a(x14), .b(new_n141_), .c(new_n170_), .O(new_n171_));
  nand3  g86(.a(new_n171_), .b(new_n169_), .c(new_n85_), .O(new_n172_));
  inv1   g87(.a(new_n172_), .O(z28));
  zero   g88(.O(z18));
  zero   g89(.O(z19));
  zero   g90(.O(z29));
  zero   g91(.O(z30));
