...
module FAU ( 
  ...
  oai21  g072(.a(x14), .b(new_n140_), .c(new_n161_), .O(new_n162_));
  ...
  oai21  g077(.a(x14), .b(new_n140_), .c(new_n159_), .O(new_n167_));
  ...
  oai21  g082(.a(x14), .b(new_n140_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g087(.a(x14), .b(new_n140_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g092(.a(x14), .b(new_n140_), .c(new_n175_), .O(new_n182_));
  ...
  oai21  g097(.a(x14), .b(new_n140_), .c(new_n180_), .O(new_n187_));
  ...
  oai21  g102(.a(x14), .b(new_n140_), .c(new_n185_), .O(new_n192_));
  ...
  oai21  g106(.a(x14), .b(new_n140_), .c(new_n190_), .O(new_n196_));
