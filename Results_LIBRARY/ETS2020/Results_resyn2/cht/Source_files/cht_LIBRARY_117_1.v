...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n150_, new_n152_, new_n153_, new_n155_, new_n156_, new_n160_,
  ...
  nor2   g065(.a(x36), .b(new_n142_), .O(new_n152_));
  oai21  g066(.a(x35), .b(x09), .c(new_n85_), .O(new_n153_));
  nor2   g067(.a(new_n153_), .b(new_n152_), .O(z24));
  nor2   g068(.a(x37), .b(new_n142_), .O(new_n155_));
  oai21  g069(.a(x36), .b(x09), .c(new_n85_), .O(new_n156_));
  nor2   g070(.a(new_n156_), .b(new_n155_), .O(z25));
  inv1   g071(.a(x14), .O(new_n160_));
  inv1   g072(.a(x40), .O(new_n161_));
  nand3  g073(.a(new_n161_), .b(new_n160_), .c(x09), .O(new_n162_));
  inv1   g074(.a(x39), .O(new_n163_));
  oai21  g075(.a(x14), .b(new_n142_), .c(new_n163_), .O(new_n164_));
  nand3  g076(.a(new_n164_), .b(new_n162_), .c(new_n85_), .O(new_n165_));
  inv1   g077(.a(new_n165_), .O(z28));
  inv1   g078(.a(x41), .O(new_n167_));
  nand3  g079(.a(new_n167_), .b(new_n160_), .c(x09), .O(new_n168_));
  oai21  g080(.a(x14), .b(new_n142_), .c(new_n161_), .O(new_n169_));
  nand3  g081(.a(new_n169_), .b(new_n168_), .c(new_n85_), .O(new_n170_));
  inv1   g082(.a(new_n170_), .O(z29));
  inv1   g083(.a(x42), .O(new_n172_));
  nand3  g084(.a(new_n172_), .b(new_n160_), .c(x09), .O(new_n173_));
  oai21  g085(.a(x14), .b(new_n142_), .c(new_n167_), .O(new_n174_));
  nand3  g086(.a(new_n174_), .b(new_n173_), .c(new_n85_), .O(new_n175_));
  inv1   g087(.a(new_n175_), .O(z30));
  inv1   g088(.a(x43), .O(new_n177_));
  nand3  g089(.a(new_n177_), .b(new_n160_), .c(x09), .O(new_n178_));
  oai21  g090(.a(x14), .b(new_n142_), .c(new_n172_), .O(new_n179_));
  nand3  g091(.a(new_n179_), .b(new_n178_), .c(new_n85_), .O(new_n180_));
  inv1   g092(.a(new_n180_), .O(z31));
  inv1   g093(.a(x44), .O(new_n182_));
  nand3  g094(.a(new_n182_), .b(new_n160_), .c(x09), .O(new_n183_));
  oai21  g095(.a(x14), .b(new_n142_), .c(new_n177_), .O(new_n184_));
  nand3  g096(.a(new_n184_), .b(new_n183_), .c(new_n85_), .O(new_n185_));
  inv1   g097(.a(new_n185_), .O(z32));
  inv1   g098(.a(x45), .O(new_n187_));
  nand3  g099(.a(new_n187_), .b(new_n160_), .c(x09), .O(new_n188_));
  oai21  g100(.a(x14), .b(new_n142_), .c(new_n182_), .O(new_n189_));
  nand3  g101(.a(new_n189_), .b(new_n188_), .c(new_n85_), .O(new_n190_));
  inv1   g102(.a(new_n190_), .O(z33));
  inv1   g103(.a(x46), .O(new_n192_));
  nand3  g104(.a(new_n192_), .b(new_n160_), .c(x09), .O(new_n193_));
  oai21  g105(.a(x14), .b(new_n142_), .c(new_n187_), .O(new_n194_));
  nand3  g106(.a(new_n194_), .b(new_n193_), .c(new_n85_), .O(new_n195_));
  inv1   g107(.a(new_n195_), .O(z34));
  nand3  g108(.a(new_n160_), .b(x09), .c(new_n138_), .O(new_n197_));
  oai21  g109(.a(x14), .b(new_n142_), .c(new_n192_), .O(new_n198_));
