...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n107_, new_n108_, new_n112_, new_n113_, new_n115_, new_n116_,
  ...
  oai21  g054(.a(x34), .b(x09), .c(new_n86_), .O(new_n144_));
  ...
  nor2   g062(.a(x38), .b(new_n133_), .O(new_n152_));
  ...
  oai21  g069(.a(x14), .b(new_n133_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g074(.a(x14), .b(new_n133_), .c(new_n157_), .O(new_n165_));
  ...
  oai21  g079(.a(x14), .b(new_n133_), .c(new_n163_), .O(new_n170_));
  ...
  oai21  g084(.a(x14), .b(new_n133_), .c(new_n168_), .O(new_n175_));
  ...
  oai21  g089(.a(x14), .b(new_n133_), .c(new_n173_), .O(new_n180_));
  ...
  oai21  g094(.a(x14), .b(new_n133_), .c(new_n178_), .O(new_n185_));
  ...
  oai21  g099(.a(x14), .b(new_n133_), .c(new_n183_), .O(new_n190_));
  nand3  g100(.a(new_n190_), .b(new_n189_), .c(new_n86_), .O(new_n191_));
  inv1   g101(.a(new_n191_), .O(z34));
  nand3  g102(.a(new_n156_), .b(x09), .c(new_n130_), .O(new_n193_));
  oai21  g103(.a(x14), .b(new_n133_), .c(new_n188_), .O(new_n194_));
