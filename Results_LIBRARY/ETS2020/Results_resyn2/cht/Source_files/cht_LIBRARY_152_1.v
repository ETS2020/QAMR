...
module FAU ( 
  ...
  oai21  g066(.a(x14), .b(new_n137_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g071(.a(x14), .b(new_n137_), .c(new_n155_), .O(new_n163_));
  ...
  oai21  g076(.a(x14), .b(new_n137_), .c(new_n161_), .O(new_n168_));
  ...
  oai21  g081(.a(x14), .b(new_n137_), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g086(.a(x14), .b(new_n137_), .c(new_n171_), .O(new_n178_));
  ...
  oai21  g091(.a(x14), .b(new_n137_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g096(.a(x14), .b(new_n137_), .c(new_n181_), .O(new_n188_));
  ...
  oai21  g100(.a(x14), .b(new_n137_), .c(new_n186_), .O(new_n192_));
