...
module FAU ( 
  ...
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    ...
    new_n141_, new_n143_, new_n144_, new_n146_, new_n147_, new_n154_,
  ...
  oai21  g066(.a(x14), .b(new_n139_), .c(new_n157_), .O(new_n158_));
  nand3  g067(.a(new_n158_), .b(new_n156_), .c(new_n88_), .O(new_n159_));
  inv1   g068(.a(new_n159_), .O(z28));
  inv1   g069(.a(x41), .O(new_n161_));
  nand3  g070(.a(new_n161_), .b(new_n154_), .c(x09), .O(new_n162_));
  oai21  g071(.a(x14), .b(new_n139_), .c(new_n155_), .O(new_n163_));
  nand3  g072(.a(new_n163_), .b(new_n162_), .c(new_n88_), .O(new_n164_));
  inv1   g073(.a(new_n164_), .O(z29));
  inv1   g074(.a(x42), .O(new_n166_));
  nand3  g075(.a(new_n166_), .b(new_n154_), .c(x09), .O(new_n167_));
  oai21  g076(.a(x14), .b(new_n139_), .c(new_n161_), .O(new_n168_));
  nand3  g077(.a(new_n168_), .b(new_n167_), .c(new_n88_), .O(new_n169_));
  inv1   g078(.a(new_n169_), .O(z30));
  inv1   g079(.a(x44), .O(new_n172_));
  nand3  g080(.a(new_n172_), .b(new_n154_), .c(x09), .O(new_n173_));
  inv1   g081(.a(x43), .O(new_n174_));
  oai21  g082(.a(x14), .b(new_n139_), .c(new_n174_), .O(new_n175_));
  nand3  g083(.a(new_n175_), .b(new_n173_), .c(new_n88_), .O(new_n176_));
  inv1   g084(.a(new_n176_), .O(z32));
  inv1   g085(.a(x45), .O(new_n178_));
  nand3  g086(.a(new_n178_), .b(new_n154_), .c(x09), .O(new_n179_));
  oai21  g087(.a(x14), .b(new_n139_), .c(new_n172_), .O(new_n180_));
  nand3  g088(.a(new_n180_), .b(new_n179_), .c(new_n88_), .O(new_n181_));
  inv1   g089(.a(new_n181_), .O(z33));
  inv1   g090(.a(x46), .O(new_n183_));
  nand3  g091(.a(new_n183_), .b(new_n154_), .c(x09), .O(new_n184_));
  oai21  g092(.a(x14), .b(new_n139_), .c(new_n178_), .O(new_n185_));
  nand3  g093(.a(new_n185_), .b(new_n184_), .c(new_n88_), .O(new_n186_));
  inv1   g094(.a(new_n186_), .O(z34));
  nand3  g095(.a(new_n154_), .b(x09), .c(new_n136_), .O(new_n188_));
  oai21  g096(.a(x14), .b(new_n139_), .c(new_n183_), .O(new_n189_));
  nand3  g097(.a(new_n189_), .b(new_n188_), .c(new_n88_), .O(new_n190_));
  inv1   g098(.a(new_n190_), .O(z35));
  zero   g099(.O(z00));
  zero   g100(.O(z01));
  zero   g101(.O(z02));
  zero   g102(.O(z23));
