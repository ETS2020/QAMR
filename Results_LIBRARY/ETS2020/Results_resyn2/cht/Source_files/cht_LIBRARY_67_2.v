...
module FAU ( 
  ...
  inv1   g79(.a(x42), .O(new_n168_));
  nand3  g80(.a(new_n168_), .b(new_n162_), .c(x09), .O(new_n169_));
  inv1   g81(.a(x41), .O(new_n170_));
  oai21  g82(.a(x14), .b(new_n139_), .c(new_n170_), .O(new_n171_));
  nand3  g83(.a(new_n171_), .b(new_n169_), .c(new_n85_), .O(new_n172_));
  inv1   g84(.a(new_n172_), .O(z30));
  zero   g85(.O(z13));
  zero   g86(.O(z16));
  zero   g87(.O(z19));
  zero   g88(.O(z28));
