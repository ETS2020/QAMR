...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n105_, new_n106_, new_n109_, new_n110_, new_n113_, new_n114_,
    new_n116_, new_n117_, new_n120_, new_n121_, new_n124_, new_n125_,
    new_n128_, new_n129_, new_n131_, new_n132_, new_n133_, new_n135_,
    new_n136_, new_n139_, new_n140_, new_n142_, new_n143_, new_n148_,
  ...
  oai21  g042(.a(x31), .b(x09), .c(new_n86_), .O(new_n133_));
  ...
  nand3  g058(.a(new_n152_), .b(new_n150_), .c(new_n86_), .O(new_n153_));
  ...
  nand3  g063(.a(new_n157_), .b(new_n156_), .c(new_n86_), .O(new_n158_));
  ...
  nand3  g068(.a(new_n162_), .b(new_n161_), .c(new_n86_), .O(new_n163_));
  ...
  nand3  g073(.a(new_n167_), .b(new_n166_), .c(new_n86_), .O(new_n168_));
  ...
  nand3  g078(.a(new_n172_), .b(new_n171_), .c(new_n86_), .O(new_n173_));
  ...
  nand3  g083(.a(new_n177_), .b(new_n176_), .c(new_n86_), .O(new_n178_));
  ...
  nand3  g088(.a(new_n182_), .b(new_n181_), .c(new_n86_), .O(new_n183_));
  ...
  nand3  g092(.a(new_n186_), .b(new_n185_), .c(new_n86_), .O(new_n187_));
