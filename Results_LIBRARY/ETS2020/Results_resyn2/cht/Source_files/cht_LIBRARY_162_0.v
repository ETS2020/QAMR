...
module FAU ( 
  ...
  oai21  g026(.a(x24), .b(x08), .c(new_n85_), .O(new_n115_));
  aoi21  g027(.a(new_n114_), .b(x08), .c(new_n115_), .O(z13));
  inv1   g028(.a(x26), .O(new_n117_));
  oai21  g029(.a(x25), .b(x08), .c(new_n85_), .O(new_n118_));
  ...
  aoi21  g064(.a(x39), .b(new_n154_), .c(new_n136_), .O(new_n155_));
  ...
  oai21  g070(.a(x14), .b(new_n136_), .c(new_n160_), .O(new_n161_));
  ...
  oai21  g075(.a(x14), .b(new_n136_), .c(new_n158_), .O(new_n166_));
  ...
  oai21  g080(.a(x14), .b(new_n136_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g085(.a(x14), .b(new_n136_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g090(.a(x14), .b(new_n136_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g095(.a(x14), .b(new_n136_), .c(new_n179_), .O(new_n186_));
  ...
  oai21  g100(.a(x14), .b(new_n136_), .c(new_n184_), .O(new_n191_));
  ...
  oai21  g104(.a(x14), .b(new_n136_), .c(new_n189_), .O(new_n195_));
