// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:35 2020
...
module FAU ( 
  ...
  oai21  g38(.a(x26), .b(x08), .c(new_n86_), .O(new_n125_));
  aoi21  g39(.a(new_n124_), .b(x08), .c(new_n125_), .O(z15));
  inv1   g40(.a(x28), .O(new_n127_));
  oai21  g41(.a(x27), .b(x08), .c(new_n86_), .O(new_n128_));
  aoi21  g42(.a(new_n127_), .b(x08), .c(new_n128_), .O(z16));
  ...
  nor2   g56(.a(x34), .b(new_n137_), .O(new_n144_));
  oai21  g57(.a(x33), .b(x09), .c(new_n86_), .O(new_n145_));
  nor2   g58(.a(new_n145_), .b(new_n144_), .O(z22));
  nor2   g59(.a(x35), .b(new_n137_), .O(new_n147_));
  oai21  g60(.a(x34), .b(x09), .c(new_n86_), .O(new_n148_));
  nor2   g61(.a(new_n148_), .b(new_n147_), .O(z23));
  nor2   g62(.a(x36), .b(new_n137_), .O(new_n150_));
  oai21  g63(.a(x35), .b(x09), .c(new_n86_), .O(new_n151_));
  nor2   g64(.a(new_n151_), .b(new_n150_), .O(z24));
  nor2   g65(.a(x37), .b(new_n137_), .O(new_n153_));
  oai21  g66(.a(x36), .b(x09), .c(new_n86_), .O(new_n154_));
  nor2   g67(.a(new_n154_), .b(new_n153_), .O(z25));
  nor2   g68(.a(x38), .b(new_n137_), .O(new_n156_));
  oai21  g69(.a(x37), .b(x09), .c(new_n86_), .O(new_n157_));
  nor2   g70(.a(new_n157_), .b(new_n156_), .O(z26));
  nand2  g71(.a(x14), .b(x00), .O(new_n159_));
  inv1   g72(.a(x14), .O(new_n160_));
  aoi21  g73(.a(x39), .b(new_n160_), .c(new_n137_), .O(new_n161_));
  oai21  g74(.a(x38), .b(x09), .c(new_n86_), .O(new_n162_));
