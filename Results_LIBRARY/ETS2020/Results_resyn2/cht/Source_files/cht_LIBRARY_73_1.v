...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n137_, new_n140_, new_n141_, new_n143_, new_n144_, new_n148_,
  ...
  oai21  g057(.a(x14), .b(new_n129_), .c(new_n151_), .O(new_n152_));
  ...
  oai21  g062(.a(x14), .b(new_n129_), .c(new_n149_), .O(new_n157_));
  ...
  oai21  g067(.a(x14), .b(new_n129_), .c(new_n155_), .O(new_n162_));
  ...
  oai21  g072(.a(x14), .b(new_n129_), .c(new_n160_), .O(new_n167_));
  ...
  oai21  g077(.a(x14), .b(new_n129_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g082(.a(x14), .b(new_n129_), .c(new_n170_), .O(new_n177_));
  ...
  oai21  g087(.a(x14), .b(new_n129_), .c(new_n175_), .O(new_n182_));
  nand3  g088(.a(new_n182_), .b(new_n181_), .c(new_n85_), .O(new_n183_));
  inv1   g089(.a(new_n183_), .O(z34));
  nand3  g090(.a(new_n148_), .b(x09), .c(new_n126_), .O(new_n185_));
  oai21  g091(.a(x14), .b(new_n129_), .c(new_n180_), .O(new_n186_));
