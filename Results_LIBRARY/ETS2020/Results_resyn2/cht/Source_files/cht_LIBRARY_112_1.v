...
module FAU ( 
  ...
  oai21  g075(.a(x14), .b(new_n139_), .c(new_n163_), .O(new_n164_));
  ...
  oai21  g080(.a(x14), .b(new_n139_), .c(new_n161_), .O(new_n169_));
  ...
  oai21  g085(.a(x14), .b(new_n139_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g090(.a(x14), .b(new_n139_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g095(.a(x14), .b(new_n139_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g100(.a(x14), .b(new_n139_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g105(.a(x14), .b(new_n139_), .c(new_n187_), .O(new_n194_));
  nand3  g106(.a(new_n194_), .b(new_n193_), .c(new_n85_), .O(new_n195_));
  inv1   g107(.a(new_n195_), .O(z34));
  nand3  g108(.a(new_n160_), .b(x09), .c(new_n136_), .O(new_n197_));
  oai21  g109(.a(x14), .b(new_n139_), .c(new_n192_), .O(new_n198_));
