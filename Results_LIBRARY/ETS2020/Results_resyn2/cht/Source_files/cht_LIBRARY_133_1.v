...
module FAU ( 
  ...
  inv1   g086(.a(x46), .O(new_n180_));
  nand3  g087(.a(new_n180_), .b(new_n152_), .c(x09), .O(new_n181_));
  inv1   g088(.a(x45), .O(new_n182_));
  oai21  g089(.a(x14), .b(new_n136_), .c(new_n182_), .O(new_n183_));
  nand3  g090(.a(new_n183_), .b(new_n181_), .c(new_n85_), .O(new_n184_));
  inv1   g091(.a(new_n184_), .O(z34));
  nand3  g092(.a(new_n152_), .b(x09), .c(new_n132_), .O(new_n186_));
  oai21  g093(.a(x14), .b(new_n136_), .c(new_n180_), .O(new_n187_));
  nand3  g094(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g095(.a(new_n188_), .O(z35));
  zero   g096(.O(z01));
  zero   g097(.O(z07));
  zero   g098(.O(z14));
  zero   g099(.O(z15));
