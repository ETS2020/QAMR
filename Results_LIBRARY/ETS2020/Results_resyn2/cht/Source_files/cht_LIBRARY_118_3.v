...
module FAU ( 
  ...
  aoi21  g082(.a(x39), .b(new_n166_), .c(new_n145_), .O(new_n167_));
  ...
  oai21  g088(.a(x14), .b(new_n145_), .c(new_n172_), .O(new_n173_));
  ...
  oai21  g093(.a(x14), .b(new_n145_), .c(new_n170_), .O(new_n178_));
  ...
  oai21  g098(.a(x14), .b(new_n145_), .c(new_n176_), .O(new_n183_));
  ...
  oai21  g103(.a(x14), .b(new_n145_), .c(new_n181_), .O(new_n188_));
  ...
  oai21  g108(.a(x14), .b(new_n145_), .c(new_n186_), .O(new_n193_));
  ...
  oai21  g113(.a(x14), .b(new_n145_), .c(new_n191_), .O(new_n198_));
  ...
  oai21  g118(.a(x14), .b(new_n145_), .c(new_n196_), .O(new_n203_));
  nand3  g119(.a(new_n203_), .b(new_n202_), .c(new_n85_), .O(new_n204_));
  inv1   g120(.a(new_n204_), .O(z34));
  nand3  g121(.a(new_n166_), .b(x09), .c(new_n142_), .O(new_n206_));
  oai21  g122(.a(x14), .b(new_n145_), .c(new_n201_), .O(new_n207_));
