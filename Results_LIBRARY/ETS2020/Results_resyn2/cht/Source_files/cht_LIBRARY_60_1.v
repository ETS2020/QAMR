...
module FAU ( 
  ...
  nand3  g064(.a(new_n156_), .b(new_n154_), .c(new_n86_), .O(new_n157_));
  ...
  nand3  g069(.a(new_n161_), .b(new_n160_), .c(new_n86_), .O(new_n162_));
  ...
  nand3  g074(.a(new_n166_), .b(new_n165_), .c(new_n86_), .O(new_n167_));
  ...
  nand3  g079(.a(new_n171_), .b(new_n170_), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g084(.a(new_n176_), .b(new_n175_), .c(new_n86_), .O(new_n177_));
  ...
  nand3  g089(.a(new_n181_), .b(new_n180_), .c(new_n86_), .O(new_n182_));
  ...
  nand3  g094(.a(new_n186_), .b(new_n185_), .c(new_n86_), .O(new_n187_));
  ...
  nand3  g098(.a(new_n190_), .b(new_n189_), .c(new_n86_), .O(new_n191_));
