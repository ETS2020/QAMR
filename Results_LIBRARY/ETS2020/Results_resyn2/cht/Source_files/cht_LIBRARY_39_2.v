...
module FAU ( 
  ...
  inv1   g40(.a(x25), .O(new_n124_));
  oai21  g41(.a(x24), .b(x08), .c(new_n85_), .O(new_n125_));
  aoi21  g42(.a(new_n124_), .b(x08), .c(new_n125_), .O(z13));
  ...
  nor2   g62(.a(x36), .b(new_n139_), .O(new_n150_));
