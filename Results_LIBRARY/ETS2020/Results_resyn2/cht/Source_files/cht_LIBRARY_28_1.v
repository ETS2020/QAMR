...
module FAU ( 
  ...
  nand3  g083(.a(new_n175_), .b(new_n173_), .c(new_n85_), .O(new_n176_));
  ...
  nand3  g088(.a(new_n180_), .b(new_n179_), .c(new_n85_), .O(new_n181_));
  ...
  nand3  g093(.a(new_n185_), .b(new_n184_), .c(new_n85_), .O(new_n186_));
  inv1   g094(.a(new_n186_), .O(z34));
  nand3  g095(.a(new_n154_), .b(x09), .c(new_n134_), .O(new_n188_));
  oai21  g096(.a(x14), .b(new_n139_), .c(new_n183_), .O(new_n189_));
  nand3  g097(.a(new_n189_), .b(new_n188_), .c(new_n85_), .O(new_n190_));
