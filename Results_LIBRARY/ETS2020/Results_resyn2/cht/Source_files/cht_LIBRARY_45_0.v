...
module FAU ( 
  ...
  nor2   g044(.a(x37), .b(new_n133_), .O(new_n139_));
  ...
  oai21  g048(.a(x37), .b(x09), .c(new_n85_), .O(new_n143_));
  ...
  oai21  g053(.a(x38), .b(x09), .c(new_n85_), .O(new_n148_));
  ...
  nand3  g059(.a(new_n153_), .b(new_n151_), .c(new_n85_), .O(new_n154_));
  ...
  nand3  g064(.a(new_n158_), .b(new_n157_), .c(new_n85_), .O(new_n159_));
  ...
  nand3  g069(.a(new_n163_), .b(new_n162_), .c(new_n85_), .O(new_n164_));
  ...
  nand3  g074(.a(new_n168_), .b(new_n167_), .c(new_n85_), .O(new_n169_));
  ...
  nand3  g079(.a(new_n173_), .b(new_n172_), .c(new_n85_), .O(new_n174_));
  ...
  nand3  g084(.a(new_n178_), .b(new_n177_), .c(new_n85_), .O(new_n179_));
  ...
  nand3  g089(.a(new_n183_), .b(new_n182_), .c(new_n85_), .O(new_n184_));
  ...
  nand3  g093(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
