...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n129_, new_n132_, new_n133_, new_n135_, new_n136_, new_n140_,
  ...
  nor2   g044(.a(x38), .b(new_n127_), .O(new_n140_));
  ...
  aoi21  g049(.a(x39), .b(new_n144_), .c(new_n127_), .O(new_n145_));
  ...
  oai21  g055(.a(x14), .b(new_n127_), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g060(.a(x14), .b(new_n127_), .c(new_n148_), .O(new_n156_));
  ...
  oai21  g065(.a(x14), .b(new_n127_), .c(new_n154_), .O(new_n161_));
  ...
  oai21  g070(.a(x14), .b(new_n127_), .c(new_n159_), .O(new_n166_));
  ...
  oai21  g075(.a(x14), .b(new_n127_), .c(new_n164_), .O(new_n171_));
  ...
  oai21  g080(.a(x14), .b(new_n127_), .c(new_n169_), .O(new_n176_));
  ...
  oai21  g085(.a(x14), .b(new_n127_), .c(new_n174_), .O(new_n181_));
  ...
  oai21  g089(.a(x14), .b(new_n127_), .c(new_n179_), .O(new_n185_));
