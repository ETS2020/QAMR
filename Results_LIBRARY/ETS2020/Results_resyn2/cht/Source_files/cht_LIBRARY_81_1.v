...
module FAU ( 
  ...
  inv1   g068(.a(x43), .O(new_n163_));
  nand3  g069(.a(new_n163_), .b(new_n150_), .c(x09), .O(new_n164_));
  inv1   g070(.a(x42), .O(new_n165_));
  oai21  g071(.a(x14), .b(new_n133_), .c(new_n165_), .O(new_n166_));
  nand3  g072(.a(new_n166_), .b(new_n164_), .c(new_n87_), .O(new_n167_));
  inv1   g073(.a(new_n167_), .O(z31));
  inv1   g074(.a(x44), .O(new_n169_));
  nand3  g075(.a(new_n169_), .b(new_n150_), .c(x09), .O(new_n170_));
  oai21  g076(.a(x14), .b(new_n133_), .c(new_n163_), .O(new_n171_));
  nand3  g077(.a(new_n171_), .b(new_n170_), .c(new_n87_), .O(new_n172_));
  inv1   g078(.a(new_n172_), .O(z32));
  inv1   g079(.a(x45), .O(new_n174_));
  nand3  g080(.a(new_n174_), .b(new_n150_), .c(x09), .O(new_n175_));
  oai21  g081(.a(x14), .b(new_n133_), .c(new_n169_), .O(new_n176_));
  nand3  g082(.a(new_n176_), .b(new_n175_), .c(new_n87_), .O(new_n177_));
  inv1   g083(.a(new_n177_), .O(z33));
  inv1   g084(.a(x46), .O(new_n179_));
  nand3  g085(.a(new_n179_), .b(new_n150_), .c(x09), .O(new_n180_));
  oai21  g086(.a(x14), .b(new_n133_), .c(new_n174_), .O(new_n181_));
  nand3  g087(.a(new_n181_), .b(new_n180_), .c(new_n87_), .O(new_n182_));
  inv1   g088(.a(new_n182_), .O(z34));
  zero   g089(.O(z00));
  zero   g090(.O(z01));
  zero   g091(.O(z08));
  zero   g092(.O(z10));
