// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:38 2020
...
module FAU ( 
  ...
  oai21  g011(.a(x18), .b(x08), .c(new_n86_), .O(new_n99_));
  ...
  oai21  g035(.a(x28), .b(x08), .c(new_n86_), .O(new_n125_));
  aoi21  g036(.a(new_n124_), .b(x08), .c(new_n125_), .O(z17));
  inv1   g037(.a(x30), .O(new_n127_));
  oai21  g038(.a(x29), .b(x08), .c(new_n86_), .O(new_n128_));
  ...
  nand3  g061(.a(new_n154_), .b(new_n152_), .c(new_n86_), .O(new_n155_));
  ...
  nand3  g066(.a(new_n159_), .b(new_n158_), .c(new_n86_), .O(new_n160_));
  ...
  nand3  g071(.a(new_n164_), .b(new_n163_), .c(new_n86_), .O(new_n165_));
  ...
  nand3  g076(.a(new_n169_), .b(new_n168_), .c(new_n86_), .O(new_n170_));
  ...
  nand3  g081(.a(new_n174_), .b(new_n173_), .c(new_n86_), .O(new_n175_));
  ...
  nand3  g086(.a(new_n179_), .b(new_n178_), .c(new_n86_), .O(new_n180_));
  ...
  nand3  g091(.a(new_n184_), .b(new_n183_), .c(new_n86_), .O(new_n185_));
  ...
  nand3  g095(.a(new_n188_), .b(new_n187_), .c(new_n86_), .O(new_n189_));
