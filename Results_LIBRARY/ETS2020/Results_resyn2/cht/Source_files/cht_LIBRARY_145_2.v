...
module FAU ( 
  ...
  inv1   g73(.a(x43), .O(new_n165_));
  nand3  g74(.a(new_n165_), .b(new_n158_), .c(x09), .O(new_n166_));
  inv1   g75(.a(x42), .O(new_n167_));
  oai21  g76(.a(x14), .b(new_n135_), .c(new_n167_), .O(new_n168_));
  nand3  g77(.a(new_n168_), .b(new_n166_), .c(new_n85_), .O(new_n169_));
  inv1   g78(.a(new_n169_), .O(z31));
  zero   g79(.O(z08));
  zero   g80(.O(z11));
  zero   g81(.O(z15));
  zero   g82(.O(z16));
