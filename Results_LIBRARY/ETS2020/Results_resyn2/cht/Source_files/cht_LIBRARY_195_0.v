// Benchmark "FAU" written by ABC on Fri Jul 24 20:41:39 2020
...
module FAU ( 
  ...
  aoi21  g061(.a(x39), .b(new_n152_), .c(new_n135_), .O(new_n153_));
  ...
  oai21  g067(.a(x14), .b(new_n135_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g072(.a(x14), .b(new_n135_), .c(new_n156_), .O(new_n164_));
  ...
  oai21  g077(.a(x14), .b(new_n135_), .c(new_n162_), .O(new_n169_));
  ...
  oai21  g082(.a(x14), .b(new_n135_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g087(.a(x14), .b(new_n135_), .c(new_n172_), .O(new_n179_));
  ...
  oai21  g092(.a(x14), .b(new_n135_), .c(new_n177_), .O(new_n184_));
  ...
  oai21  g097(.a(x14), .b(new_n135_), .c(new_n182_), .O(new_n189_));
  ...
  oai21  g101(.a(x14), .b(new_n135_), .c(new_n187_), .O(new_n193_));
