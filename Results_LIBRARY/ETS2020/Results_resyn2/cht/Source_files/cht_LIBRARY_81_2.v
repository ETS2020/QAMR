...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n163_, new_n164_, new_n165_, new_n166_, new_n172_, new_n173_,
  ...
  inv1   g70(.a(x42), .O(new_n162_));
  nand3  g71(.a(new_n162_), .b(new_n156_), .c(x09), .O(new_n163_));
  inv1   g72(.a(x41), .O(new_n164_));
  oai21  g73(.a(x14), .b(new_n133_), .c(new_n164_), .O(new_n165_));
  nand3  g74(.a(new_n165_), .b(new_n163_), .c(new_n85_), .O(new_n166_));
  inv1   g75(.a(new_n166_), .O(z30));
  inv1   g76(.a(x00), .O(new_n172_));
  nand3  g77(.a(new_n156_), .b(x09), .c(new_n172_), .O(new_n173_));
  inv1   g78(.a(x46), .O(new_n174_));
  oai21  g79(.a(x14), .b(new_n133_), .c(new_n174_), .O(new_n175_));
  nand3  g80(.a(new_n175_), .b(new_n173_), .c(new_n85_), .O(new_n176_));
  inv1   g81(.a(new_n176_), .O(z35));
  zero   g82(.O(z05));
  zero   g83(.O(z11));
  zero   g84(.O(z13));
  zero   g85(.O(z16));
