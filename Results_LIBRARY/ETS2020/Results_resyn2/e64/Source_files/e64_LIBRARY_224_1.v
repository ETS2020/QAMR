// Benchmark "FAU" written by ABC on Sat Jul 25 00:25:08 2020
...
module FAU ( 
  ...
  inv1   g126(.a(x11), .O(new_n263_));
  inv1   g127(.a(x25), .O(new_n264_));
  nor2   g128(.a(x24), .b(x15), .O(new_n265_));
  nand4  g129(.a(new_n265_), .b(new_n264_), .c(new_n225_), .d(new_n263_), .O(new_n266_));
  ...
  nand4  g142(.a(new_n155_), .b(new_n234_), .c(new_n225_), .d(x10), .O(new_n280_));
  nor2   g143(.a(new_n280_), .b(new_n232_), .O(z15));
  nand2  g144(.a(new_n229_), .b(new_n147_), .O(new_n282_));
  inv1   g145(.a(new_n282_), .O(new_n283_));
  nor3   g146(.a(x43), .b(x40), .c(x39), .O(new_n284_));
  nand2  g147(.a(new_n284_), .b(new_n227_), .O(new_n285_));
  inv1   g148(.a(new_n285_), .O(new_n286_));
  nand2  g149(.a(new_n270_), .b(new_n131_), .O(new_n287_));
  nand3  g150(.a(new_n248_), .b(new_n204_), .c(new_n273_), .O(new_n288_));
  nor2   g151(.a(new_n288_), .b(new_n287_), .O(new_n289_));
  nand4  g152(.a(new_n289_), .b(new_n286_), .c(new_n283_), .d(x26), .O(new_n290_));
  nor2   g153(.a(new_n290_), .b(new_n269_), .O(z16));
  inv1   g154(.a(x64), .O(new_n294_));
  nor2   g155(.a(new_n179_), .b(new_n174_), .O(new_n295_));
  nand3  g156(.a(new_n151_), .b(new_n227_), .c(new_n150_), .O(new_n296_));
  nor2   g157(.a(x24), .b(x22), .O(new_n297_));
  nor2   g158(.a(x18), .b(x17), .O(new_n298_));
  nand4  g159(.a(new_n298_), .b(new_n297_), .c(new_n192_), .d(new_n136_), .O(new_n299_));
  nor3   g160(.a(new_n299_), .b(new_n296_), .c(new_n238_), .O(new_n300_));
  nand4  g161(.a(new_n253_), .b(new_n246_), .c(new_n161_), .d(new_n156_), .O(new_n301_));
  nor2   g162(.a(new_n301_), .b(new_n251_), .O(new_n302_));
  nand3  g163(.a(new_n132_), .b(new_n131_), .c(new_n155_), .O(new_n303_));
  nor2   g164(.a(new_n303_), .b(x57), .O(new_n304_));
  nand4  g165(.a(new_n304_), .b(new_n302_), .c(new_n300_), .d(new_n295_), .O(new_n305_));
  nor2   g166(.a(new_n305_), .b(new_n294_), .O(z19));
  inv1   g167(.a(x41), .O(new_n308_));
  nand2  g168(.a(new_n284_), .b(new_n308_), .O(new_n309_));
  inv1   g169(.a(new_n309_), .O(new_n310_));
  nand4  g170(.a(new_n310_), .b(new_n289_), .c(new_n231_), .d(new_n147_), .O(new_n311_));
  inv1   g171(.a(x03), .O(new_n312_));
  nand2  g172(.a(new_n173_), .b(new_n172_), .O(new_n313_));
  nand2  g173(.a(new_n159_), .b(new_n145_), .O(new_n314_));
  nor3   g174(.a(new_n314_), .b(new_n266_), .c(new_n313_), .O(new_n315_));
  nand3  g175(.a(new_n315_), .b(new_n312_), .c(x00), .O(new_n316_));
  nor2   g176(.a(new_n316_), .b(new_n311_), .O(z21));
  nand3  g177(.a(new_n298_), .b(new_n180_), .c(new_n136_), .O(new_n318_));
  nand2  g178(.a(new_n192_), .b(new_n150_), .O(new_n319_));
  nor3   g179(.a(new_n319_), .b(new_n238_), .c(x35), .O(new_n320_));
  nor2   g180(.a(new_n201_), .b(new_n157_), .O(new_n321_));
  nand3  g181(.a(new_n158_), .b(x36), .c(new_n209_), .O(new_n322_));
  nor3   g182(.a(new_n322_), .b(x24), .c(x22), .O(new_n323_));
  nand4  g183(.a(new_n323_), .b(new_n321_), .c(new_n320_), .d(new_n236_), .O(new_n324_));
  nor2   g184(.a(new_n324_), .b(new_n318_), .O(z22));
  inv1   g185(.a(x12), .O(new_n326_));
  nand3  g186(.a(new_n295_), .b(new_n136_), .c(new_n326_), .O(new_n327_));
  inv1   g187(.a(x21), .O(new_n328_));
  inv1   g188(.a(x24), .O(new_n329_));
  nand4  g189(.a(new_n227_), .b(new_n209_), .c(new_n329_), .d(new_n328_), .O(new_n330_));
  nand4  g190(.a(new_n211_), .b(new_n159_), .c(new_n182_), .d(x16), .O(new_n331_));
  nor2   g191(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand4  g192(.a(new_n332_), .b(new_n320_), .c(new_n236_), .d(new_n206_), .O(new_n333_));
  nor2   g193(.a(new_n333_), .b(new_n327_), .O(z23));
  nor2   g194(.a(x50), .b(x46), .O(new_n335_));
  nand3  g195(.a(new_n335_), .b(new_n286_), .c(new_n270_), .O(new_n336_));
  inv1   g196(.a(x10), .O(new_n337_));
  nand3  g197(.a(new_n226_), .b(new_n225_), .c(new_n337_), .O(new_n338_));
  nor3   g198(.a(new_n338_), .b(new_n228_), .c(x28), .O(new_n339_));
  nand2  g199(.a(new_n339_), .b(new_n135_), .O(new_n340_));
  nor3   g200(.a(new_n340_), .b(new_n336_), .c(new_n263_), .O(z24));
  nand3  g201(.a(new_n339_), .b(new_n264_), .c(x24), .O(new_n342_));
  nor2   g202(.a(new_n342_), .b(new_n336_), .O(z25));
  nand3  g203(.a(new_n187_), .b(new_n295_), .c(new_n326_), .O(new_n344_));
  nand3  g204(.a(new_n255_), .b(new_n252_), .c(new_n244_), .O(new_n345_));
  nor2   g205(.a(new_n319_), .b(new_n238_), .O(new_n346_));
  nor2   g206(.a(new_n208_), .b(x24), .O(new_n347_));
  nand4  g207(.a(new_n347_), .b(new_n346_), .c(new_n189_), .d(new_n151_), .O(new_n348_));
  nor3   g208(.a(new_n348_), .b(new_n345_), .c(new_n344_), .O(z26));
  nand3  g209(.a(new_n339_), .b(new_n286_), .c(new_n155_), .O(new_n352_));
  nand2  g210(.a(new_n335_), .b(x60), .O(new_n353_));
  nor2   g211(.a(new_n353_), .b(new_n352_), .O(z29));
  nor3   g212(.a(new_n152_), .b(x53), .c(new_n202_), .O(new_n355_));
  inv1   g213(.a(x22), .O(new_n356_));
  nand3  g214(.a(new_n135_), .b(new_n356_), .c(new_n328_), .O(new_n357_));
  nor2   g215(.a(new_n357_), .b(new_n148_), .O(new_n358_));
  nand4  g216(.a(new_n358_), .b(new_n355_), .c(new_n321_), .d(new_n252_), .O(new_n359_));
  nor2   g217(.a(new_n359_), .b(new_n318_), .O(z30));
  nand4  g218(.a(new_n227_), .b(new_n245_), .c(new_n356_), .d(x21), .O(new_n361_));
  inv1   g219(.a(new_n361_), .O(new_n362_));
  nand4  g220(.a(new_n192_), .b(new_n151_), .c(new_n146_), .d(new_n329_), .O(new_n363_));
  nor2   g221(.a(new_n363_), .b(new_n217_), .O(new_n364_));
  nand4  g222(.a(new_n364_), .b(new_n362_), .c(new_n302_), .d(new_n244_), .O(new_n365_));
  nor2   g223(.a(new_n365_), .b(new_n318_), .O(z31));
  nor3   g224(.a(new_n352_), .b(x50), .c(new_n166_), .O(z32));
  inv1   g225(.a(new_n177_), .O(new_n371_));
  nor2   g226(.a(new_n282_), .b(new_n371_), .O(new_n372_));
  nand2  g227(.a(new_n248_), .b(new_n161_), .O(new_n373_));
  nor2   g228(.a(new_n373_), .b(new_n309_), .O(new_n374_));
  nand4  g229(.a(new_n374_), .b(new_n372_), .c(new_n315_), .d(new_n210_), .O(new_n375_));
  nor2   g230(.a(new_n271_), .b(x55), .O(new_n376_));
  nand2  g231(.a(new_n376_), .b(x61), .O(new_n377_));
  nor2   g232(.a(new_n377_), .b(new_n375_), .O(z36));
  inv1   g233(.a(new_n205_), .O(new_n379_));
  nand2  g234(.a(new_n379_), .b(new_n244_), .O(new_n380_));
  inv1   g235(.a(x20), .O(new_n381_));
  nand4  g236(.a(new_n150_), .b(new_n149_), .c(new_n381_), .d(x19), .O(new_n382_));
  nor2   g237(.a(new_n382_), .b(new_n216_), .O(new_n383_));
  nand3  g238(.a(new_n383_), .b(new_n358_), .c(new_n213_), .O(new_n384_));
  ...
  nor2   g242(.a(new_n299_), .b(new_n174_), .O(new_n390_));
  nand4  g243(.a(new_n390_), .b(new_n389_), .c(new_n376_), .d(new_n283_), .O(new_n391_));
  inv1   g244(.a(new_n274_), .O(new_n392_));
  inv1   g245(.a(new_n296_), .O(new_n393_));
  inv1   g246(.a(x51), .O(new_n394_));
  nand3  g247(.a(new_n249_), .b(x54), .c(new_n394_), .O(new_n395_));
  inv1   g248(.a(new_n395_), .O(new_n396_));
  nand4  g249(.a(new_n396_), .b(new_n393_), .c(new_n392_), .d(new_n246_), .O(new_n397_));
  nor2   g250(.a(new_n397_), .b(new_n391_), .O(z40));
  nand4  g251(.a(new_n214_), .b(new_n168_), .c(new_n167_), .d(x02), .O(new_n402_));
  nor2   g252(.a(new_n402_), .b(new_n165_), .O(z44));
  inv1   g253(.a(new_n207_), .O(new_n404_));
  inv1   g254(.a(new_n373_), .O(new_n405_));
  nor2   g255(.a(x39), .b(new_n209_), .O(new_n406_));
  nand4  g256(.a(new_n406_), .b(new_n405_), .c(new_n210_), .d(new_n404_), .O(new_n407_));
  nor2   g257(.a(new_n407_), .b(new_n391_), .O(z45));
  nand3  g258(.a(new_n302_), .b(new_n300_), .c(new_n295_), .O(new_n413_));
  nand3  g259(.a(new_n134_), .b(new_n155_), .c(x57), .O(new_n414_));
  nor2   g260(.a(new_n414_), .b(new_n413_), .O(z50));
  nand3  g261(.a(new_n136_), .b(new_n182_), .c(x12), .O(new_n417_));
  nor2   g262(.a(new_n417_), .b(new_n160_), .O(new_n418_));
  nand2  g263(.a(new_n418_), .b(new_n295_), .O(new_n419_));
  nand3  g264(.a(new_n364_), .b(new_n321_), .c(new_n236_), .O(new_n420_));
  nor2   g265(.a(new_n420_), .b(new_n419_), .O(z52));
  nand2  g266(.a(new_n294_), .b(x63), .O(new_n422_));
  nor2   g267(.a(new_n422_), .b(new_n305_), .O(z53));
  nand2  g268(.a(new_n272_), .b(x55), .O(new_n424_));
  nor2   g269(.a(new_n424_), .b(new_n375_), .O(z54));
  nand2  g270(.a(new_n372_), .b(new_n315_), .O(new_n426_));
  nand4  g271(.a(new_n374_), .b(new_n272_), .c(new_n227_), .d(x35), .O(new_n427_));
  nor2   g272(.a(new_n427_), .b(new_n426_), .O(z55));
  inv1   g273(.a(new_n184_), .O(new_n429_));
  inv1   g274(.a(new_n357_), .O(new_n430_));
  nand4  g275(.a(new_n430_), .b(new_n429_), .c(new_n153_), .d(x20), .O(new_n431_));
  nor3   g276(.a(new_n431_), .b(new_n327_), .c(new_n345_), .O(z56));
  nand2  g277(.a(new_n267_), .b(new_n192_), .O(new_n434_));
  nand3  g278(.a(new_n265_), .b(new_n225_), .c(new_n337_), .O(new_n435_));
  nor2   g279(.a(new_n435_), .b(new_n434_), .O(new_n436_));
  nand4  g280(.a(new_n436_), .b(new_n172_), .c(x22), .d(new_n263_), .O(new_n437_));
  nor2   g281(.a(new_n437_), .b(new_n311_), .O(z58));
  nand4  g282(.a(new_n155_), .b(new_n273_), .c(new_n234_), .d(x40), .O(new_n439_));
  nor3   g283(.a(new_n439_), .b(new_n338_), .c(new_n230_), .O(z59));
  nor2   g284(.a(x56), .b(x40), .O(new_n441_));
  nor2   g285(.a(x30), .b(x11), .O(new_n442_));
  nand4  g286(.a(new_n442_), .b(new_n441_), .c(new_n270_), .d(new_n158_), .O(new_n443_));
  inv1   g287(.a(x08), .O(new_n444_));
  nand3  g288(.a(new_n392_), .b(new_n444_), .c(x07), .O(new_n445_));
  nor3   g289(.a(new_n445_), .b(new_n443_), .c(new_n340_), .O(z60));
  nor2   g290(.a(x30), .b(new_n228_), .O(new_n447_));
  nor2   g291(.a(x10), .b(new_n444_), .O(new_n448_));
  nand4  g292(.a(new_n448_), .b(new_n270_), .c(new_n447_), .d(new_n146_), .O(new_n449_));
  nor4   g293(.a(new_n449_), .b(new_n288_), .c(new_n285_), .d(new_n266_), .O(z61));
  nand3  g294(.a(new_n335_), .b(x47), .c(new_n234_), .O(new_n451_));
  nor3   g295(.a(new_n451_), .b(new_n443_), .c(new_n340_), .O(z62));
  zero   g296(.O(z01));
  zero   g297(.O(z03));
  zero   g298(.O(z04));
  zero   g299(.O(z10));
