// Benchmark "FAU" written by ABC on Sat Jul 25 00:24:25 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n487_, new_n489_, new_n490_, new_n493_, new_n495_, new_n497_,
  ...
  nand4  g215(.a(new_n213_), .b(new_n192_), .c(new_n160_), .d(new_n154_), .O(new_n348_));
  nor2   g216(.a(new_n348_), .b(new_n310_), .O(new_n349_));
  nand3  g217(.a(new_n349_), .b(new_n298_), .c(x51), .O(new_n350_));
  ...
  nand2  g222(.a(new_n336_), .b(new_n210_), .O(new_n357_));
  ...
  nand4  g234(.a(new_n370_), .b(new_n334_), .c(new_n268_), .d(new_n227_), .O(new_n371_));
  nor2   g235(.a(new_n371_), .b(new_n366_), .O(z26));
  nand3  g236(.a(new_n201_), .b(new_n200_), .c(new_n199_), .O(new_n373_));
  nand3  g237(.a(new_n296_), .b(new_n241_), .c(x13), .O(new_n374_));
  ...
  nand4  g242(.a(new_n378_), .b(new_n321_), .c(new_n142_), .d(new_n252_), .O(new_n379_));
  nor3   g243(.a(new_n379_), .b(new_n305_), .c(new_n294_), .O(z28));
  ...
  nand3  g250(.a(new_n331_), .b(new_n165_), .c(new_n386_), .O(new_n387_));
  nor2   g251(.a(new_n226_), .b(new_n174_), .O(new_n388_));
  nand3  g252(.a(new_n388_), .b(new_n344_), .c(new_n139_), .O(new_n389_));
  ...
  nand4  g258(.a(new_n294_), .b(new_n296_), .c(new_n394_), .d(new_n368_), .O(new_n395_));
  ...
  nor3   g268(.a(new_n246_), .b(new_n308_), .c(new_n172_), .O(z34));
  nand2  g269(.a(new_n345_), .b(new_n222_), .O(new_n407_));
  ...
  nand2  g281(.a(new_n184_), .b(new_n181_), .O(new_n419_));
  inv1   g282(.a(new_n419_), .O(new_n420_));
  nand4  g283(.a(new_n420_), .b(new_n416_), .c(new_n349_), .d(new_n298_), .O(new_n421_));
  inv1   g284(.a(new_n280_), .O(new_n422_));
  nor2   g285(.a(new_n253_), .b(x55), .O(new_n423_));
  nand2  g286(.a(new_n423_), .b(new_n422_), .O(new_n424_));
  nor2   g287(.a(new_n424_), .b(new_n421_), .O(z36));
  nand4  g288(.a(new_n216_), .b(new_n137_), .c(new_n367_), .d(x19), .O(new_n426_));
  nor3   g289(.a(new_n426_), .b(new_n395_), .c(new_n134_), .O(new_n427_));
  nand3  g290(.a(new_n427_), .b(new_n356_), .c(new_n255_), .O(new_n428_));
  nor2   g291(.a(new_n428_), .b(new_n366_), .O(z37));
  inv1   g292(.a(x08), .O(new_n430_));
  nand4  g293(.a(new_n192_), .b(new_n154_), .c(new_n430_), .d(new_n153_), .O(new_n431_));
  nor2   g294(.a(new_n431_), .b(new_n285_), .O(new_n432_));
  nor2   g295(.a(new_n407_), .b(new_n231_), .O(new_n433_));
  nand4  g296(.a(new_n433_), .b(new_n432_), .c(new_n414_), .d(new_n337_), .O(new_n434_));
  inv1   g297(.a(new_n185_), .O(new_n435_));
  inv1   g298(.a(new_n340_), .O(new_n436_));
  nand3  g299(.a(new_n436_), .b(new_n435_), .c(x59), .O(new_n437_));
  nor2   g300(.a(new_n437_), .b(new_n434_), .O(z38));
  nand4  g301(.a(new_n436_), .b(new_n184_), .c(new_n242_), .d(x42), .O(new_n439_));
  nor2   g302(.a(new_n439_), .b(new_n434_), .O(z39));
  nor2   g303(.a(new_n431_), .b(new_n166_), .O(new_n441_));
  nand3  g304(.a(new_n321_), .b(new_n265_), .c(new_n142_), .O(new_n442_));
  nor3   g305(.a(x51), .b(x50), .c(x47), .O(new_n443_));
  nand3  g306(.a(new_n443_), .b(new_n337_), .c(new_n336_), .O(new_n444_));
  nor2   g307(.a(new_n444_), .b(new_n442_), .O(new_n445_));
  nand4  g308(.a(new_n445_), .b(new_n441_), .c(new_n414_), .d(new_n146_), .O(new_n446_));
  nand2  g309(.a(new_n179_), .b(x54), .O(new_n447_));
  nor2   g310(.a(new_n447_), .b(new_n446_), .O(z40));
  nand3  g311(.a(new_n441_), .b(new_n414_), .c(new_n146_), .O(new_n449_));
  nand3  g312(.a(new_n321_), .b(new_n265_), .c(new_n142_), .O(new_n450_));
  inv1   g313(.a(new_n450_), .O(new_n451_));
  nand3  g314(.a(new_n337_), .b(new_n135_), .c(x33), .O(new_n452_));
  inv1   g315(.a(new_n452_), .O(new_n453_));
  nand4  g316(.a(new_n453_), .b(new_n451_), .c(new_n443_), .d(new_n179_), .O(new_n454_));
  nor2   g317(.a(new_n454_), .b(new_n449_), .O(z41));
  nand3  g318(.a(new_n339_), .b(new_n334_), .c(new_n331_), .O(new_n456_));
  inv1   g319(.a(x49), .O(new_n457_));
  nor2   g320(.a(x50), .b(new_n457_), .O(new_n458_));
  nand4  g321(.a(new_n458_), .b(new_n179_), .c(new_n157_), .d(new_n171_), .O(new_n459_));
  nor2   g322(.a(new_n459_), .b(new_n456_), .O(z42));
  nand2  g323(.a(new_n339_), .b(new_n334_), .O(new_n461_));
  inv1   g324(.a(new_n194_), .O(new_n462_));
  nand2  g325(.a(new_n154_), .b(new_n196_), .O(new_n463_));
  nor3   g326(.a(new_n463_), .b(new_n182_), .c(new_n195_), .O(new_n464_));
  nand3  g327(.a(new_n464_), .b(new_n462_), .c(new_n179_), .O(new_n465_));
  nor2   g328(.a(new_n465_), .b(new_n461_), .O(z43));
  nand3  g329(.a(new_n451_), .b(new_n443_), .c(new_n179_), .O(new_n469_));
  inv1   g330(.a(x09), .O(new_n470_));
  nor2   g331(.a(x10), .b(new_n470_), .O(new_n471_));
  nand4  g332(.a(new_n471_), .b(new_n441_), .c(new_n414_), .d(new_n337_), .O(new_n472_));
  nor2   g333(.a(new_n472_), .b(new_n469_), .O(z46));
  nor2   g334(.a(x18), .b(new_n164_), .O(new_n474_));
  nand3  g335(.a(new_n332_), .b(new_n354_), .c(new_n136_), .O(new_n475_));
  inv1   g336(.a(new_n475_), .O(new_n476_));
  nor3   g337(.a(new_n419_), .b(new_n260_), .c(new_n214_), .O(new_n477_));
  nand4  g338(.a(new_n477_), .b(new_n476_), .c(new_n474_), .d(new_n323_), .O(new_n478_));
  nand2  g339(.a(new_n432_), .b(new_n179_), .O(new_n479_));
  nor2   g340(.a(new_n479_), .b(new_n478_), .O(z47));
  nand4  g341(.a(new_n136_), .b(new_n135_), .c(new_n215_), .d(x31), .O(new_n481_));
  nor2   g342(.a(new_n481_), .b(new_n143_), .O(new_n482_));
  nand3  g343(.a(new_n482_), .b(new_n186_), .c(new_n179_), .O(new_n483_));
  nor2   g344(.a(new_n483_), .b(new_n449_), .O(z48));
  nand3  g345(.a(new_n179_), .b(new_n171_), .c(x53), .O(new_n485_));
  nor2   g346(.a(new_n485_), .b(new_n446_), .O(z49));
  nand3  g347(.a(new_n345_), .b(new_n169_), .c(x57), .O(new_n487_));
  nor2   g348(.a(new_n487_), .b(new_n343_), .O(z50));
  inv1   g349(.a(new_n182_), .O(new_n489_));
  nand4  g350(.a(new_n489_), .b(new_n179_), .c(new_n457_), .d(x48), .O(new_n490_));
  nor2   g351(.a(new_n490_), .b(new_n456_), .O(z51));
  nand2  g352(.a(new_n225_), .b(x63), .O(new_n493_));
  nor3   g353(.a(new_n493_), .b(new_n346_), .c(new_n343_), .O(z53));
  nand2  g354(.a(new_n422_), .b(x55), .O(new_n495_));
  nor2   g355(.a(new_n495_), .b(new_n421_), .O(z54));
  nand3  g356(.a(new_n420_), .b(new_n349_), .c(new_n298_), .O(new_n497_));
  inv1   g357(.a(new_n415_), .O(new_n498_));
  nand4  g358(.a(new_n498_), .b(new_n422_), .c(new_n140_), .d(x35), .O(new_n499_));
  nor2   g359(.a(new_n499_), .b(new_n497_), .O(z55));
  nand3  g360(.a(new_n201_), .b(x20), .c(new_n200_), .O(new_n501_));
  nor2   g361(.a(new_n501_), .b(new_n395_), .O(new_n502_));
  nand2  g362(.a(new_n502_), .b(new_n268_), .O(new_n503_));
  nor3   g363(.a(new_n503_), .b(new_n389_), .c(new_n387_), .O(z56));
  nand3  g364(.a(new_n332_), .b(new_n294_), .c(x18), .O(new_n505_));
  nor2   g365(.a(new_n505_), .b(new_n134_), .O(new_n506_));
  nand2  g366(.a(new_n506_), .b(new_n412_), .O(new_n507_));
  nor2   g367(.a(new_n507_), .b(new_n283_), .O(z57));
  nand3  g368(.a(new_n323_), .b(new_n296_), .c(x22), .O(new_n509_));
  nor3   g369(.a(new_n509_), .b(new_n415_), .c(new_n214_), .O(new_n510_));
  nand3  g370(.a(new_n510_), .b(new_n412_), .c(new_n282_), .O(new_n511_));
  inv1   g371(.a(new_n511_), .O(z58));
  nor2   g372(.a(new_n403_), .b(new_n259_), .O(z59));
  nor2   g373(.a(x08), .b(new_n293_), .O(new_n514_));
  nand4  g374(.a(new_n514_), .b(new_n326_), .c(new_n325_), .d(new_n286_), .O(new_n515_));
  inv1   g375(.a(new_n515_), .O(z60));
  nand2  g376(.a(new_n325_), .b(new_n286_), .O(new_n518_));
  nand3  g377(.a(new_n279_), .b(new_n304_), .c(x47), .O(new_n519_));
  nor2   g378(.a(new_n519_), .b(new_n518_), .O(z62));
  nand3  g379(.a(new_n378_), .b(new_n252_), .c(x56), .O(new_n521_));
  nor2   g380(.a(new_n521_), .b(new_n518_), .O(z63));
  nand2  g381(.a(new_n140_), .b(x30), .O(new_n523_));
  nor4   g382(.a(new_n523_), .b(new_n379_), .c(new_n285_), .d(new_n269_), .O(z64));
  zero   g383(.O(z02));
  zero   g384(.O(z05));
  zero   g385(.O(z21));
  zero   g386(.O(z22));
