...
module FAU ( 
  ...
  aoi21  g39(.a(new_n73_), .b(new_n80_), .c(new_n85_), .O(new_n86_));
  nor2   g40(.a(x21), .b(x20), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n73_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n86_), .c(x16), .O(new_n90_));
  aoi21  g44(.a(new_n75_), .b(new_n54_), .c(x16), .O(new_n91_));
  oai21  g45(.a(new_n75_), .b(x02), .c(new_n91_), .O(new_n92_));
  ...
  oai21  g50(.a(new_n94_), .b(new_n79_), .c(new_n96_), .O(z12));
  inv1   g51(.a(x22), .O(new_n98_));
  nand3  g52(.a(new_n87_), .b(new_n73_), .c(new_n98_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x23), .O(new_n100_));
  nor2   g54(.a(x23), .b(x22), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n87_), .c(new_n73_), .O(new_n102_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n101_), .c(new_n73_), .d(new_n80_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x16), .O(new_n112_));
  aoi21  g66(.a(new_n75_), .b(new_n63_), .c(x16), .O(new_n113_));
  oai21  g67(.a(new_n75_), .b(x05), .c(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n112_), .O(z14));
  nand2  g69(.a(new_n110_), .b(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x24), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n101_), .c(new_n87_), .d(new_n73_), .O(new_n118_));
  ...
  nand2  g76(.a(new_n122_), .b(new_n120_), .O(z15));
  or2    g77(.a(new_n118_), .b(x26), .O(new_n124_));
  aoi21  g78(.a(new_n118_), .b(x26), .c(new_n79_), .O(new_n125_));
  oai21  g79(.a(x18), .b(new_n69_), .c(new_n79_), .O(new_n126_));
  aoi21  g80(.a(x18), .b(x07), .c(new_n126_), .O(new_n127_));
  aoi21  g81(.a(new_n125_), .b(new_n124_), .c(new_n127_), .O(z16));
  zero   g82(.O(z17));
  buf    g83(.a(x27), .O(z08));
endmodule
