// Benchmark "FAU" written by ABC on Fri Jul 24 21:56:55 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n52_, new_n53_, new_n55_, new_n59_,
  ...
  aoi21  g08(.a(new_n51_), .b(x22), .c(new_n55_), .O(z03));
  inv1   g09(.a(x14), .O(new_n59_));
  nor2   g10(.a(new_n51_), .b(new_n59_), .O(new_n60_));
  aoi21  g11(.a(new_n51_), .b(x25), .c(new_n60_), .O(z06));
  inv1   g12(.a(x15), .O(new_n62_));
  nor2   g13(.a(new_n51_), .b(new_n62_), .O(new_n63_));
  aoi21  g14(.a(new_n51_), .b(x26), .c(new_n63_), .O(z07));
  ...
  aoi21  g26(.a(new_n70_), .b(new_n52_), .c(x16), .O(new_n77_));
  oai21  g27(.a(new_n70_), .b(x02), .c(new_n77_), .O(new_n78_));
  oai21  g28(.a(new_n76_), .b(new_n66_), .c(new_n78_), .O(z11));
