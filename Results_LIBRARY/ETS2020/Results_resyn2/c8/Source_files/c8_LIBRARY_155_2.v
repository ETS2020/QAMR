...
module FAU ( 
  ...
  nor2   g35(.a(new_n70_), .b(x02), .O(new_n86_));
  oai21  g36(.a(x18), .b(x10), .c(new_n72_), .O(new_n87_));
  oai21  g37(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(z11));
  xor2a  g38(.a(new_n83_), .b(x22), .O(new_n89_));
  aoi21  g39(.a(new_n70_), .b(new_n51_), .c(x16), .O(new_n90_));
