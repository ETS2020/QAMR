...
module FAU ( 
  ...
  nor2   g08(.a(new_n47_), .b(new_n56_), .O(new_n57_));
  aoi21  g09(.a(new_n47_), .b(x23), .c(new_n57_), .O(z04));
  inv1   g10(.a(x13), .O(new_n59_));
  nor2   g11(.a(new_n47_), .b(new_n59_), .O(new_n60_));
  aoi21  g12(.a(new_n47_), .b(x24), .c(new_n60_), .O(z05));
  inv1   g13(.a(x14), .O(new_n62_));
  nor2   g14(.a(new_n47_), .b(new_n62_), .O(new_n63_));
  aoi21  g15(.a(new_n47_), .b(x25), .c(new_n63_), .O(z06));
  inv1   g16(.a(x15), .O(new_n65_));
  nor2   g17(.a(new_n47_), .b(new_n65_), .O(new_n66_));
  aoi21  g18(.a(new_n47_), .b(x26), .c(new_n66_), .O(z07));
  ...
  aoi21  g23(.a(new_n72_), .b(new_n48_), .c(x16), .O(new_n73_));
  oai21  g24(.a(new_n72_), .b(x00), .c(new_n73_), .O(new_n74_));
  nand2  g25(.a(new_n74_), .b(new_n71_), .O(z09));
  ...
  oai21  g30(.a(x18), .b(x09), .c(new_n76_), .O(new_n80_));
  oai22  g31(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n76_), .O(z10));
  ...
  oai21  g43(.a(x18), .b(x11), .c(new_n76_), .O(new_n93_));
  oai22  g44(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n76_), .O(z12));
  ...
  aoi21  g72(.a(new_n115_), .b(x26), .c(new_n76_), .O(new_n122_));
  oai21  g73(.a(x18), .b(new_n65_), .c(new_n76_), .O(new_n123_));
