...
module FAU ( 
  ...
  nor2   g11(.a(new_n54_), .b(new_n59_), .O(new_n60_));
  aoi21  g12(.a(new_n54_), .b(x24), .c(new_n60_), .O(z05));
  ...
  aoi21  g42(.a(new_n65_), .b(new_n93_), .c(x16), .O(new_n94_));
  oai21  g43(.a(new_n65_), .b(x04), .c(new_n94_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n92_), .O(z13));
  or2    g45(.a(new_n90_), .b(x24), .O(new_n97_));
  aoi21  g46(.a(new_n90_), .b(x24), .c(new_n68_), .O(new_n98_));
