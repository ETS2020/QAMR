...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_, new_n59_,
  ...
  aoi21  g08(.a(new_n48_), .b(x22), .c(new_n55_), .O(z03));
  inv1   g09(.a(x14), .O(new_n59_));
  nor2   g10(.a(new_n48_), .b(new_n59_), .O(new_n60_));
  aoi21  g11(.a(new_n48_), .b(x25), .c(new_n60_), .O(z06));
  inv1   g12(.a(x15), .O(new_n62_));
  nor2   g13(.a(new_n48_), .b(new_n62_), .O(new_n63_));
  aoi21  g14(.a(new_n48_), .b(x26), .c(new_n63_), .O(z07));
  ...
  inv1   g46(.a(x19), .O(new_n100_));
  nor2   g47(.a(x26), .b(new_n100_), .O(new_n101_));
  nand4  g48(.a(new_n101_), .b(new_n87_), .c(new_n83_), .d(new_n75_), .O(new_n102_));
  oai21  g49(.a(x27), .b(new_n99_), .c(x16), .O(new_n103_));
  aoi21  g50(.a(new_n102_), .b(new_n99_), .c(new_n103_), .O(z17));
  zero   g51(.O(z00));
  zero   g52(.O(z04));
  zero   g53(.O(z05));
  zero   g54(.O(z09));
