// Benchmark "FAU" written by ABC on Fri Jul 24 21:56:36 2020
...
module FAU ( 
  ...
  aoi21  g35(.a(new_n69_), .b(new_n50_), .c(x16), .O(new_n85_));
  oai21  g36(.a(new_n69_), .b(x02), .c(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n84_), .O(z11));
  xor2a  g38(.a(new_n82_), .b(x22), .O(new_n88_));
  nor2   g39(.a(new_n69_), .b(x03), .O(new_n89_));
  oai21  g40(.a(x18), .b(x11), .c(new_n71_), .O(new_n90_));
  oai22  g41(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n71_), .O(z12));
