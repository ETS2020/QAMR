...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n53_, new_n54_, new_n56_,
    new_n57_, new_n59_, new_n60_, new_n62_, new_n63_, new_n67_, new_n68_,
  ...
  aoi21  g38(.a(new_n68_), .b(new_n56_), .c(x16), .O(new_n88_));
  ...
  aoi21  g46(.a(new_n68_), .b(new_n59_), .c(x16), .O(new_n96_));
  ...
  oai21  g51(.a(x18), .b(new_n62_), .c(new_n71_), .O(new_n101_));
