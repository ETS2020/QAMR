...
module FAU ( 
  ...
  aoi21  g35(.a(new_n66_), .b(new_n54_), .c(x16), .O(new_n86_));
  ...
  aoi21  g43(.a(new_n66_), .b(new_n57_), .c(x16), .O(new_n94_));
  ...
  oai21  g48(.a(x18), .b(new_n60_), .c(new_n69_), .O(new_n99_));
  aoi21  g49(.a(x18), .b(x05), .c(new_n99_), .O(new_n100_));
  aoi21  g50(.a(new_n98_), .b(new_n97_), .c(new_n100_), .O(z14));
  inv1   g51(.a(x26), .O(new_n103_));
  nor2   g52(.a(x25), .b(x24), .O(new_n104_));
  nand4  g53(.a(new_n104_), .b(new_n90_), .c(new_n81_), .d(new_n70_), .O(new_n105_));
  and2   g54(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g55(.a(new_n105_), .b(new_n103_), .c(x16), .O(new_n107_));
  inv1   g56(.a(x15), .O(new_n108_));
  aoi21  g57(.a(new_n66_), .b(new_n108_), .c(x16), .O(new_n109_));
  oai21  g58(.a(new_n66_), .b(x07), .c(new_n109_), .O(new_n110_));
  oai21  g59(.a(new_n107_), .b(new_n106_), .c(new_n110_), .O(z16));
  nand2  g60(.a(x27), .b(x17), .O(new_n112_));
  inv1   g61(.a(x17), .O(new_n113_));
  nand3  g62(.a(new_n103_), .b(x19), .c(new_n113_), .O(new_n114_));
  inv1   g63(.a(new_n114_), .O(new_n115_));
  nand4  g64(.a(new_n115_), .b(new_n104_), .c(new_n90_), .d(new_n81_), .O(new_n116_));
  aoi21  g65(.a(new_n116_), .b(new_n112_), .c(new_n69_), .O(z17));
  zero   g66(.O(z02));
  zero   g67(.O(z06));
  zero   g68(.O(z07));
  zero   g69(.O(z11));
