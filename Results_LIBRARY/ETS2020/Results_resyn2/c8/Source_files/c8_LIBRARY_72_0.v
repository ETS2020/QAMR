...
module FAU ( 
  ...
  and2   g13(.a(x27), .b(x15), .O(new_n63_));
  aoi21  g14(.a(new_n54_), .b(x26), .c(new_n63_), .O(z07));
  ...
  aoi21  g35(.a(new_n66_), .b(new_n55_), .c(x16), .O(new_n86_));
  ...
  aoi21  g44(.a(new_n66_), .b(new_n94_), .c(x16), .O(new_n95_));
  oai21  g45(.a(new_n66_), .b(x04), .c(new_n95_), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(new_n93_), .O(z13));
  or2    g47(.a(new_n91_), .b(x24), .O(new_n98_));
  aoi21  g48(.a(new_n91_), .b(x24), .c(new_n69_), .O(new_n99_));
  oai21  g49(.a(x18), .b(new_n59_), .c(new_n69_), .O(new_n100_));
