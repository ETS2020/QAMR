...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n50_, new_n51_, new_n53_, new_n57_, new_n58_, new_n60_,
  ...
  aoi21  g05(.a(new_n49_), .b(x22), .c(new_n53_), .O(z03));
  inv1   g06(.a(x14), .O(new_n57_));
  nor2   g07(.a(new_n49_), .b(new_n57_), .O(new_n58_));
  aoi21  g08(.a(new_n49_), .b(x25), .c(new_n58_), .O(z06));
  inv1   g09(.a(x15), .O(new_n60_));
  nor2   g10(.a(new_n49_), .b(new_n60_), .O(new_n61_));
  aoi21  g11(.a(new_n49_), .b(x26), .c(new_n61_), .O(z07));
  ...
  aoi21  g23(.a(new_n68_), .b(new_n50_), .c(x16), .O(new_n75_));
  oai21  g24(.a(new_n68_), .b(x02), .c(new_n75_), .O(new_n76_));
  oai21  g25(.a(new_n74_), .b(new_n64_), .c(new_n76_), .O(z11));
  ...
  inv1   g43(.a(x19), .O(new_n98_));
  nor2   g44(.a(x26), .b(new_n98_), .O(new_n99_));
  nand4  g45(.a(new_n99_), .b(new_n85_), .c(new_n81_), .d(new_n73_), .O(new_n100_));
  oai21  g46(.a(x27), .b(new_n97_), .c(x16), .O(new_n101_));
  aoi21  g47(.a(new_n100_), .b(new_n97_), .c(new_n101_), .O(z17));
  zero   g48(.O(z00));
  zero   g49(.O(z01));
  zero   g50(.O(z04));
  zero   g51(.O(z05));
