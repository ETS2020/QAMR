...
module FAU ( 
  ...
  aoi21  g36(.a(new_n69_), .b(new_n57_), .c(x16), .O(new_n86_));
  oai21  g37(.a(new_n69_), .b(x03), .c(new_n86_), .O(new_n87_));
  oai21  g38(.a(new_n85_), .b(new_n72_), .c(new_n87_), .O(z12));
  ...
  aoi21  g47(.a(new_n69_), .b(new_n96_), .c(x16), .O(new_n97_));
  oai21  g48(.a(new_n69_), .b(x04), .c(new_n97_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n95_), .O(z13));
  nand2  g50(.a(new_n93_), .b(x24), .O(new_n100_));
  nor2   g51(.a(x24), .b(x21), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n92_), .c(new_n73_), .d(new_n50_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g54(.a(new_n103_), .b(x16), .O(new_n104_));
  aoi21  g55(.a(new_n69_), .b(new_n61_), .c(x16), .O(new_n105_));
  oai21  g56(.a(new_n69_), .b(x05), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n104_), .O(z14));
  oai21  g58(.a(x18), .b(new_n64_), .c(new_n72_), .O(new_n108_));
  aoi21  g59(.a(x18), .b(x06), .c(new_n108_), .O(new_n109_));
  nand2  g60(.a(new_n102_), .b(x25), .O(new_n110_));
  nor2   g61(.a(x25), .b(x24), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n92_), .c(new_n78_), .d(new_n73_), .O(new_n112_));
  and2   g63(.a(new_n112_), .b(x16), .O(new_n113_));
  aoi21  g64(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(z15));
  inv1   g65(.a(x26), .O(new_n115_));
  nand2  g66(.a(new_n111_), .b(new_n92_), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(new_n117_));
  nand3  g68(.a(new_n117_), .b(new_n80_), .c(new_n115_), .O(new_n118_));
  aoi21  g69(.a(new_n112_), .b(x26), .c(new_n72_), .O(new_n119_));
  nand2  g70(.a(x18), .b(x07), .O(new_n120_));
  aoi21  g71(.a(new_n69_), .b(x15), .c(x16), .O(new_n121_));
  aoi22  g72(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(z16));
  nand2  g73(.a(x27), .b(x17), .O(new_n123_));
  nor2   g74(.a(new_n47_), .b(x17), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n117_), .c(new_n78_), .d(new_n115_), .O(new_n125_));
  aoi21  g76(.a(new_n125_), .b(new_n123_), .c(new_n72_), .O(z17));
  zero   g77(.O(z04));
  zero   g78(.O(z07));
  zero   g79(.O(z10));
  buf    g80(.a(x27), .O(z08));
