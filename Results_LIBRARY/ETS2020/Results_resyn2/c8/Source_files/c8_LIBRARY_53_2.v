...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nor2   g30(.a(x21), .b(x20), .O(new_n81_));
  nand2  g31(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  inv1   g32(.a(new_n82_), .O(new_n83_));
  oai21  g33(.a(new_n83_), .b(new_n80_), .c(x16), .O(new_n84_));
  aoi21  g34(.a(new_n72_), .b(new_n50_), .c(x16), .O(new_n85_));
  oai21  g35(.a(new_n72_), .b(x02), .c(new_n85_), .O(new_n86_));
  nand2  g36(.a(new_n86_), .b(new_n84_), .O(z11));
  xor2a  g37(.a(new_n82_), .b(x22), .O(new_n88_));
  aoi21  g38(.a(new_n72_), .b(new_n53_), .c(x16), .O(new_n89_));
  oai21  g39(.a(new_n72_), .b(x03), .c(new_n89_), .O(new_n90_));
  oai21  g40(.a(new_n88_), .b(new_n74_), .c(new_n90_), .O(z12));
  inv1   g41(.a(x22), .O(new_n92_));
  nand3  g42(.a(new_n81_), .b(new_n70_), .c(new_n92_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(x23), .O(new_n94_));
  nor2   g44(.a(x23), .b(x22), .O(new_n95_));
  nand3  g45(.a(new_n95_), .b(new_n81_), .c(new_n70_), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(x16), .O(new_n98_));
  aoi21  g48(.a(new_n72_), .b(new_n56_), .c(x16), .O(new_n99_));
  oai21  g49(.a(new_n72_), .b(x04), .c(new_n99_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n98_), .O(z13));
  nand2  g51(.a(new_n96_), .b(x24), .O(new_n102_));
  nor2   g52(.a(x24), .b(x21), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n95_), .c(new_n70_), .d(new_n78_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(x16), .O(new_n106_));
  aoi21  g56(.a(new_n72_), .b(new_n59_), .c(x16), .O(new_n107_));
  oai21  g57(.a(new_n72_), .b(x05), .c(new_n107_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n106_), .O(z14));
  oai21  g59(.a(x18), .b(new_n62_), .c(new_n74_), .O(new_n110_));
  aoi21  g60(.a(x18), .b(x06), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n104_), .b(x25), .O(new_n112_));
  nor2   g62(.a(x25), .b(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n95_), .c(new_n81_), .d(new_n70_), .O(new_n114_));
  and2   g64(.a(new_n114_), .b(x16), .O(new_n115_));
  aoi21  g65(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(z15));
  inv1   g66(.a(x26), .O(new_n117_));
  nand4  g67(.a(new_n113_), .b(new_n95_), .c(new_n83_), .d(new_n117_), .O(new_n118_));
  aoi21  g68(.a(new_n114_), .b(x26), .c(new_n74_), .O(new_n119_));
  oai21  g69(.a(x18), .b(new_n65_), .c(new_n74_), .O(new_n120_));
