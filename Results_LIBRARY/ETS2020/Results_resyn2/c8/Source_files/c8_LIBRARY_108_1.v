...
module FAU ( 
  ...
  nor2   g11(.a(new_n50_), .b(new_n61_), .O(new_n62_));
  aoi21  g12(.a(new_n50_), .b(x26), .c(new_n62_), .O(z07));
  ...
  nor2   g24(.a(new_n69_), .b(x02), .O(new_n76_));
  oai21  g25(.a(x18), .b(x10), .c(new_n65_), .O(new_n77_));
  oai22  g26(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n65_), .O(z11));
