...
module FAU ( 
  ...
  aoi21  g35(.a(new_n67_), .b(new_n54_), .c(x16), .O(new_n85_));
  ...
  nand4  g50(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n88_), .O(new_n102_));
  inv1   g51(.a(new_n102_), .O(new_n103_));
  aoi22  g52(.a(new_n103_), .b(new_n83_), .c(new_n98_), .d(x25), .O(new_n104_));
  aoi21  g53(.a(new_n67_), .b(new_n60_), .c(x16), .O(new_n105_));
  oai21  g54(.a(new_n67_), .b(x06), .c(new_n105_), .O(new_n106_));
  oai21  g55(.a(new_n104_), .b(new_n70_), .c(new_n106_), .O(z15));
  nand2  g56(.a(x27), .b(x17), .O(new_n109_));
  nand3  g57(.a(new_n63_), .b(x19), .c(new_n81_), .O(new_n110_));
  inv1   g58(.a(new_n110_), .O(new_n111_));
  nand4  g59(.a(new_n111_), .b(new_n103_), .c(new_n79_), .d(new_n74_), .O(new_n112_));
  aoi21  g60(.a(new_n112_), .b(new_n109_), .c(new_n70_), .O(z17));
  zero   g61(.O(z03));
  zero   g62(.O(z04));
  zero   g63(.O(z05));
  zero   g64(.O(z13));
