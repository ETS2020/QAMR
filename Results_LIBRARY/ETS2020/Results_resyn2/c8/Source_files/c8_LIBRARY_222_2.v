...
module FAU ( 
  ...
  aoi21  g42(.a(new_n72_), .b(new_n55_), .c(x16), .O(new_n92_));
  ...
  aoi21  g52(.a(new_n72_), .b(new_n58_), .c(x16), .O(new_n102_));
  ...
  inv1   g60(.a(x13), .O(new_n110_));
  aoi21  g61(.a(new_n72_), .b(new_n110_), .c(x16), .O(new_n111_));
  oai21  g62(.a(new_n72_), .b(x05), .c(new_n111_), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n109_), .O(z14));
  nand2  g64(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g65(.a(x25), .b(x24), .O(new_n115_));
  nand4  g66(.a(new_n115_), .b(new_n98_), .c(new_n84_), .d(new_n70_), .O(new_n116_));
  nand2  g67(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(x16), .O(new_n118_));
  aoi21  g69(.a(new_n72_), .b(new_n62_), .c(x16), .O(new_n119_));
  oai21  g70(.a(new_n72_), .b(x06), .c(new_n119_), .O(new_n120_));
  nand2  g71(.a(new_n120_), .b(new_n118_), .O(z15));
  or2    g72(.a(new_n116_), .b(x26), .O(new_n122_));
  aoi21  g73(.a(new_n116_), .b(x26), .c(new_n74_), .O(new_n123_));
  oai21  g74(.a(x18), .b(new_n65_), .c(new_n74_), .O(new_n124_));
  aoi21  g75(.a(x18), .b(x07), .c(new_n124_), .O(new_n125_));
  aoi21  g76(.a(new_n123_), .b(new_n122_), .c(new_n125_), .O(z16));
  zero   g77(.O(z00));
  zero   g78(.O(z05));
  zero   g79(.O(z08));
  zero   g80(.O(z17));
