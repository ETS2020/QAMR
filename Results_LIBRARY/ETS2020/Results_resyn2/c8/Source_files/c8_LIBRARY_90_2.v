...
module FAU ( 
  ...
  aoi21  g47(.a(new_n74_), .b(new_n58_), .c(x16), .O(new_n98_));
  ...
  aoi21  g55(.a(new_n74_), .b(new_n61_), .c(x16), .O(new_n106_));
  ...
  aoi21  g64(.a(new_n74_), .b(new_n114_), .c(x16), .O(new_n115_));
  oai21  g65(.a(new_n74_), .b(x06), .c(new_n115_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n113_), .O(z15));
  or2    g67(.a(new_n111_), .b(x26), .O(new_n118_));
  aoi21  g68(.a(new_n111_), .b(x26), .c(new_n70_), .O(new_n119_));
