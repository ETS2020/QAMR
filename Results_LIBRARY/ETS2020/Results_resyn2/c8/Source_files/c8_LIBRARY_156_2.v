// Benchmark "FAU" written by ABC on Fri Jul 24 21:57:05 2020
...
module FAU ( 
  ...
  nor2   g39(.a(new_n70_), .b(x03), .O(new_n90_));
  oai21  g40(.a(x18), .b(x11), .c(new_n72_), .O(new_n91_));
  oai22  g41(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n72_), .O(z12));
  ...
  aoi21  g49(.a(new_n70_), .b(new_n54_), .c(x16), .O(new_n100_));
  ...
  aoi21  g57(.a(new_n70_), .b(new_n57_), .c(x16), .O(new_n108_));
  ...
  aoi21  g65(.a(new_n70_), .b(new_n60_), .c(x16), .O(new_n116_));
  ...
  oai21  g70(.a(x18), .b(new_n63_), .c(new_n72_), .O(new_n121_));
  aoi21  g71(.a(x18), .b(x07), .c(new_n121_), .O(new_n122_));
  aoi21  g72(.a(new_n120_), .b(new_n119_), .c(new_n122_), .O(z16));
  zero   g73(.O(z00));
  zero   g74(.O(z01));
  zero   g75(.O(z03));
  zero   g76(.O(z08));
