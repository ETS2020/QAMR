...
module FAU ( 
  ...
  nand2  g32(.a(new_n70_), .b(new_n77_), .O(new_n82_));
  nor2   g33(.a(x21), .b(x20), .O(new_n83_));
  aoi22  g34(.a(new_n83_), .b(new_n70_), .c(new_n82_), .d(x21), .O(new_n84_));
  aoi21  g35(.a(new_n72_), .b(new_n52_), .c(x16), .O(new_n85_));
  oai21  g36(.a(new_n72_), .b(x02), .c(new_n85_), .O(new_n86_));
  oai21  g37(.a(new_n84_), .b(new_n74_), .c(new_n86_), .O(z11));
  inv1   g38(.a(x22), .O(new_n88_));
  aoi21  g39(.a(new_n83_), .b(new_n70_), .c(new_n88_), .O(new_n89_));
  nand3  g40(.a(new_n83_), .b(new_n70_), .c(new_n88_), .O(new_n90_));
  inv1   g41(.a(new_n90_), .O(new_n91_));
  oai21  g42(.a(new_n91_), .b(new_n89_), .c(x16), .O(new_n92_));
  aoi21  g43(.a(new_n72_), .b(new_n55_), .c(x16), .O(new_n93_));
  oai21  g44(.a(new_n72_), .b(x03), .c(new_n93_), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(new_n92_), .O(z12));
  nand2  g46(.a(new_n90_), .b(x23), .O(new_n96_));
  nor2   g47(.a(x23), .b(x22), .O(new_n97_));
  nand3  g48(.a(new_n97_), .b(new_n83_), .c(new_n70_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(x16), .O(new_n100_));
  aoi21  g51(.a(new_n72_), .b(new_n58_), .c(x16), .O(new_n101_));
  oai21  g52(.a(new_n72_), .b(x04), .c(new_n101_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(new_n100_), .O(z13));
  or2    g54(.a(new_n98_), .b(x24), .O(new_n104_));
  aoi21  g55(.a(new_n98_), .b(x24), .c(new_n74_), .O(new_n105_));
  oai21  g56(.a(x18), .b(new_n61_), .c(new_n74_), .O(new_n106_));
  ...
  nand4  g61(.a(new_n111_), .b(new_n97_), .c(new_n83_), .d(new_n70_), .O(new_n112_));
  and2   g62(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  oai21  g63(.a(new_n112_), .b(new_n110_), .c(x16), .O(new_n114_));
  aoi21  g64(.a(new_n72_), .b(new_n65_), .c(x16), .O(new_n115_));
  oai21  g65(.a(new_n72_), .b(x07), .c(new_n115_), .O(new_n116_));
