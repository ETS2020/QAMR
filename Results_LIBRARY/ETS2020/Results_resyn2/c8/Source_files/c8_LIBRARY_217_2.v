...
module FAU ( 
  ...
  nor2   g05(.a(new_n47_), .b(new_n52_), .O(new_n53_));
  aoi21  g06(.a(new_n47_), .b(x21), .c(new_n53_), .O(z02));
  inv1   g07(.a(x11), .O(new_n55_));
  nor2   g08(.a(new_n47_), .b(new_n55_), .O(new_n56_));
  aoi21  g09(.a(new_n47_), .b(x22), .c(new_n56_), .O(z03));
  inv1   g10(.a(x12), .O(new_n58_));
  nor2   g11(.a(new_n47_), .b(new_n58_), .O(new_n59_));
  aoi21  g12(.a(new_n47_), .b(x23), .c(new_n59_), .O(z04));
  inv1   g13(.a(x13), .O(new_n61_));
  nor2   g14(.a(new_n47_), .b(new_n61_), .O(new_n62_));
  aoi21  g15(.a(new_n47_), .b(x24), .c(new_n62_), .O(z05));
  inv1   g16(.a(x14), .O(new_n64_));
  nor2   g17(.a(new_n47_), .b(new_n64_), .O(new_n65_));
  aoi21  g18(.a(new_n47_), .b(x25), .c(new_n65_), .O(z06));
  inv1   g19(.a(x15), .O(new_n67_));
  nor2   g20(.a(new_n47_), .b(new_n67_), .O(new_n68_));
  aoi21  g21(.a(new_n47_), .b(x26), .c(new_n68_), .O(z07));
  ...
  aoi21  g26(.a(new_n74_), .b(new_n48_), .c(x16), .O(new_n75_));
  oai21  g27(.a(new_n74_), .b(x00), .c(new_n75_), .O(new_n76_));
  nand2  g28(.a(new_n76_), .b(new_n73_), .O(z09));
  ...
  oai21  g33(.a(x18), .b(x09), .c(new_n78_), .O(new_n82_));
  oai22  g34(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n78_), .O(z10));
  ...
  oai21  g47(.a(new_n93_), .b(new_n78_), .c(new_n95_), .O(z12));
  ...
  aoi21  g75(.a(new_n117_), .b(x26), .c(new_n78_), .O(new_n124_));
  oai21  g76(.a(x18), .b(new_n67_), .c(new_n78_), .O(new_n125_));
