// Benchmark "FAU" written by ABC on Fri Jul 24 21:57:23 2020
...
module FAU ( 
  ...
  aoi21  g38(.a(new_n72_), .b(new_n50_), .c(x16), .O(new_n88_));
  ...
  aoi21  g42(.a(new_n72_), .b(new_n53_), .c(x16), .O(new_n92_));
  oai21  g43(.a(new_n72_), .b(x03), .c(new_n92_), .O(new_n93_));
  oai21  g44(.a(new_n91_), .b(new_n74_), .c(new_n93_), .O(z12));
