// Benchmark "FAU" written by ABC on Fri Jul 24 21:57:02 2020
...
module FAU ( 
  ...
  nor2   g39(.a(new_n71_), .b(x03), .O(new_n88_));
  oai21  g40(.a(x18), .b(x11), .c(new_n74_), .O(new_n89_));
  oai22  g41(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n74_), .O(z12));
