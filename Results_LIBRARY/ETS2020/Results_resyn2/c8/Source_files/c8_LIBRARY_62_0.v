...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n54_, new_n55_, new_n56_,
    new_n58_, new_n59_, new_n61_, new_n62_, new_n65_, new_n68_, new_n69_,
  ...
  aoi21  g38(.a(new_n69_), .b(new_n55_), .c(x16), .O(new_n89_));
  ...
  aoi21  g46(.a(new_n69_), .b(new_n58_), .c(x16), .O(new_n97_));
  ...
  oai21  g51(.a(x18), .b(new_n61_), .c(new_n72_), .O(new_n102_));
