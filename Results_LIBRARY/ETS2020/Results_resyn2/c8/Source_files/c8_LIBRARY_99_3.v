...
module FAU ( 
  ...
  aoi21  g39(.a(new_n72_), .b(new_n57_), .c(x16), .O(new_n89_));
  oai21  g40(.a(new_n72_), .b(x03), .c(new_n89_), .O(new_n90_));
  oai21  g41(.a(new_n88_), .b(new_n75_), .c(new_n90_), .O(z12));
  ...
  aoi21  g49(.a(new_n72_), .b(new_n60_), .c(x16), .O(new_n99_));
  ...
  aoi21  g57(.a(new_n72_), .b(new_n63_), .c(x16), .O(new_n107_));
  oai21  g58(.a(new_n72_), .b(x05), .c(new_n107_), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(new_n106_), .O(z14));
  oai21  g60(.a(x18), .b(new_n66_), .c(new_n75_), .O(new_n110_));
  ...
  aoi21  g73(.a(new_n72_), .b(x15), .c(x16), .O(new_n123_));
  aoi22  g74(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(z16));
