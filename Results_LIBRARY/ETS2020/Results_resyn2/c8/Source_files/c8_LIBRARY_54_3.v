...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n48_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  inv1   g00(.a(x20), .O(new_n48_));
  nor2   g01(.a(x27), .b(new_n48_), .O(new_n49_));
  aoi21  g02(.a(x27), .b(x09), .c(new_n49_), .O(z01));
  ...
  nor2   g08(.a(new_n51_), .b(new_n55_), .O(new_n56_));
  aoi21  g09(.a(new_n51_), .b(x22), .c(new_n56_), .O(z03));
  inv1   g10(.a(x12), .O(new_n58_));
  nor2   g11(.a(new_n51_), .b(new_n58_), .O(new_n59_));
  aoi21  g12(.a(new_n51_), .b(x23), .c(new_n59_), .O(z04));
  inv1   g13(.a(x13), .O(new_n61_));
  nor2   g14(.a(new_n51_), .b(new_n61_), .O(new_n62_));
  aoi21  g15(.a(new_n51_), .b(x24), .c(new_n62_), .O(z05));
  inv1   g16(.a(x14), .O(new_n64_));
  nor2   g17(.a(new_n51_), .b(new_n64_), .O(new_n65_));
  aoi21  g18(.a(new_n51_), .b(x25), .c(new_n65_), .O(z06));
  inv1   g19(.a(x15), .O(new_n67_));
  nor2   g20(.a(new_n51_), .b(new_n67_), .O(new_n68_));
  aoi21  g21(.a(new_n51_), .b(x26), .c(new_n68_), .O(z07));
  ...
  nand2  g30(.a(new_n75_), .b(new_n48_), .O(new_n79_));
  ...
  aoi21  g39(.a(new_n71_), .b(new_n55_), .c(x16), .O(new_n88_));
  ...
  aoi21  g49(.a(new_n71_), .b(new_n58_), .c(x16), .O(new_n98_));
  ...
  oai21  g72(.a(x18), .b(new_n67_), .c(new_n74_), .O(new_n121_));
  aoi21  g73(.a(x18), .b(x07), .c(new_n121_), .O(new_n122_));
  aoi21  g74(.a(new_n120_), .b(new_n119_), .c(new_n122_), .O(z16));
  nand2  g75(.a(x27), .b(x17), .O(new_n124_));
  inv1   g76(.a(x19), .O(new_n125_));
  nor2   g77(.a(new_n125_), .b(x17), .O(new_n126_));
  nand4  g78(.a(new_n126_), .b(new_n118_), .c(new_n80_), .d(new_n116_), .O(new_n127_));
  aoi21  g79(.a(new_n127_), .b(new_n124_), .c(new_n74_), .O(z17));
  zero   g80(.O(z00));
  zero   g81(.O(z10));
  buf    g82(.a(x27), .O(z08));
endmodule
