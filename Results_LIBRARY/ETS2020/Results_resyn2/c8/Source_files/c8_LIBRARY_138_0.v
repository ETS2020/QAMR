...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n54_, new_n55_, new_n56_,
    new_n58_, new_n59_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_,
    new_n69_, new_n70_, new_n72_, new_n73_, new_n74_, new_n75_, new_n76_,
    new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
    new_n86_, new_n88_, new_n89_, new_n90_, new_n91_, new_n92_, new_n93_,
    new_n94_, new_n96_, new_n97_, new_n98_, new_n99_, new_n100_, new_n104_,
  ...
  aoi21  g33(.a(new_n65_), .b(new_n55_), .c(x16), .O(new_n85_));
  oai21  g34(.a(new_n65_), .b(x03), .c(new_n85_), .O(new_n86_));
  nand2  g35(.a(new_n86_), .b(new_n84_), .O(z12));
  nand2  g36(.a(new_n82_), .b(x23), .O(new_n88_));
  nor2   g37(.a(x23), .b(x22), .O(new_n89_));
  nand3  g38(.a(new_n89_), .b(new_n80_), .c(new_n69_), .O(new_n90_));
  nand2  g39(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(x16), .O(new_n92_));
  aoi21  g41(.a(new_n65_), .b(new_n58_), .c(x16), .O(new_n93_));
  oai21  g42(.a(new_n65_), .b(x04), .c(new_n93_), .O(new_n94_));
  nand2  g43(.a(new_n94_), .b(new_n92_), .O(z13));
  or2    g44(.a(new_n90_), .b(x24), .O(new_n96_));
  aoi21  g45(.a(new_n90_), .b(x24), .c(new_n68_), .O(new_n97_));
  inv1   g46(.a(x13), .O(new_n98_));
  oai21  g47(.a(x18), .b(new_n98_), .c(new_n68_), .O(new_n99_));
  aoi21  g48(.a(x18), .b(x05), .c(new_n99_), .O(new_n100_));
  aoi21  g49(.a(new_n97_), .b(new_n96_), .c(new_n100_), .O(z14));
  nand2  g50(.a(x27), .b(x17), .O(new_n104_));
  nor3   g51(.a(x26), .b(x25), .c(x24), .O(new_n105_));
  nor2   g52(.a(new_n47_), .b(x17), .O(new_n106_));
  nand4  g53(.a(new_n106_), .b(new_n105_), .c(new_n89_), .d(new_n80_), .O(new_n107_));
