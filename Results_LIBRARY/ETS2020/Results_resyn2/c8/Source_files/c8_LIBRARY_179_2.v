...
module FAU ( 
  ...
  aoi21  g24(.a(new_n70_), .b(new_n50_), .c(x16), .O(new_n77_));
  ...
  aoi21  g32(.a(new_n70_), .b(new_n53_), .c(x16), .O(new_n85_));
  ...
  oai21  g46(.a(x18), .b(new_n57_), .c(new_n66_), .O(new_n99_));
  ...
  aoi21  g54(.a(new_n70_), .b(new_n61_), .c(x16), .O(new_n108_));
  oai21  g55(.a(new_n70_), .b(x07), .c(new_n108_), .O(new_n109_));
  oai21  g56(.a(new_n107_), .b(new_n106_), .c(new_n109_), .O(z16));
  zero   g57(.O(z00));
  zero   g58(.O(z01));
  zero   g59(.O(z04));
  zero   g60(.O(z06));
