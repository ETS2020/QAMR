...
module FAU ( 
  ...
  aoi21  g24(.a(new_n69_), .b(new_n54_), .c(x16), .O(new_n76_));
  ...
  aoi21  g35(.a(new_n69_), .b(new_n60_), .c(x16), .O(new_n90_));
  ...
  inv1   g40(.a(x15), .O(new_n95_));
  oai21  g41(.a(x18), .b(new_n95_), .c(new_n65_), .O(new_n96_));
  aoi21  g42(.a(x18), .b(x07), .c(new_n96_), .O(new_n97_));
  aoi21  g43(.a(new_n94_), .b(new_n93_), .c(new_n97_), .O(z16));
  inv1   g44(.a(x17), .O(new_n99_));
  nor2   g45(.a(x26), .b(new_n47_), .O(new_n100_));
  nand4  g46(.a(new_n100_), .b(new_n86_), .c(new_n82_), .d(new_n74_), .O(new_n101_));
