...
module FAU ( 
  ...
  oai21  g23(.a(x18), .b(x09), .c(new_n73_), .O(new_n74_));
  oai21  g24(.a(new_n74_), .b(new_n72_), .c(new_n70_), .O(z10));
  ...
  aoi21  g28(.a(new_n71_), .b(new_n52_), .c(x16), .O(new_n79_));
  oai21  g29(.a(new_n71_), .b(x02), .c(new_n79_), .O(new_n80_));
  oai21  g30(.a(new_n78_), .b(new_n73_), .c(new_n80_), .O(z11));
  ...
  oai21  g36(.a(x18), .b(x12), .c(new_n73_), .O(new_n88_));
  ...
  aoi21  g49(.a(new_n95_), .b(x26), .c(new_n73_), .O(new_n102_));
  oai21  g50(.a(x18), .b(new_n62_), .c(new_n73_), .O(new_n103_));
