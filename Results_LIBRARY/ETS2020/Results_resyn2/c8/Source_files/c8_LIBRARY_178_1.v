...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n54_, new_n55_, new_n57_, new_n58_, new_n60_,
  ...
  and2   g04(.a(x27), .b(x13), .O(new_n55_));
  aoi21  g05(.a(new_n54_), .b(x24), .c(new_n55_), .O(z05));
  inv1   g06(.a(x14), .O(new_n57_));
  nor2   g07(.a(new_n54_), .b(new_n57_), .O(new_n58_));
  aoi21  g08(.a(new_n54_), .b(x25), .c(new_n58_), .O(z06));
  inv1   g09(.a(x15), .O(new_n60_));
  nor2   g10(.a(new_n54_), .b(new_n60_), .O(new_n61_));
  aoi21  g11(.a(new_n54_), .b(x26), .c(new_n61_), .O(z07));
