// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:43 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n33_), .b(new_n40_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g24(.a(new_n26_), .b(new_n33_), .c(new_n40_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n28_), .O(z14));
  nor2   g26(.a(new_n50_), .b(new_n31_), .O(z15));
  zero   g27(.O(z01));
  zero   g28(.O(z05));
  zero   g29(.O(z09));
  zero   g30(.O(z13));
