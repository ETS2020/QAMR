...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n28_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n36_, new_n41_, new_n42_, new_n45_;
  ...
  nand2  g18(.a(new_n32_), .b(new_n41_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g20(.a(new_n45_), .b(new_n36_), .O(z14));
  nor2   g21(.a(new_n45_), .b(new_n30_), .O(z15));
  zero   g22(.O(z01));
  zero   g23(.O(z05));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
