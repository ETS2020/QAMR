// Benchmark "FAU" written by ABC on Fri Jul 24 21:43:02 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n39_, new_n40_, new_n43_, new_n46_;
  ...
  nor2   g16(.a(new_n40_), .b(new_n29_), .O(z10));
  nand3  g17(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n40_), .O(z11));
  nand2  g19(.a(new_n33_), .b(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n26_), .O(z13));
