...
module FAU ( 
  ...
  nor2   g14(.a(new_n40_), .b(new_n26_), .O(z09));
  nor2   g15(.a(new_n40_), .b(new_n30_), .O(z11));
  nand2  g16(.a(new_n33_), .b(new_n39_), .O(new_n44_));
  nor2   g17(.a(new_n44_), .b(new_n23_), .O(z12));
  nor2   g18(.a(new_n44_), .b(new_n26_), .O(z13));
  nor2   g19(.a(new_n44_), .b(new_n30_), .O(z15));
  zero   g20(.O(z02));
  zero   g21(.O(z04));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
