// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:26 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n37_, new_n40_, new_n41_, new_n45_;
  ...
  nand3  g14(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n37_));
