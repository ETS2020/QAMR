...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n44_, new_n46_;
  ...
  nand3  g20(.a(x4), .b(new_n29_), .c(x2), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n44_), .O(z13));
  nor2   g22(.a(new_n44_), .b(new_n27_), .O(z14));
  nor2   g23(.a(new_n44_), .b(new_n30_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z05));
  zero   g26(.O(z09));
  zero   g27(.O(z11));
