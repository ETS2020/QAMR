// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:05 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n40_, new_n41_, new_n44_, new_n49_;
  ...
  nand3  g19(.a(new_n26_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n28_), .O(z10));
  nor2   g21(.a(new_n44_), .b(new_n31_), .O(z11));
  nand3  g22(.a(new_n26_), .b(new_n33_), .c(new_n40_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n28_), .O(z14));
  nor2   g24(.a(new_n49_), .b(new_n31_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z05));
  zero   g27(.O(z09));
  zero   g28(.O(z12));
