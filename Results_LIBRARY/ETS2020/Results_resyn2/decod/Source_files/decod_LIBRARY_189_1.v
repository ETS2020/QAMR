...
module FAU ( 
  ...
  nand3  g12(.a(new_n35_), .b(new_n30_), .c(x0), .O(new_n36_));
  nor2   g13(.a(new_n36_), .b(new_n34_), .O(z06));
  nand2  g14(.a(x4), .b(new_n25_), .O(new_n38_));
  ...
  nand3  g19(.a(new_n35_), .b(x1), .c(new_n41_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n34_), .O(z10));
  nor2   g21(.a(new_n44_), .b(new_n38_), .O(z11));
  nand2  g22(.a(new_n30_), .b(new_n41_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  nor2   g24(.a(new_n47_), .b(new_n26_), .O(z13));
  nand3  g25(.a(new_n35_), .b(new_n30_), .c(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n34_), .O(z14));
