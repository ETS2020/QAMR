...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_,
    new_n32_, new_n34_, new_n35_, new_n40_, new_n41_, new_n48_;
  ...
  nor2   g15(.a(new_n35_), .b(new_n30_), .O(z06));
  nor2   g16(.a(new_n35_), .b(new_n32_), .O(z07));
  ...
  nor2   g22(.a(new_n48_), .b(new_n30_), .O(z14));
  nor2   g23(.a(new_n48_), .b(new_n32_), .O(z15));
  zero   g24(.O(z05));
  zero   g25(.O(z09));
  zero   g26(.O(z11));
  zero   g27(.O(z12));
