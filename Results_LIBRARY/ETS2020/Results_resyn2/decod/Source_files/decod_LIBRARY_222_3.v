// Benchmark "FAU" written by ABC on Fri Jul 24 21:43:07 2020
...
module FAU ( 
  ...
  nand2  g23(.a(x1), .b(new_n41_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n30_), .O(z10));
  nor2   g25(.a(new_n45_), .b(new_n32_), .O(z11));
  nand3  g26(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n48_));
  nor2   g27(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g28(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g29(.a(new_n34_), .b(new_n41_), .O(new_n51_));
  nor2   g30(.a(new_n51_), .b(new_n30_), .O(z14));
  zero   g31(.O(z15));
endmodule
