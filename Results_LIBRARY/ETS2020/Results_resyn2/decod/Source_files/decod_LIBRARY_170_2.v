// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:50 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n36_, new_n39_, new_n40_, new_n45_;
  ...
  nor2   g18(.a(new_n40_), .b(new_n30_), .O(z11));
  nand2  g19(.a(new_n33_), .b(new_n39_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g21(.a(new_n45_), .b(new_n26_), .O(z13));
