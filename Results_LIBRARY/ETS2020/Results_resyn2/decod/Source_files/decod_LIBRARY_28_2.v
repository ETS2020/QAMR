// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:04 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n39_, new_n40_, new_n44_;
  ...
  nor2   g16(.a(new_n40_), .b(new_n30_), .O(z11));
  nand2  g17(.a(new_n33_), .b(new_n39_), .O(new_n44_));
