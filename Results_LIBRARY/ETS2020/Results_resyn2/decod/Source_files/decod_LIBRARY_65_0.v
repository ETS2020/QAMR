...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n35_, new_n39_, new_n40_, new_n47_;
  ...
  nor2   g19(.a(new_n40_), .b(new_n27_), .O(z10));
  nand2  g20(.a(new_n32_), .b(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n27_), .O(z14));
  nor2   g22(.a(new_n47_), .b(new_n30_), .O(z15));
  zero   g23(.O(z01));
  zero   g24(.O(z09));
  zero   g25(.O(z11));
  zero   g26(.O(z12));
