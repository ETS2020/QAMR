// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:12 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n39_, new_n40_, new_n42_, new_n45_;
  ...
  nand3  g17(.a(x4), .b(x3), .c(new_n29_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n40_), .O(z10));
  nor2   g19(.a(new_n40_), .b(new_n30_), .O(z11));
  nand2  g20(.a(new_n32_), .b(new_n39_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n45_), .b(new_n26_), .O(z13));
  nor2   g23(.a(new_n45_), .b(new_n30_), .O(z15));
  zero   g24(.O(z02));
  zero   g25(.O(z06));
  zero   g26(.O(z08));
  zero   g27(.O(z14));
