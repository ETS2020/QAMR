...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n38_, new_n39_, new_n44_, new_n47_;
  ...
  nand3  g20(.a(x4), .b(x3), .c(new_n29_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n44_), .O(z14));
  nor2   g22(.a(new_n44_), .b(new_n30_), .O(z15));
  zero   g23(.O(z02));
  zero   g24(.O(z04));
  zero   g25(.O(z06));
  zero   g26(.O(z07));
