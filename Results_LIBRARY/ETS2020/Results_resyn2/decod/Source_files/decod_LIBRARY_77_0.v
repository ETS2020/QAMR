...
module FAU ( 
  ...
  nand2  g17(.a(new_n32_), .b(new_n38_), .O(new_n45_));
  nand3  g18(.a(x4), .b(new_n29_), .c(x2), .O(new_n46_));
  nor2   g19(.a(new_n46_), .b(new_n45_), .O(z13));
  nor2   g20(.a(new_n45_), .b(new_n27_), .O(z14));
