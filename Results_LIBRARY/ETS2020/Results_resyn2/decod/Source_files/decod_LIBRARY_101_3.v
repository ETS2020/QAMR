// Benchmark "FAU" written by ABC on Fri Jul 24 21:42:28 2020
...
module FAU ( 
  ...
  nor2   g17(.a(new_n40_), .b(new_n34_), .O(z08));
  nor2   g18(.a(new_n40_), .b(new_n25_), .O(z09));
  nor2   g19(.a(new_n40_), .b(new_n28_), .O(z10));
  nor2   g20(.a(new_n40_), .b(new_n30_), .O(z11));
  nand2  g21(.a(new_n32_), .b(new_n39_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n34_), .O(z12));
  nor2   g23(.a(new_n45_), .b(new_n25_), .O(z13));
  nor2   g24(.a(new_n45_), .b(new_n28_), .O(z14));
  zero   g25(.O(z00));
  zero   g26(.O(z07));
  zero   g27(.O(z15));
endmodule
