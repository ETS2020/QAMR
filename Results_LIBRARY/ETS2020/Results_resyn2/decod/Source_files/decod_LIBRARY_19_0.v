...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n45_, new_n46_;
  ...
  nand2  g18(.a(new_n32_), .b(new_n38_), .O(new_n45_));
  nand3  g19(.a(x4), .b(new_n29_), .c(x2), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n45_), .O(z13));
  nor2   g21(.a(new_n45_), .b(new_n27_), .O(z14));
