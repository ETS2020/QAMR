...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n33_,
    new_n34_, new_n38_, new_n39_, new_n42_, new_n45_;
  ...
  nor2   g18(.a(new_n42_), .b(new_n39_), .O(z10));
  nor2   g19(.a(new_n39_), .b(new_n30_), .O(z11));
  nand2  g20(.a(new_n33_), .b(new_n38_), .O(new_n45_));
