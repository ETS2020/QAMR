...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n36_,
    new_n37_, new_n41_, new_n42_, new_n46_;
  ...
  nor2   g13(.a(new_n37_), .b(new_n27_), .O(z10));
  inv1   g14(.a(x3), .O(new_n41_));
  nand3  g15(.a(x4), .b(new_n41_), .c(new_n26_), .O(new_n42_));
  nor2   g16(.a(new_n42_), .b(new_n37_), .O(z11));
  nand2  g17(.a(new_n30_), .b(new_n36_), .O(new_n46_));
  nor2   g18(.a(new_n46_), .b(new_n27_), .O(z14));
  nor2   g19(.a(new_n46_), .b(new_n42_), .O(z15));
  zero   g20(.O(z01));
  zero   g21(.O(z03));
  zero   g22(.O(z05));
  zero   g23(.O(z07));
