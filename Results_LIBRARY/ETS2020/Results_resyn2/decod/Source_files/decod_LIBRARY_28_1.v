...
module FAU ( 
  ...
  nor2   g24(.a(new_n45_), .b(new_n39_), .O(z11));
  nand3  g25(.a(x2), .b(new_n33_), .c(new_n41_), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g27(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g28(.a(new_n33_), .b(new_n41_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n30_), .O(z14));
  nor2   g30(.a(new_n51_), .b(new_n39_), .O(z15));
  zero   g31(.O(z03));
endmodule
