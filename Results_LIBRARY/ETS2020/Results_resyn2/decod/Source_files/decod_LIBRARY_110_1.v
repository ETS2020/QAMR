...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n37_, new_n39_, new_n40_, new_n46_;
  ...
  nor2   g21(.a(new_n40_), .b(new_n37_), .O(z11));
  nand2  g22(.a(new_n32_), .b(new_n39_), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z13));
  nor2   g24(.a(new_n46_), .b(new_n29_), .O(z14));
  nor2   g25(.a(new_n46_), .b(new_n37_), .O(z15));
  zero   g26(.O(z03));
  zero   g27(.O(z12));
endmodule
