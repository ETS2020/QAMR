// Benchmark "FAU" written by ABC on Fri Jul 24 21:41:55 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n40_, new_n41_, new_n45_;
  ...
  nor2   g20(.a(new_n41_), .b(new_n31_), .O(z11));
  nand2  g21(.a(new_n33_), .b(new_n40_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n45_), .b(new_n26_), .O(z13));
  nor2   g24(.a(new_n45_), .b(new_n29_), .O(z14));
  nor2   g25(.a(new_n45_), .b(new_n31_), .O(z15));
  zero   g26(.O(z07));
  zero   g27(.O(z08));
endmodule
