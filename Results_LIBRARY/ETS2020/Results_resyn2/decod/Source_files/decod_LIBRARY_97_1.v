...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n39_, new_n40_, new_n44_, new_n46_, new_n47_, new_n49_,
    new_n51_;
  ...
  nand2  g19(.a(new_n25_), .b(x2), .O(new_n46_));
  nand3  g20(.a(x4), .b(new_n33_), .c(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n46_), .O(z13));
  nand2  g22(.a(x3), .b(new_n28_), .O(new_n49_));
  nor2   g23(.a(new_n47_), .b(new_n49_), .O(z14));
  nand2  g24(.a(new_n25_), .b(new_n28_), .O(new_n51_));
