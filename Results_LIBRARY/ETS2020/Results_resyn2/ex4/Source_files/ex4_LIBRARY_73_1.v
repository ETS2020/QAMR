// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:40 2020
...
module FAU ( 
  ...
  oai21  g187(.a(x074), .b(x050), .c(new_n182_), .O(new_n347_));
  nor2   g188(.a(new_n174_), .b(new_n173_), .O(new_n348_));
  oai22  g189(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n349_));
  ...
  oai21  g194(.a(x075), .b(x051), .c(new_n197_), .O(new_n354_));
  nor2   g195(.a(new_n189_), .b(new_n188_), .O(new_n355_));
  oai22  g196(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n356_));
