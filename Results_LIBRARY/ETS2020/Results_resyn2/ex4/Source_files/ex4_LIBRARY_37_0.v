...
module FAU ( 
  ...
  oai22  g052(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n214_));
  nand3  g053(.a(new_n214_), .b(x065), .c(x017), .O(new_n215_));
  oai22  g054(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n216_));
  and2   g055(.a(x081), .b(x001), .O(new_n217_));
