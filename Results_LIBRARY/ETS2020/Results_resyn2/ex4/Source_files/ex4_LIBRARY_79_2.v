...
module FAU ( 
  ...
  oai21  g174(.a(x074), .b(x050), .c(new_n180_), .O(new_n335_));
  nor2   g175(.a(new_n172_), .b(new_n171_), .O(new_n336_));
  oai22  g176(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n337_));
  aoi21  g177(.a(new_n336_), .b(new_n335_), .c(new_n337_), .O(new_n338_));
  aoi21  g178(.a(new_n338_), .b(new_n334_), .c(x042), .O(z10));
  oai22  g179(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n340_));
  nand3  g180(.a(new_n340_), .b(x083), .c(x003), .O(new_n341_));
  oai22  g181(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n342_));
  and2   g182(.a(x067), .b(x019), .O(new_n343_));
  nand2  g183(.a(x075), .b(x011), .O(new_n344_));
  nand2  g184(.a(x051), .b(x035), .O(new_n345_));
  nand2  g185(.a(new_n345_), .b(new_n344_), .O(new_n346_));
  aoi21  g186(.a(new_n343_), .b(new_n342_), .c(new_n346_), .O(new_n347_));
  aoi21  g187(.a(new_n347_), .b(new_n341_), .c(x043), .O(z11));
  oai22  g188(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n349_));
  nand3  g189(.a(new_n349_), .b(x068), .c(x020), .O(new_n350_));
  oai21  g190(.a(x076), .b(x052), .c(new_n196_), .O(new_n351_));
  nor2   g191(.a(new_n188_), .b(new_n187_), .O(new_n352_));
  oai22  g192(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n353_));
