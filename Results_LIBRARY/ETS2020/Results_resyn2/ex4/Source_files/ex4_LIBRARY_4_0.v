// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:42 2020
...
module FAU ( 
  ...
  oai22  g104(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n265_));
  nand3  g105(.a(new_n265_), .b(x065), .c(x017), .O(new_n266_));
  oai21  g106(.a(x073), .b(x049), .c(new_n183_), .O(new_n267_));
  nor2   g107(.a(new_n175_), .b(new_n174_), .O(new_n268_));
  oai22  g108(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n269_));
  aoi21  g109(.a(new_n268_), .b(new_n267_), .c(new_n269_), .O(new_n270_));
  aoi21  g110(.a(new_n270_), .b(new_n266_), .c(x041), .O(z09));
  ...
  and2   g114(.a(x067), .b(x019), .O(new_n276_));
  nand2  g115(.a(x075), .b(x011), .O(new_n277_));
  nand2  g116(.a(x051), .b(x035), .O(new_n278_));
  nand2  g117(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  aoi21  g118(.a(new_n276_), .b(new_n275_), .c(new_n279_), .O(new_n280_));
  aoi21  g119(.a(new_n280_), .b(new_n274_), .c(x043), .O(z11));
  zero   g120(.O(z03));
  zero   g121(.O(z05));
  zero   g122(.O(z06));
  zero   g123(.O(z07));
