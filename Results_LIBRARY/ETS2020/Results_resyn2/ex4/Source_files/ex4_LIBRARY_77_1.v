...
module FAU ( 
  ...
  oai22  g150(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n312_));
  nand3  g151(.a(new_n312_), .b(x081), .c(x001), .O(new_n313_));
  oai22  g152(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n314_));
  and2   g153(.a(x065), .b(x017), .O(new_n315_));
  nand2  g154(.a(x073), .b(x009), .O(new_n316_));
  nand2  g155(.a(x049), .b(x033), .O(new_n317_));
  nand2  g156(.a(new_n317_), .b(new_n316_), .O(new_n318_));
  aoi21  g157(.a(new_n315_), .b(new_n314_), .c(new_n318_), .O(new_n319_));
  aoi21  g158(.a(new_n319_), .b(new_n313_), .c(x041), .O(z09));
  oai22  g159(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n321_));
  nand3  g160(.a(new_n321_), .b(x082), .c(x002), .O(new_n322_));
  oai22  g161(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n323_));
  and2   g162(.a(x066), .b(x018), .O(new_n324_));
  nand2  g163(.a(x074), .b(x010), .O(new_n325_));
  nand2  g164(.a(x050), .b(x034), .O(new_n326_));
  nand2  g165(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  aoi21  g166(.a(new_n324_), .b(new_n323_), .c(new_n327_), .O(new_n328_));
  aoi21  g167(.a(new_n328_), .b(new_n322_), .c(x042), .O(z10));
  oai22  g168(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n330_));
  nand3  g169(.a(new_n330_), .b(x067), .c(x019), .O(new_n331_));
  oai21  g170(.a(x075), .b(x051), .c(new_n169_), .O(new_n332_));
  nor2   g171(.a(new_n161_), .b(new_n160_), .O(new_n333_));
  oai22  g172(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n334_));
  aoi21  g173(.a(new_n333_), .b(new_n332_), .c(new_n334_), .O(new_n335_));
  aoi21  g174(.a(new_n335_), .b(new_n331_), .c(x043), .O(z11));
  oai22  g175(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n337_));
  nand3  g176(.a(new_n337_), .b(x068), .c(x020), .O(new_n338_));
  oai21  g177(.a(x076), .b(x052), .c(new_n184_), .O(new_n339_));
  nor2   g178(.a(new_n176_), .b(new_n175_), .O(new_n340_));
  oai22  g179(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n341_));
  aoi21  g180(.a(new_n340_), .b(new_n339_), .c(new_n341_), .O(new_n342_));
  aoi21  g181(.a(new_n342_), .b(new_n338_), .c(x044), .O(z12));
