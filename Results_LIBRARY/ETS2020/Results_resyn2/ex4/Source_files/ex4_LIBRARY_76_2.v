...
module FAU ( 
  ...
  oai22  g202(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n364_));
  nand3  g203(.a(new_n364_), .b(x082), .c(x002), .O(new_n365_));
  oai22  g204(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n366_));
  and2   g205(.a(x066), .b(x018), .O(new_n367_));
  nand2  g206(.a(x074), .b(x010), .O(new_n368_));
  nand2  g207(.a(x050), .b(x034), .O(new_n369_));
  nand2  g208(.a(new_n369_), .b(new_n368_), .O(new_n370_));
  aoi21  g209(.a(new_n367_), .b(new_n366_), .c(new_n370_), .O(new_n371_));
  aoi21  g210(.a(new_n371_), .b(new_n365_), .c(x042), .O(z10));
