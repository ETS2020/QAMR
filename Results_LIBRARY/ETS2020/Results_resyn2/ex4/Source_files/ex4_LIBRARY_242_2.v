// Benchmark "FAU" written by ABC on Sat Jul 25 09:21:01 2020
...
module FAU ( 
  ...
  oai22  g249(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n408_));
  nand3  g250(.a(new_n408_), .b(x084), .c(x004), .O(new_n409_));
  oai22  g251(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n410_));
  and2   g252(.a(x068), .b(x020), .O(new_n411_));
  nand2  g253(.a(x076), .b(x012), .O(new_n412_));
  nand2  g254(.a(x052), .b(x036), .O(new_n413_));
  nand2  g255(.a(new_n413_), .b(new_n412_), .O(new_n414_));
  aoi21  g256(.a(new_n411_), .b(new_n410_), .c(new_n414_), .O(new_n415_));
  aoi21  g257(.a(new_n415_), .b(new_n409_), .c(x044), .O(z12));
