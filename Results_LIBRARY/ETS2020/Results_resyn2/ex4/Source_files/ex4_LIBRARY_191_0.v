// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:18 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n215_, new_n216_, new_n217_, new_n218_, new_n223_, new_n224_,
  ...
  oai22  g108(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n269_));
  nand3  g109(.a(new_n269_), .b(x081), .c(x001), .O(new_n270_));
  oai22  g110(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n271_));
  and2   g111(.a(x065), .b(x017), .O(new_n272_));
  nand2  g112(.a(x073), .b(x009), .O(new_n273_));
  nand2  g113(.a(x049), .b(x033), .O(new_n274_));
  nand2  g114(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  aoi21  g115(.a(new_n272_), .b(new_n271_), .c(new_n275_), .O(new_n276_));
  aoi21  g116(.a(new_n276_), .b(new_n270_), .c(x041), .O(z09));
  oai22  g117(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n278_));
  nand3  g118(.a(new_n278_), .b(x066), .c(x018), .O(new_n279_));
  oai21  g119(.a(x074), .b(x050), .c(new_n184_), .O(new_n280_));
  nor2   g120(.a(new_n176_), .b(new_n175_), .O(new_n281_));
  oai22  g121(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n282_));
  ...
  oai21  g126(.a(x075), .b(x051), .c(new_n199_), .O(new_n287_));
  nor2   g127(.a(new_n191_), .b(new_n190_), .O(new_n288_));
  oai22  g128(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n289_));
  ...
  nand3  g132(.a(new_n292_), .b(x068), .c(x020), .O(new_n293_));
  oai21  g133(.a(x076), .b(x052), .c(new_n214_), .O(new_n294_));
  nor2   g134(.a(new_n206_), .b(new_n205_), .O(new_n295_));
  oai22  g135(.a(new_n210_), .b(new_n207_), .c(new_n209_), .d(new_n208_), .O(new_n296_));
  aoi21  g136(.a(new_n295_), .b(new_n294_), .c(new_n296_), .O(new_n297_));
  aoi21  g137(.a(new_n297_), .b(new_n293_), .c(x044), .O(z12));
  zero   g138(.O(z01));
  zero   g139(.O(z05));
  zero   g140(.O(z06));
  zero   g141(.O(z07));
