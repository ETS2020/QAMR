// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:34 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n313_, new_n314_, new_n315_, new_n316_, new_n324_, new_n325_,
  ...
  inv1   g159(.a(x077), .O(new_n324_));
  nand2  g160(.a(new_n208_), .b(new_n203_), .O(new_n325_));
  nand2  g161(.a(new_n325_), .b(new_n212_), .O(new_n326_));
  nor2   g162(.a(x117), .b(x109), .O(new_n327_));
  aoi21  g163(.a(new_n327_), .b(new_n326_), .c(x069), .O(new_n328_));
  nor2   g164(.a(x117), .b(x021), .O(new_n329_));
  aoi21  g165(.a(new_n329_), .b(x125), .c(x085), .O(new_n330_));
  nand2  g166(.a(x021), .b(x013), .O(new_n331_));
  oai21  g167(.a(new_n242_), .b(x029), .c(new_n331_), .O(new_n332_));
  oai21  g168(.a(new_n208_), .b(x109), .c(x037), .O(new_n333_));
  nand2  g169(.a(new_n333_), .b(x117), .O(new_n334_));
  inv1   g170(.a(x109), .O(new_n335_));
  oai21  g171(.a(new_n203_), .b(x061), .c(new_n335_), .O(new_n336_));
  nand2  g172(.a(new_n336_), .b(new_n206_), .O(new_n337_));
  nand4  g173(.a(new_n337_), .b(new_n334_), .c(new_n332_), .d(new_n330_), .O(new_n338_));
  oai21  g174(.a(new_n338_), .b(new_n328_), .c(new_n324_), .O(new_n339_));
  nand4  g175(.a(x125), .b(new_n241_), .c(new_n206_), .d(x013), .O(new_n340_));
  aoi21  g176(.a(new_n340_), .b(new_n339_), .c(x053), .O(new_n341_));
  nand3  g177(.a(x085), .b(new_n206_), .c(new_n216_), .O(new_n342_));
  inv1   g178(.a(new_n342_), .O(new_n343_));
  oai21  g179(.a(new_n343_), .b(new_n341_), .c(x005), .O(new_n344_));
  nand2  g180(.a(new_n219_), .b(x029), .O(new_n345_));
  nand2  g181(.a(new_n345_), .b(new_n217_), .O(new_n346_));
  nand2  g182(.a(new_n346_), .b(new_n324_), .O(new_n347_));
  aoi21  g183(.a(new_n347_), .b(new_n216_), .c(new_n327_), .O(new_n348_));
  nor2   g184(.a(new_n221_), .b(x021), .O(new_n349_));
  oai21  g185(.a(new_n349_), .b(new_n242_), .c(x069), .O(new_n350_));
  nand4  g186(.a(new_n331_), .b(new_n325_), .c(new_n219_), .d(x029), .O(new_n351_));
  aoi21  g187(.a(new_n351_), .b(new_n350_), .c(x077), .O(new_n352_));
  oai21  g188(.a(new_n352_), .b(new_n348_), .c(new_n200_), .O(new_n353_));
  aoi21  g189(.a(x021), .b(x013), .c(new_n221_), .O(new_n354_));
  nor2   g190(.a(x077), .b(new_n206_), .O(new_n355_));
  oai21  g191(.a(new_n354_), .b(new_n242_), .c(new_n355_), .O(new_n356_));
  nand2  g192(.a(new_n356_), .b(new_n353_), .O(new_n357_));
  oai22  g193(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n358_));
  nand3  g194(.a(new_n358_), .b(x069), .c(x021), .O(new_n359_));
  aoi22  g195(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n360_));
  nand2  g196(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  aoi21  g197(.a(new_n357_), .b(new_n215_), .c(new_n361_), .O(new_n362_));
  aoi21  g198(.a(new_n362_), .b(new_n344_), .c(x045), .O(z13));
  nand2  g199(.a(new_n267_), .b(new_n263_), .O(new_n364_));
  nand2  g200(.a(new_n364_), .b(new_n301_), .O(new_n365_));
  nor2   g201(.a(x118), .b(x110), .O(new_n366_));
  aoi21  g202(.a(new_n366_), .b(new_n365_), .c(x070), .O(new_n367_));
  nor2   g203(.a(x118), .b(x022), .O(new_n368_));
  aoi21  g204(.a(new_n368_), .b(x126), .c(x086), .O(new_n369_));
  nand2  g205(.a(x022), .b(x014), .O(new_n370_));
  oai21  g206(.a(new_n302_), .b(x030), .c(new_n370_), .O(new_n371_));
  oai21  g207(.a(new_n267_), .b(x110), .c(x038), .O(new_n372_));
  nand2  g208(.a(new_n372_), .b(x118), .O(new_n373_));
  oai21  g209(.a(new_n263_), .b(x062), .c(new_n260_), .O(new_n374_));
  nand2  g210(.a(new_n374_), .b(new_n266_), .O(new_n375_));
  nand4  g211(.a(new_n375_), .b(new_n373_), .c(new_n371_), .d(new_n369_), .O(new_n376_));
  oai21  g212(.a(new_n376_), .b(new_n367_), .c(new_n295_), .O(new_n377_));
  nand4  g213(.a(x126), .b(new_n300_), .c(new_n266_), .d(x014), .O(new_n378_));
  aoi21  g214(.a(new_n378_), .b(new_n377_), .c(x054), .O(new_n379_));
  nand3  g215(.a(x086), .b(new_n266_), .c(new_n276_), .O(new_n380_));
  inv1   g216(.a(new_n380_), .O(new_n381_));
  oai21  g217(.a(new_n381_), .b(new_n379_), .c(x006), .O(new_n382_));
  nand2  g218(.a(new_n279_), .b(x030), .O(new_n383_));
  nand2  g219(.a(new_n383_), .b(new_n277_), .O(new_n384_));
  nand2  g220(.a(new_n384_), .b(new_n295_), .O(new_n385_));
  aoi21  g221(.a(new_n385_), .b(new_n276_), .c(new_n366_), .O(new_n386_));
  nor2   g222(.a(new_n299_), .b(x022), .O(new_n387_));
  oai21  g223(.a(new_n387_), .b(new_n302_), .c(x070), .O(new_n388_));
  nand4  g224(.a(new_n370_), .b(new_n364_), .c(new_n279_), .d(x030), .O(new_n389_));
  aoi21  g225(.a(new_n389_), .b(new_n388_), .c(x078), .O(new_n390_));
  oai21  g226(.a(new_n390_), .b(new_n386_), .c(new_n259_), .O(new_n391_));
  nand2  g227(.a(new_n370_), .b(x030), .O(new_n392_));
  nand2  g228(.a(new_n392_), .b(new_n291_), .O(new_n393_));
  nand3  g229(.a(new_n393_), .b(new_n295_), .c(x038), .O(new_n394_));
  nand2  g230(.a(new_n394_), .b(new_n391_), .O(new_n395_));
  oai22  g231(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n396_));
  nand3  g232(.a(new_n396_), .b(x070), .c(x022), .O(new_n397_));
  nand2  g233(.a(x078), .b(x014), .O(new_n398_));
  nand3  g234(.a(new_n398_), .b(new_n397_), .c(new_n310_), .O(new_n399_));
  aoi21  g235(.a(new_n395_), .b(new_n275_), .c(new_n399_), .O(new_n400_));
  aoi21  g236(.a(new_n400_), .b(new_n382_), .c(x046), .O(z14));
  zero   g237(.O(z00));
  zero   g238(.O(z02));
  zero   g239(.O(z07));
  zero   g240(.O(z08));
