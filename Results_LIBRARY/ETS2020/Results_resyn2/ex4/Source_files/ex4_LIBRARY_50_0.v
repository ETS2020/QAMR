...
module FAU ( 
  ...
  inv1   g151(.a(x077), .O(new_n311_));
  inv1   g152(.a(x093), .O(new_n312_));
  inv1   g153(.a(x101), .O(new_n313_));
  inv1   g154(.a(x125), .O(new_n314_));
  nand2  g155(.a(new_n314_), .b(new_n313_), .O(new_n315_));
  nand2  g156(.a(new_n315_), .b(new_n312_), .O(new_n316_));
  nor2   g157(.a(x117), .b(x109), .O(new_n317_));
  aoi21  g158(.a(new_n317_), .b(new_n316_), .c(x069), .O(new_n318_));
  nor2   g159(.a(x117), .b(x021), .O(new_n319_));
  aoi21  g160(.a(new_n319_), .b(x125), .c(x085), .O(new_n320_));
  nand2  g161(.a(x021), .b(x013), .O(new_n321_));
  inv1   g162(.a(x061), .O(new_n322_));
  nand2  g163(.a(new_n312_), .b(new_n322_), .O(new_n323_));
  oai21  g164(.a(new_n323_), .b(x029), .c(new_n321_), .O(new_n324_));
  oai21  g165(.a(new_n314_), .b(x109), .c(x037), .O(new_n325_));
  nand2  g166(.a(new_n325_), .b(x117), .O(new_n326_));
  inv1   g167(.a(x037), .O(new_n327_));
  inv1   g168(.a(x109), .O(new_n328_));
  oai21  g169(.a(new_n313_), .b(x061), .c(new_n328_), .O(new_n329_));
  nand2  g170(.a(new_n329_), .b(new_n327_), .O(new_n330_));
  nand4  g171(.a(new_n330_), .b(new_n326_), .c(new_n324_), .d(new_n320_), .O(new_n331_));
  oai21  g172(.a(new_n331_), .b(new_n318_), .c(new_n311_), .O(new_n332_));
  nand4  g173(.a(x125), .b(new_n322_), .c(new_n327_), .d(x013), .O(new_n333_));
  aoi21  g174(.a(new_n333_), .b(new_n332_), .c(x053), .O(new_n334_));
  inv1   g175(.a(x013), .O(new_n335_));
  nand3  g176(.a(x085), .b(new_n327_), .c(new_n335_), .O(new_n336_));
  inv1   g177(.a(new_n336_), .O(new_n337_));
  oai21  g178(.a(new_n337_), .b(new_n334_), .c(x005), .O(new_n338_));
  inv1   g179(.a(x085), .O(new_n339_));
  inv1   g180(.a(x053), .O(new_n340_));
  inv1   g181(.a(x029), .O(new_n341_));
  aoi21  g182(.a(x093), .b(x061), .c(new_n341_), .O(new_n342_));
  oai21  g183(.a(new_n342_), .b(x021), .c(new_n311_), .O(new_n343_));
  aoi21  g184(.a(new_n343_), .b(new_n335_), .c(new_n317_), .O(new_n344_));
  nor2   g185(.a(new_n341_), .b(x021), .O(new_n345_));
  oai21  g186(.a(new_n345_), .b(new_n323_), .c(x069), .O(new_n346_));
  aoi21  g187(.a(x021), .b(x013), .c(new_n341_), .O(new_n347_));
  nand2  g188(.a(x093), .b(x061), .O(new_n348_));
  nand3  g189(.a(new_n348_), .b(new_n347_), .c(new_n315_), .O(new_n349_));
  aoi21  g190(.a(new_n349_), .b(new_n346_), .c(x077), .O(new_n350_));
  oai21  g191(.a(new_n350_), .b(new_n344_), .c(new_n340_), .O(new_n351_));
  nor2   g192(.a(x077), .b(new_n327_), .O(new_n352_));
  oai21  g193(.a(new_n323_), .b(new_n347_), .c(new_n352_), .O(new_n353_));
  nand2  g194(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  oai22  g195(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n355_));
  nand3  g196(.a(new_n355_), .b(x069), .c(x021), .O(new_n356_));
  aoi22  g197(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n357_));
  nand2  g198(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  aoi21  g199(.a(new_n354_), .b(new_n339_), .c(new_n358_), .O(new_n359_));
  aoi21  g200(.a(new_n359_), .b(new_n338_), .c(x045), .O(z13));
  zero   g201(.O(z05));
  zero   g202(.O(z06));
  zero   g203(.O(z07));
  zero   g204(.O(z14));
