// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:18 2020
...
module FAU ( 
  ...
  oai22  g202(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n363_));
  nand3  g203(.a(new_n363_), .b(x081), .c(x001), .O(new_n364_));
  oai22  g204(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n365_));
  and2   g205(.a(x065), .b(x017), .O(new_n366_));
  nand2  g206(.a(x073), .b(x009), .O(new_n367_));
  nand2  g207(.a(x049), .b(x033), .O(new_n368_));
  nand2  g208(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  aoi21  g209(.a(new_n366_), .b(new_n365_), .c(new_n369_), .O(new_n370_));
  aoi21  g210(.a(new_n370_), .b(new_n364_), .c(x041), .O(z09));
  oai22  g211(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n373_));
  nand3  g212(.a(new_n373_), .b(x067), .c(x019), .O(new_n374_));
  oai21  g213(.a(x075), .b(x051), .c(new_n169_), .O(new_n375_));
  nor2   g214(.a(new_n161_), .b(new_n160_), .O(new_n376_));
  oai22  g215(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n377_));
  aoi21  g216(.a(new_n376_), .b(new_n375_), .c(new_n377_), .O(new_n378_));
  aoi21  g217(.a(new_n378_), .b(new_n374_), .c(x043), .O(z11));
  oai22  g218(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n380_));
  nand3  g219(.a(new_n380_), .b(x068), .c(x020), .O(new_n381_));
  oai21  g220(.a(x076), .b(x052), .c(new_n184_), .O(new_n382_));
  nor2   g221(.a(new_n176_), .b(new_n175_), .O(new_n383_));
  oai22  g222(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n384_));
  aoi21  g223(.a(new_n383_), .b(new_n382_), .c(new_n384_), .O(new_n385_));
  aoi21  g224(.a(new_n385_), .b(new_n381_), .c(x044), .O(z12));
