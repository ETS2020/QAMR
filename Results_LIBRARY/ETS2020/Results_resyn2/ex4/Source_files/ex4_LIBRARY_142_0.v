...
module FAU ( 
  ...
  oai22  g108(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n270_));
  nand3  g109(.a(new_n270_), .b(x066), .c(x018), .O(new_n271_));
  oai21  g110(.a(x074), .b(x050), .c(new_n184_), .O(new_n272_));
  nor2   g111(.a(new_n176_), .b(new_n175_), .O(new_n273_));
  oai22  g112(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n274_));
  aoi21  g113(.a(new_n273_), .b(new_n272_), .c(new_n274_), .O(new_n275_));
  aoi21  g114(.a(new_n275_), .b(new_n271_), .c(x042), .O(z10));
  oai22  g115(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n277_));
  nand3  g116(.a(new_n277_), .b(x067), .c(x019), .O(new_n278_));
  oai21  g117(.a(x075), .b(x051), .c(new_n199_), .O(new_n279_));
  nor2   g118(.a(new_n191_), .b(new_n190_), .O(new_n280_));
  oai22  g119(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n281_));
  ...
  oai21  g124(.a(x076), .b(x052), .c(new_n214_), .O(new_n286_));
  nor2   g125(.a(new_n206_), .b(new_n205_), .O(new_n287_));
  oai22  g126(.a(new_n210_), .b(new_n207_), .c(new_n209_), .d(new_n208_), .O(new_n288_));
