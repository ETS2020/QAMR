// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:21 2020
...
module FAU ( 
  ...
  inv1   g216(.a(x077), .O(new_n379_));
  nand2  g217(.a(new_n198_), .b(new_n193_), .O(new_n380_));
  nand2  g218(.a(new_n380_), .b(new_n202_), .O(new_n381_));
  nor2   g219(.a(x117), .b(x109), .O(new_n382_));
  aoi21  g220(.a(new_n382_), .b(new_n381_), .c(x069), .O(new_n383_));
  nor2   g221(.a(x117), .b(x021), .O(new_n384_));
  aoi21  g222(.a(new_n384_), .b(x125), .c(x085), .O(new_n385_));
  nand2  g223(.a(x021), .b(x013), .O(new_n386_));
  oai21  g224(.a(new_n232_), .b(x029), .c(new_n386_), .O(new_n387_));
  oai21  g225(.a(new_n198_), .b(x109), .c(x037), .O(new_n388_));
  nand2  g226(.a(new_n388_), .b(x117), .O(new_n389_));
  inv1   g227(.a(x109), .O(new_n390_));
  oai21  g228(.a(new_n193_), .b(x061), .c(new_n390_), .O(new_n391_));
  nand2  g229(.a(new_n391_), .b(new_n196_), .O(new_n392_));
  nand4  g230(.a(new_n392_), .b(new_n389_), .c(new_n387_), .d(new_n385_), .O(new_n393_));
  oai21  g231(.a(new_n393_), .b(new_n383_), .c(new_n379_), .O(new_n394_));
  nand4  g232(.a(x125), .b(new_n231_), .c(new_n196_), .d(x013), .O(new_n395_));
  aoi21  g233(.a(new_n395_), .b(new_n394_), .c(x053), .O(new_n396_));
  nand3  g234(.a(x085), .b(new_n196_), .c(new_n206_), .O(new_n397_));
  inv1   g235(.a(new_n397_), .O(new_n398_));
  oai21  g236(.a(new_n398_), .b(new_n396_), .c(x005), .O(new_n399_));
  nand2  g237(.a(new_n209_), .b(x029), .O(new_n400_));
  nand2  g238(.a(new_n400_), .b(new_n207_), .O(new_n401_));
  nand2  g239(.a(new_n401_), .b(new_n379_), .O(new_n402_));
  aoi21  g240(.a(new_n402_), .b(new_n206_), .c(new_n382_), .O(new_n403_));
  nor2   g241(.a(new_n211_), .b(x021), .O(new_n404_));
  oai21  g242(.a(new_n404_), .b(new_n232_), .c(x069), .O(new_n405_));
  nand4  g243(.a(new_n386_), .b(new_n380_), .c(new_n209_), .d(x029), .O(new_n406_));
  aoi21  g244(.a(new_n406_), .b(new_n405_), .c(x077), .O(new_n407_));
  oai21  g245(.a(new_n407_), .b(new_n403_), .c(new_n190_), .O(new_n408_));
  aoi21  g246(.a(x021), .b(x013), .c(new_n211_), .O(new_n409_));
  nor2   g247(.a(x077), .b(new_n196_), .O(new_n410_));
  oai21  g248(.a(new_n409_), .b(new_n232_), .c(new_n410_), .O(new_n411_));
  nand2  g249(.a(new_n411_), .b(new_n408_), .O(new_n412_));
  oai22  g250(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n413_));
  nand3  g251(.a(new_n413_), .b(x069), .c(x021), .O(new_n414_));
  aoi22  g252(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n415_));
  nand2  g253(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  aoi21  g254(.a(new_n412_), .b(new_n205_), .c(new_n416_), .O(new_n417_));
  aoi21  g255(.a(new_n417_), .b(new_n399_), .c(x045), .O(z13));
  nand2  g256(.a(new_n257_), .b(new_n253_), .O(new_n419_));
  nand2  g257(.a(new_n419_), .b(new_n291_), .O(new_n420_));
  nor2   g258(.a(x118), .b(x110), .O(new_n421_));
  aoi21  g259(.a(new_n421_), .b(new_n420_), .c(x070), .O(new_n422_));
  nor2   g260(.a(x118), .b(x022), .O(new_n423_));
  aoi21  g261(.a(new_n423_), .b(x126), .c(x086), .O(new_n424_));
  nand2  g262(.a(x022), .b(x014), .O(new_n425_));
  oai21  g263(.a(new_n292_), .b(x030), .c(new_n425_), .O(new_n426_));
  oai21  g264(.a(new_n257_), .b(x110), .c(x038), .O(new_n427_));
  nand2  g265(.a(new_n427_), .b(x118), .O(new_n428_));
  oai21  g266(.a(new_n253_), .b(x062), .c(new_n250_), .O(new_n429_));
  nand2  g267(.a(new_n429_), .b(new_n256_), .O(new_n430_));
  nand4  g268(.a(new_n430_), .b(new_n428_), .c(new_n426_), .d(new_n424_), .O(new_n431_));
  oai21  g269(.a(new_n431_), .b(new_n422_), .c(new_n285_), .O(new_n432_));
  nand4  g270(.a(x126), .b(new_n290_), .c(new_n256_), .d(x014), .O(new_n433_));
  aoi21  g271(.a(new_n433_), .b(new_n432_), .c(x054), .O(new_n434_));
  nand3  g272(.a(x086), .b(new_n256_), .c(new_n266_), .O(new_n435_));
  inv1   g273(.a(new_n435_), .O(new_n436_));
  oai21  g274(.a(new_n436_), .b(new_n434_), .c(x006), .O(new_n437_));
  nand2  g275(.a(new_n269_), .b(x030), .O(new_n438_));
  nand2  g276(.a(new_n438_), .b(new_n267_), .O(new_n439_));
  nand2  g277(.a(new_n439_), .b(new_n285_), .O(new_n440_));
  aoi21  g278(.a(new_n440_), .b(new_n266_), .c(new_n421_), .O(new_n441_));
  nor2   g279(.a(new_n289_), .b(x022), .O(new_n442_));
  oai21  g280(.a(new_n442_), .b(new_n292_), .c(x070), .O(new_n443_));
  nand4  g281(.a(new_n425_), .b(new_n419_), .c(new_n269_), .d(x030), .O(new_n444_));
  aoi21  g282(.a(new_n444_), .b(new_n443_), .c(x078), .O(new_n445_));
  oai21  g283(.a(new_n445_), .b(new_n441_), .c(new_n249_), .O(new_n446_));
  nand2  g284(.a(new_n425_), .b(x030), .O(new_n447_));
  nand2  g285(.a(new_n447_), .b(new_n281_), .O(new_n448_));
  nand3  g286(.a(new_n448_), .b(new_n285_), .c(x038), .O(new_n449_));
  nand2  g287(.a(new_n449_), .b(new_n446_), .O(new_n450_));
  oai22  g288(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n451_));
  nand3  g289(.a(new_n451_), .b(x070), .c(x022), .O(new_n452_));
  nand2  g290(.a(x078), .b(x014), .O(new_n453_));
  nand3  g291(.a(new_n453_), .b(new_n452_), .c(new_n300_), .O(new_n454_));
  aoi21  g292(.a(new_n450_), .b(new_n265_), .c(new_n454_), .O(new_n455_));
  aoi21  g293(.a(new_n455_), .b(new_n437_), .c(x046), .O(z14));
  zero   g294(.O(z00));
  zero   g295(.O(z01));
  zero   g296(.O(z04));
  zero   g297(.O(z07));
