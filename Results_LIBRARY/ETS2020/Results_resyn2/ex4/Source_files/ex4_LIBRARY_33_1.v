// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:06 2020
...
module FAU ( 
  ...
  oai22  g239(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n399_));
  nand3  g240(.a(new_n399_), .b(x067), .c(x019), .O(new_n400_));
  oai21  g241(.a(x075), .b(x051), .c(new_n209_), .O(new_n401_));
  nor2   g242(.a(new_n201_), .b(new_n200_), .O(new_n402_));
  oai22  g243(.a(new_n205_), .b(new_n202_), .c(new_n204_), .d(new_n203_), .O(new_n403_));
  aoi21  g244(.a(new_n402_), .b(new_n401_), .c(new_n403_), .O(new_n404_));
  aoi21  g245(.a(new_n404_), .b(new_n400_), .c(x043), .O(z11));
  oai22  g246(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n406_));
  nand3  g247(.a(new_n406_), .b(x068), .c(x020), .O(new_n407_));
  oai21  g248(.a(x076), .b(x052), .c(new_n224_), .O(new_n408_));
  nor2   g249(.a(new_n216_), .b(new_n215_), .O(new_n409_));
  oai22  g250(.a(new_n220_), .b(new_n217_), .c(new_n219_), .d(new_n218_), .O(new_n410_));
  aoi21  g251(.a(new_n409_), .b(new_n408_), .c(new_n410_), .O(new_n411_));
  aoi21  g252(.a(new_n411_), .b(new_n407_), .c(x044), .O(z12));
