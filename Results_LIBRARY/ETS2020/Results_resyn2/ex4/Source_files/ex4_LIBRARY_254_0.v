...
module FAU ( 
  ...
  nand2  g27(.a(x034), .b(x010), .O(new_n184_));
  nand2  g28(.a(x074), .b(x050), .O(new_n185_));
  nand2  g29(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nor2   g30(.a(x082), .b(x002), .O(new_n187_));
  nand2  g31(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g32(.a(x050), .b(x010), .O(new_n189_));
  nand2  g33(.a(x074), .b(x034), .O(new_n190_));
  nand2  g34(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nor2   g35(.a(x066), .b(x018), .O(new_n192_));
  ...
  oai22  g52(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n215_));
  nand3  g53(.a(new_n215_), .b(x082), .c(x002), .O(new_n216_));
  oai22  g54(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n217_));
  and2   g55(.a(x066), .b(x018), .O(new_n218_));
  nand2  g56(.a(x050), .b(x034), .O(new_n219_));
  nand2  g57(.a(x074), .b(x010), .O(new_n220_));
  nand2  g58(.a(new_n220_), .b(new_n219_), .O(new_n221_));
  aoi21  g59(.a(new_n218_), .b(new_n217_), .c(new_n221_), .O(new_n222_));
  aoi21  g60(.a(new_n222_), .b(new_n216_), .c(x042), .O(z10));
  oai22  g61(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n224_));
  nand3  g62(.a(new_n224_), .b(x083), .c(x003), .O(new_n225_));
  oai22  g63(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n226_));
  and2   g64(.a(x067), .b(x019), .O(new_n227_));
  nand2  g65(.a(x051), .b(x035), .O(new_n228_));
  nand2  g66(.a(x075), .b(x011), .O(new_n229_));
  nand2  g67(.a(new_n229_), .b(new_n228_), .O(new_n230_));
  aoi21  g68(.a(new_n227_), .b(new_n226_), .c(new_n230_), .O(new_n231_));
  aoi21  g69(.a(new_n231_), .b(new_n225_), .c(x043), .O(z11));
  zero   g70(.O(z04));
  zero   g71(.O(z05));
  zero   g72(.O(z06));
  zero   g73(.O(z07));
