// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:47 2020
...
module FAU ( 
  ...
  inv1   g039(.a(x004), .O(new_n197_));
  inv1   g040(.a(x084), .O(new_n198_));
  inv1   g041(.a(x012), .O(new_n199_));
  inv1   g042(.a(x036), .O(new_n200_));
  inv1   g043(.a(x052), .O(new_n201_));
  inv1   g044(.a(x076), .O(new_n202_));
  oai22  g045(.a(new_n202_), .b(new_n201_), .c(new_n200_), .d(new_n199_), .O(new_n203_));
  nand3  g046(.a(new_n203_), .b(new_n198_), .c(new_n197_), .O(new_n204_));
  nand3  g047(.a(new_n202_), .b(new_n201_), .c(x036), .O(new_n205_));
  nand2  g048(.a(new_n200_), .b(new_n199_), .O(new_n206_));
  nor2   g049(.a(x068), .b(x020), .O(new_n207_));
  nand3  g050(.a(new_n207_), .b(new_n206_), .c(new_n205_), .O(new_n208_));
  aoi22  g051(.a(new_n202_), .b(new_n199_), .c(new_n201_), .d(new_n200_), .O(new_n209_));
  nand3  g052(.a(new_n209_), .b(new_n208_), .c(new_n204_), .O(new_n210_));
  and2   g053(.a(new_n210_), .b(x044), .O(z04));
  ...
  oai22  g174(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n337_));
  nand3  g175(.a(new_n337_), .b(x068), .c(x020), .O(new_n338_));
  oai21  g176(.a(x076), .b(x052), .c(new_n206_), .O(new_n339_));
  nor2   g177(.a(new_n198_), .b(new_n197_), .O(new_n340_));
  oai22  g178(.a(new_n202_), .b(new_n199_), .c(new_n201_), .d(new_n200_), .O(new_n341_));
  aoi21  g179(.a(new_n340_), .b(new_n339_), .c(new_n341_), .O(new_n342_));
  aoi21  g180(.a(new_n342_), .b(new_n338_), .c(x044), .O(z12));
