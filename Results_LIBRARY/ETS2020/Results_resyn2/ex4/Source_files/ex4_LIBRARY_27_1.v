...
module FAU ( 
  ...
  oai21  g176(.a(x075), .b(x051), .c(new_n193_), .O(new_n338_));
  nor2   g177(.a(new_n185_), .b(new_n184_), .O(new_n339_));
  oai22  g178(.a(new_n189_), .b(new_n186_), .c(new_n188_), .d(new_n187_), .O(new_n340_));
