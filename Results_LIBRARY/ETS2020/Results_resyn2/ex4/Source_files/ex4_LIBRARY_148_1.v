...
module FAU ( 
  ...
  oai22  g170(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n332_));
  nand3  g171(.a(new_n332_), .b(x083), .c(x003), .O(new_n333_));
  oai22  g172(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n334_));
  and2   g173(.a(x067), .b(x019), .O(new_n335_));
  nand2  g174(.a(x075), .b(x011), .O(new_n336_));
  nand2  g175(.a(x051), .b(x035), .O(new_n337_));
  nand2  g176(.a(new_n337_), .b(new_n336_), .O(new_n338_));
  aoi21  g177(.a(new_n335_), .b(new_n334_), .c(new_n338_), .O(new_n339_));
  aoi21  g178(.a(new_n339_), .b(new_n333_), .c(x043), .O(z11));
  oai22  g179(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n341_));
  nand3  g180(.a(new_n341_), .b(x068), .c(x020), .O(new_n342_));
  oai21  g181(.a(x076), .b(x052), .c(new_n194_), .O(new_n343_));
  nor2   g182(.a(new_n186_), .b(new_n185_), .O(new_n344_));
  oai22  g183(.a(new_n190_), .b(new_n187_), .c(new_n189_), .d(new_n188_), .O(new_n345_));
