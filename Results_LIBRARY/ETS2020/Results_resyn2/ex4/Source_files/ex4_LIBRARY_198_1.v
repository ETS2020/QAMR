...
module FAU ( 
  ...
  oai22  g216(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(x083), .c(x003), .O(new_n378_));
  oai22  g218(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n379_));
  and2   g219(.a(x067), .b(x019), .O(new_n380_));
  nand2  g220(.a(x075), .b(x011), .O(new_n381_));
  nand2  g221(.a(x051), .b(x035), .O(new_n382_));
  nand2  g222(.a(new_n382_), .b(new_n381_), .O(new_n383_));
  aoi21  g223(.a(new_n380_), .b(new_n379_), .c(new_n383_), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n378_), .c(x043), .O(z11));
  oai22  g225(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n386_));
  nand3  g226(.a(new_n386_), .b(x084), .c(x004), .O(new_n387_));
  oai22  g227(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n388_));
  and2   g228(.a(x068), .b(x020), .O(new_n389_));
  nand2  g229(.a(x076), .b(x012), .O(new_n390_));
  nand2  g230(.a(x052), .b(x036), .O(new_n391_));
  nand2  g231(.a(new_n391_), .b(new_n390_), .O(new_n392_));
  aoi21  g232(.a(new_n389_), .b(new_n388_), .c(new_n392_), .O(new_n393_));
  aoi21  g233(.a(new_n393_), .b(new_n387_), .c(x044), .O(z12));
