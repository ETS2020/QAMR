...
module FAU ( 
  ...
  inv1   g018(.a(x084), .O(new_n178_));
  inv1   g019(.a(x012), .O(new_n179_));
  inv1   g020(.a(x036), .O(new_n180_));
  inv1   g021(.a(x052), .O(new_n181_));
  inv1   g022(.a(x076), .O(new_n182_));
  oai22  g023(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n179_), .O(new_n183_));
  nand3  g024(.a(new_n183_), .b(new_n178_), .c(new_n177_), .O(new_n184_));
  nand3  g025(.a(new_n182_), .b(new_n181_), .c(x036), .O(new_n185_));
  nand2  g026(.a(new_n180_), .b(new_n179_), .O(new_n186_));
  nor2   g027(.a(x068), .b(x020), .O(new_n187_));
  nand3  g028(.a(new_n187_), .b(new_n186_), .c(new_n185_), .O(new_n188_));
  aoi22  g029(.a(new_n182_), .b(new_n179_), .c(new_n181_), .d(new_n180_), .O(new_n189_));
  nand3  g030(.a(new_n189_), .b(new_n188_), .c(new_n184_), .O(new_n190_));
  and2   g031(.a(new_n190_), .b(x044), .O(z04));
  ...
  nand3  g217(.a(new_n378_), .b(x068), .c(x020), .O(new_n379_));
  oai21  g218(.a(x076), .b(x052), .c(new_n186_), .O(new_n380_));
  nor2   g219(.a(new_n178_), .b(new_n177_), .O(new_n381_));
  oai22  g220(.a(new_n182_), .b(new_n179_), .c(new_n181_), .d(new_n180_), .O(new_n382_));
  aoi21  g221(.a(new_n381_), .b(new_n380_), .c(new_n382_), .O(new_n383_));
  aoi21  g222(.a(new_n383_), .b(new_n379_), .c(x044), .O(z12));
