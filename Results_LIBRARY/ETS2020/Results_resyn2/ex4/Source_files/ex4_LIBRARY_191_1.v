...
module FAU ( 
  ...
  nand3  g214(.a(new_n375_), .b(x067), .c(x019), .O(new_n376_));
  oai21  g215(.a(x075), .b(x051), .c(new_n193_), .O(new_n377_));
  nor2   g216(.a(new_n185_), .b(new_n184_), .O(new_n378_));
  oai22  g217(.a(new_n189_), .b(new_n186_), .c(new_n188_), .d(new_n187_), .O(new_n379_));
  aoi21  g218(.a(new_n378_), .b(new_n377_), .c(new_n379_), .O(new_n380_));
  aoi21  g219(.a(new_n380_), .b(new_n376_), .c(x043), .O(z11));
  oai22  g220(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n382_));
  nand3  g221(.a(new_n382_), .b(x084), .c(x004), .O(new_n383_));
  oai22  g222(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n384_));
  and2   g223(.a(x068), .b(x020), .O(new_n385_));
  nand2  g224(.a(x076), .b(x012), .O(new_n386_));
  nand2  g225(.a(x052), .b(x036), .O(new_n387_));
  nand2  g226(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  aoi21  g227(.a(new_n385_), .b(new_n384_), .c(new_n388_), .O(new_n389_));
  aoi21  g228(.a(new_n389_), .b(new_n383_), .c(x044), .O(z12));
