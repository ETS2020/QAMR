...
module FAU ( 
  ...
  oai22  g148(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n311_));
  nand3  g149(.a(new_n311_), .b(x066), .c(x018), .O(new_n312_));
  oai21  g150(.a(x074), .b(x050), .c(new_n168_), .O(new_n313_));
  nor2   g151(.a(new_n160_), .b(new_n159_), .O(new_n314_));
  oai22  g152(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n315_));
  aoi21  g153(.a(new_n314_), .b(new_n313_), .c(new_n315_), .O(new_n316_));
  aoi21  g154(.a(new_n316_), .b(new_n312_), .c(x042), .O(z10));
