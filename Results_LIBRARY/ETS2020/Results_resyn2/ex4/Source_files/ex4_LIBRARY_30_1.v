// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:03 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n331_, new_n332_, new_n333_, new_n334_, new_n339_, new_n340_,
  ...
  oai22  g178(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n339_));
  nand3  g179(.a(new_n339_), .b(x066), .c(x018), .O(new_n340_));
  oai21  g180(.a(x074), .b(x050), .c(new_n180_), .O(new_n341_));
  nor2   g181(.a(new_n172_), .b(new_n171_), .O(new_n342_));
  oai22  g182(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n343_));
  aoi21  g183(.a(new_n342_), .b(new_n341_), .c(new_n343_), .O(new_n344_));
  aoi21  g184(.a(new_n344_), .b(new_n340_), .c(x042), .O(z10));
  oai22  g185(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n346_));
  nand3  g186(.a(new_n346_), .b(x067), .c(x019), .O(new_n347_));
  oai21  g187(.a(x075), .b(x051), .c(new_n195_), .O(new_n348_));
  nor2   g188(.a(new_n187_), .b(new_n186_), .O(new_n349_));
  oai22  g189(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n350_));
  ...
  oai21  g194(.a(x076), .b(x052), .c(new_n210_), .O(new_n355_));
  nor2   g195(.a(new_n202_), .b(new_n201_), .O(new_n356_));
  oai22  g196(.a(new_n206_), .b(new_n203_), .c(new_n205_), .d(new_n204_), .O(new_n357_));
