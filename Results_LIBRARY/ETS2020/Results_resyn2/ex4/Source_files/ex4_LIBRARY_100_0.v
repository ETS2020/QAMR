...
module FAU ( 
  ...
  oai21  g108(.a(x075), .b(x051), .c(new_n197_), .O(new_n271_));
  nor2   g109(.a(new_n189_), .b(new_n188_), .O(new_n272_));
  oai22  g110(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n273_));
  ...
  oai21  g115(.a(x076), .b(x052), .c(new_n212_), .O(new_n278_));
  nor2   g116(.a(new_n204_), .b(new_n203_), .O(new_n279_));
  oai22  g117(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n280_));
  aoi21  g118(.a(new_n279_), .b(new_n278_), .c(new_n280_), .O(new_n281_));
  aoi21  g119(.a(new_n281_), .b(new_n277_), .c(x044), .O(z12));
  zero   g120(.O(z01));
  zero   g121(.O(z05));
  zero   g122(.O(z06));
  zero   g123(.O(z07));
