...
module FAU ( 
  ...
  oai22  g163(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n324_));
  nand3  g164(.a(new_n324_), .b(x081), .c(x001), .O(new_n325_));
  oai22  g165(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n326_));
  and2   g166(.a(x065), .b(x017), .O(new_n327_));
  nand2  g167(.a(x073), .b(x009), .O(new_n328_));
  nand2  g168(.a(x049), .b(x033), .O(new_n329_));
  nand2  g169(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  aoi21  g170(.a(new_n327_), .b(new_n326_), .c(new_n330_), .O(new_n331_));
  aoi21  g171(.a(new_n331_), .b(new_n325_), .c(x041), .O(z09));
  oai22  g172(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n333_));
  nand3  g173(.a(new_n333_), .b(x066), .c(x018), .O(new_n334_));
  oai21  g174(.a(x074), .b(x050), .c(new_n168_), .O(new_n335_));
  nor2   g175(.a(new_n160_), .b(new_n159_), .O(new_n336_));
  oai22  g176(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n337_));
  aoi21  g177(.a(new_n336_), .b(new_n335_), .c(new_n337_), .O(new_n338_));
  aoi21  g178(.a(new_n338_), .b(new_n334_), .c(x042), .O(z10));
  oai22  g179(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n340_));
  nand3  g180(.a(new_n340_), .b(x067), .c(x019), .O(new_n341_));
  oai21  g181(.a(x075), .b(x051), .c(new_n183_), .O(new_n342_));
  nor2   g182(.a(new_n175_), .b(new_n174_), .O(new_n343_));
  oai22  g183(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n344_));
