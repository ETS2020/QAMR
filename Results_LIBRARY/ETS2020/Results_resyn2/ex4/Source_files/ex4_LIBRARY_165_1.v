// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:57 2020
...
module FAU ( 
  ...
  oai21  g187(.a(x074), .b(x050), .c(new_n180_), .O(new_n347_));
  nor2   g188(.a(new_n172_), .b(new_n171_), .O(new_n348_));
  oai22  g189(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n349_));
