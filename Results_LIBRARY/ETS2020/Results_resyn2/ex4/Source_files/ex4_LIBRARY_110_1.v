...
module FAU ( 
  ...
  inv1   g028(.a(x004), .O(new_n187_));
  inv1   g029(.a(x084), .O(new_n188_));
  inv1   g030(.a(x012), .O(new_n189_));
  inv1   g031(.a(x036), .O(new_n190_));
  inv1   g032(.a(x052), .O(new_n191_));
  inv1   g033(.a(x076), .O(new_n192_));
  oai22  g034(.a(new_n192_), .b(new_n191_), .c(new_n190_), .d(new_n189_), .O(new_n193_));
  nand3  g035(.a(new_n193_), .b(new_n188_), .c(new_n187_), .O(new_n194_));
  nand3  g036(.a(new_n192_), .b(new_n191_), .c(x036), .O(new_n195_));
  nand2  g037(.a(new_n190_), .b(new_n189_), .O(new_n196_));
  nor2   g038(.a(x068), .b(x020), .O(new_n197_));
  nand3  g039(.a(new_n197_), .b(new_n196_), .c(new_n195_), .O(new_n198_));
  aoi22  g040(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n199_));
  nand3  g041(.a(new_n199_), .b(new_n198_), .c(new_n194_), .O(new_n200_));
  and2   g042(.a(new_n200_), .b(x044), .O(z04));
  ...
  oai22  g215(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n377_));
  nand3  g216(.a(new_n377_), .b(x067), .c(x019), .O(new_n378_));
  oai21  g217(.a(x075), .b(x051), .c(new_n181_), .O(new_n379_));
  nor2   g218(.a(new_n173_), .b(new_n172_), .O(new_n380_));
  oai22  g219(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n381_));
  aoi21  g220(.a(new_n380_), .b(new_n379_), .c(new_n381_), .O(new_n382_));
  aoi21  g221(.a(new_n382_), .b(new_n378_), .c(x043), .O(z11));
  oai22  g222(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n384_));
  nand3  g223(.a(new_n384_), .b(x068), .c(x020), .O(new_n385_));
  oai21  g224(.a(x076), .b(x052), .c(new_n196_), .O(new_n386_));
  nor2   g225(.a(new_n188_), .b(new_n187_), .O(new_n387_));
  oai22  g226(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n388_));
  aoi21  g227(.a(new_n387_), .b(new_n386_), .c(new_n388_), .O(new_n389_));
  aoi21  g228(.a(new_n389_), .b(new_n385_), .c(x044), .O(z12));
