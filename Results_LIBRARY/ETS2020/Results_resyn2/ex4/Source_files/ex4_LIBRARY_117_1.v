// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:17 2020
...
module FAU ( 
  ...
  wire new_n159_, new_n160_, new_n161_, new_n162_, new_n163_, new_n164_,
    ...
    new_n319_, new_n320_, new_n325_, new_n326_, new_n327_, new_n328_,
  ...
  oai22  g163(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n325_));
  nand3  g164(.a(new_n325_), .b(x066), .c(x018), .O(new_n326_));
  oai21  g165(.a(x074), .b(x050), .c(new_n168_), .O(new_n327_));
  nor2   g166(.a(new_n160_), .b(new_n159_), .O(new_n328_));
  oai22  g167(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n329_));
  aoi21  g168(.a(new_n328_), .b(new_n327_), .c(new_n329_), .O(new_n330_));
  aoi21  g169(.a(new_n330_), .b(new_n326_), .c(x042), .O(z10));
  oai22  g170(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n332_));
  nand3  g171(.a(new_n332_), .b(x067), .c(x019), .O(new_n333_));
  oai21  g172(.a(x075), .b(x051), .c(new_n183_), .O(new_n334_));
  nor2   g173(.a(new_n175_), .b(new_n174_), .O(new_n335_));
  oai22  g174(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n336_));
