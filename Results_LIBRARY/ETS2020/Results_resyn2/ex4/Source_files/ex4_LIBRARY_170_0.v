...
module FAU ( 
  ...
  oai22  g122(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n283_));
  nand3  g123(.a(new_n283_), .b(x083), .c(x003), .O(new_n284_));
  oai22  g124(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n285_));
  and2   g125(.a(x067), .b(x019), .O(new_n286_));
  nand2  g126(.a(x075), .b(x011), .O(new_n287_));
  nand2  g127(.a(x051), .b(x035), .O(new_n288_));
  nand2  g128(.a(new_n288_), .b(new_n287_), .O(new_n289_));
  aoi21  g129(.a(new_n286_), .b(new_n285_), .c(new_n289_), .O(new_n290_));
  aoi21  g130(.a(new_n290_), .b(new_n284_), .c(x043), .O(z11));
