// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:10 2020
...
module FAU ( 
  ...
  wire new_n159_, new_n160_, new_n161_, new_n162_, new_n163_, new_n164_,
    ...
    new_n197_, new_n198_, new_n199_, new_n200_, new_n205_, new_n206_,
  ...
  and2   g098(.a(x065), .b(x017), .O(new_n260_));
  nand2  g099(.a(x073), .b(x009), .O(new_n261_));
  nand2  g100(.a(x049), .b(x033), .O(new_n262_));
  nand2  g101(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  aoi21  g102(.a(new_n260_), .b(new_n259_), .c(new_n263_), .O(new_n264_));
  aoi21  g103(.a(new_n264_), .b(new_n258_), .c(x041), .O(z09));
  oai22  g104(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n266_));
  nand3  g105(.a(new_n266_), .b(x066), .c(x018), .O(new_n267_));
  oai21  g106(.a(x074), .b(x050), .c(new_n168_), .O(new_n268_));
  nor2   g107(.a(new_n160_), .b(new_n159_), .O(new_n269_));
  oai22  g108(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n270_));
  ...
  oai21  g113(.a(x075), .b(x051), .c(new_n183_), .O(new_n275_));
  nor2   g114(.a(new_n175_), .b(new_n174_), .O(new_n276_));
  oai22  g115(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n277_));
