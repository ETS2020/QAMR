...
module FAU ( 
  ...
  oai21  g150(.a(x074), .b(x050), .c(new_n180_), .O(new_n313_));
  nor2   g151(.a(new_n172_), .b(new_n171_), .O(new_n314_));
  oai22  g152(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n315_));
