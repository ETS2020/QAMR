...
module FAU ( 
  ...
  oai21  g228(.a(x074), .b(x050), .c(new_n184_), .O(new_n388_));
  nor2   g229(.a(new_n176_), .b(new_n175_), .O(new_n389_));
  oai22  g230(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n390_));
