...
module FAU ( 
  ...
  nand2  g40(.a(x036), .b(x012), .O(new_n198_));
  nand2  g41(.a(x076), .b(x052), .O(new_n199_));
  nand2  g42(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nor2   g43(.a(x084), .b(x004), .O(new_n201_));
  nand2  g44(.a(new_n201_), .b(new_n200_), .O(new_n202_));
  nand2  g45(.a(x052), .b(x012), .O(new_n203_));
  nand2  g46(.a(x076), .b(x036), .O(new_n204_));
  nand2  g47(.a(new_n204_), .b(new_n203_), .O(new_n205_));
  nor2   g48(.a(x068), .b(x020), .O(new_n206_));
  ...
  oai22  g52(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n216_));
  nand3  g53(.a(new_n216_), .b(x083), .c(x003), .O(new_n217_));
  oai22  g54(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n218_));
  and2   g55(.a(x067), .b(x019), .O(new_n219_));
  nand2  g56(.a(x051), .b(x035), .O(new_n220_));
  nand2  g57(.a(x075), .b(x011), .O(new_n221_));
  nand2  g58(.a(new_n221_), .b(new_n220_), .O(new_n222_));
  aoi21  g59(.a(new_n219_), .b(new_n218_), .c(new_n222_), .O(new_n223_));
  aoi21  g60(.a(new_n223_), .b(new_n217_), .c(x043), .O(z11));
  oai22  g61(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n225_));
  nand3  g62(.a(new_n225_), .b(x084), .c(x004), .O(new_n226_));
  oai22  g63(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n227_));
  and2   g64(.a(x068), .b(x020), .O(new_n228_));
  nand2  g65(.a(x052), .b(x036), .O(new_n229_));
  nand2  g66(.a(x076), .b(x012), .O(new_n230_));
  nand2  g67(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  aoi21  g68(.a(new_n228_), .b(new_n227_), .c(new_n231_), .O(new_n232_));
  aoi21  g69(.a(new_n232_), .b(new_n226_), .c(x044), .O(z12));
  zero   g70(.O(z01));
  zero   g71(.O(z05));
  zero   g72(.O(z06));
  zero   g73(.O(z07));
