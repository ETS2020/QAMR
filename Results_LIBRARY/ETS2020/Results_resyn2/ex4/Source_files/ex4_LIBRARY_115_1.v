...
module FAU ( 
  ...
  oai21  g213(.a(x075), .b(x051), .c(new_n197_), .O(new_n375_));
  nor2   g214(.a(new_n189_), .b(new_n188_), .O(new_n376_));
  oai22  g215(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n377_));
  aoi21  g216(.a(new_n376_), .b(new_n375_), .c(new_n377_), .O(new_n378_));
  aoi21  g217(.a(new_n378_), .b(new_n374_), .c(x043), .O(z11));
  oai22  g218(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n380_));
  nand3  g219(.a(new_n380_), .b(x084), .c(x004), .O(new_n381_));
  oai22  g220(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n382_));
  and2   g221(.a(x068), .b(x020), .O(new_n383_));
  nand2  g222(.a(x076), .b(x012), .O(new_n384_));
  nand2  g223(.a(x052), .b(x036), .O(new_n385_));
  nand2  g224(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  aoi21  g225(.a(new_n383_), .b(new_n382_), .c(new_n386_), .O(new_n387_));
  aoi21  g226(.a(new_n387_), .b(new_n381_), .c(x044), .O(z12));
