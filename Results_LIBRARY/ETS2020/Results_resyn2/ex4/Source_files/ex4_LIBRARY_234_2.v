...
module FAU ( 
  ...
  and2   g234(.a(x067), .b(x019), .O(new_n394_));
  nand2  g235(.a(x075), .b(x011), .O(new_n395_));
  nand2  g236(.a(x051), .b(x035), .O(new_n396_));
  nand2  g237(.a(new_n396_), .b(new_n395_), .O(new_n397_));
  aoi21  g238(.a(new_n394_), .b(new_n393_), .c(new_n397_), .O(new_n398_));
  aoi21  g239(.a(new_n398_), .b(new_n392_), .c(x043), .O(z11));
