...
module FAU ( 
  ...
  oai21  g194(.a(x075), .b(x051), .c(new_n195_), .O(new_n354_));
  nor2   g195(.a(new_n187_), .b(new_n186_), .O(new_n355_));
  oai22  g196(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n356_));
