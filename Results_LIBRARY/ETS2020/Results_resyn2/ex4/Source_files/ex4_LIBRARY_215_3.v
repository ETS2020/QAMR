...
module FAU ( 
  ...
  nand3  g214(.a(new_n374_), .b(x066), .c(x018), .O(new_n375_));
  oai21  g215(.a(x074), .b(x050), .c(new_n184_), .O(new_n376_));
  nor2   g216(.a(new_n176_), .b(new_n175_), .O(new_n377_));
  oai22  g217(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n378_));
  aoi21  g218(.a(new_n377_), .b(new_n376_), .c(new_n378_), .O(new_n379_));
  aoi21  g219(.a(new_n379_), .b(new_n375_), .c(x042), .O(z10));
