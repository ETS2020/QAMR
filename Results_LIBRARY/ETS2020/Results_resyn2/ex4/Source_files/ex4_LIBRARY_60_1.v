// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:29 2020
...
module FAU ( 
  ...
  nand2  g187(.a(new_n210_), .b(new_n205_), .O(new_n349_));
  nand2  g188(.a(new_n349_), .b(new_n214_), .O(new_n350_));
  ...
  oai21  g194(.a(new_n244_), .b(x029), .c(new_n355_), .O(new_n356_));
  oai21  g195(.a(new_n210_), .b(x109), .c(x037), .O(new_n357_));
  nand2  g196(.a(new_n357_), .b(x117), .O(new_n358_));
  inv1   g197(.a(x109), .O(new_n359_));
  oai21  g198(.a(new_n205_), .b(x061), .c(new_n359_), .O(new_n360_));
  nand2  g199(.a(new_n360_), .b(new_n208_), .O(new_n361_));
  ...
  nand4  g202(.a(x125), .b(new_n243_), .c(new_n208_), .d(x013), .O(new_n364_));
  aoi21  g203(.a(new_n364_), .b(new_n363_), .c(x053), .O(new_n365_));
  nand3  g204(.a(x085), .b(new_n208_), .c(new_n218_), .O(new_n366_));
  inv1   g205(.a(new_n366_), .O(new_n367_));
  oai21  g206(.a(new_n367_), .b(new_n365_), .c(x005), .O(new_n368_));
  nand2  g207(.a(new_n221_), .b(x029), .O(new_n369_));
  nand2  g208(.a(new_n369_), .b(new_n219_), .O(new_n370_));
  nand2  g209(.a(new_n370_), .b(new_n348_), .O(new_n371_));
  aoi21  g210(.a(new_n371_), .b(new_n218_), .c(new_n351_), .O(new_n372_));
  nor2   g211(.a(new_n223_), .b(x021), .O(new_n373_));
  oai21  g212(.a(new_n373_), .b(new_n244_), .c(x069), .O(new_n374_));
  nand4  g213(.a(new_n355_), .b(new_n349_), .c(new_n221_), .d(x029), .O(new_n375_));
  aoi21  g214(.a(new_n375_), .b(new_n374_), .c(x077), .O(new_n376_));
  oai21  g215(.a(new_n376_), .b(new_n372_), .c(new_n202_), .O(new_n377_));
  aoi21  g216(.a(x021), .b(x013), .c(new_n223_), .O(new_n378_));
  nor2   g217(.a(x077), .b(new_n208_), .O(new_n379_));
  oai21  g218(.a(new_n378_), .b(new_n244_), .c(new_n379_), .O(new_n380_));
  ...
  aoi21  g224(.a(new_n381_), .b(new_n217_), .c(new_n385_), .O(new_n386_));
  aoi21  g225(.a(new_n386_), .b(new_n368_), .c(x045), .O(z13));
  nand2  g226(.a(new_n269_), .b(new_n265_), .O(new_n388_));
  nand2  g227(.a(new_n388_), .b(new_n303_), .O(new_n389_));
  ...
  oai21  g233(.a(new_n304_), .b(x030), .c(new_n394_), .O(new_n395_));
  oai21  g234(.a(new_n269_), .b(x110), .c(x038), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(x118), .O(new_n397_));
  oai21  g236(.a(new_n265_), .b(x062), .c(new_n262_), .O(new_n398_));
  nand2  g237(.a(new_n398_), .b(new_n268_), .O(new_n399_));
  nand4  g238(.a(new_n399_), .b(new_n397_), .c(new_n395_), .d(new_n393_), .O(new_n400_));
  oai21  g239(.a(new_n400_), .b(new_n391_), .c(new_n297_), .O(new_n401_));
  nand4  g240(.a(x126), .b(new_n302_), .c(new_n268_), .d(x014), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n401_), .c(x054), .O(new_n403_));
  nand3  g242(.a(x086), .b(new_n268_), .c(new_n278_), .O(new_n404_));
  inv1   g243(.a(new_n404_), .O(new_n405_));
  oai21  g244(.a(new_n405_), .b(new_n403_), .c(x006), .O(new_n406_));
  nand2  g245(.a(new_n281_), .b(x030), .O(new_n407_));
  nand2  g246(.a(new_n407_), .b(new_n279_), .O(new_n408_));
  nand2  g247(.a(new_n408_), .b(new_n297_), .O(new_n409_));
  aoi21  g248(.a(new_n409_), .b(new_n278_), .c(new_n390_), .O(new_n410_));
  nor2   g249(.a(new_n301_), .b(x022), .O(new_n411_));
  oai21  g250(.a(new_n411_), .b(new_n304_), .c(x070), .O(new_n412_));
  nand4  g251(.a(new_n394_), .b(new_n388_), .c(new_n281_), .d(x030), .O(new_n413_));
  aoi21  g252(.a(new_n413_), .b(new_n412_), .c(x078), .O(new_n414_));
  oai21  g253(.a(new_n414_), .b(new_n410_), .c(new_n261_), .O(new_n415_));
  nand2  g254(.a(new_n394_), .b(x030), .O(new_n416_));
  nand2  g255(.a(new_n416_), .b(new_n293_), .O(new_n417_));
  nand3  g256(.a(new_n417_), .b(new_n297_), .c(x038), .O(new_n418_));
  ...
  nand3  g261(.a(new_n422_), .b(new_n421_), .c(new_n312_), .O(new_n423_));
  aoi21  g262(.a(new_n419_), .b(new_n277_), .c(new_n423_), .O(new_n424_));
