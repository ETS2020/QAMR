...
module FAU ( 
  ...
  oai22  g207(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n368_));
  nand3  g208(.a(new_n368_), .b(x082), .c(x002), .O(new_n369_));
  oai22  g209(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n370_));
  and2   g210(.a(x066), .b(x018), .O(new_n371_));
  nand2  g211(.a(x074), .b(x010), .O(new_n372_));
  nand2  g212(.a(x050), .b(x034), .O(new_n373_));
  nand2  g213(.a(new_n373_), .b(new_n372_), .O(new_n374_));
  aoi21  g214(.a(new_n371_), .b(new_n370_), .c(new_n374_), .O(new_n375_));
  aoi21  g215(.a(new_n375_), .b(new_n369_), .c(x042), .O(z10));
  oai22  g216(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n377_));
  nand3  g217(.a(new_n377_), .b(x067), .c(x019), .O(new_n378_));
  oai21  g218(.a(x075), .b(x051), .c(new_n185_), .O(new_n379_));
  nor2   g219(.a(new_n177_), .b(new_n176_), .O(new_n380_));
  oai22  g220(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n179_), .O(new_n381_));
  aoi21  g221(.a(new_n380_), .b(new_n379_), .c(new_n381_), .O(new_n382_));
  aoi21  g222(.a(new_n382_), .b(new_n378_), .c(x043), .O(z11));
