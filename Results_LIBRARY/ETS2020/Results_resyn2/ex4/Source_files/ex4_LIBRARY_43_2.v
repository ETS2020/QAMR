// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:14 2020
...
module FAU ( 
  ...
  oai22  g226(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n385_));
  nand3  g227(.a(new_n385_), .b(x081), .c(x001), .O(new_n386_));
  oai22  g228(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n387_));
  and2   g229(.a(x065), .b(x017), .O(new_n388_));
  nand2  g230(.a(x073), .b(x009), .O(new_n389_));
  nand2  g231(.a(x049), .b(x033), .O(new_n390_));
  nand2  g232(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  aoi21  g233(.a(new_n388_), .b(new_n387_), .c(new_n391_), .O(new_n392_));
  aoi21  g234(.a(new_n392_), .b(new_n386_), .c(x041), .O(z09));
  oai22  g235(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n394_));
  nand3  g236(.a(new_n394_), .b(x066), .c(x018), .O(new_n395_));
  oai21  g237(.a(x074), .b(x050), .c(new_n184_), .O(new_n396_));
  nor2   g238(.a(new_n176_), .b(new_n175_), .O(new_n397_));
  oai22  g239(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n398_));
