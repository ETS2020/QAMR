...
module FAU ( 
  ...
  oai22  g205(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n364_));
  nand3  g206(.a(new_n364_), .b(x067), .c(x019), .O(new_n365_));
  oai21  g207(.a(x075), .b(x051), .c(new_n209_), .O(new_n366_));
  nor2   g208(.a(new_n201_), .b(new_n200_), .O(new_n367_));
  oai22  g209(.a(new_n205_), .b(new_n202_), .c(new_n204_), .d(new_n203_), .O(new_n368_));
  aoi21  g210(.a(new_n367_), .b(new_n366_), .c(new_n368_), .O(new_n369_));
  aoi21  g211(.a(new_n369_), .b(new_n365_), .c(x043), .O(z11));
