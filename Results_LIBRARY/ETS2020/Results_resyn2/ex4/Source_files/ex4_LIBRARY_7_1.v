...
module FAU ( 
  ...
  oai22  g163(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n326_));
  nand3  g164(.a(new_n326_), .b(x067), .c(x019), .O(new_n327_));
  oai21  g165(.a(x075), .b(x051), .c(new_n181_), .O(new_n328_));
  nor2   g166(.a(new_n173_), .b(new_n172_), .O(new_n329_));
  oai22  g167(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n330_));
  aoi21  g168(.a(new_n329_), .b(new_n328_), .c(new_n330_), .O(new_n331_));
  aoi21  g169(.a(new_n331_), .b(new_n327_), .c(x043), .O(z11));
  oai22  g170(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n333_));
  nand3  g171(.a(new_n333_), .b(x068), .c(x020), .O(new_n334_));
  oai21  g172(.a(x076), .b(x052), .c(new_n196_), .O(new_n335_));
  nor2   g173(.a(new_n188_), .b(new_n187_), .O(new_n336_));
  oai22  g174(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n337_));
  aoi21  g175(.a(new_n336_), .b(new_n335_), .c(new_n337_), .O(new_n338_));
  aoi21  g176(.a(new_n338_), .b(new_n334_), .c(x044), .O(z12));
