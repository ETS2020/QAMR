...
module FAU ( 
  ...
  oai21  g213(.a(x074), .b(x050), .c(new_n168_), .O(new_n374_));
  nor2   g214(.a(new_n160_), .b(new_n159_), .O(new_n375_));
  oai22  g215(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n376_));
  ...
  nand3  g219(.a(new_n379_), .b(x067), .c(x019), .O(new_n380_));
  oai21  g220(.a(x075), .b(x051), .c(new_n183_), .O(new_n381_));
  nor2   g221(.a(new_n175_), .b(new_n174_), .O(new_n382_));
  oai22  g222(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n383_));
  aoi21  g223(.a(new_n382_), .b(new_n381_), .c(new_n383_), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n380_), .c(x043), .O(z11));
