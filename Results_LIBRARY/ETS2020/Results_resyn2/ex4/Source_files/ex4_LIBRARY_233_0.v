...
module FAU ( 
  ...
  nand2  g014(.a(x049), .b(x009), .O(new_n171_));
  nand2  g015(.a(x073), .b(x033), .O(new_n172_));
  nand2  g016(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nor2   g017(.a(x065), .b(x017), .O(new_n174_));
  nand2  g018(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g019(.a(x033), .b(x009), .O(new_n176_));
  nand2  g020(.a(x073), .b(x049), .O(new_n177_));
  ...
  nand2  g027(.a(x050), .b(x010), .O(new_n184_));
  nand2  g028(.a(x074), .b(x034), .O(new_n185_));
  nand2  g029(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nor2   g030(.a(x066), .b(x018), .O(new_n187_));
  nand2  g031(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g032(.a(x034), .b(x010), .O(new_n189_));
  nand2  g033(.a(x074), .b(x050), .O(new_n190_));
  ...
  nand2  g053(.a(x036), .b(x012), .O(new_n210_));
  nand2  g054(.a(x076), .b(x052), .O(new_n211_));
  nand2  g055(.a(new_n211_), .b(new_n210_), .O(new_n212_));
  nor2   g056(.a(x084), .b(x004), .O(new_n213_));
  nand2  g057(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nand2  g058(.a(x052), .b(x012), .O(new_n215_));
  nand2  g059(.a(x076), .b(x036), .O(new_n216_));
  nand2  g060(.a(new_n216_), .b(new_n215_), .O(new_n217_));
  nor2   g061(.a(x068), .b(x020), .O(new_n218_));
  ...
  oai22  g065(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n228_));
  nand3  g066(.a(new_n228_), .b(x083), .c(x003), .O(new_n229_));
  oai22  g067(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n230_));
  and2   g068(.a(x067), .b(x019), .O(new_n231_));
  nand2  g069(.a(x051), .b(x035), .O(new_n232_));
  nand2  g070(.a(x075), .b(x011), .O(new_n233_));
  nand2  g071(.a(new_n233_), .b(new_n232_), .O(new_n234_));
  aoi21  g072(.a(new_n231_), .b(new_n230_), .c(new_n234_), .O(new_n235_));
  aoi21  g073(.a(new_n235_), .b(new_n229_), .c(x043), .O(z11));
  oai22  g074(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n237_));
  nand3  g075(.a(new_n237_), .b(x084), .c(x004), .O(new_n238_));
  oai22  g076(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n239_));
  and2   g077(.a(x068), .b(x020), .O(new_n240_));
  nand2  g078(.a(x052), .b(x036), .O(new_n241_));
  nand2  g079(.a(x076), .b(x012), .O(new_n242_));
  nand2  g080(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  aoi21  g081(.a(new_n240_), .b(new_n239_), .c(new_n243_), .O(new_n244_));
  aoi21  g082(.a(new_n244_), .b(new_n238_), .c(x044), .O(z12));
  zero   g083(.O(z05));
  zero   g084(.O(z06));
  zero   g085(.O(z07));
  zero   g086(.O(z08));
