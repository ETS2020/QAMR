...
module FAU ( 
  ...
  oai22  g161(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n324_));
  nand3  g162(.a(new_n324_), .b(x083), .c(x003), .O(new_n325_));
  oai22  g163(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n326_));
  and2   g164(.a(x067), .b(x019), .O(new_n327_));
  nand2  g165(.a(x075), .b(x011), .O(new_n328_));
  nand2  g166(.a(x051), .b(x035), .O(new_n329_));
  nand2  g167(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  aoi21  g168(.a(new_n327_), .b(new_n326_), .c(new_n330_), .O(new_n331_));
  aoi21  g169(.a(new_n331_), .b(new_n325_), .c(x043), .O(z11));
  oai22  g170(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n333_));
  nand3  g171(.a(new_n333_), .b(x068), .c(x020), .O(new_n334_));
  oai21  g172(.a(x076), .b(x052), .c(new_n194_), .O(new_n335_));
  nor2   g173(.a(new_n186_), .b(new_n185_), .O(new_n336_));
  oai22  g174(.a(new_n190_), .b(new_n187_), .c(new_n189_), .d(new_n188_), .O(new_n337_));
