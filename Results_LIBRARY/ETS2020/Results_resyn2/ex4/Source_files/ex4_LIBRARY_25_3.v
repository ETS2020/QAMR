// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:59 2020
...
module FAU ( 
  ...
  oai21  g235(.a(x075), .b(x051), .c(new_n197_), .O(new_n395_));
  nor2   g236(.a(new_n189_), .b(new_n188_), .O(new_n396_));
  oai22  g237(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n397_));
