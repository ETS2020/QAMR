// Benchmark "FAU" written by ABC on Sat Jul 25 09:21:05 2020
...
module FAU ( 
  ...
  nand2  g230(.a(new_n212_), .b(new_n207_), .O(new_n392_));
  nand2  g231(.a(new_n392_), .b(new_n216_), .O(new_n393_));
  ...
  oai21  g237(.a(new_n246_), .b(x029), .c(new_n398_), .O(new_n399_));
  oai21  g238(.a(new_n212_), .b(x109), .c(x037), .O(new_n400_));
  nand2  g239(.a(new_n400_), .b(x117), .O(new_n401_));
  inv1   g240(.a(x109), .O(new_n402_));
  oai21  g241(.a(new_n207_), .b(x061), .c(new_n402_), .O(new_n403_));
  nand2  g242(.a(new_n403_), .b(new_n210_), .O(new_n404_));
  ...
  nand4  g245(.a(x125), .b(new_n245_), .c(new_n210_), .d(x013), .O(new_n407_));
  aoi21  g246(.a(new_n407_), .b(new_n406_), .c(x053), .O(new_n408_));
  nand3  g247(.a(x085), .b(new_n210_), .c(new_n220_), .O(new_n409_));
  inv1   g248(.a(new_n409_), .O(new_n410_));
  oai21  g249(.a(new_n410_), .b(new_n408_), .c(x005), .O(new_n411_));
  nand2  g250(.a(new_n223_), .b(x029), .O(new_n412_));
  nand2  g251(.a(new_n412_), .b(new_n221_), .O(new_n413_));
  nand2  g252(.a(new_n413_), .b(new_n391_), .O(new_n414_));
  aoi21  g253(.a(new_n414_), .b(new_n220_), .c(new_n394_), .O(new_n415_));
  nor2   g254(.a(new_n225_), .b(x021), .O(new_n416_));
  oai21  g255(.a(new_n416_), .b(new_n246_), .c(x069), .O(new_n417_));
  nand4  g256(.a(new_n398_), .b(new_n392_), .c(new_n223_), .d(x029), .O(new_n418_));
  aoi21  g257(.a(new_n418_), .b(new_n417_), .c(x077), .O(new_n419_));
  oai21  g258(.a(new_n419_), .b(new_n415_), .c(new_n204_), .O(new_n420_));
  aoi21  g259(.a(x021), .b(x013), .c(new_n225_), .O(new_n421_));
  nor2   g260(.a(x077), .b(new_n210_), .O(new_n422_));
  oai21  g261(.a(new_n421_), .b(new_n246_), .c(new_n422_), .O(new_n423_));
  ...
  aoi21  g267(.a(new_n424_), .b(new_n219_), .c(new_n428_), .O(new_n429_));
  aoi21  g268(.a(new_n429_), .b(new_n411_), .c(x045), .O(z13));
  nand2  g269(.a(new_n271_), .b(new_n267_), .O(new_n431_));
  nand2  g270(.a(new_n431_), .b(new_n305_), .O(new_n432_));
  ...
  oai21  g276(.a(new_n306_), .b(x030), .c(new_n437_), .O(new_n438_));
  oai21  g277(.a(new_n271_), .b(x110), .c(x038), .O(new_n439_));
  nand2  g278(.a(new_n439_), .b(x118), .O(new_n440_));
  oai21  g279(.a(new_n267_), .b(x062), .c(new_n264_), .O(new_n441_));
  nand2  g280(.a(new_n441_), .b(new_n270_), .O(new_n442_));
  nand4  g281(.a(new_n442_), .b(new_n440_), .c(new_n438_), .d(new_n436_), .O(new_n443_));
  oai21  g282(.a(new_n443_), .b(new_n434_), .c(new_n299_), .O(new_n444_));
  nand4  g283(.a(x126), .b(new_n304_), .c(new_n270_), .d(x014), .O(new_n445_));
  aoi21  g284(.a(new_n445_), .b(new_n444_), .c(x054), .O(new_n446_));
  nand3  g285(.a(x086), .b(new_n270_), .c(new_n280_), .O(new_n447_));
  inv1   g286(.a(new_n447_), .O(new_n448_));
  oai21  g287(.a(new_n448_), .b(new_n446_), .c(x006), .O(new_n449_));
  nand2  g288(.a(new_n283_), .b(x030), .O(new_n450_));
  nand2  g289(.a(new_n450_), .b(new_n281_), .O(new_n451_));
  nand2  g290(.a(new_n451_), .b(new_n299_), .O(new_n452_));
  aoi21  g291(.a(new_n452_), .b(new_n280_), .c(new_n433_), .O(new_n453_));
  nor2   g292(.a(new_n303_), .b(x022), .O(new_n454_));
  oai21  g293(.a(new_n454_), .b(new_n306_), .c(x070), .O(new_n455_));
  nand4  g294(.a(new_n437_), .b(new_n431_), .c(new_n283_), .d(x030), .O(new_n456_));
  aoi21  g295(.a(new_n456_), .b(new_n455_), .c(x078), .O(new_n457_));
  oai21  g296(.a(new_n457_), .b(new_n453_), .c(new_n263_), .O(new_n458_));
  nand2  g297(.a(new_n437_), .b(x030), .O(new_n459_));
  nand2  g298(.a(new_n459_), .b(new_n295_), .O(new_n460_));
  nand3  g299(.a(new_n460_), .b(new_n299_), .c(x038), .O(new_n461_));
  ...
  nand3  g304(.a(new_n465_), .b(new_n464_), .c(new_n314_), .O(new_n466_));
  aoi21  g305(.a(new_n462_), .b(new_n279_), .c(new_n466_), .O(new_n467_));
