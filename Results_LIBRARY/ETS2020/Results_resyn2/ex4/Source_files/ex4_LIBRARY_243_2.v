...
module FAU ( 
  ...
  oai22  g230(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n390_));
  nand3  g231(.a(new_n390_), .b(x066), .c(x018), .O(new_n391_));
  oai21  g232(.a(x074), .b(x050), .c(new_n180_), .O(new_n392_));
  nor2   g233(.a(new_n172_), .b(new_n171_), .O(new_n393_));
  oai22  g234(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n394_));
  aoi21  g235(.a(new_n393_), .b(new_n392_), .c(new_n394_), .O(new_n395_));
  aoi21  g236(.a(new_n395_), .b(new_n391_), .c(x042), .O(z10));
  oai22  g237(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n397_));
  nand3  g238(.a(new_n397_), .b(x067), .c(x019), .O(new_n398_));
  oai21  g239(.a(x075), .b(x051), .c(new_n195_), .O(new_n399_));
  nor2   g240(.a(new_n187_), .b(new_n186_), .O(new_n400_));
  oai22  g241(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n401_));
  aoi21  g242(.a(new_n400_), .b(new_n399_), .c(new_n401_), .O(new_n402_));
  aoi21  g243(.a(new_n402_), .b(new_n398_), .c(x043), .O(z11));
  oai22  g244(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n404_));
  nand3  g245(.a(new_n404_), .b(x068), .c(x020), .O(new_n405_));
  oai21  g246(.a(x076), .b(x052), .c(new_n210_), .O(new_n406_));
  nor2   g247(.a(new_n202_), .b(new_n201_), .O(new_n407_));
  oai22  g248(.a(new_n206_), .b(new_n203_), .c(new_n205_), .d(new_n204_), .O(new_n408_));
  aoi21  g249(.a(new_n407_), .b(new_n406_), .c(new_n408_), .O(new_n409_));
  aoi21  g250(.a(new_n409_), .b(new_n405_), .c(x044), .O(z12));
