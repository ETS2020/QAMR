// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:52 2020
...
module FAU ( 
  ...
  oai22  g165(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n327_));
  nand3  g166(.a(new_n327_), .b(x066), .c(x018), .O(new_n328_));
  oai21  g167(.a(x074), .b(x050), .c(new_n168_), .O(new_n329_));
  nor2   g168(.a(new_n160_), .b(new_n159_), .O(new_n330_));
  oai22  g169(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n331_));
  aoi21  g170(.a(new_n330_), .b(new_n329_), .c(new_n331_), .O(new_n332_));
  aoi21  g171(.a(new_n332_), .b(new_n328_), .c(x042), .O(z10));
  oai22  g172(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n334_));
  nand3  g173(.a(new_n334_), .b(x067), .c(x019), .O(new_n335_));
  oai21  g174(.a(x075), .b(x051), .c(new_n183_), .O(new_n336_));
  nor2   g175(.a(new_n175_), .b(new_n174_), .O(new_n337_));
  oai22  g176(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n338_));
  aoi21  g177(.a(new_n337_), .b(new_n336_), .c(new_n338_), .O(new_n339_));
  aoi21  g178(.a(new_n339_), .b(new_n335_), .c(x043), .O(z11));
  oai22  g179(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n341_));
  nand3  g180(.a(new_n341_), .b(x068), .c(x020), .O(new_n342_));
  oai21  g181(.a(x076), .b(x052), .c(new_n198_), .O(new_n343_));
  nor2   g182(.a(new_n190_), .b(new_n189_), .O(new_n344_));
  oai22  g183(.a(new_n194_), .b(new_n191_), .c(new_n193_), .d(new_n192_), .O(new_n345_));
  aoi21  g184(.a(new_n344_), .b(new_n343_), .c(new_n345_), .O(new_n346_));
  aoi21  g185(.a(new_n346_), .b(new_n342_), .c(x044), .O(z12));
  inv1   g186(.a(x077), .O(new_n348_));
  nand2  g187(.a(new_n214_), .b(new_n209_), .O(new_n349_));
  nand2  g188(.a(new_n349_), .b(new_n218_), .O(new_n350_));
  ...
  oai21  g194(.a(new_n248_), .b(x029), .c(new_n355_), .O(new_n356_));
  oai21  g195(.a(new_n214_), .b(x109), .c(x037), .O(new_n357_));
  nand2  g196(.a(new_n357_), .b(x117), .O(new_n358_));
  inv1   g197(.a(x109), .O(new_n359_));
  oai21  g198(.a(new_n209_), .b(x061), .c(new_n359_), .O(new_n360_));
  nand2  g199(.a(new_n360_), .b(new_n212_), .O(new_n361_));
  ...
  nand4  g202(.a(x125), .b(new_n247_), .c(new_n212_), .d(x013), .O(new_n364_));
  aoi21  g203(.a(new_n364_), .b(new_n363_), .c(x053), .O(new_n365_));
  nand3  g204(.a(x085), .b(new_n212_), .c(new_n222_), .O(new_n366_));
  inv1   g205(.a(new_n366_), .O(new_n367_));
  oai21  g206(.a(new_n367_), .b(new_n365_), .c(x005), .O(new_n368_));
  nand2  g207(.a(new_n225_), .b(x029), .O(new_n369_));
  nand2  g208(.a(new_n369_), .b(new_n223_), .O(new_n370_));
  nand2  g209(.a(new_n370_), .b(new_n348_), .O(new_n371_));
  aoi21  g210(.a(new_n371_), .b(new_n222_), .c(new_n351_), .O(new_n372_));
  nor2   g211(.a(new_n227_), .b(x021), .O(new_n373_));
  oai21  g212(.a(new_n373_), .b(new_n248_), .c(x069), .O(new_n374_));
  nand4  g213(.a(new_n355_), .b(new_n349_), .c(new_n225_), .d(x029), .O(new_n375_));
  aoi21  g214(.a(new_n375_), .b(new_n374_), .c(x077), .O(new_n376_));
  oai21  g215(.a(new_n376_), .b(new_n372_), .c(new_n206_), .O(new_n377_));
  aoi21  g216(.a(x021), .b(x013), .c(new_n227_), .O(new_n378_));
  nor2   g217(.a(x077), .b(new_n212_), .O(new_n379_));
  oai21  g218(.a(new_n378_), .b(new_n248_), .c(new_n379_), .O(new_n380_));
  ...
  aoi21  g224(.a(new_n381_), .b(new_n221_), .c(new_n385_), .O(new_n386_));
  aoi21  g225(.a(new_n386_), .b(new_n368_), .c(x045), .O(z13));
  nand2  g226(.a(new_n273_), .b(new_n269_), .O(new_n388_));
  nand2  g227(.a(new_n388_), .b(new_n307_), .O(new_n389_));
  ...
  oai21  g233(.a(new_n308_), .b(x030), .c(new_n394_), .O(new_n395_));
  oai21  g234(.a(new_n273_), .b(x110), .c(x038), .O(new_n396_));
  nand2  g235(.a(new_n396_), .b(x118), .O(new_n397_));
  oai21  g236(.a(new_n269_), .b(x062), .c(new_n266_), .O(new_n398_));
  nand2  g237(.a(new_n398_), .b(new_n272_), .O(new_n399_));
  nand4  g238(.a(new_n399_), .b(new_n397_), .c(new_n395_), .d(new_n393_), .O(new_n400_));
  oai21  g239(.a(new_n400_), .b(new_n391_), .c(new_n301_), .O(new_n401_));
  nand4  g240(.a(x126), .b(new_n306_), .c(new_n272_), .d(x014), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n401_), .c(x054), .O(new_n403_));
  nand3  g242(.a(x086), .b(new_n272_), .c(new_n282_), .O(new_n404_));
  inv1   g243(.a(new_n404_), .O(new_n405_));
  oai21  g244(.a(new_n405_), .b(new_n403_), .c(x006), .O(new_n406_));
  nand2  g245(.a(new_n285_), .b(x030), .O(new_n407_));
  nand2  g246(.a(new_n407_), .b(new_n283_), .O(new_n408_));
  nand2  g247(.a(new_n408_), .b(new_n301_), .O(new_n409_));
  aoi21  g248(.a(new_n409_), .b(new_n282_), .c(new_n390_), .O(new_n410_));
  nor2   g249(.a(new_n305_), .b(x022), .O(new_n411_));
  oai21  g250(.a(new_n411_), .b(new_n308_), .c(x070), .O(new_n412_));
  nand4  g251(.a(new_n394_), .b(new_n388_), .c(new_n285_), .d(x030), .O(new_n413_));
  aoi21  g252(.a(new_n413_), .b(new_n412_), .c(x078), .O(new_n414_));
  oai21  g253(.a(new_n414_), .b(new_n410_), .c(new_n265_), .O(new_n415_));
  nand2  g254(.a(new_n394_), .b(x030), .O(new_n416_));
  nand2  g255(.a(new_n416_), .b(new_n297_), .O(new_n417_));
  nand3  g256(.a(new_n417_), .b(new_n301_), .c(x038), .O(new_n418_));
  ...
  nand3  g261(.a(new_n422_), .b(new_n421_), .c(new_n316_), .O(new_n423_));
  aoi21  g262(.a(new_n419_), .b(new_n281_), .c(new_n423_), .O(new_n424_));
