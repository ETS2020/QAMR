...
module FAU ( 
  ...
  oai22  g202(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n364_));
  nand3  g203(.a(new_n364_), .b(x066), .c(x018), .O(new_n365_));
  oai21  g204(.a(x074), .b(x050), .c(new_n168_), .O(new_n366_));
  nor2   g205(.a(new_n160_), .b(new_n159_), .O(new_n367_));
  oai22  g206(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n368_));
  aoi21  g207(.a(new_n367_), .b(new_n366_), .c(new_n368_), .O(new_n369_));
  aoi21  g208(.a(new_n369_), .b(new_n365_), .c(x042), .O(z10));
