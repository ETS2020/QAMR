...
module FAU ( 
  ...
  oai22  g207(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n370_));
  nand3  g208(.a(new_n370_), .b(x068), .c(x020), .O(new_n371_));
  oai21  g209(.a(x076), .b(x052), .c(new_n186_), .O(new_n372_));
  nor2   g210(.a(new_n178_), .b(new_n177_), .O(new_n373_));
  oai22  g211(.a(new_n182_), .b(new_n179_), .c(new_n181_), .d(new_n180_), .O(new_n374_));
  aoi21  g212(.a(new_n373_), .b(new_n372_), .c(new_n374_), .O(new_n375_));
  aoi21  g213(.a(new_n375_), .b(new_n371_), .c(x044), .O(z12));
