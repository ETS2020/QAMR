...
module FAU ( 
  ...
  oai22  g121(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n282_));
  nand3  g122(.a(new_n282_), .b(x066), .c(x018), .O(new_n283_));
  oai21  g123(.a(x074), .b(x050), .c(new_n196_), .O(new_n284_));
  nor2   g124(.a(new_n188_), .b(new_n187_), .O(new_n285_));
  oai22  g125(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n286_));
  aoi21  g126(.a(new_n285_), .b(new_n284_), .c(new_n286_), .O(new_n287_));
  aoi21  g127(.a(new_n287_), .b(new_n283_), .c(x042), .O(z10));
