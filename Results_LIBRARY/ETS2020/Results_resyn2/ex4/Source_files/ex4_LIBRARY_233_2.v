...
module FAU ( 
  ...
  oai21  g231(.a(x075), .b(x051), .c(new_n185_), .O(new_n391_));
  nor2   g232(.a(new_n177_), .b(new_n176_), .O(new_n392_));
  oai22  g233(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n179_), .O(new_n393_));
