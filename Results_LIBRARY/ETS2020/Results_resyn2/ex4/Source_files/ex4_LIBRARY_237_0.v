// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:56 2020
...
module FAU ( 
  ...
  oai21  g121(.a(x074), .b(x050), .c(new_n196_), .O(new_n282_));
  nor2   g122(.a(new_n188_), .b(new_n187_), .O(new_n283_));
  oai22  g123(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n284_));
