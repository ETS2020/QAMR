...
module FAU ( 
  ...
  oai21  g237(.a(x075), .b(x051), .c(new_n195_), .O(new_n397_));
  nor2   g238(.a(new_n187_), .b(new_n186_), .O(new_n398_));
  oai22  g239(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n399_));
