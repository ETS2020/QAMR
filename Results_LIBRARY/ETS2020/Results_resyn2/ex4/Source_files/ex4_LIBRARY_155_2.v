// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:49 2020
...
module FAU ( 
  ...
  oai21  g224(.a(x074), .b(x050), .c(new_n184_), .O(new_n384_));
  nor2   g225(.a(new_n176_), .b(new_n175_), .O(new_n385_));
  oai22  g226(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n386_));
