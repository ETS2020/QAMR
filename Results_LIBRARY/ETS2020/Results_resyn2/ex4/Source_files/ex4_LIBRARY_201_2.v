...
module FAU ( 
  ...
  nand3  g221(.a(new_n381_), .b(x067), .c(x019), .O(new_n382_));
  oai21  g222(.a(x075), .b(x051), .c(new_n197_), .O(new_n383_));
  nor2   g223(.a(new_n189_), .b(new_n188_), .O(new_n384_));
  oai22  g224(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n385_));
  aoi21  g225(.a(new_n384_), .b(new_n383_), .c(new_n385_), .O(new_n386_));
  aoi21  g226(.a(new_n386_), .b(new_n382_), .c(x043), .O(z11));
