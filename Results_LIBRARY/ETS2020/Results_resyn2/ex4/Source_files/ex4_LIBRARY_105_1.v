...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n369_, new_n373_, new_n374_, new_n375_, new_n376_, new_n377_,
  ...
  oai22  g211(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n373_));
  nand3  g212(.a(new_n373_), .b(x083), .c(x003), .O(new_n374_));
  oai22  g213(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n375_));
  and2   g214(.a(x067), .b(x019), .O(new_n376_));
  nand2  g215(.a(x075), .b(x011), .O(new_n377_));
  nand2  g216(.a(x051), .b(x035), .O(new_n378_));
  nand2  g217(.a(new_n378_), .b(new_n377_), .O(new_n379_));
  aoi21  g218(.a(new_n376_), .b(new_n375_), .c(new_n379_), .O(new_n380_));
  aoi21  g219(.a(new_n380_), .b(new_n374_), .c(x043), .O(z11));
