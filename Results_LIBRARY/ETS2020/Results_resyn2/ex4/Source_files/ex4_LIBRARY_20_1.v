// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:55 2020
...
module FAU ( 
  ...
  oai22  g176(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n336_));
  nand3  g177(.a(new_n336_), .b(x065), .c(x017), .O(new_n337_));
  oai21  g178(.a(x073), .b(x049), .c(new_n179_), .O(new_n338_));
  nor2   g179(.a(new_n171_), .b(new_n170_), .O(new_n339_));
  oai22  g180(.a(new_n175_), .b(new_n172_), .c(new_n174_), .d(new_n173_), .O(new_n340_));
  aoi21  g181(.a(new_n339_), .b(new_n338_), .c(new_n340_), .O(new_n341_));
  aoi21  g182(.a(new_n341_), .b(new_n337_), .c(x041), .O(z09));
  ...
  oai22  g190(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n351_));
  nand3  g191(.a(new_n351_), .b(x084), .c(x004), .O(new_n352_));
  oai22  g192(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n353_));
  and2   g193(.a(x068), .b(x020), .O(new_n354_));
  nand2  g194(.a(x076), .b(x012), .O(new_n355_));
  nand2  g195(.a(x052), .b(x036), .O(new_n356_));
  nand2  g196(.a(new_n356_), .b(new_n355_), .O(new_n357_));
  aoi21  g197(.a(new_n354_), .b(new_n353_), .c(new_n357_), .O(new_n358_));
  aoi21  g198(.a(new_n358_), .b(new_n352_), .c(x044), .O(z12));
  inv1   g199(.a(x077), .O(new_n360_));
  nand2  g200(.a(new_n224_), .b(new_n219_), .O(new_n361_));
  nand2  g201(.a(new_n361_), .b(new_n228_), .O(new_n362_));
  ...
  oai21  g207(.a(new_n258_), .b(x029), .c(new_n367_), .O(new_n368_));
  oai21  g208(.a(new_n224_), .b(x109), .c(x037), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(x117), .O(new_n370_));
  inv1   g210(.a(x109), .O(new_n371_));
  oai21  g211(.a(new_n219_), .b(x061), .c(new_n371_), .O(new_n372_));
  nand2  g212(.a(new_n372_), .b(new_n222_), .O(new_n373_));
  ...
  nand4  g215(.a(x125), .b(new_n257_), .c(new_n222_), .d(x013), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(new_n375_), .c(x053), .O(new_n377_));
  nand3  g217(.a(x085), .b(new_n222_), .c(new_n232_), .O(new_n378_));
  inv1   g218(.a(new_n378_), .O(new_n379_));
  oai21  g219(.a(new_n379_), .b(new_n377_), .c(x005), .O(new_n380_));
  nand2  g220(.a(new_n235_), .b(x029), .O(new_n381_));
  nand2  g221(.a(new_n381_), .b(new_n233_), .O(new_n382_));
  nand2  g222(.a(new_n382_), .b(new_n360_), .O(new_n383_));
  aoi21  g223(.a(new_n383_), .b(new_n232_), .c(new_n363_), .O(new_n384_));
  nor2   g224(.a(new_n237_), .b(x021), .O(new_n385_));
  oai21  g225(.a(new_n385_), .b(new_n258_), .c(x069), .O(new_n386_));
  nand4  g226(.a(new_n367_), .b(new_n361_), .c(new_n235_), .d(x029), .O(new_n387_));
  aoi21  g227(.a(new_n387_), .b(new_n386_), .c(x077), .O(new_n388_));
  oai21  g228(.a(new_n388_), .b(new_n384_), .c(new_n216_), .O(new_n389_));
  aoi21  g229(.a(x021), .b(x013), .c(new_n237_), .O(new_n390_));
  nor2   g230(.a(x077), .b(new_n222_), .O(new_n391_));
  oai21  g231(.a(new_n390_), .b(new_n258_), .c(new_n391_), .O(new_n392_));
  ...
  aoi21  g237(.a(new_n393_), .b(new_n231_), .c(new_n397_), .O(new_n398_));
  aoi21  g238(.a(new_n398_), .b(new_n380_), .c(x045), .O(z13));
  nand2  g239(.a(new_n283_), .b(new_n279_), .O(new_n400_));
  nand2  g240(.a(new_n400_), .b(new_n317_), .O(new_n401_));
  ...
  oai21  g246(.a(new_n318_), .b(x030), .c(new_n406_), .O(new_n407_));
  oai21  g247(.a(new_n283_), .b(x110), .c(x038), .O(new_n408_));
  nand2  g248(.a(new_n408_), .b(x118), .O(new_n409_));
  oai21  g249(.a(new_n279_), .b(x062), .c(new_n276_), .O(new_n410_));
  nand2  g250(.a(new_n410_), .b(new_n282_), .O(new_n411_));
  nand4  g251(.a(new_n411_), .b(new_n409_), .c(new_n407_), .d(new_n405_), .O(new_n412_));
  oai21  g252(.a(new_n412_), .b(new_n403_), .c(new_n311_), .O(new_n413_));
  nand4  g253(.a(x126), .b(new_n316_), .c(new_n282_), .d(x014), .O(new_n414_));
  aoi21  g254(.a(new_n414_), .b(new_n413_), .c(x054), .O(new_n415_));
  nand3  g255(.a(x086), .b(new_n282_), .c(new_n292_), .O(new_n416_));
  inv1   g256(.a(new_n416_), .O(new_n417_));
  oai21  g257(.a(new_n417_), .b(new_n415_), .c(x006), .O(new_n418_));
  nand2  g258(.a(new_n295_), .b(x030), .O(new_n419_));
  nand2  g259(.a(new_n419_), .b(new_n293_), .O(new_n420_));
  nand2  g260(.a(new_n420_), .b(new_n311_), .O(new_n421_));
  aoi21  g261(.a(new_n421_), .b(new_n292_), .c(new_n402_), .O(new_n422_));
  nor2   g262(.a(new_n315_), .b(x022), .O(new_n423_));
  oai21  g263(.a(new_n423_), .b(new_n318_), .c(x070), .O(new_n424_));
  nand4  g264(.a(new_n406_), .b(new_n400_), .c(new_n295_), .d(x030), .O(new_n425_));
  aoi21  g265(.a(new_n425_), .b(new_n424_), .c(x078), .O(new_n426_));
  oai21  g266(.a(new_n426_), .b(new_n422_), .c(new_n275_), .O(new_n427_));
  nand2  g267(.a(new_n406_), .b(x030), .O(new_n428_));
  nand2  g268(.a(new_n428_), .b(new_n307_), .O(new_n429_));
  nand3  g269(.a(new_n429_), .b(new_n311_), .c(x038), .O(new_n430_));
  ...
  nand3  g274(.a(new_n434_), .b(new_n433_), .c(new_n326_), .O(new_n435_));
  aoi21  g275(.a(new_n431_), .b(new_n291_), .c(new_n435_), .O(new_n436_));
