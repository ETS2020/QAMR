// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:36 2020
...
module FAU ( 
  ...
  oai22  g148(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n312_));
  nand3  g149(.a(new_n312_), .b(x067), .c(x019), .O(new_n313_));
  oai21  g150(.a(x075), .b(x051), .c(new_n181_), .O(new_n314_));
  nor2   g151(.a(new_n173_), .b(new_n172_), .O(new_n315_));
  oai22  g152(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n316_));
  aoi21  g153(.a(new_n315_), .b(new_n314_), .c(new_n316_), .O(new_n317_));
  aoi21  g154(.a(new_n317_), .b(new_n313_), .c(x043), .O(z11));
  oai22  g155(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n319_));
  nand3  g156(.a(new_n319_), .b(x084), .c(x004), .O(new_n320_));
  oai22  g157(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n321_));
  and2   g158(.a(x068), .b(x020), .O(new_n322_));
  nand2  g159(.a(x076), .b(x012), .O(new_n323_));
  nand2  g160(.a(x052), .b(x036), .O(new_n324_));
  nand2  g161(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  aoi21  g162(.a(new_n322_), .b(new_n321_), .c(new_n325_), .O(new_n326_));
  aoi21  g163(.a(new_n326_), .b(new_n320_), .c(x044), .O(z12));
