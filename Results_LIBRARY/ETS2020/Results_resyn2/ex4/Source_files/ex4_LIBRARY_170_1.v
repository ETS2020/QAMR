...
module FAU ( 
  ...
  oai21  g159(.a(x075), .b(x051), .c(new_n169_), .O(new_n322_));
  nor2   g160(.a(new_n161_), .b(new_n160_), .O(new_n323_));
  oai22  g161(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n324_));
