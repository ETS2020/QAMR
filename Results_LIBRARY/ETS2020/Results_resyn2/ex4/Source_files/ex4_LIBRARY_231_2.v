...
module FAU ( 
  ...
  oai22  g217(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n378_));
  nand3  g218(.a(new_n378_), .b(x066), .c(x018), .O(new_n379_));
  oai21  g219(.a(x074), .b(x050), .c(new_n168_), .O(new_n380_));
  nor2   g220(.a(new_n160_), .b(new_n159_), .O(new_n381_));
  oai22  g221(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n382_));
  aoi21  g222(.a(new_n381_), .b(new_n380_), .c(new_n382_), .O(new_n383_));
  aoi21  g223(.a(new_n383_), .b(new_n379_), .c(x042), .O(z10));
