// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:54 2020
...
module FAU ( 
  ...
  oai22  g113(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n275_));
  nand3  g114(.a(new_n275_), .b(x083), .c(x003), .O(new_n276_));
  oai22  g115(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n277_));
  and2   g116(.a(x067), .b(x019), .O(new_n278_));
  nand2  g117(.a(x075), .b(x011), .O(new_n279_));
  nand2  g118(.a(x051), .b(x035), .O(new_n280_));
  nand2  g119(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  aoi21  g120(.a(new_n278_), .b(new_n277_), .c(new_n281_), .O(new_n282_));
  aoi21  g121(.a(new_n282_), .b(new_n276_), .c(x043), .O(z11));
