// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:05 2020
...
module FAU ( 
  ...
  nand3  g227(.a(new_n386_), .b(x066), .c(x018), .O(new_n387_));
  oai21  g228(.a(x074), .b(x050), .c(new_n196_), .O(new_n388_));
  nor2   g229(.a(new_n188_), .b(new_n187_), .O(new_n389_));
  oai22  g230(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n390_));
  aoi21  g231(.a(new_n389_), .b(new_n388_), .c(new_n390_), .O(new_n391_));
  aoi21  g232(.a(new_n391_), .b(new_n387_), .c(x042), .O(z10));
  oai22  g233(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n394_));
  nand3  g234(.a(new_n394_), .b(x068), .c(x020), .O(new_n395_));
  oai21  g235(.a(x076), .b(x052), .c(new_n212_), .O(new_n396_));
  nor2   g236(.a(new_n204_), .b(new_n203_), .O(new_n397_));
  oai22  g237(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n398_));
  aoi21  g238(.a(new_n397_), .b(new_n396_), .c(new_n398_), .O(new_n399_));
  aoi21  g239(.a(new_n399_), .b(new_n395_), .c(x044), .O(z12));
  inv1   g240(.a(x077), .O(new_n401_));
  nand2  g241(.a(new_n228_), .b(new_n223_), .O(new_n402_));
  nand2  g242(.a(new_n402_), .b(new_n232_), .O(new_n403_));
  ...
  oai21  g248(.a(new_n262_), .b(x029), .c(new_n408_), .O(new_n409_));
  oai21  g249(.a(new_n228_), .b(x109), .c(x037), .O(new_n410_));
  nand2  g250(.a(new_n410_), .b(x117), .O(new_n411_));
  inv1   g251(.a(x109), .O(new_n412_));
  oai21  g252(.a(new_n223_), .b(x061), .c(new_n412_), .O(new_n413_));
  nand2  g253(.a(new_n413_), .b(new_n226_), .O(new_n414_));
  ...
  nand4  g256(.a(x125), .b(new_n261_), .c(new_n226_), .d(x013), .O(new_n417_));
  aoi21  g257(.a(new_n417_), .b(new_n416_), .c(x053), .O(new_n418_));
  nand3  g258(.a(x085), .b(new_n226_), .c(new_n236_), .O(new_n419_));
  inv1   g259(.a(new_n419_), .O(new_n420_));
  oai21  g260(.a(new_n420_), .b(new_n418_), .c(x005), .O(new_n421_));
  nand2  g261(.a(new_n239_), .b(x029), .O(new_n422_));
  nand2  g262(.a(new_n422_), .b(new_n237_), .O(new_n423_));
  nand2  g263(.a(new_n423_), .b(new_n401_), .O(new_n424_));
  aoi21  g264(.a(new_n424_), .b(new_n236_), .c(new_n404_), .O(new_n425_));
  nor2   g265(.a(new_n241_), .b(x021), .O(new_n426_));
  oai21  g266(.a(new_n426_), .b(new_n262_), .c(x069), .O(new_n427_));
  nand4  g267(.a(new_n408_), .b(new_n402_), .c(new_n239_), .d(x029), .O(new_n428_));
  aoi21  g268(.a(new_n428_), .b(new_n427_), .c(x077), .O(new_n429_));
  oai21  g269(.a(new_n429_), .b(new_n425_), .c(new_n220_), .O(new_n430_));
  aoi21  g270(.a(x021), .b(x013), .c(new_n241_), .O(new_n431_));
  nor2   g271(.a(x077), .b(new_n226_), .O(new_n432_));
  oai21  g272(.a(new_n431_), .b(new_n262_), .c(new_n432_), .O(new_n433_));
  ...
  aoi21  g278(.a(new_n434_), .b(new_n235_), .c(new_n438_), .O(new_n439_));
  aoi21  g279(.a(new_n439_), .b(new_n421_), .c(x045), .O(z13));
  nand2  g280(.a(new_n287_), .b(new_n283_), .O(new_n441_));
  nand2  g281(.a(new_n441_), .b(new_n321_), .O(new_n442_));
  ...
  oai21  g287(.a(new_n322_), .b(x030), .c(new_n447_), .O(new_n448_));
  oai21  g288(.a(new_n287_), .b(x110), .c(x038), .O(new_n449_));
  nand2  g289(.a(new_n449_), .b(x118), .O(new_n450_));
  oai21  g290(.a(new_n283_), .b(x062), .c(new_n280_), .O(new_n451_));
  nand2  g291(.a(new_n451_), .b(new_n286_), .O(new_n452_));
  nand4  g292(.a(new_n452_), .b(new_n450_), .c(new_n448_), .d(new_n446_), .O(new_n453_));
  oai21  g293(.a(new_n453_), .b(new_n444_), .c(new_n315_), .O(new_n454_));
  nand4  g294(.a(x126), .b(new_n320_), .c(new_n286_), .d(x014), .O(new_n455_));
  aoi21  g295(.a(new_n455_), .b(new_n454_), .c(x054), .O(new_n456_));
  nand3  g296(.a(x086), .b(new_n286_), .c(new_n296_), .O(new_n457_));
  inv1   g297(.a(new_n457_), .O(new_n458_));
  oai21  g298(.a(new_n458_), .b(new_n456_), .c(x006), .O(new_n459_));
  nand2  g299(.a(new_n299_), .b(x030), .O(new_n460_));
  nand2  g300(.a(new_n460_), .b(new_n297_), .O(new_n461_));
  nand2  g301(.a(new_n461_), .b(new_n315_), .O(new_n462_));
  aoi21  g302(.a(new_n462_), .b(new_n296_), .c(new_n443_), .O(new_n463_));
  nor2   g303(.a(new_n319_), .b(x022), .O(new_n464_));
  oai21  g304(.a(new_n464_), .b(new_n322_), .c(x070), .O(new_n465_));
  nand4  g305(.a(new_n447_), .b(new_n441_), .c(new_n299_), .d(x030), .O(new_n466_));
  aoi21  g306(.a(new_n466_), .b(new_n465_), .c(x078), .O(new_n467_));
  oai21  g307(.a(new_n467_), .b(new_n463_), .c(new_n279_), .O(new_n468_));
  nand2  g308(.a(new_n447_), .b(x030), .O(new_n469_));
  nand2  g309(.a(new_n469_), .b(new_n311_), .O(new_n470_));
  nand3  g310(.a(new_n470_), .b(new_n315_), .c(x038), .O(new_n471_));
  ...
  nand3  g315(.a(new_n475_), .b(new_n474_), .c(new_n330_), .O(new_n476_));
  aoi21  g316(.a(new_n472_), .b(new_n295_), .c(new_n476_), .O(new_n477_));
