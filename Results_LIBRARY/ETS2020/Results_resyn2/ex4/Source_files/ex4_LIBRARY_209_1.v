...
module FAU ( 
  ...
  oai22  g178(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n338_));
  nand3  g179(.a(new_n338_), .b(x081), .c(x001), .O(new_n339_));
  oai22  g180(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n340_));
  and2   g181(.a(x065), .b(x017), .O(new_n341_));
  nand2  g182(.a(x073), .b(x009), .O(new_n342_));
  nand2  g183(.a(x049), .b(x033), .O(new_n343_));
  nand2  g184(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  aoi21  g185(.a(new_n341_), .b(new_n340_), .c(new_n344_), .O(new_n345_));
  aoi21  g186(.a(new_n345_), .b(new_n339_), .c(x041), .O(z09));
  oai22  g187(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n347_));
  nand3  g188(.a(new_n347_), .b(x066), .c(x018), .O(new_n348_));
  oai21  g189(.a(x074), .b(x050), .c(new_n180_), .O(new_n349_));
  nor2   g190(.a(new_n172_), .b(new_n171_), .O(new_n350_));
  oai22  g191(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n351_));
