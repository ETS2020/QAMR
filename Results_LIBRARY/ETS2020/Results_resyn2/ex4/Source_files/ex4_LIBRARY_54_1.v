// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:24 2020
...
module FAU ( 
  ...
  oai21  g172(.a(x075), .b(x051), .c(new_n181_), .O(new_n334_));
  nor2   g173(.a(new_n173_), .b(new_n172_), .O(new_n335_));
  oai22  g174(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n336_));
