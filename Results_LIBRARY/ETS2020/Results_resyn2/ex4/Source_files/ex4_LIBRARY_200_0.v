...
module FAU ( 
  ...
  oai21  g099(.a(x074), .b(x050), .c(new_n168_), .O(new_n262_));
  nor2   g100(.a(new_n160_), .b(new_n159_), .O(new_n263_));
  oai22  g101(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n264_));
  aoi21  g102(.a(new_n263_), .b(new_n262_), .c(new_n264_), .O(new_n265_));
  aoi21  g103(.a(new_n265_), .b(new_n261_), .c(x042), .O(z10));
  oai22  g104(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n267_));
  nand3  g105(.a(new_n267_), .b(x067), .c(x019), .O(new_n268_));
  oai21  g106(.a(x075), .b(x051), .c(new_n183_), .O(new_n269_));
  nor2   g107(.a(new_n175_), .b(new_n174_), .O(new_n270_));
  oai22  g108(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n271_));
  ...
  oai21  g113(.a(x076), .b(x052), .c(new_n198_), .O(new_n276_));
  nor2   g114(.a(new_n190_), .b(new_n189_), .O(new_n277_));
  oai22  g115(.a(new_n194_), .b(new_n191_), .c(new_n193_), .d(new_n192_), .O(new_n278_));
