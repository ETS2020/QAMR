...
module FAU ( 
  ...
  nand3  g160(.a(new_n321_), .b(x066), .c(x018), .O(new_n322_));
  oai21  g161(.a(x074), .b(x050), .c(new_n168_), .O(new_n323_));
  nor2   g162(.a(new_n160_), .b(new_n159_), .O(new_n324_));
  oai22  g163(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n325_));
  aoi21  g164(.a(new_n324_), .b(new_n323_), .c(new_n325_), .O(new_n326_));
  aoi21  g165(.a(new_n326_), .b(new_n322_), .c(x042), .O(z10));
  oai22  g166(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n329_));
  nand3  g167(.a(new_n329_), .b(x068), .c(x020), .O(new_n330_));
  oai21  g168(.a(x076), .b(x052), .c(new_n184_), .O(new_n331_));
  nor2   g169(.a(new_n176_), .b(new_n175_), .O(new_n332_));
  oai22  g170(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n333_));
