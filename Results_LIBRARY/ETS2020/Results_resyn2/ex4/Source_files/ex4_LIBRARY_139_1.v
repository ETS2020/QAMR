...
module FAU ( 
  ...
  oai21  g165(.a(x073), .b(x049), .c(new_n167_), .O(new_n326_));
  nor2   g166(.a(new_n159_), .b(new_n158_), .O(new_n327_));
  oai22  g167(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n328_));
