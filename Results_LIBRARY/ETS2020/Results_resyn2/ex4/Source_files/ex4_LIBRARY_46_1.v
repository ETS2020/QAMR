// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:17 2020
...
module FAU ( 
  ...
  oai22  g176(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n336_));
  nand3  g177(.a(new_n336_), .b(x081), .c(x001), .O(new_n337_));
  oai22  g178(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n338_));
  and2   g179(.a(x065), .b(x017), .O(new_n339_));
  nand2  g180(.a(x073), .b(x009), .O(new_n340_));
  nand2  g181(.a(x049), .b(x033), .O(new_n341_));
  nand2  g182(.a(new_n341_), .b(new_n340_), .O(new_n342_));
  aoi21  g183(.a(new_n339_), .b(new_n338_), .c(new_n342_), .O(new_n343_));
  aoi21  g184(.a(new_n343_), .b(new_n337_), .c(x041), .O(z09));
  oai22  g185(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n346_));
  nand3  g186(.a(new_n346_), .b(x067), .c(x019), .O(new_n347_));
  oai21  g187(.a(x075), .b(x051), .c(new_n193_), .O(new_n348_));
  nor2   g188(.a(new_n185_), .b(new_n184_), .O(new_n349_));
  oai22  g189(.a(new_n189_), .b(new_n186_), .c(new_n188_), .d(new_n187_), .O(new_n350_));
  aoi21  g190(.a(new_n349_), .b(new_n348_), .c(new_n350_), .O(new_n351_));
  aoi21  g191(.a(new_n351_), .b(new_n347_), .c(x043), .O(z11));
  oai22  g192(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n353_));
  nand3  g193(.a(new_n353_), .b(x068), .c(x020), .O(new_n354_));
  oai21  g194(.a(x076), .b(x052), .c(new_n208_), .O(new_n355_));
  nor2   g195(.a(new_n200_), .b(new_n199_), .O(new_n356_));
  oai22  g196(.a(new_n204_), .b(new_n201_), .c(new_n203_), .d(new_n202_), .O(new_n357_));
  aoi21  g197(.a(new_n356_), .b(new_n355_), .c(new_n357_), .O(new_n358_));
  aoi21  g198(.a(new_n358_), .b(new_n354_), .c(x044), .O(z12));
