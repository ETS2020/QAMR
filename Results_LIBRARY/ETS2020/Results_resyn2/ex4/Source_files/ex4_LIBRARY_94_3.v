// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:58 2020
...
module FAU ( 
  ...
  oai22  g235(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n394_));
  nand3  g236(.a(new_n394_), .b(x082), .c(x002), .O(new_n395_));
  oai22  g237(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n396_));
  and2   g238(.a(x066), .b(x018), .O(new_n397_));
  nand2  g239(.a(x074), .b(x010), .O(new_n398_));
  nand2  g240(.a(x050), .b(x034), .O(new_n399_));
  nand2  g241(.a(new_n399_), .b(new_n398_), .O(new_n400_));
  aoi21  g242(.a(new_n397_), .b(new_n396_), .c(new_n400_), .O(new_n401_));
  aoi21  g243(.a(new_n401_), .b(new_n395_), .c(x042), .O(z10));
