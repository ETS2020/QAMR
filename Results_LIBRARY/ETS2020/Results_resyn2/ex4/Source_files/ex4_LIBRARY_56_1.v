// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:26 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x043), .O(new_n174_));
  inv1   g016(.a(x011), .O(new_n175_));
  inv1   g017(.a(x035), .O(new_n176_));
  inv1   g018(.a(x051), .O(new_n177_));
  inv1   g019(.a(x075), .O(new_n178_));
  oai22  g020(.a(new_n178_), .b(new_n177_), .c(new_n176_), .d(new_n175_), .O(new_n179_));
  nor2   g021(.a(x083), .b(x003), .O(new_n180_));
  nand2  g022(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  oai22  g023(.a(new_n178_), .b(new_n176_), .c(new_n177_), .d(new_n175_), .O(new_n182_));
  nor2   g024(.a(x067), .b(x019), .O(new_n183_));
  oai22  g025(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n184_));
  aoi21  g026(.a(new_n183_), .b(new_n182_), .c(new_n184_), .O(new_n185_));
  aoi21  g027(.a(new_n185_), .b(new_n181_), .c(new_n174_), .O(z03));
  ...
  oai22  g209(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n370_));
  nand3  g210(.a(new_n370_), .b(x066), .c(x018), .O(new_n371_));
  oai21  g211(.a(x074), .b(x050), .c(new_n168_), .O(new_n372_));
  nor2   g212(.a(new_n160_), .b(new_n159_), .O(new_n373_));
  oai22  g213(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n374_));
  aoi21  g214(.a(new_n373_), .b(new_n372_), .c(new_n374_), .O(new_n375_));
  aoi21  g215(.a(new_n375_), .b(new_n371_), .c(x042), .O(z10));
