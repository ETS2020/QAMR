// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:30 2020
...
module FAU ( 
  ...
  oai21  g226(.a(x075), .b(x051), .c(new_n197_), .O(new_n387_));
  nor2   g227(.a(new_n189_), .b(new_n188_), .O(new_n388_));
  oai22  g228(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n389_));
  ...
  nand2  g232(.a(new_n226_), .b(new_n221_), .O(new_n394_));
  nand2  g233(.a(new_n394_), .b(new_n230_), .O(new_n395_));
  ...
  oai21  g239(.a(new_n260_), .b(x029), .c(new_n400_), .O(new_n401_));
  oai21  g240(.a(new_n226_), .b(x109), .c(x037), .O(new_n402_));
  nand2  g241(.a(new_n402_), .b(x117), .O(new_n403_));
  inv1   g242(.a(x109), .O(new_n404_));
  oai21  g243(.a(new_n221_), .b(x061), .c(new_n404_), .O(new_n405_));
  nand2  g244(.a(new_n405_), .b(new_n224_), .O(new_n406_));
  ...
  nand4  g247(.a(x125), .b(new_n259_), .c(new_n224_), .d(x013), .O(new_n409_));
  aoi21  g248(.a(new_n409_), .b(new_n408_), .c(x053), .O(new_n410_));
  nand3  g249(.a(x085), .b(new_n224_), .c(new_n234_), .O(new_n411_));
  inv1   g250(.a(new_n411_), .O(new_n412_));
  oai21  g251(.a(new_n412_), .b(new_n410_), .c(x005), .O(new_n413_));
  nand2  g252(.a(new_n237_), .b(x029), .O(new_n414_));
  nand2  g253(.a(new_n414_), .b(new_n235_), .O(new_n415_));
  nand2  g254(.a(new_n415_), .b(new_n393_), .O(new_n416_));
  aoi21  g255(.a(new_n416_), .b(new_n234_), .c(new_n396_), .O(new_n417_));
  nor2   g256(.a(new_n239_), .b(x021), .O(new_n418_));
  oai21  g257(.a(new_n418_), .b(new_n260_), .c(x069), .O(new_n419_));
  nand4  g258(.a(new_n400_), .b(new_n394_), .c(new_n237_), .d(x029), .O(new_n420_));
  aoi21  g259(.a(new_n420_), .b(new_n419_), .c(x077), .O(new_n421_));
  oai21  g260(.a(new_n421_), .b(new_n417_), .c(new_n218_), .O(new_n422_));
  aoi21  g261(.a(x021), .b(x013), .c(new_n239_), .O(new_n423_));
  nor2   g262(.a(x077), .b(new_n224_), .O(new_n424_));
  oai21  g263(.a(new_n423_), .b(new_n260_), .c(new_n424_), .O(new_n425_));
  ...
  aoi21  g269(.a(new_n426_), .b(new_n233_), .c(new_n430_), .O(new_n431_));
  aoi21  g270(.a(new_n431_), .b(new_n413_), .c(x045), .O(z13));
  nand2  g271(.a(new_n285_), .b(new_n281_), .O(new_n433_));
  nand2  g272(.a(new_n433_), .b(new_n319_), .O(new_n434_));
  ...
  oai21  g278(.a(new_n320_), .b(x030), .c(new_n439_), .O(new_n440_));
  oai21  g279(.a(new_n285_), .b(x110), .c(x038), .O(new_n441_));
  nand2  g280(.a(new_n441_), .b(x118), .O(new_n442_));
  oai21  g281(.a(new_n281_), .b(x062), .c(new_n278_), .O(new_n443_));
  nand2  g282(.a(new_n443_), .b(new_n284_), .O(new_n444_));
  nand4  g283(.a(new_n444_), .b(new_n442_), .c(new_n440_), .d(new_n438_), .O(new_n445_));
  oai21  g284(.a(new_n445_), .b(new_n436_), .c(new_n313_), .O(new_n446_));
  nand4  g285(.a(x126), .b(new_n318_), .c(new_n284_), .d(x014), .O(new_n447_));
  aoi21  g286(.a(new_n447_), .b(new_n446_), .c(x054), .O(new_n448_));
  nand3  g287(.a(x086), .b(new_n284_), .c(new_n294_), .O(new_n449_));
  inv1   g288(.a(new_n449_), .O(new_n450_));
  oai21  g289(.a(new_n450_), .b(new_n448_), .c(x006), .O(new_n451_));
  nand2  g290(.a(new_n297_), .b(x030), .O(new_n452_));
  nand2  g291(.a(new_n452_), .b(new_n295_), .O(new_n453_));
  nand2  g292(.a(new_n453_), .b(new_n313_), .O(new_n454_));
  aoi21  g293(.a(new_n454_), .b(new_n294_), .c(new_n435_), .O(new_n455_));
  nor2   g294(.a(new_n317_), .b(x022), .O(new_n456_));
  oai21  g295(.a(new_n456_), .b(new_n320_), .c(x070), .O(new_n457_));
  nand4  g296(.a(new_n439_), .b(new_n433_), .c(new_n297_), .d(x030), .O(new_n458_));
  aoi21  g297(.a(new_n458_), .b(new_n457_), .c(x078), .O(new_n459_));
  oai21  g298(.a(new_n459_), .b(new_n455_), .c(new_n277_), .O(new_n460_));
  nand2  g299(.a(new_n439_), .b(x030), .O(new_n461_));
  nand2  g300(.a(new_n461_), .b(new_n309_), .O(new_n462_));
  nand3  g301(.a(new_n462_), .b(new_n313_), .c(x038), .O(new_n463_));
  ...
  nand3  g306(.a(new_n467_), .b(new_n466_), .c(new_n328_), .O(new_n468_));
  aoi21  g307(.a(new_n464_), .b(new_n293_), .c(new_n468_), .O(new_n469_));
