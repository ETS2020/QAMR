...
module FAU ( 
  ...
  oai22  g191(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n351_));
  nand3  g192(.a(new_n351_), .b(x066), .c(x018), .O(new_n352_));
  oai21  g193(.a(x074), .b(x050), .c(new_n192_), .O(new_n353_));
  nor2   g194(.a(new_n184_), .b(new_n183_), .O(new_n354_));
  oai22  g195(.a(new_n188_), .b(new_n185_), .c(new_n187_), .d(new_n186_), .O(new_n355_));
  aoi21  g196(.a(new_n354_), .b(new_n353_), .c(new_n355_), .O(new_n356_));
  aoi21  g197(.a(new_n356_), .b(new_n352_), .c(x042), .O(z10));
  oai22  g198(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n358_));
  nand3  g199(.a(new_n358_), .b(x067), .c(x019), .O(new_n359_));
  oai21  g200(.a(x075), .b(x051), .c(new_n207_), .O(new_n360_));
  nor2   g201(.a(new_n199_), .b(new_n198_), .O(new_n361_));
  oai22  g202(.a(new_n203_), .b(new_n200_), .c(new_n202_), .d(new_n201_), .O(new_n362_));
  aoi21  g203(.a(new_n361_), .b(new_n360_), .c(new_n362_), .O(new_n363_));
  aoi21  g204(.a(new_n363_), .b(new_n359_), .c(x043), .O(z11));
