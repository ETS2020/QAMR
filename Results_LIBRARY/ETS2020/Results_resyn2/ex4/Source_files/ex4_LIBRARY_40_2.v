...
module FAU ( 
  ...
  oai21  g241(.a(x074), .b(x050), .c(new_n196_), .O(new_n400_));
  nor2   g242(.a(new_n188_), .b(new_n187_), .O(new_n401_));
  oai22  g243(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n402_));
