// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:31 2020
...
module FAU ( 
  ...
  oai22  g196(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n357_));
  nand3  g197(.a(new_n357_), .b(x081), .c(x001), .O(new_n358_));
  oai22  g198(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n359_));
  and2   g199(.a(x065), .b(x017), .O(new_n360_));
  nand2  g200(.a(x073), .b(x009), .O(new_n361_));
  nand2  g201(.a(x049), .b(x033), .O(new_n362_));
  nand2  g202(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  aoi21  g203(.a(new_n360_), .b(new_n359_), .c(new_n363_), .O(new_n364_));
  aoi21  g204(.a(new_n364_), .b(new_n358_), .c(x041), .O(z09));
  oai22  g205(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n366_));
  nand3  g206(.a(new_n366_), .b(x082), .c(x002), .O(new_n367_));
  oai22  g207(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n368_));
  and2   g208(.a(x066), .b(x018), .O(new_n369_));
  nand2  g209(.a(x074), .b(x010), .O(new_n370_));
  nand2  g210(.a(x050), .b(x034), .O(new_n371_));
  nand2  g211(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  aoi21  g212(.a(new_n369_), .b(new_n368_), .c(new_n372_), .O(new_n373_));
  aoi21  g213(.a(new_n373_), .b(new_n367_), .c(x042), .O(z10));
  oai22  g214(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n376_));
  nand3  g215(.a(new_n376_), .b(x084), .c(x004), .O(new_n377_));
  oai22  g216(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n378_));
  and2   g217(.a(x068), .b(x020), .O(new_n379_));
  nand2  g218(.a(x076), .b(x012), .O(new_n380_));
  nand2  g219(.a(x052), .b(x036), .O(new_n381_));
  nand2  g220(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  aoi21  g221(.a(new_n379_), .b(new_n378_), .c(new_n382_), .O(new_n383_));
  aoi21  g222(.a(new_n383_), .b(new_n377_), .c(x044), .O(z12));
  inv1   g223(.a(x077), .O(new_n385_));
  nand2  g224(.a(new_n200_), .b(new_n195_), .O(new_n386_));
  nand2  g225(.a(new_n386_), .b(new_n204_), .O(new_n387_));
  nor2   g226(.a(x117), .b(x109), .O(new_n388_));
  aoi21  g227(.a(new_n388_), .b(new_n387_), .c(x069), .O(new_n389_));
  nor2   g228(.a(x117), .b(x021), .O(new_n390_));
  aoi21  g229(.a(new_n390_), .b(x125), .c(x085), .O(new_n391_));
  nand2  g230(.a(x021), .b(x013), .O(new_n392_));
  oai21  g231(.a(new_n234_), .b(x029), .c(new_n392_), .O(new_n393_));
  oai21  g232(.a(new_n200_), .b(x109), .c(x037), .O(new_n394_));
  nand2  g233(.a(new_n394_), .b(x117), .O(new_n395_));
  inv1   g234(.a(x109), .O(new_n396_));
  oai21  g235(.a(new_n195_), .b(x061), .c(new_n396_), .O(new_n397_));
  nand2  g236(.a(new_n397_), .b(new_n198_), .O(new_n398_));
  nand4  g237(.a(new_n398_), .b(new_n395_), .c(new_n393_), .d(new_n391_), .O(new_n399_));
  oai21  g238(.a(new_n399_), .b(new_n389_), .c(new_n385_), .O(new_n400_));
  nand4  g239(.a(x125), .b(new_n233_), .c(new_n198_), .d(x013), .O(new_n401_));
  aoi21  g240(.a(new_n401_), .b(new_n400_), .c(x053), .O(new_n402_));
  nand3  g241(.a(x085), .b(new_n198_), .c(new_n208_), .O(new_n403_));
  inv1   g242(.a(new_n403_), .O(new_n404_));
  oai21  g243(.a(new_n404_), .b(new_n402_), .c(x005), .O(new_n405_));
  nand2  g244(.a(new_n211_), .b(x029), .O(new_n406_));
  nand2  g245(.a(new_n406_), .b(new_n209_), .O(new_n407_));
  nand2  g246(.a(new_n407_), .b(new_n385_), .O(new_n408_));
  aoi21  g247(.a(new_n408_), .b(new_n208_), .c(new_n388_), .O(new_n409_));
  nor2   g248(.a(new_n213_), .b(x021), .O(new_n410_));
  oai21  g249(.a(new_n410_), .b(new_n234_), .c(x069), .O(new_n411_));
  nand4  g250(.a(new_n392_), .b(new_n386_), .c(new_n211_), .d(x029), .O(new_n412_));
  aoi21  g251(.a(new_n412_), .b(new_n411_), .c(x077), .O(new_n413_));
  oai21  g252(.a(new_n413_), .b(new_n409_), .c(new_n192_), .O(new_n414_));
  aoi21  g253(.a(x021), .b(x013), .c(new_n213_), .O(new_n415_));
  nor2   g254(.a(x077), .b(new_n198_), .O(new_n416_));
  oai21  g255(.a(new_n415_), .b(new_n234_), .c(new_n416_), .O(new_n417_));
  nand2  g256(.a(new_n417_), .b(new_n414_), .O(new_n418_));
  oai22  g257(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n419_));
  nand3  g258(.a(new_n419_), .b(x069), .c(x021), .O(new_n420_));
  aoi22  g259(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n421_));
  nand2  g260(.a(new_n421_), .b(new_n420_), .O(new_n422_));
  aoi21  g261(.a(new_n418_), .b(new_n207_), .c(new_n422_), .O(new_n423_));
  aoi21  g262(.a(new_n423_), .b(new_n405_), .c(x045), .O(z13));
  nand2  g263(.a(new_n259_), .b(new_n255_), .O(new_n425_));
  nand2  g264(.a(new_n425_), .b(new_n293_), .O(new_n426_));
  nor2   g265(.a(x118), .b(x110), .O(new_n427_));
  aoi21  g266(.a(new_n427_), .b(new_n426_), .c(x070), .O(new_n428_));
  nor2   g267(.a(x118), .b(x022), .O(new_n429_));
  aoi21  g268(.a(new_n429_), .b(x126), .c(x086), .O(new_n430_));
  nand2  g269(.a(x022), .b(x014), .O(new_n431_));
  oai21  g270(.a(new_n294_), .b(x030), .c(new_n431_), .O(new_n432_));
  oai21  g271(.a(new_n259_), .b(x110), .c(x038), .O(new_n433_));
  nand2  g272(.a(new_n433_), .b(x118), .O(new_n434_));
  oai21  g273(.a(new_n255_), .b(x062), .c(new_n252_), .O(new_n435_));
  nand2  g274(.a(new_n435_), .b(new_n258_), .O(new_n436_));
  nand4  g275(.a(new_n436_), .b(new_n434_), .c(new_n432_), .d(new_n430_), .O(new_n437_));
  oai21  g276(.a(new_n437_), .b(new_n428_), .c(new_n287_), .O(new_n438_));
  nand4  g277(.a(x126), .b(new_n292_), .c(new_n258_), .d(x014), .O(new_n439_));
  aoi21  g278(.a(new_n439_), .b(new_n438_), .c(x054), .O(new_n440_));
  nand3  g279(.a(x086), .b(new_n258_), .c(new_n268_), .O(new_n441_));
  inv1   g280(.a(new_n441_), .O(new_n442_));
  oai21  g281(.a(new_n442_), .b(new_n440_), .c(x006), .O(new_n443_));
  nand2  g282(.a(new_n271_), .b(x030), .O(new_n444_));
  nand2  g283(.a(new_n444_), .b(new_n269_), .O(new_n445_));
  nand2  g284(.a(new_n445_), .b(new_n287_), .O(new_n446_));
  aoi21  g285(.a(new_n446_), .b(new_n268_), .c(new_n427_), .O(new_n447_));
  nor2   g286(.a(new_n291_), .b(x022), .O(new_n448_));
  oai21  g287(.a(new_n448_), .b(new_n294_), .c(x070), .O(new_n449_));
  nand4  g288(.a(new_n431_), .b(new_n425_), .c(new_n271_), .d(x030), .O(new_n450_));
  aoi21  g289(.a(new_n450_), .b(new_n449_), .c(x078), .O(new_n451_));
  oai21  g290(.a(new_n451_), .b(new_n447_), .c(new_n251_), .O(new_n452_));
  nand2  g291(.a(new_n431_), .b(x030), .O(new_n453_));
  nand2  g292(.a(new_n453_), .b(new_n283_), .O(new_n454_));
  nand3  g293(.a(new_n454_), .b(new_n287_), .c(x038), .O(new_n455_));
  nand2  g294(.a(new_n455_), .b(new_n452_), .O(new_n456_));
  oai22  g295(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n457_));
  nand3  g296(.a(new_n457_), .b(x070), .c(x022), .O(new_n458_));
  nand2  g297(.a(x078), .b(x014), .O(new_n459_));
  nand3  g298(.a(new_n459_), .b(new_n458_), .c(new_n302_), .O(new_n460_));
  aoi21  g299(.a(new_n456_), .b(new_n267_), .c(new_n460_), .O(new_n461_));
  aoi21  g300(.a(new_n461_), .b(new_n443_), .c(x046), .O(z14));
  zero   g301(.O(z01));
  zero   g302(.O(z02));
  zero   g303(.O(z04));
  zero   g304(.O(z07));
