// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:53 2020
...
module FAU ( 
  ...
  oai21  g150(.a(x073), .b(x049), .c(new_n167_), .O(new_n312_));
  nor2   g151(.a(new_n159_), .b(new_n158_), .O(new_n313_));
  oai22  g152(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n314_));
  aoi21  g153(.a(new_n313_), .b(new_n312_), .c(new_n314_), .O(new_n315_));
  aoi21  g154(.a(new_n315_), .b(new_n311_), .c(x041), .O(z09));
  oai22  g155(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n318_));
  nand3  g156(.a(new_n318_), .b(x083), .c(x003), .O(new_n319_));
  oai22  g157(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n320_));
  and2   g158(.a(x067), .b(x019), .O(new_n321_));
  nand2  g159(.a(x075), .b(x011), .O(new_n322_));
  nand2  g160(.a(x051), .b(x035), .O(new_n323_));
  nand2  g161(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  aoi21  g162(.a(new_n321_), .b(new_n320_), .c(new_n324_), .O(new_n325_));
  aoi21  g163(.a(new_n325_), .b(new_n319_), .c(x043), .O(z11));
  oai22  g164(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n327_));
  nand3  g165(.a(new_n327_), .b(x084), .c(x004), .O(new_n328_));
  oai22  g166(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n329_));
  and2   g167(.a(x068), .b(x020), .O(new_n330_));
  nand2  g168(.a(x076), .b(x012), .O(new_n331_));
  nand2  g169(.a(x052), .b(x036), .O(new_n332_));
  nand2  g170(.a(new_n332_), .b(new_n331_), .O(new_n333_));
  aoi21  g171(.a(new_n330_), .b(new_n329_), .c(new_n333_), .O(new_n334_));
  aoi21  g172(.a(new_n334_), .b(new_n328_), .c(x044), .O(z12));
