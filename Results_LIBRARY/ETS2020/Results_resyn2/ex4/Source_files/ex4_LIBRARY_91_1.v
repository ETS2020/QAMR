// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:55 2020
...
module FAU ( 
  ...
  nand3  g166(.a(new_n326_), .b(x065), .c(x017), .O(new_n327_));
  oai21  g167(.a(x073), .b(x049), .c(new_n167_), .O(new_n328_));
  nor2   g168(.a(new_n159_), .b(new_n158_), .O(new_n329_));
  oai22  g169(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n330_));
  aoi21  g170(.a(new_n329_), .b(new_n328_), .c(new_n330_), .O(new_n331_));
  aoi21  g171(.a(new_n331_), .b(new_n327_), .c(x041), .O(z09));
  oai22  g172(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n333_));
  nand3  g173(.a(new_n333_), .b(x066), .c(x018), .O(new_n334_));
  oai21  g174(.a(x074), .b(x050), .c(new_n182_), .O(new_n335_));
  nor2   g175(.a(new_n174_), .b(new_n173_), .O(new_n336_));
  oai22  g176(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n337_));
  ...
  oai21  g181(.a(x075), .b(x051), .c(new_n197_), .O(new_n342_));
  nor2   g182(.a(new_n189_), .b(new_n188_), .O(new_n343_));
  oai22  g183(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n344_));
