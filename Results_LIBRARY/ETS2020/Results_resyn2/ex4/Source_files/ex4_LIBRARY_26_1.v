// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:00 2020
...
module FAU ( 
  ...
  oai22  g226(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n387_));
  nand3  g227(.a(new_n387_), .b(x067), .c(x019), .O(new_n388_));
  oai21  g228(.a(x075), .b(x051), .c(new_n197_), .O(new_n389_));
  nor2   g229(.a(new_n189_), .b(new_n188_), .O(new_n390_));
  oai22  g230(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n391_));
  aoi21  g231(.a(new_n390_), .b(new_n389_), .c(new_n391_), .O(new_n392_));
  aoi21  g232(.a(new_n392_), .b(new_n388_), .c(x043), .O(z11));
