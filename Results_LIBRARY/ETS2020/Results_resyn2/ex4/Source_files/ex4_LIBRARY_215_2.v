// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:38 2020
...
module FAU ( 
  ...
  oai22  g161(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n322_));
  nand3  g162(.a(new_n322_), .b(x065), .c(x017), .O(new_n323_));
  oai21  g163(.a(x073), .b(x049), .c(new_n179_), .O(new_n324_));
  nor2   g164(.a(new_n171_), .b(new_n170_), .O(new_n325_));
  oai22  g165(.a(new_n175_), .b(new_n172_), .c(new_n174_), .d(new_n173_), .O(new_n326_));
  aoi21  g166(.a(new_n325_), .b(new_n324_), .c(new_n326_), .O(new_n327_));
  aoi21  g167(.a(new_n327_), .b(new_n323_), .c(x041), .O(z09));
  oai22  g168(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n329_));
  nand3  g169(.a(new_n329_), .b(x082), .c(x002), .O(new_n330_));
  oai22  g170(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n331_));
  and2   g171(.a(x066), .b(x018), .O(new_n332_));
  nand2  g172(.a(x074), .b(x010), .O(new_n333_));
  nand2  g173(.a(x050), .b(x034), .O(new_n334_));
  nand2  g174(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  aoi21  g175(.a(new_n332_), .b(new_n331_), .c(new_n335_), .O(new_n336_));
  aoi21  g176(.a(new_n336_), .b(new_n330_), .c(x042), .O(z10));
