...
module FAU ( 
  ...
  oai21  g106(.a(x075), .b(x051), .c(new_n181_), .O(new_n269_));
  nor2   g107(.a(new_n173_), .b(new_n172_), .O(new_n270_));
  oai22  g108(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n271_));
  ...
  nand3  g112(.a(new_n274_), .b(x068), .c(x020), .O(new_n275_));
  oai21  g113(.a(x076), .b(x052), .c(new_n196_), .O(new_n276_));
  nor2   g114(.a(new_n188_), .b(new_n187_), .O(new_n277_));
  oai22  g115(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n278_));
  aoi21  g116(.a(new_n277_), .b(new_n276_), .c(new_n278_), .O(new_n279_));
  aoi21  g117(.a(new_n279_), .b(new_n275_), .c(x044), .O(z12));
  zero   g118(.O(z00));
  zero   g119(.O(z01));
  zero   g120(.O(z05));
  zero   g121(.O(z06));
