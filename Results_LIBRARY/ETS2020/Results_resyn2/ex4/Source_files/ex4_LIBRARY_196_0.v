...
module FAU ( 
  ...
  oai22  g70(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n233_));
  nand3  g71(.a(new_n233_), .b(x084), .c(x004), .O(new_n234_));
  oai22  g72(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n235_));
  and2   g73(.a(x068), .b(x020), .O(new_n236_));
  nand2  g74(.a(x052), .b(x036), .O(new_n237_));
  nand2  g75(.a(x076), .b(x012), .O(new_n238_));
  nand2  g76(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  aoi21  g77(.a(new_n236_), .b(new_n235_), .c(new_n239_), .O(new_n240_));
  aoi21  g78(.a(new_n240_), .b(new_n234_), .c(x044), .O(z12));
  zero   g79(.O(z01));
  zero   g80(.O(z05));
  zero   g81(.O(z06));
  zero   g82(.O(z07));
