...
module FAU ( 
  ...
  and2   g107(.a(x066), .b(x018), .O(new_n269_));
  nand2  g108(.a(x074), .b(x010), .O(new_n270_));
  nand2  g109(.a(x050), .b(x034), .O(new_n271_));
  nand2  g110(.a(new_n271_), .b(new_n270_), .O(new_n272_));
  aoi21  g111(.a(new_n269_), .b(new_n268_), .c(new_n272_), .O(new_n273_));
  aoi21  g112(.a(new_n273_), .b(new_n267_), .c(x042), .O(z10));
