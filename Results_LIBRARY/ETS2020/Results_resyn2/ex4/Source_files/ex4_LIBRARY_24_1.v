// Benchmark "FAU" written by ABC on Sat Jul 25 09:17:58 2020
...
module FAU ( 
  ...
  oai21  g180(.a(x073), .b(x049), .c(new_n167_), .O(new_n340_));
  nor2   g181(.a(new_n159_), .b(new_n158_), .O(new_n341_));
  oai22  g182(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n342_));
