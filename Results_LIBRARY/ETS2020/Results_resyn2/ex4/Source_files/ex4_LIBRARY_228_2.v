// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:49 2020
...
module FAU ( 
  ...
  oai22  g199(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n359_));
  nand3  g200(.a(new_n359_), .b(x084), .c(x004), .O(new_n360_));
  oai22  g201(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n361_));
  and2   g202(.a(x068), .b(x020), .O(new_n362_));
  nand2  g203(.a(x076), .b(x012), .O(new_n363_));
  nand2  g204(.a(x052), .b(x036), .O(new_n364_));
  nand2  g205(.a(new_n364_), .b(new_n363_), .O(new_n365_));
  aoi21  g206(.a(new_n362_), .b(new_n361_), .c(new_n365_), .O(new_n366_));
  aoi21  g207(.a(new_n366_), .b(new_n360_), .c(x044), .O(z12));
