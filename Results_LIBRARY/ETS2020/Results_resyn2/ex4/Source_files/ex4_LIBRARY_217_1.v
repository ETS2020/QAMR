...
module FAU ( 
  ...
  nand3  g162(.a(new_n323_), .b(x066), .c(x018), .O(new_n324_));
  oai21  g163(.a(x074), .b(x050), .c(new_n180_), .O(new_n325_));
  nor2   g164(.a(new_n172_), .b(new_n171_), .O(new_n326_));
  oai22  g165(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n327_));
  aoi21  g166(.a(new_n326_), .b(new_n325_), .c(new_n327_), .O(new_n328_));
  aoi21  g167(.a(new_n328_), .b(new_n324_), .c(x042), .O(z10));
  oai22  g168(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n330_));
  nand3  g169(.a(new_n330_), .b(x083), .c(x003), .O(new_n331_));
  oai22  g170(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n332_));
  and2   g171(.a(x067), .b(x019), .O(new_n333_));
  nand2  g172(.a(x075), .b(x011), .O(new_n334_));
  nand2  g173(.a(x051), .b(x035), .O(new_n335_));
  nand2  g174(.a(new_n335_), .b(new_n334_), .O(new_n336_));
  aoi21  g175(.a(new_n333_), .b(new_n332_), .c(new_n336_), .O(new_n337_));
  aoi21  g176(.a(new_n337_), .b(new_n331_), .c(x043), .O(z11));
