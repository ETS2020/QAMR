// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:50 2020
...
module FAU ( 
  ...
  nand3  g201(.a(new_n361_), .b(x065), .c(x017), .O(new_n362_));
  oai21  g202(.a(x073), .b(x049), .c(new_n167_), .O(new_n363_));
  nor2   g203(.a(new_n159_), .b(new_n158_), .O(new_n364_));
  oai22  g204(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n365_));
  aoi21  g205(.a(new_n364_), .b(new_n363_), .c(new_n365_), .O(new_n366_));
  aoi21  g206(.a(new_n366_), .b(new_n362_), .c(x041), .O(z09));
