...
module FAU ( 
  ...
  oai22  g104(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n268_));
  nand3  g105(.a(new_n268_), .b(x068), .c(x020), .O(new_n269_));
  oai21  g106(.a(x076), .b(x052), .c(new_n210_), .O(new_n270_));
  nor2   g107(.a(new_n202_), .b(new_n201_), .O(new_n271_));
  oai22  g108(.a(new_n206_), .b(new_n203_), .c(new_n205_), .d(new_n204_), .O(new_n272_));
  aoi21  g109(.a(new_n271_), .b(new_n270_), .c(new_n272_), .O(new_n273_));
  aoi21  g110(.a(new_n273_), .b(new_n269_), .c(x044), .O(z12));
  zero   g111(.O(z01));
  zero   g112(.O(z05));
  zero   g113(.O(z06));
  zero   g114(.O(z07));
