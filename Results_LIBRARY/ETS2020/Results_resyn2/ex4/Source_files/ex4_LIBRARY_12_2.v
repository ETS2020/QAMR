...
module FAU ( 
  ...
  inv1   g047(.a(x044), .O(new_n205_));
  inv1   g048(.a(x012), .O(new_n206_));
  inv1   g049(.a(x036), .O(new_n207_));
  inv1   g050(.a(x052), .O(new_n208_));
  inv1   g051(.a(x076), .O(new_n209_));
  oai22  g052(.a(new_n209_), .b(new_n208_), .c(new_n207_), .d(new_n206_), .O(new_n210_));
  nor2   g053(.a(x084), .b(x004), .O(new_n211_));
  nand2  g054(.a(new_n211_), .b(new_n210_), .O(new_n212_));
  oai22  g055(.a(new_n209_), .b(new_n207_), .c(new_n208_), .d(new_n206_), .O(new_n213_));
  nor2   g056(.a(x068), .b(x020), .O(new_n214_));
  oai22  g057(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n215_));
  aoi21  g058(.a(new_n214_), .b(new_n213_), .c(new_n215_), .O(new_n216_));
  aoi21  g059(.a(new_n216_), .b(new_n212_), .c(new_n205_), .O(z04));
  ...
  oai22  g233(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n392_));
  nand3  g234(.a(new_n392_), .b(x082), .c(x002), .O(new_n393_));
  oai22  g235(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n394_));
  and2   g236(.a(x066), .b(x018), .O(new_n395_));
  nand2  g237(.a(x074), .b(x010), .O(new_n396_));
  nand2  g238(.a(x050), .b(x034), .O(new_n397_));
  nand2  g239(.a(new_n397_), .b(new_n396_), .O(new_n398_));
  aoi21  g240(.a(new_n395_), .b(new_n394_), .c(new_n398_), .O(new_n399_));
  aoi21  g241(.a(new_n399_), .b(new_n393_), .c(x042), .O(z10));
  oai22  g242(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n401_));
  nand3  g243(.a(new_n401_), .b(x067), .c(x019), .O(new_n402_));
  oai21  g244(.a(x075), .b(x051), .c(new_n199_), .O(new_n403_));
  nor2   g245(.a(new_n191_), .b(new_n190_), .O(new_n404_));
  oai22  g246(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n405_));
