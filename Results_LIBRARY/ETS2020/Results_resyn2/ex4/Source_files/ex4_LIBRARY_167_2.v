// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:59 2020
...
module FAU ( 
  ...
  oai21  g235(.a(x075), .b(x051), .c(new_n211_), .O(new_n395_));
  nor2   g236(.a(new_n203_), .b(new_n202_), .O(new_n396_));
  oai22  g237(.a(new_n207_), .b(new_n204_), .c(new_n206_), .d(new_n205_), .O(new_n397_));
