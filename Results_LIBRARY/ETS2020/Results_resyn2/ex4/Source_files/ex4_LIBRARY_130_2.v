...
module FAU ( 
  ...
  oai22  g224(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n383_));
  nand3  g225(.a(new_n383_), .b(x081), .c(x001), .O(new_n384_));
  oai22  g226(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n385_));
  and2   g227(.a(x065), .b(x017), .O(new_n386_));
  nand2  g228(.a(x073), .b(x009), .O(new_n387_));
  nand2  g229(.a(x049), .b(x033), .O(new_n388_));
  nand2  g230(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  aoi21  g231(.a(new_n386_), .b(new_n385_), .c(new_n389_), .O(new_n390_));
  aoi21  g232(.a(new_n390_), .b(new_n384_), .c(x041), .O(z09));
  oai22  g233(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n392_));
  nand3  g234(.a(new_n392_), .b(x066), .c(x018), .O(new_n393_));
  oai21  g235(.a(x074), .b(x050), .c(new_n184_), .O(new_n394_));
  nor2   g236(.a(new_n176_), .b(new_n175_), .O(new_n395_));
  oai22  g237(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n396_));
