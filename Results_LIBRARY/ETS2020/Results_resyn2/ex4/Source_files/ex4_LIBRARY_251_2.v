...
module FAU ( 
  ...
  oai21  g220(.a(x075), .b(x051), .c(new_n169_), .O(new_n381_));
  nor2   g221(.a(new_n161_), .b(new_n160_), .O(new_n382_));
  oai22  g222(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n383_));
