// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:51 2020
...
module FAU ( 
  ...
  nand3  g199(.a(new_n359_), .b(x065), .c(x017), .O(new_n360_));
  oai21  g200(.a(x073), .b(x049), .c(new_n183_), .O(new_n361_));
  nor2   g201(.a(new_n175_), .b(new_n174_), .O(new_n362_));
  oai22  g202(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n363_));
  aoi21  g203(.a(new_n362_), .b(new_n361_), .c(new_n363_), .O(new_n364_));
  aoi21  g204(.a(new_n364_), .b(new_n360_), .c(x041), .O(z09));
  ...
  nand2  g224(.a(new_n202_), .b(new_n197_), .O(new_n386_));
  nand2  g225(.a(new_n386_), .b(new_n206_), .O(new_n387_));
  ...
  oai21  g231(.a(new_n236_), .b(x029), .c(new_n392_), .O(new_n393_));
  oai21  g232(.a(new_n202_), .b(x109), .c(x037), .O(new_n394_));
  nand2  g233(.a(new_n394_), .b(x117), .O(new_n395_));
  inv1   g234(.a(x109), .O(new_n396_));
  oai21  g235(.a(new_n197_), .b(x061), .c(new_n396_), .O(new_n397_));
  nand2  g236(.a(new_n397_), .b(new_n200_), .O(new_n398_));
  ...
  nand4  g239(.a(x125), .b(new_n235_), .c(new_n200_), .d(x013), .O(new_n401_));
  aoi21  g240(.a(new_n401_), .b(new_n400_), .c(x053), .O(new_n402_));
  nand3  g241(.a(x085), .b(new_n200_), .c(new_n210_), .O(new_n403_));
  inv1   g242(.a(new_n403_), .O(new_n404_));
  oai21  g243(.a(new_n404_), .b(new_n402_), .c(x005), .O(new_n405_));
  nand2  g244(.a(new_n213_), .b(x029), .O(new_n406_));
  nand2  g245(.a(new_n406_), .b(new_n211_), .O(new_n407_));
  nand2  g246(.a(new_n407_), .b(new_n385_), .O(new_n408_));
  aoi21  g247(.a(new_n408_), .b(new_n210_), .c(new_n388_), .O(new_n409_));
  nor2   g248(.a(new_n215_), .b(x021), .O(new_n410_));
  oai21  g249(.a(new_n410_), .b(new_n236_), .c(x069), .O(new_n411_));
  nand4  g250(.a(new_n392_), .b(new_n386_), .c(new_n213_), .d(x029), .O(new_n412_));
  aoi21  g251(.a(new_n412_), .b(new_n411_), .c(x077), .O(new_n413_));
  oai21  g252(.a(new_n413_), .b(new_n409_), .c(new_n194_), .O(new_n414_));
  aoi21  g253(.a(x021), .b(x013), .c(new_n215_), .O(new_n415_));
  nor2   g254(.a(x077), .b(new_n200_), .O(new_n416_));
  oai21  g255(.a(new_n415_), .b(new_n236_), .c(new_n416_), .O(new_n417_));
  ...
  aoi21  g261(.a(new_n418_), .b(new_n209_), .c(new_n422_), .O(new_n423_));
  aoi21  g262(.a(new_n423_), .b(new_n405_), .c(x045), .O(z13));
  nand2  g263(.a(new_n261_), .b(new_n257_), .O(new_n425_));
  nand2  g264(.a(new_n425_), .b(new_n295_), .O(new_n426_));
  ...
  oai21  g270(.a(new_n296_), .b(x030), .c(new_n431_), .O(new_n432_));
  oai21  g271(.a(new_n261_), .b(x110), .c(x038), .O(new_n433_));
  nand2  g272(.a(new_n433_), .b(x118), .O(new_n434_));
  oai21  g273(.a(new_n257_), .b(x062), .c(new_n254_), .O(new_n435_));
  nand2  g274(.a(new_n435_), .b(new_n260_), .O(new_n436_));
  nand4  g275(.a(new_n436_), .b(new_n434_), .c(new_n432_), .d(new_n430_), .O(new_n437_));
  oai21  g276(.a(new_n437_), .b(new_n428_), .c(new_n289_), .O(new_n438_));
  nand4  g277(.a(x126), .b(new_n294_), .c(new_n260_), .d(x014), .O(new_n439_));
  aoi21  g278(.a(new_n439_), .b(new_n438_), .c(x054), .O(new_n440_));
  nand3  g279(.a(x086), .b(new_n260_), .c(new_n270_), .O(new_n441_));
  inv1   g280(.a(new_n441_), .O(new_n442_));
  oai21  g281(.a(new_n442_), .b(new_n440_), .c(x006), .O(new_n443_));
  nand2  g282(.a(new_n273_), .b(x030), .O(new_n444_));
  nand2  g283(.a(new_n444_), .b(new_n271_), .O(new_n445_));
  nand2  g284(.a(new_n445_), .b(new_n289_), .O(new_n446_));
  aoi21  g285(.a(new_n446_), .b(new_n270_), .c(new_n427_), .O(new_n447_));
  nor2   g286(.a(new_n293_), .b(x022), .O(new_n448_));
  oai21  g287(.a(new_n448_), .b(new_n296_), .c(x070), .O(new_n449_));
  nand4  g288(.a(new_n431_), .b(new_n425_), .c(new_n273_), .d(x030), .O(new_n450_));
  aoi21  g289(.a(new_n450_), .b(new_n449_), .c(x078), .O(new_n451_));
  oai21  g290(.a(new_n451_), .b(new_n447_), .c(new_n253_), .O(new_n452_));
  nand2  g291(.a(new_n431_), .b(x030), .O(new_n453_));
  nand2  g292(.a(new_n453_), .b(new_n285_), .O(new_n454_));
  nand3  g293(.a(new_n454_), .b(new_n289_), .c(x038), .O(new_n455_));
  ...
  nand3  g298(.a(new_n459_), .b(new_n458_), .c(new_n304_), .O(new_n460_));
  aoi21  g299(.a(new_n456_), .b(new_n269_), .c(new_n460_), .O(new_n461_));
