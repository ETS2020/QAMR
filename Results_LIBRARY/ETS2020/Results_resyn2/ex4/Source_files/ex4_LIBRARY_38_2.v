// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:10 2020
...
module FAU ( 
  ...
  inv1   g032(.a(x004), .O(new_n191_));
  inv1   g033(.a(x084), .O(new_n192_));
  inv1   g034(.a(x012), .O(new_n193_));
  inv1   g035(.a(x036), .O(new_n194_));
  inv1   g036(.a(x052), .O(new_n195_));
  inv1   g037(.a(x076), .O(new_n196_));
  oai22  g038(.a(new_n196_), .b(new_n195_), .c(new_n194_), .d(new_n193_), .O(new_n197_));
  nand3  g039(.a(new_n197_), .b(new_n192_), .c(new_n191_), .O(new_n198_));
  nand3  g040(.a(new_n196_), .b(new_n195_), .c(x036), .O(new_n199_));
  nand2  g041(.a(new_n194_), .b(new_n193_), .O(new_n200_));
  nor2   g042(.a(x068), .b(x020), .O(new_n201_));
  nand3  g043(.a(new_n201_), .b(new_n200_), .c(new_n199_), .O(new_n202_));
  aoi22  g044(.a(new_n196_), .b(new_n193_), .c(new_n195_), .d(new_n194_), .O(new_n203_));
  nand3  g045(.a(new_n203_), .b(new_n202_), .c(new_n198_), .O(new_n204_));
  and2   g046(.a(new_n204_), .b(x044), .O(z04));
  ...
  oai22  g220(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n381_));
  nand3  g221(.a(new_n381_), .b(x083), .c(x003), .O(new_n382_));
  oai22  g222(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n383_));
  and2   g223(.a(x067), .b(x019), .O(new_n384_));
  nand2  g224(.a(x075), .b(x011), .O(new_n385_));
  nand2  g225(.a(x051), .b(x035), .O(new_n386_));
  nand2  g226(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  aoi21  g227(.a(new_n384_), .b(new_n383_), .c(new_n387_), .O(new_n388_));
  aoi21  g228(.a(new_n388_), .b(new_n382_), .c(x043), .O(z11));
  oai22  g229(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n390_));
  nand3  g230(.a(new_n390_), .b(x068), .c(x020), .O(new_n391_));
  oai21  g231(.a(x076), .b(x052), .c(new_n200_), .O(new_n392_));
  nor2   g232(.a(new_n192_), .b(new_n191_), .O(new_n393_));
  oai22  g233(.a(new_n196_), .b(new_n193_), .c(new_n195_), .d(new_n194_), .O(new_n394_));
  aoi21  g234(.a(new_n393_), .b(new_n392_), .c(new_n394_), .O(new_n395_));
  aoi21  g235(.a(new_n395_), .b(new_n391_), .c(x044), .O(z12));
