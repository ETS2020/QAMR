...
module FAU ( 
  ...
  oai21  g185(.a(x074), .b(x050), .c(new_n194_), .O(new_n345_));
  nor2   g186(.a(new_n186_), .b(new_n185_), .O(new_n346_));
  oai22  g187(.a(new_n190_), .b(new_n187_), .c(new_n189_), .d(new_n188_), .O(new_n347_));
