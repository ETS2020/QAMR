...
module FAU ( 
  ...
  oai21  g217(.a(x074), .b(x050), .c(new_n168_), .O(new_n378_));
  nor2   g218(.a(new_n160_), .b(new_n159_), .O(new_n379_));
  oai22  g219(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n380_));
  ...
  oai21  g224(.a(x075), .b(x051), .c(new_n183_), .O(new_n385_));
  nor2   g225(.a(new_n175_), .b(new_n174_), .O(new_n386_));
  oai22  g226(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n387_));
