// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:26 2020
...
module FAU ( 
  ...
  oai22  g242(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n401_));
  nand3  g243(.a(new_n401_), .b(x083), .c(x003), .O(new_n402_));
  oai22  g244(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n403_));
  and2   g245(.a(x067), .b(x019), .O(new_n404_));
  nand2  g246(.a(x075), .b(x011), .O(new_n405_));
  nand2  g247(.a(x051), .b(x035), .O(new_n406_));
  nand2  g248(.a(new_n406_), .b(new_n405_), .O(new_n407_));
  aoi21  g249(.a(new_n404_), .b(new_n403_), .c(new_n407_), .O(new_n408_));
  aoi21  g250(.a(new_n408_), .b(new_n402_), .c(x043), .O(z11));
