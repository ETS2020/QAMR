...
module FAU ( 
  ...
  oai21  g235(.a(x076), .b(x052), .c(new_n210_), .O(new_n396_));
  nor2   g236(.a(new_n202_), .b(new_n201_), .O(new_n397_));
  oai22  g237(.a(new_n206_), .b(new_n203_), .c(new_n205_), .d(new_n204_), .O(new_n398_));
