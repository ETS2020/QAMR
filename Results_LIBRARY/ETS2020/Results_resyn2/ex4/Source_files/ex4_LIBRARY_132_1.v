// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:30 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n313_, new_n314_, new_n315_, new_n316_, new_n322_, new_n323_,
  ...
  oai22  g159(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n322_));
  nand3  g160(.a(new_n322_), .b(x083), .c(x003), .O(new_n323_));
  oai22  g161(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n324_));
  and2   g162(.a(x067), .b(x019), .O(new_n325_));
  nand2  g163(.a(x075), .b(x011), .O(new_n326_));
  nand2  g164(.a(x051), .b(x035), .O(new_n327_));
  nand2  g165(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  aoi21  g166(.a(new_n325_), .b(new_n324_), .c(new_n328_), .O(new_n329_));
  aoi21  g167(.a(new_n329_), .b(new_n323_), .c(x043), .O(z11));
  inv1   g168(.a(x077), .O(new_n332_));
  nand2  g169(.a(new_n208_), .b(new_n203_), .O(new_n333_));
  nand2  g170(.a(new_n333_), .b(new_n212_), .O(new_n334_));
  nor2   g171(.a(x117), .b(x109), .O(new_n335_));
  aoi21  g172(.a(new_n335_), .b(new_n334_), .c(x069), .O(new_n336_));
  nor2   g173(.a(x117), .b(x021), .O(new_n337_));
  aoi21  g174(.a(new_n337_), .b(x125), .c(x085), .O(new_n338_));
  nand2  g175(.a(x021), .b(x013), .O(new_n339_));
  oai21  g176(.a(new_n242_), .b(x029), .c(new_n339_), .O(new_n340_));
  oai21  g177(.a(new_n208_), .b(x109), .c(x037), .O(new_n341_));
  nand2  g178(.a(new_n341_), .b(x117), .O(new_n342_));
  inv1   g179(.a(x109), .O(new_n343_));
  oai21  g180(.a(new_n203_), .b(x061), .c(new_n343_), .O(new_n344_));
  nand2  g181(.a(new_n344_), .b(new_n206_), .O(new_n345_));
  nand4  g182(.a(new_n345_), .b(new_n342_), .c(new_n340_), .d(new_n338_), .O(new_n346_));
  oai21  g183(.a(new_n346_), .b(new_n336_), .c(new_n332_), .O(new_n347_));
  nand4  g184(.a(x125), .b(new_n241_), .c(new_n206_), .d(x013), .O(new_n348_));
  aoi21  g185(.a(new_n348_), .b(new_n347_), .c(x053), .O(new_n349_));
  nand3  g186(.a(x085), .b(new_n206_), .c(new_n216_), .O(new_n350_));
  inv1   g187(.a(new_n350_), .O(new_n351_));
  oai21  g188(.a(new_n351_), .b(new_n349_), .c(x005), .O(new_n352_));
  nand2  g189(.a(new_n219_), .b(x029), .O(new_n353_));
  nand2  g190(.a(new_n353_), .b(new_n217_), .O(new_n354_));
  nand2  g191(.a(new_n354_), .b(new_n332_), .O(new_n355_));
  aoi21  g192(.a(new_n355_), .b(new_n216_), .c(new_n335_), .O(new_n356_));
  nor2   g193(.a(new_n221_), .b(x021), .O(new_n357_));
  oai21  g194(.a(new_n357_), .b(new_n242_), .c(x069), .O(new_n358_));
  nand4  g195(.a(new_n339_), .b(new_n333_), .c(new_n219_), .d(x029), .O(new_n359_));
  aoi21  g196(.a(new_n359_), .b(new_n358_), .c(x077), .O(new_n360_));
  oai21  g197(.a(new_n360_), .b(new_n356_), .c(new_n200_), .O(new_n361_));
  aoi21  g198(.a(x021), .b(x013), .c(new_n221_), .O(new_n362_));
  nor2   g199(.a(x077), .b(new_n206_), .O(new_n363_));
  oai21  g200(.a(new_n362_), .b(new_n242_), .c(new_n363_), .O(new_n364_));
  nand2  g201(.a(new_n364_), .b(new_n361_), .O(new_n365_));
  oai22  g202(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n366_));
  nand3  g203(.a(new_n366_), .b(x069), .c(x021), .O(new_n367_));
  aoi22  g204(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n368_));
  nand2  g205(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  aoi21  g206(.a(new_n365_), .b(new_n215_), .c(new_n369_), .O(new_n370_));
  aoi21  g207(.a(new_n370_), .b(new_n352_), .c(x045), .O(z13));
  nand2  g208(.a(new_n267_), .b(new_n263_), .O(new_n372_));
  nand2  g209(.a(new_n372_), .b(new_n301_), .O(new_n373_));
  nor2   g210(.a(x118), .b(x110), .O(new_n374_));
  aoi21  g211(.a(new_n374_), .b(new_n373_), .c(x070), .O(new_n375_));
  nor2   g212(.a(x118), .b(x022), .O(new_n376_));
  aoi21  g213(.a(new_n376_), .b(x126), .c(x086), .O(new_n377_));
  nand2  g214(.a(x022), .b(x014), .O(new_n378_));
  oai21  g215(.a(new_n302_), .b(x030), .c(new_n378_), .O(new_n379_));
  oai21  g216(.a(new_n267_), .b(x110), .c(x038), .O(new_n380_));
  nand2  g217(.a(new_n380_), .b(x118), .O(new_n381_));
  oai21  g218(.a(new_n263_), .b(x062), .c(new_n260_), .O(new_n382_));
  nand2  g219(.a(new_n382_), .b(new_n266_), .O(new_n383_));
  nand4  g220(.a(new_n383_), .b(new_n381_), .c(new_n379_), .d(new_n377_), .O(new_n384_));
  oai21  g221(.a(new_n384_), .b(new_n375_), .c(new_n295_), .O(new_n385_));
  nand4  g222(.a(x126), .b(new_n300_), .c(new_n266_), .d(x014), .O(new_n386_));
  aoi21  g223(.a(new_n386_), .b(new_n385_), .c(x054), .O(new_n387_));
  nand3  g224(.a(x086), .b(new_n266_), .c(new_n276_), .O(new_n388_));
  inv1   g225(.a(new_n388_), .O(new_n389_));
  oai21  g226(.a(new_n389_), .b(new_n387_), .c(x006), .O(new_n390_));
  nand2  g227(.a(new_n279_), .b(x030), .O(new_n391_));
  nand2  g228(.a(new_n391_), .b(new_n277_), .O(new_n392_));
  nand2  g229(.a(new_n392_), .b(new_n295_), .O(new_n393_));
  aoi21  g230(.a(new_n393_), .b(new_n276_), .c(new_n374_), .O(new_n394_));
  nor2   g231(.a(new_n299_), .b(x022), .O(new_n395_));
  oai21  g232(.a(new_n395_), .b(new_n302_), .c(x070), .O(new_n396_));
  nand4  g233(.a(new_n378_), .b(new_n372_), .c(new_n279_), .d(x030), .O(new_n397_));
  aoi21  g234(.a(new_n397_), .b(new_n396_), .c(x078), .O(new_n398_));
  oai21  g235(.a(new_n398_), .b(new_n394_), .c(new_n259_), .O(new_n399_));
  nand2  g236(.a(new_n378_), .b(x030), .O(new_n400_));
  nand2  g237(.a(new_n400_), .b(new_n291_), .O(new_n401_));
  nand3  g238(.a(new_n401_), .b(new_n295_), .c(x038), .O(new_n402_));
  nand2  g239(.a(new_n402_), .b(new_n399_), .O(new_n403_));
  oai22  g240(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n404_));
  nand3  g241(.a(new_n404_), .b(x070), .c(x022), .O(new_n405_));
  nand2  g242(.a(x078), .b(x014), .O(new_n406_));
  nand3  g243(.a(new_n406_), .b(new_n405_), .c(new_n310_), .O(new_n407_));
  aoi21  g244(.a(new_n403_), .b(new_n275_), .c(new_n407_), .O(new_n408_));
  aoi21  g245(.a(new_n408_), .b(new_n390_), .c(x046), .O(z14));
  zero   g246(.O(z00));
  zero   g247(.O(z03));
  zero   g248(.O(z07));
  zero   g249(.O(z08));
