// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:58 2020
...
module FAU ( 
  ...
  oai21  g226(.a(x074), .b(x050), .c(new_n182_), .O(new_n386_));
  nor2   g227(.a(new_n174_), .b(new_n173_), .O(new_n387_));
  oai22  g228(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n388_));
  ...
  oai21  g233(.a(x075), .b(x051), .c(new_n197_), .O(new_n393_));
  nor2   g234(.a(new_n189_), .b(new_n188_), .O(new_n394_));
  oai22  g235(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n395_));
  ...
  and2   g241(.a(x068), .b(x020), .O(new_n401_));
  nand2  g242(.a(x076), .b(x012), .O(new_n402_));
  nand2  g243(.a(x052), .b(x036), .O(new_n403_));
  nand2  g244(.a(new_n403_), .b(new_n402_), .O(new_n404_));
  aoi21  g245(.a(new_n401_), .b(new_n400_), .c(new_n404_), .O(new_n405_));
  aoi21  g246(.a(new_n405_), .b(new_n399_), .c(x044), .O(z12));
