// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:12 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n214_, new_n215_, new_n221_, new_n222_, new_n223_, new_n224_,
  ...
  oai21  g108(.a(x073), .b(x049), .c(new_n183_), .O(new_n269_));
  nor2   g109(.a(new_n175_), .b(new_n174_), .O(new_n270_));
  oai22  g110(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n271_));
  aoi21  g111(.a(new_n270_), .b(new_n269_), .c(new_n271_), .O(new_n272_));
  aoi21  g112(.a(new_n272_), .b(new_n268_), .c(x041), .O(z09));
  oai22  g113(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n275_));
  nand3  g114(.a(new_n275_), .b(x067), .c(x019), .O(new_n276_));
  oai21  g115(.a(x075), .b(x051), .c(new_n211_), .O(new_n277_));
  nor2   g116(.a(new_n203_), .b(new_n202_), .O(new_n278_));
  oai22  g117(.a(new_n207_), .b(new_n204_), .c(new_n206_), .d(new_n205_), .O(new_n279_));
  aoi21  g118(.a(new_n278_), .b(new_n277_), .c(new_n279_), .O(new_n280_));
  aoi21  g119(.a(new_n280_), .b(new_n276_), .c(x043), .O(z11));
  oai22  g120(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n282_));
  nand3  g121(.a(new_n282_), .b(x084), .c(x004), .O(new_n283_));
  oai22  g122(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n284_));
  and2   g123(.a(x068), .b(x020), .O(new_n285_));
  nand2  g124(.a(x076), .b(x012), .O(new_n286_));
  nand2  g125(.a(x052), .b(x036), .O(new_n287_));
  nand2  g126(.a(new_n287_), .b(new_n286_), .O(new_n288_));
  aoi21  g127(.a(new_n285_), .b(new_n284_), .c(new_n288_), .O(new_n289_));
  aoi21  g128(.a(new_n289_), .b(new_n283_), .c(x044), .O(z12));
  zero   g129(.O(z04));
  zero   g130(.O(z05));
  zero   g131(.O(z06));
  zero   g132(.O(z07));
