...
module FAU ( 
  ...
  oai22  g177(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n338_));
  nand3  g178(.a(new_n338_), .b(x083), .c(x003), .O(new_n339_));
  oai22  g179(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n340_));
  and2   g180(.a(x067), .b(x019), .O(new_n341_));
  nand2  g181(.a(x075), .b(x011), .O(new_n342_));
  nand2  g182(.a(x051), .b(x035), .O(new_n343_));
  nand2  g183(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  aoi21  g184(.a(new_n341_), .b(new_n340_), .c(new_n344_), .O(new_n345_));
  aoi21  g185(.a(new_n345_), .b(new_n339_), .c(x043), .O(z11));
