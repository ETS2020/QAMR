// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:29 2020
...
module FAU ( 
  ...
  oai22  g095(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n259_));
  nand3  g096(.a(new_n259_), .b(x067), .c(x019), .O(new_n260_));
  oai21  g097(.a(x075), .b(x051), .c(new_n181_), .O(new_n261_));
  nor2   g098(.a(new_n173_), .b(new_n172_), .O(new_n262_));
  oai22  g099(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n263_));
  aoi21  g100(.a(new_n262_), .b(new_n261_), .c(new_n263_), .O(new_n264_));
  aoi21  g101(.a(new_n264_), .b(new_n260_), .c(x043), .O(z11));
  oai22  g102(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n266_));
  nand3  g103(.a(new_n266_), .b(x068), .c(x020), .O(new_n267_));
  oai21  g104(.a(x076), .b(x052), .c(new_n196_), .O(new_n268_));
  nor2   g105(.a(new_n188_), .b(new_n187_), .O(new_n269_));
  oai22  g106(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n270_));
  aoi21  g107(.a(new_n269_), .b(new_n268_), .c(new_n270_), .O(new_n271_));
  aoi21  g108(.a(new_n271_), .b(new_n267_), .c(x044), .O(z12));
  zero   g109(.O(z00));
  zero   g110(.O(z01));
  zero   g111(.O(z05));
  zero   g112(.O(z06));
