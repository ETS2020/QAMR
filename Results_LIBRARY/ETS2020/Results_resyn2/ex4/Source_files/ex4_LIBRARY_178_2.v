...
module FAU ( 
  ...
  oai21  g248(.a(x075), .b(x051), .c(new_n211_), .O(new_n407_));
  nor2   g249(.a(new_n203_), .b(new_n202_), .O(new_n408_));
  oai22  g250(.a(new_n207_), .b(new_n204_), .c(new_n206_), .d(new_n205_), .O(new_n409_));
