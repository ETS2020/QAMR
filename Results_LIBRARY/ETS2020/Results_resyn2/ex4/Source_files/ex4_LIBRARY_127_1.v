// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:25 2020
...
module FAU ( 
  ...
  oai21  g165(.a(x074), .b(x050), .c(new_n180_), .O(new_n327_));
  nor2   g166(.a(new_n172_), .b(new_n171_), .O(new_n328_));
  oai22  g167(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n329_));
