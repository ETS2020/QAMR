...
module FAU ( 
  ...
  and2   g208(.a(x067), .b(x019), .O(new_n370_));
  nand2  g209(.a(x075), .b(x011), .O(new_n371_));
  nand2  g210(.a(x051), .b(x035), .O(new_n372_));
  nand2  g211(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  aoi21  g212(.a(new_n370_), .b(new_n369_), .c(new_n373_), .O(new_n374_));
  aoi21  g213(.a(new_n374_), .b(new_n368_), .c(x043), .O(z11));
