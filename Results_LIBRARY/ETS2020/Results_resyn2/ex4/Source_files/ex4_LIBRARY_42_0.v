...
module FAU ( 
  ...
  oai22  g065(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n227_));
  nand3  g066(.a(new_n227_), .b(x082), .c(x002), .O(new_n228_));
  oai22  g067(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n229_));
  and2   g068(.a(x066), .b(x018), .O(new_n230_));
  nand2  g069(.a(x050), .b(x034), .O(new_n231_));
  nand2  g070(.a(x074), .b(x010), .O(new_n232_));
  nand2  g071(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  aoi21  g072(.a(new_n230_), .b(new_n229_), .c(new_n233_), .O(new_n234_));
  aoi21  g073(.a(new_n234_), .b(new_n228_), .c(x042), .O(z10));
  oai22  g074(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n236_));
  nand3  g075(.a(new_n236_), .b(x083), .c(x003), .O(new_n237_));
  oai22  g076(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n238_));
  and2   g077(.a(x067), .b(x019), .O(new_n239_));
  nand2  g078(.a(x051), .b(x035), .O(new_n240_));
  nand2  g079(.a(x075), .b(x011), .O(new_n241_));
  nand2  g080(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  aoi21  g081(.a(new_n239_), .b(new_n238_), .c(new_n242_), .O(new_n243_));
  aoi21  g082(.a(new_n243_), .b(new_n237_), .c(x043), .O(z11));
  zero   g083(.O(z05));
  zero   g084(.O(z06));
  zero   g085(.O(z07));
  zero   g086(.O(z08));
