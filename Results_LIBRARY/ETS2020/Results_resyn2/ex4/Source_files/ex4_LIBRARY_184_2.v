// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:13 2020
...
module FAU ( 
  ...
  oai22  g224(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n383_));
  nand3  g225(.a(new_n383_), .b(x065), .c(x017), .O(new_n384_));
  oai21  g226(.a(x073), .b(x049), .c(new_n183_), .O(new_n385_));
  nor2   g227(.a(new_n175_), .b(new_n174_), .O(new_n386_));
  oai22  g228(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n387_));
  aoi21  g229(.a(new_n386_), .b(new_n385_), .c(new_n387_), .O(new_n388_));
  aoi21  g230(.a(new_n388_), .b(new_n384_), .c(x041), .O(z09));
  ...
  and2   g234(.a(x066), .b(x018), .O(new_n393_));
  nand2  g235(.a(x074), .b(x010), .O(new_n394_));
  nand2  g236(.a(x050), .b(x034), .O(new_n395_));
  nand2  g237(.a(new_n395_), .b(new_n394_), .O(new_n396_));
  aoi21  g238(.a(new_n393_), .b(new_n392_), .c(new_n396_), .O(new_n397_));
  aoi21  g239(.a(new_n397_), .b(new_n391_), .c(x042), .O(z10));
