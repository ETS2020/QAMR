...
module FAU ( 
  ...
  oai22  g150(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n313_));
  nand3  g151(.a(new_n313_), .b(x082), .c(x002), .O(new_n314_));
  oai22  g152(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n315_));
  and2   g153(.a(x066), .b(x018), .O(new_n316_));
  nand2  g154(.a(x074), .b(x010), .O(new_n317_));
  nand2  g155(.a(x050), .b(x034), .O(new_n318_));
  nand2  g156(.a(new_n318_), .b(new_n317_), .O(new_n319_));
  aoi21  g157(.a(new_n316_), .b(new_n315_), .c(new_n319_), .O(new_n320_));
  aoi21  g158(.a(new_n320_), .b(new_n314_), .c(x042), .O(z10));
  oai22  g159(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n322_));
  nand3  g160(.a(new_n322_), .b(x067), .c(x019), .O(new_n323_));
  oai21  g161(.a(x075), .b(x051), .c(new_n169_), .O(new_n324_));
  nor2   g162(.a(new_n161_), .b(new_n160_), .O(new_n325_));
  oai22  g163(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n326_));
  aoi21  g164(.a(new_n325_), .b(new_n324_), .c(new_n326_), .O(new_n327_));
  aoi21  g165(.a(new_n327_), .b(new_n323_), .c(x043), .O(z11));
