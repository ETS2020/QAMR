...
module FAU ( 
  ...
  oai22  g183(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n344_));
  nand3  g184(.a(new_n344_), .b(x083), .c(x003), .O(new_n345_));
  oai22  g185(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n346_));
  and2   g186(.a(x067), .b(x019), .O(new_n347_));
  nand2  g187(.a(x075), .b(x011), .O(new_n348_));
  nand2  g188(.a(x051), .b(x035), .O(new_n349_));
  nand2  g189(.a(new_n349_), .b(new_n348_), .O(new_n350_));
  aoi21  g190(.a(new_n347_), .b(new_n346_), .c(new_n350_), .O(new_n351_));
  aoi21  g191(.a(new_n351_), .b(new_n345_), .c(x043), .O(z11));
