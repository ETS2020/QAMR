...
module FAU ( 
  ...
  and2   g107(.a(x065), .b(x017), .O(new_n268_));
  nand2  g108(.a(x073), .b(x009), .O(new_n269_));
  nand2  g109(.a(x049), .b(x033), .O(new_n270_));
  nand2  g110(.a(new_n270_), .b(new_n269_), .O(new_n271_));
  aoi21  g111(.a(new_n268_), .b(new_n267_), .c(new_n271_), .O(new_n272_));
  aoi21  g112(.a(new_n272_), .b(new_n266_), .c(x041), .O(z09));
  oai22  g113(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n275_));
  nand3  g114(.a(new_n275_), .b(x067), .c(x019), .O(new_n276_));
  oai21  g115(.a(x075), .b(x051), .c(new_n197_), .O(new_n277_));
  nor2   g116(.a(new_n189_), .b(new_n188_), .O(new_n278_));
  oai22  g117(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n279_));
