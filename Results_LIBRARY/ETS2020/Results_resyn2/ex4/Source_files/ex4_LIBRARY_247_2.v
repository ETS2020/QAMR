...
module FAU ( 
  ...
  oai22  g240(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n399_));
  nand3  g241(.a(new_n399_), .b(x083), .c(x003), .O(new_n400_));
  oai22  g242(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n401_));
  and2   g243(.a(x067), .b(x019), .O(new_n402_));
  nand2  g244(.a(x075), .b(x011), .O(new_n403_));
  nand2  g245(.a(x051), .b(x035), .O(new_n404_));
  nand2  g246(.a(new_n404_), .b(new_n403_), .O(new_n405_));
  aoi21  g247(.a(new_n402_), .b(new_n401_), .c(new_n405_), .O(new_n406_));
  aoi21  g248(.a(new_n406_), .b(new_n400_), .c(x043), .O(z11));
