// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:57 2020
...
module FAU ( 
  ...
  inv1   g032(.a(x044), .O(new_n191_));
  inv1   g033(.a(x012), .O(new_n192_));
  inv1   g034(.a(x036), .O(new_n193_));
  inv1   g035(.a(x052), .O(new_n194_));
  inv1   g036(.a(x076), .O(new_n195_));
  oai22  g037(.a(new_n195_), .b(new_n194_), .c(new_n193_), .d(new_n192_), .O(new_n196_));
  nor2   g038(.a(x084), .b(x004), .O(new_n197_));
  nand2  g039(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  oai22  g040(.a(new_n195_), .b(new_n193_), .c(new_n194_), .d(new_n192_), .O(new_n199_));
  nor2   g041(.a(x068), .b(x020), .O(new_n200_));
  oai22  g042(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n201_));
  aoi21  g043(.a(new_n200_), .b(new_n199_), .c(new_n201_), .O(new_n202_));
  aoi21  g044(.a(new_n202_), .b(new_n198_), .c(new_n191_), .O(z04));
