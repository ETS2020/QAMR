...
module FAU ( 
  ...
  oai22  g215(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n375_));
  nand3  g216(.a(new_n375_), .b(x081), .c(x001), .O(new_n376_));
  oai22  g217(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n377_));
  and2   g218(.a(x065), .b(x017), .O(new_n378_));
  nand2  g219(.a(x073), .b(x009), .O(new_n379_));
  nand2  g220(.a(x049), .b(x033), .O(new_n380_));
  nand2  g221(.a(new_n380_), .b(new_n379_), .O(new_n381_));
  aoi21  g222(.a(new_n378_), .b(new_n377_), .c(new_n381_), .O(new_n382_));
  aoi21  g223(.a(new_n382_), .b(new_n376_), .c(x041), .O(z09));
  oai22  g224(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n385_));
  nand3  g225(.a(new_n385_), .b(x067), .c(x019), .O(new_n386_));
  oai21  g226(.a(x075), .b(x051), .c(new_n181_), .O(new_n387_));
  nor2   g227(.a(new_n173_), .b(new_n172_), .O(new_n388_));
  oai22  g228(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n389_));
  ...
  oai21  g233(.a(x076), .b(x052), .c(new_n196_), .O(new_n394_));
  nor2   g234(.a(new_n188_), .b(new_n187_), .O(new_n395_));
  oai22  g235(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n396_));
