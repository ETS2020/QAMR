// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:14 2020
...
module FAU ( 
  ...
  oai22  g157(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n319_));
  nand3  g158(.a(new_n319_), .b(x082), .c(x002), .O(new_n320_));
  oai22  g159(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n321_));
  and2   g160(.a(x066), .b(x018), .O(new_n322_));
  nand2  g161(.a(x074), .b(x010), .O(new_n323_));
  nand2  g162(.a(x050), .b(x034), .O(new_n324_));
  nand2  g163(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  aoi21  g164(.a(new_n322_), .b(new_n321_), .c(new_n325_), .O(new_n326_));
  aoi21  g165(.a(new_n326_), .b(new_n320_), .c(x042), .O(z10));
  oai22  g166(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n328_));
  nand3  g167(.a(new_n328_), .b(x067), .c(x019), .O(new_n329_));
  oai21  g168(.a(x075), .b(x051), .c(new_n183_), .O(new_n330_));
  nor2   g169(.a(new_n175_), .b(new_n174_), .O(new_n331_));
  oai22  g170(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n332_));
  aoi21  g171(.a(new_n331_), .b(new_n330_), .c(new_n332_), .O(new_n333_));
  aoi21  g172(.a(new_n333_), .b(new_n329_), .c(x043), .O(z11));
