...
module FAU ( 
  ...
  oai21  g235(.a(x075), .b(x051), .c(new_n199_), .O(new_n395_));
  nor2   g236(.a(new_n191_), .b(new_n190_), .O(new_n396_));
  oai22  g237(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n397_));
