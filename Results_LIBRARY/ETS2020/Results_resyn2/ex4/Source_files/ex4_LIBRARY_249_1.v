...
module FAU ( 
  ...
  oai21  g226(.a(x075), .b(x051), .c(new_n209_), .O(new_n387_));
  nor2   g227(.a(new_n201_), .b(new_n200_), .O(new_n388_));
  oai22  g228(.a(new_n205_), .b(new_n202_), .c(new_n204_), .d(new_n203_), .O(new_n389_));
