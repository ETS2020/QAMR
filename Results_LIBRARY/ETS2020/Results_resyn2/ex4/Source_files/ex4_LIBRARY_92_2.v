// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:56 2020
...
module FAU ( 
  ...
  oai22  g213(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n374_));
  nand3  g214(.a(new_n374_), .b(x082), .c(x002), .O(new_n375_));
  oai22  g215(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n376_));
  and2   g216(.a(x066), .b(x018), .O(new_n377_));
  nand2  g217(.a(x074), .b(x010), .O(new_n378_));
  nand2  g218(.a(x050), .b(x034), .O(new_n379_));
  nand2  g219(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  aoi21  g220(.a(new_n377_), .b(new_n376_), .c(new_n380_), .O(new_n381_));
  aoi21  g221(.a(new_n381_), .b(new_n375_), .c(x042), .O(z10));
  oai22  g222(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n383_));
  nand3  g223(.a(new_n383_), .b(x067), .c(x019), .O(new_n384_));
  oai21  g224(.a(x075), .b(x051), .c(new_n185_), .O(new_n385_));
  nor2   g225(.a(new_n177_), .b(new_n176_), .O(new_n386_));
  oai22  g226(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n179_), .O(new_n387_));
