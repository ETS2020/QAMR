...
module FAU ( 
  ...
  oai22  g115(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n276_));
  nand3  g116(.a(new_n276_), .b(x082), .c(x002), .O(new_n277_));
  oai22  g117(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n278_));
  and2   g118(.a(x066), .b(x018), .O(new_n279_));
  nand2  g119(.a(x074), .b(x010), .O(new_n280_));
  nand2  g120(.a(x050), .b(x034), .O(new_n281_));
  nand2  g121(.a(new_n281_), .b(new_n280_), .O(new_n282_));
  aoi21  g122(.a(new_n279_), .b(new_n278_), .c(new_n282_), .O(new_n283_));
  aoi21  g123(.a(new_n283_), .b(new_n277_), .c(x042), .O(z10));
