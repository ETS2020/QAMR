// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:19 2020
...
module FAU ( 
  ...
  oai21  g231(.a(x076), .b(x052), .c(new_n198_), .O(new_n392_));
  nor2   g232(.a(new_n190_), .b(new_n189_), .O(new_n393_));
  oai22  g233(.a(new_n194_), .b(new_n191_), .c(new_n193_), .d(new_n192_), .O(new_n394_));
