// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:39 2020
...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n331_, new_n332_, new_n338_, new_n339_, new_n340_, new_n341_,
  ...
  oai22  g176(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n338_));
  nand3  g177(.a(new_n338_), .b(x067), .c(x019), .O(new_n339_));
  oai21  g178(.a(x075), .b(x051), .c(new_n193_), .O(new_n340_));
  nor2   g179(.a(new_n185_), .b(new_n184_), .O(new_n341_));
  oai22  g180(.a(new_n189_), .b(new_n186_), .c(new_n188_), .d(new_n187_), .O(new_n342_));
  aoi21  g181(.a(new_n341_), .b(new_n340_), .c(new_n342_), .O(new_n343_));
  aoi21  g182(.a(new_n343_), .b(new_n339_), .c(x043), .O(z11));
  oai22  g183(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n345_));
  nand3  g184(.a(new_n345_), .b(x068), .c(x020), .O(new_n346_));
  oai21  g185(.a(x076), .b(x052), .c(new_n208_), .O(new_n347_));
  nor2   g186(.a(new_n200_), .b(new_n199_), .O(new_n348_));
  oai22  g187(.a(new_n204_), .b(new_n201_), .c(new_n203_), .d(new_n202_), .O(new_n349_));
  aoi21  g188(.a(new_n348_), .b(new_n347_), .c(new_n349_), .O(new_n350_));
  aoi21  g189(.a(new_n350_), .b(new_n346_), .c(x044), .O(z12));
