// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:23 2020
...
module FAU ( 
  ...
  inv1   g193(.a(x088), .O(new_n351_));
  inv1   g194(.a(x096), .O(new_n352_));
  inv1   g195(.a(x120), .O(new_n353_));
  nand2  g196(.a(new_n353_), .b(new_n352_), .O(new_n354_));
  inv1   g197(.a(x104), .O(new_n355_));
  inv1   g198(.a(x112), .O(new_n356_));
  nand2  g199(.a(new_n356_), .b(new_n355_), .O(new_n357_));
  aoi21  g200(.a(new_n354_), .b(new_n351_), .c(new_n357_), .O(new_n358_));
  nor2   g201(.a(new_n358_), .b(x064), .O(new_n359_));
  nor2   g202(.a(x112), .b(x016), .O(new_n360_));
  aoi21  g203(.a(new_n360_), .b(x120), .c(x080), .O(new_n361_));
  nand2  g204(.a(x016), .b(x008), .O(new_n362_));
  inv1   g205(.a(x056), .O(new_n363_));
  nand2  g206(.a(new_n351_), .b(new_n363_), .O(new_n364_));
  oai21  g207(.a(new_n364_), .b(x024), .c(new_n362_), .O(new_n365_));
  oai21  g208(.a(new_n353_), .b(x104), .c(x032), .O(new_n366_));
  nand2  g209(.a(new_n366_), .b(x112), .O(new_n367_));
  oai21  g210(.a(new_n352_), .b(x056), .c(new_n355_), .O(new_n368_));
  nand2  g211(.a(new_n368_), .b(new_n162_), .O(new_n369_));
  nand4  g212(.a(new_n369_), .b(new_n367_), .c(new_n365_), .d(new_n361_), .O(new_n370_));
  oai21  g213(.a(new_n370_), .b(new_n359_), .c(new_n168_), .O(new_n371_));
  nand4  g214(.a(x120), .b(new_n363_), .c(new_n162_), .d(x008), .O(new_n372_));
  aoi21  g215(.a(new_n372_), .b(new_n371_), .c(x048), .O(new_n373_));
  nand3  g216(.a(x080), .b(new_n162_), .c(new_n166_), .O(new_n374_));
  inv1   g217(.a(new_n374_), .O(new_n375_));
  oai21  g218(.a(new_n375_), .b(new_n373_), .c(x000), .O(new_n376_));
  nor2   g219(.a(x080), .b(x048), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(x024), .O(new_n378_));
  aoi21  g221(.a(new_n378_), .b(new_n158_), .c(x032), .O(new_n379_));
  and2   g222(.a(new_n377_), .b(new_n364_), .O(new_n380_));
  oai21  g223(.a(new_n380_), .b(new_n379_), .c(x064), .O(new_n381_));
  aoi21  g224(.a(new_n362_), .b(x024), .c(new_n364_), .O(new_n382_));
  nor2   g225(.a(new_n382_), .b(new_n162_), .O(new_n383_));
  nand2  g226(.a(new_n357_), .b(x016), .O(new_n384_));
  aoi21  g227(.a(new_n362_), .b(new_n354_), .c(new_n357_), .O(new_n385_));
  oai21  g228(.a(new_n351_), .b(new_n363_), .c(x024), .O(new_n386_));
  oai21  g229(.a(new_n386_), .b(new_n385_), .c(new_n384_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n167_), .c(new_n383_), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(x080), .c(new_n381_), .O(new_n389_));
  aoi21  g232(.a(new_n377_), .b(new_n357_), .c(x072), .O(new_n390_));
  nor2   g233(.a(new_n158_), .b(x008), .O(new_n391_));
  nor2   g234(.a(new_n159_), .b(x048), .O(new_n392_));
  aoi22  g235(.a(new_n392_), .b(new_n391_), .c(x048), .d(x032), .O(new_n393_));
  oai21  g236(.a(new_n390_), .b(new_n166_), .c(new_n393_), .O(new_n394_));
  aoi21  g237(.a(new_n389_), .b(new_n168_), .c(new_n394_), .O(new_n395_));
  aoi21  g238(.a(new_n395_), .b(new_n376_), .c(x040), .O(z08));
  oai22  g239(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(x065), .c(x017), .O(new_n398_));
  oai21  g241(.a(x073), .b(x049), .c(new_n183_), .O(new_n399_));
  nor2   g242(.a(new_n175_), .b(new_n174_), .O(new_n400_));
  oai22  g243(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n401_));
  ...
  oai21  g248(.a(x074), .b(x050), .c(new_n198_), .O(new_n406_));
  nor2   g249(.a(new_n190_), .b(new_n189_), .O(new_n407_));
  oai22  g250(.a(new_n194_), .b(new_n191_), .c(new_n193_), .d(new_n192_), .O(new_n408_));
  aoi21  g251(.a(new_n407_), .b(new_n406_), .c(new_n408_), .O(new_n409_));
  aoi21  g252(.a(new_n409_), .b(new_n405_), .c(x042), .O(z10));
  inv1   g253(.a(x077), .O(new_n413_));
  nand2  g254(.a(new_n240_), .b(new_n235_), .O(new_n414_));
  nand2  g255(.a(new_n414_), .b(new_n244_), .O(new_n415_));
  nor2   g256(.a(x117), .b(x109), .O(new_n416_));
  aoi21  g257(.a(new_n416_), .b(new_n415_), .c(x069), .O(new_n417_));
  nor2   g258(.a(x117), .b(x021), .O(new_n418_));
  aoi21  g259(.a(new_n418_), .b(x125), .c(x085), .O(new_n419_));
  nand2  g260(.a(x021), .b(x013), .O(new_n420_));
  oai21  g261(.a(new_n274_), .b(x029), .c(new_n420_), .O(new_n421_));
  oai21  g262(.a(new_n240_), .b(x109), .c(x037), .O(new_n422_));
  nand2  g263(.a(new_n422_), .b(x117), .O(new_n423_));
  inv1   g264(.a(x109), .O(new_n424_));
  oai21  g265(.a(new_n235_), .b(x061), .c(new_n424_), .O(new_n425_));
  nand2  g266(.a(new_n425_), .b(new_n238_), .O(new_n426_));
  nand4  g267(.a(new_n426_), .b(new_n423_), .c(new_n421_), .d(new_n419_), .O(new_n427_));
  oai21  g268(.a(new_n427_), .b(new_n417_), .c(new_n413_), .O(new_n428_));
  nand4  g269(.a(x125), .b(new_n273_), .c(new_n238_), .d(x013), .O(new_n429_));
  aoi21  g270(.a(new_n429_), .b(new_n428_), .c(x053), .O(new_n430_));
  nand3  g271(.a(x085), .b(new_n238_), .c(new_n248_), .O(new_n431_));
  inv1   g272(.a(new_n431_), .O(new_n432_));
  oai21  g273(.a(new_n432_), .b(new_n430_), .c(x005), .O(new_n433_));
  nand2  g274(.a(new_n251_), .b(x029), .O(new_n434_));
  nand2  g275(.a(new_n434_), .b(new_n249_), .O(new_n435_));
  nand2  g276(.a(new_n435_), .b(new_n413_), .O(new_n436_));
  aoi21  g277(.a(new_n436_), .b(new_n248_), .c(new_n416_), .O(new_n437_));
  nor2   g278(.a(new_n253_), .b(x021), .O(new_n438_));
  oai21  g279(.a(new_n438_), .b(new_n274_), .c(x069), .O(new_n439_));
  nand4  g280(.a(new_n420_), .b(new_n414_), .c(new_n251_), .d(x029), .O(new_n440_));
  aoi21  g281(.a(new_n440_), .b(new_n439_), .c(x077), .O(new_n441_));
  oai21  g282(.a(new_n441_), .b(new_n437_), .c(new_n232_), .O(new_n442_));
  aoi21  g283(.a(x021), .b(x013), .c(new_n253_), .O(new_n443_));
  nor2   g284(.a(x077), .b(new_n238_), .O(new_n444_));
  oai21  g285(.a(new_n443_), .b(new_n274_), .c(new_n444_), .O(new_n445_));
  nand2  g286(.a(new_n445_), .b(new_n442_), .O(new_n446_));
  oai22  g287(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n447_));
  nand3  g288(.a(new_n447_), .b(x069), .c(x021), .O(new_n448_));
  aoi22  g289(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n449_));
  nand2  g290(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  aoi21  g291(.a(new_n446_), .b(new_n247_), .c(new_n450_), .O(new_n451_));
  aoi21  g292(.a(new_n451_), .b(new_n433_), .c(x045), .O(z13));
  nand2  g293(.a(new_n299_), .b(new_n295_), .O(new_n453_));
  nand2  g294(.a(new_n453_), .b(new_n333_), .O(new_n454_));
  nor2   g295(.a(x118), .b(x110), .O(new_n455_));
  aoi21  g296(.a(new_n455_), .b(new_n454_), .c(x070), .O(new_n456_));
  nor2   g297(.a(x118), .b(x022), .O(new_n457_));
  aoi21  g298(.a(new_n457_), .b(x126), .c(x086), .O(new_n458_));
  nand2  g299(.a(x022), .b(x014), .O(new_n459_));
  oai21  g300(.a(new_n334_), .b(x030), .c(new_n459_), .O(new_n460_));
  oai21  g301(.a(new_n299_), .b(x110), .c(x038), .O(new_n461_));
  nand2  g302(.a(new_n461_), .b(x118), .O(new_n462_));
  oai21  g303(.a(new_n295_), .b(x062), .c(new_n292_), .O(new_n463_));
  nand2  g304(.a(new_n463_), .b(new_n298_), .O(new_n464_));
  nand4  g305(.a(new_n464_), .b(new_n462_), .c(new_n460_), .d(new_n458_), .O(new_n465_));
  oai21  g306(.a(new_n465_), .b(new_n456_), .c(new_n327_), .O(new_n466_));
  nand4  g307(.a(x126), .b(new_n332_), .c(new_n298_), .d(x014), .O(new_n467_));
  aoi21  g308(.a(new_n467_), .b(new_n466_), .c(x054), .O(new_n468_));
  nand3  g309(.a(x086), .b(new_n298_), .c(new_n308_), .O(new_n469_));
  inv1   g310(.a(new_n469_), .O(new_n470_));
  oai21  g311(.a(new_n470_), .b(new_n468_), .c(x006), .O(new_n471_));
  nand2  g312(.a(new_n311_), .b(x030), .O(new_n472_));
  nand2  g313(.a(new_n472_), .b(new_n309_), .O(new_n473_));
  nand2  g314(.a(new_n473_), .b(new_n327_), .O(new_n474_));
  aoi21  g315(.a(new_n474_), .b(new_n308_), .c(new_n455_), .O(new_n475_));
  nor2   g316(.a(new_n331_), .b(x022), .O(new_n476_));
  oai21  g317(.a(new_n476_), .b(new_n334_), .c(x070), .O(new_n477_));
  nand4  g318(.a(new_n459_), .b(new_n453_), .c(new_n311_), .d(x030), .O(new_n478_));
  aoi21  g319(.a(new_n478_), .b(new_n477_), .c(x078), .O(new_n479_));
  oai21  g320(.a(new_n479_), .b(new_n475_), .c(new_n291_), .O(new_n480_));
  nand2  g321(.a(new_n459_), .b(x030), .O(new_n481_));
  nand2  g322(.a(new_n481_), .b(new_n323_), .O(new_n482_));
  nand3  g323(.a(new_n482_), .b(new_n327_), .c(x038), .O(new_n483_));
  nand2  g324(.a(new_n483_), .b(new_n480_), .O(new_n484_));
  oai22  g325(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n485_));
  nand3  g326(.a(new_n485_), .b(x070), .c(x022), .O(new_n486_));
  nand2  g327(.a(x078), .b(x014), .O(new_n487_));
  nand3  g328(.a(new_n487_), .b(new_n486_), .c(new_n342_), .O(new_n488_));
  aoi21  g329(.a(new_n484_), .b(new_n307_), .c(new_n488_), .O(new_n489_));
  aoi21  g330(.a(new_n489_), .b(new_n471_), .c(x046), .O(z14));
  zero   g331(.O(z07));
  zero   g332(.O(z11));
  zero   g333(.O(z12));
  zero   g334(.O(z15));
