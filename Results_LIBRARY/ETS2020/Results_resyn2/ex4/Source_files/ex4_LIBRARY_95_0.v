...
module FAU ( 
  ...
  oai22  g52(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n214_));
  nand3  g53(.a(new_n214_), .b(x065), .c(x017), .O(new_n215_));
  oai22  g54(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n216_));
  and2   g55(.a(x081), .b(x001), .O(new_n217_));
  ...
  oai22  g61(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n223_));
  nand3  g62(.a(new_n223_), .b(x082), .c(x002), .O(new_n224_));
  oai22  g63(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n225_));
  and2   g64(.a(x066), .b(x018), .O(new_n226_));
  nand2  g65(.a(x050), .b(x034), .O(new_n227_));
  nand2  g66(.a(x074), .b(x010), .O(new_n228_));
  nand2  g67(.a(new_n228_), .b(new_n227_), .O(new_n229_));
  aoi21  g68(.a(new_n226_), .b(new_n225_), .c(new_n229_), .O(new_n230_));
  aoi21  g69(.a(new_n230_), .b(new_n224_), .c(x042), .O(z10));
  oai22  g70(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n232_));
  nand3  g71(.a(new_n232_), .b(x083), .c(x003), .O(new_n233_));
  oai22  g72(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n234_));
  and2   g73(.a(x067), .b(x019), .O(new_n235_));
  nand2  g74(.a(x051), .b(x035), .O(new_n236_));
  nand2  g75(.a(x075), .b(x011), .O(new_n237_));
  nand2  g76(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  aoi21  g77(.a(new_n235_), .b(new_n234_), .c(new_n238_), .O(new_n239_));
  aoi21  g78(.a(new_n239_), .b(new_n233_), .c(x043), .O(z11));
  zero   g79(.O(z01));
  zero   g80(.O(z05));
  zero   g81(.O(z06));
  zero   g82(.O(z07));
