...
module FAU ( 
  ...
  oai21  g117(.a(x074), .b(x050), .c(new_n184_), .O(new_n278_));
  nor2   g118(.a(new_n176_), .b(new_n175_), .O(new_n279_));
  oai22  g119(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n280_));
  ...
  oai21  g124(.a(x075), .b(x051), .c(new_n199_), .O(new_n285_));
  nor2   g125(.a(new_n191_), .b(new_n190_), .O(new_n286_));
  oai22  g126(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n287_));
