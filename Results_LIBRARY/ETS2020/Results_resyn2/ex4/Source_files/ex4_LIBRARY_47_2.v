// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:18 2020
...
module FAU ( 
  ...
  oai22  g170(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n331_));
  nand3  g171(.a(new_n331_), .b(x082), .c(x002), .O(new_n332_));
  oai22  g172(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n333_));
  and2   g173(.a(x066), .b(x018), .O(new_n334_));
  nand2  g174(.a(x074), .b(x010), .O(new_n335_));
  nand2  g175(.a(x050), .b(x034), .O(new_n336_));
  nand2  g176(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  aoi21  g177(.a(new_n334_), .b(new_n333_), .c(new_n337_), .O(new_n338_));
  aoi21  g178(.a(new_n338_), .b(new_n332_), .c(x042), .O(z10));
  oai22  g179(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n340_));
  nand3  g180(.a(new_n340_), .b(x067), .c(x019), .O(new_n341_));
  oai21  g181(.a(x075), .b(x051), .c(new_n195_), .O(new_n342_));
  nor2   g182(.a(new_n187_), .b(new_n186_), .O(new_n343_));
  oai22  g183(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n344_));
  aoi21  g184(.a(new_n343_), .b(new_n342_), .c(new_n344_), .O(new_n345_));
  aoi21  g185(.a(new_n345_), .b(new_n341_), .c(x043), .O(z11));
  oai22  g186(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n347_));
  nand3  g187(.a(new_n347_), .b(x084), .c(x004), .O(new_n348_));
  oai22  g188(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n349_));
  and2   g189(.a(x068), .b(x020), .O(new_n350_));
  nand2  g190(.a(x076), .b(x012), .O(new_n351_));
  nand2  g191(.a(x052), .b(x036), .O(new_n352_));
  nand2  g192(.a(new_n352_), .b(new_n351_), .O(new_n353_));
  aoi21  g193(.a(new_n350_), .b(new_n349_), .c(new_n353_), .O(new_n354_));
  aoi21  g194(.a(new_n354_), .b(new_n348_), .c(x044), .O(z12));
  inv1   g195(.a(x077), .O(new_n356_));
  nand2  g196(.a(new_n212_), .b(new_n207_), .O(new_n357_));
  nand2  g197(.a(new_n357_), .b(new_n216_), .O(new_n358_));
  nor2   g198(.a(x117), .b(x109), .O(new_n359_));
  aoi21  g199(.a(new_n359_), .b(new_n358_), .c(x069), .O(new_n360_));
  nor2   g200(.a(x117), .b(x021), .O(new_n361_));
  aoi21  g201(.a(new_n361_), .b(x125), .c(x085), .O(new_n362_));
  nand2  g202(.a(x021), .b(x013), .O(new_n363_));
  oai21  g203(.a(new_n246_), .b(x029), .c(new_n363_), .O(new_n364_));
  oai21  g204(.a(new_n212_), .b(x109), .c(x037), .O(new_n365_));
  nand2  g205(.a(new_n365_), .b(x117), .O(new_n366_));
  inv1   g206(.a(x109), .O(new_n367_));
  oai21  g207(.a(new_n207_), .b(x061), .c(new_n367_), .O(new_n368_));
  nand2  g208(.a(new_n368_), .b(new_n210_), .O(new_n369_));
  nand4  g209(.a(new_n369_), .b(new_n366_), .c(new_n364_), .d(new_n362_), .O(new_n370_));
  oai21  g210(.a(new_n370_), .b(new_n360_), .c(new_n356_), .O(new_n371_));
  nand4  g211(.a(x125), .b(new_n245_), .c(new_n210_), .d(x013), .O(new_n372_));
  aoi21  g212(.a(new_n372_), .b(new_n371_), .c(x053), .O(new_n373_));
  nand3  g213(.a(x085), .b(new_n210_), .c(new_n220_), .O(new_n374_));
  inv1   g214(.a(new_n374_), .O(new_n375_));
  oai21  g215(.a(new_n375_), .b(new_n373_), .c(x005), .O(new_n376_));
  nand2  g216(.a(new_n223_), .b(x029), .O(new_n377_));
  nand2  g217(.a(new_n377_), .b(new_n221_), .O(new_n378_));
  nand2  g218(.a(new_n378_), .b(new_n356_), .O(new_n379_));
  aoi21  g219(.a(new_n379_), .b(new_n220_), .c(new_n359_), .O(new_n380_));
  nor2   g220(.a(new_n225_), .b(x021), .O(new_n381_));
  oai21  g221(.a(new_n381_), .b(new_n246_), .c(x069), .O(new_n382_));
  nand4  g222(.a(new_n363_), .b(new_n357_), .c(new_n223_), .d(x029), .O(new_n383_));
  aoi21  g223(.a(new_n383_), .b(new_n382_), .c(x077), .O(new_n384_));
  oai21  g224(.a(new_n384_), .b(new_n380_), .c(new_n204_), .O(new_n385_));
  aoi21  g225(.a(x021), .b(x013), .c(new_n225_), .O(new_n386_));
  nor2   g226(.a(x077), .b(new_n210_), .O(new_n387_));
  oai21  g227(.a(new_n386_), .b(new_n246_), .c(new_n387_), .O(new_n388_));
  nand2  g228(.a(new_n388_), .b(new_n385_), .O(new_n389_));
  oai22  g229(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n390_));
  nand3  g230(.a(new_n390_), .b(x069), .c(x021), .O(new_n391_));
  aoi22  g231(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n392_));
  nand2  g232(.a(new_n392_), .b(new_n391_), .O(new_n393_));
  aoi21  g233(.a(new_n389_), .b(new_n219_), .c(new_n393_), .O(new_n394_));
  aoi21  g234(.a(new_n394_), .b(new_n376_), .c(x045), .O(z13));
  nand2  g235(.a(new_n271_), .b(new_n267_), .O(new_n396_));
  nand2  g236(.a(new_n396_), .b(new_n305_), .O(new_n397_));
  nor2   g237(.a(x118), .b(x110), .O(new_n398_));
  aoi21  g238(.a(new_n398_), .b(new_n397_), .c(x070), .O(new_n399_));
  nor2   g239(.a(x118), .b(x022), .O(new_n400_));
  aoi21  g240(.a(new_n400_), .b(x126), .c(x086), .O(new_n401_));
  nand2  g241(.a(x022), .b(x014), .O(new_n402_));
  oai21  g242(.a(new_n306_), .b(x030), .c(new_n402_), .O(new_n403_));
  oai21  g243(.a(new_n271_), .b(x110), .c(x038), .O(new_n404_));
  nand2  g244(.a(new_n404_), .b(x118), .O(new_n405_));
  oai21  g245(.a(new_n267_), .b(x062), .c(new_n264_), .O(new_n406_));
  nand2  g246(.a(new_n406_), .b(new_n270_), .O(new_n407_));
  nand4  g247(.a(new_n407_), .b(new_n405_), .c(new_n403_), .d(new_n401_), .O(new_n408_));
  oai21  g248(.a(new_n408_), .b(new_n399_), .c(new_n299_), .O(new_n409_));
  nand4  g249(.a(x126), .b(new_n304_), .c(new_n270_), .d(x014), .O(new_n410_));
  aoi21  g250(.a(new_n410_), .b(new_n409_), .c(x054), .O(new_n411_));
  nand3  g251(.a(x086), .b(new_n270_), .c(new_n280_), .O(new_n412_));
  inv1   g252(.a(new_n412_), .O(new_n413_));
  oai21  g253(.a(new_n413_), .b(new_n411_), .c(x006), .O(new_n414_));
  nand2  g254(.a(new_n283_), .b(x030), .O(new_n415_));
  nand2  g255(.a(new_n415_), .b(new_n281_), .O(new_n416_));
  nand2  g256(.a(new_n416_), .b(new_n299_), .O(new_n417_));
  aoi21  g257(.a(new_n417_), .b(new_n280_), .c(new_n398_), .O(new_n418_));
  nor2   g258(.a(new_n303_), .b(x022), .O(new_n419_));
  oai21  g259(.a(new_n419_), .b(new_n306_), .c(x070), .O(new_n420_));
  nand4  g260(.a(new_n402_), .b(new_n396_), .c(new_n283_), .d(x030), .O(new_n421_));
  aoi21  g261(.a(new_n421_), .b(new_n420_), .c(x078), .O(new_n422_));
  oai21  g262(.a(new_n422_), .b(new_n418_), .c(new_n263_), .O(new_n423_));
  nand2  g263(.a(new_n402_), .b(x030), .O(new_n424_));
  nand2  g264(.a(new_n424_), .b(new_n295_), .O(new_n425_));
  nand3  g265(.a(new_n425_), .b(new_n299_), .c(x038), .O(new_n426_));
  nand2  g266(.a(new_n426_), .b(new_n423_), .O(new_n427_));
  oai22  g267(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n428_));
  nand3  g268(.a(new_n428_), .b(x070), .c(x022), .O(new_n429_));
  nand2  g269(.a(x078), .b(x014), .O(new_n430_));
  nand3  g270(.a(new_n430_), .b(new_n429_), .c(new_n314_), .O(new_n431_));
  aoi21  g271(.a(new_n427_), .b(new_n279_), .c(new_n431_), .O(new_n432_));
  aoi21  g272(.a(new_n432_), .b(new_n414_), .c(x046), .O(z14));
  zero   g273(.O(z02));
  zero   g274(.O(z04));
  zero   g275(.O(z07));
  zero   g276(.O(z08));
