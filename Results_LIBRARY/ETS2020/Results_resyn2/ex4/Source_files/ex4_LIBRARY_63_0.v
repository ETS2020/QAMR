// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:31 2020
...
module FAU ( 
  ...
  oai22  g079(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n241_));
  nand3  g080(.a(new_n241_), .b(x068), .c(x020), .O(new_n242_));
  oai22  g081(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n243_));
  and2   g082(.a(x084), .b(x004), .O(new_n244_));
