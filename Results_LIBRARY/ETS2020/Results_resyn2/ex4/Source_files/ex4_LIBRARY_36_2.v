// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:08 2020
...
module FAU ( 
  ...
  inv1   g017(.a(x044), .O(new_n177_));
  inv1   g018(.a(x012), .O(new_n178_));
  inv1   g019(.a(x036), .O(new_n179_));
  inv1   g020(.a(x052), .O(new_n180_));
  inv1   g021(.a(x076), .O(new_n181_));
  oai22  g022(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n178_), .O(new_n182_));
  nor2   g023(.a(x084), .b(x004), .O(new_n183_));
  nand2  g024(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  oai22  g025(.a(new_n181_), .b(new_n179_), .c(new_n180_), .d(new_n178_), .O(new_n185_));
  nor2   g026(.a(x068), .b(x020), .O(new_n186_));
  oai22  g027(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n187_));
  aoi21  g028(.a(new_n186_), .b(new_n185_), .c(new_n187_), .O(new_n188_));
  aoi21  g029(.a(new_n188_), .b(new_n184_), .c(new_n177_), .O(z04));
