...
module FAU ( 
  ...
  oai22  g226(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n386_));
  nand3  g227(.a(new_n386_), .b(x082), .c(x002), .O(new_n387_));
  oai22  g228(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n388_));
  and2   g229(.a(x066), .b(x018), .O(new_n389_));
  nand2  g230(.a(x074), .b(x010), .O(new_n390_));
  nand2  g231(.a(x050), .b(x034), .O(new_n391_));
  nand2  g232(.a(new_n391_), .b(new_n390_), .O(new_n392_));
  aoi21  g233(.a(new_n389_), .b(new_n388_), .c(new_n392_), .O(new_n393_));
  aoi21  g234(.a(new_n393_), .b(new_n387_), .c(x042), .O(z10));
  oai22  g235(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n395_));
  nand3  g236(.a(new_n395_), .b(x067), .c(x019), .O(new_n396_));
  oai21  g237(.a(x075), .b(x051), .c(new_n197_), .O(new_n397_));
  nor2   g238(.a(new_n189_), .b(new_n188_), .O(new_n398_));
  oai22  g239(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n399_));
  ...
  oai21  g244(.a(x076), .b(x052), .c(new_n212_), .O(new_n404_));
  nor2   g245(.a(new_n204_), .b(new_n203_), .O(new_n405_));
  oai22  g246(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n406_));
