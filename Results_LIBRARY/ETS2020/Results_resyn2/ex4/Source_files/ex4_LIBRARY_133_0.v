...
module FAU ( 
  ...
  oai22  g083(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n245_));
  nand3  g084(.a(new_n245_), .b(x084), .c(x004), .O(new_n246_));
  oai22  g085(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n247_));
  and2   g086(.a(x068), .b(x020), .O(new_n248_));
  nand2  g087(.a(x052), .b(x036), .O(new_n249_));
  nand2  g088(.a(x076), .b(x012), .O(new_n250_));
  nand2  g089(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  aoi21  g090(.a(new_n248_), .b(new_n247_), .c(new_n251_), .O(new_n252_));
  aoi21  g091(.a(new_n252_), .b(new_n246_), .c(x044), .O(z12));
  zero   g092(.O(z05));
  zero   g093(.O(z06));
  zero   g094(.O(z07));
  zero   g095(.O(z08));
