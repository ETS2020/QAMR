...
module FAU ( 
  ...
  oai22  g163(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n325_));
  nand3  g164(.a(new_n325_), .b(x082), .c(x002), .O(new_n326_));
  oai22  g165(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n327_));
  and2   g166(.a(x066), .b(x018), .O(new_n328_));
  nand2  g167(.a(x074), .b(x010), .O(new_n329_));
  nand2  g168(.a(x050), .b(x034), .O(new_n330_));
  nand2  g169(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  aoi21  g170(.a(new_n328_), .b(new_n327_), .c(new_n331_), .O(new_n332_));
  aoi21  g171(.a(new_n332_), .b(new_n326_), .c(x042), .O(z10));
  oai22  g172(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n334_));
  nand3  g173(.a(new_n334_), .b(x067), .c(x019), .O(new_n335_));
  oai21  g174(.a(x075), .b(x051), .c(new_n181_), .O(new_n336_));
  nor2   g175(.a(new_n173_), .b(new_n172_), .O(new_n337_));
  oai22  g176(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n338_));
  ...
  oai21  g181(.a(x076), .b(x052), .c(new_n196_), .O(new_n343_));
  nor2   g182(.a(new_n188_), .b(new_n187_), .O(new_n344_));
  oai22  g183(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n345_));
