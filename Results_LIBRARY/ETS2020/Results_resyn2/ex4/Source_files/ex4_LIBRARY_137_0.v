...
module FAU ( 
  ...
  oai22  g66(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n229_));
  nand3  g67(.a(new_n229_), .b(x084), .c(x004), .O(new_n230_));
  oai22  g68(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n231_));
  and2   g69(.a(x068), .b(x020), .O(new_n232_));
