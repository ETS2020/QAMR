// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:48 2020
...
module FAU ( 
  ...
  inv1   g018(.a(x083), .O(new_n177_));
  inv1   g019(.a(x011), .O(new_n178_));
  inv1   g020(.a(x035), .O(new_n179_));
  inv1   g021(.a(x051), .O(new_n180_));
  inv1   g022(.a(x075), .O(new_n181_));
  oai22  g023(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n178_), .O(new_n182_));
  nand3  g024(.a(new_n182_), .b(new_n177_), .c(new_n176_), .O(new_n183_));
  nand3  g025(.a(new_n181_), .b(new_n180_), .c(x035), .O(new_n184_));
  nand2  g026(.a(new_n179_), .b(new_n178_), .O(new_n185_));
  nor2   g027(.a(x067), .b(x019), .O(new_n186_));
  nand3  g028(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  aoi22  g029(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n179_), .O(new_n188_));
  nand3  g030(.a(new_n188_), .b(new_n187_), .c(new_n183_), .O(new_n189_));
  and2   g031(.a(new_n189_), .b(x043), .O(z03));
  ...
  oai22  g222(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n382_));
  nand3  g223(.a(new_n382_), .b(x082), .c(x002), .O(new_n383_));
  oai22  g224(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n384_));
  and2   g225(.a(x066), .b(x018), .O(new_n385_));
  nand2  g226(.a(x074), .b(x010), .O(new_n386_));
  nand2  g227(.a(x050), .b(x034), .O(new_n387_));
  nand2  g228(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  aoi21  g229(.a(new_n385_), .b(new_n384_), .c(new_n388_), .O(new_n389_));
  aoi21  g230(.a(new_n389_), .b(new_n383_), .c(x042), .O(z10));
  oai22  g231(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n391_));
  nand3  g232(.a(new_n391_), .b(x067), .c(x019), .O(new_n392_));
  oai21  g233(.a(x075), .b(x051), .c(new_n185_), .O(new_n393_));
  nor2   g234(.a(new_n177_), .b(new_n176_), .O(new_n394_));
  oai22  g235(.a(new_n181_), .b(new_n178_), .c(new_n180_), .d(new_n179_), .O(new_n395_));
  aoi21  g236(.a(new_n394_), .b(new_n393_), .c(new_n395_), .O(new_n396_));
  aoi21  g237(.a(new_n396_), .b(new_n392_), .c(x043), .O(z11));
  oai22  g238(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n398_));
  nand3  g239(.a(new_n398_), .b(x068), .c(x020), .O(new_n399_));
  oai21  g240(.a(x076), .b(x052), .c(new_n200_), .O(new_n400_));
  nor2   g241(.a(new_n192_), .b(new_n191_), .O(new_n401_));
  oai22  g242(.a(new_n196_), .b(new_n193_), .c(new_n195_), .d(new_n194_), .O(new_n402_));
  aoi21  g243(.a(new_n401_), .b(new_n400_), .c(new_n402_), .O(new_n403_));
  aoi21  g244(.a(new_n403_), .b(new_n399_), .c(x044), .O(z12));
