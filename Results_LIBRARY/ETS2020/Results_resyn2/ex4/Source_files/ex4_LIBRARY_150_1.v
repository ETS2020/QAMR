...
module FAU ( 
  ...
  oai22  g228(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n389_));
  nand3  g229(.a(new_n389_), .b(x067), .c(x019), .O(new_n390_));
  oai21  g230(.a(x075), .b(x051), .c(new_n193_), .O(new_n391_));
  nor2   g231(.a(new_n185_), .b(new_n184_), .O(new_n392_));
  oai22  g232(.a(new_n189_), .b(new_n186_), .c(new_n188_), .d(new_n187_), .O(new_n393_));
  aoi21  g233(.a(new_n392_), .b(new_n391_), .c(new_n393_), .O(new_n394_));
  aoi21  g234(.a(new_n394_), .b(new_n390_), .c(x043), .O(z11));
