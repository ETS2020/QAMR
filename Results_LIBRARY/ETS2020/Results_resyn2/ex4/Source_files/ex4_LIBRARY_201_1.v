...
module FAU ( 
  ...
  oai21  g172(.a(x074), .b(x050), .c(new_n168_), .O(new_n333_));
  nor2   g173(.a(new_n160_), .b(new_n159_), .O(new_n334_));
  oai22  g174(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n335_));
