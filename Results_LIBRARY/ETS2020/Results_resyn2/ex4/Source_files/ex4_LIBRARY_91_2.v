...
module FAU ( 
  ...
  oai22  g220(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n382_));
  nand3  g221(.a(new_n382_), .b(x068), .c(x020), .O(new_n383_));
  oai21  g222(.a(x076), .b(x052), .c(new_n198_), .O(new_n384_));
  nor2   g223(.a(new_n190_), .b(new_n189_), .O(new_n385_));
  oai22  g224(.a(new_n194_), .b(new_n191_), .c(new_n193_), .d(new_n192_), .O(new_n386_));
  aoi21  g225(.a(new_n385_), .b(new_n384_), .c(new_n386_), .O(new_n387_));
  aoi21  g226(.a(new_n387_), .b(new_n383_), .c(x044), .O(z12));
