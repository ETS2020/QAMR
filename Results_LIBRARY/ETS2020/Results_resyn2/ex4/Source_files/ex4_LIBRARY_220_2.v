// Benchmark "FAU" written by ABC on Sat Jul 25 09:20:42 2020
...
module FAU ( 
  ...
  oai22  g235(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n395_));
  nand3  g236(.a(new_n395_), .b(x067), .c(x019), .O(new_n396_));
  oai21  g237(.a(x075), .b(x051), .c(new_n199_), .O(new_n397_));
  nor2   g238(.a(new_n191_), .b(new_n190_), .O(new_n398_));
  oai22  g239(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n399_));
  aoi21  g240(.a(new_n398_), .b(new_n397_), .c(new_n399_), .O(new_n400_));
  aoi21  g241(.a(new_n400_), .b(new_n396_), .c(x043), .O(z11));
  oai22  g242(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n402_));
  nand3  g243(.a(new_n402_), .b(x068), .c(x020), .O(new_n403_));
  oai21  g244(.a(x076), .b(x052), .c(new_n214_), .O(new_n404_));
  nor2   g245(.a(new_n206_), .b(new_n205_), .O(new_n405_));
  oai22  g246(.a(new_n210_), .b(new_n207_), .c(new_n209_), .d(new_n208_), .O(new_n406_));
  aoi21  g247(.a(new_n405_), .b(new_n404_), .c(new_n406_), .O(new_n407_));
  aoi21  g248(.a(new_n407_), .b(new_n403_), .c(x044), .O(z12));
