...
module FAU ( 
  ...
  oai22  g095(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n258_));
  nand3  g096(.a(new_n258_), .b(x066), .c(x018), .O(new_n259_));
  oai21  g097(.a(x074), .b(x050), .c(new_n180_), .O(new_n260_));
  nor2   g098(.a(new_n172_), .b(new_n171_), .O(new_n261_));
  oai22  g099(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n262_));
  aoi21  g100(.a(new_n261_), .b(new_n260_), .c(new_n262_), .O(new_n263_));
  aoi21  g101(.a(new_n263_), .b(new_n259_), .c(x042), .O(z10));
