...
module FAU ( 
  ...
  oai21  g108(.a(x074), .b(x050), .c(new_n196_), .O(new_n270_));
  nor2   g109(.a(new_n188_), .b(new_n187_), .O(new_n271_));
  oai22  g110(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n272_));
