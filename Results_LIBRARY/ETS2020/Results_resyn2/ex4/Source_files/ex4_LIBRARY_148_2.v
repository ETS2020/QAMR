...
module FAU ( 
  ...
  oai21  g233(.a(x075), .b(x051), .c(new_n183_), .O(new_n393_));
  nor2   g234(.a(new_n175_), .b(new_n174_), .O(new_n394_));
  oai22  g235(.a(new_n179_), .b(new_n176_), .c(new_n178_), .d(new_n177_), .O(new_n395_));
