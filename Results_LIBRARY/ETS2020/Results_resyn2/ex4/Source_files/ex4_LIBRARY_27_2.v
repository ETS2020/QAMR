// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:01 2020
...
module FAU ( 
  ...
  oai21  g211(.a(x074), .b(x050), .c(new_n182_), .O(new_n372_));
  nor2   g212(.a(new_n174_), .b(new_n173_), .O(new_n373_));
  oai22  g213(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n374_));
