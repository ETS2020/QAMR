...
module FAU ( 
  ...
  oai22  g209(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n371_));
  nand3  g210(.a(new_n371_), .b(x083), .c(x003), .O(new_n372_));
  oai22  g211(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n373_));
  and2   g212(.a(x067), .b(x019), .O(new_n374_));
  nand2  g213(.a(x075), .b(x011), .O(new_n375_));
  nand2  g214(.a(x051), .b(x035), .O(new_n376_));
  nand2  g215(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  aoi21  g216(.a(new_n374_), .b(new_n373_), .c(new_n377_), .O(new_n378_));
  aoi21  g217(.a(new_n378_), .b(new_n372_), .c(x043), .O(z11));
