...
module FAU ( 
  ...
  oai22  g161(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n322_));
  nand3  g162(.a(new_n322_), .b(x081), .c(x001), .O(new_n323_));
  oai22  g163(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n324_));
  and2   g164(.a(x065), .b(x017), .O(new_n325_));
  nand2  g165(.a(x073), .b(x009), .O(new_n326_));
  nand2  g166(.a(x049), .b(x033), .O(new_n327_));
  nand2  g167(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  aoi21  g168(.a(new_n325_), .b(new_n324_), .c(new_n328_), .O(new_n329_));
  aoi21  g169(.a(new_n329_), .b(new_n323_), .c(x041), .O(z09));
  oai22  g170(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n331_));
  nand3  g171(.a(new_n331_), .b(x066), .c(x018), .O(new_n332_));
  oai21  g172(.a(x074), .b(x050), .c(new_n180_), .O(new_n333_));
  nor2   g173(.a(new_n172_), .b(new_n171_), .O(new_n334_));
  oai22  g174(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n335_));
