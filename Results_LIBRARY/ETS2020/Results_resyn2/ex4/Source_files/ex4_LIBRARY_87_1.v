// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:52 2020
...
module FAU ( 
  ...
  nand3  g158(.a(new_n320_), .b(x067), .c(x019), .O(new_n321_));
  oai21  g159(.a(x075), .b(x051), .c(new_n181_), .O(new_n322_));
  nor2   g160(.a(new_n173_), .b(new_n172_), .O(new_n323_));
  oai22  g161(.a(new_n177_), .b(new_n174_), .c(new_n176_), .d(new_n175_), .O(new_n324_));
  aoi21  g162(.a(new_n323_), .b(new_n322_), .c(new_n324_), .O(new_n325_));
  aoi21  g163(.a(new_n325_), .b(new_n321_), .c(x043), .O(z11));
