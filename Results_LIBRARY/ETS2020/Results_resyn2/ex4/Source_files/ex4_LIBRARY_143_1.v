...
module FAU ( 
  ...
  oai22  g215(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n376_));
  nand3  g216(.a(new_n376_), .b(x066), .c(x018), .O(new_n377_));
  oai21  g217(.a(x074), .b(x050), .c(new_n180_), .O(new_n378_));
  nor2   g218(.a(new_n172_), .b(new_n171_), .O(new_n379_));
  oai22  g219(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n380_));
  aoi21  g220(.a(new_n379_), .b(new_n378_), .c(new_n380_), .O(new_n381_));
  aoi21  g221(.a(new_n381_), .b(new_n377_), .c(x042), .O(z10));
  oai22  g222(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n383_));
  nand3  g223(.a(new_n383_), .b(x067), .c(x019), .O(new_n384_));
  oai21  g224(.a(x075), .b(x051), .c(new_n195_), .O(new_n385_));
  nor2   g225(.a(new_n187_), .b(new_n186_), .O(new_n386_));
  oai22  g226(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n387_));
  aoi21  g227(.a(new_n386_), .b(new_n385_), .c(new_n387_), .O(new_n388_));
  aoi21  g228(.a(new_n388_), .b(new_n384_), .c(x043), .O(z11));
  oai22  g229(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n390_));
  nand3  g230(.a(new_n390_), .b(x084), .c(x004), .O(new_n391_));
  oai22  g231(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n392_));
  and2   g232(.a(x068), .b(x020), .O(new_n393_));
  nand2  g233(.a(x076), .b(x012), .O(new_n394_));
  nand2  g234(.a(x052), .b(x036), .O(new_n395_));
  nand2  g235(.a(new_n395_), .b(new_n394_), .O(new_n396_));
  aoi21  g236(.a(new_n393_), .b(new_n392_), .c(new_n396_), .O(new_n397_));
  aoi21  g237(.a(new_n397_), .b(new_n391_), .c(x044), .O(z12));
