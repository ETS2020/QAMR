...
module FAU ( 
  ...
  oai22  g183(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n343_));
  nand3  g184(.a(new_n343_), .b(x082), .c(x002), .O(new_n344_));
  oai22  g185(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n345_));
  and2   g186(.a(x066), .b(x018), .O(new_n346_));
  nand2  g187(.a(x074), .b(x010), .O(new_n347_));
  nand2  g188(.a(x050), .b(x034), .O(new_n348_));
  nand2  g189(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  aoi21  g190(.a(new_n346_), .b(new_n345_), .c(new_n349_), .O(new_n350_));
  aoi21  g191(.a(new_n350_), .b(new_n344_), .c(x042), .O(z10));
