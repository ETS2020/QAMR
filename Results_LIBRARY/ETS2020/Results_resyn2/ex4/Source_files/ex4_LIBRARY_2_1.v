...
module FAU ( 
  ...
  oai21  g178(.a(x074), .b(x050), .c(new_n180_), .O(new_n339_));
  nor2   g179(.a(new_n172_), .b(new_n171_), .O(new_n340_));
  oai22  g180(.a(new_n176_), .b(new_n173_), .c(new_n175_), .d(new_n174_), .O(new_n341_));
  ...
  oai21  g185(.a(x075), .b(x051), .c(new_n195_), .O(new_n346_));
  nor2   g186(.a(new_n187_), .b(new_n186_), .O(new_n347_));
  oai22  g187(.a(new_n191_), .b(new_n188_), .c(new_n190_), .d(new_n189_), .O(new_n348_));
