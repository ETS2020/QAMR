// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:30 2020
...
module FAU ( 
  ...
  oai22  g220(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n380_));
  nand3  g221(.a(new_n380_), .b(x082), .c(x002), .O(new_n381_));
  oai22  g222(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n382_));
  and2   g223(.a(x066), .b(x018), .O(new_n383_));
  nand2  g224(.a(x074), .b(x010), .O(new_n384_));
  nand2  g225(.a(x050), .b(x034), .O(new_n385_));
  nand2  g226(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  aoi21  g227(.a(new_n383_), .b(new_n382_), .c(new_n386_), .O(new_n387_));
  aoi21  g228(.a(new_n387_), .b(new_n381_), .c(x042), .O(z10));
  oai22  g229(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n389_));
  nand3  g230(.a(new_n389_), .b(x067), .c(x019), .O(new_n390_));
  oai21  g231(.a(x075), .b(x051), .c(new_n199_), .O(new_n391_));
  nor2   g232(.a(new_n191_), .b(new_n190_), .O(new_n392_));
  oai22  g233(.a(new_n195_), .b(new_n192_), .c(new_n194_), .d(new_n193_), .O(new_n393_));
  aoi21  g234(.a(new_n392_), .b(new_n391_), .c(new_n393_), .O(new_n394_));
  aoi21  g235(.a(new_n394_), .b(new_n390_), .c(x043), .O(z11));
  inv1   g236(.a(x077), .O(new_n397_));
  nand2  g237(.a(new_n216_), .b(new_n211_), .O(new_n398_));
  nand2  g238(.a(new_n398_), .b(new_n220_), .O(new_n399_));
  ...
  oai21  g244(.a(new_n250_), .b(x029), .c(new_n404_), .O(new_n405_));
  oai21  g245(.a(new_n216_), .b(x109), .c(x037), .O(new_n406_));
  nand2  g246(.a(new_n406_), .b(x117), .O(new_n407_));
  inv1   g247(.a(x109), .O(new_n408_));
  oai21  g248(.a(new_n211_), .b(x061), .c(new_n408_), .O(new_n409_));
  nand2  g249(.a(new_n409_), .b(new_n214_), .O(new_n410_));
  ...
  nand4  g252(.a(x125), .b(new_n249_), .c(new_n214_), .d(x013), .O(new_n413_));
  aoi21  g253(.a(new_n413_), .b(new_n412_), .c(x053), .O(new_n414_));
  nand3  g254(.a(x085), .b(new_n214_), .c(new_n224_), .O(new_n415_));
  inv1   g255(.a(new_n415_), .O(new_n416_));
  oai21  g256(.a(new_n416_), .b(new_n414_), .c(x005), .O(new_n417_));
  nand2  g257(.a(new_n227_), .b(x029), .O(new_n418_));
  nand2  g258(.a(new_n418_), .b(new_n225_), .O(new_n419_));
  nand2  g259(.a(new_n419_), .b(new_n397_), .O(new_n420_));
  aoi21  g260(.a(new_n420_), .b(new_n224_), .c(new_n400_), .O(new_n421_));
  nor2   g261(.a(new_n229_), .b(x021), .O(new_n422_));
  oai21  g262(.a(new_n422_), .b(new_n250_), .c(x069), .O(new_n423_));
  nand4  g263(.a(new_n404_), .b(new_n398_), .c(new_n227_), .d(x029), .O(new_n424_));
  aoi21  g264(.a(new_n424_), .b(new_n423_), .c(x077), .O(new_n425_));
  oai21  g265(.a(new_n425_), .b(new_n421_), .c(new_n208_), .O(new_n426_));
  aoi21  g266(.a(x021), .b(x013), .c(new_n229_), .O(new_n427_));
  nor2   g267(.a(x077), .b(new_n214_), .O(new_n428_));
  oai21  g268(.a(new_n427_), .b(new_n250_), .c(new_n428_), .O(new_n429_));
  ...
  aoi21  g274(.a(new_n430_), .b(new_n223_), .c(new_n434_), .O(new_n435_));
  aoi21  g275(.a(new_n435_), .b(new_n417_), .c(x045), .O(z13));
  nand2  g276(.a(new_n275_), .b(new_n271_), .O(new_n437_));
  nand2  g277(.a(new_n437_), .b(new_n309_), .O(new_n438_));
  ...
  oai21  g283(.a(new_n310_), .b(x030), .c(new_n443_), .O(new_n444_));
  oai21  g284(.a(new_n275_), .b(x110), .c(x038), .O(new_n445_));
  nand2  g285(.a(new_n445_), .b(x118), .O(new_n446_));
  oai21  g286(.a(new_n271_), .b(x062), .c(new_n268_), .O(new_n447_));
  nand2  g287(.a(new_n447_), .b(new_n274_), .O(new_n448_));
  nand4  g288(.a(new_n448_), .b(new_n446_), .c(new_n444_), .d(new_n442_), .O(new_n449_));
  oai21  g289(.a(new_n449_), .b(new_n440_), .c(new_n303_), .O(new_n450_));
  nand4  g290(.a(x126), .b(new_n308_), .c(new_n274_), .d(x014), .O(new_n451_));
  aoi21  g291(.a(new_n451_), .b(new_n450_), .c(x054), .O(new_n452_));
  nand3  g292(.a(x086), .b(new_n274_), .c(new_n284_), .O(new_n453_));
  inv1   g293(.a(new_n453_), .O(new_n454_));
  oai21  g294(.a(new_n454_), .b(new_n452_), .c(x006), .O(new_n455_));
  nand2  g295(.a(new_n287_), .b(x030), .O(new_n456_));
  nand2  g296(.a(new_n456_), .b(new_n285_), .O(new_n457_));
  nand2  g297(.a(new_n457_), .b(new_n303_), .O(new_n458_));
  aoi21  g298(.a(new_n458_), .b(new_n284_), .c(new_n439_), .O(new_n459_));
  nor2   g299(.a(new_n307_), .b(x022), .O(new_n460_));
  oai21  g300(.a(new_n460_), .b(new_n310_), .c(x070), .O(new_n461_));
  nand4  g301(.a(new_n443_), .b(new_n437_), .c(new_n287_), .d(x030), .O(new_n462_));
  aoi21  g302(.a(new_n462_), .b(new_n461_), .c(x078), .O(new_n463_));
  oai21  g303(.a(new_n463_), .b(new_n459_), .c(new_n267_), .O(new_n464_));
  nand2  g304(.a(new_n443_), .b(x030), .O(new_n465_));
  nand2  g305(.a(new_n465_), .b(new_n299_), .O(new_n466_));
  nand3  g306(.a(new_n466_), .b(new_n303_), .c(x038), .O(new_n467_));
  ...
  nand3  g311(.a(new_n471_), .b(new_n470_), .c(new_n318_), .O(new_n472_));
  aoi21  g312(.a(new_n468_), .b(new_n283_), .c(new_n472_), .O(new_n473_));
