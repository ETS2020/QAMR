...
module FAU ( 
  ...
  oai22  g192(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n352_));
  nand3  g193(.a(new_n352_), .b(x083), .c(x003), .O(new_n353_));
  oai22  g194(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n354_));
  and2   g195(.a(x067), .b(x019), .O(new_n355_));
  nand2  g196(.a(x075), .b(x011), .O(new_n356_));
  nand2  g197(.a(x051), .b(x035), .O(new_n357_));
  nand2  g198(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  aoi21  g199(.a(new_n355_), .b(new_n354_), .c(new_n358_), .O(new_n359_));
  aoi21  g200(.a(new_n359_), .b(new_n353_), .c(x043), .O(z11));
