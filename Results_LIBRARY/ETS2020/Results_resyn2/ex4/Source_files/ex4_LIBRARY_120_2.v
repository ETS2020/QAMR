// Benchmark "FAU" written by ABC on Sat Jul 25 09:19:19 2020
...
module FAU ( 
  ...
  nand3  g212(.a(new_n372_), .b(x066), .c(x018), .O(new_n373_));
  oai21  g213(.a(x074), .b(x050), .c(new_n196_), .O(new_n374_));
  nor2   g214(.a(new_n188_), .b(new_n187_), .O(new_n375_));
  oai22  g215(.a(new_n192_), .b(new_n189_), .c(new_n191_), .d(new_n190_), .O(new_n376_));
  aoi21  g216(.a(new_n375_), .b(new_n374_), .c(new_n376_), .O(new_n377_));
  aoi21  g217(.a(new_n377_), .b(new_n373_), .c(x042), .O(z10));
  inv1   g218(.a(x077), .O(new_n381_));
  nand2  g219(.a(new_n214_), .b(new_n209_), .O(new_n382_));
  nand2  g220(.a(new_n382_), .b(new_n218_), .O(new_n383_));
  ...
  oai21  g226(.a(new_n248_), .b(x029), .c(new_n388_), .O(new_n389_));
  oai21  g227(.a(new_n214_), .b(x109), .c(x037), .O(new_n390_));
  nand2  g228(.a(new_n390_), .b(x117), .O(new_n391_));
  inv1   g229(.a(x109), .O(new_n392_));
  oai21  g230(.a(new_n209_), .b(x061), .c(new_n392_), .O(new_n393_));
  nand2  g231(.a(new_n393_), .b(new_n212_), .O(new_n394_));
  ...
  nand4  g234(.a(x125), .b(new_n247_), .c(new_n212_), .d(x013), .O(new_n397_));
  aoi21  g235(.a(new_n397_), .b(new_n396_), .c(x053), .O(new_n398_));
  nand3  g236(.a(x085), .b(new_n212_), .c(new_n222_), .O(new_n399_));
  inv1   g237(.a(new_n399_), .O(new_n400_));
  oai21  g238(.a(new_n400_), .b(new_n398_), .c(x005), .O(new_n401_));
  nand2  g239(.a(new_n225_), .b(x029), .O(new_n402_));
  nand2  g240(.a(new_n402_), .b(new_n223_), .O(new_n403_));
  nand2  g241(.a(new_n403_), .b(new_n381_), .O(new_n404_));
  aoi21  g242(.a(new_n404_), .b(new_n222_), .c(new_n384_), .O(new_n405_));
  nor2   g243(.a(new_n227_), .b(x021), .O(new_n406_));
  oai21  g244(.a(new_n406_), .b(new_n248_), .c(x069), .O(new_n407_));
  nand4  g245(.a(new_n388_), .b(new_n382_), .c(new_n225_), .d(x029), .O(new_n408_));
  aoi21  g246(.a(new_n408_), .b(new_n407_), .c(x077), .O(new_n409_));
  oai21  g247(.a(new_n409_), .b(new_n405_), .c(new_n206_), .O(new_n410_));
  aoi21  g248(.a(x021), .b(x013), .c(new_n227_), .O(new_n411_));
  nor2   g249(.a(x077), .b(new_n212_), .O(new_n412_));
  oai21  g250(.a(new_n411_), .b(new_n248_), .c(new_n412_), .O(new_n413_));
  ...
  aoi21  g256(.a(new_n414_), .b(new_n221_), .c(new_n418_), .O(new_n419_));
  aoi21  g257(.a(new_n419_), .b(new_n401_), .c(x045), .O(z13));
  nand2  g258(.a(new_n273_), .b(new_n269_), .O(new_n421_));
  nand2  g259(.a(new_n421_), .b(new_n307_), .O(new_n422_));
  ...
  oai21  g265(.a(new_n308_), .b(x030), .c(new_n427_), .O(new_n428_));
  oai21  g266(.a(new_n273_), .b(x110), .c(x038), .O(new_n429_));
  nand2  g267(.a(new_n429_), .b(x118), .O(new_n430_));
  oai21  g268(.a(new_n269_), .b(x062), .c(new_n266_), .O(new_n431_));
  nand2  g269(.a(new_n431_), .b(new_n272_), .O(new_n432_));
  nand4  g270(.a(new_n432_), .b(new_n430_), .c(new_n428_), .d(new_n426_), .O(new_n433_));
  oai21  g271(.a(new_n433_), .b(new_n424_), .c(new_n301_), .O(new_n434_));
  nand4  g272(.a(x126), .b(new_n306_), .c(new_n272_), .d(x014), .O(new_n435_));
  aoi21  g273(.a(new_n435_), .b(new_n434_), .c(x054), .O(new_n436_));
  nand3  g274(.a(x086), .b(new_n272_), .c(new_n282_), .O(new_n437_));
  inv1   g275(.a(new_n437_), .O(new_n438_));
  oai21  g276(.a(new_n438_), .b(new_n436_), .c(x006), .O(new_n439_));
  nand2  g277(.a(new_n285_), .b(x030), .O(new_n440_));
  nand2  g278(.a(new_n440_), .b(new_n283_), .O(new_n441_));
  nand2  g279(.a(new_n441_), .b(new_n301_), .O(new_n442_));
  aoi21  g280(.a(new_n442_), .b(new_n282_), .c(new_n423_), .O(new_n443_));
  nor2   g281(.a(new_n305_), .b(x022), .O(new_n444_));
  oai21  g282(.a(new_n444_), .b(new_n308_), .c(x070), .O(new_n445_));
  nand4  g283(.a(new_n427_), .b(new_n421_), .c(new_n285_), .d(x030), .O(new_n446_));
  aoi21  g284(.a(new_n446_), .b(new_n445_), .c(x078), .O(new_n447_));
  oai21  g285(.a(new_n447_), .b(new_n443_), .c(new_n265_), .O(new_n448_));
  nand2  g286(.a(new_n427_), .b(x030), .O(new_n449_));
  nand2  g287(.a(new_n449_), .b(new_n297_), .O(new_n450_));
  nand3  g288(.a(new_n450_), .b(new_n301_), .c(x038), .O(new_n451_));
  ...
  nand3  g293(.a(new_n455_), .b(new_n454_), .c(new_n316_), .O(new_n456_));
  aoi21  g294(.a(new_n452_), .b(new_n281_), .c(new_n456_), .O(new_n457_));
