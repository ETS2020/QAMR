...
module FAU ( 
  ...
  nand3  g226(.a(new_n386_), .b(x068), .c(x020), .O(new_n387_));
  oai21  g227(.a(x076), .b(x052), .c(new_n186_), .O(new_n388_));
  nor2   g228(.a(new_n178_), .b(new_n177_), .O(new_n389_));
  oai22  g229(.a(new_n182_), .b(new_n179_), .c(new_n181_), .d(new_n180_), .O(new_n390_));
  aoi21  g230(.a(new_n389_), .b(new_n388_), .c(new_n390_), .O(new_n391_));
  aoi21  g231(.a(new_n391_), .b(new_n387_), .c(x044), .O(z12));
