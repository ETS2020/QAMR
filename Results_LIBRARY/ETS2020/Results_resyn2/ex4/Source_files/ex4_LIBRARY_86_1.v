// Benchmark "FAU" written by ABC on Sat Jul 25 09:18:51 2020
...
module FAU ( 
  ...
  oai21  g178(.a(x073), .b(x049), .c(new_n167_), .O(new_n338_));
  nor2   g179(.a(new_n159_), .b(new_n158_), .O(new_n339_));
  oai22  g180(.a(new_n163_), .b(new_n160_), .c(new_n162_), .d(new_n161_), .O(new_n340_));
  aoi21  g181(.a(new_n339_), .b(new_n338_), .c(new_n340_), .O(new_n341_));
  aoi21  g182(.a(new_n341_), .b(new_n337_), .c(x041), .O(z09));
  oai22  g183(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n343_));
  nand3  g184(.a(new_n343_), .b(x066), .c(x018), .O(new_n344_));
  oai21  g185(.a(x074), .b(x050), .c(new_n182_), .O(new_n345_));
  nor2   g186(.a(new_n174_), .b(new_n173_), .O(new_n346_));
  oai22  g187(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n347_));
  aoi21  g188(.a(new_n346_), .b(new_n345_), .c(new_n347_), .O(new_n348_));
  aoi21  g189(.a(new_n348_), .b(new_n344_), .c(x042), .O(z10));
