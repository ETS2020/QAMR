// Benchmark "FAU" written by ABC on Fri Jul 24 22:47:13 2020
...
module FAU ( 
  ...
  nor2   g195(.a(new_n92_), .b(new_n142_), .O(new_n212_));
  nor2   g196(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  inv1   g197(.a(new_n213_), .O(z2));
  nor2   g198(.a(new_n150_), .b(x1), .O(new_n216_));
  nand3  g199(.a(x7), .b(x4), .c(x3), .O(new_n217_));
  inv1   g200(.a(new_n217_), .O(new_n218_));
  oai22  g201(.a(x8), .b(x4), .c(x7), .d(x2), .O(new_n219_));
  oai21  g202(.a(new_n219_), .b(new_n218_), .c(x6), .O(new_n220_));
  oai21  g203(.a(new_n216_), .b(new_n143_), .c(new_n220_), .O(new_n221_));
  nand2  g204(.a(new_n221_), .b(x0), .O(new_n222_));
  nand2  g205(.a(new_n103_), .b(x6), .O(new_n223_));
  nand2  g206(.a(new_n148_), .b(new_n35_), .O(new_n224_));
  nand2  g207(.a(new_n66_), .b(x3), .O(new_n225_));
  aoi21  g208(.a(new_n225_), .b(new_n224_), .c(new_n36_), .O(new_n226_));
  nand3  g209(.a(new_n148_), .b(x3), .c(new_n142_), .O(new_n227_));
  inv1   g210(.a(new_n227_), .O(new_n228_));
  oai21  g211(.a(new_n228_), .b(new_n226_), .c(x4), .O(new_n229_));
  nand3  g212(.a(new_n229_), .b(new_n223_), .c(new_n222_), .O(new_n230_));
  nand2  g213(.a(new_n230_), .b(new_n22_), .O(new_n231_));
  nand3  g214(.a(new_n116_), .b(new_n113_), .c(new_n52_), .O(new_n232_));
  nand2  g215(.a(x7), .b(new_n52_), .O(new_n233_));
  nand3  g216(.a(new_n233_), .b(x2), .c(x0), .O(new_n234_));
  nand3  g217(.a(new_n234_), .b(new_n232_), .c(new_n38_), .O(new_n235_));
  nand2  g218(.a(new_n26_), .b(new_n35_), .O(new_n236_));
  nand2  g219(.a(new_n236_), .b(x7), .O(new_n237_));
  xor2a  g220(.a(x2), .b(x0), .O(new_n238_));
  inv1   g221(.a(new_n238_), .O(new_n239_));
  aoi21  g222(.a(x8), .b(new_n38_), .c(x1), .O(new_n240_));
  nand3  g223(.a(new_n240_), .b(new_n239_), .c(new_n237_), .O(new_n241_));
  oai21  g224(.a(x2), .b(new_n35_), .c(new_n142_), .O(new_n242_));
  nand3  g225(.a(new_n242_), .b(new_n54_), .c(x7), .O(new_n243_));
  nand3  g226(.a(new_n243_), .b(new_n241_), .c(new_n235_), .O(new_n244_));
  nand2  g227(.a(new_n244_), .b(new_n92_), .O(new_n245_));
  oai21  g228(.a(new_n175_), .b(new_n35_), .c(new_n142_), .O(new_n246_));
  oai21  g229(.a(new_n199_), .b(new_n38_), .c(new_n28_), .O(new_n247_));
  nand2  g230(.a(new_n247_), .b(new_n246_), .O(new_n248_));
  oai22  g231(.a(new_n238_), .b(new_n61_), .c(new_n236_), .d(x4), .O(new_n249_));
  aoi22  g232(.a(new_n249_), .b(new_n212_), .c(new_n248_), .d(x4), .O(new_n250_));
  nand2  g233(.a(new_n250_), .b(new_n245_), .O(new_n251_));
  nand2  g234(.a(x5), .b(x4), .O(new_n252_));
  nand3  g235(.a(new_n252_), .b(new_n38_), .c(x3), .O(new_n253_));
  aoi21  g236(.a(new_n253_), .b(new_n196_), .c(new_n28_), .O(new_n254_));
  nand2  g237(.a(new_n69_), .b(new_n66_), .O(new_n255_));
  nand2  g238(.a(new_n148_), .b(new_n92_), .O(new_n256_));
  aoi21  g239(.a(new_n256_), .b(new_n255_), .c(x5), .O(new_n257_));
  oai21  g240(.a(new_n257_), .b(new_n254_), .c(x1), .O(new_n258_));
  nand2  g241(.a(new_n178_), .b(x1), .O(new_n259_));
  aoi21  g242(.a(new_n259_), .b(new_n203_), .c(new_n233_), .O(new_n260_));
  nand3  g243(.a(new_n103_), .b(new_n38_), .c(x1), .O(new_n261_));
  inv1   g244(.a(new_n261_), .O(new_n262_));
  oai21  g245(.a(new_n262_), .b(new_n260_), .c(x0), .O(new_n263_));
  nand2  g246(.a(new_n263_), .b(new_n258_), .O(new_n264_));
  aoi21  g247(.a(new_n251_), .b(x5), .c(new_n264_), .O(new_n265_));
  aoi21  g248(.a(new_n265_), .b(new_n231_), .c(new_n18_), .O(z4));
  nor2   g249(.a(new_n238_), .b(new_n213_), .O(z5));
  zero   g250(.O(z3));
endmodule
