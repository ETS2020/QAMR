...
module FAU ( 
  ...
  nor2   g194(.a(new_n92_), .b(new_n142_), .O(z3));
  nor2   g195(.a(new_n150_), .b(x1), .O(new_n213_));
  nand3  g196(.a(x7), .b(x4), .c(x3), .O(new_n214_));
  inv1   g197(.a(new_n214_), .O(new_n215_));
  oai22  g198(.a(x8), .b(x4), .c(x7), .d(x2), .O(new_n216_));
  oai21  g199(.a(new_n216_), .b(new_n215_), .c(x6), .O(new_n217_));
  oai21  g200(.a(new_n213_), .b(new_n143_), .c(new_n217_), .O(new_n218_));
  nand2  g201(.a(new_n218_), .b(x0), .O(new_n219_));
  nand2  g202(.a(new_n103_), .b(x6), .O(new_n220_));
  nand2  g203(.a(new_n148_), .b(new_n35_), .O(new_n221_));
  nand2  g204(.a(new_n66_), .b(x3), .O(new_n222_));
  aoi21  g205(.a(new_n222_), .b(new_n221_), .c(new_n36_), .O(new_n223_));
  nand3  g206(.a(new_n148_), .b(x3), .c(new_n142_), .O(new_n224_));
  inv1   g207(.a(new_n224_), .O(new_n225_));
  oai21  g208(.a(new_n225_), .b(new_n223_), .c(x4), .O(new_n226_));
  nand3  g209(.a(new_n226_), .b(new_n220_), .c(new_n219_), .O(new_n227_));
  nand2  g210(.a(new_n227_), .b(new_n22_), .O(new_n228_));
  nand3  g211(.a(new_n116_), .b(new_n113_), .c(new_n52_), .O(new_n229_));
  nand2  g212(.a(x7), .b(new_n52_), .O(new_n230_));
  nand3  g213(.a(new_n230_), .b(x2), .c(x0), .O(new_n231_));
  nand3  g214(.a(new_n231_), .b(new_n229_), .c(new_n38_), .O(new_n232_));
  nand2  g215(.a(new_n26_), .b(new_n35_), .O(new_n233_));
  nand2  g216(.a(new_n233_), .b(x7), .O(new_n234_));
  xor2a  g217(.a(x2), .b(x0), .O(new_n235_));
  inv1   g218(.a(new_n235_), .O(new_n236_));
  aoi21  g219(.a(x8), .b(new_n38_), .c(x1), .O(new_n237_));
  nand3  g220(.a(new_n237_), .b(new_n236_), .c(new_n234_), .O(new_n238_));
  oai21  g221(.a(x2), .b(new_n35_), .c(new_n142_), .O(new_n239_));
  nand3  g222(.a(new_n239_), .b(new_n54_), .c(x7), .O(new_n240_));
  nand3  g223(.a(new_n240_), .b(new_n238_), .c(new_n232_), .O(new_n241_));
  nand2  g224(.a(new_n241_), .b(new_n92_), .O(new_n242_));
  oai21  g225(.a(new_n175_), .b(new_n35_), .c(new_n142_), .O(new_n243_));
  oai21  g226(.a(new_n199_), .b(new_n38_), .c(new_n28_), .O(new_n244_));
  nand2  g227(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  oai22  g228(.a(new_n235_), .b(new_n61_), .c(new_n233_), .d(x4), .O(new_n246_));
  aoi22  g229(.a(new_n246_), .b(z3), .c(new_n245_), .d(x4), .O(new_n247_));
  nand2  g230(.a(new_n247_), .b(new_n242_), .O(new_n248_));
  nand2  g231(.a(x5), .b(x4), .O(new_n249_));
  nand3  g232(.a(new_n249_), .b(new_n38_), .c(x3), .O(new_n250_));
  aoi21  g233(.a(new_n250_), .b(new_n196_), .c(new_n28_), .O(new_n251_));
  nand2  g234(.a(new_n69_), .b(new_n66_), .O(new_n252_));
  nand2  g235(.a(new_n148_), .b(new_n92_), .O(new_n253_));
  aoi21  g236(.a(new_n253_), .b(new_n252_), .c(x5), .O(new_n254_));
  oai21  g237(.a(new_n254_), .b(new_n251_), .c(x1), .O(new_n255_));
  nand2  g238(.a(new_n178_), .b(x1), .O(new_n256_));
  aoi21  g239(.a(new_n256_), .b(new_n203_), .c(new_n230_), .O(new_n257_));
  nand3  g240(.a(new_n103_), .b(new_n38_), .c(x1), .O(new_n258_));
  inv1   g241(.a(new_n258_), .O(new_n259_));
  oai21  g242(.a(new_n259_), .b(new_n257_), .c(x0), .O(new_n260_));
  nand2  g243(.a(new_n260_), .b(new_n255_), .O(new_n261_));
  aoi21  g244(.a(new_n248_), .b(x5), .c(new_n261_), .O(new_n262_));
  aoi21  g245(.a(new_n262_), .b(new_n228_), .c(new_n18_), .O(z4));
  nor2   g246(.a(x3), .b(x1), .O(new_n264_));
  nor2   g247(.a(new_n264_), .b(z3), .O(new_n265_));
  nor2   g248(.a(new_n265_), .b(new_n235_), .O(z5));
  zero   g249(.O(z2));
endmodule
