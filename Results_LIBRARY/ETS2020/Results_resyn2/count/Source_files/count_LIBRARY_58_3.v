// Benchmark "FAU" written by ABC on Fri Jul 24 21:59:06 2020
...
module FAU ( 
  ...
  oai21  g111(.a(new_n157_), .b(new_n105_), .c(x33), .O(new_n163_));
  nor2   g112(.a(x33), .b(x32), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n154_), .c(new_n98_), .O(new_n165_));
