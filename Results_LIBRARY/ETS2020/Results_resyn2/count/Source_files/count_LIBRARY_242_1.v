...
module FAU ( 
  ...
  nand2  g61(.a(new_n110_), .b(x29), .O(new_n115_));
  inv1   g62(.a(x29), .O(new_n116_));
  inv1   g63(.a(x26), .O(new_n117_));
  inv1   g64(.a(x27), .O(new_n118_));
  nand2  g65(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  inv1   g66(.a(x25), .O(new_n120_));
  nand3  g67(.a(new_n108_), .b(new_n120_), .c(new_n97_), .O(new_n121_));
  nor2   g68(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g69(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  nand2  g70(.a(new_n123_), .b(new_n116_), .O(new_n124_));
  nand3  g71(.a(new_n124_), .b(new_n115_), .c(x16), .O(new_n125_));
  inv1   g72(.a(x05), .O(new_n126_));
  aoi21  g73(.a(new_n58_), .b(new_n126_), .c(x18), .O(new_n127_));
  nand2  g74(.a(new_n127_), .b(new_n125_), .O(z10));
  nor2   g75(.a(x30), .b(x29), .O(new_n130_));
  nand3  g76(.a(new_n130_), .b(new_n122_), .c(new_n86_), .O(new_n131_));
  nor3   g77(.a(x31), .b(x30), .c(x29), .O(new_n132_));
  aoi22  g78(.a(new_n132_), .b(new_n110_), .c(new_n131_), .d(x31), .O(new_n133_));
  ...
  nand3  g82(.a(new_n132_), .b(new_n110_), .c(x32), .O(new_n137_));
  inv1   g83(.a(x32), .O(new_n138_));
  inv1   g84(.a(new_n132_), .O(new_n139_));
  oai21  g85(.a(new_n139_), .b(new_n123_), .c(new_n138_), .O(new_n140_));
  nand3  g86(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
