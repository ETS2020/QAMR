...
module FAU ( 
  ...
  nand2  g37(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  xor2a  g38(.a(new_n90_), .b(x24), .O(new_n91_));
  inv1   g39(.a(x10), .O(new_n92_));
  aoi21  g40(.a(new_n58_), .b(new_n92_), .c(x18), .O(new_n93_));
  oai21  g41(.a(new_n91_), .b(new_n58_), .c(new_n93_), .O(z05));
  inv1   g42(.a(x18), .O(new_n95_));
  nand2  g43(.a(new_n58_), .b(x09), .O(new_n96_));
  inv1   g44(.a(x24), .O(new_n97_));
  inv1   g45(.a(x25), .O(new_n98_));
  aoi21  g46(.a(new_n84_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g47(.a(new_n98_), .b(new_n97_), .O(new_n100_));
  oai21  g48(.a(new_n100_), .b(new_n90_), .c(x16), .O(new_n101_));
  oai21  g49(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n95_), .O(z06));
  inv1   g51(.a(x29), .O(new_n107_));
  nor2   g52(.a(x25), .b(x24), .O(new_n108_));
  nor3   g53(.a(x28), .b(x27), .c(x26), .O(new_n109_));
  nand4  g54(.a(new_n109_), .b(new_n108_), .c(new_n89_), .d(new_n63_), .O(new_n110_));
  nor2   g55(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  inv1   g56(.a(new_n110_), .O(new_n112_));
  oai21  g57(.a(new_n112_), .b(x29), .c(x16), .O(new_n113_));
  inv1   g58(.a(x05), .O(new_n114_));
  aoi21  g59(.a(new_n58_), .b(new_n114_), .c(x18), .O(new_n115_));
  oai21  g60(.a(new_n113_), .b(new_n111_), .c(new_n115_), .O(z10));
  nor3   g61(.a(x31), .b(x30), .c(x29), .O(new_n118_));
  nor2   g62(.a(x30), .b(x29), .O(new_n119_));
  nor2   g63(.a(new_n100_), .b(new_n80_), .O(new_n120_));
  inv1   g64(.a(x26), .O(new_n121_));
  inv1   g65(.a(x27), .O(new_n122_));
  inv1   g66(.a(x28), .O(new_n123_));
  nand3  g67(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nor2   g68(.a(new_n124_), .b(new_n83_), .O(new_n125_));
  nand3  g69(.a(new_n125_), .b(new_n120_), .c(new_n119_), .O(new_n126_));
  aoi22  g70(.a(new_n126_), .b(x31), .c(new_n118_), .d(new_n112_), .O(new_n127_));
  inv1   g71(.a(x03), .O(new_n128_));
  aoi21  g72(.a(new_n58_), .b(new_n128_), .c(x18), .O(new_n129_));
  oai21  g73(.a(new_n127_), .b(new_n58_), .c(new_n129_), .O(z12));
  nand3  g74(.a(new_n125_), .b(new_n120_), .c(new_n118_), .O(new_n131_));
  inv1   g75(.a(x32), .O(new_n132_));
  nand2  g76(.a(new_n118_), .b(new_n132_), .O(new_n133_));
  inv1   g77(.a(new_n133_), .O(new_n134_));
  aoi22  g78(.a(new_n134_), .b(new_n112_), .c(new_n131_), .d(x32), .O(new_n135_));
