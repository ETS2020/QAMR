...
module FAU ( 
  ...
  nor2   g46(.a(x27), .b(x26), .O(new_n101_));
  nand3  g47(.a(new_n101_), .b(new_n100_), .c(new_n86_), .O(new_n102_));
  inv1   g48(.a(x28), .O(new_n103_));
  nand3  g49(.a(new_n101_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nor2   g50(.a(new_n104_), .b(new_n92_), .O(new_n105_));
  aoi21  g51(.a(new_n102_), .b(x28), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g55(.a(new_n104_), .b(new_n92_), .c(x29), .O(new_n110_));
  inv1   g56(.a(x29), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(new_n103_), .O(new_n112_));
  oai21  g58(.a(new_n112_), .b(new_n102_), .c(new_n110_), .O(new_n113_));
  nand2  g59(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g60(.a(x05), .O(new_n115_));
  aoi21  g61(.a(new_n58_), .b(new_n115_), .c(x18), .O(new_n116_));
  nand2  g62(.a(new_n116_), .b(new_n114_), .O(z10));
  inv1   g63(.a(x26), .O(new_n119_));
  inv1   g64(.a(x27), .O(new_n120_));
  nand2  g65(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  inv1   g66(.a(x24), .O(new_n122_));
  inv1   g67(.a(x25), .O(new_n123_));
  nand3  g68(.a(new_n103_), .b(new_n123_), .c(new_n122_), .O(new_n124_));
  nor2   g69(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nor2   g70(.a(x30), .b(x29), .O(new_n126_));
  nand3  g71(.a(new_n126_), .b(new_n125_), .c(new_n86_), .O(new_n127_));
  nor3   g72(.a(x31), .b(x30), .c(x29), .O(new_n128_));
  aoi22  g73(.a(new_n128_), .b(new_n105_), .c(new_n127_), .d(x31), .O(new_n129_));
  inv1   g74(.a(x03), .O(new_n130_));
  aoi21  g75(.a(new_n58_), .b(new_n130_), .c(x18), .O(new_n131_));
  oai21  g76(.a(new_n129_), .b(new_n58_), .c(new_n131_), .O(z12));
  nand3  g77(.a(new_n128_), .b(new_n105_), .c(x32), .O(new_n133_));
  inv1   g78(.a(x32), .O(new_n134_));
  nand2  g79(.a(new_n125_), .b(new_n86_), .O(new_n135_));
  inv1   g80(.a(new_n128_), .O(new_n136_));
  oai21  g81(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  nand3  g82(.a(new_n137_), .b(new_n133_), .c(x16), .O(new_n138_));
