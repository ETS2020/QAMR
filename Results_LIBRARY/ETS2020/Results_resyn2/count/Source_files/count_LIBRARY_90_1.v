...
module FAU ( 
  ...
  nor2   g45(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  aoi21  g46(.a(new_n95_), .b(x25), .c(new_n98_), .O(new_n99_));
  inv1   g47(.a(x09), .O(new_n100_));
  aoi21  g48(.a(new_n58_), .b(new_n100_), .c(x18), .O(new_n101_));
  oai21  g49(.a(new_n99_), .b(new_n58_), .c(new_n101_), .O(z06));
  inv1   g50(.a(x26), .O(new_n103_));
  xor2a  g51(.a(new_n98_), .b(new_n103_), .O(new_n104_));
  inv1   g52(.a(x08), .O(new_n105_));
  aoi21  g53(.a(new_n58_), .b(new_n105_), .c(x18), .O(new_n106_));
  oai21  g54(.a(new_n104_), .b(new_n58_), .c(new_n106_), .O(z07));
  inv1   g55(.a(new_n83_), .O(new_n109_));
  nor2   g56(.a(x27), .b(x26), .O(new_n110_));
  nand4  g57(.a(new_n110_), .b(new_n96_), .c(new_n109_), .d(new_n64_), .O(new_n111_));
  inv1   g58(.a(x27), .O(new_n112_));
  inv1   g59(.a(x28), .O(new_n113_));
  nand3  g60(.a(new_n113_), .b(new_n112_), .c(new_n103_), .O(new_n114_));
  inv1   g61(.a(new_n114_), .O(new_n115_));
  aoi22  g62(.a(new_n115_), .b(new_n98_), .c(new_n111_), .d(x28), .O(new_n116_));
  inv1   g63(.a(x06), .O(new_n117_));
  aoi21  g64(.a(new_n58_), .b(new_n117_), .c(x18), .O(new_n118_));
  oai21  g65(.a(new_n116_), .b(new_n58_), .c(new_n118_), .O(z09));
  nand3  g66(.a(new_n115_), .b(new_n98_), .c(x29), .O(new_n120_));
  inv1   g67(.a(x29), .O(new_n121_));
  nand3  g68(.a(new_n115_), .b(new_n96_), .c(new_n84_), .O(new_n122_));
  nand2  g69(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g70(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  inv1   g71(.a(x05), .O(new_n125_));
  aoi21  g72(.a(new_n58_), .b(new_n125_), .c(x18), .O(new_n126_));
  nand2  g73(.a(new_n126_), .b(new_n124_), .O(z10));
  inv1   g74(.a(x30), .O(new_n129_));
  nand2  g75(.a(new_n129_), .b(new_n121_), .O(new_n130_));
  nor2   g76(.a(new_n130_), .b(new_n114_), .O(new_n131_));
  nand3  g77(.a(new_n131_), .b(new_n96_), .c(new_n84_), .O(new_n132_));
  xor2a  g78(.a(new_n132_), .b(x31), .O(new_n133_));
  ...
  inv1   g82(.a(x32), .O(new_n137_));
  inv1   g83(.a(x31), .O(new_n138_));
  nand4  g84(.a(new_n131_), .b(new_n96_), .c(new_n84_), .d(new_n138_), .O(new_n139_));
  nand2  g85(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g86(.a(new_n131_), .b(new_n98_), .c(x32), .d(new_n138_), .O(new_n141_));
  nand3  g87(.a(new_n141_), .b(new_n140_), .c(x16), .O(new_n142_));
  inv1   g88(.a(x02), .O(new_n143_));
  aoi21  g89(.a(new_n58_), .b(new_n143_), .c(x18), .O(new_n144_));
  nand2  g90(.a(new_n144_), .b(new_n142_), .O(z13));
  zero   g91(.O(z02));
  zero   g92(.O(z08));
  zero   g93(.O(z11));
  zero   g94(.O(z14));
