...
module FAU ( 
  ...
  oai21  g115(.a(new_n51_), .b(x14), .c(new_n50_), .O(new_n150_));
  aoi21  g116(.a(new_n150_), .b(new_n78_), .c(x03), .O(new_n151_));
  oai21  g117(.a(x20), .b(new_n80_), .c(x06), .O(new_n152_));
  aoi21  g118(.a(new_n152_), .b(x11), .c(new_n73_), .O(new_n153_));
  oai22  g119(.a(new_n153_), .b(new_n119_), .c(new_n151_), .d(new_n46_), .O(z6));
