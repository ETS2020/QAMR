...
module FAU ( 
  ...
  nand3  g33(.a(new_n65_), .b(new_n68_), .c(new_n64_), .O(new_n69_));
  oai21  g34(.a(new_n61_), .b(x10), .c(x11), .O(new_n70_));
  nand3  g35(.a(new_n70_), .b(new_n69_), .c(new_n45_), .O(z07));
  nor2   g36(.a(x09), .b(new_n55_), .O(new_n73_));
  nor2   g37(.a(x12), .b(x11), .O(new_n74_));
  nand4  g38(.a(new_n74_), .b(new_n73_), .c(new_n53_), .d(new_n64_), .O(new_n75_));
  nand2  g39(.a(new_n75_), .b(x13), .O(new_n76_));
  inv1   g40(.a(x12), .O(new_n77_));
  inv1   g41(.a(x13), .O(new_n78_));
  nand4  g42(.a(new_n78_), .b(new_n77_), .c(new_n68_), .d(new_n64_), .O(new_n79_));
  inv1   g43(.a(new_n79_), .O(new_n80_));
  nand2  g44(.a(new_n80_), .b(new_n65_), .O(new_n81_));
  nand3  g45(.a(new_n81_), .b(new_n76_), .c(new_n45_), .O(z09));
  nand2  g46(.a(new_n44_), .b(x14), .O(new_n83_));
  oai21  g47(.a(x03), .b(new_n36_), .c(x16), .O(new_n84_));
  inv1   g48(.a(x00), .O(new_n85_));
  nand2  g49(.a(new_n79_), .b(new_n85_), .O(new_n86_));
  nand3  g50(.a(new_n86_), .b(new_n65_), .c(new_n84_), .O(new_n87_));
  aoi21  g51(.a(new_n87_), .b(new_n83_), .c(new_n41_), .O(z10));
  nand2  g52(.a(x16), .b(new_n36_), .O(new_n89_));
  aoi21  g53(.a(new_n89_), .b(new_n42_), .c(new_n41_), .O(z12));
