...
module FAU ( 
  ...
  nor2   g09(.a(new_n44_), .b(new_n38_), .O(new_n45_));
  ...
  nand2  g14(.a(new_n49_), .b(new_n41_), .O(new_n50_));
  ...
  inv1   g46(.a(x02), .O(new_n82_));
  oai21  g47(.a(x03), .b(new_n82_), .c(x16), .O(new_n83_));
  inv1   g48(.a(x00), .O(new_n84_));
  inv1   g49(.a(x12), .O(new_n85_));
  nand4  g50(.a(new_n78_), .b(new_n85_), .c(new_n68_), .d(new_n64_), .O(new_n86_));
  nand2  g51(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand3  g52(.a(new_n87_), .b(new_n65_), .c(new_n83_), .O(new_n88_));
  aoi21  g53(.a(new_n88_), .b(new_n81_), .c(new_n38_), .O(z10));
  nand2  g54(.a(x16), .b(new_n82_), .O(new_n91_));
  aoi21  g55(.a(new_n91_), .b(new_n42_), .c(new_n38_), .O(z12));
