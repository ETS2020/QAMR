// Benchmark "FAU" written by ABC on Fri Jul 24 21:44:43 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n36_, new_n37_, new_n38_, new_n41_, new_n42_, new_n43_, new_n44_,
    new_n45_;
  ...
  xor2a  g07(.a(x07), .b(x06), .O(new_n44_));
  nand2  g08(.a(new_n44_), .b(x04), .O(new_n45_));
  nor2   g09(.a(new_n45_), .b(new_n43_), .O(z03));
  zero   g10(.O(z00));
  zero   g11(.O(z02));
  zero   g12(.O(z04));
  zero   g13(.O(z05));
