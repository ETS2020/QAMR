...
module FAU ( 
  ...
  nor2   g40(.a(x09), .b(new_n58_), .O(new_n76_));
  nor2   g41(.a(x12), .b(x11), .O(new_n77_));
  nand4  g42(.a(new_n77_), .b(new_n76_), .c(new_n56_), .d(new_n67_), .O(new_n78_));
  nand2  g43(.a(new_n78_), .b(x13), .O(new_n79_));
  inv1   g44(.a(x12), .O(new_n80_));
  inv1   g45(.a(x13), .O(new_n81_));
  nand4  g46(.a(new_n81_), .b(new_n80_), .c(new_n71_), .d(new_n67_), .O(new_n82_));
  inv1   g47(.a(new_n82_), .O(new_n83_));
  nand2  g48(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n79_), .c(new_n48_), .O(z09));
  nand2  g50(.a(new_n47_), .b(x14), .O(new_n86_));
  oai21  g51(.a(x03), .b(new_n36_), .c(x16), .O(new_n87_));
  inv1   g52(.a(x00), .O(new_n88_));
  nand2  g53(.a(new_n82_), .b(new_n88_), .O(new_n89_));
  nand3  g54(.a(new_n89_), .b(new_n68_), .c(new_n87_), .O(new_n90_));
  aoi21  g55(.a(new_n90_), .b(new_n86_), .c(new_n41_), .O(z10));
  nand2  g56(.a(x16), .b(new_n36_), .O(new_n93_));
  aoi21  g57(.a(new_n93_), .b(new_n45_), .c(new_n41_), .O(z12));
