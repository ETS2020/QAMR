...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n37_, new_n40_, new_n41_, new_n42_, new_n43_,
    ...
    new_n61_, new_n63_, new_n64_, new_n65_, new_n66_, new_n69_, new_n70_,
  ...
  nor2   g33(.a(x09), .b(new_n55_), .O(new_n70_));
  nand4  g34(.a(new_n70_), .b(new_n53_), .c(new_n69_), .d(new_n64_), .O(new_n71_));
  nand2  g35(.a(new_n71_), .b(x12), .O(new_n72_));
  nor2   g36(.a(x12), .b(x11), .O(new_n73_));
  nand4  g37(.a(new_n73_), .b(new_n70_), .c(new_n53_), .d(new_n64_), .O(new_n74_));
  nand3  g38(.a(new_n74_), .b(new_n72_), .c(new_n45_), .O(z08));
  nand2  g39(.a(new_n74_), .b(x13), .O(new_n76_));
  inv1   g40(.a(x13), .O(new_n77_));
  nand4  g41(.a(new_n73_), .b(new_n65_), .c(new_n77_), .d(new_n64_), .O(new_n78_));
  nand3  g42(.a(new_n78_), .b(new_n76_), .c(new_n45_), .O(z09));
  nand2  g43(.a(new_n44_), .b(x14), .O(new_n80_));
  oai21  g44(.a(x03), .b(new_n36_), .c(x16), .O(new_n81_));
  inv1   g45(.a(x00), .O(new_n82_));
  inv1   g46(.a(x12), .O(new_n83_));
  nand4  g47(.a(new_n77_), .b(new_n83_), .c(new_n69_), .d(new_n64_), .O(new_n84_));
  nand2  g48(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g49(.a(new_n85_), .b(new_n65_), .c(new_n81_), .O(new_n86_));
  aoi21  g50(.a(new_n86_), .b(new_n80_), .c(new_n41_), .O(z10));
