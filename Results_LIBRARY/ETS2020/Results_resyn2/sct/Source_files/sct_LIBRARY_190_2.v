...
module FAU ( 
  ...
  inv1   g10(.a(x16), .O(new_n46_));
  aoi21  g11(.a(new_n45_), .b(x02), .c(new_n46_), .O(new_n47_));
  nor2   g12(.a(new_n47_), .b(new_n41_), .O(new_n48_));
  nand2  g13(.a(x07), .b(x06), .O(new_n49_));
  or2    g14(.a(x07), .b(x06), .O(new_n50_));
  nand3  g15(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n51_));
  inv1   g16(.a(new_n51_), .O(z03));
  inv1   g17(.a(new_n49_), .O(new_n53_));
  nand2  g18(.a(new_n53_), .b(x08), .O(new_n54_));
  inv1   g19(.a(x08), .O(new_n55_));
  nand2  g20(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  ...
  aoi21  g54(.a(new_n90_), .b(new_n45_), .c(new_n41_), .O(z12));
