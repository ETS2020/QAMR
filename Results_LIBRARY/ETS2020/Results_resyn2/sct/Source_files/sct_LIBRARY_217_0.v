...
module FAU ( 
  ...
  nor2   g29(.a(x09), .b(new_n55_), .O(new_n66_));
  nand4  g30(.a(new_n66_), .b(new_n53_), .c(new_n65_), .d(new_n64_), .O(new_n67_));
  oai21  g31(.a(new_n61_), .b(x10), .c(x11), .O(new_n68_));
  nand3  g32(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(z07));
  nand2  g33(.a(new_n67_), .b(x12), .O(new_n70_));
  nor2   g34(.a(x12), .b(x11), .O(new_n71_));
  nand4  g35(.a(new_n71_), .b(new_n66_), .c(new_n53_), .d(new_n64_), .O(new_n72_));
  nand3  g36(.a(new_n72_), .b(new_n70_), .c(new_n45_), .O(z08));
  nand2  g37(.a(new_n72_), .b(x13), .O(new_n74_));
  inv1   g38(.a(x13), .O(new_n75_));
  inv1   g39(.a(new_n61_), .O(new_n76_));
  nand4  g40(.a(new_n71_), .b(new_n76_), .c(new_n75_), .d(new_n64_), .O(new_n77_));
  nand3  g41(.a(new_n77_), .b(new_n74_), .c(new_n45_), .O(z09));
  nand2  g42(.a(new_n44_), .b(x14), .O(new_n79_));
  oai21  g43(.a(x03), .b(new_n36_), .c(x16), .O(new_n80_));
  inv1   g44(.a(x00), .O(new_n81_));
  inv1   g45(.a(x12), .O(new_n82_));
  nand4  g46(.a(new_n75_), .b(new_n82_), .c(new_n65_), .d(new_n64_), .O(new_n83_));
  nand2  g47(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand3  g48(.a(new_n84_), .b(new_n76_), .c(new_n80_), .O(new_n85_));
  aoi21  g49(.a(new_n85_), .b(new_n79_), .c(new_n41_), .O(z10));
  nand2  g50(.a(x16), .b(new_n36_), .O(new_n87_));
  aoi21  g51(.a(new_n87_), .b(new_n42_), .c(new_n41_), .O(z12));
