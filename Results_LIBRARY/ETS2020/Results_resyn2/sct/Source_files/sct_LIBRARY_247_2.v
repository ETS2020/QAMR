...
module FAU ( 
  ...
  nor2   g37(.a(x09), .b(new_n58_), .O(new_n73_));
  nand4  g38(.a(new_n73_), .b(new_n56_), .c(new_n72_), .d(new_n67_), .O(new_n74_));
  nand2  g39(.a(new_n74_), .b(x12), .O(new_n75_));
  nor2   g40(.a(x12), .b(x11), .O(new_n76_));
  nand4  g41(.a(new_n76_), .b(new_n73_), .c(new_n56_), .d(new_n67_), .O(new_n77_));
  nand3  g42(.a(new_n77_), .b(new_n75_), .c(new_n48_), .O(z08));
  nand2  g43(.a(new_n77_), .b(x13), .O(new_n79_));
  inv1   g44(.a(x13), .O(new_n80_));
  nand4  g45(.a(new_n76_), .b(new_n68_), .c(new_n80_), .d(new_n67_), .O(new_n81_));
  ...
  nand4  g51(.a(new_n80_), .b(new_n86_), .c(new_n72_), .d(new_n67_), .O(new_n87_));
  nand2  g52(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand3  g53(.a(new_n88_), .b(new_n68_), .c(new_n84_), .O(new_n89_));
