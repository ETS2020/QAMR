...
module FAU ( 
  ...
  nand4  g39(.a(new_n65_), .b(new_n74_), .c(new_n68_), .d(new_n64_), .O(new_n75_));
  nand3  g40(.a(new_n75_), .b(new_n73_), .c(new_n45_), .O(z08));
  oai21  g41(.a(x03), .b(new_n36_), .c(x16), .O(new_n78_));
  inv1   g42(.a(x00), .O(new_n79_));
  inv1   g43(.a(x13), .O(new_n80_));
  nand4  g44(.a(new_n80_), .b(new_n74_), .c(new_n68_), .d(new_n64_), .O(new_n81_));
  nand2  g45(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand3  g46(.a(new_n82_), .b(new_n65_), .c(new_n78_), .O(new_n83_));
  nand2  g47(.a(new_n44_), .b(x14), .O(new_n84_));
  aoi21  g48(.a(new_n84_), .b(new_n83_), .c(new_n41_), .O(z10));
