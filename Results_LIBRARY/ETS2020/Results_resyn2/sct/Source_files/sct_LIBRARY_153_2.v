...
module FAU ( 
  ...
  nor2   g13(.a(new_n48_), .b(new_n40_), .O(new_n49_));
  inv1   g14(.a(new_n49_), .O(new_n50_));
  nand2  g15(.a(new_n48_), .b(new_n40_), .O(new_n51_));
  nand3  g16(.a(new_n51_), .b(new_n50_), .c(new_n45_), .O(new_n52_));
  inv1   g17(.a(new_n52_), .O(z03));
  inv1   g18(.a(x08), .O(new_n55_));
  oai21  g19(.a(new_n50_), .b(new_n55_), .c(x09), .O(new_n56_));
  ...
  nand4  g30(.a(new_n66_), .b(new_n49_), .c(new_n65_), .d(new_n61_), .O(new_n67_));
  ...
  nand4  g35(.a(new_n71_), .b(new_n66_), .c(new_n49_), .d(new_n61_), .O(new_n72_));
