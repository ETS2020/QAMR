...
module FAU ( 
  ...
  nand4  g43(.a(new_n68_), .b(new_n77_), .c(new_n71_), .d(new_n67_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z08));
  oai21  g45(.a(x03), .b(new_n36_), .c(x16), .O(new_n81_));
  inv1   g46(.a(x00), .O(new_n82_));
  inv1   g47(.a(x13), .O(new_n83_));
  nand4  g48(.a(new_n83_), .b(new_n77_), .c(new_n71_), .d(new_n67_), .O(new_n84_));
  nand2  g49(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g50(.a(new_n85_), .b(new_n68_), .c(new_n81_), .O(new_n86_));
  nand2  g51(.a(new_n47_), .b(x14), .O(new_n87_));
  aoi21  g52(.a(new_n87_), .b(new_n86_), .c(new_n41_), .O(z10));
