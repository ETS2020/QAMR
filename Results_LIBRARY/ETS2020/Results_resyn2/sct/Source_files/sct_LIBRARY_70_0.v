// Benchmark "FAU" written by ABC on Fri Jul 24 21:44:46 2020
...
module FAU ( 
  ...
  nand2  g16(.a(x07), .b(x06), .O(new_n52_));
  inv1   g17(.a(new_n52_), .O(new_n53_));
  nand2  g18(.a(new_n53_), .b(x08), .O(new_n54_));
  inv1   g19(.a(x08), .O(new_n55_));
  nand2  g20(.a(new_n52_), .b(new_n55_), .O(new_n56_));
  nand3  g21(.a(new_n56_), .b(new_n54_), .c(new_n48_), .O(new_n57_));
  ...
  nand3  g26(.a(new_n61_), .b(new_n59_), .c(new_n48_), .O(z05));
  ...
  nand3  g31(.a(new_n66_), .b(new_n63_), .c(new_n48_), .O(z06));
  ...
  nand3  g36(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z07));
  ...
  nand3  g40(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z08));
  ...
  nand3  g44(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z09));
  nand2  g45(.a(new_n47_), .b(x14), .O(new_n81_));
  ...
  aoi21  g54(.a(new_n89_), .b(new_n45_), .c(new_n41_), .O(z12));
