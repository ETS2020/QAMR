// Benchmark "FAU" written by ABC on Sat Jul 25 11:01:03 2020
...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n664_, new_n668_, new_n671_, new_n672_, new_n674_;
  ...
  inv1   g352(.a(new_n463_), .O(new_n464_));
  nor2   g353(.a(x05), .b(x00), .O(new_n465_));
  aoi21  g354(.a(new_n465_), .b(new_n161_), .c(new_n464_), .O(new_n466_));
  inv1   g355(.a(x42), .O(new_n467_));
  inv1   g356(.a(x44), .O(new_n468_));
  nor2   g357(.a(x43), .b(x40), .O(new_n469_));
  aoi21  g358(.a(new_n469_), .b(new_n468_), .c(new_n95_), .O(new_n470_));
  inv1   g359(.a(x40), .O(new_n471_));
  nand3  g360(.a(x44), .b(x43), .c(new_n471_), .O(new_n472_));
  inv1   g361(.a(new_n472_), .O(new_n473_));
  oai21  g362(.a(new_n473_), .b(new_n470_), .c(new_n467_), .O(new_n474_));
  xnor2a g363(.a(x42), .b(x39), .O(new_n475_));
  nand2  g364(.a(new_n475_), .b(new_n401_), .O(new_n476_));
  nand2  g365(.a(x42), .b(x19), .O(new_n477_));
  nand3  g366(.a(new_n477_), .b(new_n225_), .c(x21), .O(new_n478_));
  nor2   g367(.a(new_n478_), .b(new_n476_), .O(new_n479_));
  aoi21  g368(.a(new_n479_), .b(new_n474_), .c(new_n466_), .O(new_n480_));
  nor2   g369(.a(x21), .b(x01), .O(new_n481_));
  aoi21  g370(.a(x28), .b(x21), .c(new_n481_), .O(new_n482_));
  aoi22  g371(.a(new_n482_), .b(new_n221_), .c(new_n337_), .d(x23), .O(new_n483_));
  oai21  g372(.a(new_n480_), .b(x28), .c(new_n483_), .O(new_n484_));
  oai21  g373(.a(x28), .b(new_n147_), .c(new_n93_), .O(new_n485_));
  aoi21  g374(.a(new_n485_), .b(new_n310_), .c(new_n95_), .O(new_n486_));
  nand2  g375(.a(new_n158_), .b(x00), .O(new_n487_));
  nand3  g376(.a(new_n487_), .b(new_n463_), .c(new_n107_), .O(new_n488_));
  nand2  g377(.a(new_n488_), .b(x20), .O(new_n489_));
  nand3  g378(.a(new_n338_), .b(new_n287_), .c(x28), .O(new_n490_));
  oai21  g379(.a(new_n489_), .b(new_n486_), .c(new_n490_), .O(new_n491_));
  aoi21  g380(.a(new_n484_), .b(new_n134_), .c(new_n491_), .O(new_n492_));
  oai22  g381(.a(new_n290_), .b(x28), .c(new_n155_), .d(new_n138_), .O(new_n493_));
  nand2  g382(.a(new_n493_), .b(x22), .O(new_n494_));
  aoi21  g383(.a(new_n383_), .b(x28), .c(new_n95_), .O(new_n495_));
  nor2   g384(.a(x28), .b(x00), .O(new_n496_));
  nand2  g385(.a(new_n496_), .b(new_n276_), .O(new_n497_));
  nand4  g386(.a(new_n497_), .b(x26), .c(new_n117_), .d(new_n95_), .O(new_n498_));
  oai21  g387(.a(x28), .b(new_n202_), .c(new_n95_), .O(new_n499_));
  nand2  g388(.a(new_n499_), .b(x21), .O(new_n500_));
  nand3  g389(.a(new_n500_), .b(new_n498_), .c(x20), .O(new_n501_));
  nor2   g390(.a(new_n106_), .b(new_n123_), .O(new_n502_));
  aoi21  g391(.a(new_n120_), .b(x00), .c(new_n502_), .O(new_n503_));
  aoi21  g392(.a(new_n337_), .b(new_n106_), .c(x20), .O(new_n504_));
  oai21  g393(.a(new_n503_), .b(new_n287_), .c(new_n504_), .O(new_n505_));
  oai21  g394(.a(new_n501_), .b(new_n495_), .c(new_n505_), .O(new_n506_));
  nand2  g395(.a(new_n506_), .b(new_n494_), .O(new_n507_));
  nand2  g396(.a(new_n348_), .b(new_n95_), .O(new_n508_));
  nand2  g397(.a(new_n508_), .b(new_n386_), .O(new_n509_));
  nand2  g398(.a(new_n509_), .b(new_n267_), .O(new_n510_));
  nand2  g399(.a(new_n510_), .b(x29), .O(new_n511_));
  aoi21  g400(.a(new_n507_), .b(x18), .c(new_n511_), .O(new_n512_));
  oai21  g401(.a(new_n492_), .b(x18), .c(new_n512_), .O(new_n513_));
  nand3  g402(.a(new_n171_), .b(new_n117_), .c(x18), .O(new_n514_));
  inv1   g403(.a(new_n514_), .O(new_n515_));
  inv1   g404(.a(x08), .O(new_n516_));
  nand2  g405(.a(x16), .b(new_n516_), .O(new_n517_));
  nor2   g406(.a(x16), .b(x07), .O(new_n518_));
  nor2   g407(.a(new_n518_), .b(x21), .O(new_n519_));
  nand2  g408(.a(x22), .b(new_n94_), .O(new_n520_));
  aoi21  g409(.a(new_n519_), .b(new_n517_), .c(new_n520_), .O(new_n521_));
  oai21  g410(.a(new_n521_), .b(new_n515_), .c(x28), .O(new_n522_));
  nor2   g411(.a(x21), .b(new_n94_), .O(new_n523_));
  nand2  g412(.a(x03), .b(new_n93_), .O(new_n524_));
  nand3  g413(.a(new_n524_), .b(new_n523_), .c(x27), .O(new_n525_));
  aoi21  g414(.a(new_n525_), .b(new_n522_), .c(new_n95_), .O(new_n526_));
  inv1   g415(.a(x14), .O(new_n527_));
  nand4  g416(.a(new_n171_), .b(new_n157_), .c(new_n95_), .d(new_n527_), .O(new_n528_));
  inv1   g417(.a(new_n528_), .O(new_n529_));
  oai21  g418(.a(new_n529_), .b(new_n260_), .c(new_n94_), .O(new_n530_));
  nand3  g419(.a(new_n502_), .b(new_n347_), .c(x17), .O(new_n531_));
  aoi21  g420(.a(new_n531_), .b(new_n530_), .c(x21), .O(new_n532_));
  oai21  g421(.a(new_n532_), .b(new_n526_), .c(x20), .O(new_n533_));
  inv1   g422(.a(new_n103_), .O(new_n534_));
  oai21  g423(.a(new_n534_), .b(x13), .c(new_n374_), .O(new_n535_));
  nor2   g424(.a(new_n110_), .b(new_n106_), .O(new_n536_));
  oai21  g425(.a(new_n187_), .b(new_n94_), .c(new_n536_), .O(new_n537_));
  nand2  g426(.a(new_n537_), .b(new_n535_), .O(new_n538_));
  oai21  g427(.a(new_n215_), .b(new_n139_), .c(new_n376_), .O(new_n539_));
  nand2  g428(.a(new_n539_), .b(x21), .O(new_n540_));
  aoi21  g429(.a(new_n410_), .b(x14), .c(x29), .O(new_n541_));
  nand2  g430(.a(new_n541_), .b(new_n540_), .O(new_n542_));
  aoi21  g431(.a(new_n538_), .b(new_n117_), .c(new_n542_), .O(new_n543_));
  aoi21  g432(.a(new_n543_), .b(new_n533_), .c(x30), .O(new_n544_));
  nand2  g433(.a(new_n544_), .b(new_n513_), .O(new_n545_));
  nand2  g434(.a(new_n192_), .b(x19), .O(new_n546_));
  aoi21  g435(.a(new_n546_), .b(new_n301_), .c(new_n162_), .O(new_n547_));
  nand2  g436(.a(new_n162_), .b(x20), .O(new_n548_));
  aoi21  g437(.a(new_n198_), .b(x19), .c(new_n548_), .O(new_n549_));
  oai21  g438(.a(new_n549_), .b(new_n547_), .c(x28), .O(new_n550_));
  nand2  g439(.a(new_n348_), .b(new_n295_), .O(new_n551_));
  inv1   g440(.a(new_n551_), .O(new_n552_));
  oai21  g441(.a(x03), .b(x02), .c(x28), .O(new_n553_));
  nand2  g442(.a(new_n553_), .b(new_n134_), .O(new_n554_));
  nand2  g443(.a(new_n124_), .b(x20), .O(new_n555_));
  nand4  g444(.a(new_n555_), .b(new_n554_), .c(new_n191_), .d(new_n159_), .O(new_n556_));
  aoi21  g445(.a(new_n556_), .b(new_n95_), .c(new_n552_), .O(new_n557_));
  aoi21  g446(.a(new_n557_), .b(new_n550_), .c(x21), .O(new_n558_));
  nand2  g447(.a(new_n434_), .b(x00), .O(new_n559_));
  nor2   g448(.a(new_n191_), .b(new_n448_), .O(new_n560_));
  nand3  g449(.a(new_n123_), .b(new_n202_), .c(new_n107_), .O(new_n561_));
  oai21  g450(.a(new_n561_), .b(new_n560_), .c(new_n106_), .O(new_n562_));
  nand3  g451(.a(new_n562_), .b(new_n559_), .c(x19), .O(new_n563_));
  nand2  g452(.a(new_n427_), .b(x20), .O(new_n564_));
  nand3  g453(.a(new_n564_), .b(new_n423_), .c(new_n95_), .O(new_n565_));
  nand3  g454(.a(new_n565_), .b(new_n563_), .c(x21), .O(new_n566_));
  inv1   g455(.a(new_n566_), .O(new_n567_));
  oai21  g456(.a(new_n567_), .b(new_n558_), .c(new_n94_), .O(new_n568_));
  nand2  g457(.a(x21), .b(new_n93_), .O(new_n569_));
  nand2  g458(.a(new_n569_), .b(new_n370_), .O(new_n570_));
  nand2  g459(.a(new_n394_), .b(new_n123_), .O(new_n571_));
  aoi21  g460(.a(new_n571_), .b(new_n569_), .c(new_n149_), .O(new_n572_));
  nand3  g461(.a(x25), .b(new_n354_), .c(x05), .O(new_n573_));
  nand3  g462(.a(new_n573_), .b(new_n149_), .c(new_n94_), .O(new_n574_));
  aoi21  g463(.a(new_n332_), .b(new_n117_), .c(x28), .O(new_n575_));
  nand2  g464(.a(new_n575_), .b(new_n574_), .O(new_n576_));
  nand4  g465(.a(new_n502_), .b(new_n117_), .c(x18), .d(x00), .O(new_n577_));
  oai21  g466(.a(new_n576_), .b(new_n572_), .c(new_n577_), .O(new_n578_));
  nand2  g467(.a(new_n578_), .b(new_n95_), .O(new_n579_));
  nand2  g468(.a(new_n579_), .b(new_n570_), .O(new_n580_));
  oai21  g469(.a(new_n443_), .b(x22), .c(x19), .O(new_n581_));
  nor2   g470(.a(x25), .b(x21), .O(new_n582_));
  oai21  g471(.a(new_n496_), .b(x19), .c(x21), .O(new_n583_));
  nand2  g472(.a(new_n583_), .b(new_n102_), .O(new_n584_));
  aoi21  g473(.a(new_n582_), .b(new_n581_), .c(new_n584_), .O(new_n585_));
  aoi21  g474(.a(new_n580_), .b(x20), .c(new_n585_), .O(new_n586_));
  aoi21  g475(.a(new_n586_), .b(new_n568_), .c(x29), .O(new_n587_));
  nand3  g476(.a(x22), .b(x21), .c(new_n94_), .O(new_n588_));
  oai21  g477(.a(new_n514_), .b(new_n465_), .c(new_n588_), .O(new_n589_));
  aoi22  g478(.a(new_n589_), .b(x19), .c(new_n310_), .d(new_n94_), .O(new_n590_));
  nor3   g479(.a(new_n329_), .b(new_n97_), .c(x20), .O(new_n591_));
  nand3  g480(.a(new_n205_), .b(new_n203_), .c(x20), .O(new_n592_));
  nand2  g481(.a(x20), .b(new_n94_), .O(new_n593_));
  nand2  g482(.a(new_n593_), .b(x22), .O(new_n594_));
  nand4  g483(.a(new_n594_), .b(new_n592_), .c(new_n404_), .d(x21), .O(new_n595_));
  nand3  g484(.a(x26), .b(x20), .c(new_n276_), .O(new_n596_));
  aoi21  g485(.a(new_n596_), .b(new_n523_), .c(x19), .O(new_n597_));
  aoi21  g486(.a(new_n597_), .b(new_n595_), .c(new_n591_), .O(new_n598_));
  oai21  g487(.a(new_n590_), .b(new_n134_), .c(new_n598_), .O(new_n599_));
  nand2  g488(.a(new_n360_), .b(x18), .O(new_n600_));
  nor2   g489(.a(x21), .b(x18), .O(new_n601_));
  aoi21  g490(.a(new_n601_), .b(new_n191_), .c(new_n106_), .O(new_n602_));
  oai21  g491(.a(new_n394_), .b(x21), .c(new_n134_), .O(new_n603_));
  nor2   g492(.a(new_n319_), .b(new_n94_), .O(new_n604_));
  aoi22  g493(.a(new_n604_), .b(new_n603_), .c(new_n602_), .d(new_n600_), .O(new_n605_));
  oai22  g494(.a(new_n605_), .b(new_n95_), .c(new_n593_), .d(new_n338_), .O(new_n606_));
  aoi21  g495(.a(new_n599_), .b(new_n106_), .c(new_n606_), .O(new_n607_));
  nand2  g496(.a(new_n370_), .b(x25), .O(new_n608_));
  nand3  g497(.a(new_n106_), .b(new_n94_), .c(new_n246_), .O(new_n609_));
  nand3  g498(.a(new_n609_), .b(new_n98_), .c(x22), .O(new_n610_));
  nand2  g499(.a(new_n610_), .b(new_n608_), .O(new_n611_));
  nand2  g500(.a(new_n611_), .b(x21), .O(new_n612_));
  nand3  g501(.a(new_n463_), .b(new_n395_), .c(x18), .O(new_n613_));
  aoi21  g502(.a(new_n613_), .b(new_n612_), .c(x20), .O(new_n614_));
  inv1   g503(.a(new_n328_), .O(new_n615_));
  nand4  g504(.a(new_n314_), .b(new_n313_), .c(new_n110_), .d(new_n91_), .O(new_n616_));
  inv1   g505(.a(new_n616_), .O(new_n617_));
  aoi21  g506(.a(new_n615_), .b(new_n117_), .c(new_n617_), .O(new_n618_));
  nand2  g507(.a(new_n191_), .b(new_n123_), .O(new_n619_));
  nand3  g508(.a(new_n619_), .b(new_n370_), .c(x21), .O(new_n620_));
  oai21  g509(.a(new_n618_), .b(new_n220_), .c(new_n620_), .O(new_n621_));
  nor2   g510(.a(new_n621_), .b(new_n614_), .O(new_n622_));
  oai21  g511(.a(new_n607_), .b(new_n91_), .c(new_n622_), .O(new_n623_));
  oai21  g512(.a(new_n623_), .b(new_n587_), .c(x30), .O(new_n624_));
  nand3  g513(.a(x25), .b(new_n94_), .c(new_n354_), .O(new_n625_));
  inv1   g514(.a(new_n625_), .O(new_n626_));
  oai21  g515(.a(new_n626_), .b(new_n335_), .c(x20), .O(new_n627_));
  nand4  g516(.a(new_n476_), .b(new_n225_), .c(new_n218_), .d(new_n266_), .O(new_n628_));
  nand2  g517(.a(new_n628_), .b(new_n627_), .O(new_n629_));
  nand2  g518(.a(new_n629_), .b(new_n337_), .O(new_n630_));
  nand3  g519(.a(new_n630_), .b(new_n624_), .c(new_n545_), .O(z37));
  oai21  g520(.a(new_n448_), .b(new_n134_), .c(new_n118_), .O(new_n632_));
  nand3  g521(.a(new_n502_), .b(new_n319_), .c(x11), .O(new_n633_));
  nand3  g522(.a(new_n633_), .b(new_n632_), .c(x18), .O(new_n634_));
  nand2  g523(.a(new_n107_), .b(new_n198_), .O(new_n635_));
  oai21  g524(.a(new_n635_), .b(new_n203_), .c(new_n267_), .O(new_n636_));
  xnor2a g525(.a(x20), .b(x02), .O(new_n637_));
  nand3  g526(.a(new_n637_), .b(new_n261_), .c(new_n161_), .O(new_n638_));
  nand3  g527(.a(new_n638_), .b(new_n636_), .c(new_n94_), .O(new_n639_));
  nand2  g528(.a(new_n639_), .b(new_n634_), .O(new_n640_));
  oai21  g529(.a(new_n329_), .b(new_n106_), .c(new_n99_), .O(new_n641_));
  oai21  g530(.a(new_n307_), .b(x18), .c(x19), .O(new_n642_));
  aoi21  g531(.a(new_n641_), .b(new_n604_), .c(new_n642_), .O(new_n643_));
  aoi21  g532(.a(new_n640_), .b(new_n95_), .c(new_n643_), .O(new_n644_));
  nor3   g533(.a(new_n588_), .b(new_n149_), .c(new_n134_), .O(new_n645_));
  oai21  g534(.a(new_n645_), .b(new_n644_), .c(x30), .O(new_n646_));
  nand2  g535(.a(new_n167_), .b(new_n117_), .O(new_n647_));
  aoi21  g536(.a(new_n647_), .b(new_n646_), .c(x29), .O(new_n648_));
  nand2  g537(.a(new_n359_), .b(new_n171_), .O(new_n649_));
  aoi21  g538(.a(new_n649_), .b(new_n508_), .c(new_n134_), .O(new_n650_));
  oai21  g539(.a(new_n395_), .b(new_n348_), .c(new_n137_), .O(new_n651_));
  nand2  g540(.a(new_n651_), .b(x18), .O(new_n652_));
  oai21  g541(.a(new_n389_), .b(new_n351_), .c(x20), .O(new_n653_));
  nand3  g542(.a(new_n296_), .b(new_n106_), .c(new_n161_), .O(new_n654_));
  nand2  g543(.a(new_n654_), .b(new_n546_), .O(new_n655_));
  aoi21  g544(.a(new_n655_), .b(new_n147_), .c(x18), .O(new_n656_));
  aoi21  g545(.a(new_n656_), .b(new_n653_), .c(x30), .O(new_n657_));
  oai21  g546(.a(new_n652_), .b(new_n650_), .c(new_n657_), .O(new_n658_));
  nand4  g547(.a(new_n361_), .b(new_n190_), .c(new_n370_), .d(new_n147_), .O(new_n659_));
  aoi21  g548(.a(new_n659_), .b(new_n658_), .c(new_n458_), .O(new_n660_));
  oai21  g549(.a(new_n660_), .b(new_n648_), .c(new_n93_), .O(new_n661_));
  nand2  g550(.a(new_n346_), .b(new_n119_), .O(new_n662_));
  nor2   g551(.a(x20), .b(x01), .O(new_n663_));
  nand4  g552(.a(new_n663_), .b(new_n662_), .c(new_n312_), .d(new_n110_), .O(new_n664_));
  nand2  g553(.a(new_n664_), .b(new_n661_), .O(z38));
  nand4  g554(.a(new_n91_), .b(new_n106_), .c(x21), .d(new_n148_), .O(new_n668_));
  nor4   g555(.a(new_n668_), .b(new_n414_), .c(new_n382_), .d(new_n214_), .O(z41));
  nor3   g556(.a(new_n464_), .b(new_n593_), .c(new_n231_), .O(new_n671_));
  nand2  g557(.a(new_n671_), .b(new_n635_), .O(new_n672_));
  inv1   g558(.a(new_n672_), .O(z43));
  nand2  g559(.a(new_n671_), .b(x22), .O(new_n674_));
  inv1   g560(.a(new_n674_), .O(z44));
  zero   g561(.O(z02));
  zero   g562(.O(z06));
  zero   g563(.O(z08));
  zero   g564(.O(z10));
