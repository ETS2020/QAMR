...
module FAU ( 
  ...
  nor2   g30(.a(x02), .b(x01), .O(new_n56_));
  nand2  g31(.a(x09), .b(new_n35_), .O(new_n57_));
  ...
  nand2  g35(.a(x08), .b(x00), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n46_), .c(new_n42_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n60_), .c(new_n59_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(z6));
  aoi21  g40(.a(new_n56_), .b(x03), .c(new_n43_), .O(new_n66_));
  nand3  g41(.a(new_n56_), .b(new_n45_), .c(x03), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n66_), .c(new_n54_), .O(z7));
  nand2  g44(.a(new_n56_), .b(x03), .O(new_n70_));
  nand2  g45(.a(new_n45_), .b(x00), .O(new_n71_));
  nand2  g46(.a(new_n53_), .b(x09), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n70_), .c(new_n71_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n54_), .O(z8));
  zero   g49(.O(z4));
endmodule
