// Benchmark "FAU" written by ABC on Fri Jul 24 21:55:12 2020
...
module FAU ( 
  ...
  nor2   g20(.a(x07), .b(new_n35_), .O(new_n46_));
  ...
  nand4  g25(.a(new_n50_), .b(x13), .c(new_n49_), .d(new_n35_), .O(z5));
  nor2   g26(.a(x02), .b(x01), .O(new_n53_));
  nand3  g27(.a(new_n53_), .b(x09), .c(x03), .O(new_n54_));
  nand2  g28(.a(new_n53_), .b(x03), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(new_n37_), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(new_n54_), .c(new_n50_), .O(z7));
  nand2  g31(.a(new_n39_), .b(x00), .O(new_n58_));
  nand4  g32(.a(new_n53_), .b(new_n49_), .c(x09), .d(x03), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(new_n50_), .O(z8));
  zero   g35(.O(z0));
  zero   g36(.O(z6));
endmodule
