// Benchmark "FAU" written by ABC on Fri Jul 24 21:55:05 2020
...
module FAU ( 
  ...
  nor2   g18(.a(x02), .b(x01), .O(new_n47_));
  nand3  g19(.a(new_n47_), .b(x09), .c(x03), .O(new_n48_));
  inv1   g20(.a(x08), .O(new_n49_));
  oai21  g21(.a(new_n30_), .b(new_n35_), .c(new_n49_), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(new_n48_), .c(new_n44_), .O(z7));
  nand3  g23(.a(new_n47_), .b(new_n43_), .c(x03), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x09), .O(new_n53_));
  inv1   g25(.a(x09), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n34_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n44_), .O(z8));
  zero   g28(.O(z2));
  zero   g29(.O(z3));
  zero   g30(.O(z4));
  zero   g31(.O(z6));
