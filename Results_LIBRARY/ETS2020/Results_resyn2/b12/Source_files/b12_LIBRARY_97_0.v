...
module FAU ( 
  ...
  nor2   g21(.a(new_n39_), .b(x07), .O(new_n48_));
  aoi22  g22(.a(new_n48_), .b(new_n47_), .c(x11), .d(x07), .O(z4));
  inv1   g23(.a(x12), .O(new_n50_));
  nor2   g24(.a(x10), .b(x07), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x13), .c(new_n50_), .d(new_n35_), .O(z5));
  xor2a  g26(.a(x09), .b(x03), .O(new_n53_));
  nand2  g27(.a(new_n28_), .b(new_n27_), .O(new_n54_));
  nor2   g28(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand4  g29(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(new_n46_), .c(new_n51_), .O(new_n57_));
  nor2   g31(.a(new_n57_), .b(new_n55_), .O(z6));
  nor2   g32(.a(x02), .b(x01), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(x09), .c(x03), .O(new_n60_));
  oai21  g34(.a(new_n54_), .b(new_n29_), .c(new_n37_), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n60_), .c(new_n51_), .O(z7));
  nand2  g36(.a(new_n39_), .b(x00), .O(new_n63_));
  nand4  g37(.a(new_n59_), .b(new_n50_), .c(x09), .d(x03), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n51_), .O(z8));
  zero   g40(.O(z0));
  zero   g41(.O(z3));
endmodule
