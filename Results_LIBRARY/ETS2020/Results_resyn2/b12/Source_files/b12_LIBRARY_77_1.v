...
module FAU ( 
  ...
  nor2   g28(.a(new_n45_), .b(x07), .O(new_n54_));
  aoi22  g29(.a(new_n54_), .b(new_n53_), .c(x11), .d(x07), .O(z4));
  inv1   g30(.a(x12), .O(new_n56_));
  nor2   g31(.a(x10), .b(x07), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x13), .c(new_n56_), .d(new_n41_), .O(z5));
  nor2   g33(.a(x02), .b(x01), .O(new_n59_));
  nand2  g34(.a(new_n45_), .b(x03), .O(new_n60_));
  nand2  g35(.a(x09), .b(new_n35_), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(new_n62_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n63_));
  nand3  g38(.a(new_n52_), .b(new_n46_), .c(new_n42_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z6));
  nand3  g42(.a(new_n59_), .b(x09), .c(x03), .O(new_n68_));
  oai21  g43(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(z7));
  nand2  g45(.a(new_n45_), .b(x00), .O(new_n71_));
  nand4  g46(.a(new_n59_), .b(new_n56_), .c(x09), .d(x03), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n57_), .O(z8));
  zero   g49(.O(z3));
endmodule
