...
module FAU ( 
  ...
  nor2   g12(.a(x07), .b(new_n28_), .O(new_n40_));
  nor2   g13(.a(new_n33_), .b(new_n30_), .O(new_n41_));
  aoi22  g14(.a(new_n41_), .b(new_n40_), .c(x11), .d(x07), .O(z4));
  nor2   g15(.a(x10), .b(x07), .O(new_n45_));
  nor2   g16(.a(x02), .b(x01), .O(new_n46_));
  nand3  g17(.a(new_n46_), .b(x09), .c(x03), .O(new_n47_));
  nand2  g18(.a(new_n46_), .b(x03), .O(new_n48_));
  nand2  g19(.a(new_n48_), .b(new_n30_), .O(new_n49_));
  nand3  g20(.a(new_n49_), .b(new_n47_), .c(new_n45_), .O(z7));
  nand2  g21(.a(new_n33_), .b(x00), .O(new_n51_));
  inv1   g22(.a(x12), .O(new_n52_));
  nand4  g23(.a(new_n46_), .b(new_n52_), .c(x09), .d(x03), .O(new_n53_));
  nand2  g24(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n45_), .O(z8));
  zero   g26(.O(z0));
  zero   g27(.O(z1));
  zero   g28(.O(z3));
  zero   g29(.O(z5));
