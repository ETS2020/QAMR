// Benchmark "FAU" written by ABC on Fri Jul 24 21:55:17 2020
...
module FAU ( 
  ...
  xor2a  g31(.a(x09), .b(x03), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(new_n31_), .O(new_n58_));
  nor2   g33(.a(x10), .b(x07), .O(new_n59_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n52_), .c(new_n59_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n58_), .O(z6));
  zero   g37(.O(z5));
  zero   g38(.O(z7));
  zero   g39(.O(z8));
endmodule
