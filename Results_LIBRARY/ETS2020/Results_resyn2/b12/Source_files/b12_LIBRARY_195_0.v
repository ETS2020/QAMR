// Benchmark "FAU" written by ABC on Fri Jul 24 21:55:09 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n41_, new_n42_, new_n43_, new_n47_, new_n48_, new_n50_, new_n51_,
  ...
  nand4  g22(.a(new_n48_), .b(x13), .c(new_n47_), .d(new_n35_), .O(z5));
  nand2  g23(.a(x09), .b(new_n29_), .O(new_n50_));
  nor2   g24(.a(x02), .b(x01), .O(new_n51_));
  nand2  g25(.a(new_n39_), .b(x03), .O(new_n52_));
  nand3  g26(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n53_));
  nand4  g27(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n54_));
  nand2  g28(.a(x08), .b(x00), .O(new_n55_));
  nand3  g29(.a(new_n55_), .b(new_n40_), .c(new_n36_), .O(new_n56_));
  inv1   g30(.a(new_n56_), .O(new_n57_));
  nand3  g31(.a(new_n57_), .b(new_n54_), .c(new_n53_), .O(new_n58_));
  inv1   g32(.a(new_n58_), .O(z6));
  nand3  g33(.a(new_n51_), .b(x09), .c(x03), .O(new_n60_));
  nand2  g34(.a(new_n51_), .b(x03), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(new_n37_), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(new_n60_), .c(new_n48_), .O(z7));
  nand2  g37(.a(new_n39_), .b(x00), .O(new_n64_));
  nand4  g38(.a(new_n51_), .b(new_n47_), .c(x09), .d(x03), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n48_), .O(z8));
  zero   g41(.O(z0));
  zero   g42(.O(z4));
endmodule
