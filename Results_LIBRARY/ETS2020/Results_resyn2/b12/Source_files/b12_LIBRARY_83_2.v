...
module FAU ( 
  ...
  nand4  g28(.a(new_n54_), .b(x13), .c(new_n53_), .d(new_n41_), .O(z5));
  nor2   g29(.a(x02), .b(x01), .O(new_n57_));
  nand3  g30(.a(new_n57_), .b(x09), .c(x03), .O(new_n58_));
  oai21  g31(.a(new_n28_), .b(new_n35_), .c(new_n43_), .O(new_n59_));
  nand3  g32(.a(new_n59_), .b(new_n58_), .c(new_n54_), .O(z7));
  nand2  g33(.a(new_n45_), .b(x00), .O(new_n61_));
  nand4  g34(.a(new_n57_), .b(new_n53_), .c(x09), .d(x03), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g36(.a(new_n63_), .b(new_n54_), .O(z8));
  zero   g37(.O(z3));
  zero   g38(.O(z4));
  zero   g39(.O(z6));
endmodule
