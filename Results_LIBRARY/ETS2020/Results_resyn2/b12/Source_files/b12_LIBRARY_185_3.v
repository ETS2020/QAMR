...
module FAU ( 
  ...
  nor2   g30(.a(x10), .b(x07), .O(new_n56_));
  nor2   g31(.a(x12), .b(x00), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n56_), .c(x13), .O(z5));
  xor2a  g33(.a(x09), .b(x03), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(new_n31_), .O(new_n60_));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n52_), .c(new_n56_), .O(new_n62_));
  nor2   g37(.a(new_n62_), .b(new_n60_), .O(z6));
  zero   g38(.O(z3));
  zero   g39(.O(z7));
  zero   g40(.O(z8));
endmodule
