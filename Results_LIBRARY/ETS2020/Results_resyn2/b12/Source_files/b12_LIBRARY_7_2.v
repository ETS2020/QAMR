...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n49_, new_n52_, new_n53_, new_n55_, new_n56_, new_n59_,
  ...
  nor2   g27(.a(x07), .b(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n45_), .b(new_n43_), .O(new_n53_));
  ...
  oai21  g35(.a(new_n28_), .b(new_n35_), .c(new_n43_), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n60_), .c(new_n56_), .O(z7));
  nand2  g37(.a(new_n45_), .b(x00), .O(new_n63_));
  nand4  g38(.a(new_n59_), .b(new_n55_), .c(x09), .d(x03), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n56_), .O(z8));
  zero   g41(.O(z6));
endmodule
