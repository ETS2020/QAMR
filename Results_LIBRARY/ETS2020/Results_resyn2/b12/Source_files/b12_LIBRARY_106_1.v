...
module FAU ( 
  ...
  nand2  g31(.a(new_n45_), .b(x03), .O(new_n58_));
  nand2  g32(.a(x09), .b(new_n35_), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n61_));
  nand3  g35(.a(new_n52_), .b(new_n46_), .c(new_n42_), .O(new_n62_));
  inv1   g36(.a(new_n62_), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  inv1   g38(.a(new_n64_), .O(z6));
  nor2   g39(.a(x10), .b(x07), .O(new_n66_));
  nand3  g40(.a(new_n57_), .b(x09), .c(x03), .O(new_n67_));
  oai21  g41(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z7));
  nand2  g43(.a(new_n45_), .b(x00), .O(new_n70_));
  inv1   g44(.a(x12), .O(new_n71_));
  nand4  g45(.a(new_n57_), .b(new_n71_), .c(x09), .d(x03), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n66_), .O(z8));
  zero   g48(.O(z3));
  zero   g49(.O(z5));
endmodule
