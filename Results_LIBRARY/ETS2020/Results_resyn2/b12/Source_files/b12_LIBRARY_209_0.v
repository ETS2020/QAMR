// Benchmark "FAU" written by ABC on Fri Jul 24 21:55:11 2020
...
module FAU ( 
  ...
  xor2a  g24(.a(x09), .b(x03), .O(new_n51_));
  nand2  g25(.a(new_n28_), .b(new_n27_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nor2   g27(.a(x10), .b(x07), .O(new_n54_));
  nand4  g28(.a(x14), .b(x02), .c(x01), .d(new_n35_), .O(new_n55_));
  nand3  g29(.a(new_n55_), .b(new_n46_), .c(new_n54_), .O(new_n56_));
  nor2   g30(.a(new_n56_), .b(new_n53_), .O(z6));
  nor2   g31(.a(x02), .b(x01), .O(new_n58_));
  nand3  g32(.a(new_n58_), .b(x09), .c(x03), .O(new_n59_));
  oai21  g33(.a(new_n52_), .b(new_n29_), .c(new_n37_), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n59_), .c(new_n54_), .O(z7));
  nand2  g35(.a(new_n39_), .b(x00), .O(new_n62_));
  inv1   g36(.a(x12), .O(new_n63_));
  nand4  g37(.a(new_n58_), .b(new_n63_), .c(x09), .d(x03), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n54_), .O(z8));
  zero   g40(.O(z0));
  zero   g41(.O(z5));
endmodule
