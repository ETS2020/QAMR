...
module FAU ( 
  ...
  nand3  g27(.a(new_n48_), .b(x09), .c(x03), .O(new_n55_));
  nand2  g28(.a(new_n48_), .b(x03), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(new_n30_), .O(new_n57_));
  nand4  g30(.a(new_n57_), .b(new_n55_), .c(new_n34_), .d(new_n29_), .O(z7));
  zero   g31(.O(z0));
  zero   g32(.O(z1));
  zero   g33(.O(z5));
  zero   g34(.O(z8));
