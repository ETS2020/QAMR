// Benchmark "FAU" written by ABC on Fri Jul 24 21:54:59 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n49_, new_n53_, new_n55_, new_n56_, new_n57_, new_n58_,
  ...
  nor2   g27(.a(x12), .b(x00), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x13), .c(new_n46_), .d(new_n42_), .O(z5));
  nor2   g29(.a(x02), .b(x01), .O(new_n55_));
  nand2  g30(.a(x09), .b(new_n35_), .O(new_n56_));
  nand2  g31(.a(new_n45_), .b(x03), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n59_));
  nand2  g34(.a(x08), .b(x00), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n46_), .c(new_n42_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n59_), .c(new_n58_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z6));
  zero   g39(.O(z4));
  zero   g40(.O(z7));
  zero   g41(.O(z8));
endmodule
