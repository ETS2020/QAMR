...
module FAU ( 
  ...
  nor2   g16(.a(x10), .b(x07), .O(new_n43_));
  nor2   g17(.a(x12), .b(x00), .O(new_n44_));
  nand3  g18(.a(new_n44_), .b(new_n43_), .c(x13), .O(z5));
  nand4  g19(.a(x09), .b(x03), .c(new_n29_), .d(new_n28_), .O(new_n47_));
  inv1   g20(.a(x08), .O(new_n48_));
  oai21  g21(.a(new_n30_), .b(new_n35_), .c(new_n48_), .O(new_n49_));
  nand3  g22(.a(new_n49_), .b(new_n47_), .c(new_n43_), .O(z7));
  zero   g23(.O(z2));
  zero   g24(.O(z4));
  zero   g25(.O(z6));
  zero   g26(.O(z8));
