// Benchmark "FAU" written by ABC on Fri Jul 24 21:54:49 2020
...
module FAU ( 
  ...
  nor2   g19(.a(x02), .b(x01), .O(new_n46_));
  inv1   g20(.a(x09), .O(new_n47_));
  nand2  g21(.a(new_n47_), .b(x03), .O(new_n48_));
  nand2  g22(.a(x09), .b(new_n35_), .O(new_n49_));
  nand3  g23(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(new_n50_));
  nand4  g24(.a(x14), .b(x02), .c(x01), .d(new_n34_), .O(new_n51_));
  inv1   g25(.a(x07), .O(new_n52_));
  inv1   g26(.a(x10), .O(new_n53_));
  nand2  g27(.a(x08), .b(x00), .O(new_n54_));
  nand3  g28(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n55_));
  inv1   g29(.a(new_n55_), .O(new_n56_));
  nand3  g30(.a(new_n56_), .b(new_n51_), .c(new_n50_), .O(new_n57_));
  inv1   g31(.a(new_n57_), .O(z6));
  inv1   g32(.a(x08), .O(new_n59_));
  aoi21  g33(.a(new_n46_), .b(x03), .c(new_n59_), .O(new_n60_));
  nand3  g34(.a(new_n46_), .b(new_n47_), .c(x03), .O(new_n61_));
  inv1   g35(.a(new_n61_), .O(new_n62_));
  oai21  g36(.a(new_n62_), .b(new_n60_), .c(new_n44_), .O(z7));
  nand2  g37(.a(new_n46_), .b(x03), .O(new_n64_));
  nand2  g38(.a(new_n43_), .b(x09), .O(new_n65_));
  nand2  g39(.a(new_n47_), .b(x00), .O(new_n66_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n44_), .O(z8));
  zero   g42(.O(z2));
  zero   g43(.O(z4));
endmodule
