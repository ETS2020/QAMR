...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n52_, new_n53_,
  ...
  nor2   g17(.a(x07), .b(new_n43_), .O(new_n44_));
  and2   g18(.a(x09), .b(x08), .O(new_n45_));
  aoi22  g19(.a(new_n45_), .b(new_n44_), .c(x11), .d(x07), .O(z4));
  nor2   g20(.a(x07), .b(x00), .O(new_n47_));
  nor2   g21(.a(x12), .b(x10), .O(new_n48_));
  nand3  g22(.a(new_n48_), .b(new_n47_), .c(x13), .O(z5));
  inv1   g23(.a(x12), .O(new_n52_));
  nand2  g24(.a(new_n52_), .b(x03), .O(new_n53_));
  oai21  g25(.a(new_n53_), .b(new_n28_), .c(x09), .O(new_n54_));
  inv1   g26(.a(x09), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n43_), .O(new_n56_));
  nor2   g28(.a(x10), .b(x07), .O(new_n57_));
  nand3  g29(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(z8));
  zero   g30(.O(z2));
  zero   g31(.O(z3));
  zero   g32(.O(z6));
  zero   g33(.O(z7));
