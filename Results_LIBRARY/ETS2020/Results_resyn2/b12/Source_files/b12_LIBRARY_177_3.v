...
module FAU ( 
  ...
  nand3  g43(.a(new_n56_), .b(x09), .c(x03), .O(new_n69_));
  oai22  g44(.a(new_n69_), .b(new_n30_), .c(x09), .d(new_n41_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n57_), .O(z8));
  zero   g46(.O(z7));
endmodule
