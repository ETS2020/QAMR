...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    new_n32_, new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n42_,
  ...
  nor2   g16(.a(x07), .b(new_n34_), .O(new_n42_));
  inv1   g17(.a(x08), .O(new_n43_));
  inv1   g18(.a(x09), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  aoi22  g20(.a(new_n45_), .b(new_n42_), .c(x11), .d(x07), .O(z4));
  inv1   g21(.a(x12), .O(new_n47_));
  nor2   g22(.a(x10), .b(x07), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x13), .c(new_n47_), .d(new_n34_), .O(z5));
  nor2   g24(.a(x02), .b(x01), .O(new_n51_));
  nand3  g25(.a(new_n51_), .b(x09), .c(x03), .O(new_n52_));
  oai21  g26(.a(new_n30_), .b(new_n35_), .c(new_n43_), .O(new_n53_));
  nand3  g27(.a(new_n53_), .b(new_n52_), .c(new_n48_), .O(z7));
  nand3  g28(.a(new_n51_), .b(new_n47_), .c(x03), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(x09), .O(new_n56_));
  nand2  g30(.a(new_n44_), .b(new_n34_), .O(new_n57_));
  nand3  g31(.a(new_n57_), .b(new_n56_), .c(new_n48_), .O(z8));
  zero   g32(.O(z2));
  zero   g33(.O(z6));
endmodule
