// Benchmark "FAU" written by ABC on Sat Jul 25 01:28:03 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n180_, new_n184_, new_n185_, new_n189_, new_n190_, new_n192_,
  ...
  nand2  g131(.a(new_n287_), .b(x70), .O(new_n300_));
  inv1   g132(.a(x10), .O(new_n301_));
  nand2  g133(.a(new_n293_), .b(new_n301_), .O(new_n302_));
  inv1   g134(.a(x18), .O(new_n303_));
  nand2  g135(.a(x52), .b(new_n303_), .O(new_n304_));
  nand3  g136(.a(new_n304_), .b(new_n302_), .c(new_n291_), .O(new_n305_));
  aoi21  g137(.a(new_n305_), .b(new_n300_), .c(x01), .O(z50));
  nand2  g138(.a(new_n287_), .b(x71), .O(new_n307_));
  inv1   g139(.a(x11), .O(new_n308_));
  nand2  g140(.a(new_n293_), .b(new_n308_), .O(new_n309_));
  inv1   g141(.a(x19), .O(new_n310_));
  nand2  g142(.a(x52), .b(new_n310_), .O(new_n311_));
  nand3  g143(.a(new_n311_), .b(new_n309_), .c(new_n291_), .O(new_n312_));
  aoi21  g144(.a(new_n312_), .b(new_n307_), .c(x01), .O(z51));
  nand2  g145(.a(new_n287_), .b(x72), .O(new_n314_));
  inv1   g146(.a(x12), .O(new_n315_));
  nand2  g147(.a(new_n293_), .b(new_n315_), .O(new_n316_));
  inv1   g148(.a(x20), .O(new_n317_));
  nand2  g149(.a(x52), .b(new_n317_), .O(new_n318_));
  nand3  g150(.a(new_n318_), .b(new_n316_), .c(new_n291_), .O(new_n319_));
  aoi21  g151(.a(new_n319_), .b(new_n314_), .c(x01), .O(z52));
  nand2  g152(.a(new_n287_), .b(x73), .O(new_n321_));
  inv1   g153(.a(x13), .O(new_n322_));
  nand2  g154(.a(new_n293_), .b(new_n322_), .O(new_n323_));
  inv1   g155(.a(x21), .O(new_n324_));
  nand2  g156(.a(x52), .b(new_n324_), .O(new_n325_));
  nand3  g157(.a(new_n325_), .b(new_n323_), .c(new_n291_), .O(new_n326_));
  aoi21  g158(.a(new_n326_), .b(new_n321_), .c(x01), .O(z53));
  inv1   g159(.a(x82), .O(new_n329_));
  nand2  g160(.a(x84), .b(new_n329_), .O(new_n330_));
  nor4   g161(.a(new_n330_), .b(new_n208_), .c(x81), .d(x80), .O(new_n331_));
  and2   g162(.a(new_n331_), .b(new_n252_), .O(z55));
  oai21  g163(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n333_));
  aoi21  g164(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n334_));
  nand2  g165(.a(new_n334_), .b(new_n333_), .O(z56));
  inv1   g166(.a(x02), .O(new_n336_));
  nand3  g167(.a(new_n219_), .b(x03), .c(new_n336_), .O(new_n337_));
  inv1   g168(.a(new_n337_), .O(z57));
  oai21  g169(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n339_));
  nand2  g170(.a(x78), .b(x04), .O(new_n340_));
  aoi21  g171(.a(x42), .b(x40), .c(new_n340_), .O(new_n341_));
  nand3  g172(.a(new_n341_), .b(new_n210_), .c(x79), .O(new_n342_));
  nand4  g173(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n343_));
  nand2  g174(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  nand2  g175(.a(new_n344_), .b(x77), .O(new_n345_));
  aoi21  g176(.a(new_n345_), .b(new_n339_), .c(x01), .O(z58));
  nor2   g177(.a(new_n158_), .b(new_n155_), .O(new_n348_));
  inv1   g178(.a(new_n348_), .O(new_n349_));
  nor2   g179(.a(new_n289_), .b(new_n215_), .O(new_n350_));
  oai21  g180(.a(new_n349_), .b(new_n161_), .c(new_n350_), .O(new_n351_));
  aoi21  g181(.a(new_n351_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g182(.a(new_n224_), .b(new_n220_), .O(new_n353_));
  oai21  g183(.a(new_n348_), .b(new_n214_), .c(new_n353_), .O(new_n354_));
  nand3  g184(.a(new_n354_), .b(new_n162_), .c(x80), .O(new_n355_));
  inv1   g185(.a(new_n355_), .O(z61));
  nand3  g186(.a(x84), .b(x81), .c(x79), .O(new_n357_));
  inv1   g187(.a(new_n357_), .O(new_n358_));
  nand2  g188(.a(new_n358_), .b(new_n158_), .O(new_n359_));
  aoi21  g189(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n360_));
  nand3  g190(.a(x81), .b(x79), .c(new_n220_), .O(new_n361_));
  nand2  g191(.a(new_n361_), .b(x77), .O(new_n362_));
  nor2   g192(.a(new_n289_), .b(x77), .O(new_n363_));
  aoi21  g193(.a(new_n363_), .b(new_n357_), .c(new_n154_), .O(new_n364_));
  oai21  g194(.a(new_n362_), .b(new_n360_), .c(new_n364_), .O(new_n365_));
  aoi21  g195(.a(new_n365_), .b(new_n359_), .c(x01), .O(z62));
  nand3  g196(.a(new_n354_), .b(new_n162_), .c(x82), .O(new_n367_));
  inv1   g197(.a(new_n367_), .O(z63));
  nand2  g198(.a(new_n349_), .b(x81), .O(new_n370_));
  nand2  g199(.a(new_n162_), .b(x84), .O(new_n371_));
  aoi21  g200(.a(new_n370_), .b(new_n353_), .c(new_n371_), .O(z65));
  zero   g201(.O(z00));
  zero   g202(.O(z01));
  zero   g203(.O(z04));
  zero   g204(.O(z05));
