...
module FAU ( 
  ...
  nand3  g094(.a(new_n244_), .b(x46), .c(new_n221_), .O(new_n250_));
  inv1   g095(.a(new_n250_), .O(z28));
  ...
  nand2  g153(.a(new_n290_), .b(x69), .O(new_n309_));
  inv1   g154(.a(x09), .O(new_n310_));
  nand2  g155(.a(new_n269_), .b(new_n310_), .O(new_n311_));
  inv1   g156(.a(x17), .O(new_n312_));
  nand2  g157(.a(x52), .b(new_n312_), .O(new_n313_));
  nand3  g158(.a(new_n313_), .b(new_n311_), .c(new_n295_), .O(new_n314_));
  aoi21  g159(.a(new_n314_), .b(new_n309_), .c(x01), .O(z49));
  nand2  g160(.a(new_n290_), .b(x70), .O(new_n316_));
  inv1   g161(.a(x10), .O(new_n317_));
  nand2  g162(.a(new_n269_), .b(new_n317_), .O(new_n318_));
  inv1   g163(.a(x18), .O(new_n319_));
  nand2  g164(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g165(.a(new_n320_), .b(new_n318_), .c(new_n295_), .O(new_n321_));
  aoi21  g166(.a(new_n321_), .b(new_n316_), .c(x01), .O(z50));
