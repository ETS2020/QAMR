...
module FAU ( 
  ...
  nand2  g129(.a(new_n272_), .b(x62), .O(new_n286_));
  nor2   g130(.a(new_n286_), .b(new_n270_), .O(z44));
  nor3   g131(.a(new_n270_), .b(new_n240_), .c(new_n180_), .O(z45));
  nor3   g132(.a(new_n270_), .b(new_n240_), .c(new_n177_), .O(z46));
  nor3   g133(.a(new_n232_), .b(new_n163_), .c(new_n155_), .O(new_n290_));
  oai21  g134(.a(x75), .b(x67), .c(new_n290_), .O(new_n291_));
  inv1   g135(.a(new_n161_), .O(new_n292_));
  nor2   g136(.a(x79), .b(new_n228_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(new_n292_), .O(new_n294_));
  inv1   g138(.a(new_n294_), .O(new_n295_));
  inv1   g139(.a(x07), .O(new_n296_));
  nand2  g140(.a(new_n268_), .b(new_n296_), .O(new_n297_));
  ...
  nand2  g147(.a(new_n268_), .b(new_n303_), .O(new_n304_));
  ...
  nand2  g182(.a(new_n268_), .b(new_n338_), .O(new_n339_));
  ...
  oai21  g188(.a(new_n268_), .b(x22), .c(new_n153_), .O(new_n345_));
  ...
  nor3   g193(.a(new_n349_), .b(new_n259_), .c(new_n240_), .O(z55));
  inv1   g194(.a(x02), .O(new_n352_));
  nand4  g195(.a(x03), .b(new_n352_), .c(new_n153_), .d(x00), .O(new_n353_));
  inv1   g196(.a(new_n353_), .O(z57));
  nand2  g197(.a(new_n226_), .b(new_n158_), .O(new_n356_));
  nand2  g198(.a(new_n356_), .b(new_n229_), .O(new_n357_));
  aoi21  g199(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n358_));
  oai21  g200(.a(new_n358_), .b(new_n228_), .c(new_n153_), .O(new_n359_));
  aoi21  g201(.a(new_n357_), .b(x79), .c(new_n359_), .O(z59));
  aoi22  g202(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n361_));
  aoi21  g203(.a(new_n361_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g204(.a(new_n169_), .O(new_n363_));
  nand2  g205(.a(new_n163_), .b(new_n161_), .O(new_n364_));
  nand2  g206(.a(new_n233_), .b(new_n364_), .O(new_n365_));
  nand3  g207(.a(x78), .b(x77), .c(new_n228_), .O(new_n366_));
  ...
  aoi21  g213(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n372_));
  nand3  g214(.a(x81), .b(x79), .c(new_n228_), .O(new_n373_));
