...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n334_, new_n339_, new_n340_, new_n342_, new_n343_, new_n345_,
    new_n346_, new_n347_, new_n348_, new_n350_, new_n351_, new_n353_,
    new_n354_, new_n355_, new_n356_, new_n357_, new_n358_, new_n359_,
    new_n361_, new_n362_, new_n363_, new_n364_, new_n365_, new_n367_,
    new_n369_, new_n370_, new_n371_, new_n374_, new_n376_;
  ...
  oai21  g180(.a(new_n315_), .b(x22), .c(new_n153_), .O(new_n340_));
  nor3   g181(.a(new_n340_), .b(new_n339_), .c(new_n312_), .O(z54));
  inv1   g182(.a(x82), .O(new_n342_));
  nand2  g183(.a(x84), .b(new_n342_), .O(new_n343_));
  nor4   g184(.a(new_n272_), .b(new_n252_), .c(new_n343_), .d(x80), .O(z55));
  inv1   g185(.a(new_n235_), .O(new_n345_));
  nor2   g186(.a(new_n345_), .b(new_n164_), .O(new_n346_));
  aoi21  g187(.a(new_n244_), .b(x76), .c(new_n346_), .O(new_n347_));
  aoi21  g188(.a(new_n154_), .b(new_n162_), .c(new_n239_), .O(new_n348_));
  oai21  g189(.a(new_n347_), .b(new_n170_), .c(new_n348_), .O(z56));
  inv1   g190(.a(x02), .O(new_n350_));
  nand3  g191(.a(new_n240_), .b(x03), .c(new_n350_), .O(new_n351_));
  inv1   g192(.a(new_n351_), .O(z57));
  aoi21  g193(.a(x42), .b(x40), .c(new_n232_), .O(new_n353_));
  nand3  g194(.a(new_n353_), .b(new_n230_), .c(x79), .O(new_n354_));
  nand4  g195(.a(new_n170_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n355_));
  nand2  g196(.a(new_n355_), .b(new_n354_), .O(new_n356_));
  nand2  g197(.a(new_n356_), .b(x77), .O(new_n357_));
  inv1   g198(.a(x04), .O(new_n358_));
  oai21  g199(.a(new_n161_), .b(new_n358_), .c(new_n170_), .O(new_n359_));
  aoi21  g200(.a(new_n359_), .b(new_n357_), .c(x01), .O(z58));
  inv1   g201(.a(new_n241_), .O(new_n361_));
  nand2  g202(.a(new_n170_), .b(new_n154_), .O(new_n362_));
  aoi21  g203(.a(new_n362_), .b(new_n232_), .c(new_n158_), .O(new_n363_));
  aoi21  g204(.a(new_n230_), .b(x79), .c(new_n232_), .O(new_n364_));
  oai21  g205(.a(new_n364_), .b(new_n363_), .c(x77), .O(new_n365_));
  aoi21  g206(.a(new_n365_), .b(new_n361_), .c(x01), .O(z59));
  aoi21  g207(.a(new_n346_), .b(x79), .c(new_n241_), .O(new_n367_));
  aoi21  g208(.a(new_n367_), .b(new_n234_), .c(x01), .O(z60));
  nand2  g209(.a(new_n235_), .b(new_n165_), .O(new_n369_));
  oai21  g210(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n370_));
  nand4  g211(.a(new_n370_), .b(new_n369_), .c(new_n171_), .d(x80), .O(new_n371_));
  inv1   g212(.a(new_n371_), .O(z61));
  nand4  g213(.a(new_n370_), .b(new_n369_), .c(new_n171_), .d(x82), .O(new_n374_));
  inv1   g214(.a(new_n374_), .O(z63));
  nand4  g215(.a(new_n370_), .b(new_n369_), .c(x83), .d(x79), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(new_n312_), .c(x01), .O(z64));
  zero   g217(.O(z07));
  zero   g218(.O(z40));
  zero   g219(.O(z41));
  zero   g220(.O(z43));
