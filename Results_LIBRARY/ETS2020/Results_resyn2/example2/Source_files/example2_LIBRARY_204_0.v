...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n239_, new_n241_, new_n243_, new_n246_, new_n249_, new_n250_,
  ...
  nand2  g141(.a(new_n289_), .b(x71), .O(new_n309_));
  inv1   g142(.a(x11), .O(new_n310_));
  nand2  g143(.a(new_n295_), .b(new_n310_), .O(new_n311_));
  inv1   g144(.a(x19), .O(new_n312_));
  nand2  g145(.a(x52), .b(new_n312_), .O(new_n313_));
  nand3  g146(.a(new_n313_), .b(new_n311_), .c(new_n293_), .O(new_n314_));
  aoi21  g147(.a(new_n314_), .b(new_n309_), .c(x01), .O(z51));
  ...
  nor4   g164(.a(new_n332_), .b(new_n210_), .c(x81), .d(x80), .O(new_n333_));
  and2   g165(.a(new_n333_), .b(new_n254_), .O(z55));
  oai21  g166(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n335_));
  aoi21  g167(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n336_));
  nand2  g168(.a(new_n336_), .b(new_n335_), .O(z56));
  inv1   g169(.a(x02), .O(new_n338_));
  nand3  g170(.a(new_n221_), .b(x03), .c(new_n338_), .O(new_n339_));
  inv1   g171(.a(new_n339_), .O(z57));
  oai21  g172(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n341_));
  nand2  g173(.a(x78), .b(x04), .O(new_n342_));
  aoi21  g174(.a(x42), .b(x40), .c(new_n342_), .O(new_n343_));
  nand3  g175(.a(new_n343_), .b(new_n212_), .c(x79), .O(new_n344_));
  nand4  g176(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n345_));
  ...
  nor2   g182(.a(new_n291_), .b(new_n217_), .O(new_n352_));
  oai21  g183(.a(new_n351_), .b(new_n161_), .c(new_n352_), .O(new_n353_));
  aoi21  g184(.a(new_n353_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g185(.a(new_n226_), .b(new_n222_), .O(new_n355_));
  oai21  g186(.a(new_n350_), .b(new_n216_), .c(new_n355_), .O(new_n356_));
  ...
  aoi21  g192(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n362_));
  nand3  g193(.a(x81), .b(x79), .c(new_n222_), .O(new_n363_));
  nand2  g194(.a(new_n363_), .b(x77), .O(new_n364_));
  nor2   g195(.a(new_n291_), .b(x77), .O(new_n365_));
