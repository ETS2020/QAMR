...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n330_, new_n331_, new_n332_, new_n337_, new_n338_, new_n339_,
  ...
  inv1   g073(.a(new_n220_), .O(new_n237_));
  nand2  g074(.a(x83), .b(x42), .O(new_n238_));
  xor2a  g075(.a(new_n238_), .b(new_n218_), .O(new_n239_));
  nand3  g076(.a(new_n239_), .b(new_n237_), .c(x52), .O(new_n240_));
  inv1   g077(.a(new_n240_), .O(z34));
  nand3  g078(.a(new_n239_), .b(new_n237_), .c(x53), .O(new_n242_));
  inv1   g079(.a(new_n242_), .O(z35));
  nand3  g080(.a(new_n239_), .b(new_n237_), .c(x58), .O(new_n248_));
  inv1   g081(.a(new_n248_), .O(z40));
  nand3  g082(.a(new_n239_), .b(new_n237_), .c(x59), .O(new_n250_));
  inv1   g083(.a(new_n250_), .O(z41));
  nand3  g084(.a(new_n239_), .b(new_n237_), .c(x61), .O(new_n253_));
  inv1   g085(.a(new_n253_), .O(z43));
  and2   g086(.a(x84), .b(x81), .O(new_n258_));
  nor2   g087(.a(x84), .b(x81), .O(new_n259_));
  nor2   g088(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g089(.a(new_n160_), .b(x79), .O(new_n261_));
  ...
  nand2  g094(.a(new_n265_), .b(new_n162_), .O(new_n266_));
  ...
  nand2  g110(.a(new_n262_), .b(x69), .O(new_n282_));
  inv1   g111(.a(x09), .O(new_n283_));
  nand2  g112(.a(new_n269_), .b(new_n283_), .O(new_n284_));
  inv1   g113(.a(x17), .O(new_n285_));
  nand2  g114(.a(x52), .b(new_n285_), .O(new_n286_));
  nand3  g115(.a(new_n286_), .b(new_n284_), .c(new_n267_), .O(new_n287_));
  aoi21  g116(.a(new_n287_), .b(new_n282_), .c(x01), .O(z49));
  nand2  g117(.a(new_n262_), .b(x71), .O(new_n290_));
  inv1   g118(.a(x11), .O(new_n291_));
  nand2  g119(.a(new_n269_), .b(new_n291_), .O(new_n292_));
  inv1   g120(.a(x19), .O(new_n293_));
  nand2  g121(.a(x52), .b(new_n293_), .O(new_n294_));
  nand3  g122(.a(new_n294_), .b(new_n292_), .c(new_n267_), .O(new_n295_));
  aoi21  g123(.a(new_n295_), .b(new_n290_), .c(x01), .O(z51));
  nand2  g124(.a(new_n262_), .b(x72), .O(new_n297_));
  inv1   g125(.a(x12), .O(new_n298_));
  nand2  g126(.a(new_n269_), .b(new_n298_), .O(new_n299_));
  inv1   g127(.a(x20), .O(new_n300_));
  nand2  g128(.a(x52), .b(new_n300_), .O(new_n301_));
  nand3  g129(.a(new_n301_), .b(new_n299_), .c(new_n267_), .O(new_n302_));
  aoi21  g130(.a(new_n302_), .b(new_n297_), .c(x01), .O(z52));
  nand2  g131(.a(new_n262_), .b(x73), .O(new_n304_));
  inv1   g132(.a(x13), .O(new_n305_));
  nand2  g133(.a(new_n269_), .b(new_n305_), .O(new_n306_));
  inv1   g134(.a(x21), .O(new_n307_));
  nand2  g135(.a(x52), .b(new_n307_), .O(new_n308_));
  nand3  g136(.a(new_n308_), .b(new_n306_), .c(new_n267_), .O(new_n309_));
  aoi21  g137(.a(new_n309_), .b(new_n304_), .c(x01), .O(z53));
  nor2   g138(.a(x52), .b(x14), .O(new_n311_));
  oai21  g139(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n312_));
  nor3   g140(.a(new_n312_), .b(new_n311_), .c(new_n266_), .O(z54));
  inv1   g141(.a(x79), .O(new_n315_));
  aoi22  g142(.a(new_n260_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n316_));
  nand2  g143(.a(new_n153_), .b(x00), .O(new_n317_));
  aoi21  g144(.a(new_n161_), .b(new_n159_), .c(new_n317_), .O(new_n318_));
  oai21  g145(.a(new_n316_), .b(new_n315_), .c(new_n318_), .O(z56));
  ...
  oai21  g150(.a(new_n324_), .b(new_n322_), .c(new_n216_), .O(new_n325_));
  nand2  g151(.a(x78), .b(x04), .O(new_n326_));
  aoi21  g152(.a(x42), .b(x40), .c(new_n326_), .O(new_n327_));
  nand3  g153(.a(new_n327_), .b(new_n325_), .c(x79), .O(new_n328_));
  nand4  g154(.a(new_n315_), .b(new_n161_), .c(new_n216_), .d(x40), .O(new_n329_));
  nand2  g155(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  nand2  g156(.a(new_n330_), .b(x77), .O(new_n331_));
  oai21  g157(.a(new_n162_), .b(new_n264_), .c(new_n315_), .O(new_n332_));
  aoi21  g158(.a(new_n332_), .b(new_n331_), .c(x01), .O(z58));
  nand3  g159(.a(new_n258_), .b(new_n160_), .c(x79), .O(new_n337_));
  aoi21  g160(.a(new_n325_), .b(x79), .c(new_n264_), .O(new_n338_));
  nand3  g161(.a(x81), .b(x79), .c(new_n264_), .O(new_n339_));
  nand2  g162(.a(new_n339_), .b(x77), .O(new_n340_));
  nand2  g163(.a(new_n258_), .b(x79), .O(new_n341_));
  nor2   g164(.a(new_n265_), .b(x77), .O(new_n342_));
  ...
  nand2  g168(.a(new_n219_), .b(new_n264_), .O(new_n347_));
  oai21  g169(.a(new_n260_), .b(new_n163_), .c(new_n347_), .O(new_n348_));
  nand3  g170(.a(new_n348_), .b(x83), .c(x79), .O(new_n349_));
  aoi21  g171(.a(new_n349_), .b(new_n266_), .c(x01), .O(z64));
