...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n178_, new_n180_, new_n181_, new_n185_, new_n186_, new_n190_,
  ...
  oai21  g055(.a(new_n214_), .b(new_n156_), .c(x79), .O(new_n215_));
  nand3  g056(.a(new_n215_), .b(x78), .c(x04), .O(new_n216_));
  inv1   g057(.a(x41), .O(new_n217_));
  xnor2a g058(.a(x84), .b(x81), .O(new_n218_));
  nand4  g059(.a(new_n218_), .b(new_n160_), .c(x79), .d(new_n217_), .O(new_n219_));
  aoi21  g060(.a(new_n219_), .b(new_n216_), .c(x01), .O(z22));
  nand2  g061(.a(new_n164_), .b(x00), .O(new_n221_));
  inv1   g062(.a(new_n221_), .O(new_n222_));
  inv1   g063(.a(x04), .O(new_n223_));
  nand3  g064(.a(new_n161_), .b(x05), .c(new_n223_), .O(new_n224_));
  nand2  g065(.a(new_n224_), .b(new_n222_), .O(z23));
  inv1   g066(.a(x05), .O(new_n226_));
  nor2   g067(.a(new_n158_), .b(new_n156_), .O(new_n227_));
  nor2   g068(.a(new_n227_), .b(new_n161_), .O(new_n228_));
  nand2  g069(.a(new_n223_), .b(new_n164_), .O(new_n229_));
  ...
  nor2   g121(.a(new_n288_), .b(new_n159_), .O(new_n289_));
  nand2  g122(.a(new_n289_), .b(x68), .O(new_n290_));
  inv1   g123(.a(new_n157_), .O(new_n291_));
  nor2   g124(.a(x79), .b(new_n223_), .O(new_n292_));
  ...
  aoi21  g133(.a(new_n300_), .b(new_n290_), .c(x01), .O(z48));
  nand2  g134(.a(new_n289_), .b(x69), .O(new_n302_));
  ...
  nand2  g141(.a(new_n289_), .b(x71), .O(new_n310_));
  inv1   g142(.a(x11), .O(new_n311_));
  nand2  g143(.a(new_n296_), .b(new_n311_), .O(new_n312_));
  inv1   g144(.a(x19), .O(new_n313_));
  nand2  g145(.a(x52), .b(new_n313_), .O(new_n314_));
  nand3  g146(.a(new_n314_), .b(new_n312_), .c(new_n294_), .O(new_n315_));
  aoi21  g147(.a(new_n315_), .b(new_n310_), .c(x01), .O(z51));
  nand2  g148(.a(new_n289_), .b(x72), .O(new_n317_));
  inv1   g149(.a(x12), .O(new_n318_));
  nand2  g150(.a(new_n296_), .b(new_n318_), .O(new_n319_));
  inv1   g151(.a(x20), .O(new_n320_));
  nand2  g152(.a(x52), .b(new_n320_), .O(new_n321_));
  nand3  g153(.a(new_n321_), .b(new_n319_), .c(new_n294_), .O(new_n322_));
  aoi21  g154(.a(new_n322_), .b(new_n317_), .c(x01), .O(z52));
  nand2  g155(.a(new_n289_), .b(x73), .O(new_n324_));
  inv1   g156(.a(x13), .O(new_n325_));
  nand2  g157(.a(new_n296_), .b(new_n325_), .O(new_n326_));
  inv1   g158(.a(x21), .O(new_n327_));
  nand2  g159(.a(x52), .b(new_n327_), .O(new_n328_));
  nand3  g160(.a(new_n328_), .b(new_n326_), .c(new_n294_), .O(new_n329_));
  aoi21  g161(.a(new_n329_), .b(new_n324_), .c(x01), .O(z53));
  inv1   g162(.a(x80), .O(new_n332_));
  inv1   g163(.a(x82), .O(new_n333_));
  nor2   g164(.a(new_n212_), .b(x81), .O(new_n334_));
  nand4  g165(.a(new_n334_), .b(x84), .c(new_n333_), .d(new_n332_), .O(new_n335_));
  nor3   g166(.a(new_n335_), .b(new_n236_), .c(new_n229_), .O(z55));
  inv1   g167(.a(new_n228_), .O(new_n337_));
  inv1   g168(.a(x76), .O(new_n338_));
  and2   g169(.a(new_n218_), .b(new_n338_), .O(new_n339_));
  aoi21  g170(.a(new_n158_), .b(new_n156_), .c(new_n221_), .O(new_n340_));
  oai21  g171(.a(new_n339_), .b(new_n337_), .c(new_n340_), .O(z56));
  inv1   g172(.a(x02), .O(new_n342_));
  nand3  g173(.a(new_n222_), .b(x03), .c(new_n342_), .O(new_n343_));
  inv1   g174(.a(new_n343_), .O(z57));
  oai21  g175(.a(new_n291_), .b(new_n223_), .c(new_n161_), .O(new_n345_));
  nand2  g176(.a(x78), .b(x04), .O(new_n346_));
  aoi21  g177(.a(x42), .b(x40), .c(new_n346_), .O(new_n347_));
  nand3  g178(.a(new_n347_), .b(new_n214_), .c(x79), .O(new_n348_));
  nand4  g179(.a(new_n161_), .b(new_n158_), .c(new_n209_), .d(x40), .O(new_n349_));
  ...
  nand2  g183(.a(new_n159_), .b(new_n157_), .O(new_n354_));
  aoi21  g184(.a(new_n218_), .b(x79), .c(new_n292_), .O(new_n355_));
  oai21  g185(.a(new_n354_), .b(new_n161_), .c(new_n355_), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n216_), .c(x01), .O(z60));
  inv1   g187(.a(new_n162_), .O(new_n358_));
  nand2  g188(.a(new_n227_), .b(new_n223_), .O(new_n359_));
  nand2  g189(.a(new_n354_), .b(new_n218_), .O(new_n360_));
  nand2  g190(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  inv1   g191(.a(new_n361_), .O(new_n362_));
  nor3   g192(.a(new_n362_), .b(new_n358_), .c(new_n332_), .O(z61));
  nand3  g193(.a(x84), .b(x81), .c(x79), .O(new_n364_));
  or2    g194(.a(new_n364_), .b(new_n159_), .O(new_n365_));
  ...
  nor2   g198(.a(new_n292_), .b(x77), .O(new_n369_));
  aoi21  g199(.a(new_n369_), .b(new_n364_), .c(new_n158_), .O(new_n370_));
  oai21  g200(.a(new_n368_), .b(new_n366_), .c(new_n370_), .O(new_n371_));
  aoi21  g201(.a(new_n371_), .b(new_n365_), .c(x01), .O(z62));
  nor3   g202(.a(new_n362_), .b(new_n358_), .c(new_n333_), .O(z63));
  nand3  g203(.a(new_n361_), .b(x83), .c(x79), .O(new_n374_));
  aoi21  g204(.a(new_n374_), .b(new_n293_), .c(x01), .O(z64));
  nand2  g205(.a(new_n354_), .b(x81), .O(new_n376_));
