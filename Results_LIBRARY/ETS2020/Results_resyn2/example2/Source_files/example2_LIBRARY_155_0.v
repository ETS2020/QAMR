...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n178_, new_n181_, new_n182_, new_n186_, new_n187_, new_n190_,
    ...
    new_n239_, new_n241_, new_n245_, new_n247_, new_n249_, new_n250_,
  ...
  and2   g122(.a(new_n217_), .b(new_n158_), .O(new_n289_));
  nand2  g123(.a(new_n289_), .b(x68), .O(new_n290_));
  nor2   g124(.a(x79), .b(new_n222_), .O(new_n291_));
  nand2  g125(.a(new_n291_), .b(new_n155_), .O(new_n292_));
  inv1   g126(.a(new_n292_), .O(new_n293_));
  inv1   g127(.a(x08), .O(new_n294_));
  inv1   g128(.a(x52), .O(new_n295_));
  nand2  g129(.a(new_n295_), .b(new_n294_), .O(new_n296_));
  inv1   g130(.a(x16), .O(new_n297_));
  nand2  g131(.a(x52), .b(new_n297_), .O(new_n298_));
  nand3  g132(.a(new_n298_), .b(new_n296_), .c(new_n293_), .O(new_n299_));
  aoi21  g133(.a(new_n299_), .b(new_n290_), .c(x01), .O(z48));
  nand2  g134(.a(new_n289_), .b(x69), .O(new_n301_));
  inv1   g135(.a(x09), .O(new_n302_));
  nand2  g136(.a(new_n295_), .b(new_n302_), .O(new_n303_));
  inv1   g137(.a(x17), .O(new_n304_));
  nand2  g138(.a(x52), .b(new_n304_), .O(new_n305_));
  nand3  g139(.a(new_n305_), .b(new_n303_), .c(new_n293_), .O(new_n306_));
  aoi21  g140(.a(new_n306_), .b(new_n301_), .c(x01), .O(z49));
  nand2  g141(.a(new_n289_), .b(x70), .O(new_n308_));
  inv1   g142(.a(x10), .O(new_n309_));
  nand2  g143(.a(new_n295_), .b(new_n309_), .O(new_n310_));
  inv1   g144(.a(x18), .O(new_n311_));
  nand2  g145(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g146(.a(new_n312_), .b(new_n310_), .c(new_n293_), .O(new_n313_));
  aoi21  g147(.a(new_n313_), .b(new_n308_), .c(x01), .O(z50));
  nand2  g148(.a(new_n289_), .b(x72), .O(new_n316_));
  inv1   g149(.a(x12), .O(new_n317_));
  nand2  g150(.a(new_n295_), .b(new_n317_), .O(new_n318_));
  inv1   g151(.a(x20), .O(new_n319_));
  nand2  g152(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g153(.a(new_n320_), .b(new_n318_), .c(new_n293_), .O(new_n321_));
  aoi21  g154(.a(new_n321_), .b(new_n316_), .c(x01), .O(z52));
  nand2  g155(.a(new_n289_), .b(x73), .O(new_n323_));
  inv1   g156(.a(x13), .O(new_n324_));
  nand2  g157(.a(new_n295_), .b(new_n324_), .O(new_n325_));
  inv1   g158(.a(x21), .O(new_n326_));
  nand2  g159(.a(x52), .b(new_n326_), .O(new_n327_));
  nand3  g160(.a(new_n327_), .b(new_n325_), .c(new_n293_), .O(new_n328_));
  aoi21  g161(.a(new_n328_), .b(new_n323_), .c(x01), .O(z53));
  nor2   g162(.a(x52), .b(x14), .O(new_n330_));
  oai21  g163(.a(new_n295_), .b(x22), .c(new_n164_), .O(new_n331_));
  nor3   g164(.a(new_n331_), .b(new_n330_), .c(new_n292_), .O(z54));
  inv1   g165(.a(x82), .O(new_n333_));
  nand2  g166(.a(x84), .b(new_n333_), .O(new_n334_));
  nor4   g167(.a(new_n334_), .b(new_n210_), .c(x81), .d(x80), .O(new_n335_));
  and2   g168(.a(new_n335_), .b(new_n254_), .O(z55));
  oai21  g169(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n337_));
  aoi21  g170(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n338_));
  nand2  g171(.a(new_n338_), .b(new_n337_), .O(z56));
  inv1   g172(.a(x02), .O(new_n340_));
  nand3  g173(.a(new_n221_), .b(x03), .c(new_n340_), .O(new_n341_));
  inv1   g174(.a(new_n341_), .O(z57));
  oai21  g175(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n343_));
  nand2  g176(.a(x78), .b(x04), .O(new_n344_));
  aoi21  g177(.a(x42), .b(x40), .c(new_n344_), .O(new_n345_));
  nand3  g178(.a(new_n345_), .b(new_n212_), .c(x79), .O(new_n346_));
  nand4  g179(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n347_));
  ...
  nor2   g185(.a(new_n291_), .b(new_n217_), .O(new_n354_));
  oai21  g186(.a(new_n353_), .b(new_n161_), .c(new_n354_), .O(new_n355_));
  aoi21  g187(.a(new_n355_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g188(.a(new_n226_), .b(new_n222_), .O(new_n357_));
  oai21  g189(.a(new_n352_), .b(new_n216_), .c(new_n357_), .O(new_n358_));
  ...
  aoi21  g195(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n364_));
  nand3  g196(.a(x81), .b(x79), .c(new_n222_), .O(new_n365_));
  nand2  g197(.a(new_n365_), .b(x77), .O(new_n366_));
  nor2   g198(.a(new_n291_), .b(x77), .O(new_n367_));
