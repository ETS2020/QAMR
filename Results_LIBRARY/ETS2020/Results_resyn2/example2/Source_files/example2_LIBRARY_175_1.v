// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:29 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n179_, new_n180_, new_n184_, new_n185_, new_n187_, new_n188_,
  ...
  nand2  g128(.a(new_n264_), .b(x72), .O(new_n299_));
  inv1   g129(.a(x12), .O(new_n300_));
  nand2  g130(.a(new_n271_), .b(new_n300_), .O(new_n301_));
  inv1   g131(.a(x20), .O(new_n302_));
  nand2  g132(.a(x52), .b(new_n302_), .O(new_n303_));
  nand3  g133(.a(new_n303_), .b(new_n301_), .c(new_n269_), .O(new_n304_));
  aoi21  g134(.a(new_n304_), .b(new_n299_), .c(x01), .O(z52));
  nand2  g135(.a(new_n264_), .b(x73), .O(new_n306_));
  inv1   g136(.a(x13), .O(new_n307_));
  nand2  g137(.a(new_n271_), .b(new_n307_), .O(new_n308_));
  inv1   g138(.a(x21), .O(new_n309_));
  nand2  g139(.a(x52), .b(new_n309_), .O(new_n310_));
  nand3  g140(.a(new_n310_), .b(new_n308_), .c(new_n269_), .O(new_n311_));
  aoi21  g141(.a(new_n311_), .b(new_n306_), .c(x01), .O(z53));
  nor2   g142(.a(x52), .b(x14), .O(new_n313_));
  oai21  g143(.a(new_n271_), .b(x22), .c(new_n153_), .O(new_n314_));
  nor3   g144(.a(new_n314_), .b(new_n313_), .c(new_n268_), .O(z54));
  inv1   g145(.a(x79), .O(new_n317_));
  aoi22  g146(.a(new_n262_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n318_));
  nand2  g147(.a(new_n153_), .b(x00), .O(new_n319_));
  aoi21  g148(.a(new_n161_), .b(new_n159_), .c(new_n319_), .O(new_n320_));
  oai21  g149(.a(new_n318_), .b(new_n317_), .c(new_n320_), .O(z56));
  oai21  g150(.a(new_n162_), .b(new_n266_), .c(new_n317_), .O(new_n323_));
  inv1   g151(.a(x83), .O(new_n324_));
  nand3  g152(.a(new_n324_), .b(x82), .c(x80), .O(new_n325_));
  inv1   g153(.a(x74), .O(new_n326_));
  nand4  g154(.a(x84), .b(x81), .c(new_n326_), .d(x43), .O(new_n327_));
  oai21  g155(.a(new_n327_), .b(new_n325_), .c(new_n216_), .O(new_n328_));
  nor2   g156(.a(new_n161_), .b(new_n266_), .O(new_n329_));
  nand3  g157(.a(new_n329_), .b(new_n328_), .c(x79), .O(new_n330_));
  nand3  g158(.a(new_n317_), .b(new_n161_), .c(x40), .O(new_n331_));
  nand2  g159(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  aoi21  g160(.a(x42), .b(x40), .c(new_n159_), .O(new_n333_));
  nand2  g161(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  aoi21  g162(.a(new_n334_), .b(new_n323_), .c(x01), .O(z58));
  nand2  g163(.a(new_n328_), .b(new_n156_), .O(new_n336_));
  nand2  g164(.a(new_n336_), .b(new_n329_), .O(new_n337_));
  aoi21  g165(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n338_));
  oai21  g166(.a(new_n338_), .b(new_n266_), .c(new_n153_), .O(new_n339_));
  aoi21  g167(.a(new_n337_), .b(x79), .c(new_n339_), .O(z59));
  nand3  g168(.a(new_n260_), .b(new_n160_), .c(x79), .O(new_n343_));
  aoi21  g169(.a(new_n328_), .b(x79), .c(new_n266_), .O(new_n344_));
  nand3  g170(.a(x81), .b(x79), .c(new_n266_), .O(new_n345_));
  nand2  g171(.a(new_n345_), .b(x77), .O(new_n346_));
  nand2  g172(.a(new_n260_), .b(x79), .O(new_n347_));
  nor2   g173(.a(new_n267_), .b(x77), .O(new_n348_));
  aoi21  g174(.a(new_n348_), .b(new_n347_), .c(new_n161_), .O(new_n349_));
  oai21  g175(.a(new_n346_), .b(new_n344_), .c(new_n349_), .O(new_n350_));
  aoi21  g176(.a(new_n350_), .b(new_n343_), .c(x01), .O(z62));
  nand2  g177(.a(new_n219_), .b(new_n266_), .O(new_n353_));
  oai21  g178(.a(new_n262_), .b(new_n163_), .c(new_n353_), .O(new_n354_));
  nand3  g179(.a(new_n354_), .b(x83), .c(x79), .O(new_n355_));
  aoi21  g180(.a(new_n355_), .b(new_n268_), .c(x01), .O(z64));
  nand2  g181(.a(new_n164_), .b(x81), .O(new_n357_));
  nand3  g182(.a(x84), .b(x79), .c(new_n153_), .O(new_n358_));
  aoi21  g183(.a(new_n357_), .b(new_n353_), .c(new_n358_), .O(z65));
  zero   g184(.O(z02));
  zero   g185(.O(z03));
  zero   g186(.O(z08));
  zero   g187(.O(z10));
