...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n182_, new_n188_, new_n189_, new_n191_, new_n192_, new_n194_,
    new_n195_, new_n197_, new_n198_, new_n200_, new_n201_, new_n203_,
    new_n204_, new_n205_, new_n206_, new_n207_, new_n208_, new_n209_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n216_,
    new_n217_, new_n218_, new_n219_, new_n221_, new_n222_, new_n223_,
    new_n224_, new_n228_, new_n229_, new_n230_, new_n231_, new_n232_,
    new_n233_, new_n234_, new_n236_, new_n240_, new_n242_, new_n244_,
  ...
  nand3  g073(.a(new_n233_), .b(new_n228_), .c(x49), .O(new_n240_));
  inv1   g074(.a(new_n240_), .O(z31));
  nand3  g075(.a(new_n233_), .b(new_n228_), .c(x50), .O(new_n242_));
  ...
  nand3  g080(.a(new_n229_), .b(x51), .c(new_n203_), .O(new_n247_));
  nand3  g081(.a(new_n247_), .b(new_n246_), .c(new_n230_), .O(new_n248_));
  nor2   g082(.a(new_n232_), .b(new_n224_), .O(new_n249_));
  ...
  inv1   g089(.a(new_n231_), .O(new_n258_));
  nand3  g090(.a(new_n258_), .b(x83), .c(x42), .O(new_n259_));
  oai21  g091(.a(new_n206_), .b(new_n203_), .c(new_n231_), .O(new_n260_));
