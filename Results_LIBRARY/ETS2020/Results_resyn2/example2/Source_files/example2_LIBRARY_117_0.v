...
module FAU ( 
  ...
  inv1   g028(.a(x58), .O(new_n185_));
  nor2   g029(.a(x40), .b(x30), .O(new_n186_));
  aoi21  g030(.a(new_n185_), .b(x40), .c(new_n186_), .O(z12));
  ...
  nand2  g142(.a(new_n290_), .b(x72), .O(new_n311_));
  inv1   g143(.a(x12), .O(new_n312_));
  nand2  g144(.a(new_n296_), .b(new_n312_), .O(new_n313_));
  inv1   g145(.a(x20), .O(new_n314_));
  nand2  g146(.a(x52), .b(new_n314_), .O(new_n315_));
  nand3  g147(.a(new_n315_), .b(new_n313_), .c(new_n294_), .O(new_n316_));
  aoi21  g148(.a(new_n316_), .b(new_n311_), .c(x01), .O(z52));
  nand2  g149(.a(new_n290_), .b(x73), .O(new_n318_));
  inv1   g150(.a(x13), .O(new_n319_));
  nand2  g151(.a(new_n296_), .b(new_n319_), .O(new_n320_));
  inv1   g152(.a(x21), .O(new_n321_));
  nand2  g153(.a(x52), .b(new_n321_), .O(new_n322_));
  nand3  g154(.a(new_n322_), .b(new_n320_), .c(new_n294_), .O(new_n323_));
  aoi21  g155(.a(new_n323_), .b(new_n318_), .c(x01), .O(z53));
  inv1   g156(.a(x82), .O(new_n326_));
  nand2  g157(.a(x84), .b(new_n326_), .O(new_n327_));
  nor4   g158(.a(new_n327_), .b(new_n212_), .c(x81), .d(x80), .O(new_n328_));
  and2   g159(.a(new_n328_), .b(new_n255_), .O(z55));
  oai21  g160(.a(new_n218_), .b(x76), .c(new_n229_), .O(new_n330_));
  aoi21  g161(.a(new_n154_), .b(new_n157_), .c(new_n222_), .O(new_n331_));
  nand2  g162(.a(new_n331_), .b(new_n330_), .O(z56));
  inv1   g163(.a(x02), .O(new_n333_));
  nand3  g164(.a(new_n223_), .b(x03), .c(new_n333_), .O(new_n334_));
  inv1   g165(.a(new_n334_), .O(z57));
  oai21  g166(.a(new_n155_), .b(new_n224_), .c(new_n161_), .O(new_n336_));
  nand2  g167(.a(x78), .b(x04), .O(new_n337_));
  aoi21  g168(.a(x42), .b(x40), .c(new_n337_), .O(new_n338_));
  nand3  g169(.a(new_n338_), .b(new_n214_), .c(x79), .O(new_n339_));
  nand4  g170(.a(new_n161_), .b(new_n154_), .c(new_n209_), .d(x40), .O(new_n340_));
  ...
  nor2   g176(.a(new_n292_), .b(new_n219_), .O(new_n347_));
  oai21  g177(.a(new_n346_), .b(new_n161_), .c(new_n347_), .O(new_n348_));
  aoi21  g178(.a(new_n348_), .b(new_n216_), .c(x01), .O(z60));
  nand2  g179(.a(new_n228_), .b(new_n224_), .O(new_n350_));
  oai21  g180(.a(new_n345_), .b(new_n218_), .c(new_n350_), .O(new_n351_));
  ...
  aoi21  g186(.a(new_n214_), .b(x79), .c(new_n224_), .O(new_n357_));
  nand3  g187(.a(x81), .b(x79), .c(new_n224_), .O(new_n358_));
  nand2  g188(.a(new_n358_), .b(x77), .O(new_n359_));
  nor2   g189(.a(new_n292_), .b(x77), .O(new_n360_));
