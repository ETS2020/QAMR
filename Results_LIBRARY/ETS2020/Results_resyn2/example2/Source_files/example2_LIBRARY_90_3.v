...
module FAU ( 
  ...
  nand2  g160(.a(new_n307_), .b(x70), .O(new_n320_));
  inv1   g161(.a(x10), .O(new_n321_));
  nand2  g162(.a(new_n312_), .b(new_n321_), .O(new_n322_));
  inv1   g163(.a(x18), .O(new_n323_));
  nand2  g164(.a(x52), .b(new_n323_), .O(new_n324_));
  nand3  g165(.a(new_n324_), .b(new_n322_), .c(new_n310_), .O(new_n325_));
  aoi21  g166(.a(new_n325_), .b(new_n320_), .c(x01), .O(z50));
  nand2  g167(.a(new_n307_), .b(x71), .O(new_n327_));
  inv1   g168(.a(x11), .O(new_n328_));
  nand2  g169(.a(new_n312_), .b(new_n328_), .O(new_n329_));
  inv1   g170(.a(x19), .O(new_n330_));
  nand2  g171(.a(x52), .b(new_n330_), .O(new_n331_));
  nand3  g172(.a(new_n331_), .b(new_n329_), .c(new_n310_), .O(new_n332_));
  aoi21  g173(.a(new_n332_), .b(new_n327_), .c(x01), .O(z51));
