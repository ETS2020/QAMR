...
module FAU ( 
  ...
  nand2  g122(.a(new_n260_), .b(x72), .O(new_n295_));
  inv1   g123(.a(x12), .O(new_n296_));
  nand2  g124(.a(new_n267_), .b(new_n296_), .O(new_n297_));
  inv1   g125(.a(x20), .O(new_n298_));
  nand2  g126(.a(x52), .b(new_n298_), .O(new_n299_));
  nand3  g127(.a(new_n299_), .b(new_n297_), .c(new_n265_), .O(new_n300_));
  aoi21  g128(.a(new_n300_), .b(new_n295_), .c(x01), .O(z52));
  nand2  g129(.a(new_n260_), .b(x73), .O(new_n302_));
  inv1   g130(.a(x13), .O(new_n303_));
  nand2  g131(.a(new_n267_), .b(new_n303_), .O(new_n304_));
  inv1   g132(.a(x21), .O(new_n305_));
  nand2  g133(.a(x52), .b(new_n305_), .O(new_n306_));
  nand3  g134(.a(new_n306_), .b(new_n304_), .c(new_n265_), .O(new_n307_));
  aoi21  g135(.a(new_n307_), .b(new_n302_), .c(x01), .O(z53));
  nor2   g136(.a(x52), .b(x14), .O(new_n309_));
  oai21  g137(.a(new_n267_), .b(x22), .c(new_n153_), .O(new_n310_));
  nor3   g138(.a(new_n310_), .b(new_n309_), .c(new_n264_), .O(z54));
  inv1   g139(.a(x79), .O(new_n313_));
  aoi22  g140(.a(new_n258_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n314_));
  nand2  g141(.a(new_n153_), .b(x00), .O(new_n315_));
  aoi21  g142(.a(new_n161_), .b(new_n159_), .c(new_n315_), .O(new_n316_));
  oai21  g143(.a(new_n314_), .b(new_n313_), .c(new_n316_), .O(z56));
  oai21  g144(.a(new_n162_), .b(new_n262_), .c(new_n313_), .O(new_n319_));
  inv1   g145(.a(x83), .O(new_n320_));
  nand3  g146(.a(new_n320_), .b(x82), .c(x80), .O(new_n321_));
  inv1   g147(.a(x74), .O(new_n322_));
  nand4  g148(.a(x84), .b(x81), .c(new_n322_), .d(x43), .O(new_n323_));
  oai21  g149(.a(new_n323_), .b(new_n321_), .c(new_n212_), .O(new_n324_));
  nor2   g150(.a(new_n161_), .b(new_n262_), .O(new_n325_));
  nand3  g151(.a(new_n325_), .b(new_n324_), .c(x79), .O(new_n326_));
  nand3  g152(.a(new_n313_), .b(new_n161_), .c(x40), .O(new_n327_));
  ...
  aoi21  g156(.a(new_n330_), .b(new_n319_), .c(x01), .O(z58));
  ...
  oai21  g160(.a(new_n334_), .b(new_n262_), .c(new_n153_), .O(new_n335_));
  aoi21  g161(.a(new_n333_), .b(x79), .c(new_n335_), .O(z59));
  nand3  g162(.a(new_n256_), .b(new_n160_), .c(x79), .O(new_n339_));
  aoi21  g163(.a(new_n324_), .b(x79), .c(new_n262_), .O(new_n340_));
  nand3  g164(.a(x81), .b(x79), .c(new_n262_), .O(new_n341_));
  nand2  g165(.a(new_n341_), .b(x77), .O(new_n342_));
  nand2  g166(.a(new_n256_), .b(x79), .O(new_n343_));
  nor2   g167(.a(new_n263_), .b(x77), .O(new_n344_));
  ...
  nand2  g171(.a(new_n215_), .b(new_n262_), .O(new_n349_));
  oai21  g172(.a(new_n258_), .b(new_n163_), .c(new_n349_), .O(new_n350_));
  nand3  g173(.a(new_n350_), .b(x83), .c(x79), .O(new_n351_));
  aoi21  g174(.a(new_n351_), .b(new_n264_), .c(x01), .O(z64));
