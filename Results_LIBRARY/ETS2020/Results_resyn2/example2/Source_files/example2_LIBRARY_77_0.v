...
module FAU ( 
  ...
  nand4  g101(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x58), .O(new_n270_));
  inv1   g102(.a(new_n270_), .O(z40));
  nand4  g103(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x59), .O(new_n272_));
  inv1   g104(.a(new_n272_), .O(z41));
  nand4  g105(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x60), .O(new_n274_));
  inv1   g106(.a(new_n274_), .O(z42));
  nand4  g107(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x61), .O(new_n276_));
  inv1   g108(.a(new_n276_), .O(z43));
  nand4  g109(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x62), .O(new_n278_));
  inv1   g110(.a(new_n278_), .O(z44));
  nand4  g111(.a(new_n262_), .b(new_n261_), .c(new_n251_), .d(x63), .O(new_n280_));
