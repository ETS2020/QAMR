...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n179_, new_n186_, new_n187_, new_n190_, new_n191_, new_n193_,
  ...
  nor4   g166(.a(new_n335_), .b(new_n208_), .c(x81), .d(x80), .O(new_n336_));
  and2   g167(.a(new_n336_), .b(new_n251_), .O(z55));
  oai21  g168(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n338_));
  aoi21  g169(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n339_));
  nand2  g170(.a(new_n339_), .b(new_n338_), .O(z56));
  inv1   g171(.a(x02), .O(new_n341_));
  nand3  g172(.a(new_n219_), .b(x03), .c(new_n341_), .O(new_n342_));
  inv1   g173(.a(new_n342_), .O(z57));
  oai21  g174(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n344_));
  nand2  g175(.a(x78), .b(x04), .O(new_n345_));
  aoi21  g176(.a(x42), .b(x40), .c(new_n345_), .O(new_n346_));
  nand3  g177(.a(new_n346_), .b(new_n210_), .c(x79), .O(new_n347_));
  nand4  g178(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n348_));
  nand2  g179(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  nand2  g180(.a(new_n349_), .b(x77), .O(new_n350_));
  aoi21  g181(.a(new_n350_), .b(new_n344_), .c(x01), .O(z58));
  nor2   g182(.a(new_n158_), .b(new_n155_), .O(new_n353_));
  inv1   g183(.a(new_n353_), .O(new_n354_));
  nor2   g184(.a(new_n288_), .b(new_n215_), .O(new_n355_));
  oai21  g185(.a(new_n354_), .b(new_n161_), .c(new_n355_), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g187(.a(new_n224_), .b(new_n220_), .O(new_n358_));
  oai21  g188(.a(new_n353_), .b(new_n214_), .c(new_n358_), .O(new_n359_));
  nand3  g189(.a(new_n359_), .b(new_n162_), .c(x80), .O(new_n360_));
  inv1   g190(.a(new_n360_), .O(z61));
  nand3  g191(.a(x84), .b(x81), .c(x79), .O(new_n362_));
  inv1   g192(.a(new_n362_), .O(new_n363_));
  nand2  g193(.a(new_n363_), .b(new_n158_), .O(new_n364_));
  aoi21  g194(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n365_));
  nand3  g195(.a(x81), .b(x79), .c(new_n220_), .O(new_n366_));
  nand2  g196(.a(new_n366_), .b(x77), .O(new_n367_));
  nor2   g197(.a(new_n288_), .b(x77), .O(new_n368_));
  aoi21  g198(.a(new_n368_), .b(new_n362_), .c(new_n154_), .O(new_n369_));
  oai21  g199(.a(new_n367_), .b(new_n365_), .c(new_n369_), .O(new_n370_));
  aoi21  g200(.a(new_n370_), .b(new_n364_), .c(x01), .O(z62));
  nand3  g201(.a(new_n359_), .b(new_n162_), .c(x82), .O(new_n372_));
  inv1   g202(.a(new_n372_), .O(z63));
  nand2  g203(.a(new_n354_), .b(x81), .O(new_n375_));
  nand2  g204(.a(new_n162_), .b(x84), .O(new_n376_));
  aoi21  g205(.a(new_n375_), .b(new_n358_), .c(new_n376_), .O(z65));
  zero   g206(.O(z00));
  zero   g207(.O(z01));
  zero   g208(.O(z04));
  zero   g209(.O(z06));
