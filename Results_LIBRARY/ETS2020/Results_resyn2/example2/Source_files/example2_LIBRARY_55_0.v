...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n179_, new_n181_, new_n182_, new_n184_, new_n185_, new_n192_,
  ...
  nor4   g169(.a(new_n337_), .b(new_n210_), .c(x81), .d(x80), .O(new_n338_));
  and2   g170(.a(new_n338_), .b(new_n253_), .O(z55));
  oai21  g171(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n340_));
  aoi21  g172(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n341_));
  nand2  g173(.a(new_n341_), .b(new_n340_), .O(z56));
  inv1   g174(.a(x02), .O(new_n343_));
  nand3  g175(.a(new_n221_), .b(x03), .c(new_n343_), .O(new_n344_));
  inv1   g176(.a(new_n344_), .O(z57));
  oai21  g177(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n346_));
  nand2  g178(.a(x78), .b(x04), .O(new_n347_));
  aoi21  g179(.a(x42), .b(x40), .c(new_n347_), .O(new_n348_));
  nand3  g180(.a(new_n348_), .b(new_n212_), .c(x79), .O(new_n349_));
  nand4  g181(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n350_));
  ...
  nor2   g187(.a(new_n290_), .b(new_n217_), .O(new_n357_));
  oai21  g188(.a(new_n356_), .b(new_n161_), .c(new_n357_), .O(new_n358_));
  aoi21  g189(.a(new_n358_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g190(.a(new_n226_), .b(new_n222_), .O(new_n360_));
  oai21  g191(.a(new_n355_), .b(new_n216_), .c(new_n360_), .O(new_n361_));
  ...
  aoi21  g197(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n367_));
  nand3  g198(.a(x81), .b(x79), .c(new_n222_), .O(new_n368_));
  nand2  g199(.a(new_n368_), .b(x77), .O(new_n369_));
  nor2   g200(.a(new_n290_), .b(x77), .O(new_n370_));
