...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n228_, new_n230_, new_n232_, new_n237_, new_n238_, new_n239_,
  ...
  nand2  g109(.a(new_n262_), .b(x69), .O(new_n282_));
  inv1   g110(.a(x09), .O(new_n283_));
  nand2  g111(.a(new_n269_), .b(new_n283_), .O(new_n284_));
  inv1   g112(.a(x17), .O(new_n285_));
  nand2  g113(.a(x52), .b(new_n285_), .O(new_n286_));
  nand3  g114(.a(new_n286_), .b(new_n284_), .c(new_n267_), .O(new_n287_));
  aoi21  g115(.a(new_n287_), .b(new_n282_), .c(x01), .O(z49));
  nand2  g116(.a(new_n262_), .b(x71), .O(new_n290_));
  inv1   g117(.a(x11), .O(new_n291_));
  nand2  g118(.a(new_n269_), .b(new_n291_), .O(new_n292_));
  inv1   g119(.a(x19), .O(new_n293_));
  nand2  g120(.a(x52), .b(new_n293_), .O(new_n294_));
  nand3  g121(.a(new_n294_), .b(new_n292_), .c(new_n267_), .O(new_n295_));
  aoi21  g122(.a(new_n295_), .b(new_n290_), .c(x01), .O(z51));
  nand2  g123(.a(new_n262_), .b(x72), .O(new_n297_));
  inv1   g124(.a(x12), .O(new_n298_));
  nand2  g125(.a(new_n269_), .b(new_n298_), .O(new_n299_));
  inv1   g126(.a(x20), .O(new_n300_));
  nand2  g127(.a(x52), .b(new_n300_), .O(new_n301_));
  nand3  g128(.a(new_n301_), .b(new_n299_), .c(new_n267_), .O(new_n302_));
  aoi21  g129(.a(new_n302_), .b(new_n297_), .c(x01), .O(z52));
  nand2  g130(.a(new_n262_), .b(x73), .O(new_n304_));
  inv1   g131(.a(x13), .O(new_n305_));
  nand2  g132(.a(new_n269_), .b(new_n305_), .O(new_n306_));
  inv1   g133(.a(x21), .O(new_n307_));
  nand2  g134(.a(x52), .b(new_n307_), .O(new_n308_));
  nand3  g135(.a(new_n308_), .b(new_n306_), .c(new_n267_), .O(new_n309_));
  aoi21  g136(.a(new_n309_), .b(new_n304_), .c(x01), .O(z53));
  nor2   g137(.a(x52), .b(x14), .O(new_n311_));
  oai21  g138(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n312_));
  nor3   g139(.a(new_n312_), .b(new_n311_), .c(new_n266_), .O(z54));
  inv1   g140(.a(x79), .O(new_n315_));
  aoi22  g141(.a(new_n260_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n316_));
  nand2  g142(.a(new_n153_), .b(x00), .O(new_n317_));
  aoi21  g143(.a(new_n161_), .b(new_n159_), .c(new_n317_), .O(new_n318_));
  oai21  g144(.a(new_n316_), .b(new_n315_), .c(new_n318_), .O(z56));
  oai21  g145(.a(new_n162_), .b(new_n264_), .c(new_n315_), .O(new_n321_));
  inv1   g146(.a(x83), .O(new_n322_));
  nand3  g147(.a(new_n322_), .b(x82), .c(x80), .O(new_n323_));
  inv1   g148(.a(x74), .O(new_n324_));
  nand4  g149(.a(x84), .b(x81), .c(new_n324_), .d(x43), .O(new_n325_));
  oai21  g150(.a(new_n325_), .b(new_n323_), .c(new_n218_), .O(new_n326_));
  nor2   g151(.a(new_n161_), .b(new_n264_), .O(new_n327_));
  nand3  g152(.a(new_n327_), .b(new_n326_), .c(x79), .O(new_n328_));
  nand3  g153(.a(new_n315_), .b(new_n161_), .c(x40), .O(new_n329_));
  ...
  oai21  g161(.a(new_n336_), .b(new_n264_), .c(new_n153_), .O(new_n337_));
  aoi21  g162(.a(new_n335_), .b(x79), .c(new_n337_), .O(z59));
  nand3  g163(.a(new_n258_), .b(new_n160_), .c(x79), .O(new_n341_));
  aoi21  g164(.a(new_n326_), .b(x79), .c(new_n264_), .O(new_n342_));
  nand3  g165(.a(x81), .b(x79), .c(new_n264_), .O(new_n343_));
  nand2  g166(.a(new_n343_), .b(x77), .O(new_n344_));
  nand2  g167(.a(new_n258_), .b(x79), .O(new_n345_));
  nor2   g168(.a(new_n265_), .b(x77), .O(new_n346_));
  ...
  nand2  g172(.a(new_n221_), .b(new_n264_), .O(new_n351_));
  oai21  g173(.a(new_n260_), .b(new_n163_), .c(new_n351_), .O(new_n352_));
  nand3  g174(.a(new_n352_), .b(x83), .c(x79), .O(new_n353_));
  aoi21  g175(.a(new_n353_), .b(new_n266_), .c(x01), .O(z64));
