...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n191_, new_n192_, new_n196_, new_n197_, new_n199_, new_n200_,
  ...
  aoi22  g135(.a(new_n255_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n311_));
  ...
  oai21  g139(.a(new_n162_), .b(new_n259_), .c(new_n310_), .O(new_n316_));
  ...
  oai21  g144(.a(new_n320_), .b(new_n318_), .c(new_n210_), .O(new_n321_));
  nor2   g145(.a(new_n161_), .b(new_n259_), .O(new_n322_));
  ...
  oai21  g155(.a(new_n331_), .b(new_n259_), .c(new_n153_), .O(new_n332_));
  aoi21  g156(.a(new_n330_), .b(x79), .c(new_n332_), .O(z59));
  nand3  g157(.a(new_n253_), .b(new_n160_), .c(x79), .O(new_n336_));
  aoi21  g158(.a(new_n321_), .b(x79), .c(new_n259_), .O(new_n337_));
  nand3  g159(.a(x81), .b(x79), .c(new_n259_), .O(new_n338_));
  nand2  g160(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g161(.a(new_n253_), .b(x79), .O(new_n340_));
  ...
  nand2  g166(.a(new_n213_), .b(new_n259_), .O(new_n346_));
  oai21  g167(.a(new_n255_), .b(new_n163_), .c(new_n346_), .O(new_n347_));
  nand3  g168(.a(new_n347_), .b(x83), .c(x79), .O(new_n348_));
  aoi21  g169(.a(new_n348_), .b(new_n261_), .c(x01), .O(z64));
