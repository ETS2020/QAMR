...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n225_, new_n226_, new_n228_, new_n231_, new_n233_, new_n235_,
    new_n240_, new_n241_, new_n242_, new_n243_, new_n244_, new_n246_,
    new_n249_, new_n253_, new_n255_, new_n258_, new_n263_, new_n264_,
  ...
  inv1   g075(.a(new_n224_), .O(new_n240_));
  nand4  g076(.a(new_n221_), .b(new_n218_), .c(x83), .d(x42), .O(new_n241_));
  inv1   g077(.a(x83), .O(new_n242_));
  oai21  g078(.a(new_n242_), .b(new_n216_), .c(new_n222_), .O(new_n243_));
  nand4  g079(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x52), .O(new_n244_));
  inv1   g080(.a(new_n244_), .O(z34));
  nand4  g081(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x53), .O(new_n246_));
  inv1   g082(.a(new_n246_), .O(z35));
  nand4  g083(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x55), .O(new_n249_));
  inv1   g084(.a(new_n249_), .O(z37));
  nand4  g085(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x58), .O(new_n253_));
  inv1   g086(.a(new_n253_), .O(z40));
  nand4  g087(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x59), .O(new_n255_));
  inv1   g088(.a(new_n255_), .O(z41));
  nand4  g089(.a(new_n243_), .b(new_n241_), .c(new_n240_), .d(x61), .O(new_n258_));
  inv1   g090(.a(new_n258_), .O(z43));
  and2   g091(.a(x84), .b(x81), .O(new_n263_));
  nor2   g092(.a(x84), .b(x81), .O(new_n264_));
  nor2   g093(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g094(.a(new_n160_), .b(x79), .O(new_n266_));
  nor2   g095(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  oai21  g096(.a(x75), .b(x67), .c(new_n267_), .O(new_n268_));
  inv1   g097(.a(x04), .O(new_n269_));
  nor2   g098(.a(x79), .b(new_n269_), .O(new_n270_));
  nand2  g099(.a(new_n270_), .b(new_n162_), .O(new_n271_));
  inv1   g100(.a(new_n271_), .O(new_n272_));
  inv1   g101(.a(x07), .O(new_n273_));
  inv1   g102(.a(x52), .O(new_n274_));
  nand2  g103(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  inv1   g104(.a(x15), .O(new_n276_));
  nand2  g105(.a(x52), .b(new_n276_), .O(new_n277_));
  nand3  g106(.a(new_n277_), .b(new_n275_), .c(new_n272_), .O(new_n278_));
  aoi21  g107(.a(new_n278_), .b(new_n268_), .c(x01), .O(z47));
  nand2  g108(.a(new_n267_), .b(x68), .O(new_n280_));
  inv1   g109(.a(x08), .O(new_n281_));
  nand2  g110(.a(new_n274_), .b(new_n281_), .O(new_n282_));
  inv1   g111(.a(x16), .O(new_n283_));
  nand2  g112(.a(x52), .b(new_n283_), .O(new_n284_));
  nand3  g113(.a(new_n284_), .b(new_n282_), .c(new_n272_), .O(new_n285_));
  aoi21  g114(.a(new_n285_), .b(new_n280_), .c(x01), .O(z48));
  nand2  g115(.a(new_n267_), .b(x71), .O(new_n289_));
  inv1   g116(.a(x11), .O(new_n290_));
  nand2  g117(.a(new_n274_), .b(new_n290_), .O(new_n291_));
  inv1   g118(.a(x19), .O(new_n292_));
  nand2  g119(.a(x52), .b(new_n292_), .O(new_n293_));
  nand3  g120(.a(new_n293_), .b(new_n291_), .c(new_n272_), .O(new_n294_));
  aoi21  g121(.a(new_n294_), .b(new_n289_), .c(x01), .O(z51));
  nand2  g122(.a(new_n267_), .b(x72), .O(new_n296_));
  inv1   g123(.a(x12), .O(new_n297_));
  nand2  g124(.a(new_n274_), .b(new_n297_), .O(new_n298_));
  inv1   g125(.a(x20), .O(new_n299_));
  nand2  g126(.a(x52), .b(new_n299_), .O(new_n300_));
  nand3  g127(.a(new_n300_), .b(new_n298_), .c(new_n272_), .O(new_n301_));
  aoi21  g128(.a(new_n301_), .b(new_n296_), .c(x01), .O(z52));
  nand2  g129(.a(new_n267_), .b(x73), .O(new_n303_));
  inv1   g130(.a(x13), .O(new_n304_));
  nand2  g131(.a(new_n274_), .b(new_n304_), .O(new_n305_));
  inv1   g132(.a(x21), .O(new_n306_));
  nand2  g133(.a(x52), .b(new_n306_), .O(new_n307_));
  nand3  g134(.a(new_n307_), .b(new_n305_), .c(new_n272_), .O(new_n308_));
  aoi21  g135(.a(new_n308_), .b(new_n303_), .c(x01), .O(z53));
  nor2   g136(.a(x52), .b(x14), .O(new_n310_));
  oai21  g137(.a(new_n274_), .b(x22), .c(new_n153_), .O(new_n311_));
  nor3   g138(.a(new_n311_), .b(new_n310_), .c(new_n271_), .O(z54));
  inv1   g139(.a(x79), .O(new_n314_));
  aoi22  g140(.a(new_n265_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n315_));
  ...
  oai21  g144(.a(new_n162_), .b(new_n269_), .c(new_n314_), .O(new_n320_));
  nand3  g145(.a(new_n242_), .b(x82), .c(x80), .O(new_n321_));
  ...
  nor2   g149(.a(new_n161_), .b(new_n269_), .O(new_n325_));
  nand3  g150(.a(new_n325_), .b(new_n324_), .c(x79), .O(new_n326_));
  nand3  g151(.a(new_n314_), .b(new_n161_), .c(x40), .O(new_n327_));
  ...
  aoi21  g155(.a(new_n330_), .b(new_n320_), .c(x01), .O(z58));
  ...
  oai21  g159(.a(new_n334_), .b(new_n269_), .c(new_n153_), .O(new_n335_));
  aoi21  g160(.a(new_n333_), .b(x79), .c(new_n335_), .O(z59));
  nand3  g161(.a(new_n263_), .b(new_n160_), .c(x79), .O(new_n339_));
  aoi21  g162(.a(new_n324_), .b(x79), .c(new_n269_), .O(new_n340_));
  nand3  g163(.a(x81), .b(x79), .c(new_n269_), .O(new_n341_));
  nand2  g164(.a(new_n341_), .b(x77), .O(new_n342_));
  nand2  g165(.a(new_n263_), .b(x79), .O(new_n343_));
  nor2   g166(.a(new_n270_), .b(x77), .O(new_n344_));
  ...
  nand2  g170(.a(new_n223_), .b(new_n269_), .O(new_n349_));
  oai21  g171(.a(new_n265_), .b(new_n163_), .c(new_n349_), .O(new_n350_));
  nand3  g172(.a(new_n350_), .b(x83), .c(x79), .O(new_n351_));
  aoi21  g173(.a(new_n351_), .b(new_n271_), .c(x01), .O(z64));
