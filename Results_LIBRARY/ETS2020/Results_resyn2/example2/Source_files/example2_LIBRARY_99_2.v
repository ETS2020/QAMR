...
module FAU ( 
  ...
  nand2  g158(.a(new_n271_), .b(new_n312_), .O(new_n313_));
  ...
  nand2  g165(.a(new_n271_), .b(new_n319_), .O(new_n320_));
  ...
  nand2  g172(.a(new_n271_), .b(new_n326_), .O(new_n327_));
  ...
  nand2  g179(.a(new_n271_), .b(new_n333_), .O(new_n334_));
  ...
  nand2  g186(.a(new_n271_), .b(new_n340_), .O(new_n341_));
  ...
  oai21  g192(.a(new_n271_), .b(x22), .c(new_n153_), .O(new_n347_));
  ...
  nor3   g197(.a(new_n351_), .b(new_n262_), .c(new_n242_), .O(z55));
  ...
  aoi22  g206(.a(new_n234_), .b(new_n164_), .c(new_n155_), .d(new_n230_), .O(new_n363_));
  aoi21  g207(.a(new_n363_), .b(new_n232_), .c(x01), .O(z60));
  inv1   g208(.a(new_n169_), .O(new_n365_));
  nand2  g209(.a(new_n163_), .b(new_n161_), .O(new_n366_));
  nand2  g210(.a(new_n235_), .b(new_n366_), .O(new_n367_));
  ...
  nor3   g214(.a(new_n370_), .b(new_n365_), .c(new_n349_), .O(z61));
