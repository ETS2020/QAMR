...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n211_, new_n213_, new_n214_, new_n216_, new_n217_, new_n221_,
  ...
  nor3   g124(.a(new_n271_), .b(new_n240_), .c(new_n198_), .O(z39));
  nor3   g125(.a(new_n271_), .b(new_n240_), .c(new_n195_), .O(z40));
  nor3   g126(.a(new_n271_), .b(new_n240_), .c(new_n192_), .O(z41));
  nor3   g127(.a(new_n271_), .b(new_n240_), .c(new_n189_), .O(z42));
  nor3   g128(.a(new_n271_), .b(new_n240_), .c(new_n186_), .O(z43));
  nor3   g129(.a(new_n271_), .b(new_n240_), .c(new_n183_), .O(z44));
  nor3   g130(.a(new_n271_), .b(new_n240_), .c(new_n180_), .O(z45));
  nor3   g131(.a(new_n271_), .b(new_n240_), .c(new_n177_), .O(z46));
  ...
  nand2  g167(.a(new_n269_), .b(new_n323_), .O(new_n324_));
  ...
  nand2  g174(.a(new_n269_), .b(new_n330_), .O(new_n331_));
  ...
  nand2  g181(.a(new_n269_), .b(new_n337_), .O(new_n338_));
  ...
  nor3   g189(.a(new_n346_), .b(new_n260_), .c(new_n240_), .O(z55));
