...
module FAU ( 
  ...
  nand2  g116(.a(new_n261_), .b(x70), .O(new_n288_));
  inv1   g117(.a(x10), .O(new_n289_));
  nand2  g118(.a(new_n268_), .b(new_n289_), .O(new_n290_));
  inv1   g119(.a(x18), .O(new_n291_));
  nand2  g120(.a(x52), .b(new_n291_), .O(new_n292_));
  nand3  g121(.a(new_n292_), .b(new_n290_), .c(new_n266_), .O(new_n293_));
  ...
  aoi22  g138(.a(new_n259_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n313_));
  ...
  oai21  g142(.a(new_n162_), .b(new_n263_), .c(new_n312_), .O(new_n318_));
  ...
  oai21  g147(.a(new_n322_), .b(new_n320_), .c(new_n214_), .O(new_n323_));
  nor2   g148(.a(new_n161_), .b(new_n263_), .O(new_n324_));
  ...
  oai21  g158(.a(new_n333_), .b(new_n263_), .c(new_n153_), .O(new_n334_));
  aoi21  g159(.a(new_n332_), .b(x79), .c(new_n334_), .O(z59));
  nand3  g160(.a(new_n257_), .b(new_n160_), .c(x79), .O(new_n338_));
  aoi21  g161(.a(new_n323_), .b(x79), .c(new_n263_), .O(new_n339_));
  nand3  g162(.a(x81), .b(x79), .c(new_n263_), .O(new_n340_));
  nand2  g163(.a(new_n340_), .b(x77), .O(new_n341_));
  nand2  g164(.a(new_n257_), .b(x79), .O(new_n342_));
  nor2   g165(.a(new_n264_), .b(x77), .O(new_n343_));
  ...
  nand2  g169(.a(new_n217_), .b(new_n263_), .O(new_n348_));
  oai21  g170(.a(new_n259_), .b(new_n163_), .c(new_n348_), .O(new_n349_));
  nand3  g171(.a(new_n349_), .b(x83), .c(x79), .O(new_n350_));
  aoi21  g172(.a(new_n350_), .b(new_n265_), .c(x01), .O(z64));
