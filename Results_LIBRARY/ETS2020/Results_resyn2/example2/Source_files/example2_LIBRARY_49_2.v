...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n212_, new_n214_, new_n215_, new_n219_, new_n220_, new_n221_,
    ...
    new_n271_, new_n273_, new_n276_, new_n286_, new_n287_, new_n288_,
    ...
    new_n333_, new_n338_, new_n339_, new_n340_, new_n341_, new_n343_,
    new_n345_, new_n346_, new_n347_, new_n348_, new_n349_, new_n350_,
    new_n352_, new_n353_, new_n354_, new_n355_, new_n356_, new_n357_,
    new_n358_, new_n359_, new_n362_, new_n364_, new_n365_;
  ...
  nor3   g119(.a(new_n268_), .b(new_n238_), .c(new_n196_), .O(z39));
  nor3   g120(.a(new_n268_), .b(new_n238_), .c(new_n193_), .O(z40));
  nor3   g121(.a(new_n268_), .b(new_n238_), .c(new_n190_), .O(z41));
  nor3   g122(.a(new_n268_), .b(new_n238_), .c(new_n187_), .O(z42));
  nor3   g123(.a(new_n268_), .b(new_n238_), .c(new_n184_), .O(z43));
  nor3   g124(.a(new_n268_), .b(new_n238_), .c(new_n181_), .O(z44));
  nor3   g125(.a(new_n268_), .b(new_n238_), .c(new_n178_), .O(z45));
  nor3   g126(.a(new_n268_), .b(new_n238_), .c(new_n175_), .O(z46));
  ...
  nand2  g160(.a(new_n286_), .b(x73), .O(new_n321_));
  inv1   g161(.a(x13), .O(new_n322_));
  nand2  g162(.a(new_n266_), .b(new_n322_), .O(new_n323_));
  inv1   g163(.a(x21), .O(new_n324_));
  nand2  g164(.a(x52), .b(new_n324_), .O(new_n325_));
  nand3  g165(.a(new_n325_), .b(new_n323_), .c(new_n291_), .O(new_n326_));
  aoi21  g166(.a(new_n326_), .b(new_n321_), .c(x01), .O(z53));
  nor2   g167(.a(x52), .b(x14), .O(new_n328_));
  oai21  g168(.a(new_n266_), .b(x22), .c(new_n153_), .O(new_n329_));
  nor3   g169(.a(new_n329_), .b(new_n328_), .c(new_n290_), .O(z54));
  inv1   g170(.a(x80), .O(new_n331_));
  inv1   g171(.a(x82), .O(new_n332_));
  nand3  g172(.a(x84), .b(new_n332_), .c(new_n331_), .O(new_n333_));
  nor3   g173(.a(new_n333_), .b(new_n257_), .c(new_n238_), .O(z55));
  nand2  g174(.a(new_n224_), .b(new_n158_), .O(new_n338_));
  nand2  g175(.a(new_n338_), .b(new_n227_), .O(new_n339_));
  aoi21  g176(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n340_));
  oai21  g177(.a(new_n340_), .b(new_n226_), .c(new_n153_), .O(new_n341_));
  aoi21  g178(.a(new_n339_), .b(x79), .c(new_n341_), .O(z59));
  aoi22  g179(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n343_));
  aoi21  g180(.a(new_n343_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g181(.a(new_n169_), .O(new_n345_));
  nand2  g182(.a(new_n163_), .b(new_n161_), .O(new_n346_));
  nand2  g183(.a(new_n231_), .b(new_n346_), .O(new_n347_));
  nand3  g184(.a(x78), .b(x77), .c(new_n226_), .O(new_n348_));
  nand2  g185(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  inv1   g186(.a(new_n349_), .O(new_n350_));
  nor3   g187(.a(new_n350_), .b(new_n345_), .c(new_n331_), .O(z61));
  nand3  g188(.a(x84), .b(x81), .c(x79), .O(new_n352_));
  or2    g189(.a(new_n352_), .b(new_n163_), .O(new_n353_));
  aoi21  g190(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n354_));
  nand3  g191(.a(x81), .b(x79), .c(new_n226_), .O(new_n355_));
  nand2  g192(.a(new_n355_), .b(x77), .O(new_n356_));
  nor2   g193(.a(new_n289_), .b(x77), .O(new_n357_));
  aoi21  g194(.a(new_n357_), .b(new_n352_), .c(new_n162_), .O(new_n358_));
  oai21  g195(.a(new_n356_), .b(new_n354_), .c(new_n358_), .O(new_n359_));
  aoi21  g196(.a(new_n359_), .b(new_n353_), .c(x01), .O(z62));
  nor3   g197(.a(new_n350_), .b(new_n345_), .c(new_n332_), .O(z63));
  nand3  g198(.a(new_n349_), .b(x83), .c(x79), .O(new_n362_));
  aoi21  g199(.a(new_n362_), .b(new_n290_), .c(x01), .O(z64));
  nand2  g200(.a(new_n346_), .b(x81), .O(new_n364_));
  nand2  g201(.a(new_n169_), .b(x84), .O(new_n365_));
  aoi21  g202(.a(new_n364_), .b(new_n348_), .c(new_n365_), .O(z65));
  zero   g203(.O(z05));
  zero   g204(.O(z20));
  zero   g205(.O(z21));
  zero   g206(.O(z24));
