...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n220_, new_n223_, new_n226_, new_n228_, new_n230_, new_n233_,
  ...
  nand2  g104(.a(new_n258_), .b(x71), .O(new_n280_));
  inv1   g105(.a(x11), .O(new_n281_));
  nand2  g106(.a(new_n265_), .b(new_n281_), .O(new_n282_));
  inv1   g107(.a(x19), .O(new_n283_));
  nand2  g108(.a(x52), .b(new_n283_), .O(new_n284_));
  nand3  g109(.a(new_n284_), .b(new_n282_), .c(new_n263_), .O(new_n285_));
  aoi21  g110(.a(new_n285_), .b(new_n280_), .c(x01), .O(z51));
