...
module FAU ( 
  ...
  nor2   g174(.a(x52), .b(x14), .O(new_n332_));
  oai21  g175(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n333_));
  nor3   g176(.a(new_n333_), .b(new_n332_), .c(new_n294_), .O(z54));
  inv1   g177(.a(x80), .O(new_n335_));
  inv1   g178(.a(x82), .O(new_n336_));
  nand3  g179(.a(x84), .b(new_n336_), .c(new_n335_), .O(new_n337_));
  nor3   g180(.a(new_n337_), .b(new_n260_), .c(new_n240_), .O(z55));
  inv1   g181(.a(x02), .O(new_n340_));
  nand4  g182(.a(x03), .b(new_n340_), .c(new_n153_), .d(x00), .O(new_n341_));
  inv1   g183(.a(new_n341_), .O(z57));
  nand2  g184(.a(new_n226_), .b(new_n158_), .O(new_n344_));
  nand2  g185(.a(new_n344_), .b(new_n229_), .O(new_n345_));
  aoi21  g186(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n346_));
  oai21  g187(.a(new_n346_), .b(new_n228_), .c(new_n153_), .O(new_n347_));
  aoi21  g188(.a(new_n345_), .b(x79), .c(new_n347_), .O(z59));
  aoi22  g189(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n349_));
  aoi21  g190(.a(new_n349_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g191(.a(new_n169_), .O(new_n351_));
  nand2  g192(.a(new_n163_), .b(new_n161_), .O(new_n352_));
  nand2  g193(.a(new_n233_), .b(new_n352_), .O(new_n353_));
  nand3  g194(.a(x78), .b(x77), .c(new_n228_), .O(new_n354_));
  nand2  g195(.a(new_n354_), .b(new_n353_), .O(new_n355_));
  inv1   g196(.a(new_n355_), .O(new_n356_));
  nor3   g197(.a(new_n356_), .b(new_n351_), .c(new_n335_), .O(z61));
  nand3  g198(.a(x84), .b(x81), .c(x79), .O(new_n358_));
  or2    g199(.a(new_n358_), .b(new_n163_), .O(new_n359_));
  aoi21  g200(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n360_));
  nand3  g201(.a(x81), .b(x79), .c(new_n228_), .O(new_n361_));
  nand2  g202(.a(new_n361_), .b(x77), .O(new_n362_));
  nor2   g203(.a(new_n293_), .b(x77), .O(new_n363_));
  aoi21  g204(.a(new_n363_), .b(new_n358_), .c(new_n162_), .O(new_n364_));
  oai21  g205(.a(new_n362_), .b(new_n360_), .c(new_n364_), .O(new_n365_));
  aoi21  g206(.a(new_n365_), .b(new_n359_), .c(x01), .O(z62));
  nor3   g207(.a(new_n356_), .b(new_n351_), .c(new_n336_), .O(z63));
  nand3  g208(.a(new_n355_), .b(x83), .c(x79), .O(new_n368_));
  aoi21  g209(.a(new_n368_), .b(new_n294_), .c(x01), .O(z64));
  nand2  g210(.a(new_n352_), .b(x81), .O(new_n370_));
  nand2  g211(.a(new_n169_), .b(x84), .O(new_n371_));
  aoi21  g212(.a(new_n370_), .b(new_n354_), .c(new_n371_), .O(z65));
  zero   g213(.O(z05));
  zero   g214(.O(z20));
  zero   g215(.O(z24));
  zero   g216(.O(z32));
