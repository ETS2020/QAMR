...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n270_, new_n272_, new_n275_, new_n277_, new_n279_, new_n281_,
  ...
  nand4  g106(.a(new_n261_), .b(new_n260_), .c(new_n250_), .d(x61), .O(new_n275_));
  inv1   g107(.a(new_n275_), .O(z43));
  nand4  g108(.a(new_n261_), .b(new_n260_), .c(new_n250_), .d(x62), .O(new_n277_));
  inv1   g109(.a(new_n277_), .O(z44));
  nand4  g110(.a(new_n261_), .b(new_n260_), .c(new_n250_), .d(x63), .O(new_n279_));
  inv1   g111(.a(new_n279_), .O(z45));
  nand4  g112(.a(new_n261_), .b(new_n260_), .c(new_n250_), .d(x64), .O(new_n281_));
  ...
  and2   g157(.a(new_n328_), .b(new_n250_), .O(z55));
