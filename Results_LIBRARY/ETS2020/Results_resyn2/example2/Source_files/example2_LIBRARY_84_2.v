...
module FAU ( 
  ...
  nand2  g150(.a(new_n288_), .b(x70), .O(new_n308_));
  inv1   g151(.a(x10), .O(new_n309_));
  nand2  g152(.a(new_n267_), .b(new_n309_), .O(new_n310_));
  inv1   g153(.a(x18), .O(new_n311_));
  nand2  g154(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g155(.a(new_n312_), .b(new_n310_), .c(new_n293_), .O(new_n313_));
  aoi21  g156(.a(new_n313_), .b(new_n308_), .c(x01), .O(z50));
  nand2  g157(.a(new_n288_), .b(x71), .O(new_n315_));
  inv1   g158(.a(x11), .O(new_n316_));
  nand2  g159(.a(new_n267_), .b(new_n316_), .O(new_n317_));
  inv1   g160(.a(x19), .O(new_n318_));
  nand2  g161(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g162(.a(new_n319_), .b(new_n317_), .c(new_n293_), .O(new_n320_));
  aoi21  g163(.a(new_n320_), .b(new_n315_), .c(x01), .O(z51));
