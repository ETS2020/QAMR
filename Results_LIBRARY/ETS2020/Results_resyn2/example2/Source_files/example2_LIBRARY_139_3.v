...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n347_, new_n351_, new_n352_, new_n354_, new_n355_, new_n357_,
    ...
    new_n381_, new_n382_, new_n385_, new_n387_;
  ...
  inv1   g153(.a(x04), .O(new_n310_));
  nor2   g154(.a(x77), .b(new_n310_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(new_n155_), .O(new_n312_));
  inv1   g156(.a(new_n312_), .O(new_n313_));
  inv1   g157(.a(x07), .O(new_n314_));
  inv1   g158(.a(x52), .O(new_n315_));
  nand2  g159(.a(new_n315_), .b(new_n314_), .O(new_n316_));
  inv1   g160(.a(x15), .O(new_n317_));
  nand2  g161(.a(x52), .b(new_n317_), .O(new_n318_));
  nand3  g162(.a(new_n318_), .b(new_n316_), .c(new_n313_), .O(new_n319_));
  aoi21  g163(.a(new_n319_), .b(new_n309_), .c(x01), .O(z47));
  nand2  g164(.a(new_n308_), .b(x68), .O(new_n321_));
  inv1   g165(.a(x08), .O(new_n322_));
  nand2  g166(.a(new_n315_), .b(new_n322_), .O(new_n323_));
  inv1   g167(.a(x16), .O(new_n324_));
  nand2  g168(.a(x52), .b(new_n324_), .O(new_n325_));
  nand3  g169(.a(new_n325_), .b(new_n323_), .c(new_n313_), .O(new_n326_));
  aoi21  g170(.a(new_n326_), .b(new_n321_), .c(x01), .O(z48));
  nand2  g171(.a(new_n308_), .b(x69), .O(new_n328_));
  inv1   g172(.a(x09), .O(new_n329_));
  nand2  g173(.a(new_n315_), .b(new_n329_), .O(new_n330_));
  inv1   g174(.a(x17), .O(new_n331_));
  nand2  g175(.a(x52), .b(new_n331_), .O(new_n332_));
  nand3  g176(.a(new_n332_), .b(new_n330_), .c(new_n313_), .O(new_n333_));
  aoi21  g177(.a(new_n333_), .b(new_n328_), .c(x01), .O(z49));
  nand2  g178(.a(new_n308_), .b(x70), .O(new_n335_));
  inv1   g179(.a(x10), .O(new_n336_));
  nand2  g180(.a(new_n315_), .b(new_n336_), .O(new_n337_));
  inv1   g181(.a(x18), .O(new_n338_));
  nand2  g182(.a(x52), .b(new_n338_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n337_), .c(new_n313_), .O(new_n340_));
  aoi21  g184(.a(new_n340_), .b(new_n335_), .c(x01), .O(z50));
  nand2  g185(.a(new_n308_), .b(x71), .O(new_n342_));
  inv1   g186(.a(x11), .O(new_n343_));
  nand2  g187(.a(new_n315_), .b(new_n343_), .O(new_n344_));
  inv1   g188(.a(x19), .O(new_n345_));
  nand2  g189(.a(x52), .b(new_n345_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n344_), .c(new_n313_), .O(new_n347_));
  aoi21  g191(.a(new_n347_), .b(new_n342_), .c(x01), .O(z51));
  nor2   g192(.a(x52), .b(x14), .O(new_n351_));
  oai21  g193(.a(new_n315_), .b(x22), .c(new_n153_), .O(new_n352_));
  nor3   g194(.a(new_n352_), .b(new_n351_), .c(new_n312_), .O(z54));
  inv1   g195(.a(x82), .O(new_n354_));
  nand2  g196(.a(x84), .b(new_n354_), .O(new_n355_));
  nor4   g197(.a(new_n270_), .b(new_n250_), .c(new_n355_), .d(x80), .O(z55));
  inv1   g198(.a(new_n233_), .O(new_n357_));
  nor2   g199(.a(new_n357_), .b(new_n164_), .O(new_n358_));
  aoi21  g200(.a(new_n242_), .b(x76), .c(new_n358_), .O(new_n359_));
  aoi21  g201(.a(new_n154_), .b(new_n162_), .c(new_n237_), .O(new_n360_));
  oai21  g202(.a(new_n359_), .b(new_n170_), .c(new_n360_), .O(z56));
  inv1   g203(.a(x02), .O(new_n362_));
  nand3  g204(.a(new_n238_), .b(x03), .c(new_n362_), .O(new_n363_));
  inv1   g205(.a(new_n363_), .O(z57));
  aoi21  g206(.a(x42), .b(x40), .c(new_n230_), .O(new_n365_));
  nand3  g207(.a(new_n365_), .b(new_n228_), .c(x79), .O(new_n366_));
  nand4  g208(.a(new_n170_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n367_));
  nand2  g209(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  nand2  g210(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g211(.a(new_n161_), .b(new_n310_), .c(new_n170_), .O(new_n370_));
  aoi21  g212(.a(new_n370_), .b(new_n369_), .c(x01), .O(z58));
  inv1   g213(.a(new_n239_), .O(new_n372_));
  nand2  g214(.a(new_n170_), .b(new_n154_), .O(new_n373_));
  aoi21  g215(.a(new_n373_), .b(new_n230_), .c(new_n158_), .O(new_n374_));
  aoi21  g216(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n375_));
  oai21  g217(.a(new_n375_), .b(new_n374_), .c(x77), .O(new_n376_));
  aoi21  g218(.a(new_n376_), .b(new_n372_), .c(x01), .O(z59));
  aoi21  g219(.a(new_n358_), .b(x79), .c(new_n239_), .O(new_n378_));
  aoi21  g220(.a(new_n378_), .b(new_n232_), .c(x01), .O(z60));
  nand2  g221(.a(new_n233_), .b(new_n165_), .O(new_n380_));
  oai21  g222(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n381_));
  nand4  g223(.a(new_n381_), .b(new_n380_), .c(new_n171_), .d(x80), .O(new_n382_));
  inv1   g224(.a(new_n382_), .O(z61));
  nand4  g225(.a(new_n381_), .b(new_n380_), .c(new_n171_), .d(x82), .O(new_n385_));
  inv1   g226(.a(new_n385_), .O(z63));
  nand4  g227(.a(new_n381_), .b(new_n380_), .c(x83), .d(x79), .O(new_n387_));
  aoi21  g228(.a(new_n387_), .b(new_n312_), .c(x01), .O(z64));
  zero   g229(.O(z07));
  zero   g230(.O(z19));
  zero   g231(.O(z40));
  zero   g232(.O(z41));
