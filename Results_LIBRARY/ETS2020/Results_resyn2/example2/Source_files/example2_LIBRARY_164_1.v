...
module FAU ( 
  ...
  aoi22  g124(.a(new_n259_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n301_));
  ...
  oai21  g128(.a(new_n162_), .b(new_n263_), .c(new_n300_), .O(new_n306_));
  ...
  oai21  g133(.a(new_n310_), .b(new_n308_), .c(new_n214_), .O(new_n311_));
  nor2   g134(.a(new_n161_), .b(new_n263_), .O(new_n312_));
  ...
  oai21  g144(.a(new_n321_), .b(new_n263_), .c(new_n153_), .O(new_n322_));
  aoi21  g145(.a(new_n320_), .b(x79), .c(new_n322_), .O(z59));
  nand3  g146(.a(new_n257_), .b(new_n160_), .c(x79), .O(new_n326_));
  aoi21  g147(.a(new_n311_), .b(x79), .c(new_n263_), .O(new_n327_));
  nand3  g148(.a(x81), .b(x79), .c(new_n263_), .O(new_n328_));
  nand2  g149(.a(new_n328_), .b(x77), .O(new_n329_));
  nand2  g150(.a(new_n257_), .b(x79), .O(new_n330_));
  nor2   g151(.a(new_n264_), .b(x77), .O(new_n331_));
  ...
  nand2  g155(.a(new_n217_), .b(new_n263_), .O(new_n336_));
  oai21  g156(.a(new_n259_), .b(new_n163_), .c(new_n336_), .O(new_n337_));
  nand3  g157(.a(new_n337_), .b(x83), .c(x79), .O(new_n338_));
  aoi21  g158(.a(new_n338_), .b(new_n265_), .c(x01), .O(z64));
