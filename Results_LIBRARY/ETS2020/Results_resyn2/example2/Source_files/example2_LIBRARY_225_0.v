...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n189_, new_n193_, new_n194_, new_n197_, new_n198_, new_n200_,
    ...
    new_n303_, new_n304_, new_n305_, new_n309_, new_n310_, new_n311_,
  ...
  nand2  g139(.a(new_n288_), .b(x72), .O(new_n309_));
  inv1   g140(.a(x12), .O(new_n310_));
  nand2  g141(.a(new_n294_), .b(new_n310_), .O(new_n311_));
  inv1   g142(.a(x20), .O(new_n312_));
  nand2  g143(.a(x52), .b(new_n312_), .O(new_n313_));
  nand3  g144(.a(new_n313_), .b(new_n311_), .c(new_n292_), .O(new_n314_));
  aoi21  g145(.a(new_n314_), .b(new_n309_), .c(x01), .O(z52));
  nand2  g146(.a(new_n288_), .b(x73), .O(new_n316_));
  inv1   g147(.a(x13), .O(new_n317_));
  nand2  g148(.a(new_n294_), .b(new_n317_), .O(new_n318_));
  inv1   g149(.a(x21), .O(new_n319_));
  nand2  g150(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g151(.a(new_n320_), .b(new_n318_), .c(new_n292_), .O(new_n321_));
  aoi21  g152(.a(new_n321_), .b(new_n316_), .c(x01), .O(z53));
  nor2   g153(.a(x52), .b(x14), .O(new_n323_));
  oai21  g154(.a(new_n294_), .b(x22), .c(new_n164_), .O(new_n324_));
  nor3   g155(.a(new_n324_), .b(new_n323_), .c(new_n291_), .O(z54));
  inv1   g156(.a(x82), .O(new_n326_));
  nand2  g157(.a(x84), .b(new_n326_), .O(new_n327_));
  nor4   g158(.a(new_n327_), .b(new_n210_), .c(x81), .d(x80), .O(new_n328_));
  and2   g159(.a(new_n328_), .b(new_n253_), .O(z55));
  oai21  g160(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n330_));
  aoi21  g161(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n331_));
  nand2  g162(.a(new_n331_), .b(new_n330_), .O(z56));
  inv1   g163(.a(x02), .O(new_n333_));
  nand3  g164(.a(new_n221_), .b(x03), .c(new_n333_), .O(new_n334_));
  inv1   g165(.a(new_n334_), .O(z57));
  oai21  g166(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n336_));
  nand2  g167(.a(x78), .b(x04), .O(new_n337_));
  aoi21  g168(.a(x42), .b(x40), .c(new_n337_), .O(new_n338_));
  nand3  g169(.a(new_n338_), .b(new_n212_), .c(x79), .O(new_n339_));
  nand4  g170(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n339_), .O(new_n341_));
  nand2  g172(.a(new_n341_), .b(x77), .O(new_n342_));
  aoi21  g173(.a(new_n342_), .b(new_n336_), .c(x01), .O(z58));
  nor2   g174(.a(new_n158_), .b(new_n155_), .O(new_n345_));
  inv1   g175(.a(new_n345_), .O(new_n346_));
  nor2   g176(.a(new_n290_), .b(new_n217_), .O(new_n347_));
  oai21  g177(.a(new_n346_), .b(new_n161_), .c(new_n347_), .O(new_n348_));
  aoi21  g178(.a(new_n348_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g179(.a(new_n226_), .b(new_n222_), .O(new_n350_));
  oai21  g180(.a(new_n345_), .b(new_n216_), .c(new_n350_), .O(new_n351_));
  nand3  g181(.a(new_n351_), .b(new_n162_), .c(x80), .O(new_n352_));
  inv1   g182(.a(new_n352_), .O(z61));
  nand3  g183(.a(x84), .b(x81), .c(x79), .O(new_n354_));
  inv1   g184(.a(new_n354_), .O(new_n355_));
  nand2  g185(.a(new_n355_), .b(new_n158_), .O(new_n356_));
  aoi21  g186(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n357_));
  nand3  g187(.a(x81), .b(x79), .c(new_n222_), .O(new_n358_));
  nand2  g188(.a(new_n358_), .b(x77), .O(new_n359_));
  nor2   g189(.a(new_n290_), .b(x77), .O(new_n360_));
  aoi21  g190(.a(new_n360_), .b(new_n354_), .c(new_n154_), .O(new_n361_));
  oai21  g191(.a(new_n359_), .b(new_n357_), .c(new_n361_), .O(new_n362_));
  aoi21  g192(.a(new_n362_), .b(new_n356_), .c(x01), .O(z62));
  nand3  g193(.a(new_n351_), .b(new_n162_), .c(x82), .O(new_n364_));
  inv1   g194(.a(new_n364_), .O(z63));
  nand2  g195(.a(new_n346_), .b(x81), .O(new_n367_));
  nand2  g196(.a(new_n162_), .b(x84), .O(new_n368_));
  aoi21  g197(.a(new_n367_), .b(new_n350_), .c(new_n368_), .O(z65));
  zero   g198(.O(z00));
  zero   g199(.O(z01));
  zero   g200(.O(z04));
  zero   g201(.O(z06));
