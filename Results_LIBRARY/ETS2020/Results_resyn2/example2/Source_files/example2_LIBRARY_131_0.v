...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n233_, new_n234_, new_n235_, new_n236_, new_n238_, new_n243_,
  ...
  inv1   g066(.a(new_n226_), .O(new_n230_));
  inv1   g067(.a(x81), .O(new_n231_));
  xor2a  g068(.a(x84), .b(x82), .O(new_n232_));
  xor2a  g069(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand2  g070(.a(new_n224_), .b(x79), .O(new_n234_));
  nor3   g071(.a(new_n234_), .b(new_n233_), .c(x42), .O(new_n235_));
  nand3  g072(.a(new_n235_), .b(new_n230_), .c(x45), .O(new_n236_));
  inv1   g073(.a(new_n236_), .O(z27));
  nand3  g074(.a(new_n235_), .b(new_n230_), .c(x46), .O(new_n238_));
  inv1   g075(.a(new_n238_), .O(z28));
  nand3  g076(.a(new_n235_), .b(new_n230_), .c(x50), .O(new_n243_));
  ...
  nand3  g081(.a(new_n231_), .b(x51), .c(new_n205_), .O(new_n248_));
  nand3  g082(.a(new_n248_), .b(new_n247_), .c(new_n232_), .O(new_n249_));
  nor2   g083(.a(new_n234_), .b(new_n226_), .O(new_n250_));
  ...
  nand2  g127(.a(new_n285_), .b(x70), .O(new_n298_));
  inv1   g128(.a(x10), .O(new_n299_));
  nand2  g129(.a(new_n291_), .b(new_n299_), .O(new_n300_));
  inv1   g130(.a(x18), .O(new_n301_));
  nand2  g131(.a(x52), .b(new_n301_), .O(new_n302_));
  nand3  g132(.a(new_n302_), .b(new_n300_), .c(new_n289_), .O(new_n303_));
  aoi21  g133(.a(new_n303_), .b(new_n298_), .c(x01), .O(z50));
  nand2  g134(.a(new_n285_), .b(x71), .O(new_n305_));
  inv1   g135(.a(x11), .O(new_n306_));
  nand2  g136(.a(new_n291_), .b(new_n306_), .O(new_n307_));
  inv1   g137(.a(x19), .O(new_n308_));
  nand2  g138(.a(x52), .b(new_n308_), .O(new_n309_));
  nand3  g139(.a(new_n309_), .b(new_n307_), .c(new_n289_), .O(new_n310_));
  aoi21  g140(.a(new_n310_), .b(new_n305_), .c(x01), .O(z51));
  nand2  g141(.a(new_n285_), .b(x72), .O(new_n312_));
  inv1   g142(.a(x12), .O(new_n313_));
  nand2  g143(.a(new_n291_), .b(new_n313_), .O(new_n314_));
  inv1   g144(.a(x20), .O(new_n315_));
  nand2  g145(.a(x52), .b(new_n315_), .O(new_n316_));
  nand3  g146(.a(new_n316_), .b(new_n314_), .c(new_n289_), .O(new_n317_));
  aoi21  g147(.a(new_n317_), .b(new_n312_), .c(x01), .O(z52));
  nand2  g148(.a(new_n285_), .b(x73), .O(new_n319_));
  inv1   g149(.a(x13), .O(new_n320_));
  nand2  g150(.a(new_n291_), .b(new_n320_), .O(new_n321_));
  inv1   g151(.a(x21), .O(new_n322_));
  nand2  g152(.a(x52), .b(new_n322_), .O(new_n323_));
  nand3  g153(.a(new_n323_), .b(new_n321_), .c(new_n289_), .O(new_n324_));
  aoi21  g154(.a(new_n324_), .b(new_n319_), .c(x01), .O(z53));
  inv1   g155(.a(x82), .O(new_n327_));
  nand2  g156(.a(x84), .b(new_n327_), .O(new_n328_));
  nor4   g157(.a(new_n328_), .b(new_n208_), .c(x81), .d(x80), .O(new_n329_));
  and2   g158(.a(new_n329_), .b(new_n250_), .O(z55));
  oai21  g159(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n331_));
  aoi21  g160(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n332_));
  nand2  g161(.a(new_n332_), .b(new_n331_), .O(z56));
  inv1   g162(.a(x02), .O(new_n334_));
  nand3  g163(.a(new_n219_), .b(x03), .c(new_n334_), .O(new_n335_));
  inv1   g164(.a(new_n335_), .O(z57));
  oai21  g165(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n337_));
  nand2  g166(.a(x78), .b(x04), .O(new_n338_));
  aoi21  g167(.a(x42), .b(x40), .c(new_n338_), .O(new_n339_));
  nand3  g168(.a(new_n339_), .b(new_n210_), .c(x79), .O(new_n340_));
  nand4  g169(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n341_));
  ...
  nor2   g175(.a(new_n287_), .b(new_n215_), .O(new_n348_));
  oai21  g176(.a(new_n347_), .b(new_n161_), .c(new_n348_), .O(new_n349_));
  aoi21  g177(.a(new_n349_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g178(.a(new_n224_), .b(new_n220_), .O(new_n351_));
  oai21  g179(.a(new_n346_), .b(new_n214_), .c(new_n351_), .O(new_n352_));
  ...
  aoi21  g185(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n358_));
  nand3  g186(.a(x81), .b(x79), .c(new_n220_), .O(new_n359_));
  nand2  g187(.a(new_n359_), .b(x77), .O(new_n360_));
  nor2   g188(.a(new_n287_), .b(x77), .O(new_n361_));
