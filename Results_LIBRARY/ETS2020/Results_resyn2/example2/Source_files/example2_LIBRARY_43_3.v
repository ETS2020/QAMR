...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n342_, new_n345_, new_n346_, new_n348_, new_n349_, new_n351_,
  ...
  nand2  g179(.a(new_n310_), .b(x72), .O(new_n337_));
  inv1   g180(.a(x12), .O(new_n338_));
  nand2  g181(.a(new_n315_), .b(new_n338_), .O(new_n339_));
  inv1   g182(.a(x20), .O(new_n340_));
  nand2  g183(.a(x52), .b(new_n340_), .O(new_n341_));
  nand3  g184(.a(new_n341_), .b(new_n339_), .c(new_n313_), .O(new_n342_));
  aoi21  g185(.a(new_n342_), .b(new_n337_), .c(x01), .O(z52));
