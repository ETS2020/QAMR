...
module FAU ( 
  ...
  nand2  g144(.a(new_n289_), .b(x69), .O(new_n302_));
  inv1   g145(.a(x09), .O(new_n303_));
  nand2  g146(.a(new_n268_), .b(new_n303_), .O(new_n304_));
  inv1   g147(.a(x17), .O(new_n305_));
  nand2  g148(.a(x52), .b(new_n305_), .O(new_n306_));
  nand3  g149(.a(new_n306_), .b(new_n304_), .c(new_n294_), .O(new_n307_));
  aoi21  g150(.a(new_n307_), .b(new_n302_), .c(x01), .O(z49));
