...
module FAU ( 
  ...
  nand2  g145(.a(new_n285_), .b(x70), .O(new_n305_));
  inv1   g146(.a(x10), .O(new_n306_));
  nand2  g147(.a(new_n264_), .b(new_n306_), .O(new_n307_));
  inv1   g148(.a(x18), .O(new_n308_));
  nand2  g149(.a(x52), .b(new_n308_), .O(new_n309_));
  nand3  g150(.a(new_n309_), .b(new_n307_), .c(new_n290_), .O(new_n310_));
  aoi21  g151(.a(new_n310_), .b(new_n305_), .c(x01), .O(z50));
