...
module FAU ( 
  ...
  nand2  g164(.a(new_n313_), .b(new_n322_), .O(new_n323_));
  inv1   g165(.a(x18), .O(new_n324_));
  nand2  g166(.a(x52), .b(new_n324_), .O(new_n325_));
  nand3  g167(.a(new_n325_), .b(new_n323_), .c(new_n311_), .O(new_n326_));
  aoi21  g168(.a(new_n326_), .b(new_n321_), .c(x01), .O(z50));
  nand2  g169(.a(new_n308_), .b(x71), .O(new_n328_));
  inv1   g170(.a(x11), .O(new_n329_));
  nand2  g171(.a(new_n313_), .b(new_n329_), .O(new_n330_));
  inv1   g172(.a(x19), .O(new_n331_));
  nand2  g173(.a(x52), .b(new_n331_), .O(new_n332_));
  nand3  g174(.a(new_n332_), .b(new_n330_), .c(new_n311_), .O(new_n333_));
