// Benchmark "FAU" written by ABC on Sat Jul 25 01:26:24 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n246_, new_n249_, new_n251_, new_n253_, new_n256_,
    ...
    new_n331_, new_n332_, new_n335_, new_n336_, new_n337_, new_n340_,
  ...
  nand2  g160(.a(new_n286_), .b(x72), .O(new_n320_));
  inv1   g161(.a(x12), .O(new_n321_));
  nand2  g162(.a(new_n265_), .b(new_n321_), .O(new_n322_));
  ...
  nand2  g167(.a(new_n286_), .b(x73), .O(new_n327_));
  inv1   g168(.a(x13), .O(new_n328_));
  nand2  g169(.a(new_n265_), .b(new_n328_), .O(new_n329_));
  ...
  inv1   g175(.a(x82), .O(new_n336_));
  nand3  g176(.a(x84), .b(new_n336_), .c(new_n335_), .O(new_n337_));
  nor3   g177(.a(new_n337_), .b(new_n256_), .c(new_n238_), .O(z55));
  inv1   g178(.a(x02), .O(new_n340_));
  nand4  g179(.a(x03), .b(new_n340_), .c(new_n153_), .d(x00), .O(new_n341_));
  inv1   g180(.a(new_n341_), .O(z57));
  nand2  g181(.a(new_n224_), .b(new_n158_), .O(new_n344_));
  nand2  g182(.a(new_n344_), .b(new_n227_), .O(new_n345_));
  aoi21  g183(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n346_));
  oai21  g184(.a(new_n346_), .b(new_n226_), .c(new_n153_), .O(new_n347_));
  aoi21  g185(.a(new_n345_), .b(x79), .c(new_n347_), .O(z59));
  aoi22  g186(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n349_));
  aoi21  g187(.a(new_n349_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g188(.a(new_n169_), .O(new_n351_));
  nand2  g189(.a(new_n163_), .b(new_n161_), .O(new_n352_));
  nand2  g190(.a(new_n231_), .b(new_n352_), .O(new_n353_));
  nand3  g191(.a(x78), .b(x77), .c(new_n226_), .O(new_n354_));
  nand2  g192(.a(new_n354_), .b(new_n353_), .O(new_n355_));
  inv1   g193(.a(new_n355_), .O(new_n356_));
  nor3   g194(.a(new_n356_), .b(new_n351_), .c(new_n335_), .O(z61));
  nand3  g195(.a(x84), .b(x81), .c(x79), .O(new_n358_));
  or2    g196(.a(new_n358_), .b(new_n163_), .O(new_n359_));
  aoi21  g197(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n360_));
  nand3  g198(.a(x81), .b(x79), .c(new_n226_), .O(new_n361_));
  nand2  g199(.a(new_n361_), .b(x77), .O(new_n362_));
  nor2   g200(.a(new_n289_), .b(x77), .O(new_n363_));
  aoi21  g201(.a(new_n363_), .b(new_n358_), .c(new_n162_), .O(new_n364_));
  oai21  g202(.a(new_n362_), .b(new_n360_), .c(new_n364_), .O(new_n365_));
  aoi21  g203(.a(new_n365_), .b(new_n359_), .c(x01), .O(z62));
  nor3   g204(.a(new_n356_), .b(new_n351_), .c(new_n336_), .O(z63));
  nand3  g205(.a(new_n355_), .b(x83), .c(x79), .O(new_n368_));
  aoi21  g206(.a(new_n368_), .b(new_n290_), .c(x01), .O(z64));
  nand2  g207(.a(new_n352_), .b(x81), .O(new_n370_));
  nand2  g208(.a(new_n169_), .b(x84), .O(new_n371_));
  aoi21  g209(.a(new_n370_), .b(new_n354_), .c(new_n371_), .O(z65));
  zero   g210(.O(z19));
  zero   g211(.O(z20));
  zero   g212(.O(z21));
  zero   g213(.O(z24));
