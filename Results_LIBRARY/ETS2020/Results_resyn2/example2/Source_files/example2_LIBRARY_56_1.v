...
module FAU ( 
  ...
  nand2  g115(.a(new_n265_), .b(x71), .O(new_n287_));
  inv1   g116(.a(x11), .O(new_n288_));
  nand2  g117(.a(new_n272_), .b(new_n288_), .O(new_n289_));
  inv1   g118(.a(x19), .O(new_n290_));
  nand2  g119(.a(x52), .b(new_n290_), .O(new_n291_));
  nand3  g120(.a(new_n291_), .b(new_n289_), .c(new_n270_), .O(new_n292_));
  aoi21  g121(.a(new_n292_), .b(new_n287_), .c(x01), .O(z51));
  nand2  g122(.a(new_n265_), .b(x72), .O(new_n294_));
  inv1   g123(.a(x12), .O(new_n295_));
  nand2  g124(.a(new_n272_), .b(new_n295_), .O(new_n296_));
  inv1   g125(.a(x20), .O(new_n297_));
  nand2  g126(.a(x52), .b(new_n297_), .O(new_n298_));
  nand3  g127(.a(new_n298_), .b(new_n296_), .c(new_n270_), .O(new_n299_));
  aoi21  g128(.a(new_n299_), .b(new_n294_), .c(x01), .O(z52));
  nand2  g129(.a(new_n265_), .b(x73), .O(new_n301_));
  inv1   g130(.a(x13), .O(new_n302_));
  nand2  g131(.a(new_n272_), .b(new_n302_), .O(new_n303_));
  inv1   g132(.a(x21), .O(new_n304_));
  nand2  g133(.a(x52), .b(new_n304_), .O(new_n305_));
  nand3  g134(.a(new_n305_), .b(new_n303_), .c(new_n270_), .O(new_n306_));
  aoi21  g135(.a(new_n306_), .b(new_n301_), .c(x01), .O(z53));
  inv1   g136(.a(x79), .O(new_n310_));
  aoi22  g137(.a(new_n263_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n311_));
  ...
  oai21  g141(.a(new_n162_), .b(new_n267_), .c(new_n310_), .O(new_n316_));
  ...
  nor2   g147(.a(new_n161_), .b(new_n267_), .O(new_n322_));
  ...
  oai21  g157(.a(new_n331_), .b(new_n267_), .c(new_n153_), .O(new_n332_));
  aoi21  g158(.a(new_n330_), .b(x79), .c(new_n332_), .O(z59));
  nand3  g159(.a(new_n261_), .b(new_n160_), .c(x79), .O(new_n336_));
  aoi21  g160(.a(new_n321_), .b(x79), .c(new_n267_), .O(new_n337_));
  nand3  g161(.a(x81), .b(x79), .c(new_n267_), .O(new_n338_));
  nand2  g162(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g163(.a(new_n261_), .b(x79), .O(new_n340_));
  nor2   g164(.a(new_n268_), .b(x77), .O(new_n341_));
  ...
  nand2  g168(.a(new_n221_), .b(new_n267_), .O(new_n346_));
  oai21  g169(.a(new_n263_), .b(new_n163_), .c(new_n346_), .O(new_n347_));
  nand3  g170(.a(new_n347_), .b(x83), .c(x79), .O(new_n348_));
  aoi21  g171(.a(new_n348_), .b(new_n269_), .c(x01), .O(z64));
