// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:11 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n201_, new_n203_, new_n204_, new_n209_, new_n210_, new_n211_,
    new_n213_, new_n214_, new_n215_, new_n216_, new_n217_, new_n218_,
    new_n219_, new_n224_, new_n226_, new_n228_, new_n232_, new_n233_,
    new_n234_, new_n235_, new_n236_, new_n238_, new_n243_, new_n245_,
  ...
  xor2a  g054(.a(new_n215_), .b(new_n214_), .O(new_n216_));
  nand3  g055(.a(new_n210_), .b(new_n162_), .c(x79), .O(new_n217_));
  nor2   g056(.a(new_n217_), .b(new_n216_), .O(new_n218_));
  nand3  g057(.a(new_n218_), .b(new_n213_), .c(x05), .O(new_n219_));
  inv1   g058(.a(new_n219_), .O(z25));
  nand3  g059(.a(new_n218_), .b(x47), .c(new_n213_), .O(new_n224_));
  inv1   g060(.a(new_n224_), .O(z29));
  nand3  g061(.a(new_n218_), .b(x48), .c(new_n213_), .O(new_n226_));
  inv1   g062(.a(new_n226_), .O(z30));
  nand3  g063(.a(new_n218_), .b(x49), .c(new_n213_), .O(new_n228_));
  inv1   g064(.a(new_n228_), .O(z31));
  inv1   g065(.a(new_n217_), .O(new_n232_));
  nand2  g066(.a(x83), .b(x42), .O(new_n233_));
  or2    g067(.a(new_n233_), .b(new_n216_), .O(new_n234_));
  nand2  g068(.a(new_n233_), .b(new_n216_), .O(new_n235_));
  nand4  g069(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x52), .O(new_n236_));
  inv1   g070(.a(new_n236_), .O(z34));
  nand4  g071(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x53), .O(new_n238_));
  inv1   g072(.a(new_n238_), .O(z35));
  nand4  g073(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x57), .O(new_n243_));
  inv1   g074(.a(new_n243_), .O(z39));
  nand4  g075(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x58), .O(new_n245_));
  inv1   g076(.a(new_n245_), .O(z40));
  nand4  g077(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x59), .O(new_n247_));
  inv1   g078(.a(new_n247_), .O(z41));
  nand4  g079(.a(new_n235_), .b(new_n234_), .c(new_n232_), .d(x61), .O(new_n250_));
  inv1   g080(.a(new_n250_), .O(z43));
  xor2a  g081(.a(x84), .b(x81), .O(new_n255_));
  inv1   g082(.a(x77), .O(new_n256_));
  nor2   g083(.a(x78), .b(new_n256_), .O(new_n257_));
  nand2  g084(.a(new_n257_), .b(x79), .O(new_n258_));
  nor2   g085(.a(new_n258_), .b(new_n255_), .O(new_n259_));
  oai21  g086(.a(x75), .b(x67), .c(new_n259_), .O(new_n260_));
  inv1   g087(.a(x78), .O(new_n261_));
  nor2   g088(.a(new_n261_), .b(x77), .O(new_n262_));
  inv1   g089(.a(x04), .O(new_n263_));
  nor2   g090(.a(x79), .b(new_n263_), .O(new_n264_));
  nand2  g091(.a(new_n264_), .b(new_n262_), .O(new_n265_));
  ...
  aoi21  g099(.a(new_n272_), .b(new_n260_), .c(x01), .O(z47));
  nand2  g100(.a(new_n259_), .b(x68), .O(new_n274_));
  ...
  nand2  g107(.a(new_n259_), .b(x71), .O(new_n283_));
  inv1   g108(.a(x11), .O(new_n284_));
  nand2  g109(.a(new_n268_), .b(new_n284_), .O(new_n285_));
  inv1   g110(.a(x19), .O(new_n286_));
  nand2  g111(.a(x52), .b(new_n286_), .O(new_n287_));
  nand3  g112(.a(new_n287_), .b(new_n285_), .c(new_n266_), .O(new_n288_));
  aoi21  g113(.a(new_n288_), .b(new_n283_), .c(x01), .O(z51));
  nand2  g114(.a(new_n259_), .b(x72), .O(new_n290_));
  inv1   g115(.a(x12), .O(new_n291_));
  nand2  g116(.a(new_n268_), .b(new_n291_), .O(new_n292_));
  inv1   g117(.a(x20), .O(new_n293_));
  nand2  g118(.a(x52), .b(new_n293_), .O(new_n294_));
  nand3  g119(.a(new_n294_), .b(new_n292_), .c(new_n266_), .O(new_n295_));
  aoi21  g120(.a(new_n295_), .b(new_n290_), .c(x01), .O(z52));
  nand2  g121(.a(new_n259_), .b(x73), .O(new_n297_));
  inv1   g122(.a(x13), .O(new_n298_));
  nand2  g123(.a(new_n268_), .b(new_n298_), .O(new_n299_));
  inv1   g124(.a(x21), .O(new_n300_));
  nand2  g125(.a(x52), .b(new_n300_), .O(new_n301_));
  nand3  g126(.a(new_n301_), .b(new_n299_), .c(new_n266_), .O(new_n302_));
  aoi21  g127(.a(new_n302_), .b(new_n297_), .c(x01), .O(z53));
  nor2   g128(.a(new_n262_), .b(new_n257_), .O(new_n306_));
  inv1   g129(.a(new_n306_), .O(new_n307_));
  aoi22  g130(.a(new_n307_), .b(new_n255_), .c(new_n154_), .d(x76), .O(new_n308_));
  ...
  inv1   g134(.a(x02), .O(new_n312_));
  nand4  g135(.a(x03), .b(new_n312_), .c(new_n153_), .d(x00), .O(new_n313_));
  inv1   g136(.a(new_n313_), .O(z57));
  oai21  g137(.a(new_n262_), .b(new_n263_), .c(new_n161_), .O(new_n315_));
  ...
  oai21  g142(.a(new_n319_), .b(new_n317_), .c(new_n213_), .O(new_n320_));
  nor2   g143(.a(new_n261_), .b(new_n263_), .O(new_n321_));
  nand3  g144(.a(new_n321_), .b(new_n320_), .c(x79), .O(new_n322_));
  nand3  g145(.a(new_n161_), .b(new_n261_), .c(x40), .O(new_n323_));
  nand2  g146(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  aoi21  g147(.a(x42), .b(x40), .c(new_n256_), .O(new_n325_));
  ...
  aoi21  g152(.a(new_n261_), .b(new_n156_), .c(new_n256_), .O(new_n330_));
  oai21  g153(.a(new_n330_), .b(new_n263_), .c(new_n153_), .O(new_n331_));
  aoi21  g154(.a(new_n329_), .b(x79), .c(new_n331_), .O(z59));
  and2   g155(.a(x84), .b(x81), .O(new_n335_));
  nand3  g156(.a(new_n257_), .b(new_n335_), .c(x79), .O(new_n336_));
  aoi21  g157(.a(new_n320_), .b(x79), .c(new_n263_), .O(new_n337_));
  nand3  g158(.a(x81), .b(x79), .c(new_n263_), .O(new_n338_));
  nand2  g159(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g160(.a(new_n335_), .b(x79), .O(new_n340_));
  nor2   g161(.a(new_n264_), .b(x77), .O(new_n341_));
  aoi21  g162(.a(new_n341_), .b(new_n340_), .c(new_n261_), .O(new_n342_));
  oai21  g163(.a(new_n339_), .b(new_n337_), .c(new_n342_), .O(new_n343_));
  aoi21  g164(.a(new_n343_), .b(new_n336_), .c(x01), .O(z62));
  nand2  g165(.a(new_n162_), .b(new_n263_), .O(new_n346_));
  oai21  g166(.a(new_n306_), .b(new_n255_), .c(new_n346_), .O(new_n347_));
  nand3  g167(.a(new_n347_), .b(x83), .c(x79), .O(new_n348_));
  aoi21  g168(.a(new_n348_), .b(new_n265_), .c(x01), .O(z64));
  nand2  g169(.a(new_n154_), .b(x81), .O(new_n350_));
  nand4  g170(.a(new_n160_), .b(x84), .c(x79), .d(new_n153_), .O(new_n351_));
