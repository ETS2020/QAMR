...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n235_, new_n236_, new_n237_, new_n238_, new_n240_,
  ...
  nor2   g128(.a(x52), .b(x14), .O(new_n303_));
  oai21  g129(.a(new_n267_), .b(x22), .c(new_n153_), .O(new_n304_));
  nor3   g130(.a(new_n304_), .b(new_n303_), .c(new_n264_), .O(z54));
  inv1   g131(.a(x79), .O(new_n307_));
  aoi22  g132(.a(new_n258_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n308_));
  nand2  g133(.a(new_n153_), .b(x00), .O(new_n309_));
  aoi21  g134(.a(new_n161_), .b(new_n159_), .c(new_n309_), .O(new_n310_));
  oai21  g135(.a(new_n308_), .b(new_n307_), .c(new_n310_), .O(z56));
  oai21  g136(.a(new_n162_), .b(new_n262_), .c(new_n307_), .O(new_n313_));
  inv1   g137(.a(x83), .O(new_n314_));
  nand3  g138(.a(new_n314_), .b(x82), .c(x80), .O(new_n315_));
  inv1   g139(.a(x74), .O(new_n316_));
  nand4  g140(.a(x84), .b(x81), .c(new_n316_), .d(x43), .O(new_n317_));
  oai21  g141(.a(new_n317_), .b(new_n315_), .c(new_n214_), .O(new_n318_));
  nor2   g142(.a(new_n161_), .b(new_n262_), .O(new_n319_));
  nand3  g143(.a(new_n319_), .b(new_n318_), .c(x79), .O(new_n320_));
  nand3  g144(.a(new_n307_), .b(new_n161_), .c(x40), .O(new_n321_));
  nand2  g145(.a(new_n321_), .b(new_n320_), .O(new_n322_));
  aoi21  g146(.a(x42), .b(x40), .c(new_n159_), .O(new_n323_));
  nand2  g147(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  aoi21  g148(.a(new_n324_), .b(new_n313_), .c(x01), .O(z58));
  nand2  g149(.a(new_n318_), .b(new_n156_), .O(new_n326_));
  nand2  g150(.a(new_n326_), .b(new_n319_), .O(new_n327_));
  aoi21  g151(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n328_));
  oai21  g152(.a(new_n328_), .b(new_n262_), .c(new_n153_), .O(new_n329_));
  aoi21  g153(.a(new_n327_), .b(x79), .c(new_n329_), .O(z59));
  nand3  g154(.a(new_n256_), .b(new_n160_), .c(x79), .O(new_n333_));
  aoi21  g155(.a(new_n318_), .b(x79), .c(new_n262_), .O(new_n334_));
  nand3  g156(.a(x81), .b(x79), .c(new_n262_), .O(new_n335_));
  nand2  g157(.a(new_n335_), .b(x77), .O(new_n336_));
  nand2  g158(.a(new_n256_), .b(x79), .O(new_n337_));
  nor2   g159(.a(new_n263_), .b(x77), .O(new_n338_));
  aoi21  g160(.a(new_n338_), .b(new_n337_), .c(new_n161_), .O(new_n339_));
  oai21  g161(.a(new_n336_), .b(new_n334_), .c(new_n339_), .O(new_n340_));
  aoi21  g162(.a(new_n340_), .b(new_n333_), .c(x01), .O(z62));
  nand2  g163(.a(new_n217_), .b(new_n262_), .O(new_n343_));
  oai21  g164(.a(new_n258_), .b(new_n163_), .c(new_n343_), .O(new_n344_));
  nand3  g165(.a(new_n344_), .b(x83), .c(x79), .O(new_n345_));
  aoi21  g166(.a(new_n345_), .b(new_n264_), .c(x01), .O(z64));
  nand2  g167(.a(new_n164_), .b(x81), .O(new_n347_));
  nand3  g168(.a(x84), .b(x79), .c(new_n153_), .O(new_n348_));
  aoi21  g169(.a(new_n347_), .b(new_n343_), .c(new_n348_), .O(z65));
  zero   g170(.O(z02));
  zero   g171(.O(z03));
  zero   g172(.O(z05));
  zero   g173(.O(z08));
