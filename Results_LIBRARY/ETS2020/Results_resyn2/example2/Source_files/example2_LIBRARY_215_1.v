...
module FAU ( 
  ...
  nand3  g057(.a(new_n217_), .b(x47), .c(new_n212_), .O(new_n223_));
  inv1   g058(.a(new_n223_), .O(z29));
  nand3  g059(.a(new_n217_), .b(x48), .c(new_n212_), .O(new_n225_));
  inv1   g060(.a(new_n225_), .O(z30));
  nand3  g061(.a(new_n217_), .b(x49), .c(new_n212_), .O(new_n227_));
