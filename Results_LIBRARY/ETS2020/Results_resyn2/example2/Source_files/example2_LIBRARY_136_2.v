...
module FAU ( 
  ...
  nand2  g151(.a(new_n289_), .b(x70), .O(new_n309_));
  inv1   g152(.a(x10), .O(new_n310_));
  nand2  g153(.a(new_n268_), .b(new_n310_), .O(new_n311_));
  inv1   g154(.a(x18), .O(new_n312_));
  nand2  g155(.a(x52), .b(new_n312_), .O(new_n313_));
  nand3  g156(.a(new_n313_), .b(new_n311_), .c(new_n294_), .O(new_n314_));
  aoi21  g157(.a(new_n314_), .b(new_n309_), .c(x01), .O(z50));
  nand2  g158(.a(new_n289_), .b(x71), .O(new_n316_));
  inv1   g159(.a(x11), .O(new_n317_));
  nand2  g160(.a(new_n268_), .b(new_n317_), .O(new_n318_));
  inv1   g161(.a(x19), .O(new_n319_));
  nand2  g162(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g163(.a(new_n320_), .b(new_n318_), .c(new_n294_), .O(new_n321_));
  aoi21  g164(.a(new_n321_), .b(new_n316_), .c(x01), .O(z51));
