...
module FAU ( 
  ...
  nor2   g134(.a(x52), .b(x14), .O(new_n308_));
  oai21  g135(.a(new_n266_), .b(x22), .c(new_n153_), .O(new_n309_));
  nor3   g136(.a(new_n309_), .b(new_n308_), .c(new_n263_), .O(z54));
  inv1   g137(.a(x79), .O(new_n312_));
  aoi22  g138(.a(new_n257_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n313_));
  ...
  oai21  g142(.a(new_n162_), .b(new_n261_), .c(new_n312_), .O(new_n318_));
  inv1   g143(.a(x83), .O(new_n319_));
  nand3  g144(.a(new_n319_), .b(x82), .c(x80), .O(new_n320_));
  inv1   g145(.a(x74), .O(new_n321_));
  nand4  g146(.a(x84), .b(x81), .c(new_n321_), .d(x43), .O(new_n322_));
  oai21  g147(.a(new_n322_), .b(new_n320_), .c(new_n212_), .O(new_n323_));
  nor2   g148(.a(new_n161_), .b(new_n261_), .O(new_n324_));
  nand3  g149(.a(new_n324_), .b(new_n323_), .c(x79), .O(new_n325_));
  nand3  g150(.a(new_n312_), .b(new_n161_), .c(x40), .O(new_n326_));
  nand2  g151(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  aoi21  g152(.a(x42), .b(x40), .c(new_n159_), .O(new_n328_));
  nand2  g153(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  aoi21  g154(.a(new_n329_), .b(new_n318_), .c(x01), .O(z58));
  nand2  g155(.a(new_n323_), .b(new_n156_), .O(new_n331_));
  nand2  g156(.a(new_n331_), .b(new_n324_), .O(new_n332_));
  aoi21  g157(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n333_));
  oai21  g158(.a(new_n333_), .b(new_n261_), .c(new_n153_), .O(new_n334_));
  aoi21  g159(.a(new_n332_), .b(x79), .c(new_n334_), .O(z59));
  nand3  g160(.a(new_n255_), .b(new_n160_), .c(x79), .O(new_n338_));
  aoi21  g161(.a(new_n323_), .b(x79), .c(new_n261_), .O(new_n339_));
  nand3  g162(.a(x81), .b(x79), .c(new_n261_), .O(new_n340_));
  nand2  g163(.a(new_n340_), .b(x77), .O(new_n341_));
  nand2  g164(.a(new_n255_), .b(x79), .O(new_n342_));
  nor2   g165(.a(new_n262_), .b(x77), .O(new_n343_));
  ...
  nand2  g169(.a(new_n215_), .b(new_n261_), .O(new_n348_));
  oai21  g170(.a(new_n257_), .b(new_n163_), .c(new_n348_), .O(new_n349_));
  nand3  g171(.a(new_n349_), .b(x83), .c(x79), .O(new_n350_));
  aoi21  g172(.a(new_n350_), .b(new_n263_), .c(x01), .O(z64));
