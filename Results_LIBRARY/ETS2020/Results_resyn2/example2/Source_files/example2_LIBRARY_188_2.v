...
module FAU ( 
  ...
  nor3   g189(.a(new_n346_), .b(new_n259_), .c(new_n240_), .O(z55));
  inv1   g190(.a(x02), .O(new_n349_));
  nand4  g191(.a(x03), .b(new_n349_), .c(new_n153_), .d(x00), .O(new_n350_));
  inv1   g192(.a(new_n350_), .O(z57));
  nand2  g193(.a(new_n226_), .b(new_n158_), .O(new_n353_));
  nand2  g194(.a(new_n353_), .b(new_n229_), .O(new_n354_));
  aoi21  g195(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n355_));
  oai21  g196(.a(new_n355_), .b(new_n228_), .c(new_n153_), .O(new_n356_));
  aoi21  g197(.a(new_n354_), .b(x79), .c(new_n356_), .O(z59));
  aoi22  g198(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n358_));
  aoi21  g199(.a(new_n358_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g200(.a(new_n169_), .O(new_n360_));
  nand2  g201(.a(new_n163_), .b(new_n161_), .O(new_n361_));
  nand2  g202(.a(new_n233_), .b(new_n361_), .O(new_n362_));
  nand3  g203(.a(x78), .b(x77), .c(new_n228_), .O(new_n363_));
  ...
  aoi21  g209(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n369_));
  nand3  g210(.a(x81), .b(x79), .c(new_n228_), .O(new_n370_));
  nand2  g211(.a(new_n370_), .b(x77), .O(new_n371_));
  nor2   g212(.a(new_n292_), .b(x77), .O(new_n372_));
  ...
  aoi21  g218(.a(new_n377_), .b(new_n293_), .c(x01), .O(z64));
