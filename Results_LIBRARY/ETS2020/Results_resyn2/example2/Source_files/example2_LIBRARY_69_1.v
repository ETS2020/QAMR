...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n226_, new_n228_, new_n231_, new_n233_, new_n236_, new_n239_,
  ...
  nand2  g113(.a(new_n264_), .b(x72), .O(new_n287_));
  inv1   g114(.a(x12), .O(new_n288_));
  nand2  g115(.a(new_n271_), .b(new_n288_), .O(new_n289_));
  inv1   g116(.a(x20), .O(new_n290_));
  nand2  g117(.a(x52), .b(new_n290_), .O(new_n291_));
  nand3  g118(.a(new_n291_), .b(new_n289_), .c(new_n269_), .O(new_n292_));
  aoi21  g119(.a(new_n292_), .b(new_n287_), .c(x01), .O(z52));
  nand2  g120(.a(new_n264_), .b(x73), .O(new_n294_));
  inv1   g121(.a(x13), .O(new_n295_));
  nand2  g122(.a(new_n271_), .b(new_n295_), .O(new_n296_));
  inv1   g123(.a(x21), .O(new_n297_));
  nand2  g124(.a(x52), .b(new_n297_), .O(new_n298_));
  nand3  g125(.a(new_n298_), .b(new_n296_), .c(new_n269_), .O(new_n299_));
  aoi21  g126(.a(new_n299_), .b(new_n294_), .c(x01), .O(z53));
  inv1   g127(.a(x79), .O(new_n303_));
  aoi22  g128(.a(new_n262_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n304_));
  nand2  g129(.a(new_n153_), .b(x00), .O(new_n305_));
  aoi21  g130(.a(new_n161_), .b(new_n159_), .c(new_n305_), .O(new_n306_));
  oai21  g131(.a(new_n304_), .b(new_n303_), .c(new_n306_), .O(z56));
  oai21  g132(.a(new_n162_), .b(new_n266_), .c(new_n303_), .O(new_n309_));
  inv1   g133(.a(x83), .O(new_n310_));
  nand3  g134(.a(new_n310_), .b(x82), .c(x80), .O(new_n311_));
  inv1   g135(.a(x74), .O(new_n312_));
  nand4  g136(.a(x84), .b(x81), .c(new_n312_), .d(x43), .O(new_n313_));
  oai21  g137(.a(new_n313_), .b(new_n311_), .c(new_n218_), .O(new_n314_));
  nor2   g138(.a(new_n161_), .b(new_n266_), .O(new_n315_));
  nand3  g139(.a(new_n315_), .b(new_n314_), .c(x79), .O(new_n316_));
  nand3  g140(.a(new_n303_), .b(new_n161_), .c(x40), .O(new_n317_));
  nand2  g141(.a(new_n317_), .b(new_n316_), .O(new_n318_));
  aoi21  g142(.a(x42), .b(x40), .c(new_n159_), .O(new_n319_));
  nand2  g143(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  aoi21  g144(.a(new_n320_), .b(new_n309_), .c(x01), .O(z58));
  nand2  g145(.a(new_n314_), .b(new_n156_), .O(new_n322_));
  nand2  g146(.a(new_n322_), .b(new_n315_), .O(new_n323_));
  aoi21  g147(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n324_));
  oai21  g148(.a(new_n324_), .b(new_n266_), .c(new_n153_), .O(new_n325_));
  aoi21  g149(.a(new_n323_), .b(x79), .c(new_n325_), .O(z59));
  nand3  g150(.a(new_n260_), .b(new_n160_), .c(x79), .O(new_n329_));
  aoi21  g151(.a(new_n314_), .b(x79), .c(new_n266_), .O(new_n330_));
  nand3  g152(.a(x81), .b(x79), .c(new_n266_), .O(new_n331_));
  nand2  g153(.a(new_n331_), .b(x77), .O(new_n332_));
  nand2  g154(.a(new_n260_), .b(x79), .O(new_n333_));
  nor2   g155(.a(new_n267_), .b(x77), .O(new_n334_));
  aoi21  g156(.a(new_n334_), .b(new_n333_), .c(new_n161_), .O(new_n335_));
  oai21  g157(.a(new_n332_), .b(new_n330_), .c(new_n335_), .O(new_n336_));
  aoi21  g158(.a(new_n336_), .b(new_n329_), .c(x01), .O(z62));
  nand2  g159(.a(new_n221_), .b(new_n266_), .O(new_n339_));
  oai21  g160(.a(new_n262_), .b(new_n163_), .c(new_n339_), .O(new_n340_));
  nand3  g161(.a(new_n340_), .b(x83), .c(x79), .O(new_n341_));
  aoi21  g162(.a(new_n341_), .b(new_n268_), .c(x01), .O(z64));
  nand2  g163(.a(new_n164_), .b(x81), .O(new_n343_));
  nand3  g164(.a(x84), .b(x79), .c(new_n153_), .O(new_n344_));
  aoi21  g165(.a(new_n343_), .b(new_n339_), .c(new_n344_), .O(z65));
  zero   g166(.O(z02));
  zero   g167(.O(z03));
  zero   g168(.O(z09));
  zero   g169(.O(z11));
