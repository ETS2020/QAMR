...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n291_, new_n293_, new_n295_, new_n298_, new_n300_, new_n303_,
  ...
  nand4  g143(.a(new_n284_), .b(new_n283_), .c(new_n269_), .d(x59), .O(new_n298_));
  inv1   g144(.a(new_n298_), .O(z41));
  nand4  g145(.a(new_n284_), .b(new_n283_), .c(new_n269_), .d(x60), .O(new_n300_));
  inv1   g146(.a(new_n300_), .O(z42));
  nand4  g147(.a(new_n284_), .b(new_n283_), .c(new_n269_), .d(x62), .O(new_n303_));
  inv1   g148(.a(new_n303_), .O(z44));
  nand4  g149(.a(new_n284_), .b(new_n283_), .c(new_n269_), .d(x63), .O(new_n305_));
  inv1   g150(.a(new_n305_), .O(z45));
  nand4  g151(.a(new_n284_), .b(new_n283_), .c(new_n269_), .d(x64), .O(new_n307_));
  ...
  nor4   g191(.a(new_n271_), .b(new_n252_), .c(new_n349_), .d(x80), .O(z55));
