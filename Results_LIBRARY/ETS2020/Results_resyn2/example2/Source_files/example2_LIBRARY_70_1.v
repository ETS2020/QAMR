...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n219_, new_n220_, new_n223_, new_n225_, new_n228_, new_n230_,
  ...
  nand3  g066(.a(new_n219_), .b(x49), .c(new_n214_), .O(new_n230_));
  inv1   g067(.a(new_n230_), .O(z31));
  ...
  nand2  g112(.a(new_n259_), .b(x71), .O(new_n287_));
  inv1   g113(.a(x11), .O(new_n288_));
  nand2  g114(.a(new_n266_), .b(new_n288_), .O(new_n289_));
  inv1   g115(.a(x19), .O(new_n290_));
  nand2  g116(.a(x52), .b(new_n290_), .O(new_n291_));
  nand3  g117(.a(new_n291_), .b(new_n289_), .c(new_n264_), .O(new_n292_));
  aoi21  g118(.a(new_n292_), .b(new_n287_), .c(x01), .O(z51));
  ...
  inv1   g136(.a(x79), .O(new_n312_));
  aoi22  g137(.a(new_n257_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n313_));
  nand2  g138(.a(new_n153_), .b(x00), .O(new_n314_));
  aoi21  g139(.a(new_n161_), .b(new_n159_), .c(new_n314_), .O(new_n315_));
  oai21  g140(.a(new_n313_), .b(new_n312_), .c(new_n315_), .O(z56));
  oai21  g141(.a(new_n162_), .b(new_n261_), .c(new_n312_), .O(new_n318_));
  inv1   g142(.a(x83), .O(new_n319_));
  nand3  g143(.a(new_n319_), .b(x82), .c(x80), .O(new_n320_));
  inv1   g144(.a(x74), .O(new_n321_));
  nand4  g145(.a(x84), .b(x81), .c(new_n321_), .d(x43), .O(new_n322_));
  oai21  g146(.a(new_n322_), .b(new_n320_), .c(new_n214_), .O(new_n323_));
  nor2   g147(.a(new_n161_), .b(new_n261_), .O(new_n324_));
  nand3  g148(.a(new_n324_), .b(new_n323_), .c(x79), .O(new_n325_));
  nand3  g149(.a(new_n312_), .b(new_n161_), .c(x40), .O(new_n326_));
  nand2  g150(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  aoi21  g151(.a(x42), .b(x40), .c(new_n159_), .O(new_n328_));
  nand2  g152(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  aoi21  g153(.a(new_n329_), .b(new_n318_), .c(x01), .O(z58));
  nand2  g154(.a(new_n323_), .b(new_n156_), .O(new_n331_));
  nand2  g155(.a(new_n331_), .b(new_n324_), .O(new_n332_));
  aoi21  g156(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n333_));
  oai21  g157(.a(new_n333_), .b(new_n261_), .c(new_n153_), .O(new_n334_));
  aoi21  g158(.a(new_n332_), .b(x79), .c(new_n334_), .O(z59));
  nand3  g159(.a(new_n255_), .b(new_n160_), .c(x79), .O(new_n338_));
  aoi21  g160(.a(new_n323_), .b(x79), .c(new_n261_), .O(new_n339_));
  nand3  g161(.a(x81), .b(x79), .c(new_n261_), .O(new_n340_));
  nand2  g162(.a(new_n340_), .b(x77), .O(new_n341_));
  nand2  g163(.a(new_n255_), .b(x79), .O(new_n342_));
  nor2   g164(.a(new_n262_), .b(x77), .O(new_n343_));
  aoi21  g165(.a(new_n343_), .b(new_n342_), .c(new_n161_), .O(new_n344_));
  oai21  g166(.a(new_n341_), .b(new_n339_), .c(new_n344_), .O(new_n345_));
  aoi21  g167(.a(new_n345_), .b(new_n338_), .c(x01), .O(z62));
  nand2  g168(.a(new_n217_), .b(new_n261_), .O(new_n348_));
  oai21  g169(.a(new_n257_), .b(new_n163_), .c(new_n348_), .O(new_n349_));
  nand3  g170(.a(new_n349_), .b(x83), .c(x79), .O(new_n350_));
  aoi21  g171(.a(new_n350_), .b(new_n263_), .c(x01), .O(z64));
  nand2  g172(.a(new_n164_), .b(x81), .O(new_n352_));
  nand3  g173(.a(x84), .b(x79), .c(new_n153_), .O(new_n353_));
  aoi21  g174(.a(new_n352_), .b(new_n348_), .c(new_n353_), .O(z65));
  zero   g175(.O(z02));
  zero   g176(.O(z03));
  zero   g177(.O(z08));
  zero   g178(.O(z09));
