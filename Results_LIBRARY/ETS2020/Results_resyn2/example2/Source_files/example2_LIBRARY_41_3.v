...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n361_, new_n363_, new_n365_, new_n366_, new_n367_, new_n370_,
    new_n372_;
  ...
  nand2  g159(.a(new_n306_), .b(x70), .O(new_n319_));
  inv1   g160(.a(x10), .O(new_n320_));
  nand2  g161(.a(new_n311_), .b(new_n320_), .O(new_n321_));
  inv1   g162(.a(x18), .O(new_n322_));
  nand2  g163(.a(x52), .b(new_n322_), .O(new_n323_));
  nand3  g164(.a(new_n323_), .b(new_n321_), .c(new_n309_), .O(new_n324_));
  aoi21  g165(.a(new_n324_), .b(new_n319_), .c(x01), .O(z50));
  nand2  g166(.a(new_n306_), .b(x71), .O(new_n326_));
  inv1   g167(.a(x11), .O(new_n327_));
  nand2  g168(.a(new_n311_), .b(new_n327_), .O(new_n328_));
  inv1   g169(.a(x19), .O(new_n329_));
  nand2  g170(.a(x52), .b(new_n329_), .O(new_n330_));
  nand3  g171(.a(new_n330_), .b(new_n328_), .c(new_n309_), .O(new_n331_));
  aoi21  g172(.a(new_n331_), .b(new_n326_), .c(x01), .O(z51));
  nor2   g173(.a(x52), .b(x14), .O(new_n335_));
  oai21  g174(.a(new_n311_), .b(x22), .c(new_n153_), .O(new_n336_));
  nor3   g175(.a(new_n336_), .b(new_n335_), .c(new_n308_), .O(z54));
  inv1   g176(.a(x82), .O(new_n338_));
  nand2  g177(.a(x84), .b(new_n338_), .O(new_n339_));
  nor4   g178(.a(new_n268_), .b(new_n248_), .c(new_n339_), .d(x80), .O(z55));
  inv1   g179(.a(new_n231_), .O(new_n341_));
  nor2   g180(.a(new_n341_), .b(new_n164_), .O(new_n342_));
  aoi21  g181(.a(new_n240_), .b(x76), .c(new_n342_), .O(new_n343_));
  aoi21  g182(.a(new_n154_), .b(new_n162_), .c(new_n235_), .O(new_n344_));
  oai21  g183(.a(new_n343_), .b(new_n170_), .c(new_n344_), .O(z56));
  inv1   g184(.a(x02), .O(new_n346_));
  nand3  g185(.a(new_n236_), .b(x03), .c(new_n346_), .O(new_n347_));
  inv1   g186(.a(new_n347_), .O(z57));
  aoi21  g187(.a(x42), .b(x40), .c(new_n228_), .O(new_n349_));
  nand3  g188(.a(new_n349_), .b(new_n226_), .c(x79), .O(new_n350_));
  nand4  g189(.a(new_n170_), .b(new_n154_), .c(new_n221_), .d(x40), .O(new_n351_));
  nand2  g190(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  nand2  g191(.a(new_n352_), .b(x77), .O(new_n353_));
  inv1   g192(.a(x04), .O(new_n354_));
  oai21  g193(.a(new_n161_), .b(new_n354_), .c(new_n170_), .O(new_n355_));
  aoi21  g194(.a(new_n355_), .b(new_n353_), .c(x01), .O(z58));
  inv1   g195(.a(new_n237_), .O(new_n357_));
  nand2  g196(.a(new_n170_), .b(new_n154_), .O(new_n358_));
  aoi21  g197(.a(new_n358_), .b(new_n228_), .c(new_n158_), .O(new_n359_));
  aoi21  g198(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n360_));
  oai21  g199(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  aoi21  g200(.a(new_n361_), .b(new_n357_), .c(x01), .O(z59));
  aoi21  g201(.a(new_n342_), .b(x79), .c(new_n237_), .O(new_n363_));
  aoi21  g202(.a(new_n363_), .b(new_n230_), .c(x01), .O(z60));
  nand2  g203(.a(new_n231_), .b(new_n165_), .O(new_n365_));
  oai21  g204(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n366_));
  nand4  g205(.a(new_n366_), .b(new_n365_), .c(new_n171_), .d(x80), .O(new_n367_));
  inv1   g206(.a(new_n367_), .O(z61));
  nand4  g207(.a(new_n366_), .b(new_n365_), .c(new_n171_), .d(x82), .O(new_n370_));
  inv1   g208(.a(new_n370_), .O(z63));
  nand4  g209(.a(new_n366_), .b(new_n365_), .c(x83), .d(x79), .O(new_n372_));
  aoi21  g210(.a(new_n372_), .b(new_n308_), .c(x01), .O(z64));
  zero   g211(.O(z07));
  zero   g212(.O(z17));
  zero   g213(.O(z19));
  zero   g214(.O(z40));
