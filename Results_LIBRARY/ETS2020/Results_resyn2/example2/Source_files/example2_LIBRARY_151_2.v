...
module FAU ( 
  ...
  nand2  g144(.a(new_n285_), .b(x71), .O(new_n306_));
  inv1   g145(.a(x11), .O(new_n307_));
  nand2  g146(.a(new_n264_), .b(new_n307_), .O(new_n308_));
  inv1   g147(.a(x19), .O(new_n309_));
  nand2  g148(.a(x52), .b(new_n309_), .O(new_n310_));
  nand3  g149(.a(new_n310_), .b(new_n308_), .c(new_n290_), .O(new_n311_));
  aoi21  g150(.a(new_n311_), .b(new_n306_), .c(x01), .O(z51));
  nand2  g151(.a(new_n285_), .b(x72), .O(new_n313_));
  inv1   g152(.a(x12), .O(new_n314_));
  nand2  g153(.a(new_n264_), .b(new_n314_), .O(new_n315_));
  inv1   g154(.a(x20), .O(new_n316_));
  nand2  g155(.a(x52), .b(new_n316_), .O(new_n317_));
  nand3  g156(.a(new_n317_), .b(new_n315_), .c(new_n290_), .O(new_n318_));
  aoi21  g157(.a(new_n318_), .b(new_n313_), .c(x01), .O(z52));
  nand2  g158(.a(new_n285_), .b(x73), .O(new_n320_));
  inv1   g159(.a(x13), .O(new_n321_));
  nand2  g160(.a(new_n264_), .b(new_n321_), .O(new_n322_));
  ...
  oai21  g166(.a(new_n264_), .b(x22), .c(new_n153_), .O(new_n328_));
  ...
  nor3   g171(.a(new_n332_), .b(new_n255_), .c(new_n238_), .O(z55));
  inv1   g172(.a(x02), .O(new_n335_));
  nand4  g173(.a(x03), .b(new_n335_), .c(new_n153_), .d(x00), .O(new_n336_));
  inv1   g174(.a(new_n336_), .O(z57));
  nand2  g175(.a(new_n224_), .b(new_n158_), .O(new_n339_));
  nand2  g176(.a(new_n339_), .b(new_n227_), .O(new_n340_));
  aoi21  g177(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n341_));
  oai21  g178(.a(new_n341_), .b(new_n226_), .c(new_n153_), .O(new_n342_));
  aoi21  g179(.a(new_n340_), .b(x79), .c(new_n342_), .O(z59));
  aoi22  g180(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n344_));
  aoi21  g181(.a(new_n344_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g182(.a(new_n169_), .O(new_n346_));
  nand2  g183(.a(new_n163_), .b(new_n161_), .O(new_n347_));
  nand2  g184(.a(new_n231_), .b(new_n347_), .O(new_n348_));
  nand3  g185(.a(x78), .b(x77), .c(new_n226_), .O(new_n349_));
  nand2  g186(.a(new_n349_), .b(new_n348_), .O(new_n350_));
  inv1   g187(.a(new_n350_), .O(new_n351_));
  nor3   g188(.a(new_n351_), .b(new_n346_), .c(new_n330_), .O(z61));
  nand3  g189(.a(x84), .b(x81), .c(x79), .O(new_n353_));
  or2    g190(.a(new_n353_), .b(new_n163_), .O(new_n354_));
  aoi21  g191(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n355_));
  nand3  g192(.a(x81), .b(x79), .c(new_n226_), .O(new_n356_));
  nand2  g193(.a(new_n356_), .b(x77), .O(new_n357_));
  nor2   g194(.a(new_n288_), .b(x77), .O(new_n358_));
  aoi21  g195(.a(new_n358_), .b(new_n353_), .c(new_n162_), .O(new_n359_));
  oai21  g196(.a(new_n357_), .b(new_n355_), .c(new_n359_), .O(new_n360_));
  aoi21  g197(.a(new_n360_), .b(new_n354_), .c(x01), .O(z62));
  nor3   g198(.a(new_n351_), .b(new_n346_), .c(new_n331_), .O(z63));
  nand3  g199(.a(new_n350_), .b(x83), .c(x79), .O(new_n363_));
  aoi21  g200(.a(new_n363_), .b(new_n289_), .c(x01), .O(z64));
  nand2  g201(.a(new_n347_), .b(x81), .O(new_n365_));
  nand2  g202(.a(new_n169_), .b(x84), .O(new_n366_));
  aoi21  g203(.a(new_n365_), .b(new_n349_), .c(new_n366_), .O(z65));
  zero   g204(.O(z15));
  zero   g205(.O(z19));
  zero   g206(.O(z20));
  zero   g207(.O(z24));
