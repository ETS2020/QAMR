...
module FAU ( 
  ...
  nor3   g128(.a(new_n271_), .b(new_n240_), .c(new_n189_), .O(z42));
  nor3   g129(.a(new_n271_), .b(new_n240_), .c(new_n186_), .O(z43));
  nor3   g130(.a(new_n271_), .b(new_n240_), .c(new_n183_), .O(z44));
  nor3   g131(.a(new_n271_), .b(new_n240_), .c(new_n180_), .O(z45));
  nor3   g132(.a(new_n271_), .b(new_n240_), .c(new_n177_), .O(z46));
  ...
  nor3   g186(.a(new_n343_), .b(new_n260_), .c(new_n240_), .O(z55));
  inv1   g187(.a(x02), .O(new_n346_));
  nand4  g188(.a(x03), .b(new_n346_), .c(new_n153_), .d(x00), .O(new_n347_));
  inv1   g189(.a(new_n347_), .O(z57));
  nand2  g190(.a(new_n226_), .b(new_n158_), .O(new_n350_));
  nand2  g191(.a(new_n350_), .b(new_n229_), .O(new_n351_));
  aoi21  g192(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n352_));
  oai21  g193(.a(new_n352_), .b(new_n228_), .c(new_n153_), .O(new_n353_));
  aoi21  g194(.a(new_n351_), .b(x79), .c(new_n353_), .O(z59));
  aoi22  g195(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n355_));
  aoi21  g196(.a(new_n355_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g197(.a(new_n169_), .O(new_n357_));
  nand2  g198(.a(new_n163_), .b(new_n161_), .O(new_n358_));
  nand2  g199(.a(new_n233_), .b(new_n358_), .O(new_n359_));
  nand3  g200(.a(x78), .b(x77), .c(new_n228_), .O(new_n360_));
  ...
  aoi21  g206(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n366_));
  nand3  g207(.a(x81), .b(x79), .c(new_n228_), .O(new_n367_));
