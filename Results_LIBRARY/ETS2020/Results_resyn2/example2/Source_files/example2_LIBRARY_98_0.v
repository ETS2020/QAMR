...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n190_, new_n193_, new_n194_, new_n198_, new_n199_, new_n201_,
  ...
  nand2  g132(.a(new_n288_), .b(x70), .O(new_n301_));
  inv1   g133(.a(x10), .O(new_n302_));
  nand2  g134(.a(new_n294_), .b(new_n302_), .O(new_n303_));
  inv1   g135(.a(x18), .O(new_n304_));
  nand2  g136(.a(x52), .b(new_n304_), .O(new_n305_));
  nand3  g137(.a(new_n305_), .b(new_n303_), .c(new_n292_), .O(new_n306_));
  aoi21  g138(.a(new_n306_), .b(new_n301_), .c(x01), .O(z50));
  nand2  g139(.a(new_n288_), .b(x71), .O(new_n308_));
  inv1   g140(.a(x11), .O(new_n309_));
  nand2  g141(.a(new_n294_), .b(new_n309_), .O(new_n310_));
  inv1   g142(.a(x19), .O(new_n311_));
  nand2  g143(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g144(.a(new_n312_), .b(new_n310_), .c(new_n292_), .O(new_n313_));
  aoi21  g145(.a(new_n313_), .b(new_n308_), .c(x01), .O(z51));
