...
module FAU ( 
  ...
  nand2  g158(.a(new_n289_), .b(x72), .O(new_n317_));
  inv1   g159(.a(x12), .O(new_n318_));
  nand2  g160(.a(new_n268_), .b(new_n318_), .O(new_n319_));
  inv1   g161(.a(x20), .O(new_n320_));
  nand2  g162(.a(x52), .b(new_n320_), .O(new_n321_));
  nand3  g163(.a(new_n321_), .b(new_n319_), .c(new_n294_), .O(new_n322_));
  aoi21  g164(.a(new_n322_), .b(new_n317_), .c(x01), .O(z52));
  nand2  g165(.a(new_n289_), .b(x73), .O(new_n324_));
  inv1   g166(.a(x13), .O(new_n325_));
  nand2  g167(.a(new_n268_), .b(new_n325_), .O(new_n326_));
  inv1   g168(.a(x21), .O(new_n327_));
  nand2  g169(.a(x52), .b(new_n327_), .O(new_n328_));
  nand3  g170(.a(new_n328_), .b(new_n326_), .c(new_n294_), .O(new_n329_));
  aoi21  g171(.a(new_n329_), .b(new_n324_), .c(x01), .O(z53));
  nor2   g172(.a(x52), .b(x14), .O(new_n331_));
  oai21  g173(.a(new_n268_), .b(x22), .c(new_n153_), .O(new_n332_));
  nor3   g174(.a(new_n332_), .b(new_n331_), .c(new_n293_), .O(z54));
  inv1   g175(.a(x80), .O(new_n334_));
  inv1   g176(.a(x82), .O(new_n335_));
  nand3  g177(.a(x84), .b(new_n335_), .c(new_n334_), .O(new_n336_));
  nor3   g178(.a(new_n336_), .b(new_n259_), .c(new_n240_), .O(z55));
  inv1   g179(.a(x02), .O(new_n339_));
  nand4  g180(.a(x03), .b(new_n339_), .c(new_n153_), .d(x00), .O(new_n340_));
  inv1   g181(.a(new_n340_), .O(z57));
  nand2  g182(.a(new_n226_), .b(new_n158_), .O(new_n343_));
  nand2  g183(.a(new_n343_), .b(new_n229_), .O(new_n344_));
  aoi21  g184(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n345_));
  oai21  g185(.a(new_n345_), .b(new_n228_), .c(new_n153_), .O(new_n346_));
  aoi21  g186(.a(new_n344_), .b(x79), .c(new_n346_), .O(z59));
  aoi22  g187(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n348_));
  aoi21  g188(.a(new_n348_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g189(.a(new_n169_), .O(new_n350_));
  nand2  g190(.a(new_n163_), .b(new_n161_), .O(new_n351_));
  nand2  g191(.a(new_n233_), .b(new_n351_), .O(new_n352_));
  nand3  g192(.a(x78), .b(x77), .c(new_n228_), .O(new_n353_));
  nand2  g193(.a(new_n353_), .b(new_n352_), .O(new_n354_));
  inv1   g194(.a(new_n354_), .O(new_n355_));
  nor3   g195(.a(new_n355_), .b(new_n350_), .c(new_n334_), .O(z61));
  nand3  g196(.a(x84), .b(x81), .c(x79), .O(new_n357_));
  or2    g197(.a(new_n357_), .b(new_n163_), .O(new_n358_));
  aoi21  g198(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n359_));
  nand3  g199(.a(x81), .b(x79), .c(new_n228_), .O(new_n360_));
  nand2  g200(.a(new_n360_), .b(x77), .O(new_n361_));
  nor2   g201(.a(new_n292_), .b(x77), .O(new_n362_));
  aoi21  g202(.a(new_n362_), .b(new_n357_), .c(new_n162_), .O(new_n363_));
  oai21  g203(.a(new_n361_), .b(new_n359_), .c(new_n363_), .O(new_n364_));
  aoi21  g204(.a(new_n364_), .b(new_n358_), .c(x01), .O(z62));
  nor3   g205(.a(new_n355_), .b(new_n350_), .c(new_n335_), .O(z63));
  nand3  g206(.a(new_n354_), .b(x83), .c(x79), .O(new_n367_));
  aoi21  g207(.a(new_n367_), .b(new_n293_), .c(x01), .O(z64));
  nand2  g208(.a(new_n351_), .b(x81), .O(new_n369_));
  nand2  g209(.a(new_n169_), .b(x84), .O(new_n370_));
  aoi21  g210(.a(new_n369_), .b(new_n353_), .c(new_n370_), .O(z65));
  zero   g211(.O(z19));
  zero   g212(.O(z20));
  zero   g213(.O(z24));
  zero   g214(.O(z27));
