...
module FAU ( 
  ...
  nor3   g132(.a(new_n273_), .b(new_n242_), .c(new_n186_), .O(z43));
  nor3   g133(.a(new_n273_), .b(new_n242_), .c(new_n183_), .O(z44));
  nor3   g134(.a(new_n273_), .b(new_n242_), .c(new_n180_), .O(z45));
  nor3   g135(.a(new_n273_), .b(new_n242_), .c(new_n177_), .O(z46));
  nor3   g136(.a(new_n234_), .b(new_n163_), .c(new_n155_), .O(new_n292_));
  oai21  g137(.a(x75), .b(x67), .c(new_n292_), .O(new_n293_));
  inv1   g138(.a(new_n161_), .O(new_n294_));
  nor2   g139(.a(x79), .b(new_n230_), .O(new_n295_));
  ...
  nor3   g189(.a(new_n345_), .b(new_n262_), .c(new_n242_), .O(z55));
  inv1   g190(.a(x02), .O(new_n348_));
  nand4  g191(.a(x03), .b(new_n348_), .c(new_n153_), .d(x00), .O(new_n349_));
  inv1   g192(.a(new_n349_), .O(z57));
  nand2  g193(.a(new_n228_), .b(new_n158_), .O(new_n352_));
  nand2  g194(.a(new_n352_), .b(new_n231_), .O(new_n353_));
  aoi21  g195(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n354_));
  oai21  g196(.a(new_n354_), .b(new_n230_), .c(new_n153_), .O(new_n355_));
  aoi21  g197(.a(new_n353_), .b(x79), .c(new_n355_), .O(z59));
  aoi22  g198(.a(new_n234_), .b(new_n164_), .c(new_n155_), .d(new_n230_), .O(new_n357_));
  aoi21  g199(.a(new_n357_), .b(new_n232_), .c(x01), .O(z60));
  inv1   g200(.a(new_n169_), .O(new_n359_));
  nand2  g201(.a(new_n163_), .b(new_n161_), .O(new_n360_));
  nand2  g202(.a(new_n235_), .b(new_n360_), .O(new_n361_));
  nand3  g203(.a(x78), .b(x77), .c(new_n230_), .O(new_n362_));
  ...
  aoi21  g209(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n368_));
  nand3  g210(.a(x81), .b(x79), .c(new_n230_), .O(new_n369_));
