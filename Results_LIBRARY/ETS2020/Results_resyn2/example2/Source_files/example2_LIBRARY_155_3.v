// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:20 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n290_, new_n292_, new_n294_, new_n296_, new_n299_, new_n301_,
    ...
    new_n374_, new_n376_, new_n377_, new_n378_, new_n381_, new_n383_;
  ...
  nand4  g145(.a(new_n285_), .b(new_n284_), .c(new_n270_), .d(x59), .O(new_n299_));
  inv1   g146(.a(new_n299_), .O(z41));
  nand4  g147(.a(new_n285_), .b(new_n284_), .c(new_n270_), .d(x60), .O(new_n301_));
  inv1   g148(.a(new_n301_), .O(z42));
  nand4  g149(.a(new_n285_), .b(new_n284_), .c(new_n270_), .d(x62), .O(new_n304_));
  inv1   g150(.a(new_n304_), .O(z44));
  nand4  g151(.a(new_n285_), .b(new_n284_), .c(new_n270_), .d(x63), .O(new_n306_));
  inv1   g152(.a(new_n306_), .O(z45));
  nand4  g153(.a(new_n285_), .b(new_n284_), .c(new_n270_), .d(x64), .O(new_n308_));
  inv1   g154(.a(new_n308_), .O(z46));
  nand2  g155(.a(new_n163_), .b(x79), .O(new_n310_));
  nor2   g156(.a(new_n310_), .b(new_n235_), .O(new_n311_));
  oai21  g157(.a(x75), .b(x67), .c(new_n311_), .O(new_n312_));
  nand3  g158(.a(new_n155_), .b(new_n162_), .c(x04), .O(new_n313_));
  inv1   g159(.a(new_n313_), .O(new_n314_));
  inv1   g160(.a(x07), .O(new_n315_));
  inv1   g161(.a(x52), .O(new_n316_));
  nand2  g162(.a(new_n316_), .b(new_n315_), .O(new_n317_));
  inv1   g163(.a(x15), .O(new_n318_));
  nand2  g164(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g165(.a(new_n319_), .b(new_n317_), .c(new_n314_), .O(new_n320_));
  aoi21  g166(.a(new_n320_), .b(new_n312_), .c(x01), .O(z47));
  nand2  g167(.a(new_n311_), .b(x69), .O(new_n323_));
  inv1   g168(.a(x09), .O(new_n324_));
  nand2  g169(.a(new_n316_), .b(new_n324_), .O(new_n325_));
  inv1   g170(.a(x17), .O(new_n326_));
  nand2  g171(.a(x52), .b(new_n326_), .O(new_n327_));
  nand3  g172(.a(new_n327_), .b(new_n325_), .c(new_n314_), .O(new_n328_));
  aoi21  g173(.a(new_n328_), .b(new_n323_), .c(x01), .O(z49));
  nand2  g174(.a(new_n311_), .b(x70), .O(new_n330_));
  inv1   g175(.a(x10), .O(new_n331_));
  nand2  g176(.a(new_n316_), .b(new_n331_), .O(new_n332_));
  inv1   g177(.a(x18), .O(new_n333_));
  nand2  g178(.a(x52), .b(new_n333_), .O(new_n334_));
  nand3  g179(.a(new_n334_), .b(new_n332_), .c(new_n314_), .O(new_n335_));
  aoi21  g180(.a(new_n335_), .b(new_n330_), .c(x01), .O(z50));
  nand2  g181(.a(new_n311_), .b(x71), .O(new_n337_));
  inv1   g182(.a(x11), .O(new_n338_));
  nand2  g183(.a(new_n316_), .b(new_n338_), .O(new_n339_));
  inv1   g184(.a(x19), .O(new_n340_));
  nand2  g185(.a(x52), .b(new_n340_), .O(new_n341_));
  nand3  g186(.a(new_n341_), .b(new_n339_), .c(new_n314_), .O(new_n342_));
  aoi21  g187(.a(new_n342_), .b(new_n337_), .c(x01), .O(z51));
  nor2   g188(.a(x52), .b(x14), .O(new_n346_));
  oai21  g189(.a(new_n316_), .b(x22), .c(new_n153_), .O(new_n347_));
  nor3   g190(.a(new_n347_), .b(new_n346_), .c(new_n313_), .O(z54));
  inv1   g191(.a(x82), .O(new_n349_));
  nand2  g192(.a(x84), .b(new_n349_), .O(new_n350_));
  nor4   g193(.a(new_n272_), .b(new_n252_), .c(new_n350_), .d(x80), .O(z55));
  inv1   g194(.a(new_n235_), .O(new_n352_));
  nor2   g195(.a(new_n352_), .b(new_n164_), .O(new_n353_));
  aoi21  g196(.a(new_n244_), .b(x76), .c(new_n353_), .O(new_n354_));
  aoi21  g197(.a(new_n154_), .b(new_n162_), .c(new_n239_), .O(new_n355_));
  oai21  g198(.a(new_n354_), .b(new_n170_), .c(new_n355_), .O(z56));
  inv1   g199(.a(x02), .O(new_n357_));
  nand3  g200(.a(new_n240_), .b(x03), .c(new_n357_), .O(new_n358_));
  inv1   g201(.a(new_n358_), .O(z57));
  aoi21  g202(.a(x42), .b(x40), .c(new_n232_), .O(new_n360_));
  nand3  g203(.a(new_n360_), .b(new_n230_), .c(x79), .O(new_n361_));
  nand4  g204(.a(new_n170_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n362_));
  nand2  g205(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  nand2  g206(.a(new_n363_), .b(x77), .O(new_n364_));
  inv1   g207(.a(x04), .O(new_n365_));
  oai21  g208(.a(new_n161_), .b(new_n365_), .c(new_n170_), .O(new_n366_));
  aoi21  g209(.a(new_n366_), .b(new_n364_), .c(x01), .O(z58));
  inv1   g210(.a(new_n241_), .O(new_n368_));
  nand2  g211(.a(new_n170_), .b(new_n154_), .O(new_n369_));
  aoi21  g212(.a(new_n369_), .b(new_n232_), .c(new_n158_), .O(new_n370_));
  aoi21  g213(.a(new_n230_), .b(x79), .c(new_n232_), .O(new_n371_));
  oai21  g214(.a(new_n371_), .b(new_n370_), .c(x77), .O(new_n372_));
  aoi21  g215(.a(new_n372_), .b(new_n368_), .c(x01), .O(z59));
  aoi21  g216(.a(new_n353_), .b(x79), .c(new_n241_), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n234_), .c(x01), .O(z60));
  nand2  g218(.a(new_n235_), .b(new_n165_), .O(new_n376_));
  oai21  g219(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n377_));
  nand4  g220(.a(new_n377_), .b(new_n376_), .c(new_n171_), .d(x80), .O(new_n378_));
  inv1   g221(.a(new_n378_), .O(z61));
  nand4  g222(.a(new_n377_), .b(new_n376_), .c(new_n171_), .d(x82), .O(new_n381_));
  inv1   g223(.a(new_n381_), .O(z63));
  nand4  g224(.a(new_n377_), .b(new_n376_), .c(x83), .d(x79), .O(new_n383_));
  aoi21  g225(.a(new_n383_), .b(new_n313_), .c(x01), .O(z64));
  zero   g226(.O(z07));
  zero   g227(.O(z40));
  zero   g228(.O(z43));
  zero   g229(.O(z48));
