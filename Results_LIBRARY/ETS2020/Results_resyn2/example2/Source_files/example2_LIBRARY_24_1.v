...
module FAU ( 
  ...
  oai21  g144(.a(new_n162_), .b(new_n263_), .c(new_n314_), .O(new_n320_));
  inv1   g145(.a(x83), .O(new_n321_));
  nand3  g146(.a(new_n321_), .b(x82), .c(x80), .O(new_n322_));
  inv1   g147(.a(x74), .O(new_n323_));
  nand4  g148(.a(x84), .b(x81), .c(new_n323_), .d(x43), .O(new_n324_));
  oai21  g149(.a(new_n324_), .b(new_n322_), .c(new_n216_), .O(new_n325_));
  nor2   g150(.a(new_n161_), .b(new_n263_), .O(new_n326_));
  nand3  g151(.a(new_n326_), .b(new_n325_), .c(x79), .O(new_n327_));
  nand3  g152(.a(new_n314_), .b(new_n161_), .c(x40), .O(new_n328_));
  nand2  g153(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  aoi21  g154(.a(x42), .b(x40), .c(new_n159_), .O(new_n330_));
  nand2  g155(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  aoi21  g156(.a(new_n331_), .b(new_n320_), .c(x01), .O(z58));
  nand2  g157(.a(new_n325_), .b(new_n156_), .O(new_n333_));
  nand2  g158(.a(new_n333_), .b(new_n326_), .O(new_n334_));
  aoi21  g159(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n335_));
  oai21  g160(.a(new_n335_), .b(new_n263_), .c(new_n153_), .O(new_n336_));
  aoi21  g161(.a(new_n334_), .b(x79), .c(new_n336_), .O(z59));
  nand3  g162(.a(new_n257_), .b(new_n160_), .c(x79), .O(new_n340_));
  aoi21  g163(.a(new_n325_), .b(x79), .c(new_n263_), .O(new_n341_));
  nand3  g164(.a(x81), .b(x79), .c(new_n263_), .O(new_n342_));
  nand2  g165(.a(new_n342_), .b(x77), .O(new_n343_));
  nand2  g166(.a(new_n257_), .b(x79), .O(new_n344_));
  nor2   g167(.a(new_n264_), .b(x77), .O(new_n345_));
  aoi21  g168(.a(new_n345_), .b(new_n344_), .c(new_n161_), .O(new_n346_));
  oai21  g169(.a(new_n343_), .b(new_n341_), .c(new_n346_), .O(new_n347_));
  aoi21  g170(.a(new_n347_), .b(new_n340_), .c(x01), .O(z62));
  nand2  g171(.a(new_n219_), .b(new_n263_), .O(new_n350_));
  oai21  g172(.a(new_n259_), .b(new_n163_), .c(new_n350_), .O(new_n351_));
  nand3  g173(.a(new_n351_), .b(x83), .c(x79), .O(new_n352_));
  aoi21  g174(.a(new_n352_), .b(new_n265_), .c(x01), .O(z64));
  nand2  g175(.a(new_n164_), .b(x81), .O(new_n354_));
  nand3  g176(.a(x84), .b(x79), .c(new_n153_), .O(new_n355_));
  aoi21  g177(.a(new_n354_), .b(new_n350_), .c(new_n355_), .O(z65));
  zero   g178(.O(z02));
  zero   g179(.O(z03));
  zero   g180(.O(z08));
  zero   g181(.O(z09));
