...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n181_, new_n183_, new_n184_, new_n190_, new_n191_, new_n193_,
    ...
    new_n232_, new_n233_, new_n235_, new_n237_, new_n239_, new_n242_,
  ...
  nand3  g077(.a(new_n232_), .b(new_n227_), .c(x49), .O(new_n242_));
  ...
  nand2  g135(.a(new_n285_), .b(x72), .O(new_n306_));
  inv1   g136(.a(x12), .O(new_n307_));
  nand2  g137(.a(new_n291_), .b(new_n307_), .O(new_n308_));
  inv1   g138(.a(x20), .O(new_n309_));
  nand2  g139(.a(x52), .b(new_n309_), .O(new_n310_));
  nand3  g140(.a(new_n310_), .b(new_n308_), .c(new_n289_), .O(new_n311_));
  aoi21  g141(.a(new_n311_), .b(new_n306_), .c(x01), .O(z52));
  nand2  g142(.a(new_n285_), .b(x73), .O(new_n313_));
  inv1   g143(.a(x13), .O(new_n314_));
  nand2  g144(.a(new_n291_), .b(new_n314_), .O(new_n315_));
  inv1   g145(.a(x21), .O(new_n316_));
  nand2  g146(.a(x52), .b(new_n316_), .O(new_n317_));
  nand3  g147(.a(new_n317_), .b(new_n315_), .c(new_n289_), .O(new_n318_));
  aoi21  g148(.a(new_n318_), .b(new_n313_), .c(x01), .O(z53));
  inv1   g149(.a(x82), .O(new_n321_));
  nand2  g150(.a(x84), .b(new_n321_), .O(new_n322_));
  nor4   g151(.a(new_n322_), .b(new_n206_), .c(x81), .d(x80), .O(new_n323_));
  and2   g152(.a(new_n323_), .b(new_n250_), .O(z55));
  oai21  g153(.a(new_n212_), .b(x76), .c(new_n223_), .O(new_n325_));
  aoi21  g154(.a(new_n154_), .b(new_n157_), .c(new_n216_), .O(new_n326_));
  nand2  g155(.a(new_n326_), .b(new_n325_), .O(z56));
  inv1   g156(.a(x02), .O(new_n328_));
  nand3  g157(.a(new_n217_), .b(x03), .c(new_n328_), .O(new_n329_));
  inv1   g158(.a(new_n329_), .O(z57));
  oai21  g159(.a(new_n155_), .b(new_n218_), .c(new_n161_), .O(new_n331_));
  nand2  g160(.a(x78), .b(x04), .O(new_n332_));
  aoi21  g161(.a(x42), .b(x40), .c(new_n332_), .O(new_n333_));
  nand3  g162(.a(new_n333_), .b(new_n208_), .c(x79), .O(new_n334_));
  nand4  g163(.a(new_n161_), .b(new_n154_), .c(new_n203_), .d(x40), .O(new_n335_));
  nand2  g164(.a(new_n335_), .b(new_n334_), .O(new_n336_));
  nand2  g165(.a(new_n336_), .b(x77), .O(new_n337_));
  aoi21  g166(.a(new_n337_), .b(new_n331_), .c(x01), .O(z58));
  nor2   g167(.a(new_n158_), .b(new_n155_), .O(new_n340_));
  inv1   g168(.a(new_n340_), .O(new_n341_));
  nor2   g169(.a(new_n287_), .b(new_n213_), .O(new_n342_));
  oai21  g170(.a(new_n341_), .b(new_n161_), .c(new_n342_), .O(new_n343_));
  aoi21  g171(.a(new_n343_), .b(new_n210_), .c(x01), .O(z60));
  nand2  g172(.a(new_n222_), .b(new_n218_), .O(new_n345_));
  oai21  g173(.a(new_n340_), .b(new_n212_), .c(new_n345_), .O(new_n346_));
  nand3  g174(.a(new_n346_), .b(new_n162_), .c(x80), .O(new_n347_));
  inv1   g175(.a(new_n347_), .O(z61));
  nand3  g176(.a(x84), .b(x81), .c(x79), .O(new_n349_));
  inv1   g177(.a(new_n349_), .O(new_n350_));
  nand2  g178(.a(new_n350_), .b(new_n158_), .O(new_n351_));
  aoi21  g179(.a(new_n208_), .b(x79), .c(new_n218_), .O(new_n352_));
  nand3  g180(.a(x81), .b(x79), .c(new_n218_), .O(new_n353_));
  nand2  g181(.a(new_n353_), .b(x77), .O(new_n354_));
  nor2   g182(.a(new_n287_), .b(x77), .O(new_n355_));
  aoi21  g183(.a(new_n355_), .b(new_n349_), .c(new_n154_), .O(new_n356_));
  oai21  g184(.a(new_n354_), .b(new_n352_), .c(new_n356_), .O(new_n357_));
  aoi21  g185(.a(new_n357_), .b(new_n351_), .c(x01), .O(z62));
  nand3  g186(.a(new_n346_), .b(new_n162_), .c(x82), .O(new_n359_));
  inv1   g187(.a(new_n359_), .O(z63));
  nand2  g188(.a(new_n341_), .b(x81), .O(new_n362_));
  nand2  g189(.a(new_n162_), .b(x84), .O(new_n363_));
  aoi21  g190(.a(new_n362_), .b(new_n345_), .c(new_n363_), .O(z65));
  zero   g191(.O(z00));
  zero   g192(.O(z01));
  zero   g193(.O(z04));
  zero   g194(.O(z05));
