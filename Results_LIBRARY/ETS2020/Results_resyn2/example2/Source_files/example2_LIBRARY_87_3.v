...
module FAU ( 
  ...
  nand2  g174(.a(new_n307_), .b(x71), .O(new_n333_));
  inv1   g175(.a(x11), .O(new_n334_));
  nand2  g176(.a(new_n312_), .b(new_n334_), .O(new_n335_));
  inv1   g177(.a(x19), .O(new_n336_));
  nand2  g178(.a(x52), .b(new_n336_), .O(new_n337_));
  nand3  g179(.a(new_n337_), .b(new_n335_), .c(new_n310_), .O(new_n338_));
  aoi21  g180(.a(new_n338_), .b(new_n333_), .c(x01), .O(z51));
  nor2   g181(.a(x52), .b(x14), .O(new_n342_));
  oai21  g182(.a(new_n312_), .b(x22), .c(new_n153_), .O(new_n343_));
  nor3   g183(.a(new_n343_), .b(new_n342_), .c(new_n309_), .O(z54));
  inv1   g184(.a(x82), .O(new_n345_));
  nand2  g185(.a(x84), .b(new_n345_), .O(new_n346_));
  nor4   g186(.a(new_n269_), .b(new_n250_), .c(new_n346_), .d(x80), .O(z55));
  inv1   g187(.a(new_n233_), .O(new_n348_));
  nor2   g188(.a(new_n348_), .b(new_n164_), .O(new_n349_));
  aoi21  g189(.a(new_n242_), .b(x76), .c(new_n349_), .O(new_n350_));
  aoi21  g190(.a(new_n154_), .b(new_n162_), .c(new_n237_), .O(new_n351_));
  oai21  g191(.a(new_n350_), .b(new_n170_), .c(new_n351_), .O(z56));
  inv1   g192(.a(x02), .O(new_n353_));
  nand3  g193(.a(new_n238_), .b(x03), .c(new_n353_), .O(new_n354_));
  inv1   g194(.a(new_n354_), .O(z57));
  aoi21  g195(.a(x42), .b(x40), .c(new_n230_), .O(new_n356_));
  nand3  g196(.a(new_n356_), .b(new_n228_), .c(x79), .O(new_n357_));
  nand4  g197(.a(new_n170_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n358_));
  nand2  g198(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  nand2  g199(.a(new_n359_), .b(x77), .O(new_n360_));
  inv1   g200(.a(x04), .O(new_n361_));
  oai21  g201(.a(new_n161_), .b(new_n361_), .c(new_n170_), .O(new_n362_));
  aoi21  g202(.a(new_n362_), .b(new_n360_), .c(x01), .O(z58));
  inv1   g203(.a(new_n239_), .O(new_n364_));
  nand2  g204(.a(new_n170_), .b(new_n154_), .O(new_n365_));
  aoi21  g205(.a(new_n365_), .b(new_n230_), .c(new_n158_), .O(new_n366_));
  aoi21  g206(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n367_));
  oai21  g207(.a(new_n367_), .b(new_n366_), .c(x77), .O(new_n368_));
  aoi21  g208(.a(new_n368_), .b(new_n364_), .c(x01), .O(z59));
  aoi21  g209(.a(new_n349_), .b(x79), .c(new_n239_), .O(new_n370_));
  aoi21  g210(.a(new_n370_), .b(new_n232_), .c(x01), .O(z60));
  nand2  g211(.a(new_n233_), .b(new_n165_), .O(new_n372_));
  oai21  g212(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n373_));
  nand4  g213(.a(new_n373_), .b(new_n372_), .c(new_n171_), .d(x80), .O(new_n374_));
  inv1   g214(.a(new_n374_), .O(z61));
  nand4  g215(.a(new_n373_), .b(new_n372_), .c(new_n171_), .d(x82), .O(new_n377_));
  inv1   g216(.a(new_n377_), .O(z63));
  nand4  g217(.a(new_n373_), .b(new_n372_), .c(x83), .d(x79), .O(new_n379_));
  aoi21  g218(.a(new_n379_), .b(new_n309_), .c(x01), .O(z64));
  zero   g219(.O(z07));
  zero   g220(.O(z19));
  zero   g221(.O(z27));
  zero   g222(.O(z40));
