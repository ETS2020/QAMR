...
module FAU ( 
  ...
  nand2  g112(.a(new_n263_), .b(x70), .O(new_n284_));
  inv1   g113(.a(x10), .O(new_n285_));
  nand2  g114(.a(new_n270_), .b(new_n285_), .O(new_n286_));
  inv1   g115(.a(x18), .O(new_n287_));
  nand2  g116(.a(x52), .b(new_n287_), .O(new_n288_));
  nand3  g117(.a(new_n288_), .b(new_n286_), .c(new_n268_), .O(new_n289_));
  aoi21  g118(.a(new_n289_), .b(new_n284_), .c(x01), .O(z50));
  ...
  aoi22  g141(.a(new_n261_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n315_));
  ...
  oai21  g145(.a(new_n162_), .b(new_n265_), .c(new_n314_), .O(new_n320_));
  ...
  nor2   g151(.a(new_n161_), .b(new_n265_), .O(new_n326_));
  ...
  oai21  g161(.a(new_n335_), .b(new_n265_), .c(new_n153_), .O(new_n336_));
  aoi21  g162(.a(new_n334_), .b(x79), .c(new_n336_), .O(z59));
  nand3  g163(.a(new_n259_), .b(new_n160_), .c(x79), .O(new_n340_));
  aoi21  g164(.a(new_n325_), .b(x79), .c(new_n265_), .O(new_n341_));
  nand3  g165(.a(x81), .b(x79), .c(new_n265_), .O(new_n342_));
  nand2  g166(.a(new_n342_), .b(x77), .O(new_n343_));
  nand2  g167(.a(new_n259_), .b(x79), .O(new_n344_));
  nor2   g168(.a(new_n266_), .b(x77), .O(new_n345_));
  ...
  nand2  g172(.a(new_n219_), .b(new_n265_), .O(new_n350_));
  oai21  g173(.a(new_n261_), .b(new_n163_), .c(new_n350_), .O(new_n351_));
  nand3  g174(.a(new_n351_), .b(x83), .c(x79), .O(new_n352_));
  aoi21  g175(.a(new_n352_), .b(new_n267_), .c(x01), .O(z64));
