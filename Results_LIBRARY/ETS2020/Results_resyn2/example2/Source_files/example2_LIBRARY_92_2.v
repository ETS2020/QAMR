...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n271_, new_n273_, new_n274_, new_n276_, new_n279_,
    ...
    new_n338_, new_n340_, new_n341_, new_n342_, new_n347_, new_n348_,
  ...
  nand2  g122(.a(new_n273_), .b(x56), .O(new_n279_));
  nor2   g123(.a(new_n279_), .b(new_n271_), .O(z38));
  nor3   g124(.a(new_n271_), .b(new_n240_), .c(new_n196_), .O(z39));
  nor3   g125(.a(new_n271_), .b(new_n240_), .c(new_n193_), .O(z40));
  nor3   g126(.a(new_n271_), .b(new_n240_), .c(new_n190_), .O(z41));
  nor3   g127(.a(new_n271_), .b(new_n240_), .c(new_n187_), .O(z42));
  nor3   g128(.a(new_n271_), .b(new_n240_), .c(new_n184_), .O(z43));
  nor3   g129(.a(new_n271_), .b(new_n240_), .c(new_n181_), .O(z44));
  nor3   g130(.a(new_n271_), .b(new_n240_), .c(new_n178_), .O(z45));
  nor3   g131(.a(new_n271_), .b(new_n240_), .c(new_n175_), .O(z46));
  ...
  nand2  g153(.a(new_n269_), .b(new_n309_), .O(new_n310_));
  ...
  nand2  g160(.a(new_n269_), .b(new_n316_), .O(new_n317_));
  ...
  nand2  g165(.a(new_n289_), .b(x72), .O(new_n323_));
  inv1   g166(.a(x12), .O(new_n324_));
  nand2  g167(.a(new_n269_), .b(new_n324_), .O(new_n325_));
  inv1   g168(.a(x20), .O(new_n326_));
  nand2  g169(.a(x52), .b(new_n326_), .O(new_n327_));
  nand3  g170(.a(new_n327_), .b(new_n325_), .c(new_n294_), .O(new_n328_));
  aoi21  g171(.a(new_n328_), .b(new_n323_), .c(x01), .O(z52));
  nand2  g172(.a(new_n289_), .b(x73), .O(new_n330_));
  inv1   g173(.a(x13), .O(new_n331_));
  nand2  g174(.a(new_n269_), .b(new_n331_), .O(new_n332_));
  inv1   g175(.a(x21), .O(new_n333_));
  nand2  g176(.a(x52), .b(new_n333_), .O(new_n334_));
  nand3  g177(.a(new_n334_), .b(new_n332_), .c(new_n294_), .O(new_n335_));
  aoi21  g178(.a(new_n335_), .b(new_n330_), .c(x01), .O(z53));
  nor2   g179(.a(x52), .b(x14), .O(new_n337_));
  oai21  g180(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n338_));
  nor3   g181(.a(new_n338_), .b(new_n337_), .c(new_n293_), .O(z54));
  inv1   g182(.a(x80), .O(new_n340_));
  inv1   g183(.a(x82), .O(new_n341_));
  nand3  g184(.a(x84), .b(new_n341_), .c(new_n340_), .O(new_n342_));
  nor3   g185(.a(new_n342_), .b(new_n260_), .c(new_n240_), .O(z55));
  nand2  g186(.a(new_n226_), .b(new_n158_), .O(new_n347_));
  nand2  g187(.a(new_n347_), .b(new_n229_), .O(new_n348_));
  aoi21  g188(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n349_));
  oai21  g189(.a(new_n349_), .b(new_n228_), .c(new_n153_), .O(new_n350_));
  aoi21  g190(.a(new_n348_), .b(x79), .c(new_n350_), .O(z59));
  aoi22  g191(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n352_));
  aoi21  g192(.a(new_n352_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g193(.a(new_n169_), .O(new_n354_));
  nand2  g194(.a(new_n163_), .b(new_n161_), .O(new_n355_));
  nand2  g195(.a(new_n233_), .b(new_n355_), .O(new_n356_));
  nand3  g196(.a(x78), .b(x77), .c(new_n228_), .O(new_n357_));
  nand2  g197(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  inv1   g198(.a(new_n358_), .O(new_n359_));
  nor3   g199(.a(new_n359_), .b(new_n354_), .c(new_n340_), .O(z61));
  nand3  g200(.a(x84), .b(x81), .c(x79), .O(new_n361_));
  or2    g201(.a(new_n361_), .b(new_n163_), .O(new_n362_));
  aoi21  g202(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n363_));
  nand3  g203(.a(x81), .b(x79), .c(new_n228_), .O(new_n364_));
  nand2  g204(.a(new_n364_), .b(x77), .O(new_n365_));
  nor2   g205(.a(new_n292_), .b(x77), .O(new_n366_));
  ...
  nor3   g209(.a(new_n359_), .b(new_n354_), .c(new_n341_), .O(z63));
  nand3  g210(.a(new_n358_), .b(x83), .c(x79), .O(new_n371_));
  aoi21  g211(.a(new_n371_), .b(new_n293_), .c(x01), .O(z64));
