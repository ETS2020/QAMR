...
module FAU ( 
  ...
  aoi22  g126(.a(new_n260_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n302_));
  ...
  oai21  g130(.a(new_n162_), .b(new_n264_), .c(new_n301_), .O(new_n307_));
  ...
  oai21  g135(.a(new_n311_), .b(new_n309_), .c(new_n214_), .O(new_n312_));
  nor2   g136(.a(new_n161_), .b(new_n264_), .O(new_n313_));
  ...
  oai21  g146(.a(new_n322_), .b(new_n264_), .c(new_n153_), .O(new_n323_));
  aoi21  g147(.a(new_n321_), .b(x79), .c(new_n323_), .O(z59));
  nand3  g148(.a(new_n258_), .b(new_n160_), .c(x79), .O(new_n327_));
  aoi21  g149(.a(new_n312_), .b(x79), .c(new_n264_), .O(new_n328_));
  nand3  g150(.a(x81), .b(x79), .c(new_n264_), .O(new_n329_));
  nand2  g151(.a(new_n329_), .b(x77), .O(new_n330_));
  nand2  g152(.a(new_n258_), .b(x79), .O(new_n331_));
  nor2   g153(.a(new_n265_), .b(x77), .O(new_n332_));
  ...
  nand2  g157(.a(new_n217_), .b(new_n264_), .O(new_n337_));
  oai21  g158(.a(new_n260_), .b(new_n163_), .c(new_n337_), .O(new_n338_));
  nand3  g159(.a(new_n338_), .b(x83), .c(x79), .O(new_n339_));
  aoi21  g160(.a(new_n339_), .b(new_n266_), .c(x01), .O(z64));
