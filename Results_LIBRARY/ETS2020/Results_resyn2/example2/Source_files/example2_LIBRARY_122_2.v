...
module FAU ( 
  ...
  nand2  g159(.a(new_n290_), .b(x71), .O(new_n317_));
  inv1   g160(.a(x11), .O(new_n318_));
  nand2  g161(.a(new_n269_), .b(new_n318_), .O(new_n319_));
  inv1   g162(.a(x19), .O(new_n320_));
  nand2  g163(.a(x52), .b(new_n320_), .O(new_n321_));
  nand3  g164(.a(new_n321_), .b(new_n319_), .c(new_n295_), .O(new_n322_));
  aoi21  g165(.a(new_n322_), .b(new_n317_), .c(x01), .O(z51));
