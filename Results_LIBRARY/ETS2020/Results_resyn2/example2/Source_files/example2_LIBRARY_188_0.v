...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n232_, new_n233_, new_n234_, new_n235_, new_n237_, new_n242_,
  ...
  nand3  g076(.a(new_n234_), .b(new_n229_), .c(x49), .O(new_n242_));
  ...
  nor2   g162(.a(x52), .b(x14), .O(new_n332_));
  oai21  g163(.a(new_n291_), .b(x22), .c(new_n164_), .O(new_n333_));
  nor3   g164(.a(new_n333_), .b(new_n332_), .c(new_n288_), .O(z54));
  inv1   g165(.a(x82), .O(new_n335_));
  nand2  g166(.a(x84), .b(new_n335_), .O(new_n336_));
  nor4   g167(.a(new_n336_), .b(new_n208_), .c(x81), .d(x80), .O(new_n337_));
  and2   g168(.a(new_n337_), .b(new_n250_), .O(z55));
  oai21  g169(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n339_));
  aoi21  g170(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n339_), .O(z56));
  inv1   g172(.a(x02), .O(new_n342_));
  nand3  g173(.a(new_n219_), .b(x03), .c(new_n342_), .O(new_n343_));
  inv1   g174(.a(new_n343_), .O(z57));
  oai21  g175(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n345_));
  nand2  g176(.a(x78), .b(x04), .O(new_n346_));
  aoi21  g177(.a(x42), .b(x40), .c(new_n346_), .O(new_n347_));
  nand3  g178(.a(new_n347_), .b(new_n210_), .c(x79), .O(new_n348_));
  nand4  g179(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n349_));
  ...
  nor2   g185(.a(new_n287_), .b(new_n215_), .O(new_n356_));
  oai21  g186(.a(new_n355_), .b(new_n161_), .c(new_n356_), .O(new_n357_));
  aoi21  g187(.a(new_n357_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g188(.a(new_n224_), .b(new_n220_), .O(new_n359_));
  oai21  g189(.a(new_n354_), .b(new_n214_), .c(new_n359_), .O(new_n360_));
  ...
  aoi21  g195(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n366_));
  nand3  g196(.a(x81), .b(x79), .c(new_n220_), .O(new_n367_));
  nand2  g197(.a(new_n367_), .b(x77), .O(new_n368_));
  nor2   g198(.a(new_n287_), .b(x77), .O(new_n369_));
