...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n370_, new_n371_, new_n372_, new_n373_, new_n375_, new_n378_,
    new_n379_;
  ...
  nor2   g166(.a(x52), .b(x14), .O(new_n334_));
  oai21  g167(.a(new_n293_), .b(x22), .c(new_n164_), .O(new_n335_));
  nor3   g168(.a(new_n335_), .b(new_n334_), .c(new_n290_), .O(z54));
  inv1   g169(.a(x82), .O(new_n337_));
  nand2  g170(.a(x84), .b(new_n337_), .O(new_n338_));
  nor4   g171(.a(new_n338_), .b(new_n208_), .c(x81), .d(x80), .O(new_n339_));
  and2   g172(.a(new_n339_), .b(new_n252_), .O(z55));
  oai21  g173(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n341_));
  aoi21  g174(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n342_));
  nand2  g175(.a(new_n342_), .b(new_n341_), .O(z56));
  inv1   g176(.a(x02), .O(new_n344_));
  nand3  g177(.a(new_n219_), .b(x03), .c(new_n344_), .O(new_n345_));
  inv1   g178(.a(new_n345_), .O(z57));
  oai21  g179(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n347_));
  nand2  g180(.a(x78), .b(x04), .O(new_n348_));
  aoi21  g181(.a(x42), .b(x40), .c(new_n348_), .O(new_n349_));
  nand3  g182(.a(new_n349_), .b(new_n210_), .c(x79), .O(new_n350_));
  nand4  g183(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n351_));
  nand2  g184(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  nand2  g185(.a(new_n352_), .b(x77), .O(new_n353_));
  aoi21  g186(.a(new_n353_), .b(new_n347_), .c(x01), .O(z58));
  nor2   g187(.a(new_n158_), .b(new_n155_), .O(new_n356_));
  inv1   g188(.a(new_n356_), .O(new_n357_));
  nor2   g189(.a(new_n289_), .b(new_n215_), .O(new_n358_));
  oai21  g190(.a(new_n357_), .b(new_n161_), .c(new_n358_), .O(new_n359_));
  aoi21  g191(.a(new_n359_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g192(.a(new_n224_), .b(new_n220_), .O(new_n361_));
  oai21  g193(.a(new_n356_), .b(new_n214_), .c(new_n361_), .O(new_n362_));
  nand3  g194(.a(new_n362_), .b(new_n162_), .c(x80), .O(new_n363_));
  inv1   g195(.a(new_n363_), .O(z61));
  nand3  g196(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  inv1   g197(.a(new_n365_), .O(new_n366_));
  nand2  g198(.a(new_n366_), .b(new_n158_), .O(new_n367_));
  aoi21  g199(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n368_));
  nand3  g200(.a(x81), .b(x79), .c(new_n220_), .O(new_n369_));
  nand2  g201(.a(new_n369_), .b(x77), .O(new_n370_));
  nor2   g202(.a(new_n289_), .b(x77), .O(new_n371_));
  aoi21  g203(.a(new_n371_), .b(new_n365_), .c(new_n154_), .O(new_n372_));
  oai21  g204(.a(new_n370_), .b(new_n368_), .c(new_n372_), .O(new_n373_));
  aoi21  g205(.a(new_n373_), .b(new_n367_), .c(x01), .O(z62));
  nand3  g206(.a(new_n362_), .b(new_n162_), .c(x82), .O(new_n375_));
  inv1   g207(.a(new_n375_), .O(z63));
  nand2  g208(.a(new_n357_), .b(x81), .O(new_n378_));
  nand2  g209(.a(new_n162_), .b(x84), .O(new_n379_));
  aoi21  g210(.a(new_n378_), .b(new_n361_), .c(new_n379_), .O(z65));
  zero   g211(.O(z00));
  zero   g212(.O(z01));
  zero   g213(.O(z04));
  zero   g214(.O(z06));
