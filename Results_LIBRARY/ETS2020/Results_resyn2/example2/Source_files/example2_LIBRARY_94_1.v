...
module FAU ( 
  ...
  aoi22  g136(.a(new_n261_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n311_));
  ...
  oai21  g140(.a(new_n162_), .b(new_n265_), .c(new_n310_), .O(new_n316_));
  inv1   g141(.a(x83), .O(new_n317_));
  nand3  g142(.a(new_n317_), .b(x82), .c(x80), .O(new_n318_));
  inv1   g143(.a(x74), .O(new_n319_));
  nand4  g144(.a(x84), .b(x81), .c(new_n319_), .d(x43), .O(new_n320_));
  oai21  g145(.a(new_n320_), .b(new_n318_), .c(new_n218_), .O(new_n321_));
  nor2   g146(.a(new_n161_), .b(new_n265_), .O(new_n322_));
  nand3  g147(.a(new_n322_), .b(new_n321_), .c(x79), .O(new_n323_));
  nand3  g148(.a(new_n310_), .b(new_n161_), .c(x40), .O(new_n324_));
  nand2  g149(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  aoi21  g150(.a(x42), .b(x40), .c(new_n159_), .O(new_n326_));
  nand2  g151(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  aoi21  g152(.a(new_n327_), .b(new_n316_), .c(x01), .O(z58));
  nand2  g153(.a(new_n321_), .b(new_n156_), .O(new_n329_));
  nand2  g154(.a(new_n329_), .b(new_n322_), .O(new_n330_));
  aoi21  g155(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n331_));
  oai21  g156(.a(new_n331_), .b(new_n265_), .c(new_n153_), .O(new_n332_));
  aoi21  g157(.a(new_n330_), .b(x79), .c(new_n332_), .O(z59));
  nand3  g158(.a(new_n259_), .b(new_n160_), .c(x79), .O(new_n336_));
  aoi21  g159(.a(new_n321_), .b(x79), .c(new_n265_), .O(new_n337_));
  nand3  g160(.a(x81), .b(x79), .c(new_n265_), .O(new_n338_));
  nand2  g161(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g162(.a(new_n259_), .b(x79), .O(new_n340_));
  nor2   g163(.a(new_n266_), .b(x77), .O(new_n341_));
  aoi21  g164(.a(new_n341_), .b(new_n340_), .c(new_n161_), .O(new_n342_));
  oai21  g165(.a(new_n339_), .b(new_n337_), .c(new_n342_), .O(new_n343_));
  aoi21  g166(.a(new_n343_), .b(new_n336_), .c(x01), .O(z62));
  nand2  g167(.a(new_n221_), .b(new_n265_), .O(new_n346_));
  oai21  g168(.a(new_n261_), .b(new_n163_), .c(new_n346_), .O(new_n347_));
  nand3  g169(.a(new_n347_), .b(x83), .c(x79), .O(new_n348_));
  aoi21  g170(.a(new_n348_), .b(new_n267_), .c(x01), .O(z64));
  nand2  g171(.a(new_n164_), .b(x81), .O(new_n350_));
  nand3  g172(.a(x84), .b(x79), .c(new_n153_), .O(new_n351_));
  aoi21  g173(.a(new_n350_), .b(new_n346_), .c(new_n351_), .O(z65));
  zero   g174(.O(z02));
  zero   g175(.O(z03));
  zero   g176(.O(z05));
  zero   g177(.O(z08));
