...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n240_, new_n244_, new_n246_, new_n248_, new_n249_, new_n250_,
  ...
  nand3  g079(.a(new_n237_), .b(new_n232_), .c(x49), .O(new_n244_));
  inv1   g080(.a(new_n244_), .O(z31));
  nand3  g081(.a(new_n237_), .b(new_n232_), .c(x50), .O(new_n246_));
  ...
  nand3  g086(.a(new_n233_), .b(x51), .c(new_n207_), .O(new_n251_));
  nand3  g087(.a(new_n251_), .b(new_n250_), .c(new_n234_), .O(new_n252_));
  nor2   g088(.a(new_n236_), .b(new_n228_), .O(new_n253_));
  ...
  inv1   g095(.a(new_n235_), .O(new_n262_));
  nand3  g096(.a(new_n262_), .b(x83), .c(x42), .O(new_n263_));
  oai21  g097(.a(new_n210_), .b(new_n207_), .c(new_n235_), .O(new_n264_));
