...
module FAU ( 
  ...
  nand2  g114(.a(new_n268_), .b(x56), .O(new_n274_));
  nor2   g115(.a(new_n274_), .b(new_n266_), .O(z38));
  nor3   g116(.a(new_n266_), .b(new_n236_), .c(new_n196_), .O(z39));
  nor3   g117(.a(new_n266_), .b(new_n236_), .c(new_n193_), .O(z40));
  nor3   g118(.a(new_n266_), .b(new_n236_), .c(new_n190_), .O(z41));
  nor3   g119(.a(new_n266_), .b(new_n236_), .c(new_n187_), .O(z42));
  nor3   g120(.a(new_n266_), .b(new_n236_), .c(new_n184_), .O(z43));
  nor3   g121(.a(new_n266_), .b(new_n236_), .c(new_n181_), .O(z44));
  nor3   g122(.a(new_n266_), .b(new_n236_), .c(new_n178_), .O(z45));
  nor3   g123(.a(new_n266_), .b(new_n236_), .c(new_n175_), .O(z46));
  nor3   g124(.a(new_n228_), .b(new_n163_), .c(new_n155_), .O(new_n284_));
  oai21  g125(.a(x75), .b(x67), .c(new_n284_), .O(new_n285_));
  inv1   g126(.a(new_n161_), .O(new_n286_));
  nor2   g127(.a(x79), .b(new_n224_), .O(new_n287_));
  nand2  g128(.a(new_n287_), .b(new_n286_), .O(new_n288_));
  inv1   g129(.a(new_n288_), .O(new_n289_));
  inv1   g130(.a(x07), .O(new_n290_));
  nand2  g131(.a(new_n264_), .b(new_n290_), .O(new_n291_));
  inv1   g132(.a(x15), .O(new_n292_));
  nand2  g133(.a(x52), .b(new_n292_), .O(new_n293_));
  nand3  g134(.a(new_n293_), .b(new_n291_), .c(new_n289_), .O(new_n294_));
  aoi21  g135(.a(new_n294_), .b(new_n285_), .c(x01), .O(z47));
  nand2  g136(.a(new_n284_), .b(x68), .O(new_n296_));
  inv1   g137(.a(x08), .O(new_n297_));
  nand2  g138(.a(new_n264_), .b(new_n297_), .O(new_n298_));
  inv1   g139(.a(x16), .O(new_n299_));
  nand2  g140(.a(x52), .b(new_n299_), .O(new_n300_));
  nand3  g141(.a(new_n300_), .b(new_n298_), .c(new_n289_), .O(new_n301_));
  aoi21  g142(.a(new_n301_), .b(new_n296_), .c(x01), .O(z48));
  nand2  g143(.a(new_n284_), .b(x70), .O(new_n304_));
  inv1   g144(.a(x10), .O(new_n305_));
  nand2  g145(.a(new_n264_), .b(new_n305_), .O(new_n306_));
  inv1   g146(.a(x18), .O(new_n307_));
  nand2  g147(.a(x52), .b(new_n307_), .O(new_n308_));
  nand3  g148(.a(new_n308_), .b(new_n306_), .c(new_n289_), .O(new_n309_));
  aoi21  g149(.a(new_n309_), .b(new_n304_), .c(x01), .O(z50));
  nand2  g150(.a(new_n284_), .b(x71), .O(new_n311_));
  inv1   g151(.a(x11), .O(new_n312_));
  nand2  g152(.a(new_n264_), .b(new_n312_), .O(new_n313_));
  inv1   g153(.a(x19), .O(new_n314_));
  nand2  g154(.a(x52), .b(new_n314_), .O(new_n315_));
  nand3  g155(.a(new_n315_), .b(new_n313_), .c(new_n289_), .O(new_n316_));
  aoi21  g156(.a(new_n316_), .b(new_n311_), .c(x01), .O(z51));
  nand2  g157(.a(new_n284_), .b(x72), .O(new_n318_));
  inv1   g158(.a(x12), .O(new_n319_));
  nand2  g159(.a(new_n264_), .b(new_n319_), .O(new_n320_));
  inv1   g160(.a(x20), .O(new_n321_));
  nand2  g161(.a(x52), .b(new_n321_), .O(new_n322_));
  nand3  g162(.a(new_n322_), .b(new_n320_), .c(new_n289_), .O(new_n323_));
  aoi21  g163(.a(new_n323_), .b(new_n318_), .c(x01), .O(z52));
  nand2  g164(.a(new_n284_), .b(x73), .O(new_n325_));
  inv1   g165(.a(x13), .O(new_n326_));
  nand2  g166(.a(new_n264_), .b(new_n326_), .O(new_n327_));
  inv1   g167(.a(x21), .O(new_n328_));
  nand2  g168(.a(x52), .b(new_n328_), .O(new_n329_));
  nand3  g169(.a(new_n329_), .b(new_n327_), .c(new_n289_), .O(new_n330_));
  aoi21  g170(.a(new_n330_), .b(new_n325_), .c(x01), .O(z53));
  nor2   g171(.a(x52), .b(x14), .O(new_n332_));
  oai21  g172(.a(new_n264_), .b(x22), .c(new_n153_), .O(new_n333_));
  nor3   g173(.a(new_n333_), .b(new_n332_), .c(new_n288_), .O(z54));
  inv1   g174(.a(x80), .O(new_n335_));
  inv1   g175(.a(x82), .O(new_n336_));
  nand3  g176(.a(x84), .b(new_n336_), .c(new_n335_), .O(new_n337_));
  nor3   g177(.a(new_n337_), .b(new_n255_), .c(new_n236_), .O(z55));
  inv1   g178(.a(x02), .O(new_n340_));
  nand4  g179(.a(x03), .b(new_n340_), .c(new_n153_), .d(x00), .O(new_n341_));
  inv1   g180(.a(new_n341_), .O(z57));
  nand2  g181(.a(new_n222_), .b(new_n158_), .O(new_n344_));
  nand2  g182(.a(new_n344_), .b(new_n225_), .O(new_n345_));
  aoi21  g183(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n346_));
  oai21  g184(.a(new_n346_), .b(new_n224_), .c(new_n153_), .O(new_n347_));
  aoi21  g185(.a(new_n345_), .b(x79), .c(new_n347_), .O(z59));
  aoi22  g186(.a(new_n228_), .b(new_n164_), .c(new_n155_), .d(new_n224_), .O(new_n349_));
  aoi21  g187(.a(new_n349_), .b(new_n226_), .c(x01), .O(z60));
  inv1   g188(.a(new_n169_), .O(new_n351_));
  nand2  g189(.a(new_n163_), .b(new_n161_), .O(new_n352_));
  nand2  g190(.a(new_n229_), .b(new_n352_), .O(new_n353_));
  nand3  g191(.a(x78), .b(x77), .c(new_n224_), .O(new_n354_));
  ...
  aoi21  g197(.a(new_n222_), .b(x79), .c(new_n224_), .O(new_n360_));
  nand3  g198(.a(x81), .b(x79), .c(new_n224_), .O(new_n361_));
  nand2  g199(.a(new_n361_), .b(x77), .O(new_n362_));
  nor2   g200(.a(new_n287_), .b(x77), .O(new_n363_));
  ...
  aoi21  g206(.a(new_n368_), .b(new_n288_), .c(x01), .O(z64));
