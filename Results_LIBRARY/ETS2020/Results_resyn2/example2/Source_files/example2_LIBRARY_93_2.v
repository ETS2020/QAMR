...
module FAU ( 
  ...
  nand2  g167(.a(new_n290_), .b(x73), .O(new_n325_));
  inv1   g168(.a(x13), .O(new_n326_));
  nand2  g169(.a(new_n269_), .b(new_n326_), .O(new_n327_));
  inv1   g170(.a(x21), .O(new_n328_));
  nand2  g171(.a(x52), .b(new_n328_), .O(new_n329_));
  nand3  g172(.a(new_n329_), .b(new_n327_), .c(new_n295_), .O(new_n330_));
  aoi21  g173(.a(new_n330_), .b(new_n325_), .c(x01), .O(z53));
