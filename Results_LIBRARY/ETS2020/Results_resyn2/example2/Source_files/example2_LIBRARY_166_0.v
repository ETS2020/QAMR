...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n178_, new_n180_, new_n181_, new_n183_, new_n184_, new_n188_,
    new_n189_, new_n192_, new_n193_, new_n197_, new_n198_, new_n200_,
  ...
  nand2  g135(.a(new_n290_), .b(x69), .O(new_n302_));
  inv1   g136(.a(x09), .O(new_n303_));
  nand2  g137(.a(new_n296_), .b(new_n303_), .O(new_n304_));
  inv1   g138(.a(x17), .O(new_n305_));
  nand2  g139(.a(x52), .b(new_n305_), .O(new_n306_));
  nand3  g140(.a(new_n306_), .b(new_n304_), .c(new_n294_), .O(new_n307_));
  aoi21  g141(.a(new_n307_), .b(new_n302_), .c(x01), .O(z49));
  nand2  g142(.a(new_n290_), .b(x70), .O(new_n309_));
  inv1   g143(.a(x10), .O(new_n310_));
  nand2  g144(.a(new_n296_), .b(new_n310_), .O(new_n311_));
  inv1   g145(.a(x18), .O(new_n312_));
  nand2  g146(.a(x52), .b(new_n312_), .O(new_n313_));
  nand3  g147(.a(new_n313_), .b(new_n311_), .c(new_n294_), .O(new_n314_));
  aoi21  g148(.a(new_n314_), .b(new_n309_), .c(x01), .O(z50));
  nand2  g149(.a(new_n290_), .b(x71), .O(new_n316_));
  inv1   g150(.a(x11), .O(new_n317_));
  nand2  g151(.a(new_n296_), .b(new_n317_), .O(new_n318_));
  inv1   g152(.a(x19), .O(new_n319_));
  nand2  g153(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g154(.a(new_n320_), .b(new_n318_), .c(new_n294_), .O(new_n321_));
  aoi21  g155(.a(new_n321_), .b(new_n316_), .c(x01), .O(z51));
  nand2  g156(.a(new_n290_), .b(x72), .O(new_n323_));
  inv1   g157(.a(x12), .O(new_n324_));
  nand2  g158(.a(new_n296_), .b(new_n324_), .O(new_n325_));
  inv1   g159(.a(x20), .O(new_n326_));
  nand2  g160(.a(x52), .b(new_n326_), .O(new_n327_));
  nand3  g161(.a(new_n327_), .b(new_n325_), .c(new_n294_), .O(new_n328_));
  aoi21  g162(.a(new_n328_), .b(new_n323_), .c(x01), .O(z52));
  nand2  g163(.a(new_n290_), .b(x73), .O(new_n330_));
  inv1   g164(.a(x13), .O(new_n331_));
  nand2  g165(.a(new_n296_), .b(new_n331_), .O(new_n332_));
  inv1   g166(.a(x21), .O(new_n333_));
  nand2  g167(.a(x52), .b(new_n333_), .O(new_n334_));
  nand3  g168(.a(new_n334_), .b(new_n332_), .c(new_n294_), .O(new_n335_));
  aoi21  g169(.a(new_n335_), .b(new_n330_), .c(x01), .O(z53));
  inv1   g170(.a(x82), .O(new_n338_));
  nand2  g171(.a(x84), .b(new_n338_), .O(new_n339_));
  nor4   g172(.a(new_n339_), .b(new_n212_), .c(x81), .d(x80), .O(new_n340_));
  and2   g173(.a(new_n340_), .b(new_n255_), .O(z55));
  oai21  g174(.a(new_n218_), .b(x76), .c(new_n229_), .O(new_n342_));
  aoi21  g175(.a(new_n154_), .b(new_n157_), .c(new_n222_), .O(new_n343_));
  nand2  g176(.a(new_n343_), .b(new_n342_), .O(z56));
  inv1   g177(.a(x02), .O(new_n345_));
  nand3  g178(.a(new_n223_), .b(x03), .c(new_n345_), .O(new_n346_));
  inv1   g179(.a(new_n346_), .O(z57));
  oai21  g180(.a(new_n155_), .b(new_n224_), .c(new_n161_), .O(new_n348_));
  nand2  g181(.a(x78), .b(x04), .O(new_n349_));
  aoi21  g182(.a(x42), .b(x40), .c(new_n349_), .O(new_n350_));
  nand3  g183(.a(new_n350_), .b(new_n214_), .c(x79), .O(new_n351_));
  nand4  g184(.a(new_n161_), .b(new_n154_), .c(new_n209_), .d(x40), .O(new_n352_));
  ...
  nor2   g190(.a(new_n292_), .b(new_n219_), .O(new_n359_));
  oai21  g191(.a(new_n358_), .b(new_n161_), .c(new_n359_), .O(new_n360_));
  aoi21  g192(.a(new_n360_), .b(new_n216_), .c(x01), .O(z60));
  nand2  g193(.a(new_n228_), .b(new_n224_), .O(new_n362_));
  oai21  g194(.a(new_n357_), .b(new_n218_), .c(new_n362_), .O(new_n363_));
  ...
  aoi21  g200(.a(new_n214_), .b(x79), .c(new_n224_), .O(new_n369_));
  nand3  g201(.a(x81), .b(x79), .c(new_n224_), .O(new_n370_));
  nand2  g202(.a(new_n370_), .b(x77), .O(new_n371_));
  nor2   g203(.a(new_n292_), .b(x77), .O(new_n372_));
