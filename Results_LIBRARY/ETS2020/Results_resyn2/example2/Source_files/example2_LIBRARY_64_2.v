...
module FAU ( 
  ...
  inv1   g046(.a(x50), .O(new_n200_));
  nor2   g047(.a(x40), .b(x33), .O(new_n201_));
  aoi21  g048(.a(new_n200_), .b(x40), .c(new_n201_), .O(z15));
  ...
  nand2  g150(.a(new_n265_), .b(new_n307_), .O(new_n308_));
  ...
  nand2  g157(.a(new_n265_), .b(new_n314_), .O(new_n315_));
  ...
  nand2  g164(.a(new_n265_), .b(new_n323_), .O(new_n324_));
  ...
  oai21  g170(.a(new_n265_), .b(x22), .c(new_n153_), .O(new_n330_));
  ...
  nor3   g175(.a(new_n334_), .b(new_n256_), .c(new_n236_), .O(z55));
  ...
  nor3   g189(.a(new_n351_), .b(new_n346_), .c(new_n332_), .O(z61));
  ...
  nor2   g195(.a(new_n290_), .b(x77), .O(new_n358_));
  ...
  nor3   g199(.a(new_n351_), .b(new_n346_), .c(new_n333_), .O(z63));
  nand3  g200(.a(new_n350_), .b(x83), .c(x79), .O(new_n363_));
  aoi21  g201(.a(new_n363_), .b(new_n291_), .c(x01), .O(z64));
