// Benchmark "FAU" written by ABC on Sat Jul 25 01:26:56 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n181_, new_n182_, new_n184_, new_n185_, new_n189_, new_n190_,
    ...
    new_n240_, new_n241_, new_n243_, new_n249_, new_n251_, new_n253_,
  ...
  nand3  g061(.a(new_n221_), .b(x45), .c(new_n212_), .O(new_n225_));
  ...
  nand4  g083(.a(new_n240_), .b(new_n238_), .c(new_n237_), .d(x60), .O(new_n253_));
  inv1   g084(.a(new_n253_), .O(z42));
  nand4  g085(.a(new_n240_), .b(new_n238_), .c(new_n237_), .d(x61), .O(new_n255_));
  inv1   g086(.a(new_n255_), .O(z43));
  ...
  nand2  g111(.a(new_n264_), .b(x69), .O(new_n284_));
  inv1   g112(.a(x09), .O(new_n285_));
  nand2  g113(.a(new_n271_), .b(new_n285_), .O(new_n286_));
  inv1   g114(.a(x17), .O(new_n287_));
  nand2  g115(.a(x52), .b(new_n287_), .O(new_n288_));
  nand3  g116(.a(new_n288_), .b(new_n286_), .c(new_n269_), .O(new_n289_));
  aoi21  g117(.a(new_n289_), .b(new_n284_), .c(x01), .O(z49));
  nand2  g118(.a(new_n264_), .b(x72), .O(new_n293_));
  inv1   g119(.a(x12), .O(new_n294_));
  nand2  g120(.a(new_n271_), .b(new_n294_), .O(new_n295_));
  inv1   g121(.a(x20), .O(new_n296_));
  nand2  g122(.a(x52), .b(new_n296_), .O(new_n297_));
  nand3  g123(.a(new_n297_), .b(new_n295_), .c(new_n269_), .O(new_n298_));
  aoi21  g124(.a(new_n298_), .b(new_n293_), .c(x01), .O(z52));
  nand2  g125(.a(new_n264_), .b(x73), .O(new_n300_));
  inv1   g126(.a(x13), .O(new_n301_));
  nand2  g127(.a(new_n271_), .b(new_n301_), .O(new_n302_));
  inv1   g128(.a(x21), .O(new_n303_));
  nand2  g129(.a(x52), .b(new_n303_), .O(new_n304_));
  nand3  g130(.a(new_n304_), .b(new_n302_), .c(new_n269_), .O(new_n305_));
  aoi21  g131(.a(new_n305_), .b(new_n300_), .c(x01), .O(z53));
  nor2   g132(.a(x52), .b(x14), .O(new_n307_));
  oai21  g133(.a(new_n271_), .b(x22), .c(new_n153_), .O(new_n308_));
  nor3   g134(.a(new_n308_), .b(new_n307_), .c(new_n268_), .O(z54));
  inv1   g135(.a(x79), .O(new_n311_));
  aoi22  g136(.a(new_n262_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n312_));
  nand2  g137(.a(new_n153_), .b(x00), .O(new_n313_));
  aoi21  g138(.a(new_n161_), .b(new_n159_), .c(new_n313_), .O(new_n314_));
  oai21  g139(.a(new_n312_), .b(new_n311_), .c(new_n314_), .O(z56));
  oai21  g140(.a(new_n162_), .b(new_n266_), .c(new_n311_), .O(new_n317_));
  nand3  g141(.a(new_n239_), .b(x82), .c(x80), .O(new_n318_));
  ...
  nor2   g145(.a(new_n161_), .b(new_n266_), .O(new_n322_));
  nand3  g146(.a(new_n322_), .b(new_n321_), .c(x79), .O(new_n323_));
  nand3  g147(.a(new_n311_), .b(new_n161_), .c(x40), .O(new_n324_));
  ...
  aoi21  g151(.a(new_n327_), .b(new_n317_), .c(x01), .O(z58));
  ...
  oai21  g155(.a(new_n331_), .b(new_n266_), .c(new_n153_), .O(new_n332_));
  aoi21  g156(.a(new_n330_), .b(x79), .c(new_n332_), .O(z59));
  nand3  g157(.a(new_n260_), .b(new_n160_), .c(x79), .O(new_n336_));
  aoi21  g158(.a(new_n321_), .b(x79), .c(new_n266_), .O(new_n337_));
  nand3  g159(.a(x81), .b(x79), .c(new_n266_), .O(new_n338_));
  nand2  g160(.a(new_n338_), .b(x77), .O(new_n339_));
  nand2  g161(.a(new_n260_), .b(x79), .O(new_n340_));
  nor2   g162(.a(new_n267_), .b(x77), .O(new_n341_));
  ...
  nand2  g166(.a(new_n219_), .b(new_n266_), .O(new_n346_));
  oai21  g167(.a(new_n262_), .b(new_n163_), .c(new_n346_), .O(new_n347_));
  nand3  g168(.a(new_n347_), .b(x83), .c(x79), .O(new_n348_));
  aoi21  g169(.a(new_n348_), .b(new_n268_), .c(x01), .O(z64));
