...
module FAU ( 
  ...
  nand3  g101(.a(new_n246_), .b(x50), .c(new_n223_), .O(new_n258_));
  ...
  nand2  g168(.a(new_n269_), .b(new_n324_), .O(new_n325_));
  ...
  nand2  g175(.a(new_n269_), .b(new_n331_), .O(new_n332_));
  ...
  nand2  g182(.a(new_n269_), .b(new_n338_), .O(new_n339_));
  ...
  oai21  g188(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n345_));
  ...
  nor3   g193(.a(new_n349_), .b(new_n260_), .c(new_n242_), .O(z55));
