...
module FAU ( 
  ...
  nor2   g156(.a(x52), .b(x14), .O(new_n326_));
  oai21  g157(.a(new_n291_), .b(x22), .c(new_n164_), .O(new_n327_));
  nor3   g158(.a(new_n327_), .b(new_n326_), .c(new_n288_), .O(z54));
  inv1   g159(.a(x82), .O(new_n329_));
  nand2  g160(.a(x84), .b(new_n329_), .O(new_n330_));
  nor4   g161(.a(new_n330_), .b(new_n206_), .c(x81), .d(x80), .O(new_n331_));
  and2   g162(.a(new_n331_), .b(new_n250_), .O(z55));
  oai21  g163(.a(new_n212_), .b(x76), .c(new_n223_), .O(new_n333_));
  aoi21  g164(.a(new_n154_), .b(new_n157_), .c(new_n216_), .O(new_n334_));
  nand2  g165(.a(new_n334_), .b(new_n333_), .O(z56));
  inv1   g166(.a(x02), .O(new_n336_));
  nand3  g167(.a(new_n217_), .b(x03), .c(new_n336_), .O(new_n337_));
  inv1   g168(.a(new_n337_), .O(z57));
  oai21  g169(.a(new_n155_), .b(new_n218_), .c(new_n161_), .O(new_n339_));
  nand2  g170(.a(x78), .b(x04), .O(new_n340_));
  aoi21  g171(.a(x42), .b(x40), .c(new_n340_), .O(new_n341_));
  nand3  g172(.a(new_n341_), .b(new_n208_), .c(x79), .O(new_n342_));
  nand4  g173(.a(new_n161_), .b(new_n154_), .c(new_n203_), .d(x40), .O(new_n343_));
  ...
  nor2   g179(.a(new_n287_), .b(new_n213_), .O(new_n350_));
  oai21  g180(.a(new_n349_), .b(new_n161_), .c(new_n350_), .O(new_n351_));
  aoi21  g181(.a(new_n351_), .b(new_n210_), .c(x01), .O(z60));
  nand2  g182(.a(new_n222_), .b(new_n218_), .O(new_n353_));
  oai21  g183(.a(new_n348_), .b(new_n212_), .c(new_n353_), .O(new_n354_));
  ...
  aoi21  g189(.a(new_n208_), .b(x79), .c(new_n218_), .O(new_n360_));
  nand3  g190(.a(x81), .b(x79), .c(new_n218_), .O(new_n361_));
  nand2  g191(.a(new_n361_), .b(x77), .O(new_n362_));
  nor2   g192(.a(new_n287_), .b(x77), .O(new_n363_));
