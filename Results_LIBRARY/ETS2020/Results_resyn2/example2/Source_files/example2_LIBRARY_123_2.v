...
module FAU ( 
  ...
  nand2  g155(.a(new_n287_), .b(x71), .O(new_n314_));
  inv1   g156(.a(x11), .O(new_n315_));
  nand2  g157(.a(new_n266_), .b(new_n315_), .O(new_n316_));
  inv1   g158(.a(x19), .O(new_n317_));
  nand2  g159(.a(x52), .b(new_n317_), .O(new_n318_));
  nand3  g160(.a(new_n318_), .b(new_n316_), .c(new_n292_), .O(new_n319_));
  aoi21  g161(.a(new_n319_), .b(new_n314_), .c(x01), .O(z51));
