...
module FAU ( 
  ...
  nand3  g071(.a(new_n221_), .b(x50), .c(new_n216_), .O(new_n234_));
  inv1   g072(.a(new_n234_), .O(z32));
  ...
  oai21  g146(.a(new_n162_), .b(new_n264_), .c(new_n315_), .O(new_n321_));
  inv1   g147(.a(x83), .O(new_n322_));
  nand3  g148(.a(new_n322_), .b(x82), .c(x80), .O(new_n323_));
  inv1   g149(.a(x74), .O(new_n324_));
  nand4  g150(.a(x84), .b(x81), .c(new_n324_), .d(x43), .O(new_n325_));
  oai21  g151(.a(new_n325_), .b(new_n323_), .c(new_n216_), .O(new_n326_));
  nor2   g152(.a(new_n161_), .b(new_n264_), .O(new_n327_));
  nand3  g153(.a(new_n327_), .b(new_n326_), .c(x79), .O(new_n328_));
  nand3  g154(.a(new_n315_), .b(new_n161_), .c(x40), .O(new_n329_));
  nand2  g155(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  aoi21  g156(.a(x42), .b(x40), .c(new_n159_), .O(new_n331_));
  nand2  g157(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  aoi21  g158(.a(new_n332_), .b(new_n321_), .c(x01), .O(z58));
  nand2  g159(.a(new_n326_), .b(new_n156_), .O(new_n334_));
  nand2  g160(.a(new_n334_), .b(new_n327_), .O(new_n335_));
  aoi21  g161(.a(new_n161_), .b(new_n156_), .c(new_n159_), .O(new_n336_));
  oai21  g162(.a(new_n336_), .b(new_n264_), .c(new_n153_), .O(new_n337_));
  aoi21  g163(.a(new_n335_), .b(x79), .c(new_n337_), .O(z59));
  nand3  g164(.a(new_n258_), .b(new_n160_), .c(x79), .O(new_n341_));
  aoi21  g165(.a(new_n326_), .b(x79), .c(new_n264_), .O(new_n342_));
  nand3  g166(.a(x81), .b(x79), .c(new_n264_), .O(new_n343_));
  nand2  g167(.a(new_n343_), .b(x77), .O(new_n344_));
  nand2  g168(.a(new_n258_), .b(x79), .O(new_n345_));
  nor2   g169(.a(new_n265_), .b(x77), .O(new_n346_));
  aoi21  g170(.a(new_n346_), .b(new_n345_), .c(new_n161_), .O(new_n347_));
  oai21  g171(.a(new_n344_), .b(new_n342_), .c(new_n347_), .O(new_n348_));
  aoi21  g172(.a(new_n348_), .b(new_n341_), .c(x01), .O(z62));
  nand2  g173(.a(new_n219_), .b(new_n264_), .O(new_n351_));
  oai21  g174(.a(new_n260_), .b(new_n163_), .c(new_n351_), .O(new_n352_));
  nand3  g175(.a(new_n352_), .b(x83), .c(x79), .O(new_n353_));
  aoi21  g176(.a(new_n353_), .b(new_n266_), .c(x01), .O(z64));
  nand2  g177(.a(new_n164_), .b(x81), .O(new_n355_));
  nand3  g178(.a(x84), .b(x79), .c(new_n153_), .O(new_n356_));
  aoi21  g179(.a(new_n355_), .b(new_n351_), .c(new_n356_), .O(z65));
  zero   g180(.O(z02));
  zero   g181(.O(z03));
  zero   g182(.O(z05));
  zero   g183(.O(z08));
