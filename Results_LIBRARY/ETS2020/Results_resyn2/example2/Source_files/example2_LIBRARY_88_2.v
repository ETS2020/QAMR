// Benchmark "FAU" written by ABC on Sat Jul 25 01:26:52 2020
...
module FAU ( 
  ...
  nand2  g154(.a(new_n269_), .b(new_n310_), .O(new_n311_));
  ...
  nand2  g161(.a(new_n269_), .b(new_n317_), .O(new_n318_));
  ...
  nand2  g166(.a(new_n290_), .b(x72), .O(new_n324_));
  inv1   g167(.a(x12), .O(new_n325_));
  nand2  g168(.a(new_n269_), .b(new_n325_), .O(new_n326_));
  inv1   g169(.a(x20), .O(new_n327_));
  nand2  g170(.a(x52), .b(new_n327_), .O(new_n328_));
  nand3  g171(.a(new_n328_), .b(new_n326_), .c(new_n295_), .O(new_n329_));
  aoi21  g172(.a(new_n329_), .b(new_n324_), .c(x01), .O(z52));
  nand2  g173(.a(new_n290_), .b(x73), .O(new_n331_));
  inv1   g174(.a(x13), .O(new_n332_));
  nand2  g175(.a(new_n269_), .b(new_n332_), .O(new_n333_));
  inv1   g176(.a(x21), .O(new_n334_));
  nand2  g177(.a(x52), .b(new_n334_), .O(new_n335_));
  nand3  g178(.a(new_n335_), .b(new_n333_), .c(new_n295_), .O(new_n336_));
  aoi21  g179(.a(new_n336_), .b(new_n331_), .c(x01), .O(z53));
  nor2   g180(.a(x52), .b(x14), .O(new_n338_));
  oai21  g181(.a(new_n269_), .b(x22), .c(new_n153_), .O(new_n339_));
  nor3   g182(.a(new_n339_), .b(new_n338_), .c(new_n294_), .O(z54));
  inv1   g183(.a(x80), .O(new_n341_));
  inv1   g184(.a(x82), .O(new_n342_));
  nand3  g185(.a(x84), .b(new_n342_), .c(new_n341_), .O(new_n343_));
  nor3   g186(.a(new_n343_), .b(new_n260_), .c(new_n242_), .O(z55));
  inv1   g187(.a(x02), .O(new_n346_));
  nand4  g188(.a(x03), .b(new_n346_), .c(new_n153_), .d(x00), .O(new_n347_));
  inv1   g189(.a(new_n347_), .O(z57));
  nand2  g190(.a(new_n228_), .b(new_n158_), .O(new_n350_));
  nand2  g191(.a(new_n350_), .b(new_n231_), .O(new_n351_));
  aoi21  g192(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n352_));
  oai21  g193(.a(new_n352_), .b(new_n230_), .c(new_n153_), .O(new_n353_));
  aoi21  g194(.a(new_n351_), .b(x79), .c(new_n353_), .O(z59));
  aoi22  g195(.a(new_n234_), .b(new_n164_), .c(new_n155_), .d(new_n230_), .O(new_n355_));
  aoi21  g196(.a(new_n355_), .b(new_n232_), .c(x01), .O(z60));
  inv1   g197(.a(new_n169_), .O(new_n357_));
  nand2  g198(.a(new_n163_), .b(new_n161_), .O(new_n358_));
  nand2  g199(.a(new_n235_), .b(new_n358_), .O(new_n359_));
  nand3  g200(.a(x78), .b(x77), .c(new_n230_), .O(new_n360_));
  nand2  g201(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  inv1   g202(.a(new_n361_), .O(new_n362_));
  nor3   g203(.a(new_n362_), .b(new_n357_), .c(new_n341_), .O(z61));
  nand3  g204(.a(x84), .b(x81), .c(x79), .O(new_n364_));
  or2    g205(.a(new_n364_), .b(new_n163_), .O(new_n365_));
  aoi21  g206(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n366_));
  nand3  g207(.a(x81), .b(x79), .c(new_n230_), .O(new_n367_));
  nand2  g208(.a(new_n367_), .b(x77), .O(new_n368_));
  nor2   g209(.a(new_n293_), .b(x77), .O(new_n369_));
  aoi21  g210(.a(new_n369_), .b(new_n364_), .c(new_n162_), .O(new_n370_));
  oai21  g211(.a(new_n368_), .b(new_n366_), .c(new_n370_), .O(new_n371_));
  aoi21  g212(.a(new_n371_), .b(new_n365_), .c(x01), .O(z62));
  nor3   g213(.a(new_n362_), .b(new_n357_), .c(new_n342_), .O(z63));
  nand3  g214(.a(new_n361_), .b(x83), .c(x79), .O(new_n374_));
  aoi21  g215(.a(new_n374_), .b(new_n294_), .c(x01), .O(z64));
  nand2  g216(.a(new_n358_), .b(x81), .O(new_n376_));
  nand2  g217(.a(new_n169_), .b(x84), .O(new_n377_));
  aoi21  g218(.a(new_n376_), .b(new_n360_), .c(new_n377_), .O(z65));
  zero   g219(.O(z20));
  zero   g220(.O(z24));
  zero   g221(.O(z26));
  zero   g222(.O(z28));
