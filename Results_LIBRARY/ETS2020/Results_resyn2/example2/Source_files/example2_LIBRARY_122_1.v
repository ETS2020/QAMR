...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n220_, new_n222_, new_n225_, new_n227_, new_n230_, new_n233_,
  ...
  nand2  g111(.a(new_n258_), .b(x72), .O(new_n287_));
  ...
  nand2  g118(.a(new_n258_), .b(x73), .O(new_n294_));
  ...
  oai21  g126(.a(new_n265_), .b(x22), .c(new_n153_), .O(new_n302_));
  nor3   g127(.a(new_n302_), .b(new_n301_), .c(new_n262_), .O(z54));
  inv1   g128(.a(x79), .O(new_n305_));
  aoi22  g129(.a(new_n256_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n306_));
  ...
  oai21  g133(.a(new_n162_), .b(new_n260_), .c(new_n305_), .O(new_n311_));
  ...
  nor2   g139(.a(new_n161_), .b(new_n260_), .O(new_n317_));
  ...
  oai21  g149(.a(new_n326_), .b(new_n260_), .c(new_n153_), .O(new_n327_));
  aoi21  g150(.a(new_n325_), .b(x79), .c(new_n327_), .O(z59));
  nand3  g151(.a(new_n254_), .b(new_n160_), .c(x79), .O(new_n331_));
  aoi21  g152(.a(new_n316_), .b(x79), .c(new_n260_), .O(new_n332_));
  nand3  g153(.a(x81), .b(x79), .c(new_n260_), .O(new_n333_));
  nand2  g154(.a(new_n333_), .b(x77), .O(new_n334_));
  nand2  g155(.a(new_n254_), .b(x79), .O(new_n335_));
  nor2   g156(.a(new_n261_), .b(x77), .O(new_n336_));
  ...
  nand2  g160(.a(new_n215_), .b(new_n260_), .O(new_n341_));
  oai21  g161(.a(new_n256_), .b(new_n163_), .c(new_n341_), .O(new_n342_));
  nand3  g162(.a(new_n342_), .b(x83), .c(x79), .O(new_n343_));
  aoi21  g163(.a(new_n343_), .b(new_n262_), .c(x01), .O(z64));
