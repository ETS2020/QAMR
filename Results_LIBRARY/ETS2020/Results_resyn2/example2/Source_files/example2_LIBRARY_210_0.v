...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n269_, new_n271_, new_n273_, new_n276_, new_n278_, new_n280_,
  ...
  nand2  g090(.a(x83), .b(x42), .O(new_n258_));
  or2    g091(.a(new_n258_), .b(new_n232_), .O(new_n259_));
  nand2  g092(.a(new_n258_), .b(new_n232_), .O(new_n260_));
  nand4  g093(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x53), .O(new_n261_));
  inv1   g094(.a(new_n261_), .O(z35));
  nand4  g095(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x54), .O(new_n263_));
  inv1   g096(.a(new_n263_), .O(z36));
  nand4  g097(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x55), .O(new_n265_));
  inv1   g098(.a(new_n265_), .O(z37));
  nand4  g099(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x56), .O(new_n267_));
  inv1   g100(.a(new_n267_), .O(z38));
  nand4  g101(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x57), .O(new_n269_));
  inv1   g102(.a(new_n269_), .O(z39));
  nand4  g103(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x58), .O(new_n271_));
  inv1   g104(.a(new_n271_), .O(z40));
  nand4  g105(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x59), .O(new_n273_));
  inv1   g106(.a(new_n273_), .O(z41));
  nand4  g107(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x61), .O(new_n276_));
  inv1   g108(.a(new_n276_), .O(z43));
  nand4  g109(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x62), .O(new_n278_));
  inv1   g110(.a(new_n278_), .O(z44));
  nand4  g111(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x63), .O(new_n280_));
  inv1   g112(.a(new_n280_), .O(z45));
  nand4  g113(.a(new_n260_), .b(new_n259_), .c(new_n250_), .d(x64), .O(new_n282_));
