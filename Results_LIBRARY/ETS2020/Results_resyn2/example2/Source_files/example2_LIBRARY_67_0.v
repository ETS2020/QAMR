...
module FAU ( 
  ...
  nand2  g130(.a(new_n287_), .b(x71), .O(new_n301_));
  inv1   g131(.a(x11), .O(new_n302_));
  nand2  g132(.a(new_n293_), .b(new_n302_), .O(new_n303_));
  inv1   g133(.a(x19), .O(new_n304_));
  nand2  g134(.a(x52), .b(new_n304_), .O(new_n305_));
  nand3  g135(.a(new_n305_), .b(new_n303_), .c(new_n291_), .O(new_n306_));
  aoi21  g136(.a(new_n306_), .b(new_n301_), .c(x01), .O(z51));
  nand2  g137(.a(new_n287_), .b(x72), .O(new_n308_));
  inv1   g138(.a(x12), .O(new_n309_));
  nand2  g139(.a(new_n293_), .b(new_n309_), .O(new_n310_));
  inv1   g140(.a(x20), .O(new_n311_));
  nand2  g141(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g142(.a(new_n312_), .b(new_n310_), .c(new_n291_), .O(new_n313_));
  aoi21  g143(.a(new_n313_), .b(new_n308_), .c(x01), .O(z52));
  nand2  g144(.a(new_n287_), .b(x73), .O(new_n315_));
  inv1   g145(.a(x13), .O(new_n316_));
  nand2  g146(.a(new_n293_), .b(new_n316_), .O(new_n317_));
  inv1   g147(.a(x21), .O(new_n318_));
  nand2  g148(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g149(.a(new_n319_), .b(new_n317_), .c(new_n291_), .O(new_n320_));
  aoi21  g150(.a(new_n320_), .b(new_n315_), .c(x01), .O(z53));
  inv1   g151(.a(x82), .O(new_n323_));
  nand2  g152(.a(x84), .b(new_n323_), .O(new_n324_));
  nor4   g153(.a(new_n324_), .b(new_n210_), .c(x81), .d(x80), .O(new_n325_));
  and2   g154(.a(new_n325_), .b(new_n252_), .O(z55));
  oai21  g155(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n327_));
  aoi21  g156(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n328_));
  nand2  g157(.a(new_n328_), .b(new_n327_), .O(z56));
  inv1   g158(.a(x02), .O(new_n330_));
  nand3  g159(.a(new_n221_), .b(x03), .c(new_n330_), .O(new_n331_));
  inv1   g160(.a(new_n331_), .O(z57));
  oai21  g161(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n333_));
  nand2  g162(.a(x78), .b(x04), .O(new_n334_));
  aoi21  g163(.a(x42), .b(x40), .c(new_n334_), .O(new_n335_));
  nand3  g164(.a(new_n335_), .b(new_n212_), .c(x79), .O(new_n336_));
  nand4  g165(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n337_));
  ...
  nor2   g171(.a(new_n289_), .b(new_n217_), .O(new_n344_));
  oai21  g172(.a(new_n343_), .b(new_n161_), .c(new_n344_), .O(new_n345_));
  aoi21  g173(.a(new_n345_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g174(.a(new_n226_), .b(new_n222_), .O(new_n347_));
  oai21  g175(.a(new_n342_), .b(new_n216_), .c(new_n347_), .O(new_n348_));
  ...
  aoi21  g181(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n354_));
  nand3  g182(.a(x81), .b(x79), .c(new_n222_), .O(new_n355_));
  nand2  g183(.a(new_n355_), .b(x77), .O(new_n356_));
  nor2   g184(.a(new_n289_), .b(x77), .O(new_n357_));
