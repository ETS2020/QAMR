...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n179_, new_n181_, new_n182_, new_n190_, new_n191_, new_n193_,
  ...
  nand3  g078(.a(new_n234_), .b(new_n229_), .c(x47), .O(new_n241_));
  inv1   g079(.a(new_n241_), .O(z29));
  ...
  nor2   g159(.a(x52), .b(x14), .O(new_n328_));
  oai21  g160(.a(new_n293_), .b(x22), .c(new_n164_), .O(new_n329_));
  nor3   g161(.a(new_n329_), .b(new_n328_), .c(new_n290_), .O(z54));
  inv1   g162(.a(x82), .O(new_n331_));
  nand2  g163(.a(x84), .b(new_n331_), .O(new_n332_));
  nor4   g164(.a(new_n332_), .b(new_n208_), .c(x81), .d(x80), .O(new_n333_));
  and2   g165(.a(new_n333_), .b(new_n252_), .O(z55));
  oai21  g166(.a(new_n214_), .b(x76), .c(new_n225_), .O(new_n335_));
  aoi21  g167(.a(new_n154_), .b(new_n157_), .c(new_n218_), .O(new_n336_));
  nand2  g168(.a(new_n336_), .b(new_n335_), .O(z56));
  inv1   g169(.a(x02), .O(new_n338_));
  nand3  g170(.a(new_n219_), .b(x03), .c(new_n338_), .O(new_n339_));
  inv1   g171(.a(new_n339_), .O(z57));
  oai21  g172(.a(new_n155_), .b(new_n220_), .c(new_n161_), .O(new_n341_));
  nand2  g173(.a(x78), .b(x04), .O(new_n342_));
  aoi21  g174(.a(x42), .b(x40), .c(new_n342_), .O(new_n343_));
  nand3  g175(.a(new_n343_), .b(new_n210_), .c(x79), .O(new_n344_));
  nand4  g176(.a(new_n161_), .b(new_n154_), .c(new_n205_), .d(x40), .O(new_n345_));
  nand2  g177(.a(new_n345_), .b(new_n344_), .O(new_n346_));
  nand2  g178(.a(new_n346_), .b(x77), .O(new_n347_));
  aoi21  g179(.a(new_n347_), .b(new_n341_), .c(x01), .O(z58));
  nor2   g180(.a(new_n158_), .b(new_n155_), .O(new_n350_));
  inv1   g181(.a(new_n350_), .O(new_n351_));
  nor2   g182(.a(new_n289_), .b(new_n215_), .O(new_n352_));
  oai21  g183(.a(new_n351_), .b(new_n161_), .c(new_n352_), .O(new_n353_));
  aoi21  g184(.a(new_n353_), .b(new_n212_), .c(x01), .O(z60));
  nand2  g185(.a(new_n224_), .b(new_n220_), .O(new_n355_));
  oai21  g186(.a(new_n350_), .b(new_n214_), .c(new_n355_), .O(new_n356_));
  nand3  g187(.a(new_n356_), .b(new_n162_), .c(x80), .O(new_n357_));
  inv1   g188(.a(new_n357_), .O(z61));
  nand3  g189(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  inv1   g190(.a(new_n359_), .O(new_n360_));
  nand2  g191(.a(new_n360_), .b(new_n158_), .O(new_n361_));
  aoi21  g192(.a(new_n210_), .b(x79), .c(new_n220_), .O(new_n362_));
  nand3  g193(.a(x81), .b(x79), .c(new_n220_), .O(new_n363_));
  nand2  g194(.a(new_n363_), .b(x77), .O(new_n364_));
  nor2   g195(.a(new_n289_), .b(x77), .O(new_n365_));
  aoi21  g196(.a(new_n365_), .b(new_n359_), .c(new_n154_), .O(new_n366_));
  oai21  g197(.a(new_n364_), .b(new_n362_), .c(new_n366_), .O(new_n367_));
  aoi21  g198(.a(new_n367_), .b(new_n361_), .c(x01), .O(z62));
  nand3  g199(.a(new_n356_), .b(new_n162_), .c(x82), .O(new_n369_));
  inv1   g200(.a(new_n369_), .O(z63));
  nand2  g201(.a(new_n351_), .b(x81), .O(new_n372_));
  nand2  g202(.a(new_n162_), .b(x84), .O(new_n373_));
  aoi21  g203(.a(new_n372_), .b(new_n355_), .c(new_n373_), .O(z65));
  zero   g204(.O(z00));
  zero   g205(.O(z01));
  zero   g206(.O(z04));
  zero   g207(.O(z06));
