...
module FAU ( 
  ...
  inv1   g183(.a(x80), .O(new_n342_));
  inv1   g184(.a(x82), .O(new_n343_));
  nand3  g185(.a(x84), .b(new_n343_), .c(new_n342_), .O(new_n344_));
  nor3   g186(.a(new_n344_), .b(new_n257_), .c(new_n238_), .O(z55));
  inv1   g187(.a(x02), .O(new_n347_));
  nand4  g188(.a(x03), .b(new_n347_), .c(new_n153_), .d(x00), .O(new_n348_));
  inv1   g189(.a(new_n348_), .O(z57));
  nand2  g190(.a(new_n224_), .b(new_n158_), .O(new_n351_));
  nand2  g191(.a(new_n351_), .b(new_n227_), .O(new_n352_));
  aoi21  g192(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n353_));
  oai21  g193(.a(new_n353_), .b(new_n226_), .c(new_n153_), .O(new_n354_));
  aoi21  g194(.a(new_n352_), .b(x79), .c(new_n354_), .O(z59));
  aoi22  g195(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n356_));
  aoi21  g196(.a(new_n356_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g197(.a(new_n169_), .O(new_n358_));
  nand2  g198(.a(new_n163_), .b(new_n161_), .O(new_n359_));
  nand2  g199(.a(new_n231_), .b(new_n359_), .O(new_n360_));
  nand3  g200(.a(x78), .b(x77), .c(new_n226_), .O(new_n361_));
  nand2  g201(.a(new_n361_), .b(new_n360_), .O(new_n362_));
  inv1   g202(.a(new_n362_), .O(new_n363_));
  nor3   g203(.a(new_n363_), .b(new_n358_), .c(new_n342_), .O(z61));
  nand3  g204(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  or2    g205(.a(new_n365_), .b(new_n163_), .O(new_n366_));
  aoi21  g206(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n367_));
  nand3  g207(.a(x81), .b(x79), .c(new_n226_), .O(new_n368_));
  nand2  g208(.a(new_n368_), .b(x77), .O(new_n369_));
  nor2   g209(.a(new_n290_), .b(x77), .O(new_n370_));
  aoi21  g210(.a(new_n370_), .b(new_n365_), .c(new_n162_), .O(new_n371_));
  oai21  g211(.a(new_n369_), .b(new_n367_), .c(new_n371_), .O(new_n372_));
  aoi21  g212(.a(new_n372_), .b(new_n366_), .c(x01), .O(z62));
  nor3   g213(.a(new_n363_), .b(new_n358_), .c(new_n343_), .O(z63));
  nand3  g214(.a(new_n362_), .b(x83), .c(x79), .O(new_n375_));
  aoi21  g215(.a(new_n375_), .b(new_n291_), .c(x01), .O(z64));
  nand2  g216(.a(new_n359_), .b(x81), .O(new_n377_));
  nand2  g217(.a(new_n169_), .b(x84), .O(new_n378_));
  aoi21  g218(.a(new_n377_), .b(new_n361_), .c(new_n378_), .O(z65));
  zero   g219(.O(z19));
  zero   g220(.O(z20));
  zero   g221(.O(z21));
  zero   g222(.O(z24));
