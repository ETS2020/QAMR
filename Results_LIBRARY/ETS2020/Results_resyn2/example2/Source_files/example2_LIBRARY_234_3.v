...
module FAU ( 
  ...
  inv1   g159(.a(x04), .O(new_n314_));
  nor2   g160(.a(x77), .b(new_n314_), .O(new_n315_));
  nand2  g161(.a(new_n315_), .b(new_n155_), .O(new_n316_));
  inv1   g162(.a(new_n316_), .O(new_n317_));
  inv1   g163(.a(x07), .O(new_n318_));
  inv1   g164(.a(x52), .O(new_n319_));
  nand2  g165(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  inv1   g166(.a(x15), .O(new_n321_));
  nand2  g167(.a(x52), .b(new_n321_), .O(new_n322_));
  nand3  g168(.a(new_n322_), .b(new_n320_), .c(new_n317_), .O(new_n323_));
  aoi21  g169(.a(new_n323_), .b(new_n313_), .c(x01), .O(z47));
  nand2  g170(.a(new_n312_), .b(x70), .O(new_n327_));
  inv1   g171(.a(x10), .O(new_n328_));
  nand2  g172(.a(new_n319_), .b(new_n328_), .O(new_n329_));
  inv1   g173(.a(x18), .O(new_n330_));
  nand2  g174(.a(x52), .b(new_n330_), .O(new_n331_));
  nand3  g175(.a(new_n331_), .b(new_n329_), .c(new_n317_), .O(new_n332_));
  aoi21  g176(.a(new_n332_), .b(new_n327_), .c(x01), .O(z50));
  nand2  g177(.a(new_n312_), .b(x71), .O(new_n334_));
  inv1   g178(.a(x11), .O(new_n335_));
  nand2  g179(.a(new_n319_), .b(new_n335_), .O(new_n336_));
  inv1   g180(.a(x19), .O(new_n337_));
  nand2  g181(.a(x52), .b(new_n337_), .O(new_n338_));
  nand3  g182(.a(new_n338_), .b(new_n336_), .c(new_n317_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n334_), .c(x01), .O(z51));
  nand2  g184(.a(new_n312_), .b(x72), .O(new_n341_));
  inv1   g185(.a(x12), .O(new_n342_));
  nand2  g186(.a(new_n319_), .b(new_n342_), .O(new_n343_));
  inv1   g187(.a(x20), .O(new_n344_));
  nand2  g188(.a(x52), .b(new_n344_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n343_), .c(new_n317_), .O(new_n346_));
  aoi21  g190(.a(new_n346_), .b(new_n341_), .c(x01), .O(z52));
  nand2  g191(.a(new_n312_), .b(x73), .O(new_n348_));
  inv1   g192(.a(x13), .O(new_n349_));
  nand2  g193(.a(new_n319_), .b(new_n349_), .O(new_n350_));
  inv1   g194(.a(x21), .O(new_n351_));
  nand2  g195(.a(x52), .b(new_n351_), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(new_n350_), .c(new_n317_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n348_), .c(x01), .O(z53));
  nor2   g198(.a(x52), .b(x14), .O(new_n355_));
  oai21  g199(.a(new_n319_), .b(x22), .c(new_n153_), .O(new_n356_));
  nor3   g200(.a(new_n356_), .b(new_n355_), .c(new_n316_), .O(z54));
  inv1   g201(.a(x82), .O(new_n358_));
  nand2  g202(.a(x84), .b(new_n358_), .O(new_n359_));
  nor4   g203(.a(new_n274_), .b(new_n254_), .c(new_n359_), .d(x80), .O(z55));
  inv1   g204(.a(new_n237_), .O(new_n361_));
  nor2   g205(.a(new_n361_), .b(new_n164_), .O(new_n362_));
  aoi21  g206(.a(new_n246_), .b(x76), .c(new_n362_), .O(new_n363_));
  aoi21  g207(.a(new_n154_), .b(new_n162_), .c(new_n241_), .O(new_n364_));
  oai21  g208(.a(new_n363_), .b(new_n170_), .c(new_n364_), .O(z56));
  inv1   g209(.a(x02), .O(new_n366_));
  nand3  g210(.a(new_n242_), .b(x03), .c(new_n366_), .O(new_n367_));
  inv1   g211(.a(new_n367_), .O(z57));
  aoi21  g212(.a(x42), .b(x40), .c(new_n234_), .O(new_n369_));
  nand3  g213(.a(new_n369_), .b(new_n232_), .c(x79), .O(new_n370_));
  nand4  g214(.a(new_n170_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand2  g216(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g217(.a(new_n161_), .b(new_n314_), .c(new_n170_), .O(new_n374_));
  aoi21  g218(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  inv1   g219(.a(new_n243_), .O(new_n376_));
  nand2  g220(.a(new_n170_), .b(new_n154_), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n234_), .c(new_n158_), .O(new_n378_));
  aoi21  g222(.a(new_n232_), .b(x79), .c(new_n234_), .O(new_n379_));
  oai21  g223(.a(new_n379_), .b(new_n378_), .c(x77), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(new_n376_), .c(x01), .O(z59));
  aoi21  g225(.a(new_n362_), .b(x79), .c(new_n243_), .O(new_n382_));
  aoi21  g226(.a(new_n382_), .b(new_n236_), .c(x01), .O(z60));
  nand2  g227(.a(new_n237_), .b(new_n165_), .O(new_n384_));
  oai21  g228(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n385_));
  nand4  g229(.a(new_n385_), .b(new_n384_), .c(new_n171_), .d(x80), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(z61));
  nand4  g231(.a(new_n385_), .b(new_n384_), .c(new_n171_), .d(x82), .O(new_n389_));
  inv1   g232(.a(new_n389_), .O(z63));
  nand4  g233(.a(new_n385_), .b(new_n384_), .c(x83), .d(x79), .O(new_n391_));
  aoi21  g234(.a(new_n391_), .b(new_n316_), .c(x01), .O(z64));
  zero   g235(.O(z40));
  zero   g236(.O(z41));
  zero   g237(.O(z43));
  zero   g238(.O(z48));
