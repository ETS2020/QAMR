...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n189_, new_n193_, new_n194_, new_n196_, new_n197_, new_n200_,
    ...
    new_n239_, new_n240_, new_n242_, new_n246_, new_n248_, new_n250_,
  ...
  inv1   g037(.a(x48), .O(new_n196_));
  nor2   g038(.a(x40), .b(x35), .O(new_n197_));
  aoi21  g039(.a(new_n196_), .b(x40), .c(new_n197_), .O(z17));
  ...
  inv1   g072(.a(new_n230_), .O(new_n234_));
  inv1   g073(.a(x81), .O(new_n235_));
  xor2a  g074(.a(x84), .b(x82), .O(new_n236_));
  xor2a  g075(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand2  g076(.a(new_n228_), .b(x79), .O(new_n238_));
  nor3   g077(.a(new_n238_), .b(new_n237_), .c(x42), .O(new_n239_));
  nand3  g078(.a(new_n239_), .b(new_n234_), .c(x45), .O(new_n240_));
  inv1   g079(.a(new_n240_), .O(z27));
  nand3  g080(.a(new_n239_), .b(new_n234_), .c(x46), .O(new_n242_));
  inv1   g081(.a(new_n242_), .O(z28));
  nand3  g082(.a(new_n239_), .b(new_n234_), .c(x49), .O(new_n246_));
  inv1   g083(.a(new_n246_), .O(z31));
  nand3  g084(.a(new_n239_), .b(new_n234_), .c(x50), .O(new_n248_));
  ...
  nand3  g089(.a(new_n235_), .b(x51), .c(new_n209_), .O(new_n253_));
  nand3  g090(.a(new_n253_), .b(new_n252_), .c(new_n236_), .O(new_n254_));
  nor2   g091(.a(new_n238_), .b(new_n230_), .O(new_n255_));
  inv1   g092(.a(new_n236_), .O(new_n256_));
  ...
  inv1   g098(.a(new_n237_), .O(new_n264_));
  nand3  g099(.a(new_n264_), .b(x83), .c(x42), .O(new_n265_));
  oai21  g100(.a(new_n212_), .b(new_n209_), .c(new_n237_), .O(new_n266_));
