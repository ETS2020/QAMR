...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n369_, new_n370_, new_n373_, new_n375_;
  ...
  nand2  g163(.a(new_n309_), .b(x70), .O(new_n322_));
  inv1   g164(.a(x10), .O(new_n323_));
  nand2  g165(.a(new_n314_), .b(new_n323_), .O(new_n324_));
  inv1   g166(.a(x18), .O(new_n325_));
  nand2  g167(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g168(.a(new_n326_), .b(new_n324_), .c(new_n312_), .O(new_n327_));
  aoi21  g169(.a(new_n327_), .b(new_n322_), .c(x01), .O(z50));
  nand2  g170(.a(new_n309_), .b(x71), .O(new_n329_));
  inv1   g171(.a(x11), .O(new_n330_));
  nand2  g172(.a(new_n314_), .b(new_n330_), .O(new_n331_));
  inv1   g173(.a(x19), .O(new_n332_));
  nand2  g174(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g175(.a(new_n333_), .b(new_n331_), .c(new_n312_), .O(new_n334_));
  aoi21  g176(.a(new_n334_), .b(new_n329_), .c(x01), .O(z51));
  nor2   g177(.a(x52), .b(x14), .O(new_n338_));
  oai21  g178(.a(new_n314_), .b(x22), .c(new_n153_), .O(new_n339_));
  nor3   g179(.a(new_n339_), .b(new_n338_), .c(new_n311_), .O(z54));
  inv1   g180(.a(x82), .O(new_n341_));
  nand2  g181(.a(x84), .b(new_n341_), .O(new_n342_));
  nor4   g182(.a(new_n271_), .b(new_n252_), .c(new_n342_), .d(x80), .O(z55));
  inv1   g183(.a(new_n235_), .O(new_n344_));
  nor2   g184(.a(new_n344_), .b(new_n164_), .O(new_n345_));
  aoi21  g185(.a(new_n244_), .b(x76), .c(new_n345_), .O(new_n346_));
  aoi21  g186(.a(new_n154_), .b(new_n162_), .c(new_n239_), .O(new_n347_));
  oai21  g187(.a(new_n346_), .b(new_n170_), .c(new_n347_), .O(z56));
  inv1   g188(.a(x02), .O(new_n349_));
  nand3  g189(.a(new_n240_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g190(.a(new_n350_), .O(z57));
  aoi21  g191(.a(x42), .b(x40), .c(new_n232_), .O(new_n352_));
  nand3  g192(.a(new_n352_), .b(new_n230_), .c(x79), .O(new_n353_));
  nand4  g193(.a(new_n170_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n354_));
  nand2  g194(.a(new_n354_), .b(new_n353_), .O(new_n355_));
  nand2  g195(.a(new_n355_), .b(x77), .O(new_n356_));
  inv1   g196(.a(x04), .O(new_n357_));
  oai21  g197(.a(new_n161_), .b(new_n357_), .c(new_n170_), .O(new_n358_));
  aoi21  g198(.a(new_n358_), .b(new_n356_), .c(x01), .O(z58));
  inv1   g199(.a(new_n241_), .O(new_n360_));
  nand2  g200(.a(new_n170_), .b(new_n154_), .O(new_n361_));
  aoi21  g201(.a(new_n361_), .b(new_n232_), .c(new_n158_), .O(new_n362_));
  aoi21  g202(.a(new_n230_), .b(x79), .c(new_n232_), .O(new_n363_));
  oai21  g203(.a(new_n363_), .b(new_n362_), .c(x77), .O(new_n364_));
  aoi21  g204(.a(new_n364_), .b(new_n360_), .c(x01), .O(z59));
  aoi21  g205(.a(new_n345_), .b(x79), .c(new_n241_), .O(new_n366_));
  aoi21  g206(.a(new_n366_), .b(new_n234_), .c(x01), .O(z60));
  nand2  g207(.a(new_n235_), .b(new_n165_), .O(new_n368_));
  oai21  g208(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n369_));
  nand4  g209(.a(new_n369_), .b(new_n368_), .c(new_n171_), .d(x80), .O(new_n370_));
  inv1   g210(.a(new_n370_), .O(z61));
  nand4  g211(.a(new_n369_), .b(new_n368_), .c(new_n171_), .d(x82), .O(new_n373_));
  inv1   g212(.a(new_n373_), .O(z63));
  nand4  g213(.a(new_n369_), .b(new_n368_), .c(x83), .d(x79), .O(new_n375_));
  aoi21  g214(.a(new_n375_), .b(new_n311_), .c(x01), .O(z64));
  zero   g215(.O(z07));
  zero   g216(.O(z32));
  zero   g217(.O(z40));
  zero   g218(.O(z41));
