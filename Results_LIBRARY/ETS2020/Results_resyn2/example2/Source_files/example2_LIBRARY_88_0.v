...
module FAU ( 
  ...
  nand2  g148(.a(new_n289_), .b(x71), .O(new_n315_));
  inv1   g149(.a(x11), .O(new_n316_));
  nand2  g150(.a(new_n295_), .b(new_n316_), .O(new_n317_));
  inv1   g151(.a(x19), .O(new_n318_));
  nand2  g152(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g153(.a(new_n319_), .b(new_n317_), .c(new_n293_), .O(new_n320_));
  aoi21  g154(.a(new_n320_), .b(new_n315_), .c(x01), .O(z51));
  nand2  g155(.a(new_n289_), .b(x72), .O(new_n322_));
  inv1   g156(.a(x12), .O(new_n323_));
  nand2  g157(.a(new_n295_), .b(new_n323_), .O(new_n324_));
  inv1   g158(.a(x20), .O(new_n325_));
  nand2  g159(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g160(.a(new_n326_), .b(new_n324_), .c(new_n293_), .O(new_n327_));
  aoi21  g161(.a(new_n327_), .b(new_n322_), .c(x01), .O(z52));
  nand2  g162(.a(new_n289_), .b(x73), .O(new_n329_));
  inv1   g163(.a(x13), .O(new_n330_));
  nand2  g164(.a(new_n295_), .b(new_n330_), .O(new_n331_));
  inv1   g165(.a(x21), .O(new_n332_));
  nand2  g166(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g167(.a(new_n333_), .b(new_n331_), .c(new_n293_), .O(new_n334_));
  aoi21  g168(.a(new_n334_), .b(new_n329_), .c(x01), .O(z53));
  inv1   g169(.a(x82), .O(new_n337_));
  nand2  g170(.a(x84), .b(new_n337_), .O(new_n338_));
  nor4   g171(.a(new_n338_), .b(new_n210_), .c(x81), .d(x80), .O(new_n339_));
  and2   g172(.a(new_n339_), .b(new_n254_), .O(z55));
  oai21  g173(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n341_));
  aoi21  g174(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n342_));
  nand2  g175(.a(new_n342_), .b(new_n341_), .O(z56));
  inv1   g176(.a(x02), .O(new_n344_));
  nand3  g177(.a(new_n221_), .b(x03), .c(new_n344_), .O(new_n345_));
  inv1   g178(.a(new_n345_), .O(z57));
  oai21  g179(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n347_));
  nand2  g180(.a(x78), .b(x04), .O(new_n348_));
  aoi21  g181(.a(x42), .b(x40), .c(new_n348_), .O(new_n349_));
  nand3  g182(.a(new_n349_), .b(new_n212_), .c(x79), .O(new_n350_));
  nand4  g183(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n351_));
  ...
  nor2   g189(.a(new_n291_), .b(new_n217_), .O(new_n358_));
  oai21  g190(.a(new_n357_), .b(new_n161_), .c(new_n358_), .O(new_n359_));
  aoi21  g191(.a(new_n359_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g192(.a(new_n226_), .b(new_n222_), .O(new_n361_));
  oai21  g193(.a(new_n356_), .b(new_n216_), .c(new_n361_), .O(new_n362_));
  ...
  aoi21  g199(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n368_));
  nand3  g200(.a(x81), .b(x79), .c(new_n222_), .O(new_n369_));
  nand2  g201(.a(new_n369_), .b(x77), .O(new_n370_));
  nor2   g202(.a(new_n291_), .b(x77), .O(new_n371_));
