...
module FAU ( 
  ...
  nand3  g063(.a(new_n221_), .b(x46), .c(new_n216_), .O(new_n226_));
  inv1   g064(.a(new_n226_), .O(z28));
  ...
  nand2  g108(.a(new_n261_), .b(x71), .O(new_n283_));
  inv1   g109(.a(x11), .O(new_n284_));
  nand2  g110(.a(new_n268_), .b(new_n284_), .O(new_n285_));
  inv1   g111(.a(x19), .O(new_n286_));
  nand2  g112(.a(x52), .b(new_n286_), .O(new_n287_));
  nand3  g113(.a(new_n287_), .b(new_n285_), .c(new_n266_), .O(new_n288_));
  aoi21  g114(.a(new_n288_), .b(new_n283_), .c(x01), .O(z51));
