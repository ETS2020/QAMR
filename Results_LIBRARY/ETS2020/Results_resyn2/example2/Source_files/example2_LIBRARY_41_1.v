...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n240_, new_n242_, new_n248_, new_n250_, new_n253_, new_n256_,
  ...
  nand4  g081(.a(new_n239_), .b(new_n237_), .c(new_n236_), .d(x61), .O(new_n253_));
  inv1   g082(.a(new_n253_), .O(z43));
  nand4  g083(.a(new_n239_), .b(new_n237_), .c(new_n236_), .d(x63), .O(new_n256_));
  inv1   g084(.a(new_n256_), .O(z45));
  ...
  nand2  g109(.a(new_n263_), .b(x69), .O(new_n283_));
  inv1   g110(.a(x09), .O(new_n284_));
  nand2  g111(.a(new_n270_), .b(new_n284_), .O(new_n285_));
  inv1   g112(.a(x17), .O(new_n286_));
  nand2  g113(.a(x52), .b(new_n286_), .O(new_n287_));
  nand3  g114(.a(new_n287_), .b(new_n285_), .c(new_n268_), .O(new_n288_));
  aoi21  g115(.a(new_n288_), .b(new_n283_), .c(x01), .O(z49));
