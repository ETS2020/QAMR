...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n343_, new_n346_, new_n347_, new_n348_, new_n351_, new_n352_,
  ...
  nor3   g192(.a(new_n348_), .b(new_n261_), .c(new_n242_), .O(z55));
  inv1   g193(.a(x02), .O(new_n351_));
  nand4  g194(.a(x03), .b(new_n351_), .c(new_n153_), .d(x00), .O(new_n352_));
  inv1   g195(.a(new_n352_), .O(z57));
  nand2  g196(.a(new_n228_), .b(new_n158_), .O(new_n355_));
  nand2  g197(.a(new_n355_), .b(new_n231_), .O(new_n356_));
  aoi21  g198(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n357_));
  oai21  g199(.a(new_n357_), .b(new_n230_), .c(new_n153_), .O(new_n358_));
  aoi21  g200(.a(new_n356_), .b(x79), .c(new_n358_), .O(z59));
  aoi22  g201(.a(new_n234_), .b(new_n164_), .c(new_n155_), .d(new_n230_), .O(new_n360_));
  aoi21  g202(.a(new_n360_), .b(new_n232_), .c(x01), .O(z60));
  inv1   g203(.a(new_n169_), .O(new_n362_));
  nand2  g204(.a(new_n163_), .b(new_n161_), .O(new_n363_));
  nand2  g205(.a(new_n235_), .b(new_n363_), .O(new_n364_));
  nand3  g206(.a(x78), .b(x77), .c(new_n230_), .O(new_n365_));
  ...
  aoi21  g212(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n371_));
  nand3  g213(.a(x81), .b(x79), .c(new_n230_), .O(new_n372_));
  nand2  g214(.a(new_n372_), .b(x77), .O(new_n373_));
  nor2   g215(.a(new_n294_), .b(x77), .O(new_n374_));
  ...
  aoi21  g221(.a(new_n379_), .b(new_n295_), .c(x01), .O(z64));
