...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n202_, new_n204_, new_n205_, new_n207_, new_n208_, new_n212_,
  ...
  nand2  g149(.a(new_n288_), .b(x70), .O(new_n308_));
  inv1   g150(.a(x10), .O(new_n309_));
  nand2  g151(.a(new_n268_), .b(new_n309_), .O(new_n310_));
  inv1   g152(.a(x18), .O(new_n311_));
  nand2  g153(.a(x52), .b(new_n311_), .O(new_n312_));
  nand3  g154(.a(new_n312_), .b(new_n310_), .c(new_n293_), .O(new_n313_));
  aoi21  g155(.a(new_n313_), .b(new_n308_), .c(x01), .O(z50));
  nand2  g156(.a(new_n288_), .b(x71), .O(new_n315_));
  inv1   g157(.a(x11), .O(new_n316_));
  nand2  g158(.a(new_n268_), .b(new_n316_), .O(new_n317_));
  inv1   g159(.a(x19), .O(new_n318_));
  nand2  g160(.a(x52), .b(new_n318_), .O(new_n319_));
  nand3  g161(.a(new_n319_), .b(new_n317_), .c(new_n293_), .O(new_n320_));
  aoi21  g162(.a(new_n320_), .b(new_n315_), .c(x01), .O(z51));
