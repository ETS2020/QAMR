...
module FAU ( 
  ...
  nor2   g118(.a(x52), .b(x14), .O(new_n295_));
  oai21  g119(.a(new_n265_), .b(x22), .c(new_n153_), .O(new_n296_));
  nor3   g120(.a(new_n296_), .b(new_n295_), .c(new_n262_), .O(z54));
  inv1   g121(.a(x79), .O(new_n299_));
  aoi22  g122(.a(new_n256_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n300_));
  ...
  oai21  g126(.a(new_n162_), .b(new_n260_), .c(new_n299_), .O(new_n305_));
  ...
  oai21  g131(.a(new_n309_), .b(new_n307_), .c(new_n212_), .O(new_n310_));
  nor2   g132(.a(new_n161_), .b(new_n260_), .O(new_n311_));
  ...
  oai21  g142(.a(new_n320_), .b(new_n260_), .c(new_n153_), .O(new_n321_));
  aoi21  g143(.a(new_n319_), .b(x79), .c(new_n321_), .O(z59));
  nand3  g144(.a(new_n254_), .b(new_n160_), .c(x79), .O(new_n325_));
  aoi21  g145(.a(new_n310_), .b(x79), .c(new_n260_), .O(new_n326_));
  nand3  g146(.a(x81), .b(x79), .c(new_n260_), .O(new_n327_));
  nand2  g147(.a(new_n327_), .b(x77), .O(new_n328_));
  nand2  g148(.a(new_n254_), .b(x79), .O(new_n329_));
  nor2   g149(.a(new_n261_), .b(x77), .O(new_n330_));
  ...
  nand2  g153(.a(new_n215_), .b(new_n260_), .O(new_n335_));
  oai21  g154(.a(new_n256_), .b(new_n163_), .c(new_n335_), .O(new_n336_));
  nand3  g155(.a(new_n336_), .b(x83), .c(x79), .O(new_n337_));
  aoi21  g156(.a(new_n337_), .b(new_n262_), .c(x01), .O(z64));
