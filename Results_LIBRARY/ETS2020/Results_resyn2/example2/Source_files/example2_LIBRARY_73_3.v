// Benchmark "FAU" written by ABC on Sat Jul 25 01:26:46 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n328_, new_n329_, new_n330_, new_n331_, new_n332_, new_n337_,
  ...
  oai21  g177(.a(new_n313_), .b(x22), .c(new_n153_), .O(new_n338_));
  nor3   g178(.a(new_n338_), .b(new_n337_), .c(new_n310_), .O(z54));
  inv1   g179(.a(x82), .O(new_n340_));
  nand2  g180(.a(x84), .b(new_n340_), .O(new_n341_));
  nor4   g181(.a(new_n270_), .b(new_n250_), .c(new_n341_), .d(x80), .O(z55));
  inv1   g182(.a(new_n233_), .O(new_n343_));
  nor2   g183(.a(new_n343_), .b(new_n164_), .O(new_n344_));
  aoi21  g184(.a(new_n242_), .b(x76), .c(new_n344_), .O(new_n345_));
  aoi21  g185(.a(new_n154_), .b(new_n162_), .c(new_n237_), .O(new_n346_));
  oai21  g186(.a(new_n345_), .b(new_n170_), .c(new_n346_), .O(z56));
  inv1   g187(.a(x02), .O(new_n348_));
  nand3  g188(.a(new_n238_), .b(x03), .c(new_n348_), .O(new_n349_));
  inv1   g189(.a(new_n349_), .O(z57));
  aoi21  g190(.a(x42), .b(x40), .c(new_n230_), .O(new_n351_));
  nand3  g191(.a(new_n351_), .b(new_n228_), .c(x79), .O(new_n352_));
  nand4  g192(.a(new_n170_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n353_));
  nand2  g193(.a(new_n353_), .b(new_n352_), .O(new_n354_));
  nand2  g194(.a(new_n354_), .b(x77), .O(new_n355_));
  inv1   g195(.a(x04), .O(new_n356_));
  oai21  g196(.a(new_n161_), .b(new_n356_), .c(new_n170_), .O(new_n357_));
  aoi21  g197(.a(new_n357_), .b(new_n355_), .c(x01), .O(z58));
  inv1   g198(.a(new_n239_), .O(new_n359_));
  nand2  g199(.a(new_n170_), .b(new_n154_), .O(new_n360_));
  aoi21  g200(.a(new_n360_), .b(new_n230_), .c(new_n158_), .O(new_n361_));
  aoi21  g201(.a(new_n228_), .b(x79), .c(new_n230_), .O(new_n362_));
  oai21  g202(.a(new_n362_), .b(new_n361_), .c(x77), .O(new_n363_));
  aoi21  g203(.a(new_n363_), .b(new_n359_), .c(x01), .O(z59));
  aoi21  g204(.a(new_n344_), .b(x79), .c(new_n239_), .O(new_n365_));
  aoi21  g205(.a(new_n365_), .b(new_n232_), .c(x01), .O(z60));
  nand2  g206(.a(new_n233_), .b(new_n165_), .O(new_n367_));
  oai21  g207(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n368_));
  nand4  g208(.a(new_n368_), .b(new_n367_), .c(new_n171_), .d(x80), .O(new_n369_));
  inv1   g209(.a(new_n369_), .O(z61));
  nand4  g210(.a(new_n368_), .b(new_n367_), .c(new_n171_), .d(x82), .O(new_n372_));
  inv1   g211(.a(new_n372_), .O(z63));
  nand4  g212(.a(new_n368_), .b(new_n367_), .c(x83), .d(x79), .O(new_n374_));
  aoi21  g213(.a(new_n374_), .b(new_n310_), .c(x01), .O(z64));
  zero   g214(.O(z07));
  zero   g215(.O(z20));
  zero   g216(.O(z40));
  zero   g217(.O(z41));
