...
module FAU ( 
  ...
  nand2  g164(.a(new_n308_), .b(x69), .O(new_n322_));
  inv1   g165(.a(x09), .O(new_n323_));
  nand2  g166(.a(new_n315_), .b(new_n323_), .O(new_n324_));
  inv1   g167(.a(x17), .O(new_n325_));
  nand2  g168(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g169(.a(new_n326_), .b(new_n324_), .c(new_n313_), .O(new_n327_));
  aoi21  g170(.a(new_n327_), .b(new_n322_), .c(x01), .O(z49));
  nand2  g171(.a(new_n308_), .b(x70), .O(new_n329_));
  inv1   g172(.a(x10), .O(new_n330_));
  nand2  g173(.a(new_n315_), .b(new_n330_), .O(new_n331_));
  inv1   g174(.a(x18), .O(new_n332_));
  nand2  g175(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g176(.a(new_n333_), .b(new_n331_), .c(new_n313_), .O(new_n334_));
  aoi21  g177(.a(new_n334_), .b(new_n329_), .c(x01), .O(z50));
  nand2  g178(.a(new_n308_), .b(x71), .O(new_n336_));
  inv1   g179(.a(x11), .O(new_n337_));
  nand2  g180(.a(new_n315_), .b(new_n337_), .O(new_n338_));
  inv1   g181(.a(x19), .O(new_n339_));
  nand2  g182(.a(x52), .b(new_n339_), .O(new_n340_));
  nand3  g183(.a(new_n340_), .b(new_n338_), .c(new_n313_), .O(new_n341_));
  aoi21  g184(.a(new_n341_), .b(new_n336_), .c(x01), .O(z51));
  nand2  g185(.a(new_n308_), .b(x73), .O(new_n344_));
  inv1   g186(.a(x13), .O(new_n345_));
  nand2  g187(.a(new_n315_), .b(new_n345_), .O(new_n346_));
  inv1   g188(.a(x21), .O(new_n347_));
  nand2  g189(.a(x52), .b(new_n347_), .O(new_n348_));
  nand3  g190(.a(new_n348_), .b(new_n346_), .c(new_n313_), .O(new_n349_));
  aoi21  g191(.a(new_n349_), .b(new_n344_), .c(x01), .O(z53));
