...
module FAU ( 
  ...
  nand4  g148(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x59), .O(new_n301_));
  inv1   g149(.a(new_n301_), .O(z41));
  nand4  g150(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x60), .O(new_n303_));
  inv1   g151(.a(new_n303_), .O(z42));
  nand4  g152(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x62), .O(new_n306_));
  inv1   g153(.a(new_n306_), .O(z44));
  nand4  g154(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x63), .O(new_n308_));
  inv1   g155(.a(new_n308_), .O(z45));
  nand4  g156(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x64), .O(new_n310_));
  inv1   g157(.a(new_n310_), .O(z46));
  nand2  g158(.a(new_n163_), .b(x79), .O(new_n312_));
  nor2   g159(.a(new_n312_), .b(new_n237_), .O(new_n313_));
  oai21  g160(.a(x75), .b(x67), .c(new_n313_), .O(new_n314_));
  inv1   g161(.a(x04), .O(new_n315_));
  nor2   g162(.a(x77), .b(new_n315_), .O(new_n316_));
  nand2  g163(.a(new_n316_), .b(new_n155_), .O(new_n317_));
  ...
  oai21  g201(.a(new_n320_), .b(x22), .c(new_n153_), .O(new_n357_));
  nor3   g202(.a(new_n357_), .b(new_n356_), .c(new_n317_), .O(z54));
  inv1   g203(.a(x82), .O(new_n359_));
  nand2  g204(.a(x84), .b(new_n359_), .O(new_n360_));
  nor4   g205(.a(new_n274_), .b(new_n254_), .c(new_n360_), .d(x80), .O(z55));
  inv1   g206(.a(new_n237_), .O(new_n362_));
  nor2   g207(.a(new_n362_), .b(new_n164_), .O(new_n363_));
  aoi21  g208(.a(new_n246_), .b(x76), .c(new_n363_), .O(new_n364_));
  aoi21  g209(.a(new_n154_), .b(new_n162_), .c(new_n241_), .O(new_n365_));
  oai21  g210(.a(new_n364_), .b(new_n170_), .c(new_n365_), .O(z56));
  inv1   g211(.a(x02), .O(new_n367_));
  nand3  g212(.a(new_n242_), .b(x03), .c(new_n367_), .O(new_n368_));
  inv1   g213(.a(new_n368_), .O(z57));
  aoi21  g214(.a(x42), .b(x40), .c(new_n234_), .O(new_n370_));
  nand3  g215(.a(new_n370_), .b(new_n232_), .c(x79), .O(new_n371_));
  nand4  g216(.a(new_n170_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n372_));
  nand2  g217(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  nand2  g218(.a(new_n373_), .b(x77), .O(new_n374_));
  oai21  g219(.a(new_n161_), .b(new_n315_), .c(new_n170_), .O(new_n375_));
  aoi21  g220(.a(new_n375_), .b(new_n374_), .c(x01), .O(z58));
  inv1   g221(.a(new_n243_), .O(new_n377_));
  nand2  g222(.a(new_n170_), .b(new_n154_), .O(new_n378_));
  aoi21  g223(.a(new_n378_), .b(new_n234_), .c(new_n158_), .O(new_n379_));
  aoi21  g224(.a(new_n232_), .b(x79), .c(new_n234_), .O(new_n380_));
  oai21  g225(.a(new_n380_), .b(new_n379_), .c(x77), .O(new_n381_));
  aoi21  g226(.a(new_n381_), .b(new_n377_), .c(x01), .O(z59));
  aoi21  g227(.a(new_n363_), .b(x79), .c(new_n243_), .O(new_n383_));
  aoi21  g228(.a(new_n383_), .b(new_n236_), .c(x01), .O(z60));
  nand2  g229(.a(new_n237_), .b(new_n165_), .O(new_n385_));
  oai21  g230(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n386_));
  nand4  g231(.a(new_n386_), .b(new_n385_), .c(new_n171_), .d(x80), .O(new_n387_));
  inv1   g232(.a(new_n387_), .O(z61));
  nand4  g233(.a(new_n386_), .b(new_n385_), .c(new_n171_), .d(x82), .O(new_n390_));
  inv1   g234(.a(new_n390_), .O(z63));
  nand4  g235(.a(new_n386_), .b(new_n385_), .c(x83), .d(x79), .O(new_n392_));
  aoi21  g236(.a(new_n392_), .b(new_n317_), .c(x01), .O(z64));
  zero   g237(.O(z40));
  zero   g238(.O(z43));
  zero   g239(.O(z48));
  zero   g240(.O(z49));
