...
module FAU ( 
  ...
  nand2  g135(.a(new_n286_), .b(x71), .O(new_n306_));
  inv1   g136(.a(x11), .O(new_n307_));
  nand2  g137(.a(new_n292_), .b(new_n307_), .O(new_n308_));
  inv1   g138(.a(x19), .O(new_n309_));
  nand2  g139(.a(x52), .b(new_n309_), .O(new_n310_));
  nand3  g140(.a(new_n310_), .b(new_n308_), .c(new_n290_), .O(new_n311_));
  aoi21  g141(.a(new_n311_), .b(new_n306_), .c(x01), .O(z51));
