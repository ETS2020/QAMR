...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n180_, new_n184_, new_n185_, new_n188_, new_n189_, new_n192_,
  ...
  nand4  g101(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x57), .O(new_n269_));
  inv1   g102(.a(new_n269_), .O(z39));
  nand4  g103(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x58), .O(new_n271_));
  inv1   g104(.a(new_n271_), .O(z40));
  nand4  g105(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x59), .O(new_n273_));
  inv1   g106(.a(new_n273_), .O(z41));
  nand4  g107(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x60), .O(new_n275_));
  inv1   g108(.a(new_n275_), .O(z42));
  nand4  g109(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x61), .O(new_n277_));
  inv1   g110(.a(new_n277_), .O(z43));
  nand4  g111(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x62), .O(new_n279_));
  inv1   g112(.a(new_n279_), .O(z44));
  nand4  g113(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x63), .O(new_n281_));
  inv1   g114(.a(new_n281_), .O(z45));
  nand4  g115(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x64), .O(new_n283_));
