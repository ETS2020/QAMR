// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:27 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n302_, new_n305_, new_n307_, new_n309_, new_n311_, new_n312_,
    new_n313_, new_n314_, new_n315_, new_n316_, new_n317_, new_n318_,
    new_n319_, new_n320_, new_n321_, new_n324_, new_n325_, new_n326_,
    new_n327_, new_n328_, new_n329_, new_n331_, new_n332_, new_n333_,
    new_n334_, new_n335_, new_n336_, new_n338_, new_n339_, new_n340_,
    new_n341_, new_n342_, new_n343_, new_n347_, new_n348_, new_n350_,
  ...
  nor3   g086(.a(new_n237_), .b(new_n170_), .c(x41), .O(new_n238_));
  ...
  nand4  g102(.a(new_n248_), .b(x79), .c(x78), .d(x77), .O(new_n254_));
  ...
  nand2  g122(.a(x83), .b(new_n251_), .O(new_n274_));
  nand4  g123(.a(new_n274_), .b(new_n273_), .c(x42), .d(x05), .O(new_n275_));
  nand3  g124(.a(new_n251_), .b(x51), .c(new_n227_), .O(new_n276_));
  nand3  g125(.a(new_n276_), .b(new_n275_), .c(new_n252_), .O(new_n277_));
  inv1   g126(.a(new_n252_), .O(new_n278_));
  nand2  g127(.a(new_n274_), .b(new_n273_), .O(new_n279_));
  nand3  g128(.a(new_n279_), .b(x42), .c(x05), .O(new_n280_));
  nand3  g129(.a(x81), .b(x51), .c(new_n227_), .O(new_n281_));
  nand3  g130(.a(new_n281_), .b(new_n280_), .c(new_n278_), .O(new_n282_));
  nand3  g131(.a(new_n282_), .b(new_n277_), .c(new_n272_), .O(new_n283_));
  inv1   g132(.a(new_n283_), .O(z33));
  inv1   g133(.a(new_n253_), .O(new_n285_));
  nand3  g134(.a(new_n285_), .b(x83), .c(x42), .O(new_n286_));
  oai21  g135(.a(new_n230_), .b(new_n227_), .c(new_n253_), .O(new_n287_));
  nand4  g136(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x52), .O(new_n288_));
  inv1   g137(.a(new_n288_), .O(z34));
  nand4  g138(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x53), .O(new_n290_));
  inv1   g139(.a(new_n290_), .O(z35));
  nand4  g140(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x54), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(z36));
  nand4  g142(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x55), .O(new_n294_));
  inv1   g143(.a(new_n294_), .O(z37));
  nand4  g144(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x56), .O(new_n296_));
  inv1   g145(.a(new_n296_), .O(z38));
  nand4  g146(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x57), .O(new_n298_));
  inv1   g147(.a(new_n298_), .O(z39));
  nand4  g148(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x60), .O(new_n302_));
  inv1   g149(.a(new_n302_), .O(z42));
  nand4  g150(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x62), .O(new_n305_));
  inv1   g151(.a(new_n305_), .O(z44));
  nand4  g152(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x63), .O(new_n307_));
  inv1   g153(.a(new_n307_), .O(z45));
  nand4  g154(.a(new_n287_), .b(new_n286_), .c(new_n272_), .d(x64), .O(new_n309_));
  inv1   g155(.a(new_n309_), .O(z46));
  nand2  g156(.a(new_n163_), .b(x79), .O(new_n311_));
  nor2   g157(.a(new_n311_), .b(new_n237_), .O(new_n312_));
  oai21  g158(.a(x75), .b(x67), .c(new_n312_), .O(new_n313_));
  nand3  g159(.a(new_n155_), .b(new_n162_), .c(x04), .O(new_n314_));
  inv1   g160(.a(new_n314_), .O(new_n315_));
  inv1   g161(.a(x07), .O(new_n316_));
  inv1   g162(.a(x52), .O(new_n317_));
  nand2  g163(.a(new_n317_), .b(new_n316_), .O(new_n318_));
  inv1   g164(.a(x15), .O(new_n319_));
  nand2  g165(.a(x52), .b(new_n319_), .O(new_n320_));
  nand3  g166(.a(new_n320_), .b(new_n318_), .c(new_n315_), .O(new_n321_));
  aoi21  g167(.a(new_n321_), .b(new_n313_), .c(x01), .O(z47));
  nand2  g168(.a(new_n312_), .b(x69), .O(new_n324_));
  inv1   g169(.a(x09), .O(new_n325_));
  nand2  g170(.a(new_n317_), .b(new_n325_), .O(new_n326_));
  inv1   g171(.a(x17), .O(new_n327_));
  nand2  g172(.a(x52), .b(new_n327_), .O(new_n328_));
  nand3  g173(.a(new_n328_), .b(new_n326_), .c(new_n315_), .O(new_n329_));
  aoi21  g174(.a(new_n329_), .b(new_n324_), .c(x01), .O(z49));
  nand2  g175(.a(new_n312_), .b(x70), .O(new_n331_));
  inv1   g176(.a(x10), .O(new_n332_));
  nand2  g177(.a(new_n317_), .b(new_n332_), .O(new_n333_));
  inv1   g178(.a(x18), .O(new_n334_));
  nand2  g179(.a(x52), .b(new_n334_), .O(new_n335_));
  nand3  g180(.a(new_n335_), .b(new_n333_), .c(new_n315_), .O(new_n336_));
  aoi21  g181(.a(new_n336_), .b(new_n331_), .c(x01), .O(z50));
  nand2  g182(.a(new_n312_), .b(x71), .O(new_n338_));
  inv1   g183(.a(x11), .O(new_n339_));
  nand2  g184(.a(new_n317_), .b(new_n339_), .O(new_n340_));
  inv1   g185(.a(x19), .O(new_n341_));
  nand2  g186(.a(x52), .b(new_n341_), .O(new_n342_));
  nand3  g187(.a(new_n342_), .b(new_n340_), .c(new_n315_), .O(new_n343_));
  aoi21  g188(.a(new_n343_), .b(new_n338_), .c(x01), .O(z51));
  nor2   g189(.a(x52), .b(x14), .O(new_n347_));
  oai21  g190(.a(new_n317_), .b(x22), .c(new_n153_), .O(new_n348_));
  nor3   g191(.a(new_n348_), .b(new_n347_), .c(new_n314_), .O(z54));
  inv1   g192(.a(x82), .O(new_n350_));
  nand2  g193(.a(x84), .b(new_n350_), .O(new_n351_));
  nor4   g194(.a(new_n274_), .b(new_n254_), .c(new_n351_), .d(x80), .O(z55));
  inv1   g195(.a(new_n237_), .O(new_n353_));
  nor2   g196(.a(new_n353_), .b(new_n164_), .O(new_n354_));
  aoi21  g197(.a(new_n246_), .b(x76), .c(new_n354_), .O(new_n355_));
  aoi21  g198(.a(new_n154_), .b(new_n162_), .c(new_n241_), .O(new_n356_));
  oai21  g199(.a(new_n355_), .b(new_n170_), .c(new_n356_), .O(z56));
  inv1   g200(.a(x02), .O(new_n358_));
  nand3  g201(.a(new_n242_), .b(x03), .c(new_n358_), .O(new_n359_));
  inv1   g202(.a(new_n359_), .O(z57));
  aoi21  g203(.a(x42), .b(x40), .c(new_n234_), .O(new_n361_));
  nand3  g204(.a(new_n361_), .b(new_n232_), .c(x79), .O(new_n362_));
  nand4  g205(.a(new_n170_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n363_));
  nand2  g206(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(x77), .O(new_n365_));
  inv1   g208(.a(x04), .O(new_n366_));
  oai21  g209(.a(new_n161_), .b(new_n366_), .c(new_n170_), .O(new_n367_));
  aoi21  g210(.a(new_n367_), .b(new_n365_), .c(x01), .O(z58));
  inv1   g211(.a(new_n243_), .O(new_n369_));
  nand2  g212(.a(new_n170_), .b(new_n154_), .O(new_n370_));
  aoi21  g213(.a(new_n370_), .b(new_n234_), .c(new_n158_), .O(new_n371_));
  aoi21  g214(.a(new_n232_), .b(x79), .c(new_n234_), .O(new_n372_));
  oai21  g215(.a(new_n372_), .b(new_n371_), .c(x77), .O(new_n373_));
  aoi21  g216(.a(new_n373_), .b(new_n369_), .c(x01), .O(z59));
  aoi21  g217(.a(new_n354_), .b(x79), .c(new_n243_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(new_n236_), .c(x01), .O(z60));
  nand2  g219(.a(new_n237_), .b(new_n165_), .O(new_n377_));
  oai21  g220(.a(new_n162_), .b(x04), .c(new_n164_), .O(new_n378_));
  nand4  g221(.a(new_n378_), .b(new_n377_), .c(new_n171_), .d(x80), .O(new_n379_));
  inv1   g222(.a(new_n379_), .O(z61));
  nand4  g223(.a(new_n378_), .b(new_n377_), .c(new_n171_), .d(x82), .O(new_n382_));
  inv1   g224(.a(new_n382_), .O(z63));
  nand4  g225(.a(new_n378_), .b(new_n377_), .c(x83), .d(x79), .O(new_n384_));
  aoi21  g226(.a(new_n384_), .b(new_n314_), .c(x01), .O(z64));
  zero   g227(.O(z40));
  zero   g228(.O(z41));
  zero   g229(.O(z43));
  zero   g230(.O(z48));
