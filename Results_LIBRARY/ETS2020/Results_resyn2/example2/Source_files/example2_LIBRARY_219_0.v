...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n181_, new_n184_, new_n185_, new_n192_, new_n193_, new_n195_,
    ...
    new_n358_, new_n360_, new_n363_, new_n364_;
  ...
  nand2  g134(.a(new_n280_), .b(x72), .O(new_n307_));
  inv1   g135(.a(x12), .O(new_n308_));
  nand2  g136(.a(new_n286_), .b(new_n308_), .O(new_n309_));
  inv1   g137(.a(x20), .O(new_n310_));
  nand2  g138(.a(x52), .b(new_n310_), .O(new_n311_));
  nand3  g139(.a(new_n311_), .b(new_n309_), .c(new_n284_), .O(new_n312_));
  aoi21  g140(.a(new_n312_), .b(new_n307_), .c(x01), .O(z52));
  nand2  g141(.a(new_n280_), .b(x73), .O(new_n314_));
  inv1   g142(.a(x13), .O(new_n315_));
  nand2  g143(.a(new_n286_), .b(new_n315_), .O(new_n316_));
  inv1   g144(.a(x21), .O(new_n317_));
  nand2  g145(.a(x52), .b(new_n317_), .O(new_n318_));
  nand3  g146(.a(new_n318_), .b(new_n316_), .c(new_n284_), .O(new_n319_));
  aoi21  g147(.a(new_n319_), .b(new_n314_), .c(x01), .O(z53));
  inv1   g148(.a(x82), .O(new_n322_));
  nand2  g149(.a(x84), .b(new_n322_), .O(new_n323_));
  nor4   g150(.a(new_n323_), .b(new_n202_), .c(x81), .d(x80), .O(new_n324_));
  and2   g151(.a(new_n324_), .b(new_n245_), .O(z55));
  oai21  g152(.a(new_n208_), .b(x76), .c(new_n219_), .O(new_n326_));
  aoi21  g153(.a(new_n154_), .b(new_n157_), .c(new_n212_), .O(new_n327_));
  nand2  g154(.a(new_n327_), .b(new_n326_), .O(z56));
  inv1   g155(.a(x02), .O(new_n329_));
  nand3  g156(.a(new_n213_), .b(x03), .c(new_n329_), .O(new_n330_));
  inv1   g157(.a(new_n330_), .O(z57));
  oai21  g158(.a(new_n155_), .b(new_n214_), .c(new_n161_), .O(new_n332_));
  nand2  g159(.a(x78), .b(x04), .O(new_n333_));
  aoi21  g160(.a(x42), .b(x40), .c(new_n333_), .O(new_n334_));
  nand3  g161(.a(new_n334_), .b(new_n204_), .c(x79), .O(new_n335_));
  nand4  g162(.a(new_n161_), .b(new_n154_), .c(new_n199_), .d(x40), .O(new_n336_));
  nand2  g163(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  nand2  g164(.a(new_n337_), .b(x77), .O(new_n338_));
  aoi21  g165(.a(new_n338_), .b(new_n332_), .c(x01), .O(z58));
  nor2   g166(.a(new_n158_), .b(new_n155_), .O(new_n341_));
  inv1   g167(.a(new_n341_), .O(new_n342_));
  nor2   g168(.a(new_n282_), .b(new_n209_), .O(new_n343_));
  oai21  g169(.a(new_n342_), .b(new_n161_), .c(new_n343_), .O(new_n344_));
  aoi21  g170(.a(new_n344_), .b(new_n206_), .c(x01), .O(z60));
  nand2  g171(.a(new_n218_), .b(new_n214_), .O(new_n346_));
  oai21  g172(.a(new_n341_), .b(new_n208_), .c(new_n346_), .O(new_n347_));
  nand3  g173(.a(new_n347_), .b(new_n162_), .c(x80), .O(new_n348_));
  inv1   g174(.a(new_n348_), .O(z61));
  nand3  g175(.a(x84), .b(x81), .c(x79), .O(new_n350_));
  inv1   g176(.a(new_n350_), .O(new_n351_));
  nand2  g177(.a(new_n351_), .b(new_n158_), .O(new_n352_));
  aoi21  g178(.a(new_n204_), .b(x79), .c(new_n214_), .O(new_n353_));
  nand3  g179(.a(x81), .b(x79), .c(new_n214_), .O(new_n354_));
  nand2  g180(.a(new_n354_), .b(x77), .O(new_n355_));
  nor2   g181(.a(new_n282_), .b(x77), .O(new_n356_));
  aoi21  g182(.a(new_n356_), .b(new_n350_), .c(new_n154_), .O(new_n357_));
  oai21  g183(.a(new_n355_), .b(new_n353_), .c(new_n357_), .O(new_n358_));
  aoi21  g184(.a(new_n358_), .b(new_n352_), .c(x01), .O(z62));
  nand3  g185(.a(new_n347_), .b(new_n162_), .c(x82), .O(new_n360_));
  inv1   g186(.a(new_n360_), .O(z63));
  nand2  g187(.a(new_n342_), .b(x81), .O(new_n363_));
  nand2  g188(.a(new_n162_), .b(x84), .O(new_n364_));
  aoi21  g189(.a(new_n363_), .b(new_n346_), .c(new_n364_), .O(z65));
  zero   g190(.O(z00));
  zero   g191(.O(z01));
  zero   g192(.O(z04));
  zero   g193(.O(z05));
