...
module FAU ( 
  ...
  nand3  g072(.a(new_n223_), .b(x50), .c(new_n214_), .O(new_n236_));
  inv1   g073(.a(new_n236_), .O(z32));
  ...
  nand4  g082(.a(new_n242_), .b(new_n240_), .c(new_n239_), .d(x54), .O(new_n247_));
  inv1   g083(.a(new_n247_), .O(z36));
  nand4  g084(.a(new_n242_), .b(new_n240_), .c(new_n239_), .d(x58), .O(new_n252_));
  inv1   g085(.a(new_n252_), .O(z40));
  nand4  g086(.a(new_n242_), .b(new_n240_), .c(new_n239_), .d(x59), .O(new_n254_));
  inv1   g087(.a(new_n254_), .O(z41));
  nand4  g088(.a(new_n242_), .b(new_n240_), .c(new_n239_), .d(x61), .O(new_n257_));
  inv1   g089(.a(new_n257_), .O(z43));
  ...
  nand2  g114(.a(new_n266_), .b(x72), .O(new_n289_));
  inv1   g115(.a(x12), .O(new_n290_));
  nand2  g116(.a(new_n273_), .b(new_n290_), .O(new_n291_));
  inv1   g117(.a(x20), .O(new_n292_));
  nand2  g118(.a(x52), .b(new_n292_), .O(new_n293_));
  nand3  g119(.a(new_n293_), .b(new_n291_), .c(new_n271_), .O(new_n294_));
  aoi21  g120(.a(new_n294_), .b(new_n289_), .c(x01), .O(z52));
  nand2  g121(.a(new_n266_), .b(x73), .O(new_n296_));
  inv1   g122(.a(x13), .O(new_n297_));
  nand2  g123(.a(new_n273_), .b(new_n297_), .O(new_n298_));
  inv1   g124(.a(x21), .O(new_n299_));
  nand2  g125(.a(x52), .b(new_n299_), .O(new_n300_));
  nand3  g126(.a(new_n300_), .b(new_n298_), .c(new_n271_), .O(new_n301_));
  aoi21  g127(.a(new_n301_), .b(new_n296_), .c(x01), .O(z53));
  nor2   g128(.a(x52), .b(x14), .O(new_n303_));
  oai21  g129(.a(new_n273_), .b(x22), .c(new_n153_), .O(new_n304_));
  nor3   g130(.a(new_n304_), .b(new_n303_), .c(new_n270_), .O(z54));
  inv1   g131(.a(x79), .O(new_n307_));
  aoi22  g132(.a(new_n264_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n308_));
  ...
  oai21  g136(.a(new_n162_), .b(new_n268_), .c(new_n307_), .O(new_n313_));
  nand3  g137(.a(new_n241_), .b(x82), .c(x80), .O(new_n314_));
  inv1   g138(.a(x74), .O(new_n315_));
  nand4  g139(.a(x84), .b(x81), .c(new_n315_), .d(x43), .O(new_n316_));
  oai21  g140(.a(new_n316_), .b(new_n314_), .c(new_n214_), .O(new_n317_));
  nor2   g141(.a(new_n161_), .b(new_n268_), .O(new_n318_));
  nand3  g142(.a(new_n318_), .b(new_n317_), .c(x79), .O(new_n319_));
  nand3  g143(.a(new_n307_), .b(new_n161_), .c(x40), .O(new_n320_));
  ...
  aoi21  g147(.a(new_n323_), .b(new_n313_), .c(x01), .O(z58));
  ...
  oai21  g151(.a(new_n327_), .b(new_n268_), .c(new_n153_), .O(new_n328_));
  aoi21  g152(.a(new_n326_), .b(x79), .c(new_n328_), .O(z59));
  nand3  g153(.a(new_n262_), .b(new_n160_), .c(x79), .O(new_n332_));
  aoi21  g154(.a(new_n317_), .b(x79), .c(new_n268_), .O(new_n333_));
  nand3  g155(.a(x81), .b(x79), .c(new_n268_), .O(new_n334_));
  nand2  g156(.a(new_n334_), .b(x77), .O(new_n335_));
  nand2  g157(.a(new_n262_), .b(x79), .O(new_n336_));
  nor2   g158(.a(new_n269_), .b(x77), .O(new_n337_));
  ...
  nand2  g162(.a(new_n221_), .b(new_n268_), .O(new_n342_));
  oai21  g163(.a(new_n264_), .b(new_n163_), .c(new_n342_), .O(new_n343_));
  nand3  g164(.a(new_n343_), .b(x83), .c(x79), .O(new_n344_));
  aoi21  g165(.a(new_n344_), .b(new_n270_), .c(x01), .O(z64));
