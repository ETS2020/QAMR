...
module FAU ( 
  ...
  nand2  g105(.a(x83), .b(x42), .O(new_n270_));
  xor2a  g106(.a(new_n270_), .b(new_n238_), .O(new_n271_));
  nand3  g107(.a(new_n271_), .b(new_n261_), .c(x54), .O(new_n272_));
  inv1   g108(.a(new_n272_), .O(z36));
  nand3  g109(.a(new_n271_), .b(new_n261_), .c(x55), .O(new_n274_));
  inv1   g110(.a(new_n274_), .O(z37));
  nand3  g111(.a(new_n271_), .b(new_n261_), .c(x56), .O(new_n276_));
  inv1   g112(.a(new_n276_), .O(z38));
  nand3  g113(.a(new_n271_), .b(new_n261_), .c(x57), .O(new_n278_));
  inv1   g114(.a(new_n278_), .O(z39));
  nand3  g115(.a(new_n271_), .b(new_n261_), .c(x58), .O(new_n280_));
  inv1   g116(.a(new_n280_), .O(z40));
  nand3  g117(.a(new_n271_), .b(new_n261_), .c(x60), .O(new_n283_));
  inv1   g118(.a(new_n283_), .O(z42));
  nand3  g119(.a(new_n271_), .b(new_n261_), .c(x61), .O(new_n285_));
  inv1   g120(.a(new_n285_), .O(z43));
  nand3  g121(.a(new_n271_), .b(new_n261_), .c(x62), .O(new_n287_));
  inv1   g122(.a(new_n287_), .O(z44));
  nand3  g123(.a(new_n271_), .b(new_n261_), .c(x63), .O(new_n289_));
  inv1   g124(.a(new_n289_), .O(z45));
  nand3  g125(.a(new_n271_), .b(new_n261_), .c(x64), .O(new_n291_));
