// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:33 2020
...
module FAU ( 
  ...
  nand3  g062(.a(new_n215_), .b(x50), .c(new_n210_), .O(new_n228_));
  inv1   g063(.a(new_n228_), .O(z32));
  inv1   g064(.a(new_n214_), .O(new_n231_));
  nand2  g065(.a(x83), .b(x42), .O(new_n232_));
  xor2a  g066(.a(new_n232_), .b(new_n212_), .O(new_n233_));
  nand3  g067(.a(new_n233_), .b(new_n231_), .c(x52), .O(new_n234_));
  inv1   g068(.a(new_n234_), .O(z34));
  nand3  g069(.a(new_n233_), .b(new_n231_), .c(x53), .O(new_n236_));
  inv1   g070(.a(new_n236_), .O(z35));
  nand3  g071(.a(new_n233_), .b(new_n231_), .c(x58), .O(new_n242_));
  inv1   g072(.a(new_n242_), .O(z40));
  nand3  g073(.a(new_n233_), .b(new_n231_), .c(x59), .O(new_n244_));
  inv1   g074(.a(new_n244_), .O(z41));
  nand3  g075(.a(new_n233_), .b(new_n231_), .c(x61), .O(new_n247_));
  inv1   g076(.a(new_n247_), .O(z43));
  and2   g077(.a(x84), .b(x81), .O(new_n252_));
  nor2   g078(.a(x84), .b(x81), .O(new_n253_));
  nor2   g079(.a(new_n253_), .b(new_n252_), .O(new_n254_));
  nand2  g080(.a(new_n160_), .b(x79), .O(new_n255_));
  nor2   g081(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  oai21  g082(.a(x75), .b(x67), .c(new_n256_), .O(new_n257_));
  inv1   g083(.a(x04), .O(new_n258_));
  nor2   g084(.a(x79), .b(new_n258_), .O(new_n259_));
  nand2  g085(.a(new_n259_), .b(new_n162_), .O(new_n260_));
  inv1   g086(.a(new_n260_), .O(new_n261_));
  inv1   g087(.a(x07), .O(new_n262_));
  inv1   g088(.a(x52), .O(new_n263_));
  nand2  g089(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  inv1   g090(.a(x15), .O(new_n265_));
  nand2  g091(.a(x52), .b(new_n265_), .O(new_n266_));
  nand3  g092(.a(new_n266_), .b(new_n264_), .c(new_n261_), .O(new_n267_));
  aoi21  g093(.a(new_n267_), .b(new_n257_), .c(x01), .O(z47));
  nand2  g094(.a(new_n256_), .b(x68), .O(new_n269_));
  inv1   g095(.a(x08), .O(new_n270_));
  nand2  g096(.a(new_n263_), .b(new_n270_), .O(new_n271_));
  inv1   g097(.a(x16), .O(new_n272_));
  nand2  g098(.a(x52), .b(new_n272_), .O(new_n273_));
  nand3  g099(.a(new_n273_), .b(new_n271_), .c(new_n261_), .O(new_n274_));
  aoi21  g100(.a(new_n274_), .b(new_n269_), .c(x01), .O(z48));
  nand2  g101(.a(new_n256_), .b(x72), .O(new_n279_));
  inv1   g102(.a(x12), .O(new_n280_));
  nand2  g103(.a(new_n263_), .b(new_n280_), .O(new_n281_));
  inv1   g104(.a(x20), .O(new_n282_));
  nand2  g105(.a(x52), .b(new_n282_), .O(new_n283_));
  nand3  g106(.a(new_n283_), .b(new_n281_), .c(new_n261_), .O(new_n284_));
  aoi21  g107(.a(new_n284_), .b(new_n279_), .c(x01), .O(z52));
  nand2  g108(.a(new_n256_), .b(x73), .O(new_n286_));
  inv1   g109(.a(x13), .O(new_n287_));
  nand2  g110(.a(new_n263_), .b(new_n287_), .O(new_n288_));
  inv1   g111(.a(x21), .O(new_n289_));
  nand2  g112(.a(x52), .b(new_n289_), .O(new_n290_));
  nand3  g113(.a(new_n290_), .b(new_n288_), .c(new_n261_), .O(new_n291_));
  aoi21  g114(.a(new_n291_), .b(new_n286_), .c(x01), .O(z53));
  nor2   g115(.a(x52), .b(x14), .O(new_n293_));
  oai21  g116(.a(new_n263_), .b(x22), .c(new_n153_), .O(new_n294_));
  nor3   g117(.a(new_n294_), .b(new_n293_), .c(new_n260_), .O(z54));
  inv1   g118(.a(x79), .O(new_n297_));
  aoi22  g119(.a(new_n254_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n298_));
  ...
  oai21  g123(.a(new_n162_), .b(new_n258_), .c(new_n297_), .O(new_n303_));
  ...
  oai21  g128(.a(new_n307_), .b(new_n305_), .c(new_n210_), .O(new_n308_));
  nor2   g129(.a(new_n161_), .b(new_n258_), .O(new_n309_));
  ...
  oai21  g139(.a(new_n318_), .b(new_n258_), .c(new_n153_), .O(new_n319_));
  aoi21  g140(.a(new_n317_), .b(x79), .c(new_n319_), .O(z59));
  nand3  g141(.a(new_n252_), .b(new_n160_), .c(x79), .O(new_n323_));
  aoi21  g142(.a(new_n308_), .b(x79), .c(new_n258_), .O(new_n324_));
  nand3  g143(.a(x81), .b(x79), .c(new_n258_), .O(new_n325_));
  nand2  g144(.a(new_n325_), .b(x77), .O(new_n326_));
  nand2  g145(.a(new_n252_), .b(x79), .O(new_n327_));
  nor2   g146(.a(new_n259_), .b(x77), .O(new_n328_));
  ...
  nand2  g150(.a(new_n213_), .b(new_n258_), .O(new_n333_));
  oai21  g151(.a(new_n254_), .b(new_n163_), .c(new_n333_), .O(new_n334_));
  nand3  g152(.a(new_n334_), .b(x83), .c(x79), .O(new_n335_));
  aoi21  g153(.a(new_n335_), .b(new_n260_), .c(x01), .O(z64));
