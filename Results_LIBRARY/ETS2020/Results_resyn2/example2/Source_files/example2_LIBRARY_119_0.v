// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:05 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n180_, new_n182_, new_n183_, new_n186_, new_n187_, new_n192_,
  ...
  nand4  g108(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x61), .O(new_n277_));
  inv1   g109(.a(new_n277_), .O(z43));
  nand4  g110(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x62), .O(new_n279_));
  inv1   g111(.a(new_n279_), .O(z44));
  nand4  g112(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x63), .O(new_n281_));
  inv1   g113(.a(new_n281_), .O(z45));
  nand4  g114(.a(new_n263_), .b(new_n262_), .c(new_n252_), .d(x64), .O(new_n283_));
  ...
  and2   g166(.a(new_n336_), .b(new_n252_), .O(z55));
