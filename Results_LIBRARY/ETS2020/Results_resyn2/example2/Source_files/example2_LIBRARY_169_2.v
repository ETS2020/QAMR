...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n211_, new_n212_, new_n214_, new_n215_, new_n219_, new_n220_,
  ...
  inv1   g065(.a(x44), .O(new_n219_));
  nor2   g066(.a(x40), .b(x39), .O(new_n220_));
  aoi21  g067(.a(new_n219_), .b(x40), .c(new_n220_), .O(z21));
  inv1   g068(.a(x42), .O(new_n222_));
  inv1   g069(.a(x83), .O(new_n223_));
  nand3  g070(.a(x84), .b(new_n223_), .c(x82), .O(new_n224_));
  inv1   g071(.a(x74), .O(new_n225_));
  nand4  g072(.a(x81), .b(x80), .c(new_n225_), .d(x43), .O(new_n226_));
  oai21  g073(.a(new_n226_), .b(new_n224_), .c(new_n222_), .O(new_n227_));
  oai21  g074(.a(new_n227_), .b(new_n161_), .c(x79), .O(new_n228_));
  inv1   g075(.a(x04), .O(new_n229_));
  nor2   g076(.a(new_n154_), .b(new_n229_), .O(new_n230_));
  nand2  g077(.a(new_n230_), .b(new_n228_), .O(new_n231_));
  xnor2a g078(.a(x84), .b(x81), .O(new_n232_));
  nor2   g079(.a(new_n169_), .b(x41), .O(new_n233_));
  nand3  g080(.a(new_n233_), .b(new_n232_), .c(new_n168_), .O(new_n234_));
  aoi21  g081(.a(new_n234_), .b(new_n231_), .c(x01), .O(z22));
  nand3  g082(.a(new_n169_), .b(x05), .c(new_n229_), .O(new_n236_));
  nand3  g083(.a(new_n236_), .b(new_n153_), .c(x00), .O(z23));
  nor3   g084(.a(new_n154_), .b(new_n161_), .c(x04), .O(new_n239_));
  nand2  g085(.a(new_n239_), .b(new_n170_), .O(new_n240_));
  ...
  nand3  g090(.a(new_n244_), .b(new_n222_), .c(x05), .O(new_n245_));
  inv1   g091(.a(new_n245_), .O(z25));
  nand3  g092(.a(new_n244_), .b(x44), .c(new_n222_), .O(new_n247_));
  inv1   g093(.a(new_n247_), .O(z26));
  nand3  g094(.a(new_n244_), .b(x47), .c(new_n222_), .O(new_n251_));
  inv1   g095(.a(new_n251_), .O(z29));
  nand3  g096(.a(new_n244_), .b(x48), .c(new_n222_), .O(new_n253_));
  inv1   g097(.a(new_n253_), .O(z30));
  nand3  g098(.a(new_n244_), .b(x49), .c(new_n222_), .O(new_n255_));
  inv1   g099(.a(new_n255_), .O(z31));
  nand3  g100(.a(new_n244_), .b(x50), .c(new_n222_), .O(new_n257_));
  inv1   g101(.a(new_n257_), .O(z32));
  nand2  g102(.a(x83), .b(new_n241_), .O(new_n259_));
  nand2  g103(.a(new_n223_), .b(x81), .O(new_n260_));
  ...
  nand3  g109(.a(new_n265_), .b(x51), .c(new_n222_), .O(new_n266_));
  aoi21  g110(.a(new_n266_), .b(new_n264_), .c(new_n240_), .O(z33));
  inv1   g111(.a(x52), .O(new_n268_));
  nor2   g112(.a(new_n223_), .b(new_n222_), .O(new_n269_));
  ...
  nor3   g124(.a(new_n270_), .b(new_n240_), .c(new_n199_), .O(z39));
  nor3   g125(.a(new_n270_), .b(new_n240_), .c(new_n196_), .O(z40));
  nor3   g126(.a(new_n270_), .b(new_n240_), .c(new_n193_), .O(z41));
  nor3   g127(.a(new_n270_), .b(new_n240_), .c(new_n190_), .O(z42));
  nor3   g128(.a(new_n270_), .b(new_n240_), .c(new_n187_), .O(z43));
  nor3   g129(.a(new_n270_), .b(new_n240_), .c(new_n184_), .O(z44));
  nor3   g130(.a(new_n270_), .b(new_n240_), .c(new_n181_), .O(z45));
  nor3   g131(.a(new_n270_), .b(new_n240_), .c(new_n178_), .O(z46));
  inv1   g132(.a(new_n232_), .O(new_n289_));
  nor3   g133(.a(new_n289_), .b(new_n163_), .c(new_n169_), .O(new_n290_));
  oai21  g134(.a(x75), .b(x67), .c(new_n290_), .O(new_n291_));
  nor2   g135(.a(x77), .b(new_n229_), .O(new_n292_));
  nand2  g136(.a(new_n292_), .b(new_n155_), .O(new_n293_));
  ...
  aoi21  g143(.a(new_n299_), .b(new_n291_), .c(x01), .O(z47));
  nand2  g144(.a(new_n290_), .b(x68), .O(new_n301_));
  ...
  nand2  g151(.a(new_n290_), .b(x69), .O(new_n308_));
  ...
  nand2  g158(.a(new_n290_), .b(x70), .O(new_n315_));
  ...
  nand2  g165(.a(new_n290_), .b(x71), .O(new_n322_));
  ...
  nand2  g172(.a(new_n290_), .b(x72), .O(new_n329_));
  ...
  nand2  g179(.a(new_n290_), .b(x73), .O(new_n336_));
  ...
  nand2  g196(.a(new_n227_), .b(new_n158_), .O(new_n355_));
  nand2  g197(.a(new_n355_), .b(new_n230_), .O(new_n356_));
  aoi21  g198(.a(new_n154_), .b(new_n158_), .c(new_n161_), .O(new_n357_));
  oai21  g199(.a(new_n357_), .b(new_n229_), .c(new_n153_), .O(new_n358_));
  aoi21  g200(.a(new_n356_), .b(x79), .c(new_n358_), .O(z59));
  inv1   g201(.a(new_n170_), .O(new_n361_));
  nand2  g202(.a(new_n232_), .b(new_n164_), .O(new_n362_));
  nand3  g203(.a(x78), .b(x77), .c(new_n229_), .O(new_n363_));
  nand2  g204(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  inv1   g205(.a(new_n364_), .O(new_n365_));
  nor3   g206(.a(new_n365_), .b(new_n361_), .c(new_n346_), .O(z61));
  aoi21  g207(.a(new_n227_), .b(x79), .c(new_n229_), .O(new_n367_));
  nand3  g208(.a(x81), .b(x79), .c(new_n229_), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(x77), .O(new_n369_));
  and2   g210(.a(x84), .b(x81), .O(new_n370_));
  nand2  g211(.a(new_n169_), .b(new_n229_), .O(new_n371_));
  oai21  g212(.a(new_n370_), .b(new_n169_), .c(new_n371_), .O(new_n372_));
  aoi21  g213(.a(new_n372_), .b(new_n161_), .c(new_n154_), .O(new_n373_));
  oai21  g214(.a(new_n369_), .b(new_n367_), .c(new_n373_), .O(new_n374_));
  nand4  g215(.a(new_n370_), .b(x79), .c(new_n154_), .d(x77), .O(new_n375_));
  aoi21  g216(.a(new_n375_), .b(new_n374_), .c(x01), .O(z62));
  nor3   g217(.a(new_n365_), .b(new_n361_), .c(new_n347_), .O(z63));
  nand3  g218(.a(new_n364_), .b(x83), .c(x79), .O(new_n378_));
  aoi21  g219(.a(new_n378_), .b(new_n293_), .c(x01), .O(z64));
  nand2  g220(.a(new_n164_), .b(x81), .O(new_n380_));
  nand2  g221(.a(new_n170_), .b(x84), .O(new_n381_));
  aoi21  g222(.a(new_n380_), .b(new_n363_), .c(new_n381_), .O(z65));
  zero   g223(.O(z19));
  zero   g224(.O(z20));
  zero   g225(.O(z24));
  zero   g226(.O(z27));
