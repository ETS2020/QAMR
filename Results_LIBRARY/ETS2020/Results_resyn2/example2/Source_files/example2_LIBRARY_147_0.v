...
module FAU ( 
  ...
  nor4   g163(.a(new_n332_), .b(new_n212_), .c(x81), .d(x80), .O(new_n333_));
  and2   g164(.a(new_n333_), .b(new_n254_), .O(z55));
  oai21  g165(.a(new_n218_), .b(x76), .c(new_n229_), .O(new_n335_));
  aoi21  g166(.a(new_n154_), .b(new_n157_), .c(new_n222_), .O(new_n336_));
  nand2  g167(.a(new_n336_), .b(new_n335_), .O(z56));
  inv1   g168(.a(x02), .O(new_n338_));
  nand3  g169(.a(new_n223_), .b(x03), .c(new_n338_), .O(new_n339_));
  inv1   g170(.a(new_n339_), .O(z57));
  oai21  g171(.a(new_n155_), .b(new_n224_), .c(new_n161_), .O(new_n341_));
  nand2  g172(.a(x78), .b(x04), .O(new_n342_));
  aoi21  g173(.a(x42), .b(x40), .c(new_n342_), .O(new_n343_));
  nand3  g174(.a(new_n343_), .b(new_n214_), .c(x79), .O(new_n344_));
  nand4  g175(.a(new_n161_), .b(new_n154_), .c(new_n209_), .d(x40), .O(new_n345_));
  ...
  nor2   g181(.a(new_n291_), .b(new_n219_), .O(new_n352_));
  oai21  g182(.a(new_n351_), .b(new_n161_), .c(new_n352_), .O(new_n353_));
  aoi21  g183(.a(new_n353_), .b(new_n216_), .c(x01), .O(z60));
  nand2  g184(.a(new_n228_), .b(new_n224_), .O(new_n355_));
  oai21  g185(.a(new_n350_), .b(new_n218_), .c(new_n355_), .O(new_n356_));
  ...
  aoi21  g191(.a(new_n214_), .b(x79), .c(new_n224_), .O(new_n362_));
  nand3  g192(.a(x81), .b(x79), .c(new_n224_), .O(new_n363_));
  nand2  g193(.a(new_n363_), .b(x77), .O(new_n364_));
  nor2   g194(.a(new_n291_), .b(x77), .O(new_n365_));
