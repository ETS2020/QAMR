...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n179_, new_n181_, new_n182_, new_n186_, new_n187_, new_n192_,
    ...
    new_n239_, new_n241_, new_n243_, new_n248_, new_n249_, new_n250_,
  ...
  nor2   g160(.a(x52), .b(x14), .O(new_n329_));
  oai21  g161(.a(new_n294_), .b(x22), .c(new_n164_), .O(new_n330_));
  nor3   g162(.a(new_n330_), .b(new_n329_), .c(new_n291_), .O(z54));
  inv1   g163(.a(x82), .O(new_n332_));
  nand2  g164(.a(x84), .b(new_n332_), .O(new_n333_));
  nor4   g165(.a(new_n333_), .b(new_n210_), .c(x81), .d(x80), .O(new_n334_));
  and2   g166(.a(new_n334_), .b(new_n253_), .O(z55));
  oai21  g167(.a(new_n216_), .b(x76), .c(new_n227_), .O(new_n336_));
  aoi21  g168(.a(new_n154_), .b(new_n157_), .c(new_n220_), .O(new_n337_));
  nand2  g169(.a(new_n337_), .b(new_n336_), .O(z56));
  inv1   g170(.a(x02), .O(new_n339_));
  nand3  g171(.a(new_n221_), .b(x03), .c(new_n339_), .O(new_n340_));
  inv1   g172(.a(new_n340_), .O(z57));
  oai21  g173(.a(new_n155_), .b(new_n222_), .c(new_n161_), .O(new_n342_));
  nand2  g174(.a(x78), .b(x04), .O(new_n343_));
  aoi21  g175(.a(x42), .b(x40), .c(new_n343_), .O(new_n344_));
  nand3  g176(.a(new_n344_), .b(new_n212_), .c(x79), .O(new_n345_));
  nand4  g177(.a(new_n161_), .b(new_n154_), .c(new_n207_), .d(x40), .O(new_n346_));
  ...
  nor2   g183(.a(new_n290_), .b(new_n217_), .O(new_n353_));
  oai21  g184(.a(new_n352_), .b(new_n161_), .c(new_n353_), .O(new_n354_));
  aoi21  g185(.a(new_n354_), .b(new_n214_), .c(x01), .O(z60));
  nand2  g186(.a(new_n226_), .b(new_n222_), .O(new_n356_));
  oai21  g187(.a(new_n351_), .b(new_n216_), .c(new_n356_), .O(new_n357_));
  ...
  aoi21  g193(.a(new_n212_), .b(x79), .c(new_n222_), .O(new_n363_));
  nand3  g194(.a(x81), .b(x79), .c(new_n222_), .O(new_n364_));
  nand2  g195(.a(new_n364_), .b(x77), .O(new_n365_));
  nor2   g196(.a(new_n290_), .b(x77), .O(new_n366_));
