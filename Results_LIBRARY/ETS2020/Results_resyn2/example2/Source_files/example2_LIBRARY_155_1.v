...
module FAU ( 
  ...
  nand2  g106(.a(new_n259_), .b(x70), .O(new_n280_));
  inv1   g107(.a(x10), .O(new_n281_));
  nand2  g108(.a(new_n266_), .b(new_n281_), .O(new_n282_));
  inv1   g109(.a(x18), .O(new_n283_));
  nand2  g110(.a(x52), .b(new_n283_), .O(new_n284_));
  nand3  g111(.a(new_n284_), .b(new_n282_), .c(new_n264_), .O(new_n285_));
  aoi21  g112(.a(new_n285_), .b(new_n280_), .c(x01), .O(z50));
