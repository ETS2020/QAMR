...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n335_, new_n339_, new_n340_, new_n342_, new_n343_, new_n345_,
  ...
  nand2  g165(.a(new_n310_), .b(x70), .O(new_n323_));
  inv1   g166(.a(x10), .O(new_n324_));
  nand2  g167(.a(new_n315_), .b(new_n324_), .O(new_n325_));
  inv1   g168(.a(x18), .O(new_n326_));
  nand2  g169(.a(x52), .b(new_n326_), .O(new_n327_));
  nand3  g170(.a(new_n327_), .b(new_n325_), .c(new_n313_), .O(new_n328_));
  aoi21  g171(.a(new_n328_), .b(new_n323_), .c(x01), .O(z50));
  nand2  g172(.a(new_n310_), .b(x71), .O(new_n330_));
  inv1   g173(.a(x11), .O(new_n331_));
  nand2  g174(.a(new_n315_), .b(new_n331_), .O(new_n332_));
  inv1   g175(.a(x19), .O(new_n333_));
  nand2  g176(.a(x52), .b(new_n333_), .O(new_n334_));
  nand3  g177(.a(new_n334_), .b(new_n332_), .c(new_n313_), .O(new_n335_));
  aoi21  g178(.a(new_n335_), .b(new_n330_), .c(x01), .O(z51));
