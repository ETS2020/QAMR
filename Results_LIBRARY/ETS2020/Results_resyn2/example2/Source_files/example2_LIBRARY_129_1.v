...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n227_, new_n230_, new_n232_, new_n234_, new_n236_, new_n239_,
    new_n240_, new_n241_, new_n242_, new_n249_, new_n251_, new_n254_,
  ...
  nand3  g066(.a(new_n223_), .b(x45), .c(new_n218_), .O(new_n227_));
  inv1   g067(.a(new_n227_), .O(z27));
  ...
  nand3  g081(.a(new_n241_), .b(new_n239_), .c(x58), .O(new_n249_));
  inv1   g082(.a(new_n249_), .O(z40));
  nand3  g083(.a(new_n241_), .b(new_n239_), .c(x59), .O(new_n251_));
  inv1   g084(.a(new_n251_), .O(z41));
  nand3  g085(.a(new_n241_), .b(new_n239_), .c(x61), .O(new_n254_));
