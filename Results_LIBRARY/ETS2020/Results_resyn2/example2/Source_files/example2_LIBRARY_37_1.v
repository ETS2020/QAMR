...
module FAU ( 
  ...
  oai21  g130(.a(new_n267_), .b(x22), .c(new_n153_), .O(new_n304_));
  nor3   g131(.a(new_n304_), .b(new_n303_), .c(new_n264_), .O(z54));
  inv1   g132(.a(x79), .O(new_n307_));
  aoi22  g133(.a(new_n258_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n308_));
  ...
  oai21  g137(.a(new_n162_), .b(new_n262_), .c(new_n307_), .O(new_n313_));
  ...
  oai21  g142(.a(new_n317_), .b(new_n315_), .c(new_n212_), .O(new_n318_));
  nor2   g143(.a(new_n161_), .b(new_n262_), .O(new_n319_));
  ...
  oai21  g153(.a(new_n328_), .b(new_n262_), .c(new_n153_), .O(new_n329_));
  aoi21  g154(.a(new_n327_), .b(x79), .c(new_n329_), .O(z59));
  nand3  g155(.a(new_n256_), .b(new_n160_), .c(x79), .O(new_n333_));
  aoi21  g156(.a(new_n318_), .b(x79), .c(new_n262_), .O(new_n334_));
  nand3  g157(.a(x81), .b(x79), .c(new_n262_), .O(new_n335_));
  nand2  g158(.a(new_n335_), .b(x77), .O(new_n336_));
  nand2  g159(.a(new_n256_), .b(x79), .O(new_n337_));
  nor2   g160(.a(new_n263_), .b(x77), .O(new_n338_));
  ...
  nand2  g164(.a(new_n215_), .b(new_n262_), .O(new_n343_));
  oai21  g165(.a(new_n258_), .b(new_n163_), .c(new_n343_), .O(new_n344_));
  nand3  g166(.a(new_n344_), .b(x83), .c(x79), .O(new_n345_));
  aoi21  g167(.a(new_n345_), .b(new_n264_), .c(x01), .O(z64));
