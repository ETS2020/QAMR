...
module FAU ( 
  ...
  nand2  g103(.a(new_n257_), .b(x69), .O(new_n277_));
  inv1   g104(.a(x09), .O(new_n278_));
  nand2  g105(.a(new_n264_), .b(new_n278_), .O(new_n279_));
  inv1   g106(.a(x17), .O(new_n280_));
  nand2  g107(.a(x52), .b(new_n280_), .O(new_n281_));
  nand3  g108(.a(new_n281_), .b(new_n279_), .c(new_n262_), .O(new_n282_));
  aoi21  g109(.a(new_n282_), .b(new_n277_), .c(x01), .O(z49));
