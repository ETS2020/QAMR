...
module FAU ( 
  ...
  nand3  g068(.a(new_n223_), .b(x46), .c(new_n218_), .O(new_n229_));
  inv1   g069(.a(new_n229_), .O(z28));
  ...
  nand2  g120(.a(new_n264_), .b(x71), .O(new_n292_));
  inv1   g121(.a(x11), .O(new_n293_));
  nand2  g122(.a(new_n271_), .b(new_n293_), .O(new_n294_));
  inv1   g123(.a(x19), .O(new_n295_));
  nand2  g124(.a(x52), .b(new_n295_), .O(new_n296_));
  nand3  g125(.a(new_n296_), .b(new_n294_), .c(new_n269_), .O(new_n297_));
  aoi21  g126(.a(new_n297_), .b(new_n292_), .c(x01), .O(z51));
  nand2  g127(.a(new_n264_), .b(x72), .O(new_n299_));
  inv1   g128(.a(x12), .O(new_n300_));
  nand2  g129(.a(new_n271_), .b(new_n300_), .O(new_n301_));
  inv1   g130(.a(x20), .O(new_n302_));
  nand2  g131(.a(x52), .b(new_n302_), .O(new_n303_));
  nand3  g132(.a(new_n303_), .b(new_n301_), .c(new_n269_), .O(new_n304_));
  aoi21  g133(.a(new_n304_), .b(new_n299_), .c(x01), .O(z52));
  nand2  g134(.a(new_n264_), .b(x73), .O(new_n306_));
  inv1   g135(.a(x13), .O(new_n307_));
  nand2  g136(.a(new_n271_), .b(new_n307_), .O(new_n308_));
  inv1   g137(.a(x21), .O(new_n309_));
  nand2  g138(.a(x52), .b(new_n309_), .O(new_n310_));
  nand3  g139(.a(new_n310_), .b(new_n308_), .c(new_n269_), .O(new_n311_));
  aoi21  g140(.a(new_n311_), .b(new_n306_), .c(x01), .O(z53));
  nor2   g141(.a(x52), .b(x14), .O(new_n313_));
  oai21  g142(.a(new_n271_), .b(x22), .c(new_n153_), .O(new_n314_));
  nor3   g143(.a(new_n314_), .b(new_n313_), .c(new_n268_), .O(z54));
  inv1   g144(.a(x79), .O(new_n317_));
  aoi22  g145(.a(new_n262_), .b(new_n164_), .c(new_n154_), .d(x76), .O(new_n318_));
  ...
  oai21  g149(.a(new_n162_), .b(new_n266_), .c(new_n317_), .O(new_n323_));
  ...
  oai21  g154(.a(new_n327_), .b(new_n325_), .c(new_n218_), .O(new_n328_));
  nor2   g155(.a(new_n161_), .b(new_n266_), .O(new_n329_));
  ...
  oai21  g165(.a(new_n338_), .b(new_n266_), .c(new_n153_), .O(new_n339_));
  aoi21  g166(.a(new_n337_), .b(x79), .c(new_n339_), .O(z59));
  nand3  g167(.a(new_n260_), .b(new_n160_), .c(x79), .O(new_n343_));
  aoi21  g168(.a(new_n328_), .b(x79), .c(new_n266_), .O(new_n344_));
  nand3  g169(.a(x81), .b(x79), .c(new_n266_), .O(new_n345_));
  nand2  g170(.a(new_n345_), .b(x77), .O(new_n346_));
  nand2  g171(.a(new_n260_), .b(x79), .O(new_n347_));
  nor2   g172(.a(new_n267_), .b(x77), .O(new_n348_));
  ...
  nand2  g176(.a(new_n221_), .b(new_n266_), .O(new_n353_));
  oai21  g177(.a(new_n262_), .b(new_n163_), .c(new_n353_), .O(new_n354_));
  nand3  g178(.a(new_n354_), .b(x83), .c(x79), .O(new_n355_));
  aoi21  g179(.a(new_n355_), .b(new_n268_), .c(x01), .O(z64));
