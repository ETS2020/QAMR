...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n257_, new_n258_, new_n263_, new_n264_, new_n265_, new_n266_,
  ...
  inv1   g095(.a(new_n234_), .O(new_n263_));
  nand3  g096(.a(new_n263_), .b(x83), .c(x42), .O(new_n264_));
  oai21  g097(.a(new_n210_), .b(new_n207_), .c(new_n234_), .O(new_n265_));
  nand4  g098(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x55), .O(new_n266_));
  inv1   g099(.a(new_n266_), .O(z37));
  nand4  g100(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x56), .O(new_n268_));
  inv1   g101(.a(new_n268_), .O(z38));
  nand4  g102(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x57), .O(new_n270_));
  inv1   g103(.a(new_n270_), .O(z39));
  nand4  g104(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x58), .O(new_n272_));
  inv1   g105(.a(new_n272_), .O(z40));
  nand4  g106(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x59), .O(new_n274_));
  inv1   g107(.a(new_n274_), .O(z41));
  nand4  g108(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x60), .O(new_n276_));
  inv1   g109(.a(new_n276_), .O(z42));
  nand4  g110(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x61), .O(new_n278_));
  inv1   g111(.a(new_n278_), .O(z43));
  nand4  g112(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x62), .O(new_n280_));
  inv1   g113(.a(new_n280_), .O(z44));
  nand4  g114(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x63), .O(new_n282_));
  inv1   g115(.a(new_n282_), .O(z45));
  nand4  g116(.a(new_n265_), .b(new_n264_), .c(new_n253_), .d(x64), .O(new_n284_));
