...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n233_, new_n234_, new_n235_, new_n236_, new_n238_, new_n242_,
  ...
  nand3  g076(.a(new_n235_), .b(new_n230_), .c(x49), .O(new_n242_));
  inv1   g077(.a(new_n242_), .O(z31));
  nand3  g078(.a(new_n235_), .b(new_n230_), .c(x50), .O(new_n244_));
  ...
  nand3  g083(.a(new_n231_), .b(x51), .c(new_n205_), .O(new_n249_));
  nand3  g084(.a(new_n249_), .b(new_n248_), .c(new_n232_), .O(new_n250_));
  nor2   g085(.a(new_n234_), .b(new_n226_), .O(new_n251_));
  inv1   g086(.a(new_n232_), .O(new_n252_));
  ...
  inv1   g092(.a(new_n233_), .O(new_n260_));
  nand3  g093(.a(new_n260_), .b(x83), .c(x42), .O(new_n261_));
  oai21  g094(.a(new_n208_), .b(new_n205_), .c(new_n233_), .O(new_n262_));
