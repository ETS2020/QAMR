...
module FAU ( 
  ...
  xnor2a g080(.a(x84), .b(x81), .O(new_n254_));
  inv1   g081(.a(new_n254_), .O(new_n255_));
  ...
  nor2   g135(.a(new_n254_), .b(new_n163_), .O(new_n311_));
  aoi21  g136(.a(new_n154_), .b(x76), .c(new_n311_), .O(new_n312_));
  nand2  g137(.a(new_n153_), .b(x00), .O(new_n313_));
  aoi21  g138(.a(new_n161_), .b(new_n159_), .c(new_n313_), .O(new_n314_));
  oai21  g139(.a(new_n312_), .b(new_n310_), .c(new_n314_), .O(z56));
  oai21  g140(.a(new_n162_), .b(new_n259_), .c(new_n310_), .O(new_n317_));
  nand3  g141(.a(new_n310_), .b(new_n161_), .c(x40), .O(new_n318_));
  ...
  oai21  g146(.a(new_n322_), .b(new_n320_), .c(new_n212_), .O(new_n323_));
  nor2   g147(.a(new_n161_), .b(new_n259_), .O(new_n324_));
  ...
  nand2  g153(.a(new_n310_), .b(new_n161_), .O(new_n330_));
  inv1   g154(.a(new_n324_), .O(new_n331_));
  aoi21  g155(.a(new_n331_), .b(new_n330_), .c(new_n156_), .O(new_n332_));
  aoi21  g156(.a(new_n323_), .b(x79), .c(new_n331_), .O(new_n333_));
  oai21  g157(.a(new_n333_), .b(new_n332_), .c(x77), .O(new_n334_));
  nor2   g158(.a(x79), .b(x04), .O(new_n335_));
  inv1   g159(.a(new_n335_), .O(new_n336_));
  aoi21  g160(.a(new_n336_), .b(new_n334_), .c(x01), .O(z59));
  oai21  g161(.a(new_n323_), .b(new_n159_), .c(x79), .O(new_n338_));
  nand2  g162(.a(new_n338_), .b(new_n324_), .O(new_n339_));
  aoi21  g163(.a(new_n311_), .b(x79), .c(new_n335_), .O(new_n340_));
  aoi21  g164(.a(new_n340_), .b(new_n339_), .c(x01), .O(z60));
  and2   g165(.a(x84), .b(x81), .O(new_n343_));
  nand3  g166(.a(new_n343_), .b(new_n160_), .c(x79), .O(new_n344_));
  aoi21  g167(.a(new_n323_), .b(x79), .c(new_n259_), .O(new_n345_));
  nand3  g168(.a(x81), .b(x79), .c(new_n259_), .O(new_n346_));
  nand2  g169(.a(new_n346_), .b(x77), .O(new_n347_));
  nand2  g170(.a(new_n343_), .b(x79), .O(new_n348_));
  nor2   g171(.a(new_n260_), .b(x77), .O(new_n349_));
  aoi21  g172(.a(new_n349_), .b(new_n348_), .c(new_n161_), .O(new_n350_));
  oai21  g173(.a(new_n347_), .b(new_n345_), .c(new_n350_), .O(new_n351_));
  aoi21  g174(.a(new_n351_), .b(new_n344_), .c(x01), .O(z62));
  nand2  g175(.a(new_n215_), .b(new_n259_), .O(new_n354_));
  oai21  g176(.a(new_n255_), .b(new_n163_), .c(new_n354_), .O(new_n355_));
  nand3  g177(.a(new_n355_), .b(x83), .c(x79), .O(new_n356_));
  aoi21  g178(.a(new_n356_), .b(new_n261_), .c(x01), .O(z64));
  nand2  g179(.a(new_n164_), .b(x81), .O(new_n358_));
  nand3  g180(.a(x84), .b(x79), .c(new_n153_), .O(new_n359_));
  aoi21  g181(.a(new_n358_), .b(new_n354_), .c(new_n359_), .O(z65));
  zero   g182(.O(z02));
  zero   g183(.O(z03));
  zero   g184(.O(z08));
  zero   g185(.O(z09));
