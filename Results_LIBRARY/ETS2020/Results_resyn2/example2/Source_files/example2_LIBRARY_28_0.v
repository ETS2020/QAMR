...
module FAU ( 
  ...
  nor2   g163(.a(x52), .b(x14), .O(new_n332_));
  oai21  g164(.a(new_n291_), .b(x22), .c(new_n164_), .O(new_n333_));
  nor3   g165(.a(new_n333_), .b(new_n332_), .c(new_n288_), .O(z54));
  inv1   g166(.a(x82), .O(new_n335_));
  nand2  g167(.a(x84), .b(new_n335_), .O(new_n336_));
  nor4   g168(.a(new_n336_), .b(new_n206_), .c(x81), .d(x80), .O(new_n337_));
  and2   g169(.a(new_n337_), .b(new_n250_), .O(z55));
  oai21  g170(.a(new_n212_), .b(x76), .c(new_n223_), .O(new_n339_));
  aoi21  g171(.a(new_n154_), .b(new_n157_), .c(new_n216_), .O(new_n340_));
  nand2  g172(.a(new_n340_), .b(new_n339_), .O(z56));
  inv1   g173(.a(x02), .O(new_n342_));
  nand3  g174(.a(new_n217_), .b(x03), .c(new_n342_), .O(new_n343_));
  inv1   g175(.a(new_n343_), .O(z57));
  oai21  g176(.a(new_n155_), .b(new_n218_), .c(new_n161_), .O(new_n345_));
  nand2  g177(.a(x78), .b(x04), .O(new_n346_));
  aoi21  g178(.a(x42), .b(x40), .c(new_n346_), .O(new_n347_));
  nand3  g179(.a(new_n347_), .b(new_n208_), .c(x79), .O(new_n348_));
  nand4  g180(.a(new_n161_), .b(new_n154_), .c(new_n203_), .d(x40), .O(new_n349_));
  ...
  nor2   g186(.a(new_n287_), .b(new_n213_), .O(new_n356_));
  oai21  g187(.a(new_n355_), .b(new_n161_), .c(new_n356_), .O(new_n357_));
  aoi21  g188(.a(new_n357_), .b(new_n210_), .c(x01), .O(z60));
  nand2  g189(.a(new_n222_), .b(new_n218_), .O(new_n359_));
  oai21  g190(.a(new_n354_), .b(new_n212_), .c(new_n359_), .O(new_n360_));
  ...
  aoi21  g196(.a(new_n208_), .b(x79), .c(new_n218_), .O(new_n366_));
  nand3  g197(.a(x81), .b(x79), .c(new_n218_), .O(new_n367_));
  nand2  g198(.a(new_n367_), .b(x77), .O(new_n368_));
  nor2   g199(.a(new_n287_), .b(x77), .O(new_n369_));
