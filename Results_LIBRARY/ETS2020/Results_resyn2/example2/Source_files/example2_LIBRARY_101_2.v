...
module FAU ( 
  ...
  nor3   g124(.a(new_n270_), .b(new_n240_), .c(new_n196_), .O(z39));
  nor3   g125(.a(new_n270_), .b(new_n240_), .c(new_n193_), .O(z40));
  nor3   g126(.a(new_n270_), .b(new_n240_), .c(new_n190_), .O(z41));
  nor3   g127(.a(new_n270_), .b(new_n240_), .c(new_n187_), .O(z42));
  nor3   g128(.a(new_n270_), .b(new_n240_), .c(new_n184_), .O(z43));
  nor3   g129(.a(new_n270_), .b(new_n240_), .c(new_n181_), .O(z44));
  nor3   g130(.a(new_n270_), .b(new_n240_), .c(new_n178_), .O(z45));
  nor3   g131(.a(new_n270_), .b(new_n240_), .c(new_n175_), .O(z46));
  ...
  nand2  g167(.a(new_n268_), .b(new_n324_), .O(new_n325_));
  ...
  nand2  g174(.a(new_n268_), .b(new_n331_), .O(new_n332_));
  ...
  oai21  g180(.a(new_n268_), .b(x22), .c(new_n153_), .O(new_n338_));
  ...
  nor3   g185(.a(new_n342_), .b(new_n259_), .c(new_n240_), .O(z55));
  inv1   g186(.a(x02), .O(new_n345_));
  nand4  g187(.a(x03), .b(new_n345_), .c(new_n153_), .d(x00), .O(new_n346_));
  inv1   g188(.a(new_n346_), .O(z57));
  nand2  g189(.a(new_n226_), .b(new_n158_), .O(new_n349_));
  nand2  g190(.a(new_n349_), .b(new_n229_), .O(new_n350_));
  aoi21  g191(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n351_));
  oai21  g192(.a(new_n351_), .b(new_n228_), .c(new_n153_), .O(new_n352_));
  aoi21  g193(.a(new_n350_), .b(x79), .c(new_n352_), .O(z59));
  aoi22  g194(.a(new_n232_), .b(new_n164_), .c(new_n155_), .d(new_n228_), .O(new_n354_));
  aoi21  g195(.a(new_n354_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g196(.a(new_n169_), .O(new_n356_));
  nand2  g197(.a(new_n163_), .b(new_n161_), .O(new_n357_));
  nand2  g198(.a(new_n233_), .b(new_n357_), .O(new_n358_));
  nand3  g199(.a(x78), .b(x77), .c(new_n228_), .O(new_n359_));
  nand2  g200(.a(new_n359_), .b(new_n358_), .O(new_n360_));
  inv1   g201(.a(new_n360_), .O(new_n361_));
  nor3   g202(.a(new_n361_), .b(new_n356_), .c(new_n340_), .O(z61));
  nand3  g203(.a(x84), .b(x81), .c(x79), .O(new_n363_));
  or2    g204(.a(new_n363_), .b(new_n163_), .O(new_n364_));
  aoi21  g205(.a(new_n226_), .b(x79), .c(new_n228_), .O(new_n365_));
  nand3  g206(.a(x81), .b(x79), .c(new_n228_), .O(new_n366_));
  nand2  g207(.a(new_n366_), .b(x77), .O(new_n367_));
  nor2   g208(.a(new_n292_), .b(x77), .O(new_n368_));
  aoi21  g209(.a(new_n368_), .b(new_n363_), .c(new_n162_), .O(new_n369_));
  oai21  g210(.a(new_n367_), .b(new_n365_), .c(new_n369_), .O(new_n370_));
  aoi21  g211(.a(new_n370_), .b(new_n364_), .c(x01), .O(z62));
  nor3   g212(.a(new_n361_), .b(new_n356_), .c(new_n341_), .O(z63));
  nand3  g213(.a(new_n360_), .b(x83), .c(x79), .O(new_n373_));
  aoi21  g214(.a(new_n373_), .b(new_n293_), .c(x01), .O(z64));
  nand2  g215(.a(new_n357_), .b(x81), .O(new_n375_));
  nand2  g216(.a(new_n169_), .b(x84), .O(new_n376_));
  aoi21  g217(.a(new_n375_), .b(new_n359_), .c(new_n376_), .O(z65));
  zero   g218(.O(z05));
  zero   g219(.O(z20));
  zero   g220(.O(z24));
  zero   g221(.O(z28));
