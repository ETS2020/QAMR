// Benchmark "FAU" written by ABC on Sat Jul 25 01:27:39 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n188_, new_n196_, new_n197_, new_n199_, new_n200_, new_n203_,
  ...
  nand2  g135(.a(new_n285_), .b(x70), .O(new_n304_));
  inv1   g136(.a(x10), .O(new_n305_));
  nand2  g137(.a(new_n291_), .b(new_n305_), .O(new_n306_));
  inv1   g138(.a(x18), .O(new_n307_));
  nand2  g139(.a(x52), .b(new_n307_), .O(new_n308_));
  nand3  g140(.a(new_n308_), .b(new_n306_), .c(new_n289_), .O(new_n309_));
  aoi21  g141(.a(new_n309_), .b(new_n304_), .c(x01), .O(z50));
  nand2  g142(.a(new_n285_), .b(x71), .O(new_n311_));
  inv1   g143(.a(x11), .O(new_n312_));
  nand2  g144(.a(new_n291_), .b(new_n312_), .O(new_n313_));
  inv1   g145(.a(x19), .O(new_n314_));
  nand2  g146(.a(x52), .b(new_n314_), .O(new_n315_));
  nand3  g147(.a(new_n315_), .b(new_n313_), .c(new_n289_), .O(new_n316_));
  aoi21  g148(.a(new_n316_), .b(new_n311_), .c(x01), .O(z51));
  nand2  g149(.a(new_n285_), .b(x72), .O(new_n318_));
  inv1   g150(.a(x12), .O(new_n319_));
  nand2  g151(.a(new_n291_), .b(new_n319_), .O(new_n320_));
  inv1   g152(.a(x20), .O(new_n321_));
  nand2  g153(.a(x52), .b(new_n321_), .O(new_n322_));
  nand3  g154(.a(new_n322_), .b(new_n320_), .c(new_n289_), .O(new_n323_));
  aoi21  g155(.a(new_n323_), .b(new_n318_), .c(x01), .O(z52));
  nand2  g156(.a(new_n285_), .b(x73), .O(new_n325_));
  inv1   g157(.a(x13), .O(new_n326_));
  nand2  g158(.a(new_n291_), .b(new_n326_), .O(new_n327_));
  inv1   g159(.a(x21), .O(new_n328_));
  nand2  g160(.a(x52), .b(new_n328_), .O(new_n329_));
  nand3  g161(.a(new_n329_), .b(new_n327_), .c(new_n289_), .O(new_n330_));
  aoi21  g162(.a(new_n330_), .b(new_n325_), .c(x01), .O(z53));
  inv1   g163(.a(x82), .O(new_n333_));
  nand2  g164(.a(x84), .b(new_n333_), .O(new_n334_));
  nor4   g165(.a(new_n334_), .b(new_n206_), .c(x81), .d(x80), .O(new_n335_));
  and2   g166(.a(new_n335_), .b(new_n250_), .O(z55));
  oai21  g167(.a(new_n212_), .b(x76), .c(new_n223_), .O(new_n337_));
  aoi21  g168(.a(new_n154_), .b(new_n157_), .c(new_n216_), .O(new_n338_));
  nand2  g169(.a(new_n338_), .b(new_n337_), .O(z56));
  inv1   g170(.a(x02), .O(new_n340_));
  nand3  g171(.a(new_n217_), .b(x03), .c(new_n340_), .O(new_n341_));
  inv1   g172(.a(new_n341_), .O(z57));
  oai21  g173(.a(new_n155_), .b(new_n218_), .c(new_n161_), .O(new_n343_));
  nand2  g174(.a(x78), .b(x04), .O(new_n344_));
  aoi21  g175(.a(x42), .b(x40), .c(new_n344_), .O(new_n345_));
  nand3  g176(.a(new_n345_), .b(new_n208_), .c(x79), .O(new_n346_));
  nand4  g177(.a(new_n161_), .b(new_n154_), .c(new_n203_), .d(x40), .O(new_n347_));
  ...
  nor2   g183(.a(new_n287_), .b(new_n213_), .O(new_n354_));
  oai21  g184(.a(new_n353_), .b(new_n161_), .c(new_n354_), .O(new_n355_));
  aoi21  g185(.a(new_n355_), .b(new_n210_), .c(x01), .O(z60));
  nand2  g186(.a(new_n222_), .b(new_n218_), .O(new_n357_));
  oai21  g187(.a(new_n352_), .b(new_n212_), .c(new_n357_), .O(new_n358_));
  ...
  aoi21  g193(.a(new_n208_), .b(x79), .c(new_n218_), .O(new_n364_));
  nand3  g194(.a(x81), .b(x79), .c(new_n218_), .O(new_n365_));
  nand2  g195(.a(new_n365_), .b(x77), .O(new_n366_));
  nor2   g196(.a(new_n287_), .b(x77), .O(new_n367_));
