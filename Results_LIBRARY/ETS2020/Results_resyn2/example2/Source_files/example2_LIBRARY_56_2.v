...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n211_, new_n216_, new_n217_, new_n219_, new_n220_, new_n221_,
  ...
  nand2  g164(.a(new_n288_), .b(x72), .O(new_n322_));
  inv1   g165(.a(x12), .O(new_n323_));
  nand2  g166(.a(new_n267_), .b(new_n323_), .O(new_n324_));
  inv1   g167(.a(x20), .O(new_n325_));
  nand2  g168(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g169(.a(new_n326_), .b(new_n324_), .c(new_n293_), .O(new_n327_));
  aoi21  g170(.a(new_n327_), .b(new_n322_), .c(x01), .O(z52));
  nand2  g171(.a(new_n288_), .b(x73), .O(new_n329_));
  inv1   g172(.a(x13), .O(new_n330_));
  nand2  g173(.a(new_n267_), .b(new_n330_), .O(new_n331_));
  inv1   g174(.a(x21), .O(new_n332_));
  nand2  g175(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g176(.a(new_n333_), .b(new_n331_), .c(new_n293_), .O(new_n334_));
  aoi21  g177(.a(new_n334_), .b(new_n329_), .c(x01), .O(z53));
  nor2   g178(.a(x52), .b(x14), .O(new_n336_));
  oai21  g179(.a(new_n267_), .b(x22), .c(new_n153_), .O(new_n337_));
  nor3   g180(.a(new_n337_), .b(new_n336_), .c(new_n292_), .O(z54));
  inv1   g181(.a(x80), .O(new_n339_));
  inv1   g182(.a(x82), .O(new_n340_));
  nand3  g183(.a(x84), .b(new_n340_), .c(new_n339_), .O(new_n341_));
  nor3   g184(.a(new_n341_), .b(new_n258_), .c(new_n238_), .O(z55));
  inv1   g185(.a(x02), .O(new_n344_));
  nand4  g186(.a(x03), .b(new_n344_), .c(new_n153_), .d(x00), .O(new_n345_));
  inv1   g187(.a(new_n345_), .O(z57));
  nand2  g188(.a(new_n224_), .b(new_n158_), .O(new_n348_));
  nand2  g189(.a(new_n348_), .b(new_n227_), .O(new_n349_));
  aoi21  g190(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n350_));
  oai21  g191(.a(new_n350_), .b(new_n226_), .c(new_n153_), .O(new_n351_));
  aoi21  g192(.a(new_n349_), .b(x79), .c(new_n351_), .O(z59));
  aoi22  g193(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n353_));
  aoi21  g194(.a(new_n353_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g195(.a(new_n169_), .O(new_n355_));
  nand2  g196(.a(new_n163_), .b(new_n161_), .O(new_n356_));
  nand2  g197(.a(new_n231_), .b(new_n356_), .O(new_n357_));
  nand3  g198(.a(x78), .b(x77), .c(new_n226_), .O(new_n358_));
  nand2  g199(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  inv1   g200(.a(new_n359_), .O(new_n360_));
  nor3   g201(.a(new_n360_), .b(new_n355_), .c(new_n339_), .O(z61));
  nand3  g202(.a(x84), .b(x81), .c(x79), .O(new_n362_));
  or2    g203(.a(new_n362_), .b(new_n163_), .O(new_n363_));
  aoi21  g204(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n364_));
  nand3  g205(.a(x81), .b(x79), .c(new_n226_), .O(new_n365_));
  nand2  g206(.a(new_n365_), .b(x77), .O(new_n366_));
  nor2   g207(.a(new_n291_), .b(x77), .O(new_n367_));
  aoi21  g208(.a(new_n367_), .b(new_n362_), .c(new_n162_), .O(new_n368_));
  oai21  g209(.a(new_n366_), .b(new_n364_), .c(new_n368_), .O(new_n369_));
  aoi21  g210(.a(new_n369_), .b(new_n363_), .c(x01), .O(z62));
  nor3   g211(.a(new_n360_), .b(new_n355_), .c(new_n340_), .O(z63));
  nand3  g212(.a(new_n359_), .b(x83), .c(x79), .O(new_n372_));
  aoi21  g213(.a(new_n372_), .b(new_n292_), .c(x01), .O(z64));
  nand2  g214(.a(new_n356_), .b(x81), .O(new_n374_));
  nand2  g215(.a(new_n169_), .b(x84), .O(new_n375_));
  aoi21  g216(.a(new_n374_), .b(new_n358_), .c(new_n375_), .O(z65));
  zero   g217(.O(z18));
  zero   g218(.O(z19));
  zero   g219(.O(z20));
  zero   g220(.O(z24));
