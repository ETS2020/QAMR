// Benchmark "FAU" written by ABC on Sat Jul 25 01:26:30 2020
...
module FAU ( 
  ...
  nor3   g122(.a(new_n267_), .b(new_n238_), .c(new_n189_), .O(z42));
  nor3   g123(.a(new_n267_), .b(new_n238_), .c(new_n186_), .O(z43));
  nor3   g124(.a(new_n267_), .b(new_n238_), .c(new_n183_), .O(z44));
  nor3   g125(.a(new_n267_), .b(new_n238_), .c(new_n180_), .O(z45));
  nor3   g126(.a(new_n267_), .b(new_n238_), .c(new_n177_), .O(z46));
  nor3   g127(.a(new_n230_), .b(new_n163_), .c(new_n155_), .O(new_n286_));
  oai21  g128(.a(x75), .b(x67), .c(new_n286_), .O(new_n287_));
  inv1   g129(.a(new_n161_), .O(new_n288_));
  nor2   g130(.a(x79), .b(new_n226_), .O(new_n289_));
  nand2  g131(.a(new_n289_), .b(new_n288_), .O(new_n290_));
  inv1   g132(.a(new_n290_), .O(new_n291_));
  inv1   g133(.a(x07), .O(new_n292_));
  nand2  g134(.a(new_n265_), .b(new_n292_), .O(new_n293_));
  ...
  aoi21  g138(.a(new_n296_), .b(new_n287_), .c(x01), .O(z47));
  nand2  g139(.a(new_n286_), .b(x68), .O(new_n298_));
  inv1   g140(.a(x08), .O(new_n299_));
  nand2  g141(.a(new_n265_), .b(new_n299_), .O(new_n300_));
  ...
  nand2  g146(.a(new_n286_), .b(x69), .O(new_n305_));
  inv1   g147(.a(x09), .O(new_n306_));
  nand2  g148(.a(new_n265_), .b(new_n306_), .O(new_n307_));
  ...
  nand2  g153(.a(new_n286_), .b(x70), .O(new_n312_));
  inv1   g154(.a(x10), .O(new_n313_));
  nand2  g155(.a(new_n265_), .b(new_n313_), .O(new_n314_));
  ...
  nand2  g160(.a(new_n286_), .b(x71), .O(new_n319_));
  inv1   g161(.a(x11), .O(new_n320_));
  nand2  g162(.a(new_n265_), .b(new_n320_), .O(new_n321_));
  inv1   g163(.a(x19), .O(new_n322_));
  nand2  g164(.a(x52), .b(new_n322_), .O(new_n323_));
  nand3  g165(.a(new_n323_), .b(new_n321_), .c(new_n291_), .O(new_n324_));
  aoi21  g166(.a(new_n324_), .b(new_n319_), .c(x01), .O(z51));
  nand2  g167(.a(new_n286_), .b(x72), .O(new_n326_));
  inv1   g168(.a(x12), .O(new_n327_));
  nand2  g169(.a(new_n265_), .b(new_n327_), .O(new_n328_));
  inv1   g170(.a(x20), .O(new_n329_));
  nand2  g171(.a(x52), .b(new_n329_), .O(new_n330_));
  nand3  g172(.a(new_n330_), .b(new_n328_), .c(new_n291_), .O(new_n331_));
  aoi21  g173(.a(new_n331_), .b(new_n326_), .c(x01), .O(z52));
  nand2  g174(.a(new_n286_), .b(x73), .O(new_n333_));
  inv1   g175(.a(x13), .O(new_n334_));
  nand2  g176(.a(new_n265_), .b(new_n334_), .O(new_n335_));
  inv1   g177(.a(x21), .O(new_n336_));
  nand2  g178(.a(x52), .b(new_n336_), .O(new_n337_));
  nand3  g179(.a(new_n337_), .b(new_n335_), .c(new_n291_), .O(new_n338_));
  aoi21  g180(.a(new_n338_), .b(new_n333_), .c(x01), .O(z53));
  nor2   g181(.a(x52), .b(x14), .O(new_n340_));
  oai21  g182(.a(new_n265_), .b(x22), .c(new_n153_), .O(new_n341_));
  nor3   g183(.a(new_n341_), .b(new_n340_), .c(new_n290_), .O(z54));
  inv1   g184(.a(x80), .O(new_n343_));
  inv1   g185(.a(x82), .O(new_n344_));
  nand3  g186(.a(x84), .b(new_n344_), .c(new_n343_), .O(new_n345_));
  nor3   g187(.a(new_n345_), .b(new_n256_), .c(new_n238_), .O(z55));
  inv1   g188(.a(x02), .O(new_n348_));
  nand4  g189(.a(x03), .b(new_n348_), .c(new_n153_), .d(x00), .O(new_n349_));
  inv1   g190(.a(new_n349_), .O(z57));
  nand2  g191(.a(new_n224_), .b(new_n158_), .O(new_n352_));
  nand2  g192(.a(new_n352_), .b(new_n227_), .O(new_n353_));
  aoi21  g193(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n354_));
  oai21  g194(.a(new_n354_), .b(new_n226_), .c(new_n153_), .O(new_n355_));
  aoi21  g195(.a(new_n353_), .b(x79), .c(new_n355_), .O(z59));
  aoi22  g196(.a(new_n230_), .b(new_n164_), .c(new_n155_), .d(new_n226_), .O(new_n357_));
  aoi21  g197(.a(new_n357_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g198(.a(new_n169_), .O(new_n359_));
  nand2  g199(.a(new_n163_), .b(new_n161_), .O(new_n360_));
  nand2  g200(.a(new_n231_), .b(new_n360_), .O(new_n361_));
  nand3  g201(.a(x78), .b(x77), .c(new_n226_), .O(new_n362_));
  nand2  g202(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  inv1   g203(.a(new_n363_), .O(new_n364_));
  nor3   g204(.a(new_n364_), .b(new_n359_), .c(new_n343_), .O(z61));
  nand3  g205(.a(x84), .b(x81), .c(x79), .O(new_n366_));
  or2    g206(.a(new_n366_), .b(new_n163_), .O(new_n367_));
  aoi21  g207(.a(new_n224_), .b(x79), .c(new_n226_), .O(new_n368_));
  nand3  g208(.a(x81), .b(x79), .c(new_n226_), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(x77), .O(new_n370_));
  nor2   g210(.a(new_n289_), .b(x77), .O(new_n371_));
  aoi21  g211(.a(new_n371_), .b(new_n366_), .c(new_n162_), .O(new_n372_));
  oai21  g212(.a(new_n370_), .b(new_n368_), .c(new_n372_), .O(new_n373_));
  aoi21  g213(.a(new_n373_), .b(new_n367_), .c(x01), .O(z62));
  nor3   g214(.a(new_n364_), .b(new_n359_), .c(new_n344_), .O(z63));
  nand3  g215(.a(new_n363_), .b(x83), .c(x79), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(new_n290_), .c(x01), .O(z64));
  nand2  g217(.a(new_n360_), .b(x81), .O(new_n378_));
  nand2  g218(.a(new_n169_), .b(x84), .O(new_n379_));
  aoi21  g219(.a(new_n378_), .b(new_n362_), .c(new_n379_), .O(z65));
  zero   g220(.O(z15));
  zero   g221(.O(z19));
  zero   g222(.O(z20));
  zero   g223(.O(z24));
