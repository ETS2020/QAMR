// Benchmark "FAU" written by ABC on Fri Jul 24 23:36:38 2020
...
module FAU ( 
  ...
  nand3  g090(.a(new_n69_), .b(x21), .c(new_n85_), .O(new_n144_));
  nor2   g091(.a(new_n78_), .b(x10), .O(new_n145_));
  nand3  g092(.a(new_n145_), .b(new_n95_), .c(new_n68_), .O(new_n146_));
  aoi21  g093(.a(new_n146_), .b(new_n144_), .c(new_n58_), .O(new_n147_));
  inv1   g094(.a(new_n147_), .O(new_n148_));
  nand2  g095(.a(x21), .b(new_n94_), .O(new_n149_));
  inv1   g096(.a(new_n149_), .O(new_n150_));
  nand2  g097(.a(new_n73_), .b(x04), .O(new_n151_));
  nand2  g098(.a(new_n130_), .b(new_n151_), .O(new_n152_));
  nand2  g099(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nor2   g100(.a(new_n73_), .b(new_n72_), .O(new_n154_));
  nor2   g101(.a(x16), .b(x13), .O(new_n155_));
  nand3  g102(.a(new_n155_), .b(new_n154_), .c(new_n95_), .O(new_n156_));
  aoi21  g103(.a(new_n156_), .b(new_n153_), .c(x06), .O(new_n157_));
  nand4  g104(.a(new_n56_), .b(x12), .c(x10), .d(x08), .O(new_n158_));
  nand4  g105(.a(x21), .b(x11), .c(new_n94_), .d(new_n58_), .O(new_n159_));
  nand2  g106(.a(x16), .b(new_n78_), .O(new_n160_));
  oai21  g107(.a(new_n160_), .b(new_n158_), .c(new_n159_), .O(new_n161_));
  aoi21  g108(.a(new_n161_), .b(x06), .c(new_n157_), .O(new_n162_));
  nor2   g109(.a(x07), .b(x05), .O(new_n163_));
  nor2   g110(.a(new_n54_), .b(x17), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nor2   g112(.a(new_n165_), .b(x09), .O(new_n166_));
  nor2   g113(.a(x15), .b(x14), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  aoi21  g115(.a(new_n162_), .b(new_n148_), .c(new_n168_), .O(z05));
  inv1   g116(.a(new_n164_), .O(new_n170_));
  aoi21  g117(.a(x11), .b(new_n58_), .c(new_n78_), .O(new_n171_));
  nor2   g118(.a(new_n171_), .b(new_n74_), .O(new_n172_));
  inv1   g119(.a(x16), .O(new_n173_));
  nand4  g120(.a(new_n173_), .b(new_n78_), .c(x12), .d(x10), .O(new_n174_));
  nand3  g121(.a(x13), .b(new_n72_), .c(x02), .O(new_n175_));
  aoi21  g122(.a(new_n175_), .b(new_n174_), .c(x06), .O(new_n176_));
  oai21  g123(.a(new_n176_), .b(new_n172_), .c(new_n95_), .O(new_n177_));
  nand3  g124(.a(new_n73_), .b(new_n68_), .c(x04), .O(new_n178_));
  nor2   g125(.a(new_n178_), .b(new_n149_), .O(new_n179_));
  aoi21  g126(.a(new_n161_), .b(x06), .c(new_n179_), .O(new_n180_));
  aoi21  g127(.a(new_n180_), .b(new_n177_), .c(x14), .O(new_n181_));
  oai21  g128(.a(new_n64_), .b(new_n68_), .c(new_n178_), .O(new_n182_));
  inv1   g129(.a(new_n182_), .O(new_n183_));
  nor3   g130(.a(new_n183_), .b(x21), .c(x08), .O(new_n184_));
  oai21  g131(.a(new_n184_), .b(new_n181_), .c(new_n62_), .O(new_n185_));
  inv1   g132(.a(new_n59_), .O(new_n186_));
  nand2  g133(.a(new_n186_), .b(new_n56_), .O(new_n187_));
  aoi21  g134(.a(new_n187_), .b(new_n185_), .c(new_n170_), .O(new_n188_));
  inv1   g135(.a(x17), .O(new_n189_));
  nor2   g136(.a(x18), .b(new_n189_), .O(new_n190_));
  nand2  g137(.a(x15), .b(x00), .O(new_n191_));
  inv1   g138(.a(new_n191_), .O(new_n192_));
  nand2  g139(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  inv1   g140(.a(new_n193_), .O(new_n194_));
  oai21  g141(.a(new_n194_), .b(new_n188_), .c(new_n103_), .O(new_n195_));
  nand3  g142(.a(new_n190_), .b(new_n62_), .c(x07), .O(new_n196_));
  nand2  g143(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g144(.a(new_n197_), .b(new_n53_), .O(new_n198_));
  inv1   g145(.a(new_n151_), .O(new_n199_));
  nand3  g146(.a(new_n56_), .b(x18), .c(new_n189_), .O(new_n200_));
  inv1   g147(.a(new_n200_), .O(new_n201_));
  nor2   g148(.a(x15), .b(new_n53_), .O(new_n202_));
  nand4  g149(.a(new_n202_), .b(new_n201_), .c(new_n108_), .d(new_n199_), .O(new_n203_));
  aoi21  g150(.a(new_n203_), .b(new_n198_), .c(x09), .O(z06));
  inv1   g151(.a(new_n111_), .O(new_n205_));
  nor2   g152(.a(new_n202_), .b(new_n115_), .O(new_n206_));
  ...
  nand3  g157(.a(new_n210_), .b(new_n163_), .c(x16), .O(new_n211_));
  aoi21  g158(.a(new_n211_), .b(new_n208_), .c(new_n170_), .O(z07));
  nor2   g159(.a(new_n94_), .b(new_n53_), .O(new_n214_));
  nand2  g160(.a(new_n214_), .b(new_n131_), .O(new_n215_));
  inv1   g161(.a(new_n215_), .O(new_n216_));
  nor2   g162(.a(x19), .b(new_n53_), .O(new_n217_));
  nor2   g163(.a(x21), .b(x05), .O(new_n218_));
  aoi21  g164(.a(new_n218_), .b(new_n182_), .c(new_n217_), .O(new_n219_));
  oai21  g165(.a(x12), .b(new_n72_), .c(new_n53_), .O(new_n220_));
  nand2  g166(.a(new_n220_), .b(new_n151_), .O(new_n221_));
  nand4  g167(.a(new_n221_), .b(new_n95_), .c(new_n79_), .d(x02), .O(new_n222_));
  oai21  g168(.a(new_n219_), .b(x08), .c(new_n222_), .O(new_n223_));
  aoi21  g169(.a(new_n223_), .b(new_n61_), .c(new_n216_), .O(new_n224_));
  oai21  g170(.a(new_n73_), .b(x07), .c(new_n214_), .O(new_n225_));
  oai21  g171(.a(new_n224_), .b(x07), .c(new_n225_), .O(new_n226_));
  inv1   g172(.a(new_n108_), .O(new_n227_));
  nand2  g173(.a(new_n57_), .b(x05), .O(new_n228_));
  inv1   g174(.a(new_n57_), .O(new_n229_));
  nand3  g175(.a(new_n115_), .b(new_n65_), .c(new_n229_), .O(new_n230_));
  aoi21  g176(.a(new_n230_), .b(new_n228_), .c(new_n227_), .O(new_n231_));
  aoi21  g177(.a(new_n226_), .b(new_n62_), .c(new_n231_), .O(new_n232_));
  nand2  g178(.a(new_n218_), .b(x12), .O(new_n233_));
  inv1   g179(.a(new_n233_), .O(new_n234_));
  nor2   g180(.a(x09), .b(x07), .O(new_n235_));
  nor2   g181(.a(x14), .b(new_n98_), .O(new_n236_));
  nor2   g182(.a(x18), .b(x15), .O(new_n237_));
  nand4  g183(.a(new_n237_), .b(new_n236_), .c(new_n235_), .d(new_n234_), .O(new_n238_));
  oai21  g184(.a(new_n232_), .b(new_n54_), .c(new_n238_), .O(new_n239_));
  nand2  g185(.a(new_n239_), .b(new_n189_), .O(new_n240_));
  nand4  g186(.a(new_n237_), .b(x17), .c(new_n61_), .d(new_n103_), .O(new_n241_));
  nand2  g187(.a(new_n241_), .b(new_n240_), .O(z09));
  nor2   g188(.a(x08), .b(x06), .O(new_n243_));
  nand2  g189(.a(new_n243_), .b(new_n164_), .O(new_n244_));
  nor2   g190(.a(new_n244_), .b(new_n206_), .O(new_n245_));
  nor3   g191(.a(new_n245_), .b(new_n190_), .c(x07), .O(new_n246_));
  nand2  g192(.a(new_n164_), .b(x19), .O(new_n247_));
  nand2  g193(.a(new_n202_), .b(x08), .O(new_n248_));
  nor2   g194(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand2  g195(.a(new_n190_), .b(new_n53_), .O(new_n250_));
  nand2  g196(.a(new_n250_), .b(x07), .O(new_n251_));
  oai21  g197(.a(new_n251_), .b(new_n249_), .c(new_n61_), .O(new_n252_));
  inv1   g198(.a(new_n128_), .O(new_n253_));
  nor2   g199(.a(new_n253_), .b(x17), .O(new_n254_));
  nor2   g200(.a(x09), .b(x05), .O(new_n255_));
  inv1   g201(.a(new_n255_), .O(new_n256_));
  nand3  g202(.a(new_n256_), .b(new_n254_), .c(new_n129_), .O(new_n257_));
  oai22  g203(.a(new_n257_), .b(new_n134_), .c(new_n252_), .d(new_n246_), .O(z10));
  inv1   g204(.a(new_n119_), .O(new_n259_));
  nand2  g205(.a(new_n189_), .b(new_n61_), .O(new_n260_));
  nor3   g206(.a(new_n260_), .b(new_n125_), .c(new_n259_), .O(z11));
  nand2  g207(.a(new_n65_), .b(x06), .O(new_n262_));
  inv1   g208(.a(new_n262_), .O(new_n263_));
  oai21  g209(.a(new_n263_), .b(new_n182_), .c(new_n94_), .O(new_n264_));
  nor2   g210(.a(x14), .b(new_n94_), .O(new_n265_));
  nand2  g211(.a(new_n265_), .b(new_n172_), .O(new_n266_));
  aoi21  g212(.a(new_n266_), .b(new_n264_), .c(x15), .O(new_n267_));
  oai21  g213(.a(new_n267_), .b(new_n186_), .c(new_n53_), .O(new_n268_));
  inv1   g214(.a(new_n90_), .O(new_n269_));
  nand2  g215(.a(new_n269_), .b(x05), .O(new_n270_));
  ...
  nand2  g220(.a(new_n199_), .b(new_n62_), .O(new_n275_));
  inv1   g221(.a(new_n275_), .O(new_n276_));
  aoi21  g222(.a(new_n276_), .b(new_n214_), .c(new_n274_), .O(new_n277_));
  aoi21  g223(.a(new_n277_), .b(new_n268_), .c(new_n200_), .O(new_n278_));
  nor2   g224(.a(new_n250_), .b(new_n191_), .O(new_n279_));
  oai21  g225(.a(new_n279_), .b(new_n278_), .c(new_n103_), .O(new_n280_));
  inv1   g226(.a(new_n250_), .O(new_n281_));
  nand3  g227(.a(new_n281_), .b(new_n62_), .c(x07), .O(new_n282_));
  aoi21  g228(.a(new_n282_), .b(new_n280_), .c(x09), .O(z12));
  nand2  g229(.a(x07), .b(x05), .O(new_n284_));
  nand4  g230(.a(new_n284_), .b(new_n54_), .c(x17), .d(new_n61_), .O(new_n285_));
  inv1   g231(.a(new_n285_), .O(z13));
  nand2  g232(.a(new_n207_), .b(new_n112_), .O(new_n287_));
  nand2  g233(.a(new_n202_), .b(new_n199_), .O(new_n288_));
  inv1   g234(.a(new_n64_), .O(new_n289_));
  nand2  g235(.a(new_n115_), .b(new_n289_), .O(new_n290_));
  nand2  g236(.a(new_n290_), .b(new_n288_), .O(new_n291_));
  nand3  g237(.a(new_n291_), .b(new_n229_), .c(new_n103_), .O(new_n292_));
  aoi21  g238(.a(new_n292_), .b(new_n287_), .c(new_n253_), .O(new_n293_));
  nor2   g239(.a(new_n256_), .b(x18), .O(new_n294_));
  inv1   g240(.a(new_n294_), .O(new_n295_));
  nand2  g241(.a(x15), .b(x07), .O(new_n296_));
  nor2   g242(.a(new_n73_), .b(x07), .O(new_n297_));
  nand2  g243(.a(new_n236_), .b(new_n62_), .O(new_n298_));
  ...
  oai21  g247(.a(new_n301_), .b(new_n293_), .c(new_n189_), .O(new_n302_));
  nor2   g248(.a(x15), .b(x07), .O(new_n303_));
  oai22  g249(.a(new_n303_), .b(new_n189_), .c(new_n103_), .d(x01), .O(new_n304_));
  nand2  g250(.a(new_n304_), .b(new_n294_), .O(new_n305_));
  nand2  g251(.a(new_n305_), .b(new_n302_), .O(z14));
  nor2   g252(.a(new_n241_), .b(new_n53_), .O(z15));
  nor2   g253(.a(x19), .b(new_n61_), .O(new_n308_));
  inv1   g254(.a(new_n145_), .O(new_n309_));
  aoi21  g255(.a(new_n309_), .b(new_n151_), .c(new_n58_), .O(new_n310_));
  nor3   g256(.a(new_n171_), .b(x16), .c(new_n73_), .O(new_n311_));
  oai21  g257(.a(new_n311_), .b(new_n310_), .c(x06), .O(new_n312_));
  inv1   g258(.a(new_n171_), .O(new_n313_));
  nand3  g259(.a(x16), .b(x12), .c(new_n68_), .O(new_n314_));
  inv1   g260(.a(new_n314_), .O(new_n315_));
  oai21  g261(.a(new_n315_), .b(new_n75_), .c(new_n313_), .O(new_n316_));
  inv1   g262(.a(x14), .O(new_n317_));
  nand3  g263(.a(new_n56_), .b(new_n317_), .c(new_n61_), .O(new_n318_));
  aoi21  g264(.a(new_n316_), .b(new_n312_), .c(new_n318_), .O(new_n319_));
  oai21  g265(.a(new_n319_), .b(new_n308_), .c(new_n303_), .O(new_n320_));
  ...
  oai21  g270(.a(new_n297_), .b(new_n324_), .c(x05), .O(new_n325_));
  nand2  g271(.a(new_n325_), .b(new_n254_), .O(new_n326_));
  ...
  oai21  g275(.a(new_n130_), .b(x06), .c(new_n262_), .O(new_n330_));
  nand4  g276(.a(new_n330_), .b(new_n271_), .c(new_n164_), .d(new_n70_), .O(new_n331_));
  ...
  nor2   g290(.a(new_n241_), .b(x05), .O(z19));
  nand3  g291(.a(new_n265_), .b(new_n313_), .c(x10), .O(new_n346_));
  nor2   g292(.a(new_n243_), .b(x05), .O(new_n347_));
  nor2   g293(.a(x08), .b(new_n53_), .O(new_n348_));
  inv1   g294(.a(new_n348_), .O(new_n349_));
  nand2  g295(.a(new_n349_), .b(new_n276_), .O(new_n350_));
  aoi21  g296(.a(new_n347_), .b(new_n346_), .c(new_n350_), .O(new_n351_));
  oai21  g297(.a(new_n351_), .b(new_n274_), .c(new_n56_), .O(new_n352_));
  nor2   g298(.a(new_n56_), .b(x14), .O(new_n353_));
  nand4  g299(.a(new_n353_), .b(new_n272_), .c(new_n271_), .d(new_n152_), .O(new_n354_));
  aoi21  g300(.a(new_n354_), .b(new_n352_), .c(new_n54_), .O(new_n355_));
  nand4  g301(.a(new_n299_), .b(new_n54_), .c(x12), .d(new_n53_), .O(new_n356_));
  nor2   g302(.a(new_n356_), .b(x21), .O(new_n357_));
  oai21  g303(.a(new_n357_), .b(new_n355_), .c(new_n61_), .O(new_n358_));
  inv1   g304(.a(new_n248_), .O(new_n359_));
  ...
  nand2  g309(.a(new_n243_), .b(new_n83_), .O(new_n364_));
  ...
  inv1   g320(.a(new_n290_), .O(new_n376_));
  aoi21  g321(.a(new_n275_), .b(new_n99_), .c(new_n53_), .O(new_n377_));
  ...
  nand4  g328(.a(new_n237_), .b(new_n383_), .c(x08), .d(new_n53_), .O(new_n384_));
  aoi21  g329(.a(new_n384_), .b(new_n382_), .c(new_n260_), .O(z24));
  nand2  g330(.a(new_n83_), .b(new_n94_), .O(new_n386_));
  aoi21  g331(.a(new_n386_), .b(new_n209_), .c(new_n165_), .O(z25));
  nor3   g332(.a(new_n262_), .b(new_n125_), .c(x08), .O(new_n389_));
  oai21  g333(.a(new_n389_), .b(new_n274_), .c(new_n56_), .O(new_n390_));
  ...
  nand3  g340(.a(new_n396_), .b(new_n296_), .c(new_n281_), .O(new_n397_));
  ...
  oai21  g344(.a(new_n400_), .b(new_n247_), .c(new_n399_), .O(z27));
  ...
  nand4  g353(.a(new_n409_), .b(new_n407_), .c(new_n235_), .d(new_n154_), .O(new_n410_));
  ...
  nand2  g358(.a(new_n255_), .b(new_n110_), .O(new_n415_));
