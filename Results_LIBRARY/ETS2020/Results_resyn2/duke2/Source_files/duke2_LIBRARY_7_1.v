// Benchmark "FAU" written by ABC on Fri Jul 24 23:36:15 2020
...
module FAU ( 
  ...
  nor2   g119(.a(x20), .b(new_n161_), .O(z08));
  oai21  g120(.a(new_n59_), .b(new_n56_), .c(new_n128_), .O(new_n175_));
  inv1   g121(.a(new_n175_), .O(new_n176_));
  nand2  g122(.a(new_n76_), .b(new_n111_), .O(new_n177_));
  nor4   g123(.a(new_n177_), .b(new_n135_), .c(new_n125_), .d(x07), .O(new_n178_));
  oai21  g124(.a(new_n178_), .b(new_n176_), .c(new_n71_), .O(new_n179_));
  nand3  g125(.a(x09), .b(new_n59_), .c(new_n56_), .O(new_n180_));
  inv1   g126(.a(new_n180_), .O(new_n181_));
  nor2   g127(.a(new_n181_), .b(new_n126_), .O(new_n182_));
  nand2  g128(.a(new_n133_), .b(new_n60_), .O(new_n183_));
  oai21  g129(.a(new_n183_), .b(new_n182_), .c(new_n179_), .O(z10));
  nand2  g130(.a(new_n176_), .b(new_n71_), .O(new_n187_));
  inv1   g131(.a(new_n187_), .O(z13));
  nand2  g132(.a(new_n117_), .b(new_n71_), .O(new_n189_));
  nand3  g133(.a(new_n169_), .b(new_n99_), .c(x07), .O(new_n190_));
  nand2  g134(.a(new_n156_), .b(new_n78_), .O(new_n191_));
  nand2  g135(.a(new_n149_), .b(new_n60_), .O(new_n192_));
  oai21  g136(.a(new_n192_), .b(new_n56_), .c(new_n191_), .O(new_n193_));
  nand2  g137(.a(new_n193_), .b(new_n88_), .O(new_n194_));
  aoi21  g138(.a(new_n194_), .b(new_n190_), .c(new_n132_), .O(new_n195_));
  nor2   g139(.a(x21), .b(x14), .O(new_n196_));
  nand3  g140(.a(new_n196_), .b(new_n109_), .c(new_n108_), .O(new_n197_));
  aoi21  g141(.a(new_n197_), .b(new_n52_), .c(new_n189_), .O(new_n198_));
  oai21  g142(.a(new_n198_), .b(new_n195_), .c(new_n127_), .O(new_n199_));
  inv1   g143(.a(new_n108_), .O(new_n200_));
  nor2   g144(.a(new_n59_), .b(x01), .O(new_n201_));
  aoi21  g145(.a(new_n200_), .b(x17), .c(new_n201_), .O(new_n202_));
  oai21  g146(.a(new_n202_), .b(new_n189_), .c(new_n199_), .O(z14));
  nand3  g147(.a(new_n128_), .b(new_n60_), .c(new_n71_), .O(new_n204_));
  nor2   g148(.a(new_n204_), .b(new_n58_), .O(z15));
  inv1   g149(.a(new_n133_), .O(new_n206_));
  nand2  g150(.a(new_n99_), .b(x09), .O(new_n207_));
  oai21  g151(.a(new_n149_), .b(new_n144_), .c(x02), .O(new_n208_));
  nand2  g152(.a(new_n105_), .b(x13), .O(new_n209_));
  nand3  g153(.a(new_n209_), .b(new_n118_), .c(x12), .O(new_n210_));
  aoi21  g154(.a(new_n210_), .b(new_n208_), .c(new_n111_), .O(new_n211_));
  aoi21  g155(.a(x11), .b(new_n82_), .c(new_n143_), .O(new_n212_));
  nand3  g156(.a(x16), .b(x12), .c(new_n111_), .O(new_n213_));
  inv1   g157(.a(x10), .O(new_n214_));
  nor2   g158(.a(new_n149_), .b(new_n214_), .O(new_n215_));
  aoi21  g159(.a(new_n215_), .b(new_n213_), .c(new_n212_), .O(new_n216_));
  nor3   g160(.a(x21), .b(x14), .c(x09), .O(new_n217_));
  oai21  g161(.a(new_n216_), .b(new_n211_), .c(new_n217_), .O(new_n218_));
  aoi21  g162(.a(new_n218_), .b(new_n207_), .c(new_n200_), .O(new_n219_));
  nand2  g163(.a(x15), .b(x09), .O(new_n220_));
  aoi21  g164(.a(new_n59_), .b(x02), .c(new_n220_), .O(new_n221_));
  oai21  g165(.a(new_n221_), .b(new_n219_), .c(new_n56_), .O(new_n222_));
  inv1   g166(.a(new_n69_), .O(new_n223_));
  nand3  g167(.a(new_n134_), .b(new_n223_), .c(x09), .O(new_n224_));
  aoi21  g168(.a(new_n224_), .b(new_n222_), .c(new_n206_), .O(z16));
  nor3   g169(.a(new_n204_), .b(x07), .c(x05), .O(z19));
  nand2  g170(.a(new_n127_), .b(new_n59_), .O(new_n229_));
  nor2   g171(.a(new_n76_), .b(new_n56_), .O(new_n230_));
  nand3  g172(.a(new_n230_), .b(x15), .c(new_n83_), .O(new_n231_));
  nor2   g173(.a(x06), .b(x05), .O(new_n232_));
  nand3  g174(.a(new_n232_), .b(new_n96_), .c(x12), .O(new_n233_));
  nand2  g175(.a(new_n233_), .b(new_n231_), .O(new_n234_));
  nand2  g176(.a(new_n234_), .b(new_n64_), .O(new_n235_));
  nand3  g177(.a(new_n161_), .b(x10), .c(x08), .O(new_n236_));
  oai21  g178(.a(new_n236_), .b(new_n212_), .c(new_n177_), .O(new_n237_));
  aoi21  g179(.a(new_n237_), .b(new_n56_), .c(new_n230_), .O(new_n238_));
  oai21  g180(.a(new_n238_), .b(new_n192_), .c(new_n235_), .O(new_n239_));
  nand2  g181(.a(new_n239_), .b(new_n93_), .O(new_n240_));
  nand3  g182(.a(new_n232_), .b(new_n151_), .c(new_n67_), .O(new_n241_));
  aoi21  g183(.a(new_n241_), .b(new_n240_), .c(new_n72_), .O(new_n242_));
  nand3  g184(.a(new_n117_), .b(new_n109_), .c(new_n67_), .O(new_n243_));
  nor2   g185(.a(new_n243_), .b(x21), .O(new_n244_));
  oai21  g186(.a(new_n244_), .b(new_n242_), .c(new_n71_), .O(new_n245_));
  nand4  g187(.a(new_n149_), .b(new_n134_), .c(new_n77_), .d(x09), .O(new_n246_));
  aoi21  g188(.a(new_n246_), .b(new_n245_), .c(new_n229_), .O(z20));
  nand2  g189(.a(new_n134_), .b(new_n71_), .O(new_n248_));
  nor3   g190(.a(new_n248_), .b(x08), .c(new_n111_), .O(new_n249_));
  nand3  g191(.a(new_n60_), .b(x09), .c(x08), .O(new_n250_));
  nand2  g192(.a(new_n250_), .b(x06), .O(new_n251_));
  nand3  g193(.a(x15), .b(new_n71_), .c(new_n76_), .O(new_n252_));
  nand2  g194(.a(new_n252_), .b(new_n111_), .O(new_n253_));
  nand3  g195(.a(new_n253_), .b(new_n251_), .c(new_n56_), .O(new_n254_));
  inv1   g196(.a(new_n254_), .O(new_n255_));
  oai21  g197(.a(new_n255_), .b(new_n249_), .c(new_n59_), .O(new_n256_));
  nand3  g198(.a(new_n78_), .b(x08), .c(x07), .O(new_n257_));
  inv1   g199(.a(new_n257_), .O(new_n258_));
  nand2  g200(.a(new_n258_), .b(new_n71_), .O(new_n259_));
  aoi21  g201(.a(new_n259_), .b(new_n256_), .c(new_n125_), .O(z21));
  nand4  g202(.a(x15), .b(new_n71_), .c(new_n76_), .d(x06), .O(new_n261_));
  aoi21  g203(.a(new_n261_), .b(new_n250_), .c(x05), .O(new_n262_));
  oai21  g204(.a(new_n262_), .b(new_n249_), .c(new_n59_), .O(new_n263_));
  aoi21  g205(.a(new_n263_), .b(new_n257_), .c(new_n125_), .O(z22));
  nor2   g206(.a(new_n183_), .b(new_n180_), .O(z23));
  inv1   g207(.a(new_n191_), .O(new_n266_));
  aoi21  g208(.a(new_n192_), .b(new_n94_), .c(new_n56_), .O(new_n267_));
  oai21  g209(.a(new_n267_), .b(new_n266_), .c(new_n77_), .O(new_n268_));
  aoi21  g210(.a(new_n268_), .b(new_n243_), .c(x21), .O(new_n269_));
  nand3  g211(.a(new_n96_), .b(x18), .c(new_n56_), .O(new_n270_));
  inv1   g212(.a(new_n270_), .O(new_n271_));
  oai21  g213(.a(new_n271_), .b(new_n269_), .c(new_n59_), .O(new_n272_));
  nor2   g214(.a(new_n59_), .b(x05), .O(new_n273_));
  nor2   g215(.a(x18), .b(x15), .O(new_n274_));
  nand4  g216(.a(new_n274_), .b(new_n273_), .c(x08), .d(x01), .O(new_n275_));
  nand2  g217(.a(new_n127_), .b(new_n71_), .O(new_n276_));
  aoi21  g218(.a(new_n275_), .b(new_n272_), .c(new_n276_), .O(z24));
  aoi21  g219(.a(new_n252_), .b(new_n250_), .c(new_n162_), .O(z25));
  nor2   g220(.a(new_n196_), .b(x20), .O(z26));
  zero   g221(.O(z01));
  zero   g222(.O(z06));
  zero   g223(.O(z09));
  zero   g224(.O(z11));
