...
module FAU ( 
  ...
  inv1   g27(.a(x3), .O(z8));
  nand2  g28(.a(z8), .b(new_n21_), .O(new_n47_));
  ...
  nand3  g57(.a(new_n31_), .b(new_n22_), .c(new_n30_), .O(new_n77_));
  inv1   g58(.a(new_n77_), .O(new_n78_));
  nor3   g59(.a(new_n78_), .b(new_n19_), .c(new_n34_), .O(z9));
  zero   g60(.O(z0));
  zero   g61(.O(z5));
endmodule
