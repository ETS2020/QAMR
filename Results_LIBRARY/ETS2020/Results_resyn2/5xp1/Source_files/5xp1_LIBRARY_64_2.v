...
module FAU ( 
  ...
  nand3  g33(.a(x3), .b(new_n37_), .c(x1), .O(new_n53_));
  oai21  g34(.a(x3), .b(new_n37_), .c(new_n53_), .O(new_n54_));
  xor2a  g35(.a(new_n54_), .b(x0), .O(z5));
  inv1   g36(.a(new_n53_), .O(new_n56_));
  aoi21  g37(.a(x3), .b(new_n37_), .c(x1), .O(new_n57_));
  nor2   g38(.a(new_n57_), .b(new_n56_), .O(z6));
  inv1   g39(.a(x3), .O(z8));
  zero   g40(.O(z2));
  zero   g41(.O(z3));
  zero   g42(.O(z7));
