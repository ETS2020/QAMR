...
module FAU ( 
  ...
  oai21  g36(.a(new_n33_), .b(new_n26_), .c(new_n18_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n27_), .c(new_n25_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n53_), .c(x6), .O(new_n56_));
  oai21  g39(.a(new_n48_), .b(new_n46_), .c(new_n56_), .O(z2));
  nand2  g40(.a(x3), .b(new_n41_), .O(new_n59_));
  oai21  g41(.a(new_n59_), .b(new_n26_), .c(new_n50_), .O(new_n60_));
  nand2  g42(.a(new_n60_), .b(x6), .O(new_n61_));
  nand2  g43(.a(new_n43_), .b(new_n40_), .O(new_n62_));
  nand3  g44(.a(new_n62_), .b(new_n32_), .c(x1), .O(new_n63_));
  xor2a  g45(.a(x6), .b(x1), .O(new_n64_));
  or2    g46(.a(new_n64_), .b(new_n49_), .O(new_n65_));
  nand3  g47(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(z4));
  xor2a  g48(.a(new_n59_), .b(new_n19_), .O(z6));
  inv1   g49(.a(new_n20_), .O(new_n69_));
  nor2   g50(.a(new_n34_), .b(new_n69_), .O(z7));
  zero   g51(.O(z3));
  zero   g52(.O(z5));
  zero   g53(.O(z9));
endmodule
