...
module FAU ( 
  ...
  nand2  g46(.a(new_n38_), .b(x1), .O(new_n65_));
  aoi21  g47(.a(new_n65_), .b(x3), .c(new_n56_), .O(new_n66_));
  xor2a  g48(.a(new_n66_), .b(x0), .O(z5));
  inv1   g49(.a(new_n65_), .O(new_n68_));
  aoi21  g50(.a(x3), .b(new_n38_), .c(x1), .O(new_n69_));
  aoi21  g51(.a(new_n68_), .b(x3), .c(new_n69_), .O(z6));
  inv1   g52(.a(x3), .O(z8));
  zero   g53(.O(z2));
  zero   g54(.O(z7));
endmodule
