...
module FAU ( 
  ...
  oai21  g39(.a(new_n30_), .b(new_n19_), .c(new_n46_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n22_), .c(new_n18_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n56_), .c(x6), .O(new_n59_));
  oai21  g42(.a(new_n51_), .b(new_n49_), .c(new_n59_), .O(z2));
  nand2  g43(.a(x3), .b(new_n43_), .O(new_n62_));
  oai21  g44(.a(new_n62_), .b(new_n19_), .c(new_n53_), .O(new_n63_));
  nand2  g45(.a(new_n63_), .b(x6), .O(new_n64_));
  nand2  g46(.a(new_n45_), .b(new_n42_), .O(new_n65_));
  nand3  g47(.a(new_n65_), .b(new_n29_), .c(x1), .O(new_n66_));
  xor2a  g48(.a(x6), .b(x1), .O(new_n67_));
  or2    g49(.a(new_n67_), .b(new_n52_), .O(new_n68_));
  nand3  g50(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(z4));
  nor2   g51(.a(x2), .b(new_n20_), .O(new_n70_));
  oai21  g52(.a(new_n70_), .b(z8), .c(new_n45_), .O(new_n71_));
  xor2a  g53(.a(new_n71_), .b(new_n19_), .O(z5));
  aoi22  g54(.a(new_n70_), .b(x3), .c(new_n62_), .d(new_n20_), .O(z6));
  zero   g55(.O(z3));
  zero   g56(.O(z7));
endmodule
