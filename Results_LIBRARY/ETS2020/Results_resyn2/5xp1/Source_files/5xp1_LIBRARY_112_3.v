...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n57_, new_n58_, new_n59_, new_n61_, new_n62_, new_n63_, new_n68_,
    new_n69_;
  ...
  inv1   g41(.a(x3), .O(new_n61_));
  nand2  g42(.a(new_n61_), .b(x2), .O(new_n62_));
  ...
  nor2   g47(.a(x6), .b(x0), .O(new_n68_));
  nand2  g48(.a(x5), .b(x4), .O(new_n69_));
  aoi21  g49(.a(new_n68_), .b(new_n30_), .c(new_n69_), .O(z9));
  zero   g50(.O(z0));
  zero   g51(.O(z3));
  zero   g52(.O(z8));
endmodule
