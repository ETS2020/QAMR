...
module FAU ( 
  ...
  nor2   g13(.a(new_n19_), .b(new_n25_), .O(new_n32_));
  inv1   g14(.a(new_n32_), .O(new_n33_));
  nand2  g15(.a(new_n20_), .b(new_n25_), .O(new_n34_));
  ...
  nand2  g25(.a(new_n43_), .b(new_n26_), .O(new_n44_));
  ...
  aoi21  g30(.a(new_n48_), .b(new_n26_), .c(new_n25_), .O(new_n49_));
  oai21  g31(.a(new_n49_), .b(x5), .c(new_n27_), .O(new_n50_));
  ...
  aoi21  g37(.a(new_n55_), .b(new_n47_), .c(new_n26_), .O(new_n56_));
  ...
  nand3  g52(.a(x3), .b(new_n48_), .c(new_n26_), .O(new_n71_));
  nor2   g53(.a(x3), .b(x2), .O(new_n72_));
  nor2   g54(.a(new_n72_), .b(new_n21_), .O(z7));
  xor2a  g55(.a(z7), .b(new_n25_), .O(new_n74_));
