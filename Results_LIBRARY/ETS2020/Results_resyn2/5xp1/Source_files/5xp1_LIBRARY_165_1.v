// Benchmark "FAU" written by ABC on Fri Jul 24 21:10:13 2020
...
module FAU ( 
  ...
  oai22  g15(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n25_), .O(new_n33_));
  ...
  oai21  g38(.a(new_n30_), .b(new_n19_), .c(new_n46_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n22_), .c(new_n18_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n55_), .c(x6), .O(new_n58_));
  oai21  g41(.a(new_n50_), .b(new_n45_), .c(new_n58_), .O(z2));
  nand2  g42(.a(new_n53_), .b(new_n38_), .O(new_n60_));
  aoi21  g43(.a(x5), .b(x3), .c(x6), .O(new_n61_));
  nor2   g44(.a(x5), .b(x3), .O(new_n62_));
  oai21  g45(.a(x6), .b(x1), .c(x2), .O(new_n63_));
  oai22  g46(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(new_n20_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n60_), .O(new_n65_));
  nor2   g48(.a(x3), .b(x0), .O(new_n66_));
  nor2   g49(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  oai21  g50(.a(new_n43_), .b(x6), .c(x1), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n53_), .c(new_n38_), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(z3));
  oai21  g53(.a(x3), .b(new_n39_), .c(new_n20_), .O(new_n72_));
  inv1   g54(.a(new_n21_), .O(new_n73_));
  nor2   g55(.a(new_n31_), .b(new_n73_), .O(z7));
  nand2  g56(.a(z7), .b(new_n72_), .O(new_n75_));
  xor2a  g57(.a(new_n75_), .b(new_n19_), .O(z5));
  zero   g58(.O(z4));
  zero   g59(.O(z6));
  zero   g60(.O(z9));
endmodule
