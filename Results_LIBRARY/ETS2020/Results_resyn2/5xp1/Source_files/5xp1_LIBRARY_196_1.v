...
module FAU ( 
  ...
  inv1   g53(.a(x3), .O(z8));
  oai21  g54(.a(x5), .b(z8), .c(new_n31_), .O(new_n72_));
  ...
  nand3  g58(.a(x3), .b(new_n60_), .c(x0), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n57_), .O(new_n77_));
  ...
  nand3  g67(.a(x3), .b(new_n60_), .c(x1), .O(new_n85_));
  oai21  g68(.a(x3), .b(new_n60_), .c(new_n85_), .O(new_n86_));
  xor2a  g69(.a(new_n86_), .b(x0), .O(z5));
  nor2   g70(.a(new_n35_), .b(new_n24_), .O(z7));
  zero   g71(.O(z6));
endmodule
