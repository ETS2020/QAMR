...
module FAU ( 
  ...
  nand2  g47(.a(new_n65_), .b(x2), .O(new_n66_));
  nand2  g48(.a(x3), .b(new_n38_), .O(new_n67_));
  oai21  g49(.a(new_n67_), .b(new_n20_), .c(new_n66_), .O(new_n68_));
  xor2a  g50(.a(new_n68_), .b(x0), .O(z5));
  xor2a  g51(.a(new_n67_), .b(new_n20_), .O(z6));
  nor2   g52(.a(new_n56_), .b(new_n24_), .O(z7));
  zero   g53(.O(z2));
  zero   g54(.O(z8));
endmodule
