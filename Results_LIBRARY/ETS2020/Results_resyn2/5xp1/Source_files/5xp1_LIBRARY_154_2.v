...
module FAU ( 
  ...
  oai21  g40(.a(x3), .b(new_n59_), .c(new_n20_), .O(new_n60_));
  inv1   g41(.a(new_n21_), .O(new_n61_));
  nor2   g42(.a(new_n31_), .b(new_n61_), .O(z7));
  nand2  g43(.a(z7), .b(new_n60_), .O(new_n63_));
  xor2a  g44(.a(new_n63_), .b(new_n19_), .O(z5));
  inv1   g45(.a(x3), .O(z8));
  zero   g46(.O(z3));
  zero   g47(.O(z4));
  zero   g48(.O(z6));
