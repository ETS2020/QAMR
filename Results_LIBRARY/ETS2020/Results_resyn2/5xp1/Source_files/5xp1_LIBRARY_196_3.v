...
module FAU ( 
  ...
  inv1   g33(.a(x3), .O(new_n53_));
  oai21  g34(.a(x5), .b(new_n53_), .c(new_n20_), .O(new_n54_));
  ...
  oai21  g38(.a(new_n53_), .b(new_n21_), .c(x1), .O(new_n58_));
  ...
  nand2  g45(.a(new_n53_), .b(x2), .O(new_n65_));
