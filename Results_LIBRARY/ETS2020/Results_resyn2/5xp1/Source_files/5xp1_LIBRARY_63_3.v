...
module FAU ( 
  ...
  oai21  g28(.a(x5), .b(new_n32_), .c(new_n26_), .O(new_n48_));
  ...
  oai21  g34(.a(new_n32_), .b(new_n27_), .c(x1), .O(new_n54_));
  ...
  nand3  g43(.a(x3), .b(new_n31_), .c(x1), .O(new_n63_));
  oai21  g44(.a(x3), .b(new_n31_), .c(new_n63_), .O(new_n64_));
  xor2a  g45(.a(new_n64_), .b(x0), .O(z5));
  inv1   g46(.a(new_n29_), .O(new_n69_));
  nand2  g47(.a(x5), .b(x4), .O(new_n70_));
  aoi21  g48(.a(new_n69_), .b(new_n26_), .c(new_n70_), .O(z9));
  zero   g49(.O(z0));
  zero   g50(.O(z1));
  zero   g51(.O(z6));
  zero   g52(.O(z7));
