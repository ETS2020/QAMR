// Benchmark "FAU" written by ABC on Fri Jul 24 21:09:41 2020
...
module FAU ( 
  ...
  or2    g38(.a(x3), .b(x2), .O(new_n57_));
  nand3  g39(.a(new_n57_), .b(new_n21_), .c(new_n23_), .O(new_n58_));
  nand3  g40(.a(new_n58_), .b(new_n56_), .c(x1), .O(new_n59_));
  oai21  g41(.a(new_n55_), .b(new_n48_), .c(new_n59_), .O(z4));
  aoi21  g42(.a(x3), .b(x1), .c(x2), .O(new_n61_));
  oai21  g43(.a(new_n61_), .b(new_n26_), .c(x0), .O(new_n62_));
  oai21  g44(.a(new_n61_), .b(new_n21_), .c(new_n62_), .O(z5));
  zero   g45(.O(z1));
  zero   g46(.O(z6));
  zero   g47(.O(z7));
  zero   g48(.O(z8));
