...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n52_, new_n56_, new_n57_, new_n58_;
  ...
  nand3  g35(.a(x3), .b(x2), .c(x1), .O(new_n56_));
  nor2   g36(.a(x6), .b(x0), .O(new_n57_));
  nand2  g37(.a(x5), .b(x4), .O(new_n58_));
  aoi21  g38(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(z9));
  zero   g39(.O(z0));
  zero   g40(.O(z1));
  zero   g41(.O(z3));
endmodule
