...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n57_, new_n58_, new_n60_, new_n61_, new_n62_;
  ...
  or2    g37(.a(x3), .b(x2), .O(new_n56_));
  nand3  g38(.a(new_n56_), .b(new_n55_), .c(new_n37_), .O(new_n57_));
  nand3  g39(.a(new_n57_), .b(new_n54_), .c(x1), .O(new_n58_));
  oai21  g40(.a(new_n53_), .b(new_n46_), .c(new_n58_), .O(z4));
  aoi21  g41(.a(x3), .b(x1), .c(x2), .O(new_n60_));
  inv1   g42(.a(new_n25_), .O(new_n61_));
  oai21  g43(.a(new_n60_), .b(new_n61_), .c(x0), .O(new_n62_));
  oai21  g44(.a(new_n60_), .b(new_n55_), .c(new_n62_), .O(z5));
  zero   g45(.O(z1));
  zero   g46(.O(z6));
  zero   g47(.O(z7));
  zero   g48(.O(z8));
