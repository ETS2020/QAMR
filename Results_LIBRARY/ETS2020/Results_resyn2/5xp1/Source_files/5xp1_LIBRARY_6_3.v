// Benchmark "FAU" written by ABC on Fri Jul 24 21:09:16 2020
...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n72_, new_n73_, new_n75_, new_n76_, new_n80_, new_n81_;
  ...
  nor2   g50(.a(z8), .b(x2), .O(new_n69_));
  inv1   g51(.a(new_n69_), .O(new_n70_));
  oai21  g52(.a(new_n70_), .b(new_n30_), .c(new_n68_), .O(new_n71_));
  oai21  g53(.a(new_n71_), .b(new_n67_), .c(x6), .O(new_n72_));
  nand3  g54(.a(new_n68_), .b(new_n49_), .c(new_n31_), .O(new_n73_));
  nand2  g55(.a(new_n73_), .b(new_n72_), .O(z4));
  nor2   g56(.a(x3), .b(new_n21_), .O(new_n75_));
  aoi21  g57(.a(new_n69_), .b(x1), .c(new_n75_), .O(new_n76_));
  xor2a  g58(.a(new_n76_), .b(new_n30_), .O(z5));
  xor2a  g59(.a(new_n69_), .b(x1), .O(z6));
  and2   g60(.a(new_n35_), .b(new_n47_), .O(z7));
  nand3  g61(.a(new_n31_), .b(new_n22_), .c(new_n30_), .O(new_n80_));
  inv1   g62(.a(new_n80_), .O(new_n81_));
  nor3   g63(.a(new_n81_), .b(new_n19_), .c(new_n34_), .O(z9));
  zero   g64(.O(z0));
endmodule
