...
module FAU ( 
  ...
  nand3  g58(.a(x3), .b(new_n32_), .c(new_n19_), .O(new_n77_));
  nand2  g59(.a(new_n34_), .b(new_n25_), .O(new_n78_));
  xor2a  g60(.a(new_n78_), .b(x0), .O(new_n79_));
  xor2a  g61(.a(new_n79_), .b(new_n77_), .O(z5));
