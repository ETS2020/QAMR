...
module FAU ( 
  ...
  nor2   g32(.a(x18), .b(x17), .O(new_n79_));
  nand3  g33(.a(new_n58_), .b(new_n75_), .c(new_n74_), .O(new_n80_));
  nor2   g34(.a(new_n51_), .b(new_n50_), .O(new_n81_));
  nor3   g35(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(z11));
  inv1   g36(.a(new_n80_), .O(new_n83_));
  nand2  g37(.a(new_n81_), .b(x19), .O(new_n84_));
  ...
  aoi21  g41(.a(new_n84_), .b(x20), .c(new_n80_), .O(new_n88_));
