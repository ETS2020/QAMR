// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:48 2020
...
module FAU ( 
  ...
  nor2   g43(.a(new_n87_), .b(x20), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  nand2  g45(.a(new_n87_), .b(x20), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(new_n80_), .O(z13));
  nand2  g47(.a(new_n91_), .b(x21), .O(new_n94_));
  inv1   g48(.a(x21), .O(new_n95_));
  nand2  g49(.a(new_n90_), .b(new_n95_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n94_), .c(new_n80_), .O(z14));
  nand2  g51(.a(new_n96_), .b(x22), .O(new_n98_));
  nor2   g52(.a(x22), .b(x21), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n90_), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n98_), .c(new_n80_), .O(z15));
  aoi21  g55(.a(new_n100_), .b(x23), .c(new_n79_), .O(new_n102_));
  oai21  g56(.a(new_n100_), .b(x23), .c(new_n102_), .O(z16));
  nor2   g57(.a(x24), .b(x23), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n99_), .c(new_n90_), .O(new_n106_));
  aoi21  g59(.a(new_n106_), .b(x25), .c(new_n79_), .O(new_n107_));
  oai21  g60(.a(new_n106_), .b(x25), .c(new_n107_), .O(z18));
  zero   g61(.O(z08));
  zero   g62(.O(z17));
  buf    g63(.a(x16), .O(z02));
endmodule
