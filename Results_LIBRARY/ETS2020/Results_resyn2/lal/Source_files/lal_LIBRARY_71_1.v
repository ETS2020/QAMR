...
module FAU ( 
  ...
  nor3   g36(.a(new_n79_), .b(x22), .c(x21), .O(new_n88_));
  nor2   g37(.a(new_n88_), .b(new_n81_), .O(new_n89_));
  nand2  g38(.a(new_n89_), .b(new_n87_), .O(z15));
  inv1   g39(.a(x23), .O(new_n92_));
  inv1   g40(.a(x24), .O(new_n93_));
  nand3  g41(.a(new_n88_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  nor2   g42(.a(x22), .b(x21), .O(new_n95_));
  nand3  g43(.a(new_n95_), .b(new_n84_), .c(new_n92_), .O(new_n96_));
  aoi21  g44(.a(new_n96_), .b(x24), .c(new_n81_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n94_), .O(z17));
  nand4  g46(.a(new_n88_), .b(new_n47_), .c(new_n93_), .d(new_n92_), .O(new_n99_));
  oai21  g47(.a(new_n96_), .b(x24), .c(x25), .O(new_n100_));
  nand3  g48(.a(new_n100_), .b(new_n99_), .c(new_n82_), .O(z18));
  zero   g49(.O(z00));
  zero   g50(.O(z07));
  zero   g51(.O(z10));
  zero   g52(.O(z11));
