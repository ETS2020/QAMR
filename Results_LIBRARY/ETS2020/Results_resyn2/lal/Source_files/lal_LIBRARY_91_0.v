...
module FAU ( 
  ...
  nand4  g34(.a(new_n82_), .b(new_n81_), .c(x05), .d(x04), .O(new_n83_));
  inv1   g35(.a(new_n83_), .O(z09));
  nand2  g36(.a(x05), .b(x04), .O(new_n85_));
  nand3  g37(.a(new_n85_), .b(new_n82_), .c(new_n81_), .O(new_n86_));
  inv1   g38(.a(new_n86_), .O(new_n87_));
  nand2  g39(.a(new_n87_), .b(new_n70_), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(z10));
  nor2   g41(.a(new_n65_), .b(new_n70_), .O(new_n90_));
  nor2   g42(.a(x18), .b(x17), .O(new_n91_));
  nor3   g43(.a(new_n91_), .b(new_n86_), .c(new_n90_), .O(z11));
  nor2   g44(.a(new_n90_), .b(x19), .O(new_n93_));
  nand3  g45(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand2  g46(.a(new_n87_), .b(new_n94_), .O(new_n95_));
  nor2   g47(.a(new_n95_), .b(new_n93_), .O(z12));
  nand2  g48(.a(new_n94_), .b(x20), .O(new_n97_));
  nor2   g49(.a(new_n94_), .b(x20), .O(new_n98_));
  inv1   g50(.a(new_n98_), .O(new_n99_));
  nand3  g51(.a(new_n99_), .b(new_n97_), .c(new_n87_), .O(z13));
  nand2  g52(.a(new_n99_), .b(x21), .O(new_n101_));
  inv1   g53(.a(x21), .O(new_n102_));
  nand2  g54(.a(new_n98_), .b(new_n102_), .O(new_n103_));
  nand3  g55(.a(new_n103_), .b(new_n101_), .c(new_n87_), .O(z14));
  nand2  g56(.a(new_n103_), .b(x22), .O(new_n105_));
  nor2   g57(.a(x22), .b(x21), .O(new_n106_));
  nand2  g58(.a(new_n98_), .b(new_n106_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n105_), .c(new_n87_), .O(z15));
  nand2  g60(.a(new_n107_), .b(x23), .O(new_n109_));
  nand3  g61(.a(new_n98_), .b(new_n106_), .c(new_n76_), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n109_), .c(new_n87_), .O(z16));
  inv1   g63(.a(new_n94_), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n63_), .c(new_n62_), .O(new_n113_));
  nand2  g65(.a(new_n110_), .b(x24), .O(new_n114_));
  nand3  g66(.a(new_n114_), .b(new_n87_), .c(new_n113_), .O(z17));
  nand4  g67(.a(new_n112_), .b(new_n63_), .c(new_n62_), .d(new_n71_), .O(new_n116_));
  nand2  g68(.a(new_n113_), .b(x25), .O(new_n117_));
  nand3  g69(.a(new_n117_), .b(new_n116_), .c(new_n87_), .O(z18));
  zero   g70(.O(z01));
  zero   g71(.O(z02));
  zero   g72(.O(z03));
endmodule
