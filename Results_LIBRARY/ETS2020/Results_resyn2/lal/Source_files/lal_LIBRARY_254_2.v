...
module FAU ( 
  ...
  nor2   g24(.a(x18), .b(x17), .O(new_n73_));
  nand3  g25(.a(new_n58_), .b(new_n69_), .c(new_n68_), .O(new_n74_));
  nor2   g26(.a(new_n51_), .b(new_n50_), .O(new_n75_));
  nor3   g27(.a(new_n75_), .b(new_n74_), .c(new_n73_), .O(z11));
  inv1   g28(.a(new_n74_), .O(new_n77_));
  nand2  g29(.a(new_n75_), .b(x19), .O(new_n78_));
  oai21  g30(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n79_));
  nand3  g31(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  inv1   g32(.a(new_n80_), .O(z12));
  aoi21  g33(.a(new_n78_), .b(x20), .c(new_n74_), .O(new_n82_));
  oai21  g34(.a(new_n78_), .b(x20), .c(new_n82_), .O(z13));
  zero   g35(.O(z04));
  zero   g36(.O(z05));
  zero   g37(.O(z10));
  zero   g38(.O(z14));
