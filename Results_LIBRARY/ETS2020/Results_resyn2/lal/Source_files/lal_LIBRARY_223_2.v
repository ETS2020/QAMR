// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:47 2020
...
module FAU ( 
  ...
  nand4  g29(.a(new_n71_), .b(new_n74_), .c(new_n73_), .d(new_n49_), .O(new_n75_));
  inv1   g30(.a(x18), .O(new_n76_));
  inv1   g31(.a(x19), .O(new_n77_));
  nor3   g32(.a(x24), .b(new_n77_), .c(new_n76_), .O(new_n78_));
  nand3  g33(.a(new_n78_), .b(new_n75_), .c(new_n71_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x25), .O(new_n80_));
  aoi21  g35(.a(new_n77_), .b(new_n76_), .c(x20), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(new_n50_), .c(new_n48_), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(x24), .c(x25), .O(new_n83_));
  nand2  g38(.a(new_n74_), .b(x17), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  oai21  g40(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z08));
  ...
  nand2  g54(.a(new_n93_), .b(new_n72_), .O(new_n100_));
  aoi21  g55(.a(new_n96_), .b(new_n77_), .c(new_n100_), .O(z12));
  inv1   g56(.a(x20), .O(new_n102_));
  aoi21  g57(.a(new_n73_), .b(new_n102_), .c(new_n92_), .O(new_n103_));
  oai21  g58(.a(new_n73_), .b(new_n102_), .c(new_n103_), .O(z13));
  nand2  g59(.a(new_n71_), .b(new_n74_), .O(new_n108_));
  oai21  g60(.a(new_n108_), .b(new_n72_), .c(x24), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n93_), .c(new_n75_), .O(z17));
  zero   g62(.O(z14));
  zero   g63(.O(z15));
  zero   g64(.O(z16));
  zero   g65(.O(z18));
