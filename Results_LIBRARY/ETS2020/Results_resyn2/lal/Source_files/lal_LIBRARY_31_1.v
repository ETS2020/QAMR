...
module FAU ( 
  ...
  nand3  g26(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n79_));
  aoi21  g27(.a(new_n78_), .b(x21), .c(new_n79_), .O(new_n80_));
  oai21  g28(.a(new_n78_), .b(x21), .c(new_n80_), .O(z14));
  inv1   g29(.a(new_n79_), .O(new_n83_));
  inv1   g30(.a(x23), .O(new_n84_));
  inv1   g31(.a(new_n78_), .O(new_n85_));
  nor2   g32(.a(x22), .b(x21), .O(new_n86_));
  nand3  g33(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  nand2  g34(.a(new_n86_), .b(new_n85_), .O(new_n88_));
  nand2  g35(.a(new_n88_), .b(x23), .O(new_n89_));
  nand3  g36(.a(new_n89_), .b(new_n87_), .c(new_n83_), .O(z16));
  inv1   g37(.a(x24), .O(new_n91_));
  nor3   g38(.a(new_n78_), .b(x22), .c(x21), .O(new_n92_));
  nand3  g39(.a(new_n92_), .b(new_n91_), .c(new_n84_), .O(new_n93_));
  aoi21  g40(.a(new_n87_), .b(x24), .c(new_n79_), .O(new_n94_));
  nand2  g41(.a(new_n94_), .b(new_n93_), .O(z17));
  nand4  g42(.a(new_n92_), .b(new_n47_), .c(new_n91_), .d(new_n84_), .O(new_n96_));
  oai21  g43(.a(new_n87_), .b(x24), .c(x25), .O(new_n97_));
  nand3  g44(.a(new_n97_), .b(new_n96_), .c(new_n83_), .O(z18));
  zero   g45(.O(z00));
  zero   g46(.O(z06));
  zero   g47(.O(z07));
  zero   g48(.O(z10));
