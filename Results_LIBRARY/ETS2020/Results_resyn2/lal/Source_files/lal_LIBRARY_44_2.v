...
module FAU ( 
  ...
  inv1   g25(.a(x07), .O(new_n73_));
  inv1   g26(.a(x15), .O(new_n74_));
  nand3  g27(.a(new_n59_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  inv1   g28(.a(new_n75_), .O(z09));
  nand3  g29(.a(new_n58_), .b(new_n74_), .c(new_n73_), .O(new_n77_));
  inv1   g30(.a(new_n77_), .O(new_n78_));
  nand2  g31(.a(new_n78_), .b(new_n50_), .O(new_n79_));
  inv1   g32(.a(new_n79_), .O(z10));
  nor2   g33(.a(x18), .b(x17), .O(new_n81_));
  nor2   g34(.a(new_n51_), .b(new_n50_), .O(new_n82_));
  nor3   g35(.a(new_n82_), .b(new_n77_), .c(new_n81_), .O(z11));
  nand2  g36(.a(new_n82_), .b(x19), .O(new_n84_));
  oai21  g37(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n85_));
  nand3  g38(.a(new_n85_), .b(new_n84_), .c(new_n78_), .O(new_n86_));
  inv1   g39(.a(new_n86_), .O(z12));
  aoi21  g40(.a(new_n84_), .b(x20), .c(new_n77_), .O(new_n88_));
  oai21  g41(.a(new_n84_), .b(x20), .c(new_n88_), .O(z13));
  zero   g42(.O(z05));
  zero   g43(.O(z06));
  zero   g44(.O(z14));
  zero   g45(.O(z15));
