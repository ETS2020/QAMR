...
module FAU ( 
  ...
  nand4  g46(.a(new_n83_), .b(new_n91_), .c(new_n49_), .d(x19), .O(new_n92_));
  oai21  g47(.a(new_n85_), .b(x20), .c(x21), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n79_), .O(z14));
  zero   g49(.O(z15));
  zero   g50(.O(z16));
  zero   g51(.O(z17));
  zero   g52(.O(z18));
