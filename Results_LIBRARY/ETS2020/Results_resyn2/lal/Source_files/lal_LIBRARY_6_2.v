...
module FAU ( 
  ...
  nor2   g35(.a(new_n51_), .b(new_n50_), .O(new_n83_));
  nor3   g36(.a(new_n83_), .b(new_n78_), .c(new_n82_), .O(z11));
  nor2   g37(.a(new_n83_), .b(x19), .O(new_n85_));
  nand2  g38(.a(new_n83_), .b(x19), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n79_), .O(new_n87_));
  nor2   g40(.a(new_n87_), .b(new_n85_), .O(z12));
  aoi21  g41(.a(new_n86_), .b(x20), .c(new_n78_), .O(new_n89_));
  oai21  g42(.a(new_n86_), .b(x20), .c(new_n89_), .O(z13));
  zero   g43(.O(z06));
  zero   g44(.O(z08));
  zero   g45(.O(z14));
  zero   g46(.O(z15));
