...
module FAU ( 
  ...
  nand3  g52(.a(new_n91_), .b(new_n98_), .c(new_n95_), .O(new_n99_));
  nand2  g53(.a(new_n96_), .b(x22), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n99_), .c(new_n80_), .O(z15));
  oai21  g55(.a(new_n99_), .b(x23), .c(x24), .O(new_n103_));
  nor3   g56(.a(x24), .b(x23), .c(x22), .O(new_n104_));
  nand3  g57(.a(new_n104_), .b(new_n91_), .c(new_n95_), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n103_), .c(new_n80_), .O(z17));
  aoi21  g59(.a(new_n105_), .b(x25), .c(new_n79_), .O(new_n107_));
  oai21  g60(.a(new_n105_), .b(x25), .c(new_n107_), .O(z18));
  zero   g61(.O(z08));
  zero   g62(.O(z16));
  buf    g63(.a(x16), .O(z02));
endmodule
