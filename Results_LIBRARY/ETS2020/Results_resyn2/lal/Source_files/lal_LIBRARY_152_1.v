...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n89_, new_n91_, new_n92_, new_n93_, new_n96_, new_n97_,
    new_n98_, new_n99_;
  ...
  oai21  g43(.a(new_n92_), .b(x24), .c(x25), .O(new_n96_));
  inv1   g44(.a(x24), .O(new_n97_));
  nor3   g45(.a(new_n79_), .b(x22), .c(x21), .O(new_n98_));
  nand4  g46(.a(new_n98_), .b(new_n47_), .c(new_n97_), .d(new_n91_), .O(new_n99_));
  nand3  g47(.a(new_n99_), .b(new_n96_), .c(new_n82_), .O(z18));
  zero   g48(.O(z00));
  zero   g49(.O(z07));
  zero   g50(.O(z10));
  zero   g51(.O(z11));
