// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:41 2020
...
module FAU ( 
  ...
  nand3  g35(.a(x19), .b(x18), .c(x17), .O(new_n83_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n84_));
  nand3  g37(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(new_n85_));
  inv1   g38(.a(new_n85_), .O(z12));
  aoi21  g39(.a(new_n83_), .b(x20), .c(new_n78_), .O(new_n87_));
  oai21  g40(.a(new_n83_), .b(x20), .c(new_n87_), .O(z13));
  zero   g41(.O(z05));
  zero   g42(.O(z11));
  zero   g43(.O(z14));
  zero   g44(.O(z15));
