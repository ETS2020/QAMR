...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n75_, new_n78_, new_n79_, new_n80_, new_n84_, new_n85_, new_n86_,
  ...
  nand3  g27(.a(new_n58_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  inv1   g28(.a(new_n75_), .O(z09));
  nor2   g29(.a(x18), .b(x17), .O(new_n78_));
  nand3  g30(.a(new_n57_), .b(new_n74_), .c(new_n73_), .O(new_n79_));
  nor2   g31(.a(new_n50_), .b(new_n49_), .O(new_n80_));
  nor3   g32(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(z11));
  inv1   g33(.a(new_n79_), .O(new_n84_));
  nand4  g34(.a(new_n48_), .b(x19), .c(x18), .d(x17), .O(new_n85_));
  nand2  g35(.a(new_n85_), .b(x21), .O(new_n86_));
  inv1   g36(.a(x21), .O(new_n87_));
  inv1   g37(.a(new_n85_), .O(new_n88_));
  nand2  g38(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand3  g39(.a(new_n89_), .b(new_n86_), .c(new_n84_), .O(z14));
  nand2  g40(.a(new_n89_), .b(x22), .O(new_n91_));
  nor2   g41(.a(x22), .b(x21), .O(new_n92_));
  nand2  g42(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand3  g43(.a(new_n93_), .b(new_n91_), .c(new_n84_), .O(z15));
  inv1   g44(.a(x23), .O(new_n95_));
  nand3  g45(.a(new_n92_), .b(new_n88_), .c(new_n95_), .O(new_n96_));
  nand2  g46(.a(new_n93_), .b(x23), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n96_), .c(new_n84_), .O(z16));
  inv1   g48(.a(x24), .O(new_n99_));
  nor3   g49(.a(new_n85_), .b(x22), .c(x21), .O(new_n100_));
  nand3  g50(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(new_n101_));
  aoi21  g51(.a(new_n96_), .b(x24), .c(new_n79_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n101_), .O(z17));
  nand4  g53(.a(new_n100_), .b(new_n47_), .c(new_n99_), .d(new_n95_), .O(new_n104_));
  oai21  g54(.a(new_n96_), .b(x24), .c(x25), .O(new_n105_));
