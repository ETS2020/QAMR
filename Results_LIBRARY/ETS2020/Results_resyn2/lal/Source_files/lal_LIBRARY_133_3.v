// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:26 2020
...
module FAU ( 
  ...
  nand3  g28(.a(new_n59_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g29(.a(new_n76_), .O(z09));
  nand3  g30(.a(new_n58_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  inv1   g31(.a(new_n78_), .O(new_n79_));
  nand2  g32(.a(new_n79_), .b(new_n50_), .O(new_n80_));
  inv1   g33(.a(new_n80_), .O(z10));
  nor2   g34(.a(x18), .b(x17), .O(new_n82_));
  nand2  g35(.a(x18), .b(x17), .O(new_n83_));
  inv1   g36(.a(new_n83_), .O(new_n84_));
  nor3   g37(.a(new_n84_), .b(new_n78_), .c(new_n82_), .O(z11));
  nand3  g38(.a(x19), .b(x18), .c(x17), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n79_), .O(new_n87_));
  aoi21  g40(.a(new_n83_), .b(new_n52_), .c(new_n87_), .O(z12));
  nand2  g41(.a(new_n86_), .b(x20), .O(new_n89_));
  nor2   g42(.a(new_n86_), .b(x20), .O(new_n90_));
  inv1   g43(.a(new_n90_), .O(new_n91_));
  nand3  g44(.a(new_n91_), .b(new_n89_), .c(new_n79_), .O(z13));
  nand2  g45(.a(new_n91_), .b(x21), .O(new_n93_));
  inv1   g46(.a(x21), .O(new_n94_));
  nand2  g47(.a(new_n90_), .b(new_n94_), .O(new_n95_));
  nand3  g48(.a(new_n95_), .b(new_n93_), .c(new_n79_), .O(z14));
  aoi21  g49(.a(new_n95_), .b(x22), .c(new_n78_), .O(new_n97_));
  oai21  g50(.a(new_n95_), .b(x22), .c(new_n97_), .O(z15));
  oai21  g51(.a(new_n95_), .b(x22), .c(x23), .O(new_n99_));
  nor2   g52(.a(x23), .b(x22), .O(new_n100_));
  nand3  g53(.a(new_n100_), .b(new_n90_), .c(new_n94_), .O(new_n101_));
  nand3  g54(.a(new_n101_), .b(new_n99_), .c(new_n79_), .O(z16));
  nand2  g55(.a(new_n101_), .b(x24), .O(new_n103_));
  inv1   g56(.a(x24), .O(new_n104_));
  nand4  g57(.a(new_n100_), .b(new_n90_), .c(new_n104_), .d(new_n94_), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n103_), .c(new_n79_), .O(z17));
  aoi21  g59(.a(new_n105_), .b(x25), .c(new_n78_), .O(new_n107_));
