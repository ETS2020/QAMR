...
module FAU ( 
  ...
  wire new_n46_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n77_, new_n78_, new_n79_, new_n80_, new_n82_, new_n85_, new_n86_,
  ...
  xnor2a g30(.a(x18), .b(x17), .O(new_n82_));
  nor2   g31(.a(new_n82_), .b(new_n78_), .O(z11));
  nand3  g32(.a(x19), .b(x18), .c(x17), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(x20), .O(new_n86_));
  nor2   g34(.a(new_n85_), .b(x20), .O(new_n87_));
  inv1   g35(.a(new_n87_), .O(new_n88_));
  nand3  g36(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(z13));
  nand2  g37(.a(new_n88_), .b(x21), .O(new_n90_));
  inv1   g38(.a(x21), .O(new_n91_));
  nand2  g39(.a(new_n87_), .b(new_n91_), .O(new_n92_));
  nand3  g40(.a(new_n92_), .b(new_n90_), .c(new_n79_), .O(z14));
  nand2  g41(.a(new_n92_), .b(x22), .O(new_n94_));
  nor2   g42(.a(x22), .b(x21), .O(new_n95_));
  nand2  g43(.a(new_n87_), .b(new_n95_), .O(new_n96_));
  nand3  g44(.a(new_n96_), .b(new_n94_), .c(new_n79_), .O(z15));
  nand2  g45(.a(new_n96_), .b(x23), .O(new_n98_));
  nand3  g46(.a(new_n87_), .b(new_n95_), .c(new_n69_), .O(new_n99_));
  nand3  g47(.a(new_n99_), .b(new_n98_), .c(new_n79_), .O(z16));
  inv1   g48(.a(new_n85_), .O(new_n101_));
  nand3  g49(.a(new_n101_), .b(new_n56_), .c(new_n55_), .O(new_n102_));
  nand2  g50(.a(new_n99_), .b(x24), .O(new_n103_));
  nand3  g51(.a(new_n103_), .b(new_n79_), .c(new_n102_), .O(z17));
  nand4  g52(.a(new_n101_), .b(new_n56_), .c(new_n55_), .d(new_n64_), .O(new_n105_));
  nand2  g53(.a(new_n102_), .b(x25), .O(new_n106_));
  nand3  g54(.a(new_n106_), .b(new_n105_), .c(new_n79_), .O(z18));
  zero   g55(.O(z01));
  zero   g56(.O(z02));
  zero   g57(.O(z03));
  zero   g58(.O(z04));
