...
module FAU ( 
  ...
  nand3  g53(.a(new_n90_), .b(new_n99_), .c(new_n95_), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n98_), .c(new_n80_), .O(z15));
  nand2  g55(.a(new_n100_), .b(x23), .O(new_n102_));
  nor2   g56(.a(x23), .b(x22), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n90_), .c(new_n95_), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n102_), .c(new_n80_), .O(z16));
  aoi21  g59(.a(new_n104_), .b(x24), .c(new_n79_), .O(new_n106_));
  oai21  g60(.a(new_n104_), .b(x24), .c(new_n106_), .O(z17));
  zero   g61(.O(z08));
  zero   g62(.O(z18));
  buf    g63(.a(x16), .O(z02));
endmodule
