// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:52 2020
...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n76_, new_n77_, new_n78_, new_n83_, new_n84_, new_n85_, new_n86_,
  ...
  nand3  g24(.a(new_n58_), .b(new_n73_), .c(new_n72_), .O(new_n74_));
  inv1   g25(.a(new_n74_), .O(z09));
  nand3  g26(.a(new_n57_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  inv1   g27(.a(new_n76_), .O(new_n77_));
  nand2  g28(.a(new_n77_), .b(new_n49_), .O(new_n78_));
  inv1   g29(.a(new_n78_), .O(z10));
  nand4  g30(.a(new_n48_), .b(x19), .c(x18), .d(x17), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(x21), .O(new_n84_));
  inv1   g32(.a(x21), .O(new_n85_));
  inv1   g33(.a(new_n83_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g35(.a(new_n87_), .b(new_n84_), .c(new_n77_), .O(z14));
  nand2  g36(.a(new_n87_), .b(x22), .O(new_n89_));
  nor2   g37(.a(x22), .b(x21), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n86_), .O(new_n91_));
  nand3  g39(.a(new_n91_), .b(new_n89_), .c(new_n77_), .O(z15));
  inv1   g40(.a(x23), .O(new_n93_));
  nand3  g41(.a(new_n90_), .b(new_n86_), .c(new_n93_), .O(new_n94_));
  nand2  g42(.a(new_n91_), .b(x23), .O(new_n95_));
  nand3  g43(.a(new_n95_), .b(new_n94_), .c(new_n77_), .O(z16));
  inv1   g44(.a(x24), .O(new_n97_));
  nor3   g45(.a(new_n83_), .b(x22), .c(x21), .O(new_n98_));
  nand3  g46(.a(new_n98_), .b(new_n97_), .c(new_n93_), .O(new_n99_));
  aoi21  g47(.a(new_n94_), .b(x24), .c(new_n76_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n99_), .O(z17));
  nand4  g49(.a(new_n98_), .b(new_n47_), .c(new_n97_), .d(new_n93_), .O(new_n102_));
  oai21  g50(.a(new_n94_), .b(x24), .c(x25), .O(new_n103_));
  nand3  g51(.a(new_n103_), .b(new_n102_), .c(new_n77_), .O(z18));
  zero   g52(.O(z00));
  zero   g53(.O(z05));
  zero   g54(.O(z06));
  zero   g55(.O(z07));
