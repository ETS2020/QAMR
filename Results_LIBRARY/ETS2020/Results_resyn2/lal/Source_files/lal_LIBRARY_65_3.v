...
module FAU ( 
  ...
  nor2   g38(.a(new_n85_), .b(new_n73_), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n84_), .O(z13));
  inv1   g40(.a(x21), .O(new_n89_));
  nand2  g41(.a(new_n85_), .b(new_n89_), .O(new_n90_));
  aoi21  g42(.a(new_n90_), .b(x22), .c(new_n73_), .O(new_n91_));
  oai21  g43(.a(new_n90_), .b(x22), .c(new_n91_), .O(z15));
  oai21  g44(.a(new_n90_), .b(x22), .c(x23), .O(new_n93_));
  nor2   g45(.a(x23), .b(x22), .O(new_n94_));
  nand3  g46(.a(new_n94_), .b(new_n85_), .c(new_n89_), .O(new_n95_));
  nand3  g47(.a(new_n95_), .b(new_n93_), .c(new_n74_), .O(z16));
  nand2  g48(.a(new_n95_), .b(x24), .O(new_n97_));
  inv1   g49(.a(x24), .O(new_n98_));
  nand4  g50(.a(new_n94_), .b(new_n85_), .c(new_n98_), .d(new_n89_), .O(new_n99_));
  nand3  g51(.a(new_n99_), .b(new_n97_), .c(new_n74_), .O(z17));
  aoi21  g52(.a(new_n99_), .b(x25), .c(new_n73_), .O(new_n101_));
  oai21  g53(.a(new_n99_), .b(x25), .c(new_n101_), .O(z18));
  zero   g54(.O(z04));
  zero   g55(.O(z08));
  zero   g56(.O(z14));
  buf    g57(.a(x16), .O(z02));
