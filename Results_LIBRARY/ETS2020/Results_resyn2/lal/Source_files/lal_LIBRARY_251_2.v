// Benchmark "FAU" written by ABC on Fri Jul 24 22:27:54 2020
...
module FAU ( 
  ...
  inv1   g27(.a(x07), .O(new_n74_));
  inv1   g28(.a(x15), .O(new_n75_));
  nand3  g29(.a(new_n59_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g30(.a(new_n76_), .O(z09));
  nand3  g31(.a(new_n58_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  inv1   g32(.a(new_n78_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n50_), .O(new_n80_));
  inv1   g34(.a(new_n80_), .O(z10));
  nor2   g35(.a(x18), .b(x17), .O(new_n82_));
  nor2   g36(.a(new_n51_), .b(new_n50_), .O(new_n83_));
  nor3   g37(.a(new_n83_), .b(new_n78_), .c(new_n82_), .O(z11));
  nand2  g38(.a(new_n83_), .b(x19), .O(new_n85_));
  oai21  g39(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n86_));
  nand3  g40(.a(new_n86_), .b(new_n85_), .c(new_n79_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(z12));
  aoi21  g42(.a(new_n85_), .b(x20), .c(new_n78_), .O(new_n89_));
  oai21  g43(.a(new_n85_), .b(x20), .c(new_n89_), .O(z13));
  zero   g44(.O(z05));
  zero   g45(.O(z14));
  zero   g46(.O(z15));
  zero   g47(.O(z16));
