...
module FAU ( 
  ...
  nand2  g24(.a(new_n70_), .b(x06), .O(z07));
  inv1   g25(.a(x07), .O(new_n72_));
  inv1   g26(.a(x15), .O(new_n73_));
  nand4  g27(.a(new_n73_), .b(new_n72_), .c(x05), .d(x04), .O(new_n74_));
  inv1   g28(.a(new_n74_), .O(z09));
  nand4  g29(.a(new_n48_), .b(x19), .c(x18), .d(x17), .O(new_n80_));
  nand2  g30(.a(new_n80_), .b(x21), .O(new_n81_));
  nand3  g31(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n82_));
  inv1   g32(.a(new_n82_), .O(new_n83_));
  inv1   g33(.a(x21), .O(new_n84_));
  inv1   g34(.a(new_n80_), .O(new_n85_));
  nand2  g35(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand3  g36(.a(new_n86_), .b(new_n83_), .c(new_n81_), .O(z14));
  nand2  g37(.a(new_n86_), .b(x22), .O(new_n88_));
  nor2   g38(.a(x22), .b(x21), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nand3  g40(.a(new_n90_), .b(new_n88_), .c(new_n83_), .O(z15));
  inv1   g41(.a(x23), .O(new_n92_));
  nand3  g42(.a(new_n89_), .b(new_n85_), .c(new_n92_), .O(new_n93_));
  nand2  g43(.a(new_n90_), .b(x23), .O(new_n94_));
  nand3  g44(.a(new_n94_), .b(new_n93_), .c(new_n83_), .O(z16));
  inv1   g45(.a(x24), .O(new_n96_));
  nor3   g46(.a(new_n80_), .b(x22), .c(x21), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(new_n98_));
  aoi21  g48(.a(new_n93_), .b(x24), .c(new_n82_), .O(new_n99_));
  nand2  g49(.a(new_n99_), .b(new_n98_), .O(z17));
  nand4  g50(.a(new_n97_), .b(new_n47_), .c(new_n96_), .d(new_n92_), .O(new_n101_));
  oai21  g51(.a(new_n93_), .b(x24), .c(x25), .O(new_n102_));
  nand3  g52(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(z18));
  zero   g53(.O(z00));
  zero   g54(.O(z10));
  zero   g55(.O(z11));
  zero   g56(.O(z12));
