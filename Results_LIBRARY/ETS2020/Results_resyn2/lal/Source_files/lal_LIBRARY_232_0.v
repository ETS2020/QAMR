...
module FAU ( 
  ...
  nor2   g38(.a(new_n64_), .b(new_n69_), .O(new_n88_));
  nor2   g39(.a(x18), .b(x17), .O(new_n89_));
  nor3   g40(.a(new_n89_), .b(new_n84_), .c(new_n88_), .O(z11));
  nor2   g41(.a(new_n88_), .b(x19), .O(new_n91_));
  nand3  g42(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  nand2  g43(.a(new_n85_), .b(new_n92_), .O(new_n93_));
  nor2   g44(.a(new_n93_), .b(new_n91_), .O(z12));
  nand2  g45(.a(new_n92_), .b(x20), .O(new_n95_));
  nor2   g46(.a(new_n92_), .b(x20), .O(new_n96_));
  inv1   g47(.a(new_n96_), .O(new_n97_));
  nand3  g48(.a(new_n97_), .b(new_n95_), .c(new_n85_), .O(z13));
  nand2  g49(.a(new_n97_), .b(x21), .O(new_n99_));
  inv1   g50(.a(x21), .O(new_n100_));
  nand2  g51(.a(new_n96_), .b(new_n100_), .O(new_n101_));
  nand3  g52(.a(new_n101_), .b(new_n99_), .c(new_n85_), .O(z14));
  nand2  g53(.a(new_n101_), .b(x22), .O(new_n103_));
  nor2   g54(.a(x22), .b(x21), .O(new_n104_));
  nand2  g55(.a(new_n96_), .b(new_n104_), .O(new_n105_));
  nand3  g56(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(z15));
  nand2  g57(.a(new_n105_), .b(x23), .O(new_n107_));
  nand3  g58(.a(new_n96_), .b(new_n104_), .c(new_n75_), .O(new_n108_));
  nand3  g59(.a(new_n108_), .b(new_n107_), .c(new_n85_), .O(z16));
  inv1   g60(.a(new_n92_), .O(new_n110_));
  nand3  g61(.a(new_n110_), .b(new_n62_), .c(new_n61_), .O(new_n111_));
  nand2  g62(.a(new_n108_), .b(x24), .O(new_n112_));
  nand3  g63(.a(new_n112_), .b(new_n85_), .c(new_n111_), .O(z17));
  nand4  g64(.a(new_n110_), .b(new_n62_), .c(new_n61_), .d(new_n70_), .O(new_n114_));
  nand2  g65(.a(new_n111_), .b(x25), .O(new_n115_));
  nand3  g66(.a(new_n115_), .b(new_n114_), .c(new_n85_), .O(z18));
  zero   g67(.O(z01));
  zero   g68(.O(z03));
  zero   g69(.O(z05));
  zero   g70(.O(z09));
