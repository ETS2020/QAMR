...
module FAU ( 
  ...
  nor3   g34(.a(new_n72_), .b(x22), .c(x21), .O(new_n89_));
  nand3  g35(.a(new_n89_), .b(new_n88_), .c(new_n84_), .O(new_n90_));
  aoi21  g36(.a(new_n85_), .b(x24), .c(new_n74_), .O(new_n91_));
  nand2  g37(.a(new_n91_), .b(new_n90_), .O(z17));
  nand4  g38(.a(new_n89_), .b(new_n47_), .c(new_n88_), .d(new_n84_), .O(new_n93_));
  oai21  g39(.a(new_n85_), .b(x24), .c(x25), .O(new_n94_));
  nand3  g40(.a(new_n94_), .b(new_n93_), .c(new_n75_), .O(z18));
  zero   g41(.O(z00));
  zero   g42(.O(z04));
  zero   g43(.O(z05));
  zero   g44(.O(z06));
