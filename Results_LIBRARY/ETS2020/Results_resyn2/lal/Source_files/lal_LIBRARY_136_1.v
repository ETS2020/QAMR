...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n64_, new_n65_, new_n70_, new_n71_, new_n72_, new_n79_, new_n80_,
  ...
  oai21  g26(.a(new_n79_), .b(x21), .c(x22), .O(new_n80_));
  nand3  g27(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n81_));
  inv1   g28(.a(new_n81_), .O(new_n82_));
  inv1   g29(.a(new_n79_), .O(new_n83_));
  nor2   g30(.a(x22), .b(x21), .O(new_n84_));
  nand2  g31(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand3  g32(.a(new_n85_), .b(new_n82_), .c(new_n80_), .O(z15));
  inv1   g33(.a(x23), .O(new_n87_));
  nand3  g34(.a(new_n84_), .b(new_n83_), .c(new_n87_), .O(new_n88_));
  nand2  g35(.a(new_n85_), .b(x23), .O(new_n89_));
  nand3  g36(.a(new_n89_), .b(new_n88_), .c(new_n82_), .O(z16));
  inv1   g37(.a(x24), .O(new_n91_));
  nor3   g38(.a(new_n79_), .b(x22), .c(x21), .O(new_n92_));
  nand3  g39(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(new_n93_));
  aoi21  g40(.a(new_n88_), .b(x24), .c(new_n81_), .O(new_n94_));
  nand2  g41(.a(new_n94_), .b(new_n93_), .O(z17));
  nand4  g42(.a(new_n92_), .b(new_n47_), .c(new_n91_), .d(new_n87_), .O(new_n96_));
  oai21  g43(.a(new_n88_), .b(x24), .c(x25), .O(new_n97_));
  nand3  g44(.a(new_n97_), .b(new_n96_), .c(new_n82_), .O(z18));
  zero   g45(.O(z00));
  zero   g46(.O(z06));
  zero   g47(.O(z07));
  zero   g48(.O(z10));
