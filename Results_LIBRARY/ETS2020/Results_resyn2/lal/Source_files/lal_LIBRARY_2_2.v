...
module FAU ( 
  ...
  inv1   g20(.a(x07), .O(new_n68_));
  inv1   g21(.a(x15), .O(new_n69_));
  nand3  g22(.a(new_n59_), .b(new_n69_), .c(new_n68_), .O(new_n70_));
  inv1   g23(.a(new_n70_), .O(z09));
  nand3  g24(.a(new_n58_), .b(new_n69_), .c(new_n68_), .O(new_n72_));
  inv1   g25(.a(new_n72_), .O(new_n73_));
  nand2  g26(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  inv1   g27(.a(new_n74_), .O(z10));
  nor2   g28(.a(x18), .b(x17), .O(new_n76_));
  nor2   g29(.a(new_n51_), .b(new_n50_), .O(new_n77_));
  nor3   g30(.a(new_n77_), .b(new_n72_), .c(new_n76_), .O(z11));
  nand2  g31(.a(new_n77_), .b(x19), .O(new_n79_));
  oai21  g32(.a(new_n51_), .b(new_n50_), .c(new_n52_), .O(new_n80_));
  nand3  g33(.a(new_n80_), .b(new_n79_), .c(new_n73_), .O(new_n81_));
  inv1   g34(.a(new_n81_), .O(z12));
  aoi21  g35(.a(new_n79_), .b(x20), .c(new_n72_), .O(new_n83_));
  oai21  g36(.a(new_n79_), .b(x20), .c(new_n83_), .O(z13));
  zero   g37(.O(z04));
  zero   g38(.O(z05));
  zero   g39(.O(z14));
  zero   g40(.O(z15));
