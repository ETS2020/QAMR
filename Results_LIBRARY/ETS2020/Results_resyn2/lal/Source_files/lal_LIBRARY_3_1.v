// Benchmark "FAU" written by ABC on Fri Jul 24 22:26:55 2020
...
module FAU ( 
  ...
  inv1   g22(.a(x07), .O(new_n71_));
  inv1   g23(.a(x15), .O(new_n72_));
  nand4  g24(.a(new_n72_), .b(new_n71_), .c(x05), .d(x04), .O(new_n73_));
  inv1   g25(.a(new_n73_), .O(z09));
  nand4  g26(.a(new_n48_), .b(x19), .c(x18), .d(x17), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(x21), .O(new_n80_));
  nand3  g28(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n81_));
  inv1   g29(.a(new_n81_), .O(new_n82_));
  inv1   g30(.a(x21), .O(new_n83_));
  inv1   g31(.a(new_n79_), .O(new_n84_));
  nand2  g32(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand3  g33(.a(new_n85_), .b(new_n82_), .c(new_n80_), .O(z14));
  nand2  g34(.a(new_n85_), .b(x22), .O(new_n87_));
  nor2   g35(.a(x22), .b(x21), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  nand3  g37(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(z15));
  inv1   g38(.a(x23), .O(new_n91_));
  nand3  g39(.a(new_n88_), .b(new_n84_), .c(new_n91_), .O(new_n92_));
  nand2  g40(.a(new_n89_), .b(x23), .O(new_n93_));
  nand3  g41(.a(new_n93_), .b(new_n92_), .c(new_n82_), .O(z16));
  inv1   g42(.a(x24), .O(new_n95_));
  nor3   g43(.a(new_n79_), .b(x22), .c(x21), .O(new_n96_));
  nand3  g44(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(new_n97_));
  aoi21  g45(.a(new_n92_), .b(x24), .c(new_n81_), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n97_), .O(z17));
  nand4  g47(.a(new_n96_), .b(new_n47_), .c(new_n95_), .d(new_n91_), .O(new_n100_));
  oai21  g48(.a(new_n92_), .b(x24), .c(x25), .O(new_n101_));
  nand3  g49(.a(new_n101_), .b(new_n100_), .c(new_n82_), .O(z18));
  zero   g50(.O(z00));
  zero   g51(.O(z05));
  zero   g52(.O(z07));
  zero   g53(.O(z10));
