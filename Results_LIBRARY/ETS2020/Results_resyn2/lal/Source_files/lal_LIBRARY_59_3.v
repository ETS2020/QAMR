...
module FAU ( 
  ...
  nor2   g44(.a(new_n91_), .b(new_n79_), .O(new_n92_));
  nand2  g45(.a(new_n92_), .b(new_n90_), .O(z13));
  inv1   g46(.a(x21), .O(new_n95_));
  nand2  g47(.a(new_n91_), .b(new_n95_), .O(new_n96_));
  aoi21  g48(.a(new_n96_), .b(x22), .c(new_n79_), .O(new_n97_));
  oai21  g49(.a(new_n96_), .b(x22), .c(new_n97_), .O(z15));
  oai21  g50(.a(new_n96_), .b(x22), .c(x23), .O(new_n99_));
  nor2   g51(.a(x23), .b(x22), .O(new_n100_));
  nand3  g52(.a(new_n100_), .b(new_n91_), .c(new_n95_), .O(new_n101_));
  nand3  g53(.a(new_n101_), .b(new_n99_), .c(new_n80_), .O(z16));
  nand2  g54(.a(new_n101_), .b(x24), .O(new_n103_));
  inv1   g55(.a(x24), .O(new_n104_));
  nand4  g56(.a(new_n100_), .b(new_n91_), .c(new_n104_), .d(new_n95_), .O(new_n105_));
  nand3  g57(.a(new_n105_), .b(new_n103_), .c(new_n80_), .O(z17));
  aoi21  g58(.a(new_n105_), .b(x25), .c(new_n79_), .O(new_n107_));
  oai21  g59(.a(new_n105_), .b(x25), .c(new_n107_), .O(z18));
  zero   g60(.O(z05));
  zero   g61(.O(z08));
  zero   g62(.O(z14));
  buf    g63(.a(x16), .O(z02));
