...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n98_, new_n99_, new_n100_,
    ...
    new_n152_, new_n153_, new_n154_, new_n171_, new_n172_, new_n173_,
  ...
  nand4  g42(.a(new_n130_), .b(x20), .c(new_n109_), .d(new_n113_), .O(new_n152_));
  nor2   g43(.a(new_n127_), .b(x29), .O(new_n153_));
  nand2  g44(.a(new_n153_), .b(x22), .O(new_n154_));
  nor2   g45(.a(new_n154_), .b(new_n152_), .O(z24));
  nand4  g46(.a(x22), .b(x20), .c(x19), .d(x05), .O(new_n171_));
  aoi21  g47(.a(new_n131_), .b(new_n94_), .c(new_n171_), .O(new_n172_));
  nor2   g48(.a(x20), .b(x19), .O(new_n173_));
  inv1   g49(.a(x03), .O(new_n174_));
  nand2  g50(.a(new_n121_), .b(new_n174_), .O(new_n175_));
  nand2  g51(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nor2   g52(.a(new_n176_), .b(new_n131_), .O(new_n177_));
  oai21  g53(.a(new_n177_), .b(new_n172_), .c(new_n113_), .O(new_n178_));
  inv1   g54(.a(x25), .O(new_n179_));
  nor2   g55(.a(new_n179_), .b(x10), .O(new_n180_));
  inv1   g56(.a(x27), .O(new_n181_));
  nand4  g57(.a(x29), .b(new_n181_), .c(new_n130_), .d(x19), .O(new_n182_));
  oai21  g58(.a(new_n180_), .b(new_n125_), .c(new_n182_), .O(new_n183_));
  nand4  g59(.a(new_n183_), .b(new_n128_), .c(x18), .d(x05), .O(new_n184_));
  aoi21  g60(.a(new_n184_), .b(new_n178_), .c(x28), .O(z40));
  oai21  g61(.a(x24), .b(x22), .c(new_n153_), .O(new_n188_));
  nor2   g62(.a(new_n188_), .b(new_n152_), .O(z43));
  zero   g63(.O(z00));
  zero   g64(.O(z02));
  zero   g65(.O(z06));
  zero   g66(.O(z08));
  ...
  zero   g97(.O(z41));
  zero   g98(.O(z42));
  nor2   g99(.a(new_n154_), .b(new_n152_), .O(z44));
endmodule
