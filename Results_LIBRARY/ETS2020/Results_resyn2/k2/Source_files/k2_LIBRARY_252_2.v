// Benchmark "FAU" written by ABC on Sat Jul 25 09:27:28 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n100_,
    ...
    new_n224_, new_n231_, new_n232_, new_n249_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n254_, new_n255_, new_n256_, new_n257_,
    new_n258_, new_n260_, new_n261_, new_n264_;
  ...
  nand3  g122(.a(x30), .b(new_n100_), .c(x22), .O(new_n231_));
  nand4  g123(.a(new_n130_), .b(x20), .c(new_n115_), .d(new_n113_), .O(new_n232_));
  nor2   g124(.a(new_n232_), .b(new_n231_), .O(z24));
  oai21  g125(.a(x05), .b(x03), .c(new_n153_), .O(new_n249_));
  nor2   g126(.a(new_n249_), .b(new_n132_), .O(new_n250_));
  nand4  g127(.a(x22), .b(x20), .c(x19), .d(x05), .O(new_n251_));
  aoi21  g128(.a(new_n132_), .b(new_n96_), .c(new_n251_), .O(new_n252_));
  oai21  g129(.a(new_n252_), .b(new_n250_), .c(new_n113_), .O(new_n253_));
  nor2   g130(.a(new_n149_), .b(x10), .O(new_n254_));
  nand3  g131(.a(new_n100_), .b(x21), .c(new_n115_), .O(new_n255_));
  nand3  g132(.a(new_n190_), .b(new_n219_), .c(new_n130_), .O(new_n256_));
  oai21  g133(.a(new_n255_), .b(new_n254_), .c(new_n256_), .O(new_n257_));
  nand4  g134(.a(new_n257_), .b(new_n196_), .c(x18), .d(x05), .O(new_n258_));
  aoi21  g135(.a(new_n258_), .b(new_n253_), .c(x28), .O(z40));
  nand2  g136(.a(x20), .b(x19), .O(new_n260_));
  nand3  g137(.a(new_n106_), .b(x21), .c(x00), .O(new_n261_));
  nor4   g138(.a(new_n261_), .b(new_n260_), .c(new_n231_), .d(new_n127_), .O(z41));
  oai21  g139(.a(x24), .b(x22), .c(new_n95_), .O(new_n264_));
  nor2   g140(.a(new_n264_), .b(new_n232_), .O(z43));
  zero   g141(.O(z00));
  zero   g142(.O(z02));
  zero   g143(.O(z06));
  zero   g144(.O(z08));
  ...
  zero   g173(.O(z39));
  zero   g174(.O(z42));
  nor2   g175(.a(new_n232_), .b(new_n231_), .O(z44));
endmodule
