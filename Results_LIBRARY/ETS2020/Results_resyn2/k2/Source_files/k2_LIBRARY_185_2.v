...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n135_, new_n136_, new_n154_, new_n155_, new_n156_, new_n159_,
    new_n160_, new_n161_, new_n162_, new_n163_, new_n164_, new_n165_,
    new_n180_, new_n181_, new_n182_, new_n183_, new_n184_, new_n185_,
    new_n186_, new_n187_, new_n188_, new_n189_, new_n190_, new_n191_,
    new_n192_, new_n193_, new_n195_, new_n198_;
  ...
  nor2   g045(.a(new_n129_), .b(x29), .O(new_n155_));
  nand2  g046(.a(new_n155_), .b(x22), .O(new_n156_));
  nor2   g047(.a(new_n156_), .b(new_n154_), .O(z24));
  nand2  g048(.a(x22), .b(new_n97_), .O(new_n159_));
  oai21  g049(.a(x27), .b(new_n97_), .c(new_n159_), .O(new_n160_));
  nand2  g050(.a(new_n160_), .b(new_n114_), .O(new_n161_));
  oai21  g051(.a(x23), .b(new_n113_), .c(new_n96_), .O(new_n162_));
  nand3  g052(.a(x30), .b(new_n93_), .c(new_n117_), .O(new_n163_));
  inv1   g053(.a(new_n163_), .O(new_n164_));
  nand2  g054(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  aoi21  g055(.a(new_n162_), .b(new_n161_), .c(new_n165_), .O(z26));
  ...
  inv1   g066(.a(x27), .O(new_n190_));
  nand4  g067(.a(x29), .b(new_n190_), .c(new_n132_), .d(x19), .O(new_n191_));
  oai21  g068(.a(new_n189_), .b(new_n127_), .c(new_n191_), .O(new_n192_));
  nand4  g069(.a(new_n192_), .b(new_n130_), .c(x18), .d(x05), .O(new_n193_));
  aoi21  g070(.a(new_n193_), .b(new_n187_), .c(x28), .O(z40));
  nand3  g071(.a(new_n114_), .b(x21), .c(x00), .O(new_n195_));
  nor4   g072(.a(new_n195_), .b(new_n163_), .c(new_n159_), .d(new_n125_), .O(z41));
  oai21  g073(.a(x24), .b(x22), .c(new_n155_), .O(new_n198_));
  nor2   g074(.a(new_n198_), .b(new_n154_), .O(z43));
  zero   g075(.O(z00));
  zero   g076(.O(z02));
  zero   g077(.O(z06));
  zero   g078(.O(z08));
  ...
  zero   g107(.O(z39));
  zero   g108(.O(z42));
  nor2   g109(.a(new_n156_), .b(new_n154_), .O(z44));
endmodule
