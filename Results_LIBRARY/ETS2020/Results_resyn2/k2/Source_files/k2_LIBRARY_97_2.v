...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n250_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
  ...
  nand4  g134(.a(new_n128_), .b(new_n113_), .c(new_n170_), .d(new_n169_), .O(new_n250_));
  nor4   g135(.a(new_n250_), .b(new_n93_), .c(x13), .d(x12), .O(z32));
  oai21  g136(.a(x05), .b(x03), .c(new_n114_), .O(new_n259_));
  nor2   g137(.a(new_n259_), .b(new_n132_), .O(new_n260_));
  nand3  g138(.a(new_n118_), .b(x22), .c(x05), .O(new_n261_));
  aoi21  g139(.a(new_n132_), .b(new_n95_), .c(new_n261_), .O(new_n262_));
  oai21  g140(.a(new_n262_), .b(new_n260_), .c(new_n98_), .O(new_n263_));
  nand2  g141(.a(new_n94_), .b(new_n100_), .O(new_n264_));
  inv1   g142(.a(x25), .O(new_n265_));
  nor2   g143(.a(new_n265_), .b(x10), .O(new_n266_));
  nand4  g144(.a(x29), .b(new_n170_), .c(new_n131_), .d(x19), .O(new_n267_));
  oai21  g145(.a(new_n266_), .b(new_n264_), .c(new_n267_), .O(new_n268_));
  nand4  g146(.a(new_n268_), .b(new_n129_), .c(x18), .d(x05), .O(new_n269_));
  aoi21  g147(.a(new_n269_), .b(new_n263_), .c(x28), .O(z40));
  inv1   g148(.a(new_n118_), .O(new_n271_));
  nand3  g149(.a(new_n107_), .b(x21), .c(x00), .O(new_n272_));
  nor4   g150(.a(new_n272_), .b(new_n240_), .c(new_n126_), .d(new_n271_), .O(z41));
  nor2   g151(.a(x24), .b(x22), .O(new_n275_));
  nor4   g152(.a(new_n275_), .b(new_n241_), .c(new_n128_), .d(x29), .O(z43));
  zero   g153(.O(z00));
  zero   g154(.O(z02));
  zero   g155(.O(z06));
  zero   g156(.O(z08));
  ...
  zero   g184(.O(z39));
  zero   g185(.O(z42));
  nor2   g186(.a(new_n241_), .b(new_n240_), .O(z44));
endmodule
