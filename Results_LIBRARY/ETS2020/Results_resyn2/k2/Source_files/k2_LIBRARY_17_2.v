...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n98_, new_n99_, new_n100_,
    ...
    new_n170_, new_n171_, new_n182_, new_n183_, new_n184_, new_n185_,
    new_n186_, new_n187_, new_n188_, new_n189_, new_n190_, new_n191_,
    new_n192_, new_n194_, new_n197_;
  ...
  nand3  g058(.a(new_n118_), .b(x22), .c(x05), .O(new_n182_));
  aoi21  g059(.a(new_n126_), .b(new_n93_), .c(new_n182_), .O(new_n183_));
  oai21  g060(.a(x05), .b(x03), .c(new_n114_), .O(new_n184_));
  nor2   g061(.a(new_n184_), .b(new_n126_), .O(new_n185_));
  oai21  g062(.a(new_n185_), .b(new_n183_), .c(new_n107_), .O(new_n186_));
  ...
  oai21  g067(.a(new_n188_), .b(new_n131_), .c(new_n190_), .O(new_n191_));
  nand4  g068(.a(new_n191_), .b(new_n133_), .c(x18), .d(x05), .O(new_n192_));
  aoi21  g069(.a(new_n192_), .b(new_n186_), .c(x28), .O(z40));
  nand3  g070(.a(new_n100_), .b(x21), .c(x00), .O(new_n194_));
  nor4   g071(.a(new_n194_), .b(new_n153_), .c(new_n129_), .d(new_n119_), .O(z41));
  nor2   g072(.a(x24), .b(x22), .O(new_n197_));
  nor4   g073(.a(new_n197_), .b(new_n154_), .c(new_n125_), .d(x29), .O(z43));
  zero   g074(.O(z00));
  zero   g075(.O(z02));
  zero   g076(.O(z06));
  zero   g077(.O(z08));
  ...
  zero   g106(.O(z39));
  zero   g107(.O(z42));
  nor2   g108(.a(new_n154_), .b(new_n153_), .O(z44));
endmodule
