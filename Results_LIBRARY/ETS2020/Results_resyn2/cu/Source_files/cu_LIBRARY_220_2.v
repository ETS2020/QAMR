// Benchmark "FAU" written by ABC on Fri Jul 24 21:27:06 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n64_, new_n68_, new_n69_;
  ...
  aoi21  g40(.a(new_n60_), .b(new_n57_), .c(new_n62_), .O(z08));
  nand2  g41(.a(x05), .b(x02), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x06), .c(new_n61_), .O(new_n69_));
