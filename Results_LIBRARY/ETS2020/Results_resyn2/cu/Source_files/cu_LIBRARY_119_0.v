...
module FAU ( 
  ...
  nand3  g18(.a(new_n45_), .b(new_n43_), .c(new_n28_), .O(new_n46_));
  inv1   g19(.a(x11), .O(new_n47_));
  nand2  g20(.a(new_n47_), .b(x01), .O(new_n48_));
  inv1   g21(.a(x09), .O(new_n49_));
  nand2  g22(.a(new_n49_), .b(new_n39_), .O(new_n50_));
  nand3  g23(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n51_));
  inv1   g24(.a(x05), .O(new_n52_));
  nor2   g25(.a(new_n52_), .b(x02), .O(new_n53_));
  inv1   g26(.a(x07), .O(new_n54_));
  inv1   g27(.a(x12), .O(new_n55_));
  nand3  g28(.a(x13), .b(new_n55_), .c(new_n54_), .O(new_n56_));
  inv1   g29(.a(new_n56_), .O(new_n57_));
  nand4  g30(.a(new_n57_), .b(new_n53_), .c(new_n51_), .d(new_n46_), .O(new_n58_));
  nand3  g31(.a(new_n32_), .b(new_n52_), .c(x02), .O(new_n59_));
  nand2  g32(.a(x04), .b(new_n30_), .O(new_n60_));
  aoi21  g33(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z06));
  nor3   g34(.a(new_n33_), .b(x03), .c(x02), .O(z07));
  zero   g35(.O(z00));
  zero   g36(.O(z01));
  zero   g37(.O(z08));
  zero   g38(.O(z09));
