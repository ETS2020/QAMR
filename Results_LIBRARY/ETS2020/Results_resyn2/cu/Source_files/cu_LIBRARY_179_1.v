// Benchmark "FAU" written by ABC on Fri Jul 24 21:26:58 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n46_, new_n47_;
  ...
  nand2  g14(.a(x05), .b(x02), .O(new_n46_));
  nand3  g15(.a(new_n46_), .b(x06), .c(new_n26_), .O(new_n47_));
  inv1   g16(.a(new_n47_), .O(z10));
  zero   g17(.O(z03));
  zero   g18(.O(z04));
  zero   g19(.O(z05));
  zero   g20(.O(z06));
