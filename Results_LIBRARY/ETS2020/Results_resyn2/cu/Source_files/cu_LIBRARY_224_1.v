// Benchmark "FAU" written by ABC on Fri Jul 24 21:27:07 2020
...
module FAU ( 
  ...
  nand2  g09(.a(x05), .b(x02), .O(new_n43_));
  nand3  g10(.a(new_n43_), .b(x06), .c(new_n42_), .O(new_n44_));
  inv1   g11(.a(new_n44_), .O(z10));
  zero   g12(.O(z01));
  zero   g13(.O(z02));
  zero   g14(.O(z03));
  zero   g15(.O(z04));
