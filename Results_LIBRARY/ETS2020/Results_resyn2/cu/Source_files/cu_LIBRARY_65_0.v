...
module FAU ( 
  ...
  wire new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n38_, new_n42_, new_n43_, new_n44_, new_n45_,
  ...
  nor4   g11(.a(new_n38_), .b(new_n33_), .c(x03), .d(x02), .O(z03));
  nor2   g12(.a(new_n35_), .b(new_n37_), .O(z04));
  ...
  nand3  g18(.a(new_n46_), .b(new_n44_), .c(new_n28_), .O(new_n47_));
  ...
  nand3  g23(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  inv1   g24(.a(x12), .O(new_n53_));
  nand4  g25(.a(x13), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n54_));
  inv1   g26(.a(new_n54_), .O(new_n55_));
  nand4  g27(.a(new_n55_), .b(new_n52_), .c(new_n47_), .d(new_n42_), .O(new_n56_));
  inv1   g28(.a(x05), .O(new_n57_));
  nand3  g29(.a(new_n32_), .b(new_n57_), .c(x02), .O(new_n58_));
  nand2  g30(.a(x04), .b(new_n30_), .O(new_n59_));
  aoi21  g31(.a(new_n58_), .b(new_n56_), .c(new_n59_), .O(z06));
  nor3   g32(.a(new_n33_), .b(x03), .c(x02), .O(z07));
  aoi21  g33(.a(new_n58_), .b(new_n54_), .c(new_n59_), .O(z08));
