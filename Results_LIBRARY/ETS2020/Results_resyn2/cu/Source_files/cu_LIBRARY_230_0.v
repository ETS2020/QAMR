...
module FAU ( 
  ...
  nor4   g05(.a(new_n33_), .b(new_n31_), .c(x03), .d(x02), .O(z03));
  inv1   g06(.a(x02), .O(new_n35_));
  inv1   g07(.a(x03), .O(new_n36_));
  inv1   g08(.a(new_n31_), .O(new_n37_));
  nand4  g09(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(x01), .O(new_n38_));
  nor2   g10(.a(new_n38_), .b(x00), .O(z04));
  inv1   g11(.a(x00), .O(new_n40_));
  nor2   g12(.a(new_n38_), .b(new_n40_), .O(z05));
  ...
  nand4  g25(.a(x13), .b(new_n53_), .c(x05), .d(new_n35_), .O(new_n54_));
  inv1   g26(.a(new_n54_), .O(new_n55_));
  nand4  g27(.a(new_n55_), .b(new_n52_), .c(new_n47_), .d(new_n42_), .O(new_n56_));
  inv1   g28(.a(x05), .O(new_n57_));
  nand3  g29(.a(new_n30_), .b(new_n57_), .c(x02), .O(new_n58_));
  nand2  g30(.a(x04), .b(new_n36_), .O(new_n59_));
  aoi21  g31(.a(new_n58_), .b(new_n56_), .c(new_n59_), .O(z06));
  nor3   g32(.a(new_n31_), .b(x03), .c(x02), .O(z07));
