...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n41_, new_n42_,
    new_n43_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n54_;
  ...
  xor2a  g16(.a(x12), .b(x11), .O(new_n49_));
  nor2   g17(.a(new_n49_), .b(new_n48_), .O(z09));
  nand2  g18(.a(new_n32_), .b(new_n30_), .O(new_n52_));
  nand4  g19(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n53_));
  nand3  g20(.a(x11), .b(new_n47_), .c(x00), .O(new_n54_));
