...
module FAU ( 
  ...
  inv1   g20(.a(x00), .O(new_n52_));
  nor2   g21(.a(x10), .b(new_n52_), .O(new_n53_));
  xnor2a g22(.a(x12), .b(x11), .O(new_n54_));
  and2   g23(.a(new_n54_), .b(new_n53_), .O(z09));
  ...
  nand3  g29(.a(new_n60_), .b(new_n53_), .c(x11), .O(new_n61_));
