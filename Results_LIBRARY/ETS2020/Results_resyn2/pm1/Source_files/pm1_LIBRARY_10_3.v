...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n43_, new_n44_, new_n45_, new_n48_, new_n49_, new_n50_, new_n53_,
  ...
  oai21  g21(.a(new_n43_), .b(new_n37_), .c(new_n50_), .O(z08));
  inv1   g22(.a(x09), .O(new_n53_));
  nand2  g23(.a(new_n43_), .b(x12), .O(new_n54_));
  nor3   g24(.a(new_n54_), .b(new_n49_), .c(new_n53_), .O(z10));
  aoi21  g25(.a(new_n43_), .b(x12), .c(new_n30_), .O(new_n56_));
  nand2  g26(.a(new_n45_), .b(x12), .O(new_n57_));
  nand4  g27(.a(new_n57_), .b(x11), .c(new_n48_), .d(x00), .O(new_n58_));
  nor2   g28(.a(new_n58_), .b(new_n56_), .O(z11));
  nor3   g29(.a(new_n49_), .b(new_n32_), .c(x09), .O(z12));
  zero   g30(.O(z09));
endmodule
