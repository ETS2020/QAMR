...
module FAU ( 
  ...
  nand4  g11(.a(new_n39_), .b(x12), .c(x11), .d(x09), .O(new_n45_));
  nand2  g12(.a(new_n45_), .b(new_n44_), .O(z08));
  nand2  g13(.a(new_n42_), .b(x00), .O(new_n47_));
  ...
  nand2  g19(.a(new_n38_), .b(x12), .O(new_n53_));
  nor3   g20(.a(new_n53_), .b(new_n43_), .c(new_n52_), .O(z10));
  inv1   g21(.a(x01), .O(new_n55_));
  aoi21  g22(.a(new_n38_), .b(x12), .c(new_n55_), .O(new_n56_));
  nand2  g23(.a(new_n37_), .b(x12), .O(new_n57_));
  nand4  g24(.a(new_n57_), .b(x11), .c(new_n42_), .d(x00), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(new_n56_), .O(z11));
  nor3   g26(.a(new_n48_), .b(new_n47_), .c(x09), .O(z12));
  zero   g27(.O(z00));
  zero   g28(.O(z02));
  zero   g29(.O(z03));
  zero   g30(.O(z05));
