...
module FAU ( 
  ...
  nand2  g12(.a(x12), .b(x11), .O(new_n46_));
  inv1   g13(.a(x10), .O(new_n47_));
  nand2  g14(.a(new_n47_), .b(x00), .O(new_n48_));
  inv1   g15(.a(x12), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n31_), .O(new_n50_));
  aoi21  g17(.a(new_n50_), .b(new_n46_), .c(new_n48_), .O(z09));
  nand4  g18(.a(new_n40_), .b(new_n36_), .c(new_n47_), .d(x00), .O(new_n52_));
  inv1   g19(.a(new_n52_), .O(z10));
  nor3   g20(.a(new_n48_), .b(new_n46_), .c(x09), .O(z12));
  zero   g21(.O(z00));
  zero   g22(.O(z02));
  zero   g23(.O(z05));
  zero   g24(.O(z08));
