...
module FAU ( 
  ...
  nand3  g10(.a(x04), .b(x03), .c(x02), .O(new_n43_));
  inv1   g11(.a(x10), .O(new_n44_));
  nand3  g12(.a(x11), .b(new_n44_), .c(x00), .O(new_n45_));
  inv1   g13(.a(new_n45_), .O(new_n46_));
  oai21  g14(.a(new_n43_), .b(new_n35_), .c(new_n46_), .O(z08));
  nand2  g15(.a(new_n44_), .b(x00), .O(new_n48_));
  nand2  g16(.a(x12), .b(x11), .O(new_n49_));
  inv1   g17(.a(x12), .O(new_n50_));
  nand2  g18(.a(new_n50_), .b(new_n31_), .O(new_n51_));
  aoi21  g19(.a(new_n51_), .b(new_n49_), .c(new_n48_), .O(z09));
  inv1   g20(.a(x09), .O(new_n53_));
  nand2  g21(.a(new_n43_), .b(x12), .O(new_n54_));
  nor3   g22(.a(new_n54_), .b(new_n45_), .c(new_n53_), .O(z10));
  inv1   g23(.a(x01), .O(new_n56_));
  aoi21  g24(.a(new_n43_), .b(x12), .c(new_n56_), .O(new_n57_));
  nand2  g25(.a(x09), .b(x01), .O(new_n58_));
  nand2  g26(.a(new_n58_), .b(x12), .O(new_n59_));
  nand4  g27(.a(new_n59_), .b(x11), .c(new_n44_), .d(x00), .O(new_n60_));
  nor2   g28(.a(new_n60_), .b(new_n57_), .O(z11));
  nor3   g29(.a(new_n49_), .b(new_n48_), .c(x09), .O(z12));
  zero   g30(.O(z00));
  zero   g31(.O(z06));
  zero   g32(.O(z07));
endmodule
