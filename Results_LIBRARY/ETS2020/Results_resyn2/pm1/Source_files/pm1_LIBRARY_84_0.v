// Benchmark "FAU" written by ABC on Fri Jul 24 21:10:45 2020
...
module FAU ( 
  ...
  nand2  g16(.a(new_n45_), .b(new_n38_), .O(new_n48_));
  ...
  nand2  g21(.a(new_n32_), .b(new_n31_), .O(new_n53_));
  nand2  g22(.a(new_n49_), .b(x00), .O(new_n54_));
  nand2  g23(.a(x12), .b(x11), .O(new_n55_));
  aoi21  g24(.a(new_n55_), .b(new_n53_), .c(new_n54_), .O(z09));
  nand4  g25(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  nand2  g26(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  aoi21  g27(.a(new_n59_), .b(new_n58_), .c(new_n50_), .O(z11));
  inv1   g28(.a(x09), .O(new_n61_));
  nand3  g29(.a(new_n49_), .b(new_n61_), .c(x00), .O(new_n62_));
  nor2   g30(.a(new_n62_), .b(new_n55_), .O(z12));
  zero   g31(.O(z05));
  zero   g32(.O(z07));
  zero   g33(.O(z10));
endmodule
