// Benchmark "FAU" written by ABC on Fri Jul 24 21:11:22 2020
...
module FAU ( 
  ...
  nand2  g20(.a(new_n32_), .b(x11), .O(new_n52_));
  nand4  g21(.a(new_n52_), .b(z01), .c(new_n48_), .d(x00), .O(new_n53_));
  inv1   g22(.a(new_n53_), .O(z09));
  nand2  g23(.a(new_n45_), .b(x12), .O(new_n55_));
  nand4  g24(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n56_));
  nor2   g25(.a(new_n56_), .b(new_n55_), .O(z10));
  nand2  g26(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  nand4  g27(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g28(.a(new_n59_), .b(new_n58_), .c(new_n49_), .O(z11));
  zero   g29(.O(z04));
  zero   g30(.O(z06));
  zero   g31(.O(z12));
endmodule
