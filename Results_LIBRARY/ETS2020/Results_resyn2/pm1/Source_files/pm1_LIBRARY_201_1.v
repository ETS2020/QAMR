...
module FAU ( 
  ...
  nor2   g11(.a(new_n45_), .b(new_n44_), .O(z09));
  nand4  g12(.a(x12), .b(x11), .c(new_n43_), .d(x00), .O(new_n47_));
  nand2  g13(.a(new_n37_), .b(x09), .O(new_n48_));
  nor2   g14(.a(new_n48_), .b(new_n47_), .O(z10));
  nor2   g15(.a(new_n47_), .b(x09), .O(z12));
  zero   g16(.O(z00));
  zero   g17(.O(z02));
  zero   g18(.O(z03));
  zero   g19(.O(z07));
