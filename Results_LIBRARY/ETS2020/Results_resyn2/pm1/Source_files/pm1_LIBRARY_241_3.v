...
module FAU ( 
  ...
  oai21  g19(.a(new_n44_), .b(new_n37_), .c(new_n50_), .O(z08));
  nand2  g20(.a(new_n32_), .b(new_n31_), .O(new_n52_));
  nand2  g21(.a(new_n48_), .b(x00), .O(new_n53_));
  nand2  g22(.a(x12), .b(x11), .O(new_n54_));
  aoi21  g23(.a(new_n54_), .b(new_n52_), .c(new_n53_), .O(z09));
  inv1   g24(.a(x09), .O(new_n56_));
  nand2  g25(.a(new_n44_), .b(x12), .O(new_n57_));
  nor3   g26(.a(new_n57_), .b(new_n49_), .c(new_n56_), .O(z10));
  aoi21  g27(.a(new_n44_), .b(x12), .c(new_n30_), .O(new_n59_));
  nand2  g28(.a(new_n43_), .b(x12), .O(new_n60_));
  nand4  g29(.a(new_n60_), .b(x11), .c(new_n48_), .d(x00), .O(new_n61_));
  nor2   g30(.a(new_n61_), .b(new_n59_), .O(z11));
  nor3   g31(.a(new_n54_), .b(new_n53_), .c(x09), .O(z12));
  zero   g32(.O(z04));
  zero   g33(.O(z07));
endmodule
