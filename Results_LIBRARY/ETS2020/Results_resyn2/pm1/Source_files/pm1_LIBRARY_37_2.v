...
module FAU ( 
  ...
  nand2  g21(.a(new_n45_), .b(x12), .O(new_n53_));
  nand4  g22(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n54_));
  nor2   g23(.a(new_n54_), .b(new_n53_), .O(z10));
  nand2  g24(.a(new_n32_), .b(new_n30_), .O(new_n56_));
  nand4  g25(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  aoi21  g26(.a(new_n57_), .b(new_n56_), .c(new_n49_), .O(z11));
  inv1   g27(.a(x09), .O(new_n59_));
  nand2  g28(.a(x12), .b(new_n59_), .O(new_n60_));
  nor2   g29(.a(new_n60_), .b(new_n49_), .O(z12));
  zero   g30(.O(z06));
  zero   g31(.O(z09));
endmodule
