...
module FAU ( 
  ...
  nand2  g15(.a(new_n44_), .b(new_n36_), .O(new_n47_));
  ...
  xor2a  g21(.a(x12), .b(x11), .O(new_n53_));
  nor2   g22(.a(new_n53_), .b(new_n52_), .O(z09));
  nand4  g23(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n56_));
  nand2  g24(.a(new_n32_), .b(new_n30_), .O(new_n57_));
