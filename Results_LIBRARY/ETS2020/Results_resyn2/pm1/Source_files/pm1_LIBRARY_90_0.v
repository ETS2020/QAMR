// Benchmark "FAU" written by ABC on Fri Jul 24 21:10:46 2020
...
module FAU ( 
  ...
  nand2  g21(.a(new_n49_), .b(x00), .O(new_n53_));
  xor2a  g22(.a(x12), .b(x11), .O(new_n54_));
  nor2   g23(.a(new_n54_), .b(new_n53_), .O(z09));
  nand4  g24(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  nand2  g25(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  aoi21  g26(.a(new_n58_), .b(new_n57_), .c(new_n50_), .O(z11));
  zero   g27(.O(z05));
  zero   g28(.O(z07));
  zero   g29(.O(z10));
  zero   g30(.O(z12));
