...
module FAU ( 
  ...
  nand3  g09(.a(x12), .b(x11), .c(x09), .O(new_n42_));
  inv1   g10(.a(new_n42_), .O(new_n43_));
  nand2  g11(.a(new_n43_), .b(new_n38_), .O(new_n44_));
  ...
  nand2  g16(.a(new_n45_), .b(x00), .O(new_n49_));
  nand2  g17(.a(x12), .b(x11), .O(new_n50_));
  inv1   g18(.a(x12), .O(new_n51_));
  nand2  g19(.a(new_n51_), .b(new_n31_), .O(new_n52_));
  aoi21  g20(.a(new_n52_), .b(new_n50_), .c(new_n49_), .O(z09));
  nand3  g21(.a(new_n37_), .b(new_n45_), .c(x00), .O(new_n54_));
  nor2   g22(.a(new_n54_), .b(new_n42_), .O(z10));
  inv1   g23(.a(x09), .O(new_n57_));
  nand3  g24(.a(new_n45_), .b(new_n57_), .c(x00), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(new_n50_), .O(z12));
  zero   g26(.O(z00));
  zero   g27(.O(z02));
  zero   g28(.O(z03));
  zero   g29(.O(z11));
