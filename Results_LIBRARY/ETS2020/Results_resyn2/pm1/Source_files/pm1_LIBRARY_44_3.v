...
module FAU ( 
  ...
  oai21  g19(.a(new_n43_), .b(new_n37_), .c(new_n50_), .O(z08));
  inv1   g20(.a(x09), .O(new_n53_));
  nand2  g21(.a(new_n43_), .b(x12), .O(new_n54_));
  nor3   g22(.a(new_n54_), .b(new_n49_), .c(new_n53_), .O(z10));
  aoi21  g23(.a(new_n43_), .b(x12), .c(new_n30_), .O(new_n56_));
  nand2  g24(.a(new_n45_), .b(x12), .O(new_n57_));
  nand4  g25(.a(new_n57_), .b(x11), .c(new_n48_), .d(x00), .O(new_n58_));
  nor2   g26(.a(new_n58_), .b(new_n56_), .O(z11));
  nor3   g27(.a(new_n49_), .b(new_n32_), .c(x09), .O(z12));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
  zero   g30(.O(z09));
endmodule
