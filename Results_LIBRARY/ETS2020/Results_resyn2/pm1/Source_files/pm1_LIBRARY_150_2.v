...
module FAU ( 
  ...
  nand2  g14(.a(new_n45_), .b(new_n36_), .O(new_n46_));
  ...
  aoi21  g22(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(z09));
  nand2  g23(.a(new_n44_), .b(x12), .O(new_n55_));
  nand4  g24(.a(x11), .b(new_n47_), .c(x09), .d(x00), .O(new_n56_));
  ...
  aoi21  g28(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z11));
  inv1   g29(.a(x09), .O(new_n61_));
  nand3  g30(.a(new_n47_), .b(new_n61_), .c(x00), .O(new_n62_));
  nor2   g31(.a(new_n62_), .b(new_n52_), .O(z12));
  zero   g32(.O(z03));
  zero   g33(.O(z06));
endmodule
