...
module FAU ( 
  ...
  aoi21  g24(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(z09));
  nand2  g25(.a(new_n45_), .b(x12), .O(new_n56_));
  nand4  g26(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n57_));
  nor2   g27(.a(new_n57_), .b(new_n56_), .O(z10));
  nand2  g28(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  nand4  g29(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  aoi21  g30(.a(new_n60_), .b(new_n59_), .c(new_n49_), .O(z11));
