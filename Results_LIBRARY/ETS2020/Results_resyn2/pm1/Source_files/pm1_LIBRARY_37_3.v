...
module FAU ( 
  ...
  nand2  g12(.a(x12), .b(new_n31_), .O(new_n44_));
  nand3  g13(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  inv1   g14(.a(new_n45_), .O(new_n46_));
  aoi21  g15(.a(new_n46_), .b(new_n44_), .c(new_n43_), .O(z06));
  inv1   g16(.a(x15), .O(z07));
  nand2  g17(.a(new_n46_), .b(new_n38_), .O(new_n49_));
  ...
  nand2  g22(.a(new_n50_), .b(x00), .O(new_n54_));
  nand2  g23(.a(x12), .b(x11), .O(new_n55_));
  nand2  g24(.a(new_n32_), .b(new_n31_), .O(new_n56_));
  aoi21  g25(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(z09));
  nand2  g26(.a(new_n45_), .b(x12), .O(new_n58_));
  nand4  g27(.a(x11), .b(new_n50_), .c(x09), .d(x00), .O(new_n59_));
  nor2   g28(.a(new_n59_), .b(new_n58_), .O(z10));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n61_));
  nand4  g30(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  aoi21  g31(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(z11));
  inv1   g32(.a(x09), .O(new_n64_));
  nand3  g33(.a(new_n50_), .b(new_n64_), .c(x00), .O(new_n65_));
  nor2   g34(.a(new_n65_), .b(new_n55_), .O(z12));
  zero   g35(.O(z01));
  zero   g36(.O(z04));
endmodule
