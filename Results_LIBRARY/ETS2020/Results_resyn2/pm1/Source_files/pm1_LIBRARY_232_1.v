...
module FAU ( 
  ...
  nand2  g12(.a(x09), .b(x01), .O(new_n44_));
  aoi21  g13(.a(new_n43_), .b(z01), .c(new_n44_), .O(z06));
  inv1   g14(.a(x15), .O(z07));
  nand2  g15(.a(new_n43_), .b(new_n36_), .O(new_n47_));
  ...
  aoi21  g22(.a(new_n53_), .b(new_n32_), .c(new_n52_), .O(z09));
  nand3  g23(.a(new_n49_), .b(new_n42_), .c(new_n36_), .O(new_n55_));
  inv1   g24(.a(new_n55_), .O(z10));
  nor3   g25(.a(new_n53_), .b(new_n52_), .c(x09), .O(z12));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
  zero   g28(.O(z11));
endmodule
