...
module FAU ( 
  ...
  nand2  g09(.a(new_n32_), .b(new_n31_), .O(new_n45_));
  nand2  g10(.a(x12), .b(x11), .O(new_n46_));
  inv1   g11(.a(x10), .O(new_n47_));
  nand2  g12(.a(new_n47_), .b(x00), .O(new_n48_));
  aoi21  g13(.a(new_n46_), .b(new_n45_), .c(new_n48_), .O(z09));
  nand4  g14(.a(x12), .b(x11), .c(new_n47_), .d(x00), .O(new_n50_));
  nand2  g15(.a(new_n39_), .b(x09), .O(new_n51_));
  nor2   g16(.a(new_n51_), .b(new_n50_), .O(z10));
  nor2   g17(.a(new_n50_), .b(x09), .O(z12));
  zero   g18(.O(z02));
  zero   g19(.O(z03));
  zero   g20(.O(z04));
  zero   g21(.O(z05));
