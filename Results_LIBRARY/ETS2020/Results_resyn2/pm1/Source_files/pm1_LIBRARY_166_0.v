...
module FAU ( 
  ...
  nand2  g19(.a(new_n44_), .b(new_n38_), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(new_n49_), .O(z08));
  nand2  g21(.a(new_n32_), .b(new_n31_), .O(new_n52_));
  nand2  g22(.a(x12), .b(x11), .O(new_n53_));
  nand2  g23(.a(new_n47_), .b(x00), .O(new_n54_));
  aoi21  g24(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(z09));
  nand4  g25(.a(new_n43_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
