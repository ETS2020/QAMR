// Benchmark "FAU" written by ABC on Fri Jul 24 21:11:21 2020
...
module FAU ( 
  ...
  nand2  g12(.a(x12), .b(new_n31_), .O(new_n43_));
  ...
  nand2  g18(.a(new_n45_), .b(new_n38_), .O(new_n49_));
  ...
  nand2  g23(.a(new_n44_), .b(x12), .O(new_n55_));
  nand4  g24(.a(x11), .b(new_n50_), .c(x09), .d(x00), .O(new_n56_));
  nor2   g25(.a(new_n56_), .b(new_n55_), .O(z10));
  nand2  g26(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  nand4  g27(.a(new_n44_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g28(.a(new_n59_), .b(new_n58_), .c(new_n51_), .O(z11));
  inv1   g29(.a(x09), .O(new_n61_));
  nand2  g30(.a(x12), .b(new_n61_), .O(new_n62_));
  nor2   g31(.a(new_n62_), .b(new_n51_), .O(z12));
  zero   g32(.O(z01));
  zero   g33(.O(z09));
endmodule
