// Benchmark "FAU" written by ABC on Fri Jul 24 21:48:57 2020
...
module FAU ( 
  ...
  inv1   g28(.a(x04), .O(new_n72_));
  nand4  g29(.a(new_n48_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  inv1   g30(.a(x17), .O(new_n74_));
  oai21  g31(.a(new_n61_), .b(x15), .c(new_n74_), .O(new_n75_));
  nand3  g32(.a(new_n75_), .b(new_n73_), .c(x12), .O(new_n76_));
  inv1   g33(.a(new_n76_), .O(z16));
  inv1   g34(.a(x05), .O(new_n78_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(new_n78_), .O(new_n79_));
  oai21  g36(.a(new_n61_), .b(x15), .c(z04), .O(new_n80_));
  nand3  g37(.a(new_n80_), .b(new_n79_), .c(x12), .O(new_n81_));
  inv1   g38(.a(new_n81_), .O(z17));
  inv1   g39(.a(x06), .O(new_n83_));
  nand4  g40(.a(new_n48_), .b(x10), .c(x08), .d(new_n83_), .O(new_n84_));
  inv1   g41(.a(x19), .O(new_n85_));
  oai21  g42(.a(new_n61_), .b(x15), .c(new_n85_), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(new_n84_), .c(x12), .O(new_n87_));
  inv1   g44(.a(new_n87_), .O(z18));
  inv1   g45(.a(x07), .O(new_n89_));
  nand4  g46(.a(new_n48_), .b(x10), .c(x08), .d(new_n89_), .O(new_n90_));
  oai21  g47(.a(new_n61_), .b(x15), .c(new_n43_), .O(new_n91_));
  nand3  g48(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  inv1   g49(.a(new_n92_), .O(z19));
  zero   g50(.O(z05));
  zero   g51(.O(z15));
  buf    g52(.a(x15), .O(z06));
  buf    g53(.a(x17), .O(z07));
