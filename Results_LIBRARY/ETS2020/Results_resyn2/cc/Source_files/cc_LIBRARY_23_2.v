// Benchmark "FAU" written by ABC on Fri Jul 24 21:48:49 2020
...
module FAU ( 
  ...
  nand4  g29(.a(new_n48_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  inv1   g30(.a(x17), .O(new_n75_));
  oai21  g31(.a(new_n62_), .b(x15), .c(new_n75_), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(new_n74_), .c(x12), .O(new_n77_));
  inv1   g33(.a(new_n77_), .O(z16));
  inv1   g34(.a(x05), .O(new_n79_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(new_n79_), .O(new_n80_));
  oai21  g36(.a(new_n62_), .b(x15), .c(z04), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n80_), .c(x12), .O(new_n82_));
  inv1   g38(.a(new_n82_), .O(z17));
  inv1   g39(.a(x06), .O(new_n84_));
  nand4  g40(.a(new_n48_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  inv1   g41(.a(x19), .O(new_n86_));
  oai21  g42(.a(new_n62_), .b(x15), .c(new_n86_), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n85_), .c(x12), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(z18));
  inv1   g45(.a(x07), .O(new_n90_));
  nand4  g46(.a(new_n48_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g47(.a(new_n62_), .b(x15), .c(new_n43_), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(x12), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(z19));
  zero   g50(.O(z05));
  zero   g51(.O(z06));
  zero   g52(.O(z15));
  buf    g53(.a(x17), .O(z07));
