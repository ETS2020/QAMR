...
module FAU ( 
  ...
  oai21  g40(.a(new_n62_), .b(x15), .c(new_n84_), .O(new_n85_));
  nand3  g41(.a(new_n85_), .b(new_n83_), .c(x12), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(z18));
  inv1   g43(.a(x07), .O(new_n88_));
  nand4  g44(.a(new_n48_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g45(.a(new_n62_), .b(x15), .c(new_n43_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(z19));
  zero   g48(.O(z05));
  zero   g49(.O(z07));
  zero   g50(.O(z17));
  buf    g51(.a(x15), .O(z06));
