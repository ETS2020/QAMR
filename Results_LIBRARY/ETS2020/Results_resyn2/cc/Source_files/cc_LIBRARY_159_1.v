...
module FAU ( 
  ...
  oai21  g40(.a(new_n61_), .b(x15), .c(new_n83_), .O(new_n84_));
  nand3  g41(.a(new_n84_), .b(new_n82_), .c(x12), .O(new_n85_));
  inv1   g42(.a(new_n85_), .O(z18));
  inv1   g43(.a(x07), .O(new_n87_));
  nand4  g44(.a(new_n48_), .b(x10), .c(x08), .d(new_n87_), .O(new_n88_));
  oai21  g45(.a(new_n61_), .b(x15), .c(new_n43_), .O(new_n89_));
