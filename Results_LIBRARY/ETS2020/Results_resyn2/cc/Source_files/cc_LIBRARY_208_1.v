...
module FAU ( 
  ...
  oai21  g33(.a(new_n61_), .b(x15), .c(z04), .O(new_n77_));
  nand3  g34(.a(new_n77_), .b(new_n76_), .c(x12), .O(new_n78_));
  inv1   g35(.a(new_n78_), .O(z17));
