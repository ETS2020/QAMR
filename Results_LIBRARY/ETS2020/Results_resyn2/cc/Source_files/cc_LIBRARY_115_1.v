...
module FAU ( 
  ...
  oai21  g33(.a(new_n62_), .b(x15), .c(z04), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  inv1   g35(.a(new_n79_), .O(z17));
  inv1   g36(.a(x06), .O(new_n81_));
  ...
  inv1   g41(.a(new_n85_), .O(z18));
  inv1   g42(.a(x07), .O(new_n87_));
  nand4  g43(.a(new_n48_), .b(x10), .c(x08), .d(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n62_), .b(x15), .c(new_n43_), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(new_n88_), .c(x12), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(z19));
  zero   g47(.O(z05));
  zero   g48(.O(z07));
  zero   g49(.O(z16));
  buf    g50(.a(x15), .O(z06));
