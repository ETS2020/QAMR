...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n64_, new_n65_, new_n68_, new_n69_, new_n71_, new_n72_, new_n73_,
  ...
  nand3  g25(.a(new_n49_), .b(x16), .c(new_n47_), .O(new_n68_));
  nand4  g26(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n69_));
  aoi21  g27(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z15));
  inv1   g28(.a(x04), .O(new_n71_));
  nand4  g29(.a(new_n48_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  inv1   g30(.a(x17), .O(new_n73_));
  oai21  g31(.a(new_n60_), .b(x15), .c(new_n73_), .O(new_n74_));
  nand3  g32(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  inv1   g33(.a(new_n75_), .O(z16));
  inv1   g34(.a(x05), .O(new_n77_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(new_n77_), .O(new_n78_));
  oai21  g36(.a(new_n60_), .b(x15), .c(z04), .O(new_n79_));
  nand3  g37(.a(new_n79_), .b(new_n78_), .c(x12), .O(new_n80_));
  inv1   g38(.a(new_n80_), .O(z17));
  inv1   g39(.a(x06), .O(new_n82_));
  nand4  g40(.a(new_n48_), .b(x10), .c(x08), .d(new_n82_), .O(new_n83_));
  inv1   g41(.a(x19), .O(new_n84_));
  oai21  g42(.a(new_n60_), .b(x15), .c(new_n84_), .O(new_n85_));
  nand3  g43(.a(new_n85_), .b(new_n83_), .c(x12), .O(new_n86_));
  inv1   g44(.a(new_n86_), .O(z18));
  inv1   g45(.a(x07), .O(new_n88_));
  nand4  g46(.a(new_n48_), .b(x10), .c(x08), .d(new_n88_), .O(new_n89_));
  oai21  g47(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n90_));
  nand3  g48(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g49(.a(new_n91_), .O(z19));
  zero   g50(.O(z14));
  buf    g51(.a(x19), .O(z05));
  buf    g52(.a(x15), .O(z06));
  buf    g53(.a(x17), .O(z07));
