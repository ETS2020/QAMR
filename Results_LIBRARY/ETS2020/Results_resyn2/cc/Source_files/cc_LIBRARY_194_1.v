...
module FAU ( 
  ...
  nand4  g14(.a(new_n48_), .b(x10), .c(x08), .d(new_n57_), .O(new_n58_));
  inv1   g15(.a(x13), .O(new_n59_));
  nand2  g16(.a(x10), .b(x08), .O(new_n60_));
  oai21  g17(.a(new_n60_), .b(x15), .c(new_n59_), .O(new_n61_));
  nand3  g18(.a(new_n61_), .b(new_n58_), .c(x12), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(z12));
  inv1   g20(.a(x12), .O(new_n64_));
  inv1   g21(.a(x01), .O(new_n65_));
  oai21  g22(.a(new_n60_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g23(.a(new_n66_), .b(new_n45_), .c(new_n64_), .O(z13));
  ...
  oai21  g38(.a(new_n60_), .b(x15), .c(z04), .O(new_n82_));
  ...
  oai21  g44(.a(new_n60_), .b(x15), .c(new_n87_), .O(new_n88_));
  ...
  oai21  g49(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n93_));
