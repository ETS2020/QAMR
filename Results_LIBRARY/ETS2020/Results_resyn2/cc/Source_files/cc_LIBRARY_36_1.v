// Benchmark "FAU" written by ABC on Fri Jul 24 21:48:51 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n64_, new_n65_, new_n67_, new_n68_, new_n70_, new_n71_, new_n74_,
  ...
  inv1   g31(.a(x05), .O(new_n74_));
  nand4  g32(.a(new_n48_), .b(x10), .c(x08), .d(new_n74_), .O(new_n75_));
  oai21  g33(.a(new_n60_), .b(x15), .c(z04), .O(new_n76_));
  nand3  g34(.a(new_n76_), .b(new_n75_), .c(x12), .O(new_n77_));
  inv1   g35(.a(new_n77_), .O(z17));
  inv1   g36(.a(x06), .O(new_n79_));
  nand4  g37(.a(new_n48_), .b(x10), .c(x08), .d(new_n79_), .O(new_n80_));
  inv1   g38(.a(x19), .O(new_n81_));
  oai21  g39(.a(new_n60_), .b(x15), .c(new_n81_), .O(new_n82_));
  nand3  g40(.a(new_n82_), .b(new_n80_), .c(x12), .O(new_n83_));
  inv1   g41(.a(new_n83_), .O(z18));
  inv1   g42(.a(x07), .O(new_n85_));
  nand4  g43(.a(new_n48_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  oai21  g44(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n87_));
  nand3  g45(.a(new_n87_), .b(new_n86_), .c(x12), .O(new_n88_));
  inv1   g46(.a(new_n88_), .O(z19));
  zero   g47(.O(z16));
  buf    g48(.a(x19), .O(z05));
  buf    g49(.a(x15), .O(z06));
  buf    g50(.a(x17), .O(z07));
