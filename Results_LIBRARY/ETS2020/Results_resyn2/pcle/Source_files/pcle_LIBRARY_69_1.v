...
module FAU ( 
  ...
  nand3  g19(.a(new_n47_), .b(new_n44_), .c(new_n35_), .O(new_n48_));
  nand2  g20(.a(new_n48_), .b(new_n43_), .O(z3));
  nand2  g21(.a(x08), .b(x04), .O(new_n51_));
  inv1   g22(.a(x15), .O(new_n52_));
  nand2  g23(.a(new_n29_), .b(new_n52_), .O(new_n53_));
  nand3  g24(.a(new_n53_), .b(new_n35_), .c(new_n31_), .O(new_n54_));
  nand2  g25(.a(new_n54_), .b(new_n51_), .O(z5));
  nand2  g26(.a(x08), .b(x05), .O(new_n56_));
  nand3  g27(.a(new_n30_), .b(x16), .c(x15), .O(new_n57_));
  inv1   g28(.a(x16), .O(new_n58_));
  nand2  g29(.a(new_n31_), .b(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n57_), .c(new_n35_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n56_), .O(z6));
  nand2  g32(.a(x08), .b(x06), .O(new_n62_));
  nor2   g33(.a(new_n58_), .b(new_n52_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(new_n30_), .c(x17), .O(new_n64_));
  inv1   g35(.a(x17), .O(new_n65_));
  nand2  g36(.a(new_n63_), .b(new_n30_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g38(.a(new_n67_), .b(new_n64_), .c(new_n35_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n62_), .O(z7));
  nand4  g40(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n70_));
  oai21  g41(.a(new_n70_), .b(new_n44_), .c(x18), .O(new_n71_));
  nor2   g42(.a(x18), .b(new_n65_), .O(new_n72_));
  nand3  g43(.a(new_n72_), .b(new_n63_), .c(new_n30_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g45(.a(new_n74_), .b(new_n35_), .O(new_n75_));
