...
module FAU ( 
  ...
  oai21  g25(.a(new_n54_), .b(new_n30_), .c(new_n53_), .O(new_n55_));
  inv1   g26(.a(new_n30_), .O(new_n56_));
  nand3  g27(.a(x16), .b(x15), .c(x14), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n55_), .c(new_n43_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n52_), .O(z6));
  nand2  g32(.a(x08), .b(x06), .O(new_n62_));
  nand3  g33(.a(new_n58_), .b(new_n56_), .c(x17), .O(new_n63_));
  inv1   g34(.a(x17), .O(new_n64_));
  nand2  g35(.a(new_n59_), .b(new_n64_), .O(new_n65_));
  nand3  g36(.a(new_n65_), .b(new_n63_), .c(new_n43_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n62_), .O(z7));
  oai21  g38(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n68_));
  nand4  g39(.a(new_n58_), .b(new_n56_), .c(new_n29_), .d(x17), .O(new_n69_));
