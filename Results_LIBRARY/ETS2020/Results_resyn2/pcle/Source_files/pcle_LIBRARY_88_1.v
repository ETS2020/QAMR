...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(x15), .c(new_n43_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(z5));
  nand2  g29(.a(x08), .b(x05), .O(new_n58_));
  inv1   g30(.a(x16), .O(new_n59_));
  nor3   g31(.a(new_n47_), .b(new_n59_), .c(new_n53_), .O(new_n60_));
  nand2  g32(.a(x15), .b(x14), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n30_), .c(new_n59_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n43_), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n60_), .c(new_n58_), .O(z6));
  oai21  g36(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n66_));
  and2   g37(.a(x17), .b(x16), .O(new_n67_));
  nor2   g38(.a(x18), .b(new_n53_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n55_), .c(new_n67_), .O(new_n69_));
