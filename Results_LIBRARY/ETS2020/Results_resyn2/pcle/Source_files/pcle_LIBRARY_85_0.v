...
module FAU ( 
  ...
  nand2  g00(.a(x08), .b(x05), .O(new_n35_));
  nand2  g01(.a(x12), .b(x11), .O(new_n36_));
  inv1   g02(.a(new_n36_), .O(new_n37_));
  nand3  g03(.a(x15), .b(x14), .c(x13), .O(new_n38_));
  inv1   g04(.a(new_n38_), .O(new_n39_));
  nand3  g05(.a(new_n39_), .b(new_n37_), .c(x16), .O(new_n40_));
  inv1   g06(.a(x16), .O(new_n41_));
  oai21  g07(.a(new_n38_), .b(new_n36_), .c(new_n41_), .O(new_n42_));
  inv1   g08(.a(x08), .O(new_n43_));
  inv1   g09(.a(x10), .O(new_n44_));
  nand3  g10(.a(new_n44_), .b(x09), .c(new_n43_), .O(new_n45_));
  inv1   g11(.a(new_n45_), .O(new_n46_));
  nand3  g12(.a(new_n46_), .b(new_n42_), .c(new_n40_), .O(new_n47_));
  nand2  g13(.a(new_n47_), .b(new_n35_), .O(z6));
  zero   g14(.O(z0));
  zero   g15(.O(z1));
  zero   g16(.O(z2));
  zero   g17(.O(z3));
