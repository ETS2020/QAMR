// Benchmark "FAU" written by ABC on Fri Jul 24 21:58:22 2020
...
module FAU ( 
  ...
  nand2  g23(.a(x3), .b(new_n23_), .O(new_n41_));
  ...
  nand3  g29(.a(new_n42_), .b(new_n27_), .c(new_n18_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n46_), .O(z5));
  nand3  g31(.a(new_n24_), .b(new_n19_), .c(x2), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n43_), .b(new_n50_), .c(new_n16_), .O(new_n51_));
  oai21  g34(.a(x4), .b(x2), .c(new_n19_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(x1), .c(new_n18_), .O(new_n53_));
