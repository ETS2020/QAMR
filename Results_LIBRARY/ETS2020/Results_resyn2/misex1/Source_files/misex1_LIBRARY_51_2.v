// Benchmark "FAU" written by ABC on Fri Jul 24 21:57:44 2020
...
module FAU ( 
  ...
  nand2  g17(.a(new_n26_), .b(new_n23_), .O(new_n33_));
  nand2  g18(.a(new_n19_), .b(new_n16_), .O(new_n34_));
  aoi21  g19(.a(new_n33_), .b(new_n32_), .c(new_n34_), .O(new_n35_));
  nand2  g20(.a(x4), .b(new_n23_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n19_), .c(new_n16_), .O(new_n37_));
  ...
  nand4  g26(.a(new_n24_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n18_), .O(new_n44_));
  nand3  g29(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(z3));
  nor2   g31(.a(new_n25_), .b(x0), .O(new_n48_));
  nand2  g32(.a(x3), .b(new_n23_), .O(new_n49_));
  nand2  g33(.a(new_n19_), .b(x2), .O(new_n50_));
  nand3  g34(.a(new_n50_), .b(new_n49_), .c(x0), .O(new_n51_));
  nand2  g35(.a(new_n51_), .b(new_n16_), .O(new_n52_));
  nand3  g36(.a(new_n50_), .b(new_n27_), .c(new_n18_), .O(new_n53_));
  oai21  g37(.a(new_n52_), .b(new_n48_), .c(new_n53_), .O(z5));
  zero   g38(.O(z4));
  zero   g39(.O(z6));
endmodule
