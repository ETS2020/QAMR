// Benchmark "FAU" written by ABC on Fri Jul 24 21:57:57 2020
...
module FAU ( 
  ...
  nand3  g24(.a(new_n41_), .b(new_n19_), .c(new_n30_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n40_), .c(new_n38_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n17_), .O(new_n44_));
  aoi21  g27(.a(new_n19_), .b(x2), .c(x0), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n23_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n44_), .O(z4));
  nand2  g30(.a(new_n40_), .b(new_n38_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n17_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n46_), .O(z5));
  nor2   g33(.a(x5), .b(x3), .O(new_n51_));
  aoi22  g34(.a(new_n37_), .b(x0), .c(new_n51_), .d(x2), .O(new_n52_));
  oai21  g35(.a(x4), .b(x2), .c(new_n19_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x1), .c(new_n30_), .O(new_n54_));
  oai21  g37(.a(new_n52_), .b(x1), .c(new_n54_), .O(z6));
  zero   g38(.O(z0));
  zero   g39(.O(z3));
endmodule
