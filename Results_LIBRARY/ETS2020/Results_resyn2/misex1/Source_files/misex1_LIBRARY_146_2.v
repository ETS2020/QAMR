...
module FAU ( 
  ...
  nand4  g21(.a(new_n37_), .b(new_n18_), .c(x1), .d(new_n20_), .O(new_n38_));
  nand2  g22(.a(x5), .b(new_n20_), .O(new_n39_));
  nand3  g23(.a(new_n39_), .b(new_n32_), .c(x2), .O(new_n40_));
  nand2  g24(.a(new_n40_), .b(new_n38_), .O(z3));
  zero   g25(.O(z0));
  zero   g26(.O(z4));
  zero   g27(.O(z5));
  zero   g28(.O(z6));
