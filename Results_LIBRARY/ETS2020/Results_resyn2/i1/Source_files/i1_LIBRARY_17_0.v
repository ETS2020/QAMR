...
module FAU ( 
  ...
  nand2  g22(.a(x23), .b(x14), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(x24), .O(z12));
  nand2  g24(.a(x23), .b(x17), .O(new_n70_));
  nor2   g25(.a(new_n70_), .b(x24), .O(z13));
  inv1   g26(.a(x16), .O(new_n72_));
  nor2   g27(.a(x24), .b(new_n72_), .O(z14));
  nor2   g28(.a(x13), .b(x12), .O(new_n74_));
  nor2   g29(.a(x15), .b(x14), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(new_n74_), .O(z15));
  zero   g31(.O(z07));
  zero   g32(.O(z09));
  zero   g33(.O(z10));
  zero   g34(.O(z11));
