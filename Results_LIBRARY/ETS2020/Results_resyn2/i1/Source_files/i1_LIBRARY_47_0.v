// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:05 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n62_, new_n63_, new_n64_, new_n68_, new_n71_, new_n73_,
  ...
  nand2  g22(.a(x22), .b(x14), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(x24), .O(z10));
  nand2  g24(.a(x23), .b(x14), .O(new_n71_));
  nor2   g25(.a(new_n71_), .b(x24), .O(z12));
  nand2  g26(.a(x23), .b(x17), .O(new_n73_));
  nor2   g27(.a(new_n73_), .b(x24), .O(z13));
  inv1   g28(.a(x16), .O(new_n75_));
  nor2   g29(.a(x24), .b(new_n75_), .O(z14));
  nor2   g30(.a(x13), .b(x12), .O(new_n77_));
  nor2   g31(.a(x15), .b(x14), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g33(.O(z00));
  zero   g34(.O(z03));
  zero   g35(.O(z07));
  zero   g36(.O(z09));
