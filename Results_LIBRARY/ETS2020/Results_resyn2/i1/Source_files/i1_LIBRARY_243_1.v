// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:44 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n69_, new_n72_, new_n74_,
    new_n77_, new_n78_;
  ...
  nand2  g25(.a(x23), .b(x14), .O(new_n72_));
  nor2   g26(.a(new_n72_), .b(x24), .O(z12));
  nand2  g27(.a(x23), .b(x17), .O(new_n74_));
  nor2   g28(.a(new_n74_), .b(x24), .O(z13));
  nor2   g29(.a(x13), .b(x12), .O(new_n77_));
  nor2   g30(.a(x15), .b(x14), .O(new_n78_));
  nand2  g31(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g32(.O(z03));
  zero   g33(.O(z06));
  zero   g34(.O(z08));
  zero   g35(.O(z09));
