// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:22 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n62_, new_n63_, new_n64_, new_n68_, new_n69_, new_n71_,
    new_n73_, new_n76_, new_n78_, new_n79_;
  ...
  nand2  g20(.a(x19), .b(new_n63_), .O(new_n64_));
  oai21  g21(.a(new_n64_), .b(new_n56_), .c(new_n62_), .O(z05));
  inv1   g22(.a(x14), .O(new_n68_));
  inv1   g23(.a(x22), .O(new_n69_));
  nor3   g24(.a(x24), .b(new_n69_), .c(new_n68_), .O(z10));
  inv1   g25(.a(x17), .O(new_n71_));
  nor3   g26(.a(x24), .b(new_n69_), .c(new_n71_), .O(z11));
  inv1   g27(.a(x23), .O(new_n73_));
  nor3   g28(.a(x24), .b(new_n73_), .c(new_n68_), .O(z12));
  nor3   g29(.a(x24), .b(new_n73_), .c(new_n71_), .O(z13));
  inv1   g30(.a(x16), .O(new_n76_));
  nor2   g31(.a(x24), .b(new_n76_), .O(z14));
  nor2   g32(.a(x13), .b(x12), .O(new_n78_));
  nor2   g33(.a(x15), .b(x14), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g35(.O(z00));
  zero   g36(.O(z03));
  zero   g37(.O(z07));
  zero   g38(.O(z09));
