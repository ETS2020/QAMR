...
module FAU ( 
  ...
  nor3   g23(.a(x24), .b(new_n68_), .c(new_n67_), .O(z10));
  inv1   g24(.a(x17), .O(new_n70_));
  nor3   g25(.a(x24), .b(new_n68_), .c(new_n70_), .O(z11));
  inv1   g26(.a(x23), .O(new_n72_));
  nor3   g27(.a(x24), .b(new_n72_), .c(new_n67_), .O(z12));
  nor3   g28(.a(x24), .b(new_n72_), .c(new_n70_), .O(z13));
