...
module FAU ( 
  ...
  nand2  g26(.a(x23), .b(x17), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x24), .O(z13));
  inv1   g28(.a(x16), .O(new_n72_));
  nor2   g29(.a(x24), .b(new_n72_), .O(z14));
  nor2   g30(.a(x13), .b(x12), .O(new_n74_));
  nor2   g31(.a(x15), .b(x14), .O(new_n75_));
  nand2  g32(.a(new_n75_), .b(new_n74_), .O(z15));
  zero   g33(.O(z11));
  zero   g34(.O(z12));
  buf    g35(.a(x00), .O(z00));
  buf    g36(.a(x20), .O(z03));
