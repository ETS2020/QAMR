...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n56_,
    new_n58_, new_n60_, new_n63_, new_n64_;
  ...
  nand2  g08(.a(x22), .b(x17), .O(new_n56_));
  nor2   g09(.a(new_n56_), .b(x24), .O(z11));
  nand2  g10(.a(x23), .b(x14), .O(new_n58_));
  nor2   g11(.a(new_n58_), .b(x24), .O(z12));
  nand2  g12(.a(x23), .b(x17), .O(new_n60_));
  nor2   g13(.a(new_n60_), .b(x24), .O(z13));
  nor2   g14(.a(x13), .b(x12), .O(new_n63_));
  nor2   g15(.a(x15), .b(x14), .O(new_n64_));
  nand2  g16(.a(new_n64_), .b(new_n63_), .O(z15));
  zero   g17(.O(z02));
  zero   g18(.O(z03));
  zero   g19(.O(z04));
  zero   g20(.O(z05));
