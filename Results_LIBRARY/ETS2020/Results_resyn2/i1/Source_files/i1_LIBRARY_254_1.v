// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:46 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n68_, new_n70_, new_n72_,
    new_n75_;
  ...
  nand2  g25(.a(x22), .b(x17), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(x24), .O(z11));
  nand2  g27(.a(x23), .b(x14), .O(new_n72_));
  nor2   g28(.a(new_n72_), .b(x24), .O(z12));
  inv1   g29(.a(x16), .O(new_n75_));
  nor2   g30(.a(x24), .b(new_n75_), .O(z14));
  zero   g31(.O(z03));
  zero   g32(.O(z07));
  zero   g33(.O(z08));
  zero   g34(.O(z13));
