...
module FAU ( 
  ...
  nand2  g22(.a(x22), .b(x17), .O(new_n70_));
  nor2   g23(.a(new_n70_), .b(x24), .O(z11));
  nand2  g24(.a(x23), .b(x14), .O(new_n72_));
  nor2   g25(.a(new_n72_), .b(x24), .O(z12));
  nand2  g26(.a(x23), .b(x17), .O(new_n74_));
  nor2   g27(.a(new_n74_), .b(x24), .O(z13));
