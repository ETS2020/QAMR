// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:27 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n67_, new_n70_, new_n72_,
  ...
  nand2  g24(.a(x22), .b(x14), .O(new_n67_));
  nor2   g25(.a(new_n67_), .b(x24), .O(z10));
  nand2  g26(.a(x23), .b(x14), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x24), .O(z12));
  nand2  g28(.a(x23), .b(x17), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(x24), .O(z13));
