...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n69_, new_n75_, new_n76_;
  ...
  nor2   g24(.a(x13), .b(x12), .O(new_n75_));
  nor2   g25(.a(x15), .b(x14), .O(new_n76_));
  nand2  g26(.a(new_n76_), .b(new_n75_), .O(z15));
  zero   g27(.O(z03));
  zero   g28(.O(z06));
  zero   g29(.O(z07));
  zero   g30(.O(z08));
