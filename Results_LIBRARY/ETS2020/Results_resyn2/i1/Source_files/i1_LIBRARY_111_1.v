// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:18 2020
...
module FAU ( 
  ...
  nand2  g23(.a(x22), .b(x14), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(x24), .O(z10));
  nand2  g25(.a(x23), .b(x14), .O(new_n71_));
  nor2   g26(.a(new_n71_), .b(x24), .O(z12));
  nand2  g27(.a(x23), .b(x17), .O(new_n73_));
  nor2   g28(.a(new_n73_), .b(x24), .O(z13));
  nor2   g29(.a(x13), .b(x12), .O(new_n76_));
  nor2   g30(.a(x15), .b(x14), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n76_), .O(z15));
  zero   g32(.O(z00));
  zero   g33(.O(z03));
  zero   g34(.O(z07));
  zero   g35(.O(z11));
