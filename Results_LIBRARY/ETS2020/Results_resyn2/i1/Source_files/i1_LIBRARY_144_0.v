...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n61_, new_n62_, new_n63_, new_n68_, new_n69_, new_n71_,
  ...
  inv1   g31(.a(x16), .O(new_n76_));
  nor2   g32(.a(x24), .b(new_n76_), .O(z14));
  nor2   g33(.a(x13), .b(x12), .O(new_n78_));
  nor2   g34(.a(x15), .b(x14), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g36(.O(z00));
  zero   g37(.O(z06));
  zero   g38(.O(z07));
  buf    g39(.a(x20), .O(z03));
