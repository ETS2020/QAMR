// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:43 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n67_, new_n68_, new_n70_,
    new_n72_, new_n75_, new_n77_, new_n78_;
  ...
  oai21  g21(.a(new_n63_), .b(new_n55_), .c(new_n61_), .O(z05));
  and2   g22(.a(x24), .b(x18), .O(z07));
  and2   g23(.a(x24), .b(x11), .O(z09));
  inv1   g24(.a(x14), .O(new_n67_));
  inv1   g25(.a(x22), .O(new_n68_));
  nor3   g26(.a(x24), .b(new_n68_), .c(new_n67_), .O(z10));
  inv1   g27(.a(x17), .O(new_n70_));
  nor3   g28(.a(x24), .b(new_n68_), .c(new_n70_), .O(z11));
  inv1   g29(.a(x23), .O(new_n72_));
  nor3   g30(.a(x24), .b(new_n72_), .c(new_n67_), .O(z12));
  nor3   g31(.a(x24), .b(new_n72_), .c(new_n70_), .O(z13));
  inv1   g32(.a(x16), .O(new_n75_));
  nor2   g33(.a(x24), .b(new_n75_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n77_));
  nor2   g35(.a(x15), .b(x14), .O(new_n78_));
  nand2  g36(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g37(.O(z03));
  buf    g38(.a(x00), .O(z00));
  buf    g39(.a(x19), .O(z06));
  buf    g40(.a(x11), .O(z08));
