// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:26 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n66_, new_n67_, new_n69_,
    new_n71_, new_n74_, new_n76_, new_n77_;
  ...
  inv1   g18(.a(x08), .O(new_n61_));
  nand2  g19(.a(x19), .b(new_n61_), .O(new_n62_));
  oai21  g20(.a(new_n62_), .b(new_n55_), .c(new_n60_), .O(z05));
  and2   g21(.a(x24), .b(x18), .O(z07));
  inv1   g22(.a(x14), .O(new_n66_));
  inv1   g23(.a(x22), .O(new_n67_));
  nor3   g24(.a(x24), .b(new_n67_), .c(new_n66_), .O(z10));
  inv1   g25(.a(x17), .O(new_n69_));
  nor3   g26(.a(x24), .b(new_n67_), .c(new_n69_), .O(z11));
  inv1   g27(.a(x23), .O(new_n71_));
  nor3   g28(.a(x24), .b(new_n71_), .c(new_n66_), .O(z12));
  nor3   g29(.a(x24), .b(new_n71_), .c(new_n69_), .O(z13));
  inv1   g30(.a(x16), .O(new_n74_));
  nor2   g31(.a(x24), .b(new_n74_), .O(z14));
  nor2   g32(.a(x13), .b(x12), .O(new_n76_));
  nor2   g33(.a(x15), .b(x14), .O(new_n77_));
  nand2  g34(.a(new_n77_), .b(new_n76_), .O(z15));
  zero   g35(.O(z04));
  zero   g36(.O(z09));
  buf    g37(.a(x00), .O(z00));
  buf    g38(.a(x20), .O(z03));
