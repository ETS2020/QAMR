...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n62_, new_n63_, new_n64_, new_n69_, new_n70_, new_n72_,
    new_n74_, new_n77_, new_n79_, new_n80_;
  ...
  nor3   g25(.a(x24), .b(new_n70_), .c(new_n69_), .O(z10));
  inv1   g26(.a(x17), .O(new_n72_));
  nor3   g27(.a(x24), .b(new_n70_), .c(new_n72_), .O(z11));
  inv1   g28(.a(x23), .O(new_n74_));
  nor3   g29(.a(x24), .b(new_n74_), .c(new_n69_), .O(z12));
  nor3   g30(.a(x24), .b(new_n74_), .c(new_n72_), .O(z13));
  inv1   g31(.a(x16), .O(new_n77_));
  nor2   g32(.a(x24), .b(new_n77_), .O(z14));
  nor2   g33(.a(x13), .b(x12), .O(new_n79_));
  nor2   g34(.a(x15), .b(x14), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n79_), .O(z15));
  zero   g36(.O(z00));
  zero   g37(.O(z03));
  zero   g38(.O(z07));
  zero   g39(.O(z08));
