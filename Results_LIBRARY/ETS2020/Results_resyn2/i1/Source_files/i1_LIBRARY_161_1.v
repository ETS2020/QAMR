// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:28 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n68_, new_n74_, new_n75_;
  ...
  nor2   g25(.a(x13), .b(x12), .O(new_n74_));
  nor2   g26(.a(x15), .b(x14), .O(new_n75_));
  nand2  g27(.a(new_n75_), .b(new_n74_), .O(z15));
  zero   g28(.O(z06));
  zero   g29(.O(z07));
  zero   g30(.O(z08));
  zero   g31(.O(z11));
