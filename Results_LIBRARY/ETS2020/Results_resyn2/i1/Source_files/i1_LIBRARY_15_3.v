...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n67_, new_n69_, new_n71_,
  ...
  nand2  g22(.a(x22), .b(x17), .O(new_n67_));
  nor2   g23(.a(new_n67_), .b(x24), .O(z11));
  nand2  g24(.a(x23), .b(x14), .O(new_n69_));
  nor2   g25(.a(new_n69_), .b(x24), .O(z12));
