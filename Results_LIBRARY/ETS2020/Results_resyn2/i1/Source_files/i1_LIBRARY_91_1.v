...
module FAU ( 
  ...
  inv1   g24(.a(x14), .O(new_n69_));
  inv1   g25(.a(x22), .O(new_n70_));
  nor3   g26(.a(x24), .b(new_n70_), .c(new_n69_), .O(z10));
  inv1   g27(.a(x17), .O(new_n72_));
  nor3   g28(.a(x24), .b(new_n70_), .c(new_n72_), .O(z11));
  inv1   g29(.a(x23), .O(new_n74_));
  nor3   g30(.a(x24), .b(new_n74_), .c(new_n69_), .O(z12));
  nor3   g31(.a(x24), .b(new_n74_), .c(new_n72_), .O(z13));
  inv1   g32(.a(x16), .O(new_n77_));
  nor2   g33(.a(x24), .b(new_n77_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n79_));
  nor2   g35(.a(x15), .b(x14), .O(new_n80_));
  nand2  g36(.a(new_n80_), .b(new_n79_), .O(z15));
  zero   g37(.O(z03));
  zero   g38(.O(z06));
  zero   g39(.O(z08));
  buf    g40(.a(x00), .O(z00));
