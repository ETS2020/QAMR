...
module FAU ( 
  ...
  nand2  g21(.a(x22), .b(x14), .O(new_n69_));
  nor2   g22(.a(new_n69_), .b(x24), .O(z10));
  ...
  nor2   g27(.a(x13), .b(x12), .O(new_n77_));
  nor2   g28(.a(x15), .b(x14), .O(new_n78_));
  nand2  g29(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g30(.O(z03));
  zero   g31(.O(z04));
  zero   g32(.O(z06));
  zero   g33(.O(z07));
