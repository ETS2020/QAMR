...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n61_, new_n62_, new_n63_, new_n67_, new_n69_, new_n71_,
  ...
  nand2  g26(.a(x22), .b(x17), .O(new_n69_));
  nor2   g27(.a(new_n69_), .b(x24), .O(z11));
  nand2  g28(.a(x23), .b(x14), .O(new_n71_));
  nor2   g29(.a(new_n71_), .b(x24), .O(z12));
