...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n66_, new_n70_, new_n72_;
  ...
  nand2  g24(.a(x23), .b(x17), .O(new_n70_));
  nor2   g25(.a(new_n70_), .b(x24), .O(z13));
  inv1   g26(.a(x16), .O(new_n72_));
  nor2   g27(.a(x24), .b(new_n72_), .O(z14));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
  zero   g30(.O(z11));
  zero   g31(.O(z12));
