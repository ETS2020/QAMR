...
module FAU ( 
  ...
  nand2  g23(.a(x22), .b(x17), .O(new_n69_));
  nor2   g24(.a(new_n69_), .b(x24), .O(z11));
  inv1   g25(.a(x16), .O(new_n73_));
  nor2   g26(.a(x24), .b(new_n73_), .O(z14));
  nor2   g27(.a(x13), .b(x12), .O(new_n75_));
  nor2   g28(.a(x15), .b(x14), .O(new_n76_));
  nand2  g29(.a(new_n76_), .b(new_n75_), .O(z15));
  zero   g30(.O(z03));
  zero   g31(.O(z08));
  zero   g32(.O(z09));
  zero   g33(.O(z10));
