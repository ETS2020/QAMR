...
module FAU ( 
  ...
  nor3   g23(.a(x24), .b(new_n69_), .c(new_n68_), .O(z10));
  inv1   g24(.a(x17), .O(new_n71_));
  nor3   g25(.a(x24), .b(new_n69_), .c(new_n71_), .O(z11));
  inv1   g26(.a(x23), .O(new_n73_));
  nor3   g27(.a(x24), .b(new_n73_), .c(new_n68_), .O(z12));
  nor3   g28(.a(x24), .b(new_n73_), .c(new_n71_), .O(z13));
