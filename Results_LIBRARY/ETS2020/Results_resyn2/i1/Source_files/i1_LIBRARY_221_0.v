...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n61_, new_n62_, new_n63_, new_n69_, new_n70_, new_n72_,
  ...
  nor3   g24(.a(x24), .b(new_n70_), .c(new_n69_), .O(z10));
  inv1   g25(.a(x17), .O(new_n72_));
  nor3   g26(.a(x24), .b(new_n70_), .c(new_n72_), .O(z11));
  inv1   g27(.a(x23), .O(new_n74_));
  nor3   g28(.a(x24), .b(new_n74_), .c(new_n69_), .O(z12));
  nor3   g29(.a(x24), .b(new_n74_), .c(new_n72_), .O(z13));
