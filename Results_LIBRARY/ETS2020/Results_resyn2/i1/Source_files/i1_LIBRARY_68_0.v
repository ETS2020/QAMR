// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:09 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n67_, new_n69_, new_n72_,
  ...
  inv1   g18(.a(x08), .O(new_n62_));
  nand2  g19(.a(x19), .b(new_n62_), .O(new_n63_));
  oai21  g20(.a(new_n63_), .b(new_n55_), .c(new_n61_), .O(z05));
  and2   g21(.a(x24), .b(x18), .O(z07));
  and2   g22(.a(x24), .b(x11), .O(z09));
  nand2  g23(.a(x22), .b(x14), .O(new_n67_));
  nor2   g24(.a(new_n67_), .b(x24), .O(z10));
  nand2  g25(.a(x22), .b(x17), .O(new_n69_));
  nor2   g26(.a(new_n69_), .b(x24), .O(z11));
  nand2  g27(.a(x23), .b(x17), .O(new_n72_));
  nor2   g28(.a(new_n72_), .b(x24), .O(z13));
  inv1   g29(.a(x16), .O(new_n74_));
  nor2   g30(.a(x24), .b(new_n74_), .O(z14));
  nor2   g31(.a(x13), .b(x12), .O(new_n76_));
  nor2   g32(.a(x15), .b(x14), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n76_), .O(z15));
  zero   g34(.O(z03));
  zero   g35(.O(z04));
  zero   g36(.O(z12));
  buf    g37(.a(x00), .O(z00));
