...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n48_, new_n50_, new_n52_, new_n54_, new_n56_, new_n58_, new_n59_;
  ...
  nor2   g11(.a(x24), .b(new_n56_), .O(z14));
  nor2   g12(.a(x13), .b(x12), .O(new_n58_));
  nor2   g13(.a(x15), .b(x14), .O(new_n59_));
  nand2  g14(.a(new_n59_), .b(new_n58_), .O(z15));
  zero   g15(.O(z01));
  zero   g16(.O(z02));
  zero   g17(.O(z04));
  zero   g18(.O(z05));
