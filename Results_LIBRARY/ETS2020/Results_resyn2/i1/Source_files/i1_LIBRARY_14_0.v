// Benchmark "FAU" written by ABC on Fri Jul 24 21:06:59 2020
...
module FAU ( 
  ...
  inv1   g23(.a(x14), .O(new_n68_));
  inv1   g24(.a(x22), .O(new_n69_));
  nor3   g25(.a(x24), .b(new_n69_), .c(new_n68_), .O(z10));
  inv1   g26(.a(x17), .O(new_n71_));
  nor3   g27(.a(x24), .b(new_n69_), .c(new_n71_), .O(z11));
  inv1   g28(.a(x23), .O(new_n73_));
  nor3   g29(.a(x24), .b(new_n73_), .c(new_n68_), .O(z12));
  nor3   g30(.a(x24), .b(new_n73_), .c(new_n71_), .O(z13));
  nor2   g31(.a(x13), .b(x12), .O(new_n77_));
  nor2   g32(.a(x15), .b(x14), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g34(.O(z00));
  zero   g35(.O(z03));
  zero   g36(.O(z09));
  zero   g37(.O(z14));
