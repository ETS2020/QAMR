// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:11 2020
...
module FAU ( 
  ...
  inv1   g24(.a(x22), .O(new_n68_));
  nor3   g25(.a(x24), .b(new_n68_), .c(new_n67_), .O(z10));
  inv1   g26(.a(x17), .O(new_n70_));
  nor3   g27(.a(x24), .b(new_n68_), .c(new_n70_), .O(z11));
  inv1   g28(.a(x23), .O(new_n72_));
  nor3   g29(.a(x24), .b(new_n72_), .c(new_n67_), .O(z12));
  nor3   g30(.a(x24), .b(new_n72_), .c(new_n70_), .O(z13));
  inv1   g31(.a(x16), .O(new_n75_));
  nor2   g32(.a(x24), .b(new_n75_), .O(z14));
  nor2   g33(.a(x13), .b(x12), .O(new_n77_));
  nor2   g34(.a(x15), .b(x14), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(new_n77_), .O(z15));
  zero   g36(.O(z03));
  zero   g37(.O(z07));
  buf    g38(.a(x00), .O(z00));
  buf    g39(.a(x19), .O(z06));
