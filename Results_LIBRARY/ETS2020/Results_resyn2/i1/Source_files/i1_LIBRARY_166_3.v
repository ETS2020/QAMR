// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:29 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n66_, new_n68_, new_n72_,
    new_n74_, new_n75_;
  ...
  nand2  g25(.a(x22), .b(x17), .O(new_n68_));
  nor2   g26(.a(new_n68_), .b(x24), .O(z11));
  inv1   g27(.a(x16), .O(new_n72_));
  nor2   g28(.a(x24), .b(new_n72_), .O(z14));
  nor2   g29(.a(x13), .b(x12), .O(new_n74_));
  nor2   g30(.a(x15), .b(x14), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n74_), .O(z15));
  zero   g32(.O(z04));
  zero   g33(.O(z12));
  zero   g34(.O(z13));
  buf    g35(.a(x00), .O(z00));
