...
module FAU ( 
  ...
  nor3   g26(.a(x24), .b(new_n69_), .c(new_n68_), .O(z10));
  inv1   g27(.a(x17), .O(new_n71_));
  nor3   g28(.a(x24), .b(new_n69_), .c(new_n71_), .O(z11));
  inv1   g29(.a(x23), .O(new_n73_));
  nor3   g30(.a(x24), .b(new_n73_), .c(new_n68_), .O(z12));
  nor3   g31(.a(x24), .b(new_n73_), .c(new_n71_), .O(z13));
  inv1   g32(.a(x16), .O(new_n76_));
  nor2   g33(.a(x24), .b(new_n76_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n78_));
  nor2   g35(.a(x15), .b(x14), .O(new_n79_));
  nand2  g36(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g37(.O(z00));
  zero   g38(.O(z06));
  buf    g39(.a(x20), .O(z03));
  buf    g40(.a(x11), .O(z08));
