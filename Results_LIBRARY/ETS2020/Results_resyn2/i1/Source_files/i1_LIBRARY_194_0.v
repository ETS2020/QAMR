// Benchmark "FAU" written by ABC on Fri Jul 24 21:07:34 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n58_, new_n62_, new_n63_, new_n64_, new_n69_, new_n72_, new_n74_,
    new_n77_, new_n78_;
  ...
  nand2  g26(.a(x23), .b(x14), .O(new_n72_));
  nor2   g27(.a(new_n72_), .b(x24), .O(z12));
  nand2  g28(.a(x23), .b(x17), .O(new_n74_));
  nor2   g29(.a(new_n74_), .b(x24), .O(z13));
