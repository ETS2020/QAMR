...
module FAU ( 
  ...
  nand2  g24(.a(x22), .b(x14), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(x24), .O(z10));
  nand2  g26(.a(x23), .b(x14), .O(new_n69_));
  nor2   g27(.a(new_n69_), .b(x24), .O(z12));
  nand2  g28(.a(x23), .b(x17), .O(new_n71_));
  nor2   g29(.a(new_n71_), .b(x24), .O(z13));
  inv1   g30(.a(x16), .O(new_n73_));
  nor2   g31(.a(x24), .b(new_n73_), .O(z14));
  nor2   g32(.a(x13), .b(x12), .O(new_n75_));
  nor2   g33(.a(x15), .b(x14), .O(new_n76_));
  nand2  g34(.a(new_n76_), .b(new_n75_), .O(z15));
  zero   g35(.O(z11));
  buf    g36(.a(x00), .O(z00));
  buf    g37(.a(x20), .O(z03));
  buf    g38(.a(x19), .O(z06));
