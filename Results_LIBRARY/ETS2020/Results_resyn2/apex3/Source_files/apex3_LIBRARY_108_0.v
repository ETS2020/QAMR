// Benchmark "FAU" written by ABC on Sat Jul 25 13:10:42 2020
...
module FAU ( 
  ...
  wire new_n113_, new_n114_, new_n115_, new_n116_, new_n117_, new_n118_,
    ...
    new_n292_, new_n296_, new_n297_, new_n301_, new_n304_, new_n305_,
  ...
  nand4  g060(.a(new_n172_), .b(new_n126_), .c(x51), .d(x47), .O(new_n173_));
  ...
  nand3  g068(.a(new_n128_), .b(new_n115_), .c(new_n113_), .O(new_n181_));
  ...
  nand4  g076(.a(new_n126_), .b(new_n120_), .c(new_n153_), .d(new_n113_), .O(new_n189_));
  oai21  g077(.a(new_n188_), .b(x47), .c(new_n189_), .O(z11));
  nand2  g078(.a(new_n162_), .b(new_n121_), .O(new_n192_));
  nor2   g079(.a(x47), .b(x46), .O(new_n193_));
  nand3  g080(.a(new_n193_), .b(new_n115_), .c(new_n153_), .O(new_n194_));
  nor2   g081(.a(new_n194_), .b(new_n192_), .O(z13));
  inv1   g082(.a(new_n160_), .O(new_n196_));
  nand3  g083(.a(new_n193_), .b(x49), .c(x48), .O(new_n197_));
  inv1   g084(.a(new_n197_), .O(new_n198_));
  nand2  g085(.a(new_n198_), .b(new_n168_), .O(new_n199_));
  nor2   g086(.a(new_n199_), .b(new_n196_), .O(z14));
  nand3  g087(.a(new_n184_), .b(new_n125_), .c(x51), .O(new_n201_));
  nand3  g088(.a(new_n126_), .b(new_n118_), .c(x49), .O(new_n202_));
  ...
  nand3  g107(.a(new_n128_), .b(x51), .c(x46), .O(new_n221_));
  ...
  nand3  g115(.a(new_n228_), .b(new_n128_), .c(x50), .O(new_n229_));
  nand2  g116(.a(x52), .b(new_n115_), .O(new_n230_));
  aoi21  g117(.a(new_n229_), .b(new_n225_), .c(new_n230_), .O(new_n231_));
  nand2  g118(.a(new_n226_), .b(new_n130_), .O(new_n232_));
  nor3   g119(.a(new_n232_), .b(new_n143_), .c(x52), .O(new_n233_));
  oai21  g120(.a(new_n233_), .b(new_n231_), .c(new_n153_), .O(new_n234_));
  nand3  g121(.a(new_n151_), .b(new_n126_), .c(new_n113_), .O(new_n235_));
  or2    g122(.a(new_n235_), .b(x51), .O(new_n236_));
  nand2  g123(.a(new_n236_), .b(new_n234_), .O(z16));
  inv1   g124(.a(new_n146_), .O(new_n239_));
  nand2  g125(.a(new_n128_), .b(x48), .O(new_n240_));
  inv1   g126(.a(new_n240_), .O(new_n241_));
  nand2  g127(.a(new_n241_), .b(new_n180_), .O(new_n242_));
  nand3  g128(.a(new_n162_), .b(x50), .c(new_n153_), .O(new_n243_));
  nand2  g129(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nor2   g130(.a(new_n118_), .b(x49), .O(new_n245_));
  nand2  g131(.a(new_n129_), .b(new_n118_), .O(new_n246_));
  nor3   g132(.a(new_n176_), .b(new_n246_), .c(x48), .O(new_n247_));
  aoi21  g133(.a(new_n245_), .b(new_n244_), .c(new_n247_), .O(new_n248_));
  nor2   g134(.a(new_n138_), .b(x48), .O(new_n249_));
  inv1   g135(.a(new_n178_), .O(new_n250_));
  nand3  g136(.a(new_n125_), .b(new_n118_), .c(x23), .O(new_n251_));
  nand2  g137(.a(new_n251_), .b(x48), .O(new_n252_));
  nand4  g138(.a(new_n252_), .b(new_n226_), .c(new_n250_), .d(new_n128_), .O(new_n253_));
  oai22  g139(.a(new_n253_), .b(new_n249_), .c(new_n248_), .d(new_n239_), .O(z18));
  inv1   g140(.a(new_n133_), .O(new_n256_));
  nor3   g141(.a(new_n197_), .b(new_n135_), .c(new_n256_), .O(z20));
  nand3  g142(.a(new_n155_), .b(x53), .c(x46), .O(new_n258_));
  aoi21  g143(.a(new_n258_), .b(new_n235_), .c(new_n118_), .O(z21));
  nand2  g144(.a(new_n162_), .b(new_n118_), .O(new_n263_));
  nand2  g145(.a(new_n198_), .b(new_n116_), .O(new_n264_));
  aoi21  g146(.a(new_n263_), .b(new_n136_), .c(new_n264_), .O(z25));
  nand2  g147(.a(new_n193_), .b(new_n184_), .O(new_n267_));
  nor3   g148(.a(new_n267_), .b(new_n246_), .c(x50), .O(z27));
  ...
  nand2  g152(.a(new_n172_), .b(new_n129_), .O(new_n272_));
  ...
  nand3  g159(.a(new_n228_), .b(new_n130_), .c(x48), .O(new_n279_));
  ...
  nand4  g163(.a(new_n152_), .b(new_n135_), .c(x49), .d(x46), .O(new_n283_));
  aoi21  g164(.a(new_n283_), .b(new_n282_), .c(x51), .O(new_n284_));
  nand3  g165(.a(new_n133_), .b(x49), .c(x46), .O(new_n285_));
  ...
  nand4  g169(.a(new_n241_), .b(new_n288_), .c(x52), .d(x46), .O(new_n289_));
  aoi21  g170(.a(new_n289_), .b(new_n287_), .c(x47), .O(z30));
  inv1   g171(.a(new_n176_), .O(new_n291_));
  nand4  g172(.a(new_n193_), .b(new_n291_), .c(x51), .d(new_n153_), .O(new_n292_));
  ...
  nor2   g178(.a(new_n197_), .b(new_n192_), .O(z36));
  inv1   g179(.a(new_n121_), .O(new_n301_));
  nor2   g180(.a(new_n199_), .b(new_n301_), .O(z37));
  nor2   g181(.a(new_n199_), .b(new_n256_), .O(z38));
  inv1   g182(.a(x24), .O(new_n304_));
  aoi21  g183(.a(new_n160_), .b(new_n304_), .c(new_n133_), .O(new_n305_));
  nor3   g184(.a(new_n305_), .b(new_n267_), .c(new_n165_), .O(z39));
  nor2   g185(.a(new_n128_), .b(x48), .O(new_n307_));
  oai22  g186(.a(new_n307_), .b(new_n232_), .c(new_n208_), .d(x50), .O(new_n308_));
  nand2  g187(.a(new_n308_), .b(new_n118_), .O(new_n309_));
  nand2  g188(.a(x49), .b(x11), .O(new_n310_));
  oai21  g189(.a(new_n310_), .b(x53), .c(new_n118_), .O(new_n311_));
  nand3  g190(.a(new_n311_), .b(new_n226_), .c(new_n147_), .O(new_n312_));
  aoi21  g191(.a(new_n312_), .b(new_n309_), .c(x52), .O(z40));
  nor2   g192(.a(new_n292_), .b(new_n161_), .O(z42));
  nor2   g193(.a(new_n292_), .b(new_n165_), .O(z43));
  nand2  g194(.a(new_n138_), .b(x50), .O(new_n317_));
  aoi21  g195(.a(new_n192_), .b(new_n317_), .c(new_n267_), .O(z44));
  nor2   g196(.a(new_n279_), .b(new_n161_), .O(z46));
  nor3   g197(.a(new_n267_), .b(new_n175_), .c(new_n256_), .O(z47));
  zero   g198(.O(z00));
  zero   g199(.O(z01));
  zero   g200(.O(z02));
  zero   g201(.O(z03));
  ...
  zero   g216(.O(z48));
  zero   g217(.O(z49));
  nor2   g218(.a(new_n292_), .b(new_n164_), .O(z45));
endmodule
