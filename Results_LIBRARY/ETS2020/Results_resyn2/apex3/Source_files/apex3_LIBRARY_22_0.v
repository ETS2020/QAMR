// Benchmark "FAU" written by ABC on Sat Jul 25 13:09:09 2020
...
module FAU ( 
  ...
  nand3  g099(.a(new_n188_), .b(new_n147_), .c(x53), .O(new_n213_));
  ...
  nor3   g125(.a(new_n238_), .b(new_n151_), .c(x52), .O(new_n239_));
  ...
  inv1   g129(.a(new_n147_), .O(new_n244_));
  nand2  g130(.a(new_n164_), .b(new_n148_), .O(new_n245_));
  ...
  nand3  g149(.a(new_n237_), .b(new_n254_), .c(x53), .O(new_n269_));
  nand4  g150(.a(new_n249_), .b(new_n156_), .c(new_n127_), .d(x46), .O(new_n270_));
  aoi21  g151(.a(new_n270_), .b(new_n269_), .c(new_n138_), .O(z26));
  nand2  g152(.a(new_n204_), .b(new_n157_), .O(new_n272_));
  nor2   g153(.a(new_n272_), .b(new_n129_), .O(z27));
  inv1   g154(.a(new_n237_), .O(new_n274_));
  aoi21  g155(.a(x53), .b(new_n161_), .c(x50), .O(new_n275_));
  oai21  g156(.a(new_n275_), .b(new_n148_), .c(x52), .O(new_n276_));
  nand2  g157(.a(new_n176_), .b(new_n128_), .O(new_n277_));
  aoi21  g158(.a(new_n277_), .b(new_n276_), .c(new_n118_), .O(new_n278_));
  inv1   g159(.a(new_n176_), .O(new_n279_));
  nor2   g160(.a(new_n200_), .b(new_n279_), .O(new_n280_));
  oai21  g161(.a(new_n280_), .b(new_n278_), .c(x49), .O(new_n281_));
  nand3  g162(.a(new_n220_), .b(new_n254_), .c(new_n161_), .O(new_n282_));
  aoi21  g163(.a(new_n282_), .b(new_n281_), .c(new_n274_), .O(z28));
  nand2  g164(.a(new_n233_), .b(new_n154_), .O(new_n284_));
  nor2   g165(.a(new_n284_), .b(new_n167_), .O(z29));
  nand2  g166(.a(new_n249_), .b(x51), .O(new_n286_));
  nand4  g167(.a(new_n229_), .b(new_n136_), .c(new_n118_), .d(x49), .O(new_n287_));
  aoi21  g168(.a(new_n287_), .b(new_n286_), .c(new_n113_), .O(new_n288_));
  nand2  g169(.a(new_n249_), .b(new_n124_), .O(new_n289_));
  nand3  g170(.a(new_n163_), .b(new_n118_), .c(new_n113_), .O(new_n290_));
  aoi21  g171(.a(new_n289_), .b(new_n182_), .c(new_n290_), .O(new_n291_));
  oai21  g172(.a(new_n291_), .b(new_n288_), .c(new_n161_), .O(new_n292_));
  nand4  g173(.a(new_n175_), .b(new_n157_), .c(x48), .d(x46), .O(new_n293_));
  aoi21  g174(.a(new_n293_), .b(new_n292_), .c(x47), .O(z30));
  nand3  g175(.a(new_n251_), .b(new_n202_), .c(x51), .O(new_n295_));
  nor2   g176(.a(new_n295_), .b(new_n166_), .O(z31));
  nor2   g177(.a(new_n284_), .b(new_n179_), .O(z33));
  nor2   g178(.a(x53), .b(x48), .O(new_n299_));
  xor2a  g179(.a(new_n299_), .b(x52), .O(new_n300_));
  nor4   g180(.a(new_n300_), .b(new_n274_), .c(new_n180_), .d(x51), .O(z34));
  nor2   g181(.a(new_n267_), .b(new_n266_), .O(z36));
  nor2   g182(.a(new_n205_), .b(new_n180_), .O(z37));
  nand2  g183(.a(new_n170_), .b(x51), .O(new_n305_));
  nor2   g184(.a(new_n305_), .b(new_n267_), .O(z38));
  inv1   g185(.a(x24), .O(new_n307_));
  aoi21  g186(.a(new_n162_), .b(new_n307_), .c(new_n134_), .O(new_n308_));
  nand2  g187(.a(new_n202_), .b(new_n188_), .O(new_n309_));
  nor3   g188(.a(new_n309_), .b(new_n308_), .c(new_n167_), .O(z39));
  nor2   g189(.a(new_n127_), .b(x48), .O(new_n311_));
  oai22  g190(.a(new_n311_), .b(new_n238_), .c(new_n213_), .d(x50), .O(new_n312_));
  nand2  g191(.a(new_n312_), .b(new_n118_), .O(new_n313_));
  nand2  g192(.a(x49), .b(x11), .O(new_n314_));
  oai21  g193(.a(new_n314_), .b(x53), .c(new_n118_), .O(new_n315_));
  nand3  g194(.a(new_n315_), .b(new_n237_), .c(new_n148_), .O(new_n316_));
  aoi21  g195(.a(new_n316_), .b(new_n313_), .c(x52), .O(z40));
  nor2   g196(.a(new_n295_), .b(new_n163_), .O(z42));
  nor2   g197(.a(new_n295_), .b(new_n167_), .O(z43));
  nand2  g198(.a(new_n139_), .b(x50), .O(new_n321_));
  aoi21  g199(.a(new_n197_), .b(new_n321_), .c(new_n309_), .O(z44));
  nor2   g200(.a(new_n284_), .b(new_n163_), .O(z46));
  nor2   g201(.a(new_n305_), .b(new_n272_), .O(z47));
  zero   g202(.O(z00));
  zero   g203(.O(z01));
  zero   g204(.O(z02));
  zero   g205(.O(z03));
