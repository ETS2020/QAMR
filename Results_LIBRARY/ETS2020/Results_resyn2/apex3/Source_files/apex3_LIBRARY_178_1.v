// Benchmark "FAU" written by ABC on Sat Jul 25 13:11:57 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1291_, new_n1293_, new_n1294_, new_n1295_, new_n1303_, new_n1305_,
  ...
  nand3  g1186(.a(new_n234_), .b(new_n116_), .c(x27), .O(new_n1303_));
  nor3   g1187(.a(new_n1303_), .b(new_n1217_), .c(new_n135_), .O(z48));
  nand2  g1188(.a(new_n556_), .b(new_n170_), .O(new_n1305_));
  nand3  g1189(.a(new_n481_), .b(new_n164_), .c(new_n147_), .O(new_n1306_));
  nand2  g1190(.a(new_n1196_), .b(new_n244_), .O(new_n1307_));
  aoi21  g1191(.a(new_n1307_), .b(new_n1306_), .c(x47), .O(new_n1308_));
  oai21  g1192(.a(new_n1308_), .b(new_n1293_), .c(new_n107_), .O(new_n1309_));
  oai21  g1193(.a(new_n1305_), .b(new_n1217_), .c(new_n1309_), .O(new_n1310_));
  nand2  g1194(.a(new_n1310_), .b(new_n234_), .O(new_n1311_));
  nand3  g1195(.a(new_n1188_), .b(x48), .c(new_n159_), .O(new_n1312_));
  oai21  g1196(.a(new_n1312_), .b(new_n1305_), .c(new_n1311_), .O(z49));
  zero   g1197(.O(z08));
  zero   g1198(.O(z09));
  zero   g1199(.O(z13));
  zero   g1200(.O(z20));
