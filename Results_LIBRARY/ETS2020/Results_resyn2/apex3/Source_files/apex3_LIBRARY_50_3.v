...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1299_, new_n1300_, new_n1303_, new_n1304_, new_n1308_, new_n1309_,
    new_n1310_, new_n1311_, new_n1313_, new_n1317_, new_n1318_, new_n1320_,
    new_n1321_, new_n1322_, new_n1323_, new_n1324_, new_n1326_, new_n1327_,
    new_n1329_, new_n1330_, new_n1332_, new_n1335_, new_n1339_, new_n1341_,
  ...
  nand2  g1195(.a(new_n1165_), .b(new_n358_), .O(new_n1303_));
  nand3  g1196(.a(new_n1031_), .b(new_n214_), .c(new_n127_), .O(new_n1304_));
  aoi21  g1197(.a(new_n1304_), .b(new_n1303_), .c(new_n412_), .O(z32));
  nor2   g1198(.a(new_n1289_), .b(new_n330_), .O(z33));
  nand2  g1199(.a(new_n675_), .b(new_n638_), .O(new_n1308_));
  nor3   g1200(.a(new_n805_), .b(new_n885_), .c(new_n453_), .O(new_n1309_));
  aoi22  g1201(.a(new_n1309_), .b(new_n1308_), .c(new_n1257_), .d(new_n1299_), .O(new_n1310_));
  nand4  g1202(.a(new_n1186_), .b(new_n1157_), .c(new_n1291_), .d(new_n210_), .O(new_n1311_));
  oai21  g1203(.a(new_n1310_), .b(new_n192_), .c(new_n1311_), .O(z35));
  or2    g1204(.a(new_n1254_), .b(new_n481_), .O(new_n1313_));
  nor2   g1205(.a(new_n1313_), .b(new_n172_), .O(z36));
  nor2   g1206(.a(new_n1313_), .b(new_n330_), .O(z37));
  nor2   g1207(.a(new_n1274_), .b(new_n237_), .O(z38));
  aoi21  g1208(.a(new_n563_), .b(new_n748_), .c(new_n247_), .O(new_n1317_));
  nand2  g1209(.a(new_n282_), .b(new_n197_), .O(new_n1318_));
  nor3   g1210(.a(new_n1318_), .b(new_n1317_), .c(new_n592_), .O(z39));
  oai21  g1211(.a(new_n134_), .b(x48), .c(new_n150_), .O(new_n1320_));
  nand2  g1212(.a(new_n1031_), .b(x53), .O(new_n1321_));
  oai22  g1213(.a(new_n1321_), .b(new_n328_), .c(new_n1320_), .d(new_n942_), .O(new_n1322_));
  nand2  g1214(.a(new_n1322_), .b(new_n106_), .O(new_n1323_));
  nand2  g1215(.a(new_n1127_), .b(new_n233_), .O(new_n1324_));
  aoi21  g1216(.a(new_n1324_), .b(new_n1323_), .c(x52), .O(z40));
  nand2  g1217(.a(new_n1277_), .b(new_n358_), .O(new_n1326_));
  nand3  g1218(.a(new_n1257_), .b(new_n799_), .c(new_n224_), .O(new_n1327_));
  aoi21  g1219(.a(new_n1327_), .b(new_n1326_), .c(x50), .O(z41));
  nor3   g1220(.a(new_n729_), .b(new_n412_), .c(new_n562_), .O(new_n1329_));
  nand2  g1221(.a(new_n1329_), .b(new_n173_), .O(new_n1330_));
  inv1   g1222(.a(new_n1330_), .O(z42));
  nand2  g1223(.a(new_n1329_), .b(new_n350_), .O(new_n1332_));
  inv1   g1224(.a(new_n1332_), .O(z43));
  aoi21  g1225(.a(new_n1244_), .b(new_n1179_), .c(new_n1318_), .O(z44));
  nand2  g1226(.a(new_n1329_), .b(new_n231_), .O(new_n1335_));
  inv1   g1227(.a(new_n1335_), .O(z45));
  ...
  aoi21  g1236(.a(new_n1344_), .b(new_n1326_), .c(x50), .O(new_n1345_));
