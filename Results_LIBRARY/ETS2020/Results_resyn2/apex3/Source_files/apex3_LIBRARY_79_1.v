...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1291_, new_n1292_, new_n1293_, new_n1295_, new_n1296_, new_n1300_,
  ...
  nor2   g1170(.a(new_n1178_), .b(new_n135_), .O(z38));
  aoi21  g1171(.a(new_n555_), .b(new_n742_), .c(new_n446_), .O(new_n1286_));
  nand2  g1172(.a(new_n1182_), .b(new_n1177_), .O(new_n1287_));
  nor3   g1173(.a(new_n1287_), .b(new_n1286_), .c(new_n829_), .O(z39));
  nand2  g1174(.a(new_n724_), .b(x50), .O(new_n1289_));
  nand2  g1175(.a(new_n680_), .b(new_n107_), .O(new_n1290_));
  oai22  g1176(.a(new_n1290_), .b(new_n247_), .c(new_n1289_), .d(new_n896_), .O(new_n1291_));
  nand2  g1177(.a(new_n1291_), .b(new_n105_), .O(new_n1292_));
  nand2  g1178(.a(new_n324_), .b(new_n886_), .O(new_n1293_));
  aoi21  g1179(.a(new_n1293_), .b(new_n1292_), .c(x52), .O(z40));
  nand2  g1180(.a(new_n1222_), .b(new_n1187_), .O(new_n1295_));
  nand3  g1181(.a(new_n1241_), .b(new_n235_), .c(new_n195_), .O(new_n1296_));
  aoi21  g1182(.a(new_n1296_), .b(new_n1295_), .c(x50), .O(z41));
  nor2   g1183(.a(new_n1266_), .b(new_n724_), .O(z42));
  nand2  g1184(.a(new_n290_), .b(x53), .O(new_n1300_));
  aoi21  g1185(.a(new_n1300_), .b(new_n1231_), .c(new_n1287_), .O(z44));
  nor4   g1186(.a(new_n896_), .b(new_n436_), .c(new_n107_), .d(new_n234_), .O(z46));
  nand3  g1187(.a(new_n160_), .b(new_n116_), .c(x27), .O(new_n1304_));
  nor3   g1188(.a(new_n1304_), .b(new_n662_), .c(new_n135_), .O(z48));
  ...
  aoi21  g1192(.a(new_n1308_), .b(new_n1295_), .c(x50), .O(new_n1309_));
