...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1316_, new_n1317_, new_n1319_, new_n1324_, new_n1325_, new_n1326_,
    new_n1327_, new_n1329_, new_n1330_, new_n1332_, new_n1334_, new_n1336_,
  ...
  oai21  g1214(.a(new_n134_), .b(x48), .c(new_n151_), .O(new_n1324_));
  oai22  g1215(.a(new_n1324_), .b(new_n949_), .c(new_n1265_), .d(new_n330_), .O(new_n1325_));
  nand2  g1216(.a(new_n1325_), .b(new_n106_), .O(new_n1326_));
  nand3  g1217(.a(new_n1132_), .b(new_n158_), .c(x51), .O(new_n1327_));
  aoi21  g1218(.a(new_n1327_), .b(new_n1326_), .c(x52), .O(z40));
  nand2  g1219(.a(new_n1280_), .b(new_n359_), .O(new_n1329_));
  nand3  g1220(.a(new_n1260_), .b(new_n807_), .c(new_n226_), .O(new_n1330_));
  aoi21  g1221(.a(new_n1330_), .b(new_n1329_), .c(x50), .O(z41));
  nand2  g1222(.a(new_n1306_), .b(new_n177_), .O(new_n1332_));
  inv1   g1223(.a(new_n1332_), .O(z42));
  nand2  g1224(.a(new_n1306_), .b(new_n351_), .O(new_n1334_));
  inv1   g1225(.a(new_n1334_), .O(z43));
  nand2  g1226(.a(new_n1181_), .b(new_n1162_), .O(new_n1336_));
  aoi21  g1227(.a(new_n1247_), .b(new_n1185_), .c(new_n1336_), .O(z44));
  nor2   g1228(.a(new_n1293_), .b(new_n176_), .O(z46));
  nor3   g1229(.a(new_n939_), .b(new_n200_), .c(new_n137_), .O(z47));
  nand3  g1230(.a(new_n244_), .b(new_n115_), .c(x27), .O(new_n1340_));
  nor3   g1231(.a(new_n1340_), .b(new_n1279_), .c(new_n139_), .O(z48));
  nand3  g1232(.a(new_n495_), .b(new_n351_), .c(new_n151_), .O(new_n1342_));
  nand3  g1233(.a(new_n652_), .b(new_n489_), .c(x46), .O(new_n1343_));
  nand2  g1234(.a(new_n1343_), .b(new_n1342_), .O(new_n1344_));
  nand2  g1235(.a(new_n1344_), .b(new_n157_), .O(new_n1345_));
  aoi21  g1236(.a(new_n1345_), .b(new_n1329_), .c(x50), .O(new_n1346_));
  nor2   g1237(.a(new_n1279_), .b(new_n1198_), .O(new_n1347_));
  oai21  g1238(.a(new_n1347_), .b(new_n1346_), .c(new_n244_), .O(new_n1348_));
  nand2  g1239(.a(new_n1221_), .b(new_n1162_), .O(new_n1349_));
  oai21  g1240(.a(new_n1349_), .b(new_n1198_), .c(new_n1348_), .O(z49));
  zero   g1241(.O(z14));
  zero   g1242(.O(z18));
  zero   g1243(.O(z25));
  zero   g1244(.O(z34));
  zero   g1245(.O(z39));
  inv1   g1246(.a(new_n1307_), .O(z45));
endmodule
