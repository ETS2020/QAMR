// Benchmark "FAU" written by ABC on Sat Jul 25 13:09:23 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1328_, new_n1329_, new_n1331_, new_n1333_, new_n1339_, new_n1341_,
  ...
  nor2   g1201(.a(new_n1289_), .b(new_n330_), .O(z33));
  nand2  g1202(.a(new_n675_), .b(new_n638_), .O(new_n1310_));
  nor3   g1203(.a(new_n805_), .b(new_n885_), .c(new_n453_), .O(new_n1311_));
  aoi22  g1204(.a(new_n1311_), .b(new_n1310_), .c(new_n1257_), .d(new_n1299_), .O(new_n1312_));
  nand4  g1205(.a(new_n1186_), .b(new_n1157_), .c(new_n1291_), .d(new_n210_), .O(new_n1313_));
  oai21  g1206(.a(new_n1312_), .b(new_n192_), .c(new_n1313_), .O(z35));
  or2    g1207(.a(new_n1254_), .b(new_n481_), .O(new_n1315_));
  nor2   g1208(.a(new_n1315_), .b(new_n172_), .O(z36));
  nor2   g1209(.a(new_n1315_), .b(new_n330_), .O(z37));
  nor2   g1210(.a(new_n1274_), .b(new_n237_), .O(z38));
  aoi21  g1211(.a(new_n563_), .b(new_n748_), .c(new_n247_), .O(new_n1319_));
  nand2  g1212(.a(new_n282_), .b(new_n197_), .O(new_n1320_));
  nor3   g1213(.a(new_n1320_), .b(new_n1319_), .c(new_n592_), .O(z39));
  oai21  g1214(.a(new_n134_), .b(x48), .c(new_n150_), .O(new_n1322_));
  nand2  g1215(.a(new_n1031_), .b(x53), .O(new_n1323_));
  oai22  g1216(.a(new_n1323_), .b(new_n328_), .c(new_n1322_), .d(new_n942_), .O(new_n1324_));
  nand2  g1217(.a(new_n1324_), .b(new_n106_), .O(new_n1325_));
  nand2  g1218(.a(new_n1127_), .b(new_n233_), .O(new_n1326_));
  aoi21  g1219(.a(new_n1326_), .b(new_n1325_), .c(x52), .O(z40));
  nand2  g1220(.a(new_n1277_), .b(new_n358_), .O(new_n1328_));
  nand3  g1221(.a(new_n1257_), .b(new_n799_), .c(new_n224_), .O(new_n1329_));
  aoi21  g1222(.a(new_n1329_), .b(new_n1328_), .c(x50), .O(z41));
  nand2  g1223(.a(new_n1302_), .b(new_n173_), .O(new_n1331_));
  inv1   g1224(.a(new_n1331_), .O(z42));
  nand2  g1225(.a(new_n1302_), .b(new_n350_), .O(new_n1333_));
  inv1   g1226(.a(new_n1333_), .O(z43));
  aoi21  g1227(.a(new_n1244_), .b(new_n1179_), .c(new_n1320_), .O(z44));
  nor2   g1228(.a(new_n1289_), .b(new_n172_), .O(z46));
  nor3   g1229(.a(new_n932_), .b(new_n198_), .c(new_n312_), .O(z47));
  nand3  g1230(.a(new_n241_), .b(new_n115_), .c(x27), .O(new_n1339_));
  nor3   g1231(.a(new_n1339_), .b(new_n1276_), .c(new_n138_), .O(z48));
  nand2  g1232(.a(new_n649_), .b(x46), .O(new_n1341_));
  nand3  g1233(.a(new_n512_), .b(new_n350_), .c(new_n150_), .O(new_n1342_));
  oai21  g1234(.a(new_n1341_), .b(new_n269_), .c(new_n1342_), .O(new_n1343_));
  nand2  g1235(.a(new_n1343_), .b(new_n159_), .O(new_n1344_));
  aoi21  g1236(.a(new_n1344_), .b(new_n1328_), .c(x50), .O(new_n1345_));
  nor2   g1237(.a(new_n1276_), .b(new_n1193_), .O(new_n1346_));
  oai21  g1238(.a(new_n1346_), .b(new_n1345_), .c(new_n241_), .O(new_n1347_));
  nand2  g1239(.a(new_n1218_), .b(new_n1157_), .O(new_n1348_));
  oai21  g1240(.a(new_n1348_), .b(new_n1193_), .c(new_n1347_), .O(z49));
  zero   g1241(.O(z14));
  zero   g1242(.O(z18));
  zero   g1243(.O(z34));
  zero   g1244(.O(z45));
