// Benchmark "FAU" written by ABC on Sat Jul 25 13:11:24 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1245_, new_n1246_, new_n1249_, new_n1250_, new_n1253_, new_n1254_,
    new_n1255_, new_n1257_, new_n1258_, new_n1259_, new_n1260_, new_n1261_,
    new_n1262_, new_n1263_, new_n1270_, new_n1271_, new_n1279_, new_n1281_,
  ...
  nand4  g1137(.a(new_n351_), .b(new_n179_), .c(new_n113_), .d(new_n154_), .O(new_n1250_));
  aoi21  g1138(.a(new_n1250_), .b(new_n1249_), .c(new_n403_), .O(z32));
  nand2  g1139(.a(new_n922_), .b(x52), .O(new_n1253_));
  inv1   g1140(.a(new_n976_), .O(new_n1254_));
  nand2  g1141(.a(new_n1254_), .b(new_n154_), .O(new_n1255_));
  aoi21  g1142(.a(new_n1253_), .b(new_n931_), .c(new_n1255_), .O(z34));
  nor3   g1143(.a(new_n1195_), .b(new_n1194_), .c(new_n154_), .O(new_n1257_));
  nand2  g1144(.a(new_n675_), .b(new_n307_), .O(new_n1258_));
  nand2  g1145(.a(new_n743_), .b(new_n886_), .O(new_n1259_));
  nor2   g1146(.a(new_n1259_), .b(new_n1151_), .O(new_n1260_));
  aoi21  g1147(.a(new_n1260_), .b(new_n1258_), .c(new_n1257_), .O(new_n1261_));
  nand2  g1148(.a(new_n429_), .b(new_n220_), .O(new_n1262_));
  nand3  g1149(.a(new_n1262_), .b(new_n1172_), .c(new_n478_), .O(new_n1263_));
  oai21  g1150(.a(new_n1261_), .b(new_n162_), .c(new_n1263_), .O(z35));
  nor2   g1151(.a(new_n1173_), .b(new_n142_), .O(z38));
  nand2  g1152(.a(new_n1188_), .b(new_n350_), .O(new_n1270_));
  nand4  g1153(.a(new_n670_), .b(new_n386_), .c(new_n241_), .d(x46), .O(new_n1271_));
  aoi21  g1154(.a(new_n1271_), .b(new_n1270_), .c(x50), .O(z41));
  nor3   g1155(.a(new_n1169_), .b(new_n159_), .c(new_n140_), .O(z43));
  nor4   g1156(.a(new_n622_), .b(new_n1220_), .c(new_n236_), .d(x50), .O(z47));
  nand3  g1157(.a(new_n170_), .b(new_n106_), .c(x27), .O(new_n1279_));
  nor3   g1158(.a(new_n1279_), .b(new_n319_), .c(new_n142_), .O(z48));
  inv1   g1159(.a(new_n1205_), .O(new_n1281_));
  nand3  g1160(.a(new_n498_), .b(new_n458_), .c(new_n154_), .O(new_n1282_));
  oai21  g1161(.a(new_n1281_), .b(new_n799_), .c(new_n1282_), .O(new_n1283_));
  nand2  g1162(.a(new_n1283_), .b(new_n169_), .O(new_n1284_));
  aoi21  g1163(.a(new_n1284_), .b(new_n1270_), .c(x50), .O(new_n1285_));
  nor2   g1164(.a(new_n1187_), .b(new_n887_), .O(new_n1286_));
  oai21  g1165(.a(new_n1286_), .b(new_n1285_), .c(new_n240_), .O(new_n1287_));
  nand3  g1166(.a(new_n888_), .b(new_n280_), .c(new_n175_), .O(new_n1288_));
  nand2  g1167(.a(new_n1288_), .b(new_n1287_), .O(z49));
  zero   g1168(.O(z10));
  zero   g1169(.O(z11));
  zero   g1170(.O(z15));
  zero   g1171(.O(z16));
