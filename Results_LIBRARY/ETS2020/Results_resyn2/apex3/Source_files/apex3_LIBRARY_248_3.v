// Benchmark "FAU" written by ABC on Sat Jul 25 13:13:12 2020
...
module FAU ( 
  ...
  nand3  g1230(.a(new_n241_), .b(new_n115_), .c(x27), .O(new_n1338_));
  nor3   g1231(.a(new_n1338_), .b(new_n1276_), .c(new_n138_), .O(z48));
  nand2  g1232(.a(new_n649_), .b(x46), .O(new_n1340_));
  nand3  g1233(.a(new_n512_), .b(new_n350_), .c(new_n150_), .O(new_n1341_));
  oai21  g1234(.a(new_n1340_), .b(new_n269_), .c(new_n1341_), .O(new_n1342_));
  nand2  g1235(.a(new_n1342_), .b(new_n159_), .O(new_n1343_));
  aoi21  g1236(.a(new_n1343_), .b(new_n1328_), .c(x50), .O(new_n1344_));
  nor2   g1237(.a(new_n1276_), .b(new_n1193_), .O(new_n1345_));
  oai21  g1238(.a(new_n1345_), .b(new_n1344_), .c(new_n241_), .O(new_n1346_));
  nand2  g1239(.a(new_n1218_), .b(new_n1157_), .O(new_n1347_));
  oai21  g1240(.a(new_n1347_), .b(new_n1193_), .c(new_n1346_), .O(z49));
  zero   g1241(.O(z14));
  zero   g1242(.O(z18));
  zero   g1243(.O(z34));
