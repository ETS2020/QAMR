...
module FAU ( 
  ...
  wire new_n113_, new_n114_, new_n115_, new_n116_, new_n117_, new_n118_,
    ...
    new_n295_, new_n298_, new_n300_, new_n303_, new_n304_, new_n305_,
  ...
  nand4  g140(.a(new_n155_), .b(new_n154_), .c(new_n128_), .d(x46), .O(new_n257_));
  aoi21  g141(.a(new_n257_), .b(new_n239_), .c(new_n118_), .O(z21));
  inv1   g142(.a(new_n178_), .O(new_n262_));
  nand2  g143(.a(new_n201_), .b(new_n262_), .O(new_n263_));
  aoi21  g144(.a(new_n197_), .b(new_n135_), .c(new_n263_), .O(z25));
  nand3  g145(.a(new_n235_), .b(new_n250_), .c(x53), .O(new_n265_));
  nand4  g146(.a(new_n262_), .b(new_n155_), .c(new_n127_), .d(x46), .O(new_n266_));
  aoi21  g147(.a(new_n266_), .b(new_n265_), .c(new_n136_), .O(z26));
  nor4   g148(.a(new_n200_), .b(new_n144_), .c(x52), .d(x50), .O(z27));
  inv1   g149(.a(new_n235_), .O(new_n269_));
  aoi21  g150(.a(x53), .b(new_n159_), .c(x50), .O(new_n270_));
  oai21  g151(.a(new_n270_), .b(new_n147_), .c(x52), .O(new_n271_));
  nand2  g152(.a(new_n174_), .b(new_n128_), .O(new_n272_));
  aoi21  g153(.a(new_n272_), .b(new_n271_), .c(new_n118_), .O(new_n273_));
  inv1   g154(.a(new_n174_), .O(new_n274_));
  nor2   g155(.a(new_n208_), .b(new_n274_), .O(new_n275_));
  oai21  g156(.a(new_n275_), .b(new_n273_), .c(x49), .O(new_n276_));
  nand3  g157(.a(new_n218_), .b(new_n250_), .c(new_n159_), .O(new_n277_));
  aoi21  g158(.a(new_n277_), .b(new_n276_), .c(new_n269_), .O(z28));
  nand2  g159(.a(new_n231_), .b(new_n152_), .O(new_n279_));
  nor2   g160(.a(new_n279_), .b(new_n165_), .O(z29));
  nand2  g161(.a(new_n262_), .b(x51), .O(new_n281_));
  nand4  g162(.a(new_n227_), .b(new_n134_), .c(new_n118_), .d(x49), .O(new_n282_));
  aoi21  g163(.a(new_n282_), .b(new_n281_), .c(new_n113_), .O(new_n283_));
  nand2  g164(.a(new_n262_), .b(new_n124_), .O(new_n284_));
  nand3  g165(.a(new_n161_), .b(new_n118_), .c(new_n113_), .O(new_n285_));
  aoi21  g166(.a(new_n284_), .b(new_n180_), .c(new_n285_), .O(new_n286_));
  oai21  g167(.a(new_n286_), .b(new_n283_), .c(new_n159_), .O(new_n287_));
  nand4  g168(.a(new_n173_), .b(new_n154_), .c(x48), .d(x46), .O(new_n288_));
  aoi21  g169(.a(new_n288_), .b(new_n287_), .c(x47), .O(z30));
  or2    g170(.a(new_n281_), .b(new_n196_), .O(new_n290_));
  nor2   g171(.a(new_n290_), .b(new_n164_), .O(z31));
  nor2   g172(.a(new_n279_), .b(new_n177_), .O(z33));
  nor2   g173(.a(x53), .b(x48), .O(new_n294_));
  xor2a  g174(.a(new_n294_), .b(x52), .O(new_n295_));
  nor4   g175(.a(new_n295_), .b(new_n269_), .c(new_n178_), .d(x51), .O(z34));
  nand2  g176(.a(new_n162_), .b(new_n121_), .O(new_n298_));
  nor3   g177(.a(new_n298_), .b(new_n200_), .c(new_n115_), .O(z36));
  inv1   g178(.a(new_n121_), .O(new_n300_));
  nor2   g179(.a(new_n202_), .b(new_n300_), .O(z37));
  inv1   g180(.a(x24), .O(new_n303_));
  aoi21  g181(.a(new_n160_), .b(new_n303_), .c(new_n132_), .O(new_n304_));
  nand2  g182(.a(new_n195_), .b(new_n186_), .O(new_n305_));
  nor3   g183(.a(new_n305_), .b(new_n304_), .c(new_n165_), .O(z39));
  nor2   g184(.a(new_n127_), .b(x48), .O(new_n307_));
  oai22  g185(.a(new_n307_), .b(new_n236_), .c(new_n211_), .d(x50), .O(new_n308_));
  nand2  g186(.a(new_n308_), .b(new_n118_), .O(new_n309_));
  nand2  g187(.a(x49), .b(x11), .O(new_n310_));
  oai21  g188(.a(new_n310_), .b(x53), .c(new_n118_), .O(new_n311_));
  nand3  g189(.a(new_n311_), .b(new_n235_), .c(new_n147_), .O(new_n312_));
  aoi21  g190(.a(new_n312_), .b(new_n309_), .c(x52), .O(z40));
  nor2   g191(.a(new_n290_), .b(new_n161_), .O(z42));
  nor2   g192(.a(new_n290_), .b(new_n165_), .O(z43));
  nand2  g193(.a(new_n137_), .b(x50), .O(new_n317_));
  aoi21  g194(.a(new_n298_), .b(new_n317_), .c(new_n305_), .O(z44));
  nor2   g195(.a(new_n279_), .b(new_n161_), .O(z46));
  nor3   g196(.a(new_n200_), .b(new_n177_), .c(new_n117_), .O(z47));
  zero   g197(.O(z00));
  zero   g198(.O(z01));
  zero   g199(.O(z02));
  zero   g200(.O(z03));
  ...
  zero   g216(.O(z48));
  zero   g217(.O(z49));
  nor2   g218(.a(new_n290_), .b(new_n164_), .O(z45));
endmodule
