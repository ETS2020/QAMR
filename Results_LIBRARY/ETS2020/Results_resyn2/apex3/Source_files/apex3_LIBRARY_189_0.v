...
module FAU ( 
  ...
  inv1   g177(.a(x24), .O(new_n301_));
  aoi21  g178(.a(new_n159_), .b(new_n301_), .c(new_n131_), .O(new_n302_));
  nand2  g179(.a(new_n193_), .b(new_n185_), .O(new_n303_));
  nor3   g180(.a(new_n303_), .b(new_n302_), .c(new_n164_), .O(z39));
  nor2   g181(.a(new_n126_), .b(x48), .O(new_n305_));
  oai22  g182(.a(new_n305_), .b(new_n232_), .c(new_n208_), .d(x50), .O(new_n306_));
  nand2  g183(.a(new_n306_), .b(new_n118_), .O(new_n307_));
  nand2  g184(.a(x49), .b(x11), .O(new_n308_));
  oai21  g185(.a(new_n308_), .b(x53), .c(new_n118_), .O(new_n309_));
  nand3  g186(.a(new_n309_), .b(new_n228_), .c(new_n145_), .O(new_n310_));
  aoi21  g187(.a(new_n310_), .b(new_n307_), .c(x52), .O(z40));
  nor2   g188(.a(new_n290_), .b(new_n160_), .O(z42));
  nor2   g189(.a(new_n290_), .b(new_n164_), .O(z43));
  nand2  g190(.a(new_n136_), .b(x50), .O(new_n315_));
  nand2  g191(.a(new_n195_), .b(new_n116_), .O(new_n316_));
  aoi21  g192(.a(new_n316_), .b(new_n315_), .c(new_n303_), .O(z44));
  nor2   g193(.a(new_n279_), .b(new_n160_), .O(z46));
  nor3   g194(.a(new_n303_), .b(new_n224_), .c(new_n134_), .O(z47));
  zero   g195(.O(z00));
  zero   g196(.O(z01));
  zero   g197(.O(z02));
  zero   g198(.O(z03));
