// Benchmark "FAU" written by ABC on Sat Jul 25 13:12:34 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1221_, new_n1222_, new_n1227_, new_n1228_, new_n1229_, new_n1230_,
  ...
  nor2   g1114(.a(new_n1171_), .b(new_n461_), .O(z27));
  inv1   g1115(.a(new_n1214_), .O(new_n1227_));
  oai21  g1116(.a(new_n1227_), .b(new_n922_), .c(x52), .O(new_n1228_));
  aoi21  g1117(.a(new_n1228_), .b(new_n1201_), .c(new_n113_), .O(new_n1229_));
  nor3   g1118(.a(new_n225_), .b(x50), .c(x48), .O(new_n1230_));
  oai21  g1119(.a(new_n1230_), .b(new_n1229_), .c(x49), .O(new_n1231_));
  nand3  g1120(.a(new_n350_), .b(new_n291_), .c(new_n240_), .O(new_n1232_));
  aoi21  g1121(.a(new_n1232_), .b(new_n1231_), .c(new_n224_), .O(z28));
  nand2  g1122(.a(new_n254_), .b(x49), .O(new_n1235_));
  oai21  g1123(.a(new_n271_), .b(new_n178_), .c(new_n1235_), .O(new_n1236_));
  nand2  g1124(.a(new_n1236_), .b(new_n154_), .O(new_n1237_));
  inv1   g1125(.a(new_n139_), .O(new_n1238_));
  nand3  g1126(.a(new_n1205_), .b(new_n602_), .c(new_n1238_), .O(new_n1239_));
  aoi21  g1127(.a(new_n1239_), .b(new_n1237_), .c(x51), .O(new_n1240_));
  nand2  g1128(.a(new_n1205_), .b(new_n361_), .O(new_n1241_));
  inv1   g1129(.a(new_n1241_), .O(new_n1242_));
  oai21  g1130(.a(new_n1242_), .b(new_n1240_), .c(new_n240_), .O(new_n1243_));
  nand4  g1131(.a(new_n505_), .b(new_n361_), .c(new_n280_), .d(x46), .O(new_n1244_));
  aoi21  g1132(.a(new_n1244_), .b(new_n1243_), .c(x47), .O(z30));
  nand2  g1133(.a(new_n1153_), .b(new_n350_), .O(new_n1247_));
  nand2  g1134(.a(new_n351_), .b(new_n154_), .O(new_n1248_));
  or2    g1135(.a(new_n1248_), .b(new_n225_), .O(new_n1249_));
  aoi21  g1136(.a(new_n1249_), .b(new_n1247_), .c(new_n403_), .O(z32));
  nand2  g1137(.a(new_n922_), .b(x52), .O(new_n1252_));
  inv1   g1138(.a(new_n976_), .O(new_n1253_));
  nand2  g1139(.a(new_n1253_), .b(new_n154_), .O(new_n1254_));
  aoi21  g1140(.a(new_n1252_), .b(new_n931_), .c(new_n1254_), .O(z34));
  nor3   g1141(.a(new_n1195_), .b(new_n1194_), .c(new_n154_), .O(new_n1256_));
  nand2  g1142(.a(new_n675_), .b(new_n307_), .O(new_n1257_));
  nand2  g1143(.a(new_n743_), .b(new_n886_), .O(new_n1258_));
  nor2   g1144(.a(new_n1258_), .b(new_n1151_), .O(new_n1259_));
  aoi21  g1145(.a(new_n1259_), .b(new_n1257_), .c(new_n1256_), .O(new_n1260_));
  nand2  g1146(.a(new_n429_), .b(new_n220_), .O(new_n1261_));
  nand3  g1147(.a(new_n1261_), .b(new_n1172_), .c(new_n478_), .O(new_n1262_));
  oai21  g1148(.a(new_n1260_), .b(new_n162_), .c(new_n1262_), .O(z35));
  nor2   g1149(.a(new_n1249_), .b(new_n403_), .O(z37));
  nor3   g1150(.a(new_n1248_), .b(new_n236_), .c(new_n403_), .O(z38));
  nand2  g1151(.a(new_n1188_), .b(new_n350_), .O(new_n1269_));
  nand4  g1152(.a(new_n670_), .b(new_n386_), .c(new_n241_), .d(x46), .O(new_n1270_));
  aoi21  g1153(.a(new_n1270_), .b(new_n1269_), .c(x50), .O(z41));
  nor3   g1154(.a(new_n1169_), .b(new_n159_), .c(new_n140_), .O(z43));
  nor4   g1155(.a(new_n622_), .b(new_n1220_), .c(new_n236_), .d(x50), .O(z47));
  nand3  g1156(.a(new_n170_), .b(new_n106_), .c(x27), .O(new_n1278_));
  nor3   g1157(.a(new_n1278_), .b(new_n319_), .c(new_n142_), .O(z48));
  inv1   g1158(.a(new_n1205_), .O(new_n1280_));
  nand3  g1159(.a(new_n498_), .b(new_n458_), .c(new_n154_), .O(new_n1281_));
  oai21  g1160(.a(new_n1280_), .b(new_n799_), .c(new_n1281_), .O(new_n1282_));
  nand2  g1161(.a(new_n1282_), .b(new_n169_), .O(new_n1283_));
  aoi21  g1162(.a(new_n1283_), .b(new_n1269_), .c(x50), .O(new_n1284_));
  nor2   g1163(.a(new_n1187_), .b(new_n887_), .O(new_n1285_));
  oai21  g1164(.a(new_n1285_), .b(new_n1284_), .c(new_n240_), .O(new_n1286_));
  nand3  g1165(.a(new_n888_), .b(new_n280_), .c(new_n175_), .O(new_n1287_));
  nand2  g1166(.a(new_n1287_), .b(new_n1286_), .O(z49));
  zero   g1167(.O(z10));
  zero   g1168(.O(z11));
  zero   g1169(.O(z15));
  zero   g1170(.O(z16));
