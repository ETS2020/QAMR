// Benchmark "FAU" written by ABC on Sat Jul 25 13:10:14 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n1328_, new_n1329_, new_n1332_, new_n1337_, new_n1339_, new_n1340_,
  ...
  nand2  g1223(.a(new_n1302_), .b(new_n350_), .O(new_n1332_));
  inv1   g1224(.a(new_n1332_), .O(z43));
  aoi21  g1225(.a(new_n1244_), .b(new_n1179_), .c(new_n1320_), .O(z44));
  nor2   g1226(.a(new_n1289_), .b(new_n172_), .O(z46));
  nor3   g1227(.a(new_n932_), .b(new_n198_), .c(new_n312_), .O(z47));
  nand3  g1228(.a(new_n241_), .b(new_n115_), .c(x27), .O(new_n1337_));
  nor3   g1229(.a(new_n1337_), .b(new_n1276_), .c(new_n138_), .O(z48));
  nand2  g1230(.a(new_n649_), .b(x46), .O(new_n1339_));
  nand3  g1231(.a(new_n512_), .b(new_n350_), .c(new_n150_), .O(new_n1340_));
  oai21  g1232(.a(new_n1339_), .b(new_n269_), .c(new_n1340_), .O(new_n1341_));
  nand2  g1233(.a(new_n1341_), .b(new_n159_), .O(new_n1342_));
  aoi21  g1234(.a(new_n1342_), .b(new_n1328_), .c(x50), .O(new_n1343_));
  nor2   g1235(.a(new_n1276_), .b(new_n1193_), .O(new_n1344_));
  oai21  g1236(.a(new_n1344_), .b(new_n1343_), .c(new_n241_), .O(new_n1345_));
  nand2  g1237(.a(new_n1218_), .b(new_n1157_), .O(new_n1346_));
  oai21  g1238(.a(new_n1346_), .b(new_n1193_), .c(new_n1345_), .O(z49));
  zero   g1239(.O(z14));
  zero   g1240(.O(z18));
  zero   g1241(.O(z34));
  zero   g1242(.O(z42));
  inv1   g1243(.a(new_n1303_), .O(z45));
endmodule
