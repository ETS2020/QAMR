// Benchmark "FAU" written by ABC on Sat Jul 25 13:12:47 2020
...
module FAU ( 
  ...
  wire new_n113_, new_n114_, new_n115_, new_n116_, new_n117_, new_n118_,
    ...
    new_n249_, new_n252_, new_n254_, new_n259_, new_n260_, new_n261_,
    new_n263_, new_n264_, new_n265_, new_n268_, new_n269_, new_n270_,
    new_n271_, new_n272_, new_n273_, new_n274_, new_n275_, new_n276_,
    new_n278_, new_n279_, new_n281_, new_n282_, new_n283_, new_n284_,
    new_n285_, new_n286_, new_n287_, new_n288_, new_n290_, new_n294_,
  ...
  nand2  g136(.a(new_n165_), .b(new_n131_), .O(new_n252_));
  nor2   g137(.a(new_n252_), .b(new_n198_), .O(z20));
  nand4  g138(.a(new_n154_), .b(new_n153_), .c(new_n127_), .d(x46), .O(new_n254_));
  aoi21  g139(.a(new_n254_), .b(new_n235_), .c(new_n118_), .O(z21));
  inv1   g140(.a(new_n195_), .O(new_n259_));
  inv1   g141(.a(new_n198_), .O(new_n260_));
  nand2  g142(.a(new_n260_), .b(new_n116_), .O(new_n261_));
  aoi21  g143(.a(new_n259_), .b(new_n134_), .c(new_n261_), .O(z25));
  nand3  g144(.a(new_n228_), .b(new_n246_), .c(x53), .O(new_n263_));
  inv1   g145(.a(new_n177_), .O(new_n264_));
  nand4  g146(.a(new_n264_), .b(new_n153_), .c(new_n126_), .d(x46), .O(new_n265_));
  aoi21  g147(.a(new_n265_), .b(new_n263_), .c(new_n135_), .O(z26));
  inv1   g148(.a(new_n228_), .O(new_n268_));
  aoi21  g149(.a(x53), .b(new_n158_), .c(x50), .O(new_n269_));
  oai21  g150(.a(new_n269_), .b(new_n145_), .c(x52), .O(new_n270_));
  nand2  g151(.a(new_n173_), .b(new_n127_), .O(new_n271_));
  aoi21  g152(.a(new_n271_), .b(new_n270_), .c(new_n118_), .O(new_n272_));
  inv1   g153(.a(new_n173_), .O(new_n273_));
  nor2   g154(.a(new_n205_), .b(new_n273_), .O(new_n274_));
  oai21  g155(.a(new_n274_), .b(new_n272_), .c(x49), .O(new_n275_));
  nand3  g156(.a(new_n215_), .b(new_n246_), .c(new_n158_), .O(new_n276_));
  aoi21  g157(.a(new_n276_), .b(new_n275_), .c(new_n268_), .O(z28));
  nor2   g158(.a(new_n118_), .b(new_n116_), .O(new_n278_));
  nand4  g159(.a(new_n278_), .b(new_n228_), .c(x49), .d(x48), .O(new_n279_));
  nor2   g160(.a(new_n279_), .b(new_n164_), .O(z29));
  nand2  g161(.a(new_n264_), .b(x51), .O(new_n281_));
  nand4  g162(.a(new_n224_), .b(new_n133_), .c(new_n118_), .d(x49), .O(new_n282_));
  aoi21  g163(.a(new_n282_), .b(new_n281_), .c(new_n113_), .O(new_n283_));
  nand2  g164(.a(new_n264_), .b(new_n123_), .O(new_n284_));
  nand3  g165(.a(new_n160_), .b(new_n118_), .c(new_n113_), .O(new_n285_));
  aoi21  g166(.a(new_n284_), .b(new_n179_), .c(new_n285_), .O(new_n286_));
  oai21  g167(.a(new_n286_), .b(new_n283_), .c(new_n158_), .O(new_n287_));
  nand4  g168(.a(new_n172_), .b(new_n154_), .c(x48), .d(x46), .O(new_n288_));
  aoi21  g169(.a(new_n288_), .b(new_n287_), .c(x47), .O(z30));
  or2    g170(.a(new_n281_), .b(new_n194_), .O(new_n290_));
  nor2   g171(.a(new_n290_), .b(new_n163_), .O(z31));
  nor2   g172(.a(new_n279_), .b(new_n176_), .O(z33));
  nor2   g173(.a(x53), .b(x48), .O(new_n294_));
  xor2a  g174(.a(new_n294_), .b(x52), .O(new_n295_));
  nor4   g175(.a(new_n295_), .b(new_n268_), .c(new_n177_), .d(x51), .O(z34));
  nor2   g176(.a(new_n261_), .b(new_n259_), .O(z36));
  nor2   g177(.a(new_n261_), .b(new_n205_), .O(z37));
  inv1   g178(.a(x24), .O(new_n301_));
  aoi21  g179(.a(new_n159_), .b(new_n301_), .c(new_n131_), .O(new_n302_));
  nand2  g180(.a(new_n193_), .b(new_n185_), .O(new_n303_));
  nor3   g181(.a(new_n303_), .b(new_n302_), .c(new_n164_), .O(z39));
  nor2   g182(.a(new_n126_), .b(x48), .O(new_n305_));
  oai22  g183(.a(new_n305_), .b(new_n232_), .c(new_n208_), .d(x50), .O(new_n306_));
  nand2  g184(.a(new_n306_), .b(new_n118_), .O(new_n307_));
  nand2  g185(.a(x49), .b(x11), .O(new_n308_));
  oai21  g186(.a(new_n308_), .b(x53), .c(new_n118_), .O(new_n309_));
  nand3  g187(.a(new_n309_), .b(new_n228_), .c(new_n145_), .O(new_n310_));
  aoi21  g188(.a(new_n310_), .b(new_n307_), .c(x52), .O(z40));
  nor2   g189(.a(new_n290_), .b(new_n160_), .O(z42));
  nor2   g190(.a(new_n290_), .b(new_n164_), .O(z43));
  nand2  g191(.a(new_n136_), .b(x50), .O(new_n315_));
  nand2  g192(.a(new_n195_), .b(new_n116_), .O(new_n316_));
  aoi21  g193(.a(new_n316_), .b(new_n315_), .c(new_n303_), .O(z44));
  nor2   g194(.a(new_n279_), .b(new_n160_), .O(z46));
  nor3   g195(.a(new_n303_), .b(new_n224_), .c(new_n134_), .O(z47));
  zero   g196(.O(z00));
  zero   g197(.O(z01));
  zero   g198(.O(z02));
  zero   g199(.O(z03));
  ...
  zero   g215(.O(z48));
  zero   g216(.O(z49));
  nor2   g217(.a(new_n290_), .b(new_n163_), .O(z45));
endmodule
