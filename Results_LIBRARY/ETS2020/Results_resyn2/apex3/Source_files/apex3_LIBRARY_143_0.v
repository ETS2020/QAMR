...
module FAU ( 
  ...
  wire new_n113_, new_n114_, new_n115_, new_n116_, new_n117_, new_n118_,
    ...
    new_n257_, new_n259_, new_n262_, new_n265_, new_n266_, new_n268_,
  ...
  inv1   g067(.a(new_n168_), .O(new_n180_));
  nand2  g068(.a(new_n116_), .b(x49), .O(new_n181_));
  nand2  g069(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g070(.a(x50), .b(new_n115_), .O(new_n183_));
  aoi21  g071(.a(new_n183_), .b(new_n161_), .c(new_n113_), .O(new_n184_));
  aoi21  g072(.a(new_n184_), .b(new_n182_), .c(new_n179_), .O(new_n185_));
  ...
  nor2   g117(.a(new_n116_), .b(new_n114_), .O(new_n231_));
  nand4  g118(.a(new_n231_), .b(new_n127_), .c(x51), .d(new_n113_), .O(new_n232_));
  ...
  nor4   g132(.a(new_n181_), .b(new_n165_), .c(x51), .d(x48), .O(new_n247_));
  ...
  nand3  g137(.a(new_n136_), .b(new_n135_), .c(new_n159_), .O(new_n252_));
  nand4  g138(.a(new_n252_), .b(new_n251_), .c(new_n231_), .d(new_n249_), .O(new_n253_));
  ...
  inv1   g145(.a(new_n235_), .O(new_n262_));
  nor3   g146(.a(new_n262_), .b(new_n183_), .c(new_n172_), .O(z23));
  inv1   g147(.a(new_n181_), .O(new_n265_));
  nand2  g148(.a(new_n201_), .b(new_n265_), .O(new_n266_));
  aoi21  g149(.a(new_n197_), .b(new_n135_), .c(new_n266_), .O(z25));
  inv1   g150(.a(new_n183_), .O(new_n268_));
  nand3  g151(.a(new_n235_), .b(new_n268_), .c(x53), .O(new_n269_));
  nand4  g152(.a(new_n265_), .b(new_n155_), .c(new_n127_), .d(x46), .O(new_n270_));
  aoi21  g153(.a(new_n270_), .b(new_n269_), .c(new_n136_), .O(z26));
  nor4   g154(.a(new_n200_), .b(new_n144_), .c(x52), .d(x50), .O(z27));
  aoi21  g155(.a(x53), .b(new_n159_), .c(x50), .O(new_n273_));
  oai21  g156(.a(new_n273_), .b(new_n147_), .c(x52), .O(new_n274_));
  nand2  g157(.a(new_n174_), .b(new_n128_), .O(new_n275_));
  aoi21  g158(.a(new_n275_), .b(new_n274_), .c(new_n118_), .O(new_n276_));
  inv1   g159(.a(new_n174_), .O(new_n277_));
  nor2   g160(.a(new_n208_), .b(new_n277_), .O(new_n278_));
  oai21  g161(.a(new_n278_), .b(new_n276_), .c(x49), .O(new_n279_));
  nand3  g162(.a(new_n218_), .b(new_n268_), .c(new_n159_), .O(new_n280_));
  aoi21  g163(.a(new_n280_), .b(new_n279_), .c(new_n262_), .O(z28));
  nand3  g164(.a(new_n152_), .b(x51), .c(new_n113_), .O(new_n282_));
  nor2   g165(.a(new_n282_), .b(new_n165_), .O(z29));
  nand2  g166(.a(new_n265_), .b(x51), .O(new_n284_));
  nand4  g167(.a(new_n227_), .b(new_n134_), .c(new_n118_), .d(x49), .O(new_n285_));
  aoi21  g168(.a(new_n285_), .b(new_n284_), .c(new_n113_), .O(new_n286_));
  nand2  g169(.a(new_n265_), .b(new_n124_), .O(new_n287_));
  nand3  g170(.a(new_n161_), .b(new_n118_), .c(new_n113_), .O(new_n288_));
  aoi21  g171(.a(new_n287_), .b(new_n183_), .c(new_n288_), .O(new_n289_));
  oai21  g172(.a(new_n289_), .b(new_n286_), .c(new_n159_), .O(new_n290_));
  nand4  g173(.a(new_n173_), .b(new_n154_), .c(x48), .d(x46), .O(new_n291_));
  aoi21  g174(.a(new_n291_), .b(new_n290_), .c(x47), .O(z30));
  or2    g175(.a(new_n284_), .b(new_n196_), .O(new_n293_));
  nor2   g176(.a(new_n293_), .b(new_n164_), .O(z31));
  nor2   g177(.a(new_n282_), .b(new_n180_), .O(z33));
  nor2   g178(.a(x53), .b(x48), .O(new_n297_));
  xor2a  g179(.a(new_n297_), .b(x52), .O(new_n298_));
  nor4   g180(.a(new_n298_), .b(new_n262_), .c(new_n181_), .d(x51), .O(z34));
  nand2  g181(.a(new_n162_), .b(new_n121_), .O(new_n301_));
  nor2   g182(.a(new_n301_), .b(new_n256_), .O(z36));
  inv1   g183(.a(new_n121_), .O(new_n303_));
  nor2   g184(.a(new_n202_), .b(new_n303_), .O(z37));
  inv1   g185(.a(x24), .O(new_n306_));
  aoi21  g186(.a(new_n160_), .b(new_n306_), .c(new_n132_), .O(new_n307_));
  nand2  g187(.a(new_n195_), .b(new_n186_), .O(new_n308_));
  nor3   g188(.a(new_n308_), .b(new_n307_), .c(new_n165_), .O(z39));
  nor2   g189(.a(new_n127_), .b(x48), .O(new_n310_));
  oai22  g190(.a(new_n310_), .b(new_n236_), .c(new_n211_), .d(x50), .O(new_n311_));
  nand2  g191(.a(new_n311_), .b(new_n118_), .O(new_n312_));
  nand2  g192(.a(x49), .b(x11), .O(new_n313_));
  oai21  g193(.a(new_n313_), .b(x53), .c(new_n118_), .O(new_n314_));
  nand3  g194(.a(new_n314_), .b(new_n235_), .c(new_n147_), .O(new_n315_));
  aoi21  g195(.a(new_n315_), .b(new_n312_), .c(x52), .O(z40));
  nor2   g196(.a(new_n293_), .b(new_n161_), .O(z42));
  nor2   g197(.a(new_n293_), .b(new_n165_), .O(z43));
  nand2  g198(.a(new_n137_), .b(x50), .O(new_n320_));
  aoi21  g199(.a(new_n301_), .b(new_n320_), .c(new_n308_), .O(z44));
  nor2   g200(.a(new_n282_), .b(new_n161_), .O(z46));
  nor3   g201(.a(new_n200_), .b(new_n180_), .c(new_n117_), .O(z47));
  zero   g202(.O(z00));
  zero   g203(.O(z01));
  zero   g204(.O(z02));
  zero   g205(.O(z03));
  ...
  zero   g219(.O(z48));
  zero   g220(.O(z49));
  nor2   g221(.a(new_n293_), .b(new_n164_), .O(z45));
endmodule
