// Benchmark "FAU" written by ABC on Sat Jul 25 16:29:15 2020
...
module FAU ( 
  ...
  nand2  g173(.a(x38), .b(x37), .O(new_n251_));
  oai21  g174(.a(new_n106_), .b(x35), .c(x37), .O(new_n252_));
  nand2  g175(.a(new_n252_), .b(new_n251_), .O(new_n253_));
  oai21  g176(.a(new_n253_), .b(new_n250_), .c(x36), .O(new_n254_));
  oai21  g177(.a(new_n242_), .b(new_n238_), .c(new_n254_), .O(new_n255_));
  aoi21  g178(.a(new_n255_), .b(new_n117_), .c(x34), .O(new_n256_));
  inv1   g179(.a(new_n116_), .O(new_n257_));
  nand2  g180(.a(new_n87_), .b(x39), .O(new_n258_));
  nand3  g181(.a(new_n258_), .b(new_n257_), .c(new_n84_), .O(new_n259_));
  nand2  g182(.a(new_n87_), .b(x40), .O(new_n260_));
  nor2   g183(.a(new_n163_), .b(new_n116_), .O(new_n261_));
  inv1   g184(.a(new_n261_), .O(new_n262_));
  nand3  g185(.a(new_n262_), .b(new_n260_), .c(new_n96_), .O(new_n263_));
  nand2  g186(.a(new_n113_), .b(new_n81_), .O(new_n264_));
  aoi21  g187(.a(new_n263_), .b(new_n259_), .c(new_n264_), .O(new_n265_));
  oai21  g188(.a(new_n265_), .b(new_n256_), .c(new_n80_), .O(new_n266_));
  aoi21  g189(.a(new_n266_), .b(new_n78_), .c(new_n79_), .O(z02));
  inv1   g190(.a(x21), .O(new_n268_));
  inv1   g191(.a(x22), .O(new_n269_));
  nor2   g192(.a(new_n269_), .b(new_n268_), .O(new_n270_));
  oai21  g193(.a(new_n270_), .b(new_n173_), .c(x24), .O(new_n271_));
  nand2  g194(.a(new_n99_), .b(x37), .O(new_n272_));
  inv1   g195(.a(new_n272_), .O(new_n273_));
  nor3   g196(.a(new_n273_), .b(x39), .c(x38), .O(new_n274_));
  nand2  g197(.a(new_n274_), .b(new_n271_), .O(new_n275_));
  inv1   g198(.a(new_n213_), .O(new_n276_));
  aoi21  g199(.a(new_n99_), .b(new_n209_), .c(new_n268_), .O(new_n277_));
  nor2   g200(.a(x18), .b(x09), .O(new_n278_));
  nor2   g201(.a(new_n278_), .b(new_n99_), .O(new_n279_));
  oai21  g202(.a(new_n279_), .b(new_n277_), .c(new_n276_), .O(new_n280_));
  nand2  g203(.a(new_n280_), .b(new_n208_), .O(new_n281_));
  inv1   g204(.a(new_n92_), .O(new_n282_));
  nor2   g205(.a(new_n91_), .b(x05), .O(new_n283_));
  nand2  g206(.a(new_n283_), .b(new_n282_), .O(new_n284_));
  aoi21  g207(.a(new_n281_), .b(new_n275_), .c(new_n284_), .O(new_n285_));
  nand2  g208(.a(new_n165_), .b(x00), .O(new_n286_));
  nand2  g209(.a(new_n257_), .b(new_n83_), .O(new_n287_));
  aoi21  g210(.a(new_n287_), .b(new_n286_), .c(new_n95_), .O(new_n288_));
  nor2   g211(.a(new_n122_), .b(x34), .O(new_n289_));
  oai21  g212(.a(new_n288_), .b(new_n285_), .c(new_n289_), .O(new_n290_));
  inv1   g213(.a(new_n177_), .O(new_n291_));
  nor2   g214(.a(new_n92_), .b(x16), .O(new_n292_));
  aoi21  g215(.a(new_n159_), .b(new_n158_), .c(x09), .O(new_n293_));
  nor2   g216(.a(new_n239_), .b(x17), .O(new_n294_));
  oai21  g217(.a(new_n294_), .b(new_n293_), .c(new_n292_), .O(new_n295_));
  oai22  g218(.a(x17), .b(x16), .c(x12), .d(x11), .O(new_n296_));
  aoi21  g219(.a(new_n296_), .b(x40), .c(new_n148_), .O(new_n297_));
  oai21  g220(.a(x12), .b(x11), .c(x40), .O(new_n298_));
  nor2   g221(.a(new_n298_), .b(new_n149_), .O(new_n299_));
  nor2   g222(.a(new_n146_), .b(new_n158_), .O(new_n300_));
  ...
  nand2  g226(.a(new_n151_), .b(new_n282_), .O(new_n304_));
  aoi21  g227(.a(new_n304_), .b(new_n226_), .c(new_n140_), .O(new_n305_));
  inv1   g228(.a(x16), .O(new_n306_));
  inv1   g229(.a(x17), .O(new_n307_));
  aoi21  g230(.a(new_n156_), .b(new_n307_), .c(new_n306_), .O(new_n308_));
  oai22  g231(.a(new_n308_), .b(new_n157_), .c(new_n180_), .d(x17), .O(new_n309_));
  nor2   g232(.a(new_n92_), .b(x09), .O(new_n310_));
  aoi21  g233(.a(new_n310_), .b(new_n309_), .c(new_n305_), .O(new_n311_));
  aoi21  g234(.a(new_n311_), .b(new_n303_), .c(new_n91_), .O(new_n312_));
  inv1   g235(.a(x13), .O(new_n313_));
  nand3  g236(.a(new_n95_), .b(new_n91_), .c(x09), .O(new_n314_));
  oai21  g237(.a(new_n314_), .b(new_n164_), .c(new_n189_), .O(new_n315_));
  nand2  g238(.a(new_n315_), .b(new_n313_), .O(new_n316_));
  nand3  g239(.a(new_n222_), .b(new_n221_), .c(new_n219_), .O(new_n317_));
  nand2  g240(.a(new_n116_), .b(x38), .O(new_n318_));
  nand2  g241(.a(new_n163_), .b(new_n96_), .O(new_n319_));
  nand2  g242(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  nand2  g243(.a(new_n320_), .b(new_n317_), .O(new_n321_));
  nand2  g244(.a(x38), .b(new_n148_), .O(new_n322_));
  nor2   g245(.a(new_n322_), .b(new_n173_), .O(new_n323_));
  nor3   g246(.a(new_n317_), .b(new_n272_), .c(x38), .O(new_n324_));
  oai21  g247(.a(new_n324_), .b(new_n323_), .c(x39), .O(new_n325_));
  nand3  g248(.a(new_n325_), .b(new_n321_), .c(new_n316_), .O(new_n326_));
  oai21  g249(.a(new_n326_), .b(new_n312_), .c(new_n138_), .O(new_n327_));
  aoi21  g250(.a(new_n327_), .b(new_n291_), .c(x05), .O(new_n328_));
  inv1   g251(.a(new_n169_), .O(new_n329_));
  nor2   g252(.a(new_n158_), .b(x37), .O(new_n330_));
  nand3  g253(.a(new_n330_), .b(new_n193_), .c(new_n329_), .O(new_n331_));
  inv1   g254(.a(new_n331_), .O(new_n332_));
  nand2  g255(.a(new_n332_), .b(x40), .O(new_n333_));
  oai21  g256(.a(new_n333_), .b(new_n83_), .c(new_n112_), .O(new_n334_));
  ...
  nand2  g263(.a(new_n339_), .b(new_n107_), .O(new_n341_));
  nand4  g264(.a(new_n341_), .b(new_n340_), .c(new_n82_), .d(new_n95_), .O(new_n342_));
  inv1   g265(.a(new_n270_), .O(new_n343_));
  inv1   g266(.a(new_n298_), .O(new_n344_));
  nor2   g267(.a(new_n158_), .b(new_n95_), .O(new_n345_));
  nand4  g268(.a(new_n345_), .b(new_n344_), .c(new_n283_), .d(new_n343_), .O(new_n346_));
  nand2  g269(.a(new_n346_), .b(new_n342_), .O(new_n347_));
  nand3  g270(.a(new_n258_), .b(new_n84_), .c(new_n99_), .O(new_n348_));
  nand2  g271(.a(new_n207_), .b(new_n140_), .O(new_n349_));
  oai21  g272(.a(new_n99_), .b(x03), .c(new_n88_), .O(new_n350_));
  nand2  g273(.a(new_n350_), .b(new_n349_), .O(new_n351_));
  nand3  g274(.a(new_n351_), .b(new_n348_), .c(x34), .O(new_n352_));
  aoi21  g275(.a(new_n347_), .b(new_n83_), .c(new_n352_), .O(new_n353_));
  nor2   g276(.a(new_n353_), .b(x35), .O(new_n354_));
  oai21  g277(.a(new_n334_), .b(new_n328_), .c(new_n354_), .O(new_n355_));
  aoi21  g278(.a(new_n355_), .b(new_n290_), .c(x36), .O(new_n356_));
  nand2  g279(.a(new_n120_), .b(x39), .O(new_n357_));
  aoi21  g280(.a(new_n357_), .b(new_n95_), .c(x38), .O(new_n358_));
  inv1   g281(.a(new_n345_), .O(new_n359_));
  nand2  g282(.a(new_n180_), .b(new_n95_), .O(new_n360_));
  nand3  g283(.a(new_n360_), .b(new_n87_), .c(x00), .O(new_n361_));
  nand3  g284(.a(new_n361_), .b(new_n359_), .c(x40), .O(new_n362_));
  nand2  g285(.a(new_n84_), .b(new_n158_), .O(new_n363_));
  nor2   g286(.a(new_n345_), .b(x40), .O(new_n364_));
  oai21  g287(.a(new_n363_), .b(new_n244_), .c(new_n364_), .O(new_n365_));
  oai21  g288(.a(new_n362_), .b(new_n358_), .c(new_n365_), .O(new_n366_));
  nand2  g289(.a(new_n366_), .b(new_n122_), .O(new_n367_));
  nor2   g290(.a(new_n81_), .b(x34), .O(new_n368_));
  inv1   g291(.a(x02), .O(new_n369_));
  nor2   g292(.a(new_n83_), .b(x01), .O(new_n370_));
  nand2  g293(.a(new_n370_), .b(new_n338_), .O(new_n371_));
  aoi21  g294(.a(new_n371_), .b(new_n109_), .c(new_n369_), .O(new_n372_));
  nand2  g295(.a(new_n338_), .b(x01), .O(new_n373_));
  ...
  nand4  g306(.a(new_n383_), .b(new_n380_), .c(new_n319_), .d(x35), .O(new_n384_));
  nand3  g307(.a(new_n384_), .b(new_n368_), .c(new_n367_), .O(new_n385_));
  inv1   g308(.a(new_n336_), .O(new_n386_));
  nand2  g309(.a(new_n386_), .b(new_n337_), .O(new_n387_));
  ...
  oai21  g313(.a(new_n390_), .b(new_n356_), .c(new_n80_), .O(new_n391_));
  ...
  aoi21  g317(.a(new_n394_), .b(x40), .c(new_n359_), .O(new_n395_));
  nor3   g318(.a(new_n387_), .b(new_n261_), .c(x37), .O(new_n396_));
  ...
  aoi21  g330(.a(new_n407_), .b(new_n313_), .c(new_n93_), .O(new_n408_));
  oai21  g331(.a(new_n408_), .b(new_n406_), .c(new_n90_), .O(new_n409_));
  aoi21  g332(.a(new_n409_), .b(new_n272_), .c(x36), .O(new_n410_));
  ...
  aoi21  g341(.a(new_n272_), .b(new_n158_), .c(x36), .O(new_n419_));
  nand2  g342(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  aoi21  g343(.a(new_n387_), .b(x37), .c(new_n261_), .O(new_n421_));
  ...
  nand2  g346(.a(new_n273_), .b(new_n224_), .O(new_n424_));
  ...
  oai22  g351(.a(new_n317_), .b(x39), .c(new_n196_), .d(new_n153_), .O(new_n429_));
  ...
  oai22  g359(.a(new_n436_), .b(new_n158_), .c(new_n363_), .d(new_n245_), .O(new_n437_));
  ...
  inv1   g364(.a(new_n317_), .O(new_n444_));
  nand2  g365(.a(new_n320_), .b(new_n444_), .O(new_n445_));
  oai21  g366(.a(new_n226_), .b(new_n144_), .c(new_n445_), .O(new_n446_));
  nand2  g367(.a(new_n446_), .b(new_n229_), .O(new_n447_));
  nand2  g368(.a(new_n349_), .b(x21), .O(new_n448_));
  aoi21  g369(.a(new_n180_), .b(new_n95_), .c(new_n278_), .O(new_n449_));
  ...
  nor2   g381(.a(new_n460_), .b(new_n359_), .O(new_n461_));
  nand3  g382(.a(new_n461_), .b(new_n282_), .c(x22), .O(new_n462_));
  nor3   g383(.a(new_n462_), .b(new_n268_), .c(new_n91_), .O(new_n463_));
  ...
  nand4  g387(.a(new_n272_), .b(new_n466_), .c(new_n465_), .d(new_n113_), .O(new_n467_));
  aoi21  g388(.a(new_n467_), .b(new_n464_), .c(x36), .O(new_n468_));
  nand3  g389(.a(new_n262_), .b(x38), .c(x35), .O(new_n469_));
  or2    g390(.a(new_n357_), .b(new_n124_), .O(new_n470_));
  nand2  g391(.a(new_n368_), .b(new_n95_), .O(new_n471_));
  ...
  oai21  g399(.a(new_n478_), .b(new_n357_), .c(new_n477_), .O(new_n479_));
  ...
  nor2   g405(.a(new_n269_), .b(x21), .O(new_n485_));
  ...
  nor3   g423(.a(new_n491_), .b(new_n318_), .c(x35), .O(new_n504_));
  ...
  nand3  g429(.a(new_n344_), .b(new_n283_), .c(new_n270_), .O(new_n515_));
  nand2  g430(.a(new_n515_), .b(x37), .O(new_n516_));
  nand2  g431(.a(new_n387_), .b(new_n99_), .O(new_n517_));
  aoi21  g432(.a(new_n517_), .b(new_n516_), .c(new_n273_), .O(new_n518_));
  ...
  nand2  g438(.a(new_n258_), .b(new_n95_), .O(new_n524_));
  ...
  inv1   g444(.a(new_n330_), .O(new_n530_));
  ...
  oai21  g450(.a(new_n535_), .b(new_n225_), .c(new_n331_), .O(new_n536_));
  nand3  g451(.a(new_n534_), .b(new_n345_), .c(x09), .O(new_n537_));
  ...
  nand3  g458(.a(new_n543_), .b(new_n277_), .c(new_n276_), .O(new_n544_));
  ...
  nor2   g476(.a(new_n343_), .b(new_n561_), .O(new_n562_));
  ...
  nor2   g485(.a(new_n570_), .b(new_n252_), .O(new_n571_));
  nor2   g486(.a(new_n99_), .b(x11), .O(new_n572_));
  nand2  g487(.a(new_n330_), .b(new_n122_), .O(new_n573_));
  ...
  nand2  g498(.a(new_n583_), .b(new_n282_), .O(new_n584_));
  ...
  nor3   g510(.a(new_n251_), .b(new_n82_), .c(x06), .O(new_n598_));
  ...
  nand3  g535(.a(new_n402_), .b(new_n401_), .c(new_n268_), .O(new_n624_));
  aoi21  g536(.a(new_n624_), .b(new_n183_), .c(new_n487_), .O(new_n625_));
  oai21  g537(.a(new_n625_), .b(new_n623_), .c(new_n282_), .O(new_n626_));
  ...
  nand3  g545(.a(new_n633_), .b(new_n564_), .c(new_n282_), .O(new_n634_));
  aoi21  g546(.a(new_n634_), .b(new_n632_), .c(new_n91_), .O(new_n635_));
  aoi21  g547(.a(new_n534_), .b(x37), .c(x35), .O(new_n636_));
  nand2  g548(.a(new_n272_), .b(new_n90_), .O(new_n637_));
  ...
  nand3  g558(.a(new_n646_), .b(new_n272_), .c(new_n93_), .O(new_n647_));
  ...
  nand2  g572(.a(new_n660_), .b(new_n292_), .O(new_n661_));
  aoi21  g573(.a(new_n661_), .b(new_n301_), .c(new_n91_), .O(new_n662_));
  nand3  g574(.a(new_n91_), .b(new_n313_), .c(x09), .O(new_n663_));
  ...
  nand2  g580(.a(new_n257_), .b(new_n138_), .O(new_n669_));
  ...
  nand2  g585(.a(new_n673_), .b(new_n333_), .O(new_n674_));
  ...
  nor3   g592(.a(new_n679_), .b(new_n340_), .c(new_n81_), .O(new_n681_));
  ...
  oai21  g596(.a(new_n641_), .b(new_n257_), .c(new_n682_), .O(new_n685_));
  ...
  aoi21  g610(.a(new_n345_), .b(x40), .c(new_n112_), .O(new_n699_));
  nand4  g611(.a(new_n283_), .b(new_n141_), .c(new_n95_), .d(new_n138_), .O(new_n700_));
  nor2   g612(.a(new_n700_), .b(new_n628_), .O(new_n701_));
  oai21  g613(.a(new_n701_), .b(new_n699_), .c(x38), .O(new_n702_));
  oai21  g614(.a(new_n340_), .b(new_n141_), .c(x34), .O(new_n703_));
  aoi21  g615(.a(new_n679_), .b(new_n82_), .c(x37), .O(new_n704_));
  nand2  g616(.a(new_n704_), .b(new_n703_), .O(new_n705_));
  oai21  g617(.a(new_n350_), .b(x39), .c(x34), .O(new_n706_));
  ...
  oai21  g628(.a(new_n719_), .b(new_n270_), .c(x24), .O(new_n720_));
  nand2  g629(.a(new_n720_), .b(new_n274_), .O(new_n721_));
  aoi21  g630(.a(new_n721_), .b(new_n281_), .c(new_n122_), .O(new_n722_));
  ...
  nand2  g637(.a(new_n461_), .b(new_n343_), .O(new_n729_));
  aoi21  g638(.a(new_n729_), .b(new_n728_), .c(new_n184_), .O(new_n730_));
  nor4   g639(.a(new_n322_), .b(new_n622_), .c(new_n465_), .d(x34), .O(new_n731_));
  oai21  g640(.a(new_n731_), .b(new_n730_), .c(new_n432_), .O(new_n732_));
  nand4  g641(.a(new_n368_), .b(new_n199_), .c(new_n163_), .d(new_n83_), .O(new_n733_));
  ...
  nand3  g646(.a(new_n320_), .b(new_n229_), .c(new_n738_), .O(new_n739_));
  ...
  nand2  g651(.a(new_n272_), .b(new_n183_), .O(new_n745_));
  nor2   g652(.a(new_n95_), .b(x23), .O(new_n746_));
  nand4  g653(.a(new_n746_), .b(new_n485_), .c(new_n279_), .d(new_n483_), .O(new_n747_));
  aoi21  g654(.a(new_n747_), .b(new_n745_), .c(new_n179_), .O(new_n748_));
  nand3  g655(.a(new_n270_), .b(new_n99_), .c(new_n209_), .O(new_n749_));
  aoi21  g656(.a(new_n749_), .b(x24), .c(new_n207_), .O(new_n750_));
  oai21  g657(.a(new_n750_), .b(new_n748_), .c(new_n543_), .O(new_n751_));
  inv1   g658(.a(new_n339_), .O(new_n752_));
  nand4  g659(.a(new_n379_), .b(new_n370_), .c(new_n752_), .d(x36), .O(new_n753_));
  ...
  nor2   g663(.a(new_n601_), .b(new_n339_), .O(new_n757_));
