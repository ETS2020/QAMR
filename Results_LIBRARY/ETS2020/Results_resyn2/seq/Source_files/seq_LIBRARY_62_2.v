// Benchmark "FAU" written by ABC on Sat Jul 25 16:25:51 2020
...
module FAU ( 
  ...
  nand2  g1039(.a(new_n307_), .b(new_n225_), .O(new_n1122_));
  nor2   g1040(.a(new_n1122_), .b(new_n264_), .O(new_n1123_));
  nand2  g1041(.a(new_n152_), .b(new_n91_), .O(new_n1124_));
  nand3  g1042(.a(new_n307_), .b(new_n225_), .c(x40), .O(new_n1125_));
  aoi21  g1043(.a(new_n1125_), .b(new_n1124_), .c(new_n374_), .O(new_n1126_));
  oai21  g1044(.a(new_n1126_), .b(new_n1123_), .c(x09), .O(new_n1127_));
  inv1   g1045(.a(new_n226_), .O(new_n1128_));
  nand3  g1046(.a(new_n307_), .b(new_n313_), .c(new_n1128_), .O(new_n1129_));
  aoi21  g1047(.a(new_n1129_), .b(new_n1127_), .c(new_n178_), .O(new_n1130_));
  nor2   g1048(.a(new_n504_), .b(new_n174_), .O(new_n1131_));
  nor3   g1049(.a(new_n1131_), .b(new_n199_), .c(new_n92_), .O(new_n1132_));
  oai21  g1050(.a(new_n1132_), .b(new_n877_), .c(new_n84_), .O(new_n1133_));
  nand2  g1051(.a(new_n296_), .b(new_n242_), .O(new_n1134_));
  aoi21  g1052(.a(new_n808_), .b(new_n511_), .c(new_n633_), .O(new_n1135_));
  nand3  g1053(.a(new_n1135_), .b(new_n1134_), .c(new_n1133_), .O(new_n1136_));
  oai21  g1054(.a(new_n1136_), .b(new_n1130_), .c(new_n601_), .O(new_n1137_));
  nand3  g1055(.a(new_n706_), .b(new_n460_), .c(x39), .O(new_n1138_));
  inv1   g1056(.a(new_n1138_), .O(new_n1139_));
  oai21  g1057(.a(new_n1139_), .b(new_n397_), .c(new_n84_), .O(new_n1140_));
  nand2  g1058(.a(new_n1140_), .b(new_n107_), .O(new_n1141_));
  aoi21  g1059(.a(new_n1141_), .b(x36), .c(x35), .O(new_n1142_));
  nand2  g1060(.a(new_n1142_), .b(new_n1137_), .O(new_n1143_));
  nand3  g1061(.a(new_n1056_), .b(new_n201_), .c(new_n158_), .O(new_n1144_));
  oai21  g1062(.a(new_n292_), .b(new_n156_), .c(new_n1144_), .O(new_n1145_));
  nand2  g1063(.a(new_n1145_), .b(new_n636_), .O(new_n1146_));
  oai21  g1064(.a(new_n663_), .b(new_n201_), .c(new_n215_), .O(new_n1147_));
  aoi21  g1065(.a(new_n1147_), .b(new_n1146_), .c(new_n816_), .O(new_n1148_));
  oai21  g1066(.a(new_n341_), .b(new_n914_), .c(new_n297_), .O(new_n1149_));
  nand2  g1067(.a(new_n1149_), .b(x36), .O(new_n1150_));
  nand3  g1068(.a(new_n1150_), .b(new_n695_), .c(new_n84_), .O(new_n1151_));
  nor2   g1069(.a(new_n527_), .b(new_n215_), .O(new_n1152_));
  nor4   g1070(.a(new_n1152_), .b(new_n816_), .c(new_n320_), .d(new_n244_), .O(new_n1153_));
  nor2   g1071(.a(new_n663_), .b(new_n87_), .O(new_n1154_));
  nand2  g1072(.a(new_n114_), .b(new_n87_), .O(new_n1155_));
  nand4  g1073(.a(new_n1155_), .b(new_n703_), .c(x04), .d(x00), .O(new_n1156_));
  oai22  g1074(.a(new_n1156_), .b(new_n1154_), .c(new_n851_), .d(new_n459_), .O(new_n1157_));
  nand2  g1075(.a(new_n1157_), .b(x36), .O(new_n1158_));
  nand2  g1076(.a(new_n1158_), .b(x37), .O(new_n1159_));
  oai22  g1077(.a(new_n1159_), .b(new_n1153_), .c(new_n1151_), .d(new_n1148_), .O(new_n1160_));
  aoi21  g1078(.a(new_n1160_), .b(x35), .c(x34), .O(new_n1161_));
  aoi21  g1079(.a(new_n623_), .b(x37), .c(new_n210_), .O(new_n1162_));
  nand2  g1080(.a(new_n847_), .b(new_n114_), .O(new_n1163_));
  oai21  g1081(.a(new_n84_), .b(new_n914_), .c(x39), .O(new_n1164_));
  nand2  g1082(.a(new_n1164_), .b(new_n240_), .O(new_n1165_));
  aoi21  g1083(.a(new_n1165_), .b(x38), .c(new_n359_), .O(new_n1166_));
  oai21  g1084(.a(new_n1163_), .b(new_n1162_), .c(new_n1166_), .O(new_n1167_));
  nand2  g1085(.a(new_n1167_), .b(new_n77_), .O(new_n1168_));
  aoi21  g1086(.a(new_n1161_), .b(new_n1143_), .c(new_n1168_), .O(new_n1169_));
  nand2  g1087(.a(x33), .b(new_n78_), .O(new_n1170_));
  oai22  g1088(.a(new_n1170_), .b(new_n1169_), .c(new_n771_), .d(new_n78_), .O(z33));
  nand2  g1089(.a(new_n703_), .b(new_n211_), .O(new_n1172_));
  nand2  g1090(.a(x34), .b(x04), .O(new_n1173_));
  oai21  g1091(.a(new_n1173_), .b(new_n1172_), .c(new_n684_), .O(new_n1174_));
  aoi22  g1092(.a(new_n1174_), .b(new_n740_), .c(new_n883_), .d(new_n126_), .O(new_n1175_));
  nand2  g1093(.a(new_n860_), .b(new_n832_), .O(new_n1176_));
  nand3  g1094(.a(new_n1176_), .b(new_n511_), .c(x34), .O(new_n1177_));
  oai21  g1095(.a(new_n1175_), .b(x38), .c(new_n1177_), .O(new_n1178_));
  nand2  g1096(.a(new_n1178_), .b(new_n841_), .O(new_n1179_));
  nand2  g1097(.a(new_n849_), .b(x35), .O(new_n1180_));
  oai21  g1098(.a(new_n291_), .b(new_n347_), .c(new_n820_), .O(new_n1181_));
  nand2  g1099(.a(new_n1181_), .b(new_n82_), .O(new_n1182_));
  aoi21  g1100(.a(new_n1182_), .b(new_n1180_), .c(new_n268_), .O(new_n1183_));
  nand2  g1101(.a(new_n1006_), .b(x06), .O(new_n1184_));
  inv1   g1102(.a(new_n1184_), .O(new_n1185_));
  aoi21  g1103(.a(new_n704_), .b(x40), .c(x35), .O(new_n1186_));
  oai21  g1104(.a(new_n1186_), .b(new_n1185_), .c(x36), .O(new_n1187_));
  aoi21  g1105(.a(new_n235_), .b(new_n145_), .c(new_n306_), .O(new_n1188_));
  oai22  g1106(.a(new_n1188_), .b(new_n984_), .c(new_n236_), .d(new_n153_), .O(new_n1189_));
  nor3   g1107(.a(new_n974_), .b(new_n236_), .c(x40), .O(new_n1190_));
  aoi21  g1108(.a(new_n1189_), .b(x15), .c(new_n1190_), .O(new_n1191_));
  oai21  g1109(.a(new_n1191_), .b(new_n1048_), .c(new_n1187_), .O(new_n1192_));
  aoi21  g1110(.a(new_n1192_), .b(new_n84_), .c(new_n1183_), .O(new_n1193_));
  nor2   g1111(.a(new_n1180_), .b(new_n459_), .O(new_n1194_));
  nor2   g1112(.a(new_n340_), .b(new_n268_), .O(new_n1195_));
  aoi21  g1113(.a(new_n1043_), .b(new_n605_), .c(new_n879_), .O(new_n1196_));
  oai21  g1114(.a(new_n1196_), .b(new_n1195_), .c(new_n80_), .O(new_n1197_));
  nand3  g1115(.a(new_n344_), .b(new_n646_), .c(x11), .O(new_n1198_));
  nand2  g1116(.a(new_n1198_), .b(new_n1197_), .O(new_n1199_));
  aoi21  g1117(.a(new_n1199_), .b(new_n83_), .c(new_n1194_), .O(new_n1200_));
  oai21  g1118(.a(new_n1193_), .b(new_n114_), .c(new_n1200_), .O(new_n1201_));
  nand2  g1119(.a(new_n469_), .b(new_n147_), .O(new_n1202_));
  aoi21  g1120(.a(new_n1202_), .b(new_n794_), .c(new_n1172_), .O(new_n1203_));
  aoi21  g1121(.a(new_n188_), .b(new_n83_), .c(new_n684_), .O(new_n1204_));
  oai21  g1122(.a(new_n1204_), .b(new_n1203_), .c(x38), .O(new_n1205_));
  nor2   g1123(.a(new_n1022_), .b(new_n111_), .O(new_n1206_));
  oai21  g1124(.a(x40), .b(x35), .c(new_n1184_), .O(new_n1207_));
  oai21  g1125(.a(new_n1207_), .b(new_n1206_), .c(new_n184_), .O(new_n1208_));
  aoi21  g1126(.a(new_n1208_), .b(new_n1205_), .c(new_n80_), .O(new_n1209_));
  nand3  g1127(.a(new_n895_), .b(new_n235_), .c(new_n114_), .O(new_n1210_));
  aoi21  g1128(.a(new_n1210_), .b(new_n916_), .c(new_n1048_), .O(new_n1211_));
  oai21  g1129(.a(new_n1211_), .b(new_n1209_), .c(x37), .O(new_n1212_));
  oai21  g1130(.a(new_n1006_), .b(new_n84_), .c(new_n952_), .O(new_n1213_));
  nand3  g1131(.a(new_n254_), .b(x38), .c(x35), .O(new_n1214_));
  aoi21  g1132(.a(new_n1214_), .b(new_n1213_), .c(x39), .O(new_n1215_));
  oai21  g1133(.a(new_n881_), .b(new_n287_), .c(x05), .O(new_n1216_));
  nand2  g1134(.a(new_n459_), .b(new_n288_), .O(new_n1217_));
  nand3  g1135(.a(new_n1217_), .b(new_n235_), .c(new_n242_), .O(new_n1218_));
  aoi21  g1136(.a(new_n1218_), .b(new_n1216_), .c(x35), .O(new_n1219_));
  oai21  g1137(.a(new_n1219_), .b(new_n1215_), .c(new_n80_), .O(new_n1220_));
  nand2  g1138(.a(new_n1220_), .b(new_n1212_), .O(new_n1221_));
  aoi21  g1139(.a(new_n1201_), .b(x39), .c(new_n1221_), .O(new_n1222_));
  oai21  g1140(.a(new_n1222_), .b(x34), .c(new_n1179_), .O(new_n1223_));
  nand2  g1141(.a(new_n1223_), .b(new_n78_), .O(new_n1224_));
  aoi21  g1142(.a(new_n1224_), .b(new_n77_), .c(new_n281_), .O(z34));
  zero   g1143(.O(z03));
  zero   g1144(.O(z09));
  zero   g1145(.O(z15));
  zero   g1146(.O(z27));
