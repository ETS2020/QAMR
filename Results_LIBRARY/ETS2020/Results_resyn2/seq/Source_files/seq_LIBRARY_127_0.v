// Benchmark "FAU" written by ABC on Sat Jul 25 16:27:10 2020
...
module FAU ( 
  ...
  wire new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_,
    ...
    new_n753_, new_n754_, new_n755_, new_n757_;
  ...
  inv1   g663(.a(new_n289_), .O(new_n757_));
  nor4   g664(.a(new_n511_), .b(new_n757_), .c(new_n144_), .d(new_n142_), .O(z32));
  zero   g665(.O(z00));
  zero   g666(.O(z05));
  zero   g667(.O(z06));
  zero   g668(.O(z12));
