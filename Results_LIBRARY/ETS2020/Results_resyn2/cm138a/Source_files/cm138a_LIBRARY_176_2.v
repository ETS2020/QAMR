// Benchmark "FAU" written by ABC on Fri Jul 24 20:55:26 2020
...
module FAU ( 
  ...
  nor2   g10(.a(new_n25_), .b(new_n21_), .O(new_n26_));
  ...
  nor2   g14(.a(new_n15_), .b(new_n25_), .O(new_n30_));
  nand4  g15(.a(new_n30_), .b(new_n18_), .c(new_n16_), .d(new_n21_), .O(z6));
  nand4  g16(.a(new_n30_), .b(new_n18_), .c(new_n16_), .d(x0), .O(z7));
  zero   g17(.O(z2));
endmodule
