// Benchmark "FAU" written by ABC on Fri Jul 24 20:55:22 2020
...
module FAU ( 
  ...
  nand4  g14(.a(new_n25_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g15(.a(new_n24_), .b(new_n21_), .O(new_n31_));
  nand4  g16(.a(new_n31_), .b(new_n18_), .c(new_n16_), .d(x2), .O(z7));
  zero   g17(.O(z3));
endmodule
