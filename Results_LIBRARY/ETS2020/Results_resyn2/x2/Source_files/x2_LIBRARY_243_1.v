// Benchmark "FAU" written by ABC on Fri Jul 24 21:06:03 2020
...
module FAU ( 
  ...
  nand2  g04(.a(new_n18_), .b(new_n22_), .O(new_n23_));
  ...
  nand2  g10(.a(new_n19_), .b(new_n22_), .O(new_n29_));
  or2    g11(.a(new_n29_), .b(new_n28_), .O(z3));
  nand2  g12(.a(x9), .b(x8), .O(new_n31_));
  nand3  g13(.a(new_n31_), .b(x7), .c(x6), .O(z4));
  oai21  g14(.a(new_n31_), .b(new_n22_), .c(new_n23_), .O(new_n33_));
  nand4  g15(.a(new_n33_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n34_));
  inv1   g16(.a(x9), .O(new_n35_));
  inv1   g17(.a(x4), .O(new_n36_));
  nand3  g18(.a(x7), .b(new_n36_), .c(x3), .O(new_n37_));
  nand2  g19(.a(new_n37_), .b(x8), .O(new_n38_));
  nand2  g20(.a(new_n38_), .b(new_n35_), .O(new_n39_));
  ...
  nand3  g25(.a(new_n43_), .b(new_n39_), .c(new_n34_), .O(z5));
  aoi21  g26(.a(new_n28_), .b(x8), .c(new_n35_), .O(new_n45_));
  nand4  g27(.a(new_n35_), .b(x8), .c(x4), .d(x3), .O(new_n46_));
