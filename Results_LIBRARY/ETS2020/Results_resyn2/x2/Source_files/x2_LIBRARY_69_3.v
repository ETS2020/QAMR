...
module FAU ( 
  ...
  and2   g04(.a(x9), .b(x7), .O(new_n22_));
  oai21  g05(.a(new_n22_), .b(new_n21_), .c(new_n20_), .O(z1));
  nor3   g06(.a(x9), .b(x8), .c(x7), .O(z2));
  inv1   g07(.a(x2), .O(new_n25_));
  nor2   g08(.a(x1), .b(x0), .O(new_n26_));
  nand4  g09(.a(new_n26_), .b(new_n21_), .c(x8), .d(new_n25_), .O(z3));
  ...
  aoi21  g23(.a(new_n40_), .b(new_n28_), .c(new_n38_), .O(new_n41_));
