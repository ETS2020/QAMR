...
module FAU ( 
  ...
  nand4  g15(.a(new_n34_), .b(x2), .c(new_n27_), .d(new_n26_), .O(new_n35_));
  inv1   g16(.a(x4), .O(new_n36_));
  nand3  g17(.a(x7), .b(new_n36_), .c(x3), .O(new_n37_));
  nand2  g18(.a(new_n37_), .b(x8), .O(new_n38_));
  nand2  g19(.a(new_n38_), .b(new_n25_), .O(new_n39_));
  inv1   g20(.a(x6), .O(new_n40_));
  nand3  g21(.a(x9), .b(x8), .c(x5), .O(new_n41_));
  inv1   g22(.a(new_n41_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n22_), .c(new_n40_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n39_), .c(new_n35_), .O(z5));
  aoi21  g25(.a(new_n29_), .b(x8), .c(new_n25_), .O(new_n45_));
  nand4  g26(.a(new_n25_), .b(x8), .c(x4), .d(x3), .O(new_n46_));
  inv1   g27(.a(new_n46_), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n45_), .c(x7), .O(new_n48_));
  oai21  g29(.a(x9), .b(x8), .c(new_n41_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n22_), .c(new_n40_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n48_), .O(z6));
  zero   g32(.O(z0));
  zero   g33(.O(z4));
endmodule
