...
module FAU ( 
  ...
  nand4  g48(.a(new_n100_), .b(new_n91_), .c(new_n99_), .d(new_n48_), .O(new_n101_));
  nand2  g49(.a(new_n100_), .b(new_n91_), .O(new_n102_));
  oai21  g50(.a(new_n102_), .b(new_n80_), .c(x25), .O(new_n103_));
  nand3  g51(.a(new_n103_), .b(new_n101_), .c(new_n83_), .O(z18));
  zero   g52(.O(z02));
  zero   g53(.O(z08));
  zero   g54(.O(z09));
  zero   g55(.O(z10));
