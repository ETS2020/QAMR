...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n73_, new_n74_, new_n75_,
  ...
  inv1   g24(.a(x07), .O(new_n73_));
  inv1   g25(.a(x15), .O(new_n74_));
  nand2  g26(.a(x05), .b(x04), .O(new_n75_));
  nand4  g27(.a(new_n75_), .b(new_n50_), .c(new_n74_), .d(new_n73_), .O(new_n76_));
  inv1   g28(.a(new_n76_), .O(z10));
  nand3  g29(.a(x19), .b(x18), .c(x17), .O(new_n80_));
  nand2  g30(.a(new_n80_), .b(x20), .O(new_n81_));
  nand4  g31(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n82_));
  nand2  g32(.a(new_n58_), .b(new_n74_), .O(new_n83_));
  inv1   g33(.a(new_n83_), .O(new_n84_));
  nand3  g34(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z13));
  inv1   g35(.a(new_n80_), .O(new_n86_));
  nor2   g36(.a(x21), .b(x20), .O(new_n87_));
  nand2  g37(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g38(.a(new_n82_), .b(x21), .O(new_n89_));
  ...
  inv1   g49(.a(new_n82_), .O(new_n100_));
