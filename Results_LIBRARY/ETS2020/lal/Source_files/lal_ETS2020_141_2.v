// Benchmark "FAU" written by ABC on Tue Jun 23 16:23:53 2020
...
module FAU ( 
  ...
  inv1   g51(.a(new_n62_), .O(new_n100_));
  nor2   g52(.a(new_n100_), .b(x15), .O(new_n101_));
  nand4  g53(.a(new_n101_), .b(new_n99_), .c(new_n88_), .d(new_n86_), .O(z13));
  nand2  g54(.a(new_n63_), .b(new_n61_), .O(new_n103_));
  nand3  g55(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n104_));
  aoi21  g56(.a(new_n62_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g57(.a(new_n103_), .b(new_n98_), .c(new_n105_), .O(z14));
  inv1   g58(.a(new_n104_), .O(new_n107_));
  oai21  g59(.a(new_n103_), .b(new_n98_), .c(x22), .O(new_n108_));
  inv1   g60(.a(new_n98_), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n69_), .c(new_n61_), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(z15));
  nand2  g63(.a(new_n69_), .b(new_n61_), .O(new_n112_));
  oai21  g64(.a(new_n112_), .b(new_n98_), .c(x23), .O(new_n113_));
  nand4  g65(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n61_), .O(new_n114_));
  ...
  oai21  g69(.a(new_n114_), .b(new_n98_), .c(x24), .O(new_n118_));
  nor2   g70(.a(new_n92_), .b(new_n68_), .O(new_n119_));
  nand2  g71(.a(new_n119_), .b(new_n118_), .O(z17));
  nand4  g72(.a(new_n81_), .b(new_n69_), .c(new_n100_), .d(new_n65_), .O(new_n121_));
  oai21  g73(.a(new_n67_), .b(new_n62_), .c(x25), .O(new_n122_));
  nand3  g74(.a(new_n122_), .b(new_n121_), .c(new_n107_), .O(z18));
  zero   g75(.O(z01));
  zero   g76(.O(z03));
  zero   g77(.O(z09));
  buf    g78(.a(x16), .O(z02));
