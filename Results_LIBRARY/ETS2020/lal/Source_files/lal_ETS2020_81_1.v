// Benchmark "FAU" written by ABC on Tue Jun 23 16:22:58 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n69_, new_n73_, new_n74_,
    new_n75_, new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n86_,
  ...
  inv1   g26(.a(x07), .O(new_n73_));
  inv1   g27(.a(x15), .O(new_n74_));
  nand4  g28(.a(new_n74_), .b(new_n73_), .c(x05), .d(x04), .O(new_n75_));
  inv1   g29(.a(new_n75_), .O(z09));
  nand3  g30(.a(x19), .b(x18), .c(x17), .O(new_n80_));
  nand2  g31(.a(new_n80_), .b(x20), .O(new_n81_));
  nand4  g32(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n82_));
  nand2  g33(.a(new_n58_), .b(new_n74_), .O(new_n83_));
  inv1   g34(.a(new_n83_), .O(new_n84_));
  nand3  g35(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z13));
  inv1   g36(.a(new_n80_), .O(new_n86_));
  nor2   g37(.a(x21), .b(x20), .O(new_n87_));
  nand2  g38(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g39(.a(new_n82_), .b(x21), .O(new_n89_));
  nand3  g40(.a(new_n89_), .b(new_n88_), .c(new_n84_), .O(z14));
  nand2  g41(.a(new_n88_), .b(x22), .O(new_n91_));
  nor2   g42(.a(x22), .b(x21), .O(new_n92_));
  nand3  g43(.a(new_n92_), .b(new_n86_), .c(new_n49_), .O(new_n93_));
  nand3  g44(.a(new_n93_), .b(new_n91_), .c(new_n84_), .O(z15));
  nand2  g45(.a(new_n93_), .b(x23), .O(new_n95_));
  nor2   g46(.a(x23), .b(x22), .O(new_n96_));
  nand3  g47(.a(new_n96_), .b(new_n87_), .c(new_n86_), .O(new_n97_));
  nand3  g48(.a(new_n97_), .b(new_n95_), .c(new_n84_), .O(z16));
  nand2  g49(.a(new_n97_), .b(x24), .O(new_n99_));
  inv1   g50(.a(new_n82_), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand3  g52(.a(new_n101_), .b(new_n92_), .c(new_n100_), .O(new_n102_));
  nand3  g53(.a(new_n102_), .b(new_n99_), .c(new_n84_), .O(z17));
  nand4  g54(.a(new_n101_), .b(new_n92_), .c(new_n100_), .d(new_n48_), .O(new_n104_));
  nand2  g55(.a(new_n102_), .b(x25), .O(new_n105_));
  nand3  g56(.a(new_n105_), .b(new_n104_), .c(new_n84_), .O(z18));
  zero   g57(.O(z08));
  zero   g58(.O(z10));
  zero   g59(.O(z11));
  zero   g60(.O(z12));
