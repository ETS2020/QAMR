...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n64_, new_n65_, new_n66_, new_n67_, new_n72_, new_n73_, new_n75_,
    new_n77_, new_n78_, new_n80_, new_n81_, new_n82_, new_n89_, new_n90_,
  ...
  nor2   g23(.a(x15), .b(x07), .O(new_n72_));
  nand2  g24(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  inv1   g25(.a(new_n73_), .O(z09));
  nand3  g26(.a(new_n72_), .b(new_n57_), .c(new_n49_), .O(new_n75_));
  inv1   g27(.a(new_n75_), .O(z10));
  xnor2a g28(.a(x18), .b(x17), .O(new_n77_));
  nand2  g29(.a(new_n72_), .b(new_n57_), .O(new_n78_));
  nor2   g30(.a(new_n78_), .b(new_n77_), .O(z11));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x19), .O(new_n80_));
  nor2   g32(.a(new_n50_), .b(new_n49_), .O(new_n81_));
  nand2  g33(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  aoi21  g34(.a(new_n82_), .b(new_n80_), .c(new_n78_), .O(z12));
  nand3  g35(.a(new_n81_), .b(new_n48_), .c(x19), .O(new_n89_));
  inv1   g36(.a(new_n89_), .O(new_n90_));
  nor2   g37(.a(x22), .b(x21), .O(new_n91_));
  nor2   g38(.a(x24), .b(x23), .O(new_n92_));
  nand4  g39(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n47_), .O(new_n93_));
  nand2  g40(.a(new_n92_), .b(new_n91_), .O(new_n94_));
  oai21  g41(.a(new_n94_), .b(new_n89_), .c(x25), .O(new_n95_));
  nand4  g42(.a(new_n95_), .b(new_n93_), .c(new_n72_), .d(new_n57_), .O(z18));
  zero   g43(.O(z00));
  zero   g44(.O(z06));
  zero   g45(.O(z07));
  zero   g46(.O(z13));
