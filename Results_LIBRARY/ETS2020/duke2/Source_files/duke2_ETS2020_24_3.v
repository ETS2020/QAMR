// Benchmark "FAU" written by ABC on Tue Jun 23 03:49:27 2020
...
module FAU ( 
  ...
  nand2  g240(.a(new_n69_), .b(x17), .O(new_n293_));
  inv1   g241(.a(new_n293_), .O(new_n294_));
  oai21  g242(.a(new_n53_), .b(new_n52_), .c(new_n294_), .O(new_n295_));
  inv1   g243(.a(new_n295_), .O(z13));
  inv1   g244(.a(new_n156_), .O(new_n297_));
  nand3  g245(.a(new_n97_), .b(new_n52_), .c(new_n75_), .O(new_n298_));
  oai21  g246(.a(new_n283_), .b(new_n282_), .c(new_n298_), .O(new_n299_));
  aoi21  g247(.a(x21), .b(new_n72_), .c(x07), .O(new_n300_));
  nand2  g248(.a(new_n300_), .b(new_n299_), .O(new_n301_));
  nand3  g249(.a(new_n162_), .b(new_n118_), .c(x07), .O(new_n302_));
  aoi21  g250(.a(new_n302_), .b(new_n301_), .c(new_n297_), .O(new_n303_));
  nor2   g251(.a(x21), .b(x15), .O(new_n304_));
  nand4  g252(.a(new_n304_), .b(new_n66_), .c(new_n234_), .d(x04), .O(new_n305_));
  nor3   g253(.a(x18), .b(x09), .c(x05), .O(new_n306_));
  inv1   g254(.a(new_n306_), .O(new_n307_));
  aoi21  g255(.a(new_n305_), .b(new_n57_), .c(new_n307_), .O(new_n308_));
  oai21  g256(.a(new_n308_), .b(new_n303_), .c(new_n159_), .O(new_n309_));
  aoi21  g257(.a(new_n54_), .b(new_n53_), .c(new_n159_), .O(new_n310_));
  nor2   g258(.a(new_n53_), .b(x01), .O(new_n311_));
  oai21  g259(.a(new_n311_), .b(new_n310_), .c(new_n306_), .O(new_n312_));
  nand2  g260(.a(new_n312_), .b(new_n309_), .O(z14));
  nor2   g261(.a(x07), .b(new_n52_), .O(new_n314_));
  inv1   g262(.a(new_n314_), .O(new_n315_));
  nand3  g263(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n316_));
  nor2   g264(.a(new_n316_), .b(new_n315_), .O(z15));
  nand2  g265(.a(new_n156_), .b(new_n159_), .O(new_n318_));
  oai21  g266(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n319_));
  nor2   g267(.a(x16), .b(new_n65_), .O(new_n320_));
  oai21  g268(.a(new_n74_), .b(new_n87_), .c(new_n320_), .O(new_n321_));
  aoi21  g269(.a(new_n321_), .b(new_n319_), .c(new_n80_), .O(new_n322_));
  inv1   g270(.a(new_n74_), .O(new_n323_));
  nand3  g271(.a(x16), .b(x12), .c(new_n80_), .O(new_n324_));
  aoi22  g272(.a(new_n324_), .b(new_n84_), .c(new_n323_), .d(x13), .O(new_n325_));
  nor3   g273(.a(x21), .b(x14), .c(x09), .O(new_n326_));
  oai21  g274(.a(new_n325_), .b(new_n322_), .c(new_n326_), .O(new_n327_));
  nand2  g275(.a(new_n118_), .b(x09), .O(new_n328_));
  nand2  g276(.a(new_n54_), .b(new_n53_), .O(new_n329_));
  aoi21  g277(.a(new_n328_), .b(new_n327_), .c(new_n329_), .O(new_n330_));
  nand2  g278(.a(x15), .b(x09), .O(new_n331_));
  aoi21  g279(.a(new_n53_), .b(x02), .c(new_n331_), .O(new_n332_));
  oai21  g280(.a(new_n332_), .b(new_n330_), .c(new_n52_), .O(new_n333_));
  inv1   g281(.a(new_n66_), .O(new_n334_));
  nand3  g282(.a(new_n160_), .b(new_n334_), .c(x09), .O(new_n335_));
  aoi21  g283(.a(new_n335_), .b(new_n333_), .c(new_n318_), .O(z16));
  inv1   g284(.a(new_n219_), .O(new_n337_));
  inv1   g285(.a(new_n169_), .O(new_n338_));
  inv1   g286(.a(new_n76_), .O(new_n339_));
  nand2  g287(.a(new_n176_), .b(new_n80_), .O(new_n340_));
  oai21  g288(.a(new_n339_), .b(new_n80_), .c(new_n340_), .O(new_n341_));
  nand3  g289(.a(new_n341_), .b(new_n338_), .c(new_n79_), .O(new_n342_));
  aoi21  g290(.a(new_n342_), .b(new_n216_), .c(x07), .O(new_n343_));
  oai21  g291(.a(new_n343_), .b(new_n337_), .c(new_n52_), .O(new_n344_));
  nand4  g292(.a(new_n223_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n345_));
  aoi21  g293(.a(new_n345_), .b(new_n344_), .c(x09), .O(z17));
  nand3  g294(.a(x21), .b(new_n86_), .c(new_n62_), .O(new_n347_));
  nor2   g295(.a(new_n83_), .b(new_n86_), .O(new_n348_));
  inv1   g296(.a(new_n348_), .O(new_n349_));
  oai21  g297(.a(new_n349_), .b(new_n183_), .c(new_n347_), .O(new_n350_));
  nand2  g298(.a(new_n350_), .b(new_n80_), .O(new_n351_));
  inv1   g299(.a(new_n191_), .O(new_n352_));
  nand3  g300(.a(new_n348_), .b(new_n352_), .c(x06), .O(new_n353_));
  aoi21  g301(.a(new_n353_), .b(new_n351_), .c(new_n65_), .O(new_n354_));
  oai21  g302(.a(new_n354_), .b(new_n189_), .c(new_n67_), .O(new_n355_));
  nand3  g303(.a(x19), .b(x15), .c(new_n86_), .O(new_n356_));
  nor2   g304(.a(x17), .b(x09), .O(new_n357_));
  nand3  g305(.a(new_n357_), .b(new_n150_), .c(x18), .O(new_n358_));
  aoi21  g306(.a(new_n356_), .b(new_n355_), .c(new_n358_), .O(z18));
  inv1   g307(.a(new_n150_), .O(new_n360_));
  nor2   g308(.a(new_n316_), .b(new_n360_), .O(z19));
  inv1   g309(.a(new_n281_), .O(new_n362_));
  nand2  g310(.a(new_n348_), .b(new_n234_), .O(new_n363_));
  oai21  g311(.a(new_n363_), .b(new_n199_), .c(new_n236_), .O(new_n364_));
  aoi21  g312(.a(new_n364_), .b(new_n52_), .c(new_n130_), .O(new_n365_));
  nand2  g313(.a(new_n177_), .b(new_n54_), .O(new_n366_));
  oai21  g314(.a(new_n366_), .b(new_n365_), .c(new_n362_), .O(new_n367_));
  nor4   g315(.a(new_n236_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n368_));
  aoi21  g316(.a(new_n367_), .b(new_n143_), .c(new_n368_), .O(new_n369_));
  nor2   g317(.a(new_n65_), .b(x05), .O(new_n370_));
  nand4  g318(.a(new_n370_), .b(new_n261_), .c(new_n67_), .d(x04), .O(new_n371_));
  oai21  g319(.a(new_n369_), .b(new_n99_), .c(new_n371_), .O(new_n372_));
  nand2  g320(.a(new_n372_), .b(new_n72_), .O(new_n373_));
  nor2   g321(.a(new_n99_), .b(x15), .O(new_n374_));
  nand4  g322(.a(new_n374_), .b(new_n177_), .c(new_n130_), .d(x09), .O(new_n375_));
  nand2  g323(.a(new_n159_), .b(new_n53_), .O(new_n376_));
  aoi21  g324(.a(new_n375_), .b(new_n373_), .c(new_n376_), .O(z20));
  nor2   g325(.a(new_n54_), .b(x09), .O(new_n378_));
  nand2  g326(.a(new_n378_), .b(new_n279_), .O(new_n379_));
  nand3  g327(.a(new_n172_), .b(x08), .c(x06), .O(new_n380_));
  aoi21  g328(.a(new_n380_), .b(new_n379_), .c(x05), .O(new_n381_));
  inv1   g329(.a(new_n136_), .O(new_n382_));
  nor4   g330(.a(new_n382_), .b(x15), .c(x09), .d(new_n80_), .O(new_n383_));
  oai21  g331(.a(new_n383_), .b(new_n381_), .c(new_n53_), .O(new_n384_));
  nand3  g332(.a(new_n378_), .b(new_n290_), .c(x08), .O(new_n385_));
  aoi21  g333(.a(new_n385_), .b(new_n384_), .c(new_n198_), .O(z21));
  nand2  g334(.a(new_n378_), .b(new_n81_), .O(new_n387_));
  nand2  g335(.a(new_n172_), .b(x08), .O(new_n388_));
  aoi21  g336(.a(new_n388_), .b(new_n387_), .c(x05), .O(new_n389_));
  oai21  g337(.a(new_n389_), .b(new_n383_), .c(new_n53_), .O(new_n390_));
  nand2  g338(.a(new_n290_), .b(new_n120_), .O(new_n391_));
  aoi21  g339(.a(new_n391_), .b(new_n390_), .c(new_n198_), .O(z22));
  nand2  g340(.a(new_n194_), .b(x09), .O(new_n393_));
  nor3   g341(.a(new_n393_), .b(new_n297_), .c(new_n360_), .O(z23));
  inv1   g342(.a(new_n357_), .O(new_n395_));
  nand3  g343(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n396_));
  nand3  g344(.a(new_n370_), .b(new_n99_), .c(new_n234_), .O(new_n397_));
  nand2  g345(.a(new_n54_), .b(x04), .O(new_n398_));
  aoi21  g346(.a(new_n397_), .b(new_n396_), .c(new_n398_), .O(new_n399_));
  nand3  g347(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n400_));
  nand2  g348(.a(new_n107_), .b(new_n73_), .O(new_n401_));
  nand2  g349(.a(new_n120_), .b(x18), .O(new_n402_));
  aoi21  g350(.a(new_n401_), .b(new_n400_), .c(new_n402_), .O(new_n403_));
  oai21  g351(.a(new_n403_), .b(new_n399_), .c(new_n143_), .O(new_n404_));
  nand3  g352(.a(new_n374_), .b(new_n86_), .c(new_n52_), .O(new_n405_));
  nand2  g353(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  nand2  g354(.a(new_n406_), .b(new_n53_), .O(new_n407_));
  nand4  g355(.a(new_n290_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n408_));
  aoi21  g356(.a(new_n408_), .b(new_n407_), .c(new_n395_), .O(z24));
  nand2  g357(.a(new_n378_), .b(new_n86_), .O(new_n410_));
  nand2  g358(.a(new_n168_), .b(new_n150_), .O(new_n411_));
  aoi21  g359(.a(new_n410_), .b(new_n388_), .c(new_n411_), .O(z25));
  nor2   g360(.a(new_n89_), .b(x20), .O(z26));
  nand2  g361(.a(new_n133_), .b(new_n81_), .O(new_n414_));
  nor2   g362(.a(new_n414_), .b(new_n339_), .O(new_n415_));
  oai21  g363(.a(new_n415_), .b(new_n281_), .c(new_n143_), .O(new_n416_));
  nand3  g364(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n417_));
  aoi21  g365(.a(new_n417_), .b(new_n416_), .c(x07), .O(new_n418_));
  nor3   g366(.a(new_n228_), .b(new_n161_), .c(new_n118_), .O(new_n419_));
  oai21  g367(.a(new_n419_), .b(new_n418_), .c(new_n168_), .O(new_n420_));
  nand3  g368(.a(x15), .b(new_n53_), .c(x00), .O(new_n421_));
  oai21  g369(.a(x15), .b(new_n53_), .c(new_n421_), .O(new_n422_));
  nand4  g370(.a(new_n422_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n423_));
  nand2  g371(.a(new_n423_), .b(new_n420_), .O(new_n424_));
  nand2  g372(.a(new_n424_), .b(new_n72_), .O(new_n425_));
  nand3  g373(.a(new_n159_), .b(new_n52_), .c(x03), .O(new_n426_));
  nand3  g374(.a(new_n172_), .b(new_n119_), .c(new_n106_), .O(new_n427_));
  oai21  g375(.a(new_n427_), .b(new_n426_), .c(new_n425_), .O(z27));
  nand3  g376(.a(new_n262_), .b(new_n143_), .c(x11), .O(new_n429_));
  aoi21  g377(.a(new_n429_), .b(new_n72_), .c(x02), .O(new_n430_));
  nand2  g378(.a(x11), .b(new_n53_), .O(new_n431_));
  oai21  g379(.a(new_n431_), .b(new_n430_), .c(x15), .O(new_n432_));
  nand3  g380(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n433_));
  inv1   g381(.a(new_n67_), .O(new_n434_));
  nor2   g382(.a(new_n434_), .b(x21), .O(new_n435_));
  nand4  g383(.a(new_n435_), .b(new_n433_), .c(new_n262_), .d(new_n180_), .O(new_n436_));
  aoi21  g384(.a(new_n436_), .b(new_n432_), .c(x05), .O(new_n437_));
  nand4  g385(.a(new_n256_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n438_));
  nand2  g386(.a(new_n378_), .b(x21), .O(new_n439_));
  aoi21  g387(.a(new_n439_), .b(new_n438_), .c(x07), .O(new_n440_));
  oai21  g388(.a(new_n440_), .b(new_n437_), .c(x08), .O(new_n441_));
  nor3   g389(.a(new_n212_), .b(new_n434_), .c(new_n143_), .O(new_n442_));
  nor2   g390(.a(x19), .b(new_n54_), .O(new_n443_));
  nand3  g391(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n444_));
  inv1   g392(.a(new_n444_), .O(new_n445_));
  oai21  g393(.a(new_n443_), .b(new_n442_), .c(new_n445_), .O(new_n446_));
  aoi21  g394(.a(new_n446_), .b(new_n441_), .c(new_n99_), .O(new_n447_));
  nand2  g395(.a(new_n378_), .b(new_n99_), .O(new_n448_));
  oai21  g396(.a(new_n73_), .b(new_n75_), .c(new_n290_), .O(new_n449_));
  nor2   g397(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  oai21  g398(.a(new_n450_), .b(new_n447_), .c(new_n159_), .O(new_n451_));
  oai21  g399(.a(new_n118_), .b(new_n53_), .c(new_n153_), .O(new_n452_));
  nand2  g400(.a(new_n452_), .b(new_n315_), .O(new_n453_));
  nand2  g401(.a(new_n453_), .b(new_n294_), .O(new_n454_));
  nand2  g402(.a(new_n454_), .b(new_n451_), .O(z28));
  zero   g403(.O(z10));
endmodule
