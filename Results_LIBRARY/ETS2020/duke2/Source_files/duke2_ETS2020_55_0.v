...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n133_, new_n138_, new_n139_, new_n143_, new_n144_, new_n145_,
  ...
  nor2   g057(.a(x20), .b(new_n113_), .O(z08));
  nor2   g058(.a(x07), .b(x06), .O(new_n116_));
  nor2   g059(.a(x09), .b(x08), .O(new_n117_));
  aoi21  g060(.a(new_n117_), .b(new_n116_), .c(new_n93_), .O(new_n118_));
  nand3  g061(.a(new_n101_), .b(x09), .c(x08), .O(new_n119_));
  oai21  g062(.a(new_n118_), .b(new_n82_), .c(new_n119_), .O(new_n120_));
  nand3  g063(.a(new_n116_), .b(new_n55_), .c(new_n82_), .O(new_n121_));
  nor3   g064(.a(new_n121_), .b(new_n68_), .c(x09), .O(new_n122_));
  aoi21  g065(.a(new_n120_), .b(new_n68_), .c(new_n122_), .O(new_n123_));
  nand2  g066(.a(x07), .b(x05), .O(new_n124_));
  nand2  g067(.a(x17), .b(new_n54_), .O(new_n125_));
  inv1   g068(.a(new_n125_), .O(new_n126_));
  nand3  g069(.a(new_n126_), .b(new_n124_), .c(new_n88_), .O(new_n127_));
  oai21  g070(.a(new_n123_), .b(new_n108_), .c(new_n127_), .O(z10));
  inv1   g071(.a(new_n127_), .O(z13));
  inv1   g072(.a(new_n83_), .O(new_n133_));
  nor4   g073(.a(new_n125_), .b(new_n133_), .c(x18), .d(x07), .O(z15));
  inv1   g074(.a(new_n101_), .O(new_n138_));
  nand2  g075(.a(new_n126_), .b(new_n58_), .O(new_n139_));
  nor2   g076(.a(new_n139_), .b(new_n138_), .O(z19));
  nand4  g077(.a(x15), .b(new_n54_), .c(new_n55_), .d(x06), .O(new_n143_));
  nand2  g078(.a(new_n102_), .b(x08), .O(new_n144_));
  aoi21  g079(.a(new_n144_), .b(new_n143_), .c(x05), .O(new_n145_));
  nand3  g080(.a(new_n68_), .b(new_n54_), .c(x06), .O(new_n146_));
  nor2   g081(.a(new_n146_), .b(new_n69_), .O(new_n147_));
  oai21  g082(.a(new_n147_), .b(new_n145_), .c(new_n60_), .O(new_n148_));
  nand2  g083(.a(new_n93_), .b(new_n81_), .O(new_n149_));
  aoi21  g084(.a(new_n149_), .b(new_n148_), .c(new_n108_), .O(z22));
  nor4   g085(.a(new_n119_), .b(new_n88_), .c(x17), .d(x15), .O(z23));
  zero   g086(.O(z00));
  zero   g087(.O(z01));
  zero   g088(.O(z04));
  zero   g089(.O(z05));
