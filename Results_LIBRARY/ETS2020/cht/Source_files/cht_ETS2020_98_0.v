...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n125_, new_n128_, new_n129_, new_n131_, new_n132_, new_n145_,
  ...
  inv1   g44(.a(x09), .O(new_n145_));
  oai21  g45(.a(x14), .b(new_n145_), .c(x42), .O(new_n146_));
  inv1   g46(.a(x14), .O(new_n147_));
  nand3  g47(.a(x43), .b(new_n147_), .c(x09), .O(new_n148_));
  aoi21  g48(.a(new_n148_), .b(new_n146_), .c(x10), .O(z31));
  oai21  g49(.a(x14), .b(new_n145_), .c(x43), .O(new_n150_));
  nand3  g50(.a(x44), .b(new_n147_), .c(x09), .O(new_n151_));
  aoi21  g51(.a(new_n151_), .b(new_n150_), .c(x10), .O(z32));
  zero   g52(.O(z08));
  zero   g53(.O(z09));
  zero   g54(.O(z10));
  zero   g55(.O(z13));
