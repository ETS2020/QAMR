...
module FAU ( 
  ...
  inv1   g465(.a(new_n297_), .O(new_n563_));
  nor4   g466(.a(new_n369_), .b(new_n563_), .c(new_n228_), .d(new_n190_), .O(z21));
  ...
  oai21  g805(.a(x24), .b(x22), .c(new_n100_), .O(new_n912_));
  nor3   g806(.a(new_n912_), .b(new_n563_), .c(new_n137_), .O(z43));
  zero   g807(.O(z02));
  zero   g808(.O(z12));
  zero   g809(.O(z13));
  zero   g810(.O(z14));
