...
module FAU ( 
  ...
  nand2  g24(.a(x22), .b(x14), .O(new_n72_));
  nor2   g25(.a(new_n72_), .b(x24), .O(z10));
  nand2  g26(.a(x22), .b(x17), .O(new_n74_));
  nor2   g27(.a(new_n74_), .b(x24), .O(z11));
  nand2  g28(.a(x23), .b(x17), .O(new_n77_));
  nor2   g29(.a(new_n77_), .b(x24), .O(z13));
  nor2   g30(.a(x13), .b(x12), .O(new_n80_));
  nor2   g31(.a(x15), .b(x14), .O(new_n81_));
  nand2  g32(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g33(.O(z03));
  zero   g34(.O(z04));
  zero   g35(.O(z06));
  zero   g36(.O(z07));
