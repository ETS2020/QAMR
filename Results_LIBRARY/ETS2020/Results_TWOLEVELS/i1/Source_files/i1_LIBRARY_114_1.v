...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n70_, new_n74_, new_n76_, new_n78_,
  ...
  nand3  g26(.a(new_n69_), .b(new_n60_), .c(x19), .O(new_n70_));
  oai21  g27(.a(new_n70_), .b(new_n50_), .c(new_n68_), .O(z05));
  and2   g28(.a(x24), .b(x18), .O(z07));
  nand2  g29(.a(x22), .b(x14), .O(new_n74_));
  nor2   g30(.a(new_n74_), .b(x24), .O(z10));
  nand2  g31(.a(x22), .b(x17), .O(new_n76_));
  nor2   g32(.a(new_n76_), .b(x24), .O(z11));
  nand2  g33(.a(x23), .b(x14), .O(new_n78_));
  nor2   g34(.a(new_n78_), .b(x24), .O(z12));
  inv1   g35(.a(x16), .O(new_n81_));
  nor2   g36(.a(x24), .b(new_n81_), .O(z14));
  nor2   g37(.a(x13), .b(x12), .O(new_n83_));
  nor2   g38(.a(x15), .b(x14), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g40(.O(z00));
  zero   g41(.O(z04));
  zero   g42(.O(z09));
  zero   g43(.O(z13));
