...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n72_, new_n74_, new_n78_, new_n79_;
  ...
  nand2  g24(.a(x22), .b(x17), .O(new_n72_));
  nor2   g25(.a(new_n72_), .b(x24), .O(z11));
  nand2  g26(.a(x23), .b(x14), .O(new_n74_));
  nor2   g27(.a(new_n74_), .b(x24), .O(z12));
  nor2   g28(.a(x13), .b(x12), .O(new_n78_));
  nor2   g29(.a(x15), .b(x14), .O(new_n79_));
  nand2  g30(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g31(.O(z04));
  zero   g32(.O(z06));
  zero   g33(.O(z07));
  zero   g34(.O(z08));
