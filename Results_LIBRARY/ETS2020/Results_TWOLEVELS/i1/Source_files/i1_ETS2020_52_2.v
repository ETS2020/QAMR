// Benchmark "FAU" written by ABC on Tue Jun 23 01:15:27 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n64_), .b(new_n54_), .c(x19), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n49_), .c(new_n63_), .O(z05));
  and2   g25(.a(x24), .b(x18), .O(z07));
  and2   g26(.a(x24), .b(x11), .O(z09));
  inv1   g27(.a(x14), .O(new_n70_));
  inv1   g28(.a(x22), .O(new_n71_));
  nor3   g29(.a(x24), .b(new_n71_), .c(new_n70_), .O(z10));
  inv1   g30(.a(x17), .O(new_n73_));
  nor3   g31(.a(x24), .b(new_n71_), .c(new_n73_), .O(z11));
  inv1   g32(.a(x23), .O(new_n75_));
  nor3   g33(.a(x24), .b(new_n75_), .c(new_n70_), .O(z12));
  nor3   g34(.a(x24), .b(new_n75_), .c(new_n73_), .O(z13));
  inv1   g35(.a(x16), .O(new_n78_));
  nor2   g36(.a(x24), .b(new_n78_), .O(z14));
  nor2   g37(.a(x13), .b(x12), .O(new_n80_));
  nor2   g38(.a(x15), .b(x14), .O(new_n81_));
  nand2  g39(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g40(.O(z06));
  buf    g41(.a(x00), .O(z00));
  buf    g42(.a(x20), .O(z03));
  buf    g43(.a(x11), .O(z08));
