...
module FAU ( 
  ...
  nor3   g32(.a(x24), .b(new_n77_), .c(new_n76_), .O(z10));
  inv1   g33(.a(x17), .O(new_n79_));
  nor3   g34(.a(x24), .b(new_n77_), .c(new_n79_), .O(z11));
  inv1   g35(.a(x23), .O(new_n81_));
  nor3   g36(.a(x24), .b(new_n81_), .c(new_n76_), .O(z12));
  nor3   g37(.a(x24), .b(new_n81_), .c(new_n79_), .O(z13));
