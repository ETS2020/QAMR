...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n69_, new_n72_, new_n73_;
  ...
  nand2  g21(.a(x23), .b(x17), .O(new_n69_));
  nor2   g22(.a(new_n69_), .b(x24), .O(z13));
  nor2   g23(.a(x13), .b(x12), .O(new_n72_));
  nor2   g24(.a(x15), .b(x14), .O(new_n73_));
  nand2  g25(.a(new_n73_), .b(new_n72_), .O(z15));
  zero   g26(.O(z01));
  zero   g27(.O(z04));
  zero   g28(.O(z09));
  zero   g29(.O(z10));
