// Benchmark "FAU" written by ABC on Tue Jun 23 01:15:46 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n72_, new_n76_, new_n78_, new_n79_;
  ...
  nand2  g26(.a(x22), .b(x17), .O(new_n72_));
  nor2   g27(.a(new_n72_), .b(x24), .O(z11));
  inv1   g28(.a(x16), .O(new_n76_));
  nor2   g29(.a(x24), .b(new_n76_), .O(z14));
  nor2   g30(.a(x13), .b(x12), .O(new_n78_));
  nor2   g31(.a(x15), .b(x14), .O(new_n79_));
  nand2  g32(.a(new_n79_), .b(new_n78_), .O(z15));
  zero   g33(.O(z03));
  zero   g34(.O(z06));
  zero   g35(.O(z07));
  zero   g36(.O(z10));
