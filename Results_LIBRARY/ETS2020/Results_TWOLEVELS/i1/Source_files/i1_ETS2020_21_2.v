...
module FAU ( 
  ...
  inv1   g27(.a(x14), .O(new_n72_));
  inv1   g28(.a(x22), .O(new_n73_));
  nor3   g29(.a(x24), .b(new_n73_), .c(new_n72_), .O(z10));
  inv1   g30(.a(x17), .O(new_n75_));
  nor3   g31(.a(x24), .b(new_n73_), .c(new_n75_), .O(z11));
  inv1   g32(.a(x23), .O(new_n77_));
  nor3   g33(.a(x24), .b(new_n77_), .c(new_n72_), .O(z12));
  nor3   g34(.a(x24), .b(new_n77_), .c(new_n75_), .O(z13));
