...
module FAU ( 
  ...
  nand2  g21(.a(x22), .b(x17), .O(new_n68_));
  nor2   g22(.a(new_n68_), .b(x24), .O(z11));
  nand2  g23(.a(x23), .b(x14), .O(new_n70_));
  nor2   g24(.a(new_n70_), .b(x24), .O(z12));
  nand2  g25(.a(x23), .b(x17), .O(new_n72_));
  nor2   g26(.a(new_n72_), .b(x24), .O(z13));
  inv1   g27(.a(x16), .O(new_n74_));
  nor2   g28(.a(x24), .b(new_n74_), .O(z14));
