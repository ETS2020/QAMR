...
module FAU ( 
  ...
  nand2  g09(.a(x22), .b(x14), .O(new_n56_));
  nor2   g10(.a(new_n56_), .b(x24), .O(z10));
  nand2  g11(.a(x22), .b(x17), .O(new_n58_));
  nor2   g12(.a(new_n58_), .b(x24), .O(z11));
  nand2  g13(.a(x23), .b(x14), .O(new_n60_));
  nor2   g14(.a(new_n60_), .b(x24), .O(z12));
  inv1   g15(.a(x16), .O(new_n63_));
  nor2   g16(.a(x24), .b(new_n63_), .O(z14));
