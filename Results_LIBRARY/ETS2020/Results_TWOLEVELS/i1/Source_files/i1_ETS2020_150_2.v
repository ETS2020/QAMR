...
module FAU ( 
  ...
  nor3   g26(.a(x24), .b(new_n73_), .c(new_n72_), .O(z10));
  inv1   g27(.a(x17), .O(new_n75_));
  nor3   g28(.a(x24), .b(new_n73_), .c(new_n75_), .O(z11));
  inv1   g29(.a(x23), .O(new_n77_));
  nor3   g30(.a(x24), .b(new_n77_), .c(new_n72_), .O(z12));
  nor3   g31(.a(x24), .b(new_n77_), .c(new_n75_), .O(z13));
