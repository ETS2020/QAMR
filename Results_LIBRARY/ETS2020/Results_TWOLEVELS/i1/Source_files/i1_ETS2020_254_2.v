// Benchmark "FAU" written by ABC on Tue Jun 23 01:16:13 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n70_, new_n72_, new_n76_, new_n78_, new_n79_;
  ...
  nand2  g26(.a(x22), .b(x14), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(x24), .O(z10));
  nand2  g28(.a(x22), .b(x17), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(x24), .O(z11));
