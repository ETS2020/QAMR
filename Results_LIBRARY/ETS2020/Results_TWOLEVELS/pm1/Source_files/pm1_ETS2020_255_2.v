...
module FAU ( 
  ...
  nor2   g15(.a(new_n45_), .b(new_n44_), .O(z06));
  inv1   g16(.a(x15), .O(z07));
  nand3  g17(.a(x12), .b(x09), .c(x04), .O(new_n48_));
  inv1   g18(.a(new_n48_), .O(new_n49_));
  nand3  g19(.a(new_n49_), .b(x03), .c(x02), .O(new_n50_));
  nand3  g20(.a(new_n50_), .b(new_n33_), .c(x11), .O(z08));
  xnor2a g21(.a(x12), .b(x11), .O(new_n52_));
  and2   g22(.a(new_n52_), .b(new_n33_), .O(z09));
  nand3  g23(.a(new_n43_), .b(new_n38_), .c(new_n33_), .O(new_n54_));
  inv1   g24(.a(new_n54_), .O(z10));
  zero   g25(.O(z00));
  zero   g26(.O(z11));
  zero   g27(.O(z12));
endmodule
