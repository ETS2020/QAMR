// Benchmark "FAU" written by ABC on Tue Jun 23 03:58:05 2020
...
module FAU ( 
  ...
  xor2a  g20(.a(x12), .b(x11), .O(new_n51_));
  inv1   g21(.a(x10), .O(new_n52_));
  nand2  g22(.a(new_n52_), .b(x00), .O(new_n53_));
  nor2   g23(.a(new_n53_), .b(new_n51_), .O(z09));
  nand2  g24(.a(new_n45_), .b(x12), .O(new_n55_));
  nand4  g25(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n56_));
  nor2   g26(.a(new_n56_), .b(new_n55_), .O(z10));
  nand4  g27(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  nand2  g28(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  nand3  g29(.a(x11), .b(new_n52_), .c(x00), .O(new_n60_));
  aoi21  g30(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z11));
  inv1   g31(.a(x09), .O(new_n62_));
  nand3  g32(.a(x12), .b(x11), .c(new_n62_), .O(new_n63_));
  nor2   g33(.a(new_n63_), .b(new_n53_), .O(z12));
  zero   g34(.O(z08));
endmodule
