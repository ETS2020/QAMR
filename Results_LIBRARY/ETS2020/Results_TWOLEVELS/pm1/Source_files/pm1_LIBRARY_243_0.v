...
module FAU ( 
  ...
  nor2   g14(.a(new_n47_), .b(new_n45_), .O(z09));
  nand2  g15(.a(new_n39_), .b(x12), .O(new_n49_));
  nand4  g16(.a(x11), .b(new_n46_), .c(x09), .d(x00), .O(new_n50_));
  nor2   g17(.a(new_n50_), .b(new_n49_), .O(z10));
  nand4  g18(.a(new_n39_), .b(x12), .c(x09), .d(x01), .O(new_n52_));
  or2    g19(.a(x12), .b(x01), .O(new_n53_));
  nand3  g20(.a(x11), .b(new_n46_), .c(x00), .O(new_n54_));
  aoi21  g21(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(z11));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z04));
  zero   g25(.O(z08));
