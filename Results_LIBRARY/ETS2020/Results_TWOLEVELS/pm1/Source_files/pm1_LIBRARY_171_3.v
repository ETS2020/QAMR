...
module FAU ( 
  ...
  aoi21  g14(.a(new_n44_), .b(new_n42_), .c(new_n45_), .O(z06));
  inv1   g15(.a(x15), .O(z07));
  inv1   g16(.a(x10), .O(new_n48_));
  nand2  g17(.a(new_n48_), .b(x00), .O(new_n49_));
  inv1   g18(.a(new_n49_), .O(new_n50_));
  inv1   g19(.a(x00), .O(new_n51_));
  oai21  g20(.a(x10), .b(new_n51_), .c(new_n32_), .O(new_n52_));
  nand2  g21(.a(new_n52_), .b(new_n31_), .O(new_n53_));
  nand3  g22(.a(new_n42_), .b(new_n38_), .c(x04), .O(new_n54_));
  nand3  g23(.a(new_n54_), .b(new_n53_), .c(new_n50_), .O(z08));
  xor2a  g24(.a(x12), .b(x11), .O(new_n56_));
  nor2   g25(.a(new_n56_), .b(new_n49_), .O(z09));
  nand3  g26(.a(x12), .b(x11), .c(new_n37_), .O(new_n60_));
  nor2   g27(.a(new_n60_), .b(new_n49_), .O(z12));
  zero   g28(.O(z02));
  zero   g29(.O(z05));
  zero   g30(.O(z10));
  zero   g31(.O(z11));
