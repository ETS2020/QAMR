// Benchmark "FAU" written by ABC on Tue Jun 23 03:57:15 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n55_), .b(x12), .O(new_n56_));
  nand4  g24(.a(x11), .b(new_n50_), .c(x09), .d(x00), .O(new_n57_));
  nor2   g25(.a(new_n57_), .b(new_n56_), .O(z10));
  nand2  g26(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  nand4  g27(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  aoi21  g28(.a(new_n60_), .b(new_n59_), .c(new_n51_), .O(z11));
  nand2  g29(.a(new_n50_), .b(x00), .O(new_n62_));
  inv1   g30(.a(x09), .O(new_n63_));
  nand3  g31(.a(x12), .b(x11), .c(new_n63_), .O(new_n64_));
  nor2   g32(.a(new_n64_), .b(new_n62_), .O(z12));
  zero   g33(.O(z05));
  zero   g34(.O(z06));
  zero   g35(.O(z09));
endmodule
