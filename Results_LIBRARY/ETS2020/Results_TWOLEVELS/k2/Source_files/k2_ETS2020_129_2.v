// Benchmark "FAU" written by ABC on Wed Jun 24 05:12:04 2020
...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n1118_, new_n1121_, new_n1122_, new_n1123_, new_n1125_, new_n1126_,
    new_n1127_, new_n1128_, new_n1133_, new_n1134_, new_n1135_, new_n1136_,
  ...
  nand2  g0072(.a(new_n147_), .b(x28), .O(new_n167_));
  ...
  nor3   g0079(.a(new_n173_), .b(new_n169_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g0090(.a(new_n184_), .b(new_n182_), .c(new_n172_), .O(new_n185_));
  ...
  inv1   g0132(.a(new_n167_), .O(new_n227_));
  ...
  nand4  g0147(.a(new_n241_), .b(new_n170_), .c(new_n168_), .d(new_n227_), .O(new_n242_));
  ...
  oai22  g0255(.a(new_n344_), .b(new_n171_), .c(new_n207_), .d(new_n189_), .O(new_n352_));
  ...
  nand3  g0287(.a(new_n383_), .b(new_n172_), .c(new_n145_), .O(new_n384_));
  nand2  g0288(.a(new_n384_), .b(new_n379_), .O(new_n385_));
  nand3  g0289(.a(x30), .b(x21), .c(new_n93_), .O(new_n386_));
  nor3   g0290(.a(new_n386_), .b(new_n171_), .c(new_n201_), .O(new_n387_));
  ...
  oai21  g0304(.a(new_n400_), .b(new_n393_), .c(new_n168_), .O(new_n401_));
  ...
  nand2  g0394(.a(new_n172_), .b(new_n93_), .O(new_n491_));
  ...
  nand4  g0461(.a(new_n557_), .b(new_n172_), .c(new_n125_), .d(x20), .O(new_n558_));
  ...
  nor3   g0507(.a(new_n549_), .b(new_n171_), .c(new_n111_), .O(new_n604_));
  ...
  aoi21  g0670(.a(new_n736_), .b(new_n171_), .c(new_n133_), .O(new_n767_));
  aoi21  g0671(.a(new_n172_), .b(new_n766_), .c(new_n767_), .O(new_n768_));
  ...
  oai21  g0901(.a(new_n171_), .b(new_n106_), .c(new_n101_), .O(new_n998_));
  ...
  aoi22  g0923(.a(new_n1019_), .b(new_n172_), .c(new_n779_), .d(new_n92_), .O(new_n1020_));
  nand2  g0924(.a(x25), .b(new_n390_), .O(new_n1021_));
  nand2  g0925(.a(new_n172_), .b(x20), .O(new_n1022_));
  ...
  oai21  g0956(.a(x29), .b(x22), .c(new_n172_), .O(new_n1054_));
  ...
  nand4  g0994(.a(new_n652_), .b(new_n172_), .c(new_n145_), .d(x03), .O(new_n1092_));
  ...
  nand3  g1019(.a(new_n287_), .b(new_n241_), .c(new_n170_), .O(new_n1117_));
  nand3  g1020(.a(new_n125_), .b(x29), .c(new_n145_), .O(new_n1118_));
  aoi21  g1021(.a(new_n1117_), .b(new_n1116_), .c(new_n1118_), .O(z30));
  nand2  g1022(.a(new_n574_), .b(new_n159_), .O(new_n1121_));
  inv1   g1023(.a(x12), .O(new_n1122_));
  nand4  g1024(.a(x21), .b(new_n686_), .c(new_n462_), .d(new_n1122_), .O(new_n1123_));
  nor2   g1025(.a(new_n1123_), .b(new_n1121_), .O(z32));
  oai21  g1026(.a(new_n555_), .b(x30), .c(new_n440_), .O(new_n1125_));
  oai21  g1027(.a(new_n529_), .b(new_n96_), .c(new_n1042_), .O(new_n1126_));
  nand3  g1028(.a(new_n1126_), .b(x29), .c(new_n286_), .O(new_n1127_));
  nand2  g1029(.a(new_n417_), .b(new_n172_), .O(new_n1128_));
  aoi21  g1030(.a(new_n1127_), .b(new_n1125_), .c(new_n1128_), .O(z33));
  aoi22  g1031(.a(new_n884_), .b(new_n100_), .c(new_n714_), .d(new_n692_), .O(new_n1133_));
  nand4  g1032(.a(new_n885_), .b(new_n330_), .c(new_n452_), .d(x22), .O(new_n1134_));
  oai21  g1033(.a(new_n1033_), .b(x00), .c(new_n1081_), .O(new_n1135_));
  oai21  g1034(.a(new_n1134_), .b(new_n1133_), .c(new_n1135_), .O(new_n1136_));
  nand3  g1035(.a(x23), .b(x21), .c(new_n100_), .O(new_n1137_));
  nand2  g1036(.a(new_n1137_), .b(new_n329_), .O(new_n1138_));
  aoi21  g1037(.a(new_n1136_), .b(new_n96_), .c(new_n1138_), .O(new_n1139_));
  aoi21  g1038(.a(new_n96_), .b(x05), .c(x00), .O(new_n1140_));
  nand2  g1039(.a(new_n417_), .b(x22), .O(new_n1141_));
  oai21  g1040(.a(new_n1141_), .b(new_n1140_), .c(new_n338_), .O(new_n1142_));
  nand2  g1041(.a(new_n746_), .b(x00), .O(new_n1143_));
  nand3  g1042(.a(new_n1143_), .b(new_n94_), .c(new_n145_), .O(new_n1144_));
  aoi22  g1043(.a(new_n1144_), .b(new_n779_), .c(new_n1142_), .d(x19), .O(new_n1145_));
  oai21  g1044(.a(new_n1139_), .b(x20), .c(new_n1145_), .O(new_n1146_));
  nand2  g1045(.a(new_n1146_), .b(new_n92_), .O(new_n1147_));
  oai21  g1046(.a(x28), .b(x00), .c(x26), .O(new_n1148_));
  oai21  g1047(.a(new_n183_), .b(new_n91_), .c(new_n1148_), .O(new_n1149_));
  nand2  g1048(.a(new_n1149_), .b(new_n93_), .O(new_n1150_));
  nand2  g1049(.a(new_n634_), .b(x00), .O(new_n1151_));
  aoi21  g1050(.a(new_n1151_), .b(new_n286_), .c(new_n96_), .O(new_n1152_));
  oai21  g1051(.a(new_n1152_), .b(new_n93_), .c(new_n1150_), .O(new_n1153_));
  nor3   g1052(.a(x28), .b(x17), .c(x00), .O(new_n1154_));
  nor3   g1053(.a(new_n1154_), .b(new_n189_), .c(new_n106_), .O(new_n1155_));
  aoi21  g1054(.a(new_n1153_), .b(x19), .c(new_n1155_), .O(new_n1156_));
  nand3  g1055(.a(new_n315_), .b(new_n96_), .c(x25), .O(new_n1157_));
  nand2  g1056(.a(new_n1157_), .b(new_n100_), .O(new_n1158_));
  nand2  g1057(.a(new_n1158_), .b(new_n204_), .O(new_n1159_));
  oai21  g1058(.a(new_n1156_), .b(x21), .c(new_n1159_), .O(new_n1160_));
  aoi21  g1059(.a(new_n1160_), .b(x18), .c(new_n834_), .O(new_n1161_));
  aoi21  g1060(.a(new_n1161_), .b(new_n1147_), .c(new_n111_), .O(new_n1162_));
  nand3  g1061(.a(new_n1081_), .b(new_n286_), .c(new_n579_), .O(new_n1163_));
  oai21  g1062(.a(new_n583_), .b(new_n100_), .c(new_n1163_), .O(new_n1164_));
  nand2  g1063(.a(new_n1164_), .b(new_n92_), .O(new_n1165_));
  aoi21  g1064(.a(new_n919_), .b(new_n288_), .c(new_n100_), .O(new_n1166_));
  nand2  g1065(.a(new_n284_), .b(new_n218_), .O(new_n1167_));
  inv1   g1066(.a(new_n1167_), .O(new_n1168_));
  oai21  g1067(.a(new_n1168_), .b(new_n1166_), .c(new_n495_), .O(new_n1169_));
  aoi21  g1068(.a(new_n1169_), .b(new_n1165_), .c(new_n93_), .O(new_n1170_));
  nand2  g1069(.a(new_n1105_), .b(new_n218_), .O(new_n1171_));
  inv1   g1070(.a(new_n1171_), .O(new_n1172_));
  nand2  g1071(.a(new_n574_), .b(new_n145_), .O(new_n1173_));
  aoi21  g1072(.a(new_n1173_), .b(new_n338_), .c(x19), .O(new_n1174_));
  oai21  g1073(.a(new_n1174_), .b(new_n1172_), .c(new_n225_), .O(new_n1175_));
  nand2  g1074(.a(new_n145_), .b(x13), .O(new_n1176_));
  nand3  g1075(.a(new_n1176_), .b(new_n1123_), .c(new_n686_), .O(new_n1177_));
  nand2  g1076(.a(new_n1177_), .b(new_n574_), .O(new_n1178_));
  nand2  g1077(.a(new_n1178_), .b(new_n1175_), .O(new_n1179_));
  oai21  g1078(.a(new_n1179_), .b(new_n1170_), .c(new_n111_), .O(new_n1180_));
  nand2  g1079(.a(new_n141_), .b(new_n102_), .O(new_n1181_));
  nand2  g1080(.a(new_n1181_), .b(new_n1180_), .O(new_n1182_));
  oai21  g1081(.a(new_n1182_), .b(new_n1162_), .c(new_n125_), .O(new_n1183_));
  oai21  g1082(.a(new_n390_), .b(new_n151_), .c(x25), .O(new_n1184_));
  oai21  g1083(.a(x26), .b(x22), .c(new_n151_), .O(new_n1185_));
  nand3  g1084(.a(new_n100_), .b(new_n952_), .c(x00), .O(new_n1186_));
  aoi21  g1085(.a(new_n1185_), .b(new_n1184_), .c(new_n1186_), .O(new_n1187_));
  oai21  g1086(.a(new_n1187_), .b(new_n1049_), .c(x21), .O(new_n1188_));
  aoi22  g1087(.a(new_n546_), .b(x15), .c(new_n376_), .d(new_n322_), .O(new_n1189_));
  aoi21  g1088(.a(new_n1189_), .b(new_n1188_), .c(x28), .O(new_n1190_));
  nand2  g1089(.a(new_n1081_), .b(new_n218_), .O(new_n1191_));
  nand2  g1090(.a(new_n1191_), .b(new_n1108_), .O(new_n1192_));
  nand2  g1091(.a(new_n1192_), .b(x00), .O(new_n1193_));
  aoi21  g1092(.a(new_n365_), .b(x15), .c(new_n1105_), .O(new_n1194_));
  aoi21  g1093(.a(new_n1194_), .b(new_n1193_), .c(new_n92_), .O(new_n1195_));
  oai21  g1094(.a(new_n1195_), .b(new_n1190_), .c(x20), .O(new_n1196_));
  nand2  g1095(.a(new_n756_), .b(x00), .O(new_n1197_));
  aoi21  g1096(.a(new_n1197_), .b(new_n833_), .c(new_n405_), .O(new_n1198_));
  nor2   g1097(.a(new_n1038_), .b(new_n487_), .O(new_n1199_));
  oai21  g1098(.a(new_n1199_), .b(new_n1198_), .c(x28), .O(new_n1200_));
  nand2  g1099(.a(new_n928_), .b(x19), .O(new_n1201_));
  nand3  g1100(.a(new_n1201_), .b(new_n861_), .c(new_n579_), .O(new_n1202_));
  aoi21  g1101(.a(new_n1202_), .b(new_n96_), .c(new_n1012_), .O(new_n1203_));
  aoi21  g1102(.a(new_n1203_), .b(new_n1200_), .c(x21), .O(new_n1204_));
  nand4  g1103(.a(new_n130_), .b(new_n96_), .c(x22), .d(x20), .O(new_n1205_));
  aoi21  g1104(.a(new_n1205_), .b(new_n96_), .c(new_n91_), .O(new_n1206_));
  nand3  g1105(.a(new_n96_), .b(x25), .c(new_n390_), .O(new_n1207_));
  inv1   g1106(.a(new_n1207_), .O(new_n1208_));
  oai21  g1107(.a(new_n1208_), .b(new_n1206_), .c(x19), .O(new_n1209_));
  oai22  g1108(.a(new_n189_), .b(new_n91_), .c(x28), .d(new_n100_), .O(new_n1210_));
  oai22  g1109(.a(new_n228_), .b(new_n91_), .c(new_n579_), .d(x20), .O(new_n1211_));
  aoi22  g1110(.a(new_n1211_), .b(new_n100_), .c(new_n1210_), .d(new_n108_), .O(new_n1212_));
  aoi21  g1111(.a(new_n1212_), .b(new_n1209_), .c(new_n145_), .O(new_n1213_));
  oai21  g1112(.a(new_n1213_), .b(new_n1204_), .c(new_n92_), .O(new_n1214_));
  nor2   g1113(.a(new_n936_), .b(x21), .O(new_n1215_));
  oai21  g1114(.a(new_n207_), .b(x19), .c(new_n1171_), .O(new_n1216_));
  nand2  g1115(.a(new_n1216_), .b(x00), .O(new_n1217_));
  oai21  g1116(.a(new_n338_), .b(x19), .c(new_n1217_), .O(new_n1218_));
  oai21  g1117(.a(new_n1218_), .b(new_n1215_), .c(new_n225_), .O(new_n1219_));
  nand3  g1118(.a(new_n1219_), .b(new_n1214_), .c(new_n1196_), .O(new_n1220_));
  nand2  g1119(.a(new_n1220_), .b(new_n111_), .O(new_n1221_));
  inv1   g1120(.a(new_n362_), .O(new_n1222_));
  nand3  g1121(.a(new_n96_), .b(new_n151_), .c(new_n91_), .O(new_n1223_));
  aoi22  g1122(.a(new_n1223_), .b(new_n641_), .c(new_n935_), .d(new_n93_), .O(new_n1224_));
  oai21  g1123(.a(new_n1224_), .b(x21), .c(new_n203_), .O(new_n1225_));
  aoi21  g1124(.a(new_n1225_), .b(x18), .c(new_n349_), .O(new_n1226_));
  oai21  g1125(.a(new_n1226_), .b(new_n100_), .c(new_n1222_), .O(new_n1227_));
  inv1   g1126(.a(new_n499_), .O(new_n1228_));
  nand3  g1127(.a(new_n1228_), .b(new_n145_), .c(x18), .O(new_n1229_));
  oai21  g1128(.a(new_n96_), .b(x21), .c(new_n152_), .O(new_n1230_));
  aoi21  g1129(.a(new_n1230_), .b(new_n1229_), .c(x19), .O(new_n1231_));
  nand2  g1130(.a(new_n172_), .b(x21), .O(new_n1232_));
  nor2   g1131(.a(new_n1232_), .b(new_n499_), .O(new_n1233_));
  oai21  g1132(.a(new_n1233_), .b(new_n1231_), .c(new_n93_), .O(new_n1234_));
  aoi21  g1133(.a(new_n228_), .b(new_n106_), .c(new_n1232_), .O(new_n1235_));
  nor2   g1134(.a(new_n1235_), .b(new_n419_), .O(new_n1236_));
  ...
  inv1   g1138(.a(new_n985_), .O(new_n1240_));
  nand4  g1139(.a(new_n617_), .b(new_n454_), .c(new_n371_), .d(new_n280_), .O(new_n1241_));
  nand2  g1140(.a(new_n280_), .b(new_n93_), .O(new_n1242_));
  inv1   g1141(.a(new_n1242_), .O(new_n1243_));
  oai21  g1142(.a(new_n1243_), .b(new_n727_), .c(x18), .O(new_n1244_));
  nand3  g1143(.a(new_n1244_), .b(new_n1241_), .c(new_n1240_), .O(new_n1245_));
  nand2  g1144(.a(new_n1245_), .b(x21), .O(new_n1246_));
  oai21  g1145(.a(new_n93_), .b(new_n137_), .c(new_n138_), .O(new_n1247_));
  nand3  g1146(.a(new_n1247_), .b(new_n410_), .c(new_n281_), .O(new_n1248_));
  ...
  inv1   g1150(.a(new_n233_), .O(new_n1253_));
  oai21  g1151(.a(new_n288_), .b(new_n634_), .c(new_n145_), .O(new_n1254_));
  nand2  g1152(.a(new_n1254_), .b(x18), .O(new_n1255_));
  aoi21  g1153(.a(new_n1255_), .b(new_n1253_), .c(new_n93_), .O(new_n1256_));
  inv1   g1154(.a(new_n213_), .O(new_n1257_));
  nor2   g1155(.a(new_n224_), .b(new_n1257_), .O(new_n1258_));
  oai21  g1156(.a(new_n1258_), .b(new_n1256_), .c(new_n125_), .O(new_n1259_));
  nand3  g1157(.a(new_n1025_), .b(new_n1228_), .c(new_n225_), .O(new_n1260_));
  aoi21  g1158(.a(new_n1260_), .b(new_n1259_), .c(new_n111_), .O(new_n1261_));
  nand4  g1159(.a(new_n646_), .b(new_n487_), .c(new_n126_), .d(x20), .O(new_n1262_));
  oai21  g1160(.a(new_n632_), .b(new_n148_), .c(new_n1262_), .O(new_n1263_));
  nand2  g1161(.a(new_n773_), .b(new_n629_), .O(new_n1264_));
  aoi21  g1162(.a(new_n1264_), .b(new_n167_), .c(new_n145_), .O(new_n1265_));
  aoi21  g1163(.a(new_n1263_), .b(new_n145_), .c(new_n1265_), .O(new_n1266_));
  nand4  g1164(.a(new_n417_), .b(new_n126_), .c(x27), .d(x18), .O(new_n1267_));
  oai21  g1165(.a(new_n1266_), .b(x18), .c(new_n1267_), .O(new_n1268_));
  oai21  g1166(.a(new_n1268_), .b(new_n1261_), .c(x19), .O(new_n1269_));
  oai21  g1167(.a(new_n614_), .b(new_n92_), .c(new_n100_), .O(new_n1270_));
  aoi21  g1168(.a(new_n1270_), .b(new_n783_), .c(new_n145_), .O(new_n1271_));
  nor2   g1169(.a(new_n321_), .b(new_n1257_), .O(new_n1272_));
  oai21  g1170(.a(new_n1272_), .b(new_n1271_), .c(new_n125_), .O(new_n1273_));
  oai21  g1171(.a(new_n106_), .b(x17), .c(x18), .O(new_n1274_));
  nand3  g1172(.a(new_n1274_), .b(new_n1081_), .c(new_n303_), .O(new_n1275_));
  aoi21  g1173(.a(new_n1275_), .b(new_n1273_), .c(new_n93_), .O(new_n1276_));
  nand2  g1174(.a(new_n141_), .b(new_n92_), .O(new_n1277_));
  nand2  g1175(.a(new_n225_), .b(new_n208_), .O(new_n1278_));
  aoi21  g1176(.a(new_n1278_), .b(new_n1277_), .c(new_n1097_), .O(new_n1279_));
  oai21  g1177(.a(new_n1279_), .b(new_n1276_), .c(x29), .O(new_n1280_));
  nand2  g1178(.a(new_n1280_), .b(new_n1269_), .O(z39));
  nand4  g1179(.a(new_n92_), .b(new_n952_), .c(new_n151_), .d(x00), .O(new_n1283_));
  nor4   g1180(.a(new_n1283_), .b(new_n772_), .c(new_n1253_), .d(new_n860_), .O(z41));
  nand2  g1181(.a(new_n417_), .b(new_n126_), .O(new_n1286_));
  nor3   g1182(.a(new_n1286_), .b(new_n925_), .c(new_n101_), .O(z43));
  zero   g1183(.O(z01));
  zero   g1184(.O(z02));
  zero   g1185(.O(z03));
  zero   g1186(.O(z04));
  ...
  zero   g1195(.O(z40));
  zero   g1196(.O(z42));
  nor3   g1197(.a(new_n807_), .b(new_n763_), .c(new_n101_), .O(z44));
endmodule
