...
module FAU ( 
  ...
  inv1   g124(.a(new_n162_), .O(new_n278_));
  ...
  nor3   g144(.a(new_n290_), .b(new_n242_), .c(new_n200_), .O(z39));
  nor3   g145(.a(new_n290_), .b(new_n242_), .c(new_n197_), .O(z40));
  nor3   g146(.a(new_n290_), .b(new_n242_), .c(new_n194_), .O(z41));
  nor3   g147(.a(new_n290_), .b(new_n242_), .c(new_n191_), .O(z42));
  nor3   g148(.a(new_n290_), .b(new_n242_), .c(new_n188_), .O(z43));
  nor3   g149(.a(new_n290_), .b(new_n242_), .c(new_n185_), .O(z44));
  nor3   g150(.a(new_n290_), .b(new_n242_), .c(new_n182_), .O(z45));
  nor3   g151(.a(new_n290_), .b(new_n242_), .c(new_n179_), .O(z46));
