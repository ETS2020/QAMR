...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n166_, new_n168_, new_n169_, new_n172_, new_n173_, new_n184_,
  ...
  aoi21  g149(.a(new_n214_), .b(x79), .c(new_n328_), .O(new_n329_));
  oai21  g150(.a(new_n210_), .b(new_n208_), .c(new_n220_), .O(new_n330_));
  aoi21  g151(.a(new_n330_), .b(x79), .c(new_n214_), .O(new_n331_));
  ...
  aoi21  g157(.a(new_n336_), .b(new_n216_), .c(x01), .O(z60));
  aoi21  g158(.a(new_n164_), .b(new_n163_), .c(new_n203_), .O(new_n341_));
  nor2   g159(.a(new_n317_), .b(x04), .O(new_n342_));
  nor2   g160(.a(new_n207_), .b(new_n157_), .O(new_n343_));
  oai21  g161(.a(new_n342_), .b(new_n341_), .c(new_n343_), .O(new_n344_));
  aoi21  g162(.a(new_n344_), .b(new_n276_), .c(x01), .O(z64));
  zero   g163(.O(z00));
  zero   g164(.O(z06));
  zero   g165(.O(z07));
  zero   g166(.O(z08));
