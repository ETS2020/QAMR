...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n273_, new_n284_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nand2  g140(.a(new_n259_), .b(x14), .O(new_n308_));
  ...
  nand3  g145(.a(new_n246_), .b(x84), .c(new_n312_), .O(new_n313_));
  ...
  aoi21  g149(.a(x84), .b(new_n227_), .c(x76), .O(new_n317_));
  oai21  g150(.a(x84), .b(new_n227_), .c(new_n317_), .O(new_n318_));
  nand2  g151(.a(new_n318_), .b(new_n164_), .O(new_n319_));
  nand4  g152(.a(new_n319_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g153(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n322_));
  inv1   g154(.a(x74), .O(new_n323_));
  nand4  g155(.a(x80), .b(new_n323_), .c(x43), .d(new_n223_), .O(new_n324_));
  oai22  g156(.a(new_n324_), .b(new_n322_), .c(new_n223_), .d(x40), .O(new_n325_));
  nand2  g157(.a(x78), .b(x04), .O(new_n326_));
  inv1   g158(.a(new_n326_), .O(new_n327_));
  nand3  g159(.a(new_n327_), .b(new_n325_), .c(x79), .O(new_n328_));
  nand4  g160(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n329_));
  ...
  oai21  g167(.a(new_n335_), .b(new_n322_), .c(new_n223_), .O(new_n336_));
  ...
  nor2   g195(.a(new_n227_), .b(x78), .O(new_n365_));
