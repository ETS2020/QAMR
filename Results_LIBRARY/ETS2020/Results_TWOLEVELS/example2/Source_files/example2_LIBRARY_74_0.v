...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n256_, new_n257_, new_n261_, new_n263_, new_n267_,
  ...
  nand4  g105(.a(new_n256_), .b(new_n244_), .c(x46), .d(new_n247_), .O(new_n261_));
  inv1   g106(.a(new_n261_), .O(z28));
  nand4  g107(.a(new_n256_), .b(new_n244_), .c(x47), .d(new_n247_), .O(new_n263_));
  inv1   g108(.a(new_n263_), .O(z29));
  nand4  g109(.a(new_n256_), .b(new_n244_), .c(x50), .d(new_n247_), .O(new_n267_));
