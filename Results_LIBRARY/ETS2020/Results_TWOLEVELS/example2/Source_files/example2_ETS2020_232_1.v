...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n272_, new_n274_, new_n276_, new_n278_, new_n288_,
  ...
  nor2   g117(.a(new_n276_), .b(new_n270_), .O(z37));
  nand2  g118(.a(new_n222_), .b(x56), .O(new_n278_));
  nor2   g119(.a(new_n278_), .b(new_n270_), .O(z38));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g122(.a(new_n270_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g123(.a(new_n270_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g124(.a(new_n270_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g125(.a(new_n270_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g126(.a(new_n270_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g127(.a(new_n270_), .b(new_n223_), .c(new_n173_), .O(z46));
  ...
  nand2  g140(.a(new_n261_), .b(x14), .O(new_n306_));
  ...
  nand3  g145(.a(new_n248_), .b(x84), .c(new_n310_), .O(new_n311_));
  ...
  nand4  g153(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n320_));
