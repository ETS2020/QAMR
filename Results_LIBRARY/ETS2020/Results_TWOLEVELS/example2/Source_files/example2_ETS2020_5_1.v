...
module FAU ( 
  ...
  nor3   g122(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g123(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  ...
  nand4  g132(.a(new_n220_), .b(new_n163_), .c(new_n300_), .d(x79), .O(new_n301_));
  nor2   g133(.a(new_n301_), .b(new_n299_), .O(z55));
  aoi21  g134(.a(x84), .b(new_n227_), .c(x76), .O(new_n303_));
  oai21  g135(.a(x84), .b(new_n227_), .c(new_n303_), .O(new_n304_));
  ...
  nand4  g140(.a(x80), .b(new_n309_), .c(x43), .d(new_n223_), .O(new_n310_));
  oai22  g141(.a(new_n310_), .b(new_n308_), .c(new_n223_), .d(x40), .O(new_n311_));
  nand2  g142(.a(x78), .b(x04), .O(new_n312_));
  inv1   g143(.a(new_n312_), .O(new_n313_));
  nand3  g144(.a(new_n313_), .b(new_n311_), .c(x79), .O(new_n314_));
  nand4  g145(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n315_));
  nand2  g146(.a(new_n315_), .b(new_n314_), .O(new_n316_));
  nand2  g147(.a(new_n316_), .b(x77), .O(new_n317_));
  oai21  g148(.a(new_n295_), .b(new_n216_), .c(new_n162_), .O(new_n318_));
  ...
  oai21  g152(.a(new_n321_), .b(new_n308_), .c(new_n223_), .O(new_n322_));
  aoi21  g153(.a(new_n322_), .b(x79), .c(new_n312_), .O(new_n323_));
  oai21  g154(.a(new_n323_), .b(new_n320_), .c(x77), .O(new_n324_));
  nand2  g155(.a(new_n162_), .b(new_n216_), .O(new_n325_));
  ...
  nand2  g160(.a(new_n163_), .b(new_n216_), .O(new_n331_));
  ...
  oai21  g167(.a(x79), .b(new_n216_), .c(new_n337_), .O(new_n338_));
  nand2  g168(.a(new_n338_), .b(new_n160_), .O(new_n339_));
  nand2  g169(.a(new_n322_), .b(x79), .O(new_n340_));
  nand3  g170(.a(x81), .b(x79), .c(new_n216_), .O(new_n341_));
  ...
  nor2   g183(.a(new_n227_), .b(x78), .O(new_n354_));
