...
module FAU ( 
  ...
  nand2  g166(.a(new_n169_), .b(new_n168_), .O(new_n347_));
  nand2  g167(.a(new_n347_), .b(new_n207_), .O(new_n348_));
  oai21  g168(.a(new_n326_), .b(x04), .c(new_n348_), .O(new_n349_));
  nand2  g169(.a(new_n171_), .b(x80), .O(new_n350_));
  inv1   g170(.a(new_n350_), .O(new_n351_));
  and2   g171(.a(new_n351_), .b(new_n349_), .O(z61));
  nand3  g172(.a(new_n349_), .b(x83), .c(x79), .O(new_n355_));
  aoi21  g173(.a(new_n355_), .b(new_n276_), .c(x01), .O(z64));
  zero   g174(.O(z03));
  zero   g175(.O(z06));
  zero   g176(.O(z07));
  zero   g177(.O(z08));
