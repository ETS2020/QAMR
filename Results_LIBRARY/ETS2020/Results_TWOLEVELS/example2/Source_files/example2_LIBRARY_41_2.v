...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n259_, new_n260_, new_n262_, new_n264_, new_n276_, new_n277_,
  ...
  nand4  g073(.a(new_n231_), .b(new_n230_), .c(x46), .d(new_n223_), .O(new_n238_));
  inv1   g074(.a(new_n238_), .O(z28));
  nand4  g075(.a(new_n231_), .b(new_n230_), .c(x47), .d(new_n223_), .O(new_n240_));
  inv1   g076(.a(new_n240_), .O(z29));
  nand4  g077(.a(new_n231_), .b(new_n230_), .c(x48), .d(new_n223_), .O(new_n242_));
  inv1   g078(.a(new_n242_), .O(z30));
  nand4  g079(.a(new_n231_), .b(new_n230_), .c(x49), .d(new_n223_), .O(new_n244_));
  inv1   g080(.a(new_n244_), .O(z31));
  nand4  g081(.a(new_n231_), .b(new_n230_), .c(x50), .d(new_n223_), .O(new_n246_));
  ...
  aoi21  g088(.a(new_n254_), .b(new_n252_), .c(new_n227_), .O(new_n255_));
  nand2  g089(.a(new_n251_), .b(x81), .O(new_n256_));
  nand2  g090(.a(new_n253_), .b(new_n224_), .O(new_n257_));
  aoi21  g091(.a(new_n257_), .b(new_n256_), .c(new_n225_), .O(new_n258_));
  oai21  g092(.a(new_n258_), .b(new_n255_), .c(new_n250_), .O(new_n259_));
  nand2  g093(.a(new_n231_), .b(x53), .O(new_n260_));
  nor2   g094(.a(new_n260_), .b(new_n259_), .O(z35));
  nand2  g095(.a(new_n231_), .b(x54), .O(new_n262_));
  nor2   g096(.a(new_n262_), .b(new_n259_), .O(z36));
  nand2  g097(.a(new_n231_), .b(x55), .O(new_n264_));
  ...
  nor2   g168(.a(new_n160_), .b(x04), .O(new_n350_));
  nor2   g169(.a(new_n224_), .b(x78), .O(new_n351_));
  oai21  g170(.a(new_n351_), .b(new_n350_), .c(x77), .O(new_n352_));
  nand3  g171(.a(x81), .b(x78), .c(new_n159_), .O(new_n353_));
  nand2  g172(.a(new_n171_), .b(x84), .O(new_n354_));
  aoi21  g173(.a(new_n353_), .b(new_n352_), .c(new_n354_), .O(z65));
  zero   g174(.O(z03));
  zero   g175(.O(z06));
  zero   g176(.O(z07));
  zero   g177(.O(z08));
