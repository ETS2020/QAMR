...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n262_, new_n268_, new_n274_, new_n275_, new_n276_, new_n277_,
  ...
  nand2  g094(.a(new_n231_), .b(x61), .O(new_n268_));
  nor2   g095(.a(new_n268_), .b(new_n255_), .O(z43));
  ...
  nand3  g138(.a(new_n316_), .b(new_n231_), .c(new_n161_), .O(new_n317_));
  ...
  oai21  g152(.a(new_n211_), .b(new_n209_), .c(new_n223_), .O(new_n332_));
  ...
  nor2   g166(.a(new_n224_), .b(x78), .O(new_n349_));
