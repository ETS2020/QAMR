...
module FAU ( 
  ...
  nand2  g108(.a(new_n222_), .b(x55), .O(new_n272_));
  ...
  nand2  g132(.a(new_n259_), .b(x14), .O(new_n302_));
  ...
  nand3  g137(.a(new_n246_), .b(x84), .c(new_n306_), .O(new_n307_));
  ...
  nand4  g145(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n316_));
