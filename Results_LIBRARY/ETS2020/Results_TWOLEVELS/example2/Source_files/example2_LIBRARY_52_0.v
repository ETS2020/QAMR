...
module FAU ( 
  ...
  nand2  g193(.a(x52), .b(x22), .O(new_n350_));
  nand2  g194(.a(new_n281_), .b(x14), .O(new_n351_));
  inv1   g195(.a(new_n164_), .O(new_n352_));
  nand4  g196(.a(new_n352_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n353_));
  aoi21  g197(.a(new_n351_), .b(new_n350_), .c(new_n353_), .O(z54));
  inv1   g198(.a(new_n240_), .O(new_n356_));
  xnor2a g199(.a(x84), .b(x81), .O(new_n357_));
  aoi21  g200(.a(new_n165_), .b(new_n164_), .c(new_n357_), .O(new_n358_));
  aoi22  g201(.a(new_n358_), .b(new_n153_), .c(new_n356_), .d(x76), .O(new_n359_));
  aoi21  g202(.a(new_n154_), .b(new_n163_), .c(new_n236_), .O(new_n360_));
  oai21  g203(.a(new_n359_), .b(new_n167_), .c(new_n360_), .O(z56));
  inv1   g204(.a(x02), .O(new_n362_));
  nand3  g205(.a(new_n237_), .b(x03), .c(new_n362_), .O(new_n363_));
  inv1   g206(.a(new_n363_), .O(z57));
  nand2  g207(.a(x42), .b(new_n152_), .O(new_n365_));
  nand4  g208(.a(x80), .b(new_n226_), .c(x43), .d(new_n245_), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(new_n225_), .c(new_n365_), .O(new_n367_));
  nand3  g210(.a(x79), .b(x78), .c(x04), .O(new_n368_));
  inv1   g211(.a(new_n368_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand4  g213(.a(new_n167_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g216(.a(new_n352_), .b(new_n231_), .c(new_n167_), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nand2  g218(.a(new_n232_), .b(new_n228_), .O(new_n377_));
  inv1   g219(.a(new_n377_), .O(new_n378_));
  oai21  g220(.a(new_n227_), .b(new_n225_), .c(new_n378_), .O(new_n379_));
  aoi21  g221(.a(new_n154_), .b(x04), .c(x79), .O(new_n380_));
  aoi21  g222(.a(new_n358_), .b(x79), .c(new_n380_), .O(new_n381_));
  aoi21  g223(.a(new_n381_), .b(new_n379_), .c(x01), .O(z60));
  nand2  g224(.a(new_n165_), .b(new_n164_), .O(new_n383_));
  aoi22  g225(.a(new_n383_), .b(new_n221_), .c(new_n240_), .d(new_n231_), .O(new_n384_));
  nand2  g226(.a(new_n168_), .b(x80), .O(new_n385_));
  nor2   g227(.a(new_n385_), .b(new_n384_), .O(z61));
  nand2  g228(.a(x78), .b(new_n231_), .O(new_n387_));
  nand2  g229(.a(x84), .b(new_n154_), .O(new_n388_));
  aoi21  g230(.a(new_n388_), .b(new_n387_), .c(new_n163_), .O(new_n389_));
  nand2  g231(.a(new_n352_), .b(x84), .O(new_n390_));
  inv1   g232(.a(new_n390_), .O(new_n391_));
  nor2   g233(.a(new_n249_), .b(new_n167_), .O(new_n392_));
  oai21  g234(.a(new_n391_), .b(new_n389_), .c(new_n392_), .O(new_n393_));
  aoi21  g235(.a(new_n393_), .b(new_n233_), .c(x01), .O(z62));
  nand2  g236(.a(new_n168_), .b(x82), .O(new_n395_));
  nor2   g237(.a(new_n395_), .b(new_n384_), .O(z63));
  oai21  g238(.a(new_n249_), .b(x78), .c(new_n387_), .O(new_n398_));
  nand2  g239(.a(new_n398_), .b(x77), .O(new_n399_));
  nand2  g240(.a(new_n352_), .b(x81), .O(new_n400_));
  nand2  g241(.a(new_n168_), .b(x84), .O(new_n401_));
