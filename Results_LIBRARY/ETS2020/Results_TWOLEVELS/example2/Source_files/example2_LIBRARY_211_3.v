// Benchmark "FAU" written by ABC on Sat Jun 27 02:04:57 2020
...
module FAU ( 
  ...
  nand4  g208(.a(x80), .b(new_n224_), .c(x43), .d(new_n241_), .O(new_n366_));
  oai22  g209(.a(new_n366_), .b(new_n223_), .c(new_n241_), .d(x40), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n229_), .c(x79), .O(new_n368_));
  nor2   g211(.a(x79), .b(x78), .O(new_n369_));
  nand3  g212(.a(new_n369_), .b(new_n241_), .c(x40), .O(new_n370_));
  ...
  oai21  g219(.a(new_n225_), .b(new_n223_), .c(new_n241_), .O(new_n377_));
  ...
  nor2   g251(.a(new_n245_), .b(x78), .O(new_n409_));
