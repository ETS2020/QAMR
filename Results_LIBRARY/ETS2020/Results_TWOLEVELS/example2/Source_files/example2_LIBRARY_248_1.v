...
module FAU ( 
  ...
  nand2  g020(.a(new_n152_), .b(x26), .O(new_n176_));
  oai21  g021(.a(new_n175_), .b(new_n152_), .c(new_n176_), .O(z08));
  inv1   g022(.a(x61), .O(new_n178_));
  nand2  g023(.a(new_n152_), .b(x27), .O(new_n179_));
  oai21  g024(.a(new_n178_), .b(new_n152_), .c(new_n179_), .O(z09));
  inv1   g025(.a(x60), .O(new_n181_));
  nand2  g026(.a(new_n152_), .b(x28), .O(new_n182_));
  oai21  g027(.a(new_n181_), .b(new_n152_), .c(new_n182_), .O(z10));
  ...
  nor2   g116(.a(new_n275_), .b(new_n269_), .O(z37));
  nand2  g117(.a(new_n220_), .b(x56), .O(new_n277_));
  nor2   g118(.a(new_n277_), .b(new_n269_), .O(z38));
  nor3   g119(.a(new_n269_), .b(new_n221_), .c(new_n190_), .O(z39));
  nor3   g120(.a(new_n269_), .b(new_n221_), .c(new_n187_), .O(z40));
  nor3   g121(.a(new_n269_), .b(new_n221_), .c(new_n184_), .O(z41));
  nor3   g122(.a(new_n269_), .b(new_n221_), .c(new_n181_), .O(z42));
  nor3   g123(.a(new_n269_), .b(new_n221_), .c(new_n178_), .O(z43));
  nor3   g124(.a(new_n269_), .b(new_n221_), .c(new_n175_), .O(z44));
  nand2  g125(.a(new_n220_), .b(x63), .O(new_n285_));
  nor2   g126(.a(new_n285_), .b(new_n269_), .O(z45));
  nor3   g127(.a(new_n269_), .b(new_n221_), .c(new_n171_), .O(z46));
  ...
  nand2  g140(.a(new_n260_), .b(x14), .O(new_n306_));
  ...
  nand3  g145(.a(new_n247_), .b(x84), .c(new_n310_), .O(new_n311_));
  inv1   g146(.a(x80), .O(new_n312_));
  nand4  g147(.a(new_n220_), .b(new_n163_), .c(new_n312_), .d(x79), .O(new_n313_));
  nor2   g148(.a(new_n313_), .b(new_n311_), .O(z55));
  aoi21  g149(.a(x84), .b(new_n227_), .c(x76), .O(new_n315_));
  oai21  g150(.a(x84), .b(new_n227_), .c(new_n315_), .O(new_n316_));
  nand2  g151(.a(new_n316_), .b(new_n164_), .O(new_n317_));
  nand4  g152(.a(new_n317_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g153(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n320_));
  inv1   g154(.a(x74), .O(new_n321_));
  nand4  g155(.a(x80), .b(new_n321_), .c(x43), .d(new_n223_), .O(new_n322_));
  oai22  g156(.a(new_n322_), .b(new_n320_), .c(new_n223_), .d(x40), .O(new_n323_));
  nand2  g157(.a(x78), .b(x04), .O(new_n324_));
  inv1   g158(.a(new_n324_), .O(new_n325_));
  nand3  g159(.a(new_n325_), .b(new_n323_), .c(x79), .O(new_n326_));
  nand4  g160(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n327_));
  nand2  g161(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  nand2  g162(.a(new_n328_), .b(x77), .O(new_n329_));
  oai21  g163(.a(new_n307_), .b(new_n216_), .c(new_n162_), .O(new_n330_));
  ...
  oai21  g180(.a(x79), .b(new_n216_), .c(new_n347_), .O(new_n348_));
  nand2  g181(.a(new_n348_), .b(new_n160_), .O(new_n349_));
  nand2  g182(.a(new_n334_), .b(x79), .O(new_n350_));
  nand3  g183(.a(x81), .b(x79), .c(new_n216_), .O(new_n351_));
  ...
  nor2   g195(.a(new_n227_), .b(x78), .O(new_n363_));
