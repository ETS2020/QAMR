// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:13 2020
...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n203_, new_n204_, new_n208_, new_n209_, new_n211_, new_n212_,
    new_n214_, new_n215_, new_n217_, new_n218_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n224_, new_n225_, new_n226_, new_n227_,
    new_n228_, new_n229_, new_n230_, new_n231_, new_n233_, new_n234_,
    new_n236_, new_n237_, new_n238_, new_n239_, new_n242_, new_n243_,
    new_n244_, new_n245_, new_n246_, new_n247_, new_n248_, new_n249_,
    new_n250_, new_n252_, new_n254_, new_n257_, new_n259_, new_n261_,
  ...
  inv1   g081(.a(x05), .O(new_n236_));
  nor2   g082(.a(new_n155_), .b(new_n157_), .O(new_n237_));
  nor2   g083(.a(x04), .b(x01), .O(new_n238_));
  inv1   g084(.a(new_n238_), .O(new_n239_));
  nor4   g085(.a(new_n239_), .b(new_n237_), .c(x43), .d(new_n236_), .O(z24));
  ...
  aoi21  g093(.a(new_n248_), .b(new_n245_), .c(new_n156_), .O(new_n249_));
  nand4  g094(.a(new_n249_), .b(new_n238_), .c(x44), .d(new_n242_), .O(new_n250_));
  inv1   g095(.a(new_n250_), .O(z26));
  nand4  g096(.a(new_n249_), .b(new_n238_), .c(x45), .d(new_n242_), .O(new_n252_));
  inv1   g097(.a(new_n252_), .O(z27));
  nand4  g098(.a(new_n249_), .b(new_n238_), .c(x46), .d(new_n242_), .O(new_n254_));
  inv1   g099(.a(new_n254_), .O(z28));
  nand4  g100(.a(new_n249_), .b(new_n238_), .c(x48), .d(new_n242_), .O(new_n257_));
  inv1   g101(.a(new_n257_), .O(z30));
  nand4  g102(.a(new_n249_), .b(new_n238_), .c(x49), .d(new_n242_), .O(new_n259_));
  inv1   g103(.a(new_n259_), .O(z31));
  nand4  g104(.a(new_n249_), .b(new_n238_), .c(x50), .d(new_n242_), .O(new_n261_));
  inv1   g105(.a(new_n261_), .O(z32));
  nor2   g106(.a(new_n223_), .b(x81), .O(new_n263_));
  nor2   g107(.a(x83), .b(new_n246_), .O(new_n264_));
  nor2   g108(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g109(.a(x42), .b(x05), .O(new_n266_));
  nand2  g110(.a(x51), .b(new_n242_), .O(new_n267_));
  oai22  g111(.a(new_n267_), .b(new_n246_), .c(new_n266_), .d(new_n265_), .O(new_n268_));
  nand2  g112(.a(new_n268_), .b(new_n244_), .O(new_n269_));
  xor2a  g113(.a(x83), .b(x81), .O(new_n270_));
  oai22  g114(.a(new_n270_), .b(new_n266_), .c(new_n267_), .d(x81), .O(new_n271_));
  nand2  g115(.a(new_n271_), .b(new_n247_), .O(new_n272_));
  inv1   g116(.a(new_n156_), .O(new_n273_));
  nand2  g117(.a(new_n238_), .b(new_n273_), .O(new_n274_));
  aoi21  g118(.a(new_n272_), .b(new_n269_), .c(new_n274_), .O(z33));
  inv1   g119(.a(x52), .O(new_n276_));
  nand2  g120(.a(x83), .b(x42), .O(new_n277_));
  nand2  g121(.a(new_n277_), .b(new_n246_), .O(new_n278_));
  nand3  g122(.a(x83), .b(x81), .c(x42), .O(new_n279_));
  nand2  g123(.a(new_n279_), .b(new_n278_), .O(new_n280_));
  and2   g124(.a(new_n280_), .b(new_n247_), .O(new_n281_));
  nand2  g125(.a(new_n277_), .b(x81), .O(new_n282_));
  nand2  g126(.a(new_n263_), .b(x42), .O(new_n283_));
  aoi21  g127(.a(new_n283_), .b(new_n282_), .c(new_n243_), .O(new_n284_));
  oai21  g128(.a(new_n284_), .b(new_n281_), .c(new_n273_), .O(new_n285_));
  nor3   g129(.a(new_n285_), .b(new_n239_), .c(new_n276_), .O(z34));
  nand2  g130(.a(new_n238_), .b(x53), .O(new_n287_));
  nor2   g131(.a(new_n287_), .b(new_n285_), .O(z35));
  nand2  g132(.a(new_n238_), .b(x54), .O(new_n289_));
  nor2   g133(.a(new_n289_), .b(new_n285_), .O(z36));
  nand2  g134(.a(new_n238_), .b(x55), .O(new_n291_));
  nor2   g135(.a(new_n291_), .b(new_n285_), .O(z37));
  nand2  g136(.a(new_n238_), .b(x56), .O(new_n293_));
  nor2   g137(.a(new_n293_), .b(new_n285_), .O(z38));
  nor3   g138(.a(new_n285_), .b(new_n239_), .c(new_n197_), .O(z39));
  nor3   g139(.a(new_n285_), .b(new_n239_), .c(new_n194_), .O(z40));
  nor3   g140(.a(new_n285_), .b(new_n239_), .c(new_n191_), .O(z41));
  nor3   g141(.a(new_n285_), .b(new_n239_), .c(new_n188_), .O(z42));
  nor3   g142(.a(new_n285_), .b(new_n239_), .c(new_n185_), .O(z43));
  nor3   g143(.a(new_n285_), .b(new_n239_), .c(new_n182_), .O(z44));
  nor3   g144(.a(new_n285_), .b(new_n239_), .c(new_n179_), .O(z45));
  nor3   g145(.a(new_n285_), .b(new_n239_), .c(new_n176_), .O(z46));
  ...
  nand2  g197(.a(new_n276_), .b(x14), .O(new_n354_));
  ...
  nand3  g201(.a(new_n263_), .b(x84), .c(new_n357_), .O(new_n358_));
  inv1   g202(.a(x80), .O(new_n359_));
  nand4  g203(.a(new_n238_), .b(new_n155_), .c(new_n359_), .d(x79), .O(new_n360_));
  ...
  nand4  g208(.a(x80), .b(new_n225_), .c(x43), .d(new_n242_), .O(new_n366_));
  oai22  g209(.a(new_n366_), .b(new_n224_), .c(new_n242_), .d(x40), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n230_), .c(x79), .O(new_n368_));
  nand4  g211(.a(new_n157_), .b(new_n154_), .c(new_n242_), .d(x40), .O(new_n369_));
  ...
  oai21  g217(.a(new_n226_), .b(new_n224_), .c(new_n242_), .O(new_n375_));
  ...
  nand2  g229(.a(new_n155_), .b(new_n233_), .O(new_n387_));
  ...
  nor2   g249(.a(new_n246_), .b(x78), .O(new_n407_));
