...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n258_, new_n260_, new_n262_, new_n266_, new_n268_,
  ...
  nand4  g108(.a(new_n255_), .b(new_n242_), .c(x50), .d(new_n246_), .O(new_n266_));
  ...
  nand2  g131(.a(new_n242_), .b(x53), .O(new_n289_));
  ...
  nor3   g137(.a(new_n287_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g138(.a(new_n287_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g139(.a(new_n287_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g140(.a(new_n287_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g141(.a(new_n287_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g142(.a(new_n287_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g143(.a(new_n287_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g144(.a(new_n287_), .b(new_n243_), .c(new_n176_), .O(z46));
  ...
  nand2  g194(.a(new_n279_), .b(x14), .O(new_n353_));
