// Benchmark "FAU" written by ABC on Sat Jun 27 01:52:09 2020
...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n316_, new_n318_, new_n319_, new_n322_, new_n323_, new_n324_,
    new_n325_, new_n326_, new_n327_, new_n328_, new_n330_, new_n335_,
  ...
  nand2  g122(.a(new_n301_), .b(new_n275_), .O(new_n302_));
  nand2  g123(.a(new_n277_), .b(x73), .O(new_n303_));
  aoi21  g124(.a(new_n303_), .b(new_n302_), .c(x01), .O(z53));
  nand2  g125(.a(x84), .b(x83), .O(new_n306_));
  nor2   g126(.a(x80), .b(new_n157_), .O(new_n307_));
  nand3  g127(.a(new_n307_), .b(new_n226_), .c(new_n155_), .O(new_n308_));
  nor4   g128(.a(new_n308_), .b(new_n306_), .c(x82), .d(x81), .O(z55));
  inv1   g129(.a(x01), .O(new_n310_));
  inv1   g130(.a(new_n155_), .O(new_n311_));
  xnor2a g131(.a(x84), .b(x81), .O(new_n312_));
  aoi21  g132(.a(new_n164_), .b(new_n163_), .c(new_n312_), .O(new_n313_));
  aoi22  g133(.a(new_n313_), .b(new_n310_), .c(new_n311_), .d(x76), .O(new_n314_));
  inv1   g134(.a(x00), .O(new_n315_));
  nor3   g135(.a(new_n158_), .b(x01), .c(new_n315_), .O(new_n316_));
  oai21  g136(.a(new_n314_), .b(new_n157_), .c(new_n316_), .O(z56));
  inv1   g137(.a(x02), .O(new_n318_));
  nand4  g138(.a(x03), .b(new_n318_), .c(new_n310_), .d(x00), .O(new_n319_));
  inv1   g139(.a(new_n319_), .O(z57));
  inv1   g140(.a(x40), .O(new_n322_));
  aoi21  g141(.a(new_n212_), .b(x79), .c(new_n322_), .O(new_n323_));
  oai21  g142(.a(new_n208_), .b(new_n206_), .c(new_n218_), .O(new_n324_));
  aoi21  g143(.a(new_n324_), .b(x79), .c(new_n212_), .O(new_n325_));
  oai21  g144(.a(new_n325_), .b(new_n323_), .c(x77), .O(new_n326_));
  nor2   g145(.a(x79), .b(x04), .O(new_n327_));
  inv1   g146(.a(new_n327_), .O(new_n328_));
  aoi21  g147(.a(new_n328_), .b(new_n326_), .c(x01), .O(z59));
  aoi21  g148(.a(new_n313_), .b(x79), .c(new_n327_), .O(new_n330_));
  aoi21  g149(.a(new_n330_), .b(new_n214_), .c(x01), .O(z60));
  aoi21  g150(.a(new_n164_), .b(new_n163_), .c(new_n201_), .O(new_n335_));
  nor2   g151(.a(new_n311_), .b(x04), .O(new_n336_));
  nor2   g152(.a(new_n205_), .b(new_n157_), .O(new_n337_));
  oai21  g153(.a(new_n336_), .b(new_n335_), .c(new_n337_), .O(new_n338_));
  aoi21  g154(.a(new_n338_), .b(new_n274_), .c(x01), .O(z64));
  zero   g155(.O(z00));
  zero   g156(.O(z03));
  zero   g157(.O(z06));
  zero   g158(.O(z07));
