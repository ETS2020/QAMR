// Benchmark "FAU" written by ABC on Sat Jun 27 02:08:03 2020
...
module FAU ( 
  ...
  nor3   g121(.a(new_n271_), .b(new_n225_), .c(new_n194_), .O(z39));
  nor3   g122(.a(new_n271_), .b(new_n225_), .c(new_n191_), .O(z40));
  nor3   g123(.a(new_n271_), .b(new_n225_), .c(new_n188_), .O(z41));
  nor3   g124(.a(new_n271_), .b(new_n225_), .c(new_n185_), .O(z42));
  nor3   g125(.a(new_n271_), .b(new_n225_), .c(new_n182_), .O(z43));
  nor3   g126(.a(new_n271_), .b(new_n225_), .c(new_n179_), .O(z44));
  nor3   g127(.a(new_n271_), .b(new_n225_), .c(new_n173_), .O(z46));
  inv1   g128(.a(x07), .O(new_n289_));
  nand2  g129(.a(x52), .b(x15), .O(new_n290_));
  oai21  g130(.a(x52), .b(new_n289_), .c(new_n290_), .O(new_n291_));
  nand3  g131(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n292_));
  inv1   g132(.a(new_n292_), .O(new_n293_));
  nand2  g133(.a(new_n293_), .b(new_n291_), .O(new_n294_));
  xnor2a g134(.a(x84), .b(x81), .O(new_n295_));
  or2    g135(.a(x75), .b(x67), .O(new_n296_));
  nor2   g136(.a(x78), .b(new_n160_), .O(new_n297_));
  nand4  g137(.a(new_n297_), .b(new_n296_), .c(new_n295_), .d(x79), .O(new_n298_));
  aoi21  g138(.a(new_n298_), .b(new_n294_), .c(x01), .O(z47));
  nand2  g139(.a(x52), .b(x22), .O(new_n306_));
  nand2  g140(.a(new_n262_), .b(x14), .O(new_n307_));
  nor2   g141(.a(new_n154_), .b(x77), .O(new_n308_));
  nand4  g142(.a(new_n308_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n309_));
  aoi21  g143(.a(new_n307_), .b(new_n306_), .c(new_n309_), .O(z54));
  inv1   g144(.a(x82), .O(new_n311_));
  nand3  g145(.a(new_n249_), .b(x84), .c(new_n311_), .O(new_n312_));
  inv1   g146(.a(x80), .O(new_n313_));
  nand4  g147(.a(new_n224_), .b(new_n163_), .c(new_n313_), .d(x79), .O(new_n314_));
  nor2   g148(.a(new_n314_), .b(new_n312_), .O(z55));
  aoi21  g149(.a(x84), .b(new_n231_), .c(x76), .O(new_n316_));
  oai21  g150(.a(x84), .b(new_n231_), .c(new_n316_), .O(new_n317_));
  nand2  g151(.a(new_n317_), .b(new_n164_), .O(new_n318_));
  nand4  g152(.a(new_n318_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g153(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n321_));
  inv1   g154(.a(x74), .O(new_n322_));
  nand4  g155(.a(x80), .b(new_n322_), .c(x43), .d(new_n227_), .O(new_n323_));
  oai22  g156(.a(new_n323_), .b(new_n321_), .c(new_n227_), .d(x40), .O(new_n324_));
  nand2  g157(.a(x78), .b(x04), .O(new_n325_));
  inv1   g158(.a(new_n325_), .O(new_n326_));
  nand3  g159(.a(new_n326_), .b(new_n324_), .c(x79), .O(new_n327_));
  nand4  g160(.a(new_n162_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n328_));
  nand2  g161(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand2  g162(.a(new_n329_), .b(x77), .O(new_n330_));
  oai21  g163(.a(new_n308_), .b(new_n220_), .c(new_n162_), .O(new_n331_));
  aoi21  g164(.a(new_n331_), .b(new_n330_), .c(x01), .O(z58));
  aoi21  g165(.a(new_n325_), .b(x79), .c(new_n152_), .O(new_n333_));
  nand3  g166(.a(x80), .b(new_n322_), .c(x43), .O(new_n334_));
  oai21  g167(.a(new_n334_), .b(new_n321_), .c(new_n227_), .O(new_n335_));
  aoi21  g168(.a(new_n335_), .b(x79), .c(new_n325_), .O(new_n336_));
  oai21  g169(.a(new_n336_), .b(new_n333_), .c(x77), .O(new_n337_));
  nand2  g170(.a(new_n162_), .b(new_n220_), .O(new_n338_));
  aoi21  g171(.a(new_n338_), .b(new_n337_), .c(x01), .O(z59));
  oai21  g172(.a(new_n308_), .b(new_n297_), .c(new_n295_), .O(new_n341_));
  nand2  g173(.a(new_n163_), .b(new_n220_), .O(new_n342_));
  ...
  nor3   g178(.a(new_n346_), .b(new_n344_), .c(new_n313_), .O(z61));
  nand3  g179(.a(x84), .b(x81), .c(x79), .O(new_n348_));
  oai21  g180(.a(x79), .b(new_n220_), .c(new_n348_), .O(new_n349_));
  nand2  g181(.a(new_n349_), .b(new_n160_), .O(new_n350_));
  nand2  g182(.a(new_n335_), .b(x79), .O(new_n351_));
  nand3  g183(.a(x81), .b(x79), .c(new_n220_), .O(new_n352_));
  ...
  nand2  g189(.a(new_n357_), .b(new_n297_), .O(new_n358_));
  aoi21  g190(.a(new_n358_), .b(new_n356_), .c(x01), .O(z62));
  nor3   g191(.a(new_n346_), .b(new_n344_), .c(new_n311_), .O(z63));
  nand3  g192(.a(new_n343_), .b(x83), .c(x79), .O(new_n361_));
  aoi21  g193(.a(new_n361_), .b(new_n292_), .c(x01), .O(z64));
  nor2   g194(.a(new_n154_), .b(x04), .O(new_n363_));
  nor2   g195(.a(new_n231_), .b(x78), .O(new_n364_));
  oai21  g196(.a(new_n364_), .b(new_n363_), .c(x77), .O(new_n365_));
  nand2  g197(.a(new_n308_), .b(x81), .O(new_n366_));
