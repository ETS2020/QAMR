...
module FAU ( 
  ...
  oai21  g156(.a(new_n303_), .b(new_n216_), .c(new_n162_), .O(new_n326_));
  aoi21  g157(.a(new_n326_), .b(new_n325_), .c(x01), .O(z58));
  aoi21  g158(.a(new_n320_), .b(x79), .c(new_n152_), .O(new_n328_));
  nand3  g159(.a(x80), .b(new_n317_), .c(x43), .O(new_n329_));
  oai21  g160(.a(new_n329_), .b(new_n316_), .c(new_n223_), .O(new_n330_));
  aoi21  g161(.a(new_n330_), .b(x79), .c(new_n320_), .O(new_n331_));
  oai21  g162(.a(new_n331_), .b(new_n328_), .c(x77), .O(new_n332_));
  nand2  g163(.a(new_n162_), .b(new_n216_), .O(new_n333_));
  aoi21  g164(.a(new_n333_), .b(new_n332_), .c(x01), .O(z59));
  oai21  g165(.a(new_n303_), .b(new_n292_), .c(new_n290_), .O(new_n336_));
  nand2  g166(.a(new_n163_), .b(new_n216_), .O(new_n337_));
  nand2  g167(.a(new_n337_), .b(new_n336_), .O(new_n338_));
  inv1   g168(.a(new_n338_), .O(new_n339_));
  nor2   g169(.a(new_n162_), .b(x01), .O(new_n340_));
  inv1   g170(.a(new_n340_), .O(new_n341_));
  nor3   g171(.a(new_n341_), .b(new_n339_), .c(new_n308_), .O(z61));
  nand3  g172(.a(x84), .b(x81), .c(x79), .O(new_n343_));
  oai21  g173(.a(x79), .b(new_n216_), .c(new_n343_), .O(new_n344_));
  nand2  g174(.a(new_n344_), .b(new_n160_), .O(new_n345_));
  nand2  g175(.a(new_n330_), .b(x79), .O(new_n346_));
  nand3  g176(.a(x81), .b(x79), .c(new_n216_), .O(new_n347_));
  inv1   g177(.a(new_n347_), .O(new_n348_));
  aoi21  g178(.a(new_n346_), .b(x04), .c(new_n348_), .O(new_n349_));
  oai21  g179(.a(new_n349_), .b(new_n160_), .c(new_n345_), .O(new_n350_));
  nand2  g180(.a(new_n350_), .b(x78), .O(new_n351_));
  inv1   g181(.a(new_n343_), .O(new_n352_));
  nand2  g182(.a(new_n352_), .b(new_n292_), .O(new_n353_));
  aoi21  g183(.a(new_n353_), .b(new_n351_), .c(x01), .O(z62));
  nor3   g184(.a(new_n341_), .b(new_n339_), .c(new_n306_), .O(z63));
  nand3  g185(.a(new_n338_), .b(x83), .c(x79), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n287_), .c(x01), .O(z64));
  nor2   g187(.a(new_n154_), .b(x04), .O(new_n358_));
  nor2   g188(.a(new_n227_), .b(x78), .O(new_n359_));
  oai21  g189(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand2  g190(.a(new_n303_), .b(x81), .O(new_n361_));
  nand2  g191(.a(new_n340_), .b(x84), .O(new_n362_));
  aoi21  g192(.a(new_n361_), .b(new_n360_), .c(new_n362_), .O(z65));
  zero   g193(.O(z02));
  zero   g194(.O(z04));
  zero   g195(.O(z15));
  zero   g196(.O(z18));
