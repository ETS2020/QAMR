...
module FAU ( 
  ...
  nand4  g091(.a(new_n245_), .b(new_n235_), .c(x45), .d(new_n238_), .O(new_n249_));
  ...
  nor2   g103(.a(new_n219_), .b(x81), .O(new_n261_));
  ...
  nor3   g133(.a(new_n283_), .b(new_n236_), .c(new_n195_), .O(z39));
  nor3   g134(.a(new_n283_), .b(new_n236_), .c(new_n192_), .O(z40));
  nor3   g135(.a(new_n283_), .b(new_n236_), .c(new_n189_), .O(z41));
  nor3   g136(.a(new_n283_), .b(new_n236_), .c(new_n186_), .O(z42));
  nor3   g137(.a(new_n283_), .b(new_n236_), .c(new_n183_), .O(z43));
  nor3   g138(.a(new_n283_), .b(new_n236_), .c(new_n180_), .O(z44));
  nor3   g139(.a(new_n283_), .b(new_n236_), .c(new_n177_), .O(z45));
  nor3   g140(.a(new_n283_), .b(new_n236_), .c(new_n174_), .O(z46));
  ...
  nand2  g145(.a(new_n303_), .b(new_n226_), .O(new_n304_));
  ...
  nand2  g151(.a(new_n309_), .b(new_n216_), .O(new_n310_));
  ...
  inv1   g157(.a(new_n216_), .O(new_n316_));
  ...
  nand4  g193(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n229_), .O(new_n352_));
  ...
  nand4  g201(.a(x03), .b(new_n360_), .c(new_n229_), .d(x00), .O(new_n361_));
  inv1   g202(.a(new_n361_), .O(z57));
  nand4  g203(.a(x80), .b(new_n221_), .c(x43), .d(new_n238_), .O(new_n363_));
  oai22  g204(.a(new_n363_), .b(new_n220_), .c(new_n238_), .d(x40), .O(new_n364_));
  nand3  g205(.a(new_n364_), .b(new_n226_), .c(x79), .O(new_n365_));
  ...
  aoi21  g211(.a(new_n225_), .b(x79), .c(new_n173_), .O(new_n371_));
  oai21  g212(.a(new_n222_), .b(new_n220_), .c(new_n238_), .O(new_n372_));
  aoi21  g213(.a(new_n372_), .b(x79), .c(new_n225_), .O(new_n373_));
  ...
  aoi21  g221(.a(new_n380_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g222(.a(new_n166_), .O(new_n382_));
  oai21  g223(.a(new_n163_), .b(new_n161_), .c(new_n216_), .O(new_n383_));
  nand2  g224(.a(new_n155_), .b(new_n230_), .O(new_n384_));
  ...
  oai21  g229(.a(x79), .b(new_n230_), .c(new_n388_), .O(new_n389_));
  nand2  g230(.a(new_n389_), .b(new_n153_), .O(new_n390_));
  nand2  g231(.a(new_n372_), .b(x79), .O(new_n391_));
  nand3  g232(.a(x81), .b(x79), .c(new_n230_), .O(new_n392_));
  ...
  nor2   g244(.a(new_n242_), .b(x78), .O(new_n404_));
