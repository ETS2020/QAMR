...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n232_, new_n233_, new_n234_, new_n235_, new_n239_, new_n241_,
  ...
  nand4  g081(.a(new_n234_), .b(new_n222_), .c(x48), .d(new_n226_), .O(new_n241_));
  inv1   g082(.a(new_n241_), .O(z30));
  nand4  g083(.a(new_n234_), .b(new_n222_), .c(x49), .d(new_n226_), .O(new_n243_));
  inv1   g084(.a(new_n243_), .O(z31));
  inv1   g085(.a(x83), .O(new_n246_));
  nor2   g086(.a(new_n246_), .b(x81), .O(new_n247_));
  nor2   g087(.a(x83), .b(new_n230_), .O(new_n248_));
  nor2   g088(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand2  g089(.a(x42), .b(x05), .O(new_n250_));
  nand2  g090(.a(x51), .b(new_n226_), .O(new_n251_));
  oai22  g091(.a(new_n251_), .b(new_n230_), .c(new_n250_), .d(new_n249_), .O(new_n252_));
  nand2  g092(.a(new_n252_), .b(new_n228_), .O(new_n253_));
  xor2a  g093(.a(x83), .b(x81), .O(new_n254_));
  oai22  g094(.a(new_n254_), .b(new_n250_), .c(new_n251_), .d(x81), .O(new_n255_));
  nand2  g095(.a(new_n255_), .b(new_n231_), .O(new_n256_));
  inv1   g096(.a(new_n233_), .O(new_n257_));
  ...
  nor3   g120(.a(new_n269_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g121(.a(new_n269_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g122(.a(new_n269_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g123(.a(new_n269_), .b(new_n223_), .c(new_n173_), .O(z46));
  ...
  aoi21  g134(.a(x84), .b(new_n230_), .c(x76), .O(new_n303_));
  oai21  g135(.a(x84), .b(new_n230_), .c(new_n303_), .O(new_n304_));
  ...
  nand4  g140(.a(x80), .b(new_n309_), .c(x43), .d(new_n226_), .O(new_n310_));
  oai22  g141(.a(new_n310_), .b(new_n308_), .c(new_n226_), .d(x40), .O(new_n311_));
  nand2  g142(.a(x78), .b(x04), .O(new_n312_));
  inv1   g143(.a(new_n312_), .O(new_n313_));
  nand3  g144(.a(new_n313_), .b(new_n311_), .c(x79), .O(new_n314_));
  nand4  g145(.a(new_n162_), .b(new_n154_), .c(new_n226_), .d(x40), .O(new_n315_));
  ...
  oai21  g152(.a(new_n321_), .b(new_n308_), .c(new_n226_), .O(new_n322_));
  ...
  nor2   g183(.a(new_n230_), .b(x78), .O(new_n354_));
