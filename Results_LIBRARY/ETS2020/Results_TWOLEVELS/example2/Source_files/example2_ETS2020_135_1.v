// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:17 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n271_, new_n272_, new_n277_, new_n287_, new_n288_,
  ...
  nand2  g115(.a(new_n224_), .b(x56), .O(new_n277_));
  nor2   g116(.a(new_n277_), .b(new_n272_), .O(z38));
  nor3   g117(.a(new_n272_), .b(new_n225_), .c(new_n194_), .O(z39));
  nor3   g118(.a(new_n272_), .b(new_n225_), .c(new_n191_), .O(z40));
  nor3   g119(.a(new_n272_), .b(new_n225_), .c(new_n188_), .O(z41));
  nor3   g120(.a(new_n272_), .b(new_n225_), .c(new_n185_), .O(z42));
  nor3   g121(.a(new_n272_), .b(new_n225_), .c(new_n182_), .O(z43));
  nor3   g122(.a(new_n272_), .b(new_n225_), .c(new_n179_), .O(z44));
  nor3   g123(.a(new_n272_), .b(new_n225_), .c(new_n176_), .O(z45));
  nor3   g124(.a(new_n272_), .b(new_n225_), .c(new_n173_), .O(z46));
  inv1   g125(.a(x07), .O(new_n287_));
  nand2  g126(.a(x52), .b(x15), .O(new_n288_));
  oai21  g127(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand3  g128(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n290_));
  inv1   g129(.a(new_n290_), .O(new_n291_));
  nand2  g130(.a(new_n291_), .b(new_n289_), .O(new_n292_));
  xnor2a g131(.a(x84), .b(x81), .O(new_n293_));
  or2    g132(.a(x75), .b(x67), .O(new_n294_));
  nor2   g133(.a(x78), .b(new_n160_), .O(new_n295_));
  nand4  g134(.a(new_n295_), .b(new_n294_), .c(new_n293_), .d(x79), .O(new_n296_));
  aoi21  g135(.a(new_n296_), .b(new_n292_), .c(x01), .O(z47));
  nand2  g136(.a(x52), .b(x22), .O(new_n304_));
  nand2  g137(.a(new_n263_), .b(x14), .O(new_n305_));
  nor2   g138(.a(new_n154_), .b(x77), .O(new_n306_));
  nand4  g139(.a(new_n306_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n307_));
  aoi21  g140(.a(new_n305_), .b(new_n304_), .c(new_n307_), .O(z54));
  inv1   g141(.a(x82), .O(new_n309_));
  nand3  g142(.a(new_n250_), .b(x84), .c(new_n309_), .O(new_n310_));
  inv1   g143(.a(x80), .O(new_n311_));
  nand4  g144(.a(new_n224_), .b(new_n163_), .c(new_n311_), .d(x79), .O(new_n312_));
  nor2   g145(.a(new_n312_), .b(new_n310_), .O(z55));
  aoi21  g146(.a(x84), .b(new_n231_), .c(x76), .O(new_n314_));
  oai21  g147(.a(x84), .b(new_n231_), .c(new_n314_), .O(new_n315_));
  nand2  g148(.a(new_n315_), .b(new_n164_), .O(new_n316_));
  nand4  g149(.a(new_n316_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g150(.a(x84), .b(new_n249_), .c(x82), .d(x81), .O(new_n319_));
  inv1   g151(.a(x74), .O(new_n320_));
  nand4  g152(.a(x80), .b(new_n320_), .c(x43), .d(new_n227_), .O(new_n321_));
  oai22  g153(.a(new_n321_), .b(new_n319_), .c(new_n227_), .d(x40), .O(new_n322_));
  nand2  g154(.a(x78), .b(x04), .O(new_n323_));
  inv1   g155(.a(new_n323_), .O(new_n324_));
  nand3  g156(.a(new_n324_), .b(new_n322_), .c(x79), .O(new_n325_));
  nand4  g157(.a(new_n162_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n326_));
  nand2  g158(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand2  g159(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g160(.a(new_n306_), .b(new_n220_), .c(new_n162_), .O(new_n329_));
  aoi21  g161(.a(new_n329_), .b(new_n328_), .c(x01), .O(z58));
  aoi21  g162(.a(new_n323_), .b(x79), .c(new_n152_), .O(new_n331_));
  nand3  g163(.a(x80), .b(new_n320_), .c(x43), .O(new_n332_));
  oai21  g164(.a(new_n332_), .b(new_n319_), .c(new_n227_), .O(new_n333_));
  aoi21  g165(.a(new_n333_), .b(x79), .c(new_n323_), .O(new_n334_));
  oai21  g166(.a(new_n334_), .b(new_n331_), .c(x77), .O(new_n335_));
  nand2  g167(.a(new_n162_), .b(new_n220_), .O(new_n336_));
  aoi21  g168(.a(new_n336_), .b(new_n335_), .c(x01), .O(z59));
  oai21  g169(.a(new_n306_), .b(new_n295_), .c(new_n293_), .O(new_n339_));
  nand2  g170(.a(new_n163_), .b(new_n220_), .O(new_n340_));
  nand2  g171(.a(new_n340_), .b(new_n339_), .O(new_n341_));
  inv1   g172(.a(new_n341_), .O(new_n342_));
  nor2   g173(.a(new_n162_), .b(x01), .O(new_n343_));
  inv1   g174(.a(new_n343_), .O(new_n344_));
  nor3   g175(.a(new_n344_), .b(new_n342_), .c(new_n311_), .O(z61));
  nand3  g176(.a(x84), .b(x81), .c(x79), .O(new_n346_));
  oai21  g177(.a(x79), .b(new_n220_), .c(new_n346_), .O(new_n347_));
  nand2  g178(.a(new_n347_), .b(new_n160_), .O(new_n348_));
  nand2  g179(.a(new_n333_), .b(x79), .O(new_n349_));
  nand3  g180(.a(x81), .b(x79), .c(new_n220_), .O(new_n350_));
  inv1   g181(.a(new_n350_), .O(new_n351_));
  aoi21  g182(.a(new_n349_), .b(x04), .c(new_n351_), .O(new_n352_));
  oai21  g183(.a(new_n352_), .b(new_n160_), .c(new_n348_), .O(new_n353_));
  nand2  g184(.a(new_n353_), .b(x78), .O(new_n354_));
  inv1   g185(.a(new_n346_), .O(new_n355_));
  nand2  g186(.a(new_n355_), .b(new_n295_), .O(new_n356_));
  aoi21  g187(.a(new_n356_), .b(new_n354_), .c(x01), .O(z62));
  nor3   g188(.a(new_n344_), .b(new_n342_), .c(new_n309_), .O(z63));
  nand3  g189(.a(new_n341_), .b(x83), .c(x79), .O(new_n359_));
  aoi21  g190(.a(new_n359_), .b(new_n290_), .c(x01), .O(z64));
  nor2   g191(.a(new_n154_), .b(x04), .O(new_n361_));
  nor2   g192(.a(new_n231_), .b(x78), .O(new_n362_));
  oai21  g193(.a(new_n362_), .b(new_n361_), .c(x77), .O(new_n363_));
  nand2  g194(.a(new_n306_), .b(x81), .O(new_n364_));
  nand2  g195(.a(new_n343_), .b(x84), .O(new_n365_));
  aoi21  g196(.a(new_n364_), .b(new_n363_), .c(new_n365_), .O(z65));
  zero   g197(.O(z02));
  zero   g198(.O(z04));
  zero   g199(.O(z18));
  zero   g200(.O(z22));
