...
module FAU ( 
  ...
  nor3   g146(.a(new_n291_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g147(.a(new_n291_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g148(.a(new_n291_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g149(.a(new_n291_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g150(.a(new_n291_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g151(.a(new_n291_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g152(.a(new_n291_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g153(.a(new_n291_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g203(.a(new_n283_), .b(x14), .O(new_n358_));
