...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n282_, new_n284_, new_n286_, new_n288_, new_n293_, new_n300_,
  ...
  nand2  g134(.a(new_n234_), .b(x59), .O(new_n293_));
  nor2   g135(.a(new_n293_), .b(new_n282_), .O(z41));
  nor3   g136(.a(new_n282_), .b(new_n235_), .c(new_n188_), .O(z42));
  nor3   g137(.a(new_n282_), .b(new_n235_), .c(new_n185_), .O(z43));
  nor3   g138(.a(new_n282_), .b(new_n235_), .c(new_n182_), .O(z44));
  nor3   g139(.a(new_n282_), .b(new_n235_), .c(new_n179_), .O(z45));
  nor3   g140(.a(new_n282_), .b(new_n235_), .c(new_n176_), .O(z46));
  ...
  nand4  g203(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n363_));
  oai22  g204(.a(new_n363_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n364_));
  nand3  g205(.a(new_n364_), .b(new_n226_), .c(x79), .O(new_n365_));
  nand4  g206(.a(new_n157_), .b(new_n154_), .c(new_n237_), .d(x40), .O(new_n366_));
  ...
  aoi21  g211(.a(new_n225_), .b(x79), .c(new_n175_), .O(new_n371_));
  oai21  g212(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n372_));
  ...
  nor2   g244(.a(new_n241_), .b(x78), .O(new_n404_));
