// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:00 2020
...
module FAU ( 
  ...
  inv1   g118(.a(x12), .O(new_n297_));
  nand2  g119(.a(x52), .b(x20), .O(new_n298_));
  oai21  g120(.a(x52), .b(new_n297_), .c(new_n298_), .O(new_n299_));
  nand2  g121(.a(new_n299_), .b(new_n279_), .O(new_n300_));
  nand2  g122(.a(new_n281_), .b(x72), .O(new_n301_));
  aoi21  g123(.a(new_n301_), .b(new_n300_), .c(x01), .O(z52));
  inv1   g124(.a(x13), .O(new_n303_));
  nand2  g125(.a(x52), .b(x21), .O(new_n304_));
  oai21  g126(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand2  g127(.a(new_n305_), .b(new_n279_), .O(new_n306_));
  nand2  g128(.a(new_n281_), .b(x73), .O(new_n307_));
  aoi21  g129(.a(new_n307_), .b(new_n306_), .c(x01), .O(z53));
  nand2  g130(.a(x84), .b(x83), .O(new_n310_));
  nor2   g131(.a(x80), .b(new_n154_), .O(new_n311_));
  nand3  g132(.a(new_n311_), .b(new_n229_), .c(new_n161_), .O(new_n312_));
  nor4   g133(.a(new_n312_), .b(new_n310_), .c(x82), .d(x81), .O(z55));
  inv1   g134(.a(new_n161_), .O(new_n314_));
  xnor2a g135(.a(x84), .b(x81), .O(new_n315_));
  aoi21  g136(.a(new_n169_), .b(new_n168_), .c(new_n315_), .O(new_n316_));
  aoi22  g137(.a(new_n316_), .b(new_n153_), .c(new_n314_), .d(x76), .O(new_n317_));
  inv1   g138(.a(x00), .O(new_n318_));
  nor3   g139(.a(new_n163_), .b(x01), .c(new_n318_), .O(new_n319_));
  oai21  g140(.a(new_n317_), .b(new_n154_), .c(new_n319_), .O(z56));
  inv1   g141(.a(x02), .O(new_n321_));
  nand4  g142(.a(x03), .b(new_n321_), .c(new_n153_), .d(x00), .O(new_n322_));
  inv1   g143(.a(new_n322_), .O(z57));
  nand2  g144(.a(new_n154_), .b(new_n160_), .O(new_n325_));
  aoi21  g145(.a(new_n215_), .b(new_n325_), .c(new_n152_), .O(new_n326_));
  oai21  g146(.a(new_n211_), .b(new_n209_), .c(new_n221_), .O(new_n327_));
  aoi21  g147(.a(new_n327_), .b(x79), .c(new_n215_), .O(new_n328_));
  oai21  g148(.a(new_n328_), .b(new_n326_), .c(x77), .O(new_n329_));
  nor2   g149(.a(x79), .b(x04), .O(new_n330_));
  inv1   g150(.a(new_n330_), .O(new_n331_));
  aoi21  g151(.a(new_n331_), .b(new_n329_), .c(x01), .O(z59));
  aoi21  g152(.a(new_n316_), .b(x79), .c(new_n330_), .O(new_n333_));
  aoi21  g153(.a(new_n333_), .b(new_n217_), .c(x01), .O(z60));
  aoi21  g154(.a(new_n169_), .b(new_n168_), .c(new_n204_), .O(new_n338_));
  nor2   g155(.a(new_n314_), .b(x04), .O(new_n339_));
  nor2   g156(.a(new_n208_), .b(new_n154_), .O(new_n340_));
  oai21  g157(.a(new_n339_), .b(new_n338_), .c(new_n340_), .O(new_n341_));
  aoi21  g158(.a(new_n341_), .b(new_n278_), .c(x01), .O(z64));
  zero   g159(.O(z03));
  zero   g160(.O(z06));
  zero   g161(.O(z07));
  zero   g162(.O(z08));
