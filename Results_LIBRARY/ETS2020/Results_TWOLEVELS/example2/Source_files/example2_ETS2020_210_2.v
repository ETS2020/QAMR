...
module FAU ( 
  ...
  nand4  g063(.a(new_n229_), .b(new_n228_), .c(x46), .d(new_n221_), .O(new_n232_));
  inv1   g064(.a(new_n232_), .O(z28));
  nand4  g065(.a(new_n229_), .b(new_n228_), .c(x47), .d(new_n221_), .O(new_n234_));
  inv1   g066(.a(new_n234_), .O(z29));
  nand4  g067(.a(new_n229_), .b(new_n228_), .c(x48), .d(new_n221_), .O(new_n236_));
  inv1   g068(.a(new_n236_), .O(z30));
  nand4  g069(.a(new_n229_), .b(new_n228_), .c(x49), .d(new_n221_), .O(new_n238_));
  inv1   g070(.a(new_n238_), .O(z31));
  nand4  g071(.a(new_n229_), .b(new_n228_), .c(x50), .d(new_n221_), .O(new_n240_));
  ...
  aoi21  g078(.a(new_n248_), .b(new_n246_), .c(new_n225_), .O(new_n249_));
  nand2  g079(.a(new_n245_), .b(x81), .O(new_n250_));
  nand2  g080(.a(new_n247_), .b(new_n222_), .O(new_n251_));
  aoi21  g081(.a(new_n251_), .b(new_n250_), .c(new_n223_), .O(new_n252_));
  oai21  g082(.a(new_n252_), .b(new_n249_), .c(new_n244_), .O(new_n253_));
  nand2  g083(.a(new_n229_), .b(x53), .O(new_n254_));
