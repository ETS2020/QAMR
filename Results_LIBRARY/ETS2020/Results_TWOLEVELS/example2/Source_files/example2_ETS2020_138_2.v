// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:30 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n260_, new_n262_, new_n266_, new_n275_, new_n276_, new_n277_,
  ...
  nand4  g071(.a(new_n232_), .b(new_n231_), .c(x47), .d(new_n224_), .O(new_n238_));
  ...
  nand2  g091(.a(new_n232_), .b(x54), .O(new_n260_));
  nor2   g092(.a(new_n260_), .b(new_n257_), .O(z36));
  nand2  g093(.a(new_n232_), .b(x55), .O(new_n262_));
  nor2   g094(.a(new_n262_), .b(new_n257_), .O(z37));
  nand2  g095(.a(new_n232_), .b(x58), .O(new_n266_));
  ...
  nand2  g101(.a(new_n278_), .b(new_n219_), .O(new_n279_));
  inv1   g102(.a(new_n279_), .O(new_n280_));
  nand2  g103(.a(new_n280_), .b(new_n277_), .O(new_n281_));
  nor3   g104(.a(new_n207_), .b(new_n169_), .c(new_n154_), .O(new_n282_));
  ...
  nand3  g139(.a(new_n317_), .b(new_n232_), .c(new_n161_), .O(new_n318_));
  ...
  aoi21  g152(.a(new_n218_), .b(new_n331_), .c(new_n152_), .O(new_n332_));
  oai21  g153(.a(new_n214_), .b(new_n212_), .c(new_n224_), .O(new_n333_));
  aoi21  g154(.a(new_n333_), .b(x79), .c(new_n218_), .O(new_n334_));
  ...
  aoi21  g160(.a(new_n339_), .b(new_n220_), .c(x01), .O(z60));
  aoi21  g161(.a(new_n169_), .b(new_n168_), .c(new_n207_), .O(new_n344_));
  nor2   g162(.a(new_n320_), .b(x04), .O(new_n345_));
  nor2   g163(.a(new_n211_), .b(new_n154_), .O(new_n346_));
