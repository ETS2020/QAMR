...
module FAU ( 
  ...
  nor2   g164(.a(new_n154_), .b(x04), .O(new_n347_));
  nor2   g165(.a(new_n221_), .b(x78), .O(new_n348_));
  oai21  g166(.a(new_n348_), .b(new_n347_), .c(x77), .O(new_n349_));
  nand3  g167(.a(x81), .b(x78), .c(new_n153_), .O(new_n350_));
  nand2  g168(.a(new_n166_), .b(x84), .O(new_n351_));
  aoi21  g169(.a(new_n350_), .b(new_n349_), .c(new_n351_), .O(z65));
  zero   g170(.O(z00));
  zero   g171(.O(z03));
  zero   g172(.O(z06));
  zero   g173(.O(z07));
