...
module FAU ( 
  ...
  nor3   g140(.a(new_n288_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g141(.a(new_n288_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g142(.a(new_n288_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g143(.a(new_n288_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g144(.a(new_n288_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g145(.a(new_n288_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g146(.a(new_n288_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g147(.a(new_n288_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g197(.a(new_n280_), .b(x14), .O(new_n355_));
