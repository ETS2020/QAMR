...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n204_, new_n208_, new_n209_, new_n211_, new_n212_, new_n216_,
    new_n217_, new_n219_, new_n220_, new_n221_, new_n224_, new_n225_,
    new_n226_, new_n227_, new_n228_, new_n229_, new_n230_, new_n231_,
    new_n232_, new_n233_, new_n235_, new_n237_, new_n239_, new_n241_,
    ...
    new_n289_, new_n290_, new_n291_, new_n292_, new_n293_, new_n300_,
  ...
  inv1   g065(.a(x42), .O(new_n224_));
  xor2a  g066(.a(x84), .b(x82), .O(new_n225_));
  inv1   g067(.a(new_n225_), .O(new_n226_));
  nand2  g068(.a(new_n226_), .b(x81), .O(new_n227_));
  inv1   g069(.a(x81), .O(new_n228_));
  xor2a  g070(.a(x84), .b(x82), .O(new_n229_));
  nand2  g071(.a(new_n229_), .b(new_n228_), .O(new_n230_));
  nand2  g072(.a(new_n163_), .b(x79), .O(new_n231_));
  aoi21  g073(.a(new_n230_), .b(new_n227_), .c(new_n231_), .O(new_n232_));
  nand4  g074(.a(new_n232_), .b(new_n220_), .c(x44), .d(new_n224_), .O(new_n233_));
  inv1   g075(.a(new_n233_), .O(z26));
  nand4  g076(.a(new_n232_), .b(new_n220_), .c(x45), .d(new_n224_), .O(new_n235_));
  inv1   g077(.a(new_n235_), .O(z27));
  nand4  g078(.a(new_n232_), .b(new_n220_), .c(x46), .d(new_n224_), .O(new_n237_));
  inv1   g079(.a(new_n237_), .O(z28));
  nand4  g080(.a(new_n232_), .b(new_n220_), .c(x47), .d(new_n224_), .O(new_n239_));
  inv1   g081(.a(new_n239_), .O(z29));
  nand4  g082(.a(new_n232_), .b(new_n220_), .c(x48), .d(new_n224_), .O(new_n241_));
  inv1   g083(.a(new_n241_), .O(z30));
  nand4  g084(.a(new_n232_), .b(new_n220_), .c(x49), .d(new_n224_), .O(new_n243_));
  ...
  nor2   g112(.a(new_n274_), .b(new_n269_), .O(z38));
  nor3   g113(.a(new_n269_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g114(.a(new_n269_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g115(.a(new_n269_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g116(.a(new_n269_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g117(.a(new_n269_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g118(.a(new_n269_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g119(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g120(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  ...
  inv1   g132(.a(x13), .O(new_n300_));
  nand2  g133(.a(x52), .b(x21), .O(new_n301_));
  oai21  g134(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand2  g135(.a(new_n302_), .b(new_n288_), .O(new_n303_));
  nor2   g136(.a(new_n162_), .b(x78), .O(new_n304_));
  nand4  g137(.a(new_n304_), .b(new_n290_), .c(x77), .d(x73), .O(new_n305_));
  aoi21  g138(.a(new_n305_), .b(new_n303_), .c(x01), .O(z53));
  nand2  g139(.a(x52), .b(x22), .O(new_n307_));
  nand2  g140(.a(new_n260_), .b(x14), .O(new_n308_));
  nor2   g141(.a(new_n154_), .b(x77), .O(new_n309_));
  nand4  g142(.a(new_n309_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n310_));
  aoi21  g143(.a(new_n308_), .b(new_n307_), .c(new_n310_), .O(z54));
  inv1   g144(.a(x82), .O(new_n312_));
  nand3  g145(.a(new_n247_), .b(x84), .c(new_n312_), .O(new_n313_));
  inv1   g146(.a(x80), .O(new_n314_));
  nand4  g147(.a(new_n220_), .b(new_n163_), .c(new_n314_), .d(x79), .O(new_n315_));
  nor2   g148(.a(new_n315_), .b(new_n313_), .O(z55));
  aoi21  g149(.a(x84), .b(new_n228_), .c(x76), .O(new_n317_));
  oai21  g150(.a(x84), .b(new_n228_), .c(new_n317_), .O(new_n318_));
  nand2  g151(.a(new_n318_), .b(new_n164_), .O(new_n319_));
  nand4  g152(.a(new_n319_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g153(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n322_));
  inv1   g154(.a(x74), .O(new_n323_));
  nand4  g155(.a(x80), .b(new_n323_), .c(x43), .d(new_n224_), .O(new_n324_));
  oai22  g156(.a(new_n324_), .b(new_n322_), .c(new_n224_), .d(x40), .O(new_n325_));
  nand2  g157(.a(x78), .b(x04), .O(new_n326_));
  inv1   g158(.a(new_n326_), .O(new_n327_));
  nand3  g159(.a(new_n327_), .b(new_n325_), .c(x79), .O(new_n328_));
  nand4  g160(.a(new_n162_), .b(new_n154_), .c(new_n224_), .d(x40), .O(new_n329_));
  nand2  g161(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  nand2  g162(.a(new_n330_), .b(x77), .O(new_n331_));
  oai21  g163(.a(new_n309_), .b(new_n216_), .c(new_n162_), .O(new_n332_));
  aoi21  g164(.a(new_n332_), .b(new_n331_), .c(x01), .O(z58));
  aoi21  g165(.a(new_n326_), .b(x79), .c(new_n152_), .O(new_n334_));
  nand3  g166(.a(x80), .b(new_n323_), .c(x43), .O(new_n335_));
  oai21  g167(.a(new_n335_), .b(new_n322_), .c(new_n224_), .O(new_n336_));
  aoi21  g168(.a(new_n336_), .b(x79), .c(new_n326_), .O(new_n337_));
  oai21  g169(.a(new_n337_), .b(new_n334_), .c(x77), .O(new_n338_));
  nand2  g170(.a(new_n162_), .b(new_n216_), .O(new_n339_));
  aoi21  g171(.a(new_n339_), .b(new_n338_), .c(x01), .O(z59));
  oai21  g172(.a(new_n309_), .b(new_n292_), .c(new_n290_), .O(new_n342_));
  nand2  g173(.a(new_n163_), .b(new_n216_), .O(new_n343_));
  nand2  g174(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  inv1   g175(.a(new_n344_), .O(new_n345_));
  nor2   g176(.a(new_n162_), .b(x01), .O(new_n346_));
  inv1   g177(.a(new_n346_), .O(new_n347_));
  nor3   g178(.a(new_n347_), .b(new_n345_), .c(new_n314_), .O(z61));
  nand3  g179(.a(x84), .b(x81), .c(x79), .O(new_n349_));
  oai21  g180(.a(x79), .b(new_n216_), .c(new_n349_), .O(new_n350_));
  nand2  g181(.a(new_n350_), .b(new_n160_), .O(new_n351_));
  nand2  g182(.a(new_n336_), .b(x79), .O(new_n352_));
  nand3  g183(.a(x81), .b(x79), .c(new_n216_), .O(new_n353_));
  inv1   g184(.a(new_n353_), .O(new_n354_));
  aoi21  g185(.a(new_n352_), .b(x04), .c(new_n354_), .O(new_n355_));
  oai21  g186(.a(new_n355_), .b(new_n160_), .c(new_n351_), .O(new_n356_));
  nand2  g187(.a(new_n356_), .b(x78), .O(new_n357_));
  inv1   g188(.a(new_n349_), .O(new_n358_));
  nand2  g189(.a(new_n358_), .b(new_n292_), .O(new_n359_));
  aoi21  g190(.a(new_n359_), .b(new_n357_), .c(x01), .O(z62));
  nor3   g191(.a(new_n347_), .b(new_n345_), .c(new_n312_), .O(z63));
  nand3  g192(.a(new_n344_), .b(x83), .c(x79), .O(new_n362_));
  aoi21  g193(.a(new_n362_), .b(new_n287_), .c(x01), .O(z64));
  nor2   g194(.a(new_n154_), .b(x04), .O(new_n364_));
  nor2   g195(.a(new_n228_), .b(x78), .O(new_n365_));
  oai21  g196(.a(new_n365_), .b(new_n364_), .c(x77), .O(new_n366_));
  nand2  g197(.a(new_n309_), .b(x81), .O(new_n367_));
  nand2  g198(.a(new_n346_), .b(x84), .O(new_n368_));
  aoi21  g199(.a(new_n367_), .b(new_n366_), .c(new_n368_), .O(z65));
  zero   g200(.O(z02));
  zero   g201(.O(z04));
  zero   g202(.O(z17));
  zero   g203(.O(z18));
