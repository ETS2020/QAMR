...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n234_, new_n237_, new_n239_, new_n241_, new_n243_,
  ...
  nand2  g100(.a(new_n277_), .b(new_n217_), .O(new_n278_));
  inv1   g101(.a(new_n278_), .O(new_n279_));
  nand2  g102(.a(new_n279_), .b(new_n276_), .O(new_n280_));
  nor3   g103(.a(new_n205_), .b(new_n169_), .c(new_n154_), .O(new_n281_));
  ...
  nand3  g138(.a(new_n316_), .b(new_n230_), .c(new_n161_), .O(new_n317_));
  ...
  aoi21  g151(.a(new_n216_), .b(new_n330_), .c(new_n152_), .O(new_n331_));
  oai21  g152(.a(new_n212_), .b(new_n210_), .c(new_n222_), .O(new_n332_));
  aoi21  g153(.a(new_n332_), .b(x79), .c(new_n216_), .O(new_n333_));
  ...
  aoi21  g159(.a(new_n338_), .b(new_n218_), .c(x01), .O(z60));
  aoi21  g160(.a(new_n169_), .b(new_n168_), .c(new_n205_), .O(new_n343_));
  nor2   g161(.a(new_n319_), .b(x04), .O(new_n344_));
  nor2   g162(.a(new_n209_), .b(new_n154_), .O(new_n345_));
