...
module FAU ( 
  ...
  nand4  g212(.a(x80), .b(new_n226_), .c(x43), .d(new_n246_), .O(new_n370_));
  ...
  nand4  g217(.a(new_n167_), .b(new_n154_), .c(new_n246_), .d(x40), .O(new_n375_));
  ...
  nor2   g237(.a(new_n250_), .b(new_n167_), .O(new_n396_));
  ...
  oai21  g242(.a(new_n250_), .b(x78), .c(new_n391_), .O(new_n402_));
