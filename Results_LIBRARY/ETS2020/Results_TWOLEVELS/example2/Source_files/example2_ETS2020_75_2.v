...
module FAU ( 
  ...
  nand4  g065(.a(new_n228_), .b(new_n227_), .c(x44), .d(new_n220_), .O(new_n231_));
  inv1   g066(.a(new_n231_), .O(z26));
  nand4  g067(.a(new_n228_), .b(new_n227_), .c(x45), .d(new_n220_), .O(new_n233_));
  ...
  nand2  g093(.a(new_n228_), .b(x56), .O(new_n262_));
  nor2   g094(.a(new_n262_), .b(new_n255_), .O(z38));
  ...
  nor2   g111(.a(new_n280_), .b(new_n203_), .O(new_n288_));
  ...
  nand2  g135(.a(new_n312_), .b(new_n277_), .O(new_n313_));
  nand2  g136(.a(new_n288_), .b(x73), .O(new_n314_));
  aoi21  g137(.a(new_n314_), .b(new_n313_), .c(x01), .O(z53));
  nand2  g138(.a(x84), .b(x83), .O(new_n317_));
  nor2   g139(.a(x80), .b(new_n154_), .O(new_n318_));
  nand3  g140(.a(new_n318_), .b(new_n228_), .c(new_n161_), .O(new_n319_));
  ...
  aoi21  g153(.a(new_n214_), .b(new_n332_), .c(new_n152_), .O(new_n333_));
  oai21  g154(.a(new_n210_), .b(new_n208_), .c(new_n220_), .O(new_n334_));
  aoi21  g155(.a(new_n334_), .b(x79), .c(new_n214_), .O(new_n335_));
  ...
  aoi21  g161(.a(new_n340_), .b(new_n216_), .c(x01), .O(z60));
  aoi21  g162(.a(new_n169_), .b(new_n168_), .c(new_n203_), .O(new_n345_));
  nor2   g163(.a(new_n321_), .b(x04), .O(new_n346_));
  nor2   g164(.a(new_n207_), .b(new_n154_), .O(new_n347_));
  oai21  g165(.a(new_n346_), .b(new_n345_), .c(new_n347_), .O(new_n348_));
  aoi21  g166(.a(new_n348_), .b(new_n276_), .c(x01), .O(z64));
  nor2   g167(.a(new_n160_), .b(x04), .O(new_n350_));
  nor2   g168(.a(new_n221_), .b(x78), .O(new_n351_));
  oai21  g169(.a(new_n351_), .b(new_n350_), .c(x77), .O(new_n352_));
  nand3  g170(.a(x81), .b(x78), .c(new_n159_), .O(new_n353_));
  nand2  g171(.a(new_n171_), .b(x84), .O(new_n354_));
  aoi21  g172(.a(new_n353_), .b(new_n352_), .c(new_n354_), .O(z65));
  zero   g173(.O(z05));
  zero   g174(.O(z06));
  zero   g175(.O(z07));
  zero   g176(.O(z08));
