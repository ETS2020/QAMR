// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:57 2020
...
module FAU ( 
  ...
  nand2  g120(.a(new_n276_), .b(new_n253_), .O(new_n277_));
  inv1   g121(.a(new_n255_), .O(new_n278_));
  ...
  nand2  g126(.a(new_n282_), .b(new_n251_), .O(new_n283_));
  nand3  g127(.a(x83), .b(x81), .c(x42), .O(new_n284_));
  aoi21  g128(.a(new_n284_), .b(new_n283_), .c(new_n252_), .O(new_n285_));
  nand2  g129(.a(new_n282_), .b(x81), .O(new_n286_));
  nand3  g130(.a(x83), .b(new_n251_), .c(x42), .O(new_n287_));
  aoi21  g131(.a(new_n287_), .b(new_n286_), .c(new_n248_), .O(new_n288_));
  ...
  nand2  g138(.a(new_n244_), .b(x55), .O(new_n295_));
  nor2   g139(.a(new_n295_), .b(new_n289_), .O(z37));
  nand2  g140(.a(new_n244_), .b(x56), .O(new_n297_));
  nor2   g141(.a(new_n297_), .b(new_n289_), .O(z38));
  nor3   g142(.a(new_n289_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g143(.a(new_n289_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g144(.a(new_n289_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g145(.a(new_n289_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g146(.a(new_n289_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g147(.a(new_n289_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g148(.a(new_n289_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g149(.a(new_n289_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  inv1   g161(.a(x09), .O(new_n319_));
  nand2  g162(.a(x52), .b(x17), .O(new_n320_));
  oai21  g163(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g164(.a(new_n321_), .b(new_n311_), .O(new_n322_));
  nor2   g165(.a(new_n314_), .b(new_n222_), .O(new_n323_));
  nand2  g166(.a(new_n323_), .b(x69), .O(new_n324_));
  aoi21  g167(.a(new_n324_), .b(new_n322_), .c(x01), .O(z49));
  inv1   g168(.a(x10), .O(new_n326_));
  nand2  g169(.a(x52), .b(x18), .O(new_n327_));
  oai21  g170(.a(x52), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g171(.a(new_n328_), .b(new_n311_), .O(new_n329_));
  nand2  g172(.a(new_n323_), .b(x70), .O(new_n330_));
  ...
  nand2  g177(.a(new_n334_), .b(new_n311_), .O(new_n335_));
  nand2  g178(.a(new_n323_), .b(x71), .O(new_n336_));
  ...
  nand2  g183(.a(new_n340_), .b(new_n311_), .O(new_n341_));
  nand2  g184(.a(new_n323_), .b(x72), .O(new_n342_));
  ...
  nand2  g189(.a(new_n346_), .b(new_n311_), .O(new_n347_));
  nand2  g190(.a(new_n323_), .b(x73), .O(new_n348_));
  aoi21  g191(.a(new_n348_), .b(new_n347_), .c(x01), .O(z53));
  nand2  g192(.a(x52), .b(x22), .O(new_n350_));
  nand2  g193(.a(new_n281_), .b(x14), .O(new_n351_));
  inv1   g194(.a(new_n164_), .O(new_n352_));
  nand4  g195(.a(new_n352_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n353_));
  aoi21  g196(.a(new_n351_), .b(new_n350_), .c(new_n353_), .O(z54));
  inv1   g197(.a(new_n242_), .O(new_n356_));
  xnor2a g198(.a(x84), .b(x81), .O(new_n357_));
  aoi21  g199(.a(new_n165_), .b(new_n164_), .c(new_n357_), .O(new_n358_));
  aoi22  g200(.a(new_n358_), .b(new_n153_), .c(new_n356_), .d(x76), .O(new_n359_));
  aoi21  g201(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n360_));
  oai21  g202(.a(new_n359_), .b(new_n167_), .c(new_n360_), .O(z56));
  inv1   g203(.a(x02), .O(new_n362_));
  nand3  g204(.a(new_n239_), .b(x03), .c(new_n362_), .O(new_n363_));
  inv1   g205(.a(new_n363_), .O(z57));
  nand2  g206(.a(x42), .b(new_n152_), .O(new_n365_));
  nand4  g207(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n366_));
  oai21  g208(.a(new_n366_), .b(new_n227_), .c(new_n365_), .O(new_n367_));
  nand3  g209(.a(x79), .b(x78), .c(x04), .O(new_n368_));
  inv1   g210(.a(new_n368_), .O(new_n369_));
  nand2  g211(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand4  g212(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n371_));
  nand2  g213(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand2  g214(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g215(.a(new_n352_), .b(new_n233_), .c(new_n167_), .O(new_n374_));
  aoi21  g216(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  nand2  g217(.a(new_n234_), .b(new_n230_), .O(new_n377_));
  inv1   g218(.a(new_n377_), .O(new_n378_));
  oai21  g219(.a(new_n229_), .b(new_n227_), .c(new_n378_), .O(new_n379_));
  aoi21  g220(.a(new_n154_), .b(x04), .c(x79), .O(new_n380_));
  aoi21  g221(.a(new_n358_), .b(x79), .c(new_n380_), .O(new_n381_));
  aoi21  g222(.a(new_n381_), .b(new_n379_), .c(x01), .O(z60));
  nand2  g223(.a(new_n165_), .b(new_n164_), .O(new_n383_));
  aoi22  g224(.a(new_n383_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n384_));
  nand2  g225(.a(new_n168_), .b(x80), .O(new_n385_));
  nor2   g226(.a(new_n385_), .b(new_n384_), .O(z61));
  nand2  g227(.a(x78), .b(new_n233_), .O(new_n387_));
  nand2  g228(.a(x84), .b(new_n154_), .O(new_n388_));
  aoi21  g229(.a(new_n388_), .b(new_n387_), .c(new_n163_), .O(new_n389_));
  nand2  g230(.a(new_n352_), .b(x84), .O(new_n390_));
  inv1   g231(.a(new_n390_), .O(new_n391_));
  nor2   g232(.a(new_n251_), .b(new_n167_), .O(new_n392_));
  oai21  g233(.a(new_n391_), .b(new_n389_), .c(new_n392_), .O(new_n393_));
  aoi21  g234(.a(new_n393_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g235(.a(new_n168_), .b(x82), .O(new_n395_));
  nor2   g236(.a(new_n395_), .b(new_n384_), .O(z63));
  oai21  g237(.a(new_n251_), .b(x78), .c(new_n387_), .O(new_n398_));
  nand2  g238(.a(new_n398_), .b(x77), .O(new_n399_));
  nand2  g239(.a(new_n352_), .b(x81), .O(new_n400_));
  nand2  g240(.a(new_n168_), .b(x84), .O(new_n401_));
