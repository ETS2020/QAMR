...
module FAU ( 
  ...
  nor2   g166(.a(new_n160_), .b(x04), .O(new_n349_));
  nor2   g167(.a(new_n224_), .b(x78), .O(new_n350_));
  oai21  g168(.a(new_n350_), .b(new_n349_), .c(x77), .O(new_n351_));
  nand3  g169(.a(x81), .b(x78), .c(new_n159_), .O(new_n352_));
  nand2  g170(.a(new_n171_), .b(x84), .O(new_n353_));
  aoi21  g171(.a(new_n352_), .b(new_n351_), .c(new_n353_), .O(z65));
  zero   g172(.O(z03));
  zero   g173(.O(z06));
  zero   g174(.O(z07));
  zero   g175(.O(z08));
