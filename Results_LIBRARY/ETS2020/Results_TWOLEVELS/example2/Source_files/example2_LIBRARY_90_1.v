// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:58 2020
...
module FAU ( 
  ...
  nor2   g114(.a(new_n274_), .b(new_n270_), .O(z37));
  ...
  nand2  g137(.a(new_n261_), .b(x14), .O(new_n304_));
  ...
  nand3  g142(.a(new_n248_), .b(x84), .c(new_n308_), .O(new_n309_));
  ...
  nand4  g150(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n318_));
