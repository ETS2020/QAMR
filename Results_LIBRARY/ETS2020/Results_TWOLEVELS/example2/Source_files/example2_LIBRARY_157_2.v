...
module FAU ( 
  ...
  nand2  g100(.a(new_n276_), .b(new_n216_), .O(new_n277_));
  ...
  nand2  g106(.a(new_n282_), .b(new_n205_), .O(new_n283_));
  ...
  nor2   g112(.a(new_n281_), .b(new_n204_), .O(new_n289_));
  ...
  nand3  g147(.a(new_n324_), .b(new_n229_), .c(new_n161_), .O(new_n325_));
  ...
  aoi21  g160(.a(new_n215_), .b(new_n338_), .c(new_n152_), .O(new_n339_));
  oai21  g161(.a(new_n211_), .b(new_n209_), .c(new_n221_), .O(new_n340_));
  aoi21  g162(.a(new_n340_), .b(x79), .c(new_n215_), .O(new_n341_));
  ...
  aoi21  g168(.a(new_n346_), .b(new_n217_), .c(x01), .O(z60));
  aoi21  g169(.a(new_n169_), .b(new_n168_), .c(new_n204_), .O(new_n351_));
  nor2   g170(.a(new_n327_), .b(x04), .O(new_n352_));
  nor2   g171(.a(new_n208_), .b(new_n154_), .O(new_n353_));
