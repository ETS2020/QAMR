...
module FAU ( 
  ...
  nor2   g065(.a(new_n157_), .b(x41), .O(new_n221_));
  nand3  g066(.a(new_n221_), .b(new_n220_), .c(new_n165_), .O(new_n222_));
  ...
  nor3   g072(.a(new_n227_), .b(new_n153_), .c(x42), .O(new_n228_));
  nand2  g073(.a(x78), .b(x04), .O(new_n229_));
  inv1   g074(.a(new_n229_), .O(new_n230_));
  oai21  g075(.a(new_n228_), .b(new_n157_), .c(new_n230_), .O(new_n231_));
  aoi21  g076(.a(new_n231_), .b(new_n222_), .c(x01), .O(z22));
  inv1   g077(.a(x04), .O(new_n233_));
  nand3  g078(.a(new_n157_), .b(x05), .c(new_n233_), .O(new_n234_));
  nand3  g079(.a(new_n234_), .b(new_n167_), .c(x00), .O(z23));
  inv1   g080(.a(x05), .O(new_n236_));
  nor2   g081(.a(new_n155_), .b(new_n157_), .O(new_n237_));
  ...
  nand4  g204(.a(new_n238_), .b(new_n155_), .c(new_n360_), .d(x79), .O(new_n361_));
  ...
  nand4  g212(.a(new_n157_), .b(new_n154_), .c(new_n241_), .d(x40), .O(new_n370_));
  ...
  oai21  g218(.a(new_n226_), .b(new_n224_), .c(new_n241_), .O(new_n376_));
