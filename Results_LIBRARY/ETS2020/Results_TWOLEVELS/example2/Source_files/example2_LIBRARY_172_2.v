// Benchmark "FAU" written by ABC on Sat Jun 27 02:02:02 2020
...
module FAU ( 
  ...
  nand3  g145(.a(new_n323_), .b(new_n231_), .c(new_n161_), .O(new_n324_));
  ...
  oai21  g159(.a(new_n211_), .b(new_n209_), .c(new_n223_), .O(new_n339_));
