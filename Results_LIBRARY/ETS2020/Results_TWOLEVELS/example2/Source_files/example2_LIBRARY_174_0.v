// Benchmark "FAU" written by ABC on Sat Jun 27 02:02:11 2020
...
module FAU ( 
  ...
  nand4  g110(.a(new_n254_), .b(new_n242_), .c(x48), .d(new_n245_), .O(new_n265_));
  inv1   g111(.a(new_n265_), .O(z30));
  nand4  g112(.a(new_n254_), .b(new_n242_), .c(x49), .d(new_n245_), .O(new_n267_));
  inv1   g113(.a(new_n267_), .O(z31));
  xnor2a g114(.a(x83), .b(x81), .O(new_n270_));
  nand2  g115(.a(x42), .b(x05), .O(new_n271_));
  nand2  g116(.a(x51), .b(new_n245_), .O(new_n272_));
  oai22  g117(.a(new_n272_), .b(new_n249_), .c(new_n271_), .d(new_n270_), .O(new_n273_));
  ...
  inv1   g122(.a(new_n253_), .O(new_n278_));
  ...
  nand2  g127(.a(new_n282_), .b(new_n249_), .O(new_n283_));
  nand3  g128(.a(x83), .b(x81), .c(x42), .O(new_n284_));
  aoi21  g129(.a(new_n284_), .b(new_n283_), .c(new_n250_), .O(new_n285_));
  nand2  g130(.a(new_n282_), .b(x81), .O(new_n286_));
  nand3  g131(.a(x83), .b(new_n249_), .c(x42), .O(new_n287_));
  aoi21  g132(.a(new_n287_), .b(new_n286_), .c(new_n246_), .O(new_n288_));
  oai21  g133(.a(new_n288_), .b(new_n285_), .c(new_n278_), .O(new_n289_));
  nor3   g134(.a(new_n289_), .b(new_n243_), .c(new_n281_), .O(z34));
  nand2  g135(.a(new_n242_), .b(x53), .O(new_n291_));
  nor2   g136(.a(new_n291_), .b(new_n289_), .O(z35));
  nand2  g137(.a(new_n242_), .b(x54), .O(new_n293_));
  nor2   g138(.a(new_n293_), .b(new_n289_), .O(z36));
  nand2  g139(.a(new_n242_), .b(x56), .O(new_n296_));
  nor2   g140(.a(new_n296_), .b(new_n289_), .O(z38));
  nor3   g141(.a(new_n289_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g142(.a(new_n289_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g143(.a(new_n289_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g144(.a(new_n289_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g145(.a(new_n289_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g146(.a(new_n289_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g147(.a(new_n289_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g148(.a(new_n289_), .b(new_n243_), .c(new_n176_), .O(z46));
  inv1   g149(.a(x07), .O(new_n306_));
  nand2  g150(.a(x52), .b(x15), .O(new_n307_));
  oai21  g151(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand3  g152(.a(new_n232_), .b(new_n167_), .c(new_n163_), .O(new_n309_));
  inv1   g153(.a(new_n309_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n308_), .O(new_n311_));
  nor2   g155(.a(x75), .b(x67), .O(new_n312_));
  nand3  g156(.a(x79), .b(new_n154_), .c(x77), .O(new_n313_));
  ...
  nand2  g176(.a(new_n332_), .b(new_n310_), .O(new_n333_));
  ...
  nand2  g182(.a(new_n338_), .b(new_n310_), .O(new_n339_));
  ...
  nand2  g194(.a(new_n350_), .b(new_n310_), .O(new_n351_));
  nand2  g195(.a(new_n321_), .b(x73), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(new_n351_), .c(x01), .O(z53));
  nand2  g197(.a(x52), .b(x22), .O(new_n354_));
  nand2  g198(.a(new_n281_), .b(x14), .O(new_n355_));
  inv1   g199(.a(new_n164_), .O(new_n356_));
  nand4  g200(.a(new_n356_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n357_));
  aoi21  g201(.a(new_n355_), .b(new_n354_), .c(new_n357_), .O(z54));
  inv1   g202(.a(new_n240_), .O(new_n360_));
  xnor2a g203(.a(x84), .b(x81), .O(new_n361_));
  aoi21  g204(.a(new_n165_), .b(new_n164_), .c(new_n361_), .O(new_n362_));
  aoi22  g205(.a(new_n362_), .b(new_n153_), .c(new_n360_), .d(x76), .O(new_n363_));
  aoi21  g206(.a(new_n154_), .b(new_n163_), .c(new_n236_), .O(new_n364_));
  oai21  g207(.a(new_n363_), .b(new_n167_), .c(new_n364_), .O(z56));
  inv1   g208(.a(x02), .O(new_n366_));
  nand3  g209(.a(new_n237_), .b(x03), .c(new_n366_), .O(new_n367_));
  inv1   g210(.a(new_n367_), .O(z57));
  nand2  g211(.a(x42), .b(new_n152_), .O(new_n369_));
  nand4  g212(.a(x80), .b(new_n226_), .c(x43), .d(new_n245_), .O(new_n370_));
  oai21  g213(.a(new_n370_), .b(new_n225_), .c(new_n369_), .O(new_n371_));
  nand3  g214(.a(x79), .b(x78), .c(x04), .O(new_n372_));
  inv1   g215(.a(new_n372_), .O(new_n373_));
  nand2  g216(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand4  g217(.a(new_n167_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand2  g219(.a(new_n376_), .b(x77), .O(new_n377_));
  oai21  g220(.a(new_n356_), .b(new_n231_), .c(new_n167_), .O(new_n378_));
  aoi21  g221(.a(new_n378_), .b(new_n377_), .c(x01), .O(z58));
  nand2  g222(.a(new_n232_), .b(new_n228_), .O(new_n381_));
  inv1   g223(.a(new_n381_), .O(new_n382_));
  oai21  g224(.a(new_n227_), .b(new_n225_), .c(new_n382_), .O(new_n383_));
  aoi21  g225(.a(new_n154_), .b(x04), .c(x79), .O(new_n384_));
  aoi21  g226(.a(new_n362_), .b(x79), .c(new_n384_), .O(new_n385_));
  aoi21  g227(.a(new_n385_), .b(new_n383_), .c(x01), .O(z60));
  nand2  g228(.a(new_n165_), .b(new_n164_), .O(new_n387_));
  aoi22  g229(.a(new_n387_), .b(new_n221_), .c(new_n240_), .d(new_n231_), .O(new_n388_));
  nand2  g230(.a(new_n168_), .b(x80), .O(new_n389_));
  nor2   g231(.a(new_n389_), .b(new_n388_), .O(z61));
  nand2  g232(.a(x78), .b(new_n231_), .O(new_n391_));
  nand2  g233(.a(x84), .b(new_n154_), .O(new_n392_));
  aoi21  g234(.a(new_n392_), .b(new_n391_), .c(new_n163_), .O(new_n393_));
  nand2  g235(.a(new_n356_), .b(x84), .O(new_n394_));
  inv1   g236(.a(new_n394_), .O(new_n395_));
  nor2   g237(.a(new_n249_), .b(new_n167_), .O(new_n396_));
  oai21  g238(.a(new_n395_), .b(new_n393_), .c(new_n396_), .O(new_n397_));
  aoi21  g239(.a(new_n397_), .b(new_n233_), .c(x01), .O(z62));
  nand2  g240(.a(new_n168_), .b(x82), .O(new_n399_));
  nor2   g241(.a(new_n399_), .b(new_n388_), .O(z63));
  oai21  g242(.a(new_n249_), .b(x78), .c(new_n391_), .O(new_n402_));
  nand2  g243(.a(new_n402_), .b(x77), .O(new_n403_));
  nand2  g244(.a(new_n356_), .b(x81), .O(new_n404_));
  nand2  g245(.a(new_n168_), .b(x84), .O(new_n405_));
  aoi21  g246(.a(new_n404_), .b(new_n403_), .c(new_n405_), .O(z65));
  zero   g247(.O(z01));
  zero   g248(.O(z19));
  zero   g249(.O(z21));
  zero   g250(.O(z32));
