// Benchmark "FAU" written by ABC on Sat Jun 27 02:02:20 2020
...
module FAU ( 
  ...
  nor2   g159(.a(new_n160_), .b(x04), .O(new_n344_));
  nor2   g160(.a(new_n218_), .b(x78), .O(new_n345_));
  oai21  g161(.a(new_n345_), .b(new_n344_), .c(x77), .O(new_n346_));
  nand3  g162(.a(x81), .b(x78), .c(new_n159_), .O(new_n347_));
  nand2  g163(.a(new_n171_), .b(x84), .O(new_n348_));
  aoi21  g164(.a(new_n347_), .b(new_n346_), .c(new_n348_), .O(z65));
  zero   g165(.O(z03));
  zero   g166(.O(z05));
  zero   g167(.O(z06));
  zero   g168(.O(z07));
