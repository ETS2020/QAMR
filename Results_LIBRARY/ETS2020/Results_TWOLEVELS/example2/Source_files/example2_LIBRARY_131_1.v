...
module FAU ( 
  ...
  nand2  g142(.a(new_n304_), .b(new_n292_), .O(new_n305_));
  nor2   g143(.a(new_n162_), .b(x78), .O(new_n306_));
  nand4  g144(.a(new_n306_), .b(new_n294_), .c(x77), .d(x71), .O(new_n307_));
  aoi21  g145(.a(new_n307_), .b(new_n305_), .c(x01), .O(z51));
  nand2  g146(.a(x52), .b(x22), .O(new_n311_));
  nand2  g147(.a(new_n262_), .b(x14), .O(new_n312_));
  ...
  nand3  g152(.a(new_n249_), .b(x84), .c(new_n316_), .O(new_n317_));
  ...
  nand4  g160(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n326_));
