// Benchmark "FAU" written by ABC on Sat Jun 27 01:51:23 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n203_, new_n207_, new_n208_, new_n210_, new_n211_, new_n214_,
  ...
  nor3   g133(.a(new_n283_), .b(new_n236_), .c(new_n198_), .O(z39));
  nor3   g134(.a(new_n283_), .b(new_n236_), .c(new_n192_), .O(z41));
  nor3   g135(.a(new_n283_), .b(new_n236_), .c(new_n189_), .O(z42));
  nor3   g136(.a(new_n283_), .b(new_n236_), .c(new_n186_), .O(z43));
  nor3   g137(.a(new_n283_), .b(new_n236_), .c(new_n183_), .O(z44));
  nor3   g138(.a(new_n283_), .b(new_n236_), .c(new_n180_), .O(z45));
  nor3   g139(.a(new_n283_), .b(new_n236_), .c(new_n177_), .O(z46));
  ...
  nand4  g202(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n363_));
  oai22  g203(.a(new_n363_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n364_));
  nand3  g204(.a(new_n364_), .b(new_n227_), .c(x79), .O(new_n365_));
  nor2   g205(.a(x79), .b(x78), .O(new_n366_));
  nand3  g206(.a(new_n366_), .b(new_n238_), .c(x40), .O(new_n367_));
  ...
  oai21  g213(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n374_));
  ...
  nor2   g245(.a(new_n242_), .b(x78), .O(new_n406_));
