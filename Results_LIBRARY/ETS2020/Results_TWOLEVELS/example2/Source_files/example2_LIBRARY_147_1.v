...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n233_, new_n234_, new_n239_, new_n243_,
  ...
  nand4  g079(.a(new_n233_), .b(new_n222_), .c(x47), .d(new_n225_), .O(new_n239_));
  inv1   g080(.a(new_n239_), .O(z29));
  nand4  g081(.a(new_n233_), .b(new_n222_), .c(x50), .d(new_n225_), .O(new_n243_));
  inv1   g082(.a(new_n243_), .O(z32));
  ...
  nand2  g108(.a(new_n222_), .b(x54), .O(new_n271_));
  nor2   g109(.a(new_n271_), .b(new_n268_), .O(z36));
  nand2  g110(.a(new_n222_), .b(x55), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n268_), .O(z37));
  ...
  inv1   g122(.a(x07), .O(new_n285_));
  nand2  g123(.a(x52), .b(x15), .O(new_n286_));
  oai21  g124(.a(x52), .b(new_n285_), .c(new_n286_), .O(new_n287_));
  nand3  g125(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n288_));
  inv1   g126(.a(new_n288_), .O(new_n289_));
  nand2  g127(.a(new_n289_), .b(new_n287_), .O(new_n290_));
  xnor2a g128(.a(x84), .b(x81), .O(new_n291_));
  or2    g129(.a(x75), .b(x67), .O(new_n292_));
  nor2   g130(.a(x78), .b(new_n160_), .O(new_n293_));
  nand4  g131(.a(new_n293_), .b(new_n292_), .c(new_n291_), .d(x79), .O(new_n294_));
  aoi21  g132(.a(new_n294_), .b(new_n290_), .c(x01), .O(z47));
  nand2  g133(.a(x52), .b(x22), .O(new_n302_));
  nand2  g134(.a(new_n259_), .b(x14), .O(new_n303_));
  nor2   g135(.a(new_n154_), .b(x77), .O(new_n304_));
  nand4  g136(.a(new_n304_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n305_));
  aoi21  g137(.a(new_n303_), .b(new_n302_), .c(new_n305_), .O(z54));
  inv1   g138(.a(x82), .O(new_n307_));
  nand3  g139(.a(new_n246_), .b(x84), .c(new_n307_), .O(new_n308_));
  inv1   g140(.a(x80), .O(new_n309_));
  nand4  g141(.a(new_n222_), .b(new_n163_), .c(new_n309_), .d(x79), .O(new_n310_));
  nor2   g142(.a(new_n310_), .b(new_n308_), .O(z55));
  aoi21  g143(.a(x84), .b(new_n229_), .c(x76), .O(new_n312_));
  oai21  g144(.a(x84), .b(new_n229_), .c(new_n312_), .O(new_n313_));
  nand2  g145(.a(new_n313_), .b(new_n164_), .O(new_n314_));
  nand4  g146(.a(new_n314_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g147(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n317_));
  inv1   g148(.a(x74), .O(new_n318_));
  nand4  g149(.a(x80), .b(new_n318_), .c(x43), .d(new_n225_), .O(new_n319_));
  oai22  g150(.a(new_n319_), .b(new_n317_), .c(new_n225_), .d(x40), .O(new_n320_));
  nand2  g151(.a(x78), .b(x04), .O(new_n321_));
  inv1   g152(.a(new_n321_), .O(new_n322_));
  nand3  g153(.a(new_n322_), .b(new_n320_), .c(x79), .O(new_n323_));
  nand4  g154(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n324_));
  nand2  g155(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand2  g156(.a(new_n325_), .b(x77), .O(new_n326_));
  oai21  g157(.a(new_n304_), .b(new_n218_), .c(new_n162_), .O(new_n327_));
  aoi21  g158(.a(new_n327_), .b(new_n326_), .c(x01), .O(z58));
  aoi21  g159(.a(new_n321_), .b(x79), .c(new_n152_), .O(new_n329_));
  nand3  g160(.a(x80), .b(new_n318_), .c(x43), .O(new_n330_));
  oai21  g161(.a(new_n330_), .b(new_n317_), .c(new_n225_), .O(new_n331_));
  aoi21  g162(.a(new_n331_), .b(x79), .c(new_n321_), .O(new_n332_));
  oai21  g163(.a(new_n332_), .b(new_n329_), .c(x77), .O(new_n333_));
  nand2  g164(.a(new_n162_), .b(new_n218_), .O(new_n334_));
  aoi21  g165(.a(new_n334_), .b(new_n333_), .c(x01), .O(z59));
  oai21  g166(.a(new_n304_), .b(new_n293_), .c(new_n291_), .O(new_n337_));
  nand2  g167(.a(new_n163_), .b(new_n218_), .O(new_n338_));
  ...
  nor3   g172(.a(new_n342_), .b(new_n340_), .c(new_n309_), .O(z61));
  nand3  g173(.a(x84), .b(x81), .c(x79), .O(new_n344_));
  oai21  g174(.a(x79), .b(new_n218_), .c(new_n344_), .O(new_n345_));
  nand2  g175(.a(new_n345_), .b(new_n160_), .O(new_n346_));
  nand2  g176(.a(new_n331_), .b(x79), .O(new_n347_));
  nand3  g177(.a(x81), .b(x79), .c(new_n218_), .O(new_n348_));
  ...
  nand2  g183(.a(new_n353_), .b(new_n293_), .O(new_n354_));
  aoi21  g184(.a(new_n354_), .b(new_n352_), .c(x01), .O(z62));
  nor3   g185(.a(new_n342_), .b(new_n340_), .c(new_n307_), .O(z63));
  nand3  g186(.a(new_n339_), .b(x83), .c(x79), .O(new_n357_));
  aoi21  g187(.a(new_n357_), .b(new_n288_), .c(x01), .O(z64));
  nor2   g188(.a(new_n154_), .b(x04), .O(new_n359_));
  nor2   g189(.a(new_n229_), .b(x78), .O(new_n360_));
  oai21  g190(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  nand2  g191(.a(new_n304_), .b(x81), .O(new_n362_));
