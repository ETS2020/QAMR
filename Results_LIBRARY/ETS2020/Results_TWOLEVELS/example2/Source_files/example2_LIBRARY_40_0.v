// Benchmark "FAU" written by ABC on Sat Jun 27 01:52:17 2020
...
module FAU ( 
  ...
  nand4  g115(.a(new_n257_), .b(new_n244_), .c(x50), .d(new_n248_), .O(new_n270_));
  inv1   g116(.a(new_n270_), .O(z32));
  xnor2a g117(.a(x83), .b(x81), .O(new_n272_));
  nand2  g118(.a(x42), .b(x05), .O(new_n273_));
  nand2  g119(.a(x51), .b(new_n248_), .O(new_n274_));
  oai22  g120(.a(new_n274_), .b(new_n252_), .c(new_n273_), .d(new_n272_), .O(new_n275_));
  nand2  g121(.a(new_n275_), .b(new_n250_), .O(new_n276_));
  ...
  inv1   g125(.a(new_n256_), .O(new_n280_));
  ...
  nand2  g130(.a(new_n284_), .b(new_n252_), .O(new_n285_));
  nand3  g131(.a(x83), .b(x81), .c(x42), .O(new_n286_));
  aoi21  g132(.a(new_n286_), .b(new_n285_), .c(new_n253_), .O(new_n287_));
  nand2  g133(.a(new_n284_), .b(x81), .O(new_n288_));
  nand3  g134(.a(x83), .b(new_n252_), .c(x42), .O(new_n289_));
  aoi21  g135(.a(new_n289_), .b(new_n288_), .c(new_n249_), .O(new_n290_));
  oai21  g136(.a(new_n290_), .b(new_n287_), .c(new_n280_), .O(new_n291_));
  nor3   g137(.a(new_n291_), .b(new_n245_), .c(new_n283_), .O(z34));
  nand2  g138(.a(new_n244_), .b(x53), .O(new_n293_));
  ...
  nor2   g143(.a(new_n298_), .b(new_n291_), .O(z38));
  nor3   g144(.a(new_n291_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g145(.a(new_n291_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g146(.a(new_n291_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g147(.a(new_n291_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g148(.a(new_n291_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g149(.a(new_n291_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g150(.a(new_n291_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g151(.a(new_n291_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g201(.a(new_n283_), .b(x14), .O(new_n357_));
  ...
  nand4  g215(.a(x80), .b(new_n228_), .c(x43), .d(new_n248_), .O(new_n372_));
  ...
  nand4  g220(.a(new_n167_), .b(new_n154_), .c(new_n248_), .d(x40), .O(new_n377_));
  ...
  nor2   g240(.a(new_n252_), .b(new_n167_), .O(new_n398_));
  ...
  oai21  g245(.a(new_n252_), .b(x78), .c(new_n393_), .O(new_n404_));
