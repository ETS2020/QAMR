...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n274_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nor3   g114(.a(new_n270_), .b(new_n223_), .c(new_n192_), .O(z39));
  nor3   g115(.a(new_n270_), .b(new_n223_), .c(new_n189_), .O(z40));
  nor3   g116(.a(new_n270_), .b(new_n223_), .c(new_n186_), .O(z41));
  nor3   g117(.a(new_n270_), .b(new_n223_), .c(new_n183_), .O(z42));
  nor3   g118(.a(new_n270_), .b(new_n223_), .c(new_n180_), .O(z43));
  nor3   g119(.a(new_n270_), .b(new_n223_), .c(new_n177_), .O(z44));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n174_), .O(z45));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n171_), .O(z46));
  ...
  nand2  g134(.a(new_n261_), .b(x14), .O(new_n303_));
  ...
  nand3  g139(.a(new_n248_), .b(x84), .c(new_n307_), .O(new_n308_));
  ...
  nand4  g147(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n317_));
