...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n280_, new_n288_, new_n291_, new_n292_, new_n293_, new_n294_,
  ...
  nor3   g123(.a(new_n274_), .b(new_n225_), .c(new_n192_), .O(z39));
  nor3   g124(.a(new_n274_), .b(new_n225_), .c(new_n189_), .O(z40));
  nor3   g125(.a(new_n274_), .b(new_n225_), .c(new_n186_), .O(z41));
  nor3   g126(.a(new_n274_), .b(new_n225_), .c(new_n183_), .O(z42));
  nor3   g127(.a(new_n274_), .b(new_n225_), .c(new_n180_), .O(z43));
  nor3   g128(.a(new_n274_), .b(new_n225_), .c(new_n177_), .O(z44));
  nand2  g129(.a(new_n224_), .b(x63), .O(new_n288_));
  nor2   g130(.a(new_n288_), .b(new_n274_), .O(z45));
  nor3   g131(.a(new_n274_), .b(new_n225_), .c(new_n173_), .O(z46));
  ...
  nand4  g151(.a(new_n224_), .b(new_n163_), .c(new_n315_), .d(x79), .O(new_n316_));
  nor2   g152(.a(new_n316_), .b(new_n314_), .O(z55));
  aoi21  g153(.a(x84), .b(new_n231_), .c(x76), .O(new_n318_));
  oai21  g154(.a(x84), .b(new_n231_), .c(new_n318_), .O(new_n319_));
  ...
  nand4  g159(.a(x80), .b(new_n324_), .c(x43), .d(new_n227_), .O(new_n325_));
  oai22  g160(.a(new_n325_), .b(new_n323_), .c(new_n227_), .d(x40), .O(new_n326_));
  nand2  g161(.a(x78), .b(x04), .O(new_n327_));
  inv1   g162(.a(new_n327_), .O(new_n328_));
  nand3  g163(.a(new_n328_), .b(new_n326_), .c(x79), .O(new_n329_));
  nand4  g164(.a(new_n162_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n330_));
  nand2  g165(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand2  g166(.a(new_n331_), .b(x77), .O(new_n332_));
  oai21  g167(.a(new_n310_), .b(new_n220_), .c(new_n162_), .O(new_n333_));
  ...
  oai21  g184(.a(x79), .b(new_n220_), .c(new_n350_), .O(new_n351_));
  nand2  g185(.a(new_n351_), .b(new_n160_), .O(new_n352_));
  nand2  g186(.a(new_n337_), .b(x79), .O(new_n353_));
  nand3  g187(.a(x81), .b(x79), .c(new_n220_), .O(new_n354_));
