...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n232_, new_n234_, new_n237_, new_n239_, new_n243_, new_n244_,
    new_n245_, new_n246_, new_n247_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n257_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n268_, new_n271_, new_n273_,
    new_n275_, new_n284_, new_n285_, new_n286_, new_n287_, new_n288_,
    new_n289_, new_n290_, new_n291_, new_n292_, new_n293_, new_n299_,
  ...
  nand2  g112(.a(new_n218_), .b(x57), .O(new_n275_));
  nor2   g113(.a(new_n275_), .b(new_n266_), .O(z39));
  nor3   g114(.a(new_n266_), .b(new_n219_), .c(new_n191_), .O(z40));
  nor3   g115(.a(new_n266_), .b(new_n219_), .c(new_n188_), .O(z41));
  nor3   g116(.a(new_n266_), .b(new_n219_), .c(new_n185_), .O(z42));
  nor3   g117(.a(new_n266_), .b(new_n219_), .c(new_n182_), .O(z43));
  nor3   g118(.a(new_n266_), .b(new_n219_), .c(new_n179_), .O(z44));
  nor3   g119(.a(new_n266_), .b(new_n219_), .c(new_n176_), .O(z45));
  nor3   g120(.a(new_n266_), .b(new_n219_), .c(new_n173_), .O(z46));
  ...
  inv1   g132(.a(x12), .O(new_n299_));
  nand2  g133(.a(x52), .b(x20), .O(new_n300_));
  oai21  g134(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand2  g135(.a(new_n301_), .b(new_n288_), .O(new_n302_));
  nor2   g136(.a(new_n162_), .b(x78), .O(new_n303_));
  nand4  g137(.a(new_n303_), .b(new_n290_), .c(x77), .d(x72), .O(new_n304_));
  aoi21  g138(.a(new_n304_), .b(new_n302_), .c(x01), .O(z52));
  nand2  g139(.a(x52), .b(x22), .O(new_n307_));
  nand2  g140(.a(new_n257_), .b(x14), .O(new_n308_));
  ...
  nand3  g145(.a(new_n244_), .b(x84), .c(new_n312_), .O(new_n313_));
  inv1   g146(.a(x80), .O(new_n314_));
  nand4  g147(.a(new_n218_), .b(new_n163_), .c(new_n314_), .d(x79), .O(new_n315_));
  nor2   g148(.a(new_n315_), .b(new_n313_), .O(z55));
  aoi21  g149(.a(x84), .b(new_n225_), .c(x76), .O(new_n317_));
  oai21  g150(.a(x84), .b(new_n225_), .c(new_n317_), .O(new_n318_));
  nand2  g151(.a(new_n318_), .b(new_n164_), .O(new_n319_));
  nand4  g152(.a(new_n319_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g153(.a(x84), .b(new_n243_), .c(x82), .d(x81), .O(new_n322_));
  inv1   g154(.a(x74), .O(new_n323_));
  nand4  g155(.a(x80), .b(new_n323_), .c(x43), .d(new_n221_), .O(new_n324_));
  oai22  g156(.a(new_n324_), .b(new_n322_), .c(new_n221_), .d(x40), .O(new_n325_));
  nand2  g157(.a(x78), .b(x04), .O(new_n326_));
  inv1   g158(.a(new_n326_), .O(new_n327_));
  nand3  g159(.a(new_n327_), .b(new_n325_), .c(x79), .O(new_n328_));
  nand4  g160(.a(new_n162_), .b(new_n154_), .c(new_n221_), .d(x40), .O(new_n329_));
  nand2  g161(.a(new_n329_), .b(new_n328_), .O(new_n330_));
  nand2  g162(.a(new_n330_), .b(x77), .O(new_n331_));
  oai21  g163(.a(new_n309_), .b(new_n214_), .c(new_n162_), .O(new_n332_));
  ...
  oai21  g180(.a(x79), .b(new_n214_), .c(new_n349_), .O(new_n350_));
  nand2  g181(.a(new_n350_), .b(new_n160_), .O(new_n351_));
  nand2  g182(.a(new_n336_), .b(x79), .O(new_n352_));
  nand3  g183(.a(x81), .b(x79), .c(new_n214_), .O(new_n353_));
  ...
  nor2   g195(.a(new_n225_), .b(x78), .O(new_n365_));
