...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n271_, new_n273_, new_n275_, new_n278_, new_n288_,
  ...
  nor3   g121(.a(new_n271_), .b(new_n225_), .c(new_n185_), .O(z42));
  nor3   g122(.a(new_n271_), .b(new_n225_), .c(new_n182_), .O(z43));
  nor3   g123(.a(new_n271_), .b(new_n225_), .c(new_n179_), .O(z44));
  nor3   g124(.a(new_n271_), .b(new_n225_), .c(new_n176_), .O(z45));
  nor3   g125(.a(new_n271_), .b(new_n225_), .c(new_n173_), .O(z46));
  ...
  nor2   g134(.a(x78), .b(new_n160_), .O(new_n296_));
  nand4  g135(.a(new_n296_), .b(new_n295_), .c(new_n294_), .d(x79), .O(new_n297_));
  aoi21  g136(.a(new_n297_), .b(new_n293_), .c(x01), .O(z47));
  nand2  g137(.a(x52), .b(x22), .O(new_n305_));
  nand2  g138(.a(new_n262_), .b(x14), .O(new_n306_));
  nor2   g139(.a(new_n154_), .b(x77), .O(new_n307_));
  nand4  g140(.a(new_n307_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n308_));
  aoi21  g141(.a(new_n306_), .b(new_n305_), .c(new_n308_), .O(z54));
  inv1   g142(.a(x82), .O(new_n310_));
  nand3  g143(.a(new_n249_), .b(x84), .c(new_n310_), .O(new_n311_));
  inv1   g144(.a(x80), .O(new_n312_));
  nand4  g145(.a(new_n224_), .b(new_n163_), .c(new_n312_), .d(x79), .O(new_n313_));
  nor2   g146(.a(new_n313_), .b(new_n311_), .O(z55));
  aoi21  g147(.a(x84), .b(new_n231_), .c(x76), .O(new_n315_));
  oai21  g148(.a(x84), .b(new_n231_), .c(new_n315_), .O(new_n316_));
  nand2  g149(.a(new_n316_), .b(new_n164_), .O(new_n317_));
  nand4  g150(.a(new_n317_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g151(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n320_));
  inv1   g152(.a(x74), .O(new_n321_));
  nand4  g153(.a(x80), .b(new_n321_), .c(x43), .d(new_n227_), .O(new_n322_));
  oai22  g154(.a(new_n322_), .b(new_n320_), .c(new_n227_), .d(x40), .O(new_n323_));
  nand2  g155(.a(x78), .b(x04), .O(new_n324_));
  inv1   g156(.a(new_n324_), .O(new_n325_));
  nand3  g157(.a(new_n325_), .b(new_n323_), .c(x79), .O(new_n326_));
  nand4  g158(.a(new_n162_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n327_));
  nand2  g159(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  nand2  g160(.a(new_n328_), .b(x77), .O(new_n329_));
  oai21  g161(.a(new_n307_), .b(new_n220_), .c(new_n162_), .O(new_n330_));
  aoi21  g162(.a(new_n330_), .b(new_n329_), .c(x01), .O(z58));
  aoi21  g163(.a(new_n324_), .b(x79), .c(new_n152_), .O(new_n332_));
  nand3  g164(.a(x80), .b(new_n321_), .c(x43), .O(new_n333_));
  oai21  g165(.a(new_n333_), .b(new_n320_), .c(new_n227_), .O(new_n334_));
  aoi21  g166(.a(new_n334_), .b(x79), .c(new_n324_), .O(new_n335_));
  oai21  g167(.a(new_n335_), .b(new_n332_), .c(x77), .O(new_n336_));
  nand2  g168(.a(new_n162_), .b(new_n220_), .O(new_n337_));
  aoi21  g169(.a(new_n337_), .b(new_n336_), .c(x01), .O(z59));
  oai21  g170(.a(new_n307_), .b(new_n296_), .c(new_n294_), .O(new_n340_));
  nand2  g171(.a(new_n163_), .b(new_n220_), .O(new_n341_));
  nand2  g172(.a(new_n341_), .b(new_n340_), .O(new_n342_));
  inv1   g173(.a(new_n342_), .O(new_n343_));
  nor2   g174(.a(new_n162_), .b(x01), .O(new_n344_));
  inv1   g175(.a(new_n344_), .O(new_n345_));
  nor3   g176(.a(new_n345_), .b(new_n343_), .c(new_n312_), .O(z61));
  nand3  g177(.a(x84), .b(x81), .c(x79), .O(new_n347_));
  oai21  g178(.a(x79), .b(new_n220_), .c(new_n347_), .O(new_n348_));
  nand2  g179(.a(new_n348_), .b(new_n160_), .O(new_n349_));
  nand2  g180(.a(new_n334_), .b(x79), .O(new_n350_));
  nand3  g181(.a(x81), .b(x79), .c(new_n220_), .O(new_n351_));
  inv1   g182(.a(new_n351_), .O(new_n352_));
  aoi21  g183(.a(new_n350_), .b(x04), .c(new_n352_), .O(new_n353_));
  oai21  g184(.a(new_n353_), .b(new_n160_), .c(new_n349_), .O(new_n354_));
  nand2  g185(.a(new_n354_), .b(x78), .O(new_n355_));
  inv1   g186(.a(new_n347_), .O(new_n356_));
  nand2  g187(.a(new_n356_), .b(new_n296_), .O(new_n357_));
  aoi21  g188(.a(new_n357_), .b(new_n355_), .c(x01), .O(z62));
  nor3   g189(.a(new_n345_), .b(new_n343_), .c(new_n310_), .O(z63));
  nand3  g190(.a(new_n342_), .b(x83), .c(x79), .O(new_n360_));
  aoi21  g191(.a(new_n360_), .b(new_n291_), .c(x01), .O(z64));
  nor2   g192(.a(new_n154_), .b(x04), .O(new_n362_));
  nor2   g193(.a(new_n231_), .b(x78), .O(new_n363_));
  oai21  g194(.a(new_n363_), .b(new_n362_), .c(x77), .O(new_n364_));
  nand2  g195(.a(new_n307_), .b(x81), .O(new_n365_));
  nand2  g196(.a(new_n344_), .b(x84), .O(new_n366_));
