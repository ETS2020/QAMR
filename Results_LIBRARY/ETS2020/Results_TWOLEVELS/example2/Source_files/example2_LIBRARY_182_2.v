...
module FAU ( 
  ...
  nor2   g176(.a(new_n160_), .b(x04), .O(new_n358_));
  nor2   g177(.a(new_n228_), .b(x78), .O(new_n359_));
  oai21  g178(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand3  g179(.a(x81), .b(x78), .c(new_n159_), .O(new_n361_));
  nand2  g180(.a(new_n171_), .b(x84), .O(new_n362_));
  aoi21  g181(.a(new_n361_), .b(new_n360_), .c(new_n362_), .O(z65));
  zero   g182(.O(z03));
  zero   g183(.O(z06));
  zero   g184(.O(z07));
  zero   g185(.O(z08));
