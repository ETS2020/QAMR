// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:54 2020
...
module FAU ( 
  ...
  nand4  g113(.a(new_n257_), .b(new_n244_), .c(x49), .d(new_n248_), .O(new_n268_));
  ...
  nand4  g213(.a(x80), .b(new_n228_), .c(x43), .d(new_n248_), .O(new_n371_));
  ...
  nand4  g218(.a(new_n167_), .b(new_n154_), .c(new_n248_), .d(x40), .O(new_n376_));
  ...
  nor2   g238(.a(new_n252_), .b(new_n167_), .O(new_n397_));
  ...
  oai21  g243(.a(new_n252_), .b(x78), .c(new_n392_), .O(new_n403_));
