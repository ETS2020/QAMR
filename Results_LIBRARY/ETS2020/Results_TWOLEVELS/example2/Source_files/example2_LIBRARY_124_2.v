...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n254_, new_n255_, new_n256_, new_n257_, new_n259_, new_n271_,
  ...
  inv1   g076(.a(new_n162_), .O(new_n247_));
  nand2  g077(.a(x83), .b(x42), .O(new_n248_));
  nand2  g078(.a(new_n248_), .b(new_n224_), .O(new_n249_));
  inv1   g079(.a(new_n248_), .O(new_n250_));
  nand2  g080(.a(new_n250_), .b(x81), .O(new_n251_));
  aoi21  g081(.a(new_n251_), .b(new_n249_), .c(new_n227_), .O(new_n252_));
  nand2  g082(.a(new_n248_), .b(x81), .O(new_n253_));
  nand2  g083(.a(new_n250_), .b(new_n224_), .O(new_n254_));
  aoi21  g084(.a(new_n254_), .b(new_n253_), .c(new_n225_), .O(new_n255_));
  oai21  g085(.a(new_n255_), .b(new_n252_), .c(new_n247_), .O(new_n256_));
  nand2  g086(.a(new_n231_), .b(x54), .O(new_n257_));
  nor2   g087(.a(new_n257_), .b(new_n256_), .O(z36));
  nand2  g088(.a(new_n231_), .b(x55), .O(new_n259_));
  nor2   g089(.a(new_n259_), .b(new_n256_), .O(z37));
