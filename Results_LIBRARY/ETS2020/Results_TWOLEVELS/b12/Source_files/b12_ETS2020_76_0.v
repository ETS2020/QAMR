// Benchmark "FAU" written by ABC on Tue Jun 23 04:23:35 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n49_, new_n51_, new_n52_, new_n54_, new_n55_, new_n59_, new_n60_,
  ...
  nand3  g25(.a(x09), .b(x08), .c(x00), .O(new_n51_));
  nand2  g26(.a(new_n51_), .b(new_n40_), .O(new_n52_));
  oai21  g27(.a(x11), .b(new_n40_), .c(new_n52_), .O(z4));
  inv1   g28(.a(x13), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x12), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n41_), .c(new_n40_), .d(new_n49_), .O(z5));
  inv1   g31(.a(x12), .O(new_n59_));
  nand4  g32(.a(new_n59_), .b(x03), .c(new_n31_), .d(new_n35_), .O(new_n60_));
  nand2  g33(.a(new_n60_), .b(x09), .O(new_n61_));
  inv1   g34(.a(x09), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  nand4  g36(.a(new_n63_), .b(new_n61_), .c(new_n41_), .d(new_n40_), .O(z8));
  zero   g37(.O(z0));
  zero   g38(.O(z6));
  zero   g39(.O(z7));
endmodule
