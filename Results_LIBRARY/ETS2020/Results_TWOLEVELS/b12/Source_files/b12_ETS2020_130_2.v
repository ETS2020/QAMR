...
module FAU ( 
  ...
  nor2   g44(.a(new_n34_), .b(x01), .O(new_n72_));
  oai21  g45(.a(x07), .b(new_n30_), .c(new_n72_), .O(new_n73_));
  nand2  g46(.a(new_n73_), .b(new_n60_), .O(new_n74_));
  nor2   g47(.a(new_n62_), .b(x02), .O(new_n75_));
  aoi21  g48(.a(new_n75_), .b(new_n72_), .c(new_n45_), .O(new_n76_));
