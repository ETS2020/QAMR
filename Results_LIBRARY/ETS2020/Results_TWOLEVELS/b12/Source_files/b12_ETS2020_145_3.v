// Benchmark "FAU" written by ABC on Tue Jun 23 04:23:58 2020
...
module FAU ( 
  ...
  nand3  g29(.a(x09), .b(x08), .c(x00), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(new_n45_), .O(new_n56_));
  oai21  g31(.a(x11), .b(new_n45_), .c(new_n56_), .O(z4));
  inv1   g32(.a(x12), .O(new_n58_));
  nor2   g33(.a(x07), .b(x00), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(x13), .c(new_n58_), .d(new_n46_), .O(z5));
  nor2   g35(.a(x07), .b(new_n30_), .O(new_n62_));
  nand2  g36(.a(x03), .b(new_n25_), .O(new_n63_));
  oai21  g37(.a(new_n63_), .b(new_n62_), .c(new_n49_), .O(new_n64_));
  nor2   g38(.a(x02), .b(x01), .O(new_n65_));
  and2   g39(.a(x09), .b(x03), .O(new_n66_));
  nand2  g40(.a(new_n46_), .b(new_n45_), .O(new_n67_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n64_), .O(z7));
  nand3  g43(.a(new_n65_), .b(new_n58_), .c(x03), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(x09), .O(new_n71_));
  nor2   g45(.a(x09), .b(x00), .O(new_n72_));
  nor2   g46(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n71_), .O(z8));
  zero   g48(.O(z3));
  zero   g49(.O(z6));
endmodule
