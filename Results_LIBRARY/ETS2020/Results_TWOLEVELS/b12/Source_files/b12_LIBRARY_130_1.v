...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    ...
    new_n41_, new_n42_, new_n44_, new_n46_, new_n47_, new_n49_, new_n53_,
  ...
  nand3  g19(.a(x09), .b(x08), .c(x00), .O(new_n46_));
  nand2  g20(.a(new_n46_), .b(new_n35_), .O(new_n47_));
  oai21  g21(.a(x11), .b(new_n35_), .c(new_n47_), .O(z4));
  nor2   g22(.a(x12), .b(x00), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(x13), .c(new_n36_), .d(new_n35_), .O(z5));
  inv1   g24(.a(x12), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(x03), .c(new_n28_), .d(new_n29_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x09), .O(new_n55_));
  inv1   g27(.a(x09), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  nand4  g29(.a(new_n57_), .b(new_n55_), .c(new_n36_), .d(new_n35_), .O(z8));
  zero   g30(.O(z0));
  zero   g31(.O(z1));
  zero   g32(.O(z6));
  zero   g33(.O(z7));
