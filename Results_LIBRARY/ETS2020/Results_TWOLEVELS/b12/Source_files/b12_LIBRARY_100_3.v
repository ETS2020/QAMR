...
module FAU ( 
  ...
  nor2   g36(.a(x12), .b(x10), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n40_), .d(new_n61_), .O(z5));
  aoi21  g38(.a(x09), .b(new_n34_), .c(x02), .O(new_n64_));
  nand3  g39(.a(new_n57_), .b(x03), .c(new_n30_), .O(new_n65_));
  oai21  g40(.a(new_n64_), .b(x01), .c(new_n65_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n58_), .O(new_n67_));
  inv1   g42(.a(x14), .O(new_n68_));
  nand2  g43(.a(new_n30_), .b(new_n61_), .O(new_n69_));
  oai21  g44(.a(x08), .b(new_n61_), .c(new_n69_), .O(new_n70_));
  nor2   g45(.a(new_n30_), .b(x00), .O(new_n71_));
  aoi22  g46(.a(new_n71_), .b(new_n68_), .c(new_n70_), .d(x01), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n67_), .c(new_n45_), .O(z6));
  nand2  g48(.a(x03), .b(new_n25_), .O(new_n74_));
  aoi21  g49(.a(new_n40_), .b(x02), .c(new_n74_), .O(new_n75_));
  nor2   g50(.a(new_n34_), .b(x01), .O(new_n76_));
  nor2   g51(.a(new_n57_), .b(x02), .O(new_n77_));
