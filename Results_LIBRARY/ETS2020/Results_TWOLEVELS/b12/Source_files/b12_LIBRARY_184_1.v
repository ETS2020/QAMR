// Benchmark "FAU" written by ABC on Tue Jun 23 04:24:11 2020
...
module FAU ( 
  ...
  nor2   g30(.a(new_n55_), .b(x12), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n41_), .c(new_n40_), .d(new_n49_), .O(z5));
  nand2  g32(.a(new_n41_), .b(new_n40_), .O(new_n58_));
  aoi21  g33(.a(new_n51_), .b(x03), .c(x01), .O(new_n59_));
  nand3  g34(.a(x09), .b(new_n27_), .c(new_n35_), .O(new_n60_));
  oai21  g35(.a(new_n59_), .b(x02), .c(new_n60_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n52_), .O(new_n62_));
  nand2  g37(.a(new_n35_), .b(new_n49_), .O(new_n63_));
  oai21  g38(.a(x08), .b(new_n49_), .c(new_n63_), .O(new_n64_));
  inv1   g39(.a(x14), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x01), .c(new_n49_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  aoi21  g42(.a(new_n64_), .b(x02), .c(new_n67_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n62_), .c(new_n58_), .O(z6));
  nand3  g44(.a(x09), .b(x03), .c(new_n35_), .O(new_n70_));
  nand4  g45(.a(new_n41_), .b(new_n44_), .c(new_n40_), .d(x01), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n31_), .O(new_n73_));
  oai21  g48(.a(x07), .b(new_n31_), .c(x03), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n44_), .c(new_n58_), .O(new_n75_));
