...
module FAU ( 
  ...
  nand3  g41(.a(x09), .b(x03), .c(new_n27_), .O(new_n67_));
  nand4  g42(.a(new_n42_), .b(new_n45_), .c(new_n41_), .d(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n25_), .O(new_n70_));
  nand2  g45(.a(x03), .b(new_n25_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n45_), .c(new_n58_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n70_), .O(z7));
  inv1   g48(.a(x12), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n27_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n71_), .c(x09), .O(new_n76_));
  aoi21  g51(.a(new_n52_), .b(new_n50_), .c(new_n58_), .O(new_n77_));
