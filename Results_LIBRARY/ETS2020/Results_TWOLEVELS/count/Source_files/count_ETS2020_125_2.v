...
module FAU ( 
  ...
  nand4  g085(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n139_));
  nor2   g086(.a(x26), .b(x25), .O(new_n140_));
  nor2   g087(.a(x30), .b(x29), .O(new_n141_));
  nand4  g088(.a(new_n141_), .b(new_n122_), .c(new_n140_), .d(new_n83_), .O(new_n142_));
  oai21  g089(.a(new_n142_), .b(new_n139_), .c(x31), .O(new_n143_));
  ...
  nand3  g094(.a(new_n147_), .b(new_n120_), .c(new_n87_), .O(new_n148_));
  nand2  g095(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  ...
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n113_), .d(new_n94_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n86_), .c(x32), .O(new_n155_));
  nor2   g102(.a(x32), .b(x31), .O(new_n156_));
  nand4  g103(.a(new_n156_), .b(new_n141_), .c(new_n122_), .d(new_n140_), .O(new_n157_));
  inv1   g104(.a(new_n157_), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(new_n87_), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand2  g107(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g108(.a(x02), .O(new_n162_));
  aoi21  g109(.a(new_n59_), .b(new_n162_), .c(x18), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(new_n161_), .O(z13));
  oai21  g111(.a(new_n157_), .b(new_n86_), .c(x33), .O(new_n165_));
  nor2   g112(.a(x33), .b(x32), .O(new_n166_));
  nand4  g113(.a(new_n166_), .b(new_n145_), .c(new_n144_), .d(new_n113_), .O(new_n167_));
  inv1   g114(.a(new_n167_), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(new_n96_), .O(new_n169_));
  nand2  g116(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g117(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g118(.a(x01), .O(new_n172_));
  aoi21  g119(.a(new_n59_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(new_n171_), .O(z14));
  oai21  g121(.a(new_n167_), .b(new_n104_), .c(x34), .O(new_n175_));
  nand2  g122(.a(new_n144_), .b(new_n113_), .O(new_n176_));
