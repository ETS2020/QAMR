...
module FAU ( 
  ...
  nor2   g11(.a(x21), .b(x20), .O(new_n64_));
  aoi22  g12(.a(new_n64_), .b(new_n55_), .c(new_n63_), .d(x21), .O(new_n65_));
  inv1   g13(.a(x13), .O(new_n66_));
  aoi21  g14(.a(new_n58_), .b(new_n66_), .c(x18), .O(new_n67_));
  oai21  g15(.a(new_n65_), .b(new_n58_), .c(new_n67_), .O(z02));
  zero   g16(.O(z01));
  zero   g17(.O(z03));
  zero   g18(.O(z04));
  zero   g19(.O(z05));
