// Benchmark "FAU" written by ABC on Tue Jun 23 07:15:45 2020
...
module FAU ( 
  ...
  nand4  g045(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n54_), .O(new_n99_));
  ...
  aoi21  g052(.a(new_n59_), .b(new_n105_), .c(x18), .O(new_n106_));
  ...
  aoi21  g059(.a(new_n59_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g060(.a(new_n111_), .b(new_n59_), .c(new_n113_), .O(z08));
  nor3   g061(.a(x27), .b(x26), .c(x25), .O(new_n115_));
  nand4  g062(.a(new_n115_), .b(new_n84_), .c(new_n72_), .d(new_n56_), .O(new_n116_));
  ...
  aoi21  g069(.a(new_n59_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g070(.a(new_n121_), .b(new_n59_), .c(new_n123_), .O(z09));
  inv1   g071(.a(x29), .O(new_n125_));
  nor3   g072(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g073(.a(new_n126_), .b(new_n101_), .c(new_n78_), .d(new_n56_), .O(new_n127_));
  ...
  aoi21  g077(.a(new_n59_), .b(new_n130_), .c(x18), .O(new_n131_));
  nand2  g078(.a(new_n131_), .b(new_n129_), .O(z10));
  nand4  g079(.a(new_n97_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n133_));
  ...
  aoi21  g086(.a(new_n59_), .b(new_n139_), .c(x18), .O(new_n140_));
  oai21  g087(.a(new_n138_), .b(new_n59_), .c(new_n140_), .O(z11));
  ...
  nand4  g095(.a(new_n148_), .b(new_n115_), .c(new_n144_), .d(new_n56_), .O(new_n149_));
  nand2  g096(.a(new_n149_), .b(new_n142_), .O(new_n150_));
  nand2  g097(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g098(.a(x03), .O(new_n152_));
  aoi21  g099(.a(new_n59_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g100(.a(new_n153_), .b(new_n151_), .O(z12));
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n108_), .d(new_n89_), .O(new_n155_));
  oai21  g102(.a(new_n155_), .b(new_n85_), .c(x32), .O(new_n156_));
  nand2  g103(.a(new_n135_), .b(new_n117_), .O(new_n157_));
  inv1   g104(.a(new_n157_), .O(new_n158_));
  nor2   g105(.a(x32), .b(x31), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n134_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n158_), .c(new_n144_), .d(new_n56_), .O(new_n162_));
  nand2  g109(.a(new_n162_), .b(new_n156_), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g111(.a(x02), .O(new_n165_));
  aoi21  g112(.a(new_n59_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n164_), .O(z13));
  nand4  g114(.a(new_n159_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n168_));
  oai21  g115(.a(new_n168_), .b(new_n85_), .c(x33), .O(new_n169_));
  nor2   g116(.a(x33), .b(x32), .O(new_n170_));
  nand4  g117(.a(new_n170_), .b(new_n146_), .c(new_n145_), .d(new_n108_), .O(new_n171_));
  inv1   g118(.a(new_n171_), .O(new_n172_));
  nand2  g119(.a(new_n172_), .b(new_n91_), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand2  g121(.a(new_n174_), .b(x16), .O(new_n175_));
  inv1   g122(.a(x01), .O(new_n176_));
  aoi21  g123(.a(new_n59_), .b(new_n176_), .c(x18), .O(new_n177_));
  nand2  g124(.a(new_n177_), .b(new_n175_), .O(z14));
  oai21  g125(.a(new_n171_), .b(new_n99_), .c(x34), .O(new_n179_));
  nand2  g126(.a(new_n145_), .b(new_n108_), .O(new_n180_));
  inv1   g127(.a(new_n180_), .O(new_n181_));
  inv1   g128(.a(x30), .O(new_n182_));
  inv1   g129(.a(x31), .O(new_n183_));
  nand2  g130(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  inv1   g131(.a(x32), .O(new_n185_));
  inv1   g132(.a(x33), .O(new_n186_));
  inv1   g133(.a(x34), .O(new_n187_));
  nand3  g134(.a(new_n187_), .b(new_n186_), .c(new_n185_), .O(new_n188_));
  nor2   g135(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand3  g136(.a(new_n189_), .b(new_n181_), .c(new_n91_), .O(new_n190_));
  nand2  g137(.a(new_n190_), .b(new_n179_), .O(new_n191_));
  nand2  g138(.a(new_n191_), .b(x16), .O(new_n192_));
  inv1   g139(.a(x00), .O(new_n193_));
  aoi21  g140(.a(new_n59_), .b(new_n193_), .c(x18), .O(new_n194_));
  nand2  g141(.a(new_n194_), .b(new_n192_), .O(z15));
  zero   g142(.O(z00));
  zero   g143(.O(z05));
endmodule
