// Benchmark "FAU" written by ABC on Tue Jun 23 16:25:27 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n69_, new_n77_, new_n78_,
  ...
  nand3  g26(.a(x19), .b(x18), .c(x17), .O(new_n77_));
  nand2  g27(.a(new_n77_), .b(x20), .O(new_n78_));
  nand4  g28(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n79_));
  inv1   g29(.a(x15), .O(new_n80_));
  nand2  g30(.a(new_n58_), .b(new_n80_), .O(new_n81_));
  inv1   g31(.a(new_n81_), .O(new_n82_));
  nand3  g32(.a(new_n82_), .b(new_n79_), .c(new_n78_), .O(z13));
  inv1   g33(.a(new_n77_), .O(new_n84_));
  nor2   g34(.a(x21), .b(x20), .O(new_n85_));
  nand2  g35(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g36(.a(new_n79_), .b(x21), .O(new_n87_));
  nand3  g37(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(z14));
  nand2  g38(.a(new_n86_), .b(x22), .O(new_n89_));
  nor2   g39(.a(x22), .b(x21), .O(new_n90_));
  nand3  g40(.a(new_n90_), .b(new_n84_), .c(new_n49_), .O(new_n91_));
  nand3  g41(.a(new_n91_), .b(new_n89_), .c(new_n82_), .O(z15));
  nand2  g42(.a(new_n91_), .b(x23), .O(new_n93_));
  nor2   g43(.a(x23), .b(x22), .O(new_n94_));
  nand3  g44(.a(new_n94_), .b(new_n85_), .c(new_n84_), .O(new_n95_));
  nand3  g45(.a(new_n95_), .b(new_n93_), .c(new_n82_), .O(z16));
  nand2  g46(.a(new_n95_), .b(x24), .O(new_n97_));
  inv1   g47(.a(new_n79_), .O(new_n98_));
  nor2   g48(.a(x24), .b(x23), .O(new_n99_));
  nand3  g49(.a(new_n99_), .b(new_n90_), .c(new_n98_), .O(new_n100_));
  nand3  g50(.a(new_n100_), .b(new_n97_), .c(new_n82_), .O(z17));
  nand4  g51(.a(new_n99_), .b(new_n90_), .c(new_n98_), .d(new_n48_), .O(new_n102_));
  nand2  g52(.a(new_n100_), .b(x25), .O(new_n103_));
  nand3  g53(.a(new_n103_), .b(new_n102_), .c(new_n82_), .O(z18));
  zero   g54(.O(z08));
  zero   g55(.O(z09));
  zero   g56(.O(z10));
  zero   g57(.O(z11));
