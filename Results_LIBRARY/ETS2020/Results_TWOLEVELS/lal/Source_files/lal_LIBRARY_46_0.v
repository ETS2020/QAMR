// Benchmark "FAU" written by ABC on Tue Jun 23 16:22:28 2020
...
module FAU ( 
  ...
  nand3  g28(.a(new_n74_), .b(new_n57_), .c(new_n49_), .O(new_n77_));
  inv1   g29(.a(new_n77_), .O(z10));
  xnor2a g30(.a(x18), .b(x17), .O(new_n79_));
  nand2  g31(.a(new_n74_), .b(new_n57_), .O(new_n80_));
  nor2   g32(.a(new_n80_), .b(new_n79_), .O(z11));
  oai21  g33(.a(new_n50_), .b(new_n49_), .c(x19), .O(new_n82_));
  nor2   g34(.a(new_n50_), .b(new_n49_), .O(new_n83_));
  nand2  g35(.a(new_n83_), .b(new_n51_), .O(new_n84_));
  aoi21  g36(.a(new_n84_), .b(new_n82_), .c(new_n80_), .O(z12));
  nand3  g37(.a(new_n83_), .b(new_n48_), .c(x19), .O(new_n91_));
  inv1   g38(.a(new_n91_), .O(new_n92_));
  nor2   g39(.a(x22), .b(x21), .O(new_n93_));
  nor2   g40(.a(x24), .b(x23), .O(new_n94_));
  nand4  g41(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n47_), .O(new_n95_));
  nand2  g42(.a(new_n94_), .b(new_n93_), .O(new_n96_));
  oai21  g43(.a(new_n96_), .b(new_n91_), .c(x25), .O(new_n97_));
  nand4  g44(.a(new_n97_), .b(new_n95_), .c(new_n74_), .d(new_n57_), .O(z18));
  zero   g45(.O(z00));
  zero   g46(.O(z02));
  zero   g47(.O(z07));
  zero   g48(.O(z13));
