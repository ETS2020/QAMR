...
module FAU ( 
  ...
  nand2  g28(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g29(.a(new_n76_), .b(new_n51_), .O(new_n79_));
  aoi21  g30(.a(new_n79_), .b(new_n78_), .c(new_n74_), .O(z12));
  inv1   g31(.a(x21), .O(new_n83_));
  nand3  g32(.a(new_n83_), .b(new_n48_), .c(x19), .O(new_n84_));
  oai21  g33(.a(new_n84_), .b(new_n77_), .c(x22), .O(new_n85_));
  inv1   g34(.a(x22), .O(new_n86_));
  nand2  g35(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand3  g36(.a(new_n76_), .b(new_n48_), .c(x19), .O(new_n88_));
  nor2   g37(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g38(.a(new_n68_), .b(new_n57_), .O(new_n90_));
  nor2   g39(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n85_), .O(z15));
  inv1   g41(.a(new_n90_), .O(new_n95_));
  nor2   g42(.a(x24), .b(x23), .O(new_n96_));
  nand3  g43(.a(new_n96_), .b(new_n89_), .c(new_n47_), .O(new_n97_));
  nand3  g44(.a(new_n96_), .b(new_n86_), .c(new_n83_), .O(new_n98_));
  oai21  g45(.a(new_n98_), .b(new_n88_), .c(x25), .O(new_n99_));
  nand3  g46(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(z18));
  zero   g47(.O(z00));
  zero   g48(.O(z02));
  zero   g49(.O(z04));
  zero   g50(.O(z07));
