...
module FAU ( 
  ...
  nand2  g26(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g27(.a(new_n75_), .b(new_n51_), .O(new_n78_));
  aoi21  g28(.a(new_n78_), .b(new_n77_), .c(new_n73_), .O(z12));
  inv1   g29(.a(x21), .O(new_n82_));
  nand3  g30(.a(new_n82_), .b(new_n48_), .c(x19), .O(new_n83_));
  oai21  g31(.a(new_n83_), .b(new_n76_), .c(x22), .O(new_n84_));
  inv1   g32(.a(x22), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand3  g34(.a(new_n75_), .b(new_n48_), .c(x19), .O(new_n87_));
  nor2   g35(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g36(.a(new_n67_), .b(new_n57_), .O(new_n89_));
  nor2   g37(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n84_), .O(z15));
  inv1   g39(.a(new_n89_), .O(new_n94_));
  nor2   g40(.a(x24), .b(x23), .O(new_n95_));
  nand3  g41(.a(new_n95_), .b(new_n88_), .c(new_n47_), .O(new_n96_));
  nand3  g42(.a(new_n95_), .b(new_n85_), .c(new_n82_), .O(new_n97_));
  oai21  g43(.a(new_n97_), .b(new_n87_), .c(x25), .O(new_n98_));
  nand3  g44(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(z18));
  zero   g45(.O(z00));
  zero   g46(.O(z02));
  zero   g47(.O(z04));
  zero   g48(.O(z06));
