...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n67_, new_n68_,
  ...
  inv1   g17(.a(x07), .O(new_n67_));
  inv1   g18(.a(x15), .O(new_n68_));
  nand2  g19(.a(x05), .b(x04), .O(new_n69_));
  nand4  g20(.a(new_n69_), .b(new_n50_), .c(new_n68_), .d(new_n67_), .O(new_n70_));
