...
module FAU ( 
  ...
  nand4  g47(.a(new_n99_), .b(new_n90_), .c(new_n98_), .d(new_n48_), .O(new_n100_));
  nand2  g48(.a(new_n99_), .b(new_n90_), .O(new_n101_));
  oai21  g49(.a(new_n101_), .b(new_n79_), .c(x25), .O(new_n102_));
  nand3  g50(.a(new_n102_), .b(new_n100_), .c(new_n82_), .O(z18));
  zero   g51(.O(z05));
  zero   g52(.O(z08));
  zero   g53(.O(z09));
  zero   g54(.O(z10));
