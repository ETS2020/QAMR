// Benchmark "FAU" written by ABC on Tue Jun 23 16:25:14 2020
...
module FAU ( 
  ...
  nor2   g23(.a(x15), .b(x07), .O(new_n73_));
  nand2  g24(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  inv1   g25(.a(new_n74_), .O(z09));
  nand3  g26(.a(new_n73_), .b(new_n57_), .c(new_n49_), .O(new_n76_));
  inv1   g27(.a(new_n76_), .O(z10));
  xnor2a g28(.a(x18), .b(x17), .O(new_n78_));
  nand2  g29(.a(new_n73_), .b(new_n57_), .O(new_n79_));
  ...
  nand4  g42(.a(new_n96_), .b(new_n94_), .c(new_n73_), .d(new_n57_), .O(z18));
  zero   g43(.O(z00));
  zero   g44(.O(z02));
  zero   g45(.O(z06));
  zero   g46(.O(z07));
