...
module FAU ( 
  ...
  inv1   g80(.a(x15), .O(new_n134_));
  nor2   g81(.a(x18), .b(new_n134_), .O(new_n135_));
  nor2   g82(.a(x33), .b(new_n55_), .O(new_n136_));
  oai21  g83(.a(new_n136_), .b(new_n135_), .c(new_n58_), .O(new_n137_));
  inv1   g84(.a(x32), .O(new_n138_));
  nand2  g85(.a(new_n138_), .b(new_n57_), .O(new_n139_));
  nand2  g86(.a(new_n139_), .b(new_n137_), .O(z12));
  inv1   g87(.a(x14), .O(new_n141_));
  nor2   g88(.a(x18), .b(new_n141_), .O(new_n142_));
  nor2   g89(.a(x34), .b(new_n55_), .O(new_n143_));
  oai21  g90(.a(new_n143_), .b(new_n142_), .c(new_n58_), .O(new_n144_));
  inv1   g91(.a(x33), .O(new_n145_));
  nand2  g92(.a(new_n145_), .b(new_n57_), .O(new_n146_));
  nand2  g93(.a(new_n146_), .b(new_n144_), .O(z13));
  zero   g94(.O(z08));
  zero   g95(.O(z14));
  zero   g96(.O(z15));
endmodule
