...
module FAU ( 
  ...
  inv1   g73(.a(x09), .O(new_n126_));
  nor2   g74(.a(x18), .b(new_n126_), .O(new_n127_));
  nor2   g75(.a(x31), .b(new_n55_), .O(new_n128_));
  oai21  g76(.a(new_n128_), .b(new_n127_), .c(new_n58_), .O(new_n129_));
  inv1   g77(.a(x30), .O(new_n130_));
  nand2  g78(.a(new_n130_), .b(new_n57_), .O(new_n131_));
  nand2  g79(.a(new_n131_), .b(new_n129_), .O(z10));
