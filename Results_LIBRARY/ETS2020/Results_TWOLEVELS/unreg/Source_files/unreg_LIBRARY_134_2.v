...
module FAU ( 
  ...
  wire new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n71_, new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_,
  ...
  nor2   g19(.a(x30), .b(new_n57_), .O(new_n79_));
  oai21  g20(.a(new_n79_), .b(new_n78_), .c(new_n60_), .O(new_n80_));
  inv1   g21(.a(x29), .O(new_n81_));
  nand2  g22(.a(new_n81_), .b(new_n59_), .O(new_n82_));
