// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:35 2020
...
module FAU ( 
  ...
  nor2   g40(.a(x26), .b(new_n55_), .O(new_n93_));
  oai21  g41(.a(new_n93_), .b(new_n92_), .c(new_n58_), .O(new_n94_));
  inv1   g42(.a(x25), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n57_), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n94_), .O(z05));
  inv1   g45(.a(x05), .O(new_n98_));
  nor2   g46(.a(x18), .b(new_n98_), .O(new_n99_));
  nor2   g47(.a(x27), .b(new_n55_), .O(new_n100_));
  oai21  g48(.a(new_n100_), .b(new_n99_), .c(new_n58_), .O(new_n101_));
  inv1   g49(.a(x26), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n57_), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n101_), .O(z06));
  inv1   g52(.a(x04), .O(new_n105_));
  nor2   g53(.a(x18), .b(new_n105_), .O(new_n106_));
  nor2   g54(.a(x20), .b(new_n55_), .O(new_n107_));
  oai21  g55(.a(new_n107_), .b(new_n106_), .c(new_n58_), .O(new_n108_));
  inv1   g56(.a(x27), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n57_), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n108_), .O(z07));
  inv1   g59(.a(x11), .O(new_n112_));
  nor2   g60(.a(x18), .b(new_n112_), .O(new_n113_));
  nor2   g61(.a(x29), .b(new_n55_), .O(new_n114_));
  oai21  g62(.a(new_n114_), .b(new_n113_), .c(new_n58_), .O(new_n115_));
  inv1   g63(.a(x28), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n57_), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n115_), .O(z08));
  inv1   g66(.a(x10), .O(new_n119_));
  nor2   g67(.a(x18), .b(new_n119_), .O(new_n120_));
  nor2   g68(.a(x30), .b(new_n55_), .O(new_n121_));
  oai21  g69(.a(new_n121_), .b(new_n120_), .c(new_n58_), .O(new_n122_));
  inv1   g70(.a(x29), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n57_), .O(new_n124_));
  nand2  g72(.a(new_n124_), .b(new_n122_), .O(z09));
  inv1   g73(.a(x15), .O(new_n128_));
  nor2   g74(.a(x18), .b(new_n128_), .O(new_n129_));
  nor2   g75(.a(x33), .b(new_n55_), .O(new_n130_));
  oai21  g76(.a(new_n130_), .b(new_n129_), .c(new_n58_), .O(new_n131_));
  inv1   g77(.a(x32), .O(new_n132_));
  nand2  g78(.a(new_n132_), .b(new_n57_), .O(new_n133_));
  nand2  g79(.a(new_n133_), .b(new_n131_), .O(z12));
