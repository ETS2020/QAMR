// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:54 2020
...
module FAU ( 
  ...
  nor2   g075(.a(x24), .b(new_n55_), .O(new_n129_));
  oai21  g076(.a(new_n129_), .b(new_n128_), .c(new_n58_), .O(new_n130_));
  inv1   g077(.a(x31), .O(new_n131_));
  nand2  g078(.a(new_n131_), .b(new_n57_), .O(new_n132_));
  nand2  g079(.a(new_n132_), .b(new_n130_), .O(z11));
  inv1   g080(.a(x15), .O(new_n134_));
  nor2   g081(.a(x18), .b(new_n134_), .O(new_n135_));
  nor2   g082(.a(x33), .b(new_n55_), .O(new_n136_));
  oai21  g083(.a(new_n136_), .b(new_n135_), .c(new_n58_), .O(new_n137_));
  inv1   g084(.a(x32), .O(new_n138_));
  nand2  g085(.a(new_n138_), .b(new_n57_), .O(new_n139_));
  ...
  nor2   g096(.a(x35), .b(new_n55_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n149_), .c(new_n58_), .O(new_n151_));
  inv1   g098(.a(x34), .O(new_n152_));
  nand2  g099(.a(new_n152_), .b(new_n57_), .O(new_n153_));
  nand2  g100(.a(new_n153_), .b(new_n151_), .O(z14));
  inv1   g101(.a(x12), .O(new_n155_));
  nor2   g102(.a(x18), .b(new_n155_), .O(new_n156_));
  nor2   g103(.a(x28), .b(new_n55_), .O(new_n157_));
  oai21  g104(.a(new_n157_), .b(new_n156_), .c(new_n58_), .O(new_n158_));
  inv1   g105(.a(x35), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n57_), .O(new_n160_));
