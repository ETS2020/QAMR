// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:20 2020
...
module FAU ( 
  ...
  nor2   g68(.a(x35), .b(new_n56_), .O(new_n126_));
  oai21  g69(.a(new_n126_), .b(new_n125_), .c(new_n59_), .O(new_n127_));
  inv1   g70(.a(x34), .O(new_n128_));
  nand2  g71(.a(new_n128_), .b(new_n58_), .O(new_n129_));
  nand2  g72(.a(new_n129_), .b(new_n127_), .O(z14));
  inv1   g73(.a(x12), .O(new_n131_));
  nor2   g74(.a(x18), .b(new_n131_), .O(new_n132_));
  nor2   g75(.a(x28), .b(new_n56_), .O(new_n133_));
  oai21  g76(.a(new_n133_), .b(new_n132_), .c(new_n59_), .O(new_n134_));
  inv1   g77(.a(x35), .O(new_n135_));
  nand2  g78(.a(new_n135_), .b(new_n58_), .O(new_n136_));
