...
module FAU ( 
  ...
  inv1   g10(.a(x04), .O(new_n69_));
  nor2   g11(.a(x18), .b(new_n69_), .O(new_n70_));
  nor2   g12(.a(x20), .b(new_n56_), .O(new_n71_));
  oai21  g13(.a(new_n71_), .b(new_n70_), .c(new_n59_), .O(new_n72_));
  inv1   g14(.a(x27), .O(new_n73_));
  nand2  g15(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  nand2  g16(.a(new_n74_), .b(new_n72_), .O(z07));
