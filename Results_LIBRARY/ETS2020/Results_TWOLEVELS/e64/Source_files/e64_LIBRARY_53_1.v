...
module FAU ( 
  ...
  nor4   g106(.a(new_n239_), .b(new_n213_), .c(x15), .d(new_n237_), .O(z06));
  ...
  nand3  g314(.a(new_n224_), .b(new_n313_), .c(x31), .O(new_n466_));
  nor3   g315(.a(new_n466_), .b(new_n239_), .c(new_n223_), .O(new_n467_));
  nand3  g316(.a(new_n228_), .b(new_n321_), .c(new_n219_), .O(new_n468_));
  nor2   g317(.a(new_n468_), .b(new_n440_), .O(new_n469_));
  nand3  g318(.a(new_n469_), .b(new_n467_), .c(new_n445_), .O(new_n470_));
  nor2   g319(.a(new_n470_), .b(new_n428_), .O(z48));
  nand4  g320(.a(new_n444_), .b(new_n442_), .c(new_n197_), .d(x53), .O(new_n472_));
  nor2   g321(.a(new_n472_), .b(new_n425_), .O(z49));
  nand3  g322(.a(new_n327_), .b(new_n325_), .c(new_n146_), .O(new_n474_));
  nand3  g323(.a(new_n329_), .b(new_n354_), .c(x57), .O(new_n475_));
  nor2   g324(.a(new_n475_), .b(new_n474_), .O(z50));
  nor3   g325(.a(new_n440_), .b(x49), .c(new_n189_), .O(new_n477_));
  nand2  g326(.a(new_n477_), .b(new_n445_), .O(new_n478_));
  nor2   g327(.a(new_n478_), .b(new_n436_), .O(z51));
  nand2  g328(.a(new_n205_), .b(x63), .O(new_n481_));
  nor2   g329(.a(new_n481_), .b(new_n332_), .O(z53));
  nand2  g330(.a(new_n199_), .b(x55), .O(new_n483_));
  nor3   g331(.a(new_n483_), .b(new_n400_), .c(new_n285_), .O(z54));
  ...
  inv1   g338(.a(new_n348_), .O(new_n497_));
  nor2   g339(.a(new_n303_), .b(new_n298_), .O(new_n498_));
  nor3   g340(.a(new_n492_), .b(x50), .c(new_n188_), .O(new_n499_));
  nand4  g341(.a(new_n499_), .b(new_n498_), .c(new_n497_), .d(new_n300_), .O(new_n500_));
  inv1   g342(.a(new_n500_), .O(z62));
  nand4  g343(.a(new_n491_), .b(new_n354_), .c(x56), .d(new_n166_), .O(new_n502_));
  inv1   g344(.a(new_n502_), .O(new_n503_));
  nand4  g345(.a(new_n503_), .b(new_n498_), .c(new_n497_), .d(new_n300_), .O(new_n504_));
  inv1   g346(.a(new_n504_), .O(z63));
  nand4  g347(.a(new_n350_), .b(new_n497_), .c(new_n316_), .d(x30), .O(new_n506_));
  nor3   g348(.a(new_n506_), .b(new_n303_), .c(new_n298_), .O(z64));
  zero   g349(.O(z00));
  zero   g350(.O(z01));
  zero   g351(.O(z04));
  zero   g352(.O(z07));
