// Benchmark "FAU" written by ABC on Tue Jun 23 00:07:22 2020
...
module FAU ( 
  ...
  oai21  g115(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n150_));
  aoi21  g116(.a(new_n150_), .b(new_n48_), .c(x03), .O(new_n151_));
  inv1   g117(.a(x03), .O(new_n152_));
  oai21  g118(.a(x20), .b(new_n77_), .c(x06), .O(new_n153_));
  aoi21  g119(.a(new_n153_), .b(x11), .c(new_n152_), .O(new_n154_));
  oai22  g120(.a(new_n154_), .b(new_n122_), .c(new_n151_), .d(new_n46_), .O(z6));
  inv1   g121(.a(new_n122_), .O(z7));
  zero   g122(.O(z5));
endmodule
