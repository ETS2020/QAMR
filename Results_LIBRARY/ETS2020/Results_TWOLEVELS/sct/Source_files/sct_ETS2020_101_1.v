...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n43_,
    new_n44_, new_n46_, new_n47_, new_n50_, new_n51_, new_n52_, new_n53_,
  ...
  and2   g20(.a(x07), .b(x06), .O(new_n56_));
  ...
  nand2  g45(.a(x16), .b(new_n35_), .O(new_n83_));
  aoi21  g46(.a(new_n83_), .b(new_n52_), .c(new_n40_), .O(z12));
