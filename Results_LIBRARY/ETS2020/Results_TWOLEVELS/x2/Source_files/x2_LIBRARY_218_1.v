// Benchmark "FAU" written by ABC on Mon Jun 22 23:58:03 2020
...
module FAU ( 
  ...
  oai21  g15(.a(x9), .b(new_n22_), .c(new_n20_), .O(new_n33_));
  ...
  nand3  g24(.a(new_n41_), .b(new_n31_), .c(x2), .O(new_n42_));
