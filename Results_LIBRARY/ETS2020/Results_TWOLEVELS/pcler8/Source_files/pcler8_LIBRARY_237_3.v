// Benchmark "FAU" written by ABC on Tue Jun 23 02:06:03 2020
...
module FAU ( 
  ...
  nand2  g34(.a(x08), .b(x02), .O(new_n82_));
  oai21  g35(.a(new_n81_), .b(new_n65_), .c(new_n82_), .O(z11));
  nand2  g36(.a(x23), .b(x14), .O(new_n84_));
  nand3  g37(.a(x21), .b(x20), .c(x19), .O(new_n85_));
  inv1   g38(.a(new_n85_), .O(new_n86_));
  oai21  g39(.a(new_n84_), .b(new_n75_), .c(new_n86_), .O(new_n87_));
  ...
  oai21  g44(.a(new_n91_), .b(new_n65_), .c(new_n52_), .O(z12));
  ...
  nand3  g50(.a(new_n93_), .b(x22), .c(x21), .O(new_n98_));
  nor2   g51(.a(new_n98_), .b(new_n77_), .O(new_n99_));
  oai21  g52(.a(new_n99_), .b(new_n97_), .c(new_n66_), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n54_), .O(z13));
  nand3  g54(.a(x26), .b(x25), .c(x16), .O(new_n102_));
  nand4  g55(.a(new_n102_), .b(new_n86_), .c(x23), .d(x22), .O(new_n103_));
  nand2  g56(.a(x23), .b(x22), .O(new_n104_));
  nor3   g57(.a(new_n85_), .b(new_n104_), .c(x24), .O(new_n105_));
  ...
  nand3  g63(.a(new_n110_), .b(new_n108_), .c(new_n86_), .O(new_n111_));
  inv1   g64(.a(x25), .O(new_n112_));
  nand4  g65(.a(new_n112_), .b(x24), .c(x23), .d(x22), .O(new_n113_));
  inv1   g66(.a(new_n113_), .O(new_n114_));
  aoi22  g67(.a(new_n114_), .b(new_n86_), .c(new_n111_), .d(x25), .O(new_n115_));
