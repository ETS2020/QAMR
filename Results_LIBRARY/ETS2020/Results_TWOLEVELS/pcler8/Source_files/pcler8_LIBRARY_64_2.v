...
module FAU ( 
  ...
  nand4  g35(.a(x24), .b(x23), .c(x22), .d(x13), .O(new_n83_));
  nand2  g36(.a(x20), .b(x19), .O(new_n84_));
  inv1   g37(.a(new_n84_), .O(new_n85_));
  oai21  g38(.a(new_n83_), .b(new_n82_), .c(new_n85_), .O(new_n86_));
  nor2   g39(.a(new_n84_), .b(x21), .O(new_n87_));
  aoi21  g40(.a(new_n86_), .b(x21), .c(new_n87_), .O(new_n88_));
  nand2  g41(.a(x08), .b(x02), .O(new_n89_));
  oai21  g42(.a(new_n88_), .b(new_n75_), .c(new_n89_), .O(z11));
