...
module FAU ( 
  ...
  nand2  g30(.a(x08), .b(x00), .O(new_n77_));
  oai21  g31(.a(new_n76_), .b(new_n74_), .c(new_n77_), .O(z09));
  nand3  g32(.a(x22), .b(x21), .c(x12), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n71_), .c(x19), .O(new_n80_));
  nor2   g34(.a(x20), .b(new_n52_), .O(new_n81_));
  aoi21  g35(.a(new_n80_), .b(x20), .c(new_n81_), .O(new_n82_));
  oai22  g36(.a(new_n82_), .b(new_n76_), .c(new_n58_), .d(new_n57_), .O(z10));
