...
module FAU ( 
  ...
  nand3  g63(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand3  g64(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(x23), .d(x22), .O(new_n112_));
  nand2  g67(.a(x23), .b(x22), .O(new_n113_));
  nor3   g68(.a(new_n110_), .b(new_n113_), .c(x24), .O(new_n114_));
  aoi21  g69(.a(new_n112_), .b(x24), .c(new_n114_), .O(new_n115_));
  nand2  g70(.a(x08), .b(x05), .O(new_n116_));
  oai21  g71(.a(new_n115_), .b(new_n77_), .c(new_n116_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n118_));
  nand3  g73(.a(x24), .b(x23), .c(x22), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n111_), .O(new_n121_));
  inv1   g76(.a(x25), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi22  g79(.a(new_n124_), .b(new_n111_), .c(new_n121_), .d(x25), .O(new_n125_));
