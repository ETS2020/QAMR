...
module FAU ( 
  ...
  oai21  g55(.a(new_n99_), .b(new_n77_), .c(new_n63_), .O(z12));
  ...
  oai21  g63(.a(new_n107_), .b(new_n77_), .c(new_n65_), .O(z13));
  ...
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(new_n115_));
  inv1   g70(.a(x25), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(x24), .c(x23), .d(x22), .O(new_n117_));
  inv1   g72(.a(new_n117_), .O(new_n118_));
  aoi22  g73(.a(new_n118_), .b(new_n111_), .c(new_n115_), .d(x25), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n77_), .c(new_n68_), .O(z15));
  nor2   g75(.a(new_n52_), .b(x18), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n49_), .c(new_n45_), .O(new_n122_));
  inv1   g77(.a(x26), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(x25), .c(x22), .d(x21), .O(new_n124_));
  nand4  g79(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  aoi21  g81(.a(new_n122_), .b(x26), .c(new_n126_), .O(new_n127_));
  oai21  g82(.a(new_n127_), .b(new_n77_), .c(new_n70_), .O(z16));
  zero   g83(.O(z14));
endmodule
