...
module FAU ( 
  ...
  nand4  g28(.a(x19), .b(new_n49_), .c(x17), .d(new_n73_), .O(new_n74_));
  inv1   g29(.a(x05), .O(new_n75_));
  nor2   g30(.a(x07), .b(x06), .O(new_n76_));
  nand3  g31(.a(new_n76_), .b(new_n75_), .c(x04), .O(new_n77_));
  inv1   g32(.a(x03), .O(new_n78_));
  nand3  g33(.a(new_n46_), .b(new_n78_), .c(x02), .O(new_n79_));
  nor3   g34(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(z08));
  ...
  nand2  g39(.a(x02), .b(new_n63_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  inv1   g41(.a(x13), .O(new_n87_));
  inv1   g42(.a(x14), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n70_), .O(new_n89_));
  ...
  nor2   g52(.a(x20), .b(new_n63_), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n58_), .c(x22), .d(x21), .O(new_n99_));
  nand3  g54(.a(new_n87_), .b(x12), .c(new_n70_), .O(new_n100_));
  ...
  nand2  g65(.a(new_n95_), .b(new_n62_), .O(new_n111_));
