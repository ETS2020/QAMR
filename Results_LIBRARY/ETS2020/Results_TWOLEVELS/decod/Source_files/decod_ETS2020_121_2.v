...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n45_, new_n46_, new_n47_;
  ...
  inv1   g17(.a(x0), .O(new_n45_));
  nand2  g18(.a(new_n32_), .b(new_n45_), .O(new_n46_));
  nand3  g19(.a(x4), .b(x3), .c(new_n28_), .O(new_n47_));
  nor2   g20(.a(new_n47_), .b(new_n46_), .O(z14));
  zero   g21(.O(z08));
  zero   g22(.O(z09));
  zero   g23(.O(z10));
  zero   g24(.O(z11));
