// Benchmark "FAU" written by ABC on Tue Jun 23 00:19:12 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n43_, new_n46_, new_n50_,
    new_n51_;
  ...
  nand3  g28(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n51_));
  nor2   g29(.a(new_n51_), .b(new_n50_), .O(z15));
  zero   g30(.O(z14));
endmodule
