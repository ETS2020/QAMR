...
module FAU ( 
  ...
  oai21  g094(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n161_));
  nand2  g095(.a(new_n161_), .b(x08), .O(new_n162_));
  nand3  g096(.a(new_n162_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g097(.a(new_n86_), .b(new_n72_), .c(new_n119_), .O(new_n164_));
  oai21  g098(.a(new_n74_), .b(x27), .c(x35), .O(new_n165_));
  nand2  g099(.a(new_n165_), .b(new_n116_), .O(new_n166_));
  aoi21  g100(.a(new_n166_), .b(new_n164_), .c(new_n123_), .O(z20));
  zero   g101(.O(z05));
  zero   g102(.O(z06));
  zero   g103(.O(z09));
  zero   g104(.O(z17));
  aoi21  g105(.a(new_n121_), .b(new_n118_), .c(new_n123_), .O(z19));
endmodule
