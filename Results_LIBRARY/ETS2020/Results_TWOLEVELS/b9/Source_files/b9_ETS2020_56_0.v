// Benchmark "FAU" written by ABC on Fri Jun 26 04:15:32 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n153_, new_n155_, new_n157_, new_n160_, new_n161_, new_n163_,
    new_n164_, new_n165_;
  ...
  inv1   g028(.a(x03), .O(new_n94_));
  inv1   g029(.a(x00), .O(new_n95_));
  oai21  g030(.a(x25), .b(new_n95_), .c(x38), .O(new_n96_));
  inv1   g031(.a(x15), .O(new_n97_));
  nand2  g032(.a(x17), .b(new_n97_), .O(new_n98_));
  nor2   g033(.a(x33), .b(x31), .O(new_n99_));
  nand3  g034(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(new_n100_));
  inv1   g035(.a(x14), .O(new_n101_));
  inv1   g036(.a(x25), .O(new_n102_));
  nand3  g037(.a(x38), .b(new_n102_), .c(new_n95_), .O(new_n103_));
  nand2  g038(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  aoi21  g039(.a(new_n104_), .b(new_n100_), .c(new_n94_), .O(z07));
  inv1   g040(.a(new_n82_), .O(z08));
  inv1   g041(.a(x05), .O(new_n108_));
  nand2  g042(.a(new_n82_), .b(x07), .O(new_n109_));
  oai21  g043(.a(new_n82_), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nor3   g044(.a(new_n77_), .b(new_n82_), .c(new_n108_), .O(new_n111_));
  aoi21  g045(.a(new_n110_), .b(new_n76_), .c(new_n111_), .O(new_n112_));
  nand3  g046(.a(x37), .b(x27), .c(x06), .O(new_n113_));
  oai21  g047(.a(new_n112_), .b(x04), .c(new_n113_), .O(z10));
  nand2  g048(.a(z08), .b(x29), .O(new_n115_));
  nor2   g049(.a(new_n72_), .b(new_n64_), .O(new_n116_));
  ...
  aoi21  g057(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n124_));
  inv1   g058(.a(new_n66_), .O(new_n125_));
  nand2  g059(.a(new_n125_), .b(x27), .O(new_n126_));
  oai21  g060(.a(new_n82_), .b(x04), .c(new_n126_), .O(new_n127_));
  ...
  nor2   g074(.a(x13), .b(x04), .O(new_n141_));
  nand3  g075(.a(new_n141_), .b(new_n78_), .c(z08), .O(new_n142_));
  nand2  g076(.a(new_n142_), .b(new_n140_), .O(z13));
  inv1   g077(.a(x30), .O(new_n144_));
  inv1   g078(.a(x32), .O(new_n145_));
  nand4  g079(.a(new_n129_), .b(new_n145_), .c(new_n144_), .d(x28), .O(new_n146_));
  inv1   g080(.a(new_n146_), .O(new_n147_));
  nand2  g081(.a(new_n141_), .b(z08), .O(new_n148_));
  oai21  g082(.a(new_n148_), .b(new_n147_), .c(new_n136_), .O(new_n149_));
  nand3  g083(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n150_));
  nand2  g084(.a(new_n150_), .b(x27), .O(new_n151_));
  nand2  g085(.a(new_n151_), .b(new_n77_), .O(new_n152_));
  nand2  g086(.a(new_n148_), .b(new_n126_), .O(new_n153_));
  nand3  g087(.a(new_n153_), .b(new_n152_), .c(new_n149_), .O(z14));
  nand4  g088(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n155_));
  inv1   g089(.a(new_n155_), .O(z15));
  nand2  g090(.a(x22), .b(x01), .O(new_n157_));
  nor2   g091(.a(new_n157_), .b(x23), .O(z16));
  oai21  g092(.a(new_n75_), .b(x27), .c(new_n115_), .O(new_n160_));
  nand2  g093(.a(new_n160_), .b(x08), .O(new_n161_));
  nand3  g094(.a(new_n161_), .b(new_n121_), .c(new_n119_), .O(z18));
  oai21  g095(.a(new_n86_), .b(new_n72_), .c(new_n118_), .O(new_n163_));
  oai21  g096(.a(new_n74_), .b(x27), .c(x35), .O(new_n164_));
  nand2  g097(.a(new_n164_), .b(new_n115_), .O(new_n165_));
  aoi21  g098(.a(new_n165_), .b(new_n163_), .c(new_n122_), .O(z20));
  zero   g099(.O(z04));
  zero   g100(.O(z05));
  zero   g101(.O(z06));
  zero   g102(.O(z09));
  zero   g103(.O(z17));
  aoi21  g104(.a(new_n120_), .b(new_n117_), .c(new_n122_), .O(z19));
endmodule
