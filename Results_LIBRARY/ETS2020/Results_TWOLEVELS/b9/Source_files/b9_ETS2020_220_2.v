// Benchmark "FAU" written by ABC on Fri Jun 26 04:26:30 2020
...
module FAU ( 
  ...
  inv1   g67(.a(x39), .O(new_n130_));
  nor2   g68(.a(new_n130_), .b(x04), .O(new_n131_));
  oai21  g69(.a(new_n73_), .b(new_n86_), .c(x28), .O(new_n132_));
  nand4  g70(.a(new_n132_), .b(new_n131_), .c(x40), .d(new_n129_), .O(new_n133_));
  inv1   g71(.a(new_n66_), .O(new_n134_));
  ...
  nand4  g76(.a(new_n78_), .b(z08), .c(new_n129_), .d(new_n64_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n138_), .O(z13));
  nand2  g78(.a(x22), .b(x01), .O(new_n143_));
  nor2   g79(.a(new_n143_), .b(x23), .O(z16));
  inv1   g80(.a(x24), .O(new_n145_));
  nand4  g81(.a(new_n145_), .b(x23), .c(x22), .d(x01), .O(new_n146_));
  inv1   g82(.a(new_n146_), .O(z17));
  oai21  g83(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n148_));
  nand2  g84(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g85(.a(new_n149_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g86(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n151_));
  oai21  g87(.a(new_n74_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g88(.a(new_n152_), .b(new_n117_), .O(new_n153_));
  aoi21  g89(.a(new_n153_), .b(new_n151_), .c(new_n124_), .O(z20));
  zero   g90(.O(z14));
  zero   g91(.O(z15));
  aoi21  g92(.a(new_n122_), .b(new_n119_), .c(new_n124_), .O(z19));
endmodule
