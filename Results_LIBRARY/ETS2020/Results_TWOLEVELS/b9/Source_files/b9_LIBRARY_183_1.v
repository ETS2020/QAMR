...
module FAU ( 
  ...
  nand4  g24(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n97_));
  inv1   g25(.a(new_n97_), .O(z15));
  inv1   g26(.a(x24), .O(new_n100_));
  nand4  g27(.a(new_n100_), .b(x23), .c(x22), .d(x01), .O(new_n101_));
  inv1   g28(.a(new_n101_), .O(z17));
  zero   g29(.O(z01));
  zero   g30(.O(z02));
  zero   g31(.O(z03));
  zero   g32(.O(z04));
