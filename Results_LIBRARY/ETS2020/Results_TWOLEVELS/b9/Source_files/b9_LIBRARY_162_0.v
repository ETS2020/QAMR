...
module FAU ( 
  ...
  inv1   g093(.a(x24), .O(new_n160_));
  nand4  g094(.a(new_n160_), .b(x23), .c(x22), .d(x01), .O(new_n161_));
  inv1   g095(.a(new_n161_), .O(z17));
  oai21  g096(.a(new_n75_), .b(x27), .c(new_n115_), .O(new_n163_));
  nand2  g097(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g098(.a(new_n164_), .b(new_n121_), .c(new_n119_), .O(z18));
  oai21  g099(.a(new_n81_), .b(new_n83_), .c(new_n118_), .O(new_n166_));
  oai21  g100(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g101(.a(new_n167_), .b(new_n115_), .O(new_n168_));
  aoi21  g102(.a(new_n168_), .b(new_n166_), .c(new_n122_), .O(z20));
  zero   g103(.O(z01));
  zero   g104(.O(z05));
  zero   g105(.O(z06));
  zero   g106(.O(z09));
