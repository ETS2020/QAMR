...
module FAU ( 
  ...
  oai21  g84(.a(new_n67_), .b(x27), .c(new_n109_), .O(new_n150_));
  nand2  g85(.a(new_n150_), .b(x08), .O(new_n151_));
  nand3  g86(.a(new_n151_), .b(new_n116_), .c(new_n114_), .O(z18));
  oai21  g87(.a(new_n78_), .b(new_n64_), .c(new_n113_), .O(new_n153_));
  oai21  g88(.a(new_n66_), .b(x27), .c(x35), .O(new_n154_));
  nand2  g89(.a(new_n154_), .b(new_n109_), .O(new_n155_));
  aoi21  g90(.a(new_n155_), .b(new_n153_), .c(new_n117_), .O(z20));
  zero   g91(.O(z00));
  zero   g92(.O(z15));
  zero   g93(.O(z16));
  aoi21  g94(.a(new_n115_), .b(new_n112_), .c(new_n117_), .O(z19));
endmodule
