...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n93_, new_n94_,
    new_n95_, new_n96_, new_n97_, new_n98_, new_n99_, new_n100_, new_n101_,
    new_n106_, new_n108_, new_n110_, new_n111_;
  ...
  and2   g24(.a(x27), .b(x04), .O(new_n94_));
  inv1   g25(.a(x28), .O(new_n95_));
  nand2  g26(.a(x35), .b(new_n95_), .O(new_n96_));
  oai21  g27(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(new_n97_));
  inv1   g28(.a(x08), .O(new_n98_));
  nand2  g29(.a(x27), .b(new_n64_), .O(new_n99_));
  oai21  g30(.a(new_n99_), .b(new_n96_), .c(new_n98_), .O(new_n100_));
  or2    g31(.a(x30), .b(x09), .O(new_n101_));
  aoi21  g32(.a(new_n100_), .b(new_n97_), .c(new_n101_), .O(z11));
  nand4  g33(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n106_));
  inv1   g34(.a(new_n106_), .O(z15));
  nand2  g35(.a(x22), .b(x01), .O(new_n108_));
  nor2   g36(.a(new_n108_), .b(x23), .O(z16));
  inv1   g37(.a(x24), .O(new_n110_));
  nand4  g38(.a(new_n110_), .b(x23), .c(x22), .d(x01), .O(new_n111_));
  inv1   g39(.a(new_n111_), .O(z17));
  zero   g40(.O(z01));
  zero   g41(.O(z02));
  zero   g42(.O(z03));
  zero   g43(.O(z04));
