// Benchmark "FAU" written by ABC on Fri Jun 26 04:13:07 2020
...
module FAU ( 
  ...
  nand2  g69(.a(x22), .b(x01), .O(new_n135_));
  nor2   g70(.a(new_n135_), .b(x23), .O(z16));
  inv1   g71(.a(x24), .O(new_n137_));
  nand4  g72(.a(new_n137_), .b(x23), .c(x22), .d(x01), .O(new_n138_));
  inv1   g73(.a(new_n138_), .O(z17));
  oai21  g74(.a(new_n67_), .b(x27), .c(new_n98_), .O(new_n140_));
  nand2  g75(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g76(.a(new_n141_), .b(new_n105_), .c(new_n103_), .O(z18));
  oai21  g77(.a(new_n78_), .b(new_n64_), .c(new_n102_), .O(new_n143_));
  oai21  g78(.a(new_n66_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g79(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  aoi21  g80(.a(new_n145_), .b(new_n143_), .c(new_n106_), .O(z20));
  zero   g81(.O(z00));
  zero   g82(.O(z07));
  zero   g83(.O(z15));
  aoi21  g84(.a(new_n104_), .b(new_n101_), .c(new_n106_), .O(z19));
endmodule
