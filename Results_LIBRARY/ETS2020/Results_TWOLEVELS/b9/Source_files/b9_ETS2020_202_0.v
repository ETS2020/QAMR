...
module FAU ( 
  ...
  inv1   g094(.a(x24), .O(new_n161_));
  nand4  g095(.a(new_n161_), .b(x23), .c(x22), .d(x01), .O(new_n162_));
  inv1   g096(.a(new_n162_), .O(z17));
  oai21  g097(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n164_));
  nand2  g098(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g099(.a(new_n165_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g100(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n167_));
  oai21  g101(.a(new_n74_), .b(x27), .c(x35), .O(new_n168_));
  nand2  g102(.a(new_n168_), .b(new_n117_), .O(new_n169_));
  aoi21  g103(.a(new_n169_), .b(new_n167_), .c(new_n124_), .O(z20));
  zero   g104(.O(z05));
  zero   g105(.O(z06));
  zero   g106(.O(z08));
  zero   g107(.O(z09));
