// Benchmark "FAU" written by ABC on Fri Jun 26 04:26:59 2020
...
module FAU ( 
  ...
  oai21  g066(.a(new_n82_), .b(x04), .c(new_n128_), .O(new_n129_));
  ...
  nor2   g071(.a(new_n133_), .b(x13), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(new_n132_), .c(x39), .d(new_n64_), .O(new_n135_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n127_), .O(new_n140_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n147_), .c(new_n146_), .d(x28), .O(new_n148_));
  ...
  nand2  g092(.a(new_n150_), .b(new_n128_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .O(z14));
  nand2  g094(.a(x22), .b(x01), .O(new_n158_));
  nor2   g095(.a(new_n158_), .b(x23), .O(z16));
  inv1   g096(.a(x24), .O(new_n160_));
  nand4  g097(.a(new_n160_), .b(x23), .c(x22), .d(x01), .O(new_n161_));
  inv1   g098(.a(new_n161_), .O(z17));
  oai21  g099(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n163_));
  nand2  g100(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g101(.a(new_n164_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g102(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n166_));
  oai21  g103(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g104(.a(new_n167_), .b(new_n117_), .O(new_n168_));
  aoi21  g105(.a(new_n168_), .b(new_n166_), .c(new_n124_), .O(z20));
  zero   g106(.O(z15));
