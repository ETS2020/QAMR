// Benchmark "FAU" written by ABC on Fri Jun 26 04:25:42 2020
...
module FAU ( 
  ...
  oai21  g77(.a(new_n78_), .b(new_n64_), .c(new_n102_), .O(new_n144_));
  oai21  g78(.a(new_n66_), .b(x27), .c(x35), .O(new_n145_));
  nand2  g79(.a(new_n145_), .b(new_n98_), .O(new_n146_));
  aoi21  g80(.a(new_n146_), .b(new_n144_), .c(new_n106_), .O(z20));
  zero   g81(.O(z00));
  zero   g82(.O(z07));
  zero   g83(.O(z15));
  zero   g84(.O(z19));
