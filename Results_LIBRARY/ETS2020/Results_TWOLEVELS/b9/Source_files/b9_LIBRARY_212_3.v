// Benchmark "FAU" written by ABC on Fri Jun 26 04:25:49 2020
...
module FAU ( 
  ...
  nand4  g81(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n145_));
  inv1   g82(.a(new_n145_), .O(z15));
  nand2  g83(.a(x22), .b(x01), .O(new_n147_));
  nor2   g84(.a(new_n147_), .b(x23), .O(z16));
  inv1   g85(.a(x24), .O(new_n149_));
  nand4  g86(.a(new_n149_), .b(x23), .c(x22), .d(x01), .O(new_n150_));
  inv1   g87(.a(new_n150_), .O(z17));
  oai21  g88(.a(new_n67_), .b(x27), .c(new_n109_), .O(new_n152_));
  nand2  g89(.a(new_n152_), .b(x08), .O(new_n153_));
  nand3  g90(.a(new_n153_), .b(new_n116_), .c(new_n114_), .O(z18));
  oai21  g91(.a(new_n78_), .b(new_n64_), .c(new_n113_), .O(new_n155_));
  oai21  g92(.a(new_n66_), .b(x27), .c(x35), .O(new_n156_));
  nand2  g93(.a(new_n156_), .b(new_n109_), .O(new_n157_));
  aoi21  g94(.a(new_n157_), .b(new_n155_), .c(new_n117_), .O(z20));
  zero   g95(.O(z00));
  aoi21  g96(.a(new_n115_), .b(new_n112_), .c(new_n117_), .O(z19));
endmodule
