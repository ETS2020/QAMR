// Benchmark "FAU" written by ABC on Fri Jun 26 04:24:46 2020
...
module FAU ( 
  ...
  inv1   g82(.a(x24), .O(new_n149_));
  nand4  g83(.a(new_n149_), .b(x23), .c(x22), .d(x01), .O(new_n150_));
  inv1   g84(.a(new_n150_), .O(z17));
  oai21  g85(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n152_));
  nand2  g86(.a(new_n152_), .b(x08), .O(new_n153_));
  nand3  g87(.a(new_n153_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g88(.a(new_n86_), .b(new_n72_), .c(new_n108_), .O(new_n155_));
  oai21  g89(.a(new_n74_), .b(x27), .c(x35), .O(new_n156_));
  nand2  g90(.a(new_n156_), .b(new_n105_), .O(new_n157_));
  aoi21  g91(.a(new_n157_), .b(new_n155_), .c(new_n112_), .O(z20));
  zero   g92(.O(z05));
  zero   g93(.O(z06));
  zero   g94(.O(z07));
  zero   g95(.O(z09));
  aoi21  g96(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
