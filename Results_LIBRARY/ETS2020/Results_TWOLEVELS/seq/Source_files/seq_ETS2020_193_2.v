// Benchmark "FAU" written by ABC on Thu Jun 25 01:36:33 2020
...
module FAU ( 
  ...
  nor2   g376(.a(new_n247_), .b(new_n243_), .O(z15));
  nand3  g377(.a(new_n103_), .b(x04), .c(x00), .O(new_n468_));
  nand3  g378(.a(new_n197_), .b(x37), .c(new_n101_), .O(new_n469_));
  oai21  g379(.a(new_n468_), .b(new_n121_), .c(new_n469_), .O(new_n470_));
  inv1   g380(.a(new_n97_), .O(new_n471_));
  nor4   g381(.a(new_n471_), .b(x36), .c(new_n349_), .d(x03), .O(new_n472_));
  nand2  g382(.a(new_n241_), .b(x37), .O(new_n473_));
  nor2   g383(.a(new_n473_), .b(new_n198_), .O(new_n474_));
  aoi21  g384(.a(new_n472_), .b(new_n470_), .c(new_n474_), .O(new_n475_));
  nor2   g385(.a(x39), .b(x06), .O(new_n476_));
  nor3   g386(.a(new_n476_), .b(new_n103_), .c(new_n77_), .O(new_n477_));
  aoi21  g387(.a(new_n210_), .b(new_n77_), .c(new_n477_), .O(new_n478_));
  nand2  g388(.a(new_n206_), .b(x40), .O(new_n479_));
  oai22  g389(.a(new_n479_), .b(new_n478_), .c(new_n475_), .d(x35), .O(new_n480_));
  nand2  g390(.a(new_n480_), .b(new_n136_), .O(new_n481_));
  nand3  g391(.a(new_n350_), .b(x37), .c(new_n77_), .O(new_n482_));
  nand3  g392(.a(new_n206_), .b(new_n103_), .c(x36), .O(new_n483_));
  nand3  g393(.a(x40), .b(x39), .c(x06), .O(new_n484_));
  aoi21  g394(.a(new_n483_), .b(new_n482_), .c(new_n484_), .O(new_n485_));
  nand4  g395(.a(new_n203_), .b(new_n106_), .c(new_n97_), .d(x36), .O(new_n486_));
  nand3  g396(.a(new_n197_), .b(new_n103_), .c(new_n77_), .O(new_n487_));
  aoi21  g397(.a(new_n487_), .b(new_n486_), .c(new_n207_), .O(new_n488_));
  oai21  g398(.a(new_n488_), .b(new_n485_), .c(x38), .O(new_n489_));
  aoi21  g399(.a(new_n489_), .b(new_n481_), .c(new_n245_), .O(z19));
  nor2   g400(.a(new_n113_), .b(new_n110_), .O(new_n494_));
  nand2  g401(.a(new_n88_), .b(new_n103_), .O(new_n495_));
  nand2  g402(.a(new_n495_), .b(new_n90_), .O(new_n496_));
  nand2  g403(.a(new_n496_), .b(x40), .O(new_n497_));
  nand2  g404(.a(new_n497_), .b(new_n100_), .O(new_n498_));
  oai21  g405(.a(new_n498_), .b(new_n494_), .c(x34), .O(new_n499_));
  nand2  g406(.a(new_n127_), .b(new_n120_), .O(new_n500_));
  nand2  g407(.a(new_n292_), .b(new_n123_), .O(new_n501_));
  aoi21  g408(.a(new_n501_), .b(new_n500_), .c(new_n83_), .O(new_n502_));
  nor2   g409(.a(new_n162_), .b(new_n92_), .O(new_n503_));
  oai21  g410(.a(new_n503_), .b(new_n502_), .c(new_n116_), .O(new_n504_));
  nand3  g411(.a(new_n268_), .b(new_n136_), .c(x13), .O(new_n505_));
  nand2  g412(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  oai21  g413(.a(new_n506_), .b(new_n140_), .c(new_n168_), .O(new_n507_));
  aoi21  g414(.a(new_n507_), .b(new_n499_), .c(x07), .O(new_n508_));
  inv1   g415(.a(new_n307_), .O(new_n509_));
  nand2  g416(.a(new_n88_), .b(new_n349_), .O(new_n510_));
  aoi21  g417(.a(new_n510_), .b(new_n288_), .c(x37), .O(new_n511_));
  oai21  g418(.a(new_n511_), .b(new_n509_), .c(new_n85_), .O(new_n512_));
  inv1   g419(.a(new_n264_), .O(new_n513_));
  nand2  g420(.a(new_n513_), .b(x15), .O(new_n514_));
  aoi21  g421(.a(new_n514_), .b(new_n327_), .c(x37), .O(new_n515_));
  nor2   g422(.a(new_n94_), .b(new_n327_), .O(new_n516_));
  oai21  g423(.a(new_n516_), .b(new_n515_), .c(new_n349_), .O(new_n517_));
  nand2  g424(.a(new_n517_), .b(new_n512_), .O(new_n518_));
  nand2  g425(.a(new_n518_), .b(new_n171_), .O(new_n519_));
  aoi21  g426(.a(new_n78_), .b(new_n87_), .c(new_n153_), .O(new_n520_));
  nand4  g427(.a(new_n312_), .b(new_n121_), .c(new_n103_), .d(new_n101_), .O(new_n521_));
  aoi21  g428(.a(new_n521_), .b(x40), .c(new_n136_), .O(new_n522_));
  oai21  g429(.a(new_n522_), .b(new_n520_), .c(x34), .O(new_n523_));
  nand2  g430(.a(new_n523_), .b(new_n519_), .O(new_n524_));
  oai21  g431(.a(new_n524_), .b(new_n508_), .c(new_n205_), .O(new_n525_));
  nand2  g432(.a(new_n243_), .b(x00), .O(new_n526_));
  aoi21  g433(.a(new_n526_), .b(x39), .c(new_n117_), .O(new_n527_));
  oai21  g434(.a(new_n527_), .b(new_n88_), .c(x35), .O(new_n528_));
  aoi21  g435(.a(new_n528_), .b(new_n102_), .c(new_n103_), .O(new_n529_));
  oai21  g436(.a(new_n92_), .b(x37), .c(new_n102_), .O(new_n530_));
  oai21  g437(.a(new_n235_), .b(new_n205_), .c(new_n90_), .O(new_n531_));
  aoi21  g438(.a(new_n530_), .b(new_n309_), .c(new_n531_), .O(new_n532_));
  oai22  g439(.a(new_n532_), .b(new_n78_), .c(new_n303_), .d(new_n92_), .O(new_n533_));
  oai21  g440(.a(new_n533_), .b(new_n529_), .c(new_n349_), .O(new_n534_));
  aoi21  g441(.a(new_n534_), .b(new_n525_), .c(x36), .O(new_n535_));
  inv1   g442(.a(new_n291_), .O(new_n536_));
  nand2  g443(.a(new_n112_), .b(x38), .O(new_n537_));
  oai21  g444(.a(new_n537_), .b(new_n215_), .c(new_n390_), .O(new_n538_));
  nor2   g445(.a(new_n103_), .b(x07), .O(new_n539_));
  aoi22  g446(.a(new_n539_), .b(new_n538_), .c(new_n536_), .d(new_n210_), .O(new_n540_));
  aoi21  g447(.a(x38), .b(new_n111_), .c(new_n78_), .O(new_n541_));
  inv1   g448(.a(new_n228_), .O(new_n542_));
  nand3  g449(.a(new_n235_), .b(new_n542_), .c(new_n117_), .O(new_n543_));
  oai21  g450(.a(new_n543_), .b(new_n541_), .c(new_n205_), .O(new_n544_));
  oai21  g451(.a(new_n540_), .b(new_n205_), .c(new_n544_), .O(new_n545_));
  nand2  g452(.a(new_n78_), .b(x38), .O(new_n546_));
  aoi22  g453(.a(new_n546_), .b(new_n103_), .c(new_n221_), .d(x00), .O(new_n547_));
  nand2  g454(.a(new_n87_), .b(x35), .O(new_n548_));
  nand2  g455(.a(x37), .b(new_n171_), .O(new_n549_));
  oai22  g456(.a(new_n549_), .b(new_n390_), .c(new_n548_), .d(new_n547_), .O(new_n550_));
  aoi21  g457(.a(new_n545_), .b(x36), .c(new_n550_), .O(new_n551_));
  nand3  g458(.a(new_n103_), .b(new_n77_), .c(new_n205_), .O(new_n552_));
  nand2  g459(.a(new_n392_), .b(x38), .O(new_n553_));
  nand2  g460(.a(new_n553_), .b(new_n552_), .O(new_n554_));
  nand2  g461(.a(new_n554_), .b(new_n111_), .O(new_n555_));
  nand2  g462(.a(new_n78_), .b(x36), .O(new_n556_));
  nand3  g463(.a(new_n556_), .b(new_n205_), .c(new_n349_), .O(new_n557_));
  nand2  g464(.a(new_n557_), .b(new_n555_), .O(new_n558_));
  nand2  g465(.a(new_n197_), .b(new_n109_), .O(new_n559_));
  nor3   g466(.a(new_n559_), .b(new_n351_), .c(new_n77_), .O(new_n560_));
  aoi21  g467(.a(new_n558_), .b(x05), .c(new_n560_), .O(new_n561_));
  oai21  g468(.a(new_n551_), .b(x34), .c(new_n561_), .O(new_n562_));
  oai21  g469(.a(new_n562_), .b(new_n535_), .c(new_n244_), .O(new_n563_));
  aoi21  g470(.a(new_n563_), .b(new_n243_), .c(new_n247_), .O(z23));
  nor3   g471(.a(new_n81_), .b(new_n341_), .c(new_n80_), .O(new_n570_));
  nand4  g472(.a(new_n570_), .b(new_n300_), .c(new_n269_), .d(new_n176_), .O(new_n571_));
  nand4  g473(.a(new_n334_), .b(new_n160_), .c(new_n152_), .d(x39), .O(new_n572_));
  aoi21  g474(.a(new_n572_), .b(new_n571_), .c(x40), .O(new_n573_));
  nor4   g475(.a(new_n450_), .b(new_n159_), .c(new_n90_), .d(new_n78_), .O(new_n574_));
  oai21  g476(.a(new_n574_), .b(new_n573_), .c(new_n349_), .O(new_n575_));
  nand2  g477(.a(new_n256_), .b(new_n176_), .O(new_n576_));
  inv1   g478(.a(new_n576_), .O(new_n577_));
  nand4  g479(.a(new_n577_), .b(new_n350_), .c(new_n271_), .d(new_n88_), .O(new_n578_));
  nand2  g480(.a(new_n578_), .b(new_n575_), .O(new_n579_));
  nand3  g481(.a(new_n579_), .b(new_n77_), .c(new_n171_), .O(new_n580_));
  nand4  g482(.a(new_n206_), .b(new_n152_), .c(new_n104_), .d(x36), .O(new_n581_));
  aoi21  g483(.a(new_n581_), .b(new_n580_), .c(new_n245_), .O(z29));
  zero   g484(.O(z02));
  zero   g485(.O(z04));
  zero   g486(.O(z05));
  zero   g487(.O(z06));
