// Benchmark "FAU" written by ABC on Thu Jun 25 01:38:58 2020
...
module FAU ( 
  ...
  wire new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    ...
    new_n455_, new_n456_, new_n457_, new_n463_, new_n464_, new_n465_,
    new_n466_, new_n467_, new_n468_, new_n469_, new_n470_, new_n476_,
    new_n477_, new_n478_, new_n479_, new_n480_, new_n481_, new_n482_,
    new_n483_, new_n484_, new_n485_, new_n486_, new_n487_, new_n488_,
    new_n489_, new_n490_, new_n491_, new_n492_, new_n493_, new_n494_,
    new_n495_, new_n496_, new_n497_, new_n502_, new_n503_, new_n504_,
  ...
  inv1   g376(.a(new_n412_), .O(new_n463_));
  nand2  g377(.a(new_n77_), .b(new_n243_), .O(new_n464_));
  aoi21  g378(.a(new_n463_), .b(new_n288_), .c(new_n464_), .O(new_n465_));
  nand3  g379(.a(new_n94_), .b(x36), .c(x13), .O(new_n466_));
  inv1   g380(.a(new_n466_), .O(new_n467_));
  nand3  g381(.a(new_n300_), .b(new_n349_), .c(new_n244_), .O(new_n468_));
  inv1   g382(.a(new_n468_), .O(new_n469_));
  oai21  g383(.a(new_n467_), .b(new_n465_), .c(new_n469_), .O(new_n470_));
  aoi21  g384(.a(new_n470_), .b(new_n243_), .c(new_n247_), .O(z14));
  nor2   g385(.a(new_n247_), .b(new_n243_), .O(z15));
  nand3  g386(.a(new_n103_), .b(x04), .c(x00), .O(new_n476_));
  nand3  g387(.a(new_n197_), .b(x37), .c(new_n101_), .O(new_n477_));
  oai21  g388(.a(new_n476_), .b(new_n121_), .c(new_n477_), .O(new_n478_));
  inv1   g389(.a(new_n97_), .O(new_n479_));
  nor4   g390(.a(new_n479_), .b(x36), .c(new_n349_), .d(x03), .O(new_n480_));
  nand2  g391(.a(new_n241_), .b(x37), .O(new_n481_));
  nor2   g392(.a(new_n481_), .b(new_n198_), .O(new_n482_));
  aoi21  g393(.a(new_n480_), .b(new_n478_), .c(new_n482_), .O(new_n483_));
  nor2   g394(.a(x39), .b(x06), .O(new_n484_));
  nor3   g395(.a(new_n484_), .b(new_n103_), .c(new_n77_), .O(new_n485_));
  aoi21  g396(.a(new_n210_), .b(new_n77_), .c(new_n485_), .O(new_n486_));
  nand2  g397(.a(new_n206_), .b(x40), .O(new_n487_));
  oai22  g398(.a(new_n487_), .b(new_n486_), .c(new_n483_), .d(x35), .O(new_n488_));
  nand2  g399(.a(new_n488_), .b(new_n136_), .O(new_n489_));
  nand3  g400(.a(new_n350_), .b(x37), .c(new_n77_), .O(new_n490_));
  nand3  g401(.a(new_n206_), .b(new_n103_), .c(x36), .O(new_n491_));
  nand3  g402(.a(x40), .b(x39), .c(x06), .O(new_n492_));
  aoi21  g403(.a(new_n491_), .b(new_n490_), .c(new_n492_), .O(new_n493_));
  nand4  g404(.a(new_n203_), .b(new_n106_), .c(new_n97_), .d(x36), .O(new_n494_));
  nand3  g405(.a(new_n197_), .b(new_n103_), .c(new_n77_), .O(new_n495_));
  aoi21  g406(.a(new_n495_), .b(new_n494_), .c(new_n207_), .O(new_n496_));
  oai21  g407(.a(new_n496_), .b(new_n493_), .c(x38), .O(new_n497_));
  aoi21  g408(.a(new_n497_), .b(new_n489_), .c(new_n245_), .O(z19));
  nor2   g409(.a(new_n113_), .b(new_n110_), .O(new_n502_));
  nand2  g410(.a(new_n88_), .b(new_n103_), .O(new_n503_));
  nand2  g411(.a(new_n503_), .b(new_n90_), .O(new_n504_));
  nand2  g412(.a(new_n504_), .b(x40), .O(new_n505_));
  nand2  g413(.a(new_n505_), .b(new_n100_), .O(new_n506_));
  oai21  g414(.a(new_n506_), .b(new_n502_), .c(x34), .O(new_n507_));
  nand2  g415(.a(new_n127_), .b(new_n120_), .O(new_n508_));
  nand2  g416(.a(new_n292_), .b(new_n123_), .O(new_n509_));
  aoi21  g417(.a(new_n509_), .b(new_n508_), .c(new_n83_), .O(new_n510_));
  nor2   g418(.a(new_n162_), .b(new_n92_), .O(new_n511_));
  oai21  g419(.a(new_n511_), .b(new_n510_), .c(new_n116_), .O(new_n512_));
  nand3  g420(.a(new_n268_), .b(new_n136_), .c(x13), .O(new_n513_));
  nand2  g421(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  oai21  g422(.a(new_n514_), .b(new_n140_), .c(new_n168_), .O(new_n515_));
  aoi21  g423(.a(new_n515_), .b(new_n507_), .c(x07), .O(new_n516_));
  inv1   g424(.a(new_n307_), .O(new_n517_));
  nand2  g425(.a(new_n88_), .b(new_n349_), .O(new_n518_));
  aoi21  g426(.a(new_n518_), .b(new_n288_), .c(x37), .O(new_n519_));
  oai21  g427(.a(new_n519_), .b(new_n517_), .c(new_n85_), .O(new_n520_));
  inv1   g428(.a(new_n264_), .O(new_n521_));
  nand2  g429(.a(new_n521_), .b(x15), .O(new_n522_));
  aoi21  g430(.a(new_n522_), .b(new_n327_), .c(x37), .O(new_n523_));
  nor2   g431(.a(new_n94_), .b(new_n327_), .O(new_n524_));
  oai21  g432(.a(new_n524_), .b(new_n523_), .c(new_n349_), .O(new_n525_));
  nand2  g433(.a(new_n525_), .b(new_n520_), .O(new_n526_));
  nand2  g434(.a(new_n526_), .b(new_n171_), .O(new_n527_));
  aoi21  g435(.a(new_n78_), .b(new_n87_), .c(new_n153_), .O(new_n528_));
  nand4  g436(.a(new_n312_), .b(new_n121_), .c(new_n103_), .d(new_n101_), .O(new_n529_));
  aoi21  g437(.a(new_n529_), .b(x40), .c(new_n136_), .O(new_n530_));
  oai21  g438(.a(new_n530_), .b(new_n528_), .c(x34), .O(new_n531_));
  nand2  g439(.a(new_n531_), .b(new_n527_), .O(new_n532_));
  oai21  g440(.a(new_n532_), .b(new_n516_), .c(new_n205_), .O(new_n533_));
  nand2  g441(.a(new_n243_), .b(x00), .O(new_n534_));
  aoi21  g442(.a(new_n534_), .b(x39), .c(new_n117_), .O(new_n535_));
  oai21  g443(.a(new_n535_), .b(new_n88_), .c(x35), .O(new_n536_));
  aoi21  g444(.a(new_n536_), .b(new_n102_), .c(new_n103_), .O(new_n537_));
  oai21  g445(.a(new_n92_), .b(x37), .c(new_n102_), .O(new_n538_));
  oai21  g446(.a(new_n235_), .b(new_n205_), .c(new_n90_), .O(new_n539_));
  aoi21  g447(.a(new_n538_), .b(new_n309_), .c(new_n539_), .O(new_n540_));
  oai22  g448(.a(new_n540_), .b(new_n78_), .c(new_n303_), .d(new_n92_), .O(new_n541_));
  oai21  g449(.a(new_n541_), .b(new_n537_), .c(new_n349_), .O(new_n542_));
  aoi21  g450(.a(new_n542_), .b(new_n533_), .c(x36), .O(new_n543_));
  inv1   g451(.a(new_n291_), .O(new_n544_));
  nand2  g452(.a(new_n112_), .b(x38), .O(new_n545_));
  oai21  g453(.a(new_n545_), .b(new_n215_), .c(new_n390_), .O(new_n546_));
  nor2   g454(.a(new_n103_), .b(x07), .O(new_n547_));
  aoi22  g455(.a(new_n547_), .b(new_n546_), .c(new_n544_), .d(new_n210_), .O(new_n548_));
  aoi21  g456(.a(x38), .b(new_n111_), .c(new_n78_), .O(new_n549_));
  inv1   g457(.a(new_n228_), .O(new_n550_));
  nand3  g458(.a(new_n235_), .b(new_n550_), .c(new_n117_), .O(new_n551_));
  oai21  g459(.a(new_n551_), .b(new_n549_), .c(new_n205_), .O(new_n552_));
  oai21  g460(.a(new_n548_), .b(new_n205_), .c(new_n552_), .O(new_n553_));
  nand2  g461(.a(new_n78_), .b(x38), .O(new_n554_));
  aoi22  g462(.a(new_n554_), .b(new_n103_), .c(new_n221_), .d(x00), .O(new_n555_));
  nand2  g463(.a(new_n87_), .b(x35), .O(new_n556_));
  nand2  g464(.a(x37), .b(new_n171_), .O(new_n557_));
  oai22  g465(.a(new_n557_), .b(new_n390_), .c(new_n556_), .d(new_n555_), .O(new_n558_));
  aoi21  g466(.a(new_n553_), .b(x36), .c(new_n558_), .O(new_n559_));
  nand3  g467(.a(new_n103_), .b(new_n77_), .c(new_n205_), .O(new_n560_));
  nand2  g468(.a(new_n392_), .b(x38), .O(new_n561_));
  nand2  g469(.a(new_n561_), .b(new_n560_), .O(new_n562_));
  nand2  g470(.a(new_n562_), .b(new_n111_), .O(new_n563_));
  nand2  g471(.a(new_n78_), .b(x36), .O(new_n564_));
  nand3  g472(.a(new_n564_), .b(new_n205_), .c(new_n349_), .O(new_n565_));
  nand2  g473(.a(new_n565_), .b(new_n563_), .O(new_n566_));
  nand2  g474(.a(new_n197_), .b(new_n109_), .O(new_n567_));
  nor3   g475(.a(new_n567_), .b(new_n351_), .c(new_n77_), .O(new_n568_));
  aoi21  g476(.a(new_n566_), .b(x05), .c(new_n568_), .O(new_n569_));
  oai21  g477(.a(new_n559_), .b(x34), .c(new_n569_), .O(new_n570_));
  oai21  g478(.a(new_n570_), .b(new_n543_), .c(new_n244_), .O(new_n571_));
  aoi21  g479(.a(new_n571_), .b(new_n243_), .c(new_n247_), .O(z23));
  nor3   g480(.a(new_n81_), .b(new_n341_), .c(new_n80_), .O(new_n578_));
  nand4  g481(.a(new_n578_), .b(new_n300_), .c(new_n269_), .d(new_n176_), .O(new_n579_));
  nand4  g482(.a(new_n334_), .b(new_n160_), .c(new_n152_), .d(x39), .O(new_n580_));
  aoi21  g483(.a(new_n580_), .b(new_n579_), .c(x40), .O(new_n581_));
  nor4   g484(.a(new_n450_), .b(new_n159_), .c(new_n90_), .d(new_n78_), .O(new_n582_));
  oai21  g485(.a(new_n582_), .b(new_n581_), .c(new_n349_), .O(new_n583_));
  nand2  g486(.a(new_n256_), .b(new_n176_), .O(new_n584_));
  inv1   g487(.a(new_n584_), .O(new_n585_));
  nand4  g488(.a(new_n585_), .b(new_n350_), .c(new_n271_), .d(new_n88_), .O(new_n586_));
  nand2  g489(.a(new_n586_), .b(new_n583_), .O(new_n587_));
  nand3  g490(.a(new_n587_), .b(new_n77_), .c(new_n171_), .O(new_n588_));
  nand4  g491(.a(new_n206_), .b(new_n152_), .c(new_n104_), .d(x36), .O(new_n589_));
  aoi21  g492(.a(new_n589_), .b(new_n588_), .c(new_n245_), .O(z29));
  zero   g493(.O(z02));
  zero   g494(.O(z04));
  zero   g495(.O(z05));
  zero   g496(.O(z06));
