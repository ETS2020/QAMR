// Benchmark "FAU" written by ABC on Tue Jun 23 03:50:24 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n122_, new_n124_, new_n129_, new_n134_;
  ...
  nand4  g65(.a(new_n54_), .b(x07), .c(new_n69_), .d(x01), .O(new_n124_));
  nor4   g66(.a(new_n124_), .b(x18), .c(x17), .d(x15), .O(z11));
  inv1   g67(.a(new_n122_), .O(z13));
  nand2  g68(.a(new_n88_), .b(x17), .O(new_n129_));
  nor4   g69(.a(new_n129_), .b(new_n82_), .c(x09), .d(x07), .O(z15));
  inv1   g70(.a(new_n102_), .O(new_n134_));
  nor4   g71(.a(new_n134_), .b(new_n129_), .c(x15), .d(x09), .O(z19));
  nor4   g72(.a(new_n118_), .b(new_n88_), .c(x17), .d(x15), .O(z23));
  zero   g73(.O(z00));
  zero   g74(.O(z01));
  zero   g75(.O(z04));
  zero   g76(.O(z05));
