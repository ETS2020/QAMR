...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n122_, new_n123_, new_n124_, new_n130_, new_n135_, new_n142_,
    new_n143_;
  ...
  nor2   g57(.a(x07), .b(x06), .O(new_n115_));
  nor2   g58(.a(x09), .b(x08), .O(new_n116_));
  aoi22  g59(.a(new_n116_), .b(new_n115_), .c(x08), .d(x07), .O(new_n117_));
  nand3  g60(.a(new_n102_), .b(x09), .c(x08), .O(new_n118_));
  oai21  g61(.a(new_n117_), .b(new_n69_), .c(new_n118_), .O(new_n119_));
  nand2  g62(.a(new_n116_), .b(x15), .O(new_n120_));
  nand2  g63(.a(new_n115_), .b(new_n69_), .O(new_n121_));
  nor2   g64(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  aoi21  g65(.a(new_n119_), .b(new_n68_), .c(new_n122_), .O(new_n123_));
  nand2  g66(.a(new_n100_), .b(new_n54_), .O(new_n124_));
  oai21  g67(.a(new_n123_), .b(new_n109_), .c(new_n124_), .O(z10));
  inv1   g68(.a(new_n124_), .O(z13));
  nand2  g69(.a(new_n88_), .b(x17), .O(new_n130_));
  nor4   g70(.a(new_n130_), .b(new_n82_), .c(x09), .d(x07), .O(z15));
  inv1   g71(.a(new_n102_), .O(new_n135_));
  nor4   g72(.a(new_n135_), .b(new_n130_), .c(x15), .d(x09), .O(z19));
  nor4   g73(.a(new_n118_), .b(new_n88_), .c(x17), .d(x15), .O(z23));
  nand2  g74(.a(new_n103_), .b(x08), .O(new_n142_));
  nand2  g75(.a(new_n102_), .b(new_n97_), .O(new_n143_));
  aoi21  g76(.a(new_n142_), .b(new_n120_), .c(new_n143_), .O(z25));
  zero   g77(.O(z00));
  zero   g78(.O(z01));
  zero   g79(.O(z05));
  zero   g80(.O(z06));
