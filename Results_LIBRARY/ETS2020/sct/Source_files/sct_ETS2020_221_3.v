...
module FAU ( 
  ...
  nand3  g35(.a(new_n60_), .b(new_n70_), .c(new_n66_), .O(new_n71_));
  oai21  g36(.a(new_n71_), .b(new_n54_), .c(x13), .O(new_n72_));
  ...
  nand4  g47(.a(new_n82_), .b(new_n70_), .c(new_n66_), .d(new_n65_), .O(new_n83_));
