...
module FAU ( 
  ...
  inv1   g20(.a(new_n51_), .O(new_n57_));
  nor2   g21(.a(x10), .b(x09), .O(new_n58_));
  nand2  g22(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand2  g23(.a(new_n59_), .b(x11), .O(new_n60_));
  inv1   g24(.a(x10), .O(new_n61_));
  inv1   g25(.a(x11), .O(new_n62_));
  nand4  g26(.a(new_n57_), .b(new_n62_), .c(new_n61_), .d(new_n53_), .O(new_n63_));
  nand3  g27(.a(new_n63_), .b(new_n60_), .c(new_n45_), .O(z07));
  nand2  g28(.a(new_n63_), .b(x12), .O(new_n65_));
  inv1   g29(.a(x12), .O(new_n66_));
  nand4  g30(.a(new_n58_), .b(new_n57_), .c(new_n66_), .d(new_n62_), .O(new_n67_));
  ...
  nand3  g35(.a(new_n58_), .b(x08), .c(x07), .O(new_n72_));
  ...
  nand4  g43(.a(new_n79_), .b(new_n66_), .c(new_n62_), .d(new_n61_), .O(new_n80_));
