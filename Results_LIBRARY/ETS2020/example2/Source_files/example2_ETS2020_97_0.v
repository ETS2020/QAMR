...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n289_, new_n290_, new_n292_, new_n294_, new_n297_,
  ...
  nand4  g111(.a(new_n256_), .b(new_n244_), .c(x48), .d(new_n247_), .O(new_n266_));
  ...
  nor3   g142(.a(new_n290_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g143(.a(new_n290_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g144(.a(new_n290_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g145(.a(new_n290_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g146(.a(new_n290_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g147(.a(new_n290_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g148(.a(new_n290_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g149(.a(new_n290_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g199(.a(new_n282_), .b(x14), .O(new_n356_));
