// Benchmark "FAU" written by ABC on Sat Jun 27 02:00:59 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n235_, new_n239_, new_n241_, new_n243_,
  ...
  nand2  g089(.a(new_n231_), .b(x55), .O(new_n260_));
  nor2   g090(.a(new_n260_), .b(new_n256_), .O(z37));
  nand2  g091(.a(new_n231_), .b(x56), .O(new_n262_));
  nor2   g092(.a(new_n262_), .b(new_n256_), .O(z38));
  inv1   g093(.a(x07), .O(new_n272_));
  nand2  g094(.a(x52), .b(x15), .O(new_n273_));
  oai21  g095(.a(x52), .b(new_n272_), .c(new_n273_), .O(new_n274_));
  nor2   g096(.a(x79), .b(x77), .O(new_n275_));
  nand2  g097(.a(new_n275_), .b(new_n218_), .O(new_n276_));
  inv1   g098(.a(new_n276_), .O(new_n277_));
  nand2  g099(.a(new_n277_), .b(new_n274_), .O(new_n278_));
  nor2   g100(.a(x75), .b(x67), .O(new_n279_));
  nand3  g101(.a(x79), .b(new_n160_), .c(x77), .O(new_n280_));
  nor2   g102(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  nand2  g103(.a(new_n281_), .b(new_n207_), .O(new_n282_));
  aoi21  g104(.a(new_n282_), .b(new_n278_), .c(x01), .O(z47));
  inv1   g105(.a(x08), .O(new_n284_));
  nand2  g106(.a(x52), .b(x16), .O(new_n285_));
  oai21  g107(.a(x52), .b(new_n284_), .c(new_n285_), .O(new_n286_));
  nand2  g108(.a(new_n286_), .b(new_n277_), .O(new_n287_));
  nor2   g109(.a(new_n280_), .b(new_n206_), .O(new_n288_));
  nand2  g110(.a(new_n288_), .b(x68), .O(new_n289_));
  aoi21  g111(.a(new_n289_), .b(new_n287_), .c(x01), .O(z48));
  inv1   g112(.a(x09), .O(new_n291_));
  nand2  g113(.a(x52), .b(x17), .O(new_n292_));
  oai21  g114(.a(x52), .b(new_n291_), .c(new_n292_), .O(new_n293_));
  nand2  g115(.a(new_n293_), .b(new_n277_), .O(new_n294_));
  nand2  g116(.a(new_n288_), .b(x69), .O(new_n295_));
  aoi21  g117(.a(new_n295_), .b(new_n294_), .c(x01), .O(z49));
  inv1   g118(.a(x10), .O(new_n297_));
  nand2  g119(.a(x52), .b(x18), .O(new_n298_));
  oai21  g120(.a(x52), .b(new_n297_), .c(new_n298_), .O(new_n299_));
  nand2  g121(.a(new_n299_), .b(new_n277_), .O(new_n300_));
  nand2  g122(.a(new_n288_), .b(x70), .O(new_n301_));
  aoi21  g123(.a(new_n301_), .b(new_n300_), .c(x01), .O(z50));
  inv1   g124(.a(x11), .O(new_n303_));
  nand2  g125(.a(x52), .b(x19), .O(new_n304_));
  oai21  g126(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand2  g127(.a(new_n305_), .b(new_n277_), .O(new_n306_));
  nand2  g128(.a(new_n288_), .b(x71), .O(new_n307_));
  aoi21  g129(.a(new_n307_), .b(new_n306_), .c(x01), .O(z51));
  inv1   g130(.a(x12), .O(new_n309_));
  nand2  g131(.a(x52), .b(x20), .O(new_n310_));
  oai21  g132(.a(x52), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g133(.a(new_n311_), .b(new_n277_), .O(new_n312_));
  nand2  g134(.a(new_n288_), .b(x72), .O(new_n313_));
  aoi21  g135(.a(new_n313_), .b(new_n312_), .c(x01), .O(z52));
  inv1   g136(.a(x13), .O(new_n315_));
  nand2  g137(.a(x52), .b(x21), .O(new_n316_));
  oai21  g138(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g139(.a(new_n317_), .b(new_n277_), .O(new_n318_));
  nand2  g140(.a(new_n288_), .b(x73), .O(new_n319_));
  aoi21  g141(.a(new_n319_), .b(new_n318_), .c(x01), .O(z53));
  nand2  g142(.a(x84), .b(x83), .O(new_n322_));
  nor2   g143(.a(x80), .b(new_n154_), .O(new_n323_));
  nand3  g144(.a(new_n323_), .b(new_n231_), .c(new_n161_), .O(new_n324_));
  nor4   g145(.a(new_n324_), .b(new_n322_), .c(x82), .d(x81), .O(z55));
  inv1   g146(.a(new_n161_), .O(new_n326_));
  xnor2a g147(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g148(.a(new_n169_), .b(new_n168_), .c(new_n327_), .O(new_n328_));
  aoi22  g149(.a(new_n328_), .b(new_n153_), .c(new_n326_), .d(x76), .O(new_n329_));
  inv1   g150(.a(x00), .O(new_n330_));
  nor3   g151(.a(new_n163_), .b(x01), .c(new_n330_), .O(new_n331_));
  oai21  g152(.a(new_n329_), .b(new_n154_), .c(new_n331_), .O(z56));
  inv1   g153(.a(x02), .O(new_n333_));
  nand4  g154(.a(x03), .b(new_n333_), .c(new_n153_), .d(x00), .O(new_n334_));
  inv1   g155(.a(new_n334_), .O(z57));
  nand2  g156(.a(new_n154_), .b(new_n160_), .O(new_n337_));
  aoi21  g157(.a(new_n217_), .b(new_n337_), .c(new_n152_), .O(new_n338_));
  oai21  g158(.a(new_n213_), .b(new_n211_), .c(new_n223_), .O(new_n339_));
  aoi21  g159(.a(new_n339_), .b(x79), .c(new_n217_), .O(new_n340_));
  oai21  g160(.a(new_n340_), .b(new_n338_), .c(x77), .O(new_n341_));
  nor2   g161(.a(x79), .b(x04), .O(new_n342_));
  inv1   g162(.a(new_n342_), .O(new_n343_));
  aoi21  g163(.a(new_n343_), .b(new_n341_), .c(x01), .O(z59));
  aoi21  g164(.a(new_n328_), .b(x79), .c(new_n342_), .O(new_n345_));
  aoi21  g165(.a(new_n345_), .b(new_n219_), .c(x01), .O(z60));
  aoi21  g166(.a(new_n169_), .b(new_n168_), .c(new_n206_), .O(new_n350_));
  nor2   g167(.a(new_n326_), .b(x04), .O(new_n351_));
  nor2   g168(.a(new_n210_), .b(new_n154_), .O(new_n352_));
  oai21  g169(.a(new_n351_), .b(new_n350_), .c(new_n352_), .O(new_n353_));
  aoi21  g170(.a(new_n353_), .b(new_n276_), .c(x01), .O(z64));
  zero   g171(.O(z03));
  zero   g172(.O(z05));
  zero   g173(.O(z06));
  zero   g174(.O(z07));
