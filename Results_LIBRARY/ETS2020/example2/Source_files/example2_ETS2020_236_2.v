...
module FAU ( 
  ...
  inv1   g140(.a(x14), .O(new_n317_));
  nor2   g141(.a(x52), .b(new_n317_), .O(new_n318_));
  aoi21  g142(.a(x52), .b(x22), .c(new_n318_), .O(new_n319_));
  inv1   g143(.a(new_n168_), .O(new_n320_));
  nand4  g144(.a(new_n320_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n321_));
  nor2   g145(.a(new_n321_), .b(new_n319_), .O(z54));
  nand2  g146(.a(x84), .b(x83), .O(new_n323_));
  nor2   g147(.a(x80), .b(new_n154_), .O(new_n324_));
  nand3  g148(.a(new_n324_), .b(new_n233_), .c(new_n161_), .O(new_n325_));
  nor4   g149(.a(new_n325_), .b(new_n323_), .c(x82), .d(x81), .O(z55));
  inv1   g150(.a(new_n161_), .O(new_n327_));
  xnor2a g151(.a(x84), .b(x81), .O(new_n328_));
  aoi21  g152(.a(new_n169_), .b(new_n168_), .c(new_n328_), .O(new_n329_));
  aoi22  g153(.a(new_n329_), .b(new_n153_), .c(new_n327_), .d(x76), .O(new_n330_));
  inv1   g154(.a(x00), .O(new_n331_));
  nor3   g155(.a(new_n163_), .b(x01), .c(new_n331_), .O(new_n332_));
  oai21  g156(.a(new_n330_), .b(new_n154_), .c(new_n332_), .O(z56));
  inv1   g157(.a(x02), .O(new_n334_));
  nand4  g158(.a(x03), .b(new_n334_), .c(new_n153_), .d(x00), .O(new_n335_));
  inv1   g159(.a(new_n335_), .O(z57));
  nand2  g160(.a(new_n154_), .b(new_n160_), .O(new_n338_));
  aoi21  g161(.a(new_n219_), .b(new_n338_), .c(new_n152_), .O(new_n339_));
  oai21  g162(.a(new_n215_), .b(new_n213_), .c(new_n225_), .O(new_n340_));
  aoi21  g163(.a(new_n340_), .b(x79), .c(new_n219_), .O(new_n341_));
  oai21  g164(.a(new_n341_), .b(new_n339_), .c(x77), .O(new_n342_));
  nor2   g165(.a(x79), .b(x04), .O(new_n343_));
  inv1   g166(.a(new_n343_), .O(new_n344_));
  aoi21  g167(.a(new_n344_), .b(new_n342_), .c(x01), .O(z59));
  aoi21  g168(.a(new_n329_), .b(x79), .c(new_n343_), .O(new_n346_));
  aoi21  g169(.a(new_n346_), .b(new_n221_), .c(x01), .O(z60));
  aoi21  g170(.a(new_n169_), .b(new_n168_), .c(new_n208_), .O(new_n351_));
  nor2   g171(.a(new_n327_), .b(x04), .O(new_n352_));
  nor2   g172(.a(new_n212_), .b(new_n154_), .O(new_n353_));
  oai21  g173(.a(new_n352_), .b(new_n351_), .c(new_n353_), .O(new_n354_));
  aoi21  g174(.a(new_n354_), .b(new_n281_), .c(x01), .O(z64));
  nor2   g175(.a(new_n160_), .b(x04), .O(new_n356_));
  nor2   g176(.a(new_n226_), .b(x78), .O(new_n357_));
  oai21  g177(.a(new_n357_), .b(new_n356_), .c(x77), .O(new_n358_));
  nand2  g178(.a(new_n320_), .b(x81), .O(new_n359_));
  nand2  g179(.a(new_n171_), .b(x84), .O(new_n360_));
  aoi21  g180(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z65));
  zero   g181(.O(z03));
  zero   g182(.O(z06));
  zero   g183(.O(z07));
  zero   g184(.O(z08));
