...
module FAU ( 
  ...
  nand4  g094(.a(new_n245_), .b(new_n234_), .c(x47), .d(new_n238_), .O(new_n252_));
  inv1   g095(.a(new_n252_), .O(z29));
  nand4  g096(.a(new_n245_), .b(new_n234_), .c(x48), .d(new_n238_), .O(new_n254_));
  inv1   g097(.a(new_n254_), .O(z30));
  nand4  g098(.a(new_n245_), .b(new_n234_), .c(x49), .d(new_n238_), .O(new_n256_));
  inv1   g099(.a(new_n256_), .O(z31));
  nand4  g100(.a(new_n245_), .b(new_n234_), .c(x50), .d(new_n238_), .O(new_n258_));
  inv1   g101(.a(new_n258_), .O(z32));
  nor2   g102(.a(new_n219_), .b(x81), .O(new_n260_));
  nor2   g103(.a(x83), .b(new_n242_), .O(new_n261_));
  nor2   g104(.a(new_n261_), .b(new_n260_), .O(new_n262_));
  nand2  g105(.a(x42), .b(x05), .O(new_n263_));
  nand2  g106(.a(x51), .b(new_n238_), .O(new_n264_));
  oai22  g107(.a(new_n264_), .b(new_n242_), .c(new_n263_), .d(new_n262_), .O(new_n265_));
  nand2  g108(.a(new_n265_), .b(new_n240_), .O(new_n266_));
  ...
  nand4  g202(.a(x80), .b(new_n221_), .c(x43), .d(new_n238_), .O(new_n362_));
  oai22  g203(.a(new_n362_), .b(new_n220_), .c(new_n238_), .d(x40), .O(new_n363_));
  nand3  g204(.a(new_n363_), .b(new_n226_), .c(x79), .O(new_n364_));
  nand4  g205(.a(new_n157_), .b(new_n154_), .c(new_n238_), .d(x40), .O(new_n365_));
  ...
  oai21  g211(.a(new_n222_), .b(new_n220_), .c(new_n238_), .O(new_n371_));
  ...
  nor2   g243(.a(new_n242_), .b(x78), .O(new_n403_));
