...
module FAU ( 
  ...
  oai21  g045(.a(x40), .b(new_n196_), .c(new_n197_), .O(z12));
  ...
  nand4  g099(.a(new_n249_), .b(new_n238_), .c(x48), .d(new_n242_), .O(new_n257_));
  inv1   g100(.a(new_n257_), .O(z30));
  nand4  g101(.a(new_n249_), .b(new_n238_), .c(x49), .d(new_n242_), .O(new_n259_));
  inv1   g102(.a(new_n259_), .O(z31));
  nand4  g103(.a(new_n249_), .b(new_n238_), .c(x50), .d(new_n242_), .O(new_n261_));
  inv1   g104(.a(new_n261_), .O(z32));
  nor2   g105(.a(new_n223_), .b(x81), .O(new_n263_));
  nor2   g106(.a(x83), .b(new_n246_), .O(new_n264_));
  nor2   g107(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g108(.a(x42), .b(x05), .O(new_n266_));
  nand2  g109(.a(x51), .b(new_n242_), .O(new_n267_));
  oai22  g110(.a(new_n267_), .b(new_n246_), .c(new_n266_), .d(new_n265_), .O(new_n268_));
  ...
  nor3   g136(.a(new_n285_), .b(new_n239_), .c(new_n193_), .O(z41));
  nor3   g137(.a(new_n285_), .b(new_n239_), .c(new_n190_), .O(z42));
  nor3   g138(.a(new_n285_), .b(new_n239_), .c(new_n187_), .O(z43));
  nor3   g139(.a(new_n285_), .b(new_n239_), .c(new_n184_), .O(z44));
  nor3   g140(.a(new_n285_), .b(new_n239_), .c(new_n181_), .O(z45));
  nor3   g141(.a(new_n285_), .b(new_n239_), .c(new_n178_), .O(z46));
  ...
  nand2  g150(.a(new_n168_), .b(x79), .O(new_n310_));
  aoi21  g151(.a(new_n165_), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  ...
  nand4  g194(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n354_));
  ...
  nand4  g199(.a(new_n238_), .b(new_n161_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g200(.a(new_n359_), .b(new_n357_), .O(z55));
  inv1   g201(.a(x02), .O(new_n362_));
  nand4  g202(.a(x03), .b(new_n362_), .c(new_n153_), .d(x00), .O(new_n363_));
  inv1   g203(.a(new_n363_), .O(z57));
  nand4  g204(.a(x80), .b(new_n225_), .c(x43), .d(new_n242_), .O(new_n365_));
  oai22  g205(.a(new_n365_), .b(new_n224_), .c(new_n242_), .d(x40), .O(new_n366_));
  nand3  g206(.a(new_n366_), .b(new_n230_), .c(x79), .O(new_n367_));
  nor2   g207(.a(x79), .b(x78), .O(new_n368_));
  nand3  g208(.a(new_n368_), .b(new_n242_), .c(x40), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g210(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g211(.a(new_n166_), .b(new_n233_), .c(new_n154_), .O(new_n372_));
  aoi21  g212(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  inv1   g213(.a(new_n368_), .O(new_n374_));
  aoi21  g214(.a(new_n229_), .b(new_n374_), .c(new_n152_), .O(new_n375_));
  oai21  g215(.a(new_n226_), .b(new_n224_), .c(new_n242_), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(x79), .c(new_n229_), .O(new_n377_));
  ...
  xor2a  g221(.a(x84), .b(x81), .O(new_n382_));
  nand2  g222(.a(new_n310_), .b(new_n167_), .O(new_n383_));
  aoi21  g223(.a(new_n383_), .b(new_n382_), .c(new_n379_), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n231_), .c(x01), .O(z60));
  inv1   g225(.a(new_n171_), .O(new_n386_));
  oai21  g226(.a(new_n168_), .b(new_n166_), .c(new_n220_), .O(new_n387_));
  nand2  g227(.a(new_n161_), .b(new_n233_), .O(new_n388_));
  nand2  g228(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  inv1   g229(.a(new_n389_), .O(new_n390_));
  nor3   g230(.a(new_n390_), .b(new_n386_), .c(new_n358_), .O(z61));
  nand3  g231(.a(x84), .b(x81), .c(x79), .O(new_n392_));
  oai21  g232(.a(x79), .b(new_n233_), .c(new_n392_), .O(new_n393_));
  nand2  g233(.a(new_n393_), .b(new_n159_), .O(new_n394_));
  nand2  g234(.a(new_n376_), .b(x79), .O(new_n395_));
  nand3  g235(.a(x81), .b(x79), .c(new_n233_), .O(new_n396_));
  ...
  nand2  g241(.a(new_n401_), .b(new_n168_), .O(new_n402_));
  aoi21  g242(.a(new_n402_), .b(new_n400_), .c(x01), .O(z62));
  nor3   g243(.a(new_n390_), .b(new_n386_), .c(new_n356_), .O(z63));
  nand3  g244(.a(new_n389_), .b(x83), .c(x79), .O(new_n405_));
  aoi21  g245(.a(new_n405_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g246(.a(new_n160_), .b(x04), .O(new_n407_));
  nor2   g247(.a(new_n246_), .b(x78), .O(new_n408_));
  oai21  g248(.a(new_n408_), .b(new_n407_), .c(x77), .O(new_n409_));
  nand2  g249(.a(new_n166_), .b(x81), .O(new_n410_));
  nand2  g250(.a(new_n171_), .b(x84), .O(new_n411_));
