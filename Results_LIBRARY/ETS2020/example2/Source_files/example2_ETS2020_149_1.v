...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n274_, new_n276_, new_n281_, new_n287_, new_n288_,
  ...
  nor3   g119(.a(new_n270_), .b(new_n221_), .c(new_n186_), .O(z41));
  nand2  g120(.a(new_n220_), .b(x60), .O(new_n281_));
  nor2   g121(.a(new_n281_), .b(new_n270_), .O(z42));
  ...
  nand4  g145(.a(new_n220_), .b(new_n163_), .c(new_n311_), .d(x79), .O(new_n312_));
  nor2   g146(.a(new_n312_), .b(new_n310_), .O(z55));
  aoi21  g147(.a(x84), .b(new_n227_), .c(x76), .O(new_n314_));
  oai21  g148(.a(x84), .b(new_n227_), .c(new_n314_), .O(new_n315_));
  ...
  nand4  g153(.a(x80), .b(new_n320_), .c(x43), .d(new_n223_), .O(new_n321_));
  oai22  g154(.a(new_n321_), .b(new_n319_), .c(new_n223_), .d(x40), .O(new_n322_));
  nand2  g155(.a(x78), .b(x04), .O(new_n323_));
  inv1   g156(.a(new_n323_), .O(new_n324_));
  nand3  g157(.a(new_n324_), .b(new_n322_), .c(x79), .O(new_n325_));
  nand4  g158(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n326_));
  nand2  g159(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand2  g160(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g161(.a(new_n306_), .b(new_n216_), .c(new_n162_), .O(new_n329_));
  ...
  oai21  g178(.a(x79), .b(new_n216_), .c(new_n346_), .O(new_n347_));
  nand2  g179(.a(new_n347_), .b(new_n160_), .O(new_n348_));
  nand2  g180(.a(new_n333_), .b(x79), .O(new_n349_));
  nand3  g181(.a(x81), .b(x79), .c(new_n216_), .O(new_n350_));
  ...
  nor2   g193(.a(new_n227_), .b(x78), .O(new_n362_));
