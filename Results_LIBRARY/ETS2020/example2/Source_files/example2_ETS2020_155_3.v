// Benchmark "FAU" written by ABC on Sat Jun 27 02:00:46 2020
...
module FAU ( 
  ...
  nand4  g093(.a(new_n246_), .b(new_n236_), .c(x45), .d(new_n239_), .O(new_n250_));
  inv1   g094(.a(new_n250_), .O(z27));
  nand4  g095(.a(new_n246_), .b(new_n236_), .c(x46), .d(new_n239_), .O(new_n252_));
  inv1   g096(.a(new_n252_), .O(z28));
  nand4  g097(.a(new_n246_), .b(new_n236_), .c(x48), .d(new_n239_), .O(new_n255_));
  inv1   g098(.a(new_n255_), .O(z30));
  nand4  g099(.a(new_n246_), .b(new_n236_), .c(x49), .d(new_n239_), .O(new_n257_));
  ...
  nand4  g203(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n363_));
  oai22  g204(.a(new_n363_), .b(new_n222_), .c(new_n239_), .d(x40), .O(new_n364_));
  nand3  g205(.a(new_n364_), .b(new_n228_), .c(x79), .O(new_n365_));
  nand4  g206(.a(new_n157_), .b(new_n154_), .c(new_n239_), .d(x40), .O(new_n366_));
  ...
  oai21  g212(.a(new_n224_), .b(new_n222_), .c(new_n239_), .O(new_n372_));
  ...
  nor2   g244(.a(new_n243_), .b(x78), .O(new_n404_));
