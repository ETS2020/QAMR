...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n267_, new_n273_, new_n274_, new_n275_, new_n276_, new_n277_,
  ...
  nand2  g094(.a(new_n228_), .b(x61), .O(new_n267_));
  nor2   g095(.a(new_n267_), .b(new_n255_), .O(z43));
  ...
  inv1   g140(.a(new_n155_), .O(new_n318_));
  xnor2a g141(.a(x84), .b(x81), .O(new_n319_));
  aoi21  g142(.a(new_n164_), .b(new_n163_), .c(new_n319_), .O(new_n320_));
  aoi22  g143(.a(new_n320_), .b(new_n168_), .c(new_n318_), .d(x76), .O(new_n321_));
  inv1   g144(.a(x00), .O(new_n322_));
  nor3   g145(.a(new_n158_), .b(x01), .c(new_n322_), .O(new_n323_));
  oai21  g146(.a(new_n321_), .b(new_n157_), .c(new_n323_), .O(z56));
  inv1   g147(.a(x02), .O(new_n325_));
  nand4  g148(.a(x03), .b(new_n325_), .c(new_n168_), .d(x00), .O(new_n326_));
  inv1   g149(.a(new_n326_), .O(z57));
  inv1   g150(.a(x40), .O(new_n329_));
  aoi21  g151(.a(new_n214_), .b(x79), .c(new_n329_), .O(new_n330_));
  oai21  g152(.a(new_n210_), .b(new_n208_), .c(new_n220_), .O(new_n331_));
  aoi21  g153(.a(new_n331_), .b(x79), .c(new_n214_), .O(new_n332_));
  oai21  g154(.a(new_n332_), .b(new_n330_), .c(x77), .O(new_n333_));
  nor2   g155(.a(x79), .b(x04), .O(new_n334_));
  inv1   g156(.a(new_n334_), .O(new_n335_));
  aoi21  g157(.a(new_n335_), .b(new_n333_), .c(x01), .O(z59));
  aoi21  g158(.a(new_n320_), .b(x79), .c(new_n334_), .O(new_n337_));
  aoi21  g159(.a(new_n337_), .b(new_n216_), .c(x01), .O(z60));
  aoi21  g160(.a(new_n164_), .b(new_n163_), .c(new_n203_), .O(new_n342_));
  nor2   g161(.a(new_n318_), .b(x04), .O(new_n343_));
  nor2   g162(.a(new_n207_), .b(new_n157_), .O(new_n344_));
  oai21  g163(.a(new_n343_), .b(new_n342_), .c(new_n344_), .O(new_n345_));
  aoi21  g164(.a(new_n345_), .b(new_n277_), .c(x01), .O(z64));
  nor2   g165(.a(new_n154_), .b(x04), .O(new_n347_));
  nor2   g166(.a(new_n221_), .b(x78), .O(new_n348_));
  oai21  g167(.a(new_n348_), .b(new_n347_), .c(x77), .O(new_n349_));
  nand3  g168(.a(x81), .b(x78), .c(new_n153_), .O(new_n350_));
  nand2  g169(.a(new_n166_), .b(x84), .O(new_n351_));
  aoi21  g170(.a(new_n350_), .b(new_n349_), .c(new_n351_), .O(z65));
  zero   g171(.O(z00));
  zero   g172(.O(z06));
  zero   g173(.O(z07));
  zero   g174(.O(z08));
