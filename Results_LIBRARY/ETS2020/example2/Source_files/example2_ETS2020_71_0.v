// Benchmark "FAU" written by ABC on Sat Jun 27 01:54:33 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n259_, new_n261_, new_n266_, new_n267_, new_n268_,
  ...
  nand4  g102(.a(new_n255_), .b(new_n242_), .c(x46), .d(new_n246_), .O(new_n259_));
  ...
  nand2  g107(.a(x42), .b(x05), .O(new_n267_));
  nand2  g108(.a(x51), .b(new_n246_), .O(new_n268_));
  oai22  g109(.a(new_n268_), .b(new_n250_), .c(new_n267_), .d(new_n266_), .O(new_n269_));
  nand2  g110(.a(new_n269_), .b(new_n248_), .O(new_n270_));
  xor2a  g111(.a(x83), .b(x81), .O(new_n271_));
  oai22  g112(.a(new_n271_), .b(new_n267_), .c(new_n268_), .d(x81), .O(new_n272_));
  nand2  g113(.a(new_n272_), .b(new_n252_), .O(new_n273_));
  inv1   g114(.a(new_n254_), .O(new_n274_));
  nand2  g115(.a(new_n274_), .b(new_n242_), .O(new_n275_));
  aoi21  g116(.a(new_n273_), .b(new_n270_), .c(new_n275_), .O(z33));
  inv1   g117(.a(x52), .O(new_n277_));
  nand2  g118(.a(x83), .b(x42), .O(new_n278_));
  nand2  g119(.a(new_n278_), .b(new_n250_), .O(new_n279_));
  nand3  g120(.a(x83), .b(x81), .c(x42), .O(new_n280_));
  aoi21  g121(.a(new_n280_), .b(new_n279_), .c(new_n251_), .O(new_n281_));
  nand2  g122(.a(new_n278_), .b(x81), .O(new_n282_));
  nand3  g123(.a(x83), .b(new_n250_), .c(x42), .O(new_n283_));
  aoi21  g124(.a(new_n283_), .b(new_n282_), .c(new_n247_), .O(new_n284_));
  oai21  g125(.a(new_n284_), .b(new_n281_), .c(new_n274_), .O(new_n285_));
  nor3   g126(.a(new_n285_), .b(new_n243_), .c(new_n277_), .O(z34));
  nand2  g127(.a(new_n242_), .b(x53), .O(new_n287_));
  nor2   g128(.a(new_n287_), .b(new_n285_), .O(z35));
  nand2  g129(.a(new_n242_), .b(x54), .O(new_n289_));
  nor2   g130(.a(new_n289_), .b(new_n285_), .O(z36));
  nand2  g131(.a(new_n242_), .b(x55), .O(new_n291_));
  nor2   g132(.a(new_n291_), .b(new_n285_), .O(z37));
  nand2  g133(.a(new_n242_), .b(x56), .O(new_n293_));
  nor2   g134(.a(new_n293_), .b(new_n285_), .O(z38));
  nor3   g135(.a(new_n285_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g136(.a(new_n285_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g137(.a(new_n285_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g138(.a(new_n285_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g139(.a(new_n285_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g140(.a(new_n285_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g141(.a(new_n285_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g142(.a(new_n285_), .b(new_n243_), .c(new_n176_), .O(z46));
  ...
  nand2  g192(.a(new_n277_), .b(x14), .O(new_n352_));
