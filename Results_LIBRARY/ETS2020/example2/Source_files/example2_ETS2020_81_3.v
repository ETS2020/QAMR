...
module FAU ( 
  ...
  oai21  g226(.a(new_n163_), .b(new_n161_), .c(new_n218_), .O(new_n385_));
  nand2  g227(.a(new_n155_), .b(new_n231_), .O(new_n386_));
  ...
  oai21  g232(.a(x79), .b(new_n231_), .c(new_n390_), .O(new_n391_));
  nand2  g233(.a(new_n391_), .b(new_n153_), .O(new_n392_));
  nand2  g234(.a(new_n374_), .b(x79), .O(new_n393_));
  nand3  g235(.a(x81), .b(x79), .c(new_n231_), .O(new_n394_));
  ...
  nor2   g247(.a(new_n243_), .b(x78), .O(new_n406_));
