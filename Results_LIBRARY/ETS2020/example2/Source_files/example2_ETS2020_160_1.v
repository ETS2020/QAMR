// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:08 2020
...
module FAU ( 
  ...
  nand2  g110(.a(new_n222_), .b(x53), .O(new_n271_));
  nor2   g111(.a(new_n271_), .b(new_n269_), .O(z35));
  nand2  g112(.a(new_n222_), .b(x55), .O(new_n274_));
  nor2   g113(.a(new_n274_), .b(new_n269_), .O(z37));
  nand2  g114(.a(new_n222_), .b(x56), .O(new_n276_));
  nor2   g115(.a(new_n276_), .b(new_n269_), .O(z38));
  nor3   g116(.a(new_n269_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g117(.a(new_n269_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g118(.a(new_n269_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g119(.a(new_n269_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g120(.a(new_n269_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g121(.a(new_n269_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g122(.a(new_n269_), .b(new_n223_), .c(new_n173_), .O(z46));
  ...
  nand2  g135(.a(new_n260_), .b(x14), .O(new_n304_));
  ...
  nand3  g140(.a(new_n247_), .b(x84), .c(new_n308_), .O(new_n309_));
  inv1   g141(.a(x80), .O(new_n310_));
  nand4  g142(.a(new_n222_), .b(new_n163_), .c(new_n310_), .d(x79), .O(new_n311_));
  nor2   g143(.a(new_n311_), .b(new_n309_), .O(z55));
  aoi21  g144(.a(x84), .b(new_n229_), .c(x76), .O(new_n313_));
  oai21  g145(.a(x84), .b(new_n229_), .c(new_n313_), .O(new_n314_));
  nand2  g146(.a(new_n314_), .b(new_n164_), .O(new_n315_));
  nand4  g147(.a(new_n315_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g148(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n318_));
  inv1   g149(.a(x74), .O(new_n319_));
  nand4  g150(.a(x80), .b(new_n319_), .c(x43), .d(new_n225_), .O(new_n320_));
  oai22  g151(.a(new_n320_), .b(new_n318_), .c(new_n225_), .d(x40), .O(new_n321_));
  nand2  g152(.a(x78), .b(x04), .O(new_n322_));
  inv1   g153(.a(new_n322_), .O(new_n323_));
  nand3  g154(.a(new_n323_), .b(new_n321_), .c(x79), .O(new_n324_));
  nand4  g155(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n325_));
  nand2  g156(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  nand2  g157(.a(new_n326_), .b(x77), .O(new_n327_));
  oai21  g158(.a(new_n305_), .b(new_n218_), .c(new_n162_), .O(new_n328_));
  ...
  oai21  g175(.a(x79), .b(new_n218_), .c(new_n345_), .O(new_n346_));
  nand2  g176(.a(new_n346_), .b(new_n160_), .O(new_n347_));
  nand2  g177(.a(new_n332_), .b(x79), .O(new_n348_));
  nand3  g178(.a(x81), .b(x79), .c(new_n218_), .O(new_n349_));
  ...
  nor2   g190(.a(new_n229_), .b(x78), .O(new_n361_));
