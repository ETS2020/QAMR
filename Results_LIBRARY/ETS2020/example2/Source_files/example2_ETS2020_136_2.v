...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n233_, new_n234_, new_n236_, new_n238_, new_n240_, new_n242_,
  ...
  nand4  g071(.a(new_n233_), .b(new_n232_), .c(x47), .d(new_n225_), .O(new_n238_));
  inv1   g072(.a(new_n238_), .O(z29));
  nand4  g073(.a(new_n233_), .b(new_n232_), .c(x48), .d(new_n225_), .O(new_n240_));
  inv1   g074(.a(new_n240_), .O(z30));
  nand4  g075(.a(new_n233_), .b(new_n232_), .c(x49), .d(new_n225_), .O(new_n242_));
  inv1   g076(.a(new_n242_), .O(z31));
  nand4  g077(.a(new_n233_), .b(new_n232_), .c(x50), .d(new_n225_), .O(new_n244_));
  inv1   g078(.a(new_n244_), .O(z32));
  inv1   g079(.a(new_n162_), .O(new_n248_));
  nand2  g080(.a(x83), .b(x42), .O(new_n249_));
  nand2  g081(.a(new_n249_), .b(new_n226_), .O(new_n250_));
  inv1   g082(.a(new_n249_), .O(new_n251_));
  nand2  g083(.a(new_n251_), .b(x81), .O(new_n252_));
  aoi21  g084(.a(new_n252_), .b(new_n250_), .c(new_n229_), .O(new_n253_));
  nand2  g085(.a(new_n249_), .b(x81), .O(new_n254_));
  nand2  g086(.a(new_n251_), .b(new_n226_), .O(new_n255_));
  aoi21  g087(.a(new_n255_), .b(new_n254_), .c(new_n227_), .O(new_n256_));
  oai21  g088(.a(new_n256_), .b(new_n253_), .c(new_n248_), .O(new_n257_));
  nand2  g089(.a(new_n233_), .b(x53), .O(new_n258_));
  nor2   g090(.a(new_n258_), .b(new_n257_), .O(z35));
  nand2  g091(.a(new_n233_), .b(x54), .O(new_n260_));
  nor2   g092(.a(new_n260_), .b(new_n257_), .O(z36));
  nand2  g093(.a(new_n233_), .b(x55), .O(new_n262_));
  ...
  nand3  g137(.a(new_n316_), .b(new_n233_), .c(new_n161_), .O(new_n317_));
  ...
  oai21  g151(.a(new_n213_), .b(new_n211_), .c(new_n225_), .O(new_n332_));
