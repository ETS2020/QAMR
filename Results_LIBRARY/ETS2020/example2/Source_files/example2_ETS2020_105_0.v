// Benchmark "FAU" written by ABC on Sat Jun 27 01:57:03 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n257_, new_n260_, new_n262_, new_n265_, new_n268_,
  ...
  nand4  g108(.a(new_n254_), .b(new_n242_), .c(x49), .d(new_n245_), .O(new_n265_));
  ...
  nand4  g206(.a(x80), .b(new_n226_), .c(x43), .d(new_n245_), .O(new_n367_));
  ...
  nand4  g211(.a(new_n167_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n372_));
  ...
  nor2   g231(.a(new_n249_), .b(new_n167_), .O(new_n393_));
  ...
  oai21  g236(.a(new_n249_), .b(x78), .c(new_n388_), .O(new_n399_));
