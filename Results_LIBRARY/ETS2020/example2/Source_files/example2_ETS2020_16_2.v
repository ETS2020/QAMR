...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n176_, new_n186_, new_n187_, new_n192_, new_n193_,
    ...
    new_n263_, new_n272_, new_n273_, new_n274_, new_n275_, new_n276_,
  ...
  nand4  g067(.a(new_n227_), .b(new_n226_), .c(x46), .d(new_n219_), .O(new_n234_));
  inv1   g068(.a(new_n234_), .O(z28));
  nand4  g069(.a(new_n227_), .b(new_n226_), .c(x47), .d(new_n219_), .O(new_n236_));
  inv1   g070(.a(new_n236_), .O(z29));
  nand4  g071(.a(new_n227_), .b(new_n226_), .c(x48), .d(new_n219_), .O(new_n238_));
  inv1   g072(.a(new_n238_), .O(z30));
  nand4  g073(.a(new_n227_), .b(new_n226_), .c(x49), .d(new_n219_), .O(new_n240_));
  inv1   g074(.a(new_n240_), .O(z31));
  nand4  g075(.a(new_n227_), .b(new_n226_), .c(x50), .d(new_n219_), .O(new_n242_));
  inv1   g076(.a(new_n242_), .O(z32));
  inv1   g077(.a(new_n162_), .O(new_n246_));
  nand2  g078(.a(x83), .b(x42), .O(new_n247_));
  nand2  g079(.a(new_n247_), .b(new_n220_), .O(new_n248_));
  inv1   g080(.a(new_n247_), .O(new_n249_));
  nand2  g081(.a(new_n249_), .b(x81), .O(new_n250_));
  aoi21  g082(.a(new_n250_), .b(new_n248_), .c(new_n223_), .O(new_n251_));
  nand2  g083(.a(new_n247_), .b(x81), .O(new_n252_));
  nand2  g084(.a(new_n249_), .b(new_n220_), .O(new_n253_));
  aoi21  g085(.a(new_n253_), .b(new_n252_), .c(new_n221_), .O(new_n254_));
  oai21  g086(.a(new_n254_), .b(new_n251_), .c(new_n246_), .O(new_n255_));
  nand2  g087(.a(new_n227_), .b(x53), .O(new_n256_));
  nor2   g088(.a(new_n256_), .b(new_n255_), .O(z35));
  nand2  g089(.a(new_n227_), .b(x55), .O(new_n259_));
  nor2   g090(.a(new_n259_), .b(new_n255_), .O(z37));
  nand2  g091(.a(new_n227_), .b(x56), .O(new_n261_));
  nor2   g092(.a(new_n261_), .b(new_n255_), .O(z38));
  nand2  g093(.a(new_n227_), .b(x57), .O(new_n263_));
  nor2   g094(.a(new_n263_), .b(new_n255_), .O(z39));
  ...
  nand2  g099(.a(new_n275_), .b(new_n214_), .O(new_n276_));
  ...
  nand2  g105(.a(new_n281_), .b(new_n203_), .O(new_n282_));
  ...
  nor2   g111(.a(new_n280_), .b(new_n202_), .O(new_n288_));
  ...
  nor2   g145(.a(x80), .b(new_n154_), .O(new_n323_));
  nand3  g146(.a(new_n323_), .b(new_n227_), .c(new_n161_), .O(new_n324_));
  nor4   g147(.a(new_n324_), .b(new_n322_), .c(x82), .d(x81), .O(z55));
  inv1   g148(.a(new_n161_), .O(new_n326_));
  xnor2a g149(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g150(.a(new_n169_), .b(new_n168_), .c(new_n327_), .O(new_n328_));
  aoi22  g151(.a(new_n328_), .b(new_n153_), .c(new_n326_), .d(x76), .O(new_n329_));
  inv1   g152(.a(x00), .O(new_n330_));
  nor3   g153(.a(new_n163_), .b(x01), .c(new_n330_), .O(new_n331_));
  oai21  g154(.a(new_n329_), .b(new_n154_), .c(new_n331_), .O(z56));
  inv1   g155(.a(x02), .O(new_n333_));
  nand4  g156(.a(x03), .b(new_n333_), .c(new_n153_), .d(x00), .O(new_n334_));
  inv1   g157(.a(new_n334_), .O(z57));
  nand2  g158(.a(new_n154_), .b(new_n160_), .O(new_n337_));
  aoi21  g159(.a(new_n213_), .b(new_n337_), .c(new_n152_), .O(new_n338_));
  oai21  g160(.a(new_n209_), .b(new_n207_), .c(new_n219_), .O(new_n339_));
  aoi21  g161(.a(new_n339_), .b(x79), .c(new_n213_), .O(new_n340_));
  ...
  aoi21  g167(.a(new_n345_), .b(new_n215_), .c(x01), .O(z60));
  aoi21  g168(.a(new_n169_), .b(new_n168_), .c(new_n202_), .O(new_n350_));
  nor2   g169(.a(new_n326_), .b(x04), .O(new_n351_));
  nor2   g170(.a(new_n206_), .b(new_n154_), .O(new_n352_));
