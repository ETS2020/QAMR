...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n166_, new_n171_, new_n172_, new_n181_, new_n182_, new_n184_,
    ...
    new_n225_, new_n230_, new_n232_, new_n234_, new_n236_, new_n240_,
  ...
  nand4  g060(.a(new_n224_), .b(new_n223_), .c(x47), .d(new_n216_), .O(new_n230_));
  inv1   g061(.a(new_n230_), .O(z29));
  nand4  g062(.a(new_n224_), .b(new_n223_), .c(x48), .d(new_n216_), .O(new_n232_));
  inv1   g063(.a(new_n232_), .O(z30));
  nand4  g064(.a(new_n224_), .b(new_n223_), .c(x49), .d(new_n216_), .O(new_n234_));
  inv1   g065(.a(new_n234_), .O(z31));
  nand4  g066(.a(new_n224_), .b(new_n223_), .c(x50), .d(new_n216_), .O(new_n236_));
  inv1   g067(.a(new_n236_), .O(z32));
  inv1   g068(.a(new_n156_), .O(new_n240_));
  nand2  g069(.a(x83), .b(x42), .O(new_n241_));
  nand2  g070(.a(new_n241_), .b(new_n217_), .O(new_n242_));
  inv1   g071(.a(new_n241_), .O(new_n243_));
  nand2  g072(.a(new_n243_), .b(x81), .O(new_n244_));
  aoi21  g073(.a(new_n244_), .b(new_n242_), .c(new_n220_), .O(new_n245_));
  nand2  g074(.a(new_n241_), .b(x81), .O(new_n246_));
  nand2  g075(.a(new_n243_), .b(new_n217_), .O(new_n247_));
  aoi21  g076(.a(new_n247_), .b(new_n246_), .c(new_n218_), .O(new_n248_));
  oai21  g077(.a(new_n248_), .b(new_n245_), .c(new_n240_), .O(new_n249_));
  nand2  g078(.a(new_n224_), .b(x53), .O(new_n250_));
  nor2   g079(.a(new_n250_), .b(new_n249_), .O(z35));
  nand2  g080(.a(new_n224_), .b(x54), .O(new_n252_));
