...
module FAU ( 
  ...
  nand4  g068(.a(new_n230_), .b(new_n229_), .c(x47), .d(new_n222_), .O(new_n235_));
  inv1   g069(.a(new_n235_), .O(z29));
  nand4  g070(.a(new_n230_), .b(new_n229_), .c(x48), .d(new_n222_), .O(new_n237_));
  inv1   g071(.a(new_n237_), .O(z30));
  nand4  g072(.a(new_n230_), .b(new_n229_), .c(x49), .d(new_n222_), .O(new_n239_));
  inv1   g073(.a(new_n239_), .O(z31));
  nand4  g074(.a(new_n230_), .b(new_n229_), .c(x50), .d(new_n222_), .O(new_n241_));
  inv1   g075(.a(new_n241_), .O(z32));
  inv1   g076(.a(new_n156_), .O(new_n245_));
  nand2  g077(.a(x83), .b(x42), .O(new_n246_));
  nand2  g078(.a(new_n246_), .b(new_n223_), .O(new_n247_));
  inv1   g079(.a(new_n246_), .O(new_n248_));
  nand2  g080(.a(new_n248_), .b(x81), .O(new_n249_));
  aoi21  g081(.a(new_n249_), .b(new_n247_), .c(new_n226_), .O(new_n250_));
  nand2  g082(.a(new_n246_), .b(x81), .O(new_n251_));
  nand2  g083(.a(new_n248_), .b(new_n223_), .O(new_n252_));
  aoi21  g084(.a(new_n252_), .b(new_n251_), .c(new_n224_), .O(new_n253_));
  oai21  g085(.a(new_n253_), .b(new_n250_), .c(new_n245_), .O(new_n254_));
  nand2  g086(.a(new_n230_), .b(x53), .O(new_n255_));
  nor2   g087(.a(new_n255_), .b(new_n254_), .O(z35));
  nand2  g088(.a(new_n230_), .b(x54), .O(new_n257_));
  nor2   g089(.a(new_n257_), .b(new_n254_), .O(z36));
  nand2  g090(.a(new_n230_), .b(x55), .O(new_n259_));
  nor2   g091(.a(new_n259_), .b(new_n254_), .O(z37));
  nand2  g092(.a(new_n230_), .b(x56), .O(new_n261_));
  ...
  nand3  g136(.a(new_n314_), .b(new_n230_), .c(new_n155_), .O(new_n315_));
  ...
  oai21  g151(.a(new_n210_), .b(new_n208_), .c(new_n222_), .O(new_n331_));
  ...
  nor2   g165(.a(new_n223_), .b(x78), .O(new_n348_));
