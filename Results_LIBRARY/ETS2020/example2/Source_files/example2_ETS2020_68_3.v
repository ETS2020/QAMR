...
module FAU ( 
  ...
  nand2  g035(.a(new_n152_), .b(x28), .O(new_n189_));
  oai21  g036(.a(new_n188_), .b(new_n152_), .c(new_n189_), .O(z10));
  inv1   g037(.a(x59), .O(new_n191_));
  nand2  g038(.a(new_n152_), .b(x29), .O(new_n192_));
  oai21  g039(.a(new_n191_), .b(new_n152_), .c(new_n192_), .O(z11));
  ...
  nor3   g139(.a(new_n286_), .b(new_n239_), .c(new_n197_), .O(z39));
  nor3   g140(.a(new_n286_), .b(new_n239_), .c(new_n194_), .O(z40));
  nor3   g141(.a(new_n286_), .b(new_n239_), .c(new_n191_), .O(z41));
  nor3   g142(.a(new_n286_), .b(new_n239_), .c(new_n188_), .O(z42));
  nor3   g143(.a(new_n286_), .b(new_n239_), .c(new_n185_), .O(z43));
  nor3   g144(.a(new_n286_), .b(new_n239_), .c(new_n182_), .O(z44));
  nor3   g145(.a(new_n286_), .b(new_n239_), .c(new_n179_), .O(z45));
  nor3   g146(.a(new_n286_), .b(new_n239_), .c(new_n176_), .O(z46));
  ...
  oai21  g231(.a(new_n168_), .b(new_n166_), .c(new_n220_), .O(new_n389_));
  nand2  g232(.a(new_n161_), .b(new_n233_), .O(new_n390_));
  ...
  oai21  g237(.a(x79), .b(new_n233_), .c(new_n394_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n159_), .O(new_n396_));
  nand2  g239(.a(new_n378_), .b(x79), .O(new_n397_));
  nand3  g240(.a(x81), .b(x79), .c(new_n233_), .O(new_n398_));
  ...
  nor2   g252(.a(new_n245_), .b(x78), .O(new_n410_));
