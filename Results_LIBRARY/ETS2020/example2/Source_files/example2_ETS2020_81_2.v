...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n253_, new_n254_, new_n255_, new_n256_, new_n259_, new_n262_,
  ...
  nand2  g090(.a(new_n231_), .b(x57), .O(new_n262_));
  nor2   g091(.a(new_n262_), .b(new_n255_), .O(z39));
  ...
  nand3  g134(.a(new_n314_), .b(new_n231_), .c(new_n161_), .O(new_n315_));
  ...
  oai21  g148(.a(new_n211_), .b(new_n209_), .c(new_n223_), .O(new_n330_));
