// Benchmark "FAU" written by ABC on Sat Jun 27 02:05:36 2020
...
module FAU ( 
  ...
  aoi21  g093(.a(new_n247_), .b(new_n244_), .c(new_n156_), .O(new_n248_));
  nand4  g094(.a(new_n248_), .b(new_n238_), .c(new_n241_), .d(x05), .O(new_n249_));
  inv1   g095(.a(new_n249_), .O(z25));
  nand4  g096(.a(new_n248_), .b(new_n238_), .c(x44), .d(new_n241_), .O(new_n251_));
  inv1   g097(.a(new_n251_), .O(z26));
  nand4  g098(.a(new_n248_), .b(new_n238_), .c(x45), .d(new_n241_), .O(new_n253_));
  inv1   g099(.a(new_n253_), .O(z27));
  nand4  g100(.a(new_n248_), .b(new_n238_), .c(x46), .d(new_n241_), .O(new_n255_));
  inv1   g101(.a(new_n255_), .O(z28));
  nand4  g102(.a(new_n248_), .b(new_n238_), .c(x48), .d(new_n241_), .O(new_n258_));
  inv1   g103(.a(new_n258_), .O(z30));
  nand4  g104(.a(new_n248_), .b(new_n238_), .c(x49), .d(new_n241_), .O(new_n260_));
  inv1   g105(.a(new_n260_), .O(z31));
  nand4  g106(.a(new_n248_), .b(new_n238_), .c(x50), .d(new_n241_), .O(new_n262_));
  inv1   g107(.a(new_n262_), .O(z32));
  nor2   g108(.a(new_n223_), .b(x81), .O(new_n264_));
  nor2   g109(.a(x83), .b(new_n245_), .O(new_n265_));
  nor2   g110(.a(new_n265_), .b(new_n264_), .O(new_n266_));
  nand2  g111(.a(x42), .b(x05), .O(new_n267_));
  nand2  g112(.a(x51), .b(new_n241_), .O(new_n268_));
  oai22  g113(.a(new_n268_), .b(new_n245_), .c(new_n267_), .d(new_n266_), .O(new_n269_));
  nand2  g114(.a(new_n269_), .b(new_n243_), .O(new_n270_));
  ...
  nand2  g123(.a(new_n278_), .b(new_n245_), .O(new_n279_));
  nand3  g124(.a(x83), .b(x81), .c(x42), .O(new_n280_));
  nand2  g125(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  and2   g126(.a(new_n281_), .b(new_n246_), .O(new_n282_));
  nand2  g127(.a(new_n278_), .b(x81), .O(new_n283_));
  nand2  g128(.a(new_n264_), .b(x42), .O(new_n284_));
  aoi21  g129(.a(new_n284_), .b(new_n283_), .c(new_n242_), .O(new_n285_));
  oai21  g130(.a(new_n285_), .b(new_n282_), .c(new_n274_), .O(new_n286_));
  nor3   g131(.a(new_n286_), .b(new_n239_), .c(new_n277_), .O(z34));
  nand2  g132(.a(new_n238_), .b(x53), .O(new_n288_));
  nor2   g133(.a(new_n288_), .b(new_n286_), .O(z35));
  nand2  g134(.a(new_n238_), .b(x54), .O(new_n290_));
  nor2   g135(.a(new_n290_), .b(new_n286_), .O(z36));
  nand2  g136(.a(new_n238_), .b(x55), .O(new_n292_));
  nor2   g137(.a(new_n292_), .b(new_n286_), .O(z37));
  nor3   g138(.a(new_n286_), .b(new_n239_), .c(new_n197_), .O(z39));
  nor3   g139(.a(new_n286_), .b(new_n239_), .c(new_n194_), .O(z40));
  nor3   g140(.a(new_n286_), .b(new_n239_), .c(new_n191_), .O(z41));
  nor3   g141(.a(new_n286_), .b(new_n239_), .c(new_n188_), .O(z42));
  nor3   g142(.a(new_n286_), .b(new_n239_), .c(new_n185_), .O(z43));
  nor3   g143(.a(new_n286_), .b(new_n239_), .c(new_n182_), .O(z44));
  nor3   g144(.a(new_n286_), .b(new_n239_), .c(new_n179_), .O(z45));
  nor3   g145(.a(new_n286_), .b(new_n239_), .c(new_n176_), .O(z46));
  ...
  nand4  g208(.a(x80), .b(new_n225_), .c(x43), .d(new_n241_), .O(new_n366_));
  oai22  g209(.a(new_n366_), .b(new_n224_), .c(new_n241_), .d(x40), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n230_), .c(x79), .O(new_n368_));
  nand4  g211(.a(new_n157_), .b(new_n154_), .c(new_n241_), .d(x40), .O(new_n369_));
  ...
  oai21  g217(.a(new_n226_), .b(new_n224_), .c(new_n241_), .O(new_n375_));
  ...
  nor2   g249(.a(new_n245_), .b(x78), .O(new_n407_));
