...
module FAU ( 
  ...
  nand4  g065(.a(new_n228_), .b(new_n227_), .c(x47), .d(new_n220_), .O(new_n233_));
  inv1   g066(.a(new_n233_), .O(z29));
  nand4  g067(.a(new_n228_), .b(new_n227_), .c(x48), .d(new_n220_), .O(new_n235_));
  inv1   g068(.a(new_n235_), .O(z30));
  nand4  g069(.a(new_n228_), .b(new_n227_), .c(x49), .d(new_n220_), .O(new_n237_));
  inv1   g070(.a(new_n237_), .O(z31));
  nand4  g071(.a(new_n228_), .b(new_n227_), .c(x50), .d(new_n220_), .O(new_n239_));
  inv1   g072(.a(new_n239_), .O(z32));
  inv1   g073(.a(new_n156_), .O(new_n243_));
  nand2  g074(.a(x83), .b(x42), .O(new_n244_));
  nand2  g075(.a(new_n244_), .b(new_n221_), .O(new_n245_));
  inv1   g076(.a(new_n244_), .O(new_n246_));
  nand2  g077(.a(new_n246_), .b(x81), .O(new_n247_));
  aoi21  g078(.a(new_n247_), .b(new_n245_), .c(new_n224_), .O(new_n248_));
  nand2  g079(.a(new_n244_), .b(x81), .O(new_n249_));
  nand2  g080(.a(new_n246_), .b(new_n221_), .O(new_n250_));
  aoi21  g081(.a(new_n250_), .b(new_n249_), .c(new_n222_), .O(new_n251_));
  oai21  g082(.a(new_n251_), .b(new_n248_), .c(new_n243_), .O(new_n252_));
  nand2  g083(.a(new_n228_), .b(x53), .O(new_n253_));
  nor2   g084(.a(new_n253_), .b(new_n252_), .O(z35));
  nand2  g085(.a(new_n228_), .b(x54), .O(new_n255_));
  nor2   g086(.a(new_n255_), .b(new_n252_), .O(z36));
  nand2  g087(.a(new_n228_), .b(x55), .O(new_n257_));
  ...
  nand3  g140(.a(new_n319_), .b(new_n228_), .c(new_n155_), .O(new_n320_));
  ...
  oai21  g155(.a(new_n208_), .b(new_n206_), .c(new_n220_), .O(new_n336_));
