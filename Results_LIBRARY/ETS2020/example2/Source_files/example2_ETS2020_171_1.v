...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n302_, new_n309_, new_n310_, new_n311_, new_n312_, new_n314_,
  ...
  nor2   g115(.a(new_n276_), .b(new_n271_), .O(z38));
  nor3   g116(.a(new_n271_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g117(.a(new_n271_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g118(.a(new_n271_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g119(.a(new_n271_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g120(.a(new_n271_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g121(.a(new_n271_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g122(.a(new_n271_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g123(.a(new_n271_), .b(new_n223_), .c(new_n173_), .O(z46));
  ...
  nand2  g138(.a(new_n299_), .b(new_n290_), .O(new_n300_));
  nor2   g139(.a(new_n162_), .b(x78), .O(new_n301_));
  nand4  g140(.a(new_n301_), .b(new_n292_), .c(x77), .d(x68), .O(new_n302_));
  aoi21  g141(.a(new_n302_), .b(new_n300_), .c(x01), .O(z48));
  nand2  g142(.a(x52), .b(x22), .O(new_n309_));
  nand2  g143(.a(new_n262_), .b(x14), .O(new_n310_));
  nor2   g144(.a(new_n154_), .b(x77), .O(new_n311_));
  nand4  g145(.a(new_n311_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n312_));
  aoi21  g146(.a(new_n310_), .b(new_n309_), .c(new_n312_), .O(z54));
  inv1   g147(.a(x82), .O(new_n314_));
  nand3  g148(.a(new_n249_), .b(x84), .c(new_n314_), .O(new_n315_));
  inv1   g149(.a(x80), .O(new_n316_));
  nand4  g150(.a(new_n222_), .b(new_n163_), .c(new_n316_), .d(x79), .O(new_n317_));
  nor2   g151(.a(new_n317_), .b(new_n315_), .O(z55));
  aoi21  g152(.a(x84), .b(new_n229_), .c(x76), .O(new_n319_));
  oai21  g153(.a(x84), .b(new_n229_), .c(new_n319_), .O(new_n320_));
  nand2  g154(.a(new_n320_), .b(new_n164_), .O(new_n321_));
  nand4  g155(.a(new_n321_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g156(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n324_));
  inv1   g157(.a(x74), .O(new_n325_));
  nand4  g158(.a(x80), .b(new_n325_), .c(x43), .d(new_n225_), .O(new_n326_));
  oai22  g159(.a(new_n326_), .b(new_n324_), .c(new_n225_), .d(x40), .O(new_n327_));
  nand2  g160(.a(x78), .b(x04), .O(new_n328_));
  inv1   g161(.a(new_n328_), .O(new_n329_));
  nand3  g162(.a(new_n329_), .b(new_n327_), .c(x79), .O(new_n330_));
  nand4  g163(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n331_));
  nand2  g164(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  nand2  g165(.a(new_n332_), .b(x77), .O(new_n333_));
  oai21  g166(.a(new_n311_), .b(new_n218_), .c(new_n162_), .O(new_n334_));
  aoi21  g167(.a(new_n334_), .b(new_n333_), .c(x01), .O(z58));
  aoi21  g168(.a(new_n328_), .b(x79), .c(new_n152_), .O(new_n336_));
  nand3  g169(.a(x80), .b(new_n325_), .c(x43), .O(new_n337_));
  oai21  g170(.a(new_n337_), .b(new_n324_), .c(new_n225_), .O(new_n338_));
  aoi21  g171(.a(new_n338_), .b(x79), .c(new_n328_), .O(new_n339_));
  oai21  g172(.a(new_n339_), .b(new_n336_), .c(x77), .O(new_n340_));
  nand2  g173(.a(new_n162_), .b(new_n218_), .O(new_n341_));
  aoi21  g174(.a(new_n341_), .b(new_n340_), .c(x01), .O(z59));
  oai21  g175(.a(new_n311_), .b(new_n294_), .c(new_n292_), .O(new_n344_));
  nand2  g176(.a(new_n163_), .b(new_n218_), .O(new_n345_));
  nand2  g177(.a(new_n345_), .b(new_n344_), .O(new_n346_));
  inv1   g178(.a(new_n346_), .O(new_n347_));
  nor2   g179(.a(new_n162_), .b(x01), .O(new_n348_));
  inv1   g180(.a(new_n348_), .O(new_n349_));
  nor3   g181(.a(new_n349_), .b(new_n347_), .c(new_n316_), .O(z61));
  nand3  g182(.a(x84), .b(x81), .c(x79), .O(new_n351_));
  oai21  g183(.a(x79), .b(new_n218_), .c(new_n351_), .O(new_n352_));
  nand2  g184(.a(new_n352_), .b(new_n160_), .O(new_n353_));
  nand2  g185(.a(new_n338_), .b(x79), .O(new_n354_));
  nand3  g186(.a(x81), .b(x79), .c(new_n218_), .O(new_n355_));
  inv1   g187(.a(new_n355_), .O(new_n356_));
  aoi21  g188(.a(new_n354_), .b(x04), .c(new_n356_), .O(new_n357_));
  oai21  g189(.a(new_n357_), .b(new_n160_), .c(new_n353_), .O(new_n358_));
  nand2  g190(.a(new_n358_), .b(x78), .O(new_n359_));
  inv1   g191(.a(new_n351_), .O(new_n360_));
  nand2  g192(.a(new_n360_), .b(new_n294_), .O(new_n361_));
  aoi21  g193(.a(new_n361_), .b(new_n359_), .c(x01), .O(z62));
  nor3   g194(.a(new_n349_), .b(new_n347_), .c(new_n314_), .O(z63));
  nand3  g195(.a(new_n346_), .b(x83), .c(x79), .O(new_n364_));
  aoi21  g196(.a(new_n364_), .b(new_n289_), .c(x01), .O(z64));
  nor2   g197(.a(new_n154_), .b(x04), .O(new_n366_));
  nor2   g198(.a(new_n229_), .b(x78), .O(new_n367_));
  oai21  g199(.a(new_n367_), .b(new_n366_), .c(x77), .O(new_n368_));
  nand2  g200(.a(new_n311_), .b(x81), .O(new_n369_));
  nand2  g201(.a(new_n348_), .b(x84), .O(new_n370_));
  aoi21  g202(.a(new_n369_), .b(new_n368_), .c(new_n370_), .O(z65));
  zero   g203(.O(z02));
  zero   g204(.O(z04));
  zero   g205(.O(z15));
  zero   g206(.O(z21));
