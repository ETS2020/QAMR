...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n272_, new_n276_, new_n283_, new_n294_, new_n295_,
  ...
  nor3   g120(.a(new_n270_), .b(new_n221_), .c(new_n183_), .O(z42));
  nor3   g121(.a(new_n270_), .b(new_n221_), .c(new_n180_), .O(z43));
  nand2  g122(.a(new_n220_), .b(x62), .O(new_n283_));
  nor2   g123(.a(new_n283_), .b(new_n270_), .O(z44));
