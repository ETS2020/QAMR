...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n233_, new_n234_, new_n236_, new_n239_, new_n241_, new_n243_,
  ...
  nand4  g073(.a(new_n233_), .b(new_n232_), .c(x49), .d(new_n225_), .O(new_n241_));
  inv1   g074(.a(new_n241_), .O(z31));
  nand4  g075(.a(new_n233_), .b(new_n232_), .c(x50), .d(new_n225_), .O(new_n243_));
  inv1   g076(.a(new_n243_), .O(z32));
  inv1   g077(.a(new_n162_), .O(new_n247_));
  nand2  g078(.a(x83), .b(x42), .O(new_n248_));
  nand2  g079(.a(new_n248_), .b(new_n226_), .O(new_n249_));
  inv1   g080(.a(new_n248_), .O(new_n250_));
  nand2  g081(.a(new_n250_), .b(x81), .O(new_n251_));
  aoi21  g082(.a(new_n251_), .b(new_n249_), .c(new_n229_), .O(new_n252_));
  nand2  g083(.a(new_n248_), .b(x81), .O(new_n253_));
  nand2  g084(.a(new_n250_), .b(new_n226_), .O(new_n254_));
  aoi21  g085(.a(new_n254_), .b(new_n253_), .c(new_n227_), .O(new_n255_));
  oai21  g086(.a(new_n255_), .b(new_n252_), .c(new_n247_), .O(new_n256_));
  nand2  g087(.a(new_n233_), .b(x53), .O(new_n257_));
  nor2   g088(.a(new_n257_), .b(new_n256_), .O(z35));
  nand2  g089(.a(new_n233_), .b(x54), .O(new_n259_));
  nor2   g090(.a(new_n259_), .b(new_n256_), .O(z36));
  nand2  g091(.a(new_n233_), .b(x55), .O(new_n261_));
  nor2   g092(.a(new_n261_), .b(new_n256_), .O(z37));
  nand2  g093(.a(new_n233_), .b(x56), .O(new_n263_));
