...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n233_, new_n235_, new_n237_, new_n239_, new_n241_,
    new_n243_, new_n245_, new_n249_, new_n250_, new_n251_, new_n252_,
    new_n253_, new_n254_, new_n255_, new_n256_, new_n257_, new_n258_,
    new_n259_, new_n261_, new_n263_, new_n266_, new_n276_, new_n277_,
  ...
  nand4  g067(.a(new_n230_), .b(new_n220_), .c(x44), .d(new_n223_), .O(new_n233_));
  inv1   g068(.a(new_n233_), .O(z26));
  nand4  g069(.a(new_n230_), .b(new_n220_), .c(x45), .d(new_n223_), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(z27));
  nand4  g071(.a(new_n230_), .b(new_n220_), .c(x46), .d(new_n223_), .O(new_n237_));
  inv1   g072(.a(new_n237_), .O(z28));
  nand4  g073(.a(new_n230_), .b(new_n220_), .c(x47), .d(new_n223_), .O(new_n239_));
  inv1   g074(.a(new_n239_), .O(z29));
  nand4  g075(.a(new_n230_), .b(new_n220_), .c(x48), .d(new_n223_), .O(new_n241_));
  inv1   g076(.a(new_n241_), .O(z30));
  nand4  g077(.a(new_n230_), .b(new_n220_), .c(x49), .d(new_n223_), .O(new_n243_));
  inv1   g078(.a(new_n243_), .O(z31));
  nand4  g079(.a(new_n230_), .b(new_n220_), .c(x50), .d(new_n223_), .O(new_n245_));
  ...
  nand2  g091(.a(new_n220_), .b(x53), .O(new_n259_));
  nor2   g092(.a(new_n259_), .b(new_n258_), .O(z35));
  nand2  g093(.a(new_n220_), .b(x54), .O(new_n261_));
  nor2   g094(.a(new_n261_), .b(new_n258_), .O(z36));
  nand2  g095(.a(new_n220_), .b(x55), .O(new_n263_));
  nor2   g096(.a(new_n263_), .b(new_n258_), .O(z37));
  nand2  g097(.a(new_n220_), .b(x57), .O(new_n266_));
  ...
  nand2  g103(.a(new_n279_), .b(new_n214_), .O(new_n280_));
  inv1   g104(.a(new_n280_), .O(new_n281_));
  nand2  g105(.a(new_n281_), .b(new_n278_), .O(new_n282_));
  nor3   g106(.a(new_n202_), .b(new_n169_), .c(new_n154_), .O(new_n283_));
  ...
  nand3  g141(.a(new_n318_), .b(new_n220_), .c(new_n161_), .O(new_n319_));
  ...
  aoi22  g145(.a(new_n322_), .b(new_n153_), .c(new_n218_), .d(x76), .O(new_n323_));
  ...
  aoi21  g153(.a(new_n213_), .b(new_n331_), .c(new_n152_), .O(new_n332_));
  oai21  g154(.a(new_n209_), .b(new_n207_), .c(new_n223_), .O(new_n333_));
  aoi21  g155(.a(new_n333_), .b(x79), .c(new_n213_), .O(new_n334_));
  ...
  aoi21  g161(.a(new_n339_), .b(new_n215_), .c(x01), .O(z60));
  aoi21  g162(.a(new_n169_), .b(new_n168_), .c(new_n202_), .O(new_n344_));
  nor2   g163(.a(new_n218_), .b(x04), .O(new_n345_));
  nor2   g164(.a(new_n206_), .b(new_n154_), .O(new_n346_));
  oai21  g165(.a(new_n345_), .b(new_n344_), .c(new_n346_), .O(new_n347_));
  aoi21  g166(.a(new_n347_), .b(new_n280_), .c(x01), .O(z64));
  zero   g167(.O(z03));
  zero   g168(.O(z05));
  zero   g169(.O(z06));
  zero   g170(.O(z07));
