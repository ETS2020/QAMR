...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n233_, new_n237_, new_n239_, new_n241_, new_n245_, new_n246_,
  ...
  nor2   g159(.a(new_n160_), .b(x04), .O(new_n345_));
  nor2   g160(.a(new_n222_), .b(x78), .O(new_n346_));
  oai21  g161(.a(new_n346_), .b(new_n345_), .c(x77), .O(new_n347_));
  nand3  g162(.a(x81), .b(x78), .c(new_n159_), .O(new_n348_));
  nand2  g163(.a(new_n171_), .b(x84), .O(new_n349_));
  aoi21  g164(.a(new_n348_), .b(new_n347_), .c(new_n349_), .O(z65));
  zero   g165(.O(z03));
  zero   g166(.O(z05));
  zero   g167(.O(z06));
  zero   g168(.O(z07));
