...
module FAU ( 
  ...
  nand4  g107(.a(new_n253_), .b(new_n240_), .c(x50), .d(new_n244_), .O(new_n265_));
  ...
  nand2  g118(.a(new_n275_), .b(new_n240_), .O(new_n276_));
  ...
  nand2  g125(.a(new_n279_), .b(x81), .O(new_n283_));
  nand3  g126(.a(x83), .b(new_n248_), .c(x42), .O(new_n284_));
  aoi21  g127(.a(new_n284_), .b(new_n283_), .c(new_n245_), .O(new_n285_));
  oai21  g128(.a(new_n285_), .b(new_n282_), .c(new_n275_), .O(new_n286_));
  nor3   g129(.a(new_n286_), .b(new_n241_), .c(new_n278_), .O(z34));
  ...
  nor2   g135(.a(new_n293_), .b(new_n286_), .O(z38));
  nor3   g136(.a(new_n286_), .b(new_n241_), .c(new_n197_), .O(z39));
  nor3   g137(.a(new_n286_), .b(new_n241_), .c(new_n194_), .O(z40));
  nor3   g138(.a(new_n286_), .b(new_n241_), .c(new_n191_), .O(z41));
  nor3   g139(.a(new_n286_), .b(new_n241_), .c(new_n188_), .O(z42));
  nor3   g140(.a(new_n286_), .b(new_n241_), .c(new_n185_), .O(z43));
  nor3   g141(.a(new_n286_), .b(new_n241_), .c(new_n182_), .O(z44));
  nor3   g142(.a(new_n286_), .b(new_n241_), .c(new_n179_), .O(z45));
  nor3   g143(.a(new_n286_), .b(new_n241_), .c(new_n176_), .O(z46));
  ...
  nand2  g193(.a(new_n278_), .b(x14), .O(new_n352_));
