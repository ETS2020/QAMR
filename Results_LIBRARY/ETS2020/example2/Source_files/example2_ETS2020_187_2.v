...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n210_, new_n211_, new_n212_, new_n219_, new_n220_, new_n221_,
    ...
    new_n256_, new_n266_, new_n267_, new_n268_, new_n269_, new_n270_,
  ...
  inv1   g049(.a(x42), .O(new_n219_));
  inv1   g050(.a(x81), .O(new_n220_));
  xor2a  g051(.a(x84), .b(x82), .O(new_n221_));
  nor2   g052(.a(new_n221_), .b(new_n220_), .O(new_n222_));
  xnor2a g053(.a(x84), .b(x82), .O(new_n223_));
  nor2   g054(.a(new_n223_), .b(x81), .O(new_n224_));
  nor2   g055(.a(new_n224_), .b(new_n222_), .O(new_n225_));
  nor2   g056(.a(new_n225_), .b(new_n156_), .O(new_n226_));
  nor2   g057(.a(x04), .b(x01), .O(new_n227_));
  nand4  g058(.a(new_n227_), .b(new_n226_), .c(x46), .d(new_n219_), .O(new_n228_));
  inv1   g059(.a(new_n228_), .O(z28));
  nand4  g060(.a(new_n227_), .b(new_n226_), .c(x47), .d(new_n219_), .O(new_n230_));
  inv1   g061(.a(new_n230_), .O(z29));
  nand4  g062(.a(new_n227_), .b(new_n226_), .c(x48), .d(new_n219_), .O(new_n232_));
  inv1   g063(.a(new_n232_), .O(z30));
  nand4  g064(.a(new_n227_), .b(new_n226_), .c(x49), .d(new_n219_), .O(new_n234_));
  inv1   g065(.a(new_n234_), .O(z31));
  nand4  g066(.a(new_n227_), .b(new_n226_), .c(x50), .d(new_n219_), .O(new_n236_));
  inv1   g067(.a(new_n236_), .O(z32));
  inv1   g068(.a(new_n156_), .O(new_n240_));
  nand2  g069(.a(x83), .b(x42), .O(new_n241_));
  nand2  g070(.a(new_n241_), .b(new_n220_), .O(new_n242_));
  inv1   g071(.a(new_n241_), .O(new_n243_));
  nand2  g072(.a(new_n243_), .b(x81), .O(new_n244_));
  aoi21  g073(.a(new_n244_), .b(new_n242_), .c(new_n223_), .O(new_n245_));
  nand2  g074(.a(new_n241_), .b(x81), .O(new_n246_));
  nand2  g075(.a(new_n243_), .b(new_n220_), .O(new_n247_));
  aoi21  g076(.a(new_n247_), .b(new_n246_), .c(new_n221_), .O(new_n248_));
  oai21  g077(.a(new_n248_), .b(new_n245_), .c(new_n240_), .O(new_n249_));
  nand2  g078(.a(new_n227_), .b(x53), .O(new_n250_));
  nor2   g079(.a(new_n250_), .b(new_n249_), .O(z35));
  nand2  g080(.a(new_n227_), .b(x54), .O(new_n252_));
  nor2   g081(.a(new_n252_), .b(new_n249_), .O(z36));
  nand2  g082(.a(new_n227_), .b(x55), .O(new_n254_));
  nor2   g083(.a(new_n254_), .b(new_n249_), .O(z37));
  nand2  g084(.a(new_n227_), .b(x56), .O(new_n256_));
  ...
  nand3  g137(.a(new_n317_), .b(new_n227_), .c(new_n155_), .O(new_n318_));
  ...
  oai21  g152(.a(new_n206_), .b(new_n204_), .c(new_n219_), .O(new_n334_));
