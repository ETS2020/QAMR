...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n271_, new_n275_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  inv1   g133(.a(x10), .O(new_n298_));
  nand2  g134(.a(x52), .b(x18), .O(new_n299_));
  oai21  g135(.a(x52), .b(new_n298_), .c(new_n299_), .O(new_n300_));
  nand2  g136(.a(new_n300_), .b(new_n289_), .O(new_n301_));
  nor2   g137(.a(new_n162_), .b(x78), .O(new_n302_));
  nand4  g138(.a(new_n302_), .b(new_n291_), .c(x77), .d(x70), .O(new_n303_));
  aoi21  g139(.a(new_n303_), .b(new_n301_), .c(x01), .O(z50));
  nand2  g140(.a(x52), .b(x22), .O(new_n308_));
  nand2  g141(.a(new_n260_), .b(x14), .O(new_n309_));
  nor2   g142(.a(new_n154_), .b(x77), .O(new_n310_));
  nand4  g143(.a(new_n310_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n311_));
  aoi21  g144(.a(new_n309_), .b(new_n308_), .c(new_n311_), .O(z54));
  inv1   g145(.a(x82), .O(new_n313_));
  nand3  g146(.a(new_n247_), .b(x84), .c(new_n313_), .O(new_n314_));
  inv1   g147(.a(x80), .O(new_n315_));
  nand4  g148(.a(new_n222_), .b(new_n163_), .c(new_n315_), .d(x79), .O(new_n316_));
  nor2   g149(.a(new_n316_), .b(new_n314_), .O(z55));
  aoi21  g150(.a(x84), .b(new_n229_), .c(x76), .O(new_n318_));
  oai21  g151(.a(x84), .b(new_n229_), .c(new_n318_), .O(new_n319_));
  nand2  g152(.a(new_n319_), .b(new_n164_), .O(new_n320_));
  nand4  g153(.a(new_n320_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g154(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n323_));
  inv1   g155(.a(x74), .O(new_n324_));
  nand4  g156(.a(x80), .b(new_n324_), .c(x43), .d(new_n225_), .O(new_n325_));
  oai22  g157(.a(new_n325_), .b(new_n323_), .c(new_n225_), .d(x40), .O(new_n326_));
  nand2  g158(.a(x78), .b(x04), .O(new_n327_));
  inv1   g159(.a(new_n327_), .O(new_n328_));
  nand3  g160(.a(new_n328_), .b(new_n326_), .c(x79), .O(new_n329_));
  nand4  g161(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n330_));
  nand2  g162(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand2  g163(.a(new_n331_), .b(x77), .O(new_n332_));
  oai21  g164(.a(new_n310_), .b(new_n218_), .c(new_n162_), .O(new_n333_));
  aoi21  g165(.a(new_n333_), .b(new_n332_), .c(x01), .O(z58));
  aoi21  g166(.a(new_n327_), .b(x79), .c(new_n152_), .O(new_n335_));
  nand3  g167(.a(x80), .b(new_n324_), .c(x43), .O(new_n336_));
  oai21  g168(.a(new_n336_), .b(new_n323_), .c(new_n225_), .O(new_n337_));
  aoi21  g169(.a(new_n337_), .b(x79), .c(new_n327_), .O(new_n338_));
  oai21  g170(.a(new_n338_), .b(new_n335_), .c(x77), .O(new_n339_));
  nand2  g171(.a(new_n162_), .b(new_n218_), .O(new_n340_));
  aoi21  g172(.a(new_n340_), .b(new_n339_), .c(x01), .O(z59));
  oai21  g173(.a(new_n310_), .b(new_n293_), .c(new_n291_), .O(new_n343_));
  nand2  g174(.a(new_n163_), .b(new_n218_), .O(new_n344_));
  nand2  g175(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  inv1   g176(.a(new_n345_), .O(new_n346_));
  nor2   g177(.a(new_n162_), .b(x01), .O(new_n347_));
  inv1   g178(.a(new_n347_), .O(new_n348_));
  nor3   g179(.a(new_n348_), .b(new_n346_), .c(new_n315_), .O(z61));
  nand3  g180(.a(x84), .b(x81), .c(x79), .O(new_n350_));
  oai21  g181(.a(x79), .b(new_n218_), .c(new_n350_), .O(new_n351_));
  nand2  g182(.a(new_n351_), .b(new_n160_), .O(new_n352_));
  nand2  g183(.a(new_n337_), .b(x79), .O(new_n353_));
  nand3  g184(.a(x81), .b(x79), .c(new_n218_), .O(new_n354_));
  inv1   g185(.a(new_n354_), .O(new_n355_));
  aoi21  g186(.a(new_n353_), .b(x04), .c(new_n355_), .O(new_n356_));
  oai21  g187(.a(new_n356_), .b(new_n160_), .c(new_n352_), .O(new_n357_));
  nand2  g188(.a(new_n357_), .b(x78), .O(new_n358_));
  inv1   g189(.a(new_n350_), .O(new_n359_));
  nand2  g190(.a(new_n359_), .b(new_n293_), .O(new_n360_));
  aoi21  g191(.a(new_n360_), .b(new_n358_), .c(x01), .O(z62));
  nor3   g192(.a(new_n348_), .b(new_n346_), .c(new_n313_), .O(z63));
  nand3  g193(.a(new_n345_), .b(x83), .c(x79), .O(new_n363_));
  aoi21  g194(.a(new_n363_), .b(new_n288_), .c(x01), .O(z64));
  nor2   g195(.a(new_n154_), .b(x04), .O(new_n365_));
  nor2   g196(.a(new_n229_), .b(x78), .O(new_n366_));
  oai21  g197(.a(new_n366_), .b(new_n365_), .c(x77), .O(new_n367_));
  nand2  g198(.a(new_n310_), .b(x81), .O(new_n368_));
  nand2  g199(.a(new_n347_), .b(x84), .O(new_n369_));
  aoi21  g200(.a(new_n368_), .b(new_n367_), .c(new_n369_), .O(z65));
  zero   g201(.O(z02));
  zero   g202(.O(z04));
  zero   g203(.O(z15));
  zero   g204(.O(z21));
