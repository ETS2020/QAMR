// Benchmark "FAU" written by ABC on Sat Jun 27 01:49:38 2020
...
module FAU ( 
  ...
  nand2  g092(.a(new_n230_), .b(x62), .O(new_n268_));
  nor2   g093(.a(new_n268_), .b(new_n255_), .O(z44));
  ...
  oai21  g159(.a(new_n211_), .b(new_n209_), .c(new_n222_), .O(new_n339_));
  ...
  nor2   g173(.a(new_n223_), .b(x78), .O(new_n356_));
