// Benchmark "FAU" written by ABC on Sat Jun 27 01:57:58 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n176_, new_n183_, new_n184_, new_n188_, new_n189_,
    ...
    new_n259_, new_n260_, new_n263_, new_n265_, new_n275_, new_n276_,
  ...
  nand2  g084(.a(new_n251_), .b(new_n228_), .O(new_n252_));
  inv1   g085(.a(new_n251_), .O(new_n253_));
  nand2  g086(.a(new_n253_), .b(x81), .O(new_n254_));
  aoi21  g087(.a(new_n254_), .b(new_n252_), .c(new_n231_), .O(new_n255_));
  nand2  g088(.a(new_n251_), .b(x81), .O(new_n256_));
  nand2  g089(.a(new_n253_), .b(new_n228_), .O(new_n257_));
  aoi21  g090(.a(new_n257_), .b(new_n256_), .c(new_n229_), .O(new_n258_));
  oai21  g091(.a(new_n258_), .b(new_n255_), .c(new_n250_), .O(new_n259_));
  nand2  g092(.a(new_n235_), .b(x53), .O(new_n260_));
