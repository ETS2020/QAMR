...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n176_, new_n177_, new_n186_, new_n187_, new_n189_, new_n190_,
    ...
    new_n259_, new_n261_, new_n263_, new_n267_, new_n276_, new_n277_,
  ...
  nand4  g069(.a(new_n231_), .b(new_n230_), .c(x44), .d(new_n223_), .O(new_n234_));
  inv1   g070(.a(new_n234_), .O(z26));
  nand4  g071(.a(new_n231_), .b(new_n230_), .c(x45), .d(new_n223_), .O(new_n236_));
  ...
  nand2  g097(.a(new_n231_), .b(x58), .O(new_n267_));
  nor2   g098(.a(new_n267_), .b(new_n258_), .O(z40));
