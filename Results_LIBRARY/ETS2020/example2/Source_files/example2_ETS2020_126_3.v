// Benchmark "FAU" written by ABC on Sat Jun 27 01:58:38 2020
...
module FAU ( 
  ...
  inv1   g081(.a(new_n155_), .O(new_n236_));
  ...
  inv1   g120(.a(new_n238_), .O(new_n277_));
  ...
  nand2  g127(.a(new_n263_), .b(x42), .O(new_n284_));
  ...
  nor3   g139(.a(new_n286_), .b(new_n277_), .c(new_n197_), .O(z39));
  nor3   g140(.a(new_n286_), .b(new_n277_), .c(new_n194_), .O(z40));
  nor3   g141(.a(new_n286_), .b(new_n277_), .c(new_n191_), .O(z41));
  nor3   g142(.a(new_n286_), .b(new_n277_), .c(new_n188_), .O(z42));
  nor3   g143(.a(new_n286_), .b(new_n277_), .c(new_n185_), .O(z43));
  nor3   g144(.a(new_n286_), .b(new_n277_), .c(new_n182_), .O(z44));
  nor3   g145(.a(new_n286_), .b(new_n277_), .c(new_n179_), .O(z45));
  nor3   g146(.a(new_n286_), .b(new_n277_), .c(new_n176_), .O(z46));
  ...
  nand2  g198(.a(new_n276_), .b(x14), .O(new_n355_));
  ...
  nand3  g202(.a(new_n263_), .b(x84), .c(new_n358_), .O(new_n359_));
  nor2   g203(.a(x80), .b(new_n157_), .O(new_n360_));
  nand3  g204(.a(new_n360_), .b(new_n238_), .c(new_n155_), .O(new_n361_));
  ...
  nand4  g209(.a(x80), .b(new_n225_), .c(x43), .d(new_n242_), .O(new_n367_));
  oai22  g210(.a(new_n367_), .b(new_n224_), .c(new_n242_), .d(x40), .O(new_n368_));
  nand3  g211(.a(new_n368_), .b(new_n230_), .c(x79), .O(new_n369_));
  nand4  g212(.a(new_n157_), .b(new_n154_), .c(new_n242_), .d(x40), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g215(.a(new_n161_), .b(new_n233_), .c(new_n157_), .O(new_n373_));
  aoi21  g216(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  aoi21  g217(.a(new_n229_), .b(x79), .c(new_n175_), .O(new_n375_));
  oai21  g218(.a(new_n226_), .b(new_n224_), .c(new_n242_), .O(new_n376_));
  aoi21  g219(.a(new_n376_), .b(x79), .c(new_n229_), .O(new_n377_));
  ...
  aoi21  g227(.a(new_n384_), .b(new_n231_), .c(x01), .O(z60));
  nand3  g228(.a(x84), .b(x81), .c(x79), .O(new_n387_));
  oai21  g229(.a(x79), .b(new_n233_), .c(new_n387_), .O(new_n388_));
  nand2  g230(.a(new_n388_), .b(new_n153_), .O(new_n389_));
  nand2  g231(.a(new_n376_), .b(x79), .O(new_n390_));
  nand3  g232(.a(x81), .b(x79), .c(new_n233_), .O(new_n391_));
  inv1   g233(.a(new_n391_), .O(new_n392_));
  aoi21  g234(.a(new_n390_), .b(x04), .c(new_n392_), .O(new_n393_));
  oai21  g235(.a(new_n393_), .b(new_n153_), .c(new_n389_), .O(new_n394_));
  nand2  g236(.a(new_n394_), .b(x78), .O(new_n395_));
  inv1   g237(.a(new_n387_), .O(new_n396_));
  nand2  g238(.a(new_n396_), .b(new_n163_), .O(new_n397_));
  aoi21  g239(.a(new_n397_), .b(new_n395_), .c(x01), .O(z62));
  oai21  g240(.a(new_n163_), .b(new_n161_), .c(new_n220_), .O(new_n399_));
  oai21  g241(.a(new_n236_), .b(x04), .c(new_n399_), .O(new_n400_));
  nand2  g242(.a(new_n166_), .b(x82), .O(new_n401_));
  inv1   g243(.a(new_n401_), .O(new_n402_));
  and2   g244(.a(new_n402_), .b(new_n400_), .O(z63));
  nand3  g245(.a(new_n400_), .b(x83), .c(x79), .O(new_n404_));
  aoi21  g246(.a(new_n404_), .b(new_n308_), .c(x01), .O(z64));
  nor2   g247(.a(new_n154_), .b(x04), .O(new_n406_));
  nor2   g248(.a(new_n246_), .b(x78), .O(new_n407_));
  oai21  g249(.a(new_n407_), .b(new_n406_), .c(x77), .O(new_n408_));
  nand2  g250(.a(new_n161_), .b(x81), .O(new_n409_));
  nand2  g251(.a(new_n166_), .b(x84), .O(new_n410_));
  aoi21  g252(.a(new_n409_), .b(new_n408_), .c(new_n410_), .O(z65));
  zero   g253(.O(z00));
  zero   g254(.O(z14));
  zero   g255(.O(z16));
  zero   g256(.O(z25));
