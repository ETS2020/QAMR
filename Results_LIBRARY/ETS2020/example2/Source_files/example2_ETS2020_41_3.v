// Benchmark "FAU" written by ABC on Sat Jun 27 01:52:22 2020
...
module FAU ( 
  ...
  nor3   g136(.a(new_n284_), .b(new_n238_), .c(new_n196_), .O(z39));
  nor3   g137(.a(new_n284_), .b(new_n238_), .c(new_n193_), .O(z40));
  nor3   g138(.a(new_n284_), .b(new_n238_), .c(new_n190_), .O(z41));
  nor3   g139(.a(new_n284_), .b(new_n238_), .c(new_n187_), .O(z42));
  nor3   g140(.a(new_n284_), .b(new_n238_), .c(new_n184_), .O(z43));
  nor3   g141(.a(new_n284_), .b(new_n238_), .c(new_n181_), .O(z44));
  nor3   g142(.a(new_n284_), .b(new_n238_), .c(new_n178_), .O(z45));
  nor3   g143(.a(new_n284_), .b(new_n238_), .c(new_n175_), .O(z46));
  ...
  nand4  g209(.a(new_n157_), .b(new_n154_), .c(new_n240_), .d(x40), .O(new_n368_));
  ...
  aoi21  g214(.a(new_n228_), .b(x79), .c(new_n174_), .O(new_n373_));
  oai21  g215(.a(new_n225_), .b(new_n223_), .c(new_n240_), .O(new_n374_));
