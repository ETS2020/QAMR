// Benchmark "FAU" written by ABC on Sat Jun 27 01:56:25 2020
...
module FAU ( 
  ...
  nor3   g138(.a(new_n285_), .b(new_n238_), .c(new_n198_), .O(z39));
  nor3   g139(.a(new_n285_), .b(new_n238_), .c(new_n195_), .O(z40));
  nor3   g140(.a(new_n285_), .b(new_n238_), .c(new_n192_), .O(z41));
  nor3   g141(.a(new_n285_), .b(new_n238_), .c(new_n189_), .O(z42));
  nor3   g142(.a(new_n285_), .b(new_n238_), .c(new_n186_), .O(z43));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n183_), .O(z44));
  nor3   g144(.a(new_n285_), .b(new_n238_), .c(new_n180_), .O(z45));
  nor3   g145(.a(new_n285_), .b(new_n238_), .c(new_n177_), .O(z46));
