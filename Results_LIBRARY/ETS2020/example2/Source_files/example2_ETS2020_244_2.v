...
module FAU ( 
  ...
  nand2  g095(.a(new_n233_), .b(x56), .O(new_n264_));
  ...
  nand3  g139(.a(new_n317_), .b(new_n233_), .c(new_n161_), .O(new_n318_));
  ...
  oai21  g153(.a(new_n213_), .b(new_n211_), .c(new_n225_), .O(new_n333_));
