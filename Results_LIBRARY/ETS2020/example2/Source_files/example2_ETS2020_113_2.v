...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n176_, new_n187_, new_n188_, new_n191_, new_n192_,
    new_n194_, new_n195_, new_n197_, new_n198_, new_n200_, new_n201_,
    new_n203_, new_n204_, new_n206_, new_n207_, new_n208_, new_n209_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n223_, new_n224_,
    new_n225_, new_n226_, new_n227_, new_n228_, new_n229_, new_n230_,
    new_n231_, new_n232_, new_n234_, new_n236_, new_n240_, new_n242_,
    ...
    new_n351_, new_n352_, new_n353_, new_n357_;
  ...
  nand2  g170(.a(new_n169_), .b(new_n168_), .O(new_n349_));
  nand2  g171(.a(new_n349_), .b(new_n207_), .O(new_n350_));
  oai21  g172(.a(new_n328_), .b(x04), .c(new_n350_), .O(new_n351_));
  nand2  g173(.a(new_n171_), .b(x80), .O(new_n352_));
  inv1   g174(.a(new_n352_), .O(new_n353_));
  and2   g175(.a(new_n353_), .b(new_n351_), .O(z61));
  nand3  g176(.a(new_n351_), .b(x83), .c(x79), .O(new_n357_));
  aoi21  g177(.a(new_n357_), .b(new_n278_), .c(x01), .O(z64));
  zero   g178(.O(z03));
  zero   g179(.O(z06));
  zero   g180(.O(z07));
  zero   g181(.O(z08));
