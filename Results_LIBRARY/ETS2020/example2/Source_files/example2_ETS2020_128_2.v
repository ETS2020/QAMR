...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n173_, new_n185_, new_n186_, new_n188_, new_n189_, new_n191_,
    ...
    new_n231_, new_n232_, new_n233_, new_n237_, new_n239_, new_n241_,
  ...
  inv1   g030(.a(x34), .O(new_n191_));
  nand2  g031(.a(x49), .b(x40), .O(new_n192_));
  oai21  g032(.a(x40), .b(new_n191_), .c(new_n192_), .O(z16));
  ...
  nand4  g073(.a(new_n232_), .b(new_n231_), .c(x47), .d(new_n224_), .O(new_n239_));
  inv1   g074(.a(new_n239_), .O(z29));
  nand4  g075(.a(new_n232_), .b(new_n231_), .c(x48), .d(new_n224_), .O(new_n241_));
  inv1   g076(.a(new_n241_), .O(z30));
  nand4  g077(.a(new_n232_), .b(new_n231_), .c(x49), .d(new_n224_), .O(new_n243_));
  inv1   g078(.a(new_n243_), .O(z31));
  nand4  g079(.a(new_n232_), .b(new_n231_), .c(x50), .d(new_n224_), .O(new_n245_));
  inv1   g080(.a(new_n245_), .O(z32));
  inv1   g081(.a(new_n162_), .O(new_n249_));
  nand2  g082(.a(x83), .b(x42), .O(new_n250_));
  nand2  g083(.a(new_n250_), .b(new_n225_), .O(new_n251_));
  inv1   g084(.a(new_n250_), .O(new_n252_));
  nand2  g085(.a(new_n252_), .b(x81), .O(new_n253_));
  aoi21  g086(.a(new_n253_), .b(new_n251_), .c(new_n228_), .O(new_n254_));
  nand2  g087(.a(new_n250_), .b(x81), .O(new_n255_));
  nand2  g088(.a(new_n252_), .b(new_n225_), .O(new_n256_));
  aoi21  g089(.a(new_n256_), .b(new_n255_), .c(new_n226_), .O(new_n257_));
  oai21  g090(.a(new_n257_), .b(new_n254_), .c(new_n249_), .O(new_n258_));
  nand2  g091(.a(new_n232_), .b(x53), .O(new_n259_));
  nor2   g092(.a(new_n259_), .b(new_n258_), .O(z35));
  nand2  g093(.a(new_n232_), .b(x54), .O(new_n261_));
  nor2   g094(.a(new_n261_), .b(new_n258_), .O(z36));
  nand2  g095(.a(new_n232_), .b(x55), .O(new_n263_));
  nor2   g096(.a(new_n263_), .b(new_n258_), .O(z37));
  nand2  g097(.a(new_n232_), .b(x56), .O(new_n265_));
  ...
  nand2  g103(.a(new_n279_), .b(new_n219_), .O(new_n280_));
  inv1   g104(.a(new_n280_), .O(new_n281_));
  nand2  g105(.a(new_n281_), .b(new_n278_), .O(new_n282_));
  nor3   g106(.a(new_n207_), .b(new_n169_), .c(new_n154_), .O(new_n283_));
  ...
  nand3  g141(.a(new_n318_), .b(new_n232_), .c(new_n161_), .O(new_n319_));
  ...
  aoi21  g154(.a(new_n218_), .b(new_n332_), .c(new_n152_), .O(new_n333_));
  oai21  g155(.a(new_n214_), .b(new_n212_), .c(new_n224_), .O(new_n334_));
  aoi21  g156(.a(new_n334_), .b(x79), .c(new_n218_), .O(new_n335_));
  ...
  aoi21  g162(.a(new_n340_), .b(new_n220_), .c(x01), .O(z60));
  aoi21  g163(.a(new_n169_), .b(new_n168_), .c(new_n207_), .O(new_n345_));
  nor2   g164(.a(new_n321_), .b(x04), .O(new_n346_));
  nor2   g165(.a(new_n211_), .b(new_n154_), .O(new_n347_));
