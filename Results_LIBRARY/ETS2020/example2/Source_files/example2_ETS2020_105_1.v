...
module FAU ( 
  ...
  nor3   g125(.a(new_n273_), .b(new_n225_), .c(new_n194_), .O(z39));
  nor3   g126(.a(new_n273_), .b(new_n225_), .c(new_n191_), .O(z40));
  nor3   g127(.a(new_n273_), .b(new_n225_), .c(new_n188_), .O(z41));
  nor3   g128(.a(new_n273_), .b(new_n225_), .c(new_n185_), .O(z42));
  nor3   g129(.a(new_n273_), .b(new_n225_), .c(new_n182_), .O(z43));
  nor3   g130(.a(new_n273_), .b(new_n225_), .c(new_n179_), .O(z44));
  nor3   g131(.a(new_n273_), .b(new_n225_), .c(new_n176_), .O(z45));
  nor3   g132(.a(new_n273_), .b(new_n225_), .c(new_n173_), .O(z46));
  ...
  nand2  g145(.a(new_n264_), .b(x14), .O(new_n309_));
  ...
  nand3  g150(.a(new_n251_), .b(x84), .c(new_n313_), .O(new_n314_));
  ...
  nand4  g158(.a(x84), .b(new_n250_), .c(x82), .d(x81), .O(new_n323_));
