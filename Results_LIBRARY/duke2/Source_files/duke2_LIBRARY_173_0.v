...
module FAU ( 
  ...
  nor2   g077(.a(new_n128_), .b(new_n113_), .O(new_n129_));
  ...
  oai22  g140(.a(new_n159_), .b(new_n99_), .c(new_n114_), .d(new_n124_), .O(new_n193_));
  ...
  nor2   g171(.a(new_n113_), .b(x04), .O(new_n224_));
  ...
  nor3   g237(.a(new_n288_), .b(new_n113_), .c(x04), .O(new_n290_));
  ...
  nor4   g248(.a(new_n112_), .b(x15), .c(x09), .d(new_n99_), .O(new_n301_));
