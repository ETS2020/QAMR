...
module FAU ( 
  ...
  nand4  g386(.a(x19), .b(x18), .c(new_n154_), .d(x09), .O(new_n438_));
  nand3  g387(.a(new_n104_), .b(new_n52_), .c(x03), .O(new_n439_));
  oai21  g388(.a(new_n439_), .b(new_n438_), .c(new_n437_), .O(z27));
  ...
  nand4  g396(.a(new_n447_), .b(new_n445_), .c(new_n259_), .d(new_n177_), .O(new_n448_));
  ...
  nor3   g402(.a(new_n208_), .b(new_n446_), .c(new_n92_), .O(new_n454_));
  ...
  oai21  g409(.a(new_n73_), .b(new_n75_), .c(new_n304_), .O(new_n461_));
  nor2   g410(.a(new_n461_), .b(new_n460_), .O(new_n462_));
  oai21  g411(.a(new_n462_), .b(new_n459_), .c(new_n154_), .O(new_n463_));
  aoi21  g412(.a(new_n148_), .b(new_n121_), .c(new_n327_), .O(new_n464_));
  oai21  g413(.a(new_n464_), .b(new_n307_), .c(new_n463_), .O(z28));
endmodule
