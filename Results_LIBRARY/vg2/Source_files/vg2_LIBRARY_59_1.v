...
module FAU ( 
  ...
  nand2  g037(.a(new_n52_), .b(x21), .O(new_n71_));
  nand2  g038(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g039(.a(x04), .b(x03), .O(new_n73_));
  nand2  g040(.a(x08), .b(x06), .O(new_n74_));
  nand2  g041(.a(x11), .b(x09), .O(new_n75_));
  ...
  nor2   g053(.a(new_n66_), .b(new_n47_), .O(new_n87_));
  and2   g054(.a(x20), .b(x18), .O(new_n88_));
  nor2   g055(.a(new_n62_), .b(new_n61_), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x17), .O(new_n90_));
  inv1   g057(.a(x07), .O(new_n91_));
  nor2   g058(.a(x12), .b(new_n91_), .O(new_n92_));
  nor2   g059(.a(x23), .b(x22), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n57_), .d(new_n49_), .O(new_n94_));
  inv1   g061(.a(x04), .O(new_n95_));
  nor2   g062(.a(x16), .b(x14), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n48_), .c(new_n60_), .d(new_n95_), .O(new_n97_));
  ...
  nand3  g069(.a(new_n102_), .b(new_n89_), .c(new_n87_), .O(new_n103_));
  nor2   g070(.a(x14), .b(x12), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n93_), .c(new_n57_), .d(new_n49_), .O(new_n105_));
  nor2   g072(.a(x17), .b(x16), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n48_), .c(x19), .d(new_n95_), .O(new_n107_));
  oai22  g074(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n86_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n39_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n100_), .c(new_n82_), .O(z1));
  ...
  nand3  g080(.a(new_n52_), .b(new_n36_), .c(x21), .O(new_n114_));
  ...
  nor2   g089(.a(new_n122_), .b(new_n118_), .O(z2));
  inv1   g090(.a(x08), .O(new_n124_));
  nand4  g091(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n124_), .O(new_n125_));
  aoi21  g092(.a(new_n54_), .b(new_n53_), .c(new_n125_), .O(new_n126_));
  inv1   g093(.a(x20), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n121_), .c(x11), .d(x08), .O(new_n129_));
  aoi21  g096(.a(new_n71_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n126_), .c(new_n36_), .O(new_n131_));
  nand2  g098(.a(new_n48_), .b(new_n120_), .O(new_n132_));
  nand4  g099(.a(new_n47_), .b(new_n64_), .c(new_n124_), .d(x07), .O(new_n133_));
  nand3  g100(.a(x08), .b(x06), .c(x03), .O(new_n134_));
  nand4  g101(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n132_), .O(new_n136_));
  nand4  g103(.a(x19), .b(new_n47_), .c(new_n64_), .d(new_n124_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n134_), .c(new_n137_), .d(new_n132_), .O(new_n139_));
  ...
  aoi21  g111(.a(new_n144_), .b(new_n66_), .c(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n95_), .c(new_n60_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n61_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n124_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n118_), .c(new_n145_), .d(new_n46_), .O(z4));
  inv1   g116(.a(new_n46_), .O(z5));
  oai21  g117(.a(new_n127_), .b(x14), .c(new_n120_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n64_), .c(x03), .O(new_n152_));
  oai21  g119(.a(x20), .b(new_n47_), .c(x06), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x11), .c(new_n119_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n118_), .c(new_n152_), .d(new_n46_), .O(z6));
  inv1   g122(.a(new_n118_), .O(z7));
endmodule
