...
module FAU ( 
  ...
  nand3  g035(.a(new_n68_), .b(new_n51_), .c(new_n47_), .O(new_n69_));
  ...
  nand3  g045(.a(new_n78_), .b(new_n70_), .c(new_n67_), .O(new_n79_));
  ...
  nand4  g051(.a(x23), .b(x22), .c(x14), .d(x12), .O(new_n85_));
  ...
  nor2   g058(.a(x08), .b(new_n91_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n93_));
  inv1   g060(.a(x06), .O(new_n94_));
  nor2   g061(.a(x17), .b(x16), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n47_), .c(new_n50_), .d(new_n94_), .O(new_n96_));
  oai22  g063(.a(new_n96_), .b(new_n93_), .c(new_n87_), .d(new_n84_), .O(new_n97_));
  nor2   g064(.a(new_n39_), .b(new_n36_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g066(.a(new_n86_), .b(x17), .c(x16), .d(x15), .O(new_n100_));
  nor2   g067(.a(x12), .b(x11), .O(new_n101_));
  inv1   g068(.a(x19), .O(new_n102_));
  nor2   g069(.a(x20), .b(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n101_), .c(new_n90_), .d(new_n68_), .O(new_n104_));
  nor2   g071(.a(x16), .b(x14), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n47_), .c(new_n76_), .d(new_n94_), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n104_), .c(new_n100_), .d(new_n84_), .O(new_n107_));
  nand2  g074(.a(new_n107_), .b(new_n39_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n99_), .c(new_n81_), .O(z1));
  ...
  nand3  g079(.a(new_n55_), .b(new_n36_), .c(x21), .O(new_n113_));
  ...
  nor3   g085(.a(new_n118_), .b(new_n117_), .c(new_n58_), .O(z2));
  inv1   g086(.a(x11), .O(new_n120_));
  nor2   g087(.a(new_n49_), .b(new_n120_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n83_), .c(new_n57_), .d(x20), .O(new_n122_));
  nor3   g089(.a(x20), .b(x14), .c(x08), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n67_), .c(new_n51_), .d(new_n47_), .O(new_n124_));
  ...
  nand3  g095(.a(new_n47_), .b(new_n128_), .c(x07), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n52_), .c(new_n127_), .d(new_n82_), .O(new_n130_));
  nand4  g097(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n131_));
  nand3  g098(.a(new_n51_), .b(new_n49_), .c(new_n128_), .O(new_n132_));
  nand3  g099(.a(new_n47_), .b(new_n50_), .c(x19), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n82_), .O(new_n134_));
  aoi22  g101(.a(new_n134_), .b(new_n39_), .c(new_n130_), .d(new_n98_), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(new_n126_), .O(z3));
  inv1   g103(.a(x09), .O(new_n137_));
  aoi21  g104(.a(new_n72_), .b(x04), .c(x17), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x22), .c(new_n137_), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n75_), .c(x08), .O(new_n140_));
  inv1   g107(.a(x04), .O(new_n141_));
  aoi21  g108(.a(x23), .b(new_n141_), .c(new_n76_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n71_), .c(x09), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n128_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n117_), .c(new_n140_), .d(new_n46_), .O(z4));
  inv1   g112(.a(new_n46_), .O(z5));
  oai21  g113(.a(new_n50_), .b(x14), .c(new_n94_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n120_), .c(x03), .O(new_n148_));
  inv1   g115(.a(x03), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n49_), .c(x06), .O(new_n150_));
