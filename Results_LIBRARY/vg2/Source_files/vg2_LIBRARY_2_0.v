...
module FAU ( 
  ...
  oai21  g002(.a(x24), .b(new_n34_), .c(new_n35_), .O(new_n36_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n68_), .d(new_n49_), .O(new_n95_));
  ...
  nor2   g066(.a(new_n38_), .b(new_n43_), .O(new_n100_));
  ...
  nor2   g087(.a(x24), .b(new_n120_), .O(new_n121_));
  aoi22  g088(.a(new_n121_), .b(new_n54_), .c(new_n38_), .d(x15), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  inv1   g090(.a(new_n123_), .O(new_n124_));
  inv1   g091(.a(new_n57_), .O(new_n125_));
  nor2   g092(.a(new_n78_), .b(new_n77_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n125_), .c(x11), .d(x06), .O(new_n127_));
  aoi21  g094(.a(new_n124_), .b(new_n118_), .c(new_n127_), .O(z2));
  nor2   g095(.a(new_n77_), .b(new_n47_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n130_));
  nor2   g097(.a(x08), .b(x06), .O(new_n131_));
  nor3   g098(.a(x20), .b(x14), .c(x11), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n131_), .c(new_n66_), .d(new_n48_), .O(new_n133_));
  ...
  nand3  g103(.a(new_n49_), .b(new_n47_), .c(new_n108_), .O(new_n137_));
  nand3  g104(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n86_), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n140_));
  nand3  g107(.a(new_n48_), .b(new_n77_), .c(new_n47_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n109_), .c(new_n140_), .d(new_n86_), .O(new_n142_));
  aoi22  g109(.a(new_n142_), .b(new_n38_), .c(new_n139_), .d(new_n100_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n135_), .O(z3));
  ...
  oai21  g114(.a(x13), .b(x05), .c(new_n115_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n122_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  oai21  g117(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n73_), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n108_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(z5), .O(new_n154_));
  nand4  g121(.a(new_n43_), .b(x15), .c(x13), .d(x05), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n154_), .c(new_n150_), .O(z4));
  nand2  g123(.a(x20), .b(new_n77_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n46_), .c(x11), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x03), .c(z5), .O(new_n159_));
  aoi21  g126(.a(new_n78_), .b(x14), .c(new_n46_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n47_), .c(x03), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n149_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n159_), .c(new_n155_), .O(z6));
  nand2  g130(.a(new_n124_), .b(new_n118_), .O(z7));
endmodule
