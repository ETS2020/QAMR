// Benchmark "FAU" written by ABC on Thu Jun 25 17:02:58 2020
...
module FAU ( 
  ...
  nand2  g27(.a(x19), .b(x13), .O(new_n61_));
  ...
  nand3  g48(.a(x24), .b(x18), .c(x05), .O(new_n82_));
  oai21  g49(.a(new_n81_), .b(x05), .c(new_n82_), .O(new_n83_));
  nand3  g50(.a(new_n83_), .b(new_n58_), .c(new_n55_), .O(new_n84_));
  inv1   g51(.a(new_n84_), .O(new_n85_));
  inv1   g52(.a(x19), .O(new_n86_));
  oai21  g53(.a(new_n86_), .b(x05), .c(new_n40_), .O(new_n87_));
