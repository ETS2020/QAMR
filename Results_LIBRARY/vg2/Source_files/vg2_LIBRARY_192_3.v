...
module FAU ( 
  ...
  nand4  g072(.a(new_n78_), .b(x19), .c(new_n105_), .d(new_n47_), .O(new_n106_));
  ...
  nor2   g079(.a(new_n35_), .b(new_n112_), .O(new_n113_));
  nand2  g080(.a(x15), .b(x13), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(x24), .O(new_n115_));
  oai21  g082(.a(new_n115_), .b(new_n113_), .c(x05), .O(new_n116_));
  nand3  g083(.a(new_n35_), .b(x21), .c(new_n42_), .O(new_n117_));
  aoi22  g084(.a(new_n113_), .b(x13), .c(new_n39_), .d(x15), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  inv1   g086(.a(new_n119_), .O(new_n120_));
  inv1   g087(.a(new_n57_), .O(new_n121_));
  nor2   g088(.a(new_n78_), .b(new_n77_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n121_), .c(x11), .d(x06), .O(new_n123_));
  aoi21  g090(.a(new_n120_), .b(new_n116_), .c(new_n123_), .O(z2));
  ...
  nand3  g094(.a(new_n49_), .b(new_n105_), .c(new_n47_), .O(new_n128_));
  inv1   g095(.a(new_n128_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n127_), .c(new_n66_), .d(new_n78_), .O(new_n130_));
  ...
  nand3  g100(.a(new_n50_), .b(new_n48_), .c(new_n105_), .O(new_n134_));
  ...
  nand2  g104(.a(new_n127_), .b(new_n49_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n106_), .c(new_n137_), .d(new_n86_), .O(new_n139_));
  ...
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n105_), .O(new_n145_));
  ...
  aoi21  g126(.a(new_n159_), .b(x11), .c(new_n155_), .O(new_n160_));
  nand3  g127(.a(new_n48_), .b(x07), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(new_n112_), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n98_), .O(new_n163_));
  nor2   g130(.a(new_n55_), .b(x24), .O(new_n164_));
  or2    g131(.a(new_n164_), .b(new_n39_), .O(new_n165_));
  nand3  g132(.a(x19), .b(new_n48_), .c(x06), .O(new_n166_));
  oai21  g133(.a(new_n160_), .b(new_n53_), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand2  g135(.a(x21), .b(new_n43_), .O(new_n169_));
  nand3  g136(.a(new_n48_), .b(x06), .c(x00), .O(new_n170_));
  oai21  g137(.a(new_n169_), .b(new_n160_), .c(new_n170_), .O(new_n171_));
  nor2   g138(.a(x24), .b(x02), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n168_), .c(new_n163_), .d(new_n158_), .O(z6));
endmodule
