...
module FAU ( 
  ...
  nand4  g045(.a(new_n78_), .b(new_n47_), .c(new_n77_), .d(new_n76_), .O(new_n79_));
  ...
  nor2   g054(.a(new_n78_), .b(new_n77_), .O(new_n88_));
  and2   g055(.a(x20), .b(x18), .O(new_n89_));
  nor2   g056(.a(new_n74_), .b(new_n73_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x17), .O(new_n91_));
  inv1   g058(.a(x07), .O(new_n92_));
  nor2   g059(.a(x12), .b(new_n92_), .O(new_n93_));
  nor2   g060(.a(x23), .b(x22), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n69_), .d(new_n49_), .O(new_n95_));
  nor2   g062(.a(x16), .b(x14), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n48_), .c(new_n72_), .d(new_n67_), .O(new_n97_));
  oai22  g064(.a(new_n97_), .b(new_n95_), .c(new_n91_), .d(new_n87_), .O(new_n98_));
  nor2   g065(.a(new_n39_), .b(new_n36_), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand3  g067(.a(x20), .b(x17), .c(x15), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n90_), .c(new_n88_), .O(new_n103_));
  nor2   g070(.a(x14), .b(x12), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n94_), .c(new_n69_), .d(new_n49_), .O(new_n105_));
  nor2   g072(.a(x17), .b(x16), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n48_), .c(x19), .d(new_n67_), .O(new_n107_));
  oai22  g074(.a(new_n107_), .b(new_n105_), .c(new_n103_), .d(new_n87_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n39_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n100_), .c(new_n83_), .O(z1));
  ...
  nor2   g085(.a(new_n76_), .b(new_n68_), .O(new_n119_));
  nand3  g086(.a(new_n119_), .b(new_n84_), .c(x20), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n118_), .O(z2));
  nand4  g088(.a(new_n119_), .b(new_n84_), .c(x20), .d(x08), .O(new_n122_));
  ...
  nand2  g094(.a(new_n48_), .b(new_n68_), .O(new_n128_));
  nand4  g095(.a(new_n47_), .b(new_n76_), .c(new_n124_), .d(x07), .O(new_n129_));
  nand2  g096(.a(new_n84_), .b(x06), .O(new_n130_));
  nand4  g097(.a(x20), .b(x18), .c(x11), .d(x08), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand4  g099(.a(x19), .b(new_n47_), .c(new_n76_), .d(new_n124_), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n130_), .c(new_n133_), .d(new_n128_), .O(new_n135_));
  aoi22  g102(.a(new_n135_), .b(new_n39_), .c(new_n132_), .d(new_n99_), .O(new_n136_));
  nand2  g103(.a(new_n136_), .b(new_n127_), .O(z3));
  inv1   g104(.a(x09), .O(new_n138_));
  aoi21  g105(.a(new_n74_), .b(x04), .c(x17), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n138_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n78_), .c(x08), .O(new_n141_));
  aoi21  g108(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n142_));
  ...
  aoi21  g113(.a(new_n76_), .b(x06), .c(x03), .O(new_n147_));
  inv1   g114(.a(x03), .O(new_n148_));
  oai21  g115(.a(x20), .b(new_n47_), .c(x06), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x11), .c(new_n148_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n118_), .c(new_n147_), .d(new_n46_), .O(z6));
