...
module FAU ( 
  ...
  nand3  g009(.a(new_n35_), .b(new_n42_), .c(x00), .O(new_n43_));
  ...
  nand3  g021(.a(x21), .b(new_n54_), .c(new_n42_), .O(new_n55_));
  oai21  g022(.a(new_n53_), .b(new_n52_), .c(new_n55_), .O(new_n56_));
  ...
  oai22  g032(.a(new_n53_), .b(new_n65_), .c(x02), .d(new_n64_), .O(new_n66_));
  ...
  nand4  g060(.a(new_n93_), .b(new_n92_), .c(new_n68_), .d(new_n49_), .O(new_n94_));
  ...
  nand4  g071(.a(new_n77_), .b(new_n76_), .c(new_n47_), .d(new_n104_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  inv1   g073(.a(x08), .O(new_n107_));
  nand4  g074(.a(new_n78_), .b(x19), .c(new_n107_), .d(new_n46_), .O(new_n108_));
  ...
  inv1   g080(.a(x05), .O(new_n114_));
  nand2  g081(.a(x24), .b(x18), .O(new_n115_));
  nand3  g082(.a(new_n35_), .b(x15), .c(x13), .O(new_n116_));
  aoi21  g083(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  nand4  g084(.a(new_n35_), .b(x21), .c(new_n54_), .d(new_n42_), .O(new_n118_));
  ...
  nor2   g092(.a(new_n125_), .b(new_n86_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n56_), .O(new_n127_));
  nor2   g094(.a(x08), .b(x06), .O(new_n128_));
  nor3   g095(.a(x20), .b(x14), .c(x11), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n66_), .d(new_n48_), .O(new_n130_));
  nand2  g097(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand2  g098(.a(new_n131_), .b(new_n35_), .O(new_n132_));
  nor2   g099(.a(new_n77_), .b(new_n47_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(x20), .c(x18), .O(new_n134_));
  nand3  g101(.a(new_n49_), .b(new_n47_), .c(new_n107_), .O(new_n135_));
  nand2  g102(.a(new_n93_), .b(new_n48_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n86_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n99_), .O(new_n138_));
  nand3  g105(.a(new_n133_), .b(x20), .c(x15), .O(new_n139_));
  nand3  g106(.a(new_n48_), .b(new_n77_), .c(new_n47_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n108_), .c(new_n139_), .d(new_n86_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n39_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n138_), .c(new_n132_), .O(z3));
  aoi21  g110(.a(new_n74_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n104_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n71_), .c(x08), .O(new_n146_));
  nand4  g113(.a(new_n35_), .b(new_n54_), .c(new_n42_), .d(x00), .O(new_n147_));
  nand3  g114(.a(new_n147_), .b(new_n41_), .c(new_n40_), .O(new_n148_));
  aoi21  g115(.a(new_n37_), .b(x05), .c(new_n148_), .O(new_n149_));
  inv1   g116(.a(x04), .O(new_n150_));
  aoi21  g117(.a(x23), .b(new_n150_), .c(new_n72_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n73_), .c(x09), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x16), .c(new_n107_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n122_), .c(new_n149_), .d(new_n146_), .O(z4));
  inv1   g121(.a(new_n148_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n38_), .O(z5));
  inv1   g123(.a(new_n117_), .O(new_n157_));
  and2   g124(.a(new_n120_), .b(new_n119_), .O(new_n158_));
  nand3  g125(.a(new_n35_), .b(x21), .c(new_n42_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n158_), .c(new_n157_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n133_), .c(new_n78_), .O(new_n161_));
  inv1   g128(.a(x03), .O(new_n162_));
  aoi21  g129(.a(x20), .b(new_n77_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  inv1   g132(.a(new_n121_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n157_), .O(z7));
  oai21  g134(.a(new_n47_), .b(x06), .c(x03), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(z7), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n165_), .c(new_n161_), .O(z6));
endmodule
