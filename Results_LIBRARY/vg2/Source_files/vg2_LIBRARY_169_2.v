...
module FAU ( 
  ...
  nor2   g034(.a(x11), .b(x08), .O(new_n68_));
  ...
  nand4  g072(.a(new_n73_), .b(new_n72_), .c(new_n75_), .d(new_n48_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  inv1   g074(.a(x08), .O(new_n108_));
  nand4  g075(.a(new_n71_), .b(x19), .c(new_n108_), .d(new_n47_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nor2   g078(.a(x16), .b(x14), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n49_), .c(new_n78_), .d(new_n97_), .O(new_n113_));
  ...
  nand3  g086(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n120_));
  nand3  g087(.a(x24), .b(x18), .c(x13), .O(new_n121_));
  nand2  g088(.a(new_n39_), .b(x15), .O(new_n122_));
  ...
  nor3   g092(.a(new_n125_), .b(new_n124_), .c(new_n57_), .O(z2));
  nor2   g093(.a(new_n76_), .b(new_n48_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n128_));
  nor2   g095(.a(x08), .b(x06), .O(new_n129_));
  nor3   g096(.a(x20), .b(x14), .c(x11), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n129_), .c(new_n66_), .d(new_n49_), .O(new_n131_));
  ...
  nand2  g101(.a(new_n50_), .b(new_n49_), .O(new_n135_));
  nand3  g102(.a(new_n68_), .b(x07), .c(new_n47_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n86_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n138_));
  nand3  g105(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n109_), .c(new_n138_), .d(new_n86_), .O(new_n140_));
  aoi22  g107(.a(new_n140_), .b(new_n39_), .c(new_n137_), .d(new_n101_), .O(new_n141_));
  ...
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n108_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n124_), .c(new_n146_), .d(new_n46_), .O(z4));
  ...
  oai22  g123(.a(new_n156_), .b(new_n124_), .c(new_n153_), .d(new_n46_), .O(z6));
  inv1   g124(.a(new_n124_), .O(z7));
endmodule
