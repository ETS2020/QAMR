...
module FAU ( 
  ...
  nand4  g061(.a(new_n94_), .b(new_n93_), .c(new_n91_), .d(new_n68_), .O(new_n95_));
  inv1   g062(.a(x04), .O(new_n96_));
  nand4  g063(.a(new_n50_), .b(new_n49_), .c(new_n71_), .d(new_n96_), .O(new_n97_));
  ...
  nand3  g067(.a(x17), .b(x16), .c(x15), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n89_), .c(new_n86_), .d(new_n84_), .O(new_n103_));
  inv1   g070(.a(x09), .O(new_n104_));
  nand4  g071(.a(new_n73_), .b(new_n72_), .c(new_n48_), .d(new_n104_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  inv1   g073(.a(x08), .O(new_n107_));
  nand4  g074(.a(new_n77_), .b(x19), .c(new_n107_), .d(new_n47_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nor2   g077(.a(x14), .b(x12), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n49_), .c(new_n71_), .d(new_n96_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(new_n103_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n39_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n100_), .c(new_n82_), .O(z1));
  nand2  g082(.a(x24), .b(x18), .O(new_n116_));
  nand3  g083(.a(new_n36_), .b(x15), .c(x13), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n116_), .c(new_n34_), .O(new_n118_));
  nand3  g085(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n119_));
  nand3  g086(.a(x24), .b(x18), .c(x13), .O(new_n120_));
  nand2  g087(.a(new_n39_), .b(x15), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  nand4  g090(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n123_), .c(new_n57_), .O(z2));
  nor2   g092(.a(new_n76_), .b(new_n48_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n86_), .c(new_n56_), .d(x20), .O(new_n127_));
  ...
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n85_), .O(new_n136_));
  nand4  g103(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n137_));
  nand3  g104(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n108_), .c(new_n137_), .d(new_n85_), .O(new_n139_));
  ...
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n104_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n142_), .c(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n96_), .c(new_n71_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n72_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n107_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n123_), .c(new_n145_), .d(new_n46_), .O(z4));
  inv1   g116(.a(new_n46_), .O(z5));
  oai21  g117(.a(new_n77_), .b(x14), .c(new_n47_), .O(new_n151_));
  ...
  oai22  g122(.a(new_n155_), .b(new_n123_), .c(new_n152_), .d(new_n46_), .O(z6));
  inv1   g123(.a(new_n123_), .O(z7));
endmodule
