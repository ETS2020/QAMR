...
module FAU ( 
  ...
  nand2  g024(.a(x11), .b(x09), .O(new_n58_));
  ...
  nand3  g051(.a(x12), .b(x11), .c(x09), .O(new_n85_));
  inv1   g052(.a(new_n85_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n84_), .c(x08), .d(x04), .O(new_n87_));
  nor2   g054(.a(new_n78_), .b(new_n47_), .O(new_n88_));
  ...
  nand4  g085(.a(new_n84_), .b(x20), .c(x14), .d(x11), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n118_), .O(z2));
  inv1   g087(.a(x08), .O(new_n121_));
  nor2   g088(.a(new_n76_), .b(new_n121_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n84_), .c(x20), .d(x14), .O(new_n123_));
  aoi21  g090(.a(new_n54_), .b(new_n52_), .c(new_n123_), .O(new_n124_));
  nand4  g091(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n121_), .O(new_n125_));
  aoi21  g092(.a(new_n65_), .b(new_n64_), .c(new_n125_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n124_), .c(new_n36_), .O(new_n127_));
  nand2  g094(.a(new_n48_), .b(new_n68_), .O(new_n128_));
  nand4  g095(.a(new_n47_), .b(new_n76_), .c(new_n121_), .d(x07), .O(new_n129_));
  nand2  g096(.a(new_n84_), .b(x08), .O(new_n130_));
  nand4  g097(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand4  g099(.a(x19), .b(new_n47_), .c(new_n76_), .d(new_n121_), .O(new_n133_));
  ...
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n121_), .O(new_n144_));
