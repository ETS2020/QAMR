...
module FAU ( 
  ...
  nand3  g053(.a(x18), .b(x17), .c(x16), .O(new_n87_));
  ...
  nand3  g080(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n114_));
  ...
  nand2  g085(.a(new_n35_), .b(x20), .O(new_n119_));
  oai21  g086(.a(new_n119_), .b(new_n117_), .c(new_n118_), .O(new_n120_));
  inv1   g087(.a(new_n118_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(x13), .O(new_n122_));
  inv1   g089(.a(new_n122_), .O(new_n123_));
  aoi21  g090(.a(new_n120_), .b(x05), .c(new_n123_), .O(new_n124_));
  inv1   g091(.a(new_n56_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x14), .c(x11), .d(x06), .O(new_n126_));
  aoi21  g093(.a(new_n124_), .b(new_n116_), .c(new_n126_), .O(z2));
  nor2   g094(.a(new_n76_), .b(new_n47_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n86_), .c(new_n55_), .d(x20), .O(new_n129_));
  nor2   g096(.a(x08), .b(x06), .O(new_n130_));
  nor3   g097(.a(x20), .b(x14), .c(x11), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n65_), .d(new_n48_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n35_), .O(new_n134_));
  nand3  g101(.a(x18), .b(x14), .c(x11), .O(new_n135_));
  nand3  g102(.a(new_n49_), .b(new_n47_), .c(new_n106_), .O(new_n136_));
  nand3  g103(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n85_), .O(new_n138_));
  nand4  g105(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n139_));
  nand3  g106(.a(new_n48_), .b(new_n76_), .c(new_n47_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n107_), .c(new_n139_), .d(new_n85_), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n38_), .c(new_n138_), .d(new_n98_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n134_), .O(z3));
  aoi21  g110(.a(new_n73_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n103_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n70_), .c(x08), .O(new_n146_));
  inv1   g113(.a(x04), .O(new_n147_));
  aoi21  g114(.a(x23), .b(new_n147_), .c(new_n71_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n72_), .c(x09), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x16), .c(new_n106_), .O(new_n150_));
  oai21  g117(.a(new_n117_), .b(x24), .c(new_n118_), .O(new_n151_));
  nand3  g118(.a(new_n122_), .b(new_n114_), .c(new_n113_), .O(new_n152_));
  aoi21  g119(.a(new_n151_), .b(x05), .c(new_n152_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n150_), .c(new_n146_), .d(new_n45_), .O(z4));
  ...
  inv1   g125(.a(new_n114_), .O(new_n159_));
  nand2  g126(.a(new_n77_), .b(x14), .O(new_n160_));
  ...
  oai22  g132(.a(new_n165_), .b(new_n159_), .c(new_n161_), .d(new_n158_), .O(new_n166_));
  aoi21  g133(.a(x20), .b(new_n76_), .c(x06), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(x11), .c(new_n158_), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(z5), .O(new_n169_));
  oai21  g136(.a(new_n47_), .b(x06), .c(x03), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n121_), .c(new_n163_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n169_), .c(new_n166_), .O(z6));
  inv1   g139(.a(new_n153_), .O(z7));
endmodule
