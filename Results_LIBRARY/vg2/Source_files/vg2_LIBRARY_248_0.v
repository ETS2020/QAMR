...
module FAU ( 
  ...
  nand2  g52(.a(x14), .b(new_n86_), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n85_), .c(x03), .O(new_n88_));
  inv1   g54(.a(x20), .O(new_n89_));
  oai21  g55(.a(new_n85_), .b(x06), .c(x03), .O(new_n90_));
  aoi21  g56(.a(new_n89_), .b(x14), .c(new_n90_), .O(new_n91_));
  oai22  g57(.a(new_n91_), .b(new_n47_), .c(new_n88_), .d(new_n75_), .O(z6));
  inv1   g58(.a(new_n47_), .O(z7));
  zero   g59(.O(z0));
endmodule
