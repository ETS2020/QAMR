...
module FAU ( 
  ...
  nand3  g026(.a(x22), .b(x20), .c(x17), .O(new_n60_));
  ...
  nand4  g052(.a(x22), .b(x20), .c(x14), .d(x12), .O(new_n86_));
  ...
  aoi21  g105(.a(new_n138_), .b(x17), .c(x09), .O(new_n139_));
  oai21  g106(.a(x23), .b(new_n94_), .c(new_n139_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n71_), .c(x08), .O(new_n141_));
  oai21  g108(.a(new_n72_), .b(new_n94_), .c(x22), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x09), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n129_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n117_), .c(new_n141_), .d(new_n46_), .O(z4));
  inv1   g112(.a(new_n46_), .O(z5));
  oai21  g113(.a(new_n77_), .b(x14), .c(new_n47_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n48_), .c(x03), .O(new_n148_));
  inv1   g115(.a(x03), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n76_), .c(x06), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x11), .c(new_n149_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n117_), .c(new_n148_), .d(new_n46_), .O(z6));
  inv1   g119(.a(new_n117_), .O(z7));
endmodule
