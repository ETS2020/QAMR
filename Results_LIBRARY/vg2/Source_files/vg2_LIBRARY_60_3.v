...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n155_, new_n158_, new_n159_, new_n160_, new_n161_;
  ...
  nand3  g069(.a(new_n102_), .b(new_n92_), .c(new_n89_), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  inv1   g071(.a(x13), .O(new_n105_));
  nand3  g072(.a(new_n97_), .b(x19), .c(new_n105_), .O(new_n106_));
  nand3  g073(.a(new_n49_), .b(new_n34_), .c(new_n94_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n104_), .c(new_n96_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n101_), .c(new_n82_), .O(z1));
  ...
  aoi21  g087(.a(new_n115_), .b(new_n114_), .c(new_n120_), .O(z2));
  nor2   g088(.a(x14), .b(x11), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n102_), .c(new_n49_), .d(new_n68_), .O(new_n123_));
  aoi21  g090(.a(new_n55_), .b(new_n54_), .c(new_n123_), .O(new_n124_));
  nor2   g091(.a(new_n95_), .b(new_n47_), .O(new_n125_));
  nor2   g092(.a(x02), .b(new_n116_), .O(new_n126_));
  nand4  g093(.a(x21), .b(x20), .c(x14), .d(x11), .O(new_n127_));
  inv1   g094(.a(new_n127_), .O(new_n128_));
  nor2   g095(.a(x10), .b(new_n117_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n125_), .O(new_n130_));
  inv1   g097(.a(new_n130_), .O(new_n131_));
  oai21  g098(.a(new_n131_), .b(new_n124_), .c(new_n36_), .O(new_n132_));
  nand4  g099(.a(x14), .b(x11), .c(x03), .d(x01), .O(new_n133_));
  nand4  g100(.a(x20), .b(x18), .c(x08), .d(x06), .O(new_n134_));
  nand3  g101(.a(new_n50_), .b(new_n48_), .c(new_n95_), .O(new_n135_));
  nand2  g102(.a(new_n91_), .b(new_n49_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  nand3  g104(.a(new_n122_), .b(new_n68_), .c(x19), .O(new_n138_));
  nand3  g105(.a(new_n102_), .b(new_n49_), .c(new_n39_), .O(new_n139_));
  nor2   g106(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  aoi21  g107(.a(new_n137_), .b(new_n100_), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g112(.a(new_n145_), .b(new_n61_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n94_), .c(new_n62_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n63_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n95_), .O(new_n149_));
  nand3  g116(.a(new_n36_), .b(x15), .c(x13), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n112_), .c(new_n34_), .O(new_n151_));
  nand2  g118(.a(new_n39_), .b(x15), .O(new_n152_));
  nand2  g119(.a(new_n113_), .b(x13), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n152_), .c(new_n115_), .O(new_n154_));
  nor2   g121(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n149_), .c(new_n146_), .d(new_n46_), .O(z4));
  ...
  oai21  g126(.a(x20), .b(new_n67_), .c(x06), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x11), .c(new_n117_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n155_), .c(new_n159_), .d(new_n46_), .O(z6));
  inv1   g129(.a(new_n155_), .O(z7));
endmodule
