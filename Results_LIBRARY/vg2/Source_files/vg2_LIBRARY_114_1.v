...
module FAU ( 
  ...
  oai21  g122(.a(new_n78_), .b(x14), .c(new_n46_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n47_), .c(x03), .O(new_n157_));
  ...
  oai22  g127(.a(new_n160_), .b(new_n122_), .c(new_n157_), .d(new_n149_), .O(z6));
  inv1   g128(.a(new_n122_), .O(z7));
endmodule
