// Benchmark "FAU" written by ABC on Thu Jun 25 17:02:59 2020
...
module FAU ( 
  ...
  aoi21  g119(.a(x11), .b(new_n122_), .c(new_n152_), .O(new_n153_));
  oai21  g120(.a(new_n49_), .b(x14), .c(new_n122_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n123_), .c(x03), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n46_), .c(new_n153_), .d(new_n121_), .O(z6));
  inv1   g123(.a(new_n121_), .O(z7));
endmodule
