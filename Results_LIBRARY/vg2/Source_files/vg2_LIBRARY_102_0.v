...
module FAU ( 
  ...
  nand2  g116(.a(x13), .b(x05), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(x24), .O(new_n151_));
  inv1   g118(.a(x03), .O(new_n152_));
  inv1   g119(.a(x19), .O(new_n153_));
  oai21  g120(.a(new_n77_), .b(x06), .c(new_n48_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n152_), .c(new_n153_), .O(new_n155_));
  aoi22  g122(.a(new_n78_), .b(x14), .c(x15), .d(new_n47_), .O(new_n156_));
  nand2  g123(.a(x15), .b(new_n152_), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(new_n48_), .c(new_n157_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n155_), .c(new_n151_), .d(new_n39_), .O(new_n159_));
  oai21  g126(.a(new_n48_), .b(x06), .c(x03), .O(new_n160_));
  inv1   g127(.a(x18), .O(new_n161_));
  inv1   g128(.a(new_n100_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n161_), .c(new_n118_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  aoi21  g131(.a(x20), .b(new_n77_), .c(x06), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x11), .c(new_n152_), .O(new_n166_));
  oai21  g133(.a(new_n162_), .b(new_n93_), .c(new_n44_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand2  g135(.a(new_n118_), .b(new_n115_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n125_), .c(new_n78_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n168_), .c(new_n164_), .d(new_n159_), .O(z6));
  inv1   g138(.a(new_n122_), .O(z7));
endmodule
