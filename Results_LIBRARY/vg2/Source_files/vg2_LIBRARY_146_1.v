...
module FAU ( 
  ...
  nand4  g060(.a(x23), .b(x22), .c(x14), .d(x12), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(x18), .c(x17), .d(x16), .O(new_n96_));
  oai22  g063(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n97_));
  ...
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n86_), .O(new_n103_));
  nor2   g070(.a(x17), .b(x16), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n49_), .c(x19), .d(new_n88_), .O(new_n105_));
  nand4  g072(.a(new_n95_), .b(x17), .c(x16), .d(x15), .O(new_n106_));
  oai22  g073(.a(new_n106_), .b(new_n93_), .c(new_n105_), .d(new_n103_), .O(new_n107_));
  ...
  nand4  g087(.a(new_n120_), .b(new_n92_), .c(new_n56_), .d(x20), .O(new_n121_));
  nor3   g088(.a(x20), .b(x14), .c(x11), .O(new_n122_));
  nand2  g089(.a(new_n102_), .b(new_n49_), .O(new_n123_));
  ...
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n128_), .d(new_n91_), .O(new_n132_));
  nand4  g099(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n133_));
  nand4  g100(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n123_), .c(new_n133_), .d(new_n91_), .O(new_n135_));
  ...
  aoi21  g109(.a(x23), .b(new_n88_), .c(new_n72_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n73_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n129_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n117_), .c(new_n142_), .d(new_n46_), .O(z4));
