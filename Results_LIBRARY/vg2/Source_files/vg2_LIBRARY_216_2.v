...
module FAU ( 
  ...
  nand3  g006(.a(x24), .b(new_n34_), .c(x07), .O(new_n40_));
  ...
  nand4  g051(.a(new_n70_), .b(new_n69_), .c(new_n64_), .d(new_n84_), .O(new_n85_));
  ...
  nand4  g059(.a(new_n80_), .b(new_n52_), .c(new_n51_), .d(new_n92_), .O(new_n93_));
  nor2   g060(.a(new_n93_), .b(new_n85_), .O(new_n94_));
  nand2  g061(.a(new_n94_), .b(new_n91_), .O(new_n95_));
  nand3  g062(.a(new_n95_), .b(new_n87_), .c(new_n75_), .O(z1));
  nand2  g063(.a(new_n55_), .b(x18), .O(new_n97_));
  nand2  g064(.a(new_n35_), .b(x15), .O(new_n98_));
  nor2   g065(.a(new_n34_), .b(new_n49_), .O(new_n99_));
  nor2   g066(.a(new_n51_), .b(new_n50_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(x03), .d(x01), .O(new_n101_));
  aoi21  g068(.a(new_n98_), .b(new_n97_), .c(new_n101_), .O(z2));
  nand4  g069(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n103_));
  nand4  g070(.a(new_n80_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n40_), .c(new_n103_), .d(new_n58_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  nand4  g073(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n107_));
  nand3  g074(.a(new_n52_), .b(new_n50_), .c(new_n34_), .O(new_n108_));
  nand2  g075(.a(new_n82_), .b(new_n80_), .O(new_n109_));
  oai22  g076(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n58_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n35_), .O(new_n111_));
  inv1   g078(.a(new_n104_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n91_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n111_), .c(new_n106_), .O(z3));
  inv1   g081(.a(x16), .O(new_n115_));
  aoi21  g082(.a(new_n84_), .b(x04), .c(x17), .O(new_n116_));
  oai21  g083(.a(new_n116_), .b(x22), .c(new_n92_), .O(new_n117_));
  aoi21  g084(.a(new_n117_), .b(new_n115_), .c(x08), .O(new_n118_));
  inv1   g085(.a(x05), .O(new_n119_));
  nand2  g086(.a(x24), .b(x07), .O(new_n120_));
  aoi21  g087(.a(new_n120_), .b(new_n42_), .c(new_n119_), .O(new_n121_));
  nand3  g088(.a(new_n46_), .b(new_n37_), .c(new_n36_), .O(new_n122_));
  ...
  nand3  g098(.a(new_n41_), .b(x15), .c(x13), .O(new_n132_));
  aoi21  g099(.a(new_n132_), .b(new_n131_), .c(new_n119_), .O(new_n133_));
  nand3  g100(.a(new_n88_), .b(new_n41_), .c(x21), .O(new_n134_));
  ...
  oai22  g104(.a(new_n137_), .b(new_n130_), .c(new_n123_), .d(new_n118_), .O(z4));
  inv1   g105(.a(new_n123_), .O(z5));
  inv1   g106(.a(x15), .O(new_n140_));
  oai21  g107(.a(x20), .b(new_n50_), .c(x06), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(x11), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x03), .c(new_n140_), .O(new_n143_));
  inv1   g110(.a(x03), .O(new_n144_));
  oai21  g111(.a(new_n51_), .b(x14), .c(new_n49_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n34_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n144_), .c(new_n81_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n143_), .c(new_n35_), .O(new_n148_));
  nand2  g115(.a(new_n90_), .b(new_n89_), .O(new_n149_));
  nand2  g116(.a(x20), .b(new_n50_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n49_), .c(new_n144_), .O(new_n151_));
  ...
  nand2  g122(.a(new_n155_), .b(new_n144_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n41_), .O(new_n158_));
  inv1   g125(.a(x18), .O(new_n159_));
  nand2  g126(.a(x24), .b(new_n144_), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n142_), .c(new_n159_), .O(new_n161_));
  aoi21  g128(.a(new_n146_), .b(new_n144_), .c(new_n120_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n161_), .c(new_n55_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n158_), .c(new_n148_), .O(z6));
  inv1   g131(.a(new_n137_), .O(z7));
endmodule
