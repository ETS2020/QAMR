...
module FAU ( 
  ...
  oai21  g117(.a(new_n77_), .b(x06), .c(new_n48_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n150_), .c(new_n93_), .O(new_n152_));
  aoi22  g119(.a(new_n78_), .b(x14), .c(x18), .d(new_n47_), .O(new_n153_));
  nand2  g120(.a(x18), .b(new_n150_), .O(new_n154_));
  oai21  g121(.a(new_n153_), .b(new_n48_), .c(new_n154_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n152_), .c(new_n100_), .O(new_n156_));
  inv1   g123(.a(new_n44_), .O(new_n157_));
  nand2  g124(.a(x20), .b(new_n77_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n47_), .c(x11), .O(new_n159_));
  inv1   g126(.a(x19), .O(new_n160_));
  inv1   g127(.a(new_n39_), .O(new_n161_));
  nand3  g128(.a(new_n36_), .b(x13), .c(x05), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n161_), .c(new_n160_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n157_), .c(new_n159_), .d(x03), .O(new_n164_));
  nand2  g131(.a(new_n120_), .b(new_n119_), .O(new_n165_));
  nand2  g132(.a(new_n78_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n48_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n150_), .c(new_n165_), .O(new_n168_));
  inv1   g135(.a(new_n53_), .O(new_n169_));
  nand2  g136(.a(new_n36_), .b(new_n47_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n166_), .c(new_n48_), .O(new_n171_));
  nor2   g138(.a(x24), .b(x03), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n171_), .c(new_n169_), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n168_), .c(new_n164_), .d(new_n156_), .O(z6));
