...
module FAU ( 
  ...
  nand3  g052(.a(x16), .b(x14), .c(x12), .O(new_n86_));
  ...
  oai21  g065(.a(new_n97_), .b(new_n88_), .c(new_n98_), .O(new_n99_));
  nor2   g066(.a(new_n85_), .b(new_n84_), .O(new_n100_));
  ...
  nand4  g071(.a(new_n73_), .b(new_n72_), .c(new_n75_), .d(new_n48_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  inv1   g073(.a(x08), .O(new_n107_));
  nand4  g074(.a(new_n71_), .b(x19), .c(new_n107_), .d(new_n47_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nor2   g077(.a(x16), .b(x14), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(new_n49_), .c(new_n78_), .d(new_n94_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n39_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n99_), .c(new_n83_), .O(z1));
  ...
  nor2   g093(.a(new_n126_), .b(new_n85_), .O(new_n127_));
  ...
  nand2  g109(.a(x23), .b(x22), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x04), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n107_), .O(new_n145_));
  ...
  oai22  g116(.a(new_n149_), .b(new_n46_), .c(new_n145_), .d(new_n123_), .O(z4));
  ...
  oai22  g123(.a(new_n156_), .b(new_n123_), .c(new_n153_), .d(new_n46_), .O(z6));
  inv1   g124(.a(new_n123_), .O(z7));
endmodule
