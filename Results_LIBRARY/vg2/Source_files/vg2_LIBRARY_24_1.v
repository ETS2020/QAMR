...
module FAU ( 
  ...
  nand3  g049(.a(x12), .b(x11), .c(x04), .O(new_n83_));
  ...
  nand4  g066(.a(x23), .b(x22), .c(x16), .d(x14), .O(new_n100_));
  ...
  nand4  g073(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n91_), .O(new_n107_));
  nor2   g074(.a(x14), .b(x12), .O(new_n108_));
  nand4  g075(.a(new_n108_), .b(new_n49_), .c(new_n71_), .d(new_n93_), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(new_n102_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n39_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n97_), .c(new_n82_), .O(z1));
  ...
  nor2   g090(.a(new_n123_), .b(new_n84_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n56_), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n104_), .c(new_n66_), .d(new_n49_), .O(new_n127_));
  ...
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n130_), .d(new_n84_), .O(new_n134_));
  nand3  g101(.a(new_n104_), .b(new_n77_), .c(x19), .O(new_n135_));
  nand4  g102(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n136_));
  nand3  g103(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n135_), .c(new_n136_), .d(new_n84_), .O(new_n138_));
  aoi22  g105(.a(new_n138_), .b(new_n39_), .c(new_n134_), .d(new_n96_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n129_), .O(z3));
  aoi21  g107(.a(new_n91_), .b(x04), .c(x09), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(x16), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(x08), .O(new_n143_));
  inv1   g110(.a(x17), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n93_), .c(new_n144_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n72_), .c(x09), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n131_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n120_), .c(new_n143_), .d(new_n46_), .O(z4));
  inv1   g115(.a(new_n46_), .O(z5));
  oai21  g116(.a(new_n77_), .b(x14), .c(new_n47_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n48_), .c(x03), .O(new_n151_));
  inv1   g118(.a(x03), .O(new_n152_));
  oai21  g119(.a(x20), .b(new_n76_), .c(x06), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x11), .c(new_n152_), .O(new_n154_));
  oai22  g121(.a(new_n154_), .b(new_n120_), .c(new_n151_), .d(new_n46_), .O(z6));
  inv1   g122(.a(new_n120_), .O(z7));
endmodule
