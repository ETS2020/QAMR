...
module FAU ( 
  ...
  nand4  g63(.a(new_n103_), .b(x22), .c(x21), .d(x20), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x19), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n107_), .c(new_n78_), .O(new_n110_));
  oai21  g66(.a(new_n57_), .b(new_n65_), .c(new_n110_), .O(z13));
  ...
  oai21  g74(.a(new_n118_), .b(new_n77_), .c(new_n67_), .O(z14));
  ...
  oai21  g83(.a(new_n127_), .b(new_n77_), .c(new_n69_), .O(z15));
  ...
  oai21  g91(.a(new_n135_), .b(new_n77_), .c(new_n71_), .O(z16));
endmodule
