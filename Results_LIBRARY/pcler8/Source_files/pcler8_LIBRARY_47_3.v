// Benchmark "FAU" written by ABC on Thu Jun 25 17:16:59 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n57_,
    ...
    new_n86_, new_n88_, new_n90_, new_n92_;
  ...
  oai21  g39(.a(new_n84_), .b(new_n72_), .c(new_n83_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n75_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n55_), .O(z13));
  nand3  g42(.a(new_n64_), .b(x24), .c(new_n69_), .O(new_n88_));
  oai21  g43(.a(new_n47_), .b(new_n57_), .c(new_n88_), .O(z14));
  nand3  g44(.a(new_n64_), .b(x25), .c(new_n69_), .O(new_n90_));
  oai21  g45(.a(new_n47_), .b(new_n59_), .c(new_n90_), .O(z15));
  nand3  g46(.a(new_n64_), .b(x26), .c(new_n69_), .O(new_n92_));
  oai21  g47(.a(new_n47_), .b(new_n61_), .c(new_n92_), .O(z16));
  zero   g48(.O(z00));
endmodule
