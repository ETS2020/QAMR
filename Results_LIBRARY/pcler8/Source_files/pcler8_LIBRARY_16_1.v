// Benchmark "FAU" written by ABC on Thu Jun 25 17:16:53 2020
...
module FAU ( 
  ...
  nand3  g26(.a(x24), .b(x22), .c(x11), .O(new_n71_));
  nand4  g27(.a(x26), .b(x25), .c(x21), .d(x20), .O(new_n72_));
  nor2   g28(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(new_n49_), .O(new_n74_));
  inv1   g30(.a(x10), .O(new_n75_));
  nand2  g31(.a(new_n48_), .b(new_n75_), .O(new_n76_));
  ...
  oai22  g38(.a(new_n82_), .b(new_n76_), .c(new_n55_), .d(new_n57_), .O(z10));
  nand2  g39(.a(x22), .b(x13), .O(new_n84_));
  nand2  g40(.a(x20), .b(x19), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(new_n86_));
  oai21  g42(.a(new_n84_), .b(new_n78_), .c(new_n86_), .O(new_n87_));
  nor2   g43(.a(new_n85_), .b(x21), .O(new_n88_));
  aoi21  g44(.a(new_n87_), .b(x21), .c(new_n88_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n76_), .c(new_n59_), .O(z11));
  inv1   g46(.a(new_n76_), .O(new_n91_));
  inv1   g47(.a(x22), .O(new_n92_));
  nand4  g48(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n93_));
  nand3  g49(.a(x21), .b(x20), .c(x19), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n93_), .c(new_n92_), .O(new_n96_));
  nand3  g52(.a(new_n86_), .b(new_n92_), .c(x21), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n91_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n61_), .O(z12));
  inv1   g56(.a(x23), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x22), .c(x21), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  ...
  oai21  g62(.a(new_n105_), .b(new_n101_), .c(new_n106_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n103_), .c(new_n91_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n63_), .O(z13));
  ...
  nor3   g70(.a(new_n114_), .b(new_n111_), .c(x24), .O(new_n115_));
  aoi21  g71(.a(new_n113_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n76_), .c(new_n65_), .O(z14));
  ...
  oai21  g81(.a(new_n125_), .b(new_n76_), .c(new_n67_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x25), .b(x24), .c(new_n127_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n104_), .c(x26), .O(new_n129_));
  nor2   g85(.a(x26), .b(new_n122_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n105_), .c(x24), .d(x23), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n91_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n69_), .O(z16));
endmodule
