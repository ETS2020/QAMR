// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:15 2020
...
module FAU ( 
  ...
  nand4  g31(.a(x21), .b(x20), .c(x19), .d(x11), .O(new_n76_));
  nor2   g32(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  aoi22  g33(.a(new_n77_), .b(new_n74_), .c(new_n52_), .d(new_n57_), .O(new_n78_));
  inv1   g34(.a(x10), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(x09), .O(new_n80_));
  oai22  g36(.a(new_n80_), .b(new_n78_), .c(new_n57_), .d(new_n56_), .O(z09));
  nand3  g37(.a(x26), .b(x25), .c(x12), .O(new_n82_));
  nand4  g38(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n82_), .c(x19), .O(new_n84_));
  nor2   g40(.a(x20), .b(new_n52_), .O(new_n85_));
  aoi21  g41(.a(new_n84_), .b(x20), .c(new_n85_), .O(new_n86_));
  nand2  g42(.a(new_n51_), .b(new_n79_), .O(new_n87_));
  oai22  g43(.a(new_n87_), .b(new_n86_), .c(new_n57_), .d(new_n59_), .O(z10));
  nand3  g44(.a(x23), .b(x22), .c(x13), .O(new_n89_));
  nand2  g45(.a(x20), .b(x19), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  oai21  g47(.a(new_n89_), .b(new_n73_), .c(new_n91_), .O(new_n92_));
  nor2   g48(.a(new_n90_), .b(x21), .O(new_n93_));
  aoi21  g49(.a(new_n92_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n87_), .c(new_n61_), .O(z11));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  nand3  g52(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n96_), .b(new_n73_), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g59(.a(new_n103_), .b(new_n87_), .c(new_n63_), .O(z12));
  ...
  nand2  g64(.a(x22), .b(x21), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(x23), .O(new_n110_));
  aoi22  g66(.a(new_n110_), .b(new_n91_), .c(new_n108_), .d(x23), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n87_), .c(new_n65_), .O(z13));
  ...
  nor3   g72(.a(new_n114_), .b(new_n75_), .c(x24), .O(new_n117_));
  aoi21  g73(.a(new_n116_), .b(x24), .c(new_n117_), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n87_), .c(new_n67_), .O(z14));
  ...
  oai21  g83(.a(new_n127_), .b(new_n87_), .c(new_n69_), .O(z15));
  ...
  oai21  g91(.a(new_n135_), .b(new_n87_), .c(new_n71_), .O(z16));
endmodule
