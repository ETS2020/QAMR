...
module FAU ( 
  ...
  nor2   g47(.a(new_n87_), .b(x21), .O(new_n92_));
  aoi21  g48(.a(new_n91_), .b(new_n89_), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g54(.a(new_n96_), .b(new_n85_), .c(new_n98_), .O(new_n99_));
  ...
  nor3   g64(.a(x23), .b(new_n100_), .c(new_n90_), .O(new_n109_));
