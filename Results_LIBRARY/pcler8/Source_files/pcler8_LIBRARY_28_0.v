...
module FAU ( 
  ...
  nand3  g30(.a(x22), .b(x20), .c(x11), .O(new_n75_));
  oai21  g31(.a(new_n75_), .b(new_n74_), .c(x19), .O(new_n76_));
  nor2   g32(.a(new_n73_), .b(x08), .O(new_n77_));
  aoi22  g33(.a(new_n77_), .b(new_n76_), .c(new_n73_), .d(new_n52_), .O(new_n78_));
  inv1   g34(.a(x10), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(x09), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(z09));
  ...
  nand2  g41(.a(new_n51_), .b(new_n79_), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n59_), .d(new_n58_), .O(z10));
  ...
  oai21  g50(.a(new_n94_), .b(new_n86_), .c(new_n61_), .O(z11));
  ...
  oai21  g59(.a(new_n103_), .b(new_n86_), .c(new_n63_), .O(z12));
  inv1   g60(.a(new_n86_), .O(new_n105_));
  ...
  nand3  g66(.a(new_n106_), .b(x22), .c(x21), .O(new_n111_));
  nor2   g67(.a(new_n111_), .b(new_n90_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n110_), .c(new_n105_), .O(new_n113_));
  ...
  oai21  g77(.a(new_n121_), .b(new_n86_), .c(new_n67_), .O(z14));
  ...
  oai21  g86(.a(new_n130_), .b(new_n86_), .c(new_n69_), .O(z15));
  ...
  nor2   g91(.a(new_n135_), .b(new_n108_), .O(new_n136_));
  aoi21  g92(.a(new_n133_), .b(x26), .c(new_n136_), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n86_), .c(new_n71_), .O(z16));
endmodule
