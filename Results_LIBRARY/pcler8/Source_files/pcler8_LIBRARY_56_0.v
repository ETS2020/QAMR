...
module FAU ( 
  ...
  nor2   g32(.a(new_n76_), .b(new_n52_), .O(new_n77_));
  ...
  oai22  g48(.a(new_n92_), .b(new_n79_), .c(new_n57_), .d(new_n61_), .O(z11));
  inv1   g49(.a(new_n86_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x23), .c(x14), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n89_), .c(x21), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  nand3  g53(.a(new_n89_), .b(new_n97_), .c(x21), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(new_n99_));
  aoi21  g55(.a(new_n96_), .b(x22), .c(new_n99_), .O(new_n100_));
  oai22  g56(.a(new_n100_), .b(new_n79_), .c(new_n57_), .d(new_n63_), .O(z12));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(x22), .c(x20), .d(x19), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(x23), .O(new_n104_));
  inv1   g60(.a(x23), .O(new_n105_));
  nand3  g61(.a(new_n89_), .b(new_n74_), .c(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(x08), .O(new_n107_));
  nor2   g63(.a(new_n105_), .b(x21), .O(new_n108_));
  nor2   g64(.a(x10), .b(new_n50_), .O(new_n109_));
  oai21  g65(.a(new_n108_), .b(new_n107_), .c(new_n109_), .O(new_n110_));
  ...
  oai22  g75(.a(new_n119_), .b(new_n79_), .c(new_n57_), .d(new_n67_), .O(z14));
  ...
  nand3  g79(.a(new_n113_), .b(new_n123_), .c(x24), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(new_n125_));
  aoi22  g81(.a(new_n125_), .b(new_n116_), .c(new_n122_), .d(x25), .O(new_n126_));
  ...
  nand3  g86(.a(new_n74_), .b(new_n130_), .c(x25), .O(new_n131_));
  nand3  g87(.a(new_n89_), .b(x24), .c(x23), .O(new_n132_));
