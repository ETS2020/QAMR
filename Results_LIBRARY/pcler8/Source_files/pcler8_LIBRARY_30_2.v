...
module FAU ( 
  ...
  nand2  g66(.a(x25), .b(x16), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n110_), .c(x23), .d(x22), .O(new_n112_));
  nand2  g68(.a(x23), .b(x22), .O(new_n113_));
  nor3   g69(.a(new_n109_), .b(new_n113_), .c(x24), .O(new_n114_));
  aoi21  g70(.a(new_n112_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n74_), .c(new_n65_), .O(z14));
  inv1   g72(.a(x25), .O(new_n117_));
  nor2   g73(.a(new_n105_), .b(x17), .O(new_n118_));
  nand4  g74(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n118_), .c(new_n117_), .O(new_n121_));
  nand4  g77(.a(new_n117_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(new_n109_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n121_), .c(new_n75_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n67_), .O(z15));
  oai21  g81(.a(new_n117_), .b(x18), .c(x26), .O(new_n126_));
  ...
  oai21  g86(.a(new_n55_), .b(new_n69_), .c(new_n130_), .O(z16));
endmodule
