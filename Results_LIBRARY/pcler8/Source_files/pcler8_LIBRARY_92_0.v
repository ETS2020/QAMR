...
module FAU ( 
  ...
  nor2   g23(.a(new_n61_), .b(new_n67_), .O(z05));
  inv1   g24(.a(x05), .O(new_n69_));
  nor2   g25(.a(new_n61_), .b(new_n69_), .O(z06));
  ...
  nand3  g34(.a(new_n78_), .b(x09), .c(new_n61_), .O(new_n79_));
  ...
  oai21  g39(.a(new_n83_), .b(new_n75_), .c(x19), .O(new_n84_));
  nor2   g40(.a(x20), .b(new_n54_), .O(new_n85_));
  aoi21  g41(.a(new_n84_), .b(x20), .c(new_n85_), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n79_), .c(new_n61_), .d(new_n60_), .O(z10));
  ...
  oai21  g50(.a(new_n94_), .b(new_n79_), .c(new_n63_), .O(z11));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  nand3  g52(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n96_), .b(new_n88_), .c(new_n98_), .O(new_n99_));
  ...
  oai22  g59(.a(new_n103_), .b(new_n79_), .c(new_n61_), .d(new_n65_), .O(z12));
  ...
  nand3  g65(.a(new_n105_), .b(x22), .c(x21), .O(new_n110_));
  nor2   g66(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n109_), .c(new_n80_), .O(new_n112_));
  ...
  nand3  g73(.a(new_n45_), .b(x23), .c(x22), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  aoi21  g75(.a(new_n117_), .b(x24), .c(new_n119_), .O(new_n120_));
  oai22  g76(.a(new_n120_), .b(new_n79_), .c(new_n61_), .d(new_n69_), .O(z14));
  nand2  g77(.a(x25), .b(new_n100_), .O(new_n122_));
  nand3  g78(.a(new_n46_), .b(x24), .c(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n115_), .c(new_n122_), .O(new_n124_));
  nand2  g80(.a(x26), .b(x17), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n116_), .c(x24), .d(x23), .O(new_n126_));
  aoi22  g82(.a(new_n126_), .b(x25), .c(new_n124_), .d(x23), .O(new_n127_));
  nand2  g83(.a(new_n78_), .b(x09), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n127_), .c(new_n71_), .O(z15));
  nor2   g85(.a(new_n54_), .b(x18), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n51_), .c(new_n47_), .O(new_n131_));
  ...
  oai21  g92(.a(new_n136_), .b(new_n79_), .c(new_n73_), .O(z16));
endmodule
