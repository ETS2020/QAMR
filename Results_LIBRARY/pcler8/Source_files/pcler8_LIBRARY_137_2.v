...
module FAU ( 
  ...
  nor2   g30(.a(new_n74_), .b(new_n46_), .O(new_n75_));
  ...
  nand2  g39(.a(new_n51_), .b(new_n49_), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n83_), .c(new_n57_), .d(new_n56_), .O(z09));
  nand2  g41(.a(new_n80_), .b(x12), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n79_), .c(x19), .O(new_n87_));
  nor2   g43(.a(x20), .b(new_n73_), .O(new_n88_));
  aoi21  g44(.a(new_n87_), .b(x20), .c(new_n88_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n84_), .c(new_n59_), .O(z10));
  nand2  g46(.a(new_n78_), .b(x24), .O(new_n91_));
  nand2  g47(.a(new_n47_), .b(x13), .O(new_n92_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n84_), .c(new_n61_), .O(z11));
  ...
  oai21  g58(.a(new_n100_), .b(new_n91_), .c(new_n102_), .O(new_n103_));
  nor2   g59(.a(new_n45_), .b(x10), .O(new_n104_));
  nand3  g60(.a(new_n94_), .b(new_n45_), .c(x21), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  aoi21  g62(.a(new_n104_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n99_), .c(new_n63_), .O(z12));
  nand4  g64(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n101_), .c(x23), .O(new_n111_));
  nand3  g67(.a(new_n94_), .b(new_n80_), .c(new_n46_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x10), .O(new_n113_));
  nor2   g69(.a(new_n46_), .b(x22), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n113_), .c(new_n51_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n65_), .O(z13));
  nand3  g72(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand4  g74(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n118_), .c(x24), .O(new_n120_));
  nand3  g76(.a(new_n102_), .b(new_n47_), .c(new_n74_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n120_), .c(x10), .O(new_n122_));
  nor2   g78(.a(new_n74_), .b(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n122_), .c(new_n51_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n67_), .O(z14));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(x24), .c(x23), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n101_), .c(x25), .O(new_n128_));
  nand4  g84(.a(new_n102_), .b(new_n47_), .c(new_n76_), .d(x24), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n128_), .c(x10), .O(new_n130_));
  nor2   g86(.a(new_n76_), .b(x22), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n130_), .c(new_n51_), .O(new_n132_));
  ...
  nor2   g93(.a(x26), .b(new_n76_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n94_), .c(new_n80_), .d(new_n75_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n137_), .c(x10), .O(new_n140_));
  nor2   g96(.a(new_n77_), .b(x22), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(new_n140_), .c(new_n51_), .O(new_n142_));
