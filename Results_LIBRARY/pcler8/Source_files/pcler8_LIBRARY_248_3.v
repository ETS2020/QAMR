...
module FAU ( 
  ...
  aoi21  g32(.a(new_n76_), .b(new_n74_), .c(new_n53_), .O(new_n77_));
  inv1   g33(.a(x10), .O(new_n78_));
  nand2  g34(.a(new_n52_), .b(new_n78_), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(new_n77_), .c(new_n50_), .d(new_n57_), .O(z09));
  xor2a  g36(.a(x20), .b(x19), .O(new_n81_));
  nand4  g37(.a(x22), .b(x21), .c(x20), .d(x12), .O(new_n82_));
  inv1   g38(.a(new_n82_), .O(new_n83_));
  aoi22  g39(.a(new_n83_), .b(new_n74_), .c(new_n81_), .d(new_n78_), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n51_), .c(new_n50_), .d(new_n59_), .O(z10));
  ...
  oai21  g65(.a(new_n109_), .b(new_n79_), .c(new_n65_), .O(z13));
  ...
  nor2   g83(.a(new_n53_), .b(x18), .O(new_n128_));
  ...
  oai21  g90(.a(new_n134_), .b(new_n79_), .c(new_n71_), .O(z16));
endmodule
