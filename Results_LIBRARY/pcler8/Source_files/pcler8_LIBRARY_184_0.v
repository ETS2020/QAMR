// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:25 2020
...
module FAU ( 
  ...
  nor2   g07(.a(new_n51_), .b(new_n50_), .O(z01));
  inv1   g08(.a(x01), .O(new_n53_));
  nor2   g09(.a(new_n51_), .b(new_n53_), .O(z02));
  ...
  nand2  g24(.a(new_n68_), .b(new_n46_), .O(new_n69_));
  oai21  g25(.a(new_n51_), .b(new_n50_), .c(new_n69_), .O(z09));
  ...
  oai22  g31(.a(new_n75_), .b(new_n47_), .c(new_n51_), .d(new_n53_), .O(z10));
  ...
  oai21  g39(.a(new_n83_), .b(new_n47_), .c(new_n55_), .O(z11));
  ...
  oai21  g48(.a(new_n92_), .b(new_n47_), .c(new_n57_), .O(z12));
  ...
  oai21  g56(.a(new_n100_), .b(new_n97_), .c(new_n46_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n59_), .O(z13));
  ...
  oai21  g65(.a(new_n109_), .b(new_n47_), .c(new_n61_), .O(z14));
  ...
  oai21  g74(.a(new_n118_), .b(new_n47_), .c(new_n63_), .O(z15));
  ...
  nand2  g83(.a(new_n127_), .b(new_n46_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n65_), .O(z16));
endmodule
