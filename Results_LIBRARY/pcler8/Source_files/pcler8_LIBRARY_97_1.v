// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:08 2020
...
module FAU ( 
  ...
  nand2  g41(.a(x21), .b(new_n85_), .O(new_n86_));
  inv1   g42(.a(x21), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(x20), .c(new_n57_), .O(new_n88_));
  ...
  nand2  g49(.a(new_n77_), .b(x09), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n93_), .c(new_n61_), .O(z11));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  nand3  g52(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n96_), .b(new_n90_), .c(new_n98_), .O(new_n99_));
  inv1   g55(.a(x22), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(x21), .c(x20), .d(x19), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  aoi21  g58(.a(new_n99_), .b(x22), .c(new_n102_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n78_), .c(new_n63_), .O(z12));
  nor2   g60(.a(new_n85_), .b(new_n52_), .O(new_n105_));
  ...
  nor3   g65(.a(x23), .b(new_n100_), .c(new_n87_), .O(new_n110_));
  aoi22  g66(.a(new_n110_), .b(new_n105_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n78_), .c(new_n65_), .O(z13));
  nand3  g68(.a(x26), .b(x25), .c(x16), .O(new_n113_));
  nand3  g69(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n113_), .c(x23), .d(x22), .O(new_n116_));
  nand2  g72(.a(x23), .b(x22), .O(new_n117_));
  nor3   g73(.a(new_n114_), .b(new_n117_), .c(x24), .O(new_n118_));
  aoi21  g74(.a(new_n116_), .b(x24), .c(new_n118_), .O(new_n119_));
  ...
  nand3  g79(.a(new_n123_), .b(new_n121_), .c(new_n115_), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(x24), .c(x23), .d(x22), .O(new_n126_));
  inv1   g82(.a(new_n126_), .O(new_n127_));
  aoi22  g83(.a(new_n127_), .b(new_n115_), .c(new_n124_), .d(x25), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n78_), .c(new_n69_), .O(z15));
  nor2   g85(.a(new_n52_), .b(x18), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n49_), .c(new_n45_), .O(new_n131_));
  inv1   g87(.a(x26), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(x25), .c(x22), .d(x21), .O(new_n133_));
  nand4  g89(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n134_));
  nor2   g90(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  aoi21  g91(.a(new_n131_), .b(x26), .c(new_n135_), .O(new_n136_));
