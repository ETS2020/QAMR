...
module FAU ( 
  ...
  oai21  g60(.a(new_n104_), .b(new_n102_), .c(new_n77_), .O(new_n105_));
  ...
  nand3  g67(.a(new_n107_), .b(x23), .c(x22), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(new_n94_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n111_), .c(new_n77_), .O(new_n114_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n117_), .c(new_n46_), .O(new_n119_));
  nor3   g75(.a(new_n116_), .b(new_n45_), .c(x25), .O(new_n120_));
  aoi21  g76(.a(new_n119_), .b(x25), .c(new_n120_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n76_), .c(new_n69_), .O(z15));
  inv1   g78(.a(x18), .O(new_n123_));
  nand3  g79(.a(x25), .b(x24), .c(new_n123_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n109_), .c(x26), .O(new_n125_));
  inv1   g81(.a(x26), .O(new_n126_));
  nand4  g82(.a(new_n117_), .b(new_n46_), .c(new_n126_), .d(x25), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n77_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n71_), .O(z16));
endmodule
