...
module FAU ( 
  ...
  oai22  g36(.a(new_n80_), .b(new_n78_), .c(new_n57_), .d(new_n59_), .O(z10));
  ...
  oai21  g44(.a(new_n88_), .b(new_n78_), .c(new_n61_), .O(z11));
  nand2  g45(.a(x23), .b(x14), .O(new_n90_));
  nand3  g46(.a(x21), .b(x20), .c(x19), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n90_), .b(new_n82_), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n78_), .c(new_n63_), .O(z12));
  ...
  aoi22  g60(.a(new_n104_), .b(new_n85_), .c(new_n102_), .d(x23), .O(new_n105_));
