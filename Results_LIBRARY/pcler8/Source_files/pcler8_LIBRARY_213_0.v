...
module FAU ( 
  ...
  nand2  g86(.a(new_n130_), .b(new_n115_), .O(new_n131_));
  nand4  g87(.a(x21), .b(x20), .c(x19), .d(x18), .O(new_n132_));
  nor2   g88(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  aoi21  g89(.a(new_n131_), .b(x26), .c(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n79_), .c(new_n72_), .O(z16));
endmodule
