...
module FAU ( 
  ...
  oai21  g34(.a(new_n78_), .b(new_n76_), .c(new_n56_), .O(z09));
  ...
  oai22  g39(.a(new_n83_), .b(new_n78_), .c(new_n59_), .d(new_n58_), .O(z10));
  ...
  oai22  g47(.a(new_n91_), .b(new_n78_), .c(new_n59_), .d(new_n61_), .O(z11));
  ...
  oai22  g63(.a(new_n107_), .b(new_n78_), .c(new_n59_), .d(new_n65_), .O(z13));
  ...
  oai22  g71(.a(new_n115_), .b(new_n78_), .c(new_n59_), .d(new_n67_), .O(z14));
  ...
  aoi21  g79(.a(new_n121_), .b(new_n59_), .c(new_n123_), .O(new_n124_));
  nand2  g80(.a(new_n77_), .b(x09), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n124_), .c(new_n69_), .O(z15));
  ...
  nand3  g87(.a(new_n87_), .b(x24), .c(x23), .O(new_n132_));
  inv1   g88(.a(new_n132_), .O(new_n133_));
  aoi22  g89(.a(new_n133_), .b(new_n131_), .c(new_n128_), .d(x26), .O(new_n134_));
