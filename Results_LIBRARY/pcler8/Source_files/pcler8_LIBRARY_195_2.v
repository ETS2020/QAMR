...
module FAU ( 
  ...
  oai21  g82(.a(new_n126_), .b(new_n87_), .c(x21), .O(new_n127_));
  inv1   g83(.a(x21), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(x18), .c(x26), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n75_), .O(new_n131_));
  oai21  g87(.a(new_n55_), .b(new_n69_), .c(new_n131_), .O(z16));
endmodule
