...
module FAU ( 
  ...
  nand4  g37(.a(x25), .b(x24), .c(x23), .d(x12), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n81_), .c(x19), .O(new_n83_));
  nor2   g39(.a(x20), .b(new_n74_), .O(new_n84_));
  aoi21  g40(.a(new_n83_), .b(x20), .c(new_n84_), .O(new_n85_));
  oai22  g41(.a(new_n85_), .b(new_n79_), .c(new_n58_), .d(new_n60_), .O(z10));
  ...
  oai21  g49(.a(new_n93_), .b(new_n79_), .c(new_n62_), .O(z11));
  ...
  oai21  g58(.a(new_n102_), .b(new_n79_), .c(new_n64_), .O(z12));
  ...
  nor3   g63(.a(new_n89_), .b(new_n81_), .c(x23), .O(new_n108_));
  aoi21  g64(.a(new_n107_), .b(x23), .c(new_n108_), .O(new_n109_));
