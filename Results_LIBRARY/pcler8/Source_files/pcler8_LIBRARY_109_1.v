// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:11 2020
...
module FAU ( 
  ...
  nand4  g09(.a(new_n53_), .b(new_n50_), .c(new_n48_), .d(new_n46_), .O(new_n54_));
  ...
  nand3  g31(.a(new_n75_), .b(x09), .c(new_n57_), .O(new_n76_));
  inv1   g32(.a(new_n76_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  oai21  g34(.a(new_n57_), .b(new_n56_), .c(new_n78_), .O(z09));
  ...
  nor2   g38(.a(x20), .b(new_n49_), .O(new_n83_));
  aoi21  g39(.a(new_n82_), .b(x20), .c(new_n83_), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n76_), .c(new_n57_), .d(new_n59_), .O(z10));
  inv1   g41(.a(x13), .O(new_n86_));
  nand2  g42(.a(x23), .b(x22), .O(new_n87_));
  nor3   g43(.a(new_n87_), .b(new_n80_), .c(new_n86_), .O(new_n88_));
  inv1   g44(.a(x21), .O(new_n89_));
  nand2  g45(.a(x20), .b(x19), .O(new_n90_));
  xor2a  g46(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n88_), .c(new_n77_), .O(new_n92_));
  ...
  oai21  g52(.a(new_n94_), .b(new_n80_), .c(new_n96_), .O(new_n97_));
  nand4  g53(.a(new_n52_), .b(x21), .c(x20), .d(x19), .O(new_n98_));
  inv1   g54(.a(new_n98_), .O(new_n99_));
  aoi21  g55(.a(new_n97_), .b(x22), .c(new_n99_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n76_), .c(new_n63_), .O(z12));
  ...
  nor3   g63(.a(new_n107_), .b(new_n90_), .c(x23), .O(new_n108_));
  ...
  nand4  g67(.a(new_n111_), .b(new_n96_), .c(x23), .d(x22), .O(new_n112_));
  nor3   g68(.a(new_n95_), .b(new_n87_), .c(x24), .O(new_n113_));
  ...
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n96_), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(x24), .c(x23), .d(x22), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  aoi22  g78(.a(new_n122_), .b(new_n96_), .c(new_n119_), .d(x25), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n76_), .c(new_n69_), .O(z15));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(x25), .b(x24), .c(new_n125_), .O(new_n126_));
  nand4  g82(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n126_), .c(x26), .O(new_n128_));
  and2   g84(.a(x24), .b(x23), .O(new_n129_));
  inv1   g85(.a(new_n90_), .O(new_n130_));
  inv1   g86(.a(new_n107_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n120_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n129_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n128_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n77_), .O(new_n135_));
