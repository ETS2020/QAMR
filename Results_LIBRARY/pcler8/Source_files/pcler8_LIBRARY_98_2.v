// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:09 2020
...
module FAU ( 
  ...
  nand3  g56(.a(x25), .b(x24), .c(x15), .O(new_n101_));
  ...
  nand2  g68(.a(x25), .b(x16), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n110_), .O(new_n114_));
  nor3   g70(.a(new_n111_), .b(new_n109_), .c(x24), .O(new_n115_));
  aoi21  g71(.a(new_n114_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n74_), .c(new_n65_), .O(z14));
  inv1   g73(.a(x17), .O(new_n118_));
  nand3  g74(.a(x24), .b(x23), .c(new_n118_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n102_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nand4  g77(.a(new_n112_), .b(new_n110_), .c(new_n121_), .d(x24), .O(new_n122_));
  ...
  nand3  g84(.a(new_n128_), .b(new_n85_), .c(new_n126_), .O(new_n129_));
  inv1   g85(.a(x26), .O(new_n130_));
  nor2   g86(.a(new_n130_), .b(x21), .O(new_n131_));
  aoi21  g87(.a(new_n129_), .b(x21), .c(new_n131_), .O(new_n132_));
