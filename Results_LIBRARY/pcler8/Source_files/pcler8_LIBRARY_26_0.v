...
module FAU ( 
  ...
  oai21  g44(.a(x21), .b(new_n88_), .c(x19), .O(new_n89_));
  aoi21  g45(.a(new_n87_), .b(x21), .c(new_n89_), .O(new_n90_));
  oai22  g46(.a(new_n90_), .b(new_n78_), .c(new_n57_), .d(new_n61_), .O(z11));
  nand2  g47(.a(x23), .b(x14), .O(new_n92_));
  nand3  g48(.a(x21), .b(x20), .c(x19), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n92_), .b(new_n85_), .c(new_n94_), .O(new_n95_));
  ...
  nor2   g56(.a(new_n88_), .b(new_n52_), .O(new_n101_));
  ...
  aoi22  g63(.a(new_n107_), .b(new_n101_), .c(new_n105_), .d(x23), .O(new_n108_));
