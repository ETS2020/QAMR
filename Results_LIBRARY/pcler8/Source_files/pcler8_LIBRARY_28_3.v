...
module FAU ( 
  ...
  and2   g44(.a(x20), .b(x19), .O(new_n89_));
  oai21  g45(.a(new_n88_), .b(new_n87_), .c(new_n89_), .O(new_n90_));
  nand2  g46(.a(x20), .b(x19), .O(new_n91_));
  nor2   g47(.a(new_n91_), .b(x21), .O(new_n92_));
  aoi21  g48(.a(new_n90_), .b(x21), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g55(.a(new_n89_), .b(new_n99_), .c(x21), .O(new_n100_));
  ...
  oai22  g62(.a(new_n106_), .b(new_n87_), .c(new_n105_), .d(new_n91_), .O(new_n107_));
  nand4  g63(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n108_));
  and2   g64(.a(new_n108_), .b(x23), .O(new_n109_));
  aoi21  g65(.a(new_n107_), .b(x21), .c(new_n109_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n80_), .c(new_n67_), .O(z13));
  nand3  g67(.a(new_n45_), .b(x23), .c(x22), .O(new_n112_));
  nand4  g68(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n113_));
  oai21  g69(.a(new_n112_), .b(new_n91_), .c(new_n113_), .O(new_n114_));
  nor2   g70(.a(new_n104_), .b(new_n99_), .O(new_n115_));
  aoi21  g71(.a(new_n97_), .b(new_n115_), .c(new_n45_), .O(new_n116_));
  aoi21  g72(.a(new_n114_), .b(x21), .c(new_n116_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n80_), .c(new_n69_), .O(z14));
  nand4  g74(.a(new_n46_), .b(x24), .c(x23), .d(x22), .O(new_n119_));
  nand3  g75(.a(x26), .b(x25), .c(x17), .O(new_n120_));
  oai21  g76(.a(new_n119_), .b(new_n91_), .c(new_n120_), .O(new_n121_));
  nor2   g77(.a(new_n45_), .b(new_n104_), .O(new_n122_));
  nand4  g78(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n122_), .c(new_n46_), .O(new_n125_));
  aoi21  g81(.a(new_n121_), .b(x21), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n80_), .c(new_n71_), .O(z15));
  nor2   g83(.a(new_n54_), .b(x18), .O(new_n128_));
  nand3  g84(.a(new_n128_), .b(new_n51_), .c(new_n47_), .O(new_n129_));
  inv1   g85(.a(x26), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(x25), .c(x24), .d(x23), .O(new_n131_));
  nor2   g87(.a(new_n131_), .b(new_n108_), .O(new_n132_));
  aoi21  g88(.a(new_n129_), .b(x26), .c(new_n132_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n80_), .c(new_n73_), .O(z16));
endmodule
