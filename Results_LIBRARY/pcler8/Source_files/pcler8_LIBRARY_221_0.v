...
module FAU ( 
  ...
  nor2   g06(.a(new_n50_), .b(x10), .O(new_n51_));
  ...
  nor2   g31(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  inv1   g32(.a(x10), .O(new_n77_));
  nand2  g33(.a(new_n49_), .b(new_n77_), .O(new_n78_));
  ...
  nor2   g37(.a(x20), .b(new_n50_), .O(new_n82_));
  ...
  nand4  g73(.a(new_n117_), .b(new_n112_), .c(new_n46_), .d(x24), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(x24), .c(x23), .d(x22), .O(new_n120_));
  nor2   g76(.a(new_n120_), .b(new_n111_), .O(new_n121_));
  ...
  oai21  g80(.a(new_n119_), .b(x18), .c(x09), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(x24), .b(x23), .c(x22), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n111_), .c(new_n126_), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  nand3  g85(.a(new_n124_), .b(x25), .c(x24), .O(new_n130_));
  nand4  g86(.a(x21), .b(x20), .c(x19), .d(x09), .O(new_n131_));
  nor3   g87(.a(new_n131_), .b(new_n130_), .c(new_n45_), .O(new_n132_));
  nor2   g88(.a(x10), .b(x08), .O(new_n133_));
  oai21  g89(.a(new_n132_), .b(new_n129_), .c(new_n133_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n71_), .O(z16));
endmodule
