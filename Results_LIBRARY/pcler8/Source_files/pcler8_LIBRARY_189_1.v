...
module FAU ( 
  ...
  nand2  g58(.a(x22), .b(x21), .O(new_n103_));
  nor2   g59(.a(new_n103_), .b(x23), .O(new_n104_));
  aoi22  g60(.a(new_n104_), .b(new_n88_), .c(new_n102_), .d(x23), .O(new_n105_));
  oai22  g61(.a(new_n105_), .b(new_n78_), .c(new_n57_), .d(new_n65_), .O(z13));
  ...
  nor2   g83(.a(new_n127_), .b(new_n102_), .O(new_n128_));
  aoi21  g84(.a(new_n125_), .b(x26), .c(new_n128_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
