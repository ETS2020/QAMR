...
module FAU ( 
  ...
  nand3  g58(.a(x25), .b(x24), .c(x15), .O(new_n103_));
  ...
  nor2   g63(.a(new_n107_), .b(x23), .O(new_n108_));
  aoi22  g64(.a(new_n108_), .b(new_n89_), .c(new_n106_), .d(x23), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n79_), .c(new_n66_), .O(z13));
  nand3  g66(.a(x26), .b(x25), .c(x16), .O(new_n111_));
  nand3  g67(.a(x21), .b(x20), .c(x19), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n111_), .c(new_n48_), .O(new_n114_));
  nor3   g70(.a(new_n112_), .b(new_n47_), .c(x24), .O(new_n115_));
  ...
  oai21  g89(.a(new_n133_), .b(new_n79_), .c(new_n72_), .O(z16));
endmodule
