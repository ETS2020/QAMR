...
module FAU ( 
  ...
  aoi22  g39(.a(new_n83_), .b(new_n74_), .c(new_n81_), .d(new_n57_), .O(new_n84_));
  nand2  g40(.a(new_n78_), .b(x09), .O(new_n85_));
  ...
  oai21  g49(.a(new_n93_), .b(new_n79_), .c(new_n61_), .O(z11));
  ...
  oai21  g58(.a(new_n102_), .b(new_n79_), .c(new_n63_), .O(z12));
  ...
  oai21  g66(.a(new_n110_), .b(new_n79_), .c(new_n65_), .O(z13));
  ...
  oai21  g74(.a(new_n118_), .b(new_n79_), .c(new_n67_), .O(z14));
  ...
  oai21  g83(.a(new_n127_), .b(new_n79_), .c(new_n69_), .O(z15));
  ...
  oai21  g91(.a(new_n135_), .b(new_n79_), .c(new_n71_), .O(z16));
endmodule
