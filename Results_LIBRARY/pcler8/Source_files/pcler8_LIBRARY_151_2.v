...
module FAU ( 
  ...
  nand3  g07(.a(new_n51_), .b(x19), .c(new_n48_), .O(new_n52_));
  nor2   g08(.a(new_n52_), .b(new_n47_), .O(new_n53_));
  nand4  g09(.a(new_n53_), .b(x26), .c(x25), .d(x24), .O(new_n54_));
  inv1   g10(.a(new_n54_), .O(z00));
  inv1   g11(.a(x00), .O(new_n56_));
  nor2   g12(.a(new_n49_), .b(new_n56_), .O(z01));
  inv1   g13(.a(x01), .O(new_n58_));
  nor2   g14(.a(new_n49_), .b(new_n58_), .O(z02));
  inv1   g15(.a(x02), .O(new_n60_));
  nor2   g16(.a(new_n49_), .b(new_n60_), .O(z03));
  ...
  nor2   g24(.a(new_n49_), .b(new_n68_), .O(z07));
  ...
  nand2  g31(.a(new_n51_), .b(new_n48_), .O(new_n76_));
  inv1   g32(.a(new_n76_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  oai21  g34(.a(new_n49_), .b(new_n56_), .c(new_n78_), .O(z09));
  ...
  oai22  g40(.a(new_n84_), .b(new_n76_), .c(new_n49_), .d(new_n58_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n76_), .c(new_n49_), .d(new_n60_), .O(z11));
  ...
  nor2   g76(.a(new_n103_), .b(x10), .O(new_n121_));
  nand4  g77(.a(new_n103_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(new_n95_), .O(new_n123_));
  aoi21  g79(.a(new_n121_), .b(new_n120_), .c(new_n123_), .O(new_n124_));
  oai22  g80(.a(new_n124_), .b(new_n50_), .c(new_n49_), .d(new_n68_), .O(z15));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(x22), .b(x21), .c(new_n126_), .O(new_n127_));
  nand4  g83(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n127_), .c(x26), .O(new_n129_));
  inv1   g85(.a(new_n128_), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n103_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n130_), .c(new_n73_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n129_), .c(x10), .O(new_n133_));
  nor2   g89(.a(new_n104_), .b(x25), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n133_), .c(new_n51_), .O(new_n135_));
