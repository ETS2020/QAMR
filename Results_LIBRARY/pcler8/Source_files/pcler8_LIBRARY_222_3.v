// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:33 2020
...
module FAU ( 
  ...
  oai21  g68(.a(new_n94_), .b(new_n112_), .c(x24), .O(new_n113_));
  nand3  g69(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nor2   g71(.a(new_n112_), .b(x24), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n113_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n102_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n67_), .O(z14));
