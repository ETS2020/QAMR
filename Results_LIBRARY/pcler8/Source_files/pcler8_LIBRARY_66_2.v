...
module FAU ( 
  ...
  oai21  g49(.a(new_n93_), .b(new_n80_), .c(new_n87_), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nor2   g51(.a(new_n95_), .b(x21), .O(new_n96_));
  aoi21  g52(.a(new_n94_), .b(x21), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g68(.a(new_n108_), .b(x23), .c(x21), .O(new_n113_));
  nor2   g69(.a(new_n113_), .b(new_n89_), .O(new_n114_));
