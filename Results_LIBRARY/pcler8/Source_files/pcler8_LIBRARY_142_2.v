...
module FAU ( 
  ...
  nand3  g02(.a(new_n46_), .b(x25), .c(x24), .O(new_n47_));
  ...
  nor2   g27(.a(new_n59_), .b(new_n71_), .O(z08));
  ...
  nand4  g49(.a(x25), .b(x24), .c(x23), .d(x14), .O(new_n94_));
  ...
  nor2   g63(.a(new_n107_), .b(new_n89_), .O(new_n108_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n104_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nand4  g77(.a(new_n112_), .b(new_n46_), .c(new_n121_), .d(x24), .O(new_n122_));
  ...
  aoi21  g83(.a(x24), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand3  g84(.a(new_n112_), .b(new_n46_), .c(x25), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(x24), .c(new_n128_), .O(new_n130_));
  oai22  g86(.a(new_n130_), .b(new_n76_), .c(new_n59_), .d(new_n71_), .O(z16));
endmodule
