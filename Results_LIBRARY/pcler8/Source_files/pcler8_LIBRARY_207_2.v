...
module FAU ( 
  ...
  nand4  g81(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n126_));
  inv1   g82(.a(new_n126_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(x21), .c(x20), .O(new_n128_));
  inv1   g84(.a(x18), .O(new_n129_));
  inv1   g85(.a(x26), .O(new_n130_));
  aoi21  g86(.a(x19), .b(new_n129_), .c(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n128_), .b(x19), .c(new_n131_), .O(new_n132_));
