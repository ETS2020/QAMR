...
module FAU ( 
  ...
  nand4  g15(.a(new_n19_), .b(new_n16_), .c(new_n29_), .d(x2), .O(z4));
  nand4  g16(.a(new_n22_), .b(new_n16_), .c(new_n29_), .d(x2), .O(z5));
  nand4  g17(.a(new_n25_), .b(new_n16_), .c(new_n29_), .d(x2), .O(z6));
  nand4  g18(.a(new_n27_), .b(new_n16_), .c(new_n29_), .d(x2), .O(z7));
endmodule
