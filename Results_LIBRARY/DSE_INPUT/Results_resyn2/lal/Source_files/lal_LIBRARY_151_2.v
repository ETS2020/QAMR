// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:49 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n57_), .b(new_n74_), .c(new_n73_), .O(new_n77_));
  ...
  nor3   g37(.a(new_n77_), .b(new_n82_), .c(x17), .O(z11));
  nand2  g38(.a(x19), .b(x17), .O(new_n84_));
  inv1   g39(.a(new_n84_), .O(new_n85_));
  nor2   g40(.a(x19), .b(x17), .O(new_n86_));
  nor3   g41(.a(new_n86_), .b(new_n85_), .c(new_n77_), .O(z12));
  nand2  g42(.a(new_n84_), .b(x20), .O(new_n88_));
  nor2   g43(.a(new_n84_), .b(x20), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n88_), .c(new_n78_), .O(z13));
  nand2  g46(.a(new_n90_), .b(x21), .O(new_n92_));
  nand2  g47(.a(new_n89_), .b(new_n52_), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n78_), .O(z14));
  nand2  g49(.a(new_n93_), .b(x22), .O(new_n95_));
  inv1   g50(.a(new_n93_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n53_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n95_), .c(new_n78_), .O(z15));
  oai21  g53(.a(new_n93_), .b(x22), .c(x23), .O(new_n99_));
  nor2   g54(.a(x23), .b(x22), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n96_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n78_), .O(z16));
  inv1   g57(.a(new_n100_), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n93_), .c(x24), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(new_n48_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n96_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n104_), .c(new_n78_), .O(z17));
  nand3  g63(.a(new_n106_), .b(new_n96_), .c(new_n49_), .O(new_n109_));
  oai21  g64(.a(new_n105_), .b(new_n93_), .c(x25), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n78_), .O(z18));
  buf    g66(.a(x16), .O(z02));
endmodule
