...
module FAU ( 
  ...
  nor3   g39(.a(new_n84_), .b(new_n78_), .c(new_n82_), .O(z11));
  nor2   g40(.a(new_n84_), .b(x19), .O(new_n86_));
  nand2  g41(.a(new_n84_), .b(x19), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n79_), .O(new_n88_));
  nor2   g43(.a(new_n88_), .b(new_n86_), .O(z12));
  nand2  g44(.a(new_n87_), .b(x20), .O(new_n90_));
  nand3  g45(.a(new_n84_), .b(new_n50_), .c(x19), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n79_), .O(z13));
  nand2  g47(.a(new_n91_), .b(x21), .O(new_n93_));
  inv1   g48(.a(new_n91_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n52_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n93_), .c(new_n79_), .O(z14));
  oai21  g51(.a(new_n91_), .b(x21), .c(x22), .O(new_n97_));
  nand3  g52(.a(new_n94_), .b(new_n53_), .c(new_n52_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n79_), .O(z15));
  inv1   g54(.a(x23), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand4  g56(.a(new_n53_), .b(new_n52_), .c(new_n50_), .d(x19), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(new_n103_));
  nor2   g58(.a(x23), .b(x19), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n103_), .c(new_n79_), .O(z16));
  nand2  g60(.a(new_n79_), .b(new_n48_), .O(z17));
  nand2  g61(.a(new_n79_), .b(new_n49_), .O(z18));
  buf    g62(.a(x16), .O(z02));
endmodule
