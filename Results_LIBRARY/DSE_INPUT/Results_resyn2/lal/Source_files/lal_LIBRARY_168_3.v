// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:56 2020
...
module FAU ( 
  ...
  aoi21  g32(.a(new_n77_), .b(new_n49_), .c(new_n51_), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(x23), .c(x24), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n48_), .O(z08));
  ...
  nand3  g39(.a(new_n58_), .b(new_n82_), .c(new_n81_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n74_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z10));
  nor2   g43(.a(new_n75_), .b(new_n74_), .O(new_n89_));
  nor2   g44(.a(x18), .b(x17), .O(new_n90_));
  nor3   g45(.a(new_n90_), .b(new_n89_), .c(new_n85_), .O(z11));
  nor2   g46(.a(new_n89_), .b(x19), .O(new_n92_));
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nor3   g49(.a(new_n94_), .b(new_n92_), .c(new_n85_), .O(z12));
  nand2  g50(.a(new_n93_), .b(x20), .O(new_n96_));
  nand2  g51(.a(new_n94_), .b(new_n49_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n86_), .O(z13));
  inv1   g53(.a(x21), .O(new_n99_));
  nor2   g54(.a(new_n93_), .b(x20), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g56(.a(new_n97_), .b(x21), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n101_), .c(new_n86_), .O(z14));
  nand2  g58(.a(new_n101_), .b(x22), .O(new_n104_));
  inv1   g59(.a(x22), .O(new_n105_));
  nand3  g60(.a(new_n100_), .b(new_n105_), .c(new_n99_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n86_), .O(z15));
  inv1   g62(.a(x23), .O(new_n108_));
  nand3  g63(.a(new_n106_), .b(new_n86_), .c(new_n108_), .O(z16));
  nand2  g64(.a(new_n106_), .b(x24), .O(new_n110_));
  nand3  g65(.a(new_n54_), .b(new_n105_), .c(new_n99_), .O(new_n111_));
  or2    g66(.a(new_n111_), .b(new_n97_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n86_), .O(z17));
  nand2  g68(.a(x25), .b(x24), .O(new_n114_));
  nand2  g69(.a(new_n94_), .b(new_n48_), .O(new_n115_));
  oai21  g70(.a(new_n115_), .b(new_n111_), .c(new_n114_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n49_), .O(new_n117_));
  aoi21  g72(.a(new_n106_), .b(x25), .c(new_n85_), .O(new_n118_));
