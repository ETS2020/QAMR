...
module FAU ( 
  ...
  nand2  g40(.a(new_n49_), .b(x17), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(x21), .c(x19), .O(new_n87_));
  nand2  g42(.a(new_n83_), .b(x19), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n79_), .O(new_n89_));
  aoi21  g44(.a(new_n87_), .b(new_n85_), .c(new_n89_), .O(z12));
  nand2  g45(.a(new_n88_), .b(x20), .O(new_n91_));
  nor2   g46(.a(x20), .b(new_n52_), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(new_n83_), .c(new_n78_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n91_), .O(z13));
  nand2  g49(.a(new_n92_), .b(x18), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(x21), .O(new_n96_));
  aoi21  g51(.a(new_n92_), .b(new_n50_), .c(new_n78_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n96_), .O(z14));
  inv1   g53(.a(x22), .O(new_n99_));
  nand2  g54(.a(new_n79_), .b(new_n99_), .O(z15));
  inv1   g55(.a(x23), .O(new_n101_));
  nand2  g56(.a(new_n79_), .b(new_n101_), .O(z16));
  inv1   g57(.a(x24), .O(new_n103_));
  nand2  g58(.a(new_n79_), .b(new_n103_), .O(z17));
  nand2  g59(.a(new_n79_), .b(new_n48_), .O(z18));
  buf    g60(.a(x16), .O(z02));
endmodule
