...
module FAU ( 
  ...
  oai21  g36(.a(new_n58_), .b(new_n51_), .c(new_n74_), .O(new_n82_));
  nor2   g37(.a(new_n51_), .b(new_n50_), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z11));
  nand2  g39(.a(new_n83_), .b(x19), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  nor2   g41(.a(new_n83_), .b(x19), .O(new_n87_));
  nor3   g42(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(z12));
  nand2  g43(.a(new_n85_), .b(x20), .O(new_n89_));
  nand4  g44(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n90_));
  nand2  g45(.a(new_n74_), .b(new_n58_), .O(new_n91_));
  ...
  nand2  g53(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n92_), .O(z15));
  nand2  g56(.a(new_n99_), .b(x23), .O(new_n102_));
  nor2   g57(.a(x23), .b(x22), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n95_), .c(new_n91_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n102_), .O(z16));
  inv1   g60(.a(x24), .O(new_n106_));
  nand3  g61(.a(new_n103_), .b(new_n95_), .c(new_n106_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n103_), .O(new_n109_));
  oai21  g64(.a(new_n109_), .b(new_n85_), .c(x24), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n92_), .O(z17));
  nand4  g66(.a(new_n103_), .b(new_n95_), .c(new_n48_), .d(new_n106_), .O(new_n112_));
  nand2  g67(.a(new_n107_), .b(x25), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n92_), .O(z18));
  buf    g69(.a(x16), .O(z02));
endmodule
