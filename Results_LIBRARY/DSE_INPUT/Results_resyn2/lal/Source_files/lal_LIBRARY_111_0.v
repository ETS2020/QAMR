// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:32 2020
...
module FAU ( 
  ...
  nand3  g27(.a(new_n52_), .b(new_n70_), .c(new_n69_), .O(new_n73_));
  inv1   g28(.a(x17), .O(new_n74_));
  oai21  g29(.a(x25), .b(x18), .c(new_n74_), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(new_n73_), .O(z10));
  xnor2a g31(.a(x18), .b(x17), .O(new_n77_));
  nor2   g32(.a(new_n77_), .b(new_n73_), .O(z11));
  aoi21  g33(.a(x18), .b(x17), .c(x19), .O(new_n79_));
  nand3  g34(.a(x19), .b(x18), .c(x17), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(new_n81_));
  nor3   g36(.a(new_n81_), .b(new_n79_), .c(new_n73_), .O(z12));
  inv1   g37(.a(new_n73_), .O(new_n83_));
  inv1   g38(.a(x20), .O(new_n84_));
  nand2  g39(.a(new_n81_), .b(new_n84_), .O(new_n85_));
  nand2  g40(.a(new_n80_), .b(x20), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(z13));
  nand2  g42(.a(new_n85_), .b(x21), .O(new_n88_));
  nor2   g43(.a(x21), .b(x20), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n81_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n88_), .c(new_n83_), .O(z14));
  nand2  g46(.a(new_n90_), .b(x22), .O(new_n92_));
  inv1   g47(.a(x22), .O(new_n93_));
  nand3  g48(.a(new_n89_), .b(new_n81_), .c(new_n93_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n92_), .c(new_n83_), .O(z15));
  nand2  g50(.a(new_n94_), .b(x23), .O(new_n96_));
  inv1   g51(.a(x21), .O(new_n97_));
  nand4  g52(.a(new_n48_), .b(new_n93_), .c(new_n97_), .d(new_n84_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n81_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n96_), .c(new_n83_), .O(z16));
  nor2   g56(.a(x23), .b(x22), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n89_), .c(new_n81_), .d(new_n49_), .O(new_n103_));
  oai21  g58(.a(new_n98_), .b(new_n80_), .c(x24), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n83_), .O(z17));
  nand3  g60(.a(new_n102_), .b(new_n89_), .c(x19), .O(new_n106_));
  nand2  g61(.a(new_n49_), .b(x17), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n106_), .c(x25), .O(new_n108_));
  inv1   g63(.a(x25), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n49_), .c(x17), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n99_), .c(x19), .O(new_n112_));
  nor2   g67(.a(x18), .b(new_n74_), .O(new_n113_));
  nor2   g68(.a(new_n113_), .b(new_n73_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n108_), .O(z18));
  buf    g70(.a(x16), .O(z02));
endmodule
