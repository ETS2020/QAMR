// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:35 2020
...
module FAU ( 
  ...
  nand3  g41(.a(new_n52_), .b(new_n83_), .c(new_n82_), .O(new_n87_));
  ...
  or2    g46(.a(new_n87_), .b(new_n91_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z11));
  nor2   g48(.a(new_n91_), .b(x19), .O(new_n94_));
  nor3   g49(.a(new_n94_), .b(new_n87_), .c(new_n75_), .O(z12));
  nand2  g50(.a(new_n74_), .b(x20), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n88_), .c(new_n69_), .O(z13));
  nand2  g52(.a(new_n69_), .b(x21), .O(new_n98_));
  inv1   g53(.a(new_n69_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n70_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n88_), .O(z14));
  inv1   g56(.a(x19), .O(new_n102_));
  nor2   g57(.a(x20), .b(new_n102_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n91_), .c(new_n71_), .d(new_n70_), .O(new_n104_));
  nand2  g59(.a(new_n100_), .b(x22), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n104_), .c(new_n88_), .O(z15));
  nand2  g61(.a(new_n104_), .b(x23), .O(new_n107_));
  nor2   g62(.a(x23), .b(x22), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n103_), .c(new_n91_), .d(new_n70_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n88_), .O(z16));
  inv1   g65(.a(new_n72_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n99_), .O(new_n112_));
  nand2  g67(.a(new_n109_), .b(x24), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n88_), .c(new_n112_), .O(z17));
  nand2  g69(.a(new_n73_), .b(new_n78_), .O(new_n115_));
  nand2  g70(.a(new_n112_), .b(x25), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n88_), .O(z18));
  buf    g72(.a(x16), .O(z02));
endmodule
