...
module FAU ( 
  ...
  oai21  g04(.a(new_n49_), .b(x20), .c(x21), .O(new_n50_));
  nand2  g05(.a(x24), .b(x22), .O(new_n51_));
  ...
  aoi21  g30(.a(new_n75_), .b(new_n71_), .c(new_n72_), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(x22), .c(x23), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(new_n69_), .c(new_n70_), .O(z08));
  ...
  nand3  g38(.a(new_n53_), .b(new_n80_), .c(new_n79_), .O(new_n84_));
  ...
  nor3   g44(.a(new_n89_), .b(new_n84_), .c(new_n74_), .O(z11));
  nand3  g45(.a(x19), .b(x18), .c(x17), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n85_), .O(new_n92_));
  aoi21  g47(.a(new_n88_), .b(new_n73_), .c(new_n92_), .O(z12));
  nand2  g48(.a(new_n91_), .b(x20), .O(new_n94_));
  inv1   g49(.a(new_n91_), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n94_), .c(new_n85_), .O(z13));
  nand2  g52(.a(new_n96_), .b(x21), .O(new_n98_));
  nor2   g53(.a(new_n91_), .b(x21), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n71_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n85_), .O(z14));
  nand2  g56(.a(new_n100_), .b(x22), .O(new_n102_));
  inv1   g57(.a(x22), .O(new_n103_));
  nand3  g58(.a(new_n99_), .b(new_n103_), .c(new_n71_), .O(new_n104_));
  and2   g59(.a(new_n104_), .b(new_n85_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n102_), .O(z15));
  nand2  g61(.a(new_n105_), .b(new_n48_), .O(z16));
  aoi21  g62(.a(new_n104_), .b(x24), .c(new_n84_), .O(new_n108_));
  oai21  g63(.a(new_n104_), .b(x24), .c(new_n108_), .O(z17));
  nand2  g64(.a(new_n104_), .b(x25), .O(new_n110_));
  nand2  g65(.a(new_n95_), .b(new_n72_), .O(new_n111_));
  nand3  g66(.a(new_n70_), .b(new_n69_), .c(new_n103_), .O(new_n112_));
  oai22  g67(.a(new_n112_), .b(new_n111_), .c(new_n70_), .d(new_n69_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n71_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n110_), .c(new_n85_), .O(z18));
  buf    g70(.a(x16), .O(z02));
endmodule
