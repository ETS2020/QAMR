...
module FAU ( 
  ...
  nand2  g47(.a(new_n90_), .b(new_n78_), .O(new_n93_));
  aoi21  g48(.a(new_n55_), .b(x18), .c(new_n93_), .O(z10));
  aoi21  g49(.a(new_n54_), .b(x18), .c(x17), .O(new_n95_));
  nand2  g50(.a(x18), .b(x17), .O(new_n96_));
  nand2  g51(.a(new_n90_), .b(new_n96_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n95_), .O(z11));
  nand2  g53(.a(new_n55_), .b(x18), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(new_n81_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n90_), .d(new_n71_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(z12));
  nand2  g57(.a(new_n71_), .b(x20), .O(new_n103_));
  nand2  g58(.a(new_n90_), .b(new_n54_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n73_), .O(z13));
  nand2  g61(.a(new_n73_), .b(x21), .O(new_n107_));
  inv1   g62(.a(x21), .O(new_n108_));
  nor2   g63(.a(new_n71_), .b(x20), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n105_), .O(z14));
  nand2  g66(.a(new_n110_), .b(x22), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n105_), .O(z15));
  nand3  g70(.a(new_n113_), .b(new_n109_), .c(new_n48_), .O(new_n116_));
  nand2  g71(.a(new_n114_), .b(x23), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n105_), .O(z16));
  nand2  g73(.a(new_n116_), .b(x24), .O(new_n119_));
  nand3  g74(.a(new_n75_), .b(new_n109_), .c(new_n48_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n119_), .c(new_n105_), .O(z17));
  aoi21  g76(.a(new_n120_), .b(x25), .c(new_n104_), .O(new_n122_));
  oai21  g77(.a(new_n116_), .b(new_n86_), .c(new_n122_), .O(z18));
  buf    g78(.a(x16), .O(z02));
endmodule
