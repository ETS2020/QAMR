...
module FAU ( 
  ...
  aoi21  g43(.a(new_n86_), .b(x20), .c(new_n78_), .O(new_n89_));
  oai21  g44(.a(new_n86_), .b(x20), .c(new_n89_), .O(z13));
  nor2   g45(.a(new_n86_), .b(x20), .O(new_n91_));
  nand2  g46(.a(x19), .b(x17), .O(new_n92_));
  aoi21  g47(.a(new_n92_), .b(x18), .c(x21), .O(new_n93_));
  oai21  g48(.a(new_n93_), .b(new_n91_), .c(new_n79_), .O(z14));
  inv1   g49(.a(x22), .O(new_n95_));
  nand2  g50(.a(new_n79_), .b(new_n95_), .O(z15));
  inv1   g51(.a(x23), .O(new_n97_));
  nand2  g52(.a(new_n79_), .b(new_n97_), .O(z16));
  inv1   g53(.a(x24), .O(new_n99_));
  nand2  g54(.a(new_n79_), .b(new_n99_), .O(z17));
  nand2  g55(.a(new_n79_), .b(new_n48_), .O(z18));
  buf    g56(.a(x16), .O(z02));
endmodule
