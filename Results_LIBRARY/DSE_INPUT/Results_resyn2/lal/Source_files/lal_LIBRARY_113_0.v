...
module FAU ( 
  ...
  nand3  g23(.a(new_n68_), .b(x18), .c(x17), .O(new_n69_));
  ...
  nand3  g31(.a(new_n76_), .b(new_n75_), .c(new_n49_), .O(new_n77_));
  oai21  g32(.a(new_n77_), .b(new_n73_), .c(x25), .O(new_n78_));
  nand2  g33(.a(x22), .b(x21), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n48_), .c(new_n49_), .O(new_n80_));
  oai22  g35(.a(new_n80_), .b(x25), .c(x23), .d(x20), .O(new_n81_));
  ...
  nor3   g47(.a(new_n92_), .b(new_n88_), .c(new_n75_), .O(z11));
  nor2   g48(.a(new_n75_), .b(x19), .O(new_n94_));
  nand2  g49(.a(new_n75_), .b(x19), .O(new_n95_));
  ...
  nand2  g54(.a(new_n99_), .b(x19), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n89_), .O(z13));
  nand2  g56(.a(new_n100_), .b(x21), .O(new_n102_));
  nand3  g57(.a(new_n99_), .b(new_n70_), .c(x19), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n102_), .c(new_n89_), .O(z14));
  nand2  g59(.a(new_n103_), .b(x22), .O(new_n105_));
  nand4  g60(.a(new_n76_), .b(new_n75_), .c(new_n68_), .d(x19), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n105_), .c(new_n89_), .O(z15));
  oai21  g62(.a(new_n74_), .b(x19), .c(new_n48_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n99_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n109_), .c(new_n89_), .O(z16));
  inv1   g67(.a(new_n72_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n99_), .O(new_n114_));
  nand2  g69(.a(new_n111_), .b(x24), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n89_), .c(new_n114_), .O(z17));
  nor2   g71(.a(x25), .b(x24), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n110_), .c(new_n99_), .O(new_n118_));
