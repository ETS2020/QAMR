// Benchmark "FAU" written by ABC on Mon Jul 27 19:16:19 2020
...
module FAU ( 
  ...
  nor2   g36(.a(new_n79_), .b(x19), .O(new_n82_));
  nand3  g37(.a(x19), .b(x18), .c(x17), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n75_), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(new_n82_), .O(z12));
  nand2  g40(.a(x19), .b(x17), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x20), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x18), .O(new_n88_));
  nand2  g43(.a(new_n83_), .b(x20), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n75_), .O(z13));
  inv1   g45(.a(x21), .O(new_n91_));
  nand3  g46(.a(new_n87_), .b(new_n91_), .c(x18), .O(new_n92_));
  nand2  g47(.a(new_n88_), .b(x21), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n75_), .O(z14));
  nand2  g49(.a(new_n92_), .b(x22), .O(new_n95_));
  inv1   g50(.a(new_n83_), .O(new_n96_));
  nor3   g51(.a(x22), .b(x21), .c(x20), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n74_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n95_), .O(z15));
  nand3  g54(.a(new_n97_), .b(x19), .c(x17), .O(new_n100_));
  ...
  aoi21  g58(.a(x19), .b(new_n78_), .c(new_n74_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(z16));
  nand2  g60(.a(new_n103_), .b(x24), .O(new_n106_));
  nand3  g61(.a(new_n102_), .b(new_n87_), .c(new_n49_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n106_), .c(new_n75_), .O(z17));
  nand2  g63(.a(new_n107_), .b(x25), .O(new_n109_));
  nor2   g64(.a(x23), .b(x22), .O(new_n110_));
  nor2   g65(.a(x25), .b(x24), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n110_), .c(new_n87_), .d(new_n91_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n75_), .O(z18));
  buf    g68(.a(x16), .O(z02));
endmodule
