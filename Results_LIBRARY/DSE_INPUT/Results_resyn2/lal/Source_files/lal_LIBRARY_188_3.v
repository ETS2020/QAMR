...
module FAU ( 
  ...
  oai21  g03(.a(new_n48_), .b(x20), .c(x21), .O(new_n49_));
  oai21  g04(.a(x23), .b(x22), .c(x24), .O(new_n50_));
  aoi21  g05(.a(new_n49_), .b(x22), .c(new_n50_), .O(new_n51_));
  ...
  nor2   g31(.a(new_n76_), .b(new_n71_), .O(new_n77_));
  ...
  nand3  g39(.a(x24), .b(new_n84_), .c(new_n83_), .O(new_n85_));
  nor2   g40(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  oai21  g41(.a(new_n86_), .b(x25), .c(new_n81_), .O(new_n87_));
  aoi21  g42(.a(new_n82_), .b(new_n74_), .c(new_n75_), .O(new_n88_));
  oai22  g43(.a(new_n88_), .b(x25), .c(x23), .d(x20), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n87_), .c(new_n80_), .O(z08));
  inv1   g45(.a(x07), .O(new_n91_));
  inv1   g46(.a(x15), .O(new_n92_));
  nand3  g47(.a(new_n53_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand3  g49(.a(new_n52_), .b(new_n92_), .c(new_n91_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  nand2  g53(.a(x18), .b(x17), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nor2   g55(.a(x18), .b(x17), .O(new_n101_));
  nor3   g56(.a(new_n101_), .b(new_n95_), .c(new_n100_), .O(z11));
  nand2  g57(.a(new_n96_), .b(new_n69_), .O(new_n103_));
  aoi21  g58(.a(new_n99_), .b(new_n84_), .c(new_n103_), .O(z12));
  nand2  g59(.a(new_n69_), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n96_), .c(new_n71_), .O(z13));
  nand2  g61(.a(new_n71_), .b(x21), .O(new_n107_));
  nor2   g62(.a(new_n69_), .b(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n72_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n96_), .O(z14));
  nor2   g65(.a(x23), .b(new_n73_), .O(new_n111_));
  aoi21  g66(.a(new_n109_), .b(x22), .c(new_n95_), .O(new_n112_));
  oai21  g67(.a(new_n111_), .b(new_n109_), .c(new_n112_), .O(z15));
  nand4  g68(.a(new_n108_), .b(new_n74_), .c(new_n73_), .d(new_n72_), .O(new_n114_));
  nand2  g69(.a(new_n109_), .b(x23), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n96_), .O(z16));
  nand3  g71(.a(new_n78_), .b(new_n108_), .c(new_n74_), .O(new_n117_));
  nand2  g72(.a(new_n114_), .b(x24), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n96_), .c(new_n117_), .O(z17));
  aoi21  g74(.a(new_n117_), .b(x25), .c(new_n95_), .O(new_n120_));
  oai21  g75(.a(new_n117_), .b(x25), .c(new_n120_), .O(z18));
  buf    g76(.a(x16), .O(z02));
endmodule
