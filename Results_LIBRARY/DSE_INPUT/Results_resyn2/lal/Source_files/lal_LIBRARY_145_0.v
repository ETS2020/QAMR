...
module FAU ( 
  ...
  nand3  g29(.a(new_n54_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(z09));
  inv1   g31(.a(x17), .O(new_n77_));
  nand3  g32(.a(new_n53_), .b(new_n74_), .c(new_n73_), .O(new_n78_));
  ...
  nor3   g43(.a(new_n88_), .b(new_n86_), .c(new_n78_), .O(z12));
  nand2  g44(.a(new_n87_), .b(x20), .O(new_n90_));
  nor2   g45(.a(new_n87_), .b(x20), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n90_), .c(new_n79_), .O(z13));
  nand2  g48(.a(new_n92_), .b(x21), .O(new_n94_));
  inv1   g49(.a(x21), .O(new_n95_));
  nand2  g50(.a(new_n91_), .b(new_n95_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n94_), .c(new_n79_), .O(z14));
  inv1   g52(.a(x22), .O(new_n98_));
  nand3  g53(.a(new_n91_), .b(new_n98_), .c(new_n95_), .O(new_n99_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n79_), .O(z15));
  inv1   g56(.a(new_n99_), .O(new_n102_));
  aoi21  g57(.a(new_n91_), .b(new_n95_), .c(x23), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n102_), .c(new_n79_), .O(z16));
  nand2  g59(.a(new_n79_), .b(new_n49_), .O(z17));
  nand2  g60(.a(new_n79_), .b(new_n69_), .O(z18));
  buf    g61(.a(x16), .O(z02));
endmodule
