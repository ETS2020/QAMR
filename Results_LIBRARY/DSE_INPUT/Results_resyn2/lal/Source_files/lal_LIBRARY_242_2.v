...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n69_, new_n72_, new_n74_,
  ...
  oai21  g27(.a(new_n54_), .b(new_n49_), .c(new_n72_), .O(z08));
  inv1   g28(.a(x07), .O(new_n74_));
  inv1   g29(.a(x15), .O(new_n75_));
  nand3  g30(.a(new_n57_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  inv1   g31(.a(new_n76_), .O(z09));
  inv1   g32(.a(x17), .O(new_n78_));
  nand3  g33(.a(new_n56_), .b(new_n75_), .c(new_n74_), .O(new_n79_));
  ...
  nor3   g44(.a(new_n89_), .b(new_n87_), .c(new_n79_), .O(z12));
  nand2  g45(.a(new_n88_), .b(x20), .O(new_n91_));
  nor2   g46(.a(new_n88_), .b(x20), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(new_n91_), .c(new_n80_), .O(z13));
  nand2  g49(.a(new_n93_), .b(x21), .O(new_n95_));
  nand2  g50(.a(new_n92_), .b(new_n51_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n80_), .O(z14));
  nand2  g52(.a(new_n96_), .b(x22), .O(new_n98_));
  nand3  g53(.a(new_n92_), .b(new_n52_), .c(new_n51_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(z15));
  aoi21  g55(.a(new_n99_), .b(x23), .c(new_n79_), .O(new_n101_));
  oai21  g56(.a(new_n99_), .b(x23), .c(new_n101_), .O(z16));
  oai21  g57(.a(new_n99_), .b(x23), .c(x24), .O(new_n103_));
  nand4  g58(.a(new_n92_), .b(new_n49_), .c(new_n52_), .d(new_n51_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n103_), .c(new_n80_), .O(z17));
  aoi21  g60(.a(new_n104_), .b(x25), .c(new_n79_), .O(new_n106_));
  oai21  g61(.a(new_n104_), .b(x25), .c(new_n106_), .O(z18));
  buf    g62(.a(x16), .O(z02));
endmodule
