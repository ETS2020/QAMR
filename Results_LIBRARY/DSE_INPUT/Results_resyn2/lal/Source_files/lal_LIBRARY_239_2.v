...
module FAU ( 
  ...
  nor3   g38(.a(new_n83_), .b(new_n82_), .c(new_n78_), .O(z11));
  nor2   g39(.a(new_n82_), .b(x19), .O(new_n85_));
  nand2  g40(.a(new_n82_), .b(x19), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n79_), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(new_n85_), .O(z12));
  nand2  g43(.a(new_n86_), .b(x20), .O(new_n89_));
  nand3  g44(.a(new_n82_), .b(new_n50_), .c(x19), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n79_), .O(z13));
  nand2  g46(.a(new_n90_), .b(x21), .O(new_n92_));
  inv1   g47(.a(new_n90_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n52_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n92_), .c(new_n79_), .O(z14));
  oai21  g50(.a(new_n90_), .b(x21), .c(x22), .O(new_n96_));
  nand2  g51(.a(new_n53_), .b(new_n52_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n90_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n96_), .c(new_n79_), .O(z15));
  nand3  g55(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(x18), .c(x23), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(new_n98_), .c(new_n79_), .O(z16));
  nand2  g58(.a(new_n79_), .b(new_n48_), .O(z17));
  nand2  g59(.a(new_n79_), .b(new_n49_), .O(z18));
  buf    g60(.a(x16), .O(z02));
endmodule
