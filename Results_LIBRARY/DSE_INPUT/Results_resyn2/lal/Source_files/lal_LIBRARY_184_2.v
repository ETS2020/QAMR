// Benchmark "FAU" written by ABC on Mon Jul 27 19:17:03 2020
...
module FAU ( 
  ...
  nor2   g29(.a(x18), .b(x17), .O(new_n75_));
  ...
  nor2   g42(.a(new_n51_), .b(new_n50_), .O(new_n88_));
  nor3   g43(.a(new_n88_), .b(new_n84_), .c(new_n75_), .O(z11));
  nor2   g44(.a(new_n88_), .b(x19), .O(new_n90_));
  nand2  g45(.a(new_n88_), .b(x19), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n85_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(new_n90_), .O(z12));
  ...
  xor2a  g51(.a(new_n95_), .b(x21), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n85_), .O(z14));
  inv1   g53(.a(new_n95_), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x21), .O(new_n100_));
  oai21  g55(.a(new_n74_), .b(new_n50_), .c(x18), .O(new_n101_));
  oai21  g56(.a(x20), .b(new_n51_), .c(x22), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n85_), .O(z15));
  inv1   g58(.a(x23), .O(new_n104_));
  nand2  g59(.a(new_n85_), .b(new_n104_), .O(z16));
  inv1   g60(.a(x24), .O(new_n106_));
  nand2  g61(.a(new_n85_), .b(new_n106_), .O(z17));
  nand2  g62(.a(new_n85_), .b(new_n48_), .O(z18));
  buf    g63(.a(x16), .O(z02));
endmodule
