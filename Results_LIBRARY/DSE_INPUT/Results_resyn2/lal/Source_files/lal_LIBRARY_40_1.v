...
module FAU ( 
  ...
  nand2  g48(.a(new_n89_), .b(new_n93_), .O(new_n94_));
  nand2  g49(.a(new_n90_), .b(x21), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n79_), .O(z14));
  nand2  g51(.a(new_n94_), .b(x22), .O(new_n97_));
  inv1   g52(.a(x22), .O(new_n98_));
  nand3  g53(.a(new_n89_), .b(new_n98_), .c(new_n93_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n97_), .c(new_n79_), .O(z15));
  nand2  g55(.a(new_n99_), .b(new_n79_), .O(z16));
  aoi21  g56(.a(new_n99_), .b(x24), .c(new_n78_), .O(new_n102_));
  oai21  g57(.a(new_n99_), .b(x24), .c(new_n102_), .O(z17));
  oai21  g58(.a(new_n99_), .b(x24), .c(x25), .O(new_n104_));
  inv1   g59(.a(x24), .O(new_n105_));
  nand4  g60(.a(new_n48_), .b(new_n105_), .c(new_n98_), .d(new_n93_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n89_), .c(new_n78_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n104_), .O(z18));
  buf    g64(.a(x16), .O(z02));
endmodule
