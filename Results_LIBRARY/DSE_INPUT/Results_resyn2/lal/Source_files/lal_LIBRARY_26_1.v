// Benchmark "FAU" written by ABC on Mon Jul 27 19:15:58 2020
...
module FAU ( 
  ...
  oai21  g05(.a(x18), .b(x17), .c(new_n50_), .O(new_n51_));
  ...
  nor3   g42(.a(new_n87_), .b(new_n85_), .c(new_n78_), .O(z12));
  nand2  g43(.a(new_n86_), .b(x20), .O(new_n89_));
  nor2   g44(.a(new_n86_), .b(x20), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n89_), .c(new_n79_), .O(z13));
  nand2  g47(.a(new_n91_), .b(x21), .O(new_n93_));
  nand2  g48(.a(new_n90_), .b(new_n52_), .O(new_n94_));
  ...
  oai21  g54(.a(new_n94_), .b(x22), .c(x23), .O(new_n100_));
  nor2   g55(.a(x23), .b(x22), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n79_), .O(z16));
  inv1   g58(.a(new_n101_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n94_), .c(x24), .O(new_n105_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n97_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n105_), .c(new_n79_), .O(z17));
  nand3  g64(.a(new_n107_), .b(new_n97_), .c(new_n49_), .O(new_n110_));
  oai21  g65(.a(new_n106_), .b(new_n94_), .c(x25), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(z18));
  buf    g67(.a(x16), .O(z02));
endmodule
