...
module FAU ( 
  ...
  nor2   g32(.a(x18), .b(x17), .O(new_n78_));
  nand2  g33(.a(x18), .b(x17), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(new_n80_));
  nor3   g35(.a(new_n80_), .b(new_n78_), .c(new_n74_), .O(z11));
  nand2  g36(.a(new_n80_), .b(x19), .O(new_n82_));
  inv1   g37(.a(x19), .O(new_n83_));
  nand2  g38(.a(new_n79_), .b(new_n83_), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(new_n82_), .c(new_n75_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z12));
  nor2   g41(.a(x20), .b(new_n83_), .O(new_n87_));
  inv1   g42(.a(x18), .O(new_n88_));
  inv1   g43(.a(x21), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n87_), .c(x17), .O(new_n91_));
  nand2  g46(.a(new_n82_), .b(x20), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n75_), .O(z13));
  nand2  g48(.a(new_n87_), .b(x17), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(x21), .O(new_n95_));
  nor2   g50(.a(new_n79_), .b(x21), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n95_), .c(new_n75_), .O(z14));
  inv1   g53(.a(x22), .O(new_n99_));
  nand3  g54(.a(new_n96_), .b(new_n87_), .c(new_n99_), .O(new_n100_));
  nand2  g55(.a(new_n97_), .b(x22), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n100_), .c(new_n75_), .O(z15));
  ...
  nand4  g62(.a(new_n49_), .b(new_n48_), .c(new_n99_), .d(new_n89_), .O(new_n108_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n107_), .c(new_n75_), .O(z17));
  inv1   g69(.a(x25), .O(new_n115_));
  nand3  g70(.a(new_n112_), .b(new_n109_), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n111_), .b(new_n108_), .c(x25), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n75_), .O(z18));
  buf    g73(.a(x16), .O(z02));
endmodule
