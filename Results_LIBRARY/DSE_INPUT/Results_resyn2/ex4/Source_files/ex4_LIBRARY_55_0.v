...
module FAU ( 
  ...
  nand2  g313(.a(new_n470_), .b(new_n338_), .O(new_n471_));
  ...
  oai21  g322(.a(new_n301_), .b(x094), .c(new_n298_), .O(new_n480_));
  ...
  nand4  g326(.a(x126), .b(new_n339_), .c(new_n304_), .d(x014), .O(new_n484_));
