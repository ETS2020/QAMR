// Benchmark "FAU" written by ABC on Tue Jul 28 07:03:53 2020
...
module FAU ( 
  ...
  nor2   g082(.a(new_n238_), .b(x037), .O(new_n239_));
  nand3  g083(.a(new_n239_), .b(new_n237_), .c(x109), .O(new_n240_));
  oai21  g084(.a(x085), .b(new_n236_), .c(new_n240_), .O(new_n241_));
  nand2  g085(.a(new_n241_), .b(x013), .O(new_n242_));
  ...
  oai21  g093(.a(x021), .b(x013), .c(new_n249_), .O(new_n250_));
  inv1   g094(.a(x013), .O(new_n251_));
  inv1   g095(.a(x021), .O(new_n252_));
  aoi21  g096(.a(new_n252_), .b(new_n251_), .c(x029), .O(new_n253_));
  aoi21  g097(.a(new_n244_), .b(x037), .c(new_n253_), .O(new_n254_));
  oai22  g098(.a(x125), .b(x093), .c(x101), .d(new_n236_), .O(new_n255_));
  nand2  g099(.a(new_n255_), .b(x061), .O(new_n256_));
  inv1   g100(.a(x085), .O(new_n257_));
  and2   g101(.a(x117), .b(x021), .O(new_n258_));
  aoi21  g102(.a(new_n258_), .b(new_n237_), .c(new_n257_), .O(new_n259_));
  nand4  g103(.a(new_n259_), .b(new_n256_), .c(new_n254_), .d(new_n250_), .O(new_n260_));
  aoi21  g104(.a(new_n260_), .b(x077), .c(new_n248_), .O(new_n261_));
  oai21  g105(.a(new_n261_), .b(new_n235_), .c(new_n242_), .O(new_n262_));
  nand2  g106(.a(new_n262_), .b(new_n234_), .O(new_n263_));
  oai21  g107(.a(new_n253_), .b(new_n249_), .c(new_n239_), .O(new_n264_));
  inv1   g108(.a(x029), .O(new_n265_));
  oai21  g109(.a(x021), .b(x013), .c(new_n265_), .O(new_n266_));
  aoi21  g110(.a(new_n265_), .b(x021), .c(new_n249_), .O(new_n267_));
  ...
  oai22  g115(.a(new_n271_), .b(new_n266_), .c(new_n267_), .d(x069), .O(new_n272_));
  nand2  g116(.a(x021), .b(x013), .O(new_n273_));
  inv1   g117(.a(new_n273_), .O(new_n274_));
  nand3  g118(.a(new_n270_), .b(x077), .c(new_n265_), .O(new_n275_));
  aoi21  g119(.a(new_n275_), .b(new_n274_), .c(new_n245_), .O(new_n276_));
  aoi21  g120(.a(new_n272_), .b(x077), .c(new_n276_), .O(new_n277_));
  oai21  g121(.a(new_n277_), .b(new_n235_), .c(new_n264_), .O(new_n278_));
  nand2  g122(.a(new_n238_), .b(new_n235_), .O(new_n279_));
  nand2  g123(.a(new_n243_), .b(new_n252_), .O(new_n280_));
  aoi21  g124(.a(new_n236_), .b(new_n251_), .c(new_n280_), .O(new_n281_));
  oai21  g125(.a(new_n279_), .b(new_n236_), .c(new_n281_), .O(new_n282_));
  aoi22  g126(.a(new_n238_), .b(new_n251_), .c(new_n235_), .d(new_n236_), .O(new_n283_));
  nand2  g127(.a(new_n283_), .b(new_n282_), .O(new_n284_));
  aoi21  g128(.a(new_n278_), .b(x085), .c(new_n284_), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(new_n263_), .c(new_n233_), .O(z05));
  ...
  nor2   g266(.a(x117), .b(x109), .O(new_n424_));
  aoi21  g267(.a(new_n249_), .b(x029), .c(x021), .O(new_n425_));
  nand2  g268(.a(new_n273_), .b(x029), .O(new_n426_));
  oai21  g269(.a(x125), .b(x101), .c(new_n249_), .O(new_n427_));
  oai22  g270(.a(new_n427_), .b(new_n426_), .c(new_n425_), .d(new_n424_), .O(new_n428_));
  inv1   g271(.a(new_n270_), .O(new_n429_));
  aoi21  g272(.a(new_n426_), .b(new_n429_), .c(new_n236_), .O(new_n430_));
  aoi21  g273(.a(new_n428_), .b(new_n235_), .c(new_n430_), .O(new_n431_));
  inv1   g274(.a(new_n424_), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n235_), .c(x013), .O(new_n433_));
  oai21  g276(.a(new_n431_), .b(x077), .c(new_n433_), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n257_), .O(new_n435_));
  nor2   g278(.a(new_n432_), .b(x085), .O(new_n436_));
  nand2  g279(.a(new_n273_), .b(new_n270_), .O(new_n437_));
  nand4  g280(.a(new_n437_), .b(new_n436_), .c(new_n427_), .d(new_n426_), .O(new_n438_));
  nand3  g281(.a(x085), .b(new_n236_), .c(new_n251_), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n279_), .c(new_n234_), .O(new_n440_));
  nand3  g283(.a(x069), .b(new_n235_), .c(x021), .O(new_n441_));
  aoi22  g284(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  aoi21  g286(.a(new_n440_), .b(new_n438_), .c(new_n443_), .O(new_n444_));
  aoi21  g287(.a(new_n444_), .b(new_n435_), .c(x045), .O(z13));
  nand2  g288(.a(new_n297_), .b(new_n292_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n301_), .O(new_n447_));
  ...
  oai21  g295(.a(new_n331_), .b(x030), .c(new_n452_), .O(new_n453_));
  oai21  g296(.a(new_n297_), .b(x110), .c(x038), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(x118), .O(new_n455_));
  inv1   g298(.a(x110), .O(new_n456_));
  oai21  g299(.a(new_n292_), .b(x062), .c(new_n456_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n295_), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n455_), .c(new_n453_), .d(new_n451_), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n449_), .c(new_n324_), .O(new_n460_));
  nand4  g303(.a(x126), .b(new_n330_), .c(new_n295_), .d(x014), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n460_), .c(x054), .O(new_n462_));
  nand3  g305(.a(x086), .b(new_n295_), .c(new_n305_), .O(new_n463_));
  inv1   g306(.a(new_n463_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n462_), .c(x006), .O(new_n465_));
  nand2  g308(.a(new_n308_), .b(x030), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n306_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n324_), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n305_), .c(new_n448_), .O(new_n469_));
  nor2   g312(.a(new_n328_), .b(x022), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(new_n331_), .c(x070), .O(new_n471_));
  nand4  g314(.a(new_n452_), .b(new_n446_), .c(new_n308_), .d(x030), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n471_), .c(x078), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n469_), .c(new_n289_), .O(new_n474_));
  ...
  nand3  g324(.a(new_n481_), .b(new_n480_), .c(new_n339_), .O(new_n482_));
  aoi21  g325(.a(new_n478_), .b(new_n304_), .c(new_n482_), .O(new_n483_));
