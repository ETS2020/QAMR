// Benchmark "FAU" written by ABC on Tue Jul 28 07:06:37 2020
...
module FAU ( 
  ...
  nor2   g191(.a(x070), .b(new_n313_), .O(new_n348_));
  nor2   g192(.a(new_n297_), .b(x022), .O(new_n349_));
  ...
  nand3  g325(.a(new_n348_), .b(x126), .c(new_n338_), .O(new_n483_));
