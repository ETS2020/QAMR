// Benchmark "FAU" written by ABC on Tue Jul 28 07:03:26 2020
...
module FAU ( 
  ...
  nor2   g276(.a(x109), .b(x021), .O(new_n434_));
  ...
  oai21  g280(.a(new_n244_), .b(x117), .c(x037), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(x109), .O(new_n439_));
  oai21  g282(.a(new_n239_), .b(x061), .c(new_n243_), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(new_n242_), .O(new_n441_));
  nand4  g284(.a(new_n441_), .b(new_n439_), .c(new_n437_), .d(new_n435_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n433_), .c(new_n429_), .O(new_n443_));
  ...
  nand2  g293(.a(new_n450_), .b(new_n429_), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n252_), .c(new_n432_), .O(new_n452_));
  nor2   g295(.a(new_n257_), .b(x021), .O(new_n453_));
  oai21  g296(.a(new_n453_), .b(new_n278_), .c(x069), .O(new_n454_));
  nand4  g297(.a(new_n436_), .b(new_n430_), .c(new_n255_), .d(x029), .O(new_n455_));
  ...
  nand2  g310(.a(new_n303_), .b(new_n299_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n337_), .O(new_n469_));
  ...
  oai21  g317(.a(new_n338_), .b(x030), .c(new_n474_), .O(new_n475_));
  oai21  g318(.a(new_n303_), .b(x110), .c(x038), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x118), .O(new_n477_));
  oai21  g320(.a(new_n299_), .b(x062), .c(new_n296_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n302_), .O(new_n479_));
  nand4  g322(.a(new_n479_), .b(new_n477_), .c(new_n475_), .d(new_n473_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n471_), .c(new_n331_), .O(new_n481_));
  nand4  g324(.a(x126), .b(new_n336_), .c(new_n302_), .d(x014), .O(new_n482_));
  aoi21  g325(.a(new_n482_), .b(new_n481_), .c(x054), .O(new_n483_));
  nand3  g326(.a(x086), .b(new_n302_), .c(new_n312_), .O(new_n484_));
  inv1   g327(.a(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n483_), .c(x006), .O(new_n486_));
  nand2  g329(.a(new_n315_), .b(x030), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n313_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n331_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n312_), .c(new_n470_), .O(new_n490_));
  nor2   g333(.a(new_n335_), .b(x022), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n338_), .c(x070), .O(new_n492_));
  nand4  g335(.a(new_n474_), .b(new_n468_), .c(new_n315_), .d(x030), .O(new_n493_));
  ...
  nand2  g339(.a(new_n496_), .b(new_n327_), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n331_), .c(x038), .O(new_n498_));
  ...
  nand3  g345(.a(new_n502_), .b(new_n501_), .c(new_n346_), .O(new_n503_));
  aoi21  g346(.a(new_n499_), .b(new_n311_), .c(new_n503_), .O(new_n504_));
