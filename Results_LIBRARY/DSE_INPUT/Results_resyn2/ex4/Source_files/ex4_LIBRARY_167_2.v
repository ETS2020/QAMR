// Benchmark "FAU" written by ABC on Tue Jul 28 07:05:18 2020
...
module FAU ( 
  ...
  nand2  g153(.a(new_n309_), .b(x062), .O(new_n310_));
  ...
  nand4  g166(.a(new_n305_), .b(x094), .c(x038), .d(new_n314_), .O(new_n323_));
