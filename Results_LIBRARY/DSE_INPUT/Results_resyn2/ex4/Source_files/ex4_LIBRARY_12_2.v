...
module FAU ( 
  ...
  nand2  g309(.a(new_n302_), .b(new_n297_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n306_), .O(new_n468_));
  nor2   g311(.a(x118), .b(x110), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n468_), .c(x070), .O(new_n470_));
  nor2   g313(.a(x118), .b(x022), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(x126), .c(x086), .O(new_n472_));
  nand2  g315(.a(x022), .b(x014), .O(new_n473_));
  oai21  g316(.a(new_n336_), .b(x030), .c(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n302_), .b(x110), .c(x038), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(x118), .O(new_n476_));
  inv1   g319(.a(x110), .O(new_n477_));
  oai21  g320(.a(new_n297_), .b(x062), .c(new_n477_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n300_), .O(new_n479_));
  nand4  g322(.a(new_n479_), .b(new_n476_), .c(new_n474_), .d(new_n472_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n470_), .c(new_n466_), .O(new_n481_));
  nand4  g324(.a(x126), .b(new_n335_), .c(new_n300_), .d(x014), .O(new_n482_));
  aoi21  g325(.a(new_n482_), .b(new_n481_), .c(x054), .O(new_n483_));
  nand3  g326(.a(x086), .b(new_n300_), .c(new_n310_), .O(new_n484_));
  inv1   g327(.a(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n483_), .c(x006), .O(new_n486_));
  nand2  g329(.a(new_n313_), .b(x030), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n311_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n466_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n310_), .c(new_n469_), .O(new_n490_));
  nor2   g333(.a(new_n315_), .b(x022), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n336_), .c(x070), .O(new_n492_));
  nand4  g335(.a(new_n473_), .b(new_n467_), .c(new_n313_), .d(x030), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n492_), .c(x078), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n490_), .c(new_n294_), .O(new_n495_));
  aoi21  g338(.a(x022), .b(x014), .c(new_n315_), .O(new_n496_));
  nor2   g339(.a(x078), .b(new_n300_), .O(new_n497_));
  oai21  g340(.a(new_n496_), .b(new_n336_), .c(new_n497_), .O(new_n498_));
  ...
  aoi21  g346(.a(new_n499_), .b(new_n309_), .c(new_n503_), .O(new_n504_));
