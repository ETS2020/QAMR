// Benchmark "FAU" written by ABC on Tue Jul 28 07:05:22 2020
...
module FAU ( 
  ...
  nand3  g078(.a(new_n234_), .b(x037), .c(new_n233_), .O(new_n235_));
  ...
  oai21  g088(.a(new_n244_), .b(new_n239_), .c(new_n238_), .O(new_n245_));
  inv1   g089(.a(x061), .O(new_n246_));
  inv1   g090(.a(x093), .O(new_n247_));
  nand2  g091(.a(new_n247_), .b(new_n246_), .O(new_n248_));
  nand2  g092(.a(x021), .b(x013), .O(new_n249_));
  aoi21  g093(.a(new_n248_), .b(new_n240_), .c(new_n249_), .O(new_n250_));
  aoi21  g094(.a(x117), .b(x109), .c(new_n250_), .O(new_n251_));
  aoi21  g095(.a(x037), .b(new_n240_), .c(new_n239_), .O(new_n252_));
  nand2  g096(.a(x125), .b(x101), .O(new_n253_));
  nand2  g097(.a(new_n253_), .b(new_n248_), .O(new_n254_));
  oai22  g098(.a(new_n254_), .b(new_n243_), .c(new_n252_), .d(x069), .O(new_n255_));
  oai21  g099(.a(new_n255_), .b(new_n251_), .c(x053), .O(new_n256_));
  aoi21  g100(.a(new_n256_), .b(new_n245_), .c(new_n237_), .O(new_n257_));
  oai21  g101(.a(new_n257_), .b(new_n236_), .c(x077), .O(new_n258_));
  inv1   g102(.a(x005), .O(new_n259_));
  nand2  g103(.a(x037), .b(x013), .O(new_n260_));
  nand2  g104(.a(new_n237_), .b(x045), .O(new_n261_));
  nand2  g105(.a(new_n242_), .b(new_n239_), .O(new_n262_));
  inv1   g106(.a(x109), .O(new_n263_));
  inv1   g107(.a(x117), .O(new_n264_));
  oai22  g108(.a(new_n264_), .b(new_n263_), .c(x069), .d(x037), .O(new_n265_));
  nand4  g109(.a(new_n265_), .b(new_n262_), .c(new_n243_), .d(x085), .O(new_n266_));
  nand2  g110(.a(new_n264_), .b(new_n263_), .O(new_n267_));
  aoi21  g111(.a(x117), .b(new_n233_), .c(x125), .O(new_n268_));
  nand2  g112(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  oai22  g113(.a(new_n247_), .b(new_n234_), .c(new_n246_), .d(new_n238_), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(new_n253_), .O(new_n271_));
  ...
  oai21  g119(.a(new_n272_), .b(new_n266_), .c(new_n275_), .O(new_n276_));
  oai21  g120(.a(new_n261_), .b(new_n260_), .c(new_n276_), .O(new_n277_));
  nand4  g121(.a(new_n234_), .b(x053), .c(new_n233_), .d(x013), .O(new_n278_));
  inv1   g122(.a(x013), .O(new_n279_));
  aoi22  g123(.a(new_n274_), .b(new_n279_), .c(new_n273_), .d(new_n238_), .O(new_n280_));
  nand2  g124(.a(new_n280_), .b(new_n278_), .O(new_n281_));
  aoi22  g125(.a(new_n281_), .b(x045), .c(new_n277_), .d(new_n259_), .O(new_n282_));
  nand2  g126(.a(new_n282_), .b(new_n258_), .O(z05));
  ...
  aoi21  g263(.a(x069), .b(x037), .c(new_n259_), .O(new_n421_));
  nand2  g264(.a(new_n239_), .b(x029), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n241_), .c(x085), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n421_), .c(new_n267_), .O(new_n424_));
  nand2  g267(.a(x125), .b(new_n264_), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n240_), .c(x021), .O(new_n426_));
  nand3  g269(.a(x125), .b(x093), .c(new_n246_), .O(new_n427_));
  nand2  g270(.a(x029), .b(new_n279_), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(new_n427_), .c(new_n237_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(new_n426_), .c(x005), .O(new_n430_));
  nand3  g273(.a(new_n247_), .b(new_n234_), .c(x005), .O(new_n431_));
  nor2   g274(.a(x085), .b(new_n240_), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n249_), .c(new_n239_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n431_), .O(new_n434_));
  oai21  g277(.a(x125), .b(x101), .c(new_n434_), .O(new_n435_));
  nand2  g278(.a(new_n237_), .b(x069), .O(new_n436_));
  nand3  g279(.a(x101), .b(new_n246_), .c(x005), .O(new_n437_));
  oai21  g280(.a(new_n436_), .b(new_n240_), .c(new_n437_), .O(new_n438_));
  nand2  g281(.a(new_n249_), .b(x005), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n436_), .O(new_n440_));
  aoi22  g283(.a(new_n440_), .b(new_n248_), .c(new_n438_), .d(new_n238_), .O(new_n441_));
  nand4  g284(.a(new_n441_), .b(new_n435_), .c(new_n430_), .d(new_n424_), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n273_), .O(new_n443_));
  nand3  g286(.a(x125), .b(new_n263_), .c(x005), .O(new_n444_));
  inv1   g287(.a(new_n444_), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n432_), .c(new_n279_), .O(new_n446_));
  nor2   g289(.a(new_n240_), .b(x021), .O(new_n447_));
  oai21  g290(.a(new_n447_), .b(new_n248_), .c(new_n237_), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n446_), .c(new_n273_), .O(new_n449_));
  nand3  g292(.a(x085), .b(new_n279_), .c(x005), .O(new_n450_));
  nand3  g293(.a(new_n260_), .b(x069), .c(x021), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n450_), .O(new_n452_));
  aoi21  g295(.a(new_n449_), .b(x037), .c(new_n452_), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n443_), .c(x045), .O(z13));
