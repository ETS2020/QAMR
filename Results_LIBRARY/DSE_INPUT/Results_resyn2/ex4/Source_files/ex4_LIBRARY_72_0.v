// Benchmark "FAU" written by ABC on Tue Jul 28 07:03:52 2020
...
module FAU ( 
  ...
  oai21  g133(.a(x102), .b(new_n287_), .c(new_n289_), .O(new_n290_));
  inv1   g134(.a(x038), .O(new_n291_));
  inv1   g135(.a(x118), .O(new_n292_));
  inv1   g136(.a(x126), .O(new_n293_));
  nand3  g137(.a(new_n293_), .b(new_n292_), .c(x110), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(new_n291_), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(new_n290_), .O(new_n296_));
  inv1   g140(.a(x062), .O(new_n297_));
  aoi21  g141(.a(x126), .b(x102), .c(new_n297_), .O(new_n298_));
  oai21  g142(.a(new_n298_), .b(new_n288_), .c(x070), .O(new_n299_));
  ...
  aoi21  g148(.a(new_n304_), .b(new_n303_), .c(new_n300_), .O(new_n305_));
  inv1   g149(.a(x030), .O(new_n306_));
  nor2   g150(.a(new_n292_), .b(new_n302_), .O(new_n307_));
  aoi22  g151(.a(new_n307_), .b(new_n293_), .c(new_n303_), .d(new_n306_), .O(new_n308_));
  nand4  g152(.a(new_n308_), .b(new_n305_), .c(new_n299_), .d(new_n296_), .O(new_n309_));
  nand4  g153(.a(new_n293_), .b(x094), .c(x038), .d(new_n301_), .O(new_n310_));
  inv1   g154(.a(new_n310_), .O(new_n311_));
  aoi21  g155(.a(new_n309_), .b(x078), .c(new_n311_), .O(new_n312_));
  nand3  g156(.a(new_n300_), .b(x038), .c(x014), .O(new_n313_));
  oai21  g157(.a(new_n312_), .b(new_n286_), .c(new_n313_), .O(new_n314_));
  nand2  g158(.a(new_n314_), .b(new_n285_), .O(new_n315_));
  inv1   g159(.a(x070), .O(new_n316_));
  nand3  g160(.a(x086), .b(x054), .c(new_n306_), .O(new_n317_));
  aoi21  g161(.a(new_n317_), .b(x022), .c(new_n291_), .O(new_n318_));
  inv1   g162(.a(new_n304_), .O(new_n319_));
  nand2  g163(.a(x086), .b(x054), .O(new_n320_));
  nor2   g164(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  oai21  g165(.a(new_n321_), .b(new_n318_), .c(new_n316_), .O(new_n322_));
  nand2  g166(.a(new_n288_), .b(new_n302_), .O(new_n323_));
  nand2  g167(.a(x126), .b(x102), .O(new_n324_));
  aoi21  g168(.a(new_n303_), .b(new_n324_), .c(new_n288_), .O(new_n325_));
  nand2  g169(.a(new_n287_), .b(new_n297_), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n306_), .O(new_n327_));
  oai21  g171(.a(new_n327_), .b(new_n325_), .c(new_n323_), .O(new_n328_));
  nand2  g172(.a(new_n303_), .b(new_n306_), .O(new_n329_));
  aoi21  g173(.a(new_n329_), .b(new_n319_), .c(x038), .O(new_n330_));
  aoi21  g174(.a(new_n328_), .b(x054), .c(new_n330_), .O(new_n331_));
  oai21  g175(.a(new_n331_), .b(new_n300_), .c(new_n322_), .O(new_n332_));
  oai21  g176(.a(new_n320_), .b(new_n289_), .c(x078), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n301_), .O(new_n334_));
  nor2   g178(.a(x022), .b(new_n301_), .O(new_n335_));
  nor2   g179(.a(x070), .b(new_n286_), .O(new_n336_));
  aoi22  g180(.a(new_n336_), .b(new_n335_), .c(new_n286_), .d(new_n291_), .O(new_n337_));
  nand2  g181(.a(new_n337_), .b(new_n334_), .O(new_n338_));
  aoi21  g182(.a(new_n332_), .b(x078), .c(new_n338_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n315_), .c(new_n284_), .O(z06));
  inv1   g184(.a(x088), .O(new_n342_));
  ...
  aoi21  g190(.a(new_n347_), .b(new_n346_), .c(x064), .O(new_n348_));
  nor2   g191(.a(x112), .b(x016), .O(new_n349_));
  aoi21  g192(.a(new_n349_), .b(x120), .c(x080), .O(new_n350_));
  nand2  g193(.a(x016), .b(x008), .O(new_n351_));
  inv1   g194(.a(x056), .O(new_n352_));
  nand2  g195(.a(new_n342_), .b(new_n352_), .O(new_n353_));
  oai21  g196(.a(new_n353_), .b(x024), .c(new_n351_), .O(new_n354_));
  oai21  g197(.a(new_n344_), .b(x104), .c(x032), .O(new_n355_));
  nand2  g198(.a(new_n355_), .b(x112), .O(new_n356_));
  nor2   g199(.a(new_n343_), .b(x056), .O(new_n357_));
  oai21  g200(.a(new_n357_), .b(x104), .c(new_n160_), .O(new_n358_));
  nand4  g201(.a(new_n358_), .b(new_n356_), .c(new_n354_), .d(new_n350_), .O(new_n359_));
  oai21  g202(.a(new_n359_), .b(new_n348_), .c(new_n167_), .O(new_n360_));
  nand4  g203(.a(x120), .b(new_n352_), .c(new_n160_), .d(x008), .O(new_n361_));
  aoi21  g204(.a(new_n361_), .b(new_n360_), .c(x048), .O(new_n362_));
  nand3  g205(.a(x080), .b(new_n160_), .c(new_n165_), .O(new_n363_));
  inv1   g206(.a(new_n363_), .O(new_n364_));
  oai21  g207(.a(new_n364_), .b(new_n362_), .c(x000), .O(new_n365_));
  inv1   g208(.a(x080), .O(new_n366_));
  inv1   g209(.a(x024), .O(new_n367_));
  aoi21  g210(.a(x088), .b(x056), .c(new_n367_), .O(new_n368_));
  oai21  g211(.a(new_n368_), .b(x016), .c(new_n167_), .O(new_n369_));
  aoi21  g212(.a(new_n369_), .b(new_n165_), .c(new_n347_), .O(new_n370_));
  nor2   g213(.a(new_n367_), .b(x016), .O(new_n371_));
  oai21  g214(.a(new_n371_), .b(new_n353_), .c(x064), .O(new_n372_));
  aoi21  g215(.a(x016), .b(x008), .c(new_n367_), .O(new_n373_));
  nand2  g216(.a(x088), .b(x056), .O(new_n374_));
  nand3  g217(.a(new_n374_), .b(new_n373_), .c(new_n345_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(new_n372_), .c(x072), .O(new_n376_));
  oai21  g219(.a(new_n376_), .b(new_n370_), .c(new_n166_), .O(new_n377_));
  nor2   g220(.a(x072), .b(new_n160_), .O(new_n378_));
  oai21  g221(.a(new_n353_), .b(new_n373_), .c(new_n378_), .O(new_n379_));
  ...
  nand2  g225(.a(x072), .b(x008), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n382_), .c(new_n159_), .O(new_n384_));
  aoi21  g227(.a(new_n380_), .b(new_n366_), .c(new_n384_), .O(new_n385_));
  ...
  oai21  g231(.a(x073), .b(x049), .c(new_n182_), .O(new_n389_));
  nor2   g232(.a(new_n174_), .b(new_n173_), .O(new_n390_));
  oai22  g233(.a(new_n178_), .b(new_n175_), .c(new_n177_), .d(new_n176_), .O(new_n391_));
  aoi21  g234(.a(new_n390_), .b(new_n389_), .c(new_n391_), .O(new_n392_));
  aoi21  g235(.a(new_n392_), .b(new_n388_), .c(x041), .O(z09));
  oai22  g236(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(x066), .c(x018), .O(new_n395_));
  oai21  g238(.a(x074), .b(x050), .c(new_n197_), .O(new_n396_));
  nor2   g239(.a(new_n189_), .b(new_n188_), .O(new_n397_));
  oai22  g240(.a(new_n193_), .b(new_n190_), .c(new_n192_), .d(new_n191_), .O(new_n398_));
  aoi21  g241(.a(new_n397_), .b(new_n396_), .c(new_n398_), .O(new_n399_));
  aoi21  g242(.a(new_n399_), .b(new_n395_), .c(x042), .O(z10));
  oai22  g243(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n401_));
  nand3  g244(.a(new_n401_), .b(x067), .c(x019), .O(new_n402_));
  oai21  g245(.a(x075), .b(x051), .c(new_n212_), .O(new_n403_));
  nor2   g246(.a(new_n204_), .b(new_n203_), .O(new_n404_));
  oai22  g247(.a(new_n208_), .b(new_n205_), .c(new_n207_), .d(new_n206_), .O(new_n405_));
  aoi21  g248(.a(new_n404_), .b(new_n403_), .c(new_n405_), .O(new_n406_));
  aoi21  g249(.a(new_n406_), .b(new_n402_), .c(x043), .O(z11));
  oai22  g250(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n408_));
  nand3  g251(.a(new_n408_), .b(x068), .c(x020), .O(new_n409_));
  oai21  g252(.a(x076), .b(x052), .c(new_n227_), .O(new_n410_));
  nor2   g253(.a(new_n219_), .b(new_n218_), .O(new_n411_));
  oai22  g254(.a(new_n223_), .b(new_n220_), .c(new_n222_), .d(new_n221_), .O(new_n412_));
  aoi21  g255(.a(new_n411_), .b(new_n410_), .c(new_n412_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n409_), .c(x044), .O(z12));
  inv1   g257(.a(x101), .O(new_n415_));
  nand2  g258(.a(new_n258_), .b(new_n415_), .O(new_n416_));
  inv1   g259(.a(x109), .O(new_n417_));
  inv1   g260(.a(x117), .O(new_n418_));
  nand2  g261(.a(new_n418_), .b(new_n417_), .O(new_n419_));
  aoi21  g262(.a(new_n416_), .b(new_n240_), .c(new_n419_), .O(new_n420_));
  nor2   g263(.a(new_n420_), .b(x069), .O(new_n421_));
  nor2   g264(.a(x117), .b(x021), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(x125), .c(x085), .O(new_n423_));
  nand2  g266(.a(x021), .b(x013), .O(new_n424_));
  oai21  g267(.a(new_n241_), .b(x029), .c(new_n424_), .O(new_n425_));
  oai21  g268(.a(new_n258_), .b(x109), .c(x037), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(x117), .O(new_n427_));
  oai21  g270(.a(new_n415_), .b(x061), .c(new_n417_), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n263_), .O(new_n429_));
  nand4  g272(.a(new_n429_), .b(new_n427_), .c(new_n425_), .d(new_n423_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n421_), .c(new_n237_), .O(new_n431_));
  nand3  g274(.a(new_n271_), .b(x125), .c(new_n239_), .O(new_n432_));
  aoi21  g275(.a(new_n432_), .b(new_n431_), .c(x053), .O(new_n433_));
  nand3  g276(.a(x085), .b(new_n263_), .c(new_n235_), .O(new_n434_));
  inv1   g277(.a(new_n434_), .O(new_n435_));
  oai21  g278(.a(new_n435_), .b(new_n433_), .c(x005), .O(new_n436_));
  nor2   g279(.a(x085), .b(x053), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(x029), .O(new_n438_));
  aoi21  g281(.a(new_n438_), .b(new_n248_), .c(x037), .O(new_n439_));
  and2   g282(.a(new_n437_), .b(new_n241_), .O(new_n440_));
  oai21  g283(.a(new_n440_), .b(new_n439_), .c(x069), .O(new_n441_));
  nand2  g284(.a(new_n419_), .b(x021), .O(new_n442_));
  aoi21  g285(.a(new_n424_), .b(new_n416_), .c(new_n419_), .O(new_n443_));
  nand2  g286(.a(new_n245_), .b(x029), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(new_n443_), .c(new_n442_), .O(new_n445_));
  aoi21  g288(.a(new_n424_), .b(x029), .c(new_n241_), .O(new_n446_));
  nor2   g289(.a(new_n446_), .b(new_n263_), .O(new_n447_));
  aoi21  g290(.a(new_n445_), .b(new_n234_), .c(new_n447_), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(x085), .c(new_n441_), .O(new_n449_));
  aoi21  g292(.a(new_n437_), .b(new_n419_), .c(x077), .O(new_n450_));
  nor2   g293(.a(new_n248_), .b(x013), .O(new_n451_));
  nor2   g294(.a(new_n267_), .b(x053), .O(new_n452_));
  aoi22  g295(.a(new_n452_), .b(new_n451_), .c(x053), .d(x037), .O(new_n453_));
  oai21  g296(.a(new_n450_), .b(new_n235_), .c(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n449_), .b(new_n237_), .c(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n436_), .c(x045), .O(z13));
  inv1   g299(.a(x078), .O(new_n457_));
  inv1   g300(.a(x102), .O(new_n458_));
  nand2  g301(.a(new_n293_), .b(new_n458_), .O(new_n459_));
  inv1   g302(.a(x110), .O(new_n460_));
  nand2  g303(.a(new_n292_), .b(new_n460_), .O(new_n461_));
  aoi21  g304(.a(new_n459_), .b(new_n287_), .c(new_n461_), .O(new_n462_));
  nor2   g305(.a(new_n462_), .b(x070), .O(new_n463_));
  nor2   g306(.a(x110), .b(x022), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(x126), .c(x086), .O(new_n465_));
  nand2  g308(.a(x022), .b(x014), .O(new_n466_));
  oai21  g309(.a(new_n326_), .b(x030), .c(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n293_), .b(x118), .c(x038), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(x110), .O(new_n469_));
  oai21  g312(.a(new_n458_), .b(x062), .c(new_n292_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n291_), .O(new_n471_));
  nand4  g314(.a(new_n471_), .b(new_n469_), .c(new_n467_), .d(new_n465_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n463_), .c(new_n457_), .O(new_n473_));
  nand4  g316(.a(x126), .b(new_n297_), .c(new_n291_), .d(x014), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n473_), .c(x054), .O(new_n475_));
  nand3  g318(.a(x086), .b(new_n291_), .c(new_n301_), .O(new_n476_));
  inv1   g319(.a(new_n476_), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n475_), .c(x006), .O(new_n478_));
  nor2   g321(.a(x086), .b(x054), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(x030), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n302_), .c(x038), .O(new_n481_));
  and2   g324(.a(new_n479_), .b(new_n326_), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n481_), .c(x070), .O(new_n483_));
  nand2  g326(.a(new_n461_), .b(x022), .O(new_n484_));
  aoi21  g327(.a(new_n466_), .b(new_n459_), .c(new_n461_), .O(new_n485_));
  nand2  g328(.a(new_n304_), .b(x030), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n484_), .O(new_n487_));
  aoi21  g330(.a(new_n466_), .b(x030), .c(new_n326_), .O(new_n488_));
  nor2   g331(.a(new_n488_), .b(new_n291_), .O(new_n489_));
  aoi21  g332(.a(new_n487_), .b(new_n286_), .c(new_n489_), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(x086), .c(new_n483_), .O(new_n491_));
  aoi21  g334(.a(new_n479_), .b(new_n461_), .c(x078), .O(new_n492_));
  nor2   g335(.a(new_n302_), .b(x014), .O(new_n493_));
  nor2   g336(.a(new_n316_), .b(x054), .O(new_n494_));
  aoi22  g337(.a(new_n494_), .b(new_n493_), .c(x054), .d(x038), .O(new_n495_));
  oai21  g338(.a(new_n492_), .b(new_n301_), .c(new_n495_), .O(new_n496_));
  aoi21  g339(.a(new_n491_), .b(new_n457_), .c(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n478_), .c(x046), .O(z14));
  zero   g341(.O(z07));
  zero   g342(.O(z15));
  zero   g343(.O(z16));
  zero   g344(.O(z17));
