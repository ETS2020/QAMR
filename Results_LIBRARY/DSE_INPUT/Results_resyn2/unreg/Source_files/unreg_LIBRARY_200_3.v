...
module FAU ( 
  ...
  nand2  g70(.a(x19), .b(new_n122_), .O(new_n123_));
  nor2   g71(.a(x18), .b(x14), .O(new_n124_));
  oai22  g72(.a(new_n124_), .b(new_n123_), .c(x33), .d(x19), .O(z13));
  inv1   g73(.a(x35), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(x18), .O(new_n127_));
  nand3  g75(.a(x19), .b(new_n57_), .c(x13), .O(new_n128_));
  nand2  g76(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g77(.a(new_n129_), .b(new_n122_), .O(new_n130_));
  inv1   g78(.a(x34), .O(new_n131_));
  nand2  g79(.a(new_n131_), .b(new_n54_), .O(new_n132_));
  nand2  g80(.a(new_n132_), .b(new_n130_), .O(z14));
