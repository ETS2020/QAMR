...
module FAU ( 
  ...
  inv1   g50(.a(x17), .O(new_n103_));
  inv1   g51(.a(x10), .O(new_n104_));
  nand2  g52(.a(x19), .b(x18), .O(new_n105_));
  oai22  g53(.a(new_n105_), .b(x30), .c(x18), .d(new_n104_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand2  g55(.a(new_n100_), .b(new_n54_), .O(new_n108_));
