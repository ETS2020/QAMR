// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:21 2020
...
module FAU ( 
  ...
  inv1   g60(.a(x24), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(x18), .O(new_n114_));
  nand3  g62(.a(x19), .b(new_n57_), .c(x08), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  inv1   g65(.a(x31), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(new_n54_), .O(new_n119_));
  nand2  g67(.a(new_n119_), .b(new_n117_), .O(z11));
