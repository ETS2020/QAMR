...
module FAU ( 
  ...
  inv1   g49(.a(x17), .O(new_n102_));
  nand2  g50(.a(x19), .b(new_n102_), .O(new_n103_));
  nor2   g51(.a(x18), .b(x10), .O(new_n104_));
  oai22  g52(.a(new_n104_), .b(new_n103_), .c(x29), .d(x19), .O(z09));
  inv1   g53(.a(x30), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n54_), .O(new_n107_));
  nand3  g55(.a(new_n106_), .b(new_n57_), .c(x09), .O(new_n108_));
  inv1   g56(.a(x31), .O(new_n109_));
  nand3  g57(.a(new_n109_), .b(x19), .c(x18), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n102_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n107_), .O(z10));
