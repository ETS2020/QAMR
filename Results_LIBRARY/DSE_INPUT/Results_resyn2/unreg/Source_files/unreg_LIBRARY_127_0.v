...
module FAU ( 
  ...
  nand2  g56(.a(new_n108_), .b(x18), .O(new_n109_));
  nand3  g57(.a(x19), .b(new_n57_), .c(x09), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n107_), .O(new_n112_));
  inv1   g60(.a(x30), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n54_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n112_), .O(z10));
