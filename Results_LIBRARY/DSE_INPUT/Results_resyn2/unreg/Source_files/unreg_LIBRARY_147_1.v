...
module FAU ( 
  ...
  nand2  g12(.a(new_n55_), .b(new_n64_), .O(new_n65_));
  oai21  g13(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(z01));
  inv1   g14(.a(x17), .O(new_n67_));
  inv1   g15(.a(x01), .O(new_n68_));
  nand2  g16(.a(x19), .b(x18), .O(new_n69_));
  oai22  g17(.a(new_n69_), .b(x23), .c(x18), .d(new_n68_), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nand2  g19(.a(new_n64_), .b(new_n54_), .O(new_n72_));
  nand2  g20(.a(new_n72_), .b(new_n71_), .O(z02));
  inv1   g21(.a(x16), .O(new_n74_));
  nand2  g22(.a(x18), .b(new_n74_), .O(new_n75_));
  inv1   g23(.a(x00), .O(new_n76_));
  nand2  g24(.a(new_n57_), .b(new_n76_), .O(new_n77_));
  nand3  g25(.a(new_n77_), .b(new_n75_), .c(new_n55_), .O(new_n78_));
  oai21  g26(.a(x23), .b(x19), .c(new_n78_), .O(z03));
  nand2  g27(.a(x25), .b(x18), .O(new_n80_));
  inv1   g28(.a(x07), .O(new_n81_));
  nand2  g29(.a(new_n57_), .b(new_n81_), .O(new_n82_));
  nand3  g30(.a(new_n82_), .b(new_n80_), .c(new_n55_), .O(new_n83_));
  oai21  g31(.a(x24), .b(x19), .c(new_n83_), .O(z04));
  nand2  g32(.a(x26), .b(x18), .O(new_n85_));
  inv1   g33(.a(x06), .O(new_n86_));
  nand2  g34(.a(new_n57_), .b(new_n86_), .O(new_n87_));
  nand3  g35(.a(new_n87_), .b(new_n85_), .c(new_n55_), .O(new_n88_));
  oai21  g36(.a(x25), .b(x19), .c(new_n88_), .O(z05));
  nand2  g37(.a(x27), .b(x18), .O(new_n90_));
  inv1   g38(.a(x05), .O(new_n91_));
  nand2  g39(.a(new_n57_), .b(new_n91_), .O(new_n92_));
  nand3  g40(.a(new_n92_), .b(new_n90_), .c(new_n55_), .O(new_n93_));
