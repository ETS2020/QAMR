// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:35 2020
...
module FAU ( 
  ...
  inv1   g34(.a(x17), .O(new_n87_));
  nand2  g35(.a(x19), .b(new_n87_), .O(new_n88_));
  nor2   g36(.a(x18), .b(x05), .O(new_n89_));
  oai22  g37(.a(new_n89_), .b(new_n88_), .c(x26), .d(x19), .O(z06));
  inv1   g38(.a(x20), .O(new_n91_));
  nand3  g39(.a(new_n91_), .b(x19), .c(x18), .O(new_n92_));
  inv1   g40(.a(x27), .O(new_n93_));
  nand3  g41(.a(new_n93_), .b(new_n57_), .c(x04), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  nand2  g44(.a(new_n93_), .b(new_n54_), .O(new_n97_));
