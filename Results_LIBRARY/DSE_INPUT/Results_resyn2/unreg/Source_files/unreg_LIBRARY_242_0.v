...
module FAU ( 
  ...
  nand2  g31(.a(new_n83_), .b(x18), .O(new_n84_));
  nand3  g32(.a(x19), .b(new_n57_), .c(x06), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  inv1   g35(.a(x25), .O(new_n88_));
  nand2  g36(.a(new_n88_), .b(new_n54_), .O(new_n89_));
