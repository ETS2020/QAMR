...
module FAU ( 
  ...
  nand2  g036(.a(new_n88_), .b(x24), .O(z04));
  ...
  nand2  g079(.a(x19), .b(new_n56_), .O(new_n132_));
  nand2  g080(.a(new_n59_), .b(x08), .O(new_n133_));
  oai22  g081(.a(new_n133_), .b(new_n132_), .c(x31), .d(x19), .O(z11));
