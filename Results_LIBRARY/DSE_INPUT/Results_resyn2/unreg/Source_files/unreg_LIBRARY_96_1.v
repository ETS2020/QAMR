...
module FAU ( 
  ...
  nand2  g75(.a(new_n127_), .b(new_n54_), .O(new_n128_));
  nor2   g76(.a(x18), .b(x13), .O(new_n129_));
  inv1   g77(.a(x35), .O(new_n130_));
  nand2  g78(.a(new_n55_), .b(new_n130_), .O(new_n131_));
  oai21  g79(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(z14));
  inv1   g80(.a(x17), .O(new_n133_));
  inv1   g81(.a(x12), .O(new_n134_));
  nand2  g82(.a(x19), .b(x18), .O(new_n135_));
  oai22  g83(.a(new_n135_), .b(x28), .c(x18), .d(new_n134_), .O(new_n136_));
  nand2  g84(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g85(.a(new_n130_), .b(new_n54_), .O(new_n138_));
