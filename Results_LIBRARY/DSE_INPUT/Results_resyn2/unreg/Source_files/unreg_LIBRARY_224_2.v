...
module FAU ( 
  ...
  nand2  g56(.a(x19), .b(x18), .O(new_n109_));
  oai22  g57(.a(new_n109_), .b(x31), .c(x18), .d(new_n108_), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  inv1   g59(.a(x30), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n111_), .O(z10));
