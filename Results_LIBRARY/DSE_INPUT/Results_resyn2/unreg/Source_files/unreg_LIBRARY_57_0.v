...
module FAU ( 
  ...
  nand2  g15(.a(new_n67_), .b(x18), .O(new_n68_));
  nand3  g16(.a(x19), .b(new_n57_), .c(x01), .O(new_n69_));
  nand2  g17(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n66_), .O(new_n71_));
  inv1   g19(.a(x22), .O(new_n72_));
  nand2  g20(.a(new_n72_), .b(new_n54_), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n71_), .O(z02));
