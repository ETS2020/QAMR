...
module FAU ( 
  ...
  nand2  g45(.a(x19), .b(new_n97_), .O(new_n98_));
  nor2   g46(.a(x18), .b(x11), .O(new_n99_));
  oai22  g47(.a(new_n99_), .b(new_n98_), .c(x28), .d(x19), .O(z08));
  inv1   g48(.a(x30), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(x18), .O(new_n102_));
  nand3  g50(.a(x19), .b(new_n57_), .c(x10), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  inv1   g53(.a(x29), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n54_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n105_), .O(z09));
