...
module FAU ( 
  ...
  nand2  g76(.a(x19), .b(x18), .O(new_n129_));
  oai22  g77(.a(new_n129_), .b(x35), .c(x18), .d(new_n128_), .O(new_n130_));
  nand2  g78(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  inv1   g79(.a(x34), .O(new_n132_));
  nand2  g80(.a(new_n132_), .b(new_n54_), .O(new_n133_));
  nand2  g81(.a(new_n133_), .b(new_n131_), .O(z14));
