...
module FAU ( 
  ...
  nand3  g60(.a(x19), .b(new_n57_), .c(x08), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n107_), .O(new_n115_));
  inv1   g63(.a(x31), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(new_n54_), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n115_), .O(z11));
