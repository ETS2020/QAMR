// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:51 2020
...
module FAU ( 
  ...
  nand2  g36(.a(x19), .b(x18), .O(new_n89_));
  oai22  g37(.a(new_n89_), .b(x27), .c(x18), .d(new_n88_), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n87_), .O(new_n91_));
  inv1   g39(.a(x26), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n54_), .O(new_n93_));
