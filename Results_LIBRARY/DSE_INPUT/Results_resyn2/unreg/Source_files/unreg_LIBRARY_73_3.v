...
module FAU ( 
  ...
  nand2  g26(.a(new_n78_), .b(x18), .O(new_n79_));
  nand3  g27(.a(x19), .b(new_n57_), .c(x07), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g29(.a(new_n81_), .b(new_n77_), .O(new_n82_));
  inv1   g30(.a(x24), .O(new_n83_));
  nand2  g31(.a(new_n83_), .b(new_n54_), .O(new_n84_));
  ...
  nand2  g63(.a(x19), .b(new_n77_), .O(new_n116_));
