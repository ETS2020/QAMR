// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:02 2020
...
module FAU ( 
  ...
  nand2  g65(.a(x19), .b(new_n117_), .O(new_n118_));
  nor2   g66(.a(x18), .b(x15), .O(new_n119_));
  oai22  g67(.a(new_n119_), .b(new_n118_), .c(x32), .d(x19), .O(z12));
  inv1   g68(.a(x33), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n54_), .O(new_n122_));
  nand3  g70(.a(new_n121_), .b(new_n57_), .c(x14), .O(new_n123_));
  inv1   g71(.a(x34), .O(new_n124_));
  nand3  g72(.a(new_n124_), .b(x19), .c(x18), .O(new_n125_));
  nand2  g73(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(new_n117_), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n122_), .O(z13));
