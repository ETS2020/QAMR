// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:01 2020
...
module FAU ( 
  ...
  nand2  g046(.a(x19), .b(new_n56_), .O(new_n99_));
  inv1   g047(.a(x27), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(x18), .O(new_n101_));
  oai22  g049(.a(new_n101_), .b(new_n99_), .c(x26), .d(x19), .O(z06));
  nand2  g050(.a(new_n100_), .b(new_n53_), .O(new_n103_));
