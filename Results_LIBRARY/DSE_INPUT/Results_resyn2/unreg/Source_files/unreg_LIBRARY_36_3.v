...
module FAU ( 
  ...
  nand2  g39(.a(new_n91_), .b(x18), .O(new_n92_));
  nand3  g40(.a(x19), .b(new_n57_), .c(x04), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  inv1   g43(.a(x27), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n54_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n95_), .O(z07));
