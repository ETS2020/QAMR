...
module FAU ( 
  ...
  nand2  g36(.a(new_n88_), .b(x18), .O(new_n89_));
  nand3  g37(.a(x19), .b(new_n57_), .c(x05), .O(new_n90_));
  nand2  g38(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  inv1   g40(.a(x26), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n92_), .O(z06));
