...
module FAU ( 
  ...
  nand2  g69(.a(new_n121_), .b(x18), .O(new_n122_));
  nand3  g70(.a(x19), .b(new_n57_), .c(x14), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g72(.a(new_n124_), .b(new_n117_), .O(new_n125_));
  inv1   g73(.a(x33), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(new_n54_), .O(new_n127_));
  nand2  g75(.a(new_n127_), .b(new_n125_), .O(z13));
