// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:39 2020
...
module FAU ( 
  ...
  nand3  g14(.a(x19), .b(new_n57_), .c(x01), .O(new_n67_));
  nand2  g15(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(new_n61_), .O(new_n69_));
  inv1   g17(.a(x22), .O(new_n70_));
  nand2  g18(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand2  g19(.a(new_n71_), .b(new_n69_), .O(z02));
  nand2  g20(.a(new_n65_), .b(new_n54_), .O(new_n73_));
