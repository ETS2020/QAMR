...
module FAU ( 
  ...
  nor2   g31(.a(x18), .b(x06), .O(new_n84_));
  inv1   g32(.a(x26), .O(new_n85_));
  nand2  g33(.a(new_n55_), .b(new_n85_), .O(new_n86_));
  oai21  g34(.a(new_n86_), .b(new_n84_), .c(new_n83_), .O(z05));
  inv1   g35(.a(x17), .O(new_n88_));
  inv1   g36(.a(x05), .O(new_n89_));
  nand2  g37(.a(x19), .b(x18), .O(new_n90_));
  oai22  g38(.a(new_n90_), .b(x27), .c(x18), .d(new_n89_), .O(new_n91_));
  nand2  g39(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand2  g40(.a(new_n85_), .b(new_n54_), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n92_), .O(z06));
  nand2  g42(.a(x20), .b(x18), .O(new_n95_));
  inv1   g43(.a(x04), .O(new_n96_));
  nand2  g44(.a(new_n57_), .b(new_n96_), .O(new_n97_));
  nand3  g45(.a(new_n97_), .b(new_n95_), .c(new_n55_), .O(new_n98_));
  oai21  g46(.a(x27), .b(x19), .c(new_n98_), .O(z07));
  nand2  g47(.a(x29), .b(x18), .O(new_n100_));
  inv1   g48(.a(x11), .O(new_n101_));
  nand2  g49(.a(new_n57_), .b(new_n101_), .O(new_n102_));
  nand3  g50(.a(new_n102_), .b(new_n100_), .c(new_n55_), .O(new_n103_));
