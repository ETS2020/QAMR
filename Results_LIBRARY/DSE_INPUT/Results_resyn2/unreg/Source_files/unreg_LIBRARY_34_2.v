...
module FAU ( 
  ...
  nand2  g064(.a(new_n116_), .b(x28), .O(z08));
  ...
  nand2  g107(.a(x19), .b(new_n56_), .O(new_n160_));
  nand2  g108(.a(new_n59_), .b(x12), .O(new_n161_));
  oai22  g109(.a(new_n161_), .b(new_n160_), .c(x35), .d(x19), .O(z15));
endmodule
