// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:15 2020
...
module FAU ( 
  ...
  nand2  g010(.a(x19), .b(new_n56_), .O(new_n63_));
  inv1   g011(.a(x22), .O(new_n64_));
  aoi21  g012(.a(new_n59_), .b(x02), .c(new_n64_), .O(new_n65_));
  inv1   g013(.a(x21), .O(new_n66_));
  nand2  g014(.a(new_n66_), .b(new_n53_), .O(new_n67_));
  oai21  g015(.a(new_n65_), .b(new_n63_), .c(new_n67_), .O(z01));
  nand2  g016(.a(new_n64_), .b(new_n53_), .O(new_n69_));
