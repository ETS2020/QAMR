// Benchmark "FAU" written by ABC on Mon Jul 27 22:41:46 2020
...
module FAU ( 
  ...
  nand2  g109(.a(x19), .b(new_n56_), .O(new_n162_));
  aoi21  g110(.a(new_n113_), .b(x18), .c(x12), .O(new_n163_));
  inv1   g111(.a(x35), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n53_), .O(new_n165_));
  oai21  g113(.a(new_n163_), .b(new_n162_), .c(new_n165_), .O(z15));
endmodule
