...
module FAU ( 
  ...
  nand2  g81(.a(x19), .b(x18), .O(new_n134_));
  oai22  g82(.a(new_n134_), .b(x28), .c(x18), .d(new_n133_), .O(new_n135_));
  nand2  g83(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  inv1   g84(.a(x35), .O(new_n137_));
  nand2  g85(.a(new_n137_), .b(new_n54_), .O(new_n138_));
  nand2  g86(.a(new_n138_), .b(new_n136_), .O(z15));
endmodule
