...
module FAU ( 
  ...
  nand3  g52(.a(x19), .b(new_n57_), .c(x10), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n102_), .O(new_n107_));
  inv1   g55(.a(x29), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n54_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n107_), .O(z09));
