// Benchmark "FAU" written by ABC on Mon Jul 27 22:42:20 2020
...
module FAU ( 
  ...
  nand2  g067(.a(x19), .b(new_n56_), .O(new_n120_));
  nand2  g068(.a(new_n59_), .b(x10), .O(new_n121_));
  oai22  g069(.a(new_n121_), .b(new_n120_), .c(x29), .d(x19), .O(z09));
