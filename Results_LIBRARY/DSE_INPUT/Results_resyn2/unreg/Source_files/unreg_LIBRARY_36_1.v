...
module FAU ( 
  ...
  inv1   g34(.a(x26), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  nor2   g36(.a(x18), .b(x05), .O(new_n89_));
  inv1   g37(.a(x27), .O(new_n90_));
  nand2  g38(.a(new_n55_), .b(new_n90_), .O(new_n91_));
  oai21  g39(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(z06));
  inv1   g40(.a(x17), .O(new_n93_));
  inv1   g41(.a(x04), .O(new_n94_));
  nand2  g42(.a(x19), .b(x18), .O(new_n95_));
  oai22  g43(.a(new_n95_), .b(x20), .c(x18), .d(new_n94_), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand2  g45(.a(new_n90_), .b(new_n54_), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n97_), .O(z07));
