...
module FAU ( 
  ...
  oai21  g26(.a(x09), .b(x07), .c(x11), .O(new_n51_));
  ...
  nand4  g38(.a(new_n52_), .b(new_n62_), .c(x13), .d(new_n53_), .O(z5));
  ...
  nand4  g43(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n68_));
  nand3  g44(.a(new_n58_), .b(new_n46_), .c(new_n42_), .O(new_n69_));
  ...
  oai21  g49(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n62_), .O(z7));
  nand2  g51(.a(new_n45_), .b(x00), .O(new_n76_));
  nand4  g52(.a(new_n64_), .b(new_n53_), .c(x09), .d(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n62_), .O(z8));
endmodule
