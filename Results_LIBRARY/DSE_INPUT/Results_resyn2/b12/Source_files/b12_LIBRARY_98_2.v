...
module FAU ( 
  ...
  aoi21  g07(.a(new_n29_), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  ...
  oai21  g11(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(new_n36_));
  aoi21  g12(.a(new_n25_), .b(new_n31_), .c(x00), .O(new_n37_));
  nand3  g13(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(new_n38_));
  ...
  nand4  g31(.a(new_n45_), .b(x13), .c(new_n55_), .d(new_n40_), .O(z5));
  nand2  g32(.a(new_n44_), .b(x03), .O(new_n57_));
  nand2  g33(.a(x09), .b(new_n31_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n30_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n60_));
  oai21  g36(.a(new_n26_), .b(x00), .c(new_n51_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x14), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n45_), .O(new_n63_));
  nor2   g39(.a(new_n63_), .b(new_n60_), .O(z6));
  nand3  g40(.a(x03), .b(new_n29_), .c(new_n30_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x09), .O(new_n67_));
  nand2  g43(.a(new_n65_), .b(new_n42_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(z7));
  nand2  g45(.a(new_n44_), .b(x00), .O(new_n70_));
  nand3  g46(.a(new_n66_), .b(new_n55_), .c(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n45_), .O(z8));
endmodule
