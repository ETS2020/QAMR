...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n60_, new_n62_, new_n63_, new_n64_, new_n66_;
  ...
  nand3  g23(.a(new_n47_), .b(new_n46_), .c(new_n25_), .O(new_n48_));
  ...
  nand3  g31(.a(new_n55_), .b(new_n45_), .c(x13), .O(z5));
  xnor2a g32(.a(x09), .b(x03), .O(new_n57_));
  nor2   g33(.a(x02), .b(x01), .O(new_n58_));
  nand4  g34(.a(x14), .b(x02), .c(x01), .d(new_n40_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n51_), .c(new_n45_), .O(new_n60_));
  aoi21  g36(.a(new_n58_), .b(new_n57_), .c(new_n60_), .O(z6));
  nand3  g37(.a(new_n58_), .b(x09), .c(x03), .O(new_n62_));
  nand2  g38(.a(new_n58_), .b(x03), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n42_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n45_), .O(z7));
  oai22  g41(.a(new_n62_), .b(x12), .c(x09), .d(new_n40_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n45_), .O(z8));
endmodule
