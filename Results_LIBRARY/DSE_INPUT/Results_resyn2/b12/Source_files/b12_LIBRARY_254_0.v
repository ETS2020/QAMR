// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:37 2020
...
module FAU ( 
  ...
  nand2  g32(.a(x09), .b(new_n35_), .O(new_n58_));
  nand2  g33(.a(new_n45_), .b(x03), .O(new_n59_));
  ...
  aoi21  g41(.a(new_n57_), .b(x03), .c(new_n43_), .O(new_n67_));
  nand3  g42(.a(new_n57_), .b(new_n45_), .c(x03), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z7));
  nand3  g45(.a(new_n66_), .b(new_n45_), .c(x00), .O(z8));
  one    g46(.O(z5));
endmodule
