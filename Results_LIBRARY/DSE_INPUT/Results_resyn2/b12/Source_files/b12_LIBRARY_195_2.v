...
module FAU ( 
  ...
  nand3  g43(.a(x03), .b(new_n29_), .c(new_n28_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x09), .O(new_n70_));
  nand2  g46(.a(new_n68_), .b(new_n43_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n57_), .O(z7));
  nand4  g48(.a(new_n56_), .b(x09), .c(x03), .d(new_n29_), .O(new_n73_));
  oai21  g49(.a(x09), .b(new_n41_), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n57_), .O(z8));
endmodule
