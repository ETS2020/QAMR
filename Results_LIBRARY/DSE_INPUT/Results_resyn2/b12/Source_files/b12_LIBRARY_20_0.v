...
module FAU ( 
  ...
  nand2  g09(.a(x03), .b(x01), .O(new_n34_));
  nand2  g10(.a(new_n34_), .b(new_n29_), .O(new_n35_));
  ...
  aoi21  g15(.a(new_n37_), .b(x06), .c(new_n39_), .O(z1));
  inv1   g16(.a(x07), .O(new_n41_));
  inv1   g17(.a(x08), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n41_), .c(new_n38_), .O(new_n43_));
  ...
  aoi21  g24(.a(new_n48_), .b(new_n29_), .c(new_n43_), .O(z2));
  aoi22  g25(.a(x12), .b(new_n38_), .c(x11), .d(x07), .O(z3));
  ...
  nand4  g32(.a(new_n56_), .b(x13), .c(new_n55_), .d(new_n38_), .O(z5));
  xor2a  g33(.a(x09), .b(x03), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n30_), .O(new_n59_));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n38_), .O(new_n60_));
  ...
  nand2  g40(.a(new_n63_), .b(x03), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n42_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n56_), .O(z7));
  nand2  g43(.a(new_n44_), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n63_), .b(new_n55_), .c(x09), .d(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n56_), .O(z8));
endmodule
