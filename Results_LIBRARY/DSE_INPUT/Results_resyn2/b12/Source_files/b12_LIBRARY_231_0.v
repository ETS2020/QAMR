// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:25 2020
...
module FAU ( 
  ...
  nand4  g32(.a(new_n56_), .b(x13), .c(new_n55_), .d(new_n41_), .O(z5));
  inv1   g33(.a(new_n51_), .O(new_n58_));
  nand2  g34(.a(new_n31_), .b(x09), .O(new_n59_));
  nand4  g35(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n59_), .c(new_n58_), .d(new_n56_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z6));
  nand2  g38(.a(new_n32_), .b(new_n43_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n59_), .c(new_n56_), .O(z7));
  nand2  g40(.a(x05), .b(x02), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n36_), .c(x01), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n41_), .c(x09), .O(new_n67_));
  nand3  g43(.a(new_n31_), .b(new_n55_), .c(x09), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n67_), .c(new_n56_), .O(z8));
endmodule
