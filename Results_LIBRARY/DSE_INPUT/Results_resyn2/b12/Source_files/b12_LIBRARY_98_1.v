...
module FAU ( 
  ...
  aoi22  g27(.a(x12), .b(new_n42_), .c(x11), .d(x07), .O(z3));
  nor2   g28(.a(x07), .b(new_n42_), .O(new_n53_));
  nor2   g29(.a(new_n46_), .b(new_n44_), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n53_), .c(x11), .d(x07), .O(z4));
  inv1   g31(.a(x12), .O(new_n56_));
  nand4  g32(.a(new_n47_), .b(x13), .c(new_n56_), .d(new_n42_), .O(z5));
  nand3  g33(.a(x14), .b(x02), .c(x01), .O(new_n58_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n28_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n60_), .c(new_n47_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(z6));
  aoi21  g41(.a(new_n28_), .b(x03), .c(new_n44_), .O(new_n66_));
  nand3  g42(.a(new_n28_), .b(new_n46_), .c(x03), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n47_), .O(z7));
  nand3  g45(.a(new_n28_), .b(new_n56_), .c(x03), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x09), .O(new_n71_));
  nand2  g47(.a(new_n46_), .b(new_n42_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n47_), .O(z8));
endmodule
