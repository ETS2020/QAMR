// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:15 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n58_, new_n60_, new_n61_, new_n62_, new_n64_, new_n66_;
  ...
  nand3  g19(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(new_n44_));
  ...
  oai21  g25(.a(x03), .b(x01), .c(new_n27_), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n49_), .c(new_n41_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n48_), .O(z2));
  aoi22  g28(.a(x12), .b(new_n35_), .c(x11), .d(x07), .O(z3));
  nor2   g29(.a(x07), .b(new_n35_), .O(new_n54_));
  nor2   g30(.a(new_n42_), .b(new_n49_), .O(new_n55_));
  aoi22  g31(.a(new_n55_), .b(new_n54_), .c(x11), .d(x07), .O(z4));
  inv1   g32(.a(x12), .O(new_n57_));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n57_), .d(new_n35_), .O(z5));
  xnor2a g35(.a(x09), .b(x03), .O(new_n60_));
  nand2  g36(.a(new_n28_), .b(x14), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n58_), .c(new_n35_), .O(new_n62_));
  aoi21  g38(.a(new_n60_), .b(new_n30_), .c(new_n62_), .O(z6));
  nand3  g39(.a(new_n30_), .b(x09), .c(x03), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n58_), .O(z7));
  oai22  g41(.a(new_n64_), .b(x12), .c(x09), .d(new_n35_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n58_), .O(z8));
endmodule
