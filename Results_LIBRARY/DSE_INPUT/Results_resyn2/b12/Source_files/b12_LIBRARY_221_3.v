// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:20 2020
...
module FAU ( 
  ...
  aoi21  g24(.a(new_n48_), .b(new_n39_), .c(new_n42_), .O(z2));
  aoi22  g25(.a(x12), .b(new_n33_), .c(x11), .d(x07), .O(z3));
  nor2   g26(.a(new_n41_), .b(new_n33_), .O(new_n51_));
  nor2   g27(.a(new_n44_), .b(x07), .O(new_n52_));
  aoi22  g28(.a(new_n52_), .b(new_n51_), .c(x11), .d(x07), .O(z4));
  inv1   g29(.a(x12), .O(new_n54_));
  nand4  g30(.a(new_n45_), .b(x13), .c(new_n54_), .d(new_n33_), .O(z5));
  nand2  g31(.a(x09), .b(new_n34_), .O(new_n56_));
  nand2  g32(.a(new_n44_), .b(x03), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n28_), .O(new_n58_));
  nand3  g34(.a(new_n44_), .b(x03), .c(new_n39_), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(x14), .c(x01), .d(new_n33_), .O(new_n60_));
  aoi21  g36(.a(x08), .b(x00), .c(x10), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n58_), .O(new_n62_));
  nand4  g38(.a(x14), .b(new_n39_), .c(x01), .d(new_n33_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(x07), .O(z6));
  aoi21  g40(.a(new_n28_), .b(x03), .c(new_n41_), .O(new_n65_));
  nand3  g41(.a(new_n28_), .b(new_n44_), .c(x03), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(z7));
  nand2  g44(.a(new_n28_), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n54_), .b(x09), .O(new_n70_));
  oai22  g46(.a(new_n70_), .b(new_n69_), .c(x09), .d(new_n33_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n45_), .O(z8));
endmodule
