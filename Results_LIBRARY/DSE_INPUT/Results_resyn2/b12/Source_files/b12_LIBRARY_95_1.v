// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:14 2020
...
module FAU ( 
  ...
  oai21  g44(.a(new_n30_), .b(new_n35_), .c(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(z7));
  inv1   g46(.a(new_n68_), .O(new_n71_));
  nor2   g47(.a(x09), .b(new_n41_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(z8));
endmodule
