...
module FAU ( 
  ...
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(x13), .d(new_n46_), .O(z5));
  ...
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(z7));
  oai21  g48(.a(new_n57_), .b(x09), .c(x12), .O(new_n73_));
  inv1   g49(.a(x12), .O(new_n74_));
  oai21  g50(.a(new_n30_), .b(new_n35_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n68_), .O(z8));
endmodule
