...
module FAU ( 
  ...
  aoi21  g27(.a(x10), .b(new_n42_), .c(new_n51_), .O(new_n52_));
  aoi21  g28(.a(x12), .b(new_n41_), .c(new_n52_), .O(z3));
  nor2   g29(.a(new_n51_), .b(new_n42_), .O(new_n54_));
  nand3  g30(.a(x09), .b(x08), .c(new_n42_), .O(new_n55_));
  inv1   g31(.a(new_n55_), .O(new_n56_));
  oai22  g32(.a(new_n56_), .b(new_n54_), .c(new_n52_), .d(x00), .O(z4));
  inv1   g33(.a(x12), .O(new_n58_));
  nor3   g34(.a(x11), .b(x10), .c(x07), .O(new_n59_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n46_), .c(new_n42_), .O(new_n67_));
  ...
  oai21  g47(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n59_), .O(z7));
  nand2  g49(.a(new_n45_), .b(x00), .O(new_n74_));
  nand4  g50(.a(new_n61_), .b(new_n58_), .c(x09), .d(x03), .O(new_n75_));
