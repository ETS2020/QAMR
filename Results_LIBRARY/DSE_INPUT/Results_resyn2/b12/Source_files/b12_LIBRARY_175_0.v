// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:56 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_, new_n65_,
  ...
  nor2   g12(.a(new_n36_), .b(new_n27_), .O(new_n37_));
  nand2  g13(.a(new_n37_), .b(new_n35_), .O(new_n38_));
  aoi21  g14(.a(new_n38_), .b(new_n34_), .c(x00), .O(z1));
  inv1   g15(.a(x00), .O(new_n40_));
  aoi21  g16(.a(new_n36_), .b(new_n25_), .c(new_n27_), .O(new_n41_));
  inv1   g17(.a(x03), .O(new_n42_));
  oai21  g18(.a(x10), .b(x07), .c(new_n42_), .O(new_n43_));
  ...
  oai21  g23(.a(new_n47_), .b(new_n41_), .c(new_n40_), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand2  g25(.a(x10), .b(x03), .O(new_n50_));
  inv1   g26(.a(x09), .O(new_n51_));
  nand2  g27(.a(new_n45_), .b(new_n51_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n50_), .c(new_n25_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n49_), .c(new_n44_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n48_), .O(z2));
  aoi22  g32(.a(x12), .b(new_n40_), .c(x11), .d(x07), .O(z3));
  nor2   g33(.a(new_n51_), .b(x07), .O(new_n58_));
  nand2  g34(.a(x08), .b(x00), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n58_), .c(x11), .d(x07), .O(z4));
  nor2   g37(.a(x10), .b(x07), .O(new_n62_));
  nor2   g38(.a(x12), .b(x00), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(x13), .O(z5));
  xor2a  g40(.a(x09), .b(x03), .O(new_n65_));
  nor3   g41(.a(new_n65_), .b(x02), .c(x01), .O(new_n66_));
  nand3  g42(.a(new_n31_), .b(x14), .c(new_n40_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n59_), .c(new_n62_), .O(new_n68_));
  nor2   g44(.a(new_n68_), .b(new_n66_), .O(z6));
  nand3  g45(.a(x03), .b(new_n27_), .c(new_n25_), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x09), .O(new_n72_));
  nand2  g48(.a(new_n70_), .b(new_n49_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n62_), .O(z7));
  nand2  g50(.a(new_n51_), .b(x00), .O(new_n75_));
