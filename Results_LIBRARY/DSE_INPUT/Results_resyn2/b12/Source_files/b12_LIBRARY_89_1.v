// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:11 2020
...
module FAU ( 
  ...
  nor3   g31(.a(x12), .b(x10), .c(x07), .O(new_n56_));
  nand2  g32(.a(new_n42_), .b(x00), .O(new_n57_));
  ...
  nand3  g40(.a(new_n52_), .b(new_n64_), .c(new_n42_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n63_), .c(new_n62_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  aoi21  g44(.a(new_n61_), .b(x03), .c(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n61_), .b(new_n45_), .c(x03), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n46_), .O(z7));
  nand2  g48(.a(new_n61_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x09), .O(new_n74_));
  nand2  g50(.a(new_n45_), .b(new_n41_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(z8));
endmodule
