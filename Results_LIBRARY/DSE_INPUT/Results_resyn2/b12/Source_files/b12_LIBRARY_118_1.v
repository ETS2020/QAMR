// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:26 2020
...
module FAU ( 
  ...
  oai21  g11(.a(new_n35_), .b(new_n28_), .c(new_n29_), .O(new_n36_));
  ...
  nand3  g32(.a(new_n56_), .b(x13), .c(new_n41_), .O(z5));
  nor2   g33(.a(x02), .b(x01), .O(new_n58_));
  nand2  g34(.a(new_n45_), .b(x03), .O(new_n59_));
  nand2  g35(.a(x09), .b(new_n35_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  nand4  g37(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n62_));
  ...
  nor2   g42(.a(x10), .b(new_n28_), .O(new_n67_));
  nand2  g43(.a(x03), .b(new_n29_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n58_), .b(x09), .c(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n56_), .O(z7));
  inv1   g47(.a(new_n70_), .O(new_n72_));
  nor2   g48(.a(x09), .b(new_n41_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n56_), .O(z8));
endmodule
