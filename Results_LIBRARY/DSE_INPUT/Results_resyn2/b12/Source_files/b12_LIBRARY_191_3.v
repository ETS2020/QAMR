// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:05 2020
...
module FAU ( 
  ...
  nand4  g06(.a(x06), .b(x05), .c(x04), .d(x01), .O(new_n31_));
  ...
  aoi22  g22(.a(x12), .b(new_n25_), .c(x11), .d(x07), .O(z3));
  ...
  nand2  g29(.a(x09), .b(new_n32_), .O(new_n54_));
  nand2  g30(.a(new_n41_), .b(x03), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n54_), .c(new_n36_), .d(new_n40_), .O(new_n56_));
  and2   g32(.a(x14), .b(x01), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n55_), .c(x02), .d(new_n25_), .O(new_n58_));
  nand2  g34(.a(new_n48_), .b(new_n42_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n58_), .c(new_n56_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z6));
  nand3  g38(.a(x09), .b(x03), .c(new_n36_), .O(new_n63_));
  oai21  g39(.a(new_n32_), .b(x02), .c(new_n38_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n42_), .O(z7));
  oai22  g41(.a(new_n63_), .b(x12), .c(x09), .d(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n42_), .O(z8));
endmodule
