...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n59_, new_n61_, new_n62_, new_n63_, new_n65_;
  ...
  nand3  g30(.a(new_n45_), .b(x13), .c(new_n40_), .O(z5));
  xnor2a g31(.a(x09), .b(x03), .O(new_n56_));
  nor2   g32(.a(x02), .b(x01), .O(new_n57_));
  nand4  g33(.a(x14), .b(x02), .c(x01), .d(new_n40_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n51_), .c(new_n45_), .O(new_n59_));
  aoi21  g35(.a(new_n57_), .b(new_n56_), .c(new_n59_), .O(z6));
  nand3  g36(.a(new_n57_), .b(x09), .c(x03), .O(new_n61_));
  nand2  g37(.a(new_n57_), .b(x03), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n42_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n61_), .c(new_n45_), .O(z7));
  oai22  g40(.a(new_n61_), .b(x12), .c(x09), .d(new_n40_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n45_), .O(z8));
endmodule
