// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:06 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n47_), .b(new_n46_), .c(new_n42_), .O(new_n48_));
  nand2  g24(.a(x10), .b(x01), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(new_n45_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n27_), .c(new_n44_), .O(z2));
  ...
  nand2  g34(.a(new_n46_), .b(x03), .O(new_n59_));
  aoi21  g35(.a(x09), .b(new_n36_), .c(x02), .O(new_n60_));
  oai21  g36(.a(new_n43_), .b(new_n41_), .c(new_n56_), .O(new_n61_));
  aoi21  g37(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(z6));
  nand3  g38(.a(x09), .b(x03), .c(new_n27_), .O(new_n63_));
  oai21  g39(.a(new_n36_), .b(x02), .c(new_n43_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n56_), .O(z7));
  nand2  g41(.a(new_n46_), .b(x00), .O(new_n66_));
  oai21  g42(.a(new_n63_), .b(x12), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n56_), .O(z8));
endmodule
