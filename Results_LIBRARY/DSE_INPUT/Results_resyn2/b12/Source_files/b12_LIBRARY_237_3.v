// Benchmark "FAU" written by ABC on Mon Jul 27 21:38:28 2020
...
module FAU ( 
  ...
  nand3  g28(.a(x13), .b(x09), .c(x08), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n42_), .c(new_n52_), .O(new_n54_));
  ...
  nand2  g35(.a(x12), .b(new_n52_), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n59_), .c(x13), .d(new_n41_), .O(z5));
  ...
  nand3  g42(.a(new_n55_), .b(new_n46_), .c(new_n42_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(z6));
  aoi21  g46(.a(new_n62_), .b(x03), .c(new_n43_), .O(new_n71_));
  nand3  g47(.a(new_n62_), .b(new_n45_), .c(x03), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n59_), .O(z7));
  nand2  g50(.a(new_n62_), .b(x03), .O(new_n75_));
  nand2  g51(.a(new_n45_), .b(x00), .O(new_n76_));
  inv1   g52(.a(x12), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x09), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n76_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n59_), .O(z8));
endmodule
