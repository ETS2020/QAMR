...
module FAU ( 
  ...
  aoi21  g17(.a(new_n37_), .b(new_n26_), .c(new_n27_), .O(new_n42_));
  ...
  oai21  g23(.a(new_n47_), .b(new_n42_), .c(new_n41_), .O(new_n48_));
  ...
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n62_), .d(new_n41_), .O(z5));
  nand2  g40(.a(new_n51_), .b(x03), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n30_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n31_), .O(new_n67_));
  nand3  g43(.a(new_n28_), .b(x14), .c(new_n41_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n59_), .d(new_n63_), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(z6));
  nand2  g46(.a(new_n31_), .b(x03), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x09), .O(new_n73_));
  nand2  g49(.a(new_n71_), .b(new_n49_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n63_), .O(z7));
  nand2  g51(.a(new_n51_), .b(x00), .O(new_n76_));
  nand3  g52(.a(new_n72_), .b(new_n62_), .c(x09), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n63_), .O(z8));
endmodule
