...
module FAU ( 
  ...
  nand2  g27(.a(new_n43_), .b(new_n42_), .O(new_n52_));
  nand2  g28(.a(x08), .b(x00), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  nor2   g30(.a(new_n45_), .b(x07), .O(new_n55_));
  aoi22  g31(.a(new_n55_), .b(new_n54_), .c(new_n52_), .d(x11), .O(z4));
  inv1   g32(.a(x12), .O(new_n57_));
  nor2   g33(.a(x10), .b(x07), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n57_), .d(new_n41_), .O(z5));
  ...
  nand3  g40(.a(new_n53_), .b(new_n46_), .c(new_n42_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(z6));
  aoi21  g44(.a(new_n60_), .b(x03), .c(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n60_), .b(new_n45_), .c(x03), .O(new_n70_));
  inv1   g46(.a(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n58_), .O(z7));
  nand2  g48(.a(new_n60_), .b(x03), .O(new_n73_));
  nand2  g49(.a(new_n45_), .b(x00), .O(new_n74_));
  nand2  g50(.a(new_n57_), .b(x09), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n58_), .O(z8));
endmodule
