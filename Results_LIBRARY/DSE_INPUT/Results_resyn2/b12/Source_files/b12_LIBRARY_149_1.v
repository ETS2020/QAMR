...
module FAU ( 
  ...
  aoi21  g26(.a(new_n50_), .b(new_n38_), .c(new_n44_), .O(z2));
  ...
  nand3  g32(.a(new_n56_), .b(new_n47_), .c(x13), .O(z5));
  inv1   g33(.a(x10), .O(new_n58_));
  nand2  g34(.a(x14), .b(x01), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(x02), .c(new_n41_), .O(new_n61_));
