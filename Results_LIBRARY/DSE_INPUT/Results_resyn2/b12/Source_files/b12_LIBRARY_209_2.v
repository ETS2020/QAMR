...
module FAU ( 
  ...
  nand3  g09(.a(new_n26_), .b(x06), .c(x05), .O(new_n34_));
  ...
  nand2  g32(.a(x09), .b(new_n35_), .O(new_n57_));
  nand2  g33(.a(new_n44_), .b(x03), .O(new_n58_));
  ...
  nand2  g36(.a(new_n51_), .b(new_n45_), .O(new_n61_));
  ...
  nand3  g42(.a(new_n44_), .b(x03), .c(new_n29_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n45_), .O(z7));
  nand4  g45(.a(new_n55_), .b(x09), .c(x03), .d(new_n29_), .O(new_n70_));
  oai21  g46(.a(x09), .b(new_n40_), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n45_), .c(new_n28_), .O(z8));
endmodule
