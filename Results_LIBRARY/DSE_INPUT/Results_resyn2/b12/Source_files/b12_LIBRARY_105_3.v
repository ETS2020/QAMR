...
module FAU ( 
  ...
  nand4  g32(.a(x13), .b(new_n56_), .c(new_n42_), .d(new_n41_), .O(z5));
  ...
  nand3  g43(.a(new_n58_), .b(x09), .c(x03), .O(new_n68_));
  oai21  g44(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z7));
  nand2  g46(.a(new_n45_), .b(x00), .O(new_n71_));
  nand4  g47(.a(new_n58_), .b(new_n56_), .c(x09), .d(x03), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n67_), .O(z8));
endmodule
