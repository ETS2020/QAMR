...
module FAU ( 
  ...
  nand2  g27(.a(new_n51_), .b(new_n41_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n40_), .c(new_n50_), .O(z3));
  nand2  g29(.a(x08), .b(x00), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  nor2   g31(.a(new_n44_), .b(x07), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n55_), .c(new_n50_), .O(z4));
  nand4  g33(.a(new_n45_), .b(x13), .c(new_n51_), .d(new_n40_), .O(z5));
  xnor2a g34(.a(x09), .b(x03), .O(new_n59_));
  nor2   g35(.a(x02), .b(x01), .O(new_n60_));
  nand4  g36(.a(x14), .b(x02), .c(x01), .d(new_n40_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n54_), .c(new_n45_), .O(new_n62_));
  aoi21  g38(.a(new_n60_), .b(new_n59_), .c(new_n62_), .O(z6));
  nand3  g39(.a(new_n60_), .b(x09), .c(x03), .O(new_n64_));
  nand2  g40(.a(new_n60_), .b(x03), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n42_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n45_), .O(z7));
  oai22  g43(.a(new_n64_), .b(x12), .c(x09), .d(new_n40_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n45_), .O(z8));
endmodule
