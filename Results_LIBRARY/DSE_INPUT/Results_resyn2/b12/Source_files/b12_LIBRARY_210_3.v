...
module FAU ( 
  ...
  nand2  g16(.a(x07), .b(new_n27_), .O(new_n41_));
  ...
  oai21  g24(.a(new_n48_), .b(new_n44_), .c(new_n26_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n27_), .c(new_n42_), .O(z2));
  aoi22  g26(.a(x12), .b(new_n39_), .c(x11), .d(x07), .O(z3));
  inv1   g27(.a(x09), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(x07), .O(new_n53_));
  nor2   g29(.a(new_n40_), .b(new_n39_), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n53_), .c(x11), .d(x07), .O(z4));
  inv1   g31(.a(x12), .O(new_n56_));
  nand4  g32(.a(new_n43_), .b(x13), .c(new_n56_), .d(new_n39_), .O(z5));
  nand2  g33(.a(x09), .b(new_n30_), .O(new_n58_));
  nand2  g34(.a(new_n52_), .b(x03), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n26_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n45_), .c(x02), .O(new_n61_));
  inv1   g37(.a(new_n54_), .O(new_n62_));
  nand3  g38(.a(new_n28_), .b(x14), .c(new_n39_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n46_), .O(new_n64_));
  nor2   g40(.a(new_n64_), .b(new_n61_), .O(z6));
  nor2   g41(.a(x02), .b(x01), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x03), .c(new_n40_), .O(new_n67_));
  nand3  g43(.a(new_n66_), .b(new_n52_), .c(x03), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n67_), .c(new_n43_), .O(z7));
  nand3  g46(.a(new_n66_), .b(new_n56_), .c(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x09), .O(new_n72_));
  nand2  g48(.a(new_n52_), .b(new_n39_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n43_), .O(z8));
endmodule
