...
module FAU ( 
  ...
  oai21  g29(.a(new_n53_), .b(x00), .c(new_n42_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n52_), .O(z3));
  nand2  g31(.a(x08), .b(x00), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n45_), .c(new_n42_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n52_), .O(z4));
  nor2   g34(.a(x10), .b(x07), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n53_), .d(new_n41_), .O(z5));
  nor2   g36(.a(x02), .b(x01), .O(new_n61_));
  nand2  g37(.a(new_n45_), .b(x03), .O(new_n62_));
  nand2  g38(.a(x09), .b(new_n35_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  nand4  g40(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n65_));
  nand3  g41(.a(new_n56_), .b(new_n46_), .c(new_n42_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(z6));
  nand3  g45(.a(new_n61_), .b(x09), .c(x03), .O(new_n70_));
  oai21  g46(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n59_), .O(z7));
  nand2  g48(.a(new_n45_), .b(x00), .O(new_n73_));
  nand4  g49(.a(new_n61_), .b(new_n53_), .c(x09), .d(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n59_), .O(z8));
endmodule
