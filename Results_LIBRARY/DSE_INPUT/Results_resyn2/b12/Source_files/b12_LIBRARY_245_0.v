...
module FAU ( 
  ...
  aoi22  g11(.a(x05), .b(x01), .c(new_n25_), .d(new_n30_), .O(new_n36_));
  ...
  nor2   g26(.a(new_n42_), .b(new_n40_), .O(new_n51_));
  ...
  inv1   g31(.a(new_n51_), .O(new_n56_));
  ...
  nand3  g35(.a(new_n28_), .b(x14), .c(new_n40_), .O(new_n60_));
  nand4  g36(.a(new_n60_), .b(new_n59_), .c(new_n56_), .d(new_n45_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z6));
  nand3  g38(.a(new_n31_), .b(x09), .c(x03), .O(new_n63_));
  nand2  g39(.a(new_n31_), .b(x03), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n42_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n45_), .O(z7));
  oai22  g42(.a(new_n63_), .b(x12), .c(x09), .d(new_n40_), .O(new_n67_));
