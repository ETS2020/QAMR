...
module FAU ( 
  ...
  aoi21  g09(.a(new_n31_), .b(new_n29_), .c(x00), .O(z1));
  ...
  aoi21  g18(.a(new_n42_), .b(new_n27_), .c(new_n37_), .O(z2));
  aoi22  g19(.a(x12), .b(new_n30_), .c(x11), .d(x07), .O(z3));
  ...
  nand4  g26(.a(new_n50_), .b(x13), .c(new_n49_), .d(new_n30_), .O(z5));
  xor2a  g27(.a(x09), .b(x03), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n28_), .O(new_n53_));
  nand4  g29(.a(x14), .b(x02), .c(x01), .d(new_n30_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n45_), .c(new_n50_), .O(new_n55_));
  nor2   g31(.a(new_n55_), .b(new_n53_), .O(z6));
  nor2   g32(.a(x02), .b(x01), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(x09), .c(x03), .O(new_n58_));
  nand2  g34(.a(new_n57_), .b(x03), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n36_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n58_), .c(new_n50_), .O(z7));
  nand2  g37(.a(new_n38_), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n57_), .b(new_n49_), .c(x09), .d(x03), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n50_), .O(z8));
endmodule
