// Benchmark "FAU" written by ABC on Mon Jul 27 21:37:03 2020
...
module FAU ( 
  ...
  nand2  g31(.a(x12), .b(new_n41_), .O(new_n56_));
  nor2   g32(.a(x10), .b(x07), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(x13), .O(new_n58_));
  inv1   g34(.a(new_n58_), .O(new_n59_));
  nand2  g35(.a(new_n45_), .b(x00), .O(new_n60_));
  nand2  g36(.a(x02), .b(x00), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n56_), .O(z5));
  nor2   g38(.a(x02), .b(x01), .O(new_n63_));
  nand2  g39(.a(new_n45_), .b(x03), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n35_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n63_), .O(new_n66_));
  nand4  g42(.a(x14), .b(x02), .c(x01), .d(new_n41_), .O(new_n67_));
  nand3  g43(.a(new_n52_), .b(new_n46_), .c(new_n42_), .O(new_n68_));
  ...
  oai21  g48(.a(new_n31_), .b(new_n35_), .c(new_n43_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z7));
  inv1   g50(.a(x12), .O(new_n75_));
  nand4  g51(.a(new_n63_), .b(new_n75_), .c(x09), .d(x03), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n60_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n57_), .O(z8));
endmodule
