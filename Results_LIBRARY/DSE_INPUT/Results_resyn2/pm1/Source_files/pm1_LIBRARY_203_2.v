...
module FAU ( 
  ...
  nand2  g22(.a(new_n45_), .b(x00), .O(new_n52_));
  xor2a  g23(.a(x12), .b(x11), .O(new_n53_));
  aoi21  g24(.a(new_n53_), .b(new_n50_), .c(new_n52_), .O(z09));
  inv1   g25(.a(x09), .O(new_n55_));
  nand2  g26(.a(new_n41_), .b(x12), .O(new_n56_));
  nor3   g27(.a(new_n56_), .b(new_n46_), .c(new_n55_), .O(z10));
  nand2  g28(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  nand4  g29(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n59_));
  aoi21  g30(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z11));
  nand3  g31(.a(x12), .b(x11), .c(new_n55_), .O(new_n61_));
