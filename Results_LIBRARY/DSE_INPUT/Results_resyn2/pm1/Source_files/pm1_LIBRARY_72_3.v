// Benchmark "FAU" written by ABC on Mon Jul 27 18:08:20 2020
...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    ...
    new_n53_, new_n54_, new_n55_, new_n57_, new_n59_;
  ...
  nand4  g27(.a(new_n43_), .b(new_n38_), .c(new_n49_), .d(x00), .O(new_n57_));
  inv1   g28(.a(new_n57_), .O(z10));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  nor2   g30(.a(new_n50_), .b(new_n59_), .O(z11));
