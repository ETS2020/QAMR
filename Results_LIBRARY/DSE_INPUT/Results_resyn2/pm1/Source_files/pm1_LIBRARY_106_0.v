...
module FAU ( 
  ...
  nand3  g24(.a(new_n32_), .b(x11), .c(x09), .O(new_n54_));
  nand3  g25(.a(new_n54_), .b(new_n53_), .c(z01), .O(new_n55_));
  inv1   g26(.a(new_n55_), .O(z09));
  nand2  g27(.a(new_n44_), .b(x12), .O(new_n57_));
  nand3  g28(.a(new_n53_), .b(x11), .c(x09), .O(new_n58_));
  nor2   g29(.a(new_n58_), .b(new_n57_), .O(z10));
  aoi21  g30(.a(new_n44_), .b(x12), .c(new_n30_), .O(new_n60_));
  nand2  g31(.a(new_n43_), .b(x12), .O(new_n61_));
  nand3  g32(.a(new_n61_), .b(new_n53_), .c(x11), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n60_), .O(z11));
  inv1   g34(.a(x09), .O(new_n64_));
  nand2  g35(.a(new_n50_), .b(new_n64_), .O(new_n65_));
