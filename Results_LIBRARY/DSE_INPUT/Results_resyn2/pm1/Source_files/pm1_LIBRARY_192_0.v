...
module FAU ( 
  ...
  nand2  g18(.a(new_n44_), .b(new_n38_), .O(new_n48_));
  ...
  aoi21  g32(.a(new_n60_), .b(x03), .c(new_n61_), .O(z10));
  nand2  g33(.a(new_n51_), .b(x11), .O(new_n63_));
  inv1   g34(.a(new_n45_), .O(new_n64_));
  nand2  g35(.a(new_n60_), .b(x03), .O(new_n65_));
