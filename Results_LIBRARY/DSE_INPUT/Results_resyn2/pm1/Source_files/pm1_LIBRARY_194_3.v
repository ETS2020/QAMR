...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n43_, new_n44_, new_n45_, new_n48_, new_n50_, new_n53_;
  ...
  nand3  g20(.a(new_n31_), .b(new_n48_), .c(x00), .O(new_n50_));
  inv1   g21(.a(new_n50_), .O(z09));
  nand4  g22(.a(x11), .b(new_n48_), .c(new_n30_), .d(x00), .O(new_n53_));
  inv1   g23(.a(new_n53_), .O(z11));
  zero   g24(.O(z10));
  zero   g25(.O(z12));
endmodule
