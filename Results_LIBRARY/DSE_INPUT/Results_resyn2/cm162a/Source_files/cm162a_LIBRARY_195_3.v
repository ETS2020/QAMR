// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:39 2020
...
module FAU ( 
  ...
  nand2  g20(.a(new_n24_), .b(x11), .O(new_n40_));
  inv1   g21(.a(x11), .O(new_n41_));
  nor2   g22(.a(x10), .b(x08), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n23_), .c(new_n41_), .O(new_n43_));
  aoi21  g24(.a(new_n40_), .b(new_n34_), .c(new_n43_), .O(new_n44_));
  ...
  nand3  g28(.a(new_n40_), .b(new_n34_), .c(x03), .O(new_n48_));
