...
module FAU ( 
  ...
  oai21  g22(.a(new_n41_), .b(new_n25_), .c(x03), .O(new_n42_));
  inv1   g23(.a(x06), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n20_), .c(new_n28_), .O(new_n44_));
  oai21  g25(.a(new_n42_), .b(new_n40_), .c(new_n44_), .O(z2));
  nand2  g26(.a(new_n23_), .b(new_n31_), .O(new_n46_));
  nor2   g27(.a(x11), .b(x10), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(x08), .c(new_n24_), .O(new_n48_));
  aoi22  g29(.a(new_n48_), .b(new_n23_), .c(new_n46_), .d(x12), .O(new_n49_));
  inv1   g30(.a(x07), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n28_), .O(new_n51_));
  oai21  g32(.a(new_n49_), .b(new_n20_), .c(new_n51_), .O(z3));
