// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:16 2020
...
module FAU ( 
  ...
  oai21  g14(.a(new_n33_), .b(new_n31_), .c(new_n23_), .O(new_n34_));
  ...
  nand3  g20(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n24_), .c(new_n21_), .O(new_n41_));
  aoi21  g22(.a(new_n31_), .b(new_n23_), .c(new_n39_), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n41_), .c(x03), .O(new_n43_));
  inv1   g24(.a(x06), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n20_), .c(new_n28_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z2));
  nand2  g27(.a(new_n40_), .b(new_n24_), .O(new_n47_));
