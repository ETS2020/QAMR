...
module FAU ( 
  ...
  nor2   g22(.a(x12), .b(new_n31_), .O(new_n42_));
  ...
  nand3  g30(.a(new_n23_), .b(new_n40_), .c(new_n32_), .O(new_n50_));
  oai21  g31(.a(x12), .b(x11), .c(new_n24_), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(new_n34_), .c(new_n50_), .d(x12), .O(new_n52_));
