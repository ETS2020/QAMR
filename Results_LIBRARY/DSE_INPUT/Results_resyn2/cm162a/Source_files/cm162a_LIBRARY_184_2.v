...
module FAU ( 
  ...
  nand3  g22(.a(x11), .b(new_n32_), .c(new_n31_), .O(new_n42_));
  ...
  inv1   g27(.a(new_n22_), .O(new_n47_));
  nand2  g28(.a(x07), .b(new_n20_), .O(new_n48_));
  inv1   g29(.a(x11), .O(new_n49_));
  nand4  g30(.a(new_n24_), .b(new_n49_), .c(new_n32_), .d(x03), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n47_), .c(new_n48_), .O(new_n51_));
