// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:17 2020
...
module FAU ( 
  ...
  nand2  g12(.a(new_n22_), .b(x03), .O(new_n32_));
  ...
  nand2  g24(.a(new_n37_), .b(new_n20_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n24_), .c(x12), .O(new_n45_));
  nand2  g26(.a(new_n20_), .b(x12), .O(new_n46_));
  nand4  g27(.a(new_n36_), .b(new_n23_), .c(x04), .d(x02), .O(new_n47_));
  oai21  g28(.a(new_n47_), .b(new_n46_), .c(x03), .O(new_n48_));
  inv1   g29(.a(x07), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n28_), .c(new_n29_), .O(new_n50_));
  oai21  g31(.a(new_n48_), .b(new_n45_), .c(new_n50_), .O(z3));
