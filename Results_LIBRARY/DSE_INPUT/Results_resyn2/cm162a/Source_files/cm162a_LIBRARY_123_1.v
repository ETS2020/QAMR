...
module FAU ( 
  ...
  aoi21  g12(.a(new_n31_), .b(new_n24_), .c(new_n21_), .O(new_n32_));
  aoi21  g13(.a(new_n23_), .b(new_n29_), .c(new_n30_), .O(new_n33_));
  oai21  g14(.a(new_n33_), .b(new_n32_), .c(x03), .O(new_n34_));
  ...
  nand3  g20(.a(new_n39_), .b(new_n30_), .c(new_n29_), .O(new_n40_));
  aoi21  g21(.a(new_n40_), .b(new_n24_), .c(new_n21_), .O(new_n41_));
  nor2   g22(.a(x10), .b(x08), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n23_), .c(new_n39_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n41_), .c(x03), .O(new_n44_));
  inv1   g25(.a(x06), .O(new_n45_));
  aoi21  g26(.a(new_n45_), .b(new_n20_), .c(new_n36_), .O(new_n46_));
  ...
  aoi21  g33(.a(new_n52_), .b(new_n20_), .c(new_n36_), .O(new_n53_));
