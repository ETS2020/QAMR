...
module FAU ( 
  ...
  aoi21  g13(.a(new_n32_), .b(new_n24_), .c(new_n21_), .O(new_n33_));
  inv1   g14(.a(x10), .O(new_n34_));
  nor2   g15(.a(new_n22_), .b(new_n34_), .O(new_n35_));
  ...
  aoi21  g31(.a(new_n50_), .b(new_n23_), .c(new_n49_), .O(new_n51_));
  oai21  g32(.a(new_n51_), .b(new_n20_), .c(new_n48_), .O(new_n52_));
  aoi21  g33(.a(new_n24_), .b(x12), .c(new_n20_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n42_), .c(new_n28_), .O(new_n54_));
