// Benchmark "FAU" written by ABC on Mon Jul 27 20:49:41 2020
...
module FAU ( 
  ...
  nor2   g20(.a(new_n34_), .b(x11), .O(new_n40_));
  nand3  g21(.a(x11), .b(new_n32_), .c(new_n31_), .O(new_n41_));
  nor2   g22(.a(new_n41_), .b(new_n25_), .O(new_n42_));
  nor2   g23(.a(new_n28_), .b(new_n20_), .O(new_n43_));
  oai21  g24(.a(new_n42_), .b(new_n40_), .c(new_n43_), .O(z2));
  oai21  g25(.a(x10), .b(x08), .c(new_n24_), .O(new_n45_));
  oai21  g26(.a(x12), .b(x11), .c(new_n24_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(new_n45_), .c(new_n23_), .O(new_n47_));
  inv1   g28(.a(x11), .O(new_n48_));
  nand3  g29(.a(new_n48_), .b(x04), .c(x02), .O(new_n49_));
  oai21  g30(.a(new_n49_), .b(new_n33_), .c(x12), .O(new_n50_));
