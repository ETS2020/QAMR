// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:59 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n42_), .b(new_n23_), .c(x03), .O(new_n43_));
  nand3  g24(.a(new_n23_), .b(new_n32_), .c(new_n31_), .O(new_n44_));
  oai21  g25(.a(x06), .b(x03), .c(x05), .O(new_n45_));
  aoi21  g26(.a(new_n44_), .b(x11), .c(new_n45_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n43_), .O(z2));
  aoi21  g28(.a(new_n42_), .b(new_n23_), .c(x12), .O(new_n48_));
