// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:42 2020
...
module FAU ( 
  ...
  nand2  g20(.a(new_n34_), .b(x03), .O(new_n40_));
  inv1   g21(.a(x06), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n20_), .c(new_n28_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n40_), .O(z2));
  nand2  g24(.a(new_n33_), .b(new_n24_), .O(new_n44_));
  aoi21  g25(.a(new_n44_), .b(new_n23_), .c(x12), .O(new_n45_));
  nand3  g26(.a(x12), .b(new_n32_), .c(new_n31_), .O(new_n46_));
  oai21  g27(.a(new_n46_), .b(new_n25_), .c(x03), .O(new_n47_));
  inv1   g28(.a(x07), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n20_), .c(new_n28_), .O(new_n49_));
  oai21  g30(.a(new_n47_), .b(new_n45_), .c(new_n49_), .O(z3));
