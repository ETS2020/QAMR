...
module FAU ( 
  ...
  and2   g26(.a(x06), .b(x05), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n45_), .O(z2));
  nand2  g28(.a(new_n41_), .b(new_n24_), .O(new_n48_));
  aoi21  g29(.a(new_n48_), .b(new_n23_), .c(x12), .O(new_n49_));
  nand3  g30(.a(new_n24_), .b(new_n23_), .c(x12), .O(new_n50_));
