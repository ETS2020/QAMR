...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n140_, new_n141_,
    ...
    new_n199_, new_n200_, new_n201_, new_n230_, new_n231_, new_n232_,
  ...
  inv1   g054(.a(x11), .O(new_n230_));
  nand4  g055(.a(new_n135_), .b(new_n138_), .c(new_n230_), .d(new_n187_), .O(new_n231_));
  nor2   g056(.a(new_n231_), .b(new_n179_), .O(new_n232_));
  nor2   g057(.a(x46), .b(x43), .O(new_n233_));
  nor2   g058(.a(x37), .b(x30), .O(new_n234_));
  nand3  g059(.a(new_n234_), .b(new_n233_), .c(new_n175_), .O(new_n235_));
  inv1   g060(.a(new_n235_), .O(new_n236_));
  inv1   g061(.a(x50), .O(new_n237_));
  inv1   g062(.a(x56), .O(new_n238_));
  nand4  g063(.a(new_n172_), .b(new_n157_), .c(new_n238_), .d(new_n237_), .O(new_n239_));
  nor2   g064(.a(new_n239_), .b(x47), .O(new_n240_));
  nand3  g065(.a(new_n240_), .b(new_n236_), .c(new_n232_), .O(new_n241_));
  inv1   g066(.a(new_n241_), .O(z61));
  inv1   g067(.a(x47), .O(new_n243_));
  nor2   g068(.a(new_n239_), .b(new_n243_), .O(new_n244_));
  nand3  g069(.a(new_n244_), .b(new_n236_), .c(new_n232_), .O(new_n245_));
  inv1   g070(.a(new_n245_), .O(z62));
  nand3  g071(.a(new_n195_), .b(new_n172_), .c(x56), .O(new_n247_));
  inv1   g072(.a(new_n247_), .O(new_n248_));
  nand3  g073(.a(new_n248_), .b(new_n236_), .c(new_n232_), .O(new_n249_));
  inv1   g074(.a(new_n249_), .O(z63));
  inv1   g075(.a(new_n231_), .O(new_n251_));
  nand2  g076(.a(new_n251_), .b(new_n180_), .O(new_n252_));
  nor3   g077(.a(x60), .b(x58), .c(x50), .O(new_n253_));
  inv1   g078(.a(x30), .O(new_n254_));
  nor2   g079(.a(x37), .b(new_n254_), .O(new_n255_));
  nand4  g080(.a(new_n255_), .b(new_n253_), .c(new_n233_), .d(new_n175_), .O(new_n256_));
  nor2   g081(.a(new_n256_), .b(new_n252_), .O(z64));
  zero   g082(.O(z00));
  zero   g083(.O(z01));
  zero   g084(.O(z02));
  zero   g085(.O(z03));
