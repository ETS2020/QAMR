// Benchmark "FAU" written by ABC on Tue Jul 28 01:16:59 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n473_, new_n476_, new_n479_, new_n480_, new_n481_, new_n482_,
  ...
  nand3  g200(.a(new_n154_), .b(x41), .c(new_n152_), .O(new_n331_));
  nor2   g201(.a(new_n331_), .b(new_n144_), .O(new_n332_));
  ...
  nor3   g267(.a(new_n397_), .b(new_n343_), .c(new_n342_), .O(new_n398_));
  nand2  g268(.a(new_n398_), .b(x51), .O(new_n399_));
  nor2   g269(.a(new_n399_), .b(new_n396_), .O(z20));
  nand3  g270(.a(new_n398_), .b(new_n286_), .c(new_n143_), .O(new_n401_));
  ...
  nand2  g301(.a(new_n351_), .b(new_n253_), .O(new_n432_));
  inv1   g302(.a(new_n432_), .O(new_n433_));
  nand2  g303(.a(new_n433_), .b(new_n431_), .O(new_n434_));
  nand2  g304(.a(new_n362_), .b(x11), .O(new_n435_));
  nor3   g305(.a(new_n435_), .b(new_n434_), .c(new_n336_), .O(z24));
  nand4  g306(.a(new_n433_), .b(new_n431_), .c(new_n320_), .d(new_n265_), .O(new_n437_));
  nand2  g307(.a(new_n327_), .b(x24), .O(new_n438_));
  nor2   g308(.a(new_n438_), .b(new_n437_), .O(z25));
  inv1   g309(.a(new_n213_), .O(new_n440_));
  nand2  g310(.a(new_n440_), .b(new_n405_), .O(new_n441_));
  nand4  g311(.a(new_n277_), .b(new_n241_), .c(new_n240_), .d(new_n154_), .O(new_n442_));
  nor2   g312(.a(new_n442_), .b(new_n274_), .O(new_n443_));
  nand3  g313(.a(new_n262_), .b(new_n378_), .c(x32), .O(new_n444_));
  nor3   g314(.a(new_n444_), .b(x21), .c(x20), .O(new_n445_));
  nand4  g315(.a(new_n445_), .b(new_n443_), .c(new_n376_), .d(new_n266_), .O(new_n446_));
  nor3   g316(.a(new_n446_), .b(new_n270_), .c(new_n441_), .O(z26));
  nand2  g317(.a(new_n238_), .b(new_n227_), .O(new_n448_));
  nand3  g318(.a(new_n212_), .b(new_n211_), .c(new_n210_), .O(new_n449_));
  nand3  g319(.a(new_n217_), .b(new_n216_), .c(x13), .O(new_n450_));
  nor4   g320(.a(new_n450_), .b(new_n420_), .c(new_n411_), .d(new_n449_), .O(new_n451_));
  nand3  g321(.a(new_n451_), .b(new_n410_), .c(new_n405_), .O(new_n452_));
  nor2   g322(.a(new_n452_), .b(new_n448_), .O(z27));
  nor2   g323(.a(new_n437_), .b(new_n327_), .O(z28));
  nand4  g324(.a(new_n320_), .b(new_n286_), .c(new_n154_), .d(new_n244_), .O(new_n455_));
  nand3  g325(.a(new_n429_), .b(x60), .c(new_n253_), .O(new_n456_));
  nor2   g326(.a(new_n456_), .b(new_n455_), .O(z29));
  nand4  g327(.a(new_n236_), .b(new_n230_), .c(new_n167_), .d(new_n164_), .O(new_n458_));
  inv1   g328(.a(new_n442_), .O(new_n459_));
  nand2  g329(.a(new_n218_), .b(new_n217_), .O(new_n460_));
  nor3   g330(.a(new_n460_), .b(new_n146_), .c(new_n144_), .O(new_n461_));
  nand2  g331(.a(new_n273_), .b(new_n272_), .O(new_n462_));
  nand3  g332(.a(new_n254_), .b(new_n161_), .c(x52), .O(new_n463_));
  nor3   g333(.a(new_n463_), .b(new_n462_), .c(new_n133_), .O(new_n464_));
  nand3  g334(.a(new_n464_), .b(new_n461_), .c(new_n459_), .O(new_n465_));
  nor3   g335(.a(new_n465_), .b(new_n458_), .c(new_n407_), .O(z30));
  nor2   g336(.a(x26), .b(x24), .O(new_n467_));
  nand2  g337(.a(new_n467_), .b(new_n354_), .O(new_n468_));
  nor2   g338(.a(new_n468_), .b(new_n251_), .O(new_n469_));
  nand3  g339(.a(new_n132_), .b(new_n218_), .c(x21), .O(new_n470_));
  nor2   g340(.a(new_n470_), .b(new_n261_), .O(new_n471_));
  nand4  g341(.a(new_n471_), .b(new_n469_), .c(new_n236_), .d(new_n167_), .O(new_n472_));
  nand2  g342(.a(new_n387_), .b(new_n373_), .O(new_n473_));
  nor3   g343(.a(new_n473_), .b(new_n472_), .c(new_n407_), .O(z31));
  nor3   g344(.a(new_n455_), .b(new_n430_), .c(new_n253_), .O(z32));
  nand4  g345(.a(new_n429_), .b(new_n320_), .c(new_n286_), .d(new_n244_), .O(new_n476_));
  nor3   g346(.a(new_n476_), .b(x40), .c(new_n294_), .O(z33));
  nor3   g347(.a(new_n287_), .b(new_n339_), .c(new_n167_), .O(z34));
  inv1   g348(.a(new_n147_), .O(new_n479_));
  nand2  g349(.a(new_n369_), .b(new_n199_), .O(new_n480_));
  nor3   g350(.a(new_n480_), .b(new_n321_), .c(x03), .O(new_n481_));
  nor3   g351(.a(new_n385_), .b(new_n342_), .c(x61), .O(new_n482_));
  inv1   g352(.a(new_n397_), .O(new_n483_));
  nor2   g353(.a(x37), .b(x35), .O(new_n484_));
  nand2  g354(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand3  g355(.a(new_n273_), .b(x04), .c(new_n202_), .O(new_n486_));
  nor2   g356(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  nand3  g357(.a(new_n487_), .b(new_n482_), .c(new_n481_), .O(new_n488_));
  nor2   g358(.a(new_n488_), .b(new_n479_), .O(z35));
  nor2   g359(.a(new_n485_), .b(new_n462_), .O(new_n490_));
  nor3   g360(.a(new_n316_), .b(new_n172_), .c(x55), .O(new_n491_));
  nand4  g361(.a(new_n491_), .b(new_n490_), .c(new_n395_), .d(new_n392_), .O(new_n492_));
  inv1   g362(.a(new_n492_), .O(z36));
  nand3  g363(.a(new_n131_), .b(new_n216_), .c(x19), .O(new_n494_));
  nand2  g364(.a(new_n292_), .b(new_n248_), .O(new_n495_));
  nor2   g365(.a(new_n495_), .b(new_n494_), .O(new_n496_));
  nand3  g366(.a(new_n496_), .b(new_n291_), .c(new_n243_), .O(new_n497_));
  inv1   g367(.a(new_n497_), .O(new_n498_));
  nand4  g368(.a(new_n498_), .b(new_n461_), .c(new_n238_), .d(new_n214_), .O(new_n499_));
  inv1   g369(.a(new_n499_), .O(z37));
  nor2   g370(.a(new_n480_), .b(new_n151_), .O(new_n501_));
  nand2  g371(.a(new_n484_), .b(new_n352_), .O(new_n502_));
  nor2   g372(.a(new_n502_), .b(new_n468_), .O(new_n503_));
  nand2  g373(.a(new_n154_), .b(new_n153_), .O(new_n504_));
  nor2   g374(.a(new_n504_), .b(new_n140_), .O(new_n505_));
  nand4  g375(.a(new_n505_), .b(new_n503_), .c(new_n501_), .d(new_n322_), .O(new_n506_));
  inv1   g376(.a(new_n462_), .O(new_n507_));
  ...
  nand4  g382(.a(new_n482_), .b(new_n273_), .c(new_n244_), .d(x42), .O(new_n513_));
  ...
  nand4  g390(.a(new_n520_), .b(new_n517_), .c(new_n501_), .d(new_n147_), .O(new_n521_));
  ...
  nand3  g394(.a(new_n517_), .b(new_n501_), .c(new_n147_), .O(new_n525_));
  ...
  nor3   g414(.a(new_n544_), .b(new_n541_), .c(new_n479_), .O(z44));
  nor2   g415(.a(new_n462_), .b(new_n188_), .O(new_n546_));
  nor2   g416(.a(x39), .b(new_n378_), .O(new_n547_));
  nand4  g417(.a(new_n547_), .b(new_n546_), .c(new_n484_), .d(new_n408_), .O(new_n548_));
  ...
  nand3  g422(.a(new_n552_), .b(new_n503_), .c(new_n501_), .O(new_n553_));
  ...
  nand3  g427(.a(new_n546_), .b(new_n501_), .c(new_n322_), .O(new_n558_));
  ...
  nand4  g443(.a(new_n573_), .b(new_n469_), .c(new_n291_), .d(new_n371_), .O(new_n574_));
  nor2   g444(.a(new_n574_), .b(new_n458_), .O(z52));
  ...
  nand4  g448(.a(new_n578_), .b(new_n490_), .c(new_n395_), .d(new_n392_), .O(new_n579_));
  inv1   g449(.a(new_n579_), .O(z54));
  inv1   g450(.a(new_n316_), .O(new_n581_));
  nor2   g451(.a(x37), .b(new_n379_), .O(new_n582_));
  nand4  g452(.a(new_n582_), .b(new_n483_), .c(new_n581_), .d(new_n507_), .O(new_n583_));
  ...
  nand3  g457(.a(new_n587_), .b(new_n461_), .c(new_n443_), .O(new_n588_));
  nor3   g458(.a(new_n588_), .b(new_n419_), .c(new_n270_), .O(z56));
  nand4  g459(.a(new_n481_), .b(new_n319_), .c(new_n218_), .d(x18), .O(new_n590_));
  nor2   g460(.a(new_n590_), .b(new_n318_), .O(z57));
  nand4  g461(.a(new_n481_), .b(new_n467_), .c(new_n327_), .d(x22), .O(new_n592_));
  nor2   g462(.a(new_n592_), .b(new_n401_), .O(z58));
  inv1   g463(.a(x40), .O(new_n594_));
  nor2   g464(.a(new_n476_), .b(new_n594_), .O(z59));
  ...
  nand2  g472(.a(new_n362_), .b(new_n322_), .O(new_n603_));
  nor2   g473(.a(new_n603_), .b(new_n359_), .O(new_n604_));
  inv1   g474(.a(x47), .O(new_n605_));
  nor2   g475(.a(x50), .b(new_n605_), .O(new_n606_));
  nand3  g476(.a(new_n606_), .b(new_n604_), .c(new_n315_), .O(new_n607_));
  inv1   g477(.a(new_n607_), .O(z62));
  nand3  g478(.a(new_n604_), .b(new_n431_), .c(x56), .O(new_n609_));
  inv1   g479(.a(new_n609_), .O(z63));
  nor3   g480(.a(new_n603_), .b(new_n434_), .c(new_n143_), .O(z64));
