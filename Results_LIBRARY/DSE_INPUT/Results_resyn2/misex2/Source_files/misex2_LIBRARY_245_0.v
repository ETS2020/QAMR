...
module FAU ( 
  ...
  nand3  g43(.a(new_n86_), .b(new_n52_), .c(x01), .O(new_n87_));
  ...
  nand4  g56(.a(new_n95_), .b(x20), .c(x15), .d(new_n99_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  inv1   g58(.a(x16), .O(new_n102_));
  nor2   g59(.a(x22), .b(new_n102_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n101_), .c(new_n91_), .O(new_n104_));
  inv1   g61(.a(new_n87_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(x22), .c(x21), .d(x18), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n104_), .c(x00), .O(z10));
  nand2  g64(.a(new_n96_), .b(new_n45_), .O(new_n108_));
  nand3  g65(.a(new_n101_), .b(new_n91_), .c(new_n102_), .O(new_n109_));
  nand3  g66(.a(new_n105_), .b(x21), .c(x18), .O(new_n110_));
