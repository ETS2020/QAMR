...
module FAU ( 
  ...
  nand3  g55(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  inv1   g57(.a(x22), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n45_), .O(new_n102_));
  aoi21  g59(.a(new_n99_), .b(new_n88_), .c(new_n102_), .O(z09));
  nand4  g60(.a(new_n87_), .b(new_n64_), .c(x22), .d(x21), .O(new_n104_));
  ...
  nand3  g65(.a(new_n108_), .b(new_n106_), .c(new_n92_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n104_), .c(x00), .O(z10));
  nand2  g67(.a(new_n101_), .b(new_n45_), .O(new_n111_));
  nand3  g68(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n112_));
  nand4  g69(.a(new_n100_), .b(x20), .c(new_n96_), .d(x15), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n94_), .c(new_n92_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n112_), .c(new_n111_), .O(z11));
  nand2  g73(.a(new_n71_), .b(new_n72_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n52_), .b(x17), .c(new_n93_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n83_), .O(new_n121_));
  inv1   g78(.a(x24), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(x09), .O(new_n123_));
  aoi21  g80(.a(new_n121_), .b(new_n117_), .c(new_n123_), .O(z12));
  nor2   g81(.a(new_n119_), .b(new_n47_), .O(z13));
  nor2   g82(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g83(.a(new_n57_), .b(x01), .c(new_n93_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n93_), .c(new_n46_), .O(new_n128_));
