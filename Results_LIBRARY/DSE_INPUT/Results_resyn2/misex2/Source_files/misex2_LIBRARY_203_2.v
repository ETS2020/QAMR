...
module FAU ( 
  ...
  nand4  g45(.a(x12), .b(new_n67_), .c(x02), .d(new_n46_), .O(new_n89_));
  ...
  nand3  g50(.a(new_n93_), .b(new_n92_), .c(new_n90_), .O(new_n94_));
  inv1   g51(.a(x21), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(new_n97_));
  aoi21  g54(.a(new_n94_), .b(new_n88_), .c(new_n97_), .O(z09));
  nand4  g55(.a(new_n87_), .b(new_n64_), .c(x22), .d(x21), .O(new_n99_));
  ...
  nand3  g62(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n106_));
  inv1   g63(.a(x16), .O(new_n107_));
  nand3  g64(.a(new_n95_), .b(x20), .c(new_n107_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n101_), .c(new_n90_), .O(new_n110_));
