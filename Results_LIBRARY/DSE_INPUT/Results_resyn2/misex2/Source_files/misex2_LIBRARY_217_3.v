...
module FAU ( 
  ...
  nand3  g42(.a(new_n52_), .b(x18), .c(x01), .O(new_n86_));
  inv1   g43(.a(x13), .O(new_n87_));
  nand4  g44(.a(new_n87_), .b(x12), .c(new_n66_), .d(x02), .O(new_n88_));
  ...
  nand3  g49(.a(new_n92_), .b(new_n91_), .c(new_n89_), .O(new_n93_));
  inv1   g50(.a(x21), .O(new_n94_));
  inv1   g51(.a(x22), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(new_n96_));
  ...
  nand4  g58(.a(new_n95_), .b(new_n94_), .c(x20), .d(x16), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n101_), .c(new_n89_), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n99_), .c(x00), .O(z10));
  nand2  g62(.a(new_n98_), .b(x21), .O(new_n106_));
  inv1   g63(.a(x16), .O(new_n107_));
  nand3  g64(.a(new_n94_), .b(x20), .c(new_n107_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n101_), .c(new_n89_), .O(new_n110_));
  nand2  g67(.a(new_n95_), .b(new_n45_), .O(new_n111_));
  ...
  nand2  g74(.a(new_n117_), .b(new_n82_), .O(new_n118_));
