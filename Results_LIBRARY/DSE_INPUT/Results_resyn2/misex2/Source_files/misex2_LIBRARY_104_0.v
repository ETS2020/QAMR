...
module FAU ( 
  ...
  nand3  g42(.a(new_n50_), .b(x18), .c(new_n70_), .O(new_n86_));
  ...
  nor2   g47(.a(new_n90_), .b(new_n86_), .O(z09));
  nand3  g48(.a(x21), .b(new_n87_), .c(x01), .O(new_n92_));
  nor3   g49(.a(new_n92_), .b(new_n86_), .c(new_n89_), .O(z10));
  nor3   g50(.a(new_n92_), .b(new_n86_), .c(x22), .O(z11));
  nand2  g51(.a(new_n69_), .b(new_n72_), .O(new_n95_));
  ...
  nor3   g59(.a(new_n97_), .b(x01), .c(x00), .O(z13));
  nor2   g60(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g61(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n105_));
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n106_));
  oai21  g63(.a(new_n105_), .b(new_n70_), .c(new_n106_), .O(z15));
  nor2   g64(.a(new_n71_), .b(x00), .O(z16));
