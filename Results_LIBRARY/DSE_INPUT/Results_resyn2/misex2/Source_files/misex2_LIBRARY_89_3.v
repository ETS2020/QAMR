...
module FAU ( 
  ...
  nand3  g38(.a(x02), .b(new_n70_), .c(new_n69_), .O(new_n82_));
  nand3  g39(.a(x19), .b(new_n48_), .c(x17), .O(new_n83_));
  nor3   g40(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z08));
  nor2   g41(.a(x20), .b(new_n70_), .O(new_n85_));
  nand2  g42(.a(new_n85_), .b(new_n61_), .O(new_n86_));
  nand2  g43(.a(x02), .b(new_n70_), .O(new_n87_));
  inv1   g44(.a(x13), .O(new_n88_));
  nand3  g45(.a(new_n88_), .b(x12), .c(new_n64_), .O(new_n89_));
  ...
  nand4  g55(.a(new_n85_), .b(new_n61_), .c(x22), .d(x21), .O(new_n99_));
  ...
  nand2  g63(.a(new_n96_), .b(new_n69_), .O(new_n107_));
  nand3  g64(.a(new_n85_), .b(new_n61_), .c(x21), .O(new_n108_));
  ...
  nand4  g70(.a(new_n49_), .b(x17), .c(new_n113_), .d(new_n70_), .O(new_n114_));
  ...
  nor2   g76(.a(new_n114_), .b(x00), .O(z13));
