...
module FAU ( 
  ...
  nand3  g43(.a(new_n86_), .b(x20), .c(new_n85_), .O(new_n87_));
  inv1   g44(.a(x13), .O(new_n88_));
  inv1   g45(.a(x14), .O(new_n89_));
  nand4  g46(.a(new_n89_), .b(new_n88_), .c(new_n63_), .d(x02), .O(new_n90_));
  inv1   g47(.a(x15), .O(new_n91_));
  inv1   g48(.a(x22), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n68_), .O(new_n93_));
  nor3   g50(.a(new_n93_), .b(new_n90_), .c(new_n87_), .O(z09));
  ...
  inv1   g55(.a(new_n90_), .O(new_n99_));
  nor2   g56(.a(new_n91_), .b(new_n64_), .O(new_n100_));
  nand4  g57(.a(new_n92_), .b(new_n86_), .c(x20), .d(x16), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n98_), .c(x00), .O(z10));
  nand2  g61(.a(new_n92_), .b(new_n68_), .O(new_n105_));
  inv1   g62(.a(new_n87_), .O(new_n106_));
  nand3  g63(.a(new_n100_), .b(new_n99_), .c(new_n106_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n96_), .c(new_n105_), .O(z11));
  ...
  aoi21  g77(.a(new_n54_), .b(x01), .c(new_n111_), .O(new_n121_));
  nand3  g78(.a(x19), .b(new_n111_), .c(new_n69_), .O(new_n122_));
