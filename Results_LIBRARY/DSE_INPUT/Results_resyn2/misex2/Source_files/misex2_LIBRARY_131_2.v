...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n95_, new_n98_, new_n99_, new_n101_, new_n103_, new_n104_,
  ...
  nor2   g44(.a(new_n87_), .b(x16), .O(new_n88_));
  nor2   g45(.a(new_n44_), .b(x01), .O(new_n89_));
  nor2   g46(.a(new_n66_), .b(x11), .O(new_n90_));
  nand4  g47(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n86_), .O(new_n91_));
  nand3  g48(.a(new_n62_), .b(new_n87_), .c(x01), .O(new_n92_));
  inv1   g49(.a(x21), .O(new_n93_));
  inv1   g50(.a(x22), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n93_), .c(new_n70_), .O(new_n95_));
  aoi21  g52(.a(new_n92_), .b(new_n91_), .c(new_n95_), .O(z09));
  nor2   g53(.a(new_n71_), .b(x00), .O(z16));
  nor2   g54(.a(new_n93_), .b(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(z16), .c(new_n62_), .d(x22), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(z10));
  nand4  g57(.a(new_n98_), .b(z16), .c(new_n62_), .d(new_n94_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z11));
  nand2  g59(.a(new_n69_), .b(new_n72_), .O(new_n103_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n104_));
  nand3  g61(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n105_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n103_), .c(new_n109_), .O(z12));
  nor3   g67(.a(new_n105_), .b(x01), .c(x00), .O(z13));
  nor2   g68(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g69(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g70(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n114_));
  oai21  g71(.a(new_n113_), .b(new_n70_), .c(new_n114_), .O(z15));
  nand2  g72(.a(new_n46_), .b(x02), .O(new_n116_));
  inv1   g73(.a(new_n116_), .O(z17));
endmodule
