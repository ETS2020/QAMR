...
module FAU ( 
  ...
  nand4  g53(.a(new_n96_), .b(new_n95_), .c(new_n93_), .d(new_n90_), .O(new_n97_));
  ...
  nand4  g58(.a(new_n87_), .b(new_n64_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g59(.a(x15), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x14), .O(new_n104_));
  nand2  g61(.a(x20), .b(x16), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x22), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n104_), .c(new_n93_), .d(new_n90_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n102_), .c(x00), .O(z10));
  nand2  g65(.a(new_n99_), .b(new_n45_), .O(new_n109_));
  nand3  g66(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n110_));
  inv1   g67(.a(x16), .O(new_n111_));
  nand3  g68(.a(new_n98_), .b(x20), .c(new_n111_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n104_), .c(new_n93_), .d(new_n90_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n110_), .c(new_n109_), .O(z11));
  nand2  g72(.a(new_n71_), .b(new_n72_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n52_), .b(x17), .c(new_n89_), .O(new_n118_));
  ...
  aoi21  g82(.a(new_n57_), .b(x01), .c(new_n89_), .O(new_n126_));
  nand3  g83(.a(x19), .b(new_n89_), .c(new_n46_), .O(new_n127_));
