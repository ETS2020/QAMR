...
module FAU ( 
  ...
  nor2   g17(.a(x19), .b(new_n49_), .O(new_n61_));
  nand4  g18(.a(new_n61_), .b(new_n46_), .c(new_n48_), .d(new_n44_), .O(new_n62_));
  nand2  g19(.a(new_n62_), .b(new_n60_), .O(z03));
  nand2  g20(.a(x10), .b(x02), .O(new_n64_));
  inv1   g21(.a(x11), .O(new_n65_));
  inv1   g22(.a(x12), .O(new_n66_));
  nand4  g23(.a(new_n66_), .b(new_n65_), .c(new_n45_), .d(x00), .O(new_n67_));
  nor2   g24(.a(new_n67_), .b(new_n64_), .O(z04));
  inv1   g25(.a(x00), .O(new_n69_));
  inv1   g26(.a(x01), .O(new_n70_));
  nor4   g27(.a(new_n64_), .b(new_n45_), .c(new_n70_), .d(new_n69_), .O(z05));
  nor3   g28(.a(new_n58_), .b(new_n65_), .c(new_n55_), .O(z06));
  nand2  g29(.a(x02), .b(x00), .O(new_n73_));
  nand4  g30(.a(new_n66_), .b(x11), .c(x10), .d(new_n45_), .O(new_n74_));
  ...
  nor2   g40(.a(new_n70_), .b(x00), .O(z16));
  nand3  g41(.a(z16), .b(new_n61_), .c(new_n83_), .O(new_n85_));
  inv1   g42(.a(x21), .O(new_n86_));
  inv1   g43(.a(x22), .O(new_n87_));
  nand2  g44(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nor2   g45(.a(new_n88_), .b(new_n85_), .O(z09));
  nand4  g46(.a(z16), .b(new_n61_), .c(x21), .d(new_n83_), .O(new_n90_));
  nor2   g47(.a(new_n90_), .b(new_n87_), .O(z10));
  nor2   g48(.a(new_n90_), .b(x22), .O(z11));
  nand3  g49(.a(new_n64_), .b(x01), .c(x00), .O(new_n93_));
  ...
  nor3   g57(.a(new_n95_), .b(x01), .c(x00), .O(z13));
  nor2   g58(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g59(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n103_));
  nand3  g60(.a(x19), .b(new_n44_), .c(new_n70_), .O(new_n104_));
  oai21  g61(.a(new_n103_), .b(new_n69_), .c(new_n104_), .O(z15));
  nand2  g62(.a(new_n46_), .b(x02), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z17));
endmodule
