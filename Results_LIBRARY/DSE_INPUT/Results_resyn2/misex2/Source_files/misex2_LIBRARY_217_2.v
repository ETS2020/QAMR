...
module FAU ( 
  ...
  nand3  g18(.a(new_n46_), .b(new_n50_), .c(new_n44_), .O(new_n62_));
  inv1   g19(.a(new_n62_), .O(new_n63_));
  nand3  g20(.a(new_n63_), .b(x18), .c(new_n48_), .O(new_n64_));
  ...
  inv1   g32(.a(new_n59_), .O(new_n76_));
  ...
  nand2  g40(.a(new_n46_), .b(x02), .O(new_n84_));
  nand3  g41(.a(x19), .b(new_n49_), .c(x17), .O(new_n85_));
  nor3   g42(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z08));
  nor2   g43(.a(new_n67_), .b(x11), .O(new_n87_));
  nor2   g44(.a(x14), .b(x13), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(new_n87_), .c(new_n46_), .d(x02), .O(new_n89_));
  ...
  inv1   g54(.a(new_n84_), .O(z17));
  inv1   g55(.a(x13), .O(new_n99_));
  inv1   g56(.a(x14), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n99_), .c(x12), .d(new_n66_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n93_), .b(new_n92_), .c(x20), .d(x16), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n102_), .c(z17), .d(x15), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z10));
  nand4  g63(.a(new_n95_), .b(new_n102_), .c(z17), .d(x15), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(z11));
  nand2  g65(.a(new_n70_), .b(new_n73_), .O(new_n109_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g67(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n111_));
  ...
  nor2   g73(.a(new_n62_), .b(new_n48_), .O(z13));
  nor2   g74(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g75(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n44_), .c(new_n72_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n71_), .c(new_n120_), .O(z15));
  nor2   g78(.a(new_n72_), .b(x00), .O(z16));
endmodule
