...
module FAU ( 
  ...
  nand3  g54(.a(new_n97_), .b(new_n93_), .c(new_n89_), .O(new_n98_));
  inv1   g55(.a(x21), .O(new_n99_));
  nor2   g56(.a(x20), .b(x19), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n99_), .c(x18), .d(x01), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n98_), .c(new_n88_), .O(z09));
  nor2   g59(.a(x21), .b(new_n89_), .O(new_n103_));
  nand4  g60(.a(new_n87_), .b(x20), .c(x16), .d(new_n94_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n103_), .c(new_n93_), .O(new_n106_));
  ...
  nand3  g66(.a(new_n103_), .b(new_n97_), .c(new_n93_), .O(new_n110_));
  nand4  g67(.a(new_n100_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(new_n88_), .O(z11));
