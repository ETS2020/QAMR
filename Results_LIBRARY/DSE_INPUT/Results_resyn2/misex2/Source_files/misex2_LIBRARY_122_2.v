...
module FAU ( 
  ...
  nand4  g53(.a(new_n96_), .b(new_n49_), .c(x18), .d(x01), .O(new_n97_));
  inv1   g54(.a(x22), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n68_), .O(new_n99_));
  aoi21  g56(.a(new_n97_), .b(new_n95_), .c(new_n99_), .O(z09));
  inv1   g57(.a(new_n97_), .O(new_n101_));
  nand2  g58(.a(new_n101_), .b(x21), .O(new_n102_));
  nand4  g59(.a(new_n98_), .b(x20), .c(x16), .d(x15), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n90_), .c(new_n88_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n102_), .c(x00), .O(z10));
  nand4  g63(.a(new_n98_), .b(x20), .c(new_n92_), .d(x15), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n87_), .c(new_n82_), .O(z11));
  nand2  g65(.a(new_n67_), .b(new_n70_), .O(new_n109_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g67(.a(new_n49_), .b(x17), .c(new_n89_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n81_), .O(new_n113_));
  inv1   g70(.a(x24), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g72(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nand2  g73(.a(new_n45_), .b(new_n49_), .O(new_n117_));
  nor2   g74(.a(new_n117_), .b(new_n47_), .O(z13));
  nor2   g75(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g76(.a(new_n54_), .b(x01), .c(new_n89_), .O(new_n120_));
  nand3  g77(.a(x19), .b(new_n89_), .c(new_n69_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n68_), .c(new_n121_), .O(z15));
