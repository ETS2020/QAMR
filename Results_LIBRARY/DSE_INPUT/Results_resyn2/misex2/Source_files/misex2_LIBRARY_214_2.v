...
module FAU ( 
  ...
  nand4  g46(.a(x12), .b(new_n67_), .c(x02), .d(new_n46_), .O(new_n90_));
  ...
  nand3  g52(.a(new_n95_), .b(new_n91_), .c(new_n89_), .O(new_n96_));
  ...
  nor2   g57(.a(new_n98_), .b(x00), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n87_), .c(new_n64_), .d(x21), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z10));
  nand2  g60(.a(new_n98_), .b(new_n45_), .O(new_n104_));
  nand3  g61(.a(new_n87_), .b(new_n64_), .c(x21), .O(new_n105_));
  nor2   g62(.a(x21), .b(new_n89_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n95_), .c(new_n91_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(z11));
  nand2  g65(.a(new_n71_), .b(new_n72_), .O(new_n109_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  inv1   g67(.a(x02), .O(new_n111_));
  nand3  g68(.a(new_n52_), .b(x17), .c(new_n111_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n83_), .O(new_n114_));
  inv1   g71(.a(x24), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(x09), .O(new_n116_));
  aoi21  g73(.a(new_n114_), .b(new_n109_), .c(new_n116_), .O(z12));
  nor2   g74(.a(new_n112_), .b(new_n47_), .O(z13));
  nor2   g75(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g76(.a(new_n57_), .b(x01), .c(new_n111_), .O(new_n120_));
  nand3  g77(.a(x19), .b(new_n111_), .c(new_n46_), .O(new_n121_));
  oai21  g78(.a(new_n120_), .b(new_n45_), .c(new_n121_), .O(z15));
  nor2   g79(.a(new_n46_), .b(x00), .O(z16));
  inv1   g80(.a(new_n84_), .O(z17));
endmodule
