...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n80_, new_n81_, new_n82_, new_n83_, new_n84_, new_n87_, new_n89_,
    new_n90_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    new_n99_, new_n103_, new_n104_, new_n106_;
  ...
  nand3  g44(.a(z16), .b(new_n62_), .c(new_n87_), .O(new_n89_));
  nand2  g45(.a(x22), .b(x21), .O(new_n90_));
  nor2   g46(.a(new_n90_), .b(new_n89_), .O(z10));
  nor2   g47(.a(new_n89_), .b(x22), .O(z11));
  nand2  g48(.a(new_n69_), .b(new_n72_), .O(new_n93_));
  oai21  g49(.a(x19), .b(x02), .c(x23), .O(new_n94_));
  nand3  g50(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n46_), .O(new_n97_));
  inv1   g53(.a(x24), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g55(.a(new_n97_), .b(new_n93_), .c(new_n99_), .O(z12));
  nor3   g56(.a(new_n95_), .b(x01), .c(x00), .O(z13));
  nor2   g57(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g58(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n103_));
  nand3  g59(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n104_));
  oai21  g60(.a(new_n103_), .b(new_n70_), .c(new_n104_), .O(z15));
  nand2  g61(.a(new_n46_), .b(x02), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(z17));
  zero   g63(.O(z09));
endmodule
