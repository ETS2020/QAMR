...
module FAU ( 
  ...
  nor2   g17(.a(x17), .b(x01), .O(new_n61_));
  nand4  g18(.a(new_n61_), .b(new_n45_), .c(new_n49_), .d(x18), .O(new_n62_));
  ...
  nand3  g34(.a(x19), .b(new_n48_), .c(x17), .O(new_n78_));
  ...
  nand3  g42(.a(new_n85_), .b(new_n49_), .c(x01), .O(new_n86_));
  ...
  nand3  g52(.a(new_n95_), .b(new_n94_), .c(new_n69_), .O(new_n96_));
  ...
  nand2  g63(.a(new_n95_), .b(new_n69_), .O(new_n107_));
  ...
  nor3   g77(.a(new_n114_), .b(x01), .c(x00), .O(z13));
  nor2   g78(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g79(.a(new_n54_), .b(x01), .c(new_n113_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n113_), .c(new_n70_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n69_), .c(new_n124_), .O(z15));
  nor2   g82(.a(new_n70_), .b(x00), .O(z16));
  nand2  g83(.a(new_n116_), .b(x02), .O(new_n127_));
