...
module FAU ( 
  ...
  nand4  g47(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n67_), .O(new_n91_));
  ...
  nor2   g54(.a(x20), .b(new_n46_), .O(new_n98_));
  ...
  nand4  g60(.a(new_n98_), .b(new_n64_), .c(x22), .d(x21), .O(new_n104_));
  nand4  g61(.a(new_n101_), .b(x20), .c(x16), .d(x15), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n92_), .c(new_n88_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n104_), .c(x00), .O(z10));
  nand2  g65(.a(new_n101_), .b(new_n45_), .O(new_n109_));
  nand3  g66(.a(new_n98_), .b(new_n64_), .c(x21), .O(new_n110_));
  nand3  g67(.a(x20), .b(new_n94_), .c(x15), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n92_), .c(new_n88_), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(z11));
  nand2  g71(.a(new_n71_), .b(new_n72_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n52_), .b(x17), .c(new_n87_), .O(new_n117_));
  ...
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n87_), .O(new_n125_));
  nand3  g82(.a(x19), .b(new_n87_), .c(new_n46_), .O(new_n126_));
