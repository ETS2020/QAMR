...
module FAU ( 
  ...
  nand4  g57(.a(new_n96_), .b(x20), .c(x15), .d(new_n100_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  inv1   g59(.a(x16), .O(new_n103_));
  nor2   g60(.a(x22), .b(new_n103_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n102_), .c(new_n92_), .O(new_n105_));
  nor2   g62(.a(new_n97_), .b(new_n96_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n64_), .c(new_n87_), .d(x01), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n105_), .c(x00), .O(z10));
  nand2  g65(.a(new_n97_), .b(new_n45_), .O(new_n109_));
  nand3  g66(.a(new_n102_), .b(new_n92_), .c(new_n103_), .O(new_n110_));
  nand2  g67(.a(x21), .b(new_n52_), .O(new_n111_));
  or2    g68(.a(new_n111_), .b(new_n88_), .O(new_n112_));
