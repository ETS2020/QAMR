// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:10 2020
...
module FAU ( 
  ...
  nand3  g53(.a(new_n96_), .b(new_n92_), .c(new_n88_), .O(new_n97_));
  nor3   g54(.a(x21), .b(x20), .c(x19), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(x18), .c(x01), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n97_), .c(new_n86_), .O(z09));
  nand4  g57(.a(x21), .b(new_n49_), .c(x18), .d(x01), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(x22), .O(new_n103_));
  nand4  g60(.a(new_n85_), .b(x20), .c(x16), .d(x15), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n92_), .c(new_n88_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n103_), .c(x00), .O(z10));
  nand3  g64(.a(x20), .b(new_n94_), .c(x15), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n92_), .c(new_n88_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n101_), .c(new_n86_), .O(z11));
  nand2  g68(.a(new_n67_), .b(new_n70_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n49_), .b(x17), .c(new_n87_), .O(new_n114_));
  ...
  nand2  g76(.a(new_n45_), .b(new_n49_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(new_n47_), .O(z13));
  nor2   g78(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g79(.a(new_n54_), .b(x01), .c(new_n87_), .O(new_n123_));
  nand3  g80(.a(x19), .b(new_n87_), .c(new_n69_), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n68_), .c(new_n124_), .O(z15));
  nor2   g82(.a(new_n69_), .b(x00), .O(z16));
  inv1   g83(.a(new_n82_), .O(z17));
endmodule
