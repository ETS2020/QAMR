...
module FAU ( 
  ...
  nand4  g53(.a(new_n64_), .b(new_n96_), .c(new_n92_), .d(x01), .O(new_n97_));
  ...
  nand3  g58(.a(new_n98_), .b(x15), .c(new_n101_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  and2   g60(.a(x20), .b(x16), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n103_), .c(new_n91_), .d(new_n88_), .O(new_n105_));
  nor2   g62(.a(new_n98_), .b(x20), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n64_), .c(x22), .d(x01), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n105_), .c(x00), .O(z10));
  nand4  g65(.a(new_n103_), .b(new_n93_), .c(new_n91_), .d(new_n88_), .O(new_n109_));
  nand4  g66(.a(new_n106_), .b(new_n64_), .c(new_n96_), .d(x01), .O(new_n110_));
