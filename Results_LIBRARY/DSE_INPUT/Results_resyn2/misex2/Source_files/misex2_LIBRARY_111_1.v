// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:39 2020
...
module FAU ( 
  ...
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n67_), .O(new_n90_));
  ...
  nand4  g51(.a(new_n94_), .b(new_n93_), .c(new_n91_), .d(new_n88_), .O(new_n95_));
  ...
  nand3  g57(.a(new_n96_), .b(new_n64_), .c(x22), .O(new_n101_));
  inv1   g58(.a(x14), .O(new_n102_));
  nand3  g59(.a(new_n98_), .b(x15), .c(new_n102_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  and2   g61(.a(x20), .b(x16), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n104_), .c(new_n91_), .d(new_n88_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n101_), .c(x00), .O(z10));
  nor2   g64(.a(x22), .b(new_n98_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n96_), .c(new_n64_), .O(new_n109_));
  nand4  g66(.a(new_n104_), .b(new_n93_), .c(new_n91_), .d(new_n88_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n109_), .c(x00), .O(z11));
  nand2  g68(.a(new_n71_), .b(new_n72_), .O(new_n112_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g70(.a(new_n52_), .b(x17), .c(new_n87_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n83_), .O(new_n116_));
  inv1   g73(.a(x24), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g75(.a(new_n116_), .b(new_n112_), .c(new_n118_), .O(z12));
  nor2   g76(.a(new_n114_), .b(new_n47_), .O(z13));
  nor2   g77(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g78(.a(new_n57_), .b(x01), .c(new_n87_), .O(new_n122_));
  nand3  g79(.a(x19), .b(new_n87_), .c(new_n46_), .O(new_n123_));
