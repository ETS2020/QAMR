...
module FAU ( 
  ...
  nand2  g025(.a(x20), .b(x16), .O(new_n59_));
  ...
  nand3  g030(.a(new_n40_), .b(new_n39_), .c(x00), .O(new_n64_));
  oai21  g031(.a(new_n57_), .b(new_n63_), .c(new_n64_), .O(new_n65_));
  ...
  nand3  g050(.a(new_n83_), .b(new_n73_), .c(new_n65_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n62_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n36_), .O(new_n86_));
  inv1   g053(.a(new_n54_), .O(new_n87_));
  nor2   g054(.a(x12), .b(x11), .O(new_n88_));
  nor2   g055(.a(x23), .b(x20), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n49_), .d(new_n69_), .O(new_n90_));
  nor2   g057(.a(x17), .b(x16), .O(new_n91_));
  nor2   g058(.a(x08), .b(x06), .O(new_n92_));
  inv1   g059(.a(x07), .O(new_n93_));
  nor2   g060(.a(x09), .b(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n67_), .O(new_n95_));
  inv1   g062(.a(new_n59_), .O(new_n96_));
  inv1   g063(.a(new_n60_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n96_), .c(x18), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n87_), .c(new_n95_), .d(new_n90_), .O(new_n99_));
  nor2   g066(.a(new_n42_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nor2   g068(.a(x14), .b(x09), .O(new_n102_));
  nand4  g069(.a(new_n92_), .b(new_n91_), .c(new_n102_), .d(x19), .O(new_n103_));
  nand3  g070(.a(new_n97_), .b(new_n96_), .c(x15), .O(new_n104_));
  oai22  g071(.a(new_n104_), .b(new_n87_), .c(new_n103_), .d(new_n90_), .O(new_n105_));
  ...
  nand3  g087(.a(new_n117_), .b(new_n58_), .c(new_n120_), .O(new_n121_));
  inv1   g088(.a(new_n77_), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n65_), .c(new_n48_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n36_), .O(new_n125_));
  inv1   g092(.a(x18), .O(new_n126_));
  nand2  g093(.a(new_n117_), .b(new_n120_), .O(new_n127_));
  nor2   g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand3  g095(.a(new_n92_), .b(new_n49_), .c(new_n48_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n93_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n128_), .c(new_n100_), .O(new_n131_));
  nor2   g098(.a(new_n127_), .b(new_n55_), .O(new_n132_));
  nor2   g099(.a(new_n129_), .b(new_n63_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n132_), .c(new_n42_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n131_), .c(new_n125_), .O(z3));
  nand2  g102(.a(x23), .b(x22), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x04), .c(x09), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(x16), .c(new_n76_), .O(new_n138_));
  aoi21  g105(.a(new_n81_), .b(x04), .c(x17), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n66_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n70_), .c(x08), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n46_), .c(new_n138_), .d(new_n115_), .O(z4));
  inv1   g109(.a(new_n46_), .O(z5));
  oai21  g110(.a(new_n80_), .b(x14), .c(new_n47_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n78_), .c(x03), .O(new_n145_));
  oai21  g112(.a(x20), .b(new_n67_), .c(x06), .O(new_n146_));
