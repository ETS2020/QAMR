...
module FAU ( 
  ...
  nand4  g066(.a(new_n95_), .b(new_n94_), .c(new_n54_), .d(x15), .O(new_n100_));
  nor2   g067(.a(x14), .b(x09), .O(new_n101_));
  nand4  g068(.a(new_n90_), .b(new_n89_), .c(new_n101_), .d(x19), .O(new_n102_));
  oai21  g069(.a(new_n102_), .b(new_n88_), .c(new_n100_), .O(new_n103_));
  ...
  aoi21  g102(.a(new_n135_), .b(new_n71_), .c(x08), .O(new_n136_));
  ...
  oai22  g107(.a(new_n140_), .b(new_n113_), .c(new_n136_), .d(new_n46_), .O(z4));
