...
module FAU ( 
  ...
  oai21  g102(.a(new_n49_), .b(x14), .c(new_n48_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n73_), .c(x03), .O(new_n137_));
  oai21  g104(.a(x20), .b(new_n74_), .c(x06), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x11), .c(new_n47_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n111_), .c(new_n137_), .d(new_n46_), .O(z6));
  inv1   g107(.a(new_n111_), .O(z7));
endmodule
