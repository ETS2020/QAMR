...
module FAU ( 
  ...
  nand3  g019(.a(x21), .b(new_n40_), .c(new_n39_), .O(new_n53_));
  nand2  g020(.a(x13), .b(x05), .O(new_n54_));
  oai21  g021(.a(new_n54_), .b(new_n52_), .c(new_n53_), .O(new_n55_));
  nand4  g022(.a(x23), .b(x22), .c(x16), .d(x14), .O(new_n56_));
  ...
  oai21  g032(.a(new_n54_), .b(new_n64_), .c(new_n65_), .O(new_n66_));
  inv1   g033(.a(x01), .O(new_n67_));
  inv1   g034(.a(x03), .O(new_n68_));
  nand3  g035(.a(new_n60_), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  ...
  nand3  g050(.a(new_n83_), .b(new_n73_), .c(new_n66_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n63_), .O(new_n85_));
  nand2  g052(.a(new_n85_), .b(new_n36_), .O(new_n86_));
  nor3   g053(.a(x20), .b(x03), .c(x01), .O(new_n87_));
  nor2   g054(.a(x17), .b(x16), .O(new_n88_));
  nand3  g055(.a(new_n88_), .b(new_n87_), .c(new_n70_), .O(new_n89_));
  ...
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n95_));
  inv1   g062(.a(new_n61_), .O(new_n96_));
  nor2   g063(.a(new_n60_), .b(new_n59_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n58_), .d(x18), .O(new_n98_));
  oai21  g065(.a(new_n95_), .b(new_n89_), .c(new_n98_), .O(new_n99_));
  nor2   g066(.a(new_n42_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g068(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n79_), .O(new_n102_));
  nand4  g069(.a(new_n97_), .b(new_n96_), .c(new_n58_), .d(x15), .O(new_n103_));
  nand4  g070(.a(new_n88_), .b(new_n87_), .c(x19), .d(new_n70_), .O(new_n104_));
  oai21  g071(.a(new_n104_), .b(new_n102_), .c(new_n103_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n42_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n101_), .c(new_n86_), .O(z1));
  nand2  g074(.a(x24), .b(x18), .O(new_n108_));
  nand3  g075(.a(new_n36_), .b(x15), .c(x13), .O(new_n109_));
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n34_), .O(new_n110_));
  nand4  g077(.a(new_n36_), .b(x21), .c(new_n40_), .d(new_n39_), .O(new_n111_));
  ...
  nor2   g082(.a(new_n68_), .b(new_n67_), .O(new_n116_));
  nand4  g083(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n115_), .O(z2));
  nand3  g087(.a(new_n118_), .b(new_n116_), .c(new_n55_), .O(new_n121_));
  nor3   g088(.a(x08), .b(x03), .c(x01), .O(new_n122_));
  nand3  g089(.a(new_n122_), .b(new_n66_), .c(new_n48_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n36_), .O(new_n125_));
  inv1   g092(.a(x18), .O(new_n126_));
  nor2   g093(.a(new_n119_), .b(new_n126_), .O(new_n127_));
  inv1   g094(.a(new_n48_), .O(new_n128_));
  nand2  g095(.a(new_n94_), .b(new_n49_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(new_n100_), .O(new_n131_));
  nand3  g098(.a(new_n122_), .b(new_n48_), .c(x19), .O(new_n132_));
  oai21  g099(.a(new_n119_), .b(new_n52_), .c(new_n132_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n42_), .O(new_n134_));
  nand3  g101(.a(new_n134_), .b(new_n131_), .c(new_n125_), .O(z3));
  aoi21  g102(.a(new_n77_), .b(x04), .c(x17), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x22), .c(new_n74_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n71_), .c(x08), .O(new_n138_));
  aoi21  g105(.a(x23), .b(new_n70_), .c(new_n59_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n76_), .c(x09), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x16), .c(new_n79_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n115_), .c(new_n138_), .d(new_n46_), .O(z4));
  inv1   g109(.a(new_n46_), .O(z5));
  oai21  g110(.a(new_n60_), .b(x14), .c(new_n47_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n75_), .c(x03), .O(new_n145_));
  oai21  g112(.a(x20), .b(new_n81_), .c(x06), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x11), .c(new_n68_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n115_), .c(new_n145_), .d(new_n46_), .O(z6));
  inv1   g115(.a(new_n115_), .O(z7));
endmodule
