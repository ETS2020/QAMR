...
module FAU ( 
  ...
  nand3  g13(.a(x06), .b(x03), .c(x01), .O(new_n48_));
  inv1   g14(.a(new_n48_), .O(new_n49_));
  nand2  g15(.a(new_n49_), .b(x08), .O(new_n50_));
  nand4  g16(.a(x23), .b(x22), .c(x20), .d(x17), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(new_n52_));
  and2   g18(.a(x14), .b(x11), .O(new_n53_));
  nand4  g19(.a(x16), .b(x12), .c(x09), .d(x04), .O(new_n54_));
  inv1   g20(.a(new_n54_), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(new_n56_));
  nor3   g22(.a(new_n56_), .b(new_n50_), .c(new_n47_), .O(z1));
  nand2  g23(.a(new_n53_), .b(x20), .O(new_n58_));
  nor3   g24(.a(new_n58_), .b(new_n48_), .c(new_n47_), .O(z2));
  nor3   g25(.a(new_n58_), .b(new_n50_), .c(new_n47_), .O(z3));
  ...
  inv1   g41(.a(x22), .O(new_n76_));
  inv1   g42(.a(x04), .O(new_n77_));
  inv1   g43(.a(x17), .O(new_n78_));
  aoi21  g44(.a(x23), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  oai21  g45(.a(new_n79_), .b(new_n76_), .c(x09), .O(new_n80_));
  aoi21  g46(.a(new_n80_), .b(x16), .c(new_n75_), .O(new_n81_));
  oai22  g47(.a(new_n81_), .b(new_n47_), .c(new_n74_), .d(new_n66_), .O(z4));
  inv1   g48(.a(new_n74_), .O(z5));
  inv1   g49(.a(x11), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(x03), .O(new_n85_));
  inv1   g51(.a(x20), .O(new_n86_));
  nand2  g52(.a(x06), .b(x03), .O(new_n87_));
  aoi21  g53(.a(new_n53_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  oai22  g54(.a(new_n88_), .b(new_n47_), .c(new_n85_), .d(new_n74_), .O(z6));
