...
module FAU ( 
  ...
  nor2   g011(.a(new_n43_), .b(new_n34_), .O(new_n45_));
  nand2  g012(.a(new_n45_), .b(x07), .O(new_n46_));
  nand4  g013(.a(new_n46_), .b(new_n44_), .c(new_n42_), .d(new_n37_), .O(z5));
  ...
  nand4  g029(.a(new_n62_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n63_));
  nor2   g030(.a(new_n63_), .b(new_n60_), .O(new_n64_));
  inv1   g031(.a(x12), .O(new_n65_));
  nand3  g032(.a(new_n50_), .b(new_n49_), .c(new_n65_), .O(new_n66_));
  ...
  aoi21  g037(.a(new_n40_), .b(new_n35_), .c(new_n70_), .O(new_n71_));
  nand3  g038(.a(new_n71_), .b(new_n67_), .c(new_n64_), .O(new_n72_));
  ...
  nor2   g051(.a(new_n79_), .b(new_n65_), .O(new_n85_));
  nand3  g052(.a(x18), .b(x16), .c(x14), .O(new_n86_));
  inv1   g053(.a(new_n86_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n85_), .c(new_n78_), .d(x11), .O(new_n88_));
  nand4  g055(.a(new_n69_), .b(new_n68_), .c(x07), .d(new_n48_), .O(new_n89_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n85_), .c(new_n78_), .d(x11), .O(new_n96_));
  nand4  g063(.a(new_n49_), .b(x19), .c(new_n68_), .d(new_n48_), .O(new_n97_));
  inv1   g064(.a(new_n97_), .O(new_n98_));
  nand3  g065(.a(new_n50_), .b(new_n65_), .c(new_n69_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n98_), .c(new_n64_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n96_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n43_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n93_), .c(new_n84_), .O(z1));
  inv1   g071(.a(new_n74_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n34_), .O(new_n106_));
  and2   g073(.a(x24), .b(x18), .O(new_n107_));
  inv1   g074(.a(x13), .O(new_n108_));
  nor2   g075(.a(x24), .b(new_n108_), .O(new_n109_));
  oai21  g076(.a(new_n109_), .b(new_n107_), .c(x05), .O(new_n110_));
  aoi22  g077(.a(new_n107_), .b(x13), .c(new_n43_), .d(x15), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n110_), .c(new_n106_), .O(z7));
  inv1   g079(.a(z7), .O(new_n113_));
  inv1   g080(.a(x11), .O(new_n114_));
  inv1   g081(.a(x14), .O(new_n115_));
  nand3  g082(.a(x20), .b(x03), .c(x01), .O(new_n116_));
  nor3   g083(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(x06), .O(new_n118_));
  nor2   g085(.a(new_n118_), .b(new_n113_), .O(z2));
  inv1   g086(.a(new_n76_), .O(new_n120_));
  nand3  g087(.a(new_n117_), .b(new_n120_), .c(x18), .O(new_n121_));
  inv1   g088(.a(new_n51_), .O(new_n122_));
  nor2   g089(.a(new_n54_), .b(x08), .O(new_n123_));
  nand3  g090(.a(new_n123_), .b(new_n122_), .c(x07), .O(new_n124_));
  nand2  g091(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand3  g093(.a(new_n117_), .b(new_n120_), .c(x15), .O(new_n127_));
  nand4  g094(.a(new_n98_), .b(new_n50_), .c(new_n53_), .d(new_n52_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n43_), .O(new_n130_));
  nand3  g097(.a(new_n117_), .b(new_n120_), .c(new_n75_), .O(new_n131_));
  nand2  g098(.a(new_n40_), .b(new_n35_), .O(new_n132_));
  nand3  g099(.a(new_n123_), .b(new_n132_), .c(new_n122_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n34_), .O(new_n135_));
  nand3  g102(.a(new_n135_), .b(new_n130_), .c(new_n126_), .O(z3));
  nand3  g103(.a(new_n46_), .b(new_n44_), .c(new_n42_), .O(new_n137_));
  oai21  g104(.a(x23), .b(new_n61_), .c(new_n57_), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n58_), .c(x09), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x16), .c(new_n68_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  oai21  g108(.a(new_n59_), .b(x04), .c(x17), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x22), .c(new_n69_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n62_), .c(x08), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(z7), .O(new_n145_));
  nand3  g112(.a(new_n145_), .b(new_n141_), .c(new_n37_), .O(z4));
  aoi21  g113(.a(x20), .b(new_n115_), .c(x06), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x11), .c(new_n53_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n137_), .O(new_n149_));
  aoi21  g116(.a(new_n49_), .b(x14), .c(new_n48_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n114_), .c(x03), .O(new_n151_));
