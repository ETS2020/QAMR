...
module FAU ( 
  ...
  nor2   g026(.a(new_n48_), .b(new_n59_), .O(new_n60_));
  nand3  g027(.a(x12), .b(x11), .c(x09), .O(new_n61_));
  inv1   g028(.a(new_n61_), .O(new_n62_));
  nand4  g029(.a(new_n62_), .b(new_n60_), .c(new_n58_), .d(new_n55_), .O(new_n63_));
  ...
  nand3  g040(.a(new_n40_), .b(new_n39_), .c(x00), .O(new_n74_));
  ...
  nor2   g045(.a(x20), .b(x09), .O(new_n79_));
  nand3  g046(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  inv1   g047(.a(new_n80_), .O(new_n81_));
  nand3  g048(.a(new_n81_), .b(new_n76_), .c(new_n73_), .O(new_n82_));
  nand2  g049(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  nand2  g050(.a(new_n83_), .b(new_n36_), .O(new_n84_));
  nor2   g051(.a(new_n42_), .b(new_n36_), .O(new_n85_));
  nand4  g052(.a(new_n62_), .b(new_n60_), .c(new_n55_), .d(x18), .O(new_n86_));
  inv1   g053(.a(new_n86_), .O(new_n87_));
  nor2   g054(.a(x22), .b(x04), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n50_), .c(new_n49_), .d(new_n66_), .O(new_n89_));
  nand2  g056(.a(new_n78_), .b(new_n77_), .O(new_n90_));
  nand2  g057(.a(new_n79_), .b(x07), .O(new_n91_));
  nor3   g058(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n87_), .c(new_n85_), .O(new_n93_));
  nand2  g060(.a(new_n79_), .b(x19), .O(new_n94_));
  nor3   g061(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(new_n95_));
  nand4  g062(.a(new_n62_), .b(new_n60_), .c(new_n55_), .d(x15), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n95_), .c(new_n42_), .O(new_n98_));
  ...
  nor2   g074(.a(new_n69_), .b(new_n68_), .O(new_n108_));
  nand3  g075(.a(x20), .b(x14), .c(x11), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n108_), .c(x06), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n107_), .O(z2));
  inv1   g079(.a(x07), .O(new_n113_));
  inv1   g080(.a(x18), .O(new_n114_));
  nand3  g081(.a(new_n110_), .b(new_n108_), .c(x08), .O(new_n115_));
  oai22  g082(.a(new_n115_), .b(new_n114_), .c(new_n51_), .d(new_n113_), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n85_), .O(new_n117_));
  inv1   g084(.a(x15), .O(new_n118_));
  inv1   g085(.a(x19), .O(new_n119_));
  oai22  g086(.a(new_n115_), .b(new_n118_), .c(new_n51_), .d(new_n119_), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n42_), .O(new_n121_));
  aoi21  g088(.a(new_n57_), .b(new_n56_), .c(new_n115_), .O(new_n122_));
  aoi21  g089(.a(new_n75_), .b(new_n74_), .c(new_n51_), .O(new_n123_));
  oai21  g090(.a(new_n123_), .b(new_n122_), .c(new_n36_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n121_), .c(new_n117_), .O(z3));
  ...
  aoi21  g098(.a(x23), .b(new_n64_), .c(new_n59_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n65_), .c(x09), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x16), .c(new_n131_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n107_), .c(new_n130_), .d(new_n46_), .O(z4));
  inv1   g102(.a(new_n46_), .O(z5));
  oai21  g103(.a(new_n48_), .b(x14), .c(new_n70_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n71_), .c(x03), .O(new_n138_));
  oai21  g105(.a(x20), .b(new_n47_), .c(x06), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x11), .c(new_n69_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n107_), .c(new_n138_), .d(new_n46_), .O(z6));
  inv1   g108(.a(new_n107_), .O(z7));
endmodule
