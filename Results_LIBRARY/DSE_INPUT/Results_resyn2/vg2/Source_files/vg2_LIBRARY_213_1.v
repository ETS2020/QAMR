...
module FAU ( 
  ...
  nand2  g025(.a(x20), .b(x17), .O(new_n59_));
  ...
  nor2   g055(.a(x22), .b(x20), .O(new_n89_));
  ...
  nor2   g102(.a(x17), .b(x04), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(x22), .c(new_n66_), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n70_), .c(x08), .O(new_n138_));
  oai21  g105(.a(new_n81_), .b(x17), .c(x09), .O(new_n139_));
  nand2  g106(.a(x23), .b(x22), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x04), .c(x08), .O(new_n141_));
  aoi21  g108(.a(new_n139_), .b(x16), .c(new_n141_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n115_), .c(new_n138_), .d(new_n46_), .O(z4));
  inv1   g110(.a(new_n46_), .O(z5));
  oai21  g111(.a(new_n80_), .b(x14), .c(new_n47_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n78_), .c(x03), .O(new_n146_));
  oai21  g113(.a(x20), .b(new_n67_), .c(x06), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x11), .c(new_n75_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n115_), .c(new_n146_), .d(new_n46_), .O(z6));
  inv1   g116(.a(new_n115_), .O(z7));
endmodule
