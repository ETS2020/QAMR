...
module FAU ( 
  ...
  inv1   g18(.a(x20), .O(new_n53_));
  inv1   g19(.a(x22), .O(new_n54_));
  nor2   g20(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand4  g21(.a(new_n55_), .b(new_n52_), .c(new_n50_), .d(x23), .O(new_n56_));
  nor2   g22(.a(new_n56_), .b(new_n47_), .O(z1));
  nand4  g23(.a(new_n52_), .b(x20), .c(x14), .d(x11), .O(new_n58_));
  nor2   g24(.a(new_n58_), .b(new_n47_), .O(z2));
  inv1   g25(.a(x08), .O(new_n60_));
  nor3   g26(.a(new_n58_), .b(new_n47_), .c(new_n60_), .O(z3));
  ...
  nand4  g36(.a(new_n37_), .b(new_n41_), .c(new_n40_), .d(x00), .O(new_n71_));
  nand3  g37(.a(x19), .b(new_n44_), .c(new_n35_), .O(new_n72_));
  nand3  g38(.a(x24), .b(x13), .c(x07), .O(new_n73_));
  ...
  oai21  g44(.a(new_n78_), .b(new_n54_), .c(x09), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(x16), .c(new_n60_), .O(new_n80_));
  oai22  g46(.a(new_n80_), .b(new_n47_), .c(new_n75_), .d(new_n67_), .O(z4));
  inv1   g47(.a(new_n75_), .O(z5));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(x06), .O(new_n84_));
  oai21  g50(.a(new_n53_), .b(x14), .c(new_n84_), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(new_n83_), .c(x03), .O(new_n86_));
  inv1   g52(.a(x03), .O(new_n87_));
  inv1   g53(.a(x14), .O(new_n88_));
  oai21  g54(.a(x20), .b(new_n88_), .c(x06), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(x11), .c(new_n87_), .O(new_n90_));
  oai22  g56(.a(new_n90_), .b(new_n47_), .c(new_n86_), .d(new_n75_), .O(z6));
