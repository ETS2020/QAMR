...
module FAU ( 
  ...
  nor2   g056(.a(new_n49_), .b(new_n61_), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n89_), .c(new_n60_), .d(x18), .O(new_n91_));
  ...
  nand4  g061(.a(new_n90_), .b(new_n89_), .c(new_n60_), .d(x15), .O(new_n95_));
  ...
  nand3  g070(.a(x20), .b(x14), .c(x06), .O(new_n104_));
  ...
  nand4  g076(.a(new_n36_), .b(x21), .c(new_n40_), .d(new_n39_), .O(new_n110_));
  nand3  g077(.a(x24), .b(x18), .c(x13), .O(new_n111_));
  nand2  g078(.a(new_n42_), .b(x15), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nor2   g080(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n106_), .O(z2));
  nand2  g082(.a(new_n96_), .b(new_n67_), .O(new_n116_));
  nand3  g083(.a(new_n105_), .b(new_n57_), .c(x08), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n36_), .O(new_n119_));
  nor2   g086(.a(new_n86_), .b(new_n50_), .O(new_n120_));
  nand2  g087(.a(x18), .b(x08), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n106_), .O(new_n122_));
  oai21  g089(.a(new_n122_), .b(new_n120_), .c(new_n93_), .O(new_n123_));
  nand2  g090(.a(new_n96_), .b(x19), .O(new_n124_));
  nand3  g091(.a(new_n105_), .b(x15), .c(x08), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand2  g093(.a(new_n126_), .b(new_n42_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n123_), .c(new_n119_), .O(z3));
  aoi21  g095(.a(new_n79_), .b(x04), .c(x17), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(x22), .c(new_n76_), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(new_n69_), .c(x08), .O(new_n131_));
  aoi21  g098(.a(x23), .b(new_n68_), .c(new_n61_), .O(new_n132_));
  oai21  g099(.a(new_n132_), .b(new_n78_), .c(x09), .O(new_n133_));
  aoi21  g100(.a(new_n133_), .b(x16), .c(new_n72_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n114_), .c(new_n131_), .d(new_n46_), .O(z4));
  inv1   g102(.a(new_n46_), .O(z5));
  aoi21  g103(.a(new_n51_), .b(x20), .c(x03), .O(new_n137_));
  oai21  g104(.a(x20), .b(new_n74_), .c(x06), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(x11), .c(new_n48_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n114_), .c(new_n137_), .d(new_n46_), .O(z6));
