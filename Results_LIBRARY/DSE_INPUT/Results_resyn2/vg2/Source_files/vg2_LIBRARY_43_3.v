...
module FAU ( 
  ...
  inv1   g50(.a(x20), .O(new_n85_));
  oai21  g51(.a(new_n85_), .b(x14), .c(new_n84_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n83_), .c(x03), .O(new_n87_));
  inv1   g53(.a(x03), .O(new_n88_));
  inv1   g54(.a(x14), .O(new_n89_));
  oai21  g55(.a(x20), .b(new_n89_), .c(x06), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x11), .c(new_n88_), .O(new_n91_));
  oai22  g57(.a(new_n91_), .b(new_n80_), .c(new_n87_), .d(new_n61_), .O(z6));
  inv1   g58(.a(new_n80_), .O(z7));
  zero   g59(.O(z2));
endmodule
