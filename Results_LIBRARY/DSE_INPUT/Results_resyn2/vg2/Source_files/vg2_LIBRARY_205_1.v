...
module FAU ( 
  ...
  nand4  g044(.a(x23), .b(x22), .c(x16), .d(x12), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand3  g046(.a(x11), .b(x09), .c(x04), .O(new_n80_));
  nor3   g047(.a(new_n80_), .b(new_n48_), .c(new_n64_), .O(new_n81_));
  ...
  nor2   g052(.a(new_n48_), .b(new_n64_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n79_), .d(x18), .O(new_n87_));
  inv1   g054(.a(new_n87_), .O(new_n88_));
  nor2   g055(.a(x17), .b(x09), .O(new_n89_));
  nor2   g056(.a(x23), .b(x22), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n89_), .c(new_n52_), .d(new_n59_), .O(new_n91_));
  nand2  g058(.a(new_n60_), .b(x07), .O(new_n92_));
  nor3   g059(.a(new_n92_), .b(new_n91_), .c(new_n71_), .O(new_n93_));
  nor2   g060(.a(new_n42_), .b(new_n36_), .O(new_n94_));
  oai21  g061(.a(new_n93_), .b(new_n88_), .c(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n86_), .b(new_n85_), .c(new_n79_), .d(x15), .O(new_n96_));
  nor2   g063(.a(x20), .b(new_n55_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n60_), .c(new_n49_), .d(new_n69_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n91_), .c(new_n96_), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(new_n42_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n95_), .c(new_n84_), .O(z1));
  ...
  nand3  g081(.a(new_n111_), .b(new_n114_), .c(new_n76_), .O(new_n115_));
  nand2  g082(.a(new_n60_), .b(new_n52_), .O(new_n116_));
  inv1   g083(.a(new_n116_), .O(new_n117_));
  nand3  g084(.a(new_n117_), .b(new_n58_), .c(new_n51_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n36_), .O(new_n120_));
  inv1   g087(.a(x18), .O(new_n121_));
  nand2  g088(.a(new_n111_), .b(new_n114_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  inv1   g090(.a(x07), .O(new_n124_));
  nor3   g091(.a(new_n116_), .b(new_n50_), .c(new_n124_), .O(new_n125_));
  oai21  g092(.a(new_n125_), .b(new_n123_), .c(new_n94_), .O(new_n126_));
  nor2   g093(.a(new_n122_), .b(new_n74_), .O(new_n127_));
  nand2  g094(.a(new_n97_), .b(new_n60_), .O(new_n128_));
  nand2  g095(.a(new_n52_), .b(new_n49_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g097(.a(new_n130_), .b(new_n127_), .c(new_n42_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n126_), .c(new_n120_), .O(z3));
  inv1   g099(.a(x16), .O(new_n133_));
  aoi21  g100(.a(new_n66_), .b(x04), .c(x17), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x22), .c(new_n63_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n133_), .c(x08), .O(new_n136_));
  inv1   g103(.a(x08), .O(new_n137_));
  aoi21  g104(.a(x23), .b(new_n59_), .c(new_n64_), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n65_), .c(x09), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x16), .c(new_n137_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n109_), .c(new_n136_), .d(new_n46_), .O(z4));
  ...
  oai22  g114(.a(new_n147_), .b(new_n109_), .c(new_n144_), .d(new_n46_), .O(z6));
  inv1   g115(.a(new_n109_), .O(z7));
endmodule
