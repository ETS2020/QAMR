// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:41 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n75_), .b(new_n72_), .c(new_n71_), .O(new_n76_));
  inv1   g32(.a(x26), .O(new_n77_));
  nand3  g33(.a(new_n51_), .b(new_n77_), .c(x25), .O(new_n78_));
  inv1   g34(.a(new_n78_), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(new_n76_), .c(new_n68_), .O(new_n80_));
  inv1   g36(.a(new_n80_), .O(z3));
  inv1   g37(.a(x28), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(new_n68_), .O(new_n83_));
  inv1   g39(.a(new_n83_), .O(new_n84_));
  nand2  g40(.a(new_n82_), .b(new_n68_), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(new_n79_), .d(new_n76_), .O(new_n86_));
  ...
  nand4  g46(.a(new_n90_), .b(new_n88_), .c(new_n79_), .d(new_n76_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n93_), .c(new_n79_), .d(new_n76_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(z6));
  xor2a  g53(.a(new_n93_), .b(x31), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n79_), .c(new_n76_), .O(z7));
  zero   g55(.O(z8));
  zero   g56(.O(z9));
endmodule
