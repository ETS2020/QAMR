// Benchmark "FAU" written by ABC on Tue Jul 28 01:54:59 2020
...
module FAU ( 
  ...
  aoi21  g069(.a(new_n103_), .b(x14), .c(new_n105_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(x17), .O(new_n115_));
  nand2  g071(.a(x18), .b(x12), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n103_), .c(new_n104_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n109_), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n112_), .c(x15), .O(new_n119_));
  nand2  g075(.a(new_n82_), .b(x29), .O(new_n120_));
  xor2a  g076(.a(new_n120_), .b(new_n90_), .O(new_n121_));
  nor2   g077(.a(x32), .b(new_n95_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n121_), .c(new_n119_), .d(new_n108_), .O(new_n123_));
  nand3  g079(.a(new_n106_), .b(x16), .c(x15), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x19), .O(new_n126_));
  oai21  g082(.a(x19), .b(x14), .c(x31), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n113_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n126_), .c(new_n117_), .O(new_n129_));
  nand3  g085(.a(new_n121_), .b(new_n111_), .c(new_n108_), .O(new_n130_));
  nor2   g086(.a(z0), .b(x26), .O(new_n131_));
  oai21  g087(.a(new_n130_), .b(new_n129_), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n123_), .c(new_n101_), .O(z8));
  inv1   g089(.a(new_n120_), .O(new_n134_));
  nand2  g090(.a(new_n119_), .b(new_n108_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n97_), .c(new_n47_), .O(new_n136_));
  nand2  g092(.a(x33), .b(x31), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n134_), .O(new_n138_));
  nor2   g094(.a(new_n96_), .b(x33), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n119_), .c(new_n108_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  aoi21  g097(.a(new_n106_), .b(x11), .c(x16), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n102_), .c(new_n107_), .O(new_n143_));
  oai21  g099(.a(x18), .b(x13), .c(x17), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n116_), .O(new_n145_));
  nand2  g101(.a(new_n103_), .b(x14), .O(new_n146_));
  nand2  g102(.a(new_n125_), .b(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n124_), .b(new_n103_), .O(new_n148_));
  ...
  aoi21  g107(.a(new_n141_), .b(new_n120_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n74_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n138_), .c(new_n153_), .O(z9));
endmodule
