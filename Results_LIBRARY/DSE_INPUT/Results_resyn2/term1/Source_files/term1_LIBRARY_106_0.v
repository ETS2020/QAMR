...
module FAU ( 
  ...
  xnor2a g047(.a(x31), .b(x30), .O(new_n92_));
  oai21  g048(.a(new_n87_), .b(new_n86_), .c(new_n92_), .O(new_n93_));
  inv1   g049(.a(x31), .O(new_n94_));
  nand3  g050(.a(new_n81_), .b(new_n94_), .c(x30), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n72_), .O(z7));
  nand2  g053(.a(new_n70_), .b(x00), .O(new_n98_));
  nand2  g054(.a(new_n78_), .b(x29), .O(new_n99_));
  xor2a  g055(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  inv1   g056(.a(x17), .O(new_n101_));
  nand3  g057(.a(x19), .b(x18), .c(x12), .O(new_n102_));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n94_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n106_), .c(new_n103_), .d(new_n100_), .O(new_n110_));
  nand3  g066(.a(x18), .b(x17), .c(x15), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  inv1   g068(.a(x16), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x11), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n112_), .c(x19), .O(new_n115_));
  inv1   g071(.a(x15), .O(new_n116_));
  nand2  g072(.a(x19), .b(x18), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x17), .c(x10), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  oai21  g076(.a(new_n111_), .b(new_n108_), .c(new_n113_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n120_), .c(new_n115_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n110_), .c(x32), .O(new_n123_));
  nand2  g079(.a(new_n108_), .b(new_n107_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n106_), .c(new_n117_), .O(new_n125_));
  nand2  g081(.a(new_n103_), .b(x16), .O(new_n126_));
  aoi21  g082(.a(new_n125_), .b(x17), .c(new_n126_), .O(new_n127_));
  nor3   g083(.a(new_n114_), .b(new_n117_), .c(new_n101_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(x15), .O(new_n129_));
  inv1   g085(.a(new_n119_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x16), .c(new_n116_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nor2   g088(.a(x32), .b(new_n94_), .O(new_n133_));
  and2   g089(.a(new_n133_), .b(new_n100_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n123_), .c(new_n98_), .O(z8));
  xor2a  g092(.a(new_n99_), .b(x31), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n100_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  inv1   g096(.a(new_n98_), .O(new_n141_));
  nor2   g097(.a(new_n113_), .b(x14), .O(new_n142_));
  aoi21  g098(.a(new_n113_), .b(x11), .c(new_n108_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n112_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n137_), .c(new_n121_), .O(new_n145_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n119_), .c(new_n146_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n120_), .c(new_n92_), .d(x33), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n145_), .c(new_n141_), .O(new_n153_));
  aoi21  g109(.a(new_n140_), .b(new_n47_), .c(new_n153_), .O(z9));
endmodule
