...
module FAU ( 
  ...
  oai22  g058(.a(new_n102_), .b(new_n98_), .c(new_n100_), .d(new_n97_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n79_), .O(z7));
  oai21  g060(.a(x28), .b(x27), .c(x29), .O(new_n105_));
  xor2a  g061(.a(new_n105_), .b(new_n93_), .O(new_n106_));
  inv1   g062(.a(x15), .O(new_n107_));
  nand2  g063(.a(x18), .b(x17), .O(new_n108_));
  ...
  nor2   g069(.a(new_n113_), .b(new_n107_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n112_), .c(x19), .O(new_n115_));
  nand2  g071(.a(new_n112_), .b(x11), .O(new_n116_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n120_), .c(new_n117_), .d(new_n115_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n111_), .c(x32), .O(new_n125_));
  nand2  g081(.a(new_n114_), .b(x14), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n112_), .c(x19), .O(new_n128_));
  nand2  g084(.a(new_n122_), .b(new_n121_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n120_), .c(new_n108_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n117_), .O(new_n132_));
  nand4  g088(.a(new_n110_), .b(new_n106_), .c(z0), .d(x31), .O(new_n133_));
  ...
  aoi21  g092(.a(new_n135_), .b(new_n125_), .c(new_n136_), .O(z8));
  nor2   g093(.a(new_n106_), .b(new_n102_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n122_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n69_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n118_), .O(new_n141_));
  nand4  g097(.a(x19), .b(x18), .c(new_n118_), .d(x12), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n141_), .c(x16), .O(new_n144_));
  nand4  g100(.a(new_n112_), .b(x19), .c(new_n113_), .d(x11), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(new_n107_), .O(new_n146_));
  nor4   g102(.a(new_n109_), .b(new_n108_), .c(new_n69_), .d(x15), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(new_n138_), .O(new_n148_));
  inv1   g104(.a(new_n136_), .O(new_n149_));
  inv1   g105(.a(new_n138_), .O(new_n150_));
  nor2   g106(.a(new_n69_), .b(new_n118_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n114_), .c(x13), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n122_), .O(new_n153_));
  aoi21  g109(.a(x19), .b(x12), .c(x17), .O(new_n154_));
  oai21  g110(.a(x19), .b(x14), .c(x33), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n151_), .b(x11), .O(new_n157_));
  nand4  g113(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n158_));
  aoi22  g114(.a(new_n158_), .b(new_n107_), .c(new_n157_), .d(new_n113_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n156_), .c(new_n153_), .d(new_n115_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n150_), .c(new_n149_), .O(new_n161_));
  aoi21  g117(.a(new_n148_), .b(new_n47_), .c(new_n161_), .O(z9));
endmodule
