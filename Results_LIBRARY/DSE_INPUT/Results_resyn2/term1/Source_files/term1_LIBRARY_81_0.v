...
module FAU ( 
  ...
  aoi21  g034(.a(new_n78_), .b(new_n71_), .c(new_n68_), .O(new_n79_));
  ...
  inv1   g053(.a(new_n68_), .O(new_n98_));
  nand3  g054(.a(new_n76_), .b(x20), .c(new_n75_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n74_), .c(new_n71_), .O(new_n100_));
  xor2a  g056(.a(new_n95_), .b(x31), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(new_n98_), .O(z7));
  inv1   g058(.a(x19), .O(new_n103_));
  nand4  g059(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(new_n72_), .O(new_n105_));
  nand3  g061(.a(x18), .b(x17), .c(x11), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x19), .c(x16), .O(new_n108_));
  ...
  aoi21  g069(.a(new_n103_), .b(x14), .c(new_n113_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n112_), .c(x17), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n111_), .c(new_n75_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n108_), .c(x15), .O(new_n117_));
  aoi21  g073(.a(new_n82_), .b(new_n66_), .c(new_n89_), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(x30), .c(x31), .O(new_n119_));
  aoi21  g075(.a(new_n118_), .b(x30), .c(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n117_), .c(new_n105_), .O(new_n121_));
  inv1   g077(.a(x00), .O(new_n122_));
  nor2   g078(.a(x26), .b(new_n122_), .O(new_n123_));
  inv1   g079(.a(new_n108_), .O(new_n124_));
  nand4  g080(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n103_), .O(new_n126_));
  inv1   g082(.a(new_n112_), .O(new_n127_));
  nor2   g083(.a(x19), .b(x14), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(z0), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n127_), .c(new_n111_), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n120_), .c(new_n124_), .d(new_n105_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n123_), .O(new_n133_));
  aoi21  g089(.a(new_n121_), .b(z0), .c(new_n133_), .O(z8));
  nand2  g090(.a(x31), .b(x30), .O(new_n135_));
  and2   g091(.a(new_n135_), .b(new_n118_), .O(new_n136_));
  nor2   g092(.a(x31), .b(x30), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n118_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n117_), .c(new_n105_), .O(new_n140_));
  oai21  g096(.a(new_n107_), .b(x16), .c(x15), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n104_), .O(new_n142_));
  aoi21  g098(.a(x18), .b(x12), .c(x17), .O(new_n143_));
  nor2   g099(.a(x18), .b(x13), .O(new_n144_));
  nor4   g100(.a(new_n144_), .b(new_n143_), .c(new_n128_), .d(new_n47_), .O(new_n145_));
  nor2   g101(.a(new_n136_), .b(new_n126_), .O(new_n146_));
  aoi21  g102(.a(new_n125_), .b(new_n103_), .c(new_n138_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n142_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n123_), .O(new_n149_));
  aoi21  g105(.a(new_n140_), .b(new_n47_), .c(new_n149_), .O(z9));
endmodule
