// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:09 2020
...
module FAU ( 
  ...
  and2   g051(.a(x31), .b(x30), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  xor2a  g053(.a(new_n97_), .b(new_n94_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n76_), .O(z7));
  nand2  g055(.a(new_n74_), .b(x00), .O(new_n100_));
  ...
  nand3  g061(.a(new_n105_), .b(x19), .c(x16), .O(new_n106_));
  nand3  g062(.a(new_n105_), .b(x19), .c(x11), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(new_n102_), .c(new_n106_), .d(new_n101_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  inv1   g065(.a(new_n106_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g067(.a(new_n82_), .b(x29), .O(new_n112_));
  xor2a  g068(.a(new_n112_), .b(new_n90_), .O(new_n113_));
  inv1   g069(.a(x19), .O(new_n114_));
  nand2  g070(.a(x18), .b(x12), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n103_), .O(new_n116_));
  aoi21  g072(.a(x19), .b(x13), .c(x18), .O(new_n117_));
  oai21  g073(.a(x19), .b(x14), .c(x31), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n116_), .c(new_n113_), .d(new_n111_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n109_), .c(x32), .O(new_n121_));
  nand2  g077(.a(new_n106_), .b(new_n101_), .O(new_n122_));
  and2   g078(.a(new_n107_), .b(new_n102_), .O(new_n123_));
  aoi21  g079(.a(new_n114_), .b(x14), .c(new_n104_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n117_), .c(x17), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n116_), .c(new_n102_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n123_), .c(x15), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n122_), .O(new_n128_));
  nand3  g084(.a(new_n113_), .b(z0), .c(x31), .O(new_n129_));
  or2    g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n121_), .c(new_n100_), .O(z8));
  inv1   g087(.a(new_n112_), .O(new_n132_));
  inv1   g088(.a(new_n96_), .O(new_n133_));
  oai21  g089(.a(new_n128_), .b(new_n133_), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(x33), .b(x31), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n134_), .c(new_n132_), .O(new_n136_));
  nor3   g092(.a(x33), .b(x31), .c(x30), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n127_), .c(new_n122_), .O(new_n138_));
  ...
  aoi21  g097(.a(new_n114_), .b(x14), .c(new_n101_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n105_), .c(x16), .O(new_n143_));
  nor2   g099(.a(new_n105_), .b(x19), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n97_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n141_), .d(new_n108_), .O(new_n146_));
  and2   g102(.a(new_n146_), .b(x33), .O(new_n147_));
  aoi21  g103(.a(new_n139_), .b(new_n112_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n136_), .c(new_n100_), .O(z9));
endmodule
