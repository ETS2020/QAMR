...
module FAU ( 
  ...
  nand3  g071(.a(new_n115_), .b(new_n112_), .c(x18), .O(new_n116_));
  ...
  nand3  g075(.a(new_n102_), .b(x17), .c(x14), .O(new_n120_));
  nand3  g076(.a(x19), .b(new_n114_), .c(x12), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n110_), .O(new_n122_));
  nand4  g078(.a(x19), .b(x17), .c(new_n110_), .d(x11), .O(new_n123_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n101_), .c(z0), .d(x18), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n119_), .c(new_n97_), .O(z8));
  nand2  g086(.a(new_n128_), .b(x18), .O(new_n131_));
  ...
  nand4  g093(.a(new_n47_), .b(x31), .c(x30), .d(x18), .O(new_n138_));
