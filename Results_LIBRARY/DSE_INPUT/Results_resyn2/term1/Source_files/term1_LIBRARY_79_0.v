...
module FAU ( 
  ...
  nand3  g061(.a(new_n105_), .b(x16), .c(x15), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x19), .O(new_n108_));
  nand3  g064(.a(new_n85_), .b(x30), .c(x29), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n108_), .c(new_n102_), .O(new_n110_));
  inv1   g066(.a(x15), .O(new_n111_));
  nand4  g067(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n69_), .c(new_n111_), .O(new_n113_));
  inv1   g069(.a(x16), .O(new_n114_));
  nand3  g070(.a(new_n105_), .b(x19), .c(x11), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g072(.a(x19), .b(x18), .c(x12), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n103_), .O(new_n118_));
  nand2  g074(.a(x19), .b(x13), .O(new_n119_));
  inv1   g075(.a(x14), .O(new_n120_));
  nand2  g076(.a(new_n69_), .b(new_n120_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x31), .O(new_n122_));
  aoi21  g078(.a(new_n119_), .b(new_n104_), .c(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n118_), .c(new_n116_), .d(new_n113_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n110_), .c(x32), .O(new_n125_));
  inv1   g081(.a(new_n118_), .O(new_n126_));
  nand2  g082(.a(new_n119_), .b(new_n104_), .O(new_n127_));
  nand2  g083(.a(x19), .b(x18), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n121_), .c(new_n127_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x17), .c(new_n126_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n114_), .c(new_n116_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x15), .O(new_n132_));
  nand2  g088(.a(new_n109_), .b(x31), .O(new_n133_));
  nand3  g089(.a(new_n113_), .b(new_n102_), .c(z0), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g092(.a(new_n77_), .b(x00), .O(new_n137_));
  aoi21  g093(.a(new_n136_), .b(new_n125_), .c(new_n137_), .O(z8));
  nand2  g094(.a(new_n105_), .b(x11), .O(new_n139_));
  ...
  nand2  g100(.a(new_n112_), .b(new_n111_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n133_), .c(new_n108_), .O(new_n146_));
  inv1   g102(.a(x31), .O(new_n147_));
  nand2  g103(.a(new_n102_), .b(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n106_), .b(new_n120_), .c(new_n69_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nor2   g106(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n144_), .c(new_n137_), .O(z9));
endmodule
