...
module FAU ( 
  ...
  nor2   g062(.a(new_n69_), .b(new_n106_), .O(new_n107_));
  ...
  nand3  g066(.a(x19), .b(x17), .c(x11), .O(new_n111_));
  ...
  nand2  g071(.a(x19), .b(x18), .O(new_n116_));
  nand2  g072(.a(x19), .b(x13), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n105_), .O(new_n118_));
  inv1   g074(.a(x14), .O(new_n119_));
  nand2  g075(.a(new_n69_), .b(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n118_), .c(new_n116_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(x17), .c(new_n115_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n110_), .c(new_n112_), .O(new_n123_));
  ...
  and2   g082(.a(new_n126_), .b(x31), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n124_), .c(new_n109_), .O(new_n128_));
  nand3  g084(.a(new_n107_), .b(x16), .c(x15), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x18), .O(new_n131_));
  inv1   g087(.a(new_n120_), .O(new_n132_));
  nor3   g088(.a(new_n132_), .b(z0), .c(new_n98_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n118_), .d(new_n114_), .O(new_n134_));
  nand3  g090(.a(new_n126_), .b(new_n112_), .c(new_n109_), .O(new_n135_));
  inv1   g091(.a(x00), .O(new_n136_));
  nor2   g092(.a(x26), .b(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n128_), .b(z0), .c(new_n138_), .O(z8));
  aoi21  g095(.a(x31), .b(x30), .c(new_n125_), .O(new_n140_));
  aoi21  g096(.a(new_n125_), .b(new_n99_), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n124_), .c(new_n109_), .O(new_n142_));
  nand2  g098(.a(x16), .b(x15), .O(new_n143_));
  aoi21  g099(.a(new_n116_), .b(x13), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n106_), .c(x12), .O(new_n145_));
  oai21  g101(.a(new_n144_), .b(new_n106_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n111_), .b(new_n110_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x15), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n108_), .O(new_n149_));
  nor3   g105(.a(new_n140_), .b(new_n132_), .c(new_n47_), .O(new_n150_));
  aoi22  g106(.a(new_n129_), .b(new_n105_), .c(new_n125_), .d(new_n99_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n146_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n137_), .O(new_n153_));
  aoi21  g109(.a(new_n142_), .b(new_n47_), .c(new_n153_), .O(z9));
endmodule
