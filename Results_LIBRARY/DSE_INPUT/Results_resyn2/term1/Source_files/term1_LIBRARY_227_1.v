...
module FAU ( 
  ...
  oai21  g025(.a(x24), .b(x19), .c(x26), .O(new_n70_));
  ...
  aoi21  g072(.a(new_n116_), .b(x19), .c(x16), .O(new_n117_));
  inv1   g073(.a(x16), .O(new_n118_));
  inv1   g074(.a(x17), .O(new_n119_));
  nand3  g075(.a(x19), .b(x18), .c(x12), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g077(.a(x19), .b(x13), .c(x18), .O(new_n122_));
  aoi21  g078(.a(new_n112_), .b(x14), .c(new_n74_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(x17), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(new_n118_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n117_), .c(x15), .O(new_n126_));
  ...
  nand3  g104(.a(new_n148_), .b(new_n126_), .c(new_n114_), .O(new_n149_));
  oai21  g105(.a(new_n116_), .b(x16), .c(x15), .O(new_n150_));
  ...
  aoi21  g111(.a(new_n134_), .b(new_n112_), .c(new_n147_), .O(new_n156_));
