...
module FAU ( 
  ...
  or2    g054(.a(new_n98_), .b(new_n85_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n94_), .c(new_n76_), .O(z7));
  nand2  g056(.a(new_n74_), .b(x00), .O(new_n101_));
  nand2  g057(.a(new_n82_), .b(x29), .O(new_n102_));
  inv1   g058(.a(x19), .O(new_n103_));
  nand4  g059(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n103_), .c(x15), .O(new_n105_));
  inv1   g061(.a(x15), .O(new_n106_));
  inv1   g062(.a(x16), .O(new_n107_));
  nand4  g063(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n108_));
  ...
  nand2  g069(.a(new_n103_), .b(new_n113_), .O(new_n114_));
  nand2  g070(.a(x19), .b(x18), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n114_), .c(new_n112_), .d(x17), .O(new_n116_));
  ...
  nand3  g076(.a(new_n120_), .b(new_n116_), .c(x16), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n109_), .c(new_n105_), .O(new_n122_));
  inv1   g078(.a(new_n95_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(z0), .O(new_n124_));
  oai22  g080(.a(new_n124_), .b(new_n122_), .c(z0), .d(x30), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n102_), .O(new_n126_));
  and2   g082(.a(x19), .b(x18), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n117_), .c(new_n107_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n116_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n109_), .c(new_n105_), .O(new_n130_));
  nand2  g086(.a(x31), .b(new_n90_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(z0), .O(new_n132_));
  aoi21  g088(.a(x32), .b(new_n90_), .c(new_n102_), .O(new_n133_));
  nand2  g089(.a(new_n118_), .b(new_n117_), .O(new_n134_));
  ...
  nor2   g094(.a(new_n138_), .b(new_n96_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n137_), .c(new_n134_), .d(new_n112_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  inv1   g097(.a(new_n104_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x19), .O(new_n143_));
  aoi22  g099(.a(new_n108_), .b(new_n107_), .c(new_n143_), .d(new_n106_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(z0), .O(new_n145_));
  aoi21  g101(.a(new_n133_), .b(new_n132_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n126_), .c(new_n101_), .O(z8));
  inv1   g103(.a(new_n102_), .O(new_n148_));
  nand2  g104(.a(new_n123_), .b(new_n47_), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n122_), .c(new_n47_), .d(x31), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  oai21  g107(.a(new_n130_), .b(new_n97_), .c(new_n47_), .O(new_n152_));
  aoi21  g108(.a(x33), .b(new_n96_), .c(new_n148_), .O(new_n153_));
  nand3  g109(.a(x18), .b(x17), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n107_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n104_), .O(new_n157_));
  nand2  g113(.a(x18), .b(x12), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n117_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  aoi21  g116(.a(new_n110_), .b(new_n160_), .c(new_n138_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n159_), .c(new_n98_), .O(new_n162_));
  nand2  g118(.a(new_n135_), .b(new_n103_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n137_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n157_), .c(new_n47_), .O(new_n166_));
  aoi21  g122(.a(new_n153_), .b(new_n152_), .c(new_n166_), .O(new_n167_));
