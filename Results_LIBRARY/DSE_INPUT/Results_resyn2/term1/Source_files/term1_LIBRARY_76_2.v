...
module FAU ( 
  ...
  nand3  g062(.a(new_n106_), .b(x17), .c(x14), .O(new_n107_));
  nand4  g063(.a(z0), .b(x31), .c(new_n90_), .d(x18), .O(new_n108_));
  oai22  g064(.a(new_n108_), .b(new_n107_), .c(z0), .d(new_n90_), .O(new_n109_));
  nand3  g065(.a(new_n106_), .b(x18), .c(x17), .O(new_n110_));
  inv1   g066(.a(x11), .O(new_n111_));
  nand2  g067(.a(new_n105_), .b(new_n111_), .O(new_n112_));
  or2    g068(.a(x18), .b(x13), .O(new_n113_));
  nor2   g069(.a(x17), .b(x12), .O(new_n114_));
  nor2   g070(.a(x15), .b(x10), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n113_), .c(new_n112_), .d(new_n110_), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(x19), .c(new_n109_), .d(new_n103_), .O(new_n118_));
  nand4  g074(.a(z0), .b(x31), .c(x30), .d(x18), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n107_), .c(z0), .d(x30), .O(new_n120_));
  nand2  g076(.a(new_n106_), .b(x17), .O(new_n121_));
  nand2  g077(.a(x19), .b(x18), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  inv1   g079(.a(x19), .O(new_n124_));
  nand2  g080(.a(x18), .b(x14), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  inv1   g082(.a(x17), .O(new_n127_));
  oai21  g083(.a(new_n105_), .b(new_n104_), .c(new_n127_), .O(new_n128_));
  aoi21  g084(.a(new_n105_), .b(new_n104_), .c(new_n96_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n123_), .O(new_n130_));
  aoi22  g086(.a(new_n130_), .b(x32), .c(new_n120_), .d(new_n102_), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n118_), .c(new_n101_), .O(z8));
  nand4  g088(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n133_));
  and2   g089(.a(new_n133_), .b(new_n105_), .O(new_n134_));
  nand3  g090(.a(x19), .b(x18), .c(x17), .O(new_n135_));
  nand2  g091(.a(x19), .b(x13), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n125_), .c(x17), .O(new_n137_));
  nand3  g093(.a(x19), .b(x18), .c(x12), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n127_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n137_), .c(new_n135_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(x16), .c(new_n134_), .O(new_n141_));
  nand2  g097(.a(x16), .b(x10), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n135_), .c(new_n104_), .O(new_n143_));
  and2   g099(.a(new_n143_), .b(new_n47_), .O(new_n144_));
  oai21  g100(.a(new_n141_), .b(new_n104_), .c(new_n144_), .O(new_n145_));
  oai22  g101(.a(new_n145_), .b(new_n95_), .c(new_n47_), .d(x31), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n103_), .O(new_n147_));
  nand2  g103(.a(x33), .b(x31), .O(new_n148_));
  oai21  g104(.a(new_n145_), .b(new_n97_), .c(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n126_), .b(new_n113_), .c(new_n98_), .O(new_n150_));
  oai21  g106(.a(new_n122_), .b(new_n121_), .c(new_n139_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  inv1   g108(.a(new_n134_), .O(new_n153_));
  and2   g109(.a(new_n143_), .b(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n152_), .c(new_n47_), .O(new_n155_));
  aoi21  g111(.a(new_n149_), .b(new_n102_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n147_), .c(new_n101_), .O(z9));
endmodule
