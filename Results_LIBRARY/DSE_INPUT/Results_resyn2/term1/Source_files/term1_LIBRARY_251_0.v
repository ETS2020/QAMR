...
module FAU ( 
  ...
  nand3  g070(.a(new_n114_), .b(new_n111_), .c(new_n108_), .O(new_n115_));
  ...
  nand3  g075(.a(new_n118_), .b(x16), .c(x15), .O(new_n120_));
  inv1   g076(.a(x14), .O(new_n121_));
  nand2  g077(.a(new_n69_), .b(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  aoi21  g079(.a(new_n119_), .b(new_n117_), .c(new_n123_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n85_), .b(x29), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n93_), .c(new_n98_), .O(new_n127_));
  oai21  g083(.a(new_n126_), .b(new_n93_), .c(new_n127_), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n116_), .c(new_n104_), .O(z8));
  inv1   g086(.a(new_n111_), .O(new_n131_));
  nand2  g087(.a(x19), .b(x18), .O(new_n132_));
  nand3  g088(.a(new_n122_), .b(new_n114_), .c(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(x17), .c(new_n131_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n106_), .c(new_n108_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x15), .O(new_n136_));
  nand2  g092(.a(new_n119_), .b(new_n117_), .O(new_n137_));
  inv1   g093(.a(new_n126_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n100_), .O(new_n139_));
  nand2  g095(.a(new_n126_), .b(new_n99_), .O(new_n140_));
  ...
  inv1   g099(.a(new_n104_), .O(new_n144_));
  nand2  g100(.a(new_n138_), .b(new_n98_), .O(new_n145_));
  nand2  g101(.a(new_n126_), .b(x31), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n101_), .c(x33), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n124_), .d(new_n116_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  aoi21  g106(.a(new_n143_), .b(new_n47_), .c(new_n150_), .O(z9));
endmodule
