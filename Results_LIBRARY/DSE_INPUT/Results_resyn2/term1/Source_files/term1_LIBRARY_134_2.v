...
module FAU ( 
  ...
  nand2  g053(.a(new_n82_), .b(x29), .O(new_n98_));
  ...
  aoi21  g067(.a(new_n101_), .b(x14), .c(new_n103_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(x17), .O(new_n113_));
  nand2  g069(.a(x18), .b(x12), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n101_), .c(new_n102_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n107_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n110_), .c(x15), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n106_), .O(new_n118_));
  nand2  g074(.a(z0), .b(x31), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n118_), .c(new_n91_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n98_), .b(new_n91_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(new_n115_), .d(new_n109_), .O(new_n125_));
  nand2  g081(.a(new_n104_), .b(x15), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x16), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n101_), .c(new_n106_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n125_), .c(x32), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n121_), .c(new_n97_), .O(z8));
  nand3  g087(.a(new_n117_), .b(new_n106_), .c(new_n47_), .O(new_n132_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n99_), .O(new_n136_));
  nand2  g092(.a(new_n132_), .b(new_n91_), .O(new_n137_));
  aoi21  g093(.a(new_n134_), .b(new_n91_), .c(x33), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n99_), .O(new_n139_));
  oai21  g095(.a(new_n127_), .b(x19), .c(x16), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n108_), .O(new_n141_));
  nand2  g097(.a(new_n101_), .b(x14), .O(new_n142_));
  inv1   g098(.a(new_n128_), .O(new_n143_));
  nand2  g099(.a(new_n105_), .b(new_n100_), .O(new_n144_));
  nand2  g100(.a(new_n114_), .b(new_n102_), .O(new_n145_));
  nand2  g101(.a(x31), .b(new_n91_), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  nand2  g103(.a(new_n103_), .b(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n145_), .d(new_n144_), .O(new_n149_));
  ...
  aoi21  g108(.a(new_n152_), .b(new_n136_), .c(new_n97_), .O(z9));
endmodule
