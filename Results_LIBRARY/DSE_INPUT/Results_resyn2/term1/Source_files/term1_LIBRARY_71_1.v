...
module FAU ( 
  ...
  nand3  g062(.a(x19), .b(x17), .c(x11), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g064(.a(new_n76_), .b(x18), .c(x17), .d(x14), .O(new_n109_));
  inv1   g065(.a(x17), .O(new_n110_));
  nand3  g066(.a(x19), .b(new_n110_), .c(x12), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n109_), .c(x16), .O(new_n112_));
  ...
  nand3  g074(.a(x17), .b(x16), .c(x15), .O(new_n119_));
  ...
  nand3  g090(.a(new_n126_), .b(new_n105_), .c(x18), .O(new_n135_));
