...
module FAU ( 
  ...
  inv1   g056(.a(x16), .O(new_n101_));
  inv1   g057(.a(x17), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x18), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(x19), .c(new_n100_), .O(new_n105_));
  nor2   g061(.a(x18), .b(x13), .O(new_n106_));
  nor2   g062(.a(x17), .b(x12), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  oai21  g064(.a(x16), .b(x11), .c(new_n108_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n105_), .c(x15), .O(new_n110_));
  aoi21  g066(.a(new_n79_), .b(new_n66_), .c(new_n86_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(x30), .O(new_n112_));
  nand2  g068(.a(new_n102_), .b(new_n101_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(x15), .O(new_n115_));
  nand2  g071(.a(x19), .b(x18), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n115_), .c(new_n102_), .d(new_n101_), .O(new_n117_));
  aoi21  g073(.a(x19), .b(x10), .c(x15), .O(new_n118_));
  aoi21  g074(.a(x19), .b(x15), .c(x18), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g076(.a(new_n111_), .b(x30), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n120_), .c(new_n117_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n114_), .c(new_n112_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(x26), .c(new_n110_), .O(new_n124_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n102_), .O(new_n130_));
  nand4  g086(.a(x19), .b(x18), .c(new_n102_), .d(x12), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  inv1   g089(.a(new_n116_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(x17), .c(new_n101_), .d(x11), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n115_), .O(new_n136_));
  inv1   g092(.a(x10), .O(new_n137_));
  nor2   g093(.a(x15), .b(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n103_), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n116_), .c(x26), .O(new_n140_));
  inv1   g096(.a(x31), .O(new_n141_));
  nand2  g097(.a(new_n82_), .b(x29), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n90_), .O(new_n143_));
  nor4   g099(.a(new_n143_), .b(new_n112_), .c(x32), .d(new_n141_), .O(new_n144_));
  oai21  g100(.a(new_n140_), .b(new_n136_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n125_), .c(new_n98_), .O(z8));
  nand2  g102(.a(x33), .b(new_n141_), .O(new_n147_));
  nor2   g103(.a(new_n141_), .b(new_n90_), .O(new_n148_));
  nor2   g104(.a(new_n116_), .b(x33), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n138_), .c(new_n103_), .d(new_n148_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n147_), .c(x26), .O(new_n151_));
  nand3  g107(.a(new_n148_), .b(new_n47_), .c(x15), .O(new_n152_));
  aoi21  g108(.a(new_n135_), .b(new_n133_), .c(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(new_n111_), .O(new_n154_));
  nand2  g110(.a(x33), .b(x31), .O(new_n155_));
  nor2   g111(.a(x31), .b(x30), .O(new_n156_));
  nand4  g112(.a(new_n149_), .b(new_n138_), .c(new_n103_), .d(new_n156_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(x26), .O(new_n158_));
  nand3  g114(.a(new_n156_), .b(new_n47_), .c(x15), .O(new_n159_));
  aoi21  g115(.a(new_n135_), .b(new_n133_), .c(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(new_n142_), .O(new_n161_));
  nor2   g117(.a(new_n104_), .b(new_n100_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n109_), .c(x15), .O(new_n163_));
  inv1   g119(.a(new_n117_), .O(new_n164_));
  nand3  g120(.a(new_n120_), .b(new_n113_), .c(new_n95_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n164_), .c(new_n74_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x33), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n161_), .c(new_n154_), .O(new_n169_));
  and2   g125(.a(new_n169_), .b(x00), .O(z9));
endmodule
