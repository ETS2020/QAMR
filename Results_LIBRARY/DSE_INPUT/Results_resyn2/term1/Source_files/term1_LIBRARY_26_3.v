...
module FAU ( 
  ...
  oai21  g022(.a(x22), .b(x17), .c(x24), .O(new_n67_));
  ...
  aoi21  g054(.a(new_n77_), .b(new_n66_), .c(new_n84_), .O(new_n99_));
  ...
  nand3  g058(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g059(.a(x16), .b(x10), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(new_n105_));
  inv1   g061(.a(x16), .O(new_n106_));
  inv1   g062(.a(new_n103_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x11), .c(x16), .O(new_n108_));
  ...
  nand2  g071(.a(x19), .b(x13), .O(new_n116_));
  ...
  aoi21  g077(.a(new_n121_), .b(x17), .c(new_n113_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n106_), .c(new_n109_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x15), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n105_), .c(new_n101_), .O(new_n125_));
  nand3  g081(.a(new_n107_), .b(x16), .c(x15), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n120_), .c(new_n105_), .O(new_n127_));
  nand3  g083(.a(new_n117_), .b(new_n112_), .c(x32), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n109_), .c(new_n101_), .O(new_n130_));
  ...
  aoi21  g089(.a(new_n125_), .b(z0), .c(new_n133_), .O(z8));
  nand2  g090(.a(new_n99_), .b(x30), .O(new_n135_));
  nand2  g091(.a(new_n80_), .b(x29), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(x31), .O(new_n137_));
  aoi21  g093(.a(new_n135_), .b(new_n94_), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n124_), .c(new_n105_), .O(new_n139_));
  nand2  g095(.a(new_n136_), .b(x31), .O(new_n140_));
  nor2   g096(.a(new_n137_), .b(new_n113_), .O(new_n141_));
  nand3  g097(.a(new_n117_), .b(new_n96_), .c(x33), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n108_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n141_), .c(new_n140_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n127_), .c(new_n132_), .O(new_n145_));
  aoi21  g101(.a(new_n139_), .b(new_n47_), .c(new_n145_), .O(z9));
endmodule
