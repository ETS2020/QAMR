...
module FAU ( 
  ...
  oai22  g023(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n68_));
  ...
  nand2  g056(.a(x19), .b(x10), .O(new_n101_));
  ...
  nand2  g064(.a(x19), .b(x12), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g066(.a(x14), .O(new_n111_));
  oai21  g067(.a(x19), .b(new_n111_), .c(x17), .O(new_n112_));
