// Benchmark "FAU" written by ABC on Tue Jul 28 01:54:55 2020
...
module FAU ( 
  ...
  nand4  g060(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n102_), .c(new_n104_), .d(new_n103_), .O(new_n106_));
  ...
  oai21  g072(.a(new_n99_), .b(new_n102_), .c(x19), .O(new_n117_));
  nand2  g073(.a(new_n103_), .b(x14), .O(new_n118_));
  inv1   g074(.a(x17), .O(new_n119_));
  inv1   g075(.a(x18), .O(new_n120_));
  aoi21  g076(.a(x19), .b(new_n120_), .c(new_n119_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n116_), .c(x32), .O(new_n124_));
  nand3  g080(.a(new_n103_), .b(x18), .c(x14), .O(new_n125_));
  nand3  g081(.a(x19), .b(new_n120_), .c(x13), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n125_), .c(new_n119_), .O(new_n127_));
  nand2  g083(.a(x19), .b(x18), .O(new_n128_));
  nand3  g084(.a(new_n74_), .b(new_n119_), .c(x12), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  inv1   g087(.a(new_n128_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(x17), .c(new_n99_), .d(x11), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(new_n102_), .O(new_n134_));
  nand2  g090(.a(x16), .b(x10), .O(new_n135_));
  nor4   g091(.a(new_n128_), .b(new_n135_), .c(new_n119_), .d(x15), .O(new_n136_));
  inv1   g092(.a(x31), .O(new_n137_));
  nor3   g093(.a(new_n110_), .b(x32), .c(new_n137_), .O(new_n138_));
  oai21  g094(.a(new_n136_), .b(new_n134_), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n124_), .c(new_n98_), .O(z8));
  inv1   g096(.a(new_n109_), .O(new_n141_));
  nor2   g097(.a(new_n137_), .b(new_n90_), .O(new_n142_));
  nor2   g098(.a(new_n128_), .b(x33), .O(new_n143_));
  nand4  g099(.a(new_n119_), .b(x16), .c(x15), .d(x12), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  oai21  g102(.a(new_n47_), .b(x31), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n74_), .O(new_n148_));
  aoi21  g104(.a(new_n126_), .b(new_n125_), .c(new_n99_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n99_), .d(x11), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(x15), .O(new_n152_));
  nand4  g108(.a(new_n132_), .b(x16), .c(new_n102_), .d(x10), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n142_), .c(new_n47_), .d(x17), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n148_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n141_), .O(new_n157_));
  nor2   g113(.a(x31), .b(x30), .O(new_n158_));
  nand3  g114(.a(new_n145_), .b(new_n143_), .c(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n47_), .b(new_n137_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n74_), .O(new_n161_));
  nand2  g117(.a(new_n158_), .b(x17), .O(new_n162_));
  ...
  inv1   g121(.a(new_n104_), .O(new_n166_));
  nand2  g122(.a(new_n118_), .b(new_n166_), .O(new_n167_));
