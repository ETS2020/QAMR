...
module FAU ( 
  ...
  nand2  g037(.a(new_n81_), .b(new_n66_), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(z3));
  inv1   g039(.a(x28), .O(new_n84_));
  nor2   g040(.a(new_n84_), .b(new_n66_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(new_n86_));
  nand2  g042(.a(new_n84_), .b(new_n66_), .O(new_n87_));
  ...
  nor2   g054(.a(new_n95_), .b(new_n91_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  oai22  g056(.a(new_n100_), .b(x31), .c(new_n80_), .d(x28), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x27), .O(new_n102_));
  oai21  g058(.a(new_n100_), .b(new_n66_), .c(x31), .O(new_n103_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n70_), .c(new_n105_), .O(new_n110_));
  ...
  aoi21  g071(.a(new_n70_), .b(x14), .c(new_n107_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(x17), .O(new_n117_));
  nand2  g073(.a(x18), .b(x12), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n70_), .c(new_n106_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n117_), .c(new_n111_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n114_), .c(x15), .O(new_n121_));
  nand3  g077(.a(z0), .b(x31), .c(new_n95_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(new_n110_), .O(new_n124_));
  ...
  nand2  g086(.a(new_n119_), .b(new_n117_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n113_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(x15), .c(new_n130_), .O(new_n134_));
  inv1   g090(.a(x31), .O(new_n135_));
  nand3  g091(.a(new_n127_), .b(z0), .c(x30), .O(new_n136_));
  aoi21  g092(.a(new_n87_), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  nor2   g093(.a(x19), .b(x14), .O(new_n138_));
  nor3   g094(.a(new_n138_), .b(new_n115_), .c(new_n135_), .O(new_n139_));
  nand2  g095(.a(new_n127_), .b(new_n95_), .O(new_n140_));
  nand4  g096(.a(new_n108_), .b(x19), .c(x16), .d(x15), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n119_), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  and2   g099(.a(new_n113_), .b(new_n110_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(z0), .O(new_n145_));
  aoi21  g101(.a(new_n137_), .b(new_n134_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n77_), .b(x00), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(new_n129_), .c(new_n147_), .O(z8));
  nand3  g104(.a(new_n135_), .b(new_n95_), .c(new_n91_), .O(new_n149_));
  oai21  g105(.a(x31), .b(new_n84_), .c(x30), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n127_), .c(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n134_), .O(new_n152_));
  aoi21  g108(.a(new_n108_), .b(x11), .c(x16), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n105_), .c(new_n109_), .O(new_n154_));
  nand2  g110(.a(new_n87_), .b(x33), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(new_n138_), .O(new_n156_));
  and2   g112(.a(new_n156_), .b(new_n141_), .O(new_n157_));
  oai21  g113(.a(x18), .b(x13), .c(x17), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n118_), .O(new_n159_));
  nand3  g115(.a(new_n108_), .b(x16), .c(x15), .O(new_n160_));
  nand2  g116(.a(new_n99_), .b(x31), .O(new_n161_));
  aoi22  g117(.a(new_n161_), .b(new_n149_), .c(new_n160_), .d(new_n70_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n77_), .c(x00), .O(new_n164_));
  aoi21  g120(.a(new_n152_), .b(new_n47_), .c(new_n164_), .O(z9));
endmodule
