...
module FAU ( 
  ...
  oai21  g054(.a(new_n97_), .b(new_n93_), .c(new_n98_), .O(new_n99_));
  inv1   g055(.a(x31), .O(new_n100_));
  nand3  g056(.a(new_n88_), .b(new_n100_), .c(x30), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n79_), .O(z7));
  inv1   g059(.a(x15), .O(new_n104_));
  aoi21  g060(.a(x19), .b(x13), .c(x18), .O(new_n105_));
  inv1   g061(.a(x18), .O(new_n106_));
  aoi21  g062(.a(new_n69_), .b(x14), .c(new_n106_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n105_), .c(x17), .O(new_n108_));
  ...
  nor2   g069(.a(new_n113_), .b(x16), .O(new_n114_));
  aoi21  g070(.a(new_n112_), .b(new_n108_), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g075(.a(new_n115_), .b(new_n104_), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(new_n85_), .b(x29), .O(new_n121_));
  xor2a  g077(.a(new_n121_), .b(new_n93_), .O(new_n122_));
  and2   g078(.a(new_n122_), .b(x31), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  inv1   g080(.a(x00), .O(new_n125_));
  nor2   g081(.a(x26), .b(new_n125_), .O(new_n126_));
  inv1   g082(.a(new_n105_), .O(new_n127_));
  nand2  g083(.a(new_n111_), .b(new_n110_), .O(new_n128_));
  nor2   g084(.a(new_n109_), .b(new_n104_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n116_), .O(new_n130_));
  nor2   g086(.a(x19), .b(x14), .O(new_n131_));
  nor3   g087(.a(new_n131_), .b(z0), .c(new_n100_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n130_), .c(new_n128_), .d(new_n127_), .O(new_n133_));
  nor2   g089(.a(new_n129_), .b(new_n116_), .O(new_n134_));
  aoi21  g090(.a(new_n117_), .b(new_n104_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n122_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n133_), .c(new_n126_), .O(new_n137_));
  aoi21  g093(.a(new_n124_), .b(z0), .c(new_n137_), .O(z8));
  xor2a  g094(.a(new_n121_), .b(x31), .O(new_n139_));
  ...
  aoi21  g099(.a(new_n69_), .b(x14), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n129_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n135_), .c(new_n98_), .d(x33), .O(new_n146_));
  aoi22  g102(.a(x18), .b(x12), .c(x17), .d(x13), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n69_), .c(new_n143_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n139_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n146_), .c(new_n126_), .O(new_n150_));
  aoi21  g106(.a(new_n142_), .b(new_n47_), .c(new_n150_), .O(z9));
endmodule
