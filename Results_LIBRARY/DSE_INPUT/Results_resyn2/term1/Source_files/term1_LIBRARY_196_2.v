...
module FAU ( 
  ...
  nor2   g005(.a(x03), .b(x02), .O(new_n50_));
  inv1   g006(.a(x02), .O(new_n51_));
  inv1   g007(.a(x03), .O(new_n52_));
  oai21  g008(.a(new_n52_), .b(new_n51_), .c(x01), .O(new_n53_));
  nor2   g009(.a(new_n53_), .b(new_n50_), .O(new_n54_));
  inv1   g010(.a(x06), .O(new_n55_));
  nor2   g011(.a(new_n55_), .b(x02), .O(new_n56_));
  inv1   g012(.a(x05), .O(new_n57_));
  nor2   g013(.a(new_n57_), .b(x03), .O(new_n58_));
  nand2  g014(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  aoi22  g015(.a(new_n55_), .b(new_n57_), .c(x03), .d(x02), .O(new_n60_));
  aoi21  g016(.a(new_n60_), .b(new_n59_), .c(x01), .O(new_n61_));
  xor2a  g017(.a(x07), .b(x04), .O(new_n62_));
  oai21  g018(.a(new_n61_), .b(new_n54_), .c(new_n62_), .O(new_n63_));
  nor2   g019(.a(new_n58_), .b(new_n56_), .O(new_n64_));
  nor2   g020(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  nor2   g021(.a(new_n62_), .b(new_n54_), .O(new_n66_));
  oai21  g022(.a(new_n65_), .b(x01), .c(new_n66_), .O(new_n67_));
  nor2   g023(.a(new_n56_), .b(x07), .O(new_n68_));
  inv1   g024(.a(x07), .O(new_n69_));
  nor2   g025(.a(x04), .b(x01), .O(new_n70_));
  oai21  g026(.a(new_n69_), .b(x02), .c(new_n70_), .O(new_n71_));
  nor2   g027(.a(new_n56_), .b(new_n69_), .O(new_n72_));
  nand2  g028(.a(new_n69_), .b(new_n51_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(x04), .c(new_n52_), .O(new_n74_));
  oai22  g030(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(new_n68_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  nor2   g032(.a(new_n58_), .b(x07), .O(new_n77_));
  oai21  g033(.a(new_n69_), .b(x03), .c(new_n70_), .O(new_n78_));
  nor2   g034(.a(new_n58_), .b(new_n69_), .O(new_n79_));
  nand2  g035(.a(new_n69_), .b(new_n52_), .O(new_n80_));
  nand3  g036(.a(new_n80_), .b(x04), .c(new_n51_), .O(new_n81_));
  oai22  g037(.a(new_n81_), .b(new_n79_), .c(new_n78_), .d(new_n77_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n55_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n76_), .c(new_n67_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  inv1   g041(.a(x09), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(x08), .O(new_n87_));
  aoi21  g043(.a(new_n85_), .b(new_n63_), .c(new_n87_), .O(z2));
  ...
  oai21  g050(.a(x22), .b(x17), .c(new_n94_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n91_), .c(new_n90_), .O(new_n96_));
  inv1   g052(.a(x26), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x25), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n96_), .c(new_n53_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n89_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(z3));
  inv1   g057(.a(x28), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n89_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n102_), .b(new_n89_), .O(new_n105_));
  ...
  aoi21  g097(.a(new_n102_), .b(new_n89_), .c(new_n109_), .O(new_n142_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n97_), .c(x00), .O(new_n154_));
  aoi21  g110(.a(new_n145_), .b(z0), .c(new_n154_), .O(z8));
  nand2  g111(.a(new_n97_), .b(x00), .O(new_n156_));
  nand2  g112(.a(new_n141_), .b(new_n130_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n120_), .c(new_n47_), .O(new_n158_));
  nand2  g114(.a(x33), .b(x31), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n158_), .c(new_n142_), .O(new_n160_));
  inv1   g116(.a(new_n142_), .O(new_n161_));
  nor2   g117(.a(new_n119_), .b(x33), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n141_), .c(new_n130_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  aoi21  g120(.a(new_n128_), .b(x11), .c(x16), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n124_), .c(new_n129_), .O(new_n166_));
  oai21  g122(.a(x18), .b(x13), .c(x17), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n135_), .O(new_n168_));
  nand2  g124(.a(new_n125_), .b(x14), .O(new_n169_));
  nand2  g125(.a(new_n147_), .b(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n146_), .b(new_n125_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n168_), .d(new_n121_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n166_), .c(new_n47_), .O(new_n174_));
  aoi21  g130(.a(new_n164_), .b(new_n161_), .c(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n160_), .c(new_n156_), .O(z9));
endmodule
