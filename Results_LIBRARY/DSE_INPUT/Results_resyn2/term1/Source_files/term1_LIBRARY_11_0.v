...
module FAU ( 
  ...
  nor2   g091(.a(x26), .b(new_n135_), .O(new_n136_));
  oai21  g092(.a(new_n134_), .b(new_n131_), .c(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n129_), .b(z0), .c(new_n137_), .O(z8));
  nand2  g094(.a(new_n104_), .b(x30), .O(new_n139_));
  nand2  g095(.a(new_n85_), .b(x29), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(x31), .O(new_n141_));
  aoi21  g097(.a(new_n139_), .b(new_n99_), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n128_), .c(new_n110_), .O(new_n143_));
  nand2  g099(.a(new_n140_), .b(x31), .O(new_n144_));
  nor2   g100(.a(new_n141_), .b(new_n118_), .O(new_n145_));
  nand3  g101(.a(new_n122_), .b(new_n101_), .c(x33), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n113_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n145_), .c(new_n144_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n131_), .c(new_n136_), .O(new_n149_));
