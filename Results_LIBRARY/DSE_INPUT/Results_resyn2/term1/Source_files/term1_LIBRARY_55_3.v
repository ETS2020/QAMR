...
module FAU ( 
  ...
  aoi21  g061(.a(new_n105_), .b(x10), .c(x15), .O(new_n106_));
  nand3  g062(.a(new_n105_), .b(x15), .c(x11), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n102_), .c(new_n107_), .O(new_n108_));
  inv1   g064(.a(x19), .O(new_n109_));
  inv1   g065(.a(x15), .O(new_n110_));
  nor2   g066(.a(new_n102_), .b(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n105_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand2  g069(.a(new_n109_), .b(x14), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n111_), .c(new_n105_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n113_), .c(new_n108_), .O(new_n116_));
  nand2  g072(.a(new_n82_), .b(x29), .O(new_n117_));
  xor2a  g073(.a(new_n117_), .b(x30), .O(new_n118_));
  inv1   g074(.a(x12), .O(new_n119_));
  nand2  g075(.a(new_n103_), .b(new_n119_), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(x18), .c(x17), .d(x13), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  or2    g079(.a(new_n123_), .b(new_n118_), .O(new_n124_));
  nor2   g080(.a(z0), .b(x26), .O(new_n125_));
  oai21  g081(.a(new_n124_), .b(new_n116_), .c(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n74_), .b(x17), .O(new_n127_));
  nand3  g083(.a(new_n109_), .b(x18), .c(x14), .O(new_n128_));
  nand3  g084(.a(x19), .b(new_n104_), .c(x13), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nor2   g086(.a(new_n109_), .b(new_n104_), .O(new_n131_));
  nor2   g087(.a(x17), .b(new_n119_), .O(new_n132_));
  ...
  nand3  g091(.a(new_n131_), .b(new_n74_), .c(x17), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n102_), .c(x11), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n135_), .c(new_n110_), .O(new_n139_));
  nand3  g095(.a(x16), .b(new_n110_), .c(x10), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nor3   g097(.a(new_n118_), .b(x32), .c(new_n96_), .O(new_n142_));
  oai21  g098(.a(new_n141_), .b(new_n139_), .c(new_n142_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n126_), .c(new_n101_), .O(z8));
  aoi21  g100(.a(new_n129_), .b(new_n128_), .c(new_n102_), .O(new_n145_));
  nand4  g101(.a(x19), .b(x18), .c(new_n102_), .d(x11), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(x15), .O(new_n148_));
  inv1   g104(.a(new_n140_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n131_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g107(.a(new_n97_), .b(new_n47_), .c(x17), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(new_n151_), .c(x33), .d(new_n96_), .O(new_n154_));
  or2    g110(.a(new_n121_), .b(new_n98_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n116_), .c(x33), .O(new_n156_));
  oai21  g112(.a(new_n154_), .b(new_n117_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n74_), .O(new_n158_));
  nand2  g114(.a(new_n95_), .b(x17), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n151_), .c(x33), .O(new_n161_));
  oai21  g117(.a(new_n47_), .b(x31), .c(new_n74_), .O(new_n162_));
  nand2  g118(.a(new_n132_), .b(new_n111_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n131_), .c(new_n95_), .d(new_n47_), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n161_), .c(new_n165_), .O(new_n166_));
  nand3  g122(.a(new_n164_), .b(new_n131_), .c(new_n47_), .O(new_n167_));
  nor4   g123(.a(new_n167_), .b(new_n117_), .c(new_n96_), .d(new_n90_), .O(new_n168_));
  aoi21  g124(.a(new_n166_), .b(new_n117_), .c(new_n168_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n158_), .c(new_n101_), .O(z9));
endmodule
