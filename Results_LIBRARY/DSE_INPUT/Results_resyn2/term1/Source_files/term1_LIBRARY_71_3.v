...
module FAU ( 
  ...
  or2    g26(.a(x20), .b(x15), .O(new_n71_));
  ...
  nand2  g54(.a(x23), .b(x19), .O(new_n99_));
  ...
  nand2  g59(.a(x18), .b(x14), .O(new_n104_));
  oai21  g60(.a(x18), .b(x13), .c(x19), .O(new_n105_));
  ...
  nand2  g68(.a(x19), .b(x13), .O(new_n113_));
