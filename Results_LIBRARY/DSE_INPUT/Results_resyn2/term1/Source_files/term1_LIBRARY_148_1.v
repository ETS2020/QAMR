...
module FAU ( 
  ...
  nand4  g059(.a(x19), .b(x18), .c(x17), .d(x10), .O(new_n104_));
  ...
  nand4  g064(.a(new_n76_), .b(x18), .c(x16), .d(x14), .O(new_n109_));
  ...
  nand3  g082(.a(x32), .b(x31), .c(x16), .O(new_n127_));
  ...
  nand3  g090(.a(new_n126_), .b(new_n105_), .c(x16), .O(new_n135_));
