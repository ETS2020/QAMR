// Benchmark "FAU" written by ABC on Tue Jul 28 01:55:56 2020
...
module FAU ( 
  ...
  nor2   g050(.a(new_n87_), .b(x30), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n94_), .c(new_n78_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z6));
  inv1   g053(.a(x31), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(x30), .O(new_n99_));
  nand2  g055(.a(x31), .b(new_n92_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  oai22  g057(.a(new_n101_), .b(new_n94_), .c(new_n99_), .d(new_n93_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n78_), .O(z7));
  nand2  g059(.a(new_n76_), .b(x00), .O(new_n104_));
  inv1   g060(.a(x16), .O(new_n105_));
  nand3  g061(.a(x19), .b(x18), .c(x11), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  inv1   g063(.a(x17), .O(new_n108_));
  nand4  g064(.a(x19), .b(x18), .c(x16), .d(x15), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g066(.a(x15), .O(new_n111_));
  nand4  g067(.a(x19), .b(x18), .c(x16), .d(x10), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n110_), .c(new_n107_), .O(new_n114_));
  oai21  g070(.a(x28), .b(x27), .c(x29), .O(new_n115_));
  xor2a  g071(.a(new_n115_), .b(new_n92_), .O(new_n116_));
  nor2   g072(.a(new_n105_), .b(new_n111_), .O(new_n117_));
  ...
  oai21  g077(.a(x19), .b(x14), .c(x31), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n116_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n114_), .c(x32), .O(new_n125_));
  nand2  g081(.a(x19), .b(x18), .O(new_n126_));
  oai21  g082(.a(x19), .b(x14), .c(x17), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n121_), .c(new_n126_), .O(new_n128_));
  and2   g084(.a(new_n118_), .b(x16), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand3  g086(.a(new_n119_), .b(new_n105_), .c(x11), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n111_), .O(new_n132_));
  nand3  g088(.a(x16), .b(new_n111_), .c(x10), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n118_), .O(new_n134_));
  xor2a  g090(.a(new_n115_), .b(x30), .O(new_n135_));
  nand2  g091(.a(z0), .b(x31), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  oai21  g093(.a(new_n134_), .b(new_n132_), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n125_), .c(new_n104_), .O(z8));
  nand3  g095(.a(new_n135_), .b(new_n100_), .c(new_n99_), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  oai21  g097(.a(new_n134_), .b(new_n132_), .c(new_n141_), .O(new_n142_));
  inv1   g098(.a(new_n104_), .O(new_n143_));
  aoi21  g099(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n144_));
  and2   g100(.a(new_n113_), .b(new_n107_), .O(new_n145_));
  inv1   g101(.a(x19), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x14), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n117_), .c(x18), .d(x17), .O(new_n148_));
  nand2  g104(.a(new_n121_), .b(new_n106_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n148_), .c(new_n145_), .d(new_n144_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n140_), .c(new_n143_), .O(new_n151_));
  aoi21  g107(.a(new_n142_), .b(new_n47_), .c(new_n151_), .O(z9));
endmodule
