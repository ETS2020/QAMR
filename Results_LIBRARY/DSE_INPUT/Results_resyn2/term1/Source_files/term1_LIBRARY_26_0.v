...
module FAU ( 
  ...
  or2    g021(.a(new_n65_), .b(x25), .O(new_n66_));
  nor2   g022(.a(x22), .b(x17), .O(new_n67_));
  nor2   g023(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  ...
  or2    g058(.a(x31), .b(x30), .O(new_n103_));
  ...
  nand2  g062(.a(new_n93_), .b(x25), .O(new_n107_));
  aoi21  g063(.a(new_n94_), .b(x31), .c(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n106_), .c(new_n75_), .O(z7));
  ...
  oai21  g070(.a(new_n114_), .b(new_n69_), .c(new_n110_), .O(new_n115_));
  inv1   g071(.a(x16), .O(new_n116_));
  nand3  g072(.a(new_n113_), .b(x18), .c(x11), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g074(.a(x19), .b(x13), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n69_), .O(new_n120_));
  nand2  g076(.a(x19), .b(x18), .O(new_n121_));
  inv1   g077(.a(x14), .O(new_n122_));
  nand2  g078(.a(new_n112_), .b(new_n122_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(new_n124_));
  nand3  g080(.a(x19), .b(x18), .c(x12), .O(new_n125_));
  and2   g081(.a(new_n125_), .b(new_n111_), .O(new_n126_));
  aoi21  g082(.a(new_n124_), .b(x17), .c(new_n126_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n116_), .c(new_n118_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x15), .O(new_n129_));
  aoi21  g085(.a(new_n84_), .b(new_n63_), .c(new_n90_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(x30), .c(x31), .O(new_n131_));
  aoi21  g087(.a(new_n130_), .b(x30), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n129_), .c(new_n115_), .O(new_n133_));
  inv1   g089(.a(x26), .O(new_n134_));
  nand3  g090(.a(new_n113_), .b(x16), .c(x15), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n69_), .O(new_n136_));
  nand3  g092(.a(new_n123_), .b(new_n120_), .c(x32), .O(new_n137_));
  nor3   g093(.a(new_n137_), .b(new_n136_), .c(new_n126_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n132_), .c(new_n118_), .d(new_n115_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n134_), .c(x00), .O(new_n140_));
  aoi21  g096(.a(new_n133_), .b(z0), .c(new_n140_), .O(z8));
  nand2  g097(.a(new_n134_), .b(x00), .O(new_n142_));
  inv1   g098(.a(x33), .O(new_n143_));
  nand2  g099(.a(new_n129_), .b(new_n115_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n102_), .c(new_n143_), .O(new_n145_));
  nand2  g101(.a(x33), .b(x31), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n145_), .c(new_n130_), .O(new_n147_));
  inv1   g103(.a(new_n130_), .O(new_n148_));
  nor2   g104(.a(new_n103_), .b(x33), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n129_), .c(new_n115_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  aoi21  g107(.a(new_n113_), .b(x11), .c(x16), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n110_), .c(new_n114_), .O(new_n153_));
  inv1   g109(.a(new_n135_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x18), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  oai21  g112(.a(new_n135_), .b(new_n156_), .c(new_n69_), .O(new_n157_));
  nand2  g113(.a(x19), .b(x12), .O(new_n158_));
  nand2  g114(.a(new_n123_), .b(x17), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n157_), .c(new_n155_), .d(new_n104_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n153_), .c(new_n143_), .O(new_n163_));
  aoi21  g119(.a(new_n151_), .b(new_n148_), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n147_), .c(new_n142_), .O(z9));
endmodule
