...
module FAU ( 
  ...
  oai21  g050(.a(new_n74_), .b(new_n73_), .c(new_n94_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  nand2  g052(.a(x31), .b(x30), .O(new_n97_));
  inv1   g053(.a(x31), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  or2    g056(.a(new_n100_), .b(new_n85_), .O(new_n101_));
  aoi21  g057(.a(new_n85_), .b(x31), .c(new_n68_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n101_), .c(new_n96_), .O(z7));
  inv1   g059(.a(x15), .O(new_n104_));
  inv1   g060(.a(x18), .O(new_n105_));
  inv1   g061(.a(x17), .O(new_n106_));
  nor2   g062(.a(new_n72_), .b(new_n106_), .O(new_n107_));
  ...
  nand3  g066(.a(new_n107_), .b(x18), .c(x11), .O(new_n111_));
  ...
  nand2  g071(.a(new_n72_), .b(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n114_), .c(new_n94_), .O(new_n117_));
  nand3  g073(.a(x19), .b(x18), .c(x12), .O(new_n118_));
  and2   g074(.a(new_n118_), .b(new_n106_), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(x17), .c(new_n119_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n110_), .c(new_n112_), .O(new_n121_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n109_), .O(new_n126_));
  nand3  g082(.a(new_n107_), .b(x16), .c(x15), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n105_), .O(new_n128_));
  nand3  g084(.a(new_n116_), .b(new_n114_), .c(x32), .O(new_n129_));
  nor3   g085(.a(new_n129_), .b(new_n128_), .c(new_n119_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n112_), .d(new_n109_), .O(new_n131_));
  ...
  nand2  g090(.a(new_n122_), .b(new_n109_), .O(new_n135_));
  ...
  nor2   g095(.a(new_n99_), .b(x33), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n122_), .c(new_n109_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  aoi21  g098(.a(new_n107_), .b(x11), .c(x16), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n104_), .c(new_n108_), .O(new_n144_));
  inv1   g100(.a(new_n127_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x18), .O(new_n146_));
  inv1   g102(.a(x13), .O(new_n147_));
  oai21  g103(.a(new_n127_), .b(new_n147_), .c(new_n105_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x12), .O(new_n149_));
  nand2  g105(.a(new_n116_), .b(x17), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n148_), .c(new_n146_), .d(new_n100_), .O(new_n152_));
