// Benchmark "FAU" written by ABC on Tue Jul 28 01:56:14 2020
...
module FAU ( 
  ...
  nand2  g074(.a(new_n103_), .b(x14), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x18), .O(new_n120_));
  aoi21  g076(.a(new_n118_), .b(x19), .c(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n116_), .c(x32), .O(new_n122_));
  inv1   g078(.a(x17), .O(new_n123_));
  nand3  g079(.a(new_n103_), .b(x18), .c(x14), .O(new_n124_));
  inv1   g080(.a(x18), .O(new_n125_));
  nand4  g081(.a(new_n74_), .b(x19), .c(new_n125_), .d(x13), .O(new_n126_));
  ...
  nand4  g086(.a(x19), .b(x17), .c(new_n99_), .d(x11), .O(new_n131_));
  ...
  nand3  g099(.a(new_n47_), .b(x19), .c(new_n125_), .O(new_n144_));
  ...
  oai21  g106(.a(x19), .b(x17), .c(x16), .O(new_n151_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n145_), .c(new_n47_), .d(x18), .O(new_n155_));
  ...
  nand2  g117(.a(new_n158_), .b(x18), .O(new_n162_));
