...
module FAU ( 
  ...
  oai22  g052(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n96_), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n71_), .c(new_n68_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n95_), .O(z7));
  inv1   g055(.a(x19), .O(new_n100_));
  nand4  g056(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(new_n102_));
  ...
  aoi21  g066(.a(new_n100_), .b(x14), .c(new_n110_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n109_), .c(x17), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n108_), .c(new_n72_), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n105_), .c(x15), .O(new_n114_));
  ...
  nand3  g073(.a(new_n117_), .b(new_n114_), .c(new_n102_), .O(new_n118_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n117_), .c(new_n121_), .d(new_n102_), .O(new_n129_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n114_), .c(new_n102_), .O(new_n137_));
  oai21  g093(.a(new_n104_), .b(x16), .c(x15), .O(new_n138_));
  ...
  aoi21  g099(.a(new_n122_), .b(new_n100_), .c(new_n135_), .O(new_n144_));
