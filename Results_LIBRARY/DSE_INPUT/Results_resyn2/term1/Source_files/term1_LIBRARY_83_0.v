...
module FAU ( 
  ...
  nand4  g059(.a(x19), .b(x17), .c(x16), .d(x15), .O(new_n104_));
  xnor2a g060(.a(new_n104_), .b(x18), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  oai21  g062(.a(x28), .b(x27), .c(x29), .O(new_n107_));
  xor2a  g063(.a(new_n107_), .b(new_n92_), .O(new_n108_));
  inv1   g064(.a(x17), .O(new_n109_));
  nand2  g065(.a(x19), .b(x12), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nor2   g067(.a(x19), .b(x14), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n98_), .O(new_n113_));
  inv1   g069(.a(x15), .O(new_n114_));
  inv1   g070(.a(x16), .O(new_n115_));
  nand4  g071(.a(x19), .b(x17), .c(x16), .d(x10), .O(new_n116_));
  nand3  g072(.a(x19), .b(x17), .c(x11), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(new_n115_), .c(new_n116_), .d(new_n114_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n113_), .c(new_n111_), .d(new_n108_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n106_), .c(x32), .O(new_n120_));
  aoi21  g076(.a(x18), .b(x14), .c(x19), .O(new_n121_));
  nand3  g077(.a(x19), .b(x18), .c(x12), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n109_), .c(new_n122_), .O(new_n123_));
  nand3  g079(.a(x19), .b(x18), .c(x17), .O(new_n124_));
  and2   g080(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  inv1   g082(.a(new_n124_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n115_), .c(x11), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n126_), .c(new_n114_), .O(new_n129_));
  nand3  g085(.a(x16), .b(new_n114_), .c(x10), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n124_), .O(new_n131_));
  xor2a  g087(.a(new_n107_), .b(x30), .O(new_n132_));
  ...
  nor2   g093(.a(new_n108_), .b(new_n101_), .O(new_n138_));
  oai21  g094(.a(new_n131_), .b(new_n129_), .c(new_n138_), .O(new_n139_));
  inv1   g095(.a(new_n136_), .O(new_n140_));
  nand2  g096(.a(new_n117_), .b(new_n115_), .O(new_n141_));
  aoi21  g097(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n142_));
  nand3  g098(.a(new_n117_), .b(new_n110_), .c(new_n109_), .O(new_n143_));
  nand4  g099(.a(new_n112_), .b(x17), .c(x16), .d(x15), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n132_), .b(new_n105_), .c(new_n100_), .d(new_n99_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(new_n140_), .O(new_n147_));
  aoi21  g103(.a(new_n139_), .b(new_n47_), .c(new_n147_), .O(z9));
endmodule
