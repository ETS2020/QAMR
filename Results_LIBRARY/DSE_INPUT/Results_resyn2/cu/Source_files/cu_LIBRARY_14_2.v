...
module FAU ( 
  ...
  nand3  g35(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n59_), .c(new_n30_), .O(z06));
  nand2  g39(.a(new_n37_), .b(new_n36_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n28_), .O(z07));
  nand2  g41(.a(x04), .b(new_n60_), .O(new_n67_));
  aoi21  g42(.a(new_n61_), .b(new_n57_), .c(new_n67_), .O(z08));
  and2   g43(.a(x13), .b(x06), .O(z09));
  nand2  g44(.a(x05), .b(x02), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x06), .c(new_n60_), .O(new_n71_));
