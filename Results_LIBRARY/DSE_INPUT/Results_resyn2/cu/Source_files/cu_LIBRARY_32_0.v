// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:12 2020
...
module FAU ( 
  ...
  nand3  g34(.a(new_n59_), .b(new_n55_), .c(new_n50_), .O(new_n60_));
  inv1   g35(.a(x03), .O(new_n61_));
  nand2  g36(.a(x04), .b(new_n61_), .O(new_n62_));
  aoi21  g37(.a(new_n60_), .b(new_n45_), .c(new_n62_), .O(z06));
  nand2  g38(.a(new_n37_), .b(new_n36_), .O(new_n64_));
  nor2   g39(.a(new_n64_), .b(new_n28_), .O(z07));
  nand4  g40(.a(x13), .b(new_n57_), .c(x05), .d(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n45_), .c(new_n62_), .O(z08));
