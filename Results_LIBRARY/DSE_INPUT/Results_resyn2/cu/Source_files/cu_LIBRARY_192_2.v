// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:21 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n53_, new_n54_, new_n55_, new_n56_, new_n61_, new_n62_;
  ...
  oai21  g19(.a(new_n44_), .b(x00), .c(x01), .O(new_n45_));
  inv1   g20(.a(x08), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n41_), .c(new_n39_), .O(new_n47_));
  inv1   g22(.a(x09), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(x00), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n47_), .c(new_n45_), .O(new_n50_));
  inv1   g25(.a(x12), .O(new_n51_));
  nand4  g26(.a(x13), .b(new_n51_), .c(x05), .d(new_n26_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x07), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n50_), .O(new_n54_));
  nand3  g29(.a(new_n36_), .b(new_n31_), .c(x02), .O(new_n55_));
  nand2  g30(.a(x04), .b(new_n35_), .O(new_n56_));
  aoi21  g31(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z06));
  inv1   g32(.a(new_n37_), .O(z07));
  aoi21  g33(.a(new_n55_), .b(new_n52_), .c(new_n56_), .O(z08));
  and2   g34(.a(x13), .b(x06), .O(z09));
  nand2  g35(.a(x05), .b(x02), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x06), .c(new_n35_), .O(new_n62_));
