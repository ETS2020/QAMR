// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:39 2020
...
module FAU ( 
  ...
  oai21  g21(.a(new_n36_), .b(x11), .c(x01), .O(new_n47_));
  aoi21  g22(.a(x09), .b(new_n43_), .c(new_n34_), .O(new_n48_));
  nand2  g23(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g24(.a(x10), .b(x01), .O(new_n50_));
  nand2  g25(.a(x08), .b(new_n43_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n50_), .c(x13), .d(new_n34_), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(new_n49_), .O(new_n53_));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n54_), .c(x05), .d(new_n26_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(new_n53_), .O(new_n58_));
  nand2  g33(.a(x04), .b(new_n35_), .O(new_n59_));
  aoi21  g34(.a(new_n58_), .b(new_n46_), .c(new_n59_), .O(z06));
  nand4  g35(.a(x13), .b(new_n55_), .c(x05), .d(new_n26_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n46_), .c(new_n59_), .O(z08));
