// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:01 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n36_,
  ...
  inv1   g08(.a(x03), .O(new_n36_));
  inv1   g09(.a(x13), .O(new_n37_));
  inv1   g10(.a(new_n28_), .O(new_n38_));
  nand4  g11(.a(new_n38_), .b(new_n37_), .c(x05), .d(new_n36_), .O(new_n39_));
  nor2   g12(.a(new_n39_), .b(x00), .O(z04));
  inv1   g13(.a(x00), .O(new_n41_));
  nor2   g14(.a(new_n39_), .b(new_n41_), .O(z05));
  nand3  g15(.a(new_n37_), .b(new_n30_), .c(x02), .O(new_n43_));
  inv1   g16(.a(x07), .O(new_n44_));
  nor2   g17(.a(x10), .b(x00), .O(new_n45_));
