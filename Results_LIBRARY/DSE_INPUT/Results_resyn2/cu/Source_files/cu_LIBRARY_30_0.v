// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:11 2020
...
module FAU ( 
  ...
  nand3  g19(.a(new_n44_), .b(new_n40_), .c(new_n38_), .O(new_n45_));
  ...
  nand3  g25(.a(new_n50_), .b(x01), .c(new_n38_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  nand4  g29(.a(x13), .b(new_n54_), .c(new_n53_), .d(new_n27_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  oai21  g31(.a(new_n52_), .b(new_n49_), .c(new_n56_), .O(new_n57_));
  nand2  g32(.a(x04), .b(new_n34_), .O(new_n58_));
  aoi21  g33(.a(new_n57_), .b(new_n43_), .c(new_n58_), .O(z06));
  inv1   g34(.a(new_n36_), .O(z07));
  nand4  g35(.a(x13), .b(new_n54_), .c(x05), .d(new_n27_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n43_), .c(new_n58_), .O(z08));
  and2   g37(.a(x13), .b(x06), .O(z09));
  nand2  g38(.a(x05), .b(x02), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x06), .c(new_n34_), .O(new_n65_));
