...
module FAU ( 
  ...
  or2    g25(.a(x13), .b(x05), .O(new_n55_));
  nand2  g26(.a(x04), .b(new_n29_), .O(new_n56_));
  aoi21  g27(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z06));
  nand3  g28(.a(new_n51_), .b(x05), .c(new_n27_), .O(new_n59_));
  aoi21  g29(.a(new_n55_), .b(new_n59_), .c(new_n56_), .O(z08));
  and2   g30(.a(x13), .b(x06), .O(z09));
  nand2  g31(.a(x05), .b(x02), .O(new_n62_));
  nand3  g32(.a(new_n62_), .b(x06), .c(new_n29_), .O(new_n63_));
