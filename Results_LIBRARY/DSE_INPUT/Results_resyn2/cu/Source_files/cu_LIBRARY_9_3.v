// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:05 2020
...
module FAU ( 
  ...
  nand4  g21(.a(x13), .b(new_n46_), .c(x05), .d(new_n26_), .O(new_n47_));
  inv1   g22(.a(x03), .O(new_n48_));
  nand2  g23(.a(x04), .b(new_n48_), .O(new_n49_));
  aoi21  g24(.a(new_n47_), .b(new_n45_), .c(new_n49_), .O(z08));
  nand2  g25(.a(x11), .b(x01), .O(new_n51_));
  nand2  g26(.a(x09), .b(new_n42_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n51_), .c(x00), .O(new_n53_));
  nand2  g28(.a(x10), .b(x01), .O(new_n54_));
  nand2  g29(.a(x08), .b(new_n42_), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(new_n54_), .c(new_n35_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n53_), .c(new_n45_), .O(new_n57_));
  and2   g32(.a(new_n57_), .b(z08), .O(z06));
  ...
  nand3  g37(.a(new_n62_), .b(x06), .c(new_n48_), .O(new_n63_));
