...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n63_, new_n65_, new_n66_, new_n69_, new_n70_;
  ...
  nand3  g33(.a(new_n58_), .b(new_n55_), .c(new_n50_), .O(new_n59_));
  inv1   g34(.a(x03), .O(new_n60_));
  nand2  g35(.a(x04), .b(new_n60_), .O(new_n61_));
  aoi21  g36(.a(new_n59_), .b(new_n45_), .c(new_n61_), .O(z06));
  nand2  g37(.a(new_n37_), .b(new_n36_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n28_), .O(z07));
  inv1   g39(.a(x12), .O(new_n65_));
  nand4  g40(.a(x13), .b(new_n65_), .c(x05), .d(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n45_), .c(new_n61_), .O(z08));
  and2   g42(.a(x13), .b(x06), .O(z09));
  nand2  g43(.a(x05), .b(x02), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x06), .c(new_n60_), .O(new_n70_));
