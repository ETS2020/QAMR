...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(new_n27_), .c(new_n36_), .d(new_n26_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n35_), .c(new_n34_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z02));
  and2   g16(.a(x05), .b(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(new_n38_), .c(x01), .O(z03));
  nand3  g19(.a(new_n39_), .b(x01), .c(new_n34_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z04));
  nor3   g21(.a(new_n43_), .b(new_n38_), .c(new_n35_), .O(z05));
  nand3  g22(.a(new_n37_), .b(new_n30_), .c(x02), .O(new_n48_));
  nand2  g23(.a(x09), .b(new_n35_), .O(new_n49_));
  nand2  g24(.a(x11), .b(x01), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(new_n51_));
  nand2  g26(.a(x10), .b(x01), .O(new_n52_));
  nand2  g27(.a(x08), .b(new_n35_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(new_n54_));
  ...
  aoi21  g37(.a(new_n30_), .b(x00), .c(new_n38_), .O(z07));
  ...
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n36_), .O(new_n68_));
