// Benchmark "FAU" written by ABC on Mon Jul 27 20:52:04 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n61_, new_n63_, new_n64_, new_n67_, new_n68_;
  ...
  nand2  g33(.a(x04), .b(new_n58_), .O(new_n59_));
  aoi21  g34(.a(new_n57_), .b(new_n45_), .c(new_n59_), .O(z06));
  nand2  g35(.a(new_n37_), .b(new_n36_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n28_), .O(z07));
  inv1   g37(.a(x12), .O(new_n63_));
  nand4  g38(.a(x13), .b(new_n63_), .c(x05), .d(new_n26_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n45_), .c(new_n59_), .O(z08));
  and2   g40(.a(x13), .b(x06), .O(z09));
  nand2  g41(.a(x05), .b(x02), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n58_), .O(new_n68_));
