...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n61_, new_n62_, new_n63_, new_n65_, new_n68_;
  ...
  nand4  g12(.a(new_n37_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n38_));
  inv1   g13(.a(new_n38_), .O(z07));
  nand3  g14(.a(z07), .b(new_n36_), .c(new_n35_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z02));
  nand3  g16(.a(z07), .b(new_n36_), .c(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z03));
  nand3  g18(.a(z07), .b(x01), .c(new_n35_), .O(new_n44_));
  ...
  nor2   g24(.a(new_n31_), .b(x03), .O(new_n50_));
  nor2   g25(.a(new_n37_), .b(x12), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n52_));
  ...
  nand2  g35(.a(new_n60_), .b(new_n36_), .O(new_n61_));
  ...
  nand2  g39(.a(new_n51_), .b(new_n50_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(new_n29_), .O(z08));
