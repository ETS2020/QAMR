// Benchmark "FAU" written by ABC on Mon Jul 27 20:51:07 2020
...
module FAU ( 
  ...
  oai21  g07(.a(x13), .b(x05), .c(new_n29_), .O(new_n33_));
  ...
  nand3  g34(.a(new_n59_), .b(new_n54_), .c(new_n49_), .O(new_n60_));
  nand2  g35(.a(new_n27_), .b(x02), .O(new_n61_));
  nand2  g36(.a(x04), .b(new_n26_), .O(new_n62_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(z06));
  nor3   g38(.a(new_n30_), .b(x13), .c(x03), .O(z07));
  nand3  g39(.a(x13), .b(new_n57_), .c(new_n55_), .O(new_n65_));
  aoi21  g40(.a(new_n61_), .b(new_n65_), .c(new_n62_), .O(z08));
