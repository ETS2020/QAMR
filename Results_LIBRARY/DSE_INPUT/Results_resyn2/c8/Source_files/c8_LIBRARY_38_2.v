...
module FAU ( 
  ...
  nand2  g53(.a(new_n94_), .b(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n93_), .b(x23), .c(new_n76_), .O(new_n101_));
  oai21  g55(.a(x18), .b(new_n60_), .c(new_n76_), .O(new_n102_));
  aoi21  g56(.a(x18), .b(x04), .c(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(new_n100_), .c(new_n103_), .O(z13));
  oai21  g58(.a(new_n93_), .b(x23), .c(x24), .O(new_n105_));
  inv1   g59(.a(x24), .O(new_n106_));
  aoi21  g60(.a(new_n94_), .b(new_n106_), .c(new_n76_), .O(new_n107_));
  oai21  g61(.a(x18), .b(new_n63_), .c(new_n76_), .O(new_n108_));
  aoi21  g62(.a(x18), .b(x05), .c(new_n108_), .O(new_n109_));
  aoi21  g63(.a(new_n107_), .b(new_n105_), .c(new_n109_), .O(z14));
  nor2   g64(.a(x24), .b(x22), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n86_), .c(new_n77_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x21), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n111_), .c(new_n77_), .d(new_n80_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n111_), .c(new_n86_), .d(new_n77_), .O(new_n123_));
  ...
  nand4  g84(.a(new_n130_), .b(new_n122_), .c(new_n111_), .d(new_n86_), .O(new_n131_));
