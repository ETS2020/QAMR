// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:03 2020
...
module FAU ( 
  ...
  nor2   g74(.a(new_n120_), .b(new_n88_), .O(new_n121_));
  aoi21  g75(.a(new_n111_), .b(x25), .c(new_n121_), .O(new_n122_));
  ...
  oai21  g79(.a(new_n120_), .b(new_n88_), .c(x26), .O(new_n126_));
  inv1   g80(.a(x26), .O(new_n127_));
  aoi21  g81(.a(new_n121_), .b(new_n127_), .c(new_n76_), .O(new_n128_));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  nand3  g83(.a(new_n129_), .b(new_n76_), .c(new_n69_), .O(new_n130_));
  inv1   g84(.a(new_n130_), .O(new_n131_));
  aoi21  g85(.a(new_n128_), .b(new_n126_), .c(new_n131_), .O(z16));
  nand2  g86(.a(x27), .b(x17), .O(new_n133_));
  inv1   g87(.a(new_n120_), .O(new_n134_));
  nor2   g88(.a(new_n47_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n99_), .d(new_n127_), .O(new_n136_));
  aoi21  g90(.a(new_n136_), .b(new_n133_), .c(new_n76_), .O(z17));
  buf    g91(.a(x27), .O(z08));
endmodule
