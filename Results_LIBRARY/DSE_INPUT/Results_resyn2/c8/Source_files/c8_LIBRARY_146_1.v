// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:41 2020
...
module FAU ( 
  ...
  nand3  g79(.a(new_n121_), .b(new_n89_), .c(new_n69_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n102_), .c(new_n99_), .d(new_n77_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(x26), .c(new_n76_), .O(new_n129_));
  nor3   g83(.a(x18), .b(x16), .c(x15), .O(new_n130_));
  aoi21  g84(.a(new_n129_), .b(new_n126_), .c(new_n130_), .O(z16));
  nand2  g85(.a(x27), .b(x17), .O(new_n132_));
  nor2   g86(.a(new_n47_), .b(x17), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n121_), .c(new_n99_), .d(new_n69_), .O(new_n134_));
