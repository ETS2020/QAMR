...
module FAU ( 
  ...
  oai21  g58(.a(x24), .b(x23), .c(new_n91_), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n86_), .c(new_n77_), .O(new_n106_));
  nand3  g60(.a(new_n86_), .b(new_n77_), .c(new_n99_), .O(new_n107_));
  ...
  nand3  g68(.a(new_n114_), .b(new_n86_), .c(new_n77_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x25), .O(new_n116_));
  nor2   g70(.a(x25), .b(x21), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n114_), .c(new_n77_), .d(new_n80_), .O(new_n118_));
  ...
  nand2  g77(.a(new_n118_), .b(x26), .O(new_n124_));
  nor2   g78(.a(x26), .b(x25), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n114_), .c(new_n86_), .d(new_n77_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x16), .O(new_n128_));
  aoi21  g82(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n129_));
  oai21  g83(.a(new_n73_), .b(x07), .c(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(z16));
  nand2  g85(.a(x27), .b(x17), .O(new_n132_));
  nor2   g86(.a(new_n47_), .b(x17), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n125_), .c(new_n114_), .d(new_n86_), .O(new_n134_));
