...
module FAU ( 
  ...
  xor2a  g33(.a(new_n77_), .b(x20), .O(new_n80_));
  nand2  g34(.a(new_n80_), .b(x16), .O(new_n81_));
  nand2  g35(.a(x18), .b(x01), .O(new_n82_));
  nand3  g36(.a(new_n73_), .b(new_n76_), .c(x09), .O(new_n83_));
  nand3  g37(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z10));
  inv1   g38(.a(x21), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n50_), .c(new_n85_), .O(new_n86_));
  inv1   g40(.a(x17), .O(new_n87_));
  nand4  g41(.a(new_n85_), .b(new_n50_), .c(new_n47_), .d(new_n87_), .O(new_n88_));
