// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:36 2020
...
module FAU ( 
  ...
  nor2   g76(.a(x18), .b(new_n66_), .O(new_n123_));
  inv1   g77(.a(x06), .O(new_n124_));
  nor2   g78(.a(x16), .b(new_n124_), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(x18), .c(new_n123_), .O(new_n126_));
  oai21  g80(.a(new_n122_), .b(new_n76_), .c(new_n126_), .O(z15));
  inv1   g81(.a(x26), .O(new_n128_));
  nand3  g82(.a(new_n121_), .b(new_n89_), .c(new_n128_), .O(new_n129_));
  nor2   g83(.a(x25), .b(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n102_), .c(new_n99_), .d(new_n77_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n121_), .c(new_n99_), .d(new_n128_), .O(new_n138_));
