...
module FAU ( 
  ...
  nand3  g40(.a(new_n82_), .b(new_n73_), .c(new_n72_), .O(new_n87_));
  xor2a  g41(.a(new_n87_), .b(x21), .O(new_n88_));
  inv1   g42(.a(x02), .O(new_n89_));
  nand2  g43(.a(x18), .b(new_n89_), .O(new_n90_));
  nand2  g44(.a(new_n77_), .b(new_n54_), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(new_n81_), .O(new_n92_));
  oai21  g46(.a(new_n88_), .b(new_n81_), .c(new_n92_), .O(z11));
  inv1   g47(.a(x21), .O(new_n94_));
  nand3  g48(.a(new_n75_), .b(new_n94_), .c(new_n82_), .O(new_n95_));
  inv1   g49(.a(x22), .O(new_n96_));
  nand2  g50(.a(new_n87_), .b(new_n96_), .O(new_n97_));
  ...
  aoi21  g55(.a(new_n98_), .b(x16), .c(new_n101_), .O(z12));
  nand2  g56(.a(new_n77_), .b(new_n60_), .O(new_n103_));
  oai21  g57(.a(new_n77_), .b(x04), .c(new_n103_), .O(new_n104_));
  nor2   g58(.a(x23), .b(new_n81_), .O(new_n105_));
  aoi21  g59(.a(new_n104_), .b(new_n81_), .c(new_n105_), .O(z13));
  nand2  g60(.a(new_n77_), .b(new_n63_), .O(new_n107_));
  oai21  g61(.a(new_n77_), .b(x05), .c(new_n107_), .O(new_n108_));
  nor2   g62(.a(x24), .b(new_n81_), .O(new_n109_));
  aoi21  g63(.a(new_n108_), .b(new_n81_), .c(new_n109_), .O(z14));
  nand2  g64(.a(new_n77_), .b(new_n66_), .O(new_n111_));
  oai21  g65(.a(new_n77_), .b(x06), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x25), .b(new_n81_), .O(new_n113_));
  aoi21  g67(.a(new_n112_), .b(new_n81_), .c(new_n113_), .O(z15));
  nand2  g68(.a(new_n77_), .b(new_n69_), .O(new_n115_));
  oai21  g69(.a(new_n77_), .b(x07), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x26), .b(new_n81_), .O(new_n117_));
  aoi21  g71(.a(new_n116_), .b(new_n81_), .c(new_n117_), .O(z16));
  nand3  g72(.a(x27), .b(x17), .c(x16), .O(new_n119_));
