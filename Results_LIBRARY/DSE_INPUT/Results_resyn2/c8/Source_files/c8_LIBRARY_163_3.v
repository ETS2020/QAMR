...
module FAU ( 
  ...
  nand2  g38(.a(new_n77_), .b(new_n80_), .O(new_n85_));
  nor2   g39(.a(x21), .b(x20), .O(new_n86_));
  aoi22  g40(.a(new_n86_), .b(new_n77_), .c(new_n85_), .d(x21), .O(new_n87_));
  aoi21  g41(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n88_));
  oai21  g42(.a(new_n73_), .b(x02), .c(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n87_), .b(new_n76_), .c(new_n89_), .O(z11));
  inv1   g44(.a(x22), .O(new_n91_));
  aoi21  g45(.a(new_n86_), .b(new_n77_), .c(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n86_), .b(new_n77_), .c(new_n91_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n92_), .c(x16), .O(new_n95_));
  aoi21  g49(.a(new_n73_), .b(new_n57_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n73_), .b(x03), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n95_), .O(z12));
  nand2  g52(.a(new_n73_), .b(new_n60_), .O(new_n99_));
  inv1   g53(.a(x04), .O(new_n100_));
  nand2  g54(.a(x18), .b(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n101_), .b(new_n99_), .c(x16), .O(new_n102_));
  aoi21  g56(.a(new_n93_), .b(x16), .c(new_n102_), .O(z13));
  nand2  g57(.a(new_n93_), .b(x24), .O(new_n104_));
  nor2   g58(.a(x24), .b(x22), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n86_), .c(new_n77_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x16), .O(new_n108_));
  aoi21  g62(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n109_));
  oai21  g63(.a(new_n73_), .b(x05), .c(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n108_), .O(z14));
  nand2  g65(.a(new_n106_), .b(x25), .O(new_n112_));
  nor2   g66(.a(x25), .b(x21), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n105_), .c(new_n77_), .d(new_n80_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(x16), .O(new_n116_));
  aoi21  g70(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n117_));
  oai21  g71(.a(new_n73_), .b(x06), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n116_), .O(z15));
  nand2  g73(.a(new_n114_), .b(x26), .O(new_n120_));
  nor2   g74(.a(x26), .b(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n105_), .c(new_n86_), .d(new_n77_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(x16), .O(new_n124_));
  aoi21  g78(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n125_));
  oai21  g79(.a(new_n73_), .b(x07), .c(new_n125_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n124_), .O(z16));
  nand2  g81(.a(x27), .b(x17), .O(new_n128_));
  nor2   g82(.a(new_n47_), .b(x17), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n121_), .c(new_n105_), .d(new_n86_), .O(new_n130_));
  aoi21  g84(.a(new_n130_), .b(new_n128_), .c(new_n76_), .O(z17));
  buf    g85(.a(x27), .O(z08));
endmodule
