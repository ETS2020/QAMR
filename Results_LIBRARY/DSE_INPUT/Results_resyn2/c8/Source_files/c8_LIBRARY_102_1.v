// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:18 2020
...
module FAU ( 
  ...
  nor2   g23(.a(x27), .b(new_n69_), .O(new_n70_));
  aoi21  g24(.a(x27), .b(x15), .c(new_n70_), .O(z07));
  ...
  nand4  g73(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n98_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n122_));
  ...
  nor2   g81(.a(new_n127_), .b(new_n69_), .O(new_n128_));
  nand2  g82(.a(new_n127_), .b(new_n69_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  inv1   g84(.a(x07), .O(new_n131_));
  nand2  g85(.a(x18), .b(new_n131_), .O(new_n132_));
  nand3  g86(.a(new_n132_), .b(new_n76_), .c(x15), .O(new_n133_));
  oai21  g87(.a(new_n130_), .b(new_n128_), .c(new_n133_), .O(z16));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  nor2   g89(.a(new_n47_), .b(x17), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n121_), .c(new_n99_), .d(new_n69_), .O(new_n137_));
