...
module FAU ( 
  ...
  aoi21  g42(.a(new_n77_), .b(new_n54_), .c(x16), .O(new_n89_));
  oai21  g43(.a(new_n77_), .b(x02), .c(new_n89_), .O(new_n90_));
  oai21  g44(.a(new_n88_), .b(new_n81_), .c(new_n90_), .O(z11));
  oai21  g45(.a(x18), .b(new_n57_), .c(new_n81_), .O(new_n92_));
  aoi21  g46(.a(x18), .b(x03), .c(new_n92_), .O(new_n93_));
  oai21  g47(.a(new_n87_), .b(x21), .c(x22), .O(new_n94_));
  nor3   g48(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  nor2   g49(.a(x22), .b(x21), .O(new_n96_));
  aoi21  g50(.a(new_n96_), .b(new_n95_), .c(new_n81_), .O(new_n97_));
  aoi21  g51(.a(new_n97_), .b(new_n94_), .c(new_n93_), .O(z12));
  inv1   g52(.a(x23), .O(new_n99_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n99_), .O(new_n100_));
  nand3  g54(.a(new_n96_), .b(new_n72_), .c(new_n82_), .O(new_n101_));
  aoi21  g55(.a(new_n101_), .b(x23), .c(new_n81_), .O(new_n102_));
  oai21  g56(.a(x18), .b(new_n60_), .c(new_n81_), .O(new_n103_));
  aoi21  g57(.a(x18), .b(x04), .c(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n104_), .O(z13));
  aoi21  g59(.a(new_n77_), .b(new_n63_), .c(x16), .O(new_n106_));
  oai21  g60(.a(new_n77_), .b(x05), .c(new_n106_), .O(new_n107_));
  inv1   g61(.a(x24), .O(new_n108_));
  oai21  g62(.a(x19), .b(x17), .c(new_n108_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n100_), .c(x16), .O(new_n110_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n96_), .O(new_n124_));
  aoi21  g78(.a(new_n124_), .b(new_n120_), .c(new_n81_), .O(z17));
  buf    g79(.a(x27), .O(z08));
endmodule
