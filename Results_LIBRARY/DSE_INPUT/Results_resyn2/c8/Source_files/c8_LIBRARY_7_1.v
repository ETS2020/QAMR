// Benchmark "FAU" written by ABC on Mon Jul 27 21:44:28 2020
...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(x25), .O(z06));
  inv1   g20(.a(x15), .O(new_n67_));
  nor2   g21(.a(new_n50_), .b(new_n67_), .O(new_n68_));
  aoi21  g22(.a(new_n50_), .b(x26), .c(new_n68_), .O(z07));
  ...
  aoi21  g75(.a(new_n71_), .b(new_n121_), .c(x16), .O(new_n122_));
  oai21  g76(.a(new_n71_), .b(x06), .c(new_n122_), .O(new_n123_));
  oai21  g77(.a(new_n120_), .b(new_n74_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x26), .O(new_n125_));
  nand3  g79(.a(new_n119_), .b(new_n87_), .c(new_n125_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n100_), .c(new_n97_), .d(new_n75_), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(x26), .c(new_n74_), .O(new_n129_));
  oai21  g83(.a(x18), .b(new_n67_), .c(new_n74_), .O(new_n130_));
  ...
  nand4  g88(.a(new_n134_), .b(new_n119_), .c(new_n97_), .d(new_n125_), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n133_), .c(new_n74_), .O(z17));
  buf    g90(.a(x27), .O(z08));
endmodule
