...
module FAU ( 
  ...
  oai21  g51(.a(new_n88_), .b(x22), .c(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  aoi21  g53(.a(new_n99_), .b(new_n89_), .c(new_n76_), .O(new_n100_));
  oai21  g54(.a(x18), .b(new_n60_), .c(new_n76_), .O(new_n101_));
  aoi21  g55(.a(x18), .b(x04), .c(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(new_n98_), .c(new_n102_), .O(z13));
  nor2   g57(.a(x24), .b(x21), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n99_), .c(new_n77_), .d(new_n80_), .O(new_n105_));
  nor2   g59(.a(x21), .b(x20), .O(new_n106_));
  nand3  g60(.a(new_n99_), .b(new_n106_), .c(new_n87_), .O(new_n107_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n89_), .c(new_n105_), .d(x25), .O(new_n120_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n99_), .c(new_n106_), .d(new_n77_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(x26), .O(new_n126_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n99_), .c(new_n106_), .d(new_n77_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  aoi21  g84(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n131_));
  oai21  g85(.a(new_n73_), .b(x07), .c(new_n131_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(z16));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  inv1   g88(.a(x26), .O(new_n135_));
  nand3  g89(.a(new_n135_), .b(new_n117_), .c(x19), .O(new_n136_));
  or2    g90(.a(new_n136_), .b(new_n107_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n134_), .c(new_n76_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
