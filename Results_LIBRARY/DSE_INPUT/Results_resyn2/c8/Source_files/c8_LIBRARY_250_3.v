...
module FAU ( 
  ...
  nand4  g43(.a(new_n89_), .b(new_n80_), .c(new_n47_), .d(new_n88_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  aoi21  g45(.a(new_n87_), .b(x21), .c(new_n91_), .O(new_n92_));
  aoi21  g46(.a(new_n73_), .b(new_n54_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n73_), .b(x02), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n92_), .b(new_n76_), .c(new_n94_), .O(z11));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n82_), .c(new_n107_), .O(new_n108_));
  nor2   g62(.a(x24), .b(x23), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(new_n96_), .c(new_n77_), .d(new_n80_), .O(new_n110_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n91_), .c(new_n110_), .d(x25), .O(new_n121_));
  ...
  nor2   g78(.a(new_n73_), .b(x07), .O(new_n125_));
  oai21  g79(.a(x18), .b(x15), .c(new_n76_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n96_), .c(new_n117_), .d(x16), .O(new_n128_));
  oai22  g82(.a(new_n128_), .b(new_n87_), .c(new_n126_), .d(new_n125_), .O(z16));
  nand2  g83(.a(x27), .b(x17), .O(new_n130_));
  nor2   g84(.a(x21), .b(x20), .O(new_n131_));
  nand4  g85(.a(new_n120_), .b(new_n131_), .c(x19), .d(new_n88_), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(new_n130_), .c(new_n76_), .O(z17));
  buf    g87(.a(x27), .O(z08));
endmodule
