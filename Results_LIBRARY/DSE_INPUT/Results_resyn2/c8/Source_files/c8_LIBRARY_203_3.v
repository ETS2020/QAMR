// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:04 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n85_), .b(new_n76_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  aoi21  g41(.a(new_n84_), .b(x21), .c(new_n87_), .O(new_n88_));
  aoi21  g42(.a(new_n72_), .b(new_n54_), .c(x16), .O(new_n89_));
  oai21  g43(.a(new_n72_), .b(x02), .c(new_n89_), .O(new_n90_));
  oai21  g44(.a(new_n88_), .b(new_n75_), .c(new_n90_), .O(z11));
  xor2a  g45(.a(new_n86_), .b(x22), .O(new_n92_));
  aoi21  g46(.a(new_n72_), .b(new_n57_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n72_), .b(x03), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n92_), .b(new_n75_), .c(new_n94_), .O(z12));
  inv1   g49(.a(x22), .O(new_n96_));
  nand3  g50(.a(new_n85_), .b(new_n76_), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g59(.a(new_n100_), .b(x24), .O(new_n106_));
  inv1   g60(.a(x25), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n108_));
  nand4  g62(.a(new_n108_), .b(new_n99_), .c(new_n85_), .d(new_n76_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g64(.a(x18), .b(x05), .O(new_n111_));
  nand2  g65(.a(new_n72_), .b(x13), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n111_), .c(new_n75_), .O(new_n113_));
  and2   g67(.a(new_n113_), .b(new_n110_), .O(z14));
  nand2  g68(.a(new_n100_), .b(x25), .O(new_n115_));
  nor2   g69(.a(x25), .b(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n99_), .c(new_n85_), .d(new_n76_), .O(new_n117_));
  ...
  nand2  g75(.a(new_n121_), .b(new_n119_), .O(z15));
  inv1   g76(.a(x26), .O(new_n123_));
  nand2  g77(.a(new_n116_), .b(new_n99_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  nand3  g79(.a(new_n125_), .b(new_n87_), .c(new_n123_), .O(new_n126_));
  aoi21  g80(.a(new_n117_), .b(x26), .c(new_n75_), .O(new_n127_));
  oai21  g81(.a(x18), .b(new_n68_), .c(new_n75_), .O(new_n128_));
  aoi21  g82(.a(x18), .b(x07), .c(new_n128_), .O(new_n129_));
  aoi21  g83(.a(new_n127_), .b(new_n126_), .c(new_n129_), .O(z16));
  nand2  g84(.a(x27), .b(x17), .O(new_n131_));
  nor2   g85(.a(new_n47_), .b(x17), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n125_), .c(new_n85_), .d(new_n123_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n131_), .c(new_n75_), .O(z17));
  buf    g88(.a(x27), .O(z08));
endmodule
