// Benchmark "FAU" written by ABC on Mon Jul 27 21:46:20 2020
...
module FAU ( 
  ...
  oai21  g38(.a(x18), .b(x10), .c(x02), .O(new_n85_));
  nand2  g39(.a(new_n77_), .b(new_n80_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(x21), .O(new_n87_));
  inv1   g41(.a(x17), .O(new_n88_));
  nand4  g42(.a(new_n54_), .b(new_n80_), .c(new_n47_), .d(new_n88_), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  nor2   g44(.a(new_n90_), .b(new_n76_), .O(new_n91_));
  aoi22  g45(.a(new_n91_), .b(new_n87_), .c(new_n85_), .d(new_n76_), .O(z11));
  xor2a  g46(.a(new_n89_), .b(x22), .O(new_n93_));
  ...
  aoi22  g74(.a(new_n120_), .b(new_n90_), .c(new_n110_), .d(x25), .O(new_n121_));
  ...
  nand3  g79(.a(new_n120_), .b(new_n90_), .c(new_n125_), .O(new_n126_));
