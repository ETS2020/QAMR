...
module FAU ( 
  ...
  nand2  g76(.a(new_n109_), .b(x26), .O(new_n123_));
  nor3   g77(.a(x26), .b(x23), .c(x22), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n116_), .c(new_n86_), .d(new_n77_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(x16), .O(new_n127_));
  aoi21  g81(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n128_));
  oai21  g82(.a(new_n73_), .b(x07), .c(new_n128_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n127_), .O(z16));
  nand2  g84(.a(x27), .b(x17), .O(new_n131_));
  nor2   g85(.a(new_n47_), .b(x17), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n124_), .c(new_n116_), .d(new_n86_), .O(new_n133_));
  aoi21  g87(.a(new_n133_), .b(new_n131_), .c(new_n76_), .O(z17));
  buf    g88(.a(x27), .O(z08));
endmodule
