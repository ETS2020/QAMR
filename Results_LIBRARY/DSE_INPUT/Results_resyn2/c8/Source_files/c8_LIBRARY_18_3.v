...
module FAU ( 
  ...
  nand2  g35(.a(new_n77_), .b(new_n80_), .O(new_n82_));
  inv1   g36(.a(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(new_n81_), .c(x16), .O(new_n84_));
  aoi21  g38(.a(new_n73_), .b(new_n51_), .c(x16), .O(new_n85_));
  oai21  g39(.a(new_n73_), .b(x01), .c(new_n85_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n84_), .O(z10));
  nand2  g41(.a(new_n73_), .b(new_n54_), .O(new_n88_));
  oai21  g42(.a(new_n73_), .b(x02), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(new_n83_), .b(new_n76_), .O(new_n90_));
  aoi21  g44(.a(new_n89_), .b(new_n76_), .c(new_n90_), .O(z11));
  nor2   g45(.a(x22), .b(x20), .O(new_n92_));
  aoi22  g46(.a(new_n92_), .b(new_n77_), .c(new_n82_), .d(x22), .O(new_n93_));
  ...
  aoi21  g51(.a(new_n92_), .b(new_n77_), .c(new_n97_), .O(new_n98_));
  nand3  g52(.a(new_n92_), .b(new_n77_), .c(new_n97_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n98_), .c(x16), .O(new_n101_));
  aoi21  g55(.a(new_n73_), .b(new_n60_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n73_), .b(x04), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n101_), .O(z13));
  nand2  g58(.a(new_n99_), .b(x24), .O(new_n105_));
  nor2   g59(.a(x24), .b(x23), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n92_), .c(new_n77_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(x16), .O(new_n109_));
  aoi21  g63(.a(new_n73_), .b(new_n63_), .c(x16), .O(new_n110_));
  oai21  g64(.a(new_n73_), .b(x05), .c(new_n110_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n109_), .O(z14));
  nand2  g66(.a(new_n107_), .b(x25), .O(new_n113_));
  nor2   g67(.a(x25), .b(x22), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n106_), .c(new_n77_), .d(new_n80_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(x16), .O(new_n117_));
  aoi21  g71(.a(new_n73_), .b(new_n66_), .c(x16), .O(new_n118_));
  oai21  g72(.a(new_n73_), .b(x06), .c(new_n118_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n117_), .O(z15));
  nand2  g74(.a(new_n115_), .b(x26), .O(new_n121_));
  nor2   g75(.a(x26), .b(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n106_), .c(new_n92_), .d(new_n77_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(x16), .O(new_n125_));
  aoi21  g79(.a(new_n73_), .b(new_n69_), .c(x16), .O(new_n126_));
  oai21  g80(.a(new_n73_), .b(x07), .c(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n125_), .O(z16));
  nand2  g82(.a(x27), .b(x17), .O(new_n129_));
  nor2   g83(.a(new_n47_), .b(x17), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n122_), .c(new_n106_), .d(new_n92_), .O(new_n131_));
  aoi21  g85(.a(new_n131_), .b(new_n129_), .c(new_n76_), .O(z17));
  buf    g86(.a(x27), .O(z08));
endmodule
