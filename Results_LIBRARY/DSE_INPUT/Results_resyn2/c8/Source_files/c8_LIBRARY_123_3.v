// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:29 2020
...
module FAU ( 
  ...
  aoi21  g38(.a(x18), .b(x02), .c(x10), .O(new_n85_));
  aoi21  g39(.a(new_n77_), .b(new_n80_), .c(new_n54_), .O(new_n86_));
  inv1   g40(.a(x17), .O(new_n87_));
  nand4  g41(.a(new_n54_), .b(new_n80_), .c(new_n47_), .d(new_n87_), .O(new_n88_));
  inv1   g42(.a(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n86_), .c(x16), .O(new_n90_));
  oai21  g44(.a(new_n85_), .b(x16), .c(new_n90_), .O(z11));
  xor2a  g45(.a(new_n88_), .b(x22), .O(new_n92_));
  ...
  aoi22  g73(.a(new_n119_), .b(new_n89_), .c(new_n109_), .d(x25), .O(new_n120_));
  ...
  nand3  g78(.a(new_n119_), .b(new_n89_), .c(new_n124_), .O(new_n125_));
