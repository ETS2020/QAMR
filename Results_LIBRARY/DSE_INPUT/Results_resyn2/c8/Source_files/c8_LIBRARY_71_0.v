// Benchmark "FAU" written by ABC on Mon Jul 27 21:45:02 2020
...
module FAU ( 
  ...
  nor2   g24(.a(x16), .b(x00), .O(new_n71_));
  ...
  nand2  g31(.a(new_n73_), .b(x01), .O(new_n78_));
  ...
  nand2  g38(.a(new_n73_), .b(x02), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n84_), .O(z11));
  xor2a  g40(.a(new_n82_), .b(x22), .O(new_n87_));
  nand2  g41(.a(new_n73_), .b(x03), .O(new_n88_));
  ...
  nand2  g50(.a(new_n73_), .b(x04), .O(new_n97_));
  ...
  nand2  g57(.a(new_n73_), .b(x05), .O(new_n104_));
  ...
  nand2  g62(.a(new_n73_), .b(x06), .O(new_n109_));
  ...
  nor2   g66(.a(new_n112_), .b(new_n68_), .O(new_n113_));
  nand2  g67(.a(new_n112_), .b(new_n68_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g69(.a(new_n73_), .b(x07), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n113_), .c(new_n116_), .O(z16));
  nand2  g71(.a(x27), .b(x17), .O(new_n118_));
  nor2   g72(.a(new_n47_), .b(x17), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n107_), .c(new_n90_), .d(new_n68_), .O(new_n120_));
  aoi21  g74(.a(new_n120_), .b(new_n118_), .c(new_n73_), .O(z17));
  buf    g75(.a(x27), .O(z08));
endmodule
