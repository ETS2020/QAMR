...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  oai21  g04(.a(new_n50_), .b(x09), .c(x20), .O(z01));
  inv1   g05(.a(x10), .O(new_n52_));
  nor2   g06(.a(new_n50_), .b(new_n52_), .O(new_n53_));
  aoi21  g07(.a(new_n50_), .b(x21), .c(new_n53_), .O(z02));
  inv1   g08(.a(x11), .O(new_n55_));
  nor2   g09(.a(new_n50_), .b(new_n55_), .O(new_n56_));
  aoi21  g10(.a(new_n50_), .b(x22), .c(new_n56_), .O(z03));
  inv1   g11(.a(x12), .O(new_n58_));
  nor2   g12(.a(new_n50_), .b(new_n58_), .O(new_n59_));
  aoi21  g13(.a(new_n50_), .b(x23), .c(new_n59_), .O(z04));
  inv1   g14(.a(x13), .O(new_n61_));
  nor2   g15(.a(new_n50_), .b(new_n61_), .O(new_n62_));
  aoi21  g16(.a(new_n50_), .b(x24), .c(new_n62_), .O(z05));
  inv1   g17(.a(x14), .O(new_n64_));
  nor2   g18(.a(new_n50_), .b(new_n64_), .O(new_n65_));
  aoi21  g19(.a(new_n50_), .b(x25), .c(new_n65_), .O(z06));
