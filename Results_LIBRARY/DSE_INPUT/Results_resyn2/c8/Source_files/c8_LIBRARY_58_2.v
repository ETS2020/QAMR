// Benchmark "FAU" written by ABC on Mon Jul 27 21:44:55 2020
...
module FAU ( 
  ...
  nand3  g48(.a(x18), .b(new_n76_), .c(x03), .O(new_n95_));
  oai21  g49(.a(new_n94_), .b(new_n76_), .c(new_n95_), .O(z12));
  nor2   g50(.a(x21), .b(x20), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n77_), .c(new_n57_), .O(new_n98_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n57_), .O(new_n118_));
