...
module FAU ( 
  ...
  nor2   g62(.a(x18), .b(new_n63_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(x05), .c(new_n76_), .O(new_n110_));
  nand2  g64(.a(new_n103_), .b(x24), .O(new_n111_));
  nor2   g65(.a(x24), .b(x21), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n102_), .c(new_n77_), .d(new_n80_), .O(new_n113_));
  ...
  aoi22  g75(.a(new_n121_), .b(new_n89_), .c(new_n113_), .d(x25), .O(new_n122_));
