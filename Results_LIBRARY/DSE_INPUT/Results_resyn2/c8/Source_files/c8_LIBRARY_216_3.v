...
module FAU ( 
  ...
  nand2  g72(.a(new_n118_), .b(new_n76_), .O(new_n119_));
  inv1   g73(.a(x23), .O(new_n120_));
  inv1   g74(.a(x24), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n98_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n89_), .c(new_n111_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n76_), .c(new_n119_), .O(z15));
  inv1   g80(.a(x26), .O(new_n127_));
  nand3  g81(.a(new_n124_), .b(new_n89_), .c(new_n127_), .O(new_n128_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n124_), .c(new_n99_), .d(new_n127_), .O(new_n137_));
