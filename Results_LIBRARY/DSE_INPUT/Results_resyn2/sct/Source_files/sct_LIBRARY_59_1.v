...
module FAU ( 
  ...
  nand3  g35(.a(new_n66_), .b(new_n65_), .c(new_n69_), .O(new_n70_));
  nand2  g36(.a(new_n67_), .b(x11), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n47_), .O(z07));
  nand2  g38(.a(new_n70_), .b(x12), .O(new_n73_));
  inv1   g39(.a(x12), .O(new_n74_));
  nand4  g40(.a(new_n66_), .b(new_n65_), .c(new_n74_), .d(new_n69_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n47_), .O(z08));
  nand2  g42(.a(new_n44_), .b(x02), .O(new_n77_));
  nand2  g43(.a(new_n45_), .b(new_n69_), .O(new_n78_));
  inv1   g44(.a(x10), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n74_), .c(new_n79_), .O(new_n81_));
  aoi21  g47(.a(new_n78_), .b(new_n77_), .c(new_n81_), .O(new_n82_));
  nor2   g48(.a(new_n45_), .b(x02), .O(new_n83_));
  aoi21  g49(.a(new_n82_), .b(new_n60_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n75_), .b(x13), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  aoi21  g54(.a(new_n77_), .b(x16), .c(new_n88_), .O(new_n89_));
