...
module FAU ( 
  ...
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n70_), .d(x06), .O(new_n74_));
  oai21  g40(.a(new_n63_), .b(x10), .c(x11), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z07));
  nand3  g42(.a(new_n73_), .b(new_n70_), .c(x06), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x12), .O(new_n78_));
  nand3  g44(.a(new_n73_), .b(new_n67_), .c(new_n71_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n78_), .c(new_n48_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n73_), .b(new_n67_), .c(new_n81_), .d(new_n71_), .O(new_n82_));
  nand2  g48(.a(new_n73_), .b(new_n71_), .O(new_n83_));
  ...
  nand4  g55(.a(new_n81_), .b(new_n71_), .c(new_n89_), .d(new_n66_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n67_), .c(new_n87_), .O(new_n92_));
