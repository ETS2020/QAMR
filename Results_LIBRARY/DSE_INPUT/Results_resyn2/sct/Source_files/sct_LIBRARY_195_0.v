...
module FAU ( 
  ...
  nor2   g34(.a(x10), .b(new_n53_), .O(new_n69_));
  oai21  g35(.a(new_n65_), .b(new_n48_), .c(new_n69_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n47_), .O(z06));
  inv1   g37(.a(x11), .O(new_n72_));
  nand3  g38(.a(new_n69_), .b(new_n65_), .c(new_n72_), .O(new_n73_));
  nand2  g39(.a(new_n69_), .b(new_n65_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x11), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n47_), .O(z07));
  nand2  g42(.a(new_n73_), .b(x12), .O(new_n77_));
  nor2   g43(.a(x12), .b(x11), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n69_), .c(new_n65_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n47_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n78_), .b(new_n69_), .c(new_n65_), .d(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n79_), .b(x13), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(new_n47_), .O(z09));
  oai21  g50(.a(x03), .b(new_n36_), .c(x16), .O(new_n85_));
  nand2  g51(.a(x07), .b(x00), .O(new_n86_));
  inv1   g52(.a(x12), .O(new_n87_));
  nand4  g53(.a(new_n81_), .b(new_n87_), .c(new_n72_), .d(new_n49_), .O(new_n88_));
  ...
  nand3  g58(.a(new_n92_), .b(new_n89_), .c(new_n85_), .O(new_n93_));
