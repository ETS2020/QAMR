// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:01 2020
...
module FAU ( 
  ...
  oai21  g29(.a(new_n56_), .b(new_n44_), .c(x09), .O(new_n64_));
  ...
  nor2   g37(.a(x09), .b(new_n56_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n58_), .c(new_n71_), .d(new_n67_), .O(new_n73_));
  oai21  g39(.a(new_n63_), .b(x10), .c(x11), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z07));
  nand2  g41(.a(new_n73_), .b(x12), .O(new_n76_));
  nor2   g42(.a(x12), .b(x11), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n72_), .c(new_n58_), .d(new_n67_), .O(new_n78_));
