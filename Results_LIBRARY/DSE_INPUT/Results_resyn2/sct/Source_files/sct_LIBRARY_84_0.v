// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:02 2020
...
module FAU ( 
  ...
  nand4  g38(.a(new_n49_), .b(new_n69_), .c(new_n72_), .d(x08), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(x07), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x06), .O(new_n75_));
  nand4  g41(.a(new_n69_), .b(new_n72_), .c(x08), .d(x06), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(x11), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(z07));
  oai21  g44(.a(new_n76_), .b(x11), .c(x12), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n49_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n79_), .c(new_n47_), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand2  g51(.a(new_n82_), .b(new_n85_), .O(new_n86_));
  oai21  g52(.a(new_n81_), .b(new_n76_), .c(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(new_n47_), .O(z09));
  nand2  g54(.a(new_n46_), .b(x14), .O(new_n89_));
  oai21  g55(.a(x03), .b(new_n36_), .c(x16), .O(new_n90_));
  nand2  g56(.a(x07), .b(x00), .O(new_n91_));
  nand4  g57(.a(new_n85_), .b(new_n80_), .c(new_n49_), .d(new_n69_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g59(.a(new_n72_), .b(x08), .c(x06), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n93_), .c(new_n90_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n89_), .c(new_n41_), .O(z10));
