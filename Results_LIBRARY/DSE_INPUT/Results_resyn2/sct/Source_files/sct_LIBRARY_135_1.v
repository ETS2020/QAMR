...
module FAU ( 
  ...
  nor2   g27(.a(new_n51_), .b(x09), .O(new_n62_));
  oai21  g28(.a(x10), .b(x08), .c(new_n62_), .O(new_n63_));
  ...
  oai21  g33(.a(new_n51_), .b(x09), .c(x10), .O(new_n68_));
  ...
  nand3  g40(.a(new_n71_), .b(new_n65_), .c(new_n74_), .O(new_n75_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n71_), .d(new_n65_), .O(new_n81_));
  nand2  g47(.a(x16), .b(new_n36_), .O(new_n82_));
  aoi21  g48(.a(x16), .b(x03), .c(new_n41_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n78_), .O(z09));
  ...
  nand2  g55(.a(new_n45_), .b(x02), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(x16), .c(x09), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n89_), .c(new_n65_), .O(new_n92_));
