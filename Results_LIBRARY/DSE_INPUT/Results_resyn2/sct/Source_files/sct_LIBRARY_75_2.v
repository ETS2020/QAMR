...
module FAU ( 
  ...
  nand2  g39(.a(new_n68_), .b(new_n73_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n72_), .c(new_n48_), .O(z07));
  oai21  g41(.a(new_n65_), .b(x11), .c(x12), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand3  g43(.a(new_n68_), .b(new_n77_), .c(new_n73_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(z08));
  nand2  g45(.a(new_n77_), .b(new_n73_), .O(new_n80_));
  oai21  g46(.a(new_n80_), .b(new_n65_), .c(x13), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n77_), .c(new_n73_), .O(new_n83_));
  or2    g49(.a(new_n83_), .b(new_n65_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n48_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n83_), .b(new_n86_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n68_), .c(new_n57_), .O(new_n88_));
  nand2  g54(.a(new_n47_), .b(x14), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n41_), .O(z10));
  nand2  g56(.a(x16), .b(new_n36_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n45_), .c(new_n41_), .O(z12));
