// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:06 2020
...
module FAU ( 
  ...
  inv1   g15(.a(new_n46_), .O(new_n50_));
  nand2  g16(.a(new_n44_), .b(x02), .O(new_n51_));
  nand2  g17(.a(new_n51_), .b(x07), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  inv1   g19(.a(x07), .O(new_n54_));
  oai21  g20(.a(x16), .b(new_n54_), .c(new_n43_), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(x04), .O(new_n56_));
  aoi21  g22(.a(new_n53_), .b(x06), .c(new_n56_), .O(z03));
  nand3  g23(.a(new_n51_), .b(x07), .c(x06), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n50_), .c(x08), .O(new_n59_));
  inv1   g25(.a(x08), .O(new_n60_));
  nand4  g26(.a(new_n45_), .b(new_n60_), .c(x07), .d(x06), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n59_), .c(new_n40_), .O(z04));
  ...
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n47_), .O(z06));
  ...
  nor2   g46(.a(new_n45_), .b(x02), .O(new_n81_));
  ...
  inv1   g62(.a(new_n58_), .O(new_n97_));
  aoi21  g63(.a(new_n95_), .b(new_n97_), .c(new_n40_), .O(z13));
