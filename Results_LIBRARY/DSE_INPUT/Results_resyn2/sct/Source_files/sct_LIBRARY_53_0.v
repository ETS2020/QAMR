...
module FAU ( 
  ...
  nor3   g30(.a(new_n55_), .b(x10), .c(x09), .O(new_n65_));
  ...
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n47_), .O(z07));
  nand2  g37(.a(new_n69_), .b(x12), .O(new_n72_));
  inv1   g38(.a(x12), .O(new_n73_));
  inv1   g39(.a(new_n55_), .O(new_n74_));
  nor2   g40(.a(x10), .b(x09), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(new_n68_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n47_), .O(z08));
  nor2   g43(.a(new_n45_), .b(x02), .O(new_n78_));
  nand2  g44(.a(new_n44_), .b(x02), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n73_), .c(new_n68_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n65_), .c(new_n78_), .O(new_n83_));
  ...
  aoi21  g53(.a(new_n79_), .b(x16), .c(new_n87_), .O(new_n88_));
  inv1   g54(.a(x10), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n44_), .c(x02), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(new_n81_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n88_), .c(new_n60_), .O(new_n92_));
  nand2  g58(.a(new_n46_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n40_), .O(z10));
  nor2   g60(.a(new_n78_), .b(x03), .O(new_n95_));
