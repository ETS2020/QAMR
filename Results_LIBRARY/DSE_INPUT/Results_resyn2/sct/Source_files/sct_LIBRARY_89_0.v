...
module FAU ( 
  ...
  nor2   g37(.a(new_n53_), .b(x09), .O(new_n72_));
  nor2   g38(.a(x11), .b(x10), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n61_), .O(z07));
  inv1   g41(.a(x12), .O(new_n76_));
  nand4  g42(.a(new_n73_), .b(new_n64_), .c(new_n76_), .d(new_n63_), .O(new_n77_));
  nand2  g43(.a(new_n73_), .b(new_n63_), .O(new_n78_));
  oai21  g44(.a(new_n78_), .b(new_n53_), .c(x12), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n61_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x09), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n77_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n61_), .O(z09));
  nand2  g50(.a(new_n60_), .b(x14), .O(new_n85_));
  nand3  g51(.a(new_n72_), .b(new_n45_), .c(x00), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n85_), .c(new_n41_), .O(z10));
  nand2  g53(.a(x16), .b(new_n36_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n58_), .c(new_n41_), .O(z12));
