...
module FAU ( 
  ...
  nand3  g35(.a(new_n61_), .b(new_n69_), .c(new_n66_), .O(new_n70_));
  nand2  g36(.a(new_n67_), .b(x11), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z07));
  nand2  g38(.a(new_n70_), .b(x12), .O(new_n73_));
  inv1   g39(.a(x12), .O(new_n74_));
  nand4  g40(.a(new_n61_), .b(new_n74_), .c(new_n69_), .d(new_n66_), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z08));
  nand2  g42(.a(new_n75_), .b(x13), .O(new_n77_));
  nand3  g43(.a(new_n74_), .b(new_n45_), .c(x02), .O(new_n78_));
  inv1   g44(.a(x13), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n69_), .c(new_n66_), .O(new_n80_));
  aoi21  g46(.a(new_n78_), .b(x16), .c(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(new_n61_), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n77_), .c(new_n48_), .O(z09));
  inv1   g49(.a(x00), .O(new_n84_));
  nand2  g50(.a(new_n45_), .b(x02), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(x16), .c(new_n84_), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n81_), .c(new_n61_), .O(new_n87_));
  nand2  g53(.a(new_n47_), .b(x14), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n87_), .c(new_n41_), .O(z10));
