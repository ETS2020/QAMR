...
module FAU ( 
  ...
  nor2   g10(.a(x03), .b(new_n36_), .O(new_n45_));
  nand2  g11(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  aoi21  g12(.a(new_n46_), .b(x16), .c(new_n41_), .O(z02));
  inv1   g13(.a(x16), .O(new_n48_));
  nand2  g14(.a(new_n48_), .b(x07), .O(new_n49_));
  inv1   g15(.a(x07), .O(new_n50_));
  nand2  g16(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  nand2  g17(.a(x07), .b(x06), .O(new_n52_));
  nand3  g18(.a(new_n52_), .b(new_n51_), .c(new_n45_), .O(new_n53_));
  aoi21  g19(.a(new_n53_), .b(new_n49_), .c(new_n41_), .O(z03));
  nand2  g20(.a(new_n48_), .b(x08), .O(new_n55_));
  inv1   g21(.a(x08), .O(new_n56_));
  nand2  g22(.a(new_n52_), .b(new_n56_), .O(new_n57_));
  nand3  g23(.a(x08), .b(x07), .c(x06), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(new_n59_));
  aoi21  g25(.a(new_n59_), .b(new_n55_), .c(new_n41_), .O(z04));
  nor2   g26(.a(new_n58_), .b(x09), .O(new_n61_));
  inv1   g27(.a(new_n61_), .O(new_n62_));
  inv1   g28(.a(new_n45_), .O(new_n63_));
  aoi21  g29(.a(new_n63_), .b(x16), .c(new_n41_), .O(new_n64_));
  ...
  nor2   g36(.a(new_n70_), .b(new_n58_), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n67_), .c(new_n64_), .O(z06));
  nand2  g39(.a(new_n72_), .b(x11), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  nand2  g41(.a(new_n71_), .b(new_n75_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n64_), .O(z07));
  nand2  g43(.a(new_n76_), .b(x12), .O(new_n78_));
  inv1   g44(.a(new_n58_), .O(new_n79_));
  nor2   g45(.a(x12), .b(x11), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n69_), .d(new_n68_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n78_), .c(new_n64_), .O(z08));
  nor2   g48(.a(new_n48_), .b(x02), .O(new_n83_));
  inv1   g49(.a(x12), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  inv1   g51(.a(x03), .O(new_n86_));
  inv1   g52(.a(x13), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n86_), .c(x02), .O(new_n88_));
  nor2   g54(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n71_), .c(new_n83_), .O(new_n90_));
  nand2  g56(.a(new_n81_), .b(x13), .O(new_n91_));
  nand2  g57(.a(x16), .b(x03), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x04), .O(z09));
  nand3  g59(.a(new_n63_), .b(x16), .c(x14), .O(new_n94_));
  inv1   g60(.a(x00), .O(new_n95_));
  nand3  g61(.a(new_n80_), .b(new_n87_), .c(new_n69_), .O(new_n96_));
  nand2  g62(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(new_n61_), .c(new_n45_), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n94_), .c(new_n41_), .O(z10));
  nor2   g65(.a(new_n83_), .b(x03), .O(new_n100_));
