// Benchmark "FAU" written by ABC on Mon Jul 27 17:50:13 2020
...
module FAU ( 
  ...
  nand4  g39(.a(new_n69_), .b(new_n56_), .c(new_n73_), .d(new_n66_), .O(new_n74_));
  oai21  g40(.a(new_n64_), .b(x10), .c(x11), .O(new_n75_));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z07));
  nand2  g42(.a(new_n74_), .b(x12), .O(new_n77_));
  nor2   g43(.a(x12), .b(x11), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n69_), .c(new_n56_), .d(new_n66_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n77_), .c(new_n48_), .O(z08));
  nand2  g46(.a(new_n79_), .b(x13), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n78_), .b(new_n67_), .c(new_n82_), .d(new_n66_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(z09));
  ...
  nand4  g54(.a(new_n82_), .b(new_n88_), .c(new_n73_), .d(new_n66_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n67_), .c(new_n86_), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n85_), .c(new_n41_), .O(z10));
  nand2  g58(.a(x16), .b(new_n36_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n45_), .c(new_n41_), .O(z12));
