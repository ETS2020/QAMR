...
module FAU ( 
  ...
  inv1   g40(.a(new_n56_), .O(new_n75_));
  nand3  g41(.a(new_n71_), .b(new_n75_), .c(new_n74_), .O(new_n76_));
  nand2  g42(.a(new_n71_), .b(new_n75_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(x12), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n48_), .d(new_n62_), .O(z08));
  nand2  g45(.a(new_n76_), .b(x13), .O(new_n80_));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n74_), .c(new_n81_), .d(new_n65_), .O(new_n83_));
  ...
  nand2  g53(.a(new_n62_), .b(x00), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n75_), .c(new_n87_), .O(new_n90_));
  ...
  nand4  g60(.a(new_n93_), .b(new_n63_), .c(new_n75_), .d(new_n62_), .O(new_n95_));
  and2   g61(.a(new_n95_), .b(x04), .O(z13));
