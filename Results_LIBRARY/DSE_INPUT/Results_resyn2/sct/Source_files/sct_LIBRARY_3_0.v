...
module FAU ( 
  ...
  aoi21  g14(.a(new_n45_), .b(new_n44_), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g19(.a(x16), .b(new_n48_), .c(new_n44_), .O(new_n54_));
  inv1   g20(.a(new_n54_), .O(new_n55_));
  nor3   g21(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(z03));
  oai21  g22(.a(new_n51_), .b(x06), .c(x07), .O(new_n57_));
  nand3  g23(.a(new_n52_), .b(new_n57_), .c(x08), .O(new_n58_));
  inv1   g24(.a(x08), .O(new_n59_));
  oai21  g25(.a(new_n51_), .b(new_n44_), .c(x16), .O(new_n60_));
  nand3  g26(.a(new_n60_), .b(new_n59_), .c(x07), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n58_), .c(new_n41_), .O(z04));
  ...
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n63_), .O(z06));
  ...
  nor3   g60(.a(x09), .b(new_n59_), .c(new_n48_), .O(new_n95_));
  nand3  g61(.a(new_n95_), .b(new_n94_), .c(new_n60_), .O(new_n96_));
  nand3  g62(.a(new_n51_), .b(x16), .c(x14), .O(new_n97_));
