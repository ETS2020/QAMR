...
module FAU ( 
  ...
  oai21  g40(.a(new_n74_), .b(new_n56_), .c(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand3  g42(.a(new_n71_), .b(new_n67_), .c(new_n76_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n48_), .O(z08));
  inv1   g44(.a(x13), .O(new_n79_));
  nand4  g45(.a(new_n71_), .b(new_n67_), .c(new_n79_), .d(new_n76_), .O(new_n80_));
  nand2  g46(.a(new_n71_), .b(new_n76_), .O(new_n81_));
  oai21  g47(.a(new_n81_), .b(new_n63_), .c(x13), .O(new_n82_));
  ...
  nand4  g53(.a(new_n79_), .b(new_n76_), .c(new_n87_), .d(new_n66_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n67_), .c(new_n85_), .O(new_n90_));
