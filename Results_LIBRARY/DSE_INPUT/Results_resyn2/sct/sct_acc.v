...
module FAU ( 
  ...
  nand4  g48(.a(new_n82_), .b(new_n81_), .c(new_n71_), .d(new_n67_), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n68_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n80_), .c(new_n48_), .O(z09));
  oai21  g52(.a(x03), .b(new_n36_), .c(x16), .O(new_n87_));
  inv1   g53(.a(x00), .O(new_n88_));
  nand2  g54(.a(new_n83_), .b(new_n88_), .O(new_n89_));
  nand3  g55(.a(new_n89_), .b(new_n68_), .c(new_n87_), .O(new_n90_));
  nand2  g56(.a(new_n47_), .b(x14), .O(new_n91_));
