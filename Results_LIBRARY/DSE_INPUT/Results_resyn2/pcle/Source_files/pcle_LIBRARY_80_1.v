...
module FAU ( 
  ...
  nor2   g27(.a(new_n49_), .b(new_n55_), .O(new_n56_));
  nand2  g28(.a(new_n49_), .b(new_n55_), .O(new_n57_));
  ...
  nor2   g32(.a(new_n55_), .b(new_n50_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n33_), .c(x16), .O(new_n62_));
  inv1   g34(.a(x16), .O(new_n63_));
  nand2  g35(.a(new_n61_), .b(new_n33_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n62_), .c(new_n45_), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n60_), .O(z6));
  nand2  g39(.a(x16), .b(x15), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n32_), .c(x17), .O(new_n69_));
  nor2   g41(.a(x17), .b(new_n63_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n61_), .c(new_n33_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n45_), .O(new_n73_));
