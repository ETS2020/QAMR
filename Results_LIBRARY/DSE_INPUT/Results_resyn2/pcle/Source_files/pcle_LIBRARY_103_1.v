// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:42 2020
...
module FAU ( 
  ...
  nand3  g02(.a(x17), .b(x16), .c(x14), .O(new_n31_));
  ...
  aoi21  g31(.a(new_n53_), .b(x15), .c(x16), .O(new_n60_));
  nand2  g32(.a(x16), .b(x15), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n49_), .c(new_n43_), .O(new_n62_));
  oai21  g34(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(z6));
  nand2  g35(.a(x08), .b(x06), .O(new_n64_));
  inv1   g36(.a(new_n61_), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(new_n53_), .c(x17), .O(new_n66_));
  inv1   g38(.a(x17), .O(new_n67_));
  oai21  g39(.a(new_n61_), .b(new_n49_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n66_), .c(new_n43_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n64_), .O(z7));
  oai21  g42(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n71_));
  nor2   g43(.a(x18), .b(new_n67_), .O(new_n72_));
  nand3  g44(.a(new_n72_), .b(new_n65_), .c(new_n53_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n43_), .O(new_n75_));
