...
module FAU ( 
  ...
  nand3  g32(.a(new_n60_), .b(new_n46_), .c(new_n30_), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n64_), .b(x12), .c(new_n65_), .O(new_n66_));
  nand2  g38(.a(new_n65_), .b(new_n64_), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n46_), .c(new_n30_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n66_), .c(new_n63_), .O(z6));
  ...
  nand3  g46(.a(new_n74_), .b(new_n71_), .c(new_n51_), .O(new_n75_));
  nand2  g47(.a(new_n75_), .b(new_n70_), .O(z7));
  nand2  g48(.a(x08), .b(x07), .O(new_n77_));
  inv1   g49(.a(x18), .O(new_n78_));
  oai21  g50(.a(new_n34_), .b(new_n32_), .c(new_n78_), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n36_), .c(new_n51_), .O(new_n80_));
