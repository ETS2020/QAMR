...
module FAU ( 
  ...
  nand2  g26(.a(new_n33_), .b(x15), .O(new_n55_));
  ...
  nand2  g39(.a(new_n61_), .b(x17), .O(new_n68_));
  ...
  aoi21  g45(.a(new_n61_), .b(x17), .c(x18), .O(new_n74_));
  nand2  g46(.a(new_n36_), .b(new_n45_), .O(new_n75_));
