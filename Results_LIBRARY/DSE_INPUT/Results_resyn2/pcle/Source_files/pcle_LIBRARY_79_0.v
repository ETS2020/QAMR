...
module FAU ( 
  ...
  oai21  g09(.a(x17), .b(x14), .c(new_n37_), .O(new_n38_));
  ...
  oai21  g15(.a(x17), .b(x14), .c(x11), .O(new_n44_));
  ...
  nand2  g27(.a(new_n42_), .b(new_n30_), .O(new_n56_));
  ...
  oai21  g33(.a(new_n61_), .b(x15), .c(new_n42_), .O(new_n62_));
  ...
  oai21  g38(.a(new_n59_), .b(new_n54_), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g44(.a(new_n72_), .b(x14), .c(new_n50_), .O(new_n73_));
  inv1   g45(.a(new_n59_), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(x16), .c(new_n71_), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n73_), .c(new_n42_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n70_), .O(z7));
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n78_));
  nand2  g50(.a(x17), .b(x16), .O(new_n79_));
  nor2   g51(.a(new_n79_), .b(x18), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n74_), .c(x14), .O(new_n81_));
