...
module FAU ( 
  ...
  nand3  g22(.a(x14), .b(x13), .c(new_n32_), .O(new_n52_));
  nand4  g23(.a(x12), .b(x11), .c(x09), .d(new_n31_), .O(new_n53_));
  oai21  g24(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(z5));
  inv1   g25(.a(x16), .O(new_n55_));
  nand2  g26(.a(x08), .b(x05), .O(new_n56_));
  oai21  g27(.a(new_n33_), .b(new_n55_), .c(new_n56_), .O(z6));
  inv1   g28(.a(x17), .O(new_n58_));
  nand2  g29(.a(x08), .b(x06), .O(new_n59_));
  oai21  g30(.a(new_n33_), .b(new_n58_), .c(new_n59_), .O(z7));
  inv1   g31(.a(x18), .O(new_n61_));
  nand2  g32(.a(x08), .b(x07), .O(new_n62_));
  oai21  g33(.a(new_n33_), .b(new_n61_), .c(new_n62_), .O(z8));
  zero   g34(.O(z0));
endmodule
