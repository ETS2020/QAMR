...
module FAU ( 
  ...
  aoi21  g19(.a(new_n30_), .b(new_n47_), .c(new_n34_), .O(new_n48_));
  oai21  g20(.a(new_n30_), .b(new_n47_), .c(new_n48_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n46_), .O(z4));
  nand2  g22(.a(x08), .b(x04), .O(new_n51_));
  nand3  g23(.a(x14), .b(x13), .c(x12), .O(new_n52_));
  nor2   g24(.a(new_n52_), .b(x15), .O(new_n53_));
  nand2  g25(.a(new_n52_), .b(x15), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(x11), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n53_), .c(new_n43_), .O(new_n56_));
  ...
  nand3  g32(.a(x15), .b(x12), .c(x11), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(new_n62_));
  inv1   g34(.a(new_n60_), .O(new_n63_));
  nand4  g35(.a(x16), .b(x15), .c(x12), .d(x11), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n62_), .c(new_n43_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n58_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  inv1   g41(.a(x17), .O(new_n70_));
  nor2   g42(.a(new_n66_), .b(new_n70_), .O(new_n71_));
  oai21  g43(.a(new_n64_), .b(new_n60_), .c(new_n70_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n43_), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n71_), .c(new_n69_), .O(z7));
  oai21  g46(.a(new_n31_), .b(new_n30_), .c(x18), .O(new_n75_));
  nor2   g47(.a(x18), .b(new_n70_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n65_), .c(new_n63_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n43_), .O(new_n79_));
