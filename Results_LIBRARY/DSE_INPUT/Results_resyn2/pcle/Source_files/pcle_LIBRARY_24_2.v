...
module FAU ( 
  ...
  nand3  g05(.a(x17), .b(x15), .c(x14), .O(new_n34_));
  ...
  nand4  g16(.a(new_n32_), .b(new_n30_), .c(x09), .d(new_n29_), .O(new_n45_));
  oai21  g17(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(z3));
  ...
  nand2  g24(.a(new_n52_), .b(new_n47_), .O(z4));
  xor2a  g25(.a(new_n49_), .b(x15), .O(new_n54_));
  nand2  g26(.a(x08), .b(x04), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n31_), .c(new_n55_), .O(z5));
  nand2  g28(.a(new_n49_), .b(x15), .O(new_n57_));
  inv1   g29(.a(x15), .O(new_n58_));
  nand2  g30(.a(x16), .b(new_n58_), .O(new_n59_));
  ...
  nand3  g40(.a(new_n68_), .b(new_n65_), .c(new_n48_), .O(new_n69_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n36_), .c(new_n48_), .O(new_n74_));
