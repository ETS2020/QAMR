...
module FAU ( 
  ...
  and2   g24(.a(x12), .b(x11), .O(new_n54_));
  and2   g25(.a(x14), .b(x13), .O(new_n55_));
  nand3  g26(.a(new_n55_), .b(new_n54_), .c(x15), .O(new_n56_));
  inv1   g27(.a(x15), .O(new_n57_));
  nand2  g28(.a(x14), .b(x13), .O(new_n58_));
  oai21  g29(.a(new_n58_), .b(new_n42_), .c(new_n57_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n56_), .c(new_n39_), .O(new_n60_));
  nand2  g31(.a(new_n60_), .b(new_n53_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n62_));
  oai21  g33(.a(new_n56_), .b(new_n33_), .c(new_n62_), .O(z6));
