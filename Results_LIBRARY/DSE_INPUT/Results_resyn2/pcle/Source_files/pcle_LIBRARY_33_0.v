// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:17 2020
...
module FAU ( 
  ...
  nand4  g28(.a(new_n56_), .b(new_n54_), .c(new_n33_), .d(x09), .O(new_n57_));
  ...
  nor2   g33(.a(new_n60_), .b(new_n53_), .O(new_n62_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n62_), .c(x17), .O(new_n67_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n55_), .c(new_n62_), .O(new_n74_));
