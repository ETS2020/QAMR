...
module FAU ( 
  ...
  nand2  g16(.a(new_n42_), .b(x14), .O(new_n45_));
  inv1   g17(.a(x14), .O(new_n46_));
  nand2  g18(.a(new_n46_), .b(x09), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n42_), .c(new_n45_), .O(new_n48_));
  ...
  nand3  g26(.a(new_n47_), .b(new_n45_), .c(x15), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(new_n54_), .c(new_n31_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n52_), .O(z5));
  inv1   g29(.a(x16), .O(new_n58_));
  nand2  g30(.a(x15), .b(x14), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x09), .O(new_n60_));
  aoi21  g32(.a(new_n60_), .b(new_n45_), .c(new_n58_), .O(new_n61_));
  nor3   g33(.a(new_n59_), .b(new_n42_), .c(x16), .O(new_n62_));
  ...
  aoi21  g40(.a(new_n68_), .b(new_n45_), .c(new_n66_), .O(new_n69_));
  nor3   g41(.a(new_n67_), .b(new_n42_), .c(x17), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n69_), .c(new_n31_), .O(new_n71_));
  ...
  oai21  g47(.a(new_n30_), .b(new_n29_), .c(new_n75_), .O(new_n76_));
  nand2  g48(.a(x17), .b(x16), .O(new_n77_));
  oai21  g49(.a(new_n59_), .b(new_n77_), .c(x09), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n45_), .c(x18), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n76_), .c(new_n31_), .O(new_n80_));
