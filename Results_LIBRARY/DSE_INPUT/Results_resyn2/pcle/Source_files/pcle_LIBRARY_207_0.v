...
module FAU ( 
  ...
  aoi21  g25(.a(new_n49_), .b(new_n53_), .c(new_n34_), .O(new_n54_));
  oai21  g26(.a(new_n49_), .b(new_n53_), .c(new_n54_), .O(new_n55_));
  nand2  g27(.a(new_n55_), .b(new_n52_), .O(z5));
  nand2  g28(.a(x08), .b(x05), .O(new_n57_));
  inv1   g29(.a(x16), .O(new_n58_));
  oai22  g30(.a(new_n49_), .b(new_n53_), .c(new_n58_), .d(x08), .O(new_n59_));
  nor2   g31(.a(new_n58_), .b(new_n53_), .O(new_n60_));
  inv1   g32(.a(new_n49_), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(new_n59_), .c(new_n33_), .d(x09), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(new_n57_), .O(z6));
  nand2  g36(.a(x08), .b(x06), .O(new_n65_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(x17), .O(new_n66_));
  ...
  nand3  g44(.a(new_n72_), .b(new_n61_), .c(new_n60_), .O(new_n73_));
