...
module FAU ( 
  ...
  oai21  g13(.a(new_n41_), .b(new_n35_), .c(new_n37_), .O(new_n42_));
  ...
  nand3  g27(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(new_n56_));
  ...
  nand3  g32(.a(new_n31_), .b(x15), .c(x14), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n58_), .O(z5));
  nand2  g35(.a(x08), .b(x05), .O(new_n64_));
  inv1   g36(.a(new_n42_), .O(new_n65_));
  nand2  g37(.a(new_n61_), .b(new_n41_), .O(new_n66_));
  ...
  aoi21  g43(.a(new_n67_), .b(x16), .c(x17), .O(new_n72_));
  nand2  g44(.a(new_n65_), .b(new_n34_), .O(new_n73_));
  ...
  oai21  g49(.a(new_n77_), .b(new_n53_), .c(new_n76_), .O(new_n78_));
