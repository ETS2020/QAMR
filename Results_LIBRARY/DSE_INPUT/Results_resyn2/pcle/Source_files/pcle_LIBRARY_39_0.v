...
module FAU ( 
  ...
  aoi21  g15(.a(new_n43_), .b(new_n42_), .c(new_n34_), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(new_n42_), .c(new_n44_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n41_), .O(z3));
  nand2  g18(.a(x08), .b(x03), .O(new_n47_));
  inv1   g19(.a(new_n34_), .O(new_n48_));
  inv1   g20(.a(x14), .O(new_n49_));
  aoi21  g21(.a(x13), .b(x12), .c(new_n49_), .O(new_n50_));
  nand3  g22(.a(new_n49_), .b(x13), .c(x12), .O(new_n51_));
  nand2  g23(.a(new_n51_), .b(x11), .O(new_n52_));
  oai21  g24(.a(new_n52_), .b(new_n50_), .c(new_n48_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(new_n48_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n63_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  nor2   g41(.a(new_n65_), .b(new_n56_), .O(new_n70_));
  nand3  g42(.a(new_n59_), .b(new_n70_), .c(x17), .O(new_n71_));
  inv1   g43(.a(x17), .O(new_n72_));
  nand2  g44(.a(new_n59_), .b(new_n70_), .O(new_n73_));
  ...
  nand3  g50(.a(new_n78_), .b(new_n59_), .c(new_n70_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n48_), .O(new_n81_));
