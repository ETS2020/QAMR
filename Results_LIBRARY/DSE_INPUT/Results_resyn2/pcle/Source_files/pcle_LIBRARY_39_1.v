...
module FAU ( 
  ...
  nor2   g26(.a(new_n54_), .b(x08), .O(new_n55_));
  nand3  g27(.a(new_n32_), .b(new_n55_), .c(new_n30_), .O(new_n56_));
  oai21  g28(.a(new_n56_), .b(new_n53_), .c(new_n51_), .O(z4));
  nand2  g29(.a(x08), .b(x04), .O(new_n58_));
  nand4  g30(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  nand2  g32(.a(new_n32_), .b(new_n60_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(new_n59_), .c(new_n44_), .O(new_n62_));
  ...
  nand3  g39(.a(new_n67_), .b(new_n55_), .c(new_n30_), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(z6));
  ...
  nand3  g51(.a(new_n79_), .b(new_n36_), .c(new_n44_), .O(new_n80_));
