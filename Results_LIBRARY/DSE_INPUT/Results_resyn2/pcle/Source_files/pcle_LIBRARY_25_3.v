// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:15 2020
...
module FAU ( 
  ...
  nand3  g07(.a(new_n35_), .b(x09), .c(new_n30_), .O(new_n36_));
  ...
  nor2   g25(.a(new_n29_), .b(new_n53_), .O(new_n54_));
  nand2  g26(.a(new_n29_), .b(new_n53_), .O(new_n55_));
  ...
  nor3   g32(.a(new_n60_), .b(new_n43_), .c(new_n59_), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(new_n43_), .c(new_n59_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  oai21  g35(.a(new_n63_), .b(new_n61_), .c(new_n58_), .O(z6));
  nand2  g36(.a(x08), .b(x06), .O(new_n65_));
  inv1   g37(.a(new_n29_), .O(new_n66_));
  xnor2a g38(.a(x17), .b(x16), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(new_n66_), .c(x15), .O(new_n68_));
  inv1   g40(.a(x17), .O(new_n69_));
  oai21  g41(.a(new_n60_), .b(new_n43_), .c(new_n69_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n68_), .c(new_n44_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n65_), .O(z7));
  ...
  nand2  g49(.a(new_n77_), .b(new_n35_), .O(new_n78_));
  nand3  g50(.a(new_n78_), .b(new_n76_), .c(new_n48_), .O(new_n79_));
  oai21  g51(.a(new_n75_), .b(new_n43_), .c(new_n77_), .O(new_n80_));
  nand3  g52(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n73_), .O(z8));
endmodule
