...
module FAU ( 
  ...
  nand4  g02(.a(x18), .b(x17), .c(x16), .d(x14), .O(new_n31_));
  ...
  nand2  g24(.a(new_n47_), .b(new_n29_), .O(new_n53_));
  inv1   g25(.a(new_n30_), .O(new_n54_));
  nand3  g26(.a(new_n54_), .b(x15), .c(x14), .O(new_n55_));
  inv1   g27(.a(x09), .O(new_n56_));
  nand2  g28(.a(new_n33_), .b(new_n32_), .O(new_n57_));
  aoi21  g29(.a(x15), .b(new_n56_), .c(new_n57_), .O(new_n58_));
  nand3  g30(.a(new_n58_), .b(new_n55_), .c(new_n53_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n52_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n61_));
  inv1   g33(.a(x16), .O(new_n62_));
  nand2  g34(.a(new_n55_), .b(new_n62_), .O(new_n63_));
  nand3  g35(.a(x16), .b(x15), .c(x14), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  nand2  g37(.a(new_n65_), .b(new_n54_), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n63_), .c(new_n58_), .O(new_n67_));
  nand2  g39(.a(new_n67_), .b(new_n61_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n69_));
  aoi21  g41(.a(new_n65_), .b(new_n54_), .c(x17), .O(new_n70_));
  nand3  g42(.a(new_n65_), .b(new_n54_), .c(x17), .O(new_n71_));
  ...
  oai21  g49(.a(new_n31_), .b(new_n30_), .c(x09), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(x15), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n77_), .c(new_n75_), .O(new_n80_));
