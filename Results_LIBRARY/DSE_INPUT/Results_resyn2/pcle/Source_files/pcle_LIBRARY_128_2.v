...
module FAU ( 
  ...
  and2   g05(.a(x16), .b(x15), .O(new_n34_));
  nand4  g06(.a(new_n34_), .b(new_n33_), .c(new_n32_), .d(x17), .O(new_n35_));
  ...
  nand2  g31(.a(new_n59_), .b(new_n53_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n61_));
  nand2  g33(.a(new_n34_), .b(new_n57_), .O(new_n62_));
  inv1   g34(.a(x16), .O(new_n63_));
  oai21  g35(.a(new_n50_), .b(new_n55_), .c(new_n63_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(new_n62_), .c(new_n54_), .O(new_n65_));
  ...
  oai21  g41(.a(new_n69_), .b(new_n50_), .c(new_n68_), .O(new_n70_));
  nand3  g42(.a(new_n70_), .b(new_n35_), .c(new_n54_), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n67_), .O(z7));
  nand2  g44(.a(x08), .b(x07), .O(new_n73_));
  inv1   g45(.a(x18), .O(new_n74_));
  nand2  g46(.a(new_n74_), .b(new_n55_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n35_), .c(new_n54_), .O(new_n76_));
