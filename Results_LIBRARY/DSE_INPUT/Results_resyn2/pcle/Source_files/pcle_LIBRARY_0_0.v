// Benchmark "FAU" written by ABC on Mon Jul 27 18:24:07 2020
...
module FAU ( 
  ...
  nor2   g10(.a(x12), .b(x11), .O(new_n39_));
  nand2  g11(.a(x12), .b(x11), .O(new_n40_));
  nand3  g12(.a(new_n40_), .b(new_n33_), .c(x09), .O(new_n41_));
  oai21  g13(.a(new_n41_), .b(new_n39_), .c(new_n38_), .O(z2));
  ...
  nand3  g40(.a(new_n55_), .b(new_n64_), .c(x17), .O(new_n69_));
  ...
  nand3  g47(.a(new_n75_), .b(new_n55_), .c(new_n64_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n45_), .O(new_n78_));
