...
module FAU ( 
  ...
  oai21  g09(.a(x13), .b(x12), .c(new_n37_), .O(new_n38_));
  ...
  nand3  g18(.a(new_n46_), .b(new_n44_), .c(new_n30_), .O(new_n47_));
  ...
  nor2   g30(.a(new_n57_), .b(new_n52_), .O(new_n59_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n50_), .c(x16), .O(new_n64_));
  ...
  nand3  g43(.a(new_n71_), .b(new_n50_), .c(x17), .O(new_n72_));
  inv1   g44(.a(x17), .O(new_n73_));
  oai21  g45(.a(new_n70_), .b(new_n30_), .c(new_n73_), .O(new_n74_));
  ...
  nand4  g49(.a(new_n71_), .b(new_n50_), .c(new_n29_), .d(x17), .O(new_n78_));
