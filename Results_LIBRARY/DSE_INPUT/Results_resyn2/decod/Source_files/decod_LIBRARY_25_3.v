// Benchmark "FAU" written by ABC on Mon Jul 27 20:37:11 2020
...
module FAU ( 
  ...
  nor2   g11(.a(new_n34_), .b(new_n32_), .O(z05));
  nand4  g12(.a(x4), .b(x3), .c(new_n26_), .d(x0), .O(new_n36_));
  inv1   g13(.a(new_n36_), .O(z06));
  nand3  g14(.a(x4), .b(new_n33_), .c(new_n26_), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n32_), .O(z07));
