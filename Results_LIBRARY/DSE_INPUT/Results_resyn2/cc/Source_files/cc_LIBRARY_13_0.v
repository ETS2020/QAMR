// Benchmark "FAU" written by ABC on Mon Jul 27 21:10:48 2020
...
module FAU ( 
  ...
  inv1   g43(.a(new_n49_), .O(new_n85_));
  nand2  g44(.a(x19), .b(x12), .O(new_n86_));
  aoi21  g45(.a(new_n85_), .b(new_n84_), .c(new_n86_), .O(z18));
