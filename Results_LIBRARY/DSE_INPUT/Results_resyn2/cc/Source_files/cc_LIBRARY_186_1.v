...
module FAU ( 
  ...
  nand4  g10(.a(x15), .b(new_n45_), .c(x12), .d(x10), .O(new_n52_));
  ...
  nand2  g23(.a(x10), .b(x01), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x14), .O(new_n66_));
  nand2  g25(.a(x15), .b(x10), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z13));
  aoi21  g27(.a(x10), .b(x02), .c(x15), .O(new_n69_));
  nand2  g28(.a(new_n67_), .b(x12), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(z14));
  aoi22  g30(.a(x16), .b(new_n45_), .c(new_n48_), .d(x10), .O(new_n72_));
  inv1   g31(.a(x03), .O(new_n73_));
  nand3  g32(.a(new_n48_), .b(x10), .c(new_n73_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n72_), .O(z15));
  inv1   g35(.a(x04), .O(new_n77_));
  nand3  g36(.a(new_n48_), .b(x10), .c(new_n77_), .O(new_n78_));
  inv1   g37(.a(x17), .O(new_n79_));
  oai21  g38(.a(x15), .b(new_n59_), .c(new_n79_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n78_), .c(x12), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z16));
  inv1   g41(.a(x05), .O(new_n83_));
  nand3  g42(.a(new_n48_), .b(x10), .c(new_n83_), .O(new_n84_));
  oai21  g43(.a(x15), .b(new_n59_), .c(z04), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(x12), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z17));
  inv1   g46(.a(x06), .O(new_n88_));
  nand3  g47(.a(new_n48_), .b(x10), .c(new_n88_), .O(new_n89_));
  inv1   g48(.a(x19), .O(new_n90_));
  oai21  g49(.a(x15), .b(new_n59_), .c(new_n90_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(new_n89_), .c(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z18));
  inv1   g52(.a(x07), .O(new_n94_));
  nand3  g53(.a(new_n48_), .b(x10), .c(new_n94_), .O(new_n95_));
  oai21  g54(.a(x15), .b(new_n59_), .c(new_n43_), .O(new_n96_));
