...
module FAU ( 
  ...
  oai21  g25(.a(x14), .b(x08), .c(x15), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z13));
  inv1   g27(.a(x08), .O(new_n69_));
  nand2  g28(.a(x15), .b(new_n69_), .O(new_n70_));
  nand4  g29(.a(new_n48_), .b(x10), .c(x08), .d(x02), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z14));
  ...
  oai21  g44(.a(new_n60_), .b(x15), .c(z04), .O(new_n86_));
  ...
  oai21  g50(.a(new_n60_), .b(x15), .c(new_n91_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n97_));
