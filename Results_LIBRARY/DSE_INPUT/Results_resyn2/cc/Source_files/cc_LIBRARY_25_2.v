...
module FAU ( 
  ...
  nand4  g16(.a(new_n48_), .b(x10), .c(x08), .d(x00), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n52_), .O(z12));
  ...
  oai21  g31(.a(new_n61_), .b(x15), .c(new_n72_), .O(new_n73_));
  ...
  oai21  g36(.a(new_n61_), .b(x15), .c(z04), .O(new_n78_));
  ...
  oai21  g42(.a(new_n61_), .b(x15), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g47(.a(new_n61_), .b(x15), .c(new_n43_), .O(new_n89_));
