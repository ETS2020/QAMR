// Benchmark "FAU" written by ABC on Mon Jul 27 21:12:29 2020
...
module FAU ( 
  ...
  nand2  g32(.a(x15), .b(x14), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n60_), .c(new_n73_), .O(new_n75_));
  ...
  oai21  g40(.a(new_n60_), .b(x15), .c(z04), .O(new_n82_));
