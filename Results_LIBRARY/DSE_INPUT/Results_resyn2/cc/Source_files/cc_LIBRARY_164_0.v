// Benchmark "FAU" written by ABC on Mon Jul 27 21:12:03 2020
...
module FAU ( 
  ...
  inv1   g16(.a(new_n49_), .O(new_n58_));
  nand2  g17(.a(x13), .b(x12), .O(new_n59_));
  aoi21  g18(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z12));
  inv1   g19(.a(x01), .O(new_n61_));
  nand2  g20(.a(x10), .b(x08), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n61_), .c(x14), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n45_), .c(new_n52_), .O(z13));
  nand3  g23(.a(x10), .b(x08), .c(x02), .O(new_n65_));
  nand2  g24(.a(new_n45_), .b(x12), .O(new_n66_));
  aoi21  g25(.a(new_n65_), .b(new_n48_), .c(new_n66_), .O(z14));
  nand3  g26(.a(new_n49_), .b(x16), .c(new_n47_), .O(new_n68_));
  nand4  g27(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z15));
  inv1   g29(.a(x04), .O(new_n71_));
  nand4  g30(.a(new_n48_), .b(x10), .c(x08), .d(new_n71_), .O(new_n72_));
  inv1   g31(.a(x17), .O(new_n73_));
  oai21  g32(.a(new_n62_), .b(x15), .c(new_n73_), .O(new_n74_));
  ...
  oai21  g37(.a(new_n62_), .b(x15), .c(z04), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n78_), .c(x12), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z17));
  inv1   g40(.a(x06), .O(new_n82_));
  nand4  g41(.a(new_n48_), .b(x10), .c(x08), .d(new_n82_), .O(new_n83_));
  inv1   g42(.a(x19), .O(new_n84_));
  oai21  g43(.a(new_n62_), .b(x15), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n62_), .b(x15), .c(new_n43_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(new_n89_), .c(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z19));
  buf    g51(.a(x19), .O(z05));
  buf    g52(.a(x15), .O(z06));
  buf    g53(.a(x17), .O(z07));
  buf    g54(.a(x16), .O(z08));
