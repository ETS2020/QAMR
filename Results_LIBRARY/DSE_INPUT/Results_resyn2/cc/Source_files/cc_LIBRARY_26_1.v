...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n57_, new_n58_, new_n59_, new_n60_, new_n61_,
    ...
    new_n89_, new_n91_, new_n92_, new_n93_, new_n94_, new_n95_;
  ...
  aoi21  g09(.a(new_n48_), .b(new_n44_), .c(new_n50_), .O(z02));
  inv1   g10(.a(x12), .O(new_n52_));
  nor3   g11(.a(new_n42_), .b(x14), .c(new_n52_), .O(z03));
  inv1   g12(.a(x18), .O(z04));
  nand2  g13(.a(x09), .b(x08), .O(z10));
  inv1   g14(.a(z10), .O(z09));
  inv1   g15(.a(x00), .O(new_n57_));
  nand4  g16(.a(new_n45_), .b(x10), .c(x08), .d(new_n57_), .O(new_n58_));
  inv1   g17(.a(x13), .O(new_n59_));
  oai21  g18(.a(new_n46_), .b(x15), .c(new_n59_), .O(new_n60_));
  ...
  aoi21  g23(.a(new_n64_), .b(new_n42_), .c(new_n52_), .O(z13));
  nand2  g24(.a(new_n47_), .b(x02), .O(new_n66_));
  nand2  g25(.a(new_n42_), .b(x12), .O(new_n67_));
  aoi21  g26(.a(new_n66_), .b(new_n45_), .c(new_n67_), .O(z14));
  nand2  g27(.a(x16), .b(new_n44_), .O(new_n69_));
  inv1   g28(.a(x03), .O(new_n70_));
  nand4  g29(.a(new_n45_), .b(x10), .c(x08), .d(new_n70_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x12), .O(new_n72_));
  aoi21  g31(.a(new_n69_), .b(new_n48_), .c(new_n72_), .O(z15));
  inv1   g32(.a(x04), .O(new_n74_));
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(new_n74_), .O(new_n75_));
  inv1   g34(.a(x17), .O(new_n76_));
  oai21  g35(.a(new_n46_), .b(x15), .c(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n75_), .c(x12), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z16));
  inv1   g38(.a(x05), .O(new_n80_));
  nand4  g39(.a(new_n45_), .b(x10), .c(x08), .d(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n46_), .b(x15), .c(z04), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n81_), .c(x12), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z17));
  inv1   g43(.a(x06), .O(new_n85_));
  nand4  g44(.a(new_n45_), .b(x10), .c(x08), .d(new_n85_), .O(new_n86_));
  inv1   g45(.a(x19), .O(new_n87_));
  oai21  g46(.a(new_n46_), .b(x15), .c(new_n87_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n86_), .c(x12), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z18));
  inv1   g49(.a(x07), .O(new_n91_));
  nand4  g50(.a(new_n45_), .b(x10), .c(x08), .d(new_n91_), .O(new_n92_));
  inv1   g51(.a(x20), .O(new_n93_));
  oai21  g52(.a(new_n46_), .b(x15), .c(new_n93_), .O(new_n94_));
