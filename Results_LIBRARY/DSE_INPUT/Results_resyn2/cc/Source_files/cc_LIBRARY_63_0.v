// Benchmark "FAU" written by ABC on Mon Jul 27 21:11:12 2020
...
module FAU ( 
  ...
  aoi21  g11(.a(new_n51_), .b(new_n45_), .c(new_n52_), .O(z02));
  inv1   g12(.a(x12), .O(new_n54_));
  nor2   g13(.a(new_n48_), .b(new_n54_), .O(z03));
  inv1   g14(.a(x18), .O(z04));
  nand2  g15(.a(x09), .b(x08), .O(z10));
  inv1   g16(.a(z10), .O(z09));
  inv1   g17(.a(x00), .O(new_n59_));
  nand4  g18(.a(new_n50_), .b(x10), .c(x08), .d(new_n59_), .O(new_n60_));
  inv1   g19(.a(x13), .O(new_n61_));
  nand2  g20(.a(new_n51_), .b(new_n61_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n60_), .c(x12), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z12));
  nand4  g23(.a(new_n50_), .b(x10), .c(x08), .d(x01), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n48_), .c(new_n54_), .O(z13));
  nand3  g26(.a(x10), .b(x08), .c(x02), .O(new_n68_));
  nand2  g27(.a(new_n46_), .b(x12), .O(new_n69_));
  aoi21  g28(.a(new_n68_), .b(new_n50_), .c(new_n69_), .O(z14));
  nand3  g29(.a(new_n51_), .b(x16), .c(new_n45_), .O(new_n71_));
  nand4  g30(.a(new_n50_), .b(x10), .c(x08), .d(x03), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n54_), .O(z15));
  inv1   g32(.a(x04), .O(new_n74_));
  nand3  g33(.a(new_n50_), .b(x10), .c(new_n74_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x17), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nand2  g36(.a(new_n50_), .b(new_n77_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n54_), .O(z16));
  inv1   g38(.a(x05), .O(new_n80_));
  nand4  g39(.a(new_n50_), .b(x10), .c(x08), .d(new_n80_), .O(new_n81_));
  nand2  g40(.a(new_n51_), .b(z04), .O(new_n82_));
  ...
  nand2  g46(.a(new_n51_), .b(new_n87_), .O(new_n88_));
  ...
  nand2  g51(.a(new_n51_), .b(new_n43_), .O(new_n93_));
