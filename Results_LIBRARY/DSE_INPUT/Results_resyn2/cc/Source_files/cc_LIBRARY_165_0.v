// Benchmark "FAU" written by ABC on Mon Jul 27 21:12:04 2020
...
module FAU ( 
  ...
  nand2  g20(.a(new_n49_), .b(new_n61_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(new_n60_), .c(x12), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z12));
  inv1   g23(.a(x01), .O(new_n65_));
  oai21  g24(.a(new_n58_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n45_), .c(new_n52_), .O(z13));
  ...
  nand2  g30(.a(new_n59_), .b(x03), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z15));
  inv1   g32(.a(x04), .O(new_n74_));
  nand2  g33(.a(new_n59_), .b(new_n74_), .O(new_n75_));
  inv1   g34(.a(x17), .O(new_n76_));
  nand2  g35(.a(new_n49_), .b(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n75_), .c(x12), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z16));
  inv1   g38(.a(x05), .O(new_n80_));
  nand2  g39(.a(new_n59_), .b(new_n80_), .O(new_n81_));
  nand2  g40(.a(new_n49_), .b(z04), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n81_), .c(x12), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z17));
  inv1   g43(.a(x08), .O(new_n85_));
  oai21  g44(.a(x15), .b(new_n85_), .c(x19), .O(new_n86_));
  inv1   g45(.a(x10), .O(new_n87_));
  nor2   g46(.a(x15), .b(new_n85_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(x06), .c(new_n87_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n86_), .c(new_n52_), .O(z18));
  inv1   g49(.a(x07), .O(new_n91_));
  nand2  g50(.a(new_n59_), .b(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n49_), .b(new_n43_), .O(new_n93_));
