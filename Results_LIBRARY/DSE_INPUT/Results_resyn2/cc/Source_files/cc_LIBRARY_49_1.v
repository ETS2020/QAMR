// Benchmark "FAU" written by ABC on Mon Jul 27 21:11:05 2020
...
module FAU ( 
  ...
  inv1   g42(.a(x08), .O(new_n84_));
  oai21  g43(.a(x15), .b(new_n84_), .c(x19), .O(new_n85_));
  nand4  g44(.a(new_n48_), .b(x10), .c(x08), .d(x06), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n52_), .O(z18));
