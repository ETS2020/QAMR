// Benchmark "FAU" written by ABC on Mon Jul 27 21:10:45 2020
...
module FAU ( 
  ...
  nand2  g37(.a(new_n60_), .b(x18), .O(new_n79_));
  nand4  g38(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n80_));
  ...
  oai21  g43(.a(new_n60_), .b(x15), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g48(.a(new_n60_), .b(x15), .c(new_n43_), .O(new_n90_));
