...
module FAU ( 
  ...
  oai21  g16(.a(new_n45_), .b(x15), .c(new_n57_), .O(new_n58_));
  nand3  g17(.a(new_n58_), .b(new_n56_), .c(x12), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z12));
  inv1   g19(.a(x12), .O(new_n61_));
  oai21  g20(.a(new_n45_), .b(x15), .c(x14), .O(new_n62_));
  nand2  g21(.a(x14), .b(x01), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x10), .c(x08), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n62_), .c(new_n61_), .O(z13));
  nand2  g24(.a(new_n45_), .b(x15), .O(new_n66_));
  nand4  g25(.a(new_n55_), .b(x10), .c(x08), .d(x02), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n66_), .c(new_n61_), .O(z14));
  inv1   g27(.a(x14), .O(new_n69_));
  nand2  g28(.a(x16), .b(new_n69_), .O(new_n70_));
  nand4  g29(.a(new_n55_), .b(x10), .c(x08), .d(x03), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n61_), .O(z15));
  inv1   g31(.a(x04), .O(new_n73_));
  nand4  g32(.a(new_n55_), .b(x10), .c(x08), .d(new_n73_), .O(new_n74_));
  inv1   g33(.a(x17), .O(new_n75_));
  oai21  g34(.a(new_n45_), .b(x15), .c(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n74_), .c(x12), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z16));
  inv1   g37(.a(x05), .O(new_n79_));
  nand4  g38(.a(new_n55_), .b(x10), .c(x08), .d(new_n79_), .O(new_n80_));
  oai21  g39(.a(new_n45_), .b(x15), .c(z04), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n80_), .c(x12), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z17));
  inv1   g42(.a(x06), .O(new_n84_));
  nand4  g43(.a(new_n55_), .b(x10), .c(x08), .d(new_n84_), .O(new_n85_));
  inv1   g44(.a(x19), .O(new_n86_));
  oai21  g45(.a(new_n45_), .b(x15), .c(new_n86_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n85_), .c(x12), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z18));
  inv1   g48(.a(x07), .O(new_n90_));
  nand4  g49(.a(new_n55_), .b(x10), .c(x08), .d(new_n90_), .O(new_n91_));
  oai21  g50(.a(new_n45_), .b(x15), .c(new_n43_), .O(new_n92_));
