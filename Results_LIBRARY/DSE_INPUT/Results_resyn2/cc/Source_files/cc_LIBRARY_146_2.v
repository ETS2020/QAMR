// Benchmark "FAU" written by ABC on Mon Jul 27 21:11:55 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  nand2  g06(.a(x14), .b(new_n42_), .O(new_n48_));
  ...
  aoi21  g11(.a(new_n52_), .b(new_n48_), .c(new_n47_), .O(z02));
  nor3   g12(.a(new_n45_), .b(x14), .c(new_n47_), .O(z03));
  inv1   g13(.a(x18), .O(z04));
  nand2  g14(.a(x09), .b(x08), .O(z10));
  inv1   g15(.a(z10), .O(z09));
  inv1   g16(.a(x00), .O(new_n58_));
  nand4  g17(.a(new_n49_), .b(x10), .c(x08), .d(new_n58_), .O(new_n59_));
  inv1   g18(.a(x13), .O(new_n60_));
  oai21  g19(.a(new_n50_), .b(x15), .c(new_n60_), .O(new_n61_));
  nand3  g20(.a(new_n61_), .b(new_n59_), .c(x12), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z12));
  inv1   g22(.a(x01), .O(new_n64_));
  oai21  g23(.a(new_n50_), .b(new_n64_), .c(x14), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n45_), .c(new_n47_), .O(z13));
  nand2  g25(.a(new_n51_), .b(x02), .O(new_n67_));
  nand2  g26(.a(new_n45_), .b(x12), .O(new_n68_));
  aoi21  g27(.a(new_n67_), .b(new_n49_), .c(new_n68_), .O(z14));
  inv1   g28(.a(x14), .O(new_n70_));
  nand2  g29(.a(x16), .b(new_n70_), .O(new_n71_));
  inv1   g30(.a(x03), .O(new_n72_));
  nand4  g31(.a(new_n49_), .b(x10), .c(x08), .d(new_n72_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x12), .O(new_n74_));
  aoi21  g33(.a(new_n71_), .b(new_n52_), .c(new_n74_), .O(z15));
  inv1   g34(.a(x04), .O(new_n76_));
  nand4  g35(.a(new_n49_), .b(x10), .c(x08), .d(new_n76_), .O(new_n77_));
  inv1   g36(.a(x17), .O(new_n78_));
  oai21  g37(.a(new_n50_), .b(x15), .c(new_n78_), .O(new_n79_));
  ...
  oai21  g53(.a(new_n50_), .b(x15), .c(new_n43_), .O(new_n95_));
