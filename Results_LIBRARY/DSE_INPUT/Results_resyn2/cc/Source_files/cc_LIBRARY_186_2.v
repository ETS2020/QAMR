...
module FAU ( 
  ...
  nand3  g23(.a(new_n48_), .b(x08), .c(x01), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n46_), .c(new_n64_), .O(z13));
  nand2  g26(.a(x15), .b(new_n59_), .O(new_n68_));
  nand3  g27(.a(new_n48_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(z14));
  nand3  g29(.a(new_n48_), .b(x08), .c(x03), .O(new_n71_));
  nand3  g30(.a(new_n49_), .b(x16), .c(new_n45_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n64_), .O(z15));
