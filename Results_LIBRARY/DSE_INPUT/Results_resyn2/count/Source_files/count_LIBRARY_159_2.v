...
module FAU ( 
  ...
  nand4  g044(.a(new_n95_), .b(new_n94_), .c(new_n76_), .d(new_n69_), .O(new_n96_));
  ...
  nand4  g054(.a(new_n105_), .b(new_n95_), .c(new_n94_), .d(new_n76_), .O(new_n106_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n87_), .c(new_n85_), .d(new_n55_), .O(new_n113_));
  ...
  nor2   g082(.a(new_n133_), .b(new_n86_), .O(new_n134_));
  ...
  oai21  g087(.a(new_n133_), .b(new_n86_), .c(x29), .O(new_n139_));
  nor3   g088(.a(x29), .b(x28), .c(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n115_), .c(new_n89_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n132_), .b(new_n131_), .c(new_n147_), .d(new_n95_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n88_), .c(x30), .O(new_n149_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n115_), .c(new_n89_), .O(new_n155_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n161_), .c(new_n122_), .d(new_n105_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n104_), .c(x32), .O(new_n175_));
  inv1   g124(.a(x26), .O(new_n176_));
  inv1   g125(.a(x32), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n164_), .c(new_n176_), .d(new_n105_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n154_), .c(new_n97_), .d(new_n63_), .O(new_n180_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n166_), .c(new_n107_), .d(new_n71_), .O(new_n192_));
