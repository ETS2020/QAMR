// Benchmark "FAU" written by ABC on Mon Jul 27 22:44:51 2020
...
module FAU ( 
  ...
  nor2   g083(.a(new_n128_), .b(new_n134_), .O(new_n135_));
  oai21  g084(.a(new_n129_), .b(x30), .c(x16), .O(new_n136_));
  ...
  nand2  g090(.a(new_n125_), .b(new_n141_), .O(new_n142_));
  nand2  g091(.a(new_n134_), .b(new_n117_), .O(new_n143_));
  nor2   g092(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n98_), .c(new_n140_), .O(new_n145_));
  nor2   g094(.a(x31), .b(x30), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n128_), .O(new_n148_));
  ...
  nand2  g101(.a(new_n146_), .b(new_n141_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n119_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n98_), .O(new_n155_));
  inv1   g104(.a(x32), .O(new_n156_));
  nand3  g105(.a(new_n146_), .b(new_n127_), .c(new_n156_), .O(new_n157_));
  nor2   g106(.a(new_n157_), .b(new_n105_), .O(new_n158_));
  ...
  oai21  g111(.a(new_n158_), .b(x33), .c(x16), .O(new_n163_));
  inv1   g112(.a(x01), .O(new_n164_));
  aoi21  g113(.a(new_n56_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n163_), .O(z14));
  oai21  g115(.a(new_n157_), .b(new_n105_), .c(x34), .O(new_n167_));
  nor2   g116(.a(x34), .b(x32), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n154_), .c(new_n98_), .O(new_n169_));
