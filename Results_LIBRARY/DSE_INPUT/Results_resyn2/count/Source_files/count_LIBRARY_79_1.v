// Benchmark "FAU" written by ABC on Mon Jul 27 22:44:50 2020
...
module FAU ( 
  ...
  nand4  g040(.a(new_n74_), .b(new_n55_), .c(new_n85_), .d(new_n61_), .O(new_n92_));
  ...
  nand3  g056(.a(new_n107_), .b(new_n99_), .c(new_n63_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n107_), .b(new_n87_), .c(new_n118_), .O(new_n119_));
  inv1   g068(.a(x26), .O(new_n120_));
  nand2  g069(.a(new_n118_), .b(new_n120_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(x28), .O(new_n122_));
  aoi22  g071(.a(new_n122_), .b(new_n102_), .c(new_n119_), .d(x28), .O(new_n123_));
  ...
  nand3  g075(.a(new_n122_), .b(new_n100_), .c(new_n87_), .O(new_n127_));
  ...
  nand3  g081(.a(new_n128_), .b(new_n109_), .c(x30), .O(new_n133_));
  inv1   g082(.a(x30), .O(new_n134_));
  inv1   g083(.a(new_n128_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n108_), .c(new_n134_), .O(new_n136_));
  nand3  g085(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  inv1   g086(.a(x04), .O(new_n138_));
  aoi21  g087(.a(new_n58_), .b(new_n138_), .c(x18), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n137_), .O(z11));
  nand3  g089(.a(new_n128_), .b(new_n134_), .c(new_n120_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n101_), .c(x31), .O(new_n142_));
  inv1   g091(.a(x28), .O(new_n143_));
  inv1   g092(.a(x29), .O(new_n144_));
  inv1   g093(.a(x31), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n134_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand4  g096(.a(new_n147_), .b(new_n107_), .c(new_n87_), .d(new_n118_), .O(new_n148_));
  ...
  nor3   g103(.a(x31), .b(x30), .c(x29), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n154_), .c(new_n143_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n101_), .c(x32), .O(new_n157_));
  nor2   g106(.a(new_n146_), .b(new_n121_), .O(new_n158_));
  nor2   g107(.a(x32), .b(x25), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n158_), .c(new_n87_), .d(new_n97_), .O(new_n160_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n58_), .c(new_n167_), .O(z14));
  nor3   g117(.a(x32), .b(x28), .c(x27), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n155_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n108_), .c(x34), .O(new_n171_));
  inv1   g120(.a(x32), .O(new_n172_));
  inv1   g121(.a(x34), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n146_), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n107_), .c(new_n87_), .d(new_n118_), .O(new_n176_));
