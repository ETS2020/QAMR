...
module FAU ( 
  ...
  nand3  g055(.a(new_n106_), .b(new_n91_), .c(new_n72_), .O(new_n107_));
  ...
  nor2   g071(.a(new_n122_), .b(new_n92_), .O(new_n123_));
  ...
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n113_), .O(new_n130_));
  nor3   g079(.a(new_n130_), .b(new_n107_), .c(new_n65_), .O(new_n131_));
  nor2   g080(.a(new_n123_), .b(new_n129_), .O(new_n132_));
  ...
  nor2   g085(.a(new_n131_), .b(x30), .O(new_n137_));
  inv1   g086(.a(new_n130_), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n106_), .c(x30), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n92_), .c(x16), .O(new_n140_));
  inv1   g089(.a(x04), .O(new_n141_));
  aoi21  g090(.a(new_n52_), .b(new_n141_), .c(x18), .O(new_n142_));
  oai21  g091(.a(new_n140_), .b(new_n137_), .c(new_n142_), .O(z11));
  inv1   g092(.a(x31), .O(new_n144_));
  nor2   g093(.a(x30), .b(x29), .O(new_n145_));
  aoi21  g094(.a(new_n145_), .b(new_n123_), .c(new_n144_), .O(new_n146_));
  ...
  nand2  g102(.a(new_n147_), .b(new_n123_), .O(new_n154_));
  inv1   g103(.a(x30), .O(new_n155_));
  inv1   g104(.a(x32), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n144_), .c(new_n155_), .O(new_n157_));
  ...
  aoi21  g109(.a(new_n154_), .b(x32), .c(new_n160_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n165_), .b(new_n121_), .c(new_n156_), .d(new_n129_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n107_), .c(x33), .O(new_n167_));
  inv1   g116(.a(new_n73_), .O(new_n168_));
  inv1   g117(.a(x34), .O(new_n169_));
  nand2  g118(.a(new_n90_), .b(new_n81_), .O(new_n170_));
  aoi21  g119(.a(new_n169_), .b(x33), .c(new_n170_), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n158_), .c(new_n106_), .d(new_n168_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n167_), .c(x19), .O(new_n173_));
  inv1   g122(.a(x33), .O(new_n174_));
  nor2   g123(.a(new_n60_), .b(new_n174_), .O(new_n175_));
  ...
  nand4  g128(.a(new_n165_), .b(new_n138_), .c(new_n108_), .d(new_n156_), .O(new_n180_));
  nor3   g129(.a(x34), .b(x33), .c(x32), .O(new_n181_));
  aoi22  g130(.a(new_n181_), .b(new_n149_), .c(new_n180_), .d(x34), .O(new_n182_));
