...
module FAU ( 
  ...
  nand2  g024(.a(new_n69_), .b(new_n74_), .O(new_n76_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n92_), .c(new_n60_), .d(new_n114_), .O(new_n115_));
  ...
  nand2  g070(.a(new_n121_), .b(new_n106_), .O(new_n122_));
  ...
  oai21  g076(.a(new_n122_), .b(new_n98_), .c(x29), .O(new_n128_));
  inv1   g077(.a(new_n122_), .O(new_n129_));
  nor2   g078(.a(x29), .b(x24), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n129_), .c(new_n84_), .O(new_n131_));
  ...
  nand4  g086(.a(new_n130_), .b(new_n121_), .c(new_n106_), .d(new_n137_), .O(new_n138_));
  ...
  oai21  g092(.a(new_n138_), .b(new_n83_), .c(x31), .O(new_n144_));
  nor2   g093(.a(x29), .b(x26), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n121_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nor3   g096(.a(x31), .b(x30), .c(x25), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n92_), .d(new_n60_), .O(new_n149_));
  ...
  nor2   g104(.a(x30), .b(x25), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n145_), .c(new_n121_), .d(new_n155_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n98_), .c(x32), .O(new_n158_));
  nor2   g107(.a(x32), .b(x31), .O(new_n159_));
  nand3  g108(.a(new_n145_), .b(new_n121_), .c(new_n137_), .O(new_n160_));
  inv1   g109(.a(new_n160_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n159_), .c(new_n101_), .O(new_n162_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n159_), .c(new_n121_), .d(new_n106_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n98_), .c(x33), .O(new_n170_));
  nor3   g119(.a(x33), .b(x32), .c(x31), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n161_), .c(new_n101_), .O(new_n172_));
  ...
  nand2  g127(.a(new_n159_), .b(x33), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n161_), .c(new_n101_), .O(new_n181_));
