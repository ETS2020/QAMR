...
module FAU ( 
  ...
  inv1   g031(.a(new_n71_), .O(new_n83_));
  ...
  aoi22  g055(.a(new_n106_), .b(new_n87_), .c(new_n105_), .d(x26), .O(new_n107_));
  ...
  nand2  g059(.a(new_n106_), .b(new_n87_), .O(new_n111_));
  nor2   g060(.a(x27), .b(x26), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n113_));
  ...
  nand4  g068(.a(new_n119_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n120_));
  ...
  oai21  g076(.a(new_n127_), .b(new_n111_), .c(x29), .O(new_n128_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n106_), .c(new_n87_), .O(new_n130_));
  nor2   g079(.a(x18), .b(new_n52_), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n130_), .c(new_n128_), .O(z10));
  xor2a  g081(.a(new_n130_), .b(x30), .O(new_n133_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n138_), .c(new_n137_), .d(new_n141_), .O(new_n143_));
  inv1   g092(.a(new_n143_), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n112_), .c(new_n100_), .d(new_n84_), .O(new_n145_));
  ...
  nand3  g099(.a(new_n142_), .b(new_n138_), .c(new_n137_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n120_), .c(x32), .O(new_n152_));
  nor3   g101(.a(x32), .b(x31), .c(x30), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n129_), .c(new_n106_), .d(new_n87_), .O(new_n154_));
  ...
  nand4  g110(.a(new_n153_), .b(new_n129_), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  ...
  oai21  g116(.a(new_n162_), .b(new_n94_), .c(x34), .O(new_n168_));
  inv1   g117(.a(x34), .O(new_n169_));
  inv1   g118(.a(new_n94_), .O(new_n170_));
  nand2  g119(.a(new_n126_), .b(new_n137_), .O(new_n171_));
  nand2  g120(.a(new_n161_), .b(new_n160_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n153_), .c(new_n170_), .d(new_n169_), .O(new_n174_));
