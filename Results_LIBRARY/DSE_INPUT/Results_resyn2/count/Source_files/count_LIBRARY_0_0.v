...
module FAU ( 
  ...
  nand2  g011(.a(new_n62_), .b(new_n57_), .O(z01));
  inv1   g012(.a(x21), .O(new_n64_));
  xor2a  g013(.a(new_n61_), .b(new_n64_), .O(new_n65_));
  ...
  nor2   g023(.a(new_n61_), .b(new_n74_), .O(new_n75_));
  ...
  nand2  g029(.a(new_n59_), .b(new_n58_), .O(new_n81_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n70_), .c(new_n59_), .d(new_n58_), .O(new_n93_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n99_), .c(new_n70_), .d(new_n61_), .O(new_n115_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n99_), .c(new_n70_), .d(new_n61_), .O(new_n122_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n61_), .O(new_n131_));
