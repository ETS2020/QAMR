// Benchmark "FAU" written by ABC on Mon Jul 27 22:44:59 2020
...
module FAU ( 
  ...
  nand2  g034(.a(new_n80_), .b(new_n85_), .O(new_n86_));
  inv1   g035(.a(new_n86_), .O(new_n87_));
  nor3   g036(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  nor2   g037(.a(x20), .b(x17), .O(new_n89_));
  aoi21  g038(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(new_n90_));
  oai21  g039(.a(new_n90_), .b(new_n87_), .c(x16), .O(new_n91_));
  inv1   g040(.a(x18), .O(new_n92_));
  oai21  g041(.a(x16), .b(x10), .c(new_n92_), .O(new_n93_));
  aoi21  g042(.a(x24), .b(x19), .c(new_n93_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(new_n91_), .O(z05));
  nor2   g044(.a(x25), .b(x24), .O(new_n96_));
  aoi22  g045(.a(new_n96_), .b(new_n80_), .c(new_n86_), .d(x25), .O(new_n97_));
  ...
  nand2  g049(.a(new_n96_), .b(new_n80_), .O(new_n101_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n102_));
  aoi22  g051(.a(new_n102_), .b(new_n80_), .c(new_n101_), .d(x26), .O(new_n103_));
  ...
  nand3  g057(.a(new_n102_), .b(new_n80_), .c(new_n108_), .O(new_n109_));
  nand2  g058(.a(new_n88_), .b(new_n60_), .O(new_n110_));
  inv1   g059(.a(new_n102_), .O(new_n111_));
  oai21  g060(.a(new_n111_), .b(new_n110_), .c(x27), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n107_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n92_), .O(z08));
  nor3   g064(.a(x28), .b(x27), .c(x26), .O(new_n116_));
  nand4  g065(.a(new_n116_), .b(new_n96_), .c(new_n88_), .d(new_n60_), .O(new_n117_));
  ...
  nand4  g072(.a(new_n123_), .b(new_n102_), .c(new_n88_), .d(new_n60_), .O(new_n124_));
  ...
  aoi22  g079(.a(new_n130_), .b(new_n118_), .c(new_n124_), .d(x30), .O(new_n131_));
  inv1   g080(.a(x04), .O(new_n132_));
  aoi21  g081(.a(new_n52_), .b(new_n132_), .c(x18), .O(new_n133_));
  oai21  g082(.a(new_n131_), .b(new_n52_), .c(new_n133_), .O(z11));
  inv1   g083(.a(new_n130_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n117_), .c(x31), .O(new_n136_));
  nor2   g085(.a(x28), .b(x27), .O(new_n137_));
  nor2   g086(.a(new_n135_), .b(x31), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n102_), .d(new_n80_), .O(new_n139_));
  ...
  nand2  g092(.a(new_n143_), .b(new_n141_), .O(z12));
  nand3  g093(.a(new_n138_), .b(new_n118_), .c(x32), .O(new_n145_));
  inv1   g094(.a(x32), .O(new_n146_));
  inv1   g095(.a(new_n138_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n117_), .c(new_n146_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n145_), .c(x16), .O(new_n149_));
  ...
  nand3  g103(.a(new_n146_), .b(new_n154_), .c(new_n153_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n124_), .c(x33), .O(new_n156_));
  nand2  g105(.a(new_n146_), .b(new_n154_), .O(new_n157_));
  inv1   g106(.a(x33), .O(new_n158_));
  nand2  g107(.a(new_n130_), .b(new_n158_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n137_), .c(new_n102_), .d(new_n80_), .O(new_n161_));
  ...
  nand3  g117(.a(new_n160_), .b(new_n118_), .c(x34), .O(new_n169_));
