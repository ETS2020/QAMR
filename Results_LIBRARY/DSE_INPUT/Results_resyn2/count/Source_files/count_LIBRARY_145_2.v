...
module FAU ( 
  ...
  nand3  g026(.a(new_n77_), .b(new_n55_), .c(new_n75_), .O(new_n78_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n75_), .d(new_n68_), .O(new_n94_));
  inv1   g043(.a(new_n94_), .O(new_n95_));
  aoi22  g044(.a(new_n95_), .b(new_n91_), .c(new_n85_), .d(x24), .O(new_n96_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n93_), .c(new_n92_), .d(new_n75_), .O(new_n104_));
  inv1   g053(.a(new_n104_), .O(new_n105_));
  aoi22  g054(.a(new_n105_), .b(new_n70_), .c(new_n102_), .d(x25), .O(new_n106_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n84_), .c(new_n77_), .d(new_n55_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x26), .O(new_n112_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n86_), .O(new_n114_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n95_), .c(new_n91_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n138_), .b(new_n113_), .c(new_n86_), .O(new_n139_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n113_), .c(new_n86_), .O(new_n153_));
  ...
  oai21  g109(.a(new_n160_), .b(new_n85_), .c(x31), .O(new_n161_));
  inv1   g110(.a(x31), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n150_), .c(new_n145_), .d(new_n149_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n127_), .c(new_n95_), .d(new_n91_), .O(new_n165_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n152_), .c(new_n95_), .d(new_n91_), .O(new_n178_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n164_), .c(new_n105_), .d(new_n70_), .O(new_n190_));
