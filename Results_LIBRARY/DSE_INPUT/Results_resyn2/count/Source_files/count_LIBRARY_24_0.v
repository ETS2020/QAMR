...
module FAU ( 
  ...
  xor2a  g49(.a(new_n95_), .b(x26), .O(new_n101_));
  ...
  nor2   g53(.a(new_n95_), .b(x26), .O(new_n105_));
  nand2  g54(.a(x27), .b(x16), .O(new_n106_));
  inv1   g55(.a(x07), .O(new_n107_));
  aoi21  g56(.a(new_n52_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g57(.a(new_n106_), .b(new_n105_), .c(new_n108_), .O(z08));
  inv1   g58(.a(x18), .O(new_n110_));
