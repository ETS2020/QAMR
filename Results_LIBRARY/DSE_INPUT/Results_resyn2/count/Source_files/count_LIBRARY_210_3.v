// Benchmark "FAU" written by ABC on Mon Jul 27 22:45:43 2020
...
module FAU ( 
  ...
  oai21  g028(.a(new_n79_), .b(new_n76_), .c(x16), .O(new_n80_));
  ...
  nand3  g033(.a(new_n84_), .b(new_n77_), .c(new_n52_), .O(new_n85_));
  inv1   g034(.a(new_n85_), .O(new_n86_));
  aoi21  g035(.a(new_n78_), .b(x23), .c(new_n86_), .O(new_n87_));
  inv1   g036(.a(x11), .O(new_n88_));
  aoi21  g037(.a(new_n55_), .b(new_n88_), .c(x18), .O(new_n89_));
  oai21  g038(.a(new_n87_), .b(new_n55_), .c(new_n89_), .O(z04));
  inv1   g039(.a(x23), .O(new_n91_));
  inv1   g040(.a(x24), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n91_), .c(new_n75_), .d(new_n68_), .O(new_n93_));
  inv1   g042(.a(new_n93_), .O(new_n94_));
  aoi22  g043(.a(new_n94_), .b(new_n60_), .c(new_n85_), .d(x24), .O(new_n95_));
  inv1   g044(.a(x10), .O(new_n96_));
  aoi21  g045(.a(new_n55_), .b(new_n96_), .c(x18), .O(new_n97_));
  oai21  g046(.a(new_n95_), .b(new_n55_), .c(new_n97_), .O(z05));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nor2   g048(.a(x22), .b(x21), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n99_), .c(new_n52_), .d(new_n58_), .O(new_n101_));
  inv1   g050(.a(x25), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n75_), .O(new_n103_));
  inv1   g052(.a(new_n103_), .O(new_n104_));
  aoi22  g053(.a(new_n104_), .b(new_n70_), .c(new_n101_), .d(x25), .O(new_n105_));
  inv1   g054(.a(x09), .O(new_n106_));
  aoi21  g055(.a(new_n55_), .b(new_n106_), .c(x18), .O(new_n107_));
  oai21  g056(.a(new_n105_), .b(new_n55_), .c(new_n107_), .O(z06));
  nor2   g057(.a(x25), .b(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n84_), .c(new_n77_), .d(new_n52_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n86_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(x16), .O(new_n115_));
  inv1   g064(.a(x08), .O(new_n116_));
  aoi21  g065(.a(new_n55_), .b(new_n116_), .c(x18), .O(new_n117_));
  ...
  oai21  g073(.a(new_n122_), .b(new_n55_), .c(new_n124_), .O(z08));
  nor3   g074(.a(x27), .b(x26), .c(x25), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n94_), .c(new_n60_), .O(new_n127_));
  nor2   g076(.a(x26), .b(x25), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n128_), .c(new_n99_), .O(new_n130_));
  nor2   g079(.a(new_n130_), .b(new_n78_), .O(new_n131_));
  aoi21  g080(.a(new_n127_), .b(x28), .c(new_n131_), .O(new_n132_));
  inv1   g081(.a(x06), .O(new_n133_));
  aoi21  g082(.a(new_n55_), .b(new_n133_), .c(x18), .O(new_n134_));
  oai21  g083(.a(new_n132_), .b(new_n55_), .c(new_n134_), .O(z09));
  oai21  g084(.a(new_n130_), .b(new_n78_), .c(x29), .O(new_n136_));
  nor3   g085(.a(x29), .b(x28), .c(x27), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n112_), .c(new_n86_), .O(new_n138_));
  ...
  nand4  g093(.a(new_n129_), .b(new_n128_), .c(new_n144_), .d(new_n92_), .O(new_n145_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n144_), .c(new_n148_), .d(new_n147_), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n112_), .c(new_n86_), .O(new_n152_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n129_), .c(new_n128_), .d(new_n92_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n85_), .c(x31), .O(new_n160_));
  inv1   g109(.a(x31), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n149_), .c(new_n144_), .d(new_n148_), .O(new_n162_));
  inv1   g111(.a(new_n162_), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n126_), .c(new_n94_), .d(new_n60_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g115(.a(x03), .O(new_n167_));
  aoi21  g116(.a(new_n55_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n166_), .O(z12));
  nor2   g118(.a(x31), .b(x28), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n158_), .c(new_n119_), .d(new_n102_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n101_), .c(x32), .O(new_n172_));
  inv1   g121(.a(x26), .O(new_n173_));
  inv1   g122(.a(x32), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n161_), .c(new_n173_), .d(new_n102_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n151_), .c(new_n94_), .d(new_n60_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n172_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  inv1   g128(.a(x02), .O(new_n180_));
  aoi21  g129(.a(new_n55_), .b(new_n180_), .c(x18), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n179_), .O(z13));
  nor2   g131(.a(x32), .b(x31), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n158_), .c(new_n129_), .d(new_n128_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n101_), .c(x33), .O(new_n185_));
  inv1   g134(.a(x33), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n174_), .c(new_n147_), .d(new_n173_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n163_), .c(new_n104_), .d(new_n70_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(x16), .O(new_n191_));
  inv1   g140(.a(x01), .O(new_n192_));
  aoi21  g141(.a(new_n55_), .b(new_n192_), .c(x18), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n191_), .O(z14));
  inv1   g143(.a(x34), .O(new_n195_));
  nor2   g144(.a(new_n189_), .b(new_n195_), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n170_), .c(new_n158_), .d(new_n119_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n110_), .c(new_n195_), .O(new_n199_));
  nand2  g148(.a(new_n199_), .b(x16), .O(new_n200_));
  inv1   g149(.a(x00), .O(new_n201_));
  aoi21  g150(.a(new_n55_), .b(new_n201_), .c(x18), .O(new_n202_));
  oai21  g151(.a(new_n200_), .b(new_n196_), .c(new_n202_), .O(z15));
endmodule
