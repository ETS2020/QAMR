...
module FAU ( 
  ...
  aoi21  g049(.a(new_n99_), .b(new_n100_), .c(x23), .O(new_n101_));
  oai22  g050(.a(new_n101_), .b(new_n75_), .c(new_n94_), .d(new_n99_), .O(new_n102_));
  nor2   g051(.a(new_n63_), .b(new_n99_), .O(new_n103_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n74_), .c(new_n55_), .d(new_n61_), .O(new_n109_));
  nand2  g058(.a(new_n74_), .b(new_n100_), .O(new_n110_));
  nor2   g059(.a(x26), .b(x25), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n55_), .c(new_n61_), .O(new_n112_));
  ...
  nand3  g066(.a(new_n111_), .b(new_n94_), .c(new_n63_), .O(new_n118_));
  or2    g067(.a(x27), .b(x26), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n109_), .O(new_n120_));
  aoi21  g069(.a(new_n118_), .b(x27), .c(new_n120_), .O(new_n121_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n111_), .c(new_n94_), .d(new_n63_), .O(new_n127_));
  ...
  aoi22  g082(.a(new_n133_), .b(new_n113_), .c(new_n127_), .d(x29), .O(new_n134_));
  ...
  nand2  g086(.a(new_n133_), .b(new_n113_), .O(new_n138_));
  nor3   g087(.a(x30), .b(x29), .c(x28), .O(new_n139_));
  nor3   g088(.a(x27), .b(x26), .c(x25), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n139_), .c(new_n94_), .d(new_n63_), .O(new_n141_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n125_), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  aoi22  g100(.a(new_n151_), .b(new_n120_), .c(new_n141_), .d(x31), .O(new_n152_));
  ...
  nor2   g105(.a(new_n150_), .b(x27), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n113_), .c(new_n156_), .O(new_n158_));
  nor2   g107(.a(x32), .b(x31), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n133_), .c(new_n148_), .O(new_n160_));
  ...
  nand2  g114(.a(new_n161_), .b(x33), .O(new_n166_));
  inv1   g115(.a(x33), .O(new_n167_));
  oai21  g116(.a(new_n160_), .b(new_n118_), .c(new_n167_), .O(new_n168_));
  ...
  nand3  g121(.a(new_n140_), .b(new_n139_), .c(new_n94_), .O(new_n173_));
  nand3  g122(.a(new_n159_), .b(new_n63_), .c(new_n167_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n173_), .c(x34), .O(new_n175_));
  nand2  g124(.a(new_n159_), .b(new_n148_), .O(new_n176_));
  inv1   g125(.a(x34), .O(new_n177_));
  nand3  g126(.a(new_n177_), .b(new_n167_), .c(new_n147_), .O(new_n178_));
  nor2   g127(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n126_), .c(new_n113_), .O(new_n180_));
