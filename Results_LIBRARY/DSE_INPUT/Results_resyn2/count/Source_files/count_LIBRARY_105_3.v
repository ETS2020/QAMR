...
module FAU ( 
  ...
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n55_), .d(new_n61_), .O(new_n94_));
  nand3  g043(.a(new_n85_), .b(new_n55_), .c(new_n69_), .O(new_n95_));
  ...
  aoi21  g049(.a(x24), .b(x20), .c(new_n100_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n98_), .O(z05));
  inv1   g051(.a(x23), .O(new_n103_));
  inv1   g052(.a(x24), .O(new_n104_));
  inv1   g053(.a(x25), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n76_), .O(new_n106_));
  inv1   g055(.a(new_n106_), .O(new_n107_));
  aoi22  g056(.a(new_n107_), .b(new_n71_), .c(new_n94_), .d(x25), .O(new_n108_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n85_), .c(new_n78_), .d(new_n55_), .O(new_n113_));
  ...
  nor2   g072(.a(new_n123_), .b(new_n94_), .O(new_n124_));
  ...
  nand4  g077(.a(new_n104_), .b(new_n103_), .c(new_n76_), .d(new_n69_), .O(new_n129_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n92_), .O(new_n135_));
  ...
  nand3  g091(.a(new_n142_), .b(new_n115_), .c(new_n87_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n134_), .b(new_n133_), .c(new_n149_), .d(new_n104_), .O(new_n150_));
  ...
  nand3  g105(.a(new_n156_), .b(new_n115_), .c(new_n87_), .O(new_n157_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n134_), .c(new_n133_), .d(new_n104_), .O(new_n164_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n130_), .d(new_n63_), .O(new_n169_));
  ...
  oai21  g125(.a(new_n176_), .b(new_n94_), .c(x32), .O(new_n177_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n156_), .c(new_n130_), .d(new_n63_), .O(new_n182_));
  ...
  oai21  g138(.a(new_n189_), .b(new_n94_), .c(x33), .O(new_n190_));
  ...
  oai21  g156(.a(new_n205_), .b(new_n201_), .c(new_n207_), .O(z15));
endmodule
