// Benchmark "FAU" written by ABC on Mon Jul 27 22:45:14 2020
...
module FAU ( 
  ...
  nor2   g043(.a(new_n94_), .b(new_n73_), .O(new_n95_));
  ...
  oai21  g048(.a(new_n95_), .b(x26), .c(x16), .O(new_n100_));
  inv1   g049(.a(x08), .O(new_n101_));
  aoi21  g050(.a(new_n52_), .b(new_n101_), .c(x18), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n100_), .O(z07));
  inv1   g052(.a(x27), .O(new_n104_));
  nor2   g053(.a(new_n95_), .b(new_n104_), .O(new_n105_));
  inv1   g054(.a(x25), .O(new_n106_));
  nand4  g055(.a(new_n104_), .b(new_n106_), .c(new_n91_), .d(new_n81_), .O(new_n107_));
  ...
  aoi21  g065(.a(new_n113_), .b(x28), .c(new_n116_), .O(new_n117_));
  ...
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n93_), .c(new_n72_), .d(new_n60_), .O(new_n122_));
  ...
  aoi21  g078(.a(new_n129_), .b(new_n108_), .c(new_n128_), .O(new_n130_));
  nor3   g079(.a(x30), .b(x29), .c(x28), .O(new_n131_));
  ...
  oai21  g104(.a(new_n155_), .b(new_n122_), .c(x33), .O(new_n156_));
  nor3   g105(.a(x33), .b(x32), .c(x31), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n131_), .c(new_n108_), .O(new_n158_));
  ...
  nor2   g112(.a(new_n147_), .b(new_n115_), .O(new_n164_));
  nor2   g113(.a(x34), .b(x33), .O(new_n165_));
  aoi22  g114(.a(new_n165_), .b(new_n164_), .c(new_n158_), .d(x34), .O(new_n166_));
  inv1   g115(.a(x00), .O(new_n167_));
  aoi21  g116(.a(new_n52_), .b(new_n167_), .c(x18), .O(new_n168_));
  oai21  g117(.a(new_n166_), .b(new_n52_), .c(new_n168_), .O(z15));
endmodule
