// Benchmark "FAU" written by ABC on Mon Jul 27 22:46:00 2020
...
module FAU ( 
  ...
  aoi22  g075(.a(new_n126_), .b(new_n113_), .c(new_n120_), .d(x28), .O(new_n127_));
  ...
  nand4  g080(.a(new_n126_), .b(new_n85_), .c(new_n55_), .d(new_n68_), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n112_), .c(new_n131_), .O(new_n133_));
  nor2   g082(.a(new_n132_), .b(new_n112_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(x29), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n61_), .O(new_n136_));
  nand3  g085(.a(x29), .b(x20), .c(x16), .O(new_n137_));
  inv1   g086(.a(x05), .O(new_n138_));
  aoi21  g087(.a(new_n58_), .b(new_n138_), .c(x18), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n137_), .c(new_n136_), .O(z10));
  nand4  g089(.a(new_n126_), .b(new_n111_), .c(new_n131_), .d(new_n93_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n86_), .c(x30), .O(new_n142_));
  inv1   g091(.a(new_n112_), .O(new_n143_));
  inv1   g092(.a(x28), .O(new_n144_));
  inv1   g093(.a(x30), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n131_), .c(new_n144_), .d(new_n118_), .O(new_n146_));
  inv1   g095(.a(new_n146_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n143_), .c(new_n87_), .O(new_n148_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n126_), .c(new_n111_), .d(new_n93_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n86_), .c(x31), .O(new_n156_));
  inv1   g105(.a(x31), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n145_), .c(new_n131_), .d(new_n144_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n119_), .c(new_n95_), .d(new_n63_), .O(new_n160_));
  ...
  nor2   g115(.a(x31), .b(x28), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n154_), .c(new_n166_), .d(new_n102_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n101_), .c(x32), .O(new_n169_));
  inv1   g118(.a(x26), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n157_), .c(new_n170_), .d(new_n102_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n147_), .c(new_n95_), .d(new_n63_), .O(new_n174_));
  ...
  nand4  g129(.a(new_n180_), .b(new_n154_), .c(new_n126_), .d(new_n111_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n101_), .c(x33), .O(new_n182_));
  inv1   g131(.a(x33), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n171_), .c(new_n118_), .d(new_n170_), .O(new_n184_));
  inv1   g133(.a(new_n184_), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n159_), .c(new_n104_), .d(new_n71_), .O(new_n186_));
  ...
  nor2   g141(.a(new_n186_), .b(new_n192_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n167_), .c(new_n154_), .d(new_n166_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n110_), .c(new_n192_), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(x16), .O(new_n197_));
  inv1   g146(.a(x00), .O(new_n198_));
  aoi21  g147(.a(new_n58_), .b(new_n198_), .c(x18), .O(new_n199_));
  oai21  g148(.a(new_n197_), .b(new_n193_), .c(new_n199_), .O(z15));
endmodule
