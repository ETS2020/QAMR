...
module FAU ( 
  ...
  nand2  g060(.a(new_n55_), .b(new_n68_), .O(new_n112_));
  oai21  g061(.a(new_n112_), .b(new_n104_), .c(x26), .O(new_n113_));
  ...
  aoi21  g066(.a(x26), .b(x20), .c(new_n117_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n115_), .O(z07));
  ...
  aoi21  g071(.a(new_n111_), .b(x27), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n138_), .b(new_n110_), .c(new_n87_), .O(new_n139_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n110_), .c(new_n87_), .O(new_n153_));
