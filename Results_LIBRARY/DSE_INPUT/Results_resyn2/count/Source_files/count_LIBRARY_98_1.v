...
module FAU ( 
  ...
  nor2   g031(.a(x24), .b(x22), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n66_), .c(new_n58_), .O(new_n84_));
  inv1   g033(.a(new_n84_), .O(new_n85_));
  aoi21  g034(.a(new_n73_), .b(x24), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g046(.a(new_n97_), .b(new_n83_), .c(new_n66_), .d(new_n58_), .O(new_n98_));
