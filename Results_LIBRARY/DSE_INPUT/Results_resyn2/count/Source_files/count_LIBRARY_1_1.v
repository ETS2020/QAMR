...
module FAU ( 
  ...
  oai21  g041(.a(new_n88_), .b(x25), .c(x16), .O(new_n93_));
  inv1   g042(.a(x09), .O(new_n94_));
  aoi21  g043(.a(new_n52_), .b(new_n94_), .c(x18), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(new_n93_), .O(z06));
  nor2   g045(.a(x26), .b(x24), .O(new_n97_));
  nand4  g046(.a(new_n97_), .b(new_n79_), .c(new_n66_), .d(new_n58_), .O(new_n98_));
  inv1   g047(.a(new_n98_), .O(new_n99_));
  aoi21  g048(.a(new_n87_), .b(x26), .c(new_n99_), .O(new_n100_));
  ...
  nand2  g068(.a(new_n86_), .b(new_n79_), .O(new_n120_));
  ...
  nor3   g083(.a(x27), .b(x26), .c(x24), .O(new_n135_));
