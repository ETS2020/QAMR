...
module FAU ( 
  ...
  nand4  g050(.a(new_n100_), .b(new_n93_), .c(new_n91_), .d(new_n81_), .O(new_n102_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n109_), .c(new_n72_), .d(new_n60_), .O(new_n111_));
  ...
  nand4  g066(.a(new_n117_), .b(new_n109_), .c(new_n72_), .d(new_n60_), .O(new_n118_));
  ...
  aoi21  g074(.a(new_n125_), .b(new_n103_), .c(new_n124_), .O(new_n126_));
  nor3   g075(.a(x29), .b(x28), .c(x27), .O(new_n127_));
  and2   g076(.a(new_n127_), .b(new_n103_), .O(new_n128_));
  ...
  nand2  g081(.a(new_n52_), .b(x04), .O(new_n133_));
  inv1   g082(.a(x30), .O(new_n134_));
  aoi21  g083(.a(new_n127_), .b(new_n103_), .c(new_n134_), .O(new_n135_));
  nand3  g084(.a(new_n127_), .b(new_n103_), .c(new_n134_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(x16), .O(new_n137_));
  oai21  g086(.a(new_n137_), .b(new_n135_), .c(new_n133_), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n79_), .O(z11));
  nand2  g088(.a(new_n52_), .b(x03), .O(new_n140_));
  oai21  g089(.a(new_n137_), .b(x31), .c(new_n140_), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n79_), .O(z12));
  nor2   g091(.a(x30), .b(x29), .O(new_n143_));
  inv1   g092(.a(new_n143_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n118_), .c(x32), .O(new_n145_));
  inv1   g094(.a(x28), .O(new_n146_));
  inv1   g095(.a(x32), .O(new_n147_));
  nand3  g096(.a(new_n143_), .b(new_n147_), .c(new_n146_), .O(new_n148_));
  ...
  oai21  g105(.a(new_n136_), .b(x32), .c(new_n156_), .O(new_n157_));
  nand4  g106(.a(new_n143_), .b(new_n119_), .c(x33), .d(new_n147_), .O(new_n158_));
  ...
  nor2   g111(.a(new_n148_), .b(new_n111_), .O(new_n163_));
  nor3   g112(.a(x33), .b(x32), .c(x30), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n127_), .c(new_n103_), .O(new_n165_));
  nor2   g114(.a(x34), .b(x33), .O(new_n166_));
  aoi22  g115(.a(new_n166_), .b(new_n163_), .c(new_n165_), .d(x34), .O(new_n167_));
