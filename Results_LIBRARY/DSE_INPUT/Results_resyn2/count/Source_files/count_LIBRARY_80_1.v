...
module FAU ( 
  ...
  nor2   g057(.a(x16), .b(new_n108_), .O(new_n109_));
  nor3   g058(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand3  g059(.a(new_n110_), .b(new_n99_), .c(new_n63_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  aoi21  g061(.a(new_n101_), .b(x26), .c(new_n112_), .O(new_n113_));
  oai21  g062(.a(new_n113_), .b(new_n109_), .c(new_n107_), .O(z07));
  nand2  g063(.a(new_n58_), .b(x07), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n107_), .O(z08));
  inv1   g066(.a(x06), .O(new_n118_));
  nor2   g067(.a(x16), .b(new_n118_), .O(new_n119_));
  inv1   g068(.a(x28), .O(new_n120_));
  nand3  g069(.a(new_n110_), .b(new_n87_), .c(new_n120_), .O(new_n121_));
  nand2  g070(.a(new_n111_), .b(x28), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(x16), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n119_), .c(new_n107_), .O(z09));
  nor3   g074(.a(x29), .b(x28), .c(x26), .O(new_n126_));
  aoi22  g075(.a(new_n126_), .b(new_n102_), .c(new_n121_), .d(x29), .O(new_n127_));
  ...
  nand3  g081(.a(new_n132_), .b(new_n110_), .c(new_n87_), .O(new_n133_));
  nor3   g082(.a(x30), .b(x29), .c(x28), .O(new_n134_));
  aoi22  g083(.a(new_n134_), .b(new_n131_), .c(new_n133_), .d(x30), .O(new_n135_));
  inv1   g084(.a(x04), .O(new_n136_));
  aoi21  g085(.a(new_n58_), .b(new_n136_), .c(x18), .O(new_n137_));
  oai21  g086(.a(new_n135_), .b(new_n58_), .c(new_n137_), .O(z11));
  nand3  g087(.a(new_n134_), .b(new_n131_), .c(x31), .O(new_n139_));
  inv1   g088(.a(x31), .O(new_n140_));
  inv1   g089(.a(new_n134_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n111_), .c(new_n140_), .O(new_n142_));
  ...
  nor2   g108(.a(x28), .b(x26), .O(new_n160_));
  nand4  g109(.a(new_n153_), .b(new_n160_), .c(new_n100_), .d(new_n87_), .O(new_n161_));
  inv1   g110(.a(x33), .O(new_n162_));
  nand3  g111(.a(new_n150_), .b(new_n134_), .c(new_n162_), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n111_), .O(new_n164_));
  ...
  oai21  g116(.a(new_n165_), .b(new_n58_), .c(new_n167_), .O(z14));
  oai21  g117(.a(new_n163_), .b(new_n111_), .c(x34), .O(new_n169_));
  nor2   g118(.a(x34), .b(x33), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n151_), .c(new_n150_), .O(new_n171_));
  inv1   g120(.a(new_n171_), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n110_), .c(new_n87_), .d(new_n120_), .O(new_n173_));
