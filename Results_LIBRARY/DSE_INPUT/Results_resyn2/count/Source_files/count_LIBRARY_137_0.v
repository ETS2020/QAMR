...
module FAU ( 
  ...
  nand4  g065(.a(new_n116_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n117_));
  oai21  g066(.a(new_n109_), .b(new_n115_), .c(new_n117_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n114_), .O(z08));
  nor3   g069(.a(x28), .b(x27), .c(x26), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n100_), .c(new_n71_), .d(new_n60_), .O(new_n122_));
  inv1   g071(.a(new_n122_), .O(new_n123_));
  aoi21  g072(.a(new_n117_), .b(x28), .c(new_n123_), .O(new_n124_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n116_), .c(new_n100_), .d(new_n84_), .O(new_n150_));
