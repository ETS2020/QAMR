...
module FAU ( 
  ...
  and2   g26(.a(x23), .b(x16), .O(new_n78_));
  oai21  g27(.a(new_n73_), .b(x22), .c(new_n78_), .O(new_n79_));
  inv1   g28(.a(x11), .O(new_n80_));
  aoi21  g29(.a(new_n58_), .b(new_n80_), .c(x18), .O(new_n81_));
  nand2  g30(.a(new_n81_), .b(new_n79_), .O(z04));
  inv1   g31(.a(x18), .O(new_n83_));
