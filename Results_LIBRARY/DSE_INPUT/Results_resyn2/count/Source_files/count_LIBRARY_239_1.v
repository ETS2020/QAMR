...
module FAU ( 
  ...
  nor2   g056(.a(x16), .b(new_n107_), .O(new_n108_));
  nor3   g057(.a(new_n102_), .b(x27), .c(new_n52_), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(z08));
  inv1   g059(.a(new_n102_), .O(new_n111_));
  nor2   g060(.a(x28), .b(x26), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n93_), .c(new_n72_), .d(new_n60_), .O(new_n113_));
  inv1   g062(.a(new_n113_), .O(new_n114_));
  aoi21  g063(.a(new_n111_), .b(x28), .c(new_n114_), .O(new_n115_));
  ...
  nor3   g067(.a(x29), .b(x28), .c(x26), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n93_), .c(new_n72_), .d(new_n60_), .O(new_n120_));
  inv1   g069(.a(new_n120_), .O(new_n121_));
  aoi21  g070(.a(new_n113_), .b(x29), .c(new_n121_), .O(new_n122_));
  inv1   g071(.a(x05), .O(new_n123_));
  aoi21  g072(.a(new_n52_), .b(new_n123_), .c(x18), .O(new_n124_));
  oai21  g073(.a(new_n122_), .b(new_n52_), .c(new_n124_), .O(z10));
  inv1   g074(.a(x30), .O(new_n126_));
  nor2   g075(.a(x29), .b(x28), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n102_), .c(new_n126_), .O(new_n128_));
  nor3   g077(.a(x30), .b(x29), .c(x28), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n102_), .O(new_n130_));
  ...
  oai21  g102(.a(new_n153_), .b(new_n120_), .c(x33), .O(new_n154_));
  nor3   g103(.a(x33), .b(x32), .c(x31), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n129_), .c(new_n102_), .O(new_n156_));
  ...
  nor2   g110(.a(new_n145_), .b(new_n113_), .O(new_n162_));
