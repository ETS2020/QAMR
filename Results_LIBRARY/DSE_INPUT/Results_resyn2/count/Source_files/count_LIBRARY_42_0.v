// Benchmark "FAU" written by ABC on Mon Jul 27 22:44:35 2020
...
module FAU ( 
  ...
  nand3  g034(.a(new_n85_), .b(new_n84_), .c(new_n55_), .O(new_n86_));
  inv1   g035(.a(new_n86_), .O(new_n87_));
  aoi21  g036(.a(new_n78_), .b(x23), .c(new_n87_), .O(new_n88_));
  ...
  nand4  g042(.a(new_n93_), .b(new_n85_), .c(new_n55_), .d(new_n61_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n92_), .c(new_n100_), .d(new_n76_), .O(new_n102_));
  ...
  oai21  g056(.a(new_n102_), .b(new_n70_), .c(x26), .O(new_n108_));
  ...
  oai21  g081(.a(new_n127_), .b(new_n94_), .c(x29), .O(new_n133_));
  inv1   g082(.a(new_n127_), .O(new_n134_));
  nor2   g083(.a(x29), .b(x24), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n134_), .c(new_n87_), .O(new_n136_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n126_), .c(new_n125_), .d(new_n142_), .O(new_n143_));
  ...
  nand4  g108(.a(new_n151_), .b(new_n150_), .c(new_n116_), .d(new_n101_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n94_), .c(x32), .O(new_n161_));
  nor2   g110(.a(x32), .b(x31), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n150_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n126_), .c(new_n109_), .d(new_n87_), .O(new_n165_));
  ...
  nand4  g119(.a(new_n162_), .b(new_n150_), .c(new_n126_), .d(new_n125_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n94_), .c(x33), .O(new_n172_));
  nor2   g121(.a(x33), .b(x32), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n153_), .c(new_n103_), .O(new_n174_));
  ...
  oai21  g128(.a(new_n160_), .b(new_n94_), .c(x34), .O(new_n180_));
  nand2  g129(.a(new_n151_), .b(new_n150_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nor2   g131(.a(new_n173_), .b(x27), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n182_), .c(new_n109_), .d(new_n87_), .O(new_n184_));
