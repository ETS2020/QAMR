...
module FAU ( 
  ...
  nand2  g031(.a(new_n58_), .b(new_n57_), .O(new_n83_));
  nand2  g032(.a(new_n75_), .b(new_n65_), .O(new_n84_));
  nor2   g033(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nor2   g034(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand2  g035(.a(new_n71_), .b(new_n82_), .O(new_n87_));
  nor2   g036(.a(new_n87_), .b(new_n83_), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  nand2  g038(.a(new_n89_), .b(new_n81_), .O(z04));
  inv1   g039(.a(x24), .O(new_n91_));
  nor2   g040(.a(x24), .b(x23), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n71_), .c(new_n58_), .d(new_n57_), .O(new_n93_));
  oai21  g042(.a(new_n88_), .b(new_n91_), .c(new_n93_), .O(new_n94_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n99_), .c(new_n71_), .d(new_n60_), .O(new_n115_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n99_), .c(new_n71_), .d(new_n60_), .O(new_n122_));
  ...
  nand3  g085(.a(new_n132_), .b(new_n129_), .c(new_n88_), .O(new_n137_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n114_), .c(new_n99_), .d(new_n85_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n132_), .c(new_n129_), .d(new_n88_), .O(new_n159_));
