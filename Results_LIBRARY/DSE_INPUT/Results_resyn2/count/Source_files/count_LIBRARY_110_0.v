...
module FAU ( 
  ...
  nand4  g041(.a(new_n71_), .b(new_n60_), .c(new_n92_), .d(new_n81_), .O(new_n93_));
  oai21  g042(.a(new_n87_), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n133_), .c(new_n107_), .d(new_n166_), .O(new_n167_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n93_), .c(new_n174_), .O(new_n175_));
  nand2  g124(.a(new_n168_), .b(x34), .O(new_n176_));
