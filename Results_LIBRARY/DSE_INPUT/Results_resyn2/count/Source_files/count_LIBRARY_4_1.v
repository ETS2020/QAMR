...
module FAU ( 
  ...
  oai21  g059(.a(new_n106_), .b(x27), .c(x16), .O(new_n111_));
  inv1   g060(.a(x07), .O(new_n112_));
  aoi21  g061(.a(new_n56_), .b(new_n112_), .c(x18), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n111_), .O(z08));
  xor2a  g063(.a(new_n105_), .b(x28), .O(new_n115_));
  inv1   g064(.a(x06), .O(new_n116_));
  aoi21  g065(.a(new_n56_), .b(new_n116_), .c(x18), .O(new_n117_));
  oai21  g066(.a(new_n115_), .b(new_n56_), .c(new_n117_), .O(z09));
  inv1   g067(.a(x28), .O(new_n119_));
  nand4  g068(.a(new_n104_), .b(new_n82_), .c(new_n61_), .d(new_n119_), .O(new_n120_));
  inv1   g069(.a(x26), .O(new_n121_));
  inv1   g070(.a(x29), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n119_), .c(new_n121_), .O(new_n123_));
  inv1   g072(.a(new_n123_), .O(new_n124_));
  aoi22  g073(.a(new_n124_), .b(new_n98_), .c(new_n120_), .d(x29), .O(new_n125_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n104_), .c(new_n82_), .d(new_n61_), .O(new_n130_));
  nor3   g079(.a(x30), .b(x29), .c(x28), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n104_), .c(new_n82_), .d(new_n61_), .O(new_n132_));
  ...
  nor2   g087(.a(new_n132_), .b(new_n138_), .O(new_n139_));
  oai21  g088(.a(new_n133_), .b(x31), .c(x16), .O(new_n140_));
  inv1   g089(.a(x03), .O(new_n141_));
  aoi21  g090(.a(new_n56_), .b(new_n141_), .c(x18), .O(new_n142_));
  oai21  g091(.a(new_n140_), .b(new_n139_), .c(new_n142_), .O(z12));
  inv1   g092(.a(x32), .O(new_n144_));
  inv1   g093(.a(x30), .O(new_n145_));
  nand2  g094(.a(new_n129_), .b(new_n145_), .O(new_n146_));
  nand2  g095(.a(new_n138_), .b(new_n121_), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n98_), .c(new_n144_), .O(new_n149_));
  nor2   g098(.a(x32), .b(x31), .O(new_n150_));
  inv1   g099(.a(new_n150_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n132_), .O(new_n152_));
  ...
  nand2  g105(.a(new_n150_), .b(new_n145_), .O(new_n157_));
  nor2   g106(.a(new_n157_), .b(new_n123_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n98_), .O(new_n159_));
  inv1   g108(.a(x33), .O(new_n160_));
  nand3  g109(.a(new_n150_), .b(new_n131_), .c(new_n160_), .O(new_n161_));
