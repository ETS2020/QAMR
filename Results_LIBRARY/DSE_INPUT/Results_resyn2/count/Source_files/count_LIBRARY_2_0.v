...
module FAU ( 
  ...
  nand4  g21(.a(new_n72_), .b(new_n61_), .c(new_n54_), .d(new_n53_), .O(new_n73_));
  ...
  nand3  g27(.a(new_n67_), .b(new_n52_), .c(new_n78_), .O(new_n79_));
  inv1   g28(.a(x23), .O(new_n80_));
  oai21  g29(.a(x19), .b(x17), .c(new_n80_), .O(new_n81_));
