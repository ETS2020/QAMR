...
module FAU ( 
  ...
  nand3  g027(.a(new_n63_), .b(new_n78_), .c(new_n77_), .O(new_n79_));
  ...
  nand2  g044(.a(new_n69_), .b(new_n52_), .O(new_n96_));
  inv1   g045(.a(x23), .O(new_n97_));
  inv1   g046(.a(x24), .O(new_n98_));
  inv1   g047(.a(x25), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n78_), .O(new_n100_));
  nor2   g049(.a(new_n100_), .b(new_n96_), .O(new_n101_));
  aoi22  g050(.a(new_n101_), .b(new_n53_), .c(new_n90_), .d(x25), .O(new_n102_));
  ...
  nand4  g055(.a(new_n89_), .b(new_n63_), .c(new_n99_), .d(new_n77_), .O(new_n107_));
  nor2   g056(.a(x26), .b(x25), .O(new_n108_));
  aoi22  g057(.a(new_n108_), .b(new_n106_), .c(new_n107_), .d(x26), .O(new_n109_));
  ...
  nand4  g061(.a(new_n108_), .b(new_n89_), .c(new_n63_), .d(new_n77_), .O(new_n113_));
  nor3   g062(.a(x27), .b(x26), .c(x25), .O(new_n114_));
  aoi22  g063(.a(new_n114_), .b(new_n106_), .c(new_n113_), .d(x27), .O(new_n115_));
  ...
  nand2  g067(.a(new_n114_), .b(new_n89_), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(new_n70_), .c(x28), .O(new_n120_));
  nand3  g069(.a(new_n98_), .b(new_n97_), .c(new_n78_), .O(new_n121_));
  nor2   g070(.a(x27), .b(x26), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n99_), .O(new_n123_));
  nor2   g072(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nor2   g073(.a(x28), .b(x21), .O(new_n125_));
  ...
  nand4  g080(.a(new_n125_), .b(new_n124_), .c(new_n63_), .d(x29), .O(new_n132_));
  inv1   g081(.a(x29), .O(new_n133_));
  nand2  g082(.a(new_n126_), .b(new_n133_), .O(new_n134_));
  ...
  nor3   g087(.a(x29), .b(x20), .c(x17), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n125_), .c(new_n124_), .O(new_n140_));
  nor3   g089(.a(x21), .b(x20), .c(x17), .O(new_n141_));
  nor3   g090(.a(x30), .b(x29), .c(x28), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n114_), .c(new_n141_), .d(new_n89_), .O(new_n143_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n124_), .c(new_n153_), .O(new_n158_));
  nand3  g107(.a(new_n141_), .b(new_n89_), .c(new_n99_), .O(new_n159_));
  nor2   g108(.a(x32), .b(x31), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n155_), .c(new_n122_), .d(new_n154_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n163_), .b(new_n58_), .c(new_n165_), .O(z13));
  inv1   g115(.a(x33), .O(new_n167_));
  inv1   g116(.a(new_n161_), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n101_), .c(new_n167_), .O(new_n169_));
  nand4  g118(.a(new_n160_), .b(new_n142_), .c(new_n122_), .d(new_n167_), .O(new_n170_));
  nor2   g119(.a(new_n170_), .b(new_n159_), .O(new_n171_));
  ...
  nand2  g125(.a(new_n122_), .b(new_n167_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand3  g127(.a(new_n178_), .b(new_n142_), .c(new_n101_), .O(new_n179_));
  nand3  g128(.a(new_n125_), .b(new_n114_), .c(new_n89_), .O(new_n180_));
  nor2   g129(.a(x20), .b(x17), .O(new_n181_));
  nor2   g130(.a(x34), .b(x33), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n160_), .c(new_n155_), .d(new_n181_), .O(new_n183_));
  nor2   g132(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  aoi21  g133(.a(new_n179_), .b(x34), .c(new_n184_), .O(new_n185_));
