...
module FAU ( 
  ...
  nand4  g092(.a(new_n123_), .b(new_n122_), .c(new_n143_), .d(new_n121_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n80_), .c(x31), .O(new_n145_));
  nor2   g094(.a(x31), .b(x30), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n123_), .O(new_n147_));
  ...
  nand4  g103(.a(new_n146_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n155_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n118_), .c(new_n117_), .d(new_n60_), .O(new_n162_));
  ...
  nor2   g116(.a(x32), .b(x28), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n146_), .c(new_n109_), .d(new_n108_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n87_), .c(x33), .O(new_n170_));
  nor2   g119(.a(x33), .b(x32), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n122_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n148_), .c(new_n117_), .d(new_n60_), .O(new_n174_));
  ...
  nand4  g128(.a(new_n171_), .b(new_n146_), .c(new_n123_), .d(new_n122_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n87_), .c(x34), .O(new_n181_));
  inv1   g130(.a(x27), .O(new_n182_));
  inv1   g131(.a(x33), .O(new_n183_));
  inv1   g132(.a(x34), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n183_), .c(new_n182_), .d(new_n101_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n160_), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n95_), .O(new_n187_));
