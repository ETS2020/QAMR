...
module FAU ( 
  ...
  nor2   g051(.a(x18), .b(new_n52_), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(z06));
  inv1   g053(.a(x25), .O(new_n105_));
  inv1   g054(.a(x26), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n105_), .c(new_n92_), .O(new_n107_));
  nor3   g056(.a(new_n107_), .b(new_n86_), .c(new_n82_), .O(new_n108_));
  aoi21  g057(.a(new_n102_), .b(x26), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n101_), .c(new_n71_), .d(new_n60_), .O(new_n115_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n101_), .c(new_n71_), .d(new_n60_), .O(new_n122_));
  ...
  inv1   g076(.a(new_n86_), .O(new_n128_));
  inv1   g077(.a(new_n107_), .O(new_n129_));
  nor2   g078(.a(x28), .b(x27), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n60_), .O(new_n131_));
  ...
  nand3  g085(.a(new_n132_), .b(new_n129_), .c(new_n87_), .O(new_n137_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n114_), .c(new_n101_), .d(new_n84_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n132_), .c(new_n129_), .d(new_n87_), .O(new_n159_));
