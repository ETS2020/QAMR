...
module FAU ( 
  ...
  nand2  g031(.a(new_n75_), .b(new_n82_), .O(new_n83_));
  ...
  oai21  g045(.a(new_n87_), .b(new_n92_), .c(new_n96_), .O(z05));
  nor3   g046(.a(x25), .b(x24), .c(x23), .O(new_n98_));
  aoi22  g047(.a(new_n98_), .b(new_n84_), .c(new_n94_), .d(x25), .O(new_n99_));
  ...
  nand2  g051(.a(new_n98_), .b(new_n84_), .O(new_n103_));
  inv1   g052(.a(x25), .O(new_n104_));
  inv1   g053(.a(x26), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n104_), .c(new_n92_), .O(new_n106_));
  nor3   g055(.a(new_n106_), .b(new_n86_), .c(new_n65_), .O(new_n107_));
  aoi21  g056(.a(new_n103_), .b(x26), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n98_), .c(new_n71_), .d(new_n60_), .O(new_n114_));
  ...
  nand4  g069(.a(new_n120_), .b(new_n98_), .c(new_n71_), .d(new_n60_), .O(new_n121_));
  ...
  aoi22  g080(.a(new_n131_), .b(new_n107_), .c(new_n130_), .d(x29), .O(new_n132_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n113_), .c(new_n98_), .d(new_n84_), .O(new_n149_));
  ...
  nand2  g121(.a(new_n129_), .b(new_n141_), .O(new_n173_));
  inv1   g122(.a(x33), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n105_), .c(new_n104_), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n157_), .c(new_n95_), .d(new_n172_), .O(new_n177_));
