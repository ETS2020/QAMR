...
module FAU ( 
  ...
  aoi21  g38(.a(new_n76_), .b(x13), .c(new_n82_), .O(new_n83_));
  oai21  g39(.a(new_n81_), .b(x21), .c(new_n68_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n83_), .c(new_n56_), .O(z11));
  inv1   g41(.a(x14), .O(new_n86_));
  nand3  g42(.a(x22), .b(x20), .c(x19), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n69_), .b(new_n86_), .c(new_n88_), .O(new_n89_));
  inv1   g45(.a(x21), .O(new_n90_));
  aoi21  g46(.a(new_n74_), .b(new_n75_), .c(new_n90_), .O(new_n91_));
  nand3  g47(.a(x22), .b(new_n90_), .c(new_n48_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  aoi21  g49(.a(new_n91_), .b(new_n89_), .c(new_n93_), .O(new_n94_));
  nand2  g50(.a(new_n49_), .b(x09), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n94_), .c(new_n58_), .O(z12));
  ...
  nor2   g77(.a(new_n69_), .b(x18), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n97_), .O(new_n123_));
