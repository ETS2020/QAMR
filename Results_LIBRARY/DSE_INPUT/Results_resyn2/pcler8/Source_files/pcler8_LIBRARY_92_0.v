...
module FAU ( 
  ...
  aoi21  g35(.a(new_n79_), .b(new_n70_), .c(new_n77_), .O(new_n80_));
  inv1   g36(.a(x19), .O(new_n81_));
  inv1   g37(.a(x20), .O(new_n82_));
  nand3  g38(.a(x21), .b(new_n82_), .c(new_n81_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n80_), .c(new_n48_), .d(new_n54_), .O(z10));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n88_), .c(new_n81_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n50_), .c(new_n56_), .O(z11));
  aoi21  g48(.a(new_n70_), .b(x14), .c(new_n46_), .O(new_n93_));
  inv1   g49(.a(x22), .O(new_n94_));
  nand2  g50(.a(x21), .b(x20), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n81_), .c(new_n94_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n68_), .O(new_n97_));
  oai22  g53(.a(new_n97_), .b(new_n93_), .c(new_n48_), .d(new_n58_), .O(z12));
  ...
  nor2   g79(.a(new_n81_), .b(x18), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n72_), .c(new_n70_), .O(new_n125_));
