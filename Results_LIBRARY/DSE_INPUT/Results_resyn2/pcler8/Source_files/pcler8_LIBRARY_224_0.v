...
module FAU ( 
  ...
  inv1   g43(.a(new_n46_), .O(new_n88_));
  ...
  oai21  g52(.a(new_n96_), .b(new_n46_), .c(new_n94_), .O(new_n97_));
  nand4  g53(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n98_));
  nand3  g54(.a(x22), .b(x20), .c(x19), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nand2  g56(.a(x23), .b(new_n47_), .O(new_n101_));
  aoi21  g57(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(new_n102_));
  aoi21  g58(.a(new_n97_), .b(x22), .c(new_n102_), .O(new_n103_));
  nand2  g59(.a(new_n48_), .b(x09), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n103_), .c(new_n60_), .O(z13));
  ...
  oai21  g68(.a(new_n112_), .b(new_n49_), .c(new_n62_), .O(z14));
  ...
  nand3  g73(.a(new_n117_), .b(new_n116_), .c(new_n68_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n64_), .O(z15));
  nor2   g75(.a(new_n114_), .b(new_n110_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n108_), .c(x26), .O(new_n121_));
  nor2   g77(.a(new_n93_), .b(x18), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n100_), .c(new_n87_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n68_), .O(new_n124_));
  oai22  g80(.a(new_n124_), .b(new_n121_), .c(new_n47_), .d(new_n66_), .O(z16));
endmodule
