...
module FAU ( 
  ...
  nand2  g02(.a(x26), .b(x24), .O(new_n47_));
  ...
  nand4  g24(.a(x26), .b(x24), .c(x23), .d(x22), .O(new_n69_));
  ...
  nand3  g30(.a(x26), .b(x24), .c(x23), .O(new_n75_));
  ...
  oai21  g35(.a(x20), .b(x19), .c(new_n68_), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n79_), .c(new_n54_), .O(z10));
  ...
  aoi21  g44(.a(new_n76_), .b(x14), .c(new_n88_), .O(new_n89_));
  ...
  nor2   g50(.a(new_n94_), .b(new_n88_), .O(new_n95_));
  ...
  nand3  g54(.a(x26), .b(x24), .c(x16), .O(new_n99_));
  ...
  nor2   g62(.a(new_n88_), .b(x24), .O(new_n107_));
  nor2   g63(.a(new_n46_), .b(new_n45_), .O(new_n108_));
  nand2  g64(.a(x26), .b(x17), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nor2   g66(.a(x25), .b(x23), .O(new_n111_));
  nor2   g67(.a(new_n111_), .b(new_n50_), .O(new_n112_));
  oai21  g68(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n64_), .O(z15));
  aoi21  g70(.a(new_n108_), .b(x24), .c(x26), .O(new_n115_));
  inv1   g71(.a(x18), .O(new_n116_));
  nand3  g72(.a(new_n96_), .b(new_n76_), .c(new_n116_), .O(new_n117_));
