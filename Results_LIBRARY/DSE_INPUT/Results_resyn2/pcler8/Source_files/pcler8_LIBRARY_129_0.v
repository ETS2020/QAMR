...
module FAU ( 
  ...
  aoi22  g66(.a(new_n110_), .b(new_n108_), .c(new_n86_), .d(x16), .O(new_n111_));
  ...
  nor2   g73(.a(new_n81_), .b(x18), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n77_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n117_), .c(new_n83_), .O(new_n120_));
