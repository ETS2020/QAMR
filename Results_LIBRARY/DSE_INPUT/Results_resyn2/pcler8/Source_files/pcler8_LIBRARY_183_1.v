// Benchmark "FAU" written by ABC on Mon Jul 27 18:38:00 2020
...
module FAU ( 
  ...
  xnor2a g37(.a(new_n72_), .b(x21), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n81_), .c(new_n67_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n55_), .O(z11));
  inv1   g40(.a(new_n49_), .O(new_n85_));
  nand3  g41(.a(x22), .b(x20), .c(x19), .O(new_n86_));
  ...
  oai21  g46(.a(new_n90_), .b(new_n87_), .c(new_n57_), .O(z12));
  nand4  g47(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n92_));
  aoi21  g48(.a(new_n74_), .b(x15), .c(new_n92_), .O(new_n93_));
  inv1   g49(.a(new_n48_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x23), .c(new_n67_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n93_), .c(new_n59_), .O(z13));
  nor2   g52(.a(new_n92_), .b(x24), .O(new_n97_));
  nand4  g53(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n98_));
  nand2  g54(.a(new_n92_), .b(x24), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n97_), .c(new_n67_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n61_), .O(z14));
  ...
  nand3  g62(.a(new_n106_), .b(new_n94_), .c(x25), .O(new_n107_));
  inv1   g63(.a(x25), .O(new_n108_));
  oai21  g64(.a(new_n105_), .b(new_n48_), .c(new_n108_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n107_), .c(new_n104_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n47_), .c(new_n63_), .O(z15));
  nor2   g67(.a(new_n105_), .b(new_n48_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(x25), .c(x26), .O(new_n113_));
  inv1   g69(.a(x18), .O(new_n114_));
  nand2  g70(.a(new_n74_), .b(new_n114_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n92_), .c(new_n67_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n113_), .c(new_n65_), .O(z16));
endmodule
