...
module FAU ( 
  ...
  xor2a  g36(.a(new_n73_), .b(new_n80_), .O(new_n81_));
  nand3  g37(.a(x23), .b(x22), .c(x13), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(new_n49_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n81_), .c(new_n67_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n55_), .O(z11));
  ...
  inv1   g56(.a(new_n45_), .O(new_n101_));
  nand3  g57(.a(x26), .b(x25), .c(x16), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n101_), .c(new_n100_), .O(new_n103_));
  nor3   g59(.a(new_n45_), .b(x24), .c(new_n80_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n103_), .c(new_n67_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n61_), .O(z14));
  nand2  g62(.a(x26), .b(x17), .O(new_n107_));
  nor2   g63(.a(new_n45_), .b(new_n100_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n107_), .c(x25), .O(new_n109_));
  inv1   g65(.a(x25), .O(new_n110_));
  oai21  g66(.a(new_n45_), .b(new_n100_), .c(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n67_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n63_), .O(z15));
  aoi21  g69(.a(new_n108_), .b(x25), .c(x26), .O(new_n114_));
  inv1   g70(.a(x18), .O(new_n115_));
  and2   g71(.a(x26), .b(x25), .O(new_n116_));
  nand3  g72(.a(new_n108_), .b(new_n116_), .c(new_n115_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n67_), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n114_), .c(new_n65_), .O(z16));
endmodule
