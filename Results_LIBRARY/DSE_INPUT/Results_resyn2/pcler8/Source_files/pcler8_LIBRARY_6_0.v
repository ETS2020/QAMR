...
module FAU ( 
  ...
  aoi22  g30(.a(new_n74_), .b(new_n72_), .c(new_n70_), .d(new_n45_), .O(new_n75_));
  oai22  g31(.a(new_n75_), .b(new_n49_), .c(new_n47_), .d(new_n52_), .O(z09));
  inv1   g32(.a(x20), .O(new_n77_));
  nor2   g33(.a(new_n77_), .b(new_n45_), .O(new_n78_));
  nand3  g34(.a(x22), .b(x21), .c(x12), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n71_), .c(new_n78_), .O(new_n80_));
  aoi21  g36(.a(new_n77_), .b(new_n45_), .c(new_n49_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  oai21  g38(.a(new_n47_), .b(new_n54_), .c(new_n82_), .O(z10));
  nand3  g39(.a(x21), .b(x20), .c(x19), .O(new_n84_));
  and2   g40(.a(x22), .b(x13), .O(new_n85_));
  aoi21  g41(.a(new_n85_), .b(new_n72_), .c(new_n84_), .O(new_n86_));
  inv1   g42(.a(new_n49_), .O(new_n87_));
  oai21  g43(.a(new_n78_), .b(x21), .c(new_n87_), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n86_), .c(new_n47_), .d(new_n56_), .O(z11));
  ...
  oai21  g48(.a(new_n92_), .b(x22), .c(new_n87_), .O(new_n93_));
  oai22  g49(.a(new_n93_), .b(new_n91_), .c(new_n47_), .d(new_n58_), .O(z12));
  inv1   g50(.a(x15), .O(new_n95_));
  nor2   g51(.a(new_n46_), .b(new_n45_), .O(new_n96_));
  oai21  g52(.a(new_n50_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g56(.a(new_n100_), .b(new_n60_), .O(z13));
  nand3  g57(.a(x26), .b(x25), .c(x16), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x24), .c(x19), .O(new_n103_));
  aoi21  g59(.a(new_n70_), .b(new_n46_), .c(new_n103_), .O(new_n104_));
  oai21  g60(.a(new_n96_), .b(x24), .c(new_n87_), .O(new_n105_));
  ...
  nand3  g65(.a(new_n109_), .b(new_n107_), .c(x19), .O(new_n110_));
  nand3  g66(.a(new_n68_), .b(x24), .c(x23), .O(new_n111_));
  nor2   g67(.a(new_n111_), .b(new_n90_), .O(new_n112_));
  aoi21  g68(.a(new_n110_), .b(x25), .c(new_n112_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n49_), .c(new_n64_), .O(z15));
  nor2   g70(.a(new_n108_), .b(x18), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n107_), .c(x19), .O(new_n116_));
  nand2  g72(.a(x26), .b(x25), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x24), .c(x23), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  aoi21  g75(.a(new_n116_), .b(x26), .c(new_n119_), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n49_), .c(new_n66_), .O(z16));
endmodule
