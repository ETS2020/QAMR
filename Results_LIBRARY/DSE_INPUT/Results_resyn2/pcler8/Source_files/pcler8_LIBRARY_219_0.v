...
module FAU ( 
  ...
  aoi21  g28(.a(new_n72_), .b(new_n71_), .c(x19), .O(new_n73_));
  ...
  oai22  g34(.a(new_n78_), .b(new_n47_), .c(new_n45_), .d(new_n55_), .O(z09));
  ...
  oai22  g40(.a(new_n84_), .b(new_n82_), .c(new_n45_), .d(new_n57_), .O(z10));
  nand3  g41(.a(x23), .b(x22), .c(x13), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  aoi21  g43(.a(new_n87_), .b(new_n49_), .c(new_n50_), .O(new_n88_));
  oai21  g44(.a(new_n80_), .b(x21), .c(new_n83_), .O(new_n89_));
  oai22  g45(.a(new_n89_), .b(new_n88_), .c(new_n45_), .d(new_n59_), .O(z11));
  inv1   g46(.a(new_n75_), .O(new_n91_));
  inv1   g47(.a(new_n50_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x22), .O(new_n93_));
  aoi21  g49(.a(new_n91_), .b(x14), .c(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n92_), .b(x22), .c(new_n83_), .O(new_n95_));
  ...
  inv1   g59(.a(x19), .O(new_n104_));
  nand4  g60(.a(new_n72_), .b(x23), .c(x22), .d(x21), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(x20), .c(new_n104_), .O(new_n106_));
  nand3  g62(.a(x26), .b(x25), .c(x16), .O(new_n107_));
  nand4  g63(.a(x23), .b(x22), .c(x21), .d(x19), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n107_), .c(new_n72_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n106_), .c(new_n83_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n116_), .b(new_n115_), .c(new_n80_), .d(x25), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  oai21  g75(.a(new_n100_), .b(new_n119_), .c(new_n118_), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n117_), .c(new_n114_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n47_), .c(new_n67_), .O(z15));
  inv1   g78(.a(x18), .O(new_n123_));
  nand3  g79(.a(new_n52_), .b(new_n49_), .c(new_n123_), .O(new_n124_));
  inv1   g80(.a(x26), .O(new_n125_));
  nand2  g81(.a(new_n117_), .b(new_n125_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n83_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n69_), .O(z16));
endmodule
