...
module FAU ( 
  ...
  nor2   g33(.a(new_n77_), .b(new_n69_), .O(new_n78_));
  aoi21  g34(.a(new_n76_), .b(new_n75_), .c(new_n78_), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(new_n50_), .c(new_n48_), .d(new_n54_), .O(z10));
