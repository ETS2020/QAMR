...
module FAU ( 
  ...
  nand3  g27(.a(x26), .b(x24), .c(x23), .O(new_n72_));
  ...
  oai21  g38(.a(new_n82_), .b(x21), .c(new_n67_), .O(new_n83_));
  oai22  g39(.a(new_n83_), .b(new_n81_), .c(new_n46_), .d(new_n55_), .O(z11));
  nand2  g40(.a(new_n73_), .b(x14), .O(new_n85_));
  inv1   g41(.a(new_n85_), .O(new_n86_));
  and2   g42(.a(x22), .b(x21), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n82_), .O(new_n88_));
  inv1   g44(.a(x22), .O(new_n89_));
  aoi21  g45(.a(new_n49_), .b(new_n89_), .c(new_n48_), .O(new_n90_));
  oai21  g46(.a(new_n88_), .b(new_n86_), .c(new_n90_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n57_), .O(z12));
  nand3  g48(.a(x26), .b(x24), .c(x15), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(new_n87_), .c(new_n82_), .d(x23), .O(new_n94_));
  ...
  nand2  g55(.a(x26), .b(x16), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n99_), .c(x23), .d(x22), .O(new_n101_));
  ...
  aoi21  g61(.a(new_n101_), .b(x24), .c(new_n105_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n48_), .c(new_n61_), .O(z14));
  inv1   g63(.a(new_n102_), .O(new_n108_));
  ...
  or2    g68(.a(x25), .b(x20), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n112_), .c(new_n67_), .O(new_n114_));
  oai21  g70(.a(new_n46_), .b(new_n63_), .c(new_n114_), .O(z15));
  inv1   g71(.a(x26), .O(new_n116_));
  nor4   g72(.a(new_n109_), .b(new_n102_), .c(new_n116_), .d(x18), .O(new_n117_));
  oai21  g73(.a(new_n109_), .b(new_n102_), .c(new_n116_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n67_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n117_), .c(new_n65_), .O(z16));
endmodule
