...
module FAU ( 
  ...
  nand4  g04(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n49_));
  ...
  inv1   g35(.a(new_n49_), .O(new_n80_));
  inv1   g36(.a(new_n72_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(x21), .O(new_n82_));
  aoi21  g38(.a(new_n80_), .b(x13), .c(new_n82_), .O(new_n83_));
  oai21  g39(.a(new_n81_), .b(x21), .c(new_n67_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n83_), .c(new_n55_), .O(z11));
  nand4  g41(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n86_));
  nand4  g42(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n86_), .c(x23), .O(new_n89_));
  inv1   g45(.a(x22), .O(new_n90_));
  nand2  g46(.a(new_n48_), .b(new_n90_), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n89_), .c(new_n67_), .O(new_n92_));
  oai21  g48(.a(new_n45_), .b(new_n57_), .c(new_n92_), .O(z12));
  inv1   g49(.a(x20), .O(new_n94_));
  nand4  g50(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(x19), .c(new_n94_), .O(new_n96_));
  nand3  g52(.a(x22), .b(x21), .c(x20), .O(new_n97_));
  and2   g53(.a(new_n97_), .b(x23), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n67_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n59_), .O(z13));
  nor2   g56(.a(new_n87_), .b(x24), .O(new_n101_));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n102_));
  nand2  g58(.a(new_n87_), .b(x24), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n101_), .c(new_n67_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n61_), .O(z14));
  nand3  g62(.a(x26), .b(x25), .c(x17), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  inv1   g64(.a(new_n48_), .O(new_n109_));
  nand2  g65(.a(x24), .b(x22), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(x25), .O(new_n112_));
  inv1   g68(.a(x25), .O(new_n113_));
  oai21  g69(.a(new_n110_), .b(new_n48_), .c(new_n113_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n112_), .c(new_n108_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n47_), .c(new_n63_), .O(z15));
  nor2   g72(.a(new_n110_), .b(new_n48_), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(x25), .c(x26), .O(new_n118_));
  inv1   g74(.a(x18), .O(new_n119_));
  nand3  g75(.a(new_n88_), .b(new_n74_), .c(new_n119_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n67_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n118_), .c(new_n65_), .O(z16));
endmodule
