...
module FAU ( 
  ...
  nand3  g27(.a(new_n71_), .b(new_n69_), .c(x11), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(x19), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n68_), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n52_), .O(z09));
  and2   g31(.a(x20), .b(x19), .O(new_n76_));
  nand3  g32(.a(new_n71_), .b(new_n69_), .c(x12), .O(new_n77_));
  ...
  aoi21  g40(.a(new_n84_), .b(new_n71_), .c(new_n83_), .O(new_n85_));
  oai21  g41(.a(new_n76_), .b(x21), .c(new_n68_), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n48_), .d(new_n56_), .O(z11));
  inv1   g43(.a(new_n83_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(x22), .O(new_n89_));
  aoi21  g45(.a(new_n71_), .b(x14), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g65(.a(new_n104_), .b(new_n69_), .c(new_n76_), .d(x25), .O(new_n110_));
  ...
  nand3  g74(.a(new_n71_), .b(new_n93_), .c(new_n118_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n68_), .O(new_n120_));
  oai22  g76(.a(new_n120_), .b(new_n117_), .c(new_n48_), .d(new_n66_), .O(z16));
endmodule
