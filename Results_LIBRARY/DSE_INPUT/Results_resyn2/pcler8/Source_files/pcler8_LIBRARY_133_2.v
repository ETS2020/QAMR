// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:47 2020
...
module FAU ( 
  ...
  nand2  g02(.a(x25), .b(x24), .O(new_n47_));
  ...
  nand4  g24(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n69_));
  ...
  nor2   g31(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  nor2   g32(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  oai21  g33(.a(x20), .b(x19), .c(new_n68_), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n77_), .c(new_n54_), .O(z10));
  inv1   g35(.a(new_n69_), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(x13), .c(new_n45_), .O(new_n81_));
  inv1   g37(.a(x21), .O(new_n82_));
  nand2  g38(.a(new_n74_), .b(new_n82_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n68_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n81_), .c(new_n56_), .O(z11));
  inv1   g41(.a(new_n47_), .O(new_n86_));
  nand4  g42(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  and2   g43(.a(x23), .b(x14), .O(new_n88_));
  aoi21  g44(.a(new_n88_), .b(new_n86_), .c(new_n87_), .O(new_n89_));
  inv1   g45(.a(new_n45_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x22), .c(new_n68_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(z12));
  inv1   g48(.a(x15), .O(new_n93_));
  oai21  g49(.a(new_n47_), .b(new_n93_), .c(x23), .O(new_n94_));
  nor2   g50(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  inv1   g51(.a(new_n87_), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(x23), .c(new_n68_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(new_n60_), .O(z13));
  nand3  g54(.a(x25), .b(x24), .c(x16), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  inv1   g56(.a(new_n46_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n90_), .c(x24), .O(new_n102_));
  ...
  nor2   g62(.a(new_n46_), .b(new_n45_), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(x24), .c(x25), .O(new_n108_));
  nor2   g64(.a(new_n47_), .b(x17), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n68_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n108_), .c(new_n64_), .O(z15));
  oai21  g68(.a(new_n74_), .b(new_n69_), .c(x21), .O(new_n113_));
  oai21  g69(.a(new_n82_), .b(x18), .c(x26), .O(new_n114_));
