...
module FAU ( 
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n49_), .O(new_n79_));
  nand2  g35(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  oai21  g36(.a(new_n47_), .b(new_n54_), .c(new_n80_), .O(z10));
  ...
  aoi21  g45(.a(new_n82_), .b(x14), .c(new_n89_), .O(new_n90_));
  oai21  g46(.a(new_n88_), .b(x22), .c(new_n68_), .O(new_n91_));
  oai22  g47(.a(new_n91_), .b(new_n90_), .c(new_n47_), .d(new_n58_), .O(z12));
  ...
  nor2   g59(.a(new_n102_), .b(new_n45_), .O(new_n104_));
  ...
  nand3  g65(.a(new_n109_), .b(new_n104_), .c(new_n93_), .O(new_n110_));
  nand2  g66(.a(new_n105_), .b(new_n108_), .O(new_n111_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n46_), .c(x26), .O(new_n116_));
  nand2  g72(.a(x25), .b(x24), .O(new_n117_));
  nor2   g73(.a(new_n117_), .b(x26), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n93_), .c(x23), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n68_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n66_), .O(z16));
endmodule
