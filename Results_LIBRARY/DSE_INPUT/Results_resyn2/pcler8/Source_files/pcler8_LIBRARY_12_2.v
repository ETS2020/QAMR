...
module FAU ( 
  ...
  nand2  g31(.a(x21), .b(x19), .O(new_n76_));
  aoi21  g32(.a(new_n75_), .b(new_n73_), .c(new_n76_), .O(new_n77_));
  oai22  g33(.a(new_n77_), .b(new_n52_), .c(new_n50_), .d(new_n56_), .O(z09));
  ...
  oai21  g40(.a(x20), .b(x19), .c(new_n53_), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(z10));
  nand3  g42(.a(x23), .b(x22), .c(x13), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  aoi21  g44(.a(new_n88_), .b(new_n81_), .c(new_n79_), .O(new_n89_));
  oai21  g45(.a(x21), .b(x19), .c(new_n53_), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n89_), .c(new_n60_), .O(z11));
  aoi21  g47(.a(new_n73_), .b(x14), .c(new_n45_), .O(new_n92_));
  ...
  nand4  g52(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n97_));
  aoi21  g53(.a(new_n81_), .b(x15), .c(new_n97_), .O(new_n98_));
  inv1   g54(.a(new_n45_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(x23), .c(new_n53_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(new_n64_), .O(z13));
  nor2   g57(.a(new_n97_), .b(x24), .O(new_n102_));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n103_));
  nand2  g59(.a(new_n97_), .b(x24), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n102_), .c(new_n53_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n66_), .O(z14));
  nand3  g63(.a(x26), .b(x25), .c(x17), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  inv1   g65(.a(new_n46_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n99_), .c(x25), .O(new_n111_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n52_), .c(new_n68_), .O(z15));
  aoi21  g71(.a(new_n47_), .b(x25), .c(x26), .O(new_n116_));
  inv1   g72(.a(x18), .O(new_n117_));
  nand3  g73(.a(new_n49_), .b(new_n47_), .c(new_n117_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n53_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n116_), .c(new_n70_), .O(z16));
endmodule
