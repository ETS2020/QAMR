...
module FAU ( 
  ...
  nand4  g24(.a(x26), .b(x25), .c(x23), .d(x22), .O(new_n69_));
  ...
  aoi21  g39(.a(new_n82_), .b(x13), .c(new_n83_), .O(new_n84_));
  oai21  g40(.a(new_n76_), .b(x21), .c(new_n68_), .O(new_n85_));
  oai22  g41(.a(new_n85_), .b(new_n84_), .c(new_n48_), .d(new_n56_), .O(z11));
  nand2  g42(.a(x25), .b(x23), .O(new_n87_));
  inv1   g43(.a(new_n87_), .O(new_n88_));
  and2   g44(.a(x26), .b(x14), .O(new_n89_));
  inv1   g45(.a(new_n83_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(x22), .O(new_n91_));
  aoi21  g47(.a(new_n89_), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n90_), .b(x22), .c(new_n68_), .O(new_n93_));
  oai22  g49(.a(new_n93_), .b(new_n92_), .c(new_n48_), .d(new_n58_), .O(z12));
  ...
  nand3  g66(.a(new_n110_), .b(new_n96_), .c(x24), .O(new_n111_));
  ...
  nor2   g71(.a(new_n87_), .b(x18), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(new_n103_), .c(new_n115_), .O(new_n117_));
  nand4  g73(.a(new_n115_), .b(x25), .c(x24), .d(x23), .O(new_n118_));
  nor2   g74(.a(new_n118_), .b(new_n46_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n117_), .c(new_n68_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n66_), .O(z16));
endmodule
