...
module FAU ( 
  ...
  nor2   g16(.a(new_n50_), .b(new_n60_), .O(z03));
  ...
  oai22  g43(.a(new_n87_), .b(new_n52_), .c(new_n50_), .d(new_n60_), .O(z11));
  inv1   g44(.a(new_n72_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(x14), .c(new_n45_), .O(new_n90_));
  inv1   g46(.a(x22), .O(new_n91_));
  nand2  g47(.a(new_n77_), .b(new_n91_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n90_), .c(new_n62_), .O(z12));
  nand4  g50(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n95_));
  aoi21  g51(.a(new_n79_), .b(x15), .c(new_n95_), .O(new_n96_));
  inv1   g52(.a(new_n45_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(x23), .c(new_n53_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n64_), .O(z13));
  nor2   g55(.a(new_n95_), .b(x24), .O(new_n100_));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n101_));
  nand2  g57(.a(new_n95_), .b(x24), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n100_), .c(new_n53_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n66_), .O(z14));
  ...
  oai21  g68(.a(new_n112_), .b(new_n52_), .c(new_n68_), .O(z15));
  aoi21  g69(.a(new_n47_), .b(x25), .c(x26), .O(new_n114_));
  inv1   g70(.a(x18), .O(new_n115_));
  nand3  g71(.a(new_n49_), .b(new_n47_), .c(new_n115_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n53_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n114_), .c(new_n70_), .O(z16));
endmodule
