// Benchmark "FAU" written by ABC on Mon Jul 27 18:37:44 2020
...
module FAU ( 
  ...
  nor2   g22(.a(new_n47_), .b(new_n66_), .O(z08));
  ...
  inv1   g31(.a(new_n69_), .O(new_n76_));
  ...
  nor2   g35(.a(new_n79_), .b(new_n49_), .O(new_n80_));
  ...
  aoi21  g40(.a(new_n84_), .b(new_n76_), .c(new_n83_), .O(new_n85_));
  oai21  g41(.a(new_n74_), .b(x21), .c(new_n68_), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n85_), .c(new_n47_), .d(new_n56_), .O(z11));
  inv1   g43(.a(new_n83_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(x22), .O(new_n89_));
  aoi21  g45(.a(new_n76_), .b(x14), .c(new_n89_), .O(new_n90_));
  oai21  g46(.a(new_n88_), .b(x22), .c(new_n68_), .O(new_n91_));
  ...
  aoi21  g52(.a(new_n46_), .b(new_n45_), .c(new_n49_), .O(new_n97_));
  ...
  oai21  g62(.a(new_n106_), .b(new_n49_), .c(new_n62_), .O(z14));
  nand3  g63(.a(x26), .b(x25), .c(x17), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand4  g65(.a(new_n104_), .b(new_n75_), .c(new_n74_), .d(x25), .O(new_n110_));
  inv1   g66(.a(x25), .O(new_n111_));
  nand2  g67(.a(x24), .b(x23), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n46_), .c(new_n111_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n109_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n49_), .c(new_n64_), .O(z15));
  nor2   g71(.a(new_n112_), .b(new_n46_), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(x25), .c(x26), .O(new_n117_));
  oai21  g73(.a(new_n69_), .b(new_n46_), .c(new_n68_), .O(new_n118_));
  oai22  g74(.a(new_n118_), .b(new_n117_), .c(new_n47_), .d(new_n66_), .O(z16));
endmodule
