...
module FAU ( 
  ...
  oai21  g39(.a(new_n78_), .b(x21), .c(new_n67_), .O(new_n84_));
  oai22  g40(.a(new_n84_), .b(new_n83_), .c(new_n45_), .d(new_n55_), .O(z11));
  ...
  oai21  g51(.a(new_n80_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  aoi21  g52(.a(new_n87_), .b(new_n94_), .c(new_n47_), .O(new_n97_));
  ...
  oai21  g58(.a(new_n87_), .b(new_n94_), .c(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n87_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x24), .c(x23), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n103_), .c(new_n101_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n47_), .c(new_n61_), .O(z14));
  nand2  g63(.a(x26), .b(x17), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n95_), .c(x25), .d(x24), .O(new_n109_));
  ...
  nor2   g73(.a(new_n49_), .b(new_n48_), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n117_), .c(new_n47_), .O(new_n119_));
