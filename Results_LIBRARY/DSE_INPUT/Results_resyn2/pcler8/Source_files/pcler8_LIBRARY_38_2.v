...
module FAU ( 
  ...
  nand3  g01(.a(x22), .b(x21), .c(x19), .O(new_n46_));
  ...
  nand2  g25(.a(x20), .b(x19), .O(new_n70_));
  aoi21  g26(.a(new_n69_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  oai22  g27(.a(new_n71_), .b(new_n49_), .c(new_n47_), .d(new_n51_), .O(z09));
  inv1   g28(.a(x20), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(x19), .O(new_n74_));
  nand3  g30(.a(x22), .b(x21), .c(x19), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(new_n76_));
  inv1   g32(.a(x12), .O(new_n77_));
  nor2   g33(.a(new_n45_), .b(new_n77_), .O(new_n78_));
  aoi21  g34(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n49_), .c(new_n53_), .O(z10));
  ...
  oai21  g40(.a(new_n84_), .b(new_n45_), .c(new_n83_), .O(new_n85_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n49_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n55_), .O(z11));
  aoi21  g44(.a(new_n67_), .b(x14), .c(new_n46_), .O(new_n89_));
  inv1   g45(.a(new_n49_), .O(new_n90_));
  oai21  g46(.a(new_n83_), .b(x22), .c(new_n90_), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n89_), .c(new_n57_), .O(z12));
  and2   g48(.a(x26), .b(x25), .O(new_n93_));
  and2   g49(.a(x24), .b(x15), .O(new_n94_));
  nand2  g50(.a(new_n76_), .b(x23), .O(new_n95_));
  aoi21  g51(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  inv1   g52(.a(new_n46_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(x23), .c(new_n90_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(new_n59_), .O(z13));
  nand2  g55(.a(new_n93_), .b(x16), .O(new_n100_));
  nand2  g56(.a(x24), .b(x23), .O(new_n101_));
  nor2   g57(.a(new_n75_), .b(new_n101_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  inv1   g59(.a(x24), .O(new_n104_));
  nand2  g60(.a(new_n95_), .b(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n103_), .c(new_n90_), .O(new_n106_));
  ...
  nand3  g66(.a(new_n76_), .b(new_n110_), .c(x25), .O(new_n111_));
  inv1   g67(.a(x25), .O(new_n112_));
  oai21  g68(.a(new_n75_), .b(new_n101_), .c(new_n112_), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n49_), .c(new_n63_), .O(z15));
  aoi21  g71(.a(new_n102_), .b(x25), .c(x26), .O(new_n116_));
  inv1   g72(.a(x18), .O(new_n117_));
  nand3  g73(.a(new_n76_), .b(new_n67_), .c(new_n117_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n90_), .O(new_n119_));
