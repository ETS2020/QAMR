...
module FAU ( 
  ...
  nor2   g26(.a(new_n45_), .b(new_n70_), .O(new_n71_));
  aoi21  g27(.a(new_n71_), .b(new_n69_), .c(new_n67_), .O(new_n72_));
  oai21  g28(.a(new_n72_), .b(new_n49_), .c(new_n51_), .O(z09));
  ...
  aoi22  g35(.a(new_n79_), .b(new_n74_), .c(new_n77_), .d(new_n75_), .O(new_n80_));
  oai22  g36(.a(new_n80_), .b(new_n49_), .c(new_n47_), .d(new_n53_), .O(z10));
  inv1   g37(.a(x21), .O(new_n82_));
  nor2   g38(.a(new_n82_), .b(new_n76_), .O(new_n83_));
  nand2  g39(.a(x22), .b(x13), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n45_), .c(new_n83_), .O(new_n85_));
  aoi21  g41(.a(new_n75_), .b(new_n82_), .c(new_n49_), .O(new_n86_));
  ...
  nand2  g50(.a(new_n69_), .b(x23), .O(new_n95_));
  ...
  nor2   g57(.a(new_n68_), .b(new_n101_), .O(new_n102_));
  ...
  nand3  g66(.a(new_n69_), .b(new_n110_), .c(x25), .O(new_n111_));
  inv1   g67(.a(x25), .O(new_n112_));
  oai21  g68(.a(new_n68_), .b(new_n101_), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g73(.a(new_n69_), .b(new_n74_), .c(new_n117_), .O(new_n118_));
