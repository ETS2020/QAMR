...
module FAU ( 
  ...
  nand4  g40(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n85_));
  ...
  oai21  g45(.a(new_n89_), .b(x22), .c(new_n77_), .O(new_n90_));
  oai22  g46(.a(new_n90_), .b(new_n88_), .c(new_n47_), .d(new_n58_), .O(z12));
  nor2   g47(.a(new_n87_), .b(x23), .O(new_n92_));
  nand2  g48(.a(new_n87_), .b(x23), .O(new_n93_));
  nand3  g49(.a(new_n86_), .b(x21), .c(x15), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n92_), .c(new_n77_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n60_), .O(z13));
  inv1   g53(.a(x16), .O(new_n98_));
  nand3  g54(.a(x22), .b(x20), .c(x19), .O(new_n99_));
  inv1   g55(.a(x24), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x23), .O(new_n101_));
  oai22  g57(.a(new_n101_), .b(new_n99_), .c(new_n50_), .d(new_n98_), .O(new_n102_));
  nor2   g58(.a(new_n46_), .b(new_n45_), .O(new_n103_));
  nor2   g59(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  aoi21  g60(.a(new_n102_), .b(x21), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(new_n108_), .O(new_n114_));
  aoi21  g70(.a(new_n110_), .b(x21), .c(new_n114_), .O(new_n115_));
  ...
  nor3   g78(.a(new_n122_), .b(new_n87_), .c(new_n111_), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n121_), .c(new_n77_), .O(new_n124_));
