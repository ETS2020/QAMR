...
module FAU ( 
  ...
  nor2   g34(.a(new_n69_), .b(new_n78_), .O(new_n79_));
  and2   g35(.a(x21), .b(x12), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(new_n79_), .c(new_n77_), .O(new_n81_));
  oai21  g37(.a(x20), .b(x19), .c(new_n68_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n81_), .c(new_n48_), .d(new_n54_), .O(z10));
  ...
  nand2  g43(.a(new_n87_), .b(new_n68_), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n85_), .c(new_n48_), .d(new_n56_), .O(z11));
  nor2   g45(.a(new_n78_), .b(x20), .O(new_n90_));
  inv1   g46(.a(x14), .O(new_n91_));
  nand3  g47(.a(x22), .b(x21), .c(x19), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  oai21  g49(.a(new_n69_), .b(new_n91_), .c(new_n93_), .O(new_n94_));
  aoi21  g50(.a(new_n84_), .b(new_n78_), .c(x08), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(new_n96_));
  ...
  nand4  g80(.a(new_n72_), .b(new_n70_), .c(x19), .d(new_n124_), .O(new_n125_));
