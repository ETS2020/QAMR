...
module FAU ( 
  ...
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n49_), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  oai21  g34(.a(new_n47_), .b(new_n53_), .c(new_n78_), .O(z10));
  inv1   g35(.a(new_n45_), .O(new_n80_));
  nand3  g36(.a(x21), .b(x20), .c(x19), .O(new_n81_));
  aoi21  g37(.a(new_n80_), .b(x13), .c(new_n81_), .O(new_n82_));
  oai21  g38(.a(new_n74_), .b(x21), .c(new_n67_), .O(new_n83_));
  oai22  g39(.a(new_n83_), .b(new_n82_), .c(new_n47_), .d(new_n55_), .O(z11));
  inv1   g40(.a(x22), .O(new_n85_));
  nand2  g41(.a(new_n81_), .b(new_n85_), .O(new_n86_));
  nand4  g42(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  aoi22  g43(.a(new_n87_), .b(new_n86_), .c(new_n80_), .d(x14), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n49_), .c(new_n47_), .d(new_n57_), .O(z12));
  nor2   g45(.a(new_n87_), .b(x23), .O(new_n90_));
  nand4  g46(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n91_));
  nand2  g47(.a(new_n87_), .b(x23), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n90_), .c(new_n67_), .O(new_n94_));
  ...
  nand2  g54(.a(x23), .b(x22), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n46_), .c(new_n98_), .O(new_n100_));
  inv1   g56(.a(new_n46_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(x24), .c(x23), .d(x22), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n97_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n49_), .c(new_n61_), .O(z14));
  nor2   g60(.a(new_n99_), .b(new_n46_), .O(new_n105_));
  inv1   g61(.a(x25), .O(new_n106_));
  aoi21  g62(.a(x26), .b(x17), .c(new_n106_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n105_), .c(x24), .O(new_n108_));
  ...
  inv1   g68(.a(new_n87_), .O(new_n113_));
  nand2  g69(.a(x25), .b(x24), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(x18), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(new_n116_));
  nand4  g72(.a(new_n112_), .b(x25), .c(x24), .d(x23), .O(new_n117_));
  nor2   g73(.a(new_n117_), .b(new_n87_), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n116_), .c(new_n67_), .O(new_n119_));
