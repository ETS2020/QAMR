...
module FAU ( 
  ...
  oai21  g086(.a(x38), .b(x09), .c(new_n88_), .O(new_n170_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n173_), .c(new_n88_), .O(new_n176_));
