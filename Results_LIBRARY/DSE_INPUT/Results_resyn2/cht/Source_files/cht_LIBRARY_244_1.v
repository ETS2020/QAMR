...
module FAU ( 
  ...
  nand3  g020(.a(x17), .b(new_n85_), .c(new_n103_), .O(new_n104_));
  inv1   g021(.a(new_n104_), .O(z06));
  nand3  g022(.a(x19), .b(new_n85_), .c(x08), .O(new_n106_));
  inv1   g023(.a(new_n106_), .O(z07));
  nor2   g024(.a(x20), .b(new_n103_), .O(new_n108_));
  oai21  g025(.a(x19), .b(x08), .c(new_n85_), .O(new_n109_));
  nor2   g026(.a(new_n109_), .b(new_n108_), .O(z08));
  nor2   g027(.a(x21), .b(new_n103_), .O(new_n111_));
  oai21  g028(.a(x20), .b(x08), .c(new_n85_), .O(new_n112_));
  nor2   g029(.a(new_n112_), .b(new_n111_), .O(z09));
