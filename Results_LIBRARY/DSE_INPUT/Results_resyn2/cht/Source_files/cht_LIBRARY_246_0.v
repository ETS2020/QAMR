// Benchmark "FAU" written by ABC on Mon Jul 27 21:43:00 2020
...
module FAU ( 
  ...
  aoi21  g047(.a(new_n128_), .b(new_n103_), .c(x10), .O(z15));
  inv1   g048(.a(x28), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(x08), .c(x10), .O(z16));
  nor2   g050(.a(x29), .b(new_n103_), .O(new_n134_));
  oai21  g051(.a(x28), .b(x08), .c(new_n85_), .O(new_n135_));
  nor2   g052(.a(new_n135_), .b(new_n134_), .O(z17));
  nor2   g053(.a(x30), .b(new_n103_), .O(new_n137_));
  oai21  g054(.a(x29), .b(x08), .c(new_n85_), .O(new_n138_));
  nor2   g055(.a(new_n138_), .b(new_n137_), .O(z18));
