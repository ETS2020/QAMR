// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:44 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n156_, new_n158_, new_n159_, new_n162_, new_n164_, new_n165_,
  ...
  aoi21  g076(.a(new_n158_), .b(x09), .c(new_n159_), .O(z24));
  aoi21  g077(.a(new_n158_), .b(new_n145_), .c(x10), .O(z25));
  inv1   g078(.a(x38), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(x09), .c(x10), .O(z26));
