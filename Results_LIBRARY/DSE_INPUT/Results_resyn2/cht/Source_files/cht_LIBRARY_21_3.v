...
module FAU ( 
  ...
  nand3  g078(.a(x36), .b(new_n85_), .c(new_n145_), .O(new_n162_));
  oai21  g079(.a(new_n161_), .b(new_n145_), .c(new_n162_), .O(z25));
  nand3  g080(.a(x38), .b(new_n85_), .c(x09), .O(new_n164_));
  oai21  g081(.a(new_n161_), .b(x09), .c(new_n164_), .O(z26));
