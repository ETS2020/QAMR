// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:14 2020
...
module FAU ( 
  ...
  nor2   g088(.a(x14), .b(new_n145_), .O(new_n172_));
  ...
  oai21  g092(.a(x14), .b(new_n145_), .c(new_n171_), .O(new_n176_));
  ...
  inv1   g104(.a(new_n187_), .O(z31));
  inv1   g105(.a(x44), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n168_), .c(x09), .O(new_n190_));
