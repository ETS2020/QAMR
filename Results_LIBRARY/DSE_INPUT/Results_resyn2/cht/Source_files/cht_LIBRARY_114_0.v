...
module FAU ( 
  ...
  aoi21  g023(.a(new_n103_), .b(new_n106_), .c(x10), .O(z07));
  inv1   g024(.a(x20), .O(new_n108_));
  aoi21  g025(.a(new_n108_), .b(x08), .c(x10), .O(z08));
  nor2   g026(.a(x21), .b(new_n106_), .O(new_n110_));
  oai21  g027(.a(x20), .b(x08), .c(new_n85_), .O(new_n111_));
  nor2   g028(.a(new_n111_), .b(new_n110_), .O(z09));
  nor2   g029(.a(x22), .b(new_n106_), .O(new_n113_));
  oai21  g030(.a(x21), .b(x08), .c(new_n85_), .O(new_n114_));
  nor2   g031(.a(new_n114_), .b(new_n113_), .O(z10));
  nor2   g032(.a(x23), .b(new_n106_), .O(new_n116_));
  oai21  g033(.a(x22), .b(x08), .c(new_n85_), .O(new_n117_));
  nor2   g034(.a(new_n117_), .b(new_n116_), .O(z11));
  nor2   g035(.a(x24), .b(new_n106_), .O(new_n119_));
  oai21  g036(.a(x23), .b(x08), .c(new_n85_), .O(new_n120_));
  nor2   g037(.a(new_n120_), .b(new_n119_), .O(z12));
  nor2   g038(.a(x25), .b(new_n106_), .O(new_n122_));
  oai21  g039(.a(x24), .b(x08), .c(new_n85_), .O(new_n123_));
  nor2   g040(.a(new_n123_), .b(new_n122_), .O(z13));
  nor2   g041(.a(x26), .b(new_n106_), .O(new_n125_));
  oai21  g042(.a(x25), .b(x08), .c(new_n85_), .O(new_n126_));
  nor2   g043(.a(new_n126_), .b(new_n125_), .O(z14));
  nor2   g044(.a(x27), .b(new_n106_), .O(new_n128_));
  oai21  g045(.a(x26), .b(x08), .c(new_n85_), .O(new_n129_));
  nor2   g046(.a(new_n129_), .b(new_n128_), .O(z15));
  nor2   g047(.a(x28), .b(new_n106_), .O(new_n131_));
  oai21  g048(.a(x27), .b(x08), .c(new_n85_), .O(new_n132_));
  nor2   g049(.a(new_n132_), .b(new_n131_), .O(z16));
  nor2   g050(.a(x29), .b(new_n106_), .O(new_n134_));
  oai21  g051(.a(x28), .b(x08), .c(new_n85_), .O(new_n135_));
  nor2   g052(.a(new_n135_), .b(new_n134_), .O(z17));
  nor2   g053(.a(x30), .b(new_n106_), .O(new_n137_));
