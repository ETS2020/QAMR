...
module FAU ( 
  ...
  nand2  g095(.a(x40), .b(new_n85_), .O(new_n179_));
  nor2   g096(.a(new_n179_), .b(new_n178_), .O(z29));
  nand3  g097(.a(new_n178_), .b(x42), .c(new_n85_), .O(new_n181_));
  inv1   g098(.a(new_n181_), .O(z30));
  inv1   g099(.a(x43), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n168_), .c(x09), .O(new_n184_));
  inv1   g101(.a(x42), .O(new_n185_));
  oai21  g102(.a(x14), .b(new_n145_), .c(new_n185_), .O(new_n186_));
  ...
  oai21  g107(.a(x14), .b(new_n145_), .c(new_n183_), .O(new_n191_));
