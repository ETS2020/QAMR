// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:36 2020
...
module FAU ( 
  ...
  aoi21  g006(.a(new_n89_), .b(new_n84_), .c(x10), .O(z01));
  nor2   g007(.a(new_n84_), .b(x06), .O(new_n91_));
  oai21  g008(.a(x13), .b(x07), .c(new_n86_), .O(new_n92_));
  nor2   g009(.a(new_n92_), .b(new_n91_), .O(z02));
  nor2   g010(.a(new_n84_), .b(x01), .O(new_n94_));
  oai21  g011(.a(x14), .b(x07), .c(new_n86_), .O(new_n95_));
  nor2   g012(.a(new_n95_), .b(new_n94_), .O(z03));
  nor2   g013(.a(new_n84_), .b(x02), .O(new_n97_));
  oai21  g014(.a(x15), .b(x07), .c(new_n86_), .O(new_n98_));
  nor2   g015(.a(new_n98_), .b(new_n97_), .O(z04));
