...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n203_, new_n205_, new_n206_, new_n207_, new_n208_;
  ...
  nand3  g115(.a(x45), .b(new_n168_), .c(x09), .O(new_n199_));
  nand2  g116(.a(x44), .b(new_n85_), .O(new_n200_));
  oai21  g117(.a(new_n200_), .b(new_n198_), .c(new_n199_), .O(z33));
  oai21  g118(.a(x14), .b(new_n145_), .c(x45), .O(new_n202_));
  nand3  g119(.a(new_n198_), .b(x46), .c(new_n85_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n202_), .O(z34));
  nand3  g121(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n205_));
  inv1   g122(.a(x46), .O(new_n206_));
  oai21  g123(.a(x14), .b(new_n145_), .c(new_n206_), .O(new_n207_));
