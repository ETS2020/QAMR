// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:59 2020
...
module FAU ( 
  ...
  oai21  g104(.a(x14), .b(new_n145_), .c(x42), .O(new_n188_));
  nand2  g105(.a(x43), .b(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z31));
  nand2  g107(.a(x43), .b(new_n145_), .O(new_n191_));
  nand3  g108(.a(x44), .b(new_n168_), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z32));
  inv1   g110(.a(x45), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(new_n168_), .c(x09), .O(new_n195_));
  inv1   g112(.a(x44), .O(new_n196_));
  oai21  g113(.a(x14), .b(new_n145_), .c(new_n196_), .O(new_n197_));
  ...
  oai21  g118(.a(x14), .b(new_n145_), .c(new_n194_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n85_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand3  g121(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n205_));
