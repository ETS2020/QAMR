...
module FAU ( 
  ...
  aoi21  g059(.a(new_n140_), .b(new_n103_), .c(x10), .O(z19));
  ...
  nand3  g104(.a(new_n187_), .b(new_n166_), .c(x09), .O(new_n188_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n166_), .c(x09), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n166_), .c(x09), .O(new_n198_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n166_), .c(x09), .O(new_n203_));
  ...
  nand2  g123(.a(new_n166_), .b(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n202_), .c(x10), .O(z35));
endmodule
