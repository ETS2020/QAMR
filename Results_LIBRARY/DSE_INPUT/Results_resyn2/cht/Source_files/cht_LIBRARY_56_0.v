// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:30 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n84_, new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_,
  ...
  oai21  g004(.a(x12), .b(x07), .c(new_n87_), .O(new_n88_));
  aoi21  g005(.a(x07), .b(new_n86_), .c(new_n88_), .O(z01));
  inv1   g006(.a(x06), .O(new_n90_));
  oai21  g007(.a(x13), .b(x07), .c(new_n87_), .O(new_n91_));
  aoi21  g008(.a(x07), .b(new_n90_), .c(new_n91_), .O(z02));
  inv1   g009(.a(x01), .O(new_n93_));
  oai21  g010(.a(x14), .b(x07), .c(new_n87_), .O(new_n94_));
  aoi21  g011(.a(x07), .b(new_n93_), .c(new_n94_), .O(z03));
  inv1   g012(.a(x02), .O(new_n96_));
  oai21  g013(.a(x15), .b(x07), .c(new_n87_), .O(new_n97_));
  aoi21  g014(.a(x07), .b(new_n96_), .c(new_n97_), .O(z04));
  inv1   g015(.a(x03), .O(new_n99_));
  oai21  g016(.a(x16), .b(x07), .c(new_n87_), .O(new_n100_));
  aoi21  g017(.a(x07), .b(new_n99_), .c(new_n100_), .O(z05));
  inv1   g018(.a(x18), .O(new_n102_));
  oai21  g019(.a(x17), .b(x08), .c(new_n87_), .O(new_n103_));
  aoi21  g020(.a(new_n102_), .b(x08), .c(new_n103_), .O(z06));
  inv1   g021(.a(x19), .O(new_n105_));
  oai21  g022(.a(x18), .b(x08), .c(new_n87_), .O(new_n106_));
  aoi21  g023(.a(new_n105_), .b(x08), .c(new_n106_), .O(z07));
  inv1   g024(.a(x20), .O(new_n108_));
  oai21  g025(.a(x19), .b(x08), .c(new_n87_), .O(new_n109_));
  aoi21  g026(.a(new_n108_), .b(x08), .c(new_n109_), .O(z08));
  inv1   g027(.a(x21), .O(new_n111_));
  oai21  g028(.a(x20), .b(x08), .c(new_n87_), .O(new_n112_));
  aoi21  g029(.a(new_n111_), .b(x08), .c(new_n112_), .O(z09));
  inv1   g030(.a(x22), .O(new_n114_));
  oai21  g031(.a(x21), .b(x08), .c(new_n87_), .O(new_n115_));
  aoi21  g032(.a(new_n114_), .b(x08), .c(new_n115_), .O(z10));
  inv1   g033(.a(x23), .O(new_n117_));
  oai21  g034(.a(x22), .b(x08), .c(new_n87_), .O(new_n118_));
  aoi21  g035(.a(new_n117_), .b(x08), .c(new_n118_), .O(z11));
  inv1   g036(.a(x24), .O(new_n120_));
  oai21  g037(.a(x23), .b(x08), .c(new_n87_), .O(new_n121_));
  aoi21  g038(.a(new_n120_), .b(x08), .c(new_n121_), .O(z12));
  inv1   g039(.a(x25), .O(new_n123_));
  oai21  g040(.a(x24), .b(x08), .c(new_n87_), .O(new_n124_));
  aoi21  g041(.a(new_n123_), .b(x08), .c(new_n124_), .O(z13));
  inv1   g042(.a(x26), .O(new_n126_));
  oai21  g043(.a(x25), .b(x08), .c(new_n87_), .O(new_n127_));
  aoi21  g044(.a(new_n126_), .b(x08), .c(new_n127_), .O(z14));
  inv1   g045(.a(x27), .O(new_n129_));
  oai21  g046(.a(x26), .b(x08), .c(new_n87_), .O(new_n130_));
  aoi21  g047(.a(new_n129_), .b(x08), .c(new_n130_), .O(z15));
  inv1   g048(.a(x28), .O(new_n132_));
  oai21  g049(.a(x27), .b(x08), .c(new_n87_), .O(new_n133_));
  aoi21  g050(.a(new_n132_), .b(x08), .c(new_n133_), .O(z16));
  inv1   g051(.a(x29), .O(new_n135_));
  oai21  g052(.a(x28), .b(x08), .c(new_n87_), .O(new_n136_));
  aoi21  g053(.a(new_n135_), .b(x08), .c(new_n136_), .O(z17));
  inv1   g054(.a(x30), .O(new_n138_));
  oai21  g055(.a(x29), .b(x08), .c(new_n87_), .O(new_n139_));
  aoi21  g056(.a(new_n138_), .b(x08), .c(new_n139_), .O(z18));
  inv1   g057(.a(x00), .O(new_n141_));
  oai21  g058(.a(x30), .b(x08), .c(new_n87_), .O(new_n142_));
  aoi21  g059(.a(x08), .b(new_n141_), .c(new_n142_), .O(z19));
  inv1   g060(.a(x09), .O(new_n144_));
  nor2   g061(.a(x32), .b(new_n144_), .O(new_n145_));
  oai21  g062(.a(x31), .b(x09), .c(new_n87_), .O(new_n146_));
  nor2   g063(.a(new_n146_), .b(new_n145_), .O(z20));
  nor2   g064(.a(x33), .b(new_n144_), .O(new_n148_));
  oai21  g065(.a(x32), .b(x09), .c(new_n87_), .O(new_n149_));
  nor2   g066(.a(new_n149_), .b(new_n148_), .O(z21));
  nor2   g067(.a(x34), .b(new_n144_), .O(new_n151_));
  oai21  g068(.a(x33), .b(x09), .c(new_n87_), .O(new_n152_));
  nor2   g069(.a(new_n152_), .b(new_n151_), .O(z22));
  nor2   g070(.a(x35), .b(new_n144_), .O(new_n154_));
  oai21  g071(.a(x34), .b(x09), .c(new_n87_), .O(new_n155_));
  nor2   g072(.a(new_n155_), .b(new_n154_), .O(z23));
  nor2   g073(.a(x36), .b(new_n144_), .O(new_n157_));
  oai21  g074(.a(x35), .b(x09), .c(new_n87_), .O(new_n158_));
  nor2   g075(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g076(.a(x37), .b(new_n144_), .O(new_n160_));
  oai21  g077(.a(x36), .b(x09), .c(new_n87_), .O(new_n161_));
  nor2   g078(.a(new_n161_), .b(new_n160_), .O(z25));
  nor2   g079(.a(x38), .b(new_n144_), .O(new_n163_));
  oai21  g080(.a(x37), .b(x09), .c(new_n87_), .O(new_n164_));
  ...
  oai21  g085(.a(x38), .b(x09), .c(new_n87_), .O(new_n169_));
