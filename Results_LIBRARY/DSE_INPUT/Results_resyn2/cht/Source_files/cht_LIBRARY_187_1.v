// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:39 2020
...
module FAU ( 
  ...
  nand3  g056(.a(x29), .b(new_n85_), .c(new_n103_), .O(new_n140_));
  inv1   g057(.a(new_n140_), .O(z18));
  inv1   g058(.a(x00), .O(new_n142_));
  nor3   g059(.a(x10), .b(new_n103_), .c(new_n142_), .O(z19));
