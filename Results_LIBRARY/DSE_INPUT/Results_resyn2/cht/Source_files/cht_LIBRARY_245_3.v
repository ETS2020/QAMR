...
module FAU ( 
  ...
  nand3  g051(.a(x27), .b(new_n85_), .c(new_n103_), .O(new_n135_));
  oai21  g052(.a(new_n134_), .b(new_n103_), .c(new_n135_), .O(z16));
  nand3  g053(.a(x29), .b(new_n85_), .c(x08), .O(new_n137_));
  oai21  g054(.a(new_n134_), .b(x08), .c(new_n137_), .O(z17));
