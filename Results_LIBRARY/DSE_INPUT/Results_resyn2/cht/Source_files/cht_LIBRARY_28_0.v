...
module FAU ( 
  ...
  nand2  g119(.a(new_n168_), .b(x09), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n198_), .c(x10), .O(z34));
  inv1   g121(.a(new_n203_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n142_), .c(x10), .O(z35));
endmodule
