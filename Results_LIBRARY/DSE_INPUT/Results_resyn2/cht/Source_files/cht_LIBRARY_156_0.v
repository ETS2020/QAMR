...
module FAU ( 
  ...
  nand2  g099(.a(new_n168_), .b(x09), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n178_), .c(x10), .O(z30));
  inv1   g101(.a(x43), .O(new_n185_));
  inv1   g102(.a(new_n183_), .O(new_n186_));
  ...
  oai21  g106(.a(x14), .b(new_n145_), .c(new_n185_), .O(new_n190_));
  ...
  oai21  g120(.a(x14), .b(new_n145_), .c(new_n198_), .O(new_n204_));
