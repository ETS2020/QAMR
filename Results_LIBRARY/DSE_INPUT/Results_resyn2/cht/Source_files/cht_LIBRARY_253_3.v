...
module FAU ( 
  ...
  nand3  g066(.a(x32), .b(new_n85_), .c(new_n145_), .O(new_n150_));
  oai21  g067(.a(new_n149_), .b(new_n145_), .c(new_n150_), .O(z21));
  nand3  g068(.a(x34), .b(new_n85_), .c(x09), .O(new_n152_));
  oai21  g069(.a(new_n149_), .b(x09), .c(new_n152_), .O(z22));
