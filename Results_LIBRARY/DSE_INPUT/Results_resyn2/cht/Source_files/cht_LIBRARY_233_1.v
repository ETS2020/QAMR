...
module FAU ( 
  ...
  nand3  g026(.a(x19), .b(new_n85_), .c(new_n103_), .O(new_n110_));
  inv1   g027(.a(new_n110_), .O(z08));
  nand3  g028(.a(x21), .b(new_n85_), .c(x08), .O(new_n112_));
  inv1   g029(.a(new_n112_), .O(z09));
  nor2   g030(.a(x22), .b(new_n103_), .O(new_n114_));
  oai21  g031(.a(x21), .b(x08), .c(new_n85_), .O(new_n115_));
  nor2   g032(.a(new_n115_), .b(new_n114_), .O(z10));
  nor2   g033(.a(x23), .b(new_n103_), .O(new_n117_));
  oai21  g034(.a(x22), .b(x08), .c(new_n85_), .O(new_n118_));
  nor2   g035(.a(new_n118_), .b(new_n117_), .O(z11));
  nor2   g036(.a(x24), .b(new_n103_), .O(new_n120_));
  oai21  g037(.a(x23), .b(x08), .c(new_n85_), .O(new_n121_));
  nor2   g038(.a(new_n121_), .b(new_n120_), .O(z12));
