// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:44 2020
...
module FAU ( 
  ...
  nor2   g053(.a(x29), .b(new_n103_), .O(new_n137_));
  oai21  g054(.a(x28), .b(x08), .c(new_n85_), .O(new_n138_));
  nor2   g055(.a(new_n138_), .b(new_n137_), .O(z17));
  nor2   g056(.a(x30), .b(new_n103_), .O(new_n140_));
  oai21  g057(.a(x29), .b(x08), .c(new_n85_), .O(new_n141_));
  nor2   g058(.a(new_n141_), .b(new_n140_), .O(z18));
  nand2  g059(.a(x08), .b(x00), .O(new_n143_));
  nand3  g060(.a(x30), .b(new_n85_), .c(new_n103_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n143_), .O(z19));
  inv1   g062(.a(x09), .O(new_n146_));
  nor2   g063(.a(x32), .b(new_n146_), .O(new_n147_));
  oai21  g064(.a(x31), .b(x09), .c(new_n85_), .O(new_n148_));
  nor2   g065(.a(new_n148_), .b(new_n147_), .O(z20));
  nor2   g066(.a(x33), .b(new_n146_), .O(new_n150_));
  oai21  g067(.a(x32), .b(x09), .c(new_n85_), .O(new_n151_));
  nor2   g068(.a(new_n151_), .b(new_n150_), .O(z21));
  nor2   g069(.a(x34), .b(new_n146_), .O(new_n153_));
  oai21  g070(.a(x33), .b(x09), .c(new_n85_), .O(new_n154_));
  nor2   g071(.a(new_n154_), .b(new_n153_), .O(z22));
  nor2   g072(.a(x35), .b(new_n146_), .O(new_n156_));
  oai21  g073(.a(x34), .b(x09), .c(new_n85_), .O(new_n157_));
  nor2   g074(.a(new_n157_), .b(new_n156_), .O(z23));
  nor2   g075(.a(x36), .b(new_n146_), .O(new_n159_));
  oai21  g076(.a(x35), .b(x09), .c(new_n85_), .O(new_n160_));
  nor2   g077(.a(new_n160_), .b(new_n159_), .O(z24));
  nor2   g078(.a(x37), .b(new_n146_), .O(new_n162_));
  oai21  g079(.a(x36), .b(x09), .c(new_n85_), .O(new_n163_));
  nor2   g080(.a(new_n163_), .b(new_n162_), .O(z25));
  nor2   g081(.a(x38), .b(new_n146_), .O(new_n165_));
  oai21  g082(.a(x37), .b(x09), .c(new_n85_), .O(new_n166_));
  nor2   g083(.a(new_n166_), .b(new_n165_), .O(z26));
  aoi21  g084(.a(x39), .b(new_n85_), .c(x14), .O(new_n168_));
  inv1   g085(.a(x14), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(x00), .c(x09), .O(new_n170_));
  nand3  g087(.a(x38), .b(new_n85_), .c(new_n146_), .O(new_n171_));
  oai21  g088(.a(new_n170_), .b(new_n168_), .c(new_n171_), .O(z27));
  inv1   g089(.a(x40), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n169_), .c(x09), .O(new_n174_));
  inv1   g091(.a(x39), .O(new_n175_));
  oai21  g092(.a(x14), .b(new_n146_), .c(new_n175_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n174_), .c(new_n85_), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z28));
  inv1   g095(.a(x41), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n169_), .c(x09), .O(new_n180_));
  oai21  g097(.a(x14), .b(new_n146_), .c(new_n173_), .O(new_n181_));
  ...
  oai21  g102(.a(x14), .b(new_n146_), .c(new_n179_), .O(new_n186_));
  ...
  oai21  g107(.a(x14), .b(new_n146_), .c(new_n184_), .O(new_n191_));
  ...
  oai21  g112(.a(x14), .b(new_n146_), .c(new_n189_), .O(new_n196_));
  ...
  oai21  g117(.a(x14), .b(new_n146_), .c(new_n194_), .O(new_n201_));
  ...
  oai21  g122(.a(x14), .b(new_n146_), .c(new_n199_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n205_), .c(new_n85_), .O(new_n207_));
  inv1   g124(.a(new_n207_), .O(z34));
  nor2   g125(.a(x14), .b(new_n146_), .O(new_n209_));
  nand3  g126(.a(new_n169_), .b(x09), .c(x00), .O(new_n210_));
  nand2  g127(.a(x46), .b(new_n85_), .O(new_n211_));
  oai21  g128(.a(new_n211_), .b(new_n209_), .c(new_n210_), .O(z35));
endmodule
