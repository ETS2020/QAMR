// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:50 2020
...
module FAU ( 
  ...
  nor2   g083(.a(x14), .b(x10), .O(new_n167_));
  aoi22  g084(.a(new_n167_), .b(x39), .c(x14), .d(x00), .O(new_n168_));
  nand3  g085(.a(x38), .b(new_n85_), .c(new_n145_), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n145_), .c(new_n169_), .O(z27));
  nand2  g087(.a(x39), .b(new_n145_), .O(new_n171_));
  nand3  g088(.a(x40), .b(new_n94_), .c(x09), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n85_), .O(new_n174_));
  nand2  g091(.a(x39), .b(x14), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(z28));
  nand2  g093(.a(x40), .b(new_n145_), .O(new_n177_));
  nand3  g094(.a(x41), .b(new_n94_), .c(x09), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n85_), .O(new_n180_));
  nand2  g097(.a(x40), .b(x14), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(z29));
  nand2  g099(.a(x41), .b(new_n145_), .O(new_n183_));
  nand3  g100(.a(x42), .b(new_n94_), .c(x09), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n85_), .O(new_n186_));
  nand2  g103(.a(x41), .b(x14), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z30));
  nand2  g105(.a(x42), .b(new_n145_), .O(new_n189_));
  nand3  g106(.a(x43), .b(new_n94_), .c(x09), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n85_), .O(new_n192_));
  nand2  g109(.a(x42), .b(x14), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n192_), .O(z31));
  nand2  g111(.a(x43), .b(new_n145_), .O(new_n195_));
  nand3  g112(.a(x44), .b(new_n94_), .c(x09), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n85_), .O(new_n198_));
  nand2  g115(.a(x43), .b(x14), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n198_), .O(z32));
  nand2  g117(.a(x44), .b(new_n145_), .O(new_n201_));
  nand3  g118(.a(x45), .b(new_n94_), .c(x09), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n201_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n85_), .O(new_n204_));
  nand2  g121(.a(x44), .b(x14), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n204_), .O(z33));
  nand2  g123(.a(x45), .b(new_n145_), .O(new_n207_));
  nand3  g124(.a(x46), .b(new_n94_), .c(x09), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n207_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n85_), .O(new_n210_));
  nand2  g127(.a(x45), .b(x14), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n210_), .O(z34));
  nand2  g129(.a(x46), .b(new_n145_), .O(new_n213_));
  nand3  g130(.a(new_n94_), .b(x09), .c(x00), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n85_), .O(new_n216_));
  nand2  g133(.a(x46), .b(x14), .O(new_n217_));
