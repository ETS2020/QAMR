...
module FAU ( 
  ...
  aoi21  g084(.a(new_n85_), .b(x00), .c(new_n167_), .O(new_n168_));
  oai21  g085(.a(x39), .b(x14), .c(x09), .O(new_n169_));
  nand3  g086(.a(x38), .b(new_n85_), .c(new_n145_), .O(new_n170_));
  oai21  g087(.a(new_n169_), .b(new_n168_), .c(new_n170_), .O(z27));
  oai21  g088(.a(x14), .b(new_n145_), .c(x39), .O(new_n172_));
  nand4  g089(.a(x40), .b(new_n167_), .c(new_n85_), .d(x09), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z28));
  inv1   g091(.a(x41), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n167_), .c(x09), .O(new_n176_));
  inv1   g093(.a(x40), .O(new_n177_));
  oai21  g094(.a(x14), .b(new_n145_), .c(new_n177_), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(new_n176_), .c(new_n85_), .O(new_n179_));
  inv1   g096(.a(new_n179_), .O(z29));
  inv1   g097(.a(x42), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n167_), .c(x09), .O(new_n182_));
  oai21  g099(.a(x14), .b(new_n145_), .c(new_n175_), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n182_), .c(new_n85_), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z30));
  inv1   g102(.a(x43), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n167_), .c(x09), .O(new_n187_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n167_), .c(x09), .O(new_n192_));
  ...
  nand3  g113(.a(new_n196_), .b(new_n167_), .c(x09), .O(new_n197_));
  ...
  nand3  g118(.a(new_n201_), .b(new_n167_), .c(x09), .O(new_n202_));
  ...
  nand3  g122(.a(new_n167_), .b(x09), .c(new_n142_), .O(new_n206_));
