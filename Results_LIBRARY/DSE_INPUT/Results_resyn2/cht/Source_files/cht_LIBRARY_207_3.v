...
module FAU ( 
  ...
  nand3  g063(.a(x31), .b(new_n85_), .c(new_n145_), .O(new_n147_));
  oai21  g064(.a(new_n146_), .b(new_n145_), .c(new_n147_), .O(z20));
  nand3  g065(.a(x33), .b(new_n85_), .c(x09), .O(new_n149_));
  oai21  g066(.a(new_n146_), .b(x09), .c(new_n149_), .O(z21));
