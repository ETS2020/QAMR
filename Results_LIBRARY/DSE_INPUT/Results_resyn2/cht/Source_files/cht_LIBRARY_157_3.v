// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:25 2020
...
module FAU ( 
  ...
  nor2   g119(.a(x14), .b(new_n145_), .O(new_n203_));
  nand3  g120(.a(x46), .b(new_n168_), .c(x09), .O(new_n204_));
  nand2  g121(.a(x45), .b(new_n85_), .O(new_n205_));
  oai21  g122(.a(new_n205_), .b(new_n203_), .c(new_n204_), .O(z34));
  oai21  g123(.a(x14), .b(new_n145_), .c(x46), .O(new_n207_));
  nand3  g124(.a(new_n203_), .b(new_n85_), .c(x00), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n207_), .O(z35));
endmodule
