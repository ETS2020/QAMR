...
module FAU ( 
  ...
  nand4  g087(.a(x40), .b(new_n170_), .c(new_n85_), .d(x09), .O(new_n171_));
  inv1   g088(.a(new_n171_), .O(z28));
  inv1   g089(.a(x41), .O(new_n173_));
  nand3  g090(.a(new_n173_), .b(new_n170_), .c(x09), .O(new_n174_));
  inv1   g091(.a(x40), .O(new_n175_));
  oai21  g092(.a(x14), .b(new_n145_), .c(new_n175_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n174_), .c(new_n85_), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z29));
  inv1   g095(.a(x42), .O(new_n179_));
  nand3  g096(.a(new_n179_), .b(new_n170_), .c(x09), .O(new_n180_));
  oai21  g097(.a(x14), .b(new_n145_), .c(new_n173_), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(new_n180_), .c(new_n85_), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z30));
  inv1   g100(.a(x43), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n170_), .c(x09), .O(new_n185_));
  ...
  nand3  g106(.a(new_n189_), .b(new_n170_), .c(x09), .O(new_n190_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n170_), .c(x09), .O(new_n195_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n170_), .c(x09), .O(new_n200_));
  ...
  oai21  g120(.a(x14), .b(new_n145_), .c(x46), .O(new_n204_));
  nand3  g121(.a(new_n170_), .b(x09), .c(x00), .O(new_n205_));
