// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:46 2020
...
module FAU ( 
  ...
  nand2  g114(.a(new_n168_), .b(x09), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n193_), .c(x10), .O(z33));
  inv1   g116(.a(x46), .O(new_n200_));
  inv1   g117(.a(new_n198_), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z34));
  nand3  g119(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n203_));
  oai21  g120(.a(x14), .b(new_n145_), .c(new_n200_), .O(new_n204_));
