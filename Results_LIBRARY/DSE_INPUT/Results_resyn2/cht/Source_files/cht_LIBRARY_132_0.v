...
module FAU ( 
  ...
  aoi21  g079(.a(new_n161_), .b(x09), .c(new_n162_), .O(z25));
  aoi21  g080(.a(new_n161_), .b(new_n145_), .c(x10), .O(z26));
  nand2  g081(.a(x14), .b(x00), .O(new_n165_));
  inv1   g082(.a(x14), .O(new_n166_));
  aoi21  g083(.a(x39), .b(new_n166_), .c(new_n145_), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n165_), .c(x10), .O(z27));
  inv1   g085(.a(x40), .O(new_n169_));
  nand3  g086(.a(new_n169_), .b(new_n166_), .c(x09), .O(new_n170_));
  ...
  nand3  g092(.a(new_n175_), .b(new_n166_), .c(x09), .O(new_n176_));
  ...
  nand3  g097(.a(new_n180_), .b(new_n166_), .c(x09), .O(new_n181_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n166_), .c(x09), .O(new_n186_));
  ...
  nand3  g107(.a(new_n190_), .b(new_n166_), .c(x09), .O(new_n191_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n166_), .c(x09), .O(new_n196_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n166_), .c(x09), .O(new_n201_));
  ...
  nand3  g121(.a(new_n166_), .b(x09), .c(new_n142_), .O(new_n205_));
