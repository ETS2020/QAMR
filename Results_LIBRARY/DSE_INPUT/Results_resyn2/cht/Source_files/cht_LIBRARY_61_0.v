// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:32 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n203_, new_n205_, new_n206_, new_n207_;
  ...
  aoi21  g068(.a(new_n149_), .b(new_n145_), .c(x10), .O(z22));
  inv1   g069(.a(x35), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(x09), .c(x10), .O(z23));
  nor2   g071(.a(x36), .b(new_n145_), .O(new_n155_));
  oai21  g072(.a(x35), .b(x09), .c(new_n85_), .O(new_n156_));
  nor2   g073(.a(new_n156_), .b(new_n155_), .O(z24));
  nor2   g074(.a(x37), .b(new_n145_), .O(new_n158_));
  oai21  g075(.a(x36), .b(x09), .c(new_n85_), .O(new_n159_));
  nor2   g076(.a(new_n159_), .b(new_n158_), .O(z25));
  nor2   g077(.a(x38), .b(new_n145_), .O(new_n161_));
  oai21  g078(.a(x37), .b(x09), .c(new_n85_), .O(new_n162_));
  nor2   g079(.a(new_n162_), .b(new_n161_), .O(z26));
  nand2  g080(.a(x14), .b(x00), .O(new_n164_));
  inv1   g081(.a(x14), .O(new_n165_));
  aoi21  g082(.a(x39), .b(new_n165_), .c(new_n145_), .O(new_n166_));
  oai21  g083(.a(x38), .b(x09), .c(new_n85_), .O(new_n167_));
  aoi21  g084(.a(new_n166_), .b(new_n164_), .c(new_n167_), .O(z27));
  inv1   g085(.a(x40), .O(new_n169_));
  nand3  g086(.a(new_n169_), .b(new_n165_), .c(x09), .O(new_n170_));
  inv1   g087(.a(x39), .O(new_n171_));
  oai21  g088(.a(x14), .b(new_n145_), .c(new_n171_), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n170_), .c(new_n85_), .O(new_n173_));
  inv1   g090(.a(new_n173_), .O(z28));
  inv1   g091(.a(x41), .O(new_n175_));
  nand3  g092(.a(new_n175_), .b(new_n165_), .c(x09), .O(new_n176_));
  oai21  g093(.a(x14), .b(new_n145_), .c(new_n169_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n176_), .c(new_n85_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z29));
  inv1   g096(.a(x42), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(new_n165_), .c(x09), .O(new_n181_));
  oai21  g098(.a(x14), .b(new_n145_), .c(new_n175_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n181_), .c(new_n85_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z30));
  inv1   g101(.a(x43), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n165_), .c(x09), .O(new_n186_));
  oai21  g103(.a(x14), .b(new_n145_), .c(new_n180_), .O(new_n187_));
  nand3  g104(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z31));
  inv1   g106(.a(x44), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n165_), .c(x09), .O(new_n191_));
  oai21  g108(.a(x14), .b(new_n145_), .c(new_n185_), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n191_), .c(new_n85_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z32));
  inv1   g111(.a(x45), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(new_n165_), .c(x09), .O(new_n196_));
  oai21  g113(.a(x14), .b(new_n145_), .c(new_n190_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n85_), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z33));
  inv1   g116(.a(x46), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n165_), .c(x09), .O(new_n201_));
  oai21  g118(.a(x14), .b(new_n145_), .c(new_n195_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(new_n85_), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand3  g121(.a(new_n165_), .b(x09), .c(new_n142_), .O(new_n205_));
  oai21  g122(.a(x14), .b(new_n145_), .c(new_n200_), .O(new_n206_));
