// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:40 2020
...
module FAU ( 
  ...
  nor2   g099(.a(x14), .b(new_n145_), .O(new_n183_));
  nand2  g100(.a(x41), .b(new_n85_), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(new_n183_), .O(z30));
  nand3  g102(.a(new_n183_), .b(x43), .c(new_n85_), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z31));
  inv1   g104(.a(x44), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n168_), .c(x09), .O(new_n189_));
  inv1   g106(.a(x43), .O(new_n190_));
  oai21  g107(.a(x14), .b(new_n145_), .c(new_n190_), .O(new_n191_));
  nand3  g108(.a(new_n191_), .b(new_n189_), .c(new_n85_), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z32));
  inv1   g110(.a(x45), .O(new_n194_));
  nand3  g111(.a(new_n194_), .b(new_n168_), .c(x09), .O(new_n195_));
  oai21  g112(.a(x14), .b(new_n145_), .c(new_n188_), .O(new_n196_));
  ...
  nand3  g120(.a(new_n168_), .b(x09), .c(new_n142_), .O(new_n204_));
  oai21  g121(.a(x14), .b(new_n145_), .c(new_n199_), .O(new_n205_));
