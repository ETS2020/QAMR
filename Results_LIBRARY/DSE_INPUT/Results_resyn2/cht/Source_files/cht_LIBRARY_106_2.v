// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:57 2020
...
module FAU ( 
  ...
  inv1   g110(.a(x00), .O(new_n194_));
  nand3  g111(.a(new_n154_), .b(x09), .c(new_n194_), .O(new_n195_));
  oai21  g112(.a(x14), .b(new_n131_), .c(new_n189_), .O(new_n196_));
  nand3  g113(.a(new_n196_), .b(new_n195_), .c(new_n85_), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z35));
endmodule
