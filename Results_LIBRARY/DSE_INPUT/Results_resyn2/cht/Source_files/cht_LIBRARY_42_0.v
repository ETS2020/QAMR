// Benchmark "FAU" written by ABC on Mon Jul 27 21:41:22 2020
...
module FAU ( 
  ...
  nor2   g019(.a(x17), .b(x08), .O(new_n103_));
  nor2   g020(.a(new_n103_), .b(x10), .O(z06));
  inv1   g021(.a(x19), .O(new_n105_));
  aoi21  g022(.a(new_n105_), .b(x08), .c(x10), .O(z07));
  inv1   g023(.a(x20), .O(new_n107_));
  oai21  g024(.a(x19), .b(x08), .c(new_n85_), .O(new_n108_));
  aoi21  g025(.a(new_n107_), .b(x08), .c(new_n108_), .O(z08));
  inv1   g026(.a(x21), .O(new_n110_));
  oai21  g027(.a(x20), .b(x08), .c(new_n85_), .O(new_n111_));
  aoi21  g028(.a(new_n110_), .b(x08), .c(new_n111_), .O(z09));
  inv1   g029(.a(x22), .O(new_n113_));
  oai21  g030(.a(x21), .b(x08), .c(new_n85_), .O(new_n114_));
  aoi21  g031(.a(new_n113_), .b(x08), .c(new_n114_), .O(z10));
  inv1   g032(.a(x23), .O(new_n116_));
  oai21  g033(.a(x22), .b(x08), .c(new_n85_), .O(new_n117_));
  aoi21  g034(.a(new_n116_), .b(x08), .c(new_n117_), .O(z11));
  inv1   g035(.a(x24), .O(new_n119_));
  oai21  g036(.a(x23), .b(x08), .c(new_n85_), .O(new_n120_));
  aoi21  g037(.a(new_n119_), .b(x08), .c(new_n120_), .O(z12));
  inv1   g038(.a(x25), .O(new_n122_));
  oai21  g039(.a(x24), .b(x08), .c(new_n85_), .O(new_n123_));
  aoi21  g040(.a(new_n122_), .b(x08), .c(new_n123_), .O(z13));
  inv1   g041(.a(x26), .O(new_n125_));
  oai21  g042(.a(x25), .b(x08), .c(new_n85_), .O(new_n126_));
  aoi21  g043(.a(new_n125_), .b(x08), .c(new_n126_), .O(z14));
  inv1   g044(.a(x27), .O(new_n128_));
  oai21  g045(.a(x26), .b(x08), .c(new_n85_), .O(new_n129_));
  aoi21  g046(.a(new_n128_), .b(x08), .c(new_n129_), .O(z15));
  inv1   g047(.a(x28), .O(new_n131_));
  oai21  g048(.a(x27), .b(x08), .c(new_n85_), .O(new_n132_));
  aoi21  g049(.a(new_n131_), .b(x08), .c(new_n132_), .O(z16));
  inv1   g050(.a(x29), .O(new_n134_));
  oai21  g051(.a(x28), .b(x08), .c(new_n85_), .O(new_n135_));
  aoi21  g052(.a(new_n134_), .b(x08), .c(new_n135_), .O(z17));
  inv1   g053(.a(x30), .O(new_n137_));
  oai21  g054(.a(x29), .b(x08), .c(new_n85_), .O(new_n138_));
  aoi21  g055(.a(new_n137_), .b(x08), .c(new_n138_), .O(z18));
  inv1   g056(.a(x00), .O(new_n140_));
  oai21  g057(.a(x30), .b(x08), .c(new_n85_), .O(new_n141_));
  aoi21  g058(.a(x08), .b(new_n140_), .c(new_n141_), .O(z19));
  ...
  nand3  g122(.a(new_n166_), .b(x09), .c(new_n140_), .O(new_n206_));
