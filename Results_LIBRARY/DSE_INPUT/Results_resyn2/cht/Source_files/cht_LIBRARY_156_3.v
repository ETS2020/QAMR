// Benchmark "FAU" written by ABC on Mon Jul 27 21:42:24 2020
...
module FAU ( 
  ...
  nand3  g100(.a(x42), .b(new_n168_), .c(x09), .O(new_n184_));
  nand2  g101(.a(x41), .b(new_n85_), .O(new_n185_));
  oai21  g102(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(z30));
  oai21  g103(.a(x14), .b(new_n145_), .c(x42), .O(new_n187_));
  nand3  g104(.a(new_n183_), .b(x43), .c(new_n85_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(z31));
  inv1   g106(.a(x44), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n168_), .c(x09), .O(new_n191_));
  inv1   g108(.a(x43), .O(new_n192_));
  oai21  g109(.a(x14), .b(new_n145_), .c(new_n192_), .O(new_n193_));
  ...
  oai21  g114(.a(x14), .b(new_n145_), .c(new_n190_), .O(new_n198_));
