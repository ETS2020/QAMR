...
module FAU ( 
  ...
  nand3  g072(.a(x34), .b(new_n85_), .c(new_n145_), .O(new_n156_));
  oai21  g073(.a(new_n155_), .b(new_n145_), .c(new_n156_), .O(z23));
  nand3  g074(.a(x36), .b(new_n85_), .c(x09), .O(new_n158_));
  oai21  g075(.a(new_n155_), .b(x09), .c(new_n158_), .O(z24));
