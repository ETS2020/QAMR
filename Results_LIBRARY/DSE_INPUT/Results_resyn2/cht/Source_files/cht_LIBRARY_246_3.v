...
module FAU ( 
  ...
  nand3  g048(.a(x26), .b(new_n85_), .c(new_n103_), .O(new_n132_));
  oai21  g049(.a(new_n131_), .b(new_n103_), .c(new_n132_), .O(z15));
  nand3  g050(.a(x28), .b(new_n85_), .c(x08), .O(new_n134_));
  oai21  g051(.a(new_n131_), .b(x08), .c(new_n134_), .O(z16));
