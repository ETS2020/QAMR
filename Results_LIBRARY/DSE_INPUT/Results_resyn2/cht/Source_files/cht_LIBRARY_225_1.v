...
module FAU ( 
  ...
  nand3  g080(.a(x37), .b(new_n85_), .c(new_n145_), .O(new_n164_));
  ...
  nand2  g085(.a(x14), .b(new_n142_), .O(new_n169_));
  nand4  g086(.a(new_n169_), .b(new_n168_), .c(new_n85_), .d(x09), .O(new_n170_));
  inv1   g087(.a(new_n170_), .O(z27));
  inv1   g088(.a(x40), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n166_), .c(x09), .O(new_n173_));
  oai21  g090(.a(x14), .b(new_n145_), .c(new_n167_), .O(new_n174_));
  ...
  oai21  g095(.a(x14), .b(new_n145_), .c(new_n172_), .O(new_n179_));
  ...
  nand3  g123(.a(new_n166_), .b(x09), .c(new_n142_), .O(new_n207_));
