// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:03 2020
...
module FAU ( 
  ...
  nor2   g116(.a(new_n161_), .b(new_n154_), .O(new_n268_));
  nand4  g117(.a(new_n268_), .b(new_n249_), .c(x47), .d(new_n227_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(new_n257_), .O(z29));
