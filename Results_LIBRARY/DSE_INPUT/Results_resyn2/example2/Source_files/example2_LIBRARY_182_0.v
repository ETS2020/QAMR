// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:02 2020
...
module FAU ( 
  ...
  nand2  g019(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  inv1   g020(.a(new_n171_), .O(z02));
  nand3  g021(.a(new_n155_), .b(x52), .c(new_n166_), .O(new_n173_));
  ...
  oai21  g080(.a(new_n231_), .b(new_n162_), .c(x79), .O(new_n232_));
  ...
  nand2  g086(.a(new_n237_), .b(new_n170_), .O(new_n238_));
  aoi21  g087(.a(new_n238_), .b(new_n235_), .c(x01), .O(z22));
  inv1   g088(.a(x05), .O(new_n240_));
  nand2  g089(.a(new_n166_), .b(x00), .O(new_n241_));
  ...
  nor4   g096(.a(new_n247_), .b(new_n164_), .c(x43), .d(new_n240_), .O(z24));
  inv1   g097(.a(x81), .O(new_n249_));
  xor2a  g098(.a(x84), .b(x82), .O(new_n250_));
  xor2a  g099(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  nand3  g100(.a(new_n246_), .b(new_n163_), .c(x79), .O(new_n252_));
  ...
  nor2   g119(.a(new_n226_), .b(new_n240_), .O(new_n271_));
  ...
  nand2  g163(.a(new_n314_), .b(new_n167_), .O(new_n315_));
  inv1   g164(.a(new_n315_), .O(new_n316_));
  oai21  g165(.a(new_n312_), .b(x15), .c(new_n316_), .O(new_n317_));
  nand2  g166(.a(new_n168_), .b(x79), .O(new_n318_));
  nor2   g167(.a(new_n318_), .b(new_n236_), .O(new_n319_));
  oai21  g168(.a(x75), .b(x67), .c(new_n319_), .O(new_n320_));
  aoi21  g169(.a(new_n320_), .b(new_n317_), .c(x01), .O(z47));
  nand2  g170(.a(new_n319_), .b(x68), .O(new_n322_));
  inv1   g171(.a(x08), .O(new_n323_));
  nand2  g172(.a(new_n312_), .b(new_n323_), .O(new_n324_));
  inv1   g173(.a(x16), .O(new_n325_));
  nand2  g174(.a(x52), .b(new_n325_), .O(new_n326_));
  nand3  g175(.a(new_n326_), .b(new_n324_), .c(new_n316_), .O(new_n327_));
  aoi21  g176(.a(new_n327_), .b(new_n322_), .c(x01), .O(z48));
  nand2  g177(.a(new_n319_), .b(x69), .O(new_n329_));
  inv1   g178(.a(x09), .O(new_n330_));
  nand2  g179(.a(new_n312_), .b(new_n330_), .O(new_n331_));
  inv1   g180(.a(x17), .O(new_n332_));
  nand2  g181(.a(x52), .b(new_n332_), .O(new_n333_));
  nand3  g182(.a(new_n333_), .b(new_n331_), .c(new_n316_), .O(new_n334_));
  aoi21  g183(.a(new_n334_), .b(new_n329_), .c(x01), .O(z49));
  nand2  g184(.a(new_n319_), .b(x70), .O(new_n336_));
  inv1   g185(.a(x10), .O(new_n337_));
  nand2  g186(.a(new_n312_), .b(new_n337_), .O(new_n338_));
  inv1   g187(.a(x18), .O(new_n339_));
  nand2  g188(.a(x52), .b(new_n339_), .O(new_n340_));
  nand3  g189(.a(new_n340_), .b(new_n338_), .c(new_n316_), .O(new_n341_));
  aoi21  g190(.a(new_n341_), .b(new_n336_), .c(x01), .O(z50));
  nand2  g191(.a(new_n319_), .b(x71), .O(new_n343_));
  inv1   g192(.a(x11), .O(new_n344_));
  nand2  g193(.a(new_n312_), .b(new_n344_), .O(new_n345_));
  inv1   g194(.a(x19), .O(new_n346_));
  nand2  g195(.a(x52), .b(new_n346_), .O(new_n347_));
  nand3  g196(.a(new_n347_), .b(new_n345_), .c(new_n316_), .O(new_n348_));
  aoi21  g197(.a(new_n348_), .b(new_n343_), .c(x01), .O(z51));
  nand2  g198(.a(new_n319_), .b(x72), .O(new_n350_));
  inv1   g199(.a(x12), .O(new_n351_));
  nand2  g200(.a(new_n312_), .b(new_n351_), .O(new_n352_));
  inv1   g201(.a(x20), .O(new_n353_));
  nand2  g202(.a(x52), .b(new_n353_), .O(new_n354_));
  nand3  g203(.a(new_n354_), .b(new_n352_), .c(new_n316_), .O(new_n355_));
  aoi21  g204(.a(new_n355_), .b(new_n350_), .c(x01), .O(z52));
  nand2  g205(.a(new_n319_), .b(x73), .O(new_n357_));
  inv1   g206(.a(x13), .O(new_n358_));
  nand2  g207(.a(new_n312_), .b(new_n358_), .O(new_n359_));
  inv1   g208(.a(x21), .O(new_n360_));
  nand2  g209(.a(x52), .b(new_n360_), .O(new_n361_));
  nand3  g210(.a(new_n361_), .b(new_n359_), .c(new_n316_), .O(new_n362_));
  aoi21  g211(.a(new_n362_), .b(new_n357_), .c(x01), .O(z53));
  nor2   g212(.a(x52), .b(x14), .O(new_n364_));
  oai21  g213(.a(new_n312_), .b(x22), .c(new_n166_), .O(new_n365_));
  nor3   g214(.a(new_n365_), .b(new_n364_), .c(new_n315_), .O(z54));
  inv1   g215(.a(x80), .O(new_n367_));
  inv1   g216(.a(x82), .O(new_n368_));
  nand4  g217(.a(new_n273_), .b(x84), .c(new_n368_), .d(new_n367_), .O(new_n369_));
  nor2   g218(.a(new_n369_), .b(new_n252_), .O(z55));
  inv1   g219(.a(new_n163_), .O(new_n371_));
  inv1   g220(.a(new_n236_), .O(new_n372_));
  nor2   g221(.a(new_n168_), .b(new_n167_), .O(new_n373_));
  nor2   g222(.a(new_n373_), .b(new_n372_), .O(new_n374_));
  aoi21  g223(.a(new_n371_), .b(x76), .c(new_n374_), .O(new_n375_));
  nor2   g224(.a(new_n241_), .b(new_n159_), .O(new_n376_));
  oai21  g225(.a(new_n375_), .b(new_n161_), .c(new_n376_), .O(z56));
  inv1   g226(.a(x02), .O(new_n378_));
  nand3  g227(.a(new_n242_), .b(x03), .c(new_n378_), .O(new_n379_));
  inv1   g228(.a(new_n379_), .O(z57));
  oai21  g229(.a(new_n167_), .b(new_n313_), .c(new_n161_), .O(new_n381_));
  nand3  g230(.a(new_n161_), .b(new_n154_), .c(x40), .O(new_n382_));
  nand3  g231(.a(new_n234_), .b(new_n231_), .c(x79), .O(new_n383_));
  ...
  aoi21  g235(.a(new_n386_), .b(new_n381_), .c(x01), .O(z58));
  nand3  g236(.a(new_n231_), .b(x79), .c(new_n153_), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(new_n234_), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n382_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x77), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(new_n244_), .c(x01), .O(z59));
  inv1   g241(.a(new_n227_), .O(new_n393_));
  nand4  g242(.a(new_n272_), .b(new_n393_), .c(new_n228_), .d(x43), .O(new_n394_));
  nand4  g243(.a(new_n394_), .b(x77), .c(new_n226_), .d(x04), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(x79), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(x78), .O(new_n397_));
  aoi21  g246(.a(new_n374_), .b(x79), .c(new_n243_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n397_), .c(x01), .O(z60));
  oai22  g248(.a(new_n373_), .b(new_n236_), .c(new_n371_), .d(x04), .O(new_n400_));
  inv1   g249(.a(new_n400_), .O(new_n401_));
  nor2   g250(.a(new_n161_), .b(x01), .O(new_n402_));
  inv1   g251(.a(new_n402_), .O(new_n403_));
  nor3   g252(.a(new_n403_), .b(new_n401_), .c(new_n367_), .O(z61));
  nand3  g253(.a(new_n394_), .b(new_n226_), .c(x04), .O(new_n405_));
  nand3  g254(.a(x81), .b(x79), .c(new_n313_), .O(new_n406_));
  aoi21  g255(.a(new_n406_), .b(new_n405_), .c(new_n162_), .O(new_n407_));
  oai21  g256(.a(new_n407_), .b(new_n314_), .c(x78), .O(new_n408_));
  inv1   g257(.a(new_n373_), .O(new_n409_));
  nand4  g258(.a(new_n409_), .b(x84), .c(x81), .d(x79), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n408_), .c(x01), .O(z62));
  nor3   g260(.a(new_n403_), .b(new_n401_), .c(new_n368_), .O(z63));
  nand3  g261(.a(new_n400_), .b(x83), .c(x79), .O(new_n413_));
  aoi21  g262(.a(new_n413_), .b(new_n315_), .c(x01), .O(z64));
  nand2  g263(.a(new_n409_), .b(x81), .O(new_n415_));
  nand3  g264(.a(x78), .b(x77), .c(new_n313_), .O(new_n416_));
  nand2  g265(.a(new_n402_), .b(x84), .O(new_n417_));
