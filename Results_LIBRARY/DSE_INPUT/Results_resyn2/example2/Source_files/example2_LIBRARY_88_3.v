...
module FAU ( 
  ...
  nand3  g193(.a(new_n167_), .b(new_n323_), .c(x10), .O(new_n345_));
  nand2  g194(.a(new_n345_), .b(new_n344_), .O(new_n346_));
  nand3  g195(.a(new_n346_), .b(new_n159_), .c(x04), .O(new_n347_));
