...
module FAU ( 
  ...
  oai21  g219(.a(new_n323_), .b(x22), .c(new_n170_), .O(new_n371_));
  nor3   g220(.a(new_n371_), .b(new_n370_), .c(new_n320_), .O(z54));
  ...
  oai21  g232(.a(new_n159_), .b(new_n318_), .c(new_n167_), .O(new_n384_));
  ...
  nand2  g247(.a(new_n247_), .b(new_n318_), .O(new_n399_));
  ...
  aoi21  g262(.a(new_n413_), .b(new_n320_), .c(x01), .O(z64));
