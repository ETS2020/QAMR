// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:30 2020
...
module FAU ( 
  ...
  nand2  g205(.a(new_n321_), .b(new_n170_), .O(new_n357_));
  nor2   g206(.a(x52), .b(x12), .O(new_n358_));
  nor2   g207(.a(new_n323_), .b(x20), .O(new_n359_));
  nor3   g208(.a(new_n359_), .b(new_n358_), .c(new_n357_), .O(z52));
  ...
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n357_), .O(z54));
