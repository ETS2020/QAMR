// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:30 2020
...
module FAU ( 
  ...
  aoi21  g227(.a(new_n238_), .b(x77), .c(x76), .O(new_n379_));
  nand2  g228(.a(x79), .b(new_n154_), .O(new_n380_));
  oai21  g229(.a(new_n380_), .b(new_n379_), .c(new_n246_), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand3  g231(.a(new_n246_), .b(x03), .c(new_n382_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  oai21  g233(.a(new_n165_), .b(new_n320_), .c(new_n169_), .O(new_n385_));
  nand3  g234(.a(new_n169_), .b(new_n154_), .c(x40), .O(new_n386_));
  nand3  g235(.a(new_n235_), .b(new_n232_), .c(x79), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  aoi21  g237(.a(x42), .b(x40), .c(new_n159_), .O(new_n389_));
  ...
  nand2  g245(.a(new_n169_), .b(new_n154_), .O(new_n397_));
  nand3  g246(.a(new_n397_), .b(new_n238_), .c(new_n162_), .O(new_n398_));
  and2   g247(.a(new_n398_), .b(new_n248_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g249(.a(new_n170_), .O(new_n401_));
  aoi22  g250(.a(new_n239_), .b(new_n162_), .c(new_n160_), .d(new_n320_), .O(new_n402_));
  nor3   g251(.a(new_n402_), .b(new_n401_), .c(new_n375_), .O(z61));
  inv1   g252(.a(new_n228_), .O(new_n404_));
  nand4  g253(.a(new_n278_), .b(new_n404_), .c(new_n229_), .d(x43), .O(new_n405_));
  nand3  g254(.a(new_n405_), .b(new_n227_), .c(x04), .O(new_n406_));
  nand3  g255(.a(x81), .b(x79), .c(new_n320_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n406_), .c(new_n159_), .O(new_n408_));
  oai21  g257(.a(new_n408_), .b(new_n321_), .c(x78), .O(new_n409_));
  inv1   g258(.a(new_n165_), .O(new_n410_));
  nand2  g259(.a(new_n167_), .b(new_n410_), .O(new_n411_));
  nand4  g260(.a(new_n411_), .b(x84), .c(x81), .d(x79), .O(new_n412_));
  aoi21  g261(.a(new_n412_), .b(new_n409_), .c(x01), .O(z62));
  nor3   g262(.a(new_n402_), .b(new_n401_), .c(new_n376_), .O(z63));
  inv1   g263(.a(new_n402_), .O(new_n415_));
  nand3  g264(.a(new_n415_), .b(x83), .c(x79), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n322_), .c(x01), .O(z64));
  nand2  g266(.a(new_n411_), .b(x81), .O(new_n418_));
  nand3  g267(.a(x78), .b(x77), .c(new_n320_), .O(new_n419_));
  nand2  g268(.a(new_n170_), .b(x84), .O(new_n420_));
