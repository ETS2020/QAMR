...
module FAU ( 
  ...
  oai21  g236(.a(new_n315_), .b(new_n316_), .c(new_n161_), .O(new_n388_));
  ...
  aoi22  g252(.a(new_n403_), .b(new_n238_), .c(new_n163_), .d(new_n316_), .O(new_n404_));
  ...
  nand3  g257(.a(x81), .b(x79), .c(new_n316_), .O(new_n409_));
  aoi21  g258(.a(new_n409_), .b(new_n408_), .c(new_n162_), .O(new_n410_));
  oai21  g259(.a(new_n410_), .b(new_n317_), .c(x78), .O(new_n411_));
  ...
  aoi21  g265(.a(new_n416_), .b(new_n318_), .c(x01), .O(z64));
  nand2  g266(.a(new_n403_), .b(x81), .O(new_n418_));
  nand3  g267(.a(x78), .b(x77), .c(new_n316_), .O(new_n419_));
