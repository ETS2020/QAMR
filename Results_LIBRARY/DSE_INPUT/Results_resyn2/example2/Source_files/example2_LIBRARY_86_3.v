// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:13 2020
...
module FAU ( 
  ...
  nand2  g198(.a(new_n321_), .b(new_n170_), .O(new_n350_));
  nor2   g199(.a(x52), .b(x11), .O(new_n351_));
  nor2   g200(.a(new_n323_), .b(x19), .O(new_n352_));
  nor3   g201(.a(new_n352_), .b(new_n351_), .c(new_n350_), .O(z51));
  nand2  g202(.a(new_n316_), .b(x72), .O(new_n354_));
  ...
  nand2  g209(.a(new_n316_), .b(x73), .O(new_n361_));
  ...
  nor2   g217(.a(new_n323_), .b(x22), .O(new_n369_));
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n350_), .O(z54));
  inv1   g219(.a(x80), .O(new_n371_));
  inv1   g220(.a(x82), .O(new_n372_));
  nand4  g221(.a(new_n277_), .b(x84), .c(new_n372_), .d(new_n371_), .O(new_n373_));
  nor2   g222(.a(new_n373_), .b(new_n256_), .O(z55));
  aoi21  g223(.a(new_n161_), .b(new_n160_), .c(new_n236_), .O(new_n375_));
  aoi21  g224(.a(new_n248_), .b(x76), .c(new_n375_), .O(new_n376_));
  aoi21  g225(.a(new_n154_), .b(new_n226_), .c(new_n242_), .O(new_n377_));
  oai21  g226(.a(new_n376_), .b(new_n167_), .c(new_n377_), .O(z56));
  inv1   g227(.a(x02), .O(new_n379_));
  nand3  g228(.a(new_n243_), .b(x03), .c(new_n379_), .O(new_n380_));
  inv1   g229(.a(new_n380_), .O(z57));
  oai21  g230(.a(new_n159_), .b(new_n318_), .c(new_n167_), .O(new_n382_));
  nand3  g231(.a(new_n167_), .b(new_n154_), .c(x40), .O(new_n383_));
  nand3  g232(.a(new_n232_), .b(new_n225_), .c(x79), .O(new_n384_));
  nand2  g233(.a(new_n384_), .b(new_n383_), .O(new_n385_));
  aoi21  g234(.a(x42), .b(x40), .c(new_n226_), .O(new_n386_));
  ...
  nand2  g238(.a(new_n389_), .b(new_n225_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n383_), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(x77), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n245_), .c(x01), .O(z59));
  aoi21  g242(.a(new_n375_), .b(x79), .c(new_n244_), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n234_), .c(x01), .O(z60));
  inv1   g244(.a(new_n168_), .O(new_n396_));
  nand2  g245(.a(new_n247_), .b(new_n318_), .O(new_n397_));
  nand2  g246(.a(new_n236_), .b(new_n162_), .O(new_n398_));
  nand2  g247(.a(new_n398_), .b(new_n397_), .O(new_n399_));
  inv1   g248(.a(new_n399_), .O(new_n400_));
  nor3   g249(.a(new_n400_), .b(new_n396_), .c(new_n371_), .O(z61));
  inv1   g250(.a(new_n228_), .O(new_n402_));
  nand4  g251(.a(new_n276_), .b(new_n402_), .c(new_n229_), .d(x43), .O(new_n403_));
  nand3  g252(.a(new_n403_), .b(new_n227_), .c(x04), .O(new_n404_));
  nand3  g253(.a(x81), .b(x79), .c(new_n318_), .O(new_n405_));
  aoi21  g254(.a(new_n405_), .b(new_n404_), .c(new_n226_), .O(new_n406_));
  oai21  g255(.a(new_n406_), .b(new_n319_), .c(x78), .O(new_n407_));
  nand4  g256(.a(new_n162_), .b(x84), .c(x81), .d(x79), .O(new_n408_));
  aoi21  g257(.a(new_n408_), .b(new_n407_), .c(x01), .O(z62));
  nor3   g258(.a(new_n400_), .b(new_n396_), .c(new_n372_), .O(z63));
  nand3  g259(.a(new_n399_), .b(x83), .c(x79), .O(new_n411_));
  aoi21  g260(.a(new_n411_), .b(new_n320_), .c(x01), .O(z64));
  nand2  g261(.a(new_n162_), .b(x81), .O(new_n413_));
  nand2  g262(.a(new_n168_), .b(x84), .O(new_n414_));
  aoi21  g263(.a(new_n413_), .b(new_n397_), .c(new_n414_), .O(z65));
endmodule
