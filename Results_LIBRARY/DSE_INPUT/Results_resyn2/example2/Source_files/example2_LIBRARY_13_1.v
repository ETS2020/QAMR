...
module FAU ( 
  ...
  nor2   g124(.a(new_n227_), .b(new_n244_), .O(new_n276_));
  ...
  nand2  g214(.a(new_n172_), .b(new_n365_), .O(new_n366_));
  ...
  nor2   g220(.a(new_n172_), .b(x22), .O(new_n372_));
  ...
  inv1   g226(.a(new_n159_), .O(new_n378_));
  inv1   g227(.a(new_n250_), .O(new_n379_));
  nand3  g228(.a(new_n379_), .b(new_n246_), .c(new_n378_), .O(z56));
  inv1   g229(.a(x02), .O(new_n381_));
  nand3  g230(.a(new_n246_), .b(x03), .c(new_n381_), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(z57));
  oai21  g232(.a(new_n165_), .b(new_n319_), .c(new_n169_), .O(new_n384_));
  nand3  g233(.a(new_n169_), .b(new_n154_), .c(x40), .O(new_n385_));
  nand3  g234(.a(new_n235_), .b(new_n232_), .c(x79), .O(new_n386_));
  nand2  g235(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  aoi21  g236(.a(x42), .b(x40), .c(new_n160_), .O(new_n388_));
  ...
  aoi21  g243(.a(new_n394_), .b(new_n248_), .c(x01), .O(z59));
  nand2  g244(.a(new_n169_), .b(new_n154_), .O(new_n396_));
  nand3  g245(.a(new_n396_), .b(new_n238_), .c(new_n162_), .O(new_n397_));
  and2   g246(.a(new_n397_), .b(new_n248_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g248(.a(new_n170_), .O(new_n400_));
  nand2  g249(.a(new_n161_), .b(new_n319_), .O(new_n401_));
  nand2  g250(.a(new_n239_), .b(new_n162_), .O(new_n402_));
  nand2  g251(.a(new_n402_), .b(new_n401_), .O(new_n403_));
  inv1   g252(.a(new_n403_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n400_), .c(new_n374_), .O(z61));
  inv1   g254(.a(new_n228_), .O(new_n406_));
  nand4  g255(.a(new_n277_), .b(new_n406_), .c(new_n229_), .d(x43), .O(new_n407_));
  nand3  g256(.a(new_n407_), .b(new_n227_), .c(x04), .O(new_n408_));
  nand3  g257(.a(x81), .b(x79), .c(new_n319_), .O(new_n409_));
  aoi21  g258(.a(new_n409_), .b(new_n408_), .c(new_n160_), .O(new_n410_));
  oai21  g259(.a(new_n410_), .b(new_n320_), .c(x78), .O(new_n411_));
  ...
  nor3   g264(.a(new_n404_), .b(new_n400_), .c(new_n375_), .O(z63));
  nand3  g265(.a(new_n403_), .b(x83), .c(x79), .O(new_n417_));
  aoi21  g266(.a(new_n417_), .b(new_n321_), .c(x01), .O(z64));
  nand2  g267(.a(new_n413_), .b(x81), .O(new_n419_));
  nand3  g268(.a(x78), .b(x77), .c(new_n319_), .O(new_n420_));
  nand2  g269(.a(new_n170_), .b(x84), .O(new_n421_));
