...
module FAU ( 
  ...
  nand2  g160(.a(new_n168_), .b(x79), .O(new_n312_));
  nor2   g161(.a(new_n312_), .b(new_n236_), .O(new_n313_));
  oai21  g162(.a(x75), .b(x67), .c(new_n313_), .O(new_n314_));
  inv1   g163(.a(x04), .O(new_n315_));
  nor2   g164(.a(x79), .b(new_n315_), .O(new_n316_));
  nand2  g165(.a(new_n316_), .b(new_n167_), .O(new_n317_));
  ...
  oai21  g181(.a(new_n320_), .b(x17), .c(new_n318_), .O(new_n333_));
  nand2  g182(.a(new_n313_), .b(x69), .O(new_n334_));
  aoi21  g183(.a(new_n334_), .b(new_n333_), .c(x01), .O(z49));
  nand2  g184(.a(new_n313_), .b(x70), .O(new_n336_));
  inv1   g185(.a(x10), .O(new_n337_));
  nand2  g186(.a(new_n320_), .b(new_n337_), .O(new_n338_));
  inv1   g187(.a(x18), .O(new_n339_));
  nand2  g188(.a(x52), .b(new_n339_), .O(new_n340_));
  nand3  g189(.a(new_n340_), .b(new_n338_), .c(new_n318_), .O(new_n341_));
  aoi21  g190(.a(new_n341_), .b(new_n336_), .c(x01), .O(z50));
  nand2  g191(.a(new_n313_), .b(x71), .O(new_n343_));
  inv1   g192(.a(x11), .O(new_n344_));
  nand2  g193(.a(new_n320_), .b(new_n344_), .O(new_n345_));
  inv1   g194(.a(x19), .O(new_n346_));
  nand2  g195(.a(x52), .b(new_n346_), .O(new_n347_));
  nand3  g196(.a(new_n347_), .b(new_n345_), .c(new_n318_), .O(new_n348_));
  aoi21  g197(.a(new_n348_), .b(new_n343_), .c(x01), .O(z51));
  nand2  g198(.a(new_n313_), .b(x72), .O(new_n350_));
  inv1   g199(.a(x12), .O(new_n351_));
  nand2  g200(.a(new_n320_), .b(new_n351_), .O(new_n352_));
  inv1   g201(.a(x20), .O(new_n353_));
  nand2  g202(.a(x52), .b(new_n353_), .O(new_n354_));
  nand3  g203(.a(new_n354_), .b(new_n352_), .c(new_n318_), .O(new_n355_));
  aoi21  g204(.a(new_n355_), .b(new_n350_), .c(x01), .O(z52));
  nand2  g205(.a(new_n313_), .b(x73), .O(new_n357_));
  inv1   g206(.a(x13), .O(new_n358_));
  nand2  g207(.a(new_n320_), .b(new_n358_), .O(new_n359_));
  inv1   g208(.a(x21), .O(new_n360_));
  nand2  g209(.a(x52), .b(new_n360_), .O(new_n361_));
  nand3  g210(.a(new_n361_), .b(new_n359_), .c(new_n318_), .O(new_n362_));
  aoi21  g211(.a(new_n362_), .b(new_n357_), .c(x01), .O(z53));
  nor2   g212(.a(x52), .b(x14), .O(new_n364_));
  oai21  g213(.a(new_n320_), .b(x22), .c(new_n166_), .O(new_n365_));
  nor3   g214(.a(new_n365_), .b(new_n364_), .c(new_n317_), .O(z54));
  ...
  oai21  g229(.a(new_n167_), .b(new_n315_), .c(new_n161_), .O(new_n381_));
  ...
  nand3  g254(.a(x81), .b(x79), .c(new_n315_), .O(new_n406_));
  aoi21  g255(.a(new_n406_), .b(new_n405_), .c(new_n162_), .O(new_n407_));
  oai21  g256(.a(new_n407_), .b(new_n316_), .c(x78), .O(new_n408_));
  ...
  nand3  g264(.a(x78), .b(x77), .c(new_n315_), .O(new_n416_));
