// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:17 2020
...
module FAU ( 
  ...
  and2   g133(.a(new_n284_), .b(new_n282_), .O(z37));
  nand2  g134(.a(z37), .b(x52), .O(new_n286_));
  inv1   g135(.a(new_n286_), .O(z34));
  nand2  g136(.a(z37), .b(x53), .O(new_n288_));
  inv1   g137(.a(new_n288_), .O(z35));
  nand2  g138(.a(z37), .b(x54), .O(new_n290_));
  inv1   g139(.a(new_n290_), .O(z36));
  nand2  g140(.a(z37), .b(x56), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(z38));
  nand2  g142(.a(z37), .b(x57), .O(new_n294_));
  inv1   g143(.a(new_n294_), .O(z39));
  nand2  g144(.a(z37), .b(x58), .O(new_n296_));
  inv1   g145(.a(new_n296_), .O(z40));
  nand2  g146(.a(z37), .b(x59), .O(new_n298_));
  inv1   g147(.a(new_n298_), .O(z41));
  nand2  g148(.a(z37), .b(x60), .O(new_n300_));
  inv1   g149(.a(new_n300_), .O(z42));
  nand2  g150(.a(z37), .b(x61), .O(new_n302_));
  inv1   g151(.a(new_n302_), .O(z43));
  nand2  g152(.a(z37), .b(x62), .O(new_n304_));
  inv1   g153(.a(new_n304_), .O(z44));
  nand2  g154(.a(z37), .b(x63), .O(new_n306_));
  inv1   g155(.a(new_n306_), .O(z45));
  nand2  g156(.a(z37), .b(x64), .O(new_n308_));
