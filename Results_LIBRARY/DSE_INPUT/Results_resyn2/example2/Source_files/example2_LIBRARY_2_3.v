// Benchmark "FAU" written by ABC on Mon Jul 27 23:24:29 2020
...
module FAU ( 
  ...
  nand3  g192(.a(new_n154_), .b(x52), .c(x18), .O(new_n344_));
  nand2  g193(.a(new_n344_), .b(new_n343_), .O(new_n345_));
  nand3  g194(.a(new_n345_), .b(new_n161_), .c(x04), .O(new_n346_));
  aoi21  g195(.a(new_n346_), .b(new_n342_), .c(x01), .O(z50));
  nand2  g196(.a(new_n315_), .b(x71), .O(new_n348_));
  inv1   g197(.a(x11), .O(new_n349_));
  nand2  g198(.a(new_n322_), .b(new_n349_), .O(new_n350_));
  inv1   g199(.a(x19), .O(new_n351_));
  nand2  g200(.a(x52), .b(new_n351_), .O(new_n352_));
  nand3  g201(.a(new_n352_), .b(new_n350_), .c(new_n320_), .O(new_n353_));
  aoi21  g202(.a(new_n353_), .b(new_n348_), .c(x01), .O(z51));
  nand2  g203(.a(new_n315_), .b(x72), .O(new_n355_));
  inv1   g204(.a(x12), .O(new_n356_));
  nand2  g205(.a(new_n322_), .b(new_n356_), .O(new_n357_));
  inv1   g206(.a(x20), .O(new_n358_));
  nand2  g207(.a(x52), .b(new_n358_), .O(new_n359_));
  nand3  g208(.a(new_n359_), .b(new_n357_), .c(new_n320_), .O(new_n360_));
  aoi21  g209(.a(new_n360_), .b(new_n355_), .c(x01), .O(z52));
  nand2  g210(.a(new_n315_), .b(x73), .O(new_n362_));
  inv1   g211(.a(x13), .O(new_n363_));
  nand2  g212(.a(new_n322_), .b(new_n363_), .O(new_n364_));
  inv1   g213(.a(x21), .O(new_n365_));
  nand2  g214(.a(x52), .b(new_n365_), .O(new_n366_));
  nand3  g215(.a(new_n366_), .b(new_n364_), .c(new_n320_), .O(new_n367_));
  aoi21  g216(.a(new_n367_), .b(new_n362_), .c(x01), .O(z53));
  nor2   g217(.a(x52), .b(x14), .O(new_n369_));
  oai21  g218(.a(new_n322_), .b(x22), .c(new_n171_), .O(new_n370_));
  nor3   g219(.a(new_n370_), .b(new_n369_), .c(new_n319_), .O(z54));
  ...
  oai21  g231(.a(new_n161_), .b(new_n317_), .c(new_n154_), .O(new_n383_));
  ...
  nand2  g246(.a(new_n157_), .b(new_n317_), .O(new_n398_));
