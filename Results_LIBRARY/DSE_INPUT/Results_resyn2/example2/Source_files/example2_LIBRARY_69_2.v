// Benchmark "FAU" written by ABC on Mon Jul 27 23:25:05 2020
...
module FAU ( 
  ...
  nand2  g185(.a(new_n323_), .b(new_n336_), .O(new_n337_));
  inv1   g186(.a(x17), .O(new_n338_));
  nand2  g187(.a(x52), .b(new_n338_), .O(new_n339_));
  nand3  g188(.a(new_n339_), .b(new_n337_), .c(new_n321_), .O(new_n340_));
  nand4  g189(.a(new_n238_), .b(new_n154_), .c(x77), .d(x69), .O(new_n341_));
