// Benchmark "FAU" written by ABC on Mon Jul 27 23:24:58 2020
...
module FAU ( 
  ...
  nor2   g119(.a(new_n162_), .b(x04), .O(new_n271_));
  nand4  g120(.a(new_n271_), .b(x48), .c(new_n230_), .d(new_n174_), .O(new_n272_));
  nor2   g121(.a(new_n272_), .b(new_n258_), .O(z30));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n271_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n271_), .b(new_n160_), .O(new_n420_));
