...
module FAU ( 
  ...
  nand3  g170(.a(new_n321_), .b(x52), .c(x15), .O(new_n322_));
  aoi21  g171(.a(new_n322_), .b(new_n316_), .c(x01), .O(z47));
  nand2  g172(.a(new_n315_), .b(x68), .O(new_n324_));
  ...
  nand3  g178(.a(new_n329_), .b(new_n327_), .c(new_n321_), .O(new_n330_));
  ...
  oai21  g216(.a(new_n326_), .b(x22), .c(new_n173_), .O(new_n368_));
