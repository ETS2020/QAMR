// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:00 2020
...
module FAU ( 
  ...
  nand3  g111(.a(new_n260_), .b(x44), .c(new_n230_), .O(new_n263_));
  inv1   g112(.a(new_n263_), .O(z26));
  nand3  g113(.a(new_n260_), .b(x45), .c(new_n230_), .O(new_n265_));
  inv1   g114(.a(new_n265_), .O(z27));
  nand3  g115(.a(new_n260_), .b(x46), .c(new_n230_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z28));
  nand3  g117(.a(new_n260_), .b(x47), .c(new_n230_), .O(new_n269_));
  inv1   g118(.a(new_n269_), .O(z29));
  nand3  g119(.a(new_n260_), .b(x48), .c(new_n230_), .O(new_n271_));
  inv1   g120(.a(new_n271_), .O(z30));
  nor2   g121(.a(new_n162_), .b(x04), .O(new_n273_));
  nand4  g122(.a(new_n273_), .b(x49), .c(new_n230_), .d(new_n174_), .O(new_n274_));
  nor2   g123(.a(new_n274_), .b(new_n258_), .O(z31));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n273_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n273_), .b(new_n160_), .O(new_n420_));
