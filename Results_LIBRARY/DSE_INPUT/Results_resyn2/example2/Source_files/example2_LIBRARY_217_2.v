// Benchmark "FAU" written by ABC on Mon Jul 27 23:26:20 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n157_, new_n159_,
    ...
    new_n261_, new_n263_, new_n265_, new_n267_, new_n268_, new_n270_,
  ...
  nor2   g115(.a(new_n162_), .b(x04), .O(new_n267_));
  nand4  g116(.a(new_n267_), .b(x46), .c(new_n230_), .d(new_n174_), .O(new_n268_));
  nor2   g117(.a(new_n268_), .b(new_n258_), .O(z28));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n267_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n267_), .b(new_n160_), .O(new_n420_));
