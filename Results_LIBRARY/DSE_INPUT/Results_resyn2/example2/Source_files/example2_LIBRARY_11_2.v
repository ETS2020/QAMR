// Benchmark "FAU" written by ABC on Mon Jul 27 23:24:34 2020
...
module FAU ( 
  ...
  nand2  g213(.a(new_n323_), .b(new_n364_), .O(new_n365_));
  inv1   g214(.a(x21), .O(new_n366_));
  nand2  g215(.a(x52), .b(new_n366_), .O(new_n367_));
  nand3  g216(.a(new_n367_), .b(new_n365_), .c(new_n321_), .O(new_n368_));
  nand4  g217(.a(new_n238_), .b(new_n154_), .c(x77), .d(x73), .O(new_n369_));
  ...
  aoi21  g227(.a(new_n169_), .b(new_n168_), .c(new_n238_), .O(new_n379_));
  aoi21  g228(.a(new_n378_), .b(x76), .c(new_n379_), .O(new_n380_));
  nor2   g229(.a(new_n244_), .b(new_n159_), .O(new_n381_));
  oai21  g230(.a(new_n380_), .b(new_n161_), .c(new_n381_), .O(z56));
  inv1   g231(.a(x02), .O(new_n383_));
  nand3  g232(.a(new_n245_), .b(x03), .c(new_n383_), .O(new_n384_));
  inv1   g233(.a(new_n384_), .O(z57));
  oai21  g234(.a(new_n317_), .b(new_n318_), .c(new_n161_), .O(new_n386_));
  nand3  g235(.a(new_n161_), .b(new_n154_), .c(x40), .O(new_n387_));
  nand3  g236(.a(new_n235_), .b(new_n232_), .c(x79), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  aoi21  g238(.a(x42), .b(x40), .c(new_n162_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(new_n386_), .c(x01), .O(z58));
  nand3  g241(.a(new_n232_), .b(x79), .c(new_n153_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(new_n235_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n387_), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(x77), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(new_n247_), .c(x01), .O(z59));
  aoi21  g246(.a(new_n379_), .b(x79), .c(new_n246_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n236_), .c(x01), .O(z60));
  inv1   g248(.a(new_n171_), .O(new_n400_));
  nand2  g249(.a(new_n169_), .b(new_n168_), .O(new_n401_));
  aoi22  g250(.a(new_n401_), .b(new_n238_), .c(new_n163_), .d(new_n318_), .O(new_n402_));
  nor3   g251(.a(new_n402_), .b(new_n400_), .c(new_n374_), .O(z61));
  inv1   g252(.a(new_n228_), .O(new_n404_));
  nand4  g253(.a(new_n275_), .b(new_n404_), .c(new_n229_), .d(x43), .O(new_n405_));
  ...
  nand4  g258(.a(new_n401_), .b(x84), .c(x81), .d(x79), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n409_), .c(x01), .O(z62));
  nor3   g260(.a(new_n402_), .b(new_n400_), .c(new_n375_), .O(z63));
  nand2  g261(.a(x83), .b(x79), .O(new_n413_));
  or2    g262(.a(new_n413_), .b(new_n402_), .O(new_n414_));
  aoi21  g263(.a(new_n414_), .b(new_n320_), .c(x01), .O(z64));
  nand2  g264(.a(new_n401_), .b(x81), .O(new_n416_));
  nand3  g265(.a(x78), .b(x77), .c(new_n318_), .O(new_n417_));
  nand2  g266(.a(new_n171_), .b(x84), .O(new_n418_));
