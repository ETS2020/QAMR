...
module FAU ( 
  ...
  nand2  g177(.a(new_n321_), .b(new_n170_), .O(new_n329_));
  nor2   g178(.a(x52), .b(x08), .O(new_n330_));
  nor2   g179(.a(new_n323_), .b(x16), .O(new_n331_));
  nor3   g180(.a(new_n331_), .b(new_n330_), .c(new_n329_), .O(z48));
  nand2  g181(.a(new_n316_), .b(x69), .O(new_n333_));
  inv1   g182(.a(x09), .O(new_n334_));
  nand2  g183(.a(new_n323_), .b(new_n334_), .O(new_n335_));
  inv1   g184(.a(x17), .O(new_n336_));
  nand2  g185(.a(x52), .b(new_n336_), .O(new_n337_));
  nand3  g186(.a(new_n337_), .b(new_n335_), .c(new_n321_), .O(new_n338_));
  aoi21  g187(.a(new_n338_), .b(new_n333_), .c(x01), .O(z49));
  nand2  g188(.a(new_n316_), .b(x70), .O(new_n340_));
  inv1   g189(.a(x10), .O(new_n341_));
  nand2  g190(.a(new_n323_), .b(new_n341_), .O(new_n342_));
  inv1   g191(.a(x18), .O(new_n343_));
  nand2  g192(.a(x52), .b(new_n343_), .O(new_n344_));
  nand3  g193(.a(new_n344_), .b(new_n342_), .c(new_n321_), .O(new_n345_));
  ...
  nor3   g218(.a(new_n369_), .b(new_n368_), .c(new_n329_), .O(z54));
