...
module FAU ( 
  ...
  nor2   g117(.a(new_n162_), .b(x04), .O(new_n269_));
  nand4  g118(.a(new_n269_), .b(x47), .c(new_n230_), .d(new_n174_), .O(new_n270_));
  nor2   g119(.a(new_n270_), .b(new_n258_), .O(z29));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(new_n269_), .O(new_n405_));
  ...
  nand2  g268(.a(new_n269_), .b(new_n160_), .O(new_n420_));
