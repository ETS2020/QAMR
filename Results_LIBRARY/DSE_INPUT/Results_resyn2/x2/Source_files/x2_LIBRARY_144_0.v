// Benchmark "FAU" written by ABC on Mon Jul 27 18:03:00 2020
...
module FAU ( 
  ...
  inv1   g08(.a(x4), .O(new_n27_));
  nand3  g09(.a(x7), .b(new_n27_), .c(x3), .O(new_n28_));
  nand2  g10(.a(new_n28_), .b(x8), .O(new_n29_));
  nand2  g11(.a(new_n29_), .b(new_n18_), .O(new_n30_));
  ...
  xnor2a g18(.a(x8), .b(x7), .O(new_n37_));
  nand4  g19(.a(new_n37_), .b(x2), .c(new_n36_), .d(new_n35_), .O(new_n38_));
  nand4  g20(.a(new_n38_), .b(new_n34_), .c(new_n30_), .d(x6), .O(z5));
  nand4  g21(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n40_));
  nand2  g22(.a(x9), .b(new_n20_), .O(new_n41_));
  inv1   g23(.a(x2), .O(new_n42_));
  nand3  g24(.a(new_n42_), .b(new_n36_), .c(new_n35_), .O(new_n43_));
  nand3  g25(.a(new_n43_), .b(new_n41_), .c(new_n40_), .O(new_n44_));
  nand2  g26(.a(new_n44_), .b(x7), .O(new_n45_));
  inv1   g27(.a(x6), .O(new_n46_));
  oai21  g28(.a(x9), .b(x8), .c(new_n32_), .O(new_n47_));
  aoi21  g29(.a(new_n47_), .b(new_n31_), .c(new_n46_), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(new_n45_), .O(z6));
  one    g31(.O(z3));
endmodule
