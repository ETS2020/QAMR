...
module FAU ( 
  ...
  aoi21  g26(.a(new_n29_), .b(x8), .c(new_n40_), .O(new_n44_));
  nand4  g27(.a(new_n40_), .b(x8), .c(x4), .d(x3), .O(new_n45_));
  inv1   g28(.a(new_n45_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n44_), .c(x7), .O(new_n47_));
  oai21  g30(.a(x9), .b(x8), .c(new_n36_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n23_), .c(new_n39_), .O(new_n49_));
