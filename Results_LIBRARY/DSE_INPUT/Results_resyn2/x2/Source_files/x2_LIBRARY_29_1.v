...
module FAU ( 
  ...
  aoi21  g19(.a(new_n36_), .b(new_n24_), .c(new_n34_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n33_), .O(z5));
  oai21  g21(.a(x1), .b(x0), .c(x8), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(x9), .O(new_n40_));
  nand4  g23(.a(new_n29_), .b(x8), .c(x4), .d(x3), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x7), .O(new_n43_));
  oai21  g26(.a(x9), .b(x8), .c(new_n35_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n24_), .c(new_n34_), .O(new_n45_));
