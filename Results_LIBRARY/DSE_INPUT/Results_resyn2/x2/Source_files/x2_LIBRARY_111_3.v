// Benchmark "FAU" written by ABC on Mon Jul 27 18:02:53 2020
...
module FAU ( 
  ...
  nand4  g20(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n38_));
  inv1   g21(.a(x3), .O(new_n39_));
  nor2   g22(.a(x4), .b(new_n39_), .O(new_n40_));
  nand2  g23(.a(new_n23_), .b(x6), .O(new_n41_));
  aoi21  g24(.a(new_n40_), .b(x7), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n38_), .c(new_n37_), .O(z5));
  ...
  oai21  g32(.a(new_n25_), .b(new_n49_), .c(new_n23_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n21_), .c(new_n48_), .O(new_n51_));
