...
module FAU ( 
  ...
  nand3  g26(.a(new_n43_), .b(new_n38_), .c(new_n35_), .O(z5));
  aoi21  g27(.a(new_n29_), .b(x8), .c(new_n40_), .O(new_n45_));
  nand4  g28(.a(new_n40_), .b(x8), .c(x4), .d(x3), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n45_), .c(x7), .O(new_n48_));
  oai21  g31(.a(x9), .b(x8), .c(new_n36_), .O(new_n49_));
