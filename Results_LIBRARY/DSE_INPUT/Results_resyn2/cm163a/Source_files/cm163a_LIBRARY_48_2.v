...
module FAU ( 
  ...
  nand2  g08(.a(new_n24_), .b(new_n23_), .O(new_n30_));
  xor2a  g09(.a(new_n30_), .b(x11), .O(new_n31_));
  inv1   g10(.a(x01), .O(new_n32_));
  aoi21  g11(.a(new_n22_), .b(new_n32_), .c(new_n27_), .O(new_n33_));
  ...
  nand3  g24(.a(new_n38_), .b(new_n24_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand4  g26(.a(new_n47_), .b(new_n35_), .c(x03), .d(x02), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x13), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n46_), .c(new_n23_), .O(new_n50_));
