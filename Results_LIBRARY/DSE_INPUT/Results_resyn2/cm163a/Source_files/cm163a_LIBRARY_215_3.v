// Benchmark "FAU" written by ABC on Mon Jul 27 20:50:01 2020
...
module FAU ( 
  ...
  nand4  g16(.a(new_n36_), .b(new_n23_), .c(x03), .d(x02), .O(new_n38_));
  inv1   g17(.a(x11), .O(new_n39_));
  nor2   g18(.a(x13), .b(new_n39_), .O(new_n40_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n39_), .c(new_n38_), .O(new_n47_));
  nand2  g26(.a(new_n38_), .b(new_n46_), .O(new_n48_));
