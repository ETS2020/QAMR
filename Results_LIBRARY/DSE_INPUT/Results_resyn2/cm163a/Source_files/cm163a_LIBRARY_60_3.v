...
module FAU ( 
  ...
  nand3  g15(.a(new_n36_), .b(new_n34_), .c(new_n31_), .O(z1));
  nand4  g16(.a(new_n29_), .b(new_n32_), .c(x03), .d(x02), .O(new_n38_));
  nor2   g17(.a(x12), .b(x11), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n30_), .c(new_n38_), .d(x12), .O(new_n40_));
  ...
  nand3  g22(.a(new_n39_), .b(new_n30_), .c(x13), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  inv1   g24(.a(x12), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(new_n29_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n33_), .c(new_n45_), .O(new_n48_));
