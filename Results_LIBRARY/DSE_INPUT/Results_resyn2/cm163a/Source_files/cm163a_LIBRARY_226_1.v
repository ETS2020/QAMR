// Benchmark "FAU" written by ABC on Mon Jul 27 20:50:05 2020
...
module FAU ( 
  ...
  oai21  g10(.a(new_n28_), .b(new_n22_), .c(new_n31_), .O(z1));
  nor2   g11(.a(new_n23_), .b(x09), .O(new_n33_));
  inv1   g12(.a(x11), .O(new_n34_));
  nand4  g13(.a(new_n34_), .b(new_n26_), .c(x03), .d(x02), .O(new_n35_));
  nor2   g14(.a(x12), .b(x11), .O(new_n36_));
  aoi22  g15(.a(new_n36_), .b(new_n33_), .c(new_n35_), .d(x12), .O(new_n37_));
  inv1   g16(.a(x06), .O(new_n38_));
  aoi21  g17(.a(new_n38_), .b(new_n22_), .c(new_n30_), .O(new_n39_));
  oai21  g18(.a(new_n37_), .b(new_n22_), .c(new_n39_), .O(z2));
  nand3  g19(.a(new_n36_), .b(new_n33_), .c(x13), .O(new_n41_));
  inv1   g20(.a(x13), .O(new_n42_));
  inv1   g21(.a(x12), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n34_), .O(new_n44_));
  oai21  g23(.a(new_n44_), .b(new_n27_), .c(new_n42_), .O(new_n45_));
