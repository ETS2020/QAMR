...
module FAU ( 
  ...
  inv1   g16(.a(new_n23_), .O(new_n38_));
  nand4  g17(.a(new_n30_), .b(new_n38_), .c(new_n37_), .d(x12), .O(new_n39_));
  ...
  nand2  g24(.a(new_n37_), .b(new_n40_), .O(new_n46_));
  nand3  g25(.a(new_n46_), .b(new_n30_), .c(new_n38_), .O(new_n47_));
  nand2  g26(.a(new_n31_), .b(new_n37_), .O(new_n48_));
