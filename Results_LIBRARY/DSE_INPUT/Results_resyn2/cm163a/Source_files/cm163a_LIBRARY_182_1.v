...
module FAU ( 
  ...
  inv1   g22(.a(new_n32_), .O(new_n44_));
  nand3  g23(.a(new_n44_), .b(new_n43_), .c(new_n42_), .O(new_n45_));
  oai21  g24(.a(new_n32_), .b(x12), .c(x13), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n45_), .c(x05), .d(x04), .O(z3));
