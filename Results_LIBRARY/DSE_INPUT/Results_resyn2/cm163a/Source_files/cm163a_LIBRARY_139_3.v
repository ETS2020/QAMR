...
module FAU ( 
  ...
  nand2  g08(.a(new_n22_), .b(x01), .O(new_n30_));
  nand3  g09(.a(new_n23_), .b(x03), .c(x02), .O(new_n31_));
  nand2  g10(.a(new_n31_), .b(x11), .O(new_n32_));
  inv1   g11(.a(x12), .O(new_n33_));
  nand2  g12(.a(new_n33_), .b(x11), .O(new_n34_));
  nand3  g13(.a(new_n34_), .b(new_n24_), .c(new_n23_), .O(new_n35_));
  ...
  nand3  g19(.a(new_n40_), .b(new_n24_), .c(new_n23_), .O(new_n41_));
  ...
  nand4  g25(.a(new_n40_), .b(new_n24_), .c(x13), .d(new_n23_), .O(new_n47_));
  inv1   g26(.a(x13), .O(new_n48_));
  nand2  g27(.a(new_n41_), .b(new_n48_), .O(new_n49_));
