// Benchmark "FAU" written by ABC on Mon Jul 27 20:48:35 2020
...
module FAU ( 
  ...
  nand2  g15(.a(new_n36_), .b(x12), .O(new_n37_));
  inv1   g16(.a(x12), .O(new_n38_));
  nand2  g17(.a(new_n30_), .b(new_n38_), .O(new_n39_));
  nand3  g18(.a(new_n39_), .b(new_n37_), .c(new_n35_), .O(new_n40_));
  nor2   g19(.a(new_n35_), .b(new_n22_), .O(new_n41_));
  oai21  g20(.a(x06), .b(x04), .c(x05), .O(new_n42_));
  aoi21  g21(.a(new_n41_), .b(x12), .c(new_n42_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n40_), .O(z2));
  inv1   g23(.a(x13), .O(new_n45_));
  nand2  g24(.a(new_n38_), .b(new_n35_), .O(new_n46_));
  oai21  g25(.a(new_n46_), .b(new_n30_), .c(new_n45_), .O(new_n47_));
  nor2   g26(.a(x12), .b(x11), .O(new_n48_));
  nand3  g27(.a(new_n48_), .b(new_n36_), .c(x13), .O(new_n49_));
