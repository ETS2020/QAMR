...
module FAU ( 
  ...
  oai21  g23(.a(x12), .b(x11), .c(x04), .O(new_n45_));
  inv1   g24(.a(x07), .O(new_n46_));
  oai21  g25(.a(new_n23_), .b(x09), .c(new_n46_), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g27(.a(new_n48_), .b(x13), .O(new_n49_));
  inv1   g28(.a(x13), .O(new_n50_));
  nor2   g29(.a(x12), .b(new_n22_), .O(new_n51_));
  nand4  g30(.a(new_n51_), .b(new_n32_), .c(new_n29_), .d(new_n50_), .O(new_n52_));
  aoi21  g31(.a(new_n46_), .b(new_n22_), .c(new_n26_), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n52_), .c(new_n49_), .O(z3));
