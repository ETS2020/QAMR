...
module FAU ( 
  ...
  nor2   g01(.a(x06), .b(x05), .O(new_n43_));
  ...
  nand2  g07(.a(x09), .b(new_n48_), .O(new_n49_));
  inv1   g08(.a(x09), .O(new_n50_));
  oai21  g09(.a(x08), .b(x07), .c(new_n50_), .O(new_n51_));
  nand3  g10(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(new_n52_));
  aoi21  g11(.a(new_n52_), .b(x00), .c(new_n42_), .O(z01));
  nand2  g12(.a(new_n50_), .b(x08), .O(new_n54_));
  nor3   g13(.a(x07), .b(x06), .c(x05), .O(new_n55_));
  nand4  g14(.a(new_n55_), .b(new_n54_), .c(new_n45_), .d(new_n44_), .O(new_n56_));
  inv1   g15(.a(x00), .O(new_n57_));
  inv1   g16(.a(x07), .O(new_n58_));
  nand4  g17(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(new_n58_), .O(new_n59_));
  ...
  nand2  g23(.a(new_n50_), .b(x07), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x19), .c(new_n48_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n46_), .c(new_n64_), .O(z05));
