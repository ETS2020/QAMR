...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n58_, new_n59_, new_n62_, new_n67_, new_n68_, new_n70_,
  ...
  oai21  g09(.a(new_n50_), .b(new_n49_), .c(x09), .O(new_n51_));
  ...
  nand2  g14(.a(new_n48_), .b(x00), .O(new_n56_));
  nor3   g15(.a(x07), .b(x06), .c(x05), .O(new_n57_));
  nor2   g16(.a(x09), .b(new_n49_), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n47_), .c(new_n46_), .d(new_n57_), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(new_n56_), .c(new_n50_), .O(z02));
  or2    g19(.a(x21), .b(x20), .O(z04));
  inv1   g20(.a(x10), .O(new_n62_));
  oai21  g21(.a(new_n48_), .b(x08), .c(new_n62_), .O(z05));
  oai21  g22(.a(new_n48_), .b(x08), .c(new_n50_), .O(z06));
