...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    new_n50_, new_n51_, new_n52_, new_n55_, new_n56_, new_n60_, new_n61_,
  ...
  nand4  g09(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(new_n50_), .O(new_n51_));
  and2   g10(.a(x19), .b(x00), .O(new_n52_));
  and2   g11(.a(new_n52_), .b(new_n51_), .O(z02));
  or2    g12(.a(x21), .b(x20), .O(z04));
  inv1   g13(.a(x10), .O(new_n55_));
  nand2  g14(.a(x19), .b(new_n46_), .O(new_n56_));
  oai21  g15(.a(new_n56_), .b(new_n51_), .c(new_n55_), .O(z05));
