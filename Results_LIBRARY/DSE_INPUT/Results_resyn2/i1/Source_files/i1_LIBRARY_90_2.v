...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n57_, new_n59_, new_n60_, new_n61_, new_n65_, new_n66_, new_n68_,
    new_n70_, new_n73_, new_n75_, new_n76_;
  ...
  nand2  g19(.a(x19), .b(new_n60_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n55_), .c(new_n59_), .O(z05));
