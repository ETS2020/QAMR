...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    new_n49_, new_n50_, new_n52_, new_n53_, new_n54_, new_n55_, new_n58_,
  ...
  nand3  g08(.a(new_n49_), .b(new_n48_), .c(new_n43_), .O(new_n50_));
  aoi21  g09(.a(new_n50_), .b(x00), .c(new_n42_), .O(z01));
  nand2  g10(.a(new_n47_), .b(x00), .O(new_n52_));
  inv1   g11(.a(x08), .O(new_n53_));
  nor2   g12(.a(x09), .b(new_n53_), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x07), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n52_), .c(new_n42_), .O(z02));
  or2    g15(.a(x21), .b(x20), .O(z04));
  inv1   g16(.a(x10), .O(new_n58_));
  nand2  g17(.a(new_n48_), .b(new_n43_), .O(new_n59_));
  nand2  g18(.a(x19), .b(new_n53_), .O(new_n60_));
