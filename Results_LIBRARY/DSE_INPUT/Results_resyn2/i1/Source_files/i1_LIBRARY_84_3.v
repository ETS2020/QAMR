// Benchmark "FAU" written by ABC on Mon Jul 27 18:17:28 2020
...
module FAU ( 
  ...
  nand2  g13(.a(new_n50_), .b(x08), .O(new_n55_));
  ...
  nand3  g23(.a(x19), .b(new_n48_), .c(new_n58_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n46_), .c(new_n64_), .O(z05));
