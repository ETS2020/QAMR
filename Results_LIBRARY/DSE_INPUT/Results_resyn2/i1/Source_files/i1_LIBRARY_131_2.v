...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n57_, new_n58_, new_n59_, new_n60_, new_n63_, new_n64_, new_n66_,
  ...
  nor2   g09(.a(new_n49_), .b(new_n50_), .O(new_n51_));
  inv1   g10(.a(x19), .O(new_n52_));
  nor2   g11(.a(new_n52_), .b(x08), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n49_), .c(new_n51_), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n48_), .c(new_n43_), .O(z01));
  nor3   g14(.a(x07), .b(x06), .c(x05), .O(new_n56_));
  nand2  g15(.a(new_n49_), .b(x08), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n47_), .c(new_n46_), .d(new_n56_), .O(new_n58_));
  nand2  g17(.a(new_n48_), .b(new_n42_), .O(new_n59_));
  ...
  inv1   g22(.a(new_n53_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n48_), .c(new_n63_), .O(z05));
  inv1   g24(.a(new_n51_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n48_), .c(new_n52_), .O(z06));
