...
module FAU ( 
  ...
  nand2  g18(.a(new_n26_), .b(new_n23_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n19_), .c(x1), .O(new_n36_));
  ...
  oai21  g25(.a(new_n40_), .b(new_n36_), .c(new_n30_), .O(z2));
  nand2  g26(.a(new_n29_), .b(x2), .O(new_n42_));
  nor2   g27(.a(x4), .b(x2), .O(new_n43_));
  aoi21  g28(.a(new_n33_), .b(new_n16_), .c(x0), .O(new_n44_));
  oai21  g29(.a(new_n43_), .b(new_n16_), .c(new_n44_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n42_), .c(x3), .O(z3));
  nand3  g31(.a(new_n35_), .b(new_n19_), .c(new_n18_), .O(new_n47_));
  nand2  g32(.a(x3), .b(new_n23_), .O(new_n48_));
  nand2  g33(.a(new_n19_), .b(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x0), .O(new_n51_));
  nand2  g36(.a(new_n25_), .b(new_n18_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n51_), .c(new_n47_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n16_), .O(new_n54_));
  nand3  g39(.a(new_n49_), .b(new_n27_), .c(new_n18_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(z4));
  aoi21  g41(.a(new_n49_), .b(new_n48_), .c(new_n18_), .O(new_n57_));
  aoi21  g42(.a(new_n25_), .b(new_n18_), .c(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x1), .c(new_n55_), .O(z5));
  aoi21  g44(.a(new_n24_), .b(x2), .c(new_n57_), .O(new_n60_));
  nor2   g45(.a(new_n16_), .b(x0), .O(new_n61_));
  oai21  g46(.a(new_n43_), .b(x3), .c(new_n61_), .O(new_n62_));
