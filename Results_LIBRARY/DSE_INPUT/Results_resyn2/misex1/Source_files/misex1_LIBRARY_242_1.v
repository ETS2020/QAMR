// Benchmark "FAU" written by ABC on Mon Jul 27 18:27:52 2020
...
module FAU ( 
  ...
  nor2   g24(.a(x7), .b(x2), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nor2   g26(.a(new_n26_), .b(x0), .O(new_n42_));
  nand3  g27(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(z3));
  nand2  g29(.a(x6), .b(new_n23_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n19_), .c(new_n18_), .O(new_n46_));
  xor2a  g31(.a(x3), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x0), .O(new_n48_));
  nand2  g33(.a(new_n26_), .b(new_n19_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(x2), .c(new_n18_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(new_n46_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n19_), .b(x2), .c(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n25_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(z4));
  nand2  g40(.a(new_n50_), .b(new_n48_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n16_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z5));
  nor2   g43(.a(x5), .b(x3), .O(new_n59_));
  aoi22  g44(.a(new_n47_), .b(x0), .c(new_n59_), .d(x2), .O(new_n60_));
  oai21  g45(.a(x4), .b(x2), .c(new_n19_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n39_), .O(new_n62_));
