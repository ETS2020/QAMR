// Benchmark "FAU" written by ABC on Mon Jul 27 18:27:41 2020
...
module FAU ( 
  ...
  oai21  g11(.a(new_n26_), .b(new_n24_), .c(new_n18_), .O(new_n27_));
  inv1   g12(.a(x2), .O(new_n28_));
  nor2   g13(.a(x1), .b(new_n18_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(x3), .c(new_n28_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n27_), .O(z1));
  nand2  g16(.a(x5), .b(x2), .O(new_n32_));
  nand2  g17(.a(x6), .b(new_n28_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(new_n32_), .c(new_n19_), .d(new_n16_), .O(new_n34_));
  nor2   g19(.a(new_n19_), .b(new_n16_), .O(new_n35_));
  inv1   g20(.a(new_n35_), .O(new_n36_));
  nand3  g21(.a(x4), .b(new_n28_), .c(x1), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n36_), .c(new_n34_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n18_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n30_), .O(z2));
  nand3  g25(.a(new_n29_), .b(new_n19_), .c(x2), .O(new_n41_));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n28_), .c(new_n16_), .O(new_n43_));
  inv1   g28(.a(x5), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n19_), .c(x2), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n18_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n43_), .c(new_n41_), .O(z3));
  oai21  g33(.a(new_n35_), .b(new_n26_), .c(new_n18_), .O(new_n49_));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x0), .O(new_n51_));
  nand2  g36(.a(new_n44_), .b(new_n19_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x2), .c(new_n18_), .O(new_n53_));
  nand4  g38(.a(new_n33_), .b(new_n32_), .c(new_n19_), .d(new_n18_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n49_), .O(z4));
  nand2  g42(.a(new_n53_), .b(new_n51_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n49_), .O(z5));
  and2   g45(.a(new_n51_), .b(new_n45_), .O(new_n61_));
