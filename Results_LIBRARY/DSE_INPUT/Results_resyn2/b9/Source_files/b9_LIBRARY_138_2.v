...
module FAU ( 
  ...
  nand3  g006(.a(new_n68_), .b(new_n66_), .c(x39), .O(new_n69_));
  nand3  g007(.a(new_n69_), .b(new_n64_), .c(new_n63_), .O(new_n70_));
  nand3  g008(.a(new_n68_), .b(x39), .c(x10), .O(new_n71_));
  inv1   g009(.a(new_n71_), .O(new_n72_));
  aoi21  g010(.a(new_n70_), .b(x27), .c(new_n72_), .O(new_n73_));
  ...
  oai21  g021(.a(new_n83_), .b(new_n78_), .c(x04), .O(new_n84_));
  ...
  nand2  g026(.a(new_n64_), .b(x27), .O(new_n89_));
  nand2  g027(.a(new_n63_), .b(new_n75_), .O(new_n90_));
  ...
  inv1   g044(.a(new_n86_), .O(z08));
  nand4  g045(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  inv1   g046(.a(new_n108_), .O(z09));
  inv1   g047(.a(x04), .O(new_n110_));
  inv1   g048(.a(x35), .O(new_n111_));
  oai21  g049(.a(new_n111_), .b(x28), .c(new_n76_), .O(new_n112_));
  inv1   g050(.a(x07), .O(new_n113_));
  nand3  g051(.a(x40), .b(x39), .c(x05), .O(new_n114_));
  oai21  g052(.a(x40), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  inv1   g054(.a(x39), .O(new_n117_));
  nand3  g055(.a(new_n66_), .b(new_n117_), .c(x07), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n116_), .c(new_n75_), .O(new_n119_));
  nor2   g057(.a(new_n114_), .b(new_n80_), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n119_), .c(new_n110_), .O(new_n121_));
  ...
  nand2  g063(.a(x35), .b(x27), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x29), .O(new_n127_));
  oai21  g065(.a(new_n111_), .b(x27), .c(new_n127_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x08), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(x04), .c(new_n129_), .O(new_n130_));
  and2   g068(.a(x40), .b(x29), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x08), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x28), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n130_), .c(new_n125_), .O(z11));
  inv1   g072(.a(new_n68_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n64_), .c(new_n117_), .O(new_n136_));
  nor2   g074(.a(x37), .b(x10), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n65_), .c(new_n75_), .O(new_n138_));
  oai22  g076(.a(new_n138_), .b(new_n72_), .c(new_n136_), .d(x37), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  nand3  g078(.a(new_n68_), .b(x39), .c(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n80_), .c(new_n75_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x28), .O(new_n145_));
  nand2  g083(.a(new_n68_), .b(new_n140_), .O(new_n146_));
  aoi21  g084(.a(new_n117_), .b(new_n77_), .c(new_n146_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  inv1   g086(.a(new_n141_), .O(new_n149_));
  nor2   g087(.a(x19), .b(x18), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x20), .O(new_n151_));
  aoi21  g089(.a(new_n64_), .b(new_n63_), .c(new_n151_), .O(new_n152_));
  aoi21  g090(.a(new_n149_), .b(new_n81_), .c(new_n152_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n148_), .c(new_n143_), .O(z13));
  nand3  g092(.a(new_n144_), .b(new_n80_), .c(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n141_), .c(new_n151_), .O(new_n157_));
  nand2  g095(.a(new_n146_), .b(new_n64_), .O(new_n158_));
  nand3  g096(.a(new_n80_), .b(new_n111_), .c(x28), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n158_), .c(x39), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n63_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n157_), .c(new_n142_), .O(z14));
  ...
  nand3  g107(.a(x35), .b(new_n77_), .c(new_n75_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n127_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nor2   g110(.a(new_n126_), .b(x04), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n77_), .c(new_n125_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n172_), .O(z18));
  oai21  g113(.a(new_n131_), .b(new_n77_), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n127_), .O(new_n177_));
  nand2  g115(.a(new_n126_), .b(new_n124_), .O(new_n178_));
  aoi21  g116(.a(new_n177_), .b(x08), .c(new_n178_), .O(z20));
  aoi21  g117(.a(new_n133_), .b(new_n130_), .c(new_n125_), .O(z19));
endmodule
