// Benchmark "FAU" written by ABC on Mon Jul 27 22:59:45 2020
...
module FAU ( 
  ...
  aoi21  g66(.a(x36), .b(x35), .c(new_n73_), .O(new_n129_));
  nor2   g67(.a(x13), .b(x04), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(z08), .O(new_n131_));
  nor2   g69(.a(x19), .b(x18), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n125_), .c(x20), .O(new_n133_));
  oai21  g71(.a(new_n131_), .b(new_n129_), .c(new_n133_), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(x27), .O(new_n135_));
  or2    g73(.a(new_n131_), .b(new_n75_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(new_n135_), .O(z13));
  nand2  g75(.a(new_n132_), .b(x20), .O(new_n138_));
  nand2  g76(.a(new_n129_), .b(new_n75_), .O(new_n139_));
  nand3  g77(.a(new_n139_), .b(new_n130_), .c(x39), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nor2   g79(.a(new_n132_), .b(x40), .O(new_n142_));
  oai21  g80(.a(new_n142_), .b(new_n126_), .c(new_n131_), .O(new_n143_));
  inv1   g81(.a(x35), .O(new_n144_));
  nand3  g82(.a(new_n87_), .b(new_n144_), .c(x28), .O(new_n145_));
  nand2  g83(.a(new_n145_), .b(x27), .O(new_n146_));
  nand2  g84(.a(new_n146_), .b(new_n75_), .O(new_n147_));
  nand3  g85(.a(new_n147_), .b(new_n143_), .c(new_n141_), .O(z14));
  ...
  oai21  g95(.a(new_n144_), .b(new_n72_), .c(new_n121_), .O(new_n158_));
