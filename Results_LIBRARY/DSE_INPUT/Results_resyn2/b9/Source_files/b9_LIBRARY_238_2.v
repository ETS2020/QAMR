...
module FAU ( 
  ...
  nand3  g048(.a(x40), .b(x35), .c(new_n75_), .O(new_n111_));
  nand2  g049(.a(x39), .b(x05), .O(new_n112_));
  aoi21  g050(.a(new_n111_), .b(new_n74_), .c(new_n112_), .O(new_n113_));
  nand2  g051(.a(new_n70_), .b(x36), .O(new_n114_));
  nand2  g052(.a(new_n83_), .b(x07), .O(new_n115_));
  aoi21  g053(.a(new_n114_), .b(new_n76_), .c(new_n115_), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(new_n113_), .c(x27), .O(new_n117_));
  nand3  g055(.a(z08), .b(new_n79_), .c(x05), .O(new_n118_));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n76_), .c(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n124_), .b(x27), .O(new_n126_));
  nand4  g064(.a(x35), .b(new_n75_), .c(x27), .d(new_n110_), .O(new_n127_));
  nor2   g065(.a(x30), .b(x09), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  aoi21  g067(.a(new_n126_), .b(new_n125_), .c(new_n129_), .O(z11));
  nor2   g068(.a(new_n67_), .b(x27), .O(new_n131_));
  nor3   g069(.a(x37), .b(x36), .c(x35), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n131_), .c(new_n66_), .O(new_n133_));
  nor2   g071(.a(new_n83_), .b(x04), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n65_), .c(new_n133_), .O(z12));
  nor2   g073(.a(x19), .b(x18), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x20), .O(new_n137_));
  nor2   g075(.a(new_n137_), .b(new_n64_), .O(new_n138_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(x27), .O(new_n144_));
  nand2  g082(.a(new_n141_), .b(z08), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n78_), .c(new_n144_), .O(z13));
  nand3  g084(.a(new_n140_), .b(new_n78_), .c(x28), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n145_), .c(new_n137_), .O(new_n149_));
  aoi21  g087(.a(new_n75_), .b(x27), .c(new_n79_), .O(new_n150_));
  nor2   g088(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n65_), .c(new_n149_), .O(z14));
  ...
  oai21  g098(.a(new_n87_), .b(new_n63_), .c(new_n128_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(new_n125_), .O(z20));
  aoi21  g100(.a(new_n126_), .b(new_n125_), .c(new_n129_), .O(z19));
endmodule
