...
module FAU ( 
  ...
  aoi21  g45(.a(new_n78_), .b(new_n107_), .c(new_n72_), .O(new_n108_));
  ...
  inv1   g53(.a(x30), .O(new_n116_));
  inv1   g54(.a(x08), .O(new_n117_));
  nand2  g55(.a(new_n72_), .b(new_n117_), .O(new_n118_));
  nand3  g56(.a(new_n118_), .b(z08), .c(x29), .O(new_n119_));
  nand3  g57(.a(new_n119_), .b(new_n116_), .c(new_n115_), .O(new_n120_));
  nand2  g58(.a(x27), .b(x04), .O(new_n121_));
  nand3  g59(.a(new_n121_), .b(new_n118_), .c(new_n79_), .O(new_n122_));
  inv1   g60(.a(new_n122_), .O(new_n123_));
  nor2   g61(.a(new_n123_), .b(new_n120_), .O(z11));
  aoi22  g62(.a(new_n64_), .b(new_n86_), .c(x40), .d(new_n72_), .O(new_n125_));
  oai21  g63(.a(new_n63_), .b(new_n72_), .c(new_n66_), .O(new_n126_));
  oai21  g64(.a(new_n125_), .b(x10), .c(new_n126_), .O(z12));
  inv1   g65(.a(x13), .O(new_n128_));
  nor2   g66(.a(new_n80_), .b(x04), .O(new_n129_));
  oai21  g67(.a(new_n107_), .b(new_n84_), .c(x28), .O(new_n130_));
  nand3  g68(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  inv1   g69(.a(new_n63_), .O(new_n132_));
  nor2   g70(.a(x19), .b(x18), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(new_n132_), .c(x20), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(x27), .O(new_n136_));
  inv1   g74(.a(new_n75_), .O(new_n137_));
  nand2  g75(.a(new_n129_), .b(new_n128_), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(new_n136_), .O(z13));
  aoi22  g79(.a(new_n135_), .b(x27), .c(new_n139_), .d(new_n137_), .O(z14));
  ...
  nand2  g87(.a(z08), .b(x29), .O(new_n150_));
  nand4  g88(.a(new_n122_), .b(new_n150_), .c(new_n116_), .d(new_n115_), .O(z18));
  oai21  g89(.a(x28), .b(new_n117_), .c(new_n72_), .O(new_n152_));
  aoi21  g90(.a(new_n152_), .b(x35), .c(new_n120_), .O(z20));
  nor2   g91(.a(new_n123_), .b(new_n120_), .O(z19));
endmodule
