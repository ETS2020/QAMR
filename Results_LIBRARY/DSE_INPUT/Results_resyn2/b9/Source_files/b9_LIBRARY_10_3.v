// Benchmark "FAU" written by ABC on Mon Jul 27 22:59:40 2020
...
module FAU ( 
  ...
  aoi22  g06(.a(new_n68_), .b(new_n66_), .c(x37), .d(x27), .O(new_n69_));
  ...
  oai21  g17(.a(new_n79_), .b(new_n73_), .c(x04), .O(new_n80_));
  ...
  nand2  g24(.a(new_n86_), .b(new_n64_), .O(new_n87_));
  ...
  nand2  g45(.a(new_n67_), .b(x07), .O(new_n108_));
  nand2  g46(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nor2   g47(.a(x32), .b(x30), .O(new_n110_));
  nor2   g48(.a(new_n107_), .b(new_n110_), .O(new_n111_));
  aoi21  g49(.a(new_n109_), .b(new_n74_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g54(.a(new_n116_), .b(new_n73_), .c(new_n115_), .O(new_n117_));
  nand2  g55(.a(new_n116_), .b(x27), .O(new_n118_));
  inv1   g56(.a(x04), .O(new_n119_));
  nand4  g57(.a(x35), .b(new_n72_), .c(x27), .d(new_n119_), .O(new_n120_));
  nor2   g58(.a(x30), .b(x09), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  aoi21  g60(.a(new_n118_), .b(new_n117_), .c(new_n122_), .O(z11));
  aoi21  g61(.a(new_n65_), .b(new_n86_), .c(new_n64_), .O(new_n124_));
  nand2  g62(.a(new_n84_), .b(new_n86_), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(x27), .O(new_n126_));
  oai21  g64(.a(new_n67_), .b(x04), .c(new_n126_), .O(new_n127_));
  oai21  g65(.a(new_n124_), .b(x10), .c(new_n127_), .O(z12));
  inv1   g66(.a(x35), .O(new_n129_));
  oai21  g67(.a(new_n71_), .b(new_n129_), .c(x28), .O(new_n130_));
  ...
  nand4  g72(.a(new_n125_), .b(x20), .c(new_n134_), .d(new_n133_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  nand3  g75(.a(new_n131_), .b(new_n77_), .c(z08), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(new_n137_), .O(z13));
  nand3  g77(.a(x20), .b(new_n134_), .c(new_n133_), .O(new_n140_));
  inv1   g78(.a(new_n140_), .O(new_n141_));
  inv1   g79(.a(new_n130_), .O(new_n142_));
  nand2  g80(.a(new_n131_), .b(z08), .O(new_n143_));
  aoi21  g81(.a(new_n142_), .b(new_n110_), .c(new_n143_), .O(new_n144_));
  aoi21  g82(.a(new_n72_), .b(x27), .c(new_n77_), .O(new_n145_));
  oai21  g83(.a(new_n145_), .b(new_n143_), .c(new_n126_), .O(new_n146_));
  oai21  g84(.a(new_n144_), .b(new_n141_), .c(new_n146_), .O(z14));
  ...
  nand2  g92(.a(new_n118_), .b(new_n117_), .O(new_n155_));
  nand3  g93(.a(new_n121_), .b(new_n120_), .c(new_n155_), .O(z18));
  oai21  g94(.a(new_n129_), .b(new_n64_), .c(new_n121_), .O(new_n157_));
  nor2   g95(.a(new_n157_), .b(new_n117_), .O(z20));
  aoi21  g96(.a(new_n118_), .b(new_n117_), .c(new_n122_), .O(z19));
endmodule
