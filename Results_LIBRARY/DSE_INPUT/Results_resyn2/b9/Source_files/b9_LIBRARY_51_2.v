...
module FAU ( 
  ...
  inv1   g53(.a(new_n79_), .O(new_n116_));
  nand2  g54(.a(x39), .b(x29), .O(new_n117_));
  oai21  g55(.a(new_n117_), .b(x40), .c(x04), .O(new_n118_));
  nand3  g56(.a(new_n118_), .b(new_n116_), .c(x27), .O(new_n119_));
  nor2   g57(.a(x30), .b(x09), .O(new_n120_));
  aoi21  g58(.a(new_n117_), .b(new_n79_), .c(new_n78_), .O(new_n121_));
  nand2  g59(.a(new_n117_), .b(x27), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand3  g61(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  inv1   g62(.a(new_n124_), .O(z11));
  aoi22  g63(.a(new_n64_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n126_));
  oai21  g64(.a(new_n63_), .b(new_n72_), .c(new_n66_), .O(new_n127_));
  ...
  nand3  g88(.a(new_n116_), .b(x27), .c(new_n65_), .O(new_n151_));
  nand3  g89(.a(new_n151_), .b(new_n123_), .c(new_n120_), .O(z18));
  oai21  g90(.a(new_n85_), .b(new_n72_), .c(new_n120_), .O(new_n153_));
  nor2   g91(.a(new_n153_), .b(new_n121_), .O(z20));
  inv1   g92(.a(new_n124_), .O(z19));
endmodule
