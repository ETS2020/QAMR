// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:20 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n143_, new_n145_, new_n146_, new_n149_, new_n150_;
  ...
  or2    g58(.a(new_n66_), .b(new_n71_), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(new_n64_), .O(new_n122_));
  oai21  g60(.a(new_n120_), .b(x10), .c(new_n122_), .O(z12));
  nor2   g61(.a(x19), .b(x18), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(x20), .O(new_n125_));
  inv1   g63(.a(x40), .O(new_n126_));
  nand2  g64(.a(x36), .b(x35), .O(new_n127_));
  oai22  g65(.a(new_n127_), .b(x30), .c(new_n126_), .d(x28), .O(new_n128_));
  nor2   g66(.a(new_n74_), .b(new_n126_), .O(new_n129_));
  aoi21  g67(.a(new_n128_), .b(x27), .c(new_n129_), .O(new_n130_));
  nor2   g68(.a(x13), .b(x04), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(x39), .O(new_n132_));
  oai22  g70(.a(new_n132_), .b(new_n130_), .c(new_n125_), .d(new_n121_), .O(z13));
  nand3  g71(.a(new_n127_), .b(new_n74_), .c(x28), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n131_), .c(z08), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n125_), .O(new_n136_));
  oai21  g74(.a(x28), .b(new_n71_), .c(new_n74_), .O(new_n137_));
  nand3  g75(.a(new_n137_), .b(new_n131_), .c(z08), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(new_n121_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n136_), .O(z14));
  ...
  nand2  g86(.a(x35), .b(x27), .O(new_n149_));
  nand2  g87(.a(new_n149_), .b(new_n117_), .O(new_n150_));
  nor2   g88(.a(new_n150_), .b(new_n114_), .O(z20));
  aoi21  g89(.a(new_n115_), .b(new_n114_), .c(new_n118_), .O(z19));
endmodule
