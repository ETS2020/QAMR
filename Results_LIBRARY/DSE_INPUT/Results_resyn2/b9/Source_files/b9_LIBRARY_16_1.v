...
module FAU ( 
  ...
  nor2   g20(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  ...
  inv1   g42(.a(new_n63_), .O(z08));
  nand4  g43(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n106_));
  inv1   g44(.a(new_n106_), .O(z09));
  inv1   g45(.a(x05), .O(new_n108_));
  oai21  g46(.a(new_n85_), .b(x28), .c(new_n73_), .O(new_n109_));
  nand3  g47(.a(new_n109_), .b(x27), .c(x07), .O(new_n110_));
  nand2  g48(.a(new_n78_), .b(z08), .O(new_n111_));
  aoi21  g49(.a(new_n111_), .b(new_n110_), .c(new_n108_), .O(new_n112_));
  or2    g50(.a(x40), .b(x07), .O(new_n113_));
  nand4  g51(.a(new_n113_), .b(new_n109_), .c(new_n63_), .d(x27), .O(new_n114_));
  inv1   g52(.a(new_n114_), .O(new_n115_));
  oai21  g53(.a(new_n115_), .b(new_n112_), .c(new_n67_), .O(new_n116_));
  ...
  aoi21  g58(.a(new_n120_), .b(new_n75_), .c(new_n119_), .O(new_n121_));
  nand2  g59(.a(new_n120_), .b(x27), .O(new_n122_));
  nand4  g60(.a(x35), .b(new_n74_), .c(x27), .d(new_n67_), .O(new_n123_));
  nor2   g61(.a(x30), .b(x09), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  aoi21  g63(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(z11));
  aoi22  g64(.a(new_n66_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n127_));
  or2    g65(.a(new_n65_), .b(new_n72_), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n68_), .O(new_n129_));
  oai21  g67(.a(new_n127_), .b(x10), .c(new_n129_), .O(z12));
  aoi21  g68(.a(x36), .b(x35), .c(new_n74_), .O(new_n131_));
  inv1   g69(.a(x13), .O(new_n132_));
  nand2  g70(.a(new_n64_), .b(new_n132_), .O(new_n133_));
  nor2   g71(.a(x19), .b(x18), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(x20), .O(new_n135_));
  oai22  g73(.a(new_n135_), .b(new_n65_), .c(new_n133_), .d(new_n131_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  nand3  g75(.a(new_n78_), .b(new_n64_), .c(new_n132_), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(new_n137_), .O(z13));
  nand2  g77(.a(new_n131_), .b(new_n77_), .O(new_n140_));
  inv1   g78(.a(new_n140_), .O(new_n141_));
  oai21  g79(.a(new_n141_), .b(new_n133_), .c(new_n135_), .O(new_n142_));
  aoi21  g80(.a(new_n74_), .b(x27), .c(new_n78_), .O(new_n143_));
  oai21  g81(.a(new_n143_), .b(new_n133_), .c(new_n128_), .O(new_n144_));
  nand2  g82(.a(new_n144_), .b(new_n142_), .O(z14));
  ...
  oai21  g91(.a(new_n85_), .b(new_n72_), .c(new_n124_), .O(new_n154_));
  nor2   g92(.a(new_n154_), .b(new_n121_), .O(z20));
  aoi21  g93(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(z19));
endmodule
