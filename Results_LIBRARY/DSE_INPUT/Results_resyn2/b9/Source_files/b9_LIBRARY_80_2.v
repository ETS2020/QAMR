...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n155_, new_n157_, new_n158_, new_n160_, new_n162_;
  ...
  nand2  g048(.a(x40), .b(x30), .O(new_n111_));
  aoi21  g049(.a(new_n111_), .b(new_n78_), .c(new_n110_), .O(new_n112_));
  ...
  aoi21  g063(.a(new_n125_), .b(new_n75_), .c(new_n124_), .O(new_n126_));
  nand2  g064(.a(new_n125_), .b(x27), .O(new_n127_));
  nand4  g065(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n128_));
  nor2   g066(.a(x30), .b(x09), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g068(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z11));
  aoi22  g069(.a(new_n64_), .b(new_n89_), .c(x40), .d(new_n72_), .O(new_n132_));
  inv1   g070(.a(new_n63_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x27), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n66_), .O(new_n135_));
  oai21  g073(.a(new_n132_), .b(x10), .c(new_n135_), .O(z12));
  aoi21  g074(.a(x36), .b(x35), .c(new_n74_), .O(new_n137_));
  nor2   g075(.a(x13), .b(x04), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(z08), .O(new_n139_));
  inv1   g077(.a(x18), .O(new_n140_));
  inv1   g078(.a(x19), .O(new_n141_));
  nand3  g079(.a(x20), .b(new_n141_), .c(new_n140_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n63_), .c(new_n139_), .d(new_n137_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nand2  g082(.a(new_n138_), .b(new_n112_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  inv1   g084(.a(new_n142_), .O(new_n147_));
  inv1   g085(.a(new_n79_), .O(new_n148_));
  aoi21  g086(.a(new_n137_), .b(new_n148_), .c(new_n139_), .O(new_n149_));
  aoi21  g087(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n139_), .c(new_n134_), .O(new_n151_));
  oai21  g089(.a(new_n149_), .b(new_n147_), .c(new_n151_), .O(z14));
  ...
  nand2  g097(.a(new_n127_), .b(new_n126_), .O(new_n160_));
  nand3  g098(.a(new_n129_), .b(new_n128_), .c(new_n160_), .O(z18));
  oai21  g099(.a(new_n87_), .b(new_n72_), .c(new_n129_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n126_), .O(z20));
  aoi21  g101(.a(new_n127_), .b(new_n126_), .c(new_n130_), .O(z19));
endmodule
