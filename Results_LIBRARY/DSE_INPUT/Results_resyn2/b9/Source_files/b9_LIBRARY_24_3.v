...
module FAU ( 
  ...
  aoi21  g007(.a(new_n67_), .b(x27), .c(new_n69_), .O(z12));
  oai21  g008(.a(z12), .b(x15), .c(x16), .O(z00));
  ...
  nand2  g017(.a(x27), .b(x20), .O(new_n80_));
  inv1   g018(.a(x18), .O(new_n81_));
  inv1   g019(.a(x19), .O(new_n82_));
  inv1   g020(.a(x37), .O(new_n83_));
  nand2  g021(.a(x35), .b(x28), .O(new_n84_));
  nand2  g022(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand3  g023(.a(new_n85_), .b(new_n82_), .c(new_n81_), .O(new_n86_));
  or2    g024(.a(new_n86_), .b(new_n80_), .O(new_n87_));
  nor2   g025(.a(x27), .b(x08), .O(new_n88_));
  oai21  g026(.a(new_n88_), .b(new_n75_), .c(x04), .O(new_n89_));
  aoi21  g027(.a(x29), .b(x08), .c(x02), .O(new_n90_));
  inv1   g028(.a(x20), .O(new_n91_));
  inv1   g029(.a(x39), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x40), .O(new_n94_));
  nor2   g032(.a(new_n94_), .b(new_n90_), .O(new_n95_));
  nand3  g033(.a(new_n95_), .b(new_n89_), .c(new_n87_), .O(z02));
  nand2  g034(.a(new_n84_), .b(x27), .O(new_n97_));
  nand2  g035(.a(new_n83_), .b(new_n72_), .O(new_n98_));
  ...
  nor2   g056(.a(new_n77_), .b(new_n115_), .O(new_n119_));
  ...
  oai21  g062(.a(new_n123_), .b(new_n122_), .c(new_n124_), .O(z10));
  inv1   g063(.a(x08), .O(new_n126_));
  nand2  g064(.a(z08), .b(x29), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n75_), .c(new_n126_), .O(new_n128_));
  nand2  g066(.a(new_n127_), .b(x27), .O(new_n129_));
  nand4  g067(.a(x35), .b(new_n74_), .c(x27), .d(new_n65_), .O(new_n130_));
  ...
  nand4  g071(.a(new_n85_), .b(x20), .c(new_n82_), .d(new_n81_), .O(new_n134_));
  inv1   g072(.a(x35), .O(new_n135_));
  oai21  g073(.a(new_n73_), .b(new_n135_), .c(x28), .O(new_n136_));
  nor2   g074(.a(x13), .b(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(z08), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  nand2  g078(.a(new_n137_), .b(new_n119_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(z13));
  nand2  g080(.a(new_n73_), .b(new_n91_), .O(new_n143_));
  nand2  g081(.a(x40), .b(new_n135_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n143_), .c(new_n74_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n72_), .c(new_n77_), .O(new_n146_));
  inv1   g084(.a(x40), .O(new_n147_));
  nand2  g085(.a(new_n80_), .b(new_n147_), .O(new_n148_));
  oai21  g086(.a(x13), .b(x04), .c(x40), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n93_), .O(new_n150_));
  aoi21  g088(.a(new_n86_), .b(new_n147_), .c(new_n150_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n146_), .O(z14));
  ...
  nand2  g097(.a(new_n129_), .b(new_n128_), .O(new_n160_));
  nand3  g098(.a(new_n131_), .b(new_n130_), .c(new_n160_), .O(z18));
  oai21  g099(.a(new_n135_), .b(new_n72_), .c(new_n131_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(new_n128_), .O(z20));
