...
module FAU ( 
  ...
  nand2  g95(.a(new_n118_), .b(new_n117_), .O(new_n158_));
  nand3  g96(.a(new_n120_), .b(new_n119_), .c(new_n158_), .O(z18));
  oai21  g97(.a(new_n130_), .b(new_n72_), .c(new_n120_), .O(new_n160_));
  nor2   g98(.a(new_n160_), .b(new_n117_), .O(z20));
  aoi21  g99(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
