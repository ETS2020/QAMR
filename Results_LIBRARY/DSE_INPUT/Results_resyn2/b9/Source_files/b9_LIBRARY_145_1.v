// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:37 2020
...
module FAU ( 
  ...
  oai21  g20(.a(new_n79_), .b(new_n63_), .c(new_n82_), .O(z02));
  ...
  aoi21  g53(.a(new_n115_), .b(new_n79_), .c(new_n114_), .O(z11));
  aoi21  g54(.a(x36), .b(x35), .c(new_n72_), .O(new_n117_));
  nor2   g55(.a(x13), .b(x04), .O(new_n118_));
  nand2  g56(.a(new_n118_), .b(z08), .O(new_n119_));
  nor2   g57(.a(x19), .b(x18), .O(new_n120_));
  nand2  g58(.a(new_n120_), .b(x20), .O(new_n121_));
  oai22  g59(.a(new_n121_), .b(new_n66_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nor2   g60(.a(new_n119_), .b(new_n74_), .O(new_n123_));
  aoi21  g61(.a(new_n122_), .b(x27), .c(new_n123_), .O(z14));
  inv1   g62(.a(z14), .O(z13));
  nand4  g63(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n126_));
  inv1   g64(.a(new_n126_), .O(z15));
  nand2  g65(.a(x22), .b(x01), .O(new_n128_));
  nor2   g66(.a(new_n128_), .b(x23), .O(z16));
  inv1   g67(.a(x24), .O(new_n130_));
  nand4  g68(.a(new_n130_), .b(x23), .c(x22), .d(x01), .O(new_n131_));
  inv1   g69(.a(new_n131_), .O(z17));
  inv1   g70(.a(z11), .O(z18));
  oai21  g71(.a(x28), .b(new_n77_), .c(new_n71_), .O(new_n134_));
  aoi21  g72(.a(new_n134_), .b(x35), .c(new_n114_), .O(z20));
  aoi21  g73(.a(new_n115_), .b(new_n79_), .c(new_n114_), .O(z19));
endmodule
