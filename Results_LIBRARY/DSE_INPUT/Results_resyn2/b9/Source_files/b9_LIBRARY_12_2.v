// Benchmark "FAU" written by ABC on Mon Jul 27 22:59:41 2020
...
module FAU ( 
  ...
  nand2  g62(.a(new_n85_), .b(new_n87_), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(x27), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(new_n66_), .O(new_n127_));
  oai21  g65(.a(new_n124_), .b(x10), .c(new_n127_), .O(z12));
  nand2  g66(.a(x36), .b(x35), .O(new_n129_));
  nand2  g67(.a(new_n129_), .b(x28), .O(new_n130_));
  nor2   g68(.a(x13), .b(x04), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n130_), .c(z08), .O(new_n132_));
  inv1   g70(.a(x18), .O(new_n133_));
  inv1   g71(.a(x19), .O(new_n134_));
  nand3  g72(.a(x20), .b(new_n134_), .c(new_n133_), .O(new_n135_));
  oai21  g73(.a(new_n135_), .b(new_n63_), .c(new_n132_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  nand2  g75(.a(new_n131_), .b(z08), .O(new_n138_));
  or2    g76(.a(new_n138_), .b(new_n75_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(z13));
  nand3  g78(.a(new_n129_), .b(new_n75_), .c(x28), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n131_), .c(x39), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(new_n135_), .O(new_n143_));
  aoi21  g81(.a(x20), .b(new_n133_), .c(x40), .O(new_n144_));
  oai21  g82(.a(new_n144_), .b(new_n126_), .c(new_n138_), .O(new_n145_));
  inv1   g83(.a(x35), .O(new_n146_));
  nand3  g84(.a(new_n87_), .b(new_n146_), .c(x28), .O(new_n147_));
  nand2  g85(.a(new_n147_), .b(x27), .O(new_n148_));
  nand2  g86(.a(new_n148_), .b(new_n75_), .O(new_n149_));
  nand3  g87(.a(new_n149_), .b(new_n145_), .c(new_n143_), .O(z14));
  ...
  nand2  g95(.a(new_n119_), .b(new_n118_), .O(new_n158_));
  nand3  g96(.a(new_n121_), .b(new_n120_), .c(new_n158_), .O(z18));
  oai21  g97(.a(new_n146_), .b(new_n72_), .c(new_n121_), .O(new_n160_));
  nor2   g98(.a(new_n160_), .b(new_n118_), .O(z20));
  aoi21  g99(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
