...
module FAU ( 
  ...
  nand3  g064(.a(new_n126_), .b(new_n121_), .c(new_n120_), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(z11));
  inv1   g066(.a(new_n63_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x39), .c(new_n64_), .O(new_n130_));
  aoi21  g068(.a(new_n66_), .b(new_n130_), .c(new_n72_), .O(new_n131_));
  nand3  g069(.a(x39), .b(x10), .c(new_n64_), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(x40), .O(z12));
  ...
  nand3  g076(.a(x39), .b(new_n138_), .c(new_n64_), .O(new_n139_));
  oai22  g077(.a(new_n139_), .b(new_n137_), .c(new_n136_), .d(new_n66_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x27), .O(new_n141_));
  inv1   g079(.a(new_n139_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n78_), .c(x40), .O(new_n143_));
  ...
  oai21  g084(.a(x13), .b(x04), .c(x40), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(x39), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n136_), .O(new_n149_));
  oai21  g087(.a(new_n139_), .b(new_n77_), .c(new_n72_), .O(new_n150_));
  nand3  g088(.a(new_n77_), .b(new_n86_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n142_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n66_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n150_), .c(new_n149_), .d(x40), .O(z14));
  ...
  nand3  g099(.a(new_n117_), .b(x27), .c(new_n64_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n126_), .c(new_n121_), .O(z18));
  nor2   g101(.a(x40), .b(new_n74_), .O(new_n164_));
  nand2  g102(.a(x35), .b(x27), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n121_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n124_), .O(z20));
  inv1   g105(.a(new_n127_), .O(z19));
endmodule
