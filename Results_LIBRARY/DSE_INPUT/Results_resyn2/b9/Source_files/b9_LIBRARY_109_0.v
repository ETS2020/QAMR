...
module FAU ( 
  ...
  inv1   g047(.a(x40), .O(new_n110_));
  oai21  g048(.a(new_n110_), .b(x35), .c(new_n74_), .O(new_n111_));
  nand2  g049(.a(new_n111_), .b(new_n73_), .O(new_n112_));
  nand2  g050(.a(new_n83_), .b(x07), .O(new_n113_));
  nand3  g051(.a(x40), .b(x39), .c(x05), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n113_), .c(new_n72_), .O(new_n115_));
  inv1   g053(.a(x05), .O(new_n116_));
  nor3   g054(.a(new_n83_), .b(new_n77_), .c(new_n116_), .O(new_n117_));
  aoi21  g055(.a(new_n115_), .b(new_n112_), .c(new_n117_), .O(new_n118_));
  ...
  oai21  g060(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(new_n123_));
  nor2   g061(.a(x28), .b(x27), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x29), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(x08), .O(new_n127_));
  nand3  g065(.a(new_n74_), .b(x27), .c(new_n65_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nor2   g067(.a(x30), .b(x09), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(new_n131_));
  aoi21  g069(.a(new_n129_), .b(new_n123_), .c(new_n131_), .O(z11));
  inv1   g070(.a(x39), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(x04), .O(new_n134_));
  nor2   g072(.a(new_n63_), .b(new_n72_), .O(new_n135_));
  nand2  g073(.a(new_n93_), .b(new_n110_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x10), .O(new_n137_));
  oai22  g075(.a(new_n64_), .b(new_n110_), .c(new_n73_), .d(new_n74_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x27), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n134_), .c(new_n135_), .O(z12));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x28), .O(new_n143_));
  nor2   g081(.a(x13), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(z08), .O(new_n145_));
  inv1   g083(.a(x18), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand3  g085(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n63_), .c(new_n145_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n144_), .b(z08), .c(new_n78_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(new_n142_), .b(new_n77_), .c(x28), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n144_), .c(z08), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  nand2  g093(.a(new_n74_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n144_), .b(new_n136_), .c(x39), .O(new_n157_));
  aoi21  g095(.a(new_n156_), .b(new_n77_), .c(new_n157_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n135_), .c(new_n155_), .O(z14));
  ...
  aoi21  g104(.a(new_n124_), .b(x35), .c(new_n126_), .O(new_n167_));
  inv1   g105(.a(new_n128_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x35), .c(new_n131_), .O(new_n169_));
  oai21  g107(.a(new_n167_), .b(new_n121_), .c(new_n169_), .O(z18));
  nor2   g108(.a(new_n74_), .b(x27), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n86_), .c(new_n122_), .O(new_n172_));
  aoi21  g110(.a(x35), .b(x27), .c(x08), .O(new_n173_));
  aoi21  g111(.a(new_n171_), .b(new_n110_), .c(new_n173_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n131_), .O(z20));
  aoi21  g113(.a(new_n129_), .b(new_n123_), .c(new_n131_), .O(z19));
endmodule
