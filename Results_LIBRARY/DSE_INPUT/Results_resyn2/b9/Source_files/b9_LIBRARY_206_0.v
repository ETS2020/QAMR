...
module FAU ( 
  ...
  aoi21  g014(.a(new_n76_), .b(new_n73_), .c(new_n72_), .O(new_n77_));
  ...
  oai21  g019(.a(new_n81_), .b(new_n76_), .c(x04), .O(new_n82_));
  ...
  nor2   g048(.a(new_n110_), .b(new_n78_), .O(new_n111_));
  inv1   g049(.a(x28), .O(new_n112_));
  inv1   g050(.a(x40), .O(new_n113_));
  oai21  g051(.a(new_n113_), .b(x35), .c(new_n112_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n73_), .O(new_n115_));
  nand2  g053(.a(new_n83_), .b(x07), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n110_), .c(new_n72_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n115_), .c(new_n111_), .O(new_n118_));
  nand3  g056(.a(x37), .b(x27), .c(x06), .O(new_n119_));
  oai21  g057(.a(new_n118_), .b(x04), .c(new_n119_), .O(z10));
  nand3  g058(.a(x39), .b(x29), .c(x08), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  nor2   g060(.a(new_n72_), .b(x04), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n112_), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x29), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  nor2   g064(.a(x28), .b(x27), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n126_), .c(x08), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  or2    g067(.a(x30), .b(x09), .O(new_n130_));
  aoi21  g068(.a(new_n129_), .b(new_n122_), .c(new_n130_), .O(z11));
  inv1   g069(.a(x10), .O(new_n132_));
  nor3   g070(.a(x37), .b(x36), .c(x35), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n72_), .c(new_n132_), .O(new_n134_));
  nand2  g072(.a(x39), .b(new_n65_), .O(new_n135_));
  oai21  g073(.a(new_n63_), .b(new_n72_), .c(new_n135_), .O(new_n136_));
  oai21  g074(.a(x37), .b(x28), .c(x27), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n113_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n136_), .c(new_n134_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  nor2   g078(.a(new_n83_), .b(x04), .O(new_n141_));
  ...
  nand2  g084(.a(new_n87_), .b(new_n89_), .O(new_n147_));
  ...
  nand3  g088(.a(new_n79_), .b(new_n141_), .c(new_n140_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n153_));
  nand3  g091(.a(new_n142_), .b(new_n78_), .c(x28), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n141_), .c(new_n140_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g094(.a(new_n89_), .b(new_n74_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n78_), .O(new_n159_));
  aoi21  g097(.a(x28), .b(x27), .c(x40), .O(new_n160_));
  nand3  g098(.a(x39), .b(new_n140_), .c(new_n65_), .O(new_n161_));
  oai22  g099(.a(new_n161_), .b(new_n160_), .c(new_n63_), .d(new_n72_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(new_n156_), .O(z14));
  ...
  aoi21  g109(.a(new_n127_), .b(x35), .c(new_n126_), .O(new_n172_));
  aoi21  g110(.a(new_n123_), .b(new_n75_), .c(new_n130_), .O(new_n173_));
  oai21  g111(.a(new_n172_), .b(new_n171_), .c(new_n173_), .O(z18));
  nand2  g112(.a(new_n112_), .b(x08), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n72_), .c(new_n74_), .O(new_n176_));
  nor2   g114(.a(new_n112_), .b(x27), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n113_), .c(new_n121_), .O(new_n178_));
  nor3   g116(.a(new_n178_), .b(new_n176_), .c(new_n130_), .O(z20));
  aoi21  g117(.a(new_n129_), .b(new_n122_), .c(new_n130_), .O(z19));
endmodule
