...
module FAU ( 
  ...
  nor2   g48(.a(x39), .b(new_n110_), .O(new_n111_));
  aoi22  g49(.a(new_n111_), .b(new_n107_), .c(new_n109_), .d(new_n76_), .O(new_n112_));
  ...
  aoi21  g54(.a(new_n116_), .b(new_n78_), .c(new_n115_), .O(new_n117_));
  nand2  g55(.a(new_n116_), .b(x27), .O(new_n118_));
  nand4  g56(.a(x35), .b(new_n73_), .c(x27), .d(new_n67_), .O(new_n119_));
  ...
  aoi22  g60(.a(new_n66_), .b(new_n86_), .c(x40), .d(new_n72_), .O(new_n123_));
  or2    g61(.a(new_n65_), .b(new_n72_), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(new_n68_), .O(new_n125_));
  oai21  g63(.a(new_n123_), .b(x10), .c(new_n125_), .O(z12));
  aoi21  g64(.a(x36), .b(x35), .c(new_n73_), .O(new_n127_));
  inv1   g65(.a(x13), .O(new_n128_));
  nand2  g66(.a(new_n64_), .b(new_n128_), .O(new_n129_));
  ...
  inv1   g71(.a(new_n75_), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n64_), .c(new_n128_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n133_), .O(z13));
  nand2  g74(.a(new_n127_), .b(new_n75_), .O(new_n137_));
  inv1   g75(.a(new_n137_), .O(new_n138_));
  oai21  g76(.a(new_n138_), .b(new_n129_), .c(new_n131_), .O(new_n139_));
  aoi21  g77(.a(new_n73_), .b(x27), .c(new_n134_), .O(new_n140_));
  oai21  g78(.a(new_n140_), .b(new_n129_), .c(new_n124_), .O(new_n141_));
  ...
  nand2  g89(.a(new_n151_), .b(new_n120_), .O(new_n152_));
  nor2   g90(.a(new_n152_), .b(new_n117_), .O(z20));
  aoi21  g91(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
