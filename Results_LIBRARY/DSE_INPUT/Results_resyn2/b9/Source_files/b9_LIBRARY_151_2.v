// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:39 2020
...
module FAU ( 
  ...
  nand2  g16(.a(x35), .b(new_n73_), .O(new_n79_));
  aoi22  g17(.a(new_n79_), .b(x40), .c(new_n72_), .d(new_n78_), .O(new_n80_));
  nand2  g18(.a(x40), .b(x39), .O(new_n81_));
  aoi21  g19(.a(x29), .b(x08), .c(x02), .O(new_n82_));
  nor2   g20(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  oai21  g21(.a(new_n80_), .b(new_n65_), .c(new_n83_), .O(z02));
  ...
  aoi21  g46(.a(new_n79_), .b(new_n108_), .c(new_n72_), .O(new_n109_));
  ...
  nand2  g53(.a(x39), .b(x29), .O(new_n116_));
  aoi21  g54(.a(new_n116_), .b(new_n79_), .c(new_n78_), .O(new_n117_));
  nand2  g55(.a(new_n116_), .b(x27), .O(new_n118_));
  nand4  g56(.a(x35), .b(new_n73_), .c(x27), .d(new_n65_), .O(new_n119_));
  nor2   g57(.a(x30), .b(x09), .O(new_n120_));
  nand2  g58(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g59(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z11));
  aoi22  g60(.a(new_n64_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n123_));
  nand2  g61(.a(new_n85_), .b(new_n87_), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(x27), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(new_n66_), .O(new_n126_));
  oai21  g64(.a(new_n123_), .b(x10), .c(new_n126_), .O(z12));
  inv1   g65(.a(x13), .O(new_n128_));
  nor2   g66(.a(new_n81_), .b(x04), .O(new_n129_));
  inv1   g67(.a(x35), .O(new_n130_));
  oai21  g68(.a(new_n108_), .b(new_n130_), .c(x28), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(new_n132_));
  inv1   g70(.a(x18), .O(new_n133_));
  inv1   g71(.a(x19), .O(new_n134_));
  nand4  g72(.a(new_n124_), .b(x20), .c(new_n134_), .d(new_n133_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  inv1   g75(.a(x30), .O(new_n138_));
  inv1   g76(.a(x32), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g78(.a(new_n140_), .b(new_n129_), .c(new_n128_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n137_), .O(z13));
  nand3  g80(.a(x20), .b(new_n134_), .c(new_n133_), .O(new_n143_));
  inv1   g81(.a(new_n143_), .O(new_n144_));
  inv1   g82(.a(new_n131_), .O(new_n145_));
  nand2  g83(.a(new_n129_), .b(new_n128_), .O(new_n146_));
  aoi21  g84(.a(new_n145_), .b(new_n75_), .c(new_n146_), .O(new_n147_));
  aoi21  g85(.a(new_n73_), .b(x27), .c(new_n140_), .O(new_n148_));
  oai21  g86(.a(new_n148_), .b(new_n146_), .c(new_n125_), .O(new_n149_));
  oai21  g87(.a(new_n147_), .b(new_n144_), .c(new_n149_), .O(z14));
  ...
  inv1   g95(.a(z11), .O(z18));
  oai21  g96(.a(new_n130_), .b(new_n72_), .c(new_n120_), .O(new_n159_));
  nor2   g97(.a(new_n159_), .b(new_n117_), .O(z20));
  aoi21  g98(.a(new_n118_), .b(new_n117_), .c(new_n121_), .O(z19));
endmodule
