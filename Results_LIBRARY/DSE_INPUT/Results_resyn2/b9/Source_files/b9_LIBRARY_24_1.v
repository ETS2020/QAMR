...
module FAU ( 
  ...
  inv1   g62(.a(new_n63_), .O(new_n125_));
  ...
  nand3  g72(.a(new_n134_), .b(new_n125_), .c(x20), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  inv1   g75(.a(new_n75_), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(new_n130_), .c(new_n129_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(z13));
  nand2  g78(.a(new_n130_), .b(new_n129_), .O(new_n141_));
  nand3  g79(.a(new_n131_), .b(new_n75_), .c(x28), .O(new_n142_));
  inv1   g80(.a(new_n142_), .O(new_n143_));
  oai22  g81(.a(new_n143_), .b(new_n141_), .c(x19), .d(x18), .O(new_n144_));
  aoi21  g82(.a(new_n73_), .b(x27), .c(new_n138_), .O(new_n145_));
  oai21  g83(.a(new_n145_), .b(new_n141_), .c(new_n126_), .O(new_n146_));
  nand3  g84(.a(new_n146_), .b(new_n144_), .c(x20), .O(z14));
  ...
  nand2  g92(.a(new_n119_), .b(new_n118_), .O(new_n155_));
  nand3  g93(.a(new_n121_), .b(new_n120_), .c(new_n155_), .O(z18));
  oai21  g94(.a(new_n85_), .b(new_n72_), .c(new_n121_), .O(new_n157_));
  nor2   g95(.a(new_n157_), .b(new_n118_), .O(z20));
  aoi21  g96(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
