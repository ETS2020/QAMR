...
module FAU ( 
  ...
  aoi21  g023(.a(new_n85_), .b(new_n83_), .c(new_n84_), .O(new_n86_));
  ...
  inv1   g045(.a(new_n84_), .O(z08));
  nand4  g046(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n109_));
  inv1   g047(.a(new_n109_), .O(z09));
  nor2   g048(.a(x32), .b(x30), .O(new_n111_));
  nor2   g049(.a(new_n84_), .b(new_n111_), .O(new_n112_));
  inv1   g050(.a(x07), .O(new_n113_));
  nand2  g051(.a(new_n84_), .b(new_n113_), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n76_), .c(new_n112_), .O(new_n115_));
  oai21  g053(.a(new_n84_), .b(x05), .c(new_n63_), .O(new_n116_));
  ...
  nand4  g060(.a(x35), .b(new_n74_), .c(x27), .d(new_n63_), .O(new_n123_));
  ...
  aoi21  g064(.a(new_n67_), .b(new_n90_), .c(new_n72_), .O(new_n127_));
  nand2  g065(.a(new_n88_), .b(new_n90_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x27), .O(new_n129_));
  inv1   g067(.a(x40), .O(new_n130_));
  nand2  g068(.a(new_n66_), .b(new_n130_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x39), .c(new_n63_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  oai21  g071(.a(new_n127_), .b(x10), .c(new_n133_), .O(z12));
  ...
  nand4  g078(.a(new_n128_), .b(x20), .c(new_n140_), .d(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x27), .O(new_n143_));
  nand2  g081(.a(new_n137_), .b(new_n112_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(z13));
  nand3  g083(.a(x20), .b(new_n140_), .c(new_n139_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  inv1   g085(.a(new_n136_), .O(new_n148_));
  nand2  g086(.a(new_n137_), .b(z08), .O(new_n149_));
  aoi21  g087(.a(new_n148_), .b(new_n111_), .c(new_n149_), .O(new_n150_));
  aoi21  g088(.a(new_n74_), .b(x27), .c(new_n79_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n129_), .O(new_n152_));
  oai21  g090(.a(new_n150_), .b(new_n147_), .c(new_n152_), .O(z14));
  ...
  nand2  g098(.a(new_n122_), .b(new_n121_), .O(new_n161_));
  nand3  g099(.a(new_n124_), .b(new_n123_), .c(new_n161_), .O(z18));
  oai21  g100(.a(new_n135_), .b(new_n72_), .c(new_n124_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(new_n121_), .O(z20));
  aoi21  g102(.a(new_n122_), .b(new_n121_), .c(new_n125_), .O(z19));
endmodule
