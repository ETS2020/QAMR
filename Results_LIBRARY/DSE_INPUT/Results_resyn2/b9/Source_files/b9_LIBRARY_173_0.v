...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n70_,
    ...
    new_n89_, new_n90_, new_n91_, new_n93_, new_n97_, new_n98_, new_n99_,
  ...
  aoi21  g001(.a(x40), .b(x36), .c(x35), .O(new_n64_));
  inv1   g002(.a(x04), .O(new_n65_));
  nand2  g003(.a(x39), .b(new_n65_), .O(new_n66_));
  ...
  aoi22  g009(.a(new_n71_), .b(z08), .c(new_n67_), .d(x27), .O(z12));
  ...
  nand2  g047(.a(new_n81_), .b(x40), .O(new_n110_));
  aoi22  g048(.a(x40), .b(x36), .c(x35), .d(new_n76_), .O(new_n111_));
  oai21  g049(.a(new_n111_), .b(new_n74_), .c(new_n110_), .O(new_n112_));
  and2   g050(.a(x39), .b(x05), .O(new_n113_));
  inv1   g051(.a(x39), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(x35), .c(new_n76_), .O(new_n115_));
  nand3  g053(.a(new_n68_), .b(x27), .c(x07), .O(new_n116_));
  aoi21  g054(.a(new_n115_), .b(new_n75_), .c(new_n116_), .O(new_n117_));
  aoi21  g055(.a(new_n113_), .b(new_n112_), .c(new_n117_), .O(new_n118_));
  ...
  nand2  g060(.a(x39), .b(x29), .O(new_n123_));
  nand3  g061(.a(x35), .b(new_n76_), .c(new_n74_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n123_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x08), .O(new_n126_));
  nand4  g064(.a(x35), .b(new_n76_), .c(x27), .d(new_n65_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(x40), .c(new_n122_), .O(z11));
  inv1   g067(.a(x18), .O(new_n130_));
  inv1   g068(.a(x19), .O(new_n131_));
  nand3  g069(.a(x20), .b(new_n131_), .c(new_n130_), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(new_n63_), .O(new_n133_));
  inv1   g071(.a(x13), .O(new_n134_));
  nand3  g072(.a(x39), .b(new_n134_), .c(new_n65_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n133_), .c(x27), .O(new_n137_));
  nand3  g075(.a(new_n136_), .b(new_n81_), .c(x40), .O(new_n138_));
  nand3  g076(.a(x40), .b(x36), .c(x35), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x28), .O(new_n140_));
  nor2   g078(.a(new_n140_), .b(new_n133_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n137_), .c(new_n138_), .O(z13));
  nand2  g080(.a(new_n138_), .b(new_n137_), .O(new_n143_));
  inv1   g081(.a(new_n132_), .O(new_n144_));
  nand3  g082(.a(new_n80_), .b(new_n79_), .c(x28), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x37), .O(new_n146_));
  aoi21  g084(.a(new_n145_), .b(x40), .c(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n145_), .b(x36), .c(x40), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n132_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n148_), .c(new_n143_), .O(z14));
  ...
  inv1   g096(.a(x29), .O(new_n159_));
  oai21  g097(.a(new_n68_), .b(new_n159_), .c(new_n124_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x08), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n127_), .c(new_n121_), .O(z18));
  nand2  g100(.a(x40), .b(x08), .O(new_n163_));
  oai21  g101(.a(new_n88_), .b(new_n74_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n76_), .b(x27), .c(x35), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n123_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n122_), .O(z20));
  aoi21  g105(.a(new_n128_), .b(x40), .c(new_n122_), .O(z19));
endmodule
