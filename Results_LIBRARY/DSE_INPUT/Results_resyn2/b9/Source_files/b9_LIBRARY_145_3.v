...
module FAU ( 
  ...
  nand3  g54(.a(x40), .b(x39), .c(x29), .O(new_n117_));
  nand3  g55(.a(new_n117_), .b(x27), .c(x04), .O(new_n118_));
  nand2  g56(.a(new_n117_), .b(new_n78_), .O(new_n119_));
  inv1   g57(.a(x08), .O(new_n120_));
  nand3  g58(.a(x35), .b(new_n73_), .c(x27), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand3  g60(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n116_), .O(new_n124_));
  nand3  g62(.a(x39), .b(new_n120_), .c(x04), .O(new_n125_));
  aoi21  g63(.a(new_n125_), .b(new_n124_), .c(x30), .O(z11));
  aoi22  g64(.a(new_n64_), .b(new_n87_), .c(x39), .d(new_n72_), .O(new_n127_));
  oai21  g65(.a(new_n63_), .b(new_n72_), .c(new_n66_), .O(new_n128_));
  oai21  g66(.a(new_n127_), .b(x10), .c(new_n128_), .O(z12));
  inv1   g67(.a(x13), .O(new_n130_));
  nor2   g68(.a(new_n81_), .b(x04), .O(new_n131_));
  oai21  g69(.a(new_n108_), .b(new_n85_), .c(x28), .O(new_n132_));
  nand3  g70(.a(new_n132_), .b(new_n131_), .c(new_n130_), .O(new_n133_));
  inv1   g71(.a(new_n63_), .O(new_n134_));
  ...
  nand2  g77(.a(new_n131_), .b(new_n130_), .O(new_n140_));
  inv1   g78(.a(new_n140_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(new_n138_), .O(z13));
  aoi22  g81(.a(new_n137_), .b(x27), .c(new_n141_), .d(new_n139_), .O(z14));
  ...
  nand2  g89(.a(new_n117_), .b(x27), .O(new_n152_));
  nand3  g90(.a(new_n152_), .b(new_n119_), .c(x08), .O(new_n153_));
  nor2   g91(.a(x30), .b(x09), .O(new_n154_));
  inv1   g92(.a(new_n121_), .O(new_n155_));
  nand2  g93(.a(new_n155_), .b(new_n65_), .O(new_n156_));
  nand3  g94(.a(new_n156_), .b(new_n154_), .c(new_n153_), .O(z18));
  oai21  g95(.a(new_n85_), .b(new_n72_), .c(new_n154_), .O(new_n158_));
  aoi21  g96(.a(new_n119_), .b(x08), .c(new_n158_), .O(z20));
  aoi21  g97(.a(new_n125_), .b(new_n124_), .c(x30), .O(z19));
endmodule
