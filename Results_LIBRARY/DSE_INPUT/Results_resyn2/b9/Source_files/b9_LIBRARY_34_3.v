...
module FAU ( 
  ...
  nand2  g59(.a(new_n75_), .b(new_n69_), .O(new_n122_));
  inv1   g60(.a(x13), .O(new_n123_));
  nand3  g61(.a(z08), .b(new_n123_), .c(new_n116_), .O(new_n124_));
  inv1   g62(.a(new_n124_), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nor2   g64(.a(x19), .b(x18), .O(new_n127_));
  nand3  g65(.a(x37), .b(x27), .c(x20), .O(new_n128_));
  inv1   g66(.a(new_n128_), .O(new_n129_));
  nand2  g67(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(new_n126_), .O(z13));
  aoi22  g69(.a(new_n129_), .b(new_n127_), .c(new_n125_), .d(new_n122_), .O(z14));
