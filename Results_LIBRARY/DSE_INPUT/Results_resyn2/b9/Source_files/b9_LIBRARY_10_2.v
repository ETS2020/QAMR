...
module FAU ( 
  ...
  aoi21  g03(.a(x36), .b(x27), .c(x10), .O(new_n66_));
  inv1   g04(.a(x04), .O(new_n67_));
  nand3  g05(.a(x40), .b(x39), .c(new_n67_), .O(new_n68_));
  oai22  g06(.a(new_n68_), .b(new_n66_), .c(new_n65_), .d(new_n64_), .O(new_n69_));
  ...
  nand2  g47(.a(new_n82_), .b(x07), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nor2   g49(.a(x32), .b(x30), .O(new_n112_));
  nor2   g50(.a(new_n109_), .b(new_n112_), .O(new_n113_));
  ...
  aoi21  g56(.a(new_n118_), .b(new_n74_), .c(new_n117_), .O(new_n119_));
  nand2  g57(.a(new_n118_), .b(x27), .O(new_n120_));
  nand4  g58(.a(x35), .b(new_n73_), .c(x27), .d(new_n67_), .O(new_n121_));
  ...
  nand4  g73(.a(new_n126_), .b(x20), .c(new_n135_), .d(new_n134_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(x27), .O(new_n138_));
  nand3  g76(.a(new_n132_), .b(new_n78_), .c(z08), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n138_), .O(z13));
  nand3  g78(.a(x20), .b(new_n135_), .c(new_n134_), .O(new_n141_));
  inv1   g79(.a(new_n141_), .O(new_n142_));
  inv1   g80(.a(new_n131_), .O(new_n143_));
  nand2  g81(.a(new_n132_), .b(z08), .O(new_n144_));
  aoi21  g82(.a(new_n143_), .b(new_n112_), .c(new_n144_), .O(new_n145_));
  aoi21  g83(.a(new_n73_), .b(x27), .c(new_n78_), .O(new_n146_));
  oai21  g84(.a(new_n146_), .b(new_n144_), .c(new_n127_), .O(new_n147_));
  ...
  nand2  g93(.a(new_n120_), .b(new_n119_), .O(new_n156_));
  nand3  g94(.a(new_n122_), .b(new_n121_), .c(new_n156_), .O(z18));
  oai21  g95(.a(new_n130_), .b(new_n64_), .c(new_n122_), .O(new_n158_));
  nor2   g96(.a(new_n158_), .b(new_n119_), .O(z20));
  aoi21  g97(.a(new_n120_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
