...
module FAU ( 
  ...
  inv1   g14(.a(new_n66_), .O(new_n77_));
  nor2   g15(.a(x19), .b(x18), .O(new_n78_));
  nand3  g16(.a(new_n78_), .b(new_n77_), .c(x20), .O(new_n79_));
  ...
  and2   g23(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  oai21  g24(.a(new_n79_), .b(new_n71_), .c(new_n86_), .O(z02));
  ...
  nor2   g48(.a(new_n73_), .b(new_n71_), .O(new_n111_));
  aoi22  g49(.a(new_n75_), .b(z08), .c(new_n111_), .d(x07), .O(new_n112_));
  oai21  g50(.a(new_n83_), .b(x05), .c(new_n63_), .O(new_n113_));
  ...
  nand4  g57(.a(x35), .b(new_n72_), .c(x27), .d(new_n63_), .O(new_n120_));
  ...
  nand2  g65(.a(new_n127_), .b(new_n79_), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(x27), .O(new_n129_));
  inv1   g67(.a(x40), .O(new_n130_));
  nor2   g68(.a(new_n74_), .b(new_n130_), .O(new_n131_));
  nand3  g69(.a(new_n131_), .b(new_n126_), .c(x39), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n129_), .O(z13));
  nand3  g71(.a(new_n124_), .b(new_n74_), .c(x28), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(new_n126_), .c(x39), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(x40), .O(new_n136_));
  aoi21  g74(.a(new_n79_), .b(new_n130_), .c(new_n71_), .O(new_n137_));
  oai21  g75(.a(new_n137_), .b(new_n131_), .c(new_n136_), .O(z14));
  ...
  nand2  g85(.a(new_n147_), .b(new_n121_), .O(new_n148_));
  nor2   g86(.a(new_n148_), .b(new_n118_), .O(z20));
  aoi21  g87(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
