...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n99_, new_n100_, new_n101_, new_n102_, new_n104_, new_n106_,
  ...
  nand2  g20(.a(new_n82_), .b(z08), .O(z02));
  ...
  aoi21  g44(.a(new_n80_), .b(new_n106_), .c(new_n72_), .O(new_n107_));
  aoi21  g45(.a(new_n107_), .b(x07), .c(z08), .O(new_n108_));
  inv1   g46(.a(x05), .O(new_n109_));
  aoi21  g47(.a(z08), .b(new_n109_), .c(x04), .O(new_n110_));
  nand2  g48(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  nand3  g49(.a(x37), .b(x27), .c(x06), .O(new_n112_));
  oai21  g50(.a(new_n111_), .b(new_n108_), .c(new_n112_), .O(z10));
  inv1   g51(.a(x08), .O(new_n114_));
  nand2  g52(.a(z08), .b(x29), .O(new_n115_));
  aoi21  g53(.a(new_n115_), .b(new_n80_), .c(new_n114_), .O(new_n116_));
  ...
  nor2   g65(.a(new_n78_), .b(x04), .O(new_n128_));
  inv1   g66(.a(x35), .O(new_n129_));
  oai21  g67(.a(new_n106_), .b(new_n129_), .c(x28), .O(new_n130_));
  ...
  nand2  g94(.a(new_n117_), .b(new_n116_), .O(new_n157_));
  nand3  g95(.a(new_n119_), .b(new_n118_), .c(new_n157_), .O(z18));
  oai21  g96(.a(new_n129_), .b(new_n72_), .c(new_n119_), .O(new_n159_));
  nor2   g97(.a(new_n159_), .b(new_n116_), .O(z20));
  aoi21  g98(.a(new_n117_), .b(new_n116_), .c(new_n120_), .O(z19));
endmodule
