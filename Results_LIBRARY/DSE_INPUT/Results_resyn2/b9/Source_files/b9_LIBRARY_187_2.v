// Benchmark "FAU" written by ABC on Mon Jul 27 23:00:54 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n136_, new_n138_, new_n139_, new_n142_, new_n143_;
  ...
  aoi21  g46(.a(new_n78_), .b(new_n77_), .c(new_n83_), .O(new_n109_));
  nor2   g47(.a(new_n109_), .b(new_n76_), .O(new_n110_));
  inv1   g48(.a(x05), .O(new_n111_));
  aoi21  g49(.a(x39), .b(new_n111_), .c(x04), .O(new_n112_));
  oai21  g50(.a(x39), .b(x07), .c(new_n112_), .O(new_n113_));
  nand3  g51(.a(x37), .b(x27), .c(x06), .O(new_n114_));
  oai21  g52(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z10));
  inv1   g53(.a(x08), .O(new_n116_));
  nand2  g54(.a(x39), .b(x29), .O(new_n117_));
  aoi21  g55(.a(new_n117_), .b(new_n75_), .c(new_n116_), .O(new_n118_));
  nand2  g56(.a(new_n117_), .b(x27), .O(new_n119_));
  nand4  g57(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n120_));
  ...
  nor2   g61(.a(x13), .b(x04), .O(new_n124_));
  nand2  g62(.a(new_n124_), .b(new_n109_), .O(new_n125_));
  nor2   g63(.a(x19), .b(x18), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(x20), .O(new_n127_));
  aoi21  g65(.a(x36), .b(x35), .c(new_n74_), .O(new_n128_));
  nand2  g66(.a(new_n124_), .b(x39), .O(new_n129_));
  oai22  g67(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n66_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n125_), .O(z13));
  aoi22  g70(.a(new_n130_), .b(x27), .c(new_n124_), .d(new_n109_), .O(z14));
  ...
  inv1   g78(.a(z11), .O(z18));
  nand2  g79(.a(x35), .b(x27), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(new_n121_), .O(new_n143_));
  nor2   g81(.a(new_n143_), .b(new_n118_), .O(z20));
  buf    g82(.a(x39), .O(z08));
  aoi21  g83(.a(new_n119_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
