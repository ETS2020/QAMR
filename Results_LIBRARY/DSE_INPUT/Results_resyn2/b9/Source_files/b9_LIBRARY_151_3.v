...
module FAU ( 
  ...
  inv1   g19(.a(new_n81_), .O(z08));
  oai21  g20(.a(new_n75_), .b(new_n72_), .c(x04), .O(new_n83_));
  nand3  g21(.a(new_n83_), .b(z08), .c(x02), .O(z02));
  ...
  aoi21  g44(.a(new_n78_), .b(new_n77_), .c(new_n81_), .O(new_n107_));
  inv1   g45(.a(x07), .O(new_n108_));
  nand2  g46(.a(new_n81_), .b(new_n108_), .O(new_n109_));
  aoi21  g47(.a(new_n109_), .b(new_n76_), .c(new_n107_), .O(new_n110_));
  oai21  g48(.a(new_n81_), .b(x05), .c(new_n65_), .O(new_n111_));
  nand3  g49(.a(x37), .b(x27), .c(x06), .O(new_n112_));
  oai21  g50(.a(new_n111_), .b(new_n110_), .c(new_n112_), .O(z10));
  inv1   g51(.a(x09), .O(new_n114_));
  nand2  g52(.a(new_n77_), .b(new_n114_), .O(new_n115_));
  nand2  g53(.a(x27), .b(x04), .O(new_n116_));
  inv1   g54(.a(x08), .O(new_n117_));
  aoi21  g55(.a(new_n72_), .b(new_n117_), .c(new_n75_), .O(new_n118_));
  aoi21  g56(.a(new_n118_), .b(new_n116_), .c(new_n115_), .O(z11));
  aoi22  g57(.a(new_n64_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n120_));
  oai21  g58(.a(new_n63_), .b(new_n72_), .c(new_n66_), .O(new_n121_));
  oai21  g59(.a(new_n120_), .b(x10), .c(new_n121_), .O(z12));
  nor2   g60(.a(x13), .b(x04), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n107_), .O(new_n124_));
  nand2  g62(.a(new_n85_), .b(new_n87_), .O(new_n125_));
  nor2   g63(.a(x19), .b(x18), .O(new_n126_));
  nand3  g64(.a(new_n126_), .b(new_n125_), .c(x20), .O(new_n127_));
  aoi21  g65(.a(x36), .b(x35), .c(new_n74_), .O(new_n128_));
  nand2  g66(.a(new_n123_), .b(z08), .O(new_n129_));
  oai21  g67(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nand2  g68(.a(new_n130_), .b(x27), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n124_), .O(z13));
  inv1   g70(.a(new_n124_), .O(new_n133_));
  aoi21  g71(.a(new_n130_), .b(x27), .c(new_n133_), .O(z14));
  ...
  oai21  g80(.a(x28), .b(new_n117_), .c(new_n72_), .O(new_n143_));
  aoi21  g81(.a(new_n143_), .b(x35), .c(new_n115_), .O(z20));
  aoi21  g82(.a(new_n118_), .b(new_n116_), .c(new_n115_), .O(z19));
endmodule
