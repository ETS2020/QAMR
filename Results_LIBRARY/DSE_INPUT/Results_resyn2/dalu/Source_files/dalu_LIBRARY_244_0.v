// Benchmark "FAU" written by ABC on Thu Jul 30 02:47:33 2020
...
module FAU ( 
  ...
  aoi21  g090(.a(new_n103_), .b(x67), .c(new_n93_), .O(new_n182_));
  ...
  oai21  g096(.a(new_n103_), .b(x67), .c(new_n187_), .O(new_n188_));
  nand3  g097(.a(new_n188_), .b(x69), .c(x48), .O(new_n189_));
  nand2  g098(.a(x71), .b(x67), .O(new_n190_));
  ...
  nor2   g103(.a(new_n96_), .b(x66), .O(new_n195_));
  ...
  oai21  g162(.a(new_n190_), .b(x66), .c(new_n174_), .O(new_n254_));
  ...
  aoi21  g168(.a(new_n259_), .b(new_n258_), .c(x67), .O(new_n260_));
  ...
  aoi21  g172(.a(new_n246_), .b(new_n132_), .c(x66), .O(new_n264_));
