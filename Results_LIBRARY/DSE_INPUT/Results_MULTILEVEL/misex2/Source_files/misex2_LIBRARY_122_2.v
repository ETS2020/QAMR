// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:01 2020
...
module FAU ( 
  ...
  nor2   g49(.a(x13), .b(new_n76_), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(new_n68_), .c(x02), .O(new_n94_));
  ...
  nand4  g63(.a(new_n93_), .b(new_n68_), .c(x02), .d(new_n60_), .O(new_n107_));
  nor3   g64(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n92_), .c(new_n91_), .d(x20), .O(new_n109_));
  or2    g66(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g68(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n112_));
  nor2   g69(.a(new_n96_), .b(x14), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n91_), .c(x20), .d(new_n97_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n107_), .c(new_n112_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n92_), .c(new_n59_), .O(new_n116_));
