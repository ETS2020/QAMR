...
module FAU ( 
  ...
  nor2   g61(.a(new_n45_), .b(new_n60_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(x22), .c(x21), .d(new_n100_), .O(new_n106_));
  ...
  nand2  g71(.a(new_n109_), .b(new_n94_), .O(new_n115_));
  nand3  g72(.a(new_n105_), .b(x21), .c(new_n100_), .O(new_n116_));
  nor2   g73(.a(new_n96_), .b(x14), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n92_), .c(x20), .d(new_n97_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n116_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n93_), .c(new_n59_), .O(new_n120_));
  ...
  nand4  g91(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n135_));
  nor2   g92(.a(new_n135_), .b(x19), .O(z14));
  aoi21  g93(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n137_));
  oai22  g94(.a(new_n137_), .b(new_n59_), .c(new_n63_), .d(x02), .O(z15));
