...
module FAU ( 
  ...
  nand4  g14(.a(new_n57_), .b(new_n44_), .c(new_n56_), .d(x09), .O(new_n58_));
  ...
  nand3  g23(.a(x12), .b(x11), .c(new_n46_), .O(new_n67_));
  ...
  nand4  g29(.a(new_n72_), .b(new_n70_), .c(new_n69_), .d(new_n46_), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(z04));
  nand2  g31(.a(new_n72_), .b(x09), .O(new_n75_));
  inv1   g32(.a(new_n75_), .O(z05));
  nand4  g33(.a(x11), .b(new_n46_), .c(x02), .d(x01), .O(new_n77_));
  nor2   g34(.a(new_n77_), .b(new_n60_), .O(z06));
  nand2  g35(.a(new_n70_), .b(x11), .O(new_n79_));
  ...
  nor2   g51(.a(new_n62_), .b(x01), .O(new_n95_));
  ...
  nor2   g58(.a(new_n45_), .b(new_n61_), .O(new_n102_));
  ...
  nor2   g65(.a(x13), .b(new_n70_), .O(new_n109_));
  ...
  nand3  g75(.a(new_n118_), .b(new_n94_), .c(new_n60_), .O(new_n119_));
  inv1   g76(.a(new_n119_), .O(z11));
  nand2  g77(.a(x01), .b(x00), .O(new_n121_));
  nor2   g78(.a(x01), .b(x00), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n64_), .c(x17), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n121_), .c(x02), .O(new_n124_));
  oai21  g81(.a(x19), .b(x02), .c(x23), .O(new_n125_));
  nor3   g82(.a(new_n125_), .b(x01), .c(x00), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nor3   g84(.a(new_n127_), .b(x24), .c(new_n46_), .O(z12));
  nand2  g85(.a(new_n47_), .b(x17), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(x19), .O(z13));
  nand4  g87(.a(new_n57_), .b(new_n44_), .c(new_n56_), .d(new_n46_), .O(new_n131_));
  nor3   g88(.a(new_n131_), .b(x19), .c(x18), .O(z14));
  nand2  g89(.a(x19), .b(new_n61_), .O(new_n133_));
  aoi21  g90(.a(new_n133_), .b(new_n60_), .c(x02), .O(z15));
  nor2   g91(.a(new_n61_), .b(x00), .O(z16));
  nand2  g92(.a(new_n122_), .b(x02), .O(new_n136_));
