...
module FAU ( 
  ...
  nand3  g49(.a(new_n92_), .b(x12), .c(new_n68_), .O(new_n93_));
  ...
  oai22  g58(.a(new_n101_), .b(new_n98_), .c(new_n97_), .d(new_n93_), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n91_), .c(new_n59_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nor3   g61(.a(new_n91_), .b(new_n100_), .c(x20), .O(new_n105_));
  ...
  nor3   g65(.a(new_n108_), .b(new_n94_), .c(x14), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n92_), .d(new_n68_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n106_), .c(x00), .O(z10));
  nand4  g68(.a(new_n96_), .b(x20), .c(new_n95_), .d(x15), .O(new_n112_));
  nand3  g69(.a(x21), .b(new_n99_), .c(new_n63_), .O(new_n113_));
  oai22  g70(.a(new_n113_), .b(new_n98_), .c(new_n112_), .d(new_n93_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n91_), .c(new_n59_), .O(new_n115_));
