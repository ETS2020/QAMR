// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:05 2020
...
module FAU ( 
  ...
  nand3  g50(.a(z16), .b(new_n63_), .c(x18), .O(new_n94_));
  nor2   g51(.a(new_n94_), .b(x20), .O(new_n95_));
  nand3  g52(.a(new_n95_), .b(new_n92_), .c(new_n91_), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z09));
  nor3   g54(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n63_), .c(x18), .d(x01), .O(new_n99_));
  nor2   g56(.a(new_n61_), .b(x01), .O(new_n100_));
  nor2   g57(.a(x13), .b(new_n76_), .O(new_n101_));
  inv1   g58(.a(x15), .O(new_n102_));
  nand3  g59(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n102_), .c(x14), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n101_), .c(new_n100_), .d(new_n68_), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n99_), .c(x00), .O(z10));
  nand3  g63(.a(new_n95_), .b(new_n92_), .c(x21), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(z11));
  nand2  g65(.a(x10), .b(x02), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(x01), .c(x00), .O(new_n110_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g68(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n60_), .c(new_n59_), .O(new_n114_));
  ...
  nand4  g76(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n120_));
  nor2   g77(.a(new_n120_), .b(x19), .O(z14));
  aoi21  g78(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n122_));
  nand3  g79(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n123_));
  oai21  g80(.a(new_n122_), .b(new_n59_), .c(new_n123_), .O(z15));
  nand3  g81(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n125_));
