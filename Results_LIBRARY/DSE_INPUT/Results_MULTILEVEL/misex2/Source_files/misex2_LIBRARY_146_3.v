...
module FAU ( 
  ...
  nand4  g49(.a(new_n92_), .b(new_n63_), .c(x18), .d(x01), .O(new_n93_));
  inv1   g50(.a(x13), .O(new_n94_));
  nor2   g51(.a(new_n61_), .b(x01), .O(new_n95_));
  ...
  oai21  g57(.a(new_n100_), .b(new_n96_), .c(new_n93_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n91_), .c(new_n59_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  inv1   g60(.a(x15), .O(new_n104_));
  inv1   g61(.a(x14), .O(new_n105_));
  nand4  g62(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n94_), .d(x12), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n104_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n98_), .c(x20), .d(x16), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x22), .O(z10));
  nand4  g68(.a(new_n109_), .b(new_n98_), .c(x20), .d(new_n97_), .O(new_n112_));
  ...
  aoi21  g83(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n59_), .c(new_n128_), .O(z15));
  nor2   g86(.a(new_n60_), .b(x00), .O(z16));
  nand3  g87(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n131_));
