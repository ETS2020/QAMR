...
module FAU ( 
  ...
  nand4  g65(.a(new_n108_), .b(x20), .c(x16), .d(new_n96_), .O(new_n109_));
  ...
  nand4  g71(.a(new_n114_), .b(new_n91_), .c(x20), .d(new_n113_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n107_), .c(new_n112_), .O(new_n116_));
