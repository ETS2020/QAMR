...
module FAU ( 
  ...
  nand3  g46(.a(new_n63_), .b(x18), .c(new_n59_), .O(new_n90_));
  nor4   g47(.a(new_n90_), .b(x22), .c(x21), .d(x20), .O(z09));
  inv1   g48(.a(x21), .O(new_n92_));
  nor2   g49(.a(new_n60_), .b(x00), .O(z16));
  nand3  g50(.a(z16), .b(new_n63_), .c(x18), .O(new_n94_));
  nor3   g51(.a(new_n94_), .b(new_n92_), .c(x20), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(x22), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(z10));
  inv1   g54(.a(x22), .O(new_n98_));
  nand2  g55(.a(new_n95_), .b(new_n98_), .O(new_n99_));
  ...
  nand3  g60(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n60_), .c(new_n59_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n102_), .c(x24), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(x09), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(z12));
  nand2  g66(.a(new_n47_), .b(x17), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x19), .O(z13));
  nand4  g68(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n112_));
  nor2   g69(.a(new_n112_), .b(x19), .O(z14));
  aoi21  g70(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n114_));
  nand3  g71(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n115_));
  oai21  g72(.a(new_n114_), .b(new_n59_), .c(new_n115_), .O(z15));
  nand3  g73(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n117_));
  inv1   g74(.a(new_n117_), .O(z17));
endmodule
