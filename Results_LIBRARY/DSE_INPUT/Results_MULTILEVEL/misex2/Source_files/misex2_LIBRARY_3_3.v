...
module FAU ( 
  ...
  nor3   g31(.a(new_n74_), .b(new_n59_), .c(new_n73_), .O(z06));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n59_), .d(new_n73_), .O(new_n85_));
  ...
  nor2   g49(.a(x01), .b(x00), .O(new_n93_));
  ...
  nand3  g63(.a(x02), .b(new_n59_), .c(new_n73_), .O(new_n107_));
  ...
  nand2  g68(.a(new_n111_), .b(new_n106_), .O(z10));
  nand4  g69(.a(new_n100_), .b(x21), .c(new_n99_), .d(new_n62_), .O(new_n113_));
  inv1   g70(.a(x13), .O(new_n114_));
  nor2   g71(.a(new_n95_), .b(x14), .O(new_n115_));
  nor2   g72(.a(x21), .b(new_n99_), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n115_), .c(new_n96_), .d(new_n114_), .O(new_n117_));
  or2    g74(.a(new_n117_), .b(new_n94_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n113_), .c(x22), .O(z11));
  nand2  g76(.a(x10), .b(x02), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(x01), .c(x00), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n62_), .b(x17), .c(new_n60_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand3  g81(.a(new_n124_), .b(new_n59_), .c(new_n73_), .O(new_n125_));
  ...
  aoi21  g89(.a(new_n56_), .b(x01), .c(new_n60_), .O(new_n133_));
  nand3  g90(.a(x19), .b(new_n60_), .c(new_n59_), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(new_n73_), .c(new_n134_), .O(z15));
  nor2   g92(.a(new_n59_), .b(x00), .O(z16));
  nand2  g93(.a(new_n93_), .b(x02), .O(new_n137_));
