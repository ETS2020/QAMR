...
module FAU ( 
  ...
  nand3  g57(.a(new_n100_), .b(new_n81_), .c(x18), .O(new_n101_));
  oai21  g58(.a(new_n99_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n93_), .c(new_n92_), .d(new_n59_), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(z09));
  nand4  g61(.a(new_n63_), .b(x22), .c(x21), .d(new_n100_), .O(new_n105_));
  nor2   g62(.a(x13), .b(new_n76_), .O(new_n106_));
  nand3  g63(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n96_), .c(x14), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n106_), .c(new_n94_), .d(new_n68_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x00), .O(z10));
  nand3  g67(.a(new_n63_), .b(x21), .c(new_n100_), .O(new_n111_));
  nand4  g68(.a(new_n98_), .b(new_n92_), .c(new_n97_), .d(x15), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n95_), .c(new_n111_), .O(new_n113_));
