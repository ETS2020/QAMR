...
module FAU ( 
  ...
  nand4  g57(.a(z16), .b(new_n99_), .c(new_n63_), .d(x18), .O(new_n101_));
  ...
  nor2   g69(.a(new_n45_), .b(new_n60_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(x21), .c(new_n99_), .d(new_n63_), .O(new_n114_));
