...
module FAU ( 
  ...
  nand4  g50(.a(new_n93_), .b(x12), .c(new_n68_), .d(x02), .O(new_n94_));
  ...
  nand3  g63(.a(new_n93_), .b(x12), .c(new_n68_), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n61_), .c(x01), .O(new_n108_));
