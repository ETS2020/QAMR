...
module FAU ( 
  ...
  nand4  g49(.a(x12), .b(new_n68_), .c(x02), .d(new_n59_), .O(new_n93_));
  nor3   g50(.a(new_n93_), .b(x14), .c(x13), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(x20), .c(new_n92_), .d(new_n91_), .O(new_n95_));
  nor3   g52(.a(new_n95_), .b(x22), .c(x21), .O(z09));
  inv1   g53(.a(x21), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n63_), .c(x18), .d(x01), .O(new_n99_));
  nor2   g56(.a(x11), .b(new_n61_), .O(new_n100_));
  nor2   g57(.a(x14), .b(x13), .O(new_n101_));
  inv1   g58(.a(x22), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(new_n97_), .c(x20), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n92_), .c(new_n91_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n101_), .c(new_n100_), .d(x12), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n99_), .c(x00), .O(z10));
  nand4  g63(.a(new_n94_), .b(x20), .c(new_n92_), .d(x15), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(x22), .c(x21), .O(z11));
  ...
  nor2   g81(.a(new_n60_), .b(x00), .O(z16));
  nand3  g82(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n126_));
