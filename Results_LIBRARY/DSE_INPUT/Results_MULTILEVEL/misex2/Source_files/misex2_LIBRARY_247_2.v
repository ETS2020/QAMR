...
module FAU ( 
  ...
  nand4  g52(.a(x12), .b(new_n68_), .c(x02), .d(new_n59_), .O(new_n96_));
  ...
  nand4  g60(.a(new_n103_), .b(x22), .c(new_n102_), .d(new_n63_), .O(new_n104_));
  nand3  g61(.a(new_n94_), .b(new_n93_), .c(x12), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n61_), .O(new_n106_));
  inv1   g63(.a(x22), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n92_), .c(x20), .O(new_n108_));
  nor3   g65(.a(new_n108_), .b(new_n91_), .c(new_n95_), .O(new_n109_));
  nand2  g66(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n104_), .c(x00), .O(z10));
  nand3  g68(.a(new_n103_), .b(new_n102_), .c(new_n63_), .O(new_n112_));
  nand4  g69(.a(new_n93_), .b(x12), .c(new_n68_), .d(x02), .O(new_n113_));
  nor2   g70(.a(new_n95_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n92_), .c(x20), .d(new_n91_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n113_), .c(new_n112_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n107_), .c(new_n59_), .O(new_n117_));
