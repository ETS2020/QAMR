// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:09 2020
...
module FAU ( 
  ...
  nand3  g51(.a(new_n94_), .b(new_n93_), .c(new_n68_), .O(new_n95_));
  ...
  nand4  g60(.a(new_n103_), .b(new_n92_), .c(new_n91_), .d(new_n59_), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(z09));
  nor3   g62(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n63_), .c(x18), .d(x01), .O(new_n107_));
  nand3  g64(.a(new_n93_), .b(x12), .c(new_n68_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nor3   g66(.a(new_n98_), .b(new_n97_), .c(x14), .O(new_n110_));
  nand3  g67(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n94_), .O(new_n113_));
  ...
  nand4  g73(.a(new_n116_), .b(new_n91_), .c(x20), .d(new_n98_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n95_), .c(new_n115_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n92_), .c(new_n59_), .O(new_n119_));
  ...
  nand3  g80(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n124_));
  ...
  aoi21  g90(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n134_));
  nand3  g91(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n135_));
  oai21  g92(.a(new_n134_), .b(new_n59_), .c(new_n135_), .O(z15));
  nor2   g93(.a(new_n60_), .b(x00), .O(z16));
  nand3  g94(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n138_));
