...
module FAU ( 
  ...
  nor2   g62(.a(x11), .b(new_n61_), .O(new_n106_));
  nand3  g63(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n107_));
  nor3   g64(.a(new_n107_), .b(new_n95_), .c(new_n94_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n106_), .c(new_n96_), .d(x12), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(x00), .O(z10));
  nand4  g67(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n63_), .O(new_n111_));
  nor2   g68(.a(x13), .b(new_n76_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n106_), .O(new_n113_));
