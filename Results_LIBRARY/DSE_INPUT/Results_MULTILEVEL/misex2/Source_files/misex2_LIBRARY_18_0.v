// Benchmark "FAU" written by ABC on Mon Jul 27 17:30:43 2020
...
module FAU ( 
  ...
  nor2   g50(.a(new_n60_), .b(x00), .O(z16));
  nand3  g51(.a(z16), .b(new_n63_), .c(x18), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  nand4  g53(.a(new_n96_), .b(new_n93_), .c(new_n92_), .d(new_n91_), .O(new_n97_));
  inv1   g54(.a(new_n97_), .O(z09));
  nor3   g55(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n63_), .c(x18), .d(x01), .O(new_n100_));
  nor2   g57(.a(new_n61_), .b(x01), .O(new_n101_));
  nor2   g58(.a(x13), .b(new_n76_), .O(new_n102_));
  nand2  g59(.a(x16), .b(x15), .O(new_n103_));
  nand3  g60(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n104_));
  nor3   g61(.a(new_n104_), .b(new_n103_), .c(x14), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n102_), .c(new_n101_), .d(new_n68_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n100_), .c(x00), .O(z10));
  nand2  g64(.a(x18), .b(x01), .O(new_n108_));
  nand3  g65(.a(x21), .b(new_n91_), .c(new_n63_), .O(new_n109_));
  nand3  g66(.a(new_n101_), .b(x12), .c(new_n68_), .O(new_n110_));
  inv1   g67(.a(x16), .O(new_n111_));
  nor2   g68(.a(x14), .b(x13), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n92_), .c(x20), .d(new_n111_), .O(new_n113_));
  oai22  g70(.a(new_n113_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n93_), .c(new_n59_), .O(new_n115_));
  ...
  nand3  g76(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n60_), .c(new_n59_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n118_), .c(x24), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x09), .O(new_n124_));
  inv1   g81(.a(new_n124_), .O(z12));
  nand2  g82(.a(new_n47_), .b(x17), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z13));
  nand4  g84(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z14));
  aoi21  g86(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n130_));
  nand3  g87(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n59_), .c(new_n131_), .O(z15));
  nand3  g89(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n133_));
