...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n125_, new_n127_, new_n129_, new_n130_, new_n132_;
  ...
  nor3   g59(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n63_), .c(x18), .d(x01), .O(new_n104_));
  nor2   g61(.a(x13), .b(new_n76_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n108_), .b(new_n105_), .c(new_n93_), .d(new_n68_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n104_), .c(x00), .O(z10));
  nor2   g67(.a(new_n60_), .b(x00), .O(z16));
  nand3  g68(.a(z16), .b(new_n63_), .c(x18), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n92_), .c(x21), .d(new_n98_), .O(new_n114_));
