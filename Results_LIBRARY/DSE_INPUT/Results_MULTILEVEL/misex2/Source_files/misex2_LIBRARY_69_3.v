...
module FAU ( 
  ...
  aoi21  g75(.a(x10), .b(x02), .c(new_n60_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand4  g77(.a(new_n63_), .b(x17), .c(new_n61_), .d(new_n60_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n120_), .c(x00), .O(new_n122_));
  aoi21  g79(.a(new_n119_), .b(x00), .c(new_n122_), .O(new_n123_));
  nor3   g80(.a(new_n123_), .b(x24), .c(new_n46_), .O(z12));
