// Benchmark "FAU" written by ABC on Mon Jul 27 17:31:03 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n124_, new_n126_, new_n128_, new_n129_, new_n132_;
  ...
  nor2   g19(.a(x19), .b(new_n45_), .O(new_n63_));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n86_));
  ...
  nor2   g47(.a(new_n90_), .b(new_n81_), .O(z08));
  inv1   g48(.a(x21), .O(new_n92_));
  nand4  g49(.a(x12), .b(new_n68_), .c(x02), .d(new_n60_), .O(new_n93_));
  ...
  nor2   g54(.a(x22), .b(x20), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n81_), .c(x18), .d(x01), .O(new_n99_));
  oai21  g56(.a(new_n97_), .b(new_n93_), .c(new_n99_), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n92_), .c(new_n59_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nand2  g59(.a(x02), .b(new_n60_), .O(new_n103_));
  nor4   g60(.a(new_n103_), .b(x13), .c(new_n76_), .d(x11), .O(new_n104_));
  nor2   g61(.a(new_n94_), .b(x14), .O(new_n105_));
  inv1   g62(.a(x20), .O(new_n106_));
  nor2   g63(.a(x21), .b(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(x16), .O(new_n108_));
  nand4  g65(.a(new_n63_), .b(x22), .c(x21), .d(new_n106_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n108_), .c(x00), .O(z10));
  nand4  g67(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n95_), .O(new_n111_));
  nor2   g68(.a(x22), .b(new_n92_), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n63_), .c(new_n106_), .d(x01), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n111_), .c(x00), .O(z11));
  nand2  g71(.a(x10), .b(x02), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(x01), .c(x00), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n81_), .b(x17), .c(new_n61_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n60_), .c(new_n59_), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n116_), .c(x24), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(x09), .O(new_n122_));
  inv1   g79(.a(new_n122_), .O(z12));
  nand2  g80(.a(new_n47_), .b(x17), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x19), .O(z13));
  nand4  g82(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n126_));
  ...
  nand3  g88(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n132_));
