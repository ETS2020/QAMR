...
module FAU ( 
  ...
  nor2   g47(.a(new_n60_), .b(x00), .O(z16));
  nand3  g48(.a(z16), .b(new_n63_), .c(x18), .O(new_n92_));
  nor2   g49(.a(new_n92_), .b(x20), .O(new_n93_));
  nand3  g50(.a(new_n93_), .b(new_n90_), .c(new_n89_), .O(new_n94_));
  inv1   g51(.a(new_n94_), .O(z09));
  nor3   g52(.a(new_n92_), .b(new_n89_), .c(x20), .O(new_n96_));
  nand2  g53(.a(new_n96_), .b(x22), .O(new_n97_));
  inv1   g54(.a(new_n97_), .O(z10));
  nand2  g55(.a(new_n96_), .b(new_n90_), .O(new_n99_));
