...
module FAU ( 
  ...
  nand3  g48(.a(new_n63_), .b(x18), .c(x01), .O(new_n92_));
  nor2   g49(.a(x11), .b(new_n61_), .O(new_n93_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n91_), .c(new_n90_), .d(new_n59_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nor2   g59(.a(new_n45_), .b(new_n60_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(x22), .c(x21), .d(new_n63_), .O(new_n104_));
  nor2   g61(.a(x14), .b(x13), .O(new_n105_));
  nand3  g62(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n106_));
  nor3   g63(.a(new_n106_), .b(new_n98_), .c(new_n97_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n105_), .c(new_n93_), .d(x12), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n104_), .c(x00), .O(z10));
  nand3  g66(.a(new_n103_), .b(x21), .c(new_n63_), .O(new_n110_));
  nor2   g67(.a(new_n97_), .b(x14), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n90_), .c(x20), .d(new_n98_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n95_), .c(new_n110_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n91_), .c(new_n59_), .O(new_n114_));
