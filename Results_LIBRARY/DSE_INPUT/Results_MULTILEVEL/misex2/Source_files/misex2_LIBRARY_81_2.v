...
module FAU ( 
  ...
  nor4   g25(.a(new_n68_), .b(x12), .c(x11), .d(new_n56_), .O(z04));
  nor3   g26(.a(new_n68_), .b(new_n56_), .c(new_n46_), .O(z05));
  nand2  g27(.a(x12), .b(x09), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(x11), .c(x10), .d(x02), .O(new_n72_));
  nor3   g29(.a(new_n72_), .b(new_n60_), .c(new_n59_), .O(z06));
  inv1   g30(.a(x12), .O(new_n74_));
  nand2  g31(.a(new_n74_), .b(x11), .O(new_n75_));
  oai21  g32(.a(new_n75_), .b(new_n56_), .c(x01), .O(new_n76_));
  ...
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n83_));
  ...
  nor2   g55(.a(new_n45_), .b(new_n60_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n63_), .O(new_n100_));
  oai21  g57(.a(new_n97_), .b(new_n93_), .c(new_n100_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n90_), .c(new_n89_), .d(new_n59_), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(z09));
  nor3   g60(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n63_), .c(x18), .d(x01), .O(new_n105_));
  nor2   g62(.a(x13), .b(new_n74_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n92_), .c(new_n91_), .O(new_n107_));
  nor3   g64(.a(new_n95_), .b(new_n94_), .c(x14), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n90_), .c(new_n89_), .d(x20), .O(new_n109_));
  or2    g66(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n105_), .c(x00), .O(z10));
  nand4  g68(.a(new_n99_), .b(x21), .c(new_n98_), .d(new_n63_), .O(new_n112_));
  nor2   g69(.a(new_n94_), .b(x14), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n89_), .c(x20), .d(new_n95_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n107_), .c(new_n112_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n90_), .c(new_n59_), .O(new_n116_));
