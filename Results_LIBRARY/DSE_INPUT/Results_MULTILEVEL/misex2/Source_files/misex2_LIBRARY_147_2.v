...
module FAU ( 
  ...
  oai21  g77(.a(x19), .b(new_n44_), .c(new_n120_), .O(new_n121_));
  nand3  g78(.a(new_n121_), .b(new_n60_), .c(new_n59_), .O(new_n122_));
  oai21  g79(.a(new_n60_), .b(new_n59_), .c(new_n122_), .O(new_n123_));
  nand3  g80(.a(new_n123_), .b(new_n119_), .c(x09), .O(new_n124_));
