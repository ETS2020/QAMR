...
module FAU ( 
  ...
  inv1   g62(.a(new_n102_), .O(new_n106_));
  nor2   g63(.a(new_n100_), .b(x00), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n106_), .c(x22), .d(x21), .O(new_n108_));
  nor2   g65(.a(x13), .b(new_n76_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n94_), .c(new_n68_), .O(new_n110_));
  nor3   g67(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n92_), .c(new_n91_), .d(x20), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n110_), .c(new_n108_), .O(z10));
  nand4  g70(.a(new_n107_), .b(x21), .c(new_n101_), .d(new_n63_), .O(new_n114_));
  nand3  g71(.a(new_n91_), .b(x20), .c(new_n97_), .O(new_n115_));
  nor3   g72(.a(new_n115_), .b(new_n96_), .c(x14), .O(new_n116_));
  nand4  g73(.a(new_n116_), .b(new_n109_), .c(new_n94_), .d(new_n68_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n114_), .c(x22), .O(z11));
