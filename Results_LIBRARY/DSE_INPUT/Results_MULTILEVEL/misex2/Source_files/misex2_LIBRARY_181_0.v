...
module FAU ( 
  ...
  nor2   g57(.a(new_n92_), .b(x20), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n63_), .c(x18), .d(x01), .O(new_n102_));
  nand3  g59(.a(new_n93_), .b(x12), .c(new_n68_), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n61_), .c(x01), .O(new_n104_));
  inv1   g61(.a(x15), .O(new_n105_));
  nor3   g62(.a(new_n91_), .b(new_n105_), .c(x14), .O(new_n106_));
  ...
  nor2   g66(.a(new_n97_), .b(new_n105_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n92_), .c(x20), .d(new_n91_), .O(new_n111_));
