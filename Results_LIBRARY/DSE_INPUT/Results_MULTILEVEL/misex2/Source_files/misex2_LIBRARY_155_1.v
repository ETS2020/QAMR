...
module FAU ( 
  ...
  nand2  g55(.a(new_n98_), .b(new_n63_), .O(new_n99_));
  oai22  g56(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n93_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n92_), .c(new_n91_), .d(new_n59_), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(z09));
  nor2   g59(.a(new_n60_), .b(x00), .O(z16));
  nand3  g60(.a(z16), .b(new_n63_), .c(x18), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(x22), .c(x21), .d(new_n98_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(z10));
  nand3  g64(.a(x21), .b(new_n98_), .c(new_n63_), .O(new_n108_));
  nand4  g65(.a(new_n95_), .b(new_n91_), .c(x20), .d(x15), .O(new_n109_));
  oai22  g66(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(new_n97_), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(new_n92_), .c(new_n59_), .O(new_n111_));
  ...
  nand3  g72(.a(new_n63_), .b(x17), .c(new_n61_), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g74(.a(new_n117_), .b(new_n60_), .c(new_n59_), .O(new_n118_));
