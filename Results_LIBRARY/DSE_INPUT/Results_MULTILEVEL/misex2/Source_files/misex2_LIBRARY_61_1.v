...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n120_, new_n122_, new_n123_, new_n125_;
  ...
  nand3  g52(.a(new_n95_), .b(x20), .c(new_n94_), .O(new_n96_));
  inv1   g53(.a(x20), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n63_), .c(x18), .d(x01), .O(new_n98_));
  oai21  g55(.a(new_n96_), .b(new_n93_), .c(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n92_), .c(new_n91_), .d(new_n59_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nor2   g58(.a(new_n60_), .b(x00), .O(z16));
  nand3  g59(.a(z16), .b(new_n63_), .c(x18), .O(new_n103_));
  nor3   g60(.a(new_n103_), .b(new_n91_), .c(x20), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(x22), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z10));
  nand2  g63(.a(new_n104_), .b(new_n92_), .O(new_n107_));
