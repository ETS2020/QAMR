...
module FAU ( 
  ...
  nand4  g48(.a(x12), .b(new_n68_), .c(x02), .d(new_n60_), .O(new_n92_));
  ...
  nor2   g53(.a(x22), .b(x20), .O(new_n97_));
  nand4  g54(.a(new_n97_), .b(new_n63_), .c(x18), .d(x01), .O(new_n98_));
  oai21  g55(.a(new_n96_), .b(new_n92_), .c(new_n98_), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n91_), .c(new_n59_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n104_), .b(x22), .c(x21), .d(new_n102_), .O(new_n105_));
  nand2  g62(.a(x02), .b(new_n60_), .O(new_n106_));
  nor4   g63(.a(new_n106_), .b(x13), .c(new_n76_), .d(x11), .O(new_n107_));
  ...
  nand3  g68(.a(new_n91_), .b(x20), .c(new_n94_), .O(new_n112_));
  nor3   g69(.a(new_n112_), .b(new_n93_), .c(x14), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n107_), .O(new_n114_));
  nor2   g71(.a(x22), .b(new_n91_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n104_), .c(new_n102_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n114_), .c(x00), .O(z11));
  ...
  nand2  g83(.a(new_n47_), .b(x17), .O(new_n127_));
  nor2   g84(.a(new_n127_), .b(x19), .O(z13));
  nand4  g85(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n129_));
  nor2   g86(.a(new_n129_), .b(x19), .O(z14));
  aoi21  g87(.a(new_n56_), .b(x01), .c(new_n61_), .O(new_n131_));
  nand3  g88(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  oai21  g89(.a(new_n131_), .b(new_n59_), .c(new_n132_), .O(z15));
  nor2   g90(.a(new_n60_), .b(x00), .O(z16));
  nand3  g91(.a(x02), .b(new_n60_), .c(new_n59_), .O(new_n135_));
