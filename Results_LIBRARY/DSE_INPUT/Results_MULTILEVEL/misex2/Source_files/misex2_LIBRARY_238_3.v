...
module FAU ( 
  ...
  nor2   g48(.a(new_n61_), .b(x01), .O(new_n92_));
  nor2   g49(.a(x13), .b(new_n75_), .O(new_n93_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n91_), .c(new_n90_), .d(new_n59_), .O(new_n103_));
  ...
  nor2   g63(.a(x14), .b(x13), .O(new_n107_));
  nand3  g64(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n108_));
  nor3   g65(.a(new_n108_), .b(new_n97_), .c(new_n96_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n107_), .c(new_n92_), .d(x12), .O(new_n110_));
  ...
  nand4  g70(.a(new_n113_), .b(new_n90_), .c(x20), .d(new_n97_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n94_), .c(new_n112_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n91_), .c(new_n59_), .O(new_n116_));
