...
module FAU ( 
  ...
  nand2  g56(.a(new_n99_), .b(new_n63_), .O(new_n100_));
  ...
  nand3  g61(.a(z16), .b(new_n63_), .c(x18), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(x22), .c(x21), .d(new_n99_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(z10));
  nand3  g65(.a(x21), .b(new_n99_), .c(new_n63_), .O(new_n109_));
  nand4  g66(.a(new_n96_), .b(new_n91_), .c(x20), .d(x15), .O(new_n110_));
  oai22  g67(.a(new_n110_), .b(new_n93_), .c(new_n109_), .d(new_n98_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n92_), .c(new_n59_), .O(new_n112_));
