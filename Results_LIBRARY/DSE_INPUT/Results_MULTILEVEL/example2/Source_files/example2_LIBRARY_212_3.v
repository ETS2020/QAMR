...
module FAU ( 
  ...
  nand4  g143(.a(new_n292_), .b(x78), .c(x77), .d(x54), .O(new_n296_));
  nor3   g144(.a(new_n296_), .b(x04), .c(x01), .O(z36));
  nand4  g145(.a(new_n292_), .b(x78), .c(x77), .d(x55), .O(new_n298_));
  nor3   g146(.a(new_n298_), .b(x04), .c(x01), .O(z37));
  nand4  g147(.a(new_n292_), .b(x78), .c(x77), .d(x56), .O(new_n300_));
  nor3   g148(.a(new_n300_), .b(x04), .c(x01), .O(z38));
  nand4  g149(.a(new_n292_), .b(x78), .c(x77), .d(x57), .O(new_n302_));
  nor3   g150(.a(new_n302_), .b(x04), .c(x01), .O(z39));
  nand4  g151(.a(new_n292_), .b(x78), .c(x77), .d(x58), .O(new_n304_));
