...
module FAU ( 
  ...
  nand2  g231(.a(new_n172_), .b(new_n382_), .O(new_n383_));
  nand3  g232(.a(new_n383_), .b(new_n381_), .c(x79), .O(new_n384_));
  inv1   g233(.a(new_n384_), .O(new_n385_));
  aoi21  g234(.a(new_n163_), .b(new_n159_), .c(new_n385_), .O(new_n386_));
  nand4  g235(.a(new_n386_), .b(new_n380_), .c(new_n153_), .d(x00), .O(z56));
  ...
  nand3  g256(.a(new_n406_), .b(new_n384_), .c(new_n241_), .O(new_n408_));
  and2   g257(.a(new_n408_), .b(new_n153_), .O(z60));
  nand2  g258(.a(new_n383_), .b(new_n233_), .O(new_n410_));
  oai21  g259(.a(new_n245_), .b(x04), .c(new_n410_), .O(new_n411_));
  ...
  nand2  g265(.a(new_n402_), .b(x04), .O(new_n417_));
  ...
  or2    g269(.a(new_n415_), .b(new_n172_), .O(new_n421_));
  ...
  nor2   g276(.a(new_n163_), .b(x04), .O(new_n428_));
  nor2   g277(.a(new_n252_), .b(x78), .O(new_n429_));
