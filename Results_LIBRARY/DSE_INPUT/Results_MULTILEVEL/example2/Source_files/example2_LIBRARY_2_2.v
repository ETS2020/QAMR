...
module FAU ( 
  ...
  nor2   g204(.a(x52), .b(new_n355_), .O(new_n356_));
  nor2   g205(.a(x79), .b(new_n160_), .O(new_n357_));
  nand4  g206(.a(new_n357_), .b(new_n356_), .c(new_n159_), .d(x04), .O(new_n358_));
  ...
  nand3  g274(.a(new_n357_), .b(new_n159_), .c(x04), .O(new_n426_));
