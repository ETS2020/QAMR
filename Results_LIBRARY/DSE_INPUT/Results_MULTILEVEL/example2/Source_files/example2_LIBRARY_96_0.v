...
module FAU ( 
  ...
  aoi21  g185(.a(x52), .b(new_n336_), .c(x79), .O(new_n337_));
  nand4  g186(.a(new_n337_), .b(x78), .c(new_n159_), .d(x04), .O(new_n338_));
  nand2  g187(.a(new_n333_), .b(x69), .O(new_n339_));
  ...
  nand2  g227(.a(new_n167_), .b(new_n378_), .O(new_n379_));
  nand3  g228(.a(new_n379_), .b(new_n377_), .c(new_n153_), .O(new_n380_));
  ...
  aoi21  g251(.a(new_n401_), .b(x77), .c(new_n402_), .O(new_n403_));
  nor2   g252(.a(new_n403_), .b(x01), .O(z59));
  nand3  g253(.a(new_n379_), .b(new_n377_), .c(x79), .O(new_n405_));
  oai21  g254(.a(x77), .b(new_n320_), .c(new_n154_), .O(new_n406_));
  oai21  g255(.a(new_n234_), .b(x42), .c(new_n406_), .O(new_n407_));
  nand2  g256(.a(new_n407_), .b(x04), .O(new_n408_));
  nand2  g257(.a(new_n154_), .b(x52), .O(new_n409_));
  nand2  g258(.a(new_n409_), .b(new_n408_), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(x78), .c(new_n402_), .O(new_n411_));
  aoi21  g260(.a(new_n411_), .b(new_n405_), .c(x01), .O(z60));
  nand2  g261(.a(new_n379_), .b(new_n228_), .O(new_n413_));
  oai21  g262(.a(new_n242_), .b(x04), .c(new_n413_), .O(new_n414_));
  ...
  nand2  g268(.a(new_n399_), .b(x04), .O(new_n420_));
  nand3  g269(.a(x81), .b(x79), .c(new_n238_), .O(new_n421_));
  aoi21  g270(.a(new_n421_), .b(new_n420_), .c(new_n159_), .O(new_n422_));
  oai21  g271(.a(new_n422_), .b(new_n419_), .c(x78), .O(new_n423_));
  or2    g272(.a(new_n418_), .b(new_n167_), .O(new_n424_));
  ...
  nor2   g280(.a(new_n249_), .b(x78), .O(new_n432_));
