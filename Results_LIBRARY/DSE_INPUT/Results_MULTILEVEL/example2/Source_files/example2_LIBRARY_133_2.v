// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:37 2020
...
module FAU ( 
  ...
  nand4  g180(.a(new_n228_), .b(new_n160_), .c(x77), .d(x68), .O(new_n332_));
  aoi21  g181(.a(new_n332_), .b(new_n331_), .c(x01), .O(z48));
  nand2  g182(.a(x52), .b(x17), .O(new_n334_));
  nand2  g183(.a(new_n320_), .b(x09), .O(new_n335_));
  aoi21  g184(.a(new_n335_), .b(new_n334_), .c(x79), .O(new_n336_));
  nand4  g185(.a(new_n336_), .b(x78), .c(new_n159_), .d(x04), .O(new_n337_));
  nand4  g186(.a(new_n228_), .b(x79), .c(new_n160_), .d(x77), .O(new_n338_));
  inv1   g187(.a(new_n338_), .O(new_n339_));
  nand2  g188(.a(new_n339_), .b(x69), .O(new_n340_));
  aoi21  g189(.a(new_n340_), .b(new_n337_), .c(x01), .O(z49));
  ...
  nand2  g194(.a(new_n339_), .b(x70), .O(new_n346_));
  ...
  nand2  g200(.a(new_n339_), .b(x71), .O(new_n352_));
  ...
  nand2  g206(.a(new_n339_), .b(x72), .O(new_n358_));
  ...
  nand2  g212(.a(new_n339_), .b(x73), .O(new_n364_));
