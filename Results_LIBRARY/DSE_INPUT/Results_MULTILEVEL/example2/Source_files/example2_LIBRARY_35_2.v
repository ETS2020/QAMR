// Benchmark "FAU" written by ABC on Mon Jul 27 21:28:58 2020
...
module FAU ( 
  ...
  nand2  g202(.a(new_n333_), .b(x72), .O(new_n354_));
  nand3  g203(.a(x52), .b(x20), .c(x04), .O(new_n355_));
  inv1   g204(.a(new_n355_), .O(new_n356_));
  nand4  g205(.a(new_n356_), .b(new_n154_), .c(x78), .d(new_n159_), .O(new_n357_));
  aoi21  g206(.a(new_n357_), .b(new_n354_), .c(x01), .O(z52));
  ...
  nand2  g211(.a(new_n333_), .b(x73), .O(new_n363_));
