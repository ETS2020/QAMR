// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:13 2020
...
module FAU ( 
  ...
  aoi22  g014(.a(new_n165_), .b(new_n154_), .c(x78), .d(x77), .O(new_n166_));
  ...
  oai21  g020(.a(new_n171_), .b(new_n168_), .c(new_n170_), .O(new_n172_));
  ...
  nand2  g229(.a(new_n171_), .b(new_n380_), .O(new_n381_));
  nand3  g230(.a(new_n381_), .b(new_n379_), .c(x79), .O(new_n382_));
  nand2  g231(.a(new_n163_), .b(new_n159_), .O(new_n383_));
  nand4  g232(.a(new_n383_), .b(new_n382_), .c(new_n153_), .d(x00), .O(z56));
  inv1   g233(.a(x02), .O(new_n385_));
  nand4  g234(.a(x03), .b(new_n385_), .c(new_n153_), .d(x00), .O(new_n386_));
  inv1   g235(.a(new_n386_), .O(z57));
  nand4  g236(.a(x80), .b(new_n234_), .c(x43), .d(new_n248_), .O(new_n388_));
  oai22  g237(.a(new_n388_), .b(new_n237_), .c(new_n248_), .d(x40), .O(new_n389_));
  nand4  g238(.a(new_n389_), .b(x79), .c(x78), .d(x04), .O(new_n390_));
  nor2   g239(.a(x79), .b(x78), .O(new_n391_));
  nand3  g240(.a(new_n391_), .b(new_n248_), .c(x40), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(new_n390_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(x77), .O(new_n394_));
  oai21  g243(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  aoi21  g244(.a(new_n395_), .b(new_n394_), .c(x01), .O(z58));
  oai21  g245(.a(new_n164_), .b(new_n391_), .c(x40), .O(new_n397_));
  oai21  g246(.a(new_n237_), .b(new_n235_), .c(new_n248_), .O(new_n398_));
  ...
  nand2  g251(.a(new_n154_), .b(new_n160_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n402_), .c(x01), .O(z59));
  nand3  g253(.a(new_n403_), .b(new_n382_), .c(new_n240_), .O(new_n405_));
  and2   g254(.a(new_n405_), .b(new_n153_), .O(z60));
  nand2  g255(.a(new_n381_), .b(new_n232_), .O(new_n407_));
  oai21  g256(.a(new_n244_), .b(x04), .c(new_n407_), .O(new_n408_));
  ...
  nand2  g262(.a(new_n399_), .b(x04), .O(new_n414_));
  ...
  or2    g266(.a(new_n412_), .b(new_n171_), .O(new_n418_));
  aoi21  g267(.a(new_n418_), .b(new_n417_), .c(x01), .O(z62));
  nand4  g268(.a(new_n408_), .b(x82), .c(x79), .d(new_n153_), .O(new_n420_));
  inv1   g269(.a(new_n420_), .O(z63));
  nand3  g270(.a(new_n408_), .b(x83), .c(x79), .O(new_n422_));
  nand4  g271(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n423_));
  aoi21  g272(.a(new_n423_), .b(new_n422_), .c(x01), .O(z64));
  nor2   g273(.a(new_n163_), .b(x04), .O(new_n425_));
  nor2   g274(.a(new_n251_), .b(x78), .O(new_n426_));
  oai21  g275(.a(new_n426_), .b(new_n425_), .c(x77), .O(new_n427_));
  nand3  g276(.a(x81), .b(x78), .c(new_n159_), .O(new_n428_));
  nand2  g277(.a(new_n428_), .b(new_n427_), .O(new_n429_));
  nand4  g278(.a(new_n429_), .b(x84), .c(x79), .d(new_n153_), .O(new_n430_));
  inv1   g279(.a(new_n430_), .O(z65));
endmodule
