...
module FAU ( 
  ...
  nand3  g092(.a(new_n243_), .b(new_n154_), .c(x05), .O(new_n244_));
  nand3  g093(.a(new_n244_), .b(new_n153_), .c(x00), .O(z23));
  inv1   g094(.a(new_n166_), .O(new_n246_));
  oai21  g095(.a(new_n246_), .b(x43), .c(x79), .O(new_n247_));
  nand4  g096(.a(new_n247_), .b(x05), .c(new_n160_), .d(new_n153_), .O(new_n248_));
  inv1   g097(.a(new_n248_), .O(z24));
  ...
  nor2   g138(.a(new_n237_), .b(new_n250_), .O(new_n290_));
  ...
  nand4  g224(.a(new_n243_), .b(x79), .c(x78), .d(x77), .O(new_n376_));
  nor2   g225(.a(new_n376_), .b(x80), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(new_n253_), .O(new_n378_));
  nor4   g227(.a(new_n378_), .b(new_n375_), .c(new_n237_), .d(x82), .O(z55));
  nand2  g228(.a(new_n246_), .b(x76), .O(new_n380_));
  ...
  nand4  g241(.a(x80), .b(new_n235_), .c(x43), .d(new_n250_), .O(new_n393_));
  ...
  nand3  g245(.a(new_n396_), .b(new_n250_), .c(x40), .O(new_n397_));
  ...
  oai21  g251(.a(new_n238_), .b(new_n236_), .c(new_n250_), .O(new_n403_));
  ...
  oai21  g263(.a(new_n246_), .b(x04), .c(new_n414_), .O(new_n415_));
  ...
  nor2   g281(.a(new_n253_), .b(x78), .O(new_n433_));
