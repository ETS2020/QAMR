...
module FAU ( 
  ...
  nand3  g092(.a(new_n243_), .b(new_n238_), .c(new_n153_), .O(new_n244_));
  ...
  inv1   g225(.a(new_n241_), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(x76), .O(new_n378_));
  ...
  aoi21  g253(.a(new_n404_), .b(new_n239_), .c(x01), .O(z59));
  nand2  g254(.a(new_n381_), .b(x79), .O(new_n406_));
  nand3  g255(.a(new_n406_), .b(new_n239_), .c(new_n236_), .O(new_n407_));
  and2   g256(.a(new_n407_), .b(new_n153_), .O(z60));
  nand2  g257(.a(new_n167_), .b(new_n379_), .O(new_n409_));
  nand2  g258(.a(new_n409_), .b(new_n228_), .O(new_n410_));
  oai21  g259(.a(new_n377_), .b(x04), .c(new_n410_), .O(new_n411_));
  ...
  nand2  g265(.a(new_n401_), .b(x04), .O(new_n417_));
