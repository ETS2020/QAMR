// Benchmark "FAU" written by ABC on Mon Jul 27 21:29:50 2020
...
module FAU ( 
  ...
  nand2  g162(.a(new_n294_), .b(new_n292_), .O(new_n314_));
  nand4  g163(.a(new_n314_), .b(x78), .c(x77), .d(x61), .O(new_n315_));
