...
module FAU ( 
  ...
  nand2  g205(.a(new_n336_), .b(x72), .O(new_n357_));
  nor2   g206(.a(x79), .b(new_n163_), .O(new_n358_));
  nand3  g207(.a(x52), .b(x20), .c(x04), .O(new_n359_));
  inv1   g208(.a(new_n359_), .O(new_n360_));
  nand3  g209(.a(new_n360_), .b(new_n358_), .c(new_n159_), .O(new_n361_));
  ...
  nand3  g277(.a(new_n358_), .b(new_n159_), .c(x04), .O(new_n429_));
