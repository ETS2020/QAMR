...
module FAU ( 
  ...
  nand4  g175(.a(new_n233_), .b(x79), .c(new_n163_), .d(x77), .O(new_n327_));
  inv1   g176(.a(new_n327_), .O(new_n328_));
  nand2  g177(.a(new_n328_), .b(x75), .O(new_n329_));
  ...
  nand2  g183(.a(new_n328_), .b(x68), .O(new_n335_));
  ...
  nand2  g189(.a(new_n328_), .b(x69), .O(new_n341_));
  ...
  nand2  g195(.a(new_n328_), .b(x70), .O(new_n347_));
  ...
  nand2  g201(.a(new_n328_), .b(x71), .O(new_n353_));
  ...
  nand2  g207(.a(new_n328_), .b(x72), .O(new_n359_));
  ...
  nand2  g213(.a(new_n328_), .b(x73), .O(new_n365_));
