// Benchmark "FAU" written by ABC on Mon Jul 27 21:30:23 2020
...
module FAU ( 
  ...
  oai21  g096(.a(x79), .b(new_n246_), .c(new_n247_), .O(new_n248_));
  nand4  g097(.a(new_n248_), .b(new_n245_), .c(new_n160_), .d(new_n153_), .O(new_n249_));
  inv1   g098(.a(new_n249_), .O(z24));
  ...
  nor4   g106(.a(new_n257_), .b(x42), .c(x04), .d(x01), .O(z25));
  inv1   g107(.a(x42), .O(new_n259_));
  inv1   g108(.a(new_n257_), .O(new_n260_));
  nand4  g109(.a(new_n260_), .b(x44), .c(new_n259_), .d(new_n160_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(x01), .O(z26));
  nand4  g111(.a(new_n260_), .b(x45), .c(new_n259_), .d(new_n160_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(x01), .O(z27));
  nand4  g113(.a(new_n260_), .b(x46), .c(new_n259_), .d(new_n160_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(x01), .O(z28));
  nand4  g115(.a(new_n260_), .b(x47), .c(new_n259_), .d(new_n160_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(x01), .O(z29));
  nand4  g117(.a(new_n260_), .b(x48), .c(new_n259_), .d(new_n160_), .O(new_n269_));
  nor2   g118(.a(new_n269_), .b(x01), .O(z30));
  nand4  g119(.a(new_n260_), .b(x49), .c(new_n259_), .d(new_n160_), .O(new_n271_));
  nor2   g120(.a(new_n271_), .b(x01), .O(z31));
  nand4  g121(.a(new_n260_), .b(x50), .c(new_n259_), .d(new_n160_), .O(new_n273_));
  nor2   g122(.a(new_n273_), .b(x01), .O(z32));
  xnor2a g123(.a(x83), .b(x81), .O(new_n275_));
  nand3  g124(.a(x81), .b(x51), .c(new_n259_), .O(new_n276_));
  oai21  g125(.a(new_n275_), .b(new_n259_), .c(new_n276_), .O(new_n277_));
  nand2  g126(.a(new_n277_), .b(new_n251_), .O(new_n278_));
  xor2a  g127(.a(x83), .b(x81), .O(new_n279_));
  nand3  g128(.a(new_n253_), .b(x51), .c(new_n259_), .O(new_n280_));
  oai21  g129(.a(new_n279_), .b(new_n259_), .c(new_n280_), .O(new_n281_));
  nand2  g130(.a(new_n281_), .b(new_n254_), .O(new_n282_));
  aoi21  g131(.a(new_n282_), .b(new_n278_), .c(new_n154_), .O(new_n283_));
  nand4  g132(.a(new_n283_), .b(x78), .c(x77), .d(new_n160_), .O(new_n284_));
  nor2   g133(.a(new_n284_), .b(x01), .O(z33));
  nor2   g134(.a(new_n237_), .b(new_n259_), .O(new_n286_));
  ...
  nand3  g138(.a(x83), .b(new_n253_), .c(x42), .O(new_n290_));
  oai21  g139(.a(new_n286_), .b(new_n253_), .c(new_n290_), .O(new_n291_));
  nand2  g140(.a(new_n291_), .b(new_n251_), .O(new_n292_));
  aoi21  g141(.a(new_n292_), .b(new_n289_), .c(new_n154_), .O(new_n293_));
  ...
  nor2   g174(.a(new_n325_), .b(new_n232_), .O(new_n326_));
  nand4  g175(.a(new_n326_), .b(x79), .c(new_n163_), .d(x77), .O(new_n327_));
  ...
  nand4  g181(.a(new_n233_), .b(x79), .c(new_n163_), .d(x77), .O(new_n333_));
  ...
  nand2  g224(.a(new_n375_), .b(new_n253_), .O(new_n376_));
  nor4   g225(.a(new_n376_), .b(new_n372_), .c(new_n237_), .d(x82), .O(z55));
  inv1   g226(.a(new_n166_), .O(new_n378_));
  nand2  g227(.a(new_n378_), .b(x76), .O(new_n379_));
  inv1   g228(.a(new_n170_), .O(new_n380_));
  xnor2a g229(.a(x84), .b(x81), .O(new_n381_));
  aoi21  g230(.a(new_n172_), .b(new_n380_), .c(new_n381_), .O(new_n382_));
  ...
  nand4  g239(.a(x80), .b(new_n235_), .c(x43), .d(new_n259_), .O(new_n391_));
  oai22  g240(.a(new_n391_), .b(new_n238_), .c(new_n259_), .d(x40), .O(new_n392_));
  nand4  g241(.a(new_n392_), .b(x79), .c(x78), .d(x04), .O(new_n393_));
  nor2   g242(.a(x79), .b(x78), .O(new_n394_));
  nand3  g243(.a(new_n394_), .b(new_n259_), .c(x40), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n393_), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(x77), .O(new_n397_));
  oai21  g246(.a(new_n170_), .b(new_n160_), .c(new_n154_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n397_), .c(x01), .O(z58));
  oai21  g248(.a(new_n164_), .b(new_n394_), .c(x40), .O(new_n400_));
  oai21  g249(.a(new_n238_), .b(new_n236_), .c(new_n259_), .O(new_n401_));
  ...
  nand3  g257(.a(new_n408_), .b(new_n406_), .c(new_n241_), .O(new_n409_));
  and2   g258(.a(new_n409_), .b(new_n153_), .O(z60));
  nand2  g259(.a(new_n172_), .b(new_n380_), .O(new_n411_));
  nand2  g260(.a(new_n411_), .b(new_n233_), .O(new_n412_));
  oai21  g261(.a(new_n378_), .b(x04), .c(new_n412_), .O(new_n413_));
  ...
  or2    g271(.a(new_n417_), .b(new_n172_), .O(new_n423_));
