...
module FAU ( 
  ...
  aoi21  g183(.a(x52), .b(new_n334_), .c(x79), .O(new_n335_));
  nand4  g184(.a(new_n335_), .b(x78), .c(new_n159_), .d(x04), .O(new_n336_));
  nand4  g185(.a(new_n236_), .b(x79), .c(new_n164_), .d(x77), .O(new_n337_));
  ...
  nand2  g190(.a(new_n160_), .b(x09), .O(new_n342_));
  ...
  nand2  g196(.a(new_n160_), .b(x10), .O(new_n348_));
  ...
  nand2  g202(.a(new_n160_), .b(x11), .O(new_n354_));
  ...
  nand2  g208(.a(new_n160_), .b(x12), .O(new_n360_));
