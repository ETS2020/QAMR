...
module FAU ( 
  ...
  nand2  g190(.a(new_n333_), .b(x70), .O(new_n342_));
  inv1   g191(.a(x10), .O(new_n343_));
  nor2   g192(.a(x52), .b(new_n343_), .O(new_n344_));
  nor2   g193(.a(x79), .b(new_n160_), .O(new_n345_));
  nand4  g194(.a(new_n345_), .b(new_n344_), .c(new_n159_), .d(x04), .O(new_n346_));
  ...
  nand3  g274(.a(new_n345_), .b(new_n159_), .c(x04), .O(new_n426_));
