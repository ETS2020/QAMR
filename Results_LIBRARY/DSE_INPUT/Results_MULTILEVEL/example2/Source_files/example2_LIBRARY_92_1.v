...
module FAU ( 
  ...
  nand3  g079(.a(x81), .b(x80), .c(new_n230_), .O(new_n231_));
  inv1   g080(.a(x83), .O(new_n232_));
  nand3  g081(.a(x84), .b(new_n232_), .c(x82), .O(new_n233_));
  ...
  oai21  g139(.a(new_n270_), .b(new_n245_), .c(new_n290_), .O(new_n291_));
  nand2  g140(.a(new_n291_), .b(new_n246_), .O(new_n292_));
  aoi21  g141(.a(new_n292_), .b(new_n288_), .c(new_n154_), .O(new_n293_));
  ...
  nand4  g221(.a(new_n242_), .b(x79), .c(x78), .d(x77), .O(new_n373_));
  nor2   g222(.a(new_n373_), .b(x80), .O(new_n374_));
  nand2  g223(.a(new_n374_), .b(new_n248_), .O(new_n375_));
  nor4   g224(.a(new_n375_), .b(new_n372_), .c(new_n232_), .d(x82), .O(z55));
  nand2  g225(.a(x78), .b(x77), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(x76), .O(new_n378_));
  xnor2a g227(.a(x84), .b(x81), .O(new_n379_));
  aoi21  g228(.a(new_n167_), .b(new_n166_), .c(new_n379_), .O(new_n380_));
  ...
  nand3  g236(.a(x80), .b(new_n230_), .c(new_n245_), .O(new_n388_));
  nand4  g237(.a(x84), .b(new_n232_), .c(x82), .d(x81), .O(new_n389_));
  oai22  g238(.a(new_n389_), .b(new_n388_), .c(new_n245_), .d(x40), .O(new_n390_));
  nand4  g239(.a(new_n390_), .b(x79), .c(x78), .d(x04), .O(new_n391_));
  nor2   g240(.a(x79), .b(x78), .O(new_n392_));
  nand3  g241(.a(new_n392_), .b(new_n245_), .c(x40), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(new_n391_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(x77), .O(new_n395_));
  nand2  g244(.a(new_n166_), .b(x04), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(new_n154_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(new_n395_), .c(x01), .O(z58));
  nor2   g247(.a(new_n160_), .b(new_n238_), .O(new_n399_));
  oai21  g248(.a(new_n399_), .b(new_n392_), .c(x40), .O(new_n400_));
  oai21  g249(.a(new_n233_), .b(new_n231_), .c(new_n245_), .O(new_n401_));
  ...
  nand2  g254(.a(new_n154_), .b(new_n238_), .O(new_n406_));
  aoi21  g255(.a(new_n406_), .b(new_n405_), .c(x01), .O(z59));
  nand2  g256(.a(new_n380_), .b(x79), .O(new_n408_));
  nand3  g257(.a(new_n408_), .b(new_n406_), .c(new_n236_), .O(new_n409_));
  and2   g258(.a(new_n409_), .b(new_n153_), .O(z60));
  nand2  g259(.a(new_n167_), .b(new_n166_), .O(new_n411_));
  nand2  g260(.a(new_n411_), .b(new_n228_), .O(new_n412_));
  oai21  g261(.a(new_n377_), .b(x04), .c(new_n412_), .O(new_n413_));
  ...
  oai21  g265(.a(x79), .b(new_n238_), .c(new_n416_), .O(new_n417_));
  nand2  g266(.a(new_n417_), .b(new_n159_), .O(new_n418_));
  nor3   g267(.a(new_n248_), .b(new_n154_), .c(x04), .O(new_n419_));
  aoi21  g268(.a(new_n402_), .b(x04), .c(new_n419_), .O(new_n420_));
  oai21  g269(.a(new_n420_), .b(new_n159_), .c(new_n418_), .O(new_n421_));
  nand2  g270(.a(new_n421_), .b(x78), .O(new_n422_));
  or2    g271(.a(new_n416_), .b(new_n167_), .O(new_n423_));
  ...
  nor2   g279(.a(new_n248_), .b(x78), .O(new_n431_));
