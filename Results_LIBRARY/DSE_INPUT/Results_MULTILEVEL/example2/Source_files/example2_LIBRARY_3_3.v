...
module FAU ( 
  ...
  nand3  g084(.a(x81), .b(x80), .c(x43), .O(new_n236_));
  ...
  oai21  g142(.a(new_n273_), .b(new_n248_), .c(new_n293_), .O(new_n294_));
  nand2  g143(.a(new_n294_), .b(new_n249_), .O(new_n295_));
  aoi21  g144(.a(new_n295_), .b(new_n291_), .c(new_n154_), .O(new_n296_));
  ...
  nor2   g177(.a(new_n328_), .b(new_n233_), .O(new_n329_));
  ...
  nand2  g227(.a(new_n378_), .b(new_n251_), .O(new_n379_));
  nor4   g228(.a(new_n379_), .b(new_n375_), .c(new_n237_), .d(x82), .O(z55));
  nand2  g229(.a(new_n166_), .b(x76), .O(new_n381_));
  inv1   g230(.a(new_n171_), .O(new_n382_));
  xnor2a g231(.a(x84), .b(x81), .O(new_n383_));
  aoi21  g232(.a(new_n173_), .b(new_n382_), .c(new_n383_), .O(new_n384_));
  ...
  nand3  g241(.a(x80), .b(x43), .c(new_n248_), .O(new_n393_));
  nand4  g242(.a(x84), .b(new_n237_), .c(x82), .d(x81), .O(new_n394_));
  oai22  g243(.a(new_n394_), .b(new_n393_), .c(new_n248_), .d(x40), .O(new_n395_));
  nand4  g244(.a(new_n395_), .b(x79), .c(x78), .d(x04), .O(new_n396_));
  nor2   g245(.a(x79), .b(x78), .O(new_n397_));
  nand3  g246(.a(new_n397_), .b(new_n248_), .c(x40), .O(new_n398_));
  nand2  g247(.a(new_n398_), .b(new_n396_), .O(new_n399_));
  nand2  g248(.a(new_n399_), .b(x77), .O(new_n400_));
  oai21  g249(.a(new_n171_), .b(new_n160_), .c(new_n154_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(new_n400_), .c(x01), .O(z58));
  oai21  g251(.a(new_n164_), .b(new_n397_), .c(x40), .O(new_n403_));
  oai21  g252(.a(new_n238_), .b(new_n236_), .c(new_n248_), .O(new_n404_));
  ...
  nand3  g260(.a(new_n411_), .b(new_n409_), .c(new_n241_), .O(new_n412_));
  and2   g261(.a(new_n412_), .b(new_n153_), .O(z60));
  nand2  g262(.a(new_n173_), .b(new_n382_), .O(new_n414_));
  nand2  g263(.a(new_n414_), .b(new_n234_), .O(new_n415_));
  oai21  g264(.a(new_n166_), .b(x04), .c(new_n415_), .O(new_n416_));
  ...
  oai21  g268(.a(x79), .b(new_n160_), .c(new_n419_), .O(new_n420_));
  nand2  g269(.a(new_n420_), .b(new_n159_), .O(new_n421_));
  nor3   g270(.a(new_n251_), .b(new_n154_), .c(x04), .O(new_n422_));
  ...
  or2    g274(.a(new_n419_), .b(new_n173_), .O(new_n426_));
  ...
  nor2   g282(.a(new_n251_), .b(x78), .O(new_n434_));
