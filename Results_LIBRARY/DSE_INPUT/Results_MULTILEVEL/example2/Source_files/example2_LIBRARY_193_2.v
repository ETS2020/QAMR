// Benchmark "FAU" written by ABC on Mon Jul 27 21:30:01 2020
...
module FAU ( 
  ...
  oai21  g174(.a(new_n154_), .b(new_n165_), .c(new_n325_), .O(new_n326_));
  nand4  g175(.a(new_n326_), .b(new_n229_), .c(new_n160_), .d(x77), .O(new_n327_));
  ...
  nand4  g181(.a(new_n229_), .b(x79), .c(new_n160_), .d(x77), .O(new_n333_));
  ...
  nand4  g236(.a(x80), .b(new_n231_), .c(x43), .d(new_n247_), .O(new_n388_));
  oai22  g237(.a(new_n388_), .b(new_n234_), .c(new_n247_), .d(x40), .O(new_n389_));
  ...
  oai21  g243(.a(new_n166_), .b(new_n239_), .c(new_n154_), .O(new_n395_));
  aoi21  g244(.a(new_n395_), .b(new_n394_), .c(x01), .O(z58));
  nor2   g245(.a(new_n160_), .b(new_n239_), .O(new_n397_));
  oai21  g246(.a(new_n397_), .b(new_n391_), .c(x40), .O(new_n398_));
  oai21  g247(.a(new_n234_), .b(new_n232_), .c(new_n247_), .O(new_n399_));
  ...
  nand2  g252(.a(new_n154_), .b(new_n239_), .O(new_n404_));
  aoi21  g253(.a(new_n404_), .b(new_n403_), .c(x01), .O(z59));
  nand2  g254(.a(new_n380_), .b(x79), .O(new_n406_));
  nand3  g255(.a(new_n406_), .b(new_n404_), .c(new_n237_), .O(new_n407_));
  and2   g256(.a(new_n407_), .b(new_n153_), .O(z60));
  nand2  g257(.a(new_n168_), .b(new_n167_), .O(new_n409_));
  nand2  g258(.a(new_n409_), .b(new_n229_), .O(new_n410_));
  oai21  g259(.a(new_n243_), .b(x04), .c(new_n410_), .O(new_n411_));
  ...
  or2    g269(.a(new_n415_), .b(new_n168_), .O(new_n421_));
  ...
  nor2   g277(.a(new_n250_), .b(x78), .O(new_n429_));
