...
module FAU ( 
  ...
  nand3  g26(.a(new_n55_), .b(new_n34_), .c(x00), .O(new_n56_));
  inv1   g27(.a(new_n56_), .O(new_n57_));
  nor2   g28(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(new_n35_), .c(new_n51_), .d(x00), .O(z08));
  nand4  g30(.a(new_n52_), .b(new_n46_), .c(x09), .d(x04), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x12), .c(x11), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(new_n56_), .c(x10), .O(z09));
  inv1   g33(.a(x09), .O(new_n63_));
  nand4  g34(.a(new_n52_), .b(x12), .c(x11), .d(new_n51_), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n63_), .O(z10));
  nand4  g36(.a(new_n52_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  nand3  g37(.a(new_n55_), .b(new_n30_), .c(x00), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(x11), .c(new_n51_), .O(new_n69_));
  inv1   g40(.a(new_n69_), .O(z11));
  nand4  g41(.a(x12), .b(x11), .c(new_n51_), .d(new_n63_), .O(new_n71_));
