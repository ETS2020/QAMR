...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n37_, new_n38_,
    new_n40_, new_n41_, new_n45_, new_n46_, new_n49_, new_n51_, new_n52_,
  ...
  xnor2a g21(.a(x12), .b(x11), .O(new_n51_));
  nand3  g22(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(z09));
  inv1   g24(.a(x12), .O(new_n54_));
  nand4  g25(.a(x11), .b(new_n49_), .c(x09), .d(x00), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n54_), .O(z10));
  nand3  g27(.a(x12), .b(x09), .c(x01), .O(new_n57_));
  oai21  g28(.a(x12), .b(x01), .c(new_n57_), .O(new_n58_));
  nand4  g29(.a(new_n58_), .b(x11), .c(new_n49_), .d(x00), .O(new_n59_));
