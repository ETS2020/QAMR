...
module FAU ( 
  ...
  and2   g09(.a(x08), .b(x07), .O(new_n39_));
  nand4  g10(.a(new_n39_), .b(new_n38_), .c(x12), .d(x11), .O(z02));
  nand4  g11(.a(new_n38_), .b(x11), .c(x08), .d(x07), .O(new_n41_));
  nand3  g12(.a(new_n41_), .b(x12), .c(x11), .O(z03));
  inv1   g13(.a(x14), .O(z04));
  inv1   g14(.a(x13), .O(z05));
  nand3  g15(.a(x04), .b(x03), .c(x02), .O(new_n45_));
  nand2  g16(.a(new_n45_), .b(x09), .O(new_n46_));
  aoi21  g17(.a(new_n46_), .b(new_n35_), .c(new_n30_), .O(z06));
  inv1   g18(.a(x15), .O(z07));
  inv1   g19(.a(x10), .O(new_n49_));
  inv1   g20(.a(x12), .O(new_n50_));
  and2   g21(.a(x03), .b(x02), .O(new_n51_));
  nand3  g22(.a(x12), .b(x11), .c(x04), .O(new_n52_));
  inv1   g23(.a(new_n52_), .O(new_n53_));
  aoi22  g24(.a(new_n53_), .b(new_n51_), .c(new_n50_), .d(new_n34_), .O(new_n54_));
  nand4  g25(.a(new_n54_), .b(new_n35_), .c(new_n49_), .d(x00), .O(z08));
  nand2  g26(.a(new_n50_), .b(new_n34_), .O(new_n56_));
  nand3  g27(.a(new_n51_), .b(new_n45_), .c(x04), .O(new_n57_));
  ...
  nand4  g33(.a(new_n45_), .b(x12), .c(x11), .d(new_n49_), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n62_), .O(z10));
  nand3  g35(.a(new_n45_), .b(x12), .c(x01), .O(new_n65_));
  oai21  g36(.a(x12), .b(x01), .c(new_n65_), .O(new_n66_));
  nand4  g37(.a(new_n66_), .b(x11), .c(new_n49_), .d(x00), .O(new_n67_));
