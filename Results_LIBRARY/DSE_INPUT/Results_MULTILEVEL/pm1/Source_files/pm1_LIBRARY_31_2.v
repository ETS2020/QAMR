...
module FAU ( 
  ...
  nand3  g24(.a(new_n53_), .b(new_n51_), .c(x00), .O(new_n54_));
  ...
  nand4  g31(.a(new_n60_), .b(x11), .c(new_n51_), .d(x00), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z11));
  inv1   g33(.a(x09), .O(new_n63_));
  nand4  g34(.a(x11), .b(new_n51_), .c(new_n63_), .d(x00), .O(new_n64_));
  nor2   g35(.a(new_n64_), .b(new_n56_), .O(z12));
endmodule
