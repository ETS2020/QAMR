...
module FAU ( 
  ...
  aoi21  g20(.a(new_n49_), .b(new_n48_), .c(new_n46_), .O(z06));
  ...
  nand4  g28(.a(new_n57_), .b(new_n47_), .c(x09), .d(x04), .O(new_n58_));
  ...
  nand3  g35(.a(new_n47_), .b(x12), .c(x11), .O(new_n65_));
  nor4   g36(.a(new_n65_), .b(x10), .c(new_n46_), .d(new_n64_), .O(z10));
  inv1   g37(.a(x01), .O(new_n67_));
  nand4  g38(.a(new_n47_), .b(x12), .c(x11), .d(x09), .O(new_n68_));
  nand2  g39(.a(new_n38_), .b(new_n67_), .O(new_n69_));
  ...
  nand4  g43(.a(x11), .b(new_n52_), .c(new_n46_), .d(x00), .O(new_n73_));
  nor2   g44(.a(new_n73_), .b(new_n38_), .O(z12));
endmodule
