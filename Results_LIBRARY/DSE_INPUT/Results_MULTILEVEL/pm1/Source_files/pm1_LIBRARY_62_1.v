...
module FAU ( 
  ...
  nand2  g22(.a(x04), .b(x02), .O(new_n52_));
  ...
  nor2   g29(.a(new_n58_), .b(x02), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(x09), .c(x02), .O(new_n60_));
  ...
  nand4  g37(.a(new_n52_), .b(x12), .c(x11), .d(new_n50_), .O(new_n67_));
  ...
  nand4  g41(.a(new_n70_), .b(x11), .c(new_n50_), .d(x00), .O(new_n71_));
  inv1   g42(.a(new_n71_), .O(z11));
  nand4  g43(.a(x11), .b(new_n50_), .c(new_n66_), .d(x00), .O(new_n73_));
  nor2   g44(.a(new_n73_), .b(new_n51_), .O(z12));
endmodule
