...
module FAU ( 
  ...
  aoi21  g26(.a(new_n46_), .b(new_n34_), .c(new_n55_), .O(new_n56_));
  nand4  g27(.a(new_n56_), .b(new_n35_), .c(new_n52_), .d(x00), .O(z08));
  nand2  g28(.a(new_n46_), .b(new_n34_), .O(new_n58_));
  nand4  g29(.a(new_n53_), .b(new_n47_), .c(x09), .d(x04), .O(new_n59_));
  ...
  nand4  g36(.a(new_n53_), .b(x12), .c(x11), .d(new_n52_), .O(new_n66_));
  nor3   g37(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(z10));
  nand4  g38(.a(new_n46_), .b(x11), .c(new_n52_), .d(x00), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z11));
  nand4  g40(.a(x11), .b(new_n52_), .c(new_n65_), .d(x00), .O(new_n70_));
  nor2   g41(.a(new_n70_), .b(new_n46_), .O(z12));
endmodule
