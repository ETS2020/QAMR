...
module FAU ( 
  ...
  nand4  g060(.a(new_n112_), .b(x19), .c(x18), .d(new_n53_), .O(new_n113_));
  oai21  g061(.a(x28), .b(x19), .c(new_n113_), .O(z08));
  ...
  nand3  g066(.a(new_n118_), .b(x19), .c(new_n53_), .O(new_n119_));
  nand2  g067(.a(new_n112_), .b(new_n60_), .O(new_n120_));
  ...
  nand2  g074(.a(new_n116_), .b(new_n60_), .O(new_n127_));
  ...
  nand2  g080(.a(new_n123_), .b(new_n60_), .O(new_n133_));
  ...
  nand2  g095(.a(new_n136_), .b(new_n60_), .O(new_n148_));
  ...
  inv1   g105(.a(x28), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(x18), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g108(.a(new_n160_), .b(x19), .c(new_n53_), .O(new_n161_));
  nand2  g109(.a(new_n151_), .b(new_n60_), .O(new_n162_));
