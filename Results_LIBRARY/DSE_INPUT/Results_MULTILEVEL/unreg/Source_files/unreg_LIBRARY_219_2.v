// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:02 2020
...
module FAU ( 
  ...
  nand4  g087(.a(x19), .b(new_n54_), .c(new_n53_), .d(x15), .O(new_n140_));
  oai21  g088(.a(x32), .b(x19), .c(new_n140_), .O(z12));
  ...
  nand2  g102(.a(new_n143_), .b(new_n60_), .O(new_n155_));
