...
module FAU ( 
  ...
  oai21  g060(.a(x18), .b(new_n112_), .c(x29), .O(new_n113_));
  ...
  nand2  g071(.a(new_n123_), .b(new_n60_), .O(new_n124_));
  ...
  nand2  g078(.a(new_n119_), .b(new_n60_), .O(new_n131_));
  ...
  nand2  g109(.a(new_n115_), .b(x18), .O(new_n162_));
