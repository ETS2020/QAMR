// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:24 2020
...
module FAU ( 
  ...
  nand4  g068(.a(new_n120_), .b(x19), .c(x18), .d(new_n53_), .O(new_n121_));
  ...
  nand2  g075(.a(new_n120_), .b(new_n60_), .O(new_n128_));
