...
module FAU ( 
  ...
  nand2  g061(.a(new_n54_), .b(new_n113_), .O(new_n114_));
  nand4  g062(.a(new_n114_), .b(new_n112_), .c(x19), .d(new_n53_), .O(new_n115_));
  oai21  g063(.a(x28), .b(x19), .c(new_n115_), .O(z08));
  nand2  g064(.a(new_n54_), .b(x10), .O(new_n117_));
  inv1   g065(.a(x30), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(x19), .c(x18), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n53_), .O(new_n121_));
  nand2  g069(.a(new_n112_), .b(new_n60_), .O(new_n122_));
  ...
  inv1   g107(.a(x28), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(x18), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g110(.a(new_n162_), .b(x19), .c(new_n53_), .O(new_n163_));
  nand2  g111(.a(new_n153_), .b(new_n60_), .O(new_n164_));
