...
module FAU ( 
  ...
  oai21  g046(.a(x18), .b(x05), .c(x19), .O(new_n99_));
  oai22  g047(.a(new_n99_), .b(x17), .c(x26), .d(x19), .O(z06));
  nand3  g048(.a(x19), .b(new_n54_), .c(x04), .O(new_n101_));
  nand2  g049(.a(new_n61_), .b(x18), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g051(.a(new_n103_), .b(new_n53_), .O(new_n104_));
