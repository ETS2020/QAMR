// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:51 2020
...
module FAU ( 
  ...
  nand2  g043(.a(new_n84_), .b(new_n60_), .O(new_n96_));
  ...
  nand2  g050(.a(new_n92_), .b(new_n60_), .O(new_n103_));
  ...
  nand2  g056(.a(new_n99_), .b(new_n60_), .O(new_n109_));
  ...
  nand2  g071(.a(new_n112_), .b(new_n60_), .O(new_n124_));
  ...
  nand2  g084(.a(new_n127_), .b(new_n60_), .O(new_n137_));
  ...
  oai21  g089(.a(new_n141_), .b(new_n140_), .c(new_n53_), .O(new_n142_));
  aoi21  g090(.a(new_n142_), .b(x19), .c(x32), .O(z12));
  ...
  nand2  g097(.a(new_n149_), .b(new_n60_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n148_), .O(z13));
