...
module FAU ( 
  ...
  nand4  g031(.a(x19), .b(new_n54_), .c(new_n53_), .d(x07), .O(new_n84_));
  oai21  g032(.a(x24), .b(x19), .c(new_n84_), .O(z04));
  nand2  g033(.a(new_n54_), .b(x06), .O(new_n86_));
  ...
  nand2  g039(.a(new_n91_), .b(new_n60_), .O(new_n92_));
  ...
  nand2  g046(.a(new_n87_), .b(new_n60_), .O(new_n99_));
