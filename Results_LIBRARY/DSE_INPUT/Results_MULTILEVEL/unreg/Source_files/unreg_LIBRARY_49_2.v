// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:11 2020
...
module FAU ( 
  ...
  nand4  g081(.a(x19), .b(new_n54_), .c(new_n53_), .d(x08), .O(new_n134_));
  oai21  g082(.a(x31), .b(x19), .c(new_n134_), .O(z11));
