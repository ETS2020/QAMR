...
module FAU ( 
  ...
  oai21  g012(.a(x18), .b(new_n64_), .c(x22), .O(new_n65_));
  nand3  g013(.a(new_n65_), .b(x19), .c(new_n53_), .O(new_n66_));
  nand2  g014(.a(new_n56_), .b(new_n60_), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(new_n66_), .O(z01));
  ...
  nand2  g028(.a(new_n70_), .b(new_n60_), .O(new_n81_));
  ...
  nand2  g099(.a(new_n140_), .b(new_n60_), .O(new_n152_));
  ...
  nand2  g106(.a(new_n148_), .b(new_n60_), .O(new_n159_));
  ...
  nand2  g112(.a(new_n155_), .b(new_n60_), .O(new_n165_));
