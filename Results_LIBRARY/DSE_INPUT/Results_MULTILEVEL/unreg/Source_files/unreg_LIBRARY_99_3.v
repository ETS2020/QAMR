// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:26 2020
...
module FAU ( 
  ...
  oai21  g003(.a(x21), .b(new_n55_), .c(new_n54_), .O(new_n56_));
  ...
  nand2  g009(.a(new_n55_), .b(x02), .O(new_n62_));
  ...
  nand2  g017(.a(new_n55_), .b(x01), .O(new_n70_));
  ...
  nand2  g043(.a(new_n84_), .b(new_n58_), .O(new_n96_));
  nand2  g044(.a(new_n96_), .b(new_n95_), .O(z05));
  nand2  g045(.a(new_n55_), .b(x05), .O(new_n98_));
  ...
  nand2  g052(.a(new_n55_), .b(x04), .O(new_n105_));
  nand2  g053(.a(new_n59_), .b(x18), .O(new_n106_));
  nand2  g054(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g055(.a(new_n107_), .b(x19), .c(new_n53_), .O(new_n108_));
  nand2  g056(.a(new_n99_), .b(new_n58_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n108_), .O(z07));
  nand2  g058(.a(new_n55_), .b(x11), .O(new_n111_));
  ...
  nand2  g066(.a(new_n55_), .b(x10), .O(new_n119_));
  ...
  nand2  g073(.a(new_n55_), .b(x09), .O(new_n126_));
  ...
  nand2  g078(.a(new_n120_), .b(new_n58_), .O(new_n131_));
  nand2  g079(.a(new_n131_), .b(new_n130_), .O(z10));
  nand2  g080(.a(new_n55_), .b(x08), .O(new_n133_));
  ...
  nand2  g084(.a(new_n127_), .b(new_n58_), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n136_), .O(z11));
  nand2  g086(.a(new_n55_), .b(x15), .O(new_n139_));
  ...
  nand2  g094(.a(new_n55_), .b(x14), .O(new_n147_));
  ...
  nand2  g099(.a(new_n140_), .b(new_n58_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n151_), .O(z13));
  nand2  g101(.a(new_n55_), .b(x13), .O(new_n154_));
  ...
  nand2  g106(.a(new_n148_), .b(new_n58_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n158_), .O(z14));
  nand2  g108(.a(new_n55_), .b(x12), .O(new_n161_));
  ...
  nand2  g112(.a(new_n155_), .b(new_n58_), .O(new_n165_));
