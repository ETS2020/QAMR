// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:30 2020
...
module FAU ( 
  ...
  oai21  g075(.a(x31), .b(new_n54_), .c(new_n127_), .O(new_n128_));
  nand3  g076(.a(new_n128_), .b(x19), .c(new_n53_), .O(new_n129_));
  nand2  g077(.a(new_n121_), .b(new_n60_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n129_), .O(z10));
  nand2  g079(.a(new_n54_), .b(x08), .O(new_n132_));
  nand2  g080(.a(new_n89_), .b(x18), .O(new_n133_));
