// Benchmark "FAU" written by ABC on Mon Jul 27 19:01:30 2020
...
module FAU ( 
  ...
  nand4  g15(.a(new_n32_), .b(x9), .c(new_n24_), .d(x2), .O(new_n33_));
  ...
  nand2  g20(.a(new_n20_), .b(new_n24_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n37_), .c(x6), .O(z6));
endmodule
