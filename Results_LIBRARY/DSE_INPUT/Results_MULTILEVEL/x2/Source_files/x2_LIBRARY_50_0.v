...
module FAU ( 
  ...
  nand2  g10(.a(new_n23_), .b(x8), .O(new_n28_));
  oai21  g11(.a(x9), .b(new_n26_), .c(new_n20_), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(z3));
  nand3  g13(.a(new_n29_), .b(new_n28_), .c(x6), .O(z4));
  inv1   g14(.a(x0), .O(new_n32_));
  inv1   g15(.a(x1), .O(new_n33_));
  nand3  g16(.a(x2), .b(new_n33_), .c(new_n32_), .O(new_n34_));
  nand2  g17(.a(new_n20_), .b(x5), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(x9), .c(x8), .O(new_n37_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(new_n46_), .O(z6));
endmodule
