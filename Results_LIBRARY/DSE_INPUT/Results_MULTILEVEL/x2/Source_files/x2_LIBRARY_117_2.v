...
module FAU ( 
  ...
  nand3  g17(.a(new_n30_), .b(x9), .c(x2), .O(new_n35_));
  ...
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n22_), .d(x6), .O(z5));
  inv1   g24(.a(x5), .O(new_n42_));
  oai21  g25(.a(new_n24_), .b(new_n42_), .c(new_n22_), .O(new_n43_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n44_), .c(x6), .O(z6));
endmodule
