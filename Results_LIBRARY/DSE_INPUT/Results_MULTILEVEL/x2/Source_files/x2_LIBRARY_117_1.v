...
module FAU ( 
  ...
  nand3  g30(.a(x9), .b(x8), .c(x5), .O(new_n49_));
  oai21  g31(.a(x9), .b(x8), .c(new_n49_), .O(new_n50_));
  aoi21  g32(.a(new_n50_), .b(new_n21_), .c(new_n27_), .O(new_n51_));
  nand2  g33(.a(new_n51_), .b(new_n48_), .O(z6));
  one    g34(.O(z3));
endmodule
