// Benchmark "FAU" written by ABC on Mon Jul 27 19:01:53 2020
...
module FAU ( 
  ...
  nor2   g26(.a(new_n25_), .b(x7), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(x5), .c(new_n43_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n38_), .O(z5));
  nor2   g29(.a(x9), .b(x8), .O(new_n47_));
  and2   g30(.a(x8), .b(x5), .O(new_n48_));
