...
module FAU ( 
  ...
  nor2   g117(.a(z3), .b(new_n132_), .O(new_n134_));
  ...
  nand2  g136(.a(new_n33_), .b(new_n26_), .O(new_n153_));
  nand3  g137(.a(x7), .b(new_n17_), .c(x3), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n153_), .c(new_n59_), .O(new_n155_));
  aoi21  g139(.a(x3), .b(x1), .c(x2), .O(new_n156_));
  oai21  g140(.a(new_n156_), .b(new_n26_), .c(x4), .O(new_n157_));
  oai21  g141(.a(new_n26_), .b(new_n18_), .c(x8), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(new_n17_), .c(new_n58_), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n157_), .c(new_n23_), .O(new_n160_));
  oai21  g144(.a(new_n160_), .b(new_n155_), .c(new_n43_), .O(new_n161_));
  oai21  g145(.a(x4), .b(x2), .c(x5), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(x3), .O(new_n163_));
  aoi22  g147(.a(new_n33_), .b(new_n17_), .c(new_n23_), .d(x2), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n163_), .c(new_n26_), .O(new_n165_));
  nor2   g149(.a(x8), .b(x5), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n165_), .c(x1), .O(new_n167_));
  nand3  g151(.a(x8), .b(new_n26_), .c(x5), .O(new_n168_));
  inv1   g152(.a(new_n168_), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n34_), .c(x2), .O(new_n170_));
  oai21  g154(.a(x8), .b(x5), .c(new_n170_), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(x4), .c(x3), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(new_n167_), .c(new_n161_), .O(new_n173_));
  aoi21  g157(.a(new_n152_), .b(x6), .c(new_n173_), .O(new_n174_));
  nor2   g158(.a(new_n174_), .b(new_n20_), .O(z4));
  xor2a  g159(.a(x2), .b(x0), .O(new_n176_));
  nor2   g160(.a(new_n176_), .b(new_n134_), .O(z5));
endmodule
