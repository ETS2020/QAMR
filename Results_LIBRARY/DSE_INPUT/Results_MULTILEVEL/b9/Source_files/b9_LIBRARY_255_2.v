...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n172_, new_n174_, new_n176_, new_n178_, new_n180_, new_n181_,
  ...
  inv1   g030(.a(new_n84_), .O(new_n93_));
  ...
  nand4  g074(.a(new_n136_), .b(x35), .c(new_n83_), .d(x27), .O(new_n137_));
  ...
  nor2   g081(.a(new_n92_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nand2  g083(.a(z08), .b(new_n65_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n71_), .c(new_n70_), .O(new_n147_));
  nand3  g085(.a(x40), .b(x39), .c(new_n65_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n64_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n145_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n92_), .O(new_n153_));
  ...
  nand3  g097(.a(new_n125_), .b(new_n151_), .c(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n162_));
  nand4  g100(.a(new_n152_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n163_));
  ...
  oai21  g108(.a(new_n144_), .b(new_n73_), .c(new_n164_), .O(new_n171_));
  oai21  g109(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n172_));
  ...
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n132_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n64_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n93_), .c(x30), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n181_), .c(new_n131_), .O(z18));
  inv1   g122(.a(new_n132_), .O(new_n185_));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n135_), .O(new_n186_));
  aoi21  g124(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n186_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n81_), .c(new_n131_), .O(new_n189_));
