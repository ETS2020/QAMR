...
module FAU ( 
  ...
  nand3  g098(.a(new_n156_), .b(new_n71_), .c(new_n70_), .O(new_n161_));
  nand3  g099(.a(x39), .b(new_n141_), .c(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n64_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n161_), .c(new_n160_), .d(new_n157_), .O(z14));
  ...
  oai21  g109(.a(new_n85_), .b(x27), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  inv1   g111(.a(new_n85_), .O(new_n174_));
  nor2   g112(.a(new_n64_), .b(x04), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(x30), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n173_), .c(new_n126_), .O(z18));
  oai21  g115(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n178_));
  oai21  g116(.a(new_n84_), .b(x27), .c(x35), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n128_), .O(new_n180_));
  nand2  g118(.a(new_n76_), .b(new_n66_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n178_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n82_), .c(new_n126_), .O(new_n183_));
