...
module FAU ( 
  ...
  nand3  g070(.a(new_n90_), .b(x27), .c(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n82_), .c(new_n129_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nor2   g075(.a(x37), .b(x36), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n139_));
  ...
  aoi21  g082(.a(new_n144_), .b(x28), .c(new_n76_), .O(new_n145_));
  ...
  nand3  g089(.a(new_n123_), .b(new_n143_), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand3  g091(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n154_));
  nand4  g092(.a(new_n144_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n155_));
  ...
  nand3  g098(.a(new_n160_), .b(new_n83_), .c(new_n82_), .O(new_n161_));
  ...
  nand2  g109(.a(new_n90_), .b(new_n64_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n130_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n133_), .c(new_n82_), .d(new_n129_), .O(z18));
  inv1   g113(.a(new_n130_), .O(new_n176_));
  oai21  g114(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n177_));
  aoi21  g115(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n177_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n82_), .c(new_n129_), .O(new_n180_));
