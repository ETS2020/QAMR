...
module FAU ( 
  ...
  nor2   g067(.a(new_n66_), .b(x28), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x27), .c(new_n65_), .O(new_n131_));
  ...
  nand3  g088(.a(new_n119_), .b(new_n141_), .c(new_n65_), .O(new_n151_));
  ...
  oai21  g106(.a(new_n84_), .b(x27), .c(new_n126_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n131_), .c(new_n81_), .d(new_n125_), .O(z18));
  inv1   g109(.a(new_n126_), .O(new_n172_));
  oai21  g110(.a(new_n66_), .b(new_n64_), .c(new_n129_), .O(new_n173_));
  aoi21  g111(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n125_), .O(new_n176_));
