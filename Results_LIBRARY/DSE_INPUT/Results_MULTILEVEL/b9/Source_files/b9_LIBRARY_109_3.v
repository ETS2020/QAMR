...
module FAU ( 
  ...
  nand2  g096(.a(x20), .b(new_n153_), .O(new_n159_));
  ...
  nand2  g106(.a(new_n72_), .b(x27), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n75_), .c(x18), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n168_), .c(new_n167_), .d(new_n164_), .O(z14));
  ...
  oai21  g115(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  inv1   g117(.a(new_n84_), .O(new_n180_));
  nor2   g118(.a(new_n64_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(x30), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n179_), .c(new_n127_), .O(z18));
  inv1   g121(.a(new_n128_), .O(new_n184_));
  oai21  g122(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n81_), .c(new_n127_), .O(new_n188_));
