...
module FAU ( 
  ...
  nor3   g014(.a(new_n76_), .b(new_n75_), .c(x04), .O(new_n77_));
  ...
  nand2  g053(.a(new_n112_), .b(x07), .O(new_n116_));
  ...
  nor2   g058(.a(new_n120_), .b(new_n76_), .O(new_n121_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n83_), .c(new_n128_), .O(new_n130_));
  nand2  g068(.a(x40), .b(x04), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(x35), .c(new_n82_), .d(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n90_), .O(new_n133_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n64_), .c(new_n75_), .O(new_n138_));
  nand2  g076(.a(new_n131_), .b(x39), .O(new_n139_));
  ...
  nand3  g091(.a(new_n121_), .b(new_n144_), .c(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n153_), .O(z13));
  nand3  g093(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n156_));
  nand4  g094(.a(new_n146_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n157_));
  nand2  g095(.a(new_n144_), .b(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x40), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n157_), .c(z08), .O(new_n160_));
  ...
  nand3  g101(.a(new_n163_), .b(new_n81_), .c(new_n80_), .O(new_n164_));
  nor2   g102(.a(new_n145_), .b(x27), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n73_), .c(new_n158_), .O(new_n166_));
  oai21  g104(.a(new_n73_), .b(new_n64_), .c(new_n112_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .d(new_n161_), .O(z14));
  ...
  oai21  g112(.a(new_n83_), .b(x27), .c(new_n128_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  inv1   g114(.a(new_n83_), .O(new_n177_));
  ...
  oai21  g119(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n181_), .c(new_n182_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n80_), .c(new_n127_), .O(new_n185_));
