...
module FAU ( 
  ...
  oai21  g067(.a(new_n64_), .b(new_n65_), .c(x35), .O(new_n130_));
  nand2  g068(.a(z08), .b(x29), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  oai21  g070(.a(new_n75_), .b(new_n90_), .c(x28), .O(new_n133_));
  nand2  g071(.a(x35), .b(x27), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(x04), .c(new_n90_), .O(new_n135_));
  ...
  oai21  g109(.a(new_n84_), .b(x27), .c(new_n131_), .O(new_n172_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n173_), .c(new_n129_), .O(z18));
  nand2  g115(.a(new_n134_), .b(new_n90_), .O(new_n178_));
  oai21  g116(.a(new_n83_), .b(x27), .c(x35), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n75_), .O(new_n180_));
  nand2  g118(.a(new_n66_), .b(new_n91_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n178_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n81_), .c(new_n129_), .O(new_n183_));
