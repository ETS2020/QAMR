// Benchmark "FAU" written by ABC on Mon Jul 27 18:20:19 2020
...
module FAU ( 
  ...
  nand3  g087(.a(new_n119_), .b(new_n140_), .c(new_n65_), .O(new_n150_));
  ...
  oai21  g107(.a(new_n84_), .b(x27), .c(new_n126_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n131_), .c(new_n81_), .d(new_n125_), .O(z18));
  inv1   g110(.a(new_n126_), .O(new_n173_));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n129_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n81_), .c(new_n125_), .O(new_n177_));
