...
module FAU ( 
  ...
  nand2  g004(.a(x39), .b(x36), .O(new_n67_));
  nand2  g005(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g006(.a(new_n68_), .b(x40), .c(new_n65_), .O(new_n69_));
  ...
  nand3  g028(.a(new_n90_), .b(x39), .c(new_n89_), .O(new_n91_));
  ...
  nand3  g054(.a(new_n116_), .b(x40), .c(x05), .O(new_n117_));
  ...
  nor2   g063(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x39), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n123_), .c(new_n65_), .O(new_n129_));
  ...
  oai22  g072(.a(new_n134_), .b(new_n84_), .c(new_n119_), .d(new_n133_), .O(new_n135_));
  ...
  nand3  g076(.a(new_n138_), .b(new_n135_), .c(x39), .O(new_n139_));
  ...
  nor2   g082(.a(new_n144_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(new_n151_), .d(new_n65_), .O(new_n153_));
  ...
  nand4  g096(.a(new_n126_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand3  g098(.a(x40), .b(new_n151_), .c(new_n65_), .O(new_n161_));
  ...
  aoi21  g102(.a(new_n164_), .b(x39), .c(x37), .O(new_n165_));
  ...
  nor2   g109(.a(new_n125_), .b(x04), .O(new_n172_));
  ...
  oai22  g119(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n133_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n137_), .c(new_n81_), .d(new_n132_), .O(z18));
  nor2   g122(.a(new_n119_), .b(new_n133_), .O(new_n185_));
  oai22  g123(.a(new_n144_), .b(new_n136_), .c(new_n66_), .d(new_n64_), .O(new_n186_));
