...
module FAU ( 
  ...
  oai21  g005(.a(x36), .b(new_n66_), .c(new_n67_), .O(new_n68_));
  ...
  oai21  g022(.a(new_n66_), .b(x28), .c(new_n84_), .O(new_n85_));
  ...
  nor2   g057(.a(x40), .b(new_n117_), .O(new_n120_));
  aoi21  g058(.a(new_n119_), .b(new_n85_), .c(new_n120_), .O(new_n121_));
  ...
  oai21  g062(.a(new_n121_), .b(new_n64_), .c(new_n124_), .O(new_n125_));
  ...
  oai21  g068(.a(new_n64_), .b(new_n65_), .c(new_n90_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  inv1   g070(.a(x28), .O(new_n133_));
  nand2  g071(.a(x40), .b(x04), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(x35), .c(new_n133_), .d(x27), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n82_), .c(new_n129_), .O(new_n138_));
  ...
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n76_), .O(new_n151_));
  ...
  nand3  g095(.a(new_n123_), .b(new_n149_), .c(new_n65_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n160_));
  nand4  g098(.a(new_n150_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n161_));
  ...
  oai22  g107(.a(new_n73_), .b(new_n64_), .c(new_n76_), .d(new_n75_), .O(new_n170_));
  ...
  nand2  g115(.a(new_n90_), .b(new_n64_), .O(new_n178_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n90_), .c(x30), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n180_), .c(new_n129_), .O(z18));
  inv1   g121(.a(new_n130_), .O(new_n184_));
  oai21  g122(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n82_), .c(new_n129_), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z20));
  inv1   g127(.a(new_n138_), .O(z19));
endmodule
