...
module FAU ( 
  ...
  nand2  g068(.a(x39), .b(x04), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(x35), .c(new_n83_), .d(x27), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n91_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n81_), .c(new_n127_), .O(new_n135_));
  inv1   g073(.a(new_n135_), .O(z11));
  inv1   g074(.a(x10), .O(new_n137_));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  nor2   g076(.a(new_n119_), .b(x27), .O(new_n139_));
  ...
  inv1   g080(.a(new_n131_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n75_), .c(new_n64_), .O(new_n144_));
  ...
  nand3  g093(.a(new_n121_), .b(new_n146_), .c(new_n65_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n155_), .O(z13));
  nand3  g095(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n158_));
  nand4  g096(.a(new_n148_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n159_));
  nand2  g097(.a(new_n146_), .b(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x39), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(z08), .O(new_n162_));
  ...
  nand3  g103(.a(new_n165_), .b(new_n82_), .c(new_n81_), .O(new_n166_));
  oai21  g104(.a(new_n139_), .b(new_n73_), .c(new_n160_), .O(new_n167_));
  oai21  g105(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n163_), .O(z14));
  ...
  oai21  g113(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n176_));
  ...
  nand3  g118(.a(new_n180_), .b(new_n177_), .c(new_n127_), .O(z18));
  inv1   g119(.a(new_n128_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n81_), .c(new_n127_), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z20));
  inv1   g125(.a(new_n135_), .O(z19));
endmodule
