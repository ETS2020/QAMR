...
module FAU ( 
  ...
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n138_), .O(new_n148_));
  ...
  nand4  g095(.a(new_n147_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n158_));
  ...
  oai21  g104(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n167_));
  ...
  oai21  g112(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n131_), .c(new_n81_), .d(new_n127_), .O(z18));
  inv1   g115(.a(new_n128_), .O(new_n178_));
  oai21  g116(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n179_));
  aoi21  g117(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n178_), .c(new_n179_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n81_), .c(new_n127_), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z20));
  inv1   g121(.a(new_n134_), .O(z19));
endmodule
