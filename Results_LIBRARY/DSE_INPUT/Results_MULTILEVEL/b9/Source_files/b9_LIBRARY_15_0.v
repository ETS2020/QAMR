...
module FAU ( 
  ...
  aoi21  g027(.a(new_n84_), .b(x04), .c(new_n75_), .O(new_n90_));
  oai21  g028(.a(new_n89_), .b(x02), .c(new_n90_), .O(z02));
  ...
  nand2  g050(.a(new_n75_), .b(x07), .O(new_n113_));
  nand3  g051(.a(x40), .b(x39), .c(x05), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n85_), .c(x27), .O(new_n116_));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n126_), .c(new_n125_), .O(new_n129_));
  nor3   g067(.a(new_n129_), .b(x30), .c(x09), .O(z11));
  nor2   g068(.a(x37), .b(x36), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n66_), .c(new_n64_), .O(new_n132_));
  nand2  g070(.a(new_n72_), .b(x27), .O(new_n133_));
  oai21  g071(.a(new_n75_), .b(x04), .c(new_n133_), .O(new_n134_));
  ...
  aoi21  g076(.a(new_n138_), .b(x28), .c(new_n137_), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x39), .c(new_n136_), .d(new_n65_), .O(new_n140_));
  inv1   g078(.a(x18), .O(new_n141_));
  inv1   g079(.a(x19), .O(new_n142_));
  nand4  g080(.a(new_n72_), .b(x20), .c(new_n142_), .d(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n119_), .b(new_n136_), .c(new_n65_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n145_), .O(z13));
  nand3  g085(.a(x20), .b(new_n142_), .c(new_n141_), .O(new_n148_));
  nand4  g086(.a(new_n138_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n149_));
  inv1   g087(.a(new_n149_), .O(new_n150_));
  nand3  g088(.a(z08), .b(new_n136_), .c(new_n65_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n148_), .O(new_n152_));
  nand3  g090(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n82_), .c(new_n81_), .O(new_n155_));
  nand2  g093(.a(new_n151_), .b(new_n133_), .O(new_n156_));
  ...
  inv1   g101(.a(x09), .O(new_n164_));
  nand3  g102(.a(new_n127_), .b(x35), .c(new_n83_), .O(new_n165_));
  nand2  g103(.a(new_n89_), .b(z08), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n165_), .c(new_n81_), .d(new_n164_), .O(z18));
  inv1   g105(.a(new_n126_), .O(new_n168_));
  oai21  g106(.a(new_n66_), .b(new_n64_), .c(new_n125_), .O(new_n169_));
  aoi21  g107(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n81_), .c(new_n164_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(z20));
  nor3   g111(.a(new_n129_), .b(x30), .c(x09), .O(z19));
endmodule
