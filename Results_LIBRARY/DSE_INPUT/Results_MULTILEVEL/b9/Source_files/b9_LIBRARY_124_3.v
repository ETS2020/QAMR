...
module FAU ( 
  ...
  aoi21  g018(.a(new_n68_), .b(x27), .c(x32), .O(new_n81_));
  aoi21  g019(.a(new_n67_), .b(x28), .c(new_n81_), .O(new_n82_));
  oai21  g020(.a(new_n82_), .b(x30), .c(x04), .O(z01));
  ...
  nand3  g028(.a(new_n90_), .b(new_n86_), .c(z08), .O(z02));
  ...
  nand2  g050(.a(new_n89_), .b(new_n67_), .O(new_n113_));
  ...
  nand4  g069(.a(x35), .b(new_n88_), .c(x27), .d(new_n65_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n127_), .c(new_n126_), .O(new_n135_));
  ...
  nand3  g089(.a(new_n120_), .b(new_n142_), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand3  g091(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n154_));
  nand3  g092(.a(new_n144_), .b(new_n127_), .c(x28), .O(new_n155_));
  ...
  nand2  g098(.a(new_n160_), .b(new_n127_), .O(new_n161_));
  ...
  oai21  g107(.a(new_n89_), .b(x27), .c(new_n128_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n132_), .c(new_n127_), .d(new_n126_), .O(z18));
  ...
  nand3  g114(.a(new_n176_), .b(new_n127_), .c(new_n126_), .O(new_n177_));
