...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n86_, new_n87_, new_n89_, new_n91_, new_n92_, new_n94_, new_n98_,
  ...
  oai21  g026(.a(new_n84_), .b(new_n64_), .c(x04), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(z08), .c(x02), .O(z02));
  ...
  nand2  g049(.a(new_n75_), .b(x07), .O(new_n112_));
  nand3  g050(.a(x40), .b(x39), .c(x05), .O(new_n113_));
  nand2  g051(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(new_n85_), .c(x27), .O(new_n115_));
  ...
  nand2  g064(.a(new_n64_), .b(new_n126_), .O(new_n127_));
  nand4  g065(.a(new_n127_), .b(new_n125_), .c(x35), .d(new_n83_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n81_), .c(new_n124_), .O(new_n129_));
  ...
  nand3  g082(.a(new_n118_), .b(new_n135_), .c(new_n65_), .O(new_n145_));
  ...
  nand3  g092(.a(z08), .b(new_n135_), .c(new_n65_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n71_), .c(new_n70_), .O(new_n156_));
  nand4  g094(.a(x40), .b(x39), .c(new_n135_), .d(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n64_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(new_n151_), .O(z14));
  ...
  oai21  g104(.a(x27), .b(new_n126_), .c(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(x35), .c(new_n83_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n81_), .c(new_n124_), .O(z18));
