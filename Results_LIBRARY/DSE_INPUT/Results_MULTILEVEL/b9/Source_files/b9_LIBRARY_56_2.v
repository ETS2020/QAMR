...
module FAU ( 
  ...
  nand2  g020(.a(new_n68_), .b(x27), .O(new_n83_));
  ...
  nand4  g049(.a(new_n68_), .b(x40), .c(x39), .d(x05), .O(new_n112_));
  oai21  g050(.a(new_n66_), .b(x28), .c(new_n67_), .O(new_n113_));
  nand3  g051(.a(new_n113_), .b(new_n75_), .c(x07), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n112_), .c(new_n64_), .O(new_n115_));
  ...
  nand4  g085(.a(x27), .b(x20), .c(new_n139_), .d(new_n138_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n73_), .c(new_n142_), .O(new_n149_));
  oai21  g087(.a(new_n117_), .b(x27), .c(new_n149_), .O(z14));
  ...
  nor3   g093(.a(new_n153_), .b(x24), .c(new_n155_), .O(z17));
  nand2  g094(.a(new_n87_), .b(new_n64_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n124_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x08), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n129_), .c(new_n81_), .d(new_n123_), .O(z18));
  inv1   g098(.a(new_n124_), .O(new_n161_));
  oai21  g099(.a(new_n66_), .b(new_n64_), .c(new_n128_), .O(new_n162_));
  aoi21  g100(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(new_n162_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n81_), .c(new_n123_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(z20));
  inv1   g104(.a(new_n132_), .O(z19));
endmodule
