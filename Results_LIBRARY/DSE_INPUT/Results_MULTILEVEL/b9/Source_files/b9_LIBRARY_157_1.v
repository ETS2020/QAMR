// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:56 2020
...
module FAU ( 
  ...
  nand2  g026(.a(new_n84_), .b(x04), .O(new_n89_));
  or2    g027(.a(x29), .b(x02), .O(new_n90_));
  nand4  g028(.a(new_n90_), .b(new_n89_), .c(x40), .d(x39), .O(z02));
  ...
  aoi22  g066(.a(new_n128_), .b(new_n126_), .c(new_n64_), .d(new_n125_), .O(new_n129_));
  nor3   g067(.a(new_n129_), .b(x30), .c(x09), .O(z11));
  nor2   g068(.a(x37), .b(x36), .O(new_n131_));
  aoi22  g069(.a(new_n131_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n132_));
  oai22  g070(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n133_));
  oai21  g071(.a(new_n132_), .b(x10), .c(new_n133_), .O(z12));
  inv1   g072(.a(x13), .O(new_n135_));
  inv1   g073(.a(x40), .O(new_n136_));
  nand2  g074(.a(x36), .b(x35), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x28), .c(new_n136_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x39), .c(new_n135_), .d(new_n65_), .O(new_n139_));
  inv1   g077(.a(x18), .O(new_n140_));
  inv1   g078(.a(x19), .O(new_n141_));
  nand4  g079(.a(new_n72_), .b(x20), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x27), .O(new_n144_));
  nand3  g082(.a(new_n119_), .b(new_n135_), .c(new_n65_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  nand3  g084(.a(x20), .b(new_n141_), .c(new_n140_), .O(new_n147_));
  nand4  g085(.a(new_n137_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  nand3  g087(.a(z08), .b(new_n135_), .c(new_n65_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n147_), .O(new_n151_));
  nand3  g089(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n82_), .c(new_n81_), .O(new_n154_));
  nand3  g092(.a(new_n150_), .b(new_n71_), .c(new_n70_), .O(new_n155_));
  nand4  g093(.a(x40), .b(x39), .c(new_n135_), .d(new_n65_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n64_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n155_), .c(new_n154_), .d(new_n151_), .O(z14));
  ...
  oai21  g104(.a(x27), .b(new_n125_), .c(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(x35), .c(new_n83_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n126_), .c(new_n81_), .d(new_n165_), .O(z18));
  inv1   g107(.a(new_n126_), .O(new_n170_));
  aoi21  g108(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n171_));
  oai22  g109(.a(new_n171_), .b(new_n170_), .c(x27), .d(x08), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n81_), .c(new_n165_), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z20));
  nor3   g112(.a(new_n129_), .b(x30), .c(x09), .O(z19));
endmodule
