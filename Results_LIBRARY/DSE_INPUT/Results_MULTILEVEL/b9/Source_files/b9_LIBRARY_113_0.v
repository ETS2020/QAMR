...
module FAU ( 
  ...
  nand4  g068(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n82_), .c(new_n127_), .O(new_n134_));
  ...
  oai21  g076(.a(new_n73_), .b(new_n64_), .c(new_n138_), .O(new_n139_));
  ...
  nand3  g087(.a(new_n121_), .b(new_n141_), .c(new_n65_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  nand3  g089(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n152_));
  nand4  g090(.a(new_n142_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  nand3  g092(.a(z08), .b(new_n141_), .c(new_n65_), .O(new_n155_));
  ...
  nand3  g096(.a(new_n158_), .b(new_n83_), .c(new_n82_), .O(new_n159_));
  nand3  g097(.a(new_n155_), .b(new_n71_), .c(new_n70_), .O(new_n160_));
  nand4  g098(.a(x40), .b(x39), .c(new_n141_), .d(new_n65_), .O(new_n161_));
  ...
  oai21  g107(.a(new_n85_), .b(x27), .c(new_n128_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n131_), .c(new_n82_), .d(new_n127_), .O(z18));
  inv1   g110(.a(new_n128_), .O(new_n173_));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n92_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n82_), .c(new_n127_), .O(new_n177_));
