...
module FAU ( 
  ...
  nor2   g105(.a(new_n100_), .b(x13), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n167_), .c(x39), .d(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g108(.a(x40), .b(new_n66_), .c(x28), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(x27), .c(x32), .O(new_n172_));
  aoi21  g110(.a(new_n102_), .b(z08), .c(x27), .O(new_n173_));
  aoi21  g111(.a(new_n172_), .b(new_n81_), .c(new_n173_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n170_), .c(new_n165_), .O(z14));
  ...
  nand4  g121(.a(new_n183_), .b(new_n138_), .c(new_n81_), .d(new_n132_), .O(z18));
