...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n83_), .c(x35), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n89_), .c(x04), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(z08), .O(z02));
  ...
  nor2   g077(.a(new_n90_), .b(x27), .O(new_n140_));
  ...
  aoi21  g086(.a(new_n148_), .b(x28), .c(new_n90_), .O(new_n149_));
