...
module FAU ( 
  ...
  nand2  g049(.a(new_n68_), .b(x07), .O(new_n112_));
  ...
  nand4  g065(.a(x35), .b(new_n75_), .c(x27), .d(new_n111_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n83_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n72_), .c(new_n124_), .O(new_n131_));
  ...
  nand2  g075(.a(new_n134_), .b(new_n84_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n136_), .O(z12));
  inv1   g077(.a(x13), .O(new_n140_));
  nand2  g078(.a(x36), .b(x35), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x28), .c(new_n134_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(x39), .c(new_n140_), .d(new_n111_), .O(new_n143_));
  inv1   g081(.a(x18), .O(new_n144_));
  inv1   g082(.a(x19), .O(new_n145_));
  inv1   g083(.a(new_n64_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x20), .c(new_n145_), .d(new_n144_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand3  g087(.a(new_n118_), .b(new_n140_), .c(new_n111_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z13));
  nand3  g089(.a(x39), .b(new_n140_), .c(new_n111_), .O(new_n152_));
  nand3  g090(.a(x20), .b(new_n145_), .c(new_n144_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n64_), .c(new_n152_), .O(new_n154_));
  nand4  g092(.a(new_n141_), .b(new_n73_), .c(new_n72_), .d(x28), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x40), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g095(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n73_), .c(new_n72_), .O(new_n160_));
  nand4  g098(.a(x40), .b(x39), .c(new_n140_), .d(new_n111_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n84_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n160_), .c(new_n157_), .d(new_n154_), .O(z14));
  ...
  oai21  g107(.a(new_n76_), .b(x27), .c(new_n125_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n128_), .c(new_n72_), .d(new_n124_), .O(z18));
  inv1   g110(.a(new_n125_), .O(new_n173_));
  oai21  g111(.a(new_n87_), .b(new_n84_), .c(new_n83_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n84_), .c(new_n87_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n174_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n72_), .c(new_n124_), .O(new_n177_));
