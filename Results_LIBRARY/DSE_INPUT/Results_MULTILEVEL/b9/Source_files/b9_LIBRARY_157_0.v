...
module FAU ( 
  ...
  nor2   g080(.a(new_n90_), .b(x27), .O(new_n143_));
  ...
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n90_), .O(new_n152_));
  ...
  oai21  g116(.a(new_n84_), .b(x27), .c(new_n132_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n136_), .c(new_n81_), .d(new_n131_), .O(z18));
  inv1   g119(.a(new_n132_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n135_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n81_), .c(new_n131_), .O(new_n186_));
