...
module FAU ( 
  ...
  aoi21  g059(.a(new_n78_), .b(x27), .c(x08), .O(new_n122_));
  nand2  g060(.a(x40), .b(x29), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x28), .O(new_n124_));
  nand3  g062(.a(new_n78_), .b(x27), .c(x04), .O(new_n125_));
  ...
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(new_n125_), .d(new_n124_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n122_), .c(new_n76_), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(x09), .O(z11));
  oai21  g071(.a(x37), .b(x35), .c(x27), .O(new_n134_));
  oai21  g072(.a(new_n109_), .b(x04), .c(new_n134_), .O(new_n135_));
  nor3   g073(.a(x37), .b(x36), .c(x35), .O(new_n136_));
  nor2   g074(.a(new_n127_), .b(x27), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n136_), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n69_), .b(new_n78_), .O(new_n139_));
  ...
  nor2   g081(.a(new_n126_), .b(x13), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(z08), .c(x36), .d(new_n64_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  inv1   g085(.a(x13), .O(new_n148_));
  aoi21  g086(.a(new_n77_), .b(new_n76_), .c(new_n127_), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n148_), .d(new_n64_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(z13));
  nand3  g089(.a(x20), .b(new_n142_), .c(new_n141_), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n77_), .c(new_n76_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(z08), .c(new_n148_), .d(new_n64_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g094(.a(new_n77_), .b(new_n76_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(z08), .c(new_n64_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n134_), .O(new_n159_));
  nor2   g097(.a(x37), .b(x35), .O(new_n160_));
  oai21  g098(.a(new_n137_), .b(new_n160_), .c(x13), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n159_), .c(new_n156_), .d(new_n139_), .O(z14));
  ...
  nand3  g111(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(z18));
  oai21  g112(.a(new_n126_), .b(new_n90_), .c(new_n85_), .O(new_n175_));
  oai21  g113(.a(new_n78_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n123_), .O(new_n177_));
  oai21  g115(.a(new_n137_), .b(new_n126_), .c(new_n129_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n175_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n76_), .c(new_n169_), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z20));
  nor2   g119(.a(new_n132_), .b(x09), .O(z19));
endmodule
