// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:31 2020
...
module FAU ( 
  ...
  oai21  g067(.a(new_n129_), .b(new_n84_), .c(new_n75_), .O(new_n130_));
  inv1   g068(.a(x08), .O(new_n131_));
  inv1   g069(.a(x29), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n131_), .c(new_n132_), .O(new_n134_));
  ...
  oai22  g108(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n132_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  oai21  g111(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n174_));
  aoi21  g112(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(z08), .c(new_n174_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n81_), .c(new_n128_), .O(new_n177_));
