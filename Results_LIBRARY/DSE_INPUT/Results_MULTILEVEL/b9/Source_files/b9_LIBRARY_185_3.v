...
module FAU ( 
  ...
  nor2   g077(.a(new_n119_), .b(x27), .O(new_n140_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n75_), .c(new_n64_), .O(new_n145_));
  ...
  nand3  g094(.a(new_n121_), .b(new_n147_), .c(new_n65_), .O(new_n157_));
  ...
  nand2  g098(.a(new_n147_), .b(new_n65_), .O(new_n161_));
  ...
  oai21  g105(.a(new_n140_), .b(new_n73_), .c(new_n161_), .O(new_n168_));
