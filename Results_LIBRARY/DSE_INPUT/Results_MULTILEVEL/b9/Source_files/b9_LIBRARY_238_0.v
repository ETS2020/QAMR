...
module FAU ( 
  ...
  aoi21  g027(.a(new_n66_), .b(x34), .c(x28), .O(new_n90_));
  ...
  nand3  g070(.a(new_n132_), .b(x27), .c(new_n65_), .O(new_n133_));
  ...
  nand3  g090(.a(new_n121_), .b(new_n143_), .c(new_n65_), .O(new_n153_));
  ...
  oai21  g108(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n133_), .c(new_n81_), .d(new_n127_), .O(z18));
