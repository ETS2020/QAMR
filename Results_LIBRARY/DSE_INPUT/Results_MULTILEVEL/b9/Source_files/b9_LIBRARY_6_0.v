...
module FAU ( 
  ...
  nand3  g030(.a(new_n92_), .b(new_n88_), .c(z08), .O(z02));
  ...
  nand3  g053(.a(new_n115_), .b(new_n75_), .c(x07), .O(new_n116_));
  nand3  g054(.a(z08), .b(x36), .c(x05), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n116_), .c(new_n64_), .O(new_n118_));
  inv1   g056(.a(x05), .O(new_n119_));
  nand2  g057(.a(new_n82_), .b(new_n81_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(x40), .c(x39), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n81_), .c(new_n126_), .O(new_n128_));
  inv1   g066(.a(new_n128_), .O(z11));
  nor2   g067(.a(x37), .b(x36), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n66_), .c(new_n64_), .O(new_n131_));
  oai22  g069(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n132_));
  oai21  g070(.a(new_n131_), .b(x10), .c(new_n132_), .O(z12));
  inv1   g071(.a(x18), .O(new_n134_));
  inv1   g072(.a(x19), .O(new_n135_));
  nand4  g073(.a(new_n72_), .b(x20), .c(new_n135_), .d(new_n134_), .O(new_n136_));
  nor2   g074(.a(new_n66_), .b(x13), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(z08), .c(x36), .d(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  nor2   g078(.a(new_n121_), .b(x13), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n82_), .c(new_n81_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  nor2   g085(.a(x13), .b(x04), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(z08), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n144_), .O(new_n150_));
  oai21  g088(.a(x37), .b(x35), .c(x27), .O(new_n151_));
  nand3  g089(.a(new_n148_), .b(new_n120_), .c(z08), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g091(.a(new_n149_), .b(new_n70_), .c(new_n90_), .O(new_n154_));
  ...
  nand3  g099(.a(new_n127_), .b(new_n81_), .c(new_n126_), .O(z18));
  nand2  g100(.a(x35), .b(x27), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n127_), .c(new_n81_), .d(new_n126_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(z20));
  inv1   g103(.a(new_n128_), .O(z19));
endmodule
