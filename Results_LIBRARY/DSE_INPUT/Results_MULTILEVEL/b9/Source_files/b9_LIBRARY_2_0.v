// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:21 2020
...
module FAU ( 
  ...
  nand3  g072(.a(new_n128_), .b(x27), .c(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n134_), .c(new_n131_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n82_), .c(new_n127_), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(z11));
  inv1   g077(.a(x10), .O(new_n140_));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  nor2   g079(.a(new_n76_), .b(x27), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  oai22  g081(.a(new_n73_), .b(new_n64_), .c(new_n75_), .d(x04), .O(new_n144_));
  oai21  g082(.a(x37), .b(x28), .c(x27), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n76_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n143_), .O(z12));
  ...
  nand3  g094(.a(new_n122_), .b(new_n148_), .c(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n159_));
  nand4  g097(.a(new_n149_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(z08), .c(new_n148_), .d(new_n65_), .O(new_n161_));
  ...
  nand2  g103(.a(z08), .b(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n145_), .O(new_n167_));
  nand2  g105(.a(new_n71_), .b(x13), .O(new_n168_));
  oai21  g106(.a(new_n75_), .b(x04), .c(new_n66_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  aoi22  g108(.a(new_n170_), .b(new_n70_), .c(new_n142_), .d(x13), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n167_), .c(new_n165_), .d(new_n162_), .O(z14));
  ...
  nor2   g116(.a(new_n66_), .b(x28), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n64_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n130_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n64_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n179_), .c(x30), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n182_), .c(new_n127_), .O(z18));
  oai21  g123(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n186_));
  oai21  g124(.a(new_n128_), .b(x27), .c(x35), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n133_), .O(new_n188_));
  nand3  g126(.a(new_n76_), .b(x28), .c(new_n64_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n188_), .c(new_n186_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n82_), .c(new_n127_), .O(new_n191_));
  inv1   g129(.a(new_n191_), .O(z20));
  inv1   g130(.a(new_n138_), .O(z19));
endmodule
