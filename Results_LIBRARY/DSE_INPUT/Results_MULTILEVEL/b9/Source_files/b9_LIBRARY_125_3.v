// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:49 2020
...
module FAU ( 
  ...
  oai21  g042(.a(new_n104_), .b(x25), .c(new_n103_), .O(new_n105_));
  inv1   g043(.a(x31), .O(new_n106_));
  inv1   g044(.a(x33), .O(new_n107_));
  nand2  g045(.a(x17), .b(new_n63_), .O(new_n108_));
  nand4  g046(.a(new_n108_), .b(new_n104_), .c(new_n107_), .d(new_n106_), .O(new_n109_));
  nand3  g047(.a(new_n109_), .b(new_n105_), .c(new_n102_), .O(new_n110_));
  and2   g048(.a(new_n110_), .b(x03), .O(z07));
  ...
  nand3  g054(.a(new_n116_), .b(new_n85_), .c(x27), .O(new_n117_));
  ...
  oai21  g066(.a(new_n128_), .b(new_n84_), .c(new_n127_), .O(new_n129_));
  ...
  nand3  g071(.a(new_n133_), .b(new_n81_), .c(new_n126_), .O(new_n134_));
  ...
  nand3  g088(.a(new_n120_), .b(new_n141_), .c(new_n65_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n150_), .O(z13));
  nand3  g090(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n153_));
  nand4  g091(.a(new_n143_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n154_));
  inv1   g092(.a(new_n154_), .O(new_n155_));
  nand3  g093(.a(z08), .b(new_n141_), .c(new_n65_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n155_), .c(new_n153_), .O(new_n157_));
  nand3  g095(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n82_), .c(new_n81_), .O(new_n160_));
  nand2  g098(.a(new_n156_), .b(new_n138_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(new_n157_), .O(z14));
  ...
  oai21  g106(.a(new_n84_), .b(x27), .c(new_n127_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n131_), .c(new_n81_), .d(new_n126_), .O(z18));
  inv1   g109(.a(new_n127_), .O(new_n172_));
  oai21  g110(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n173_));
  aoi21  g111(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n173_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n126_), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z20));
  inv1   g115(.a(new_n134_), .O(z19));
endmodule
