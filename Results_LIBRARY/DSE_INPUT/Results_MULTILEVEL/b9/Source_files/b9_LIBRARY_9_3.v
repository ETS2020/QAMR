...
module FAU ( 
  ...
  nand3  g027(.a(new_n64_), .b(new_n89_), .c(x04), .O(new_n90_));
  ...
  nand2  g051(.a(new_n113_), .b(x07), .O(new_n114_));
  nand3  g052(.a(x40), .b(x39), .c(x05), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n83_), .c(x27), .O(new_n117_));
  ...
  oai21  g063(.a(new_n125_), .b(new_n82_), .c(new_n124_), .O(new_n126_));
  nand4  g064(.a(x35), .b(new_n81_), .c(x27), .d(new_n65_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n89_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n80_), .c(new_n123_), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(z11));
  nor2   g069(.a(x37), .b(x36), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n133_));
  nand2  g071(.a(new_n72_), .b(x27), .O(new_n134_));
  oai21  g072(.a(new_n113_), .b(x04), .c(new_n134_), .O(new_n135_));
  oai21  g073(.a(new_n133_), .b(x10), .c(new_n135_), .O(z12));
  ...
  nand4  g078(.a(new_n140_), .b(x39), .c(new_n137_), .d(new_n65_), .O(new_n141_));
  ...
  nor3   g102(.a(new_n162_), .b(x24), .c(new_n164_), .O(z17));
  oai21  g103(.a(new_n82_), .b(x27), .c(new_n124_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n127_), .c(new_n80_), .d(new_n123_), .O(z18));
  inv1   g106(.a(new_n124_), .O(new_n169_));
  oai21  g107(.a(new_n66_), .b(new_n64_), .c(new_n89_), .O(new_n170_));
  aoi21  g108(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n170_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n80_), .c(new_n123_), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z20));
  inv1   g112(.a(new_n130_), .O(z19));
endmodule
