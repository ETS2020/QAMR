...
module FAU ( 
  ...
  nor2   g061(.a(new_n84_), .b(new_n111_), .O(new_n124_));
  oai21  g062(.a(new_n124_), .b(new_n76_), .c(new_n123_), .O(new_n125_));
  nand2  g063(.a(x40), .b(x04), .O(new_n126_));
  nand4  g064(.a(new_n126_), .b(x35), .c(new_n75_), .d(x27), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n72_), .c(new_n122_), .O(new_n130_));
  ...
  oai21  g072(.a(new_n134_), .b(new_n132_), .c(new_n66_), .O(new_n135_));
  nand2  g073(.a(x39), .b(new_n111_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n87_), .c(new_n89_), .O(new_n137_));
  nand3  g075(.a(x40), .b(x39), .c(new_n111_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n84_), .O(new_n139_));
  ...
  nand4  g081(.a(new_n143_), .b(x39), .c(new_n141_), .d(new_n111_), .O(new_n144_));
  ...
  aoi21  g088(.a(new_n73_), .b(new_n72_), .c(new_n133_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n141_), .d(new_n111_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  nand3  g091(.a(x39), .b(new_n141_), .c(new_n111_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n87_), .O(new_n155_));
  inv1   g093(.a(x35), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n73_), .c(new_n72_), .d(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n89_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n146_), .c(new_n145_), .O(new_n160_));
  nand4  g098(.a(new_n142_), .b(new_n73_), .c(new_n72_), .d(x28), .O(new_n161_));
  oai21  g099(.a(x13), .b(x04), .c(x40), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n161_), .c(z08), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand3  g102(.a(new_n162_), .b(new_n116_), .c(z08), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n84_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n164_), .c(new_n159_), .O(z14));
  ...
  oai21  g111(.a(new_n76_), .b(x27), .c(new_n123_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  inv1   g113(.a(new_n76_), .O(new_n176_));
  nor2   g114(.a(new_n84_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(x30), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n175_), .c(new_n122_), .O(z18));
  inv1   g117(.a(new_n123_), .O(new_n180_));
  oai21  g118(.a(new_n156_), .b(new_n84_), .c(new_n83_), .O(new_n181_));
  aoi21  g119(.a(x28), .b(new_n84_), .c(new_n156_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n180_), .c(new_n181_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n72_), .c(new_n122_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z20));
  inv1   g123(.a(new_n130_), .O(z19));
endmodule
