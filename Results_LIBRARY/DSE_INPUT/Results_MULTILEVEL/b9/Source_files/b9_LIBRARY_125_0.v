...
module FAU ( 
  ...
  aoi21  g046(.a(new_n108_), .b(x14), .c(new_n102_), .O(z07));
  ...
  nand3  g069(.a(new_n131_), .b(new_n81_), .c(new_n124_), .O(new_n132_));
  ...
  nand3  g086(.a(new_n118_), .b(new_n139_), .c(new_n65_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(z13));
  nand3  g088(.a(x20), .b(new_n145_), .c(new_n144_), .O(new_n151_));
  nand4  g089(.a(new_n141_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  nand3  g091(.a(z08), .b(new_n139_), .c(new_n65_), .O(new_n154_));
  ...
  nand2  g096(.a(new_n154_), .b(new_n136_), .O(new_n159_));
  ...
  oai21  g104(.a(new_n84_), .b(x27), .c(new_n125_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n129_), .c(new_n81_), .d(new_n124_), .O(z18));
  inv1   g107(.a(new_n125_), .O(new_n170_));
  oai21  g108(.a(new_n66_), .b(new_n64_), .c(new_n128_), .O(new_n171_));
  aoi21  g109(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n171_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n81_), .c(new_n124_), .O(new_n174_));
