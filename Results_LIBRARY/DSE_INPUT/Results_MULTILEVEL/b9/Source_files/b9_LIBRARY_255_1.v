...
module FAU ( 
  ...
  aoi22  g027(.a(new_n84_), .b(x40), .c(new_n64_), .d(new_n89_), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n65_), .c(z08), .O(z02));
  ...
  nand4  g066(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n89_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n81_), .c(new_n125_), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(z11));
  nor2   g071(.a(x37), .b(x36), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(new_n66_), .c(x40), .d(new_n64_), .O(new_n135_));
  ...
  aoi21  g078(.a(new_n140_), .b(x28), .c(new_n139_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(x39), .c(new_n138_), .d(new_n65_), .O(new_n142_));
  inv1   g080(.a(x18), .O(new_n143_));
  inv1   g081(.a(x19), .O(new_n144_));
  nand4  g082(.a(new_n72_), .b(x20), .c(new_n144_), .d(new_n143_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand3  g085(.a(new_n119_), .b(new_n138_), .c(new_n65_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  nand3  g087(.a(x20), .b(new_n144_), .c(new_n143_), .O(new_n150_));
  nand4  g088(.a(new_n140_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  nand3  g090(.a(z08), .b(new_n138_), .c(new_n65_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n152_), .c(new_n150_), .O(new_n154_));
  nand3  g092(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n82_), .c(new_n81_), .O(new_n157_));
  nand3  g095(.a(new_n153_), .b(new_n71_), .c(new_n70_), .O(new_n158_));
  nand4  g096(.a(x40), .b(x39), .c(new_n138_), .d(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n64_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n158_), .c(new_n157_), .d(new_n154_), .O(z14));
  ...
  nand4  g107(.a(new_n169_), .b(new_n129_), .c(new_n81_), .d(new_n125_), .O(z18));
  inv1   g108(.a(new_n126_), .O(new_n171_));
  oai21  g109(.a(new_n66_), .b(new_n64_), .c(new_n89_), .O(new_n172_));
  aoi21  g110(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(new_n172_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n125_), .O(new_n175_));
