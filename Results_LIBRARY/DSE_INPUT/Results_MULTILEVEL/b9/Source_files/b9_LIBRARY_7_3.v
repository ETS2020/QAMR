...
module FAU ( 
  ...
  nand2  g051(.a(new_n87_), .b(x07), .O(new_n114_));
  ...
  nor2   g065(.a(new_n92_), .b(new_n64_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n77_), .c(new_n127_), .O(new_n129_));
  inv1   g067(.a(x08), .O(new_n130_));
  nand4  g068(.a(x35), .b(new_n76_), .c(x27), .d(new_n64_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n73_), .c(new_n126_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  inv1   g073(.a(x35), .O(new_n136_));
  nor2   g074(.a(x37), .b(x36), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(new_n92_), .O(new_n138_));
  nand2  g076(.a(new_n90_), .b(new_n93_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n87_), .b(x04), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g090(.a(new_n120_), .b(new_n143_), .c(new_n64_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z13));
  nand3  g092(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n155_));
  nand4  g093(.a(new_n145_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n156_));
  ...
  nand3  g097(.a(new_n93_), .b(new_n136_), .c(x28), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n74_), .c(new_n73_), .O(new_n162_));
  ...
  oai21  g108(.a(new_n77_), .b(x27), .c(new_n127_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n131_), .c(new_n73_), .d(new_n126_), .O(z18));
  inv1   g111(.a(new_n127_), .O(new_n174_));
  oai21  g112(.a(new_n136_), .b(new_n92_), .c(new_n130_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n92_), .c(new_n136_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n175_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n73_), .c(new_n126_), .O(new_n178_));
