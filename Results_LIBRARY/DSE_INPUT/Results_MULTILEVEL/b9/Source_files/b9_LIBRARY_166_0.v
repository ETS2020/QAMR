...
module FAU ( 
  ...
  oai21  g025(.a(x27), .b(x08), .c(new_n83_), .O(new_n88_));
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n75_), .O(new_n89_));
  oai21  g027(.a(new_n87_), .b(x02), .c(new_n89_), .O(z02));
  ...
  nand3  g052(.a(new_n114_), .b(x35), .c(new_n112_), .O(new_n115_));
  ...
  nand2  g056(.a(new_n118_), .b(x36), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n115_), .c(new_n64_), .O(new_n120_));
  inv1   g058(.a(x39), .O(new_n121_));
  oai21  g059(.a(x32), .b(x30), .c(x40), .O(new_n122_));
  nor2   g060(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  and2   g061(.a(new_n123_), .b(x05), .O(new_n124_));
  ...
  oai21  g067(.a(new_n64_), .b(new_n65_), .c(new_n83_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  inv1   g069(.a(x08), .O(new_n132_));
  nand3  g070(.a(new_n83_), .b(x27), .c(new_n65_), .O(new_n133_));
  ...
  nand3  g090(.a(new_n123_), .b(new_n143_), .c(new_n65_), .O(new_n153_));
  ...
  nand2  g108(.a(new_n83_), .b(new_n64_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n129_), .O(new_n172_));
