...
module FAU ( 
  ...
  aoi21  g006(.a(new_n68_), .b(new_n63_), .c(x15), .O(new_n69_));
  nand2  g007(.a(x35), .b(x28), .O(new_n70_));
  inv1   g008(.a(new_n70_), .O(new_n71_));
  oai21  g009(.a(new_n71_), .b(new_n69_), .c(x27), .O(new_n72_));
  ...
  aoi21  g015(.a(new_n77_), .b(new_n75_), .c(new_n73_), .O(new_n78_));
  ...
  nand2  g021(.a(new_n83_), .b(new_n66_), .O(new_n84_));
  ...
  oai21  g032(.a(new_n65_), .b(new_n82_), .c(x27), .O(new_n95_));
  ...
  nand4  g047(.a(new_n109_), .b(new_n107_), .c(new_n105_), .d(new_n104_), .O(new_n110_));
  ...
  nor2   g069(.a(new_n96_), .b(new_n64_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n83_), .c(new_n131_), .O(new_n133_));
  inv1   g071(.a(x08), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n82_), .c(x27), .d(new_n64_), .O(new_n135_));
  ...
  nor2   g077(.a(x37), .b(x36), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n65_), .c(new_n96_), .O(new_n141_));
  nand2  g079(.a(new_n70_), .b(new_n63_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x27), .O(new_n143_));
  oai21  g081(.a(new_n76_), .b(x04), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n141_), .b(x10), .c(new_n144_), .O(z12));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n146_), .d(new_n64_), .O(new_n150_));
  ...
  oai21  g111(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n135_), .c(new_n80_), .d(new_n130_), .O(z18));
  inv1   g114(.a(new_n131_), .O(new_n177_));
  oai21  g115(.a(new_n65_), .b(new_n96_), .c(new_n134_), .O(new_n178_));
  aoi21  g116(.a(x28), .b(new_n96_), .c(new_n65_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(new_n178_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n80_), .c(new_n130_), .O(new_n181_));
  inv1   g119(.a(new_n181_), .O(z20));
  inv1   g120(.a(new_n138_), .O(z19));
endmodule
