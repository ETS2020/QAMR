// Benchmark "FAU" written by ABC on Mon Jul 27 18:20:17 2020
...
module FAU ( 
  ...
  nand2  g055(.a(new_n67_), .b(x28), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n76_), .c(x07), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n117_), .c(new_n64_), .O(new_n120_));
  oai21  g058(.a(x32), .b(x30), .c(x40), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n75_), .O(new_n122_));
  and2   g060(.a(new_n122_), .b(x05), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n120_), .c(new_n65_), .O(new_n124_));
  ...
  oai21  g066(.a(new_n64_), .b(new_n65_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g071(.a(new_n133_), .b(new_n132_), .c(new_n66_), .O(new_n134_));
  nand2  g072(.a(x40), .b(x04), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n128_), .c(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n134_), .c(new_n131_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n82_), .c(new_n127_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  inv1   g078(.a(x10), .O(new_n141_));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  nor2   g080(.a(new_n76_), .b(x27), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  aoi22  g082(.a(x39), .b(new_n65_), .c(x35), .d(x28), .O(new_n145_));
  nor2   g083(.a(x40), .b(x28), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n70_), .O(new_n147_));
  nand3  g085(.a(x40), .b(x39), .c(new_n65_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n64_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n144_), .O(z12));
  ...
  nand3  g107(.a(new_n169_), .b(new_n83_), .c(new_n82_), .O(new_n170_));
  oai21  g108(.a(new_n143_), .b(new_n73_), .c(new_n164_), .O(new_n171_));
  inv1   g109(.a(z08), .O(new_n172_));
  oai21  g110(.a(x37), .b(x28), .c(x27), .O(new_n173_));
  nor3   g111(.a(x39), .b(x37), .c(x35), .O(new_n174_));
  aoi21  g112(.a(new_n173_), .b(new_n172_), .c(new_n174_), .O(new_n175_));
  ...
  nand2  g121(.a(new_n183_), .b(new_n64_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n130_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n64_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n183_), .c(x30), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n186_), .c(new_n127_), .O(z18));
  oai21  g127(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n190_));
  oai21  g128(.a(new_n128_), .b(x27), .c(x35), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n133_), .O(new_n192_));
  nand3  g130(.a(new_n76_), .b(x28), .c(new_n64_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n192_), .c(new_n190_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n82_), .c(new_n127_), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(z20));
  inv1   g134(.a(new_n139_), .O(z19));
endmodule
