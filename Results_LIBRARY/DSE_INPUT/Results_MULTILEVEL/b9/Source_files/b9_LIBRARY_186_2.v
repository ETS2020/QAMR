// Benchmark "FAU" written by ABC on Mon Jul 27 18:20:03 2020
...
module FAU ( 
  ...
  nand2  g053(.a(new_n75_), .b(x07), .O(new_n116_));
  nand3  g054(.a(x40), .b(x39), .c(x05), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n85_), .c(x27), .O(new_n119_));
  inv1   g057(.a(x40), .O(new_n120_));
  nor2   g058(.a(x32), .b(x30), .O(new_n121_));
  ...
  nand2  g066(.a(z08), .b(x29), .O(new_n129_));
  nor2   g067(.a(new_n64_), .b(new_n65_), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(new_n84_), .c(new_n129_), .O(new_n131_));
  inv1   g069(.a(x08), .O(new_n132_));
  nand4  g070(.a(x35), .b(new_n83_), .c(x27), .d(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n81_), .c(new_n128_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  nor2   g075(.a(x37), .b(x36), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n66_), .c(new_n64_), .O(new_n139_));
  nand2  g077(.a(z08), .b(new_n65_), .O(new_n140_));
  oai21  g078(.a(new_n73_), .b(new_n64_), .c(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n139_), .b(x10), .c(new_n141_), .O(z12));
  nand2  g080(.a(x36), .b(x35), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x13), .c(x28), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(x40), .c(x39), .d(new_n65_), .O(new_n145_));
  inv1   g083(.a(x18), .O(new_n146_));
  inv1   g084(.a(x19), .O(new_n147_));
  nand4  g085(.a(new_n72_), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  inv1   g088(.a(x13), .O(new_n151_));
  nand4  g089(.a(new_n122_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  nand4  g091(.a(x27), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n73_), .c(new_n140_), .O(new_n155_));
  oai21  g093(.a(new_n121_), .b(x13), .c(new_n64_), .O(new_n156_));
  nand2  g094(.a(new_n121_), .b(x28), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n151_), .c(x37), .O(new_n158_));
  nand3  g096(.a(x20), .b(new_n147_), .c(new_n146_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n158_), .c(new_n66_), .O(new_n162_));
  nand4  g100(.a(new_n67_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n151_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n159_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n162_), .c(new_n156_), .d(new_n155_), .O(z14));
  ...
  nor3   g109(.a(new_n169_), .b(x24), .c(new_n171_), .O(z17));
  oai21  g110(.a(new_n84_), .b(x27), .c(new_n129_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n133_), .c(new_n81_), .d(new_n128_), .O(z18));
  inv1   g113(.a(new_n129_), .O(new_n176_));
  oai21  g114(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n177_));
  aoi21  g115(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n177_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n81_), .c(new_n128_), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z20));
  inv1   g119(.a(new_n136_), .O(z19));
endmodule
