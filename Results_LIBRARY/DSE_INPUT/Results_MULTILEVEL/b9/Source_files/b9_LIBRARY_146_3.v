// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:54 2020
...
module FAU ( 
  ...
  nand2  g051(.a(new_n75_), .b(x07), .O(new_n114_));
  nand3  g052(.a(x40), .b(x39), .c(x05), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g054(.a(new_n116_), .b(new_n84_), .c(x27), .O(new_n117_));
  nand3  g055(.a(z08), .b(x30), .c(x05), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n65_), .O(new_n120_));
  ...
  nor2   g062(.a(new_n64_), .b(new_n65_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n83_), .c(new_n124_), .O(new_n126_));
  inv1   g064(.a(x08), .O(new_n127_));
  nand2  g065(.a(x40), .b(x04), .O(new_n128_));
  nand4  g066(.a(new_n128_), .b(x35), .c(new_n82_), .d(x27), .O(new_n129_));
  ...
  oai21  g075(.a(new_n137_), .b(new_n135_), .c(new_n134_), .O(new_n138_));
  nand2  g076(.a(z08), .b(new_n65_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n71_), .c(new_n70_), .O(new_n140_));
  nand3  g078(.a(x40), .b(x39), .c(new_n65_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n138_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x28), .c(new_n136_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n65_), .O(new_n147_));
  ...
  nand3  g091(.a(new_n153_), .b(z08), .c(x30), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(z13));
  nand3  g093(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n156_));
  nand3  g094(.a(new_n145_), .b(new_n81_), .c(x28), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n153_), .c(x40), .d(x39), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g097(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n160_));
  oai21  g098(.a(x32), .b(x27), .c(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n81_), .O(new_n162_));
  nand2  g100(.a(new_n153_), .b(z08), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n71_), .c(new_n70_), .O(new_n164_));
  nand4  g102(.a(x40), .b(x39), .c(new_n144_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n64_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n164_), .c(new_n162_), .d(new_n159_), .O(z14));
  ...
  oai21  g111(.a(new_n83_), .b(x27), .c(new_n124_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  inv1   g113(.a(new_n83_), .O(new_n176_));
  nor2   g114(.a(new_n64_), .b(x04), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(x30), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n175_), .c(new_n123_), .O(z18));
  inv1   g117(.a(new_n124_), .O(new_n180_));
  oai21  g118(.a(new_n66_), .b(new_n64_), .c(new_n127_), .O(new_n181_));
  aoi21  g119(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n180_), .c(new_n181_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n81_), .c(new_n123_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z20));
  inv1   g123(.a(new_n132_), .O(z19));
endmodule
