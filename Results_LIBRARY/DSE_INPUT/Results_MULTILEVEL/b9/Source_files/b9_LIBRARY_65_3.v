...
module FAU ( 
  ...
  oai21  g027(.a(new_n89_), .b(new_n83_), .c(x35), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x04), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(z08), .c(x29), .d(x08), .O(z02));
  ...
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n89_), .O(new_n148_));
  ...
  nand3  g092(.a(new_n120_), .b(new_n146_), .c(new_n65_), .O(new_n155_));
  ...
  oai21  g112(.a(new_n84_), .b(x27), .c(new_n127_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n132_), .c(new_n81_), .d(new_n126_), .O(z18));
  inv1   g115(.a(new_n127_), .O(new_n178_));
  oai21  g116(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n179_));
  aoi21  g117(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n178_), .c(new_n179_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n81_), .c(new_n126_), .O(new_n182_));
