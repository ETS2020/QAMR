...
module FAU ( 
  ...
  inv1   g027(.a(x19), .O(new_n90_));
  nor2   g028(.a(new_n70_), .b(new_n64_), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(x20), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  oai21  g030(.a(x08), .b(new_n65_), .c(x40), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n64_), .O(new_n94_));
  nand2  g032(.a(new_n81_), .b(x04), .O(new_n95_));
  inv1   g033(.a(x40), .O(new_n96_));
  nand3  g034(.a(x20), .b(new_n90_), .c(new_n89_), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n70_), .c(new_n96_), .O(new_n98_));
  inv1   g036(.a(x39), .O(new_n99_));
  nand2  g037(.a(x40), .b(new_n99_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n98_), .c(new_n95_), .d(new_n94_), .O(new_n101_));
  inv1   g039(.a(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n92_), .c(new_n88_), .O(z02));
  oai21  g041(.a(new_n66_), .b(new_n80_), .c(x27), .O(new_n104_));
  inv1   g042(.a(x37), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n64_), .O(new_n106_));
  ...
  aoi21  g047(.a(x28), .b(x27), .c(x37), .O(z06));
  inv1   g048(.a(z06), .O(z05));
  ...
  aoi21  g060(.a(new_n122_), .b(new_n118_), .c(new_n112_), .O(z07));
  ...
  nor2   g068(.a(new_n130_), .b(new_n99_), .O(new_n131_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(z10));
  ...
  nand3  g080(.a(new_n142_), .b(x27), .c(new_n65_), .O(new_n143_));
  ...
  nor2   g087(.a(new_n72_), .b(x04), .O(new_n150_));
  oai22  g088(.a(new_n150_), .b(new_n91_), .c(new_n149_), .d(x10), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n96_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n155_));
  inv1   g093(.a(new_n70_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x20), .c(new_n90_), .d(new_n89_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n131_), .b(new_n152_), .c(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand2  g099(.a(new_n130_), .b(new_n64_), .O(new_n162_));
  nand4  g100(.a(new_n153_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x40), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n162_), .c(new_n98_), .O(z14));
  ...
  oai21  g110(.a(new_n81_), .b(x27), .c(new_n138_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n143_), .c(new_n78_), .d(new_n137_), .O(z18));
  inv1   g113(.a(new_n138_), .O(new_n176_));
  oai21  g114(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n177_));
  aoi21  g115(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n177_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n78_), .c(new_n137_), .O(new_n180_));
  inv1   g118(.a(new_n180_), .O(z20));
  inv1   g119(.a(new_n146_), .O(z19));
endmodule
