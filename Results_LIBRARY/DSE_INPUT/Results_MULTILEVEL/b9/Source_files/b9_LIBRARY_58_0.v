...
module FAU ( 
  ...
  nand2  g097(.a(new_n159_), .b(x39), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g099(.a(x27), .b(new_n152_), .c(new_n151_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x40), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n72_), .c(x20), .O(new_n164_));
  oai21  g102(.a(x13), .b(x04), .c(new_n164_), .O(new_n165_));
  oai21  g103(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n166_));
  nand3  g104(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x27), .c(x32), .O(new_n168_));
  aoi21  g106(.a(new_n152_), .b(new_n151_), .c(x40), .O(new_n169_));
  aoi21  g107(.a(new_n168_), .b(new_n81_), .c(new_n169_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n166_), .c(new_n165_), .d(new_n161_), .O(z14));
  ...
  oai21  g122(.a(new_n66_), .b(new_n64_), .c(new_n91_), .O(new_n185_));
