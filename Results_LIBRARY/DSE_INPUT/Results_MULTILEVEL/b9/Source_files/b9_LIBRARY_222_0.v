...
module FAU ( 
  ...
  nand3  g037(.a(new_n99_), .b(new_n96_), .c(new_n98_), .O(z04));
  ...
  nand3  g091(.a(new_n123_), .b(new_n144_), .c(new_n65_), .O(new_n154_));
  ...
  nand3  g096(.a(z08), .b(new_n144_), .c(new_n65_), .O(new_n159_));
  ...
  nand2  g101(.a(new_n159_), .b(new_n141_), .O(new_n164_));
  ...
  oai21  g109(.a(new_n84_), .b(x27), .c(new_n130_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n134_), .c(new_n81_), .d(new_n129_), .O(z18));
  inv1   g112(.a(new_n130_), .O(new_n175_));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n175_), .c(new_n176_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n81_), .c(new_n129_), .O(new_n179_));
