...
module FAU ( 
  ...
  nand4  g086(.a(new_n148_), .b(x20), .c(new_n146_), .d(new_n145_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand3  g089(.a(new_n120_), .b(new_n140_), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  aoi21  g091(.a(x20), .b(new_n146_), .c(new_n80_), .O(new_n154_));
  nor2   g092(.a(x19), .b(new_n145_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(new_n142_), .O(new_n156_));
  aoi21  g094(.a(new_n147_), .b(new_n146_), .c(new_n64_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n79_), .c(new_n78_), .O(new_n159_));
  nand3  g097(.a(z08), .b(new_n140_), .c(new_n65_), .O(new_n160_));
  nor2   g098(.a(x19), .b(x18), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n148_), .c(x27), .d(x20), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n159_), .O(z14));
  ...
  oai21  g108(.a(new_n81_), .b(x27), .c(new_n127_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n131_), .c(new_n78_), .d(new_n126_), .O(z18));
  inv1   g111(.a(new_n127_), .O(new_n174_));
  oai21  g112(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n175_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n78_), .c(new_n126_), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z20));
  inv1   g117(.a(new_n134_), .O(z19));
endmodule
