// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:26 2020
...
module FAU ( 
  ...
  nand4  g070(.a(new_n132_), .b(x35), .c(new_n83_), .d(x27), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n81_), .c(new_n127_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x10), .O(new_n138_));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  inv1   g077(.a(x40), .O(new_n140_));
  nor2   g078(.a(new_n140_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n139_), .c(new_n138_), .O(new_n142_));
  nand2  g080(.a(z08), .b(new_n65_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n71_), .c(new_n70_), .O(new_n144_));
  nand3  g082(.a(x40), .b(x39), .c(new_n65_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n64_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n142_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n140_), .O(new_n150_));
  ...
  nand3  g094(.a(new_n121_), .b(new_n148_), .c(new_n65_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n159_));
  nand4  g097(.a(new_n149_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n160_));
  nand2  g098(.a(new_n148_), .b(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x40), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n160_), .c(z08), .O(new_n163_));
  ...
  oai21  g105(.a(new_n141_), .b(new_n73_), .c(new_n161_), .O(new_n168_));
  oai21  g106(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n164_), .O(z14));
  ...
  oai21  g114(.a(new_n84_), .b(x27), .c(new_n128_), .O(new_n177_));
  ...
  nand3  g119(.a(new_n181_), .b(new_n178_), .c(new_n127_), .O(z18));
  inv1   g120(.a(new_n128_), .O(new_n183_));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n131_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n81_), .c(new_n127_), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(z20));
  inv1   g126(.a(new_n136_), .O(z19));
endmodule
