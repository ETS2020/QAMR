...
module FAU ( 
  ...
  nand2  g073(.a(z08), .b(new_n65_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n71_), .c(new_n70_), .O(new_n137_));
  nand3  g075(.a(x40), .b(x39), .c(new_n65_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n64_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n137_), .c(new_n135_), .O(z12));
  inv1   g078(.a(x13), .O(new_n141_));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x28), .c(new_n133_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n119_), .b(new_n141_), .c(new_n65_), .O(new_n150_));
  ...
  nand2  g091(.a(new_n141_), .b(new_n65_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x40), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n153_), .c(z08), .O(new_n156_));
  ...
  oai21  g098(.a(new_n134_), .b(new_n73_), .c(new_n154_), .O(new_n161_));
  oai21  g099(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n157_), .O(z14));
  ...
  nand2  g108(.a(x27), .b(new_n65_), .O(new_n171_));
  oai21  g109(.a(x27), .b(new_n125_), .c(new_n171_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(x35), .c(new_n83_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n126_), .c(new_n81_), .d(new_n170_), .O(z18));
  inv1   g112(.a(new_n126_), .O(new_n175_));
  aoi21  g113(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n176_));
  oai22  g114(.a(new_n176_), .b(new_n175_), .c(x27), .d(x08), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n170_), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z20));
  nor3   g117(.a(new_n129_), .b(x30), .c(x09), .O(z19));
endmodule
