...
module FAU ( 
  ...
  nand3  g035(.a(new_n97_), .b(new_n92_), .c(z08), .O(z02));
  ...
  aoi21  g041(.a(x28), .b(x27), .c(x37), .O(z06));
  ...
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n93_), .O(new_n152_));
  ...
  nand3  g096(.a(new_n126_), .b(new_n150_), .c(new_n65_), .O(new_n159_));
  ...
  nand2  g100(.a(new_n150_), .b(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x40), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(z08), .O(new_n165_));
  ...
  oai21  g107(.a(new_n143_), .b(new_n73_), .c(new_n163_), .O(new_n170_));
  oai21  g108(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n170_), .c(new_n169_), .d(new_n166_), .O(z14));
  ...
  oai21  g116(.a(new_n84_), .b(x27), .c(new_n133_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n136_), .c(new_n81_), .d(new_n132_), .O(z18));
  inv1   g119(.a(new_n133_), .O(new_n182_));
  oai21  g120(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n182_), .c(new_n183_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n81_), .c(new_n132_), .O(new_n186_));
