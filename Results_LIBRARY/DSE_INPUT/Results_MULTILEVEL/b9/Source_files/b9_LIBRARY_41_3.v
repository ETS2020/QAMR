...
module FAU ( 
  ...
  oai21  g036(.a(new_n83_), .b(new_n64_), .c(new_n70_), .O(z05));
  inv1   g037(.a(x40), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n83_), .c(new_n64_), .O(new_n101_));
  nor2   g039(.a(x13), .b(x04), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(x39), .c(new_n64_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(x40), .c(new_n83_), .O(new_n104_));
  oai21  g042(.a(new_n101_), .b(x37), .c(new_n104_), .O(z06));
  ...
  nand3  g081(.a(x40), .b(new_n67_), .c(new_n66_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n65_), .c(new_n100_), .O(new_n147_));
  nor2   g085(.a(x40), .b(x37), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n71_), .O(new_n149_));
  oai21  g087(.a(new_n75_), .b(x04), .c(new_n64_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n149_), .c(new_n146_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n100_), .O(new_n154_));
  ...
  nand3  g098(.a(new_n126_), .b(new_n152_), .c(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nor2   g100(.a(new_n124_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n65_), .c(new_n100_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n148_), .c(new_n71_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n166_));
  nand4  g104(.a(new_n67_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n102_), .c(z08), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  nand3  g107(.a(x40), .b(new_n66_), .c(x28), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x27), .c(x32), .O(new_n171_));
  aoi21  g109(.a(new_n102_), .b(z08), .c(x27), .O(new_n172_));
  aoi21  g110(.a(new_n171_), .b(new_n81_), .c(new_n172_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n169_), .c(new_n165_), .O(z14));
  ...
  nand4  g120(.a(new_n182_), .b(new_n138_), .c(new_n81_), .d(new_n132_), .O(z18));
  inv1   g121(.a(new_n133_), .O(new_n184_));
  oai21  g122(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n185_));
