...
module FAU ( 
  ...
  nor2   g061(.a(new_n123_), .b(new_n118_), .O(new_n124_));
  and2   g062(.a(new_n124_), .b(x05), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n122_), .c(new_n65_), .O(new_n126_));
  ...
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n83_), .d(x27), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n133_), .c(new_n134_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n81_), .c(new_n129_), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(z11));
  inv1   g078(.a(x10), .O(new_n141_));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  nor2   g080(.a(new_n134_), .b(x27), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(new_n144_));
  oai22  g082(.a(new_n73_), .b(new_n64_), .c(new_n118_), .d(x04), .O(new_n145_));
  oai21  g083(.a(new_n70_), .b(new_n64_), .c(new_n134_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  inv1   g086(.a(x36), .O(new_n149_));
  oai22  g087(.a(new_n134_), .b(x28), .c(new_n149_), .d(new_n66_), .O(new_n150_));
  ...
  nand3  g094(.a(new_n124_), .b(new_n148_), .c(new_n65_), .O(new_n157_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n85_), .c(x30), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n180_), .c(new_n129_), .O(z18));
  oai21  g121(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n184_));
  oai21  g122(.a(new_n83_), .b(x27), .c(x35), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n130_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n184_), .c(x40), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n81_), .c(new_n129_), .O(new_n188_));
