...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n161_, new_n163_, new_n166_, new_n167_;
  ...
  oai22  g068(.a(new_n130_), .b(new_n127_), .c(new_n86_), .d(x04), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z12));
  inv1   g070(.a(x18), .O(new_n133_));
  inv1   g071(.a(x19), .O(new_n134_));
  inv1   g072(.a(new_n130_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x20), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  ...
  nand2  g093(.a(new_n141_), .b(new_n66_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n86_), .c(new_n130_), .d(new_n127_), .O(new_n157_));
  ...
  nand4  g102(.a(new_n124_), .b(new_n123_), .c(new_n78_), .d(new_n122_), .O(z18));
  nand2  g103(.a(x35), .b(x27), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n124_), .c(new_n78_), .d(new_n122_), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(z20));
  inv1   g106(.a(new_n125_), .O(z19));
endmodule
