...
module FAU ( 
  ...
  aoi21  g025(.a(new_n87_), .b(x04), .c(new_n75_), .O(new_n88_));
  oai21  g026(.a(new_n86_), .b(x02), .c(new_n88_), .O(z02));
  nand2  g027(.a(new_n71_), .b(x27), .O(new_n90_));
  nand2  g028(.a(new_n70_), .b(new_n64_), .O(new_n91_));
  ...
  nand2  g049(.a(x35), .b(new_n111_), .O(new_n112_));
  nand2  g050(.a(new_n112_), .b(new_n67_), .O(new_n113_));
  ...
  oai21  g066(.a(new_n128_), .b(new_n112_), .c(new_n127_), .O(new_n129_));
  ...
  oai21  g074(.a(new_n70_), .b(new_n64_), .c(x04), .O(new_n137_));
  ...
  nand4  g089(.a(new_n120_), .b(x39), .c(new_n143_), .d(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(z13));
  nand4  g091(.a(x27), .b(x20), .c(new_n148_), .d(new_n147_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n73_), .c(new_n75_), .d(x13), .O(new_n155_));
  oai21  g093(.a(new_n119_), .b(x04), .c(new_n64_), .O(new_n156_));
  nand4  g094(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n65_), .O(new_n158_));
  nand4  g096(.a(x37), .b(x20), .c(new_n148_), .d(new_n147_), .O(new_n159_));
  ...
  oai21  g109(.a(new_n112_), .b(x27), .c(new_n127_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x08), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n132_), .c(new_n81_), .d(new_n126_), .O(z18));
  inv1   g112(.a(new_n127_), .O(new_n175_));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n130_), .O(new_n176_));
  aoi21  g114(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n175_), .c(new_n176_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n81_), .c(new_n126_), .O(new_n179_));
