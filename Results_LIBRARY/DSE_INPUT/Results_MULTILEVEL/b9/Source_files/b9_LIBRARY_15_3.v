// Benchmark "FAU" written by ABC on Mon Jul 27 18:19:24 2020
...
module FAU ( 
  ...
  oai21  g066(.a(new_n64_), .b(new_n65_), .c(x35), .O(new_n129_));
  ...
  oai21  g071(.a(new_n133_), .b(x04), .c(new_n132_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n131_), .c(new_n83_), .O(new_n135_));
  ...
  oai21  g108(.a(new_n66_), .b(x27), .c(new_n130_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  inv1   g110(.a(new_n84_), .O(new_n173_));
  nor2   g111(.a(new_n64_), .b(x04), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(x30), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n172_), .c(new_n128_), .O(z18));
  nand2  g114(.a(new_n133_), .b(new_n132_), .O(new_n177_));
  nand2  g115(.a(new_n130_), .b(new_n66_), .O(new_n178_));
