...
module FAU ( 
  ...
  nand3  g071(.a(new_n133_), .b(new_n113_), .c(x27), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n81_), .c(new_n74_), .O(new_n135_));
  oai21  g073(.a(new_n132_), .b(new_n130_), .c(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n72_), .c(new_n129_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  nor2   g076(.a(x37), .b(x28), .O(new_n139_));
  inv1   g077(.a(new_n139_), .O(new_n140_));
  oai21  g078(.a(new_n109_), .b(x27), .c(new_n140_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x04), .O(new_n142_));
  aoi21  g080(.a(new_n140_), .b(x27), .c(z08), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(new_n144_));
  inv1   g082(.a(x10), .O(new_n145_));
  nor2   g083(.a(new_n109_), .b(x27), .O(new_n146_));
  aoi22  g084(.a(new_n146_), .b(new_n145_), .c(new_n67_), .d(new_n74_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n144_), .c(new_n142_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  aoi21  g087(.a(new_n110_), .b(x28), .c(new_n109_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n149_), .d(new_n63_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n69_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n123_), .b(new_n149_), .c(new_n63_), .O(new_n157_));
  ...
  nand4  g098(.a(new_n110_), .b(new_n73_), .c(new_n72_), .d(x28), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n160_), .c(x40), .d(x39), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  inv1   g101(.a(new_n160_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n141_), .O(new_n165_));
  nor2   g103(.a(new_n121_), .b(x27), .O(new_n166_));
  aoi21  g104(.a(new_n67_), .b(new_n74_), .c(new_n166_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n165_), .c(new_n163_), .d(new_n144_), .O(z14));
  ...
  nand2  g112(.a(new_n75_), .b(new_n82_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n131_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  nor2   g115(.a(new_n82_), .b(x04), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n75_), .c(x30), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n177_), .c(new_n129_), .O(z18));
  aoi21  g118(.a(new_n131_), .b(x28), .c(new_n81_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(x27), .c(x35), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n72_), .c(new_n129_), .O(new_n183_));
