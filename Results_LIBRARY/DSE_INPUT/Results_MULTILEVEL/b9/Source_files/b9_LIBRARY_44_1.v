...
module FAU ( 
  ...
  oai21  g067(.a(x29), .b(new_n64_), .c(new_n90_), .O(new_n130_));
  nand2  g068(.a(new_n75_), .b(x29), .O(new_n131_));
  nor2   g069(.a(new_n64_), .b(new_n65_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n84_), .c(new_n91_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n131_), .c(new_n130_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n81_), .c(new_n129_), .O(new_n135_));
  ...
  nand3  g089(.a(new_n123_), .b(new_n142_), .c(new_n65_), .O(new_n152_));
  ...
  oai22  g107(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n91_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  inv1   g109(.a(new_n84_), .O(new_n172_));
  nor2   g110(.a(new_n64_), .b(x04), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(x30), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n171_), .c(new_n129_), .O(z18));
  oai21  g113(.a(new_n66_), .b(new_n64_), .c(new_n90_), .O(new_n176_));
  oai21  g114(.a(new_n91_), .b(x27), .c(x35), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n75_), .O(new_n178_));
  oai21  g116(.a(new_n83_), .b(x27), .c(x35), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n91_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n178_), .c(new_n176_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n81_), .c(new_n129_), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z20));
  inv1   g121(.a(new_n135_), .O(z19));
endmodule
