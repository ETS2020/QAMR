...
module FAU ( 
  ...
  nand2  g069(.a(new_n84_), .b(new_n91_), .O(new_n132_));
  nand3  g070(.a(new_n83_), .b(x27), .c(x04), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n134_));
