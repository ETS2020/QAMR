...
module FAU ( 
  ...
  nand3  g45(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n92_));
  ...
  nand3  g54(.a(new_n100_), .b(new_n51_), .c(new_n48_), .O(new_n101_));
  nor2   g55(.a(new_n101_), .b(x17), .O(new_n102_));
  aoi21  g56(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n99_), .O(z12));
  ...
  nand3  g62(.a(new_n100_), .b(new_n74_), .c(new_n51_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n84_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n87_), .c(new_n108_), .O(z13));
  ...
  nand3  g69(.a(x23), .b(new_n57_), .c(new_n54_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  aoi22  g71(.a(new_n117_), .b(new_n84_), .c(new_n109_), .d(x24), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n87_), .c(new_n115_), .O(z14));
