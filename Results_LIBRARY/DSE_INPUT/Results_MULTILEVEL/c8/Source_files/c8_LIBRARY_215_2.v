...
module FAU ( 
  ...
  nand3  g38(.a(new_n51_), .b(new_n48_), .c(new_n76_), .O(new_n85_));
  oai21  g39(.a(new_n75_), .b(new_n51_), .c(new_n85_), .O(new_n86_));
  ...
  aoi22  g47(.a(new_n93_), .b(new_n75_), .c(new_n85_), .d(x21), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n80_), .c(new_n92_), .O(z11));
  nor2   g49(.a(x18), .b(new_n57_), .O(new_n96_));
  aoi21  g50(.a(x18), .b(x03), .c(new_n96_), .O(new_n97_));
  nand4  g51(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n76_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x16), .O(new_n99_));
  oai21  g53(.a(new_n97_), .b(x16), .c(new_n99_), .O(z12));
  inv1   g54(.a(x12), .O(new_n101_));
  nand2  g55(.a(x18), .b(x04), .O(new_n102_));
  oai21  g56(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n80_), .O(new_n104_));
  oai21  g58(.a(new_n60_), .b(new_n80_), .c(new_n104_), .O(z13));
  ...
  oai21  g63(.a(new_n63_), .b(new_n80_), .c(new_n109_), .O(z14));
  ...
  oai21  g68(.a(new_n66_), .b(new_n80_), .c(new_n114_), .O(z15));
  ...
  oai21  g73(.a(new_n69_), .b(new_n80_), .c(new_n119_), .O(z16));
