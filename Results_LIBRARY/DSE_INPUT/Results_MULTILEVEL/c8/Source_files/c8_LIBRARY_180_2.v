// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:49 2020
...
module FAU ( 
  ...
  nand2  g51(.a(new_n94_), .b(x22), .O(new_n98_));
  nor2   g52(.a(x22), .b(x21), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n74_), .c(new_n51_), .O(new_n100_));
  and2   g54(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand3  g55(.a(x18), .b(new_n87_), .c(x03), .O(new_n102_));
  oai21  g56(.a(new_n101_), .b(new_n87_), .c(new_n102_), .O(z12));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n84_), .c(new_n100_), .d(x23), .O(new_n109_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n99_), .c(new_n92_), .d(new_n72_), .O(new_n117_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n95_), .c(new_n117_), .d(x25), .O(new_n127_));
