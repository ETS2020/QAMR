// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:59 2020
...
module FAU ( 
  ...
  nand2  g45(.a(new_n91_), .b(new_n72_), .O(new_n92_));
  nor2   g46(.a(x21), .b(x20), .O(new_n93_));
  aoi22  g47(.a(new_n93_), .b(new_n74_), .c(new_n92_), .d(x21), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n87_), .c(new_n90_), .O(z11));
  ...
  nand2  g52(.a(new_n93_), .b(new_n74_), .O(new_n99_));
  ...
  oai21  g57(.a(new_n103_), .b(new_n87_), .c(new_n98_), .O(z12));
  nand2  g58(.a(x18), .b(x04), .O(new_n105_));
  oai21  g59(.a(x18), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n84_), .c(new_n102_), .d(x23), .O(new_n109_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n101_), .c(new_n91_), .d(new_n72_), .O(new_n117_));
  ...
  nor2   g78(.a(x17), .b(new_n87_), .O(new_n125_));
  nor3   g79(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n101_), .d(new_n91_), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(z15));
  ...
  nand2  g85(.a(new_n117_), .b(x26), .O(new_n132_));
  nor2   g86(.a(x23), .b(x22), .O(new_n133_));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n93_), .d(new_n74_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g91(.a(x26), .b(x25), .O(new_n138_));
  nand3  g92(.a(new_n138_), .b(new_n137_), .c(new_n131_), .O(z16));
  nor2   g93(.a(new_n48_), .b(x17), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n134_), .c(new_n133_), .d(new_n93_), .O(new_n141_));
  nand2  g95(.a(x27), .b(x17), .O(new_n142_));
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n87_), .O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
