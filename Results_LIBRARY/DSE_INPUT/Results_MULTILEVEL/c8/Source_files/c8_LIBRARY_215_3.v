...
module FAU ( 
  ...
  nand4  g54(.a(new_n100_), .b(new_n48_), .c(new_n72_), .d(x16), .O(new_n101_));
  oai21  g55(.a(new_n99_), .b(x16), .c(new_n101_), .O(z12));
  ...
  nand2  g60(.a(new_n94_), .b(x23), .O(new_n107_));
  nor2   g61(.a(x23), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n74_), .c(new_n51_), .O(new_n109_));
  ...
  nor3   g69(.a(x24), .b(x23), .c(x21), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n84_), .c(new_n109_), .d(x24), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n87_), .c(new_n115_), .O(z14));
  ...
  aoi21  g76(.a(new_n116_), .b(new_n84_), .c(new_n66_), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n108_), .c(new_n92_), .d(new_n72_), .O(new_n125_));
  ...
  nand4  g90(.a(new_n134_), .b(new_n100_), .c(x19), .d(new_n72_), .O(new_n137_));
