...
module FAU ( 
  ...
  oai21  g50(.a(new_n96_), .b(new_n87_), .c(new_n90_), .O(z11));
  ...
  nand2  g54(.a(new_n94_), .b(x22), .O(new_n101_));
  ...
  oai21  g58(.a(new_n104_), .b(new_n87_), .c(new_n100_), .O(z12));
  nand2  g59(.a(x18), .b(x04), .O(new_n106_));
  oai21  g60(.a(x18), .b(new_n60_), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n84_), .c(new_n103_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n87_), .c(new_n108_), .O(z13));
  ...
  nand4  g71(.a(new_n117_), .b(new_n102_), .c(new_n91_), .d(new_n72_), .O(new_n118_));
  ...
  nand3  g79(.a(new_n118_), .b(x25), .c(x16), .O(new_n126_));
  nor2   g80(.a(x23), .b(x22), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n95_), .c(new_n66_), .d(new_n63_), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n126_), .c(new_n125_), .O(z15));
  inv1   g83(.a(x15), .O(new_n130_));
  nand2  g84(.a(x18), .b(x07), .O(new_n131_));
  oai21  g85(.a(x18), .b(new_n130_), .c(new_n131_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n87_), .O(new_n133_));
  nand2  g87(.a(new_n118_), .b(x26), .O(new_n134_));
  nor2   g88(.a(x26), .b(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n127_), .c(new_n93_), .d(new_n74_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n66_), .O(new_n138_));
  nand3  g92(.a(x26), .b(x25), .c(x16), .O(new_n139_));
  nand3  g93(.a(new_n139_), .b(new_n138_), .c(new_n133_), .O(z16));
  nand3  g94(.a(x27), .b(x17), .c(x16), .O(new_n141_));
  nand3  g95(.a(new_n93_), .b(x19), .c(new_n72_), .O(new_n142_));
  nand4  g96(.a(new_n127_), .b(new_n69_), .c(new_n66_), .d(new_n63_), .O(new_n143_));
  oai21  g97(.a(new_n143_), .b(new_n142_), .c(new_n141_), .O(z17));
  buf    g98(.a(x27), .O(z08));
endmodule
