...
module FAU ( 
  ...
  aoi22  g063(.a(new_n109_), .b(new_n87_), .c(new_n106_), .d(x23), .O(new_n110_));
  inv1   g064(.a(x18), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n76_), .c(x12), .O(new_n112_));
  oai21  g066(.a(new_n110_), .b(new_n76_), .c(new_n112_), .O(z13));
  ...
  aoi21  g071(.a(new_n109_), .b(new_n87_), .c(new_n63_), .O(new_n118_));
