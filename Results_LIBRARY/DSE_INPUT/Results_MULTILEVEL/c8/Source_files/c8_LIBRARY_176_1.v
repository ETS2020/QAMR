...
module FAU ( 
  ...
  nand2  g003(.a(new_n47_), .b(new_n49_), .O(new_n50_));
  oai21  g004(.a(new_n47_), .b(x09), .c(new_n50_), .O(z01));
  inv1   g005(.a(x21), .O(new_n52_));
  nand2  g006(.a(new_n47_), .b(new_n52_), .O(new_n53_));
  oai21  g007(.a(new_n47_), .b(x10), .c(new_n53_), .O(z02));
  ...
  nor2   g097(.a(new_n71_), .b(x17), .O(new_n144_));
