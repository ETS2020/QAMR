...
module FAU ( 
  ...
  nand3  g036(.a(new_n82_), .b(new_n80_), .c(x09), .O(new_n83_));
  ...
  oai21  g059(.a(new_n105_), .b(new_n80_), .c(new_n101_), .O(z12));
  ...
  oai21  g084(.a(new_n130_), .b(new_n80_), .c(new_n127_), .O(z15));
  nand2  g085(.a(x18), .b(x07), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n69_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n80_), .O(new_n134_));
