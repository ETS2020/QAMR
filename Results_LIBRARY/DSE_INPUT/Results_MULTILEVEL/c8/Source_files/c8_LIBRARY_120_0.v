...
module FAU ( 
  ...
  nand3  g38(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n85_));
  oai21  g39(.a(new_n74_), .b(new_n51_), .c(new_n85_), .O(new_n86_));
  ...
  aoi22  g46(.a(new_n92_), .b(new_n74_), .c(new_n85_), .d(x21), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n80_), .c(new_n91_), .O(z11));
  ...
  aoi21  g53(.a(new_n99_), .b(new_n72_), .c(new_n57_), .O(new_n100_));
  nand4  g54(.a(x21), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n101_));
