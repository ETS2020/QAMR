...
module FAU ( 
  ...
  nand2  g038(.a(new_n48_), .b(new_n72_), .O(new_n85_));
  ...
  nand2  g054(.a(new_n94_), .b(new_n74_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(x22), .c(x16), .O(new_n102_));
  nor2   g056(.a(x22), .b(x21), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n74_), .c(new_n51_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(z12));
  ...
  aoi21  g063(.a(new_n94_), .b(new_n74_), .c(new_n60_), .O(new_n110_));
  nand3  g064(.a(new_n60_), .b(new_n54_), .c(new_n51_), .O(new_n111_));
  nor2   g065(.a(new_n111_), .b(new_n85_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n110_), .c(new_n57_), .O(new_n113_));
  nand3  g067(.a(x23), .b(x22), .c(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n113_), .c(new_n109_), .O(z13));
  nor2   g069(.a(x23), .b(x22), .O(new_n116_));
  nor2   g070(.a(new_n116_), .b(new_n80_), .O(new_n117_));
  aoi21  g071(.a(new_n94_), .b(new_n74_), .c(x22), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n103_), .c(new_n86_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n122_), .c(new_n119_), .O(z14));
  ...
  aoi21  g082(.a(new_n123_), .b(new_n57_), .c(new_n80_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n118_), .c(x25), .O(new_n130_));
  inv1   g084(.a(new_n101_), .O(new_n131_));
  nor2   g085(.a(x25), .b(x24), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n116_), .c(new_n131_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n130_), .c(new_n128_), .O(z15));
  ...
  aoi21  g091(.a(new_n132_), .b(new_n116_), .c(new_n80_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n118_), .c(x26), .O(new_n139_));
  nor3   g093(.a(x26), .b(x25), .c(x24), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n116_), .c(new_n131_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n139_), .c(new_n137_), .O(z16));
  nand2  g096(.a(new_n140_), .b(new_n116_), .O(new_n143_));
  nand3  g097(.a(x27), .b(x17), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n94_), .b(x19), .c(new_n72_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n143_), .c(new_n144_), .O(z17));
