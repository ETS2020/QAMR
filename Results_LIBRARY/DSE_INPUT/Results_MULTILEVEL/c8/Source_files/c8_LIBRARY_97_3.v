...
module FAU ( 
  ...
  aoi21  g033(.a(x18), .b(x01), .c(x09), .O(new_n80_));
  nor2   g034(.a(new_n74_), .b(new_n51_), .O(new_n81_));
  ...
  aoi21  g069(.a(new_n109_), .b(new_n82_), .c(new_n63_), .O(new_n116_));
  ...
  oai21  g082(.a(new_n128_), .b(new_n85_), .c(new_n125_), .O(z15));
