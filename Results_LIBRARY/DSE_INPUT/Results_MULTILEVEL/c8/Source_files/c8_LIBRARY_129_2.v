...
module FAU ( 
  ...
  aoi21  g67(.a(new_n111_), .b(new_n84_), .c(new_n63_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n103_), .c(new_n92_), .d(new_n72_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g72(.a(x18), .b(new_n87_), .c(x05), .O(new_n119_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n95_), .c(new_n116_), .d(x25), .O(new_n127_));
