...
module FAU ( 
  ...
  aoi22  g065(.a(new_n111_), .b(new_n81_), .c(new_n104_), .d(x23), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n81_), .c(new_n63_), .O(new_n118_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n119_), .d(new_n103_), .O(new_n147_));
  nand2  g101(.a(x27), .b(x17), .O(new_n148_));
  aoi21  g102(.a(new_n148_), .b(new_n147_), .c(new_n80_), .O(z17));
