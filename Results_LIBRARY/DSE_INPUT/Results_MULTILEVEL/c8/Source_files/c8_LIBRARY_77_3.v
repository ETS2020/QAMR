...
module FAU ( 
  ...
  inv1   g44(.a(new_n84_), .O(new_n91_));
  ...
  nand2  g61(.a(new_n101_), .b(new_n74_), .O(new_n108_));
  ...
  aoi21  g69(.a(new_n66_), .b(x21), .c(x24), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n60_), .c(new_n57_), .d(new_n51_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(x19), .O(new_n118_));
  aoi21  g72(.a(new_n109_), .b(new_n84_), .c(new_n63_), .O(new_n119_));
  aoi21  g73(.a(new_n118_), .b(new_n72_), .c(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n87_), .c(new_n115_), .O(z14));
  inv1   g75(.a(x14), .O(new_n122_));
  nor2   g76(.a(x18), .b(new_n122_), .O(new_n123_));
  aoi21  g77(.a(x18), .b(x06), .c(new_n123_), .O(new_n124_));
  nor3   g78(.a(x24), .b(x23), .c(x22), .O(new_n125_));
  aoi21  g79(.a(new_n125_), .b(new_n84_), .c(new_n66_), .O(new_n126_));
  nor2   g80(.a(x23), .b(x22), .O(new_n127_));
  nand3  g81(.a(new_n127_), .b(new_n66_), .c(new_n63_), .O(new_n128_));
  nor2   g82(.a(new_n128_), .b(new_n93_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n126_), .c(x16), .O(new_n130_));
  oai21  g84(.a(new_n124_), .b(x16), .c(new_n130_), .O(z15));
  inv1   g85(.a(x15), .O(new_n132_));
  nor2   g86(.a(x18), .b(new_n132_), .O(new_n133_));
  aoi21  g87(.a(x18), .b(x07), .c(new_n133_), .O(new_n134_));
  nand4  g88(.a(new_n127_), .b(new_n69_), .c(new_n66_), .d(new_n63_), .O(new_n135_));
  oai22  g89(.a(new_n135_), .b(new_n93_), .c(new_n129_), .d(new_n69_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x16), .O(new_n137_));
  oai21  g91(.a(new_n134_), .b(x16), .c(new_n137_), .O(z16));
  nand3  g92(.a(new_n92_), .b(x19), .c(new_n72_), .O(new_n139_));
  or2    g93(.a(new_n139_), .b(new_n135_), .O(new_n140_));
