// Benchmark "FAU" written by ABC on Mon Jul 27 17:51:35 2020
...
module FAU ( 
  ...
  aoi22  g63(.a(new_n109_), .b(new_n85_), .c(new_n102_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n88_), .c(new_n108_), .O(z13));
  inv1   g65(.a(x13), .O(new_n112_));
  nor2   g66(.a(x18), .b(new_n112_), .O(new_n113_));
  aoi21  g67(.a(x18), .b(x05), .c(new_n113_), .O(new_n114_));
  aoi21  g68(.a(new_n109_), .b(new_n85_), .c(new_n63_), .O(new_n115_));
  nand3  g69(.a(new_n101_), .b(new_n63_), .c(new_n60_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n115_), .c(x16), .O(new_n118_));
  oai21  g72(.a(new_n114_), .b(x16), .c(new_n118_), .O(z14));
  inv1   g73(.a(x14), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  oai21  g75(.a(x18), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n88_), .O(new_n123_));
  nand2  g77(.a(new_n69_), .b(x23), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n66_), .c(new_n63_), .d(new_n57_), .O(new_n125_));
  nor2   g79(.a(new_n125_), .b(x21), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n127_));
  oai21  g81(.a(new_n116_), .b(new_n84_), .c(x25), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x16), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n123_), .O(z15));
  inv1   g85(.a(x15), .O(new_n132_));
  nor2   g86(.a(x18), .b(new_n132_), .O(new_n133_));
  aoi21  g87(.a(x18), .b(x07), .c(new_n133_), .O(new_n134_));
  nand3  g88(.a(new_n101_), .b(new_n66_), .c(new_n63_), .O(new_n135_));
  oai21  g89(.a(new_n135_), .b(new_n84_), .c(x26), .O(new_n136_));
  nor2   g90(.a(x23), .b(x22), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n69_), .c(new_n66_), .d(new_n63_), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(new_n99_), .c(new_n136_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  oai21  g94(.a(new_n134_), .b(x16), .c(new_n140_), .O(z16));
