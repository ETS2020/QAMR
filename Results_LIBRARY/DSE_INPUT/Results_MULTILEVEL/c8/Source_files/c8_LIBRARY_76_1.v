...
module FAU ( 
  ...
  oai21  g40(.a(new_n84_), .b(x21), .c(x16), .O(new_n87_));
  nor2   g41(.a(x18), .b(new_n54_), .O(new_n88_));
  aoi21  g42(.a(x18), .b(x02), .c(new_n88_), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(x16), .c(new_n87_), .O(z11));
  ...
  nand4  g51(.a(new_n57_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n98_));
  ...
  nand3  g61(.a(new_n107_), .b(new_n74_), .c(new_n51_), .O(new_n108_));
  ...
  aoi22  g69(.a(new_n115_), .b(new_n84_), .c(new_n108_), .d(x24), .O(new_n116_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n107_), .c(new_n96_), .d(new_n72_), .O(new_n124_));
  ...
  nor3   g91(.a(x26), .b(x25), .c(x24), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n107_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n91_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
