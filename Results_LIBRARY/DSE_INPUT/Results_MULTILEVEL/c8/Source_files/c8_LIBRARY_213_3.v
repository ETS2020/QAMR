...
module FAU ( 
  ...
  nand4  g046(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n90_), .O(new_n93_));
  inv1   g047(.a(new_n93_), .O(new_n94_));
  aoi21  g048(.a(new_n92_), .b(x21), .c(new_n94_), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n85_), .c(new_n89_), .O(z11));
  ...
  nand3  g056(.a(new_n102_), .b(new_n75_), .c(new_n51_), .O(new_n103_));
  and2   g057(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n85_), .c(new_n100_), .O(z12));
  ...
  aoi22  g064(.a(new_n110_), .b(new_n82_), .c(new_n103_), .d(x23), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n85_), .c(new_n109_), .O(z13));
  ...
  aoi21  g070(.a(new_n110_), .b(new_n82_), .c(new_n63_), .O(new_n117_));
  nor2   g071(.a(x24), .b(x23), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n102_), .c(new_n91_), .d(new_n90_), .O(new_n119_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n75_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x26), .O(new_n138_));
  nor3   g092(.a(x26), .b(x25), .c(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n135_), .c(new_n134_), .d(new_n75_), .O(new_n140_));
