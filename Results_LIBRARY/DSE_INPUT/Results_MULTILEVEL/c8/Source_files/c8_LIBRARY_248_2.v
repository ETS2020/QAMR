// Benchmark "FAU" written by ABC on Mon Jul 27 17:52:01 2020
...
module FAU ( 
  ...
  aoi21  g030(.a(new_n76_), .b(x08), .c(x00), .O(new_n77_));
  oai21  g031(.a(new_n77_), .b(x16), .c(new_n75_), .O(z09));
  ...
  oai21  g050(.a(new_n96_), .b(new_n79_), .c(new_n91_), .O(z11));
  ...
  oai21  g059(.a(new_n105_), .b(new_n79_), .c(new_n101_), .O(z12));
  ...
  aoi22  g065(.a(new_n111_), .b(new_n85_), .c(new_n104_), .d(x23), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n79_), .c(new_n110_), .O(z13));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n85_), .c(new_n63_), .O(new_n118_));
  nor2   g072(.a(x24), .b(x23), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n103_), .c(new_n92_), .d(new_n72_), .O(new_n120_));
  ...
  nand2  g080(.a(new_n126_), .b(new_n79_), .O(new_n127_));
  nand4  g081(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n95_), .c(new_n120_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n79_), .c(new_n127_), .O(z15));
  nand2  g085(.a(x18), .b(x07), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n69_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n79_), .O(new_n134_));
  ...
  aoi21  g101(.a(new_n147_), .b(new_n146_), .c(new_n79_), .O(z17));
