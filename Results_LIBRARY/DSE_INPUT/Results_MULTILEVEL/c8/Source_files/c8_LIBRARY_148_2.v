...
module FAU ( 
  ...
  aoi21  g71(.a(new_n111_), .b(new_n84_), .c(new_n63_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n103_), .c(new_n92_), .d(new_n72_), .O(new_n120_));
  ...
  nand4  g77(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n95_), .c(new_n120_), .d(x25), .O(new_n126_));
  nand3  g80(.a(x18), .b(new_n87_), .c(x06), .O(new_n127_));
