...
module FAU ( 
  ...
  nand3  g36(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n83_));
  oai21  g37(.a(new_n74_), .b(new_n51_), .c(new_n83_), .O(new_n84_));
  ...
  nor3   g45(.a(x21), .b(x20), .c(x19), .O(new_n92_));
  aoi22  g46(.a(new_n92_), .b(new_n72_), .c(new_n83_), .d(x21), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n87_), .c(new_n91_), .O(z11));
  ...
  aoi22  g54(.a(new_n100_), .b(new_n74_), .c(new_n99_), .d(x22), .O(new_n101_));
  ...
  nand2  g59(.a(new_n57_), .b(new_n54_), .O(new_n106_));
  nand4  g60(.a(new_n106_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n107_));
  nand2  g61(.a(new_n83_), .b(x23), .O(new_n108_));
  ...
  oai21  g69(.a(new_n63_), .b(new_n87_), .c(new_n115_), .O(z14));
  ...
  oai21  g74(.a(new_n66_), .b(new_n87_), .c(new_n120_), .O(z15));
  ...
  oai21  g79(.a(new_n69_), .b(new_n87_), .c(new_n125_), .O(z16));
  nand3  g80(.a(x27), .b(x17), .c(x16), .O(new_n127_));
