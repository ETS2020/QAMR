...
module FAU ( 
  ...
  oai21  g038(.a(x19), .b(x17), .c(x20), .O(new_n85_));
  nor2   g039(.a(x20), .b(x19), .O(new_n86_));
  nand3  g040(.a(new_n86_), .b(new_n72_), .c(x16), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(z10));
  ...
  oai21  g048(.a(new_n74_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(x16), .O(new_n96_));
  nand2  g050(.a(x21), .b(x20), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(z11));
  ...
  nor3   g056(.a(x21), .b(x19), .c(x17), .O(new_n103_));
  ...
  nand2  g061(.a(x22), .b(x20), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z12));
  ...
  aoi21  g067(.a(new_n104_), .b(new_n74_), .c(new_n60_), .O(new_n114_));
  nand2  g068(.a(new_n86_), .b(new_n72_), .O(new_n115_));
  nor2   g069(.a(x23), .b(x22), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n54_), .O(new_n117_));
  nor2   g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n114_), .c(x16), .O(new_n119_));
  nand2  g073(.a(x23), .b(x20), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n119_), .c(new_n113_), .O(z13));
  ...
  nand3  g078(.a(new_n116_), .b(new_n74_), .c(new_n54_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x24), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n104_), .c(new_n86_), .d(new_n72_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x16), .O(new_n130_));
  nand2  g084(.a(x24), .b(x20), .O(new_n131_));
  ...
  aoi21  g091(.a(new_n137_), .b(new_n103_), .c(new_n66_), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n116_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n94_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand2  g096(.a(x25), .b(x20), .O(new_n143_));
  ...
  nor2   g101(.a(x21), .b(x19), .O(new_n148_));
  nand4  g102(.a(new_n139_), .b(new_n116_), .c(new_n148_), .d(new_n72_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n116_), .c(new_n93_), .d(new_n74_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(x26), .b(x20), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n147_), .O(z16));
  nor2   g110(.a(new_n48_), .b(x17), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n151_), .c(new_n116_), .d(new_n93_), .O(new_n158_));
