...
module FAU ( 
  ...
  nand2  g42(.a(new_n76_), .b(x10), .O(new_n89_));
  ...
  nand2  g48(.a(new_n76_), .b(x11), .O(new_n95_));
  ...
  nand2  g52(.a(new_n76_), .b(x12), .O(new_n99_));
  ...
  nand2  g59(.a(new_n76_), .b(x13), .O(new_n106_));
  ...
  nand2  g64(.a(new_n76_), .b(x14), .O(new_n111_));
  ...
  nand2  g75(.a(new_n76_), .b(x15), .O(new_n122_));
