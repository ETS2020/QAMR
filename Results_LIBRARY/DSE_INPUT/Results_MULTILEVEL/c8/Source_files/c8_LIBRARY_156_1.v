...
module FAU ( 
  ...
  nand4  g81(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n128_));
  inv1   g82(.a(new_n128_), .O(new_n129_));
  aoi22  g83(.a(new_n129_), .b(new_n95_), .c(new_n120_), .d(x25), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(new_n87_), .c(new_n127_), .O(z15));
  nor2   g85(.a(new_n128_), .b(new_n94_), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(x26), .c(x16), .O(new_n133_));
  ...
  nand2  g90(.a(new_n136_), .b(new_n133_), .O(z16));
  nor2   g91(.a(x21), .b(x20), .O(new_n138_));
  nand4  g92(.a(new_n129_), .b(new_n138_), .c(x19), .d(new_n72_), .O(new_n139_));
