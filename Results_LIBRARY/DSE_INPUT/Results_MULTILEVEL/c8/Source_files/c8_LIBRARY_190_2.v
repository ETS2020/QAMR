...
module FAU ( 
  ...
  nand3  g036(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n83_));
  ...
  nand3  g046(.a(new_n74_), .b(new_n54_), .c(new_n51_), .O(new_n93_));
  inv1   g047(.a(new_n93_), .O(new_n94_));
  aoi21  g048(.a(new_n83_), .b(x21), .c(new_n94_), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n88_), .c(new_n92_), .O(z11));
  ...
  nand2  g054(.a(new_n57_), .b(new_n54_), .O(new_n101_));
  nor2   g055(.a(new_n101_), .b(x20), .O(new_n102_));
  aoi22  g056(.a(new_n102_), .b(new_n74_), .c(new_n93_), .d(x22), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n88_), .c(new_n100_), .O(z12));
  ...
  nand2  g062(.a(new_n102_), .b(new_n74_), .O(new_n109_));
  nor3   g063(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g064(.a(new_n110_), .b(new_n84_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n88_), .c(new_n108_), .O(z13));
  ...
  nand4  g072(.a(new_n118_), .b(new_n84_), .c(new_n57_), .d(new_n54_), .O(new_n119_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n66_), .c(new_n63_), .O(new_n128_));
  nor2   g082(.a(new_n128_), .b(new_n93_), .O(new_n129_));
  aoi21  g083(.a(new_n119_), .b(x25), .c(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n88_), .c(new_n126_), .O(z15));
  ...
  nand3  g089(.a(new_n135_), .b(new_n127_), .c(new_n63_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n138_));
  oai21  g092(.a(new_n128_), .b(new_n83_), .c(x26), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n134_), .O(z16));
  nor2   g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nor2   g097(.a(x22), .b(x20), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n135_), .d(new_n118_), .O(new_n145_));
