...
module FAU ( 
  ...
  nand2  g065(.a(x15), .b(new_n73_), .O(new_n117_));
  ...
  aoi22  g076(.a(new_n63_), .b(new_n113_), .c(new_n73_), .d(x05), .O(new_n128_));
  ...
  aoi21  g092(.a(x09), .b(new_n78_), .c(new_n90_), .O(new_n144_));
  ...
  nand4  g113(.a(x21), .b(new_n90_), .c(new_n73_), .d(x06), .O(new_n165_));
  ...
  nand3  g129(.a(new_n66_), .b(new_n107_), .c(new_n173_), .O(new_n181_));
  ...
  oai21  g137(.a(new_n90_), .b(x02), .c(x13), .O(new_n189_));
  ...
  nand2  g141(.a(new_n107_), .b(new_n173_), .O(new_n193_));
  ...
  nand3  g150(.a(new_n63_), .b(new_n113_), .c(x04), .O(new_n202_));
  ...
  oai21  g155(.a(new_n206_), .b(x15), .c(new_n87_), .O(new_n207_));
  ...
  nand2  g185(.a(new_n167_), .b(new_n113_), .O(new_n237_));
  ...
  nand4  g203(.a(new_n254_), .b(x15), .c(new_n90_), .d(new_n57_), .O(new_n255_));
  ...
  nor3   g224(.a(new_n131_), .b(new_n52_), .c(x17), .O(new_n276_));
  ...
  nand3  g237(.a(new_n123_), .b(x15), .c(new_n90_), .O(new_n289_));
  ...
  oai21  g242(.a(new_n75_), .b(new_n113_), .c(new_n202_), .O(new_n294_));
  nand2  g243(.a(new_n294_), .b(new_n73_), .O(new_n295_));
  nand4  g244(.a(new_n189_), .b(new_n80_), .c(new_n79_), .d(x08), .O(new_n296_));
  ...
  nand3  g266(.a(new_n150_), .b(new_n131_), .c(x07), .O(new_n318_));
  ...
  oai21  g277(.a(x15), .b(x07), .c(new_n52_), .O(new_n329_));
  oai22  g278(.a(new_n329_), .b(new_n53_), .c(new_n54_), .d(x01), .O(new_n330_));
  nand3  g279(.a(new_n330_), .b(new_n72_), .c(new_n57_), .O(new_n331_));
  ...
  aoi22  g283(.a(x13), .b(new_n167_), .c(new_n63_), .d(x04), .O(new_n335_));
  ...
  nand4  g288(.a(new_n336_), .b(x16), .c(x12), .d(new_n113_), .O(new_n340_));
  ...
  nand3  g299(.a(x12), .b(new_n113_), .c(new_n62_), .O(new_n351_));
  oai21  g300(.a(new_n118_), .b(new_n78_), .c(new_n351_), .O(new_n352_));
  ...
  nand4  g306(.a(new_n217_), .b(new_n102_), .c(x15), .d(new_n90_), .O(new_n358_));
  ...
  nor3   g311(.a(new_n361_), .b(new_n174_), .c(new_n113_), .O(new_n363_));
  aoi21  g312(.a(new_n362_), .b(new_n113_), .c(new_n363_), .O(new_n364_));
  ...
  nand4  g330(.a(new_n381_), .b(new_n73_), .c(new_n113_), .d(new_n57_), .O(new_n382_));
  ...
  nand4  g334(.a(new_n385_), .b(new_n260_), .c(new_n67_), .d(x04), .O(new_n386_));
  ...
  nand4  g399(.a(new_n450_), .b(new_n276_), .c(new_n161_), .d(new_n100_), .O(new_n451_));
  ...
  nand2  g416(.a(new_n131_), .b(x15), .O(new_n468_));
