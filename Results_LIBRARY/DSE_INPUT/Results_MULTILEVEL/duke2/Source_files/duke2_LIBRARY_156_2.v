...
module FAU ( 
  ...
  aoi22  g073(.a(new_n63_), .b(new_n113_), .c(new_n73_), .d(x05), .O(new_n125_));
  nand2  g074(.a(new_n55_), .b(new_n57_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(x21), .c(x08), .O(new_n127_));
  oai21  g076(.a(new_n125_), .b(x15), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g149(.a(new_n63_), .b(new_n113_), .c(x04), .O(new_n201_));
  ...
  nand2  g174(.a(new_n73_), .b(new_n113_), .O(new_n226_));
  ...
  nand2  g184(.a(new_n166_), .b(new_n113_), .O(new_n236_));
  ...
  nor2   g194(.a(new_n130_), .b(new_n72_), .O(new_n246_));
  ...
  nor3   g223(.a(new_n130_), .b(new_n52_), .c(x17), .O(new_n275_));
  ...
  nand3  g236(.a(new_n122_), .b(x15), .c(new_n90_), .O(new_n288_));
  ...
  oai21  g241(.a(new_n75_), .b(new_n113_), .c(new_n201_), .O(new_n293_));
  nand2  g242(.a(new_n293_), .b(new_n73_), .O(new_n294_));
  nand4  g243(.a(new_n188_), .b(new_n80_), .c(new_n79_), .d(x08), .O(new_n295_));
  aoi21  g244(.a(new_n295_), .b(new_n294_), .c(x15), .O(new_n296_));
  nand2  g245(.a(new_n91_), .b(new_n85_), .O(new_n297_));
  ...
  nand3  g265(.a(new_n149_), .b(new_n130_), .c(x07), .O(new_n317_));
  ...
  aoi22  g282(.a(x13), .b(new_n166_), .c(new_n63_), .d(x04), .O(new_n334_));
  ...
  nand3  g298(.a(new_n90_), .b(x06), .c(x02), .O(new_n350_));
  ...
  nand4  g306(.a(new_n216_), .b(new_n102_), .c(x15), .d(new_n90_), .O(new_n358_));
  ...
  nor3   g311(.a(new_n361_), .b(new_n173_), .c(new_n113_), .O(new_n363_));
  ...
  nand3  g387(.a(new_n131_), .b(new_n73_), .c(x05), .O(new_n439_));
