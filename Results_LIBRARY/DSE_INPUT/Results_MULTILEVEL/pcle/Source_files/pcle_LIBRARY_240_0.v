// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:32 2020
...
module FAU ( 
  ...
  nor2   g51(.a(new_n62_), .b(new_n56_), .O(new_n80_));
  nor2   g52(.a(x17), .b(new_n72_), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n54_), .c(new_n79_), .O(new_n83_));
  ...
  nand3  g58(.a(new_n80_), .b(x17), .c(x16), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n54_), .c(x18), .O(new_n88_));
  nor2   g60(.a(new_n72_), .b(new_n62_), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n64_), .c(new_n29_), .d(x17), .O(new_n90_));
