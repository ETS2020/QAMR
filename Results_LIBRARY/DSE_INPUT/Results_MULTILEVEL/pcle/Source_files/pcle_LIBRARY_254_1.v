// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:35 2020
...
module FAU ( 
  ...
  aoi22  g26(.a(new_n54_), .b(x09), .c(x12), .d(new_n39_), .O(new_n55_));
  nand4  g27(.a(new_n30_), .b(x13), .c(x12), .d(x11), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n30_), .c(new_n56_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n65_), .b(x15), .c(x09), .O(new_n66_));
  inv1   g38(.a(new_n66_), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n64_), .c(new_n38_), .O(new_n68_));
  nand2  g40(.a(x08), .b(x04), .O(new_n69_));
  oai21  g41(.a(new_n68_), .b(x08), .c(new_n69_), .O(z5));
  inv1   g42(.a(x16), .O(new_n71_));
  nand2  g43(.a(new_n54_), .b(x09), .O(new_n72_));
  nand2  g44(.a(x15), .b(x14), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n39_), .c(x12), .O(new_n74_));
  aoi21  g46(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(new_n75_));
  nand3  g47(.a(x13), .b(x12), .c(x11), .O(new_n76_));
  nand3  g48(.a(new_n71_), .b(x15), .c(x14), .O(new_n77_));
  nor2   g49(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n75_), .c(new_n38_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(x08), .c(new_n80_), .O(z6));
  inv1   g53(.a(x17), .O(new_n82_));
  nand4  g54(.a(x16), .b(x15), .c(x14), .d(x11), .O(new_n83_));
  aoi22  g55(.a(new_n83_), .b(x12), .c(new_n54_), .d(x09), .O(new_n84_));
  nand4  g56(.a(new_n82_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai22  g57(.a(new_n85_), .b(new_n76_), .c(new_n84_), .d(new_n82_), .O(new_n86_));
  nand3  g58(.a(new_n86_), .b(new_n38_), .c(new_n37_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n87_), .O(z7));
  nand2  g61(.a(x14), .b(x11), .O(new_n90_));
  nand3  g62(.a(x17), .b(x16), .c(x15), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n90_), .c(x12), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n72_), .c(new_n29_), .O(new_n93_));
  nand4  g65(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n94_));
  nand4  g66(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n95_));
  nor2   g67(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n93_), .c(new_n38_), .O(new_n97_));
