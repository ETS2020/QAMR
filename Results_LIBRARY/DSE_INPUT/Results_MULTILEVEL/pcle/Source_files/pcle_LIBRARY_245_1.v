...
module FAU ( 
  ...
  oai21  g25(.a(new_n53_), .b(new_n39_), .c(x14), .O(new_n54_));
  nand3  g26(.a(new_n47_), .b(new_n31_), .c(x13), .O(new_n55_));
  ...
  oai21  g40(.a(new_n68_), .b(new_n53_), .c(x16), .O(new_n69_));
  ...
  oai21  g56(.a(new_n84_), .b(new_n60_), .c(x18), .O(new_n85_));
