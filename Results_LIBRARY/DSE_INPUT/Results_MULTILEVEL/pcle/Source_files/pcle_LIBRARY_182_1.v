...
module FAU ( 
  ...
  oai22  g42(.a(new_n70_), .b(new_n53_), .c(new_n63_), .d(new_n69_), .O(new_n71_));
  ...
  nand3  g49(.a(new_n77_), .b(x16), .c(x14), .O(new_n78_));
  ...
  nand4  g56(.a(new_n29_), .b(x17), .c(x16), .d(x14), .O(new_n85_));
