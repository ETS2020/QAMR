...
module FAU ( 
  ...
  oai21  g34(.a(new_n62_), .b(new_n46_), .c(x15), .O(new_n63_));
  ...
  nand3  g57(.a(x14), .b(x13), .c(x12), .O(new_n86_));
  nand3  g58(.a(x17), .b(x16), .c(x15), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n86_), .c(x18), .O(new_n88_));
  nor2   g60(.a(new_n72_), .b(new_n64_), .O(new_n89_));
  inv1   g61(.a(new_n86_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n89_), .c(new_n29_), .d(x17), .O(new_n91_));
  nand3  g63(.a(new_n91_), .b(new_n88_), .c(x11), .O(new_n92_));
