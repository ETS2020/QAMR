// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:33 2020
...
module FAU ( 
  ...
  nand2  g34(.a(new_n62_), .b(x12), .O(new_n63_));
  nand2  g35(.a(new_n63_), .b(x15), .O(new_n64_));
  inv1   g36(.a(x15), .O(new_n65_));
  nand4  g37(.a(new_n65_), .b(x14), .c(x13), .d(x12), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(new_n64_), .c(x11), .O(new_n67_));
  ...
  nor2   g60(.a(new_n73_), .b(new_n65_), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n81_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n89_), .c(new_n62_), .d(new_n48_), .O(new_n91_));
