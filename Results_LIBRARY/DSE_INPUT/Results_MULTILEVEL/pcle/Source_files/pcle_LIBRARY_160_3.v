...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(x14), .c(new_n38_), .O(new_n54_));
  ...
  nand3  g33(.a(new_n61_), .b(x15), .c(new_n38_), .O(new_n62_));
  ...
  oai21  g41(.a(new_n69_), .b(new_n55_), .c(x16), .O(new_n70_));
  inv1   g42(.a(x16), .O(new_n71_));
  nand3  g43(.a(new_n71_), .b(x15), .c(x14), .O(new_n72_));
  oai22  g44(.a(new_n72_), .b(new_n53_), .c(new_n70_), .d(x10), .O(new_n73_));
  ...
  oai22  g52(.a(new_n80_), .b(new_n53_), .c(new_n78_), .d(x10), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(x09), .c(new_n32_), .O(new_n82_));
  ...
  oai22  g59(.a(new_n87_), .b(new_n61_), .c(new_n86_), .d(x10), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(x09), .c(new_n32_), .O(new_n89_));
