...
module FAU ( 
  ...
  oai21  g26(.a(new_n53_), .b(new_n31_), .c(new_n54_), .O(new_n55_));
  nand4  g27(.a(new_n55_), .b(new_n38_), .c(x09), .d(new_n32_), .O(new_n56_));
  ...
  nand2  g33(.a(new_n46_), .b(new_n38_), .O(new_n62_));
  nand3  g34(.a(new_n59_), .b(x14), .c(x13), .O(new_n63_));
  oai22  g35(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(new_n59_), .O(new_n64_));
  nand3  g36(.a(new_n64_), .b(x09), .c(new_n32_), .O(new_n65_));
  nand2  g37(.a(x08), .b(x04), .O(new_n66_));
  nand2  g38(.a(new_n66_), .b(new_n65_), .O(z5));
  nand2  g39(.a(new_n60_), .b(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  nand4  g41(.a(new_n46_), .b(new_n69_), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n68_), .c(new_n59_), .O(new_n71_));
  nand3  g43(.a(x16), .b(new_n59_), .c(new_n38_), .O(new_n72_));
  ...
  aoi22  g50(.a(new_n78_), .b(new_n38_), .c(new_n60_), .d(x15), .O(new_n79_));
  nor2   g51(.a(new_n59_), .b(new_n31_), .O(new_n80_));
  nand4  g52(.a(new_n80_), .b(new_n53_), .c(new_n77_), .d(x16), .O(new_n81_));
  oai21  g53(.a(new_n79_), .b(new_n77_), .c(new_n81_), .O(new_n82_));
  ...
  aoi22  g58(.a(new_n86_), .b(new_n38_), .c(new_n60_), .d(x15), .O(new_n87_));
  inv1   g59(.a(new_n78_), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(new_n61_), .c(new_n29_), .d(x17), .O(new_n89_));
  oai21  g61(.a(new_n87_), .b(new_n29_), .c(new_n89_), .O(new_n90_));
