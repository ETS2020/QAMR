...
module FAU ( 
  ...
  nand3  g21(.a(new_n49_), .b(new_n32_), .c(x09), .O(new_n50_));
  ...
  nand3  g29(.a(new_n57_), .b(new_n32_), .c(x09), .O(new_n58_));
  ...
  nand3  g37(.a(new_n65_), .b(new_n32_), .c(x09), .O(new_n66_));
  ...
  oai22  g44(.a(new_n72_), .b(new_n53_), .c(new_n70_), .d(x08), .O(new_n73_));
  ...
  oai22  g52(.a(new_n80_), .b(new_n53_), .c(new_n78_), .d(x08), .O(new_n81_));
  ...
  oai22  g59(.a(new_n87_), .b(new_n61_), .c(new_n86_), .d(x08), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n32_), .c(x09), .O(new_n89_));
