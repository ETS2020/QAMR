// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:28 2020
...
module FAU ( 
  ...
  nand2  g29(.a(new_n58_), .b(x15), .O(new_n59_));
  ...
  oai21  g38(.a(new_n67_), .b(new_n42_), .c(new_n66_), .O(new_n68_));
  nand4  g39(.a(new_n68_), .b(new_n37_), .c(x09), .d(new_n36_), .O(new_n69_));
  nand2  g40(.a(x08), .b(x05), .O(new_n70_));
  nand2  g41(.a(new_n70_), .b(new_n69_), .O(z6));
  nand2  g42(.a(x08), .b(x06), .O(new_n72_));
  nand3  g43(.a(new_n32_), .b(x17), .c(new_n37_), .O(new_n73_));
  nand2  g44(.a(new_n73_), .b(new_n72_), .O(z7));
  nand2  g45(.a(x08), .b(x07), .O(new_n75_));
  nand3  g46(.a(new_n32_), .b(x18), .c(new_n37_), .O(new_n76_));
