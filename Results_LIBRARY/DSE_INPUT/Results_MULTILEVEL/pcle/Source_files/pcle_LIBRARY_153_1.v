...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(new_n46_), .c(new_n54_), .O(new_n56_));
  ...
  nand3  g56(.a(x14), .b(x13), .c(x12), .O(new_n85_));
  nand3  g57(.a(x17), .b(x16), .c(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n85_), .c(x18), .O(new_n87_));
  nand4  g59(.a(new_n29_), .b(x17), .c(x16), .d(x15), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n85_), .c(new_n87_), .O(new_n89_));
