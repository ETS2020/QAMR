// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:15 2020
...
module FAU ( 
  ...
  nand2  g09(.a(x09), .b(new_n32_), .O(new_n38_));
  nand2  g10(.a(x08), .b(x00), .O(new_n39_));
  inv1   g11(.a(x11), .O(new_n40_));
  nand2  g12(.a(new_n40_), .b(new_n33_), .O(new_n41_));
  oai21  g13(.a(new_n41_), .b(new_n38_), .c(new_n39_), .O(z1));
  nand2  g14(.a(x08), .b(x01), .O(new_n43_));
  inv1   g15(.a(x12), .O(new_n44_));
  nand3  g16(.a(new_n44_), .b(x11), .c(new_n33_), .O(new_n45_));
  oai21  g17(.a(new_n45_), .b(new_n38_), .c(new_n43_), .O(z2));
  ...
  nand3  g24(.a(new_n31_), .b(x13), .c(x12), .O(new_n53_));
  ...
  nand3  g29(.a(x14), .b(x13), .c(x12), .O(new_n58_));
