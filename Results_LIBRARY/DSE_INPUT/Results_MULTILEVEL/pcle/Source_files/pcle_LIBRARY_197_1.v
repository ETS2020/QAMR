...
module FAU ( 
  ...
  nand3  g29(.a(new_n37_), .b(x09), .c(new_n36_), .O(new_n59_));
  nand4  g30(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n60_));
  oai21  g31(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z5));
  nand2  g32(.a(x08), .b(x05), .O(new_n62_));
  nand3  g33(.a(new_n32_), .b(x16), .c(new_n37_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(z6));
  nand2  g35(.a(x08), .b(x06), .O(new_n65_));
  nand3  g36(.a(new_n32_), .b(x17), .c(new_n37_), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n65_), .O(z7));
  nand2  g38(.a(x08), .b(x07), .O(new_n68_));
  nand3  g39(.a(new_n32_), .b(x18), .c(new_n37_), .O(new_n69_));
