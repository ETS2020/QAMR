...
module FAU ( 
  ...
  nand3  g16(.a(new_n40_), .b(new_n44_), .c(x11), .O(new_n45_));
  ...
  oai21  g37(.a(new_n65_), .b(new_n58_), .c(x15), .O(new_n66_));
  inv1   g38(.a(x15), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x14), .c(x13), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n58_), .c(new_n66_), .O(new_n69_));
  ...
  nand3  g57(.a(new_n74_), .b(new_n85_), .c(x16), .O(new_n86_));
  ...
  nand3  g62(.a(new_n29_), .b(x17), .c(x16), .O(new_n91_));
  oai21  g63(.a(new_n91_), .b(new_n73_), .c(x13), .O(new_n92_));
  nor2   g64(.a(new_n29_), .b(x12), .O(new_n93_));
  aoi21  g65(.a(new_n92_), .b(x12), .c(new_n93_), .O(new_n94_));
  nand2  g66(.a(x14), .b(x11), .O(new_n95_));
  nand3  g67(.a(x17), .b(x16), .c(x15), .O(new_n96_));
  oai21  g68(.a(new_n96_), .b(new_n95_), .c(x18), .O(new_n97_));
  oai21  g69(.a(new_n94_), .b(new_n38_), .c(new_n97_), .O(new_n98_));
