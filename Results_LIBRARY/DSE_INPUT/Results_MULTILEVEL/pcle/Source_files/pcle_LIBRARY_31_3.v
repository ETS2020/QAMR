...
module FAU ( 
  ...
  nand3  g31(.a(new_n47_), .b(x14), .c(x13), .O(new_n60_));
  ...
  nand4  g50(.a(new_n54_), .b(new_n78_), .c(x15), .d(x14), .O(new_n79_));
  ...
  oai21  g57(.a(new_n78_), .b(new_n71_), .c(new_n38_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n69_), .c(new_n29_), .O(new_n87_));
  ...
  oai21  g63(.a(new_n90_), .b(x08), .c(new_n91_), .O(z8));
endmodule
