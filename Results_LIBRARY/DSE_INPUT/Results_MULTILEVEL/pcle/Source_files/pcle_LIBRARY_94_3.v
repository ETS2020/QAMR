...
module FAU ( 
  ...
  nand3  g13(.a(x12), .b(new_n39_), .c(new_n38_), .O(new_n42_));
  oai21  g14(.a(x12), .b(new_n39_), .c(new_n42_), .O(new_n43_));
  nand3  g15(.a(new_n43_), .b(x09), .c(new_n32_), .O(new_n44_));
  nand2  g16(.a(x08), .b(x01), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n44_), .O(z2));
  xnor2a g18(.a(x13), .b(x12), .O(new_n47_));
  nand3  g19(.a(x13), .b(new_n39_), .c(new_n38_), .O(new_n48_));
  ...
  aoi21  g25(.a(x13), .b(x11), .c(x10), .O(new_n54_));
  aoi21  g26(.a(new_n53_), .b(x11), .c(new_n54_), .O(new_n55_));
  ...
  nand2  g32(.a(x15), .b(new_n53_), .O(new_n61_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n53_), .c(x11), .O(new_n74_));
  ...
  oai21  g68(.a(new_n96_), .b(new_n93_), .c(x09), .O(new_n97_));
