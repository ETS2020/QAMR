...
module FAU ( 
  ...
  nand2  g17(.a(new_n42_), .b(x13), .O(new_n46_));
  ...
  oai21  g28(.a(new_n56_), .b(new_n42_), .c(new_n54_), .O(new_n57_));
  ...
  oai22  g36(.a(new_n64_), .b(new_n42_), .c(new_n63_), .d(new_n61_), .O(new_n65_));
  ...
  oai21  g41(.a(new_n69_), .b(new_n42_), .c(x16), .O(new_n70_));
