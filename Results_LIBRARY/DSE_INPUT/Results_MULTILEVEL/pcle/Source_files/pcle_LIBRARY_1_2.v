...
module FAU ( 
  ...
  nand2  g13(.a(x12), .b(new_n39_), .O(new_n42_));
  nand2  g14(.a(new_n30_), .b(x11), .O(new_n43_));
  ...
  nand2  g19(.a(x13), .b(new_n30_), .O(new_n48_));
  ...
  nand3  g26(.a(new_n31_), .b(x12), .c(x11), .O(new_n55_));
