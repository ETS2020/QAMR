...
module FAU ( 
  ...
  nand4  g07(.a(new_n35_), .b(x16), .c(x15), .d(x14), .O(new_n36_));
  ...
  nand3  g50(.a(new_n78_), .b(x12), .c(x11), .O(new_n79_));
  ...
  oai21  g55(.a(new_n83_), .b(new_n53_), .c(x18), .O(new_n84_));
  nand4  g56(.a(new_n29_), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n53_), .c(new_n84_), .O(new_n86_));
