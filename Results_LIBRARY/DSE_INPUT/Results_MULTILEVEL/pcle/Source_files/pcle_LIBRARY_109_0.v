...
module FAU ( 
  ...
  inv1   g27(.a(x11), .O(new_n56_));
  aoi21  g28(.a(new_n39_), .b(x13), .c(new_n38_), .O(new_n57_));
  oai21  g29(.a(new_n50_), .b(new_n56_), .c(x14), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n56_), .c(new_n58_), .O(new_n59_));
  ...
  oai22  g38(.a(new_n66_), .b(new_n48_), .c(new_n65_), .d(new_n63_), .O(new_n67_));
