...
module FAU ( 
  ...
  nand3  g21(.a(new_n37_), .b(x09), .c(new_n36_), .O(new_n51_));
  nand3  g22(.a(x13), .b(x12), .c(x11), .O(new_n52_));
  oai21  g23(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(z4));
  nand2  g24(.a(x08), .b(x04), .O(new_n54_));
  nand3  g25(.a(new_n32_), .b(x15), .c(new_n37_), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n54_), .O(z5));
  nand2  g27(.a(x08), .b(x05), .O(new_n57_));
  nand3  g28(.a(new_n32_), .b(x16), .c(new_n37_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n57_), .O(z6));
  nand2  g30(.a(x08), .b(x06), .O(new_n60_));
  nand3  g31(.a(new_n32_), .b(x17), .c(new_n37_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n60_), .O(z7));
  nand2  g33(.a(x08), .b(x07), .O(new_n63_));
  nand3  g34(.a(new_n32_), .b(x18), .c(new_n37_), .O(new_n64_));
