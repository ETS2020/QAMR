// Benchmark "FAU" written by ABC on Mon Jul 27 18:14:26 2020
...
module FAU ( 
  ...
  nand3  g37(.a(new_n32_), .b(x11), .c(new_n37_), .O(new_n67_));
  nand4  g38(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z6));
  nand2  g40(.a(x08), .b(x06), .O(new_n70_));
  nand3  g41(.a(new_n32_), .b(x17), .c(new_n37_), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z7));
  nand2  g43(.a(x08), .b(x07), .O(new_n73_));
  nand3  g44(.a(new_n32_), .b(x18), .c(new_n37_), .O(new_n74_));
