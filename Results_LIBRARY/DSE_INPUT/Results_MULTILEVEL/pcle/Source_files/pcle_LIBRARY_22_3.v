...
module FAU ( 
  ...
  nand4  g20(.a(new_n48_), .b(new_n38_), .c(x09), .d(new_n32_), .O(new_n49_));
  ...
  nand2  g25(.a(x11), .b(new_n38_), .O(new_n54_));
  nand3  g26(.a(new_n31_), .b(x13), .c(x12), .O(new_n55_));
  oai21  g27(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(new_n56_));
  nand3  g28(.a(new_n56_), .b(x09), .c(new_n32_), .O(new_n57_));
  ...
  aoi21  g34(.a(new_n62_), .b(new_n60_), .c(new_n31_), .O(new_n63_));
  nand3  g35(.a(x15), .b(new_n31_), .c(new_n38_), .O(new_n64_));
  inv1   g36(.a(new_n64_), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n63_), .c(x09), .O(new_n66_));
  nand2  g38(.a(x08), .b(x04), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(x08), .c(new_n67_), .O(z5));
  inv1   g40(.a(x16), .O(new_n69_));
  oai21  g41(.a(new_n61_), .b(new_n31_), .c(new_n38_), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(new_n53_), .c(new_n69_), .O(new_n71_));
  nand3  g43(.a(new_n69_), .b(x15), .c(x14), .O(new_n72_));
  nor2   g44(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n71_), .c(x09), .O(new_n74_));
  ...
  oai21  g50(.a(new_n78_), .b(new_n31_), .c(new_n38_), .O(new_n79_));
  aoi21  g51(.a(new_n79_), .b(new_n53_), .c(new_n77_), .O(new_n80_));
  nand4  g52(.a(new_n77_), .b(x16), .c(x15), .d(x14), .O(new_n81_));
  nor2   g53(.a(new_n81_), .b(new_n52_), .O(new_n82_));
  ...
  aoi22  g58(.a(new_n86_), .b(new_n38_), .c(new_n52_), .d(x14), .O(new_n87_));
  inv1   g59(.a(new_n78_), .O(new_n88_));
  nor2   g60(.a(new_n31_), .b(new_n30_), .O(new_n89_));
  nor2   g61(.a(x18), .b(new_n77_), .O(new_n90_));
  nand4  g62(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n46_), .O(new_n91_));
  oai21  g63(.a(new_n87_), .b(new_n29_), .c(new_n91_), .O(new_n92_));
