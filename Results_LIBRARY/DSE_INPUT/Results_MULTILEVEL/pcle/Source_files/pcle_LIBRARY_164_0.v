...
module FAU ( 
  ...
  nor2   g23(.a(new_n45_), .b(new_n38_), .O(new_n52_));
  ...
  nand3  g29(.a(new_n39_), .b(x13), .c(x12), .O(new_n58_));
  oai21  g30(.a(new_n39_), .b(x12), .c(new_n58_), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(x11), .O(new_n60_));
  oai21  g32(.a(new_n51_), .b(new_n38_), .c(x14), .O(new_n61_));
  ...
  nand4  g40(.a(new_n52_), .b(new_n68_), .c(x14), .d(x13), .O(new_n69_));
  ...
  oai21  g45(.a(x16), .b(new_n68_), .c(x14), .O(new_n74_));
  nand3  g46(.a(new_n74_), .b(x13), .c(x12), .O(new_n75_));
  nand2  g47(.a(x16), .b(new_n45_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x11), .O(new_n78_));
  nand3  g50(.a(x15), .b(x13), .c(x11), .O(new_n79_));
  ...
  nor2   g57(.a(new_n40_), .b(new_n68_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(x14), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n85_), .c(x17), .O(new_n88_));
  inv1   g60(.a(x17), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(x16), .c(x15), .d(x14), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n85_), .c(new_n88_), .O(new_n91_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n85_), .c(x18), .O(new_n96_));
  nand3  g68(.a(new_n86_), .b(new_n29_), .c(x17), .O(new_n97_));
  oai21  g69(.a(new_n97_), .b(new_n66_), .c(new_n96_), .O(new_n98_));
