...
module FAU ( 
  ...
  and2   g55(.a(x14), .b(x13), .O(new_n84_));
  nand2  g56(.a(x17), .b(x16), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(x14), .c(x13), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(new_n84_), .c(x12), .d(x11), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(x15), .O(new_n88_));
  nand2  g60(.a(x18), .b(new_n63_), .O(new_n89_));
