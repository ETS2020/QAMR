...
module FAU ( 
  ...
  nor2   g40(.a(new_n63_), .b(new_n55_), .O(new_n69_));
  ...
  oai21  g46(.a(new_n74_), .b(new_n46_), .c(x17), .O(new_n75_));
  ...
  nand3  g53(.a(x17), .b(x15), .c(x14), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n53_), .c(x18), .O(new_n83_));
  nand4  g55(.a(new_n29_), .b(x17), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n53_), .c(new_n83_), .O(new_n85_));
