...
module FAU ( 
  ...
  aoi21  g063(.a(new_n81_), .b(new_n80_), .c(new_n87_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n86_), .d(new_n107_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n106_), .c(x30), .O(new_n110_));
  inv1   g066(.a(x30), .O(new_n111_));
  nand4  g067(.a(new_n93_), .b(new_n111_), .c(x29), .d(x28), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n79_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n56_), .O(z6));
  nor2   g071(.a(new_n111_), .b(new_n99_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  ...
  inv1   g076(.a(new_n101_), .O(new_n121_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n111_), .c(x29), .O(new_n129_));
  nor2   g085(.a(new_n127_), .b(new_n99_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n111_), .c(new_n129_), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n87_), .c(x13), .O(new_n132_));
  nand3  g088(.a(new_n90_), .b(x18), .c(x14), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n84_), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n135_));
  ...
  nand4  g101(.a(new_n142_), .b(x16), .c(new_n80_), .d(x10), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n131_), .c(z0), .d(x31), .O(new_n148_));
  nand2  g104(.a(new_n116_), .b(x27), .O(new_n149_));
  ...
  oai21  g108(.a(new_n152_), .b(new_n141_), .c(new_n80_), .O(new_n153_));
  nand2  g109(.a(x17), .b(x11), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n139_), .c(new_n138_), .O(new_n155_));
  inv1   g111(.a(x12), .O(new_n156_));
  oai21  g112(.a(new_n139_), .b(new_n156_), .c(new_n84_), .O(new_n157_));
  inv1   g113(.a(x13), .O(new_n158_));
  oai21  g114(.a(new_n90_), .b(new_n158_), .c(new_n87_), .O(new_n159_));
  nor2   g115(.a(x19), .b(x14), .O(new_n160_));
  nor2   g116(.a(new_n138_), .b(new_n80_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n142_), .c(new_n160_), .O(new_n162_));
  oai21  g118(.a(x30), .b(x29), .c(x31), .O(new_n163_));
  aoi21  g119(.a(new_n116_), .b(x28), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g129(.a(x33), .b(new_n122_), .O(new_n174_));
  ...
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n122_), .d(new_n111_), .O(new_n178_));
  ...
  aoi21  g137(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x17), .c(x16), .d(x15), .O(new_n183_));
  inv1   g139(.a(new_n161_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x17), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(new_n90_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n152_), .c(new_n80_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n188_), .c(new_n138_), .O(new_n189_));
  oai21  g145(.a(new_n87_), .b(new_n156_), .c(new_n84_), .O(new_n190_));
  nand2  g146(.a(new_n87_), .b(new_n158_), .O(new_n191_));
