...
module FAU ( 
  ...
  nand4  g082(.a(new_n107_), .b(x19), .c(new_n86_), .d(x13), .O(new_n127_));
  ...
  nand4  g106(.a(new_n139_), .b(x16), .c(new_n125_), .d(x10), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n144_), .c(x30), .d(x19), .O(new_n153_));
  oai21  g109(.a(new_n142_), .b(new_n98_), .c(new_n153_), .O(new_n154_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n125_), .O(new_n162_));
  nand3  g118(.a(new_n160_), .b(x17), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n160_), .b(x12), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n83_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n89_), .b(new_n166_), .c(new_n86_), .O(new_n167_));
  inv1   g123(.a(new_n161_), .O(new_n168_));
  nor2   g124(.a(x19), .b(x14), .O(new_n169_));
  nor2   g125(.a(new_n133_), .b(new_n125_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  oai21  g127(.a(x30), .b(x29), .c(x31), .O(new_n172_));
  aoi21  g128(.a(new_n112_), .b(x28), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n167_), .d(new_n165_), .O(new_n174_));
  aoi21  g130(.a(new_n163_), .b(new_n133_), .c(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n162_), .c(new_n158_), .O(new_n176_));
  ...
  inv1   g136(.a(x00), .O(new_n181_));
  inv1   g137(.a(x33), .O(new_n182_));
  nand2  g138(.a(new_n135_), .b(new_n132_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x15), .O(new_n184_));
  inv1   g140(.a(new_n141_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n182_), .c(new_n118_), .O(new_n187_));
  nand2  g143(.a(x33), .b(x31), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n187_), .c(new_n143_), .O(new_n189_));
  nand4  g145(.a(new_n152_), .b(new_n182_), .c(x31), .d(x30), .O(new_n190_));
  nand2  g146(.a(x33), .b(new_n118_), .O(new_n191_));
  oai21  g147(.a(new_n190_), .b(new_n89_), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n124_), .c(x29), .O(new_n193_));
  aoi21  g149(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(x17), .c(x16), .d(x15), .O(new_n195_));
  nand2  g151(.a(new_n170_), .b(new_n139_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n89_), .O(new_n197_));
  inv1   g153(.a(new_n139_), .O(new_n198_));
  oai21  g154(.a(new_n159_), .b(new_n198_), .c(new_n125_), .O(new_n199_));
  nand2  g155(.a(new_n139_), .b(x11), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n133_), .O(new_n201_));
  nand2  g157(.a(x18), .b(x12), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n83_), .O(new_n203_));
  nand2  g159(.a(new_n86_), .b(new_n166_), .O(new_n204_));
  xnor2a g160(.a(x31), .b(x30), .O(new_n205_));
  nand4  g161(.a(new_n205_), .b(new_n204_), .c(new_n203_), .d(new_n201_), .O(new_n206_));
  inv1   g162(.a(new_n206_), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n199_), .c(new_n197_), .d(new_n195_), .O(new_n208_));
  nand2  g164(.a(new_n208_), .b(x33), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(new_n193_), .O(new_n210_));
  oai21  g166(.a(new_n210_), .b(new_n189_), .c(new_n78_), .O(new_n211_));
  nor2   g167(.a(new_n211_), .b(new_n181_), .O(z9));
endmodule
