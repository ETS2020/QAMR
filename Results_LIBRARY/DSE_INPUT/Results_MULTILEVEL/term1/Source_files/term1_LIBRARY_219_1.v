...
module FAU ( 
  ...
  nand3  g079(.a(new_n123_), .b(new_n107_), .c(x29), .O(new_n124_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n134_), .O(new_n151_));
  inv1   g107(.a(x12), .O(new_n152_));
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n83_), .O(new_n153_));
  inv1   g109(.a(x13), .O(new_n154_));
  oai21  g110(.a(new_n89_), .b(new_n154_), .c(new_n86_), .O(new_n155_));
  nor2   g111(.a(x19), .b(x14), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n135_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  oai21  g115(.a(x30), .b(x29), .c(x31), .O(new_n160_));
  aoi21  g116(.a(new_n112_), .b(x28), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n155_), .d(new_n153_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n151_), .c(new_n148_), .d(new_n146_), .O(new_n164_));
  ...
  inv1   g124(.a(new_n141_), .O(new_n169_));
  aoi21  g125(.a(new_n138_), .b(x15), .c(new_n169_), .O(new_n170_));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n123_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n123_), .b(x29), .c(x31), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(new_n107_), .c(new_n173_), .d(x29), .O(new_n175_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n157_), .c(new_n89_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n147_), .c(new_n140_), .O(new_n181_));
  aoi21  g137(.a(new_n178_), .b(x11), .c(x16), .O(new_n182_));
  oai21  g138(.a(new_n86_), .b(new_n152_), .c(new_n83_), .O(new_n183_));
  nand2  g139(.a(new_n86_), .b(new_n154_), .O(new_n184_));
  nor2   g140(.a(new_n118_), .b(new_n98_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n123_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n181_), .c(new_n180_), .d(new_n177_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  oai21  g145(.a(new_n175_), .b(new_n170_), .c(new_n189_), .O(new_n190_));
