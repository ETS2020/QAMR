// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:32 2020
...
module FAU ( 
  ...
  nand2  g083(.a(x19), .b(new_n86_), .O(new_n128_));
  ...
  nor2   g102(.a(new_n134_), .b(new_n140_), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x17), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n86_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(new_n140_), .O(new_n152_));
  inv1   g108(.a(x11), .O(new_n153_));
  oai21  g109(.a(new_n149_), .b(new_n153_), .c(new_n134_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  aoi21  g113(.a(new_n147_), .b(new_n136_), .c(new_n157_), .O(new_n158_));
  oai21  g114(.a(x30), .b(x29), .c(x31), .O(new_n159_));
  aoi21  g115(.a(new_n112_), .b(x28), .c(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n152_), .c(new_n150_), .d(new_n146_), .O(new_n163_));
  ...
  nand4  g124(.a(new_n142_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n118_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n124_), .c(x29), .O(new_n172_));
  inv1   g128(.a(new_n126_), .O(new_n173_));
  nand4  g129(.a(new_n142_), .b(new_n168_), .c(new_n118_), .d(new_n107_), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x17), .c(x16), .d(x15), .O(new_n179_));
  nand2  g135(.a(x17), .b(x16), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n140_), .c(new_n89_), .O(new_n181_));
  inv1   g137(.a(x10), .O(new_n182_));
  oai21  g138(.a(new_n180_), .b(new_n182_), .c(new_n140_), .O(new_n183_));
  oai21  g139(.a(new_n83_), .b(new_n153_), .c(new_n134_), .O(new_n184_));
  nand2  g140(.a(new_n83_), .b(new_n155_), .O(new_n185_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n181_), .c(new_n179_), .d(new_n150_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n177_), .c(new_n172_), .O(new_n191_));
