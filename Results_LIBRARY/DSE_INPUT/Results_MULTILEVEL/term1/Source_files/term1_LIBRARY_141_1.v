...
module FAU ( 
  ...
  nand4  g098(.a(new_n142_), .b(new_n127_), .c(x31), .d(new_n78_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n122_), .O(z8));
  inv1   g100(.a(x33), .O(new_n145_));
  nand4  g101(.a(new_n142_), .b(new_n145_), .c(x31), .d(x30), .O(new_n146_));
  nand2  g102(.a(x33), .b(new_n117_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n124_), .c(x29), .O(new_n149_));
  inv1   g105(.a(new_n126_), .O(new_n150_));
  nand4  g106(.a(new_n142_), .b(new_n145_), .c(new_n117_), .d(new_n107_), .O(new_n151_));
  nand2  g107(.a(x33), .b(x31), .O(new_n152_));
  ...
  aoi21  g111(.a(new_n155_), .b(new_n136_), .c(x15), .O(new_n156_));
  ...
  oai22  g120(.a(new_n164_), .b(new_n135_), .c(x19), .d(x14), .O(new_n165_));
  xor2a  g121(.a(x31), .b(x30), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n156_), .c(x33), .O(new_n169_));
