...
module FAU ( 
  ...
  nor2   g058(.a(new_n80_), .b(new_n79_), .O(new_n103_));
  nand2  g059(.a(x29), .b(new_n78_), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n78_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n94_), .c(new_n58_), .d(new_n77_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n99_), .c(new_n56_), .O(z5));
  inv1   g063(.a(new_n103_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n78_), .c(x30), .O(new_n109_));
  inv1   g065(.a(x30), .O(new_n110_));
  nor2   g066(.a(new_n79_), .b(new_n78_), .O(new_n111_));
  ...
  nor2   g072(.a(new_n110_), .b(new_n80_), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(x31), .O(new_n119_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n116_), .c(new_n77_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n99_), .O(new_n125_));
  ...
  oai21  g085(.a(new_n127_), .b(new_n80_), .c(x30), .O(new_n130_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n131_), .c(z0), .d(x31), .O(new_n147_));
  xnor2a g103(.a(x30), .b(x27), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n79_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n138_), .O(new_n154_));
  ...
  aoi21  g127(.a(new_n141_), .b(new_n137_), .c(new_n144_), .O(new_n172_));
  inv1   g128(.a(new_n145_), .O(new_n173_));
  nor2   g129(.a(new_n122_), .b(new_n110_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x27), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nor3   g132(.a(x31), .b(x30), .c(x27), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n176_), .c(new_n79_), .O(new_n178_));
  nor3   g134(.a(x31), .b(x30), .c(x29), .O(new_n179_));
  aoi21  g135(.a(new_n174_), .b(new_n103_), .c(new_n179_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  oai21  g137(.a(new_n173_), .b(new_n172_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x17), .c(x16), .d(x15), .O(new_n184_));
  xor2a  g140(.a(x31), .b(x27), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n79_), .O(new_n186_));
  nand2  g142(.a(new_n118_), .b(x31), .O(new_n187_));
  nand2  g143(.a(new_n108_), .b(new_n110_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n160_), .c(new_n91_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n150_), .c(new_n144_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n138_), .O(new_n193_));
  nand2  g149(.a(x18), .b(x12), .O(new_n194_));
  aoi22  g150(.a(new_n194_), .b(new_n85_), .c(new_n88_), .d(new_n157_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n193_), .c(new_n191_), .d(new_n190_), .O(new_n196_));
  aoi21  g152(.a(new_n188_), .b(new_n122_), .c(new_n196_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n187_), .c(new_n186_), .d(new_n184_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(x33), .O(new_n199_));
  oai21  g155(.a(new_n182_), .b(x33), .c(new_n199_), .O(new_n200_));
