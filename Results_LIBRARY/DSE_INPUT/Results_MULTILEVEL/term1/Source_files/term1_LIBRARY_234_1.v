...
module FAU ( 
  ...
  aoi22  g114(.a(new_n158_), .b(new_n138_), .c(new_n80_), .d(new_n157_), .O(new_n159_));
  ...
  aoi21  g134(.a(new_n88_), .b(x13), .c(new_n80_), .O(new_n179_));
  ...
  nand2  g140(.a(new_n80_), .b(new_n157_), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n182_), .b(new_n186_), .c(new_n134_), .O(new_n187_));
  oai21  g143(.a(new_n80_), .b(new_n153_), .c(new_n85_), .O(new_n188_));
