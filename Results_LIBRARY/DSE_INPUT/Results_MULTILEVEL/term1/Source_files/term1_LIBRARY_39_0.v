...
module FAU ( 
  ...
  nor2   g059(.a(new_n79_), .b(new_n78_), .O(new_n104_));
  ...
  aoi21  g064(.a(new_n80_), .b(x29), .c(new_n79_), .O(new_n109_));
  oai21  g065(.a(new_n103_), .b(new_n78_), .c(x30), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(new_n78_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n58_), .d(new_n77_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n99_), .c(new_n56_), .O(z6));
  nand3  g069(.a(new_n104_), .b(x30), .c(x29), .O(new_n114_));
  ...
  nand2  g099(.a(new_n79_), .b(new_n78_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x30), .c(x29), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n135_), .c(new_n140_), .O(new_n147_));
  nor2   g103(.a(new_n91_), .b(new_n88_), .O(new_n148_));
  ...
  nand2  g109(.a(new_n91_), .b(new_n153_), .O(new_n154_));
  nand3  g110(.a(new_n136_), .b(x16), .c(x15), .O(new_n155_));
  aoi21  g111(.a(new_n80_), .b(new_n103_), .c(new_n119_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n155_), .c(new_n154_), .O(new_n157_));
  nor3   g113(.a(new_n157_), .b(new_n152_), .c(new_n151_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n150_), .c(new_n147_), .d(new_n145_), .O(new_n159_));
  ...
  nand4  g120(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n165_));
  nand3  g121(.a(new_n119_), .b(new_n80_), .c(new_n103_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n142_), .c(new_n164_), .O(new_n168_));
  nand2  g124(.a(new_n91_), .b(x14), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(x18), .c(x17), .d(x16), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n140_), .O(new_n171_));
  nand2  g127(.a(x16), .b(x15), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n172_), .c(new_n91_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n146_), .c(new_n140_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n134_), .O(new_n177_));
  aoi21  g133(.a(x18), .b(x12), .c(x17), .O(new_n178_));
  oai21  g134(.a(x18), .b(x13), .c(new_n125_), .O(new_n179_));
  nand2  g135(.a(new_n119_), .b(x30), .O(new_n180_));
  nand2  g136(.a(x31), .b(new_n103_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n180_), .c(new_n124_), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n179_), .c(new_n178_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n177_), .c(new_n175_), .d(new_n174_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n171_), .c(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n168_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n77_), .c(x00), .O(new_n187_));
