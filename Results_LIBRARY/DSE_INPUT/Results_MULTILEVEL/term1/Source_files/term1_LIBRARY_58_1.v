...
module FAU ( 
  ...
  nand4  g084(.a(new_n89_), .b(x18), .c(x14), .d(x00), .O(new_n129_));
  ...
  nand2  g100(.a(new_n107_), .b(new_n79_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(x28), .O(new_n146_));
  nand2  g102(.a(x15), .b(x14), .O(new_n147_));
  nand3  g103(.a(x18), .b(x17), .c(x16), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n89_), .O(new_n149_));
  nand2  g105(.a(new_n112_), .b(x28), .O(new_n150_));
  aoi21  g106(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n146_), .c(x00), .O(new_n153_));
  nor2   g109(.a(new_n86_), .b(new_n83_), .O(new_n154_));
  and2   g110(.a(x16), .b(x10), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(x15), .O(new_n156_));
  nand2  g112(.a(new_n154_), .b(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n134_), .O(new_n158_));
  nand2  g114(.a(x18), .b(x12), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n83_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  nand2  g117(.a(new_n86_), .b(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n154_), .b(x16), .c(x15), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n156_), .c(x19), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n153_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x32), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n143_), .c(x26), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  nand4  g125(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n170_));
  nor2   g126(.a(x19), .b(new_n86_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n169_), .c(x31), .d(x30), .O(new_n172_));
  oai22  g128(.a(new_n172_), .b(new_n170_), .c(new_n169_), .d(x31), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x00), .O(new_n174_));
  nand3  g130(.a(x18), .b(new_n83_), .c(x12), .O(new_n175_));
  nand3  g131(.a(new_n86_), .b(x17), .c(x13), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n175_), .c(new_n134_), .O(new_n177_));
  nand4  g133(.a(x18), .b(x17), .c(new_n134_), .d(x11), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(x15), .O(new_n180_));
  inv1   g136(.a(new_n148_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n140_), .c(x10), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n180_), .c(x33), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x31), .c(x30), .d(x19), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n174_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n124_), .c(x29), .O(new_n186_));
  inv1   g142(.a(new_n126_), .O(new_n187_));
  nand4  g143(.a(new_n171_), .b(new_n169_), .c(new_n118_), .d(new_n107_), .O(new_n188_));
  oai22  g144(.a(new_n188_), .b(new_n170_), .c(new_n169_), .d(new_n118_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x00), .O(new_n190_));
  nand4  g146(.a(new_n183_), .b(new_n118_), .c(new_n107_), .d(x19), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  xnor2a g148(.a(x31), .b(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n149_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(x00), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n165_), .c(new_n169_), .O(new_n196_));
  aoi21  g152(.a(new_n192_), .b(new_n187_), .c(new_n196_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n186_), .c(x26), .O(z9));
endmodule
