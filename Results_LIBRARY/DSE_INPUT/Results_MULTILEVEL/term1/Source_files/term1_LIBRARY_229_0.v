// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:57 2020
...
module FAU ( 
  ...
  nor2   g064(.a(new_n104_), .b(new_n95_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n97_), .O(new_n110_));
  ...
  inv1   g069(.a(new_n97_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x30), .c(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n114_), .c(new_n78_), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n77_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(z7));
  nor2   g075(.a(x28), .b(x27), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n104_), .c(x29), .O(new_n122_));
  nor2   g078(.a(new_n120_), .b(new_n95_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n104_), .c(new_n122_), .O(new_n124_));
  inv1   g080(.a(x17), .O(new_n125_));
  nand3  g081(.a(x19), .b(new_n83_), .c(x13), .O(new_n126_));
  nand3  g082(.a(new_n86_), .b(x18), .c(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  nand4  g084(.a(x19), .b(x18), .c(new_n125_), .d(x12), .O(new_n129_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n132_), .c(x11), .O(new_n137_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(z0), .d(x31), .O(new_n143_));
  nand2  g099(.a(new_n109_), .b(x27), .O(new_n144_));
  oai21  g100(.a(x30), .b(x27), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n133_), .c(new_n132_), .O(new_n150_));
  inv1   g106(.a(x12), .O(new_n151_));
  oai21  g107(.a(new_n133_), .b(new_n151_), .c(new_n125_), .O(new_n152_));
  inv1   g108(.a(x13), .O(new_n153_));
  oai21  g109(.a(new_n86_), .b(new_n153_), .c(new_n83_), .O(new_n154_));
  nor2   g110(.a(x19), .b(x14), .O(new_n155_));
  nor2   g111(.a(new_n132_), .b(new_n140_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n136_), .c(new_n155_), .O(new_n157_));
  oai21  g113(.a(x30), .b(x29), .c(x31), .O(new_n158_));
  aoi21  g114(.a(new_n109_), .b(x28), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n157_), .c(new_n154_), .d(new_n152_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n150_), .c(new_n148_), .d(new_n146_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x32), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n143_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n78_), .c(x00), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n142_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n115_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n121_), .c(x29), .O(new_n171_));
  inv1   g127(.a(new_n123_), .O(new_n172_));
  nand4  g128(.a(new_n142_), .b(new_n167_), .c(new_n115_), .d(new_n104_), .O(new_n173_));
  ...
  aoi21  g132(.a(new_n86_), .b(x14), .c(new_n83_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x17), .c(x16), .d(x15), .O(new_n178_));
  inv1   g134(.a(new_n156_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x17), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n86_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n147_), .c(new_n140_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n132_), .O(new_n184_));
  oai21  g140(.a(new_n83_), .b(new_n151_), .c(new_n125_), .O(new_n185_));
  nand2  g141(.a(new_n83_), .b(new_n153_), .O(new_n186_));
