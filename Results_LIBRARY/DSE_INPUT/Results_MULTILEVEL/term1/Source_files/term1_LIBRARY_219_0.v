...
module FAU ( 
  ...
  nand3  g097(.a(x16), .b(new_n128_), .c(x10), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  or2    g099(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n138_), .c(new_n128_), .O(new_n150_));
  nand2  g106(.a(x17), .b(x11), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n136_), .c(new_n135_), .O(new_n152_));
  inv1   g108(.a(x12), .O(new_n153_));
  oai21  g109(.a(new_n136_), .b(new_n153_), .c(new_n83_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n86_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  nor2   g113(.a(new_n135_), .b(new_n128_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n139_), .c(new_n157_), .O(new_n159_));
  ...
  oai21  g125(.a(new_n143_), .b(new_n141_), .c(new_n169_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n118_), .c(x30), .O(new_n171_));
  ...
  oai21  g130(.a(new_n123_), .b(new_n98_), .c(x31), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n158_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n89_), .O(new_n179_));
  nand3  g135(.a(new_n177_), .b(x16), .c(x10), .O(new_n180_));
  nand2  g136(.a(new_n118_), .b(x30), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n176_), .b(new_n182_), .c(new_n135_), .O(new_n183_));
  oai21  g139(.a(new_n86_), .b(new_n153_), .c(new_n83_), .O(new_n184_));
  nand2  g140(.a(new_n86_), .b(new_n155_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n181_), .O(new_n186_));
  aoi21  g142(.a(new_n180_), .b(new_n128_), .c(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n179_), .c(new_n175_), .d(new_n174_), .O(new_n188_));
