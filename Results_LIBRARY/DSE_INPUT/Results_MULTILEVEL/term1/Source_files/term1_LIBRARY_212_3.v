// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:52 2020
...
module FAU ( 
  ...
  nand2  g102(.a(new_n112_), .b(x27), .O(new_n147_));
  ...
  aoi21  g117(.a(new_n112_), .b(x28), .c(new_n161_), .O(new_n162_));
  ...
  aoi21  g122(.a(new_n166_), .b(new_n146_), .c(new_n123_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n145_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n118_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n125_), .c(x29), .O(new_n172_));
  inv1   g128(.a(new_n127_), .O(new_n173_));
  nand4  g129(.a(new_n145_), .b(new_n168_), .c(new_n118_), .d(new_n107_), .O(new_n174_));
  ...
  aoi21  g136(.a(new_n180_), .b(new_n159_), .c(x19), .O(new_n181_));
  inv1   g137(.a(new_n150_), .O(new_n182_));
  aoi21  g138(.a(new_n180_), .b(new_n182_), .c(x15), .O(new_n183_));
  aoi21  g139(.a(new_n180_), .b(x11), .c(x16), .O(new_n184_));
  oai21  g140(.a(new_n86_), .b(new_n154_), .c(new_n83_), .O(new_n185_));
  nand2  g141(.a(new_n86_), .b(new_n156_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .O(new_n188_));
  nor4   g144(.a(new_n188_), .b(new_n184_), .c(new_n183_), .d(new_n181_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n178_), .c(new_n168_), .O(new_n190_));
  aoi21  g146(.a(new_n176_), .b(new_n173_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n172_), .c(new_n123_), .O(z9));
endmodule
