// Benchmark "FAU" written by ABC on Mon Jul 27 22:03:01 2020
...
module FAU ( 
  ...
  nand2  g053(.a(new_n95_), .b(x27), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g055(.a(new_n88_), .b(new_n85_), .c(new_n82_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(x27), .c(new_n95_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n97_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n90_), .c(new_n89_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n56_), .O(z4));
  inv1   g064(.a(x29), .O(new_n109_));
  nor2   g065(.a(new_n95_), .b(new_n79_), .O(new_n110_));
  nand3  g066(.a(new_n109_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n77_), .c(new_n56_), .O(z5));
  aoi21  g070(.a(x29), .b(x28), .c(new_n102_), .O(new_n115_));
  nand2  g071(.a(new_n102_), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n95_), .c(x27), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(new_n100_), .O(new_n118_));
  aoi21  g074(.a(new_n98_), .b(x29), .c(new_n102_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n117_), .c(new_n90_), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(x19), .c(new_n118_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n56_), .O(z6));
  nand3  g079(.a(new_n110_), .b(x30), .c(x29), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x31), .O(new_n125_));
  nand4  g081(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n126_));
  nor2   g082(.a(new_n57_), .b(new_n56_), .O(new_n127_));
  inv1   g083(.a(new_n110_), .O(new_n128_));
  inv1   g084(.a(x31), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x30), .c(x29), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n128_), .c(new_n78_), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n77_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(z7));
  nand2  g089(.a(new_n95_), .b(new_n79_), .O(new_n134_));
  nand2  g090(.a(x30), .b(new_n109_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n134_), .c(new_n116_), .O(new_n136_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n136_), .c(z0), .d(x31), .O(new_n152_));
  nand2  g108(.a(new_n95_), .b(new_n79_), .O(new_n153_));
  ...
  nor2   g112(.a(new_n89_), .b(new_n86_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(x17), .c(x11), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n143_), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(x12), .c(x17), .O(new_n160_));
  aoi21  g116(.a(x19), .b(x13), .c(x18), .O(new_n161_));
  inv1   g117(.a(x14), .O(new_n162_));
  nand2  g118(.a(new_n89_), .b(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n145_), .b(x16), .c(x15), .O(new_n164_));
  aoi21  g120(.a(new_n102_), .b(new_n109_), .c(new_n129_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  nor3   g122(.a(new_n166_), .b(new_n161_), .c(new_n160_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n159_), .c(new_n156_), .d(new_n154_), .O(new_n168_));
  ...
  nand4  g129(.a(new_n134_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  nand3  g130(.a(new_n129_), .b(new_n102_), .c(new_n109_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n151_), .c(new_n173_), .O(new_n177_));
  nand2  g133(.a(new_n89_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n149_), .O(new_n180_));
  nand2  g136(.a(x16), .b(x15), .O(new_n181_));
  nand2  g137(.a(x18), .b(x17), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n181_), .c(new_n89_), .O(new_n183_));
  oai21  g139(.a(new_n182_), .b(new_n155_), .c(new_n149_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n143_), .O(new_n186_));
  aoi21  g142(.a(x18), .b(x12), .c(x17), .O(new_n187_));
  oai21  g143(.a(x18), .b(x13), .c(new_n134_), .O(new_n188_));
  nand2  g144(.a(new_n129_), .b(x30), .O(new_n189_));
  nand2  g145(.a(x31), .b(new_n109_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n189_), .c(new_n116_), .O(new_n191_));
  nor3   g147(.a(new_n191_), .b(new_n188_), .c(new_n187_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n186_), .c(new_n184_), .d(new_n183_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n180_), .c(x33), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n177_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n78_), .c(x00), .O(new_n196_));
