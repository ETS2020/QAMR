...
module FAU ( 
  ...
  nand4  g096(.a(new_n140_), .b(z0), .c(x31), .d(x30), .O(new_n141_));
  oai21  g097(.a(z0), .b(x30), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n123_), .O(new_n143_));
  nor2   g099(.a(new_n131_), .b(x17), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n126_), .c(x16), .O(new_n145_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n122_), .c(z0), .d(x31), .O(new_n149_));
  ...
  aoi21  g111(.a(new_n155_), .b(new_n134_), .c(x15), .O(new_n156_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n133_), .c(x31), .O(new_n165_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n153_), .c(new_n143_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n78_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n140_), .b(new_n172_), .c(x31), .d(x30), .O(new_n173_));
  ...
  nand4  g132(.a(new_n148_), .b(new_n172_), .c(new_n117_), .d(new_n107_), .O(new_n177_));
  ...
  oai21  g139(.a(new_n182_), .b(new_n154_), .c(new_n138_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n130_), .O(new_n186_));
  oai21  g142(.a(new_n86_), .b(new_n159_), .c(new_n83_), .O(new_n187_));
  nand2  g143(.a(new_n86_), .b(new_n161_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n184_), .c(new_n183_), .d(new_n181_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n179_), .c(new_n176_), .O(new_n194_));
