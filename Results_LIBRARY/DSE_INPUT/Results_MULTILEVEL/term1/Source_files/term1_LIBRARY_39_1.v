// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:56 2020
...
module FAU ( 
  ...
  oai21  g060(.a(new_n100_), .b(new_n79_), .c(x30), .O(new_n105_));
  ...
  nor2   g066(.a(new_n106_), .b(new_n100_), .O(new_n111_));
  ...
  nand4  g071(.a(new_n115_), .b(x30), .c(x29), .d(x27), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n78_), .c(x25), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n57_), .c(new_n56_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n114_), .c(new_n113_), .O(z7));
  nor2   g075(.a(x28), .b(x27), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n106_), .c(x29), .O(new_n122_));
  nand2  g078(.a(x30), .b(new_n100_), .O(new_n123_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n125_), .c(new_n83_), .O(new_n127_));
  nand4  g083(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n128_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n124_), .c(z0), .d(x31), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n132_), .c(new_n137_), .O(new_n142_));
  nand2  g098(.a(x19), .b(x18), .O(new_n143_));
  nand2  g099(.a(x17), .b(x11), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n131_), .O(new_n145_));
  ...
  nand2  g106(.a(new_n89_), .b(new_n150_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x15), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n132_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n120_), .O(new_n154_));
  nor2   g110(.a(x30), .b(x29), .O(new_n155_));
  nor3   g111(.a(new_n155_), .b(new_n111_), .c(new_n115_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n154_), .c(new_n151_), .d(new_n149_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n147_), .c(new_n145_), .d(new_n142_), .O(new_n159_));
  ...
  oai21  g120(.a(new_n155_), .b(new_n120_), .c(new_n115_), .O(new_n165_));
  nand3  g121(.a(x31), .b(x30), .c(x29), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n139_), .c(new_n164_), .O(new_n168_));
  nand2  g124(.a(new_n89_), .b(x14), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(x18), .c(x17), .d(x16), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n137_), .O(new_n171_));
  nand3  g127(.a(new_n121_), .b(new_n115_), .c(x29), .O(new_n172_));
  nor2   g128(.a(new_n86_), .b(new_n83_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n152_), .c(new_n89_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n141_), .c(new_n137_), .O(new_n176_));
  aoi21  g132(.a(new_n173_), .b(x11), .c(x16), .O(new_n177_));
  oai21  g133(.a(new_n86_), .b(new_n146_), .c(new_n83_), .O(new_n178_));
  nand2  g134(.a(new_n86_), .b(new_n148_), .O(new_n179_));
  nand2  g135(.a(x31), .b(new_n106_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n123_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n176_), .c(new_n175_), .d(new_n172_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n171_), .c(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n168_), .O(new_n185_));
