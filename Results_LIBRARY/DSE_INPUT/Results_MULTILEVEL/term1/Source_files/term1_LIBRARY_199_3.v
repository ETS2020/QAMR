...
module FAU ( 
  ...
  nand3  g058(.a(new_n88_), .b(new_n82_), .c(x22), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n102_), .c(x30), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand4  g061(.a(new_n89_), .b(new_n105_), .c(x29), .d(x28), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n79_), .c(new_n104_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n56_), .O(z6));
  ...
  nand4  g069(.a(new_n113_), .b(new_n112_), .c(new_n85_), .d(new_n82_), .O(new_n114_));
  ...
  nand4  g076(.a(new_n120_), .b(new_n115_), .c(new_n114_), .d(new_n111_), .O(z7));
  ...
  nand2  g085(.a(new_n83_), .b(x12), .O(new_n130_));
  nand3  g086(.a(new_n105_), .b(x19), .c(x18), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  ...
  nand2  g099(.a(new_n96_), .b(new_n79_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x32), .c(x30), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n143_), .c(new_n95_), .O(new_n146_));
  nor2   g102(.a(new_n123_), .b(new_n95_), .O(new_n147_));
  nand4  g103(.a(x18), .b(x16), .c(x15), .d(x12), .O(new_n148_));
  nand4  g104(.a(z0), .b(x31), .c(x30), .d(x19), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  aoi21  g106(.a(x32), .b(new_n105_), .c(new_n150_), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  nor2   g108(.a(new_n134_), .b(new_n140_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n152_), .c(new_n125_), .O(new_n155_));
  inv1   g111(.a(x10), .O(new_n156_));
  nand2  g112(.a(x19), .b(x16), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n140_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n127_), .b(new_n159_), .c(new_n134_), .O(new_n160_));
  nor2   g116(.a(new_n127_), .b(new_n125_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  aoi21  g118(.a(new_n153_), .b(new_n161_), .c(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n160_), .c(new_n158_), .d(new_n155_), .O(new_n164_));
  oai21  g120(.a(new_n127_), .b(new_n83_), .c(new_n125_), .O(new_n165_));
  nand2  g121(.a(x15), .b(x12), .O(new_n166_));
  oai21  g122(.a(new_n157_), .b(new_n166_), .c(new_n83_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n165_), .c(x31), .O(new_n168_));
  aoi21  g124(.a(new_n164_), .b(x17), .c(new_n168_), .O(new_n169_));
  oai22  g125(.a(new_n169_), .b(z0), .c(new_n151_), .d(new_n147_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n146_), .c(new_n78_), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n122_), .O(z8));
  inv1   g128(.a(x33), .O(new_n173_));
  nand3  g129(.a(new_n142_), .b(new_n173_), .c(new_n117_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x31), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n147_), .O(new_n176_));
  nand4  g132(.a(new_n173_), .b(x31), .c(x30), .d(x19), .O(new_n177_));
  oai22  g133(.a(new_n177_), .b(new_n148_), .c(new_n173_), .d(x31), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n124_), .c(x29), .O(new_n179_));
  aoi21  g135(.a(new_n127_), .b(x14), .c(new_n125_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x17), .c(x16), .d(x15), .O(new_n181_));
  nand2  g137(.a(x18), .b(x17), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n154_), .c(new_n127_), .O(new_n183_));
  nand2  g139(.a(x16), .b(x10), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n182_), .c(new_n140_), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n159_), .c(new_n134_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x12), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n83_), .O(new_n188_));
  nand2  g144(.a(new_n125_), .b(new_n152_), .O(new_n189_));
  ...
  nand4  g148(.a(new_n192_), .b(new_n185_), .c(new_n183_), .d(new_n181_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n179_), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n176_), .c(new_n78_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n122_), .O(z9));
endmodule
