// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:08 2020
...
module FAU ( 
  ...
  nand3  g018(.a(new_n62_), .b(x06), .c(new_n50_), .O(new_n63_));
  nand2  g019(.a(x06), .b(new_n50_), .O(new_n64_));
  nand3  g020(.a(new_n64_), .b(x05), .c(new_n47_), .O(new_n65_));
  ...
  nor2   g025(.a(new_n47_), .b(x01), .O(new_n70_));
  nor2   g026(.a(x05), .b(x03), .O(new_n71_));
  oai21  g027(.a(new_n71_), .b(new_n70_), .c(x02), .O(new_n72_));
  inv1   g028(.a(new_n62_), .O(new_n73_));
  nand2  g029(.a(x06), .b(x05), .O(new_n74_));
  oai22  g030(.a(new_n74_), .b(new_n60_), .c(new_n73_), .d(x06), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  aoi21  g033(.a(new_n69_), .b(x01), .c(new_n77_), .O(new_n78_));
  oai21  g034(.a(new_n78_), .b(new_n68_), .c(new_n67_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n55_), .c(x08), .O(new_n80_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n59_), .c(new_n84_), .d(new_n83_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n82_), .c(new_n57_), .O(z3));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n59_), .d(new_n83_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n82_), .c(new_n57_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n97_), .c(new_n59_), .d(new_n83_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n82_), .c(new_n57_), .O(z5));
  inv1   g065(.a(x30), .O(new_n110_));
  nand4  g066(.a(new_n59_), .b(new_n110_), .c(x29), .d(x28), .O(new_n111_));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x30), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n84_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n97_), .c(new_n83_), .d(x25), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n57_), .O(z6));
  nor2   g072(.a(new_n110_), .b(new_n103_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n105_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  nand4  g075(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n120_));
  nor2   g076(.a(new_n58_), .b(new_n57_), .O(new_n121_));
  inv1   g077(.a(new_n105_), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x30), .c(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n83_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n82_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n110_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n103_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n110_), .c(new_n130_), .O(new_n132_));
  nand3  g088(.a(x19), .b(new_n91_), .c(x13), .O(new_n133_));
  nand3  g089(.a(new_n94_), .b(x18), .c(x14), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n88_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n136_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n132_), .c(z0), .d(x31), .O(new_n150_));
  nand2  g106(.a(new_n117_), .b(x27), .O(new_n151_));
  oai21  g107(.a(x30), .b(x27), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n104_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n142_), .c(new_n147_), .O(new_n155_));
  nand2  g111(.a(x17), .b(x11), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n140_), .c(new_n139_), .O(new_n157_));
  inv1   g113(.a(x12), .O(new_n158_));
  oai21  g114(.a(new_n140_), .b(new_n158_), .c(new_n88_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n94_), .b(new_n160_), .c(new_n91_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nor2   g118(.a(new_n139_), .b(new_n147_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n143_), .c(new_n162_), .O(new_n164_));
  oai21  g120(.a(x30), .b(x29), .c(x31), .O(new_n165_));
  aoi21  g121(.a(new_n117_), .b(x28), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n161_), .d(new_n159_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x32), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n150_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n83_), .c(x00), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n149_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n123_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n129_), .c(x29), .O(new_n178_));
  inv1   g134(.a(new_n131_), .O(new_n179_));
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n123_), .d(new_n110_), .O(new_n180_));
  ...
  aoi21  g139(.a(new_n94_), .b(x14), .c(new_n91_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  inv1   g141(.a(new_n163_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n186_), .c(new_n94_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n154_), .c(new_n147_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n139_), .O(new_n191_));
  oai21  g147(.a(new_n91_), .b(new_n158_), .c(new_n88_), .O(new_n192_));
  nand2  g148(.a(new_n91_), .b(new_n160_), .O(new_n193_));
  ...
  nand4  g152(.a(new_n196_), .b(new_n189_), .c(new_n188_), .d(new_n185_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(x33), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n183_), .c(new_n178_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n83_), .c(x00), .O(new_n200_));
