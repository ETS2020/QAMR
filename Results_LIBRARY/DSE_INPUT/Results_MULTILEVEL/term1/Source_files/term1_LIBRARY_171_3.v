...
module FAU ( 
  ...
  aoi21  g125(.a(new_n143_), .b(new_n141_), .c(x33), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x31), .c(x30), .d(new_n78_), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n118_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n124_), .c(x29), .O(new_n174_));
  inv1   g130(.a(new_n126_), .O(new_n175_));
  nand4  g131(.a(new_n170_), .b(new_n118_), .c(new_n107_), .d(new_n78_), .O(new_n176_));
  ...
  aoi21  g139(.a(new_n183_), .b(new_n158_), .c(x19), .O(new_n184_));
  inv1   g140(.a(new_n149_), .O(new_n185_));
  aoi21  g141(.a(new_n183_), .b(new_n185_), .c(x15), .O(new_n186_));
  aoi21  g142(.a(new_n183_), .b(x11), .c(x16), .O(new_n187_));
  oai21  g143(.a(new_n86_), .b(new_n153_), .c(new_n83_), .O(new_n188_));
  nand2  g144(.a(new_n86_), .b(new_n155_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n189_), .c(new_n188_), .O(new_n191_));
  nor4   g147(.a(new_n191_), .b(new_n187_), .c(new_n186_), .d(new_n184_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n181_), .c(new_n179_), .O(new_n193_));
  aoi21  g149(.a(new_n178_), .b(new_n175_), .c(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n174_), .c(new_n169_), .O(z9));
endmodule
