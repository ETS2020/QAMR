...
module FAU ( 
  ...
  nand4  g093(.a(new_n137_), .b(z0), .c(x31), .d(x18), .O(new_n138_));
  nand2  g094(.a(new_n83_), .b(x12), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x19), .c(x16), .d(x15), .O(new_n140_));
  ...
  nand2  g099(.a(x19), .b(x16), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n134_), .c(new_n83_), .O(new_n145_));
  inv1   g101(.a(new_n144_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(x10), .c(x15), .O(new_n147_));
  nand2  g103(.a(x19), .b(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n127_), .O(new_n149_));
  inv1   g105(.a(x14), .O(new_n150_));
  aoi21  g106(.a(new_n89_), .b(new_n150_), .c(new_n86_), .O(new_n151_));
  ...
  nand4  g121(.a(new_n161_), .b(new_n118_), .c(new_n107_), .d(x18), .O(new_n166_));
