...
module FAU ( 
  ...
  nor2   g061(.a(new_n98_), .b(new_n99_), .O(new_n106_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n105_), .c(new_n108_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n92_), .c(new_n58_), .d(new_n78_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n77_), .c(new_n56_), .O(z6));
  nand2  g069(.a(x30), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n105_), .c(x31), .O(new_n115_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n105_), .c(new_n78_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n77_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(z7));
  oai22  g078(.a(new_n110_), .b(new_n99_), .c(new_n106_), .d(new_n109_), .O(new_n123_));
  ...
  nand3  g096(.a(x32), .b(new_n109_), .c(new_n79_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(x28), .O(new_n142_));
  nand2  g098(.a(x16), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n131_), .c(new_n136_), .O(new_n144_));
  ...
  oai22  g107(.a(new_n151_), .b(new_n131_), .c(x19), .d(x14), .O(new_n152_));
  aoi21  g108(.a(new_n109_), .b(new_n98_), .c(new_n118_), .O(new_n153_));
  oai21  g109(.a(new_n114_), .b(new_n99_), .c(new_n153_), .O(new_n154_));
  nor3   g110(.a(new_n154_), .b(new_n152_), .c(new_n150_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n149_), .c(new_n147_), .d(new_n144_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(x32), .c(new_n142_), .O(new_n157_));
  ...
  nand2  g116(.a(new_n99_), .b(new_n79_), .O(new_n161_));
  inv1   g117(.a(x33), .O(new_n162_));
  nand4  g118(.a(new_n138_), .b(new_n162_), .c(x31), .d(x30), .O(new_n163_));
  nand2  g119(.a(x33), .b(new_n118_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n161_), .c(x29), .O(new_n166_));
  nand2  g122(.a(new_n161_), .b(x29), .O(new_n167_));
  nand4  g123(.a(new_n138_), .b(new_n162_), .c(new_n118_), .d(new_n109_), .O(new_n168_));
  nand2  g124(.a(x33), .b(x31), .O(new_n169_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n151_), .c(new_n89_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n143_), .c(new_n136_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n130_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n83_), .O(new_n180_));
  inv1   g136(.a(x13), .O(new_n181_));
  nand2  g137(.a(new_n86_), .b(new_n181_), .O(new_n182_));
  xnor2a g138(.a(x31), .b(x30), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n180_), .d(new_n178_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n176_), .c(new_n175_), .d(new_n173_), .O(new_n186_));
