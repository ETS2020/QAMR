...
module FAU ( 
  ...
  inv1   g081(.a(new_n124_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x29), .O(new_n127_));
  aoi22  g083(.a(new_n127_), .b(x30), .c(new_n125_), .d(x29), .O(new_n128_));
  ...
  nand4  g099(.a(new_n143_), .b(z0), .c(x31), .d(new_n78_), .O(new_n144_));
  ...
  nand2  g107(.a(new_n150_), .b(x12), .O(new_n152_));
  ...
  nor2   g112(.a(new_n135_), .b(new_n141_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n137_), .c(new_n156_), .O(new_n158_));
  ...
  aoi21  g117(.a(new_n151_), .b(new_n135_), .c(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n149_), .c(new_n147_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x32), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n144_), .c(new_n123_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand2  g122(.a(new_n142_), .b(new_n140_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n166_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n118_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n126_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n167_), .b(new_n166_), .c(new_n118_), .d(new_n107_), .O(new_n172_));
  ...
  inv1   g133(.a(new_n157_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x17), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n89_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n148_), .c(new_n141_), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n135_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x12), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n83_), .O(new_n185_));
  nand2  g141(.a(new_n86_), .b(new_n154_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n183_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n181_), .c(new_n180_), .d(new_n177_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n175_), .c(new_n171_), .O(new_n192_));
