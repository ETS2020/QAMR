// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:55 2020
...
module FAU ( 
  ...
  nand2  g056(.a(x30), .b(new_n77_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(new_n92_), .d(x29), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  nand4  g059(.a(new_n92_), .b(new_n103_), .c(x28), .d(x27), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n77_), .c(new_n102_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n58_), .c(new_n78_), .d(x01), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  nand2  g063(.a(new_n99_), .b(x29), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x30), .c(x25), .O(new_n109_));
  inv1   g065(.a(x30), .O(new_n110_));
  nand3  g066(.a(new_n99_), .b(new_n110_), .c(x29), .O(new_n111_));
  ...
  nor2   g070(.a(new_n110_), .b(new_n103_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n99_), .O(new_n116_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n100_), .c(new_n78_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n77_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(z7));
  nor2   g080(.a(x28), .b(x27), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n110_), .c(x29), .O(new_n127_));
  nor2   g083(.a(new_n125_), .b(new_n103_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n110_), .c(new_n127_), .O(new_n129_));
  ...
  nand3  g096(.a(new_n140_), .b(new_n136_), .c(x11), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n135_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n129_), .c(z0), .d(x31), .O(new_n147_));
  nand2  g103(.a(new_n115_), .b(x27), .O(new_n148_));
  oai21  g104(.a(x30), .b(x27), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n98_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n139_), .c(new_n144_), .O(new_n152_));
  nand2  g108(.a(x17), .b(x11), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n137_), .c(new_n136_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n137_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n89_), .b(new_n157_), .c(new_n86_), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  nor2   g115(.a(new_n136_), .b(new_n144_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n140_), .c(new_n159_), .O(new_n161_));
  oai21  g117(.a(x30), .b(x29), .c(x31), .O(new_n162_));
  aoi21  g118(.a(new_n115_), .b(x28), .c(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n161_), .c(new_n158_), .d(new_n156_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x32), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n147_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n78_), .c(x00), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n146_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n120_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n126_), .c(x29), .O(new_n175_));
  inv1   g131(.a(new_n128_), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n171_), .c(new_n120_), .d(new_n110_), .O(new_n177_));
  ...
  aoi21  g136(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x17), .c(x16), .d(x15), .O(new_n182_));
  inv1   g138(.a(new_n160_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(new_n89_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n151_), .c(new_n144_), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n136_), .O(new_n188_));
  oai21  g144(.a(new_n86_), .b(new_n155_), .c(new_n83_), .O(new_n189_));
  nand2  g145(.a(new_n86_), .b(new_n157_), .O(new_n190_));
  ...
  nand3  g151(.a(new_n195_), .b(new_n180_), .c(new_n175_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n78_), .c(x00), .O(new_n197_));
