...
module FAU ( 
  ...
  nand2  g056(.a(x29), .b(x28), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n83_), .c(new_n82_), .O(new_n102_));
  inv1   g058(.a(x30), .O(new_n103_));
  nand2  g059(.a(new_n87_), .b(new_n81_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n103_), .c(x29), .d(x28), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x27), .O(new_n107_));
  nor2   g063(.a(new_n94_), .b(new_n95_), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(x27), .c(new_n87_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(x27), .b(x22), .c(x17), .O(new_n110_));
  ...
  nor2   g070(.a(new_n103_), .b(new_n94_), .O(new_n115_));
  ...
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(new_n84_), .d(new_n81_), .O(new_n120_));
  nor2   g076(.a(new_n57_), .b(new_n56_), .O(new_n121_));
  inv1   g077(.a(new_n96_), .O(new_n122_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n121_), .c(new_n120_), .d(new_n117_), .O(z7));
  nor2   g083(.a(x28), .b(x27), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n103_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n94_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n103_), .c(new_n130_), .O(new_n132_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n134_), .c(new_n82_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n138_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n132_), .c(z0), .d(x31), .O(new_n152_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n82_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n135_), .b(new_n162_), .c(new_n133_), .O(new_n163_));
  ...
  aoi21  g123(.a(new_n115_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  inv1   g136(.a(new_n131_), .O(new_n181_));
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n123_), .d(new_n103_), .O(new_n182_));
  ...
  oai21  g149(.a(new_n133_), .b(new_n160_), .c(new_n82_), .O(new_n194_));
  nand2  g150(.a(new_n133_), .b(new_n162_), .O(new_n195_));
  ...
  nand3  g157(.a(new_n201_), .b(new_n78_), .c(x00), .O(new_n202_));
