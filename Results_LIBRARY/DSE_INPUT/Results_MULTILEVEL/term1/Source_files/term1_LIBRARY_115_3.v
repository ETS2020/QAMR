// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:20 2020
...
module FAU ( 
  ...
  nand3  g084(.a(new_n128_), .b(new_n107_), .c(x17), .O(new_n129_));
  ...
  nand2  g089(.a(new_n107_), .b(x19), .O(new_n134_));
  nor3   g090(.a(new_n134_), .b(new_n133_), .c(new_n86_), .O(new_n135_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n137_), .d(x10), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n124_), .c(x29), .O(new_n143_));
  nor2   g099(.a(new_n123_), .b(new_n98_), .O(new_n144_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n145_), .c(x30), .d(x17), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n143_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(z0), .c(x31), .O(new_n155_));
  nand2  g111(.a(new_n112_), .b(x27), .O(new_n156_));
  oai21  g112(.a(x30), .b(x27), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n99_), .O(new_n158_));
  nor2   g114(.a(new_n125_), .b(new_n150_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n130_), .c(x12), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n83_), .O(new_n161_));
  inv1   g117(.a(new_n130_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x10), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n150_), .O(new_n164_));
  inv1   g120(.a(x11), .O(new_n165_));
  oai21  g121(.a(new_n162_), .b(new_n165_), .c(new_n125_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  oai21  g123(.a(new_n89_), .b(new_n167_), .c(new_n86_), .O(new_n168_));
  nor2   g124(.a(x19), .b(x14), .O(new_n169_));
  nand2  g125(.a(new_n130_), .b(x17), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n159_), .c(new_n169_), .O(new_n172_));
  ...
  nand4  g132(.a(new_n176_), .b(new_n164_), .c(new_n161_), .d(new_n158_), .O(new_n177_));
  ...
  nand3  g139(.a(new_n142_), .b(new_n183_), .c(new_n118_), .O(new_n184_));
  nand2  g140(.a(x33), .b(x31), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n184_), .c(new_n144_), .O(new_n186_));
  nand4  g142(.a(new_n152_), .b(new_n183_), .c(x31), .d(x30), .O(new_n187_));
  nand2  g143(.a(x33), .b(new_n118_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n83_), .c(new_n188_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n124_), .c(x29), .O(new_n190_));
  aoi21  g146(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x17), .c(x16), .d(x15), .O(new_n192_));
  nand2  g148(.a(new_n159_), .b(new_n140_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n89_), .O(new_n194_));
  oai21  g150(.a(new_n163_), .b(new_n139_), .c(new_n150_), .O(new_n195_));
  oai21  g151(.a(new_n139_), .b(new_n165_), .c(new_n125_), .O(new_n196_));
  nand2  g152(.a(x18), .b(x12), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n83_), .O(new_n198_));
  nand2  g154(.a(new_n86_), .b(new_n167_), .O(new_n199_));
  xnor2a g155(.a(x31), .b(x30), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n199_), .c(new_n198_), .d(new_n196_), .O(new_n201_));
  ...
  oai21  g161(.a(new_n205_), .b(new_n186_), .c(new_n78_), .O(new_n206_));
  nor2   g162(.a(new_n206_), .b(new_n182_), .O(z9));
endmodule
