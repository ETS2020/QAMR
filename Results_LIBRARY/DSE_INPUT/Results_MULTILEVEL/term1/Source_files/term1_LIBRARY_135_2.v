// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:27 2020
...
module FAU ( 
  ...
  nand4  g082(.a(x30), .b(new_n89_), .c(x18), .d(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n83_), .O(new_n128_));
  inv1   g084(.a(x12), .O(new_n129_));
  nand3  g085(.a(x30), .b(x19), .c(x18), .O(new_n130_));
  nor3   g086(.a(new_n130_), .b(x17), .c(new_n129_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  inv1   g088(.a(x16), .O(new_n133_));
  inv1   g089(.a(new_n130_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(x17), .c(new_n133_), .d(x11), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n125_), .O(new_n136_));
  nand3  g092(.a(x16), .b(new_n125_), .c(x10), .O(new_n137_));
  nor2   g093(.a(new_n86_), .b(new_n83_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x30), .c(x19), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n136_), .c(z0), .O(new_n141_));
  nand2  g097(.a(x32), .b(new_n107_), .O(new_n142_));
  oai21  g098(.a(new_n141_), .b(new_n117_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n124_), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n83_), .c(x12), .O(new_n145_));
  nand3  g101(.a(new_n89_), .b(x17), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n133_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x17), .c(new_n133_), .d(x11), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n147_), .c(x15), .O(new_n150_));
  nor2   g106(.a(new_n89_), .b(new_n83_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(x16), .c(new_n125_), .d(x10), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n150_), .c(new_n122_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(z0), .c(x31), .d(new_n107_), .O(new_n154_));
  nand2  g110(.a(new_n99_), .b(new_n79_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x32), .c(x30), .O(new_n156_));
  oai21  g112(.a(new_n154_), .b(new_n86_), .c(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x29), .O(new_n158_));
  and2   g114(.a(x16), .b(x10), .O(new_n159_));
  nor2   g115(.a(new_n89_), .b(new_n86_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x17), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n159_), .c(x15), .O(new_n163_));
  nand3  g119(.a(new_n160_), .b(x17), .c(x11), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n133_), .O(new_n165_));
  nand2  g121(.a(new_n160_), .b(x12), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n83_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  oai21  g124(.a(new_n89_), .b(new_n168_), .c(new_n86_), .O(new_n169_));
  nor2   g125(.a(x19), .b(x14), .O(new_n170_));
  nor2   g126(.a(new_n133_), .b(new_n125_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n162_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x31), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n163_), .c(x32), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n158_), .c(new_n144_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n78_), .c(x00), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(z8));
  inv1   g135(.a(x33), .O(new_n180_));
  oai21  g136(.a(new_n140_), .b(new_n136_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(x33), .b(new_n117_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n117_), .c(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n123_), .c(x29), .O(new_n184_));
  nand2  g140(.a(new_n152_), .b(new_n150_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n180_), .c(new_n117_), .d(new_n107_), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n86_), .c(new_n180_), .d(new_n117_), .O(new_n187_));
  aoi21  g143(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  aoi21  g145(.a(new_n171_), .b(new_n138_), .c(x19), .O(new_n190_));
  aoi21  g146(.a(new_n159_), .b(new_n138_), .c(x15), .O(new_n191_));
  aoi21  g147(.a(new_n138_), .b(x11), .c(x16), .O(new_n192_));
  oai21  g148(.a(new_n86_), .b(new_n129_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n168_), .O(new_n194_));
  xnor2a g150(.a(x31), .b(x30), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n194_), .c(new_n193_), .O(new_n196_));
  nor4   g152(.a(new_n196_), .b(new_n192_), .c(new_n191_), .d(new_n190_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n189_), .c(new_n180_), .O(new_n198_));
  aoi21  g154(.a(new_n187_), .b(new_n124_), .c(new_n198_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n184_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n78_), .c(x00), .O(new_n201_));
