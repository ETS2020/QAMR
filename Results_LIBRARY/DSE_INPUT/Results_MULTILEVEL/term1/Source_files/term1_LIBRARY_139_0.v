...
module FAU ( 
  ...
  nand3  g059(.a(new_n103_), .b(new_n87_), .c(new_n86_), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(new_n106_));
  ...
  nor3   g067(.a(x27), .b(x24), .c(x19), .O(new_n112_));
  ...
  nand4  g075(.a(new_n88_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n120_));
  ...
  nand3  g091(.a(new_n86_), .b(x18), .c(x14), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n133_), .O(new_n137_));
  ...
  oai21  g118(.a(new_n86_), .b(new_n162_), .c(new_n134_), .O(new_n163_));
  ...
  oai21  g149(.a(new_n134_), .b(new_n160_), .c(new_n133_), .O(new_n194_));
  nand2  g150(.a(new_n134_), .b(new_n162_), .O(new_n195_));
