...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n91_), .c(new_n57_), .d(new_n77_), .O(new_n101_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n57_), .d(new_n77_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n76_), .c(new_n56_), .O(z6));
  nand4  g065(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n110_));
  nand3  g066(.a(new_n98_), .b(x30), .c(x29), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n77_), .c(x25), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n110_), .c(new_n57_), .d(x01), .O(z7));
  nand3  g070(.a(x32), .b(new_n77_), .c(x00), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(z8));
  inv1   g072(.a(x33), .O(new_n117_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n118_), .c(new_n117_), .d(new_n105_), .O(new_n134_));
  aoi21  g090(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n135_));
  ...
  aoi21  g102(.a(new_n85_), .b(new_n146_), .c(x30), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n139_), .c(new_n136_), .d(new_n118_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x33), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n134_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n77_), .c(x00), .O(new_n153_));
