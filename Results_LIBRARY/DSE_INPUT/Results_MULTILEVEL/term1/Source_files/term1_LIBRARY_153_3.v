...
module FAU ( 
  ...
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(new_n78_), .O(new_n135_));
  nand3  g091(.a(x19), .b(x18), .c(x17), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n129_), .c(x11), .O(new_n138_));
  oai21  g094(.a(new_n135_), .b(new_n129_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x15), .O(new_n140_));
  nor2   g096(.a(new_n129_), .b(x15), .O(new_n141_));
  nand2  g097(.a(x18), .b(x17), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n89_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n141_), .d(x10), .O(new_n145_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n142_), .c(new_n89_), .O(new_n154_));
  inv1   g110(.a(x15), .O(new_n155_));
  nand3  g111(.a(new_n143_), .b(x16), .c(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n142_), .b(new_n159_), .c(new_n129_), .O(new_n160_));
  ...
  oai21  g126(.a(new_n134_), .b(new_n132_), .c(x15), .O(new_n171_));
  nand3  g127(.a(new_n137_), .b(new_n155_), .c(x10), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(x33), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x31), .c(x30), .d(x16), .O(new_n174_));
  nand2  g130(.a(x33), .b(new_n118_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n78_), .O(new_n177_));
  nor2   g133(.a(new_n89_), .b(new_n86_), .O(new_n178_));
  nand4  g134(.a(x17), .b(new_n129_), .c(x15), .d(x11), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nor2   g136(.a(x33), .b(new_n118_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n178_), .d(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n177_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n125_), .c(x29), .O(new_n184_));
  inv1   g140(.a(new_n127_), .O(new_n185_));
  nand4  g141(.a(new_n173_), .b(new_n118_), .c(new_n107_), .d(x16), .O(new_n186_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n180_), .c(new_n178_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand2  g148(.a(new_n86_), .b(new_n163_), .O(new_n193_));
  xnor2a g149(.a(x31), .b(x30), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n193_), .c(new_n162_), .d(new_n160_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n157_), .c(new_n154_), .d(new_n149_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(x33), .c(new_n78_), .O(new_n198_));
  inv1   g154(.a(new_n198_), .O(new_n199_));
  aoi21  g155(.a(new_n192_), .b(new_n185_), .c(new_n199_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n184_), .c(new_n123_), .O(z9));
endmodule
