...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n94_));
  ...
  oai21  g072(.a(x23), .b(x18), .c(x19), .O(new_n117_));
  oai21  g073(.a(new_n92_), .b(x19), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n119_));
  ...
  nand3  g087(.a(x17), .b(new_n83_), .c(x11), .O(new_n132_));
  nand3  g088(.a(new_n86_), .b(x16), .c(x12), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(x19), .c(x18), .O(new_n135_));
  nand2  g091(.a(new_n89_), .b(x13), .O(new_n136_));
  nand2  g092(.a(new_n90_), .b(x14), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x17), .c(x16), .O(new_n139_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n131_), .c(z0), .d(x31), .O(new_n146_));
  ...
  nand2  g105(.a(x15), .b(x13), .O(new_n150_));
  ...
  nand2  g109(.a(x19), .b(x17), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n153_), .c(new_n80_), .O(new_n155_));
  inv1   g111(.a(x11), .O(new_n156_));
  oai21  g112(.a(new_n154_), .b(new_n156_), .c(new_n83_), .O(new_n157_));
  nand2  g113(.a(x19), .b(x12), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n86_), .O(new_n159_));
  nor2   g115(.a(x19), .b(x14), .O(new_n160_));
  nor2   g116(.a(new_n83_), .b(new_n80_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n143_), .c(new_n160_), .O(new_n162_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n155_), .c(new_n152_), .d(new_n149_), .O(new_n167_));
  ...
  nand4  g133(.a(new_n145_), .b(new_n172_), .c(new_n122_), .d(new_n109_), .O(new_n178_));
  ...
  nand4  g137(.a(new_n137_), .b(x18), .c(x17), .d(x16), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n80_), .O(new_n183_));
  oai22  g139(.a(new_n151_), .b(new_n80_), .c(new_n90_), .d(new_n89_), .O(new_n184_));
  inv1   g140(.a(x10), .O(new_n185_));
  oai21  g141(.a(new_n151_), .b(new_n185_), .c(new_n80_), .O(new_n186_));
  oai21  g142(.a(new_n86_), .b(new_n156_), .c(new_n83_), .O(new_n187_));
  oai22  g143(.a(x18), .b(x13), .c(x17), .d(x12), .O(new_n188_));
  xor2a  g144(.a(x31), .b(x30), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n187_), .c(new_n186_), .d(new_n184_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n183_), .c(x33), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n181_), .c(new_n176_), .O(new_n193_));
