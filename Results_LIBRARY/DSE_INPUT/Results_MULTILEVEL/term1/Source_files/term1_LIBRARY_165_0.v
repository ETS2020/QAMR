...
module FAU ( 
  ...
  nand2  g076(.a(new_n106_), .b(x29), .O(new_n121_));
  nand2  g077(.a(new_n99_), .b(new_n79_), .O(new_n122_));
  nand2  g078(.a(x30), .b(new_n98_), .O(new_n123_));
  ...
  nand2  g096(.a(new_n99_), .b(new_n79_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x30), .c(x29), .O(new_n142_));
  nand2  g098(.a(x16), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n132_), .c(new_n137_), .O(new_n144_));
  nor2   g100(.a(new_n89_), .b(new_n86_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x17), .c(x11), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n131_), .O(new_n147_));
  aoi21  g103(.a(new_n145_), .b(x12), .c(x17), .O(new_n148_));
  aoi21  g104(.a(x19), .b(x13), .c(x18), .O(new_n149_));
  inv1   g105(.a(x14), .O(new_n150_));
  nand2  g106(.a(new_n89_), .b(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n133_), .b(x16), .c(x15), .O(new_n152_));
  aoi21  g108(.a(new_n106_), .b(new_n98_), .c(new_n116_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  nor3   g110(.a(new_n154_), .b(new_n149_), .c(new_n148_), .O(new_n155_));
  ...
  nand4  g117(.a(new_n122_), .b(x31), .c(x30), .d(x29), .O(new_n162_));
  nand3  g118(.a(new_n116_), .b(new_n106_), .c(new_n98_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n139_), .c(new_n161_), .O(new_n165_));
  nand2  g121(.a(new_n89_), .b(x14), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x18), .c(x17), .d(x16), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n137_), .O(new_n168_));
  ...
  oai21  g127(.a(new_n170_), .b(new_n143_), .c(new_n137_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n170_), .b(new_n173_), .c(new_n131_), .O(new_n174_));
  aoi21  g130(.a(x18), .b(x12), .c(x17), .O(new_n175_));
  oai21  g131(.a(x18), .b(x13), .c(new_n122_), .O(new_n176_));
  nand2  g132(.a(new_n116_), .b(x30), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n98_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n177_), .c(new_n121_), .O(new_n179_));
  nor3   g135(.a(new_n179_), .b(new_n176_), .c(new_n175_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n174_), .c(new_n172_), .d(new_n171_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n168_), .c(x33), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n165_), .O(new_n183_));
