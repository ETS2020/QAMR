...
module FAU ( 
  ...
  nand4  g066(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n90_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n57_), .c(new_n77_), .d(x25), .O(new_n114_));
  inv1   g070(.a(new_n79_), .O(new_n115_));
  nand3  g071(.a(new_n85_), .b(new_n82_), .c(new_n115_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n57_), .b(new_n77_), .c(x25), .d(x01), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(new_n88_), .c(new_n118_), .O(new_n119_));
  oai21  g075(.a(new_n114_), .b(new_n56_), .c(new_n119_), .O(z7));
  nand2  g076(.a(new_n98_), .b(new_n78_), .O(new_n121_));
  inv1   g077(.a(x15), .O(new_n122_));
  nand3  g078(.a(x19), .b(new_n83_), .c(x13), .O(new_n123_));
  nand3  g079(.a(new_n86_), .b(x18), .c(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n80_), .O(new_n125_));
  nand4  g081(.a(x19), .b(x18), .c(new_n80_), .d(x12), .O(new_n126_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n128_), .c(new_n122_), .O(new_n133_));
  inv1   g089(.a(x10), .O(new_n134_));
  nor4   g090(.a(new_n130_), .b(new_n129_), .c(x15), .d(new_n134_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(z0), .O(new_n136_));
  nand2  g092(.a(x32), .b(x30), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(x30), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n121_), .c(x29), .O(new_n139_));
  nand2  g095(.a(new_n121_), .b(x29), .O(new_n140_));
  nand2  g096(.a(x32), .b(new_n106_), .O(new_n141_));
  oai21  g097(.a(new_n136_), .b(new_n106_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nor2   g099(.a(new_n129_), .b(new_n134_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n131_), .c(x15), .O(new_n145_));
  ...
  oai21  g107(.a(new_n86_), .b(new_n151_), .c(new_n83_), .O(new_n152_));
  nor2   g108(.a(x19), .b(x14), .O(new_n153_));
  nor2   g109(.a(new_n129_), .b(new_n122_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n131_), .c(new_n153_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n145_), .c(x32), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n143_), .c(new_n139_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n77_), .c(x00), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  or2    g117(.a(new_n135_), .b(new_n133_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n121_), .c(new_n161_), .d(x30), .O(new_n163_));
  aoi21  g119(.a(new_n86_), .b(x14), .c(new_n83_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(x17), .c(x16), .d(x15), .O(new_n165_));
  nor2   g121(.a(new_n83_), .b(new_n80_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n154_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n86_), .O(new_n168_));
  nand2  g124(.a(new_n166_), .b(new_n144_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n122_), .O(new_n170_));
  aoi21  g126(.a(new_n166_), .b(x11), .c(x16), .O(new_n171_));
  aoi21  g127(.a(x18), .b(x12), .c(x17), .O(new_n172_));
  nand2  g128(.a(new_n83_), .b(new_n151_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n121_), .c(x30), .d(x29), .O(new_n174_));
  nor3   g130(.a(new_n174_), .b(new_n172_), .c(new_n171_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n170_), .c(new_n168_), .d(new_n165_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  oai21  g133(.a(new_n163_), .b(new_n97_), .c(new_n177_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n77_), .c(x00), .O(new_n179_));
