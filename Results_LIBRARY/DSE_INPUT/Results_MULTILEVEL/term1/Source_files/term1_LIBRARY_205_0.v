// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:50 2020
...
module FAU ( 
  ...
  nand3  g101(.a(new_n145_), .b(x30), .c(x15), .O(new_n146_));
  ...
  nand2  g105(.a(x32), .b(new_n104_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n131_), .O(new_n151_));
  inv1   g107(.a(new_n130_), .O(new_n152_));
  nand4  g108(.a(new_n145_), .b(new_n152_), .c(z0), .d(x31), .O(new_n153_));
  nand2  g109(.a(new_n96_), .b(new_n79_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(x32), .c(x30), .O(new_n155_));
  oai21  g111(.a(new_n153_), .b(x30), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x29), .O(new_n157_));
  and2   g113(.a(x16), .b(x10), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n143_), .c(x15), .O(new_n159_));
  nand2  g115(.a(x19), .b(x18), .O(new_n160_));
  nand2  g116(.a(x17), .b(x11), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n141_), .O(new_n162_));
  inv1   g118(.a(x12), .O(new_n163_));
  oai21  g119(.a(new_n160_), .b(new_n163_), .c(new_n132_), .O(new_n164_));
  inv1   g120(.a(x13), .O(new_n165_));
  oai21  g121(.a(new_n135_), .b(new_n165_), .c(new_n133_), .O(new_n166_));
  nor2   g122(.a(x19), .b(x14), .O(new_n167_));
  nor2   g123(.a(new_n141_), .b(new_n80_), .O(new_n168_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n157_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n151_), .c(new_n78_), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n129_), .O(z8));
  inv1   g132(.a(x33), .O(new_n177_));
  nand3  g133(.a(new_n148_), .b(new_n177_), .c(x31), .O(new_n178_));
  nand2  g134(.a(x33), .b(new_n124_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n152_), .c(x29), .O(new_n181_));
  inv1   g137(.a(new_n131_), .O(new_n182_));
  nand4  g138(.a(new_n145_), .b(new_n177_), .c(new_n124_), .d(new_n104_), .O(new_n183_));
  oai21  g139(.a(new_n177_), .b(new_n124_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n135_), .b(x14), .c(new_n133_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x17), .c(x16), .d(x15), .O(new_n186_));
  nor2   g142(.a(new_n133_), .b(new_n132_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n168_), .c(x19), .O(new_n188_));
  aoi21  g144(.a(new_n187_), .b(new_n158_), .c(x15), .O(new_n189_));
  aoi21  g145(.a(new_n187_), .b(x11), .c(x16), .O(new_n190_));
  oai21  g146(.a(new_n133_), .b(new_n163_), .c(new_n132_), .O(new_n191_));
  nand2  g147(.a(new_n133_), .b(new_n165_), .O(new_n192_));
  xnor2a g148(.a(x31), .b(x30), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n192_), .c(new_n191_), .O(new_n194_));
  nor4   g150(.a(new_n194_), .b(new_n190_), .c(new_n189_), .d(new_n188_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n186_), .c(new_n177_), .O(new_n196_));
  aoi21  g152(.a(new_n184_), .b(new_n182_), .c(new_n196_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n181_), .O(new_n198_));
