...
module FAU ( 
  ...
  nand2  g056(.a(x30), .b(new_n56_), .O(new_n101_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n56_), .c(new_n102_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  nand2  g063(.a(new_n99_), .b(x29), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x30), .c(x01), .O(new_n109_));
  ...
  nor2   g069(.a(new_n113_), .b(new_n77_), .O(z6));
