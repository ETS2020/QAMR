// Benchmark "FAU" written by ABC on Mon Jul 27 22:01:51 2020
...
module FAU ( 
  ...
  nand3  g081(.a(new_n125_), .b(new_n107_), .c(x29), .O(new_n126_));
  nor2   g082(.a(new_n124_), .b(new_n98_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n107_), .c(new_n126_), .O(new_n128_));
  nand3  g084(.a(new_n89_), .b(x18), .c(x14), .O(new_n129_));
  nand4  g085(.a(new_n78_), .b(x19), .c(new_n86_), .d(x13), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n83_), .O(new_n131_));
  nand2  g087(.a(new_n83_), .b(x12), .O(new_n132_));
  nand3  g088(.a(new_n78_), .b(x19), .c(x18), .O(new_n133_));
  ...
  nor2   g096(.a(x26), .b(new_n89_), .O(new_n141_));
  nor2   g097(.a(new_n136_), .b(x15), .O(new_n142_));
  nand2  g098(.a(x18), .b(x17), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(x10), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(z0), .d(x31), .O(new_n147_));
  aoi21  g103(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x17), .c(x16), .d(x15), .O(new_n149_));
  nand2  g105(.a(new_n112_), .b(x27), .O(new_n150_));
  oai21  g106(.a(x30), .b(x27), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n99_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n143_), .c(new_n89_), .O(new_n154_));
  inv1   g110(.a(x15), .O(new_n155_));
  nand3  g111(.a(new_n144_), .b(x16), .c(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n143_), .b(new_n159_), .c(new_n136_), .O(new_n160_));
  nand2  g116(.a(x18), .b(x12), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n83_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  aoi22  g119(.a(new_n112_), .b(x28), .c(new_n86_), .d(new_n163_), .O(new_n164_));
  aoi21  g120(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(x32), .c(new_n78_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n147_), .c(new_n123_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n146_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  nand3  g128(.a(x33), .b(new_n118_), .c(new_n78_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n125_), .c(x29), .O(new_n175_));
  inv1   g131(.a(new_n127_), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n171_), .c(new_n118_), .d(new_n107_), .O(new_n177_));
  nand3  g133(.a(x33), .b(x31), .c(new_n78_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n86_), .b(new_n163_), .O(new_n180_));
  ...
  nand4  g139(.a(new_n183_), .b(new_n157_), .c(new_n154_), .d(new_n149_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(x33), .c(new_n78_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n179_), .b(new_n176_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n175_), .c(new_n123_), .O(z9));
endmodule
