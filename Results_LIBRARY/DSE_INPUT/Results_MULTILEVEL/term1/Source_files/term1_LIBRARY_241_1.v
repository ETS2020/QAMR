...
module FAU ( 
  ...
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n88_), .O(new_n130_));
  nand4  g086(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n131_));
  ...
  oai21  g109(.a(new_n135_), .b(new_n153_), .c(new_n88_), .O(new_n154_));
  ...
  aoi21  g134(.a(new_n83_), .b(x14), .c(new_n80_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n80_), .b(new_n153_), .c(new_n88_), .O(new_n187_));
