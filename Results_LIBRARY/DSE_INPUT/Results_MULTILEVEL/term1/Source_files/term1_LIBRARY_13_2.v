...
module FAU ( 
  ...
  oai21  g086(.a(new_n130_), .b(new_n128_), .c(x30), .O(new_n131_));
  nand3  g087(.a(x19), .b(x18), .c(x17), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n125_), .c(x11), .O(new_n134_));
  oai21  g090(.a(new_n131_), .b(new_n125_), .c(new_n134_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x15), .O(new_n136_));
  nor2   g092(.a(new_n125_), .b(x15), .O(new_n137_));
  nor2   g093(.a(new_n86_), .b(new_n83_), .O(new_n138_));
  nor2   g094(.a(new_n107_), .b(new_n89_), .O(new_n139_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n142_), .c(new_n124_), .O(new_n144_));
  oai21  g100(.a(new_n130_), .b(new_n128_), .c(x15), .O(new_n145_));
  inv1   g101(.a(x15), .O(new_n146_));
  nand3  g102(.a(new_n133_), .b(new_n146_), .c(x10), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n145_), .c(new_n123_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(z0), .c(x31), .d(new_n107_), .O(new_n149_));
  nand2  g105(.a(new_n99_), .b(new_n79_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x32), .c(x30), .O(new_n151_));
  oai21  g107(.a(new_n149_), .b(new_n125_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x29), .O(new_n153_));
  and2   g109(.a(x16), .b(x10), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n133_), .c(x15), .O(new_n155_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n132_), .c(x31), .O(new_n165_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n144_), .c(new_n78_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n122_), .O(z8));
  inv1   g127(.a(new_n123_), .O(new_n172_));
  inv1   g128(.a(x33), .O(new_n173_));
  nand3  g129(.a(new_n141_), .b(new_n173_), .c(x31), .O(new_n174_));
  ...
  inv1   g133(.a(new_n124_), .O(new_n178_));
  nand2  g134(.a(new_n147_), .b(new_n145_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n173_), .c(new_n117_), .d(new_n107_), .O(new_n180_));
  oai22  g136(.a(new_n180_), .b(new_n125_), .c(new_n173_), .d(new_n117_), .O(new_n181_));
  aoi21  g137(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x17), .c(x16), .d(x15), .O(new_n183_));
  inv1   g139(.a(new_n164_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n138_), .c(x19), .O(new_n185_));
  aoi21  g141(.a(new_n154_), .b(new_n138_), .c(x15), .O(new_n186_));
  aoi21  g142(.a(new_n138_), .b(x11), .c(x16), .O(new_n187_));
  nand2  g143(.a(x18), .b(x12), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n83_), .O(new_n189_));
  nand2  g145(.a(new_n86_), .b(new_n161_), .O(new_n190_));
  xnor2a g146(.a(x31), .b(x30), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  nor4   g148(.a(new_n192_), .b(new_n187_), .c(new_n186_), .d(new_n185_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n183_), .c(new_n173_), .O(new_n194_));
  aoi21  g150(.a(new_n181_), .b(new_n178_), .c(new_n194_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n177_), .O(new_n196_));
