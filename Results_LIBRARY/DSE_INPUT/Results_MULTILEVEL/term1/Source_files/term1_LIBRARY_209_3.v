...
module FAU ( 
  ...
  nand2  g115(.a(new_n130_), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n150_), .O(new_n161_));
  ...
  inv1   g122(.a(new_n160_), .O(new_n167_));
  nor2   g123(.a(x19), .b(x14), .O(new_n168_));
  nor2   g124(.a(new_n125_), .b(new_n150_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n167_), .c(new_n168_), .O(new_n170_));
  oai21  g126(.a(x30), .b(x29), .c(x31), .O(new_n171_));
  aoi21  g127(.a(new_n112_), .b(x28), .c(new_n171_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n170_), .c(new_n166_), .d(new_n164_), .O(new_n173_));
  aoi21  g129(.a(new_n162_), .b(new_n125_), .c(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n161_), .c(new_n158_), .O(new_n175_));
  ...
  inv1   g135(.a(x00), .O(new_n180_));
  inv1   g136(.a(x33), .O(new_n181_));
  nand3  g137(.a(new_n142_), .b(new_n181_), .c(new_n118_), .O(new_n182_));
  nand2  g138(.a(x33), .b(x31), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n182_), .c(new_n144_), .O(new_n184_));
  nand4  g140(.a(new_n152_), .b(new_n181_), .c(x31), .d(x30), .O(new_n185_));
  nand2  g141(.a(x33), .b(new_n118_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n83_), .c(new_n186_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n124_), .c(x29), .O(new_n188_));
  aoi21  g144(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(x17), .c(x16), .d(x15), .O(new_n190_));
  nand2  g146(.a(new_n169_), .b(new_n140_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n89_), .O(new_n192_));
  oai21  g148(.a(new_n159_), .b(new_n139_), .c(new_n150_), .O(new_n193_));
  inv1   g149(.a(x11), .O(new_n194_));
  oai21  g150(.a(new_n139_), .b(new_n194_), .c(new_n125_), .O(new_n195_));
  nand2  g151(.a(x18), .b(x12), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n83_), .O(new_n197_));
  nand2  g153(.a(new_n86_), .b(new_n165_), .O(new_n198_));
  ...
  nand4  g157(.a(new_n201_), .b(new_n193_), .c(new_n192_), .d(new_n190_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x33), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n188_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n184_), .c(new_n78_), .O(new_n205_));
  nor2   g161(.a(new_n205_), .b(new_n180_), .O(z9));
endmodule
