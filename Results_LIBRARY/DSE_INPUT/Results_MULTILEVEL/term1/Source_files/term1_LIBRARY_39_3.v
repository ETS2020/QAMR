...
module FAU ( 
  ...
  oai21  g068(.a(x30), .b(new_n78_), .c(new_n97_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x29), .O(new_n114_));
  nand2  g070(.a(x29), .b(x27), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n104_), .c(new_n114_), .O(new_n117_));
  nand3  g073(.a(x19), .b(new_n85_), .c(x13), .O(new_n118_));
  inv1   g074(.a(x19), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x18), .c(x14), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n82_), .O(new_n121_));
  ...
  nand3  g087(.a(x16), .b(new_n131_), .c(x10), .O(new_n132_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n117_), .c(z0), .d(x31), .O(new_n136_));
  oai21  g092(.a(x28), .b(x27), .c(x29), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n104_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n126_), .c(new_n131_), .O(new_n140_));
  nor2   g096(.a(new_n119_), .b(new_n85_), .O(new_n141_));
  ...
  oai21  g101(.a(new_n119_), .b(new_n145_), .c(new_n85_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nand2  g103(.a(new_n119_), .b(new_n147_), .O(new_n148_));
  nand3  g104(.a(new_n127_), .b(x16), .c(x15), .O(new_n149_));
  inv1   g105(.a(x31), .O(new_n150_));
  nor2   g106(.a(new_n104_), .b(new_n99_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x27), .c(new_n150_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n149_), .c(new_n148_), .d(new_n146_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n144_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n136_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n77_), .c(x00), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(z8));
  aoi21  g115(.a(new_n128_), .b(new_n124_), .c(new_n131_), .O(new_n160_));
  nand3  g116(.a(new_n137_), .b(new_n150_), .c(new_n104_), .O(new_n161_));
  nand3  g117(.a(new_n116_), .b(x31), .c(x30), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  oai21  g119(.a(new_n133_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n119_), .b(x14), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x18), .c(x17), .d(x16), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n131_), .O(new_n167_));
  nand2  g123(.a(new_n115_), .b(x31), .O(new_n168_));
  nand2  g124(.a(x16), .b(x15), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n169_), .c(new_n119_), .O(new_n171_));
  or2    g127(.a(new_n170_), .b(new_n139_), .O(new_n172_));
  ...
  nand2  g132(.a(new_n85_), .b(new_n145_), .O(new_n177_));
  nand2  g133(.a(new_n150_), .b(x30), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n177_), .c(new_n176_), .d(new_n174_), .O(new_n179_));
  aoi21  g135(.a(new_n172_), .b(new_n131_), .c(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n171_), .c(new_n168_), .d(new_n114_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n167_), .c(x33), .O(new_n182_));
  oai21  g138(.a(new_n164_), .b(x33), .c(new_n182_), .O(new_n183_));
