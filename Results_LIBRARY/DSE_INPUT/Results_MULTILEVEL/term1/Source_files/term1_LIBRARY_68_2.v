...
module FAU ( 
  ...
  oai21  g057(.a(new_n101_), .b(new_n81_), .c(new_n80_), .O(new_n102_));
  nor2   g058(.a(new_n84_), .b(new_n82_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n102_), .c(new_n92_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n100_), .c(new_n58_), .d(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand3  g062(.a(new_n94_), .b(new_n106_), .c(x28), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n79_), .c(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n78_), .c(x25), .d(x01), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z5));
  nand3  g066(.a(x29), .b(new_n81_), .c(new_n80_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n91_), .c(new_n88_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  aoi22  g069(.a(new_n113_), .b(new_n103_), .c(x28), .d(x27), .O(new_n114_));
  aoi21  g070(.a(new_n93_), .b(new_n83_), .c(x29), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(x30), .O(new_n116_));
  nor2   g072(.a(new_n82_), .b(new_n80_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n93_), .c(x30), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x29), .c(x28), .d(x27), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n56_), .O(z6));
  nor2   g078(.a(new_n101_), .b(new_n106_), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n100_), .c(x31), .O(new_n125_));
  nand4  g081(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n83_), .O(new_n126_));
  ...
  nor2   g091(.a(new_n133_), .b(new_n106_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n101_), .c(new_n135_), .O(new_n137_));
  inv1   g093(.a(x17), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n86_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n89_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n138_), .O(new_n141_));
  nand4  g097(.a(x19), .b(x18), .c(new_n138_), .d(x12), .O(new_n142_));
  ...
  nand3  g104(.a(new_n148_), .b(new_n80_), .c(x11), .O(new_n149_));
  ...
  nand2  g112(.a(new_n101_), .b(new_n79_), .O(new_n157_));
  oai21  g113(.a(new_n124_), .b(new_n79_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n145_), .c(new_n80_), .O(new_n163_));
  inv1   g119(.a(x12), .O(new_n164_));
  oai21  g120(.a(new_n145_), .b(new_n164_), .c(new_n138_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n89_), .b(new_n166_), .c(new_n86_), .O(new_n167_));
  nor2   g123(.a(x19), .b(x14), .O(new_n168_));
  nor2   g124(.a(new_n80_), .b(new_n152_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n148_), .c(new_n168_), .O(new_n170_));
  oai21  g126(.a(x30), .b(x29), .c(x31), .O(new_n171_));
  aoi21  g127(.a(new_n123_), .b(x28), .c(new_n171_), .O(new_n172_));
  ...
  nand3  g139(.a(new_n183_), .b(new_n134_), .c(x29), .O(new_n184_));
  inv1   g140(.a(new_n136_), .O(new_n185_));
  nand4  g141(.a(new_n154_), .b(new_n180_), .c(new_n128_), .d(new_n101_), .O(new_n186_));
  ...
  aoi21  g145(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n190_));
  ...
  oai21  g152(.a(new_n193_), .b(new_n196_), .c(new_n80_), .O(new_n197_));
  oai21  g153(.a(new_n86_), .b(new_n164_), .c(new_n138_), .O(new_n198_));
  nand2  g154(.a(new_n86_), .b(new_n166_), .O(new_n199_));
