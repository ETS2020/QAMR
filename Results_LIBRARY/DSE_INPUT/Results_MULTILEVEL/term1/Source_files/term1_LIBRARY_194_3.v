...
module FAU ( 
  ...
  nand3  g093(.a(new_n137_), .b(new_n107_), .c(x15), .O(new_n138_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n137_), .c(x30), .d(x15), .O(new_n145_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(new_n167_));
  ...
  inv1   g127(.a(x00), .O(new_n172_));
  inv1   g128(.a(x33), .O(new_n173_));
  nand3  g129(.a(new_n141_), .b(new_n173_), .c(new_n118_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x31), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n143_), .O(new_n176_));
  nand4  g132(.a(new_n137_), .b(new_n173_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n118_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n139_), .c(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n124_), .c(x29), .O(new_n180_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n184_), .c(new_n139_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n184_), .b(new_n188_), .c(new_n131_), .O(new_n189_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n187_), .c(new_n185_), .d(new_n182_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n180_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n176_), .c(new_n78_), .O(new_n198_));
  nor2   g154(.a(new_n198_), .b(new_n172_), .O(z9));
endmodule
