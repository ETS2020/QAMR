// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:34 2020
...
module FAU ( 
  ...
  nand2  g056(.a(x30), .b(x26), .O(new_n101_));
  ...
  oai21  g060(.a(new_n104_), .b(x26), .c(new_n102_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n58_), .c(x25), .d(x01), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z5));
  nand2  g063(.a(new_n99_), .b(x29), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x30), .c(new_n78_), .O(new_n109_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n113_));
  ...
  nand4  g072(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n117_));
  nor2   g073(.a(new_n57_), .b(new_n56_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n100_), .c(new_n78_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n98_), .b(new_n79_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x29), .O(new_n126_));
  nand3  g082(.a(x19), .b(new_n86_), .c(x13), .O(new_n127_));
  nand3  g083(.a(new_n89_), .b(x18), .c(x14), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n83_), .O(new_n129_));
  nand4  g085(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n130_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n133_), .c(x11), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n132_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n143_), .b(z0), .c(x31), .d(x30), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(x26), .c(z0), .d(x30), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n126_), .O(new_n146_));
  nand4  g102(.a(new_n143_), .b(new_n125_), .c(z0), .d(x31), .O(new_n147_));
  nand2  g103(.a(new_n98_), .b(new_n79_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x32), .c(x30), .d(new_n78_), .O(new_n149_));
  oai21  g105(.a(new_n147_), .b(x30), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n137_), .c(x15), .O(new_n153_));
  nand2  g109(.a(x17), .b(x11), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n134_), .c(new_n133_), .O(new_n155_));
  inv1   g111(.a(x12), .O(new_n156_));
  oai21  g112(.a(new_n134_), .b(new_n156_), .c(new_n83_), .O(new_n157_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n136_), .c(x31), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  ...
  nor2   g121(.a(new_n165_), .b(x26), .O(new_n166_));
  aoi21  g122(.a(new_n150_), .b(x29), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n146_), .c(new_n124_), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  nand4  g125(.a(new_n143_), .b(new_n169_), .c(x31), .d(x30), .O(new_n170_));
  oai22  g126(.a(new_n170_), .b(x26), .c(new_n169_), .d(x30), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n125_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n143_), .b(new_n169_), .c(new_n119_), .d(new_n110_), .O(new_n173_));
  nand3  g129(.a(x33), .b(x31), .c(new_n78_), .O(new_n174_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n161_), .c(new_n89_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n151_), .c(new_n141_), .O(new_n180_));
  nand2  g136(.a(new_n119_), .b(x30), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n182_), .c(new_n133_), .O(new_n183_));
  oai21  g139(.a(new_n86_), .b(new_n156_), .c(new_n83_), .O(new_n184_));
  nand2  g140(.a(new_n86_), .b(new_n158_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(new_n183_), .d(new_n181_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(x33), .c(new_n78_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  aoi21  g146(.a(new_n175_), .b(new_n126_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n172_), .c(new_n124_), .O(z9));
endmodule
