...
module FAU ( 
  ...
  nand4  g091(.a(new_n135_), .b(x17), .c(new_n134_), .d(x10), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n127_), .c(z0), .d(x31), .O(new_n138_));
  ...
  nand3  g097(.a(new_n135_), .b(x17), .c(x10), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n134_), .O(new_n143_));
  nand2  g099(.a(new_n135_), .b(x12), .O(new_n144_));
  ...
  nand3  g105(.a(new_n135_), .b(x17), .c(x15), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(x16), .O(new_n151_));
  ...
  oai21  g112(.a(new_n138_), .b(new_n122_), .c(new_n156_), .O(new_n157_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n124_), .c(x29), .O(new_n164_));
  inv1   g120(.a(new_n126_), .O(new_n165_));
  nand4  g121(.a(new_n160_), .b(new_n117_), .c(new_n107_), .d(x16), .O(new_n166_));
  ...
  aoi21  g126(.a(new_n89_), .b(new_n148_), .c(new_n122_), .O(new_n171_));
