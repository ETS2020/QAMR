// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:28 2020
...
module FAU ( 
  ...
  oai21  g067(.a(new_n105_), .b(new_n91_), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n107_), .c(new_n128_), .O(new_n130_));
  ...
  oai21  g112(.a(new_n138_), .b(new_n156_), .c(new_n83_), .O(new_n157_));
  ...
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n121_), .d(new_n107_), .O(new_n178_));
  ...
  oai21  g145(.a(new_n86_), .b(new_n156_), .c(new_n83_), .O(new_n190_));
  nand2  g146(.a(new_n86_), .b(new_n158_), .O(new_n191_));
