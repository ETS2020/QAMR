...
module FAU ( 
  ...
  aoi21  g096(.a(new_n140_), .b(new_n134_), .c(new_n128_), .O(new_n141_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n127_), .c(z0), .d(x31), .O(new_n147_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n138_), .c(new_n128_), .O(new_n152_));
  nand2  g108(.a(x17), .b(x11), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n136_), .c(new_n135_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n136_), .b(new_n155_), .c(new_n83_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n89_), .b(new_n157_), .c(new_n86_), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  nor2   g115(.a(new_n135_), .b(new_n128_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n139_), .c(new_n159_), .O(new_n161_));
  ...
  oai21  g127(.a(new_n144_), .b(new_n141_), .c(x31), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n107_), .c(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n124_), .c(x29), .O(new_n174_));
  aoi21  g130(.a(new_n145_), .b(new_n142_), .c(new_n126_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n171_), .c(new_n118_), .d(new_n107_), .O(new_n176_));
  ...
  oai21  g137(.a(new_n180_), .b(new_n151_), .c(new_n128_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n135_), .O(new_n184_));
  oai21  g140(.a(new_n86_), .b(new_n155_), .c(new_n83_), .O(new_n185_));
  aoi21  g141(.a(new_n86_), .b(new_n157_), .c(x31), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n182_), .c(new_n181_), .d(new_n178_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n176_), .c(new_n174_), .O(new_n191_));
