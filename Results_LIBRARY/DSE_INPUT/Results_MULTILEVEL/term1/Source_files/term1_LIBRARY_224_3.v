...
module FAU ( 
  ...
  nand3  g050(.a(x28), .b(new_n79_), .c(new_n78_), .O(new_n95_));
  oai21  g051(.a(x28), .b(new_n79_), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n97_));
  ...
  nand3  g057(.a(new_n101_), .b(x29), .c(new_n78_), .O(new_n102_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n101_), .c(new_n78_), .O(new_n121_));
  ...
  oai21  g080(.a(new_n99_), .b(x26), .c(new_n79_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n110_), .c(x29), .O(new_n126_));
  aoi21  g082(.a(new_n99_), .b(new_n79_), .c(new_n103_), .O(new_n127_));
  ...
  nor3   g104(.a(x30), .b(x27), .c(x26), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n99_), .O(new_n150_));
  ...
  aoi21  g117(.a(new_n110_), .b(new_n103_), .c(new_n119_), .O(new_n162_));
  oai21  g118(.a(new_n115_), .b(new_n99_), .c(new_n162_), .O(new_n163_));
  ...
  aoi21  g124(.a(new_n168_), .b(new_n146_), .c(new_n124_), .O(z8));
  ...
  nand4  g129(.a(new_n145_), .b(new_n170_), .c(new_n119_), .d(new_n110_), .O(new_n174_));
  ...
  aoi21  g148(.a(new_n192_), .b(new_n173_), .c(new_n124_), .O(z9));
endmodule
