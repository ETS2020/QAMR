...
module FAU ( 
  ...
  inv1   g077(.a(x00), .O(new_n122_));
  nor2   g078(.a(x28), .b(x27), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(x32), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x31), .c(new_n107_), .d(x18), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(x16), .c(x15), .d(x14), .O(new_n127_));
  nand2  g083(.a(new_n99_), .b(new_n79_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x32), .c(x30), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n98_), .O(new_n130_));
  nor2   g086(.a(new_n123_), .b(new_n98_), .O(new_n131_));
  nand4  g087(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n132_));
  nand4  g088(.a(z0), .b(x31), .c(x30), .d(x18), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  aoi21  g090(.a(x32), .b(new_n107_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(x16), .b(x15), .c(x14), .O(new_n136_));
  nand3  g092(.a(x31), .b(x18), .c(x17), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(x32), .O(new_n138_));
  oai21  g094(.a(new_n135_), .b(new_n131_), .c(new_n138_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n130_), .c(new_n78_), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n122_), .O(z8));
  inv1   g097(.a(x33), .O(new_n142_));
  nand3  g098(.a(x19), .b(new_n86_), .c(x13), .O(new_n143_));
  nand4  g099(.a(new_n117_), .b(new_n89_), .c(x18), .d(x14), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n83_), .O(new_n145_));
  ...
  nand3  g113(.a(new_n157_), .b(new_n142_), .c(new_n107_), .O(new_n158_));
  nand2  g114(.a(x33), .b(x31), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n131_), .O(new_n160_));
  inv1   g116(.a(new_n123_), .O(new_n161_));
  nand4  g117(.a(new_n142_), .b(x31), .c(x30), .d(x18), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n132_), .c(new_n142_), .d(x31), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n161_), .c(x29), .O(new_n164_));
  aoi21  g120(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x17), .c(x16), .d(x15), .O(new_n166_));
  nand2  g122(.a(x16), .b(x15), .O(new_n167_));
  nand2  g123(.a(x18), .b(x17), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n167_), .c(new_n89_), .O(new_n169_));
  nand2  g125(.a(x16), .b(x10), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n168_), .c(new_n155_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n168_), .b(new_n172_), .c(new_n149_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x12), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n83_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n86_), .b(new_n176_), .O(new_n177_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n160_), .c(new_n78_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n122_), .O(z9));
endmodule
