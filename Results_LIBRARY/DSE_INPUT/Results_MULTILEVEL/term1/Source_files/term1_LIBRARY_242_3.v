// Benchmark "FAU" written by ABC on Mon Jul 27 22:03:02 2020
...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(x27), .c(new_n78_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n56_), .O(z4));
  xnor2a g055(.a(x29), .b(x27), .O(new_n100_));
  nand3  g056(.a(x29), .b(new_n95_), .c(new_n78_), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n95_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n56_), .O(z5));
  inv1   g060(.a(x30), .O(new_n105_));
  nand2  g061(.a(x29), .b(x28), .O(new_n106_));
  aoi22  g062(.a(new_n106_), .b(new_n78_), .c(x28), .d(new_n79_), .O(new_n107_));
  nor2   g063(.a(new_n95_), .b(new_n79_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n105_), .c(x29), .O(new_n109_));
  oai21  g065(.a(new_n107_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n56_), .O(z6));
  inv1   g068(.a(new_n108_), .O(new_n113_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n113_), .c(new_n78_), .O(new_n120_));
  ...
  oai21  g079(.a(new_n79_), .b(x26), .c(new_n95_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n105_), .c(x29), .O(new_n125_));
  inv1   g081(.a(x29), .O(new_n126_));
  aoi21  g082(.a(new_n95_), .b(new_n79_), .c(new_n126_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x30), .c(new_n78_), .O(new_n129_));
  ...
  nor2   g098(.a(new_n137_), .b(x15), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n139_), .c(x10), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n130_), .c(z0), .d(x31), .O(new_n146_));
  nand3  g102(.a(x30), .b(x29), .c(x28), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nor3   g104(.a(x30), .b(x28), .c(x26), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n79_), .O(new_n150_));
  and2   g106(.a(x16), .b(x10), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n139_), .c(x15), .O(new_n152_));
  ...
  oai22  g116(.a(new_n160_), .b(new_n138_), .c(x19), .d(x14), .O(new_n161_));
  aoi21  g117(.a(new_n105_), .b(new_n126_), .c(new_n118_), .O(new_n162_));
  oai21  g118(.a(new_n114_), .b(new_n79_), .c(new_n162_), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n152_), .c(new_n78_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n150_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x32), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n146_), .c(new_n123_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n145_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(x31), .c(new_n171_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n124_), .c(x29), .O(new_n173_));
  nand4  g129(.a(new_n145_), .b(new_n170_), .c(new_n118_), .d(new_n105_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x31), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n127_), .O(new_n176_));
  ...
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(x19), .O(new_n182_));
  aoi21  g138(.a(new_n181_), .b(new_n151_), .c(x15), .O(new_n183_));
  aoi21  g139(.a(new_n181_), .b(x11), .c(x16), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n83_), .O(new_n186_));
  nand2  g142(.a(new_n86_), .b(new_n158_), .O(new_n187_));
  xnor2a g143(.a(x31), .b(x30), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n187_), .c(new_n186_), .O(new_n189_));
  nor4   g145(.a(new_n189_), .b(new_n184_), .c(new_n183_), .d(new_n182_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n178_), .c(new_n170_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n176_), .c(new_n78_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n173_), .c(new_n123_), .O(z9));
endmodule
