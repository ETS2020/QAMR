...
module FAU ( 
  ...
  aoi21  g096(.a(new_n140_), .b(new_n131_), .c(x15), .O(new_n141_));
  nand2  g097(.a(x19), .b(x18), .O(new_n142_));
  nand2  g098(.a(x17), .b(x11), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(new_n129_), .O(new_n144_));
  ...
  oai22  g105(.a(new_n149_), .b(new_n130_), .c(x19), .d(x14), .O(new_n150_));
  nand3  g106(.a(new_n122_), .b(x31), .c(x29), .O(new_n151_));
  ...
  oai21  g110(.a(new_n138_), .b(new_n98_), .c(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n78_), .c(x00), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(z8));
  inv1   g113(.a(x33), .O(new_n158_));
  nand2  g114(.a(new_n122_), .b(x29), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n137_), .c(new_n158_), .d(new_n117_), .O(new_n160_));
  aoi21  g116(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x17), .c(x16), .d(x15), .O(new_n162_));
  nand2  g118(.a(x18), .b(x17), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n149_), .c(new_n89_), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n139_), .c(new_n135_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  oai21  g122(.a(new_n163_), .b(new_n166_), .c(new_n129_), .O(new_n167_));
  oai21  g123(.a(new_n86_), .b(new_n145_), .c(new_n83_), .O(new_n168_));
  aoi21  g124(.a(new_n86_), .b(new_n147_), .c(x31), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n165_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n164_), .c(new_n162_), .d(new_n159_), .O(new_n172_));
