...
module FAU ( 
  ...
  aoi22  g047(.a(new_n91_), .b(new_n89_), .c(new_n90_), .d(new_n88_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n93_));
  ...
  nor2   g068(.a(new_n108_), .b(new_n99_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n101_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  nand2  g071(.a(new_n90_), .b(new_n88_), .O(new_n116_));
  oai21  g072(.a(new_n80_), .b(new_n91_), .c(new_n89_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n87_), .d(new_n84_), .O(new_n118_));
  ...
  nor2   g084(.a(new_n126_), .b(new_n99_), .O(new_n129_));
  ...
  nand3  g096(.a(new_n140_), .b(new_n82_), .c(x11), .O(new_n141_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n130_), .c(z0), .d(x31), .O(new_n147_));
  nand2  g103(.a(new_n113_), .b(x27), .O(new_n148_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n137_), .c(new_n82_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n137_), .b(new_n155_), .c(new_n85_), .O(new_n156_));
  nand2  g112(.a(x19), .b(x13), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n88_), .O(new_n158_));
  inv1   g114(.a(x14), .O(new_n159_));
  nor2   g115(.a(new_n82_), .b(new_n144_), .O(new_n160_));
  aoi22  g116(.a(new_n160_), .b(new_n140_), .c(new_n89_), .d(new_n159_), .O(new_n161_));
  oai21  g117(.a(x30), .b(x29), .c(x31), .O(new_n162_));
  aoi21  g118(.a(new_n113_), .b(x28), .c(new_n162_), .O(new_n163_));
  ...
  inv1   g131(.a(new_n129_), .O(new_n176_));
  nand4  g132(.a(new_n146_), .b(new_n171_), .c(new_n121_), .d(new_n108_), .O(new_n177_));
  ...
  aoi21  g136(.a(new_n88_), .b(x13), .c(new_n89_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x17), .c(x16), .d(x15), .O(new_n182_));
  inv1   g138(.a(new_n160_), .O(new_n183_));
  nand2  g139(.a(x19), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(new_n88_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n151_), .c(new_n144_), .O(new_n186_));
  nand2  g142(.a(new_n89_), .b(new_n159_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n184_), .b(new_n188_), .c(new_n82_), .O(new_n189_));
  oai21  g145(.a(new_n89_), .b(new_n155_), .c(new_n85_), .O(new_n190_));
  xnor2a g146(.a(x31), .b(x30), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n187_), .O(new_n192_));
