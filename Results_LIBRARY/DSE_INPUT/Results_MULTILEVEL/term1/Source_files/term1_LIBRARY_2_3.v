...
module FAU ( 
  ...
  nand4  g056(.a(new_n98_), .b(x28), .c(x27), .d(new_n78_), .O(new_n101_));
  ...
  nand3  g064(.a(x30), .b(new_n98_), .c(new_n78_), .O(new_n109_));
  ...
  nand3  g079(.a(x29), .b(new_n99_), .c(new_n79_), .O(new_n124_));
  oai21  g080(.a(x29), .b(x26), .c(new_n124_), .O(new_n125_));
  ...
  nor2   g093(.a(new_n132_), .b(x15), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n134_), .c(x10), .O(new_n139_));
  ...
  nand2  g099(.a(new_n99_), .b(new_n79_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n140_), .c(z0), .d(x31), .O(new_n145_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n134_), .c(x15), .O(new_n150_));
  nor2   g106(.a(new_n89_), .b(new_n86_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x17), .c(x11), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n132_), .O(new_n153_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n133_), .c(x31), .O(new_n160_));
  ...
  nor2   g119(.a(new_n163_), .b(x26), .O(new_n164_));
  aoi21  g120(.a(new_n148_), .b(x29), .c(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n143_), .c(new_n123_), .O(z8));
  ...
  nand4  g127(.a(new_n140_), .b(new_n167_), .c(new_n118_), .d(new_n105_), .O(new_n172_));
  nand2  g128(.a(x33), .b(x31), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n99_), .c(new_n79_), .O(new_n175_));
  ...
  nand2  g135(.a(new_n114_), .b(x31), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n159_), .c(new_n89_), .O(new_n182_));
  inv1   g138(.a(new_n181_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n149_), .c(x15), .O(new_n184_));
  aoi21  g140(.a(new_n183_), .b(x11), .c(x16), .O(new_n185_));
  aoi21  g141(.a(x18), .b(x12), .c(x17), .O(new_n186_));
  oai22  g142(.a(x31), .b(new_n105_), .c(x18), .d(x13), .O(new_n187_));
  ...
  oai21  g146(.a(new_n172_), .b(x29), .c(new_n190_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n78_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n177_), .c(new_n123_), .O(z9));
endmodule
