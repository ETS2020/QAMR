...
module FAU ( 
  ...
  nand3  g061(.a(new_n100_), .b(new_n105_), .c(x29), .O(new_n106_));
  ...
  nand2  g065(.a(x30), .b(x28), .O(new_n110_));
  ...
  nand3  g069(.a(new_n100_), .b(new_n113_), .c(x30), .O(new_n114_));
  ...
  nor2   g073(.a(x28), .b(x27), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n105_), .c(x29), .O(new_n120_));
  nand3  g076(.a(x30), .b(new_n99_), .c(new_n79_), .O(new_n121_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n130_), .c(new_n135_), .O(new_n141_));
  ...
  oai22  g103(.a(new_n147_), .b(new_n130_), .c(x19), .d(x14), .O(new_n148_));
  nand3  g104(.a(new_n110_), .b(x31), .c(x29), .O(new_n149_));
  nor4   g105(.a(new_n149_), .b(new_n148_), .c(new_n146_), .d(new_n145_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n144_), .c(new_n141_), .O(new_n151_));
  aoi21  g107(.a(new_n139_), .b(new_n99_), .c(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(z0), .c(new_n138_), .O(new_n153_));
  ...
  nand4  g113(.a(new_n137_), .b(new_n157_), .c(x31), .d(x30), .O(new_n158_));
  nand3  g114(.a(x33), .b(new_n113_), .c(x29), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n118_), .O(new_n160_));
  nand3  g116(.a(new_n105_), .b(new_n99_), .c(new_n79_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x29), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n137_), .c(new_n157_), .d(new_n113_), .O(new_n163_));
  aoi21  g119(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(x17), .c(x16), .d(x15), .O(new_n165_));
  nor2   g121(.a(new_n86_), .b(new_n83_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n147_), .c(new_n89_), .O(new_n168_));
  oai21  g124(.a(new_n167_), .b(new_n140_), .c(new_n135_), .O(new_n169_));
  aoi21  g125(.a(new_n166_), .b(x11), .c(x16), .O(new_n170_));
  aoi21  g126(.a(x18), .b(x12), .c(x17), .O(new_n171_));
  nor2   g127(.a(x18), .b(x13), .O(new_n172_));
  oai21  g128(.a(new_n113_), .b(x30), .c(new_n121_), .O(new_n173_));
  nor4   g129(.a(new_n173_), .b(new_n172_), .c(new_n171_), .d(new_n170_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n169_), .c(new_n168_), .d(new_n165_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x33), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n163_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n160_), .c(new_n78_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n156_), .O(z9));
endmodule
