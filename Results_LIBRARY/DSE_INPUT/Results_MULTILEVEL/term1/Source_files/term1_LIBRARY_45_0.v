...
module FAU ( 
  ...
  nand4  g085(.a(x31), .b(x19), .c(new_n86_), .d(x13), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n83_), .O(new_n131_));
  inv1   g087(.a(x12), .O(new_n132_));
  nand3  g088(.a(x31), .b(x19), .c(x18), .O(new_n133_));
  nor3   g089(.a(new_n133_), .b(x17), .c(new_n132_), .O(new_n134_));
  ...
  nor2   g096(.a(new_n86_), .b(new_n83_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x31), .c(x19), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n139_), .c(new_n127_), .O(new_n144_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(new_n128_), .O(new_n152_));
  nand3  g108(.a(new_n150_), .b(x17), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n136_), .O(new_n154_));
  nand2  g110(.a(new_n150_), .b(x12), .O(new_n155_));
  ...
  inv1   g114(.a(new_n151_), .O(new_n159_));
  nor2   g115(.a(x19), .b(x14), .O(new_n160_));
  nor2   g116(.a(new_n136_), .b(new_n128_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n159_), .c(new_n160_), .O(new_n162_));
  oai21  g118(.a(x30), .b(x29), .c(x31), .O(new_n163_));
  aoi21  g119(.a(new_n112_), .b(x28), .c(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n162_), .c(new_n158_), .d(new_n156_), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n154_), .c(new_n152_), .d(new_n147_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x32), .O(new_n168_));
  oai21  g124(.a(new_n144_), .b(x32), .c(new_n168_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n78_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  oai21  g128(.a(new_n143_), .b(new_n139_), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n118_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n107_), .c(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n124_), .c(x29), .O(new_n176_));
  nand3  g132(.a(x18), .b(new_n83_), .c(x12), .O(new_n177_));
  nand3  g133(.a(new_n86_), .b(x17), .c(x13), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n177_), .c(new_n136_), .O(new_n179_));
  nand3  g135(.a(new_n141_), .b(new_n136_), .c(x11), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n179_), .c(x15), .O(new_n182_));
  nand4  g138(.a(new_n141_), .b(x16), .c(new_n128_), .d(x10), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n172_), .c(new_n118_), .d(new_n107_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n185_), .c(new_n126_), .O(new_n187_));
  aoi21  g143(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  aoi21  g145(.a(new_n161_), .b(new_n141_), .c(x19), .O(new_n190_));
  aoi21  g146(.a(new_n148_), .b(new_n141_), .c(x15), .O(new_n191_));
  aoi21  g147(.a(new_n141_), .b(x11), .c(x16), .O(new_n192_));
  oai21  g148(.a(new_n86_), .b(new_n132_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n157_), .O(new_n194_));
  ...
  aoi21  g153(.a(new_n197_), .b(new_n189_), .c(new_n172_), .O(new_n198_));
  nor2   g154(.a(new_n198_), .b(new_n187_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n176_), .O(new_n200_));
