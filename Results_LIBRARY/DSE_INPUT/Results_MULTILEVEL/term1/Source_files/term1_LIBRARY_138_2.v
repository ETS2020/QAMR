...
module FAU ( 
  ...
  nand4  g086(.a(x19), .b(x18), .c(new_n127_), .d(x11), .O(new_n131_));
  ...
  nand4  g093(.a(new_n137_), .b(z0), .c(x31), .d(x17), .O(new_n138_));
  nand2  g094(.a(new_n89_), .b(x14), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(x18), .c(x16), .d(x15), .O(new_n140_));
  ...
  nand2  g099(.a(x18), .b(x16), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n134_), .c(new_n89_), .O(new_n145_));
  ...
  aoi21  g106(.a(new_n86_), .b(new_n150_), .c(new_n83_), .O(new_n151_));
  ...
  nand4  g117(.a(new_n161_), .b(x31), .c(x30), .d(x17), .O(new_n162_));
  ...
  nand4  g121(.a(new_n161_), .b(new_n118_), .c(new_n107_), .d(x17), .O(new_n166_));
