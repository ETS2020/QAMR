...
module FAU ( 
  ...
  nand2  g016(.a(x03), .b(new_n60_), .O(new_n61_));
  oai21  g017(.a(x05), .b(x03), .c(new_n61_), .O(new_n62_));
  nand3  g018(.a(new_n62_), .b(x06), .c(new_n50_), .O(new_n63_));
  nand2  g019(.a(x06), .b(new_n50_), .O(new_n64_));
  nand4  g020(.a(new_n64_), .b(x05), .c(new_n47_), .d(new_n60_), .O(new_n65_));
  ...
  nand2  g025(.a(new_n62_), .b(x02), .O(new_n70_));
  aoi21  g026(.a(x05), .b(new_n47_), .c(x06), .O(new_n71_));
  nand3  g027(.a(new_n58_), .b(x06), .c(x05), .O(new_n72_));
  inv1   g028(.a(new_n72_), .O(new_n73_));
  oai21  g029(.a(new_n73_), .b(new_n71_), .c(new_n60_), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  aoi21  g031(.a(new_n69_), .b(x01), .c(new_n75_), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(new_n68_), .c(new_n67_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n55_), .c(x08), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(z2));
  inv1   g035(.a(x25), .O(new_n80_));
  inv1   g036(.a(x26), .O(new_n81_));
  inv1   g037(.a(x27), .O(new_n82_));
  inv1   g038(.a(new_n57_), .O(new_n83_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n80_), .c(new_n60_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n83_), .d(new_n81_), .O(new_n100_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n96_), .c(new_n83_), .d(new_n81_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n80_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n96_), .c(new_n83_), .d(new_n81_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n80_), .c(new_n60_), .O(z6));
  nor2   g071(.a(new_n111_), .b(new_n102_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x31), .O(new_n118_));
  nand4  g074(.a(new_n95_), .b(new_n92_), .c(new_n89_), .d(new_n86_), .O(new_n119_));
  nor2   g075(.a(new_n57_), .b(new_n60_), .O(new_n120_));
  ...
  nor2   g085(.a(new_n127_), .b(new_n102_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n111_), .c(new_n129_), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n90_), .c(x13), .O(new_n132_));
  nand3  g088(.a(new_n93_), .b(x18), .c(x14), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n87_), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n87_), .d(x12), .O(new_n135_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n131_), .c(z0), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n116_), .b(x27), .O(new_n150_));
  oai21  g106(.a(x30), .b(x27), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n103_), .O(new_n152_));
  ...
  inv1   g133(.a(new_n130_), .O(new_n178_));
  nand4  g134(.a(new_n148_), .b(new_n173_), .c(new_n122_), .d(new_n111_), .O(new_n179_));
  ...
  oai21  g146(.a(new_n90_), .b(new_n157_), .c(new_n87_), .O(new_n191_));
  nand2  g147(.a(new_n90_), .b(new_n159_), .O(new_n192_));
