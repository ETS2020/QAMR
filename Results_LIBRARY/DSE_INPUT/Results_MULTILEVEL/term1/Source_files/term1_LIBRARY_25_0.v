...
module FAU ( 
  ...
  nand4  g096(.a(new_n140_), .b(new_n124_), .c(z0), .d(x31), .O(new_n141_));
  nand2  g097(.a(new_n125_), .b(x13), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(x19), .c(x17), .d(x16), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g100(.a(new_n109_), .b(x27), .O(new_n145_));
  oai21  g101(.a(x30), .b(x27), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n96_), .O(new_n147_));
  nor2   g103(.a(new_n86_), .b(new_n83_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(x16), .c(x15), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n125_), .O(new_n150_));
  nand3  g106(.a(new_n148_), .b(x16), .c(x10), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n138_), .O(new_n152_));
  aoi21  g108(.a(new_n148_), .b(x11), .c(x16), .O(new_n153_));
  inv1   g109(.a(x12), .O(new_n154_));
  oai21  g110(.a(new_n86_), .b(new_n154_), .c(new_n83_), .O(new_n155_));
  inv1   g111(.a(x14), .O(new_n156_));
  nand2  g112(.a(new_n86_), .b(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n109_), .b(x28), .O(new_n158_));
  aoi21  g114(.a(new_n104_), .b(new_n95_), .c(new_n115_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n155_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n153_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n144_), .c(x32), .O(new_n163_));
  ...
  nand4  g128(.a(new_n140_), .b(new_n167_), .c(new_n115_), .d(new_n104_), .O(new_n173_));
  ...
  oai21  g132(.a(x19), .b(new_n156_), .c(x18), .O(new_n177_));
  oai21  g133(.a(new_n86_), .b(x13), .c(new_n177_), .O(new_n178_));
  ...
  nand2  g137(.a(new_n181_), .b(new_n138_), .O(new_n182_));
  nand2  g138(.a(x17), .b(x11), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n132_), .O(new_n184_));
  nand2  g140(.a(new_n83_), .b(new_n154_), .O(new_n185_));
  xnor2a g141(.a(x31), .b(x30), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n182_), .O(new_n187_));
  aoi21  g143(.a(new_n180_), .b(new_n86_), .c(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n179_), .c(new_n150_), .O(new_n189_));
