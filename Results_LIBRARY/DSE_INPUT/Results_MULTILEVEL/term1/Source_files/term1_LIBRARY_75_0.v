...
module FAU ( 
  ...
  oai21  g061(.a(new_n105_), .b(x03), .c(x02), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n79_), .O(new_n107_));
  oai21  g063(.a(new_n98_), .b(new_n99_), .c(new_n50_), .O(new_n108_));
  nand4  g064(.a(new_n105_), .b(x29), .c(x28), .d(new_n47_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g067(.a(x29), .b(x28), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x30), .c(new_n47_), .O(new_n113_));
