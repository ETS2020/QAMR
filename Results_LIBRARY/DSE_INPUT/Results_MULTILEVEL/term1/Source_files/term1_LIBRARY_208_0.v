...
module FAU ( 
  ...
  nand2  g097(.a(new_n126_), .b(x14), .O(new_n142_));
  ...
  nand2  g115(.a(new_n109_), .b(x28), .O(new_n160_));
  aoi21  g116(.a(new_n104_), .b(new_n95_), .c(new_n115_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n160_), .c(new_n159_), .d(new_n157_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n155_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n152_), .c(new_n150_), .d(new_n147_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n144_), .c(x32), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n141_), .O(new_n166_));
  ...
  nand2  g126(.a(x33), .b(new_n115_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n121_), .c(x29), .O(new_n173_));
  inv1   g129(.a(new_n123_), .O(new_n174_));
  nand4  g130(.a(new_n140_), .b(new_n169_), .c(new_n115_), .d(new_n104_), .O(new_n175_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n159_), .c(new_n157_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n182_));
