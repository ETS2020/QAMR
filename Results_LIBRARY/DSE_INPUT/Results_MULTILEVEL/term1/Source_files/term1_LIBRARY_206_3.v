...
module FAU ( 
  ...
  nand4  g061(.a(new_n88_), .b(new_n85_), .c(new_n82_), .d(x24), .O(new_n106_));
  ...
  nand4  g082(.a(new_n108_), .b(new_n89_), .c(x18), .d(x14), .O(new_n127_));
  ...
  nand4  g101(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n146_));
  nand4  g102(.a(z0), .b(x31), .c(x30), .d(x18), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  aoi21  g104(.a(x32), .b(new_n108_), .c(new_n148_), .O(new_n149_));
  nor2   g105(.a(new_n86_), .b(new_n83_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x16), .c(x10), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n138_), .O(new_n152_));
  nand2  g108(.a(new_n150_), .b(x11), .O(new_n153_));
  ...
  nand2  g113(.a(new_n86_), .b(new_n157_), .O(new_n158_));
  nand3  g114(.a(new_n150_), .b(x16), .c(x15), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n152_), .c(new_n89_), .O(new_n162_));
  nand4  g118(.a(new_n150_), .b(x16), .c(x15), .d(x14), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n89_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x31), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n162_), .c(x32), .O(new_n166_));
  oai21  g122(.a(new_n149_), .b(new_n145_), .c(new_n166_), .O(new_n167_));
  ...
  nand4  g129(.a(new_n170_), .b(x31), .c(x30), .d(x18), .O(new_n174_));
  ...
  nand2  g134(.a(new_n159_), .b(new_n89_), .O(new_n179_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(new_n178_), .d(new_n152_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n176_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n173_), .c(new_n78_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n123_), .O(z9));
endmodule
