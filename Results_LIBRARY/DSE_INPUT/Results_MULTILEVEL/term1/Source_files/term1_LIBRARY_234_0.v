...
module FAU ( 
  ...
  oai21  g098(.a(x19), .b(new_n142_), .c(x18), .O(new_n143_));
  nor4   g099(.a(new_n143_), .b(new_n83_), .c(new_n132_), .d(new_n138_), .O(new_n144_));
  ...
  oai21  g132(.a(new_n126_), .b(x13), .c(new_n143_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x17), .c(x16), .d(x15), .O(new_n178_));
  nand4  g134(.a(x19), .b(x17), .c(x16), .d(x15), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n86_), .O(new_n180_));
  nand3  g136(.a(x17), .b(x16), .c(x15), .O(new_n181_));
  nand3  g137(.a(x17), .b(x16), .c(x10), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n138_), .O(new_n183_));
  nand2  g139(.a(x17), .b(x11), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n132_), .O(new_n185_));
  nand2  g141(.a(new_n83_), .b(new_n154_), .O(new_n186_));
  xnor2a g142(.a(x31), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n183_), .O(new_n188_));
  aoi21  g144(.a(new_n181_), .b(new_n126_), .c(new_n188_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n180_), .c(new_n178_), .O(new_n190_));
