...
module FAU ( 
  ...
  nand4  g085(.a(new_n107_), .b(x19), .c(new_n86_), .d(x13), .O(new_n130_));
  ...
  nand3  g103(.a(x18), .b(new_n83_), .c(x12), .O(new_n148_));
  nand3  g104(.a(new_n86_), .b(x17), .c(x13), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(new_n136_), .O(new_n150_));
  nand3  g106(.a(new_n142_), .b(new_n136_), .c(x11), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n150_), .c(x15), .O(new_n153_));
  nand4  g109(.a(new_n142_), .b(x16), .c(new_n128_), .d(x10), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n147_), .c(x30), .O(new_n156_));
  oai21  g112(.a(new_n145_), .b(new_n98_), .c(new_n156_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(z0), .c(x31), .O(new_n158_));
  nand2  g114(.a(new_n115_), .b(x27), .O(new_n159_));
  oai21  g115(.a(x30), .b(x27), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n99_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  nor2   g118(.a(new_n89_), .b(new_n86_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x17), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(new_n128_), .O(new_n165_));
  nand3  g121(.a(new_n163_), .b(x17), .c(x11), .O(new_n166_));
  nand2  g122(.a(new_n163_), .b(x12), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n83_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  oai21  g125(.a(new_n89_), .b(new_n169_), .c(new_n86_), .O(new_n170_));
  inv1   g126(.a(new_n164_), .O(new_n171_));
  nor2   g127(.a(x19), .b(x14), .O(new_n172_));
  nor2   g128(.a(new_n136_), .b(new_n128_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n171_), .c(new_n172_), .O(new_n174_));
  oai21  g130(.a(x30), .b(x29), .c(x31), .O(new_n175_));
  aoi21  g131(.a(new_n115_), .b(x28), .c(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n174_), .c(new_n170_), .d(new_n168_), .O(new_n177_));
  aoi21  g133(.a(new_n166_), .b(new_n136_), .c(new_n177_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n165_), .c(new_n161_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x32), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n158_), .O(new_n181_));
  ...
  nand2  g141(.a(new_n138_), .b(new_n135_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x15), .O(new_n187_));
  inv1   g143(.a(new_n144_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n185_), .c(new_n121_), .O(new_n190_));
  nand2  g146(.a(x33), .b(x31), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n190_), .c(new_n146_), .O(new_n192_));
  nand4  g148(.a(new_n155_), .b(new_n185_), .c(x31), .d(x30), .O(new_n193_));
  nand2  g149(.a(x33), .b(new_n121_), .O(new_n194_));
  ...
  nand2  g154(.a(new_n173_), .b(new_n142_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n89_), .O(new_n200_));
  inv1   g156(.a(new_n142_), .O(new_n201_));
  oai21  g157(.a(new_n162_), .b(new_n201_), .c(new_n128_), .O(new_n202_));
  ...
  nand2  g162(.a(new_n86_), .b(new_n169_), .O(new_n207_));
  ...
  oai21  g169(.a(new_n213_), .b(new_n192_), .c(new_n78_), .O(new_n214_));
  nor2   g170(.a(new_n214_), .b(new_n184_), .O(z9));
endmodule
