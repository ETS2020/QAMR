...
module FAU ( 
  ...
  nor4   g047(.a(new_n91_), .b(x27), .c(new_n77_), .d(new_n56_), .O(z3));
  xnor2a g048(.a(x28), .b(x27), .O(new_n93_));
  nor4   g049(.a(new_n93_), .b(new_n91_), .c(new_n77_), .d(new_n56_), .O(z4));
  ...
  nand4  g054(.a(new_n98_), .b(new_n90_), .c(new_n58_), .d(x25), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n56_), .O(z5));
  ...
  nand4  g061(.a(new_n105_), .b(new_n90_), .c(new_n58_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n56_), .O(z6));
  nor2   g063(.a(new_n103_), .b(new_n95_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n96_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x31), .O(new_n110_));
  nand4  g066(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n80_), .O(new_n111_));
  nor2   g067(.a(new_n57_), .b(new_n56_), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x30), .c(x29), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n96_), .c(new_n77_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(z7));
  inv1   g073(.a(x26), .O(new_n118_));
  nor2   g074(.a(x28), .b(x27), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n103_), .c(x29), .O(new_n121_));
  nor2   g077(.a(new_n119_), .b(new_n95_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n103_), .c(new_n121_), .O(new_n123_));
  nand3  g079(.a(x19), .b(new_n84_), .c(x13), .O(new_n124_));
  nand3  g080(.a(new_n87_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n124_), .c(new_n81_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n127_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n123_), .c(z0), .d(x31), .O(new_n141_));
  inv1   g097(.a(x28), .O(new_n142_));
  nand2  g098(.a(new_n108_), .b(x27), .O(new_n143_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n133_), .c(new_n138_), .O(new_n147_));
  nand2  g103(.a(x17), .b(x11), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n131_), .c(new_n130_), .O(new_n149_));
  inv1   g105(.a(x12), .O(new_n150_));
  oai21  g106(.a(new_n131_), .b(new_n150_), .c(new_n81_), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  oai21  g108(.a(new_n87_), .b(new_n152_), .c(new_n84_), .O(new_n153_));
  nor2   g109(.a(x19), .b(x14), .O(new_n154_));
  nor2   g110(.a(new_n130_), .b(new_n138_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n134_), .c(new_n154_), .O(new_n156_));
  oai21  g112(.a(x30), .b(x29), .c(x31), .O(new_n157_));
  aoi21  g113(.a(new_n108_), .b(x28), .c(new_n157_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n156_), .c(new_n153_), .d(new_n151_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n149_), .c(new_n147_), .d(new_n145_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x32), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n141_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n118_), .c(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n140_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n113_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n120_), .c(x29), .O(new_n170_));
  inv1   g126(.a(new_n122_), .O(new_n171_));
  nand4  g127(.a(new_n140_), .b(new_n166_), .c(new_n113_), .d(new_n103_), .O(new_n172_));
  ...
  inv1   g133(.a(new_n155_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x17), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n87_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n146_), .c(new_n138_), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n130_), .O(new_n183_));
  oai21  g139(.a(new_n84_), .b(new_n150_), .c(new_n81_), .O(new_n184_));
  nand2  g140(.a(new_n84_), .b(new_n152_), .O(new_n185_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n181_), .c(new_n180_), .d(new_n177_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n175_), .c(new_n170_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n118_), .c(x00), .O(new_n192_));
