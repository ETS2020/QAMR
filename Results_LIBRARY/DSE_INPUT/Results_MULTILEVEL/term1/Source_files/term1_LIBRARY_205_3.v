...
module FAU ( 
  ...
  nand3  g059(.a(new_n88_), .b(new_n82_), .c(x20), .O(new_n104_));
  ...
  nor2   g091(.a(new_n130_), .b(new_n128_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(x17), .c(new_n80_), .d(x11), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x15), .O(new_n139_));
  nor2   g095(.a(new_n80_), .b(x15), .O(new_n140_));
  nand2  g096(.a(x18), .b(x17), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nor2   g098(.a(x30), .b(new_n130_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(x10), .O(new_n144_));
  ...
  nand3  g106(.a(new_n142_), .b(x16), .c(x10), .O(new_n151_));
  ...
  aoi22  g112(.a(new_n127_), .b(new_n156_), .c(new_n80_), .d(new_n155_), .O(new_n157_));
  inv1   g113(.a(x13), .O(new_n158_));
  nand2  g114(.a(new_n128_), .b(new_n158_), .O(new_n159_));
  nand3  g115(.a(new_n136_), .b(x17), .c(x16), .O(new_n160_));
  ...
  nand3  g119(.a(new_n136_), .b(x17), .c(x15), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n80_), .O(new_n165_));
  nand2  g121(.a(new_n136_), .b(x15), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n127_), .O(new_n167_));
  inv1   g123(.a(x15), .O(new_n168_));
  oai21  g124(.a(new_n130_), .b(new_n168_), .c(new_n128_), .O(new_n169_));
  nand2  g125(.a(x19), .b(x10), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n168_), .c(new_n119_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n172_));
  aoi21  g128(.a(new_n163_), .b(x15), .c(new_n172_), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(z0), .c(new_n154_), .d(new_n150_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n149_), .c(new_n78_), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n124_), .O(z8));
  inv1   g132(.a(x33), .O(new_n177_));
  nand3  g133(.a(new_n145_), .b(new_n177_), .c(new_n119_), .O(new_n178_));
  nand2  g134(.a(x33), .b(x31), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n178_), .c(new_n150_), .O(new_n180_));
  nand4  g136(.a(new_n177_), .b(x31), .c(x30), .d(x19), .O(new_n181_));
  oai22  g137(.a(new_n181_), .b(new_n151_), .c(new_n177_), .d(x31), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n126_), .c(x29), .O(new_n183_));
  aoi21  g139(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  nand2  g141(.a(x16), .b(x15), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n141_), .c(new_n130_), .O(new_n187_));
  oai21  g143(.a(new_n141_), .b(new_n155_), .c(new_n80_), .O(new_n188_));
  oai21  g144(.a(new_n128_), .b(new_n156_), .c(new_n127_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(new_n159_), .O(new_n191_));
  aoi21  g147(.a(new_n151_), .b(new_n168_), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n187_), .c(new_n185_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n183_), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n180_), .c(new_n78_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n124_), .O(z9));
endmodule
