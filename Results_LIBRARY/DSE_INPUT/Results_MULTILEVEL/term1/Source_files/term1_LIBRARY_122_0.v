// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:23 2020
...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n98_), .c(new_n58_), .d(new_n78_), .O(new_n104_));
  ...
  nand4  g064(.a(new_n108_), .b(x29), .c(x28), .d(x27), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n98_), .c(new_n58_), .d(new_n78_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n77_), .c(new_n56_), .O(z6));
  nand4  g068(.a(new_n92_), .b(new_n108_), .c(new_n78_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n56_), .c(x31), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x29), .c(x28), .d(x27), .O(new_n115_));
  nand2  g071(.a(new_n106_), .b(x31), .O(new_n116_));
  inv1   g072(.a(new_n80_), .O(new_n117_));
  nand4  g073(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n58_), .b(new_n78_), .c(x25), .d(x01), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n118_), .c(new_n116_), .d(new_n115_), .O(z7));
  nand2  g077(.a(new_n99_), .b(new_n79_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n108_), .c(x29), .O(new_n123_));
  nand2  g079(.a(new_n122_), .b(x29), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x31), .c(x30), .O(new_n125_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n126_), .c(z0), .O(new_n142_));
  nor2   g098(.a(new_n108_), .b(new_n101_), .O(new_n143_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n134_), .c(new_n139_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x18), .O(new_n149_));
  nand2  g105(.a(x17), .b(x11), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n133_), .O(new_n151_));
  inv1   g107(.a(x12), .O(new_n152_));
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n81_), .O(new_n153_));
  inv1   g109(.a(x13), .O(new_n154_));
  oai21  g110(.a(new_n87_), .b(new_n154_), .c(new_n84_), .O(new_n155_));
  nor2   g111(.a(x19), .b(x14), .O(new_n156_));
  nor2   g112(.a(new_n133_), .b(new_n139_), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n135_), .c(new_n156_), .O(new_n158_));
  oai21  g114(.a(x30), .b(x29), .c(x31), .O(new_n159_));
  aoi21  g115(.a(new_n143_), .b(x28), .c(new_n159_), .O(new_n160_));
  ...
  inv1   g124(.a(new_n122_), .O(new_n169_));
  aoi21  g125(.a(new_n140_), .b(new_n138_), .c(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(x31), .d(x30), .O(new_n171_));
  aoi21  g127(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x17), .c(x16), .d(x15), .O(new_n173_));
  nor2   g129(.a(new_n84_), .b(new_n81_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n157_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n87_), .O(new_n176_));
  inv1   g132(.a(new_n174_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n147_), .c(new_n139_), .O(new_n178_));
  aoi21  g134(.a(new_n174_), .b(x11), .c(x16), .O(new_n179_));
  aoi21  g135(.a(x18), .b(x12), .c(x17), .O(new_n180_));
  oai21  g136(.a(x18), .b(x13), .c(new_n122_), .O(new_n181_));
  nand3  g137(.a(x31), .b(x30), .c(x29), .O(new_n182_));
  nor4   g138(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n179_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n178_), .c(new_n176_), .d(new_n173_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  oai21  g141(.a(new_n171_), .b(new_n101_), .c(new_n185_), .O(new_n186_));
