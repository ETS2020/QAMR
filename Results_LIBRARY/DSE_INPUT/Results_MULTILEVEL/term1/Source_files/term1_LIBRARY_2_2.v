...
module FAU ( 
  ...
  nand2  g034(.a(x29), .b(x26), .O(new_n79_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n79_), .c(new_n58_), .d(new_n78_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n77_), .c(new_n56_), .O(z3));
  inv1   g050(.a(x26), .O(new_n95_));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n92_), .c(new_n58_), .d(new_n95_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n101_), .b(x29), .c(new_n95_), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x28), .c(x27), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n56_), .O(z5));
  inv1   g063(.a(x30), .O(new_n108_));
  nand3  g064(.a(new_n100_), .b(new_n108_), .c(x29), .O(new_n109_));
  oai21  g065(.a(new_n100_), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n95_), .O(new_n111_));
  nand2  g067(.a(x30), .b(new_n103_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n92_), .c(new_n58_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n56_), .O(z6));
  nor2   g071(.a(new_n108_), .b(new_n103_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n100_), .O(new_n117_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n101_), .c(new_n95_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n77_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(z7));
  inv1   g081(.a(x00), .O(new_n126_));
  nor2   g082(.a(x28), .b(x27), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n108_), .c(x29), .O(new_n129_));
  nand3  g085(.a(x30), .b(new_n99_), .c(new_n78_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n95_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n112_), .O(new_n133_));
  nand3  g089(.a(x19), .b(new_n86_), .c(x13), .O(new_n134_));
  nand3  g090(.a(new_n89_), .b(x18), .c(x14), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n134_), .c(new_n83_), .O(new_n136_));
  nand4  g092(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n137_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(z0), .d(x31), .O(new_n149_));
  ...
  oai21  g114(.a(new_n89_), .b(new_n158_), .c(new_n86_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nand2  g116(.a(new_n89_), .b(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n142_), .b(x16), .c(x15), .O(new_n162_));
  aoi21  g118(.a(new_n116_), .b(x28), .c(new_n121_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n159_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n157_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n156_), .c(new_n153_), .O(new_n166_));
  aoi21  g122(.a(new_n151_), .b(new_n99_), .c(new_n166_), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(x26), .c(x30), .d(x29), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x32), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n149_), .c(new_n126_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n148_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n121_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n128_), .c(x29), .O(new_n175_));
  aoi21  g131(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x17), .c(x16), .d(x15), .O(new_n177_));
  oai21  g133(.a(new_n127_), .b(new_n108_), .c(x31), .O(new_n178_));
  ...
  or2    g137(.a(new_n180_), .b(new_n152_), .O(new_n182_));
  nand2  g138(.a(new_n121_), .b(x30), .O(new_n183_));
  inv1   g139(.a(x11), .O(new_n184_));
  oai21  g140(.a(new_n180_), .b(new_n184_), .c(new_n140_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x12), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n83_), .O(new_n187_));
  nand2  g143(.a(new_n86_), .b(new_n158_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n185_), .d(new_n183_), .O(new_n189_));
  aoi21  g145(.a(new_n182_), .b(new_n146_), .c(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n181_), .c(new_n178_), .d(new_n177_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  aoi21  g148(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n193_));
  inv1   g149(.a(new_n147_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n193_), .c(new_n171_), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(x31), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n108_), .c(new_n99_), .d(new_n78_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n192_), .c(new_n175_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n95_), .O(new_n199_));
  nand2  g155(.a(new_n196_), .b(new_n108_), .O(new_n200_));
  oai21  g156(.a(new_n171_), .b(new_n121_), .c(new_n200_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n103_), .O(new_n202_));
  aoi21  g158(.a(new_n202_), .b(new_n199_), .c(new_n126_), .O(z9));
endmodule
