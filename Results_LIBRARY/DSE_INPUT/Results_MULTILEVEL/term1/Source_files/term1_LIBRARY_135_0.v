...
module FAU ( 
  ...
  nand4  g094(.a(new_n138_), .b(z0), .c(x31), .d(x30), .O(new_n139_));
  oai21  g095(.a(z0), .b(x30), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n123_), .O(new_n141_));
  nand2  g097(.a(x19), .b(new_n86_), .O(new_n142_));
  aoi21  g098(.a(new_n125_), .b(new_n142_), .c(new_n83_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n128_), .c(x16), .O(new_n144_));
  ...
  aoi21  g110(.a(new_n154_), .b(new_n132_), .c(x15), .O(new_n155_));
  ...
  oai21  g120(.a(new_n164_), .b(new_n131_), .c(x31), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n155_), .c(x32), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n152_), .c(new_n141_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n78_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n138_), .b(new_n172_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n117_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n122_), .c(x29), .O(new_n176_));
  nand4  g132(.a(new_n147_), .b(new_n172_), .c(new_n117_), .d(new_n107_), .O(new_n177_));
  oai21  g133(.a(new_n172_), .b(new_n117_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n123_), .O(new_n179_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n164_), .c(new_n89_), .O(new_n183_));
  oai21  g139(.a(new_n182_), .b(new_n153_), .c(new_n136_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n130_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x12), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n83_), .O(new_n188_));
  nand2  g144(.a(new_n86_), .b(new_n161_), .O(new_n189_));
  ...
  nand3  g150(.a(new_n194_), .b(new_n179_), .c(new_n176_), .O(new_n195_));
