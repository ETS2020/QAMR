...
module FAU ( 
  ...
  nand3  g119(.a(new_n163_), .b(x32), .c(new_n78_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n144_), .c(new_n123_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n143_), .b(new_n166_), .c(x31), .d(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n118_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n125_), .c(x29), .O(new_n170_));
  inv1   g126(.a(new_n127_), .O(new_n171_));
  nand4  g127(.a(new_n143_), .b(new_n166_), .c(new_n118_), .d(new_n107_), .O(new_n172_));
