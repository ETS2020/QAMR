...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n90_), .c(new_n87_), .d(x15), .O(new_n115_));
  ...
  nand4  g098(.a(new_n139_), .b(x16), .c(new_n80_), .d(x10), .O(new_n143_));
  ...
  oai21  g139(.a(new_n182_), .b(new_n149_), .c(new_n80_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n135_), .O(new_n186_));
