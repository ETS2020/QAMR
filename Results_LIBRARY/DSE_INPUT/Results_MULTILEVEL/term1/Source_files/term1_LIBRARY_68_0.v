...
module FAU ( 
  ...
  nand3  g103(.a(new_n147_), .b(new_n80_), .c(x11), .O(new_n148_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n144_), .c(new_n80_), .O(new_n161_));
  inv1   g117(.a(x12), .O(new_n162_));
  oai21  g118(.a(new_n144_), .b(new_n162_), .c(new_n135_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  oai21  g120(.a(new_n138_), .b(new_n164_), .c(new_n136_), .O(new_n165_));
  nor2   g121(.a(x19), .b(x14), .O(new_n166_));
  nor2   g122(.a(new_n80_), .b(new_n151_), .O(new_n167_));
  ...
  oai21  g150(.a(new_n191_), .b(new_n194_), .c(new_n80_), .O(new_n195_));
