...
module FAU ( 
  ...
  oai21  g060(.a(x30), .b(x03), .c(x02), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x29), .c(x28), .d(x27), .O(new_n106_));
  nand3  g062(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x30), .c(new_n47_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n92_), .c(new_n78_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n56_), .O(z6));
  ...
  nand3  g081(.a(new_n125_), .b(new_n112_), .c(x29), .O(new_n126_));
  nor2   g082(.a(new_n124_), .b(new_n98_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n112_), .c(new_n126_), .O(new_n128_));
  ...
  nand4  g131(.a(new_n145_), .b(new_n170_), .c(new_n119_), .d(new_n112_), .O(new_n176_));
