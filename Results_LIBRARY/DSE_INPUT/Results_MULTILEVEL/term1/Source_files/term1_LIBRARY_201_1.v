...
module FAU ( 
  ...
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(new_n83_), .O(new_n133_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n105_), .c(x15), .O(new_n144_));
  ...
  nor2   g104(.a(new_n127_), .b(new_n95_), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n143_), .c(x30), .O(new_n151_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n96_), .O(new_n156_));
  ...
  nand3  g134(.a(new_n147_), .b(new_n178_), .c(new_n122_), .O(new_n179_));
  nand2  g135(.a(x33), .b(x31), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n179_), .c(new_n149_), .O(new_n181_));
  nand4  g137(.a(new_n143_), .b(new_n178_), .c(x31), .d(x30), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(x31), .c(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n128_), .c(x29), .O(new_n184_));
  aoi21  g140(.a(new_n131_), .b(x14), .c(new_n129_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x17), .c(x16), .d(x15), .O(new_n186_));
  inv1   g142(.a(new_n166_), .O(new_n187_));
  nand2  g143(.a(x18), .b(x17), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n131_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n157_), .c(new_n145_), .O(new_n190_));
  inv1   g146(.a(x11), .O(new_n191_));
  oai21  g147(.a(new_n188_), .b(new_n191_), .c(new_n137_), .O(new_n192_));
  oai21  g148(.a(new_n129_), .b(new_n161_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n129_), .b(new_n163_), .O(new_n194_));
  ...
  oai21  g156(.a(new_n200_), .b(new_n181_), .c(new_n78_), .O(new_n201_));
  nor2   g157(.a(new_n201_), .b(new_n177_), .O(z9));
endmodule
