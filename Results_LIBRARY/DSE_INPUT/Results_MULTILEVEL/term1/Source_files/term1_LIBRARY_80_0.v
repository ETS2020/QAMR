...
module FAU ( 
  ...
  nand4  g097(.a(new_n141_), .b(z0), .c(x31), .d(x30), .O(new_n142_));
  oai22  g098(.a(new_n142_), .b(new_n124_), .c(z0), .d(x30), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n123_), .O(new_n144_));
  nand2  g100(.a(new_n99_), .b(new_n79_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x32), .c(x30), .d(x00), .O(new_n146_));
  nand4  g102(.a(new_n141_), .b(new_n122_), .c(z0), .d(x31), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(x30), .c(new_n146_), .O(new_n148_));
  nand2  g104(.a(x16), .b(x10), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n135_), .c(x15), .O(new_n151_));
  nand2  g107(.a(x17), .b(x11), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n132_), .c(new_n131_), .O(new_n153_));
  inv1   g109(.a(x12), .O(new_n154_));
  oai21  g110(.a(new_n132_), .b(new_n154_), .c(new_n83_), .O(new_n155_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n134_), .c(x31), .O(new_n160_));
  ...
  nor2   g119(.a(new_n163_), .b(new_n124_), .O(new_n164_));
  aoi21  g120(.a(new_n148_), .b(x29), .c(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n144_), .c(x26), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n141_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  oai22  g124(.a(new_n168_), .b(new_n124_), .c(new_n167_), .d(x30), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n122_), .c(x29), .O(new_n170_));
  nand4  g126(.a(new_n141_), .b(new_n167_), .c(new_n117_), .d(new_n107_), .O(new_n171_));
  nand3  g127(.a(x33), .b(x31), .c(x00), .O(new_n172_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n159_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n149_), .c(new_n139_), .O(new_n178_));
  nand2  g134(.a(new_n117_), .b(x30), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n180_), .c(new_n131_), .O(new_n181_));
  oai21  g137(.a(new_n86_), .b(new_n154_), .c(new_n83_), .O(new_n182_));
  nand2  g138(.a(new_n86_), .b(new_n156_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .d(new_n179_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x33), .c(x00), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n173_), .b(new_n123_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n170_), .c(x26), .O(z9));
endmodule
