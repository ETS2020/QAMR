...
module FAU ( 
  ...
  nand2  g089(.a(new_n131_), .b(x12), .O(new_n134_));
  ...
  aoi21  g099(.a(new_n112_), .b(x28), .c(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n137_), .d(new_n135_), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n133_), .c(new_n129_), .d(new_n125_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n78_), .c(x00), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(z8));
  ...
  nand3  g113(.a(new_n139_), .b(new_n130_), .c(x11), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x15), .O(new_n160_));
  nand4  g116(.a(new_n139_), .b(x16), .c(new_n126_), .d(x10), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n151_), .c(x31), .d(x30), .O(new_n163_));
  nand2  g119(.a(x33), .b(new_n118_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n150_), .c(x29), .O(new_n166_));
  nand2  g122(.a(new_n150_), .b(x29), .O(new_n167_));
  nand4  g123(.a(new_n162_), .b(new_n151_), .c(new_n118_), .d(new_n107_), .O(new_n168_));
  ...
  oai21  g128(.a(new_n118_), .b(x30), .c(new_n140_), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n138_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n137_), .c(new_n135_), .d(new_n133_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n172_), .c(x33), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n171_), .c(new_n166_), .O(new_n177_));
