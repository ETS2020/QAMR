// Benchmark "FAU" written by ABC on Mon Jul 27 22:02:12 2020
...
module FAU ( 
  ...
  nand3  g061(.a(new_n97_), .b(new_n105_), .c(x29), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  inv1   g063(.a(new_n80_), .O(new_n108_));
  nand3  g064(.a(new_n88_), .b(new_n85_), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  oai21  g066(.a(new_n103_), .b(new_n102_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n58_), .c(new_n78_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n56_), .O(z6));
  nor2   g069(.a(new_n105_), .b(new_n95_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n97_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x31), .O(new_n116_));
  inv1   g072(.a(new_n86_), .O(new_n117_));
  inv1   g073(.a(new_n87_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n117_), .c(new_n85_), .d(new_n82_), .O(new_n119_));
  nor2   g075(.a(new_n57_), .b(new_n56_), .O(new_n120_));
  inv1   g076(.a(new_n97_), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x30), .c(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n78_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n77_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n116_), .O(z7));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(new_n83_), .O(new_n134_));
  nand4  g090(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n134_), .c(new_n105_), .O(new_n137_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n129_), .c(x11), .O(new_n142_));
  oai21  g098(.a(new_n137_), .b(new_n129_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x15), .O(new_n144_));
  nor2   g100(.a(new_n129_), .b(x15), .O(new_n145_));
  nand2  g101(.a(x18), .b(x17), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  nor2   g103(.a(x30), .b(new_n132_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n145_), .d(x10), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n128_), .c(x29), .O(new_n151_));
  nor2   g107(.a(new_n127_), .b(new_n95_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n136_), .b(new_n134_), .c(x15), .O(new_n154_));
  inv1   g110(.a(x15), .O(new_n155_));
  nand3  g111(.a(new_n141_), .b(new_n155_), .c(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n153_), .c(x30), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n151_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(z0), .c(x31), .O(new_n160_));
  nand2  g116(.a(new_n114_), .b(x27), .O(new_n161_));
  oai21  g117(.a(x30), .b(x27), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n96_), .O(new_n163_));
  nand2  g119(.a(x16), .b(x10), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n140_), .c(new_n155_), .O(new_n165_));
  nand2  g121(.a(x17), .b(x11), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n138_), .c(new_n129_), .O(new_n167_));
  inv1   g123(.a(x12), .O(new_n168_));
  oai21  g124(.a(new_n138_), .b(new_n168_), .c(new_n83_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  oai21  g126(.a(new_n132_), .b(new_n170_), .c(new_n130_), .O(new_n171_));
  nor2   g127(.a(x19), .b(x14), .O(new_n172_));
  nor2   g128(.a(new_n129_), .b(new_n155_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n141_), .c(new_n172_), .O(new_n174_));
  oai21  g130(.a(x30), .b(x29), .c(x31), .O(new_n175_));
  aoi21  g131(.a(new_n114_), .b(x28), .c(new_n175_), .O(new_n176_));
  ...
  nand3  g137(.a(new_n181_), .b(new_n78_), .c(x00), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(z8));
  inv1   g139(.a(x00), .O(new_n184_));
  inv1   g140(.a(x33), .O(new_n185_));
  nand3  g141(.a(new_n150_), .b(new_n185_), .c(new_n122_), .O(new_n186_));
  nand2  g142(.a(x33), .b(x31), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n186_), .c(new_n152_), .O(new_n188_));
  nand4  g144(.a(new_n157_), .b(new_n185_), .c(x31), .d(x30), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(x31), .c(new_n189_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n128_), .c(x29), .O(new_n191_));
  aoi21  g147(.a(new_n132_), .b(x14), .c(new_n130_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(x17), .c(x16), .d(x15), .O(new_n193_));
  nand2  g149(.a(new_n173_), .b(new_n147_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n132_), .O(new_n195_));
  oai21  g151(.a(new_n164_), .b(new_n146_), .c(new_n155_), .O(new_n196_));
  inv1   g152(.a(x11), .O(new_n197_));
  oai21  g153(.a(new_n146_), .b(new_n197_), .c(new_n129_), .O(new_n198_));
  oai21  g154(.a(new_n130_), .b(new_n168_), .c(new_n83_), .O(new_n199_));
  nand2  g155(.a(new_n130_), .b(new_n170_), .O(new_n200_));
  ...
  nand4  g159(.a(new_n203_), .b(new_n196_), .c(new_n195_), .d(new_n193_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(x33), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(new_n191_), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n188_), .c(new_n78_), .O(new_n207_));
  nor2   g163(.a(new_n207_), .b(new_n184_), .O(z9));
endmodule
