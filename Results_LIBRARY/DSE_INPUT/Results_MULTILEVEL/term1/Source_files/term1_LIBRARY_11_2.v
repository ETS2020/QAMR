...
module FAU ( 
  ...
  nand4  g107(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n152_));
  nand3  g108(.a(x19), .b(x18), .c(x12), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n83_), .O(new_n154_));
  inv1   g110(.a(x13), .O(new_n155_));
  oai21  g111(.a(new_n89_), .b(new_n155_), .c(new_n86_), .O(new_n156_));
  inv1   g112(.a(x14), .O(new_n157_));
  nand2  g113(.a(new_n89_), .b(new_n157_), .O(new_n158_));
  nor2   g114(.a(new_n131_), .b(new_n137_), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n133_), .c(new_n117_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n161_));
  aoi21  g117(.a(new_n152_), .b(new_n131_), .c(new_n161_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n151_), .c(z0), .O(new_n163_));
  ...
  aoi21  g130(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x17), .c(x16), .d(x15), .O(new_n176_));
  nor2   g132(.a(new_n86_), .b(new_n83_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n159_), .c(x19), .O(new_n178_));
  aoi21  g134(.a(new_n177_), .b(new_n149_), .c(x15), .O(new_n179_));
  aoi21  g135(.a(new_n177_), .b(x11), .c(x16), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n83_), .O(new_n182_));
  nand2  g138(.a(new_n86_), .b(new_n155_), .O(new_n183_));
  xnor2a g139(.a(x31), .b(x30), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n183_), .c(new_n182_), .O(new_n185_));
  nor4   g141(.a(new_n185_), .b(new_n180_), .c(new_n179_), .d(new_n178_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n176_), .c(new_n168_), .O(new_n187_));
