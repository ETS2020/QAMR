...
module FAU ( 
  ...
  nand3  g091(.a(new_n135_), .b(x17), .c(new_n134_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x15), .O(new_n138_));
  inv1   g094(.a(x15), .O(new_n139_));
  nand2  g095(.a(new_n135_), .b(x17), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(x16), .c(new_n139_), .d(x10), .O(new_n142_));
  ...
  nand3  g103(.a(new_n135_), .b(x17), .c(x15), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n134_), .O(new_n149_));
  nand3  g105(.a(new_n135_), .b(x17), .c(x10), .O(new_n150_));
  nand2  g106(.a(new_n135_), .b(x12), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n83_), .O(new_n152_));
  inv1   g108(.a(x13), .O(new_n153_));
  oai21  g109(.a(new_n89_), .b(new_n153_), .c(new_n86_), .O(new_n154_));
  nor2   g110(.a(x19), .b(x14), .O(new_n155_));
  nor2   g111(.a(new_n134_), .b(new_n139_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n141_), .c(new_n155_), .O(new_n157_));
  oai21  g113(.a(x30), .b(x29), .c(x31), .O(new_n158_));
  aoi21  g114(.a(new_n112_), .b(x28), .c(new_n158_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n157_), .c(new_n154_), .d(new_n152_), .O(new_n160_));
  aoi21  g116(.a(new_n150_), .b(new_n139_), .c(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n149_), .c(new_n147_), .O(new_n162_));
  ...
  nand4  g123(.a(new_n143_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n118_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n124_), .c(x29), .O(new_n171_));
  inv1   g127(.a(new_n126_), .O(new_n172_));
  nand4  g128(.a(new_n143_), .b(new_n167_), .c(new_n118_), .d(new_n107_), .O(new_n173_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n139_), .c(new_n89_), .O(new_n180_));
  inv1   g136(.a(x10), .O(new_n181_));
  oai21  g137(.a(new_n179_), .b(new_n181_), .c(new_n139_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n83_), .O(new_n184_));
  nand2  g140(.a(new_n86_), .b(new_n153_), .O(new_n185_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n180_), .c(new_n178_), .d(new_n149_), .O(new_n189_));
