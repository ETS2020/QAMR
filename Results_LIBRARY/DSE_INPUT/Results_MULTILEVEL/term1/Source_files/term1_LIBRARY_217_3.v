...
module FAU ( 
  ...
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(x31), .O(new_n114_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n112_), .c(new_n78_), .O(new_n119_));
  ...
  nor2   g080(.a(new_n122_), .b(new_n98_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n107_), .c(new_n124_), .O(new_n126_));
  inv1   g082(.a(x16), .O(new_n127_));
  nand3  g083(.a(x19), .b(new_n83_), .c(x12), .O(new_n128_));
  nand3  g084(.a(new_n89_), .b(x17), .c(x14), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(new_n130_));
  nand4  g086(.a(x19), .b(x17), .c(new_n127_), .d(x11), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n130_), .c(x15), .O(new_n133_));
  inv1   g089(.a(x15), .O(new_n134_));
  nor2   g090(.a(new_n89_), .b(new_n83_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x16), .c(new_n134_), .d(x10), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n126_), .c(z0), .d(x31), .O(new_n138_));
  nand3  g094(.a(x30), .b(x29), .c(x27), .O(new_n139_));
  nand2  g095(.a(new_n107_), .b(new_n79_), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(x28), .O(new_n141_));
  nand3  g097(.a(new_n135_), .b(x16), .c(x10), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n134_), .O(new_n143_));
  nand2  g099(.a(new_n135_), .b(x11), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n127_), .O(new_n145_));
  nand2  g101(.a(x19), .b(x12), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n83_), .O(new_n147_));
  inv1   g103(.a(x14), .O(new_n148_));
  nand2  g104(.a(new_n89_), .b(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n135_), .b(x16), .c(x15), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(x18), .O(new_n151_));
  aoi21  g107(.a(new_n107_), .b(new_n98_), .c(new_n117_), .O(new_n152_));
  oai21  g108(.a(new_n113_), .b(new_n99_), .c(new_n152_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n147_), .c(new_n145_), .d(new_n143_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n141_), .c(x32), .O(new_n156_));
  oai21  g112(.a(new_n138_), .b(new_n86_), .c(new_n156_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n78_), .c(x00), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(z8));
  aoi21  g115(.a(new_n136_), .b(new_n133_), .c(x33), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(x31), .c(x30), .d(x18), .O(new_n161_));
  nand2  g117(.a(x33), .b(new_n117_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n123_), .c(x29), .O(new_n164_));
  inv1   g120(.a(new_n125_), .O(new_n165_));
  nand4  g121(.a(new_n160_), .b(new_n117_), .c(new_n107_), .d(x18), .O(new_n166_));
  ...
  inv1   g125(.a(new_n143_), .O(new_n170_));
  aoi21  g126(.a(new_n89_), .b(new_n148_), .c(new_n86_), .O(new_n171_));
  xnor2a g127(.a(x31), .b(x30), .O(new_n172_));
  and2   g128(.a(new_n172_), .b(new_n150_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n171_), .c(new_n147_), .d(new_n145_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n170_), .c(x33), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n169_), .c(new_n164_), .O(new_n176_));
