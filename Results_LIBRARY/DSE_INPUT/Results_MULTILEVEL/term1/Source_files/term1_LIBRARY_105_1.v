...
module FAU ( 
  ...
  nand3  g057(.a(new_n101_), .b(new_n93_), .c(new_n78_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n77_), .c(new_n56_), .O(z5));
  oai21  g059(.a(new_n99_), .b(new_n79_), .c(x30), .O(new_n104_));
  ...
  nand4  g069(.a(new_n113_), .b(x30), .c(x29), .d(x27), .O(new_n114_));
  ...
  nand3  g075(.a(x19), .b(new_n86_), .c(x13), .O(new_n120_));
  nand3  g076(.a(new_n89_), .b(x18), .c(x14), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n120_), .c(new_n83_), .O(new_n122_));
  nand4  g078(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n123_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n119_), .c(z0), .d(x31), .O(new_n135_));
  nand2  g091(.a(x16), .b(x10), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n128_), .c(x15), .O(new_n138_));
  nand2  g094(.a(x19), .b(x18), .O(new_n139_));
  nand2  g095(.a(x17), .b(x11), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(new_n126_), .O(new_n141_));
  ...
  oai22  g102(.a(new_n146_), .b(new_n127_), .c(x19), .d(x14), .O(new_n147_));
  nand2  g103(.a(new_n105_), .b(new_n99_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n110_), .c(x31), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n151_));
  ...
  nand3  g113(.a(new_n113_), .b(new_n105_), .c(new_n99_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n134_), .c(new_n156_), .O(new_n160_));
  nand2  g116(.a(new_n89_), .b(x14), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x18), .c(x17), .d(x16), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n132_), .O(new_n163_));
  nand2  g119(.a(x18), .b(x17), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n146_), .c(new_n89_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n136_), .c(new_n132_), .O(new_n166_));
  inv1   g122(.a(x11), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n167_), .c(new_n126_), .O(new_n168_));
  aoi21  g124(.a(x18), .b(x12), .c(x17), .O(new_n169_));
  nand2  g125(.a(new_n113_), .b(x30), .O(new_n170_));
  nand2  g126(.a(new_n86_), .b(new_n144_), .O(new_n171_));
  nand2  g127(.a(x31), .b(new_n99_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n106_), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n168_), .c(new_n166_), .d(new_n165_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n163_), .c(x33), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n160_), .O(new_n177_));
