...
module FAU ( 
  ...
  nor2   g103(.a(new_n135_), .b(new_n141_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand2  g105(.a(x19), .b(x17), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n86_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n150_), .c(new_n141_), .O(new_n153_));
  inv1   g109(.a(x11), .O(new_n154_));
  oai21  g110(.a(new_n150_), .b(new_n154_), .c(new_n135_), .O(new_n155_));
  inv1   g111(.a(x12), .O(new_n156_));
  oai21  g112(.a(new_n89_), .b(new_n156_), .c(new_n83_), .O(new_n157_));
  nor2   g113(.a(x19), .b(x14), .O(new_n158_));
  aoi21  g114(.a(new_n148_), .b(new_n137_), .c(new_n158_), .O(new_n159_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n153_), .c(new_n151_), .d(new_n147_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x32), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n144_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n78_), .O(new_n167_));
  inv1   g123(.a(x13), .O(new_n168_));
  nand3  g124(.a(x32), .b(new_n86_), .c(new_n168_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n167_), .c(new_n123_), .O(z8));
  ...
  nand4  g132(.a(new_n143_), .b(new_n171_), .c(new_n118_), .d(new_n107_), .O(new_n177_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n141_), .c(new_n89_), .O(new_n184_));
  inv1   g140(.a(x10), .O(new_n185_));
  oai21  g141(.a(new_n183_), .b(new_n185_), .c(new_n141_), .O(new_n186_));
  oai21  g142(.a(new_n83_), .b(new_n154_), .c(new_n135_), .O(new_n187_));
  nand2  g143(.a(new_n83_), .b(new_n156_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n184_), .c(new_n182_), .d(new_n151_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n180_), .c(new_n175_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n78_), .O(new_n195_));
  nand3  g151(.a(x33), .b(new_n86_), .c(new_n168_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n195_), .c(new_n123_), .O(z9));
endmodule
