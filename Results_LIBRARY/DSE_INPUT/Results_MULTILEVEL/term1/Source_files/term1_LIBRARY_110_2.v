...
module FAU ( 
  ...
  nand4  g108(.a(new_n149_), .b(x16), .c(new_n80_), .d(x10), .O(new_n153_));
  ...
  oai21  g150(.a(new_n193_), .b(new_n160_), .c(new_n80_), .O(new_n195_));
