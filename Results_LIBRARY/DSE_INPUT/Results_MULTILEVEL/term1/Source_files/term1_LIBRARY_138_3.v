...
module FAU ( 
  ...
  nand3  g088(.a(new_n132_), .b(new_n78_), .c(x17), .O(new_n133_));
  nor2   g089(.a(new_n89_), .b(new_n86_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n83_), .c(x12), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n129_), .O(new_n136_));
  inv1   g092(.a(x11), .O(new_n137_));
  nor2   g093(.a(x26), .b(new_n89_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x18), .O(new_n139_));
  nor4   g095(.a(new_n139_), .b(new_n83_), .c(x16), .d(new_n137_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n136_), .c(x15), .O(new_n141_));
  nor2   g097(.a(new_n129_), .b(x15), .O(new_n142_));
  nand2  g098(.a(x18), .b(x17), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n138_), .d(x10), .O(new_n145_));
  ...
  oai21  g114(.a(new_n143_), .b(new_n137_), .c(new_n129_), .O(new_n159_));
  nand2  g115(.a(x18), .b(x12), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n83_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  aoi22  g118(.a(new_n112_), .b(x28), .c(new_n86_), .d(new_n162_), .O(new_n163_));
  aoi21  g119(.a(new_n107_), .b(new_n98_), .c(new_n118_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n158_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(x32), .c(new_n78_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n147_), .c(new_n123_), .O(z8));
  aoi21  g125(.a(new_n131_), .b(new_n130_), .c(new_n129_), .O(new_n170_));
  nand4  g126(.a(x19), .b(x18), .c(new_n129_), .d(x11), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n170_), .c(x15), .O(new_n173_));
  nand4  g129(.a(new_n134_), .b(x16), .c(new_n155_), .d(x10), .O(new_n174_));
  ...
  nand4  g135(.a(new_n83_), .b(x16), .c(x15), .d(x12), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nor2   g137(.a(x33), .b(new_n118_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n181_), .c(new_n134_), .d(x30), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n125_), .c(x29), .O(new_n185_));
  inv1   g141(.a(new_n127_), .O(new_n186_));
  nand4  g142(.a(new_n175_), .b(new_n118_), .c(new_n107_), .d(x17), .O(new_n187_));
  ...
  nand3  g147(.a(new_n191_), .b(new_n181_), .c(new_n134_), .O(new_n192_));
  ...
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n161_), .d(new_n159_), .O(new_n196_));
  inv1   g152(.a(new_n196_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n157_), .c(new_n154_), .d(new_n149_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(x33), .c(new_n78_), .O(new_n199_));
  inv1   g155(.a(new_n199_), .O(new_n200_));
  aoi21  g156(.a(new_n193_), .b(new_n186_), .c(new_n200_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n185_), .c(new_n123_), .O(z9));
endmodule
