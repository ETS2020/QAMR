...
module FAU ( 
  ...
  nand3  g097(.a(new_n132_), .b(x16), .c(new_n136_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n135_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n122_), .c(z0), .d(x31), .O(new_n144_));
  nand2  g100(.a(new_n99_), .b(new_n79_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x32), .c(x30), .O(new_n146_));
  oai21  g102(.a(new_n144_), .b(x30), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  nand2  g104(.a(x16), .b(x10), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n132_), .c(x15), .O(new_n151_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n131_), .c(x31), .O(new_n161_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n148_), .c(new_n141_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n78_), .c(x00), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n138_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n117_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n122_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n143_), .b(new_n168_), .c(new_n117_), .d(new_n107_), .O(new_n173_));
  oai21  g129(.a(new_n168_), .b(new_n117_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n123_), .O(new_n175_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n160_), .c(new_n89_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n149_), .c(new_n136_), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(new_n181_), .c(new_n130_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n83_), .O(new_n184_));
  nand2  g140(.a(new_n86_), .b(new_n157_), .O(new_n185_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n175_), .c(new_n172_), .O(new_n191_));
