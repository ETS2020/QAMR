...
module FAU ( 
  ...
  or2    g038(.a(x23), .b(x18), .O(new_n83_));
  nand4  g039(.a(new_n83_), .b(new_n82_), .c(new_n79_), .d(x24), .O(new_n84_));
  ...
  nand4  g063(.a(new_n83_), .b(new_n82_), .c(new_n79_), .d(x24), .O(new_n108_));
  ...
  nand4  g073(.a(new_n117_), .b(x31), .c(new_n101_), .d(x18), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n80_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x16), .c(x15), .d(x14), .O(new_n120_));
  ...
  nand4  g081(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n126_));
  nand4  g082(.a(z0), .b(x31), .c(x30), .d(x18), .O(new_n127_));
  oai22  g083(.a(new_n127_), .b(new_n126_), .c(z0), .d(x30), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand3  g085(.a(x16), .b(x15), .c(x14), .O(new_n130_));
  nand3  g086(.a(x31), .b(x18), .c(x17), .O(new_n131_));
  ...
  nand4  g092(.a(new_n136_), .b(x31), .c(x30), .d(x18), .O(new_n137_));
  oai22  g093(.a(new_n137_), .b(new_n126_), .c(new_n136_), .d(x31), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n124_), .c(x29), .O(new_n139_));
  nand4  g095(.a(new_n136_), .b(new_n111_), .c(new_n101_), .d(x18), .O(new_n140_));
  ...
  nand3  g099(.a(new_n143_), .b(x18), .c(x17), .O(new_n144_));
