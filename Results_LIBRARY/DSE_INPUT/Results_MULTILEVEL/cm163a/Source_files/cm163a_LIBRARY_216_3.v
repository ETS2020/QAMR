// Benchmark "FAU" written by ABC on Mon Jul 27 17:20:26 2020
...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(x03), .c(x02), .O(new_n37_));
  nor3   g16(.a(x12), .b(x11), .c(x09), .O(new_n38_));
  aoi22  g17(.a(new_n38_), .b(new_n23_), .c(new_n37_), .d(x12), .O(new_n39_));
  ...
  aoi21  g23(.a(new_n44_), .b(new_n23_), .c(new_n43_), .O(new_n45_));
  inv1   g24(.a(x11), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand3  g26(.a(new_n43_), .b(new_n47_), .c(new_n46_), .O(new_n48_));
  ...
  nand2  g31(.a(x13), .b(x09), .O(new_n53_));
  nand3  g32(.a(new_n53_), .b(new_n52_), .c(x05), .O(new_n54_));
