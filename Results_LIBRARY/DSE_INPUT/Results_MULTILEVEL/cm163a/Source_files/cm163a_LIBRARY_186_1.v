// Benchmark "FAU" written by ABC on Mon Jul 27 17:20:21 2020
...
module FAU ( 
  ...
  aoi21  g11(.a(new_n32_), .b(new_n28_), .c(x11), .O(new_n33_));
  nand4  g12(.a(new_n33_), .b(new_n22_), .c(x03), .d(x02), .O(new_n34_));
  nand3  g13(.a(new_n24_), .b(x11), .c(x04), .O(new_n35_));
  ...
  nand2  g19(.a(new_n40_), .b(x12), .O(new_n41_));
  inv1   g20(.a(x06), .O(new_n42_));
  nand2  g21(.a(new_n42_), .b(new_n28_), .O(new_n43_));
  nor3   g22(.a(x12), .b(x11), .c(x09), .O(new_n44_));
  nand4  g23(.a(new_n44_), .b(x04), .c(x03), .d(x02), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n43_), .c(new_n41_), .d(x05), .O(z2));
  inv1   g25(.a(x13), .O(new_n47_));
  aoi21  g26(.a(new_n39_), .b(new_n23_), .c(new_n47_), .O(new_n48_));
  inv1   g27(.a(x11), .O(new_n49_));
  nand3  g28(.a(new_n47_), .b(new_n32_), .c(new_n49_), .O(new_n50_));
  ...
  nand3  g34(.a(new_n55_), .b(new_n54_), .c(x05), .O(new_n56_));
