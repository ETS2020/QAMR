...
module FAU ( 
  ...
  aoi22  g12(.a(new_n33_), .b(x03), .c(new_n25_), .d(x11), .O(new_n34_));
  ...
  nand4  g19(.a(new_n38_), .b(new_n40_), .c(new_n24_), .d(x03), .O(new_n41_));
  ...
  nand4  g27(.a(new_n48_), .b(new_n38_), .c(new_n40_), .d(new_n24_), .O(new_n49_));
