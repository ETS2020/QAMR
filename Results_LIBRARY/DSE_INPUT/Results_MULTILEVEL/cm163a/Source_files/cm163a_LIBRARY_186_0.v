...
module FAU ( 
  ...
  aoi22  g24(.a(new_n45_), .b(new_n23_), .c(new_n38_), .d(x13), .O(new_n46_));
  inv1   g25(.a(x07), .O(new_n47_));
  nand2  g26(.a(new_n47_), .b(new_n28_), .O(new_n48_));
  nand3  g27(.a(x13), .b(x12), .c(x04), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n48_), .c(x05), .O(new_n50_));
  inv1   g29(.a(new_n50_), .O(new_n51_));
  oai21  g30(.a(new_n46_), .b(x12), .c(new_n51_), .O(z3));
