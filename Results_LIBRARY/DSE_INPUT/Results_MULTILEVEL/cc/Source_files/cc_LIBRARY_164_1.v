...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n57_, new_n58_, new_n60_, new_n61_, new_n62_,
  ...
  oai21  g16(.a(z04), .b(x14), .c(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(x09), .O(z10));
  nand2  g18(.a(new_n48_), .b(x13), .O(new_n60_));
  inv1   g19(.a(x10), .O(new_n61_));
  nor2   g20(.a(x15), .b(new_n61_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(x08), .c(x00), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n60_), .c(new_n52_), .O(z12));
  oai21  g23(.a(new_n61_), .b(new_n57_), .c(new_n43_), .O(new_n65_));
  ...
  nand3  g29(.a(new_n62_), .b(x08), .c(x02), .O(new_n71_));
