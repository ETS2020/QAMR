...
module FAU ( 
  ...
  aoi21  g31(.a(new_n47_), .b(x08), .c(new_n72_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n59_), .c(new_n43_), .O(new_n74_));
  nand3  g33(.a(new_n60_), .b(x08), .c(x03), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n52_), .O(z15));
  nand2  g35(.a(new_n48_), .b(x17), .O(new_n77_));
  nand3  g36(.a(new_n60_), .b(x08), .c(x04), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(z16));
  nand2  g38(.a(new_n48_), .b(x18), .O(new_n80_));
  nand3  g39(.a(new_n60_), .b(x08), .c(x05), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(z17));
  nand2  g41(.a(new_n48_), .b(x19), .O(new_n83_));
  nand3  g42(.a(new_n60_), .b(x08), .c(x06), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(z18));
  nand2  g44(.a(new_n48_), .b(x20), .O(new_n86_));
  nand3  g45(.a(new_n60_), .b(x08), .c(x07), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(z19));
  buf    g47(.a(x19), .O(z05));
  buf    g48(.a(x15), .O(z06));
  buf    g49(.a(x17), .O(z07));
  buf    g50(.a(x16), .O(z08));
