// Benchmark "FAU" written by ABC on Mon Jul 27 17:23:27 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  nor2   g10(.a(x15), .b(x11), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n45_), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n51_), .c(new_n48_), .O(z02));
  nor4   g13(.a(new_n44_), .b(new_n49_), .c(x14), .d(new_n48_), .O(z03));
  ...
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n48_), .O(z12));
  inv1   g22(.a(x08), .O(new_n64_));
  oai21  g23(.a(new_n60_), .b(new_n64_), .c(new_n43_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x15), .O(new_n66_));
  inv1   g25(.a(x01), .O(new_n67_));
  oai21  g26(.a(new_n44_), .b(new_n67_), .c(x14), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n48_), .O(z13));
  nand2  g28(.a(new_n44_), .b(x15), .O(new_n70_));
  nand3  g29(.a(new_n61_), .b(x08), .c(x02), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z14));
  nand3  g31(.a(new_n50_), .b(x16), .c(new_n43_), .O(new_n73_));
  nand3  g32(.a(new_n61_), .b(x08), .c(x03), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n48_), .O(z15));
  nand2  g34(.a(new_n50_), .b(x17), .O(new_n76_));
  nand3  g35(.a(new_n61_), .b(x08), .c(x04), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n48_), .O(z16));
  nand2  g37(.a(new_n50_), .b(x18), .O(new_n79_));
  nand3  g38(.a(new_n61_), .b(x08), .c(x05), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n48_), .O(z17));
  nand2  g40(.a(new_n50_), .b(x19), .O(new_n82_));
  nand3  g41(.a(new_n61_), .b(x08), .c(x06), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n48_), .O(z18));
  nand2  g43(.a(new_n50_), .b(x20), .O(new_n85_));
  nand3  g44(.a(new_n61_), .b(x08), .c(x07), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(z19));
  buf    g46(.a(x19), .O(z05));
  buf    g47(.a(x15), .O(z06));
  buf    g48(.a(x17), .O(z07));
  buf    g49(.a(x16), .O(z08));
