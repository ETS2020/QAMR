...
module FAU ( 
  ...
  nand2  g17(.a(new_n43_), .b(new_n58_), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(x15), .c(x10), .O(new_n60_));
  oai21  g19(.a(new_n53_), .b(x00), .c(x13), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n60_), .c(new_n52_), .O(z12));
  inv1   g21(.a(x01), .O(new_n63_));
  oai21  g22(.a(new_n53_), .b(new_n63_), .c(x14), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n60_), .c(new_n52_), .O(z13));
  nand2  g24(.a(new_n53_), .b(x15), .O(new_n66_));
  inv1   g25(.a(x10), .O(new_n67_));
  nor2   g26(.a(x15), .b(new_n67_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n52_), .O(z14));
  nand3  g29(.a(new_n48_), .b(x16), .c(new_n43_), .O(new_n71_));
  nand3  g30(.a(new_n68_), .b(x08), .c(x03), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n52_), .O(z15));
  nand2  g32(.a(new_n48_), .b(x17), .O(new_n74_));
  nand3  g33(.a(new_n68_), .b(x08), .c(x04), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n52_), .O(z16));
  nand2  g35(.a(new_n48_), .b(x18), .O(new_n77_));
  nand3  g36(.a(new_n68_), .b(x08), .c(x05), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(z17));
