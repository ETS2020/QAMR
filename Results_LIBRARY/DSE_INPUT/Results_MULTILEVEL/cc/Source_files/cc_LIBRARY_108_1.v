...
module FAU ( 
  ...
  nand2  g24(.a(new_n53_), .b(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n52_), .O(z13));
  nand2  g26(.a(new_n53_), .b(x15), .O(new_n68_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z14));
