// Benchmark "FAU" written by ABC on Mon Jul 27 17:23:15 2020
...
module FAU ( 
  ...
  nand2  g28(.a(x15), .b(new_n43_), .O(new_n70_));
  nand2  g29(.a(new_n47_), .b(x03), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x10), .c(x08), .O(new_n73_));
  nand3  g32(.a(new_n53_), .b(x16), .c(new_n43_), .O(new_n74_));
