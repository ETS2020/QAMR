// Benchmark "FAU" written by ABC on Mon Jul 27 17:23:24 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n43_), .b(x10), .c(x08), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x17), .c(new_n43_), .O(new_n64_));
  ...
  nand2  g33(.a(x15), .b(new_n43_), .O(new_n75_));
  nand2  g34(.a(new_n47_), .b(x04), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x10), .c(x08), .O(new_n78_));
  nand2  g37(.a(x15), .b(x14), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x10), .c(x08), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n78_), .c(new_n52_), .O(z16));
  nand2  g41(.a(new_n48_), .b(x18), .O(new_n83_));
  nand3  g42(.a(new_n60_), .b(x08), .c(x05), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(z17));
  nand2  g44(.a(new_n48_), .b(x19), .O(new_n86_));
  nand3  g45(.a(new_n60_), .b(x08), .c(x06), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n52_), .O(z18));
  nand2  g47(.a(new_n48_), .b(x20), .O(new_n89_));
  nand3  g48(.a(new_n60_), .b(x08), .c(x07), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n52_), .O(z19));
  buf    g50(.a(x19), .O(z05));
  buf    g51(.a(x15), .O(z06));
  buf    g52(.a(x17), .O(z07));
  buf    g53(.a(x16), .O(z08));
