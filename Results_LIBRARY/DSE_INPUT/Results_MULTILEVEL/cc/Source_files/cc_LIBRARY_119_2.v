...
module FAU ( 
  ...
  nand3  g17(.a(new_n47_), .b(x08), .c(x00), .O(new_n59_));
  ...
  oai21  g24(.a(new_n53_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n52_), .O(z13));
  nand2  g26(.a(new_n53_), .b(x15), .O(new_n68_));
  nor2   g27(.a(x15), .b(new_n62_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x08), .c(x02), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n52_), .O(z14));
  nand3  g30(.a(new_n48_), .b(x16), .c(new_n43_), .O(new_n72_));
  nand3  g31(.a(new_n69_), .b(x08), .c(x03), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n52_), .O(z15));
  nand2  g33(.a(new_n48_), .b(x17), .O(new_n75_));
  nand3  g34(.a(new_n69_), .b(x08), .c(x04), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n52_), .O(z16));
  nand2  g36(.a(new_n48_), .b(x18), .O(new_n78_));
  nand3  g37(.a(new_n69_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(z17));
  nand2  g39(.a(new_n48_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n69_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(z18));
  nand2  g42(.a(new_n48_), .b(x20), .O(new_n84_));
  nand3  g43(.a(new_n69_), .b(x08), .c(x07), .O(new_n85_));
