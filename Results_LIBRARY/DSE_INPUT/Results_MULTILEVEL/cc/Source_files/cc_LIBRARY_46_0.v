...
module FAU ( 
  ...
  nand3  g16(.a(new_n52_), .b(x10), .c(x08), .O(new_n58_));
  ...
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n51_), .O(z12));
  oai21  g22(.a(new_n60_), .b(new_n47_), .c(new_n43_), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x15), .O(new_n65_));
  inv1   g24(.a(x01), .O(new_n66_));
  oai21  g25(.a(new_n53_), .b(new_n66_), .c(x14), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n51_), .O(z13));
  nand2  g27(.a(new_n53_), .b(x15), .O(new_n69_));
  nand3  g28(.a(new_n61_), .b(x08), .c(x02), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n51_), .O(z14));
  nand3  g30(.a(new_n58_), .b(x16), .c(new_n43_), .O(new_n72_));
  nand3  g31(.a(new_n61_), .b(x08), .c(x03), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n51_), .O(z15));
  nand2  g33(.a(new_n58_), .b(x17), .O(new_n75_));
  nand3  g34(.a(new_n61_), .b(x08), .c(x04), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n51_), .O(z16));
  nand2  g36(.a(new_n58_), .b(x18), .O(new_n78_));
  nand3  g37(.a(new_n61_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(z17));
  nand2  g39(.a(new_n58_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n61_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(z18));
  nand2  g42(.a(new_n58_), .b(x20), .O(new_n84_));
  nand3  g43(.a(new_n61_), .b(x08), .c(x07), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n51_), .O(z19));
  buf    g45(.a(x19), .O(z05));
  buf    g46(.a(x15), .O(z06));
  buf    g47(.a(x17), .O(z07));
  buf    g48(.a(x16), .O(z08));
