...
module FAU ( 
  ...
  oai21  g35(.a(x15), .b(new_n76_), .c(x18), .O(new_n77_));
  nor2   g36(.a(x15), .b(new_n76_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x05), .c(new_n59_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n52_), .O(z17));
