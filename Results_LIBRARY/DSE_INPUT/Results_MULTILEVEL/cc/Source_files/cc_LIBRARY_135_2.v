...
module FAU ( 
  ...
  nand2  g22(.a(new_n43_), .b(new_n63_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(x15), .c(x10), .O(new_n65_));
  ...
  oai21  g36(.a(new_n53_), .b(x05), .c(x18), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n65_), .c(new_n52_), .O(z17));
