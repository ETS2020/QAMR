...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n74_, new_n77_, new_n78_, new_n80_, new_n81_;
  ...
  aoi21  g34(.a(new_n48_), .b(z04), .c(new_n52_), .O(z17));
  nand2  g35(.a(new_n48_), .b(x19), .O(new_n77_));
  nand3  g36(.a(new_n60_), .b(x08), .c(x06), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n52_), .O(z18));
  nand2  g38(.a(new_n48_), .b(x20), .O(new_n80_));
  nand3  g39(.a(new_n60_), .b(x08), .c(x07), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n52_), .O(z19));
  buf    g41(.a(x19), .O(z05));
  buf    g42(.a(x15), .O(z06));
  buf    g43(.a(x17), .O(z07));
  buf    g44(.a(x16), .O(z08));
