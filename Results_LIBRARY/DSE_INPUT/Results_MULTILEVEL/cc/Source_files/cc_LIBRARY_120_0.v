...
module FAU ( 
  ...
  nand2  g40(.a(new_n53_), .b(x18), .O(new_n82_));
  ...
  nand3  g45(.a(new_n86_), .b(x10), .c(x08), .O(new_n87_));
  nand2  g46(.a(new_n53_), .b(x19), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(z18));
  nand2  g48(.a(new_n48_), .b(x20), .O(new_n90_));
  nand3  g49(.a(new_n60_), .b(x08), .c(x07), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n52_), .O(z19));
  buf    g51(.a(x19), .O(z05));
  buf    g52(.a(x15), .O(z06));
  buf    g53(.a(x17), .O(z07));
  buf    g54(.a(x16), .O(z08));
