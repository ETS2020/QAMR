...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n52_, new_n53_, new_n57_, new_n59_, new_n60_, new_n61_, new_n62_,
  ...
  and2   g14(.a(x09), .b(x08), .O(z09));
  nor2   g15(.a(x19), .b(x14), .O(new_n57_));
  oai21  g16(.a(new_n57_), .b(x08), .c(x09), .O(z10));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n52_), .O(z14));
