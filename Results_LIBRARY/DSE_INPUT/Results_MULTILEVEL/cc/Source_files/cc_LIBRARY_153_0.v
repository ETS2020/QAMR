...
module FAU ( 
  ...
  nor3   g11(.a(new_n52_), .b(new_n47_), .c(x14), .O(z03));
  ...
  nand2  g24(.a(x10), .b(x01), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(x14), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n57_), .O(z13));
  nand2  g27(.a(x15), .b(new_n59_), .O(new_n69_));
  nand3  g28(.a(new_n47_), .b(x10), .c(x02), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n69_), .c(x08), .O(new_n71_));
  and2   g30(.a(new_n71_), .b(x12), .O(z14));
  nand3  g31(.a(new_n48_), .b(x16), .c(new_n43_), .O(new_n73_));
  nand2  g32(.a(new_n60_), .b(x03), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n57_), .O(z15));
  nand2  g34(.a(new_n48_), .b(x17), .O(new_n76_));
  nand2  g35(.a(new_n60_), .b(x04), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(z16));
  nand2  g37(.a(new_n48_), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n60_), .b(x05), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n57_), .O(z17));
  nand2  g40(.a(new_n48_), .b(x19), .O(new_n82_));
  nand2  g41(.a(new_n60_), .b(x06), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n57_), .O(z18));
  nand2  g43(.a(new_n48_), .b(x20), .O(new_n85_));
  nand2  g44(.a(new_n60_), .b(x07), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n57_), .O(z19));
  buf    g46(.a(x19), .O(z05));
  buf    g47(.a(x15), .O(z06));
  buf    g48(.a(x17), .O(z07));
  buf    g49(.a(x16), .O(z08));
