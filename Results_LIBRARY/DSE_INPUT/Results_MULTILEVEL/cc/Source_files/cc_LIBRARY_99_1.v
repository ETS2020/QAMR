...
module FAU ( 
  ...
  nand2  g36(.a(new_n48_), .b(x18), .O(new_n78_));
  nand3  g37(.a(new_n61_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(z17));
  nand2  g39(.a(new_n48_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n61_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n52_), .O(z18));
  nand2  g42(.a(new_n48_), .b(x20), .O(new_n84_));
  nand3  g43(.a(new_n61_), .b(x08), .c(x07), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n52_), .O(z19));
  buf    g45(.a(x19), .O(z05));
  buf    g46(.a(x15), .O(z06));
  buf    g47(.a(x17), .O(z07));
  buf    g48(.a(x16), .O(z08));
