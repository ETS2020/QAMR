...
module FAU ( 
  ...
  oai21  g77(.a(new_n121_), .b(new_n109_), .c(x24), .O(new_n122_));
  oai21  g78(.a(new_n119_), .b(x24), .c(new_n122_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n66_), .O(z15));
  ...
  nand4  g85(.a(new_n113_), .b(new_n73_), .c(new_n45_), .d(x24), .O(new_n130_));
