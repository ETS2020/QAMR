...
module FAU ( 
  ...
  nor2   g80(.a(new_n72_), .b(new_n47_), .O(new_n125_));
  nand4  g81(.a(new_n117_), .b(new_n125_), .c(new_n75_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n66_), .O(z15));
  inv1   g85(.a(x18), .O(new_n130_));
  nand3  g86(.a(x21), .b(x20), .c(new_n130_), .O(new_n131_));
  nand4  g87(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n131_), .c(x26), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n75_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n101_), .c(new_n74_), .d(new_n70_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n137_));
  oai21  g93(.a(new_n48_), .b(new_n68_), .c(new_n137_), .O(z16));
endmodule
