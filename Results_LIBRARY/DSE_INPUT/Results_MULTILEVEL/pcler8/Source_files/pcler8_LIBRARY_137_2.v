...
module FAU ( 
  ...
  nand4  g31(.a(new_n75_), .b(new_n73_), .c(new_n70_), .d(x11), .O(new_n76_));
  nand3  g32(.a(new_n76_), .b(x22), .c(x19), .O(new_n77_));
  nand4  g33(.a(new_n77_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n78_));
  oai21  g34(.a(new_n48_), .b(new_n54_), .c(new_n78_), .O(z09));
  ...
  nand2  g43(.a(x23), .b(x13), .O(new_n88_));
  ...
  nand2  g50(.a(x22), .b(new_n80_), .O(new_n95_));
  nand2  g51(.a(x23), .b(x14), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n82_), .c(x21), .d(new_n46_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n46_), .c(x19), .O(new_n98_));
  ...
  nand3  g62(.a(new_n103_), .b(new_n71_), .c(x21), .O(new_n107_));
  ...
  nand3  g67(.a(new_n111_), .b(x23), .c(x21), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n102_), .c(x24), .O(new_n113_));
  nand4  g69(.a(new_n103_), .b(new_n72_), .c(x23), .d(x21), .O(new_n114_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n74_), .c(x24), .d(x23), .O(new_n123_));
  ...
  nand4  g84(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  nand4  g86(.a(new_n122_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n131_));
