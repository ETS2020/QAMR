...
module FAU ( 
  ...
  aoi22  g54(.a(new_n98_), .b(new_n93_), .c(new_n97_), .d(new_n96_), .O(new_n99_));
  and2   g55(.a(x20), .b(x19), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n71_), .c(x21), .O(new_n101_));
  oai21  g57(.a(new_n99_), .b(new_n71_), .c(new_n101_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n60_), .O(z12));
  inv1   g60(.a(new_n97_), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n105_), .c(x22), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n108_));
  nand4  g64(.a(new_n100_), .b(new_n94_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n111_));
  oai21  g67(.a(new_n46_), .b(new_n62_), .c(new_n111_), .O(z13));
  nand2  g68(.a(x24), .b(x23), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(x21), .c(x20), .d(x19), .O(new_n114_));
  nand2  g70(.a(new_n97_), .b(x24), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x22), .O(new_n117_));
  nand3  g73(.a(x26), .b(x25), .c(x16), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x22), .O(new_n119_));
  ...
  nand2  g78(.a(new_n122_), .b(new_n64_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(x24), .c(x23), .d(x22), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n97_), .c(x25), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  nor2   g83(.a(new_n94_), .b(new_n71_), .O(new_n128_));
  nand4  g84(.a(new_n105_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  oai21  g87(.a(new_n46_), .b(new_n66_), .c(new_n131_), .O(z15));
  ...
  inv1   g92(.a(new_n113_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n100_), .c(new_n137_), .d(new_n72_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  oai21  g97(.a(new_n46_), .b(new_n68_), .c(new_n141_), .O(z16));
endmodule
