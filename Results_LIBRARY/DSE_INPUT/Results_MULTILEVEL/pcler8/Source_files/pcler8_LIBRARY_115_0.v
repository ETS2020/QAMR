...
module FAU ( 
  ...
  nand2  g25(.a(x20), .b(x11), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(x10), .O(new_n71_));
  nand3  g27(.a(x23), .b(x22), .c(x21), .O(new_n72_));
  nand3  g28(.a(x26), .b(x25), .c(x24), .O(new_n73_));
  nor2   g29(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g30(.a(new_n74_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n75_));
  oai21  g31(.a(new_n48_), .b(new_n54_), .c(new_n75_), .O(z09));
  ...
  oai21  g37(.a(new_n81_), .b(new_n77_), .c(x20), .O(new_n82_));
  nand4  g38(.a(new_n82_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n83_));
  ...
  oai21  g44(.a(x21), .b(new_n85_), .c(new_n88_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n58_), .O(z11));
  nand2  g47(.a(x23), .b(x14), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n73_), .c(x21), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n85_), .c(x22), .O(new_n94_));
  nand3  g50(.a(new_n47_), .b(x21), .c(x20), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n60_), .O(z12));
  nand2  g54(.a(x21), .b(x20), .O(new_n99_));
  ...
  nand2  g58(.a(new_n102_), .b(x23), .O(new_n103_));
  nand3  g59(.a(new_n100_), .b(new_n78_), .c(x22), .O(new_n104_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n99_), .c(x24), .O(new_n110_));
  nand4  g66(.a(new_n100_), .b(new_n79_), .c(x23), .d(x22), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n64_), .O(z14));
  nand3  g70(.a(x22), .b(x21), .c(x20), .O(new_n115_));
  nand2  g71(.a(x26), .b(x17), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x24), .c(x23), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n115_), .c(x25), .O(new_n118_));
  inv1   g74(.a(new_n115_), .O(new_n119_));
  nor2   g75(.a(x25), .b(new_n79_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n119_), .c(x23), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n123_));
  oai21  g79(.a(new_n48_), .b(new_n66_), .c(new_n123_), .O(z15));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(x21), .b(x20), .c(new_n125_), .O(new_n126_));
  nand4  g82(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n126_), .c(x26), .O(new_n128_));
  nand4  g84(.a(new_n119_), .b(new_n80_), .c(new_n45_), .d(x25), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n131_));
  oai21  g87(.a(new_n48_), .b(new_n68_), .c(new_n131_), .O(z16));
endmodule
