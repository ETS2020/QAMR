...
module FAU ( 
  ...
  nand3  g41(.a(x26), .b(x24), .c(x23), .O(new_n86_));
  ...
  nand3  g50(.a(x26), .b(x25), .c(x24), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n94_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n93_), .c(x22), .O(new_n97_));
  inv1   g53(.a(new_n93_), .O(new_n98_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n93_), .c(x23), .O(new_n105_));
  ...
  nand4  g81(.a(new_n125_), .b(new_n116_), .c(new_n124_), .d(x24), .O(new_n126_));
