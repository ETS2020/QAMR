...
module FAU ( 
  ...
  nand3  g58(.a(new_n100_), .b(x22), .c(x21), .O(new_n103_));
  oai22  g59(.a(new_n103_), .b(new_n91_), .c(new_n102_), .d(new_n100_), .O(new_n104_));
  ...
  nor2   g84(.a(new_n111_), .b(new_n100_), .O(new_n129_));
  nand4  g85(.a(new_n102_), .b(new_n129_), .c(new_n45_), .d(x25), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  oai21  g88(.a(new_n46_), .b(new_n68_), .c(new_n132_), .O(z16));
endmodule
