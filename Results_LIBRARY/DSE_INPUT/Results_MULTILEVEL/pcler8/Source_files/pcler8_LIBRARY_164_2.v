...
module FAU ( 
  ...
  aoi21  g50(.a(x23), .b(x10), .c(new_n94_), .O(new_n95_));
  nand3  g51(.a(x23), .b(x14), .c(new_n47_), .O(new_n96_));
  nor2   g52(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(x22), .O(new_n98_));
  nor2   g54(.a(new_n78_), .b(x10), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n71_), .c(x21), .d(x20), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x09), .c(new_n46_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n60_), .O(z12));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n94_), .c(x22), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x23), .c(new_n47_), .O(new_n106_));
  inv1   g62(.a(x23), .O(new_n107_));
  nand2  g63(.a(x20), .b(x19), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n107_), .c(x22), .d(x21), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(x09), .c(new_n46_), .O(new_n112_));
  oai21  g68(.a(new_n46_), .b(new_n62_), .c(new_n112_), .O(z13));
  nand3  g69(.a(x26), .b(x25), .c(x16), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(x22), .c(x21), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n108_), .c(x24), .O(new_n116_));
  inv1   g72(.a(x24), .O(new_n117_));
  nand4  g73(.a(new_n94_), .b(new_n117_), .c(x23), .d(x22), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n116_), .c(x10), .O(new_n119_));
  nor2   g75(.a(new_n117_), .b(x23), .O(new_n120_));
  ...
  nand3  g79(.a(new_n123_), .b(x24), .c(x22), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n93_), .c(x25), .O(new_n125_));
  inv1   g81(.a(x25), .O(new_n126_));
  nor2   g82(.a(new_n107_), .b(new_n71_), .O(new_n127_));
  nand4  g83(.a(new_n94_), .b(new_n127_), .c(new_n126_), .d(x24), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n125_), .c(x10), .O(new_n129_));
  nor2   g85(.a(new_n126_), .b(x23), .O(new_n130_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n109_), .c(new_n137_), .d(new_n72_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x10), .O(new_n140_));
  nor2   g96(.a(new_n45_), .b(x23), .O(new_n141_));
