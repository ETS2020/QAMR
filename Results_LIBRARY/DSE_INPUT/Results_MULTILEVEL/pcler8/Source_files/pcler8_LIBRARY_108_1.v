...
module FAU ( 
  ...
  nor3   g67(.a(new_n93_), .b(new_n111_), .c(new_n70_), .O(new_n112_));
  nand3  g68(.a(x21), .b(x20), .c(x19), .O(new_n113_));
  nand3  g69(.a(new_n110_), .b(x23), .c(x22), .O(new_n114_));
  oai22  g70(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n110_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n64_), .O(z14));
  nand2  g73(.a(x26), .b(x17), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(x24), .c(x23), .d(x22), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n113_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  inv1   g77(.a(new_n111_), .O(new_n122_));
  ...
  nor2   g87(.a(new_n110_), .b(new_n105_), .O(new_n132_));
