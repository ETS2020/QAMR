...
module FAU ( 
  ...
  oai22  g67(.a(new_n111_), .b(new_n93_), .c(new_n110_), .d(x22), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n113_));
  nand3  g69(.a(x26), .b(x25), .c(x16), .O(new_n114_));
  nand3  g70(.a(new_n114_), .b(x23), .c(x21), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n93_), .c(x24), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n47_), .c(x09), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n64_), .O(z14));
  ...
  nor2   g90(.a(new_n110_), .b(new_n105_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n124_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n97_), .c(new_n135_), .d(new_n72_), .O(new_n137_));
