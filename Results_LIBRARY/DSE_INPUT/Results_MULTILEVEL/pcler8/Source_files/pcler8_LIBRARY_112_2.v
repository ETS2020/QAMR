...
module FAU ( 
  ...
  nand4  g88(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n133_));
  inv1   g89(.a(new_n133_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n123_), .O(new_n135_));
  nand3  g91(.a(new_n135_), .b(new_n134_), .c(new_n132_), .O(new_n136_));
  aoi21  g92(.a(new_n136_), .b(new_n131_), .c(x10), .O(new_n137_));
  nand3  g93(.a(x26), .b(new_n75_), .c(new_n128_), .O(new_n138_));
  inv1   g94(.a(new_n138_), .O(new_n139_));
  oai21  g95(.a(new_n139_), .b(new_n137_), .c(x09), .O(new_n140_));
  oai21  g96(.a(new_n140_), .b(x08), .c(new_n68_), .O(z16));
endmodule
