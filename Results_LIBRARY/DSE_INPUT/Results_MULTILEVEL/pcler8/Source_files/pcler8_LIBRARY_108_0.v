...
module FAU ( 
  ...
  aoi21  g65(.a(new_n86_), .b(x24), .c(new_n105_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(x22), .c(x21), .d(x20), .O(new_n111_));
  nand3  g67(.a(x23), .b(x22), .c(x21), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n93_), .c(x24), .O(new_n113_));
  oai21  g69(.a(new_n111_), .b(new_n78_), .c(new_n113_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n64_), .O(z14));
  ...
  nor2   g77(.a(new_n105_), .b(new_n71_), .O(new_n122_));
  inv1   g78(.a(new_n117_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(x24), .O(new_n124_));
  ...
  and2   g87(.a(x24), .b(x23), .O(new_n132_));
  nor2   g88(.a(x26), .b(new_n121_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n97_), .c(new_n132_), .d(new_n72_), .O(new_n134_));
