...
module FAU ( 
  ...
  nand3  g28(.a(new_n72_), .b(x26), .c(new_n47_), .O(new_n73_));
  oai21  g29(.a(x26), .b(x19), .c(new_n73_), .O(new_n74_));
  ...
  oai21  g88(.a(new_n132_), .b(new_n71_), .c(x26), .O(new_n133_));
  nor2   g89(.a(new_n98_), .b(new_n89_), .O(new_n134_));
  nor2   g90(.a(new_n116_), .b(new_n107_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n125_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n99_), .c(new_n135_), .d(new_n134_), .O(new_n137_));
  oai21  g93(.a(new_n133_), .b(x10), .c(new_n137_), .O(new_n138_));
  nand3  g94(.a(new_n138_), .b(x09), .c(new_n46_), .O(new_n139_));
