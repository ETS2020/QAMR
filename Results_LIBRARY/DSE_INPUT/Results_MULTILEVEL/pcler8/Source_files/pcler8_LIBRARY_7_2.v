// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:24 2020
...
module FAU ( 
  ...
  nand3  g25(.a(x22), .b(x20), .c(x11), .O(new_n70_));
  ...
  oai21  g42(.a(new_n86_), .b(new_n80_), .c(x19), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(x20), .O(new_n88_));
  nand2  g44(.a(x21), .b(new_n46_), .O(new_n89_));
  ...
  oai21  g50(.a(new_n94_), .b(new_n78_), .c(x22), .O(new_n95_));
  nand3  g51(.a(new_n47_), .b(x20), .c(x19), .O(new_n96_));
  ...
  nand3  g58(.a(new_n102_), .b(new_n101_), .c(x22), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(x23), .O(new_n104_));
  nand3  g60(.a(new_n101_), .b(new_n71_), .c(x22), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n62_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x23), .c(x22), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n100_), .c(x24), .O(new_n111_));
  nand4  g67(.a(new_n101_), .b(new_n72_), .c(x23), .d(x22), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n64_), .O(z14));
  nand3  g71(.a(x22), .b(x20), .c(x19), .O(new_n116_));
  nand2  g72(.a(x26), .b(x17), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x24), .c(x23), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n116_), .c(x25), .O(new_n119_));
  inv1   g75(.a(new_n116_), .O(new_n120_));
  nor2   g76(.a(x25), .b(new_n72_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(x23), .O(new_n122_));
  ...
  nand4  g83(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n127_), .c(x26), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n130_));
