...
module FAU ( 
  ...
  aoi21  g54(.a(new_n98_), .b(new_n95_), .c(x08), .O(new_n99_));
  inv1   g55(.a(x23), .O(new_n100_));
  nor2   g56(.a(new_n100_), .b(new_n71_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(x14), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n99_), .c(new_n47_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n93_), .c(new_n60_), .O(z12));
  ...
  nand4  g64(.a(new_n97_), .b(new_n100_), .c(x22), .d(x21), .O(new_n109_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n94_), .c(x24), .O(new_n115_));
  inv1   g71(.a(x24), .O(new_n116_));
  inv1   g72(.a(new_n94_), .O(new_n117_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n94_), .c(x25), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand4  g81(.a(new_n117_), .b(new_n101_), .c(new_n125_), .d(x24), .O(new_n126_));
  ...
  nor2   g89(.a(new_n116_), .b(new_n100_), .O(new_n134_));
