...
module FAU ( 
  ...
  nand3  g52(.a(new_n96_), .b(new_n71_), .c(x21), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n94_), .c(x10), .O(new_n98_));
  inv1   g54(.a(x23), .O(new_n99_));
  nor2   g55(.a(new_n99_), .b(new_n71_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(x14), .O(new_n101_));
  nor2   g57(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n98_), .c(x09), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(x08), .c(new_n60_), .O(z12));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n95_), .c(x23), .O(new_n107_));
  nand4  g63(.a(new_n96_), .b(new_n99_), .c(x22), .d(x21), .O(new_n108_));
  ...
  inv1   g71(.a(new_n93_), .O(new_n116_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n93_), .c(x25), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  nand4  g80(.a(new_n116_), .b(new_n100_), .c(new_n124_), .d(x24), .O(new_n125_));
  ...
  nor2   g88(.a(new_n115_), .b(new_n99_), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n124_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n96_), .c(new_n133_), .d(new_n72_), .O(new_n135_));
