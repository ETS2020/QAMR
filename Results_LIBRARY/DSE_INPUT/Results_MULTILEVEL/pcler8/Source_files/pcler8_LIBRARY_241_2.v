...
module FAU ( 
  ...
  nand3  g29(.a(new_n73_), .b(x25), .c(x24), .O(new_n74_));
  ...
  nand4  g50(.a(x25), .b(x24), .c(x23), .d(x14), .O(new_n95_));
  ...
  nand3  g57(.a(x25), .b(x24), .c(x15), .O(new_n102_));
  ...
  oai21  g63(.a(new_n48_), .b(new_n62_), .c(new_n107_), .O(z13));
  ...
  nand3  g75(.a(x20), .b(x19), .c(new_n119_), .O(new_n120_));
  nand4  g76(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n120_), .c(x25), .O(new_n122_));
  nand4  g78(.a(new_n114_), .b(new_n73_), .c(new_n45_), .d(x24), .O(new_n123_));
  ...
  oai21  g82(.a(new_n113_), .b(x18), .c(x26), .O(new_n127_));
  nand4  g83(.a(new_n114_), .b(x25), .c(x23), .d(x22), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(x24), .O(new_n129_));
