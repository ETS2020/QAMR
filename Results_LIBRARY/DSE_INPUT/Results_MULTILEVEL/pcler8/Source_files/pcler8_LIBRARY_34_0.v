...
module FAU ( 
  ...
  inv1   g35(.a(new_n74_), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(new_n72_), .c(new_n79_), .O(new_n81_));
  nand2  g37(.a(x20), .b(new_n78_), .O(new_n82_));
  oai21  g38(.a(new_n81_), .b(new_n78_), .c(new_n82_), .O(new_n83_));
  nand4  g39(.a(new_n83_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n84_));
  ...
  oai21  g44(.a(new_n88_), .b(new_n78_), .c(x21), .O(new_n89_));
  ...
  oai21  g65(.a(new_n46_), .b(new_n62_), .c(new_n109_), .O(z13));
  ...
  nand4  g74(.a(new_n118_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n119_));
  oai21  g75(.a(new_n46_), .b(new_n64_), .c(new_n119_), .O(z14));
  ...
  nor2   g80(.a(new_n106_), .b(new_n71_), .O(new_n125_));
  ...
  nand4  g91(.a(new_n135_), .b(new_n98_), .c(new_n134_), .d(new_n72_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  oai21  g94(.a(new_n46_), .b(new_n68_), .c(new_n138_), .O(z16));
endmodule
