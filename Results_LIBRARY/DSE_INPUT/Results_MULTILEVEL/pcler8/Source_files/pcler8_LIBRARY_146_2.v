...
module FAU ( 
  ...
  aoi21  g77(.a(new_n119_), .b(x20), .c(new_n121_), .O(new_n122_));
  nand2  g78(.a(x25), .b(new_n78_), .O(new_n123_));
  oai21  g79(.a(new_n122_), .b(new_n78_), .c(new_n123_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n66_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x20), .b(x19), .c(new_n127_), .O(new_n128_));
  nand4  g84(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  nand4  g86(.a(new_n113_), .b(new_n73_), .c(new_n45_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n133_));
  oai21  g89(.a(new_n48_), .b(new_n68_), .c(new_n133_), .O(z16));
endmodule
