...
module FAU ( 
  ...
  oai21  g04(.a(x15), .b(x14), .c(x26), .O(new_n49_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n73_), .c(new_n102_), .O(new_n105_));
  ...
  oai21  g64(.a(new_n93_), .b(new_n108_), .c(x23), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(x22), .c(x21), .d(x20), .O(new_n110_));
  nand3  g66(.a(new_n74_), .b(x20), .c(x19), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n112_));
  oai21  g68(.a(new_n110_), .b(new_n91_), .c(new_n112_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n45_), .c(x09), .d(new_n56_), .O(new_n114_));
  oai21  g70(.a(new_n56_), .b(new_n64_), .c(new_n114_), .O(z13));
  nand2  g71(.a(new_n79_), .b(x16), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x23), .c(x22), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n103_), .c(x24), .O(new_n118_));
  nand4  g74(.a(new_n104_), .b(new_n47_), .c(x23), .d(x22), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n45_), .c(x09), .d(new_n56_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n66_), .O(z14));
  nor2   g78(.a(new_n76_), .b(new_n73_), .O(new_n123_));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n123_), .c(x24), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n103_), .c(x25), .O(new_n126_));
  nand4  g82(.a(new_n104_), .b(new_n123_), .c(new_n48_), .d(x24), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n45_), .c(x09), .d(new_n56_), .O(new_n129_));
  oai21  g85(.a(new_n56_), .b(new_n68_), .c(new_n129_), .O(z15));
  inv1   g86(.a(x18), .O(new_n131_));
  nand4  g87(.a(x21), .b(x20), .c(x19), .d(new_n131_), .O(new_n132_));
  nand3  g88(.a(new_n123_), .b(x25), .c(x24), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n132_), .c(x26), .O(new_n134_));
  nand3  g90(.a(new_n77_), .b(new_n78_), .c(x25), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n111_), .c(new_n134_), .O(new_n136_));
