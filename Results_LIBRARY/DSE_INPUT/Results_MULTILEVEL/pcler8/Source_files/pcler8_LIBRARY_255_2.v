...
module FAU ( 
  ...
  nand4  g29(.a(new_n73_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n74_));
  oai21  g30(.a(new_n46_), .b(new_n54_), .c(new_n74_), .O(z09));
  inv1   g31(.a(x19), .O(new_n76_));
  nand3  g32(.a(x22), .b(x21), .c(x12), .O(new_n77_));
  oai21  g33(.a(new_n77_), .b(new_n72_), .c(x19), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(x20), .O(new_n79_));
  oai21  g35(.a(x20), .b(new_n76_), .c(new_n79_), .O(new_n80_));
  nand4  g36(.a(new_n80_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n56_), .O(z10));
  inv1   g38(.a(x02), .O(new_n83_));
  ...
  oai21  g42(.a(new_n86_), .b(new_n76_), .c(x21), .O(new_n87_));
  nand3  g43(.a(new_n68_), .b(x20), .c(x19), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n83_), .O(z11));
  ...
  oai21  g73(.a(new_n46_), .b(new_n62_), .c(new_n117_), .O(z14));
  ...
  nor2   g78(.a(new_n104_), .b(new_n69_), .O(new_n123_));
  ...
  oai21  g82(.a(new_n46_), .b(new_n64_), .c(new_n126_), .O(z15));
  ...
  nand4  g89(.a(new_n133_), .b(new_n96_), .c(new_n132_), .d(new_n70_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n136_));
  oai21  g92(.a(new_n46_), .b(new_n66_), .c(new_n136_), .O(z16));
  buf1   g93(.a(x02), .O(z03));
endmodule
