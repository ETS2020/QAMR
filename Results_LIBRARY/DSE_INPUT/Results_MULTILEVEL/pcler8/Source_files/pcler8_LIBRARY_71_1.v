...
module FAU ( 
  ...
  nor2   g27(.a(new_n45_), .b(new_n71_), .O(new_n72_));
  nand3  g28(.a(new_n72_), .b(x24), .c(x22), .O(new_n73_));
  oai21  g29(.a(new_n73_), .b(new_n70_), .c(x19), .O(new_n74_));
  nand4  g30(.a(new_n74_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n75_));
  ...
  oai21  g41(.a(new_n85_), .b(new_n79_), .c(x20), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(new_n77_), .c(x21), .O(new_n87_));
  nand3  g43(.a(new_n47_), .b(x20), .c(x19), .O(new_n88_));
  ...
  nand4  g47(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(x21), .c(x20), .d(x19), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x22), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nor2   g51(.a(new_n46_), .b(new_n77_), .O(new_n96_));
  ...
  nand3  g60(.a(new_n72_), .b(x24), .c(x15), .O(new_n105_));
  ...
  nor2   g69(.a(x24), .b(new_n103_), .O(new_n114_));
  ...
  nor2   g77(.a(new_n103_), .b(new_n95_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n113_), .c(new_n71_), .d(x24), .O(new_n123_));
  ...
  nand4  g84(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  inv1   g86(.a(new_n101_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n71_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n131_), .c(x24), .d(x23), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n135_));
  oai21  g91(.a(new_n48_), .b(new_n68_), .c(new_n135_), .O(z16));
endmodule
