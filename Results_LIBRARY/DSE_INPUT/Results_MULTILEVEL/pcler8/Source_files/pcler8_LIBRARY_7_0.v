...
module FAU ( 
  ...
  oai21  g26(.a(x21), .b(x20), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g32(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(new_n77_));
  ...
  oai21  g38(.a(x20), .b(new_n70_), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g42(.a(new_n72_), .b(new_n86_), .c(x19), .O(new_n87_));
  ...
  nand2  g47(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  ...
  oai21  g52(.a(new_n96_), .b(new_n89_), .c(x21), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n95_), .c(x22), .O(new_n98_));
  inv1   g54(.a(new_n95_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n73_), .c(x21), .O(new_n100_));
  ...
  nor2   g81(.a(new_n107_), .b(new_n73_), .O(new_n126_));
  ...
  nor2   g90(.a(new_n116_), .b(new_n107_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n125_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n99_), .c(new_n135_), .d(new_n74_), .O(new_n137_));
