// Benchmark "FAU" written by ABC on Mon Jul 27 18:45:38 2020
...
module FAU ( 
  ...
  oai21  g32(.a(x20), .b(new_n70_), .c(new_n76_), .O(new_n77_));
  ...
  oai21  g38(.a(new_n82_), .b(new_n70_), .c(x21), .O(new_n83_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n107_), .c(x24), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  inv1   g67(.a(new_n107_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n111_), .c(x23), .d(x22), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  oai21  g71(.a(new_n46_), .b(new_n64_), .c(new_n115_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(x24), .c(x23), .d(x22), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n107_), .c(x25), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nor2   g76(.a(new_n102_), .b(new_n93_), .O(new_n121_));
  nand4  g77(.a(new_n112_), .b(new_n121_), .c(new_n120_), .d(x24), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  oai21  g80(.a(new_n46_), .b(new_n66_), .c(new_n124_), .O(z15));
  inv1   g81(.a(x18), .O(new_n126_));
  nand4  g82(.a(x21), .b(x20), .c(x19), .d(new_n126_), .O(new_n127_));
  nand4  g83(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n127_), .c(x26), .O(new_n129_));
  nor2   g85(.a(new_n93_), .b(new_n84_), .O(new_n130_));
  nor2   g86(.a(new_n111_), .b(new_n102_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n120_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n94_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n129_), .O(new_n134_));
