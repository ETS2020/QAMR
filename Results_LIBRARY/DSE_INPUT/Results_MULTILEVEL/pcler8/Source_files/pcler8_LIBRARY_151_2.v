...
module FAU ( 
  ...
  nand3  g54(.a(new_n98_), .b(x23), .c(x14), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n97_), .c(new_n94_), .O(new_n100_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n95_), .c(x23), .O(new_n105_));
  ...
  inv1   g70(.a(new_n93_), .O(new_n115_));
  ...
  oai21  g77(.a(new_n121_), .b(new_n93_), .c(x25), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nor2   g79(.a(new_n106_), .b(new_n71_), .O(new_n124_));
  ...
  nor2   g88(.a(new_n114_), .b(new_n106_), .O(new_n133_));
