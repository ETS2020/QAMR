...
module FAU ( 
  ...
  nand4  g50(.a(x26), .b(x25), .c(x23), .d(x14), .O(new_n95_));
  ...
  nand3  g57(.a(x26), .b(x25), .c(x15), .O(new_n102_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n93_), .c(x23), .O(new_n111_));
  nand2  g67(.a(x24), .b(new_n72_), .O(new_n112_));
