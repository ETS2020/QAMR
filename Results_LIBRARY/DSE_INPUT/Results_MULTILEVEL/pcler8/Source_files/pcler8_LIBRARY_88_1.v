...
module FAU ( 
  ...
  oai21  g59(.a(new_n103_), .b(new_n101_), .c(x23), .O(new_n104_));
  inv1   g60(.a(new_n101_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n93_), .c(x22), .d(x21), .O(new_n106_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n96_), .c(x24), .O(new_n112_));
  inv1   g68(.a(x24), .O(new_n113_));
  nand4  g69(.a(new_n97_), .b(new_n113_), .c(x23), .d(x22), .O(new_n114_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n96_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nor2   g77(.a(new_n93_), .b(new_n71_), .O(new_n122_));
  nand4  g78(.a(new_n97_), .b(new_n122_), .c(new_n121_), .d(x24), .O(new_n123_));
  ...
  nor2   g86(.a(new_n113_), .b(new_n93_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n121_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n105_), .c(new_n131_), .d(new_n72_), .O(new_n133_));
