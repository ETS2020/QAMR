...
module FAU ( 
  ...
  nand3  g33(.a(x23), .b(x22), .c(x12), .O(new_n78_));
  ...
  nand3  g59(.a(new_n100_), .b(new_n71_), .c(x22), .O(new_n104_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n72_), .c(x23), .d(x22), .O(new_n111_));
  ...
  nor2   g75(.a(x25), .b(new_n72_), .O(new_n120_));
  ...
  nand4  g84(.a(new_n119_), .b(new_n73_), .c(new_n45_), .d(x25), .O(new_n129_));
