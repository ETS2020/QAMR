...
module FAU ( 
  ...
  nand2  g19(.a(new_n64_), .b(new_n46_), .O(z09));
  nand4  g20(.a(x20), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n66_));
  nand2  g21(.a(new_n66_), .b(new_n48_), .O(z10));
  nand4  g22(.a(x21), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n68_));
  nand2  g23(.a(new_n68_), .b(new_n50_), .O(z11));
  nand4  g24(.a(x22), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n70_));
  nand2  g25(.a(new_n70_), .b(new_n52_), .O(z12));
  nand4  g26(.a(x23), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n72_));
  nand2  g27(.a(new_n72_), .b(new_n54_), .O(z13));
  nand4  g28(.a(x24), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n56_), .O(z14));
  nand4  g30(.a(x25), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n58_), .O(z15));
  nand4  g32(.a(x26), .b(new_n63_), .c(x09), .d(new_n62_), .O(new_n78_));
  nand2  g33(.a(new_n78_), .b(new_n60_), .O(z16));
  zero   g34(.O(z00));
endmodule
