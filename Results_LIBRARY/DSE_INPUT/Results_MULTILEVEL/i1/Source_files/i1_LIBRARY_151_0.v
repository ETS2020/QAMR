...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(new_n47_), .c(new_n46_), .d(new_n55_), .O(new_n58_));
  oai21  g17(.a(new_n58_), .b(new_n54_), .c(new_n48_), .O(new_n59_));
  nand2  g18(.a(x07), .b(x00), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(new_n59_), .c(new_n42_), .O(z02));
  or2    g20(.a(x21), .b(x20), .O(z04));
  inv1   g21(.a(x10), .O(new_n63_));
  nand4  g22(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n64_));
  nor2   g23(.a(new_n42_), .b(x08), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z05));
  nor2   g26(.a(new_n58_), .b(new_n54_), .O(new_n68_));
  nand2  g27(.a(new_n56_), .b(x08), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n47_), .c(new_n46_), .d(new_n55_), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n68_), .c(new_n48_), .d(x00), .O(new_n73_));
  and2   g32(.a(new_n73_), .b(x19), .O(z06));
