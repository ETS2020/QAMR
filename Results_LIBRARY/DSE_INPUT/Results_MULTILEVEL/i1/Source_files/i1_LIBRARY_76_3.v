// Benchmark "FAU" written by ABC on Mon Jul 27 17:44:51 2020
...
module FAU ( 
  ...
  nand4  g28(.a(new_n65_), .b(x19), .c(new_n51_), .d(new_n50_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n63_), .c(new_n69_), .O(z05));
  nand2  g30(.a(new_n51_), .b(x07), .O(new_n72_));
