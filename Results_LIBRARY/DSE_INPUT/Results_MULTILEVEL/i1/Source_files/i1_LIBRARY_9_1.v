// Benchmark "FAU" written by ABC on Mon Jul 27 17:44:39 2020
...
module FAU ( 
  ...
  nand4  g10(.a(new_n51_), .b(new_n50_), .c(new_n44_), .d(new_n43_), .O(new_n52_));
  ...
  nand4  g15(.a(new_n56_), .b(new_n55_), .c(new_n54_), .d(new_n45_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(x00), .O(new_n58_));
  nand4  g17(.a(new_n51_), .b(new_n50_), .c(x08), .d(new_n43_), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(z02));
  or2    g19(.a(x21), .b(x20), .O(z04));
  inv1   g20(.a(x10), .O(new_n62_));
  nand4  g21(.a(new_n51_), .b(x19), .c(new_n44_), .d(new_n43_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n49_), .c(new_n62_), .O(z05));
  inv1   g23(.a(x05), .O(new_n65_));
  inv1   g24(.a(x06), .O(new_n66_));
  nand4  g25(.a(new_n43_), .b(new_n66_), .c(new_n65_), .d(new_n48_), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(new_n68_));
  nand4  g27(.a(new_n68_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n69_));
  inv1   g28(.a(x00), .O(new_n70_));
  nor2   g29(.a(new_n57_), .b(new_n70_), .O(new_n71_));
