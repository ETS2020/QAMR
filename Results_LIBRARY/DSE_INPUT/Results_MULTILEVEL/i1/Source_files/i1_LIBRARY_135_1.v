// Benchmark "FAU" written by ABC on Mon Jul 27 17:45:01 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n74_, new_n75_, new_n76_, new_n80_, new_n81_, new_n83_, new_n85_,
  ...
  nand4  g19(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(new_n62_));
  nor2   g21(.a(x06), .b(x05), .O(new_n63_));
  nand4  g22(.a(new_n63_), .b(new_n62_), .c(new_n60_), .d(new_n48_), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n59_), .c(new_n42_), .O(z02));
  or2    g24(.a(x21), .b(x20), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  inv1   g26(.a(x08), .O(new_n68_));
  nand4  g27(.a(new_n63_), .b(x19), .c(new_n68_), .d(new_n48_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n61_), .c(new_n67_), .O(z05));
  nor2   g29(.a(x07), .b(x06), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n46_), .c(new_n55_), .d(new_n45_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n44_), .c(new_n43_), .O(new_n74_));
  inv1   g33(.a(x00), .O(new_n75_));
  nor2   g34(.a(new_n58_), .b(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n42_), .O(z06));
  and2   g36(.a(x24), .b(x18), .O(z07));
  and2   g37(.a(x24), .b(x11), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  inv1   g39(.a(x22), .O(new_n81_));
  nor3   g40(.a(x24), .b(new_n81_), .c(new_n80_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  nor3   g42(.a(x24), .b(new_n81_), .c(new_n83_), .O(z11));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(x24), .b(new_n85_), .c(new_n80_), .O(z12));
  nor3   g45(.a(x24), .b(new_n85_), .c(new_n83_), .O(z13));
  ...
  buf1   g51(.a(x00), .O(z00));
  buf1   g52(.a(x20), .O(z03));
  buf1   g53(.a(x11), .O(z08));
endmodule
