...
module FAU ( 
  ...
  nor2   g23(.a(x09), .b(new_n51_), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n48_), .d(new_n47_), .O(new_n66_));
  ...
  oai21  g30(.a(new_n71_), .b(new_n63_), .c(new_n69_), .O(z05));
  nand2  g31(.a(new_n51_), .b(x06), .O(new_n73_));
