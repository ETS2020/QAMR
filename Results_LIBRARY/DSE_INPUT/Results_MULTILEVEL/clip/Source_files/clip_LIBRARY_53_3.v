...
module FAU ( 
  ...
  nor2   g32(.a(new_n34_), .b(new_n16_), .O(new_n47_));
  nor2   g33(.a(new_n47_), .b(new_n17_), .O(new_n48_));
  nor2   g34(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  aoi21  g35(.a(x7), .b(x4), .c(x2), .O(new_n50_));
  nor2   g36(.a(x7), .b(x1), .O(new_n51_));
  oai21  g37(.a(new_n51_), .b(new_n50_), .c(new_n16_), .O(new_n52_));
  oai21  g38(.a(new_n47_), .b(new_n32_), .c(new_n31_), .O(new_n53_));
  nand2  g39(.a(new_n47_), .b(new_n32_), .O(new_n54_));
  nand3  g40(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n55_));
  oai22  g41(.a(new_n55_), .b(new_n49_), .c(new_n45_), .d(new_n43_), .O(new_n56_));
  ...
  nand2  g47(.a(new_n61_), .b(new_n46_), .O(new_n62_));
  aoi21  g48(.a(new_n62_), .b(new_n59_), .c(new_n31_), .O(new_n63_));
  ...
  nand3  g52(.a(new_n66_), .b(new_n56_), .c(new_n28_), .O(z2));
  oai21  g53(.a(new_n43_), .b(new_n16_), .c(new_n15_), .O(new_n68_));
  nand2  g54(.a(x8), .b(x6), .O(new_n69_));
  aoi21  g55(.a(new_n69_), .b(new_n24_), .c(new_n46_), .O(new_n70_));
  nor2   g56(.a(new_n69_), .b(x1), .O(new_n71_));
  oai21  g57(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(new_n72_));
  oai21  g58(.a(x8), .b(new_n15_), .c(x3), .O(new_n73_));
  nand2  g59(.a(new_n73_), .b(new_n31_), .O(new_n74_));
  nand2  g60(.a(x7), .b(x2), .O(new_n75_));
  nand3  g61(.a(new_n75_), .b(new_n26_), .c(x5), .O(new_n76_));
  nand3  g62(.a(new_n44_), .b(x7), .c(x6), .O(new_n77_));
  nand3  g63(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(new_n78_));
  nand2  g64(.a(new_n78_), .b(new_n32_), .O(new_n79_));
  nand2  g65(.a(x2), .b(x1), .O(new_n80_));
  nand3  g66(.a(new_n80_), .b(new_n26_), .c(new_n34_), .O(new_n81_));
  nand2  g67(.a(new_n81_), .b(new_n24_), .O(new_n82_));
  nand4  g68(.a(new_n23_), .b(x7), .c(new_n22_), .d(new_n31_), .O(new_n83_));
  inv1   g69(.a(new_n83_), .O(new_n84_));
  aoi21  g70(.a(new_n82_), .b(x5), .c(new_n84_), .O(new_n85_));
  nand4  g71(.a(new_n85_), .b(new_n79_), .c(new_n72_), .d(new_n68_), .O(new_n86_));
  nand2  g72(.a(new_n86_), .b(x0), .O(new_n87_));
  inv1   g73(.a(x0), .O(new_n88_));
  oai21  g74(.a(new_n19_), .b(new_n31_), .c(new_n20_), .O(new_n89_));
  oai21  g75(.a(new_n23_), .b(x6), .c(new_n44_), .O(new_n90_));
  nand2  g76(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g77(.a(new_n33_), .b(new_n46_), .c(x1), .O(new_n92_));
  aoi21  g78(.a(new_n92_), .b(new_n35_), .c(new_n43_), .O(new_n93_));
  oai21  g79(.a(new_n93_), .b(new_n45_), .c(x6), .O(new_n94_));
  nand3  g80(.a(x8), .b(new_n16_), .c(x3), .O(new_n95_));
  nand3  g81(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(new_n96_));
  nand2  g82(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  nand2  g83(.a(new_n97_), .b(new_n87_), .O(z3));
  nand2  g84(.a(new_n94_), .b(new_n15_), .O(new_n99_));
  nand2  g85(.a(new_n99_), .b(new_n88_), .O(new_n100_));
  oai21  g86(.a(x7), .b(new_n88_), .c(x4), .O(new_n101_));
  nand2  g87(.a(new_n101_), .b(new_n31_), .O(new_n102_));
  nand2  g88(.a(new_n18_), .b(x8), .O(new_n103_));
  oai21  g89(.a(new_n103_), .b(new_n50_), .c(x0), .O(new_n104_));
  aoi21  g90(.a(new_n104_), .b(new_n102_), .c(x3), .O(new_n105_));
  aoi21  g91(.a(new_n80_), .b(new_n20_), .c(new_n17_), .O(new_n106_));
  nor3   g92(.a(new_n106_), .b(x8), .c(new_n88_), .O(new_n107_));
  oai21  g93(.a(new_n107_), .b(new_n105_), .c(x5), .O(new_n108_));
  nand2  g94(.a(new_n108_), .b(new_n100_), .O(z4));
endmodule
