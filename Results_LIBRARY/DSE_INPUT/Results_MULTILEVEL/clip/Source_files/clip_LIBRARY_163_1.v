...
module FAU ( 
  ...
  nand2  g131(.a(new_n47_), .b(x3), .O(new_n146_));
  nand2  g132(.a(x8), .b(new_n16_), .O(new_n147_));
  aoi21  g133(.a(new_n147_), .b(new_n146_), .c(new_n42_), .O(new_n148_));
  nand4  g134(.a(new_n148_), .b(new_n17_), .c(x2), .d(x1), .O(new_n149_));
  nand3  g135(.a(new_n149_), .b(new_n145_), .c(new_n133_), .O(z3));
  nand3  g136(.a(new_n47_), .b(new_n33_), .c(x1), .O(new_n151_));
  oai21  g137(.a(x5), .b(new_n47_), .c(new_n151_), .O(new_n152_));
  nand4  g138(.a(new_n152_), .b(new_n37_), .c(x6), .d(new_n15_), .O(new_n153_));
  and2   g139(.a(new_n128_), .b(new_n65_), .O(new_n154_));
  nand4  g140(.a(new_n154_), .b(new_n17_), .c(x5), .d(x0), .O(new_n155_));
  nand2  g141(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g142(.a(new_n156_), .b(new_n42_), .O(new_n157_));
  nand4  g143(.a(new_n37_), .b(x4), .c(new_n33_), .d(x1), .O(new_n158_));
  aoi21  g144(.a(new_n158_), .b(new_n92_), .c(new_n17_), .O(new_n159_));
  oai21  g145(.a(new_n159_), .b(x5), .c(new_n15_), .O(new_n160_));
  nand2  g146(.a(new_n23_), .b(x0), .O(new_n161_));
  oai21  g147(.a(new_n161_), .b(x8), .c(new_n17_), .O(new_n162_));
  nand2  g148(.a(new_n162_), .b(x5), .O(new_n163_));
  nand3  g149(.a(new_n163_), .b(new_n160_), .c(new_n157_), .O(z4));
endmodule
