// Benchmark "FAU" written by ABC on Tue Jul 28 06:46:57 2020
...
module FAU ( 
  ...
  nand4  g152(.a(new_n304_), .b(x094), .c(x038), .d(new_n287_), .O(new_n309_));
  ...
  aoi21  g302(.a(new_n316_), .b(new_n286_), .c(new_n459_), .O(new_n460_));
  inv1   g303(.a(x062), .O(new_n461_));
  inv1   g304(.a(x102), .O(new_n462_));
  oai22  g305(.a(new_n304_), .b(new_n302_), .c(new_n462_), .d(x038), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n461_), .O(new_n464_));
  oai22  g307(.a(x118), .b(x110), .c(new_n321_), .d(new_n299_), .O(new_n465_));
  nand2  g308(.a(new_n304_), .b(new_n462_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n302_), .c(new_n321_), .O(new_n467_));
  nor2   g310(.a(new_n304_), .b(x110), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n288_), .c(x086), .O(new_n469_));
  nand4  g312(.a(new_n469_), .b(new_n467_), .c(new_n465_), .d(new_n464_), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(new_n460_), .c(new_n285_), .O(new_n471_));
  nand4  g314(.a(x126), .b(new_n295_), .c(x038), .d(new_n287_), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n471_), .c(x078), .O(new_n473_));
  nand3  g316(.a(x086), .b(new_n299_), .c(new_n287_), .O(new_n474_));
  inv1   g317(.a(new_n474_), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n473_), .c(x006), .O(new_n476_));
  ...
  aoi21  g323(.a(new_n480_), .b(new_n287_), .c(new_n477_), .O(new_n481_));
  nor2   g324(.a(new_n286_), .b(x022), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n324_), .c(x070), .O(new_n483_));
  nand4  g326(.a(new_n466_), .b(new_n458_), .c(new_n290_), .d(x030), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n483_), .c(x078), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n481_), .c(new_n285_), .O(new_n486_));
  oai21  g329(.a(new_n459_), .b(new_n286_), .c(new_n316_), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(new_n320_), .c(x038), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n486_), .O(new_n489_));
  ...
  aoi21  g336(.a(new_n489_), .b(new_n312_), .c(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n476_), .c(x046), .O(z14));
  zero   g338(.O(z07));
  zero   g339(.O(z15));
  zero   g340(.O(z16));
  zero   g341(.O(z17));
