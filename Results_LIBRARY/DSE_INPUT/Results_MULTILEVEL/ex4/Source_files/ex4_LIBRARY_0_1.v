// Benchmark "FAU" written by ABC on Tue Jul 28 06:46:17 2020
...
module FAU ( 
  ...
  nand3  g073(.a(x093), .b(x061), .c(x029), .O(new_n230_));
  ...
  aoi21  g090(.a(new_n235_), .b(new_n246_), .c(new_n228_), .O(new_n247_));
  oai21  g091(.a(new_n247_), .b(new_n245_), .c(x013), .O(new_n248_));
  inv1   g092(.a(x069), .O(new_n249_));
  nand2  g093(.a(new_n230_), .b(new_n249_), .O(new_n250_));
  nand4  g094(.a(new_n235_), .b(new_n232_), .c(new_n229_), .d(new_n246_), .O(new_n251_));
  aoi21  g095(.a(new_n251_), .b(new_n250_), .c(new_n245_), .O(new_n252_));
  aoi21  g096(.a(new_n248_), .b(new_n237_), .c(new_n252_), .O(new_n253_));
  oai22  g097(.a(new_n253_), .b(new_n241_), .c(x069), .d(x021), .O(new_n254_));
  inv1   g098(.a(x037), .O(new_n255_));
  inv1   g099(.a(x053), .O(new_n256_));
  nand2  g100(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand3  g101(.a(x077), .b(new_n249_), .c(new_n228_), .O(new_n258_));
  nand2  g102(.a(new_n245_), .b(new_n227_), .O(new_n259_));
  nand3  g103(.a(new_n259_), .b(new_n258_), .c(new_n257_), .O(new_n260_));
  aoi21  g104(.a(new_n254_), .b(x053), .c(new_n260_), .O(new_n261_));
  aoi21  g105(.a(new_n261_), .b(new_n244_), .c(new_n225_), .O(z05));
  ...
  oai21  g166(.a(new_n323_), .b(x024), .c(new_n320_), .O(new_n324_));
  ...
  nand4  g183(.a(x120), .b(new_n321_), .c(new_n161_), .d(x008), .O(new_n341_));
  ...
  aoi21  g193(.a(new_n350_), .b(new_n160_), .c(new_n327_), .O(new_n351_));
  inv1   g194(.a(x024), .O(new_n352_));
  nor2   g195(.a(new_n352_), .b(x016), .O(new_n353_));
  oai21  g196(.a(new_n353_), .b(new_n323_), .c(x064), .O(new_n354_));
  inv1   g197(.a(new_n326_), .O(new_n355_));
  nand4  g198(.a(new_n347_), .b(new_n355_), .c(new_n320_), .d(x024), .O(new_n356_));
  aoi21  g199(.a(new_n356_), .b(new_n354_), .c(x072), .O(new_n357_));
  oai21  g200(.a(new_n357_), .b(new_n351_), .c(new_n162_), .O(new_n358_));
  nand2  g201(.a(new_n320_), .b(x024), .O(new_n359_));
  nand3  g202(.a(new_n359_), .b(new_n322_), .c(new_n321_), .O(new_n360_));
  nand3  g203(.a(new_n360_), .b(new_n163_), .c(x032), .O(new_n361_));
  ...
  aoi21  g209(.a(new_n362_), .b(new_n159_), .c(new_n366_), .O(new_n367_));
  ...
  nand2  g239(.a(x093), .b(x061), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(x029), .O(new_n398_));
  aoi21  g241(.a(new_n398_), .b(new_n228_), .c(x085), .O(new_n399_));
  nor2   g242(.a(x069), .b(new_n226_), .O(new_n400_));
  oai22  g243(.a(new_n400_), .b(new_n399_), .c(x117), .d(x109), .O(new_n401_));
  or2    g244(.a(x125), .b(x101), .O(new_n402_));
  nand2  g245(.a(x021), .b(x013), .O(new_n403_));
  nand4  g246(.a(new_n403_), .b(new_n397_), .c(new_n241_), .d(x029), .O(new_n404_));
  nand3  g247(.a(new_n234_), .b(new_n249_), .c(x005), .O(new_n405_));
  nand2  g248(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(new_n402_), .O(new_n407_));
  oai21  g250(.a(new_n235_), .b(x029), .c(new_n403_), .O(new_n408_));
  inv1   g251(.a(x117), .O(new_n409_));
  nor2   g252(.a(new_n409_), .b(x109), .O(new_n410_));
  nor2   g253(.a(x117), .b(x021), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(new_n410_), .c(x125), .O(new_n412_));
  nand3  g255(.a(new_n412_), .b(new_n408_), .c(new_n241_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(x005), .O(new_n414_));
  aoi21  g257(.a(x029), .b(new_n228_), .c(new_n235_), .O(new_n415_));
  nor2   g258(.a(new_n415_), .b(x085), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(x069), .O(new_n417_));
  nand4  g260(.a(new_n417_), .b(new_n414_), .c(new_n407_), .d(new_n401_), .O(new_n418_));
  nand2  g261(.a(new_n418_), .b(new_n256_), .O(new_n419_));
  nand2  g262(.a(x085), .b(x005), .O(new_n420_));
  nand3  g263(.a(new_n241_), .b(x037), .c(x029), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n420_), .c(x013), .O(new_n422_));
  aoi21  g265(.a(new_n416_), .b(x037), .c(new_n422_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n419_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n245_), .O(new_n425_));
  nand2  g268(.a(x037), .b(x013), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(x069), .c(x021), .O(new_n427_));
  nor2   g270(.a(x117), .b(x109), .O(new_n428_));
  nand2  g271(.a(new_n255_), .b(x005), .O(new_n429_));
  nand2  g272(.a(new_n241_), .b(x013), .O(new_n430_));
  aoi21  g273(.a(new_n430_), .b(new_n429_), .c(new_n428_), .O(new_n431_));
  nand4  g274(.a(new_n402_), .b(new_n233_), .c(new_n255_), .d(x005), .O(new_n432_));
  inv1   g275(.a(new_n432_), .O(new_n433_));
  oai21  g276(.a(new_n433_), .b(new_n431_), .c(new_n256_), .O(new_n434_));
  aoi22  g277(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n435_));
  nand3  g278(.a(new_n435_), .b(new_n434_), .c(new_n427_), .O(new_n436_));
  inv1   g279(.a(new_n436_), .O(new_n437_));
  aoi21  g280(.a(new_n437_), .b(new_n425_), .c(x045), .O(z13));
  nand2  g281(.a(x022), .b(x014), .O(new_n439_));
  oai21  g282(.a(new_n304_), .b(x030), .c(new_n439_), .O(new_n440_));
  ...
  nand2  g286(.a(new_n443_), .b(new_n301_), .O(new_n444_));
  oai21  g287(.a(new_n284_), .b(x110), .c(x038), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(x118), .O(new_n446_));
  inv1   g289(.a(x102), .O(new_n447_));
  oai21  g290(.a(new_n447_), .b(x062), .c(new_n274_), .O(new_n448_));
  nand3  g291(.a(x126), .b(new_n275_), .c(new_n268_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n292_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n279_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n446_), .c(new_n444_), .d(new_n440_), .O(new_n452_));
  nand4  g295(.a(x126), .b(new_n282_), .c(new_n279_), .d(x014), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n300_), .c(new_n454_), .O(new_n455_));
  nand3  g298(.a(x086), .b(new_n279_), .c(new_n267_), .O(new_n456_));
  oai21  g299(.a(new_n455_), .b(x054), .c(new_n456_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(x006), .O(new_n458_));
  oai21  g301(.a(new_n308_), .b(new_n266_), .c(new_n268_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n300_), .O(new_n460_));
  aoi21  g303(.a(new_n460_), .b(new_n267_), .c(new_n442_), .O(new_n461_));
  nor2   g304(.a(new_n266_), .b(x022), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n304_), .c(x070), .O(new_n463_));
  inv1   g306(.a(new_n441_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n439_), .c(new_n270_), .d(x030), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n463_), .c(x078), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n461_), .c(new_n265_), .O(new_n467_));
  nand2  g310(.a(new_n439_), .b(x030), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n296_), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n300_), .c(x038), .O(new_n470_));
  ...
  aoi21  g318(.a(new_n471_), .b(new_n292_), .c(new_n475_), .O(new_n476_));
