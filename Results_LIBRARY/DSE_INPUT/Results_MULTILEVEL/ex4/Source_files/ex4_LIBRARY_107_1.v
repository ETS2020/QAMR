...
module FAU ( 
  ...
  nand4  g093(.a(new_n245_), .b(x093), .c(x037), .d(new_n229_), .O(new_n250_));
  ...
  oai21  g143(.a(x126), .b(new_n295_), .c(new_n299_), .O(new_n300_));
  nand2  g144(.a(new_n300_), .b(new_n294_), .O(new_n301_));
  inv1   g145(.a(x062), .O(new_n302_));
  oai21  g146(.a(x102), .b(new_n302_), .c(x118), .O(new_n303_));
  inv1   g147(.a(x126), .O(new_n304_));
  nand3  g148(.a(new_n304_), .b(x110), .c(x022), .O(new_n305_));
  ...
  nand4  g274(.a(x125), .b(new_n234_), .c(new_n239_), .d(x013), .O(new_n432_));
