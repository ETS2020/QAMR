// Benchmark "FAU" written by ABC on Tue Jul 28 06:47:21 2020
...
module FAU ( 
  ...
  nand3  g070(.a(x077), .b(new_n226_), .c(new_n225_), .O(new_n227_));
  inv1   g071(.a(x005), .O(new_n228_));
  inv1   g072(.a(x085), .O(new_n229_));
  nand3  g073(.a(new_n229_), .b(x013), .c(new_n228_), .O(new_n230_));
  ...
  oai21  g078(.a(new_n229_), .b(new_n234_), .c(x053), .O(new_n235_));
  nand2  g079(.a(new_n235_), .b(new_n233_), .O(new_n236_));
  inv1   g080(.a(x029), .O(new_n237_));
  and2   g081(.a(x125), .b(x101), .O(new_n238_));
  nor2   g082(.a(x021), .b(x013), .O(new_n239_));
  and2   g083(.a(x117), .b(x109), .O(new_n240_));
  oai21  g084(.a(new_n239_), .b(new_n238_), .c(new_n240_), .O(new_n241_));
  nand3  g085(.a(new_n241_), .b(x093), .c(new_n237_), .O(new_n242_));
  inv1   g086(.a(new_n240_), .O(new_n243_));
  aoi21  g087(.a(new_n243_), .b(new_n225_), .c(new_n226_), .O(new_n244_));
  aoi21  g088(.a(new_n244_), .b(new_n242_), .c(new_n234_), .O(new_n245_));
  nor2   g089(.a(new_n240_), .b(x013), .O(new_n246_));
  oai21  g090(.a(new_n246_), .b(new_n245_), .c(x085), .O(new_n247_));
  oai22  g091(.a(new_n234_), .b(x005), .c(x069), .d(x021), .O(new_n248_));
  inv1   g092(.a(x101), .O(new_n249_));
  inv1   g093(.a(x125), .O(new_n250_));
  oai21  g094(.a(new_n250_), .b(new_n249_), .c(x093), .O(new_n251_));
  nor2   g095(.a(new_n229_), .b(x021), .O(new_n252_));
  aoi21  g096(.a(new_n252_), .b(new_n251_), .c(new_n234_), .O(new_n253_));
  aoi22  g097(.a(new_n253_), .b(new_n228_), .c(new_n248_), .d(x013), .O(new_n254_));
  nand2  g098(.a(new_n254_), .b(new_n247_), .O(new_n255_));
  nand2  g099(.a(new_n255_), .b(x053), .O(new_n256_));
  inv1   g100(.a(x013), .O(new_n257_));
  nand2  g101(.a(new_n234_), .b(new_n257_), .O(new_n258_));
  nand4  g102(.a(new_n258_), .b(new_n256_), .c(new_n236_), .d(new_n232_), .O(new_n259_));
  and2   g103(.a(new_n259_), .b(x045), .O(z05));
  inv1   g104(.a(x046), .O(new_n261_));
  inv1   g105(.a(x006), .O(new_n262_));
  inv1   g106(.a(x054), .O(new_n263_));
  inv1   g107(.a(x030), .O(new_n264_));
  inv1   g108(.a(x014), .O(new_n265_));
  inv1   g109(.a(x022), .O(new_n266_));
  nand2  g110(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  inv1   g111(.a(x062), .O(new_n268_));
  inv1   g112(.a(x094), .O(new_n269_));
  nor2   g113(.a(new_n269_), .b(new_n268_), .O(new_n270_));
  inv1   g114(.a(new_n270_), .O(new_n271_));
  oai21  g115(.a(new_n271_), .b(new_n264_), .c(new_n267_), .O(new_n272_));
  ...
  nand2  g122(.a(new_n278_), .b(x070), .O(new_n279_));
  inv1   g123(.a(x038), .O(new_n280_));
  oai21  g124(.a(x126), .b(new_n275_), .c(new_n280_), .O(new_n281_));
  nand2  g125(.a(new_n281_), .b(new_n276_), .O(new_n282_));
  oai21  g126(.a(x102), .b(new_n268_), .c(x110), .O(new_n283_));
  ...
  nand4  g131(.a(new_n287_), .b(new_n282_), .c(new_n279_), .d(new_n272_), .O(new_n288_));
  nand4  g132(.a(new_n284_), .b(x062), .c(x038), .d(new_n265_), .O(new_n289_));
  ...
  oai21  g137(.a(new_n291_), .b(new_n263_), .c(new_n293_), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(new_n262_), .O(new_n295_));
  ...
  aoi21  g142(.a(new_n298_), .b(x014), .c(new_n277_), .O(new_n299_));
  inv1   g143(.a(x078), .O(new_n300_));
  inv1   g144(.a(x070), .O(new_n301_));
  nor2   g145(.a(x030), .b(new_n266_), .O(new_n302_));
  oai21  g146(.a(new_n302_), .b(new_n271_), .c(new_n301_), .O(new_n303_));
  inv1   g147(.a(new_n296_), .O(new_n304_));
  nand4  g148(.a(new_n304_), .b(new_n273_), .c(new_n267_), .d(new_n264_), .O(new_n305_));
  aoi21  g149(.a(new_n305_), .b(new_n303_), .c(new_n300_), .O(new_n306_));
  oai21  g150(.a(new_n306_), .b(new_n299_), .c(x054), .O(new_n307_));
  nand2  g151(.a(new_n267_), .b(new_n264_), .O(new_n308_));
  nand2  g152(.a(new_n308_), .b(new_n270_), .O(new_n309_));
  nand3  g153(.a(new_n309_), .b(x078), .c(new_n280_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n307_), .O(new_n311_));
  oai22  g155(.a(new_n300_), .b(new_n280_), .c(new_n263_), .d(new_n265_), .O(new_n312_));
  nand3  g156(.a(new_n312_), .b(new_n301_), .c(new_n266_), .O(new_n313_));
  aoi22  g157(.a(new_n300_), .b(new_n265_), .c(new_n263_), .d(new_n280_), .O(new_n314_));
  nand2  g158(.a(new_n314_), .b(new_n313_), .O(new_n315_));
  aoi21  g159(.a(new_n311_), .b(x086), .c(new_n315_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n295_), .c(new_n261_), .O(z06));
  nand2  g161(.a(x016), .b(x008), .O(new_n319_));
  inv1   g162(.a(x056), .O(new_n320_));
  inv1   g163(.a(x088), .O(new_n321_));
  nand2  g164(.a(new_n321_), .b(new_n320_), .O(new_n322_));
  oai21  g165(.a(new_n322_), .b(x024), .c(new_n319_), .O(new_n323_));
  inv1   g166(.a(x064), .O(new_n324_));
  inv1   g167(.a(x096), .O(new_n325_));
  inv1   g168(.a(x120), .O(new_n326_));
  nand2  g169(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand2  g170(.a(new_n327_), .b(new_n321_), .O(new_n328_));
  ...
  oai21  g174(.a(new_n326_), .b(x104), .c(x032), .O(new_n332_));
  nand2  g175(.a(new_n332_), .b(x112), .O(new_n333_));
  inv1   g176(.a(x104), .O(new_n334_));
  oai21  g177(.a(new_n325_), .b(x056), .c(new_n334_), .O(new_n335_));
  ...
  nand4  g182(.a(new_n339_), .b(new_n333_), .c(new_n331_), .d(new_n323_), .O(new_n340_));
  nand4  g183(.a(x120), .b(new_n320_), .c(new_n161_), .d(x008), .O(new_n341_));
  inv1   g184(.a(new_n341_), .O(new_n342_));
  aoi21  g185(.a(new_n340_), .b(new_n163_), .c(new_n342_), .O(new_n343_));
  nand3  g186(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n344_));
  oai21  g187(.a(new_n343_), .b(x048), .c(new_n344_), .O(new_n345_));
  nand2  g188(.a(new_n345_), .b(x000), .O(new_n346_));
  nand2  g189(.a(x088), .b(x056), .O(new_n347_));
  nand2  g190(.a(new_n347_), .b(x024), .O(new_n348_));
  nand2  g191(.a(new_n348_), .b(new_n166_), .O(new_n349_));
  nand2  g192(.a(new_n349_), .b(new_n163_), .O(new_n350_));
  aoi21  g193(.a(new_n350_), .b(new_n160_), .c(new_n329_), .O(new_n351_));
  inv1   g194(.a(x024), .O(new_n352_));
  nor2   g195(.a(new_n352_), .b(x016), .O(new_n353_));
  oai21  g196(.a(new_n353_), .b(new_n322_), .c(x064), .O(new_n354_));
  nand4  g197(.a(new_n347_), .b(new_n327_), .c(new_n319_), .d(x024), .O(new_n355_));
  aoi21  g198(.a(new_n355_), .b(new_n354_), .c(x072), .O(new_n356_));
  oai21  g199(.a(new_n356_), .b(new_n351_), .c(new_n162_), .O(new_n357_));
  nand2  g200(.a(new_n319_), .b(x024), .O(new_n358_));
  nand3  g201(.a(new_n358_), .b(new_n321_), .c(new_n320_), .O(new_n359_));
  nand3  g202(.a(new_n359_), .b(new_n163_), .c(x032), .O(new_n360_));
  ...
  aoi21  g208(.a(new_n361_), .b(new_n159_), .c(new_n365_), .O(new_n366_));
  aoi21  g209(.a(new_n366_), .b(new_n346_), .c(x040), .O(z08));
  oai22  g210(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n368_));
  nand3  g211(.a(new_n368_), .b(x081), .c(x001), .O(new_n369_));
  oai22  g212(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n370_));
  nand3  g213(.a(new_n370_), .b(x065), .c(x017), .O(new_n371_));
  aoi22  g214(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n372_));
  nand3  g215(.a(new_n372_), .b(new_n371_), .c(new_n369_), .O(new_n373_));
  and2   g216(.a(new_n373_), .b(new_n173_), .O(z09));
  oai22  g217(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n375_));
  nand3  g218(.a(new_n375_), .b(x082), .c(x002), .O(new_n376_));
  oai22  g219(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n377_));
  nand3  g220(.a(new_n377_), .b(x066), .c(x018), .O(new_n378_));
  aoi22  g221(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n379_));
  nand3  g222(.a(new_n379_), .b(new_n378_), .c(new_n376_), .O(new_n380_));
  and2   g223(.a(new_n380_), .b(new_n186_), .O(z10));
  oai22  g224(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n382_));
  nand3  g225(.a(new_n382_), .b(x083), .c(x003), .O(new_n383_));
  oai22  g226(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n384_));
  nand3  g227(.a(new_n384_), .b(x067), .c(x019), .O(new_n385_));
  aoi22  g228(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(new_n385_), .c(new_n383_), .O(new_n387_));
  and2   g230(.a(new_n387_), .b(new_n199_), .O(z11));
  oai22  g231(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(x084), .c(x004), .O(new_n390_));
  oai22  g233(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(x068), .c(x020), .O(new_n392_));
  aoi22  g235(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n392_), .c(new_n390_), .O(new_n394_));
  and2   g237(.a(new_n394_), .b(new_n212_), .O(z12));
  nand2  g238(.a(x021), .b(x013), .O(new_n396_));
  inv1   g239(.a(x061), .O(new_n397_));
  nor2   g240(.a(x093), .b(x029), .O(new_n398_));
  oai21  g241(.a(new_n398_), .b(x077), .c(new_n397_), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(new_n396_), .O(new_n400_));
  nand2  g243(.a(x101), .b(new_n226_), .O(new_n401_));
  nand2  g244(.a(x125), .b(x093), .O(new_n402_));
  aoi21  g245(.a(new_n402_), .b(new_n401_), .c(x061), .O(new_n403_));
  inv1   g246(.a(x093), .O(new_n404_));
  oai22  g247(.a(new_n250_), .b(x069), .c(new_n249_), .d(x037), .O(new_n405_));
  ...
  oai21  g252(.a(new_n226_), .b(new_n233_), .c(new_n409_), .O(new_n410_));
  nor2   g253(.a(new_n408_), .b(x109), .O(new_n411_));
  nor2   g254(.a(x117), .b(x021), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(new_n411_), .c(x125), .O(new_n413_));
  nand4  g256(.a(new_n413_), .b(new_n410_), .c(new_n406_), .d(new_n229_), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(new_n403_), .c(new_n234_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n400_), .c(x053), .O(new_n416_));
  nand3  g259(.a(x085), .b(new_n233_), .c(new_n257_), .O(new_n417_));
  inv1   g260(.a(new_n417_), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(new_n416_), .c(x005), .O(new_n419_));
  nand2  g262(.a(x093), .b(x061), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(x029), .c(x021), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(x077), .c(new_n257_), .O(new_n422_));
  nand2  g265(.a(new_n422_), .b(new_n409_), .O(new_n423_));
  aoi21  g266(.a(x029), .b(new_n225_), .c(x093), .O(new_n424_));
  nand2  g267(.a(new_n250_), .b(new_n249_), .O(new_n425_));
  nand4  g268(.a(new_n425_), .b(new_n420_), .c(new_n396_), .d(x029), .O(new_n426_));
  oai21  g269(.a(new_n424_), .b(new_n226_), .c(new_n426_), .O(new_n427_));
  nand2  g270(.a(new_n427_), .b(new_n234_), .O(new_n428_));
  nand2  g271(.a(x069), .b(x061), .O(new_n429_));
  nand3  g272(.a(new_n429_), .b(new_n428_), .c(new_n423_), .O(new_n430_));
  inv1   g273(.a(new_n430_), .O(new_n431_));
  aoi21  g274(.a(new_n396_), .b(x029), .c(x093), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(x077), .c(new_n397_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(x037), .O(new_n434_));
  oai21  g277(.a(new_n431_), .b(x053), .c(new_n434_), .O(new_n435_));
  ...
  aoi21  g282(.a(new_n435_), .b(new_n229_), .c(new_n439_), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n419_), .c(x045), .O(z13));
  nand2  g284(.a(x022), .b(x014), .O(new_n442_));
  oai21  g285(.a(new_n304_), .b(x030), .c(new_n442_), .O(new_n443_));
  inv1   g286(.a(x102), .O(new_n444_));
  nand2  g287(.a(new_n284_), .b(new_n444_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n269_), .O(new_n446_));
  nor2   g289(.a(x118), .b(x110), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n446_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n301_), .O(new_n449_));
  oai21  g292(.a(new_n284_), .b(x110), .c(x038), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x118), .O(new_n451_));
  oai21  g294(.a(new_n444_), .b(x062), .c(new_n275_), .O(new_n452_));
  nand3  g295(.a(x126), .b(new_n276_), .c(new_n266_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n292_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n280_), .c(new_n454_), .O(new_n455_));
  nand4  g298(.a(new_n455_), .b(new_n451_), .c(new_n449_), .d(new_n443_), .O(new_n456_));
  nand4  g299(.a(x126), .b(new_n268_), .c(new_n280_), .d(x014), .O(new_n457_));
  inv1   g300(.a(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n456_), .b(new_n300_), .c(new_n458_), .O(new_n459_));
  nand3  g302(.a(x086), .b(new_n280_), .c(new_n265_), .O(new_n460_));
  oai21  g303(.a(new_n459_), .b(x054), .c(new_n460_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(x006), .O(new_n462_));
  oai21  g305(.a(new_n270_), .b(new_n264_), .c(new_n266_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n300_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n265_), .c(new_n447_), .O(new_n465_));
  nor2   g308(.a(new_n264_), .b(x022), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n304_), .c(x070), .O(new_n467_));
  nand4  g310(.a(new_n445_), .b(new_n442_), .c(new_n271_), .d(x030), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n467_), .c(x078), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n465_), .c(new_n263_), .O(new_n470_));
  ...
  aoi21  g322(.a(new_n479_), .b(new_n462_), .c(x046), .O(z14));
  zero   g323(.O(z07));
  zero   g324(.O(z15));
  zero   g325(.O(z16));
  zero   g326(.O(z17));
