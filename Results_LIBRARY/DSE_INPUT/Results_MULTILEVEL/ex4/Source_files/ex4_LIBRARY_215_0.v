// Benchmark "FAU" written by ABC on Tue Jul 28 06:49:13 2020
...
module FAU ( 
  ...
  oai21  g082(.a(x125), .b(new_n233_), .c(new_n238_), .O(new_n239_));
  ...
  nand3  g087(.a(new_n243_), .b(x117), .c(x021), .O(new_n244_));
  nand2  g088(.a(new_n244_), .b(x085), .O(new_n245_));
  aoi21  g089(.a(new_n242_), .b(x037), .c(new_n245_), .O(new_n246_));
  nand4  g090(.a(new_n246_), .b(new_n240_), .c(new_n237_), .d(new_n230_), .O(new_n247_));
  inv1   g091(.a(x013), .O(new_n248_));
  nand4  g092(.a(new_n243_), .b(x061), .c(x037), .d(new_n248_), .O(new_n249_));
  inv1   g093(.a(new_n249_), .O(new_n250_));
  aoi21  g094(.a(new_n247_), .b(x077), .c(new_n250_), .O(new_n251_));
  inv1   g095(.a(x085), .O(new_n252_));
  nand3  g096(.a(new_n252_), .b(x037), .c(x013), .O(new_n253_));
  oai21  g097(.a(new_n251_), .b(new_n227_), .c(new_n253_), .O(new_n254_));
  nand2  g098(.a(new_n254_), .b(new_n226_), .O(new_n255_));
  nor2   g099(.a(x093), .b(x061), .O(new_n256_));
  oai21  g100(.a(new_n256_), .b(x029), .c(x021), .O(new_n257_));
  nand2  g101(.a(new_n257_), .b(x077), .O(new_n258_));
  aoi21  g102(.a(new_n258_), .b(x013), .c(new_n235_), .O(new_n259_));
  inv1   g103(.a(x077), .O(new_n260_));
  inv1   g104(.a(x069), .O(new_n261_));
  inv1   g105(.a(x021), .O(new_n262_));
  nor2   g106(.a(x029), .b(new_n262_), .O(new_n263_));
  oai21  g107(.a(new_n263_), .b(new_n229_), .c(new_n261_), .O(new_n264_));
  nor2   g108(.a(x021), .b(x013), .O(new_n265_));
  nor2   g109(.a(new_n256_), .b(new_n265_), .O(new_n266_));
  nand3  g110(.a(new_n266_), .b(new_n231_), .c(new_n228_), .O(new_n267_));
  aoi21  g111(.a(new_n267_), .b(new_n264_), .c(new_n260_), .O(new_n268_));
  oai21  g112(.a(new_n268_), .b(new_n259_), .c(x053), .O(new_n269_));
  inv1   g113(.a(new_n229_), .O(new_n270_));
  oai21  g114(.a(new_n265_), .b(x029), .c(new_n270_), .O(new_n271_));
  nand3  g115(.a(new_n271_), .b(x077), .c(new_n238_), .O(new_n272_));
  nand2  g116(.a(new_n272_), .b(new_n269_), .O(new_n273_));
  nand2  g117(.a(new_n238_), .b(new_n248_), .O(new_n274_));
  nand3  g118(.a(new_n274_), .b(new_n261_), .c(new_n262_), .O(new_n275_));
  aoi22  g119(.a(new_n260_), .b(new_n248_), .c(new_n227_), .d(new_n238_), .O(new_n276_));
  nand2  g120(.a(new_n276_), .b(new_n275_), .O(new_n277_));
  aoi21  g121(.a(new_n273_), .b(x085), .c(new_n277_), .O(new_n278_));
  aoi21  g122(.a(new_n278_), .b(new_n255_), .c(new_n225_), .O(z05));
  ...
  nand2  g256(.a(x077), .b(x053), .O(new_n414_));
  nand3  g257(.a(new_n414_), .b(x069), .c(x021), .O(new_n415_));
  nand2  g258(.a(x053), .b(x037), .O(new_n416_));
  nand2  g259(.a(x077), .b(x013), .O(new_n417_));
  nand4  g260(.a(x085), .b(new_n238_), .c(new_n248_), .d(x005), .O(new_n418_));
  nand4  g261(.a(new_n418_), .b(new_n417_), .c(new_n416_), .d(new_n415_), .O(new_n419_));
  and2   g262(.a(new_n419_), .b(new_n225_), .O(z13));
  nand2  g263(.a(x022), .b(x014), .O(new_n421_));
  oai21  g264(.a(new_n321_), .b(x030), .c(new_n421_), .O(new_n422_));
  nor2   g265(.a(x126), .b(x102), .O(new_n423_));
  nor2   g266(.a(x118), .b(x110), .O(new_n424_));
  oai21  g267(.a(new_n423_), .b(x094), .c(new_n424_), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n318_), .O(new_n426_));
  oai21  g269(.a(new_n301_), .b(x110), .c(x038), .O(new_n427_));
  nand2  g270(.a(new_n427_), .b(x118), .O(new_n428_));
  inv1   g271(.a(x102), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(x062), .c(new_n291_), .O(new_n430_));
  nand3  g273(.a(x126), .b(new_n292_), .c(new_n285_), .O(new_n431_));
  nand2  g274(.a(new_n431_), .b(new_n309_), .O(new_n432_));
  aoi21  g275(.a(new_n430_), .b(new_n296_), .c(new_n432_), .O(new_n433_));
  nand4  g276(.a(new_n433_), .b(new_n428_), .c(new_n426_), .d(new_n422_), .O(new_n434_));
  nand4  g277(.a(x126), .b(new_n299_), .c(new_n296_), .d(x014), .O(new_n435_));
  inv1   g278(.a(new_n435_), .O(new_n436_));
  aoi21  g279(.a(new_n434_), .b(new_n317_), .c(new_n436_), .O(new_n437_));
  nand3  g280(.a(x086), .b(new_n296_), .c(new_n284_), .O(new_n438_));
  oai21  g281(.a(new_n437_), .b(x054), .c(new_n438_), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(x006), .O(new_n440_));
  nand2  g283(.a(new_n287_), .b(x030), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n285_), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n317_), .O(new_n443_));
  aoi21  g286(.a(new_n443_), .b(new_n284_), .c(new_n424_), .O(new_n444_));
  nor2   g287(.a(new_n283_), .b(x022), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n321_), .c(x070), .O(new_n446_));
  inv1   g289(.a(new_n423_), .O(new_n447_));
  nand4  g290(.a(new_n447_), .b(new_n421_), .c(new_n287_), .d(x030), .O(new_n448_));
  aoi21  g291(.a(new_n448_), .b(new_n446_), .c(x078), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(new_n444_), .c(new_n282_), .O(new_n450_));
  nand2  g293(.a(new_n421_), .b(x030), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n313_), .O(new_n452_));
  nand3  g295(.a(new_n452_), .b(new_n317_), .c(x038), .O(new_n453_));
  ...
  aoi21  g301(.a(new_n454_), .b(new_n309_), .c(new_n458_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n440_), .c(x046), .O(z14));
  zero   g303(.O(z07));
  zero   g304(.O(z15));
  zero   g305(.O(z16));
  zero   g306(.O(z17));
