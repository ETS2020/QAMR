...
module FAU ( 
  ...
  oai21  g306(.a(new_n304_), .b(x118), .c(x038), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x110), .O(new_n465_));
  inv1   g308(.a(x102), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x062), .c(new_n295_), .O(new_n467_));
  nand3  g310(.a(x126), .b(new_n294_), .c(new_n288_), .O(new_n468_));
