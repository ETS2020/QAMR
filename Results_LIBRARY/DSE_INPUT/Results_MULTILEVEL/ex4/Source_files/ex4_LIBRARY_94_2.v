// Benchmark "FAU" written by ABC on Tue Jul 28 06:47:34 2020
...
module FAU ( 
  ...
  oai21  g191(.a(new_n348_), .b(x112), .c(x032), .O(new_n349_));
  nand2  g192(.a(new_n349_), .b(x104), .O(new_n350_));
  ...
  oai21  g301(.a(new_n457_), .b(x062), .c(new_n458_), .O(new_n459_));
  ...
  oai21  g306(.a(new_n463_), .b(x094), .c(new_n292_), .O(new_n464_));
  ...
  nand4  g312(.a(x126), .b(new_n469_), .c(new_n297_), .d(x014), .O(new_n470_));
  inv1   g313(.a(new_n470_), .O(new_n471_));
  aoi21  g314(.a(new_n468_), .b(new_n318_), .c(new_n471_), .O(new_n472_));
  ...
  nand3  g318(.a(new_n310_), .b(new_n283_), .c(x030), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n286_), .c(x038), .O(new_n477_));
  nor3   g320(.a(new_n314_), .b(x086), .c(x054), .O(new_n478_));
  ...
  oai21  g325(.a(new_n480_), .b(new_n458_), .c(new_n482_), .O(new_n483_));
  nand2  g326(.a(new_n455_), .b(x030), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n314_), .c(new_n297_), .O(new_n485_));
  aoi21  g328(.a(new_n483_), .b(new_n283_), .c(new_n485_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(x086), .c(new_n479_), .O(new_n487_));
  nor2   g330(.a(new_n458_), .b(x086), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n283_), .c(x078), .O(new_n489_));
  nor2   g332(.a(new_n286_), .b(x014), .O(new_n490_));
  nor2   g333(.a(new_n319_), .b(x054), .O(new_n491_));
  aoi22  g334(.a(new_n491_), .b(new_n490_), .c(x054), .d(x038), .O(new_n492_));
  oai21  g335(.a(new_n489_), .b(new_n285_), .c(new_n492_), .O(new_n493_));
  aoi21  g336(.a(new_n487_), .b(new_n318_), .c(new_n493_), .O(new_n494_));
