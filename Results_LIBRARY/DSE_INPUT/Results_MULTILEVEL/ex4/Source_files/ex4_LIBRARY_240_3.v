...
module FAU ( 
  ...
  oai22  g191(.a(new_n348_), .b(new_n346_), .c(new_n347_), .d(x064), .O(new_n349_));
  nand2  g192(.a(new_n349_), .b(new_n345_), .O(new_n350_));
  oai22  g193(.a(new_n348_), .b(x064), .c(new_n347_), .d(x032), .O(new_n351_));
  nand2  g194(.a(new_n351_), .b(new_n346_), .O(new_n352_));
  nor2   g195(.a(x112), .b(x104), .O(new_n353_));
  aoi21  g196(.a(x064), .b(x032), .c(new_n353_), .O(new_n354_));
  ...
  nor2   g200(.a(new_n357_), .b(new_n354_), .O(new_n358_));
  nand4  g201(.a(new_n358_), .b(new_n352_), .c(new_n350_), .d(new_n344_), .O(new_n359_));
  inv1   g202(.a(x104), .O(new_n360_));
  nand4  g203(.a(x120), .b(new_n360_), .c(x032), .d(new_n160_), .O(new_n361_));
  inv1   g204(.a(new_n361_), .O(new_n362_));
  aoi21  g205(.a(new_n359_), .b(new_n162_), .c(new_n362_), .O(new_n363_));
  nand3  g206(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n364_));
  oai21  g207(.a(new_n363_), .b(x072), .c(new_n364_), .O(new_n365_));
  nand2  g208(.a(new_n365_), .b(x000), .O(new_n366_));
  nand3  g209(.a(new_n159_), .b(new_n162_), .c(x024), .O(new_n367_));
  aoi21  g210(.a(new_n367_), .b(new_n166_), .c(x032), .O(new_n368_));
  nor3   g211(.a(new_n342_), .b(x080), .c(x048), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(new_n368_), .c(x064), .O(new_n370_));
  nand2  g213(.a(x088), .b(x056), .O(new_n371_));
  aoi21  g214(.a(new_n371_), .b(x024), .c(x016), .O(new_n372_));
  nand2  g215(.a(new_n348_), .b(new_n347_), .O(new_n373_));
  nand4  g216(.a(new_n373_), .b(new_n371_), .c(new_n340_), .d(x024), .O(new_n374_));
  oai21  g217(.a(new_n372_), .b(new_n353_), .c(new_n374_), .O(new_n375_));
  nand2  g218(.a(new_n340_), .b(x024), .O(new_n376_));
  aoi21  g219(.a(new_n376_), .b(new_n342_), .c(new_n161_), .O(new_n377_));
  aoi21  g220(.a(new_n375_), .b(new_n162_), .c(new_n377_), .O(new_n378_));
  oai21  g221(.a(new_n378_), .b(x080), .c(new_n370_), .O(new_n379_));
  nor2   g222(.a(new_n353_), .b(x080), .O(new_n380_));
  aoi21  g223(.a(new_n380_), .b(new_n162_), .c(x072), .O(new_n381_));
  nor2   g224(.a(new_n166_), .b(x008), .O(new_n382_));
  inv1   g225(.a(x064), .O(new_n383_));
  nor2   g226(.a(new_n383_), .b(x048), .O(new_n384_));
  aoi22  g227(.a(new_n384_), .b(new_n382_), .c(x048), .d(x032), .O(new_n385_));
  oai21  g228(.a(new_n381_), .b(new_n160_), .c(new_n385_), .O(new_n386_));
  aoi21  g229(.a(new_n379_), .b(new_n163_), .c(new_n386_), .O(new_n387_));
