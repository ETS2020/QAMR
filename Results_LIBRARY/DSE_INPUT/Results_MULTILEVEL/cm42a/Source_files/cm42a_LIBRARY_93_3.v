// Benchmark "FAU" written by ABC on Mon Jul 27 16:21:39 2020
...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n24_;
  ...
  nor2   g09(.a(new_n17_), .b(x0), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n17_), .O(z5));
  ...
  nand2  g14(.a(new_n24_), .b(new_n17_), .O(z7));
endmodule
