// Benchmark "FAU" written by ABC on Mon Jul 27 17:15:47 2020
...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n17_), .c(new_n23_), .d(new_n15_), .O(z3));
  nand3  g14(.a(new_n18_), .b(new_n17_), .c(x2), .O(z4));
  nand3  g15(.a(new_n21_), .b(new_n17_), .c(x2), .O(z5));
  nand4  g16(.a(new_n25_), .b(new_n17_), .c(new_n23_), .d(x2), .O(z6));
  nand4  g17(.a(new_n27_), .b(new_n17_), .c(new_n23_), .d(x2), .O(z7));
endmodule
