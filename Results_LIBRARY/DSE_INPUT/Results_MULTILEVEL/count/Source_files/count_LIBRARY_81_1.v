...
module FAU ( 
  ...
  oai21  g122(.a(new_n169_), .b(x31), .c(x16), .O(new_n174_));
  ...
  nand3  g127(.a(new_n167_), .b(new_n133_), .c(new_n140_), .O(new_n179_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n156_), .c(new_n133_), .d(new_n102_), .O(new_n183_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n145_), .c(new_n152_), .d(new_n113_), .O(new_n190_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n167_), .c(new_n145_), .d(new_n119_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n156_), .c(new_n163_), .d(new_n128_), .O(new_n201_));
  ...
  nand4  g153(.a(new_n204_), .b(new_n182_), .c(new_n156_), .d(new_n133_), .O(new_n205_));
