...
module FAU ( 
  ...
  aoi22  g049(.a(new_n100_), .b(x24), .c(new_n99_), .d(new_n53_), .O(new_n101_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n62_), .c(new_n54_), .d(new_n53_), .O(new_n108_));
  ...
  nand4  g069(.a(new_n120_), .b(new_n62_), .c(new_n54_), .d(new_n53_), .O(new_n121_));
  ...
  aoi21  g099(.a(new_n146_), .b(new_n53_), .c(new_n150_), .O(new_n151_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n62_), .c(new_n54_), .d(new_n53_), .O(new_n161_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n62_), .c(new_n54_), .d(new_n53_), .O(new_n175_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n69_), .c(new_n62_), .d(new_n54_), .O(new_n189_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n69_), .c(new_n62_), .d(new_n54_), .O(new_n203_));
