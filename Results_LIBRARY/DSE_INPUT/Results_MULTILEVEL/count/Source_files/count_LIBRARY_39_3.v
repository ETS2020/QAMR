...
module FAU ( 
  ...
  nand3  g064(.a(new_n115_), .b(new_n61_), .c(new_n52_), .O(new_n116_));
  ...
  nor3   g074(.a(new_n125_), .b(new_n123_), .c(x18), .O(new_n126_));
  oai21  g075(.a(new_n122_), .b(new_n58_), .c(new_n126_), .O(z07));
  nand2  g076(.a(new_n119_), .b(new_n118_), .O(new_n128_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n96_), .c(new_n132_), .O(new_n134_));
  ...
  nand2  g088(.a(new_n133_), .b(new_n105_), .O(new_n140_));
  ...
  nor3   g093(.a(new_n144_), .b(new_n131_), .c(new_n114_), .O(new_n145_));
  aoi21  g094(.a(new_n142_), .b(x28), .c(new_n145_), .O(new_n146_));
  ...
  nand2  g098(.a(new_n143_), .b(new_n119_), .O(new_n150_));
  ...
  inv1   g109(.a(new_n119_), .O(new_n161_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n119_), .d(new_n118_), .O(new_n165_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n115_), .c(new_n68_), .d(new_n52_), .O(new_n187_));
  nor2   g136(.a(x32), .b(x31), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n164_), .c(new_n143_), .d(new_n119_), .O(new_n189_));
  ...
  nand2  g147(.a(new_n154_), .b(new_n133_), .O(new_n199_));
