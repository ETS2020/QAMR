...
module FAU ( 
  ...
  nand3  g034(.a(new_n85_), .b(new_n60_), .c(new_n84_), .O(new_n86_));
  ...
  nand3  g041(.a(new_n92_), .b(new_n77_), .c(new_n84_), .O(new_n93_));
  inv1   g042(.a(new_n93_), .O(new_n94_));
  nand3  g043(.a(new_n94_), .b(new_n66_), .c(new_n65_), .O(new_n95_));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(new_n74_), .O(new_n97_));
  inv1   g046(.a(new_n97_), .O(new_n98_));
  aoi22  g047(.a(new_n98_), .b(new_n60_), .c(new_n95_), .d(x24), .O(new_n99_));
  ...
  nand4  g051(.a(new_n96_), .b(new_n74_), .c(new_n66_), .d(new_n65_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n85_), .c(new_n68_), .d(new_n58_), .O(new_n106_));
  aoi21  g055(.a(new_n106_), .b(new_n104_), .c(new_n52_), .O(new_n107_));
  inv1   g056(.a(x18), .O(new_n108_));
  oai21  g057(.a(x16), .b(x09), .c(new_n108_), .O(new_n109_));
  or2    g058(.a(new_n109_), .b(new_n107_), .O(z06));
  nand2  g059(.a(new_n77_), .b(new_n84_), .O(new_n111_));
  inv1   g060(.a(x24), .O(new_n112_));
  inv1   g061(.a(x25), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n112_), .c(new_n92_), .O(new_n114_));
  nor2   g063(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n66_), .c(new_n65_), .O(new_n116_));
  nand2  g065(.a(new_n68_), .b(new_n58_), .O(new_n117_));
  nor2   g066(.a(x26), .b(x25), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n85_), .c(new_n112_), .O(new_n119_));
  ...
  oai21  g072(.a(new_n121_), .b(new_n52_), .c(new_n123_), .O(z07));
  inv1   g073(.a(x26), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n113_), .c(new_n112_), .O(new_n126_));
  nor2   g075(.a(new_n126_), .b(new_n93_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n66_), .c(new_n65_), .O(new_n128_));
  nand3  g077(.a(new_n74_), .b(new_n58_), .c(new_n57_), .O(new_n129_));
  nor2   g078(.a(x27), .b(x26), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n96_), .c(new_n113_), .O(new_n131_));
  ...
  nand2  g085(.a(new_n130_), .b(new_n105_), .O(new_n137_));
  inv1   g086(.a(new_n137_), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n94_), .c(new_n66_), .d(new_n65_), .O(new_n139_));
  inv1   g088(.a(x27), .O(new_n140_));
  inv1   g089(.a(x28), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n140_), .c(new_n125_), .O(new_n142_));
  nor3   g091(.a(new_n142_), .b(new_n129_), .c(new_n114_), .O(new_n143_));
  ...
  nand4  g099(.a(new_n150_), .b(new_n98_), .c(new_n66_), .d(new_n65_), .O(new_n151_));
  inv1   g100(.a(x29), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n141_), .c(new_n140_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n126_), .O(new_n154_));
  aoi22  g103(.a(new_n154_), .b(new_n87_), .c(new_n151_), .d(x29), .O(new_n155_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n98_), .c(new_n66_), .d(new_n65_), .O(new_n161_));
  nor2   g110(.a(x30), .b(x29), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n148_), .c(new_n118_), .d(new_n112_), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n86_), .O(new_n164_));
  ...
  oai21  g116(.a(new_n165_), .b(new_n52_), .c(new_n167_), .O(z11));
  nand2  g117(.a(new_n140_), .b(new_n125_), .O(new_n169_));
  inv1   g118(.a(x30), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n152_), .c(new_n141_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n115_), .c(new_n66_), .d(new_n65_), .O(new_n173_));
  nand3  g122(.a(new_n96_), .b(new_n74_), .c(new_n60_), .O(new_n174_));
  nor2   g123(.a(x29), .b(x28), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n175_), .c(new_n130_), .d(new_n113_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  aoi21  g127(.a(new_n173_), .b(x31), .c(new_n178_), .O(new_n179_));
  inv1   g128(.a(x03), .O(new_n180_));
  aoi21  g129(.a(new_n52_), .b(new_n180_), .c(x18), .O(new_n181_));
  oai21  g130(.a(new_n179_), .b(new_n52_), .c(new_n181_), .O(z12));
  inv1   g131(.a(x31), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n170_), .c(new_n152_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n142_), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n115_), .c(new_n66_), .d(new_n65_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n162_), .c(new_n148_), .d(new_n118_), .O(new_n188_));
  ...
  aoi21  g140(.a(new_n52_), .b(new_n191_), .c(x18), .O(new_n192_));
  oai21  g141(.a(new_n190_), .b(new_n52_), .c(new_n192_), .O(z13));
  inv1   g142(.a(x32), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n183_), .c(new_n170_), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n153_), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n127_), .c(new_n66_), .d(new_n65_), .O(new_n197_));
  nor2   g146(.a(x33), .b(x32), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n176_), .c(new_n175_), .d(new_n130_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n106_), .O(new_n200_));
  aoi21  g149(.a(new_n197_), .b(x33), .c(new_n200_), .O(new_n201_));
  inv1   g150(.a(x01), .O(new_n202_));
  aoi21  g151(.a(new_n52_), .b(new_n202_), .c(x18), .O(new_n203_));
  oai21  g152(.a(new_n201_), .b(new_n52_), .c(new_n203_), .O(z14));
  inv1   g153(.a(x33), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n194_), .c(new_n183_), .d(new_n170_), .O(new_n206_));
  nor2   g155(.a(new_n206_), .b(new_n153_), .O(new_n207_));
  nand4  g156(.a(new_n207_), .b(new_n127_), .c(new_n57_), .d(new_n65_), .O(new_n208_));
  nor2   g157(.a(x20), .b(x17), .O(new_n209_));
  nand4  g158(.a(new_n209_), .b(new_n118_), .c(new_n96_), .d(new_n74_), .O(new_n210_));
  nor2   g159(.a(x34), .b(x33), .O(new_n211_));
  nand4  g160(.a(new_n211_), .b(new_n187_), .c(new_n162_), .d(new_n148_), .O(new_n212_));
  nor2   g161(.a(new_n212_), .b(new_n210_), .O(new_n213_));
  aoi21  g162(.a(new_n208_), .b(x34), .c(new_n213_), .O(new_n214_));
  nor2   g163(.a(x16), .b(x00), .O(new_n215_));
  nand3  g164(.a(x34), .b(x19), .c(x16), .O(new_n216_));
  nand2  g165(.a(new_n216_), .b(new_n108_), .O(new_n217_));
  nor2   g166(.a(new_n217_), .b(new_n215_), .O(new_n218_));
  oai21  g167(.a(new_n214_), .b(x19), .c(new_n218_), .O(z15));
endmodule
