...
module FAU ( 
  ...
  nand3  g076(.a(new_n127_), .b(new_n61_), .c(new_n52_), .O(new_n128_));
  ...
  nor3   g086(.a(new_n137_), .b(new_n135_), .c(x18), .O(new_n138_));
  oai21  g087(.a(new_n134_), .b(new_n58_), .c(new_n138_), .O(z08));
  nand2  g088(.a(new_n131_), .b(new_n105_), .O(new_n140_));
  ...
  nor3   g094(.a(new_n145_), .b(new_n129_), .c(new_n114_), .O(new_n146_));
  ...
  nand2  g099(.a(new_n144_), .b(new_n119_), .O(new_n151_));
  ...
  aoi22  g105(.a(new_n156_), .b(new_n89_), .c(new_n153_), .d(x29), .O(new_n157_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n144_), .c(new_n119_), .d(new_n118_), .O(new_n165_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n164_), .c(new_n144_), .d(new_n119_), .O(new_n189_));
