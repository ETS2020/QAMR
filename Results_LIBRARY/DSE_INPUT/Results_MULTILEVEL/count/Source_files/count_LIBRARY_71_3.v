...
module FAU ( 
  ...
  oai21  g044(.a(new_n89_), .b(x19), .c(new_n63_), .O(new_n96_));
  ...
  aoi21  g066(.a(new_n117_), .b(new_n63_), .c(new_n114_), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  inv1   g068(.a(new_n119_), .O(new_n120_));
  nor3   g069(.a(new_n120_), .b(new_n88_), .c(new_n70_), .O(new_n121_));
  ...
  nand2  g075(.a(new_n119_), .b(new_n89_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  aoi21  g077(.a(new_n128_), .b(new_n63_), .c(new_n126_), .O(new_n129_));
  inv1   g078(.a(new_n97_), .O(new_n130_));
  nand3  g079(.a(new_n77_), .b(new_n55_), .c(new_n61_), .O(new_n131_));
  nor2   g080(.a(x27), .b(x26), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n104_), .O(new_n133_));
  nor3   g082(.a(new_n133_), .b(new_n131_), .c(new_n130_), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n129_), .c(x16), .O(new_n135_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n107_), .c(new_n89_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n53_), .O(new_n141_));
  aoi21  g090(.a(new_n141_), .b(new_n63_), .c(new_n139_), .O(new_n142_));
  ...
  nand2  g100(.a(new_n143_), .b(new_n151_), .O(new_n152_));
  or2    g101(.a(new_n152_), .b(new_n98_), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n53_), .c(new_n68_), .O(new_n154_));
  nor3   g103(.a(x29), .b(x28), .c(x27), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n119_), .c(new_n91_), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(new_n150_), .c(new_n156_), .O(new_n157_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n151_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n98_), .c(new_n53_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n63_), .c(new_n162_), .O(new_n165_));
  nor2   g114(.a(x30), .b(x29), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n143_), .c(new_n119_), .O(new_n167_));
  ...
  nand2  g123(.a(new_n174_), .b(new_n132_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n116_), .c(new_n53_), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n63_), .c(new_n173_), .O(new_n177_));
  inv1   g126(.a(new_n99_), .O(new_n178_));
  inv1   g127(.a(new_n133_), .O(new_n179_));
  nor2   g128(.a(x29), .b(x28), .O(new_n180_));
  nor2   g129(.a(x31), .b(x30), .O(new_n181_));
  nand3  g130(.a(new_n181_), .b(new_n180_), .c(new_n179_), .O(new_n182_));
  nor2   g131(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  ...
  nand4  g137(.a(new_n181_), .b(new_n143_), .c(new_n150_), .d(new_n114_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n116_), .c(new_n53_), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n63_), .c(new_n188_), .O(new_n191_));
  nor2   g140(.a(x32), .b(x31), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(new_n166_), .O(new_n193_));
  nor3   g142(.a(new_n193_), .b(new_n152_), .c(new_n178_), .O(new_n194_));
  ...
  aoi21  g148(.a(new_n199_), .b(x21), .c(x33), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n188_), .c(new_n173_), .d(new_n162_), .O(new_n201_));
  nor3   g150(.a(new_n201_), .b(x29), .c(x28), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n126_), .c(new_n114_), .d(new_n104_), .O(new_n203_));
  nor2   g152(.a(new_n203_), .b(x24), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n115_), .c(new_n80_), .d(new_n61_), .O(new_n205_));
  nand3  g154(.a(new_n192_), .b(new_n155_), .c(new_n162_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n127_), .c(x33), .O(new_n207_));
  oai21  g156(.a(new_n205_), .b(x17), .c(new_n207_), .O(new_n208_));
  inv1   g157(.a(x33), .O(new_n209_));
  nor2   g158(.a(new_n63_), .b(new_n209_), .O(new_n210_));
  aoi21  g159(.a(new_n208_), .b(new_n53_), .c(new_n210_), .O(new_n211_));
  inv1   g160(.a(x01), .O(new_n212_));
  aoi21  g161(.a(new_n58_), .b(new_n212_), .c(x18), .O(new_n213_));
  oai21  g162(.a(new_n211_), .b(new_n58_), .c(new_n213_), .O(z14));
  nand3  g163(.a(new_n179_), .b(new_n97_), .c(new_n80_), .O(new_n215_));
  nand4  g164(.a(new_n174_), .b(new_n209_), .c(new_n188_), .d(new_n173_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n215_), .c(new_n53_), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n63_), .c(new_n199_), .O(new_n218_));
  nor3   g167(.a(x34), .b(x33), .c(x32), .O(new_n219_));
  nand4  g168(.a(new_n219_), .b(new_n181_), .c(new_n180_), .d(new_n132_), .O(new_n220_));
  nor2   g169(.a(new_n220_), .b(new_n108_), .O(new_n221_));
