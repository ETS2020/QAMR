...
module FAU ( 
  ...
  aoi21  g001(.a(new_n52_), .b(x19), .c(x17), .O(new_n53_));
  ...
  nand3  g010(.a(new_n52_), .b(new_n55_), .c(new_n54_), .O(new_n62_));
  inv1   g011(.a(new_n62_), .O(new_n63_));
  aoi21  g012(.a(x20), .b(x17), .c(new_n63_), .O(new_n64_));
  inv1   g013(.a(x14), .O(new_n65_));
  aoi21  g014(.a(new_n59_), .b(new_n65_), .c(x18), .O(new_n66_));
  oai21  g015(.a(new_n64_), .b(new_n59_), .c(new_n66_), .O(z01));
  inv1   g016(.a(x21), .O(new_n68_));
  nand4  g017(.a(new_n68_), .b(new_n52_), .c(new_n55_), .d(new_n54_), .O(new_n69_));
  ...
  nor2   g023(.a(x19), .b(x17), .O(new_n75_));
  ...
  nand3  g030(.a(new_n81_), .b(new_n75_), .c(new_n52_), .O(new_n82_));
  ...
  nand4  g040(.a(new_n88_), .b(new_n91_), .c(new_n90_), .d(new_n68_), .O(new_n92_));
  ...
  nand4  g048(.a(new_n99_), .b(new_n81_), .c(new_n98_), .d(new_n54_), .O(new_n100_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n75_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x26), .O(new_n112_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n109_), .c(new_n70_), .O(new_n114_));
  ...
  oai21  g074(.a(new_n123_), .b(new_n59_), .c(new_n125_), .O(z08));
  inv1   g075(.a(x28), .O(new_n127_));
  nor3   g076(.a(x25), .b(x24), .c(x23), .O(new_n128_));
  nor3   g077(.a(x28), .b(x27), .c(x26), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n128_), .c(new_n76_), .d(new_n75_), .O(new_n130_));
  ...
  nand4  g084(.a(new_n109_), .b(new_n98_), .c(new_n68_), .d(new_n54_), .O(new_n136_));
  ...
  oai21  g093(.a(new_n142_), .b(new_n59_), .c(new_n144_), .O(z10));
  nor3   g094(.a(x29), .b(x28), .c(x27), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n113_), .c(new_n83_), .d(new_n63_), .O(new_n147_));
