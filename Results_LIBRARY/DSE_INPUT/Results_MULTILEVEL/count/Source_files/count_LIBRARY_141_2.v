...
module FAU ( 
  ...
  nand3  g121(.a(new_n166_), .b(new_n132_), .c(new_n139_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n114_), .c(new_n53_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n64_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(x31), .O(new_n176_));
  ...
  nor2   g128(.a(new_n179_), .b(x18), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n176_), .c(x16), .O(z12));
  inv1   g130(.a(x32), .O(new_n182_));
  nand4  g131(.a(new_n177_), .b(new_n144_), .c(new_n151_), .d(new_n112_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n114_), .c(new_n53_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n64_), .c(new_n182_), .O(new_n185_));
  nor2   g134(.a(x32), .b(x31), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n166_), .c(new_n144_), .d(new_n127_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n95_), .O(new_n188_));
  ...
  nand4  g154(.a(new_n198_), .b(new_n177_), .c(new_n155_), .d(new_n125_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n128_), .c(new_n53_), .O(new_n207_));
  aoi21  g156(.a(new_n207_), .b(new_n64_), .c(new_n205_), .O(new_n208_));
  nand4  g157(.a(new_n177_), .b(new_n205_), .c(new_n193_), .d(new_n182_), .O(new_n209_));
  nor3   g158(.a(new_n209_), .b(new_n197_), .c(new_n106_), .O(new_n210_));
