...
module FAU ( 
  ...
  oai21  g039(.a(new_n90_), .b(new_n58_), .c(new_n84_), .O(z04));
  oai21  g040(.a(new_n89_), .b(x19), .c(new_n64_), .O(new_n92_));
  nor2   g041(.a(x24), .b(x23), .O(new_n93_));
  nand3  g042(.a(new_n93_), .b(new_n75_), .c(new_n64_), .O(new_n94_));
  ...
  nand2  g049(.a(new_n93_), .b(new_n75_), .O(new_n101_));
  ...
  nand4  g053(.a(new_n104_), .b(new_n87_), .c(new_n69_), .d(new_n55_), .O(new_n105_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n87_), .c(new_n125_), .d(new_n86_), .O(new_n127_));
  ...
  oai21  g088(.a(new_n139_), .b(new_n88_), .c(new_n53_), .O(new_n140_));
  ...
  nand2  g099(.a(new_n89_), .b(new_n64_), .O(new_n151_));
  nand4  g100(.a(new_n143_), .b(new_n126_), .c(new_n93_), .d(new_n75_), .O(new_n152_));
