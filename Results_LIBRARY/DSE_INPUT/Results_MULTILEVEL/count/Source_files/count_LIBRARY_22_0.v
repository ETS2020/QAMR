...
module FAU ( 
  ...
  nand3  g037(.a(new_n75_), .b(new_n52_), .c(new_n68_), .O(new_n89_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n109_));
  ...
  aoi21  g097(.a(new_n145_), .b(new_n53_), .c(new_n148_), .O(new_n149_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n146_), .c(new_n160_), .d(new_n140_), .O(new_n162_));
  nor2   g111(.a(new_n162_), .b(x25), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n99_), .c(new_n86_), .d(new_n78_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(x21), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n166_));
  ...
  nand2  g119(.a(x31), .b(x16), .O(new_n171_));
  inv1   g120(.a(x03), .O(new_n172_));
  nand2  g121(.a(new_n58_), .b(new_n172_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n113_), .O(z12));
  nand2  g123(.a(x32), .b(x16), .O(new_n175_));
  inv1   g124(.a(x02), .O(new_n176_));
  nand2  g125(.a(new_n58_), .b(new_n176_), .O(new_n177_));
  nand3  g126(.a(new_n177_), .b(new_n175_), .c(new_n113_), .O(z13));
  nand2  g127(.a(x33), .b(x16), .O(new_n179_));
  inv1   g128(.a(x01), .O(new_n180_));
  nand2  g129(.a(new_n58_), .b(new_n180_), .O(new_n181_));
  nand3  g130(.a(new_n181_), .b(new_n179_), .c(new_n113_), .O(z14));
  nand2  g131(.a(x34), .b(x16), .O(new_n183_));
  inv1   g132(.a(x00), .O(new_n184_));
  nand2  g133(.a(new_n58_), .b(new_n184_), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n183_), .c(new_n113_), .O(z15));
endmodule
