...
module FAU ( 
  ...
  inv1   g102(.a(new_n96_), .O(new_n154_));
  nand2  g103(.a(new_n145_), .b(new_n118_), .O(new_n155_));
  ...
  oai22  g109(.a(new_n160_), .b(new_n153_), .c(new_n158_), .d(new_n152_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n166_), .b(new_n140_), .c(new_n125_), .O(new_n167_));
  nor2   g116(.a(new_n167_), .b(x26), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n102_), .c(new_n117_), .d(new_n113_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(x22), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n69_), .c(new_n61_), .d(new_n52_), .O(new_n171_));
  nand2  g120(.a(new_n159_), .b(new_n118_), .O(new_n172_));
  ...
  nor2   g124(.a(new_n63_), .b(new_n175_), .O(new_n176_));
  ...
  nand3  g129(.a(new_n166_), .b(new_n145_), .c(new_n126_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n153_), .c(x31), .O(new_n182_));
  nor2   g131(.a(x29), .b(x28), .O(new_n183_));
  nor2   g132(.a(x31), .b(x30), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n183_), .c(new_n133_), .d(new_n97_), .O(new_n185_));
  ...
  nand3  g140(.a(new_n166_), .b(new_n131_), .c(new_n140_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n114_), .c(new_n53_), .O(new_n193_));
  inv1   g142(.a(x31), .O(new_n194_));
  nand3  g143(.a(new_n55_), .b(new_n194_), .c(new_n61_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n193_), .c(new_n191_), .O(new_n197_));
  inv1   g146(.a(new_n97_), .O(new_n198_));
  nand4  g147(.a(new_n166_), .b(new_n156_), .c(new_n191_), .d(new_n194_), .O(new_n199_));
  ...
  nand4  g155(.a(new_n206_), .b(new_n191_), .c(new_n175_), .d(new_n152_), .O(new_n207_));
  oai21  g156(.a(new_n207_), .b(new_n114_), .c(new_n53_), .O(new_n208_));
  aoi21  g157(.a(new_n208_), .b(new_n196_), .c(new_n205_), .O(new_n209_));
  nor2   g158(.a(x33), .b(x32), .O(new_n210_));
  nand4  g159(.a(new_n210_), .b(new_n184_), .c(new_n183_), .d(new_n131_), .O(new_n211_));
  nor2   g160(.a(new_n211_), .b(new_n106_), .O(new_n212_));
  ...
  nand3  g166(.a(new_n217_), .b(new_n205_), .c(new_n191_), .O(new_n218_));
  aoi21  g167(.a(new_n218_), .b(new_n194_), .c(x30), .O(new_n219_));
  nand4  g168(.a(new_n219_), .b(new_n152_), .c(new_n140_), .d(new_n125_), .O(new_n220_));
  nor2   g169(.a(new_n220_), .b(x26), .O(new_n221_));
  nand4  g170(.a(new_n221_), .b(new_n102_), .c(new_n117_), .d(new_n113_), .O(new_n222_));
  nor2   g171(.a(new_n222_), .b(x22), .O(new_n223_));
  nand4  g172(.a(new_n223_), .b(new_n69_), .c(new_n61_), .d(new_n52_), .O(new_n224_));
  nand3  g173(.a(new_n210_), .b(new_n159_), .c(new_n175_), .O(new_n225_));
  oai21  g174(.a(new_n225_), .b(new_n127_), .c(x34), .O(new_n226_));
  aoi21  g175(.a(new_n226_), .b(new_n224_), .c(x19), .O(new_n227_));
  nor2   g176(.a(new_n63_), .b(new_n217_), .O(new_n228_));
