...
module FAU ( 
  ...
  oai21  g15(.a(x19), .b(x17), .c(x21), .O(new_n67_));
  nand3  g16(.a(x20), .b(new_n59_), .c(new_n58_), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g18(.a(new_n69_), .b(x16), .O(new_n70_));
  inv1   g19(.a(x13), .O(new_n71_));
  aoi21  g20(.a(new_n52_), .b(new_n71_), .c(x18), .O(new_n72_));
