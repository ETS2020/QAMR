...
module FAU ( 
  ...
  nor3   g028(.a(x23), .b(x22), .c(x20), .O(new_n80_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n55_), .c(new_n61_), .O(new_n86_));
  nor3   g035(.a(x24), .b(x23), .c(x22), .O(new_n87_));
  aoi22  g036(.a(new_n87_), .b(new_n63_), .c(new_n86_), .d(x24), .O(new_n88_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n113_), .c(new_n87_), .d(new_n63_), .O(new_n147_));
