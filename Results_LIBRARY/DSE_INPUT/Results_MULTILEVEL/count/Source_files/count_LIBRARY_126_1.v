...
module FAU ( 
  ...
  nand2  g124(.a(new_n155_), .b(new_n125_), .O(new_n176_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n156_), .c(new_n130_), .d(new_n113_), .O(new_n183_));
  ...
  nand3  g137(.a(new_n164_), .b(new_n155_), .c(new_n125_), .O(new_n189_));
  ...
  nand4  g154(.a(new_n205_), .b(new_n182_), .c(new_n156_), .d(new_n130_), .O(new_n206_));
