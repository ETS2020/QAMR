...
module FAU ( 
  ...
  nand4  g145(.a(new_n189_), .b(new_n156_), .c(new_n163_), .d(new_n128_), .O(new_n197_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n178_), .c(new_n156_), .d(new_n133_), .O(new_n201_));
  nor3   g150(.a(new_n201_), .b(new_n107_), .c(new_n70_), .O(new_n202_));
