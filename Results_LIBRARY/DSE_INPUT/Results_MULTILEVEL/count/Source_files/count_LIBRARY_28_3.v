...
module FAU ( 
  ...
  nand3  g043(.a(new_n94_), .b(new_n61_), .c(new_n52_), .O(new_n95_));
  ...
  nor3   g051(.a(new_n102_), .b(new_n100_), .c(x18), .O(new_n103_));
  oai21  g052(.a(new_n99_), .b(new_n58_), .c(new_n103_), .O(z05));
  nand3  g053(.a(new_n98_), .b(new_n68_), .c(new_n52_), .O(new_n105_));
  ...
  nand3  g069(.a(new_n120_), .b(new_n87_), .c(new_n101_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  aoi21  g071(.a(new_n118_), .b(x26), .c(new_n122_), .O(new_n123_));
  ...
  nand2  g075(.a(new_n120_), .b(new_n101_), .O(new_n127_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n143_), .c(new_n120_), .d(new_n101_), .O(new_n165_));
