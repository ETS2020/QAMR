...
module FAU ( 
  ...
  nand3  g123(.a(new_n166_), .b(new_n132_), .c(new_n139_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n114_), .c(new_n53_), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n64_), .c(new_n174_), .O(new_n177_));
  nor2   g126(.a(x31), .b(x30), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n155_), .c(new_n132_), .d(new_n101_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n95_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n177_), .c(x16), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n173_), .O(z12));
  inv1   g131(.a(x32), .O(new_n183_));
  nand4  g132(.a(new_n178_), .b(new_n144_), .c(new_n151_), .d(new_n112_), .O(new_n184_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n166_), .c(new_n144_), .d(new_n127_), .O(new_n188_));
  nor2   g137(.a(new_n188_), .b(new_n95_), .O(new_n189_));
  ...
  nand4  g143(.a(new_n187_), .b(new_n155_), .c(new_n162_), .d(new_n125_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n128_), .c(new_n53_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n64_), .c(new_n194_), .O(new_n197_));
  nand2  g146(.a(new_n155_), .b(new_n132_), .O(new_n198_));
  ...
  nand4  g155(.a(new_n199_), .b(new_n178_), .c(new_n155_), .d(new_n125_), .O(new_n207_));
  oai21  g156(.a(new_n207_), .b(new_n128_), .c(new_n53_), .O(new_n208_));
  aoi21  g157(.a(new_n208_), .b(new_n64_), .c(new_n206_), .O(new_n209_));
  nand4  g158(.a(new_n178_), .b(new_n206_), .c(new_n194_), .d(new_n183_), .O(new_n210_));
