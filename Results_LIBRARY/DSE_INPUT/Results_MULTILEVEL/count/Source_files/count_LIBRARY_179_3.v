...
module FAU ( 
  ...
  nand4  g110(.a(new_n161_), .b(new_n98_), .c(new_n61_), .d(new_n52_), .O(new_n162_));
  ...
  oai21  g119(.a(new_n166_), .b(new_n58_), .c(new_n170_), .O(z11));
  inv1   g120(.a(new_n131_), .O(new_n172_));
  inv1   g121(.a(x28), .O(new_n173_));
  nand2  g122(.a(new_n163_), .b(new_n173_), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n115_), .c(new_n68_), .d(new_n52_), .O(new_n176_));
  nand3  g125(.a(new_n96_), .b(new_n76_), .c(new_n63_), .O(new_n177_));
  nor2   g126(.a(x31), .b(x30), .O(new_n178_));
  nand4  g127(.a(new_n178_), .b(new_n153_), .c(new_n131_), .d(new_n130_), .O(new_n179_));
  ...
  nor2   g135(.a(new_n186_), .b(new_n143_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n115_), .c(new_n68_), .d(new_n52_), .O(new_n188_));
  nor2   g137(.a(x32), .b(x31), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n163_), .c(new_n142_), .d(new_n119_), .O(new_n190_));
  ...
  nand2  g144(.a(new_n189_), .b(new_n168_), .O(new_n196_));
  nor2   g145(.a(new_n196_), .b(new_n154_), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n127_), .c(new_n68_), .d(new_n52_), .O(new_n198_));
  nand2  g147(.a(new_n153_), .b(new_n131_), .O(new_n199_));
  ...
  nor2   g155(.a(new_n201_), .b(new_n154_), .O(new_n207_));
