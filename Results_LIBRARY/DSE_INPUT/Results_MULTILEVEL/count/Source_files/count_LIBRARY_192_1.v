...
module FAU ( 
  ...
  oai21  g072(.a(new_n119_), .b(x27), .c(x16), .O(new_n124_));
  inv1   g073(.a(x07), .O(new_n125_));
  aoi21  g074(.a(new_n52_), .b(new_n125_), .c(x18), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n124_), .O(z08));
  nand3  g076(.a(new_n111_), .b(new_n78_), .c(new_n109_), .O(new_n128_));
  inv1   g077(.a(x26), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n113_), .c(new_n112_), .O(new_n130_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n92_), .c(new_n113_), .O(new_n135_));
  ...
  nand2  g089(.a(new_n134_), .b(new_n102_), .O(new_n141_));
  inv1   g090(.a(new_n141_), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n86_), .c(new_n74_), .d(new_n84_), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n102_), .c(new_n129_), .d(new_n111_), .O(new_n145_));
  ...
  nand2  g099(.a(new_n144_), .b(new_n117_), .O(new_n151_));
  inv1   g100(.a(new_n151_), .O(new_n152_));
  nand4  g101(.a(new_n152_), .b(new_n94_), .c(new_n74_), .d(new_n84_), .O(new_n153_));
  nand2  g102(.a(new_n86_), .b(new_n60_), .O(new_n154_));
  inv1   g103(.a(x28), .O(new_n155_));
  nor2   g104(.a(x30), .b(x29), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n117_), .c(new_n155_), .d(new_n112_), .O(new_n157_));
  ...
  nand2  g111(.a(new_n129_), .b(new_n113_), .O(new_n163_));
  ...
  nand4  g116(.a(new_n167_), .b(new_n94_), .c(new_n74_), .d(new_n84_), .O(new_n168_));
  nor2   g117(.a(x31), .b(x30), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n144_), .c(new_n117_), .d(new_n112_), .O(new_n170_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n115_), .c(new_n74_), .d(new_n84_), .O(new_n180_));
  nand4  g129(.a(new_n92_), .b(new_n75_), .c(new_n74_), .d(new_n84_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n156_), .c(new_n134_), .d(new_n113_), .O(new_n183_));
  ...
  nand4  g143(.a(new_n194_), .b(new_n169_), .c(new_n144_), .d(new_n117_), .O(new_n195_));
  ...
  nand4  g152(.a(new_n203_), .b(new_n131_), .c(new_n74_), .d(new_n84_), .O(new_n204_));
