...
module FAU ( 
  ...
  aoi22  g018(.a(new_n69_), .b(new_n56_), .c(new_n68_), .d(x21), .O(new_n70_));
  inv1   g019(.a(x13), .O(new_n71_));
  aoi21  g020(.a(new_n54_), .b(new_n71_), .c(x18), .O(new_n72_));
  oai21  g021(.a(new_n70_), .b(new_n54_), .c(new_n72_), .O(z02));
  ...
  aoi21  g030(.a(new_n54_), .b(new_n81_), .c(x18), .O(new_n82_));
  ...
  oai21  g040(.a(new_n89_), .b(new_n54_), .c(new_n91_), .O(z04));
  ...
  aoi21  g048(.a(new_n54_), .b(new_n99_), .c(x18), .O(new_n100_));
  oai21  g049(.a(new_n98_), .b(new_n54_), .c(new_n100_), .O(z05));
  ...
  nand4  g053(.a(new_n104_), .b(new_n86_), .c(new_n69_), .d(new_n56_), .O(new_n105_));
  ...
  nand2  g064(.a(new_n69_), .b(new_n56_), .O(new_n116_));
  ...
  oai21  g072(.a(new_n121_), .b(new_n54_), .c(new_n123_), .O(z07));
  ...
  nand3  g076(.a(new_n75_), .b(new_n56_), .c(new_n59_), .O(new_n128_));
  ...
  aoi21  g083(.a(new_n54_), .b(new_n134_), .c(x18), .O(new_n135_));
  oai21  g084(.a(new_n133_), .b(new_n54_), .c(new_n135_), .O(z08));
  ...
  aoi21  g094(.a(new_n54_), .b(new_n145_), .c(x18), .O(new_n146_));
  oai21  g095(.a(new_n144_), .b(new_n54_), .c(new_n146_), .O(z09));
  ...
  aoi21  g105(.a(new_n54_), .b(new_n156_), .c(x18), .O(new_n157_));
  oai21  g106(.a(new_n155_), .b(new_n54_), .c(new_n157_), .O(z10));
  ...
  aoi21  g115(.a(new_n54_), .b(new_n166_), .c(x18), .O(new_n167_));
  oai21  g116(.a(new_n165_), .b(new_n54_), .c(new_n167_), .O(z11));
  ...
  aoi21  g128(.a(new_n54_), .b(new_n179_), .c(x18), .O(new_n180_));
  oai21  g129(.a(new_n178_), .b(new_n54_), .c(new_n180_), .O(z12));
  ...
  aoi21  g139(.a(new_n54_), .b(new_n190_), .c(x18), .O(new_n191_));
  oai21  g140(.a(new_n189_), .b(new_n54_), .c(new_n191_), .O(z13));
  ...
  aoi21  g151(.a(new_n54_), .b(new_n202_), .c(x18), .O(new_n203_));
  oai21  g152(.a(new_n201_), .b(new_n54_), .c(new_n203_), .O(z14));
  ...
  aoi21  g161(.a(new_n54_), .b(new_n212_), .c(x18), .O(new_n213_));
  oai21  g162(.a(new_n211_), .b(new_n54_), .c(new_n213_), .O(z15));
endmodule
