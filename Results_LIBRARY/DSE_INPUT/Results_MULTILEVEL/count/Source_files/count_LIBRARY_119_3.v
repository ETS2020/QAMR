...
module FAU ( 
  ...
  nor2   g014(.a(new_n61_), .b(new_n52_), .O(new_n66_));
  nor3   g015(.a(new_n66_), .b(new_n65_), .c(x18), .O(new_n67_));
  oai21  g016(.a(new_n64_), .b(new_n58_), .c(new_n67_), .O(z01));
  nor2   g017(.a(x21), .b(x20), .O(new_n69_));
  aoi22  g018(.a(new_n69_), .b(new_n55_), .c(new_n62_), .d(x21), .O(new_n70_));
  ...
  oai21  g032(.a(new_n75_), .b(x19), .c(new_n63_), .O(new_n84_));
  ...
  nand3  g043(.a(new_n94_), .b(new_n75_), .c(new_n63_), .O(new_n95_));
  ...
  aoi21  g052(.a(new_n103_), .b(new_n63_), .c(new_n101_), .O(new_n104_));
  ...
  aoi21  g102(.a(new_n153_), .b(new_n53_), .c(new_n62_), .O(new_n154_));
  ...
  aoi21  g124(.a(new_n175_), .b(new_n63_), .c(new_n173_), .O(new_n176_));
  ...
  aoi21  g146(.a(new_n197_), .b(new_n63_), .c(new_n195_), .O(new_n198_));
