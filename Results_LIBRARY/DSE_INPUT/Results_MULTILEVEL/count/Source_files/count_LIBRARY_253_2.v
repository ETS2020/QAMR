// Benchmark "FAU" written by ABC on Mon Jul 27 18:27:45 2020
...
module FAU ( 
  ...
  nand3  g043(.a(new_n94_), .b(new_n74_), .c(new_n84_), .O(new_n95_));
  ...
  nand3  g051(.a(new_n98_), .b(new_n74_), .c(new_n84_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g053(.a(x25), .b(x24), .O(new_n105_));
  nand4  g054(.a(new_n105_), .b(new_n87_), .c(new_n66_), .d(new_n58_), .O(new_n106_));
  ...
  nor2   g068(.a(new_n119_), .b(new_n67_), .O(new_n120_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n74_), .c(new_n84_), .O(new_n127_));
  nand3  g076(.a(new_n75_), .b(new_n58_), .c(new_n57_), .O(new_n128_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n94_), .c(new_n74_), .d(new_n84_), .O(new_n139_));
  inv1   g088(.a(x26), .O(new_n140_));
  nor2   g089(.a(x28), .b(x27), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nor3   g091(.a(new_n142_), .b(new_n128_), .c(new_n114_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n98_), .c(new_n74_), .d(new_n84_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n154_), .b(new_n94_), .c(new_n57_), .d(new_n84_), .O(new_n159_));
  nand2  g108(.a(new_n130_), .b(new_n129_), .O(new_n160_));
  nand4  g109(.a(new_n96_), .b(new_n66_), .c(new_n78_), .d(new_n84_), .O(new_n161_));
  inv1   g110(.a(x28), .O(new_n162_));
  nor2   g111(.a(x30), .b(x29), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nor3   g113(.a(new_n164_), .b(new_n161_), .c(new_n160_), .O(new_n165_));
  aoi21  g114(.a(new_n159_), .b(x30), .c(new_n165_), .O(new_n166_));
  nor2   g115(.a(x16), .b(x04), .O(new_n167_));
  nand3  g116(.a(x30), .b(x19), .c(x16), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nor3   g118(.a(new_n169_), .b(new_n167_), .c(x18), .O(new_n170_));
  oai21  g119(.a(new_n166_), .b(x19), .c(new_n170_), .O(z11));
  inv1   g120(.a(new_n130_), .O(new_n172_));
  nor2   g121(.a(new_n164_), .b(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n115_), .c(new_n74_), .d(new_n84_), .O(new_n174_));
  nand3  g123(.a(new_n96_), .b(new_n75_), .c(new_n60_), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n152_), .c(new_n130_), .d(new_n129_), .O(new_n177_));
  ...
  nand4  g134(.a(new_n185_), .b(new_n115_), .c(new_n74_), .d(new_n84_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n163_), .c(new_n141_), .d(new_n118_), .O(new_n188_));
  ...
  nand4  g145(.a(new_n196_), .b(new_n126_), .c(new_n74_), .d(new_n84_), .O(new_n197_));
  nand2  g146(.a(new_n152_), .b(new_n130_), .O(new_n198_));
  ...
  aoi21  g152(.a(new_n52_), .b(new_n203_), .c(x18), .O(new_n204_));
  oai21  g153(.a(new_n202_), .b(new_n52_), .c(new_n204_), .O(z14));
  nor2   g154(.a(new_n200_), .b(new_n153_), .O(new_n206_));
  nand4  g155(.a(new_n206_), .b(new_n126_), .c(new_n74_), .d(new_n84_), .O(new_n207_));
  inv1   g156(.a(x32), .O(new_n208_));
  nor2   g157(.a(x34), .b(x33), .O(new_n209_));
  nand3  g158(.a(new_n209_), .b(new_n176_), .c(new_n208_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(new_n198_), .c(new_n106_), .O(new_n211_));
  aoi21  g160(.a(new_n207_), .b(x34), .c(new_n211_), .O(new_n212_));
  inv1   g161(.a(x00), .O(new_n213_));
  aoi21  g162(.a(new_n52_), .b(new_n213_), .c(x18), .O(new_n214_));
  oai21  g163(.a(new_n212_), .b(new_n52_), .c(new_n214_), .O(z15));
endmodule
