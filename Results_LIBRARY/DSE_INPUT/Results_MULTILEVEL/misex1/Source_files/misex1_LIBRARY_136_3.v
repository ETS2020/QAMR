...
module FAU ( 
  ...
  aoi21  g38(.a(new_n51_), .b(new_n53_), .c(new_n17_), .O(new_n54_));
  inv1   g39(.a(x5), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(x2), .c(new_n37_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x3), .c(new_n23_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n17_), .c(new_n54_), .O(new_n58_));
  aoi21  g43(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n59_));
  ...
  nand3  g50(.a(new_n47_), .b(x2), .c(new_n17_), .O(new_n66_));
