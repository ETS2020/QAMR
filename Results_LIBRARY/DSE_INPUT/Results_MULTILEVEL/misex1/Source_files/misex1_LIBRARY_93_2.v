...
module FAU ( 
  ...
  oai22  g10(.a(new_n25_), .b(x2), .c(x4), .d(new_n19_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n20_), .O(new_n27_));
  inv1   g12(.a(x4), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n20_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n16_), .c(x1), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n27_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n24_), .c(new_n17_), .O(new_n32_));
  nand4  g17(.a(x3), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n33_));
  ...
  oai21  g22(.a(new_n28_), .b(x2), .c(new_n20_), .O(new_n38_));
  ...
  nor2   g46(.a(new_n23_), .b(x0), .O(new_n62_));
  ...
  oai21  g51(.a(new_n66_), .b(new_n51_), .c(new_n19_), .O(new_n67_));
  nand2  g52(.a(x4), .b(new_n20_), .O(new_n68_));
