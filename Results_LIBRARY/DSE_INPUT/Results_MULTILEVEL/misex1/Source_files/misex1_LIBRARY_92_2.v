...
module FAU ( 
  ...
  or2    g14(.a(new_n29_), .b(new_n28_), .O(new_n30_));
  ...
  oai21  g29(.a(new_n44_), .b(new_n28_), .c(new_n43_), .O(z3));
  aoi21  g30(.a(new_n44_), .b(new_n29_), .c(new_n17_), .O(new_n46_));
  nor2   g31(.a(new_n16_), .b(x0), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n46_), .c(new_n19_), .O(new_n48_));
  nor2   g33(.a(x3), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n32_), .c(new_n17_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z4));
  xor2a  g36(.a(x3), .b(x2), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  nand2  g38(.a(new_n23_), .b(new_n20_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(x2), .c(new_n17_), .O(new_n55_));
  ...
  nand3  g46(.a(new_n38_), .b(x2), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n19_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n18_), .O(z6));
endmodule
