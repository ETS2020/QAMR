...
module FAU ( 
  ...
  nand2  g08(.a(x5), .b(new_n20_), .O(new_n24_));
  ...
  oai21  g22(.a(new_n37_), .b(new_n19_), .c(new_n36_), .O(new_n38_));
  ...
  aoi21  g33(.a(new_n47_), .b(new_n32_), .c(new_n17_), .O(new_n49_));
  oai21  g34(.a(new_n43_), .b(x3), .c(x2), .O(new_n50_));
  inv1   g35(.a(x6), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(x5), .c(new_n20_), .O(new_n52_));
