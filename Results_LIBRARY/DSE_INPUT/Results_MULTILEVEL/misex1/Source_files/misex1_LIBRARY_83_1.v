// Benchmark "FAU" written by ABC on Mon Jul 27 17:10:09 2020
...
module FAU ( 
  ...
  oai21  g41(.a(new_n56_), .b(new_n48_), .c(new_n19_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z5));
  nand3  g43(.a(new_n39_), .b(x2), .c(new_n17_), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n48_), .c(new_n19_), .O(new_n61_));
