...
module FAU ( 
  ...
  nand3  g08(.a(x5), .b(x2), .c(new_n17_), .O(new_n24_));
  ...
  nand4  g25(.a(x3), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n41_));
  ...
  nand4  g31(.a(new_n20_), .b(x2), .c(new_n19_), .d(x0), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(z3));
  xnor2a g33(.a(x3), .b(x2), .O(new_n49_));
  nor2   g34(.a(new_n49_), .b(new_n17_), .O(new_n50_));
  aoi21  g35(.a(new_n36_), .b(new_n16_), .c(x0), .O(new_n51_));
  ...
  inv1   g42(.a(new_n24_), .O(new_n58_));
  oai21  g43(.a(new_n50_), .b(new_n58_), .c(new_n19_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  nand3  g45(.a(new_n33_), .b(x2), .c(new_n17_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n50_), .c(new_n19_), .O(new_n63_));
