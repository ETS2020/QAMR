...
module FAU ( 
  ...
  nand3  g24(.a(new_n25_), .b(new_n16_), .c(x1), .O(new_n40_));
  nand2  g25(.a(new_n32_), .b(new_n19_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n17_), .O(new_n43_));
  nand3  g28(.a(x2), .b(new_n19_), .c(x0), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x3), .O(z3));
  nand2  g30(.a(x3), .b(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n20_), .b(x2), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n46_), .c(new_n17_), .O(new_n48_));
  inv1   g33(.a(x5), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(x2), .c(new_n33_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x3), .c(new_n23_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n17_), .c(new_n48_), .O(new_n52_));
  aoi21  g37(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n53_));
  nand3  g38(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n54_));
  ...
  oai21  g43(.a(new_n58_), .b(new_n48_), .c(new_n19_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  nand4  g45(.a(new_n49_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n48_), .c(new_n19_), .O(new_n63_));
