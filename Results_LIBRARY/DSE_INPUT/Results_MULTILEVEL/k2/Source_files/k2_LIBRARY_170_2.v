...
module FAU ( 
  ...
  nand3  g1131(.a(new_n1222_), .b(x16), .c(x08), .O(new_n1223_));
  inv1   g1132(.a(x16), .O(new_n1224_));
  nand3  g1133(.a(new_n410_), .b(new_n1224_), .c(x07), .O(new_n1225_));
  ...
  nor2   g1163(.a(new_n1220_), .b(new_n202_), .O(new_n1255_));
  ...
  nand2  g1409(.a(x16), .b(x08), .O(new_n1501_));
  ...
  oai21  g1415(.a(new_n316_), .b(x18), .c(new_n1220_), .O(new_n1507_));
  ...
  nor3   g1423(.a(new_n1514_), .b(new_n1220_), .c(x11), .O(new_n1515_));
  ...
  nand2  g1428(.a(new_n1224_), .b(new_n1519_), .O(new_n1520_));
  ...
  nor2   g1649(.a(new_n1220_), .b(new_n1550_), .O(new_n1741_));
