...
module FAU ( 
  ...
  nor2   g018(.a(new_n51_), .b(x03), .O(z0));
  ...
  nor4   g047(.a(new_n80_), .b(new_n64_), .c(new_n63_), .d(new_n79_), .O(new_n81_));
  ...
  nor3   g052(.a(x06), .b(x04), .c(x03), .O(new_n86_));
  ...
  aoi21  g115(.a(new_n148_), .b(new_n35_), .c(x03), .O(new_n149_));
  nand2  g116(.a(new_n67_), .b(x14), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x06), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x11), .c(new_n63_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n115_), .c(new_n149_), .d(new_n49_), .O(z6));
  inv1   g120(.a(new_n115_), .O(z7));
endmodule
