...
module FAU ( 
  ...
  nand3  g042(.a(new_n39_), .b(x13), .c(x05), .O(new_n76_));
  ...
  nand4  g048(.a(new_n81_), .b(new_n80_), .c(new_n61_), .d(new_n55_), .O(new_n82_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n80_), .c(new_n61_), .d(new_n55_), .O(new_n92_));
  inv1   g059(.a(x04), .O(new_n93_));
  inv1   g060(.a(x01), .O(new_n94_));
  nand4  g061(.a(new_n34_), .b(new_n43_), .c(new_n94_), .d(x00), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n83_), .c(new_n35_), .d(new_n93_), .O(new_n97_));
  oai21  g064(.a(new_n97_), .b(new_n88_), .c(new_n92_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n39_), .c(new_n44_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n90_), .c(new_n78_), .O(z1));
  ...
  nand3  g072(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n106_));
  nand4  g073(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  aoi21  g075(.a(new_n104_), .b(x05), .c(new_n108_), .O(new_n109_));
  nor3   g076(.a(new_n109_), .b(new_n59_), .c(new_n101_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(x11), .c(x06), .d(x03), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n94_), .O(z2));
  nand3  g079(.a(x15), .b(x13), .c(x05), .O(new_n113_));
  nand3  g080(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x20), .c(x14), .d(x11), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n63_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(x06), .c(x03), .d(x01), .O(new_n118_));
  nand3  g085(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n119_));
  nand3  g086(.a(x19), .b(x13), .c(x05), .O(new_n120_));
  nand2  g087(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n59_), .c(new_n101_), .d(new_n36_), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(x08), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n124_));
  ...
  nand3  g094(.a(new_n81_), .b(x14), .c(x11), .O(new_n128_));
  nand4  g095(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n129_));
  nand4  g096(.a(new_n59_), .b(new_n101_), .c(new_n36_), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g100(.a(new_n63_), .b(new_n35_), .c(new_n34_), .d(new_n94_), .O(new_n134_));
  nand3  g101(.a(new_n70_), .b(new_n101_), .c(new_n36_), .O(new_n135_));
  ...
  and2   g104(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n126_), .O(z3));
  inv1   g106(.a(new_n49_), .O(z5));
  inv1   g107(.a(x22), .O(new_n141_));
  oai21  g108(.a(x23), .b(new_n93_), .c(new_n58_), .O(new_n142_));
  ...
  aoi21  g112(.a(x23), .b(new_n93_), .c(new_n58_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n141_), .c(x09), .O(new_n147_));
  nand2  g114(.a(new_n104_), .b(x05), .O(new_n148_));
  nand3  g115(.a(new_n39_), .b(x21), .c(new_n44_), .O(new_n149_));
  nand4  g116(.a(new_n149_), .b(new_n106_), .c(new_n105_), .d(new_n148_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n147_), .c(x16), .O(new_n151_));
  inv1   g118(.a(new_n109_), .O(z7));
  nand2  g119(.a(z7), .b(new_n63_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n151_), .c(new_n145_), .O(z4));
  nand2  g121(.a(x20), .b(new_n101_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n35_), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(new_n36_), .c(x03), .O(new_n157_));
  nand2  g124(.a(new_n59_), .b(x14), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(x06), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x11), .c(new_n34_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n109_), .c(new_n157_), .d(new_n49_), .O(z6));
endmodule
