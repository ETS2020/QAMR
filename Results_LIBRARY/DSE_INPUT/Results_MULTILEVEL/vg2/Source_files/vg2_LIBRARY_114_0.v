...
module FAU ( 
  ...
  nand2  g116(.a(new_n72_), .b(x17), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n67_), .c(x16), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x08), .c(z5), .O(new_n152_));
  ...
  nand4  g122(.a(new_n99_), .b(new_n69_), .c(x07), .d(x04), .O(new_n156_));
  oai21  g123(.a(new_n155_), .b(new_n91_), .c(new_n156_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n136_), .c(x24), .O(new_n158_));
  nand3  g125(.a(new_n39_), .b(x13), .c(x05), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n136_), .O(new_n160_));
  inv1   g127(.a(x15), .O(new_n161_));
  nand4  g128(.a(new_n99_), .b(x19), .c(new_n69_), .d(x04), .O(new_n162_));
  oai21  g129(.a(new_n155_), .b(new_n161_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nor2   g131(.a(new_n155_), .b(x24), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n164_), .c(new_n158_), .d(new_n152_), .O(z4));
  ...
  oai22  g140(.a(new_n173_), .b(new_n124_), .c(new_n170_), .d(new_n49_), .O(z6));
  inv1   g141(.a(new_n124_), .O(z7));
endmodule
