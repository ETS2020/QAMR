...
module FAU ( 
  ...
  nand3  g088(.a(new_n39_), .b(x21), .c(new_n43_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  and2   g090(.a(new_n123_), .b(x20), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x14), .c(x11), .d(x06), .O(new_n125_));
  nor3   g092(.a(new_n125_), .b(new_n34_), .c(new_n64_), .O(z2));
  ...
  nand4  g120(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n121_), .c(new_n120_), .O(new_n155_));
  nor2   g122(.a(new_n155_), .b(new_n118_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n153_), .c(new_n150_), .d(new_n49_), .O(z4));
  ...
  inv1   g128(.a(new_n156_), .O(z7));
  oai21  g129(.a(new_n36_), .b(x06), .c(x03), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(z7), .O(new_n164_));
  nand4  g131(.a(new_n123_), .b(new_n71_), .c(x14), .d(x11), .O(new_n165_));
