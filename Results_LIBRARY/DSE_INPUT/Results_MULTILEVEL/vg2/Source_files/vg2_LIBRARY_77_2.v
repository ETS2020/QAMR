...
module FAU ( 
  ...
  oai21  g127(.a(x20), .b(new_n68_), .c(x06), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n54_), .c(x24), .O(new_n163_));
  nand3  g130(.a(new_n112_), .b(x14), .c(x03), .O(new_n164_));
  oai21  g131(.a(new_n86_), .b(x06), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(x24), .c(x18), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n123_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n163_), .c(x11), .O(new_n168_));
  inv1   g135(.a(new_n86_), .O(new_n169_));
  nand3  g136(.a(new_n39_), .b(x13), .c(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g138(.a(x20), .b(x19), .c(new_n68_), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(new_n35_), .c(x11), .O(new_n173_));
  nand2  g140(.a(x15), .b(new_n34_), .O(new_n174_));
  oai21  g141(.a(new_n111_), .b(new_n34_), .c(new_n174_), .O(new_n175_));
  oai21  g142(.a(new_n175_), .b(new_n173_), .c(new_n171_), .O(new_n176_));
  inv1   g143(.a(x00), .O(new_n177_));
  oai21  g144(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n179_));
  nand3  g146(.a(new_n169_), .b(x20), .c(new_n68_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n35_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(x24), .c(x07), .O(new_n182_));
  oai21  g149(.a(new_n179_), .b(new_n177_), .c(new_n182_), .O(new_n183_));
  nand2  g150(.a(x21), .b(new_n34_), .O(new_n184_));
  oai21  g151(.a(new_n34_), .b(new_n177_), .c(new_n184_), .O(new_n185_));
  nand4  g152(.a(new_n185_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n186_));
  nand2  g153(.a(x07), .b(x03), .O(new_n187_));
  oai21  g154(.a(new_n91_), .b(x03), .c(new_n187_), .O(new_n188_));
  nand3  g155(.a(new_n188_), .b(new_n169_), .c(x24), .O(new_n189_));
  nand2  g156(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  aoi21  g157(.a(new_n183_), .b(new_n36_), .c(new_n190_), .O(new_n191_));
  nand3  g158(.a(new_n191_), .b(new_n176_), .c(new_n168_), .O(z6));
  inv1   g159(.a(new_n126_), .O(z7));
endmodule
