...
module FAU ( 
  ...
  nor2   g101(.a(new_n53_), .b(new_n66_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n130_), .c(x19), .d(new_n53_), .O(new_n139_));
