...
module FAU ( 
  ...
  nand4  g089(.a(new_n122_), .b(x14), .c(x06), .d(x03), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(new_n64_), .O(z2));
  nand2  g091(.a(new_n57_), .b(new_n56_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x20), .c(x14), .d(x08), .O(new_n126_));
  ...
  nor2   g100(.a(new_n53_), .b(new_n66_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n137_), .b(new_n136_), .c(new_n66_), .d(x07), .O(new_n138_));
  aoi21  g105(.a(new_n138_), .b(new_n135_), .c(new_n81_), .O(new_n139_));
  nand4  g106(.a(new_n134_), .b(new_n133_), .c(x20), .d(x15), .O(new_n140_));
  nand4  g107(.a(new_n136_), .b(new_n106_), .c(new_n36_), .d(new_n66_), .O(new_n141_));
  ...
  nand2  g121(.a(x11), .b(new_n35_), .O(new_n155_));
  nand2  g122(.a(new_n69_), .b(x14), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n155_), .c(x03), .O(new_n157_));
  inv1   g124(.a(new_n157_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n121_), .c(new_n154_), .d(new_n49_), .O(z6));
