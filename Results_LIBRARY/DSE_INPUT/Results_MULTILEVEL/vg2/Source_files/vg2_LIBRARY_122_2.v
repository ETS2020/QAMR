...
module FAU ( 
  ...
  nor3   g026(.a(new_n59_), .b(new_n36_), .c(new_n54_), .O(new_n60_));
  ...
  nand4  g041(.a(new_n74_), .b(new_n54_), .c(new_n35_), .d(new_n66_), .O(new_n75_));
  ...
  nor4   g050(.a(new_n83_), .b(new_n82_), .c(new_n36_), .d(new_n54_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  nor3   g052(.a(x04), .b(x03), .c(x01), .O(new_n86_));
  inv1   g053(.a(x08), .O(new_n87_));
  nand4  g054(.a(new_n35_), .b(new_n66_), .c(new_n87_), .d(x07), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  nor3   g056(.a(x16), .b(x14), .c(x12), .O(new_n90_));
  nand4  g057(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n91_));
  ...
  nand4  g065(.a(new_n54_), .b(new_n35_), .c(new_n66_), .d(new_n87_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nor3   g067(.a(x17), .b(x16), .c(x14), .O(new_n101_));
  nand4  g068(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(x19), .O(new_n102_));
  ...
  nor4   g087(.a(new_n120_), .b(new_n53_), .c(new_n34_), .d(new_n64_), .O(new_n121_));
  nand2  g088(.a(new_n71_), .b(new_n70_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n68_), .c(new_n36_), .d(new_n35_), .O(new_n123_));
  nor4   g090(.a(new_n123_), .b(x08), .c(x03), .d(x01), .O(new_n124_));
  ...
  nand3  g095(.a(x07), .b(new_n34_), .c(new_n64_), .O(new_n129_));
  nand4  g096(.a(new_n68_), .b(new_n36_), .c(new_n35_), .d(new_n87_), .O(new_n130_));
  ...
  nand3  g100(.a(new_n87_), .b(new_n34_), .c(new_n64_), .O(new_n134_));
  nand4  g101(.a(new_n68_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n135_));
  ...
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n66_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n82_), .c(x08), .O(new_n141_));
  aoi21  g108(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n69_), .c(x09), .O(new_n143_));
  ...
  aoi21  g113(.a(x11), .b(new_n53_), .c(new_n34_), .O(new_n147_));
