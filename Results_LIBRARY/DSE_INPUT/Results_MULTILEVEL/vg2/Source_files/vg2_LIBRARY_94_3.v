...
module FAU ( 
  ...
  aoi21  g55(.a(x11), .b(new_n55_), .c(new_n53_), .O(new_n90_));
  nand2  g56(.a(x20), .b(new_n35_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n55_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n34_), .c(x03), .O(new_n93_));
  oai22  g59(.a(new_n93_), .b(new_n49_), .c(new_n90_), .d(new_n88_), .O(z6));
  inv1   g60(.a(new_n88_), .O(z7));
  zero   g61(.O(z2));
endmodule
