...
module FAU ( 
  ...
  oai21  g021(.a(x10), .b(x02), .c(new_n54_), .O(new_n55_));
  ...
  nand4  g046(.a(new_n79_), .b(new_n36_), .c(new_n66_), .d(new_n65_), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(x06), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n64_), .c(new_n34_), .d(new_n63_), .O(new_n82_));
  ...
  nor4   g053(.a(new_n86_), .b(new_n64_), .c(new_n34_), .d(new_n63_), .O(new_n87_));
  ...
  nand4  g064(.a(new_n68_), .b(new_n67_), .c(new_n53_), .d(new_n36_), .O(new_n98_));
  nand4  g065(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n97_), .c(new_n96_), .d(new_n94_), .O(new_n101_));
  aoi21  g068(.a(new_n101_), .b(new_n93_), .c(new_n85_), .O(new_n102_));
  ...
  nand4  g075(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n53_), .O(new_n109_));
  inv1   g076(.a(x19), .O(new_n110_));
  nor2   g077(.a(x20), .b(new_n110_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n72_), .c(new_n71_), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n108_), .c(new_n107_), .d(new_n94_), .O(new_n114_));
  aoi21  g081(.a(new_n114_), .b(new_n106_), .c(x13), .O(new_n115_));
  aoi22  g082(.a(new_n115_), .b(new_n37_), .c(new_n102_), .d(x24), .O(new_n116_));
  nand2  g083(.a(new_n116_), .b(new_n84_), .O(z1));
  nor2   g084(.a(new_n39_), .b(new_n90_), .O(new_n118_));
  ...
  nand3  g089(.a(new_n39_), .b(new_n44_), .c(new_n43_), .O(new_n123_));
  ...
  nor3   g095(.a(new_n128_), .b(new_n34_), .c(new_n63_), .O(z2));
  nand4  g096(.a(new_n55_), .b(x20), .c(x14), .d(x11), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n65_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(x06), .c(x03), .d(x01), .O(new_n132_));
  nand4  g099(.a(new_n75_), .b(new_n70_), .c(new_n67_), .d(new_n36_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n135_));
  ...
  nor2   g106(.a(new_n67_), .b(new_n36_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n139_), .c(new_n91_), .O(new_n141_));
  nor2   g108(.a(x03), .b(x01), .O(new_n142_));
  nor2   g109(.a(x11), .b(x08), .O(new_n143_));
  nor2   g110(.a(x20), .b(x14), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n96_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n141_), .c(new_n85_), .O(new_n146_));
  nand4  g113(.a(new_n140_), .b(new_n139_), .c(x20), .d(x15), .O(new_n147_));
  nor2   g114(.a(x14), .b(x11), .O(new_n148_));
  nand4  g115(.a(new_n148_), .b(new_n142_), .c(new_n111_), .d(new_n107_), .O(new_n149_));
  ...
  aoi21  g119(.a(new_n72_), .b(x04), .c(x17), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n66_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n68_), .c(x08), .O(new_n155_));
  aoi21  g122(.a(x23), .b(new_n64_), .c(new_n69_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n71_), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x16), .c(new_n65_), .O(new_n158_));
  nand4  g125(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n124_), .c(new_n122_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n121_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n158_), .c(new_n155_), .d(new_n49_), .O(z4));
  inv1   g129(.a(new_n49_), .O(z5));
  oai21  g130(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  inv1   g132(.a(new_n85_), .O(new_n166_));
  oai21  g133(.a(x20), .b(new_n67_), .c(x06), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x11), .c(new_n34_), .O(new_n168_));
  nand4  g135(.a(x20), .b(new_n67_), .c(new_n36_), .d(x07), .O(new_n169_));
  oai21  g136(.a(new_n168_), .b(new_n90_), .c(new_n169_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n166_), .c(x24), .O(new_n171_));
  nand3  g138(.a(new_n39_), .b(x13), .c(x05), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n166_), .O(new_n173_));
  inv1   g140(.a(x15), .O(new_n174_));
  nand3  g141(.a(new_n148_), .b(x20), .c(x19), .O(new_n175_));
  oai21  g142(.a(new_n168_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  nor2   g144(.a(new_n168_), .b(x24), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n177_), .c(new_n171_), .d(new_n165_), .O(z6));
  inv1   g147(.a(new_n161_), .O(z7));
endmodule
