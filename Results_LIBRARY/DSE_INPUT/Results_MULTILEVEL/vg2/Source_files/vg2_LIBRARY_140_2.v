...
module FAU ( 
  ...
  nand4  g060(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n94_));
  ...
  nand4  g068(.a(new_n53_), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n102_));
  ...
  nand3  g073(.a(new_n106_), .b(new_n55_), .c(new_n70_), .O(new_n107_));
  ...
  nand4  g092(.a(new_n125_), .b(x20), .c(x11), .d(x08), .O(new_n126_));
  nor4   g093(.a(new_n126_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n127_));
  nand2  g094(.a(new_n72_), .b(new_n71_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n69_), .c(new_n36_), .d(new_n66_), .O(new_n129_));
  ...
  nand3  g102(.a(new_n135_), .b(new_n133_), .c(new_n87_), .O(new_n136_));
  nor3   g103(.a(x06), .b(x03), .c(x01), .O(new_n137_));
  nor2   g104(.a(x20), .b(x14), .O(new_n138_));
  nand4  g105(.a(new_n138_), .b(new_n137_), .c(new_n66_), .d(x07), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(new_n136_), .c(new_n81_), .O(new_n140_));
  nand4  g107(.a(new_n135_), .b(new_n133_), .c(x20), .d(x15), .O(new_n141_));
  nand4  g108(.a(new_n137_), .b(new_n106_), .c(new_n36_), .d(new_n66_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n141_), .c(x13), .O(new_n143_));
  aoi22  g110(.a(new_n143_), .b(new_n37_), .c(new_n140_), .d(x24), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n131_), .O(z3));
  aoi21  g112(.a(new_n55_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n67_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n54_), .c(x08), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n70_), .c(x09), .O(new_n150_));
  ...
  nand2  g120(.a(new_n134_), .b(x06), .O(new_n154_));
  nand2  g121(.a(x20), .b(new_n36_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n154_), .c(new_n34_), .O(new_n156_));
  inv1   g123(.a(new_n156_), .O(new_n157_));
  aoi21  g124(.a(x20), .b(x06), .c(new_n134_), .O(new_n158_));
  nor2   g125(.a(new_n158_), .b(new_n34_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n121_), .c(new_n157_), .d(new_n49_), .O(z6));
