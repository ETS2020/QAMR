...
module FAU ( 
  ...
  nand4  g047(.a(new_n80_), .b(new_n79_), .c(new_n61_), .d(new_n55_), .O(new_n81_));
  ...
  and2   g056(.a(x21), .b(x20), .O(new_n90_));
  nand4  g057(.a(new_n90_), .b(new_n79_), .c(new_n61_), .d(new_n55_), .O(new_n91_));
  inv1   g058(.a(x04), .O(new_n92_));
  inv1   g059(.a(x01), .O(new_n93_));
  nand4  g060(.a(new_n34_), .b(new_n43_), .c(new_n93_), .d(x00), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n82_), .c(new_n35_), .d(new_n92_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(new_n87_), .c(new_n91_), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n39_), .c(new_n44_), .O(new_n98_));
  ...
  aoi21  g069(.a(new_n102_), .b(new_n101_), .c(new_n37_), .O(new_n103_));
  nand3  g070(.a(x24), .b(x18), .c(x13), .O(new_n104_));
  nand3  g071(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n105_));
  nand4  g072(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n105_), .c(new_n104_), .O(new_n107_));
  nor2   g074(.a(new_n107_), .b(new_n103_), .O(new_n108_));
  nor3   g075(.a(new_n108_), .b(new_n59_), .c(new_n100_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(x11), .c(x06), .d(x03), .O(new_n110_));
  nor2   g077(.a(new_n110_), .b(new_n93_), .O(z2));
  nand3  g078(.a(x15), .b(x13), .c(x05), .O(new_n112_));
  nand3  g079(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n113_));
  ...
  nand4  g087(.a(new_n120_), .b(new_n59_), .c(new_n100_), .d(new_n36_), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(x08), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n35_), .c(new_n34_), .d(new_n93_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n80_), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n93_), .O(new_n128_));
  nand4  g095(.a(new_n59_), .b(new_n100_), .c(new_n36_), .d(new_n63_), .O(new_n129_));
  oai22  g096(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n74_), .c(x24), .O(new_n131_));
  nand4  g098(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n132_));
  nand4  g099(.a(new_n63_), .b(new_n35_), .c(new_n34_), .d(new_n93_), .O(new_n133_));
  nand3  g100(.a(new_n70_), .b(new_n100_), .c(new_n36_), .O(new_n134_));
  ...
  inv1   g112(.a(new_n108_), .O(z7));
  oai21  g113(.a(new_n140_), .b(x09), .c(x08), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(z7), .O(new_n148_));
  nand2  g115(.a(x23), .b(new_n92_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x17), .c(new_n141_), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(x18), .c(x16), .O(new_n151_));
  nand3  g118(.a(new_n140_), .b(x09), .c(x07), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n74_), .c(x24), .O(new_n154_));
  nand3  g121(.a(new_n150_), .b(x16), .c(x15), .O(new_n155_));
  nand3  g122(.a(x19), .b(new_n140_), .c(x09), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n76_), .O(new_n158_));
  nand3  g125(.a(new_n150_), .b(x21), .c(x16), .O(new_n159_));
  nand2  g126(.a(new_n140_), .b(x00), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand4  g128(.a(new_n161_), .b(new_n39_), .c(new_n44_), .d(x09), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n158_), .c(new_n154_), .O(new_n163_));
  inv1   g130(.a(new_n163_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n148_), .c(new_n145_), .O(z4));
  nand2  g132(.a(x20), .b(new_n100_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n35_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n36_), .c(x03), .O(new_n168_));
  nand2  g135(.a(new_n59_), .b(x14), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(x06), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(x11), .c(new_n34_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n108_), .c(new_n168_), .d(new_n49_), .O(z6));
endmodule
