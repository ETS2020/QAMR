...
module FAU ( 
  ...
  oai21  g78(.a(x23), .b(new_n57_), .c(x22), .O(new_n112_));
  nand2  g79(.a(new_n112_), .b(x09), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(x16), .c(new_n81_), .O(new_n114_));
  oai22  g81(.a(new_n114_), .b(new_n77_), .c(new_n111_), .d(new_n49_), .O(z4));
