...
module FAU ( 
  ...
  nand4  g039(.a(new_n37_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n73_));
  nand3  g040(.a(x19), .b(x13), .c(x05), .O(new_n74_));
  aoi21  g041(.a(new_n74_), .b(new_n73_), .c(x23), .O(new_n75_));
  nand4  g042(.a(new_n75_), .b(new_n72_), .c(new_n36_), .d(new_n71_), .O(new_n76_));
  nor3   g043(.a(new_n76_), .b(x16), .c(x12), .O(new_n77_));
  nand4  g044(.a(new_n77_), .b(new_n35_), .c(new_n70_), .d(new_n69_), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(x06), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n80_));
  ...
  nor4   g051(.a(new_n84_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n85_));
  ...
  nand4  g060(.a(new_n70_), .b(new_n69_), .c(x07), .d(new_n34_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  inv1   g062(.a(x16), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n37_), .c(new_n55_), .d(new_n35_), .O(new_n97_));
  nand4  g064(.a(new_n90_), .b(new_n72_), .c(new_n36_), .d(new_n71_), .O(new_n98_));
  ...
  nor3   g074(.a(x17), .b(x16), .c(x12), .O(new_n108_));
  nand4  g075(.a(new_n90_), .b(new_n72_), .c(new_n36_), .d(x19), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n93_), .O(new_n111_));
  ...
  nor3   g089(.a(new_n122_), .b(new_n36_), .c(new_n37_), .O(new_n123_));
  ...
  nand2  g096(.a(new_n74_), .b(new_n73_), .O(new_n130_));
  ...
  inv1   g100(.a(new_n83_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n36_), .b(new_n37_), .c(new_n35_), .d(new_n69_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n34_), .b(new_n67_), .c(new_n66_), .O(new_n142_));
  nand4  g109(.a(new_n36_), .b(x19), .c(new_n35_), .d(new_n69_), .O(new_n143_));
  ...
  aoi21  g113(.a(new_n90_), .b(x04), .c(x17), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x22), .c(new_n70_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n96_), .c(x08), .O(new_n149_));
  ...
  aoi21  g120(.a(x23), .b(new_n68_), .c(new_n71_), .O(new_n154_));
  ...
  aoi21  g132(.a(new_n36_), .b(x14), .c(new_n34_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n35_), .c(x03), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x15), .O(new_n168_));
  nor2   g135(.a(x20), .b(x06), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x11), .c(new_n67_), .O(new_n170_));
  ...
  oai21  g140(.a(new_n161_), .b(new_n88_), .c(new_n120_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n167_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n173_), .c(new_n163_), .O(z6));
  inv1   g143(.a(new_n122_), .O(z7));
endmodule
