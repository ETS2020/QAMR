// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:15 2020
...
module FAU ( 
  ...
  nand3  g048(.a(x17), .b(x16), .c(x12), .O(new_n82_));
  inv1   g049(.a(new_n82_), .O(new_n83_));
  and2   g050(.a(x20), .b(x18), .O(new_n84_));
  inv1   g051(.a(x22), .O(new_n85_));
  nor2   g052(.a(new_n55_), .b(new_n85_), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n84_), .c(new_n83_), .d(new_n81_), .O(new_n87_));
  ...
  nor3   g057(.a(x14), .b(x12), .c(x11), .O(new_n91_));
  nand4  g058(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(new_n54_), .O(new_n92_));
  ...
  nand3  g062(.a(x16), .b(x15), .c(x12), .O(new_n96_));
  nand3  g063(.a(new_n86_), .b(x20), .c(x17), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n81_), .O(new_n99_));
  nand4  g066(.a(new_n36_), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nor3   g068(.a(x16), .b(x14), .c(x12), .O(new_n102_));
  nand4  g069(.a(new_n55_), .b(new_n69_), .c(x19), .d(new_n68_), .O(new_n103_));
  ...
  nand2  g074(.a(new_n107_), .b(new_n79_), .O(z1));
  ...
  nor3   g084(.a(new_n117_), .b(new_n69_), .c(new_n109_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(x11), .c(x06), .d(x03), .O(new_n119_));
  nor2   g086(.a(new_n119_), .b(new_n64_), .O(z2));
  ...
  nand2  g091(.a(new_n71_), .b(new_n70_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n69_), .c(new_n109_), .d(new_n36_), .O(new_n126_));
  ...
  nand2  g097(.a(new_n46_), .b(new_n37_), .O(new_n131_));
  nand4  g098(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n132_));
  nand3  g099(.a(new_n84_), .b(x14), .c(x11), .O(new_n133_));
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n134_));
  nand4  g101(.a(new_n69_), .b(new_n109_), .c(new_n36_), .d(new_n66_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n139_));
  nand4  g106(.a(new_n69_), .b(x19), .c(new_n109_), .d(new_n36_), .O(new_n140_));
  ...
  aoi21  g112(.a(new_n145_), .b(new_n54_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n65_), .c(new_n68_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n85_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n66_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n117_), .c(new_n146_), .d(new_n49_), .O(z4));
  inv1   g117(.a(new_n49_), .O(z5));
  nand2  g118(.a(x20), .b(new_n109_), .O(new_n152_));
  ...
  oai22  g124(.a(new_n157_), .b(new_n117_), .c(new_n154_), .d(new_n49_), .O(z6));
  inv1   g125(.a(new_n117_), .O(z7));
endmodule
