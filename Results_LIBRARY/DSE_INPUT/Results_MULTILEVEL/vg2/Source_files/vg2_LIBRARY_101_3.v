...
module FAU ( 
  ...
  oai21  g114(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(z5), .c(new_n36_), .O(new_n149_));
  ...
  oai22  g122(.a(new_n151_), .b(new_n155_), .c(new_n71_), .d(new_n34_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n78_), .O(new_n157_));
  inv1   g124(.a(x00), .O(new_n158_));
  nand3  g125(.a(new_n150_), .b(x21), .c(x11), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x03), .O(new_n161_));
  nand3  g128(.a(x21), .b(new_n34_), .c(new_n44_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n40_), .c(new_n45_), .O(new_n164_));
  nand4  g131(.a(new_n164_), .b(new_n157_), .c(new_n154_), .d(new_n149_), .O(z6));
  nand2  g132(.a(new_n34_), .b(x02), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n40_), .c(x21), .d(new_n45_), .O(new_n167_));
  nand4  g134(.a(new_n167_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(z7));
endmodule
