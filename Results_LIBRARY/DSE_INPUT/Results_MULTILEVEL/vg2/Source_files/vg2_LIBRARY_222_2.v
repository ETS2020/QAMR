...
module FAU ( 
  ...
  nand3  g070(.a(new_n103_), .b(new_n55_), .c(new_n69_), .O(new_n104_));
  ...
  nor3   g084(.a(new_n117_), .b(new_n68_), .c(new_n54_), .O(new_n118_));
  ...
  nor4   g089(.a(new_n122_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n123_));
  ...
  nor2   g097(.a(new_n36_), .b(new_n130_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n129_), .c(x18), .d(x14), .O(new_n132_));
  nor3   g099(.a(x06), .b(x03), .c(x01), .O(new_n133_));
  nor2   g100(.a(x20), .b(x14), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n133_), .c(new_n36_), .d(x07), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n132_), .c(new_n80_), .O(new_n136_));
  nand3  g103(.a(new_n131_), .b(new_n129_), .c(new_n95_), .O(new_n137_));
  nand4  g104(.a(new_n133_), .b(new_n103_), .c(new_n54_), .d(new_n36_), .O(new_n138_));
  ...
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n66_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n83_), .c(x08), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n69_), .c(x09), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n130_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n117_), .c(new_n144_), .d(new_n49_), .O(z4));
  ...
  nand2  g119(.a(new_n68_), .b(x14), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x06), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x11), .c(new_n34_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n117_), .c(new_n152_), .d(new_n49_), .O(z6));
  inv1   g123(.a(new_n117_), .O(z7));
endmodule
