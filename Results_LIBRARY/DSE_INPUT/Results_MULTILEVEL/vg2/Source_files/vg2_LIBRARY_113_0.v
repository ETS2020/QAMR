...
module FAU ( 
  ...
  nand3  g060(.a(new_n54_), .b(new_n93_), .c(x09), .O(new_n94_));
  ...
  nand3  g066(.a(new_n99_), .b(new_n95_), .c(new_n89_), .O(new_n100_));
  nand3  g067(.a(new_n100_), .b(new_n88_), .c(new_n75_), .O(z1));
  ...
  oai21  g074(.a(new_n107_), .b(new_n104_), .c(x11), .O(new_n108_));
  ...
  nand4  g078(.a(new_n111_), .b(x14), .c(x06), .d(x03), .O(new_n112_));
  nor2   g079(.a(new_n112_), .b(new_n90_), .O(z2));
  nand3  g080(.a(new_n54_), .b(x03), .c(x01), .O(new_n114_));
  nand4  g081(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n115_));
  nand3  g082(.a(new_n63_), .b(new_n34_), .c(new_n90_), .O(new_n116_));
  ...
  nand3  g088(.a(new_n81_), .b(new_n34_), .c(new_n90_), .O(new_n122_));
  ...
  nor3   g093(.a(new_n126_), .b(new_n117_), .c(x10), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n91_), .c(new_n54_), .d(x03), .O(new_n128_));
  ...
  nand4  g100(.a(new_n40_), .b(new_n93_), .c(new_n109_), .d(x00), .O(new_n134_));
  ...
  nand3  g112(.a(new_n93_), .b(new_n109_), .c(x00), .O(new_n146_));
  ...
  nand3  g116(.a(x21), .b(new_n93_), .c(new_n109_), .O(new_n150_));
  ...
  nand4  g120(.a(x15), .b(x13), .c(x11), .d(x05), .O(new_n154_));
  ...
  and2   g124(.a(new_n157_), .b(x19), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(x13), .c(new_n36_), .d(x05), .O(new_n159_));
  ...
  aoi21  g129(.a(new_n153_), .b(x11), .c(new_n34_), .O(new_n163_));
  aoi21  g130(.a(new_n157_), .b(new_n36_), .c(x03), .O(new_n164_));
  oai22  g131(.a(new_n164_), .b(new_n80_), .c(new_n163_), .d(new_n162_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n72_), .c(x24), .O(new_n166_));
  inv1   g133(.a(x15), .O(new_n167_));
  oai22  g134(.a(new_n164_), .b(new_n67_), .c(new_n163_), .d(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n44_), .c(new_n38_), .O(new_n169_));
