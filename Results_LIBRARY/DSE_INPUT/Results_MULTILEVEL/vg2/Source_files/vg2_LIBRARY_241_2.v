...
module FAU ( 
  ...
  nor2   g020(.a(new_n53_), .b(new_n34_), .O(new_n54_));
  nand2  g021(.a(new_n54_), .b(x01), .O(new_n55_));
  ...
  nand3  g044(.a(new_n38_), .b(x13), .c(x05), .O(new_n78_));
  ...
  nand3  g048(.a(new_n61_), .b(x20), .c(x18), .O(new_n82_));
  ...
  nand3  g054(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(new_n88_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n54_), .c(new_n42_), .d(x01), .O(new_n96_));
  inv1   g063(.a(new_n81_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n61_), .c(x21), .d(x20), .O(new_n98_));
  ...
  oai22  g068(.a(new_n101_), .b(new_n92_), .c(new_n98_), .d(new_n96_), .O(new_n102_));
  nand3  g069(.a(new_n102_), .b(new_n38_), .c(new_n43_), .O(new_n103_));
  ...
  nand4  g079(.a(new_n38_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nor2   g081(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  nor3   g082(.a(new_n115_), .b(new_n107_), .c(new_n106_), .O(new_n116_));
  ...
  nand3  g087(.a(x21), .b(new_n43_), .c(new_n42_), .O(new_n121_));
  ...
  nand3  g092(.a(new_n43_), .b(new_n42_), .c(x00), .O(new_n126_));
  nand3  g093(.a(x19), .b(x13), .c(x05), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n107_), .c(new_n106_), .d(new_n36_), .O(new_n129_));
  nor2   g096(.a(new_n129_), .b(x08), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n35_), .c(new_n34_), .d(new_n105_), .O(new_n131_));
  ...
  nor2   g102(.a(new_n106_), .b(new_n36_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n139_), .b(new_n138_), .c(new_n99_), .d(new_n86_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n137_), .c(new_n76_), .O(new_n141_));
  nand4  g108(.a(new_n136_), .b(new_n135_), .c(x20), .d(x15), .O(new_n142_));
  nor2   g109(.a(x14), .b(x11), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n99_), .c(new_n72_), .d(new_n67_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n142_), .c(x13), .O(new_n145_));
  aoi22  g112(.a(new_n145_), .b(new_n45_), .c(new_n141_), .d(x24), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n133_), .O(z3));
  inv1   g114(.a(new_n49_), .O(z5));
  oai21  g115(.a(x16), .b(new_n65_), .c(new_n119_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(z5), .O(new_n150_));
  inv1   g117(.a(x16), .O(new_n151_));
  inv1   g118(.a(x17), .O(new_n152_));
  oai21  g119(.a(x23), .b(new_n53_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n40_), .b(x05), .O(new_n154_));
  nand3  g121(.a(new_n38_), .b(new_n43_), .c(x00), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n47_), .c(new_n41_), .d(new_n154_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n153_), .c(new_n59_), .d(new_n151_), .O(new_n157_));
  inv1   g124(.a(new_n115_), .O(z7));
  oai21  g125(.a(new_n60_), .b(x04), .c(x17), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(x22), .c(new_n65_), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n151_), .c(x08), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z7), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n157_), .c(new_n150_), .O(z4));
  nand2  g130(.a(x20), .b(new_n106_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n35_), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(new_n36_), .c(x03), .O(new_n166_));
  nand2  g133(.a(new_n107_), .b(x14), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(x06), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x11), .c(new_n34_), .O(new_n169_));
  oai22  g136(.a(new_n169_), .b(new_n115_), .c(new_n166_), .d(new_n49_), .O(z6));
endmodule
