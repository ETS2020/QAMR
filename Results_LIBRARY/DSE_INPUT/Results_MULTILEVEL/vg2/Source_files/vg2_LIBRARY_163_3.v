// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:39 2020
...
module FAU ( 
  ...
  aoi21  g114(.a(new_n147_), .b(new_n35_), .c(x11), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x03), .c(z5), .O(new_n149_));
  inv1   g116(.a(new_n144_), .O(z7));
  oai21  g117(.a(new_n36_), .b(x06), .c(x03), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(z7), .O(new_n152_));
  nand2  g119(.a(new_n110_), .b(new_n105_), .O(new_n153_));
  nand4  g120(.a(new_n153_), .b(new_n37_), .c(x14), .d(x11), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n152_), .c(new_n149_), .O(z6));
endmodule
