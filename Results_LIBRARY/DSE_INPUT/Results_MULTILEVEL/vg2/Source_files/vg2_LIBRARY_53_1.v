...
module FAU ( 
  ...
  nand3  g055(.a(x17), .b(x16), .c(x12), .O(new_n89_));
  ...
  nor2   g082(.a(new_n39_), .b(new_n91_), .O(new_n116_));
  nand4  g083(.a(new_n39_), .b(x15), .c(x14), .d(x13), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n116_), .c(x05), .O(new_n119_));
  ...
  nand2  g089(.a(new_n122_), .b(x14), .O(new_n123_));
  nand2  g090(.a(new_n116_), .b(x13), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n123_), .c(new_n119_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(x20), .c(x11), .d(x06), .O(new_n126_));
  nor3   g093(.a(new_n126_), .b(new_n34_), .c(new_n64_), .O(z2));
  ...
  nand3  g104(.a(new_n92_), .b(x11), .c(x08), .O(new_n138_));
  ...
  nand3  g115(.a(new_n148_), .b(new_n142_), .c(new_n135_), .O(z3));
  aoi21  g116(.a(new_n73_), .b(x04), .c(x17), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(x22), .c(new_n67_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n69_), .c(x08), .O(new_n152_));
  aoi21  g119(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n72_), .c(x09), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x16), .c(new_n66_), .O(new_n155_));
  inv1   g122(.a(new_n116_), .O(new_n156_));
  nand3  g123(.a(new_n39_), .b(x15), .c(x13), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n156_), .c(new_n37_), .O(new_n158_));
  nand3  g125(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n159_));
  nor2   g126(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n155_), .c(new_n152_), .d(new_n49_), .O(z4));
  inv1   g128(.a(new_n49_), .O(z5));
  nand2  g129(.a(x20), .b(new_n68_), .O(new_n163_));
  ...
  nand2  g133(.a(new_n71_), .b(x14), .O(new_n167_));
  ...
  aoi21  g137(.a(new_n170_), .b(new_n136_), .c(new_n169_), .O(new_n171_));
  oai22  g138(.a(new_n171_), .b(new_n166_), .c(new_n168_), .d(new_n34_), .O(new_n172_));
  oai21  g139(.a(new_n71_), .b(new_n35_), .c(x11), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(x03), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n136_), .c(x24), .d(x18), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(new_n172_), .c(new_n165_), .O(z6));
  inv1   g143(.a(new_n160_), .O(z7));
endmodule
