...
module FAU ( 
  ...
  nand4  g065(.a(new_n69_), .b(new_n68_), .c(new_n53_), .d(new_n36_), .O(new_n99_));
  ...
  nand3  g089(.a(x15), .b(new_n46_), .c(new_n37_), .O(new_n123_));
  nand4  g090(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(new_n125_));
  nor2   g092(.a(new_n125_), .b(new_n121_), .O(new_n126_));
  nor3   g093(.a(new_n126_), .b(new_n71_), .c(new_n68_), .O(new_n127_));
  ...
  nand4  g099(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x08), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n135_));
  ...
  nor2   g106(.a(new_n68_), .b(new_n36_), .O(new_n140_));
  ...
  aoi21  g122(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n72_), .c(x09), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x16), .c(new_n66_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n126_), .c(new_n155_), .d(new_n49_), .O(z4));
  inv1   g126(.a(new_n49_), .O(z5));
  oai21  g127(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z5), .O(new_n162_));
  inv1   g129(.a(new_n86_), .O(new_n163_));
  oai21  g130(.a(x20), .b(new_n68_), .c(x06), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  nand2  g132(.a(new_n36_), .b(x07), .O(new_n166_));
  nand2  g133(.a(x20), .b(new_n68_), .O(new_n167_));
  oai22  g134(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(new_n91_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n163_), .c(x24), .O(new_n169_));
  nand3  g136(.a(new_n39_), .b(x13), .c(x05), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n163_), .O(new_n171_));
  inv1   g138(.a(x15), .O(new_n172_));
  nand3  g139(.a(new_n148_), .b(x20), .c(x19), .O(new_n173_));
  oai21  g140(.a(new_n165_), .b(new_n172_), .c(new_n173_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  aoi21  g142(.a(new_n68_), .b(x06), .c(new_n36_), .O(new_n176_));
  oai21  g143(.a(new_n176_), .b(new_n34_), .c(x21), .O(new_n177_));
  oai21  g144(.a(new_n167_), .b(x11), .c(new_n177_), .O(new_n178_));
  nand4  g145(.a(new_n178_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n179_));
  nand4  g146(.a(new_n179_), .b(new_n175_), .c(new_n169_), .d(new_n162_), .O(z6));
  inv1   g147(.a(new_n126_), .O(z7));
endmodule
