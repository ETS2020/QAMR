...
module FAU ( 
  ...
  aoi21  g129(.a(new_n162_), .b(new_n134_), .c(new_n161_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n158_), .c(new_n160_), .d(new_n34_), .O(new_n164_));
  oai21  g131(.a(new_n36_), .b(x06), .c(x03), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n134_), .c(x24), .d(x18), .O(new_n166_));
  nand3  g133(.a(new_n166_), .b(new_n164_), .c(new_n157_), .O(z6));
  inv1   g134(.a(new_n122_), .O(z7));
endmodule
