...
module FAU ( 
  ...
  oai22  g120(.a(new_n153_), .b(new_n123_), .c(new_n150_), .d(new_n49_), .O(z4));
  inv1   g121(.a(new_n49_), .O(z5));
  oai21  g122(.a(x20), .b(new_n68_), .c(x06), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n157_));
  nand4  g124(.a(x15), .b(x13), .c(new_n35_), .d(x05), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n157_), .c(x24), .O(new_n159_));
  nand3  g126(.a(new_n135_), .b(x24), .c(x18), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n120_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n35_), .O(new_n162_));
  nor2   g129(.a(new_n68_), .b(new_n34_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(x24), .c(new_n71_), .d(x18), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n159_), .c(x11), .O(new_n166_));
  nand3  g133(.a(new_n39_), .b(x13), .c(x05), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n135_), .O(new_n168_));
  inv1   g135(.a(x19), .O(new_n169_));
  oai21  g136(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n170_));
  aoi21  g137(.a(new_n170_), .b(new_n36_), .c(x03), .O(new_n171_));
  nand2  g138(.a(x15), .b(new_n34_), .O(new_n172_));
  ...
  oai22  g142(.a(new_n171_), .b(new_n175_), .c(new_n91_), .d(x03), .O(new_n176_));
  nand3  g143(.a(new_n176_), .b(new_n135_), .c(x24), .O(new_n177_));
  inv1   g144(.a(x00), .O(new_n178_));
  nand2  g145(.a(x21), .b(new_n34_), .O(new_n179_));
  oai21  g146(.a(new_n171_), .b(new_n178_), .c(new_n179_), .O(new_n180_));
  nand4  g147(.a(new_n180_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n181_));
  nand4  g148(.a(new_n181_), .b(new_n177_), .c(new_n174_), .d(new_n166_), .O(z6));
  inv1   g149(.a(new_n123_), .O(z7));
endmodule
