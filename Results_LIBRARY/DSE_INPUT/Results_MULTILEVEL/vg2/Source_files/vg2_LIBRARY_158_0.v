...
module FAU ( 
  ...
  nand4  g044(.a(new_n77_), .b(new_n70_), .c(new_n69_), .d(new_n36_), .O(new_n78_));
  nor2   g045(.a(new_n78_), .b(x12), .O(new_n79_));
  nand4  g046(.a(new_n79_), .b(new_n35_), .c(new_n68_), .d(new_n67_), .O(new_n80_));
  nor2   g047(.a(new_n80_), .b(x06), .O(new_n81_));
  nand4  g048(.a(new_n81_), .b(new_n66_), .c(new_n65_), .d(new_n64_), .O(new_n82_));
  ...
  nand4  g060(.a(new_n68_), .b(new_n67_), .c(x07), .d(new_n34_), .O(new_n94_));
  inv1   g061(.a(new_n94_), .O(new_n95_));
  nand4  g062(.a(new_n69_), .b(new_n36_), .c(new_n53_), .d(new_n35_), .O(new_n96_));
  ...
  nand4  g071(.a(new_n35_), .b(new_n68_), .c(new_n67_), .d(new_n34_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n70_), .b(new_n69_), .c(new_n36_), .d(new_n53_), .O(new_n107_));
  ...
  nor3   g088(.a(new_n121_), .b(new_n71_), .c(new_n36_), .O(new_n122_));
  ...
  nor2   g092(.a(new_n125_), .b(new_n67_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(x06), .c(x03), .d(x01), .O(new_n127_));
  nand4  g094(.a(new_n75_), .b(new_n71_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nor2   g095(.a(new_n128_), .b(x08), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n130_));
  ...
  nand2  g102(.a(new_n135_), .b(new_n90_), .O(new_n136_));
  nand4  g103(.a(x07), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n137_));
  nand4  g104(.a(new_n71_), .b(new_n36_), .c(new_n35_), .d(new_n67_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n134_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n133_), .c(x24), .O(new_n140_));
  nand3  g107(.a(new_n135_), .b(x20), .c(x15), .O(new_n141_));
  nand4  g108(.a(new_n67_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n142_));
  nand4  g109(.a(new_n71_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n143_));
  ...
  nand3  g112(.a(new_n145_), .b(new_n140_), .c(new_n132_), .O(z3));
  aoi21  g113(.a(new_n73_), .b(x04), .c(x17), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(x22), .c(new_n68_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n69_), .c(x08), .O(new_n149_));
  nand4  g116(.a(new_n39_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n150_));
  nand3  g117(.a(new_n150_), .b(new_n47_), .c(new_n42_), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n41_), .O(new_n152_));
  aoi21  g119(.a(x23), .b(new_n66_), .c(new_n70_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n72_), .c(x09), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x16), .c(new_n67_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n121_), .c(new_n152_), .d(new_n149_), .O(z4));
  inv1   g123(.a(new_n152_), .O(z5));
  inv1   g124(.a(new_n121_), .O(z7));
  oai21  g125(.a(new_n35_), .b(x06), .c(x03), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(z7), .O(new_n160_));
  nand3  g127(.a(new_n39_), .b(x13), .c(x05), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n133_), .O(new_n162_));
  inv1   g129(.a(x19), .O(new_n163_));
  oai21  g130(.a(new_n71_), .b(x14), .c(new_n34_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n35_), .c(x03), .O(new_n165_));
  nand3  g132(.a(new_n135_), .b(new_n71_), .c(x15), .O(new_n166_));
  ...
  nand3  g136(.a(new_n135_), .b(new_n71_), .c(x18), .O(new_n170_));
  oai21  g137(.a(new_n165_), .b(new_n169_), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n133_), .c(x24), .O(new_n172_));
  nor2   g139(.a(new_n165_), .b(x24), .O(new_n173_));
  nand4  g140(.a(new_n173_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n172_), .c(new_n168_), .d(new_n160_), .O(z6));
endmodule
