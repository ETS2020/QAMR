...
module FAU ( 
  ...
  nor2   g052(.a(new_n55_), .b(new_n69_), .O(new_n86_));
  ...
  nand4  g061(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(new_n67_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(new_n88_), .O(new_n97_));
  aoi21  g064(.a(new_n97_), .b(new_n87_), .c(new_n80_), .O(new_n98_));
  nand3  g065(.a(x16), .b(x15), .c(x12), .O(new_n99_));
  nand3  g066(.a(new_n86_), .b(x20), .c(x17), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n82_), .O(new_n102_));
  nor2   g069(.a(x08), .b(x06), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n53_), .c(new_n36_), .O(new_n104_));
  ...
  nand3  g075(.a(new_n108_), .b(new_n55_), .c(new_n69_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n106_), .c(new_n105_), .d(new_n88_), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(new_n102_), .c(x13), .O(new_n112_));
  aoi22  g079(.a(new_n112_), .b(new_n37_), .c(new_n98_), .d(x24), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n79_), .O(z1));
  ...
  nor3   g090(.a(new_n123_), .b(new_n68_), .c(new_n115_), .O(new_n124_));
  ...
  nand2  g097(.a(new_n71_), .b(new_n70_), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n68_), .c(new_n115_), .d(new_n36_), .O(new_n132_));
  ...
  nor2   g105(.a(new_n115_), .b(new_n36_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n138_), .c(new_n85_), .O(new_n140_));
  nor2   g107(.a(x03), .b(x01), .O(new_n141_));
  nor2   g108(.a(x20), .b(x14), .O(new_n142_));
  nand4  g109(.a(new_n142_), .b(new_n141_), .c(new_n91_), .d(new_n90_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n140_), .c(new_n80_), .O(new_n144_));
  nand4  g111(.a(new_n139_), .b(new_n138_), .c(x20), .d(x15), .O(new_n145_));
  nor2   g112(.a(x14), .b(x11), .O(new_n146_));
  nand4  g113(.a(new_n146_), .b(new_n141_), .c(new_n108_), .d(new_n103_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n145_), .c(x13), .O(new_n148_));
  aoi22  g115(.a(new_n148_), .b(new_n37_), .c(new_n144_), .d(x24), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n136_), .O(z3));
  inv1   g117(.a(x09), .O(new_n151_));
  aoi21  g118(.a(new_n55_), .b(x04), .c(x17), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x22), .c(new_n151_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n54_), .c(x08), .O(new_n154_));
  aoi21  g121(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n69_), .c(x09), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x16), .c(new_n66_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n123_), .c(new_n154_), .d(new_n49_), .O(z4));
  inv1   g125(.a(new_n49_), .O(z5));
  nand2  g126(.a(x20), .b(new_n115_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(new_n35_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n36_), .c(x03), .O(new_n162_));
  nand2  g129(.a(new_n68_), .b(x14), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(x06), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x11), .c(new_n34_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n123_), .c(new_n162_), .d(new_n49_), .O(z6));
  inv1   g133(.a(new_n123_), .O(z7));
endmodule
