...
module FAU ( 
  ...
  nand4  g116(.a(new_n149_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n150_));
  nand4  g117(.a(new_n70_), .b(x15), .c(x13), .d(x05), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n39_), .O(new_n153_));
  nand3  g120(.a(new_n136_), .b(x24), .c(x18), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n121_), .O(new_n155_));
  nand3  g122(.a(x24), .b(x23), .c(x18), .O(new_n156_));
  nor3   g123(.a(new_n156_), .b(new_n66_), .c(x04), .O(new_n157_));
  aoi21  g124(.a(new_n155_), .b(new_n70_), .c(new_n157_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n153_), .c(new_n72_), .O(new_n159_));
  nor2   g126(.a(new_n124_), .b(x09), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand3  g128(.a(new_n39_), .b(x13), .c(x05), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n136_), .O(new_n163_));
  inv1   g130(.a(x19), .O(new_n164_));
  aoi21  g131(.a(new_n73_), .b(x04), .c(x17), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x22), .c(new_n67_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n69_), .c(x08), .O(new_n167_));
  nand2  g134(.a(x15), .b(new_n66_), .O(new_n168_));
  oai21  g135(.a(new_n167_), .b(new_n164_), .c(new_n168_), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n163_), .O(new_n170_));
  inv1   g137(.a(x07), .O(new_n171_));
  oai22  g138(.a(new_n167_), .b(new_n171_), .c(new_n91_), .d(x08), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n136_), .c(x24), .O(new_n173_));
  inv1   g140(.a(x00), .O(new_n174_));
  nand2  g141(.a(x21), .b(new_n66_), .O(new_n175_));
  oai21  g142(.a(new_n167_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  nand4  g143(.a(new_n176_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n177_));
  nand4  g144(.a(new_n177_), .b(new_n173_), .c(new_n170_), .d(new_n161_), .O(z4));
  inv1   g145(.a(new_n49_), .O(z5));
  nand2  g146(.a(x20), .b(new_n68_), .O(new_n180_));
  nand2  g147(.a(new_n180_), .b(new_n35_), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(new_n36_), .c(x03), .O(new_n182_));
  nand2  g149(.a(new_n71_), .b(x14), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(x06), .O(new_n184_));
  aoi21  g151(.a(new_n184_), .b(x11), .c(new_n34_), .O(new_n185_));
  oai22  g152(.a(new_n185_), .b(new_n124_), .c(new_n182_), .d(new_n49_), .O(z6));
  inv1   g153(.a(new_n124_), .O(z7));
endmodule
