...
module FAU ( 
  ...
  aoi21  g54(.a(new_n88_), .b(x06), .c(x03), .O(new_n89_));
  inv1   g55(.a(x03), .O(new_n90_));
  inv1   g56(.a(x20), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x14), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x06), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(x11), .c(new_n90_), .O(new_n94_));
  oai22  g60(.a(new_n94_), .b(new_n59_), .c(new_n89_), .d(new_n80_), .O(z6));
  zero   g61(.O(z0));
endmodule
