// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:11 2020
...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n60_), .c(x07), .d(new_n35_), .O(new_n80_));
  ...
  oai22  g051(.a(new_n84_), .b(new_n80_), .c(new_n78_), .d(new_n55_), .O(new_n85_));
  nand3  g052(.a(new_n85_), .b(new_n70_), .c(x24), .O(new_n86_));
  inv1   g053(.a(x02), .O(new_n87_));
  nand4  g054(.a(x04), .b(x03), .c(new_n87_), .d(x01), .O(new_n88_));
  inv1   g055(.a(new_n88_), .O(new_n89_));
  inv1   g056(.a(x08), .O(new_n90_));
  inv1   g057(.a(x10), .O(new_n91_));
  nand3  g058(.a(x11), .b(new_n91_), .c(x09), .O(new_n92_));
  nor3   g059(.a(new_n92_), .b(new_n90_), .c(new_n35_), .O(new_n93_));
  inv1   g060(.a(x22), .O(new_n94_));
  inv1   g061(.a(x23), .O(new_n95_));
  nand2  g062(.a(x21), .b(x20), .O(new_n96_));
  nor4   g063(.a(new_n96_), .b(x24), .c(new_n95_), .d(new_n94_), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n93_), .c(new_n89_), .d(new_n75_), .O(new_n98_));
  nand3  g065(.a(new_n98_), .b(new_n86_), .c(new_n73_), .O(z1));
  ...
  nand4  g073(.a(new_n40_), .b(x21), .c(new_n91_), .d(new_n87_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n104_), .c(x20), .O(new_n109_));
  nor2   g076(.a(new_n109_), .b(new_n101_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(x11), .c(x06), .d(x03), .O(new_n111_));
  nor2   g078(.a(new_n111_), .b(new_n100_), .O(z2));
  nor2   g079(.a(new_n90_), .b(new_n35_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(x03), .c(x01), .O(new_n114_));
  nor2   g081(.a(new_n101_), .b(new_n36_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(x20), .c(x15), .O(new_n116_));
  nand3  g083(.a(new_n61_), .b(new_n34_), .c(new_n100_), .O(new_n117_));
  nand3  g084(.a(new_n66_), .b(new_n101_), .c(new_n36_), .O(new_n118_));
  ...
  nand4  g088(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n100_), .O(new_n122_));
  nand4  g089(.a(new_n37_), .b(new_n101_), .c(new_n36_), .d(new_n90_), .O(new_n123_));
  ...
  nor2   g092(.a(x02), .b(new_n100_), .O(new_n126_));
  ...
  nand4  g096(.a(new_n129_), .b(new_n126_), .c(new_n113_), .d(x03), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n125_), .c(new_n120_), .O(z3));
  nor2   g098(.a(new_n108_), .b(new_n104_), .O(new_n132_));
  inv1   g099(.a(x16), .O(new_n133_));
  aoi21  g100(.a(new_n95_), .b(x04), .c(x17), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x22), .c(new_n59_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n133_), .c(x08), .O(new_n136_));
  nand4  g103(.a(new_n40_), .b(new_n91_), .c(new_n87_), .d(x00), .O(new_n137_));
  nand3  g104(.a(new_n137_), .b(new_n45_), .c(new_n43_), .O(new_n138_));
  nor2   g105(.a(new_n138_), .b(new_n42_), .O(new_n139_));
  inv1   g106(.a(x04), .O(new_n140_));
  inv1   g107(.a(x17), .O(new_n141_));
  aoi21  g108(.a(x23), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n94_), .c(x09), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n90_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n132_), .c(new_n139_), .d(new_n136_), .O(z4));
  ...
  oai21  g118(.a(new_n150_), .b(new_n76_), .c(new_n151_), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n70_), .c(x24), .O(new_n153_));
  ...
  nor2   g124(.a(new_n150_), .b(x24), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(x21), .c(new_n91_), .d(new_n87_), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n157_), .c(new_n153_), .d(new_n148_), .O(z6));
  inv1   g127(.a(new_n132_), .O(z7));
endmodule
