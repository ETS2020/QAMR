...
module FAU ( 
  ...
  nand3  g024(.a(new_n57_), .b(x21), .c(x14), .O(new_n58_));
  ...
  nand4  g044(.a(new_n77_), .b(new_n70_), .c(new_n54_), .d(new_n69_), .O(new_n78_));
  ...
  nor2   g058(.a(new_n55_), .b(new_n72_), .O(new_n92_));
  ...
  nand4  g063(.a(new_n54_), .b(new_n69_), .c(new_n53_), .d(new_n36_), .O(new_n97_));
  nand4  g064(.a(new_n55_), .b(new_n72_), .c(new_n71_), .d(new_n70_), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n96_), .c(new_n94_), .O(new_n100_));
  aoi21  g067(.a(new_n100_), .b(new_n93_), .c(new_n85_), .O(new_n101_));
  ...
  nand4  g074(.a(new_n70_), .b(new_n54_), .c(new_n69_), .d(new_n53_), .O(new_n108_));
  nand4  g075(.a(new_n55_), .b(new_n72_), .c(new_n71_), .d(x19), .O(new_n109_));
  ...
  nand2  g080(.a(new_n113_), .b(new_n84_), .O(z1));
  ...
  oai21  g084(.a(new_n116_), .b(new_n69_), .c(new_n117_), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(x05), .O(new_n119_));
  nand2  g086(.a(new_n115_), .b(x13), .O(new_n120_));
  nand3  g087(.a(new_n57_), .b(new_n39_), .c(x21), .O(new_n121_));
  ...
  nor3   g093(.a(new_n126_), .b(new_n34_), .c(new_n65_), .O(z2));
  nand2  g094(.a(new_n58_), .b(new_n56_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(x20), .c(x11), .d(x08), .O(new_n129_));
  nor4   g096(.a(new_n129_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n130_));
  nand4  g097(.a(new_n75_), .b(new_n71_), .c(new_n69_), .d(new_n36_), .O(new_n131_));
  inv1   g098(.a(new_n131_), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n67_), .c(new_n35_), .d(new_n34_), .O(new_n133_));
  nor2   g100(.a(new_n133_), .b(x01), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n130_), .c(new_n39_), .O(new_n135_));
  inv1   g102(.a(new_n85_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n71_), .b(new_n69_), .c(new_n36_), .d(new_n67_), .O(new_n140_));
  ...
  nand3  g109(.a(x06), .b(x03), .c(x01), .O(new_n143_));
  nand4  g110(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n144_));
  nand4  g111(.a(new_n67_), .b(new_n35_), .c(new_n34_), .d(new_n65_), .O(new_n145_));
  nand4  g112(.a(new_n71_), .b(x19), .c(new_n69_), .d(new_n36_), .O(new_n146_));
  ...
  aoi21  g122(.a(new_n117_), .b(new_n116_), .c(new_n37_), .O(new_n156_));
  nand3  g123(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n157_));
  nor2   g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n155_), .c(new_n152_), .d(new_n49_), .O(z4));
  ...
  nand3  g132(.a(new_n136_), .b(x24), .c(x18), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n121_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand3  g135(.a(new_n39_), .b(x13), .c(x05), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n136_), .O(new_n170_));
  oai21  g137(.a(new_n71_), .b(new_n35_), .c(x11), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(x03), .O(new_n172_));
  nand3  g139(.a(new_n172_), .b(new_n170_), .c(x15), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n168_), .c(new_n163_), .O(z6));
  inv1   g141(.a(new_n158_), .O(z7));
endmodule
