...
module FAU ( 
  ...
  nand4  g038(.a(new_n71_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n72_));
  nand3  g039(.a(x19), .b(x13), .c(x05), .O(new_n73_));
  aoi21  g040(.a(new_n73_), .b(new_n72_), .c(x23), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n75_));
  nor3   g042(.a(new_n75_), .b(x14), .c(x12), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(new_n36_), .c(new_n67_), .d(new_n66_), .O(new_n77_));
  nor2   g044(.a(new_n77_), .b(x06), .O(new_n78_));
  nand4  g045(.a(new_n78_), .b(new_n65_), .c(new_n34_), .d(new_n64_), .O(new_n79_));
  ...
  nor2   g054(.a(new_n69_), .b(new_n87_), .O(new_n88_));
  inv1   g055(.a(x23), .O(new_n89_));
  nor2   g056(.a(new_n89_), .b(new_n70_), .O(new_n90_));
  ...
  nand4  g062(.a(new_n68_), .b(new_n95_), .c(new_n53_), .d(new_n36_), .O(new_n96_));
  nor2   g063(.a(x23), .b(x22), .O(new_n97_));
  nand3  g064(.a(new_n97_), .b(new_n69_), .c(new_n71_), .O(new_n98_));
  nor2   g065(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand3  g066(.a(new_n99_), .b(new_n94_), .c(new_n92_), .O(new_n100_));
  ...
  nand3  g075(.a(new_n97_), .b(new_n69_), .c(x19), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand4  g077(.a(new_n110_), .b(new_n108_), .c(new_n107_), .d(new_n92_), .O(new_n111_));
  ...
  nor3   g089(.a(new_n122_), .b(new_n69_), .c(new_n95_), .O(new_n123_));
  ...
  nand3  g095(.a(new_n44_), .b(new_n43_), .c(x00), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n73_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n69_), .c(new_n95_), .d(new_n36_), .O(new_n131_));
  ...
  inv1   g102(.a(new_n82_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n69_), .b(new_n95_), .c(new_n36_), .d(new_n66_), .O(new_n140_));
  ...
  nand4  g111(.a(new_n69_), .b(x19), .c(new_n95_), .d(new_n36_), .O(new_n145_));
  ...
  inv1   g115(.a(x07), .O(new_n149_));
  aoi21  g116(.a(x23), .b(new_n65_), .c(new_n71_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n70_), .c(x09), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  aoi21  g119(.a(new_n89_), .b(x04), .c(x17), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x22), .c(new_n67_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n68_), .c(x08), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n149_), .c(new_n152_), .d(new_n87_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n136_), .c(x24), .O(new_n157_));
  nand3  g124(.a(new_n39_), .b(x13), .c(x05), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n136_), .O(new_n159_));
  inv1   g126(.a(x15), .O(new_n160_));
  nand2  g127(.a(new_n97_), .b(x04), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n67_), .c(x16), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x08), .c(x19), .O(new_n163_));
  oai21  g130(.a(new_n152_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n159_), .O(new_n165_));
  inv1   g132(.a(x00), .O(new_n166_));
  inv1   g133(.a(x21), .O(new_n167_));
  oai22  g134(.a(new_n155_), .b(new_n166_), .c(new_n152_), .d(new_n167_), .O(new_n168_));
  nand4  g135(.a(new_n168_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n165_), .c(new_n157_), .O(z4));
  inv1   g137(.a(new_n49_), .O(z5));
  nand2  g138(.a(x20), .b(new_n95_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n35_), .O(new_n173_));
  aoi21  g140(.a(new_n173_), .b(new_n36_), .c(x03), .O(new_n174_));
  nand2  g141(.a(new_n69_), .b(x14), .O(new_n175_));
  nand2  g142(.a(new_n175_), .b(x06), .O(new_n176_));
  aoi21  g143(.a(new_n176_), .b(x11), .c(new_n34_), .O(new_n177_));
  oai22  g144(.a(new_n177_), .b(new_n122_), .c(new_n174_), .d(new_n49_), .O(z6));
  inv1   g145(.a(new_n122_), .O(z7));
endmodule
