...
module FAU ( 
  ...
  nand4  g022(.a(x15), .b(x14), .c(x13), .d(x05), .O(new_n56_));
  ...
  nand4  g059(.a(new_n54_), .b(new_n92_), .c(new_n53_), .d(new_n36_), .O(new_n93_));
  ...
  nand4  g070(.a(new_n66_), .b(new_n54_), .c(new_n92_), .d(new_n53_), .O(new_n104_));
  ...
  aoi21  g085(.a(new_n118_), .b(new_n117_), .c(new_n67_), .O(new_n119_));
  ...
  nand4  g089(.a(new_n122_), .b(x20), .c(x11), .d(x08), .O(new_n123_));
  nor4   g090(.a(new_n123_), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n124_));
  nand2  g091(.a(new_n70_), .b(new_n69_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n67_), .c(new_n92_), .d(new_n36_), .O(new_n126_));
  ...
  nand4  g100(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n134_));
  nand4  g101(.a(new_n67_), .b(new_n92_), .c(new_n36_), .d(new_n89_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n89_), .b(new_n35_), .c(new_n34_), .d(new_n80_), .O(new_n139_));
  nand4  g106(.a(new_n67_), .b(x19), .c(new_n92_), .d(new_n36_), .O(new_n140_));
  ...
  aoi21  g113(.a(x23), .b(new_n64_), .c(new_n66_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n68_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n89_), .O(new_n149_));
  nand3  g116(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n113_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n149_), .c(new_n146_), .d(new_n49_), .O(z4));
  inv1   g119(.a(new_n49_), .O(z5));
  nand2  g120(.a(x20), .b(new_n92_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n35_), .c(x11), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x03), .c(z5), .O(new_n156_));
  nand2  g123(.a(x20), .b(x06), .O(new_n157_));
  nand4  g124(.a(new_n157_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n158_));
  aoi21  g125(.a(new_n67_), .b(x14), .c(new_n35_), .O(new_n159_));
  inv1   g126(.a(new_n159_), .O(new_n160_));
  nand4  g127(.a(new_n160_), .b(x15), .c(x13), .d(x05), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n158_), .c(x24), .O(new_n162_));
  nand3  g129(.a(new_n131_), .b(x24), .c(x18), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(new_n115_), .c(new_n159_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n162_), .c(x11), .O(new_n165_));
  inv1   g132(.a(new_n151_), .O(z7));
  nand2  g133(.a(z7), .b(new_n34_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n165_), .c(new_n156_), .O(z6));
endmodule
