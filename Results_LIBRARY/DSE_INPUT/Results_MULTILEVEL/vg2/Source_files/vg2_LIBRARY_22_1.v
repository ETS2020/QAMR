...
module FAU ( 
  ...
  nor2   g137(.a(new_n163_), .b(x24), .O(new_n171_));
  nand4  g138(.a(new_n171_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n172_));
  nand4  g139(.a(new_n172_), .b(new_n170_), .c(new_n166_), .d(new_n158_), .O(z6));
endmodule
