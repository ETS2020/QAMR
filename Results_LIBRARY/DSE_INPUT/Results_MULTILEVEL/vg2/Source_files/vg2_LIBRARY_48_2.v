...
module FAU ( 
  ...
  oai21  g127(.a(x11), .b(new_n34_), .c(new_n61_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(x07), .O(new_n162_));
  aoi21  g129(.a(new_n67_), .b(x14), .c(new_n34_), .O(new_n163_));
  ...
  oai21  g136(.a(new_n169_), .b(new_n168_), .c(new_n164_), .O(new_n170_));
