...
module FAU ( 
  ...
  oai21  g114(.a(x11), .b(new_n34_), .c(new_n125_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(z5), .O(new_n149_));
  inv1   g116(.a(x18), .O(new_n150_));
  oai21  g117(.a(x20), .b(new_n36_), .c(x06), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x11), .c(new_n125_), .O(new_n152_));
  nand4  g119(.a(x20), .b(new_n36_), .c(new_n35_), .d(x07), .O(new_n153_));
  oai21  g120(.a(new_n152_), .b(new_n150_), .c(new_n153_), .O(new_n154_));
  nand3  g121(.a(new_n154_), .b(new_n72_), .c(x24), .O(new_n155_));
  inv1   g122(.a(x15), .O(new_n156_));
  nand4  g123(.a(x20), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n157_));
  oai21  g124(.a(new_n152_), .b(new_n156_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n74_), .O(new_n159_));
  nand2  g126(.a(new_n151_), .b(x11), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(x03), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(x21), .c(new_n105_), .O(new_n162_));
  nand4  g129(.a(x20), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n38_), .c(new_n43_), .O(new_n165_));
  nand4  g132(.a(new_n165_), .b(new_n159_), .c(new_n155_), .d(new_n149_), .O(z6));
  inv1   g133(.a(new_n133_), .O(z7));
endmodule
