...
module FAU ( 
  ...
  nand4  g047(.a(x12), .b(x11), .c(x08), .d(x06), .O(new_n81_));
  ...
  nor3   g083(.a(new_n116_), .b(new_n69_), .c(new_n53_), .O(new_n117_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n69_), .c(new_n53_), .d(new_n36_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n69_), .b(new_n53_), .c(new_n36_), .d(new_n66_), .O(new_n134_));
  ...
  nand4  g105(.a(new_n69_), .b(x19), .c(new_n53_), .d(new_n36_), .O(new_n139_));
  ...
  oai21  g113(.a(new_n146_), .b(new_n70_), .c(x09), .O(new_n147_));
  ...
  nand2  g120(.a(new_n69_), .b(x14), .O(new_n154_));
