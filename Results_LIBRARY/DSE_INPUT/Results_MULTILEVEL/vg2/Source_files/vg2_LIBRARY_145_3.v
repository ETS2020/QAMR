...
module FAU ( 
  ...
  oai21  g128(.a(new_n36_), .b(x06), .c(x03), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n113_), .c(x24), .d(x18), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n161_), .c(new_n158_), .O(z6));
  inv1   g131(.a(new_n153_), .O(z7));
endmodule
