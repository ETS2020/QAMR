...
module FAU ( 
  ...
  oai21  g108(.a(x11), .b(new_n34_), .c(new_n64_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  oai21  g110(.a(new_n35_), .b(x06), .c(x03), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n55_), .O(new_n145_));
  nor2   g112(.a(new_n70_), .b(x14), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n35_), .c(x00), .O(new_n147_));
  nand4  g114(.a(x21), .b(new_n70_), .c(x14), .d(x11), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n39_), .c(new_n38_), .O(new_n150_));
  nand2  g117(.a(new_n146_), .b(new_n35_), .O(new_n151_));
  nand3  g118(.a(new_n70_), .b(x15), .c(x11), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(x13), .c(x05), .O(new_n154_));
  nand4  g121(.a(new_n154_), .b(new_n150_), .c(new_n145_), .d(new_n143_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n37_), .O(new_n156_));
  inv1   g123(.a(new_n45_), .O(new_n157_));
  aoi21  g124(.a(new_n70_), .b(x14), .c(new_n34_), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(new_n35_), .c(x03), .O(new_n159_));
  aoi22  g126(.a(new_n159_), .b(x18), .c(new_n142_), .d(x07), .O(new_n160_));
  nand3  g127(.a(new_n146_), .b(new_n35_), .c(x07), .O(new_n161_));
  oai21  g128(.a(new_n160_), .b(new_n157_), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x24), .O(new_n163_));
  aoi21  g130(.a(x20), .b(x06), .c(new_n35_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n64_), .c(x15), .O(new_n165_));
  and2   g132(.a(x19), .b(x06), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n146_), .c(new_n35_), .O(new_n167_));
  nand2  g134(.a(x19), .b(x03), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n44_), .c(new_n43_), .O(new_n170_));
  nand3  g137(.a(new_n170_), .b(new_n163_), .c(new_n156_), .O(z6));
  inv1   g138(.a(new_n106_), .O(z7));
endmodule
