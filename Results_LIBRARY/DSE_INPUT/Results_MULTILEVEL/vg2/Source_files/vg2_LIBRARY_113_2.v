...
module FAU ( 
  ...
  nand2  g114(.a(new_n49_), .b(new_n41_), .O(new_n148_));
  oai21  g115(.a(new_n121_), .b(x14), .c(new_n34_), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n148_), .c(new_n35_), .O(new_n150_));
  inv1   g117(.a(x18), .O(new_n151_));
  oai21  g118(.a(x20), .b(new_n36_), .c(x06), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x11), .c(new_n125_), .O(new_n153_));
  nand2  g120(.a(x07), .b(x03), .O(new_n154_));
  oai21  g121(.a(new_n153_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n72_), .c(x24), .O(new_n156_));
  inv1   g123(.a(x15), .O(new_n157_));
  oai22  g124(.a(new_n153_), .b(new_n157_), .c(new_n67_), .d(new_n125_), .O(new_n158_));
  ...
  nand4  g129(.a(new_n162_), .b(new_n38_), .c(new_n43_), .d(new_n105_), .O(new_n163_));
  nand4  g130(.a(new_n163_), .b(new_n159_), .c(new_n156_), .d(new_n150_), .O(z6));
  inv1   g131(.a(new_n133_), .O(z7));
endmodule
