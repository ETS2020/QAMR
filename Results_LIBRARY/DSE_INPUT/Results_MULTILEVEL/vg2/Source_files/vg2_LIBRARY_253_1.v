...
module FAU ( 
  ...
  nor4   g048(.a(new_n81_), .b(new_n66_), .c(new_n34_), .d(new_n65_), .O(new_n82_));
  ...
  nand4  g087(.a(new_n120_), .b(x14), .c(x11), .d(x03), .O(new_n121_));
  ...
  nor4   g091(.a(new_n124_), .b(new_n53_), .c(new_n34_), .d(new_n65_), .O(new_n125_));
  ...
  nand3  g099(.a(x08), .b(x03), .c(x01), .O(new_n133_));
