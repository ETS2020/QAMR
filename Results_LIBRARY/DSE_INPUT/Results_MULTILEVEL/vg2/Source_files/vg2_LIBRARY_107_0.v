...
module FAU ( 
  ...
  aoi21  g54(.a(x14), .b(new_n88_), .c(x11), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(x03), .O(new_n90_));
  nand2  g56(.a(x11), .b(new_n88_), .O(new_n91_));
  inv1   g57(.a(x20), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x14), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n91_), .c(x03), .O(new_n94_));
  inv1   g60(.a(new_n94_), .O(new_n95_));
  oai22  g61(.a(new_n95_), .b(new_n59_), .c(new_n90_), .d(new_n80_), .O(z6));
  zero   g62(.O(z0));
endmodule
