...
module FAU ( 
  ...
  nor2   g099(.a(new_n111_), .b(new_n108_), .O(new_n133_));
  aoi21  g100(.a(new_n100_), .b(x04), .c(x17), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(x22), .c(new_n62_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n86_), .c(x08), .O(new_n136_));
  inv1   g103(.a(x04), .O(new_n137_));
  aoi21  g104(.a(x23), .b(new_n137_), .c(new_n83_), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(new_n99_), .c(x09), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x16), .c(new_n96_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n133_), .c(new_n136_), .d(new_n132_), .O(z4));
  inv1   g108(.a(new_n132_), .O(z5));
  nand2  g109(.a(x20), .b(new_n85_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n35_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n36_), .c(x03), .O(new_n145_));
  nand2  g112(.a(new_n37_), .b(x14), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x06), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x11), .c(new_n34_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n133_), .c(new_n145_), .d(new_n132_), .O(z6));
  inv1   g116(.a(new_n133_), .O(z7));
endmodule
