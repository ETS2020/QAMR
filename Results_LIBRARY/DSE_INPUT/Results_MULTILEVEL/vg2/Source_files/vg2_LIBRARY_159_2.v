...
module FAU ( 
  ...
  aoi21  g114(.a(new_n35_), .b(x06), .c(x03), .O(new_n148_));
  inv1   g115(.a(new_n133_), .O(z7));
  nand3  g116(.a(new_n121_), .b(x14), .c(x11), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x03), .O(new_n151_));
  nand3  g118(.a(x15), .b(x11), .c(new_n34_), .O(new_n152_));
  nand4  g119(.a(x20), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n74_), .O(new_n155_));
  nand3  g122(.a(x18), .b(x11), .c(new_n34_), .O(new_n156_));
  nand4  g123(.a(x20), .b(new_n36_), .c(new_n35_), .d(x07), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n72_), .c(x24), .O(new_n159_));
  nand4  g126(.a(x20), .b(new_n36_), .c(new_n35_), .d(x00), .O(new_n160_));
  nand2  g127(.a(x21), .b(x11), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n38_), .c(new_n43_), .d(new_n34_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n159_), .c(new_n155_), .O(new_n164_));
  aoi21  g131(.a(new_n151_), .b(z7), .c(new_n164_), .O(new_n165_));
  oai21  g132(.a(new_n148_), .b(new_n140_), .c(new_n165_), .O(z6));
endmodule
