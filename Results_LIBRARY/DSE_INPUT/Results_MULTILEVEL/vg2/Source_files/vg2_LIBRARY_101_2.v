...
module FAU ( 
  ...
  nand3  g106(.a(new_n139_), .b(new_n47_), .c(new_n42_), .O(new_n140_));
  aoi21  g107(.a(new_n40_), .b(x05), .c(new_n140_), .O(new_n141_));
  inv1   g108(.a(x04), .O(new_n142_));
  inv1   g109(.a(x17), .O(new_n143_));
  aoi21  g110(.a(x23), .b(new_n142_), .c(new_n143_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n76_), .c(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n120_), .O(new_n146_));
  oai22  g113(.a(new_n146_), .b(new_n133_), .c(new_n141_), .d(new_n137_), .O(z4));
  nand2  g114(.a(x03), .b(x02), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n43_), .c(x00), .O(new_n149_));
  ...
  nand3  g119(.a(new_n72_), .b(x24), .c(x07), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n152_), .c(new_n47_), .O(z5));
  oai21  g121(.a(new_n121_), .b(x14), .c(new_n34_), .O(new_n155_));
  nand3  g122(.a(new_n138_), .b(new_n125_), .c(x00), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n47_), .c(new_n42_), .d(new_n41_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n155_), .c(new_n35_), .O(new_n158_));
  inv1   g125(.a(x18), .O(new_n159_));
  oai21  g126(.a(x20), .b(new_n36_), .c(x06), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x11), .c(new_n125_), .O(new_n161_));
  nand2  g128(.a(x07), .b(x03), .O(new_n162_));
  oai21  g129(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n72_), .c(x24), .O(new_n164_));
  inv1   g131(.a(x15), .O(new_n165_));
  oai22  g132(.a(new_n161_), .b(new_n165_), .c(new_n67_), .d(new_n125_), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n74_), .O(new_n167_));
  nand3  g134(.a(new_n160_), .b(x21), .c(x11), .O(new_n168_));
  nand2  g135(.a(x03), .b(x00), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n105_), .O(new_n171_));
  nand2  g138(.a(x21), .b(new_n125_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n38_), .c(new_n43_), .O(new_n174_));
  nand4  g141(.a(new_n174_), .b(new_n167_), .c(new_n164_), .d(new_n158_), .O(z6));
  inv1   g142(.a(new_n133_), .O(z7));
endmodule
