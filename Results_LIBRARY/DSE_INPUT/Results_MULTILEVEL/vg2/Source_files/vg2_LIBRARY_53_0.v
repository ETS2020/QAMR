...
module FAU ( 
  ...
  aoi21  g067(.a(new_n100_), .b(new_n93_), .c(new_n86_), .O(new_n101_));
  ...
  nor3   g089(.a(new_n122_), .b(new_n71_), .c(new_n68_), .O(new_n123_));
  ...
  nand4  g108(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n142_));
  nand4  g109(.a(new_n71_), .b(x19), .c(new_n68_), .d(new_n36_), .O(new_n143_));
  ...
  oai21  g114(.a(new_n147_), .b(x22), .c(new_n67_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n69_), .c(x08), .O(new_n149_));
  aoi21  g116(.a(x23), .b(new_n65_), .c(new_n70_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n72_), .c(x09), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x16), .c(new_n66_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n122_), .c(new_n149_), .d(new_n49_), .O(z4));
  inv1   g120(.a(new_n49_), .O(z5));
  nand2  g121(.a(x20), .b(new_n68_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n35_), .c(x11), .O(new_n156_));
  inv1   g123(.a(x19), .O(new_n157_));
  nor2   g124(.a(x24), .b(new_n46_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x05), .c(new_n86_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n157_), .c(new_n45_), .O(new_n160_));
  oai21  g127(.a(new_n156_), .b(x03), .c(new_n160_), .O(new_n161_));
  oai21  g128(.a(x11), .b(new_n35_), .c(new_n34_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(x07), .O(new_n163_));
  aoi21  g130(.a(new_n71_), .b(x14), .c(new_n35_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n36_), .c(x03), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(x18), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n134_), .c(x24), .O(new_n168_));
  inv1   g135(.a(x15), .O(new_n169_));
  oai21  g136(.a(new_n159_), .b(new_n169_), .c(new_n120_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n165_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n168_), .c(new_n161_), .O(z6));
  inv1   g139(.a(new_n122_), .O(z7));
endmodule
