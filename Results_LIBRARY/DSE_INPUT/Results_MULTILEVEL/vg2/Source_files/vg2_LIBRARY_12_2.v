...
module FAU ( 
  ...
  nand3  g048(.a(x16), .b(x14), .c(x12), .O(new_n82_));
  inv1   g049(.a(new_n82_), .O(new_n83_));
  and2   g050(.a(x20), .b(x18), .O(new_n84_));
  nor2   g051(.a(new_n55_), .b(new_n68_), .O(new_n85_));
  nand4  g052(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n81_), .O(new_n86_));
  nor3   g053(.a(x06), .b(x03), .c(x01), .O(new_n87_));
  inv1   g054(.a(x08), .O(new_n88_));
  nand4  g055(.a(new_n36_), .b(new_n65_), .c(new_n88_), .d(x07), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nor3   g057(.a(x16), .b(x14), .c(x12), .O(new_n91_));
  nand4  g058(.a(new_n55_), .b(new_n68_), .c(new_n67_), .d(new_n66_), .O(new_n92_));
  inv1   g059(.a(new_n92_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(new_n87_), .O(new_n94_));
  aoi22  g061(.a(new_n94_), .b(new_n86_), .c(new_n46_), .d(new_n37_), .O(new_n95_));
  nand3  g062(.a(x15), .b(x14), .c(x12), .O(new_n96_));
  nand3  g063(.a(new_n85_), .b(x20), .c(x16), .O(new_n97_));
  nor2   g064(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g065(.a(new_n98_), .b(new_n81_), .O(new_n99_));
  nand4  g066(.a(new_n53_), .b(new_n36_), .c(new_n65_), .d(new_n88_), .O(new_n100_));
  inv1   g067(.a(new_n100_), .O(new_n101_));
  nor3   g068(.a(x17), .b(x16), .c(x14), .O(new_n102_));
  nand4  g069(.a(new_n55_), .b(new_n68_), .c(new_n67_), .d(x19), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n87_), .O(new_n105_));
  ...
  nor3   g083(.a(new_n116_), .b(new_n67_), .c(new_n54_), .O(new_n117_));
  ...
  nor2   g088(.a(new_n121_), .b(new_n88_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(x06), .c(x03), .d(x01), .O(new_n123_));
  nand2  g090(.a(new_n70_), .b(new_n69_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n67_), .c(new_n54_), .d(new_n36_), .O(new_n125_));
  ...
  nand4  g100(.a(new_n67_), .b(new_n54_), .c(new_n36_), .d(new_n88_), .O(new_n134_));
  ...
  nand4  g104(.a(new_n88_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n138_));
  nand4  g105(.a(new_n67_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n139_));
  ...
  nand2  g109(.a(new_n68_), .b(x17), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n65_), .c(x16), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n79_), .c(new_n66_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n68_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n88_), .O(new_n148_));
  ...
  nand2  g120(.a(new_n67_), .b(x14), .O(new_n154_));
