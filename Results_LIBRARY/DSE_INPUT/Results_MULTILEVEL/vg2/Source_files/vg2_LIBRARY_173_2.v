// Benchmark "FAU" written by ABC on Mon Jul 27 19:38:40 2020
...
module FAU ( 
  ...
  aoi21  g115(.a(new_n148_), .b(new_n34_), .c(x11), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x03), .c(z5), .O(new_n150_));
  inv1   g117(.a(new_n133_), .O(z7));
  oai21  g118(.a(new_n35_), .b(x06), .c(x03), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(z7), .O(new_n153_));
  inv1   g120(.a(new_n102_), .O(new_n154_));
  nand3  g121(.a(new_n38_), .b(x21), .c(new_n43_), .O(new_n155_));
  nand4  g122(.a(new_n155_), .b(new_n104_), .c(new_n103_), .d(new_n154_), .O(new_n156_));
  nand4  g123(.a(new_n156_), .b(new_n121_), .c(x14), .d(x11), .O(new_n157_));
