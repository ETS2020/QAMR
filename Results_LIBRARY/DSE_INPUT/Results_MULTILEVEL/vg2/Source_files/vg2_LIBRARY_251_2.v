...
module FAU ( 
  ...
  nand4  g049(.a(x23), .b(x20), .c(x18), .d(x17), .O(new_n83_));
  ...
  nand4  g061(.a(x23), .b(x20), .c(x17), .d(x16), .O(new_n95_));
  ...
  nor3   g082(.a(new_n115_), .b(new_n107_), .c(new_n54_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(x11), .c(x06), .d(x03), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n64_), .O(z2));
  nand2  g085(.a(new_n57_), .b(new_n56_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(x20), .c(x14), .d(x11), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n66_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(x06), .c(x03), .d(x01), .O(new_n122_));
  nand2  g089(.a(new_n72_), .b(new_n71_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n107_), .c(new_n54_), .d(new_n36_), .O(new_n124_));
  nor2   g091(.a(new_n124_), .b(x08), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n126_));
  ...
  nand4  g099(.a(new_n107_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n133_));
  ...
  nand4  g103(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n137_));
  nand4  g104(.a(new_n107_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n130_), .O(new_n139_));
  nand3  g106(.a(new_n139_), .b(new_n46_), .c(new_n37_), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n135_), .c(new_n128_), .O(z3));
  aoi21  g108(.a(new_n55_), .b(x04), .c(x17), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n67_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n68_), .c(x08), .O(new_n144_));
  ...
  oai22  g114(.a(new_n147_), .b(new_n115_), .c(new_n144_), .d(new_n49_), .O(z4));
  ...
  nand2  g119(.a(new_n107_), .b(x14), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x06), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x11), .c(new_n34_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n115_), .c(new_n152_), .d(new_n49_), .O(z6));
  inv1   g123(.a(new_n115_), .O(z7));
endmodule
