...
module FAU ( 
  ...
  nor3   g090(.a(new_n123_), .b(new_n71_), .c(new_n68_), .O(new_n124_));
  ...
  nand4  g096(.a(new_n76_), .b(new_n71_), .c(new_n68_), .d(new_n36_), .O(new_n130_));
  ...
  nor2   g103(.a(new_n68_), .b(new_n36_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n92_), .O(new_n138_));
  ...
  oai22  g121(.a(new_n154_), .b(new_n123_), .c(new_n151_), .d(new_n49_), .O(z4));
  ...
  nand2  g126(.a(new_n159_), .b(new_n56_), .O(new_n160_));
  nor2   g127(.a(new_n71_), .b(x14), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n36_), .c(x00), .O(new_n162_));
  nand3  g129(.a(new_n137_), .b(x21), .c(new_n71_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(new_n44_), .c(new_n43_), .O(new_n165_));
  inv1   g132(.a(new_n161_), .O(new_n166_));
  nand3  g133(.a(x15), .b(x14), .c(x11), .O(new_n167_));
  oai21  g134(.a(new_n166_), .b(x11), .c(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(x13), .c(x05), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n165_), .c(new_n160_), .d(new_n158_), .O(new_n170_));
  nand2  g137(.a(new_n170_), .b(new_n39_), .O(new_n171_));
  inv1   g138(.a(x19), .O(new_n172_));
  oai21  g139(.a(new_n172_), .b(new_n35_), .c(new_n166_), .O(new_n173_));
  nand3  g140(.a(new_n173_), .b(new_n46_), .c(new_n37_), .O(new_n174_));
  oai21  g141(.a(new_n86_), .b(new_n35_), .c(new_n166_), .O(new_n175_));
  nand3  g142(.a(new_n175_), .b(x24), .c(x07), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand2  g144(.a(new_n177_), .b(new_n36_), .O(new_n178_));
  oai21  g145(.a(x20), .b(new_n68_), .c(x06), .O(new_n179_));
  aoi21  g146(.a(new_n179_), .b(x11), .c(new_n34_), .O(new_n180_));
  nand2  g147(.a(x07), .b(x03), .O(new_n181_));
  oai21  g148(.a(new_n180_), .b(new_n91_), .c(new_n181_), .O(new_n182_));
  nand3  g149(.a(new_n182_), .b(new_n135_), .c(x24), .O(new_n183_));
  aoi21  g150(.a(new_n68_), .b(x06), .c(new_n36_), .O(new_n184_));
  oai21  g151(.a(new_n184_), .b(new_n34_), .c(x15), .O(new_n185_));
  oai21  g152(.a(new_n172_), .b(new_n34_), .c(new_n185_), .O(new_n186_));
  nand3  g153(.a(new_n186_), .b(new_n46_), .c(new_n37_), .O(new_n187_));
  nand4  g154(.a(new_n187_), .b(new_n183_), .c(new_n178_), .d(new_n171_), .O(z6));
  inv1   g155(.a(new_n123_), .O(z7));
endmodule
