...
module FAU ( 
  ...
  nand4  g041(.a(new_n74_), .b(new_n53_), .c(new_n35_), .d(new_n66_), .O(new_n75_));
  nor2   g042(.a(new_n75_), .b(x08), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(new_n34_), .c(new_n65_), .d(new_n64_), .O(new_n77_));
  ...
  nor2   g052(.a(new_n68_), .b(new_n85_), .O(new_n86_));
  nor2   g053(.a(new_n55_), .b(new_n69_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n88_));
  nor3   g055(.a(x06), .b(x04), .c(x01), .O(new_n89_));
  inv1   g056(.a(x08), .O(new_n90_));
  nand4  g057(.a(new_n35_), .b(new_n66_), .c(new_n90_), .d(x07), .O(new_n91_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n93_), .c(new_n92_), .d(new_n89_), .O(new_n96_));
  aoi22  g063(.a(new_n96_), .b(new_n88_), .c(new_n46_), .d(new_n37_), .O(new_n97_));
  nand3  g064(.a(x16), .b(x15), .c(x12), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nor2   g066(.a(new_n68_), .b(new_n67_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n99_), .c(new_n87_), .d(new_n82_), .O(new_n101_));
  nand4  g068(.a(new_n53_), .b(new_n35_), .c(new_n66_), .d(new_n90_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nor3   g070(.a(x17), .b(x16), .c(x14), .O(new_n104_));
  nand4  g071(.a(new_n55_), .b(new_n69_), .c(new_n68_), .d(x19), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n104_), .c(new_n103_), .d(new_n89_), .O(new_n107_));
  ...
  nand4  g091(.a(new_n124_), .b(x20), .c(x11), .d(x08), .O(new_n125_));
  nor4   g092(.a(new_n125_), .b(new_n34_), .c(new_n123_), .d(new_n64_), .O(new_n126_));
  nand2  g093(.a(new_n71_), .b(new_n70_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n68_), .c(new_n36_), .d(new_n35_), .O(new_n128_));
  nor4   g095(.a(new_n128_), .b(x08), .c(x06), .d(x01), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n126_), .c(new_n39_), .O(new_n130_));
  nand2  g097(.a(new_n46_), .b(new_n37_), .O(new_n131_));
  nand3  g098(.a(x06), .b(x03), .c(x01), .O(new_n132_));
  nand3  g099(.a(new_n86_), .b(x11), .c(x08), .O(new_n133_));
  nand3  g100(.a(x07), .b(new_n34_), .c(new_n64_), .O(new_n134_));
  nand4  g101(.a(new_n68_), .b(new_n36_), .c(new_n35_), .d(new_n90_), .O(new_n135_));
  ...
  nand4  g104(.a(x20), .b(x15), .c(x11), .d(x08), .O(new_n138_));
  nand3  g105(.a(new_n90_), .b(new_n34_), .c(new_n64_), .O(new_n139_));
  nand4  g106(.a(new_n68_), .b(x19), .c(new_n36_), .d(new_n35_), .O(new_n140_));
  ...
  aoi21  g113(.a(x23), .b(new_n65_), .c(new_n67_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n69_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n90_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n119_), .c(new_n146_), .d(new_n49_), .O(z4));
  inv1   g117(.a(new_n49_), .O(z5));
  nand2  g118(.a(x20), .b(new_n36_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n34_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n35_), .c(x03), .O(new_n154_));
  nand2  g121(.a(x20), .b(x06), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x11), .c(new_n123_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n119_), .c(new_n154_), .d(new_n49_), .O(z6));
