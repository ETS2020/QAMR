...
module FAU ( 
  ...
  nand4  g055(.a(new_n88_), .b(x15), .c(x14), .d(x13), .O(new_n89_));
  aoi21  g056(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(new_n90_));
  inv1   g057(.a(new_n87_), .O(new_n91_));
  nand2  g058(.a(new_n91_), .b(x13), .O(new_n92_));
  nand3  g059(.a(new_n41_), .b(x15), .c(x14), .O(new_n93_));
  nand2  g060(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(new_n90_), .c(x23), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(x20), .c(x17), .d(x16), .O(new_n97_));
  ...
  nand3  g068(.a(new_n101_), .b(new_n85_), .c(new_n76_), .O(z1));
  inv1   g069(.a(new_n90_), .O(new_n103_));
  inv1   g070(.a(x13), .O(new_n104_));
  nand3  g071(.a(x15), .b(new_n104_), .c(new_n86_), .O(new_n105_));
  inv1   g072(.a(x21), .O(new_n106_));
  nor2   g073(.a(x24), .b(new_n106_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n46_), .c(new_n45_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(x14), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n92_), .c(new_n103_), .O(new_n111_));
  nand4  g078(.a(new_n111_), .b(x20), .c(x11), .d(x06), .O(new_n112_));
  nor3   g079(.a(new_n112_), .b(new_n35_), .c(new_n34_), .O(z2));
  nand4  g080(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(x00), .O(new_n114_));
  nand4  g081(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n54_), .O(new_n115_));
  nand3  g082(.a(new_n66_), .b(x08), .c(x06), .O(new_n116_));
  nand4  g083(.a(new_n107_), .b(x20), .c(x14), .d(x11), .O(new_n117_));
  ...
  nand4  g086(.a(new_n43_), .b(new_n39_), .c(x19), .d(new_n38_), .O(new_n120_));
  nor3   g087(.a(new_n120_), .b(x11), .c(x08), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n36_), .c(new_n35_), .d(new_n34_), .O(new_n122_));
  nand3  g089(.a(new_n93_), .b(new_n92_), .c(new_n103_), .O(new_n123_));
  ...
  nand3  g093(.a(new_n126_), .b(new_n122_), .c(new_n119_), .O(z3));
  ...
  nand3  g098(.a(new_n88_), .b(x19), .c(x13), .O(new_n132_));
  oai21  g099(.a(new_n88_), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  nand3  g100(.a(x24), .b(x13), .c(x07), .O(new_n134_));
  nand4  g101(.a(new_n88_), .b(new_n46_), .c(new_n45_), .d(x00), .O(new_n135_));
  nand3  g102(.a(x19), .b(new_n104_), .c(new_n86_), .O(new_n136_));
  nand3  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n137_));
  aoi21  g104(.a(new_n133_), .b(x05), .c(new_n137_), .O(new_n138_));
  aoi21  g105(.a(x23), .b(new_n53_), .c(new_n59_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n78_), .c(x09), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x16), .c(new_n54_), .O(new_n141_));
  inv1   g108(.a(new_n92_), .O(new_n142_));
  nand3  g109(.a(new_n88_), .b(x15), .c(x13), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n87_), .c(new_n86_), .O(new_n144_));
  nor3   g111(.a(new_n144_), .b(new_n109_), .c(new_n142_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n141_), .c(new_n138_), .d(new_n130_), .O(z4));
  inv1   g113(.a(new_n138_), .O(z5));
  nand2  g114(.a(x20), .b(new_n38_), .O(new_n148_));
  nand2  g115(.a(new_n88_), .b(x06), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n148_), .c(x11), .O(new_n150_));
  nor2   g117(.a(x24), .b(new_n35_), .O(new_n151_));
  ...
  inv1   g121(.a(new_n108_), .O(new_n155_));
  nand2  g122(.a(new_n39_), .b(x14), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x06), .c(new_n37_), .O(new_n157_));
  inv1   g124(.a(x15), .O(new_n158_));
  nand3  g125(.a(new_n88_), .b(x13), .c(x05), .O(new_n159_));
  aoi21  g126(.a(new_n159_), .b(new_n42_), .c(new_n158_), .O(new_n160_));
  oai22  g127(.a(new_n160_), .b(new_n155_), .c(new_n157_), .d(new_n35_), .O(new_n161_));
  inv1   g128(.a(x18), .O(new_n162_));
  aoi21  g129(.a(new_n37_), .b(x06), .c(x03), .O(new_n163_));
  nand2  g130(.a(x20), .b(x06), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x11), .c(new_n35_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n162_), .c(new_n163_), .d(new_n131_), .O(new_n166_));
  ...
  nand4  g136(.a(new_n169_), .b(x19), .c(new_n104_), .d(new_n86_), .O(new_n170_));
  nand4  g137(.a(new_n170_), .b(new_n167_), .c(new_n161_), .d(new_n154_), .O(z6));
  inv1   g138(.a(new_n145_), .O(z7));
endmodule
