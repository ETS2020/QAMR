...
module FAU ( 
  ...
  nand4  g057(.a(new_n90_), .b(new_n70_), .c(new_n37_), .d(new_n85_), .O(new_n91_));
  ...
  nand3  g062(.a(new_n95_), .b(new_n34_), .c(new_n44_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nand3  g064(.a(new_n45_), .b(new_n62_), .c(new_n81_), .O(new_n98_));
  nor3   g065(.a(new_n98_), .b(x06), .c(x04), .O(new_n99_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n99_), .c(new_n97_), .d(new_n90_), .O(new_n104_));
  ...
  nor2   g084(.a(new_n87_), .b(new_n36_), .O(new_n118_));
  nand3  g085(.a(new_n118_), .b(x20), .c(x15), .O(new_n119_));
  nand3  g086(.a(new_n64_), .b(new_n34_), .c(new_n106_), .O(new_n120_));
  nand3  g087(.a(new_n69_), .b(new_n87_), .c(new_n36_), .O(new_n121_));
  oai22  g088(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n75_), .O(new_n123_));
  nand3  g090(.a(new_n118_), .b(x20), .c(x18), .O(new_n124_));
  nand3  g091(.a(new_n83_), .b(new_n34_), .c(new_n106_), .O(new_n125_));
  nand4  g092(.a(new_n37_), .b(new_n87_), .c(new_n36_), .d(new_n81_), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n117_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n73_), .c(x24), .O(new_n128_));
  nor3   g095(.a(x06), .b(x03), .c(x02), .O(new_n129_));
  nor3   g096(.a(x11), .b(x10), .c(x08), .O(new_n130_));
  nor3   g097(.a(x24), .b(x20), .c(x14), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n95_), .O(new_n132_));
  nand3  g099(.a(new_n132_), .b(new_n128_), .c(new_n123_), .O(z3));
  nor2   g100(.a(new_n49_), .b(new_n42_), .O(new_n134_));
  aoi21  g101(.a(new_n101_), .b(x04), .c(x17), .O(new_n135_));
  oai21  g102(.a(new_n135_), .b(x22), .c(new_n62_), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(new_n88_), .c(x08), .O(new_n137_));
  inv1   g104(.a(x04), .O(new_n138_));
  aoi21  g105(.a(x23), .b(new_n138_), .c(new_n85_), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(new_n100_), .c(x09), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(x16), .c(new_n81_), .O(new_n141_));
  nand4  g108(.a(new_n40_), .b(x21), .c(new_n45_), .d(new_n44_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n111_), .c(new_n110_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n109_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n141_), .c(new_n137_), .d(new_n134_), .O(z4));
  inv1   g112(.a(new_n134_), .O(z5));
  inv1   g113(.a(new_n144_), .O(z7));
  oai21  g114(.a(new_n36_), .b(x06), .c(x03), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(z7), .O(new_n149_));
  oai21  g116(.a(new_n37_), .b(x14), .c(new_n35_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n36_), .c(x03), .O(new_n151_));
  nand3  g118(.a(new_n118_), .b(new_n37_), .c(x15), .O(new_n152_));
  oai21  g119(.a(new_n151_), .b(new_n68_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n75_), .O(new_n154_));
  nand3  g121(.a(new_n118_), .b(new_n37_), .c(x18), .O(new_n155_));
  oai21  g122(.a(new_n151_), .b(new_n82_), .c(new_n155_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n73_), .c(x24), .O(new_n157_));
  nor2   g124(.a(new_n151_), .b(x24), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n159_));
  nand4  g126(.a(new_n159_), .b(new_n157_), .c(new_n154_), .d(new_n149_), .O(z6));
endmodule
