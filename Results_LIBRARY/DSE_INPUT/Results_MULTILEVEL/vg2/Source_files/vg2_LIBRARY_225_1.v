...
module FAU ( 
  ...
  nor4   g050(.a(new_n83_), .b(new_n68_), .c(new_n54_), .d(new_n53_), .O(new_n84_));
  nand2  g051(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nor3   g052(.a(x04), .b(x03), .c(x01), .O(new_n86_));
  nand4  g053(.a(new_n67_), .b(new_n66_), .c(x07), .d(new_n35_), .O(new_n87_));
  inv1   g054(.a(new_n87_), .O(new_n88_));
  nor3   g055(.a(x14), .b(x12), .c(x11), .O(new_n89_));
  nand4  g056(.a(new_n55_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  inv1   g057(.a(new_n90_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n86_), .O(new_n92_));
  aoi22  g059(.a(new_n92_), .b(new_n85_), .c(new_n46_), .d(new_n37_), .O(new_n93_));
  nand3  g060(.a(x15), .b(x14), .c(x12), .O(new_n94_));
  nand4  g061(.a(x23), .b(x22), .c(x17), .d(x16), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g063(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nand4  g064(.a(new_n36_), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n98_));
  inv1   g065(.a(new_n98_), .O(new_n99_));
  nor3   g066(.a(x16), .b(x14), .c(x12), .O(new_n100_));
  nand4  g067(.a(new_n55_), .b(new_n70_), .c(x19), .d(new_n69_), .O(new_n101_));
  inv1   g068(.a(new_n101_), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n100_), .c(new_n99_), .d(new_n86_), .O(new_n103_));
  aoi21  g070(.a(new_n103_), .b(new_n97_), .c(x13), .O(new_n104_));
  aoi22  g071(.a(new_n104_), .b(new_n37_), .c(new_n93_), .d(x24), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n80_), .O(z1));
  ...
  nor3   g081(.a(new_n114_), .b(new_n70_), .c(new_n54_), .O(new_n115_));
  nand4  g082(.a(new_n115_), .b(x11), .c(x06), .d(x03), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n64_), .O(z2));
  nand2  g084(.a(new_n57_), .b(new_n56_), .O(new_n118_));
  ...
  nand2  g088(.a(new_n72_), .b(new_n71_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n70_), .c(new_n54_), .d(new_n36_), .O(new_n123_));
  ...
  nand2  g094(.a(new_n46_), .b(new_n37_), .O(new_n128_));
  nand4  g095(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n129_));
  nand4  g096(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n130_));
  nand4  g097(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n131_));
  nand4  g098(.a(new_n70_), .b(new_n54_), .c(new_n36_), .d(new_n66_), .O(new_n132_));
  oai22  g099(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n129_), .O(new_n133_));
  nand3  g100(.a(new_n133_), .b(new_n128_), .c(x24), .O(new_n134_));
  nand4  g101(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n135_));
  nand4  g102(.a(new_n66_), .b(new_n35_), .c(new_n34_), .d(new_n64_), .O(new_n136_));
  nand4  g103(.a(new_n70_), .b(x19), .c(new_n54_), .d(new_n36_), .O(new_n137_));
  ...
  nand3  g106(.a(new_n139_), .b(new_n134_), .c(new_n127_), .O(z3));
  aoi21  g107(.a(new_n55_), .b(x04), .c(x17), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n67_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n68_), .c(x08), .O(new_n143_));
  inv1   g110(.a(x22), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n65_), .c(new_n69_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n144_), .c(x09), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n66_), .O(new_n147_));
  oai22  g114(.a(new_n147_), .b(new_n114_), .c(new_n143_), .d(new_n49_), .O(z4));
  inv1   g115(.a(new_n49_), .O(z5));
  nand2  g116(.a(x20), .b(new_n54_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n35_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n36_), .c(x03), .O(new_n152_));
  nand2  g119(.a(new_n70_), .b(x14), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x06), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x11), .c(new_n34_), .O(new_n155_));
  oai22  g122(.a(new_n155_), .b(new_n114_), .c(new_n152_), .d(new_n49_), .O(z6));
  inv1   g123(.a(new_n114_), .O(z7));
endmodule
