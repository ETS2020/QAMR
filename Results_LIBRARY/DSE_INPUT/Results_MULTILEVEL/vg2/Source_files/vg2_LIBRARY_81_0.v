...
module FAU ( 
  ...
  nor2   g57(.a(x13), .b(x05), .O(new_n91_));
  inv1   g58(.a(new_n91_), .O(new_n92_));
  nand4  g59(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n93_));
  nand4  g60(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n94_));
  nand4  g61(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n53_), .O(new_n95_));
  nand4  g62(.a(new_n72_), .b(new_n55_), .c(new_n36_), .d(new_n54_), .O(new_n96_));
  ...
  nand4  g66(.a(new_n54_), .b(new_n35_), .c(new_n34_), .d(new_n53_), .O(new_n100_));
  nand4  g67(.a(new_n72_), .b(x19), .c(new_n55_), .d(new_n36_), .O(new_n101_));
  oai22  g68(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n93_), .O(new_n102_));
  nand3  g69(.a(new_n102_), .b(new_n46_), .c(new_n37_), .O(new_n103_));
  nand3  g70(.a(new_n103_), .b(new_n98_), .c(new_n90_), .O(z3));
  inv1   g71(.a(x18), .O(new_n105_));
  inv1   g72(.a(x04), .O(new_n106_));
  inv1   g73(.a(x17), .O(new_n107_));
  aoi21  g74(.a(x23), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  oai21  g75(.a(new_n108_), .b(new_n56_), .c(x09), .O(new_n109_));
  aoi21  g76(.a(new_n109_), .b(x16), .c(new_n54_), .O(new_n110_));
  nand2  g77(.a(x08), .b(x07), .O(new_n111_));
  oai21  g78(.a(new_n110_), .b(new_n105_), .c(new_n111_), .O(new_n112_));
  nand3  g79(.a(new_n112_), .b(new_n92_), .c(x24), .O(new_n113_));
  nand3  g80(.a(new_n39_), .b(x13), .c(x05), .O(new_n114_));
  nand2  g81(.a(new_n114_), .b(new_n92_), .O(new_n115_));
  inv1   g82(.a(x15), .O(new_n116_));
  nand2  g83(.a(x19), .b(x08), .O(new_n117_));
  oai21  g84(.a(new_n110_), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g85(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  inv1   g86(.a(x21), .O(new_n120_));
  nand2  g87(.a(x08), .b(x00), .O(new_n121_));
  oai21  g88(.a(new_n110_), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand4  g89(.a(new_n122_), .b(new_n39_), .c(new_n44_), .d(new_n43_), .O(new_n123_));
  nand3  g90(.a(new_n123_), .b(new_n119_), .c(new_n113_), .O(z4));
  inv1   g91(.a(new_n49_), .O(z5));
  nand2  g92(.a(x20), .b(new_n55_), .O(new_n126_));
  nand2  g93(.a(new_n126_), .b(new_n35_), .O(new_n127_));
  aoi21  g94(.a(new_n127_), .b(new_n36_), .c(x03), .O(new_n128_));
  nand2  g95(.a(new_n72_), .b(x14), .O(new_n129_));
  nand2  g96(.a(new_n129_), .b(x06), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(x11), .c(new_n34_), .O(new_n131_));
  oai22  g98(.a(new_n131_), .b(new_n73_), .c(new_n128_), .d(new_n49_), .O(z6));
  inv1   g99(.a(new_n73_), .O(z7));
endmodule
