...
module FAU ( 
  ...
  nand4  g062(.a(new_n36_), .b(new_n67_), .c(new_n66_), .d(new_n35_), .O(new_n96_));
  inv1   g063(.a(new_n96_), .O(new_n97_));
  nor3   g064(.a(x16), .b(x14), .c(x12), .O(new_n98_));
  nand4  g065(.a(new_n84_), .b(new_n69_), .c(x19), .d(new_n68_), .O(new_n99_));
  inv1   g066(.a(new_n99_), .O(new_n100_));
  nand4  g067(.a(new_n100_), .b(new_n98_), .c(new_n97_), .d(new_n80_), .O(new_n101_));
  nand3  g068(.a(x16), .b(x15), .c(x12), .O(new_n102_));
  ...
  aoi21  g072(.a(new_n105_), .b(new_n101_), .c(x13), .O(new_n106_));
  ...
  nand3  g099(.a(new_n92_), .b(x14), .c(x11), .O(new_n133_));
  ...
  oai21  g114(.a(new_n147_), .b(new_n84_), .c(x09), .O(new_n148_));
