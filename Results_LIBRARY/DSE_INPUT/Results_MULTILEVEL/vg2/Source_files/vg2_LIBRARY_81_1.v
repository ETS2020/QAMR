...
module FAU ( 
  ...
  nand4  g047(.a(x12), .b(x11), .c(x09), .d(x06), .O(new_n81_));
  ...
  nand2  g109(.a(new_n55_), .b(x04), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n68_), .c(x22), .O(new_n144_));
  nor3   g111(.a(new_n144_), .b(x09), .c(x08), .O(new_n145_));
