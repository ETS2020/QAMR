...
module FAU ( 
  ...
  nor3   g030(.a(new_n63_), .b(x14), .c(x12), .O(new_n64_));
  nand4  g031(.a(new_n64_), .b(new_n36_), .c(new_n56_), .d(new_n55_), .O(new_n65_));
  nor2   g032(.a(new_n65_), .b(x06), .O(new_n66_));
  nand4  g033(.a(new_n66_), .b(new_n54_), .c(new_n34_), .d(new_n53_), .O(new_n67_));
  inv1   g034(.a(x14), .O(new_n68_));
  inv1   g035(.a(x23), .O(new_n69_));
  nand3  g036(.a(x15), .b(x13), .c(x05), .O(new_n70_));
  nand3  g037(.a(x21), .b(new_n44_), .c(new_n43_), .O(new_n71_));
  aoi21  g038(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  nand4  g039(.a(new_n72_), .b(x22), .c(x20), .d(x17), .O(new_n73_));
  nor3   g040(.a(new_n73_), .b(new_n57_), .c(new_n68_), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(x12), .c(x11), .d(x09), .O(new_n75_));
  nor2   g042(.a(new_n75_), .b(new_n55_), .O(new_n76_));
  nand4  g043(.a(new_n76_), .b(x06), .c(x04), .d(x03), .O(new_n77_));
  ...
  nor4   g048(.a(new_n81_), .b(new_n35_), .c(new_n54_), .d(new_n34_), .O(new_n82_));
  ...
  nor2   g054(.a(new_n69_), .b(new_n59_), .O(new_n88_));
  nand4  g055(.a(new_n88_), .b(new_n87_), .c(new_n84_), .d(new_n82_), .O(new_n89_));
  nor3   g056(.a(x04), .b(x03), .c(x01), .O(new_n90_));
  nand4  g057(.a(new_n56_), .b(new_n55_), .c(x07), .d(new_n35_), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nor3   g059(.a(x14), .b(x12), .c(x11), .O(new_n93_));
  nand4  g060(.a(new_n69_), .b(new_n59_), .c(new_n58_), .d(new_n57_), .O(new_n94_));
  ...
  nand4  g068(.a(new_n36_), .b(new_n56_), .c(new_n55_), .d(new_n35_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nor3   g070(.a(x16), .b(x14), .c(x12), .O(new_n104_));
  nand4  g071(.a(new_n69_), .b(new_n59_), .c(x19), .d(new_n58_), .O(new_n105_));
  ...
  nor2   g088(.a(new_n121_), .b(new_n34_), .O(z2));
  nand2  g089(.a(new_n61_), .b(new_n60_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n68_), .c(new_n36_), .d(new_n55_), .O(new_n124_));
  ...
  nor4   g094(.a(new_n127_), .b(new_n55_), .c(new_n35_), .d(new_n34_), .O(new_n128_));
  ...
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n55_), .d(x07), .O(new_n132_));
  nand3  g099(.a(x08), .b(x06), .c(x03), .O(new_n133_));
  inv1   g100(.a(new_n133_), .O(new_n134_));
  nor2   g101(.a(new_n68_), .b(new_n36_), .O(new_n135_));
  ...
  nand4  g105(.a(new_n138_), .b(new_n130_), .c(x19), .d(new_n68_), .O(new_n139_));
  ...
  aoi21  g110(.a(new_n69_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n56_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n57_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n54_), .c(new_n58_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n59_), .c(x09), .O(new_n148_));
