...
module FAU ( 
  ...
  nand4  g061(.a(new_n66_), .b(new_n65_), .c(x07), .d(new_n35_), .O(new_n95_));
  inv1   g062(.a(new_n95_), .O(new_n96_));
  nand4  g063(.a(new_n68_), .b(new_n67_), .c(new_n53_), .d(new_n36_), .O(new_n97_));
  nand4  g064(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n69_), .O(new_n98_));
  ...
  nand4  g072(.a(new_n36_), .b(new_n66_), .c(new_n65_), .d(new_n35_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  nand4  g074(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n53_), .O(new_n108_));
  nand4  g075(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(x19), .O(new_n109_));
  ...
  nand3  g086(.a(new_n39_), .b(new_n44_), .c(new_n43_), .O(new_n120_));
  ...
  nor2   g090(.a(new_n123_), .b(new_n70_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(x14), .c(x11), .d(x06), .O(new_n125_));
  nor3   g092(.a(new_n125_), .b(new_n34_), .c(new_n63_), .O(z2));
  nand4  g093(.a(new_n55_), .b(x20), .c(x14), .d(x11), .O(new_n127_));
  ...
  nor2   g103(.a(new_n67_), .b(new_n36_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n91_), .O(new_n138_));
  nand4  g105(.a(x07), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n139_));
  nand4  g106(.a(new_n70_), .b(new_n67_), .c(new_n36_), .d(new_n65_), .O(new_n140_));
  ...
  nand4  g110(.a(new_n65_), .b(new_n35_), .c(new_n34_), .d(new_n63_), .O(new_n144_));
  nand4  g111(.a(new_n70_), .b(x19), .c(new_n67_), .d(new_n36_), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n72_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x22), .c(new_n66_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n68_), .c(x08), .O(new_n151_));
  aoi21  g118(.a(x23), .b(new_n64_), .c(new_n69_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n71_), .c(x09), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(x16), .c(new_n65_), .O(new_n154_));
  nand4  g121(.a(new_n39_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n121_), .c(new_n119_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(new_n118_), .O(new_n157_));
  oai22  g124(.a(new_n157_), .b(new_n154_), .c(new_n151_), .d(new_n49_), .O(z4));
  inv1   g125(.a(new_n49_), .O(z5));
  inv1   g126(.a(new_n157_), .O(z7));
  ...
  oai21  g132(.a(new_n70_), .b(x14), .c(new_n35_), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(new_n36_), .c(x03), .O(new_n167_));
  nand3  g134(.a(new_n137_), .b(new_n70_), .c(x15), .O(new_n168_));
  ...
  nand3  g138(.a(new_n137_), .b(new_n70_), .c(x18), .O(new_n172_));
