...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n71_), .c(new_n70_), .d(new_n37_), .O(new_n80_));
  ...
  nor2   g059(.a(new_n92_), .b(x17), .O(new_n93_));
  ...
  aoi21  g076(.a(new_n109_), .b(new_n108_), .c(new_n72_), .O(new_n110_));
  ...
  nand4  g082(.a(new_n77_), .b(new_n72_), .c(new_n37_), .d(new_n36_), .O(new_n116_));
  ...
  aoi21  g087(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n121_));
  ...
  nor4   g092(.a(new_n125_), .b(new_n124_), .c(new_n37_), .d(new_n36_), .O(new_n126_));
  ...
  aoi21  g097(.a(new_n130_), .b(new_n70_), .c(x08), .O(new_n131_));
  nand3  g098(.a(new_n90_), .b(new_n49_), .c(new_n45_), .O(new_n132_));
  nor2   g099(.a(new_n132_), .b(new_n42_), .O(new_n133_));
  aoi21  g100(.a(x23), .b(new_n67_), .c(new_n71_), .O(new_n134_));
  ...
  nand2  g112(.a(x20), .b(new_n37_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n35_), .c(x11), .O(new_n147_));
  nand2  g114(.a(new_n49_), .b(new_n45_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n42_), .c(new_n147_), .d(x03), .O(new_n149_));
  ...
  oai21  g119(.a(new_n36_), .b(x06), .c(x03), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(x15), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n87_), .c(new_n38_), .O(new_n156_));
  nand2  g123(.a(new_n72_), .b(x14), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x06), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(x21), .c(new_n44_), .d(new_n43_), .O(new_n159_));
  oai21  g126(.a(x06), .b(new_n38_), .c(new_n157_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(x15), .c(x13), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n159_), .c(x24), .O(new_n162_));
  nand2  g129(.a(new_n88_), .b(new_n35_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n157_), .O(new_n164_));
  nand3  g131(.a(new_n164_), .b(x24), .c(x18), .O(new_n165_));
  inv1   g132(.a(new_n165_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n162_), .c(x11), .O(new_n167_));
  nand2  g134(.a(new_n141_), .b(new_n139_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n138_), .c(new_n34_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n167_), .c(new_n156_), .d(new_n149_), .O(z6));
  inv1   g137(.a(new_n143_), .O(z7));
endmodule
