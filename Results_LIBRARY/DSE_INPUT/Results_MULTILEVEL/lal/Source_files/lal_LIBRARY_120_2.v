...
module FAU ( 
  ...
  nand4  g46(.a(new_n91_), .b(new_n57_), .c(new_n79_), .d(new_n78_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z12));
  nor2   g48(.a(x20), .b(new_n88_), .O(new_n94_));
  ...
  nand2  g58(.a(new_n94_), .b(new_n89_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n109_), .b(x19), .c(x18), .d(x17), .O(new_n110_));
  nand2  g65(.a(new_n102_), .b(new_n89_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x22), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n99_), .O(z15));
  nand4  g68(.a(new_n73_), .b(new_n53_), .c(new_n52_), .d(new_n50_), .O(new_n114_));
  inv1   g69(.a(new_n114_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(x19), .c(x18), .d(x17), .O(new_n116_));
  oai21  g71(.a(new_n108_), .b(new_n96_), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n99_), .O(z16));
  nor2   g73(.a(x15), .b(x07), .O(new_n119_));
  nand4  g74(.a(new_n73_), .b(new_n53_), .c(new_n52_), .d(new_n50_), .O(new_n120_));
  oai21  g75(.a(new_n120_), .b(new_n96_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n107_), .c(new_n94_), .d(new_n89_), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n57_), .O(z17));
  nand2  g79(.a(x19), .b(x17), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n57_), .c(new_n79_), .d(new_n78_), .O(new_n126_));
  nand4  g81(.a(new_n48_), .b(new_n73_), .c(new_n53_), .d(new_n52_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n50_), .c(x19), .d(x17), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(x18), .O(new_n130_));
  nand2  g85(.a(new_n50_), .b(x18), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(x25), .c(new_n98_), .O(new_n132_));
