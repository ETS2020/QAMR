...
module FAU ( 
  ...
  oai21  g43(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n61_), .c(new_n81_), .d(new_n80_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z12));
  aoi21  g46(.a(new_n62_), .b(new_n81_), .c(x07), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n50_), .c(new_n81_), .O(z13));
  nand3  g48(.a(new_n92_), .b(new_n56_), .c(new_n81_), .O(z14));
  nand3  g49(.a(new_n92_), .b(new_n57_), .c(new_n81_), .O(z15));
  nor2   g50(.a(x23), .b(x15), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(new_n92_), .O(z16));
  nand3  g52(.a(new_n92_), .b(new_n48_), .c(new_n81_), .O(z17));
  nand3  g53(.a(new_n92_), .b(new_n49_), .c(new_n81_), .O(z18));
  buf1   g54(.a(x16), .O(z02));
endmodule
