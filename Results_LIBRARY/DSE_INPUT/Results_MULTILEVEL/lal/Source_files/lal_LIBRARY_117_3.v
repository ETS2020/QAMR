...
module FAU ( 
  ...
  oai21  g08(.a(new_n53_), .b(new_n52_), .c(x24), .O(new_n54_));
  aoi21  g09(.a(new_n54_), .b(new_n51_), .c(x23), .O(new_n55_));
  inv1   g10(.a(x18), .O(new_n56_));
  oai21  g11(.a(x20), .b(new_n56_), .c(x24), .O(new_n57_));
  oai21  g12(.a(new_n57_), .b(new_n55_), .c(new_n49_), .O(new_n58_));
  ...
  nand2  g29(.a(new_n74_), .b(new_n56_), .O(new_n75_));
  nand3  g30(.a(x24), .b(x22), .c(x21), .O(new_n76_));
  oai21  g31(.a(new_n76_), .b(new_n75_), .c(new_n49_), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand2  g33(.a(new_n76_), .b(new_n49_), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(x20), .O(new_n80_));
  oai21  g35(.a(x25), .b(x23), .c(x24), .O(new_n81_));
  nor2   g36(.a(new_n74_), .b(new_n56_), .O(new_n82_));
  ...
  nand4  g42(.a(new_n87_), .b(new_n82_), .c(new_n53_), .d(new_n52_), .O(new_n88_));
  ...
  inv1   g46(.a(new_n59_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n48_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z09));
  nand4  g49(.a(new_n59_), .b(new_n73_), .c(new_n91_), .d(new_n48_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n59_), .c(new_n91_), .d(new_n48_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z11));
  nor2   g54(.a(new_n56_), .b(new_n73_), .O(new_n100_));
  nand3  g55(.a(new_n74_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g56(.a(new_n100_), .b(new_n74_), .c(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n59_), .c(new_n91_), .d(new_n48_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z12));
  nand2  g59(.a(new_n83_), .b(x20), .O(new_n105_));
  ...
  nand3  g64(.a(new_n100_), .b(new_n85_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n109_), .c(new_n106_), .d(new_n59_), .O(z14));
  nand2  g66(.a(new_n110_), .b(x22), .O(new_n112_));
  nor2   g67(.a(x22), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n84_), .c(new_n50_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n106_), .d(new_n59_), .O(z15));
  nand2  g70(.a(new_n106_), .b(new_n92_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x15), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n114_), .c(new_n116_), .d(new_n48_), .O(z16));
  nand3  g73(.a(new_n86_), .b(new_n52_), .c(new_n50_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(x19), .c(x18), .d(x17), .O(new_n121_));
  nand3  g76(.a(new_n59_), .b(new_n91_), .c(new_n48_), .O(new_n122_));
  aoi21  g77(.a(new_n114_), .b(x24), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g82(.a(new_n127_), .b(new_n113_), .c(new_n126_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n125_), .c(new_n106_), .d(new_n59_), .O(z18));
