...
module FAU ( 
  ...
  nand3  g28(.a(new_n73_), .b(x19), .c(x17), .O(new_n74_));
  ...
  nand4  g34(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(x17), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n75_), .c(new_n49_), .d(new_n72_), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(x25), .O(new_n82_));
  nand3  g37(.a(new_n82_), .b(new_n71_), .c(new_n70_), .O(z08));
  inv1   g38(.a(x07), .O(new_n84_));
  inv1   g39(.a(x15), .O(new_n85_));
  nand3  g40(.a(new_n53_), .b(new_n85_), .c(new_n84_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z09));
  inv1   g42(.a(x17), .O(new_n88_));
  nand4  g43(.a(new_n52_), .b(new_n88_), .c(new_n85_), .d(new_n84_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xor2a  g45(.a(x18), .b(x17), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n52_), .c(new_n85_), .d(new_n84_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z11));
  and2   g48(.a(x18), .b(x17), .O(new_n94_));
  nand3  g49(.a(new_n76_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n94_), .b(new_n76_), .c(new_n95_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n52_), .c(new_n85_), .d(new_n84_), .O(new_n97_));
  ...
  nand2  g56(.a(new_n94_), .b(new_n77_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n52_), .O(z13));
  ...
  nand4  g61(.a(new_n106_), .b(new_n104_), .c(new_n101_), .d(new_n52_), .O(z14));
  nand2  g62(.a(new_n106_), .b(x22), .O(new_n108_));
  inv1   g63(.a(x20), .O(new_n109_));
  nand2  g64(.a(new_n78_), .b(new_n109_), .O(new_n110_));
  or2    g65(.a(new_n110_), .b(new_n99_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n101_), .d(new_n52_), .O(z15));
  oai21  g67(.a(new_n76_), .b(x18), .c(new_n52_), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(new_n85_), .O(new_n114_));
  nor2   g69(.a(new_n76_), .b(new_n88_), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n110_), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n109_), .b(x19), .c(x17), .O(new_n118_));
  ...
  nand4  g76(.a(new_n121_), .b(new_n117_), .c(new_n114_), .d(new_n84_), .O(z16));
  nand3  g77(.a(new_n79_), .b(new_n72_), .c(new_n73_), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n109_), .c(x19), .d(x17), .O(new_n125_));
  nand2  g80(.a(new_n120_), .b(new_n119_), .O(new_n126_));
  nand3  g81(.a(new_n52_), .b(new_n85_), .c(new_n84_), .O(new_n127_));
  aoi21  g82(.a(new_n126_), .b(x24), .c(new_n127_), .O(new_n128_));
  nand2  g83(.a(new_n128_), .b(new_n125_), .O(z17));
  nand2  g84(.a(new_n80_), .b(x25), .O(new_n130_));
  nor2   g85(.a(x25), .b(x24), .O(new_n131_));
  nor2   g86(.a(x23), .b(x22), .O(new_n132_));
  nand4  g87(.a(new_n132_), .b(new_n115_), .c(new_n105_), .d(new_n131_), .O(new_n133_));
  nand4  g88(.a(new_n133_), .b(new_n130_), .c(new_n101_), .d(new_n52_), .O(z18));
