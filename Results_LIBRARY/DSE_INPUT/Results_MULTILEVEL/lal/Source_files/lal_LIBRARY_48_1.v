...
module FAU ( 
  ...
  nand4  g58(.a(new_n75_), .b(new_n103_), .c(new_n102_), .d(x19), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n101_), .c(new_n99_), .d(new_n52_), .O(z14));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n106_));
  nand3  g61(.a(new_n74_), .b(new_n73_), .c(new_n102_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n99_), .d(new_n52_), .O(z15));
  inv1   g63(.a(x22), .O(new_n109_));
  inv1   g64(.a(x18), .O(new_n110_));
  nand2  g65(.a(new_n49_), .b(new_n110_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n48_), .c(new_n109_), .d(new_n103_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n102_), .c(x19), .d(x17), .O(new_n114_));
  nand3  g69(.a(new_n52_), .b(new_n84_), .c(new_n83_), .O(new_n115_));
  aoi21  g70(.a(new_n107_), .b(x23), .c(new_n115_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n114_), .O(z16));
  nand3  g72(.a(new_n78_), .b(new_n109_), .c(new_n103_), .O(new_n118_));
  ...
  nand3  g76(.a(new_n121_), .b(new_n77_), .c(x17), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(x24), .c(new_n115_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n120_), .O(z17));
  nand2  g79(.a(new_n79_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n77_), .c(new_n75_), .d(new_n74_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n99_), .d(new_n52_), .O(z18));
