...
module FAU ( 
  ...
  nand2  g32(.a(new_n75_), .b(new_n48_), .O(new_n78_));
  ...
  nand4  g43(.a(new_n88_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(x25), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n80_), .c(new_n79_), .d(new_n77_), .O(z08));
  ...
  nand3  g65(.a(new_n101_), .b(new_n86_), .c(x19), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n107_), .c(new_n58_), .O(z15));
  inv1   g67(.a(z15), .O(new_n113_));
  oai21  g68(.a(new_n110_), .b(new_n81_), .c(new_n113_), .O(z14));
  nand2  g69(.a(new_n111_), .b(x23), .O(new_n115_));
  nor2   g70(.a(x23), .b(x21), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n85_), .c(new_n49_), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n107_), .d(new_n58_), .O(z16));
  nand3  g73(.a(new_n87_), .b(new_n81_), .c(new_n49_), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(x19), .c(x18), .d(x17), .O(new_n121_));
  nand3  g76(.a(new_n58_), .b(new_n93_), .c(new_n92_), .O(new_n122_));
  ...
  nand4  g80(.a(new_n116_), .b(new_n110_), .c(new_n48_), .d(new_n82_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n125_), .c(new_n107_), .d(new_n58_), .O(z18));
