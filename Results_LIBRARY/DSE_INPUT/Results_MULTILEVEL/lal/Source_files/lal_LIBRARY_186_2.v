...
module FAU ( 
  ...
  nand4  g50(.a(new_n50_), .b(x19), .c(x18), .d(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n59_), .O(z13));
  nand2  g52(.a(x19), .b(x17), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(x18), .c(new_n60_), .O(new_n99_));
  oai21  g54(.a(x20), .b(new_n52_), .c(x21), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n80_), .d(new_n79_), .O(z14));
  aoi21  g56(.a(new_n60_), .b(new_n80_), .c(x07), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n75_), .c(new_n80_), .O(z15));
  nor2   g58(.a(x23), .b(x15), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n102_), .O(z16));
  nand3  g60(.a(new_n102_), .b(new_n48_), .c(new_n80_), .O(z17));
  nand3  g61(.a(new_n102_), .b(new_n49_), .c(new_n80_), .O(z18));
