...
module FAU ( 
  ...
  oai21  g41(.a(x19), .b(x18), .c(new_n52_), .O(new_n87_));
  nor4   g42(.a(new_n87_), .b(x17), .c(x15), .d(x07), .O(z10));
  xor2a  g43(.a(x18), .b(x17), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n52_), .c(new_n84_), .d(new_n83_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z11));
  nand2  g46(.a(x19), .b(x18), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(x17), .O(new_n93_));
  oai21  g48(.a(new_n76_), .b(x17), .c(new_n93_), .O(new_n94_));
