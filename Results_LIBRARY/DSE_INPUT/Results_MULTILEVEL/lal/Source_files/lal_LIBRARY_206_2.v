...
module FAU ( 
  ...
  oai21  g28(.a(new_n73_), .b(x24), .c(new_n48_), .O(new_n74_));
  nand4  g29(.a(new_n74_), .b(new_n52_), .c(new_n51_), .d(new_n72_), .O(new_n75_));
  inv1   g30(.a(new_n75_), .O(new_n76_));
  nand4  g31(.a(new_n76_), .b(x19), .c(x18), .d(x17), .O(new_n77_));
  inv1   g32(.a(x17), .O(new_n78_));
  nor2   g33(.a(x19), .b(x18), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(x24), .c(x22), .d(x21), .O(new_n80_));
  nand3  g35(.a(new_n80_), .b(new_n73_), .c(new_n48_), .O(new_n81_));
  nand2  g36(.a(new_n73_), .b(new_n48_), .O(new_n82_));
  nand2  g37(.a(x19), .b(x18), .O(new_n83_));
  nand3  g38(.a(new_n52_), .b(new_n51_), .c(new_n72_), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  nand3  g40(.a(x22), .b(x21), .c(x20), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x24), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  aoi21  g44(.a(new_n81_), .b(new_n78_), .c(new_n89_), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n77_), .O(z08));
  inv1   g46(.a(x07), .O(new_n92_));
  inv1   g47(.a(x15), .O(new_n93_));
  nand3  g48(.a(new_n57_), .b(new_n93_), .c(new_n92_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  nand4  g50(.a(new_n56_), .b(new_n78_), .c(new_n93_), .d(new_n92_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  xor2a  g52(.a(x18), .b(x17), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n56_), .c(new_n93_), .d(new_n92_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(z11));
  inv1   g55(.a(x19), .O(new_n101_));
  and2   g56(.a(x18), .b(x17), .O(new_n102_));
  nand3  g57(.a(new_n101_), .b(x18), .c(x17), .O(new_n103_));
  oai21  g58(.a(new_n102_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n56_), .c(new_n93_), .d(new_n92_), .O(new_n105_));
  ...
  nand3  g64(.a(new_n102_), .b(new_n72_), .c(x19), .O(new_n110_));
  nand4  g65(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n56_), .O(z13));
  ...
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n109_), .d(new_n56_), .O(z14));
  inv1   g70(.a(new_n84_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(x19), .c(x18), .d(x17), .O(new_n117_));
  nand3  g72(.a(new_n56_), .b(new_n93_), .c(new_n92_), .O(new_n118_));
  aoi21  g73(.a(new_n114_), .b(x22), .c(new_n118_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(z15));
  inv1   g75(.a(new_n107_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n116_), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(x23), .O(new_n123_));
  nand4  g78(.a(new_n113_), .b(new_n121_), .c(new_n48_), .d(new_n52_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n123_), .c(new_n109_), .d(new_n56_), .O(z16));
  nand2  g80(.a(x24), .b(new_n48_), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n52_), .c(new_n51_), .d(new_n72_), .O(new_n127_));
  inv1   g82(.a(new_n127_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(x19), .c(x18), .d(x17), .O(new_n129_));
  aoi21  g84(.a(new_n122_), .b(x24), .c(new_n118_), .O(new_n130_));
  nand2  g85(.a(new_n130_), .b(new_n129_), .O(z17));
  nand3  g86(.a(new_n113_), .b(new_n49_), .c(new_n52_), .O(new_n132_));
  oai21  g87(.a(new_n132_), .b(new_n107_), .c(x25), .O(new_n133_));
  nor2   g88(.a(x22), .b(x21), .O(new_n134_));
  inv1   g89(.a(new_n110_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n134_), .c(new_n73_), .d(new_n49_), .O(new_n136_));
  nand4  g91(.a(new_n136_), .b(new_n133_), .c(new_n109_), .d(new_n56_), .O(z18));
