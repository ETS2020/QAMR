...
module FAU ( 
  ...
  nor2   g35(.a(new_n71_), .b(new_n80_), .O(new_n81_));
  ...
  nor2   g53(.a(new_n80_), .b(new_n70_), .O(new_n99_));
  nand3  g54(.a(new_n71_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n71_), .c(new_n100_), .O(new_n101_));
