...
module FAU ( 
  ...
  nand4  g41(.a(new_n86_), .b(new_n81_), .c(new_n49_), .d(new_n51_), .O(new_n87_));
  ...
  nand3  g61(.a(new_n99_), .b(new_n106_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n56_), .O(z13));
  nand4  g63(.a(new_n84_), .b(x19), .c(x18), .d(x17), .O(new_n109_));
  nand3  g64(.a(new_n56_), .b(new_n91_), .c(new_n90_), .O(new_n110_));
  aoi21  g65(.a(new_n107_), .b(x21), .c(new_n110_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n109_), .O(z14));
  nand3  g67(.a(new_n99_), .b(new_n84_), .c(x19), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x22), .O(new_n114_));
  nand4  g69(.a(new_n83_), .b(new_n52_), .c(new_n51_), .d(new_n106_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n105_), .d(new_n56_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  nand4  g72(.a(new_n84_), .b(new_n83_), .c(new_n48_), .d(new_n52_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n117_), .c(new_n105_), .d(new_n56_), .O(z16));
  nor2   g74(.a(new_n85_), .b(x22), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x21), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n106_), .c(x19), .d(x18), .O(new_n122_));
  nor2   g77(.a(x23), .b(x21), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n83_), .c(new_n106_), .O(new_n124_));
  aoi21  g79(.a(new_n124_), .b(x24), .c(new_n110_), .O(new_n125_));
  oai21  g80(.a(new_n122_), .b(new_n72_), .c(new_n125_), .O(z17));
  nand2  g81(.a(new_n86_), .b(x25), .O(new_n127_));
  inv1   g82(.a(new_n107_), .O(new_n128_));
  nand4  g83(.a(new_n123_), .b(new_n128_), .c(new_n73_), .d(new_n49_), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(new_n127_), .c(new_n105_), .d(new_n56_), .O(z18));
