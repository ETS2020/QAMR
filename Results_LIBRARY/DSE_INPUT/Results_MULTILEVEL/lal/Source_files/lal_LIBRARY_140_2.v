...
module FAU ( 
  ...
  inv1   g48(.a(new_n59_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n48_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand2  g51(.a(new_n94_), .b(x18), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n51_), .c(new_n93_), .d(new_n48_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z10));
  nand3  g54(.a(new_n59_), .b(x18), .c(new_n51_), .O(new_n100_));
  oai21  g55(.a(x18), .b(new_n51_), .c(new_n100_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n93_), .c(new_n48_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z11));
  nand2  g58(.a(x19), .b(new_n51_), .O(new_n104_));
  nand3  g59(.a(new_n53_), .b(x18), .c(x17), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n104_), .c(new_n94_), .O(new_n106_));
  nor2   g61(.a(new_n53_), .b(x18), .O(new_n107_));
  oai21  g62(.a(new_n107_), .b(new_n106_), .c(new_n93_), .O(new_n108_));
  nor2   g63(.a(new_n108_), .b(x07), .O(z12));
  nand2  g64(.a(new_n86_), .b(new_n85_), .O(new_n110_));
  nand3  g65(.a(x19), .b(x18), .c(x17), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x20), .O(new_n112_));
  nor2   g67(.a(x15), .b(x07), .O(new_n113_));
  nand4  g68(.a(new_n113_), .b(new_n112_), .c(new_n110_), .d(new_n59_), .O(z13));
  nand2  g69(.a(new_n110_), .b(x21), .O(new_n115_));
  nor2   g70(.a(x21), .b(x20), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n85_), .c(x19), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n115_), .c(new_n113_), .d(new_n59_), .O(z14));
  nand2  g73(.a(new_n117_), .b(x22), .O(new_n119_));
  inv1   g74(.a(new_n111_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n87_), .c(new_n50_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n119_), .c(new_n113_), .d(new_n59_), .O(z15));
  nand2  g77(.a(new_n121_), .b(x23), .O(new_n123_));
  nor2   g78(.a(x23), .b(x22), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n116_), .c(new_n120_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n113_), .d(new_n59_), .O(z16));
  nand3  g81(.a(new_n88_), .b(new_n80_), .c(new_n82_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(x20), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(x19), .c(x18), .d(x17), .O(new_n129_));
  nand3  g84(.a(new_n59_), .b(new_n93_), .c(new_n48_), .O(new_n130_));
  aoi21  g85(.a(new_n125_), .b(x24), .c(new_n130_), .O(new_n131_));
  nand2  g86(.a(new_n131_), .b(new_n129_), .O(z17));
  nand2  g87(.a(new_n89_), .b(x25), .O(new_n133_));
  nor3   g88(.a(x25), .b(x24), .c(x23), .O(new_n134_));
  nand4  g89(.a(new_n134_), .b(new_n87_), .c(new_n86_), .d(new_n85_), .O(new_n135_));
  nand4  g90(.a(new_n135_), .b(new_n133_), .c(new_n113_), .d(new_n59_), .O(z18));
