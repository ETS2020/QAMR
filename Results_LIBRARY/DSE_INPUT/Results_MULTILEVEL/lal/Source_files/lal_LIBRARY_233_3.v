...
module FAU ( 
  ...
  nand2  g54(.a(new_n65_), .b(x21), .O(new_n101_));
  nand4  g55(.a(new_n101_), .b(new_n64_), .c(new_n100_), .d(new_n92_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  nand4  g57(.a(new_n103_), .b(x19), .c(x18), .d(x17), .O(new_n104_));
  nand3  g58(.a(new_n51_), .b(new_n74_), .c(new_n48_), .O(new_n105_));
  aoi21  g59(.a(new_n98_), .b(x23), .c(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n104_), .O(z16));
  nand4  g61(.a(new_n65_), .b(new_n64_), .c(new_n100_), .d(new_n93_), .O(new_n108_));
  nor2   g62(.a(new_n108_), .b(x20), .O(new_n109_));
  nand4  g63(.a(new_n109_), .b(x19), .c(x18), .d(x17), .O(new_n110_));
  nand4  g64(.a(new_n97_), .b(new_n64_), .c(new_n100_), .d(new_n92_), .O(new_n111_));
  aoi21  g65(.a(new_n111_), .b(x24), .c(new_n105_), .O(new_n112_));
