// Benchmark "FAU" written by ABC on Mon Jul 27 18:46:45 2020
...
module FAU ( 
  ...
  oai21  g30(.a(new_n75_), .b(new_n74_), .c(new_n49_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand2  g32(.a(new_n75_), .b(new_n49_), .O(new_n78_));
  ...
  nor2   g37(.a(x22), .b(x21), .O(new_n83_));
  ...
  nand4  g42(.a(new_n84_), .b(new_n87_), .c(x19), .d(x18), .O(new_n88_));
  ...
  nand4  g49(.a(new_n59_), .b(new_n51_), .c(new_n92_), .d(new_n48_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n59_), .c(new_n92_), .d(new_n48_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z11));
  nor2   g54(.a(new_n52_), .b(new_n51_), .O(new_n100_));
  nand3  g55(.a(new_n73_), .b(x18), .c(x17), .O(new_n101_));
  oai21  g56(.a(new_n100_), .b(new_n73_), .c(new_n101_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n59_), .c(new_n92_), .d(new_n48_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(z12));
  nand2  g59(.a(new_n81_), .b(x20), .O(new_n105_));
  nor2   g60(.a(x15), .b(x07), .O(new_n106_));
  nand3  g61(.a(new_n100_), .b(new_n50_), .c(x19), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n59_), .O(z13));
  nand2  g63(.a(new_n107_), .b(x21), .O(new_n109_));
  nor2   g64(.a(x21), .b(x20), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n100_), .c(x19), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n106_), .d(new_n59_), .O(z14));
  nand2  g67(.a(new_n111_), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n83_), .b(new_n82_), .c(new_n50_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n113_), .c(new_n106_), .d(new_n59_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  inv1   g71(.a(x23), .O(new_n117_));
  nand4  g72(.a(new_n110_), .b(new_n82_), .c(new_n117_), .d(new_n80_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n59_), .O(z16));
  nand3  g74(.a(new_n84_), .b(new_n80_), .c(new_n87_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x20), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(x19), .c(x18), .d(x17), .O(new_n122_));
  nand3  g77(.a(new_n59_), .b(new_n92_), .c(new_n48_), .O(new_n123_));
  aoi21  g78(.a(new_n118_), .b(x24), .c(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(z17));
  nand3  g80(.a(new_n100_), .b(new_n87_), .c(x19), .O(new_n126_));
  inv1   g81(.a(x24), .O(new_n127_));
  nand4  g82(.a(new_n49_), .b(new_n127_), .c(new_n117_), .d(new_n80_), .O(new_n128_));
  oai22  g83(.a(new_n128_), .b(new_n126_), .c(new_n49_), .d(new_n80_), .O(new_n129_));
  nand2  g84(.a(new_n129_), .b(new_n50_), .O(new_n130_));
  nand3  g85(.a(new_n110_), .b(new_n84_), .c(new_n82_), .O(new_n131_));
  aoi21  g86(.a(new_n131_), .b(x25), .c(new_n123_), .O(new_n132_));
  nand2  g87(.a(new_n132_), .b(new_n130_), .O(z18));
  buf1   g88(.a(x16), .O(z02));
endmodule
