...
module FAU ( 
  ...
  aoi21  g04(.a(x21), .b(x18), .c(x17), .O(new_n50_));
  ...
  nor2   g38(.a(x20), .b(new_n82_), .O(new_n84_));
  ...
  nand4  g49(.a(new_n56_), .b(new_n72_), .c(new_n92_), .d(new_n91_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z10));
  xor2a  g51(.a(x18), .b(x17), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n56_), .c(new_n92_), .d(new_n91_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(z11));
  nand3  g54(.a(new_n82_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g55(.a(new_n82_), .b(x17), .c(new_n100_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n56_), .c(new_n92_), .d(new_n91_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z12));
  nand2  g58(.a(new_n84_), .b(x17), .O(new_n104_));
  oai21  g59(.a(new_n82_), .b(new_n72_), .c(x20), .O(new_n105_));
  ...
  nor2   g64(.a(new_n82_), .b(new_n72_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n51_), .c(new_n109_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n108_), .c(new_n106_), .d(new_n56_), .O(z14));
  nand2  g67(.a(new_n111_), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n110_), .b(new_n85_), .c(new_n109_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n113_), .c(new_n106_), .d(new_n56_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n84_), .c(new_n51_), .d(x17), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .d(new_n56_), .O(z16));
  nand3  g74(.a(new_n86_), .b(new_n52_), .c(new_n51_), .O(new_n120_));
  inv1   g75(.a(new_n120_), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n109_), .c(x19), .d(x17), .O(new_n122_));
  nand3  g77(.a(new_n56_), .b(new_n92_), .c(new_n91_), .O(new_n123_));
  aoi21  g78(.a(new_n118_), .b(x24), .c(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n122_), .O(z17));
  nand2  g80(.a(new_n87_), .b(x25), .O(new_n126_));
  inv1   g81(.a(new_n111_), .O(new_n127_));
  nand4  g82(.a(new_n117_), .b(new_n127_), .c(new_n73_), .d(new_n49_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n106_), .d(new_n56_), .O(z18));
