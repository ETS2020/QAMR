...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n52_), .c(new_n84_), .d(new_n83_), .O(new_n91_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n97_), .c(x19), .d(x17), .O(new_n101_));
  nand3  g56(.a(new_n52_), .b(new_n84_), .c(new_n83_), .O(new_n102_));
  aoi21  g57(.a(new_n72_), .b(x20), .c(new_n102_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n101_), .O(z13));
  nor2   g59(.a(x15), .b(x07), .O(new_n105_));
  nand2  g60(.a(new_n77_), .b(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(x21), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n75_), .c(x19), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n107_), .c(new_n105_), .d(new_n52_), .O(z14));
  nand2  g65(.a(new_n109_), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n74_), .b(new_n73_), .c(new_n97_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n111_), .c(new_n105_), .d(new_n52_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  inv1   g69(.a(x22), .O(new_n115_));
  nand4  g70(.a(new_n108_), .b(new_n73_), .c(new_n48_), .d(new_n115_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n114_), .c(new_n105_), .d(new_n52_), .O(z16));
  nand3  g72(.a(new_n78_), .b(new_n115_), .c(new_n99_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(x20), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(x19), .c(x18), .d(x17), .O(new_n120_));
  aoi21  g75(.a(new_n116_), .b(x24), .c(new_n102_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n120_), .O(z17));
  nand2  g77(.a(new_n79_), .b(x25), .O(new_n123_));
  nor3   g78(.a(x25), .b(x24), .c(x23), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n77_), .c(new_n75_), .d(new_n74_), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n123_), .c(new_n105_), .d(new_n52_), .O(z18));
