...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n82_, new_n84_, new_n86_, new_n88_, new_n90_, new_n94_;
  ...
  nand4  g40(.a(new_n61_), .b(x17), .c(new_n81_), .d(new_n80_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(z11));
  nand4  g42(.a(new_n61_), .b(x19), .c(new_n81_), .d(new_n80_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(z12));
  aoi21  g44(.a(new_n62_), .b(new_n81_), .c(x07), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n50_), .c(new_n81_), .O(z13));
  nand3  g46(.a(new_n90_), .b(new_n56_), .c(new_n81_), .O(z14));
  nand3  g47(.a(new_n90_), .b(new_n57_), .c(new_n81_), .O(z15));
  nor2   g48(.a(x23), .b(x15), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n90_), .O(z16));
  nand3  g50(.a(new_n90_), .b(new_n48_), .c(new_n81_), .O(z17));
  nand3  g51(.a(new_n90_), .b(new_n49_), .c(new_n81_), .O(z18));
  buf1   g52(.a(x16), .O(z02));
endmodule
