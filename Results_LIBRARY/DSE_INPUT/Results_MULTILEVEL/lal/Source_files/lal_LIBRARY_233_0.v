...
module FAU ( 
  ...
  nand3  g55(.a(new_n61_), .b(new_n81_), .c(new_n80_), .O(new_n101_));
  aoi21  g56(.a(new_n97_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n100_), .O(z14));
  nand3  g58(.a(new_n99_), .b(new_n89_), .c(x19), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x22), .O(new_n105_));
  inv1   g60(.a(new_n94_), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n57_), .c(new_n56_), .d(new_n50_), .O(new_n107_));
  nand4  g62(.a(new_n107_), .b(new_n105_), .c(new_n96_), .d(new_n61_), .O(z15));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n109_));
  inv1   g64(.a(x23), .O(new_n110_));
  nand4  g65(.a(new_n99_), .b(new_n106_), .c(new_n110_), .d(new_n57_), .O(new_n111_));
  nand4  g66(.a(new_n111_), .b(new_n109_), .c(new_n96_), .d(new_n61_), .O(z16));
  nand3  g67(.a(new_n110_), .b(new_n56_), .c(new_n50_), .O(new_n113_));
  oai21  g68(.a(new_n113_), .b(new_n94_), .c(x24), .O(new_n114_));
  nand4  g69(.a(new_n106_), .b(x22), .c(new_n56_), .d(new_n50_), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n96_), .d(new_n61_), .O(z17));
  nand4  g71(.a(new_n61_), .b(new_n49_), .c(new_n81_), .d(new_n80_), .O(z18));
