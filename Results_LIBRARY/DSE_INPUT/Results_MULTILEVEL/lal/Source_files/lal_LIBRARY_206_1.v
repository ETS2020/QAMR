...
module FAU ( 
  ...
  nand4  g21(.a(new_n66_), .b(x19), .c(x18), .d(x17), .O(new_n67_));
  ...
  nand4  g29(.a(new_n74_), .b(new_n69_), .c(new_n68_), .d(new_n65_), .O(new_n75_));
  nand2  g30(.a(new_n75_), .b(x25), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n64_), .O(z08));
  inv1   g32(.a(x15), .O(new_n78_));
  nand4  g33(.a(new_n78_), .b(new_n48_), .c(x05), .d(x04), .O(new_n79_));
  inv1   g34(.a(new_n79_), .O(z09));
  inv1   g35(.a(x17), .O(new_n81_));
  nand4  g36(.a(new_n51_), .b(new_n81_), .c(new_n78_), .d(new_n48_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(z10));
  xor2a  g38(.a(x18), .b(x17), .O(new_n84_));
  nand4  g39(.a(new_n84_), .b(new_n51_), .c(new_n78_), .d(new_n48_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z11));
  inv1   g41(.a(x19), .O(new_n87_));
  and2   g42(.a(x18), .b(x17), .O(new_n88_));
  nand3  g43(.a(new_n87_), .b(x18), .c(x17), .O(new_n89_));
  oai21  g44(.a(new_n88_), .b(new_n87_), .c(new_n89_), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n51_), .c(new_n78_), .d(new_n48_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z12));
  nand2  g47(.a(new_n70_), .b(x20), .O(new_n93_));
  nor2   g48(.a(x15), .b(x07), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n93_), .c(new_n67_), .d(new_n51_), .O(z13));
  nand2  g50(.a(new_n67_), .b(x21), .O(new_n96_));
  nand3  g51(.a(new_n72_), .b(new_n88_), .c(x19), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n96_), .c(new_n94_), .d(new_n51_), .O(z14));
  nand2  g53(.a(new_n97_), .b(x22), .O(new_n99_));
  nand3  g54(.a(new_n71_), .b(new_n69_), .c(new_n66_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n94_), .d(new_n51_), .O(z15));
  inv1   g56(.a(x21), .O(new_n102_));
  nand3  g57(.a(new_n73_), .b(new_n102_), .c(new_n66_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  nand3  g60(.a(new_n51_), .b(new_n78_), .c(new_n48_), .O(new_n106_));
  aoi21  g61(.a(new_n100_), .b(x23), .c(new_n106_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n105_), .O(z16));
  nand4  g63(.a(new_n105_), .b(new_n94_), .c(new_n51_), .d(new_n64_), .O(z17));
  nand2  g64(.a(new_n74_), .b(x25), .O(new_n110_));
  nor2   g65(.a(x25), .b(x23), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n69_), .c(new_n68_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(new_n94_), .d(new_n51_), .O(z18));
