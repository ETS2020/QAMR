...
module FAU ( 
  ...
  oai21  g26(.a(new_n71_), .b(x25), .c(x20), .O(new_n72_));
  ...
  and2   g31(.a(x18), .b(x17), .O(new_n77_));
  inv1   g32(.a(x19), .O(new_n78_));
  nor2   g33(.a(x20), .b(new_n78_), .O(new_n79_));
  nor2   g34(.a(x24), .b(x23), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n79_), .c(new_n77_), .d(new_n76_), .O(new_n81_));
  nand4  g36(.a(new_n81_), .b(new_n76_), .c(new_n75_), .d(new_n49_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(x25), .O(new_n83_));
  nand3  g38(.a(new_n83_), .b(new_n73_), .c(new_n72_), .O(z08));
  inv1   g39(.a(x07), .O(new_n85_));
  inv1   g40(.a(x15), .O(new_n86_));
  nand3  g41(.a(new_n55_), .b(new_n86_), .c(new_n85_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  inv1   g43(.a(x17), .O(new_n89_));
  nand4  g44(.a(new_n54_), .b(new_n89_), .c(new_n86_), .d(new_n85_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xor2a  g46(.a(x18), .b(x17), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z11));
  nand3  g49(.a(new_n78_), .b(x18), .c(x17), .O(new_n95_));
  oai21  g50(.a(new_n77_), .b(new_n78_), .c(new_n95_), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z12));
  nand2  g53(.a(new_n79_), .b(new_n77_), .O(new_n99_));
  nand2  g54(.a(new_n74_), .b(x20), .O(new_n100_));
  nor2   g55(.a(x15), .b(x07), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n54_), .O(z13));
  nand2  g57(.a(new_n99_), .b(x21), .O(new_n103_));
  inv1   g58(.a(x21), .O(new_n104_));
  nand4  g59(.a(new_n77_), .b(new_n104_), .c(new_n50_), .d(x19), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n103_), .c(new_n101_), .d(new_n54_), .O(z14));
  nand2  g61(.a(new_n105_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n76_), .b(new_n75_), .c(new_n50_), .O(new_n108_));
  nand4  g63(.a(new_n108_), .b(new_n107_), .c(new_n101_), .d(new_n54_), .O(z15));
  inv1   g64(.a(x22), .O(new_n110_));
  inv1   g65(.a(x18), .O(new_n111_));
  nand2  g66(.a(new_n49_), .b(new_n111_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n48_), .c(new_n110_), .d(new_n104_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n50_), .c(x19), .d(x17), .O(new_n115_));
  nand3  g70(.a(new_n54_), .b(new_n86_), .c(new_n85_), .O(new_n116_));
  aoi21  g71(.a(new_n108_), .b(x23), .c(new_n116_), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n115_), .O(z16));
  nand3  g73(.a(new_n80_), .b(new_n110_), .c(new_n104_), .O(new_n119_));
  ...
  nand3  g77(.a(new_n122_), .b(new_n79_), .c(x17), .O(new_n123_));
  aoi21  g78(.a(new_n123_), .b(x24), .c(new_n116_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n121_), .O(z17));
  nand2  g80(.a(new_n81_), .b(x25), .O(new_n126_));
  nor3   g81(.a(x25), .b(x24), .c(x23), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n79_), .c(new_n77_), .d(new_n76_), .O(new_n128_));
  nand4  g83(.a(new_n128_), .b(new_n126_), .c(new_n101_), .d(new_n54_), .O(z18));
