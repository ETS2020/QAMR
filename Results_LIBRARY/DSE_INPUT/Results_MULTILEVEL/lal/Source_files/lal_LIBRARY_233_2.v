// Benchmark "FAU" written by ABC on Mon Jul 27 18:47:45 2020
...
module FAU ( 
  ...
  nand4  g48(.a(new_n56_), .b(new_n72_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z10));
  xor2a  g50(.a(x18), .b(x17), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n56_), .c(new_n91_), .d(new_n90_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z11));
  nor2   g53(.a(new_n74_), .b(new_n72_), .O(new_n99_));
  nand3  g54(.a(new_n75_), .b(x18), .c(x17), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n75_), .c(new_n100_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n56_), .c(new_n91_), .d(new_n90_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(z12));
  inv1   g58(.a(x20), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(x19), .c(x18), .d(x17), .O(new_n105_));
  nand3  g60(.a(new_n56_), .b(new_n91_), .c(new_n90_), .O(new_n106_));
  aoi21  g61(.a(new_n82_), .b(x20), .c(new_n106_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n105_), .O(z13));
  nor2   g63(.a(x15), .b(x07), .O(new_n109_));
  nand3  g64(.a(new_n99_), .b(new_n104_), .c(x19), .O(new_n110_));
  ...
  nand4  g68(.a(new_n113_), .b(new_n111_), .c(new_n109_), .d(new_n56_), .O(z14));
  nand2  g69(.a(new_n113_), .b(x22), .O(new_n115_));
  nand4  g70(.a(new_n83_), .b(new_n52_), .c(new_n51_), .d(new_n104_), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n115_), .c(new_n109_), .d(new_n56_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n112_), .c(new_n83_), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n118_), .c(new_n109_), .d(new_n56_), .O(z16));
  nand2  g76(.a(new_n85_), .b(new_n52_), .O(new_n122_));
  aoi21  g77(.a(new_n122_), .b(new_n51_), .c(x20), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(x19), .c(x18), .d(x17), .O(new_n124_));
  nand3  g79(.a(new_n119_), .b(new_n83_), .c(new_n104_), .O(new_n125_));
  aoi21  g80(.a(new_n125_), .b(x24), .c(new_n106_), .O(new_n126_));
  nand2  g81(.a(new_n126_), .b(new_n124_), .O(z17));
  nand2  g82(.a(new_n86_), .b(x25), .O(new_n128_));
  inv1   g83(.a(new_n110_), .O(new_n129_));
  nand4  g84(.a(new_n119_), .b(new_n129_), .c(new_n73_), .d(new_n49_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n128_), .c(new_n109_), .d(new_n56_), .O(z18));
