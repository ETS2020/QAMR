...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n92_, new_n93_, new_n95_, new_n96_, new_n97_, new_n99_;
  ...
  oai21  g43(.a(new_n88_), .b(new_n82_), .c(x19), .O(new_n89_));
  ...
  nand2  g49(.a(x19), .b(x17), .O(new_n95_));
  aoi21  g50(.a(new_n95_), .b(x18), .c(new_n58_), .O(new_n96_));
  nand2  g51(.a(x20), .b(new_n88_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n96_), .c(new_n79_), .d(new_n78_), .O(z13));
  aoi21  g53(.a(new_n58_), .b(new_n79_), .c(x07), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n52_), .c(new_n79_), .O(z14));
  nand3  g55(.a(new_n99_), .b(new_n53_), .c(new_n79_), .O(z15));
  nand3  g56(.a(new_n99_), .b(new_n73_), .c(new_n79_), .O(z16));
  nand3  g57(.a(new_n99_), .b(new_n48_), .c(new_n79_), .O(z17));
  nand3  g58(.a(new_n99_), .b(new_n49_), .c(new_n79_), .O(z18));
  buf1   g59(.a(x16), .O(z02));
endmodule
