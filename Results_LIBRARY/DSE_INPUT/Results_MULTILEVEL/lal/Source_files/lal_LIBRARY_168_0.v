...
module FAU ( 
  ...
  nand2  g43(.a(new_n56_), .b(new_n50_), .O(new_n89_));
  nand2  g44(.a(x18), .b(x17), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(x19), .O(new_n91_));
  nand3  g46(.a(new_n53_), .b(x18), .c(x17), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n61_), .c(new_n81_), .d(new_n80_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z12));
  nand4  g50(.a(new_n90_), .b(new_n61_), .c(x20), .d(x19), .O(new_n96_));
  and2   g51(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  inv1   g52(.a(new_n90_), .O(new_n98_));
  nor2   g53(.a(new_n50_), .b(x19), .O(new_n99_));
  nor2   g54(.a(x20), .b(new_n53_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n98_), .c(new_n99_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n97_), .c(new_n81_), .d(new_n80_), .O(z13));
  nand4  g57(.a(new_n90_), .b(new_n61_), .c(x19), .d(new_n81_), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(x07), .c(new_n100_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x21), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n61_), .c(new_n81_), .d(new_n80_), .O(z14));
  aoi21  g61(.a(new_n62_), .b(new_n81_), .c(x07), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n57_), .c(new_n81_), .O(z15));
  nor2   g63(.a(x23), .b(x15), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n107_), .O(z16));
  nand3  g65(.a(new_n107_), .b(new_n48_), .c(new_n81_), .O(z17));
  nand3  g66(.a(new_n107_), .b(new_n49_), .c(new_n81_), .O(z18));
