...
module FAU ( 
  ...
  nand2  g53(.a(new_n80_), .b(new_n79_), .O(new_n99_));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nor2   g56(.a(x15), .b(x07), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n101_), .c(new_n99_), .d(new_n54_), .O(z13));
  inv1   g58(.a(x22), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(x20), .c(x21), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(x19), .c(x18), .d(x17), .O(new_n106_));
  nand3  g61(.a(new_n54_), .b(new_n87_), .c(new_n86_), .O(new_n107_));
  aoi21  g62(.a(new_n99_), .b(x21), .c(new_n107_), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n106_), .O(z14));
  inv1   g64(.a(x21), .O(new_n110_));
  nand3  g65(.a(new_n80_), .b(new_n110_), .c(x19), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(x22), .O(new_n112_));
  inv1   g67(.a(new_n100_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n78_), .c(new_n75_), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n112_), .c(new_n102_), .d(new_n54_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand4  g72(.a(new_n117_), .b(new_n113_), .c(new_n110_), .d(new_n75_), .O(new_n118_));
  nand4  g73(.a(new_n118_), .b(new_n116_), .c(new_n102_), .d(new_n54_), .O(z16));
  nand3  g74(.a(new_n81_), .b(new_n104_), .c(new_n110_), .O(new_n120_));
  nor2   g75(.a(new_n120_), .b(x20), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(x19), .c(x18), .d(x17), .O(new_n122_));
  aoi21  g77(.a(new_n118_), .b(x24), .c(new_n107_), .O(new_n123_));
  nand2  g78(.a(new_n123_), .b(new_n122_), .O(z17));
  nand2  g79(.a(new_n82_), .b(x25), .O(new_n125_));
  nor3   g80(.a(x25), .b(x24), .c(x23), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n80_), .c(new_n78_), .d(new_n79_), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n125_), .c(new_n102_), .d(new_n54_), .O(z18));
