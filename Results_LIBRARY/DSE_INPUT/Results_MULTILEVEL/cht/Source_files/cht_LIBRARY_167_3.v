...
module FAU ( 
  ...
  nand3  g022(.a(x18), .b(new_n105_), .c(x08), .O(new_n106_));
  nand2  g023(.a(new_n106_), .b(new_n104_), .O(z06));
  nand2  g024(.a(x18), .b(new_n103_), .O(new_n108_));
  nand2  g025(.a(x19), .b(x08), .O(new_n109_));
  aoi21  g026(.a(new_n109_), .b(new_n108_), .c(x10), .O(z07));
  nand2  g027(.a(x19), .b(new_n103_), .O(new_n111_));
  nand2  g028(.a(x20), .b(x08), .O(new_n112_));
  aoi21  g029(.a(new_n112_), .b(new_n111_), .c(x10), .O(z08));
  nand2  g030(.a(x20), .b(new_n103_), .O(new_n114_));
  nand2  g031(.a(x21), .b(x08), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n114_), .c(x10), .O(z09));
  nand2  g033(.a(x21), .b(new_n103_), .O(new_n117_));
  ...
  nand2  g042(.a(x24), .b(new_n103_), .O(new_n126_));
  nand2  g043(.a(x25), .b(x08), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(new_n126_), .c(x10), .O(z13));
  nand2  g045(.a(x25), .b(new_n103_), .O(new_n129_));
  ...
  nand2  g054(.a(x28), .b(new_n103_), .O(new_n138_));
  ...
  nand2  g061(.a(x30), .b(new_n103_), .O(new_n145_));
