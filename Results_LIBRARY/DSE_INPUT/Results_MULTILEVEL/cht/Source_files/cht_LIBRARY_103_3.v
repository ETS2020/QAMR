// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:50 2020
...
module FAU ( 
  ...
  inv1   g107(.a(x10), .O(new_n191_));
  nand3  g108(.a(new_n175_), .b(x44), .c(new_n191_), .O(new_n192_));
  ...
  nand4  g112(.a(x46), .b(new_n174_), .c(new_n191_), .d(x09), .O(new_n196_));
