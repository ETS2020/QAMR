...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n189_, new_n191_, new_n193_, new_n195_, new_n196_;
  ...
  aoi21  g108(.a(new_n175_), .b(new_n191_), .c(x10), .O(z33));
  nor2   g109(.a(x46), .b(x14), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(x09), .c(x10), .O(z34));
