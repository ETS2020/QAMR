...
module FAU ( 
  ...
  aoi21  g060(.a(new_n143_), .b(new_n103_), .c(x10), .O(z19));
  ...
  oai21  g086(.a(x14), .b(new_n145_), .c(x39), .O(new_n170_));
  inv1   g087(.a(x14), .O(new_n171_));
  nand3  g088(.a(x40), .b(new_n171_), .c(x09), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n170_), .c(x10), .O(z28));
  oai21  g090(.a(x14), .b(new_n145_), .c(x40), .O(new_n174_));
  nand3  g091(.a(x41), .b(new_n171_), .c(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z29));
  oai21  g093(.a(x14), .b(new_n145_), .c(x41), .O(new_n177_));
  nand3  g094(.a(x42), .b(new_n171_), .c(x09), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z30));
  oai21  g096(.a(x14), .b(new_n145_), .c(x42), .O(new_n180_));
  nand3  g097(.a(x43), .b(new_n171_), .c(x09), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z31));
  oai21  g099(.a(x14), .b(new_n145_), .c(x43), .O(new_n183_));
  nand3  g100(.a(x44), .b(new_n171_), .c(x09), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z32));
  oai21  g102(.a(x14), .b(new_n145_), .c(x44), .O(new_n186_));
  nand3  g103(.a(x45), .b(new_n171_), .c(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z33));
  oai21  g105(.a(x14), .b(new_n145_), .c(x45), .O(new_n189_));
  nand3  g106(.a(x46), .b(new_n171_), .c(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n189_), .c(x10), .O(z34));
  aoi21  g108(.a(new_n171_), .b(x09), .c(x46), .O(new_n192_));
  nor2   g109(.a(new_n192_), .b(x10), .O(z35));
endmodule
