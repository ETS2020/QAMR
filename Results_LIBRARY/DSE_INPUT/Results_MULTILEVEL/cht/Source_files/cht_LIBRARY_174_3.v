...
module FAU ( 
  ...
  inv1   g042(.a(x10), .O(new_n126_));
  nand3  g043(.a(x24), .b(new_n126_), .c(new_n103_), .O(new_n127_));
  oai21  g044(.a(new_n125_), .b(new_n103_), .c(new_n127_), .O(z13));
  nand3  g045(.a(x26), .b(new_n126_), .c(x08), .O(new_n129_));
  oai21  g046(.a(new_n125_), .b(x08), .c(new_n129_), .O(z14));
