// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:35 2020
...
module FAU ( 
  ...
  inv1   g063(.a(x10), .O(new_n147_));
  nand3  g064(.a(x31), .b(new_n147_), .c(new_n146_), .O(new_n148_));
  inv1   g065(.a(new_n148_), .O(z20));
  nand3  g066(.a(x33), .b(new_n147_), .c(x09), .O(new_n150_));
  inv1   g067(.a(new_n150_), .O(z21));
  nand2  g068(.a(x33), .b(new_n146_), .O(new_n152_));
