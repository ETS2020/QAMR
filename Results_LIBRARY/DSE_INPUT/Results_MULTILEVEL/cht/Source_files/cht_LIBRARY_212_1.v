// Benchmark "FAU" written by ABC on Mon Jul 27 17:54:09 2020
...
module FAU ( 
  ...
  nand2  g084(.a(x39), .b(x09), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z27));
  nand2  g086(.a(x39), .b(new_n145_), .O(new_n170_));
  nand2  g087(.a(x40), .b(x09), .O(new_n171_));
  aoi21  g088(.a(new_n171_), .b(new_n170_), .c(x10), .O(z28));
  nand2  g089(.a(x40), .b(new_n145_), .O(new_n173_));
  nand2  g090(.a(x41), .b(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z29));
  nand2  g092(.a(x41), .b(new_n145_), .O(new_n176_));
  nand2  g093(.a(x42), .b(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z30));
  nand2  g095(.a(x42), .b(new_n145_), .O(new_n179_));
  nand2  g096(.a(x43), .b(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z31));
  nand2  g098(.a(x43), .b(new_n145_), .O(new_n182_));
  nand2  g099(.a(x44), .b(x09), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z32));
  nand2  g101(.a(x44), .b(new_n145_), .O(new_n185_));
  nand2  g102(.a(x45), .b(x09), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z33));
  nand2  g104(.a(x45), .b(new_n145_), .O(new_n188_));
  nand2  g105(.a(x46), .b(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z34));
  nand2  g107(.a(x09), .b(x00), .O(new_n191_));
  nand2  g108(.a(x46), .b(new_n145_), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z35));
endmodule
