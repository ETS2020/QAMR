// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:36 2020
...
module FAU ( 
  ...
  nand2  g004(.a(x12), .b(new_n87_), .O(new_n88_));
  aoi21  g005(.a(new_n88_), .b(new_n86_), .c(x10), .O(z01));
  nand2  g006(.a(x07), .b(x06), .O(new_n90_));
  nand2  g007(.a(x13), .b(new_n87_), .O(new_n91_));
  aoi21  g008(.a(new_n91_), .b(new_n90_), .c(x10), .O(z02));
  nand2  g009(.a(x07), .b(x01), .O(new_n93_));
  nand2  g010(.a(x14), .b(new_n87_), .O(new_n94_));
  aoi21  g011(.a(new_n94_), .b(new_n93_), .c(x10), .O(z03));
  nand2  g012(.a(x07), .b(x02), .O(new_n96_));
  nand2  g013(.a(x15), .b(new_n87_), .O(new_n97_));
  aoi21  g014(.a(new_n97_), .b(new_n96_), .c(x10), .O(z04));
  nand2  g015(.a(x07), .b(x03), .O(new_n99_));
  nand2  g016(.a(x16), .b(new_n87_), .O(new_n100_));
