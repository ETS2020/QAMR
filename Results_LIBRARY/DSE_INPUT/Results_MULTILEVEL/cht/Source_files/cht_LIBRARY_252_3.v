// Benchmark "FAU" written by ABC on Mon Jul 27 17:54:16 2020
...
module FAU ( 
  ...
  inv1   g051(.a(x10), .O(new_n135_));
  nand3  g052(.a(x27), .b(new_n135_), .c(new_n103_), .O(new_n136_));
  oai21  g053(.a(new_n134_), .b(new_n103_), .c(new_n136_), .O(z16));
  nand3  g054(.a(x29), .b(new_n135_), .c(x08), .O(new_n138_));
  oai21  g055(.a(new_n134_), .b(x08), .c(new_n138_), .O(z17));
