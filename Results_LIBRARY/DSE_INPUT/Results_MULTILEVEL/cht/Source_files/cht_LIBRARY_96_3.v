// Benchmark "FAU" written by ABC on Mon Jul 27 17:53:49 2020
...
module FAU ( 
  ...
  inv1   g060(.a(x10), .O(new_n144_));
  nand3  g061(.a(x30), .b(new_n144_), .c(new_n103_), .O(new_n145_));
  oai21  g062(.a(new_n103_), .b(new_n143_), .c(new_n145_), .O(z19));
  ...
  nand3  g087(.a(x39), .b(new_n170_), .c(new_n144_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(x09), .O(new_n173_));
  nand3  g090(.a(x38), .b(new_n144_), .c(new_n147_), .O(new_n174_));
