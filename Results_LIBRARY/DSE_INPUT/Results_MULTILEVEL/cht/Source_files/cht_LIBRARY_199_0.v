// Benchmark "FAU" written by ABC on Mon Jul 27 17:54:06 2020
...
module FAU ( 
  ...
  nor2   g063(.a(new_n146_), .b(x10), .O(z20));
  inv1   g064(.a(x33), .O(new_n148_));
  nor2   g065(.a(new_n148_), .b(x10), .O(z21));
  inv1   g066(.a(x34), .O(new_n150_));
  nor2   g067(.a(new_n150_), .b(x10), .O(z22));
  inv1   g068(.a(x35), .O(new_n152_));
  nor2   g069(.a(new_n152_), .b(x10), .O(z23));
  inv1   g070(.a(x36), .O(new_n154_));
  nor2   g071(.a(new_n154_), .b(x10), .O(z24));
  inv1   g072(.a(x37), .O(new_n156_));
  nor2   g073(.a(new_n156_), .b(x10), .O(z25));
  inv1   g074(.a(x38), .O(new_n158_));
  nor2   g075(.a(new_n158_), .b(x10), .O(z26));
  nand2  g076(.a(x14), .b(x00), .O(new_n160_));
  inv1   g077(.a(x14), .O(new_n161_));
  nand2  g078(.a(x39), .b(new_n161_), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n160_), .c(x10), .O(z27));
  nand2  g080(.a(x39), .b(x14), .O(new_n164_));
  nand2  g081(.a(x40), .b(new_n161_), .O(new_n165_));
  aoi21  g082(.a(new_n165_), .b(new_n164_), .c(x10), .O(z28));
  nand2  g083(.a(x40), .b(x14), .O(new_n167_));
  nand2  g084(.a(x41), .b(new_n161_), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z29));
  nand2  g086(.a(x41), .b(x14), .O(new_n170_));
  nand2  g087(.a(x42), .b(new_n161_), .O(new_n171_));
  aoi21  g088(.a(new_n171_), .b(new_n170_), .c(x10), .O(z30));
  nand2  g089(.a(x42), .b(x14), .O(new_n173_));
  nand2  g090(.a(x43), .b(new_n161_), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z31));
  nand2  g092(.a(x43), .b(x14), .O(new_n176_));
  nand2  g093(.a(x44), .b(new_n161_), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z32));
  nand2  g095(.a(x44), .b(x14), .O(new_n179_));
  nand2  g096(.a(x45), .b(new_n161_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z33));
  nand2  g098(.a(x45), .b(x14), .O(new_n182_));
  nand2  g099(.a(x46), .b(new_n161_), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z34));
  nand2  g101(.a(new_n161_), .b(x00), .O(new_n185_));
  nand2  g102(.a(x46), .b(x14), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z35));
endmodule
