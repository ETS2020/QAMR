...
module FAU ( 
  ...
  nand3  g034(.a(x21), .b(new_n117_), .c(new_n103_), .O(new_n118_));
  oai21  g035(.a(new_n116_), .b(new_n103_), .c(new_n118_), .O(z10));
  nand3  g036(.a(x23), .b(new_n117_), .c(x08), .O(new_n120_));
  oai21  g037(.a(new_n116_), .b(x08), .c(new_n120_), .O(z11));
