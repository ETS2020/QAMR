// Benchmark "FAU" written by ABC on Mon Jul 27 18:26:32 2020
...
module FAU ( 
  ...
  and2   g03(.a(x08), .b(x01), .O(z09));
  inv1   g04(.a(x11), .O(new_n38_));
  nand2  g05(.a(x08), .b(x02), .O(new_n39_));
  oai21  g06(.a(new_n38_), .b(x08), .c(new_n39_), .O(z10));
