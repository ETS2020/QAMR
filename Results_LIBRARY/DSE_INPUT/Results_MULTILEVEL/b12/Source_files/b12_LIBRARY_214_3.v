...
module FAU ( 
  ...
  oai21  g51(.a(new_n72_), .b(x08), .c(new_n75_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand3  g53(.a(new_n64_), .b(new_n77_), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  aoi21  g55(.a(new_n66_), .b(new_n56_), .c(x10), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n42_), .O(z8));
endmodule
