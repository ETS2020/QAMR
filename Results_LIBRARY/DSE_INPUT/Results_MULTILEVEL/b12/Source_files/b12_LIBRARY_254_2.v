...
module FAU ( 
  ...
  nand3  g12(.a(new_n36_), .b(new_n34_), .c(new_n31_), .O(new_n37_));
  ...
  nand2  g17(.a(new_n31_), .b(x01), .O(new_n42_));
  oai21  g18(.a(new_n30_), .b(new_n25_), .c(x04), .O(new_n43_));
  inv1   g19(.a(x03), .O(new_n44_));
  nor2   g20(.a(x04), .b(new_n44_), .O(new_n45_));
  nor2   g21(.a(x10), .b(x07), .O(new_n46_));
  oai21  g22(.a(new_n46_), .b(new_n45_), .c(new_n25_), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n43_), .c(new_n42_), .O(new_n48_));
  ...
  oai21  g35(.a(new_n59_), .b(new_n53_), .c(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n39_), .O(new_n61_));
  ...
  oai21  g46(.a(x09), .b(new_n44_), .c(new_n25_), .O(new_n71_));
  nor2   g47(.a(x02), .b(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n64_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  oai21  g50(.a(new_n52_), .b(x03), .c(new_n39_), .O(new_n75_));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n25_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x01), .c(new_n64_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n58_), .c(new_n51_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n39_), .O(new_n83_));
  nand4  g59(.a(new_n58_), .b(new_n57_), .c(new_n51_), .d(x02), .O(new_n84_));
  ...
  nor2   g63(.a(new_n87_), .b(new_n49_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n39_), .d(new_n25_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n52_), .b(new_n64_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n51_), .O(z8));
endmodule
