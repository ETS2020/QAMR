...
module FAU ( 
  ...
  oai21  g38(.a(new_n62_), .b(x00), .c(new_n49_), .O(new_n63_));
  ...
  aoi21  g47(.a(x12), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n56_), .c(new_n49_), .d(new_n70_), .O(z5));
  oai21  g49(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n70_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  oai21  g53(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n25_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n70_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n56_), .c(new_n49_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n38_), .O(new_n86_));
  nand4  g62(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n25_), .O(new_n89_));
  aoi21  g65(.a(x03), .b(new_n25_), .c(x08), .O(new_n90_));
  nor2   g66(.a(new_n90_), .b(new_n47_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n89_), .O(z7));
  nand4  g68(.a(new_n62_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n50_), .b(new_n70_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n49_), .O(z8));
endmodule
