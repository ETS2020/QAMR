...
module FAU ( 
  ...
  oai22  g44(.a(x10), .b(new_n25_), .c(x09), .d(new_n34_), .O(new_n69_));
  nand2  g45(.a(new_n38_), .b(new_n62_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n62_), .c(new_n70_), .O(new_n71_));
  ...
  nand2  g54(.a(new_n78_), .b(new_n56_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n72_), .c(x07), .O(z6));
