...
module FAU ( 
  ...
  nor2   g46(.a(x08), .b(new_n63_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(x02), .O(new_n72_));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  xnor2a g49(.a(x09), .b(x03), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x01), .c(new_n26_), .O(new_n75_));
  ...
  nand4  g64(.a(new_n57_), .b(new_n51_), .c(new_n50_), .d(x00), .O(z8));
endmodule
