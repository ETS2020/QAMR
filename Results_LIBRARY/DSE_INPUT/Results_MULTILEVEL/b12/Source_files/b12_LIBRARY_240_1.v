...
module FAU ( 
  ...
  aoi22  g11(.a(x06), .b(x05), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  nand2  g19(.a(new_n26_), .b(x03), .O(new_n44_));
  inv1   g20(.a(x07), .O(new_n45_));
  inv1   g21(.a(x10), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(new_n45_), .c(new_n25_), .O(new_n47_));
  nand4  g23(.a(new_n47_), .b(new_n44_), .c(new_n43_), .d(new_n42_), .O(new_n48_));
  oai21  g24(.a(x10), .b(x07), .c(new_n34_), .O(new_n49_));
  nand3  g25(.a(new_n46_), .b(x09), .c(new_n45_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n49_), .c(x01), .O(new_n51_));
  aoi21  g27(.a(new_n48_), .b(x02), .c(new_n51_), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  inv1   g29(.a(x09), .O(new_n54_));
  nor2   g30(.a(x10), .b(new_n54_), .O(new_n55_));
  nor2   g31(.a(new_n46_), .b(x03), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(new_n25_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n38_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n53_), .c(new_n45_), .O(new_n59_));
  oai21  g35(.a(new_n52_), .b(x00), .c(new_n59_), .O(z2));
  ...
  oai21  g40(.a(x11), .b(new_n45_), .c(new_n64_), .O(z4));
  nor2   g41(.a(x12), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n46_), .d(new_n45_), .O(z5));
  ...
  oai21  g47(.a(new_n54_), .b(x03), .c(new_n38_), .O(new_n72_));
  ...
  nand4  g56(.a(new_n46_), .b(new_n53_), .c(new_n45_), .d(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(new_n83_));
  oai21  g59(.a(new_n34_), .b(x01), .c(new_n53_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n46_), .d(new_n45_), .O(z7));
  ...
  aoi21  g64(.a(new_n54_), .b(new_n61_), .c(x10), .O(new_n89_));
