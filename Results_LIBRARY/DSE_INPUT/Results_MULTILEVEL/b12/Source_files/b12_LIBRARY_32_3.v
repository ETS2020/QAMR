...
module FAU ( 
  ...
  nand3  g48(.a(x09), .b(new_n55_), .c(new_n34_), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(x00), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand3  g51(.a(new_n55_), .b(x02), .c(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n56_), .c(new_n49_), .O(new_n78_));
  ...
  aoi21  g62(.a(new_n49_), .b(new_n34_), .c(x12), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n38_), .c(new_n25_), .O(new_n88_));
