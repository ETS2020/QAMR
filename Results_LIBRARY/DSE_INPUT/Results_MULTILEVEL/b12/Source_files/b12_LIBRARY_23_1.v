// Benchmark "FAU" written by ABC on Mon Jul 27 17:21:43 2020
...
module FAU ( 
  ...
  oai21  g37(.a(new_n61_), .b(new_n48_), .c(x00), .O(new_n62_));
  inv1   g38(.a(x00), .O(new_n63_));
  nand2  g39(.a(new_n48_), .b(new_n63_), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n61_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n62_), .O(z3));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n48_), .O(new_n69_));
  oai21  g45(.a(x11), .b(new_n48_), .c(new_n69_), .O(z4));
  nand4  g46(.a(x13), .b(new_n55_), .c(new_n48_), .d(new_n63_), .O(z5));
  oai21  g47(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n72_));
  nor2   g48(.a(x02), .b(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n63_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  oai21  g51(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n76_));
  nand2  g52(.a(x08), .b(x00), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n25_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x02), .c(new_n63_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n55_), .c(new_n48_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand2  g59(.a(new_n48_), .b(x02), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x03), .c(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n55_), .d(new_n48_), .O(z7));
  nand3  g64(.a(x03), .b(new_n38_), .c(new_n25_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n49_), .b(new_n63_), .c(x10), .O(new_n91_));
