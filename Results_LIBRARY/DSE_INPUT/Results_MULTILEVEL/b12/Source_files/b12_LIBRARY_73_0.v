...
module FAU ( 
  ...
  oai21  g05(.a(new_n29_), .b(new_n25_), .c(x04), .O(new_n30_));
  nand2  g06(.a(new_n30_), .b(x01), .O(new_n31_));
  aoi21  g07(.a(new_n31_), .b(new_n28_), .c(x00), .O(z0));
  inv1   g08(.a(x04), .O(new_n33_));
  nand2  g09(.a(new_n33_), .b(x03), .O(new_n34_));
  oai21  g10(.a(new_n33_), .b(new_n25_), .c(new_n34_), .O(new_n35_));
  ...
  aoi21  g20(.a(new_n44_), .b(new_n33_), .c(new_n25_), .O(new_n45_));
  inv1   g21(.a(x03), .O(new_n46_));
  oai21  g22(.a(x10), .b(x07), .c(new_n46_), .O(new_n47_));
  nand3  g23(.a(new_n43_), .b(x09), .c(new_n42_), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n47_), .c(new_n34_), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n45_), .c(new_n41_), .O(new_n50_));
  nand3  g26(.a(new_n29_), .b(x04), .c(x02), .O(new_n51_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n41_), .O(new_n58_));
  ...
  aoi22  g37(.a(x12), .b(new_n40_), .c(x11), .d(x07), .O(z3));
  ...
  nand2  g43(.a(new_n55_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n25_), .c(new_n40_), .O(new_n69_));
  nand3  g45(.a(x09), .b(new_n46_), .c(new_n41_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n54_), .O(new_n72_));
  oai21  g48(.a(new_n55_), .b(x03), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n41_), .O(new_n74_));
  oai21  g50(.a(x09), .b(new_n46_), .c(new_n41_), .O(new_n75_));
  ...
  nand2  g56(.a(new_n80_), .b(new_n72_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n43_), .c(new_n42_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n41_), .O(new_n84_));
  nand4  g60(.a(new_n43_), .b(new_n54_), .c(new_n42_), .d(x01), .O(new_n85_));
  ...
  aoi21  g64(.a(new_n88_), .b(new_n54_), .c(new_n44_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n55_), .b(new_n40_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n42_), .O(z8));
endmodule
