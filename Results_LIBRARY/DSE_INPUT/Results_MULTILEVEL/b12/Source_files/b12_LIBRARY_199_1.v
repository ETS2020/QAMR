...
module FAU ( 
  ...
  nand4  g45(.a(new_n69_), .b(new_n57_), .c(new_n50_), .d(new_n63_), .O(z5));
  nand2  g46(.a(new_n51_), .b(x03), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n25_), .c(new_n63_), .O(new_n72_));
  nand3  g48(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n26_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n56_), .O(new_n75_));
  oai21  g51(.a(new_n51_), .b(x03), .c(new_n25_), .O(new_n76_));
  ...
  nand2  g58(.a(new_n82_), .b(new_n63_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n75_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n57_), .c(new_n50_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n27_), .O(new_n87_));
  nand4  g63(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x01), .O(new_n88_));
  ...
  aoi21  g67(.a(new_n91_), .b(new_n56_), .c(new_n48_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n90_), .O(z7));
  nand3  g69(.a(x03), .b(new_n25_), .c(new_n27_), .O(new_n94_));
