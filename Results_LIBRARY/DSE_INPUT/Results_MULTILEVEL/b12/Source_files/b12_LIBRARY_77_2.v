...
module FAU ( 
  ...
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n45_), .d(new_n53_), .O(z5));
  nor2   g35(.a(new_n41_), .b(new_n53_), .O(new_n60_));
  oai21  g36(.a(x09), .b(new_n30_), .c(new_n26_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n33_), .O(new_n62_));
  nand3  g38(.a(x09), .b(new_n30_), .c(new_n26_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(new_n64_));
  nand2  g40(.a(x14), .b(x01), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n53_), .O(new_n66_));
  nand2  g42(.a(new_n41_), .b(x00), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(new_n33_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n64_), .c(new_n36_), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(x07), .O(z6));
  nand3  g46(.a(x09), .b(x03), .c(new_n26_), .O(new_n71_));
  nand4  g47(.a(new_n36_), .b(new_n41_), .c(new_n45_), .d(x01), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n33_), .O(new_n74_));
  oai21  g50(.a(x07), .b(new_n33_), .c(x03), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n41_), .c(new_n46_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z7));
  inv1   g53(.a(x12), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x03), .c(new_n33_), .d(new_n26_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x09), .O(new_n80_));
  aoi21  g56(.a(new_n37_), .b(new_n53_), .c(x10), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z8));
endmodule
