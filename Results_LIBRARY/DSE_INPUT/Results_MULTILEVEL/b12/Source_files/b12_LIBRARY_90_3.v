...
module FAU ( 
  ...
  nand4  g59(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n87_), .b(new_n55_), .c(new_n47_), .O(new_n88_));
