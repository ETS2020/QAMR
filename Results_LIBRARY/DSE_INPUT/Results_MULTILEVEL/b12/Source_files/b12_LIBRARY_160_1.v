...
module FAU ( 
  ...
  oai21  g21(.a(new_n45_), .b(x01), .c(new_n28_), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(new_n44_), .c(new_n37_), .O(new_n47_));
  ...
  nand2  g31(.a(new_n41_), .b(new_n28_), .O(new_n56_));
  nand2  g32(.a(x08), .b(x00), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n56_), .c(new_n34_), .O(new_n58_));
  aoi21  g34(.a(x14), .b(x02), .c(x00), .O(new_n59_));
  aoi21  g35(.a(new_n44_), .b(x00), .c(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n34_), .c(new_n58_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n38_), .c(new_n37_), .O(new_n62_));
  inv1   g38(.a(new_n62_), .O(z6));
  nand3  g39(.a(new_n38_), .b(x08), .c(new_n37_), .O(z7));
  nand4  g40(.a(new_n38_), .b(new_n41_), .c(new_n37_), .d(x00), .O(z8));
endmodule
