...
module FAU ( 
  ...
  oai21  g21(.a(new_n42_), .b(x00), .c(new_n45_), .O(z2));
  ...
  nand2  g30(.a(x14), .b(x02), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n47_), .O(new_n56_));
  oai21  g32(.a(x08), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n52_), .c(new_n43_), .O(new_n58_));
