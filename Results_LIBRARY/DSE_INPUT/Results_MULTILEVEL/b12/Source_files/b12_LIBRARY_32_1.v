...
module FAU ( 
  ...
  oai21  g42(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n67_));
  oai21  g43(.a(x01), .b(x00), .c(x08), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n70_));
  oai21  g46(.a(x02), .b(x00), .c(x08), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  inv1   g48(.a(x14), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x01), .c(new_n60_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n54_), .c(new_n48_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  oai21  g53(.a(x10), .b(new_n25_), .c(new_n38_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n48_), .c(new_n34_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n54_), .c(new_n48_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n79_), .b(x08), .c(new_n82_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n49_), .b(new_n60_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n48_), .O(z8));
endmodule
