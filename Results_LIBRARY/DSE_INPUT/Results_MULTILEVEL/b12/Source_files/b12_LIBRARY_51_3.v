...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(x09), .O(new_n53_));
  oai21  g29(.a(new_n46_), .b(x03), .c(new_n53_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n52_), .c(new_n27_), .O(new_n55_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n52_), .c(x03), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x00), .O(new_n68_));
  nor2   g44(.a(new_n52_), .b(x00), .O(new_n69_));
  nor2   g45(.a(x08), .b(x02), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(x01), .O(new_n71_));
  nand3  g47(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n72_));
  nand3  g48(.a(new_n65_), .b(x03), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n42_), .O(new_n75_));
  nand3  g51(.a(x09), .b(new_n52_), .c(new_n36_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nor2   g53(.a(x14), .b(new_n25_), .O(new_n78_));
  aoi21  g54(.a(new_n77_), .b(new_n27_), .c(new_n78_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n75_), .c(new_n71_), .d(new_n68_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n46_), .c(new_n45_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand2  g58(.a(x05), .b(x01), .O(new_n83_));
  oai21  g59(.a(x05), .b(new_n36_), .c(new_n83_), .O(new_n84_));
  aoi21  g60(.a(x01), .b(new_n42_), .c(x10), .O(new_n85_));
  aoi22  g61(.a(new_n85_), .b(new_n45_), .c(new_n84_), .d(new_n42_), .O(new_n86_));
  oai21  g62(.a(new_n47_), .b(new_n26_), .c(x03), .O(new_n87_));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n46_), .c(new_n45_), .O(new_n89_));
  aoi21  g65(.a(new_n87_), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n86_), .b(new_n25_), .c(new_n90_), .O(z7));
  aoi21  g67(.a(new_n45_), .b(new_n36_), .c(x12), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n25_), .c(new_n27_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n65_), .b(new_n42_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(z8));
endmodule
