...
module FAU ( 
  ...
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n38_), .O(new_n61_));
  aoi21  g37(.a(x14), .b(x01), .c(x00), .O(new_n62_));
  aoi21  g38(.a(new_n47_), .b(x00), .c(new_n62_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n38_), .c(new_n61_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n43_), .c(new_n42_), .O(new_n65_));
  inv1   g41(.a(new_n65_), .O(z6));
  nand4  g42(.a(new_n59_), .b(new_n43_), .c(new_n47_), .d(new_n42_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n38_), .O(new_n69_));
  nand3  g45(.a(new_n47_), .b(new_n42_), .c(x02), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n43_), .d(new_n42_), .O(z7));
  nand3  g47(.a(new_n44_), .b(new_n31_), .c(new_n25_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n52_), .c(x09), .O(new_n73_));
  nand2  g49(.a(x12), .b(new_n38_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n43_), .c(new_n42_), .O(new_n75_));
