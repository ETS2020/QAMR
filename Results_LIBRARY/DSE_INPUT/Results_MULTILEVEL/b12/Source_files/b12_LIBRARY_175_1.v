...
module FAU ( 
  ...
  oai21  g39(.a(new_n50_), .b(new_n62_), .c(new_n49_), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x07), .c(new_n55_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n64_), .O(z4));
  nor2   g43(.a(x12), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n56_), .d(new_n49_), .O(z5));
