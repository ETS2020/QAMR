...
module FAU ( 
  ...
  oai21  g19(.a(x04), .b(new_n36_), .c(x07), .O(new_n44_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n27_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n25_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n54_), .c(new_n47_), .O(new_n60_));
  ...
  nand3  g44(.a(new_n48_), .b(new_n55_), .c(x03), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n25_), .c(new_n62_), .O(new_n70_));
  nand3  g46(.a(x09), .b(new_n36_), .c(new_n27_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n26_), .c(x10), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n70_), .c(new_n54_), .O(new_n73_));
  nand3  g49(.a(new_n48_), .b(x09), .c(new_n36_), .O(new_n74_));
  ...
  oai21  g56(.a(new_n80_), .b(new_n75_), .c(new_n62_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n73_), .c(x07), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n27_), .O(new_n83_));
  nand4  g59(.a(new_n48_), .b(new_n54_), .c(new_n47_), .d(x01), .O(new_n84_));
  ...
  aoi21  g63(.a(new_n87_), .b(new_n54_), .c(new_n49_), .O(new_n88_));
  ...
  aoi21  g68(.a(new_n55_), .b(new_n62_), .c(x10), .O(new_n93_));
