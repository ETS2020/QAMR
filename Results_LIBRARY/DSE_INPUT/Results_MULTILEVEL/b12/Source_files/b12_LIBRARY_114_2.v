...
module FAU ( 
  ...
  nand2  g41(.a(new_n51_), .b(x03), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n25_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n64_), .c(new_n46_), .d(new_n45_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(z6));
  nand3  g45(.a(new_n46_), .b(new_n45_), .c(x01), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n50_), .O(new_n72_));
  nand3  g48(.a(x09), .b(x03), .c(new_n25_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n46_), .d(new_n45_), .O(z7));
  inv1   g50(.a(x12), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x03), .c(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x09), .O(new_n77_));
  aoi21  g53(.a(new_n51_), .b(new_n41_), .c(x10), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n45_), .O(z8));
endmodule
