...
module FAU ( 
  ...
  oai22  g18(.a(x10), .b(x07), .c(x04), .d(new_n34_), .O(new_n43_));
  ...
  aoi21  g27(.a(new_n45_), .b(x02), .c(new_n51_), .O(new_n52_));
  nand2  g28(.a(x10), .b(new_n34_), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  nand2  g30(.a(new_n49_), .b(new_n54_), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n53_), .c(x01), .O(new_n56_));
  nor2   g32(.a(x08), .b(new_n38_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n47_), .O(new_n58_));
  ...
  oai21  g39(.a(new_n48_), .b(x01), .c(new_n63_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n54_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n49_), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  oai21  g43(.a(x11), .b(new_n47_), .c(new_n67_), .O(z4));
  nor3   g44(.a(x12), .b(x10), .c(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(x13), .c(new_n47_), .O(z5));
  ...
  oai21  g50(.a(new_n48_), .b(x03), .c(new_n38_), .O(new_n75_));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n25_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x01), .c(new_n60_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n62_), .c(new_n47_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n38_), .O(new_n83_));
  nand4  g59(.a(new_n62_), .b(new_n54_), .c(new_n47_), .d(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  oai21  g62(.a(new_n34_), .b(x01), .c(new_n54_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n62_), .d(new_n47_), .O(z7));
  ...
  nand2  g67(.a(new_n48_), .b(new_n60_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n62_), .d(new_n47_), .O(z8));
endmodule
