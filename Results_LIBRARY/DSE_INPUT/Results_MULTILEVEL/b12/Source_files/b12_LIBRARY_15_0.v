...
module FAU ( 
  ...
  oai21  g08(.a(x04), .b(x03), .c(new_n29_), .O(new_n33_));
  inv1   g09(.a(x06), .O(new_n34_));
  oai21  g10(.a(x04), .b(x03), .c(new_n34_), .O(new_n35_));
  nand3  g11(.a(new_n35_), .b(new_n33_), .c(x05), .O(new_n36_));
  ...
  aoi21  g18(.a(new_n42_), .b(new_n38_), .c(x00), .O(new_n43_));
  nor2   g19(.a(new_n42_), .b(x08), .O(new_n44_));
  oai21  g20(.a(new_n44_), .b(new_n43_), .c(new_n41_), .O(new_n45_));
  inv1   g21(.a(x08), .O(new_n46_));
  nand3  g22(.a(x10), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n45_), .c(x07), .O(new_n48_));
  ...
  oai21  g29(.a(new_n53_), .b(new_n48_), .c(new_n29_), .O(new_n54_));
  aoi21  g30(.a(x05), .b(new_n29_), .c(x00), .O(new_n55_));
  ...
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n50_), .d(new_n59_), .O(z5));
  nor2   g41(.a(new_n46_), .b(new_n59_), .O(new_n66_));
  oai21  g42(.a(new_n42_), .b(x03), .c(new_n38_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n29_), .O(new_n68_));
  nand3  g44(.a(new_n42_), .b(x03), .c(new_n38_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(new_n70_));
  nand2  g46(.a(x14), .b(x02), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n59_), .O(new_n72_));
  nand2  g48(.a(new_n46_), .b(x00), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(new_n29_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n70_), .c(new_n41_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(x07), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n38_), .O(new_n77_));
  nand4  g53(.a(new_n41_), .b(new_n46_), .c(new_n50_), .d(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n29_), .O(new_n80_));
  nand2  g56(.a(x03), .b(new_n29_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n46_), .c(new_n51_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n38_), .d(new_n29_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n42_), .b(new_n59_), .c(x10), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n50_), .O(z8));
endmodule
