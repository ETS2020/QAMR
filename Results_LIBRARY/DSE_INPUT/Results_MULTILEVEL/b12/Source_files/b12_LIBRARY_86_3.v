...
module FAU ( 
  ...
  aoi21  g29(.a(x10), .b(new_n34_), .c(x09), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(x01), .c(new_n38_), .O(new_n55_));
  ...
  oai21  g38(.a(new_n60_), .b(x01), .c(new_n62_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n53_), .O(new_n64_));
  ...
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n61_), .d(new_n49_), .O(z5));
  nand2  g47(.a(x09), .b(new_n34_), .O(new_n72_));
  nand2  g48(.a(new_n61_), .b(x02), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x01), .O(new_n74_));
  nand4  g50(.a(new_n61_), .b(new_n60_), .c(x03), .d(new_n38_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  oai22  g52(.a(new_n76_), .b(new_n74_), .c(new_n53_), .d(new_n58_), .O(new_n77_));
  nand2  g53(.a(x14), .b(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n58_), .O(new_n79_));
  oai21  g55(.a(x08), .b(new_n58_), .c(new_n79_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n61_), .c(x01), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n77_), .c(x07), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n38_), .O(new_n83_));
  nand4  g59(.a(new_n61_), .b(new_n53_), .c(new_n49_), .d(x02), .O(new_n84_));
  ...
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n60_), .b(new_n58_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n49_), .O(z8));
endmodule
