...
module FAU ( 
  ...
  nand4  g41(.a(x13), .b(new_n55_), .c(new_n48_), .d(new_n61_), .O(z5));
  oai21  g42(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n67_));
  nor2   g43(.a(x02), .b(x00), .O(new_n68_));
  nor2   g44(.a(x08), .b(new_n61_), .O(new_n69_));
  ...
  nand3  g50(.a(new_n74_), .b(x02), .c(new_n61_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n55_), .c(new_n48_), .O(new_n77_));
  inv1   g53(.a(new_n77_), .O(z6));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  nor2   g55(.a(new_n49_), .b(new_n34_), .O(new_n80_));
  aoi22  g56(.a(new_n80_), .b(new_n79_), .c(new_n54_), .d(x02), .O(new_n81_));
  oai21  g57(.a(new_n34_), .b(x01), .c(new_n54_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n55_), .d(new_n48_), .O(z7));
  nand3  g59(.a(x03), .b(new_n38_), .c(new_n25_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n49_), .b(new_n61_), .c(x10), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(z8));
endmodule
