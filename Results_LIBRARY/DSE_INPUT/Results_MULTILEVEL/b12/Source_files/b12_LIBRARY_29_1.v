// Benchmark "FAU" written by ABC on Mon Jul 27 17:21:44 2020
...
module FAU ( 
  ...
  oai21  g36(.a(x09), .b(new_n31_), .c(new_n39_), .O(new_n61_));
  ...
  oai21  g41(.a(new_n65_), .b(x03), .c(new_n36_), .O(new_n66_));
  nand2  g42(.a(x08), .b(x00), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n39_), .O(new_n68_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n41_), .c(new_n40_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n36_), .O(new_n74_));
  nand4  g50(.a(new_n41_), .b(new_n48_), .c(new_n40_), .d(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n39_), .O(new_n77_));
  nor2   g53(.a(new_n34_), .b(x08), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(new_n42_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n36_), .d(new_n39_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n65_), .b(new_n54_), .c(x10), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n40_), .O(z8));
endmodule
