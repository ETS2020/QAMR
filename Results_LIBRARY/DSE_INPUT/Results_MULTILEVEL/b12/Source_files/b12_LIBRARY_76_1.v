...
module FAU ( 
  ...
  nand3  g21(.a(new_n45_), .b(new_n42_), .c(new_n40_), .O(new_n46_));
  ...
  oai21  g48(.a(new_n50_), .b(x03), .c(new_n37_), .O(new_n73_));
  ...
  nand3  g56(.a(x09), .b(x03), .c(new_n37_), .O(new_n81_));
  ...
  nand4  g64(.a(new_n88_), .b(x03), .c(new_n37_), .d(new_n25_), .O(new_n89_));
