// Benchmark "FAU" written by ABC on Mon Jul 27 17:21:40 2020
...
module FAU ( 
  ...
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n46_), .d(new_n45_), .O(z5));
  oai21  g39(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n64_));
  nand2  g40(.a(new_n38_), .b(new_n41_), .O(new_n65_));
  nand2  g41(.a(new_n50_), .b(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  oai21  g44(.a(new_n51_), .b(x03), .c(new_n38_), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n25_), .O(new_n71_));
  inv1   g47(.a(x14), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x01), .c(new_n41_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n46_), .c(new_n45_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n38_), .O(new_n77_));
  nand4  g53(.a(new_n46_), .b(new_n50_), .c(new_n45_), .d(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  oai21  g56(.a(new_n34_), .b(x01), .c(new_n50_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n46_), .d(new_n45_), .O(z7));
  ...
  aoi21  g61(.a(new_n51_), .b(new_n41_), .c(x10), .O(new_n86_));
