...
module FAU ( 
  ...
  nand4  g35(.a(new_n59_), .b(new_n38_), .c(new_n45_), .d(new_n25_), .O(z5));
  nand2  g36(.a(new_n40_), .b(x03), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n33_), .c(new_n25_), .O(new_n62_));
  nand3  g38(.a(x09), .b(new_n26_), .c(new_n36_), .O(new_n63_));
  oai21  g39(.a(x02), .b(new_n36_), .c(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n62_), .c(new_n37_), .O(new_n65_));
  nand2  g41(.a(x14), .b(x02), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x01), .O(new_n67_));
  oai21  g43(.a(new_n40_), .b(x03), .c(new_n33_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n36_), .O(new_n69_));
  nand3  g45(.a(new_n40_), .b(x03), .c(new_n33_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n67_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n65_), .O(new_n73_));
