...
module FAU ( 
  ...
  nor2   g43(.a(x08), .b(new_n61_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(new_n70_));
  oai21  g45(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n71_));
  nand2  g46(.a(x08), .b(x00), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  inv1   g48(.a(x14), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x02), .c(new_n61_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n55_), .c(new_n48_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z6));
  nand2  g53(.a(new_n48_), .b(x02), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x03), .c(new_n25_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n54_), .O(new_n81_));
  nor2   g56(.a(x02), .b(x01), .O(new_n82_));
  nor2   g57(.a(new_n49_), .b(new_n34_), .O(new_n83_));
  aoi21  g58(.a(new_n83_), .b(new_n82_), .c(x10), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(new_n81_), .c(new_n48_), .O(z7));
  inv1   g60(.a(x12), .O(new_n86_));
  nand3  g61(.a(new_n82_), .b(new_n86_), .c(x03), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g63(.a(new_n49_), .b(new_n61_), .c(x10), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z8));
  one    g65(.O(z5));
endmodule
