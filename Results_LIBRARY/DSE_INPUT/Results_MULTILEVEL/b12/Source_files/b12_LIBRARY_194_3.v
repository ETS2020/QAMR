...
module FAU ( 
  ...
  nand3  g56(.a(new_n80_), .b(new_n56_), .c(new_n49_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  oai21  g58(.a(x10), .b(new_n27_), .c(new_n25_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n49_), .c(new_n36_), .O(new_n84_));
  nand2  g60(.a(x09), .b(x03), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x01), .c(new_n56_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(new_n87_));
  oai21  g63(.a(new_n84_), .b(x08), .c(new_n87_), .O(z7));
  inv1   g64(.a(x12), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x03), .c(new_n27_), .O(new_n90_));
