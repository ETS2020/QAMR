...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(x01), .c(x00), .O(new_n60_));
  nand2  g36(.a(x02), .b(new_n25_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n60_), .c(x08), .O(new_n62_));
  nand2  g38(.a(x14), .b(x02), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x01), .O(new_n64_));
  oai21  g40(.a(new_n59_), .b(x02), .c(new_n25_), .O(new_n65_));
  ...
  nand4  g44(.a(new_n43_), .b(new_n47_), .c(new_n42_), .d(x02), .O(new_n69_));
  oai21  g45(.a(new_n59_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n43_), .b(new_n42_), .O(new_n72_));
  aoi21  g48(.a(new_n47_), .b(x01), .c(new_n72_), .O(new_n73_));
  ...
  nand4  g54(.a(new_n43_), .b(new_n59_), .c(new_n42_), .d(new_n25_), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n83_), .b(x09), .c(new_n72_), .O(new_n84_));
