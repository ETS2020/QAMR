...
module FAU ( 
  ...
  nand2  g26(.a(new_n46_), .b(x09), .O(new_n51_));
  oai21  g27(.a(new_n46_), .b(x03), .c(new_n51_), .O(new_n52_));
  nand4  g28(.a(new_n52_), .b(new_n50_), .c(new_n45_), .d(new_n25_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n49_), .O(z2));
  aoi22  g30(.a(x12), .b(new_n41_), .c(x11), .d(x07), .O(z3));
  ...
  nand4  g41(.a(new_n65_), .b(new_n61_), .c(new_n46_), .d(new_n45_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(z6));
  nand3  g43(.a(new_n46_), .b(new_n45_), .c(x01), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x03), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n50_), .O(new_n70_));
  nand3  g46(.a(x09), .b(x03), .c(new_n25_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n70_), .c(new_n46_), .d(new_n45_), .O(z7));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x03), .c(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x09), .O(new_n75_));
  aoi21  g51(.a(new_n63_), .b(new_n41_), .c(x10), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(z8));
endmodule
