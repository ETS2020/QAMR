...
module FAU ( 
  ...
  nor2   g41(.a(new_n49_), .b(x07), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n49_), .O(z5));
  ...
  aoi21  g47(.a(x09), .b(new_n34_), .c(x02), .O(new_n72_));
  nand3  g48(.a(new_n49_), .b(x03), .c(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  inv1   g51(.a(x14), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x02), .c(new_n61_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n70_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n55_), .c(new_n48_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand2  g56(.a(new_n48_), .b(x02), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x03), .c(new_n25_), .O(new_n82_));
  ...
  nand4  g61(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(x00), .O(z8));
endmodule
