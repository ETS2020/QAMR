// Benchmark "FAU" written by ABC on Mon Jul 27 17:22:00 2020
...
module FAU ( 
  ...
  oai21  g31(.a(new_n50_), .b(x01), .c(new_n38_), .O(new_n56_));
  ...
  nand3  g36(.a(new_n50_), .b(new_n38_), .c(new_n25_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(x09), .c(x00), .O(new_n63_));
  ...
  nand2  g45(.a(new_n50_), .b(x03), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n25_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n38_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x01), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n59_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n59_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n47_), .c(x02), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n72_), .c(x07), .O(z6));
  nand3  g53(.a(new_n55_), .b(new_n48_), .c(x01), .O(new_n78_));
  nand3  g54(.a(x09), .b(x03), .c(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n38_), .O(new_n81_));
  oai21  g57(.a(x07), .b(new_n38_), .c(x03), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n55_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n44_), .O(z7));
  ...
  aoi21  g63(.a(new_n50_), .b(new_n59_), .c(x10), .O(new_n88_));
