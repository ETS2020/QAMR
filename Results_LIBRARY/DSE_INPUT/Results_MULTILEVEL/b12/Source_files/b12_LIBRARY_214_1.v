...
module FAU ( 
  ...
  nand2  g43(.a(new_n49_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n38_), .c(new_n61_), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n34_), .O(new_n70_));
  inv1   g46(.a(x14), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x01), .O(new_n72_));
  oai21  g48(.a(new_n70_), .b(x01), .c(new_n72_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n69_), .c(new_n54_), .O(new_n74_));
  aoi21  g50(.a(new_n70_), .b(new_n38_), .c(x01), .O(new_n75_));
  aoi21  g51(.a(new_n68_), .b(new_n25_), .c(x14), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n61_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n55_), .c(new_n48_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand3  g56(.a(new_n71_), .b(new_n55_), .c(x01), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n38_), .c(x07), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n34_), .c(new_n54_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n55_), .d(new_n48_), .O(z7));
  inv1   g61(.a(x12), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(x03), .c(new_n38_), .d(new_n25_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g64(.a(new_n49_), .b(new_n61_), .c(x10), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n48_), .O(z8));
endmodule
