...
module FAU ( 
  ...
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n50_), .d(new_n63_), .O(z5));
  nand2  g45(.a(new_n51_), .b(x03), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n27_), .c(new_n63_), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n36_), .O(new_n72_));
  oai21  g48(.a(new_n25_), .b(x01), .c(new_n72_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n56_), .O(new_n74_));
  aoi21  g50(.a(new_n70_), .b(new_n25_), .c(x01), .O(new_n75_));
  inv1   g51(.a(x14), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x02), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n72_), .c(new_n26_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n63_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n74_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n57_), .c(new_n50_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n25_), .O(new_n83_));
  nand4  g59(.a(new_n57_), .b(new_n56_), .c(new_n50_), .d(x02), .O(new_n84_));
  ...
  nor2   g63(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n51_), .b(new_n63_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n50_), .O(z8));
endmodule
