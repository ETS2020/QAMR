...
module FAU ( 
  ...
  oai22  g30(.a(x08), .b(x07), .c(new_n26_), .d(x00), .O(new_n55_));
  ...
  oai21  g37(.a(x11), .b(new_n50_), .c(new_n61_), .O(z4));
  nor2   g38(.a(x12), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(x13), .c(new_n40_), .d(new_n50_), .O(z5));
  oai21  g40(.a(x09), .b(new_n45_), .c(new_n26_), .O(new_n65_));
  nor2   g41(.a(x02), .b(x00), .O(new_n66_));
  nor2   g42(.a(x08), .b(new_n58_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  oai21  g44(.a(new_n41_), .b(x03), .c(new_n37_), .O(new_n69_));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n26_), .O(new_n71_));
  inv1   g47(.a(x14), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x01), .c(new_n58_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n40_), .c(new_n50_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n37_), .O(new_n77_));
  nand4  g53(.a(new_n40_), .b(new_n46_), .c(new_n50_), .d(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n26_), .O(new_n80_));
  nand2  g56(.a(x03), .b(new_n26_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n46_), .c(new_n51_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n37_), .d(new_n26_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n41_), .b(new_n58_), .c(x10), .O(new_n87_));
