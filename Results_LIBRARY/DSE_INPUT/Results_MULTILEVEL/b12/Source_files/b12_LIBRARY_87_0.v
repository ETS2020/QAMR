...
module FAU ( 
  ...
  aoi21  g44(.a(new_n50_), .b(x03), .c(x01), .O(new_n69_));
  nor2   g45(.a(x02), .b(x00), .O(new_n70_));
  aoi21  g46(.a(new_n55_), .b(x00), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n50_), .b(x03), .c(new_n38_), .O(new_n72_));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n25_), .O(new_n74_));
  oai21  g50(.a(new_n71_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n56_), .c(new_n49_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n38_), .O(new_n78_));
  nand4  g54(.a(new_n56_), .b(new_n55_), .c(new_n49_), .d(x02), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  aoi21  g57(.a(x03), .b(new_n25_), .c(x08), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  ...
  aoi21  g63(.a(new_n50_), .b(new_n62_), .c(x10), .O(new_n88_));
