...
module FAU ( 
  ...
  nand2  g19(.a(new_n43_), .b(new_n27_), .O(new_n44_));
  nand3  g20(.a(new_n44_), .b(new_n40_), .c(new_n39_), .O(new_n45_));
  aoi21  g21(.a(new_n45_), .b(new_n42_), .c(x01), .O(new_n46_));
  nor3   g22(.a(x04), .b(x03), .c(x01), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n27_), .O(new_n48_));
  oai21  g24(.a(new_n48_), .b(new_n46_), .c(new_n37_), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nor2   g26(.a(new_n40_), .b(x03), .O(new_n51_));
  nor2   g27(.a(x10), .b(new_n43_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n51_), .c(new_n25_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n50_), .c(new_n39_), .O(new_n55_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n50_), .c(new_n41_), .O(new_n80_));
  ...
  aoi21  g60(.a(new_n43_), .b(new_n37_), .c(x10), .O(new_n85_));
