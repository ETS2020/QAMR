...
module FAU ( 
  ...
  nand4  g44(.a(new_n78_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n79_));
  nand2  g45(.a(x16), .b(new_n35_), .O(new_n80_));
  oai21  g46(.a(new_n79_), .b(new_n62_), .c(new_n80_), .O(new_n81_));
  nand2  g47(.a(new_n81_), .b(x04), .O(new_n82_));
  nand2  g48(.a(new_n76_), .b(x13), .O(new_n83_));
  aoi21  g49(.a(x16), .b(x03), .c(new_n40_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  aoi21  g52(.a(new_n79_), .b(new_n86_), .c(x09), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(x08), .c(x07), .d(x06), .O(new_n88_));
  inv1   g54(.a(x14), .O(new_n89_));
  or2    g55(.a(new_n44_), .b(new_n89_), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n88_), .c(new_n40_), .O(z10));
  aoi21  g57(.a(new_n80_), .b(new_n56_), .c(new_n40_), .O(z12));
