...
module FAU ( 
  ...
  nand4  g36(.a(new_n70_), .b(new_n69_), .c(new_n65_), .d(new_n61_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n68_), .c(new_n58_), .d(x04), .O(z07));
  inv1   g38(.a(x12), .O(new_n73_));
  nand4  g39(.a(new_n71_), .b(new_n58_), .c(new_n73_), .d(x04), .O(z08));
  inv1   g40(.a(x13), .O(new_n75_));
  nand4  g41(.a(new_n44_), .b(new_n75_), .c(new_n69_), .d(new_n65_), .O(new_n76_));
  ...
  aoi21  g49(.a(new_n71_), .b(x13), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(new_n81_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n75_), .b(new_n69_), .c(new_n65_), .O(new_n87_));
