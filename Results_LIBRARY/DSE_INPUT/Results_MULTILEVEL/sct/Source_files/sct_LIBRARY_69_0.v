...
module FAU ( 
  ...
  nand4  g53(.a(new_n78_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n86_), .c(new_n87_), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n61_), .c(x08), .d(x07), .O(new_n90_));
  nand3  g56(.a(new_n87_), .b(x14), .c(x04), .O(new_n91_));
  oai21  g57(.a(new_n90_), .b(new_n43_), .c(new_n91_), .O(z10));
  nand2  g58(.a(x16), .b(new_n35_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n56_), .c(new_n40_), .O(z12));
