...
module FAU ( 
  ...
  nand4  g61(.a(new_n84_), .b(new_n83_), .c(new_n75_), .d(new_n74_), .O(new_n96_));
  ...
  aoi21  g66(.a(new_n60_), .b(new_n63_), .c(new_n40_), .O(z12));
  nand3  g67(.a(x08), .b(x07), .c(x06), .O(new_n102_));
  nand3  g68(.a(new_n61_), .b(new_n56_), .c(new_n63_), .O(new_n103_));
