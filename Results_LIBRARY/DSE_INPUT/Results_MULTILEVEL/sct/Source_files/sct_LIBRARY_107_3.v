...
module FAU ( 
  ...
  nand4  g41(.a(new_n65_), .b(new_n69_), .c(new_n75_), .d(new_n74_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g43(.a(x13), .O(new_n78_));
  nand4  g44(.a(new_n44_), .b(new_n78_), .c(new_n75_), .d(new_n74_), .O(new_n79_));
  ...
  nor3   g54(.a(new_n79_), .b(x10), .c(x09), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(x08), .c(x07), .d(x06), .O(new_n90_));
  inv1   g56(.a(new_n44_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n90_), .c(new_n40_), .O(z10));
  aoi21  g59(.a(new_n82_), .b(new_n56_), .c(new_n40_), .O(z12));
  and2   g60(.a(x17), .b(x04), .O(z14));
  buf1   g61(.a(x02), .O(z11));
  buf1   g62(.a(x04), .O(z13));
endmodule
