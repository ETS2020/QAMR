...
module FAU ( 
  ...
  oai21  g17(.a(x16), .b(x08), .c(new_n51_), .O(new_n52_));
  nand3  g18(.a(new_n52_), .b(x07), .c(x06), .O(new_n53_));
  nand2  g19(.a(x07), .b(x06), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(x08), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n53_), .c(new_n40_), .O(z04));
  oai21  g22(.a(new_n40_), .b(x02), .c(new_n50_), .O(new_n57_));
  ...
  nand4  g29(.a(new_n63_), .b(new_n60_), .c(new_n58_), .d(x04), .O(z05));
  nand2  g30(.a(new_n63_), .b(x10), .O(new_n65_));
  nor2   g31(.a(x10), .b(x09), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n62_), .c(x08), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n65_), .c(new_n58_), .d(x04), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n71_), .d(new_n70_), .O(new_n80_));
  nand2  g46(.a(x16), .b(new_n35_), .O(new_n81_));
  oai21  g47(.a(new_n80_), .b(new_n63_), .c(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(x04), .O(new_n83_));
  nand2  g49(.a(new_n77_), .b(x13), .O(new_n84_));
  aoi21  g50(.a(x16), .b(x03), .c(new_n40_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(z09));
  inv1   g52(.a(x00), .O(new_n87_));
  aoi21  g53(.a(new_n80_), .b(new_n87_), .c(x09), .O(new_n88_));
  ...
  aoi21  g58(.a(new_n81_), .b(new_n50_), .c(new_n40_), .O(z12));
