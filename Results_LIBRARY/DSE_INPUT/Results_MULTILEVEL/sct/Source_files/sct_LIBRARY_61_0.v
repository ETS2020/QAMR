...
module FAU ( 
  ...
  oai21  g21(.a(new_n55_), .b(x02), .c(new_n54_), .O(new_n56_));
  ...
  nand3  g26(.a(new_n49_), .b(new_n60_), .c(x08), .O(new_n61_));
  ...
  nand3  g30(.a(new_n64_), .b(new_n49_), .c(x08), .O(new_n65_));
  ...
  nand4  g43(.a(new_n42_), .b(new_n77_), .c(new_n74_), .d(new_n69_), .O(new_n78_));
  ...
  oai21  g47(.a(new_n80_), .b(new_n41_), .c(new_n81_), .O(new_n82_));
  ...
  nand4  g56(.a(new_n90_), .b(new_n42_), .c(new_n60_), .d(x08), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(x07), .c(x06), .O(new_n93_));
  inv1   g59(.a(new_n42_), .O(new_n94_));
  nand2  g60(.a(new_n94_), .b(x14), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n93_), .c(new_n55_), .O(z10));
  aoi21  g62(.a(new_n81_), .b(new_n54_), .c(new_n55_), .O(z12));
