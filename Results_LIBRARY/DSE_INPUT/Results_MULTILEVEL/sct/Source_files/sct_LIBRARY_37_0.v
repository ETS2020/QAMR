...
module FAU ( 
  ...
  nand3  g40(.a(new_n74_), .b(new_n65_), .c(new_n69_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n58_), .d(x04), .O(z08));
  nand2  g42(.a(new_n56_), .b(x02), .O(new_n77_));
  nor2   g43(.a(new_n59_), .b(new_n77_), .O(new_n78_));
  nor3   g44(.a(x13), .b(x12), .c(x11), .O(new_n79_));
  and2   g45(.a(new_n79_), .b(new_n65_), .O(new_n80_));
  aoi22  g46(.a(new_n80_), .b(new_n78_), .c(x16), .d(new_n35_), .O(new_n81_));
  nand2  g47(.a(new_n75_), .b(x13), .O(new_n82_));
  nand2  g48(.a(x16), .b(x03), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(x04), .O(z09));
  nand2  g50(.a(new_n44_), .b(x00), .O(new_n85_));
  nor2   g51(.a(x10), .b(x03), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n79_), .c(x02), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n85_), .c(x09), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(x08), .c(x07), .d(x06), .O(new_n89_));
  nand3  g55(.a(new_n77_), .b(x16), .c(x14), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n40_), .O(z10));
  nand2  g57(.a(x16), .b(new_n35_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n56_), .c(new_n40_), .O(z12));
