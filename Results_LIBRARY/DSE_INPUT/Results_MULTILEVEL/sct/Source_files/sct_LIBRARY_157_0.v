...
module FAU ( 
  ...
  nand3  g46(.a(new_n80_), .b(new_n66_), .c(x04), .O(z08));
  nor2   g47(.a(x13), .b(new_n40_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n66_), .O(z09));
  nand4  g49(.a(new_n44_), .b(new_n56_), .c(x08), .d(x07), .O(new_n84_));
  inv1   g50(.a(new_n84_), .O(new_n85_));
  nand3  g51(.a(new_n85_), .b(x06), .c(x00), .O(new_n86_));
  inv1   g52(.a(x14), .O(new_n87_));
  or2    g53(.a(new_n44_), .b(new_n87_), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n86_), .c(new_n40_), .O(z10));
  aoi21  g55(.a(new_n58_), .b(new_n64_), .c(new_n40_), .O(z12));
  nor2   g56(.a(x12), .b(x11), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n57_), .c(new_n40_), .O(z13));
