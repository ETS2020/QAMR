...
module FAU ( 
  ...
  nand2  g17(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  inv1   g18(.a(x07), .O(new_n53_));
  nand3  g19(.a(new_n49_), .b(new_n53_), .c(x06), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(new_n52_), .c(new_n40_), .O(z03));
  xor2a  g21(.a(x08), .b(x06), .O(new_n56_));
  nand3  g22(.a(new_n56_), .b(new_n44_), .c(x02), .O(new_n57_));
  inv1   g23(.a(x08), .O(new_n58_));
  nor2   g24(.a(new_n53_), .b(new_n43_), .O(new_n59_));
  ...
  aoi21  g28(.a(new_n62_), .b(new_n57_), .c(new_n40_), .O(z04));
  oai21  g29(.a(new_n40_), .b(x02), .c(new_n44_), .O(new_n64_));
  ...
  nand3  g38(.a(new_n72_), .b(new_n59_), .c(x08), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n65_), .d(x04), .O(z06));
  ...
  nand4  g45(.a(new_n79_), .b(new_n75_), .c(new_n65_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n83_), .b(new_n81_), .c(new_n65_), .d(x04), .O(z08));
  inv1   g50(.a(x13), .O(new_n85_));
  nand4  g51(.a(new_n51_), .b(new_n85_), .c(new_n82_), .d(new_n77_), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x10), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n68_), .c(x08), .d(x06), .O(new_n88_));
  nand2  g54(.a(x16), .b(new_n35_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(x04), .O(new_n91_));
  oai21  g57(.a(new_n49_), .b(new_n44_), .c(x04), .O(new_n92_));
  aoi21  g58(.a(new_n83_), .b(x13), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n91_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand4  g61(.a(new_n85_), .b(new_n82_), .c(new_n77_), .d(new_n76_), .O(new_n96_));
  aoi22  g62(.a(new_n96_), .b(new_n95_), .c(new_n50_), .d(new_n45_), .O(new_n97_));
  nand4  g63(.a(new_n97_), .b(new_n68_), .c(x08), .d(x06), .O(new_n98_));
  nand3  g64(.a(new_n45_), .b(x16), .c(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(z10));
  aoi21  g66(.a(new_n89_), .b(new_n44_), .c(new_n40_), .O(z12));
