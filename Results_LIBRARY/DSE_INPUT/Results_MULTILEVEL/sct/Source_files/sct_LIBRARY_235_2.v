...
module FAU ( 
  ...
  nand3  g34(.a(new_n68_), .b(new_n64_), .c(x08), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n60_), .d(x04), .O(z06));
  nand2  g36(.a(new_n69_), .b(x11), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  inv1   g39(.a(new_n61_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n63_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n71_), .c(new_n60_), .d(x04), .O(z07));
  ...
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n60_), .d(x04), .O(z08));
  nor2   g46(.a(new_n61_), .b(new_n45_), .O(new_n81_));
  ...
  nand4  g59(.a(new_n93_), .b(x06), .c(new_n44_), .d(x02), .O(new_n94_));
  nand3  g60(.a(new_n45_), .b(x16), .c(x14), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n40_), .O(z10));
  nand2  g62(.a(x16), .b(new_n35_), .O(new_n97_));
  aoi21  g63(.a(new_n97_), .b(new_n44_), .c(new_n40_), .O(z12));
