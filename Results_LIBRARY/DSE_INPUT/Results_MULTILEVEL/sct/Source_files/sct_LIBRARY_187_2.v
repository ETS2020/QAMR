...
module FAU ( 
  ...
  aoi21  g32(.a(new_n63_), .b(x09), .c(new_n66_), .O(new_n67_));
  ...
  aoi21  g37(.a(new_n71_), .b(new_n52_), .c(new_n61_), .O(new_n72_));
  nand3  g38(.a(new_n52_), .b(new_n57_), .c(x08), .O(new_n73_));
  aoi21  g39(.a(new_n73_), .b(x10), .c(new_n66_), .O(new_n74_));
  oai21  g40(.a(new_n72_), .b(new_n40_), .c(new_n74_), .O(z06));
  aoi21  g41(.a(new_n64_), .b(x02), .c(new_n65_), .O(new_n76_));
  nor2   g42(.a(new_n50_), .b(new_n43_), .O(new_n77_));
  nand4  g43(.a(x10), .b(new_n57_), .c(x08), .d(x06), .O(new_n78_));
  oai21  g44(.a(new_n77_), .b(new_n76_), .c(new_n78_), .O(new_n79_));
  nand2  g45(.a(x11), .b(x09), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n60_), .O(new_n81_));
  aoi21  g47(.a(new_n79_), .b(x07), .c(new_n81_), .O(new_n82_));
  aoi22  g48(.a(x16), .b(x03), .c(x11), .d(new_n51_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(x04), .O(z07));
  oai21  g50(.a(new_n40_), .b(x02), .c(new_n64_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x16), .O(new_n86_));
  nor2   g52(.a(x12), .b(new_n40_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(z08));
  nor2   g54(.a(x13), .b(new_n40_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n86_), .O(z09));
  nand4  g56(.a(new_n44_), .b(new_n57_), .c(x08), .d(x07), .O(new_n91_));
  inv1   g57(.a(new_n91_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(x06), .c(x00), .O(new_n93_));
  nand2  g59(.a(new_n76_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(z10));
  aoi21  g61(.a(new_n60_), .b(new_n64_), .c(new_n40_), .O(z12));
  nand3  g62(.a(x08), .b(x07), .c(x06), .O(new_n97_));
  nand2  g63(.a(new_n97_), .b(new_n44_), .O(new_n98_));
  nor3   g64(.a(new_n81_), .b(new_n59_), .c(x03), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(z13));
