...
module FAU ( 
  ...
  oai21  g23(.a(new_n40_), .b(x02), .c(new_n44_), .O(new_n58_));
  ...
  nor2   g44(.a(new_n60_), .b(new_n45_), .O(new_n79_));
  nor3   g45(.a(x13), .b(x12), .c(x11), .O(new_n80_));
  and2   g46(.a(new_n80_), .b(new_n66_), .O(new_n81_));
  aoi22  g47(.a(new_n81_), .b(new_n79_), .c(x16), .d(new_n35_), .O(new_n82_));
  nand2  g48(.a(new_n77_), .b(x13), .O(new_n83_));
  ...
  nand4  g53(.a(new_n87_), .b(new_n76_), .c(new_n71_), .d(new_n70_), .O(new_n88_));
  ...
  nand4  g57(.a(new_n91_), .b(x06), .c(new_n44_), .d(x02), .O(new_n92_));
  nand3  g58(.a(new_n45_), .b(x16), .c(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n40_), .O(z10));
  nand2  g60(.a(x16), .b(new_n35_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n44_), .c(new_n40_), .O(z12));
