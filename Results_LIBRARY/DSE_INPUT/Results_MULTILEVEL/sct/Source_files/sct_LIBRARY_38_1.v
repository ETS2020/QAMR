...
module FAU ( 
  ...
  oai21  g20(.a(new_n54_), .b(new_n51_), .c(new_n44_), .O(new_n55_));
  ...
  oai21  g26(.a(new_n58_), .b(x03), .c(new_n60_), .O(new_n61_));
  ...
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n84_), .d(new_n79_), .O(new_n89_));
  ...
  nand2  g60(.a(new_n88_), .b(x04), .O(new_n95_));
  aoi21  g61(.a(new_n85_), .b(x13), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g66(.a(new_n100_), .b(new_n88_), .c(new_n70_), .d(x08), .O(new_n101_));
  inv1   g67(.a(new_n101_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(x07), .c(x06), .O(new_n103_));
  nand2  g69(.a(new_n46_), .b(x14), .O(new_n104_));
  aoi21  g70(.a(new_n104_), .b(new_n103_), .c(new_n40_), .O(z10));
  aoi21  g71(.a(new_n92_), .b(new_n44_), .c(new_n40_), .O(z12));
