...
module FAU ( 
  ...
  nand2  g12(.a(x07), .b(new_n43_), .O(new_n47_));
  ...
  nor2   g31(.a(new_n48_), .b(new_n43_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(new_n67_));
  nand4  g33(.a(new_n67_), .b(new_n64_), .c(new_n60_), .d(x04), .O(z06));
  nand2  g34(.a(new_n67_), .b(x11), .O(new_n69_));
  inv1   g35(.a(x11), .O(new_n70_));
  nand4  g36(.a(new_n66_), .b(new_n70_), .c(new_n65_), .d(new_n61_), .O(new_n71_));
  nand4  g37(.a(new_n71_), .b(new_n69_), .c(new_n60_), .d(x04), .O(z07));
  nand2  g38(.a(new_n71_), .b(x12), .O(new_n73_));
  inv1   g39(.a(x12), .O(new_n74_));
  inv1   g40(.a(new_n62_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n74_), .c(new_n70_), .d(new_n65_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n60_), .d(x04), .O(z08));
  inv1   g43(.a(x13), .O(new_n78_));
  nand4  g44(.a(new_n44_), .b(new_n78_), .c(new_n74_), .d(new_n70_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(x10), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n61_), .c(x07), .d(x06), .O(new_n81_));
