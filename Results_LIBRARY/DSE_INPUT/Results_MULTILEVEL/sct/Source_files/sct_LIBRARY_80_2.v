...
module FAU ( 
  ...
  inv1   g46(.a(new_n44_), .O(new_n81_));
  inv1   g47(.a(x11), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n68_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n57_), .c(x07), .d(x06), .O(new_n84_));
  oai21  g50(.a(new_n52_), .b(new_n81_), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(x08), .O(new_n86_));
  nand2  g52(.a(x12), .b(x09), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  inv1   g54(.a(new_n88_), .O(new_n89_));
  aoi22  g55(.a(x16), .b(x03), .c(x12), .d(new_n50_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n86_), .d(x04), .O(z08));
  inv1   g57(.a(x16), .O(new_n92_));
  aoi21  g58(.a(x04), .b(new_n35_), .c(x03), .O(new_n93_));
  nor2   g59(.a(x13), .b(new_n40_), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n92_), .c(new_n94_), .O(z09));
  nand4  g61(.a(new_n44_), .b(new_n57_), .c(x08), .d(x07), .O(new_n96_));
  inv1   g62(.a(new_n96_), .O(new_n97_));
  nand3  g63(.a(new_n97_), .b(x06), .c(x00), .O(new_n98_));
  nand2  g64(.a(new_n81_), .b(x14), .O(new_n99_));
  aoi21  g65(.a(new_n99_), .b(new_n98_), .c(new_n40_), .O(z10));
  inv1   g66(.a(x03), .O(new_n101_));
  aoi21  g67(.a(new_n60_), .b(new_n101_), .c(new_n40_), .O(z12));
  nand3  g68(.a(x08), .b(x07), .c(x06), .O(new_n103_));
  nand2  g69(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  nor3   g70(.a(new_n88_), .b(new_n59_), .c(x03), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n104_), .c(new_n40_), .O(z13));
