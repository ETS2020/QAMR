...
module FAU ( 
  ...
  oai21  g51(.a(new_n85_), .b(new_n56_), .c(x04), .O(new_n86_));
  aoi21  g52(.a(new_n76_), .b(x13), .c(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n84_), .O(z09));
  inv1   g54(.a(x00), .O(new_n89_));
  aoi21  g55(.a(new_n56_), .b(x02), .c(new_n85_), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(x13), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n75_), .c(new_n70_), .d(new_n69_), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n89_), .c(x09), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(x08), .c(x07), .d(x06), .O(new_n94_));
  nand2  g60(.a(new_n90_), .b(x14), .O(new_n95_));
