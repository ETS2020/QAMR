...
module FAU ( 
  ...
  nand4  g47(.a(new_n70_), .b(new_n69_), .c(x13), .d(new_n74_), .O(new_n82_));
  nand2  g48(.a(x16), .b(x03), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n82_), .c(x04), .O(new_n84_));
  aoi21  g50(.a(new_n71_), .b(x12), .c(new_n84_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n81_), .O(z08));
  nand4  g52(.a(new_n69_), .b(new_n74_), .c(new_n73_), .d(new_n65_), .O(new_n87_));
  nand2  g53(.a(new_n83_), .b(x04), .O(new_n88_));
  aoi21  g54(.a(new_n87_), .b(x13), .c(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n81_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand3  g57(.a(new_n70_), .b(new_n75_), .c(new_n74_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n94_));
  ...
  aoi21  g65(.a(new_n79_), .b(new_n56_), .c(new_n40_), .O(z12));
