...
module FAU ( 
  ...
  nor2   g21(.a(x09), .b(new_n50_), .O(new_n56_));
  inv1   g22(.a(x16), .O(new_n57_));
  nor2   g23(.a(new_n57_), .b(x02), .O(new_n58_));
  aoi21  g24(.a(new_n56_), .b(new_n51_), .c(new_n58_), .O(new_n59_));
  ...
  nand3  g32(.a(new_n51_), .b(new_n66_), .c(x08), .O(new_n67_));
  and2   g33(.a(new_n67_), .b(new_n62_), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n65_), .c(new_n64_), .d(x04), .O(z06));
  ...
  nand4  g40(.a(new_n51_), .b(new_n74_), .c(new_n66_), .d(x08), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n72_), .d(x04), .O(z07));
  ...
  nand4  g46(.a(new_n80_), .b(new_n77_), .c(new_n72_), .d(x04), .O(z08));
  inv1   g47(.a(new_n58_), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n44_), .b(new_n83_), .c(new_n78_), .d(new_n74_), .O(new_n84_));
  ...
  nand2  g54(.a(new_n62_), .b(x04), .O(new_n89_));
  ...
  nand4  g60(.a(new_n83_), .b(new_n78_), .c(new_n74_), .d(new_n66_), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n92_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(x08), .c(x07), .d(x06), .O(new_n97_));
  nand2  g63(.a(new_n92_), .b(x14), .O(new_n98_));
  aoi21  g64(.a(new_n98_), .b(new_n97_), .c(new_n40_), .O(z10));
  aoi21  g65(.a(new_n82_), .b(new_n70_), .c(new_n40_), .O(z12));
  nand3  g66(.a(x08), .b(x07), .c(x06), .O(new_n101_));
  nand3  g67(.a(new_n59_), .b(new_n93_), .c(new_n70_), .O(new_n102_));
  aoi21  g68(.a(new_n101_), .b(new_n44_), .c(new_n102_), .O(new_n103_));
  nor2   g69(.a(new_n103_), .b(new_n40_), .O(z13));
