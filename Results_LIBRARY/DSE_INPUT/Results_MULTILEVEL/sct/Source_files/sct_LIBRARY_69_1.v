...
module FAU ( 
  ...
  oai21  g29(.a(new_n58_), .b(new_n63_), .c(x04), .O(new_n64_));
  aoi21  g30(.a(new_n62_), .b(x09), .c(new_n64_), .O(new_n65_));
  oai21  g31(.a(new_n61_), .b(new_n40_), .c(new_n65_), .O(z05));
  oai21  g32(.a(new_n40_), .b(x02), .c(new_n63_), .O(new_n67_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n74_), .d(new_n56_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n73_), .c(new_n68_), .d(x04), .O(z07));
  ...
  nand4  g49(.a(new_n44_), .b(new_n83_), .c(new_n80_), .d(new_n75_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(x10), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n56_), .c(x08), .d(x07), .O(new_n86_));
  oai21  g52(.a(new_n86_), .b(new_n43_), .c(new_n60_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(x04), .O(new_n88_));
  aoi21  g54(.a(new_n81_), .b(x13), .c(new_n64_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  nand4  g57(.a(new_n83_), .b(new_n80_), .c(new_n75_), .d(new_n74_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g59(.a(new_n93_), .b(new_n44_), .c(new_n56_), .d(x08), .O(new_n94_));
  ...
  aoi21  g65(.a(new_n60_), .b(new_n63_), .c(new_n40_), .O(z12));
  nand3  g66(.a(x08), .b(x07), .c(x06), .O(new_n101_));
  and2   g67(.a(new_n101_), .b(new_n44_), .O(new_n102_));
  nand2  g68(.a(new_n61_), .b(new_n63_), .O(new_n103_));
  oai21  g69(.a(new_n103_), .b(new_n102_), .c(x04), .O(new_n104_));
  nand2  g70(.a(new_n104_), .b(new_n56_), .O(z13));
