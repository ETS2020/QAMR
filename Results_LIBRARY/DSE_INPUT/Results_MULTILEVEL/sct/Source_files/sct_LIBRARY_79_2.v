...
module FAU ( 
  ...
  nand3  g30(.a(new_n64_), .b(new_n61_), .c(x08), .O(new_n65_));
  inv1   g31(.a(new_n65_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(x07), .c(x06), .O(new_n67_));
  nand2  g33(.a(new_n62_), .b(x10), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n67_), .c(new_n58_), .d(x04), .O(z06));
  nand2  g35(.a(new_n66_), .b(new_n51_), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(x11), .O(new_n71_));
  inv1   g37(.a(x11), .O(new_n72_));
  inv1   g38(.a(new_n59_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n64_), .d(new_n61_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n58_), .d(x04), .O(z07));
  nand2  g41(.a(x12), .b(new_n72_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n64_), .c(new_n61_), .d(x08), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(x07), .c(x06), .O(new_n79_));
  aoi21  g45(.a(new_n70_), .b(x12), .c(new_n40_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n79_), .c(new_n58_), .O(z08));
  inv1   g47(.a(x12), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n44_), .b(new_n83_), .c(new_n82_), .d(new_n64_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(x09), .O(new_n85_));
  ...
  nand4  g55(.a(new_n73_), .b(new_n82_), .c(new_n64_), .d(new_n61_), .O(new_n90_));
  nand2  g56(.a(x16), .b(x03), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(x04), .O(new_n92_));
  aoi21  g58(.a(new_n90_), .b(x13), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n89_), .O(z09));
  inv1   g60(.a(x00), .O(new_n95_));
  nand3  g61(.a(new_n83_), .b(new_n82_), .c(new_n64_), .O(new_n96_));
  ...
  aoi21  g69(.a(new_n87_), .b(new_n56_), .c(new_n40_), .O(z12));
