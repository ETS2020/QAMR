...
module FAU ( 
  ...
  nor2   g17(.a(x07), .b(new_n43_), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n44_), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(new_n54_));
  oai21  g20(.a(new_n54_), .b(new_n51_), .c(x02), .O(new_n55_));
  oai21  g21(.a(new_n52_), .b(new_n51_), .c(new_n45_), .O(new_n56_));
  aoi21  g22(.a(new_n56_), .b(new_n55_), .c(new_n40_), .O(z03));
  xnor2a g23(.a(x08), .b(x06), .O(new_n58_));
  inv1   g24(.a(x08), .O(new_n59_));
  nand3  g25(.a(new_n45_), .b(new_n59_), .c(x06), .O(new_n60_));
  oai21  g26(.a(new_n58_), .b(new_n35_), .c(new_n60_), .O(new_n61_));
  nand2  g27(.a(new_n61_), .b(x07), .O(new_n62_));
  oai22  g28(.a(new_n46_), .b(x07), .c(x16), .d(x06), .O(new_n63_));
  nand2  g29(.a(new_n63_), .b(x08), .O(new_n64_));
  aoi21  g30(.a(new_n64_), .b(new_n62_), .c(new_n40_), .O(z04));
  oai21  g31(.a(new_n40_), .b(x02), .c(new_n44_), .O(new_n66_));
  ...
  nand4  g41(.a(new_n75_), .b(new_n73_), .c(new_n67_), .d(x04), .O(z06));
  ...
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n67_), .d(x04), .O(z07));
  ...
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n67_), .d(x04), .O(z08));
  nand2  g52(.a(x16), .b(new_n35_), .O(new_n87_));
  inv1   g53(.a(x13), .O(new_n88_));
  nand4  g54(.a(new_n87_), .b(new_n88_), .c(new_n84_), .d(new_n79_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(x10), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n70_), .c(x08), .d(x07), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n43_), .c(new_n87_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(x04), .O(new_n93_));
  oai21  g59(.a(new_n45_), .b(new_n44_), .c(x04), .O(new_n94_));
  aoi21  g60(.a(new_n85_), .b(x13), .c(new_n94_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n93_), .O(z09));
  inv1   g62(.a(x00), .O(new_n97_));
  nand4  g63(.a(new_n88_), .b(new_n84_), .c(new_n79_), .d(new_n78_), .O(new_n98_));
  nand2  g64(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g65(.a(new_n99_), .b(new_n87_), .c(new_n70_), .d(x08), .O(new_n100_));
  inv1   g66(.a(new_n100_), .O(new_n101_));
  nand3  g67(.a(new_n101_), .b(x07), .c(x06), .O(new_n102_));
  nand2  g68(.a(new_n46_), .b(x14), .O(new_n103_));
  aoi21  g69(.a(new_n103_), .b(new_n102_), .c(new_n40_), .O(z10));
  aoi21  g70(.a(new_n87_), .b(new_n44_), .c(new_n40_), .O(z12));
