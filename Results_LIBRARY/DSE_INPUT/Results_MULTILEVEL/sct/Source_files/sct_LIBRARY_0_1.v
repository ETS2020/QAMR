...
module FAU ( 
  ...
  nand4  g30(.a(new_n62_), .b(new_n58_), .c(new_n64_), .d(x04), .O(z06));
  nand2  g31(.a(new_n62_), .b(x11), .O(new_n66_));
  inv1   g32(.a(x11), .O(new_n67_));
  nand4  g33(.a(new_n51_), .b(new_n67_), .c(new_n61_), .d(x08), .O(new_n68_));
  nand4  g34(.a(new_n68_), .b(new_n66_), .c(new_n58_), .d(x04), .O(z07));
  nand2  g35(.a(new_n68_), .b(x12), .O(new_n70_));
  inv1   g36(.a(x12), .O(new_n71_));
  inv1   g37(.a(new_n59_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n67_), .d(new_n61_), .O(new_n73_));
  ...
  nand3  g52(.a(new_n75_), .b(new_n71_), .c(new_n67_), .O(new_n87_));
