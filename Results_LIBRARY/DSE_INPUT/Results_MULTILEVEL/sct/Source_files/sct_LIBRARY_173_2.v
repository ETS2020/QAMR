...
module FAU ( 
  ...
  nand3  g55(.a(new_n70_), .b(new_n78_), .c(new_n75_), .O(new_n90_));
  nand2  g56(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g57(.a(new_n91_), .b(new_n56_), .c(x02), .O(new_n92_));
  nand4  g58(.a(new_n70_), .b(new_n85_), .c(new_n78_), .d(new_n75_), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(x09), .O(new_n94_));
  ...
  aoi21  g64(.a(new_n82_), .b(new_n56_), .c(new_n40_), .O(z12));
