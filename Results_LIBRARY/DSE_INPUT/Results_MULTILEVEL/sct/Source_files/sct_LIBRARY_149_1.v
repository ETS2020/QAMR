...
module FAU ( 
  ...
  nand4  g31(.a(new_n51_), .b(new_n65_), .c(new_n61_), .d(x08), .O(new_n66_));
  ...
  nand4  g41(.a(new_n44_), .b(new_n75_), .c(new_n74_), .d(new_n73_), .O(new_n76_));
  ...
  oai21  g45(.a(new_n78_), .b(new_n43_), .c(new_n79_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x04), .O(new_n81_));
  nand2  g47(.a(new_n71_), .b(x12), .O(new_n82_));
  nand3  g48(.a(new_n61_), .b(x08), .c(x06), .O(new_n83_));
  inv1   g49(.a(new_n83_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n70_), .c(x13), .d(new_n74_), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n82_), .d(x04), .O(new_n87_));
  inv1   g53(.a(new_n87_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n81_), .O(z08));
  nand4  g55(.a(new_n84_), .b(new_n74_), .c(new_n73_), .d(new_n65_), .O(new_n90_));
  nand2  g56(.a(new_n86_), .b(x04), .O(new_n91_));
  aoi21  g57(.a(new_n90_), .b(x13), .c(new_n91_), .O(new_n92_));
  nand2  g58(.a(new_n92_), .b(new_n81_), .O(z09));
  inv1   g59(.a(x00), .O(new_n94_));
  nand3  g60(.a(new_n70_), .b(new_n75_), .c(new_n74_), .O(new_n95_));
  nand2  g61(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g62(.a(new_n96_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n97_));
  inv1   g63(.a(new_n97_), .O(new_n98_));
  nand3  g64(.a(new_n98_), .b(x07), .c(x06), .O(new_n99_));
  inv1   g65(.a(new_n44_), .O(new_n100_));
  nand2  g66(.a(new_n100_), .b(x14), .O(new_n101_));
  aoi21  g67(.a(new_n101_), .b(new_n99_), .c(new_n40_), .O(z10));
  aoi21  g68(.a(new_n79_), .b(new_n56_), .c(new_n40_), .O(z12));
