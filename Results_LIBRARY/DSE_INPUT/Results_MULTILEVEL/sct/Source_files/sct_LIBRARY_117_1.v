...
module FAU ( 
  ...
  nand3  g16(.a(new_n50_), .b(x07), .c(x06), .O(new_n51_));
  oai21  g17(.a(new_n50_), .b(x06), .c(new_n51_), .O(new_n52_));
  nand3  g18(.a(new_n52_), .b(new_n44_), .c(x04), .O(new_n53_));
  inv1   g19(.a(new_n53_), .O(z04));
  oai21  g20(.a(new_n50_), .b(new_n43_), .c(x09), .O(new_n55_));
  ...
  nand3  g25(.a(new_n59_), .b(x08), .c(x06), .O(new_n60_));
  ...
  nand3  g30(.a(new_n64_), .b(new_n63_), .c(new_n59_), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n58_), .d(x04), .O(z06));
  nand2  g32(.a(new_n65_), .b(x11), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n64_), .b(new_n68_), .c(new_n63_), .d(new_n59_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n58_), .d(x04), .O(z07));
  nand2  g36(.a(new_n69_), .b(x12), .O(new_n71_));
  inv1   g37(.a(x12), .O(new_n72_));
  inv1   g38(.a(new_n60_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n72_), .c(new_n68_), .d(new_n63_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g41(.a(x13), .O(new_n76_));
  nand4  g42(.a(new_n44_), .b(new_n76_), .c(new_n72_), .d(new_n68_), .O(new_n77_));
  nor2   g43(.a(new_n77_), .b(x10), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n59_), .c(x08), .d(x06), .O(new_n79_));
  ...
  nand4  g54(.a(new_n76_), .b(new_n72_), .c(new_n68_), .d(new_n63_), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n87_), .c(new_n88_), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n59_), .c(x08), .d(x06), .O(new_n91_));
  nand2  g57(.a(new_n88_), .b(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n40_), .O(z10));
  aoi21  g59(.a(new_n80_), .b(new_n56_), .c(new_n40_), .O(z12));
