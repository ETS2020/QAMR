...
module FAU ( 
  ...
  nor2   g33(.a(x12), .b(x07), .O(new_n68_));
  nor3   g34(.a(new_n68_), .b(x11), .c(x10), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n61_), .c(x08), .d(x06), .O(new_n70_));
  aoi21  g36(.a(new_n66_), .b(x11), .c(new_n40_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(z07));
  ...
  oai21  g42(.a(new_n76_), .b(new_n73_), .c(x12), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  inv1   g44(.a(new_n59_), .O(new_n79_));
  nand4  g45(.a(new_n65_), .b(new_n79_), .c(new_n78_), .d(new_n75_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n77_), .c(new_n58_), .d(x04), .O(z08));
  ...
  nand4  g50(.a(new_n84_), .b(new_n61_), .c(x08), .d(x07), .O(new_n85_));
  ...
  nand4  g61(.a(new_n95_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n96_));
  ...
  aoi21  g67(.a(new_n86_), .b(new_n56_), .c(new_n40_), .O(z12));
