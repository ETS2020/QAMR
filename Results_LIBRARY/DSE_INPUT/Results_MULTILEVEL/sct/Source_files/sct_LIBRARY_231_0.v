...
module FAU ( 
  ...
  nand2  g09(.a(x07), .b(new_n40_), .O(new_n44_));
  oai21  g10(.a(x03), .b(new_n35_), .c(x16), .O(new_n45_));
  nand3  g11(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(new_n46_));
  inv1   g12(.a(new_n46_), .O(z02));
  inv1   g13(.a(new_n45_), .O(new_n48_));
  nand3  g14(.a(x07), .b(new_n43_), .c(x04), .O(new_n49_));
  inv1   g15(.a(x07), .O(new_n50_));
  nand2  g16(.a(new_n50_), .b(x06), .O(new_n51_));
  aoi21  g17(.a(new_n51_), .b(new_n49_), .c(new_n48_), .O(z03));
  ...
  aoi21  g23(.a(new_n57_), .b(new_n56_), .c(new_n48_), .O(z04));
  ...
  nand4  g47(.a(new_n45_), .b(new_n81_), .c(new_n78_), .d(new_n73_), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x10), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n64_), .c(x08), .d(x07), .O(new_n84_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n78_), .c(new_n73_), .d(new_n72_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n45_), .c(new_n64_), .d(x08), .O(new_n95_));
  ...
  aoi21  g65(.a(new_n85_), .b(new_n59_), .c(new_n40_), .O(z12));
