...
module FAU ( 
  ...
  aoi21  g31(.a(new_n65_), .b(new_n50_), .c(x10), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n62_), .c(x08), .d(x06), .O(new_n67_));
  aoi21  g33(.a(new_n63_), .b(x10), .c(new_n40_), .O(new_n68_));
  nand3  g34(.a(new_n68_), .b(new_n67_), .c(new_n59_), .O(z06));
  ...
  nand4  g40(.a(new_n74_), .b(new_n65_), .c(new_n73_), .d(new_n62_), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n59_), .d(x04), .O(z07));
  nand2  g42(.a(new_n75_), .b(x12), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  nand4  g44(.a(new_n70_), .b(new_n74_), .c(new_n78_), .d(new_n65_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n59_), .d(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n44_), .b(new_n81_), .c(new_n78_), .d(new_n65_), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x10), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n62_), .c(x08), .d(x07), .O(new_n84_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n78_), .c(new_n65_), .d(new_n73_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n44_), .c(new_n62_), .d(x08), .O(new_n95_));
  ...
  aoi21  g66(.a(new_n85_), .b(new_n57_), .c(new_n40_), .O(z12));
