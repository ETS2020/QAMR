...
module FAU ( 
  ...
  or2    g46(.a(new_n80_), .b(new_n62_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n78_), .c(new_n58_), .d(x04), .O(z09));
  inv1   g48(.a(x14), .O(new_n83_));
  aoi21  g49(.a(new_n56_), .b(x02), .c(new_n83_), .O(new_n84_));
  nand3  g50(.a(x06), .b(new_n56_), .c(x02), .O(new_n85_));
  nand3  g51(.a(new_n61_), .b(x08), .c(x07), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n84_), .c(x16), .O(new_n88_));
  inv1   g54(.a(x16), .O(new_n89_));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n80_), .b(new_n90_), .O(new_n91_));
  nand4  g57(.a(new_n91_), .b(new_n89_), .c(new_n61_), .d(x08), .O(new_n92_));
  inv1   g58(.a(new_n92_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(x07), .c(x06), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n88_), .c(new_n40_), .O(z10));
  nand2  g61(.a(x16), .b(new_n35_), .O(new_n96_));
  aoi21  g62(.a(new_n96_), .b(new_n56_), .c(new_n40_), .O(z12));
