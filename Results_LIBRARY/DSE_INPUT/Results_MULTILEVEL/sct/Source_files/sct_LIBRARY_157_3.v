...
module FAU ( 
  ...
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n61_), .d(x08), .O(new_n71_));
  inv1   g37(.a(new_n71_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(x07), .c(x06), .O(new_n73_));
  aoi21  g39(.a(new_n66_), .b(x11), .c(new_n40_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z07));
  nand2  g41(.a(new_n66_), .b(x12), .O(new_n76_));
  inv1   g42(.a(x11), .O(new_n77_));
  inv1   g43(.a(new_n59_), .O(new_n78_));
  nand4  g44(.a(new_n65_), .b(new_n78_), .c(new_n69_), .d(new_n77_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n76_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n44_), .b(new_n81_), .c(new_n69_), .d(new_n77_), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(x10), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n61_), .c(x08), .d(x07), .O(new_n84_));
  ...
  nand4  g58(.a(new_n81_), .b(new_n69_), .c(new_n77_), .d(new_n68_), .O(new_n93_));
  ...
  aoi21  g66(.a(new_n85_), .b(new_n56_), .c(new_n40_), .O(z12));
