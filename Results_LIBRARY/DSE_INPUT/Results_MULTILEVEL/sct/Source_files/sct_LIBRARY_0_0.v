...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n43_,
    ...
    new_n73_, new_n74_, new_n75_, new_n76_, new_n77_, new_n79_;
  ...
  nand2  g29(.a(new_n59_), .b(new_n61_), .O(new_n64_));
  aoi21  g30(.a(x10), .b(x09), .c(new_n40_), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z06));
  nor2   g32(.a(x11), .b(new_n40_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n58_), .O(z07));
  nor2   g34(.a(x12), .b(new_n40_), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(new_n58_), .O(z08));
  nor2   g36(.a(x13), .b(new_n40_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n58_), .O(z09));
  nand4  g38(.a(new_n44_), .b(new_n61_), .c(x08), .d(x07), .O(new_n73_));
  inv1   g39(.a(new_n73_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(x06), .c(x00), .O(new_n75_));
  inv1   g41(.a(x14), .O(new_n76_));
  or2    g42(.a(new_n44_), .b(new_n76_), .O(new_n77_));
  aoi21  g43(.a(new_n77_), .b(new_n75_), .c(new_n40_), .O(z10));
  nand2  g44(.a(x16), .b(new_n35_), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n56_), .c(new_n40_), .O(z12));
  and2   g46(.a(x17), .b(x04), .O(z14));
  buf1   g47(.a(x02), .O(z11));
  buf1   g48(.a(x04), .O(z13));
endmodule
