...
module FAU ( 
  ...
  nand2  g49(.a(new_n80_), .b(new_n83_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n56_), .c(x02), .O(new_n85_));
  aoi21  g51(.a(new_n85_), .b(x16), .c(x09), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(x08), .c(x07), .d(x06), .O(new_n87_));
  inv1   g53(.a(new_n44_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x14), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n87_), .c(new_n40_), .O(z10));
