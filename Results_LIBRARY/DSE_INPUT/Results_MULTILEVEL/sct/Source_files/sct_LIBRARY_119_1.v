...
module FAU ( 
  ...
  nand3  g33(.a(new_n65_), .b(x08), .c(x06), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x11), .O(new_n69_));
  inv1   g35(.a(x10), .O(new_n70_));
  inv1   g36(.a(x11), .O(new_n71_));
  inv1   g37(.a(new_n59_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n70_), .d(new_n61_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n69_), .c(new_n58_), .d(x04), .O(z07));
  nand2  g40(.a(new_n73_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand4  g42(.a(new_n65_), .b(new_n72_), .c(new_n76_), .d(new_n71_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g44(.a(x13), .O(new_n79_));
  nand4  g45(.a(new_n44_), .b(new_n79_), .c(new_n76_), .d(new_n71_), .O(new_n80_));
  ...
  oai21  g49(.a(new_n82_), .b(new_n43_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand2  g52(.a(new_n86_), .b(x04), .O(new_n87_));
  aoi21  g53(.a(new_n77_), .b(x13), .c(new_n87_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(new_n85_), .O(z09));
  inv1   g55(.a(x00), .O(new_n90_));
  nand4  g56(.a(new_n79_), .b(new_n76_), .c(new_n71_), .d(new_n70_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n93_));
  ...
  aoi21  g63(.a(new_n97_), .b(new_n95_), .c(new_n40_), .O(z10));
  aoi21  g64(.a(new_n83_), .b(new_n56_), .c(new_n40_), .O(z12));
