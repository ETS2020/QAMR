...
module FAU ( 
  ...
  nand4  g34(.a(new_n66_), .b(new_n58_), .c(new_n68_), .d(x04), .O(z07));
  nand2  g35(.a(new_n66_), .b(x12), .O(new_n70_));
  inv1   g36(.a(x12), .O(new_n71_));
  inv1   g37(.a(new_n59_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n65_), .d(new_n61_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n58_), .d(x04), .O(z08));
  inv1   g40(.a(x13), .O(new_n75_));
  nand4  g41(.a(new_n44_), .b(new_n75_), .c(new_n71_), .d(new_n65_), .O(new_n76_));
  ...
  nand3  g52(.a(new_n75_), .b(new_n71_), .c(new_n65_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n44_), .c(new_n61_), .d(x08), .O(new_n89_));
  ...
  aoi21  g60(.a(new_n79_), .b(new_n56_), .c(new_n40_), .O(z12));
  and2   g61(.a(x17), .b(x04), .O(z14));
  buf1   g62(.a(x02), .O(z11));
  buf1   g63(.a(x04), .O(z13));
endmodule
