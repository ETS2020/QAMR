...
module FAU ( 
  ...
  aoi21  g21(.a(x16), .b(new_n35_), .c(x03), .O(new_n56_));
  ...
  nand3  g29(.a(new_n63_), .b(new_n51_), .c(x08), .O(new_n64_));
  ...
  nand4  g42(.a(new_n44_), .b(new_n76_), .c(new_n73_), .d(new_n68_), .O(new_n77_));
  nor3   g43(.a(new_n77_), .b(x10), .c(x09), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(x08), .c(x07), .d(x06), .O(new_n79_));
  nand2  g45(.a(new_n74_), .b(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n56_), .d(x04), .O(z09));
  inv1   g47(.a(x00), .O(new_n82_));
  nand4  g48(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n67_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n44_), .c(new_n59_), .d(x08), .O(new_n85_));
  inv1   g51(.a(new_n85_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(x07), .c(x06), .O(new_n87_));
  inv1   g53(.a(new_n56_), .O(new_n88_));
  nand2  g54(.a(new_n88_), .b(x14), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n87_), .c(new_n40_), .O(z10));
  nor2   g56(.a(new_n56_), .b(new_n40_), .O(z12));
