...
module FAU ( 
  ...
  wire new_n136_, new_n137_, new_n138_, new_n140_, new_n141_, new_n142_,
    new_n146_, new_n148_, new_n153_, new_n154_, new_n174_;
  ...
  nor3   g13(.a(x28), .b(x15), .c(x14), .O(new_n153_));
  nand4  g14(.a(new_n153_), .b(new_n140_), .c(new_n141_), .d(x29), .O(new_n154_));
  nor2   g15(.a(new_n154_), .b(x58), .O(z15));
  inv1   g16(.a(x58), .O(new_n174_));
  nor2   g17(.a(new_n154_), .b(new_n174_), .O(z34));
  zero   g18(.O(z00));
  zero   g19(.O(z01));
  zero   g20(.O(z02));
  zero   g21(.O(z03));
