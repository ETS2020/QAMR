// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:01 2020
...
module FAU ( 
  ...
  nand4  g289(.a(new_n419_), .b(new_n137_), .c(new_n220_), .d(new_n141_), .O(new_n420_));
  nor2   g290(.a(new_n420_), .b(x50), .O(new_n421_));
  nand4  g291(.a(new_n421_), .b(new_n132_), .c(new_n136_), .d(x51), .O(new_n422_));
