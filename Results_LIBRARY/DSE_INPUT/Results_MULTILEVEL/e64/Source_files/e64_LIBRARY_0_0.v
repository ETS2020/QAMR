...
module FAU ( 
  ...
  wire new_n136_, new_n137_, new_n138_, new_n140_, new_n141_, new_n142_,
    ...
    new_n156_, new_n158_, new_n159_, new_n160_, new_n180_, new_n181_,
    new_n182_;
  ...
  inv1   g13(.a(x10), .O(new_n152_));
  inv1   g14(.a(x14), .O(new_n153_));
  nand4  g15(.a(new_n137_), .b(new_n136_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  inv1   g16(.a(new_n154_), .O(new_n155_));
  nand4  g17(.a(new_n155_), .b(new_n140_), .c(new_n141_), .d(x29), .O(new_n156_));
  nor2   g18(.a(new_n156_), .b(x58), .O(z14));
  nand4  g19(.a(new_n137_), .b(new_n136_), .c(new_n153_), .d(x10), .O(new_n158_));
  ...
  inv1   g23(.a(x58), .O(new_n180_));
  nor3   g24(.a(x28), .b(x15), .c(x14), .O(new_n181_));
  nand4  g25(.a(new_n181_), .b(new_n140_), .c(new_n141_), .d(x29), .O(new_n182_));
  nor2   g26(.a(new_n182_), .b(new_n180_), .O(z34));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z03));
