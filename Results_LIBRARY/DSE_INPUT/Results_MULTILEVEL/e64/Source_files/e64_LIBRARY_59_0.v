...
module FAU ( 
  ...
  nor2   g103(.a(new_n240_), .b(x08), .O(new_n241_));
  nand4  g104(.a(new_n241_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n242_));
  nor2   g105(.a(new_n242_), .b(x15), .O(new_n243_));
  nand4  g106(.a(new_n243_), .b(new_n160_), .c(new_n237_), .d(new_n236_), .O(new_n244_));
  nor2   g107(.a(new_n244_), .b(x25), .O(new_n245_));
  nand4  g108(.a(new_n245_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n246_));
  nor2   g109(.a(new_n246_), .b(x30), .O(new_n247_));
  nand4  g110(.a(new_n247_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n248_));
  nor2   g111(.a(new_n248_), .b(x41), .O(new_n249_));
  nand4  g112(.a(new_n249_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n250_));
  nor2   g113(.a(new_n250_), .b(x50), .O(new_n251_));
  ...
  nand4  g120(.a(new_n257_), .b(new_n160_), .c(new_n237_), .d(new_n236_), .O(new_n258_));
  ...
  nand4  g159(.a(new_n163_), .b(new_n162_), .c(new_n239_), .d(new_n161_), .O(new_n325_));
  nor2   g160(.a(new_n325_), .b(x10), .O(new_n326_));
  nand4  g161(.a(new_n326_), .b(new_n135_), .c(new_n159_), .d(new_n177_), .O(new_n327_));
  nor2   g162(.a(new_n327_), .b(new_n236_), .O(new_n328_));
  nand3  g163(.a(new_n328_), .b(new_n160_), .c(new_n237_), .O(new_n329_));
  nor2   g164(.a(new_n329_), .b(x25), .O(new_n330_));
  nand4  g165(.a(new_n330_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n331_));
  nor2   g166(.a(new_n331_), .b(x30), .O(new_n332_));
  nand4  g167(.a(new_n332_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n333_));
  nor2   g168(.a(new_n333_), .b(x41), .O(new_n334_));
  nand4  g169(.a(new_n334_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n335_));
  nor2   g170(.a(new_n335_), .b(x50), .O(new_n336_));
  nand4  g171(.a(new_n336_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n337_));
  nor2   g172(.a(new_n337_), .b(x62), .O(z57));
  nor4   g173(.a(new_n327_), .b(x25), .c(x24), .d(new_n237_), .O(new_n339_));
  nand4  g174(.a(new_n339_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n340_));
  nor2   g175(.a(new_n340_), .b(x30), .O(new_n341_));
  nand4  g176(.a(new_n341_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n342_));
  nor2   g177(.a(new_n342_), .b(x41), .O(new_n343_));
  nand4  g178(.a(new_n343_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n344_));
  nor2   g179(.a(new_n344_), .b(x50), .O(new_n345_));
  nand4  g180(.a(new_n345_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n346_));
  nor2   g181(.a(new_n346_), .b(x62), .O(z58));
  nand4  g182(.a(new_n194_), .b(new_n191_), .c(new_n141_), .d(x40), .O(new_n348_));
  nor2   g183(.a(new_n348_), .b(x58), .O(z59));
  nand4  g184(.a(new_n177_), .b(new_n178_), .c(new_n163_), .d(x07), .O(new_n350_));
  nor2   g185(.a(new_n350_), .b(x14), .O(new_n351_));
  nand4  g186(.a(new_n351_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n352_));
  nor2   g187(.a(new_n352_), .b(x28), .O(new_n353_));
  nand4  g188(.a(new_n353_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n354_));
  nor2   g189(.a(new_n354_), .b(x39), .O(new_n355_));
  nand4  g190(.a(new_n355_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n356_));
  nor2   g191(.a(new_n356_), .b(x47), .O(new_n357_));
  nand4  g192(.a(new_n357_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n358_));
  nor2   g193(.a(new_n358_), .b(x60), .O(z60));
  nand4  g194(.a(new_n159_), .b(new_n177_), .c(new_n178_), .d(x08), .O(new_n360_));
  inv1   g195(.a(new_n360_), .O(new_n361_));
  nand4  g196(.a(new_n361_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n362_));
  nor2   g197(.a(new_n362_), .b(x28), .O(new_n363_));
  nand4  g198(.a(new_n363_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n364_));
  nor2   g199(.a(new_n364_), .b(x39), .O(new_n365_));
  nand4  g200(.a(new_n365_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n366_));
  nor2   g201(.a(new_n366_), .b(x47), .O(new_n367_));
  nand4  g202(.a(new_n367_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n368_));
  nor2   g203(.a(new_n368_), .b(x60), .O(z61));
  nand4  g204(.a(new_n135_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n370_));
  nor2   g205(.a(new_n370_), .b(x24), .O(new_n371_));
  nand4  g206(.a(new_n371_), .b(x29), .c(new_n138_), .d(new_n210_), .O(new_n372_));
  nor3   g207(.a(new_n372_), .b(x37), .c(x30), .O(new_n373_));
  nand4  g208(.a(new_n373_), .b(new_n141_), .c(new_n157_), .d(new_n156_), .O(new_n374_));
  nor2   g209(.a(new_n374_), .b(x46), .O(new_n375_));
  nand4  g210(.a(new_n375_), .b(new_n151_), .c(new_n191_), .d(x47), .O(new_n376_));
  nor3   g211(.a(new_n376_), .b(x60), .c(x58), .O(z62));
  nand4  g212(.a(new_n375_), .b(new_n152_), .c(x56), .d(new_n191_), .O(new_n378_));
  nor2   g213(.a(new_n378_), .b(x60), .O(z63));
  nor2   g214(.a(new_n372_), .b(new_n201_), .O(new_n380_));
  nand4  g215(.a(new_n380_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n381_));
  nor2   g216(.a(new_n381_), .b(x43), .O(new_n382_));
  nand4  g217(.a(new_n382_), .b(new_n152_), .c(new_n191_), .d(new_n154_), .O(new_n383_));
  nor2   g218(.a(new_n383_), .b(x60), .O(z64));
  zero   g219(.O(z00));
  zero   g220(.O(z01));
  zero   g221(.O(z02));
  zero   g222(.O(z03));
