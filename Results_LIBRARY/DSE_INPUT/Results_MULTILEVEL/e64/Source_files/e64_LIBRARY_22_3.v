...
module FAU ( 
  ...
  nand4  g374(.a(new_n504_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n505_));
  ...
  nand4  g378(.a(new_n508_), .b(new_n220_), .c(new_n219_), .d(new_n141_), .O(new_n509_));
  nor2   g379(.a(new_n509_), .b(x47), .O(new_n510_));
  nand4  g380(.a(new_n510_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n511_));
  nor2   g381(.a(new_n511_), .b(x51), .O(new_n512_));
  nand4  g382(.a(new_n512_), .b(new_n134_), .c(new_n217_), .d(new_n496_), .O(new_n513_));
  ...
  nor2   g431(.a(new_n561_), .b(new_n496_), .O(new_n562_));
