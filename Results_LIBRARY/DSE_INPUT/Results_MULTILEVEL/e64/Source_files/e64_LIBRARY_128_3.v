...
module FAU ( 
  ...
  nand3  g620(.a(new_n639_), .b(new_n189_), .c(x09), .O(new_n751_));
  nor2   g621(.a(new_n751_), .b(x11), .O(new_n752_));
  nand4  g622(.a(new_n752_), .b(new_n188_), .c(new_n155_), .d(new_n154_), .O(new_n753_));
  nor2   g623(.a(new_n753_), .b(x18), .O(new_n754_));
  nand4  g624(.a(new_n754_), .b(new_n187_), .c(new_n152_), .d(new_n151_), .O(new_n755_));
  nor2   g625(.a(new_n755_), .b(x26), .O(new_n756_));
  nand4  g626(.a(new_n756_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n757_));
  ...
  nand4  g632(.a(new_n762_), .b(new_n135_), .c(new_n139_), .d(new_n138_), .O(new_n763_));
