...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n581_, new_n582_, new_n583_, new_n584_, new_n585_, new_n588_,
  ...
  nand3  g225(.a(new_n355_), .b(x50), .c(new_n141_), .O(new_n356_));
  nor2   g226(.a(new_n356_), .b(x58), .O(z14));
  ...
  nand4  g415(.a(new_n355_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n546_));
  nor4   g416(.a(new_n546_), .b(new_n132_), .c(x50), .d(x46), .O(z29));
  ...
  nor4   g456(.a(new_n546_), .b(x58), .c(x50), .d(new_n220_), .O(z32));
  ...
  nor4   g478(.a(new_n416_), .b(x39), .c(x37), .d(x35), .O(new_n609_));
  ...
  nor3   g485(.a(new_n496_), .b(x20), .c(new_n224_), .O(new_n616_));
  ...
  nand4  g557(.a(new_n403_), .b(new_n139_), .c(new_n138_), .d(x49), .O(new_n688_));
  ...
  nand4  g563(.a(new_n230_), .b(new_n229_), .c(x01), .d(new_n227_), .O(new_n694_));
  inv1   g564(.a(new_n694_), .O(new_n695_));
  nand4  g565(.a(new_n695_), .b(new_n190_), .c(new_n226_), .d(new_n159_), .O(new_n696_));
  ...
  nand4  g579(.a(new_n709_), .b(new_n219_), .c(new_n141_), .d(new_n140_), .O(new_n710_));
  ...
  nand4  g587(.a(new_n159_), .b(new_n230_), .c(x02), .d(new_n227_), .O(new_n718_));
  ...
  nand4  g601(.a(new_n731_), .b(new_n219_), .c(new_n141_), .d(new_n140_), .O(new_n732_));
  ...
  nand4  g612(.a(new_n742_), .b(new_n137_), .c(new_n220_), .d(new_n141_), .O(new_n743_));
  ...
  nand4  g628(.a(new_n758_), .b(new_n137_), .c(new_n220_), .d(new_n141_), .O(new_n759_));
  ...
  nand4  g642(.a(new_n772_), .b(new_n137_), .c(new_n220_), .d(new_n141_), .O(new_n773_));
  ...
  nand2  g664(.a(new_n407_), .b(x57), .O(new_n795_));
  ...
  and2   g668(.a(new_n403_), .b(x48), .O(new_n799_));
  ...
  nand4  g689(.a(new_n819_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n820_));
  ...
  nor3   g697(.a(new_n410_), .b(x64), .c(new_n214_), .O(z53));
  ...
  nor3   g701(.a(new_n416_), .b(x37), .c(new_n184_), .O(new_n832_));
  ...
  nor4   g708(.a(new_n438_), .b(x18), .c(x17), .d(x16), .O(new_n839_));
