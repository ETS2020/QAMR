...
module FAU ( 
  ...
  nand2  g530(.a(new_n639_), .b(new_n158_), .O(new_n661_));
  nor2   g531(.a(new_n661_), .b(x10), .O(new_n662_));
  nand4  g532(.a(new_n662_), .b(new_n155_), .c(new_n154_), .d(new_n153_), .O(new_n663_));
  nor3   g533(.a(new_n663_), .b(x18), .c(x17), .O(new_n664_));
  nand4  g534(.a(new_n664_), .b(new_n187_), .c(new_n152_), .d(new_n151_), .O(new_n665_));
  nor4   g535(.a(new_n665_), .b(new_n186_), .c(x28), .d(x26), .O(new_n666_));
  ...
  nand4  g661(.a(new_n674_), .b(new_n135_), .c(new_n134_), .d(x53), .O(new_n792_));
