...
module FAU ( 
  ...
  nor2   g703(.a(new_n416_), .b(new_n184_), .O(new_n834_));
  nand4  g704(.a(new_n834_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n835_));
  nor2   g705(.a(new_n835_), .b(x41), .O(new_n836_));
  nand4  g706(.a(new_n836_), .b(new_n137_), .c(new_n220_), .d(new_n141_), .O(new_n837_));
  nor2   g707(.a(new_n837_), .b(x50), .O(new_n838_));
  nand4  g708(.a(new_n838_), .b(new_n132_), .c(new_n136_), .d(new_n139_), .O(new_n839_));
