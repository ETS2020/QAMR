// Benchmark "FAU" written by ABC on Mon Jul 27 19:30:55 2020
...
module FAU ( 
  ...
  inv1   g308(.a(new_n242_), .O(new_n439_));
  nor2   g309(.a(new_n439_), .b(x12), .O(new_n440_));
  nand3  g310(.a(new_n440_), .b(new_n155_), .c(new_n154_), .O(new_n441_));
  inv1   g311(.a(new_n441_), .O(new_n442_));
  nand3  g312(.a(new_n442_), .b(new_n150_), .c(new_n188_), .O(new_n443_));
  nor2   g313(.a(new_n443_), .b(x22), .O(new_n444_));
  nand4  g314(.a(new_n444_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n445_));
  nor2   g315(.a(new_n445_), .b(x28), .O(new_n446_));
  nand4  g316(.a(new_n446_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n447_));
  nor2   g317(.a(new_n447_), .b(x33), .O(new_n448_));
  nand4  g318(.a(new_n448_), .b(x36), .c(new_n184_), .d(new_n147_), .O(new_n449_));
  ...
  nand4  g322(.a(new_n452_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n453_));
  nor2   g323(.a(new_n453_), .b(x47), .O(new_n454_));
  nand4  g324(.a(new_n454_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n455_));
  nor2   g325(.a(new_n455_), .b(x51), .O(new_n456_));
  nand4  g326(.a(new_n456_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n457_));
  nor2   g327(.a(new_n457_), .b(x56), .O(new_n458_));
  nand4  g328(.a(new_n458_), .b(new_n131_), .c(new_n331_), .d(new_n215_), .O(new_n459_));
  nor2   g329(.a(new_n459_), .b(x60), .O(new_n460_));
  nand4  g330(.a(new_n460_), .b(new_n214_), .c(new_n213_), .d(new_n133_), .O(new_n461_));
  nor2   g331(.a(new_n461_), .b(x64), .O(z22));
  nor2   g332(.a(new_n441_), .b(new_n229_), .O(new_n463_));
  nand4  g333(.a(new_n463_), .b(new_n228_), .c(new_n150_), .d(new_n188_), .O(new_n464_));
  nor2   g334(.a(new_n464_), .b(x22), .O(new_n465_));
  nand4  g335(.a(new_n465_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n466_));
  nor2   g336(.a(new_n466_), .b(x28), .O(new_n467_));
  nand4  g337(.a(new_n467_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n468_));
  nor2   g338(.a(new_n468_), .b(x33), .O(new_n469_));
  nand4  g339(.a(new_n469_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n470_));
  nor2   g340(.a(new_n470_), .b(x37), .O(new_n471_));
  nand4  g341(.a(new_n471_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n472_));
  ...
  nand4  g345(.a(new_n475_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n476_));
  nor2   g346(.a(new_n476_), .b(x51), .O(new_n477_));
  nand4  g347(.a(new_n477_), .b(new_n134_), .c(new_n217_), .d(new_n216_), .O(new_n478_));
  nor2   g348(.a(new_n478_), .b(x55), .O(new_n479_));
  nand4  g349(.a(new_n479_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n480_));
  nor2   g350(.a(new_n480_), .b(x60), .O(new_n481_));
  nand4  g351(.a(new_n481_), .b(new_n214_), .c(new_n213_), .d(new_n133_), .O(new_n482_));
  nor2   g352(.a(new_n482_), .b(x64), .O(z23));
  nand4  g353(.a(new_n155_), .b(new_n154_), .c(x11), .d(new_n189_), .O(new_n484_));
  inv1   g354(.a(new_n484_), .O(new_n485_));
  nand4  g355(.a(new_n485_), .b(new_n149_), .c(new_n187_), .d(new_n152_), .O(new_n486_));
  ...
  nand4  g359(.a(new_n489_), .b(new_n331_), .c(new_n138_), .d(new_n222_), .O(new_n490_));
  nor2   g360(.a(new_n490_), .b(x60), .O(z24));
  nand4  g361(.a(new_n356_), .b(new_n149_), .c(new_n187_), .d(x24), .O(new_n492_));
  nor2   g362(.a(new_n492_), .b(new_n186_), .O(new_n493_));
  nand4  g363(.a(new_n493_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n494_));
  nor2   g364(.a(new_n494_), .b(x43), .O(new_n495_));
  nand4  g365(.a(new_n495_), .b(new_n331_), .c(new_n138_), .d(new_n222_), .O(new_n496_));
  nor2   g366(.a(new_n496_), .b(x60), .O(z25));
  nor2   g367(.a(new_n245_), .b(x20), .O(new_n498_));
  nand3  g368(.a(new_n498_), .b(new_n151_), .c(new_n228_), .O(new_n499_));
  nor2   g369(.a(new_n499_), .b(x24), .O(new_n500_));
  nand4  g370(.a(new_n500_), .b(new_n149_), .c(new_n148_), .d(new_n187_), .O(new_n501_));
  nor2   g371(.a(new_n501_), .b(new_n186_), .O(new_n502_));
  nand4  g372(.a(new_n502_), .b(x32), .c(new_n145_), .d(new_n185_), .O(new_n503_));
  nor2   g373(.a(new_n503_), .b(x33), .O(new_n504_));
  nand4  g374(.a(new_n504_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n505_));
  nor2   g375(.a(new_n505_), .b(x37), .O(new_n506_));
  nand4  g376(.a(new_n506_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n507_));
  nor2   g377(.a(new_n507_), .b(x42), .O(new_n508_));
  nand4  g378(.a(new_n508_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n509_));
  nor2   g379(.a(new_n509_), .b(x47), .O(new_n510_));
  nand4  g380(.a(new_n510_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n511_));
  nor2   g381(.a(new_n511_), .b(x51), .O(new_n512_));
  nand4  g382(.a(new_n512_), .b(new_n134_), .c(new_n217_), .d(new_n216_), .O(new_n513_));
  nor2   g383(.a(new_n513_), .b(x55), .O(new_n514_));
  nand4  g384(.a(new_n514_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n515_));
  ...
  nand3  g388(.a(new_n440_), .b(new_n154_), .c(x13), .O(new_n519_));
  nor4   g389(.a(new_n519_), .b(x17), .c(x16), .d(x15), .O(new_n520_));
  nand4  g390(.a(new_n520_), .b(new_n228_), .c(new_n227_), .d(new_n150_), .O(new_n521_));
  nor2   g391(.a(new_n521_), .b(x22), .O(new_n522_));
  nand4  g392(.a(new_n522_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n523_));
  nor2   g393(.a(new_n523_), .b(x28), .O(new_n524_));
  nand4  g394(.a(new_n524_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n525_));
  nor2   g395(.a(new_n525_), .b(x33), .O(new_n526_));
  nand4  g396(.a(new_n526_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n527_));
  nor2   g397(.a(new_n527_), .b(x37), .O(new_n528_));
  nand4  g398(.a(new_n528_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n529_));
  nor2   g399(.a(new_n529_), .b(x42), .O(new_n530_));
  nand4  g400(.a(new_n530_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n531_));
  nor2   g401(.a(new_n531_), .b(x47), .O(new_n532_));
  nand4  g402(.a(new_n532_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n533_));
  nor2   g403(.a(new_n533_), .b(x51), .O(new_n534_));
  nand4  g404(.a(new_n534_), .b(new_n134_), .c(new_n217_), .d(new_n216_), .O(new_n535_));
  nor2   g405(.a(new_n535_), .b(x55), .O(new_n536_));
  nand4  g406(.a(new_n536_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n537_));
  ...
  nor4   g410(.a(new_n357_), .b(new_n186_), .c(x28), .d(new_n187_), .O(new_n541_));
  ...
  nor4   g415(.a(new_n359_), .b(x43), .c(x40), .d(x39), .O(new_n546_));
  nand4  g416(.a(new_n546_), .b(new_n331_), .c(new_n138_), .d(new_n222_), .O(new_n547_));
  nor2   g417(.a(new_n547_), .b(new_n132_), .O(z29));
  nor3   g418(.a(new_n443_), .b(x22), .c(x21), .O(new_n549_));
  nand4  g419(.a(new_n549_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n550_));
  nor2   g420(.a(new_n550_), .b(x28), .O(new_n551_));
  nand4  g421(.a(new_n551_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n552_));
  nor2   g422(.a(new_n552_), .b(x33), .O(new_n553_));
  nand4  g423(.a(new_n553_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n554_));
  nor2   g424(.a(new_n554_), .b(x37), .O(new_n555_));
  nand4  g425(.a(new_n555_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n556_));
  nor2   g426(.a(new_n556_), .b(x42), .O(new_n557_));
  nand4  g427(.a(new_n557_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n558_));
  nor2   g428(.a(new_n558_), .b(x47), .O(new_n559_));
  nand4  g429(.a(new_n559_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n560_));
  nor2   g430(.a(new_n560_), .b(x51), .O(new_n561_));
  nand4  g431(.a(new_n561_), .b(new_n134_), .c(new_n217_), .d(x52), .O(new_n562_));
  nor2   g432(.a(new_n562_), .b(x55), .O(new_n563_));
  nand4  g433(.a(new_n563_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n564_));
  nor2   g434(.a(new_n564_), .b(x60), .O(new_n565_));
  nand4  g435(.a(new_n565_), .b(new_n214_), .c(new_n213_), .d(new_n133_), .O(new_n566_));
  nor2   g436(.a(new_n566_), .b(x64), .O(z30));
  nor3   g437(.a(new_n443_), .b(x22), .c(new_n228_), .O(new_n568_));
  nand4  g438(.a(new_n568_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n569_));
  nor2   g439(.a(new_n569_), .b(x28), .O(new_n570_));
  nand4  g440(.a(new_n570_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n571_));
  nor2   g441(.a(new_n571_), .b(x33), .O(new_n572_));
  nand4  g442(.a(new_n572_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n573_));
  nor2   g443(.a(new_n573_), .b(x37), .O(new_n574_));
  nand4  g444(.a(new_n574_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n575_));
  nor2   g445(.a(new_n575_), .b(x42), .O(new_n576_));
  nand4  g446(.a(new_n576_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n577_));
  nor2   g447(.a(new_n577_), .b(x47), .O(new_n578_));
  nand4  g448(.a(new_n578_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n579_));
  nor2   g449(.a(new_n579_), .b(x51), .O(new_n580_));
  nand4  g450(.a(new_n580_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n581_));
  nor2   g451(.a(new_n581_), .b(x56), .O(new_n582_));
  nand4  g452(.a(new_n582_), .b(new_n131_), .c(new_n331_), .d(new_n215_), .O(new_n583_));
  nor2   g453(.a(new_n583_), .b(x60), .O(new_n584_));
  nand4  g454(.a(new_n584_), .b(new_n214_), .c(new_n213_), .d(new_n133_), .O(new_n585_));
  nor2   g455(.a(new_n585_), .b(x64), .O(z31));
  nand3  g456(.a(new_n546_), .b(new_n138_), .c(x46), .O(new_n587_));
  nor2   g457(.a(new_n587_), .b(x58), .O(z32));
  nand4  g458(.a(new_n358_), .b(new_n141_), .c(new_n144_), .d(x39), .O(new_n589_));
  nor3   g459(.a(new_n589_), .b(x58), .c(x50), .O(z33));
  nor3   g460(.a(x28), .b(x15), .c(x14), .O(new_n591_));
  nand4  g461(.a(new_n591_), .b(new_n141_), .c(new_n142_), .d(x29), .O(new_n592_));
  nor2   g462(.a(new_n592_), .b(new_n331_), .O(z34));
  nand4  g463(.a(new_n160_), .b(new_n156_), .c(new_n190_), .d(x04), .O(new_n594_));
  nor2   g464(.a(new_n594_), .b(x08), .O(new_n595_));
  nand4  g465(.a(new_n595_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n596_));
  nor2   g466(.a(new_n596_), .b(x15), .O(new_n597_));
  nand4  g467(.a(new_n597_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n598_));
  nor2   g468(.a(new_n598_), .b(x25), .O(new_n599_));
  nand4  g469(.a(new_n599_), .b(x29), .c(new_n149_), .d(new_n148_), .O(new_n600_));
  nor2   g470(.a(new_n600_), .b(x30), .O(new_n601_));
  nand4  g471(.a(new_n601_), .b(new_n143_), .c(new_n142_), .d(new_n184_), .O(new_n602_));
  nor2   g472(.a(new_n602_), .b(x40), .O(new_n603_));
  nand4  g473(.a(new_n603_), .b(new_n222_), .c(new_n141_), .d(new_n183_), .O(new_n604_));
  nor2   g474(.a(new_n604_), .b(x47), .O(new_n605_));
  nand4  g475(.a(new_n605_), .b(new_n135_), .c(new_n139_), .d(new_n138_), .O(new_n606_));
  nor2   g476(.a(new_n606_), .b(x56), .O(new_n607_));
  nand4  g477(.a(new_n607_), .b(new_n133_), .c(new_n132_), .d(new_n331_), .O(new_n608_));
  nor2   g478(.a(new_n608_), .b(x62), .O(z35));
  nor4   g479(.a(new_n417_), .b(x39), .c(x37), .d(x35), .O(new_n610_));
  ...
  nand4  g484(.a(new_n614_), .b(x61), .c(new_n132_), .d(new_n331_), .O(new_n615_));
  nor2   g485(.a(new_n615_), .b(x62), .O(z36));
  inv1   g486(.a(x19), .O(new_n617_));
  nor2   g487(.a(new_n245_), .b(new_n617_), .O(new_n618_));
  nand4  g488(.a(new_n618_), .b(new_n151_), .c(new_n228_), .d(new_n227_), .O(new_n619_));
  nor2   g489(.a(new_n619_), .b(x24), .O(new_n620_));
  nand4  g490(.a(new_n620_), .b(new_n149_), .c(new_n148_), .d(new_n187_), .O(new_n621_));
  nor2   g491(.a(new_n621_), .b(new_n186_), .O(new_n622_));
  nand4  g492(.a(new_n622_), .b(new_n225_), .c(new_n145_), .d(new_n185_), .O(new_n623_));
  nor2   g493(.a(new_n623_), .b(x33), .O(new_n624_));
  nand4  g494(.a(new_n624_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n625_));
  nor2   g495(.a(new_n625_), .b(x37), .O(new_n626_));
  nand4  g496(.a(new_n626_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n627_));
  nor2   g497(.a(new_n627_), .b(x42), .O(new_n628_));
  nand4  g498(.a(new_n628_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n629_));
  nor2   g499(.a(new_n629_), .b(x47), .O(new_n630_));
  nand4  g500(.a(new_n630_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n631_));
  nor2   g501(.a(new_n631_), .b(x51), .O(new_n632_));
  nand4  g502(.a(new_n632_), .b(new_n134_), .c(new_n217_), .d(new_n216_), .O(new_n633_));
  nor2   g503(.a(new_n633_), .b(x55), .O(new_n634_));
  nand4  g504(.a(new_n634_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n635_));
  ...
  nand4  g517(.a(new_n647_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n648_));
  ...
  nand4  g524(.a(new_n654_), .b(new_n222_), .c(new_n141_), .d(x42), .O(new_n655_));
  ...
  nand4  g528(.a(new_n658_), .b(new_n133_), .c(new_n132_), .d(new_n331_), .O(new_n659_));
  ...
  nand4  g542(.a(new_n672_), .b(new_n138_), .c(new_n137_), .d(new_n222_), .O(new_n673_));
  ...
  nand4  g553(.a(new_n683_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n684_));
  ...
  nand4  g565(.a(new_n236_), .b(new_n235_), .c(x01), .d(new_n233_), .O(new_n696_));
  inv1   g566(.a(new_n696_), .O(new_n697_));
  nand4  g567(.a(new_n697_), .b(new_n190_), .c(new_n232_), .d(new_n159_), .O(new_n698_));
  ...
  nand4  g581(.a(new_n711_), .b(new_n221_), .c(new_n141_), .d(new_n140_), .O(new_n712_));
  ...
  nand4  g589(.a(new_n159_), .b(new_n236_), .c(x02), .d(new_n233_), .O(new_n720_));
  ...
  nand4  g603(.a(new_n733_), .b(new_n221_), .c(new_n141_), .d(new_n140_), .O(new_n734_));
  ...
  nand4  g614(.a(new_n744_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n745_));
  ...
  nand4  g630(.a(new_n760_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n761_));
  ...
  nand4  g671(.a(new_n801_), .b(new_n139_), .c(new_n138_), .d(new_n219_), .O(new_n802_));
  ...
  nor2   g677(.a(new_n439_), .b(new_n230_), .O(new_n808_));
  nand4  g678(.a(new_n808_), .b(new_n188_), .c(new_n155_), .d(new_n154_), .O(new_n809_));
  nor2   g679(.a(new_n809_), .b(x18), .O(new_n810_));
  nand4  g680(.a(new_n810_), .b(new_n187_), .c(new_n152_), .d(new_n151_), .O(new_n811_));
  nor2   g681(.a(new_n811_), .b(x26), .O(new_n812_));
  nand4  g682(.a(new_n812_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n813_));
  nor2   g683(.a(new_n813_), .b(x31), .O(new_n814_));
  nand4  g684(.a(new_n814_), .b(new_n184_), .c(new_n147_), .d(new_n146_), .O(new_n815_));
  nor2   g685(.a(new_n815_), .b(x37), .O(new_n816_));
  nand4  g686(.a(new_n816_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n817_));
  nor2   g687(.a(new_n817_), .b(x42), .O(new_n818_));
  nand4  g688(.a(new_n818_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n819_));
  nor2   g689(.a(new_n819_), .b(x47), .O(new_n820_));
  nand4  g690(.a(new_n820_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n821_));
  ...
  nand4  g694(.a(new_n824_), .b(new_n131_), .c(new_n331_), .d(new_n215_), .O(new_n825_));
  ...
  nor3   g698(.a(new_n411_), .b(x64), .c(new_n214_), .O(z53));
  nor2   g699(.a(new_n613_), .b(new_n135_), .O(new_n830_));
  nand4  g700(.a(new_n830_), .b(new_n132_), .c(new_n331_), .d(new_n136_), .O(new_n831_));
  nor2   g701(.a(new_n831_), .b(x62), .O(z54));
  nor3   g702(.a(new_n417_), .b(x37), .c(new_n184_), .O(new_n833_));
  nand4  g703(.a(new_n833_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n834_));
  nor2   g704(.a(new_n834_), .b(x43), .O(new_n835_));
  nand4  g705(.a(new_n835_), .b(new_n138_), .c(new_n137_), .d(new_n222_), .O(new_n836_));
  nor2   g706(.a(new_n836_), .b(x51), .O(new_n837_));
  nand4  g707(.a(new_n837_), .b(new_n132_), .c(new_n331_), .d(new_n136_), .O(new_n838_));
  nor2   g708(.a(new_n838_), .b(x62), .O(z55));
  nor3   g709(.a(new_n441_), .b(x17), .c(x16), .O(new_n840_));
  nand4  g710(.a(new_n840_), .b(new_n228_), .c(x20), .d(new_n150_), .O(new_n841_));
  nor2   g711(.a(new_n841_), .b(x22), .O(new_n842_));
  nand4  g712(.a(new_n842_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n843_));
  nor2   g713(.a(new_n843_), .b(x28), .O(new_n844_));
  nand4  g714(.a(new_n844_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n845_));
  nor2   g715(.a(new_n845_), .b(x33), .O(new_n846_));
  nand4  g716(.a(new_n846_), .b(new_n223_), .c(new_n184_), .d(new_n147_), .O(new_n847_));
  nor2   g717(.a(new_n847_), .b(x37), .O(new_n848_));
  nand4  g718(.a(new_n848_), .b(new_n183_), .c(new_n144_), .d(new_n143_), .O(new_n849_));
  nor2   g719(.a(new_n849_), .b(x42), .O(new_n850_));
  nand4  g720(.a(new_n850_), .b(new_n222_), .c(new_n221_), .d(new_n141_), .O(new_n851_));
  nor2   g721(.a(new_n851_), .b(x47), .O(new_n852_));
  nand4  g722(.a(new_n852_), .b(new_n138_), .c(new_n219_), .d(new_n218_), .O(new_n853_));
  nor2   g723(.a(new_n853_), .b(x51), .O(new_n854_));
  nand4  g724(.a(new_n854_), .b(new_n134_), .c(new_n217_), .d(new_n216_), .O(new_n855_));
  nor2   g725(.a(new_n855_), .b(x55), .O(new_n856_));
  nand4  g726(.a(new_n856_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n857_));
  nor2   g727(.a(new_n857_), .b(x60), .O(new_n858_));
  nand4  g728(.a(new_n858_), .b(new_n214_), .c(new_n213_), .d(new_n133_), .O(new_n859_));
  nor2   g729(.a(new_n859_), .b(x64), .O(z56));
  nand4  g730(.a(new_n157_), .b(new_n156_), .c(new_n190_), .d(new_n236_), .O(new_n861_));
  inv1   g731(.a(new_n861_), .O(new_n862_));
  nand4  g732(.a(new_n862_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n863_));
  ...
  nand4  g740(.a(new_n870_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n871_));
  nor2   g741(.a(new_n871_), .b(x50), .O(new_n872_));
  nand4  g742(.a(new_n872_), .b(new_n132_), .c(new_n331_), .d(new_n136_), .O(new_n873_));
  ...
  nand4  g750(.a(new_n880_), .b(new_n137_), .c(new_n222_), .d(new_n141_), .O(new_n881_));
  nor2   g751(.a(new_n881_), .b(x50), .O(new_n882_));
  nand4  g752(.a(new_n882_), .b(new_n132_), .c(new_n331_), .d(new_n136_), .O(new_n883_));
  nor2   g753(.a(new_n883_), .b(x62), .O(z58));
  nand4  g754(.a(new_n358_), .b(new_n138_), .c(new_n141_), .d(x40), .O(new_n885_));
  nor2   g755(.a(new_n885_), .b(x58), .O(z59));
  nand4  g756(.a(new_n153_), .b(new_n189_), .c(new_n157_), .d(x07), .O(new_n887_));
  nor2   g757(.a(new_n887_), .b(x14), .O(new_n888_));
  nand4  g758(.a(new_n888_), .b(new_n187_), .c(new_n152_), .d(new_n155_), .O(new_n889_));
  nor2   g759(.a(new_n889_), .b(x28), .O(new_n890_));
  nand4  g760(.a(new_n890_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n891_));
  nor2   g761(.a(new_n891_), .b(x39), .O(new_n892_));
  nand4  g762(.a(new_n892_), .b(new_n222_), .c(new_n141_), .d(new_n144_), .O(new_n893_));
  nor2   g763(.a(new_n893_), .b(x47), .O(new_n894_));
  nand4  g764(.a(new_n894_), .b(new_n331_), .c(new_n136_), .d(new_n138_), .O(new_n895_));
  nor2   g765(.a(new_n895_), .b(x60), .O(z60));
  nand4  g766(.a(new_n154_), .b(new_n153_), .c(new_n189_), .d(x08), .O(new_n897_));
  inv1   g767(.a(new_n897_), .O(new_n898_));
  nand4  g768(.a(new_n898_), .b(new_n187_), .c(new_n152_), .d(new_n155_), .O(new_n899_));
  nor2   g769(.a(new_n899_), .b(x28), .O(new_n900_));
  nand4  g770(.a(new_n900_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n901_));
  nor2   g771(.a(new_n901_), .b(x39), .O(new_n902_));
  nand4  g772(.a(new_n902_), .b(new_n222_), .c(new_n141_), .d(new_n144_), .O(new_n903_));
  nor2   g773(.a(new_n903_), .b(x47), .O(new_n904_));
  nand4  g774(.a(new_n904_), .b(new_n331_), .c(new_n136_), .d(new_n138_), .O(new_n905_));
  nor2   g775(.a(new_n905_), .b(x60), .O(z61));
  nand4  g776(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n189_), .O(new_n907_));
  nor2   g777(.a(new_n907_), .b(x24), .O(new_n908_));
  nand4  g778(.a(new_n908_), .b(x29), .c(new_n149_), .d(new_n187_), .O(new_n909_));
  nor3   g779(.a(new_n909_), .b(x37), .c(x30), .O(new_n910_));
  nand4  g780(.a(new_n910_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n911_));
  nor2   g781(.a(new_n911_), .b(x46), .O(new_n912_));
  nand4  g782(.a(new_n912_), .b(new_n136_), .c(new_n138_), .d(x47), .O(new_n913_));
  nor3   g783(.a(new_n913_), .b(x60), .c(x58), .O(z62));
  nand4  g784(.a(new_n912_), .b(new_n331_), .c(x56), .d(new_n138_), .O(new_n915_));
  nor2   g785(.a(new_n915_), .b(x60), .O(z63));
  nor2   g786(.a(new_n909_), .b(new_n185_), .O(new_n917_));
  nand4  g787(.a(new_n917_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n918_));
  nor2   g788(.a(new_n918_), .b(x43), .O(new_n919_));
  nand4  g789(.a(new_n919_), .b(new_n331_), .c(new_n138_), .d(new_n222_), .O(new_n920_));
