...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n141_, new_n142_,
    ...
    new_n315_, new_n316_, new_n318_, new_n337_, new_n338_, new_n339_,
  ...
  inv1   g101(.a(x00), .O(new_n239_));
  inv1   g102(.a(x06), .O(new_n240_));
  nand4  g103(.a(new_n162_), .b(new_n240_), .c(new_n161_), .d(new_n239_), .O(new_n241_));
  ...
  nand4  g117(.a(new_n162_), .b(new_n240_), .c(new_n161_), .d(x00), .O(new_n255_));
  ...
  nor2   g163(.a(new_n245_), .b(x25), .O(new_n307_));
  nand4  g164(.a(new_n307_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n308_));
  nor2   g165(.a(new_n308_), .b(x30), .O(new_n309_));
  nand4  g166(.a(new_n309_), .b(new_n156_), .c(new_n142_), .d(new_n306_), .O(new_n310_));
  nor2   g167(.a(new_n310_), .b(x40), .O(new_n311_));
  nand4  g168(.a(new_n311_), .b(new_n154_), .c(new_n141_), .d(new_n176_), .O(new_n312_));
  nor2   g169(.a(new_n312_), .b(x47), .O(new_n313_));
  nand4  g170(.a(new_n313_), .b(new_n305_), .c(new_n236_), .d(new_n191_), .O(new_n314_));
  nor2   g171(.a(new_n314_), .b(x56), .O(new_n315_));
  nand4  g172(.a(new_n315_), .b(new_n304_), .c(new_n153_), .d(new_n152_), .O(new_n316_));
  nor2   g173(.a(new_n316_), .b(x62), .O(z35));
  nand4  g174(.a(new_n315_), .b(x61), .c(new_n153_), .d(new_n152_), .O(new_n318_));
  nor2   g175(.a(new_n318_), .b(x62), .O(z36));
  nand3  g176(.a(new_n313_), .b(new_n236_), .c(new_n191_), .O(new_n337_));
  nor2   g177(.a(new_n337_), .b(new_n305_), .O(new_n338_));
  nand4  g178(.a(new_n338_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n339_));
  nor2   g179(.a(new_n339_), .b(x62), .O(z54));
  nor3   g180(.a(new_n247_), .b(x37), .c(new_n306_), .O(new_n341_));
  nand4  g181(.a(new_n341_), .b(new_n176_), .c(new_n157_), .d(new_n156_), .O(new_n342_));
  nor2   g182(.a(new_n342_), .b(x43), .O(new_n343_));
  nand4  g183(.a(new_n343_), .b(new_n191_), .c(new_n155_), .d(new_n154_), .O(new_n344_));
  nor2   g184(.a(new_n344_), .b(x51), .O(new_n345_));
  nand4  g185(.a(new_n345_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n346_));
  nor2   g186(.a(new_n346_), .b(x62), .O(z55));
  nand4  g187(.a(new_n163_), .b(new_n162_), .c(new_n240_), .d(new_n161_), .O(new_n349_));
  nor2   g188(.a(new_n349_), .b(x10), .O(new_n350_));
  nand4  g189(.a(new_n350_), .b(new_n135_), .c(new_n159_), .d(new_n177_), .O(new_n351_));
  nor2   g190(.a(new_n351_), .b(new_n237_), .O(new_n352_));
  nand3  g191(.a(new_n352_), .b(new_n160_), .c(new_n238_), .O(new_n353_));
  nor2   g192(.a(new_n353_), .b(x25), .O(new_n354_));
  nand4  g193(.a(new_n354_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n355_));
  nor2   g194(.a(new_n355_), .b(x30), .O(new_n356_));
  nand4  g195(.a(new_n356_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n357_));
  nor2   g196(.a(new_n357_), .b(x41), .O(new_n358_));
  nand4  g197(.a(new_n358_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n359_));
  nor2   g198(.a(new_n359_), .b(x50), .O(new_n360_));
  nand4  g199(.a(new_n360_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n361_));
  nor2   g200(.a(new_n361_), .b(x62), .O(z57));
  nor4   g201(.a(new_n351_), .b(x25), .c(x24), .d(new_n238_), .O(new_n363_));
  nand4  g202(.a(new_n363_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n364_));
  nor2   g203(.a(new_n364_), .b(x30), .O(new_n365_));
  nand4  g204(.a(new_n365_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n366_));
  nor2   g205(.a(new_n366_), .b(x41), .O(new_n367_));
  nand4  g206(.a(new_n367_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n368_));
  nor2   g207(.a(new_n368_), .b(x50), .O(new_n369_));
  nand4  g208(.a(new_n369_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n370_));
  nor2   g209(.a(new_n370_), .b(x62), .O(z58));
  nand4  g210(.a(new_n194_), .b(new_n191_), .c(new_n141_), .d(x40), .O(new_n372_));
  nor2   g211(.a(new_n372_), .b(x58), .O(z59));
  nand4  g212(.a(new_n177_), .b(new_n178_), .c(new_n163_), .d(x07), .O(new_n374_));
  nor2   g213(.a(new_n374_), .b(x14), .O(new_n375_));
  nand4  g214(.a(new_n375_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n376_));
  nor2   g215(.a(new_n376_), .b(x28), .O(new_n377_));
  nand4  g216(.a(new_n377_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n378_));
  nor2   g217(.a(new_n378_), .b(x39), .O(new_n379_));
  nand4  g218(.a(new_n379_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n380_));
  nor2   g219(.a(new_n380_), .b(x47), .O(new_n381_));
  nand4  g220(.a(new_n381_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n382_));
  nor2   g221(.a(new_n382_), .b(x60), .O(z60));
  nand4  g222(.a(new_n159_), .b(new_n177_), .c(new_n178_), .d(x08), .O(new_n384_));
  inv1   g223(.a(new_n384_), .O(new_n385_));
  nand4  g224(.a(new_n385_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n386_));
  nor2   g225(.a(new_n386_), .b(x28), .O(new_n387_));
  nand4  g226(.a(new_n387_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n388_));
  nor2   g227(.a(new_n388_), .b(x39), .O(new_n389_));
  nand4  g228(.a(new_n389_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n390_));
  nor2   g229(.a(new_n390_), .b(x47), .O(new_n391_));
  nand4  g230(.a(new_n391_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n392_));
  nor2   g231(.a(new_n392_), .b(x60), .O(z61));
  nand4  g232(.a(new_n135_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n394_));
  nor2   g233(.a(new_n394_), .b(x24), .O(new_n395_));
  nand4  g234(.a(new_n395_), .b(x29), .c(new_n138_), .d(new_n210_), .O(new_n396_));
  nor3   g235(.a(new_n396_), .b(x37), .c(x30), .O(new_n397_));
  nand4  g236(.a(new_n397_), .b(new_n141_), .c(new_n157_), .d(new_n156_), .O(new_n398_));
  nor2   g237(.a(new_n398_), .b(x46), .O(new_n399_));
  nand4  g238(.a(new_n399_), .b(new_n151_), .c(new_n191_), .d(x47), .O(new_n400_));
  nor3   g239(.a(new_n400_), .b(x60), .c(x58), .O(z62));
  nand4  g240(.a(new_n399_), .b(new_n152_), .c(x56), .d(new_n191_), .O(new_n402_));
  nor2   g241(.a(new_n402_), .b(x60), .O(z63));
  nor2   g242(.a(new_n396_), .b(new_n201_), .O(new_n404_));
  nand4  g243(.a(new_n404_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n405_));
  nor2   g244(.a(new_n405_), .b(x43), .O(new_n406_));
  nand4  g245(.a(new_n406_), .b(new_n152_), .c(new_n191_), .d(new_n154_), .O(new_n407_));
  nor2   g246(.a(new_n407_), .b(x60), .O(z64));
  zero   g247(.O(z00));
  zero   g248(.O(z01));
  zero   g249(.O(z02));
  zero   g250(.O(z03));
