...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n141_, new_n142_,
    ...
    new_n237_, new_n243_, new_n244_, new_n245_, new_n246_, new_n247_,
  ...
  inv1   g064(.a(x11), .O(new_n243_));
  nand4  g065(.a(new_n135_), .b(new_n154_), .c(new_n243_), .d(new_n153_), .O(new_n244_));
  inv1   g066(.a(new_n244_), .O(new_n245_));
  nand4  g067(.a(new_n245_), .b(new_n138_), .c(new_n177_), .d(new_n176_), .O(new_n246_));
  nor2   g068(.a(new_n246_), .b(new_n136_), .O(new_n247_));
  nand4  g069(.a(new_n247_), .b(new_n175_), .c(new_n174_), .d(new_n142_), .O(new_n248_));
  nor2   g070(.a(new_n248_), .b(x43), .O(new_n249_));
  nand4  g071(.a(new_n249_), .b(new_n173_), .c(new_n172_), .d(new_n171_), .O(new_n250_));
  nor2   g072(.a(new_n250_), .b(x60), .O(z64));
  zero   g073(.O(z00));
  zero   g074(.O(z01));
  zero   g075(.O(z02));
  zero   g076(.O(z03));
