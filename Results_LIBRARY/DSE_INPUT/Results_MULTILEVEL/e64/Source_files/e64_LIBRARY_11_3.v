...
module FAU ( 
  ...
  nor3   g710(.a(new_n438_), .b(x17), .c(x16), .O(new_n841_));
  nand4  g711(.a(new_n841_), .b(new_n222_), .c(x20), .d(new_n150_), .O(new_n842_));
  nor2   g712(.a(new_n842_), .b(x22), .O(new_n843_));
  nand4  g713(.a(new_n843_), .b(new_n148_), .c(new_n187_), .d(new_n152_), .O(new_n844_));
  nor2   g714(.a(new_n844_), .b(x28), .O(new_n845_));
  nand4  g715(.a(new_n845_), .b(new_n145_), .c(new_n185_), .d(x29), .O(new_n846_));
  nor2   g716(.a(new_n846_), .b(x33), .O(new_n847_));
  nand4  g717(.a(new_n847_), .b(new_n303_), .c(new_n184_), .d(new_n147_), .O(new_n848_));
  ...
  nand4  g723(.a(new_n853_), .b(new_n138_), .c(new_n218_), .d(new_n394_), .O(new_n854_));
  nor2   g724(.a(new_n854_), .b(x51), .O(new_n855_));
  nand4  g725(.a(new_n855_), .b(new_n134_), .c(new_n217_), .d(new_n549_), .O(new_n856_));
  nor2   g726(.a(new_n856_), .b(x55), .O(new_n857_));
  nand4  g727(.a(new_n857_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n858_));
