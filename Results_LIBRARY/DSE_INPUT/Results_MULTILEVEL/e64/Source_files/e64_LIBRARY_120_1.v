// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:17 2020
...
module FAU ( 
  ...
  nand2  g312(.a(new_n442_), .b(new_n150_), .O(new_n443_));
  ...
  nor4   g418(.a(new_n443_), .b(x24), .c(x22), .d(x21), .O(new_n549_));
  nand4  g419(.a(new_n549_), .b(new_n149_), .c(new_n148_), .d(new_n187_), .O(new_n550_));
  nor2   g420(.a(new_n550_), .b(new_n186_), .O(new_n551_));
  nand4  g421(.a(new_n551_), .b(new_n146_), .c(new_n145_), .d(new_n185_), .O(new_n552_));
  nor2   g422(.a(new_n552_), .b(x34), .O(new_n553_));
  nand4  g423(.a(new_n553_), .b(new_n142_), .c(new_n223_), .d(new_n184_), .O(new_n554_));
  nor2   g424(.a(new_n554_), .b(x39), .O(new_n555_));
  nand4  g425(.a(new_n555_), .b(new_n140_), .c(new_n183_), .d(new_n144_), .O(new_n556_));
  nor2   g426(.a(new_n556_), .b(x43), .O(new_n557_));
  nand4  g427(.a(new_n557_), .b(new_n137_), .c(new_n222_), .d(new_n221_), .O(new_n558_));
  nor2   g428(.a(new_n558_), .b(x48), .O(new_n559_));
  nand4  g429(.a(new_n559_), .b(new_n139_), .c(new_n138_), .d(new_n219_), .O(new_n560_));
  nor2   g430(.a(new_n560_), .b(new_n216_), .O(new_n561_));
  nand4  g431(.a(new_n561_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n562_));
  nor2   g432(.a(new_n562_), .b(x56), .O(new_n563_));
  nand4  g433(.a(new_n563_), .b(new_n131_), .c(new_n331_), .d(new_n215_), .O(new_n564_));
