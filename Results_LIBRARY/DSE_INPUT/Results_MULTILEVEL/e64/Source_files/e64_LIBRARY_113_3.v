// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:14 2020
...
module FAU ( 
  ...
  nand4  g779(.a(new_n909_), .b(new_n149_), .c(new_n187_), .d(new_n152_), .O(new_n910_));
  nor2   g780(.a(new_n910_), .b(new_n186_), .O(new_n911_));
  nand2  g781(.a(new_n911_), .b(new_n185_), .O(new_n912_));
  ...
  nand4  g789(.a(new_n911_), .b(new_n143_), .c(new_n142_), .d(x30), .O(new_n920_));
  nor2   g790(.a(new_n920_), .b(x40), .O(new_n921_));
  nand4  g791(.a(new_n921_), .b(new_n138_), .c(new_n220_), .d(new_n141_), .O(new_n922_));
