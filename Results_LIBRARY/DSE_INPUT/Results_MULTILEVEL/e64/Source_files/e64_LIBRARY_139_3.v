// Benchmark "FAU" written by ABC on Mon Jul 27 19:31:24 2020
...
module FAU ( 
  ...
  nand4  g759(.a(new_n889_), .b(new_n152_), .c(new_n155_), .d(new_n154_), .O(new_n890_));
  nor2   g760(.a(new_n890_), .b(x25), .O(new_n891_));
  nand4  g761(.a(new_n891_), .b(new_n185_), .c(x29), .d(new_n149_), .O(new_n892_));
  nor2   g762(.a(new_n892_), .b(x37), .O(new_n893_));
  nand4  g763(.a(new_n893_), .b(new_n141_), .c(new_n144_), .d(new_n143_), .O(new_n894_));
  nor2   g764(.a(new_n894_), .b(x46), .O(new_n895_));
  nand4  g765(.a(new_n895_), .b(new_n136_), .c(new_n138_), .d(new_n137_), .O(new_n896_));
