...
module FAU ( 
  ...
  nand4  g355(.a(new_n485_), .b(new_n143_), .c(new_n142_), .d(x29), .O(new_n486_));
  nor2   g356(.a(new_n486_), .b(x40), .O(new_n487_));
  nand4  g357(.a(new_n487_), .b(new_n138_), .c(new_n220_), .d(new_n141_), .O(new_n488_));
