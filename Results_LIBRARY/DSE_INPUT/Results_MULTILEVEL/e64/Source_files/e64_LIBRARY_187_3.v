...
module FAU ( 
  ...
  nand2  g231(.a(new_n344_), .b(x26), .O(new_n362_));
  nor2   g232(.a(new_n362_), .b(x28), .O(new_n363_));
  nand4  g233(.a(new_n363_), .b(new_n142_), .c(new_n185_), .d(x29), .O(new_n364_));
  nor2   g234(.a(new_n364_), .b(x39), .O(new_n365_));
  nand4  g235(.a(new_n365_), .b(new_n220_), .c(new_n141_), .d(new_n144_), .O(new_n366_));
  nor2   g236(.a(new_n366_), .b(x47), .O(new_n367_));
  nand4  g237(.a(new_n367_), .b(new_n132_), .c(new_n136_), .d(new_n138_), .O(new_n368_));
