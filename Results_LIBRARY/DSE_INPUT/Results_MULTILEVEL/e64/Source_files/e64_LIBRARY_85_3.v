...
module FAU ( 
  ...
  nor4   g533(.a(new_n663_), .b(x28), .c(x26), .d(x25), .O(new_n664_));
  nand3  g534(.a(new_n664_), .b(new_n185_), .c(x29), .O(new_n665_));
  ...
  nor3   g648(.a(new_n665_), .b(x33), .c(new_n145_), .O(new_n779_));
  nand4  g649(.a(new_n779_), .b(new_n142_), .c(new_n184_), .d(new_n147_), .O(new_n780_));
  nor2   g650(.a(new_n780_), .b(x39), .O(new_n781_));
  nand4  g651(.a(new_n781_), .b(new_n140_), .c(new_n183_), .d(new_n144_), .O(new_n782_));
  nor2   g652(.a(new_n782_), .b(x43), .O(new_n783_));
  nand4  g653(.a(new_n783_), .b(new_n138_), .c(new_n137_), .d(new_n220_), .O(new_n784_));
  nor2   g654(.a(new_n784_), .b(x51), .O(new_n785_));
  nand4  g655(.a(new_n785_), .b(new_n135_), .c(new_n134_), .d(new_n217_), .O(new_n786_));
