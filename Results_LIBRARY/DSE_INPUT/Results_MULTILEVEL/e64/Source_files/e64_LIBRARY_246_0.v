...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n141_, new_n142_,
    ...
    new_n302_, new_n324_, new_n325_, new_n328_, new_n329_, new_n330_,
  ...
  inv1   g100(.a(x06), .O(new_n238_));
  nor2   g101(.a(x03), .b(x00), .O(new_n239_));
  nand4  g102(.a(new_n239_), .b(new_n163_), .c(new_n162_), .d(new_n238_), .O(new_n240_));
  nor2   g103(.a(new_n240_), .b(x10), .O(new_n241_));
  ...
  nand4  g117(.a(new_n162_), .b(new_n238_), .c(new_n161_), .d(x00), .O(new_n255_));
  ...
  nor2   g160(.a(new_n250_), .b(x51), .O(new_n324_));
  nand4  g161(.a(new_n324_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n325_));
  nor2   g162(.a(new_n325_), .b(x62), .O(z55));
  nand4  g163(.a(new_n163_), .b(new_n162_), .c(new_n238_), .d(new_n161_), .O(new_n328_));
  nor2   g164(.a(new_n328_), .b(x10), .O(new_n329_));
  nand4  g165(.a(new_n329_), .b(new_n135_), .c(new_n159_), .d(new_n177_), .O(new_n330_));
  nor2   g166(.a(new_n330_), .b(new_n254_), .O(new_n331_));
  nand3  g167(.a(new_n331_), .b(new_n160_), .c(new_n237_), .O(new_n332_));
  nor2   g168(.a(new_n332_), .b(x25), .O(new_n333_));
  nand4  g169(.a(new_n333_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n334_));
  nor2   g170(.a(new_n334_), .b(x30), .O(new_n335_));
  nand4  g171(.a(new_n335_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n336_));
  nor2   g172(.a(new_n336_), .b(x41), .O(new_n337_));
  nand4  g173(.a(new_n337_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n338_));
  nor2   g174(.a(new_n338_), .b(x50), .O(new_n339_));
  nand4  g175(.a(new_n339_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n340_));
  nor2   g176(.a(new_n340_), .b(x62), .O(z57));
  nor4   g177(.a(new_n330_), .b(x25), .c(x24), .d(new_n237_), .O(new_n342_));
  nand4  g178(.a(new_n342_), .b(x29), .c(new_n138_), .d(new_n158_), .O(new_n343_));
  nor2   g179(.a(new_n343_), .b(x30), .O(new_n344_));
  nand4  g180(.a(new_n344_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n345_));
  nor2   g181(.a(new_n345_), .b(x41), .O(new_n346_));
  nand4  g182(.a(new_n346_), .b(new_n155_), .c(new_n154_), .d(new_n141_), .O(new_n347_));
  nor2   g183(.a(new_n347_), .b(x50), .O(new_n348_));
  nand4  g184(.a(new_n348_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n349_));
  nor2   g185(.a(new_n349_), .b(x62), .O(z58));
  nand4  g186(.a(new_n194_), .b(new_n191_), .c(new_n141_), .d(x40), .O(new_n351_));
  nor2   g187(.a(new_n351_), .b(x58), .O(z59));
  nand4  g188(.a(new_n177_), .b(new_n178_), .c(new_n163_), .d(x07), .O(new_n353_));
  nor2   g189(.a(new_n353_), .b(x14), .O(new_n354_));
  nand4  g190(.a(new_n354_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n355_));
  nor2   g191(.a(new_n355_), .b(x28), .O(new_n356_));
  nand4  g192(.a(new_n356_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n357_));
  nor2   g193(.a(new_n357_), .b(x39), .O(new_n358_));
  nand4  g194(.a(new_n358_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n359_));
  nor2   g195(.a(new_n359_), .b(x47), .O(new_n360_));
  nand4  g196(.a(new_n360_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n361_));
  nor2   g197(.a(new_n361_), .b(x60), .O(z60));
  nand4  g198(.a(new_n159_), .b(new_n177_), .c(new_n178_), .d(x08), .O(new_n363_));
  inv1   g199(.a(new_n363_), .O(new_n364_));
  nand4  g200(.a(new_n364_), .b(new_n210_), .c(new_n160_), .d(new_n135_), .O(new_n365_));
  nor2   g201(.a(new_n365_), .b(x28), .O(new_n366_));
  nand4  g202(.a(new_n366_), .b(new_n142_), .c(new_n201_), .d(x29), .O(new_n367_));
  nor2   g203(.a(new_n367_), .b(x39), .O(new_n368_));
  nand4  g204(.a(new_n368_), .b(new_n154_), .c(new_n141_), .d(new_n157_), .O(new_n369_));
  nor2   g205(.a(new_n369_), .b(x47), .O(new_n370_));
  nand4  g206(.a(new_n370_), .b(new_n152_), .c(new_n151_), .d(new_n191_), .O(new_n371_));
  nor2   g207(.a(new_n371_), .b(x60), .O(z61));
  nand4  g208(.a(new_n135_), .b(new_n159_), .c(new_n177_), .d(new_n178_), .O(new_n373_));
  nor2   g209(.a(new_n373_), .b(x24), .O(new_n374_));
  nand4  g210(.a(new_n374_), .b(x29), .c(new_n138_), .d(new_n210_), .O(new_n375_));
  nor3   g211(.a(new_n375_), .b(x37), .c(x30), .O(new_n376_));
  nand4  g212(.a(new_n376_), .b(new_n141_), .c(new_n157_), .d(new_n156_), .O(new_n377_));
  nor2   g213(.a(new_n377_), .b(x46), .O(new_n378_));
  nand4  g214(.a(new_n378_), .b(new_n151_), .c(new_n191_), .d(x47), .O(new_n379_));
  nor3   g215(.a(new_n379_), .b(x60), .c(x58), .O(z62));
  nand4  g216(.a(new_n378_), .b(new_n152_), .c(x56), .d(new_n191_), .O(new_n381_));
  nor2   g217(.a(new_n381_), .b(x60), .O(z63));
  nor2   g218(.a(new_n375_), .b(new_n201_), .O(new_n383_));
  nand4  g219(.a(new_n383_), .b(new_n157_), .c(new_n156_), .d(new_n142_), .O(new_n384_));
  nor2   g220(.a(new_n384_), .b(x43), .O(new_n385_));
  nand4  g221(.a(new_n385_), .b(new_n152_), .c(new_n191_), .d(new_n154_), .O(new_n386_));
  nor2   g222(.a(new_n386_), .b(x60), .O(z64));
  zero   g223(.O(z00));
  zero   g224(.O(z01));
  zero   g225(.O(z02));
  zero   g226(.O(z03));
