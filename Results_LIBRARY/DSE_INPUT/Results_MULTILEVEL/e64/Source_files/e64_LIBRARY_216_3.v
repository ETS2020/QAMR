...
module FAU ( 
  ...
  nand4  g677(.a(new_n395_), .b(new_n155_), .c(new_n154_), .d(x12), .O(new_n808_));
  nor2   g678(.a(new_n808_), .b(x17), .O(new_n809_));
  nand4  g679(.a(new_n809_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n810_));
  nor2   g680(.a(new_n810_), .b(x25), .O(new_n811_));
  nand4  g681(.a(new_n811_), .b(x29), .c(new_n149_), .d(new_n148_), .O(new_n812_));
  nor2   g682(.a(new_n812_), .b(x30), .O(new_n813_));
  nand4  g683(.a(new_n813_), .b(new_n147_), .c(new_n146_), .d(new_n145_), .O(new_n814_));
  nor2   g684(.a(new_n814_), .b(x35), .O(new_n815_));
  nand4  g685(.a(new_n815_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n816_));
  nor2   g686(.a(new_n816_), .b(x41), .O(new_n817_));
  nand4  g687(.a(new_n817_), .b(new_n219_), .c(new_n141_), .d(new_n140_), .O(new_n818_));
  nor2   g688(.a(new_n818_), .b(x46), .O(new_n819_));
  nand4  g689(.a(new_n819_), .b(new_n218_), .c(new_n394_), .d(new_n137_), .O(new_n820_));
  nor2   g690(.a(new_n820_), .b(x50), .O(new_n821_));
  nand4  g691(.a(new_n821_), .b(new_n134_), .c(new_n217_), .d(new_n139_), .O(new_n822_));
  nor2   g692(.a(new_n822_), .b(x55), .O(new_n823_));
  nand4  g693(.a(new_n823_), .b(new_n131_), .c(new_n215_), .d(new_n136_), .O(new_n824_));
