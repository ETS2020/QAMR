...
module FAU ( 
  ...
  nand4  g35(.a(new_n25_), .b(new_n42_), .c(new_n41_), .d(new_n24_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x12), .c(x03), .O(new_n56_));
  inv1   g37(.a(x07), .O(new_n57_));
  aoi21  g38(.a(new_n57_), .b(new_n20_), .c(new_n29_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z3));
