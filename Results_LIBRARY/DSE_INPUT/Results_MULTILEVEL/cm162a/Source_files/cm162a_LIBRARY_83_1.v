// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:39 2020
...
module FAU ( 
  ...
  aoi21  g06(.a(new_n25_), .b(new_n24_), .c(new_n21_), .O(new_n26_));
  and2   g07(.a(x04), .b(x02), .O(new_n27_));
  nor2   g08(.a(new_n27_), .b(new_n22_), .O(new_n28_));
  aoi21  g09(.a(new_n26_), .b(x02), .c(new_n28_), .O(new_n29_));
  inv1   g10(.a(x00), .O(new_n30_));
  nand2  g11(.a(new_n20_), .b(new_n30_), .O(new_n31_));
  nand3  g12(.a(new_n27_), .b(x10), .c(new_n22_), .O(new_n32_));
  nand3  g13(.a(new_n32_), .b(new_n31_), .c(x05), .O(new_n33_));
  inv1   g14(.a(new_n33_), .O(new_n34_));
  oai21  g15(.a(new_n29_), .b(new_n20_), .c(new_n34_), .O(z0));
  nand3  g16(.a(new_n26_), .b(x03), .c(x02), .O(new_n36_));
  nand3  g17(.a(new_n22_), .b(x04), .c(x02), .O(new_n37_));
  oai21  g18(.a(x03), .b(x01), .c(x05), .O(new_n38_));
  aoi21  g19(.a(new_n37_), .b(x10), .c(new_n38_), .O(new_n39_));
  nand2  g20(.a(new_n39_), .b(new_n36_), .O(z1));
  inv1   g21(.a(x11), .O(new_n41_));
  nand3  g22(.a(new_n41_), .b(new_n23_), .c(new_n22_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n25_), .c(new_n21_), .O(new_n43_));
  and2   g24(.a(new_n37_), .b(x11), .O(new_n44_));
  aoi21  g25(.a(new_n43_), .b(x02), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g33(.a(new_n52_), .b(new_n41_), .c(new_n23_), .d(new_n22_), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n25_), .c(new_n21_), .O(new_n54_));
  nor2   g35(.a(x11), .b(x08), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n27_), .c(new_n52_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n60_), .b(new_n59_), .c(x05), .O(new_n61_));
  inv1   g42(.a(new_n61_), .O(new_n62_));
  oai21  g43(.a(new_n57_), .b(new_n20_), .c(new_n62_), .O(z3));
