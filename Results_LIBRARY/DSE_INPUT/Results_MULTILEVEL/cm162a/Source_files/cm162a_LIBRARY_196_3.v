// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:58 2020
...
module FAU ( 
  ...
  nand3  g32(.a(new_n45_), .b(new_n51_), .c(new_n42_), .O(new_n52_));
  nand2  g33(.a(new_n52_), .b(new_n22_), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(x04), .c(x03), .d(x02), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  nor3   g36(.a(x11), .b(x10), .c(x08), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n25_), .c(new_n51_), .O(new_n57_));
  oai21  g38(.a(new_n57_), .b(new_n20_), .c(new_n55_), .O(new_n58_));
  nand3  g39(.a(new_n58_), .b(new_n54_), .c(x05), .O(z3));
