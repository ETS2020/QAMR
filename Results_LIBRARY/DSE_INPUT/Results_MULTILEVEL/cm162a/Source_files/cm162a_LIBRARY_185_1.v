// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:56 2020
...
module FAU ( 
  ...
  aoi21  g27(.a(new_n46_), .b(new_n20_), .c(new_n36_), .O(new_n47_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n20_), .c(new_n36_), .O(new_n56_));
