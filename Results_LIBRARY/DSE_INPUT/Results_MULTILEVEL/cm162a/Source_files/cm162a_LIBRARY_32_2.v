// Benchmark "FAU" written by ABC on Mon Jul 27 17:25:31 2020
...
module FAU ( 
  ...
  oai21  g23(.a(new_n22_), .b(new_n20_), .c(new_n42_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(x04), .c(x02), .O(new_n44_));
  inv1   g25(.a(x10), .O(new_n45_));
  nand2  g26(.a(new_n34_), .b(new_n45_), .O(new_n46_));
  oai21  g27(.a(new_n45_), .b(new_n20_), .c(new_n46_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(x11), .O(new_n48_));
  inv1   g29(.a(x06), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n29_), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n48_), .c(new_n44_), .O(z2));
  inv1   g32(.a(x11), .O(new_n52_));
  inv1   g33(.a(x12), .O(new_n53_));
  nand4  g34(.a(new_n53_), .b(new_n52_), .c(new_n45_), .d(new_n24_), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n22_), .c(new_n21_), .O(new_n55_));
  aoi21  g36(.a(new_n41_), .b(new_n25_), .c(new_n53_), .O(new_n56_));
