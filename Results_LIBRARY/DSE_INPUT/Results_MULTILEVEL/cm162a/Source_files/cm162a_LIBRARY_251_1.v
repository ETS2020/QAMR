// Benchmark "FAU" written by ABC on Mon Jul 27 17:26:07 2020
...
module FAU ( 
  ...
  nor2   g22(.a(x12), .b(x11), .O(new_n42_));
  aoi22  g23(.a(new_n42_), .b(new_n41_), .c(x13), .d(x09), .O(new_n43_));
  inv1   g24(.a(x11), .O(new_n44_));
  nand3  g25(.a(new_n41_), .b(x12), .c(new_n44_), .O(new_n45_));
  oai21  g26(.a(new_n43_), .b(new_n20_), .c(new_n45_), .O(new_n46_));
  nand3  g27(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  aoi21  g28(.a(new_n41_), .b(new_n25_), .c(new_n44_), .O(new_n48_));
  oai21  g29(.a(x06), .b(x03), .c(x05), .O(new_n49_));
  aoi21  g30(.a(new_n48_), .b(x03), .c(new_n49_), .O(new_n50_));
  nand2  g31(.a(new_n50_), .b(new_n47_), .O(z2));
  nor2   g32(.a(new_n43_), .b(new_n21_), .O(new_n52_));
  nand3  g33(.a(new_n52_), .b(x03), .c(x02), .O(new_n53_));
  nor2   g34(.a(x11), .b(x10), .O(new_n54_));
  nand3  g35(.a(new_n54_), .b(new_n25_), .c(new_n24_), .O(new_n55_));
  oai21  g36(.a(x07), .b(x03), .c(x05), .O(new_n56_));
  aoi21  g37(.a(new_n55_), .b(x12), .c(new_n56_), .O(new_n57_));
  nand2  g38(.a(new_n57_), .b(new_n53_), .O(z3));
