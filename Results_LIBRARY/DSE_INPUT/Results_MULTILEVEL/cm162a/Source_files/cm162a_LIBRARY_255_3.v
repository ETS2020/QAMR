...
module FAU ( 
  ...
  oai21  g29(.a(new_n48_), .b(new_n20_), .c(new_n45_), .O(new_n49_));
  nand3  g30(.a(new_n49_), .b(new_n44_), .c(x05), .O(z2));
  nor2   g31(.a(x12), .b(x11), .O(new_n51_));
  nand2  g32(.a(new_n51_), .b(new_n47_), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n22_), .c(new_n21_), .O(new_n53_));
  inv1   g34(.a(x12), .O(new_n54_));
  aoi21  g35(.a(new_n41_), .b(new_n25_), .c(new_n54_), .O(new_n55_));
