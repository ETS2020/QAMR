...
module FAU ( 
  ...
  nand3  g29(.a(new_n48_), .b(x11), .c(x03), .O(new_n49_));
  inv1   g30(.a(x06), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n29_), .O(new_n51_));
  nand3  g32(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(z2));
  nor2   g33(.a(x12), .b(x11), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(new_n47_), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n44_), .O(new_n55_));
  nand3  g36(.a(new_n55_), .b(x04), .c(x02), .O(new_n56_));
  aoi21  g37(.a(new_n47_), .b(new_n25_), .c(x11), .O(new_n57_));
  nor2   g38(.a(new_n42_), .b(new_n20_), .O(new_n58_));
  oai21  g39(.a(new_n58_), .b(new_n57_), .c(x12), .O(new_n59_));
  inv1   g40(.a(x07), .O(new_n60_));
  aoi21  g41(.a(new_n60_), .b(new_n20_), .c(new_n29_), .O(new_n61_));
  nand3  g42(.a(new_n61_), .b(new_n59_), .c(new_n56_), .O(z3));
