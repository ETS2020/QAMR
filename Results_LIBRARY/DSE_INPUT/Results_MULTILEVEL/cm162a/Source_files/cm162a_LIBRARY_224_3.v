...
module FAU ( 
  ...
  nand3  g31(.a(new_n45_), .b(new_n40_), .c(new_n44_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n22_), .c(new_n21_), .O(new_n52_));
  aoi21  g33(.a(new_n45_), .b(new_n25_), .c(new_n40_), .O(new_n53_));
  aoi21  g34(.a(new_n52_), .b(x02), .c(new_n53_), .O(new_n54_));
