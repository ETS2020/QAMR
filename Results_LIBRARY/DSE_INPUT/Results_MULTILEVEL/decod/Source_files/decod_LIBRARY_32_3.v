...
module FAU ( 
  ...
  inv1   g14(.a(x4), .O(new_n40_));
  inv1   g15(.a(x0), .O(new_n41_));
  inv1   g16(.a(x2), .O(new_n42_));
  nand4  g17(.a(x3), .b(new_n42_), .c(x1), .d(new_n41_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n40_), .O(z10));
  nand4  g19(.a(new_n26_), .b(new_n42_), .c(x1), .d(new_n41_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n40_), .O(z11));
  ...
  nand4  g25(.a(x3), .b(new_n42_), .c(new_n31_), .d(new_n41_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n40_), .O(z14));
  nand4  g27(.a(new_n26_), .b(new_n42_), .c(new_n31_), .d(new_n41_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n40_), .O(z15));
  zero   g29(.O(z00));
  zero   g30(.O(z01));
  zero   g31(.O(z04));
  zero   g32(.O(z05));
