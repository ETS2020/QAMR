...
module FAU ( 
  ...
  nand4  g18(.a(new_n24_), .b(new_n28_), .c(new_n33_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n27_), .O(z07));
  inv1   g20(.a(x0), .O(new_n44_));
  nand4  g21(.a(x4), .b(x3), .c(x1), .d(new_n44_), .O(new_n45_));
  inv1   g22(.a(new_n45_), .O(z10));
  nand4  g23(.a(x4), .b(new_n24_), .c(x1), .d(new_n44_), .O(new_n47_));
  inv1   g24(.a(new_n47_), .O(z11));
  nand4  g25(.a(x4), .b(x3), .c(new_n33_), .d(new_n44_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z14));
  nand4  g27(.a(x4), .b(new_n24_), .c(new_n33_), .d(new_n44_), .O(new_n53_));
