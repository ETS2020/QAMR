...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    ...
    new_n48_, new_n50_, new_n51_, new_n53_;
  ...
  nor2   g25(.a(x1), .b(x0), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(x4), .c(new_n25_), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(z13));
  nand3  g28(.a(new_n50_), .b(x4), .c(new_n28_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(z14));
  zero   g30(.O(z03));
  zero   g31(.O(z07));
  zero   g32(.O(z11));
  zero   g33(.O(z15));
