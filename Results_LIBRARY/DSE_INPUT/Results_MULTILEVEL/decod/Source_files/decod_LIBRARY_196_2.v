// Benchmark "FAU" written by ABC on Mon Jul 27 16:17:05 2020
...
module FAU ( 
  ...
  nor2   g15(.a(new_n36_), .b(new_n24_), .O(z05));
  nand4  g16(.a(x3), .b(new_n27_), .c(new_n33_), .d(x0), .O(new_n38_));
  inv1   g17(.a(new_n38_), .O(z06));
  nand4  g18(.a(new_n30_), .b(new_n27_), .c(new_n33_), .d(x0), .O(new_n40_));
  nor2   g19(.a(new_n40_), .b(new_n24_), .O(z07));
  inv1   g20(.a(x0), .O(new_n42_));
  nand4  g21(.a(x3), .b(x2), .c(x1), .d(new_n42_), .O(new_n43_));
  inv1   g22(.a(new_n43_), .O(z08));
  nand4  g23(.a(new_n30_), .b(x2), .c(x1), .d(new_n42_), .O(new_n45_));
  nor2   g24(.a(new_n45_), .b(new_n24_), .O(z09));
  nand4  g25(.a(x3), .b(new_n27_), .c(x1), .d(new_n42_), .O(new_n47_));
  inv1   g26(.a(new_n47_), .O(z10));
  nand4  g27(.a(new_n30_), .b(new_n27_), .c(x1), .d(new_n42_), .O(new_n49_));
  nor2   g28(.a(new_n49_), .b(new_n24_), .O(z11));
  nand4  g29(.a(x3), .b(x2), .c(new_n33_), .d(new_n42_), .O(new_n51_));
  inv1   g30(.a(new_n51_), .O(z12));
  nand4  g31(.a(new_n30_), .b(x2), .c(new_n33_), .d(new_n42_), .O(new_n53_));
  nor2   g32(.a(new_n53_), .b(new_n24_), .O(z13));
  nand4  g33(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n42_), .O(new_n55_));
  inv1   g34(.a(new_n55_), .O(z14));
  nand4  g35(.a(new_n30_), .b(new_n27_), .c(new_n33_), .d(new_n42_), .O(new_n57_));
  nor2   g36(.a(new_n57_), .b(new_n24_), .O(z15));
endmodule
