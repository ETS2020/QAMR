// Benchmark "FAU" written by ABC on Mon Jul 27 16:16:40 2020
...
module FAU ( 
  ...
  nor2   g13(.a(new_n36_), .b(new_n25_), .O(z06));
  ...
  nand4  g19(.a(x3), .b(new_n26_), .c(x1), .d(new_n40_), .O(new_n44_));
  ...
  nand4  g26(.a(x3), .b(new_n26_), .c(new_n32_), .d(new_n40_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n25_), .O(z14));
