// Benchmark "FAU" written by ABC on Mon Jul 27 16:16:43 2020
...
module FAU ( 
  ...
  nor2   g17(.a(new_n38_), .b(new_n26_), .O(z06));
  ...
  nor2   g26(.a(new_n47_), .b(new_n26_), .O(z10));
  ...
  inv1   g32(.a(new_n53_), .O(z13));
  nand4  g33(.a(x3), .b(new_n27_), .c(new_n33_), .d(new_n42_), .O(new_n55_));
  nor2   g34(.a(new_n55_), .b(new_n26_), .O(z14));
