// Benchmark "FAU" written by ABC on Mon Jul 27 16:17:02 2020
...
module FAU ( 
  ...
  nand4  g12(.a(x3), .b(new_n25_), .c(new_n30_), .d(x0), .O(new_n36_));
  nor2   g13(.a(new_n36_), .b(new_n29_), .O(z06));
  ...
  nand4  g25(.a(x3), .b(new_n25_), .c(new_n30_), .d(new_n40_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n29_), .O(z14));
  nand4  g27(.a(x4), .b(new_n33_), .c(new_n25_), .d(new_n40_), .O(new_n53_));
