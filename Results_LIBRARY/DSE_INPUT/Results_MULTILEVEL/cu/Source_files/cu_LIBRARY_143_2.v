...
module FAU ( 
  ...
  nand3  g20(.a(new_n47_), .b(x04), .c(new_n46_), .O(new_n48_));
  ...
  nand3  g25(.a(new_n52_), .b(x04), .c(new_n46_), .O(new_n53_));
  inv1   g26(.a(x10), .O(new_n54_));
  nand2  g27(.a(new_n54_), .b(x01), .O(new_n55_));
  aoi21  g28(.a(new_n55_), .b(new_n53_), .c(x00), .O(new_n56_));
  oai21  g29(.a(new_n56_), .b(new_n51_), .c(x13), .O(new_n57_));
  nor2   g30(.a(new_n57_), .b(x12), .O(new_n58_));
  nand4  g31(.a(new_n58_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n59_));
  inv1   g32(.a(x13), .O(new_n60_));
  nand4  g33(.a(new_n60_), .b(new_n28_), .c(x04), .d(x02), .O(new_n61_));
  aoi21  g34(.a(new_n61_), .b(new_n59_), .c(x03), .O(z06));
  nand4  g35(.a(new_n60_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n63_));
  nor2   g36(.a(new_n63_), .b(x02), .O(z07));
  inv1   g37(.a(x12), .O(new_n65_));
  nand4  g38(.a(x13), .b(new_n65_), .c(x05), .d(new_n31_), .O(new_n66_));
  nand3  g39(.a(new_n60_), .b(new_n28_), .c(x02), .O(new_n67_));
  nand2  g40(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g41(.a(new_n68_), .b(x04), .c(new_n26_), .O(new_n69_));
  inv1   g42(.a(new_n69_), .O(z08));
  and2   g43(.a(x13), .b(x06), .O(z09));
  nand3  g44(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n72_));
