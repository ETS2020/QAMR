...
module FAU ( 
  ...
  nand3  g39(.a(new_n64_), .b(x05), .c(new_n27_), .O(new_n65_));
  ...
  nand4  g44(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n72_));
