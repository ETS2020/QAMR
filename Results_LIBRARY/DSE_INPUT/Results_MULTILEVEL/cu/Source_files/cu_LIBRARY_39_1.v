...
module FAU ( 
  ...
  nand4  g15(.a(new_n31_), .b(new_n26_), .c(new_n40_), .d(x00), .O(new_n41_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n27_), .c(x01), .O(new_n57_));
  ...
  nand3  g37(.a(new_n62_), .b(new_n27_), .c(x01), .O(new_n63_));
  ...
  nand2  g46(.a(x02), .b(x01), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x03), .O(z07));
  nand4  g49(.a(x13), .b(new_n53_), .c(x05), .d(new_n27_), .O(new_n75_));
