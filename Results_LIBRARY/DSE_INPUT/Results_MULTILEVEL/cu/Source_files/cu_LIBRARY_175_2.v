...
module FAU ( 
  ...
  nand3  g38(.a(new_n63_), .b(new_n58_), .c(new_n46_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n57_), .c(new_n40_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n66_));
