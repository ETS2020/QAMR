// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:35 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n61_, new_n62_, new_n64_, new_n65_, new_n66_, new_n69_;
  ...
  nand4  g16(.a(new_n27_), .b(new_n26_), .c(new_n31_), .d(x01), .O(new_n42_));
  ...
  nand4  g35(.a(new_n61_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n62_));
  nor2   g36(.a(new_n62_), .b(x02), .O(z07));
  nand4  g37(.a(x13), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n64_));
