...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n63_, new_n65_, new_n66_, new_n67_, new_n70_;
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(x13), .O(z02));
  inv1   g14(.a(x01), .O(new_n40_));
  nand4  g15(.a(new_n27_), .b(new_n31_), .c(new_n40_), .d(x00), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x13), .c(new_n28_), .O(z03));
  inv1   g17(.a(x00), .O(new_n43_));
  nand4  g18(.a(new_n27_), .b(new_n31_), .c(x01), .d(new_n43_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x13), .c(new_n28_), .O(z04));
  nand4  g20(.a(new_n27_), .b(new_n31_), .c(x01), .d(x00), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(x13), .c(new_n28_), .O(z05));
  inv1   g22(.a(x07), .O(new_n48_));
  inv1   g23(.a(x12), .O(new_n49_));
  inv1   g24(.a(x13), .O(new_n50_));
  nor2   g25(.a(x09), .b(x01), .O(new_n51_));
  nor2   g26(.a(x11), .b(new_n40_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(x00), .O(new_n53_));
  nor2   g28(.a(x08), .b(x01), .O(new_n54_));
  nor2   g29(.a(x10), .b(new_n40_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n43_), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n53_), .c(new_n50_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n49_), .c(new_n48_), .d(x05), .O(new_n58_));
  nand3  g33(.a(new_n50_), .b(new_n28_), .c(x02), .O(new_n59_));
  ...
  nand4  g37(.a(new_n50_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z07));
  nand4  g39(.a(x13), .b(new_n49_), .c(x05), .d(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n59_), .O(new_n66_));
