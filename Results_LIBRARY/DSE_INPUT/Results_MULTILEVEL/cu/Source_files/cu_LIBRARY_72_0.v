// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:19 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n76_, new_n77_, new_n78_, new_n81_;
  ...
  nand3  g33(.a(new_n58_), .b(x05), .c(x01), .O(new_n59_));
  ...
  nand3  g41(.a(new_n66_), .b(x05), .c(new_n46_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n61_), .c(new_n40_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n55_), .c(new_n54_), .d(new_n31_), .O(new_n69_));
  nand3  g44(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nand4  g48(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n76_));
  ...
  nand3  g55(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n81_));
