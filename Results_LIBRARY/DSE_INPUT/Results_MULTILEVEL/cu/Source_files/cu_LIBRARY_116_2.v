...
module FAU ( 
  ...
  nand4  g21(.a(new_n50_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n51_));
  ...
  nand3  g28(.a(new_n58_), .b(x05), .c(new_n27_), .O(new_n59_));
  ...
  nand2  g33(.a(x05), .b(x02), .O(new_n64_));
  nand3  g34(.a(new_n64_), .b(x06), .c(new_n26_), .O(new_n65_));
  inv1   g35(.a(new_n65_), .O(z10));
  zero   g36(.O(z02));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
  zero   g39(.O(z05));
