...
module FAU ( 
  ...
  oai21  g37(.a(new_n62_), .b(new_n59_), .c(x13), .O(new_n63_));
  inv1   g38(.a(x08), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n41_), .c(new_n46_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(x12), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n67_));
  nand3  g42(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n26_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z06));
  nand4  g46(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  inv1   g48(.a(x12), .O(new_n74_));
  nand4  g49(.a(x13), .b(new_n74_), .c(x05), .d(new_n31_), .O(new_n75_));
