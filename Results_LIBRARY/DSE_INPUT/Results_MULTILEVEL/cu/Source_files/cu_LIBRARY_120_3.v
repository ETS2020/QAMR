...
module FAU ( 
  ...
  nand3  g35(.a(new_n60_), .b(new_n27_), .c(new_n44_), .O(new_n61_));
  ...
  nand2  g42(.a(x02), .b(new_n44_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x03), .O(z07));
  nand4  g45(.a(x13), .b(new_n52_), .c(x05), .d(new_n27_), .O(new_n71_));
