// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:18 2020
...
module FAU ( 
  ...
  oai21  g31(.a(new_n56_), .b(x01), .c(new_n46_), .O(new_n57_));
  inv1   g32(.a(x11), .O(new_n58_));
  nor2   g33(.a(x09), .b(x01), .O(new_n59_));
  aoi22  g34(.a(new_n59_), .b(x00), .c(new_n58_), .d(x01), .O(new_n60_));
