// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:34 2020
...
module FAU ( 
  ...
  nand3  g10(.a(new_n35_), .b(new_n31_), .c(new_n27_), .O(new_n36_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n55_), .d(new_n27_), .O(new_n64_));
  ...
  nand4  g43(.a(new_n34_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand3  g45(.a(x13), .b(new_n56_), .c(new_n27_), .O(new_n71_));
