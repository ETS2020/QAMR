...
module FAU ( 
  ...
  nand3  g33(.a(new_n58_), .b(new_n57_), .c(x01), .O(new_n59_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n58_), .c(new_n46_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n61_), .c(new_n40_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n69_));
  ...
  nand4  g50(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n76_));
