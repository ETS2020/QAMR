...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n38_));
  nor2   g13(.a(new_n38_), .b(x13), .O(z02));
  inv1   g14(.a(x13), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  nand4  g16(.a(new_n26_), .b(new_n28_), .c(new_n41_), .d(x00), .O(new_n42_));
  ...
  nand4  g21(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand4  g42(.a(new_n40_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n68_));
  ...
  oai21  g49(.a(new_n30_), .b(x02), .c(new_n31_), .O(new_n75_));
  nand2  g50(.a(x06), .b(new_n28_), .O(new_n76_));
