...
module FAU ( 
  ...
  nand3  g33(.a(new_n58_), .b(new_n26_), .c(x00), .O(new_n59_));
  ...
  nand4  g38(.a(new_n63_), .b(x13), .c(new_n53_), .d(new_n52_), .O(new_n64_));
  inv1   g39(.a(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x05), .c(new_n31_), .O(new_n66_));
  nand4  g41(.a(new_n40_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n27_), .O(z06));
  nand2  g43(.a(x03), .b(x00), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n40_), .c(x05), .d(new_n27_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n72_));
  nand3  g47(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n73_));
