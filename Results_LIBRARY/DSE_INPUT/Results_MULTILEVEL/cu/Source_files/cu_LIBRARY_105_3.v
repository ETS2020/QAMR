...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n38_, new_n41_, new_n44_, new_n45_,
  ...
  nand4  g14(.a(new_n27_), .b(new_n26_), .c(new_n31_), .d(x01), .O(new_n41_));
  nor3   g15(.a(new_n41_), .b(x13), .c(new_n28_), .O(z04));
  inv1   g16(.a(x07), .O(new_n44_));
  inv1   g17(.a(x12), .O(new_n45_));
  inv1   g18(.a(x13), .O(new_n46_));
  inv1   g19(.a(x01), .O(new_n47_));
  inv1   g20(.a(x08), .O(new_n48_));
  nand2  g21(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  inv1   g22(.a(x10), .O(new_n50_));
