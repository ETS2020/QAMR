...
module FAU ( 
  ...
  nand2  g39(.a(x02), .b(new_n41_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n40_), .c(x05), .d(new_n31_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x03), .O(z07));
  nand4  g42(.a(x13), .b(new_n52_), .c(x05), .d(new_n27_), .O(new_n68_));
