// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:36 2020
...
module FAU ( 
  ...
  aoi21  g32(.a(new_n57_), .b(new_n54_), .c(new_n35_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n51_), .c(new_n50_), .d(x04), .O(new_n59_));
  nor3   g34(.a(new_n59_), .b(x03), .c(x02), .O(z06));
  nand4  g35(.a(new_n35_), .b(x05), .c(new_n26_), .d(new_n31_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(x02), .O(z07));
  nand3  g37(.a(new_n27_), .b(new_n51_), .c(x04), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n35_), .O(z08));
  and2   g39(.a(x13), .b(x06), .O(z09));
  nand2  g40(.a(x05), .b(x02), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x06), .c(new_n31_), .O(new_n67_));
