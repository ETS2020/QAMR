...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n63_, new_n65_, new_n66_, new_n69_;
  ...
  nand4  g33(.a(new_n58_), .b(x05), .c(new_n26_), .d(new_n31_), .O(new_n59_));
  inv1   g34(.a(x13), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n28_), .c(x02), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n27_), .O(z06));
  nand4  g37(.a(new_n60_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z07));
  nor2   g39(.a(x03), .b(x02), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n49_), .d(x05), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n61_), .c(new_n27_), .O(z08));
  and2   g42(.a(x13), .b(x06), .O(z09));
  nand3  g43(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n69_));
