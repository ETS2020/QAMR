...
module FAU ( 
  ...
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n62_));
  ...
  nand4  g41(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n69_));
