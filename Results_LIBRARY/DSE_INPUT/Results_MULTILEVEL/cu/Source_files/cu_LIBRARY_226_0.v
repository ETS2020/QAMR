...
module FAU ( 
  ...
  nand3  g32(.a(x13), .b(new_n57_), .c(x01), .O(new_n58_));
  ...
  nand3  g40(.a(new_n65_), .b(x13), .c(new_n46_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n60_), .c(x12), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n68_));
  ...
  nand4  g50(.a(x13), .b(new_n75_), .c(x05), .d(new_n31_), .O(new_n76_));
