...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n40_), .c(x05), .d(new_n31_), .O(new_n49_));
  ...
  nand3  g33(.a(new_n58_), .b(x04), .c(x01), .O(new_n59_));
  ...
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n46_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x13), .c(new_n55_), .d(new_n54_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x05), .c(new_n27_), .O(new_n71_));
  nand4  g46(.a(new_n40_), .b(new_n28_), .c(x04), .d(x02), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n71_), .c(x03), .O(z06));
  nand4  g48(.a(new_n40_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n76_));
  nand3  g51(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n77_));
