...
module FAU ( 
  ...
  nand3  g35(.a(new_n60_), .b(new_n26_), .c(new_n44_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n52_), .d(new_n51_), .O(new_n63_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n27_), .O(z06));
  nand2  g42(.a(x03), .b(new_n44_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n52_), .c(x05), .d(new_n31_), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(new_n28_), .c(x02), .O(new_n72_));
