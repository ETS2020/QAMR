...
module FAU ( 
  ...
  nand4  g10(.a(new_n35_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n36_));
  nand4  g11(.a(new_n35_), .b(new_n28_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand4  g19(.a(new_n44_), .b(new_n34_), .c(x05), .d(new_n27_), .O(new_n45_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n68_));
  nand4  g43(.a(new_n34_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n68_), .c(new_n27_), .O(z06));
  nand4  g45(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  inv1   g47(.a(x12), .O(new_n73_));
  nand4  g48(.a(x13), .b(new_n73_), .c(x05), .d(new_n31_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n69_), .c(new_n27_), .O(z08));
