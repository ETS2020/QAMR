...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n26_), .d(new_n31_), .O(new_n38_));
  ...
  nand2  g38(.a(x04), .b(x01), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n67_));
