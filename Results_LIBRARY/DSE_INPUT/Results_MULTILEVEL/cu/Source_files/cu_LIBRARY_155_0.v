// Benchmark "FAU" written by ABC on Mon Jul 27 17:55:33 2020
...
module FAU ( 
  ...
  aoi21  g34(.a(new_n59_), .b(new_n57_), .c(new_n40_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n61_));
  nand3  g36(.a(new_n40_), .b(new_n28_), .c(x02), .O(new_n62_));
  ...
  nand4  g40(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n66_));
  nor2   g41(.a(new_n66_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n68_));
  ...
  nand3  g47(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n73_));
