...
module FAU ( 
  ...
  nand3  g08(.a(x05), .b(new_n29_), .c(new_n27_), .O(new_n34_));
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n29_), .d(new_n26_), .O(new_n38_));
  ...
  nand3  g38(.a(new_n40_), .b(new_n30_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n40_), .b(x05), .c(new_n29_), .d(new_n26_), .O(new_n68_));
