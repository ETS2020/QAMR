// Benchmark "FAU" written by ABC on Mon Jul 27 17:30:23 2020
...
module FAU ( 
  ...
  nand2  g099(.a(x6), .b(new_n21_), .O(new_n117_));
  aoi21  g100(.a(new_n117_), .b(new_n49_), .c(new_n34_), .O(new_n118_));
  oai21  g101(.a(x3), .b(new_n34_), .c(x6), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n33_), .O(new_n120_));
  oai21  g103(.a(new_n120_), .b(new_n118_), .c(x5), .O(new_n121_));
  nor2   g104(.a(new_n121_), .b(new_n22_), .O(z9));
endmodule
