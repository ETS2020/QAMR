...
module FAU ( 
  ...
  nor4   g222(.a(new_n352_), .b(x58), .c(x43), .d(new_n153_), .O(z15));
  ...
  nand4  g233(.a(new_n363_), .b(new_n358_), .c(new_n356_), .d(new_n343_), .O(new_n364_));
  inv1   g234(.a(new_n364_), .O(z16));
  nand2  g235(.a(new_n338_), .b(new_n175_), .O(new_n366_));
  ...
  nand3  g305(.a(new_n392_), .b(new_n297_), .c(x36), .O(new_n436_));
  ...
  nand3  g314(.a(new_n392_), .b(new_n297_), .c(new_n444_), .O(new_n445_));
  ...
  nand2  g348(.a(new_n377_), .b(new_n328_), .O(new_n479_));
  ...
  nand2  g353(.a(new_n377_), .b(new_n290_), .O(new_n484_));
  ...
  nand4  g362(.a(new_n377_), .b(new_n262_), .c(new_n149_), .d(new_n148_), .O(new_n493_));
  ...
  nand4  g376(.a(new_n506_), .b(new_n181_), .c(new_n314_), .d(x39), .O(new_n507_));
  ...
  nand3  g399(.a(new_n443_), .b(new_n250_), .c(new_n160_), .O(new_n530_));
  ...
  nor2   g450(.a(new_n387_), .b(new_n310_), .O(new_n581_));
  ...
  nand3  g480(.a(new_n376_), .b(new_n297_), .c(new_n610_), .O(new_n611_));
  ...
  nand4  g507(.a(new_n637_), .b(new_n525_), .c(new_n414_), .d(new_n412_), .O(new_n638_));
  inv1   g508(.a(new_n638_), .O(z54));
  nor2   g509(.a(x37), .b(new_n610_), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n546_), .c(new_n422_), .d(new_n327_), .O(new_n641_));
  ...
  nand4  g516(.a(new_n375_), .b(new_n340_), .c(new_n203_), .d(new_n165_), .O(new_n647_));
  nand3  g517(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n648_));
  nor4   g518(.a(new_n648_), .b(new_n647_), .c(new_n331_), .d(new_n155_), .O(z57));
  inv1   g519(.a(new_n362_), .O(new_n650_));
  nand3  g520(.a(new_n422_), .b(new_n650_), .c(new_n545_), .O(new_n651_));
  nand3  g521(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n652_));
  nor4   g522(.a(new_n652_), .b(new_n651_), .c(new_n647_), .d(new_n423_), .O(z58));
  nor4   g523(.a(new_n482_), .b(new_n350_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand4  g530(.a(new_n660_), .b(new_n369_), .c(new_n338_), .d(new_n175_), .O(new_n661_));
  nand3  g531(.a(new_n359_), .b(new_n361_), .c(new_n348_), .O(new_n662_));
  ...
  nand4  g538(.a(new_n668_), .b(new_n666_), .c(new_n480_), .d(new_n376_), .O(new_n669_));
  ...
  nand4  g542(.a(new_n672_), .b(new_n666_), .c(new_n480_), .d(new_n376_), .O(new_n673_));
  inv1   g543(.a(new_n673_), .O(z63));
  nor2   g544(.a(new_n482_), .b(x60), .O(new_n675_));
  nand4  g545(.a(new_n675_), .b(new_n480_), .c(new_n289_), .d(x30), .O(new_n676_));
