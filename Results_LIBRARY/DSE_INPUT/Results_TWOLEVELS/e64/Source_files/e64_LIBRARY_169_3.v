...
module FAU ( 
  ...
  nand3  g382(.a(new_n196_), .b(new_n290_), .c(new_n422_), .O(new_n513_));
  nor2   g383(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand3  g384(.a(new_n514_), .b(new_n361_), .c(new_n144_), .O(new_n515_));
  ...
  nand3  g422(.a(new_n133_), .b(new_n132_), .c(new_n552_), .O(new_n553_));
  inv1   g423(.a(new_n553_), .O(new_n554_));
  nor2   g424(.a(x43), .b(new_n315_), .O(new_n555_));
  nand4  g425(.a(new_n555_), .b(new_n554_), .c(new_n458_), .d(new_n194_), .O(new_n556_));
  ...
  nand2  g431(.a(new_n135_), .b(new_n552_), .O(new_n562_));
  nor3   g432(.a(new_n562_), .b(new_n561_), .c(new_n482_), .O(new_n563_));
  nand4  g433(.a(new_n563_), .b(new_n560_), .c(new_n559_), .d(new_n539_), .O(new_n564_));
  nand4  g434(.a(new_n146_), .b(new_n133_), .c(new_n132_), .d(x54), .O(new_n565_));
  nor2   g435(.a(new_n565_), .b(new_n564_), .O(z40));
  nand3  g436(.a(new_n560_), .b(new_n559_), .c(new_n539_), .O(new_n567_));
  ...
  nand4  g440(.a(new_n570_), .b(new_n554_), .c(new_n330_), .d(new_n146_), .O(new_n571_));
  ...
  nand4  g470(.a(new_n554_), .b(new_n600_), .c(new_n330_), .d(new_n146_), .O(new_n601_));
