...
module FAU ( 
  ...
  nand4  g485(.a(new_n255_), .b(new_n149_), .c(new_n469_), .d(x31), .O(new_n616_));
  nand3  g486(.a(new_n589_), .b(new_n482_), .c(new_n301_), .O(new_n617_));
  nor3   g487(.a(new_n617_), .b(new_n616_), .c(new_n565_), .O(z48));
  ...
  nand4  g493(.a(new_n580_), .b(new_n189_), .c(new_n575_), .d(x48), .O(new_n624_));
  ...
  nor3   g497(.a(new_n602_), .b(x14), .c(new_n202_), .O(new_n628_));
  ...
  nor2   g508(.a(x37), .b(new_n611_), .O(new_n639_));
