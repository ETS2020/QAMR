// Benchmark "FAU" written by ABC on Thu Jun 25 18:55:01 2020
...
module FAU ( 
  ...
  nand3  g430(.a(new_n133_), .b(new_n132_), .c(x54), .O(new_n561_));
  nor2   g431(.a(new_n561_), .b(new_n526_), .O(new_n562_));
  nand4  g432(.a(new_n562_), .b(new_n446_), .c(new_n160_), .d(new_n146_), .O(new_n563_));
  nor2   g433(.a(new_n563_), .b(new_n560_), .O(z40));
  nand3  g434(.a(new_n558_), .b(new_n557_), .c(new_n540_), .O(new_n565_));
  ...
  nand4  g441(.a(new_n571_), .b(new_n568_), .c(new_n331_), .d(new_n146_), .O(new_n572_));
  ...
  nand3  g491(.a(new_n135_), .b(new_n131_), .c(x53), .O(new_n622_));
  nor2   g492(.a(new_n622_), .b(new_n570_), .O(new_n623_));
  nand4  g493(.a(new_n623_), .b(new_n483_), .c(new_n255_), .d(new_n146_), .O(new_n624_));
