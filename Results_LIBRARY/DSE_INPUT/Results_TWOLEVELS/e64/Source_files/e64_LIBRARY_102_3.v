...
module FAU ( 
  ...
  nand2  g328(.a(new_n458_), .b(new_n361_), .O(new_n459_));
  nor4   g329(.a(new_n459_), .b(new_n457_), .c(new_n381_), .d(new_n357_), .O(z24));
  ...
  nand3  g354(.a(new_n190_), .b(new_n181_), .c(new_n348_), .O(new_n485_));
  nor3   g355(.a(new_n485_), .b(new_n484_), .c(new_n461_), .O(z28));
  nand2  g356(.a(new_n379_), .b(new_n290_), .O(new_n487_));
  or2    g357(.a(new_n487_), .b(new_n350_), .O(new_n488_));
  nand3  g358(.a(new_n458_), .b(x60), .c(new_n181_), .O(new_n489_));
  ...
  nand4  g525(.a(new_n181_), .b(new_n348_), .c(new_n290_), .d(x40), .O(new_n656_));
  nor2   g526(.a(new_n656_), .b(new_n350_), .O(z59));
  nor3   g527(.a(new_n376_), .b(x08), .c(new_n210_), .O(new_n658_));
  nor2   g528(.a(new_n383_), .b(x60), .O(new_n659_));
  nand4  g529(.a(new_n659_), .b(new_n658_), .c(new_n382_), .d(new_n330_), .O(new_n660_));
  ...
  inv1   g537(.a(new_n381_), .O(new_n668_));
  nand4  g538(.a(new_n668_), .b(new_n378_), .c(new_n377_), .d(new_n297_), .O(new_n669_));
  nand4  g539(.a(new_n659_), .b(new_n328_), .c(new_n348_), .d(x47), .O(new_n670_));
  nor2   g540(.a(new_n670_), .b(new_n669_), .O(z62));
  nor2   g541(.a(x58), .b(new_n363_), .O(new_n672_));
  nand4  g542(.a(new_n672_), .b(new_n458_), .c(new_n356_), .d(new_n190_), .O(new_n673_));
  nor2   g543(.a(new_n673_), .b(new_n669_), .O(z63));
  nand3  g544(.a(new_n483_), .b(new_n289_), .c(x30), .O(new_n675_));
  nor4   g545(.a(new_n675_), .b(new_n485_), .c(new_n381_), .d(new_n376_), .O(z64));
