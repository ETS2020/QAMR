// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:44 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n45_, new_n47_, new_n49_, new_n50_, new_n52_, new_n55_;
  ...
  nand2  g23(.a(x04), .b(x02), .O(new_n49_));
  nand3  g24(.a(new_n37_), .b(new_n28_), .c(new_n26_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n49_), .O(z06));
  nand2  g26(.a(new_n27_), .b(new_n31_), .O(new_n52_));
  nor2   g27(.a(new_n38_), .b(new_n52_), .O(z07));
  and2   g28(.a(x13), .b(x06), .O(z09));
  nand3  g29(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z10));
  nor2   g31(.a(new_n50_), .b(new_n49_), .O(z08));
endmodule
