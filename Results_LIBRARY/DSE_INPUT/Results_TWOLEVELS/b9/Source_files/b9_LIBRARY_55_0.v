// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:48 2020
...
module FAU ( 
  ...
  nor2   g068(.a(new_n130_), .b(x04), .O(new_n131_));
  nand2  g069(.a(x36), .b(x35), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x28), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n131_), .c(x40), .d(new_n129_), .O(new_n134_));
  inv1   g072(.a(x18), .O(new_n135_));
  inv1   g073(.a(x19), .O(new_n136_));
  nand2  g074(.a(new_n88_), .b(new_n86_), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(x20), .c(new_n136_), .d(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  nand4  g078(.a(new_n78_), .b(z08), .c(new_n129_), .d(new_n64_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n140_), .O(z13));
  inv1   g080(.a(x20), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x19), .c(x28), .O(new_n144_));
  nand2  g082(.a(new_n136_), .b(x18), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  oai21  g084(.a(new_n137_), .b(x19), .c(x27), .O(new_n147_));
  aoi21  g085(.a(new_n146_), .b(new_n132_), .c(new_n147_), .O(new_n148_));
  inv1   g086(.a(new_n137_), .O(new_n149_));
  nand3  g087(.a(z08), .b(new_n129_), .c(new_n64_), .O(new_n150_));
  nand4  g088(.a(x27), .b(x20), .c(new_n136_), .d(new_n135_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n150_), .O(new_n152_));
  oai21  g090(.a(new_n148_), .b(new_n78_), .c(new_n152_), .O(z14));
  ...
  nand3  g100(.a(new_n162_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g101(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n164_));
  oai21  g102(.a(new_n74_), .b(x27), .c(x35), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n117_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n124_), .O(z20));
