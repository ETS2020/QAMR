// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:59 2020
...
module FAU ( 
  ...
  oai22  g023(.a(new_n85_), .b(x02), .c(z08), .d(x20), .O(new_n86_));
  aoi21  g024(.a(new_n77_), .b(x04), .c(new_n86_), .O(new_n87_));
  nor2   g025(.a(new_n66_), .b(new_n74_), .O(new_n88_));
  nor2   g026(.a(x19), .b(x18), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(new_n88_), .c(x20), .O(new_n90_));
  inv1   g028(.a(x40), .O(new_n91_));
  inv1   g029(.a(new_n66_), .O(new_n92_));
  nand2  g030(.a(new_n89_), .b(new_n92_), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(z02));
  ...
  oai22  g077(.a(new_n139_), .b(new_n88_), .c(new_n138_), .d(x10), .O(z12));
  ...
  nand3  g082(.a(new_n89_), .b(new_n92_), .c(x20), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand3  g085(.a(new_n124_), .b(new_n141_), .c(new_n64_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n147_), .O(z13));
  oai22  g087(.a(new_n91_), .b(x35), .c(x36), .d(x20), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n151_));
  nand2  g089(.a(new_n123_), .b(new_n74_), .O(new_n152_));
  inv1   g090(.a(x20), .O(new_n153_));
  nand2  g091(.a(new_n141_), .b(new_n64_), .O(new_n154_));
  aoi22  g092(.a(new_n154_), .b(x40), .c(new_n68_), .d(new_n153_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n152_), .c(new_n151_), .d(new_n94_), .O(z14));
