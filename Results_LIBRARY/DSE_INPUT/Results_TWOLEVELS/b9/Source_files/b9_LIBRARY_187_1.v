...
module FAU ( 
  ...
  oai21  g022(.a(new_n81_), .b(new_n64_), .c(new_n84_), .O(z02));
  oai21  g023(.a(new_n80_), .b(new_n74_), .c(x27), .O(new_n86_));
  ...
  oai21  g054(.a(new_n72_), .b(new_n64_), .c(new_n81_), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nor2   g056(.a(x30), .b(x09), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(new_n120_));
  aoi21  g058(.a(new_n118_), .b(x08), .c(new_n120_), .O(z11));
  aoi21  g059(.a(new_n63_), .b(new_n87_), .c(new_n72_), .O(new_n122_));
  inv1   g060(.a(new_n66_), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(x27), .O(new_n124_));
  oai21  g062(.a(new_n82_), .b(x04), .c(new_n124_), .O(new_n125_));
  oai21  g063(.a(new_n122_), .b(x10), .c(new_n125_), .O(z12));
  nand2  g064(.a(x36), .b(x35), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x28), .O(new_n128_));
  inv1   g066(.a(x40), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(x13), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(x39), .d(new_n64_), .O(new_n131_));
  ...
  nand2  g073(.a(new_n135_), .b(new_n123_), .O(new_n136_));
  ...
  nand4  g081(.a(new_n127_), .b(new_n143_), .c(new_n142_), .d(x28), .O(new_n144_));
  ...
  nand3  g085(.a(new_n87_), .b(new_n80_), .c(x28), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n77_), .O(new_n150_));
  nand2  g088(.a(new_n146_), .b(new_n124_), .O(new_n151_));
  ...
  nand3  g097(.a(z08), .b(x29), .c(x08), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g099(.a(new_n74_), .b(x27), .c(x35), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n116_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(x08), .c(new_n120_), .O(z20));
  aoi21  g102(.a(new_n118_), .b(x08), .c(new_n120_), .O(z19));
endmodule
