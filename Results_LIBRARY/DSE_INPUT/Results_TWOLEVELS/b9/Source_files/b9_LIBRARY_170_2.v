...
module FAU ( 
  ...
  oai21  g069(.a(new_n73_), .b(new_n86_), .c(x28), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(new_n131_), .c(x40), .d(new_n129_), .O(new_n133_));
  nand2  g071(.a(new_n88_), .b(new_n74_), .O(new_n134_));
  ...
  nand4  g076(.a(new_n78_), .b(z08), .c(new_n129_), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(z13));
  nand2  g078(.a(x20), .b(x13), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n64_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n72_), .O(new_n143_));
  nand2  g081(.a(new_n134_), .b(x27), .O(new_n144_));
  oai21  g082(.a(x35), .b(new_n74_), .c(x27), .O(new_n145_));
  aoi22  g083(.a(new_n145_), .b(new_n77_), .c(new_n144_), .d(new_n82_), .O(new_n146_));
  nand2  g084(.a(new_n135_), .b(x20), .O(new_n147_));
  inv1   g085(.a(x30), .O(new_n148_));
  inv1   g086(.a(x32), .O(new_n149_));
  nand4  g087(.a(new_n73_), .b(new_n149_), .c(new_n148_), .d(x28), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(z08), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand3  g090(.a(new_n135_), .b(new_n134_), .c(x20), .O(new_n153_));
  oai21  g091(.a(x13), .b(x04), .c(new_n153_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(new_n146_), .d(new_n143_), .O(z14));
  ...
  oai21  g103(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n166_));
