...
module FAU ( 
  ...
  oai21  g14(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(new_n77_));
  nand2  g15(.a(new_n77_), .b(x04), .O(z01));
  nor2   g16(.a(x27), .b(x08), .O(new_n79_));
  nand2  g17(.a(x35), .b(new_n72_), .O(new_n80_));
  oai21  g18(.a(new_n80_), .b(new_n79_), .c(x04), .O(new_n81_));
  ...
  oai21  g23(.a(new_n73_), .b(new_n72_), .c(x27), .O(new_n86_));
  ...
  inv1   g50(.a(x36), .O(new_n113_));
  aoi21  g51(.a(new_n80_), .b(new_n113_), .c(new_n87_), .O(new_n114_));
  nor3   g52(.a(new_n76_), .b(new_n82_), .c(new_n110_), .O(new_n115_));
  aoi21  g53(.a(new_n114_), .b(new_n112_), .c(new_n115_), .O(new_n116_));
  nand3  g54(.a(x37), .b(x27), .c(x06), .O(new_n117_));
  oai21  g55(.a(new_n116_), .b(x04), .c(new_n117_), .O(z10));
  nand2  g56(.a(z08), .b(x29), .O(new_n119_));
  nor2   g57(.a(new_n87_), .b(new_n64_), .O(new_n120_));
  oai21  g58(.a(new_n120_), .b(new_n80_), .c(new_n119_), .O(new_n121_));
  inv1   g59(.a(x08), .O(new_n122_));
  nand4  g60(.a(x35), .b(new_n72_), .c(x27), .d(new_n64_), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nor2   g62(.a(x30), .b(x09), .O(new_n125_));
  inv1   g63(.a(new_n125_), .O(new_n126_));
  aoi21  g64(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(z11));
  aoi21  g65(.a(new_n63_), .b(new_n88_), .c(new_n87_), .O(new_n128_));
  oai22  g66(.a(new_n82_), .b(x04), .c(new_n66_), .d(new_n87_), .O(new_n129_));
  oai21  g67(.a(new_n128_), .b(x10), .c(new_n129_), .O(z12));
  oai21  g68(.a(x32), .b(x30), .c(z08), .O(new_n131_));
  inv1   g69(.a(x13), .O(new_n132_));
  nand2  g70(.a(new_n132_), .b(new_n64_), .O(new_n133_));
  nor2   g71(.a(x19), .b(x18), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(x20), .O(new_n135_));
  nand3  g73(.a(x40), .b(x39), .c(new_n72_), .O(new_n136_));
  oai22  g74(.a(new_n136_), .b(new_n133_), .c(new_n135_), .d(new_n66_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(x27), .O(new_n138_));
  oai21  g76(.a(new_n133_), .b(new_n131_), .c(new_n138_), .O(z13));
  nor2   g77(.a(x37), .b(x35), .O(new_n140_));
  nand2  g78(.a(new_n76_), .b(x28), .O(new_n141_));
  inv1   g79(.a(new_n141_), .O(new_n142_));
  nand3  g80(.a(z08), .b(new_n132_), .c(new_n64_), .O(new_n143_));
  oai22  g81(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(new_n135_), .O(new_n144_));
  oai21  g82(.a(x37), .b(x28), .c(x27), .O(new_n145_));
  aoi22  g83(.a(new_n145_), .b(new_n143_), .c(new_n76_), .d(new_n87_), .O(new_n146_));
  ...
  oai21  g92(.a(new_n80_), .b(x27), .c(new_n119_), .O(new_n155_));
  nand2  g93(.a(new_n155_), .b(x08), .O(new_n156_));
  nand3  g94(.a(new_n156_), .b(new_n125_), .c(new_n123_), .O(z18));
  oai21  g95(.a(new_n73_), .b(new_n87_), .c(new_n122_), .O(new_n158_));
  oai21  g96(.a(new_n72_), .b(x27), .c(x35), .O(new_n159_));
  nand2  g97(.a(new_n159_), .b(new_n119_), .O(new_n160_));
  aoi21  g98(.a(new_n160_), .b(new_n158_), .c(new_n126_), .O(z20));
  aoi21  g99(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(z19));
endmodule
