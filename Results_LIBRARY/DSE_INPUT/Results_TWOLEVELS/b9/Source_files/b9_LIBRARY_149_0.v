...
module FAU ( 
  ...
  nor3   g019(.a(new_n81_), .b(new_n80_), .c(x28), .O(new_n82_));
  nand2  g020(.a(x40), .b(x39), .O(new_n83_));
  aoi21  g021(.a(x29), .b(x08), .c(x02), .O(new_n84_));
  nor2   g022(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g023(.a(new_n82_), .b(new_n64_), .c(new_n85_), .O(z02));
  oai21  g024(.a(new_n80_), .b(new_n74_), .c(x27), .O(new_n87_));
  ...
  nand3  g059(.a(new_n121_), .b(x27), .c(new_n64_), .O(new_n122_));
  ...
  nand3  g090(.a(new_n88_), .b(new_n80_), .c(x28), .O(new_n153_));
  ...
  oai21  g105(.a(new_n80_), .b(new_n72_), .c(new_n120_), .O(new_n168_));
  ...
  aoi21  g109(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
