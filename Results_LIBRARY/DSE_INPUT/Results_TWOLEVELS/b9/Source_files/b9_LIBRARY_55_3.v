...
module FAU ( 
  ...
  nand3  g086(.a(new_n88_), .b(new_n148_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n77_), .O(new_n151_));
  nand2  g089(.a(x27), .b(new_n133_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n66_), .c(new_n146_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n148_), .b(new_n72_), .c(new_n120_), .O(new_n165_));
