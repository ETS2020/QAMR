...
module FAU ( 
  ...
  nor2   g16(.a(new_n78_), .b(x28), .O(new_n79_));
  oai21  g17(.a(x27), .b(x08), .c(new_n79_), .O(new_n80_));
  ...
  oai21  g23(.a(new_n78_), .b(new_n85_), .c(x27), .O(new_n86_));
  ...
  aoi21  g46(.a(x35), .b(new_n85_), .c(x36), .O(new_n109_));
  ...
  oai21  g56(.a(new_n87_), .b(new_n64_), .c(new_n79_), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  inv1   g58(.a(x08), .O(new_n121_));
  nand3  g59(.a(new_n79_), .b(x27), .c(new_n64_), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nor2   g61(.a(x30), .b(x09), .O(new_n124_));
  inv1   g62(.a(new_n124_), .O(new_n125_));
  aoi21  g63(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z11));
  nor3   g64(.a(x37), .b(x36), .c(x35), .O(new_n127_));
  oai21  g65(.a(new_n127_), .b(new_n87_), .c(new_n70_), .O(new_n128_));
  oai22  g66(.a(new_n68_), .b(x04), .c(new_n66_), .d(new_n87_), .O(new_n129_));
  ...
  nand3  g71(.a(new_n133_), .b(z08), .c(new_n85_), .O(new_n134_));
  oai21  g72(.a(new_n132_), .b(new_n66_), .c(new_n134_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(x27), .O(new_n136_));
  inv1   g74(.a(new_n75_), .O(new_n137_));
  nand3  g75(.a(new_n133_), .b(new_n137_), .c(z08), .O(new_n138_));
  nand2  g76(.a(new_n138_), .b(new_n136_), .O(z13));
  nand3  g77(.a(new_n131_), .b(x37), .c(x20), .O(new_n140_));
  aoi21  g78(.a(new_n140_), .b(x28), .c(new_n87_), .O(new_n141_));
  nand2  g79(.a(new_n133_), .b(z08), .O(new_n142_));
  nand3  g80(.a(new_n131_), .b(x27), .c(x20), .O(new_n143_));
  oai21  g81(.a(new_n143_), .b(new_n66_), .c(new_n142_), .O(new_n144_));
  oai21  g82(.a(new_n141_), .b(new_n137_), .c(new_n144_), .O(z14));
  ...
  nand2  g90(.a(new_n79_), .b(new_n87_), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n118_), .O(new_n154_));
  nand2  g92(.a(new_n154_), .b(x08), .O(new_n155_));
  nand3  g93(.a(new_n155_), .b(new_n124_), .c(new_n122_), .O(z18));
  oai21  g94(.a(new_n78_), .b(new_n87_), .c(new_n121_), .O(new_n157_));
  oai21  g95(.a(new_n85_), .b(x27), .c(x35), .O(new_n158_));
  nand2  g96(.a(new_n158_), .b(new_n118_), .O(new_n159_));
  aoi21  g97(.a(new_n159_), .b(new_n157_), .c(new_n125_), .O(z20));
  aoi21  g98(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z19));
endmodule
