...
module FAU ( 
  ...
  nand3  g055(.a(new_n74_), .b(x27), .c(new_n64_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  oai21  g057(.a(new_n72_), .b(new_n64_), .c(new_n74_), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x29), .O(new_n121_));
  aoi21  g059(.a(new_n121_), .b(new_n120_), .c(new_n86_), .O(new_n122_));
  ...
  inv1   g101(.a(new_n121_), .O(new_n164_));
  nor2   g102(.a(x28), .b(x27), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(x08), .O(new_n166_));
  nand4  g104(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n123_), .O(z18));
  oai21  g106(.a(new_n164_), .b(new_n74_), .c(x08), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n72_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(x35), .c(new_n124_), .O(z20));
  aoi21  g109(.a(new_n122_), .b(new_n119_), .c(new_n124_), .O(z19));
endmodule
