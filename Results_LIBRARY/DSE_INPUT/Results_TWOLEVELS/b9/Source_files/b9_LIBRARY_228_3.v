...
module FAU ( 
  ...
  aoi21  g064(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n127_));
  nor2   g065(.a(new_n66_), .b(new_n72_), .O(new_n128_));
  nor2   g066(.a(new_n83_), .b(x04), .O(new_n129_));
  ...
  nand4  g082(.a(new_n78_), .b(z08), .c(new_n131_), .d(new_n64_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  inv1   g084(.a(x32), .O(new_n147_));
  nand4  g085(.a(new_n134_), .b(new_n147_), .c(new_n124_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n120_), .c(z08), .d(new_n131_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n140_), .O(new_n150_));
  nand3  g088(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n77_), .O(new_n153_));
  nand2  g091(.a(new_n131_), .b(new_n64_), .O(new_n154_));
  ...
  aoi22  g102(.a(new_n119_), .b(new_n72_), .c(z08), .d(x29), .O(new_n165_));
  nor2   g103(.a(new_n72_), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n119_), .c(new_n125_), .O(new_n167_));
  oai21  g105(.a(new_n165_), .b(new_n164_), .c(new_n167_), .O(z18));
  oai21  g106(.a(new_n87_), .b(new_n72_), .c(new_n164_), .O(new_n169_));
  nand2  g107(.a(z08), .b(x29), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n169_), .c(new_n125_), .O(z20));
  aoi21  g111(.a(new_n122_), .b(new_n118_), .c(new_n125_), .O(z19));
endmodule
