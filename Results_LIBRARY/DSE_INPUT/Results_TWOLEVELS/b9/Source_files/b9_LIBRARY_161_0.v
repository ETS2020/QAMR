// Benchmark "FAU" written by ABC on Thu Jun 25 20:41:48 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n87_, new_n88_, new_n90_, new_n91_, new_n95_, new_n96_, new_n97_,
  ...
  aoi21  g022(.a(new_n84_), .b(new_n82_), .c(new_n83_), .O(new_n85_));
  nand2  g023(.a(new_n85_), .b(new_n81_), .O(z02));
  nor2   g024(.a(x37), .b(x27), .O(new_n87_));
  aoi21  g025(.a(new_n74_), .b(x27), .c(new_n87_), .O(new_n88_));
  nand3  g026(.a(new_n88_), .b(x35), .c(x21), .O(z03));
  inv1   g027(.a(x35), .O(new_n90_));
  nor2   g028(.a(new_n90_), .b(x21), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n88_), .O(z04));
  ...
  nand2  g048(.a(new_n83_), .b(x07), .O(new_n111_));
  oai21  g049(.a(new_n83_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nor3   g050(.a(new_n77_), .b(new_n83_), .c(new_n110_), .O(new_n113_));
  ...
  inv1   g054(.a(new_n80_), .O(new_n117_));
  nor2   g055(.a(new_n90_), .b(x28), .O(new_n118_));
  nand2  g056(.a(x27), .b(x04), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  oai21  g058(.a(new_n84_), .b(new_n83_), .c(new_n120_), .O(new_n121_));
  nor2   g059(.a(x30), .b(x09), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(new_n123_));
  aoi21  g061(.a(new_n121_), .b(new_n117_), .c(new_n123_), .O(z11));
  ...
  nand4  g081(.a(new_n78_), .b(z08), .c(new_n130_), .d(new_n64_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(z13));
  inv1   g083(.a(x30), .O(new_n146_));
  inv1   g084(.a(x32), .O(new_n147_));
  nand4  g085(.a(new_n133_), .b(new_n147_), .c(new_n146_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n119_), .c(z08), .d(new_n130_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n139_), .O(new_n150_));
  nand3  g088(.a(new_n125_), .b(new_n90_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n77_), .O(new_n153_));
  nand2  g091(.a(new_n130_), .b(new_n64_), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n83_), .c(new_n66_), .d(new_n72_), .O(new_n155_));
  ...
  oai21  g102(.a(x28), .b(x27), .c(new_n164_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand3  g104(.a(new_n118_), .b(x27), .c(new_n64_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n122_), .O(z18));
  inv1   g106(.a(x08), .O(new_n169_));
  oai21  g107(.a(new_n90_), .b(new_n72_), .c(new_n169_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n164_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n123_), .O(z20));
  aoi21  g111(.a(new_n121_), .b(new_n117_), .c(new_n123_), .O(z19));
endmodule
