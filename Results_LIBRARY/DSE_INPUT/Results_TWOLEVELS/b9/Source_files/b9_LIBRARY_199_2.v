...
module FAU ( 
  ...
  oai21  g068(.a(new_n73_), .b(new_n86_), .c(x28), .O(new_n131_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n127_), .O(new_n139_));
  ...
  nand3  g082(.a(x37), .b(x20), .c(new_n135_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n86_), .c(x28), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n77_), .O(new_n148_));
  inv1   g086(.a(x30), .O(new_n149_));
  inv1   g087(.a(x32), .O(new_n150_));
  nand4  g088(.a(new_n73_), .b(new_n150_), .c(new_n149_), .d(x28), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(new_n152_));
  nand2  g090(.a(new_n142_), .b(z08), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n152_), .c(new_n137_), .O(new_n154_));
  nand2  g092(.a(new_n153_), .b(new_n128_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n148_), .O(z14));
