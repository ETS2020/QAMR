...
module FAU ( 
  ...
  nor2   g051(.a(new_n80_), .b(new_n69_), .O(new_n114_));
  aoi22  g052(.a(new_n114_), .b(x05), .c(new_n113_), .d(new_n79_), .O(new_n115_));
  ...
  nand2  g059(.a(new_n121_), .b(new_n85_), .O(new_n122_));
  nor2   g060(.a(x30), .b(x09), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n122_), .b(new_n120_), .c(new_n124_), .O(z11));
  nor3   g063(.a(x37), .b(x36), .c(x35), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n75_), .c(new_n63_), .O(new_n127_));
  oai22  g065(.a(new_n69_), .b(x04), .c(new_n67_), .d(new_n75_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(z12));
  ...
  oai21  g075(.a(new_n137_), .b(new_n67_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x27), .O(new_n139_));
  nor2   g077(.a(x13), .b(x04), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n114_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(z13));
  inv1   g080(.a(x30), .O(new_n143_));
  inv1   g081(.a(x32), .O(new_n144_));
  nand4  g082(.a(new_n133_), .b(new_n144_), .c(new_n143_), .d(x28), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n140_), .b(z08), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n137_), .O(new_n148_));
  nand3  g086(.a(new_n132_), .b(x40), .c(new_n130_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n75_), .O(new_n150_));
  ...
  nand2  g091(.a(new_n147_), .b(new_n67_), .O(new_n154_));
  ...
  oai21  g100(.a(new_n78_), .b(x27), .c(new_n118_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g103(.a(new_n88_), .b(new_n75_), .c(new_n85_), .O(new_n166_));
  oai21  g104(.a(new_n77_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n118_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n124_), .O(z20));
  aoi21  g107(.a(new_n122_), .b(new_n120_), .c(new_n124_), .O(z19));
endmodule
