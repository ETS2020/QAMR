// Benchmark "FAU" written by ABC on Thu Jun 25 20:42:23 2020
...
module FAU ( 
  ...
  nand2  g049(.a(new_n83_), .b(x07), .O(new_n112_));
  oai21  g050(.a(new_n83_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nor3   g051(.a(new_n77_), .b(new_n83_), .c(new_n111_), .O(new_n114_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n150_), .c(new_n149_), .d(x28), .O(new_n151_));
  ...
  nand3  g092(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n77_), .O(new_n157_));
  nand2  g095(.a(new_n153_), .b(new_n131_), .O(new_n158_));
  ...
  oai22  g104(.a(new_n75_), .b(x27), .c(new_n83_), .d(new_n122_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n126_), .c(new_n120_), .O(z18));
  oai21  g107(.a(new_n87_), .b(new_n72_), .c(new_n84_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n83_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n127_), .O(z20));
  aoi21  g111(.a(new_n125_), .b(new_n121_), .c(new_n127_), .O(z19));
endmodule
