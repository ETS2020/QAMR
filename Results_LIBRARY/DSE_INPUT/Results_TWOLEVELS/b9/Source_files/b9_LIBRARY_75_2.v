...
module FAU ( 
  ...
  aoi21  g000(.a(x39), .b(x36), .c(x35), .O(new_n63_));
  ...
  nand2  g051(.a(x39), .b(x36), .O(new_n114_));
  nand2  g052(.a(x40), .b(x05), .O(new_n115_));
  ...
  aoi22  g080(.a(x39), .b(new_n76_), .c(x36), .d(x35), .O(new_n143_));
  ...
  aoi21  g097(.a(new_n159_), .b(x40), .c(new_n148_), .O(new_n160_));
