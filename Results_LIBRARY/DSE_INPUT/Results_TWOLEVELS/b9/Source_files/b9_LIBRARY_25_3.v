// Benchmark "FAU" written by ABC on Thu Jun 25 20:40:32 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x20), .O(new_n78_));
  oai21  g016(.a(x27), .b(x08), .c(x35), .O(new_n79_));
  aoi21  g017(.a(x28), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nand2  g018(.a(x40), .b(x39), .O(new_n81_));
  aoi21  g019(.a(x29), .b(x08), .c(x02), .O(new_n82_));
  nor2   g020(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  oai21  g021(.a(new_n80_), .b(new_n64_), .c(new_n83_), .O(z02));
  inv1   g022(.a(x35), .O(new_n85_));
  nand2  g023(.a(new_n78_), .b(x04), .O(new_n86_));
  nand2  g024(.a(x35), .b(new_n64_), .O(new_n87_));
  aoi21  g025(.a(new_n87_), .b(new_n86_), .c(x28), .O(new_n88_));
  oai21  g026(.a(new_n88_), .b(new_n85_), .c(x27), .O(new_n89_));
  ...
  inv1   g046(.a(new_n81_), .O(z08));
  nand4  g047(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n110_));
  inv1   g048(.a(new_n110_), .O(z09));
  inv1   g049(.a(x05), .O(new_n112_));
  nand2  g050(.a(new_n81_), .b(x07), .O(new_n113_));
  oai21  g051(.a(new_n81_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  inv1   g052(.a(x36), .O(new_n115_));
  nand2  g053(.a(x35), .b(new_n73_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n115_), .c(new_n72_), .O(new_n117_));
  nand3  g055(.a(x40), .b(x39), .c(x05), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n75_), .O(new_n119_));
  aoi21  g057(.a(new_n117_), .b(new_n114_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g062(.a(new_n124_), .b(new_n116_), .c(new_n123_), .O(new_n125_));
  inv1   g063(.a(x08), .O(new_n126_));
  nor2   g064(.a(new_n85_), .b(x28), .O(new_n127_));
  ...
  aoi21  g071(.a(new_n63_), .b(new_n90_), .c(new_n72_), .O(new_n134_));
  nand2  g072(.a(z08), .b(new_n64_), .O(new_n135_));
  oai21  g073(.a(new_n66_), .b(new_n72_), .c(new_n135_), .O(new_n136_));
  oai21  g074(.a(new_n134_), .b(x10), .c(new_n136_), .O(z12));
  inv1   g075(.a(new_n75_), .O(new_n138_));
  oai21  g076(.a(new_n115_), .b(new_n85_), .c(x28), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x27), .c(new_n138_), .O(new_n140_));
  inv1   g078(.a(x13), .O(new_n141_));
  nand4  g079(.a(x40), .b(x39), .c(new_n141_), .d(new_n64_), .O(new_n142_));
  nor2   g080(.a(x19), .b(x18), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(x37), .c(x27), .d(x20), .O(new_n144_));
  oai21  g082(.a(new_n142_), .b(new_n140_), .c(new_n144_), .O(z13));
  inv1   g083(.a(x32), .O(new_n146_));
  nand3  g084(.a(new_n85_), .b(new_n146_), .c(new_n131_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n64_), .c(x20), .O(new_n148_));
  nand3  g086(.a(new_n75_), .b(new_n115_), .c(x35), .O(new_n149_));
  inv1   g087(.a(new_n149_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n143_), .b(x37), .O(new_n152_));
  nand3  g090(.a(new_n75_), .b(x28), .c(x20), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n141_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  inv1   g093(.a(new_n86_), .O(new_n156_));
  nand2  g094(.a(x27), .b(x20), .O(new_n157_));
  nand2  g095(.a(z08), .b(new_n141_), .O(new_n158_));
  nor2   g096(.a(x28), .b(new_n72_), .O(new_n159_));
  aoi22  g097(.a(new_n159_), .b(new_n156_), .c(new_n158_), .d(new_n157_), .O(new_n160_));
  nand2  g098(.a(new_n138_), .b(new_n64_), .O(new_n161_));
  oai21  g099(.a(x37), .b(x35), .c(new_n143_), .O(new_n162_));
  aoi22  g100(.a(new_n162_), .b(new_n135_), .c(new_n161_), .d(new_n72_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n160_), .c(new_n155_), .d(new_n151_), .O(z14));
  ...
  nand2  g109(.a(new_n127_), .b(new_n72_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n123_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x08), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n128_), .c(new_n131_), .d(new_n130_), .O(z18));
  oai21  g113(.a(new_n85_), .b(new_n72_), .c(new_n126_), .O(new_n176_));
  oai21  g114(.a(new_n73_), .b(x27), .c(x35), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n123_), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n176_), .c(new_n132_), .O(z20));
  aoi21  g117(.a(new_n129_), .b(new_n125_), .c(new_n132_), .O(z19));
endmodule
