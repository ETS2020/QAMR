// Benchmark "FAU" written by ABC on Thu Jun 25 20:41:00 2020
...
module FAU ( 
  ...
  oai22  g021(.a(new_n83_), .b(x02), .c(x27), .d(new_n64_), .O(new_n84_));
  nand2  g022(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g023(.a(new_n75_), .b(x40), .c(x04), .O(new_n86_));
  nand3  g024(.a(new_n86_), .b(new_n85_), .c(z08), .O(z02));
  ...
  nand2  g049(.a(new_n80_), .b(x07), .O(new_n112_));
  oai21  g050(.a(new_n80_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nor3   g051(.a(new_n77_), .b(new_n80_), .c(new_n111_), .O(new_n114_));
  ...
  oai21  g056(.a(new_n118_), .b(new_n75_), .c(new_n80_), .O(new_n119_));
  nand2  g057(.a(x40), .b(x04), .O(new_n120_));
  ...
  nor2   g064(.a(new_n83_), .b(x27), .O(new_n127_));
  aoi21  g065(.a(new_n63_), .b(new_n90_), .c(new_n127_), .O(new_n128_));
  nand2  g066(.a(z08), .b(new_n64_), .O(new_n129_));
  nand2  g067(.a(new_n120_), .b(z08), .O(new_n130_));
  aoi22  g068(.a(new_n130_), .b(new_n72_), .c(new_n129_), .d(new_n66_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(x10), .c(new_n131_), .O(z12));
  nand2  g070(.a(x36), .b(x35), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x28), .O(new_n134_));
  nor2   g072(.a(new_n83_), .b(x13), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n134_), .c(x39), .d(new_n64_), .O(new_n136_));
  nand2  g074(.a(new_n88_), .b(new_n90_), .O(new_n137_));
  ...
  nand4  g086(.a(new_n133_), .b(new_n148_), .c(new_n124_), .d(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(new_n145_), .c(x40), .d(x39), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n140_), .O(new_n151_));
  oai21  g089(.a(new_n66_), .b(new_n72_), .c(new_n80_), .O(new_n152_));
  inv1   g090(.a(x35), .O(new_n153_));
  nand3  g091(.a(new_n90_), .b(new_n153_), .c(x28), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x27), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n77_), .O(new_n156_));
  oai22  g094(.a(new_n127_), .b(new_n66_), .c(x13), .d(x04), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n156_), .c(new_n152_), .d(new_n151_), .O(z14));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n72_), .c(z08), .O(new_n167_));
  nor2   g105(.a(new_n72_), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n125_), .O(new_n169_));
  oai21  g107(.a(new_n167_), .b(new_n82_), .c(new_n169_), .O(z18));
  oai21  g108(.a(new_n153_), .b(new_n72_), .c(new_n82_), .O(new_n171_));
  oai21  g109(.a(new_n74_), .b(x27), .c(x35), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n80_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n125_), .O(z20));
  aoi21  g112(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
