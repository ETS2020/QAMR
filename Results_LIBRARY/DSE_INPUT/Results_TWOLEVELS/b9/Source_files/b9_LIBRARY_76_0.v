...
module FAU ( 
  ...
  nor2   g059(.a(new_n88_), .b(x28), .O(new_n122_));
  ...
  aoi22  g065(.a(new_n63_), .b(new_n90_), .c(x40), .d(new_n72_), .O(new_n128_));
  oai22  g066(.a(new_n83_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(x10), .c(new_n129_), .O(z12));
  nand2  g068(.a(x36), .b(x35), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x28), .O(new_n132_));
  nor2   g070(.a(new_n84_), .b(x13), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n132_), .c(x39), .d(new_n64_), .O(new_n134_));
  ...
  and2   g089(.a(x40), .b(x13), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n65_), .c(new_n72_), .O(new_n153_));
  nand3  g091(.a(new_n90_), .b(new_n88_), .c(x28), .O(new_n154_));
  ...
  oai21  g106(.a(new_n88_), .b(new_n72_), .c(new_n80_), .O(new_n169_));
