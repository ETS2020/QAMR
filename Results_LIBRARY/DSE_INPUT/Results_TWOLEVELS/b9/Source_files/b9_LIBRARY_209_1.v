...
module FAU ( 
  ...
  nand3  g54(.a(z08), .b(x29), .c(x08), .O(new_n117_));
  nor2   g55(.a(x30), .b(x09), .O(new_n118_));
  nand2  g56(.a(new_n118_), .b(new_n117_), .O(z18));
  inv1   g57(.a(z18), .O(z11));
  aoi21  g58(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n121_));
  inv1   g59(.a(new_n66_), .O(new_n122_));
  nand2  g60(.a(new_n122_), .b(x27), .O(new_n123_));
  oai21  g61(.a(new_n82_), .b(x04), .c(new_n123_), .O(new_n124_));
  oai21  g62(.a(new_n121_), .b(x10), .c(new_n124_), .O(z12));
  nand2  g63(.a(x36), .b(x35), .O(new_n126_));
  nand2  g64(.a(new_n126_), .b(x28), .O(new_n127_));
  inv1   g65(.a(x40), .O(new_n128_));
  nor2   g66(.a(new_n128_), .b(x13), .O(new_n129_));
  nand4  g67(.a(new_n129_), .b(new_n127_), .c(x39), .d(new_n64_), .O(new_n130_));
  ...
  nand2  g72(.a(new_n134_), .b(new_n122_), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(new_n130_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x27), .O(new_n137_));
  nor2   g75(.a(x13), .b(x04), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(new_n78_), .c(z08), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(new_n137_), .O(z13));
  inv1   g78(.a(x30), .O(new_n141_));
  inv1   g79(.a(x32), .O(new_n142_));
  nand4  g80(.a(new_n126_), .b(new_n142_), .c(new_n141_), .d(x28), .O(new_n143_));
  inv1   g81(.a(new_n143_), .O(new_n144_));
  nand2  g82(.a(new_n138_), .b(z08), .O(new_n145_));
  oai21  g83(.a(new_n145_), .b(new_n144_), .c(new_n133_), .O(new_n146_));
  nand3  g84(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n147_));
  nand2  g85(.a(new_n147_), .b(x27), .O(new_n148_));
  nand2  g86(.a(new_n148_), .b(new_n77_), .O(new_n149_));
  nand2  g87(.a(new_n145_), .b(new_n123_), .O(new_n150_));
  nand3  g88(.a(new_n150_), .b(new_n149_), .c(new_n146_), .O(z14));
