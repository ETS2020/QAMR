...
module FAU ( 
  ...
  oai21  g071(.a(new_n73_), .b(new_n86_), .c(x28), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(new_n133_), .c(x40), .d(new_n131_), .O(new_n135_));
  ...
  nand4  g080(.a(new_n78_), .b(z08), .c(new_n131_), .d(new_n64_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(z13));
  inv1   g082(.a(x32), .O(new_n145_));
  nand2  g083(.a(new_n86_), .b(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n73_), .b(x35), .O(new_n147_));
  inv1   g085(.a(x30), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  aoi21  g087(.a(new_n147_), .b(new_n146_), .c(new_n149_), .O(new_n150_));
  nand3  g088(.a(z08), .b(new_n131_), .c(new_n64_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n138_), .O(new_n152_));
  nand3  g090(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x27), .c(new_n78_), .O(new_n154_));
  aoi21  g092(.a(new_n151_), .b(new_n128_), .c(new_n154_), .O(new_n155_));
