...
module FAU ( 
  ...
  aoi21  g34(.a(new_n50_), .b(new_n25_), .c(x08), .O(new_n59_));
  ...
  oai21  g39(.a(new_n60_), .b(x07), .c(new_n63_), .O(z4));
  nor2   g40(.a(x12), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  oai21  g42(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n67_));
  aoi21  g43(.a(x08), .b(x00), .c(x01), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  inv1   g45(.a(x14), .O(new_n70_));
  oai21  g46(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n30_), .b(new_n56_), .O(new_n72_));
  ...
  nand4  g53(.a(new_n41_), .b(new_n61_), .c(new_n40_), .d(x02), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(new_n61_), .c(new_n45_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n87_));
