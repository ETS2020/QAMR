...
module FAU ( 
  ...
  oai21  g37(.a(new_n61_), .b(new_n44_), .c(new_n50_), .O(new_n62_));
  ...
  oai21  g41(.a(new_n44_), .b(x03), .c(new_n36_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n61_), .c(new_n40_), .O(new_n67_));
  inv1   g43(.a(x14), .O(new_n68_));
  oai21  g44(.a(x09), .b(new_n25_), .c(new_n40_), .O(new_n69_));
  nand2  g45(.a(new_n36_), .b(new_n47_), .O(new_n70_));
  oai21  g46(.a(x08), .b(new_n47_), .c(new_n70_), .O(new_n71_));
  nor2   g47(.a(new_n40_), .b(x00), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n68_), .c(new_n71_), .d(new_n69_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n67_), .c(new_n51_), .O(z6));
  nand2  g50(.a(new_n26_), .b(x09), .O(new_n75_));
  nand4  g51(.a(new_n42_), .b(new_n41_), .c(new_n50_), .d(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n40_), .O(new_n78_));
  nand2  g54(.a(x03), .b(new_n40_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n41_), .c(new_n51_), .O(new_n80_));
  ...
  aoi21  g60(.a(new_n44_), .b(new_n47_), .c(new_n51_), .O(new_n85_));
