...
module FAU ( 
  ...
  nand3  g26(.a(new_n41_), .b(x09), .c(new_n50_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x01), .O(new_n52_));
  nor2   g28(.a(x08), .b(new_n30_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(new_n54_));
  ...
  oai21  g35(.a(new_n58_), .b(x01), .c(new_n59_), .O(new_n60_));
  nor2   g36(.a(x10), .b(x08), .O(new_n61_));
  nand3  g37(.a(new_n41_), .b(x09), .c(x00), .O(new_n62_));
  aoi21  g38(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n67_), .b(x13), .c(new_n40_), .O(z5));
  nor2   g44(.a(x10), .b(x07), .O(new_n69_));
  inv1   g45(.a(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n71_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n73_), .c(new_n70_), .O(z6));
  nand3  g56(.a(x09), .b(x03), .c(new_n30_), .O(new_n81_));
  nand2  g57(.a(new_n53_), .b(new_n69_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(new_n84_));
  nand2  g60(.a(x03), .b(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n41_), .b(new_n40_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(new_n50_), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n84_), .O(z7));
  inv1   g64(.a(x12), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n30_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n85_), .c(x09), .O(new_n91_));
  aoi21  g67(.a(new_n58_), .b(new_n56_), .c(new_n86_), .O(new_n92_));
