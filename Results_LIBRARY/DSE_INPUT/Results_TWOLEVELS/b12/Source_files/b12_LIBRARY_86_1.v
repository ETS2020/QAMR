...
module FAU ( 
  ...
  inv1   g38(.a(new_n45_), .O(new_n63_));
  nand2  g39(.a(new_n40_), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(x13), .d(new_n62_), .O(z5));
  ...
  oai21  g53(.a(new_n75_), .b(new_n58_), .c(new_n77_), .O(new_n78_));
  ...
  oai21  g58(.a(new_n75_), .b(x01), .c(x09), .O(new_n83_));
  nand2  g59(.a(new_n58_), .b(new_n56_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(new_n62_), .O(z8));
endmodule
