...
module FAU ( 
  ...
  oai21  g20(.a(x08), .b(x07), .c(new_n44_), .O(new_n45_));
  ...
  oai21  g30(.a(new_n54_), .b(new_n53_), .c(new_n48_), .O(new_n55_));
  ...
  oai21  g35(.a(x10), .b(new_n49_), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x12), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n59_), .O(z3));
  nand2  g39(.a(x09), .b(new_n27_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n26_), .c(x10), .O(new_n65_));
  oai21  g41(.a(x02), .b(x00), .c(new_n49_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  aoi21  g43(.a(x10), .b(new_n41_), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n65_), .c(new_n48_), .O(new_n70_));
  nand2  g46(.a(new_n57_), .b(x07), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  inv1   g48(.a(x13), .O(new_n73_));
  aoi21  g49(.a(x10), .b(new_n41_), .c(new_n73_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n60_), .c(new_n58_), .d(new_n48_), .O(z5));
  oai21  g51(.a(new_n67_), .b(x03), .c(new_n25_), .O(new_n76_));
  nand3  g52(.a(new_n67_), .b(x03), .c(new_n25_), .O(new_n77_));
  ...
  aoi21  g57(.a(new_n76_), .b(new_n27_), .c(new_n81_), .O(new_n82_));
  nand2  g58(.a(new_n51_), .b(new_n48_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(new_n82_), .O(z6));
  inv1   g60(.a(new_n65_), .O(new_n85_));
  nor3   g61(.a(new_n54_), .b(x10), .c(new_n35_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(z7));
  nor2   g63(.a(x10), .b(new_n67_), .O(new_n88_));
  aoi22  g64(.a(new_n88_), .b(new_n44_), .c(x10), .d(x00), .O(new_n89_));
  nand3  g65(.a(new_n58_), .b(new_n25_), .c(new_n27_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  oai21  g67(.a(new_n51_), .b(x07), .c(x09), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n41_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n91_), .c(new_n89_), .d(new_n48_), .O(z8));
endmodule
