// Benchmark "FAU" written by ABC on Thu Jun 25 19:37:29 2020
...
module FAU ( 
  ...
  aoi21  g43(.a(x14), .b(x02), .c(new_n25_), .O(new_n68_));
  aoi21  g44(.a(new_n65_), .b(new_n30_), .c(x01), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(new_n45_), .O(z6));
  nand3  g47(.a(x03), .b(new_n30_), .c(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n41_), .c(x08), .d(new_n40_), .O(z7));
  nand2  g49(.a(new_n72_), .b(x09), .O(new_n74_));
  nand2  g50(.a(x12), .b(x03), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n56_), .c(new_n45_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(z8));
endmodule
