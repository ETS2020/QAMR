...
module FAU ( 
  ...
  nand2  g39(.a(x12), .b(x09), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n63_), .c(new_n42_), .d(new_n41_), .O(z5));
  ...
  nand4  g55(.a(new_n42_), .b(new_n66_), .c(new_n41_), .d(x01), .O(new_n80_));
  ...
  aoi21  g59(.a(new_n83_), .b(new_n66_), .c(new_n46_), .O(new_n84_));
  ...
  aoi21  g64(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(new_n89_));
