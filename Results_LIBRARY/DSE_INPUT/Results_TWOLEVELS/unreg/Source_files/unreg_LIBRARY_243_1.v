...
module FAU ( 
  ...
  nor2   g045(.a(x18), .b(x05), .O(new_n98_));
  ...
  oai21  g050(.a(new_n100_), .b(new_n98_), .c(new_n102_), .O(z06));
  inv1   g051(.a(x17), .O(new_n104_));
  nand2  g052(.a(new_n55_), .b(x04), .O(new_n105_));
  nand3  g053(.a(new_n60_), .b(x19), .c(x18), .O(new_n106_));
