...
module FAU ( 
  ...
  inv1   g094(.a(x17), .O(new_n147_));
  nand2  g095(.a(x19), .b(new_n147_), .O(new_n148_));
  nor2   g096(.a(x18), .b(x14), .O(new_n149_));
  oai22  g097(.a(new_n149_), .b(new_n148_), .c(x33), .d(x19), .O(z13));
  nand3  g098(.a(x19), .b(new_n55_), .c(x13), .O(new_n151_));
  inv1   g099(.a(x35), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(x18), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  ...
  nand2  g110(.a(new_n152_), .b(new_n57_), .O(new_n163_));
