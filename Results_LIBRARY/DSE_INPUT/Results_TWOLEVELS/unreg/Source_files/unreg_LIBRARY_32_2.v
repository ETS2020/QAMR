...
module FAU ( 
  ...
  nor2   g015(.a(x23), .b(new_n54_), .O(new_n68_));
  oai21  g016(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(new_n69_));
  ...
  nor2   g029(.a(x25), .b(new_n54_), .O(new_n82_));
  oai21  g030(.a(new_n82_), .b(new_n81_), .c(new_n61_), .O(new_n83_));
  inv1   g031(.a(x24), .O(new_n84_));
  nand2  g032(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  nand2  g033(.a(new_n85_), .b(new_n83_), .O(z04));
  inv1   g034(.a(x06), .O(new_n87_));
  nor2   g035(.a(x18), .b(new_n87_), .O(new_n88_));
  nor2   g036(.a(x26), .b(new_n54_), .O(new_n89_));
  oai21  g037(.a(new_n89_), .b(new_n88_), .c(new_n61_), .O(new_n90_));
  ...
  nor2   g043(.a(x27), .b(new_n54_), .O(new_n96_));
  oai21  g044(.a(new_n96_), .b(new_n95_), .c(new_n61_), .O(new_n97_));
  ...
  nor2   g050(.a(x20), .b(new_n54_), .O(new_n103_));
  oai21  g051(.a(new_n103_), .b(new_n102_), .c(new_n61_), .O(new_n104_));
  ...
  nor2   g057(.a(x29), .b(new_n54_), .O(new_n110_));
  oai21  g058(.a(new_n110_), .b(new_n109_), .c(new_n61_), .O(new_n111_));
  ...
  nor2   g064(.a(x30), .b(new_n54_), .O(new_n117_));
  oai21  g065(.a(new_n117_), .b(new_n116_), .c(new_n61_), .O(new_n118_));
  ...
  nor2   g071(.a(x31), .b(new_n54_), .O(new_n124_));
  oai21  g072(.a(new_n124_), .b(new_n123_), .c(new_n61_), .O(new_n125_));
  ...
  nor2   g078(.a(x24), .b(new_n54_), .O(new_n131_));
  oai21  g079(.a(new_n131_), .b(new_n130_), .c(new_n61_), .O(new_n132_));
  ...
  nor2   g085(.a(x33), .b(new_n54_), .O(new_n138_));
  oai21  g086(.a(new_n138_), .b(new_n137_), .c(new_n61_), .O(new_n139_));
  ...
  nor2   g092(.a(x34), .b(new_n54_), .O(new_n145_));
  oai21  g093(.a(new_n145_), .b(new_n144_), .c(new_n61_), .O(new_n146_));
  ...
  nor2   g099(.a(x35), .b(new_n54_), .O(new_n152_));
  oai21  g100(.a(new_n152_), .b(new_n151_), .c(new_n61_), .O(new_n153_));
  ...
  nor2   g106(.a(x28), .b(new_n54_), .O(new_n159_));
  oai21  g107(.a(new_n159_), .b(new_n158_), .c(new_n61_), .O(new_n160_));
