// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:48 2020
...
module FAU ( 
  ...
  nand2  g025(.a(x19), .b(new_n77_), .O(new_n78_));
  aoi21  g026(.a(new_n55_), .b(x00), .c(x16), .O(new_n79_));
  oai22  g027(.a(new_n79_), .b(new_n78_), .c(x23), .d(x19), .O(z03));
