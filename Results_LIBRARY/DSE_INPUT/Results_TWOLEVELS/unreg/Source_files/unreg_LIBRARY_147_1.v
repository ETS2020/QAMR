...
module FAU ( 
  ...
  nor2   g073(.a(x18), .b(x09), .O(new_n126_));
  inv1   g074(.a(x31), .O(new_n127_));
  nand2  g075(.a(new_n58_), .b(new_n127_), .O(new_n128_));
  inv1   g076(.a(x30), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n57_), .O(new_n130_));
  oai21  g078(.a(new_n128_), .b(new_n126_), .c(new_n130_), .O(z10));
  inv1   g079(.a(x17), .O(new_n132_));
  nand2  g080(.a(new_n55_), .b(x08), .O(new_n133_));
  nand3  g081(.a(new_n88_), .b(x19), .c(x18), .O(new_n134_));
  nand2  g082(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g083(.a(new_n135_), .b(new_n132_), .O(new_n136_));
