...
module FAU ( 
  ...
  nand4  g011(.a(x19), .b(new_n55_), .c(new_n63_), .d(x02), .O(new_n64_));
  oai21  g012(.a(x21), .b(x19), .c(new_n64_), .O(z01));
  inv1   g013(.a(x01), .O(new_n66_));
  nor2   g014(.a(x18), .b(new_n66_), .O(new_n67_));
  nor2   g015(.a(x23), .b(new_n55_), .O(new_n68_));
  oai21  g016(.a(new_n68_), .b(new_n67_), .c(new_n58_), .O(new_n69_));
  nand2  g017(.a(new_n69_), .b(x22), .O(z02));
  ...
  nand2  g023(.a(new_n75_), .b(new_n57_), .O(new_n76_));
  nand2  g024(.a(new_n76_), .b(new_n74_), .O(z03));
  inv1   g025(.a(x07), .O(new_n78_));
  nor2   g026(.a(x18), .b(new_n78_), .O(new_n79_));
  nor2   g027(.a(x25), .b(new_n55_), .O(new_n80_));
  oai21  g028(.a(new_n80_), .b(new_n79_), .c(new_n58_), .O(new_n81_));
  ...
  nor2   g034(.a(x26), .b(new_n55_), .O(new_n87_));
  ...
  nor2   g041(.a(x27), .b(new_n55_), .O(new_n94_));
  ...
  nor2   g048(.a(x20), .b(new_n55_), .O(new_n101_));
