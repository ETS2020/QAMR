...
module FAU ( 
  ...
  nor2   g014(.a(new_n60_), .b(x17), .O(new_n67_));
  inv1   g015(.a(new_n67_), .O(new_n68_));
  aoi21  g016(.a(new_n66_), .b(new_n64_), .c(new_n68_), .O(z01));
  inv1   g017(.a(x01), .O(new_n70_));
  nor2   g018(.a(x18), .b(new_n70_), .O(new_n71_));
  nor2   g019(.a(x23), .b(new_n54_), .O(new_n72_));
  oai21  g020(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(new_n73_));
  nand2  g021(.a(new_n65_), .b(new_n60_), .O(new_n74_));
  ...
  nand2  g026(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  ...
  nor2   g032(.a(x25), .b(new_n54_), .O(new_n85_));
  oai21  g033(.a(new_n85_), .b(new_n84_), .c(new_n67_), .O(new_n86_));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n86_), .O(z04));
  inv1   g037(.a(x06), .O(new_n90_));
  nor2   g038(.a(x18), .b(new_n90_), .O(new_n91_));
  nor2   g039(.a(x26), .b(new_n54_), .O(new_n92_));
  oai21  g040(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(new_n93_));
  ...
  nor2   g046(.a(x27), .b(new_n54_), .O(new_n99_));
  oai21  g047(.a(new_n99_), .b(new_n98_), .c(new_n67_), .O(new_n100_));
  ...
  nor2   g053(.a(x20), .b(new_n54_), .O(new_n106_));
  oai21  g054(.a(new_n106_), .b(new_n105_), .c(new_n67_), .O(new_n107_));
  inv1   g055(.a(x27), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n60_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n107_), .O(z07));
  inv1   g058(.a(x11), .O(new_n111_));
  nor2   g059(.a(x18), .b(new_n111_), .O(new_n112_));
  nor2   g060(.a(x29), .b(new_n54_), .O(new_n113_));
  oai21  g061(.a(new_n113_), .b(new_n112_), .c(new_n67_), .O(new_n114_));
  ...
  nor2   g067(.a(x30), .b(new_n54_), .O(new_n120_));
  oai21  g068(.a(new_n120_), .b(new_n119_), .c(new_n67_), .O(new_n121_));
  inv1   g069(.a(x29), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n60_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n121_), .O(z09));
  inv1   g072(.a(x09), .O(new_n125_));
  nor2   g073(.a(x18), .b(new_n125_), .O(new_n126_));
  nor2   g074(.a(x31), .b(new_n54_), .O(new_n127_));
  oai21  g075(.a(new_n127_), .b(new_n126_), .c(new_n67_), .O(new_n128_));
  inv1   g076(.a(x30), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n60_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g079(.a(x08), .O(new_n132_));
  nor2   g080(.a(x18), .b(new_n132_), .O(new_n133_));
  nor2   g081(.a(x24), .b(new_n54_), .O(new_n134_));
  oai21  g082(.a(new_n134_), .b(new_n133_), .c(new_n67_), .O(new_n135_));
  ...
  nor2   g088(.a(x33), .b(new_n54_), .O(new_n141_));
  oai21  g089(.a(new_n141_), .b(new_n140_), .c(new_n67_), .O(new_n142_));
  inv1   g090(.a(x32), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n60_), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n142_), .O(z12));
  inv1   g093(.a(x14), .O(new_n146_));
  nor2   g094(.a(x18), .b(new_n146_), .O(new_n147_));
  nor2   g095(.a(x34), .b(new_n54_), .O(new_n148_));
  oai21  g096(.a(new_n148_), .b(new_n147_), .c(new_n67_), .O(new_n149_));
  ...
  nor2   g102(.a(x35), .b(new_n54_), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n154_), .c(new_n67_), .O(new_n156_));
  inv1   g104(.a(x34), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n60_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n156_), .O(z14));
  inv1   g107(.a(x12), .O(new_n160_));
  nor2   g108(.a(x18), .b(new_n160_), .O(new_n161_));
  nor2   g109(.a(x28), .b(new_n54_), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(new_n161_), .c(new_n67_), .O(new_n163_));
  inv1   g111(.a(x35), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n60_), .O(new_n165_));
