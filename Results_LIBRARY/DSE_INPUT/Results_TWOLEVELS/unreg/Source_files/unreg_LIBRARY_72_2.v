// Benchmark "FAU" written by ABC on Thu Jun 25 17:24:31 2020
...
module FAU ( 
  ...
  nand2  g035(.a(new_n87_), .b(x24), .O(z04));
  ...
  nand2  g055(.a(new_n107_), .b(new_n57_), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n106_), .O(z07));
  inv1   g057(.a(x11), .O(new_n110_));
  nor2   g058(.a(x18), .b(new_n110_), .O(new_n111_));
  nor2   g059(.a(x29), .b(new_n55_), .O(new_n112_));
  oai21  g060(.a(new_n112_), .b(new_n111_), .c(new_n58_), .O(new_n113_));
  inv1   g061(.a(x28), .O(new_n114_));
  nand2  g062(.a(new_n114_), .b(new_n57_), .O(new_n115_));
  ...
  inv1   g078(.a(x17), .O(new_n131_));
  nand4  g079(.a(x19), .b(new_n55_), .c(new_n131_), .d(x08), .O(new_n132_));
  oai21  g080(.a(x31), .b(x19), .c(new_n132_), .O(z11));
