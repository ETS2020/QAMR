...
module FAU ( 
  ...
  aoi21  g31(.a(new_n56_), .b(new_n51_), .c(new_n58_), .O(z09));
  nand2  g32(.a(new_n53_), .b(x12), .O(new_n62_));
  nand4  g33(.a(x11), .b(new_n57_), .c(x09), .d(x00), .O(new_n63_));
  nor2   g34(.a(new_n63_), .b(new_n62_), .O(z10));
  nand4  g35(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n65_));
  nand2  g36(.a(new_n32_), .b(new_n30_), .O(new_n66_));
  nand3  g37(.a(x11), .b(new_n57_), .c(x00), .O(new_n67_));
