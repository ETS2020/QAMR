// Benchmark "FAU" written by ABC on Thu Jun 25 17:14:50 2020
...
module FAU ( 
  ...
  oai21  g37(.a(new_n43_), .b(x3), .c(x1), .O(new_n53_));
  oai21  g38(.a(new_n25_), .b(x2), .c(new_n53_), .O(new_n54_));
