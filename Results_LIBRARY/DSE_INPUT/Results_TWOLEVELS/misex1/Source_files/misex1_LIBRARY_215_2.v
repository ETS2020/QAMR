// Benchmark "FAU" written by ABC on Thu Jun 25 17:14:49 2020
...
module FAU ( 
  ...
  nand2  g10(.a(x5), .b(new_n20_), .O(new_n26_));
  ...
  oai21  g35(.a(new_n42_), .b(x3), .c(x2), .O(new_n51_));
  inv1   g36(.a(x6), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x5), .c(new_n20_), .O(new_n53_));
