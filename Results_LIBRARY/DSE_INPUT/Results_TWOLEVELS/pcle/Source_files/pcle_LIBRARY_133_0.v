...
module FAU ( 
  ...
  nand2  g20(.a(new_n40_), .b(x09), .O(new_n49_));
  ...
  oai21  g29(.a(new_n56_), .b(new_n44_), .c(new_n57_), .O(z4));
  ...
  inv1   g39(.a(new_n53_), .O(new_n68_));
  nor2   g40(.a(new_n66_), .b(x16), .O(new_n69_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n53_), .c(x17), .O(new_n76_));
  inv1   g48(.a(x17), .O(new_n77_));
  nand4  g49(.a(new_n77_), .b(x16), .c(x15), .d(x14), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n53_), .c(new_n76_), .O(new_n79_));
