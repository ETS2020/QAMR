// Benchmark "FAU" written by ABC on Thu Jun 25 16:30:32 2020
...
module FAU ( 
  ...
  nand3  g05(.a(new_n34_), .b(new_n32_), .c(new_n31_), .O(new_n35_));
  nand2  g06(.a(new_n35_), .b(new_n30_), .O(z1));
  xnor2a g07(.a(x12), .b(x11), .O(new_n37_));
  inv1   g08(.a(x08), .O(new_n38_));
  nand3  g09(.a(new_n31_), .b(x09), .c(new_n38_), .O(new_n39_));
  nand2  g10(.a(x08), .b(x01), .O(new_n40_));
  oai21  g11(.a(new_n39_), .b(new_n37_), .c(new_n40_), .O(z2));
  ...
  nand2  g41(.a(new_n64_), .b(x16), .O(new_n71_));
  nor2   g42(.a(new_n32_), .b(x10), .O(new_n72_));
  nand4  g43(.a(new_n72_), .b(new_n34_), .c(x13), .d(x12), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(z7));
  nand2  g45(.a(x08), .b(x07), .O(new_n75_));
  nand3  g46(.a(new_n34_), .b(x18), .c(new_n31_), .O(new_n76_));
