// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:45 2020
...
module FAU ( 
  ...
  and2   g142(.a(x110), .b(x022), .O(new_n299_));
  aoi21  g143(.a(new_n299_), .b(new_n298_), .c(new_n297_), .O(new_n300_));
  inv1   g144(.a(x038), .O(new_n301_));
  oai21  g145(.a(x126), .b(new_n288_), .c(new_n301_), .O(new_n302_));
  nand2  g146(.a(new_n302_), .b(new_n287_), .O(new_n303_));
  inv1   g147(.a(x062), .O(new_n304_));
  oai21  g148(.a(x102), .b(new_n304_), .c(x118), .O(new_n305_));
