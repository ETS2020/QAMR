// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:07 2020
...
module FAU ( 
  ...
  nand2  g123(.a(x118), .b(x110), .O(new_n280_));
  inv1   g124(.a(x078), .O(new_n281_));
  inv1   g125(.a(x030), .O(new_n282_));
  inv1   g126(.a(x062), .O(new_n283_));
  inv1   g127(.a(x094), .O(new_n284_));
  nand2  g128(.a(new_n284_), .b(new_n283_), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(new_n282_), .O(new_n286_));
  aoi21  g130(.a(new_n286_), .b(x022), .c(new_n281_), .O(new_n287_));
  oai21  g131(.a(new_n287_), .b(new_n279_), .c(new_n280_), .O(new_n288_));
  nand2  g132(.a(x094), .b(x062), .O(new_n289_));
  aoi21  g133(.a(new_n282_), .b(x022), .c(new_n289_), .O(new_n290_));
  inv1   g134(.a(x022), .O(new_n291_));
  nand2  g135(.a(new_n291_), .b(new_n279_), .O(new_n292_));
  nand2  g136(.a(x126), .b(x102), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(new_n292_), .O(new_n294_));
  oai22  g138(.a(new_n294_), .b(new_n286_), .c(new_n290_), .d(x070), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(x078), .O(new_n296_));
  aoi21  g140(.a(new_n296_), .b(new_n288_), .c(new_n278_), .O(new_n297_));
  aoi21  g141(.a(new_n292_), .b(new_n282_), .c(new_n289_), .O(new_n298_));
  nor3   g142(.a(new_n298_), .b(new_n281_), .c(x038), .O(new_n299_));
  ...
  aoi21  g149(.a(new_n305_), .b(new_n280_), .c(new_n302_), .O(new_n306_));
  inv1   g150(.a(x126), .O(new_n307_));
  and2   g151(.a(x094), .b(x070), .O(new_n308_));
  and2   g152(.a(x118), .b(x022), .O(new_n309_));
  aoi22  g153(.a(new_n309_), .b(new_n307_), .c(new_n308_), .d(new_n293_), .O(new_n310_));
  oai21  g154(.a(new_n289_), .b(new_n282_), .c(new_n292_), .O(new_n311_));
  oai22  g155(.a(x126), .b(x094), .c(x102), .d(new_n303_), .O(new_n312_));
  nand2  g156(.a(new_n312_), .b(x062), .O(new_n313_));
  nand4  g157(.a(new_n313_), .b(new_n311_), .c(new_n310_), .d(new_n306_), .O(new_n314_));
  nand4  g158(.a(new_n307_), .b(x110), .c(new_n303_), .d(x014), .O(new_n315_));
  inv1   g159(.a(new_n315_), .O(new_n316_));
  aoi21  g160(.a(new_n314_), .b(x054), .c(new_n316_), .O(new_n317_));
  nand3  g161(.a(new_n302_), .b(x038), .c(x014), .O(new_n318_));
  oai21  g162(.a(new_n317_), .b(new_n281_), .c(new_n318_), .O(new_n319_));
  aoi22  g163(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n320_));
  nand2  g164(.a(new_n304_), .b(new_n291_), .O(new_n321_));
  aoi22  g165(.a(new_n281_), .b(new_n279_), .c(new_n278_), .d(new_n303_), .O(new_n322_));
  oai21  g166(.a(new_n321_), .b(new_n320_), .c(new_n322_), .O(new_n323_));
  aoi21  g167(.a(new_n319_), .b(new_n301_), .c(new_n323_), .O(new_n324_));
  aoi21  g168(.a(new_n324_), .b(new_n300_), .c(new_n277_), .O(z06));
  ...
  nor3   g197(.a(new_n333_), .b(x080), .c(x048), .O(new_n355_));
  ...
  aoi21  g201(.a(new_n357_), .b(x024), .c(x016), .O(new_n359_));
  oai21  g202(.a(x120), .b(x096), .c(new_n331_), .O(new_n360_));
  oai22  g203(.a(new_n360_), .b(new_n358_), .c(new_n359_), .d(new_n329_), .O(new_n361_));
  nand2  g204(.a(new_n331_), .b(x024), .O(new_n362_));
  aoi21  g205(.a(new_n362_), .b(new_n333_), .c(new_n161_), .O(new_n363_));
  aoi21  g206(.a(new_n361_), .b(new_n162_), .c(new_n363_), .O(new_n364_));
  oai21  g207(.a(new_n364_), .b(x080), .c(new_n356_), .O(new_n365_));
  nor3   g208(.a(new_n329_), .b(x080), .c(x048), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(x072), .c(x008), .O(new_n367_));
  nor2   g210(.a(new_n158_), .b(x008), .O(new_n368_));
  nor2   g211(.a(new_n159_), .b(x048), .O(new_n369_));
  ...
  aoi21  g215(.a(new_n372_), .b(new_n351_), .c(x040), .O(z08));
  ...
  oai22  g220(.a(new_n175_), .b(new_n172_), .c(new_n174_), .d(new_n173_), .O(new_n378_));
  ...
  oai22  g227(.a(new_n188_), .b(new_n185_), .c(new_n187_), .d(new_n186_), .O(new_n385_));
  ...
  oai22  g234(.a(new_n201_), .b(new_n198_), .c(new_n200_), .d(new_n199_), .O(new_n392_));
  ...
  oai22  g241(.a(new_n214_), .b(new_n211_), .c(new_n213_), .d(new_n212_), .O(new_n399_));
  aoi21  g242(.a(new_n398_), .b(new_n397_), .c(new_n399_), .O(new_n400_));
  aoi21  g243(.a(new_n400_), .b(new_n396_), .c(x044), .O(z12));
  oai21  g244(.a(x125), .b(x101), .c(new_n262_), .O(new_n402_));
  nor2   g245(.a(x117), .b(x109), .O(new_n403_));
  aoi21  g246(.a(new_n403_), .b(new_n402_), .c(x069), .O(new_n404_));
  nand2  g247(.a(x021), .b(x013), .O(new_n405_));
  oai21  g248(.a(new_n263_), .b(x029), .c(new_n405_), .O(new_n406_));
  nor2   g249(.a(x117), .b(x021), .O(new_n407_));
  aoi21  g250(.a(new_n407_), .b(x125), .c(x085), .O(new_n408_));
  oai21  g251(.a(new_n240_), .b(x109), .c(x037), .O(new_n409_));
  nand2  g252(.a(new_n409_), .b(x117), .O(new_n410_));
  inv1   g253(.a(x101), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(x061), .c(new_n229_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n243_), .O(new_n413_));
  nand4  g256(.a(new_n413_), .b(new_n410_), .c(new_n408_), .d(new_n406_), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(new_n404_), .c(new_n259_), .O(new_n415_));
  nand4  g258(.a(x125), .b(new_n246_), .c(new_n243_), .d(x013), .O(new_n416_));
  aoi21  g259(.a(new_n416_), .b(new_n415_), .c(x053), .O(new_n417_));
  nand3  g260(.a(x085), .b(new_n243_), .c(new_n234_), .O(new_n418_));
  inv1   g261(.a(new_n418_), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(new_n417_), .c(x005), .O(new_n420_));
  nand3  g263(.a(new_n239_), .b(new_n225_), .c(x029), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n235_), .c(x037), .O(new_n422_));
  nor2   g265(.a(x085), .b(x053), .O(new_n423_));
  and2   g266(.a(new_n423_), .b(new_n263_), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(new_n422_), .c(x069), .O(new_n425_));
  nand2  g268(.a(new_n237_), .b(x029), .O(new_n426_));
  aoi21  g269(.a(new_n237_), .b(x029), .c(x021), .O(new_n427_));
  oai21  g270(.a(x125), .b(x101), .c(new_n405_), .O(new_n428_));
  oai22  g271(.a(new_n428_), .b(new_n426_), .c(new_n427_), .d(new_n403_), .O(new_n429_));
  nand2  g272(.a(new_n405_), .b(x029), .O(new_n430_));
  aoi21  g273(.a(new_n430_), .b(new_n255_), .c(new_n243_), .O(new_n431_));
  aoi21  g274(.a(new_n429_), .b(new_n225_), .c(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(x085), .c(new_n425_), .O(new_n433_));
  inv1   g276(.a(new_n403_), .O(new_n434_));
  aoi21  g277(.a(new_n423_), .b(new_n434_), .c(x077), .O(new_n435_));
  nor2   g278(.a(new_n235_), .b(x013), .O(new_n436_));
  nor2   g279(.a(new_n226_), .b(x053), .O(new_n437_));
  aoi22  g280(.a(new_n437_), .b(new_n436_), .c(x053), .d(x037), .O(new_n438_));
  oai21  g281(.a(new_n435_), .b(new_n234_), .c(new_n438_), .O(new_n439_));
  aoi21  g282(.a(new_n433_), .b(new_n259_), .c(new_n439_), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n420_), .c(x045), .O(z13));
  inv1   g284(.a(x102), .O(new_n442_));
  nand2  g285(.a(new_n307_), .b(new_n442_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n284_), .O(new_n444_));
  ...
  oai21  g290(.a(new_n285_), .b(x030), .c(new_n447_), .O(new_n448_));
  nor2   g291(.a(x118), .b(x022), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(x126), .c(x086), .O(new_n450_));
  oai21  g293(.a(new_n307_), .b(x110), .c(x038), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(x118), .O(new_n452_));
  nor2   g295(.a(new_n442_), .b(x062), .O(new_n453_));
  oai21  g296(.a(new_n453_), .b(x110), .c(new_n303_), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n452_), .c(new_n450_), .d(new_n448_), .O(new_n455_));
  oai21  g298(.a(new_n455_), .b(new_n446_), .c(new_n281_), .O(new_n456_));
  nand4  g299(.a(x126), .b(new_n283_), .c(new_n303_), .d(x014), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n456_), .c(x054), .O(new_n458_));
  nand3  g301(.a(x086), .b(new_n303_), .c(new_n279_), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n458_), .c(x006), .O(new_n461_));
  nand2  g304(.a(new_n289_), .b(x030), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n291_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n281_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n279_), .c(new_n445_), .O(new_n465_));
  nor2   g308(.a(new_n282_), .b(x022), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n285_), .c(x070), .O(new_n467_));
  nand4  g310(.a(new_n447_), .b(new_n443_), .c(new_n289_), .d(x030), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n467_), .c(x078), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n465_), .c(new_n278_), .O(new_n470_));
  aoi21  g313(.a(x022), .b(x014), .c(new_n282_), .O(new_n471_));
  nor2   g314(.a(x078), .b(new_n303_), .O(new_n472_));
  oai21  g315(.a(new_n471_), .b(new_n285_), .c(new_n472_), .O(new_n473_));
  ...
  aoi21  g321(.a(new_n474_), .b(new_n302_), .c(new_n478_), .O(new_n479_));
