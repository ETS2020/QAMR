...
module FAU ( 
  ...
  inv1   g64(.a(new_n85_), .O(new_n109_));
  nand3  g65(.a(x26), .b(x25), .c(x16), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n93_), .c(new_n109_), .O(new_n111_));
  nor3   g67(.a(new_n92_), .b(new_n85_), .c(x24), .O(new_n112_));
  aoi21  g68(.a(new_n111_), .b(x24), .c(new_n112_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n74_), .c(new_n65_), .O(z14));
  nand3  g70(.a(x22), .b(x20), .c(x19), .O(new_n115_));
  ...
  nand4  g75(.a(new_n93_), .b(new_n109_), .c(new_n119_), .d(x24), .O(new_n120_));
  ...
  nand4  g81(.a(x23), .b(x22), .c(x20), .d(x19), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n125_), .c(x26), .O(new_n127_));
  inv1   g83(.a(new_n115_), .O(new_n128_));
  nor2   g84(.a(x26), .b(new_n119_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n128_), .c(x24), .d(x23), .O(new_n130_));
