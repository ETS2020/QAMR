// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:12 2020
...
module FAU ( 
  ...
  nor3   g41(.a(new_n85_), .b(new_n78_), .c(new_n84_), .O(new_n86_));
  nand2  g42(.a(x20), .b(x19), .O(new_n87_));
  xnor2a g43(.a(new_n87_), .b(x21), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n86_), .c(new_n75_), .O(new_n89_));
  oai21  g45(.a(new_n55_), .b(new_n59_), .c(new_n89_), .O(z11));
  nand2  g46(.a(x23), .b(x14), .O(new_n91_));
  nand3  g47(.a(x21), .b(x20), .c(x19), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  oai21  g49(.a(new_n91_), .b(new_n78_), .c(new_n93_), .O(new_n94_));
  ...
  nand3  g57(.a(x22), .b(x20), .c(x19), .O(new_n102_));
  ...
  oai21  g63(.a(new_n55_), .b(new_n63_), .c(new_n107_), .O(z13));
  ...
  nor3   g69(.a(new_n87_), .b(new_n85_), .c(x24), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n113_), .c(new_n75_), .O(new_n115_));
  ...
  oai21  g83(.a(new_n127_), .b(new_n111_), .c(x26), .O(new_n128_));
