...
module FAU ( 
  ...
  nand3  g09(.a(new_n53_), .b(x19), .c(new_n51_), .O(new_n54_));
  nor2   g10(.a(new_n54_), .b(new_n50_), .O(new_n55_));
  nand3  g11(.a(new_n55_), .b(new_n46_), .c(x26), .O(new_n56_));
  ...
  aoi22  g65(.a(new_n109_), .b(new_n89_), .c(new_n107_), .d(x23), .O(new_n110_));
  ...
  nand3  g70(.a(new_n114_), .b(new_n112_), .c(new_n49_), .O(new_n115_));
  nor3   g71(.a(new_n113_), .b(new_n48_), .c(x24), .O(new_n116_));
  ...
  nor2   g83(.a(new_n75_), .b(x18), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n49_), .c(new_n47_), .d(new_n46_), .O(new_n129_));
  ...
  oai21  g90(.a(new_n134_), .b(new_n80_), .c(new_n73_), .O(z16));
endmodule
