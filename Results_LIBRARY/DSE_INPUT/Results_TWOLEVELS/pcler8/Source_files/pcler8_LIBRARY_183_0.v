...
module FAU ( 
  ...
  oai22  g36(.a(new_n80_), .b(new_n78_), .c(new_n59_), .d(new_n58_), .O(z09));
  ...
  oai22  g49(.a(new_n93_), .b(new_n80_), .c(new_n59_), .d(new_n63_), .O(z11));
  inv1   g50(.a(new_n87_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(x23), .c(x14), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n90_), .c(x21), .O(new_n97_));
  inv1   g53(.a(x22), .O(new_n98_));
  nand3  g54(.a(new_n90_), .b(new_n98_), .c(x21), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  aoi21  g56(.a(new_n97_), .b(x22), .c(new_n100_), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n80_), .c(new_n65_), .O(z12));
  ...
  aoi21  g65(.a(new_n106_), .b(x23), .c(new_n109_), .O(new_n110_));
  ...
  nor2   g71(.a(new_n107_), .b(new_n98_), .O(new_n116_));
  ...
  nor2   g76(.a(new_n45_), .b(x21), .O(new_n121_));
  nor2   g77(.a(x10), .b(new_n52_), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n120_), .c(new_n122_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n69_), .O(z14));
  nand2  g80(.a(x26), .b(x17), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n118_), .c(new_n116_), .d(x24), .O(new_n126_));
  nand4  g82(.a(new_n46_), .b(x24), .c(x23), .d(x22), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n117_), .O(new_n128_));
  aoi21  g84(.a(new_n126_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai22  g85(.a(new_n129_), .b(new_n80_), .c(new_n59_), .d(new_n71_), .O(z15));
  nor2   g86(.a(new_n54_), .b(x18), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n51_), .c(new_n47_), .O(new_n132_));
  ...
  oai22  g93(.a(new_n137_), .b(new_n80_), .c(new_n59_), .d(new_n73_), .O(z16));
endmodule
