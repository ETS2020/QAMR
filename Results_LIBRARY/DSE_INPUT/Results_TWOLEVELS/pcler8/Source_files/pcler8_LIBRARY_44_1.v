...
module FAU ( 
  ...
  nor2   g56(.a(x10), .b(new_n50_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  ...
  aoi22  g65(.a(new_n109_), .b(new_n88_), .c(new_n107_), .d(x23), .O(new_n110_));
  ...
  nor3   g70(.a(new_n93_), .b(new_n99_), .c(x24), .O(new_n115_));
