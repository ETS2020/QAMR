...
module FAU ( 
  ...
  nand4  g11(.a(new_n55_), .b(new_n53_), .c(new_n50_), .d(x26), .O(new_n56_));
  nor3   g12(.a(new_n56_), .b(new_n49_), .c(new_n45_), .O(z00));
  inv1   g13(.a(x00), .O(new_n58_));
  nor2   g14(.a(new_n46_), .b(new_n58_), .O(z01));
  inv1   g15(.a(x01), .O(new_n60_));
  nor2   g16(.a(new_n46_), .b(new_n60_), .O(z02));
  ...
  oai21  g36(.a(new_n46_), .b(new_n58_), .c(new_n80_), .O(z09));
  ...
  oai22  g41(.a(new_n85_), .b(new_n78_), .c(new_n46_), .d(new_n60_), .O(z10));
  nand3  g42(.a(x22), .b(x21), .c(x13), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n74_), .c(x21), .O(new_n88_));
  nand2  g44(.a(x20), .b(x19), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nor2   g46(.a(new_n90_), .b(new_n52_), .O(new_n91_));
  aoi21  g47(.a(new_n90_), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n78_), .c(new_n62_), .O(z11));
  ...
  oai21  g58(.a(new_n102_), .b(new_n78_), .c(new_n64_), .O(z12));
  ...
  oai21  g66(.a(new_n110_), .b(new_n108_), .c(new_n79_), .O(new_n111_));
  ...
  nand3  g71(.a(new_n115_), .b(new_n113_), .c(new_n55_), .O(new_n116_));
  nor3   g72(.a(new_n114_), .b(new_n54_), .c(x24), .O(new_n117_));
  aoi21  g73(.a(new_n116_), .b(x24), .c(new_n117_), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n78_), .c(new_n68_), .O(z14));
  ...
  nand3  g80(.a(new_n124_), .b(new_n122_), .c(new_n90_), .O(new_n125_));
  ...
  nand2  g84(.a(new_n128_), .b(new_n79_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n70_), .O(z15));
  nor2   g86(.a(new_n47_), .b(x18), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n55_), .c(new_n53_), .d(new_n50_), .O(new_n132_));
  nand4  g88(.a(new_n121_), .b(x25), .c(x22), .d(x21), .O(new_n133_));
  ...
  oai21  g92(.a(new_n136_), .b(new_n78_), .c(new_n72_), .O(z16));
endmodule
