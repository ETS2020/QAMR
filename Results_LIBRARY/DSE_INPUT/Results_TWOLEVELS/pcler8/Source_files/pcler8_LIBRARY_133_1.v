...
module FAU ( 
  ...
  aoi21  g59(.a(new_n73_), .b(x23), .c(new_n103_), .O(new_n104_));
  and2   g60(.a(new_n103_), .b(x23), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n104_), .c(new_n78_), .O(new_n106_));
  ...
  oai21  g70(.a(new_n114_), .b(new_n77_), .c(new_n67_), .O(z14));
  ...
  oai21  g79(.a(new_n123_), .b(new_n77_), .c(new_n69_), .O(z15));
  nor2   g80(.a(new_n52_), .b(x18), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n49_), .c(new_n45_), .O(new_n126_));
  inv1   g82(.a(x26), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(x25), .c(x24), .d(x23), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(new_n103_), .O(new_n129_));
  aoi21  g85(.a(new_n126_), .b(x26), .c(new_n129_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n77_), .c(new_n71_), .O(z16));
endmodule
