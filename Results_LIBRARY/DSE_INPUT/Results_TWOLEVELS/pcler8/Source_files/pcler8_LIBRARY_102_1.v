...
module FAU ( 
  ...
  oai22  g75(.a(new_n119_), .b(new_n78_), .c(new_n57_), .d(new_n67_), .O(z14));
  ...
  oai22  g84(.a(new_n128_), .b(new_n78_), .c(new_n57_), .d(new_n69_), .O(z15));
  ...
  nor2   g89(.a(new_n133_), .b(new_n103_), .O(new_n134_));
  aoi21  g90(.a(new_n131_), .b(x26), .c(new_n134_), .O(new_n135_));
