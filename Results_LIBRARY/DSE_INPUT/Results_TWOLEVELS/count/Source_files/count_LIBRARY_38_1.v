...
module FAU ( 
  ...
  nor2   g130(.a(new_n181_), .b(new_n90_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(x33), .c(x16), .O(new_n183_));
  inv1   g132(.a(x01), .O(new_n184_));
  aoi21  g133(.a(new_n58_), .b(new_n184_), .c(x18), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n183_), .O(z14));
  oai21  g135(.a(new_n181_), .b(new_n90_), .c(x34), .O(new_n187_));
  inv1   g136(.a(x34), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n171_), .c(new_n168_), .d(new_n123_), .O(new_n189_));
