...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n179_, new_n180_, new_n181_, new_n183_, new_n185_;
  ...
  nand4  g026(.a(new_n55_), .b(new_n76_), .c(new_n77_), .d(new_n61_), .O(new_n78_));
  ...
  nand3  g033(.a(new_n84_), .b(new_n64_), .c(new_n77_), .O(new_n85_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n92_), .c(new_n55_), .d(new_n101_), .O(new_n103_));
  nand3  g052(.a(new_n93_), .b(new_n76_), .c(new_n77_), .O(new_n104_));
  nor2   g053(.a(new_n104_), .b(new_n63_), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n100_), .c(new_n103_), .O(new_n106_));
  ...
  nand2  g060(.a(new_n102_), .b(new_n111_), .O(new_n112_));
  nand3  g061(.a(new_n84_), .b(new_n69_), .c(new_n55_), .O(new_n113_));
  nor2   g062(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g063(.a(new_n102_), .b(new_n84_), .O(new_n115_));
  inv1   g064(.a(new_n115_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n71_), .O(new_n117_));
  aoi21  g066(.a(new_n117_), .b(x26), .c(new_n114_), .O(new_n118_));
  ...
  nand4  g071(.a(new_n122_), .b(new_n84_), .c(new_n71_), .d(new_n91_), .O(new_n123_));
  inv1   g072(.a(new_n112_), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n84_), .c(new_n71_), .O(new_n125_));
  ...
  nand2  g082(.a(new_n122_), .b(new_n93_), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n78_), .c(x28), .O(new_n135_));
  oai21  g084(.a(new_n133_), .b(new_n117_), .c(new_n135_), .O(new_n136_));
  ...
  nand4  g092(.a(new_n124_), .b(new_n143_), .c(new_n142_), .d(new_n141_), .O(new_n144_));
  nand3  g093(.a(new_n132_), .b(new_n102_), .c(new_n101_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n78_), .c(x29), .O(new_n146_));
  oai21  g095(.a(new_n144_), .b(new_n113_), .c(new_n146_), .O(new_n147_));
  ...
  nand4  g102(.a(new_n116_), .b(new_n142_), .c(new_n141_), .d(new_n111_), .O(new_n154_));
  nor2   g103(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  or2    g104(.a(new_n144_), .b(new_n85_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(x30), .c(new_n155_), .O(new_n157_));
  ...
  nand4  g109(.a(new_n152_), .b(new_n124_), .c(new_n142_), .d(new_n141_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n85_), .c(x31), .O(new_n162_));
  inv1   g111(.a(x30), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n163_), .c(new_n143_), .d(new_n142_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n122_), .c(new_n105_), .O(new_n167_));
  ...
  nand4  g121(.a(new_n164_), .b(new_n163_), .c(new_n143_), .d(new_n142_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n141_), .c(new_n111_), .d(new_n100_), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(x24), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n101_), .c(new_n76_), .d(new_n77_), .O(new_n177_));
  and2   g126(.a(new_n63_), .b(x32), .O(new_n178_));
  aoi21  g127(.a(new_n177_), .b(new_n64_), .c(new_n178_), .O(new_n179_));
  inv1   g128(.a(x02), .O(new_n180_));
  aoi21  g129(.a(new_n58_), .b(new_n180_), .c(x18), .O(new_n181_));
  oai21  g130(.a(new_n179_), .b(new_n58_), .c(new_n181_), .O(z13));
  aoi21  g131(.a(x33), .b(x16), .c(x18), .O(new_n183_));
  oai21  g132(.a(x16), .b(x01), .c(new_n183_), .O(z14));
  aoi21  g133(.a(x34), .b(x16), .c(x18), .O(new_n185_));
  oai21  g134(.a(x16), .b(x00), .c(new_n185_), .O(z15));
endmodule
