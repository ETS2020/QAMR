...
module FAU ( 
  ...
  xor2a  g016(.a(new_n55_), .b(x21), .O(new_n68_));
  nand2  g017(.a(new_n68_), .b(new_n61_), .O(new_n69_));
  nand3  g018(.a(x21), .b(x20), .c(x16), .O(new_n70_));
  inv1   g019(.a(x13), .O(new_n71_));
  aoi21  g020(.a(new_n58_), .b(new_n71_), .c(x18), .O(new_n72_));
  nand3  g021(.a(new_n72_), .b(new_n70_), .c(new_n69_), .O(z02));
  ...
  oai21  g058(.a(new_n100_), .b(new_n105_), .c(new_n109_), .O(new_n110_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n89_), .c(new_n98_), .O(new_n116_));
  ...
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n105_), .d(new_n97_), .O(new_n126_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n108_), .c(new_n82_), .d(new_n63_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n107_), .b(new_n55_), .c(new_n74_), .d(new_n61_), .O(new_n140_));
  ...
  nand3  g102(.a(new_n153_), .b(new_n122_), .c(new_n91_), .O(new_n154_));
  ...
  nand4  g108(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n98_), .O(new_n160_));
  ...
  nand4  g121(.a(new_n172_), .b(new_n151_), .c(new_n150_), .d(new_n115_), .O(new_n173_));
  ...
  nand4  g129(.a(new_n124_), .b(new_n107_), .c(new_n106_), .d(new_n55_), .O(new_n181_));
  oai21  g130(.a(new_n173_), .b(new_n181_), .c(x34), .O(new_n182_));
  nand2  g131(.a(new_n150_), .b(new_n115_), .O(new_n183_));
  ...
  nand3  g141(.a(new_n192_), .b(new_n184_), .c(new_n100_), .O(new_n193_));
