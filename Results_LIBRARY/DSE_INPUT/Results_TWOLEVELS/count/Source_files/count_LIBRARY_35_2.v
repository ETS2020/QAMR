...
module FAU ( 
  ...
  nand4  g127(.a(new_n178_), .b(new_n155_), .c(new_n133_), .d(new_n105_), .O(new_n179_));
  nor3   g128(.a(new_n179_), .b(new_n99_), .c(new_n63_), .O(new_n180_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n144_), .c(new_n143_), .d(new_n77_), .O(new_n187_));
  aoi21  g136(.a(new_n187_), .b(new_n53_), .c(new_n63_), .O(new_n188_));
  nand2  g137(.a(new_n152_), .b(new_n128_), .O(new_n189_));
  ...
  aoi21  g143(.a(new_n192_), .b(new_n100_), .c(new_n194_), .O(new_n195_));
  oai21  g144(.a(new_n188_), .b(new_n185_), .c(new_n195_), .O(z13));
  ...
  nand4  g158(.a(new_n202_), .b(new_n178_), .c(new_n155_), .d(new_n126_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n129_), .c(new_n53_), .O(new_n211_));
  aoi21  g160(.a(new_n211_), .b(new_n64_), .c(new_n209_), .O(new_n212_));
  nand3  g161(.a(new_n202_), .b(new_n178_), .c(new_n209_), .O(new_n213_));
