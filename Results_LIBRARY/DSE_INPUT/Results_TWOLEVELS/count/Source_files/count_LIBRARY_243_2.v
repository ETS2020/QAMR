...
module FAU ( 
  ...
  aoi22  g031(.a(new_n82_), .b(new_n75_), .c(new_n81_), .d(x23), .O(new_n83_));
  ...
  nand4  g036(.a(new_n87_), .b(new_n55_), .c(new_n68_), .d(new_n61_), .O(new_n88_));
  ...
  nand3  g059(.a(new_n110_), .b(new_n87_), .c(new_n70_), .O(new_n111_));
  ...
  nand4  g073(.a(new_n124_), .b(new_n89_), .c(new_n76_), .d(new_n75_), .O(new_n125_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n110_), .c(new_n82_), .d(new_n75_), .O(new_n136_));
