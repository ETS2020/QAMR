...
module FAU ( 
  ...
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n98_), .O(new_n127_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n126_), .c(new_n141_), .d(new_n99_), .O(new_n143_));
  ...
  nand4  g113(.a(new_n164_), .b(new_n133_), .c(new_n163_), .d(new_n162_), .O(new_n165_));
  ...
  nand4  g124(.a(new_n124_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n176_));
  nand4  g125(.a(new_n97_), .b(new_n69_), .c(new_n53_), .d(new_n52_), .O(new_n177_));
  ...
  nor2   g133(.a(new_n184_), .b(new_n165_), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n180_), .c(new_n178_), .O(new_n186_));
  nand4  g135(.a(new_n167_), .b(new_n142_), .c(new_n126_), .d(new_n141_), .O(new_n187_));
  ...
  nor2   g142(.a(x32), .b(x21), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n151_), .c(new_n55_), .d(new_n183_), .O(new_n195_));
  nand4  g144(.a(new_n150_), .b(new_n115_), .c(new_n125_), .d(new_n87_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n195_), .c(x34), .O(new_n197_));
  nand2  g146(.a(new_n150_), .b(new_n115_), .O(new_n198_));
  inv1   g147(.a(new_n198_), .O(new_n199_));
  nand2  g148(.a(new_n181_), .b(new_n164_), .O(new_n200_));
  nand3  g149(.a(new_n179_), .b(new_n183_), .c(new_n182_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n200_), .O(new_n202_));
  nand3  g151(.a(new_n202_), .b(new_n199_), .c(new_n102_), .O(new_n203_));
