...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n59_,
    ...
    new_n166_, new_n168_, new_n170_, new_n172_;
  ...
  nand3  g049(.a(new_n100_), .b(new_n90_), .c(new_n52_), .O(new_n101_));
  nand2  g050(.a(new_n91_), .b(new_n74_), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(new_n61_), .c(x25), .O(new_n103_));
  ...
  nand2  g058(.a(new_n98_), .b(new_n109_), .O(new_n110_));
  inv1   g059(.a(new_n110_), .O(new_n111_));
  nand3  g060(.a(new_n82_), .b(new_n67_), .c(new_n52_), .O(new_n112_));
  inv1   g061(.a(new_n112_), .O(new_n113_));
  nand3  g062(.a(new_n98_), .b(new_n82_), .c(new_n69_), .O(new_n114_));
  aoi22  g063(.a(new_n114_), .b(x26), .c(new_n113_), .d(new_n111_), .O(new_n115_));
  ...
  nand3  g069(.a(new_n111_), .b(new_n82_), .c(new_n69_), .O(new_n121_));
  ...
  nand2  g078(.a(new_n119_), .b(new_n91_), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(new_n75_), .c(x28), .O(new_n131_));
  oai21  g080(.a(new_n129_), .b(new_n114_), .c(new_n131_), .O(new_n132_));
  ...
  inv1   g085(.a(new_n128_), .O(new_n137_));
  nor3   g086(.a(new_n137_), .b(new_n110_), .c(x29), .O(new_n138_));
  nand2  g087(.a(new_n138_), .b(new_n113_), .O(new_n139_));
  nand3  g088(.a(new_n128_), .b(new_n100_), .c(new_n109_), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n75_), .c(x29), .O(new_n141_));
  ...
  aoi21  g096(.a(new_n138_), .b(new_n84_), .c(new_n147_), .O(new_n148_));
  nor4   g097(.a(new_n137_), .b(new_n110_), .c(x30), .d(x29), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n84_), .c(new_n148_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n147_), .b(new_n158_), .c(new_n157_), .d(new_n156_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(x26), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n155_), .c(new_n89_), .d(new_n154_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(x22), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n52_), .c(new_n81_), .d(new_n59_), .O(new_n163_));
  ...
  oai21  g117(.a(x16), .b(x02), .c(new_n168_), .O(z13));
  aoi21  g118(.a(x33), .b(x16), .c(x18), .O(new_n170_));
  oai21  g119(.a(x16), .b(x01), .c(new_n170_), .O(z14));
  aoi21  g120(.a(x34), .b(x16), .c(x18), .O(new_n172_));
  oai21  g121(.a(x16), .b(x00), .c(new_n172_), .O(z15));
endmodule
