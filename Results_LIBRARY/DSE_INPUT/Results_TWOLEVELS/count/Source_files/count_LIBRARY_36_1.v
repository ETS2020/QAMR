...
module FAU ( 
  ...
  oai21  g080(.a(new_n127_), .b(x29), .c(x16), .O(new_n132_));
  inv1   g081(.a(x05), .O(new_n133_));
  aoi21  g082(.a(new_n58_), .b(new_n133_), .c(x18), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n132_), .O(z10));
  oai21  g084(.a(new_n126_), .b(new_n81_), .c(x30), .O(new_n136_));
  nor3   g085(.a(x30), .b(x28), .c(x27), .O(new_n137_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n125_), .c(new_n145_), .d(new_n87_), .O(new_n147_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n121_), .c(new_n155_), .d(new_n63_), .O(new_n162_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n159_), .c(new_n123_), .d(new_n98_), .O(new_n176_));
  ...
  nand4  g133(.a(new_n184_), .b(new_n146_), .c(new_n125_), .d(new_n145_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n90_), .c(x34), .O(new_n186_));
  inv1   g135(.a(x34), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n175_), .c(new_n172_), .d(new_n123_), .O(new_n188_));
