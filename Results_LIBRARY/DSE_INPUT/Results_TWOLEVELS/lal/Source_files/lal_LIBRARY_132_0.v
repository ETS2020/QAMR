// Benchmark "FAU" written by ABC on Thu Jun 25 18:07:58 2020
...
module FAU ( 
  ...
  nand3  g48(.a(new_n93_), .b(new_n87_), .c(x19), .O(new_n94_));
  ...
  nand3  g53(.a(new_n93_), .b(new_n98_), .c(new_n97_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n96_), .c(new_n86_), .O(z15));
  nand2  g55(.a(new_n93_), .b(new_n97_), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(new_n89_), .c(x23), .O(new_n102_));
  nor2   g57(.a(x23), .b(x22), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n93_), .c(new_n98_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n86_), .O(z16));
  nand4  g60(.a(new_n58_), .b(x19), .c(x18), .d(x17), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n74_), .O(new_n107_));
  inv1   g62(.a(new_n88_), .O(new_n108_));
  oai21  g63(.a(x22), .b(x21), .c(new_n108_), .O(new_n109_));
  nand2  g64(.a(x24), .b(x23), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n74_), .c(new_n49_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n109_), .c(new_n107_), .O(z17));
  nand3  g68(.a(new_n74_), .b(new_n58_), .c(new_n48_), .O(z18));
  buf    g69(.a(x16), .O(z02));
endmodule
