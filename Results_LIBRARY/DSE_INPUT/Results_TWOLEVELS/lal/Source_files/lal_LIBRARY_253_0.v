...
module FAU ( 
  ...
  nor2   g36(.a(x22), .b(x20), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(x18), .c(x17), .O(new_n83_));
  ...
  aoi21  g42(.a(new_n87_), .b(new_n84_), .c(new_n80_), .O(z12));
  nand2  g43(.a(new_n74_), .b(x20), .O(new_n89_));
  nand2  g44(.a(new_n85_), .b(new_n58_), .O(new_n90_));
  oai22  g45(.a(new_n90_), .b(new_n89_), .c(new_n85_), .d(x20), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(x19), .O(new_n92_));
  nand2  g47(.a(x20), .b(new_n52_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n92_), .c(new_n74_), .d(new_n58_), .O(z13));
  inv1   g49(.a(x21), .O(new_n95_));
  nor2   g50(.a(x20), .b(new_n52_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n86_), .c(new_n95_), .O(new_n97_));
  inv1   g52(.a(new_n96_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n85_), .c(x21), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n97_), .c(new_n74_), .d(new_n58_), .O(z14));
  inv1   g55(.a(x22), .O(new_n101_));
  oai22  g56(.a(new_n101_), .b(x18), .c(x20), .d(x17), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(x19), .c(new_n59_), .O(new_n103_));
  nand3  g58(.a(new_n96_), .b(new_n86_), .c(x21), .O(new_n104_));
  nand2  g59(.a(new_n98_), .b(x22), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n74_), .O(z15));
