...
module FAU ( 
  ...
  nand2  g13(.a(z08), .b(new_n48_), .O(z01));
  ...
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(x19), .O(new_n78_));
  nor2   g32(.a(new_n52_), .b(new_n51_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  aoi21  g34(.a(new_n80_), .b(new_n78_), .c(new_n74_), .O(z12));
  nand2  g35(.a(new_n73_), .b(new_n52_), .O(new_n82_));
  ...
  nand4  g66(.a(new_n108_), .b(new_n97_), .c(new_n107_), .d(new_n49_), .O(new_n113_));
