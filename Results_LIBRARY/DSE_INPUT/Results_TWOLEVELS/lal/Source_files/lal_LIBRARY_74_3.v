...
module FAU ( 
  ...
  nand3  g50(.a(x18), .b(new_n77_), .c(new_n95_), .O(new_n96_));
  nand2  g51(.a(new_n79_), .b(x17), .O(new_n97_));
  inv1   g52(.a(x15), .O(new_n98_));
  nand2  g53(.a(new_n54_), .b(new_n98_), .O(new_n99_));
  aoi21  g54(.a(new_n97_), .b(new_n96_), .c(new_n99_), .O(z11));
  xor2a  g55(.a(x19), .b(x18), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x17), .O(new_n102_));
  nand3  g57(.a(x19), .b(new_n77_), .c(new_n95_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n102_), .c(new_n99_), .O(z12));
  nand3  g59(.a(x19), .b(x18), .c(x17), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n90_), .c(new_n71_), .d(new_n54_), .O(z13));
  inv1   g62(.a(new_n105_), .O(new_n108_));
  nor2   g63(.a(x21), .b(x20), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g65(.a(new_n71_), .b(x21), .O(new_n111_));
  nand2  g66(.a(new_n90_), .b(new_n54_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(z14));
  nand2  g69(.a(new_n110_), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n108_), .b(new_n72_), .c(new_n70_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n115_), .c(new_n113_), .O(z15));
  nand2  g72(.a(new_n116_), .b(x23), .O(new_n118_));
  nor2   g73(.a(x23), .b(x22), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n109_), .c(new_n108_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n113_), .O(z16));
  inv1   g76(.a(new_n74_), .O(new_n122_));
  ...
  nand4  g80(.a(new_n86_), .b(new_n72_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
