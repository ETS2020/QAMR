...
module FAU ( 
  ...
  nand2  g52(.a(x18), .b(new_n79_), .O(new_n98_));
  inv1   g53(.a(x07), .O(new_n99_));
  nand3  g54(.a(new_n81_), .b(x17), .c(new_n99_), .O(new_n100_));
  nand2  g55(.a(new_n56_), .b(new_n95_), .O(new_n101_));
  aoi21  g56(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z11));
  nor2   g57(.a(new_n82_), .b(x18), .O(new_n103_));
  nor3   g58(.a(x19), .b(new_n81_), .c(new_n79_), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(new_n105_));
  nand2  g60(.a(x19), .b(new_n79_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n105_), .c(new_n101_), .O(z12));
