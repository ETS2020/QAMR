...
module FAU ( 
  ...
  nand3  g010(.a(new_n35_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  ...
  oai22  g032(.a(new_n65_), .b(new_n64_), .c(x10), .d(x02), .O(new_n66_));
  ...
  aoi21  g109(.a(new_n74_), .b(x04), .c(x17), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n104_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n71_), .c(x08), .O(new_n145_));
  nand4  g112(.a(new_n35_), .b(new_n43_), .c(new_n42_), .d(x00), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(new_n41_), .c(new_n40_), .O(new_n147_));
  aoi21  g114(.a(new_n37_), .b(x05), .c(new_n147_), .O(new_n148_));
  inv1   g115(.a(x04), .O(new_n149_));
  aoi21  g116(.a(x23), .b(new_n149_), .c(new_n72_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n73_), .c(x09), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(x16), .c(new_n107_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n121_), .c(new_n148_), .d(new_n145_), .O(z4));
  inv1   g120(.a(new_n148_), .O(z5));
  oai21  g121(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n48_), .c(x03), .O(new_n156_));
  nand3  g123(.a(new_n132_), .b(new_n78_), .c(x18), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(new_n34_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n99_), .O(new_n159_));
  nor2   g126(.a(new_n65_), .b(x24), .O(new_n160_));
  or2    g127(.a(new_n160_), .b(new_n39_), .O(new_n161_));
  nand3  g128(.a(new_n132_), .b(new_n78_), .c(x15), .O(new_n162_));
  oai21  g129(.a(new_n156_), .b(new_n64_), .c(new_n162_), .O(new_n163_));
  nand2  g130(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g131(.a(new_n116_), .b(x05), .O(new_n165_));
  inv1   g132(.a(new_n118_), .O(new_n166_));
  aoi21  g133(.a(new_n39_), .b(x15), .c(new_n166_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n117_), .c(new_n165_), .O(z7));
  inv1   g135(.a(new_n146_), .O(new_n169_));
  inv1   g136(.a(x03), .O(new_n170_));
  nand2  g137(.a(new_n155_), .b(new_n48_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  oai21  g139(.a(new_n48_), .b(x06), .c(x03), .O(new_n173_));
  aoi22  g140(.a(new_n173_), .b(z7), .c(new_n172_), .d(new_n169_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n164_), .c(new_n159_), .O(z6));
endmodule
