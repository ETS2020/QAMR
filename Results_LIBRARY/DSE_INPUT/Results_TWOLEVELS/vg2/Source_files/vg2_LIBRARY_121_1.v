...
module FAU ( 
  ...
  nand4  g046(.a(new_n79_), .b(new_n47_), .c(new_n78_), .d(new_n77_), .O(new_n80_));
  ...
  nand3  g052(.a(x12), .b(x11), .c(x09), .O(new_n86_));
  inv1   g053(.a(new_n86_), .O(new_n87_));
  nand4  g054(.a(new_n87_), .b(new_n85_), .c(x06), .d(x04), .O(new_n88_));
  nor2   g055(.a(new_n79_), .b(new_n47_), .O(new_n89_));
  and2   g056(.a(x20), .b(x18), .O(new_n90_));
  nor2   g057(.a(new_n75_), .b(new_n74_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(x17), .O(new_n92_));
  inv1   g059(.a(x07), .O(new_n93_));
  nor2   g060(.a(x12), .b(new_n93_), .O(new_n94_));
  nor2   g061(.a(x23), .b(x22), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n70_), .d(new_n50_), .O(new_n96_));
  nor2   g063(.a(x16), .b(x14), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n49_), .c(new_n73_), .d(new_n68_), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n96_), .c(new_n92_), .d(new_n88_), .O(new_n99_));
  ...
  nand3  g070(.a(new_n103_), .b(new_n91_), .c(new_n89_), .O(new_n104_));
  nor2   g071(.a(x14), .b(x12), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n95_), .c(new_n70_), .d(new_n50_), .O(new_n106_));
  nor2   g073(.a(x17), .b(x16), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n49_), .c(x19), .d(new_n68_), .O(new_n108_));
  oai22  g075(.a(new_n108_), .b(new_n106_), .c(new_n104_), .d(new_n88_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n39_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n101_), .c(new_n84_), .O(z1));
  ...
  nand3  g081(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n115_));
  ...
  nor2   g086(.a(new_n48_), .b(new_n47_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n85_), .c(x11), .d(x06), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n119_), .O(z2));
  aoi21  g089(.a(new_n55_), .b(new_n53_), .c(new_n121_), .O(new_n123_));
  inv1   g090(.a(x08), .O(new_n124_));
  nand4  g091(.a(new_n50_), .b(new_n49_), .c(new_n47_), .d(new_n124_), .O(new_n125_));
  aoi21  g092(.a(new_n66_), .b(new_n65_), .c(new_n125_), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(new_n123_), .c(new_n36_), .O(new_n127_));
  nand2  g094(.a(new_n49_), .b(new_n69_), .O(new_n128_));
  nand4  g095(.a(new_n47_), .b(new_n77_), .c(new_n124_), .d(x07), .O(new_n129_));
  nand2  g096(.a(new_n85_), .b(x06), .O(new_n130_));
  nand4  g097(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n132_));
  nand4  g099(.a(x19), .b(new_n47_), .c(new_n77_), .d(new_n124_), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n130_), .c(new_n133_), .d(new_n128_), .O(new_n135_));
  aoi22  g102(.a(new_n135_), .b(new_n39_), .c(new_n132_), .d(new_n100_), .O(new_n136_));
  ...
  aoi21  g107(.a(new_n140_), .b(new_n79_), .c(x08), .O(new_n141_));
  aoi21  g108(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n74_), .c(x09), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(x16), .c(new_n124_), .O(new_n144_));
  oai22  g111(.a(new_n144_), .b(new_n119_), .c(new_n141_), .d(new_n46_), .O(z4));
  inv1   g112(.a(new_n46_), .O(z5));
  oai21  g113(.a(new_n48_), .b(x14), .c(new_n69_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n77_), .c(x03), .O(new_n148_));
  inv1   g115(.a(x03), .O(new_n149_));
  oai21  g116(.a(x20), .b(new_n47_), .c(x06), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x11), .c(new_n149_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n119_), .c(new_n148_), .d(new_n46_), .O(z6));
  inv1   g119(.a(new_n119_), .O(z7));
endmodule
