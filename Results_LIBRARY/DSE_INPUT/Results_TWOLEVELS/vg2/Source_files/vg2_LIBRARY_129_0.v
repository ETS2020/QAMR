...
module FAU ( 
  ...
  nand4  g060(.a(new_n93_), .b(new_n91_), .c(new_n67_), .d(new_n50_), .O(new_n94_));
  ...
  nand4  g071(.a(new_n76_), .b(new_n75_), .c(new_n48_), .d(new_n104_), .O(new_n105_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n86_), .c(new_n56_), .d(x20), .O(new_n125_));
  nor2   g092(.a(x08), .b(x06), .O(new_n126_));
  nand2  g093(.a(new_n54_), .b(x00), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n64_), .O(new_n128_));
  nor3   g095(.a(x20), .b(x14), .c(x11), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n128_), .c(new_n126_), .d(new_n49_), .O(new_n130_));
  ...
  oai22  g115(.a(new_n148_), .b(new_n121_), .c(new_n144_), .d(new_n46_), .O(z4));
