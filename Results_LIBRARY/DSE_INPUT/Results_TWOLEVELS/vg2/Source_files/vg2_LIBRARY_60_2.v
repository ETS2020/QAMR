...
module FAU ( 
  ...
  nand2  g19(.a(x13), .b(x05), .O(new_n53_));
  ...
  nor3   g50(.a(new_n79_), .b(new_n75_), .c(new_n69_), .O(new_n84_));
  nand2  g51(.a(x24), .b(x18), .O(new_n85_));
  oai21  g52(.a(x13), .b(x05), .c(new_n85_), .O(new_n86_));
  nand3  g53(.a(new_n86_), .b(new_n62_), .c(new_n59_), .O(new_n87_));
  inv1   g54(.a(new_n87_), .O(new_n88_));
  oai21  g55(.a(new_n39_), .b(new_n35_), .c(new_n40_), .O(new_n89_));
  aoi21  g56(.a(new_n89_), .b(new_n84_), .c(new_n88_), .O(new_n90_));
  nand2  g57(.a(new_n90_), .b(new_n83_), .O(z1));
  aoi21  g58(.a(new_n56_), .b(new_n36_), .c(new_n86_), .O(new_n92_));
  nand4  g59(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n93_));
  nor3   g60(.a(new_n93_), .b(new_n92_), .c(new_n57_), .O(z2));
  nand2  g61(.a(x11), .b(x06), .O(new_n95_));
  nand3  g62(.a(x20), .b(x14), .c(x08), .O(new_n96_));
  nor3   g63(.a(new_n96_), .b(new_n95_), .c(new_n57_), .O(new_n97_));
  inv1   g64(.a(x08), .O(new_n98_));
  nand3  g65(.a(new_n78_), .b(new_n77_), .c(new_n98_), .O(new_n99_));
  nand3  g66(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n100_));
  nor2   g67(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  aoi22  g68(.a(new_n101_), .b(new_n66_), .c(new_n97_), .d(new_n56_), .O(new_n102_));
  aoi22  g69(.a(new_n101_), .b(new_n89_), .c(new_n97_), .d(new_n86_), .O(new_n103_));
  oai21  g70(.a(new_n102_), .b(x24), .c(new_n103_), .O(z3));
  inv1   g71(.a(x09), .O(new_n105_));
  aoi21  g72(.a(new_n74_), .b(x04), .c(x17), .O(new_n106_));
  oai21  g73(.a(new_n106_), .b(x22), .c(new_n105_), .O(new_n107_));
  aoi21  g74(.a(new_n107_), .b(new_n71_), .c(x08), .O(new_n108_));
  inv1   g75(.a(x04), .O(new_n109_));
  aoi21  g76(.a(x23), .b(new_n109_), .c(new_n72_), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(new_n73_), .c(x09), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(x16), .c(new_n98_), .O(new_n112_));
  nand3  g79(.a(new_n36_), .b(x15), .c(x13), .O(new_n113_));
  aoi21  g80(.a(new_n113_), .b(new_n85_), .c(new_n34_), .O(new_n114_));
  nand3  g81(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n115_));
  ...
  oai22  g86(.a(new_n119_), .b(new_n112_), .c(new_n108_), .d(new_n46_), .O(z4));
  inv1   g87(.a(new_n46_), .O(z5));
  nand2  g88(.a(x20), .b(new_n77_), .O(new_n122_));
  nand2  g89(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  aoi21  g90(.a(new_n123_), .b(new_n48_), .c(x03), .O(new_n124_));
  inv1   g91(.a(x03), .O(new_n125_));
  nand2  g92(.a(new_n78_), .b(x14), .O(new_n126_));
  nand2  g93(.a(new_n126_), .b(x06), .O(new_n127_));
  aoi21  g94(.a(new_n127_), .b(x11), .c(new_n125_), .O(new_n128_));
  oai22  g95(.a(new_n128_), .b(new_n119_), .c(new_n124_), .d(new_n46_), .O(z6));
  inv1   g96(.a(new_n119_), .O(z7));
endmodule
