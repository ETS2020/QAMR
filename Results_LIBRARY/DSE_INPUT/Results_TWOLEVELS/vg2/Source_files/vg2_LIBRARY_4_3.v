...
module FAU ( 
  ...
  nand4  g020(.a(new_n34_), .b(new_n38_), .c(new_n37_), .d(x00), .O(new_n54_));
  ...
  nand3  g063(.a(new_n35_), .b(x19), .c(new_n34_), .O(new_n97_));
  ...
  nand2  g086(.a(x14), .b(x11), .O(new_n120_));
  nor4   g087(.a(new_n120_), .b(new_n87_), .c(new_n71_), .d(new_n49_), .O(new_n121_));
  ...
  aoi21  g091(.a(new_n62_), .b(x04), .c(x17), .O(new_n125_));
  ...
  aoi21  g098(.a(x23), .b(new_n131_), .c(new_n67_), .O(new_n132_));
  ...
  nand3  g110(.a(new_n39_), .b(x19), .c(x05), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n96_), .O(new_n145_));
  nor2   g112(.a(x20), .b(x06), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x11), .c(new_n114_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g115(.a(new_n39_), .b(x15), .c(x05), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n135_), .O(new_n150_));
  oai21  g117(.a(new_n64_), .b(x06), .c(x03), .O(new_n151_));
  ...
  nor2   g121(.a(new_n120_), .b(x20), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n102_), .O(new_n156_));
  aoi21  g123(.a(x20), .b(new_n34_), .c(x06), .O(new_n157_));
  oai21  g124(.a(new_n157_), .b(x11), .c(new_n114_), .O(new_n158_));
  nand3  g125(.a(x24), .b(x07), .c(x05), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n40_), .c(new_n36_), .O(new_n160_));
  nand3  g127(.a(new_n138_), .b(new_n101_), .c(new_n85_), .O(new_n161_));
  aoi22  g128(.a(new_n161_), .b(new_n151_), .c(new_n160_), .d(new_n158_), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n156_), .c(new_n154_), .O(z6));
