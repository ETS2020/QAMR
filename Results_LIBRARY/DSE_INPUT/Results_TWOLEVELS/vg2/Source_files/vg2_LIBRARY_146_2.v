...
module FAU ( 
  ...
  nand4  g062(.a(new_n95_), .b(new_n49_), .c(new_n71_), .d(new_n94_), .O(new_n96_));
  ...
  nand4  g101(.a(new_n134_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n123_), .c(new_n133_), .d(new_n83_), .O(new_n136_));
  aoi22  g103(.a(new_n136_), .b(new_n39_), .c(new_n132_), .d(new_n98_), .O(new_n137_));
  ...
  aoi21  g109(.a(x23), .b(new_n94_), .c(new_n71_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n72_), .c(x09), .O(new_n144_));
  ...
  oai21  g114(.a(new_n134_), .b(x14), .c(new_n47_), .O(new_n148_));
