...
module FAU ( 
  ...
  nand4  g22(.a(new_n55_), .b(new_n49_), .c(new_n54_), .d(new_n53_), .O(new_n56_));
  inv1   g23(.a(new_n56_), .O(new_n57_));
  nor2   g24(.a(x17), .b(x16), .O(new_n58_));
  ...
  nand4  g30(.a(new_n63_), .b(new_n59_), .c(new_n58_), .d(new_n57_), .O(new_n64_));
  ...
  nand4  g63(.a(new_n48_), .b(new_n47_), .c(new_n53_), .d(x07), .O(new_n97_));
  oai22  g64(.a(new_n97_), .b(new_n94_), .c(new_n96_), .d(new_n95_), .O(new_n98_));
  nor2   g65(.a(new_n39_), .b(new_n36_), .O(new_n99_));
  nand4  g66(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n100_));
  nand4  g67(.a(new_n48_), .b(x19), .c(new_n47_), .d(new_n53_), .O(new_n101_));
  oai22  g68(.a(new_n101_), .b(new_n94_), .c(new_n100_), .d(new_n95_), .O(new_n102_));
  aoi22  g69(.a(new_n102_), .b(new_n39_), .c(new_n99_), .d(new_n98_), .O(new_n103_));
  nand2  g70(.a(new_n103_), .b(new_n90_), .O(z3));
  oai21  g71(.a(x22), .b(new_n54_), .c(x16), .O(new_n105_));
  nand2  g72(.a(new_n105_), .b(x08), .O(new_n106_));
  oai21  g73(.a(new_n73_), .b(new_n68_), .c(new_n106_), .O(new_n107_));
  inv1   g74(.a(x16), .O(new_n108_));
  inv1   g75(.a(x23), .O(new_n109_));
  aoi21  g76(.a(new_n109_), .b(x04), .c(x17), .O(new_n110_));
  oai21  g77(.a(new_n110_), .b(x22), .c(new_n54_), .O(new_n111_));
  aoi21  g78(.a(new_n111_), .b(new_n108_), .c(x08), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(new_n46_), .c(new_n107_), .O(z4));
