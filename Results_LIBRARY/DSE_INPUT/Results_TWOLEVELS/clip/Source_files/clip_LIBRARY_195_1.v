...
module FAU ( 
  ...
  nand3  g076(.a(new_n21_), .b(new_n50_), .c(x3), .O(new_n91_));
  nand2  g077(.a(new_n25_), .b(x6), .O(new_n92_));
  aoi21  g078(.a(new_n91_), .b(new_n40_), .c(new_n92_), .O(new_n93_));
  nand2  g079(.a(new_n44_), .b(x2), .O(new_n94_));
  oai21  g080(.a(new_n64_), .b(x2), .c(new_n94_), .O(new_n95_));
  nand2  g081(.a(new_n95_), .b(x1), .O(new_n96_));
  nand2  g082(.a(new_n44_), .b(x4), .O(new_n97_));
  aoi21  g083(.a(new_n97_), .b(new_n96_), .c(new_n84_), .O(new_n98_));
  oai21  g084(.a(new_n98_), .b(new_n93_), .c(x7), .O(new_n99_));
  inv1   g085(.a(new_n84_), .O(new_n100_));
  nand2  g086(.a(new_n21_), .b(x3), .O(new_n101_));
  and2   g087(.a(new_n101_), .b(new_n40_), .O(new_n102_));
  ...
  oai22  g096(.a(new_n110_), .b(new_n85_), .c(new_n97_), .d(new_n24_), .O(new_n111_));
  nand2  g097(.a(new_n111_), .b(x1), .O(new_n112_));
  oai21  g098(.a(new_n85_), .b(new_n64_), .c(new_n112_), .O(new_n113_));
  aoi21  g099(.a(new_n113_), .b(new_n100_), .c(new_n109_), .O(new_n114_));
  nand3  g100(.a(new_n114_), .b(new_n99_), .c(new_n90_), .O(z2));
  ...
  nand2  g117(.a(new_n131_), .b(new_n91_), .O(new_n132_));
  ...
  nand4  g129(.a(new_n54_), .b(new_n29_), .c(new_n15_), .d(x7), .O(new_n144_));
  nand3  g130(.a(new_n144_), .b(new_n143_), .c(new_n130_), .O(z3));
  inv1   g131(.a(new_n137_), .O(new_n146_));
  nand3  g132(.a(new_n40_), .b(new_n39_), .c(x4), .O(new_n147_));
  aoi21  g133(.a(new_n147_), .b(new_n101_), .c(new_n146_), .O(new_n148_));
  oai21  g134(.a(new_n148_), .b(x5), .c(new_n28_), .O(new_n149_));
  inv1   g135(.a(new_n110_), .O(new_n150_));
  aoi21  g136(.a(new_n150_), .b(x1), .c(new_n65_), .O(new_n151_));
  nand3  g137(.a(new_n40_), .b(x6), .c(new_n28_), .O(new_n152_));
  nor2   g138(.a(new_n50_), .b(new_n28_), .O(new_n153_));
  nand4  g139(.a(new_n153_), .b(new_n53_), .c(new_n49_), .d(new_n44_), .O(new_n154_));
  oai21  g140(.a(new_n152_), .b(new_n151_), .c(new_n154_), .O(new_n155_));
  nand4  g141(.a(new_n21_), .b(new_n44_), .c(new_n17_), .d(x0), .O(new_n156_));
  aoi21  g142(.a(new_n156_), .b(new_n44_), .c(new_n50_), .O(new_n157_));
  aoi21  g143(.a(new_n155_), .b(new_n20_), .c(new_n157_), .O(new_n158_));
