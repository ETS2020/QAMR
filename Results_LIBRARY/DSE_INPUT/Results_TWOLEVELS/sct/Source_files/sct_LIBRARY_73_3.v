...
module FAU ( 
  ...
  xor2a  g18(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  ...
  nor2   g36(.a(x09), .b(new_n51_), .O(new_n71_));
  inv1   g37(.a(x12), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(x11), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n52_), .d(new_n70_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n69_), .c(new_n62_), .O(z07));
  oai21  g41(.a(new_n68_), .b(new_n55_), .c(x12), .O(new_n76_));
  nor2   g42(.a(x12), .b(x11), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n65_), .O(new_n78_));
  inv1   g44(.a(new_n78_), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n64_), .O(new_n80_));
  nand3  g46(.a(new_n80_), .b(new_n76_), .c(new_n62_), .O(z08));
  inv1   g47(.a(x11), .O(new_n82_));
  inv1   g48(.a(x13), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n72_), .c(new_n82_), .d(new_n70_), .O(new_n84_));
  nor2   g50(.a(new_n84_), .b(new_n60_), .O(new_n85_));
  nor2   g51(.a(new_n44_), .b(x02), .O(new_n86_));
  aoi21  g52(.a(new_n85_), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  oai21  g53(.a(new_n78_), .b(new_n55_), .c(x13), .O(new_n88_));
