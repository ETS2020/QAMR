...
module FAU ( 
  ...
  nand4  g28(.a(new_n62_), .b(new_n58_), .c(x08), .d(x06), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  oai21  g30(.a(x11), .b(x07), .c(new_n64_), .O(new_n65_));
  nand2  g31(.a(new_n59_), .b(x10), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(z06));
  nand2  g33(.a(new_n63_), .b(x11), .O(new_n68_));
  inv1   g34(.a(new_n54_), .O(new_n69_));
  nor2   g35(.a(x11), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n69_), .c(new_n58_), .O(new_n71_));
  ...
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n62_), .d(new_n58_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n76_), .c(new_n75_), .d(new_n62_), .O(new_n82_));
