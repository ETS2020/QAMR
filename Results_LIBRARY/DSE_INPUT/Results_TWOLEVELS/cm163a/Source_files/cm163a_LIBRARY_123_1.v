...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x02), .O(new_n23_));
  nand2  g02(.a(new_n22_), .b(x03), .O(new_n24_));
  and2   g03(.a(x03), .b(x02), .O(new_n25_));
  oai22  g04(.a(new_n25_), .b(new_n22_), .c(new_n24_), .d(new_n23_), .O(new_n26_));
  ...
  aoi22  g19(.a(new_n40_), .b(new_n25_), .c(new_n34_), .d(x12), .O(new_n41_));
  ...
  aoi21  g24(.a(new_n40_), .b(new_n25_), .c(new_n45_), .O(new_n46_));
  inv1   g25(.a(x12), .O(new_n47_));
  nand4  g26(.a(new_n45_), .b(new_n47_), .c(new_n33_), .d(x02), .O(new_n48_));
