...
module FAU ( 
  ...
  nand2  g15(.a(x12), .b(new_n36_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n24_), .c(new_n23_), .O(new_n38_));
  ...
  aoi21  g21(.a(new_n42_), .b(new_n22_), .c(new_n27_), .O(new_n43_));
  nand2  g22(.a(new_n43_), .b(new_n41_), .O(z2));
  inv1   g23(.a(x12), .O(new_n45_));
  nand4  g24(.a(new_n45_), .b(new_n23_), .c(x03), .d(x02), .O(new_n46_));
