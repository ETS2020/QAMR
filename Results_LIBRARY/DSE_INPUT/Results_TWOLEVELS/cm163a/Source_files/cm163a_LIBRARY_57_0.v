// Benchmark "FAU" written by ABC on Thu Jun 25 17:10:27 2020
...
module FAU ( 
  ...
  nand3  g04(.a(new_n25_), .b(new_n23_), .c(x03), .O(new_n26_));
  ...
  aoi22  g12(.a(new_n33_), .b(x02), .c(new_n23_), .d(x11), .O(new_n34_));
  ...
  aoi21  g17(.a(new_n33_), .b(x02), .c(new_n38_), .O(new_n39_));
  inv1   g18(.a(x11), .O(new_n40_));
  nand4  g19(.a(new_n38_), .b(new_n40_), .c(new_n22_), .d(x02), .O(new_n41_));
  ...
  aoi21  g29(.a(new_n33_), .b(x02), .c(new_n48_), .O(new_n51_));
