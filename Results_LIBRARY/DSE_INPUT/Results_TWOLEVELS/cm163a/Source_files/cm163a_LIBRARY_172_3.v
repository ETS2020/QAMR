// Benchmark "FAU" written by ABC on Thu Jun 25 17:10:47 2020
...
module FAU ( 
  ...
  nand3  g08(.a(new_n24_), .b(new_n23_), .c(x04), .O(new_n30_));
  inv1   g09(.a(x01), .O(new_n31_));
  aoi21  g10(.a(new_n22_), .b(new_n31_), .c(new_n27_), .O(new_n32_));
  nand2  g11(.a(new_n32_), .b(new_n30_), .O(z1));
  nand3  g12(.a(new_n23_), .b(x03), .c(x02), .O(new_n34_));
  nor2   g13(.a(x12), .b(x09), .O(new_n35_));
  aoi22  g14(.a(new_n35_), .b(new_n24_), .c(new_n34_), .d(x12), .O(new_n36_));
  inv1   g15(.a(x06), .O(new_n37_));
  aoi21  g16(.a(new_n37_), .b(new_n22_), .c(new_n27_), .O(new_n38_));
  ...
  nor3   g20(.a(x13), .b(x12), .c(x09), .O(new_n42_));
  aoi22  g21(.a(new_n42_), .b(new_n24_), .c(new_n41_), .d(x13), .O(new_n43_));
