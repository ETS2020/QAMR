...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n176_, new_n178_, new_n180_, new_n182_, new_n184_;
  ...
  aoi21  g011(.a(x07), .b(new_n94_), .c(x10), .O(z03));
  ...
  nand2  g083(.a(x09), .b(x00), .O(new_n167_));
  nand2  g084(.a(x38), .b(new_n145_), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n167_), .c(x10), .O(z27));
  inv1   g086(.a(x39), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(x10), .O(z28));
  inv1   g088(.a(x40), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(x10), .O(z29));
  inv1   g090(.a(x41), .O(new_n174_));
  nor2   g091(.a(new_n174_), .b(x10), .O(z30));
  inv1   g092(.a(x42), .O(new_n176_));
  nor2   g093(.a(new_n176_), .b(x10), .O(z31));
  inv1   g094(.a(x43), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(x10), .O(z32));
  inv1   g096(.a(x44), .O(new_n180_));
  nor2   g097(.a(new_n180_), .b(x10), .O(z33));
  inv1   g098(.a(x45), .O(new_n182_));
  nor2   g099(.a(new_n182_), .b(x10), .O(z34));
  inv1   g100(.a(x46), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(x10), .O(z35));
endmodule
