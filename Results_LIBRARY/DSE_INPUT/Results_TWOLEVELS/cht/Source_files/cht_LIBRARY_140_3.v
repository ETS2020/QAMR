// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:01 2020
...
module FAU ( 
  ...
  nor2   g094(.a(x14), .b(new_n146_), .O(new_n178_));
  nand3  g095(.a(new_n178_), .b(x40), .c(new_n168_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n177_), .O(z28));
  nand2  g097(.a(new_n176_), .b(x40), .O(new_n181_));
  nand2  g098(.a(new_n178_), .b(x41), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z29));
  nand2  g100(.a(new_n176_), .b(x41), .O(new_n184_));
  nand2  g101(.a(new_n178_), .b(x42), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z30));
  nand2  g103(.a(new_n176_), .b(x42), .O(new_n187_));
  nand2  g104(.a(new_n178_), .b(x43), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z31));
  nand2  g106(.a(new_n176_), .b(x43), .O(new_n190_));
  nand2  g107(.a(new_n178_), .b(x44), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z32));
  nand2  g109(.a(new_n176_), .b(x44), .O(new_n193_));
  nand2  g110(.a(new_n178_), .b(x45), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z33));
  nand2  g112(.a(new_n176_), .b(x45), .O(new_n196_));
  nand2  g113(.a(new_n178_), .b(x46), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z34));
  nand2  g115(.a(new_n176_), .b(x46), .O(new_n199_));
  nand2  g116(.a(new_n178_), .b(x00), .O(new_n200_));
