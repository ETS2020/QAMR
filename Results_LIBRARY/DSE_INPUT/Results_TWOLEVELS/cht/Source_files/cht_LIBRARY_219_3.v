// Benchmark "FAU" written by ABC on Thu Jun 25 19:31:38 2020
...
module FAU ( 
  ...
  nand3  g015(.a(x15), .b(new_n98_), .c(new_n85_), .O(new_n99_));
  nand2  g016(.a(new_n99_), .b(new_n97_), .O(z04));
  ...
  nor2   g094(.a(x14), .b(new_n147_), .O(new_n178_));
