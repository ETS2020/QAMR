// Benchmark "FAU" written by ABC on Thu Jun 25 19:30:51 2020
...
module FAU ( 
  ...
  inv1   g059(.a(x10), .O(new_n143_));
  nand3  g060(.a(x30), .b(new_n143_), .c(new_n103_), .O(new_n144_));
  inv1   g061(.a(new_n144_), .O(z19));
  ...
  nand2  g084(.a(x38), .b(new_n146_), .O(new_n168_));
  inv1   g085(.a(x14), .O(new_n169_));
  nand3  g086(.a(x39), .b(new_n169_), .c(x09), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n168_), .c(x10), .O(z27));
  oai21  g088(.a(x14), .b(new_n146_), .c(x39), .O(new_n172_));
  nand3  g089(.a(x40), .b(new_n169_), .c(x09), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z28));
  oai21  g091(.a(x14), .b(new_n146_), .c(x40), .O(new_n175_));
  nand3  g092(.a(x41), .b(new_n169_), .c(x09), .O(new_n176_));
  aoi21  g093(.a(new_n176_), .b(new_n175_), .c(x10), .O(z29));
  oai21  g094(.a(x14), .b(new_n146_), .c(x41), .O(new_n178_));
  nand3  g095(.a(x42), .b(new_n169_), .c(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z30));
  oai21  g097(.a(x14), .b(new_n146_), .c(x42), .O(new_n181_));
  nand3  g098(.a(x43), .b(new_n169_), .c(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z31));
  oai21  g100(.a(x14), .b(new_n146_), .c(x43), .O(new_n184_));
  nand3  g101(.a(x44), .b(new_n169_), .c(x09), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z32));
  oai21  g103(.a(x14), .b(new_n146_), .c(x44), .O(new_n187_));
  nand3  g104(.a(x45), .b(new_n169_), .c(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z33));
  oai21  g106(.a(x14), .b(new_n146_), .c(x45), .O(new_n190_));
  nand3  g107(.a(x46), .b(new_n169_), .c(x09), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z34));
  nand2  g109(.a(x46), .b(new_n143_), .O(new_n193_));
  aoi21  g110(.a(new_n169_), .b(x09), .c(new_n193_), .O(z35));
endmodule
