...
module FAU ( 
  ...
  or2    g002(.a(x10), .b(x07), .O(new_n86_));
  oai21  g003(.a(new_n86_), .b(new_n84_), .c(new_n85_), .O(z00));
  inv1   g004(.a(x12), .O(new_n88_));
  nand2  g005(.a(x07), .b(x05), .O(new_n89_));
  oai21  g006(.a(new_n86_), .b(new_n88_), .c(new_n89_), .O(z01));
  inv1   g007(.a(x13), .O(new_n91_));
  nand2  g008(.a(x07), .b(x06), .O(new_n92_));
  oai21  g009(.a(new_n86_), .b(new_n91_), .c(new_n92_), .O(z02));
  inv1   g010(.a(x14), .O(new_n94_));
  nand2  g011(.a(x07), .b(x01), .O(new_n95_));
  oai21  g012(.a(new_n86_), .b(new_n94_), .c(new_n95_), .O(z03));
  inv1   g013(.a(x15), .O(new_n97_));
  nand2  g014(.a(x07), .b(x02), .O(new_n98_));
  oai21  g015(.a(new_n86_), .b(new_n97_), .c(new_n98_), .O(z04));
  inv1   g016(.a(x16), .O(new_n100_));
  nand2  g017(.a(x07), .b(x03), .O(new_n101_));
  oai21  g018(.a(new_n86_), .b(new_n100_), .c(new_n101_), .O(z05));
  ...
  nand2  g090(.a(new_n94_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x39), .O(new_n175_));
  nor2   g092(.a(x14), .b(new_n146_), .O(new_n176_));
