...
module FAU ( 
  ...
  inv1   g044(.a(x10), .O(new_n128_));
  nand3  g045(.a(x25), .b(new_n128_), .c(new_n103_), .O(new_n129_));
  inv1   g046(.a(new_n129_), .O(z14));
  nand3  g047(.a(x27), .b(new_n128_), .c(x08), .O(new_n131_));
  inv1   g048(.a(new_n131_), .O(z15));
