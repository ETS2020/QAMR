...
module FAU ( 
  ...
  nand3  g52(.a(new_n89_), .b(new_n88_), .c(x20), .O(new_n96_));
  inv1   g53(.a(new_n96_), .O(new_n97_));
  inv1   g54(.a(x13), .O(new_n98_));
  inv1   g55(.a(x14), .O(new_n99_));
  nand4  g56(.a(x16), .b(x15), .c(new_n99_), .d(new_n98_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand4  g58(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n102_));
  ...
  nand3  g62(.a(new_n94_), .b(new_n57_), .c(x21), .O(new_n106_));
  nor2   g63(.a(new_n59_), .b(x01), .O(new_n107_));
  inv1   g64(.a(x16), .O(new_n108_));
  nand3  g65(.a(new_n88_), .b(x20), .c(new_n108_), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n99_), .b(new_n98_), .c(x12), .d(new_n62_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n110_), .c(new_n107_), .O(new_n113_));
  nand2  g70(.a(new_n89_), .b(new_n65_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n106_), .c(new_n114_), .O(z11));
