...
module FAU ( 
  ...
  aoi21  g54(.a(new_n95_), .b(new_n92_), .c(new_n97_), .O(z09));
  nor2   g55(.a(new_n96_), .b(new_n93_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n57_), .c(new_n89_), .d(x01), .O(new_n100_));
  nor2   g57(.a(new_n59_), .b(x01), .O(new_n101_));
  nand4  g58(.a(new_n96_), .b(x20), .c(x16), .d(x15), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  inv1   g61(.a(x14), .O(new_n105_));
  nand4  g62(.a(new_n105_), .b(new_n104_), .c(x12), .d(new_n62_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n103_), .c(new_n101_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n100_), .c(x00), .O(z10));
  nand3  g66(.a(x15), .b(new_n105_), .c(new_n104_), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n90_), .c(new_n88_), .O(new_n112_));
  nand4  g69(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n113_));
  aoi21  g70(.a(new_n113_), .b(new_n112_), .c(new_n97_), .O(z11));
