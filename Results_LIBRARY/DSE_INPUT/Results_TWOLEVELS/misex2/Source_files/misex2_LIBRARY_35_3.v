// Benchmark "FAU" written by ABC on Thu Jun 25 17:31:01 2020
...
module FAU ( 
  ...
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  ...
  nor2   g62(.a(new_n87_), .b(x14), .O(new_n106_));
  nand2  g63(.a(x20), .b(x16), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(x22), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n106_), .c(new_n105_), .d(new_n91_), .O(new_n109_));
  aoi21  g66(.a(new_n109_), .b(new_n102_), .c(x00), .O(z10));
  nand4  g67(.a(new_n95_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  nand3  g68(.a(new_n97_), .b(x20), .c(new_n88_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n106_), .c(new_n105_), .d(new_n91_), .O(new_n114_));
  nand2  g71(.a(new_n98_), .b(new_n65_), .O(new_n115_));
