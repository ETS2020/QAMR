...
module FAU ( 
  ...
  nand2  g46(.a(x02), .b(new_n66_), .O(new_n90_));
  inv1   g47(.a(new_n90_), .O(new_n91_));
  nor2   g48(.a(x13), .b(x11), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n87_), .O(new_n93_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n57_), .c(new_n88_), .d(x01), .O(new_n101_));
  inv1   g58(.a(x13), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x12), .c(new_n62_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n90_), .O(new_n104_));
  inv1   g61(.a(x15), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x14), .O(new_n106_));
  nand4  g63(.a(new_n97_), .b(new_n96_), .c(x20), .d(x16), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand3  g65(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  ...
  nand3  g69(.a(new_n96_), .b(x20), .c(new_n112_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n106_), .c(new_n104_), .O(new_n115_));
  nand2  g72(.a(new_n97_), .b(new_n65_), .O(new_n116_));
  aoi21  g73(.a(new_n115_), .b(new_n111_), .c(new_n116_), .O(z11));
