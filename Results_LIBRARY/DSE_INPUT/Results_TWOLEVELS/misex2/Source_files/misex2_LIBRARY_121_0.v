...
module FAU ( 
  ...
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n62_), .O(new_n93_));
  nor3   g50(.a(new_n93_), .b(new_n90_), .c(new_n83_), .O(z09));
  nor2   g51(.a(x20), .b(x19), .O(new_n95_));
  nand4  g52(.a(new_n95_), .b(x22), .c(x18), .d(x01), .O(new_n96_));
  inv1   g53(.a(new_n93_), .O(new_n97_));
  nand4  g54(.a(new_n89_), .b(new_n88_), .c(x16), .d(x15), .O(new_n98_));
  inv1   g55(.a(new_n98_), .O(new_n99_));
  nor2   g56(.a(new_n60_), .b(x01), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n97_), .O(new_n101_));
  aoi21  g58(.a(new_n101_), .b(new_n96_), .c(x00), .O(z10));
  nand3  g59(.a(new_n95_), .b(x18), .c(x01), .O(new_n103_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(x15), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n100_), .c(new_n97_), .O(new_n106_));
  nand2  g63(.a(new_n89_), .b(new_n45_), .O(new_n107_));
  aoi21  g64(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g65(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n109_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g67(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g69(.a(new_n112_), .b(new_n82_), .O(new_n113_));
  ...
  aoi21  g75(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n45_), .c(new_n120_), .O(z15));
  nor2   g78(.a(new_n46_), .b(x00), .O(z16));
  inv1   g79(.a(new_n83_), .O(z17));
endmodule
