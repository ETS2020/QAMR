...
module FAU ( 
  ...
  nor2   g52(.a(new_n51_), .b(new_n46_), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n52_), .O(new_n97_));
  inv1   g54(.a(x21), .O(new_n98_));
  inv1   g55(.a(x22), .O(new_n99_));
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(new_n100_));
  aoi21  g57(.a(new_n97_), .b(new_n94_), .c(new_n100_), .O(z09));
  nand4  g58(.a(new_n96_), .b(x22), .c(x21), .d(new_n95_), .O(new_n102_));
  ...
  nand4  g63(.a(new_n99_), .b(new_n98_), .c(x20), .d(x16), .O(new_n107_));
  ...
  nand3  g67(.a(new_n96_), .b(x21), .c(new_n95_), .O(new_n111_));
  nand3  g68(.a(new_n98_), .b(x20), .c(new_n87_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n106_), .c(new_n105_), .O(new_n114_));
  nand2  g71(.a(new_n99_), .b(new_n45_), .O(new_n115_));
