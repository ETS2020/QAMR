// Benchmark "FAU" written by ABC on Thu Jun 25 19:54:06 2020
...
module FAU ( 
  ...
  nand3  g175(.a(new_n233_), .b(new_n326_), .c(x79), .O(new_n327_));
  aoi21  g176(.a(new_n327_), .b(new_n325_), .c(x01), .O(z47));
  ...
  inv1   g181(.a(new_n327_), .O(new_n333_));
  ...
  inv1   g216(.a(new_n170_), .O(new_n368_));
  ...
  nand3  g220(.a(new_n279_), .b(x84), .c(new_n371_), .O(new_n372_));
  inv1   g221(.a(x80), .O(new_n373_));
  nand4  g222(.a(new_n251_), .b(new_n165_), .c(new_n373_), .d(x79), .O(new_n374_));
  nor2   g223(.a(new_n374_), .b(new_n372_), .O(z55));
  nand2  g224(.a(new_n249_), .b(x76), .O(new_n376_));
  xnor2a g225(.a(x84), .b(x81), .O(new_n377_));
  aoi21  g226(.a(new_n171_), .b(new_n170_), .c(new_n377_), .O(new_n378_));
  ...
  oai21  g242(.a(new_n368_), .b(new_n160_), .c(new_n154_), .O(new_n394_));
  ...
  aoi21  g251(.a(new_n378_), .b(x79), .c(new_n400_), .O(new_n403_));
  ...
  nor3   g256(.a(new_n407_), .b(new_n405_), .c(new_n373_), .O(z61));
  ...
  nand2  g267(.a(new_n418_), .b(new_n326_), .O(new_n419_));
  aoi21  g268(.a(new_n419_), .b(new_n417_), .c(x01), .O(z62));
  nor3   g269(.a(new_n407_), .b(new_n405_), .c(new_n371_), .O(z63));
