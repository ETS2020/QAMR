...
module FAU ( 
  ...
  nand3  g214(.a(x78), .b(x52), .c(x22), .O(new_n366_));
  nand3  g215(.a(new_n317_), .b(x04), .c(new_n153_), .O(new_n367_));
  ...
  oai21  g241(.a(new_n392_), .b(new_n239_), .c(new_n154_), .O(new_n393_));
  ...
  nor3   g256(.a(new_n407_), .b(new_n405_), .c(new_n371_), .O(z61));
  ...
  nor3   g269(.a(new_n407_), .b(new_n405_), .c(new_n369_), .O(z63));
