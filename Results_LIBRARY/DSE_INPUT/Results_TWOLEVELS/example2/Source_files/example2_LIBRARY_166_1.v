// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:37 2020
...
module FAU ( 
  ...
  nor2   g214(.a(new_n287_), .b(x22), .O(new_n366_));
  nand2  g215(.a(x04), .b(new_n153_), .O(new_n367_));
  nor4   g216(.a(new_n367_), .b(new_n366_), .c(new_n167_), .d(x79), .O(z54));
  inv1   g217(.a(x82), .O(new_n369_));
  nand3  g218(.a(new_n274_), .b(x84), .c(new_n369_), .O(new_n370_));
  inv1   g219(.a(x80), .O(new_n371_));
  nand4  g220(.a(new_n247_), .b(new_n161_), .c(new_n371_), .d(x79), .O(new_n372_));
  ...
  nand4  g233(.a(x80), .b(new_n231_), .c(x43), .d(new_n250_), .O(new_n385_));
  oai22  g234(.a(new_n385_), .b(new_n230_), .c(new_n250_), .d(x40), .O(new_n386_));
  ...
  inv1   g240(.a(new_n167_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n240_), .c(new_n154_), .O(new_n393_));
  ...
  oai21  g245(.a(new_n232_), .b(new_n230_), .c(new_n250_), .O(new_n397_));
  ...
  oai21  g251(.a(x77), .b(new_n287_), .c(new_n154_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n234_), .c(new_n240_), .O(new_n404_));
  nor2   g253(.a(x79), .b(new_n287_), .O(new_n405_));
  oai21  g254(.a(new_n405_), .b(new_n404_), .c(x78), .O(new_n406_));
  aoi21  g255(.a(new_n376_), .b(x79), .c(new_n400_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n406_), .c(x01), .O(z60));
  inv1   g257(.a(new_n170_), .O(new_n409_));
  nand2  g258(.a(new_n168_), .b(new_n167_), .O(new_n410_));
  aoi22  g259(.a(new_n410_), .b(new_n226_), .c(new_n161_), .d(new_n240_), .O(new_n411_));
  nor3   g260(.a(new_n411_), .b(new_n409_), .c(new_n371_), .O(z61));
  nand3  g261(.a(x84), .b(x81), .c(x79), .O(new_n413_));
  oai21  g262(.a(x79), .b(new_n240_), .c(new_n413_), .O(new_n414_));
  nand2  g263(.a(new_n414_), .b(new_n159_), .O(new_n415_));
  nand2  g264(.a(new_n397_), .b(x79), .O(new_n416_));
  nand3  g265(.a(x81), .b(x79), .c(new_n240_), .O(new_n417_));
  ...
  nand2  g271(.a(new_n422_), .b(new_n323_), .O(new_n423_));
  aoi21  g272(.a(new_n423_), .b(new_n421_), .c(x01), .O(z62));
  nor3   g273(.a(new_n411_), .b(new_n409_), .c(new_n369_), .O(z63));
  nand2  g274(.a(x83), .b(x79), .O(new_n426_));
  or2    g275(.a(new_n426_), .b(new_n411_), .O(new_n427_));
  aoi21  g276(.a(new_n427_), .b(new_n319_), .c(x01), .O(z64));
  nor2   g277(.a(new_n160_), .b(x04), .O(new_n429_));
  nor2   g278(.a(new_n254_), .b(x78), .O(new_n430_));
  oai21  g279(.a(new_n430_), .b(new_n429_), .c(x77), .O(new_n431_));
  nand2  g280(.a(new_n392_), .b(x81), .O(new_n432_));
  nand2  g281(.a(new_n170_), .b(x84), .O(new_n433_));
