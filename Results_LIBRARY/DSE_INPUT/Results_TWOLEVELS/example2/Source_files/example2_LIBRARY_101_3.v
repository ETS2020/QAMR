// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:11 2020
...
module FAU ( 
  ...
  inv1   g170(.a(x67), .O(new_n322_));
  nand2  g171(.a(new_n166_), .b(new_n322_), .O(new_n323_));
  nand4  g172(.a(new_n323_), .b(new_n226_), .c(new_n321_), .d(x79), .O(new_n324_));
  ...
  nand2  g178(.a(new_n226_), .b(x79), .O(new_n330_));
  nor2   g179(.a(new_n330_), .b(new_n168_), .O(new_n331_));
  ...
  nand4  g186(.a(new_n226_), .b(x79), .c(x77), .d(x69), .O(new_n338_));
