// Benchmark "FAU" written by ABC on Thu Jun 25 19:53:33 2020
...
module FAU ( 
  ...
  nor2   g146(.a(new_n296_), .b(new_n287_), .O(z35));
  nand2  g147(.a(new_n246_), .b(x54), .O(new_n299_));
  nor2   g148(.a(new_n299_), .b(new_n296_), .O(z36));
  nand2  g149(.a(new_n246_), .b(x55), .O(new_n301_));
  nor2   g150(.a(new_n301_), .b(new_n296_), .O(z37));
  nand2  g151(.a(new_n246_), .b(x56), .O(new_n303_));
  nor2   g152(.a(new_n303_), .b(new_n296_), .O(z38));
  nor3   g153(.a(new_n296_), .b(new_n287_), .c(new_n199_), .O(z39));
  nor3   g154(.a(new_n296_), .b(new_n287_), .c(new_n196_), .O(z40));
  nor3   g155(.a(new_n296_), .b(new_n287_), .c(new_n193_), .O(z41));
  ...
  nand3  g218(.a(new_n273_), .b(x84), .c(new_n369_), .O(new_n370_));
  inv1   g219(.a(x80), .O(new_n371_));
  nand4  g220(.a(new_n246_), .b(new_n161_), .c(new_n371_), .d(x79), .O(new_n372_));
  nor2   g221(.a(new_n372_), .b(new_n370_), .O(z55));
  nand2  g222(.a(new_n244_), .b(x76), .O(new_n374_));
  xnor2a g223(.a(x84), .b(x81), .O(new_n375_));
  aoi21  g224(.a(new_n168_), .b(new_n167_), .c(new_n375_), .O(new_n376_));
  ...
  nand3  g228(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(new_n379_), .c(new_n242_), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand3  g231(.a(new_n242_), .b(x03), .c(new_n382_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  nand4  g233(.a(x80), .b(new_n231_), .c(x43), .d(new_n249_), .O(new_n385_));
  oai22  g234(.a(new_n385_), .b(new_n230_), .c(new_n249_), .d(x40), .O(new_n386_));
  nand3  g235(.a(new_n386_), .b(new_n236_), .c(x79), .O(new_n387_));
  nor2   g236(.a(x79), .b(x78), .O(new_n388_));
  nand3  g237(.a(new_n388_), .b(new_n249_), .c(x40), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n387_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x77), .O(new_n391_));
  oai21  g240(.a(new_n366_), .b(new_n239_), .c(new_n154_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n391_), .c(x01), .O(z58));
  inv1   g242(.a(new_n388_), .O(new_n394_));
  ...
  aoi21  g250(.a(new_n376_), .b(x79), .c(new_n399_), .O(new_n402_));
  aoi21  g251(.a(new_n402_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g252(.a(new_n170_), .O(new_n404_));
  nand2  g253(.a(new_n168_), .b(new_n167_), .O(new_n405_));
  aoi22  g254(.a(new_n405_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n406_));
  nor3   g255(.a(new_n406_), .b(new_n404_), .c(new_n371_), .O(z61));
  ...
  nand2  g266(.a(new_n417_), .b(new_n321_), .O(new_n418_));
  aoi21  g267(.a(new_n418_), .b(new_n416_), .c(x01), .O(z62));
  nor3   g268(.a(new_n406_), .b(new_n404_), .c(new_n369_), .O(z63));
  ...
  nor2   g273(.a(new_n253_), .b(x78), .O(new_n425_));
