...
module FAU ( 
  ...
  nand2  g201(.a(new_n292_), .b(x11), .O(new_n353_));
  inv1   g202(.a(new_n170_), .O(new_n354_));
  nand4  g203(.a(new_n354_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n355_));
  aoi21  g204(.a(new_n353_), .b(new_n352_), .c(new_n355_), .O(z51));
  ...
  aoi21  g219(.a(new_n370_), .b(new_n369_), .c(new_n355_), .O(z54));
  ...
  oai21  g243(.a(new_n354_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g278(.a(new_n354_), .b(x81), .O(new_n430_));
