// Benchmark "FAU" written by ABC on Thu Jun 25 16:57:45 2020
...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n18_), .c(new_n20_), .d(new_n15_), .O(z3));
  nand3  g14(.a(new_n18_), .b(new_n16_), .c(x2), .O(z4));
  nand4  g15(.a(new_n22_), .b(new_n18_), .c(new_n20_), .d(x2), .O(z5));
  nand3  g16(.a(new_n25_), .b(new_n18_), .c(x2), .O(z6));
  nand4  g17(.a(new_n27_), .b(new_n18_), .c(new_n20_), .d(x2), .O(z7));
endmodule
