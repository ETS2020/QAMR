...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n33_, new_n35_;
  ...
  nor2   g11(.a(x4), .b(new_n27_), .O(new_n28_));
  inv1   g12(.a(x2), .O(new_n29_));
  nor2   g13(.a(new_n29_), .b(x1), .O(new_n30_));
  nand4  g14(.a(new_n30_), .b(new_n28_), .c(new_n22_), .d(new_n26_), .O(z4));
  nand4  g15(.a(new_n30_), .b(new_n28_), .c(new_n19_), .d(new_n26_), .O(z5));
