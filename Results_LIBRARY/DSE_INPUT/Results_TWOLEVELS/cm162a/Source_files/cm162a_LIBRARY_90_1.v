...
module FAU ( 
  ...
  nor2   g07(.a(x04), .b(new_n26_), .O(new_n27_));
  ...
  aoi21  g16(.a(new_n27_), .b(x10), .c(new_n35_), .O(new_n36_));
  oai21  g17(.a(new_n34_), .b(new_n31_), .c(new_n36_), .O(z1));
  ...
  oai21  g24(.a(new_n43_), .b(new_n41_), .c(x04), .O(new_n44_));
  oai21  g25(.a(x06), .b(x03), .c(x05), .O(new_n45_));
  aoi21  g26(.a(new_n27_), .b(x11), .c(new_n45_), .O(new_n46_));
  ...
  aoi21  g30(.a(new_n49_), .b(new_n21_), .c(new_n20_), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n27_), .b(x12), .c(new_n55_), .O(new_n56_));
