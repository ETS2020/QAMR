...
module FAU ( 
  ...
  nand4  g22(.a(new_n41_), .b(new_n40_), .c(new_n32_), .d(new_n23_), .O(new_n42_));
  nand2  g23(.a(new_n42_), .b(new_n20_), .O(new_n43_));
  nand4  g24(.a(x12), .b(new_n40_), .c(new_n32_), .d(new_n23_), .O(new_n44_));
  inv1   g25(.a(new_n44_), .O(new_n45_));
  aoi21  g26(.a(new_n43_), .b(x03), .c(new_n45_), .O(new_n46_));
  nor2   g27(.a(x10), .b(x08), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n24_), .O(new_n48_));
  nor2   g29(.a(new_n40_), .b(new_n28_), .O(new_n49_));
  oai21  g30(.a(x06), .b(x03), .c(x05), .O(new_n50_));
  aoi21  g31(.a(new_n49_), .b(new_n48_), .c(new_n50_), .O(new_n51_));
  oai21  g32(.a(new_n46_), .b(new_n21_), .c(new_n51_), .O(z2));
  nand3  g33(.a(new_n47_), .b(new_n24_), .c(new_n40_), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x12), .O(new_n54_));
  nand3  g35(.a(new_n43_), .b(new_n24_), .c(x03), .O(new_n55_));
  inv1   g36(.a(x07), .O(new_n56_));
  aoi21  g37(.a(new_n56_), .b(new_n28_), .c(new_n29_), .O(new_n57_));
  nand3  g38(.a(new_n57_), .b(new_n55_), .c(new_n54_), .O(z3));
