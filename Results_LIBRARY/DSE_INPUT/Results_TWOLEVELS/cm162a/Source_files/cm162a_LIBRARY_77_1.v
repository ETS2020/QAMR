// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:11 2020
...
module FAU ( 
  ...
  aoi21  g13(.a(new_n32_), .b(new_n20_), .c(new_n21_), .O(new_n33_));
  inv1   g14(.a(x10), .O(new_n34_));
  inv1   g15(.a(new_n21_), .O(new_n35_));
  aoi21  g16(.a(new_n35_), .b(new_n23_), .c(new_n34_), .O(new_n36_));
  ...
  nand2  g22(.a(new_n31_), .b(new_n41_), .O(new_n42_));
  aoi21  g23(.a(new_n42_), .b(new_n20_), .c(new_n21_), .O(new_n43_));
  aoi21  g24(.a(new_n31_), .b(new_n35_), .c(new_n41_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n45_));
  inv1   g26(.a(x06), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n27_), .c(new_n28_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n45_), .O(z2));
  inv1   g29(.a(x12), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n41_), .c(new_n34_), .d(new_n23_), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n55_), .b(new_n27_), .c(new_n28_), .O(new_n56_));
