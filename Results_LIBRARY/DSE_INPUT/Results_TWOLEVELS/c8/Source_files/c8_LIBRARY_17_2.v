...
module FAU ( 
  ...
  aoi22  g055(.a(new_n101_), .b(new_n83_), .c(new_n93_), .d(x22), .O(new_n102_));
  ...
  aoi22  g063(.a(new_n109_), .b(new_n83_), .c(new_n108_), .d(x23), .O(new_n110_));
  ...
  nand2  g073(.a(new_n119_), .b(new_n115_), .O(z14));
  ...
  aoi21  g081(.a(new_n127_), .b(new_n54_), .c(new_n92_), .O(new_n128_));
  nor3   g082(.a(x24), .b(x23), .c(x22), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n83_), .c(new_n66_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n126_), .b(new_n125_), .c(new_n74_), .d(new_n51_), .O(new_n137_));
  nand4  g091(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  nand4  g093(.a(new_n57_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  aoi22  g095(.a(new_n141_), .b(new_n139_), .c(new_n137_), .d(x26), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n136_), .O(z16));
  nor2   g097(.a(x22), .b(x20), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n139_), .c(x19), .d(new_n72_), .O(new_n145_));
