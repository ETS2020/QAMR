// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:21 2020
...
module FAU ( 
  ...
  nand3  g36(.a(x18), .b(new_n82_), .c(x01), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n81_), .O(z10));
  nand2  g38(.a(x18), .b(x02), .O(new_n85_));
  oai21  g39(.a(x18), .b(new_n54_), .c(new_n85_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  ...
  oai21  g44(.a(new_n90_), .b(new_n82_), .c(new_n87_), .O(z11));
  nand2  g45(.a(x18), .b(x03), .O(new_n92_));
  oai21  g46(.a(x18), .b(new_n57_), .c(new_n92_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nand2  g48(.a(new_n89_), .b(new_n73_), .O(new_n95_));
  nor2   g49(.a(x22), .b(x21), .O(new_n96_));
  aoi22  g50(.a(new_n96_), .b(new_n80_), .c(new_n95_), .d(x22), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n82_), .c(new_n94_), .O(z12));
  nand2  g52(.a(x18), .b(x04), .O(new_n99_));
  oai21  g53(.a(x18), .b(new_n60_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n82_), .O(new_n101_));
  nand3  g55(.a(new_n96_), .b(new_n73_), .c(new_n51_), .O(new_n102_));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n80_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n82_), .c(new_n101_), .O(z13));
  inv1   g59(.a(x13), .O(new_n106_));
  nand2  g60(.a(x18), .b(x05), .O(new_n107_));
  oai21  g61(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n82_), .O(new_n109_));
  aoi21  g63(.a(new_n103_), .b(new_n80_), .c(new_n63_), .O(new_n110_));
  ...
  nand2  g71(.a(new_n117_), .b(new_n82_), .O(new_n118_));
  ...
  nand2  g81(.a(new_n127_), .b(new_n82_), .O(new_n128_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n82_), .O(z17));
  buf    g92(.a(x27), .O(z08));
endmodule
