// Benchmark "FAU" written by ABC on Thu Jun 25 19:34:33 2020
...
module FAU ( 
  ...
  nand2  g47(.a(new_n91_), .b(new_n73_), .O(new_n94_));
  nor2   g48(.a(x22), .b(x21), .O(new_n95_));
  aoi22  g49(.a(new_n95_), .b(new_n83_), .c(new_n94_), .d(x22), .O(new_n96_));
  nand3  g50(.a(x18), .b(new_n86_), .c(x03), .O(new_n97_));
  oai21  g51(.a(new_n96_), .b(new_n86_), .c(new_n97_), .O(z12));
  ...
  nand3  g55(.a(new_n95_), .b(new_n73_), .c(new_n51_), .O(new_n102_));
  ...
  nand4  g65(.a(new_n111_), .b(new_n95_), .c(new_n73_), .d(new_n51_), .O(new_n112_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n120_), .c(new_n91_), .d(new_n73_), .O(new_n122_));
  ...
  nand4  g84(.a(new_n130_), .b(new_n120_), .c(new_n91_), .d(new_n73_), .O(new_n131_));
  ...
  nand4  g89(.a(new_n135_), .b(new_n130_), .c(new_n120_), .d(new_n91_), .O(new_n136_));
