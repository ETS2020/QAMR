// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:06 2020
...
module FAU ( 
  ...
  and2   g61(.a(x18), .b(x05), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(x13), .c(new_n86_), .O(new_n109_));
  aoi21  g63(.a(new_n105_), .b(new_n83_), .c(new_n63_), .O(new_n110_));
