// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:08 2020
...
module FAU ( 
  ...
  oai21  g31(.a(x18), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n75_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n74_), .O(z09));
  inv1   g34(.a(x09), .O(new_n81_));
  nand2  g35(.a(x18), .b(x01), .O(new_n82_));
  oai21  g36(.a(x18), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n75_), .O(new_n84_));
  nor2   g38(.a(new_n73_), .b(new_n51_), .O(new_n85_));
  nor3   g39(.a(x20), .b(x19), .c(x17), .O(new_n86_));
  oai21  g40(.a(new_n86_), .b(new_n85_), .c(x16), .O(new_n87_));
  nand2  g41(.a(new_n87_), .b(new_n84_), .O(z10));
  inv1   g42(.a(x18), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(x02), .c(new_n75_), .O(new_n90_));
  nand2  g44(.a(new_n73_), .b(new_n51_), .O(new_n91_));
  nor2   g45(.a(x21), .b(x20), .O(new_n92_));
  aoi22  g46(.a(new_n92_), .b(new_n73_), .c(new_n91_), .d(x21), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n75_), .c(new_n90_), .O(z11));
  nand2  g48(.a(x18), .b(x03), .O(new_n95_));
  oai21  g49(.a(x18), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n75_), .O(new_n97_));
  nand2  g51(.a(new_n92_), .b(new_n73_), .O(new_n98_));
  nor2   g52(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g53(.a(new_n99_), .b(new_n86_), .c(new_n98_), .d(x22), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n75_), .c(new_n97_), .O(z12));
  nand2  g55(.a(x18), .b(x04), .O(new_n102_));
  oai21  g56(.a(x18), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n75_), .O(new_n104_));
  nand3  g58(.a(new_n99_), .b(new_n73_), .c(new_n51_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n86_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n75_), .c(new_n104_), .O(z13));
  inv1   g62(.a(x13), .O(new_n109_));
  nand2  g63(.a(x18), .b(x05), .O(new_n110_));
  oai21  g64(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n75_), .O(new_n112_));
  aoi21  g66(.a(new_n106_), .b(new_n86_), .c(new_n63_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n99_), .c(new_n73_), .d(new_n51_), .O(new_n115_));
  ...
  oai21  g73(.a(x18), .b(new_n66_), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n75_), .O(new_n121_));
  nand2  g75(.a(new_n115_), .b(x25), .O(new_n122_));
  nor2   g76(.a(x23), .b(x22), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n123_), .c(new_n92_), .d(new_n73_), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(x16), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n121_), .O(z15));
  nand2  g82(.a(x18), .b(x07), .O(new_n129_));
  oai21  g83(.a(x18), .b(new_n69_), .c(new_n129_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n75_), .O(new_n131_));
  nand2  g85(.a(new_n125_), .b(x26), .O(new_n132_));
  nor3   g86(.a(x26), .b(x25), .c(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n123_), .c(new_n92_), .d(new_n73_), .O(new_n134_));
  ...
  nor2   g91(.a(new_n48_), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n133_), .c(new_n123_), .d(new_n92_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n75_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
