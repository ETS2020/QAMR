// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:21 2020
...
module FAU ( 
  ...
  nand2  g58(.a(new_n104_), .b(new_n75_), .O(new_n105_));
  nand3  g59(.a(new_n100_), .b(new_n73_), .c(new_n51_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n86_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n75_), .c(new_n105_), .O(z13));
  inv1   g63(.a(x13), .O(new_n110_));
  nand2  g64(.a(x18), .b(x05), .O(new_n111_));
  oai21  g65(.a(x18), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n75_), .O(new_n113_));
  aoi21  g67(.a(new_n107_), .b(new_n86_), .c(new_n63_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n116_));
  ...
  nand2  g75(.a(new_n121_), .b(new_n75_), .O(new_n122_));
  nand2  g76(.a(new_n116_), .b(x25), .O(new_n123_));
  nor2   g77(.a(x23), .b(x22), .O(new_n124_));
  nor2   g78(.a(x25), .b(x24), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n124_), .c(new_n93_), .d(new_n73_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x16), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n122_), .O(z15));
  nand2  g83(.a(new_n126_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n124_), .c(new_n93_), .d(new_n73_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g88(.a(x18), .O(new_n135_));
  nand3  g89(.a(new_n135_), .b(new_n75_), .c(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n134_), .O(z16));
  nor2   g91(.a(new_n48_), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n131_), .c(new_n124_), .d(new_n93_), .O(new_n139_));
