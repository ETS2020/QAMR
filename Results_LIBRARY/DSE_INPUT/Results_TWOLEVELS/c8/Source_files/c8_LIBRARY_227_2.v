// Benchmark "FAU" written by ABC on Thu Jun 25 19:35:25 2020
...
module FAU ( 
  ...
  and2   g29(.a(x18), .b(x00), .O(new_n76_));
  aoi21  g30(.a(new_n75_), .b(x08), .c(new_n76_), .O(new_n77_));
  oai21  g31(.a(new_n77_), .b(x16), .c(new_n74_), .O(z09));
  aoi21  g32(.a(new_n75_), .b(x09), .c(x01), .O(new_n79_));
