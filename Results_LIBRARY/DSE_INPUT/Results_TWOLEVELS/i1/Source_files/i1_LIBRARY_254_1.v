// Benchmark "FAU" written by ABC on Thu Jun 25 17:26:34 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    new_n50_, new_n51_, new_n54_, new_n55_, new_n56_, new_n60_, new_n61_,
    new_n63_, new_n65_, new_n68_, new_n70_, new_n71_;
  inv1   g00(.a(x19), .O(new_n42_));
  nor2   g01(.a(x02), .b(x01), .O(new_n43_));
  nor2   g02(.a(x04), .b(x03), .O(new_n44_));
  nor2   g03(.a(x06), .b(x05), .O(new_n45_));
  nor2   g04(.a(x09), .b(x07), .O(new_n46_));
  ...
  nand4  g08(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(new_n49_), .O(new_n50_));
  and2   g09(.a(x19), .b(x00), .O(new_n51_));
  and2   g10(.a(new_n51_), .b(new_n50_), .O(z02));
  or2    g11(.a(x21), .b(x20), .O(z04));
  inv1   g12(.a(x10), .O(new_n54_));
  nand2  g13(.a(new_n44_), .b(new_n43_), .O(new_n55_));
  nand3  g14(.a(new_n45_), .b(x19), .c(new_n49_), .O(new_n56_));
  oai21  g15(.a(new_n56_), .b(new_n55_), .c(new_n54_), .O(z05));
