...
module FAU ( 
  ...
  nand2  g039(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  ...
  aoi21  g044(.a(new_n86_), .b(new_n84_), .c(new_n88_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n83_), .O(new_n91_));
  nand2  g047(.a(new_n85_), .b(x28), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z4));
  inv1   g049(.a(x28), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  xor2a  g051(.a(new_n95_), .b(x29), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n83_), .O(new_n97_));
  nand2  g053(.a(new_n85_), .b(x29), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n88_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n95_), .b(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n95_), .b(new_n100_), .c(x29), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n83_), .O(new_n105_));
  nand2  g061(.a(new_n85_), .b(x30), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n88_), .O(z6));
  nand3  g063(.a(new_n86_), .b(new_n82_), .c(new_n79_), .O(new_n108_));
  inv1   g064(.a(x31), .O(new_n109_));
  nand3  g065(.a(new_n102_), .b(new_n109_), .c(x30), .O(new_n110_));
  inv1   g066(.a(x29), .O(new_n111_));
  nor2   g067(.a(new_n100_), .b(new_n111_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n95_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(x31), .c(new_n88_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n110_), .c(new_n108_), .O(z7));
  ...
  nand2  g088(.a(new_n94_), .b(new_n76_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n100_), .c(x29), .O(new_n134_));
  ...
  aoi21  g109(.a(new_n100_), .b(new_n111_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g114(.a(new_n87_), .b(x00), .O(new_n159_));
  ...
  nand2  g118(.a(new_n109_), .b(new_n100_), .O(new_n163_));
  ...
  nand2  g127(.a(x31), .b(new_n100_), .O(new_n172_));
