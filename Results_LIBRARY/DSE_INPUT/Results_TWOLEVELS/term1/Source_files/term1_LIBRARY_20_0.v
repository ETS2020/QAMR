...
module FAU ( 
  ...
  nor2   g050(.a(x27), .b(x26), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n94_), .c(new_n92_), .d(new_n58_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nor2   g054(.a(new_n93_), .b(x26), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n98_), .c(new_n92_), .d(new_n58_), .O(new_n100_));
  ...
  xor2a  g061(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand2  g062(.a(new_n99_), .b(new_n58_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n106_), .c(new_n91_), .O(z5));
  inv1   g064(.a(new_n107_), .O(new_n109_));
  inv1   g065(.a(x30), .O(new_n110_));
  nand2  g066(.a(new_n105_), .b(x29), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n105_), .b(new_n110_), .c(x29), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n110_), .c(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n109_), .c(new_n92_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(z6));
  inv1   g072(.a(x15), .O(new_n117_));
  nand2  g073(.a(new_n89_), .b(x20), .O(new_n118_));
  oai21  g074(.a(x20), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n86_), .c(new_n83_), .d(new_n79_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand3  g077(.a(new_n112_), .b(new_n121_), .c(x30), .O(new_n122_));
  nor2   g078(.a(new_n110_), .b(new_n102_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n105_), .c(new_n121_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n107_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n120_), .O(z7));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n117_), .O(new_n136_));
  nand3  g092(.a(x16), .b(new_n117_), .c(x10), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand2  g094(.a(new_n104_), .b(new_n103_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n110_), .c(x29), .O(new_n140_));
  ...
  nor2   g101(.a(new_n77_), .b(new_n117_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n134_), .O(new_n147_));
  nor2   g103(.a(new_n81_), .b(new_n87_), .O(new_n148_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n133_), .c(new_n117_), .O(new_n155_));
  nand2  g111(.a(new_n123_), .b(x27), .O(new_n156_));
  ...
  aoi21  g115(.a(new_n110_), .b(new_n102_), .c(new_n159_), .O(new_n160_));
  aoi21  g116(.a(x19), .b(x13), .c(x18), .O(new_n161_));
  aoi21  g117(.a(new_n123_), .b(x28), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g125(.a(new_n121_), .b(new_n110_), .O(new_n170_));
  oai22  g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n121_), .O(new_n171_));
  ...
  nand2  g133(.a(new_n121_), .b(x30), .O(new_n178_));
  nand2  g134(.a(x31), .b(new_n110_), .O(new_n179_));
  inv1   g135(.a(x13), .O(new_n180_));
  nand2  g136(.a(new_n87_), .b(new_n180_), .O(new_n181_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n154_), .c(new_n117_), .O(new_n189_));
