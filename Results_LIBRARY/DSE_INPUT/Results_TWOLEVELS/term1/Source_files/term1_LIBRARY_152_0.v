...
module FAU ( 
  ...
  nand2  g077(.a(x19), .b(x17), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x16), .c(new_n121_), .d(x10), .O(new_n124_));
  nand2  g080(.a(x18), .b(x00), .O(new_n125_));
  aoi21  g081(.a(new_n124_), .b(new_n120_), .c(new_n125_), .O(new_n126_));
  nor2   g082(.a(new_n115_), .b(x18), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nor2   g084(.a(new_n112_), .b(new_n121_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x17), .c(x13), .O(new_n130_));
  ...
  nand3  g094(.a(new_n129_), .b(new_n123_), .c(x18), .O(new_n139_));
  nand2  g095(.a(x16), .b(x10), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n122_), .c(new_n121_), .O(new_n141_));
  inv1   g097(.a(x11), .O(new_n142_));
  oai21  g098(.a(new_n122_), .b(new_n142_), .c(new_n112_), .O(new_n143_));
  ...
  aoi21  g105(.a(x19), .b(x12), .c(x17), .O(new_n150_));
  aoi21  g106(.a(new_n108_), .b(x28), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n149_), .c(new_n147_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n144_), .c(x00), .O(new_n153_));
  inv1   g109(.a(x18), .O(new_n154_));
  nand2  g110(.a(new_n123_), .b(x16), .O(new_n155_));
  nand2  g111(.a(x15), .b(x13), .O(new_n156_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n138_), .c(x26), .O(z8));
  inv1   g116(.a(x00), .O(new_n161_));
  aoi21  g117(.a(new_n124_), .b(new_n120_), .c(x33), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n106_), .c(new_n98_), .d(x18), .O(new_n163_));
  ...
  nand3  g123(.a(new_n167_), .b(x15), .c(x13), .O(new_n168_));
  inv1   g124(.a(x33), .O(new_n169_));
  nand4  g125(.a(new_n127_), .b(new_n169_), .c(new_n106_), .d(new_n98_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n165_), .c(new_n134_), .O(new_n172_));
  inv1   g128(.a(new_n134_), .O(new_n173_));
  nand3  g129(.a(x31), .b(x30), .c(x18), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  nor2   g131(.a(new_n169_), .b(x31), .O(new_n176_));
  aoi21  g132(.a(new_n175_), .b(new_n162_), .c(new_n176_), .O(new_n177_));
  inv1   g133(.a(new_n168_), .O(new_n178_));
  nor3   g134(.a(x33), .b(new_n106_), .c(new_n98_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n178_), .c(new_n127_), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n161_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n106_), .b(x30), .O(new_n182_));
  oai21  g138(.a(new_n113_), .b(new_n142_), .c(new_n112_), .O(new_n183_));
  nand2  g139(.a(x31), .b(new_n98_), .O(new_n184_));
  inv1   g140(.a(x12), .O(new_n185_));
  nand2  g141(.a(new_n113_), .b(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n184_), .c(new_n183_), .d(new_n182_), .O(new_n187_));
  inv1   g143(.a(x10), .O(new_n188_));
  oai21  g144(.a(new_n166_), .b(new_n188_), .c(new_n121_), .O(new_n189_));
  nand2  g145(.a(new_n115_), .b(x14), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n129_), .c(x18), .d(x17), .O(new_n191_));
  oai21  g147(.a(new_n166_), .b(new_n121_), .c(new_n115_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n191_), .c(new_n189_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n187_), .c(x00), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n157_), .c(new_n169_), .O(new_n195_));
  aoi21  g151(.a(new_n181_), .b(new_n173_), .c(new_n195_), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n172_), .c(x26), .O(z9));
endmodule
