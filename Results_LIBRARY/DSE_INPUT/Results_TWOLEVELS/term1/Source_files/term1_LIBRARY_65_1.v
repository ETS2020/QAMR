...
module FAU ( 
  ...
  nand3  g082(.a(x16), .b(new_n126_), .c(x10), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n122_), .O(new_n128_));
  ...
  nor2   g087(.a(new_n115_), .b(new_n113_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x17), .c(new_n121_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n120_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(x15), .c(new_n128_), .O(new_n135_));
  nand2  g091(.a(new_n130_), .b(x29), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x30), .O(new_n137_));
  oai22  g093(.a(new_n137_), .b(new_n135_), .c(new_n131_), .d(new_n129_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(z0), .c(x31), .O(new_n139_));
  nor2   g095(.a(new_n121_), .b(new_n126_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n123_), .O(new_n141_));
  nand3  g097(.a(new_n132_), .b(x17), .c(x11), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n121_), .O(new_n143_));
  nand2  g099(.a(new_n132_), .b(x12), .O(new_n144_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n122_), .c(new_n126_), .O(new_n148_));
  ...
  aoi21  g115(.a(new_n157_), .b(new_n139_), .c(new_n159_), .O(z8));
  inv1   g116(.a(new_n136_), .O(new_n161_));
  inv1   g117(.a(x33), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(x31), .c(x30), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n135_), .c(new_n162_), .d(x31), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand3  g121(.a(new_n162_), .b(new_n106_), .c(new_n98_), .O(new_n166_));
  nand2  g122(.a(x33), .b(x31), .O(new_n167_));
  oai21  g123(.a(new_n166_), .b(new_n129_), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n106_), .b(x30), .O(new_n169_));
  nand2  g125(.a(x18), .b(x12), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n112_), .O(new_n171_));
  nand2  g127(.a(x31), .b(new_n98_), .O(new_n172_));
  inv1   g128(.a(x13), .O(new_n173_));
  nand2  g129(.a(new_n113_), .b(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n171_), .d(new_n169_), .O(new_n175_));
  nand2  g131(.a(new_n115_), .b(x14), .O(new_n176_));
  nor2   g132(.a(new_n113_), .b(new_n112_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n176_), .c(new_n140_), .O(new_n178_));
  nand2  g134(.a(new_n177_), .b(new_n140_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n115_), .O(new_n180_));
  inv1   g136(.a(new_n177_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n147_), .c(new_n126_), .O(new_n182_));
  ...
  nor2   g141(.a(new_n185_), .b(new_n175_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n162_), .O(new_n187_));
  aoi21  g143(.a(new_n168_), .b(new_n136_), .c(new_n187_), .O(new_n188_));
