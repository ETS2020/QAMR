...
module FAU ( 
  ...
  oai21  g034(.a(x22), .b(x17), .c(x24), .O(new_n79_));
  ...
  nand2  g105(.a(new_n116_), .b(new_n149_), .O(new_n150_));
  ...
  aoi21  g109(.a(new_n108_), .b(x28), .c(new_n153_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n152_), .c(new_n148_), .d(new_n145_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n143_), .c(x32), .O(new_n156_));
  inv1   g112(.a(x26), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x00), .O(new_n158_));
  aoi21  g114(.a(new_n156_), .b(new_n135_), .c(new_n158_), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  oai21  g116(.a(new_n128_), .b(new_n126_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n106_), .b(new_n98_), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n106_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n131_), .O(new_n164_));
  inv1   g120(.a(new_n131_), .O(new_n165_));
  ...
  aoi21  g124(.a(x19), .b(x12), .c(x17), .O(new_n169_));
  nand2  g125(.a(new_n106_), .b(x30), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n98_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n150_), .c(new_n170_), .O(new_n172_));
  nand2  g128(.a(new_n114_), .b(x13), .O(new_n173_));
  nor2   g129(.a(new_n116_), .b(new_n113_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n136_), .c(new_n173_), .O(new_n175_));
  ...
  nor3   g138(.a(new_n182_), .b(new_n172_), .c(new_n169_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n160_), .O(new_n184_));
  aoi21  g140(.a(new_n168_), .b(new_n165_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n164_), .c(new_n158_), .O(z9));
endmodule
