...
module FAU ( 
  ...
  nand2  g055(.a(new_n91_), .b(new_n58_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n99_), .c(new_n94_), .O(z5));
  ...
  nand3  g085(.a(new_n129_), .b(new_n77_), .c(x11), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n127_), .c(new_n118_), .O(new_n131_));
  nand3  g087(.a(x16), .b(new_n118_), .c(x10), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand2  g089(.a(new_n97_), .b(new_n96_), .O(new_n134_));
  ...
  nor2   g096(.a(new_n77_), .b(new_n118_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n129_), .O(new_n142_));
  nor2   g098(.a(new_n122_), .b(new_n120_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x17), .c(x11), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n77_), .O(new_n145_));
  ...
  aoi21  g110(.a(new_n103_), .b(new_n95_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g120(.a(new_n112_), .b(new_n103_), .O(new_n165_));
  ...
  oai21  g139(.a(new_n183_), .b(new_n149_), .c(new_n118_), .O(new_n184_));
  nand2  g140(.a(new_n179_), .b(x11), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n77_), .O(new_n186_));
