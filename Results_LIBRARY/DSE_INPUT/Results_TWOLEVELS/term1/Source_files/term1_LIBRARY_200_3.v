...
module FAU ( 
  ...
  nand3  g057(.a(new_n97_), .b(new_n101_), .c(x29), .O(new_n102_));
  nand2  g058(.a(new_n97_), .b(x29), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  oai22  g060(.a(new_n104_), .b(new_n101_), .c(new_n102_), .d(new_n57_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n91_), .c(new_n84_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand3  g064(.a(new_n104_), .b(new_n108_), .c(x30), .O(new_n109_));
  nor2   g065(.a(new_n101_), .b(new_n94_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n97_), .c(new_n108_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n99_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n109_), .c(new_n84_), .O(z7));
  ...
  nand2  g086(.a(new_n96_), .b(new_n95_), .O(new_n131_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n96_), .O(new_n150_));
  oai21  g106(.a(x19), .b(x14), .c(x31), .O(new_n151_));
  aoi21  g107(.a(new_n101_), .b(new_n94_), .c(new_n151_), .O(new_n152_));
