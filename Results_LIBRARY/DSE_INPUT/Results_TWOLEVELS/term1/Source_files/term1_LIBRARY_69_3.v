...
module FAU ( 
  ...
  nand3  g084(.a(z0), .b(x31), .c(x19), .O(new_n129_));
  ...
  nand2  g090(.a(new_n115_), .b(x13), .O(new_n135_));
  ...
  oai21  g100(.a(x17), .b(x12), .c(x19), .O(new_n145_));
  ...
  nand3  g109(.a(new_n106_), .b(new_n98_), .c(x19), .O(new_n154_));
  ...
  nand3  g114(.a(x31), .b(x30), .c(x19), .O(new_n159_));
