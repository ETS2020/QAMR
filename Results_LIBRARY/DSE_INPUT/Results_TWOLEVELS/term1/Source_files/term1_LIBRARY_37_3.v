...
module FAU ( 
  ...
  nand4  g120(.a(x17), .b(x16), .c(x15), .d(x13), .O(new_n165_));
  nor2   g121(.a(new_n115_), .b(x18), .O(new_n166_));
  ...
  nand3  g125(.a(x19), .b(new_n114_), .c(x12), .O(new_n170_));
  nand3  g126(.a(new_n115_), .b(x17), .c(x14), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(new_n124_), .O(new_n172_));
  nand4  g128(.a(x19), .b(x17), .c(new_n124_), .d(x11), .O(new_n173_));
  ...
  nand3  g135(.a(new_n106_), .b(new_n98_), .c(x18), .O(new_n180_));
  ...
  nand3  g142(.a(x31), .b(x30), .c(x18), .O(new_n187_));
  ...
  inv1   g146(.a(new_n144_), .O(new_n191_));
  nand2  g147(.a(new_n115_), .b(x14), .O(new_n192_));
