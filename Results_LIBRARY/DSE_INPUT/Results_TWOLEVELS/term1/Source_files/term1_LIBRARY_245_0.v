...
module FAU ( 
  ...
  nand4  g015(.a(new_n59_), .b(x06), .c(new_n50_), .d(new_n56_), .O(new_n60_));
  ...
  nor2   g019(.a(new_n50_), .b(x01), .O(new_n64_));
  nor2   g020(.a(x06), .b(x02), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(new_n63_), .c(new_n60_), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n55_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  nand3  g025(.a(new_n62_), .b(x06), .c(x05), .O(new_n70_));
  nand2  g026(.a(new_n59_), .b(x02), .O(new_n71_));
  inv1   g027(.a(x06), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n57_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n56_), .O(new_n75_));
  nor2   g031(.a(new_n47_), .b(x02), .O(new_n76_));
  xor2a  g032(.a(x03), .b(x02), .O(new_n77_));
  aoi22  g033(.a(new_n77_), .b(x01), .c(new_n76_), .d(new_n72_), .O(new_n78_));
  ...
  inv1   g039(.a(new_n61_), .O(new_n84_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n102_), .c(new_n114_), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n104_), .O(new_n118_));
