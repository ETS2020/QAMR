...
module FAU ( 
  ...
  nand3  g084(.a(z0), .b(x31), .c(x18), .O(new_n129_));
  ...
  nand2  g088(.a(x17), .b(x16), .O(new_n133_));
  ...
  nand3  g109(.a(new_n106_), .b(new_n98_), .c(x18), .O(new_n154_));
  ...
  nand3  g114(.a(x31), .b(x30), .c(x18), .O(new_n159_));
