// Benchmark "FAU" written by ABC on Thu Jun 25 19:59:03 2020
...
module FAU ( 
  ...
  inv1   g081(.a(x26), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x15), .O(new_n127_));
  aoi21  g083(.a(new_n125_), .b(new_n121_), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g093(.a(new_n131_), .b(new_n128_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n116_), .b(x14), .O(new_n139_));
  nor2   g095(.a(new_n114_), .b(new_n113_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x16), .c(x15), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g099(.a(new_n141_), .b(new_n116_), .O(new_n144_));
  nand3  g100(.a(new_n140_), .b(x16), .c(x10), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n129_), .O(new_n146_));
  nand2  g102(.a(new_n140_), .b(x11), .O(new_n147_));
  ...
  nand2  g109(.a(new_n114_), .b(new_n153_), .O(new_n154_));
  ...
  aoi21  g117(.a(new_n161_), .b(new_n138_), .c(new_n112_), .O(z8));
  aoi21  g118(.a(new_n125_), .b(new_n121_), .c(x33), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n106_), .c(new_n98_), .d(x15), .O(new_n164_));
  nand2  g120(.a(x33), .b(x31), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n164_), .c(x26), .O(new_n166_));
  nand4  g122(.a(x17), .b(x16), .c(new_n129_), .d(x10), .O(new_n167_));
  inv1   g123(.a(x33), .O(new_n168_));
  nor2   g124(.a(new_n116_), .b(new_n114_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n106_), .d(new_n98_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n166_), .c(new_n134_), .O(new_n172_));
  inv1   g128(.a(new_n134_), .O(new_n173_));
  nand3  g129(.a(x31), .b(x30), .c(x15), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  nor2   g131(.a(new_n168_), .b(x31), .O(new_n176_));
  aoi21  g132(.a(new_n175_), .b(new_n163_), .c(new_n176_), .O(new_n177_));
  inv1   g133(.a(new_n167_), .O(new_n178_));
  nor3   g134(.a(x33), .b(new_n106_), .c(new_n98_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n178_), .c(new_n169_), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(x26), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n106_), .b(x30), .O(new_n182_));
  inv1   g138(.a(new_n157_), .O(new_n183_));
  nand2  g139(.a(x31), .b(new_n98_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n154_), .d(new_n182_), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n149_), .O(new_n186_));
  nand2  g142(.a(x33), .b(new_n126_), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  aoi21  g144(.a(new_n181_), .b(new_n173_), .c(new_n188_), .O(new_n189_));
