...
module FAU ( 
  ...
  nand2  g070(.a(x19), .b(new_n114_), .O(new_n115_));
  ...
  nand2  g092(.a(x19), .b(x17), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(new_n114_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(new_n112_), .O(new_n140_));
  inv1   g096(.a(x11), .O(new_n141_));
  oai21  g097(.a(new_n137_), .b(new_n141_), .c(new_n122_), .O(new_n142_));
  inv1   g098(.a(new_n136_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n124_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n142_), .c(new_n140_), .d(new_n138_), .O(new_n145_));
  ...
  aoi21  g106(.a(x19), .b(x12), .c(x17), .O(new_n151_));
  ...
  oai21  g123(.a(new_n113_), .b(new_n141_), .c(new_n122_), .O(new_n168_));
  nand2  g124(.a(x31), .b(new_n98_), .O(new_n169_));
  inv1   g125(.a(x12), .O(new_n170_));
  nand2  g126(.a(new_n113_), .b(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n169_), .c(new_n168_), .d(new_n167_), .O(new_n172_));
  nand2  g128(.a(new_n116_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n143_), .c(x18), .d(x17), .O(new_n174_));
  nand3  g130(.a(x17), .b(x16), .c(x15), .O(new_n175_));
  nand3  g131(.a(x17), .b(x16), .c(x10), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n112_), .c(new_n175_), .d(new_n116_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n174_), .c(new_n138_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n172_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n158_), .O(new_n180_));
  aoi21  g136(.a(new_n166_), .b(new_n163_), .c(new_n180_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n162_), .c(new_n156_), .O(z9));
endmodule
