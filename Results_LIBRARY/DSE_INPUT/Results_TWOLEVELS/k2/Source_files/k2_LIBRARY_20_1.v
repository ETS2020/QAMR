...
module FAU ( 
  ...
  nand2  g0640(.a(new_n278_), .b(new_n120_), .O(new_n732_));
  nand2  g0641(.a(x20), .b(x05), .O(new_n733_));
  oai22  g0642(.a(new_n733_), .b(new_n182_), .c(new_n732_), .d(new_n279_), .O(new_n734_));
  ...
  inv1   g1238(.a(new_n732_), .O(new_n1330_));
  ...
  nand4  g1552(.a(new_n1643_), .b(new_n1330_), .c(x19), .d(new_n279_), .O(new_n1644_));
  nand2  g1553(.a(new_n1644_), .b(new_n1642_), .O(z38));
