// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:10 2020
...
module FAU ( 
  ...
  oai21  g20(.a(new_n21_), .b(x10), .c(x11), .O(new_n40_));
  and2   g21(.a(x13), .b(x09), .O(new_n41_));
  nor2   g22(.a(x11), .b(x10), .O(new_n42_));
  oai21  g23(.a(new_n42_), .b(new_n41_), .c(new_n24_), .O(new_n43_));
  nand3  g24(.a(new_n43_), .b(new_n40_), .c(new_n23_), .O(new_n44_));
  ...
  aoi21  g32(.a(new_n42_), .b(new_n24_), .c(new_n49_), .O(new_n52_));
