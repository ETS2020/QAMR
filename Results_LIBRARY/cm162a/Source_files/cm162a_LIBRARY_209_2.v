...
module FAU ( 
  ...
  nor2   g12(.a(new_n24_), .b(x08), .O(new_n32_));
  nor2   g13(.a(new_n23_), .b(new_n28_), .O(new_n33_));
  oai21  g14(.a(new_n33_), .b(new_n32_), .c(x10), .O(new_n34_));
  nor2   g15(.a(x10), .b(x08), .O(new_n35_));
  nand3  g16(.a(x13), .b(x09), .c(x03), .O(new_n36_));
  inv1   g17(.a(new_n36_), .O(new_n37_));
  oai21  g18(.a(new_n37_), .b(new_n35_), .c(new_n24_), .O(new_n38_));
  inv1   g19(.a(x01), .O(new_n39_));
  aoi21  g20(.a(new_n28_), .b(new_n39_), .c(new_n29_), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n38_), .c(new_n34_), .O(z1));
  inv1   g22(.a(x11), .O(new_n42_));
  nand2  g23(.a(new_n35_), .b(new_n42_), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n20_), .c(new_n21_), .O(new_n44_));
  aoi21  g25(.a(new_n35_), .b(new_n24_), .c(new_n42_), .O(new_n45_));
