// Benchmark "FAU" written by ABC on Thu Jun 25 17:18:58 2020
...
module FAU ( 
  ...
  nor2   g14(.a(new_n24_), .b(new_n33_), .O(new_n34_));
  aoi21  g15(.a(new_n32_), .b(new_n24_), .c(new_n34_), .O(new_n35_));
  oai21  g16(.a(x03), .b(x01), .c(x05), .O(new_n36_));
  aoi21  g17(.a(x10), .b(x08), .c(new_n36_), .O(new_n37_));
  oai21  g18(.a(new_n35_), .b(new_n28_), .c(new_n37_), .O(z1));
  inv1   g19(.a(x11), .O(new_n39_));
  nor2   g20(.a(x10), .b(x08), .O(new_n40_));
  nand2  g21(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  aoi21  g22(.a(new_n41_), .b(new_n20_), .c(new_n21_), .O(new_n42_));
  aoi21  g23(.a(new_n40_), .b(new_n24_), .c(new_n39_), .O(new_n43_));
  ...
  nand4  g29(.a(new_n48_), .b(new_n39_), .c(new_n33_), .d(new_n23_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n21_), .O(new_n50_));
  nor3   g31(.a(x11), .b(x10), .c(x08), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n24_), .c(new_n48_), .O(new_n52_));
