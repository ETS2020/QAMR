// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:13 2020
...
module FAU ( 
  ...
  nand4  g20(.a(new_n24_), .b(new_n21_), .c(new_n32_), .d(new_n20_), .O(new_n40_));
  ...
  oai21  g26(.a(new_n24_), .b(new_n23_), .c(new_n45_), .O(new_n46_));
