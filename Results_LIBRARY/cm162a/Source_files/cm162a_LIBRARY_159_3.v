// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:27 2020
...
module FAU ( 
  ...
  aoi21  g23(.a(new_n24_), .b(new_n32_), .c(new_n40_), .O(new_n43_));
  oai21  g24(.a(new_n43_), .b(new_n42_), .c(x03), .O(new_n44_));
  oai21  g25(.a(x06), .b(x03), .c(x05), .O(new_n45_));
  aoi21  g26(.a(x11), .b(x08), .c(new_n45_), .O(new_n46_));
  nand2  g27(.a(new_n46_), .b(new_n44_), .O(z2));
  inv1   g28(.a(x12), .O(new_n48_));
  nand4  g29(.a(new_n48_), .b(new_n40_), .c(new_n32_), .d(new_n23_), .O(new_n49_));
