// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:41 2020
...
module FAU ( 
  ...
  aoi21  g16(.a(new_n22_), .b(new_n20_), .c(new_n35_), .O(new_n36_));
  ...
  aoi21  g23(.a(new_n42_), .b(new_n24_), .c(new_n21_), .O(new_n43_));
  aoi21  g24(.a(new_n32_), .b(new_n22_), .c(new_n41_), .O(new_n44_));
  ...
  nand2  g29(.a(new_n22_), .b(new_n20_), .O(new_n49_));
  nor2   g30(.a(x11), .b(x10), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(x08), .c(new_n24_), .O(new_n51_));
  aoi22  g32(.a(new_n51_), .b(new_n22_), .c(new_n49_), .d(x12), .O(new_n52_));
  inv1   g33(.a(x07), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n28_), .c(new_n29_), .O(new_n54_));
  oai21  g35(.a(new_n52_), .b(new_n28_), .c(new_n54_), .O(z3));
