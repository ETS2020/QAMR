// Benchmark "FAU" written by ABC on Thu Jun 25 17:19:18 2020
...
module FAU ( 
  ...
  aoi21  g16(.a(new_n24_), .b(new_n34_), .c(new_n35_), .O(new_n36_));
  ...
  aoi21  g23(.a(new_n42_), .b(new_n21_), .c(new_n23_), .O(new_n43_));
  aoi21  g24(.a(new_n31_), .b(new_n24_), .c(new_n41_), .O(new_n44_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n41_), .c(new_n35_), .d(new_n34_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n21_), .c(new_n23_), .O(new_n51_));
