// Benchmark "FAU" written by ABC on Fri Jun 26 05:08:21 2020
...
module FAU ( 
  ...
  oai21  g251(.a(x125), .b(x101), .c(new_n262_), .O(new_n409_));
  ...
  oai21  g255(.a(new_n263_), .b(x029), .c(new_n412_), .O(new_n413_));
  nor2   g256(.a(x117), .b(x021), .O(new_n414_));
  aoi21  g257(.a(new_n414_), .b(x125), .c(x085), .O(new_n415_));
  oai21  g258(.a(new_n240_), .b(x109), .c(x037), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(x117), .O(new_n417_));
  inv1   g260(.a(x101), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(x061), .c(new_n229_), .O(new_n419_));
  nand2  g262(.a(new_n419_), .b(new_n243_), .O(new_n420_));
  nand4  g263(.a(new_n420_), .b(new_n417_), .c(new_n415_), .d(new_n413_), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n411_), .c(new_n259_), .O(new_n422_));
  ...
  nand3  g270(.a(new_n239_), .b(new_n225_), .c(x029), .O(new_n428_));
  aoi21  g271(.a(new_n428_), .b(new_n235_), .c(x037), .O(new_n429_));
  nor2   g272(.a(x085), .b(x053), .O(new_n430_));
  and2   g273(.a(new_n430_), .b(new_n263_), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(new_n429_), .c(x069), .O(new_n432_));
  nand2  g275(.a(new_n237_), .b(x029), .O(new_n433_));
  aoi21  g276(.a(new_n237_), .b(x029), .c(x021), .O(new_n434_));
  oai21  g277(.a(x125), .b(x101), .c(new_n412_), .O(new_n435_));
  oai22  g278(.a(new_n435_), .b(new_n433_), .c(new_n434_), .d(new_n410_), .O(new_n436_));
  nand2  g279(.a(new_n412_), .b(x029), .O(new_n437_));
  aoi21  g280(.a(new_n437_), .b(new_n255_), .c(new_n243_), .O(new_n438_));
  aoi21  g281(.a(new_n436_), .b(new_n225_), .c(new_n438_), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(x085), .c(new_n432_), .O(new_n440_));
  inv1   g283(.a(new_n410_), .O(new_n441_));
  aoi21  g284(.a(new_n430_), .b(new_n441_), .c(x077), .O(new_n442_));
  nor2   g285(.a(new_n235_), .b(x013), .O(new_n443_));
  ...
  aoi21  g289(.a(new_n440_), .b(new_n259_), .c(new_n446_), .O(new_n447_));
