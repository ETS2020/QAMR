// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:46 2020
...
module FAU ( 
  ...
  nand3  g071(.a(new_n227_), .b(x085), .c(x053), .O(new_n228_));
  ...
  nand2  g080(.a(new_n236_), .b(new_n223_), .O(new_n237_));
  aoi21  g081(.a(new_n237_), .b(x021), .c(new_n233_), .O(new_n238_));
  ...
  nor2   g087(.a(new_n243_), .b(new_n237_), .O(new_n244_));
  oai21  g088(.a(new_n244_), .b(new_n238_), .c(x053), .O(new_n245_));
  inv1   g089(.a(x037), .O(new_n246_));
  aoi21  g090(.a(new_n240_), .b(new_n239_), .c(x029), .O(new_n247_));
  oai21  g091(.a(new_n247_), .b(new_n227_), .c(new_n246_), .O(new_n248_));
  aoi21  g092(.a(new_n248_), .b(new_n245_), .c(new_n230_), .O(new_n249_));
  oai21  g093(.a(new_n249_), .b(new_n229_), .c(x077), .O(new_n250_));
  inv1   g094(.a(x005), .O(new_n251_));
  nand3  g095(.a(new_n242_), .b(x093), .c(x069), .O(new_n252_));
  oai22  g096(.a(new_n232_), .b(new_n231_), .c(x069), .d(x037), .O(new_n253_));
  nand3  g097(.a(new_n253_), .b(new_n252_), .c(x085), .O(new_n254_));
  inv1   g098(.a(x125), .O(new_n255_));
  nand2  g099(.a(x117), .b(x021), .O(new_n256_));
  oai21  g100(.a(x117), .b(new_n231_), .c(new_n256_), .O(new_n257_));
  nand2  g101(.a(new_n257_), .b(new_n255_), .O(new_n258_));
  oai21  g102(.a(new_n227_), .b(new_n223_), .c(new_n241_), .O(new_n259_));
  oai22  g103(.a(x125), .b(x093), .c(x101), .d(new_n246_), .O(new_n260_));
  nand2  g104(.a(new_n260_), .b(x061), .O(new_n261_));
  nand3  g105(.a(new_n261_), .b(new_n259_), .c(new_n258_), .O(new_n262_));
  oai21  g106(.a(new_n262_), .b(new_n254_), .c(x053), .O(new_n263_));
  oai21  g107(.a(x085), .b(new_n239_), .c(new_n263_), .O(new_n264_));
  nand2  g108(.a(x085), .b(x053), .O(new_n265_));
  oai21  g109(.a(new_n233_), .b(new_n265_), .c(x077), .O(new_n266_));
  nand2  g110(.a(new_n266_), .b(new_n239_), .O(new_n267_));
  inv1   g111(.a(x053), .O(new_n268_));
  nor2   g112(.a(x021), .b(new_n239_), .O(new_n269_));
  nor2   g113(.a(x069), .b(new_n268_), .O(new_n270_));
  aoi22  g114(.a(new_n270_), .b(new_n269_), .c(new_n268_), .d(new_n246_), .O(new_n271_));
  nand2  g115(.a(new_n271_), .b(new_n267_), .O(new_n272_));
  aoi21  g116(.a(new_n264_), .b(new_n251_), .c(new_n272_), .O(new_n273_));
  aoi21  g117(.a(new_n273_), .b(new_n250_), .c(new_n222_), .O(z05));
  ...
  oai21  g248(.a(x125), .b(x101), .c(new_n235_), .O(new_n406_));
  nor2   g249(.a(x117), .b(x109), .O(new_n407_));
  aoi21  g250(.a(new_n407_), .b(new_n406_), .c(x069), .O(new_n408_));
  oai22  g251(.a(new_n236_), .b(x029), .c(new_n240_), .d(new_n239_), .O(new_n409_));
  nor2   g252(.a(x117), .b(x021), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(x125), .c(x085), .O(new_n411_));
  oai21  g254(.a(new_n255_), .b(x109), .c(x037), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(x117), .O(new_n413_));
  inv1   g256(.a(x101), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(x061), .c(new_n231_), .O(new_n415_));
  nand2  g258(.a(new_n415_), .b(new_n246_), .O(new_n416_));
  nand4  g259(.a(new_n416_), .b(new_n413_), .c(new_n411_), .d(new_n409_), .O(new_n417_));
  nor2   g260(.a(new_n417_), .b(new_n408_), .O(new_n418_));
  nor2   g261(.a(new_n418_), .b(x077), .O(new_n419_));
  nand3  g262(.a(x125), .b(new_n234_), .c(new_n246_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n407_), .c(new_n239_), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n419_), .c(new_n268_), .O(new_n422_));
  inv1   g265(.a(new_n236_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(x077), .c(new_n268_), .O(new_n424_));
  oai22  g267(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n425_));
  nand3  g268(.a(new_n425_), .b(x069), .c(x021), .O(new_n426_));
  nand2  g269(.a(x077), .b(x013), .O(new_n427_));
  nand4  g270(.a(x085), .b(new_n246_), .c(new_n239_), .d(x005), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(new_n427_), .c(new_n426_), .O(new_n429_));
  aoi21  g272(.a(new_n424_), .b(x037), .c(new_n429_), .O(new_n430_));
  aoi21  g273(.a(new_n430_), .b(new_n422_), .c(x045), .O(z13));
  inv1   g274(.a(x102), .O(new_n432_));
  nand2  g275(.a(new_n292_), .b(new_n432_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n314_), .O(new_n434_));
  ...
  oai21  g280(.a(new_n315_), .b(x030), .c(new_n437_), .O(new_n438_));
  nor2   g281(.a(x118), .b(x022), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(x126), .c(x086), .O(new_n440_));
  oai21  g283(.a(new_n292_), .b(x110), .c(x038), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(x118), .O(new_n442_));
  oai21  g285(.a(new_n432_), .b(x062), .c(new_n281_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n295_), .O(new_n444_));
  nand4  g287(.a(new_n444_), .b(new_n442_), .c(new_n440_), .d(new_n438_), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n436_), .c(new_n311_), .O(new_n446_));
  nand4  g289(.a(x126), .b(new_n298_), .c(new_n295_), .d(x014), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n446_), .c(x054), .O(new_n448_));
  nand3  g291(.a(x086), .b(new_n295_), .c(new_n286_), .O(new_n449_));
  inv1   g292(.a(new_n449_), .O(new_n450_));
  oai21  g293(.a(new_n450_), .b(new_n448_), .c(x006), .O(new_n451_));
  nand2  g294(.a(new_n289_), .b(x030), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(new_n287_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n311_), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n286_), .c(new_n435_), .O(new_n455_));
  nor2   g298(.a(new_n285_), .b(x022), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n315_), .c(x070), .O(new_n457_));
  nand4  g300(.a(new_n437_), .b(new_n433_), .c(new_n289_), .d(x030), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(new_n457_), .c(x078), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n455_), .c(new_n277_), .O(new_n460_));
  nand2  g303(.a(new_n437_), .b(x030), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n307_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n311_), .c(x038), .O(new_n463_));
  ...
  aoi21  g311(.a(new_n464_), .b(new_n291_), .c(new_n468_), .O(new_n469_));
