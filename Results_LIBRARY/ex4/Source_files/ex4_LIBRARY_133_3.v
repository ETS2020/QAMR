// Benchmark "FAU" written by ABC on Fri Jun 26 05:06:53 2020
...
module FAU ( 
  ...
  nand2  g290(.a(new_n294_), .b(new_n447_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n316_), .O(new_n449_));
  ...
  nand2  g309(.a(new_n291_), .b(x030), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n289_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n313_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n288_), .c(new_n450_), .O(new_n470_));
  nor2   g313(.a(new_n287_), .b(x022), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n317_), .c(x070), .O(new_n472_));
  nand4  g315(.a(new_n452_), .b(new_n448_), .c(new_n291_), .d(x030), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n472_), .c(x078), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n470_), .c(new_n279_), .O(new_n475_));
  nand2  g318(.a(new_n452_), .b(x030), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n309_), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n313_), .c(x038), .O(new_n478_));
  ...
  aoi21  g326(.a(new_n479_), .b(new_n293_), .c(new_n483_), .O(new_n484_));
