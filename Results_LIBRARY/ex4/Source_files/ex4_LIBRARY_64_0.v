// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:56 2020
...
module FAU ( 
  ...
  nand3  g151(.a(x086), .b(x054), .c(new_n286_), .O(new_n308_));
  aoi21  g152(.a(new_n308_), .b(x022), .c(new_n296_), .O(new_n309_));
  inv1   g153(.a(new_n290_), .O(new_n310_));
  nand2  g154(.a(x086), .b(x054), .O(new_n311_));
  nor2   g155(.a(new_n311_), .b(new_n310_), .O(new_n312_));
  oai21  g156(.a(new_n312_), .b(new_n309_), .c(new_n279_), .O(new_n313_));
  inv1   g157(.a(new_n284_), .O(new_n314_));
  ...
  nand4  g163(.a(new_n319_), .b(new_n289_), .c(new_n280_), .d(new_n286_), .O(new_n320_));
  aoi21  g164(.a(new_n320_), .b(new_n317_), .c(new_n278_), .O(new_n321_));
  nand2  g165(.a(new_n289_), .b(new_n286_), .O(new_n322_));
  aoi21  g166(.a(new_n322_), .b(new_n310_), .c(x038), .O(new_n323_));
  oai21  g167(.a(new_n323_), .b(new_n321_), .c(x086), .O(new_n324_));
  nand2  g168(.a(new_n324_), .b(new_n313_), .O(new_n325_));
  oai21  g169(.a(new_n311_), .b(new_n284_), .c(x078), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n287_), .O(new_n327_));
  nor2   g171(.a(x022), .b(new_n287_), .O(new_n328_));
  ...
  aoi21  g176(.a(new_n332_), .b(new_n307_), .c(new_n276_), .O(z06));
  ...
  nor2   g192(.a(new_n336_), .b(x056), .O(new_n350_));
  oai21  g193(.a(new_n350_), .b(x104), .c(new_n159_), .O(new_n351_));
  nand4  g194(.a(new_n351_), .b(new_n349_), .c(new_n347_), .d(new_n345_), .O(new_n352_));
  oai21  g195(.a(new_n352_), .b(new_n341_), .c(new_n161_), .O(new_n353_));
  nand4  g196(.a(x120), .b(new_n343_), .c(new_n159_), .d(x008), .O(new_n354_));
  aoi21  g197(.a(new_n354_), .b(new_n353_), .c(x048), .O(new_n355_));
  nand3  g198(.a(x080), .b(new_n159_), .c(new_n158_), .O(new_n356_));
  ...
  aoi21  g205(.a(new_n362_), .b(new_n158_), .c(new_n340_), .O(new_n363_));
  nor2   g206(.a(new_n360_), .b(x016), .O(new_n364_));
  oai21  g207(.a(new_n364_), .b(new_n344_), .c(x064), .O(new_n365_));
  nand3  g208(.a(new_n361_), .b(new_n342_), .c(new_n338_), .O(new_n366_));
  ...
  oai21  g213(.a(new_n369_), .b(new_n344_), .c(new_n370_), .O(new_n371_));
  ...
  aoi21  g219(.a(new_n372_), .b(new_n359_), .c(new_n376_), .O(new_n377_));
  aoi21  g220(.a(new_n377_), .b(new_n358_), .c(x040), .O(z08));
  ...
  nand2  g288(.a(new_n283_), .b(new_n282_), .O(new_n446_));
  nand2  g289(.a(new_n290_), .b(x030), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n288_), .c(x078), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(x014), .c(new_n446_), .O(new_n449_));
  inv1   g292(.a(x078), .O(new_n450_));
  nand2  g293(.a(x030), .b(new_n288_), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n315_), .c(new_n279_), .O(new_n452_));
  nand2  g295(.a(x022), .b(x014), .O(new_n453_));
  inv1   g296(.a(x102), .O(new_n454_));
  nand2  g297(.a(new_n293_), .b(new_n454_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n453_), .O(new_n456_));
  nor2   g299(.a(new_n456_), .b(new_n447_), .O(new_n457_));
  oai21  g300(.a(new_n457_), .b(new_n452_), .c(new_n450_), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(new_n449_), .c(x054), .O(new_n459_));
  aoi21  g302(.a(new_n453_), .b(x030), .c(new_n319_), .O(new_n460_));
  nor3   g303(.a(new_n460_), .b(x078), .c(new_n296_), .O(new_n461_));
  oai21  g304(.a(new_n461_), .b(new_n459_), .c(new_n292_), .O(new_n462_));
  nand2  g305(.a(x070), .b(x038), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n446_), .c(x086), .O(new_n464_));
  nor2   g307(.a(x094), .b(x070), .O(new_n465_));
  nor2   g308(.a(x118), .b(x022), .O(new_n466_));
  aoi22  g309(.a(new_n466_), .b(x126), .c(new_n465_), .d(new_n455_), .O(new_n467_));
  oai21  g310(.a(new_n319_), .b(x030), .c(new_n453_), .O(new_n468_));
  oai22  g311(.a(new_n293_), .b(new_n318_), .c(new_n454_), .d(x038), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n299_), .O(new_n470_));
  nand4  g313(.a(new_n470_), .b(new_n468_), .c(new_n467_), .d(new_n464_), .O(new_n471_));
  nand4  g314(.a(x126), .b(new_n282_), .c(x038), .d(new_n287_), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n471_), .b(new_n278_), .c(new_n473_), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n296_), .c(new_n287_), .O(new_n475_));
  oai21  g318(.a(new_n474_), .b(x078), .c(new_n475_), .O(new_n476_));
  ...
  aoi21  g323(.a(new_n476_), .b(x006), .c(new_n480_), .O(new_n481_));
