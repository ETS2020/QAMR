// Benchmark "FAU" written by ABC on Fri Jun 26 05:07:29 2020
...
module FAU ( 
  ...
  nand2  g112(.a(new_n242_), .b(new_n233_), .O(new_n269_));
  nand3  g113(.a(new_n269_), .b(new_n225_), .c(new_n234_), .O(new_n270_));
  ...
  nand4  g248(.a(x085), .b(new_n242_), .c(new_n233_), .d(x005), .O(new_n406_));
  nand2  g249(.a(x077), .b(x053), .O(new_n407_));
  nor2   g250(.a(new_n225_), .b(new_n234_), .O(new_n408_));
  oai22  g251(.a(new_n258_), .b(new_n233_), .c(new_n224_), .d(new_n242_), .O(new_n409_));
  aoi21  g252(.a(new_n408_), .b(new_n407_), .c(new_n409_), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(new_n406_), .c(x045), .O(z13));
  inv1   g254(.a(x102), .O(new_n412_));
  nand2  g255(.a(new_n292_), .b(new_n412_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n314_), .O(new_n414_));
  nor2   g257(.a(x118), .b(x110), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n414_), .c(x070), .O(new_n416_));
  nand2  g259(.a(x022), .b(x014), .O(new_n417_));
  oai21  g260(.a(new_n315_), .b(x030), .c(new_n417_), .O(new_n418_));
  nor2   g261(.a(x118), .b(x022), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(x126), .c(x086), .O(new_n420_));
  oai21  g263(.a(new_n292_), .b(x110), .c(x038), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(x118), .O(new_n422_));
  oai21  g265(.a(new_n412_), .b(x062), .c(new_n281_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n295_), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n422_), .c(new_n420_), .d(new_n418_), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(new_n416_), .c(new_n311_), .O(new_n426_));
  nand4  g269(.a(x126), .b(new_n298_), .c(new_n295_), .d(x014), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n426_), .c(x054), .O(new_n428_));
  nand3  g271(.a(x086), .b(new_n295_), .c(new_n286_), .O(new_n429_));
  inv1   g272(.a(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n428_), .c(x006), .O(new_n431_));
  nand2  g274(.a(new_n289_), .b(x030), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n287_), .O(new_n433_));
  nand2  g276(.a(new_n433_), .b(new_n311_), .O(new_n434_));
  aoi21  g277(.a(new_n434_), .b(new_n286_), .c(new_n415_), .O(new_n435_));
  nor2   g278(.a(new_n285_), .b(x022), .O(new_n436_));
  oai21  g279(.a(new_n436_), .b(new_n315_), .c(x070), .O(new_n437_));
  nand4  g280(.a(new_n417_), .b(new_n413_), .c(new_n289_), .d(x030), .O(new_n438_));
  aoi21  g281(.a(new_n438_), .b(new_n437_), .c(x078), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(new_n435_), .c(new_n277_), .O(new_n440_));
  nand2  g283(.a(new_n417_), .b(x030), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n307_), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n311_), .c(x038), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n440_), .O(new_n444_));
  oai22  g287(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(x070), .c(x022), .O(new_n446_));
  aoi22  g289(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n446_), .O(new_n448_));
  aoi21  g291(.a(new_n444_), .b(new_n291_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n431_), .c(x046), .O(z14));
  zero   g293(.O(z07));
  zero   g294(.O(z15));
  zero   g295(.O(z16));
  zero   g296(.O(z17));
