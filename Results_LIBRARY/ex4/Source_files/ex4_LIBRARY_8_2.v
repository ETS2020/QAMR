// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:11 2020
...
module FAU ( 
  ...
  nor2   g104(.a(new_n254_), .b(x029), .O(new_n261_));
  nand3  g105(.a(new_n261_), .b(new_n235_), .c(new_n226_), .O(new_n262_));
  aoi21  g106(.a(new_n262_), .b(new_n260_), .c(new_n258_), .O(new_n263_));
  oai21  g107(.a(new_n263_), .b(new_n257_), .c(x053), .O(new_n264_));
  aoi21  g108(.a(new_n234_), .b(new_n233_), .c(x029), .O(new_n265_));
  nor2   g109(.a(new_n258_), .b(x037), .O(new_n266_));
  oai21  g110(.a(new_n265_), .b(new_n236_), .c(new_n266_), .O(new_n267_));
  nand2  g111(.a(new_n267_), .b(new_n264_), .O(new_n268_));
  aoi22  g112(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n269_));
  nand2  g113(.a(new_n225_), .b(new_n234_), .O(new_n270_));
  aoi22  g114(.a(new_n258_), .b(new_n233_), .c(new_n224_), .d(new_n242_), .O(new_n271_));
  oai21  g115(.a(new_n270_), .b(new_n269_), .c(new_n271_), .O(new_n272_));
  aoi21  g116(.a(new_n268_), .b(x085), .c(new_n272_), .O(new_n273_));
  aoi21  g117(.a(new_n273_), .b(new_n253_), .c(new_n222_), .O(z05));
  ...
  nand2  g248(.a(x101), .b(new_n242_), .O(new_n406_));
  nand2  g249(.a(x125), .b(x093), .O(new_n407_));
  aoi21  g250(.a(new_n407_), .b(new_n406_), .c(x061), .O(new_n408_));
  nand3  g251(.a(x125), .b(new_n229_), .c(new_n234_), .O(new_n409_));
  nor2   g252(.a(x093), .b(x069), .O(new_n410_));
  oai21  g253(.a(x125), .b(x101), .c(new_n410_), .O(new_n411_));
  nand3  g254(.a(new_n411_), .b(new_n409_), .c(new_n238_), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(new_n408_), .c(x005), .O(new_n413_));
  oai21  g256(.a(new_n234_), .b(new_n233_), .c(x005), .O(new_n414_));
  nand2  g257(.a(new_n238_), .b(x069), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n414_), .c(new_n254_), .O(new_n416_));
  nand2  g259(.a(new_n229_), .b(new_n228_), .O(new_n417_));
  oai21  g260(.a(new_n225_), .b(new_n242_), .c(x005), .O(new_n418_));
  oai21  g261(.a(x085), .b(new_n234_), .c(new_n418_), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n417_), .c(new_n416_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n413_), .c(x053), .O(new_n421_));
  nand4  g264(.a(x125), .b(new_n228_), .c(new_n233_), .d(x005), .O(new_n422_));
  oai21  g265(.a(new_n254_), .b(x085), .c(new_n422_), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(x037), .O(new_n424_));
  nand3  g267(.a(x069), .b(new_n242_), .c(x021), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n424_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(new_n421_), .c(new_n258_), .O(new_n427_));
  nand3  g270(.a(new_n417_), .b(new_n238_), .c(new_n224_), .O(new_n428_));
  aoi21  g271(.a(new_n428_), .b(new_n258_), .c(new_n233_), .O(new_n429_));
  nand3  g272(.a(x069), .b(new_n224_), .c(x021), .O(new_n430_));
  nand3  g273(.a(x085), .b(new_n242_), .c(x005), .O(new_n431_));
  aoi21  g274(.a(new_n431_), .b(new_n430_), .c(x013), .O(new_n432_));
  nor2   g275(.a(new_n224_), .b(new_n242_), .O(new_n433_));
  nor3   g276(.a(new_n433_), .b(new_n432_), .c(new_n429_), .O(new_n434_));
  aoi21  g277(.a(new_n434_), .b(new_n427_), .c(x045), .O(z13));
  inv1   g278(.a(x102), .O(new_n436_));
  nand2  g279(.a(new_n292_), .b(new_n436_), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n314_), .O(new_n438_));
  nor2   g281(.a(x118), .b(x110), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n438_), .c(x070), .O(new_n440_));
  nand2  g283(.a(x022), .b(x014), .O(new_n441_));
  oai21  g284(.a(new_n315_), .b(x030), .c(new_n441_), .O(new_n442_));
  nor2   g285(.a(x118), .b(x022), .O(new_n443_));
  aoi21  g286(.a(new_n443_), .b(x126), .c(x086), .O(new_n444_));
  oai21  g287(.a(new_n292_), .b(x110), .c(x038), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(x118), .O(new_n446_));
  oai21  g289(.a(new_n436_), .b(x062), .c(new_n281_), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n295_), .O(new_n448_));
  nand4  g291(.a(new_n448_), .b(new_n446_), .c(new_n444_), .d(new_n442_), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(new_n440_), .c(new_n311_), .O(new_n450_));
  nand4  g293(.a(x126), .b(new_n298_), .c(new_n295_), .d(x014), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n450_), .c(x054), .O(new_n452_));
  nand3  g295(.a(x086), .b(new_n295_), .c(new_n286_), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n452_), .c(x006), .O(new_n455_));
  nand2  g298(.a(new_n289_), .b(x030), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n287_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n311_), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(new_n286_), .c(new_n439_), .O(new_n459_));
  nor2   g302(.a(new_n285_), .b(x022), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n315_), .c(x070), .O(new_n461_));
  nand4  g304(.a(new_n441_), .b(new_n437_), .c(new_n289_), .d(x030), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n461_), .c(x078), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n459_), .c(new_n277_), .O(new_n464_));
  nand2  g307(.a(new_n441_), .b(x030), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n307_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n311_), .c(x038), .O(new_n467_));
  ...
  aoi21  g315(.a(new_n468_), .b(new_n291_), .c(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n455_), .c(x046), .O(z14));
  zero   g317(.O(z07));
  zero   g318(.O(z15));
  zero   g319(.O(z16));
  zero   g320(.O(z17));
