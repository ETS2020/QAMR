...
module FAU ( 
  ...
  nor2   g295(.a(x110), .b(x022), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(x126), .c(x086), .O(new_n454_));
  oai21  g297(.a(new_n293_), .b(x118), .c(x038), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(x110), .O(new_n456_));
  oai21  g299(.a(new_n446_), .b(x062), .c(new_n283_), .O(new_n457_));
