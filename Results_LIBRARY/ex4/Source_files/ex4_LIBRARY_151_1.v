...
module FAU ( 
  ...
  nor2   g257(.a(x109), .b(x021), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(x125), .c(x085), .O(new_n416_));
  oai21  g259(.a(new_n240_), .b(x117), .c(x037), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(x109), .O(new_n418_));
  oai21  g261(.a(new_n408_), .b(x061), .c(new_n230_), .O(new_n419_));
