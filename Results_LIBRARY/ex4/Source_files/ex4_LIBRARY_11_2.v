// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:14 2020
...
module FAU ( 
  ...
  nand3  g176(.a(x096), .b(new_n159_), .c(new_n333_), .O(new_n334_));
  inv1   g177(.a(x104), .O(new_n335_));
  inv1   g178(.a(x112), .O(new_n336_));
  nand2  g179(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  oai21  g180(.a(new_n159_), .b(new_n161_), .c(new_n337_), .O(new_n338_));
  nand3  g181(.a(new_n338_), .b(new_n334_), .c(new_n332_), .O(new_n339_));
  nor2   g182(.a(new_n336_), .b(x104), .O(new_n340_));
  nor2   g183(.a(x112), .b(x016), .O(new_n341_));
  oai21  g184(.a(new_n341_), .b(new_n340_), .c(x120), .O(new_n342_));
  ...
  nand2  g191(.a(x096), .b(new_n161_), .O(new_n349_));
  nand2  g192(.a(x120), .b(new_n159_), .O(new_n350_));
  nand2  g193(.a(new_n350_), .b(new_n349_), .O(new_n351_));
  nand2  g194(.a(new_n351_), .b(new_n348_), .O(new_n352_));
  nand3  g195(.a(new_n352_), .b(new_n347_), .c(new_n342_), .O(new_n353_));
  oai21  g196(.a(new_n353_), .b(new_n339_), .c(new_n163_), .O(new_n354_));
  nand4  g197(.a(x120), .b(new_n333_), .c(new_n161_), .d(x008), .O(new_n355_));
  ...
  nand3  g202(.a(new_n332_), .b(new_n162_), .c(x024), .O(new_n360_));
  aoi21  g203(.a(new_n360_), .b(new_n158_), .c(x032), .O(new_n361_));
  nor3   g204(.a(new_n345_), .b(x080), .c(x048), .O(new_n362_));
  oai21  g205(.a(new_n362_), .b(new_n361_), .c(x064), .O(new_n363_));
  inv1   g206(.a(new_n337_), .O(new_n364_));
  ...
  oai21  g210(.a(x120), .b(x096), .c(new_n343_), .O(new_n368_));
  oai22  g211(.a(new_n368_), .b(new_n366_), .c(new_n367_), .d(new_n364_), .O(new_n369_));
  nand2  g212(.a(new_n343_), .b(x024), .O(new_n370_));
  aoi21  g213(.a(new_n370_), .b(new_n345_), .c(new_n161_), .O(new_n371_));
  aoi21  g214(.a(new_n369_), .b(new_n162_), .c(new_n371_), .O(new_n372_));
  oai21  g215(.a(new_n372_), .b(x080), .c(new_n363_), .O(new_n373_));
  nor2   g216(.a(x080), .b(x048), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n337_), .c(x072), .O(new_n375_));
  ...
  oai21  g221(.a(new_n375_), .b(new_n160_), .c(new_n378_), .O(new_n379_));
  ...
  inv1   g252(.a(x101), .O(new_n410_));
  nand2  g253(.a(new_n240_), .b(new_n410_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n262_), .O(new_n412_));
  nor2   g255(.a(x117), .b(x109), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n412_), .c(x069), .O(new_n414_));
  nand2  g257(.a(x021), .b(x013), .O(new_n415_));
  oai21  g258(.a(new_n263_), .b(x029), .c(new_n415_), .O(new_n416_));
  nor2   g259(.a(x117), .b(x021), .O(new_n417_));
  aoi21  g260(.a(new_n417_), .b(x125), .c(x085), .O(new_n418_));
  oai21  g261(.a(new_n240_), .b(x109), .c(x037), .O(new_n419_));
  nand2  g262(.a(new_n419_), .b(x117), .O(new_n420_));
  oai21  g263(.a(new_n410_), .b(x061), .c(new_n229_), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n243_), .O(new_n422_));
  nand4  g265(.a(new_n422_), .b(new_n420_), .c(new_n418_), .d(new_n416_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n414_), .c(new_n259_), .O(new_n424_));
  nand4  g267(.a(x125), .b(new_n246_), .c(new_n243_), .d(x013), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n424_), .c(x053), .O(new_n426_));
  nand3  g269(.a(x085), .b(new_n243_), .c(new_n234_), .O(new_n427_));
  inv1   g270(.a(new_n427_), .O(new_n428_));
  oai21  g271(.a(new_n428_), .b(new_n426_), .c(x005), .O(new_n429_));
  nand2  g272(.a(new_n237_), .b(x029), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n235_), .O(new_n431_));
  nand2  g274(.a(new_n431_), .b(new_n259_), .O(new_n432_));
  aoi21  g275(.a(new_n432_), .b(new_n234_), .c(new_n413_), .O(new_n433_));
  nor2   g276(.a(new_n233_), .b(x021), .O(new_n434_));
  oai21  g277(.a(new_n434_), .b(new_n263_), .c(x069), .O(new_n435_));
  nand4  g278(.a(new_n415_), .b(new_n411_), .c(new_n237_), .d(x029), .O(new_n436_));
  aoi21  g279(.a(new_n436_), .b(new_n435_), .c(x077), .O(new_n437_));
  oai21  g280(.a(new_n437_), .b(new_n433_), .c(new_n225_), .O(new_n438_));
  nand2  g281(.a(new_n415_), .b(x029), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n255_), .O(new_n440_));
  nand3  g283(.a(new_n440_), .b(new_n259_), .c(x037), .O(new_n441_));
  ...
  aoi21  g289(.a(new_n442_), .b(new_n239_), .c(new_n446_), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n429_), .c(x045), .O(z13));
  inv1   g291(.a(x102), .O(new_n449_));
  nand2  g292(.a(new_n294_), .b(new_n449_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n316_), .O(new_n451_));
  ...
  oai21  g297(.a(new_n317_), .b(x030), .c(new_n454_), .O(new_n455_));
  nor2   g298(.a(x118), .b(x022), .O(new_n456_));
  aoi21  g299(.a(new_n456_), .b(x126), .c(x086), .O(new_n457_));
  oai21  g300(.a(new_n294_), .b(x110), .c(x038), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(x118), .O(new_n459_));
  oai21  g302(.a(new_n449_), .b(x062), .c(new_n283_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n297_), .O(new_n461_));
  ...
  nand4  g306(.a(x126), .b(new_n300_), .c(new_n297_), .d(x014), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n463_), .c(x054), .O(new_n465_));
  nand3  g308(.a(x086), .b(new_n297_), .c(new_n288_), .O(new_n466_));
  inv1   g309(.a(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n465_), .c(x006), .O(new_n468_));
  nand2  g311(.a(new_n291_), .b(x030), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n289_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n313_), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n288_), .c(new_n452_), .O(new_n472_));
  nor2   g315(.a(new_n287_), .b(x022), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n317_), .c(x070), .O(new_n474_));
  nand4  g317(.a(new_n454_), .b(new_n450_), .c(new_n291_), .d(x030), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n474_), .c(x078), .O(new_n476_));
  oai21  g319(.a(new_n476_), .b(new_n472_), .c(new_n279_), .O(new_n477_));
  nand2  g320(.a(new_n454_), .b(x030), .O(new_n478_));
