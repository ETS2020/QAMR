// Benchmark "FAU" written by ABC on Fri Jun 26 05:05:28 2020
...
module FAU ( 
  ...
  nor2   g158(.a(new_n308_), .b(x030), .O(new_n315_));
  nand3  g159(.a(new_n315_), .b(new_n289_), .c(new_n280_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n314_), .c(new_n312_), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n311_), .c(x054), .O(new_n318_));
  aoi21  g162(.a(new_n288_), .b(new_n287_), .c(x030), .O(new_n319_));
  nor2   g163(.a(new_n312_), .b(x038), .O(new_n320_));
  oai21  g164(.a(new_n319_), .b(new_n290_), .c(new_n320_), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(new_n318_), .O(new_n322_));
  nand2  g166(.a(new_n296_), .b(new_n287_), .O(new_n323_));
  nand3  g167(.a(new_n323_), .b(new_n279_), .c(new_n288_), .O(new_n324_));
  aoi22  g168(.a(new_n312_), .b(new_n287_), .c(new_n278_), .d(new_n296_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  aoi21  g170(.a(new_n322_), .b(x086), .c(new_n326_), .O(new_n327_));
  aoi21  g171(.a(new_n327_), .b(new_n307_), .c(new_n276_), .O(z06));
  ...
  nand4  g287(.a(x086), .b(new_n296_), .c(new_n287_), .d(x006), .O(new_n445_));
  nand2  g288(.a(x078), .b(x054), .O(new_n446_));
  nor2   g289(.a(new_n279_), .b(new_n288_), .O(new_n447_));
  oai22  g290(.a(new_n312_), .b(new_n287_), .c(new_n278_), .d(new_n296_), .O(new_n448_));
  aoi21  g291(.a(new_n447_), .b(new_n446_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n445_), .c(x046), .O(z14));
  zero   g293(.O(z07));
  zero   g294(.O(z15));
  zero   g295(.O(z16));
  zero   g296(.O(z17));
