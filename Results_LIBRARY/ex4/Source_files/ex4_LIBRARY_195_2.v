...
module FAU ( 
  ...
  aoi22  g249(.a(new_n406_), .b(new_n405_), .c(x125), .d(x109), .O(new_n407_));
  ...
  nand2  g255(.a(x117), .b(new_n398_), .O(new_n413_));
  ...
  nand2  g265(.a(x117), .b(new_n256_), .O(new_n423_));
  oai21  g266(.a(x117), .b(new_n224_), .c(new_n423_), .O(new_n424_));
