...
module FAU ( 
  ...
  nor2   g297(.a(x110), .b(x022), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(x126), .c(x086), .O(new_n456_));
  oai21  g299(.a(new_n294_), .b(x118), .c(x038), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(x110), .O(new_n458_));
  oai21  g301(.a(new_n448_), .b(x062), .c(new_n284_), .O(new_n459_));
