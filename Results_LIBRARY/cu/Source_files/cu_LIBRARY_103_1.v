...
module FAU ( 
  ...
  nand2  g17(.a(new_n27_), .b(new_n31_), .O(new_n43_));
  nand3  g18(.a(new_n37_), .b(x05), .c(new_n26_), .O(new_n44_));
  nor4   g19(.a(new_n44_), .b(new_n43_), .c(new_n42_), .d(x00), .O(z04));
  nor4   g20(.a(new_n44_), .b(new_n43_), .c(new_n42_), .d(new_n40_), .O(z05));
  inv1   g21(.a(x09), .O(new_n47_));
  nand2  g22(.a(new_n47_), .b(new_n42_), .O(new_n48_));
  inv1   g23(.a(x11), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n31_), .c(x01), .O(new_n50_));
  ...
  nand3  g29(.a(new_n54_), .b(new_n31_), .c(x01), .O(new_n55_));
  ...
  aoi21  g39(.a(x02), .b(x01), .c(new_n38_), .O(z07));
