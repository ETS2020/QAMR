// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:48 2020
...
module FAU ( 
  ...
  nand3  g34(.a(new_n59_), .b(new_n55_), .c(new_n54_), .O(new_n60_));
  ...
  nor3   g38(.a(new_n39_), .b(x04), .c(x02), .O(z07));
  nand3  g39(.a(new_n55_), .b(x13), .c(new_n57_), .O(new_n65_));
