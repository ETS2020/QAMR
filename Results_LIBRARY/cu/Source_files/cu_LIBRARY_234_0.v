// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:57 2020
...
module FAU ( 
  ...
  nand3  g23(.a(x13), .b(new_n48_), .c(new_n43_), .O(new_n49_));
  ...
  nand2  g29(.a(x13), .b(new_n41_), .O(new_n55_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(new_n56_));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n59_));
