...
module FAU ( 
  ...
  nor3   g20(.a(new_n44_), .b(new_n43_), .c(new_n41_), .O(z05));
  inv1   g21(.a(x09), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n31_), .c(new_n43_), .O(new_n48_));
  ...
  nand3  g27(.a(new_n52_), .b(new_n31_), .c(new_n43_), .O(new_n53_));
  ...
  aoi21  g39(.a(x02), .b(new_n43_), .c(new_n44_), .O(z07));
