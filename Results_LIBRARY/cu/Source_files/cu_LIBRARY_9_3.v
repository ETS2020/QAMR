...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n67_;
  ...
  nand3  g27(.a(new_n52_), .b(new_n46_), .c(new_n43_), .O(new_n53_));
  ...
  oai21  g34(.a(new_n56_), .b(new_n51_), .c(new_n59_), .O(new_n60_));
  ...
  aoi21  g39(.a(new_n61_), .b(new_n58_), .c(new_n62_), .O(z08));
