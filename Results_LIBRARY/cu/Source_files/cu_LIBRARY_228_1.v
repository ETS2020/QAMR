// Benchmark "FAU" written by ABC on Thu Jun 25 17:17:56 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(new_n43_), .c(x00), .O(new_n47_));
  inv1   g22(.a(x08), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(x01), .c(new_n41_), .O(new_n49_));
  inv1   g24(.a(x11), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(x01), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n49_), .c(new_n47_), .O(new_n52_));
