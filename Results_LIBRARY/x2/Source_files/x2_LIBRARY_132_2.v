// Benchmark "FAU" written by ABC on Thu Jun 25 15:17:28 2020
...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n26_, new_n29_,
  ...
  nand2  g10(.a(new_n23_), .b(x6), .O(z4));
  nor2   g11(.a(x1), .b(x0), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(x9), .c(x8), .d(x2), .O(new_n30_));
  inv1   g13(.a(x3), .O(new_n31_));
  oai21  g14(.a(x4), .b(new_n31_), .c(x8), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n18_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n30_), .c(x6), .O(z5));
  inv1   g17(.a(x8), .O(new_n35_));
  oai21  g18(.a(new_n26_), .b(new_n35_), .c(x9), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  and2   g20(.a(x4), .b(x3), .O(new_n38_));
  nor2   g21(.a(x9), .b(new_n35_), .O(new_n39_));
  aoi21  g22(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n36_), .O(z6));
endmodule
