// Benchmark "FAU" written by ABC on Thu Jun 25 15:17:33 2020
...
module FAU ( 
  ...
  aoi21  g29(.a(new_n46_), .b(x8), .c(new_n44_), .O(new_n47_));
  ...
  oai21  g35(.a(new_n21_), .b(new_n45_), .c(new_n22_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n20_), .c(new_n44_), .O(new_n54_));
