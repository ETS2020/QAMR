// Benchmark "FAU" written by ABC on Thu Jun 25 15:17:32 2020
...
module FAU ( 
  ...
  aoi21  g20(.a(new_n36_), .b(x9), .c(new_n37_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n34_), .O(z5));
  nand4  g22(.a(x9), .b(new_n24_), .c(new_n29_), .d(new_n28_), .O(new_n40_));
  nand4  g23(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x7), .O(new_n43_));
  inv1   g26(.a(x6), .O(new_n44_));
  oai21  g27(.a(new_n18_), .b(new_n35_), .c(x8), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(new_n20_), .c(new_n44_), .O(new_n46_));
