...
module FAU ( 
  ...
  nand4  g54(.a(new_n71_), .b(new_n70_), .c(new_n22_), .d(x4), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n69_), .c(new_n62_), .O(z2));
  inv1   g56(.a(x3), .O(z8));
  aoi21  g57(.a(z8), .b(new_n20_), .c(new_n33_), .O(new_n76_));
  nand2  g58(.a(x3), .b(new_n33_), .O(new_n77_));
  oai22  g59(.a(new_n77_), .b(new_n20_), .c(new_n76_), .d(x1), .O(new_n78_));
  ...
  oai21  g66(.a(new_n83_), .b(new_n71_), .c(new_n84_), .O(new_n85_));
  nand3  g67(.a(new_n85_), .b(new_n81_), .c(new_n79_), .O(z4));
  nand2  g68(.a(z8), .b(x2), .O(new_n87_));
  oai21  g69(.a(new_n77_), .b(new_n21_), .c(new_n87_), .O(new_n88_));
  nand2  g70(.a(new_n88_), .b(new_n20_), .O(new_n89_));
  aoi21  g71(.a(x3), .b(x1), .c(x2), .O(new_n90_));
  oai21  g72(.a(new_n90_), .b(new_n82_), .c(x0), .O(new_n91_));
  nand2  g73(.a(new_n91_), .b(new_n89_), .O(z5));
  xor2a  g74(.a(new_n77_), .b(new_n21_), .O(z6));
  nand2  g75(.a(new_n87_), .b(new_n77_), .O(z7));
  nand2  g76(.a(new_n82_), .b(x1), .O(new_n95_));
  nor2   g77(.a(x6), .b(x0), .O(new_n96_));
  nand2  g78(.a(x5), .b(x4), .O(new_n97_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(new_n97_), .O(z9));
  zero   g80(.O(z3));
endmodule
