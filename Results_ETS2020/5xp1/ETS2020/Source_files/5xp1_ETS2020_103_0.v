...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n79_, new_n80_, new_n81_, new_n82_, new_n87_, new_n88_, new_n89_;
  ...
  xor2a  g65(.a(new_n73_), .b(new_n21_), .O(z6));
  inv1   g66(.a(new_n26_), .O(new_n87_));
  nand2  g67(.a(new_n78_), .b(x1), .O(new_n88_));
  nand2  g68(.a(x5), .b(x4), .O(new_n89_));
  aoi21  g69(.a(new_n88_), .b(new_n87_), .c(new_n89_), .O(z9));
  zero   g70(.O(z2));
  zero   g71(.O(z5));
  zero   g72(.O(z7));
endmodule
