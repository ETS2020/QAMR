...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
    ...
    new_n73_, new_n74_, new_n75_, new_n79_, new_n80_, new_n81_;
  ...
  nand2  g59(.a(new_n45_), .b(x1), .O(new_n79_));
  nor2   g60(.a(x6), .b(x0), .O(new_n80_));
  nand2  g61(.a(x5), .b(x4), .O(new_n81_));
  aoi21  g62(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(z9));
  zero   g63(.O(z0));
  zero   g64(.O(z2));
endmodule
