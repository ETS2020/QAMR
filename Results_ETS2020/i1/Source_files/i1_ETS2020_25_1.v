...
module FAU ( 
  ...
  inv1   g29(.a(x14), .O(new_n73_));
  inv1   g30(.a(x22), .O(new_n74_));
  nor3   g31(.a(x24), .b(new_n74_), .c(new_n73_), .O(z10));
  inv1   g32(.a(x17), .O(new_n76_));
  nor3   g33(.a(x24), .b(new_n74_), .c(new_n76_), .O(z11));
  inv1   g34(.a(x23), .O(new_n78_));
  nor3   g35(.a(x24), .b(new_n78_), .c(new_n73_), .O(z12));
  nor3   g36(.a(x24), .b(new_n78_), .c(new_n76_), .O(z13));
