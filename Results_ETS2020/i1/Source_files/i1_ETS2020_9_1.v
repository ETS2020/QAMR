...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n72_, new_n74_, new_n76_, new_n79_, new_n81_, new_n82_;
  ...
  nand2  g27(.a(x22), .b(x14), .O(new_n72_));
  nor2   g28(.a(new_n72_), .b(x24), .O(z10));
  nand2  g29(.a(x22), .b(x17), .O(new_n74_));
  nor2   g30(.a(new_n74_), .b(x24), .O(z11));
