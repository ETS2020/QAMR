...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n69_, new_n70_, new_n71_, new_n76_, new_n77_, new_n79_,
    new_n81_, new_n84_;
  ...
  inv1   g31(.a(x14), .O(new_n76_));
  inv1   g32(.a(x22), .O(new_n77_));
  nor3   g33(.a(x24), .b(new_n77_), .c(new_n76_), .O(z10));
  inv1   g34(.a(x17), .O(new_n79_));
  nor3   g35(.a(x24), .b(new_n77_), .c(new_n79_), .O(z11));
  inv1   g36(.a(x23), .O(new_n81_));
  nor3   g37(.a(x24), .b(new_n81_), .c(new_n76_), .O(z12));
  nor3   g38(.a(x24), .b(new_n81_), .c(new_n79_), .O(z13));
