// Benchmark "FAU" written by ABC on Tue Jun 23 01:15:28 2020
...
module FAU ( 
  ...
  inv1   g25(.a(x14), .O(new_n70_));
  inv1   g26(.a(x22), .O(new_n71_));
  nor3   g27(.a(x24), .b(new_n71_), .c(new_n70_), .O(z10));
  inv1   g28(.a(x17), .O(new_n73_));
  nor3   g29(.a(x24), .b(new_n71_), .c(new_n73_), .O(z11));
  inv1   g30(.a(x23), .O(new_n75_));
  nor3   g31(.a(x24), .b(new_n75_), .c(new_n70_), .O(z12));
  nor3   g32(.a(x24), .b(new_n75_), .c(new_n73_), .O(z13));
  inv1   g33(.a(x16), .O(new_n78_));
  nor2   g34(.a(x24), .b(new_n78_), .O(z14));
  nor2   g35(.a(x13), .b(x12), .O(new_n80_));
  nor2   g36(.a(x15), .b(x14), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g38(.O(z06));
  zero   g39(.O(z07));
  zero   g40(.O(z09));
  buf    g41(.a(x00), .O(z00));
