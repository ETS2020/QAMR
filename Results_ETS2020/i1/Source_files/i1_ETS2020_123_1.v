...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n75_, new_n77_, new_n79_,
  ...
  nand2  g32(.a(x23), .b(x14), .O(new_n77_));
  nor2   g33(.a(new_n77_), .b(x24), .O(z12));
  nand2  g34(.a(x23), .b(x17), .O(new_n79_));
  nor2   g35(.a(new_n79_), .b(x24), .O(z13));
  inv1   g36(.a(x16), .O(new_n81_));
  nor2   g37(.a(x24), .b(new_n81_), .O(z14));
