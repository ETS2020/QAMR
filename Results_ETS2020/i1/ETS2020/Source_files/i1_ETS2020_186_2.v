...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n71_, new_n72_, new_n74_, new_n76_, new_n79_;
  ...
  inv1   g25(.a(x22), .O(new_n72_));
  nor3   g26(.a(x24), .b(new_n72_), .c(new_n71_), .O(z10));
  inv1   g27(.a(x17), .O(new_n74_));
  nor3   g28(.a(x24), .b(new_n72_), .c(new_n74_), .O(z11));
  inv1   g29(.a(x23), .O(new_n76_));
  nor3   g30(.a(x24), .b(new_n76_), .c(new_n71_), .O(z12));
  nor3   g31(.a(x24), .b(new_n76_), .c(new_n74_), .O(z13));
