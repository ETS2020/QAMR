// Benchmark "FAU" written by ABC on Tue Jun 23 01:15:53 2020
...
module FAU ( 
  ...
  inv1   g28(.a(x22), .O(new_n72_));
  nor3   g29(.a(x24), .b(new_n72_), .c(new_n71_), .O(z10));
  inv1   g30(.a(x17), .O(new_n74_));
  nor3   g31(.a(x24), .b(new_n72_), .c(new_n74_), .O(z11));
  inv1   g32(.a(x23), .O(new_n76_));
  nor3   g33(.a(x24), .b(new_n76_), .c(new_n71_), .O(z12));
  nor3   g34(.a(x24), .b(new_n76_), .c(new_n74_), .O(z13));
  inv1   g35(.a(x16), .O(new_n79_));
  nor2   g36(.a(x24), .b(new_n79_), .O(z14));
  nor2   g37(.a(x13), .b(x12), .O(new_n81_));
  nor2   g38(.a(x15), .b(x14), .O(new_n82_));
  nand2  g39(.a(new_n82_), .b(new_n81_), .O(z15));
  zero   g40(.O(z06));
  zero   g41(.O(z08));
  buf    g42(.a(x00), .O(z00));
  buf    g43(.a(x20), .O(z03));
