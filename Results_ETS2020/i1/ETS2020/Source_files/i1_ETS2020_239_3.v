...
module FAU ( 
  ...
  nand2  g07(.a(x22), .b(x14), .O(new_n55_));
  nor2   g08(.a(new_n55_), .b(x24), .O(z10));
  nand2  g09(.a(x22), .b(x17), .O(new_n57_));
  nor2   g10(.a(new_n57_), .b(x24), .O(z11));
  nand2  g11(.a(x23), .b(x17), .O(new_n60_));
  nor2   g12(.a(new_n60_), .b(x24), .O(z13));
