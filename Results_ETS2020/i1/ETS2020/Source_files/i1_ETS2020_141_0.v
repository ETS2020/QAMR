...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n69_, new_n71_, new_n73_,
    new_n75_, new_n76_;
  ...
  nand3  g18(.a(new_n62_), .b(new_n45_), .c(x19), .O(new_n63_));
  oai21  g19(.a(new_n63_), .b(new_n51_), .c(new_n61_), .O(z05));
  and2   g20(.a(x24), .b(x18), .O(z07));
  and2   g21(.a(x24), .b(x11), .O(z09));
  nand2  g22(.a(x23), .b(x14), .O(new_n69_));
  nor2   g23(.a(new_n69_), .b(x24), .O(z12));
  nand2  g24(.a(x23), .b(x17), .O(new_n71_));
  nor2   g25(.a(new_n71_), .b(x24), .O(z13));
  inv1   g26(.a(x16), .O(new_n73_));
  nor2   g27(.a(x24), .b(new_n73_), .O(z14));
  nor2   g28(.a(x13), .b(x12), .O(new_n75_));
  nor2   g29(.a(x15), .b(x14), .O(new_n76_));
  nand2  g30(.a(new_n76_), .b(new_n75_), .O(z15));
  zero   g31(.O(z01));
  zero   g32(.O(z03));
  zero   g33(.O(z04));
  zero   g34(.O(z10));
