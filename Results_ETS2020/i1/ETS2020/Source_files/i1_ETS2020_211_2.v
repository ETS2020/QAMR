...
module FAU ( 
  ...
  nor3   g28(.a(x24), .b(new_n71_), .c(new_n70_), .O(z10));
  inv1   g29(.a(x17), .O(new_n73_));
  nor3   g30(.a(x24), .b(new_n71_), .c(new_n73_), .O(z11));
  inv1   g31(.a(x23), .O(new_n75_));
  nor3   g32(.a(x24), .b(new_n75_), .c(new_n70_), .O(z12));
  nor3   g33(.a(x24), .b(new_n75_), .c(new_n73_), .O(z13));
  inv1   g34(.a(x16), .O(new_n78_));
  nor2   g35(.a(x24), .b(new_n78_), .O(z14));
  nor2   g36(.a(x13), .b(x12), .O(new_n80_));
  nor2   g37(.a(x15), .b(x14), .O(new_n81_));
  nand2  g38(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g39(.O(z06));
  zero   g40(.O(z07));
  buf    g41(.a(x00), .O(z00));
  buf    g42(.a(x20), .O(z03));
