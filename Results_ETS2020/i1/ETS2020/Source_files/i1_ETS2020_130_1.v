...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n69_, new_n70_, new_n71_, new_n77_, new_n79_, new_n82_,
    new_n84_, new_n85_;
  ...
  nand2  g29(.a(x22), .b(x17), .O(new_n77_));
  nor2   g30(.a(new_n77_), .b(x24), .O(z11));
  nand2  g31(.a(x23), .b(x14), .O(new_n79_));
  nor2   g32(.a(new_n79_), .b(x24), .O(z12));
  inv1   g33(.a(x16), .O(new_n82_));
  nor2   g34(.a(x24), .b(new_n82_), .O(z14));
