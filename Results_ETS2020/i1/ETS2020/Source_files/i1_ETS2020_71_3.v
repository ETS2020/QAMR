...
module FAU ( 
  ...
  and2   g07(.a(x24), .b(x11), .O(z09));
  inv1   g08(.a(x14), .O(new_n54_));
  inv1   g09(.a(x22), .O(new_n55_));
  nor3   g10(.a(x24), .b(new_n55_), .c(new_n54_), .O(z10));
  inv1   g11(.a(x17), .O(new_n57_));
  nor3   g12(.a(x24), .b(new_n55_), .c(new_n57_), .O(z11));
  inv1   g13(.a(x23), .O(new_n59_));
  nor3   g14(.a(x24), .b(new_n59_), .c(new_n54_), .O(z12));
  nor3   g15(.a(x24), .b(new_n59_), .c(new_n57_), .O(z13));
  zero   g16(.O(z02));
  zero   g17(.O(z04));
  zero   g18(.O(z05));
  zero   g19(.O(z07));
