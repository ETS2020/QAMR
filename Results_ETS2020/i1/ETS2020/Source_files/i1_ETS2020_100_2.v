...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n71_, new_n73_, new_n75_, new_n77_, new_n79_, new_n80_;
  ...
  nand2  g25(.a(x22), .b(x17), .O(new_n71_));
  nor2   g26(.a(new_n71_), .b(x24), .O(z11));
  nand2  g27(.a(x23), .b(x14), .O(new_n73_));
  nor2   g28(.a(new_n73_), .b(x24), .O(z12));
  nand2  g29(.a(x23), .b(x17), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(x24), .O(z13));
