...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n75_, new_n77_, new_n80_,
    new_n82_, new_n83_;
  ...
  nand3  g27(.a(new_n69_), .b(new_n59_), .c(x19), .O(new_n70_));
  oai21  g28(.a(new_n70_), .b(new_n49_), .c(new_n68_), .O(z05));
  nand2  g29(.a(x22), .b(x17), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(x24), .O(z11));
  nand2  g31(.a(x23), .b(x14), .O(new_n77_));
  nor2   g32(.a(new_n77_), .b(x24), .O(z12));
  inv1   g33(.a(x16), .O(new_n80_));
  nor2   g34(.a(x24), .b(new_n80_), .O(z14));
  nor2   g35(.a(x13), .b(x12), .O(new_n82_));
  nor2   g36(.a(x15), .b(x14), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n82_), .O(z15));
  zero   g38(.O(z03));
  zero   g39(.O(z07));
  zero   g40(.O(z09));
  zero   g41(.O(z10));
