...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n57_, new_n60_, new_n61_, new_n62_, new_n69_, new_n71_, new_n73_,
    new_n74_;
  ...
  nand2  g23(.a(x23), .b(x17), .O(new_n69_));
  nor2   g24(.a(new_n69_), .b(x24), .O(z13));
  inv1   g25(.a(x16), .O(new_n71_));
  nor2   g26(.a(x24), .b(new_n71_), .O(z14));
  nor2   g27(.a(x13), .b(x12), .O(new_n73_));
  nor2   g28(.a(x15), .b(x14), .O(new_n74_));
  nand2  g29(.a(new_n74_), .b(new_n73_), .O(z15));
  zero   g30(.O(z01));
  zero   g31(.O(z10));
  zero   g32(.O(z11));
  zero   g33(.O(z12));
