...
module FAU ( 
  ...
  nand2  g31(.a(x22), .b(x17), .O(new_n75_));
  nor2   g32(.a(new_n75_), .b(x24), .O(z11));
  nand2  g33(.a(x23), .b(x14), .O(new_n77_));
  nor2   g34(.a(new_n77_), .b(x24), .O(z12));
  inv1   g35(.a(x16), .O(new_n80_));
  nor2   g36(.a(x24), .b(new_n80_), .O(z14));
  nor2   g37(.a(x13), .b(x12), .O(new_n82_));
