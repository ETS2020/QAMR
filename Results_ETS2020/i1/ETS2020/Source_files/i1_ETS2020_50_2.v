...
module FAU ( 
  ...
  nand3  g23(.a(new_n65_), .b(new_n54_), .c(x19), .O(new_n66_));
  oai21  g24(.a(new_n66_), .b(new_n49_), .c(new_n64_), .O(z05));
  and2   g25(.a(x24), .b(x18), .O(z07));
  inv1   g26(.a(x14), .O(new_n71_));
  inv1   g27(.a(x22), .O(new_n72_));
  nor3   g28(.a(x24), .b(new_n72_), .c(new_n71_), .O(z10));
  inv1   g29(.a(x17), .O(new_n74_));
  nor3   g30(.a(x24), .b(new_n72_), .c(new_n74_), .O(z11));
  inv1   g31(.a(x23), .O(new_n76_));
  nor3   g32(.a(x24), .b(new_n76_), .c(new_n71_), .O(z12));
  nor3   g33(.a(x24), .b(new_n76_), .c(new_n74_), .O(z13));
  inv1   g34(.a(x16), .O(new_n79_));
  nor2   g35(.a(x24), .b(new_n79_), .O(z14));
  nor2   g36(.a(x13), .b(x12), .O(new_n81_));
  nor2   g37(.a(x15), .b(x14), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n81_), .O(z15));
  zero   g39(.O(z03));
  zero   g40(.O(z06));
  zero   g41(.O(z09));
  buf    g42(.a(x00), .O(z00));
