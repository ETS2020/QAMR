...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n70_, new_n74_, new_n76_, new_n80_,
    new_n82_, new_n83_;
  ...
  nand2  g30(.a(x22), .b(x14), .O(new_n74_));
  nor2   g31(.a(new_n74_), .b(x24), .O(z10));
  nand2  g32(.a(x22), .b(x17), .O(new_n76_));
  nor2   g33(.a(new_n76_), .b(x24), .O(z11));
  inv1   g34(.a(x16), .O(new_n80_));
  nor2   g35(.a(x24), .b(new_n80_), .O(z14));
  nor2   g36(.a(x13), .b(x12), .O(new_n82_));
  nor2   g37(.a(x15), .b(x14), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n82_), .O(z15));
  zero   g39(.O(z00));
  zero   g40(.O(z04));
  zero   g41(.O(z12));
  zero   g42(.O(z13));
