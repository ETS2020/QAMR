// Benchmark "FAU" written by ABC on Tue Jun 23 01:15:39 2020
...
module FAU ( 
  ...
  nor2   g26(.a(x08), .b(x07), .O(new_n70_));
  nand3  g27(.a(new_n70_), .b(new_n60_), .c(x19), .O(new_n71_));
  oai21  g28(.a(new_n71_), .b(new_n50_), .c(new_n69_), .O(z05));
