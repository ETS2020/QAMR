...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n72_, new_n73_, new_n75_, new_n77_, new_n81_, new_n82_;
  ...
  nor3   g28(.a(x24), .b(new_n73_), .c(new_n72_), .O(z10));
  inv1   g29(.a(x17), .O(new_n75_));
  nor3   g30(.a(x24), .b(new_n73_), .c(new_n75_), .O(z11));
  inv1   g31(.a(x23), .O(new_n77_));
  nor3   g32(.a(x24), .b(new_n77_), .c(new_n72_), .O(z12));
  nor3   g33(.a(x24), .b(new_n77_), .c(new_n75_), .O(z13));
