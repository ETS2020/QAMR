...
module FAU ( 
  ...
  inv1   g31(.a(x14), .O(new_n75_));
  inv1   g32(.a(x22), .O(new_n76_));
  nor3   g33(.a(x24), .b(new_n76_), .c(new_n75_), .O(z10));
  inv1   g34(.a(x17), .O(new_n78_));
  nor3   g35(.a(x24), .b(new_n76_), .c(new_n78_), .O(z11));
  inv1   g36(.a(x23), .O(new_n80_));
  nor3   g37(.a(x24), .b(new_n80_), .c(new_n75_), .O(z12));
  nor3   g38(.a(x24), .b(new_n80_), .c(new_n78_), .O(z13));
  inv1   g39(.a(x16), .O(new_n83_));
  nor2   g40(.a(x24), .b(new_n83_), .O(z14));
  nor2   g41(.a(x13), .b(x12), .O(new_n85_));
  nor2   g42(.a(x15), .b(x14), .O(new_n86_));
  nand2  g43(.a(new_n86_), .b(new_n85_), .O(z15));
  zero   g44(.O(z03));
  zero   g45(.O(z08));
  buf    g46(.a(x00), .O(z00));
  buf    g47(.a(x19), .O(z06));
