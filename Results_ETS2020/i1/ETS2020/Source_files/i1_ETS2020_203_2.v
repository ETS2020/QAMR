...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n77_, new_n79_, new_n81_, new_n82_;
  ...
  nor2   g22(.a(x08), .b(x07), .O(new_n66_));
  nand3  g23(.a(new_n66_), .b(new_n55_), .c(x19), .O(new_n67_));
  oai21  g24(.a(new_n67_), .b(new_n50_), .c(new_n65_), .O(z05));
  nand2  g25(.a(x22), .b(x14), .O(new_n72_));
  nor2   g26(.a(new_n72_), .b(x24), .O(z10));
  nand2  g27(.a(x22), .b(x17), .O(new_n74_));
  nor2   g28(.a(new_n74_), .b(x24), .O(z11));
  nand2  g29(.a(x23), .b(x17), .O(new_n77_));
  nor2   g30(.a(new_n77_), .b(x24), .O(z13));
  inv1   g31(.a(x16), .O(new_n79_));
  nor2   g32(.a(x24), .b(new_n79_), .O(z14));
  nor2   g33(.a(x13), .b(x12), .O(new_n81_));
  nor2   g34(.a(x15), .b(x14), .O(new_n82_));
  nand2  g35(.a(new_n82_), .b(new_n81_), .O(z15));
  zero   g36(.O(z00));
  zero   g37(.O(z03));
  zero   g38(.O(z06));
  zero   g39(.O(z07));
