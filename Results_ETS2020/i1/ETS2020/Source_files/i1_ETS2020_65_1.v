...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n78_, new_n80_, new_n81_;
  ...
  nand2  g26(.a(x22), .b(x17), .O(new_n73_));
  nor2   g27(.a(new_n73_), .b(x24), .O(z11));
  nand2  g28(.a(x23), .b(x17), .O(new_n76_));
  nor2   g29(.a(new_n76_), .b(x24), .O(z13));
  inv1   g30(.a(x16), .O(new_n78_));
  nor2   g31(.a(x24), .b(new_n78_), .O(z14));
  nor2   g32(.a(x13), .b(x12), .O(new_n80_));
  nor2   g33(.a(x15), .b(x14), .O(new_n81_));
  nand2  g34(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g35(.O(z00));
  zero   g36(.O(z03));
  zero   g37(.O(z06));
  zero   g38(.O(z07));
