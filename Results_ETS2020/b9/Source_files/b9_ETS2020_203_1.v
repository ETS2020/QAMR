// Benchmark "FAU" written by ABC on Fri Jun 26 04:25:04 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n104_, new_n106_,
    new_n108_, new_n109_;
  ...
  nand4  g31(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n104_));
  inv1   g32(.a(new_n104_), .O(z15));
  nand2  g33(.a(x22), .b(x01), .O(new_n106_));
  nor2   g34(.a(new_n106_), .b(x23), .O(z16));
