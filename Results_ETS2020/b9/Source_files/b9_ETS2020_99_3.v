// Benchmark "FAU" written by ABC on Fri Jun 26 04:18:11 2020
...
module FAU ( 
  ...
  nand4  g82(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n146_));
  inv1   g83(.a(new_n146_), .O(z15));
  nand2  g84(.a(x22), .b(x01), .O(new_n148_));
  nor2   g85(.a(new_n148_), .b(x23), .O(z16));
  inv1   g86(.a(x24), .O(new_n150_));
  nand4  g87(.a(new_n150_), .b(x23), .c(x22), .d(x01), .O(new_n151_));
  inv1   g88(.a(new_n151_), .O(z17));
  oai21  g89(.a(new_n75_), .b(x27), .c(new_n106_), .O(new_n153_));
  nand2  g90(.a(new_n153_), .b(x08), .O(new_n154_));
  nand3  g91(.a(new_n154_), .b(new_n112_), .c(new_n110_), .O(z18));
  oai21  g92(.a(new_n86_), .b(new_n72_), .c(new_n109_), .O(new_n156_));
  oai21  g93(.a(new_n74_), .b(x27), .c(x35), .O(new_n157_));
  nand2  g94(.a(new_n157_), .b(new_n106_), .O(new_n158_));
  aoi21  g95(.a(new_n158_), .b(new_n156_), .c(new_n113_), .O(z20));
  zero   g96(.O(z07));
  aoi21  g97(.a(new_n111_), .b(new_n108_), .c(new_n113_), .O(z19));
endmodule
