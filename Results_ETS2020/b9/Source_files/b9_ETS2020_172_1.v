// Benchmark "FAU" written by ABC on Fri Jun 26 04:23:05 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n91_, new_n96_,
  ...
  inv1   g25(.a(x39), .O(new_n96_));
  nor2   g26(.a(new_n96_), .b(x04), .O(new_n97_));
  nand2  g27(.a(x36), .b(x35), .O(new_n98_));
  nand2  g28(.a(new_n98_), .b(x28), .O(new_n99_));
  inv1   g29(.a(x40), .O(new_n100_));
  nor2   g30(.a(new_n100_), .b(x13), .O(new_n101_));
  nand3  g31(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(new_n102_));
  inv1   g32(.a(new_n66_), .O(new_n103_));
  nor2   g33(.a(x19), .b(x18), .O(new_n104_));
  nand3  g34(.a(new_n104_), .b(new_n103_), .c(x20), .O(new_n105_));
  nand2  g35(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand2  g36(.a(new_n106_), .b(x27), .O(new_n107_));
  or2    g37(.a(x32), .b(x30), .O(new_n108_));
  nand3  g38(.a(new_n108_), .b(new_n101_), .c(new_n97_), .O(new_n109_));
  nand2  g39(.a(new_n109_), .b(new_n107_), .O(z13));
