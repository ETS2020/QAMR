// Benchmark "FAU" written by ABC on Fri Jun 26 04:21:17 2020
...
module FAU ( 
  ...
  inv1   g11(.a(x24), .O(new_n88_));
  nand4  g12(.a(new_n88_), .b(x23), .c(x22), .d(x01), .O(new_n89_));
  inv1   g13(.a(new_n89_), .O(z17));
  zero   g14(.O(z01));
  zero   g15(.O(z02));
  zero   g16(.O(z03));
  zero   g17(.O(z04));
