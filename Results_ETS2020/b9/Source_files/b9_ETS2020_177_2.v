...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n151_, new_n152_, new_n155_, new_n156_, new_n157_;
  ...
  oai21  g89(.a(new_n78_), .b(new_n64_), .c(new_n113_), .O(new_n155_));
  oai21  g90(.a(new_n66_), .b(x27), .c(x35), .O(new_n156_));
  nand2  g91(.a(new_n156_), .b(new_n109_), .O(new_n157_));
  aoi21  g92(.a(new_n157_), .b(new_n155_), .c(new_n117_), .O(z20));
  zero   g93(.O(z00));
  zero   g94(.O(z15));
  zero   g95(.O(z19));
endmodule
