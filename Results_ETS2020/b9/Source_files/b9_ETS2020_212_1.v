...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n97_, new_n99_,
    new_n101_, new_n102_;
  ...
  inv1   g27(.a(x24), .O(new_n101_));
  nand4  g28(.a(new_n101_), .b(x23), .c(x22), .d(x01), .O(new_n102_));
  inv1   g29(.a(new_n102_), .O(z17));
  zero   g30(.O(z01));
  zero   g31(.O(z02));
  zero   g32(.O(z03));
  zero   g33(.O(z04));
