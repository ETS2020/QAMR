...
module FAU ( 
  ...
  nand2  g50(.a(x27), .b(new_n110_), .O(new_n114_));
  oai21  g51(.a(new_n114_), .b(new_n67_), .c(new_n113_), .O(new_n115_));
  inv1   g52(.a(x09), .O(new_n116_));
  inv1   g53(.a(x30), .O(new_n117_));
  nand2  g54(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  aoi21  g55(.a(new_n115_), .b(new_n112_), .c(new_n118_), .O(z11));
  nor2   g56(.a(x36), .b(x35), .O(new_n120_));
  aoi21  g57(.a(new_n120_), .b(new_n80_), .c(new_n64_), .O(new_n121_));
  aoi21  g58(.a(x35), .b(x28), .c(x37), .O(new_n122_));
  nor2   g59(.a(new_n122_), .b(new_n64_), .O(new_n123_));
  nor2   g60(.a(new_n75_), .b(x04), .O(new_n124_));
  oai22  g61(.a(new_n124_), .b(new_n123_), .c(new_n121_), .d(x10), .O(z12));
  aoi21  g62(.a(x36), .b(x35), .c(new_n66_), .O(new_n126_));
  nor2   g63(.a(x13), .b(x04), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(z08), .O(new_n128_));
  nor2   g65(.a(x19), .b(x18), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(x20), .O(new_n130_));
  oai22  g67(.a(new_n130_), .b(new_n122_), .c(new_n128_), .d(new_n126_), .O(new_n131_));
  nand2  g68(.a(new_n131_), .b(x27), .O(new_n132_));
  nand3  g69(.a(new_n127_), .b(z08), .c(new_n70_), .O(new_n133_));
  nand2  g70(.a(new_n133_), .b(new_n132_), .O(z13));
  inv1   g71(.a(x32), .O(new_n135_));
  nand2  g72(.a(x36), .b(x35), .O(new_n136_));
  nand4  g73(.a(new_n136_), .b(new_n135_), .c(new_n117_), .d(x28), .O(new_n137_));
  inv1   g74(.a(new_n137_), .O(new_n138_));
  oai21  g75(.a(new_n138_), .b(new_n128_), .c(new_n130_), .O(new_n139_));
  ...
  oai21  g79(.a(new_n122_), .b(new_n64_), .c(new_n128_), .O(new_n143_));
  ...
  oai21  g88(.a(new_n78_), .b(new_n64_), .c(new_n113_), .O(new_n153_));
  oai21  g89(.a(new_n66_), .b(x27), .c(x35), .O(new_n154_));
  nand2  g90(.a(new_n154_), .b(new_n109_), .O(new_n155_));
  aoi21  g91(.a(new_n155_), .b(new_n153_), .c(new_n118_), .O(z20));
  zero   g92(.O(z00));
  zero   g93(.O(z18));
  aoi21  g94(.a(new_n115_), .b(new_n112_), .c(new_n118_), .O(z19));
endmodule
