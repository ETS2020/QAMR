// Benchmark "FAU" written by ABC on Fri Jun 26 04:23:55 2020
...
module FAU ( 
  ...
  oai21  g80(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n149_));
  nand2  g81(.a(new_n149_), .b(x08), .O(new_n150_));
  nand3  g82(.a(new_n150_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g83(.a(new_n86_), .b(new_n72_), .c(new_n108_), .O(new_n152_));
  oai21  g84(.a(new_n74_), .b(x27), .c(x35), .O(new_n153_));
  nand2  g85(.a(new_n153_), .b(new_n105_), .O(new_n154_));
  aoi21  g86(.a(new_n154_), .b(new_n152_), .c(new_n112_), .O(z20));
  zero   g87(.O(z05));
  zero   g88(.O(z06));
  zero   g89(.O(z07));
  zero   g90(.O(z09));
