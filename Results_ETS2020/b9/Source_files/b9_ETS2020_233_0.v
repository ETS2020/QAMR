...
module FAU ( 
  ...
  inv1   g023(.a(x35), .O(new_n87_));
  oai21  g024(.a(new_n87_), .b(new_n74_), .c(x27), .O(new_n88_));
  inv1   g025(.a(x37), .O(new_n89_));
  aoi21  g026(.a(new_n89_), .b(new_n72_), .c(x21), .O(new_n90_));
  nand2  g027(.a(new_n90_), .b(new_n88_), .O(z04));
  ...
  nand4  g041(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n107_));
  inv1   g042(.a(new_n107_), .O(z09));
  ...
  aoi21  g059(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n151_));
  ...
  oai21  g098(.a(new_n87_), .b(new_n72_), .c(new_n119_), .O(new_n165_));
