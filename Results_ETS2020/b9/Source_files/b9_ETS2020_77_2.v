// Benchmark "FAU" written by ABC on Fri Jun 26 04:16:46 2020
...
module FAU ( 
  ...
  inv1   g14(.a(x35), .O(new_n79_));
  oai21  g15(.a(new_n79_), .b(new_n66_), .c(x27), .O(new_n80_));
  inv1   g16(.a(x37), .O(new_n81_));
  aoi21  g17(.a(new_n81_), .b(new_n64_), .c(x21), .O(new_n82_));
  nand2  g18(.a(new_n82_), .b(new_n80_), .O(z04));
  aoi21  g19(.a(x28), .b(x27), .c(x37), .O(z06));
  inv1   g20(.a(z06), .O(z05));
  inv1   g21(.a(x03), .O(new_n86_));
  inv1   g22(.a(x00), .O(new_n87_));
  oai21  g23(.a(x25), .b(new_n87_), .c(x38), .O(new_n88_));
  inv1   g24(.a(x15), .O(new_n89_));
  nand2  g25(.a(x17), .b(new_n89_), .O(new_n90_));
  nor2   g26(.a(x33), .b(x31), .O(new_n91_));
  nand3  g27(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  inv1   g28(.a(x14), .O(new_n93_));
  inv1   g29(.a(x25), .O(new_n94_));
  nand3  g30(.a(x38), .b(new_n94_), .c(new_n87_), .O(new_n95_));
  nand2  g31(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  aoi21  g32(.a(new_n96_), .b(new_n92_), .c(new_n86_), .O(z07));
  inv1   g33(.a(new_n75_), .O(z08));
  ...
  aoi21  g54(.a(new_n118_), .b(new_n81_), .c(new_n64_), .O(new_n119_));
  ...
  nand3  g74(.a(new_n81_), .b(new_n79_), .c(x28), .O(new_n139_));
  ...
  oai21  g84(.a(new_n67_), .b(x27), .c(new_n108_), .O(new_n150_));
  nand2  g85(.a(new_n150_), .b(x08), .O(new_n151_));
  nand3  g86(.a(new_n151_), .b(new_n115_), .c(new_n113_), .O(z18));
  oai21  g87(.a(new_n79_), .b(new_n64_), .c(new_n112_), .O(new_n153_));
  oai21  g88(.a(new_n66_), .b(x27), .c(x35), .O(new_n154_));
  nand2  g89(.a(new_n154_), .b(new_n108_), .O(new_n155_));
  aoi21  g90(.a(new_n155_), .b(new_n153_), .c(new_n116_), .O(z20));
  zero   g91(.O(z00));
  zero   g92(.O(z03));
  zero   g93(.O(z15));
  aoi21  g94(.a(new_n114_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
