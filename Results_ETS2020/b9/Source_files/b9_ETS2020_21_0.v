// Benchmark "FAU" written by ABC on Fri Jun 26 04:12:43 2020
...
module FAU ( 
  ...
  inv1   g092(.a(x24), .O(new_n159_));
  nand4  g093(.a(new_n159_), .b(x23), .c(x22), .d(x01), .O(new_n160_));
  inv1   g094(.a(new_n160_), .O(z17));
  oai21  g095(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n162_));
  nand2  g096(.a(new_n162_), .b(x08), .O(new_n163_));
  nand3  g097(.a(new_n163_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g098(.a(new_n86_), .b(new_n72_), .c(new_n119_), .O(new_n165_));
  oai21  g099(.a(new_n74_), .b(x27), .c(x35), .O(new_n166_));
  nand2  g100(.a(new_n166_), .b(new_n116_), .O(new_n167_));
  aoi21  g101(.a(new_n167_), .b(new_n165_), .c(new_n123_), .O(z20));
  zero   g102(.O(z05));
  zero   g103(.O(z06));
  zero   g104(.O(z09));
  zero   g105(.O(z16));
