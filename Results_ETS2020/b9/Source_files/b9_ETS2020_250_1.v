...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n97_, new_n100_,
    new_n101_;
  ...
  nand4  g23(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n97_));
  inv1   g24(.a(new_n97_), .O(z15));
  inv1   g25(.a(x24), .O(new_n100_));
  nand4  g26(.a(new_n100_), .b(x23), .c(x22), .d(x01), .O(new_n101_));
  inv1   g27(.a(new_n101_), .O(z17));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z03));
  zero   g31(.O(z04));
