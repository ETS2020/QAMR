...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n153_, new_n154_, new_n156_, new_n158_, new_n162_, new_n163_,
    new_n164_;
  ...
  nand2  g054(.a(x27), .b(new_n64_), .O(new_n120_));
  oai21  g055(.a(new_n120_), .b(new_n75_), .c(new_n119_), .O(new_n121_));
  inv1   g056(.a(x09), .O(new_n122_));
  inv1   g057(.a(x30), .O(new_n123_));
  nand2  g058(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g059(.a(new_n121_), .b(new_n118_), .c(new_n124_), .O(z11));
  aoi21  g060(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n126_));
  inv1   g061(.a(new_n66_), .O(new_n127_));
  nand2  g062(.a(new_n127_), .b(x27), .O(new_n128_));
  oai21  g063(.a(new_n82_), .b(x04), .c(new_n128_), .O(new_n129_));
  oai21  g064(.a(new_n126_), .b(x10), .c(new_n129_), .O(z12));
  nand2  g065(.a(x36), .b(x35), .O(new_n131_));
  nand2  g066(.a(new_n131_), .b(x28), .O(new_n132_));
  inv1   g067(.a(x40), .O(new_n133_));
  nor2   g068(.a(new_n133_), .b(x13), .O(new_n134_));
  nand4  g069(.a(new_n134_), .b(new_n132_), .c(x39), .d(new_n64_), .O(new_n135_));
  inv1   g070(.a(x18), .O(new_n136_));
  inv1   g071(.a(x19), .O(new_n137_));
  nand3  g072(.a(x20), .b(new_n137_), .c(new_n136_), .O(new_n138_));
  inv1   g073(.a(new_n138_), .O(new_n139_));
  nand2  g074(.a(new_n139_), .b(new_n127_), .O(new_n140_));
  nand2  g075(.a(new_n140_), .b(new_n135_), .O(new_n141_));
  nand2  g076(.a(new_n141_), .b(x27), .O(new_n142_));
  nor2   g077(.a(x13), .b(x04), .O(new_n143_));
  nand3  g078(.a(new_n143_), .b(new_n78_), .c(z08), .O(new_n144_));
  nand2  g079(.a(new_n144_), .b(new_n142_), .O(z13));
  inv1   g080(.a(x32), .O(new_n146_));
  nand4  g081(.a(new_n131_), .b(new_n146_), .c(new_n123_), .d(x28), .O(new_n147_));
  inv1   g082(.a(new_n147_), .O(new_n148_));
  nand2  g083(.a(new_n143_), .b(z08), .O(new_n149_));
  oai21  g084(.a(new_n149_), .b(new_n148_), .c(new_n138_), .O(new_n150_));
  ...
  nand2  g088(.a(new_n149_), .b(new_n128_), .O(new_n154_));
  ...
  oai21  g094(.a(new_n86_), .b(new_n72_), .c(new_n119_), .O(new_n162_));
  oai21  g095(.a(new_n74_), .b(x27), .c(x35), .O(new_n163_));
  nand2  g096(.a(new_n163_), .b(new_n116_), .O(new_n164_));
  aoi21  g097(.a(new_n164_), .b(new_n162_), .c(new_n124_), .O(z20));
  zero   g098(.O(z05));
  zero   g099(.O(z06));
  zero   g100(.O(z09));
  zero   g101(.O(z17));
  zero   g102(.O(z18));
  aoi21  g103(.a(new_n121_), .b(new_n118_), .c(new_n124_), .O(z19));
endmodule
