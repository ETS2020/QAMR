// Benchmark "FAU" written by ABC on Fri Jun 26 04:24:37 2020
...
module FAU ( 
  ...
  nand3  g72(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n138_));
  nand2  g73(.a(new_n138_), .b(new_n93_), .O(new_n139_));
  nand2  g74(.a(new_n139_), .b(x08), .O(new_n140_));
  nand3  g75(.a(new_n140_), .b(new_n100_), .c(new_n98_), .O(z18));
  oai21  g76(.a(new_n125_), .b(new_n64_), .c(new_n97_), .O(new_n142_));
  oai21  g77(.a(new_n66_), .b(x27), .c(x35), .O(new_n143_));
  nand2  g78(.a(new_n143_), .b(new_n93_), .O(new_n144_));
  aoi21  g79(.a(new_n144_), .b(new_n142_), .c(new_n101_), .O(z20));
  zero   g80(.O(z00));
  zero   g81(.O(z07));
  zero   g82(.O(z10));
  aoi21  g83(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(z19));
endmodule
