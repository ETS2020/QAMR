...
module FAU ( 
  ...
  nand4  g12(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n80_));
  inv1   g13(.a(new_n80_), .O(z09));
  nand4  g14(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n87_));
  inv1   g15(.a(new_n87_), .O(z15));
  inv1   g16(.a(x24), .O(new_n90_));
  nand4  g17(.a(new_n90_), .b(x23), .c(x22), .d(x01), .O(new_n91_));
  inv1   g18(.a(new_n91_), .O(z17));
  zero   g19(.O(z01));
  zero   g20(.O(z02));
  zero   g21(.O(z03));
  zero   g22(.O(z04));
