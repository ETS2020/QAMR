// Benchmark "FAU" written by ABC on Fri Jun 26 04:12:06 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n99_, new_n100_;
  ...
  inv1   g23(.a(x24), .O(new_n99_));
  nand4  g24(.a(new_n99_), .b(x23), .c(x22), .d(x01), .O(new_n100_));
  inv1   g25(.a(new_n100_), .O(z17));
  zero   g26(.O(z01));
  zero   g27(.O(z02));
  zero   g28(.O(z03));
  zero   g29(.O(z04));
