...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n91_, new_n97_,
  ...
  nor2   g25(.a(x19), .b(x18), .O(new_n97_));
  nand2  g26(.a(new_n97_), .b(x20), .O(new_n98_));
  inv1   g27(.a(x30), .O(new_n99_));
  inv1   g28(.a(x32), .O(new_n100_));
  nand2  g29(.a(x36), .b(x35), .O(new_n101_));
  nand4  g30(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(x28), .O(new_n102_));
  inv1   g31(.a(new_n102_), .O(new_n103_));
  inv1   g32(.a(x13), .O(new_n104_));
  nand4  g33(.a(x40), .b(x39), .c(new_n104_), .d(new_n64_), .O(new_n105_));
  oai21  g34(.a(new_n105_), .b(new_n103_), .c(new_n98_), .O(new_n106_));
  inv1   g35(.a(x35), .O(new_n107_));
  nand2  g36(.a(new_n107_), .b(x28), .O(new_n108_));
  oai21  g37(.a(new_n108_), .b(x37), .c(x27), .O(new_n109_));
  nand3  g38(.a(new_n109_), .b(new_n100_), .c(new_n99_), .O(new_n110_));
  inv1   g39(.a(x27), .O(new_n111_));
  oai21  g40(.a(new_n66_), .b(new_n111_), .c(new_n105_), .O(new_n112_));
  nand3  g41(.a(new_n112_), .b(new_n110_), .c(new_n106_), .O(z14));
  inv1   g42(.a(x24), .O(new_n116_));
  nand4  g43(.a(new_n116_), .b(x23), .c(x22), .d(x01), .O(new_n117_));
  inv1   g44(.a(new_n117_), .O(z17));
  zero   g45(.O(z01));
  zero   g46(.O(z02));
  zero   g47(.O(z03));
  zero   g48(.O(z04));
