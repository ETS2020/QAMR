...
module FAU ( 
  ...
  inv1   g27(.a(x28), .O(new_n102_));
  nand2  g28(.a(x35), .b(new_n102_), .O(new_n103_));
  nand3  g29(.a(x40), .b(x39), .c(x29), .O(new_n104_));
  oai21  g30(.a(new_n103_), .b(x27), .c(new_n104_), .O(new_n105_));
  nand2  g31(.a(new_n105_), .b(x08), .O(new_n106_));
  nand4  g32(.a(x35), .b(new_n102_), .c(x27), .d(new_n64_), .O(new_n107_));
  nor2   g33(.a(x30), .b(x09), .O(new_n108_));
  nand3  g34(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(z18));
  zero   g35(.O(z01));
  zero   g36(.O(z02));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
