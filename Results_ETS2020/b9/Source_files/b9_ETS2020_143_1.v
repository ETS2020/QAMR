...
module FAU ( 
  ...
  inv1   g26(.a(x08), .O(new_n104_));
  nand2  g27(.a(x35), .b(x27), .O(new_n105_));
  nand2  g28(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  inv1   g29(.a(x28), .O(new_n107_));
  oai21  g30(.a(new_n107_), .b(x27), .c(x35), .O(new_n108_));
  nand3  g31(.a(x40), .b(x39), .c(x29), .O(new_n109_));
  nand2  g32(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  or2    g33(.a(x30), .b(x09), .O(new_n111_));
  aoi21  g34(.a(new_n110_), .b(new_n106_), .c(new_n111_), .O(z20));
  zero   g35(.O(z01));
  zero   g36(.O(z02));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
