...
module FAU ( 
  ...
  nand3  g17(.a(new_n49_), .b(x03), .c(x02), .O(new_n50_));
  nand3  g18(.a(new_n50_), .b(new_n33_), .c(x11), .O(z08));
  xnor2a g19(.a(x12), .b(x11), .O(new_n52_));
  and2   g20(.a(new_n52_), .b(new_n33_), .O(z09));
  nand3  g21(.a(new_n43_), .b(new_n38_), .c(new_n33_), .O(new_n54_));
  inv1   g22(.a(new_n54_), .O(z10));
  zero   g23(.O(z00));
  zero   g24(.O(z05));
  zero   g25(.O(z07));
  zero   g26(.O(z11));
