...
module FAU ( 
  ...
  nand3  g11(.a(x12), .b(x11), .c(x09), .O(new_n44_));
  inv1   g12(.a(new_n44_), .O(new_n45_));
  nand2  g13(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g14(.a(new_n32_), .b(new_n31_), .O(new_n47_));
  inv1   g15(.a(x10), .O(new_n48_));
  nand2  g16(.a(new_n48_), .b(x00), .O(new_n49_));
  inv1   g17(.a(new_n49_), .O(new_n50_));
  nand4  g18(.a(new_n50_), .b(new_n47_), .c(new_n46_), .d(z01), .O(z08));
  nand2  g19(.a(x12), .b(x11), .O(new_n52_));
  aoi21  g20(.a(new_n52_), .b(new_n47_), .c(new_n49_), .O(z09));
  nand2  g21(.a(new_n42_), .b(x12), .O(new_n54_));
  nand4  g22(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n55_));
  nor2   g23(.a(new_n55_), .b(new_n54_), .O(z10));
  nand4  g24(.a(new_n42_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  nand2  g25(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  nand3  g26(.a(x11), .b(new_n48_), .c(x00), .O(new_n59_));
  aoi21  g27(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z11));
  inv1   g28(.a(x09), .O(new_n61_));
  nand3  g29(.a(x12), .b(x11), .c(new_n61_), .O(new_n62_));
  nor2   g30(.a(new_n62_), .b(new_n49_), .O(z12));
  zero   g31(.O(z02));
  zero   g32(.O(z05));
  zero   g33(.O(z06));
endmodule
