// Benchmark "FAU" written by ABC on Tue Jun 23 03:57:59 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n49_), .b(x00), .O(new_n56_));
  inv1   g23(.a(x09), .O(new_n57_));
  nand3  g24(.a(x12), .b(x11), .c(new_n57_), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(new_n56_), .O(z12));
  zero   g26(.O(z02));
  zero   g27(.O(z09));
  zero   g28(.O(z10));
  zero   g29(.O(z11));
