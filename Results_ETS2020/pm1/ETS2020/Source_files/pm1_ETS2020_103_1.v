...
module FAU ( 
  ...
  aoi21  g18(.a(x12), .b(new_n36_), .c(new_n50_), .O(new_n51_));
  nand2  g19(.a(x09), .b(x01), .O(new_n52_));
  nor2   g20(.a(new_n52_), .b(new_n51_), .O(z06));
  inv1   g21(.a(x15), .O(z07));
  nand3  g22(.a(x09), .b(x04), .c(x00), .O(new_n55_));
  inv1   g23(.a(new_n55_), .O(new_n56_));
  nand4  g24(.a(new_n56_), .b(new_n33_), .c(x03), .d(x02), .O(new_n57_));
  nand3  g25(.a(new_n57_), .b(new_n40_), .c(x11), .O(z08));
  xnor2a g26(.a(x12), .b(x11), .O(new_n59_));
  and2   g27(.a(new_n59_), .b(new_n40_), .O(z09));
  nand2  g28(.a(new_n50_), .b(x12), .O(new_n61_));
  nand2  g29(.a(new_n43_), .b(new_n40_), .O(new_n62_));
  nor2   g30(.a(new_n62_), .b(new_n61_), .O(z10));
  nand4  g31(.a(new_n50_), .b(x12), .c(x09), .d(x01), .O(new_n64_));
  inv1   g32(.a(x01), .O(new_n65_));
  nand2  g33(.a(new_n32_), .b(new_n65_), .O(new_n66_));
  nand2  g34(.a(new_n40_), .b(x11), .O(new_n67_));
  aoi21  g35(.a(new_n66_), .b(new_n64_), .c(new_n67_), .O(z11));
  nor3   g36(.a(new_n31_), .b(new_n36_), .c(x09), .O(z12));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
  zero   g39(.O(z05));
endmodule
