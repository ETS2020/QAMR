// Benchmark "FAU" written by ABC on Tue Jun 23 03:57:12 2020
...
module FAU ( 
  ...
  nand3  g12(.a(x12), .b(x09), .c(x04), .O(new_n44_));
  inv1   g13(.a(new_n44_), .O(new_n45_));
  nand3  g14(.a(new_n45_), .b(x03), .c(x02), .O(new_n46_));
  ...
  nand2  g19(.a(new_n47_), .b(x00), .O(new_n51_));
  xor2a  g20(.a(x12), .b(x11), .O(new_n52_));
  nor2   g21(.a(new_n52_), .b(new_n51_), .O(z09));
  nand2  g22(.a(new_n39_), .b(x12), .O(new_n54_));
  nand4  g23(.a(x11), .b(new_n47_), .c(x09), .d(x00), .O(new_n55_));
  nor2   g24(.a(new_n55_), .b(new_n54_), .O(z10));
  nand4  g25(.a(new_n39_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  or2    g26(.a(x12), .b(x01), .O(new_n58_));
  aoi21  g27(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z11));
  zero   g28(.O(z00));
  zero   g29(.O(z01));
  zero   g30(.O(z12));
endmodule
