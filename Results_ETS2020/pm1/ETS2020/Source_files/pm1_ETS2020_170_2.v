// Benchmark "FAU" written by ABC on Tue Jun 23 03:57:47 2020
...
module FAU ( 
  ...
  nand3  g20(.a(new_n51_), .b(new_n49_), .c(x11), .O(z08));
  nand3  g21(.a(x04), .b(x03), .c(x02), .O(new_n54_));
  nand3  g22(.a(x12), .b(x11), .c(x09), .O(new_n55_));
  inv1   g23(.a(new_n55_), .O(new_n56_));
  nand3  g24(.a(new_n56_), .b(new_n54_), .c(new_n51_), .O(new_n57_));
  inv1   g25(.a(new_n57_), .O(z10));
  inv1   g26(.a(x10), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(x00), .O(new_n61_));
