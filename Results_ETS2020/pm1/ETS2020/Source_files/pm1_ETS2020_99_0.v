...
module FAU ( 
  ...
  nand2  g17(.a(new_n39_), .b(x12), .O(new_n52_));
  nand4  g18(.a(x11), .b(new_n47_), .c(x09), .d(x00), .O(new_n53_));
  nor2   g19(.a(new_n53_), .b(new_n52_), .O(z10));
  nand4  g20(.a(new_n39_), .b(x12), .c(x09), .d(x01), .O(new_n55_));
  or2    g21(.a(x12), .b(x01), .O(new_n56_));
  aoi21  g22(.a(new_n56_), .b(new_n55_), .c(new_n48_), .O(z11));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z04));
  zero   g26(.O(z07));
