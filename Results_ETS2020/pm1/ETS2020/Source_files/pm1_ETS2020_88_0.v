// Benchmark "FAU" written by ABC on Tue Jun 23 03:57:18 2020
...
module FAU ( 
  ...
  nand2  g17(.a(new_n47_), .b(x00), .O(new_n51_));
  xor2a  g18(.a(x12), .b(x11), .O(new_n52_));
  nor2   g19(.a(new_n52_), .b(new_n51_), .O(z09));
  nand2  g20(.a(new_n39_), .b(x12), .O(new_n54_));
  nand4  g21(.a(x11), .b(new_n47_), .c(x09), .d(x00), .O(new_n55_));
  nor2   g22(.a(new_n55_), .b(new_n54_), .O(z10));
  nand4  g23(.a(new_n39_), .b(x12), .c(x09), .d(x01), .O(new_n57_));
  or2    g24(.a(x12), .b(x01), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z11));
  zero   g26(.O(z00));
  zero   g27(.O(z01));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
