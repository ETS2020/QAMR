...
module FAU ( 
  ...
  nand3  g13(.a(x12), .b(x09), .c(x04), .O(new_n47_));
  inv1   g14(.a(new_n47_), .O(new_n48_));
  nand3  g15(.a(new_n48_), .b(x03), .c(x02), .O(new_n49_));
  inv1   g16(.a(x10), .O(new_n50_));
  nand3  g17(.a(x11), .b(new_n50_), .c(x00), .O(new_n51_));
  inv1   g18(.a(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n49_), .O(z08));
  nand3  g20(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand2  g21(.a(new_n55_), .b(x12), .O(new_n56_));
  nand4  g22(.a(x11), .b(new_n50_), .c(x09), .d(x00), .O(new_n57_));
  nor2   g23(.a(new_n57_), .b(new_n56_), .O(z10));
  nand2  g24(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  nand4  g25(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(new_n59_), .c(new_n51_), .O(z11));
  nand2  g27(.a(new_n50_), .b(x00), .O(new_n62_));
  inv1   g28(.a(x09), .O(new_n63_));
  nand3  g29(.a(x12), .b(x11), .c(new_n63_), .O(new_n64_));
  nor2   g30(.a(new_n64_), .b(new_n62_), .O(z12));
  zero   g31(.O(z04));
  zero   g32(.O(z05));
  zero   g33(.O(z06));
  zero   g34(.O(z07));
