...
module FAU ( 
  ...
  oai21  g16(.a(x10), .b(new_n47_), .c(new_n32_), .O(new_n48_));
  nand2  g17(.a(new_n48_), .b(new_n31_), .O(new_n49_));
  and2   g18(.a(x12), .b(x09), .O(new_n50_));
  ...
  aoi21  g23(.a(new_n54_), .b(new_n50_), .c(new_n52_), .O(new_n55_));
  nand2  g24(.a(new_n55_), .b(new_n49_), .O(z08));
  xor2a  g25(.a(x12), .b(x11), .O(new_n57_));
  nor2   g26(.a(new_n57_), .b(new_n52_), .O(z09));
  nand2  g27(.a(new_n53_), .b(x12), .O(new_n59_));
  nand2  g28(.a(x11), .b(x09), .O(new_n60_));
  nor3   g29(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(z10));
  nand4  g30(.a(new_n53_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g31(.a(new_n32_), .b(new_n30_), .O(new_n63_));
  nand3  g32(.a(x11), .b(new_n51_), .c(x00), .O(new_n64_));
