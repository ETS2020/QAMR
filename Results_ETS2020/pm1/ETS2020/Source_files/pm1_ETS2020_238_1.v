// Benchmark "FAU" written by ABC on Tue Jun 23 03:58:10 2020
...
module FAU ( 
  ...
  xor2a  g13(.a(x12), .b(x11), .O(new_n47_));
  inv1   g14(.a(x10), .O(new_n48_));
  nand2  g15(.a(new_n48_), .b(x00), .O(new_n49_));
  nor2   g16(.a(new_n49_), .b(new_n47_), .O(z09));
  nand2  g17(.a(new_n41_), .b(x12), .O(new_n51_));
  nand4  g18(.a(x11), .b(new_n48_), .c(x09), .d(x00), .O(new_n52_));
  nor2   g19(.a(new_n52_), .b(new_n51_), .O(z10));
  nand4  g20(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n54_));
  nand2  g21(.a(new_n32_), .b(new_n30_), .O(new_n55_));
  nand3  g22(.a(x11), .b(new_n48_), .c(x00), .O(new_n56_));
  aoi21  g23(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z11));
  inv1   g24(.a(x09), .O(new_n58_));
  nand3  g25(.a(x12), .b(x11), .c(new_n58_), .O(new_n59_));
  nor2   g26(.a(new_n59_), .b(new_n49_), .O(z12));
  zero   g27(.O(z03));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
  zero   g30(.O(z08));
