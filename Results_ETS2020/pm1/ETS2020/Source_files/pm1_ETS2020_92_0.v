...
module FAU ( 
  ...
  nand3  g17(.a(new_n47_), .b(x03), .c(x02), .O(new_n48_));
  ...
  nand4  g22(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n55_));
  nand2  g23(.a(new_n32_), .b(new_n30_), .O(new_n56_));
  aoi21  g24(.a(new_n56_), .b(new_n55_), .c(new_n50_), .O(z11));
  nand2  g25(.a(new_n49_), .b(x00), .O(new_n58_));
  inv1   g26(.a(x09), .O(new_n59_));
  nand3  g27(.a(x12), .b(x11), .c(new_n59_), .O(new_n60_));
  nor2   g28(.a(new_n60_), .b(new_n58_), .O(z12));
  zero   g29(.O(z01));
  zero   g30(.O(z09));
  zero   g31(.O(z10));
endmodule
