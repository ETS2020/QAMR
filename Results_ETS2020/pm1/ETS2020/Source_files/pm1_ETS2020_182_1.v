...
module FAU ( 
  ...
  nand2  g15(.a(new_n41_), .b(x12), .O(new_n48_));
  inv1   g16(.a(x10), .O(new_n49_));
  nand4  g17(.a(x11), .b(new_n49_), .c(x09), .d(x00), .O(new_n50_));
  nor2   g18(.a(new_n50_), .b(new_n48_), .O(z10));
  nand4  g19(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n52_));
  nand2  g20(.a(new_n32_), .b(new_n30_), .O(new_n53_));
  nand3  g21(.a(x11), .b(new_n49_), .c(x00), .O(new_n54_));
  aoi21  g22(.a(new_n53_), .b(new_n52_), .c(new_n54_), .O(z11));
  nand2  g23(.a(new_n49_), .b(x00), .O(new_n56_));
  inv1   g24(.a(x09), .O(new_n57_));
  nand3  g25(.a(x12), .b(x11), .c(new_n57_), .O(new_n58_));
  nor2   g26(.a(new_n58_), .b(new_n56_), .O(z12));
  zero   g27(.O(z03));
  zero   g28(.O(z08));
  zero   g29(.O(z09));
endmodule
