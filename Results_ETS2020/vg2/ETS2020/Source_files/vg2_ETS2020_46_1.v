// Benchmark "FAU" written by ABC on Tue Jun 23 00:07:24 2020
...
module FAU ( 
  ...
  nor2   g081(.a(new_n77_), .b(new_n48_), .O(new_n116_));
  nand4  g082(.a(new_n116_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n117_));
  nor2   g083(.a(x08), .b(x06), .O(new_n118_));
  nor3   g084(.a(x20), .b(x14), .c(x11), .O(new_n119_));
  nand4  g085(.a(new_n119_), .b(new_n118_), .c(new_n66_), .d(new_n49_), .O(new_n120_));
  nand2  g086(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand2  g087(.a(new_n121_), .b(new_n36_), .O(new_n122_));
  nand4  g088(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n123_));
  nand3  g089(.a(new_n50_), .b(new_n48_), .c(new_n108_), .O(new_n124_));
  nand3  g090(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n125_));
  oai22  g091(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n86_), .O(new_n126_));
  nand4  g092(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n127_));
  nand3  g093(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n128_));
  oai22  g094(.a(new_n128_), .b(new_n109_), .c(new_n127_), .d(new_n86_), .O(new_n129_));
  aoi22  g095(.a(new_n129_), .b(new_n39_), .c(new_n126_), .d(new_n100_), .O(new_n130_));
  nand2  g096(.a(new_n130_), .b(new_n122_), .O(z3));
  aoi21  g097(.a(new_n74_), .b(x04), .c(x17), .O(new_n132_));
  oai21  g098(.a(new_n132_), .b(x22), .c(new_n105_), .O(new_n133_));
  aoi21  g099(.a(new_n133_), .b(new_n71_), .c(x08), .O(new_n134_));
  inv1   g100(.a(x04), .O(new_n135_));
  aoi21  g101(.a(x23), .b(new_n135_), .c(new_n72_), .O(new_n136_));
  oai21  g102(.a(new_n136_), .b(new_n73_), .c(x09), .O(new_n137_));
  aoi21  g103(.a(new_n137_), .b(x16), .c(new_n108_), .O(new_n138_));
  nand2  g104(.a(x24), .b(x18), .O(new_n139_));
  nand3  g105(.a(new_n36_), .b(x15), .c(x13), .O(new_n140_));
  aoi21  g106(.a(new_n140_), .b(new_n139_), .c(new_n34_), .O(new_n141_));
  nand3  g107(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n142_));
  nand3  g108(.a(x24), .b(x18), .c(x13), .O(new_n143_));
  nand2  g109(.a(new_n39_), .b(x15), .O(new_n144_));
  nand3  g110(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nor2   g111(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  oai22  g112(.a(new_n146_), .b(new_n138_), .c(new_n134_), .d(new_n46_), .O(z4));
  inv1   g113(.a(new_n46_), .O(z5));
  oai21  g114(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n149_));
  aoi21  g115(.a(new_n149_), .b(new_n48_), .c(x03), .O(new_n150_));
  inv1   g116(.a(x03), .O(new_n151_));
  oai21  g117(.a(x20), .b(new_n77_), .c(x06), .O(new_n152_));
  aoi21  g118(.a(new_n152_), .b(x11), .c(new_n151_), .O(new_n153_));
  oai22  g119(.a(new_n153_), .b(new_n146_), .c(new_n150_), .d(new_n46_), .O(z6));
  inv1   g120(.a(new_n146_), .O(z7));
  zero   g121(.O(z2));
endmodule
