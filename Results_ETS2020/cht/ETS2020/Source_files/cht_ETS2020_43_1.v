...
module FAU ( 
  ...
  nand2  g68(.a(new_n154_), .b(x42), .O(new_n163_));
  nand2  g69(.a(new_n156_), .b(x43), .O(new_n164_));
  aoi21  g70(.a(new_n164_), .b(new_n163_), .c(x10), .O(z31));
  nand2  g71(.a(new_n154_), .b(x43), .O(new_n166_));
  nand2  g72(.a(new_n156_), .b(x44), .O(new_n167_));
  aoi21  g73(.a(new_n167_), .b(new_n166_), .c(x10), .O(z32));
  nand2  g74(.a(new_n154_), .b(x44), .O(new_n169_));
  nand2  g75(.a(new_n156_), .b(x45), .O(new_n170_));
  aoi21  g76(.a(new_n170_), .b(new_n169_), .c(x10), .O(z33));
  nand2  g77(.a(new_n154_), .b(x45), .O(new_n172_));
  nand2  g78(.a(new_n156_), .b(x46), .O(new_n173_));
  aoi21  g79(.a(new_n173_), .b(new_n172_), .c(x10), .O(z34));
  nand2  g80(.a(new_n154_), .b(x46), .O(new_n175_));
  nand2  g81(.a(new_n156_), .b(x00), .O(new_n176_));
