// Benchmark "FAU" written by ABC on Tue Jun 23 05:28:33 2020
...
module FAU ( 
  ...
  wire new_n90_, new_n91_, new_n92_, new_n95_, new_n96_, new_n98_, new_n99_,
    ...
    new_n155_, new_n157_, new_n158_, new_n160_, new_n161_, new_n165_,
  ...
  nand2  g68(.a(new_n152_), .b(x44), .O(new_n165_));
  nand2  g69(.a(new_n154_), .b(x45), .O(new_n166_));
  aoi21  g70(.a(new_n166_), .b(new_n165_), .c(x10), .O(z33));
  nand2  g71(.a(new_n152_), .b(x45), .O(new_n168_));
  nand2  g72(.a(new_n154_), .b(x46), .O(new_n169_));
  aoi21  g73(.a(new_n169_), .b(new_n168_), .c(x10), .O(z34));
  nand2  g74(.a(new_n152_), .b(x46), .O(new_n171_));
  nand2  g75(.a(new_n154_), .b(x00), .O(new_n172_));
