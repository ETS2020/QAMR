...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n134_, new_n146_, new_n147_, new_n148_, new_n149_;
  ...
  inv1   g47(.a(x09), .O(new_n146_));
  oai21  g48(.a(x14), .b(new_n146_), .c(x41), .O(new_n147_));
  inv1   g49(.a(x14), .O(new_n148_));
  nand3  g50(.a(x42), .b(new_n148_), .c(x09), .O(new_n149_));
  aoi21  g51(.a(new_n149_), .b(new_n147_), .c(x10), .O(z30));
  zero   g52(.O(z07));
  zero   g53(.O(z09));
  zero   g54(.O(z13));
  zero   g55(.O(z14));
