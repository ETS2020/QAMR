...
module FAU ( 
  ...
  nand2  g000(.a(x07), .b(x02), .O(new_n88_));
  inv1   g001(.a(x07), .O(new_n89_));
  nand2  g002(.a(x15), .b(new_n89_), .O(new_n90_));
  aoi21  g003(.a(new_n90_), .b(new_n88_), .c(x10), .O(z04));
