...
module FAU ( 
  ...
  wire new_n90_, new_n91_, new_n92_, new_n98_, new_n99_, new_n101_,
    new_n102_, new_n104_, new_n105_, new_n107_, new_n108_, new_n112_,
  ...
  nand2  g62(.a(new_n150_), .b(x41), .O(new_n158_));
  nand2  g63(.a(new_n152_), .b(x42), .O(new_n159_));
  aoi21  g64(.a(new_n159_), .b(new_n158_), .c(x10), .O(z30));
  nand2  g65(.a(new_n150_), .b(x42), .O(new_n161_));
  nand2  g66(.a(new_n152_), .b(x43), .O(new_n162_));
  aoi21  g67(.a(new_n162_), .b(new_n161_), .c(x10), .O(z31));
  nand2  g68(.a(new_n150_), .b(x43), .O(new_n164_));
  nand2  g69(.a(new_n152_), .b(x44), .O(new_n165_));
  aoi21  g70(.a(new_n165_), .b(new_n164_), .c(x10), .O(z32));
  nand2  g71(.a(new_n150_), .b(x44), .O(new_n167_));
  nand2  g72(.a(new_n152_), .b(x45), .O(new_n168_));
  aoi21  g73(.a(new_n168_), .b(new_n167_), .c(x10), .O(z33));
  nand2  g74(.a(new_n150_), .b(x45), .O(new_n170_));
  nand2  g75(.a(new_n152_), .b(x46), .O(new_n171_));
  aoi21  g76(.a(new_n171_), .b(new_n170_), .c(x10), .O(z34));
  nand2  g77(.a(new_n150_), .b(x46), .O(new_n173_));
  nand2  g78(.a(new_n152_), .b(x00), .O(new_n174_));
  aoi21  g79(.a(new_n174_), .b(new_n173_), .c(x10), .O(z35));
  zero   g80(.O(z00));
  zero   g81(.O(z01));
  zero   g82(.O(z02));
  zero   g83(.O(z03));
