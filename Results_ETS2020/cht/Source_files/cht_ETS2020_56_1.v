...
module FAU ( 
  ...
  nand2  g000(.a(x07), .b(x03), .O(new_n89_));
  inv1   g001(.a(x07), .O(new_n90_));
  nand2  g002(.a(x16), .b(new_n90_), .O(new_n91_));
  aoi21  g003(.a(new_n91_), .b(new_n89_), .c(x10), .O(z05));
  ...
  nand2  g017(.a(x21), .b(new_n93_), .O(new_n106_));
  nand2  g018(.a(x22), .b(x08), .O(new_n107_));
  aoi21  g019(.a(new_n107_), .b(new_n106_), .c(x10), .O(z10));
  nand2  g020(.a(x22), .b(new_n93_), .O(new_n109_));
  nand2  g021(.a(x23), .b(x08), .O(new_n110_));
  aoi21  g022(.a(new_n110_), .b(new_n109_), .c(x10), .O(z11));
  ...
  nand2  g029(.a(x26), .b(new_n93_), .O(new_n119_));
  nand2  g030(.a(x27), .b(x08), .O(new_n120_));
  aoi21  g031(.a(new_n120_), .b(new_n119_), .c(x10), .O(z15));
  nand2  g032(.a(x28), .b(new_n93_), .O(new_n123_));
  nand2  g033(.a(x29), .b(x08), .O(new_n124_));
  aoi21  g034(.a(new_n124_), .b(new_n123_), .c(x10), .O(z17));
  nand2  g035(.a(x29), .b(new_n93_), .O(new_n126_));
  nand2  g036(.a(x30), .b(x08), .O(new_n127_));
  aoi21  g037(.a(new_n127_), .b(new_n126_), .c(x10), .O(z18));
  nand2  g038(.a(x08), .b(x00), .O(new_n129_));
  nand2  g039(.a(x30), .b(new_n93_), .O(new_n130_));
