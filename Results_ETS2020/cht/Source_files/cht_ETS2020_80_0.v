...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n134_, new_n151_, new_n152_, new_n153_, new_n154_;
  ...
  inv1   g47(.a(x09), .O(new_n151_));
  oai21  g48(.a(x14), .b(new_n151_), .c(x46), .O(new_n152_));
  inv1   g49(.a(x14), .O(new_n153_));
  nand3  g50(.a(new_n153_), .b(x09), .c(x00), .O(new_n154_));
  aoi21  g51(.a(new_n154_), .b(new_n152_), .c(x10), .O(z35));
  zero   g52(.O(z07));
  zero   g53(.O(z08));
  zero   g54(.O(z09));
  zero   g55(.O(z13));
