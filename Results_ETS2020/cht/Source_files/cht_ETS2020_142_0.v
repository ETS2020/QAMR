...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n134_, new_n143_, new_n144_, new_n145_, new_n146_, new_n147_,
    new_n148_;
  ...
  inv1   g51(.a(x09), .O(new_n147_));
  nand2  g52(.a(x38), .b(new_n147_), .O(new_n148_));
  aoi21  g53(.a(new_n148_), .b(new_n146_), .c(x10), .O(z27));
  zero   g54(.O(z07));
  zero   g55(.O(z08));
  zero   g56(.O(z09));
  zero   g57(.O(z13));
