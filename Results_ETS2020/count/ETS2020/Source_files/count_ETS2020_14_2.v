...
module FAU ( 
  ...
  nor3   g067(.a(x25), .b(x24), .c(x23), .O(new_n120_));
  nand4  g068(.a(new_n120_), .b(new_n113_), .c(new_n72_), .d(new_n56_), .O(new_n121_));
  ...
  nand4  g095(.a(new_n149_), .b(new_n140_), .c(new_n122_), .d(new_n139_), .O(new_n150_));
  oai21  g096(.a(new_n150_), .b(new_n86_), .c(x33), .O(new_n151_));
  nor2   g097(.a(x29), .b(x28), .O(new_n152_));
  nor2   g098(.a(x31), .b(x30), .O(new_n153_));
  nor2   g099(.a(x33), .b(x32), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n113_), .O(new_n155_));
  inv1   g101(.a(new_n155_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n96_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(x16), .O(new_n159_));
  inv1   g105(.a(x01), .O(new_n160_));
  aoi21  g106(.a(new_n59_), .b(new_n160_), .c(x18), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n159_), .O(z14));
  oai21  g108(.a(new_n155_), .b(new_n104_), .c(x34), .O(new_n163_));
  nand2  g109(.a(new_n152_), .b(new_n113_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  inv1   g111(.a(x30), .O(new_n166_));
  inv1   g112(.a(x31), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  inv1   g114(.a(x32), .O(new_n169_));
  inv1   g115(.a(x33), .O(new_n170_));
  inv1   g116(.a(x34), .O(new_n171_));
  nand3  g117(.a(new_n171_), .b(new_n170_), .c(new_n169_), .O(new_n172_));
  nor2   g118(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand3  g119(.a(new_n173_), .b(new_n165_), .c(new_n96_), .O(new_n174_));
  nand2  g120(.a(new_n174_), .b(new_n163_), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g122(.a(x00), .O(new_n177_));
  aoi21  g123(.a(new_n59_), .b(new_n177_), .c(x18), .O(new_n178_));
  nand2  g124(.a(new_n178_), .b(new_n176_), .O(z15));
  zero   g125(.O(z00));
  zero   g126(.O(z12));
  zero   g127(.O(z13));
endmodule
