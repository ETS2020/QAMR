...
module FAU ( 
  ...
  aoi21  g103(.a(new_n59_), .b(new_n155_), .c(x18), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(new_n154_), .O(z12));
  nor2   g105(.a(x32), .b(x31), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n140_), .c(new_n122_), .d(new_n139_), .O(new_n160_));
  oai21  g107(.a(new_n160_), .b(new_n86_), .c(x33), .O(new_n161_));
