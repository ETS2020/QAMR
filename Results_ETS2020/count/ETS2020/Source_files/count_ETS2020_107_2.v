// Benchmark "FAU" written by ABC on Tue Jun 23 07:16:32 2020
...
module FAU ( 
  ...
  aoi21  g114(.a(new_n59_), .b(new_n166_), .c(x18), .O(new_n167_));
  ...
  aoi21  g124(.a(new_n59_), .b(new_n176_), .c(x18), .O(new_n177_));
  ...
  aoi21  g141(.a(new_n59_), .b(new_n193_), .c(x18), .O(new_n194_));
