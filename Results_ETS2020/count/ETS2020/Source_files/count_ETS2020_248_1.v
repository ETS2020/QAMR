...
module FAU ( 
  ...
  nor2   g17(.a(x23), .b(x22), .O(new_n73_));
  nor2   g18(.a(x25), .b(x24), .O(new_n74_));
  nand4  g19(.a(new_n74_), .b(new_n73_), .c(new_n64_), .d(new_n58_), .O(new_n75_));
  nand2  g20(.a(new_n75_), .b(x26), .O(new_n76_));
  nor3   g21(.a(x26), .b(x25), .c(x24), .O(new_n77_));
  nand4  g22(.a(new_n77_), .b(new_n73_), .c(new_n64_), .d(new_n58_), .O(new_n78_));
  nand2  g23(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g24(.a(new_n79_), .b(x16), .O(new_n80_));
  inv1   g25(.a(x08), .O(new_n81_));
  aoi21  g26(.a(new_n52_), .b(new_n81_), .c(x18), .O(new_n82_));
  nand2  g27(.a(new_n82_), .b(new_n80_), .O(z07));
  zero   g28(.O(z03));
  zero   g29(.O(z04));
  zero   g30(.O(z05));
  zero   g31(.O(z06));
