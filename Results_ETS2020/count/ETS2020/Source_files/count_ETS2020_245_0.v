...
module FAU ( 
  ...
  nand3  g050(.a(new_n103_), .b(new_n102_), .c(new_n66_), .O(new_n104_));
  ...
  nand4  g059(.a(new_n112_), .b(new_n85_), .c(new_n72_), .d(new_n71_), .O(new_n113_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n103_), .c(new_n78_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n102_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n131_));
  ...
  nand4  g119(.a(new_n114_), .b(new_n102_), .c(new_n172_), .d(new_n55_), .O(new_n173_));
