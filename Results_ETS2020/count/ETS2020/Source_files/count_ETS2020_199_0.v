// Benchmark "FAU" written by ABC on Tue Jun 23 07:17:16 2020
...
module FAU ( 
  ...
  aoi21  g031(.a(new_n78_), .b(new_n62_), .c(new_n83_), .O(new_n84_));
  nor2   g032(.a(x24), .b(x23), .O(new_n85_));
  nand4  g033(.a(new_n85_), .b(new_n72_), .c(new_n55_), .d(new_n64_), .O(new_n86_));
  ...
  aoi22  g044(.a(new_n96_), .b(new_n67_), .c(new_n86_), .d(x25), .O(new_n97_));
  ...
  oai21  g048(.a(new_n95_), .b(new_n66_), .c(x26), .O(new_n101_));
  nor2   g049(.a(x23), .b(x22), .O(new_n102_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n102_), .c(new_n67_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n85_), .c(new_n94_), .O(new_n111_));
  nor2   g059(.a(new_n111_), .b(new_n77_), .O(new_n112_));
  ...
  nand4  g065(.a(new_n117_), .b(new_n85_), .c(new_n72_), .d(new_n62_), .O(new_n118_));
  inv1   g066(.a(x26), .O(new_n119_));
  nor2   g067(.a(x25), .b(x24), .O(new_n120_));
  nor2   g068(.a(x28), .b(x27), .O(new_n121_));
  nand4  g069(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n93_), .O(new_n122_));
  nor2   g070(.a(new_n122_), .b(new_n77_), .O(new_n123_));
  aoi21  g071(.a(new_n118_), .b(x28), .c(new_n123_), .O(new_n124_));
  ...
  oai21  g075(.a(new_n122_), .b(new_n77_), .c(x29), .O(new_n128_));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g077(.a(new_n129_), .b(new_n103_), .c(new_n78_), .d(new_n62_), .O(new_n130_));
  ...
  nand4  g083(.a(new_n102_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n136_));
  nor2   g084(.a(x26), .b(x25), .O(new_n137_));
  nor2   g085(.a(x30), .b(x29), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n121_), .c(new_n137_), .d(new_n83_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n146_));
  inv1   g094(.a(new_n146_), .O(new_n147_));
  inv1   g095(.a(x28), .O(new_n148_));
  inv1   g096(.a(x29), .O(new_n149_));
  inv1   g097(.a(x30), .O(new_n150_));
  inv1   g098(.a(x31), .O(new_n151_));
  nand4  g099(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n152_));
  inv1   g100(.a(new_n152_), .O(new_n153_));
  nand4  g101(.a(new_n153_), .b(new_n117_), .c(new_n147_), .d(new_n62_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n145_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g104(.a(x03), .O(new_n157_));
  aoi21  g105(.a(new_n58_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n156_), .O(z12));
  nor2   g107(.a(x29), .b(x28), .O(new_n160_));
  nor2   g108(.a(x31), .b(x30), .O(new_n161_));
  nand4  g109(.a(new_n161_), .b(new_n160_), .c(new_n110_), .d(new_n94_), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(new_n86_), .c(x32), .O(new_n163_));
  inv1   g111(.a(x27), .O(new_n164_));
  nand4  g112(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n164_), .O(new_n165_));
  inv1   g113(.a(new_n165_), .O(new_n166_));
  inv1   g114(.a(x32), .O(new_n167_));
  nand4  g115(.a(new_n167_), .b(new_n151_), .c(new_n119_), .d(new_n94_), .O(new_n168_));
  inv1   g116(.a(new_n168_), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n166_), .c(new_n147_), .d(new_n62_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(new_n163_), .O(new_n171_));
  nand2  g119(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g120(.a(x02), .O(new_n173_));
  aoi21  g121(.a(new_n58_), .b(new_n173_), .c(x18), .O(new_n174_));
  nand2  g122(.a(new_n174_), .b(new_n172_), .O(z13));
  nor2   g123(.a(x32), .b(x31), .O(new_n176_));
  nand4  g124(.a(new_n176_), .b(new_n138_), .c(new_n121_), .d(new_n137_), .O(new_n177_));
  oai21  g125(.a(new_n177_), .b(new_n86_), .c(x33), .O(new_n178_));
  inv1   g126(.a(x33), .O(new_n179_));
  nand4  g127(.a(new_n179_), .b(new_n167_), .c(new_n164_), .d(new_n119_), .O(new_n180_));
  inv1   g128(.a(new_n180_), .O(new_n181_));
  nand4  g129(.a(new_n181_), .b(new_n153_), .c(new_n96_), .d(new_n67_), .O(new_n182_));
  nand2  g130(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g131(.a(new_n183_), .b(x16), .O(new_n184_));
  inv1   g132(.a(x01), .O(new_n185_));
  aoi21  g133(.a(new_n58_), .b(new_n185_), .c(x18), .O(new_n186_));
