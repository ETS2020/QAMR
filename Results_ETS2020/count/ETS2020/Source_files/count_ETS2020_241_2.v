// Benchmark "FAU" written by ABC on Tue Jun 23 07:17:35 2020
...
module FAU ( 
  ...
  nand4  g079(.a(new_n131_), .b(new_n106_), .c(new_n78_), .d(new_n56_), .O(new_n132_));
  ...
  nand4  g085(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n138_));
  ...
  aoi21  g092(.a(new_n59_), .b(new_n144_), .c(x18), .O(new_n145_));
  oai21  g093(.a(new_n143_), .b(new_n59_), .c(new_n145_), .O(z11));
  nor2   g094(.a(x29), .b(x28), .O(new_n148_));
  nor2   g095(.a(x31), .b(x30), .O(new_n149_));
  nand4  g096(.a(new_n149_), .b(new_n148_), .c(new_n113_), .d(new_n94_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n86_), .c(x32), .O(new_n151_));
  nor2   g098(.a(x32), .b(x31), .O(new_n152_));
  nand4  g099(.a(new_n152_), .b(new_n140_), .c(new_n122_), .d(new_n139_), .O(new_n153_));
  inv1   g100(.a(new_n153_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n87_), .O(new_n155_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n86_), .c(x33), .O(new_n161_));
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n149_), .c(new_n148_), .d(new_n113_), .O(new_n163_));
  inv1   g110(.a(new_n163_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n96_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g114(.a(x01), .O(new_n168_));
  aoi21  g115(.a(new_n59_), .b(new_n168_), .c(x18), .O(new_n169_));
  nand2  g116(.a(new_n169_), .b(new_n167_), .O(z14));
  oai21  g117(.a(new_n163_), .b(new_n104_), .c(x34), .O(new_n171_));
  nand2  g118(.a(new_n148_), .b(new_n113_), .O(new_n172_));
