...
module FAU ( 
  ...
  nand3  g092(.a(new_n145_), .b(new_n114_), .c(new_n87_), .O(new_n146_));
  nand2  g093(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g095(.a(x03), .O(new_n149_));
  aoi21  g096(.a(new_n59_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g097(.a(new_n150_), .b(new_n148_), .O(z12));
  nor2   g098(.a(x27), .b(x26), .O(new_n152_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n152_), .d(new_n94_), .O(new_n153_));
  oai21  g100(.a(new_n153_), .b(new_n86_), .c(x32), .O(new_n154_));
  nor2   g101(.a(x32), .b(x31), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n156_));
  ...
  nand4  g112(.a(new_n165_), .b(new_n143_), .c(new_n142_), .d(new_n152_), .O(new_n166_));
  ...
  nand2  g121(.a(new_n142_), .b(new_n152_), .O(new_n175_));
