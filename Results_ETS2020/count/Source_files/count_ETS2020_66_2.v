...
module FAU ( 
  ...
  nand4  g060(.a(new_n113_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n98_), .c(new_n78_), .d(new_n56_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n131_));
  ...
  nor2   g112(.a(new_n165_), .b(new_n66_), .O(new_n166_));
