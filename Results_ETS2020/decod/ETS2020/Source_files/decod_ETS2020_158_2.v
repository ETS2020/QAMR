// Benchmark "FAU" written by ABC on Tue Jun 23 00:19:03 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n43_, new_n44_, new_n45_;
  ...
  inv1   g17(.a(x0), .O(new_n43_));
  nand2  g18(.a(new_n32_), .b(new_n43_), .O(new_n44_));
  nand3  g19(.a(x4), .b(x3), .c(x2), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z12));
  zero   g21(.O(z08));
  zero   g22(.O(z09));
  zero   g23(.O(z10));
  zero   g24(.O(z11));
