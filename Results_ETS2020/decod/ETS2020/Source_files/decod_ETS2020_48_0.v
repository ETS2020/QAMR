...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n23_, new_n24_, new_n25_, new_n33_, new_n34_, new_n35_, new_n37_,
  ...
  nand2  g08(.a(x4), .b(new_n24_), .O(new_n37_));
  nor2   g09(.a(new_n37_), .b(new_n34_), .O(z09));
  inv1   g10(.a(x2), .O(new_n39_));
  nand3  g11(.a(new_n39_), .b(x1), .c(new_n33_), .O(new_n40_));
  ...
  nand3  g18(.a(new_n39_), .b(new_n43_), .c(new_n33_), .O(new_n47_));
