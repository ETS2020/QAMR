// Benchmark "FAU" written by ABC on Tue Jun 23 00:19:05 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n44_, new_n45_, new_n47_,
    new_n50_;
  ...
  nand3  g22(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n44_), .O(z11));
  nand3  g24(.a(x2), .b(new_n32_), .c(new_n39_), .O(new_n47_));
  nor2   g25(.a(new_n47_), .b(new_n23_), .O(z12));
  nor2   g26(.a(new_n47_), .b(new_n26_), .O(z13));
  nand3  g27(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n23_), .O(z14));
  nor2   g29(.a(new_n50_), .b(new_n26_), .O(z15));
  zero   g30(.O(z10));
endmodule
