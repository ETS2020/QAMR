// Benchmark "FAU" written by ABC on Tue Jun 23 00:19:06 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n43_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g22(.a(x4), .b(x3), .c(new_n28_), .O(new_n44_));
  nor2   g23(.a(new_n44_), .b(new_n43_), .O(z10));
