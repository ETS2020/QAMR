...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n46_, new_n47_, new_n48_;
  ...
  inv1   g17(.a(x0), .O(new_n46_));
  nand2  g18(.a(new_n32_), .b(new_n46_), .O(new_n47_));
  nand3  g19(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n48_));
  nor2   g20(.a(new_n48_), .b(new_n47_), .O(z15));
  zero   g21(.O(z08));
  zero   g22(.O(z09));
  zero   g23(.O(z10));
  zero   g24(.O(z11));
