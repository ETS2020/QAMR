...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n44_, new_n45_, new_n46_;
  ...
  inv1   g17(.a(x0), .O(new_n44_));
  nand2  g18(.a(new_n32_), .b(new_n44_), .O(new_n45_));
  nand3  g19(.a(x4), .b(new_n25_), .c(x2), .O(new_n46_));
