...
module FAU ( 
  ...
  nand4  g14(.a(new_n22_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z5));
  nand4  g15(.a(new_n25_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z6));
  nand4  g16(.a(new_n27_), .b(new_n17_), .c(new_n15_), .d(x2), .O(z7));
  zero   g17(.O(z4));
endmodule
