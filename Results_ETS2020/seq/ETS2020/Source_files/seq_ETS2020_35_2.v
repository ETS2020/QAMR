// Benchmark "FAU" written by ABC on Thu Jun 25 01:29:07 2020
...
module FAU ( 
  ...
  wire new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    ...
    new_n468_, new_n469_, new_n470_, new_n471_, new_n472_, new_n482_,
    new_n483_, new_n484_, new_n485_, new_n486_, new_n487_, new_n488_,
    new_n489_, new_n490_, new_n491_, new_n492_, new_n493_, new_n494_,
    new_n495_, new_n496_, new_n497_, new_n498_, new_n499_, new_n500_,
    new_n501_, new_n502_, new_n503_, new_n508_, new_n509_, new_n510_,
    ...
    new_n577_, new_n584_, new_n585_, new_n586_, new_n587_, new_n588_,
  ...
  nand3  g217(.a(new_n205_), .b(x12), .c(new_n128_), .O(new_n294_));
  oai22  g218(.a(new_n294_), .b(new_n293_), .c(new_n291_), .d(new_n205_), .O(new_n295_));
  ...
  nand2  g280(.a(x12), .b(new_n128_), .O(new_n358_));
  nand2  g281(.a(new_n358_), .b(new_n251_), .O(new_n359_));
  and2   g282(.a(new_n359_), .b(new_n255_), .O(new_n360_));
  ...
  aoi21  g328(.a(new_n293_), .b(new_n87_), .c(x35), .O(new_n406_));
  oai21  g329(.a(new_n406_), .b(new_n405_), .c(x37), .O(new_n407_));
  inv1   g330(.a(new_n294_), .O(new_n408_));
  ...
  nor2   g334(.a(new_n232_), .b(x38), .O(new_n412_));
  aoi22  g335(.a(new_n412_), .b(new_n408_), .c(new_n411_), .d(x35), .O(new_n413_));
  oai21  g336(.a(new_n413_), .b(x37), .c(new_n407_), .O(new_n414_));
  ...
  nand2  g355(.a(new_n432_), .b(new_n103_), .O(new_n433_));
  nand2  g356(.a(new_n152_), .b(new_n150_), .O(new_n434_));
  nand3  g357(.a(new_n434_), .b(new_n433_), .c(new_n428_), .O(new_n435_));
  nand3  g358(.a(new_n435_), .b(new_n350_), .c(new_n77_), .O(new_n436_));
  nand2  g359(.a(new_n436_), .b(new_n422_), .O(new_n437_));
  oai21  g360(.a(new_n437_), .b(new_n394_), .c(new_n244_), .O(new_n438_));
  aoi21  g361(.a(new_n438_), .b(new_n243_), .c(new_n247_), .O(z03));
  nand2  g362(.a(new_n360_), .b(new_n334_), .O(new_n445_));
  oai21  g363(.a(new_n174_), .b(new_n116_), .c(new_n172_), .O(new_n446_));
  nand4  g364(.a(x40), .b(x35), .c(x24), .d(x23), .O(new_n447_));
  inv1   g365(.a(new_n447_), .O(new_n448_));
  nand4  g366(.a(new_n448_), .b(new_n446_), .c(new_n176_), .d(new_n124_), .O(new_n449_));
  aoi21  g367(.a(new_n449_), .b(new_n445_), .c(new_n364_), .O(new_n450_));
  inv1   g368(.a(new_n334_), .O(new_n451_));
  nor3   g369(.a(new_n361_), .b(new_n451_), .c(new_n190_), .O(new_n452_));
  oai21  g370(.a(new_n452_), .b(new_n450_), .c(x15), .O(new_n453_));
  nor2   g371(.a(x29), .b(x28), .O(new_n454_));
  nor2   g372(.a(x31), .b(x30), .O(new_n455_));
  nand4  g373(.a(new_n455_), .b(new_n454_), .c(new_n391_), .d(new_n296_), .O(new_n456_));
  nand2  g374(.a(new_n456_), .b(new_n453_), .O(new_n457_));
  nand4  g375(.a(new_n457_), .b(new_n367_), .c(new_n244_), .d(new_n171_), .O(new_n458_));
  aoi21  g376(.a(new_n458_), .b(new_n243_), .c(new_n247_), .O(z09));
  aoi21  g377(.a(new_n78_), .b(new_n354_), .c(new_n92_), .O(new_n460_));
  oai21  g378(.a(new_n460_), .b(new_n199_), .c(new_n103_), .O(new_n461_));
  nand3  g379(.a(x35), .b(new_n349_), .c(x24), .O(new_n462_));
  aoi21  g380(.a(new_n461_), .b(new_n434_), .c(new_n462_), .O(new_n463_));
  inv1   g381(.a(new_n412_), .O(new_n464_));
  nor2   g382(.a(new_n464_), .b(new_n351_), .O(new_n465_));
  nand4  g383(.a(x22), .b(x21), .c(x15), .d(new_n171_), .O(new_n466_));
  nor2   g384(.a(x25), .b(x20), .O(new_n467_));
  nor3   g385(.a(new_n467_), .b(new_n466_), .c(new_n81_), .O(new_n468_));
  oai21  g386(.a(new_n465_), .b(new_n463_), .c(new_n468_), .O(new_n469_));
  nand2  g387(.a(new_n464_), .b(new_n90_), .O(new_n470_));
  nand3  g388(.a(new_n470_), .b(new_n350_), .c(new_n103_), .O(new_n471_));
  nand4  g389(.a(new_n77_), .b(x33), .c(new_n244_), .d(new_n243_), .O(new_n472_));
  aoi21  g390(.a(new_n471_), .b(new_n469_), .c(new_n472_), .O(z10));
  nand3  g391(.a(new_n103_), .b(x04), .c(x00), .O(new_n482_));
  nand3  g392(.a(new_n197_), .b(x37), .c(new_n101_), .O(new_n483_));
  oai21  g393(.a(new_n482_), .b(new_n121_), .c(new_n483_), .O(new_n484_));
  inv1   g394(.a(new_n97_), .O(new_n485_));
  nor4   g395(.a(new_n485_), .b(x36), .c(new_n349_), .d(x03), .O(new_n486_));
  nand2  g396(.a(new_n241_), .b(x37), .O(new_n487_));
  nor2   g397(.a(new_n487_), .b(new_n198_), .O(new_n488_));
  aoi21  g398(.a(new_n486_), .b(new_n484_), .c(new_n488_), .O(new_n489_));
  nor2   g399(.a(x39), .b(x06), .O(new_n490_));
  nor3   g400(.a(new_n490_), .b(new_n103_), .c(new_n77_), .O(new_n491_));
  aoi21  g401(.a(new_n210_), .b(new_n77_), .c(new_n491_), .O(new_n492_));
  nand2  g402(.a(new_n206_), .b(x40), .O(new_n493_));
  oai22  g403(.a(new_n493_), .b(new_n492_), .c(new_n489_), .d(x35), .O(new_n494_));
  nand2  g404(.a(new_n494_), .b(new_n136_), .O(new_n495_));
  nand3  g405(.a(new_n350_), .b(x37), .c(new_n77_), .O(new_n496_));
  nand3  g406(.a(new_n206_), .b(new_n103_), .c(x36), .O(new_n497_));
  nand3  g407(.a(x40), .b(x39), .c(x06), .O(new_n498_));
  aoi21  g408(.a(new_n497_), .b(new_n496_), .c(new_n498_), .O(new_n499_));
  nand4  g409(.a(new_n203_), .b(new_n106_), .c(new_n97_), .d(x36), .O(new_n500_));
  nand3  g410(.a(new_n197_), .b(new_n103_), .c(new_n77_), .O(new_n501_));
  aoi21  g411(.a(new_n501_), .b(new_n500_), .c(new_n207_), .O(new_n502_));
  oai21  g412(.a(new_n502_), .b(new_n499_), .c(x38), .O(new_n503_));
  aoi21  g413(.a(new_n503_), .b(new_n495_), .c(new_n245_), .O(z19));
  nor2   g414(.a(new_n113_), .b(new_n110_), .O(new_n508_));
  nand2  g415(.a(new_n88_), .b(new_n103_), .O(new_n509_));
  nand2  g416(.a(new_n509_), .b(new_n90_), .O(new_n510_));
  nand2  g417(.a(new_n510_), .b(x40), .O(new_n511_));
  nand2  g418(.a(new_n511_), .b(new_n100_), .O(new_n512_));
  oai21  g419(.a(new_n512_), .b(new_n508_), .c(x34), .O(new_n513_));
  nand2  g420(.a(new_n127_), .b(new_n120_), .O(new_n514_));
  nand2  g421(.a(new_n292_), .b(new_n123_), .O(new_n515_));
  aoi21  g422(.a(new_n515_), .b(new_n514_), .c(new_n83_), .O(new_n516_));
  nor2   g423(.a(new_n162_), .b(new_n92_), .O(new_n517_));
  oai21  g424(.a(new_n517_), .b(new_n516_), .c(new_n116_), .O(new_n518_));
  nand3  g425(.a(new_n268_), .b(new_n136_), .c(x13), .O(new_n519_));
  nand2  g426(.a(new_n519_), .b(new_n518_), .O(new_n520_));
  oai21  g427(.a(new_n520_), .b(new_n140_), .c(new_n168_), .O(new_n521_));
  aoi21  g428(.a(new_n521_), .b(new_n513_), .c(x07), .O(new_n522_));
  inv1   g429(.a(new_n307_), .O(new_n523_));
  nand2  g430(.a(new_n88_), .b(new_n349_), .O(new_n524_));
  aoi21  g431(.a(new_n524_), .b(new_n288_), .c(x37), .O(new_n525_));
  oai21  g432(.a(new_n525_), .b(new_n523_), .c(new_n85_), .O(new_n526_));
  inv1   g433(.a(new_n264_), .O(new_n527_));
  nand2  g434(.a(new_n527_), .b(x15), .O(new_n528_));
  aoi21  g435(.a(new_n528_), .b(new_n327_), .c(x37), .O(new_n529_));
  nor2   g436(.a(new_n94_), .b(new_n327_), .O(new_n530_));
  oai21  g437(.a(new_n530_), .b(new_n529_), .c(new_n349_), .O(new_n531_));
  nand2  g438(.a(new_n531_), .b(new_n526_), .O(new_n532_));
  nand2  g439(.a(new_n532_), .b(new_n171_), .O(new_n533_));
  aoi21  g440(.a(new_n78_), .b(new_n87_), .c(new_n153_), .O(new_n534_));
  nand4  g441(.a(new_n312_), .b(new_n121_), .c(new_n103_), .d(new_n101_), .O(new_n535_));
  aoi21  g442(.a(new_n535_), .b(x40), .c(new_n136_), .O(new_n536_));
  oai21  g443(.a(new_n536_), .b(new_n534_), .c(x34), .O(new_n537_));
  nand2  g444(.a(new_n537_), .b(new_n533_), .O(new_n538_));
  oai21  g445(.a(new_n538_), .b(new_n522_), .c(new_n205_), .O(new_n539_));
  nand2  g446(.a(new_n243_), .b(x00), .O(new_n540_));
  aoi21  g447(.a(new_n540_), .b(x39), .c(new_n117_), .O(new_n541_));
  oai21  g448(.a(new_n541_), .b(new_n88_), .c(x35), .O(new_n542_));
  aoi21  g449(.a(new_n542_), .b(new_n102_), .c(new_n103_), .O(new_n543_));
  oai21  g450(.a(new_n92_), .b(x37), .c(new_n102_), .O(new_n544_));
  oai21  g451(.a(new_n235_), .b(new_n205_), .c(new_n90_), .O(new_n545_));
  aoi21  g452(.a(new_n544_), .b(new_n309_), .c(new_n545_), .O(new_n546_));
  oai22  g453(.a(new_n546_), .b(new_n78_), .c(new_n303_), .d(new_n92_), .O(new_n547_));
  oai21  g454(.a(new_n547_), .b(new_n543_), .c(new_n349_), .O(new_n548_));
  aoi21  g455(.a(new_n548_), .b(new_n539_), .c(x36), .O(new_n549_));
  inv1   g456(.a(new_n291_), .O(new_n550_));
  nand2  g457(.a(new_n112_), .b(x38), .O(new_n551_));
  oai21  g458(.a(new_n551_), .b(new_n215_), .c(new_n390_), .O(new_n552_));
  nor2   g459(.a(new_n103_), .b(x07), .O(new_n553_));
  aoi22  g460(.a(new_n553_), .b(new_n552_), .c(new_n550_), .d(new_n210_), .O(new_n554_));
  aoi21  g461(.a(x38), .b(new_n111_), .c(new_n78_), .O(new_n555_));
  inv1   g462(.a(new_n228_), .O(new_n556_));
  nand3  g463(.a(new_n235_), .b(new_n556_), .c(new_n117_), .O(new_n557_));
  oai21  g464(.a(new_n557_), .b(new_n555_), .c(new_n205_), .O(new_n558_));
  oai21  g465(.a(new_n554_), .b(new_n205_), .c(new_n558_), .O(new_n559_));
  nand2  g466(.a(new_n78_), .b(x38), .O(new_n560_));
  aoi22  g467(.a(new_n560_), .b(new_n103_), .c(new_n221_), .d(x00), .O(new_n561_));
  nand2  g468(.a(new_n87_), .b(x35), .O(new_n562_));
  nand2  g469(.a(x37), .b(new_n171_), .O(new_n563_));
  oai22  g470(.a(new_n563_), .b(new_n390_), .c(new_n562_), .d(new_n561_), .O(new_n564_));
  aoi21  g471(.a(new_n559_), .b(x36), .c(new_n564_), .O(new_n565_));
  nand3  g472(.a(new_n103_), .b(new_n77_), .c(new_n205_), .O(new_n566_));
  nand2  g473(.a(new_n392_), .b(x38), .O(new_n567_));
  nand2  g474(.a(new_n567_), .b(new_n566_), .O(new_n568_));
  nand2  g475(.a(new_n568_), .b(new_n111_), .O(new_n569_));
  nand2  g476(.a(new_n78_), .b(x36), .O(new_n570_));
  nand3  g477(.a(new_n570_), .b(new_n205_), .c(new_n349_), .O(new_n571_));
  nand2  g478(.a(new_n571_), .b(new_n569_), .O(new_n572_));
  nand2  g479(.a(new_n197_), .b(new_n109_), .O(new_n573_));
  nor3   g480(.a(new_n573_), .b(new_n351_), .c(new_n77_), .O(new_n574_));
  aoi21  g481(.a(new_n572_), .b(x05), .c(new_n574_), .O(new_n575_));
  oai21  g482(.a(new_n565_), .b(x34), .c(new_n575_), .O(new_n576_));
  oai21  g483(.a(new_n576_), .b(new_n549_), .c(new_n244_), .O(new_n577_));
  aoi21  g484(.a(new_n577_), .b(new_n243_), .c(new_n247_), .O(z23));
  nor3   g485(.a(new_n81_), .b(new_n341_), .c(new_n80_), .O(new_n584_));
  nand4  g486(.a(new_n584_), .b(new_n300_), .c(new_n269_), .d(new_n176_), .O(new_n585_));
  nand4  g487(.a(new_n334_), .b(new_n160_), .c(new_n152_), .d(x39), .O(new_n586_));
  aoi21  g488(.a(new_n586_), .b(new_n585_), .c(x40), .O(new_n587_));
  nor4   g489(.a(new_n451_), .b(new_n159_), .c(new_n90_), .d(new_n78_), .O(new_n588_));
  oai21  g490(.a(new_n588_), .b(new_n587_), .c(new_n349_), .O(new_n589_));
  nand2  g491(.a(new_n256_), .b(new_n176_), .O(new_n590_));
  inv1   g492(.a(new_n590_), .O(new_n591_));
  nand4  g493(.a(new_n591_), .b(new_n350_), .c(new_n271_), .d(new_n88_), .O(new_n592_));
  nand2  g494(.a(new_n592_), .b(new_n589_), .O(new_n593_));
  nand3  g495(.a(new_n593_), .b(new_n77_), .c(new_n171_), .O(new_n594_));
  nand4  g496(.a(new_n206_), .b(new_n152_), .c(new_n104_), .d(x36), .O(new_n595_));
  aoi21  g497(.a(new_n595_), .b(new_n594_), .c(new_n245_), .O(z29));
  zero   g498(.O(z02));
  zero   g499(.O(z04));
  zero   g500(.O(z05));
  zero   g501(.O(z06));
