// Benchmark "FAU" written by ABC on Thu Jun 25 01:33:40 2020
...
module FAU ( 
  ...
  nor2   g400(.a(new_n339_), .b(new_n338_), .O(new_n490_));
  aoi21  g401(.a(new_n156_), .b(new_n153_), .c(x39), .O(new_n491_));
  oai21  g402(.a(new_n491_), .b(new_n490_), .c(new_n325_), .O(new_n492_));
  aoi21  g403(.a(new_n492_), .b(new_n336_), .c(new_n78_), .O(new_n493_));
  nor2   g404(.a(new_n329_), .b(new_n328_), .O(new_n494_));
  nand3  g405(.a(new_n346_), .b(new_n77_), .c(new_n113_), .O(new_n495_));
  oai21  g406(.a(new_n495_), .b(new_n494_), .c(new_n343_), .O(new_n496_));
  oai21  g407(.a(new_n496_), .b(new_n493_), .c(x38), .O(new_n497_));
  nand3  g408(.a(new_n351_), .b(new_n122_), .c(x15), .O(new_n498_));
  inv1   g409(.a(new_n150_), .O(new_n499_));
  nand2  g410(.a(new_n157_), .b(new_n499_), .O(new_n500_));
  nand2  g411(.a(new_n500_), .b(new_n498_), .O(new_n501_));
  nand2  g412(.a(new_n501_), .b(new_n325_), .O(new_n502_));
  aoi21  g413(.a(new_n502_), .b(new_n497_), .c(x35), .O(new_n503_));
  oai21  g414(.a(new_n357_), .b(new_n356_), .c(x00), .O(new_n504_));
  aoi21  g415(.a(new_n504_), .b(new_n474_), .c(new_n77_), .O(new_n505_));
  nand4  g416(.a(new_n363_), .b(new_n362_), .c(new_n98_), .d(new_n77_), .O(new_n506_));
  inv1   g417(.a(new_n506_), .O(new_n507_));
  oai21  g418(.a(new_n507_), .b(new_n505_), .c(x37), .O(new_n508_));
  nor2   g419(.a(new_n193_), .b(x24), .O(new_n509_));
  nand2  g420(.a(new_n125_), .b(new_n175_), .O(new_n510_));
  nand3  g421(.a(new_n198_), .b(new_n185_), .c(new_n171_), .O(new_n511_));
  aoi21  g422(.a(new_n511_), .b(new_n510_), .c(x37), .O(new_n512_));
  oai21  g423(.a(new_n512_), .b(new_n509_), .c(new_n377_), .O(new_n513_));
  aoi21  g424(.a(new_n513_), .b(new_n508_), .c(new_n203_), .O(new_n514_));
  oai21  g425(.a(new_n514_), .b(new_n503_), .c(new_n240_), .O(new_n515_));
  nor2   g426(.a(new_n184_), .b(new_n418_), .O(new_n516_));
  nand4  g427(.a(new_n516_), .b(new_n398_), .c(new_n177_), .d(new_n176_), .O(new_n517_));
  inv1   g428(.a(new_n417_), .O(new_n518_));
  nand2  g429(.a(new_n518_), .b(new_n100_), .O(new_n519_));
  aoi21  g430(.a(new_n519_), .b(new_n517_), .c(new_n99_), .O(new_n520_));
  aoi21  g431(.a(new_n78_), .b(new_n418_), .c(new_n171_), .O(new_n521_));
  nor2   g432(.a(new_n521_), .b(new_n189_), .O(new_n522_));
  inv1   g433(.a(new_n363_), .O(new_n523_));
  nor3   g434(.a(new_n389_), .b(new_n523_), .c(new_n80_), .O(new_n524_));
  oai21  g435(.a(new_n522_), .b(new_n520_), .c(new_n524_), .O(new_n525_));
  aoi21  g436(.a(new_n525_), .b(new_n515_), .c(x34), .O(new_n526_));
  inv1   g437(.a(new_n442_), .O(new_n527_));
  inv1   g438(.a(new_n451_), .O(new_n528_));
  nand2  g439(.a(new_n528_), .b(new_n527_), .O(new_n529_));
  nor2   g440(.a(x35), .b(new_n478_), .O(new_n530_));
  nand2  g441(.a(new_n530_), .b(new_n77_), .O(new_n531_));
  aoi21  g442(.a(new_n529_), .b(new_n445_), .c(new_n531_), .O(new_n532_));
  oai21  g443(.a(new_n532_), .b(new_n526_), .c(new_n241_), .O(new_n533_));
  aoi21  g444(.a(new_n533_), .b(new_n240_), .c(new_n244_), .O(z17));
  nand3  g445(.a(new_n100_), .b(x04), .c(x00), .O(new_n536_));
  nand3  g446(.a(new_n196_), .b(x37), .c(new_n94_), .O(new_n537_));
  oai21  g447(.a(new_n536_), .b(new_n117_), .c(new_n537_), .O(new_n538_));
  inv1   g448(.a(new_n95_), .O(new_n539_));
  nor4   g449(.a(new_n539_), .b(x36), .c(new_n478_), .d(x03), .O(new_n540_));
  nand2  g450(.a(new_n238_), .b(x37), .O(new_n541_));
  nor2   g451(.a(new_n541_), .b(new_n197_), .O(new_n542_));
  aoi21  g452(.a(new_n540_), .b(new_n538_), .c(new_n542_), .O(new_n543_));
  nor2   g453(.a(x39), .b(x06), .O(new_n544_));
  nor3   g454(.a(new_n544_), .b(new_n100_), .c(new_n77_), .O(new_n545_));
  aoi21  g455(.a(new_n331_), .b(new_n77_), .c(new_n545_), .O(new_n546_));
  nand2  g456(.a(new_n204_), .b(x40), .O(new_n547_));
  oai22  g457(.a(new_n547_), .b(new_n546_), .c(new_n543_), .d(x35), .O(new_n548_));
  nand2  g458(.a(new_n548_), .b(new_n98_), .O(new_n549_));
  nand3  g459(.a(new_n530_), .b(x37), .c(new_n77_), .O(new_n550_));
  nand2  g460(.a(new_n319_), .b(new_n204_), .O(new_n551_));
  nand3  g461(.a(x40), .b(x39), .c(x06), .O(new_n552_));
  aoi21  g462(.a(new_n551_), .b(new_n550_), .c(new_n552_), .O(new_n553_));
  nand4  g463(.a(new_n335_), .b(new_n103_), .c(new_n95_), .d(x37), .O(new_n554_));
  nand3  g464(.a(new_n196_), .b(new_n100_), .c(new_n77_), .O(new_n555_));
  aoi21  g465(.a(new_n555_), .b(new_n554_), .c(new_n205_), .O(new_n556_));
  oai21  g466(.a(new_n556_), .b(new_n553_), .c(x38), .O(new_n557_));
  aoi21  g467(.a(new_n557_), .b(new_n549_), .c(new_n242_), .O(z19));
  nor2   g468(.a(new_n110_), .b(new_n107_), .O(new_n562_));
  nand2  g469(.a(new_n85_), .b(new_n100_), .O(new_n563_));
  nand2  g470(.a(new_n563_), .b(new_n87_), .O(new_n564_));
  nand2  g471(.a(new_n564_), .b(x40), .O(new_n565_));
  nand2  g472(.a(new_n565_), .b(new_n97_), .O(new_n566_));
  oai21  g473(.a(new_n566_), .b(new_n562_), .c(x34), .O(new_n567_));
  nand2  g474(.a(new_n125_), .b(new_n116_), .O(new_n568_));
  nand3  g475(.a(x40), .b(new_n98_), .c(new_n119_), .O(new_n569_));
  aoi21  g476(.a(new_n569_), .b(new_n568_), .c(new_n170_), .O(new_n570_));
  and2   g477(.a(new_n329_), .b(x38), .O(new_n571_));
  oai21  g478(.a(new_n571_), .b(new_n570_), .c(new_n113_), .O(new_n572_));
  nand3  g479(.a(new_n276_), .b(new_n98_), .c(x13), .O(new_n573_));
  nand2  g480(.a(new_n573_), .b(new_n572_), .O(new_n574_));
  oai21  g481(.a(new_n574_), .b(new_n136_), .c(new_n167_), .O(new_n575_));
  aoi21  g482(.a(new_n575_), .b(new_n567_), .c(x07), .O(new_n576_));
  inv1   g483(.a(new_n309_), .O(new_n577_));
  nand2  g484(.a(new_n85_), .b(new_n478_), .O(new_n578_));
  aoi21  g485(.a(new_n578_), .b(new_n291_), .c(x37), .O(new_n579_));
  oai21  g486(.a(new_n579_), .b(new_n577_), .c(new_n82_), .O(new_n580_));
  nand4  g487(.a(new_n264_), .b(new_n262_), .c(new_n252_), .d(x15), .O(new_n581_));
  aoi21  g488(.a(new_n581_), .b(new_n165_), .c(x37), .O(new_n582_));
  nor2   g489(.a(new_n90_), .b(new_n165_), .O(new_n583_));
  oai21  g490(.a(new_n583_), .b(new_n582_), .c(new_n478_), .O(new_n584_));
  nand2  g491(.a(new_n584_), .b(new_n580_), .O(new_n585_));
  nand2  g492(.a(new_n585_), .b(new_n164_), .O(new_n586_));
  inv1   g493(.a(new_n149_), .O(new_n587_));
  aoi21  g494(.a(new_n78_), .b(new_n84_), .c(new_n587_), .O(new_n588_));
  nand4  g495(.a(new_n314_), .b(new_n117_), .c(new_n100_), .d(new_n94_), .O(new_n589_));
  aoi21  g496(.a(new_n589_), .b(x40), .c(new_n98_), .O(new_n590_));
  oai21  g497(.a(new_n590_), .b(new_n588_), .c(x34), .O(new_n591_));
  nand2  g498(.a(new_n591_), .b(new_n586_), .O(new_n592_));
  oai21  g499(.a(new_n592_), .b(new_n576_), .c(new_n203_), .O(new_n593_));
  oai21  g500(.a(new_n171_), .b(new_n240_), .c(new_n81_), .O(new_n594_));
  oai21  g501(.a(new_n130_), .b(new_n240_), .c(new_n170_), .O(new_n595_));
  aoi21  g502(.a(new_n595_), .b(new_n594_), .c(new_n203_), .O(new_n596_));
  nand2  g503(.a(new_n276_), .b(new_n130_), .O(new_n597_));
  inv1   g504(.a(new_n597_), .O(new_n598_));
  nor2   g505(.a(x37), .b(x05), .O(new_n599_));
  oai21  g506(.a(new_n598_), .b(new_n596_), .c(new_n599_), .O(new_n600_));
  nand4  g507(.a(new_n218_), .b(new_n78_), .c(new_n240_), .d(x00), .O(new_n601_));
  aoi21  g508(.a(new_n601_), .b(new_n600_), .c(new_n84_), .O(new_n602_));
  aoi21  g509(.a(new_n283_), .b(new_n78_), .c(x39), .O(new_n603_));
  oai21  g510(.a(new_n603_), .b(new_n602_), .c(x38), .O(new_n604_));
  aoi21  g511(.a(new_n598_), .b(new_n164_), .c(x37), .O(new_n605_));
  oai22  g512(.a(new_n605_), .b(x39), .c(new_n232_), .d(new_n203_), .O(new_n606_));
  nand2  g513(.a(new_n606_), .b(new_n98_), .O(new_n607_));
  nand2  g514(.a(new_n218_), .b(new_n117_), .O(new_n608_));
  nand3  g515(.a(new_n608_), .b(new_n607_), .c(new_n604_), .O(new_n609_));
  nand2  g516(.a(new_n609_), .b(new_n478_), .O(new_n610_));
  aoi21  g517(.a(new_n610_), .b(new_n593_), .c(x36), .O(new_n611_));
  inv1   g518(.a(new_n296_), .O(new_n612_));
  nand2  g519(.a(new_n109_), .b(x38), .O(new_n613_));
  oai21  g520(.a(new_n613_), .b(new_n211_), .c(new_n474_), .O(new_n614_));
  nor2   g521(.a(new_n100_), .b(x07), .O(new_n615_));
  aoi22  g522(.a(new_n615_), .b(new_n614_), .c(new_n612_), .d(new_n331_), .O(new_n616_));
  aoi21  g523(.a(x38), .b(new_n108_), .c(new_n78_), .O(new_n617_));
  inv1   g524(.a(new_n225_), .O(new_n618_));
  nand3  g525(.a(new_n232_), .b(new_n618_), .c(new_n446_), .O(new_n619_));
  oai21  g526(.a(new_n619_), .b(new_n617_), .c(new_n203_), .O(new_n620_));
  oai21  g527(.a(new_n616_), .b(new_n203_), .c(new_n620_), .O(new_n621_));
  aoi21  g528(.a(new_n78_), .b(x38), .c(x37), .O(new_n622_));
  aoi21  g529(.a(new_n220_), .b(x00), .c(new_n622_), .O(new_n623_));
  nand2  g530(.a(new_n84_), .b(x35), .O(new_n624_));
  nand2  g531(.a(x37), .b(new_n164_), .O(new_n625_));
  oai22  g532(.a(new_n625_), .b(new_n474_), .c(new_n624_), .d(new_n623_), .O(new_n626_));
  aoi21  g533(.a(new_n621_), .b(x36), .c(new_n626_), .O(new_n627_));
  nand3  g534(.a(new_n100_), .b(new_n77_), .c(new_n203_), .O(new_n628_));
  nand3  g535(.a(x38), .b(x37), .c(new_n478_), .O(new_n629_));
  nand2  g536(.a(new_n629_), .b(new_n628_), .O(new_n630_));
  nand2  g537(.a(new_n630_), .b(new_n108_), .O(new_n631_));
  aoi21  g538(.a(new_n78_), .b(x36), .c(x35), .O(new_n632_));
  nor2   g539(.a(new_n89_), .b(x36), .O(new_n633_));
  oai21  g540(.a(new_n633_), .b(new_n632_), .c(new_n478_), .O(new_n634_));
  nand2  g541(.a(new_n634_), .b(new_n631_), .O(new_n635_));
  nand2  g542(.a(new_n530_), .b(x36), .O(new_n636_));
  nand2  g543(.a(new_n196_), .b(new_n106_), .O(new_n637_));
  nor2   g544(.a(new_n637_), .b(new_n636_), .O(new_n638_));
  aoi21  g545(.a(new_n635_), .b(x05), .c(new_n638_), .O(new_n639_));
  oai21  g546(.a(new_n627_), .b(x34), .c(new_n639_), .O(new_n640_));
  oai21  g547(.a(new_n640_), .b(new_n611_), .c(new_n241_), .O(new_n641_));
  aoi21  g548(.a(new_n641_), .b(new_n240_), .c(new_n244_), .O(z23));
  nor3   g549(.a(new_n80_), .b(new_n184_), .c(new_n79_), .O(new_n648_));
  nand4  g550(.a(new_n648_), .b(new_n295_), .c(new_n270_), .d(new_n176_), .O(new_n649_));
  nand3  g551(.a(new_n441_), .b(new_n394_), .c(new_n157_), .O(new_n650_));
  aoi21  g552(.a(new_n650_), .b(new_n649_), .c(x40), .O(new_n651_));
  inv1   g553(.a(new_n157_), .O(new_n652_));
  inv1   g554(.a(new_n394_), .O(new_n653_));
  nor4   g555(.a(new_n653_), .b(new_n652_), .c(new_n87_), .d(new_n78_), .O(new_n654_));
  oai21  g556(.a(new_n654_), .b(new_n651_), .c(new_n478_), .O(new_n655_));
  nor3   g557(.a(x35), .b(new_n478_), .c(new_n175_), .O(new_n656_));
  nand4  g558(.a(new_n656_), .b(new_n527_), .c(new_n171_), .d(x15), .O(new_n657_));
  nand2  g559(.a(new_n657_), .b(new_n655_), .O(new_n658_));
  nand3  g560(.a(new_n658_), .b(new_n77_), .c(new_n164_), .O(new_n659_));
  nand3  g561(.a(new_n204_), .b(new_n499_), .c(x36), .O(new_n660_));
  aoi21  g562(.a(new_n660_), .b(new_n659_), .c(new_n242_), .O(z29));
  zero   g563(.O(z02));
  zero   g564(.O(z04));
  zero   g565(.O(z05));
  zero   g566(.O(z06));
