// Benchmark "FAU" written by ABC on Thu Jun 25 01:38:33 2020
...
module FAU ( 
  ...
  nor2   g376(.a(new_n246_), .b(new_n242_), .O(z15));
  nand3  g377(.a(new_n78_), .b(x04), .c(x00), .O(new_n468_));
  nand3  g378(.a(new_n192_), .b(x37), .c(new_n210_), .O(new_n469_));
  oai21  g379(.a(new_n468_), .b(new_n81_), .c(new_n469_), .O(new_n470_));
  inv1   g380(.a(new_n105_), .O(new_n471_));
  nor4   g381(.a(new_n471_), .b(x36), .c(new_n350_), .d(x03), .O(new_n472_));
  nand2  g382(.a(new_n240_), .b(x37), .O(new_n473_));
  nor2   g383(.a(new_n473_), .b(new_n193_), .O(new_n474_));
  aoi21  g384(.a(new_n472_), .b(new_n470_), .c(new_n474_), .O(new_n475_));
  nor2   g385(.a(x39), .b(x06), .O(new_n476_));
  nor3   g386(.a(new_n476_), .b(new_n78_), .c(new_n77_), .O(new_n477_));
  aoi21  g387(.a(new_n205_), .b(new_n77_), .c(new_n477_), .O(new_n478_));
  nand2  g388(.a(new_n201_), .b(x40), .O(new_n479_));
  oai22  g389(.a(new_n479_), .b(new_n478_), .c(new_n475_), .d(x35), .O(new_n480_));
  nand2  g390(.a(new_n480_), .b(new_n140_), .O(new_n481_));
  nand3  g391(.a(new_n351_), .b(x37), .c(new_n77_), .O(new_n482_));
  nand2  g392(.a(new_n317_), .b(new_n201_), .O(new_n483_));
  nand3  g393(.a(x40), .b(x39), .c(x06), .O(new_n484_));
  aoi21  g394(.a(new_n483_), .b(new_n482_), .c(new_n484_), .O(new_n485_));
  nand4  g395(.a(new_n215_), .b(new_n198_), .c(new_n105_), .d(x36), .O(new_n486_));
  nor2   g396(.a(x37), .b(x36), .O(new_n487_));
  nand2  g397(.a(new_n487_), .b(new_n192_), .O(new_n488_));
  aoi21  g398(.a(new_n488_), .b(new_n486_), .c(new_n202_), .O(new_n489_));
  oai21  g399(.a(new_n489_), .b(new_n485_), .c(x38), .O(new_n490_));
  aoi21  g400(.a(new_n490_), .b(new_n481_), .c(new_n244_), .O(z19));
  nand2  g401(.a(new_n140_), .b(new_n78_), .O(new_n495_));
  nor2   g402(.a(new_n495_), .b(new_n87_), .O(new_n496_));
  oai21  g403(.a(new_n496_), .b(new_n113_), .c(x34), .O(new_n497_));
  nand2  g404(.a(new_n125_), .b(new_n119_), .O(new_n498_));
  nand2  g405(.a(new_n293_), .b(new_n121_), .O(new_n499_));
  aoi21  g406(.a(new_n499_), .b(new_n498_), .c(new_n95_), .O(new_n500_));
  nor2   g407(.a(new_n158_), .b(new_n99_), .O(new_n501_));
  oai21  g408(.a(new_n501_), .b(new_n500_), .c(new_n115_), .O(new_n502_));
  nand3  g409(.a(new_n268_), .b(new_n140_), .c(x13), .O(new_n503_));
  nand2  g410(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  oai21  g411(.a(new_n504_), .b(new_n139_), .c(new_n164_), .O(new_n505_));
  aoi21  g412(.a(new_n505_), .b(new_n497_), .c(x07), .O(new_n506_));
  inv1   g413(.a(new_n305_), .O(new_n507_));
  nor2   g414(.a(new_n79_), .b(x38), .O(new_n508_));
  nand2  g415(.a(new_n508_), .b(new_n350_), .O(new_n509_));
  aoi21  g416(.a(new_n509_), .b(new_n288_), .c(x37), .O(new_n510_));
  oai21  g417(.a(new_n510_), .b(new_n507_), .c(new_n247_), .O(new_n511_));
  inv1   g418(.a(new_n264_), .O(new_n512_));
  nand2  g419(.a(new_n512_), .b(x15), .O(new_n513_));
  aoi21  g420(.a(new_n513_), .b(new_n328_), .c(x37), .O(new_n514_));
  nor2   g421(.a(new_n102_), .b(new_n328_), .O(new_n515_));
  oai21  g422(.a(new_n515_), .b(new_n514_), .c(new_n350_), .O(new_n516_));
  nand2  g423(.a(new_n516_), .b(new_n511_), .O(new_n517_));
  nand2  g424(.a(new_n517_), .b(new_n90_), .O(new_n518_));
  aoi21  g425(.a(new_n80_), .b(new_n79_), .c(new_n429_), .O(new_n519_));
  nand4  g426(.a(new_n312_), .b(new_n81_), .c(new_n78_), .d(new_n210_), .O(new_n520_));
  aoi21  g427(.a(new_n520_), .b(x40), .c(new_n140_), .O(new_n521_));
  oai21  g428(.a(new_n521_), .b(new_n519_), .c(x34), .O(new_n522_));
  nand2  g429(.a(new_n522_), .b(new_n518_), .O(new_n523_));
  oai21  g430(.a(new_n523_), .b(new_n506_), .c(new_n200_), .O(new_n524_));
  inv1   g431(.a(new_n102_), .O(new_n525_));
  nand2  g432(.a(new_n242_), .b(x00), .O(new_n526_));
  aoi21  g433(.a(new_n526_), .b(x39), .c(new_n116_), .O(new_n527_));
  oai21  g434(.a(new_n527_), .b(new_n508_), .c(x35), .O(new_n528_));
  aoi21  g435(.a(new_n528_), .b(new_n525_), .c(new_n78_), .O(new_n529_));
  nand2  g436(.a(new_n525_), .b(new_n101_), .O(new_n530_));
  nand2  g437(.a(new_n79_), .b(x38), .O(new_n531_));
  oai21  g438(.a(new_n234_), .b(new_n200_), .c(new_n531_), .O(new_n532_));
  aoi21  g439(.a(new_n530_), .b(new_n307_), .c(new_n532_), .O(new_n533_));
  nand2  g440(.a(new_n291_), .b(new_n125_), .O(new_n534_));
  oai21  g441(.a(new_n533_), .b(new_n80_), .c(new_n534_), .O(new_n535_));
  oai21  g442(.a(new_n535_), .b(new_n529_), .c(new_n350_), .O(new_n536_));
  aoi21  g443(.a(new_n536_), .b(new_n524_), .c(x36), .O(new_n537_));
  inv1   g444(.a(new_n292_), .O(new_n538_));
  nand2  g445(.a(new_n86_), .b(x38), .O(new_n539_));
  oai21  g446(.a(new_n539_), .b(new_n211_), .c(new_n391_), .O(new_n540_));
  nor2   g447(.a(new_n78_), .b(x07), .O(new_n541_));
  aoi22  g448(.a(new_n541_), .b(new_n540_), .c(new_n538_), .d(new_n205_), .O(new_n542_));
  aoi21  g449(.a(x38), .b(new_n85_), .c(new_n80_), .O(new_n543_));
  nand3  g450(.a(new_n234_), .b(new_n233_), .c(new_n116_), .O(new_n544_));
  oai21  g451(.a(new_n544_), .b(new_n543_), .c(new_n200_), .O(new_n545_));
  oai21  g452(.a(new_n542_), .b(new_n200_), .c(new_n545_), .O(new_n546_));
  nand2  g453(.a(new_n80_), .b(x38), .O(new_n547_));
  aoi22  g454(.a(new_n547_), .b(new_n78_), .c(new_n218_), .d(x00), .O(new_n548_));
  nand2  g455(.a(new_n79_), .b(x35), .O(new_n549_));
  nand2  g456(.a(x37), .b(new_n90_), .O(new_n550_));
  oai22  g457(.a(new_n550_), .b(new_n391_), .c(new_n549_), .d(new_n548_), .O(new_n551_));
  aoi21  g458(.a(new_n546_), .b(x36), .c(new_n551_), .O(new_n552_));
  nor3   g459(.a(x37), .b(x36), .c(x35), .O(new_n553_));
  nand2  g460(.a(x38), .b(x37), .O(new_n554_));
  nor2   g461(.a(new_n554_), .b(x34), .O(new_n555_));
  oai21  g462(.a(new_n555_), .b(new_n553_), .c(new_n85_), .O(new_n556_));
  nor2   g463(.a(x35), .b(x34), .O(new_n557_));
  oai21  g464(.a(x40), .b(new_n77_), .c(new_n557_), .O(new_n558_));
  nand2  g465(.a(new_n558_), .b(new_n556_), .O(new_n559_));
  nand2  g466(.a(new_n351_), .b(new_n317_), .O(new_n560_));
  inv1   g467(.a(new_n560_), .O(new_n561_));
  aoi22  g468(.a(new_n561_), .b(new_n194_), .c(new_n559_), .d(x05), .O(new_n562_));
  oai21  g469(.a(new_n552_), .b(x34), .c(new_n562_), .O(new_n563_));
  oai21  g470(.a(new_n563_), .b(new_n537_), .c(new_n243_), .O(new_n564_));
  aoi21  g471(.a(new_n564_), .b(new_n242_), .c(new_n246_), .O(z23));
  inv1   g472(.a(new_n83_), .O(new_n570_));
  nand2  g473(.a(new_n230_), .b(new_n140_), .O(new_n571_));
  nand2  g474(.a(new_n487_), .b(new_n351_), .O(new_n572_));
  nand2  g475(.a(new_n201_), .b(x36), .O(new_n573_));
  oai22  g476(.a(new_n573_), .b(new_n554_), .c(new_n572_), .d(new_n571_), .O(new_n574_));
  nand3  g477(.a(new_n574_), .b(new_n86_), .c(new_n570_), .O(new_n575_));
  inv1   g478(.a(new_n235_), .O(new_n576_));
  inv1   g479(.a(new_n288_), .O(new_n577_));
  nand4  g480(.a(new_n557_), .b(new_n317_), .c(new_n577_), .d(new_n576_), .O(new_n578_));
  aoi21  g481(.a(new_n578_), .b(new_n575_), .c(new_n244_), .O(z28));
  nor3   g482(.a(new_n93_), .b(new_n342_), .c(new_n92_), .O(new_n580_));
  nand4  g483(.a(new_n580_), .b(new_n291_), .c(new_n269_), .d(new_n171_), .O(new_n581_));
  nand4  g484(.a(new_n335_), .b(new_n157_), .c(new_n149_), .d(x39), .O(new_n582_));
  aoi21  g485(.a(new_n582_), .b(new_n581_), .c(x40), .O(new_n583_));
  nor4   g486(.a(new_n531_), .b(new_n450_), .c(new_n156_), .d(new_n80_), .O(new_n584_));
  oai21  g487(.a(new_n584_), .b(new_n583_), .c(new_n350_), .O(new_n585_));
  nand2  g488(.a(new_n256_), .b(new_n171_), .O(new_n586_));
  inv1   g489(.a(new_n586_), .O(new_n587_));
  nand4  g490(.a(new_n587_), .b(new_n508_), .c(new_n351_), .d(new_n271_), .O(new_n588_));
  nand2  g491(.a(new_n588_), .b(new_n585_), .O(new_n589_));
  nand3  g492(.a(new_n589_), .b(new_n77_), .c(new_n90_), .O(new_n590_));
  or2    g493(.a(new_n573_), .b(new_n150_), .O(new_n591_));
  aoi21  g494(.a(new_n591_), .b(new_n590_), .c(new_n244_), .O(z29));
  zero   g495(.O(z02));
  zero   g496(.O(z04));
  zero   g497(.O(z05));
  zero   g498(.O(z06));
