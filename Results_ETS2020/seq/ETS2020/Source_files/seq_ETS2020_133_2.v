// Benchmark "FAU" written by ABC on Thu Jun 25 01:33:45 2020
...
module FAU ( 
  ...
  nor2   g255(.a(new_n228_), .b(new_n224_), .O(z15));
  nand3  g256(.a(new_n83_), .b(x04), .c(x00), .O(new_n348_));
  nand3  g257(.a(new_n172_), .b(x37), .c(new_n79_), .O(new_n349_));
  oai21  g258(.a(new_n348_), .b(new_n118_), .c(new_n349_), .O(new_n350_));
  inv1   g259(.a(new_n80_), .O(new_n351_));
  nor4   g260(.a(new_n351_), .b(x36), .c(new_n182_), .d(x03), .O(new_n352_));
  nor3   g261(.a(new_n221_), .b(new_n173_), .c(new_n83_), .O(new_n353_));
  aoi21  g262(.a(new_n352_), .b(new_n350_), .c(new_n353_), .O(new_n354_));
  nor2   g263(.a(x39), .b(x06), .O(new_n355_));
  nor3   g264(.a(new_n355_), .b(new_n83_), .c(new_n77_), .O(new_n356_));
  aoi21  g265(.a(new_n163_), .b(new_n77_), .c(new_n356_), .O(new_n357_));
  nor2   g266(.a(new_n183_), .b(x34), .O(new_n358_));
  nand2  g267(.a(new_n358_), .b(x40), .O(new_n359_));
  oai22  g268(.a(new_n359_), .b(new_n357_), .c(new_n354_), .d(x35), .O(new_n360_));
  nand2  g269(.a(new_n360_), .b(new_n87_), .O(new_n361_));
  nor2   g270(.a(x35), .b(new_n182_), .O(new_n362_));
  nand2  g271(.a(new_n362_), .b(new_n198_), .O(new_n363_));
  nand3  g272(.a(new_n358_), .b(new_n83_), .c(x36), .O(new_n364_));
  nand3  g273(.a(x40), .b(x39), .c(x06), .O(new_n365_));
  aoi21  g274(.a(new_n364_), .b(new_n363_), .c(new_n365_), .O(new_n366_));
  inv1   g275(.a(new_n358_), .O(new_n367_));
  inv1   g276(.a(x00), .O(new_n368_));
  nor2   g277(.a(new_n77_), .b(new_n368_), .O(new_n369_));
  nand4  g278(.a(new_n369_), .b(new_n191_), .c(new_n80_), .d(x37), .O(new_n370_));
  nand3  g279(.a(new_n172_), .b(new_n83_), .c(new_n77_), .O(new_n371_));
  aoi21  g280(.a(new_n371_), .b(new_n370_), .c(new_n367_), .O(new_n372_));
  oai21  g281(.a(new_n372_), .b(new_n366_), .c(x38), .O(new_n373_));
  aoi21  g282(.a(new_n373_), .b(new_n361_), .c(new_n226_), .O(z19));
  inv1   g283(.a(x05), .O(new_n378_));
  inv1   g284(.a(new_n298_), .O(new_n379_));
  nand2  g285(.a(new_n98_), .b(new_n182_), .O(new_n380_));
  aoi21  g286(.a(new_n380_), .b(new_n278_), .c(x37), .O(new_n381_));
  oai21  g287(.a(new_n381_), .b(new_n379_), .c(new_n96_), .O(new_n382_));
  nand4  g288(.a(new_n251_), .b(new_n249_), .c(new_n238_), .d(x15), .O(new_n383_));
  aoi21  g289(.a(new_n383_), .b(new_n233_), .c(x37), .O(new_n384_));
  nor2   g290(.a(new_n90_), .b(new_n233_), .O(new_n385_));
  oai21  g291(.a(new_n385_), .b(new_n384_), .c(new_n182_), .O(new_n386_));
  nand2  g292(.a(new_n386_), .b(new_n382_), .O(new_n387_));
  nand2  g293(.a(new_n387_), .b(new_n378_), .O(new_n388_));
  nor2   g294(.a(x01), .b(new_n368_), .O(new_n389_));
  aoi21  g295(.a(new_n389_), .b(new_n188_), .c(new_n118_), .O(new_n390_));
  nand2  g296(.a(new_n85_), .b(new_n81_), .O(new_n391_));
  oai21  g297(.a(new_n390_), .b(x38), .c(new_n391_), .O(new_n392_));
  nand2  g298(.a(new_n392_), .b(x34), .O(new_n393_));
  oai21  g299(.a(new_n125_), .b(new_n121_), .c(new_n145_), .O(new_n394_));
  aoi21  g300(.a(new_n394_), .b(new_n393_), .c(x37), .O(new_n395_));
  nand3  g301(.a(x39), .b(x38), .c(new_n111_), .O(new_n396_));
  nand3  g302(.a(x40), .b(new_n87_), .c(new_n106_), .O(new_n397_));
  aoi21  g303(.a(new_n397_), .b(new_n396_), .c(new_n94_), .O(new_n398_));
  nor2   g304(.a(new_n139_), .b(new_n84_), .O(new_n399_));
  oai21  g305(.a(new_n399_), .b(new_n398_), .c(new_n105_), .O(new_n400_));
  nand3  g306(.a(new_n263_), .b(new_n87_), .c(x13), .O(new_n401_));
  nand2  g307(.a(new_n401_), .b(new_n400_), .O(new_n402_));
  nand2  g308(.a(new_n402_), .b(new_n145_), .O(new_n403_));
  inv1   g309(.a(new_n291_), .O(new_n404_));
  and2   g310(.a(new_n130_), .b(new_n81_), .O(new_n405_));
  nor2   g311(.a(x39), .b(new_n182_), .O(new_n406_));
  oai21  g312(.a(new_n405_), .b(new_n404_), .c(new_n406_), .O(new_n407_));
  nand2  g313(.a(new_n407_), .b(new_n403_), .O(new_n408_));
  oai21  g314(.a(new_n408_), .b(new_n395_), .c(new_n224_), .O(new_n409_));
  nand2  g315(.a(new_n98_), .b(x34), .O(new_n410_));
  aoi21  g316(.a(new_n410_), .b(new_n167_), .c(new_n83_), .O(new_n411_));
  nand2  g317(.a(new_n80_), .b(new_n78_), .O(new_n412_));
  nand3  g318(.a(new_n118_), .b(new_n83_), .c(new_n79_), .O(new_n413_));
  oai21  g319(.a(new_n413_), .b(new_n412_), .c(x40), .O(new_n414_));
  nor2   g320(.a(new_n87_), .b(new_n182_), .O(new_n415_));
  aoi21  g321(.a(new_n415_), .b(new_n414_), .c(new_n411_), .O(new_n416_));
  nand3  g322(.a(new_n416_), .b(new_n409_), .c(new_n388_), .O(new_n417_));
  oai21  g323(.a(x07), .b(new_n368_), .c(x39), .O(new_n418_));
  nand3  g324(.a(new_n418_), .b(new_n93_), .c(x38), .O(new_n419_));
  aoi21  g325(.a(new_n419_), .b(new_n214_), .c(new_n183_), .O(new_n420_));
  oai21  g326(.a(new_n420_), .b(new_n194_), .c(x37), .O(new_n421_));
  inv1   g327(.a(new_n128_), .O(new_n422_));
  nand2  g328(.a(new_n89_), .b(new_n86_), .O(new_n423_));
  nand2  g329(.a(new_n300_), .b(new_n263_), .O(new_n424_));
  nand2  g330(.a(new_n424_), .b(new_n183_), .O(new_n425_));
  aoi21  g331(.a(new_n425_), .b(new_n423_), .c(new_n422_), .O(new_n426_));
  aoi21  g332(.a(new_n426_), .b(new_n421_), .c(x34), .O(new_n427_));
  aoi21  g333(.a(new_n417_), .b(new_n183_), .c(new_n427_), .O(new_n428_));
  nand3  g334(.a(new_n389_), .b(new_n281_), .c(new_n188_), .O(new_n429_));
  nand3  g335(.a(new_n207_), .b(new_n90_), .c(new_n83_), .O(new_n430_));
  nand2  g336(.a(new_n430_), .b(new_n429_), .O(new_n431_));
  aoi21  g337(.a(new_n431_), .b(new_n224_), .c(new_n294_), .O(new_n432_));
  aoi21  g338(.a(x39), .b(x37), .c(new_n93_), .O(new_n433_));
  nor2   g339(.a(new_n433_), .b(new_n87_), .O(new_n434_));
  oai21  g340(.a(new_n87_), .b(x00), .c(x40), .O(new_n435_));
  nand2  g341(.a(new_n435_), .b(new_n208_), .O(new_n436_));
  oai21  g342(.a(new_n436_), .b(new_n434_), .c(new_n183_), .O(new_n437_));
  oai21  g343(.a(new_n432_), .b(new_n183_), .c(new_n437_), .O(new_n438_));
  nand2  g344(.a(new_n438_), .b(x36), .O(new_n439_));
  inv1   g345(.a(new_n131_), .O(new_n440_));
  nand2  g346(.a(new_n194_), .b(x00), .O(new_n441_));
  oai21  g347(.a(new_n291_), .b(x37), .c(new_n441_), .O(new_n442_));
  nor2   g348(.a(x39), .b(new_n183_), .O(new_n443_));
  aoi21  g349(.a(new_n443_), .b(new_n442_), .c(new_n440_), .O(new_n444_));
  nand2  g350(.a(new_n444_), .b(new_n439_), .O(new_n445_));
  nand3  g351(.a(new_n83_), .b(new_n77_), .c(new_n183_), .O(new_n446_));
  nand2  g352(.a(new_n281_), .b(new_n182_), .O(new_n447_));
  aoi21  g353(.a(new_n447_), .b(new_n446_), .c(x00), .O(new_n448_));
  nand2  g354(.a(new_n183_), .b(new_n182_), .O(new_n449_));
  aoi21  g355(.a(new_n93_), .b(x36), .c(new_n449_), .O(new_n450_));
  oai21  g356(.a(new_n450_), .b(new_n448_), .c(x05), .O(new_n451_));
  nand4  g357(.a(new_n362_), .b(new_n204_), .c(new_n172_), .d(x36), .O(new_n452_));
  nand2  g358(.a(new_n452_), .b(new_n451_), .O(new_n453_));
  aoi21  g359(.a(new_n445_), .b(new_n182_), .c(new_n453_), .O(new_n454_));
  oai21  g360(.a(new_n428_), .b(x36), .c(new_n454_), .O(new_n455_));
  nand2  g361(.a(new_n455_), .b(new_n225_), .O(new_n456_));
  aoi21  g362(.a(new_n456_), .b(new_n224_), .c(new_n228_), .O(z23));
  nor3   g363(.a(new_n107_), .b(new_n169_), .c(new_n239_), .O(new_n463_));
  nand4  g364(.a(new_n463_), .b(new_n288_), .c(new_n256_), .d(new_n153_), .O(new_n464_));
  nand4  g365(.a(new_n321_), .b(new_n138_), .c(new_n130_), .d(x39), .O(new_n465_));
  aoi21  g366(.a(new_n465_), .b(new_n464_), .c(x40), .O(new_n466_));
  inv1   g367(.a(new_n138_), .O(new_n467_));
  inv1   g368(.a(new_n321_), .O(new_n468_));
  nor4   g369(.a(new_n468_), .b(new_n467_), .c(new_n100_), .d(new_n93_), .O(new_n469_));
  oai21  g370(.a(new_n469_), .b(new_n466_), .c(new_n182_), .O(new_n470_));
  nand2  g371(.a(new_n240_), .b(new_n153_), .O(new_n471_));
  inv1   g372(.a(new_n471_), .O(new_n472_));
  nand4  g373(.a(new_n472_), .b(new_n362_), .c(new_n258_), .d(new_n98_), .O(new_n473_));
  nand2  g374(.a(new_n473_), .b(new_n470_), .O(new_n474_));
  nand3  g375(.a(new_n474_), .b(new_n77_), .c(new_n378_), .O(new_n475_));
  nand3  g376(.a(new_n358_), .b(new_n440_), .c(x36), .O(new_n476_));
  aoi21  g377(.a(new_n476_), .b(new_n475_), .c(new_n226_), .O(z29));
  zero   g378(.O(z02));
  zero   g379(.O(z03));
  zero   g380(.O(z04));
  zero   g381(.O(z05));
