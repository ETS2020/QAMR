// Benchmark "FAU" written by ABC on Thu Jun 25 01:34:52 2020
...
module FAU ( 
  ...
  oai21  g1198(.a(new_n630_), .b(new_n621_), .c(new_n636_), .O(new_n1277_));
  aoi21  g1199(.a(new_n1277_), .b(new_n499_), .c(new_n759_), .O(new_n1278_));
  oai21  g1200(.a(new_n95_), .b(x06), .c(x39), .O(new_n1279_));
  aoi21  g1201(.a(new_n1279_), .b(new_n425_), .c(new_n84_), .O(new_n1280_));
  oai21  g1202(.a(new_n1280_), .b(new_n224_), .c(x36), .O(new_n1281_));
  oai21  g1203(.a(new_n1278_), .b(x36), .c(new_n1281_), .O(new_n1282_));
  aoi21  g1204(.a(new_n1282_), .b(new_n85_), .c(new_n1276_), .O(new_n1283_));
  inv1   g1205(.a(new_n658_), .O(new_n1284_));
  nand3  g1206(.a(new_n121_), .b(x38), .c(x09), .O(new_n1285_));
  nand2  g1207(.a(new_n546_), .b(new_n82_), .O(new_n1286_));
  aoi21  g1208(.a(new_n1286_), .b(new_n1285_), .c(new_n86_), .O(new_n1287_));
  nand3  g1209(.a(new_n592_), .b(new_n82_), .c(new_n95_), .O(new_n1288_));
  inv1   g1210(.a(new_n1288_), .O(new_n1289_));
  oai21  g1211(.a(new_n1289_), .b(new_n1287_), .c(new_n85_), .O(new_n1290_));
  nand2  g1212(.a(new_n298_), .b(new_n82_), .O(new_n1291_));
  nand3  g1213(.a(new_n449_), .b(x37), .c(x09), .O(new_n1292_));
  nand4  g1214(.a(new_n1292_), .b(new_n1291_), .c(new_n676_), .d(new_n310_), .O(new_n1293_));
  inv1   g1215(.a(new_n1293_), .O(new_n1294_));
  aoi21  g1216(.a(new_n1294_), .b(new_n1290_), .c(new_n1284_), .O(new_n1295_));
  nand2  g1217(.a(new_n586_), .b(new_n335_), .O(new_n1296_));
  aoi21  g1218(.a(new_n1296_), .b(new_n546_), .c(new_n86_), .O(new_n1297_));
  oai21  g1219(.a(new_n1297_), .b(new_n490_), .c(new_n85_), .O(new_n1298_));
  nand2  g1220(.a(new_n405_), .b(new_n295_), .O(new_n1299_));
  aoi21  g1221(.a(new_n1299_), .b(new_n1298_), .c(new_n77_), .O(new_n1300_));
  oai21  g1222(.a(new_n1300_), .b(new_n1295_), .c(new_n100_), .O(new_n1301_));
  oai21  g1223(.a(new_n1283_), .b(new_n100_), .c(new_n1301_), .O(new_n1302_));
  nand3  g1224(.a(new_n917_), .b(new_n235_), .c(new_n250_), .O(new_n1303_));
  aoi21  g1225(.a(new_n668_), .b(new_n499_), .c(new_n85_), .O(new_n1304_));
  oai21  g1226(.a(new_n1304_), .b(new_n158_), .c(new_n1303_), .O(new_n1305_));
  nand2  g1227(.a(new_n1305_), .b(new_n84_), .O(new_n1306_));
  aoi21  g1228(.a(x37), .b(x06), .c(new_n86_), .O(new_n1307_));
  oai22  g1229(.a(new_n1307_), .b(new_n95_), .c(new_n893_), .d(x37), .O(new_n1308_));
  nand2  g1230(.a(new_n1308_), .b(x38), .O(new_n1309_));
  aoi21  g1231(.a(new_n1309_), .b(new_n1306_), .c(new_n430_), .O(new_n1310_));
  aoi21  g1232(.a(new_n1302_), .b(new_n78_), .c(new_n1310_), .O(new_n1311_));
  oai21  g1233(.a(new_n1311_), .b(x32), .c(new_n281_), .O(new_n1312_));
  nand2  g1234(.a(new_n1312_), .b(x33), .O(new_n1313_));
  oai21  g1235(.a(x33), .b(new_n764_), .c(new_n1313_), .O(z33));
  oai22  g1236(.a(new_n1262_), .b(new_n118_), .c(x40), .d(x36), .O(new_n1315_));
  nand2  g1237(.a(new_n1315_), .b(new_n151_), .O(new_n1316_));
  nand3  g1238(.a(new_n85_), .b(new_n77_), .c(x35), .O(new_n1317_));
  aoi21  g1239(.a(new_n1317_), .b(new_n1316_), .c(new_n499_), .O(new_n1318_));
  nor2   g1240(.a(new_n866_), .b(new_n77_), .O(new_n1319_));
  nand2  g1241(.a(new_n187_), .b(new_n80_), .O(new_n1320_));
  aoi21  g1242(.a(new_n1320_), .b(new_n283_), .c(new_n79_), .O(new_n1321_));
  or2    g1243(.a(new_n307_), .b(new_n657_), .O(new_n1322_));
  inv1   g1244(.a(new_n1322_), .O(new_n1323_));
  nor3   g1245(.a(new_n1091_), .b(new_n95_), .c(new_n231_), .O(new_n1324_));
  oai21  g1246(.a(new_n1323_), .b(new_n1321_), .c(new_n1324_), .O(new_n1325_));
  nand3  g1247(.a(new_n187_), .b(new_n121_), .c(x09), .O(new_n1326_));
  aoi21  g1248(.a(new_n1326_), .b(new_n1325_), .c(x36), .O(new_n1327_));
  oai21  g1249(.a(new_n1327_), .b(new_n1319_), .c(new_n100_), .O(new_n1328_));
  nor2   g1250(.a(new_n95_), .b(new_n996_), .O(new_n1329_));
  nand2  g1251(.a(new_n1329_), .b(new_n1192_), .O(new_n1330_));
  aoi21  g1252(.a(new_n1330_), .b(new_n1328_), .c(x37), .O(new_n1331_));
  oai21  g1253(.a(new_n1331_), .b(new_n1318_), .c(x38), .O(new_n1332_));
  nand2  g1254(.a(new_n187_), .b(new_n85_), .O(new_n1333_));
  oai22  g1255(.a(new_n1333_), .b(new_n1286_), .c(new_n342_), .d(new_n499_), .O(new_n1334_));
  nand2  g1256(.a(new_n1334_), .b(new_n77_), .O(new_n1335_));
  nand3  g1257(.a(new_n486_), .b(x36), .c(x11), .O(new_n1336_));
  nand2  g1258(.a(new_n1336_), .b(new_n1335_), .O(new_n1337_));
  nor3   g1259(.a(new_n485_), .b(x36), .c(new_n100_), .O(new_n1338_));
  aoi21  g1260(.a(new_n1337_), .b(new_n100_), .c(new_n1338_), .O(new_n1339_));
  aoi21  g1261(.a(new_n1339_), .b(new_n1332_), .c(new_n86_), .O(new_n1340_));
  nand2  g1262(.a(x35), .b(x04), .O(new_n1341_));
  nand3  g1263(.a(new_n241_), .b(new_n100_), .c(new_n251_), .O(new_n1342_));
  nand2  g1264(.a(new_n355_), .b(new_n163_), .O(new_n1343_));
  aoi21  g1265(.a(new_n1342_), .b(new_n1341_), .c(new_n1343_), .O(new_n1344_));
  aoi21  g1266(.a(new_n425_), .b(new_n100_), .c(new_n757_), .O(new_n1345_));
  oai21  g1267(.a(new_n1345_), .b(new_n1344_), .c(x38), .O(new_n1346_));
  nand2  g1268(.a(new_n95_), .b(x00), .O(new_n1347_));
  inv1   g1269(.a(new_n1329_), .O(new_n1348_));
  oai21  g1270(.a(new_n1347_), .b(new_n256_), .c(new_n1348_), .O(new_n1349_));
  aoi21  g1271(.a(new_n1349_), .b(x35), .c(new_n91_), .O(new_n1350_));
  oai21  g1272(.a(new_n1350_), .b(new_n448_), .c(new_n1346_), .O(new_n1351_));
  nand3  g1273(.a(new_n937_), .b(new_n187_), .c(new_n84_), .O(new_n1352_));
  nand2  g1274(.a(new_n1352_), .b(new_n963_), .O(new_n1353_));
  aoi22  g1275(.a(new_n1353_), .b(new_n897_), .c(new_n1351_), .d(x36), .O(new_n1354_));
  nand2  g1276(.a(new_n324_), .b(new_n99_), .O(new_n1355_));
  nand3  g1277(.a(new_n325_), .b(new_n286_), .c(new_n179_), .O(new_n1356_));
  oai21  g1278(.a(new_n1356_), .b(new_n1355_), .c(x05), .O(new_n1357_));
  nand2  g1279(.a(new_n360_), .b(new_n547_), .O(new_n1358_));
  nand3  g1280(.a(new_n1358_), .b(new_n187_), .c(new_n82_), .O(new_n1359_));
  aoi21  g1281(.a(new_n1359_), .b(new_n1357_), .c(x35), .O(new_n1360_));
  oai21  g1282(.a(new_n95_), .b(new_n100_), .c(x37), .O(new_n1361_));
  nand3  g1283(.a(new_n1361_), .b(new_n84_), .c(x05), .O(new_n1362_));
  nand2  g1284(.a(new_n347_), .b(new_n294_), .O(new_n1363_));
  aoi21  g1285(.a(new_n1363_), .b(new_n1362_), .c(x39), .O(new_n1364_));
  oai21  g1286(.a(new_n1364_), .b(new_n1360_), .c(new_n77_), .O(new_n1365_));
  oai21  g1287(.a(new_n1354_), .b(new_n85_), .c(new_n1365_), .O(new_n1366_));
  oai21  g1288(.a(new_n1366_), .b(new_n1340_), .c(new_n78_), .O(new_n1367_));
  oai21  g1289(.a(new_n1099_), .b(new_n864_), .c(new_n757_), .O(new_n1368_));
  aoi22  g1290(.a(new_n1368_), .b(new_n800_), .c(new_n1086_), .d(new_n159_), .O(new_n1369_));
  oai21  g1291(.a(new_n158_), .b(new_n996_), .c(new_n893_), .O(new_n1370_));
  nand4  g1292(.a(new_n1370_), .b(x38), .c(x37), .d(x34), .O(new_n1371_));
  oai21  g1293(.a(new_n1369_), .b(x38), .c(new_n1371_), .O(new_n1372_));
  nand2  g1294(.a(new_n1372_), .b(new_n897_), .O(new_n1373_));
  nand2  g1295(.a(new_n1373_), .b(new_n1367_), .O(new_n1374_));
  nand2  g1296(.a(new_n1374_), .b(new_n278_), .O(new_n1375_));
  aoi21  g1297(.a(new_n1375_), .b(new_n281_), .c(new_n282_), .O(z34));
  zero   g1298(.O(z03));
  zero   g1299(.O(z15));
endmodule
