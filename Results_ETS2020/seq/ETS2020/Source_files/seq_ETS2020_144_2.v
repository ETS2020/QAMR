// Benchmark "FAU" written by ABC on Thu Jun 25 01:34:16 2020
...
module FAU ( 
  ...
  nor2   g385(.a(new_n246_), .b(new_n242_), .O(z15));
  nand3  g386(.a(new_n199_), .b(x37), .c(new_n107_), .O(new_n477_));
  oai21  g387(.a(new_n339_), .b(new_n86_), .c(new_n477_), .O(new_n478_));
  inv1   g388(.a(new_n108_), .O(new_n479_));
  nor4   g389(.a(new_n479_), .b(x36), .c(new_n79_), .d(x03), .O(new_n480_));
  nand2  g390(.a(new_n240_), .b(x37), .O(new_n481_));
  nor2   g391(.a(new_n481_), .b(new_n200_), .O(new_n482_));
  aoi21  g392(.a(new_n480_), .b(new_n478_), .c(new_n482_), .O(new_n483_));
  nor2   g393(.a(x39), .b(x06), .O(new_n484_));
  nor3   g394(.a(new_n484_), .b(new_n100_), .c(new_n77_), .O(new_n485_));
  aoi21  g395(.a(new_n210_), .b(new_n77_), .c(new_n485_), .O(new_n486_));
  nand2  g396(.a(new_n206_), .b(x40), .O(new_n487_));
  oai22  g397(.a(new_n487_), .b(new_n486_), .c(new_n483_), .d(x35), .O(new_n488_));
  nand2  g398(.a(new_n488_), .b(new_n80_), .O(new_n489_));
  nand4  g399(.a(x37), .b(new_n77_), .c(new_n78_), .d(x34), .O(new_n490_));
  nand3  g400(.a(new_n206_), .b(new_n100_), .c(x36), .O(new_n491_));
  nand3  g401(.a(x40), .b(x39), .c(x06), .O(new_n492_));
  aoi21  g402(.a(new_n491_), .b(new_n490_), .c(new_n492_), .O(new_n493_));
  inv1   g403(.a(new_n206_), .O(new_n494_));
  nor2   g404(.a(new_n100_), .b(new_n86_), .O(new_n495_));
  nand4  g405(.a(new_n218_), .b(new_n495_), .c(new_n108_), .d(x36), .O(new_n496_));
  nand3  g406(.a(new_n199_), .b(new_n100_), .c(new_n77_), .O(new_n497_));
  aoi21  g407(.a(new_n497_), .b(new_n496_), .c(new_n494_), .O(new_n498_));
  oai21  g408(.a(new_n498_), .b(new_n493_), .c(x38), .O(new_n499_));
  aoi21  g409(.a(new_n499_), .b(new_n489_), .c(new_n244_), .O(z19));
  nand2  g410(.a(new_n80_), .b(new_n100_), .O(new_n504_));
  oai21  g411(.a(new_n504_), .b(new_n88_), .c(new_n114_), .O(new_n505_));
  nand2  g412(.a(new_n505_), .b(x34), .O(new_n506_));
  nand2  g413(.a(new_n102_), .b(new_n121_), .O(new_n507_));
  nand3  g414(.a(x40), .b(new_n80_), .c(new_n123_), .O(new_n508_));
  aoi21  g415(.a(new_n508_), .b(new_n507_), .c(new_n93_), .O(new_n509_));
  and2   g416(.a(new_n160_), .b(new_n102_), .O(new_n510_));
  oai21  g417(.a(new_n510_), .b(new_n509_), .c(new_n116_), .O(new_n511_));
  nand3  g418(.a(new_n270_), .b(new_n80_), .c(x13), .O(new_n512_));
  nand2  g419(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  oai21  g420(.a(new_n513_), .b(new_n140_), .c(new_n322_), .O(new_n514_));
  aoi21  g421(.a(new_n514_), .b(new_n506_), .c(x07), .O(new_n515_));
  inv1   g422(.a(new_n306_), .O(new_n516_));
  nand3  g423(.a(x39), .b(new_n80_), .c(new_n79_), .O(new_n517_));
  aoi21  g424(.a(new_n517_), .b(new_n288_), .c(x37), .O(new_n518_));
  oai21  g425(.a(new_n518_), .b(new_n516_), .c(new_n95_), .O(new_n519_));
  nand4  g426(.a(new_n265_), .b(new_n263_), .c(new_n254_), .d(x15), .O(new_n520_));
  aoi21  g427(.a(new_n520_), .b(new_n366_), .c(x37), .O(new_n521_));
  nor2   g428(.a(new_n104_), .b(new_n366_), .O(new_n522_));
  oai21  g429(.a(new_n522_), .b(new_n521_), .c(new_n79_), .O(new_n523_));
  nand2  g430(.a(new_n523_), .b(new_n519_), .O(new_n524_));
  nand2  g431(.a(new_n524_), .b(new_n96_), .O(new_n525_));
  aoi21  g432(.a(new_n117_), .b(new_n101_), .c(new_n400_), .O(new_n526_));
  nand4  g433(.a(new_n311_), .b(new_n82_), .c(new_n100_), .d(new_n107_), .O(new_n527_));
  aoi21  g434(.a(new_n527_), .b(x40), .c(new_n80_), .O(new_n528_));
  oai21  g435(.a(new_n528_), .b(new_n526_), .c(x34), .O(new_n529_));
  nand2  g436(.a(new_n529_), .b(new_n525_), .O(new_n530_));
  oai21  g437(.a(new_n530_), .b(new_n515_), .c(new_n78_), .O(new_n531_));
  aoi21  g438(.a(new_n242_), .b(x00), .c(new_n101_), .O(new_n532_));
  nand2  g439(.a(new_n118_), .b(x39), .O(new_n533_));
  oai21  g440(.a(new_n532_), .b(new_n118_), .c(new_n533_), .O(new_n534_));
  aoi21  g441(.a(new_n534_), .b(x35), .c(new_n104_), .O(new_n535_));
  nand2  g442(.a(new_n105_), .b(new_n103_), .O(new_n536_));
  nand2  g443(.a(new_n308_), .b(new_n270_), .O(new_n537_));
  nand2  g444(.a(new_n537_), .b(new_n78_), .O(new_n538_));
  aoi21  g445(.a(new_n538_), .b(new_n536_), .c(new_n113_), .O(new_n539_));
  oai21  g446(.a(new_n535_), .b(new_n100_), .c(new_n539_), .O(new_n540_));
  nand2  g447(.a(new_n540_), .b(new_n79_), .O(new_n541_));
  aoi21  g448(.a(new_n541_), .b(new_n531_), .c(x36), .O(new_n542_));
  nand2  g449(.a(new_n87_), .b(x38), .O(new_n543_));
  oai21  g450(.a(new_n543_), .b(new_n214_), .c(new_n439_), .O(new_n544_));
  nor4   g451(.a(new_n105_), .b(x37), .c(x26), .d(x25), .O(new_n545_));
  aoi21  g452(.a(new_n544_), .b(x37), .c(new_n545_), .O(new_n546_));
  oai21  g453(.a(new_n292_), .b(new_n101_), .c(new_n301_), .O(new_n547_));
  nand2  g454(.a(new_n547_), .b(new_n100_), .O(new_n548_));
  oai21  g455(.a(new_n546_), .b(x07), .c(new_n548_), .O(new_n549_));
  oai21  g456(.a(new_n80_), .b(x00), .c(x40), .O(new_n550_));
  nand3  g457(.a(new_n234_), .b(new_n233_), .c(new_n118_), .O(new_n551_));
  inv1   g458(.a(new_n551_), .O(new_n552_));
  aoi21  g459(.a(new_n552_), .b(new_n550_), .c(x35), .O(new_n553_));
  aoi21  g460(.a(new_n549_), .b(x35), .c(new_n553_), .O(new_n554_));
  nand2  g461(.a(new_n298_), .b(new_n100_), .O(new_n555_));
  nand3  g462(.a(new_n117_), .b(new_n80_), .c(x00), .O(new_n556_));
  nand2  g463(.a(new_n101_), .b(x35), .O(new_n557_));
  aoi21  g464(.a(new_n556_), .b(new_n555_), .c(new_n557_), .O(new_n558_));
  nor2   g465(.a(new_n558_), .b(new_n440_), .O(new_n559_));
  oai21  g466(.a(new_n554_), .b(new_n77_), .c(new_n559_), .O(new_n560_));
  nand2  g467(.a(new_n560_), .b(new_n79_), .O(new_n561_));
  nor3   g468(.a(x37), .b(x36), .c(x35), .O(new_n562_));
  nor3   g469(.a(new_n80_), .b(new_n100_), .c(x34), .O(new_n563_));
  oai21  g470(.a(new_n563_), .b(new_n562_), .c(new_n86_), .O(new_n564_));
  nand2  g471(.a(new_n117_), .b(x36), .O(new_n565_));
  nand3  g472(.a(new_n565_), .b(new_n78_), .c(new_n79_), .O(new_n566_));
  nand2  g473(.a(new_n566_), .b(new_n564_), .O(new_n567_));
  nand2  g474(.a(new_n567_), .b(x05), .O(new_n568_));
  nand4  g475(.a(new_n313_), .b(new_n201_), .c(x36), .d(new_n78_), .O(new_n569_));
  nand3  g476(.a(new_n569_), .b(new_n568_), .c(new_n561_), .O(new_n570_));
  oai21  g477(.a(new_n570_), .b(new_n542_), .c(new_n243_), .O(new_n571_));
  aoi21  g478(.a(new_n571_), .b(new_n242_), .c(new_n246_), .O(z23));
  inv1   g479(.a(new_n271_), .O(new_n578_));
  nor3   g480(.a(new_n91_), .b(new_n196_), .c(new_n90_), .O(new_n579_));
  nand4  g481(.a(new_n579_), .b(new_n291_), .c(new_n578_), .d(new_n175_), .O(new_n580_));
  nand4  g482(.a(new_n450_), .b(new_n158_), .c(new_n151_), .d(x39), .O(new_n581_));
  aoi21  g483(.a(new_n581_), .b(new_n580_), .c(x40), .O(new_n582_));
  nand3  g484(.a(new_n450_), .b(new_n298_), .c(new_n101_), .O(new_n583_));
  aoi21  g485(.a(new_n157_), .b(new_n155_), .c(new_n583_), .O(new_n584_));
  oai21  g486(.a(new_n584_), .b(new_n582_), .c(new_n79_), .O(new_n585_));
  nand2  g487(.a(new_n255_), .b(new_n175_), .O(new_n586_));
  nor4   g488(.a(new_n586_), .b(x38), .c(x35), .d(new_n79_), .O(new_n587_));
  nand3  g489(.a(new_n587_), .b(new_n272_), .c(x39), .O(new_n588_));
  nand2  g490(.a(new_n588_), .b(new_n585_), .O(new_n589_));
  nand3  g491(.a(new_n589_), .b(new_n77_), .c(new_n96_), .O(new_n590_));
  nand3  g492(.a(new_n206_), .b(new_n153_), .c(x36), .O(new_n591_));
  aoi21  g493(.a(new_n591_), .b(new_n590_), .c(new_n244_), .O(z29));
  nor4   g494(.a(new_n176_), .b(new_n173_), .c(new_n100_), .d(x23), .O(new_n594_));
  oai21  g495(.a(new_n594_), .b(new_n196_), .c(x40), .O(new_n595_));
  nand2  g496(.a(new_n100_), .b(new_n196_), .O(new_n596_));
  aoi21  g497(.a(new_n596_), .b(new_n595_), .c(new_n105_), .O(new_n597_));
  aoi21  g498(.a(new_n397_), .b(x24), .c(new_n191_), .O(new_n598_));
  nor3   g499(.a(new_n343_), .b(new_n91_), .c(x36), .O(new_n599_));
  oai21  g500(.a(new_n598_), .b(new_n597_), .c(new_n599_), .O(new_n600_));
  nor2   g501(.a(new_n80_), .b(new_n100_), .O(new_n601_));
  nor2   g502(.a(new_n77_), .b(new_n107_), .O(new_n602_));
  nand4  g503(.a(new_n602_), .b(new_n601_), .c(new_n87_), .d(new_n417_), .O(new_n603_));
  aoi21  g504(.a(new_n603_), .b(new_n600_), .c(new_n78_), .O(new_n604_));
  nor4   g505(.a(new_n307_), .b(new_n235_), .c(new_n77_), .d(x35), .O(new_n605_));
  oai21  g506(.a(new_n605_), .b(new_n604_), .c(new_n79_), .O(new_n606_));
  nand4  g507(.a(new_n80_), .b(new_n77_), .c(new_n78_), .d(x34), .O(new_n607_));
  inv1   g508(.a(new_n607_), .O(new_n608_));
  nand4  g509(.a(new_n608_), .b(new_n340_), .c(new_n87_), .d(new_n417_), .O(new_n609_));
  aoi21  g510(.a(new_n609_), .b(new_n606_), .c(new_n244_), .O(z31));
  zero   g511(.O(z02));
  zero   g512(.O(z04));
  zero   g513(.O(z05));
  zero   g514(.O(z06));
