// Benchmark "FAU" written by ABC on Tue Jun 23 04:24:21 2020
...
module FAU ( 
  ...
  oai21  g33(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(new_n53_), .c(new_n25_), .O(new_n60_));
  oai21  g35(.a(x09), .b(new_n36_), .c(new_n25_), .O(new_n61_));
  nand2  g36(.a(new_n27_), .b(new_n50_), .O(new_n62_));
  nand2  g37(.a(new_n45_), .b(x00), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  inv1   g39(.a(x14), .O(new_n65_));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n60_), .c(new_n58_), .O(z6));
  nand3  g44(.a(x09), .b(x03), .c(new_n27_), .O(new_n70_));
  nand4  g45(.a(new_n42_), .b(new_n45_), .c(new_n41_), .d(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand2  g48(.a(x03), .b(new_n25_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n45_), .c(new_n58_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n73_), .O(z7));
  zero   g51(.O(z1));
  zero   g52(.O(z8));
endmodule
