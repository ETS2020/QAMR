...
module FAU ( 
  ...
  aoi21  g34(.a(x09), .b(new_n34_), .c(x02), .O(new_n61_));
  inv1   g35(.a(x09), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x03), .c(new_n30_), .O(new_n63_));
  oai21  g37(.a(new_n61_), .b(x01), .c(new_n63_), .O(new_n64_));
  oai21  g38(.a(new_n60_), .b(new_n56_), .c(new_n64_), .O(new_n65_));
  inv1   g39(.a(x14), .O(new_n66_));
  nand2  g40(.a(new_n30_), .b(new_n56_), .O(new_n67_));
  oai21  g41(.a(x08), .b(new_n56_), .c(new_n67_), .O(new_n68_));
  nor2   g42(.a(new_n30_), .b(x00), .O(new_n69_));
  aoi22  g43(.a(new_n69_), .b(new_n66_), .c(new_n68_), .d(x01), .O(new_n70_));
  aoi21  g44(.a(new_n70_), .b(new_n65_), .c(new_n45_), .O(z6));
  nor2   g45(.a(new_n34_), .b(x01), .O(new_n72_));
  oai21  g46(.a(x07), .b(new_n30_), .c(new_n72_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n60_), .O(new_n74_));
  nor2   g48(.a(new_n62_), .b(x02), .O(new_n75_));
  aoi21  g49(.a(new_n75_), .b(new_n72_), .c(new_n45_), .O(new_n76_));
