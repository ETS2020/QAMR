...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n57_, new_n61_, new_n62_, new_n63_, new_n64_;
  ...
  nor2   g34(.a(x07), .b(new_n30_), .O(new_n61_));
  nand2  g35(.a(x03), .b(new_n25_), .O(new_n62_));
  oai21  g36(.a(new_n62_), .b(new_n61_), .c(new_n49_), .O(new_n63_));
  nand4  g37(.a(x09), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n64_));
  nand4  g38(.a(new_n64_), .b(new_n63_), .c(new_n46_), .d(new_n45_), .O(z7));
  zero   g39(.O(z5));
  zero   g40(.O(z6));
  zero   g41(.O(z8));
endmodule
