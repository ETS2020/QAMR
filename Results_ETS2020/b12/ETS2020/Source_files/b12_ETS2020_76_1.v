...
module FAU ( 
  ...
  oai21  g34(.a(new_n60_), .b(x03), .c(new_n30_), .O(new_n61_));
  aoi21  g35(.a(x08), .b(x00), .c(x01), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  inv1   g37(.a(x14), .O(new_n64_));
  oai21  g38(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n65_));
  nand2  g39(.a(new_n30_), .b(new_n56_), .O(new_n66_));
  oai21  g40(.a(x08), .b(new_n56_), .c(new_n66_), .O(new_n67_));
  nor2   g41(.a(new_n30_), .b(x00), .O(new_n68_));
  aoi22  g42(.a(new_n68_), .b(new_n64_), .c(new_n67_), .d(new_n65_), .O(new_n69_));
  aoi21  g43(.a(new_n69_), .b(new_n63_), .c(new_n45_), .O(z6));
  nand3  g44(.a(x09), .b(x03), .c(new_n30_), .O(new_n71_));
  inv1   g45(.a(x08), .O(new_n72_));
  nand4  g46(.a(new_n41_), .b(new_n72_), .c(new_n40_), .d(x02), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g49(.a(x03), .b(new_n25_), .O(new_n76_));
  aoi21  g50(.a(new_n76_), .b(new_n72_), .c(new_n45_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n75_), .O(z7));
  inv1   g52(.a(x12), .O(new_n79_));
  nand2  g53(.a(new_n79_), .b(new_n30_), .O(new_n80_));
  oai21  g54(.a(new_n80_), .b(new_n76_), .c(x09), .O(new_n81_));
  aoi21  g55(.a(new_n60_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
  nand2  g56(.a(new_n82_), .b(new_n81_), .O(z8));
  zero   g57(.O(z4));
  zero   g58(.O(z5));
endmodule
