...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n49_, new_n51_, new_n52_, new_n54_, new_n57_, new_n58_, new_n59_,
  ...
  nor2   g28(.a(x12), .b(x00), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  nor2   g30(.a(x07), .b(new_n31_), .O(new_n57_));
  nand2  g31(.a(x03), .b(new_n35_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(new_n59_));
  nand2  g33(.a(new_n41_), .b(new_n40_), .O(new_n60_));
  nor2   g34(.a(x02), .b(x01), .O(new_n61_));
  inv1   g35(.a(x09), .O(new_n62_));
  nor2   g36(.a(new_n62_), .b(new_n27_), .O(new_n63_));
  aoi21  g37(.a(new_n63_), .b(new_n61_), .c(new_n60_), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n59_), .O(z7));
  inv1   g39(.a(x12), .O(new_n66_));
  nand3  g40(.a(new_n61_), .b(new_n66_), .c(x03), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(x09), .O(new_n68_));
  aoi21  g42(.a(new_n62_), .b(new_n49_), .c(new_n60_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(z8));
  zero   g44(.O(z0));
  zero   g45(.O(z6));
endmodule
