...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n56_, new_n58_,
  ...
  nand4  g31(.a(new_n56_), .b(new_n42_), .c(new_n41_), .d(new_n50_), .O(z5));
  nand2  g32(.a(new_n42_), .b(new_n41_), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x03), .c(new_n27_), .O(new_n60_));
  oai21  g35(.a(x02), .b(x01), .c(x00), .O(new_n61_));
  nand3  g36(.a(x09), .b(new_n36_), .c(new_n25_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n45_), .O(new_n64_));
  nand2  g39(.a(x09), .b(new_n36_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n27_), .c(x01), .O(new_n66_));
  nand2  g41(.a(x14), .b(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n60_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n66_), .c(new_n50_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n58_), .O(z6));
  inv1   g46(.a(x12), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(x09), .O(new_n75_));
  aoi21  g49(.a(new_n59_), .b(new_n50_), .c(new_n58_), .O(new_n76_));
