...
module FAU ( 
  ...
  aoi21  g29(.a(new_n51_), .b(x03), .c(x01), .O(new_n56_));
  nand3  g30(.a(x09), .b(new_n27_), .c(new_n35_), .O(new_n57_));
  oai21  g31(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand2  g32(.a(new_n58_), .b(new_n52_), .O(new_n59_));
  aoi21  g33(.a(x14), .b(x01), .c(x00), .O(new_n60_));
  nor2   g34(.a(x08), .b(new_n49_), .O(new_n61_));
  oai21  g35(.a(new_n61_), .b(new_n60_), .c(x02), .O(new_n62_));
  nand2  g36(.a(new_n41_), .b(new_n40_), .O(new_n63_));
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n63_), .O(z6));
  nand3  g38(.a(x09), .b(x03), .c(new_n35_), .O(new_n65_));
  nand4  g39(.a(new_n41_), .b(new_n44_), .c(new_n40_), .d(x01), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n31_), .O(new_n68_));
  oai21  g42(.a(x07), .b(new_n31_), .c(x03), .O(new_n69_));
  aoi21  g43(.a(new_n69_), .b(new_n44_), .c(new_n63_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n68_), .O(z7));
  inv1   g45(.a(x12), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x03), .c(new_n31_), .d(new_n35_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(x09), .O(new_n74_));
  aoi21  g48(.a(new_n51_), .b(new_n49_), .c(new_n63_), .O(new_n75_));
