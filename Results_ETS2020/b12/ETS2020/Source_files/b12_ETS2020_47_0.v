...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n73_, new_n74_, new_n75_, new_n78_, new_n79_, new_n80_, new_n81_,
    new_n82_;
  ...
  nand3  g38(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n63_));
  oai21  g39(.a(x14), .b(new_n25_), .c(new_n63_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n56_), .O(new_n65_));
  oai21  g41(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n66_));
  nor2   g42(.a(x08), .b(new_n56_), .O(new_n67_));
  nor2   g43(.a(x02), .b(x00), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  nor2   g45(.a(x01), .b(x00), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n67_), .c(x02), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand4  g48(.a(x09), .b(new_n72_), .c(new_n34_), .d(new_n25_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n69_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n65_), .c(new_n45_), .O(z6));
  inv1   g52(.a(x12), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(x09), .O(new_n80_));
  nor2   g55(.a(x09), .b(x00), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n80_), .O(z8));
  zero   g58(.O(z7));
endmodule
