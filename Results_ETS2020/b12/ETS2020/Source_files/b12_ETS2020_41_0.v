...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n57_, new_n59_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_;
  ...
  nand4  g37(.a(new_n63_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(x09), .O(new_n65_));
  inv1   g39(.a(x09), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n54_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(new_n65_), .c(new_n46_), .d(new_n45_), .O(z8));
  zero   g42(.O(z6));
  zero   g43(.O(z7));
endmodule
