...
module FAU ( 
  ...
  xnor2a g22(.a(x09), .b(x03), .O(new_n50_));
  oai21  g23(.a(new_n50_), .b(x02), .c(new_n28_), .O(new_n51_));
  nand2  g24(.a(new_n51_), .b(new_n46_), .O(new_n52_));
  inv1   g25(.a(x00), .O(new_n53_));
  nand2  g26(.a(new_n25_), .b(new_n53_), .O(new_n54_));
  inv1   g27(.a(x08), .O(new_n55_));
  nand2  g28(.a(new_n55_), .b(x00), .O(new_n56_));
  nand2  g29(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  inv1   g30(.a(x14), .O(new_n58_));
  nand3  g31(.a(new_n58_), .b(x02), .c(new_n53_), .O(new_n59_));
  inv1   g32(.a(new_n59_), .O(new_n60_));
  aoi21  g33(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n61_));
  inv1   g34(.a(x10), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  aoi21  g36(.a(new_n61_), .b(new_n52_), .c(new_n63_), .O(z6));
  nand3  g37(.a(x09), .b(x03), .c(new_n25_), .O(new_n65_));
  nand4  g38(.a(new_n62_), .b(new_n55_), .c(new_n44_), .d(x02), .O(new_n66_));
  ...
  aoi21  g42(.a(new_n69_), .b(new_n55_), .c(new_n63_), .O(new_n70_));
  nand2  g43(.a(new_n70_), .b(new_n68_), .O(z7));
  inv1   g44(.a(x12), .O(new_n72_));
  nand2  g45(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  oai21  g46(.a(new_n73_), .b(new_n69_), .c(x09), .O(new_n74_));
  aoi21  g47(.a(new_n45_), .b(new_n53_), .c(new_n63_), .O(new_n75_));
  nand2  g48(.a(new_n75_), .b(new_n74_), .O(z8));
  zero   g49(.O(z2));
  zero   g50(.O(z3));
  zero   g51(.O(z5));
endmodule
