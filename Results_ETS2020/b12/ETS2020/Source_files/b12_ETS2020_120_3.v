...
module FAU ( 
  ...
  nand3  g36(.a(new_n57_), .b(x03), .c(new_n30_), .O(new_n63_));
  oai21  g37(.a(new_n62_), .b(x01), .c(new_n63_), .O(new_n64_));
  ...
  aoi22  g44(.a(new_n70_), .b(new_n66_), .c(new_n69_), .d(x01), .O(new_n71_));
  aoi21  g45(.a(new_n71_), .b(new_n65_), .c(new_n45_), .O(z6));
  nand2  g46(.a(x03), .b(new_n25_), .O(new_n73_));
  aoi21  g47(.a(new_n40_), .b(x02), .c(new_n73_), .O(new_n74_));
  nor2   g48(.a(x02), .b(x01), .O(new_n75_));
  nor2   g49(.a(new_n57_), .b(new_n34_), .O(new_n76_));
  aoi21  g50(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n77_));
  oai21  g51(.a(new_n74_), .b(x08), .c(new_n77_), .O(z7));
  inv1   g52(.a(x12), .O(new_n79_));
  nand3  g53(.a(new_n75_), .b(new_n79_), .c(x03), .O(new_n80_));
  nand2  g54(.a(new_n80_), .b(x09), .O(new_n81_));
  aoi21  g55(.a(new_n57_), .b(new_n67_), .c(new_n45_), .O(new_n82_));
