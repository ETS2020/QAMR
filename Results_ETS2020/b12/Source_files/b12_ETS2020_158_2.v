// Benchmark "FAU" written by ABC on Tue Jun 23 04:24:02 2020
...
module FAU ( 
  ...
  nor2   g34(.a(x02), .b(x01), .O(new_n62_));
  inv1   g35(.a(x09), .O(new_n63_));
  nor2   g36(.a(new_n63_), .b(new_n34_), .O(new_n64_));
  nand2  g37(.a(new_n46_), .b(new_n45_), .O(new_n65_));
  aoi21  g38(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n61_), .O(z7));
  inv1   g40(.a(x12), .O(new_n68_));
  nand3  g41(.a(new_n62_), .b(new_n68_), .c(x03), .O(new_n69_));
  nand2  g42(.a(new_n69_), .b(x09), .O(new_n70_));
  aoi21  g43(.a(new_n63_), .b(new_n54_), .c(new_n65_), .O(new_n71_));
  nand2  g44(.a(new_n71_), .b(new_n70_), .O(z8));
  zero   g45(.O(z4));
  zero   g46(.O(z5));
  zero   g47(.O(z6));
endmodule
