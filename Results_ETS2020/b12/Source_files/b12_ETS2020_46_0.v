...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n59_, new_n60_,
  ...
  nand4  g32(.a(new_n59_), .b(x03), .c(new_n27_), .d(new_n25_), .O(new_n60_));
  nand2  g33(.a(new_n60_), .b(x09), .O(new_n61_));
  inv1   g34(.a(x09), .O(new_n62_));
  nand2  g35(.a(new_n62_), .b(new_n50_), .O(new_n63_));
  nand4  g36(.a(new_n63_), .b(new_n61_), .c(new_n42_), .d(new_n41_), .O(z8));
  zero   g37(.O(z1));
  zero   g38(.O(z6));
  zero   g39(.O(z7));
endmodule
