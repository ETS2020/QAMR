...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    ...
    new_n59_, new_n60_, new_n61_, new_n62_, new_n65_, new_n66_, new_n67_,
    new_n68_;
  ...
  inv1   g37(.a(x12), .O(new_n65_));
  nand4  g38(.a(new_n65_), .b(x03), .c(new_n28_), .d(new_n29_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(x09), .O(new_n67_));
  aoi21  g40(.a(new_n46_), .b(new_n44_), .c(new_n52_), .O(new_n68_));
  nand2  g41(.a(new_n68_), .b(new_n67_), .O(z8));
  zero   g42(.O(z0));
  zero   g43(.O(z1));
  zero   g44(.O(z7));
endmodule
