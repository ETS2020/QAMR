// Benchmark "FAU" written by ABC on Tue Jun 23 04:24:07 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n58_, new_n59_,
    new_n60_, new_n61_;
  ...
  nor2   g29(.a(x07), .b(new_n30_), .O(new_n58_));
  nand2  g30(.a(x03), .b(new_n25_), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(new_n58_), .c(new_n49_), .O(new_n60_));
  nand4  g32(.a(x09), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n61_));
  nand4  g33(.a(new_n61_), .b(new_n60_), .c(new_n46_), .d(new_n45_), .O(z7));
  zero   g34(.O(z3));
  zero   g35(.O(z4));
  zero   g36(.O(z5));
  zero   g37(.O(z6));
