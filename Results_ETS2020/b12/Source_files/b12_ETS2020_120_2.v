// Benchmark "FAU" written by ABC on Tue Jun 23 04:23:50 2020
...
module FAU ( 
  ...
  nor2   g32(.a(new_n57_), .b(x12), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n46_), .c(new_n45_), .d(new_n54_), .O(z5));
  nor2   g34(.a(new_n34_), .b(x01), .O(new_n61_));
  oai21  g35(.a(x07), .b(new_n30_), .c(new_n61_), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n49_), .O(new_n63_));
  nand2  g37(.a(new_n46_), .b(new_n45_), .O(new_n64_));
  inv1   g38(.a(x09), .O(new_n65_));
  nor2   g39(.a(new_n65_), .b(x02), .O(new_n66_));
  aoi21  g40(.a(new_n66_), .b(new_n61_), .c(new_n64_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n63_), .O(z7));
  zero   g42(.O(z4));
  zero   g43(.O(z6));
  zero   g44(.O(z8));
endmodule
