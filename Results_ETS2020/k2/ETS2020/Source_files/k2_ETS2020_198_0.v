// Benchmark "FAU" written by ABC on Wed Jun 24 05:14:01 2020
...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n896_, new_n899_, new_n900_, new_n901_, new_n902_, new_n903_,
  ...
  nor2   g596(.a(x28), .b(x27), .O(new_n697_));
  nand2  g597(.a(new_n697_), .b(new_n158_), .O(new_n698_));
  inv1   g598(.a(x14), .O(new_n699_));
  nor2   g599(.a(x13), .b(x12), .O(new_n700_));
  nand3  g600(.a(new_n700_), .b(x21), .c(new_n699_), .O(new_n701_));
  nor2   g601(.a(new_n701_), .b(new_n698_), .O(z32));
  nor2   g602(.a(x29), .b(new_n147_), .O(new_n703_));
  oai21  g603(.a(new_n461_), .b(x30), .c(new_n703_), .O(new_n704_));
  oai21  g604(.a(new_n437_), .b(new_n104_), .c(new_n589_), .O(new_n705_));
  nand2  g605(.a(new_n705_), .b(new_n591_), .O(new_n706_));
  nand2  g606(.a(new_n296_), .b(new_n114_), .O(new_n707_));
  aoi21  g607(.a(new_n706_), .b(new_n704_), .c(new_n707_), .O(z33));
  nor2   g608(.a(new_n360_), .b(x40), .O(new_n709_));
  nor3   g609(.a(x42), .b(x41), .c(x39), .O(new_n710_));
  nor2   g610(.a(x38), .b(x28), .O(new_n711_));
  nand4  g611(.a(new_n711_), .b(new_n710_), .c(new_n500_), .d(new_n325_), .O(new_n712_));
  oai21  g612(.a(new_n712_), .b(new_n709_), .c(new_n141_), .O(new_n713_));
  nand2  g613(.a(new_n713_), .b(x21), .O(new_n714_));
  nand4  g614(.a(new_n471_), .b(new_n138_), .c(new_n110_), .d(x00), .O(new_n715_));
  aoi21  g615(.a(new_n715_), .b(new_n714_), .c(x30), .O(new_n716_));
  nor2   g616(.a(new_n286_), .b(new_n283_), .O(new_n717_));
  nand3  g617(.a(new_n500_), .b(new_n325_), .c(new_n268_), .O(new_n718_));
  nor2   g618(.a(new_n718_), .b(new_n717_), .O(new_n719_));
  oai21  g619(.a(new_n719_), .b(new_n716_), .c(x29), .O(new_n720_));
  nand4  g620(.a(new_n445_), .b(new_n96_), .c(new_n157_), .d(x00), .O(new_n721_));
  nand2  g621(.a(new_n584_), .b(new_n255_), .O(new_n722_));
  aoi21  g622(.a(new_n722_), .b(new_n721_), .c(x21), .O(new_n723_));
  nand2  g623(.a(new_n133_), .b(x00), .O(new_n724_));
  inv1   g624(.a(new_n724_), .O(new_n725_));
  oai21  g625(.a(new_n725_), .b(new_n723_), .c(x28), .O(new_n726_));
  nand3  g626(.a(new_n133_), .b(new_n107_), .c(new_n104_), .O(new_n727_));
  aoi21  g627(.a(new_n727_), .b(new_n726_), .c(x29), .O(new_n728_));
  aoi21  g628(.a(x21), .b(x09), .c(x29), .O(new_n729_));
  nand2  g629(.a(x22), .b(new_n117_), .O(new_n730_));
  oai21  g630(.a(new_n730_), .b(new_n729_), .c(new_n685_), .O(new_n731_));
  nand2  g631(.a(new_n731_), .b(new_n96_), .O(new_n732_));
  nand3  g632(.a(new_n138_), .b(x29), .c(x22), .O(new_n733_));
  aoi21  g633(.a(new_n733_), .b(new_n732_), .c(x28), .O(new_n734_));
  oai21  g634(.a(new_n734_), .b(new_n728_), .c(x30), .O(new_n735_));
  nand2  g635(.a(new_n550_), .b(x19), .O(new_n736_));
  nand3  g636(.a(new_n736_), .b(new_n170_), .c(new_n158_), .O(new_n737_));
  nand3  g637(.a(new_n737_), .b(new_n735_), .c(new_n720_), .O(new_n738_));
  nand2  g638(.a(new_n738_), .b(new_n92_), .O(new_n739_));
  nand3  g639(.a(new_n147_), .b(x19), .c(new_n146_), .O(new_n740_));
  nand2  g640(.a(x26), .b(new_n96_), .O(new_n741_));
  oai22  g641(.a(new_n741_), .b(new_n392_), .c(new_n740_), .d(new_n391_), .O(new_n742_));
  nor2   g642(.a(x27), .b(new_n96_), .O(new_n743_));
  aoi22  g643(.a(new_n743_), .b(new_n499_), .c(new_n742_), .d(x00), .O(new_n744_));
  nor2   g644(.a(new_n187_), .b(new_n145_), .O(new_n745_));
  nor2   g645(.a(new_n745_), .b(new_n398_), .O(new_n746_));
  nand2  g646(.a(new_n746_), .b(x19), .O(new_n747_));
  nand2  g647(.a(new_n747_), .b(new_n396_), .O(new_n748_));
  nand2  g648(.a(new_n748_), .b(new_n119_), .O(new_n749_));
  oai21  g649(.a(new_n744_), .b(new_n119_), .c(new_n749_), .O(new_n750_));
  nand3  g650(.a(new_n604_), .b(x21), .c(new_n222_), .O(new_n751_));
  nor4   g651(.a(new_n751_), .b(new_n414_), .c(x28), .d(x19), .O(new_n752_));
  aoi21  g652(.a(new_n750_), .b(new_n110_), .c(new_n752_), .O(new_n753_));
  and2   g653(.a(new_n407_), .b(new_n406_), .O(new_n754_));
  nor2   g654(.a(new_n110_), .b(x19), .O(new_n755_));
  aoi21  g655(.a(new_n161_), .b(x26), .c(new_n755_), .O(new_n756_));
  nand2  g656(.a(new_n161_), .b(x00), .O(new_n757_));
  oai22  g657(.a(new_n757_), .b(new_n234_), .c(new_n756_), .d(new_n754_), .O(new_n758_));
  nor4   g658(.a(new_n406_), .b(new_n152_), .c(new_n110_), .d(x19), .O(new_n759_));
  aoi21  g659(.a(new_n758_), .b(new_n117_), .c(new_n759_), .O(new_n760_));
  oai21  g660(.a(new_n753_), .b(new_n117_), .c(new_n760_), .O(new_n761_));
  nand2  g661(.a(new_n761_), .b(x18), .O(new_n762_));
  nand2  g662(.a(new_n762_), .b(new_n739_), .O(z34));
  oai21  g663(.a(new_n357_), .b(new_n271_), .c(new_n363_), .O(new_n764_));
  nand2  g664(.a(new_n764_), .b(new_n104_), .O(new_n765_));
  aoi21  g665(.a(new_n765_), .b(new_n469_), .c(x20), .O(new_n766_));
  nand3  g666(.a(new_n104_), .b(new_n600_), .c(new_n146_), .O(new_n767_));
  aoi21  g667(.a(new_n767_), .b(x19), .c(new_n152_), .O(new_n768_));
  aoi21  g668(.a(new_n106_), .b(new_n105_), .c(x19), .O(new_n769_));
  oai21  g669(.a(new_n769_), .b(new_n768_), .c(x20), .O(new_n770_));
  aoi21  g670(.a(new_n770_), .b(new_n141_), .c(new_n91_), .O(new_n771_));
  oai21  g671(.a(new_n771_), .b(new_n766_), .c(x21), .O(new_n772_));
  inv1   g672(.a(x06), .O(new_n773_));
  nand3  g673(.a(new_n255_), .b(x20), .c(new_n773_), .O(new_n774_));
  nand2  g674(.a(new_n774_), .b(new_n446_), .O(new_n775_));
  nand2  g675(.a(new_n775_), .b(x28), .O(new_n776_));
  oai21  g676(.a(x03), .b(x02), .c(x28), .O(new_n777_));
  oai21  g677(.a(x28), .b(new_n174_), .c(new_n93_), .O(new_n778_));
  aoi21  g678(.a(new_n777_), .b(new_n117_), .c(new_n778_), .O(new_n779_));
  aoi21  g679(.a(new_n779_), .b(new_n776_), .c(x19), .O(new_n780_));
  nand2  g680(.a(new_n520_), .b(new_n242_), .O(new_n781_));
  nand2  g681(.a(x23), .b(new_n117_), .O(new_n782_));
  aoi21  g682(.a(new_n782_), .b(new_n781_), .c(new_n96_), .O(new_n783_));
  oai21  g683(.a(new_n783_), .b(new_n780_), .c(new_n110_), .O(new_n784_));
  aoi21  g684(.a(new_n784_), .b(new_n772_), .c(x18), .O(new_n785_));
  nand2  g685(.a(new_n110_), .b(x18), .O(new_n786_));
  oai22  g686(.a(new_n786_), .b(new_n228_), .c(new_n643_), .d(new_n227_), .O(new_n787_));
  nand2  g687(.a(new_n787_), .b(new_n96_), .O(new_n788_));
  nand2  g688(.a(new_n133_), .b(x18), .O(new_n789_));
  aoi21  g689(.a(new_n789_), .b(new_n788_), .c(new_n91_), .O(new_n790_));
  aoi21  g690(.a(new_n432_), .b(new_n96_), .c(new_n786_), .O(new_n791_));
  oai21  g691(.a(new_n791_), .b(new_n790_), .c(x20), .O(new_n792_));
  nand2  g692(.a(new_n334_), .b(new_n114_), .O(new_n793_));
  nand4  g693(.a(new_n268_), .b(new_n210_), .c(new_n163_), .d(x00), .O(new_n794_));
  aoi21  g694(.a(new_n794_), .b(new_n793_), .c(new_n201_), .O(new_n795_));
  nand4  g695(.a(x28), .b(x26), .c(new_n110_), .d(x19), .O(new_n796_));
  nand3  g696(.a(new_n104_), .b(x21), .c(new_n96_), .O(new_n797_));
  aoi21  g697(.a(new_n797_), .b(new_n796_), .c(new_n91_), .O(new_n798_));
  oai21  g698(.a(new_n798_), .b(new_n671_), .c(x18), .O(new_n799_));
  oai21  g699(.a(new_n311_), .b(new_n152_), .c(new_n799_), .O(new_n800_));
  aoi21  g700(.a(new_n800_), .b(new_n117_), .c(new_n795_), .O(new_n801_));
  nand2  g701(.a(new_n801_), .b(new_n792_), .O(new_n802_));
  oai21  g702(.a(new_n802_), .b(new_n785_), .c(new_n145_), .O(new_n803_));
  nor2   g703(.a(new_n92_), .b(new_n146_), .O(new_n804_));
  nand2  g704(.a(new_n804_), .b(new_n697_), .O(new_n805_));
  oai21  g705(.a(new_n472_), .b(x18), .c(new_n805_), .O(new_n806_));
  nand3  g706(.a(new_n806_), .b(new_n686_), .c(new_n138_), .O(new_n807_));
  nand2  g707(.a(new_n807_), .b(new_n803_), .O(new_n808_));
  nand2  g708(.a(new_n808_), .b(x30), .O(new_n809_));
  inv1   g709(.a(new_n703_), .O(new_n810_));
  nand3  g710(.a(new_n92_), .b(new_n146_), .c(x00), .O(new_n811_));
  nand2  g711(.a(new_n500_), .b(new_n519_), .O(new_n812_));
  oai22  g712(.a(new_n812_), .b(new_n811_), .c(new_n810_), .d(new_n555_), .O(new_n813_));
  nand2  g713(.a(new_n813_), .b(new_n157_), .O(new_n814_));
  oai22  g714(.a(new_n690_), .b(new_n432_), .c(new_n681_), .d(new_n203_), .O(new_n815_));
  nor2   g715(.a(x04), .b(new_n91_), .O(new_n816_));
  nor3   g716(.a(new_n816_), .b(new_n398_), .c(new_n139_), .O(new_n817_));
  aoi21  g717(.a(new_n815_), .b(x00), .c(new_n817_), .O(new_n818_));
  nand2  g718(.a(new_n104_), .b(x05), .O(new_n819_));
  nand3  g719(.a(new_n819_), .b(x22), .c(x19), .O(new_n820_));
  nand2  g720(.a(new_n523_), .b(new_n96_), .O(new_n821_));
  nand2  g721(.a(new_n821_), .b(new_n820_), .O(new_n822_));
  nand4  g722(.a(new_n822_), .b(x20), .c(new_n92_), .d(x00), .O(new_n823_));
  oai21  g723(.a(new_n818_), .b(new_n92_), .c(new_n823_), .O(new_n824_));
  nand2  g724(.a(new_n824_), .b(x29), .O(new_n825_));
  aoi21  g725(.a(new_n825_), .b(new_n814_), .c(x21), .O(new_n826_));
  nand3  g726(.a(new_n324_), .b(new_n96_), .c(new_n362_), .O(new_n827_));
  oai21  g727(.a(new_n827_), .b(new_n323_), .c(new_n117_), .O(new_n828_));
  nand2  g728(.a(new_n604_), .b(x20), .O(new_n829_));
  nor2   g729(.a(new_n829_), .b(x19), .O(new_n830_));
  aoi21  g730(.a(new_n828_), .b(x22), .c(new_n830_), .O(new_n831_));
  nor2   g731(.a(new_n386_), .b(new_n140_), .O(new_n832_));
  oai21  g732(.a(new_n831_), .b(x28), .c(new_n832_), .O(new_n833_));
  nand2  g733(.a(new_n833_), .b(x21), .O(new_n834_));
  nand2  g734(.a(new_n588_), .b(new_n697_), .O(new_n835_));
  aoi21  g735(.a(new_n835_), .b(new_n834_), .c(new_n145_), .O(new_n836_));
  oai21  g736(.a(new_n836_), .b(new_n826_), .c(new_n119_), .O(new_n837_));
  nand2  g737(.a(new_n837_), .b(new_n809_), .O(z35));
  nand2  g738(.a(x42), .b(x39), .O(new_n839_));
  nand4  g739(.a(new_n637_), .b(new_n284_), .c(x40), .d(new_n279_), .O(new_n840_));
  nand2  g740(.a(new_n325_), .b(new_n285_), .O(new_n841_));
  aoi21  g741(.a(new_n840_), .b(new_n839_), .c(new_n841_), .O(new_n842_));
  nand2  g742(.a(new_n829_), .b(new_n489_), .O(new_n843_));
  oai21  g743(.a(new_n843_), .b(new_n842_), .c(new_n104_), .O(new_n844_));
  aoi21  g744(.a(new_n844_), .b(new_n647_), .c(x19), .O(new_n845_));
  nand2  g745(.a(x28), .b(new_n92_), .O(new_n846_));
  oai21  g746(.a(new_n117_), .b(new_n92_), .c(new_n846_), .O(new_n847_));
  nand2  g747(.a(new_n847_), .b(x19), .O(new_n848_));
  oai21  g748(.a(new_n183_), .b(new_n117_), .c(new_n848_), .O(new_n849_));
  oai21  g749(.a(new_n849_), .b(new_n845_), .c(x29), .O(new_n850_));
  nand2  g750(.a(x28), .b(new_n117_), .O(new_n851_));
  nand3  g751(.a(new_n700_), .b(new_n697_), .c(new_n699_), .O(new_n852_));
  oai21  g752(.a(new_n851_), .b(new_n368_), .c(new_n852_), .O(new_n853_));
  nand2  g753(.a(new_n853_), .b(new_n145_), .O(new_n854_));
  aoi21  g754(.a(new_n854_), .b(new_n850_), .c(new_n110_), .O(new_n855_));
  nand3  g755(.a(new_n202_), .b(x29), .c(new_n117_), .O(new_n856_));
  nand3  g756(.a(new_n703_), .b(x20), .c(x03), .O(new_n857_));
  aoi21  g757(.a(new_n857_), .b(new_n856_), .c(new_n91_), .O(new_n858_));
  nand2  g758(.a(new_n746_), .b(x20), .O(new_n859_));
  inv1   g759(.a(new_n859_), .O(new_n860_));
  oai21  g760(.a(new_n860_), .b(new_n858_), .c(x19), .O(new_n861_));
  nand2  g761(.a(new_n519_), .b(x00), .O(new_n862_));
  aoi21  g762(.a(new_n210_), .b(x17), .c(new_n214_), .O(new_n863_));
  aoi21  g763(.a(new_n862_), .b(new_n392_), .c(new_n863_), .O(new_n864_));
  nor4   g764(.a(new_n391_), .b(new_n385_), .c(x17), .d(new_n91_), .O(new_n865_));
  oai21  g765(.a(new_n865_), .b(new_n864_), .c(x26), .O(new_n866_));
  nand4  g766(.a(new_n615_), .b(new_n500_), .c(new_n147_), .d(new_n699_), .O(new_n867_));
  nand3  g767(.a(new_n867_), .b(new_n866_), .c(new_n861_), .O(new_n868_));
  nand2  g768(.a(new_n147_), .b(new_n699_), .O(new_n869_));
  nand3  g769(.a(new_n100_), .b(new_n174_), .c(x20), .O(new_n870_));
  nand2  g770(.a(new_n104_), .b(x13), .O(new_n871_));
  aoi21  g771(.a(new_n871_), .b(new_n870_), .c(new_n869_), .O(new_n872_));
  aoi21  g772(.a(new_n550_), .b(x19), .c(new_n846_), .O(new_n873_));
  oai21  g773(.a(new_n873_), .b(new_n872_), .c(new_n145_), .O(new_n874_));
  nand4  g774(.a(new_n822_), .b(new_n551_), .c(new_n92_), .d(x00), .O(new_n875_));
  nand3  g775(.a(new_n875_), .b(new_n874_), .c(new_n814_), .O(new_n876_));
  aoi21  g776(.a(new_n868_), .b(x18), .c(new_n876_), .O(new_n877_));
  inv1   g777(.a(x08), .O(new_n878_));
  nor2   g778(.a(x16), .b(x07), .O(new_n879_));
  aoi21  g779(.a(x16), .b(new_n878_), .c(new_n879_), .O(new_n880_));
  nand2  g780(.a(new_n499_), .b(new_n153_), .O(new_n881_));
  oai22  g781(.a(new_n881_), .b(new_n880_), .c(new_n391_), .d(new_n148_), .O(new_n882_));
  nand2  g782(.a(new_n882_), .b(new_n138_), .O(new_n883_));
  oai21  g783(.a(new_n877_), .b(x21), .c(new_n883_), .O(new_n884_));
  oai21  g784(.a(new_n884_), .b(new_n855_), .c(new_n119_), .O(new_n885_));
  nand3  g785(.a(x20), .b(x15), .c(new_n146_), .O(new_n886_));
  aoi21  g786(.a(new_n597_), .b(new_n368_), .c(new_n886_), .O(new_n887_));
  nand2  g787(.a(new_n107_), .b(x19), .O(new_n888_));
  inv1   g788(.a(new_n730_), .O(new_n889_));
  nand4  g789(.a(new_n889_), .b(x33), .c(new_n96_), .d(x09), .O(new_n890_));
  aoi21  g790(.a(new_n890_), .b(new_n888_), .c(x18), .O(new_n891_));
  oai21  g791(.a(new_n891_), .b(new_n887_), .c(new_n145_), .O(new_n892_));
  nand4  g792(.a(new_n551_), .b(new_n369_), .c(x25), .d(new_n222_), .O(new_n893_));
  aoi21  g793(.a(new_n893_), .b(new_n892_), .c(new_n125_), .O(new_n894_));
  nor4   g794(.a(new_n880_), .b(new_n368_), .c(new_n104_), .d(new_n117_), .O(new_n895_));
  oai21  g795(.a(new_n895_), .b(new_n894_), .c(x21), .O(new_n896_));
  nand2  g796(.a(new_n896_), .b(new_n885_), .O(z36));
  inv1   g797(.a(new_n270_), .O(new_n899_));
  xor2a  g798(.a(x20), .b(x02), .O(new_n900_));
  nor3   g799(.a(new_n900_), .b(new_n220_), .c(new_n104_), .O(new_n901_));
  nor2   g800(.a(x24), .b(x22), .O(new_n902_));
  aoi21  g801(.a(new_n902_), .b(new_n374_), .c(new_n224_), .O(new_n903_));
  oai21  g802(.a(new_n903_), .b(new_n901_), .c(new_n92_), .O(new_n904_));
  oai21  g803(.a(new_n163_), .b(new_n117_), .c(new_n268_), .O(new_n905_));
  nand4  g804(.a(new_n229_), .b(new_n110_), .c(x20), .d(x11), .O(new_n906_));
  nand2  g805(.a(new_n906_), .b(new_n905_), .O(new_n907_));
  nand2  g806(.a(new_n907_), .b(x18), .O(new_n908_));
  aoi21  g807(.a(new_n908_), .b(new_n904_), .c(x19), .O(new_n909_));
  nand3  g808(.a(x24), .b(x21), .c(x20), .O(new_n910_));
  nand2  g809(.a(new_n334_), .b(new_n229_), .O(new_n911_));
  aoi21  g810(.a(new_n911_), .b(new_n910_), .c(new_n92_), .O(new_n912_));
  nand2  g811(.a(new_n182_), .b(x28), .O(new_n913_));
  inv1   g812(.a(new_n913_), .O(new_n914_));
  oai21  g813(.a(new_n914_), .b(new_n912_), .c(x19), .O(new_n915_));
  nand2  g814(.a(new_n915_), .b(new_n248_), .O(new_n916_));
  oai21  g815(.a(new_n916_), .b(new_n909_), .c(x30), .O(new_n917_));
  nand3  g816(.a(new_n296_), .b(new_n262_), .c(x27), .O(new_n918_));
  aoi21  g817(.a(new_n918_), .b(new_n917_), .c(x29), .O(new_n919_));
  nand2  g818(.a(new_n242_), .b(x19), .O(new_n920_));
  nand3  g819(.a(new_n97_), .b(new_n96_), .c(new_n157_), .O(new_n921_));
  aoi21  g820(.a(new_n921_), .b(new_n920_), .c(x05), .O(new_n922_));
  nand2  g821(.a(new_n471_), .b(x19), .O(new_n923_));
  aoi21  g822(.a(new_n923_), .b(new_n821_), .c(new_n117_), .O(new_n924_));
  oai21  g823(.a(new_n924_), .b(new_n922_), .c(new_n92_), .O(new_n925_));
  nand2  g824(.a(new_n453_), .b(new_n96_), .O(new_n926_));
  nor2   g825(.a(new_n96_), .b(x04), .O(new_n927_));
  nand2  g826(.a(new_n927_), .b(new_n399_), .O(new_n928_));
  aoi21  g827(.a(new_n928_), .b(new_n926_), .c(new_n117_), .O(new_n929_));
  and2   g828(.a(new_n433_), .b(new_n214_), .O(new_n930_));
  oai21  g829(.a(new_n930_), .b(new_n929_), .c(x18), .O(new_n931_));
  nand2  g830(.a(new_n931_), .b(new_n925_), .O(new_n932_));
  nand2  g831(.a(new_n932_), .b(new_n119_), .O(new_n933_));
  nand4  g832(.a(new_n694_), .b(new_n126_), .c(new_n114_), .d(new_n146_), .O(new_n934_));
  aoi21  g833(.a(new_n934_), .b(new_n933_), .c(new_n685_), .O(new_n935_));
  oai21  g834(.a(new_n935_), .b(new_n919_), .c(new_n91_), .O(new_n936_));
  nand3  g835(.a(new_n214_), .b(new_n92_), .c(new_n271_), .O(new_n937_));
  oai21  g836(.a(new_n937_), .b(new_n899_), .c(new_n936_), .O(z38));
  nand2  g837(.a(new_n134_), .b(x21), .O(new_n940_));
  aoi21  g838(.a(new_n940_), .b(new_n212_), .c(new_n583_), .O(new_n941_));
  inv1   g839(.a(new_n500_), .O(new_n942_));
  nor2   g840(.a(new_n942_), .b(new_n212_), .O(new_n943_));
  oai21  g841(.a(new_n943_), .b(new_n941_), .c(x05), .O(new_n944_));
  nand3  g842(.a(new_n500_), .b(new_n213_), .c(x03), .O(new_n945_));
  nand2  g843(.a(new_n945_), .b(new_n944_), .O(new_n946_));
  nand2  g844(.a(new_n946_), .b(new_n92_), .O(new_n947_));
  nand2  g845(.a(new_n755_), .b(new_n145_), .O(new_n948_));
  oai22  g846(.a(new_n948_), .b(new_n614_), .c(new_n592_), .d(new_n311_), .O(new_n949_));
  nand4  g847(.a(new_n949_), .b(new_n804_), .c(x30), .d(x20), .O(new_n950_));
  aoi21  g848(.a(new_n950_), .b(new_n947_), .c(x28), .O(z40));
  nor4   g849(.a(new_n902_), .b(new_n565_), .c(new_n137_), .d(new_n533_), .O(z43));
  zero   g850(.O(z02));
  zero   g851(.O(z12));
  zero   g852(.O(z13));
  zero   g853(.O(z14));
