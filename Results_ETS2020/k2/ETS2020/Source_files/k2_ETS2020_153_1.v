// Benchmark "FAU" written by ABC on Wed Jun 24 05:12:45 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n1392_, new_n1394_, new_n1397_;
  ...
  nand2  g1293(.a(new_n100_), .b(x20), .O(new_n1397_));
  nor4   g1294(.a(new_n835_), .b(new_n1397_), .c(new_n104_), .d(new_n96_), .O(z43));
  zero   g1295(.O(z00));
  zero   g1296(.O(z02));
  zero   g1297(.O(z06));
  zero   g1298(.O(z07));
