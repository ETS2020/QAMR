// Benchmark "FAU" written by ABC on Wed Jun 24 05:15:28 2020
...
module FAU ( 
  ...
  inv1   g457(.a(new_n285_), .O(new_n556_));
  nor4   g458(.a(new_n359_), .b(new_n556_), .c(new_n218_), .d(new_n180_), .O(z21));
  ...
  nor2   g586(.a(x29), .b(new_n137_), .O(new_n689_));
  oai21  g587(.a(new_n452_), .b(x30), .c(new_n689_), .O(new_n690_));
  oai21  g588(.a(new_n428_), .b(new_n114_), .c(new_n580_), .O(new_n691_));
  nand2  g589(.a(new_n691_), .b(new_n582_), .O(new_n692_));
  nand2  g590(.a(new_n285_), .b(new_n94_), .O(new_n693_));
  aoi21  g591(.a(new_n692_), .b(new_n690_), .c(new_n693_), .O(z33));
  nor2   g592(.a(new_n351_), .b(x40), .O(new_n695_));
  nor3   g593(.a(x42), .b(x41), .c(x39), .O(new_n696_));
  nor2   g594(.a(x38), .b(x28), .O(new_n697_));
  nand4  g595(.a(new_n697_), .b(new_n696_), .c(new_n491_), .d(new_n316_), .O(new_n698_));
  oai21  g596(.a(new_n698_), .b(new_n695_), .c(new_n131_), .O(new_n699_));
  nand2  g597(.a(new_n699_), .b(x21), .O(new_n700_));
  nand4  g598(.a(new_n462_), .b(new_n126_), .c(new_n100_), .d(x00), .O(new_n701_));
  aoi21  g599(.a(new_n701_), .b(new_n700_), .c(x30), .O(new_n702_));
  nor2   g600(.a(new_n275_), .b(new_n272_), .O(new_n703_));
  nand3  g601(.a(new_n491_), .b(new_n316_), .c(new_n111_), .O(new_n704_));
  nor2   g602(.a(new_n704_), .b(new_n703_), .O(new_n705_));
  oai21  g603(.a(new_n705_), .b(new_n702_), .c(x29), .O(new_n706_));
  nand4  g604(.a(new_n436_), .b(new_n93_), .c(new_n147_), .d(x00), .O(new_n707_));
  nand2  g605(.a(new_n575_), .b(new_n245_), .O(new_n708_));
  aoi21  g606(.a(new_n708_), .b(new_n707_), .c(x21), .O(new_n709_));
  nand2  g607(.a(new_n122_), .b(x00), .O(new_n710_));
  inv1   g608(.a(new_n710_), .O(new_n711_));
  oai21  g609(.a(new_n711_), .b(new_n709_), .c(x28), .O(new_n712_));
  nand2  g610(.a(new_n108_), .b(new_n101_), .O(new_n713_));
  nand3  g611(.a(new_n713_), .b(new_n122_), .c(new_n114_), .O(new_n714_));
  aoi21  g612(.a(new_n714_), .b(new_n712_), .c(x29), .O(new_n715_));
  aoi21  g613(.a(x21), .b(x09), .c(x29), .O(new_n716_));
  nand2  g614(.a(x22), .b(new_n98_), .O(new_n717_));
  oai21  g615(.a(new_n717_), .b(new_n716_), .c(new_n676_), .O(new_n718_));
  nand2  g616(.a(new_n718_), .b(new_n93_), .O(new_n719_));
  nand3  g617(.a(new_n126_), .b(x29), .c(x22), .O(new_n720_));
  aoi21  g618(.a(new_n720_), .b(new_n719_), .c(x28), .O(new_n721_));
  oai21  g619(.a(new_n721_), .b(new_n715_), .c(x30), .O(new_n722_));
  nand2  g620(.a(new_n541_), .b(x19), .O(new_n723_));
  nand3  g621(.a(new_n723_), .b(new_n160_), .c(new_n148_), .O(new_n724_));
  nand3  g622(.a(new_n724_), .b(new_n722_), .c(new_n706_), .O(new_n725_));
  nand2  g623(.a(new_n725_), .b(new_n92_), .O(new_n726_));
  nand3  g624(.a(new_n137_), .b(x19), .c(new_n136_), .O(new_n727_));
  nand2  g625(.a(x26), .b(new_n93_), .O(new_n728_));
  oai22  g626(.a(new_n728_), .b(new_n383_), .c(new_n727_), .d(new_n382_), .O(new_n729_));
  nor2   g627(.a(x27), .b(new_n93_), .O(new_n730_));
  aoi22  g628(.a(new_n730_), .b(new_n490_), .c(new_n729_), .d(x00), .O(new_n731_));
  nor2   g629(.a(new_n177_), .b(new_n135_), .O(new_n732_));
  nor2   g630(.a(new_n732_), .b(new_n389_), .O(new_n733_));
  nand2  g631(.a(new_n733_), .b(x19), .O(new_n734_));
  nand2  g632(.a(new_n734_), .b(new_n387_), .O(new_n735_));
  nand2  g633(.a(new_n735_), .b(new_n103_), .O(new_n736_));
  oai21  g634(.a(new_n731_), .b(new_n103_), .c(new_n736_), .O(new_n737_));
  nand3  g635(.a(new_n595_), .b(x21), .c(new_n212_), .O(new_n738_));
  nor4   g636(.a(new_n738_), .b(new_n405_), .c(x28), .d(x19), .O(new_n739_));
  aoi21  g637(.a(new_n737_), .b(new_n100_), .c(new_n739_), .O(new_n740_));
  and2   g638(.a(new_n398_), .b(new_n397_), .O(new_n741_));
  nor2   g639(.a(new_n100_), .b(x19), .O(new_n742_));
  aoi21  g640(.a(new_n151_), .b(x26), .c(new_n742_), .O(new_n743_));
  nand2  g641(.a(new_n151_), .b(x00), .O(new_n744_));
  oai22  g642(.a(new_n744_), .b(new_n224_), .c(new_n743_), .d(new_n741_), .O(new_n745_));
  nor4   g643(.a(new_n397_), .b(new_n142_), .c(new_n100_), .d(x19), .O(new_n746_));
  aoi21  g644(.a(new_n745_), .b(new_n98_), .c(new_n746_), .O(new_n747_));
  oai21  g645(.a(new_n740_), .b(new_n98_), .c(new_n747_), .O(new_n748_));
  nand2  g646(.a(new_n748_), .b(x18), .O(new_n749_));
  nand2  g647(.a(new_n749_), .b(new_n726_), .O(z34));
  oai21  g648(.a(new_n348_), .b(new_n260_), .c(new_n354_), .O(new_n751_));
  nand2  g649(.a(new_n751_), .b(new_n114_), .O(new_n752_));
  aoi21  g650(.a(new_n752_), .b(new_n460_), .c(x20), .O(new_n753_));
  nand3  g651(.a(new_n114_), .b(new_n591_), .c(new_n136_), .O(new_n754_));
  aoi21  g652(.a(new_n754_), .b(x19), .c(new_n142_), .O(new_n755_));
  aoi21  g653(.a(new_n108_), .b(new_n101_), .c(x19), .O(new_n756_));
  oai21  g654(.a(new_n756_), .b(new_n755_), .c(x20), .O(new_n757_));
  aoi21  g655(.a(new_n757_), .b(new_n131_), .c(new_n118_), .O(new_n758_));
  oai21  g656(.a(new_n758_), .b(new_n753_), .c(x21), .O(new_n759_));
  inv1   g657(.a(x06), .O(new_n760_));
  nand3  g658(.a(new_n245_), .b(x20), .c(new_n760_), .O(new_n761_));
  nand2  g659(.a(new_n761_), .b(new_n437_), .O(new_n762_));
  nand2  g660(.a(new_n762_), .b(x28), .O(new_n763_));
  oai21  g661(.a(x03), .b(x02), .c(x28), .O(new_n764_));
  oai21  g662(.a(x28), .b(new_n164_), .c(new_n119_), .O(new_n765_));
  aoi21  g663(.a(new_n764_), .b(new_n98_), .c(new_n765_), .O(new_n766_));
  aoi21  g664(.a(new_n766_), .b(new_n763_), .c(x19), .O(new_n767_));
  nand2  g665(.a(new_n511_), .b(new_n232_), .O(new_n768_));
  nand2  g666(.a(x23), .b(new_n98_), .O(new_n769_));
  aoi21  g667(.a(new_n769_), .b(new_n768_), .c(new_n93_), .O(new_n770_));
  oai21  g668(.a(new_n770_), .b(new_n767_), .c(new_n100_), .O(new_n771_));
  aoi21  g669(.a(new_n771_), .b(new_n759_), .c(x18), .O(new_n772_));
  nand2  g670(.a(new_n100_), .b(x18), .O(new_n773_));
  oai22  g671(.a(new_n773_), .b(new_n218_), .c(new_n634_), .d(new_n217_), .O(new_n774_));
  nand2  g672(.a(new_n774_), .b(new_n93_), .O(new_n775_));
  nand2  g673(.a(new_n122_), .b(x18), .O(new_n776_));
  aoi21  g674(.a(new_n776_), .b(new_n775_), .c(new_n118_), .O(new_n777_));
  aoi21  g675(.a(new_n423_), .b(new_n93_), .c(new_n773_), .O(new_n778_));
  oai21  g676(.a(new_n778_), .b(new_n777_), .c(x20), .O(new_n779_));
  nand2  g677(.a(new_n325_), .b(new_n94_), .O(new_n780_));
  nand4  g678(.a(new_n199_), .b(new_n153_), .c(new_n111_), .d(x00), .O(new_n781_));
  aoi21  g679(.a(new_n781_), .b(new_n780_), .c(new_n191_), .O(new_n782_));
  nand4  g680(.a(x28), .b(x26), .c(new_n100_), .d(x19), .O(new_n783_));
  nand3  g681(.a(new_n114_), .b(x21), .c(new_n93_), .O(new_n784_));
  aoi21  g682(.a(new_n784_), .b(new_n783_), .c(new_n118_), .O(new_n785_));
  oai21  g683(.a(new_n785_), .b(new_n662_), .c(x18), .O(new_n786_));
  oai21  g684(.a(new_n302_), .b(new_n142_), .c(new_n786_), .O(new_n787_));
  aoi21  g685(.a(new_n787_), .b(new_n98_), .c(new_n782_), .O(new_n788_));
  nand2  g686(.a(new_n788_), .b(new_n779_), .O(new_n789_));
  oai21  g687(.a(new_n789_), .b(new_n772_), .c(new_n135_), .O(new_n790_));
  nor2   g688(.a(x28), .b(x27), .O(new_n791_));
  nor2   g689(.a(new_n92_), .b(new_n136_), .O(new_n792_));
  nand2  g690(.a(new_n792_), .b(new_n791_), .O(new_n793_));
  oai21  g691(.a(new_n463_), .b(x18), .c(new_n793_), .O(new_n794_));
  nand3  g692(.a(new_n794_), .b(new_n677_), .c(new_n126_), .O(new_n795_));
  nand2  g693(.a(new_n795_), .b(new_n790_), .O(new_n796_));
  nand2  g694(.a(new_n796_), .b(x30), .O(new_n797_));
  inv1   g695(.a(new_n689_), .O(new_n798_));
  nand3  g696(.a(new_n92_), .b(new_n136_), .c(x00), .O(new_n799_));
  nand2  g697(.a(new_n491_), .b(new_n510_), .O(new_n800_));
  oai22  g698(.a(new_n800_), .b(new_n799_), .c(new_n798_), .d(new_n546_), .O(new_n801_));
  nand2  g699(.a(new_n801_), .b(new_n147_), .O(new_n802_));
  oai22  g700(.a(new_n681_), .b(new_n423_), .c(new_n672_), .d(new_n193_), .O(new_n803_));
  nor2   g701(.a(x04), .b(new_n118_), .O(new_n804_));
  nor3   g702(.a(new_n804_), .b(new_n389_), .c(new_n127_), .O(new_n805_));
  aoi21  g703(.a(new_n803_), .b(x00), .c(new_n805_), .O(new_n806_));
  nand2  g704(.a(new_n114_), .b(x05), .O(new_n807_));
  nand3  g705(.a(new_n807_), .b(x22), .c(x19), .O(new_n808_));
  nand2  g706(.a(new_n514_), .b(new_n93_), .O(new_n809_));
  nand2  g707(.a(new_n809_), .b(new_n808_), .O(new_n810_));
  nand4  g708(.a(new_n810_), .b(x20), .c(new_n92_), .d(x00), .O(new_n811_));
  oai21  g709(.a(new_n806_), .b(new_n92_), .c(new_n811_), .O(new_n812_));
  nand2  g710(.a(new_n812_), .b(x29), .O(new_n813_));
  aoi21  g711(.a(new_n813_), .b(new_n802_), .c(x21), .O(new_n814_));
  nand3  g712(.a(new_n315_), .b(new_n93_), .c(new_n353_), .O(new_n815_));
  oai21  g713(.a(new_n815_), .b(new_n314_), .c(new_n98_), .O(new_n816_));
  nand2  g714(.a(new_n595_), .b(x20), .O(new_n817_));
  nor2   g715(.a(new_n817_), .b(x19), .O(new_n818_));
  aoi21  g716(.a(new_n816_), .b(x22), .c(new_n818_), .O(new_n819_));
  nor2   g717(.a(new_n377_), .b(new_n130_), .O(new_n820_));
  oai21  g718(.a(new_n819_), .b(x28), .c(new_n820_), .O(new_n821_));
  nand2  g719(.a(new_n821_), .b(x21), .O(new_n822_));
  nand2  g720(.a(new_n579_), .b(new_n791_), .O(new_n823_));
  aoi21  g721(.a(new_n823_), .b(new_n822_), .c(new_n135_), .O(new_n824_));
  oai21  g722(.a(new_n824_), .b(new_n814_), .c(new_n103_), .O(new_n825_));
  nand2  g723(.a(new_n825_), .b(new_n797_), .O(z35));
  nand2  g724(.a(x42), .b(x39), .O(new_n827_));
  nand4  g725(.a(new_n628_), .b(new_n273_), .c(x40), .d(new_n268_), .O(new_n828_));
  nand2  g726(.a(new_n316_), .b(new_n274_), .O(new_n829_));
  aoi21  g727(.a(new_n828_), .b(new_n827_), .c(new_n829_), .O(new_n830_));
  nand2  g728(.a(new_n817_), .b(new_n480_), .O(new_n831_));
  oai21  g729(.a(new_n831_), .b(new_n830_), .c(new_n114_), .O(new_n832_));
  aoi21  g730(.a(new_n832_), .b(new_n638_), .c(x19), .O(new_n833_));
  nand2  g731(.a(x28), .b(new_n92_), .O(new_n834_));
  oai21  g732(.a(new_n98_), .b(new_n92_), .c(new_n834_), .O(new_n835_));
  nand2  g733(.a(new_n835_), .b(x19), .O(new_n836_));
  oai21  g734(.a(new_n173_), .b(new_n98_), .c(new_n836_), .O(new_n837_));
  oai21  g735(.a(new_n837_), .b(new_n833_), .c(x29), .O(new_n838_));
  nand2  g736(.a(x28), .b(new_n98_), .O(new_n839_));
  inv1   g737(.a(x14), .O(new_n840_));
  nor2   g738(.a(x13), .b(x12), .O(new_n841_));
  nand3  g739(.a(new_n841_), .b(new_n791_), .c(new_n840_), .O(new_n842_));
  oai21  g740(.a(new_n839_), .b(new_n359_), .c(new_n842_), .O(new_n843_));
  nand2  g741(.a(new_n843_), .b(new_n135_), .O(new_n844_));
  aoi21  g742(.a(new_n844_), .b(new_n838_), .c(new_n100_), .O(new_n845_));
  nand3  g743(.a(new_n192_), .b(x29), .c(new_n98_), .O(new_n846_));
  nand3  g744(.a(new_n689_), .b(x20), .c(x03), .O(new_n847_));
  aoi21  g745(.a(new_n847_), .b(new_n846_), .c(new_n118_), .O(new_n848_));
  nand2  g746(.a(new_n733_), .b(x20), .O(new_n849_));
  inv1   g747(.a(new_n849_), .O(new_n850_));
  oai21  g748(.a(new_n850_), .b(new_n848_), .c(x19), .O(new_n851_));
  nand2  g749(.a(new_n510_), .b(x00), .O(new_n852_));
  aoi21  g750(.a(new_n199_), .b(x17), .c(new_n204_), .O(new_n853_));
  aoi21  g751(.a(new_n852_), .b(new_n383_), .c(new_n853_), .O(new_n854_));
  nor4   g752(.a(new_n382_), .b(new_n376_), .c(x17), .d(new_n118_), .O(new_n855_));
  oai21  g753(.a(new_n855_), .b(new_n854_), .c(x26), .O(new_n856_));
  nand4  g754(.a(new_n606_), .b(new_n491_), .c(new_n137_), .d(new_n840_), .O(new_n857_));
  nand3  g755(.a(new_n857_), .b(new_n856_), .c(new_n851_), .O(new_n858_));
  nand2  g756(.a(new_n137_), .b(new_n840_), .O(new_n859_));
  nand3  g757(.a(new_n95_), .b(new_n164_), .c(x20), .O(new_n860_));
  nand2  g758(.a(new_n114_), .b(x13), .O(new_n861_));
  aoi21  g759(.a(new_n861_), .b(new_n860_), .c(new_n859_), .O(new_n862_));
  aoi21  g760(.a(new_n541_), .b(x19), .c(new_n834_), .O(new_n863_));
  oai21  g761(.a(new_n863_), .b(new_n862_), .c(new_n135_), .O(new_n864_));
  nand4  g762(.a(new_n810_), .b(new_n542_), .c(new_n92_), .d(x00), .O(new_n865_));
  nand3  g763(.a(new_n865_), .b(new_n864_), .c(new_n802_), .O(new_n866_));
  aoi21  g764(.a(new_n858_), .b(x18), .c(new_n866_), .O(new_n867_));
  inv1   g765(.a(x08), .O(new_n868_));
  nor2   g766(.a(x16), .b(x07), .O(new_n869_));
  aoi21  g767(.a(x16), .b(new_n868_), .c(new_n869_), .O(new_n870_));
  nand2  g768(.a(new_n490_), .b(new_n143_), .O(new_n871_));
  oai22  g769(.a(new_n871_), .b(new_n870_), .c(new_n382_), .d(new_n138_), .O(new_n872_));
  nand2  g770(.a(new_n872_), .b(new_n126_), .O(new_n873_));
  oai21  g771(.a(new_n867_), .b(x21), .c(new_n873_), .O(new_n874_));
  oai21  g772(.a(new_n874_), .b(new_n845_), .c(new_n103_), .O(new_n875_));
  nand3  g773(.a(x20), .b(x15), .c(new_n136_), .O(new_n876_));
  aoi21  g774(.a(new_n588_), .b(new_n359_), .c(new_n876_), .O(new_n877_));
  nand2  g775(.a(new_n713_), .b(x19), .O(new_n878_));
  inv1   g776(.a(new_n717_), .O(new_n879_));
  nand4  g777(.a(new_n879_), .b(x33), .c(new_n93_), .d(x09), .O(new_n880_));
  aoi21  g778(.a(new_n880_), .b(new_n878_), .c(x18), .O(new_n881_));
  oai21  g779(.a(new_n881_), .b(new_n877_), .c(new_n135_), .O(new_n882_));
  nand4  g780(.a(new_n542_), .b(new_n360_), .c(x25), .d(new_n212_), .O(new_n883_));
  aoi21  g781(.a(new_n883_), .b(new_n882_), .c(new_n294_), .O(new_n884_));
  nor4   g782(.a(new_n870_), .b(new_n359_), .c(new_n114_), .d(new_n98_), .O(new_n885_));
  oai21  g783(.a(new_n885_), .b(new_n884_), .c(x21), .O(new_n886_));
  nand2  g784(.a(new_n886_), .b(new_n875_), .O(z36));
  inv1   g785(.a(new_n259_), .O(new_n889_));
  xor2a  g786(.a(x20), .b(x02), .O(new_n890_));
  nor3   g787(.a(new_n890_), .b(new_n210_), .c(new_n114_), .O(new_n891_));
  nor2   g788(.a(x24), .b(x22), .O(new_n892_));
  aoi21  g789(.a(new_n892_), .b(new_n365_), .c(new_n214_), .O(new_n893_));
  oai21  g790(.a(new_n893_), .b(new_n891_), .c(new_n92_), .O(new_n894_));
  oai21  g791(.a(new_n153_), .b(new_n98_), .c(new_n111_), .O(new_n895_));
  nand4  g792(.a(new_n219_), .b(new_n100_), .c(x20), .d(x11), .O(new_n896_));
  nand2  g793(.a(new_n896_), .b(new_n895_), .O(new_n897_));
  nand2  g794(.a(new_n897_), .b(x18), .O(new_n898_));
  aoi21  g795(.a(new_n898_), .b(new_n894_), .c(x19), .O(new_n899_));
  nand3  g796(.a(x24), .b(x21), .c(x20), .O(new_n900_));
  nand2  g797(.a(new_n325_), .b(new_n219_), .O(new_n901_));
  aoi21  g798(.a(new_n901_), .b(new_n900_), .c(new_n92_), .O(new_n902_));
  nand2  g799(.a(new_n172_), .b(x28), .O(new_n903_));
  inv1   g800(.a(new_n903_), .O(new_n904_));
  oai21  g801(.a(new_n904_), .b(new_n902_), .c(x19), .O(new_n905_));
  nand2  g802(.a(new_n905_), .b(new_n238_), .O(new_n906_));
  oai21  g803(.a(new_n906_), .b(new_n899_), .c(x30), .O(new_n907_));
  nand3  g804(.a(new_n285_), .b(new_n252_), .c(x27), .O(new_n908_));
  aoi21  g805(.a(new_n908_), .b(new_n907_), .c(x29), .O(new_n909_));
  nand2  g806(.a(new_n232_), .b(x19), .O(new_n910_));
  nand3  g807(.a(new_n128_), .b(new_n93_), .c(new_n147_), .O(new_n911_));
  aoi21  g808(.a(new_n911_), .b(new_n910_), .c(x05), .O(new_n912_));
  nand2  g809(.a(new_n462_), .b(x19), .O(new_n913_));
  aoi21  g810(.a(new_n913_), .b(new_n809_), .c(new_n98_), .O(new_n914_));
  oai21  g811(.a(new_n914_), .b(new_n912_), .c(new_n92_), .O(new_n915_));
  nand2  g812(.a(new_n444_), .b(new_n93_), .O(new_n916_));
  nor2   g813(.a(new_n93_), .b(x04), .O(new_n917_));
  nand2  g814(.a(new_n917_), .b(new_n390_), .O(new_n918_));
  aoi21  g815(.a(new_n918_), .b(new_n916_), .c(new_n98_), .O(new_n919_));
  and2   g816(.a(new_n424_), .b(new_n204_), .O(new_n920_));
  oai21  g817(.a(new_n920_), .b(new_n919_), .c(x18), .O(new_n921_));
  nand2  g818(.a(new_n921_), .b(new_n915_), .O(new_n922_));
  nand2  g819(.a(new_n922_), .b(new_n103_), .O(new_n923_));
  nand4  g820(.a(new_n685_), .b(new_n296_), .c(new_n94_), .d(new_n136_), .O(new_n924_));
  aoi21  g821(.a(new_n924_), .b(new_n923_), .c(new_n676_), .O(new_n925_));
  oai21  g822(.a(new_n925_), .b(new_n909_), .c(new_n118_), .O(new_n926_));
  nand3  g823(.a(new_n204_), .b(new_n92_), .c(new_n260_), .O(new_n927_));
  oai21  g824(.a(new_n927_), .b(new_n889_), .c(new_n926_), .O(z38));
  nand2  g825(.a(new_n104_), .b(x21), .O(new_n930_));
  aoi21  g826(.a(new_n930_), .b(new_n202_), .c(new_n574_), .O(new_n931_));
  inv1   g827(.a(new_n491_), .O(new_n932_));
  nor2   g828(.a(new_n932_), .b(new_n202_), .O(new_n933_));
  oai21  g829(.a(new_n933_), .b(new_n931_), .c(x05), .O(new_n934_));
  nand3  g830(.a(new_n491_), .b(new_n203_), .c(x03), .O(new_n935_));
  nand2  g831(.a(new_n935_), .b(new_n934_), .O(new_n936_));
  nand2  g832(.a(new_n936_), .b(new_n92_), .O(new_n937_));
  nand2  g833(.a(new_n742_), .b(new_n135_), .O(new_n938_));
  oai22  g834(.a(new_n938_), .b(new_n605_), .c(new_n583_), .d(new_n302_), .O(new_n939_));
  nand4  g835(.a(new_n939_), .b(new_n792_), .c(x30), .d(x20), .O(new_n940_));
  aoi21  g836(.a(new_n940_), .b(new_n937_), .c(x28), .O(z40));
  nor4   g837(.a(new_n892_), .b(new_n556_), .c(new_n125_), .d(new_n524_), .O(z43));
  zero   g838(.O(z00));
  zero   g839(.O(z02));
  zero   g840(.O(z12));
  zero   g841(.O(z13));
