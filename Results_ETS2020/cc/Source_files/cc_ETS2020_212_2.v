...
module FAU ( 
  ...
  nand2  g07(.a(x10), .b(x08), .O(new_n54_));
  nand2  g08(.a(new_n54_), .b(x15), .O(new_n55_));
  inv1   g09(.a(x15), .O(new_n56_));
  nand4  g10(.a(new_n56_), .b(x10), .c(x08), .d(x02), .O(new_n57_));
  aoi21  g11(.a(new_n57_), .b(new_n55_), .c(new_n53_), .O(z14));
  zero   g12(.O(z00));
  zero   g13(.O(z02));
  zero   g14(.O(z03));
  zero   g15(.O(z12));
