...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(x18), .O(new_n72_));
  nand4  g29(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n73_));
  aoi21  g30(.a(new_n73_), .b(new_n72_), .c(new_n56_), .O(z17));
  nand2  g31(.a(new_n46_), .b(x19), .O(new_n75_));
  nand4  g32(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g33(.a(new_n76_), .b(new_n75_), .c(new_n56_), .O(z18));
  nand2  g34(.a(new_n46_), .b(x20), .O(new_n78_));
  nand4  g35(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(new_n78_), .c(new_n56_), .O(z19));
  zero   g37(.O(z01));
  zero   g38(.O(z16));
  buf    g39(.a(x19), .O(z05));
  buf    g40(.a(x15), .O(z06));
