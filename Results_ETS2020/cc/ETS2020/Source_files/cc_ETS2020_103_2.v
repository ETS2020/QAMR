...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19;
  wire new_n43_, new_n44_, new_n52_, new_n53_, new_n54_, new_n55_;
  ...
  nand3  g07(.a(x10), .b(x08), .c(x01), .O(new_n53_));
  nand2  g08(.a(new_n53_), .b(x14), .O(new_n54_));
  nand3  g09(.a(x15), .b(x10), .c(x08), .O(new_n55_));
  aoi21  g10(.a(new_n55_), .b(new_n54_), .c(new_n52_), .O(z13));
  zero   g11(.O(z00));
  zero   g12(.O(z02));
  zero   g13(.O(z03));
  zero   g14(.O(z12));
