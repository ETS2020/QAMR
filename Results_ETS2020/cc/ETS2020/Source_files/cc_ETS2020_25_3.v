...
module FAU ( 
  ...
  nand3  g23(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n69_));
  nand4  g24(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n70_));
  aoi21  g25(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z15));
  nand2  g26(.a(new_n46_), .b(x17), .O(new_n72_));
  nand4  g27(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n73_));
  aoi21  g28(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z16));
  nand2  g29(.a(new_n46_), .b(x18), .O(new_n75_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(new_n75_), .c(new_n57_), .O(z17));
  nand2  g32(.a(new_n46_), .b(x19), .O(new_n78_));
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n79_));
  aoi21  g34(.a(new_n79_), .b(new_n78_), .c(new_n57_), .O(z18));
  nand2  g35(.a(new_n46_), .b(x20), .O(new_n81_));
  nand4  g36(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n82_));
  aoi21  g37(.a(new_n82_), .b(new_n81_), .c(new_n57_), .O(z19));
  zero   g38(.O(z00));
  zero   g39(.O(z01));
  zero   g40(.O(z04));
  zero   g41(.O(z05));
