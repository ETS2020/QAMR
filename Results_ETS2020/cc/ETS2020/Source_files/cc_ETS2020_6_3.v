// Benchmark "FAU" written by ABC on Tue Jun 23 04:01:48 2020
...
module FAU ( 
  ...
  nand2  g29(.a(new_n46_), .b(x18), .O(new_n74_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n75_));
  aoi21  g31(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(z17));
  nand2  g32(.a(new_n46_), .b(x19), .O(new_n77_));
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n78_));
  aoi21  g34(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(z18));
  nand2  g35(.a(new_n46_), .b(x20), .O(new_n80_));
  nand4  g36(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n81_));
  aoi21  g37(.a(new_n81_), .b(new_n80_), .c(new_n56_), .O(z19));
  zero   g38(.O(z00));
  zero   g39(.O(z01));
  zero   g40(.O(z04));
  buf    g41(.a(x19), .O(z05));
