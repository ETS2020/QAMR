...
module FAU ( 
  ...
  nand2  g20(.a(new_n46_), .b(new_n43_), .O(new_n47_));
  inv1   g21(.a(x11), .O(new_n48_));
  nand2  g22(.a(new_n48_), .b(x01), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(new_n47_), .c(new_n41_), .O(new_n50_));
  inv1   g24(.a(x08), .O(new_n51_));
  nand2  g25(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  inv1   g26(.a(x10), .O(new_n53_));
  nand2  g27(.a(new_n53_), .b(x01), .O(new_n54_));
  aoi21  g28(.a(new_n54_), .b(new_n52_), .c(x00), .O(new_n55_));
  nand2  g29(.a(x05), .b(new_n31_), .O(new_n56_));
  inv1   g30(.a(x07), .O(new_n57_));
  inv1   g31(.a(x12), .O(new_n58_));
  nand3  g32(.a(x13), .b(new_n58_), .c(new_n57_), .O(new_n59_));
  nor2   g33(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  oai21  g34(.a(new_n55_), .b(new_n50_), .c(new_n60_), .O(new_n61_));
  nand3  g35(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n62_));
  nand2  g36(.a(x04), .b(new_n26_), .O(new_n63_));
  aoi21  g37(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z06));
  nor2   g38(.a(new_n39_), .b(new_n37_), .O(z07));
  nand4  g39(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n66_));
  aoi21  g40(.a(new_n66_), .b(new_n62_), .c(new_n63_), .O(z08));
  nand3  g41(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n69_));
  inv1   g42(.a(new_n69_), .O(z10));
  zero   g43(.O(z05));
  zero   g44(.O(z09));
endmodule
