// Benchmark "FAU" written by ABC on Tue Jun 23 02:56:09 2020
...
module FAU ( 
  ...
  nand4  g27(.a(x13), .b(new_n53_), .c(x05), .d(new_n31_), .O(new_n54_));
  ...
  nand3  g32(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n59_));
  inv1   g33(.a(new_n59_), .O(z10));
  zero   g34(.O(z06));
endmodule
