...
module FAU ( 
  ...
  nand4  g434(.a(new_n307_), .b(new_n257_), .c(new_n198_), .d(new_n168_), .O(new_n581_));
  inv1   g435(.a(new_n415_), .O(new_n582_));
  nor2   g436(.a(x60), .b(new_n350_), .O(new_n583_));
  nand4  g437(.a(new_n583_), .b(new_n582_), .c(new_n413_), .d(new_n360_), .O(new_n584_));
  nor2   g438(.a(new_n584_), .b(new_n581_), .O(z63));
  nor2   g439(.a(x37), .b(new_n343_), .O(new_n586_));
  nand4  g440(.a(new_n586_), .b(new_n582_), .c(new_n413_), .d(new_n297_), .O(new_n587_));
  nor2   g441(.a(new_n587_), .b(new_n581_), .O(z64));
  zero   g442(.O(z03));
  zero   g443(.O(z04));
  zero   g444(.O(z06));
  zero   g445(.O(z13));
