...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n599_, new_n600_, new_n602_, new_n603_, new_n604_;
  ...
  nor2   g455(.a(x10), .b(new_n469_), .O(new_n596_));
  nand4  g456(.a(new_n596_), .b(new_n341_), .c(new_n308_), .d(new_n170_), .O(new_n597_));
  nand3  g457(.a(new_n404_), .b(new_n332_), .c(new_n319_), .O(new_n598_));
  nand2  g458(.a(new_n327_), .b(new_n190_), .O(new_n599_));
  nand2  g459(.a(new_n157_), .b(new_n151_), .O(new_n600_));
  nor4   g460(.a(new_n600_), .b(new_n599_), .c(new_n598_), .d(new_n597_), .O(z61));
  nand3  g461(.a(new_n297_), .b(new_n319_), .c(x47), .O(new_n602_));
  nor2   g462(.a(new_n602_), .b(new_n350_), .O(new_n603_));
  nand3  g463(.a(new_n603_), .b(new_n132_), .c(new_n184_), .O(new_n604_));
  nor3   g464(.a(new_n604_), .b(new_n351_), .c(new_n346_), .O(z62));
  zero   g465(.O(z09));
  zero   g466(.O(z19));
  zero   g467(.O(z29));
  zero   g468(.O(z30));
