...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n475_, new_n478_, new_n479_, new_n480_, new_n482_, new_n489_,
  ...
  nor3   g329(.a(new_n300_), .b(x08), .c(new_n141_), .O(new_n489_));
  nand2  g330(.a(new_n271_), .b(new_n269_), .O(new_n490_));
  nor2   g331(.a(new_n490_), .b(new_n309_), .O(new_n491_));
  nand3  g332(.a(new_n491_), .b(new_n489_), .c(new_n306_), .O(new_n492_));
  inv1   g333(.a(new_n492_), .O(z60));
  inv1   g334(.a(new_n328_), .O(new_n495_));
  nor2   g335(.a(new_n305_), .b(new_n300_), .O(new_n496_));
  nand2  g336(.a(new_n168_), .b(x47), .O(new_n497_));
  nor2   g337(.a(new_n497_), .b(new_n490_), .O(new_n498_));
  nand4  g338(.a(new_n498_), .b(new_n496_), .c(new_n495_), .d(new_n302_), .O(new_n499_));
  inv1   g339(.a(new_n499_), .O(z62));
  nand4  g340(.a(new_n269_), .b(new_n334_), .c(x56), .d(new_n168_), .O(new_n501_));
  inv1   g341(.a(new_n501_), .O(new_n502_));
  nand4  g342(.a(new_n502_), .b(new_n496_), .c(new_n495_), .d(new_n302_), .O(new_n503_));
  inv1   g343(.a(new_n503_), .O(z63));
  nor2   g344(.a(x37), .b(new_n180_), .O(new_n505_));
  nand3  g345(.a(new_n505_), .b(new_n330_), .c(new_n495_), .O(new_n506_));
  nor3   g346(.a(new_n506_), .b(new_n305_), .c(new_n300_), .O(z64));
  zero   g347(.O(z00));
  zero   g348(.O(z01));
  zero   g349(.O(z04));
  zero   g350(.O(z07));
