...
module FAU ( 
  ...
  nor2   g452(.a(new_n345_), .b(new_n341_), .O(new_n593_));
  nand2  g453(.a(new_n292_), .b(new_n277_), .O(new_n594_));
  inv1   g454(.a(new_n594_), .O(new_n595_));
  nand2  g455(.a(new_n595_), .b(new_n343_), .O(new_n596_));
  inv1   g456(.a(new_n596_), .O(new_n597_));
  nand2  g457(.a(new_n314_), .b(x47), .O(new_n598_));
  nor2   g458(.a(new_n598_), .b(new_n583_), .O(new_n599_));
  nand3  g459(.a(new_n599_), .b(new_n597_), .c(new_n593_), .O(new_n600_));
  inv1   g460(.a(new_n600_), .O(z62));
  nand4  g461(.a(new_n144_), .b(new_n179_), .c(x56), .d(new_n314_), .O(new_n602_));
  inv1   g462(.a(new_n602_), .O(new_n603_));
  nand3  g463(.a(new_n603_), .b(new_n597_), .c(new_n593_), .O(new_n604_));
  inv1   g464(.a(new_n604_), .O(z63));
  nor2   g465(.a(new_n580_), .b(x60), .O(new_n606_));
  nand4  g466(.a(new_n606_), .b(new_n595_), .c(new_n248_), .d(x30), .O(new_n607_));
  nor3   g467(.a(new_n607_), .b(new_n345_), .c(new_n341_), .O(z64));
  zero   g468(.O(z02));
  zero   g469(.O(z10));
  zero   g470(.O(z28));
  zero   g471(.O(z36));
