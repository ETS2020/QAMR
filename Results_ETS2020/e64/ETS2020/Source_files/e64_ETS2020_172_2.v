...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n608_, new_n609_, new_n610_, new_n611_, new_n616_, new_n617_,
  ...
  nand2  g479(.a(new_n325_), .b(x47), .O(new_n617_));
  nand2  g480(.a(new_n132_), .b(new_n300_), .O(new_n618_));
  nor2   g481(.a(new_n618_), .b(new_n617_), .O(new_n619_));
  nand4  g482(.a(new_n619_), .b(new_n616_), .c(new_n426_), .d(new_n347_), .O(new_n620_));
  inv1   g483(.a(new_n620_), .O(z62));
  nand4  g484(.a(new_n300_), .b(new_n176_), .c(x56), .d(new_n325_), .O(new_n622_));
  inv1   g485(.a(new_n622_), .O(new_n623_));
  nand4  g486(.a(new_n623_), .b(new_n616_), .c(new_n426_), .d(new_n347_), .O(new_n624_));
  inv1   g487(.a(new_n624_), .O(z63));
  nand4  g488(.a(new_n429_), .b(new_n426_), .c(new_n249_), .d(x30), .O(new_n626_));
  nor3   g489(.a(new_n626_), .b(new_n349_), .c(new_n345_), .O(z64));
  zero   g490(.O(z03));
  zero   g491(.O(z17));
  zero   g492(.O(z19));
  zero   g493(.O(z32));
