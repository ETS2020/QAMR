...
module FAU ( 
  ...
  nor2   g459(.a(new_n346_), .b(new_n342_), .O(new_n599_));
  nand2  g460(.a(new_n314_), .b(x47), .O(new_n600_));
  nor2   g461(.a(new_n600_), .b(new_n589_), .O(new_n601_));
  nand4  g462(.a(new_n601_), .b(new_n599_), .c(new_n435_), .d(new_n344_), .O(new_n602_));
  inv1   g463(.a(new_n602_), .O(z62));
  nand4  g464(.a(new_n144_), .b(new_n179_), .c(x56), .d(new_n314_), .O(new_n604_));
  inv1   g465(.a(new_n604_), .O(new_n605_));
  nand4  g466(.a(new_n605_), .b(new_n599_), .c(new_n435_), .d(new_n344_), .O(new_n606_));
  inv1   g467(.a(new_n606_), .O(z63));
  nand4  g468(.a(new_n438_), .b(new_n435_), .c(new_n248_), .d(x30), .O(new_n608_));
  nor3   g469(.a(new_n608_), .b(new_n346_), .c(new_n342_), .O(z64));
  zero   g470(.O(z02));
  zero   g471(.O(z10));
  zero   g472(.O(z36));
  zero   g473(.O(z40));
