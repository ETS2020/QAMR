...
module FAU ( 
  ...
  wire new_n133_, new_n134_, new_n135_, new_n136_, new_n137_, new_n138_,
    ...
    new_n490_, new_n497_, new_n498_, new_n499_, new_n500_, new_n503_,
  ...
  nor3   g339(.a(new_n306_), .b(x08), .c(new_n298_), .O(new_n497_));
  nand2  g340(.a(new_n280_), .b(new_n207_), .O(new_n498_));
  nor2   g341(.a(new_n498_), .b(new_n314_), .O(new_n499_));
  nand3  g342(.a(new_n499_), .b(new_n497_), .c(new_n312_), .O(new_n500_));
  inv1   g343(.a(new_n500_), .O(z60));
  inv1   g344(.a(new_n357_), .O(new_n503_));
  nor2   g345(.a(new_n311_), .b(new_n306_), .O(new_n504_));
  nor3   g346(.a(new_n498_), .b(x50), .c(new_n184_), .O(new_n505_));
  nand4  g347(.a(new_n505_), .b(new_n504_), .c(new_n503_), .d(new_n308_), .O(new_n506_));
  inv1   g348(.a(new_n506_), .O(z62));
  nand4  g349(.a(new_n207_), .b(new_n363_), .c(x56), .d(new_n162_), .O(new_n508_));
  inv1   g350(.a(new_n508_), .O(new_n509_));
  nand4  g351(.a(new_n509_), .b(new_n504_), .c(new_n503_), .d(new_n308_), .O(new_n510_));
  inv1   g352(.a(new_n510_), .O(z63));
  nand4  g353(.a(new_n359_), .b(new_n503_), .c(new_n325_), .d(x30), .O(new_n512_));
  nor3   g354(.a(new_n512_), .b(new_n311_), .c(new_n306_), .O(z64));
  zero   g355(.O(z00));
  zero   g356(.O(z01));
  zero   g357(.O(z04));
  zero   g358(.O(z07));
