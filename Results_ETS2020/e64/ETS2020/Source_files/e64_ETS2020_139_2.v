// Benchmark "FAU" written by ABC on Tue Jun 23 00:52:34 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n588_, new_n589_, new_n591_, new_n592_, new_n595_, new_n596_;
  ...
  nand4  g201(.a(new_n338_), .b(new_n172_), .c(x29), .d(x26), .O(new_n339_));
  nor4   g202(.a(new_n339_), .b(new_n334_), .c(new_n320_), .d(new_n317_), .O(z16));
  ...
  nand2  g263(.a(new_n251_), .b(new_n172_), .O(new_n403_));
  nand3  g264(.a(new_n325_), .b(x11), .c(new_n184_), .O(new_n404_));
  nand3  g265(.a(new_n347_), .b(new_n350_), .c(new_n156_), .O(new_n405_));
  nor4   g266(.a(new_n405_), .b(new_n404_), .c(new_n403_), .d(new_n345_), .O(z24));
  ...
  inv1   g428(.a(new_n403_), .O(new_n579_));
  nor3   g429(.a(new_n469_), .b(x08), .c(new_n188_), .O(new_n580_));
  nand2  g430(.a(new_n134_), .b(new_n259_), .O(new_n581_));
  nor2   g431(.a(new_n581_), .b(new_n320_), .O(new_n582_));
  nand4  g432(.a(new_n582_), .b(new_n580_), .c(new_n579_), .d(new_n338_), .O(new_n583_));
  inv1   g433(.a(new_n583_), .O(z60));
  nor2   g434(.a(x10), .b(new_n182_), .O(new_n585_));
  nand4  g435(.a(new_n585_), .b(new_n285_), .c(new_n174_), .d(new_n172_), .O(new_n586_));
  nand3  g436(.a(new_n347_), .b(new_n351_), .c(new_n350_), .O(new_n587_));
  nand2  g437(.a(new_n344_), .b(new_n273_), .O(new_n588_));
  nand2  g438(.a(new_n159_), .b(new_n153_), .O(new_n589_));
  nor4   g439(.a(new_n589_), .b(new_n588_), .c(new_n587_), .d(new_n586_), .O(z61));
  nand2  g440(.a(new_n482_), .b(new_n579_), .O(new_n591_));
  nand4  g441(.a(new_n338_), .b(new_n319_), .c(new_n350_), .d(x47), .O(new_n592_));
  nor3   g442(.a(new_n592_), .b(new_n591_), .c(new_n581_), .O(z62));
  inv1   g443(.a(new_n429_), .O(new_n595_));
  nand4  g444(.a(new_n431_), .b(new_n595_), .c(new_n281_), .d(x30), .O(new_n596_));
  nor2   g445(.a(new_n596_), .b(new_n591_), .O(z64));
  zero   g446(.O(z01));
  zero   g447(.O(z04));
  zero   g448(.O(z05));
  zero   g449(.O(z10));
