...
module FAU ( 
  ...
  nor3   g444(.a(new_n338_), .b(x08), .c(new_n303_), .O(new_n589_));
  nor3   g445(.a(x60), .b(x58), .c(x56), .O(new_n590_));
  nand4  g446(.a(new_n590_), .b(new_n589_), .c(new_n344_), .d(new_n292_), .O(new_n591_));
  inv1   g447(.a(new_n591_), .O(z60));
  nor2   g448(.a(x10), .b(new_n461_), .O(new_n593_));
  nand4  g449(.a(new_n593_), .b(new_n333_), .c(new_n301_), .d(new_n170_), .O(new_n594_));
  nand3  g450(.a(new_n389_), .b(new_n324_), .c(new_n312_), .O(new_n595_));
  nand2  g451(.a(new_n318_), .b(new_n190_), .O(new_n596_));
  nand2  g452(.a(new_n157_), .b(new_n151_), .O(new_n597_));
  nor4   g453(.a(new_n597_), .b(new_n596_), .c(new_n595_), .d(new_n594_), .O(z61));
  nand3  g454(.a(new_n290_), .b(new_n312_), .c(x47), .O(new_n599_));
  nor2   g455(.a(new_n599_), .b(new_n342_), .O(new_n600_));
  nand2  g456(.a(new_n600_), .b(new_n590_), .O(new_n601_));
  nor3   g457(.a(new_n601_), .b(new_n343_), .c(new_n338_), .O(z62));
  zero   g458(.O(z05));
  zero   g459(.O(z06));
  zero   g460(.O(z07));
  zero   g461(.O(z09));
