...
module FAU ( 
  ...
  nor2   g54(.a(x24), .b(new_n56_), .O(new_n111_));
  oai21  g55(.a(new_n111_), .b(new_n110_), .c(new_n59_), .O(new_n112_));
  inv1   g56(.a(x31), .O(new_n113_));
  nand2  g57(.a(new_n113_), .b(new_n58_), .O(new_n114_));
  nand2  g58(.a(new_n114_), .b(new_n112_), .O(z11));
  inv1   g59(.a(x15), .O(new_n116_));
  nor2   g60(.a(x18), .b(new_n116_), .O(new_n117_));
  nor2   g61(.a(x33), .b(new_n56_), .O(new_n118_));
  oai21  g62(.a(new_n118_), .b(new_n117_), .c(new_n59_), .O(new_n119_));
  inv1   g63(.a(x32), .O(new_n120_));
  nand2  g64(.a(new_n120_), .b(new_n58_), .O(new_n121_));
  nand2  g65(.a(new_n121_), .b(new_n119_), .O(z12));
  inv1   g66(.a(x14), .O(new_n123_));
  nor2   g67(.a(x18), .b(new_n123_), .O(new_n124_));
  nor2   g68(.a(x34), .b(new_n56_), .O(new_n125_));
  oai21  g69(.a(new_n125_), .b(new_n124_), .c(new_n59_), .O(new_n126_));
  inv1   g70(.a(x33), .O(new_n127_));
  nand2  g71(.a(new_n127_), .b(new_n58_), .O(new_n128_));
