...
module FAU ( 
  ...
  nor2   g19(.a(x20), .b(new_n68_), .O(new_n77_));
  ...
  nor2   g26(.a(x29), .b(new_n68_), .O(new_n84_));
  oai21  g27(.a(new_n84_), .b(new_n83_), .c(new_n60_), .O(new_n85_));
  inv1   g28(.a(x28), .O(new_n86_));
  nand2  g29(.a(new_n86_), .b(new_n59_), .O(new_n87_));
  nand2  g30(.a(new_n87_), .b(new_n85_), .O(z08));
  inv1   g31(.a(x10), .O(new_n89_));
  nor2   g32(.a(x18), .b(new_n89_), .O(new_n90_));
  nor2   g33(.a(x30), .b(new_n68_), .O(new_n91_));
  ...
  nor2   g40(.a(x31), .b(new_n68_), .O(new_n98_));
  ...
  nor2   g47(.a(x33), .b(new_n68_), .O(new_n106_));
  ...
  nor2   g54(.a(x34), .b(new_n68_), .O(new_n113_));
  ...
  nor2   g61(.a(x35), .b(new_n68_), .O(new_n120_));
  ...
  nor2   g68(.a(x28), .b(new_n68_), .O(new_n127_));
