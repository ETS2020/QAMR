// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:49 2020
...
module FAU ( 
  ...
  nor2   g61(.a(x24), .b(new_n56_), .O(new_n117_));
  oai21  g62(.a(new_n117_), .b(new_n116_), .c(new_n59_), .O(new_n118_));
  inv1   g63(.a(x31), .O(new_n119_));
  nand2  g64(.a(new_n119_), .b(new_n58_), .O(new_n120_));
  nand2  g65(.a(new_n120_), .b(new_n118_), .O(z11));
  inv1   g66(.a(x15), .O(new_n122_));
  nor2   g67(.a(x18), .b(new_n122_), .O(new_n123_));
  nor2   g68(.a(x33), .b(new_n56_), .O(new_n124_));
  oai21  g69(.a(new_n124_), .b(new_n123_), .c(new_n59_), .O(new_n125_));
  inv1   g70(.a(x32), .O(new_n126_));
  nand2  g71(.a(new_n126_), .b(new_n58_), .O(new_n127_));
  nand2  g72(.a(new_n127_), .b(new_n125_), .O(z12));
  inv1   g73(.a(x13), .O(new_n130_));
  nor2   g74(.a(x18), .b(new_n130_), .O(new_n131_));
  nor2   g75(.a(x35), .b(new_n56_), .O(new_n132_));
  oai21  g76(.a(new_n132_), .b(new_n131_), .c(new_n59_), .O(new_n133_));
  inv1   g77(.a(x34), .O(new_n134_));
  nand2  g78(.a(new_n134_), .b(new_n58_), .O(new_n135_));
  nand2  g79(.a(new_n135_), .b(new_n133_), .O(z14));
  inv1   g80(.a(x12), .O(new_n137_));
  nor2   g81(.a(x18), .b(new_n137_), .O(new_n138_));
  nor2   g82(.a(x28), .b(new_n56_), .O(new_n139_));
  oai21  g83(.a(new_n139_), .b(new_n138_), .c(new_n59_), .O(new_n140_));
  inv1   g84(.a(x35), .O(new_n141_));
  nand2  g85(.a(new_n141_), .b(new_n58_), .O(new_n142_));
