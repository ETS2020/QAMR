...
module FAU ( 
  ...
  nor2   g19(.a(x29), .b(new_n57_), .O(new_n78_));
  ...
  nor2   g47(.a(x35), .b(new_n57_), .O(new_n108_));
  oai21  g48(.a(new_n108_), .b(new_n107_), .c(new_n60_), .O(new_n109_));
  inv1   g49(.a(x34), .O(new_n110_));
  nand2  g50(.a(new_n110_), .b(new_n59_), .O(new_n111_));
