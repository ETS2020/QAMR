...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n69_, new_n76_, new_n77_, new_n78_, new_n79_, new_n80_, new_n81_,
  ...
  nor2   g26(.a(x30), .b(new_n55_), .O(new_n85_));
  oai21  g27(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(new_n86_));
  inv1   g28(.a(x29), .O(new_n87_));
  nand2  g29(.a(new_n87_), .b(new_n57_), .O(new_n88_));
  nand2  g30(.a(new_n88_), .b(new_n86_), .O(z09));
  inv1   g31(.a(x09), .O(new_n90_));
  nor2   g32(.a(x18), .b(new_n90_), .O(new_n91_));
  nor2   g33(.a(x31), .b(new_n55_), .O(new_n92_));
  oai21  g34(.a(new_n92_), .b(new_n91_), .c(new_n58_), .O(new_n93_));
  inv1   g35(.a(x30), .O(new_n94_));
  nand2  g36(.a(new_n94_), .b(new_n57_), .O(new_n95_));
  ...
  nor2   g47(.a(x34), .b(new_n55_), .O(new_n107_));
  oai21  g48(.a(new_n107_), .b(new_n106_), .c(new_n58_), .O(new_n108_));
  inv1   g49(.a(x33), .O(new_n109_));
  nand2  g50(.a(new_n109_), .b(new_n57_), .O(new_n110_));
  nand2  g51(.a(new_n110_), .b(new_n108_), .O(z13));
  inv1   g52(.a(x13), .O(new_n112_));
  nor2   g53(.a(x18), .b(new_n112_), .O(new_n113_));
  nor2   g54(.a(x35), .b(new_n55_), .O(new_n114_));
  oai21  g55(.a(new_n114_), .b(new_n113_), .c(new_n58_), .O(new_n115_));
  inv1   g56(.a(x34), .O(new_n116_));
  nand2  g57(.a(new_n116_), .b(new_n57_), .O(new_n117_));
  nand2  g58(.a(new_n117_), .b(new_n115_), .O(z14));
  inv1   g59(.a(x12), .O(new_n119_));
  nor2   g60(.a(x18), .b(new_n119_), .O(new_n120_));
  nor2   g61(.a(x28), .b(new_n55_), .O(new_n121_));
  oai21  g62(.a(new_n121_), .b(new_n120_), .c(new_n58_), .O(new_n122_));
  inv1   g63(.a(x35), .O(new_n123_));
  nand2  g64(.a(new_n123_), .b(new_n57_), .O(new_n124_));
