...
module FAU ( 
  ...
  nor2   g19(.a(x29), .b(new_n56_), .O(new_n78_));
  oai21  g20(.a(new_n78_), .b(new_n77_), .c(new_n59_), .O(new_n79_));
  inv1   g21(.a(x28), .O(new_n80_));
  nand2  g22(.a(new_n80_), .b(new_n58_), .O(new_n81_));
  nand2  g23(.a(new_n81_), .b(new_n79_), .O(z08));
  inv1   g24(.a(x10), .O(new_n83_));
  nor2   g25(.a(x18), .b(new_n83_), .O(new_n84_));
  nor2   g26(.a(x30), .b(new_n56_), .O(new_n85_));
  oai21  g27(.a(new_n85_), .b(new_n84_), .c(new_n59_), .O(new_n86_));
  inv1   g28(.a(x29), .O(new_n87_));
  nand2  g29(.a(new_n87_), .b(new_n58_), .O(new_n88_));
