...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    new_n61_, new_n62_, new_n70_, new_n71_, new_n72_, new_n73_, new_n74_,
  ...
  inv1   g10(.a(x11), .O(new_n70_));
  nor2   g11(.a(x18), .b(new_n70_), .O(new_n71_));
  nor2   g12(.a(x29), .b(new_n56_), .O(new_n72_));
  oai21  g13(.a(new_n72_), .b(new_n71_), .c(new_n59_), .O(new_n73_));
  inv1   g14(.a(x28), .O(new_n74_));
  nand2  g15(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  nand2  g16(.a(new_n75_), .b(new_n73_), .O(z08));
  inv1   g17(.a(x10), .O(new_n77_));
  nor2   g18(.a(x18), .b(new_n77_), .O(new_n78_));
  nor2   g19(.a(x30), .b(new_n56_), .O(new_n79_));
  oai21  g20(.a(new_n79_), .b(new_n78_), .c(new_n59_), .O(new_n80_));
  inv1   g21(.a(x29), .O(new_n81_));
  nand2  g22(.a(new_n81_), .b(new_n58_), .O(new_n82_));
  nand2  g23(.a(new_n82_), .b(new_n80_), .O(z09));
  inv1   g24(.a(x09), .O(new_n84_));
  nor2   g25(.a(x18), .b(new_n84_), .O(new_n85_));
  nor2   g26(.a(x31), .b(new_n56_), .O(new_n86_));
  oai21  g27(.a(new_n86_), .b(new_n85_), .c(new_n59_), .O(new_n87_));
  inv1   g28(.a(x30), .O(new_n88_));
  nand2  g29(.a(new_n88_), .b(new_n58_), .O(new_n89_));
