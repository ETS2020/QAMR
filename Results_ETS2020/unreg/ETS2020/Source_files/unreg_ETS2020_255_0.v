...
module FAU ( 
  ...
  inv1   g10(.a(x05), .O(new_n68_));
  nor2   g11(.a(x18), .b(new_n68_), .O(new_n69_));
  nor2   g12(.a(x27), .b(new_n56_), .O(new_n70_));
  oai21  g13(.a(new_n70_), .b(new_n69_), .c(new_n59_), .O(new_n71_));
  inv1   g14(.a(x26), .O(new_n72_));
  nand2  g15(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  nand2  g16(.a(new_n73_), .b(new_n71_), .O(z06));
