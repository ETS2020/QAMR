...
module FAU ( 
  ...
  nor2   g19(.a(x29), .b(new_n67_), .O(new_n78_));
  ...
  nor2   g26(.a(x30), .b(new_n67_), .O(new_n85_));
  ...
  nor2   g33(.a(x31), .b(new_n67_), .O(new_n92_));
  ...
  nor2   g40(.a(x24), .b(new_n67_), .O(new_n99_));
  ...
  nor2   g47(.a(x33), .b(new_n67_), .O(new_n106_));
  ...
  nor2   g54(.a(x35), .b(new_n67_), .O(new_n114_));
