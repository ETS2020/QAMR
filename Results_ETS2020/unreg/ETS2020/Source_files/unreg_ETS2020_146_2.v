// Benchmark "FAU" written by ABC on Tue Jun 23 01:12:47 2020
...
module FAU ( 
  ...
  inv1   g10(.a(x06), .O(new_n67_));
  nor2   g11(.a(x18), .b(new_n67_), .O(new_n68_));
  nor2   g12(.a(x26), .b(new_n57_), .O(new_n69_));
  oai21  g13(.a(new_n69_), .b(new_n68_), .c(new_n60_), .O(new_n70_));
  ...
  nor2   g26(.a(x29), .b(new_n57_), .O(new_n84_));
  ...
  nor2   g33(.a(x30), .b(new_n57_), .O(new_n91_));
  ...
  nor2   g40(.a(x31), .b(new_n57_), .O(new_n98_));
