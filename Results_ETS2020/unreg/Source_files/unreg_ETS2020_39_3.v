...
module FAU ( 
  ...
  nor2   g26(.a(x25), .b(new_n56_), .O(new_n80_));
  oai21  g27(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(new_n81_));
  inv1   g28(.a(x24), .O(new_n82_));
  nand2  g29(.a(new_n82_), .b(new_n58_), .O(new_n83_));
  nand2  g30(.a(new_n83_), .b(new_n81_), .O(z04));
  inv1   g31(.a(x06), .O(new_n85_));
  nor2   g32(.a(x18), .b(new_n85_), .O(new_n86_));
  nor2   g33(.a(x26), .b(new_n56_), .O(new_n87_));
  oai21  g34(.a(new_n87_), .b(new_n86_), .c(new_n59_), .O(new_n88_));
  inv1   g35(.a(x25), .O(new_n89_));
  nand2  g36(.a(new_n89_), .b(new_n58_), .O(new_n90_));
  nand2  g37(.a(new_n90_), .b(new_n88_), .O(z05));
  inv1   g38(.a(x05), .O(new_n92_));
  nor2   g39(.a(x18), .b(new_n92_), .O(new_n93_));
  nor2   g40(.a(x27), .b(new_n56_), .O(new_n94_));
  oai21  g41(.a(new_n94_), .b(new_n93_), .c(new_n59_), .O(new_n95_));
  inv1   g42(.a(x26), .O(new_n96_));
  nand2  g43(.a(new_n96_), .b(new_n58_), .O(new_n97_));
  nand2  g44(.a(new_n97_), .b(new_n95_), .O(z06));
  inv1   g45(.a(x04), .O(new_n99_));
  nor2   g46(.a(x18), .b(new_n99_), .O(new_n100_));
  nor2   g47(.a(x20), .b(new_n56_), .O(new_n101_));
  oai21  g48(.a(new_n101_), .b(new_n100_), .c(new_n59_), .O(new_n102_));
  inv1   g49(.a(x27), .O(new_n103_));
  nand2  g50(.a(new_n103_), .b(new_n58_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(new_n102_), .O(z07));
  inv1   g52(.a(x11), .O(new_n106_));
  nor2   g53(.a(x18), .b(new_n106_), .O(new_n107_));
  nor2   g54(.a(x29), .b(new_n56_), .O(new_n108_));
  oai21  g55(.a(new_n108_), .b(new_n107_), .c(new_n59_), .O(new_n109_));
  inv1   g56(.a(x28), .O(new_n110_));
  nand2  g57(.a(new_n110_), .b(new_n58_), .O(new_n111_));
  nand2  g58(.a(new_n111_), .b(new_n109_), .O(z08));
  inv1   g59(.a(x10), .O(new_n113_));
  nor2   g60(.a(x18), .b(new_n113_), .O(new_n114_));
  nor2   g61(.a(x30), .b(new_n56_), .O(new_n115_));
  oai21  g62(.a(new_n115_), .b(new_n114_), .c(new_n59_), .O(new_n116_));
  inv1   g63(.a(x29), .O(new_n117_));
  nand2  g64(.a(new_n117_), .b(new_n58_), .O(new_n118_));
  nand2  g65(.a(new_n118_), .b(new_n116_), .O(z09));
  inv1   g66(.a(x09), .O(new_n120_));
  nor2   g67(.a(x18), .b(new_n120_), .O(new_n121_));
  nor2   g68(.a(x31), .b(new_n56_), .O(new_n122_));
  oai21  g69(.a(new_n122_), .b(new_n121_), .c(new_n59_), .O(new_n123_));
  inv1   g70(.a(x30), .O(new_n124_));
  nand2  g71(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  nand2  g72(.a(new_n125_), .b(new_n123_), .O(z10));
  inv1   g73(.a(x08), .O(new_n127_));
  nor2   g74(.a(x18), .b(new_n127_), .O(new_n128_));
  nor2   g75(.a(x24), .b(new_n56_), .O(new_n129_));
  oai21  g76(.a(new_n129_), .b(new_n128_), .c(new_n59_), .O(new_n130_));
  inv1   g77(.a(x31), .O(new_n131_));
  nand2  g78(.a(new_n131_), .b(new_n58_), .O(new_n132_));
  nand2  g79(.a(new_n132_), .b(new_n130_), .O(z11));
  inv1   g80(.a(x14), .O(new_n135_));
  nor2   g81(.a(x18), .b(new_n135_), .O(new_n136_));
  nor2   g82(.a(x34), .b(new_n56_), .O(new_n137_));
  oai21  g83(.a(new_n137_), .b(new_n136_), .c(new_n59_), .O(new_n138_));
  inv1   g84(.a(x33), .O(new_n139_));
  nand2  g85(.a(new_n139_), .b(new_n58_), .O(new_n140_));
