// Benchmark "FAU" written by ABC on Tue Jun 23 03:40:46 2020
...
module FAU ( 
  ...
  oai21  g45(.a(x18), .b(new_n55_), .c(new_n92_), .O(new_n93_));
  ...
  oai21  g52(.a(x18), .b(new_n58_), .c(new_n99_), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  nand3  g54(.a(new_n96_), .b(new_n71_), .c(new_n49_), .O(new_n102_));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n81_), .c(new_n61_), .O(new_n110_));
  nor2   g63(.a(x24), .b(x23), .O(new_n111_));
  nand4  g64(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n49_), .O(new_n112_));
  ...
  oai21  g69(.a(x18), .b(new_n64_), .c(new_n116_), .O(new_n117_));
  ...
  nand2  g78(.a(x18), .b(x07), .O(new_n126_));
  oai21  g79(.a(x18), .b(new_n67_), .c(new_n126_), .O(new_n127_));
  nand2  g80(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand2  g81(.a(new_n122_), .b(x26), .O(new_n129_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g83(.a(new_n130_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n131_));
  nand2  g84(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g85(.a(new_n132_), .b(x16), .O(new_n133_));
  nand2  g86(.a(new_n133_), .b(new_n128_), .O(z16));
  inv1   g87(.a(x19), .O(new_n135_));
  nor2   g88(.a(new_n135_), .b(x17), .O(new_n136_));
  nand4  g89(.a(new_n136_), .b(new_n130_), .c(new_n120_), .d(new_n89_), .O(new_n137_));
