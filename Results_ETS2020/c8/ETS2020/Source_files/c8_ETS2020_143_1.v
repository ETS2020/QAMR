// Benchmark "FAU" written by ABC on Tue Jun 23 03:41:02 2020
...
module FAU ( 
  ...
  nor2   g86(.a(x21), .b(x20), .O(new_n133_));
  nor2   g87(.a(x23), .b(x22), .O(new_n134_));
  nor2   g88(.a(x25), .b(x24), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n74_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(x26), .O(new_n137_));
  nor3   g91(.a(x26), .b(x25), .c(x24), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n134_), .c(new_n133_), .d(new_n74_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n132_), .O(z16));
  zero   g96(.O(z17));
  buf    g97(.a(x27), .O(z08));
endmodule
