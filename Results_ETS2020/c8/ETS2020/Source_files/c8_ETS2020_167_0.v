...
module FAU ( 
  ...
  inv1   g01(.a(x09), .O(new_n58_));
  nand2  g02(.a(x18), .b(x01), .O(new_n59_));
  oai21  g03(.a(x18), .b(new_n58_), .c(new_n59_), .O(new_n60_));
  nand2  g04(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  oai21  g05(.a(x19), .b(x17), .c(x20), .O(new_n62_));
  ...
  nand2  g10(.a(new_n66_), .b(new_n62_), .O(new_n67_));
  nand2  g11(.a(new_n67_), .b(x16), .O(new_n68_));
  nand2  g12(.a(new_n68_), .b(new_n61_), .O(z10));
  zero   g13(.O(z00));
  zero   g14(.O(z01));
  zero   g15(.O(z02));
  zero   g16(.O(z03));
