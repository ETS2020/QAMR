...
module FAU ( 
  ...
  nand4  g097(.a(new_n249_), .b(new_n239_), .c(x45), .d(new_n242_), .O(new_n253_));
  ...
  nand4  g103(.a(new_n249_), .b(new_n239_), .c(x49), .d(new_n242_), .O(new_n260_));
  inv1   g104(.a(new_n260_), .O(z31));
  nand4  g105(.a(new_n249_), .b(new_n239_), .c(x50), .d(new_n242_), .O(new_n262_));
  inv1   g106(.a(new_n262_), .O(z32));
  nor2   g107(.a(new_n224_), .b(x81), .O(new_n264_));
  nor2   g108(.a(x83), .b(new_n246_), .O(new_n265_));
  ...
  nand4  g207(.a(x80), .b(new_n226_), .c(x43), .d(new_n242_), .O(new_n366_));
  oai22  g208(.a(new_n366_), .b(new_n225_), .c(new_n242_), .d(x40), .O(new_n367_));
  nand3  g209(.a(new_n367_), .b(new_n231_), .c(x79), .O(new_n368_));
  nand4  g210(.a(new_n157_), .b(new_n154_), .c(new_n242_), .d(x40), .O(new_n369_));
  ...
  oai21  g216(.a(new_n227_), .b(new_n225_), .c(new_n242_), .O(new_n375_));
