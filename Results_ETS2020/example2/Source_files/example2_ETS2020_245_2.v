...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n233_, new_n234_, new_n240_, new_n242_,
  ...
  nand4  g072(.a(new_n233_), .b(new_n232_), .c(x48), .d(new_n225_), .O(new_n240_));
  inv1   g073(.a(new_n240_), .O(z30));
  nand4  g074(.a(new_n233_), .b(new_n232_), .c(x49), .d(new_n225_), .O(new_n242_));
  inv1   g075(.a(new_n242_), .O(z31));
  nand4  g076(.a(new_n233_), .b(new_n232_), .c(x50), .d(new_n225_), .O(new_n244_));
  inv1   g077(.a(new_n244_), .O(z32));
  inv1   g078(.a(new_n162_), .O(new_n248_));
  nand2  g079(.a(x83), .b(x42), .O(new_n249_));
  nand2  g080(.a(new_n249_), .b(new_n226_), .O(new_n250_));
  inv1   g081(.a(new_n249_), .O(new_n251_));
  nand2  g082(.a(new_n251_), .b(x81), .O(new_n252_));
  aoi21  g083(.a(new_n252_), .b(new_n250_), .c(new_n229_), .O(new_n253_));
  nand2  g084(.a(new_n249_), .b(x81), .O(new_n254_));
  nand2  g085(.a(new_n251_), .b(new_n226_), .O(new_n255_));
  aoi21  g086(.a(new_n255_), .b(new_n254_), .c(new_n227_), .O(new_n256_));
  oai21  g087(.a(new_n256_), .b(new_n253_), .c(new_n248_), .O(new_n257_));
  nand2  g088(.a(new_n233_), .b(x53), .O(new_n258_));
  nor2   g089(.a(new_n258_), .b(new_n257_), .O(z35));
  nand2  g090(.a(new_n233_), .b(x54), .O(new_n260_));
  nor2   g091(.a(new_n260_), .b(new_n257_), .O(z36));
  nand2  g092(.a(new_n233_), .b(x55), .O(new_n262_));
  nor2   g093(.a(new_n262_), .b(new_n257_), .O(z37));
  nand2  g094(.a(new_n233_), .b(x56), .O(new_n264_));
  ...
  nor2   g099(.a(x79), .b(x77), .O(new_n278_));
  nand2  g100(.a(new_n278_), .b(new_n220_), .O(new_n279_));
  inv1   g101(.a(new_n279_), .O(new_n280_));
  nand2  g102(.a(new_n280_), .b(new_n277_), .O(new_n281_));
  nor3   g103(.a(new_n208_), .b(new_n169_), .c(new_n154_), .O(new_n282_));
  ...
  nand3  g138(.a(new_n317_), .b(new_n233_), .c(new_n161_), .O(new_n318_));
  nor4   g139(.a(new_n318_), .b(new_n316_), .c(x82), .d(x81), .O(z55));
  inv1   g140(.a(new_n161_), .O(new_n320_));
  xnor2a g141(.a(x84), .b(x81), .O(new_n321_));
  aoi21  g142(.a(new_n169_), .b(new_n168_), .c(new_n321_), .O(new_n322_));
  aoi22  g143(.a(new_n322_), .b(new_n153_), .c(new_n320_), .d(x76), .O(new_n323_));
  inv1   g144(.a(x00), .O(new_n324_));
  nor3   g145(.a(new_n163_), .b(x01), .c(new_n324_), .O(new_n325_));
  oai21  g146(.a(new_n323_), .b(new_n154_), .c(new_n325_), .O(z56));
  inv1   g147(.a(x02), .O(new_n327_));
  nand4  g148(.a(x03), .b(new_n327_), .c(new_n153_), .d(x00), .O(new_n328_));
  inv1   g149(.a(new_n328_), .O(z57));
  nand2  g150(.a(new_n154_), .b(new_n160_), .O(new_n331_));
  aoi21  g151(.a(new_n219_), .b(new_n331_), .c(new_n152_), .O(new_n332_));
  oai21  g152(.a(new_n215_), .b(new_n213_), .c(new_n225_), .O(new_n333_));
  aoi21  g153(.a(new_n333_), .b(x79), .c(new_n219_), .O(new_n334_));
  ...
  aoi21  g158(.a(new_n322_), .b(x79), .c(new_n336_), .O(new_n339_));
  aoi21  g159(.a(new_n339_), .b(new_n221_), .c(x01), .O(z60));
  aoi21  g160(.a(new_n169_), .b(new_n168_), .c(new_n208_), .O(new_n344_));
  nor2   g161(.a(new_n320_), .b(x04), .O(new_n345_));
  nor2   g162(.a(new_n212_), .b(new_n154_), .O(new_n346_));
  oai21  g163(.a(new_n345_), .b(new_n344_), .c(new_n346_), .O(new_n347_));
  aoi21  g164(.a(new_n347_), .b(new_n279_), .c(x01), .O(z64));
  zero   g165(.O(z03));
  zero   g166(.O(z05));
  zero   g167(.O(z06));
  zero   g168(.O(z07));
