// Benchmark "FAU" written by ABC on Sat Jun 27 02:03:32 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n253_, new_n254_, new_n255_, new_n257_, new_n259_, new_n271_,
  ...
  nand4  g068(.a(new_n231_), .b(new_n230_), .c(x48), .d(new_n223_), .O(new_n237_));
  inv1   g069(.a(new_n237_), .O(z30));
  nand4  g070(.a(new_n231_), .b(new_n230_), .c(x49), .d(new_n223_), .O(new_n239_));
  inv1   g071(.a(new_n239_), .O(z31));
  nand4  g072(.a(new_n231_), .b(new_n230_), .c(x50), .d(new_n223_), .O(new_n241_));
  inv1   g073(.a(new_n241_), .O(z32));
  inv1   g074(.a(new_n162_), .O(new_n245_));
  nand2  g075(.a(x83), .b(x42), .O(new_n246_));
  nand2  g076(.a(new_n246_), .b(new_n224_), .O(new_n247_));
  inv1   g077(.a(new_n246_), .O(new_n248_));
  nand2  g078(.a(new_n248_), .b(x81), .O(new_n249_));
  aoi21  g079(.a(new_n249_), .b(new_n247_), .c(new_n227_), .O(new_n250_));
  nand2  g080(.a(new_n246_), .b(x81), .O(new_n251_));
  nand2  g081(.a(new_n248_), .b(new_n224_), .O(new_n252_));
  aoi21  g082(.a(new_n252_), .b(new_n251_), .c(new_n225_), .O(new_n253_));
  oai21  g083(.a(new_n253_), .b(new_n250_), .c(new_n245_), .O(new_n254_));
  nand2  g084(.a(new_n231_), .b(x53), .O(new_n255_));
  nor2   g085(.a(new_n255_), .b(new_n254_), .O(z35));
  nand2  g086(.a(new_n231_), .b(x54), .O(new_n257_));
  nor2   g087(.a(new_n257_), .b(new_n254_), .O(z36));
  nand2  g088(.a(new_n231_), .b(x55), .O(new_n259_));
  ...
  nand3  g132(.a(new_n313_), .b(new_n231_), .c(new_n161_), .O(new_n314_));
  ...
  oai21  g146(.a(new_n211_), .b(new_n209_), .c(new_n223_), .O(new_n329_));
