// Benchmark "FAU" written by ABC on Sat Jun 27 01:51:37 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n241_, new_n243_, new_n246_, new_n250_, new_n251_, new_n252_,
  ...
  nand4  g074(.a(new_n234_), .b(new_n233_), .c(x46), .d(new_n226_), .O(new_n239_));
  inv1   g075(.a(new_n239_), .O(z28));
  nand4  g076(.a(new_n234_), .b(new_n233_), .c(x47), .d(new_n226_), .O(new_n241_));
  ...
  nor2   g169(.a(new_n160_), .b(x04), .O(new_n351_));
  nor2   g170(.a(new_n227_), .b(x78), .O(new_n352_));
  oai21  g171(.a(new_n352_), .b(new_n351_), .c(x77), .O(new_n353_));
  nand3  g172(.a(x81), .b(x78), .c(new_n159_), .O(new_n354_));
  nand2  g173(.a(new_n171_), .b(x84), .O(new_n355_));
  aoi21  g174(.a(new_n354_), .b(new_n353_), .c(new_n355_), .O(z65));
  zero   g175(.O(z03));
  zero   g176(.O(z06));
  zero   g177(.O(z07));
  zero   g178(.O(z08));
