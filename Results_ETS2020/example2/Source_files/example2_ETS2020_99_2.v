...
module FAU ( 
  ...
  inv1   g080(.a(new_n156_), .O(new_n246_));
  nand2  g081(.a(x83), .b(x42), .O(new_n247_));
  nand2  g082(.a(new_n247_), .b(new_n221_), .O(new_n248_));
  inv1   g083(.a(new_n247_), .O(new_n249_));
  nand2  g084(.a(new_n249_), .b(x81), .O(new_n250_));
  aoi21  g085(.a(new_n250_), .b(new_n248_), .c(new_n224_), .O(new_n251_));
  nand2  g086(.a(new_n247_), .b(x81), .O(new_n252_));
  nand2  g087(.a(new_n249_), .b(new_n221_), .O(new_n253_));
  aoi21  g088(.a(new_n253_), .b(new_n252_), .c(new_n222_), .O(new_n254_));
  oai21  g089(.a(new_n254_), .b(new_n251_), .c(new_n246_), .O(new_n255_));
  nand2  g090(.a(new_n228_), .b(x52), .O(new_n256_));
  nor2   g091(.a(new_n256_), .b(new_n255_), .O(z34));
  nand2  g092(.a(new_n228_), .b(x53), .O(new_n258_));
  nor2   g093(.a(new_n258_), .b(new_n255_), .O(z35));
  nand2  g094(.a(new_n228_), .b(x54), .O(new_n260_));
  nor2   g095(.a(new_n260_), .b(new_n255_), .O(z36));
  nand2  g096(.a(new_n228_), .b(x55), .O(new_n262_));
  nor2   g097(.a(new_n262_), .b(new_n255_), .O(z37));
  nand2  g098(.a(new_n228_), .b(x56), .O(new_n264_));
  nor2   g099(.a(new_n264_), .b(new_n255_), .O(z38));
  inv1   g100(.a(x08), .O(new_n275_));
  nand2  g101(.a(x52), .b(x16), .O(new_n276_));
  oai21  g102(.a(x52), .b(new_n275_), .c(new_n276_), .O(new_n277_));
  nor2   g103(.a(x79), .b(x77), .O(new_n278_));
  nand2  g104(.a(new_n278_), .b(new_n215_), .O(new_n279_));
  inv1   g105(.a(new_n279_), .O(new_n280_));
  nand2  g106(.a(new_n280_), .b(new_n277_), .O(new_n281_));
  nor3   g107(.a(new_n203_), .b(new_n164_), .c(new_n157_), .O(new_n282_));
  nand2  g108(.a(new_n282_), .b(x68), .O(new_n283_));
  aoi21  g109(.a(new_n283_), .b(new_n281_), .c(x01), .O(z48));
  inv1   g110(.a(x09), .O(new_n285_));
  nand2  g111(.a(x52), .b(x17), .O(new_n286_));
  oai21  g112(.a(x52), .b(new_n285_), .c(new_n286_), .O(new_n287_));
  nand2  g113(.a(new_n287_), .b(new_n280_), .O(new_n288_));
  nand2  g114(.a(new_n282_), .b(x69), .O(new_n289_));
  aoi21  g115(.a(new_n289_), .b(new_n288_), .c(x01), .O(z49));
  inv1   g116(.a(x10), .O(new_n291_));
  nand2  g117(.a(x52), .b(x18), .O(new_n292_));
  oai21  g118(.a(x52), .b(new_n291_), .c(new_n292_), .O(new_n293_));
  nand2  g119(.a(new_n293_), .b(new_n280_), .O(new_n294_));
  nand2  g120(.a(new_n282_), .b(x70), .O(new_n295_));
  aoi21  g121(.a(new_n295_), .b(new_n294_), .c(x01), .O(z50));
  inv1   g122(.a(x11), .O(new_n297_));
  nand2  g123(.a(x52), .b(x19), .O(new_n298_));
  oai21  g124(.a(x52), .b(new_n297_), .c(new_n298_), .O(new_n299_));
  nand2  g125(.a(new_n299_), .b(new_n280_), .O(new_n300_));
  nand2  g126(.a(new_n282_), .b(x71), .O(new_n301_));
  aoi21  g127(.a(new_n301_), .b(new_n300_), .c(x01), .O(z51));
  inv1   g128(.a(x12), .O(new_n303_));
  nand2  g129(.a(x52), .b(x20), .O(new_n304_));
  oai21  g130(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand2  g131(.a(new_n305_), .b(new_n280_), .O(new_n306_));
  nand2  g132(.a(new_n282_), .b(x72), .O(new_n307_));
  aoi21  g133(.a(new_n307_), .b(new_n306_), .c(x01), .O(z52));
  inv1   g134(.a(x13), .O(new_n309_));
  nand2  g135(.a(x52), .b(x21), .O(new_n310_));
  oai21  g136(.a(x52), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g137(.a(new_n311_), .b(new_n280_), .O(new_n312_));
  nand2  g138(.a(new_n282_), .b(x73), .O(new_n313_));
  aoi21  g139(.a(new_n313_), .b(new_n312_), .c(x01), .O(z53));
  nand2  g140(.a(x84), .b(x83), .O(new_n316_));
  nor2   g141(.a(x80), .b(new_n157_), .O(new_n317_));
  nand3  g142(.a(new_n317_), .b(new_n228_), .c(new_n155_), .O(new_n318_));
  nor4   g143(.a(new_n318_), .b(new_n316_), .c(x82), .d(x81), .O(z55));
  inv1   g144(.a(new_n155_), .O(new_n320_));
  xnor2a g145(.a(x84), .b(x81), .O(new_n321_));
  aoi21  g146(.a(new_n164_), .b(new_n163_), .c(new_n321_), .O(new_n322_));
  aoi22  g147(.a(new_n322_), .b(new_n168_), .c(new_n320_), .d(x76), .O(new_n323_));
  inv1   g148(.a(x00), .O(new_n324_));
  nor3   g149(.a(new_n158_), .b(x01), .c(new_n324_), .O(new_n325_));
  oai21  g150(.a(new_n323_), .b(new_n157_), .c(new_n325_), .O(z56));
  inv1   g151(.a(x02), .O(new_n327_));
  nand4  g152(.a(x03), .b(new_n327_), .c(new_n168_), .d(x00), .O(new_n328_));
  inv1   g153(.a(new_n328_), .O(z57));
  inv1   g154(.a(x40), .O(new_n331_));
  aoi21  g155(.a(new_n214_), .b(x79), .c(new_n331_), .O(new_n332_));
  oai21  g156(.a(new_n210_), .b(new_n208_), .c(new_n220_), .O(new_n333_));
  aoi21  g157(.a(new_n333_), .b(x79), .c(new_n214_), .O(new_n334_));
  oai21  g158(.a(new_n334_), .b(new_n332_), .c(x77), .O(new_n335_));
  nor2   g159(.a(x79), .b(x04), .O(new_n336_));
  inv1   g160(.a(new_n336_), .O(new_n337_));
  aoi21  g161(.a(new_n337_), .b(new_n335_), .c(x01), .O(z59));
  aoi21  g162(.a(new_n322_), .b(x79), .c(new_n336_), .O(new_n339_));
  aoi21  g163(.a(new_n339_), .b(new_n216_), .c(x01), .O(z60));
  aoi21  g164(.a(new_n164_), .b(new_n163_), .c(new_n203_), .O(new_n344_));
  nor2   g165(.a(new_n320_), .b(x04), .O(new_n345_));
  nor2   g166(.a(new_n207_), .b(new_n157_), .O(new_n346_));
  oai21  g167(.a(new_n345_), .b(new_n344_), .c(new_n346_), .O(new_n347_));
  aoi21  g168(.a(new_n347_), .b(new_n279_), .c(x01), .O(z64));
  zero   g169(.O(z00));
  zero   g170(.O(z05));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
