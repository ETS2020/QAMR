...
module FAU ( 
  ...
  nand4  g079(.a(new_n234_), .b(new_n222_), .c(x45), .d(new_n226_), .O(new_n237_));
  inv1   g080(.a(new_n237_), .O(z27));
  nand4  g081(.a(new_n234_), .b(new_n222_), .c(x46), .d(new_n226_), .O(new_n239_));
  inv1   g082(.a(new_n239_), .O(z28));
  nand4  g083(.a(new_n234_), .b(new_n222_), .c(x47), .d(new_n226_), .O(new_n241_));
  inv1   g084(.a(new_n241_), .O(z29));
  nand4  g085(.a(new_n234_), .b(new_n222_), .c(x48), .d(new_n226_), .O(new_n243_));
  inv1   g086(.a(new_n243_), .O(z30));
  nand4  g087(.a(new_n234_), .b(new_n222_), .c(x49), .d(new_n226_), .O(new_n245_));
  ...
  nand2  g136(.a(new_n262_), .b(x14), .O(new_n304_));
  ...
  nand3  g141(.a(new_n249_), .b(x84), .c(new_n308_), .O(new_n309_));
  ...
  aoi21  g145(.a(x84), .b(new_n230_), .c(x76), .O(new_n313_));
  oai21  g146(.a(x84), .b(new_n230_), .c(new_n313_), .O(new_n314_));
  nand2  g147(.a(new_n314_), .b(new_n164_), .O(new_n315_));
  nand4  g148(.a(new_n315_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g149(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n318_));
  inv1   g150(.a(x74), .O(new_n319_));
  nand4  g151(.a(x80), .b(new_n319_), .c(x43), .d(new_n226_), .O(new_n320_));
  oai22  g152(.a(new_n320_), .b(new_n318_), .c(new_n226_), .d(x40), .O(new_n321_));
  nand2  g153(.a(x78), .b(x04), .O(new_n322_));
  inv1   g154(.a(new_n322_), .O(new_n323_));
  nand3  g155(.a(new_n323_), .b(new_n321_), .c(x79), .O(new_n324_));
  nand4  g156(.a(new_n162_), .b(new_n154_), .c(new_n226_), .d(x40), .O(new_n325_));
  ...
  oai21  g163(.a(new_n331_), .b(new_n318_), .c(new_n226_), .O(new_n332_));
  ...
  nor2   g191(.a(new_n230_), .b(x78), .O(new_n361_));
