...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n265_, new_n268_, new_n271_, new_n272_, new_n273_, new_n274_,
  ...
  nand4  g113(.a(new_n256_), .b(new_n244_), .c(x49), .d(new_n247_), .O(new_n268_));
  ...
  nor3   g140(.a(new_n290_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g141(.a(new_n290_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g142(.a(new_n290_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g143(.a(new_n290_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g144(.a(new_n290_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g145(.a(new_n290_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g146(.a(new_n290_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g147(.a(new_n290_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g197(.a(new_n282_), .b(x14), .O(new_n355_));
  ...
  nand4  g211(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n370_));
  ...
  nand4  g216(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n375_));
  ...
  nor2   g236(.a(new_n251_), .b(new_n167_), .O(new_n396_));
  ...
  oai21  g241(.a(new_n251_), .b(x78), .c(new_n391_), .O(new_n402_));
