// Benchmark "FAU" written by ABC on Sat Jun 27 01:51:04 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n257_, new_n260_, new_n262_, new_n264_, new_n267_,
  ...
  nand4  g104(.a(new_n254_), .b(new_n242_), .c(x46), .d(new_n245_), .O(new_n260_));
  inv1   g105(.a(new_n260_), .O(z28));
  nand4  g106(.a(new_n254_), .b(new_n242_), .c(x47), .d(new_n245_), .O(new_n262_));
  inv1   g107(.a(new_n262_), .O(z29));
  nand4  g108(.a(new_n254_), .b(new_n242_), .c(x48), .d(new_n245_), .O(new_n264_));
  inv1   g109(.a(new_n264_), .O(z30));
  nand4  g110(.a(new_n254_), .b(new_n242_), .c(x50), .d(new_n245_), .O(new_n267_));
  ...
  nand4  g210(.a(x80), .b(new_n226_), .c(x43), .d(new_n245_), .O(new_n369_));
  ...
  nand4  g215(.a(new_n167_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n374_));
  ...
  nor2   g235(.a(new_n249_), .b(new_n167_), .O(new_n395_));
  ...
  oai21  g240(.a(new_n249_), .b(x78), .c(new_n390_), .O(new_n401_));
