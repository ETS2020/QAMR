// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:06 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n256_, new_n257_, new_n259_, new_n263_, new_n265_,
  ...
  nand4  g107(.a(new_n256_), .b(new_n244_), .c(x47), .d(new_n247_), .O(new_n263_));
  inv1   g108(.a(new_n263_), .O(z29));
  nand4  g109(.a(new_n256_), .b(new_n244_), .c(x48), .d(new_n247_), .O(new_n265_));
  inv1   g110(.a(new_n265_), .O(z30));
  nand4  g111(.a(new_n256_), .b(new_n244_), .c(x50), .d(new_n247_), .O(new_n268_));
  ...
  nand2  g169(.a(new_n327_), .b(new_n310_), .O(new_n328_));
  nand2  g170(.a(new_n321_), .b(x70), .O(new_n329_));
  ...
  nand2  g175(.a(new_n333_), .b(new_n310_), .O(new_n334_));
  nand2  g176(.a(new_n321_), .b(x71), .O(new_n335_));
  ...
  nand2  g181(.a(new_n339_), .b(new_n310_), .O(new_n340_));
  nand2  g182(.a(new_n321_), .b(x72), .O(new_n341_));
  ...
  nand2  g187(.a(new_n345_), .b(new_n310_), .O(new_n346_));
  nand2  g188(.a(new_n321_), .b(x73), .O(new_n347_));
  aoi21  g189(.a(new_n347_), .b(new_n346_), .c(x01), .O(z53));
  nand2  g190(.a(x52), .b(x22), .O(new_n349_));
  nand2  g191(.a(new_n281_), .b(x14), .O(new_n350_));
  inv1   g192(.a(new_n164_), .O(new_n351_));
  nand4  g193(.a(new_n351_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n352_));
  aoi21  g194(.a(new_n350_), .b(new_n349_), .c(new_n352_), .O(z54));
  inv1   g195(.a(new_n242_), .O(new_n355_));
  xnor2a g196(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g197(.a(new_n165_), .b(new_n164_), .c(new_n356_), .O(new_n357_));
  aoi22  g198(.a(new_n357_), .b(new_n153_), .c(new_n355_), .d(x76), .O(new_n358_));
  aoi21  g199(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n359_));
  oai21  g200(.a(new_n358_), .b(new_n167_), .c(new_n359_), .O(z56));
  inv1   g201(.a(x02), .O(new_n361_));
  nand3  g202(.a(new_n239_), .b(x03), .c(new_n361_), .O(new_n362_));
  inv1   g203(.a(new_n362_), .O(z57));
  nand2  g204(.a(x42), .b(new_n152_), .O(new_n364_));
  nand4  g205(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n365_));
  oai21  g206(.a(new_n365_), .b(new_n227_), .c(new_n364_), .O(new_n366_));
  nand3  g207(.a(x79), .b(x78), .c(x04), .O(new_n367_));
  inv1   g208(.a(new_n367_), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(new_n366_), .O(new_n369_));
  nand4  g210(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n370_));
  nand2  g211(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  nand2  g212(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g213(.a(new_n351_), .b(new_n233_), .c(new_n167_), .O(new_n373_));
  aoi21  g214(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  nand2  g215(.a(new_n234_), .b(new_n230_), .O(new_n376_));
  inv1   g216(.a(new_n376_), .O(new_n377_));
  oai21  g217(.a(new_n229_), .b(new_n227_), .c(new_n377_), .O(new_n378_));
  aoi21  g218(.a(new_n154_), .b(x04), .c(x79), .O(new_n379_));
  aoi21  g219(.a(new_n357_), .b(x79), .c(new_n379_), .O(new_n380_));
  aoi21  g220(.a(new_n380_), .b(new_n378_), .c(x01), .O(z60));
  nand2  g221(.a(new_n165_), .b(new_n164_), .O(new_n382_));
  aoi22  g222(.a(new_n382_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n383_));
  nand2  g223(.a(new_n168_), .b(x80), .O(new_n384_));
  nor2   g224(.a(new_n384_), .b(new_n383_), .O(z61));
  nand2  g225(.a(x78), .b(new_n233_), .O(new_n386_));
  nand2  g226(.a(x84), .b(new_n154_), .O(new_n387_));
  aoi21  g227(.a(new_n387_), .b(new_n386_), .c(new_n163_), .O(new_n388_));
  nand2  g228(.a(new_n351_), .b(x84), .O(new_n389_));
  inv1   g229(.a(new_n389_), .O(new_n390_));
  nor2   g230(.a(new_n251_), .b(new_n167_), .O(new_n391_));
  oai21  g231(.a(new_n390_), .b(new_n388_), .c(new_n391_), .O(new_n392_));
  aoi21  g232(.a(new_n392_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g233(.a(new_n168_), .b(x82), .O(new_n394_));
  nor2   g234(.a(new_n394_), .b(new_n383_), .O(z63));
  oai21  g235(.a(new_n251_), .b(x78), .c(new_n386_), .O(new_n397_));
  nand2  g236(.a(new_n397_), .b(x77), .O(new_n398_));
  nand2  g237(.a(new_n351_), .b(x81), .O(new_n399_));
  nand2  g238(.a(new_n168_), .b(x84), .O(new_n400_));
