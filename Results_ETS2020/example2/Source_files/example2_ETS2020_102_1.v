...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n234_, new_n236_, new_n239_, new_n242_,
  ...
  nand2  g113(.a(new_n220_), .b(x57), .O(new_n276_));
  nor2   g114(.a(new_n276_), .b(new_n268_), .O(z39));
  nor3   g115(.a(new_n268_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g116(.a(new_n268_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g117(.a(new_n268_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g118(.a(new_n268_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g119(.a(new_n268_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g120(.a(new_n268_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g121(.a(new_n268_), .b(new_n221_), .c(new_n173_), .O(z46));
