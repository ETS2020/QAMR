...
module FAU ( 
  ...
  nand2  g116(.a(new_n222_), .b(x54), .O(new_n275_));
  nor2   g117(.a(new_n275_), .b(new_n271_), .O(z36));
  nand2  g118(.a(new_n222_), .b(x55), .O(new_n277_));
  nor2   g119(.a(new_n277_), .b(new_n271_), .O(z37));
  nand2  g120(.a(new_n222_), .b(x56), .O(new_n279_));
  nor2   g121(.a(new_n279_), .b(new_n271_), .O(z38));
  nor3   g122(.a(new_n271_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g123(.a(new_n271_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g124(.a(new_n271_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g125(.a(new_n271_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g126(.a(new_n271_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g127(.a(new_n271_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g128(.a(new_n271_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g129(.a(new_n271_), .b(new_n223_), .c(new_n173_), .O(z46));
  nand2  g130(.a(x52), .b(x22), .O(new_n296_));
  nand2  g131(.a(new_n262_), .b(x14), .O(new_n297_));
  nor2   g132(.a(new_n154_), .b(x77), .O(new_n298_));
  nand4  g133(.a(new_n298_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n299_));
  aoi21  g134(.a(new_n297_), .b(new_n296_), .c(new_n299_), .O(z54));
  inv1   g135(.a(x82), .O(new_n301_));
  nand3  g136(.a(new_n249_), .b(x84), .c(new_n301_), .O(new_n302_));
  inv1   g137(.a(x80), .O(new_n303_));
  nand4  g138(.a(new_n222_), .b(new_n163_), .c(new_n303_), .d(x79), .O(new_n304_));
  nor2   g139(.a(new_n304_), .b(new_n302_), .O(z55));
  aoi21  g140(.a(x84), .b(new_n229_), .c(x76), .O(new_n306_));
  oai21  g141(.a(x84), .b(new_n229_), .c(new_n306_), .O(new_n307_));
  nand2  g142(.a(new_n307_), .b(new_n164_), .O(new_n308_));
  nand4  g143(.a(new_n308_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g144(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n311_));
  inv1   g145(.a(x74), .O(new_n312_));
  nand4  g146(.a(x80), .b(new_n312_), .c(x43), .d(new_n225_), .O(new_n313_));
  oai22  g147(.a(new_n313_), .b(new_n311_), .c(new_n225_), .d(x40), .O(new_n314_));
  nand2  g148(.a(x78), .b(x04), .O(new_n315_));
  inv1   g149(.a(new_n315_), .O(new_n316_));
  nand3  g150(.a(new_n316_), .b(new_n314_), .c(x79), .O(new_n317_));
  nand4  g151(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n318_));
  nand2  g152(.a(new_n318_), .b(new_n317_), .O(new_n319_));
  nand2  g153(.a(new_n319_), .b(x77), .O(new_n320_));
  oai21  g154(.a(new_n298_), .b(new_n218_), .c(new_n162_), .O(new_n321_));
  aoi21  g155(.a(new_n321_), .b(new_n320_), .c(x01), .O(z58));
  aoi21  g156(.a(new_n315_), .b(x79), .c(new_n152_), .O(new_n323_));
  nand3  g157(.a(x80), .b(new_n312_), .c(x43), .O(new_n324_));
  oai21  g158(.a(new_n324_), .b(new_n311_), .c(new_n225_), .O(new_n325_));
  aoi21  g159(.a(new_n325_), .b(x79), .c(new_n315_), .O(new_n326_));
  oai21  g160(.a(new_n326_), .b(new_n323_), .c(x77), .O(new_n327_));
  nand2  g161(.a(new_n162_), .b(new_n218_), .O(new_n328_));
  aoi21  g162(.a(new_n328_), .b(new_n327_), .c(x01), .O(z59));
  xnor2a g163(.a(x84), .b(x81), .O(new_n331_));
  nor2   g164(.a(x78), .b(new_n160_), .O(new_n332_));
  oai21  g165(.a(new_n332_), .b(new_n298_), .c(new_n331_), .O(new_n333_));
  nand2  g166(.a(new_n163_), .b(new_n218_), .O(new_n334_));
  nand2  g167(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  inv1   g168(.a(new_n335_), .O(new_n336_));
  nor2   g169(.a(new_n162_), .b(x01), .O(new_n337_));
  inv1   g170(.a(new_n337_), .O(new_n338_));
  nor3   g171(.a(new_n338_), .b(new_n336_), .c(new_n303_), .O(z61));
  nand3  g172(.a(x84), .b(x81), .c(x79), .O(new_n340_));
  oai21  g173(.a(x79), .b(new_n218_), .c(new_n340_), .O(new_n341_));
  nand2  g174(.a(new_n341_), .b(new_n160_), .O(new_n342_));
  nand2  g175(.a(new_n325_), .b(x79), .O(new_n343_));
  nand3  g176(.a(x81), .b(x79), .c(new_n218_), .O(new_n344_));
  inv1   g177(.a(new_n344_), .O(new_n345_));
  aoi21  g178(.a(new_n343_), .b(x04), .c(new_n345_), .O(new_n346_));
  oai21  g179(.a(new_n346_), .b(new_n160_), .c(new_n342_), .O(new_n347_));
  nand2  g180(.a(new_n347_), .b(x78), .O(new_n348_));
  inv1   g181(.a(new_n340_), .O(new_n349_));
  nand2  g182(.a(new_n349_), .b(new_n332_), .O(new_n350_));
  aoi21  g183(.a(new_n350_), .b(new_n348_), .c(x01), .O(z62));
  nor3   g184(.a(new_n338_), .b(new_n336_), .c(new_n301_), .O(z63));
  nand3  g185(.a(new_n335_), .b(x83), .c(x79), .O(new_n353_));
  nand3  g186(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n354_));
  aoi21  g187(.a(new_n354_), .b(new_n353_), .c(x01), .O(z64));
  nor2   g188(.a(new_n154_), .b(x04), .O(new_n356_));
  nor2   g189(.a(new_n229_), .b(x78), .O(new_n357_));
  oai21  g190(.a(new_n357_), .b(new_n356_), .c(x77), .O(new_n358_));
  nand2  g191(.a(new_n298_), .b(x81), .O(new_n359_));
  nand2  g192(.a(new_n337_), .b(x84), .O(new_n360_));
  aoi21  g193(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z65));
  zero   g194(.O(z02));
  zero   g195(.O(z04));
  zero   g196(.O(z15));
  zero   g197(.O(z18));
