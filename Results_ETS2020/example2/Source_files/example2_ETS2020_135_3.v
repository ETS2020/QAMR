...
module FAU ( 
  ...
  nor3   g139(.a(new_n286_), .b(new_n240_), .c(new_n200_), .O(z39));
  nor3   g140(.a(new_n286_), .b(new_n240_), .c(new_n197_), .O(z40));
  nor3   g141(.a(new_n286_), .b(new_n240_), .c(new_n194_), .O(z41));
  nor3   g142(.a(new_n286_), .b(new_n240_), .c(new_n191_), .O(z42));
  nor3   g143(.a(new_n286_), .b(new_n240_), .c(new_n188_), .O(z43));
  nor3   g144(.a(new_n286_), .b(new_n240_), .c(new_n185_), .O(z44));
  nor3   g145(.a(new_n286_), .b(new_n240_), .c(new_n182_), .O(z45));
  nor3   g146(.a(new_n286_), .b(new_n240_), .c(new_n179_), .O(z46));
  ...
  nand3  g213(.a(new_n370_), .b(new_n243_), .c(x40), .O(new_n371_));
  ...
  oai21  g220(.a(new_n227_), .b(new_n225_), .c(new_n243_), .O(new_n378_));
  ...
  nor2   g252(.a(new_n247_), .b(x78), .O(new_n410_));
