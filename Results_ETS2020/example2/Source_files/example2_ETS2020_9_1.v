...
module FAU ( 
  ...
  nor3   g111(.a(new_n269_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g112(.a(new_n269_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g113(.a(new_n269_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g114(.a(new_n269_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g115(.a(new_n269_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g116(.a(new_n269_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g117(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g118(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  nand2  g119(.a(x52), .b(x22), .O(new_n290_));
  nand2  g120(.a(new_n260_), .b(x14), .O(new_n291_));
  ...
  nand3  g125(.a(new_n247_), .b(x84), .c(new_n295_), .O(new_n296_));
  ...
  nand4  g133(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n305_));
