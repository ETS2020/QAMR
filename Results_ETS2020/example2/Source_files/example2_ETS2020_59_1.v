// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:41 2020
...
module FAU ( 
  ...
  nor3   g118(.a(new_n270_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g119(.a(new_n270_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g122(.a(new_n270_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g123(.a(new_n270_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g124(.a(new_n270_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g125(.a(new_n270_), .b(new_n223_), .c(new_n173_), .O(z46));
