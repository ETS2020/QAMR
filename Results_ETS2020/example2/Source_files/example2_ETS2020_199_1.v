// Benchmark "FAU" written by ABC on Sat Jun 27 02:04:04 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n197_, new_n198_, new_n201_, new_n202_, new_n206_,
    new_n207_, new_n209_, new_n210_, new_n212_, new_n213_, new_n216_,
  ...
  nand4  g084(.a(new_n231_), .b(new_n220_), .c(x50), .d(new_n223_), .O(new_n244_));
  inv1   g085(.a(new_n244_), .O(z32));
  ...
  nand2  g111(.a(new_n220_), .b(x55), .O(new_n273_));
  nor2   g112(.a(new_n273_), .b(new_n269_), .O(z37));
  nand2  g113(.a(new_n220_), .b(x56), .O(new_n275_));
  nor2   g114(.a(new_n275_), .b(new_n269_), .O(z38));
  nor3   g115(.a(new_n269_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g116(.a(new_n269_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g117(.a(new_n269_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g118(.a(new_n269_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g119(.a(new_n269_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g120(.a(new_n269_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g121(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g122(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  inv1   g123(.a(x07), .O(new_n285_));
  nand2  g124(.a(x52), .b(x15), .O(new_n286_));
  oai21  g125(.a(x52), .b(new_n285_), .c(new_n286_), .O(new_n287_));
  nand3  g126(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n288_));
  inv1   g127(.a(new_n288_), .O(new_n289_));
  nand2  g128(.a(new_n289_), .b(new_n287_), .O(new_n290_));
  xnor2a g129(.a(x84), .b(x81), .O(new_n291_));
  or2    g130(.a(x75), .b(x67), .O(new_n292_));
  nor2   g131(.a(x78), .b(new_n160_), .O(new_n293_));
  nand4  g132(.a(new_n293_), .b(new_n292_), .c(new_n291_), .d(x79), .O(new_n294_));
  aoi21  g133(.a(new_n294_), .b(new_n290_), .c(x01), .O(z47));
  nand2  g134(.a(x52), .b(x22), .O(new_n302_));
  nand2  g135(.a(new_n260_), .b(x14), .O(new_n303_));
  nor2   g136(.a(new_n154_), .b(x77), .O(new_n304_));
  nand4  g137(.a(new_n304_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n305_));
  aoi21  g138(.a(new_n303_), .b(new_n302_), .c(new_n305_), .O(z54));
  inv1   g139(.a(x82), .O(new_n307_));
  nand3  g140(.a(new_n247_), .b(x84), .c(new_n307_), .O(new_n308_));
  inv1   g141(.a(x80), .O(new_n309_));
  nand4  g142(.a(new_n220_), .b(new_n163_), .c(new_n309_), .d(x79), .O(new_n310_));
  nor2   g143(.a(new_n310_), .b(new_n308_), .O(z55));
  aoi21  g144(.a(x84), .b(new_n227_), .c(x76), .O(new_n312_));
  oai21  g145(.a(x84), .b(new_n227_), .c(new_n312_), .O(new_n313_));
  nand2  g146(.a(new_n313_), .b(new_n164_), .O(new_n314_));
  nand4  g147(.a(new_n314_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g148(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n317_));
  inv1   g149(.a(x74), .O(new_n318_));
  nand4  g150(.a(x80), .b(new_n318_), .c(x43), .d(new_n223_), .O(new_n319_));
  oai22  g151(.a(new_n319_), .b(new_n317_), .c(new_n223_), .d(x40), .O(new_n320_));
  nand2  g152(.a(x78), .b(x04), .O(new_n321_));
  inv1   g153(.a(new_n321_), .O(new_n322_));
  nand3  g154(.a(new_n322_), .b(new_n320_), .c(x79), .O(new_n323_));
  nand4  g155(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n324_));
  nand2  g156(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand2  g157(.a(new_n325_), .b(x77), .O(new_n326_));
  oai21  g158(.a(new_n304_), .b(new_n216_), .c(new_n162_), .O(new_n327_));
  aoi21  g159(.a(new_n327_), .b(new_n326_), .c(x01), .O(z58));
  aoi21  g160(.a(new_n321_), .b(x79), .c(new_n152_), .O(new_n329_));
  nand3  g161(.a(x80), .b(new_n318_), .c(x43), .O(new_n330_));
  oai21  g162(.a(new_n330_), .b(new_n317_), .c(new_n223_), .O(new_n331_));
  aoi21  g163(.a(new_n331_), .b(x79), .c(new_n321_), .O(new_n332_));
  oai21  g164(.a(new_n332_), .b(new_n329_), .c(x77), .O(new_n333_));
  nand2  g165(.a(new_n162_), .b(new_n216_), .O(new_n334_));
  aoi21  g166(.a(new_n334_), .b(new_n333_), .c(x01), .O(z59));
  oai21  g167(.a(new_n304_), .b(new_n293_), .c(new_n291_), .O(new_n337_));
  nand2  g168(.a(new_n163_), .b(new_n216_), .O(new_n338_));
  nand2  g169(.a(new_n338_), .b(new_n337_), .O(new_n339_));
  inv1   g170(.a(new_n339_), .O(new_n340_));
  nor2   g171(.a(new_n162_), .b(x01), .O(new_n341_));
  inv1   g172(.a(new_n341_), .O(new_n342_));
  nor3   g173(.a(new_n342_), .b(new_n340_), .c(new_n309_), .O(z61));
  nand3  g174(.a(x84), .b(x81), .c(x79), .O(new_n344_));
  oai21  g175(.a(x79), .b(new_n216_), .c(new_n344_), .O(new_n345_));
  nand2  g176(.a(new_n345_), .b(new_n160_), .O(new_n346_));
  nand2  g177(.a(new_n331_), .b(x79), .O(new_n347_));
  nand3  g178(.a(x81), .b(x79), .c(new_n216_), .O(new_n348_));
  inv1   g179(.a(new_n348_), .O(new_n349_));
  aoi21  g180(.a(new_n347_), .b(x04), .c(new_n349_), .O(new_n350_));
  oai21  g181(.a(new_n350_), .b(new_n160_), .c(new_n346_), .O(new_n351_));
  nand2  g182(.a(new_n351_), .b(x78), .O(new_n352_));
  inv1   g183(.a(new_n344_), .O(new_n353_));
  nand2  g184(.a(new_n353_), .b(new_n293_), .O(new_n354_));
  aoi21  g185(.a(new_n354_), .b(new_n352_), .c(x01), .O(z62));
  nor3   g186(.a(new_n342_), .b(new_n340_), .c(new_n307_), .O(z63));
  nand3  g187(.a(new_n339_), .b(x83), .c(x79), .O(new_n357_));
  aoi21  g188(.a(new_n357_), .b(new_n288_), .c(x01), .O(z64));
  nor2   g189(.a(new_n154_), .b(x04), .O(new_n359_));
  nor2   g190(.a(new_n227_), .b(x78), .O(new_n360_));
  oai21  g191(.a(new_n360_), .b(new_n359_), .c(x77), .O(new_n361_));
  nand2  g192(.a(new_n304_), .b(x81), .O(new_n362_));
  nand2  g193(.a(new_n341_), .b(x84), .O(new_n363_));
  aoi21  g194(.a(new_n362_), .b(new_n361_), .c(new_n363_), .O(z65));
  zero   g195(.O(z02));
  zero   g196(.O(z04));
  zero   g197(.O(z15));
  zero   g198(.O(z17));
