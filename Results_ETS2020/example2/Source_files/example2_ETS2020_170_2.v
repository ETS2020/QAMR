...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n294_, new_n298_, new_n299_, new_n300_, new_n302_, new_n303_,
    new_n304_, new_n305_, new_n306_, new_n307_, new_n308_, new_n310_,
    new_n311_, new_n314_, new_n315_, new_n316_, new_n317_, new_n318_,
    new_n319_, new_n320_, new_n322_, new_n327_, new_n328_, new_n329_,
    new_n330_;
  ...
  nand3  g091(.a(new_n211_), .b(new_n157_), .c(new_n153_), .O(new_n271_));
  inv1   g092(.a(new_n271_), .O(new_n272_));
  nand2  g093(.a(new_n272_), .b(new_n270_), .O(new_n273_));
  nor3   g094(.a(new_n199_), .b(new_n164_), .c(new_n157_), .O(new_n274_));
  nand2  g095(.a(new_n274_), .b(x68), .O(new_n275_));
  aoi21  g096(.a(new_n275_), .b(new_n273_), .c(x01), .O(z48));
  inv1   g097(.a(x09), .O(new_n277_));
  nand2  g098(.a(x52), .b(x17), .O(new_n278_));
  oai21  g099(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  nand2  g100(.a(new_n279_), .b(new_n272_), .O(new_n280_));
  nand2  g101(.a(new_n274_), .b(x69), .O(new_n281_));
  aoi21  g102(.a(new_n281_), .b(new_n280_), .c(x01), .O(z49));
  inv1   g103(.a(x11), .O(new_n284_));
  nand2  g104(.a(x52), .b(x19), .O(new_n285_));
  oai21  g105(.a(x52), .b(new_n284_), .c(new_n285_), .O(new_n286_));
  nand2  g106(.a(new_n286_), .b(new_n272_), .O(new_n287_));
  nand2  g107(.a(new_n274_), .b(x71), .O(new_n288_));
  aoi21  g108(.a(new_n288_), .b(new_n287_), .c(x01), .O(z51));
  inv1   g109(.a(x12), .O(new_n290_));
  nand2  g110(.a(x52), .b(x20), .O(new_n291_));
  oai21  g111(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand2  g112(.a(new_n292_), .b(new_n272_), .O(new_n293_));
  nand2  g113(.a(new_n274_), .b(x72), .O(new_n294_));
  aoi21  g114(.a(new_n294_), .b(new_n293_), .c(x01), .O(z52));
  nand2  g115(.a(x84), .b(x83), .O(new_n298_));
  nor2   g116(.a(x80), .b(new_n157_), .O(new_n299_));
  nand3  g117(.a(new_n299_), .b(new_n224_), .c(new_n155_), .O(new_n300_));
  nor4   g118(.a(new_n300_), .b(new_n298_), .c(x82), .d(x81), .O(z55));
  inv1   g119(.a(x01), .O(new_n302_));
  inv1   g120(.a(new_n155_), .O(new_n303_));
  xnor2a g121(.a(x84), .b(x81), .O(new_n304_));
  aoi21  g122(.a(new_n164_), .b(new_n163_), .c(new_n304_), .O(new_n305_));
  aoi22  g123(.a(new_n305_), .b(new_n302_), .c(new_n303_), .d(x76), .O(new_n306_));
  inv1   g124(.a(x00), .O(new_n307_));
  nor3   g125(.a(new_n158_), .b(x01), .c(new_n307_), .O(new_n308_));
  oai21  g126(.a(new_n306_), .b(new_n157_), .c(new_n308_), .O(z56));
  inv1   g127(.a(x02), .O(new_n310_));
  nand4  g128(.a(x03), .b(new_n310_), .c(new_n302_), .d(x00), .O(new_n311_));
  inv1   g129(.a(new_n311_), .O(z57));
  inv1   g130(.a(x40), .O(new_n314_));
  aoi21  g131(.a(new_n210_), .b(x79), .c(new_n314_), .O(new_n315_));
  oai21  g132(.a(new_n206_), .b(new_n204_), .c(new_n216_), .O(new_n316_));
  aoi21  g133(.a(new_n316_), .b(x79), .c(new_n210_), .O(new_n317_));
  oai21  g134(.a(new_n317_), .b(new_n315_), .c(x77), .O(new_n318_));
  nor2   g135(.a(x79), .b(x04), .O(new_n319_));
  inv1   g136(.a(new_n319_), .O(new_n320_));
  aoi21  g137(.a(new_n320_), .b(new_n318_), .c(x01), .O(z59));
  aoi21  g138(.a(new_n305_), .b(x79), .c(new_n319_), .O(new_n322_));
  aoi21  g139(.a(new_n322_), .b(new_n212_), .c(x01), .O(z60));
  aoi21  g140(.a(new_n164_), .b(new_n163_), .c(new_n199_), .O(new_n327_));
  nor2   g141(.a(new_n303_), .b(x04), .O(new_n328_));
  nor2   g142(.a(new_n203_), .b(new_n157_), .O(new_n329_));
  oai21  g143(.a(new_n328_), .b(new_n327_), .c(new_n329_), .O(new_n330_));
  aoi21  g144(.a(new_n330_), .b(new_n271_), .c(x01), .O(z64));
  zero   g145(.O(z00));
  zero   g146(.O(z03));
  zero   g147(.O(z05));
  zero   g148(.O(z06));
