// Benchmark "FAU" written by ABC on Sat Jun 27 02:08:12 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n257_, new_n258_, new_n261_, new_n263_, new_n265_,
  ...
  nand4  g109(.a(new_n257_), .b(new_n244_), .c(x48), .d(new_n248_), .O(new_n265_));
  inv1   g110(.a(new_n265_), .O(z30));
  nand4  g111(.a(new_n257_), .b(new_n244_), .c(x50), .d(new_n248_), .O(new_n268_));
