...
module FAU ( 
  ...
  nand2  g129(.a(new_n307_), .b(new_n281_), .O(new_n308_));
  nand2  g130(.a(new_n283_), .b(x73), .O(new_n309_));
  aoi21  g131(.a(new_n309_), .b(new_n308_), .c(x01), .O(z53));
  nand2  g132(.a(x84), .b(x83), .O(new_n312_));
  nor2   g133(.a(x80), .b(new_n154_), .O(new_n313_));
  nand3  g134(.a(new_n313_), .b(new_n233_), .c(new_n161_), .O(new_n314_));
  ...
  aoi21  g147(.a(new_n219_), .b(new_n327_), .c(new_n152_), .O(new_n328_));
  oai21  g148(.a(new_n215_), .b(new_n213_), .c(new_n225_), .O(new_n329_));
  aoi21  g149(.a(new_n329_), .b(x79), .c(new_n219_), .O(new_n330_));
  ...
  aoi21  g155(.a(new_n335_), .b(new_n221_), .c(x01), .O(z60));
  aoi21  g156(.a(new_n169_), .b(new_n168_), .c(new_n208_), .O(new_n340_));
  nor2   g157(.a(new_n316_), .b(x04), .O(new_n341_));
  nor2   g158(.a(new_n212_), .b(new_n154_), .O(new_n342_));
  oai21  g159(.a(new_n341_), .b(new_n340_), .c(new_n342_), .O(new_n343_));
  aoi21  g160(.a(new_n343_), .b(new_n280_), .c(x01), .O(z64));
  zero   g161(.O(z03));
  zero   g162(.O(z05));
  zero   g163(.O(z06));
  zero   g164(.O(z07));
