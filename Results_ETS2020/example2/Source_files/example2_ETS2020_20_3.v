...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n243_, new_n244_, new_n247_, new_n249_, new_n251_, new_n253_,
    new_n255_, new_n257_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n283_, new_n285_, new_n287_, new_n289_, new_n299_, new_n300_,
  ...
  aoi21  g085(.a(new_n242_), .b(new_n239_), .c(new_n156_), .O(new_n243_));
  nand4  g086(.a(new_n243_), .b(new_n233_), .c(new_n236_), .d(x05), .O(new_n244_));
  inv1   g087(.a(new_n244_), .O(z25));
  nand4  g088(.a(new_n243_), .b(new_n233_), .c(x45), .d(new_n236_), .O(new_n247_));
  ...
  nor2   g100(.a(new_n217_), .b(x81), .O(new_n259_));
  ...
  nand2  g115(.a(new_n273_), .b(new_n240_), .O(new_n274_));
  nand3  g116(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  nand2  g117(.a(new_n275_), .b(new_n274_), .O(new_n276_));
  and2   g118(.a(new_n276_), .b(new_n241_), .O(new_n277_));
  nand2  g119(.a(new_n273_), .b(x81), .O(new_n278_));
  nand2  g120(.a(new_n259_), .b(x42), .O(new_n279_));
  aoi21  g121(.a(new_n279_), .b(new_n278_), .c(new_n237_), .O(new_n280_));
  oai21  g122(.a(new_n280_), .b(new_n277_), .c(new_n269_), .O(new_n281_));
  nor3   g123(.a(new_n281_), .b(new_n234_), .c(new_n272_), .O(z34));
  nand2  g124(.a(new_n233_), .b(x53), .O(new_n283_));
  nor2   g125(.a(new_n283_), .b(new_n281_), .O(z35));
  nand2  g126(.a(new_n233_), .b(x54), .O(new_n285_));
  nor2   g127(.a(new_n285_), .b(new_n281_), .O(z36));
  nand2  g128(.a(new_n233_), .b(x55), .O(new_n287_));
  nor2   g129(.a(new_n287_), .b(new_n281_), .O(z37));
  nand2  g130(.a(new_n233_), .b(x56), .O(new_n289_));
  nor2   g131(.a(new_n289_), .b(new_n281_), .O(z38));
  nor3   g132(.a(new_n281_), .b(new_n234_), .c(new_n195_), .O(z39));
  nor3   g133(.a(new_n281_), .b(new_n234_), .c(new_n192_), .O(z40));
  nor3   g134(.a(new_n281_), .b(new_n234_), .c(new_n189_), .O(z41));
  nor3   g135(.a(new_n281_), .b(new_n234_), .c(new_n186_), .O(z42));
  nor3   g136(.a(new_n281_), .b(new_n234_), .c(new_n183_), .O(z43));
  nor3   g137(.a(new_n281_), .b(new_n234_), .c(new_n180_), .O(z44));
  nor3   g138(.a(new_n281_), .b(new_n234_), .c(new_n177_), .O(z45));
  nor3   g139(.a(new_n281_), .b(new_n234_), .c(new_n174_), .O(z46));
  ...
  nand2  g144(.a(new_n302_), .b(new_n224_), .O(new_n303_));
  ...
  nand2  g150(.a(new_n308_), .b(new_n214_), .O(new_n309_));
  ...
  inv1   g156(.a(new_n214_), .O(new_n315_));
  ...
  nand2  g191(.a(new_n272_), .b(x14), .O(new_n350_));
  nand4  g192(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n227_), .O(new_n351_));
  aoi21  g193(.a(new_n350_), .b(new_n349_), .c(new_n351_), .O(z54));
  inv1   g194(.a(x82), .O(new_n353_));
  nand3  g195(.a(new_n259_), .b(x84), .c(new_n353_), .O(new_n354_));
  inv1   g196(.a(x80), .O(new_n355_));
  nand4  g197(.a(new_n233_), .b(new_n155_), .c(new_n355_), .d(x79), .O(new_n356_));
  nor2   g198(.a(new_n356_), .b(new_n354_), .O(z55));
  inv1   g199(.a(x02), .O(new_n359_));
  nand4  g200(.a(x03), .b(new_n359_), .c(new_n227_), .d(x00), .O(new_n360_));
  inv1   g201(.a(new_n360_), .O(z57));
  nand4  g202(.a(x80), .b(new_n219_), .c(x43), .d(new_n236_), .O(new_n362_));
  oai22  g203(.a(new_n362_), .b(new_n218_), .c(new_n236_), .d(x40), .O(new_n363_));
  nand3  g204(.a(new_n363_), .b(new_n224_), .c(x79), .O(new_n364_));
  nand4  g205(.a(new_n157_), .b(new_n154_), .c(new_n236_), .d(x40), .O(new_n365_));
  nand2  g206(.a(new_n365_), .b(new_n364_), .O(new_n366_));
  nand2  g207(.a(new_n366_), .b(x77), .O(new_n367_));
  oai21  g208(.a(new_n161_), .b(new_n228_), .c(new_n157_), .O(new_n368_));
  aoi21  g209(.a(new_n368_), .b(new_n367_), .c(x01), .O(z58));
  aoi21  g210(.a(new_n223_), .b(x79), .c(new_n173_), .O(new_n370_));
  oai21  g211(.a(new_n220_), .b(new_n218_), .c(new_n236_), .O(new_n371_));
  aoi21  g212(.a(new_n371_), .b(x79), .c(new_n223_), .O(new_n372_));
  ...
  aoi21  g220(.a(new_n379_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g221(.a(new_n166_), .O(new_n381_));
  oai21  g222(.a(new_n163_), .b(new_n161_), .c(new_n214_), .O(new_n382_));
  nand2  g223(.a(new_n155_), .b(new_n228_), .O(new_n383_));
  ...
  oai21  g228(.a(x79), .b(new_n228_), .c(new_n387_), .O(new_n388_));
  nand2  g229(.a(new_n388_), .b(new_n153_), .O(new_n389_));
  nand2  g230(.a(new_n371_), .b(x79), .O(new_n390_));
  nand3  g231(.a(x81), .b(x79), .c(new_n228_), .O(new_n391_));
  ...
  nor2   g243(.a(new_n240_), .b(x78), .O(new_n403_));
