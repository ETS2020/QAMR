...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n226_,
  ...
  inv1   g060(.a(x42), .O(new_n226_));
  inv1   g061(.a(x81), .O(new_n227_));
  xor2a  g062(.a(x84), .b(x82), .O(new_n228_));
  nor2   g063(.a(new_n228_), .b(new_n227_), .O(new_n229_));
  xnor2a g064(.a(x84), .b(x82), .O(new_n230_));
  nor2   g065(.a(new_n230_), .b(x81), .O(new_n231_));
  nor2   g066(.a(new_n231_), .b(new_n229_), .O(new_n232_));
  nor2   g067(.a(new_n232_), .b(new_n162_), .O(new_n233_));
  nor2   g068(.a(x04), .b(x01), .O(new_n234_));
  nand4  g069(.a(new_n234_), .b(new_n233_), .c(x45), .d(new_n226_), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(z27));
  nand4  g071(.a(new_n234_), .b(new_n233_), .c(x46), .d(new_n226_), .O(new_n237_));
  inv1   g072(.a(new_n237_), .O(z28));
  nand4  g073(.a(new_n234_), .b(new_n233_), .c(x48), .d(new_n226_), .O(new_n240_));
  inv1   g074(.a(new_n240_), .O(z30));
  nand4  g075(.a(new_n234_), .b(new_n233_), .c(x49), .d(new_n226_), .O(new_n242_));
  inv1   g076(.a(new_n242_), .O(z31));
  nand4  g077(.a(new_n234_), .b(new_n233_), .c(x50), .d(new_n226_), .O(new_n244_));
  inv1   g078(.a(new_n244_), .O(z32));
  inv1   g079(.a(new_n162_), .O(new_n248_));
  nand2  g080(.a(x83), .b(x42), .O(new_n249_));
  nand2  g081(.a(new_n249_), .b(new_n227_), .O(new_n250_));
  inv1   g082(.a(new_n249_), .O(new_n251_));
  nand2  g083(.a(new_n251_), .b(x81), .O(new_n252_));
  aoi21  g084(.a(new_n252_), .b(new_n250_), .c(new_n230_), .O(new_n253_));
  nand2  g085(.a(new_n249_), .b(x81), .O(new_n254_));
  nand2  g086(.a(new_n251_), .b(new_n227_), .O(new_n255_));
  aoi21  g087(.a(new_n255_), .b(new_n254_), .c(new_n228_), .O(new_n256_));
  oai21  g088(.a(new_n256_), .b(new_n253_), .c(new_n248_), .O(new_n257_));
  nand2  g089(.a(new_n234_), .b(x53), .O(new_n258_));
  nor2   g090(.a(new_n258_), .b(new_n257_), .O(z35));
  nand2  g091(.a(new_n234_), .b(x54), .O(new_n260_));
  nor2   g092(.a(new_n260_), .b(new_n257_), .O(z36));
  nand2  g093(.a(new_n234_), .b(x55), .O(new_n262_));
  ...
  nand2  g099(.a(new_n276_), .b(new_n219_), .O(new_n277_));
  ...
  nand2  g105(.a(new_n282_), .b(new_n208_), .O(new_n283_));
  ...
  nor2   g111(.a(new_n281_), .b(new_n207_), .O(new_n289_));
  ...
  nand3  g146(.a(new_n324_), .b(new_n234_), .c(new_n161_), .O(new_n325_));
  ...
  aoi21  g159(.a(new_n218_), .b(new_n338_), .c(new_n152_), .O(new_n339_));
  oai21  g160(.a(new_n214_), .b(new_n212_), .c(new_n226_), .O(new_n340_));
  aoi21  g161(.a(new_n340_), .b(x79), .c(new_n218_), .O(new_n341_));
  ...
  aoi21  g167(.a(new_n346_), .b(new_n220_), .c(x01), .O(z60));
  aoi21  g168(.a(new_n169_), .b(new_n168_), .c(new_n207_), .O(new_n351_));
  nor2   g169(.a(new_n327_), .b(x04), .O(new_n352_));
  nor2   g170(.a(new_n211_), .b(new_n154_), .O(new_n353_));
  oai21  g171(.a(new_n352_), .b(new_n351_), .c(new_n353_), .O(new_n354_));
  aoi21  g172(.a(new_n354_), .b(new_n277_), .c(x01), .O(z64));
  nor2   g173(.a(new_n160_), .b(x04), .O(new_n356_));
  nor2   g174(.a(new_n227_), .b(x78), .O(new_n357_));
  oai21  g175(.a(new_n357_), .b(new_n356_), .c(x77), .O(new_n358_));
  nand3  g176(.a(x81), .b(x78), .c(new_n159_), .O(new_n359_));
  nand2  g177(.a(new_n171_), .b(x84), .O(new_n360_));
  aoi21  g178(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z65));
  zero   g179(.O(z06));
  zero   g180(.O(z07));
  zero   g181(.O(z08));
  zero   g182(.O(z09));
