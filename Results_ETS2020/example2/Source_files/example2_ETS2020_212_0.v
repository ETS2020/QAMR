...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n257_, new_n258_, new_n261_, new_n263_, new_n266_,
  ...
  nand4  g109(.a(new_n257_), .b(new_n244_), .c(x49), .d(new_n248_), .O(new_n266_));
  inv1   g110(.a(new_n266_), .O(z31));
  xnor2a g111(.a(x83), .b(x81), .O(new_n269_));
  nand2  g112(.a(x42), .b(x05), .O(new_n270_));
  nand2  g113(.a(x51), .b(new_n248_), .O(new_n271_));
  oai22  g114(.a(new_n271_), .b(new_n252_), .c(new_n270_), .d(new_n269_), .O(new_n272_));
  nand2  g115(.a(new_n272_), .b(new_n250_), .O(new_n273_));
  xor2a  g116(.a(x83), .b(x81), .O(new_n274_));
  oai22  g117(.a(new_n274_), .b(new_n270_), .c(new_n271_), .d(x81), .O(new_n275_));
  nand2  g118(.a(new_n275_), .b(new_n254_), .O(new_n276_));
  inv1   g119(.a(new_n256_), .O(new_n277_));
  ...
  nand2  g124(.a(new_n281_), .b(new_n252_), .O(new_n282_));
  nand3  g125(.a(x83), .b(x81), .c(x42), .O(new_n283_));
  aoi21  g126(.a(new_n283_), .b(new_n282_), .c(new_n253_), .O(new_n284_));
  nand2  g127(.a(new_n281_), .b(x81), .O(new_n285_));
  nand3  g128(.a(x83), .b(new_n252_), .c(x42), .O(new_n286_));
  aoi21  g129(.a(new_n286_), .b(new_n285_), .c(new_n249_), .O(new_n287_));
  ...
  nand4  g209(.a(x80), .b(new_n228_), .c(x43), .d(new_n248_), .O(new_n369_));
  ...
  nand4  g214(.a(new_n167_), .b(new_n154_), .c(new_n248_), .d(x40), .O(new_n374_));
  ...
  nor2   g234(.a(new_n252_), .b(new_n167_), .O(new_n395_));
  ...
  oai21  g239(.a(new_n252_), .b(x78), .c(new_n390_), .O(new_n401_));
