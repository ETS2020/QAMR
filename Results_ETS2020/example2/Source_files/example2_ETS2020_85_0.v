// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:36 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n289_, new_n290_, new_n291_, new_n294_, new_n297_,
  ...
  nand2  g118(.a(x42), .b(x05), .O(new_n273_));
  nand2  g119(.a(x51), .b(new_n247_), .O(new_n274_));
  oai22  g120(.a(new_n274_), .b(new_n251_), .c(new_n273_), .d(new_n272_), .O(new_n275_));
  nand2  g121(.a(new_n275_), .b(new_n249_), .O(new_n276_));
  xor2a  g122(.a(x83), .b(x81), .O(new_n277_));
  oai22  g123(.a(new_n277_), .b(new_n273_), .c(new_n274_), .d(x81), .O(new_n278_));
  nand2  g124(.a(new_n278_), .b(new_n253_), .O(new_n279_));
  inv1   g125(.a(new_n255_), .O(new_n280_));
  nand2  g126(.a(new_n280_), .b(new_n244_), .O(new_n281_));
  aoi21  g127(.a(new_n279_), .b(new_n276_), .c(new_n281_), .O(z33));
  inv1   g128(.a(x52), .O(new_n283_));
  nand2  g129(.a(x83), .b(x42), .O(new_n284_));
  nand2  g130(.a(new_n284_), .b(new_n251_), .O(new_n285_));
  nand3  g131(.a(x83), .b(x81), .c(x42), .O(new_n286_));
  aoi21  g132(.a(new_n286_), .b(new_n285_), .c(new_n252_), .O(new_n287_));
  nand2  g133(.a(new_n284_), .b(x81), .O(new_n288_));
  nand3  g134(.a(x83), .b(new_n251_), .c(x42), .O(new_n289_));
  aoi21  g135(.a(new_n289_), .b(new_n288_), .c(new_n248_), .O(new_n290_));
  oai21  g136(.a(new_n290_), .b(new_n287_), .c(new_n280_), .O(new_n291_));
  nor3   g137(.a(new_n291_), .b(new_n245_), .c(new_n283_), .O(z34));
  nand2  g138(.a(new_n244_), .b(x54), .O(new_n294_));
  nor2   g139(.a(new_n294_), .b(new_n291_), .O(z36));
  nand2  g140(.a(new_n244_), .b(x56), .O(new_n297_));
  nor2   g141(.a(new_n297_), .b(new_n291_), .O(z38));
  nor3   g142(.a(new_n291_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g143(.a(new_n291_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g144(.a(new_n291_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g145(.a(new_n291_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g146(.a(new_n291_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g147(.a(new_n291_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g148(.a(new_n291_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g149(.a(new_n291_), .b(new_n245_), .c(new_n176_), .O(z46));
  inv1   g150(.a(x07), .O(new_n307_));
  nand2  g151(.a(x52), .b(x15), .O(new_n308_));
  oai21  g152(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand3  g153(.a(new_n234_), .b(new_n167_), .c(new_n163_), .O(new_n310_));
  inv1   g154(.a(new_n310_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(new_n309_), .O(new_n312_));
  nor2   g156(.a(x75), .b(x67), .O(new_n313_));
  nand3  g157(.a(x79), .b(new_n154_), .c(x77), .O(new_n314_));
  nor2   g158(.a(new_n314_), .b(new_n313_), .O(new_n315_));
  nand2  g159(.a(new_n315_), .b(new_n223_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n312_), .c(x01), .O(z47));
  inv1   g161(.a(x08), .O(new_n318_));
  nand2  g162(.a(x52), .b(x16), .O(new_n319_));
  oai21  g163(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g164(.a(new_n320_), .b(new_n311_), .O(new_n321_));
  nor2   g165(.a(new_n314_), .b(new_n222_), .O(new_n322_));
  nand2  g166(.a(new_n322_), .b(x68), .O(new_n323_));
  aoi21  g167(.a(new_n323_), .b(new_n321_), .c(x01), .O(z48));
  inv1   g168(.a(x09), .O(new_n325_));
  nand2  g169(.a(x52), .b(x17), .O(new_n326_));
  oai21  g170(.a(x52), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g171(.a(new_n327_), .b(new_n311_), .O(new_n328_));
  ...
  nand2  g177(.a(new_n333_), .b(new_n311_), .O(new_n334_));
  ...
  nand2  g183(.a(new_n339_), .b(new_n311_), .O(new_n340_));
  ...
  nand2  g189(.a(new_n345_), .b(new_n311_), .O(new_n346_));
  ...
  nand2  g195(.a(new_n351_), .b(new_n311_), .O(new_n352_));
  nand2  g196(.a(new_n322_), .b(x73), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n352_), .c(x01), .O(z53));
  nand2  g198(.a(x52), .b(x22), .O(new_n355_));
  nand2  g199(.a(new_n283_), .b(x14), .O(new_n356_));
  inv1   g200(.a(new_n164_), .O(new_n357_));
  nand4  g201(.a(new_n357_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n358_));
  aoi21  g202(.a(new_n356_), .b(new_n355_), .c(new_n358_), .O(z54));
  inv1   g203(.a(new_n242_), .O(new_n361_));
  xnor2a g204(.a(x84), .b(x81), .O(new_n362_));
  aoi21  g205(.a(new_n165_), .b(new_n164_), .c(new_n362_), .O(new_n363_));
  aoi22  g206(.a(new_n363_), .b(new_n153_), .c(new_n361_), .d(x76), .O(new_n364_));
  aoi21  g207(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n365_));
  oai21  g208(.a(new_n364_), .b(new_n167_), .c(new_n365_), .O(z56));
  inv1   g209(.a(x02), .O(new_n367_));
  nand3  g210(.a(new_n239_), .b(x03), .c(new_n367_), .O(new_n368_));
  inv1   g211(.a(new_n368_), .O(z57));
  nand2  g212(.a(x42), .b(new_n152_), .O(new_n370_));
  nand4  g213(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n371_));
  oai21  g214(.a(new_n371_), .b(new_n227_), .c(new_n370_), .O(new_n372_));
  nand3  g215(.a(x79), .b(x78), .c(x04), .O(new_n373_));
  inv1   g216(.a(new_n373_), .O(new_n374_));
  nand2  g217(.a(new_n374_), .b(new_n372_), .O(new_n375_));
  nand4  g218(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n376_));
  nand2  g219(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g221(.a(new_n357_), .b(new_n233_), .c(new_n167_), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  nand2  g223(.a(new_n234_), .b(new_n230_), .O(new_n382_));
  inv1   g224(.a(new_n382_), .O(new_n383_));
  oai21  g225(.a(new_n229_), .b(new_n227_), .c(new_n383_), .O(new_n384_));
  aoi21  g226(.a(new_n154_), .b(x04), .c(x79), .O(new_n385_));
  aoi21  g227(.a(new_n363_), .b(x79), .c(new_n385_), .O(new_n386_));
  aoi21  g228(.a(new_n386_), .b(new_n384_), .c(x01), .O(z60));
  nand2  g229(.a(new_n165_), .b(new_n164_), .O(new_n388_));
  aoi22  g230(.a(new_n388_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n389_));
  nand2  g231(.a(new_n168_), .b(x80), .O(new_n390_));
  nor2   g232(.a(new_n390_), .b(new_n389_), .O(z61));
  nand2  g233(.a(x78), .b(new_n233_), .O(new_n392_));
  nand2  g234(.a(x84), .b(new_n154_), .O(new_n393_));
  aoi21  g235(.a(new_n393_), .b(new_n392_), .c(new_n163_), .O(new_n394_));
  nand2  g236(.a(new_n357_), .b(x84), .O(new_n395_));
  inv1   g237(.a(new_n395_), .O(new_n396_));
  nor2   g238(.a(new_n251_), .b(new_n167_), .O(new_n397_));
  oai21  g239(.a(new_n396_), .b(new_n394_), .c(new_n397_), .O(new_n398_));
  aoi21  g240(.a(new_n398_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g241(.a(new_n168_), .b(x82), .O(new_n400_));
  nor2   g242(.a(new_n400_), .b(new_n389_), .O(z63));
  oai21  g243(.a(new_n251_), .b(x78), .c(new_n392_), .O(new_n403_));
  nand2  g244(.a(new_n403_), .b(x77), .O(new_n404_));
  nand2  g245(.a(new_n357_), .b(x81), .O(new_n405_));
  nand2  g246(.a(new_n168_), .b(x84), .O(new_n406_));
