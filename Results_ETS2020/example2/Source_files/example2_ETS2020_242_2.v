// Benchmark "FAU" written by ABC on Sat Jun 27 02:07:14 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n253_, new_n254_, new_n256_, new_n258_, new_n260_, new_n270_,
  ...
  nand4  g063(.a(new_n227_), .b(new_n226_), .c(x44), .d(new_n219_), .O(new_n230_));
  inv1   g064(.a(new_n230_), .O(z26));
  nand4  g065(.a(new_n227_), .b(new_n226_), .c(x45), .d(new_n219_), .O(new_n232_));
  ...
  inv1   g091(.a(x07), .O(new_n270_));
  nand2  g092(.a(x52), .b(x15), .O(new_n271_));
  oai21  g093(.a(x52), .b(new_n270_), .c(new_n271_), .O(new_n272_));
  nor2   g094(.a(x79), .b(x77), .O(new_n273_));
  nand2  g095(.a(new_n273_), .b(new_n214_), .O(new_n274_));
  inv1   g096(.a(new_n274_), .O(new_n275_));
  nand2  g097(.a(new_n275_), .b(new_n272_), .O(new_n276_));
  nor2   g098(.a(x75), .b(x67), .O(new_n277_));
  nand3  g099(.a(x79), .b(new_n160_), .c(x77), .O(new_n278_));
  nor2   g100(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  nand2  g101(.a(new_n279_), .b(new_n203_), .O(new_n280_));
  aoi21  g102(.a(new_n280_), .b(new_n276_), .c(x01), .O(z47));
  inv1   g103(.a(x08), .O(new_n282_));
  nand2  g104(.a(x52), .b(x16), .O(new_n283_));
  oai21  g105(.a(x52), .b(new_n282_), .c(new_n283_), .O(new_n284_));
  nand2  g106(.a(new_n284_), .b(new_n275_), .O(new_n285_));
  nor2   g107(.a(new_n278_), .b(new_n202_), .O(new_n286_));
  ...
  nand2  g113(.a(new_n291_), .b(new_n275_), .O(new_n292_));
  ...
  nand2  g119(.a(new_n297_), .b(new_n275_), .O(new_n298_));
  ...
  nand2  g125(.a(new_n303_), .b(new_n275_), .O(new_n304_));
  ...
  nand2  g131(.a(new_n309_), .b(new_n275_), .O(new_n310_));
  ...
  nand2  g137(.a(new_n315_), .b(new_n275_), .O(new_n316_));
  nand2  g138(.a(new_n286_), .b(x73), .O(new_n317_));
  aoi21  g139(.a(new_n317_), .b(new_n316_), .c(x01), .O(z53));
  nand2  g140(.a(x84), .b(x83), .O(new_n320_));
  nor2   g141(.a(x80), .b(new_n154_), .O(new_n321_));
  nand3  g142(.a(new_n321_), .b(new_n227_), .c(new_n161_), .O(new_n322_));
  nor4   g143(.a(new_n322_), .b(new_n320_), .c(x82), .d(x81), .O(z55));
  inv1   g144(.a(new_n161_), .O(new_n324_));
  xnor2a g145(.a(x84), .b(x81), .O(new_n325_));
  aoi21  g146(.a(new_n169_), .b(new_n168_), .c(new_n325_), .O(new_n326_));
  aoi22  g147(.a(new_n326_), .b(new_n153_), .c(new_n324_), .d(x76), .O(new_n327_));
  inv1   g148(.a(x00), .O(new_n328_));
  nor3   g149(.a(new_n163_), .b(x01), .c(new_n328_), .O(new_n329_));
  oai21  g150(.a(new_n327_), .b(new_n154_), .c(new_n329_), .O(z56));
  inv1   g151(.a(x02), .O(new_n331_));
  nand4  g152(.a(x03), .b(new_n331_), .c(new_n153_), .d(x00), .O(new_n332_));
  inv1   g153(.a(new_n332_), .O(z57));
  nand2  g154(.a(new_n154_), .b(new_n160_), .O(new_n335_));
  aoi21  g155(.a(new_n213_), .b(new_n335_), .c(new_n152_), .O(new_n336_));
  oai21  g156(.a(new_n209_), .b(new_n207_), .c(new_n219_), .O(new_n337_));
  aoi21  g157(.a(new_n337_), .b(x79), .c(new_n213_), .O(new_n338_));
  oai21  g158(.a(new_n338_), .b(new_n336_), .c(x77), .O(new_n339_));
  nor2   g159(.a(x79), .b(x04), .O(new_n340_));
  inv1   g160(.a(new_n340_), .O(new_n341_));
  aoi21  g161(.a(new_n341_), .b(new_n339_), .c(x01), .O(z59));
  aoi21  g162(.a(new_n326_), .b(x79), .c(new_n340_), .O(new_n343_));
  aoi21  g163(.a(new_n343_), .b(new_n215_), .c(x01), .O(z60));
  aoi21  g164(.a(new_n169_), .b(new_n168_), .c(new_n202_), .O(new_n348_));
  nor2   g165(.a(new_n324_), .b(x04), .O(new_n349_));
  nor2   g166(.a(new_n206_), .b(new_n154_), .O(new_n350_));
  oai21  g167(.a(new_n349_), .b(new_n348_), .c(new_n350_), .O(new_n351_));
  aoi21  g168(.a(new_n351_), .b(new_n274_), .c(x01), .O(z64));
  zero   g169(.O(z03));
  zero   g170(.O(z05));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
