// Benchmark "FAU" written by ABC on Sat Jun 27 01:49:43 2020
...
module FAU ( 
  ...
  nor3   g134(.a(new_n283_), .b(new_n235_), .c(new_n195_), .O(z39));
  nor3   g135(.a(new_n283_), .b(new_n235_), .c(new_n192_), .O(z40));
  nor3   g136(.a(new_n283_), .b(new_n235_), .c(new_n189_), .O(z41));
  nor3   g137(.a(new_n283_), .b(new_n235_), .c(new_n186_), .O(z42));
  nor3   g138(.a(new_n283_), .b(new_n235_), .c(new_n183_), .O(z43));
  nor3   g139(.a(new_n283_), .b(new_n235_), .c(new_n180_), .O(z44));
  nor3   g140(.a(new_n283_), .b(new_n235_), .c(new_n177_), .O(z45));
  nor3   g141(.a(new_n283_), .b(new_n235_), .c(new_n174_), .O(z46));
  ...
  aoi21  g212(.a(new_n225_), .b(x79), .c(new_n173_), .O(new_n371_));
