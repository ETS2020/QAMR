...
module FAU ( 
  ...
  nor3   g136(.a(new_n282_), .b(new_n236_), .c(new_n191_), .O(z42));
  nor3   g137(.a(new_n282_), .b(new_n236_), .c(new_n188_), .O(z43));
  nor3   g138(.a(new_n282_), .b(new_n236_), .c(new_n185_), .O(z44));
  nor3   g139(.a(new_n282_), .b(new_n236_), .c(new_n182_), .O(z45));
  nor3   g140(.a(new_n282_), .b(new_n236_), .c(new_n179_), .O(z46));
