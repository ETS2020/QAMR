// Benchmark "FAU" written by ABC on Sat Jun 27 02:06:52 2020
...
module FAU ( 
  ...
  nor3   g136(.a(new_n283_), .b(new_n237_), .c(new_n194_), .O(z40));
  nor3   g137(.a(new_n283_), .b(new_n237_), .c(new_n191_), .O(z41));
  nor3   g138(.a(new_n283_), .b(new_n237_), .c(new_n188_), .O(z42));
  nor3   g139(.a(new_n283_), .b(new_n237_), .c(new_n185_), .O(z43));
  nor3   g140(.a(new_n283_), .b(new_n237_), .c(new_n182_), .O(z44));
  nor3   g141(.a(new_n283_), .b(new_n237_), .c(new_n179_), .O(z45));
  nor3   g142(.a(new_n283_), .b(new_n237_), .c(new_n176_), .O(z46));
  ...
  aoi21  g213(.a(new_n227_), .b(x79), .c(new_n175_), .O(new_n372_));
