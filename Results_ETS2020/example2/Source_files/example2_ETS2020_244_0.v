...
module FAU ( 
  ...
  nand2  g112(.a(x51), .b(new_n245_), .O(new_n270_));
  oai22  g113(.a(new_n270_), .b(new_n249_), .c(new_n269_), .d(new_n268_), .O(new_n271_));
  nand2  g114(.a(new_n271_), .b(new_n247_), .O(new_n272_));
  xor2a  g115(.a(x83), .b(x81), .O(new_n273_));
  oai22  g116(.a(new_n273_), .b(new_n269_), .c(new_n270_), .d(x81), .O(new_n274_));
  nand2  g117(.a(new_n274_), .b(new_n251_), .O(new_n275_));
  inv1   g118(.a(new_n253_), .O(new_n276_));
  ...
  nand2  g123(.a(new_n280_), .b(new_n249_), .O(new_n281_));
  nand3  g124(.a(x83), .b(x81), .c(x42), .O(new_n282_));
  aoi21  g125(.a(new_n282_), .b(new_n281_), .c(new_n250_), .O(new_n283_));
  nand2  g126(.a(new_n280_), .b(x81), .O(new_n284_));
  nand3  g127(.a(x83), .b(new_n249_), .c(x42), .O(new_n285_));
  aoi21  g128(.a(new_n285_), .b(new_n284_), .c(new_n246_), .O(new_n286_));
