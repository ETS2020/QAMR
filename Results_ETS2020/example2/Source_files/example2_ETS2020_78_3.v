...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n183_, new_n185_, new_n186_, new_n188_, new_n189_, new_n192_,
    ...
    new_n291_, new_n293_, new_n298_, new_n304_, new_n305_, new_n306_,
  ...
  nand2  g141(.a(new_n237_), .b(x60), .O(new_n298_));
  nor2   g142(.a(new_n298_), .b(new_n285_), .O(z42));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n188_), .O(z43));
  nor3   g144(.a(new_n285_), .b(new_n238_), .c(new_n185_), .O(z44));
  nor3   g145(.a(new_n285_), .b(new_n238_), .c(new_n182_), .O(z45));
  nor3   g146(.a(new_n285_), .b(new_n238_), .c(new_n179_), .O(z46));
  ...
  oai21  g231(.a(new_n168_), .b(new_n166_), .c(new_n219_), .O(new_n389_));
  nand2  g232(.a(new_n161_), .b(new_n232_), .O(new_n390_));
  ...
  oai21  g237(.a(x79), .b(new_n232_), .c(new_n394_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n159_), .O(new_n396_));
  nand2  g239(.a(new_n378_), .b(x79), .O(new_n397_));
  nand3  g240(.a(x81), .b(x79), .c(new_n232_), .O(new_n398_));
  ...
  nor2   g252(.a(new_n244_), .b(x78), .O(new_n410_));
