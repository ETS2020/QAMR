...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n258_, new_n261_, new_n264_, new_n267_, new_n268_,
  ...
  nand4  g104(.a(new_n255_), .b(new_n242_), .c(x47), .d(new_n246_), .O(new_n261_));
  inv1   g105(.a(new_n261_), .O(z29));
  nand4  g106(.a(new_n255_), .b(new_n242_), .c(x49), .d(new_n246_), .O(new_n264_));
  ...
  nor2   g132(.a(new_n291_), .b(new_n286_), .O(z37));
  nand2  g133(.a(new_n242_), .b(x56), .O(new_n293_));
  nor2   g134(.a(new_n293_), .b(new_n286_), .O(z38));
  nor3   g135(.a(new_n286_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g136(.a(new_n286_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g137(.a(new_n286_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g138(.a(new_n286_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g139(.a(new_n286_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g140(.a(new_n286_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g141(.a(new_n286_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g142(.a(new_n286_), .b(new_n243_), .c(new_n176_), .O(z46));
  ...
  nand2  g192(.a(new_n278_), .b(x14), .O(new_n352_));
