// Benchmark "FAU" written by ABC on Sat Jun 27 02:06:02 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n234_, new_n238_, new_n240_, new_n243_,
    new_n245_, new_n246_, new_n247_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n267_, new_n268_, new_n273_,
  ...
  nand2  g109(.a(new_n220_), .b(x56), .O(new_n273_));
  nor2   g110(.a(new_n273_), .b(new_n268_), .O(z38));
  nor3   g111(.a(new_n268_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g112(.a(new_n268_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g113(.a(new_n268_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g114(.a(new_n268_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g115(.a(new_n268_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g116(.a(new_n268_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g117(.a(new_n268_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g118(.a(new_n268_), .b(new_n221_), .c(new_n173_), .O(z46));
  inv1   g119(.a(x07), .O(new_n283_));
  nand2  g120(.a(x52), .b(x15), .O(new_n284_));
  oai21  g121(.a(x52), .b(new_n283_), .c(new_n284_), .O(new_n285_));
  nand3  g122(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n286_));
  inv1   g123(.a(new_n286_), .O(new_n287_));
  nand2  g124(.a(new_n287_), .b(new_n285_), .O(new_n288_));
  xnor2a g125(.a(x84), .b(x81), .O(new_n289_));
  or2    g126(.a(x75), .b(x67), .O(new_n290_));
  nor2   g127(.a(x78), .b(new_n160_), .O(new_n291_));
  nand4  g128(.a(new_n291_), .b(new_n290_), .c(new_n289_), .d(x79), .O(new_n292_));
  aoi21  g129(.a(new_n292_), .b(new_n288_), .c(x01), .O(z47));
  nand2  g130(.a(x52), .b(x22), .O(new_n300_));
  nand2  g131(.a(new_n259_), .b(x14), .O(new_n301_));
  nor2   g132(.a(new_n154_), .b(x77), .O(new_n302_));
  nand4  g133(.a(new_n302_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n303_));
  aoi21  g134(.a(new_n301_), .b(new_n300_), .c(new_n303_), .O(z54));
  inv1   g135(.a(x82), .O(new_n305_));
  nand3  g136(.a(new_n246_), .b(x84), .c(new_n305_), .O(new_n306_));
  inv1   g137(.a(x80), .O(new_n307_));
  nand4  g138(.a(new_n220_), .b(new_n163_), .c(new_n307_), .d(x79), .O(new_n308_));
  nor2   g139(.a(new_n308_), .b(new_n306_), .O(z55));
  aoi21  g140(.a(x84), .b(new_n227_), .c(x76), .O(new_n310_));
  oai21  g141(.a(x84), .b(new_n227_), .c(new_n310_), .O(new_n311_));
  nand2  g142(.a(new_n311_), .b(new_n164_), .O(new_n312_));
  nand4  g143(.a(new_n312_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g144(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n315_));
  inv1   g145(.a(x74), .O(new_n316_));
  nand4  g146(.a(x80), .b(new_n316_), .c(x43), .d(new_n223_), .O(new_n317_));
  oai22  g147(.a(new_n317_), .b(new_n315_), .c(new_n223_), .d(x40), .O(new_n318_));
  nand2  g148(.a(x78), .b(x04), .O(new_n319_));
  inv1   g149(.a(new_n319_), .O(new_n320_));
  nand3  g150(.a(new_n320_), .b(new_n318_), .c(x79), .O(new_n321_));
  nand4  g151(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n322_));
  nand2  g152(.a(new_n322_), .b(new_n321_), .O(new_n323_));
  nand2  g153(.a(new_n323_), .b(x77), .O(new_n324_));
  oai21  g154(.a(new_n302_), .b(new_n216_), .c(new_n162_), .O(new_n325_));
  aoi21  g155(.a(new_n325_), .b(new_n324_), .c(x01), .O(z58));
  aoi21  g156(.a(new_n319_), .b(x79), .c(new_n152_), .O(new_n327_));
  nand3  g157(.a(x80), .b(new_n316_), .c(x43), .O(new_n328_));
  oai21  g158(.a(new_n328_), .b(new_n315_), .c(new_n223_), .O(new_n329_));
  aoi21  g159(.a(new_n329_), .b(x79), .c(new_n319_), .O(new_n330_));
  oai21  g160(.a(new_n330_), .b(new_n327_), .c(x77), .O(new_n331_));
  nand2  g161(.a(new_n162_), .b(new_n216_), .O(new_n332_));
  aoi21  g162(.a(new_n332_), .b(new_n331_), .c(x01), .O(z59));
  oai21  g163(.a(new_n302_), .b(new_n291_), .c(new_n289_), .O(new_n335_));
  nand2  g164(.a(new_n163_), .b(new_n216_), .O(new_n336_));
  nand2  g165(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  inv1   g166(.a(new_n337_), .O(new_n338_));
  nor2   g167(.a(new_n162_), .b(x01), .O(new_n339_));
  inv1   g168(.a(new_n339_), .O(new_n340_));
  nor3   g169(.a(new_n340_), .b(new_n338_), .c(new_n307_), .O(z61));
  nand3  g170(.a(x84), .b(x81), .c(x79), .O(new_n342_));
  oai21  g171(.a(x79), .b(new_n216_), .c(new_n342_), .O(new_n343_));
  nand2  g172(.a(new_n343_), .b(new_n160_), .O(new_n344_));
  nand2  g173(.a(new_n329_), .b(x79), .O(new_n345_));
  nand3  g174(.a(x81), .b(x79), .c(new_n216_), .O(new_n346_));
  inv1   g175(.a(new_n346_), .O(new_n347_));
  aoi21  g176(.a(new_n345_), .b(x04), .c(new_n347_), .O(new_n348_));
  oai21  g177(.a(new_n348_), .b(new_n160_), .c(new_n344_), .O(new_n349_));
  nand2  g178(.a(new_n349_), .b(x78), .O(new_n350_));
  inv1   g179(.a(new_n342_), .O(new_n351_));
  nand2  g180(.a(new_n351_), .b(new_n291_), .O(new_n352_));
  aoi21  g181(.a(new_n352_), .b(new_n350_), .c(x01), .O(z62));
  nor3   g182(.a(new_n340_), .b(new_n338_), .c(new_n305_), .O(z63));
  nand3  g183(.a(new_n337_), .b(x83), .c(x79), .O(new_n355_));
  aoi21  g184(.a(new_n355_), .b(new_n286_), .c(x01), .O(z64));
  nor2   g185(.a(new_n154_), .b(x04), .O(new_n357_));
  nor2   g186(.a(new_n227_), .b(x78), .O(new_n358_));
  oai21  g187(.a(new_n358_), .b(new_n357_), .c(x77), .O(new_n359_));
  nand2  g188(.a(new_n302_), .b(x81), .O(new_n360_));
  nand2  g189(.a(new_n339_), .b(x84), .O(new_n361_));
  aoi21  g190(.a(new_n360_), .b(new_n359_), .c(new_n361_), .O(z65));
  zero   g191(.O(z02));
  zero   g192(.O(z04));
  zero   g193(.O(z15));
  zero   g194(.O(z18));
