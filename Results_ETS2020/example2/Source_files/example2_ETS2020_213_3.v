...
module FAU ( 
  ...
  nor3   g138(.a(new_n285_), .b(new_n238_), .c(new_n200_), .O(z39));
  nor3   g139(.a(new_n285_), .b(new_n238_), .c(new_n197_), .O(z40));
  nor3   g140(.a(new_n285_), .b(new_n238_), .c(new_n194_), .O(z41));
  nor3   g141(.a(new_n285_), .b(new_n238_), .c(new_n191_), .O(z42));
  nor3   g142(.a(new_n285_), .b(new_n238_), .c(new_n188_), .O(z43));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n185_), .O(z44));
  nor3   g144(.a(new_n285_), .b(new_n238_), .c(new_n182_), .O(z45));
  nor3   g145(.a(new_n285_), .b(new_n238_), .c(new_n179_), .O(z46));
