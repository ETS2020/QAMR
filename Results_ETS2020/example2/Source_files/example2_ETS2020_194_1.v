// Benchmark "FAU" written by ABC on Sat Jun 27 02:03:41 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n240_, new_n242_, new_n244_, new_n247_, new_n249_, new_n250_,
  ...
  nand4  g087(.a(new_n233_), .b(new_n222_), .c(x48), .d(new_n225_), .O(new_n244_));
  inv1   g088(.a(new_n244_), .O(z30));
  ...
  nor2   g117(.a(new_n276_), .b(new_n272_), .O(z37));
