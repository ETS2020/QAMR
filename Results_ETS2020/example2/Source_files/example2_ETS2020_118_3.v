// Benchmark "FAU" written by ABC on Sat Jun 27 01:58:02 2020
...
module FAU ( 
  ...
  nor3   g132(.a(new_n283_), .b(new_n274_), .c(new_n200_), .O(z39));
  nor3   g133(.a(new_n283_), .b(new_n274_), .c(new_n197_), .O(z40));
  nor3   g134(.a(new_n283_), .b(new_n274_), .c(new_n194_), .O(z41));
  nor3   g135(.a(new_n283_), .b(new_n274_), .c(new_n191_), .O(z42));
  nor3   g136(.a(new_n283_), .b(new_n274_), .c(new_n188_), .O(z43));
  nor3   g137(.a(new_n283_), .b(new_n274_), .c(new_n185_), .O(z44));
  nor3   g138(.a(new_n283_), .b(new_n274_), .c(new_n182_), .O(z45));
  nor3   g139(.a(new_n283_), .b(new_n274_), .c(new_n179_), .O(z46));
  ...
  inv1   g194(.a(x84), .O(new_n354_));
  inv1   g195(.a(new_n260_), .O(new_n355_));
  nor2   g196(.a(x80), .b(new_n154_), .O(new_n356_));
  nand3  g197(.a(new_n356_), .b(new_n235_), .c(new_n161_), .O(new_n357_));
  nor4   g198(.a(new_n357_), .b(new_n355_), .c(new_n354_), .d(x82), .O(z55));
  ...
  oai21  g224(.a(new_n233_), .b(x04), .c(new_n384_), .O(new_n385_));
  nand2  g225(.a(new_n171_), .b(x80), .O(new_n386_));
  inv1   g226(.a(new_n386_), .O(new_n387_));
  and2   g227(.a(new_n387_), .b(new_n385_), .O(z61));
  ...
  nand2  g231(.a(new_n374_), .b(x79), .O(new_n392_));
  ...
  nand3  g240(.a(new_n385_), .b(x83), .c(x79), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n304_), .c(x01), .O(z64));
