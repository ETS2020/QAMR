...
module FAU ( 
  ...
  nand4  g081(.a(new_n233_), .b(new_n222_), .c(x48), .d(new_n225_), .O(new_n241_));
  ...
  nor3   g116(.a(new_n270_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g117(.a(new_n270_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g118(.a(new_n270_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g119(.a(new_n270_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g122(.a(new_n270_), .b(new_n223_), .c(new_n173_), .O(z46));
  ...
  nand2  g135(.a(new_n261_), .b(x14), .O(new_n304_));
  ...
  nand3  g140(.a(new_n248_), .b(x84), .c(new_n308_), .O(new_n309_));
  ...
  nand4  g148(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n318_));
