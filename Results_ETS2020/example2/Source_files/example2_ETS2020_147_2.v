...
module FAU ( 
  ...
  nor2   g093(.a(new_n261_), .b(new_n257_), .O(z37));
  ...
  nor2   g172(.a(new_n160_), .b(x04), .O(new_n355_));
  nor2   g173(.a(new_n222_), .b(x78), .O(new_n356_));
  oai21  g174(.a(new_n356_), .b(new_n355_), .c(x77), .O(new_n357_));
  nand3  g175(.a(x81), .b(x78), .c(new_n159_), .O(new_n358_));
  nand2  g176(.a(new_n171_), .b(x84), .O(new_n359_));
  aoi21  g177(.a(new_n358_), .b(new_n357_), .c(new_n359_), .O(z65));
  zero   g178(.O(z03));
  zero   g179(.O(z05));
  zero   g180(.O(z06));
  zero   g181(.O(z07));
