...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n261_, new_n273_, new_n274_, new_n275_, new_n276_, new_n277_,
  ...
  nand2  g119(.a(new_n298_), .b(new_n278_), .O(new_n299_));
  nand2  g120(.a(new_n280_), .b(x72), .O(new_n300_));
  ...
  nand2  g125(.a(new_n304_), .b(new_n278_), .O(new_n305_));
  nand2  g126(.a(new_n280_), .b(x73), .O(new_n306_));
  aoi21  g127(.a(new_n306_), .b(new_n305_), .c(x01), .O(z53));
  nand2  g128(.a(x84), .b(x83), .O(new_n309_));
  nor2   g129(.a(x80), .b(new_n154_), .O(new_n310_));
  nand3  g130(.a(new_n310_), .b(new_n229_), .c(new_n161_), .O(new_n311_));
  nor4   g131(.a(new_n311_), .b(new_n309_), .c(x82), .d(x81), .O(z55));
  inv1   g132(.a(new_n161_), .O(new_n313_));
  xnor2a g133(.a(x84), .b(x81), .O(new_n314_));
  aoi21  g134(.a(new_n169_), .b(new_n168_), .c(new_n314_), .O(new_n315_));
  aoi22  g135(.a(new_n315_), .b(new_n153_), .c(new_n313_), .d(x76), .O(new_n316_));
  inv1   g136(.a(x00), .O(new_n317_));
  nor3   g137(.a(new_n163_), .b(x01), .c(new_n317_), .O(new_n318_));
  oai21  g138(.a(new_n316_), .b(new_n154_), .c(new_n318_), .O(z56));
  inv1   g139(.a(x02), .O(new_n320_));
  nand4  g140(.a(x03), .b(new_n320_), .c(new_n153_), .d(x00), .O(new_n321_));
  inv1   g141(.a(new_n321_), .O(z57));
  nand2  g142(.a(new_n154_), .b(new_n160_), .O(new_n324_));
  aoi21  g143(.a(new_n215_), .b(new_n324_), .c(new_n152_), .O(new_n325_));
  oai21  g144(.a(new_n211_), .b(new_n209_), .c(new_n221_), .O(new_n326_));
  aoi21  g145(.a(new_n326_), .b(x79), .c(new_n215_), .O(new_n327_));
  ...
  aoi21  g151(.a(new_n332_), .b(new_n217_), .c(x01), .O(z60));
  aoi21  g152(.a(new_n169_), .b(new_n168_), .c(new_n204_), .O(new_n337_));
  nor2   g153(.a(new_n313_), .b(x04), .O(new_n338_));
  nor2   g154(.a(new_n208_), .b(new_n154_), .O(new_n339_));
  oai21  g155(.a(new_n338_), .b(new_n337_), .c(new_n339_), .O(new_n340_));
  aoi21  g156(.a(new_n340_), .b(new_n277_), .c(x01), .O(z64));
  zero   g157(.O(z03));
  zero   g158(.O(z05));
  zero   g159(.O(z06));
  zero   g160(.O(z07));
