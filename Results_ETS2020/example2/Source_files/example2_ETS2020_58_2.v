// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:37 2020
...
module FAU ( 
  ...
  aoi22  g146(.a(new_n325_), .b(new_n322_), .c(new_n323_), .d(x76), .O(new_n326_));
  ...
  nand4  g151(.a(x03), .b(new_n330_), .c(new_n322_), .d(x00), .O(new_n331_));
  inv1   g152(.a(new_n331_), .O(z57));
  inv1   g153(.a(x40), .O(new_n334_));
  aoi21  g154(.a(new_n212_), .b(x79), .c(new_n334_), .O(new_n335_));
  oai21  g155(.a(new_n208_), .b(new_n206_), .c(new_n218_), .O(new_n336_));
  aoi21  g156(.a(new_n336_), .b(x79), .c(new_n212_), .O(new_n337_));
  ...
  aoi21  g162(.a(new_n342_), .b(new_n214_), .c(x01), .O(z60));
  aoi21  g163(.a(new_n164_), .b(new_n163_), .c(new_n201_), .O(new_n347_));
  nor2   g164(.a(new_n323_), .b(x04), .O(new_n348_));
  nor2   g165(.a(new_n205_), .b(new_n157_), .O(new_n349_));
  oai21  g166(.a(new_n348_), .b(new_n347_), .c(new_n349_), .O(new_n350_));
  aoi21  g167(.a(new_n350_), .b(new_n272_), .c(x01), .O(z64));
  zero   g168(.O(z00));
  zero   g169(.O(z03));
  zero   g170(.O(z05));
  zero   g171(.O(z06));
