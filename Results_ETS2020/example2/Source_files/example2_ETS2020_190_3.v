// Benchmark "FAU" written by ABC on Sat Jun 27 02:03:24 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n202_, new_n204_, new_n205_, new_n208_, new_n209_, new_n212_,
  ...
  nor3   g136(.a(new_n285_), .b(new_n238_), .c(new_n198_), .O(z39));
  nor3   g137(.a(new_n285_), .b(new_n238_), .c(new_n195_), .O(z40));
  nor3   g138(.a(new_n285_), .b(new_n238_), .c(new_n192_), .O(z41));
  nor3   g139(.a(new_n285_), .b(new_n238_), .c(new_n189_), .O(z42));
  nor3   g140(.a(new_n285_), .b(new_n238_), .c(new_n186_), .O(z43));
  nor3   g141(.a(new_n285_), .b(new_n238_), .c(new_n183_), .O(z44));
  nor3   g142(.a(new_n285_), .b(new_n238_), .c(new_n180_), .O(z45));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n177_), .O(z46));
  ...
  nand2  g152(.a(new_n168_), .b(x79), .O(new_n310_));
  aoi21  g153(.a(new_n165_), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  ...
  nand2  g195(.a(new_n276_), .b(x14), .O(new_n353_));
  nand4  g196(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n354_));
  aoi21  g197(.a(new_n353_), .b(new_n352_), .c(new_n354_), .O(z54));
  inv1   g198(.a(x82), .O(new_n356_));
  nand3  g199(.a(new_n263_), .b(x84), .c(new_n356_), .O(new_n357_));
  inv1   g200(.a(x80), .O(new_n358_));
  nand4  g201(.a(new_n237_), .b(new_n161_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g202(.a(new_n359_), .b(new_n357_), .O(z55));
  inv1   g203(.a(x02), .O(new_n362_));
  nand4  g204(.a(x03), .b(new_n362_), .c(new_n153_), .d(x00), .O(new_n363_));
  inv1   g205(.a(new_n363_), .O(z57));
  nand4  g206(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n365_));
  oai22  g207(.a(new_n365_), .b(new_n223_), .c(new_n240_), .d(x40), .O(new_n366_));
  nand3  g208(.a(new_n366_), .b(new_n229_), .c(x79), .O(new_n367_));
  nor2   g209(.a(x79), .b(x78), .O(new_n368_));
  nand3  g210(.a(new_n368_), .b(new_n240_), .c(x40), .O(new_n369_));
  nand2  g211(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g212(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g213(.a(new_n166_), .b(new_n232_), .c(new_n154_), .O(new_n372_));
  aoi21  g214(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  inv1   g215(.a(new_n368_), .O(new_n374_));
  aoi21  g216(.a(new_n228_), .b(new_n374_), .c(new_n152_), .O(new_n375_));
  oai21  g217(.a(new_n225_), .b(new_n223_), .c(new_n240_), .O(new_n376_));
  aoi21  g218(.a(new_n376_), .b(x79), .c(new_n228_), .O(new_n377_));
  oai21  g219(.a(new_n377_), .b(new_n375_), .c(x77), .O(new_n378_));
  nor2   g220(.a(x79), .b(x04), .O(new_n379_));
  inv1   g221(.a(new_n379_), .O(new_n380_));
  aoi21  g222(.a(new_n380_), .b(new_n378_), .c(x01), .O(z59));
  xor2a  g223(.a(x84), .b(x81), .O(new_n382_));
  nand2  g224(.a(new_n310_), .b(new_n167_), .O(new_n383_));
  aoi21  g225(.a(new_n383_), .b(new_n382_), .c(new_n379_), .O(new_n384_));
  aoi21  g226(.a(new_n384_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g227(.a(new_n171_), .O(new_n386_));
  oai21  g228(.a(new_n168_), .b(new_n166_), .c(new_n219_), .O(new_n387_));
  nand2  g229(.a(new_n161_), .b(new_n232_), .O(new_n388_));
  nand2  g230(.a(new_n388_), .b(new_n387_), .O(new_n389_));
  inv1   g231(.a(new_n389_), .O(new_n390_));
  nor3   g232(.a(new_n390_), .b(new_n386_), .c(new_n358_), .O(z61));
  nand3  g233(.a(x84), .b(x81), .c(x79), .O(new_n392_));
  oai21  g234(.a(x79), .b(new_n232_), .c(new_n392_), .O(new_n393_));
  nand2  g235(.a(new_n393_), .b(new_n159_), .O(new_n394_));
  nand2  g236(.a(new_n376_), .b(x79), .O(new_n395_));
  nand3  g237(.a(x81), .b(x79), .c(new_n232_), .O(new_n396_));
  inv1   g238(.a(new_n396_), .O(new_n397_));
  aoi21  g239(.a(new_n395_), .b(x04), .c(new_n397_), .O(new_n398_));
  oai21  g240(.a(new_n398_), .b(new_n159_), .c(new_n394_), .O(new_n399_));
  nand2  g241(.a(new_n399_), .b(x78), .O(new_n400_));
  inv1   g242(.a(new_n392_), .O(new_n401_));
  nand2  g243(.a(new_n401_), .b(new_n168_), .O(new_n402_));
  aoi21  g244(.a(new_n402_), .b(new_n400_), .c(x01), .O(z62));
  nor3   g245(.a(new_n390_), .b(new_n386_), .c(new_n356_), .O(z63));
  nand3  g246(.a(new_n389_), .b(x83), .c(x79), .O(new_n405_));
  aoi21  g247(.a(new_n405_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g248(.a(new_n160_), .b(x04), .O(new_n407_));
  nor2   g249(.a(new_n244_), .b(x78), .O(new_n408_));
  oai21  g250(.a(new_n408_), .b(new_n407_), .c(x77), .O(new_n409_));
  nand2  g251(.a(new_n166_), .b(x81), .O(new_n410_));
  nand2  g252(.a(new_n171_), .b(x84), .O(new_n411_));
  aoi21  g253(.a(new_n410_), .b(new_n409_), .c(new_n411_), .O(z65));
  zero   g254(.O(z05));
  zero   g255(.O(z16));
  zero   g256(.O(z18));
  zero   g257(.O(z20));
