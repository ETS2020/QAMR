...
module FAU ( 
  ...
  nand4  g099(.a(new_n250_), .b(new_n240_), .c(x46), .d(new_n243_), .O(new_n255_));
  inv1   g100(.a(new_n255_), .O(z28));
  nand4  g101(.a(new_n250_), .b(new_n240_), .c(x47), .d(new_n243_), .O(new_n257_));
  inv1   g102(.a(new_n257_), .O(z29));
  nand4  g103(.a(new_n250_), .b(new_n240_), .c(x48), .d(new_n243_), .O(new_n259_));
  inv1   g104(.a(new_n259_), .O(z30));
  nand4  g105(.a(new_n250_), .b(new_n240_), .c(x49), .d(new_n243_), .O(new_n261_));
  inv1   g106(.a(new_n261_), .O(z31));
  nand4  g107(.a(new_n250_), .b(new_n240_), .c(x50), .d(new_n243_), .O(new_n263_));
  ...
  nand4  g209(.a(x80), .b(new_n227_), .c(x43), .d(new_n243_), .O(new_n367_));
  oai22  g210(.a(new_n367_), .b(new_n226_), .c(new_n243_), .d(x40), .O(new_n368_));
  ...
  oai21  g218(.a(new_n228_), .b(new_n226_), .c(new_n243_), .O(new_n376_));
  ...
  nor2   g250(.a(new_n247_), .b(x78), .O(new_n408_));
