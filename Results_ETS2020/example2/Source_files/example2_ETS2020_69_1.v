...
module FAU ( 
  ...
  inv1   g130(.a(x11), .O(new_n297_));
  nand2  g131(.a(x52), .b(x19), .O(new_n298_));
  oai21  g132(.a(x52), .b(new_n297_), .c(new_n298_), .O(new_n299_));
  nand2  g133(.a(new_n299_), .b(new_n287_), .O(new_n300_));
  nor2   g134(.a(new_n162_), .b(x78), .O(new_n301_));
  nand4  g135(.a(new_n301_), .b(new_n289_), .c(x77), .d(x71), .O(new_n302_));
  aoi21  g136(.a(new_n302_), .b(new_n300_), .c(x01), .O(z51));
  nand2  g137(.a(x52), .b(x22), .O(new_n306_));
  nand2  g138(.a(new_n259_), .b(x14), .O(new_n307_));
  nor2   g139(.a(new_n154_), .b(x77), .O(new_n308_));
  nand4  g140(.a(new_n308_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n309_));
  aoi21  g141(.a(new_n307_), .b(new_n306_), .c(new_n309_), .O(z54));
  inv1   g142(.a(x82), .O(new_n311_));
  nand3  g143(.a(new_n246_), .b(x84), .c(new_n311_), .O(new_n312_));
  inv1   g144(.a(x80), .O(new_n313_));
  nand4  g145(.a(new_n220_), .b(new_n163_), .c(new_n313_), .d(x79), .O(new_n314_));
  ...
  nand2  g149(.a(new_n317_), .b(new_n164_), .O(new_n318_));
  nand4  g150(.a(new_n318_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g151(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n321_));
  ...
  nand4  g158(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n328_));
  nand2  g159(.a(new_n328_), .b(new_n327_), .O(new_n329_));
  nand2  g160(.a(new_n329_), .b(x77), .O(new_n330_));
  oai21  g161(.a(new_n308_), .b(new_n216_), .c(new_n162_), .O(new_n331_));
  ...
  nand2  g179(.a(new_n349_), .b(new_n160_), .O(new_n350_));
  ...
  oai21  g184(.a(new_n354_), .b(new_n160_), .c(new_n350_), .O(new_n355_));
  ...
  nor2   g192(.a(new_n154_), .b(x04), .O(new_n363_));
