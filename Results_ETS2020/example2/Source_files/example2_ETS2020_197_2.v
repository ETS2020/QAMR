// Benchmark "FAU" written by ABC on Sat Jun 27 02:03:55 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n259_, new_n260_, new_n262_, new_n264_, new_n266_, new_n277_,
  ...
  nand4  g078(.a(new_n234_), .b(new_n233_), .c(x49), .d(new_n226_), .O(new_n244_));
  inv1   g079(.a(new_n244_), .O(z31));
  nand4  g080(.a(new_n234_), .b(new_n233_), .c(x50), .d(new_n226_), .O(new_n246_));
  inv1   g081(.a(new_n246_), .O(z32));
  inv1   g082(.a(new_n162_), .O(new_n250_));
  nand2  g083(.a(x83), .b(x42), .O(new_n251_));
  nand2  g084(.a(new_n251_), .b(new_n227_), .O(new_n252_));
  inv1   g085(.a(new_n251_), .O(new_n253_));
  nand2  g086(.a(new_n253_), .b(x81), .O(new_n254_));
  aoi21  g087(.a(new_n254_), .b(new_n252_), .c(new_n230_), .O(new_n255_));
  nand2  g088(.a(new_n251_), .b(x81), .O(new_n256_));
  nand2  g089(.a(new_n253_), .b(new_n227_), .O(new_n257_));
  aoi21  g090(.a(new_n257_), .b(new_n256_), .c(new_n228_), .O(new_n258_));
  oai21  g091(.a(new_n258_), .b(new_n255_), .c(new_n250_), .O(new_n259_));
  nand2  g092(.a(new_n234_), .b(x53), .O(new_n260_));
  nor2   g093(.a(new_n260_), .b(new_n259_), .O(z35));
  nand2  g094(.a(new_n234_), .b(x54), .O(new_n262_));
  nor2   g095(.a(new_n262_), .b(new_n259_), .O(z36));
  nand2  g096(.a(new_n234_), .b(x55), .O(new_n264_));
  nor2   g097(.a(new_n264_), .b(new_n259_), .O(z37));
  nand2  g098(.a(new_n234_), .b(x56), .O(new_n266_));
  nor2   g099(.a(new_n266_), .b(new_n259_), .O(z38));
  inv1   g100(.a(x08), .O(new_n277_));
  nand2  g101(.a(x52), .b(x16), .O(new_n278_));
  oai21  g102(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  nor2   g103(.a(x79), .b(x77), .O(new_n280_));
  nand2  g104(.a(new_n280_), .b(new_n220_), .O(new_n281_));
  inv1   g105(.a(new_n281_), .O(new_n282_));
  nand2  g106(.a(new_n282_), .b(new_n279_), .O(new_n283_));
  nor3   g107(.a(new_n208_), .b(new_n169_), .c(new_n154_), .O(new_n284_));
  nand2  g108(.a(new_n284_), .b(x68), .O(new_n285_));
  aoi21  g109(.a(new_n285_), .b(new_n283_), .c(x01), .O(z48));
  inv1   g110(.a(x09), .O(new_n287_));
  nand2  g111(.a(x52), .b(x17), .O(new_n288_));
  oai21  g112(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand2  g113(.a(new_n289_), .b(new_n282_), .O(new_n290_));
  nand2  g114(.a(new_n284_), .b(x69), .O(new_n291_));
  aoi21  g115(.a(new_n291_), .b(new_n290_), .c(x01), .O(z49));
  inv1   g116(.a(x10), .O(new_n293_));
  nand2  g117(.a(x52), .b(x18), .O(new_n294_));
  oai21  g118(.a(x52), .b(new_n293_), .c(new_n294_), .O(new_n295_));
  nand2  g119(.a(new_n295_), .b(new_n282_), .O(new_n296_));
  nand2  g120(.a(new_n284_), .b(x70), .O(new_n297_));
  ...
  nand2  g125(.a(new_n301_), .b(new_n282_), .O(new_n302_));
  nand2  g126(.a(new_n284_), .b(x71), .O(new_n303_));
  ...
  nand2  g131(.a(new_n307_), .b(new_n282_), .O(new_n308_));
  nand2  g132(.a(new_n284_), .b(x72), .O(new_n309_));
  ...
  nand2  g137(.a(new_n313_), .b(new_n282_), .O(new_n314_));
  nand2  g138(.a(new_n284_), .b(x73), .O(new_n315_));
  aoi21  g139(.a(new_n315_), .b(new_n314_), .c(x01), .O(z53));
  nand2  g140(.a(x84), .b(x83), .O(new_n318_));
  nor2   g141(.a(x80), .b(new_n154_), .O(new_n319_));
  nand3  g142(.a(new_n319_), .b(new_n234_), .c(new_n161_), .O(new_n320_));
  nor4   g143(.a(new_n320_), .b(new_n318_), .c(x82), .d(x81), .O(z55));
  inv1   g144(.a(new_n161_), .O(new_n322_));
  xnor2a g145(.a(x84), .b(x81), .O(new_n323_));
  aoi21  g146(.a(new_n169_), .b(new_n168_), .c(new_n323_), .O(new_n324_));
  aoi22  g147(.a(new_n324_), .b(new_n153_), .c(new_n322_), .d(x76), .O(new_n325_));
  inv1   g148(.a(x00), .O(new_n326_));
  nor3   g149(.a(new_n163_), .b(x01), .c(new_n326_), .O(new_n327_));
  oai21  g150(.a(new_n325_), .b(new_n154_), .c(new_n327_), .O(z56));
  inv1   g151(.a(x02), .O(new_n329_));
  nand4  g152(.a(x03), .b(new_n329_), .c(new_n153_), .d(x00), .O(new_n330_));
  inv1   g153(.a(new_n330_), .O(z57));
  nand2  g154(.a(new_n154_), .b(new_n160_), .O(new_n333_));
  aoi21  g155(.a(new_n219_), .b(new_n333_), .c(new_n152_), .O(new_n334_));
  oai21  g156(.a(new_n215_), .b(new_n213_), .c(new_n226_), .O(new_n335_));
  aoi21  g157(.a(new_n335_), .b(x79), .c(new_n219_), .O(new_n336_));
  oai21  g158(.a(new_n336_), .b(new_n334_), .c(x77), .O(new_n337_));
  nor2   g159(.a(x79), .b(x04), .O(new_n338_));
  inv1   g160(.a(new_n338_), .O(new_n339_));
  aoi21  g161(.a(new_n339_), .b(new_n337_), .c(x01), .O(z59));
  aoi21  g162(.a(new_n324_), .b(x79), .c(new_n338_), .O(new_n341_));
  aoi21  g163(.a(new_n341_), .b(new_n221_), .c(x01), .O(z60));
  aoi21  g164(.a(new_n169_), .b(new_n168_), .c(new_n208_), .O(new_n346_));
  nor2   g165(.a(new_n322_), .b(x04), .O(new_n347_));
  nor2   g166(.a(new_n212_), .b(new_n154_), .O(new_n348_));
  oai21  g167(.a(new_n347_), .b(new_n346_), .c(new_n348_), .O(new_n349_));
  aoi21  g168(.a(new_n349_), .b(new_n281_), .c(x01), .O(z64));
  zero   g169(.O(z03));
  zero   g170(.O(z06));
  zero   g171(.O(z07));
  zero   g172(.O(z08));
