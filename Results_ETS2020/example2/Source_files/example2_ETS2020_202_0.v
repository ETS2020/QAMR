...
module FAU ( 
  ...
  nand2  g179(.a(new_n335_), .b(new_n312_), .O(new_n336_));
  nand2  g180(.a(new_n323_), .b(x71), .O(new_n337_));
  ...
  nand2  g185(.a(new_n341_), .b(new_n312_), .O(new_n342_));
  nand2  g186(.a(new_n323_), .b(x72), .O(new_n343_));
  ...
  nand2  g191(.a(new_n347_), .b(new_n312_), .O(new_n348_));
  nand2  g192(.a(new_n323_), .b(x73), .O(new_n349_));
