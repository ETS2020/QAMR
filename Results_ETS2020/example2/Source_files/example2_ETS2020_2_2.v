// Benchmark "FAU" written by ABC on Sat Jun 27 01:49:25 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n259_, new_n260_, new_n261_, new_n263_, new_n265_, new_n271_,
  ...
  nand2  g100(.a(new_n233_), .b(x60), .O(new_n271_));
  nor2   g101(.a(new_n271_), .b(new_n260_), .O(z42));
  ...
  nand2  g106(.a(new_n280_), .b(new_n220_), .O(new_n281_));
  ...
  nand2  g112(.a(new_n286_), .b(new_n209_), .O(new_n287_));
  ...
  nor2   g118(.a(new_n285_), .b(new_n208_), .O(new_n293_));
  ...
  nand3  g153(.a(new_n328_), .b(new_n233_), .c(new_n161_), .O(new_n329_));
  ...
  aoi21  g166(.a(new_n219_), .b(new_n342_), .c(new_n152_), .O(new_n343_));
  oai21  g167(.a(new_n215_), .b(new_n213_), .c(new_n225_), .O(new_n344_));
  aoi21  g168(.a(new_n344_), .b(x79), .c(new_n219_), .O(new_n345_));
  ...
  aoi21  g174(.a(new_n350_), .b(new_n221_), .c(x01), .O(z60));
  aoi21  g175(.a(new_n169_), .b(new_n168_), .c(new_n208_), .O(new_n355_));
  nor2   g176(.a(new_n331_), .b(x04), .O(new_n356_));
  nor2   g177(.a(new_n212_), .b(new_n154_), .O(new_n357_));
