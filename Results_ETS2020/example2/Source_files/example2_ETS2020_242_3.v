...
module FAU ( 
  ...
  nand4  g209(.a(x80), .b(new_n227_), .c(x43), .d(new_n245_), .O(new_n367_));
  oai22  g210(.a(new_n367_), .b(new_n226_), .c(new_n245_), .d(x40), .O(new_n368_));
  nand3  g211(.a(new_n368_), .b(new_n232_), .c(x79), .O(new_n369_));
  nand4  g212(.a(new_n157_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n370_));
  ...
  oai21  g218(.a(new_n228_), .b(new_n226_), .c(new_n245_), .O(new_n376_));
  ...
  nor2   g250(.a(new_n249_), .b(x78), .O(new_n408_));
