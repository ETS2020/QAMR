// Benchmark "FAU" written by ABC on Sat Jun 27 01:50:06 2020
...
module FAU ( 
  ...
  nor2   g169(.a(new_n160_), .b(x04), .O(new_n353_));
  nor2   g170(.a(new_n220_), .b(x78), .O(new_n354_));
  oai21  g171(.a(new_n354_), .b(new_n353_), .c(x77), .O(new_n355_));
  nand3  g172(.a(x81), .b(x78), .c(new_n159_), .O(new_n356_));
  nand2  g173(.a(new_n171_), .b(x84), .O(new_n357_));
  aoi21  g174(.a(new_n356_), .b(new_n355_), .c(new_n357_), .O(z65));
  zero   g175(.O(z03));
  zero   g176(.O(z05));
  zero   g177(.O(z06));
  zero   g178(.O(z07));
