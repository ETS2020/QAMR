// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:53 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n192_, new_n194_, new_n195_, new_n197_, new_n198_, new_n202_,
    ...
    new_n292_, new_n294_, new_n303_, new_n304_, new_n305_, new_n306_,
  ...
  nand4  g094(.a(new_n247_), .b(new_n237_), .c(x45), .d(new_n240_), .O(new_n251_));
  ...
  nand4  g100(.a(new_n247_), .b(new_n237_), .c(x49), .d(new_n240_), .O(new_n258_));
  inv1   g101(.a(new_n258_), .O(z31));
  nand4  g102(.a(new_n247_), .b(new_n237_), .c(x50), .d(new_n240_), .O(new_n260_));
  inv1   g103(.a(new_n260_), .O(z32));
  nor2   g104(.a(new_n222_), .b(x81), .O(new_n262_));
  nor2   g105(.a(x83), .b(new_n244_), .O(new_n263_));
  nor2   g106(.a(new_n263_), .b(new_n262_), .O(new_n264_));
  nand2  g107(.a(x42), .b(x05), .O(new_n265_));
  nand2  g108(.a(x51), .b(new_n240_), .O(new_n266_));
  oai22  g109(.a(new_n266_), .b(new_n244_), .c(new_n265_), .d(new_n264_), .O(new_n267_));
  nand2  g110(.a(new_n267_), .b(new_n242_), .O(new_n268_));
  xor2a  g111(.a(x83), .b(x81), .O(new_n269_));
  oai22  g112(.a(new_n269_), .b(new_n265_), .c(new_n266_), .d(x81), .O(new_n270_));
  nand2  g113(.a(new_n270_), .b(new_n245_), .O(new_n271_));
  ...
  nand2  g136(.a(new_n237_), .b(x57), .O(new_n294_));
  nor2   g137(.a(new_n294_), .b(new_n284_), .O(z39));
  nor3   g138(.a(new_n284_), .b(new_n238_), .c(new_n197_), .O(z40));
  nor3   g139(.a(new_n284_), .b(new_n238_), .c(new_n194_), .O(z41));
  nor3   g140(.a(new_n284_), .b(new_n238_), .c(new_n191_), .O(z42));
  nor3   g141(.a(new_n284_), .b(new_n238_), .c(new_n188_), .O(z43));
  nor3   g142(.a(new_n284_), .b(new_n238_), .c(new_n185_), .O(z44));
  nor3   g143(.a(new_n284_), .b(new_n238_), .c(new_n182_), .O(z45));
  nor3   g144(.a(new_n284_), .b(new_n238_), .c(new_n179_), .O(z46));
  ...
  nand2  g196(.a(new_n275_), .b(x14), .O(new_n354_));
  ...
  nand3  g200(.a(new_n262_), .b(x84), .c(new_n357_), .O(new_n358_));
