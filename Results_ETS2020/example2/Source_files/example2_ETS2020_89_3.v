...
module FAU ( 
  ...
  nor2   g106(.a(new_n221_), .b(x81), .O(new_n263_));
  ...
  nor3   g136(.a(new_n285_), .b(new_n238_), .c(new_n195_), .O(z39));
  nor3   g137(.a(new_n285_), .b(new_n238_), .c(new_n192_), .O(z40));
  nor3   g138(.a(new_n285_), .b(new_n238_), .c(new_n189_), .O(z41));
  nor3   g139(.a(new_n285_), .b(new_n238_), .c(new_n186_), .O(z42));
  nor3   g140(.a(new_n285_), .b(new_n238_), .c(new_n183_), .O(z43));
  nor3   g141(.a(new_n285_), .b(new_n238_), .c(new_n180_), .O(z44));
  nor3   g142(.a(new_n285_), .b(new_n238_), .c(new_n177_), .O(z45));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n174_), .O(z46));
  ...
  nand4  g196(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n231_), .O(new_n354_));
  ...
  nand4  g204(.a(x03), .b(new_n362_), .c(new_n231_), .d(x00), .O(new_n363_));
  inv1   g205(.a(new_n363_), .O(z57));
  nand4  g206(.a(x80), .b(new_n223_), .c(x43), .d(new_n240_), .O(new_n365_));
  oai22  g207(.a(new_n365_), .b(new_n222_), .c(new_n240_), .d(x40), .O(new_n366_));
  ...
  aoi21  g214(.a(new_n227_), .b(x79), .c(new_n173_), .O(new_n373_));
  oai21  g215(.a(new_n224_), .b(new_n222_), .c(new_n240_), .O(new_n374_));
  ...
  nand2  g227(.a(new_n155_), .b(new_n232_), .O(new_n386_));
  ...
  oai21  g232(.a(x79), .b(new_n232_), .c(new_n390_), .O(new_n391_));
  nand2  g233(.a(new_n391_), .b(new_n153_), .O(new_n392_));
  nand2  g234(.a(new_n374_), .b(x79), .O(new_n393_));
  nand3  g235(.a(x81), .b(x79), .c(new_n232_), .O(new_n394_));
  ...
  nor2   g247(.a(new_n244_), .b(x78), .O(new_n406_));
