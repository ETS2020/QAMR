...
module FAU ( 
  ...
  nand4  g068(.a(new_n228_), .b(new_n227_), .c(x48), .d(new_n220_), .O(new_n236_));
  inv1   g069(.a(new_n236_), .O(z30));
  nand4  g070(.a(new_n228_), .b(new_n227_), .c(x49), .d(new_n220_), .O(new_n238_));
  inv1   g071(.a(new_n238_), .O(z31));
  nand4  g072(.a(new_n228_), .b(new_n227_), .c(x50), .d(new_n220_), .O(new_n240_));
  inv1   g073(.a(new_n240_), .O(z32));
  inv1   g074(.a(new_n156_), .O(new_n244_));
  nand2  g075(.a(x83), .b(x42), .O(new_n245_));
  nand2  g076(.a(new_n245_), .b(new_n221_), .O(new_n246_));
  inv1   g077(.a(new_n245_), .O(new_n247_));
  nand2  g078(.a(new_n247_), .b(x81), .O(new_n248_));
  aoi21  g079(.a(new_n248_), .b(new_n246_), .c(new_n224_), .O(new_n249_));
  nand2  g080(.a(new_n245_), .b(x81), .O(new_n250_));
  nand2  g081(.a(new_n247_), .b(new_n221_), .O(new_n251_));
  aoi21  g082(.a(new_n251_), .b(new_n250_), .c(new_n222_), .O(new_n252_));
  oai21  g083(.a(new_n252_), .b(new_n249_), .c(new_n244_), .O(new_n253_));
  nand2  g084(.a(new_n228_), .b(x53), .O(new_n254_));
  nor2   g085(.a(new_n254_), .b(new_n253_), .O(z35));
  nand2  g086(.a(new_n228_), .b(x54), .O(new_n256_));
  ...
  nand2  g094(.a(new_n273_), .b(new_n215_), .O(new_n274_));
  inv1   g095(.a(new_n274_), .O(new_n275_));
  nand2  g096(.a(new_n275_), .b(new_n272_), .O(new_n276_));
  nor3   g097(.a(new_n203_), .b(new_n164_), .c(new_n157_), .O(new_n277_));
  ...
  nor2   g131(.a(x80), .b(new_n157_), .O(new_n312_));
  nand3  g132(.a(new_n312_), .b(new_n228_), .c(new_n155_), .O(new_n313_));
  nor4   g133(.a(new_n313_), .b(new_n311_), .c(x82), .d(x81), .O(z55));
  inv1   g134(.a(x01), .O(new_n315_));
  inv1   g135(.a(new_n155_), .O(new_n316_));
  xnor2a g136(.a(x84), .b(x81), .O(new_n317_));
  aoi21  g137(.a(new_n164_), .b(new_n163_), .c(new_n317_), .O(new_n318_));
  aoi22  g138(.a(new_n318_), .b(new_n315_), .c(new_n316_), .d(x76), .O(new_n319_));
  inv1   g139(.a(x00), .O(new_n320_));
  nor3   g140(.a(new_n158_), .b(x01), .c(new_n320_), .O(new_n321_));
  oai21  g141(.a(new_n319_), .b(new_n157_), .c(new_n321_), .O(z56));
  inv1   g142(.a(x02), .O(new_n323_));
  nand4  g143(.a(x03), .b(new_n323_), .c(new_n315_), .d(x00), .O(new_n324_));
  inv1   g144(.a(new_n324_), .O(z57));
  inv1   g145(.a(x40), .O(new_n327_));
  aoi21  g146(.a(new_n214_), .b(x79), .c(new_n327_), .O(new_n328_));
  oai21  g147(.a(new_n210_), .b(new_n208_), .c(new_n220_), .O(new_n329_));
  aoi21  g148(.a(new_n329_), .b(x79), .c(new_n214_), .O(new_n330_));
  ...
  aoi21  g154(.a(new_n335_), .b(new_n216_), .c(x01), .O(z60));
  aoi21  g155(.a(new_n164_), .b(new_n163_), .c(new_n203_), .O(new_n340_));
  nor2   g156(.a(new_n316_), .b(x04), .O(new_n341_));
  nor2   g157(.a(new_n207_), .b(new_n157_), .O(new_n342_));
  oai21  g158(.a(new_n341_), .b(new_n340_), .c(new_n342_), .O(new_n343_));
  aoi21  g159(.a(new_n343_), .b(new_n274_), .c(x01), .O(z64));
  zero   g160(.O(z00));
  zero   g161(.O(z03));
  zero   g162(.O(z06));
  zero   g163(.O(z07));
