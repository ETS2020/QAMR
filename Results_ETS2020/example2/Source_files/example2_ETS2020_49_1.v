// Benchmark "FAU" written by ABC on Sat Jun 27 01:52:58 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n238_, new_n240_, new_n243_, new_n245_, new_n248_, new_n250_,
  ...
  nand2  g141(.a(new_n264_), .b(x14), .O(new_n307_));
  ...
  nand3  g146(.a(new_n251_), .b(x84), .c(new_n311_), .O(new_n312_));
  ...
  nand4  g154(.a(x84), .b(new_n250_), .c(x82), .d(x81), .O(new_n321_));
