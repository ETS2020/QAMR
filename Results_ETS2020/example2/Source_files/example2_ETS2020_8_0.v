// Benchmark "FAU" written by ABC on Sat Jun 27 01:49:52 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n289_, new_n292_, new_n295_, new_n305_, new_n306_,
  ...
  nand4  g108(.a(new_n255_), .b(new_n242_), .c(x48), .d(new_n246_), .O(new_n264_));
  inv1   g109(.a(new_n264_), .O(z30));
  nand4  g110(.a(new_n255_), .b(new_n242_), .c(x49), .d(new_n246_), .O(new_n266_));
  inv1   g111(.a(new_n266_), .O(z31));
  nand4  g112(.a(new_n255_), .b(new_n242_), .c(x50), .d(new_n246_), .O(new_n268_));
  inv1   g113(.a(new_n268_), .O(z32));
  xnor2a g114(.a(x83), .b(x81), .O(new_n270_));
  nand2  g115(.a(x42), .b(x05), .O(new_n271_));
  nand2  g116(.a(x51), .b(new_n246_), .O(new_n272_));
  oai22  g117(.a(new_n272_), .b(new_n250_), .c(new_n271_), .d(new_n270_), .O(new_n273_));
  nand2  g118(.a(new_n273_), .b(new_n248_), .O(new_n274_));
  xor2a  g119(.a(x83), .b(x81), .O(new_n275_));
  oai22  g120(.a(new_n275_), .b(new_n271_), .c(new_n272_), .d(x81), .O(new_n276_));
  nand2  g121(.a(new_n276_), .b(new_n252_), .O(new_n277_));
  inv1   g122(.a(new_n254_), .O(new_n278_));
  nand2  g123(.a(new_n278_), .b(new_n242_), .O(new_n279_));
  aoi21  g124(.a(new_n277_), .b(new_n274_), .c(new_n279_), .O(z33));
  inv1   g125(.a(x52), .O(new_n281_));
  nand2  g126(.a(x83), .b(x42), .O(new_n282_));
  nand2  g127(.a(new_n282_), .b(new_n250_), .O(new_n283_));
  nand3  g128(.a(x83), .b(x81), .c(x42), .O(new_n284_));
  aoi21  g129(.a(new_n284_), .b(new_n283_), .c(new_n251_), .O(new_n285_));
  nand2  g130(.a(new_n282_), .b(x81), .O(new_n286_));
  nand3  g131(.a(x83), .b(new_n250_), .c(x42), .O(new_n287_));
  aoi21  g132(.a(new_n287_), .b(new_n286_), .c(new_n247_), .O(new_n288_));
  oai21  g133(.a(new_n288_), .b(new_n285_), .c(new_n278_), .O(new_n289_));
  nor3   g134(.a(new_n289_), .b(new_n243_), .c(new_n281_), .O(z34));
  nand2  g135(.a(new_n242_), .b(x54), .O(new_n292_));
  nor2   g136(.a(new_n292_), .b(new_n289_), .O(z36));
  nand2  g137(.a(new_n242_), .b(x56), .O(new_n295_));
  nor2   g138(.a(new_n295_), .b(new_n289_), .O(z38));
  nor3   g139(.a(new_n289_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g140(.a(new_n289_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g141(.a(new_n289_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g142(.a(new_n289_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g143(.a(new_n289_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g144(.a(new_n289_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g145(.a(new_n289_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g146(.a(new_n289_), .b(new_n243_), .c(new_n176_), .O(z46));
  inv1   g147(.a(x07), .O(new_n305_));
  nand2  g148(.a(x52), .b(x15), .O(new_n306_));
  oai21  g149(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand3  g150(.a(new_n232_), .b(new_n167_), .c(new_n163_), .O(new_n308_));
  inv1   g151(.a(new_n308_), .O(new_n309_));
  nand2  g152(.a(new_n309_), .b(new_n307_), .O(new_n310_));
  nor2   g153(.a(x75), .b(x67), .O(new_n311_));
  nand3  g154(.a(x79), .b(new_n154_), .c(x77), .O(new_n312_));
  nor2   g155(.a(new_n312_), .b(new_n311_), .O(new_n313_));
  nand2  g156(.a(new_n313_), .b(new_n221_), .O(new_n314_));
  aoi21  g157(.a(new_n314_), .b(new_n310_), .c(x01), .O(z47));
  inv1   g158(.a(x08), .O(new_n316_));
  nand2  g159(.a(x52), .b(x16), .O(new_n317_));
  oai21  g160(.a(x52), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand2  g161(.a(new_n318_), .b(new_n309_), .O(new_n319_));
  nor2   g162(.a(new_n312_), .b(new_n220_), .O(new_n320_));
  nand2  g163(.a(new_n320_), .b(x68), .O(new_n321_));
  aoi21  g164(.a(new_n321_), .b(new_n319_), .c(x01), .O(z48));
  inv1   g165(.a(x09), .O(new_n323_));
  nand2  g166(.a(x52), .b(x17), .O(new_n324_));
  oai21  g167(.a(x52), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g168(.a(new_n325_), .b(new_n309_), .O(new_n326_));
  ...
  nand2  g174(.a(new_n331_), .b(new_n309_), .O(new_n332_));
  ...
  nand2  g180(.a(new_n337_), .b(new_n309_), .O(new_n338_));
  ...
  nand2  g186(.a(new_n343_), .b(new_n309_), .O(new_n344_));
  ...
  nand2  g192(.a(new_n349_), .b(new_n309_), .O(new_n350_));
  nand2  g193(.a(new_n320_), .b(x73), .O(new_n351_));
  aoi21  g194(.a(new_n351_), .b(new_n350_), .c(x01), .O(z53));
  nand2  g195(.a(x52), .b(x22), .O(new_n353_));
  nand2  g196(.a(new_n281_), .b(x14), .O(new_n354_));
  inv1   g197(.a(new_n164_), .O(new_n355_));
  nand4  g198(.a(new_n355_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n356_));
  aoi21  g199(.a(new_n354_), .b(new_n353_), .c(new_n356_), .O(z54));
  inv1   g200(.a(new_n240_), .O(new_n359_));
  xnor2a g201(.a(x84), .b(x81), .O(new_n360_));
  aoi21  g202(.a(new_n165_), .b(new_n164_), .c(new_n360_), .O(new_n361_));
  aoi22  g203(.a(new_n361_), .b(new_n153_), .c(new_n359_), .d(x76), .O(new_n362_));
  aoi21  g204(.a(new_n154_), .b(new_n163_), .c(new_n236_), .O(new_n363_));
  oai21  g205(.a(new_n362_), .b(new_n167_), .c(new_n363_), .O(z56));
  inv1   g206(.a(x02), .O(new_n365_));
  nand3  g207(.a(new_n237_), .b(x03), .c(new_n365_), .O(new_n366_));
  inv1   g208(.a(new_n366_), .O(z57));
  nand2  g209(.a(x42), .b(new_n152_), .O(new_n368_));
  nand4  g210(.a(x80), .b(new_n226_), .c(x43), .d(new_n246_), .O(new_n369_));
  oai21  g211(.a(new_n369_), .b(new_n225_), .c(new_n368_), .O(new_n370_));
  nand3  g212(.a(x79), .b(x78), .c(x04), .O(new_n371_));
  inv1   g213(.a(new_n371_), .O(new_n372_));
  nand2  g214(.a(new_n372_), .b(new_n370_), .O(new_n373_));
  nand4  g215(.a(new_n167_), .b(new_n154_), .c(new_n246_), .d(x40), .O(new_n374_));
  nand2  g216(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  nand2  g217(.a(new_n375_), .b(x77), .O(new_n376_));
  oai21  g218(.a(new_n355_), .b(new_n231_), .c(new_n167_), .O(new_n377_));
  aoi21  g219(.a(new_n377_), .b(new_n376_), .c(x01), .O(z58));
  nand2  g220(.a(new_n232_), .b(new_n228_), .O(new_n380_));
  inv1   g221(.a(new_n380_), .O(new_n381_));
  oai21  g222(.a(new_n227_), .b(new_n225_), .c(new_n381_), .O(new_n382_));
  aoi21  g223(.a(new_n154_), .b(x04), .c(x79), .O(new_n383_));
  aoi21  g224(.a(new_n361_), .b(x79), .c(new_n383_), .O(new_n384_));
  aoi21  g225(.a(new_n384_), .b(new_n382_), .c(x01), .O(z60));
  nand2  g226(.a(new_n165_), .b(new_n164_), .O(new_n386_));
  aoi22  g227(.a(new_n386_), .b(new_n221_), .c(new_n240_), .d(new_n231_), .O(new_n387_));
  nand2  g228(.a(new_n168_), .b(x80), .O(new_n388_));
  nor2   g229(.a(new_n388_), .b(new_n387_), .O(z61));
  nand2  g230(.a(x78), .b(new_n231_), .O(new_n390_));
  nand2  g231(.a(x84), .b(new_n154_), .O(new_n391_));
  aoi21  g232(.a(new_n391_), .b(new_n390_), .c(new_n163_), .O(new_n392_));
  nand2  g233(.a(new_n355_), .b(x84), .O(new_n393_));
  inv1   g234(.a(new_n393_), .O(new_n394_));
  nor2   g235(.a(new_n250_), .b(new_n167_), .O(new_n395_));
  oai21  g236(.a(new_n394_), .b(new_n392_), .c(new_n395_), .O(new_n396_));
  aoi21  g237(.a(new_n396_), .b(new_n233_), .c(x01), .O(z62));
  nand2  g238(.a(new_n168_), .b(x82), .O(new_n398_));
  nor2   g239(.a(new_n398_), .b(new_n387_), .O(z63));
  oai21  g240(.a(new_n250_), .b(x78), .c(new_n390_), .O(new_n401_));
  nand2  g241(.a(new_n401_), .b(x77), .O(new_n402_));
  nand2  g242(.a(new_n355_), .b(x81), .O(new_n403_));
  nand2  g243(.a(new_n168_), .b(x84), .O(new_n404_));
