// Benchmark "FAU" written by ABC on Sat Jun 27 01:50:51 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n257_, new_n259_, new_n261_, new_n263_, new_n268_,
  ...
  nand4  g105(.a(new_n254_), .b(new_n242_), .c(x45), .d(new_n245_), .O(new_n259_));
  inv1   g106(.a(new_n259_), .O(z27));
  nand4  g107(.a(new_n254_), .b(new_n242_), .c(x46), .d(new_n245_), .O(new_n261_));
  inv1   g108(.a(new_n261_), .O(z28));
  nand4  g109(.a(new_n254_), .b(new_n242_), .c(x47), .d(new_n245_), .O(new_n263_));
  inv1   g110(.a(new_n263_), .O(z29));
  xnor2a g111(.a(x83), .b(x81), .O(new_n268_));
  nand2  g112(.a(x42), .b(x05), .O(new_n269_));
  nand2  g113(.a(x51), .b(new_n245_), .O(new_n270_));
  oai22  g114(.a(new_n270_), .b(new_n249_), .c(new_n269_), .d(new_n268_), .O(new_n271_));
  ...
  inv1   g119(.a(new_n253_), .O(new_n276_));
  nand2  g120(.a(new_n276_), .b(new_n242_), .O(new_n277_));
  ...
  aoi21  g126(.a(new_n282_), .b(new_n281_), .c(new_n250_), .O(new_n283_));
  nand2  g127(.a(new_n280_), .b(x81), .O(new_n284_));
  nand3  g128(.a(x83), .b(new_n249_), .c(x42), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(new_n284_), .c(new_n246_), .O(new_n286_));
  oai21  g130(.a(new_n286_), .b(new_n283_), .c(new_n276_), .O(new_n287_));
  nor3   g131(.a(new_n287_), .b(new_n243_), .c(new_n279_), .O(z34));
  ...
  nand2  g136(.a(new_n242_), .b(x55), .O(new_n293_));
  nor2   g137(.a(new_n293_), .b(new_n287_), .O(z37));
  nand2  g138(.a(new_n242_), .b(x56), .O(new_n295_));
  nor2   g139(.a(new_n295_), .b(new_n287_), .O(z38));
  nor3   g140(.a(new_n287_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g141(.a(new_n287_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g142(.a(new_n287_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g143(.a(new_n287_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g144(.a(new_n287_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g145(.a(new_n287_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g146(.a(new_n287_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g147(.a(new_n287_), .b(new_n243_), .c(new_n176_), .O(z46));
  ...
  nand2  g197(.a(new_n279_), .b(x14), .O(new_n354_));
  ...
  nand4  g209(.a(x80), .b(new_n228_), .c(x43), .d(new_n245_), .O(new_n368_));
  ...
  nand4  g214(.a(new_n167_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n373_));
  ...
  nor2   g234(.a(new_n249_), .b(new_n167_), .O(new_n394_));
  ...
  oai21  g239(.a(new_n249_), .b(x78), .c(new_n389_), .O(new_n400_));
