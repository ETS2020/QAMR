...
module FAU ( 
  ...
  nor3   g137(.a(new_n282_), .b(new_n235_), .c(new_n183_), .O(z43));
  nor3   g138(.a(new_n282_), .b(new_n235_), .c(new_n180_), .O(z44));
  nor3   g139(.a(new_n282_), .b(new_n235_), .c(new_n177_), .O(z45));
  nor3   g140(.a(new_n282_), .b(new_n235_), .c(new_n174_), .O(z46));
  ...
  nand2  g192(.a(new_n273_), .b(x14), .O(new_n351_));
  ...
  nand3  g196(.a(new_n260_), .b(x84), .c(new_n354_), .O(new_n355_));
  inv1   g197(.a(x80), .O(new_n356_));
  nand4  g198(.a(new_n234_), .b(new_n155_), .c(new_n356_), .d(x79), .O(new_n357_));
  ...
  oai21  g209(.a(new_n161_), .b(new_n229_), .c(new_n157_), .O(new_n369_));
  ...
  nand2  g224(.a(new_n155_), .b(new_n229_), .O(new_n384_));
  ...
  oai21  g229(.a(x79), .b(new_n229_), .c(new_n388_), .O(new_n389_));
  nand2  g230(.a(new_n389_), .b(new_n153_), .O(new_n390_));
  nand2  g231(.a(new_n372_), .b(x79), .O(new_n391_));
  nand3  g232(.a(x81), .b(x79), .c(new_n229_), .O(new_n392_));
