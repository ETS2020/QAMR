// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:27 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n216_, new_n217_, new_n218_, new_n219_, new_n224_, new_n225_,
    new_n226_, new_n227_, new_n228_, new_n229_, new_n230_, new_n231_,
    new_n232_, new_n233_, new_n235_, new_n237_, new_n240_, new_n242_,
  ...
  nor2   g065(.a(new_n230_), .b(new_n162_), .O(new_n231_));
  nor2   g066(.a(x04), .b(x01), .O(new_n232_));
  nand4  g067(.a(new_n232_), .b(new_n231_), .c(x44), .d(new_n224_), .O(new_n233_));
  inv1   g068(.a(new_n233_), .O(z26));
  nand4  g069(.a(new_n232_), .b(new_n231_), .c(x45), .d(new_n224_), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(z27));
  nand4  g071(.a(new_n232_), .b(new_n231_), .c(x46), .d(new_n224_), .O(new_n237_));
  inv1   g072(.a(new_n237_), .O(z28));
  nand4  g073(.a(new_n232_), .b(new_n231_), .c(x48), .d(new_n224_), .O(new_n240_));
  inv1   g074(.a(new_n240_), .O(z30));
  nand4  g075(.a(new_n232_), .b(new_n231_), .c(x49), .d(new_n224_), .O(new_n242_));
  inv1   g076(.a(new_n242_), .O(z31));
  nand4  g077(.a(new_n232_), .b(new_n231_), .c(x50), .d(new_n224_), .O(new_n244_));
  inv1   g078(.a(new_n244_), .O(z32));
  inv1   g079(.a(new_n162_), .O(new_n248_));
  nand2  g080(.a(x83), .b(x42), .O(new_n249_));
  nand2  g081(.a(new_n249_), .b(new_n225_), .O(new_n250_));
  inv1   g082(.a(new_n249_), .O(new_n251_));
  nand2  g083(.a(new_n251_), .b(x81), .O(new_n252_));
  aoi21  g084(.a(new_n252_), .b(new_n250_), .c(new_n228_), .O(new_n253_));
  nand2  g085(.a(new_n249_), .b(x81), .O(new_n254_));
  nand2  g086(.a(new_n251_), .b(new_n225_), .O(new_n255_));
  aoi21  g087(.a(new_n255_), .b(new_n254_), .c(new_n226_), .O(new_n256_));
  oai21  g088(.a(new_n256_), .b(new_n253_), .c(new_n248_), .O(new_n257_));
  nand2  g089(.a(new_n232_), .b(x53), .O(new_n258_));
  nor2   g090(.a(new_n258_), .b(new_n257_), .O(z35));
  nand2  g091(.a(new_n232_), .b(x55), .O(new_n261_));
  nor2   g092(.a(new_n261_), .b(new_n257_), .O(z37));
  nand2  g093(.a(new_n232_), .b(x56), .O(new_n263_));
  nor2   g094(.a(new_n263_), .b(new_n257_), .O(z38));
  ...
  nand3  g146(.a(new_n324_), .b(new_n232_), .c(new_n161_), .O(new_n325_));
  ...
  oai21  g160(.a(new_n213_), .b(new_n211_), .c(new_n224_), .O(new_n340_));
