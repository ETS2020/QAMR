...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n227_, new_n228_, new_n229_, new_n230_, new_n233_, new_n235_,
  ...
  inv1   g052(.a(x42), .O(new_n221_));
  inv1   g053(.a(x81), .O(new_n222_));
  xor2a  g054(.a(x84), .b(x82), .O(new_n223_));
  nor2   g055(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  xnor2a g056(.a(x84), .b(x82), .O(new_n225_));
  nor2   g057(.a(new_n225_), .b(x81), .O(new_n226_));
  nor2   g058(.a(new_n226_), .b(new_n224_), .O(new_n227_));
  nor2   g059(.a(new_n227_), .b(new_n162_), .O(new_n228_));
  nor2   g060(.a(x04), .b(x01), .O(new_n229_));
  nand4  g061(.a(new_n229_), .b(new_n228_), .c(x45), .d(new_n221_), .O(new_n230_));
  inv1   g062(.a(new_n230_), .O(z27));
  nand4  g063(.a(new_n229_), .b(new_n228_), .c(x47), .d(new_n221_), .O(new_n233_));
  inv1   g064(.a(new_n233_), .O(z29));
  nand4  g065(.a(new_n229_), .b(new_n228_), .c(x48), .d(new_n221_), .O(new_n235_));
  inv1   g066(.a(new_n235_), .O(z30));
  nand4  g067(.a(new_n229_), .b(new_n228_), .c(x49), .d(new_n221_), .O(new_n237_));
  inv1   g068(.a(new_n237_), .O(z31));
  nand4  g069(.a(new_n229_), .b(new_n228_), .c(x50), .d(new_n221_), .O(new_n239_));
  inv1   g070(.a(new_n239_), .O(z32));
  inv1   g071(.a(new_n162_), .O(new_n243_));
  nand2  g072(.a(x83), .b(x42), .O(new_n244_));
  nand2  g073(.a(new_n244_), .b(new_n222_), .O(new_n245_));
  inv1   g074(.a(new_n244_), .O(new_n246_));
  nand2  g075(.a(new_n246_), .b(x81), .O(new_n247_));
  aoi21  g076(.a(new_n247_), .b(new_n245_), .c(new_n225_), .O(new_n248_));
  nand2  g077(.a(new_n244_), .b(x81), .O(new_n249_));
  nand2  g078(.a(new_n246_), .b(new_n222_), .O(new_n250_));
  aoi21  g079(.a(new_n250_), .b(new_n249_), .c(new_n223_), .O(new_n251_));
  oai21  g080(.a(new_n251_), .b(new_n248_), .c(new_n243_), .O(new_n252_));
  nand2  g081(.a(new_n229_), .b(x53), .O(new_n253_));
  nor2   g082(.a(new_n253_), .b(new_n252_), .O(z35));
  nand2  g083(.a(new_n229_), .b(x54), .O(new_n255_));
  nor2   g084(.a(new_n255_), .b(new_n252_), .O(z36));
  nand2  g085(.a(new_n229_), .b(x55), .O(new_n257_));
  nor2   g086(.a(new_n257_), .b(new_n252_), .O(z37));
  nand2  g087(.a(new_n229_), .b(x56), .O(new_n259_));
  nor2   g088(.a(new_n259_), .b(new_n252_), .O(z38));
  ...
  nand3  g131(.a(new_n312_), .b(new_n229_), .c(new_n161_), .O(new_n313_));
  ...
  oai21  g145(.a(new_n209_), .b(new_n207_), .c(new_n221_), .O(new_n328_));
