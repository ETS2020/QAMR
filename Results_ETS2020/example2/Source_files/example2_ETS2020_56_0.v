// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:28 2020
...
module FAU ( 
  ...
  nor2   g143(.a(new_n298_), .b(new_n292_), .O(z38));
  nor3   g144(.a(new_n292_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g145(.a(new_n292_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g146(.a(new_n292_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g147(.a(new_n292_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g148(.a(new_n292_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g149(.a(new_n292_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g150(.a(new_n292_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g151(.a(new_n292_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g197(.a(new_n352_), .b(new_n312_), .O(new_n353_));
  nand2  g198(.a(new_n323_), .b(x73), .O(new_n354_));
  aoi21  g199(.a(new_n354_), .b(new_n353_), .c(x01), .O(z53));
  nand2  g200(.a(x52), .b(x22), .O(new_n356_));
  nand2  g201(.a(new_n284_), .b(x14), .O(new_n357_));
  inv1   g202(.a(new_n164_), .O(new_n358_));
  nand4  g203(.a(new_n358_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n359_));
  aoi21  g204(.a(new_n357_), .b(new_n356_), .c(new_n359_), .O(z54));
  inv1   g205(.a(new_n242_), .O(new_n362_));
  xnor2a g206(.a(x84), .b(x81), .O(new_n363_));
  aoi21  g207(.a(new_n165_), .b(new_n164_), .c(new_n363_), .O(new_n364_));
  aoi22  g208(.a(new_n364_), .b(new_n153_), .c(new_n362_), .d(x76), .O(new_n365_));
  aoi21  g209(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n366_));
  oai21  g210(.a(new_n365_), .b(new_n167_), .c(new_n366_), .O(z56));
  inv1   g211(.a(x02), .O(new_n368_));
  nand3  g212(.a(new_n239_), .b(x03), .c(new_n368_), .O(new_n369_));
  inv1   g213(.a(new_n369_), .O(z57));
  nand2  g214(.a(x42), .b(new_n152_), .O(new_n371_));
  nand4  g215(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n372_));
  oai21  g216(.a(new_n372_), .b(new_n227_), .c(new_n371_), .O(new_n373_));
  nand3  g217(.a(x79), .b(x78), .c(x04), .O(new_n374_));
  inv1   g218(.a(new_n374_), .O(new_n375_));
  nand2  g219(.a(new_n375_), .b(new_n373_), .O(new_n376_));
  nand4  g220(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n376_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(x77), .O(new_n379_));
  oai21  g223(.a(new_n358_), .b(new_n233_), .c(new_n167_), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(new_n379_), .c(x01), .O(z58));
  nand2  g225(.a(new_n234_), .b(new_n230_), .O(new_n383_));
  inv1   g226(.a(new_n383_), .O(new_n384_));
  oai21  g227(.a(new_n229_), .b(new_n227_), .c(new_n384_), .O(new_n385_));
  aoi21  g228(.a(new_n154_), .b(x04), .c(x79), .O(new_n386_));
  aoi21  g229(.a(new_n364_), .b(x79), .c(new_n386_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n385_), .c(x01), .O(z60));
  nand2  g231(.a(new_n165_), .b(new_n164_), .O(new_n389_));
  aoi22  g232(.a(new_n389_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n390_));
  nand2  g233(.a(new_n168_), .b(x80), .O(new_n391_));
  nor2   g234(.a(new_n391_), .b(new_n390_), .O(z61));
  nand2  g235(.a(x78), .b(new_n233_), .O(new_n393_));
  nand2  g236(.a(x84), .b(new_n154_), .O(new_n394_));
  aoi21  g237(.a(new_n394_), .b(new_n393_), .c(new_n163_), .O(new_n395_));
  nand2  g238(.a(new_n358_), .b(x84), .O(new_n396_));
  inv1   g239(.a(new_n396_), .O(new_n397_));
  nor2   g240(.a(new_n251_), .b(new_n167_), .O(new_n398_));
  oai21  g241(.a(new_n397_), .b(new_n395_), .c(new_n398_), .O(new_n399_));
  aoi21  g242(.a(new_n399_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g243(.a(new_n168_), .b(x82), .O(new_n401_));
  nor2   g244(.a(new_n401_), .b(new_n390_), .O(z63));
  oai21  g245(.a(new_n251_), .b(x78), .c(new_n393_), .O(new_n404_));
  nand2  g246(.a(new_n404_), .b(x77), .O(new_n405_));
  nand2  g247(.a(new_n358_), .b(x81), .O(new_n406_));
  nand2  g248(.a(new_n168_), .b(x84), .O(new_n407_));
