...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n201_, new_n204_, new_n205_, new_n210_, new_n211_, new_n214_,
  ...
  nor2   g077(.a(new_n161_), .b(new_n154_), .O(new_n234_));
  ...
  nand4  g099(.a(new_n246_), .b(new_n235_), .c(x49), .d(new_n239_), .O(new_n257_));
  inv1   g100(.a(new_n257_), .O(z31));
  nand4  g101(.a(new_n246_), .b(new_n235_), .c(x50), .d(new_n239_), .O(new_n259_));
  inv1   g102(.a(new_n259_), .O(z32));
  nor2   g103(.a(new_n220_), .b(x81), .O(new_n261_));
  nor2   g104(.a(x83), .b(new_n243_), .O(new_n262_));
  nor2   g105(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  nand2  g106(.a(x42), .b(x05), .O(new_n264_));
  nand2  g107(.a(x51), .b(new_n239_), .O(new_n265_));
  oai22  g108(.a(new_n265_), .b(new_n243_), .c(new_n264_), .d(new_n263_), .O(new_n266_));
  ...
  nor3   g133(.a(new_n283_), .b(new_n236_), .c(new_n200_), .O(z39));
  nor3   g134(.a(new_n283_), .b(new_n236_), .c(new_n197_), .O(z40));
  nor3   g135(.a(new_n283_), .b(new_n236_), .c(new_n194_), .O(z41));
  nor3   g136(.a(new_n283_), .b(new_n236_), .c(new_n191_), .O(z42));
  nor3   g137(.a(new_n283_), .b(new_n236_), .c(new_n188_), .O(z43));
  nor3   g138(.a(new_n283_), .b(new_n236_), .c(new_n185_), .O(z44));
  nor3   g139(.a(new_n283_), .b(new_n236_), .c(new_n182_), .O(z45));
  nor3   g140(.a(new_n283_), .b(new_n236_), .c(new_n179_), .O(z46));
  ...
  nand2  g149(.a(new_n168_), .b(x79), .O(new_n308_));
  aoi21  g150(.a(new_n165_), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  ...
  nand4  g193(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n352_));
  ...
  nand4  g198(.a(new_n235_), .b(new_n161_), .c(new_n356_), .d(x79), .O(new_n357_));
  nor2   g199(.a(new_n357_), .b(new_n355_), .O(z55));
  inv1   g200(.a(x02), .O(new_n360_));
  nand4  g201(.a(x03), .b(new_n360_), .c(new_n153_), .d(x00), .O(new_n361_));
  inv1   g202(.a(new_n361_), .O(z57));
  nand4  g203(.a(x80), .b(new_n222_), .c(x43), .d(new_n239_), .O(new_n363_));
  oai22  g204(.a(new_n363_), .b(new_n221_), .c(new_n239_), .d(x40), .O(new_n364_));
  nand3  g205(.a(new_n364_), .b(new_n227_), .c(x79), .O(new_n365_));
  nor2   g206(.a(x79), .b(x78), .O(new_n366_));
  nand3  g207(.a(new_n366_), .b(new_n239_), .c(x40), .O(new_n367_));
  nand2  g208(.a(new_n367_), .b(new_n365_), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g210(.a(new_n166_), .b(new_n230_), .c(new_n154_), .O(new_n370_));
  aoi21  g211(.a(new_n370_), .b(new_n369_), .c(x01), .O(z58));
  inv1   g212(.a(new_n366_), .O(new_n372_));
  aoi21  g213(.a(new_n226_), .b(new_n372_), .c(new_n152_), .O(new_n373_));
  oai21  g214(.a(new_n223_), .b(new_n221_), .c(new_n239_), .O(new_n374_));
  aoi21  g215(.a(new_n374_), .b(x79), .c(new_n226_), .O(new_n375_));
  ...
  nand2  g221(.a(new_n308_), .b(new_n167_), .O(new_n381_));
  aoi21  g222(.a(new_n381_), .b(new_n380_), .c(new_n377_), .O(new_n382_));
  aoi21  g223(.a(new_n382_), .b(new_n228_), .c(x01), .O(z60));
  inv1   g224(.a(new_n171_), .O(new_n384_));
  oai21  g225(.a(new_n168_), .b(new_n166_), .c(new_n217_), .O(new_n385_));
  nand2  g226(.a(new_n161_), .b(new_n230_), .O(new_n386_));
  nand2  g227(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  inv1   g228(.a(new_n387_), .O(new_n388_));
  nor3   g229(.a(new_n388_), .b(new_n384_), .c(new_n356_), .O(z61));
  nand3  g230(.a(x84), .b(x81), .c(x79), .O(new_n390_));
  oai21  g231(.a(x79), .b(new_n230_), .c(new_n390_), .O(new_n391_));
  nand2  g232(.a(new_n391_), .b(new_n159_), .O(new_n392_));
  nand2  g233(.a(new_n374_), .b(x79), .O(new_n393_));
  nand3  g234(.a(x81), .b(x79), .c(new_n230_), .O(new_n394_));
  inv1   g235(.a(new_n394_), .O(new_n395_));
  aoi21  g236(.a(new_n393_), .b(x04), .c(new_n395_), .O(new_n396_));
  oai21  g237(.a(new_n396_), .b(new_n159_), .c(new_n392_), .O(new_n397_));
  nand2  g238(.a(new_n397_), .b(x78), .O(new_n398_));
  inv1   g239(.a(new_n390_), .O(new_n399_));
  nand2  g240(.a(new_n399_), .b(new_n168_), .O(new_n400_));
  aoi21  g241(.a(new_n400_), .b(new_n398_), .c(x01), .O(z62));
  nor3   g242(.a(new_n388_), .b(new_n384_), .c(new_n354_), .O(z63));
  nand3  g243(.a(new_n387_), .b(x83), .c(x79), .O(new_n403_));
  aoi21  g244(.a(new_n403_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g245(.a(new_n160_), .b(x04), .O(new_n405_));
  nor2   g246(.a(new_n243_), .b(x78), .O(new_n406_));
  oai21  g247(.a(new_n406_), .b(new_n405_), .c(x77), .O(new_n407_));
  nand2  g248(.a(new_n166_), .b(x81), .O(new_n408_));
  nand2  g249(.a(new_n171_), .b(x84), .O(new_n409_));
