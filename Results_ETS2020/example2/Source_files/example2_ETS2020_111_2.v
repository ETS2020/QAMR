// Benchmark "FAU" written by ABC on Sat Jun 27 01:57:31 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n173_, new_n186_, new_n187_, new_n190_, new_n191_, new_n193_,
    ...
    new_n231_, new_n234_, new_n237_, new_n239_, new_n241_, new_n246_,
  ...
  inv1   g027(.a(x35), .O(new_n190_));
  nand2  g028(.a(x48), .b(x40), .O(new_n191_));
  oai21  g029(.a(x40), .b(new_n190_), .c(new_n191_), .O(z17));
  inv1   g030(.a(x36), .O(new_n193_));
  nand2  g031(.a(x47), .b(x40), .O(new_n194_));
  oai21  g032(.a(x40), .b(new_n193_), .c(new_n194_), .O(z18));
  ...
  nand2  g098(.a(new_n276_), .b(new_n217_), .O(new_n277_));
  inv1   g099(.a(new_n277_), .O(new_n278_));
  nand2  g100(.a(new_n278_), .b(new_n275_), .O(new_n279_));
  nor3   g101(.a(new_n205_), .b(new_n169_), .c(new_n154_), .O(new_n280_));
  ...
  aoi21  g149(.a(new_n216_), .b(new_n329_), .c(new_n152_), .O(new_n330_));
  oai21  g150(.a(new_n212_), .b(new_n210_), .c(new_n222_), .O(new_n331_));
  aoi21  g151(.a(new_n331_), .b(x79), .c(new_n216_), .O(new_n332_));
  ...
  aoi21  g157(.a(new_n337_), .b(new_n218_), .c(x01), .O(z60));
  aoi21  g158(.a(new_n169_), .b(new_n168_), .c(new_n205_), .O(new_n342_));
  nor2   g159(.a(new_n318_), .b(x04), .O(new_n343_));
  nor2   g160(.a(new_n209_), .b(new_n154_), .O(new_n344_));
