...
module FAU ( 
  ...
  nor3   g116(.a(new_n269_), .b(new_n223_), .c(new_n192_), .O(z39));
  nor3   g117(.a(new_n269_), .b(new_n223_), .c(new_n189_), .O(z40));
  nor3   g118(.a(new_n269_), .b(new_n223_), .c(new_n186_), .O(z41));
  nor3   g119(.a(new_n269_), .b(new_n223_), .c(new_n183_), .O(z42));
  nor3   g120(.a(new_n269_), .b(new_n223_), .c(new_n180_), .O(z43));
  nor3   g121(.a(new_n269_), .b(new_n223_), .c(new_n177_), .O(z44));
  nor3   g122(.a(new_n269_), .b(new_n223_), .c(new_n174_), .O(z45));
  nor3   g123(.a(new_n269_), .b(new_n223_), .c(new_n171_), .O(z46));
