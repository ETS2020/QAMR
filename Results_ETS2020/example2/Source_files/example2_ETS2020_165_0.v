// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:30 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n258_, new_n260_, new_n262_, new_n264_, new_n267_,
  ...
  xnor2a g096(.a(x84), .b(x82), .O(new_n251_));
  inv1   g097(.a(new_n251_), .O(new_n252_));
  nand2  g098(.a(new_n252_), .b(new_n250_), .O(new_n253_));
  nand2  g099(.a(new_n240_), .b(x79), .O(new_n254_));
  aoi21  g100(.a(new_n253_), .b(new_n249_), .c(new_n254_), .O(new_n255_));
  nand4  g101(.a(new_n255_), .b(new_n242_), .c(x44), .d(new_n246_), .O(new_n256_));
  inv1   g102(.a(new_n256_), .O(z26));
  nand4  g103(.a(new_n255_), .b(new_n242_), .c(x45), .d(new_n246_), .O(new_n258_));
  inv1   g104(.a(new_n258_), .O(z27));
  nand4  g105(.a(new_n255_), .b(new_n242_), .c(x46), .d(new_n246_), .O(new_n260_));
  inv1   g106(.a(new_n260_), .O(z28));
  nand4  g107(.a(new_n255_), .b(new_n242_), .c(x47), .d(new_n246_), .O(new_n262_));
  inv1   g108(.a(new_n262_), .O(z29));
  nand4  g109(.a(new_n255_), .b(new_n242_), .c(x48), .d(new_n246_), .O(new_n264_));
  inv1   g110(.a(new_n264_), .O(z30));
  nand4  g111(.a(new_n255_), .b(new_n242_), .c(x50), .d(new_n246_), .O(new_n267_));
  inv1   g112(.a(new_n267_), .O(z32));
  xnor2a g113(.a(x83), .b(x81), .O(new_n269_));
  nand2  g114(.a(x42), .b(x05), .O(new_n270_));
  nand2  g115(.a(x51), .b(new_n246_), .O(new_n271_));
  oai22  g116(.a(new_n271_), .b(new_n250_), .c(new_n270_), .d(new_n269_), .O(new_n272_));
  nand2  g117(.a(new_n272_), .b(new_n248_), .O(new_n273_));
  xor2a  g118(.a(x83), .b(x81), .O(new_n274_));
  oai22  g119(.a(new_n274_), .b(new_n270_), .c(new_n271_), .d(x81), .O(new_n275_));
  nand2  g120(.a(new_n275_), .b(new_n252_), .O(new_n276_));
  inv1   g121(.a(new_n254_), .O(new_n277_));
  nand2  g122(.a(new_n277_), .b(new_n242_), .O(new_n278_));
  aoi21  g123(.a(new_n276_), .b(new_n273_), .c(new_n278_), .O(z33));
  inv1   g124(.a(x52), .O(new_n280_));
  nand2  g125(.a(x83), .b(x42), .O(new_n281_));
  nand2  g126(.a(new_n281_), .b(new_n250_), .O(new_n282_));
  nand3  g127(.a(x83), .b(x81), .c(x42), .O(new_n283_));
  aoi21  g128(.a(new_n283_), .b(new_n282_), .c(new_n251_), .O(new_n284_));
  nand2  g129(.a(new_n281_), .b(x81), .O(new_n285_));
  nand3  g130(.a(x83), .b(new_n250_), .c(x42), .O(new_n286_));
  aoi21  g131(.a(new_n286_), .b(new_n285_), .c(new_n247_), .O(new_n287_));
  oai21  g132(.a(new_n287_), .b(new_n284_), .c(new_n277_), .O(new_n288_));
  nor3   g133(.a(new_n288_), .b(new_n243_), .c(new_n280_), .O(z34));
  nand2  g134(.a(new_n242_), .b(x53), .O(new_n290_));
  nor2   g135(.a(new_n290_), .b(new_n288_), .O(z35));
  nand2  g136(.a(new_n242_), .b(x54), .O(new_n292_));
  nor2   g137(.a(new_n292_), .b(new_n288_), .O(z36));
  nand2  g138(.a(new_n242_), .b(x56), .O(new_n295_));
  nor2   g139(.a(new_n295_), .b(new_n288_), .O(z38));
  nor3   g140(.a(new_n288_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g141(.a(new_n288_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g142(.a(new_n288_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g143(.a(new_n288_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g144(.a(new_n288_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g145(.a(new_n288_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g146(.a(new_n288_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g147(.a(new_n288_), .b(new_n243_), .c(new_n176_), .O(z46));
  inv1   g148(.a(x07), .O(new_n305_));
  nand2  g149(.a(x52), .b(x15), .O(new_n306_));
  oai21  g150(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand3  g151(.a(new_n234_), .b(new_n167_), .c(new_n163_), .O(new_n308_));
  inv1   g152(.a(new_n308_), .O(new_n309_));
  nand2  g153(.a(new_n309_), .b(new_n307_), .O(new_n310_));
  nor2   g154(.a(x75), .b(x67), .O(new_n311_));
  nand3  g155(.a(x79), .b(new_n154_), .c(x77), .O(new_n312_));
  nor2   g156(.a(new_n312_), .b(new_n311_), .O(new_n313_));
  nand2  g157(.a(new_n313_), .b(new_n223_), .O(new_n314_));
  ...
  nor2   g163(.a(new_n312_), .b(new_n222_), .O(new_n320_));
  nand2  g164(.a(new_n320_), .b(x68), .O(new_n321_));
  aoi21  g165(.a(new_n321_), .b(new_n319_), .c(x01), .O(z48));
  ...
  nand2  g175(.a(new_n331_), .b(new_n309_), .O(new_n332_));
  ...
  nand2  g181(.a(new_n337_), .b(new_n309_), .O(new_n338_));
  ...
  nand2  g187(.a(new_n343_), .b(new_n309_), .O(new_n344_));
  ...
  nand2  g193(.a(new_n349_), .b(new_n309_), .O(new_n350_));
  nand2  g194(.a(new_n320_), .b(x73), .O(new_n351_));
  aoi21  g195(.a(new_n351_), .b(new_n350_), .c(x01), .O(z53));
  nand2  g196(.a(x52), .b(x22), .O(new_n353_));
  nand2  g197(.a(new_n280_), .b(x14), .O(new_n354_));
  inv1   g198(.a(new_n164_), .O(new_n355_));
  nand4  g199(.a(new_n355_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n356_));
  aoi21  g200(.a(new_n354_), .b(new_n353_), .c(new_n356_), .O(z54));
  inv1   g201(.a(new_n240_), .O(new_n359_));
  xnor2a g202(.a(x84), .b(x81), .O(new_n360_));
  aoi21  g203(.a(new_n165_), .b(new_n164_), .c(new_n360_), .O(new_n361_));
  aoi22  g204(.a(new_n361_), .b(new_n153_), .c(new_n359_), .d(x76), .O(new_n362_));
  nand2  g205(.a(new_n153_), .b(x00), .O(new_n363_));
  aoi21  g206(.a(new_n154_), .b(new_n163_), .c(new_n363_), .O(new_n364_));
  oai21  g207(.a(new_n362_), .b(new_n167_), .c(new_n364_), .O(z56));
  nand2  g208(.a(x42), .b(new_n152_), .O(new_n367_));
  nand4  g209(.a(x80), .b(new_n228_), .c(x43), .d(new_n246_), .O(new_n368_));
  oai21  g210(.a(new_n368_), .b(new_n227_), .c(new_n367_), .O(new_n369_));
  nand3  g211(.a(x79), .b(x78), .c(x04), .O(new_n370_));
  inv1   g212(.a(new_n370_), .O(new_n371_));
  nand2  g213(.a(new_n371_), .b(new_n369_), .O(new_n372_));
  nand4  g214(.a(new_n167_), .b(new_n154_), .c(new_n246_), .d(x40), .O(new_n373_));
  nand2  g215(.a(new_n373_), .b(new_n372_), .O(new_n374_));
  nand2  g216(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g217(.a(new_n355_), .b(new_n233_), .c(new_n167_), .O(new_n376_));
  aoi21  g218(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  nand2  g219(.a(new_n234_), .b(new_n230_), .O(new_n379_));
  inv1   g220(.a(new_n379_), .O(new_n380_));
  oai21  g221(.a(new_n229_), .b(new_n227_), .c(new_n380_), .O(new_n381_));
  aoi21  g222(.a(new_n154_), .b(x04), .c(x79), .O(new_n382_));
  aoi21  g223(.a(new_n361_), .b(x79), .c(new_n382_), .O(new_n383_));
  aoi21  g224(.a(new_n383_), .b(new_n381_), .c(x01), .O(z60));
  nand2  g225(.a(new_n165_), .b(new_n164_), .O(new_n385_));
  aoi22  g226(.a(new_n385_), .b(new_n223_), .c(new_n240_), .d(new_n233_), .O(new_n386_));
  nand2  g227(.a(new_n168_), .b(x80), .O(new_n387_));
  nor2   g228(.a(new_n387_), .b(new_n386_), .O(z61));
  nand2  g229(.a(x78), .b(new_n233_), .O(new_n389_));
  nand2  g230(.a(x84), .b(new_n154_), .O(new_n390_));
  aoi21  g231(.a(new_n390_), .b(new_n389_), .c(new_n163_), .O(new_n391_));
  nand2  g232(.a(new_n355_), .b(x84), .O(new_n392_));
  inv1   g233(.a(new_n392_), .O(new_n393_));
  nor2   g234(.a(new_n250_), .b(new_n167_), .O(new_n394_));
  oai21  g235(.a(new_n393_), .b(new_n391_), .c(new_n394_), .O(new_n395_));
  aoi21  g236(.a(new_n395_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g237(.a(new_n168_), .b(x82), .O(new_n397_));
  nor2   g238(.a(new_n397_), .b(new_n386_), .O(z63));
  oai21  g239(.a(new_n250_), .b(x78), .c(new_n389_), .O(new_n400_));
  nand2  g240(.a(new_n400_), .b(x77), .O(new_n401_));
  nand2  g241(.a(new_n355_), .b(x81), .O(new_n402_));
  nand2  g242(.a(new_n168_), .b(x84), .O(new_n403_));
  aoi21  g243(.a(new_n402_), .b(new_n401_), .c(new_n403_), .O(z65));
  zero   g244(.O(z01));
  zero   g245(.O(z19));
  zero   g246(.O(z25));
  zero   g247(.O(z31));
