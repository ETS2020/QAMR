...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n253_, new_n254_, new_n255_, new_n258_, new_n260_, new_n263_,
  ...
  aoi22  g143(.a(new_n320_), .b(new_n317_), .c(new_n318_), .d(x76), .O(new_n321_));
  ...
  nand4  g148(.a(x03), .b(new_n325_), .c(new_n317_), .d(x00), .O(new_n326_));
  inv1   g149(.a(new_n326_), .O(z57));
  inv1   g150(.a(x40), .O(new_n329_));
  aoi21  g151(.a(new_n212_), .b(x79), .c(new_n329_), .O(new_n330_));
  oai21  g152(.a(new_n208_), .b(new_n206_), .c(new_n218_), .O(new_n331_));
  aoi21  g153(.a(new_n331_), .b(x79), .c(new_n212_), .O(new_n332_));
  ...
  aoi21  g159(.a(new_n337_), .b(new_n214_), .c(x01), .O(z60));
  aoi21  g160(.a(new_n164_), .b(new_n163_), .c(new_n201_), .O(new_n342_));
  nor2   g161(.a(new_n318_), .b(x04), .O(new_n343_));
  nor2   g162(.a(new_n205_), .b(new_n157_), .O(new_n344_));
  oai21  g163(.a(new_n343_), .b(new_n342_), .c(new_n344_), .O(new_n345_));
  aoi21  g164(.a(new_n345_), .b(new_n276_), .c(x01), .O(z64));
  zero   g165(.O(z00));
  zero   g166(.O(z03));
  zero   g167(.O(z06));
  zero   g168(.O(z07));
