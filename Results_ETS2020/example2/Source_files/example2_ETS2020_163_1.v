...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n213_, new_n215_, new_n216_, new_n221_, new_n222_, new_n223_,
  ...
  nand4  g146(.a(x03), .b(new_n315_), .c(new_n153_), .d(x00), .O(new_n316_));
  ...
  inv1   g158(.a(x04), .O(new_n328_));
  oai21  g159(.a(new_n303_), .b(new_n328_), .c(new_n162_), .O(new_n329_));
  aoi21  g160(.a(new_n329_), .b(new_n327_), .c(x01), .O(z58));
  aoi21  g161(.a(new_n322_), .b(x79), .c(new_n152_), .O(new_n331_));
  nand3  g162(.a(x80), .b(new_n319_), .c(x43), .O(new_n332_));
  oai21  g163(.a(new_n332_), .b(new_n318_), .c(new_n225_), .O(new_n333_));
  aoi21  g164(.a(new_n333_), .b(x79), .c(new_n322_), .O(new_n334_));
  oai21  g165(.a(new_n334_), .b(new_n331_), .c(x77), .O(new_n335_));
  nand2  g166(.a(new_n162_), .b(new_n328_), .O(new_n336_));
  aoi21  g167(.a(new_n336_), .b(new_n335_), .c(x01), .O(z59));
  oai21  g168(.a(new_n303_), .b(new_n292_), .c(new_n290_), .O(new_n339_));
  nand2  g169(.a(new_n163_), .b(new_n328_), .O(new_n340_));
  ...
  nor3   g174(.a(new_n344_), .b(new_n342_), .c(new_n308_), .O(z61));
  nand3  g175(.a(x84), .b(x81), .c(x79), .O(new_n346_));
  oai21  g176(.a(x79), .b(new_n328_), .c(new_n346_), .O(new_n347_));
  nand2  g177(.a(new_n347_), .b(new_n160_), .O(new_n348_));
  nand2  g178(.a(new_n333_), .b(x79), .O(new_n349_));
  nand3  g179(.a(x81), .b(x79), .c(new_n328_), .O(new_n350_));
  ...
  nand2  g185(.a(new_n355_), .b(new_n292_), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n354_), .c(x01), .O(z62));
  nor3   g187(.a(new_n344_), .b(new_n342_), .c(new_n306_), .O(z63));
  nand3  g188(.a(new_n341_), .b(x83), .c(x79), .O(new_n359_));
  aoi21  g189(.a(new_n359_), .b(new_n287_), .c(x01), .O(z64));
  nor2   g190(.a(new_n154_), .b(x04), .O(new_n361_));
  nor2   g191(.a(new_n229_), .b(x78), .O(new_n362_));
  oai21  g192(.a(new_n362_), .b(new_n361_), .c(x77), .O(new_n363_));
  nand2  g193(.a(new_n303_), .b(x81), .O(new_n364_));
