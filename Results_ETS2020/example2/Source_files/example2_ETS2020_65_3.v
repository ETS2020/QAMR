...
module FAU ( 
  ...
  nor3   g142(.a(new_n286_), .b(new_n238_), .c(new_n183_), .O(z43));
  nor3   g143(.a(new_n286_), .b(new_n238_), .c(new_n180_), .O(z44));
  nor3   g144(.a(new_n286_), .b(new_n238_), .c(new_n177_), .O(z45));
  nor3   g145(.a(new_n286_), .b(new_n238_), .c(new_n174_), .O(z46));
  ...
  nand2  g150(.a(new_n306_), .b(new_n228_), .O(new_n307_));
  ...
  nand2  g156(.a(new_n312_), .b(new_n218_), .O(new_n313_));
  ...
  inv1   g162(.a(new_n218_), .O(new_n319_));
  ...
  nand4  g198(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n231_), .O(new_n355_));
  ...
  nand4  g206(.a(x03), .b(new_n363_), .c(new_n231_), .d(x00), .O(new_n364_));
  inv1   g207(.a(new_n364_), .O(z57));
  nand4  g208(.a(x80), .b(new_n223_), .c(x43), .d(new_n240_), .O(new_n366_));
  oai22  g209(.a(new_n366_), .b(new_n222_), .c(new_n240_), .d(x40), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n228_), .c(x79), .O(new_n368_));
  ...
  aoi21  g216(.a(new_n227_), .b(x79), .c(new_n173_), .O(new_n374_));
  oai21  g217(.a(new_n224_), .b(new_n222_), .c(new_n240_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(x79), .c(new_n227_), .O(new_n376_));
  ...
  aoi21  g226(.a(new_n383_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g227(.a(new_n166_), .O(new_n385_));
  oai21  g228(.a(new_n163_), .b(new_n161_), .c(new_n218_), .O(new_n386_));
  nand2  g229(.a(new_n155_), .b(new_n232_), .O(new_n387_));
  ...
  oai21  g234(.a(x79), .b(new_n232_), .c(new_n391_), .O(new_n392_));
  nand2  g235(.a(new_n392_), .b(new_n153_), .O(new_n393_));
  nand2  g236(.a(new_n375_), .b(x79), .O(new_n394_));
  nand3  g237(.a(x81), .b(x79), .c(new_n232_), .O(new_n395_));
  ...
  nor2   g249(.a(new_n244_), .b(x78), .O(new_n407_));
