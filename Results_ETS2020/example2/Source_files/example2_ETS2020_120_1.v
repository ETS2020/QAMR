...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n196_, new_n199_, new_n200_, new_n203_, new_n204_, new_n206_,
    new_n207_, new_n209_, new_n210_, new_n214_, new_n215_, new_n217_,
    new_n218_, new_n219_, new_n221_, new_n222_, new_n223_, new_n224_,
    new_n225_, new_n226_, new_n227_, new_n228_, new_n229_, new_n230_,
    new_n232_, new_n236_, new_n241_, new_n242_, new_n243_, new_n244_,
    new_n245_, new_n246_, new_n247_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n255_, new_n256_, new_n257_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n266_, new_n269_, new_n271_, new_n288_, new_n289_,
  ...
  nor2   g078(.a(new_n241_), .b(x81), .O(new_n242_));
  nor2   g079(.a(x83), .b(new_n225_), .O(new_n243_));
  nor2   g080(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand2  g081(.a(x42), .b(x05), .O(new_n245_));
  nand2  g082(.a(x51), .b(new_n221_), .O(new_n246_));
  oai22  g083(.a(new_n246_), .b(new_n225_), .c(new_n245_), .d(new_n244_), .O(new_n247_));
  nand2  g084(.a(new_n247_), .b(new_n223_), .O(new_n248_));
  xor2a  g085(.a(x83), .b(x81), .O(new_n249_));
  oai22  g086(.a(new_n249_), .b(new_n245_), .c(new_n246_), .d(x81), .O(new_n250_));
  nand2  g087(.a(new_n250_), .b(new_n226_), .O(new_n251_));
  inv1   g088(.a(new_n228_), .O(new_n252_));
  nand2  g089(.a(new_n252_), .b(new_n218_), .O(new_n253_));
  aoi21  g090(.a(new_n251_), .b(new_n248_), .c(new_n253_), .O(z33));
  inv1   g091(.a(x52), .O(new_n255_));
  nand2  g092(.a(x83), .b(x42), .O(new_n256_));
  nand2  g093(.a(new_n256_), .b(new_n225_), .O(new_n257_));
  nand3  g094(.a(x83), .b(x81), .c(x42), .O(new_n258_));
  nand2  g095(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  and2   g096(.a(new_n259_), .b(new_n226_), .O(new_n260_));
  nand2  g097(.a(new_n256_), .b(x81), .O(new_n261_));
  nand2  g098(.a(new_n242_), .b(x42), .O(new_n262_));
  aoi21  g099(.a(new_n262_), .b(new_n261_), .c(new_n222_), .O(new_n263_));
  oai21  g100(.a(new_n263_), .b(new_n260_), .c(new_n252_), .O(new_n264_));
  nor3   g101(.a(new_n264_), .b(new_n219_), .c(new_n255_), .O(z34));
  nand2  g102(.a(new_n218_), .b(x53), .O(new_n266_));
  nor2   g103(.a(new_n266_), .b(new_n264_), .O(z35));
  nand2  g104(.a(new_n218_), .b(x55), .O(new_n269_));
  nor2   g105(.a(new_n269_), .b(new_n264_), .O(z37));
  nand2  g106(.a(new_n218_), .b(x56), .O(new_n271_));
  nor2   g107(.a(new_n271_), .b(new_n264_), .O(z38));
  nor3   g108(.a(new_n264_), .b(new_n219_), .c(new_n192_), .O(z39));
  nor3   g109(.a(new_n264_), .b(new_n219_), .c(new_n189_), .O(z40));
  nor3   g110(.a(new_n264_), .b(new_n219_), .c(new_n186_), .O(z41));
  nor3   g111(.a(new_n264_), .b(new_n219_), .c(new_n183_), .O(z42));
  nor3   g112(.a(new_n264_), .b(new_n219_), .c(new_n180_), .O(z43));
  nor3   g113(.a(new_n264_), .b(new_n219_), .c(new_n177_), .O(z44));
  nor3   g114(.a(new_n264_), .b(new_n219_), .c(new_n174_), .O(z45));
  nor3   g115(.a(new_n264_), .b(new_n219_), .c(new_n171_), .O(z46));
  nand2  g116(.a(x52), .b(x22), .O(new_n288_));
  nand2  g117(.a(new_n255_), .b(x14), .O(new_n289_));
  ...
  nand3  g122(.a(new_n242_), .b(x84), .c(new_n293_), .O(new_n294_));
  ...
  nand4  g130(.a(x84), .b(new_n241_), .c(x82), .d(x81), .O(new_n303_));
