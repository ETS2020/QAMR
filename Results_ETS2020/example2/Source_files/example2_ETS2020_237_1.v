...
module FAU ( 
  ...
  nand2  g101(.a(new_n260_), .b(new_n227_), .O(new_n261_));
  nand3  g102(.a(x83), .b(x81), .c(x42), .O(new_n262_));
  nand2  g103(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  and2   g104(.a(new_n263_), .b(new_n228_), .O(new_n264_));
  nand2  g105(.a(new_n260_), .b(x81), .O(new_n265_));
  nand2  g106(.a(new_n247_), .b(x42), .O(new_n266_));
  aoi21  g107(.a(new_n266_), .b(new_n265_), .c(new_n224_), .O(new_n267_));
  oai21  g108(.a(new_n267_), .b(new_n264_), .c(new_n257_), .O(new_n268_));
  nand2  g109(.a(new_n220_), .b(x52), .O(new_n269_));
  ...
  inv1   g134(.a(x82), .O(new_n303_));
  nand3  g135(.a(new_n247_), .b(x84), .c(new_n303_), .O(new_n304_));
  inv1   g136(.a(x80), .O(new_n305_));
  nand4  g137(.a(new_n220_), .b(new_n163_), .c(new_n305_), .d(x79), .O(new_n306_));
  nor2   g138(.a(new_n306_), .b(new_n304_), .O(z55));
  aoi21  g139(.a(x84), .b(new_n227_), .c(x76), .O(new_n308_));
  oai21  g140(.a(x84), .b(new_n227_), .c(new_n308_), .O(new_n309_));
  nand2  g141(.a(new_n309_), .b(new_n164_), .O(new_n310_));
  nand4  g142(.a(new_n310_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g143(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n313_));
  inv1   g144(.a(x74), .O(new_n314_));
  nand4  g145(.a(x80), .b(new_n314_), .c(x43), .d(new_n223_), .O(new_n315_));
  oai22  g146(.a(new_n315_), .b(new_n313_), .c(new_n223_), .d(x40), .O(new_n316_));
  nand2  g147(.a(x78), .b(x04), .O(new_n317_));
  inv1   g148(.a(new_n317_), .O(new_n318_));
  nand3  g149(.a(new_n318_), .b(new_n316_), .c(x79), .O(new_n319_));
  nand4  g150(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n320_));
  nand2  g151(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  nand2  g152(.a(new_n321_), .b(x77), .O(new_n322_));
  nor2   g153(.a(new_n154_), .b(x77), .O(new_n323_));
  oai21  g154(.a(new_n323_), .b(new_n216_), .c(new_n162_), .O(new_n324_));
  aoi21  g155(.a(new_n324_), .b(new_n322_), .c(x01), .O(z58));
  aoi21  g156(.a(new_n317_), .b(x79), .c(new_n152_), .O(new_n326_));
  nand3  g157(.a(x80), .b(new_n314_), .c(x43), .O(new_n327_));
  oai21  g158(.a(new_n327_), .b(new_n313_), .c(new_n223_), .O(new_n328_));
  aoi21  g159(.a(new_n328_), .b(x79), .c(new_n317_), .O(new_n329_));
  oai21  g160(.a(new_n329_), .b(new_n326_), .c(x77), .O(new_n330_));
  nand2  g161(.a(new_n162_), .b(new_n216_), .O(new_n331_));
  aoi21  g162(.a(new_n331_), .b(new_n330_), .c(x01), .O(z59));
  oai21  g163(.a(new_n323_), .b(new_n293_), .c(new_n291_), .O(new_n334_));
  nand2  g164(.a(new_n163_), .b(new_n216_), .O(new_n335_));
  nand2  g165(.a(new_n335_), .b(new_n334_), .O(new_n336_));
  inv1   g166(.a(new_n336_), .O(new_n337_));
  nor2   g167(.a(new_n162_), .b(x01), .O(new_n338_));
  inv1   g168(.a(new_n338_), .O(new_n339_));
  nor3   g169(.a(new_n339_), .b(new_n337_), .c(new_n305_), .O(z61));
  nand3  g170(.a(x84), .b(x81), .c(x79), .O(new_n341_));
  oai21  g171(.a(x79), .b(new_n216_), .c(new_n341_), .O(new_n342_));
  nand2  g172(.a(new_n342_), .b(new_n160_), .O(new_n343_));
  nand2  g173(.a(new_n328_), .b(x79), .O(new_n344_));
  nand3  g174(.a(x81), .b(x79), .c(new_n216_), .O(new_n345_));
  inv1   g175(.a(new_n345_), .O(new_n346_));
  aoi21  g176(.a(new_n344_), .b(x04), .c(new_n346_), .O(new_n347_));
  oai21  g177(.a(new_n347_), .b(new_n160_), .c(new_n343_), .O(new_n348_));
  nand2  g178(.a(new_n348_), .b(x78), .O(new_n349_));
  inv1   g179(.a(new_n341_), .O(new_n350_));
  nand2  g180(.a(new_n350_), .b(new_n293_), .O(new_n351_));
  aoi21  g181(.a(new_n351_), .b(new_n349_), .c(x01), .O(z62));
  nor3   g182(.a(new_n339_), .b(new_n337_), .c(new_n303_), .O(z63));
  nand3  g183(.a(new_n336_), .b(x83), .c(x79), .O(new_n354_));
  aoi21  g184(.a(new_n354_), .b(new_n288_), .c(x01), .O(z64));
  nor2   g185(.a(new_n154_), .b(x04), .O(new_n356_));
  nor2   g186(.a(new_n227_), .b(x78), .O(new_n357_));
  oai21  g187(.a(new_n357_), .b(new_n356_), .c(x77), .O(new_n358_));
  nand2  g188(.a(new_n323_), .b(x81), .O(new_n359_));
  nand2  g189(.a(new_n338_), .b(x84), .O(new_n360_));
  aoi21  g190(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z65));
  zero   g191(.O(z02));
  zero   g192(.O(z04));
  zero   g193(.O(z15));
  zero   g194(.O(z18));
