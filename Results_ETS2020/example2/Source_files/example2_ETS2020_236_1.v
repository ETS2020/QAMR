// Benchmark "FAU" written by ABC on Sat Jun 27 02:06:47 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n272_, new_n275_, new_n277_, new_n287_, new_n288_,
  ...
  nand2  g112(.a(new_n222_), .b(x53), .O(new_n272_));
  nor2   g113(.a(new_n272_), .b(new_n270_), .O(z35));
  nand2  g114(.a(new_n222_), .b(x55), .O(new_n275_));
  nor2   g115(.a(new_n275_), .b(new_n270_), .O(z37));
  nand2  g116(.a(new_n222_), .b(x56), .O(new_n277_));
  nor2   g117(.a(new_n277_), .b(new_n270_), .O(z38));
  nor3   g118(.a(new_n270_), .b(new_n223_), .c(new_n192_), .O(z39));
  nor3   g119(.a(new_n270_), .b(new_n223_), .c(new_n189_), .O(z40));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n186_), .O(z41));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n183_), .O(z42));
  nor3   g122(.a(new_n270_), .b(new_n223_), .c(new_n180_), .O(z43));
  nor3   g123(.a(new_n270_), .b(new_n223_), .c(new_n177_), .O(z44));
  nor3   g124(.a(new_n270_), .b(new_n223_), .c(new_n174_), .O(z45));
  nor3   g125(.a(new_n270_), .b(new_n223_), .c(new_n171_), .O(z46));
  ...
  nand2  g138(.a(new_n261_), .b(x14), .O(new_n305_));
  ...
  nand3  g143(.a(new_n248_), .b(x84), .c(new_n309_), .O(new_n310_));
  ...
  nand4  g151(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n319_));
