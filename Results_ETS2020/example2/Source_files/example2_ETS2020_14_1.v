...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n272_, new_n276_, new_n280_, new_n294_, new_n295_,
  ...
  nor3   g117(.a(new_n270_), .b(new_n221_), .c(new_n192_), .O(z39));
  nor3   g118(.a(new_n270_), .b(new_n221_), .c(new_n189_), .O(z40));
  nand2  g119(.a(new_n220_), .b(x59), .O(new_n280_));
  nor2   g120(.a(new_n280_), .b(new_n270_), .O(z41));
  nor3   g121(.a(new_n270_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g122(.a(new_n270_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g123(.a(new_n270_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g124(.a(new_n270_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g125(.a(new_n270_), .b(new_n221_), .c(new_n173_), .O(z46));
  nand2  g126(.a(x52), .b(x22), .O(new_n294_));
  nand2  g127(.a(new_n261_), .b(x14), .O(new_n295_));
  ...
  nand3  g132(.a(new_n248_), .b(x84), .c(new_n299_), .O(new_n300_));
  ...
  nand4  g140(.a(x84), .b(new_n247_), .c(x82), .d(x81), .O(new_n309_));
