...
module FAU ( 
  ...
  nor3   g141(.a(new_n285_), .b(new_n238_), .c(new_n180_), .O(z45));
  nor3   g142(.a(new_n285_), .b(new_n238_), .c(new_n177_), .O(z46));
  ...
  nand4  g195(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n167_), .O(new_n354_));
  ...
  nand4  g200(.a(new_n237_), .b(new_n155_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g201(.a(new_n359_), .b(new_n357_), .O(z55));
  inv1   g202(.a(x02), .O(new_n362_));
  nand4  g203(.a(x03), .b(new_n362_), .c(new_n167_), .d(x00), .O(new_n363_));
  ...
  nand4  g208(.a(new_n157_), .b(new_n154_), .c(new_n240_), .d(x40), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  nand2  g210(.a(new_n369_), .b(x77), .O(new_n370_));
  oai21  g211(.a(new_n161_), .b(new_n232_), .c(new_n157_), .O(new_n371_));
  aoi21  g212(.a(new_n371_), .b(new_n370_), .c(x01), .O(z58));
  aoi21  g213(.a(new_n228_), .b(x79), .c(new_n176_), .O(new_n373_));
  oai21  g214(.a(new_n225_), .b(new_n223_), .c(new_n240_), .O(new_n374_));
  aoi21  g215(.a(new_n374_), .b(x79), .c(new_n228_), .O(new_n375_));
  ...
  aoi21  g223(.a(new_n382_), .b(new_n230_), .c(x01), .O(z60));
  oai21  g224(.a(new_n163_), .b(new_n161_), .c(new_n219_), .O(new_n384_));
  nand2  g225(.a(new_n155_), .b(new_n232_), .O(new_n385_));
  nand2  g226(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  inv1   g227(.a(new_n386_), .O(new_n387_));
  nor3   g228(.a(new_n387_), .b(new_n168_), .c(new_n358_), .O(z61));
  nand3  g229(.a(x84), .b(x81), .c(x79), .O(new_n389_));
  oai21  g230(.a(x79), .b(new_n232_), .c(new_n389_), .O(new_n390_));
  nand2  g231(.a(new_n390_), .b(new_n153_), .O(new_n391_));
  nand2  g232(.a(new_n374_), .b(x79), .O(new_n392_));
  nand3  g233(.a(x81), .b(x79), .c(new_n232_), .O(new_n393_));
  ...
  nor3   g241(.a(new_n387_), .b(new_n168_), .c(new_n356_), .O(z63));
  nand3  g242(.a(new_n386_), .b(x83), .c(x79), .O(new_n402_));
  aoi21  g243(.a(new_n402_), .b(new_n306_), .c(x01), .O(z64));
  zero   g244(.O(z00));
  zero   g245(.O(z14));
  zero   g246(.O(z16));
  zero   g247(.O(z18));
