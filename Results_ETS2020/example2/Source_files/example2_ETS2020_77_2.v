// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:00 2020
...
module FAU ( 
  ...
  nor2   g158(.a(new_n154_), .b(x04), .O(new_n343_));
  nor2   g159(.a(new_n217_), .b(x78), .O(new_n344_));
  oai21  g160(.a(new_n344_), .b(new_n343_), .c(x77), .O(new_n345_));
  nand3  g161(.a(x81), .b(x78), .c(new_n153_), .O(new_n346_));
  nand2  g162(.a(new_n166_), .b(x84), .O(new_n347_));
  aoi21  g163(.a(new_n346_), .b(new_n345_), .c(new_n347_), .O(z65));
  zero   g164(.O(z00));
  zero   g165(.O(z03));
  zero   g166(.O(z05));
  zero   g167(.O(z06));
