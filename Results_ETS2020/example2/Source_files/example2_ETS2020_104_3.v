...
module FAU ( 
  ...
  nand2  g132(.a(new_n234_), .b(x56), .O(new_n290_));
  nor2   g133(.a(new_n290_), .b(new_n282_), .O(z38));
  nor3   g134(.a(new_n282_), .b(new_n235_), .c(new_n195_), .O(z39));
  nor3   g135(.a(new_n282_), .b(new_n235_), .c(new_n192_), .O(z40));
  nor3   g136(.a(new_n282_), .b(new_n235_), .c(new_n189_), .O(z41));
  nor3   g137(.a(new_n282_), .b(new_n235_), .c(new_n186_), .O(z42));
  nor3   g138(.a(new_n282_), .b(new_n235_), .c(new_n183_), .O(z43));
  nor3   g139(.a(new_n282_), .b(new_n235_), .c(new_n180_), .O(z44));
  nor3   g140(.a(new_n282_), .b(new_n235_), .c(new_n177_), .O(z45));
  nor3   g141(.a(new_n282_), .b(new_n235_), .c(new_n174_), .O(z46));
  ...
  nand2  g193(.a(new_n273_), .b(x14), .O(new_n351_));
  ...
  nand3  g197(.a(new_n260_), .b(x84), .c(new_n354_), .O(new_n355_));
