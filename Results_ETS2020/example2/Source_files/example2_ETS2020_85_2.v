...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n233_, new_n234_, new_n237_, new_n241_,
  ...
  nand4  g074(.a(new_n233_), .b(new_n232_), .c(x48), .d(new_n225_), .O(new_n241_));
  inv1   g075(.a(new_n241_), .O(z30));
  nand4  g076(.a(new_n233_), .b(new_n232_), .c(x49), .d(new_n225_), .O(new_n243_));
  inv1   g077(.a(new_n243_), .O(z31));
  nand4  g078(.a(new_n233_), .b(new_n232_), .c(x50), .d(new_n225_), .O(new_n245_));
  inv1   g079(.a(new_n245_), .O(z32));
  inv1   g080(.a(new_n162_), .O(new_n249_));
  nand2  g081(.a(x83), .b(x42), .O(new_n250_));
  nand2  g082(.a(new_n250_), .b(new_n226_), .O(new_n251_));
  inv1   g083(.a(new_n250_), .O(new_n252_));
  nand2  g084(.a(new_n252_), .b(x81), .O(new_n253_));
  aoi21  g085(.a(new_n253_), .b(new_n251_), .c(new_n229_), .O(new_n254_));
  nand2  g086(.a(new_n250_), .b(x81), .O(new_n255_));
  nand2  g087(.a(new_n252_), .b(new_n226_), .O(new_n256_));
  aoi21  g088(.a(new_n256_), .b(new_n255_), .c(new_n227_), .O(new_n257_));
  oai21  g089(.a(new_n257_), .b(new_n254_), .c(new_n249_), .O(new_n258_));
  nand2  g090(.a(new_n233_), .b(x53), .O(new_n259_));
  nor2   g091(.a(new_n259_), .b(new_n258_), .O(z35));
  nand2  g092(.a(new_n233_), .b(x54), .O(new_n261_));
  ...
  nand3  g140(.a(new_n318_), .b(new_n233_), .c(new_n161_), .O(new_n319_));
  ...
  oai21  g154(.a(new_n215_), .b(new_n213_), .c(new_n225_), .O(new_n334_));
