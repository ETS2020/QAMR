// Benchmark "FAU" written by ABC on Sat Jun 27 01:57:17 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n190_, new_n191_, new_n194_, new_n195_, new_n199_, new_n200_,
  ...
  inv1   g028(.a(x28), .O(new_n184_));
  nand2  g029(.a(x60), .b(x40), .O(new_n185_));
  oai21  g030(.a(x40), .b(new_n184_), .c(new_n185_), .O(z10));
  inv1   g031(.a(x32), .O(new_n190_));
  nand2  g032(.a(x51), .b(x40), .O(new_n191_));
  oai21  g033(.a(x40), .b(new_n190_), .c(new_n191_), .O(z14));
  inv1   g034(.a(x34), .O(new_n194_));
  nand2  g035(.a(x49), .b(x40), .O(new_n195_));
  oai21  g036(.a(x40), .b(new_n194_), .c(new_n195_), .O(z16));
  ...
  inv1   g099(.a(x07), .O(new_n275_));
  nand2  g100(.a(x52), .b(x15), .O(new_n276_));
  oai21  g101(.a(x52), .b(new_n275_), .c(new_n276_), .O(new_n277_));
  nor2   g102(.a(x79), .b(x77), .O(new_n278_));
  nand2  g103(.a(new_n278_), .b(new_n218_), .O(new_n279_));
  inv1   g104(.a(new_n279_), .O(new_n280_));
  nand2  g105(.a(new_n280_), .b(new_n277_), .O(new_n281_));
  nor2   g106(.a(x75), .b(x67), .O(new_n282_));
  nand3  g107(.a(x79), .b(new_n160_), .c(x77), .O(new_n283_));
  nor2   g108(.a(new_n283_), .b(new_n282_), .O(new_n284_));
  nand2  g109(.a(new_n284_), .b(new_n207_), .O(new_n285_));
  aoi21  g110(.a(new_n285_), .b(new_n281_), .c(x01), .O(z47));
  inv1   g111(.a(x08), .O(new_n287_));
  nand2  g112(.a(x52), .b(x16), .O(new_n288_));
  oai21  g113(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand2  g114(.a(new_n289_), .b(new_n280_), .O(new_n290_));
  ...
  nand2  g121(.a(new_n296_), .b(new_n280_), .O(new_n297_));
  ...
  nand2  g127(.a(new_n302_), .b(new_n280_), .O(new_n303_));
  ...
  nand2  g133(.a(new_n308_), .b(new_n280_), .O(new_n309_));
  ...
  nand2  g139(.a(new_n314_), .b(new_n280_), .O(new_n315_));
  ...
  nand2  g145(.a(new_n320_), .b(new_n280_), .O(new_n321_));
  ...
  nand3  g150(.a(new_n326_), .b(new_n231_), .c(new_n161_), .O(new_n327_));
  nor4   g151(.a(new_n327_), .b(new_n325_), .c(x82), .d(x81), .O(z55));
  inv1   g152(.a(new_n161_), .O(new_n329_));
  xnor2a g153(.a(x84), .b(x81), .O(new_n330_));
  aoi21  g154(.a(new_n169_), .b(new_n168_), .c(new_n330_), .O(new_n331_));
  aoi22  g155(.a(new_n331_), .b(new_n153_), .c(new_n329_), .d(x76), .O(new_n332_));
  inv1   g156(.a(x00), .O(new_n333_));
  nor3   g157(.a(new_n163_), .b(x01), .c(new_n333_), .O(new_n334_));
  oai21  g158(.a(new_n332_), .b(new_n154_), .c(new_n334_), .O(z56));
  inv1   g159(.a(x02), .O(new_n336_));
  nand4  g160(.a(x03), .b(new_n336_), .c(new_n153_), .d(x00), .O(new_n337_));
  inv1   g161(.a(new_n337_), .O(z57));
  nand2  g162(.a(new_n154_), .b(new_n160_), .O(new_n340_));
  aoi21  g163(.a(new_n217_), .b(new_n340_), .c(new_n152_), .O(new_n341_));
  oai21  g164(.a(new_n213_), .b(new_n211_), .c(new_n223_), .O(new_n342_));
  aoi21  g165(.a(new_n342_), .b(x79), .c(new_n217_), .O(new_n343_));
  oai21  g166(.a(new_n343_), .b(new_n341_), .c(x77), .O(new_n344_));
  nor2   g167(.a(x79), .b(x04), .O(new_n345_));
  inv1   g168(.a(new_n345_), .O(new_n346_));
  aoi21  g169(.a(new_n346_), .b(new_n344_), .c(x01), .O(z59));
  aoi21  g170(.a(new_n331_), .b(x79), .c(new_n345_), .O(new_n348_));
  aoi21  g171(.a(new_n348_), .b(new_n219_), .c(x01), .O(z60));
  aoi21  g172(.a(new_n169_), .b(new_n168_), .c(new_n206_), .O(new_n353_));
  nor2   g173(.a(new_n329_), .b(x04), .O(new_n354_));
  nor2   g174(.a(new_n210_), .b(new_n154_), .O(new_n355_));
  oai21  g175(.a(new_n354_), .b(new_n353_), .c(new_n355_), .O(new_n356_));
  aoi21  g176(.a(new_n356_), .b(new_n279_), .c(x01), .O(z64));
  nor2   g177(.a(new_n160_), .b(x04), .O(new_n358_));
  nor2   g178(.a(new_n224_), .b(x78), .O(new_n359_));
  oai21  g179(.a(new_n359_), .b(new_n358_), .c(x77), .O(new_n360_));
  nand3  g180(.a(x81), .b(x78), .c(new_n159_), .O(new_n361_));
  nand2  g181(.a(new_n171_), .b(x84), .O(new_n362_));
  aoi21  g182(.a(new_n361_), .b(new_n360_), .c(new_n362_), .O(z65));
  zero   g183(.O(z03));
  zero   g184(.O(z06));
  zero   g185(.O(z08));
  zero   g186(.O(z09));
