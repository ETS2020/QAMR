...
module FAU ( 
  ...
  nor3   g134(.a(new_n284_), .b(new_n238_), .c(new_n196_), .O(z39));
  nor3   g135(.a(new_n284_), .b(new_n238_), .c(new_n193_), .O(z40));
  nor3   g136(.a(new_n284_), .b(new_n238_), .c(new_n190_), .O(z41));
  nor3   g137(.a(new_n284_), .b(new_n238_), .c(new_n187_), .O(z42));
  nor3   g138(.a(new_n284_), .b(new_n238_), .c(new_n184_), .O(z43));
  nor3   g139(.a(new_n284_), .b(new_n238_), .c(new_n181_), .O(z44));
  nor3   g140(.a(new_n284_), .b(new_n238_), .c(new_n178_), .O(z45));
  nor3   g141(.a(new_n284_), .b(new_n238_), .c(new_n175_), .O(z46));
  ...
  aoi21  g212(.a(new_n228_), .b(x79), .c(new_n174_), .O(new_n372_));
