...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n205_, new_n208_, new_n209_, new_n214_, new_n215_, new_n217_,
    new_n218_, new_n219_, new_n221_, new_n222_, new_n223_, new_n224_,
    new_n225_, new_n226_, new_n227_, new_n228_, new_n229_, new_n230_,
    new_n232_, new_n236_, new_n240_, new_n242_, new_n243_, new_n244_,
    new_n245_, new_n246_, new_n247_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n256_, new_n257_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n268_, new_n270_, new_n288_, new_n289_,
  ...
  nand4  g077(.a(new_n229_), .b(new_n218_), .c(x50), .d(new_n221_), .O(new_n240_));
  inv1   g078(.a(new_n240_), .O(z32));
  ...
  nand2  g094(.a(x83), .b(x42), .O(new_n257_));
  nand2  g095(.a(new_n257_), .b(new_n225_), .O(new_n258_));
  nand3  g096(.a(x83), .b(x81), .c(x42), .O(new_n259_));
  nand2  g097(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  and2   g098(.a(new_n260_), .b(new_n226_), .O(new_n261_));
  nand2  g099(.a(new_n257_), .b(x81), .O(new_n262_));
  nand2  g100(.a(new_n243_), .b(x42), .O(new_n263_));
  aoi21  g101(.a(new_n263_), .b(new_n262_), .c(new_n222_), .O(new_n264_));
  oai21  g102(.a(new_n264_), .b(new_n261_), .c(new_n253_), .O(new_n265_));
  nor3   g103(.a(new_n265_), .b(new_n219_), .c(new_n256_), .O(z34));
  nand2  g104(.a(new_n218_), .b(x54), .O(new_n268_));
  nor2   g105(.a(new_n268_), .b(new_n265_), .O(z36));
  nand2  g106(.a(new_n218_), .b(x55), .O(new_n270_));
  nor2   g107(.a(new_n270_), .b(new_n265_), .O(z37));
  nor3   g108(.a(new_n265_), .b(new_n219_), .c(new_n194_), .O(z39));
  nor3   g109(.a(new_n265_), .b(new_n219_), .c(new_n191_), .O(z40));
  nor3   g110(.a(new_n265_), .b(new_n219_), .c(new_n188_), .O(z41));
  nor3   g111(.a(new_n265_), .b(new_n219_), .c(new_n185_), .O(z42));
  nor3   g112(.a(new_n265_), .b(new_n219_), .c(new_n182_), .O(z43));
  nor3   g113(.a(new_n265_), .b(new_n219_), .c(new_n179_), .O(z44));
  nor3   g114(.a(new_n265_), .b(new_n219_), .c(new_n176_), .O(z45));
  nor3   g115(.a(new_n265_), .b(new_n219_), .c(new_n173_), .O(z46));
  nand2  g116(.a(x52), .b(x22), .O(new_n288_));
  nand2  g117(.a(new_n256_), .b(x14), .O(new_n289_));
  ...
  nand3  g122(.a(new_n243_), .b(x84), .c(new_n293_), .O(new_n294_));
  ...
  nand4  g130(.a(x84), .b(new_n242_), .c(x82), .d(x81), .O(new_n303_));
