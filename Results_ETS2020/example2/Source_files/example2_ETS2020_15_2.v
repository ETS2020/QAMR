...
module FAU ( 
  ...
  nand2  g099(.a(new_n231_), .b(x56), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n259_), .O(z38));
  inv1   g101(.a(x08), .O(new_n277_));
  nand2  g102(.a(x52), .b(x16), .O(new_n278_));
  oai21  g103(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  nor2   g104(.a(x79), .b(x77), .O(new_n280_));
  nand2  g105(.a(new_n280_), .b(new_n218_), .O(new_n281_));
  inv1   g106(.a(new_n281_), .O(new_n282_));
  nand2  g107(.a(new_n282_), .b(new_n279_), .O(new_n283_));
  nor3   g108(.a(new_n206_), .b(new_n169_), .c(new_n154_), .O(new_n284_));
  ...
  nor2   g142(.a(x80), .b(new_n154_), .O(new_n319_));
  nand3  g143(.a(new_n319_), .b(new_n231_), .c(new_n161_), .O(new_n320_));
  nor4   g144(.a(new_n320_), .b(new_n318_), .c(x82), .d(x81), .O(z55));
  inv1   g145(.a(new_n161_), .O(new_n322_));
  xnor2a g146(.a(x84), .b(x81), .O(new_n323_));
  aoi21  g147(.a(new_n169_), .b(new_n168_), .c(new_n323_), .O(new_n324_));
  aoi22  g148(.a(new_n324_), .b(new_n153_), .c(new_n322_), .d(x76), .O(new_n325_));
  inv1   g149(.a(x00), .O(new_n326_));
  nor3   g150(.a(new_n163_), .b(x01), .c(new_n326_), .O(new_n327_));
  oai21  g151(.a(new_n325_), .b(new_n154_), .c(new_n327_), .O(z56));
  inv1   g152(.a(x02), .O(new_n329_));
  nand4  g153(.a(x03), .b(new_n329_), .c(new_n153_), .d(x00), .O(new_n330_));
  inv1   g154(.a(new_n330_), .O(z57));
  nand2  g155(.a(new_n154_), .b(new_n160_), .O(new_n333_));
  aoi21  g156(.a(new_n217_), .b(new_n333_), .c(new_n152_), .O(new_n334_));
  oai21  g157(.a(new_n213_), .b(new_n211_), .c(new_n223_), .O(new_n335_));
  aoi21  g158(.a(new_n335_), .b(x79), .c(new_n217_), .O(new_n336_));
  oai21  g159(.a(new_n336_), .b(new_n334_), .c(x77), .O(new_n337_));
  nor2   g160(.a(x79), .b(x04), .O(new_n338_));
  inv1   g161(.a(new_n338_), .O(new_n339_));
  aoi21  g162(.a(new_n339_), .b(new_n337_), .c(x01), .O(z59));
  aoi21  g163(.a(new_n324_), .b(x79), .c(new_n338_), .O(new_n341_));
  aoi21  g164(.a(new_n341_), .b(new_n219_), .c(x01), .O(z60));
  aoi21  g165(.a(new_n169_), .b(new_n168_), .c(new_n206_), .O(new_n346_));
  nor2   g166(.a(new_n322_), .b(x04), .O(new_n347_));
  nor2   g167(.a(new_n210_), .b(new_n154_), .O(new_n348_));
  oai21  g168(.a(new_n347_), .b(new_n346_), .c(new_n348_), .O(new_n349_));
  aoi21  g169(.a(new_n349_), .b(new_n281_), .c(x01), .O(z64));
  zero   g170(.O(z03));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
  zero   g173(.O(z08));
