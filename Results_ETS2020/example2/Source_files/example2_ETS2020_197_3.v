...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n243_, new_n246_, new_n248_, new_n251_, new_n253_, new_n255_,
  ...
  aoi21  g084(.a(new_n241_), .b(new_n238_), .c(new_n156_), .O(new_n242_));
  ...
  nand4  g089(.a(new_n242_), .b(new_n232_), .c(x46), .d(new_n235_), .O(new_n248_));
  inv1   g090(.a(new_n248_), .O(z28));
  nand4  g091(.a(new_n242_), .b(new_n232_), .c(x48), .d(new_n235_), .O(new_n251_));
  inv1   g092(.a(new_n251_), .O(z30));
  nand4  g093(.a(new_n242_), .b(new_n232_), .c(x49), .d(new_n235_), .O(new_n253_));
  inv1   g094(.a(new_n253_), .O(z31));
  nand4  g095(.a(new_n242_), .b(new_n232_), .c(x50), .d(new_n235_), .O(new_n255_));
  inv1   g096(.a(new_n255_), .O(z32));
  nor2   g097(.a(new_n217_), .b(x81), .O(new_n257_));
  nor2   g098(.a(x83), .b(new_n239_), .O(new_n258_));
  nor2   g099(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g100(.a(x42), .b(x05), .O(new_n260_));
  nand2  g101(.a(x51), .b(new_n235_), .O(new_n261_));
  oai22  g102(.a(new_n261_), .b(new_n239_), .c(new_n260_), .d(new_n259_), .O(new_n262_));
  nand2  g103(.a(new_n262_), .b(new_n237_), .O(new_n263_));
  ...
  nand4  g197(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n359_));
  oai22  g198(.a(new_n359_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n360_));
  nand3  g199(.a(new_n360_), .b(new_n224_), .c(x79), .O(new_n361_));
  nand4  g200(.a(new_n157_), .b(new_n154_), .c(new_n235_), .d(x40), .O(new_n362_));
  ...
  oai21  g206(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n368_));
  ...
  nor2   g238(.a(new_n239_), .b(x78), .O(new_n400_));
