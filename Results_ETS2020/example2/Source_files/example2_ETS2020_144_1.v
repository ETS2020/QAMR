...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n275_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nor3   g114(.a(new_n270_), .b(new_n223_), .c(new_n194_), .O(z39));
  nor3   g115(.a(new_n270_), .b(new_n223_), .c(new_n191_), .O(z40));
  nor3   g116(.a(new_n270_), .b(new_n223_), .c(new_n188_), .O(z41));
  nor3   g117(.a(new_n270_), .b(new_n223_), .c(new_n185_), .O(z42));
  nor3   g118(.a(new_n270_), .b(new_n223_), .c(new_n182_), .O(z43));
  nor3   g119(.a(new_n270_), .b(new_n223_), .c(new_n179_), .O(z44));
  nor3   g120(.a(new_n270_), .b(new_n223_), .c(new_n176_), .O(z45));
  nor3   g121(.a(new_n270_), .b(new_n223_), .c(new_n173_), .O(z46));
