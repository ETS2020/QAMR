// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:48 2020
...
module FAU ( 
  ...
  nand4  g064(.a(new_n225_), .b(new_n224_), .c(x46), .d(new_n217_), .O(new_n232_));
  inv1   g065(.a(new_n232_), .O(z28));
  nand4  g066(.a(new_n225_), .b(new_n224_), .c(x47), .d(new_n217_), .O(new_n234_));
  inv1   g067(.a(new_n234_), .O(z29));
  nand4  g068(.a(new_n225_), .b(new_n224_), .c(x48), .d(new_n217_), .O(new_n236_));
  inv1   g069(.a(new_n236_), .O(z30));
  nand4  g070(.a(new_n225_), .b(new_n224_), .c(x49), .d(new_n217_), .O(new_n238_));
  inv1   g071(.a(new_n238_), .O(z31));
  nand4  g072(.a(new_n225_), .b(new_n224_), .c(x50), .d(new_n217_), .O(new_n240_));
  inv1   g073(.a(new_n240_), .O(z32));
  inv1   g074(.a(new_n162_), .O(new_n244_));
  nand2  g075(.a(x83), .b(x42), .O(new_n245_));
  nand2  g076(.a(new_n245_), .b(new_n218_), .O(new_n246_));
  inv1   g077(.a(new_n245_), .O(new_n247_));
  nand2  g078(.a(new_n247_), .b(x81), .O(new_n248_));
  aoi21  g079(.a(new_n248_), .b(new_n246_), .c(new_n221_), .O(new_n249_));
  nand2  g080(.a(new_n245_), .b(x81), .O(new_n250_));
  nand2  g081(.a(new_n247_), .b(new_n218_), .O(new_n251_));
  aoi21  g082(.a(new_n251_), .b(new_n250_), .c(new_n219_), .O(new_n252_));
  oai21  g083(.a(new_n252_), .b(new_n249_), .c(new_n244_), .O(new_n253_));
  nand2  g084(.a(new_n225_), .b(x53), .O(new_n254_));
  nor2   g085(.a(new_n254_), .b(new_n253_), .O(z35));
  nand2  g086(.a(new_n225_), .b(x55), .O(new_n257_));
  nor2   g087(.a(new_n257_), .b(new_n253_), .O(z37));
  nand2  g088(.a(new_n225_), .b(x56), .O(new_n259_));
  nor2   g089(.a(new_n259_), .b(new_n253_), .O(z38));
  ...
  nand2  g094(.a(new_n273_), .b(new_n212_), .O(new_n274_));
  inv1   g095(.a(new_n274_), .O(new_n275_));
  nand2  g096(.a(new_n275_), .b(new_n272_), .O(new_n276_));
  nor3   g097(.a(new_n200_), .b(new_n169_), .c(new_n154_), .O(new_n277_));
  ...
  nand3  g132(.a(new_n312_), .b(new_n225_), .c(new_n161_), .O(new_n313_));
  nor4   g133(.a(new_n313_), .b(new_n311_), .c(x82), .d(x81), .O(z55));
  inv1   g134(.a(new_n161_), .O(new_n315_));
  xnor2a g135(.a(x84), .b(x81), .O(new_n316_));
  aoi21  g136(.a(new_n169_), .b(new_n168_), .c(new_n316_), .O(new_n317_));
  aoi22  g137(.a(new_n317_), .b(new_n153_), .c(new_n315_), .d(x76), .O(new_n318_));
  inv1   g138(.a(x00), .O(new_n319_));
  nor3   g139(.a(new_n163_), .b(x01), .c(new_n319_), .O(new_n320_));
  oai21  g140(.a(new_n318_), .b(new_n154_), .c(new_n320_), .O(z56));
  inv1   g141(.a(x02), .O(new_n322_));
  nand4  g142(.a(x03), .b(new_n322_), .c(new_n153_), .d(x00), .O(new_n323_));
  inv1   g143(.a(new_n323_), .O(z57));
  nand2  g144(.a(new_n154_), .b(new_n160_), .O(new_n326_));
  aoi21  g145(.a(new_n211_), .b(new_n326_), .c(new_n152_), .O(new_n327_));
  oai21  g146(.a(new_n207_), .b(new_n205_), .c(new_n217_), .O(new_n328_));
  aoi21  g147(.a(new_n328_), .b(x79), .c(new_n211_), .O(new_n329_));
  ...
  aoi21  g153(.a(new_n334_), .b(new_n213_), .c(x01), .O(z60));
  aoi21  g154(.a(new_n169_), .b(new_n168_), .c(new_n200_), .O(new_n339_));
  nor2   g155(.a(new_n315_), .b(x04), .O(new_n340_));
  nor2   g156(.a(new_n204_), .b(new_n154_), .O(new_n341_));
  oai21  g157(.a(new_n340_), .b(new_n339_), .c(new_n341_), .O(new_n342_));
  aoi21  g158(.a(new_n342_), .b(new_n274_), .c(x01), .O(z64));
  zero   g159(.O(z03));
  zero   g160(.O(z05));
  zero   g161(.O(z06));
  zero   g162(.O(z07));
