// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:12 2020
...
module FAU ( 
  ...
  nor2   g135(.a(new_n292_), .b(new_n289_), .O(z36));
  nand2  g136(.a(new_n244_), .b(x56), .O(new_n295_));
  nor2   g137(.a(new_n295_), .b(new_n289_), .O(z38));
  nor3   g138(.a(new_n289_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g139(.a(new_n289_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g140(.a(new_n289_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g141(.a(new_n289_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g142(.a(new_n289_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g143(.a(new_n289_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g144(.a(new_n289_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g145(.a(new_n289_), .b(new_n245_), .c(new_n176_), .O(z46));
  ...
  nand2  g195(.a(new_n281_), .b(x14), .O(new_n354_));
