...
module FAU ( 
  ...
  nor3   g135(.a(new_n283_), .b(new_n237_), .c(new_n197_), .O(z39));
  nor3   g136(.a(new_n283_), .b(new_n237_), .c(new_n191_), .O(z41));
  nor3   g137(.a(new_n283_), .b(new_n237_), .c(new_n188_), .O(z42));
  nor3   g138(.a(new_n283_), .b(new_n237_), .c(new_n185_), .O(z43));
  nor3   g139(.a(new_n283_), .b(new_n237_), .c(new_n182_), .O(z44));
  nor3   g140(.a(new_n283_), .b(new_n237_), .c(new_n179_), .O(z45));
  nor3   g141(.a(new_n283_), .b(new_n237_), .c(new_n176_), .O(z46));
  ...
  nand4  g204(.a(x80), .b(new_n223_), .c(x43), .d(new_n240_), .O(new_n364_));
  oai22  g205(.a(new_n364_), .b(new_n222_), .c(new_n240_), .d(x40), .O(new_n365_));
  nand3  g206(.a(new_n365_), .b(new_n228_), .c(x79), .O(new_n366_));
  nand4  g207(.a(new_n157_), .b(new_n154_), .c(new_n240_), .d(x40), .O(new_n367_));
  ...
  oai21  g213(.a(new_n224_), .b(new_n222_), .c(new_n240_), .O(new_n373_));
  ...
  nor2   g245(.a(new_n244_), .b(x78), .O(new_n405_));
