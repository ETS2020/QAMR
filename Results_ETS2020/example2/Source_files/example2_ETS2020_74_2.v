// Benchmark "FAU" written by ABC on Sat Jun 27 01:54:47 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n216_, new_n217_, new_n222_, new_n223_, new_n224_, new_n225_,
    ...
    new_n344_, new_n349_, new_n350_, new_n351_, new_n352_, new_n354_,
  ...
  nor2   g062(.a(new_n228_), .b(new_n162_), .O(new_n229_));
  nor2   g063(.a(x04), .b(x01), .O(new_n230_));
  nand4  g064(.a(new_n230_), .b(new_n229_), .c(x44), .d(new_n222_), .O(new_n231_));
  inv1   g065(.a(new_n231_), .O(z26));
  nand4  g066(.a(new_n230_), .b(new_n229_), .c(x45), .d(new_n222_), .O(new_n233_));
  inv1   g067(.a(new_n233_), .O(z27));
  nand4  g068(.a(new_n230_), .b(new_n229_), .c(x46), .d(new_n222_), .O(new_n235_));
  inv1   g069(.a(new_n235_), .O(z28));
  nand4  g070(.a(new_n230_), .b(new_n229_), .c(x47), .d(new_n222_), .O(new_n237_));
  ...
  nor2   g091(.a(new_n260_), .b(new_n256_), .O(z37));
  ...
  nand3  g143(.a(new_n322_), .b(new_n230_), .c(new_n161_), .O(new_n323_));
  ...
  oai21  g157(.a(new_n211_), .b(new_n209_), .c(new_n222_), .O(new_n338_));
  ...
  nor2   g170(.a(new_n160_), .b(x04), .O(new_n354_));
  nor2   g171(.a(new_n223_), .b(x78), .O(new_n355_));
  oai21  g172(.a(new_n355_), .b(new_n354_), .c(x77), .O(new_n356_));
  nand3  g173(.a(x81), .b(x78), .c(new_n159_), .O(new_n357_));
  nand2  g174(.a(new_n171_), .b(x84), .O(new_n358_));
  aoi21  g175(.a(new_n357_), .b(new_n356_), .c(new_n358_), .O(z65));
  zero   g176(.O(z03));
  zero   g177(.O(z06));
  zero   g178(.O(z07));
  zero   g179(.O(z08));
