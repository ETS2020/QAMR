...
module FAU ( 
  ...
  nor3   g118(.a(new_n269_), .b(new_n223_), .c(new_n180_), .O(z43));
  nor3   g119(.a(new_n269_), .b(new_n223_), .c(new_n177_), .O(z44));
  nor3   g120(.a(new_n269_), .b(new_n223_), .c(new_n174_), .O(z45));
  nor3   g121(.a(new_n269_), .b(new_n223_), .c(new_n171_), .O(z46));
