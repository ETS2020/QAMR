// Benchmark "FAU" written by ABC on Sat Jun 27 01:53:20 2020
...
module FAU ( 
  ...
  nand2  g135(.a(new_n238_), .b(x56), .O(new_n293_));
  nor2   g136(.a(new_n293_), .b(new_n285_), .O(z38));
  nor3   g137(.a(new_n285_), .b(new_n239_), .c(new_n199_), .O(z39));
  nor3   g138(.a(new_n285_), .b(new_n239_), .c(new_n196_), .O(z40));
  nor3   g139(.a(new_n285_), .b(new_n239_), .c(new_n193_), .O(z41));
  nor3   g140(.a(new_n285_), .b(new_n239_), .c(new_n190_), .O(z42));
  nor3   g141(.a(new_n285_), .b(new_n239_), .c(new_n187_), .O(z43));
  nor3   g142(.a(new_n285_), .b(new_n239_), .c(new_n184_), .O(z44));
  nor3   g143(.a(new_n285_), .b(new_n239_), .c(new_n181_), .O(z45));
  nor3   g144(.a(new_n285_), .b(new_n239_), .c(new_n178_), .O(z46));
