// Benchmark "FAU" written by ABC on Sat Jun 27 01:57:40 2020
...
module FAU ( 
  ...
  inv1   g084(.a(new_n155_), .O(new_n238_));
  inv1   g085(.a(x43), .O(new_n239_));
  nor2   g086(.a(x04), .b(x01), .O(new_n240_));
  nand3  g087(.a(new_n240_), .b(new_n239_), .c(x05), .O(new_n241_));
  aoi21  g088(.a(new_n238_), .b(x79), .c(new_n241_), .O(z24));
  ...
  aoi21  g096(.a(new_n251_), .b(new_n248_), .c(new_n156_), .O(new_n252_));
  nand4  g097(.a(new_n252_), .b(new_n240_), .c(x45), .d(new_n245_), .O(new_n253_));
  inv1   g098(.a(new_n253_), .O(z27));
  nand4  g099(.a(new_n252_), .b(new_n240_), .c(x46), .d(new_n245_), .O(new_n255_));
  inv1   g100(.a(new_n255_), .O(z28));
  nand4  g101(.a(new_n252_), .b(new_n240_), .c(x47), .d(new_n245_), .O(new_n257_));
  inv1   g102(.a(new_n257_), .O(z29));
  nand4  g103(.a(new_n252_), .b(new_n240_), .c(x48), .d(new_n245_), .O(new_n259_));
  inv1   g104(.a(new_n259_), .O(z30));
  nand4  g105(.a(new_n252_), .b(new_n240_), .c(x49), .d(new_n245_), .O(new_n261_));
  inv1   g106(.a(new_n261_), .O(z31));
  nand4  g107(.a(new_n252_), .b(new_n240_), .c(x50), .d(new_n245_), .O(new_n263_));
  inv1   g108(.a(new_n263_), .O(z32));
  nor2   g109(.a(new_n225_), .b(x81), .O(new_n265_));
  nor2   g110(.a(x83), .b(new_n249_), .O(new_n266_));
  nor2   g111(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  nand2  g112(.a(x42), .b(x05), .O(new_n268_));
  nand2  g113(.a(x51), .b(new_n245_), .O(new_n269_));
  oai22  g114(.a(new_n269_), .b(new_n249_), .c(new_n268_), .d(new_n267_), .O(new_n270_));
  nand2  g115(.a(new_n270_), .b(new_n247_), .O(new_n271_));
  xor2a  g116(.a(x83), .b(x81), .O(new_n272_));
  oai22  g117(.a(new_n272_), .b(new_n268_), .c(new_n269_), .d(x81), .O(new_n273_));
  nand2  g118(.a(new_n273_), .b(new_n250_), .O(new_n274_));
  ...
  nor3   g140(.a(new_n288_), .b(new_n279_), .c(new_n197_), .O(z39));
  nor3   g141(.a(new_n288_), .b(new_n279_), .c(new_n194_), .O(z40));
  nor3   g142(.a(new_n288_), .b(new_n279_), .c(new_n191_), .O(z41));
  nor3   g143(.a(new_n288_), .b(new_n279_), .c(new_n188_), .O(z42));
  nor3   g144(.a(new_n288_), .b(new_n279_), .c(new_n185_), .O(z43));
  nor3   g145(.a(new_n288_), .b(new_n279_), .c(new_n182_), .O(z44));
  nor3   g146(.a(new_n288_), .b(new_n279_), .c(new_n179_), .O(z45));
  nor3   g147(.a(new_n288_), .b(new_n279_), .c(new_n176_), .O(z46));
  ...
  nand2  g152(.a(new_n308_), .b(new_n232_), .O(new_n309_));
  inv1   g153(.a(new_n309_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n307_), .O(new_n311_));
  inv1   g155(.a(x67), .O(new_n312_));
  nand2  g156(.a(new_n163_), .b(x79), .O(new_n313_));
  aoi21  g157(.a(new_n160_), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand2  g158(.a(new_n314_), .b(new_n222_), .O(new_n315_));
  ...
  inv1   g164(.a(new_n222_), .O(new_n321_));
  ...
  nand4  g200(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n168_), .O(new_n357_));
  ...
  nor2   g204(.a(x80), .b(new_n157_), .O(new_n361_));
  nand3  g205(.a(new_n361_), .b(new_n240_), .c(new_n155_), .O(new_n362_));
  nor2   g206(.a(new_n362_), .b(new_n360_), .O(z55));
  inv1   g207(.a(x02), .O(new_n365_));
  nand4  g208(.a(x03), .b(new_n365_), .c(new_n168_), .d(x00), .O(new_n366_));
  inv1   g209(.a(new_n366_), .O(z57));
  nand4  g210(.a(x80), .b(new_n227_), .c(x43), .d(new_n245_), .O(new_n368_));
  oai22  g211(.a(new_n368_), .b(new_n226_), .c(new_n245_), .d(x40), .O(new_n369_));
  nand3  g212(.a(new_n369_), .b(new_n232_), .c(x79), .O(new_n370_));
  nand4  g213(.a(new_n157_), .b(new_n154_), .c(new_n245_), .d(x40), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(x77), .O(new_n373_));
  oai21  g216(.a(new_n161_), .b(new_n235_), .c(new_n157_), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n373_), .c(x01), .O(z58));
  aoi21  g218(.a(new_n231_), .b(x79), .c(new_n175_), .O(new_n376_));
  oai21  g219(.a(new_n228_), .b(new_n226_), .c(new_n245_), .O(new_n377_));
  aoi21  g220(.a(new_n377_), .b(x79), .c(new_n231_), .O(new_n378_));
  ...
  nand2  g226(.a(new_n313_), .b(new_n162_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n383_), .c(new_n380_), .O(new_n385_));
  aoi21  g228(.a(new_n385_), .b(new_n233_), .c(x01), .O(z60));
  nand3  g229(.a(x84), .b(x81), .c(x79), .O(new_n388_));
  oai21  g230(.a(x79), .b(new_n235_), .c(new_n388_), .O(new_n389_));
  nand2  g231(.a(new_n389_), .b(new_n153_), .O(new_n390_));
  nand2  g232(.a(new_n377_), .b(x79), .O(new_n391_));
  nand3  g233(.a(x81), .b(x79), .c(new_n235_), .O(new_n392_));
  ...
  oai21  g241(.a(new_n163_), .b(new_n161_), .c(new_n222_), .O(new_n400_));
  oai21  g242(.a(new_n238_), .b(x04), .c(new_n400_), .O(new_n401_));
  nand2  g243(.a(new_n166_), .b(x82), .O(new_n402_));
  inv1   g244(.a(new_n402_), .O(new_n403_));
  and2   g245(.a(new_n403_), .b(new_n401_), .O(z63));
  nand3  g246(.a(new_n401_), .b(x83), .c(x79), .O(new_n405_));
  aoi21  g247(.a(new_n405_), .b(new_n309_), .c(x01), .O(z64));
  nor2   g248(.a(new_n154_), .b(x04), .O(new_n407_));
  nor2   g249(.a(new_n249_), .b(x78), .O(new_n408_));
  oai21  g250(.a(new_n408_), .b(new_n407_), .c(x77), .O(new_n409_));
  nand2  g251(.a(new_n161_), .b(x81), .O(new_n410_));
  nand2  g252(.a(new_n166_), .b(x84), .O(new_n411_));
