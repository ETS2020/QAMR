// Benchmark "FAU" written by ABC on Sat Jun 27 01:54:17 2020
...
module FAU ( 
  ...
  nand4  g076(.a(new_n233_), .b(new_n232_), .c(x48), .d(new_n225_), .O(new_n242_));
  ...
  nand2  g094(.a(new_n233_), .b(x54), .O(new_n262_));
