...
module FAU ( 
  ...
  nand2  g134(.a(new_n244_), .b(x56), .O(new_n294_));
  nor2   g135(.a(new_n294_), .b(new_n288_), .O(z38));
  nor3   g136(.a(new_n288_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g137(.a(new_n288_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g138(.a(new_n288_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g139(.a(new_n288_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g140(.a(new_n288_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g141(.a(new_n288_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g142(.a(new_n288_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g143(.a(new_n288_), .b(new_n245_), .c(new_n176_), .O(z46));
  inv1   g144(.a(x07), .O(new_n304_));
  nand2  g145(.a(x52), .b(x15), .O(new_n305_));
  oai21  g146(.a(x52), .b(new_n304_), .c(new_n305_), .O(new_n306_));
  nand3  g147(.a(new_n234_), .b(new_n167_), .c(new_n163_), .O(new_n307_));
  inv1   g148(.a(new_n307_), .O(new_n308_));
  nand2  g149(.a(new_n308_), .b(new_n306_), .O(new_n309_));
  nor2   g150(.a(x75), .b(x67), .O(new_n310_));
  nand3  g151(.a(x79), .b(new_n154_), .c(x77), .O(new_n311_));
  nor2   g152(.a(new_n311_), .b(new_n310_), .O(new_n312_));
  nand2  g153(.a(new_n312_), .b(new_n223_), .O(new_n313_));
  aoi21  g154(.a(new_n313_), .b(new_n309_), .c(x01), .O(z47));
  inv1   g155(.a(x08), .O(new_n315_));
  nand2  g156(.a(x52), .b(x16), .O(new_n316_));
  oai21  g157(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g158(.a(new_n317_), .b(new_n308_), .O(new_n318_));
  nor2   g159(.a(new_n311_), .b(new_n222_), .O(new_n319_));
  ...
  nand2  g165(.a(new_n324_), .b(new_n308_), .O(new_n325_));
  ...
  nand2  g171(.a(new_n330_), .b(new_n308_), .O(new_n331_));
  nand2  g172(.a(new_n319_), .b(x70), .O(new_n332_));
  aoi21  g173(.a(new_n332_), .b(new_n331_), .c(x01), .O(z50));
  inv1   g174(.a(x11), .O(new_n334_));
  nand2  g175(.a(x52), .b(x19), .O(new_n335_));
  oai21  g176(.a(x52), .b(new_n334_), .c(new_n335_), .O(new_n336_));
  nand2  g177(.a(new_n336_), .b(new_n308_), .O(new_n337_));
  nand2  g178(.a(new_n319_), .b(x71), .O(new_n338_));
  aoi21  g179(.a(new_n338_), .b(new_n337_), .c(x01), .O(z51));
  inv1   g180(.a(x12), .O(new_n340_));
  nand2  g181(.a(x52), .b(x20), .O(new_n341_));
  oai21  g182(.a(x52), .b(new_n340_), .c(new_n341_), .O(new_n342_));
  nand2  g183(.a(new_n342_), .b(new_n308_), .O(new_n343_));
  nand2  g184(.a(new_n319_), .b(x72), .O(new_n344_));
  aoi21  g185(.a(new_n344_), .b(new_n343_), .c(x01), .O(z52));
  inv1   g186(.a(x13), .O(new_n346_));
  nand2  g187(.a(x52), .b(x21), .O(new_n347_));
  oai21  g188(.a(x52), .b(new_n346_), .c(new_n347_), .O(new_n348_));
  nand2  g189(.a(new_n348_), .b(new_n308_), .O(new_n349_));
  nand2  g190(.a(new_n319_), .b(x73), .O(new_n350_));
  aoi21  g191(.a(new_n350_), .b(new_n349_), .c(x01), .O(z53));
  nand2  g192(.a(x52), .b(x22), .O(new_n352_));
  nand2  g193(.a(new_n280_), .b(x14), .O(new_n353_));
  inv1   g194(.a(new_n164_), .O(new_n354_));
  nand4  g195(.a(new_n354_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n355_));
  aoi21  g196(.a(new_n353_), .b(new_n352_), .c(new_n355_), .O(z54));
  inv1   g197(.a(new_n242_), .O(new_n358_));
  xnor2a g198(.a(x84), .b(x81), .O(new_n359_));
  aoi21  g199(.a(new_n165_), .b(new_n164_), .c(new_n359_), .O(new_n360_));
  aoi22  g200(.a(new_n360_), .b(new_n153_), .c(new_n358_), .d(x76), .O(new_n361_));
  aoi21  g201(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n362_));
  oai21  g202(.a(new_n361_), .b(new_n167_), .c(new_n362_), .O(z56));
  inv1   g203(.a(x02), .O(new_n364_));
  nand3  g204(.a(new_n239_), .b(x03), .c(new_n364_), .O(new_n365_));
  inv1   g205(.a(new_n365_), .O(z57));
  nand2  g206(.a(x42), .b(new_n152_), .O(new_n367_));
  nand4  g207(.a(x80), .b(new_n228_), .c(x43), .d(new_n248_), .O(new_n368_));
  oai21  g208(.a(new_n368_), .b(new_n227_), .c(new_n367_), .O(new_n369_));
  nand3  g209(.a(x79), .b(x78), .c(x04), .O(new_n370_));
  inv1   g210(.a(new_n370_), .O(new_n371_));
  nand2  g211(.a(new_n371_), .b(new_n369_), .O(new_n372_));
  nand4  g212(.a(new_n167_), .b(new_n154_), .c(new_n248_), .d(x40), .O(new_n373_));
  nand2  g213(.a(new_n373_), .b(new_n372_), .O(new_n374_));
  nand2  g214(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g215(.a(new_n354_), .b(new_n233_), .c(new_n167_), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  nand2  g217(.a(new_n234_), .b(new_n230_), .O(new_n379_));
  inv1   g218(.a(new_n379_), .O(new_n380_));
  oai21  g219(.a(new_n229_), .b(new_n227_), .c(new_n380_), .O(new_n381_));
  aoi21  g220(.a(new_n154_), .b(x04), .c(x79), .O(new_n382_));
  aoi21  g221(.a(new_n360_), .b(x79), .c(new_n382_), .O(new_n383_));
  aoi21  g222(.a(new_n383_), .b(new_n381_), .c(x01), .O(z60));
  nand2  g223(.a(new_n165_), .b(new_n164_), .O(new_n385_));
  aoi22  g224(.a(new_n385_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n386_));
  nand2  g225(.a(new_n168_), .b(x80), .O(new_n387_));
  nor2   g226(.a(new_n387_), .b(new_n386_), .O(z61));
  nand2  g227(.a(x78), .b(new_n233_), .O(new_n389_));
  nand2  g228(.a(x84), .b(new_n154_), .O(new_n390_));
  aoi21  g229(.a(new_n390_), .b(new_n389_), .c(new_n163_), .O(new_n391_));
  nand2  g230(.a(new_n354_), .b(x84), .O(new_n392_));
  inv1   g231(.a(new_n392_), .O(new_n393_));
  nor2   g232(.a(new_n252_), .b(new_n167_), .O(new_n394_));
  oai21  g233(.a(new_n393_), .b(new_n391_), .c(new_n394_), .O(new_n395_));
  aoi21  g234(.a(new_n395_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g235(.a(new_n168_), .b(x82), .O(new_n397_));
  nor2   g236(.a(new_n397_), .b(new_n386_), .O(z63));
  oai21  g237(.a(new_n252_), .b(x78), .c(new_n389_), .O(new_n400_));
  nand2  g238(.a(new_n400_), .b(x77), .O(new_n401_));
  nand2  g239(.a(new_n354_), .b(x81), .O(new_n402_));
  nand2  g240(.a(new_n168_), .b(x84), .O(new_n403_));
