// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:18 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n291_, new_n293_, new_n295_, new_n305_, new_n306_,
  ...
  nand2  g132(.a(new_n244_), .b(x54), .O(new_n291_));
  nor2   g133(.a(new_n291_), .b(new_n288_), .O(z36));
  nand2  g134(.a(new_n244_), .b(x55), .O(new_n293_));
  nor2   g135(.a(new_n293_), .b(new_n288_), .O(z37));
