// Benchmark "FAU" written by ABC on Sat Jun 27 02:06:33 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n214_, new_n218_, new_n219_, new_n222_, new_n223_, new_n224_,
  ...
  nand2  g071(.a(new_n163_), .b(x79), .O(new_n229_));
  aoi21  g072(.a(new_n228_), .b(new_n225_), .c(new_n229_), .O(new_n230_));
  nor2   g073(.a(x04), .b(x01), .O(new_n231_));
  nand4  g074(.a(new_n231_), .b(new_n230_), .c(new_n222_), .d(x05), .O(new_n232_));
  inv1   g075(.a(new_n232_), .O(z25));
  nand4  g076(.a(new_n231_), .b(new_n230_), .c(x44), .d(new_n222_), .O(new_n234_));
  inv1   g077(.a(new_n234_), .O(z26));
  nand4  g078(.a(new_n231_), .b(new_n230_), .c(x45), .d(new_n222_), .O(new_n236_));
  inv1   g079(.a(new_n236_), .O(z27));
  nand4  g080(.a(new_n231_), .b(new_n230_), .c(x47), .d(new_n222_), .O(new_n239_));
  inv1   g081(.a(new_n239_), .O(z29));
  nand4  g082(.a(new_n231_), .b(new_n230_), .c(x48), .d(new_n222_), .O(new_n241_));
  inv1   g083(.a(new_n241_), .O(z30));
  nand4  g084(.a(new_n231_), .b(new_n230_), .c(x50), .d(new_n222_), .O(new_n244_));
  inv1   g085(.a(new_n244_), .O(z32));
  inv1   g086(.a(x83), .O(new_n246_));
  nor2   g087(.a(new_n246_), .b(x81), .O(new_n247_));
  nor2   g088(.a(x83), .b(new_n226_), .O(new_n248_));
  nor2   g089(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand2  g090(.a(x42), .b(x05), .O(new_n250_));
  nand2  g091(.a(x51), .b(new_n222_), .O(new_n251_));
  oai22  g092(.a(new_n251_), .b(new_n226_), .c(new_n250_), .d(new_n249_), .O(new_n252_));
  nand2  g093(.a(new_n252_), .b(new_n224_), .O(new_n253_));
  xor2a  g094(.a(x83), .b(x81), .O(new_n254_));
  oai22  g095(.a(new_n254_), .b(new_n250_), .c(new_n251_), .d(x81), .O(new_n255_));
  nand2  g096(.a(new_n255_), .b(new_n227_), .O(new_n256_));
  inv1   g097(.a(new_n229_), .O(new_n257_));
  nand2  g098(.a(new_n231_), .b(new_n257_), .O(new_n258_));
  aoi21  g099(.a(new_n256_), .b(new_n253_), .c(new_n258_), .O(z33));
  inv1   g100(.a(x52), .O(new_n260_));
  inv1   g101(.a(new_n231_), .O(new_n261_));
  nand2  g102(.a(x83), .b(x42), .O(new_n262_));
  nand2  g103(.a(new_n262_), .b(new_n226_), .O(new_n263_));
  nand3  g104(.a(x83), .b(x81), .c(x42), .O(new_n264_));
  nand2  g105(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  and2   g106(.a(new_n265_), .b(new_n227_), .O(new_n266_));
  nand2  g107(.a(new_n262_), .b(x81), .O(new_n267_));
  nand2  g108(.a(new_n247_), .b(x42), .O(new_n268_));
  aoi21  g109(.a(new_n268_), .b(new_n267_), .c(new_n223_), .O(new_n269_));
  oai21  g110(.a(new_n269_), .b(new_n266_), .c(new_n257_), .O(new_n270_));
  nor3   g111(.a(new_n270_), .b(new_n261_), .c(new_n260_), .O(z34));
  nand2  g112(.a(new_n231_), .b(x53), .O(new_n272_));
  nor2   g113(.a(new_n272_), .b(new_n270_), .O(z35));
  nand2  g114(.a(new_n231_), .b(x56), .O(new_n276_));
  nor2   g115(.a(new_n276_), .b(new_n270_), .O(z38));
  nor3   g116(.a(new_n270_), .b(new_n261_), .c(new_n192_), .O(z39));
  nor3   g117(.a(new_n270_), .b(new_n261_), .c(new_n189_), .O(z40));
  nor3   g118(.a(new_n270_), .b(new_n261_), .c(new_n186_), .O(z41));
  nor3   g119(.a(new_n270_), .b(new_n261_), .c(new_n183_), .O(z42));
  nor3   g120(.a(new_n270_), .b(new_n261_), .c(new_n180_), .O(z43));
  nor3   g121(.a(new_n270_), .b(new_n261_), .c(new_n177_), .O(z44));
  nor3   g122(.a(new_n270_), .b(new_n261_), .c(new_n174_), .O(z45));
  nor3   g123(.a(new_n270_), .b(new_n261_), .c(new_n171_), .O(z46));
  ...
  nand2  g136(.a(new_n260_), .b(x14), .O(new_n304_));
  ...
  nand3  g141(.a(new_n247_), .b(x84), .c(new_n308_), .O(new_n309_));
  inv1   g142(.a(x80), .O(new_n310_));
  nand4  g143(.a(new_n231_), .b(new_n163_), .c(new_n310_), .d(x79), .O(new_n311_));
  nor2   g144(.a(new_n311_), .b(new_n309_), .O(z55));
  aoi21  g145(.a(x84), .b(new_n226_), .c(x76), .O(new_n313_));
  oai21  g146(.a(x84), .b(new_n226_), .c(new_n313_), .O(new_n314_));
  nand2  g147(.a(new_n314_), .b(new_n164_), .O(new_n315_));
  nand4  g148(.a(new_n315_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g149(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n318_));
  inv1   g150(.a(x74), .O(new_n319_));
  nand4  g151(.a(x80), .b(new_n319_), .c(x43), .d(new_n222_), .O(new_n320_));
  oai22  g152(.a(new_n320_), .b(new_n318_), .c(new_n222_), .d(x40), .O(new_n321_));
  nand2  g153(.a(x78), .b(x04), .O(new_n322_));
  inv1   g154(.a(new_n322_), .O(new_n323_));
  nand3  g155(.a(new_n323_), .b(new_n321_), .c(x79), .O(new_n324_));
  nand4  g156(.a(new_n162_), .b(new_n154_), .c(new_n222_), .d(x40), .O(new_n325_));
  ...
  oai21  g163(.a(new_n331_), .b(new_n318_), .c(new_n222_), .O(new_n332_));
  ...
  nor2   g191(.a(new_n226_), .b(x78), .O(new_n361_));
