...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n271_, new_n273_, new_n275_, new_n278_, new_n295_,
  ...
  nor2   g130(.a(new_n154_), .b(x77), .O(new_n297_));
  nand4  g131(.a(new_n297_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n298_));
  ...
  inv1   g135(.a(x80), .O(new_n302_));
  nand4  g136(.a(new_n222_), .b(new_n163_), .c(new_n302_), .d(x79), .O(new_n303_));
  nor2   g137(.a(new_n303_), .b(new_n301_), .O(z55));
  aoi21  g138(.a(x84), .b(new_n229_), .c(x76), .O(new_n305_));
  oai21  g139(.a(x84), .b(new_n229_), .c(new_n305_), .O(new_n306_));
  nand2  g140(.a(new_n306_), .b(new_n164_), .O(new_n307_));
  ...
  nand4  g144(.a(x80), .b(new_n311_), .c(x43), .d(new_n225_), .O(new_n312_));
  oai22  g145(.a(new_n312_), .b(new_n310_), .c(new_n225_), .d(x40), .O(new_n313_));
  nand2  g146(.a(x78), .b(x04), .O(new_n314_));
  inv1   g147(.a(new_n314_), .O(new_n315_));
  nand3  g148(.a(new_n315_), .b(new_n313_), .c(x79), .O(new_n316_));
  nand4  g149(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n317_));
  nand2  g150(.a(new_n317_), .b(new_n316_), .O(new_n318_));
  nand2  g151(.a(new_n318_), .b(x77), .O(new_n319_));
  oai21  g152(.a(new_n297_), .b(new_n218_), .c(new_n162_), .O(new_n320_));
  aoi21  g153(.a(new_n320_), .b(new_n319_), .c(x01), .O(z58));
  aoi21  g154(.a(new_n314_), .b(x79), .c(new_n152_), .O(new_n322_));
  nand3  g155(.a(x80), .b(new_n311_), .c(x43), .O(new_n323_));
  oai21  g156(.a(new_n323_), .b(new_n310_), .c(new_n225_), .O(new_n324_));
  aoi21  g157(.a(new_n324_), .b(x79), .c(new_n314_), .O(new_n325_));
  oai21  g158(.a(new_n325_), .b(new_n322_), .c(x77), .O(new_n326_));
  nand2  g159(.a(new_n162_), .b(new_n218_), .O(new_n327_));
  aoi21  g160(.a(new_n327_), .b(new_n326_), .c(x01), .O(z59));
  xnor2a g161(.a(x84), .b(x81), .O(new_n330_));
  nor2   g162(.a(x78), .b(new_n160_), .O(new_n331_));
  oai21  g163(.a(new_n331_), .b(new_n297_), .c(new_n330_), .O(new_n332_));
  nand2  g164(.a(new_n163_), .b(new_n218_), .O(new_n333_));
  nand2  g165(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  inv1   g166(.a(new_n334_), .O(new_n335_));
  nor2   g167(.a(new_n162_), .b(x01), .O(new_n336_));
  inv1   g168(.a(new_n336_), .O(new_n337_));
  nor3   g169(.a(new_n337_), .b(new_n335_), .c(new_n302_), .O(z61));
  nand3  g170(.a(x84), .b(x81), .c(x79), .O(new_n339_));
  oai21  g171(.a(x79), .b(new_n218_), .c(new_n339_), .O(new_n340_));
  nand2  g172(.a(new_n340_), .b(new_n160_), .O(new_n341_));
  nand2  g173(.a(new_n324_), .b(x79), .O(new_n342_));
  nand3  g174(.a(x81), .b(x79), .c(new_n218_), .O(new_n343_));
  inv1   g175(.a(new_n343_), .O(new_n344_));
  aoi21  g176(.a(new_n342_), .b(x04), .c(new_n344_), .O(new_n345_));
  oai21  g177(.a(new_n345_), .b(new_n160_), .c(new_n341_), .O(new_n346_));
  nand2  g178(.a(new_n346_), .b(x78), .O(new_n347_));
  inv1   g179(.a(new_n339_), .O(new_n348_));
  nand2  g180(.a(new_n348_), .b(new_n331_), .O(new_n349_));
  aoi21  g181(.a(new_n349_), .b(new_n347_), .c(x01), .O(z62));
  nor3   g182(.a(new_n337_), .b(new_n335_), .c(new_n300_), .O(z63));
  nand3  g183(.a(new_n334_), .b(x83), .c(x79), .O(new_n352_));
  nand3  g184(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n353_));
  aoi21  g185(.a(new_n353_), .b(new_n352_), .c(x01), .O(z64));
  nor2   g186(.a(new_n154_), .b(x04), .O(new_n355_));
  nor2   g187(.a(new_n229_), .b(x78), .O(new_n356_));
  oai21  g188(.a(new_n356_), .b(new_n355_), .c(x77), .O(new_n357_));
  nand2  g189(.a(new_n297_), .b(x81), .O(new_n358_));
  nand2  g190(.a(new_n336_), .b(x84), .O(new_n359_));
  aoi21  g191(.a(new_n358_), .b(new_n357_), .c(new_n359_), .O(z65));
  zero   g192(.O(z02));
  zero   g193(.O(z04));
  zero   g194(.O(z15));
  zero   g195(.O(z18));
