...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n253_, new_n254_, new_n256_, new_n258_, new_n270_, new_n271_,
  ...
  nor2   g161(.a(new_n154_), .b(x04), .O(new_n345_));
  nor2   g162(.a(new_n219_), .b(x78), .O(new_n346_));
  oai21  g163(.a(new_n346_), .b(new_n345_), .c(x77), .O(new_n347_));
  nand3  g164(.a(x81), .b(x78), .c(new_n153_), .O(new_n348_));
  nand2  g165(.a(new_n166_), .b(x84), .O(new_n349_));
  aoi21  g166(.a(new_n348_), .b(new_n347_), .c(new_n349_), .O(z65));
  zero   g167(.O(z00));
  zero   g168(.O(z03));
  zero   g169(.O(z06));
  zero   g170(.O(z07));
