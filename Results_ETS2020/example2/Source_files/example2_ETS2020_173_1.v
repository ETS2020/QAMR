...
module FAU ( 
  ...
  nor3   g116(.a(new_n269_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g117(.a(new_n269_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g118(.a(new_n269_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g119(.a(new_n269_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g120(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g121(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  ...
  nand2  g134(.a(new_n260_), .b(x14), .O(new_n303_));
  ...
  nand3  g139(.a(new_n247_), .b(x84), .c(new_n307_), .O(new_n308_));
  inv1   g140(.a(x80), .O(new_n309_));
  nand4  g141(.a(new_n220_), .b(new_n163_), .c(new_n309_), .d(x79), .O(new_n310_));
  nor2   g142(.a(new_n310_), .b(new_n308_), .O(z55));
  aoi21  g143(.a(x84), .b(new_n227_), .c(x76), .O(new_n312_));
  oai21  g144(.a(x84), .b(new_n227_), .c(new_n312_), .O(new_n313_));
  nand2  g145(.a(new_n313_), .b(new_n164_), .O(new_n314_));
  nand4  g146(.a(new_n314_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g147(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n317_));
  inv1   g148(.a(x74), .O(new_n318_));
  nand4  g149(.a(x80), .b(new_n318_), .c(x43), .d(new_n223_), .O(new_n319_));
  oai22  g150(.a(new_n319_), .b(new_n317_), .c(new_n223_), .d(x40), .O(new_n320_));
  nand2  g151(.a(x78), .b(x04), .O(new_n321_));
  inv1   g152(.a(new_n321_), .O(new_n322_));
  nand3  g153(.a(new_n322_), .b(new_n320_), .c(x79), .O(new_n323_));
  nand4  g154(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n324_));
  nand2  g155(.a(new_n324_), .b(new_n323_), .O(new_n325_));
  nand2  g156(.a(new_n325_), .b(x77), .O(new_n326_));
  oai21  g157(.a(new_n304_), .b(new_n216_), .c(new_n162_), .O(new_n327_));
  ...
  oai21  g174(.a(x79), .b(new_n216_), .c(new_n344_), .O(new_n345_));
  nand2  g175(.a(new_n345_), .b(new_n160_), .O(new_n346_));
  nand2  g176(.a(new_n331_), .b(x79), .O(new_n347_));
  nand3  g177(.a(x81), .b(x79), .c(new_n216_), .O(new_n348_));
