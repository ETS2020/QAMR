// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:44 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n271_, new_n274_, new_n276_, new_n293_, new_n294_, new_n295_,
  ...
  nor3   g117(.a(new_n269_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g118(.a(new_n269_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g119(.a(new_n269_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g120(.a(new_n269_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g121(.a(new_n269_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g122(.a(new_n269_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g123(.a(new_n269_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g124(.a(new_n269_), .b(new_n221_), .c(new_n173_), .O(z46));
  nand2  g125(.a(x52), .b(x22), .O(new_n293_));
  nand2  g126(.a(new_n260_), .b(x14), .O(new_n294_));
  ...
  nand3  g131(.a(new_n247_), .b(x84), .c(new_n298_), .O(new_n299_));
  ...
  nand4  g139(.a(x84), .b(new_n246_), .c(x82), .d(x81), .O(new_n308_));
