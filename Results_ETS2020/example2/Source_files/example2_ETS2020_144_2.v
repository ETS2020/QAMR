// Benchmark "FAU" written by ABC on Sat Jun 27 01:59:57 2020
...
module FAU ( 
  ...
  nor2   g164(.a(new_n160_), .b(x04), .O(new_n348_));
  nor2   g165(.a(new_n224_), .b(x78), .O(new_n349_));
  oai21  g166(.a(new_n349_), .b(new_n348_), .c(x77), .O(new_n350_));
  nand3  g167(.a(x81), .b(x78), .c(new_n159_), .O(new_n351_));
  nand2  g168(.a(new_n171_), .b(x84), .O(new_n352_));
  aoi21  g169(.a(new_n351_), .b(new_n350_), .c(new_n352_), .O(z65));
  zero   g170(.O(z03));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
  zero   g173(.O(z08));
