// Benchmark "FAU" written by ABC on Sat Jun 27 02:05:01 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n241_, new_n243_, new_n246_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n275_, new_n277_, new_n294_, new_n295_,
  ...
  nand4  g085(.a(new_n233_), .b(new_n222_), .c(x48), .d(new_n225_), .O(new_n243_));
  inv1   g086(.a(new_n243_), .O(z30));
  ...
  nand2  g127(.a(new_n262_), .b(x14), .O(new_n295_));
  ...
  nand3  g132(.a(new_n249_), .b(x84), .c(new_n299_), .O(new_n300_));
  inv1   g133(.a(x80), .O(new_n301_));
  nand4  g134(.a(new_n222_), .b(new_n163_), .c(new_n301_), .d(x79), .O(new_n302_));
  nor2   g135(.a(new_n302_), .b(new_n300_), .O(z55));
  aoi21  g136(.a(x84), .b(new_n229_), .c(x76), .O(new_n304_));
  oai21  g137(.a(x84), .b(new_n229_), .c(new_n304_), .O(new_n305_));
  nand2  g138(.a(new_n305_), .b(new_n164_), .O(new_n306_));
  nand4  g139(.a(new_n306_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g140(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n309_));
  inv1   g141(.a(x74), .O(new_n310_));
  nand4  g142(.a(x80), .b(new_n310_), .c(x43), .d(new_n225_), .O(new_n311_));
  oai22  g143(.a(new_n311_), .b(new_n309_), .c(new_n225_), .d(x40), .O(new_n312_));
  nand2  g144(.a(x78), .b(x04), .O(new_n313_));
  inv1   g145(.a(new_n313_), .O(new_n314_));
  nand3  g146(.a(new_n314_), .b(new_n312_), .c(x79), .O(new_n315_));
  nand4  g147(.a(new_n162_), .b(new_n154_), .c(new_n225_), .d(x40), .O(new_n316_));
  nand2  g148(.a(new_n316_), .b(new_n315_), .O(new_n317_));
  nand2  g149(.a(new_n317_), .b(x77), .O(new_n318_));
  oai21  g150(.a(new_n296_), .b(new_n218_), .c(new_n162_), .O(new_n319_));
  ...
  oai21  g154(.a(new_n322_), .b(new_n309_), .c(new_n225_), .O(new_n323_));
  aoi21  g155(.a(new_n323_), .b(x79), .c(new_n313_), .O(new_n324_));
  oai21  g156(.a(new_n324_), .b(new_n321_), .c(x77), .O(new_n325_));
  nand2  g157(.a(new_n162_), .b(new_n218_), .O(new_n326_));
  ...
  nand2  g162(.a(new_n163_), .b(new_n218_), .O(new_n332_));
  ...
  oai21  g169(.a(x79), .b(new_n218_), .c(new_n338_), .O(new_n339_));
  nand2  g170(.a(new_n339_), .b(new_n160_), .O(new_n340_));
  nand2  g171(.a(new_n323_), .b(x79), .O(new_n341_));
  nand3  g172(.a(x81), .b(x79), .c(new_n218_), .O(new_n342_));
  ...
  nor2   g185(.a(new_n229_), .b(x78), .O(new_n355_));
