// Benchmark "FAU" written by ABC on Sat Jun 27 01:55:32 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n173_, new_n177_, new_n178_, new_n180_, new_n181_, new_n184_,
    new_n185_, new_n187_, new_n188_, new_n190_, new_n191_, new_n193_,
    new_n194_, new_n196_, new_n197_, new_n199_, new_n200_, new_n202_,
    new_n203_, new_n206_, new_n207_, new_n210_, new_n211_, new_n213_,
    ...
    new_n291_, new_n299_, new_n303_, new_n304_, new_n305_, new_n306_,
  ...
  nand2  g043(.a(new_n152_), .b(x31), .O(new_n197_));
  oai21  g044(.a(new_n196_), .b(new_n152_), .c(new_n197_), .O(z13));
  ...
  nor3   g136(.a(new_n285_), .b(new_n238_), .c(new_n196_), .O(z39));
  nor3   g137(.a(new_n285_), .b(new_n238_), .c(new_n193_), .O(z40));
  nor3   g138(.a(new_n285_), .b(new_n238_), .c(new_n190_), .O(z41));
  nor3   g139(.a(new_n285_), .b(new_n238_), .c(new_n187_), .O(z42));
  nor3   g140(.a(new_n285_), .b(new_n238_), .c(new_n184_), .O(z43));
  nand2  g141(.a(new_n237_), .b(x62), .O(new_n299_));
  nor2   g142(.a(new_n299_), .b(new_n285_), .O(z44));
  nor3   g143(.a(new_n285_), .b(new_n238_), .c(new_n180_), .O(z45));
  nor3   g144(.a(new_n285_), .b(new_n238_), .c(new_n177_), .O(z46));
  ...
  nand2  g149(.a(new_n306_), .b(new_n229_), .O(new_n307_));
  ...
  nand2  g155(.a(new_n312_), .b(new_n219_), .O(new_n313_));
  ...
  inv1   g161(.a(new_n219_), .O(new_n319_));
  ...
  nand2  g196(.a(new_n276_), .b(x14), .O(new_n354_));
  ...
  nand3  g200(.a(new_n263_), .b(x84), .c(new_n357_), .O(new_n358_));
  inv1   g201(.a(x80), .O(new_n359_));
  nand4  g202(.a(new_n237_), .b(new_n161_), .c(new_n359_), .d(x79), .O(new_n360_));
  ...
  nand4  g207(.a(x80), .b(new_n224_), .c(x43), .d(new_n240_), .O(new_n366_));
  oai22  g208(.a(new_n366_), .b(new_n223_), .c(new_n240_), .d(x40), .O(new_n367_));
  nand3  g209(.a(new_n367_), .b(new_n229_), .c(x79), .O(new_n368_));
  nor2   g210(.a(x79), .b(x78), .O(new_n369_));
  nand3  g211(.a(new_n369_), .b(new_n240_), .c(x40), .O(new_n370_));
  nand2  g212(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g213(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g214(.a(new_n166_), .b(new_n232_), .c(new_n154_), .O(new_n373_));
  aoi21  g215(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  inv1   g216(.a(new_n369_), .O(new_n375_));
  aoi21  g217(.a(new_n228_), .b(new_n375_), .c(new_n152_), .O(new_n376_));
  oai21  g218(.a(new_n225_), .b(new_n223_), .c(new_n240_), .O(new_n377_));
  aoi21  g219(.a(new_n377_), .b(x79), .c(new_n228_), .O(new_n378_));
  ...
  aoi21  g227(.a(new_n385_), .b(new_n230_), .c(x01), .O(z60));
  inv1   g228(.a(new_n171_), .O(new_n387_));
  oai21  g229(.a(new_n168_), .b(new_n166_), .c(new_n219_), .O(new_n388_));
  nand2  g230(.a(new_n161_), .b(new_n232_), .O(new_n389_));
  ...
  oai21  g235(.a(x79), .b(new_n232_), .c(new_n393_), .O(new_n394_));
  nand2  g236(.a(new_n394_), .b(new_n159_), .O(new_n395_));
  nand2  g237(.a(new_n377_), .b(x79), .O(new_n396_));
  nand3  g238(.a(x81), .b(x79), .c(new_n232_), .O(new_n397_));
  ...
  nor2   g250(.a(new_n244_), .b(x78), .O(new_n409_));
