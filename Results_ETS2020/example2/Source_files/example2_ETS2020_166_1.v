// Benchmark "FAU" written by ABC on Sat Jun 27 02:01:35 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n238_, new_n242_, new_n244_, new_n246_, new_n249_, new_n250_,
  ...
  nor3   g123(.a(new_n272_), .b(new_n225_), .c(new_n173_), .O(z46));
  inv1   g124(.a(x07), .O(new_n287_));
  nand2  g125(.a(x52), .b(x15), .O(new_n288_));
  oai21  g126(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand3  g127(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n290_));
  inv1   g128(.a(new_n290_), .O(new_n291_));
  nand2  g129(.a(new_n291_), .b(new_n289_), .O(new_n292_));
  xnor2a g130(.a(x84), .b(x81), .O(new_n293_));
  or2    g131(.a(x75), .b(x67), .O(new_n294_));
  nor2   g132(.a(x78), .b(new_n160_), .O(new_n295_));
  nand4  g133(.a(new_n295_), .b(new_n294_), .c(new_n293_), .d(x79), .O(new_n296_));
  aoi21  g134(.a(new_n296_), .b(new_n292_), .c(x01), .O(z47));
  nand2  g135(.a(x52), .b(x22), .O(new_n304_));
  nand2  g136(.a(new_n263_), .b(x14), .O(new_n305_));
  nor2   g137(.a(new_n154_), .b(x77), .O(new_n306_));
  nand4  g138(.a(new_n306_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n307_));
  aoi21  g139(.a(new_n305_), .b(new_n304_), .c(new_n307_), .O(z54));
  inv1   g140(.a(x82), .O(new_n309_));
  nand3  g141(.a(new_n250_), .b(x84), .c(new_n309_), .O(new_n310_));
  inv1   g142(.a(x80), .O(new_n311_));
  nand4  g143(.a(new_n224_), .b(new_n163_), .c(new_n311_), .d(x79), .O(new_n312_));
  nor2   g144(.a(new_n312_), .b(new_n310_), .O(z55));
  aoi21  g145(.a(x84), .b(new_n231_), .c(x76), .O(new_n314_));
  oai21  g146(.a(x84), .b(new_n231_), .c(new_n314_), .O(new_n315_));
  nand2  g147(.a(new_n315_), .b(new_n164_), .O(new_n316_));
  nand4  g148(.a(new_n316_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g149(.a(x84), .b(new_n249_), .c(x82), .d(x81), .O(new_n319_));
  inv1   g150(.a(x74), .O(new_n320_));
  nand4  g151(.a(x80), .b(new_n320_), .c(x43), .d(new_n227_), .O(new_n321_));
  oai22  g152(.a(new_n321_), .b(new_n319_), .c(new_n227_), .d(x40), .O(new_n322_));
  nand2  g153(.a(x78), .b(x04), .O(new_n323_));
  inv1   g154(.a(new_n323_), .O(new_n324_));
  nand3  g155(.a(new_n324_), .b(new_n322_), .c(x79), .O(new_n325_));
  nand4  g156(.a(new_n162_), .b(new_n154_), .c(new_n227_), .d(x40), .O(new_n326_));
  nand2  g157(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand2  g158(.a(new_n327_), .b(x77), .O(new_n328_));
  oai21  g159(.a(new_n306_), .b(new_n220_), .c(new_n162_), .O(new_n329_));
  aoi21  g160(.a(new_n329_), .b(new_n328_), .c(x01), .O(z58));
  aoi21  g161(.a(new_n323_), .b(x79), .c(new_n152_), .O(new_n331_));
  nand3  g162(.a(x80), .b(new_n320_), .c(x43), .O(new_n332_));
  oai21  g163(.a(new_n332_), .b(new_n319_), .c(new_n227_), .O(new_n333_));
  aoi21  g164(.a(new_n333_), .b(x79), .c(new_n323_), .O(new_n334_));
  oai21  g165(.a(new_n334_), .b(new_n331_), .c(x77), .O(new_n335_));
  nand2  g166(.a(new_n162_), .b(new_n220_), .O(new_n336_));
  aoi21  g167(.a(new_n336_), .b(new_n335_), .c(x01), .O(z59));
  oai21  g168(.a(new_n306_), .b(new_n295_), .c(new_n293_), .O(new_n339_));
  nand2  g169(.a(new_n163_), .b(new_n220_), .O(new_n340_));
  nand2  g170(.a(new_n340_), .b(new_n339_), .O(new_n341_));
  inv1   g171(.a(new_n341_), .O(new_n342_));
  nor2   g172(.a(new_n162_), .b(x01), .O(new_n343_));
  inv1   g173(.a(new_n343_), .O(new_n344_));
  nor3   g174(.a(new_n344_), .b(new_n342_), .c(new_n311_), .O(z61));
  nand3  g175(.a(x84), .b(x81), .c(x79), .O(new_n346_));
  oai21  g176(.a(x79), .b(new_n220_), .c(new_n346_), .O(new_n347_));
  nand2  g177(.a(new_n347_), .b(new_n160_), .O(new_n348_));
  nand2  g178(.a(new_n333_), .b(x79), .O(new_n349_));
  nand3  g179(.a(x81), .b(x79), .c(new_n220_), .O(new_n350_));
  inv1   g180(.a(new_n350_), .O(new_n351_));
  aoi21  g181(.a(new_n349_), .b(x04), .c(new_n351_), .O(new_n352_));
  oai21  g182(.a(new_n352_), .b(new_n160_), .c(new_n348_), .O(new_n353_));
  nand2  g183(.a(new_n353_), .b(x78), .O(new_n354_));
  inv1   g184(.a(new_n346_), .O(new_n355_));
  nand2  g185(.a(new_n355_), .b(new_n295_), .O(new_n356_));
  aoi21  g186(.a(new_n356_), .b(new_n354_), .c(x01), .O(z62));
  nor3   g187(.a(new_n344_), .b(new_n342_), .c(new_n309_), .O(z63));
  nand3  g188(.a(new_n341_), .b(x83), .c(x79), .O(new_n359_));
  aoi21  g189(.a(new_n359_), .b(new_n290_), .c(x01), .O(z64));
  nor2   g190(.a(new_n154_), .b(x04), .O(new_n361_));
  nor2   g191(.a(new_n231_), .b(x78), .O(new_n362_));
  oai21  g192(.a(new_n362_), .b(new_n361_), .c(x77), .O(new_n363_));
  nand2  g193(.a(new_n306_), .b(x81), .O(new_n364_));
  nand2  g194(.a(new_n343_), .b(x84), .O(new_n365_));
  aoi21  g195(.a(new_n364_), .b(new_n363_), .c(new_n365_), .O(z65));
  zero   g196(.O(z02));
  zero   g197(.O(z04));
  zero   g198(.O(z21));
  zero   g199(.O(z22));
