// Benchmark "FAU" written by ABC on Sat Jun 27 01:49:56 2020
...
module FAU ( 
  ...
  wire new_n153_, new_n154_, new_n155_, new_n156_, new_n157_, new_n158_,
    ...
    new_n292_, new_n300_, new_n303_, new_n304_, new_n305_, new_n306_,
  ...
  nand2  g027(.a(new_n175_), .b(x26), .O(new_n181_));
  oai21  g028(.a(new_n180_), .b(new_n175_), .c(new_n181_), .O(z08));
  inv1   g029(.a(x61), .O(new_n183_));
  nand2  g030(.a(new_n175_), .b(x27), .O(new_n184_));
  oai21  g031(.a(new_n183_), .b(new_n175_), .c(new_n184_), .O(z09));
  inv1   g032(.a(x60), .O(new_n186_));
  nand2  g033(.a(new_n175_), .b(x28), .O(new_n187_));
  oai21  g034(.a(new_n186_), .b(new_n175_), .c(new_n187_), .O(z10));
  inv1   g035(.a(x59), .O(new_n189_));
  nand2  g036(.a(new_n175_), .b(x29), .O(new_n190_));
  oai21  g037(.a(new_n189_), .b(new_n175_), .c(new_n190_), .O(z11));
  inv1   g038(.a(x58), .O(new_n192_));
  nand2  g039(.a(new_n175_), .b(x30), .O(new_n193_));
  oai21  g040(.a(new_n192_), .b(new_n175_), .c(new_n193_), .O(z12));
  inv1   g041(.a(x57), .O(new_n195_));
  nand2  g042(.a(new_n175_), .b(x31), .O(new_n196_));
  oai21  g043(.a(new_n195_), .b(new_n175_), .c(new_n196_), .O(z13));
  ...
  nor2   g066(.a(new_n157_), .b(x41), .O(new_n221_));
  ...
  nor3   g073(.a(new_n227_), .b(new_n153_), .c(x42), .O(new_n228_));
  nand2  g074(.a(x78), .b(x04), .O(new_n229_));
  inv1   g075(.a(new_n229_), .O(new_n230_));
  oai21  g076(.a(new_n228_), .b(new_n157_), .c(new_n230_), .O(new_n231_));
  aoi21  g077(.a(new_n231_), .b(new_n222_), .c(x01), .O(z22));
  inv1   g078(.a(x04), .O(new_n233_));
  nand3  g079(.a(new_n157_), .b(x05), .c(new_n233_), .O(new_n234_));
  nand3  g080(.a(new_n234_), .b(new_n168_), .c(x00), .O(z23));
  inv1   g081(.a(x42), .O(new_n237_));
  xor2a  g082(.a(x84), .b(x82), .O(new_n238_));
  ...
  aoi21  g088(.a(new_n243_), .b(new_n240_), .c(new_n156_), .O(new_n244_));
  nor2   g089(.a(x04), .b(x01), .O(new_n245_));
  nand4  g090(.a(new_n245_), .b(new_n244_), .c(new_n237_), .d(x05), .O(new_n246_));
  inv1   g091(.a(new_n246_), .O(z25));
  nand4  g092(.a(new_n245_), .b(new_n244_), .c(x44), .d(new_n237_), .O(new_n248_));
  inv1   g093(.a(new_n248_), .O(z26));
  nand4  g094(.a(new_n245_), .b(new_n244_), .c(x45), .d(new_n237_), .O(new_n250_));
  inv1   g095(.a(new_n250_), .O(z27));
  nand4  g096(.a(new_n245_), .b(new_n244_), .c(x46), .d(new_n237_), .O(new_n252_));
  inv1   g097(.a(new_n252_), .O(z28));
  nand4  g098(.a(new_n245_), .b(new_n244_), .c(x48), .d(new_n237_), .O(new_n255_));
  inv1   g099(.a(new_n255_), .O(z30));
  nand4  g100(.a(new_n245_), .b(new_n244_), .c(x49), .d(new_n237_), .O(new_n257_));
  inv1   g101(.a(new_n257_), .O(z31));
  nand4  g102(.a(new_n245_), .b(new_n244_), .c(x50), .d(new_n237_), .O(new_n259_));
  inv1   g103(.a(new_n259_), .O(z32));
  nor2   g104(.a(new_n223_), .b(x81), .O(new_n261_));
  ...
  nand2  g115(.a(new_n245_), .b(new_n271_), .O(new_n272_));
  aoi21  g116(.a(new_n270_), .b(new_n267_), .c(new_n272_), .O(z33));
  inv1   g117(.a(x52), .O(new_n274_));
  inv1   g118(.a(new_n245_), .O(new_n275_));
  nand2  g119(.a(x83), .b(x42), .O(new_n276_));
  nand2  g120(.a(new_n276_), .b(new_n241_), .O(new_n277_));
  nand3  g121(.a(x83), .b(x81), .c(x42), .O(new_n278_));
  nand2  g122(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  and2   g123(.a(new_n279_), .b(new_n242_), .O(new_n280_));
  nand2  g124(.a(new_n276_), .b(x81), .O(new_n281_));
  nand2  g125(.a(new_n261_), .b(x42), .O(new_n282_));
  aoi21  g126(.a(new_n282_), .b(new_n281_), .c(new_n238_), .O(new_n283_));
  oai21  g127(.a(new_n283_), .b(new_n280_), .c(new_n271_), .O(new_n284_));
  nor3   g128(.a(new_n284_), .b(new_n275_), .c(new_n274_), .O(z34));
  nand2  g129(.a(new_n245_), .b(x53), .O(new_n286_));
  nor2   g130(.a(new_n286_), .b(new_n284_), .O(z35));
  nand2  g131(.a(new_n245_), .b(x54), .O(new_n288_));
  nor2   g132(.a(new_n288_), .b(new_n284_), .O(z36));
  nand2  g133(.a(new_n245_), .b(x55), .O(new_n290_));
  nor2   g134(.a(new_n290_), .b(new_n284_), .O(z37));
  nand2  g135(.a(new_n245_), .b(x56), .O(new_n292_));
  nor2   g136(.a(new_n292_), .b(new_n284_), .O(z38));
  nor3   g137(.a(new_n284_), .b(new_n275_), .c(new_n195_), .O(z39));
  nor3   g138(.a(new_n284_), .b(new_n275_), .c(new_n192_), .O(z40));
  nor3   g139(.a(new_n284_), .b(new_n275_), .c(new_n189_), .O(z41));
  nor3   g140(.a(new_n284_), .b(new_n275_), .c(new_n186_), .O(z42));
  nor3   g141(.a(new_n284_), .b(new_n275_), .c(new_n183_), .O(z43));
  nor3   g142(.a(new_n284_), .b(new_n275_), .c(new_n180_), .O(z44));
  nand2  g143(.a(new_n245_), .b(x63), .O(new_n300_));
  nor2   g144(.a(new_n300_), .b(new_n284_), .O(z45));
  nor3   g145(.a(new_n284_), .b(new_n275_), .c(new_n176_), .O(z46));
  ...
  nand2  g150(.a(new_n306_), .b(new_n230_), .O(new_n307_));
  inv1   g151(.a(new_n307_), .O(new_n308_));
  nand2  g152(.a(new_n308_), .b(new_n305_), .O(new_n309_));
  inv1   g153(.a(x67), .O(new_n310_));
  nand2  g154(.a(new_n163_), .b(x79), .O(new_n311_));
  aoi21  g155(.a(new_n160_), .b(new_n310_), .c(new_n311_), .O(new_n312_));
  nand2  g156(.a(new_n312_), .b(new_n220_), .O(new_n313_));
  ...
  inv1   g162(.a(new_n220_), .O(new_n319_));
  ...
  nand2  g197(.a(new_n274_), .b(x14), .O(new_n354_));
  nand4  g198(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n168_), .O(new_n355_));
  aoi21  g199(.a(new_n354_), .b(new_n353_), .c(new_n355_), .O(z54));
  inv1   g200(.a(x82), .O(new_n357_));
  nand3  g201(.a(new_n261_), .b(x84), .c(new_n357_), .O(new_n358_));
  inv1   g202(.a(x80), .O(new_n359_));
  nand4  g203(.a(new_n245_), .b(new_n155_), .c(new_n359_), .d(x79), .O(new_n360_));
  nor2   g204(.a(new_n360_), .b(new_n358_), .O(z55));
  inv1   g205(.a(x02), .O(new_n363_));
  nand4  g206(.a(x03), .b(new_n363_), .c(new_n168_), .d(x00), .O(new_n364_));
  inv1   g207(.a(new_n364_), .O(z57));
  nand4  g208(.a(x80), .b(new_n225_), .c(x43), .d(new_n237_), .O(new_n366_));
  oai22  g209(.a(new_n366_), .b(new_n224_), .c(new_n237_), .d(x40), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n230_), .c(x79), .O(new_n368_));
  nand4  g211(.a(new_n157_), .b(new_n154_), .c(new_n237_), .d(x40), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n368_), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g214(.a(new_n161_), .b(new_n233_), .c(new_n157_), .O(new_n372_));
  aoi21  g215(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  aoi21  g216(.a(new_n229_), .b(x79), .c(new_n175_), .O(new_n374_));
  oai21  g217(.a(new_n226_), .b(new_n224_), .c(new_n237_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(x79), .c(new_n229_), .O(new_n376_));
  oai21  g219(.a(new_n376_), .b(new_n374_), .c(x77), .O(new_n377_));
  nor2   g220(.a(x79), .b(x04), .O(new_n378_));
  inv1   g221(.a(new_n378_), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n377_), .c(x01), .O(z59));
  xor2a  g223(.a(x84), .b(x81), .O(new_n381_));
  nand2  g224(.a(new_n311_), .b(new_n162_), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n381_), .c(new_n378_), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n231_), .c(x01), .O(z60));
  inv1   g227(.a(new_n166_), .O(new_n385_));
  oai21  g228(.a(new_n163_), .b(new_n161_), .c(new_n220_), .O(new_n386_));
  nand3  g229(.a(x78), .b(x77), .c(new_n233_), .O(new_n387_));
  nand2  g230(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  inv1   g231(.a(new_n388_), .O(new_n389_));
  nor3   g232(.a(new_n389_), .b(new_n385_), .c(new_n359_), .O(z61));
  nand3  g233(.a(x84), .b(x81), .c(x79), .O(new_n391_));
  oai21  g234(.a(x79), .b(new_n233_), .c(new_n391_), .O(new_n392_));
  nand2  g235(.a(new_n392_), .b(new_n153_), .O(new_n393_));
  nand2  g236(.a(new_n375_), .b(x79), .O(new_n394_));
  nand3  g237(.a(x81), .b(x79), .c(new_n233_), .O(new_n395_));
  inv1   g238(.a(new_n395_), .O(new_n396_));
  aoi21  g239(.a(new_n394_), .b(x04), .c(new_n396_), .O(new_n397_));
  oai21  g240(.a(new_n397_), .b(new_n153_), .c(new_n393_), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(x78), .O(new_n399_));
  inv1   g242(.a(new_n391_), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(new_n163_), .O(new_n401_));
  aoi21  g244(.a(new_n401_), .b(new_n399_), .c(x01), .O(z62));
  nor3   g245(.a(new_n389_), .b(new_n385_), .c(new_n357_), .O(z63));
  nand3  g246(.a(new_n388_), .b(x83), .c(x79), .O(new_n404_));
  aoi21  g247(.a(new_n404_), .b(new_n307_), .c(x01), .O(z64));
  nor2   g248(.a(new_n154_), .b(x04), .O(new_n406_));
  nor2   g249(.a(new_n241_), .b(x78), .O(new_n407_));
  oai21  g250(.a(new_n407_), .b(new_n406_), .c(x77), .O(new_n408_));
  nand2  g251(.a(new_n161_), .b(x81), .O(new_n409_));
  nand2  g252(.a(new_n166_), .b(x84), .O(new_n410_));
  aoi21  g253(.a(new_n409_), .b(new_n408_), .c(new_n410_), .O(z65));
  zero   g254(.O(z00));
  zero   g255(.O(z07));
  zero   g256(.O(z17));
  zero   g257(.O(z24));
