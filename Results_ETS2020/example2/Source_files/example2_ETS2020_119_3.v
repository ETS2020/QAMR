...
module FAU ( 
  ...
  nand4  g090(.a(new_n244_), .b(new_n234_), .c(x45), .d(new_n237_), .O(new_n248_));
  inv1   g091(.a(new_n248_), .O(z27));
  nand4  g092(.a(new_n244_), .b(new_n234_), .c(x46), .d(new_n237_), .O(new_n250_));
  inv1   g093(.a(new_n250_), .O(z28));
  nand4  g094(.a(new_n244_), .b(new_n234_), .c(x48), .d(new_n237_), .O(new_n253_));
  ...
  nor3   g130(.a(new_n281_), .b(new_n235_), .c(new_n195_), .O(z39));
  nor3   g131(.a(new_n281_), .b(new_n235_), .c(new_n192_), .O(z40));
  nor3   g132(.a(new_n281_), .b(new_n235_), .c(new_n189_), .O(z41));
  nor3   g133(.a(new_n281_), .b(new_n235_), .c(new_n186_), .O(z42));
  nor3   g134(.a(new_n281_), .b(new_n235_), .c(new_n183_), .O(z43));
  nor3   g135(.a(new_n281_), .b(new_n235_), .c(new_n180_), .O(z44));
  nor3   g136(.a(new_n281_), .b(new_n235_), .c(new_n177_), .O(z45));
  nor3   g137(.a(new_n281_), .b(new_n235_), .c(new_n174_), .O(z46));
  ...
  nand4  g200(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n361_));
  oai22  g201(.a(new_n361_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n362_));
  nand3  g202(.a(new_n362_), .b(new_n226_), .c(x79), .O(new_n363_));
  nand4  g203(.a(new_n157_), .b(new_n154_), .c(new_n237_), .d(x40), .O(new_n364_));
  ...
  aoi21  g208(.a(new_n225_), .b(x79), .c(new_n173_), .O(new_n369_));
  oai21  g209(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n370_));
  ...
  nor2   g241(.a(new_n241_), .b(x78), .O(new_n402_));
