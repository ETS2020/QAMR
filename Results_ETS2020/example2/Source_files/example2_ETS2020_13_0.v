// Benchmark "FAU" written by ABC on Sat Jun 27 01:50:14 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n265_, new_n269_, new_n271_, new_n272_, new_n273_, new_n274_,
    ...
    new_n348_, new_n351_, new_n352_, new_n353_, new_n354_, new_n357_,
  ...
  nand4  g113(.a(new_n256_), .b(new_n244_), .c(x50), .d(new_n247_), .O(new_n269_));
  inv1   g114(.a(new_n269_), .O(z32));
  xnor2a g115(.a(x83), .b(x81), .O(new_n271_));
  nand2  g116(.a(x42), .b(x05), .O(new_n272_));
  nand2  g117(.a(x51), .b(new_n247_), .O(new_n273_));
  oai22  g118(.a(new_n273_), .b(new_n251_), .c(new_n272_), .d(new_n271_), .O(new_n274_));
  nand2  g119(.a(new_n274_), .b(new_n249_), .O(new_n275_));
  xor2a  g120(.a(x83), .b(x81), .O(new_n276_));
  oai22  g121(.a(new_n276_), .b(new_n272_), .c(new_n273_), .d(x81), .O(new_n277_));
  nand2  g122(.a(new_n277_), .b(new_n253_), .O(new_n278_));
  inv1   g123(.a(new_n255_), .O(new_n279_));
  ...
  nand2  g128(.a(new_n283_), .b(new_n251_), .O(new_n284_));
  nand3  g129(.a(x83), .b(x81), .c(x42), .O(new_n285_));
  aoi21  g130(.a(new_n285_), .b(new_n284_), .c(new_n252_), .O(new_n286_));
  nand2  g131(.a(new_n283_), .b(x81), .O(new_n287_));
  nand3  g132(.a(x83), .b(new_n251_), .c(x42), .O(new_n288_));
  aoi21  g133(.a(new_n288_), .b(new_n287_), .c(new_n248_), .O(new_n289_));
  oai21  g134(.a(new_n289_), .b(new_n286_), .c(new_n279_), .O(new_n290_));
  nor3   g135(.a(new_n290_), .b(new_n245_), .c(new_n282_), .O(z34));
  nand2  g136(.a(new_n244_), .b(x53), .O(new_n292_));
  nor2   g137(.a(new_n292_), .b(new_n290_), .O(z35));
  nand2  g138(.a(new_n244_), .b(x54), .O(new_n294_));
  nor2   g139(.a(new_n294_), .b(new_n290_), .O(z36));
  nand2  g140(.a(new_n244_), .b(x55), .O(new_n296_));
  nor2   g141(.a(new_n296_), .b(new_n290_), .O(z37));
  nand2  g142(.a(new_n244_), .b(x56), .O(new_n298_));
  nor2   g143(.a(new_n298_), .b(new_n290_), .O(z38));
  nor3   g144(.a(new_n290_), .b(new_n245_), .c(new_n197_), .O(z39));
  nor3   g145(.a(new_n290_), .b(new_n245_), .c(new_n194_), .O(z40));
  nor3   g146(.a(new_n290_), .b(new_n245_), .c(new_n191_), .O(z41));
  nor3   g147(.a(new_n290_), .b(new_n245_), .c(new_n188_), .O(z42));
  nor3   g148(.a(new_n290_), .b(new_n245_), .c(new_n185_), .O(z43));
  nor3   g149(.a(new_n290_), .b(new_n245_), .c(new_n182_), .O(z44));
  nor3   g150(.a(new_n290_), .b(new_n245_), .c(new_n179_), .O(z45));
  nor3   g151(.a(new_n290_), .b(new_n245_), .c(new_n176_), .O(z46));
  inv1   g152(.a(x07), .O(new_n308_));
  nand2  g153(.a(x52), .b(x15), .O(new_n309_));
  oai21  g154(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand3  g155(.a(new_n234_), .b(new_n167_), .c(new_n163_), .O(new_n311_));
  inv1   g156(.a(new_n311_), .O(new_n312_));
  nand2  g157(.a(new_n312_), .b(new_n310_), .O(new_n313_));
  nor2   g158(.a(x75), .b(x67), .O(new_n314_));
  nand3  g159(.a(x79), .b(new_n154_), .c(x77), .O(new_n315_));
  nor2   g160(.a(new_n315_), .b(new_n314_), .O(new_n316_));
  nand2  g161(.a(new_n316_), .b(new_n223_), .O(new_n317_));
  aoi21  g162(.a(new_n317_), .b(new_n313_), .c(x01), .O(z47));
  inv1   g163(.a(x08), .O(new_n319_));
  nand2  g164(.a(x52), .b(x16), .O(new_n320_));
  oai21  g165(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g166(.a(new_n321_), .b(new_n312_), .O(new_n322_));
  nor2   g167(.a(new_n315_), .b(new_n222_), .O(new_n323_));
  nand2  g168(.a(new_n323_), .b(x68), .O(new_n324_));
  aoi21  g169(.a(new_n324_), .b(new_n322_), .c(x01), .O(z48));
  inv1   g170(.a(x09), .O(new_n326_));
  nand2  g171(.a(x52), .b(x17), .O(new_n327_));
  oai21  g172(.a(x52), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g173(.a(new_n328_), .b(new_n312_), .O(new_n329_));
  ...
  nand2  g179(.a(new_n334_), .b(new_n312_), .O(new_n335_));
  ...
  nand2  g185(.a(new_n340_), .b(new_n312_), .O(new_n341_));
  ...
  nand2  g191(.a(new_n346_), .b(new_n312_), .O(new_n347_));
  nand2  g192(.a(new_n323_), .b(x72), .O(new_n348_));
  aoi21  g193(.a(new_n348_), .b(new_n347_), .c(x01), .O(z52));
  nand2  g194(.a(x52), .b(x22), .O(new_n351_));
  nand2  g195(.a(new_n282_), .b(x14), .O(new_n352_));
  inv1   g196(.a(new_n164_), .O(new_n353_));
  nand4  g197(.a(new_n353_), .b(new_n167_), .c(x04), .d(new_n153_), .O(new_n354_));
  aoi21  g198(.a(new_n352_), .b(new_n351_), .c(new_n354_), .O(z54));
  inv1   g199(.a(new_n242_), .O(new_n357_));
  xnor2a g200(.a(x84), .b(x81), .O(new_n358_));
  aoi21  g201(.a(new_n165_), .b(new_n164_), .c(new_n358_), .O(new_n359_));
  aoi22  g202(.a(new_n359_), .b(new_n153_), .c(new_n357_), .d(x76), .O(new_n360_));
  aoi21  g203(.a(new_n154_), .b(new_n163_), .c(new_n238_), .O(new_n361_));
  oai21  g204(.a(new_n360_), .b(new_n167_), .c(new_n361_), .O(z56));
  inv1   g205(.a(x02), .O(new_n363_));
  nand3  g206(.a(new_n239_), .b(x03), .c(new_n363_), .O(new_n364_));
  inv1   g207(.a(new_n364_), .O(z57));
  nand2  g208(.a(x42), .b(new_n152_), .O(new_n366_));
  nand4  g209(.a(x80), .b(new_n228_), .c(x43), .d(new_n247_), .O(new_n367_));
  oai21  g210(.a(new_n367_), .b(new_n227_), .c(new_n366_), .O(new_n368_));
  nand3  g211(.a(x79), .b(x78), .c(x04), .O(new_n369_));
  inv1   g212(.a(new_n369_), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand4  g214(.a(new_n167_), .b(new_n154_), .c(new_n247_), .d(x40), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(new_n371_), .O(new_n373_));
  nand2  g216(.a(new_n373_), .b(x77), .O(new_n374_));
  oai21  g217(.a(new_n353_), .b(new_n233_), .c(new_n167_), .O(new_n375_));
  aoi21  g218(.a(new_n375_), .b(new_n374_), .c(x01), .O(z58));
  nand2  g219(.a(new_n234_), .b(new_n230_), .O(new_n378_));
  inv1   g220(.a(new_n378_), .O(new_n379_));
  oai21  g221(.a(new_n229_), .b(new_n227_), .c(new_n379_), .O(new_n380_));
  aoi21  g222(.a(new_n154_), .b(x04), .c(x79), .O(new_n381_));
  aoi21  g223(.a(new_n359_), .b(x79), .c(new_n381_), .O(new_n382_));
  aoi21  g224(.a(new_n382_), .b(new_n380_), .c(x01), .O(z60));
  nand2  g225(.a(new_n165_), .b(new_n164_), .O(new_n384_));
  aoi22  g226(.a(new_n384_), .b(new_n223_), .c(new_n242_), .d(new_n233_), .O(new_n385_));
  nand2  g227(.a(new_n168_), .b(x80), .O(new_n386_));
  nor2   g228(.a(new_n386_), .b(new_n385_), .O(z61));
  nand2  g229(.a(x78), .b(new_n233_), .O(new_n388_));
  nand2  g230(.a(x84), .b(new_n154_), .O(new_n389_));
  aoi21  g231(.a(new_n389_), .b(new_n388_), .c(new_n163_), .O(new_n390_));
  nand2  g232(.a(new_n353_), .b(x84), .O(new_n391_));
  inv1   g233(.a(new_n391_), .O(new_n392_));
  nor2   g234(.a(new_n251_), .b(new_n167_), .O(new_n393_));
  oai21  g235(.a(new_n392_), .b(new_n390_), .c(new_n393_), .O(new_n394_));
  aoi21  g236(.a(new_n394_), .b(new_n235_), .c(x01), .O(z62));
  nand2  g237(.a(new_n168_), .b(x82), .O(new_n396_));
  nor2   g238(.a(new_n396_), .b(new_n385_), .O(z63));
  oai21  g239(.a(new_n251_), .b(x78), .c(new_n388_), .O(new_n399_));
  nand2  g240(.a(new_n399_), .b(x77), .O(new_n400_));
  nand2  g241(.a(new_n353_), .b(x81), .O(new_n401_));
  nand2  g242(.a(new_n168_), .b(x84), .O(new_n402_));
  aoi21  g243(.a(new_n401_), .b(new_n400_), .c(new_n402_), .O(z65));
  zero   g244(.O(z01));
  zero   g245(.O(z19));
  zero   g246(.O(z30));
  zero   g247(.O(z31));
