...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n273_, new_n275_, new_n292_, new_n293_, new_n294_, new_n295_,
  ...
  nor2   g112(.a(new_n273_), .b(new_n268_), .O(z37));
  nand2  g113(.a(new_n220_), .b(x56), .O(new_n275_));
  nor2   g114(.a(new_n275_), .b(new_n268_), .O(z38));
  nor3   g115(.a(new_n268_), .b(new_n221_), .c(new_n194_), .O(z39));
  nor3   g116(.a(new_n268_), .b(new_n221_), .c(new_n191_), .O(z40));
  nor3   g117(.a(new_n268_), .b(new_n221_), .c(new_n188_), .O(z41));
  nor3   g118(.a(new_n268_), .b(new_n221_), .c(new_n185_), .O(z42));
  nor3   g119(.a(new_n268_), .b(new_n221_), .c(new_n182_), .O(z43));
  nor3   g120(.a(new_n268_), .b(new_n221_), .c(new_n179_), .O(z44));
  nor3   g121(.a(new_n268_), .b(new_n221_), .c(new_n176_), .O(z45));
  nor3   g122(.a(new_n268_), .b(new_n221_), .c(new_n173_), .O(z46));
  nand2  g123(.a(x52), .b(x22), .O(new_n292_));
  nand2  g124(.a(new_n259_), .b(x14), .O(new_n293_));
  nor2   g125(.a(new_n154_), .b(x77), .O(new_n294_));
  nand4  g126(.a(new_n294_), .b(new_n162_), .c(x04), .d(new_n153_), .O(new_n295_));
  aoi21  g127(.a(new_n293_), .b(new_n292_), .c(new_n295_), .O(z54));
  inv1   g128(.a(x82), .O(new_n297_));
  nand3  g129(.a(new_n246_), .b(x84), .c(new_n297_), .O(new_n298_));
  inv1   g130(.a(x80), .O(new_n299_));
  nand4  g131(.a(new_n220_), .b(new_n163_), .c(new_n299_), .d(x79), .O(new_n300_));
  nor2   g132(.a(new_n300_), .b(new_n298_), .O(z55));
  aoi21  g133(.a(x84), .b(new_n227_), .c(x76), .O(new_n302_));
  oai21  g134(.a(x84), .b(new_n227_), .c(new_n302_), .O(new_n303_));
  nand2  g135(.a(new_n303_), .b(new_n164_), .O(new_n304_));
  nand4  g136(.a(new_n304_), .b(new_n161_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g137(.a(x84), .b(new_n245_), .c(x82), .d(x81), .O(new_n307_));
  inv1   g138(.a(x74), .O(new_n308_));
  nand4  g139(.a(x80), .b(new_n308_), .c(x43), .d(new_n223_), .O(new_n309_));
  oai22  g140(.a(new_n309_), .b(new_n307_), .c(new_n223_), .d(x40), .O(new_n310_));
  nand2  g141(.a(x78), .b(x04), .O(new_n311_));
  inv1   g142(.a(new_n311_), .O(new_n312_));
  nand3  g143(.a(new_n312_), .b(new_n310_), .c(x79), .O(new_n313_));
  nand4  g144(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n314_));
  nand2  g145(.a(new_n314_), .b(new_n313_), .O(new_n315_));
  nand2  g146(.a(new_n315_), .b(x77), .O(new_n316_));
  oai21  g147(.a(new_n294_), .b(new_n216_), .c(new_n162_), .O(new_n317_));
  aoi21  g148(.a(new_n317_), .b(new_n316_), .c(x01), .O(z58));
  aoi21  g149(.a(new_n311_), .b(x79), .c(new_n152_), .O(new_n319_));
  nand3  g150(.a(x80), .b(new_n308_), .c(x43), .O(new_n320_));
  oai21  g151(.a(new_n320_), .b(new_n307_), .c(new_n223_), .O(new_n321_));
  aoi21  g152(.a(new_n321_), .b(x79), .c(new_n311_), .O(new_n322_));
  oai21  g153(.a(new_n322_), .b(new_n319_), .c(x77), .O(new_n323_));
  nand2  g154(.a(new_n162_), .b(new_n216_), .O(new_n324_));
  aoi21  g155(.a(new_n324_), .b(new_n323_), .c(x01), .O(z59));
  xnor2a g156(.a(x84), .b(x81), .O(new_n327_));
  nor2   g157(.a(x78), .b(new_n160_), .O(new_n328_));
  oai21  g158(.a(new_n328_), .b(new_n294_), .c(new_n327_), .O(new_n329_));
  nand2  g159(.a(new_n163_), .b(new_n216_), .O(new_n330_));
  nand2  g160(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  inv1   g161(.a(new_n331_), .O(new_n332_));
  nor2   g162(.a(new_n162_), .b(x01), .O(new_n333_));
  inv1   g163(.a(new_n333_), .O(new_n334_));
  nor3   g164(.a(new_n334_), .b(new_n332_), .c(new_n299_), .O(z61));
  nand3  g165(.a(x84), .b(x81), .c(x79), .O(new_n336_));
  oai21  g166(.a(x79), .b(new_n216_), .c(new_n336_), .O(new_n337_));
  nand2  g167(.a(new_n337_), .b(new_n160_), .O(new_n338_));
  nand2  g168(.a(new_n321_), .b(x79), .O(new_n339_));
  nand3  g169(.a(x81), .b(x79), .c(new_n216_), .O(new_n340_));
  inv1   g170(.a(new_n340_), .O(new_n341_));
  aoi21  g171(.a(new_n339_), .b(x04), .c(new_n341_), .O(new_n342_));
  oai21  g172(.a(new_n342_), .b(new_n160_), .c(new_n338_), .O(new_n343_));
  nand2  g173(.a(new_n343_), .b(x78), .O(new_n344_));
  inv1   g174(.a(new_n336_), .O(new_n345_));
  nand2  g175(.a(new_n345_), .b(new_n328_), .O(new_n346_));
  aoi21  g176(.a(new_n346_), .b(new_n344_), .c(x01), .O(z62));
  nor3   g177(.a(new_n334_), .b(new_n332_), .c(new_n297_), .O(z63));
  nand3  g178(.a(new_n331_), .b(x83), .c(x79), .O(new_n349_));
  nand3  g179(.a(new_n155_), .b(new_n160_), .c(x04), .O(new_n350_));
  aoi21  g180(.a(new_n350_), .b(new_n349_), .c(x01), .O(z64));
  nor2   g181(.a(new_n154_), .b(x04), .O(new_n352_));
  nor2   g182(.a(new_n227_), .b(x78), .O(new_n353_));
  oai21  g183(.a(new_n353_), .b(new_n352_), .c(x77), .O(new_n354_));
  nand2  g184(.a(new_n294_), .b(x81), .O(new_n355_));
  nand2  g185(.a(new_n333_), .b(x84), .O(new_n356_));
