// Benchmark "FAU" written by ABC on Sat Jun 27 02:06:51 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n231_, new_n232_, new_n235_, new_n238_, new_n240_, new_n242_,
  ...
  inv1   g135(.a(x14), .O(new_n314_));
  nor2   g136(.a(x52), .b(new_n314_), .O(new_n315_));
  aoi21  g137(.a(x52), .b(x22), .c(new_n315_), .O(new_n316_));
  nand2  g138(.a(x04), .b(new_n153_), .O(new_n317_));
  nor4   g139(.a(new_n317_), .b(new_n316_), .c(new_n168_), .d(x79), .O(z54));
  nand2  g140(.a(x84), .b(x83), .O(new_n319_));
  nor2   g141(.a(x80), .b(new_n154_), .O(new_n320_));
  nand3  g142(.a(new_n320_), .b(new_n231_), .c(new_n161_), .O(new_n321_));
  nor4   g143(.a(new_n321_), .b(new_n319_), .c(x82), .d(x81), .O(z55));
  inv1   g144(.a(new_n161_), .O(new_n323_));
  xnor2a g145(.a(x84), .b(x81), .O(new_n324_));
  aoi21  g146(.a(new_n169_), .b(new_n168_), .c(new_n324_), .O(new_n325_));
  aoi22  g147(.a(new_n325_), .b(new_n153_), .c(new_n323_), .d(x76), .O(new_n326_));
  inv1   g148(.a(x00), .O(new_n327_));
  nor3   g149(.a(new_n163_), .b(x01), .c(new_n327_), .O(new_n328_));
  oai21  g150(.a(new_n326_), .b(new_n154_), .c(new_n328_), .O(z56));
  inv1   g151(.a(x02), .O(new_n330_));
  nand4  g152(.a(x03), .b(new_n330_), .c(new_n153_), .d(x00), .O(new_n331_));
  inv1   g153(.a(new_n331_), .O(z57));
  nand2  g154(.a(new_n154_), .b(new_n160_), .O(new_n334_));
  aoi21  g155(.a(new_n217_), .b(new_n334_), .c(new_n152_), .O(new_n335_));
  oai21  g156(.a(new_n213_), .b(new_n211_), .c(new_n223_), .O(new_n336_));
  aoi21  g157(.a(new_n336_), .b(x79), .c(new_n217_), .O(new_n337_));
  oai21  g158(.a(new_n337_), .b(new_n335_), .c(x77), .O(new_n338_));
  nor2   g159(.a(x79), .b(x04), .O(new_n339_));
  inv1   g160(.a(new_n339_), .O(new_n340_));
  aoi21  g161(.a(new_n340_), .b(new_n338_), .c(x01), .O(z59));
  aoi21  g162(.a(new_n325_), .b(x79), .c(new_n339_), .O(new_n342_));
  aoi21  g163(.a(new_n342_), .b(new_n219_), .c(x01), .O(z60));
  aoi21  g164(.a(new_n169_), .b(new_n168_), .c(new_n206_), .O(new_n347_));
  nor2   g165(.a(new_n323_), .b(x04), .O(new_n348_));
  nor2   g166(.a(new_n210_), .b(new_n154_), .O(new_n349_));
  oai21  g167(.a(new_n348_), .b(new_n347_), .c(new_n349_), .O(new_n350_));
  aoi21  g168(.a(new_n350_), .b(new_n278_), .c(x01), .O(z64));
  zero   g169(.O(z03));
  zero   g170(.O(z05));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
