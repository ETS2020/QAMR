...
module FAU ( 
  ...
  nor3   g140(.a(new_n284_), .b(new_n237_), .c(new_n182_), .O(z44));
  nor3   g141(.a(new_n284_), .b(new_n237_), .c(new_n179_), .O(z45));
  nor3   g142(.a(new_n284_), .b(new_n237_), .c(new_n176_), .O(z46));
  ...
  nand2  g194(.a(new_n275_), .b(x14), .O(new_n352_));
  ...
  nand3  g198(.a(new_n262_), .b(x84), .c(new_n355_), .O(new_n356_));
