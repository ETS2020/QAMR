...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n272_, new_n275_, new_n283_, new_n286_, new_n287_, new_n288_,
  ...
  nor3   g115(.a(new_n268_), .b(new_n221_), .c(new_n192_), .O(z39));
  nor3   g116(.a(new_n268_), .b(new_n221_), .c(new_n189_), .O(z40));
  nor3   g117(.a(new_n268_), .b(new_n221_), .c(new_n186_), .O(z41));
  nor3   g118(.a(new_n268_), .b(new_n221_), .c(new_n183_), .O(z42));
  nor3   g119(.a(new_n268_), .b(new_n221_), .c(new_n180_), .O(z43));
  nor3   g120(.a(new_n268_), .b(new_n221_), .c(new_n177_), .O(z44));
  nand2  g121(.a(new_n220_), .b(x63), .O(new_n283_));
  nor2   g122(.a(new_n283_), .b(new_n268_), .O(z45));
  nor3   g123(.a(new_n268_), .b(new_n221_), .c(new_n173_), .O(z46));
  ...
  nand4  g143(.a(new_n220_), .b(new_n163_), .c(new_n310_), .d(x79), .O(new_n311_));
  nor2   g144(.a(new_n311_), .b(new_n309_), .O(z55));
  aoi21  g145(.a(x84), .b(new_n227_), .c(x76), .O(new_n313_));
  oai21  g146(.a(x84), .b(new_n227_), .c(new_n313_), .O(new_n314_));
  ...
  nand4  g151(.a(x80), .b(new_n319_), .c(x43), .d(new_n223_), .O(new_n320_));
  oai22  g152(.a(new_n320_), .b(new_n318_), .c(new_n223_), .d(x40), .O(new_n321_));
  nand2  g153(.a(x78), .b(x04), .O(new_n322_));
  inv1   g154(.a(new_n322_), .O(new_n323_));
  nand3  g155(.a(new_n323_), .b(new_n321_), .c(x79), .O(new_n324_));
  nand4  g156(.a(new_n162_), .b(new_n154_), .c(new_n223_), .d(x40), .O(new_n325_));
  nand2  g157(.a(new_n325_), .b(new_n324_), .O(new_n326_));
  nand2  g158(.a(new_n326_), .b(x77), .O(new_n327_));
  oai21  g159(.a(new_n305_), .b(new_n216_), .c(new_n162_), .O(new_n328_));
  ...
  oai21  g176(.a(x79), .b(new_n216_), .c(new_n345_), .O(new_n346_));
  nand2  g177(.a(new_n346_), .b(new_n160_), .O(new_n347_));
  nand2  g178(.a(new_n332_), .b(x79), .O(new_n348_));
  nand3  g179(.a(x81), .b(x79), .c(new_n216_), .O(new_n349_));
  ...
  nor2   g191(.a(new_n227_), .b(x78), .O(new_n361_));
