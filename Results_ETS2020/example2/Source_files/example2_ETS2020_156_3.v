...
module FAU ( 
  ...
  nand2  g146(.a(new_n305_), .b(new_n232_), .O(new_n306_));
  inv1   g147(.a(new_n306_), .O(new_n307_));
  nand2  g148(.a(new_n307_), .b(new_n304_), .O(new_n308_));
  inv1   g149(.a(x67), .O(new_n309_));
  nand2  g150(.a(new_n163_), .b(x79), .O(new_n310_));
  aoi21  g151(.a(new_n160_), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g152(.a(new_n311_), .b(new_n222_), .O(new_n312_));
  ...
  inv1   g158(.a(new_n222_), .O(new_n318_));
  ...
  nand2  g189(.a(new_n348_), .b(new_n307_), .O(new_n349_));
  nand2  g190(.a(new_n319_), .b(x73), .O(new_n350_));
  aoi21  g191(.a(new_n350_), .b(new_n349_), .c(x01), .O(z53));
  nand2  g192(.a(x52), .b(x22), .O(new_n352_));
  nand2  g193(.a(new_n276_), .b(x14), .O(new_n353_));
  nand4  g194(.a(new_n161_), .b(new_n157_), .c(x04), .d(new_n168_), .O(new_n354_));
  aoi21  g195(.a(new_n353_), .b(new_n352_), .c(new_n354_), .O(z54));
  inv1   g196(.a(x82), .O(new_n356_));
  nand3  g197(.a(new_n263_), .b(x84), .c(new_n356_), .O(new_n357_));
  inv1   g198(.a(x80), .O(new_n358_));
  nand4  g199(.a(new_n240_), .b(new_n155_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g200(.a(new_n359_), .b(new_n357_), .O(z55));
  inv1   g201(.a(x02), .O(new_n362_));
  nand4  g202(.a(x03), .b(new_n362_), .c(new_n168_), .d(x00), .O(new_n363_));
  inv1   g203(.a(new_n363_), .O(z57));
  nand4  g204(.a(x80), .b(new_n227_), .c(x43), .d(new_n246_), .O(new_n365_));
  oai22  g205(.a(new_n365_), .b(new_n226_), .c(new_n246_), .d(x40), .O(new_n366_));
  nand3  g206(.a(new_n366_), .b(new_n232_), .c(x79), .O(new_n367_));
  nand4  g207(.a(new_n157_), .b(new_n154_), .c(new_n246_), .d(x40), .O(new_n368_));
  nand2  g208(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(x77), .O(new_n370_));
  oai21  g210(.a(new_n161_), .b(new_n235_), .c(new_n157_), .O(new_n371_));
  aoi21  g211(.a(new_n371_), .b(new_n370_), .c(x01), .O(z58));
  aoi21  g212(.a(new_n231_), .b(x79), .c(new_n175_), .O(new_n373_));
  oai21  g213(.a(new_n228_), .b(new_n226_), .c(new_n246_), .O(new_n374_));
  aoi21  g214(.a(new_n374_), .b(x79), .c(new_n231_), .O(new_n375_));
  ...
  nand2  g220(.a(new_n310_), .b(new_n162_), .O(new_n381_));
  aoi21  g221(.a(new_n381_), .b(new_n380_), .c(new_n377_), .O(new_n382_));
  aoi21  g222(.a(new_n382_), .b(new_n233_), .c(x01), .O(z60));
  inv1   g223(.a(new_n166_), .O(new_n384_));
  oai21  g224(.a(new_n163_), .b(new_n161_), .c(new_n222_), .O(new_n385_));
  nand2  g225(.a(new_n155_), .b(new_n235_), .O(new_n386_));
  nand2  g226(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  inv1   g227(.a(new_n387_), .O(new_n388_));
  nor3   g228(.a(new_n388_), .b(new_n384_), .c(new_n358_), .O(z61));
  nand3  g229(.a(x84), .b(x81), .c(x79), .O(new_n390_));
  oai21  g230(.a(x79), .b(new_n235_), .c(new_n390_), .O(new_n391_));
  nand2  g231(.a(new_n391_), .b(new_n153_), .O(new_n392_));
  nand2  g232(.a(new_n374_), .b(x79), .O(new_n393_));
  nand3  g233(.a(x81), .b(x79), .c(new_n235_), .O(new_n394_));
  ...
  nand2  g239(.a(new_n399_), .b(new_n163_), .O(new_n400_));
  aoi21  g240(.a(new_n400_), .b(new_n398_), .c(x01), .O(z62));
  nor3   g241(.a(new_n388_), .b(new_n384_), .c(new_n356_), .O(z63));
  nand3  g242(.a(new_n387_), .b(x83), .c(x79), .O(new_n403_));
  aoi21  g243(.a(new_n403_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g244(.a(new_n154_), .b(x04), .O(new_n405_));
  nor2   g245(.a(new_n250_), .b(x78), .O(new_n406_));
  oai21  g246(.a(new_n406_), .b(new_n405_), .c(x77), .O(new_n407_));
  nand2  g247(.a(new_n161_), .b(x81), .O(new_n408_));
  nand2  g248(.a(new_n166_), .b(x84), .O(new_n409_));
