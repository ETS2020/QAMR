...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n264_, new_n266_, new_n268_, new_n270_, new_n273_, new_n274_,
  ...
  nand4  g114(.a(new_n259_), .b(new_n246_), .c(x48), .d(new_n250_), .O(new_n268_));
  inv1   g115(.a(new_n268_), .O(z30));
  nand4  g116(.a(new_n259_), .b(new_n246_), .c(x49), .d(new_n250_), .O(new_n270_));
  ...
  nand2  g141(.a(new_n246_), .b(x55), .O(new_n297_));
  ...
  nand4  g216(.a(x80), .b(new_n230_), .c(x43), .d(new_n250_), .O(new_n373_));
  ...
  nand4  g221(.a(new_n167_), .b(new_n154_), .c(new_n250_), .d(x40), .O(new_n378_));
  ...
  nor2   g241(.a(new_n254_), .b(new_n167_), .O(new_n399_));
  ...
  oai21  g246(.a(new_n254_), .b(x78), .c(new_n394_), .O(new_n405_));
