...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n238_, new_n240_, new_n243_, new_n248_, new_n249_, new_n250_,
    new_n251_, new_n252_, new_n253_, new_n254_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n274_, new_n276_, new_n278_, new_n288_,
  ...
  nand2  g113(.a(new_n224_), .b(x54), .O(new_n274_));
  nor2   g114(.a(new_n274_), .b(new_n271_), .O(z36));
  ...
  nor3   g119(.a(new_n271_), .b(new_n225_), .c(new_n194_), .O(z39));
  nor3   g120(.a(new_n271_), .b(new_n225_), .c(new_n191_), .O(z40));
  nor3   g121(.a(new_n271_), .b(new_n225_), .c(new_n188_), .O(z41));
  nor3   g122(.a(new_n271_), .b(new_n225_), .c(new_n185_), .O(z42));
  nor3   g123(.a(new_n271_), .b(new_n225_), .c(new_n182_), .O(z43));
  nor3   g124(.a(new_n271_), .b(new_n225_), .c(new_n179_), .O(z44));
  nor3   g125(.a(new_n271_), .b(new_n225_), .c(new_n176_), .O(z45));
  nor3   g126(.a(new_n271_), .b(new_n225_), .c(new_n173_), .O(z46));
  ...
  nand2  g139(.a(new_n262_), .b(x14), .O(new_n306_));
  ...
  nand3  g144(.a(new_n249_), .b(x84), .c(new_n310_), .O(new_n311_));
  ...
  nand4  g152(.a(x84), .b(new_n248_), .c(x82), .d(x81), .O(new_n320_));
