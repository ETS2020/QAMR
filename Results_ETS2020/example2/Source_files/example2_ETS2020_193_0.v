// Benchmark "FAU" written by ABC on Sat Jun 27 02:03:37 2020
...
module FAU ( 
  ...
  nand4  g110(.a(new_n255_), .b(new_n242_), .c(x50), .d(new_n246_), .O(new_n267_));
  inv1   g111(.a(new_n267_), .O(z32));
  xnor2a g112(.a(x83), .b(x81), .O(new_n269_));
  nand2  g113(.a(x42), .b(x05), .O(new_n270_));
  nand2  g114(.a(x51), .b(new_n246_), .O(new_n271_));
  oai22  g115(.a(new_n271_), .b(new_n250_), .c(new_n270_), .d(new_n269_), .O(new_n272_));
  ...
  nand2  g119(.a(new_n275_), .b(new_n252_), .O(new_n276_));
  inv1   g120(.a(new_n254_), .O(new_n277_));
  ...
  nand2  g125(.a(new_n281_), .b(new_n250_), .O(new_n282_));
  nand3  g126(.a(x83), .b(x81), .c(x42), .O(new_n283_));
  aoi21  g127(.a(new_n283_), .b(new_n282_), .c(new_n251_), .O(new_n284_));
  nand2  g128(.a(new_n281_), .b(x81), .O(new_n285_));
  nand3  g129(.a(x83), .b(new_n250_), .c(x42), .O(new_n286_));
  aoi21  g130(.a(new_n286_), .b(new_n285_), .c(new_n247_), .O(new_n287_));
  ...
  nor3   g139(.a(new_n288_), .b(new_n243_), .c(new_n197_), .O(z39));
  nor3   g140(.a(new_n288_), .b(new_n243_), .c(new_n194_), .O(z40));
  nor3   g141(.a(new_n288_), .b(new_n243_), .c(new_n191_), .O(z41));
  nor3   g142(.a(new_n288_), .b(new_n243_), .c(new_n188_), .O(z42));
  nor3   g143(.a(new_n288_), .b(new_n243_), .c(new_n185_), .O(z43));
  nor3   g144(.a(new_n288_), .b(new_n243_), .c(new_n182_), .O(z44));
  nor3   g145(.a(new_n288_), .b(new_n243_), .c(new_n179_), .O(z45));
  nor3   g146(.a(new_n288_), .b(new_n243_), .c(new_n176_), .O(z46));
  ...
  nand2  g196(.a(new_n280_), .b(x14), .O(new_n354_));
