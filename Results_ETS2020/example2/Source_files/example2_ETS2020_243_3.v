// Benchmark "FAU" written by ABC on Sat Jun 27 02:07:19 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n172_, new_n177_, new_n178_, new_n180_, new_n181_, new_n184_,
  ...
  inv1   g032(.a(x60), .O(new_n187_));
  nand2  g033(.a(new_n152_), .b(x28), .O(new_n188_));
  oai21  g034(.a(new_n187_), .b(new_n152_), .c(new_n188_), .O(z10));
  ...
  inv1   g041(.a(x57), .O(new_n196_));
  nand2  g042(.a(new_n152_), .b(x31), .O(new_n197_));
  oai21  g043(.a(new_n196_), .b(new_n152_), .c(new_n197_), .O(z13));
  inv1   g044(.a(x33), .O(new_n200_));
  nand2  g045(.a(x50), .b(x40), .O(new_n201_));
  oai21  g046(.a(x40), .b(new_n200_), .c(new_n201_), .O(z15));
  inv1   g047(.a(x35), .O(new_n204_));
  nand2  g048(.a(x48), .b(x40), .O(new_n205_));
  oai21  g049(.a(x40), .b(new_n204_), .c(new_n205_), .O(z17));
  inv1   g050(.a(x36), .O(new_n207_));
  nand2  g051(.a(x47), .b(x40), .O(new_n208_));
  oai21  g052(.a(x40), .b(new_n207_), .c(new_n208_), .O(z18));
  inv1   g053(.a(x37), .O(new_n210_));
  nand2  g054(.a(x46), .b(x40), .O(new_n211_));
  oai21  g055(.a(x40), .b(new_n210_), .c(new_n211_), .O(z19));
  inv1   g056(.a(x39), .O(new_n214_));
  nand2  g057(.a(x44), .b(x40), .O(new_n215_));
  oai21  g058(.a(x40), .b(new_n214_), .c(new_n215_), .O(z21));
  xnor2a g059(.a(x84), .b(x81), .O(new_n217_));
  nor2   g060(.a(new_n154_), .b(x41), .O(new_n218_));
  nand3  g061(.a(new_n218_), .b(new_n217_), .c(new_n170_), .O(new_n219_));
  ...
  nand3  g074(.a(new_n231_), .b(new_n153_), .c(x00), .O(z23));
  inv1   g075(.a(x05), .O(new_n233_));
  nor2   g076(.a(new_n161_), .b(new_n154_), .O(new_n234_));
  nor2   g077(.a(x04), .b(x01), .O(new_n235_));
  inv1   g078(.a(new_n235_), .O(new_n236_));
  nor4   g079(.a(new_n236_), .b(new_n234_), .c(x43), .d(new_n233_), .O(z24));
  ...
  nand4  g090(.a(new_n245_), .b(new_n235_), .c(x45), .d(new_n238_), .O(new_n249_));
  ...
  nor2   g102(.a(new_n220_), .b(x81), .O(new_n261_));
  ...
  nor3   g125(.a(new_n283_), .b(new_n236_), .c(new_n274_), .O(z34));
  ...
  nand2  g132(.a(new_n235_), .b(x56), .O(new_n291_));
  nor2   g133(.a(new_n291_), .b(new_n283_), .O(z38));
  nor3   g134(.a(new_n283_), .b(new_n236_), .c(new_n196_), .O(z39));
  nor3   g135(.a(new_n283_), .b(new_n236_), .c(new_n193_), .O(z40));
  nor3   g136(.a(new_n283_), .b(new_n236_), .c(new_n190_), .O(z41));
  nor3   g137(.a(new_n283_), .b(new_n236_), .c(new_n187_), .O(z42));
  nor3   g138(.a(new_n283_), .b(new_n236_), .c(new_n184_), .O(z43));
  nand2  g139(.a(new_n235_), .b(x62), .O(new_n298_));
  nor2   g140(.a(new_n298_), .b(new_n283_), .O(z44));
  nor3   g141(.a(new_n283_), .b(new_n236_), .c(new_n180_), .O(z45));
  nor3   g142(.a(new_n283_), .b(new_n236_), .c(new_n177_), .O(z46));
  ...
  nand2  g147(.a(new_n305_), .b(new_n227_), .O(new_n306_));
  ...
  nand2  g153(.a(new_n311_), .b(new_n217_), .O(new_n312_));
  ...
  inv1   g159(.a(new_n217_), .O(new_n318_));
  ...
  nand2  g194(.a(new_n274_), .b(x14), .O(new_n353_));
  ...
  nand3  g198(.a(new_n261_), .b(x84), .c(new_n356_), .O(new_n357_));
  inv1   g199(.a(x80), .O(new_n358_));
  nand4  g200(.a(new_n235_), .b(new_n161_), .c(new_n358_), .d(x79), .O(new_n359_));
  ...
  nand4  g205(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n365_));
  oai22  g206(.a(new_n365_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n366_));
  nand3  g207(.a(new_n366_), .b(new_n227_), .c(x79), .O(new_n367_));
  nor2   g208(.a(x79), .b(x78), .O(new_n368_));
  nand3  g209(.a(new_n368_), .b(new_n238_), .c(x40), .O(new_n369_));
  nand2  g210(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g211(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g212(.a(new_n166_), .b(new_n230_), .c(new_n154_), .O(new_n372_));
  aoi21  g213(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  inv1   g214(.a(new_n368_), .O(new_n374_));
  aoi21  g215(.a(new_n226_), .b(new_n374_), .c(new_n152_), .O(new_n375_));
  oai21  g216(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n376_));
  aoi21  g217(.a(new_n376_), .b(x79), .c(new_n226_), .O(new_n377_));
  ...
  aoi21  g225(.a(new_n384_), .b(new_n228_), .c(x01), .O(z60));
  oai21  g226(.a(new_n168_), .b(new_n166_), .c(new_n217_), .O(new_n386_));
  nand2  g227(.a(new_n161_), .b(new_n230_), .O(new_n387_));
  ...
  oai21  g232(.a(x79), .b(new_n230_), .c(new_n391_), .O(new_n392_));
  nand2  g233(.a(new_n392_), .b(new_n159_), .O(new_n393_));
  nand2  g234(.a(new_n376_), .b(x79), .O(new_n394_));
  nand3  g235(.a(x81), .b(x79), .c(new_n230_), .O(new_n395_));
