...
module FAU ( 
  ...
  nor3   g139(.a(new_n283_), .b(new_n236_), .c(new_n181_), .O(z44));
  nor3   g140(.a(new_n283_), .b(new_n236_), .c(new_n178_), .O(z45));
  nor3   g141(.a(new_n283_), .b(new_n236_), .c(new_n175_), .O(z46));
  ...
  nand2  g152(.a(new_n310_), .b(new_n217_), .O(new_n311_));
  ...
  inv1   g158(.a(new_n217_), .O(new_n317_));
  ...
  nand4  g199(.a(new_n235_), .b(new_n155_), .c(new_n357_), .d(x79), .O(new_n358_));
  ...
  nand4  g204(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n364_));
  oai22  g205(.a(new_n364_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n365_));
  nand3  g206(.a(new_n365_), .b(new_n227_), .c(x79), .O(new_n366_));
  nand4  g207(.a(new_n157_), .b(new_n154_), .c(new_n238_), .d(x40), .O(new_n367_));
  nand2  g208(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g210(.a(new_n161_), .b(new_n230_), .c(new_n157_), .O(new_n370_));
  aoi21  g211(.a(new_n370_), .b(new_n369_), .c(x01), .O(z58));
  aoi21  g212(.a(new_n226_), .b(x79), .c(new_n174_), .O(new_n372_));
  oai21  g213(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n373_));
  aoi21  g214(.a(new_n373_), .b(x79), .c(new_n226_), .O(new_n374_));
  ...
  aoi21  g222(.a(new_n381_), .b(new_n228_), .c(x01), .O(z60));
  oai21  g223(.a(new_n163_), .b(new_n161_), .c(new_n217_), .O(new_n383_));
