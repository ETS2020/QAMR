// Benchmark "FAU" written by ABC on Sat Jun 27 01:50:24 2020
...
module FAU ( 
  ...
  aoi21  g090(.a(new_n247_), .b(new_n244_), .c(new_n156_), .O(new_n248_));
  nand4  g091(.a(new_n248_), .b(new_n236_), .c(x45), .d(new_n241_), .O(new_n249_));
  inv1   g092(.a(new_n249_), .O(z27));
  nand4  g093(.a(new_n248_), .b(new_n236_), .c(x46), .d(new_n241_), .O(new_n251_));
  inv1   g094(.a(new_n251_), .O(z28));
  nand4  g095(.a(new_n248_), .b(new_n236_), .c(x48), .d(new_n241_), .O(new_n254_));
  inv1   g096(.a(new_n254_), .O(z30));
  nand4  g097(.a(new_n248_), .b(new_n236_), .c(x49), .d(new_n241_), .O(new_n256_));
  inv1   g098(.a(new_n256_), .O(z31));
  nand4  g099(.a(new_n248_), .b(new_n236_), .c(x50), .d(new_n241_), .O(new_n258_));
  inv1   g100(.a(new_n258_), .O(z32));
  nor2   g101(.a(new_n221_), .b(x81), .O(new_n260_));
  nor2   g102(.a(x83), .b(new_n245_), .O(new_n261_));
  ...
  nor3   g133(.a(new_n282_), .b(new_n237_), .c(new_n197_), .O(z39));
  nor3   g134(.a(new_n282_), .b(new_n237_), .c(new_n194_), .O(z40));
  nor3   g135(.a(new_n282_), .b(new_n237_), .c(new_n191_), .O(z41));
  nor3   g136(.a(new_n282_), .b(new_n237_), .c(new_n188_), .O(z42));
  nor3   g137(.a(new_n282_), .b(new_n237_), .c(new_n185_), .O(z43));
  nor3   g138(.a(new_n282_), .b(new_n237_), .c(new_n182_), .O(z44));
  nor3   g139(.a(new_n282_), .b(new_n237_), .c(new_n179_), .O(z45));
  nor3   g140(.a(new_n282_), .b(new_n237_), .c(new_n176_), .O(z46));
  ...
  nand4  g203(.a(x80), .b(new_n223_), .c(x43), .d(new_n241_), .O(new_n363_));
  oai22  g204(.a(new_n363_), .b(new_n222_), .c(new_n241_), .d(x40), .O(new_n364_));
  nand3  g205(.a(new_n364_), .b(new_n228_), .c(x79), .O(new_n365_));
  nand4  g206(.a(new_n157_), .b(new_n154_), .c(new_n241_), .d(x40), .O(new_n366_));
  ...
  oai21  g212(.a(new_n224_), .b(new_n222_), .c(new_n241_), .O(new_n372_));
  ...
  nor2   g244(.a(new_n245_), .b(x78), .O(new_n404_));
