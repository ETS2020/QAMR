...
module FAU ( 
  ...
  nor3   g127(.a(new_n279_), .b(new_n233_), .c(new_n197_), .O(z39));
  nor3   g128(.a(new_n279_), .b(new_n233_), .c(new_n194_), .O(z40));
  nor3   g129(.a(new_n279_), .b(new_n233_), .c(new_n191_), .O(z41));
  nor3   g130(.a(new_n279_), .b(new_n233_), .c(new_n188_), .O(z42));
  nor3   g131(.a(new_n279_), .b(new_n233_), .c(new_n185_), .O(z43));
  nor3   g132(.a(new_n279_), .b(new_n233_), .c(new_n182_), .O(z44));
  nor3   g133(.a(new_n279_), .b(new_n233_), .c(new_n179_), .O(z45));
  nor3   g134(.a(new_n279_), .b(new_n233_), .c(new_n176_), .O(z46));
  ...
  aoi21  g205(.a(new_n223_), .b(x79), .c(new_n175_), .O(new_n367_));
