...
module FAU ( 
  ...
  nand4  g066(.a(new_n229_), .b(new_n228_), .c(x46), .d(new_n221_), .O(new_n234_));
  inv1   g067(.a(new_n234_), .O(z28));
  nand4  g068(.a(new_n229_), .b(new_n228_), .c(x47), .d(new_n221_), .O(new_n236_));
  inv1   g069(.a(new_n236_), .O(z29));
  nand4  g070(.a(new_n229_), .b(new_n228_), .c(x48), .d(new_n221_), .O(new_n238_));
  inv1   g071(.a(new_n238_), .O(z30));
  nand4  g072(.a(new_n229_), .b(new_n228_), .c(x49), .d(new_n221_), .O(new_n240_));
  inv1   g073(.a(new_n240_), .O(z31));
  nand4  g074(.a(new_n229_), .b(new_n228_), .c(x50), .d(new_n221_), .O(new_n242_));
  inv1   g075(.a(new_n242_), .O(z32));
  inv1   g076(.a(new_n162_), .O(new_n246_));
  nand2  g077(.a(x83), .b(x42), .O(new_n247_));
  nand2  g078(.a(new_n247_), .b(new_n222_), .O(new_n248_));
  inv1   g079(.a(new_n247_), .O(new_n249_));
  nand2  g080(.a(new_n249_), .b(x81), .O(new_n250_));
  aoi21  g081(.a(new_n250_), .b(new_n248_), .c(new_n225_), .O(new_n251_));
  nand2  g082(.a(new_n247_), .b(x81), .O(new_n252_));
  nand2  g083(.a(new_n249_), .b(new_n222_), .O(new_n253_));
  aoi21  g084(.a(new_n253_), .b(new_n252_), .c(new_n223_), .O(new_n254_));
  oai21  g085(.a(new_n254_), .b(new_n251_), .c(new_n246_), .O(new_n255_));
  nand2  g086(.a(new_n229_), .b(x53), .O(new_n256_));
  nor2   g087(.a(new_n256_), .b(new_n255_), .O(z35));
  nand2  g088(.a(new_n229_), .b(x54), .O(new_n258_));
  nor2   g089(.a(new_n258_), .b(new_n255_), .O(z36));
  nand2  g090(.a(new_n229_), .b(x55), .O(new_n260_));
  nor2   g091(.a(new_n260_), .b(new_n255_), .O(z37));
  nand2  g092(.a(new_n229_), .b(x56), .O(new_n262_));
  ...
  nand3  g136(.a(new_n315_), .b(new_n229_), .c(new_n161_), .O(new_n316_));
  ...
  oai21  g150(.a(new_n211_), .b(new_n209_), .c(new_n221_), .O(new_n331_));
  ...
  nor2   g163(.a(new_n160_), .b(x04), .O(new_n347_));
  nor2   g164(.a(new_n222_), .b(x78), .O(new_n348_));
  oai21  g165(.a(new_n348_), .b(new_n347_), .c(x77), .O(new_n349_));
  nand3  g166(.a(x81), .b(x78), .c(new_n159_), .O(new_n350_));
  nand2  g167(.a(new_n171_), .b(x84), .O(new_n351_));
  aoi21  g168(.a(new_n350_), .b(new_n349_), .c(new_n351_), .O(z65));
  zero   g169(.O(z03));
  zero   g170(.O(z05));
  zero   g171(.O(z06));
  zero   g172(.O(z07));
