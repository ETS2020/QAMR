...
module FAU ( 
  ...
  nor3   g136(.a(new_n286_), .b(new_n277_), .c(new_n199_), .O(z39));
  nor3   g137(.a(new_n286_), .b(new_n277_), .c(new_n196_), .O(z40));
  nor3   g138(.a(new_n286_), .b(new_n277_), .c(new_n193_), .O(z41));
  nor3   g139(.a(new_n286_), .b(new_n277_), .c(new_n190_), .O(z42));
  nor3   g140(.a(new_n286_), .b(new_n277_), .c(new_n187_), .O(z43));
  nor3   g141(.a(new_n286_), .b(new_n277_), .c(new_n184_), .O(z44));
  nor3   g142(.a(new_n286_), .b(new_n277_), .c(new_n181_), .O(z45));
  ...
  inv1   g198(.a(x84), .O(new_n357_));
  inv1   g199(.a(new_n263_), .O(new_n358_));
  nor2   g200(.a(x80), .b(new_n154_), .O(new_n359_));
  nand3  g201(.a(new_n359_), .b(new_n238_), .c(new_n161_), .O(new_n360_));
  nor4   g202(.a(new_n360_), .b(new_n358_), .c(new_n357_), .d(x82), .O(z55));
  inv1   g203(.a(x02), .O(new_n363_));
  nand4  g204(.a(x03), .b(new_n363_), .c(new_n153_), .d(x00), .O(new_n364_));
  inv1   g205(.a(new_n364_), .O(z57));
  nand4  g206(.a(x80), .b(new_n225_), .c(x43), .d(new_n242_), .O(new_n366_));
  oai22  g207(.a(new_n366_), .b(new_n224_), .c(new_n242_), .d(x40), .O(new_n367_));
  nand3  g208(.a(new_n367_), .b(new_n230_), .c(x79), .O(new_n368_));
  nor2   g209(.a(x79), .b(x78), .O(new_n369_));
  nand3  g210(.a(new_n369_), .b(new_n242_), .c(x40), .O(new_n370_));
  ...
  oai21  g217(.a(new_n226_), .b(new_n224_), .c(new_n242_), .O(new_n377_));
  ...
  oai21  g228(.a(new_n236_), .b(x04), .c(new_n387_), .O(new_n388_));
  nand2  g229(.a(new_n171_), .b(x80), .O(new_n389_));
  inv1   g230(.a(new_n389_), .O(new_n390_));
  and2   g231(.a(new_n390_), .b(new_n388_), .O(z61));
  ...
  nand3  g244(.a(new_n388_), .b(x83), .c(x79), .O(new_n405_));
  aoi21  g245(.a(new_n405_), .b(new_n307_), .c(x01), .O(z64));
