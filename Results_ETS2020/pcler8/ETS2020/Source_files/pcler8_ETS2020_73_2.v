// Benchmark "FAU" written by ABC on Tue Jun 23 02:05:27 2020
...
module FAU ( 
  ...
  nand2  g38(.a(x23), .b(x22), .O(new_n89_));
  nor3   g39(.a(new_n86_), .b(new_n89_), .c(x24), .O(new_n90_));
  aoi21  g40(.a(new_n88_), .b(x24), .c(new_n90_), .O(new_n91_));
  oai21  g41(.a(new_n91_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g42(.a(x26), .b(x17), .O(new_n93_));
  nand3  g43(.a(x24), .b(x23), .c(x22), .O(new_n94_));
  inv1   g44(.a(new_n94_), .O(new_n95_));
  nand3  g45(.a(new_n95_), .b(new_n93_), .c(new_n87_), .O(new_n96_));
  inv1   g46(.a(x25), .O(new_n97_));
  nand4  g47(.a(new_n97_), .b(x24), .c(x23), .d(x22), .O(new_n98_));
  inv1   g48(.a(new_n98_), .O(new_n99_));
  aoi22  g49(.a(new_n99_), .b(new_n87_), .c(new_n96_), .d(x25), .O(new_n100_));
  oai21  g50(.a(new_n100_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g51(.a(new_n52_), .b(x18), .O(new_n102_));
  nand3  g52(.a(new_n102_), .b(new_n49_), .c(new_n45_), .O(new_n103_));
  inv1   g53(.a(x26), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(x25), .c(x20), .d(x19), .O(new_n105_));
  nand4  g55(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n106_));
  nor2   g56(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g57(.a(new_n103_), .b(x26), .c(new_n107_), .O(new_n108_));
  oai21  g58(.a(new_n108_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g59(.O(z03));
  zero   g60(.O(z04));
  zero   g61(.O(z05));
  zero   g62(.O(z11));
