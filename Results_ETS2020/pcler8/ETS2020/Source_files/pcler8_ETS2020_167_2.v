...
module FAU ( 
  ...
  oai22  g26(.a(new_n74_), .b(new_n72_), .c(new_n57_), .d(new_n56_), .O(z09));
  nand3  g27(.a(x22), .b(x21), .c(x12), .O(new_n76_));
  oai21  g28(.a(new_n76_), .b(new_n69_), .c(x19), .O(new_n77_));
  nor2   g29(.a(x20), .b(new_n52_), .O(new_n78_));
  aoi21  g30(.a(new_n77_), .b(x20), .c(new_n78_), .O(new_n79_));
  oai22  g31(.a(new_n79_), .b(new_n74_), .c(new_n57_), .d(new_n59_), .O(z10));
  nand3  g32(.a(x26), .b(x25), .c(x16), .O(new_n84_));
  nand3  g33(.a(x21), .b(x20), .c(x19), .O(new_n85_));
  inv1   g34(.a(new_n85_), .O(new_n86_));
  nand4  g35(.a(new_n86_), .b(new_n84_), .c(x23), .d(x22), .O(new_n87_));
  nand2  g36(.a(x23), .b(x22), .O(new_n88_));
  nor3   g37(.a(new_n85_), .b(new_n88_), .c(x24), .O(new_n89_));
  aoi21  g38(.a(new_n87_), .b(x24), .c(new_n89_), .O(new_n90_));
  oai21  g39(.a(new_n90_), .b(new_n74_), .c(new_n64_), .O(z14));
  nand2  g40(.a(x26), .b(x17), .O(new_n92_));
  nand3  g41(.a(x24), .b(x23), .c(x22), .O(new_n93_));
  inv1   g42(.a(new_n93_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n86_), .O(new_n95_));
  inv1   g44(.a(x25), .O(new_n96_));
  nand4  g45(.a(new_n96_), .b(x24), .c(x23), .d(x22), .O(new_n97_));
  inv1   g46(.a(new_n97_), .O(new_n98_));
  aoi22  g47(.a(new_n98_), .b(new_n86_), .c(new_n95_), .d(x25), .O(new_n99_));
  nand2  g48(.a(x08), .b(x06), .O(new_n100_));
  oai21  g49(.a(new_n99_), .b(new_n74_), .c(new_n100_), .O(z15));
