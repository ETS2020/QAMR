...
module FAU ( 
  ...
  nand2  g18(.a(x08), .b(x05), .O(new_n65_));
  inv1   g19(.a(new_n65_), .O(z06));
  ...
  oai21  g53(.a(new_n101_), .b(new_n76_), .c(new_n65_), .O(z14));
  ...
  oai21  g62(.a(new_n110_), .b(new_n76_), .c(new_n67_), .O(z15));
  ...
  oai21  g70(.a(new_n118_), .b(new_n76_), .c(new_n69_), .O(z16));
  zero   g71(.O(z03));
  zero   g72(.O(z05));
  zero   g73(.O(z11));
  zero   g74(.O(z13));
