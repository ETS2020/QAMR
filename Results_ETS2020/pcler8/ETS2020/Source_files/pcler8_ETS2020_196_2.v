// Benchmark "FAU" written by ABC on Tue Jun 23 02:05:54 2020
...
module FAU ( 
  ...
  nand2  g19(.a(x08), .b(x06), .O(new_n67_));
  inv1   g20(.a(new_n67_), .O(z07));
  ...
  nor2   g25(.a(new_n72_), .b(new_n53_), .O(new_n73_));
  inv1   g26(.a(x10), .O(new_n74_));
  nand2  g27(.a(new_n52_), .b(new_n74_), .O(new_n75_));
  oai22  g28(.a(new_n75_), .b(new_n73_), .c(new_n58_), .d(new_n57_), .O(z09));
  ...
  oai21  g49(.a(new_n99_), .b(new_n75_), .c(new_n67_), .O(z15));
  zero   g50(.O(z03));
  zero   g51(.O(z04));
  zero   g52(.O(z05));
  zero   g53(.O(z11));
