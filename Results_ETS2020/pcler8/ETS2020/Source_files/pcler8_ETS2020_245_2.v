...
module FAU ( 
  ...
  nand2  g44(.a(x08), .b(x03), .O(new_n92_));
  oai21  g45(.a(new_n91_), .b(new_n75_), .c(new_n92_), .O(z12));
  nand3  g46(.a(x26), .b(x25), .c(x16), .O(new_n95_));
  nand3  g47(.a(x21), .b(x20), .c(x19), .O(new_n96_));
  inv1   g48(.a(new_n96_), .O(new_n97_));
  nand4  g49(.a(new_n97_), .b(new_n95_), .c(x23), .d(x22), .O(new_n98_));
  nand2  g50(.a(x23), .b(x22), .O(new_n99_));
  nor3   g51(.a(new_n96_), .b(new_n99_), .c(x24), .O(new_n100_));
  aoi21  g52(.a(new_n98_), .b(x24), .c(new_n100_), .O(new_n101_));
  oai21  g53(.a(new_n101_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g54(.a(x26), .b(x17), .O(new_n103_));
  nand3  g55(.a(x24), .b(x23), .c(x22), .O(new_n104_));
  inv1   g56(.a(new_n104_), .O(new_n105_));
  nand3  g57(.a(new_n105_), .b(new_n103_), .c(new_n97_), .O(new_n106_));
  inv1   g58(.a(x25), .O(new_n107_));
  nand4  g59(.a(new_n107_), .b(x24), .c(x23), .d(x22), .O(new_n108_));
  inv1   g60(.a(new_n108_), .O(new_n109_));
  aoi22  g61(.a(new_n109_), .b(new_n97_), .c(new_n106_), .d(x25), .O(new_n110_));
  oai21  g62(.a(new_n110_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g63(.a(new_n52_), .b(x18), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n49_), .c(new_n45_), .O(new_n113_));
  inv1   g65(.a(x26), .O(new_n114_));
  nand4  g66(.a(new_n114_), .b(x25), .c(x22), .d(x21), .O(new_n115_));
  nand4  g67(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n116_));
  nor2   g68(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  aoi21  g69(.a(new_n113_), .b(x26), .c(new_n117_), .O(new_n118_));
  oai21  g70(.a(new_n118_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g71(.O(z04));
  zero   g72(.O(z05));
  zero   g73(.O(z11));
  zero   g74(.O(z13));
