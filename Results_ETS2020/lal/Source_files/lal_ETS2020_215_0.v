// Benchmark "FAU" written by ABC on Tue Jun 23 16:25:05 2020
...
module FAU ( 
  ...
  nand3  g29(.a(new_n77_), .b(new_n48_), .c(x19), .O(new_n85_));
  inv1   g30(.a(new_n85_), .O(new_n86_));
  nor2   g31(.a(x22), .b(x21), .O(new_n87_));
  nor2   g32(.a(x24), .b(x23), .O(new_n88_));
  nand4  g33(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n47_), .O(new_n89_));
  nand2  g34(.a(new_n88_), .b(new_n87_), .O(new_n90_));
  oai21  g35(.a(new_n90_), .b(new_n85_), .c(x25), .O(new_n91_));
  nand4  g36(.a(new_n91_), .b(new_n89_), .c(new_n68_), .d(new_n57_), .O(z18));
  zero   g37(.O(z00));
  zero   g38(.O(z02));
  zero   g39(.O(z04));
  zero   g40(.O(z05));
