...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n70_, new_n74_,
    new_n75_, new_n78_, new_n81_, new_n82_, new_n83_, new_n84_, new_n85_,
  ...
  nor2   g26(.a(x15), .b(x07), .O(new_n74_));
  nand2  g27(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  inv1   g28(.a(new_n75_), .O(z09));
  xnor2a g29(.a(x18), .b(x17), .O(new_n78_));
  nor4   g30(.a(new_n78_), .b(new_n58_), .c(x15), .d(x07), .O(z11));
  ...
  nand2  g35(.a(new_n59_), .b(new_n84_), .O(new_n85_));
  inv1   g36(.a(new_n85_), .O(new_n86_));
  nand3  g37(.a(new_n86_), .b(new_n83_), .c(new_n82_), .O(z13));
  inv1   g38(.a(new_n81_), .O(new_n88_));
  nor2   g39(.a(x21), .b(x20), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g41(.a(new_n83_), .b(x21), .O(new_n91_));
  nand3  g42(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(z14));
  nand2  g43(.a(new_n90_), .b(x22), .O(new_n93_));
  nor2   g44(.a(x22), .b(x21), .O(new_n94_));
  nand3  g45(.a(new_n94_), .b(new_n88_), .c(new_n49_), .O(new_n95_));
  nand3  g46(.a(new_n95_), .b(new_n93_), .c(new_n86_), .O(z15));
  nand2  g47(.a(new_n95_), .b(x23), .O(new_n97_));
  nor2   g48(.a(x23), .b(x22), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n89_), .c(new_n88_), .O(new_n99_));
  nand3  g50(.a(new_n99_), .b(new_n97_), .c(new_n86_), .O(z16));
  nand2  g51(.a(new_n99_), .b(x24), .O(new_n101_));
  inv1   g52(.a(new_n83_), .O(new_n102_));
  nor2   g53(.a(x24), .b(x23), .O(new_n103_));
  nand3  g54(.a(new_n103_), .b(new_n94_), .c(new_n102_), .O(new_n104_));
  nand3  g55(.a(new_n104_), .b(new_n101_), .c(new_n86_), .O(z17));
  nand4  g56(.a(new_n103_), .b(new_n94_), .c(new_n102_), .d(new_n48_), .O(new_n106_));
  nand2  g57(.a(new_n104_), .b(x25), .O(new_n107_));
  nand3  g58(.a(new_n107_), .b(new_n106_), .c(new_n86_), .O(z18));
  zero   g59(.O(z05));
  zero   g60(.O(z08));
  zero   g61(.O(z10));
  zero   g62(.O(z12));
