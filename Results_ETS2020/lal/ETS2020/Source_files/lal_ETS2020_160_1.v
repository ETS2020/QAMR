// Benchmark "FAU" written by ABC on Tue Jun 23 16:24:11 2020
...
module FAU ( 
  ...
  nand3  g20(.a(x19), .b(x18), .c(x17), .O(new_n72_));
  nand2  g21(.a(new_n72_), .b(x20), .O(new_n73_));
  inv1   g22(.a(x20), .O(new_n74_));
  nand4  g23(.a(new_n74_), .b(x19), .c(x18), .d(x17), .O(new_n75_));
  inv1   g24(.a(x15), .O(new_n76_));
  aoi21  g25(.a(x05), .b(x04), .c(x07), .O(new_n77_));
  nand2  g26(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  inv1   g27(.a(new_n78_), .O(new_n79_));
  nand3  g28(.a(new_n79_), .b(new_n75_), .c(new_n73_), .O(z13));
  inv1   g29(.a(new_n72_), .O(new_n81_));
  nor2   g30(.a(x21), .b(x20), .O(new_n82_));
  nand2  g31(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g32(.a(new_n75_), .b(x21), .O(new_n84_));
  nand3  g33(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(z14));
  nand2  g34(.a(new_n83_), .b(x22), .O(new_n86_));
  nor2   g35(.a(x22), .b(x21), .O(new_n87_));
  nand3  g36(.a(new_n87_), .b(new_n81_), .c(new_n74_), .O(new_n88_));
  nand3  g37(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(z15));
  nand2  g38(.a(new_n88_), .b(x23), .O(new_n90_));
  nor2   g39(.a(x23), .b(x22), .O(new_n91_));
  nand3  g40(.a(new_n91_), .b(new_n82_), .c(new_n81_), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n90_), .c(new_n79_), .O(z16));
  nand2  g42(.a(new_n92_), .b(x24), .O(new_n94_));
  inv1   g43(.a(new_n75_), .O(new_n95_));
  nor2   g44(.a(x24), .b(x23), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  inv1   g46(.a(new_n97_), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n95_), .O(new_n99_));
  nand3  g48(.a(new_n99_), .b(new_n94_), .c(new_n79_), .O(z17));
  inv1   g49(.a(x25), .O(new_n101_));
  nand4  g50(.a(new_n96_), .b(new_n87_), .c(new_n95_), .d(new_n101_), .O(new_n102_));
  oai21  g51(.a(new_n97_), .b(new_n75_), .c(x25), .O(new_n103_));
  nand3  g52(.a(new_n103_), .b(new_n102_), .c(new_n79_), .O(z18));
  zero   g53(.O(z01));
  zero   g54(.O(z08));
  zero   g55(.O(z09));
  zero   g56(.O(z10));
