...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n76_, new_n78_, new_n79_, new_n81_, new_n82_, new_n83_, new_n90_,
  ...
  nor2   g25(.a(x15), .b(x07), .O(new_n73_));
  nand2  g26(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  inv1   g27(.a(new_n74_), .O(z09));
  nand3  g28(.a(new_n73_), .b(new_n57_), .c(new_n49_), .O(new_n76_));
  inv1   g29(.a(new_n76_), .O(z10));
  xnor2a g30(.a(x18), .b(x17), .O(new_n78_));
  nand2  g31(.a(new_n73_), .b(new_n57_), .O(new_n79_));
  nor2   g32(.a(new_n79_), .b(new_n78_), .O(z11));
  oai21  g33(.a(new_n50_), .b(new_n49_), .c(x19), .O(new_n81_));
  nor2   g34(.a(new_n50_), .b(new_n49_), .O(new_n82_));
  nand2  g35(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  aoi21  g36(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z12));
  nand3  g37(.a(new_n82_), .b(new_n48_), .c(x19), .O(new_n90_));
  inv1   g38(.a(new_n90_), .O(new_n91_));
  nor2   g39(.a(x22), .b(x21), .O(new_n92_));
  nor2   g40(.a(x24), .b(x23), .O(new_n93_));
  nand4  g41(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n47_), .O(new_n94_));
  nand2  g42(.a(new_n93_), .b(new_n92_), .O(new_n95_));
  oai21  g43(.a(new_n95_), .b(new_n90_), .c(x25), .O(new_n96_));
  nand4  g44(.a(new_n96_), .b(new_n94_), .c(new_n73_), .d(new_n57_), .O(z18));
  zero   g45(.O(z00));
  zero   g46(.O(z07));
  zero   g47(.O(z13));
  zero   g48(.O(z14));
