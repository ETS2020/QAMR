...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n69_, new_n71_, new_n74_, new_n75_, new_n76_, new_n77_, new_n84_,
  ...
  nand2  g26(.a(new_n68_), .b(new_n57_), .O(new_n77_));
  aoi21  g27(.a(new_n76_), .b(new_n74_), .c(new_n77_), .O(z12));
  nand3  g28(.a(new_n75_), .b(new_n48_), .c(x19), .O(new_n84_));
  ...
  nand4  g35(.a(new_n90_), .b(new_n88_), .c(new_n68_), .d(new_n57_), .O(z18));
  zero   g36(.O(z00));
  zero   g37(.O(z02));
  zero   g38(.O(z04));
  zero   g39(.O(z07));
