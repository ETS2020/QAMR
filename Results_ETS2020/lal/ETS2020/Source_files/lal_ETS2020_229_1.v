// Benchmark "FAU" written by ABC on Tue Jun 23 16:25:18 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n90_), .b(new_n49_), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n77_), .c(x23), .O(new_n92_));
  nor2   g41(.a(x23), .b(x22), .O(new_n93_));
  nand3  g42(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n82_), .O(z16));
  nand2  g44(.a(new_n94_), .b(x24), .O(new_n96_));
  inv1   g45(.a(new_n79_), .O(new_n97_));
  nor2   g46(.a(x24), .b(x23), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n90_), .c(new_n97_), .O(new_n99_));
  nand3  g48(.a(new_n99_), .b(new_n96_), .c(new_n82_), .O(z17));
  nand4  g49(.a(new_n98_), .b(new_n90_), .c(new_n97_), .d(new_n48_), .O(new_n101_));
  nand2  g50(.a(new_n99_), .b(x25), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n101_), .c(new_n82_), .O(z18));
  zero   g52(.O(z08));
  zero   g53(.O(z09));
  zero   g54(.O(z10));
  zero   g55(.O(z11));
