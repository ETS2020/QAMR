...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n89_, new_n90_, new_n92_, new_n93_, new_n94_, new_n97_,
  ...
  inv1   g43(.a(new_n78_), .O(new_n97_));
  nor2   g44(.a(x24), .b(x23), .O(new_n98_));
  nand4  g45(.a(new_n98_), .b(new_n89_), .c(new_n97_), .d(new_n48_), .O(new_n99_));
  nand2  g46(.a(new_n98_), .b(new_n89_), .O(new_n100_));
  oai21  g47(.a(new_n100_), .b(new_n78_), .c(x25), .O(new_n101_));
  nand3  g48(.a(new_n101_), .b(new_n99_), .c(new_n81_), .O(z18));
  zero   g49(.O(z05));
  zero   g50(.O(z06));
  zero   g51(.O(z08));
  zero   g52(.O(z09));
