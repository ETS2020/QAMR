...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n75_, new_n78_,
  ...
  xnor2a g25(.a(x18), .b(x17), .O(new_n75_));
  nor4   g26(.a(new_n75_), .b(new_n58_), .c(x15), .d(x07), .O(z11));
  nand3  g27(.a(x19), .b(x18), .c(x17), .O(new_n78_));
  nand2  g28(.a(new_n78_), .b(x20), .O(new_n79_));
  nand4  g29(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n80_));
  inv1   g30(.a(x15), .O(new_n81_));
  nand2  g31(.a(new_n59_), .b(new_n81_), .O(new_n82_));
  inv1   g32(.a(new_n82_), .O(new_n83_));
  nand3  g33(.a(new_n83_), .b(new_n80_), .c(new_n79_), .O(z13));
  inv1   g34(.a(new_n78_), .O(new_n85_));
  nor2   g35(.a(x21), .b(x20), .O(new_n86_));
  nand2  g36(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g37(.a(new_n80_), .b(x21), .O(new_n88_));
  nand3  g38(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(z14));
  nand2  g39(.a(new_n87_), .b(x22), .O(new_n90_));
  nor2   g40(.a(x22), .b(x21), .O(new_n91_));
  nand3  g41(.a(new_n91_), .b(new_n85_), .c(new_n49_), .O(new_n92_));
  nand3  g42(.a(new_n92_), .b(new_n90_), .c(new_n83_), .O(z15));
  nand2  g43(.a(new_n92_), .b(x23), .O(new_n94_));
  nor2   g44(.a(x23), .b(x22), .O(new_n95_));
  nand3  g45(.a(new_n95_), .b(new_n86_), .c(new_n85_), .O(new_n96_));
  nand3  g46(.a(new_n96_), .b(new_n94_), .c(new_n83_), .O(z16));
  nand2  g47(.a(new_n96_), .b(x24), .O(new_n98_));
  inv1   g48(.a(new_n80_), .O(new_n99_));
  nor2   g49(.a(x24), .b(x23), .O(new_n100_));
  nand3  g50(.a(new_n100_), .b(new_n91_), .c(new_n99_), .O(new_n101_));
  nand3  g51(.a(new_n101_), .b(new_n98_), .c(new_n83_), .O(z17));
  nand4  g52(.a(new_n100_), .b(new_n91_), .c(new_n99_), .d(new_n48_), .O(new_n103_));
  nand2  g53(.a(new_n101_), .b(x25), .O(new_n104_));
  nand3  g54(.a(new_n104_), .b(new_n103_), .c(new_n83_), .O(z18));
  zero   g55(.O(z06));
  zero   g56(.O(z08));
  zero   g57(.O(z09));
  zero   g58(.O(z10));
