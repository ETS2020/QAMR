// Benchmark "FAU" written by ABC on Tue Jun 23 16:22:15 2020
...
module FAU ( 
  ...
  nand3  g40(.a(new_n85_), .b(new_n88_), .c(new_n72_), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(z10));
  xnor2a g42(.a(x18), .b(x17), .O(new_n91_));
  nand2  g43(.a(new_n85_), .b(new_n88_), .O(new_n92_));
  nor2   g44(.a(new_n92_), .b(new_n91_), .O(z11));
  oai21  g45(.a(new_n75_), .b(new_n72_), .c(x19), .O(new_n94_));
  nor2   g46(.a(new_n75_), .b(new_n72_), .O(new_n95_));
  nand2  g47(.a(new_n95_), .b(new_n76_), .O(new_n96_));
  aoi21  g48(.a(new_n96_), .b(new_n94_), .c(new_n92_), .O(z12));
  nand2  g49(.a(new_n95_), .b(x19), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(x20), .O(new_n99_));
  nand4  g51(.a(new_n99_), .b(new_n85_), .c(new_n88_), .d(new_n62_), .O(z13));
  nand2  g52(.a(new_n63_), .b(new_n61_), .O(new_n101_));
  nand2  g53(.a(new_n85_), .b(new_n88_), .O(new_n102_));
  aoi21  g54(.a(new_n62_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g55(.a(new_n101_), .b(new_n98_), .c(new_n103_), .O(z14));
  inv1   g56(.a(new_n102_), .O(new_n105_));
  oai21  g57(.a(new_n101_), .b(new_n98_), .c(x22), .O(new_n106_));
  inv1   g58(.a(new_n98_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n69_), .c(new_n61_), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(z15));
  nand2  g61(.a(new_n69_), .b(new_n61_), .O(new_n110_));
  oai21  g62(.a(new_n110_), .b(new_n98_), .c(x23), .O(new_n111_));
  nand4  g63(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n61_), .O(new_n112_));
  ...
  oai21  g67(.a(new_n112_), .b(new_n98_), .c(x24), .O(new_n116_));
  nor2   g68(.a(new_n102_), .b(new_n68_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n116_), .O(z17));
  inv1   g70(.a(new_n62_), .O(new_n119_));
  nand4  g71(.a(new_n81_), .b(new_n69_), .c(new_n119_), .d(new_n65_), .O(new_n120_));
  oai21  g72(.a(new_n67_), .b(new_n62_), .c(x25), .O(new_n121_));
