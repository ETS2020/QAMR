// Benchmark "FAU" written by ABC on Tue Jun 23 16:25:33 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n91_), .b(new_n49_), .O(new_n92_));
  oai21  g40(.a(new_n92_), .b(new_n78_), .c(x23), .O(new_n93_));
  nor2   g41(.a(x23), .b(x22), .O(new_n94_));
  nand3  g42(.a(new_n94_), .b(new_n86_), .c(new_n85_), .O(new_n95_));
  nand3  g43(.a(new_n95_), .b(new_n93_), .c(new_n83_), .O(z16));
  nand2  g44(.a(new_n95_), .b(x24), .O(new_n97_));
  inv1   g45(.a(new_n80_), .O(new_n98_));
  nor2   g46(.a(x24), .b(x23), .O(new_n99_));
  nand3  g47(.a(new_n99_), .b(new_n91_), .c(new_n98_), .O(new_n100_));
  nand3  g48(.a(new_n100_), .b(new_n97_), .c(new_n83_), .O(z17));
  nand4  g49(.a(new_n99_), .b(new_n91_), .c(new_n98_), .d(new_n48_), .O(new_n102_));
  nand2  g50(.a(new_n100_), .b(x25), .O(new_n103_));
  nand3  g51(.a(new_n103_), .b(new_n102_), .c(new_n83_), .O(z18));
  zero   g52(.O(z02));
  zero   g53(.O(z08));
  zero   g54(.O(z09));
  zero   g55(.O(z10));
