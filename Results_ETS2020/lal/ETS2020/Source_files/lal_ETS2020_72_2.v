...
module FAU ( 
  ...
  oai21  g43(.a(new_n75_), .b(new_n72_), .c(x19), .O(new_n92_));
  nor2   g44(.a(new_n75_), .b(new_n72_), .O(new_n93_));
  nand2  g45(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  nand2  g46(.a(new_n85_), .b(new_n88_), .O(new_n95_));
  ...
  nand4  g50(.a(new_n98_), .b(new_n85_), .c(new_n88_), .d(new_n62_), .O(z13));
  nand2  g51(.a(new_n63_), .b(new_n61_), .O(new_n100_));
  nand2  g52(.a(new_n85_), .b(new_n88_), .O(new_n101_));
