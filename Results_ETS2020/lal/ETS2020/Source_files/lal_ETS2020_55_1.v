// Benchmark "FAU" written by ABC on Tue Jun 23 16:22:35 2020
...
module FAU ( 
  ...
  nand3  g24(.a(x19), .b(x18), .c(x17), .O(new_n76_));
  nand2  g25(.a(new_n76_), .b(x20), .O(new_n77_));
  nand4  g26(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n78_));
  inv1   g27(.a(x15), .O(new_n79_));
  nand2  g28(.a(new_n58_), .b(new_n79_), .O(new_n80_));
  inv1   g29(.a(new_n80_), .O(new_n81_));
  nand3  g30(.a(new_n81_), .b(new_n78_), .c(new_n77_), .O(z13));
  inv1   g31(.a(new_n76_), .O(new_n83_));
  nor2   g32(.a(x21), .b(x20), .O(new_n84_));
  nand2  g33(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g34(.a(new_n78_), .b(x21), .O(new_n86_));
  nand3  g35(.a(new_n86_), .b(new_n85_), .c(new_n81_), .O(z14));
  nand2  g36(.a(new_n85_), .b(x22), .O(new_n88_));
  nor2   g37(.a(x22), .b(x21), .O(new_n89_));
  nand3  g38(.a(new_n89_), .b(new_n83_), .c(new_n49_), .O(new_n90_));
  nand3  g39(.a(new_n90_), .b(new_n88_), .c(new_n81_), .O(z15));
  nand2  g40(.a(new_n90_), .b(x23), .O(new_n92_));
  nor2   g41(.a(x23), .b(x22), .O(new_n93_));
  nand3  g42(.a(new_n93_), .b(new_n84_), .c(new_n83_), .O(new_n94_));
  nand3  g43(.a(new_n94_), .b(new_n92_), .c(new_n81_), .O(z16));
  nand2  g44(.a(new_n94_), .b(x24), .O(new_n96_));
  inv1   g45(.a(new_n78_), .O(new_n97_));
  nor2   g46(.a(x24), .b(x23), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n89_), .c(new_n97_), .O(new_n99_));
  nand3  g48(.a(new_n99_), .b(new_n96_), .c(new_n81_), .O(z17));
  nand4  g49(.a(new_n98_), .b(new_n89_), .c(new_n97_), .d(new_n48_), .O(new_n101_));
  nand2  g50(.a(new_n99_), .b(x25), .O(new_n102_));
  nand3  g51(.a(new_n102_), .b(new_n101_), .c(new_n81_), .O(z18));
  zero   g52(.O(z06));
  zero   g53(.O(z08));
  zero   g54(.O(z09));
  zero   g55(.O(z10));
