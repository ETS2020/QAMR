// Benchmark "FAU" written by ABC on Tue Jun 23 16:24:16 2020
...
module FAU ( 
  ...
  nand2  g41(.a(x05), .b(x04), .O(new_n90_));
  nand2  g42(.a(new_n85_), .b(new_n90_), .O(new_n91_));
  nor2   g43(.a(new_n91_), .b(new_n89_), .O(z11));
  oai21  g44(.a(new_n75_), .b(new_n72_), .c(x19), .O(new_n93_));
  nor2   g45(.a(new_n75_), .b(new_n72_), .O(new_n94_));
  ...
  nand4  g50(.a(new_n98_), .b(new_n85_), .c(new_n90_), .d(new_n62_), .O(z13));
  nand2  g51(.a(new_n63_), .b(new_n61_), .O(new_n100_));
  nand2  g52(.a(new_n85_), .b(new_n90_), .O(new_n101_));
  aoi21  g53(.a(new_n62_), .b(x21), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g58(.a(new_n106_), .b(new_n69_), .c(new_n61_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(z15));
  nand2  g60(.a(new_n69_), .b(new_n61_), .O(new_n109_));
  oai21  g61(.a(new_n109_), .b(new_n97_), .c(x23), .O(new_n110_));
  nand4  g62(.a(new_n65_), .b(new_n64_), .c(new_n63_), .d(new_n61_), .O(new_n111_));
  ...
  nor2   g67(.a(new_n101_), .b(new_n68_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n115_), .O(z17));
  inv1   g69(.a(new_n62_), .O(new_n118_));
  nand4  g70(.a(new_n81_), .b(new_n69_), .c(new_n118_), .d(new_n65_), .O(new_n119_));
  oai21  g71(.a(new_n67_), .b(new_n62_), .c(x25), .O(new_n120_));
