...
module FAU ( 
  ...
  nor2   g70(.a(x3), .b(x1), .O(new_n88_));
  and2   g71(.a(x3), .b(x1), .O(z3));
  nor2   g72(.a(z3), .b(new_n88_), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(z2));
  xor2a  g74(.a(x2), .b(x0), .O(new_n93_));
  nor2   g75(.a(new_n93_), .b(new_n90_), .O(z5));
  zero   g76(.O(z1));
  zero   g77(.O(z4));
endmodule
