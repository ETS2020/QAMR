// Benchmark "FAU" written by ABC on Tue Jun 23 00:59:21 2020
...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n45_,
    new_n46_, new_n47_, new_n48_, new_n56_;
  ...
  aoi21  g13(.a(x16), .b(new_n35_), .c(x03), .O(new_n56_));
  nor2   g14(.a(new_n56_), .b(new_n40_), .O(z12));
