// Benchmark "FAU" written by ABC on Tue Jun 23 00:59:11 2020
...
module FAU ( 
  ...
  oai21  g34(.a(x03), .b(new_n35_), .c(x16), .O(new_n71_));
  inv1   g35(.a(new_n54_), .O(new_n72_));
  inv1   g36(.a(x00), .O(new_n73_));
  inv1   g37(.a(x13), .O(new_n74_));
  nand4  g38(.a(new_n74_), .b(new_n67_), .c(new_n63_), .d(new_n62_), .O(new_n75_));
  nand2  g39(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g40(.a(new_n76_), .b(new_n72_), .c(new_n71_), .O(new_n77_));
  nand2  g41(.a(new_n42_), .b(x14), .O(new_n78_));
  aoi21  g42(.a(new_n78_), .b(new_n77_), .c(new_n39_), .O(z10));
