...
module FAU ( 
  ...
  nand3  g32(.a(new_n67_), .b(new_n62_), .c(new_n58_), .O(new_n68_));
  oai21  g33(.a(new_n68_), .b(new_n54_), .c(x12), .O(new_n69_));
  inv1   g34(.a(x12), .O(new_n70_));
  nand4  g35(.a(new_n70_), .b(new_n67_), .c(new_n62_), .d(new_n58_), .O(new_n71_));
  inv1   g36(.a(new_n71_), .O(new_n72_));
  nand2  g37(.a(new_n72_), .b(new_n63_), .O(new_n73_));
  nand4  g38(.a(new_n73_), .b(new_n69_), .c(new_n57_), .d(x04), .O(z08));
  inv1   g39(.a(x13), .O(new_n75_));
  nand4  g40(.a(new_n75_), .b(new_n70_), .c(new_n67_), .d(new_n62_), .O(new_n76_));
  nor2   g41(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  nor2   g42(.a(new_n44_), .b(x02), .O(new_n78_));
  aoi21  g43(.a(new_n77_), .b(new_n47_), .c(new_n78_), .O(new_n79_));
  oai21  g44(.a(new_n71_), .b(new_n54_), .c(x13), .O(new_n80_));
  nand2  g45(.a(x16), .b(x03), .O(new_n81_));
  nand4  g46(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(x04), .O(z09));
  inv1   g47(.a(new_n59_), .O(new_n83_));
  inv1   g48(.a(x00), .O(new_n84_));
  nand2  g49(.a(new_n76_), .b(new_n84_), .O(new_n85_));
  nand3  g50(.a(new_n85_), .b(new_n83_), .c(new_n47_), .O(new_n86_));
  nand2  g51(.a(new_n45_), .b(x14), .O(new_n87_));
  aoi21  g52(.a(new_n87_), .b(new_n86_), .c(new_n40_), .O(z10));
  nor2   g53(.a(new_n78_), .b(x03), .O(new_n90_));
