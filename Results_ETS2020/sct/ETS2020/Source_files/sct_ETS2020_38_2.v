...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n45_,
    ...
    new_n54_, new_n55_, new_n56_, new_n63_;
  ...
  inv1   g13(.a(x08), .O(new_n50_));
  oai21  g14(.a(new_n45_), .b(new_n50_), .c(x09), .O(new_n51_));
  inv1   g15(.a(x03), .O(new_n52_));
  oai21  g16(.a(new_n40_), .b(x02), .c(new_n52_), .O(new_n53_));
  nand2  g17(.a(new_n53_), .b(x16), .O(new_n54_));
  inv1   g18(.a(x09), .O(new_n55_));
  nand4  g19(.a(new_n55_), .b(x08), .c(x07), .d(x06), .O(new_n56_));
  nand4  g20(.a(new_n56_), .b(new_n54_), .c(new_n51_), .d(x04), .O(z05));
  nand2  g21(.a(x16), .b(new_n35_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n52_), .c(new_n40_), .O(z12));
