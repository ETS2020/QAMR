// Benchmark "FAU" written by ABC on Tue Jun 23 01:31:30 2020
...
module FAU ( 
  ...
  nand2  g39(.a(x02), .b(new_n64_), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(new_n86_));
  inv1   g41(.a(x13), .O(new_n87_));
  inv1   g42(.a(x14), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n71_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nand3  g45(.a(new_n90_), .b(new_n86_), .c(new_n84_), .O(new_n91_));
  ...
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n63_), .O(new_n96_));
  aoi21  g51(.a(new_n93_), .b(new_n91_), .c(new_n96_), .O(z09));
  nor2   g52(.a(x20), .b(new_n64_), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(new_n57_), .c(x22), .d(x21), .O(new_n99_));
  nand3  g54(.a(new_n87_), .b(x12), .c(new_n71_), .O(new_n100_));
  nor2   g55(.a(new_n100_), .b(new_n85_), .O(new_n101_));
  nor2   g56(.a(new_n81_), .b(x14), .O(new_n102_));
  nand4  g57(.a(new_n95_), .b(new_n94_), .c(x20), .d(x16), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  aoi21  g60(.a(new_n105_), .b(new_n99_), .c(x00), .O(z10));
  nand4  g61(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n107_));
  nand3  g62(.a(new_n94_), .b(x20), .c(new_n82_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n102_), .c(new_n101_), .O(new_n110_));
  nand2  g65(.a(new_n95_), .b(new_n63_), .O(new_n111_));
  aoi21  g66(.a(new_n110_), .b(new_n107_), .c(new_n111_), .O(z11));
  oai21  g67(.a(new_n54_), .b(new_n59_), .c(new_n65_), .O(new_n113_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  inv1   g72(.a(x24), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(x09), .O(new_n119_));
  aoi21  g74(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(z12));
  nor2   g75(.a(x19), .b(new_n47_), .O(new_n121_));
  and2   g76(.a(new_n121_), .b(new_n45_), .O(z13));
  nor2   g77(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g78(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n124_));
  nand3  g79(.a(x19), .b(new_n59_), .c(new_n64_), .O(new_n125_));
  oai21  g80(.a(new_n124_), .b(new_n63_), .c(new_n125_), .O(z15));
  nor2   g81(.a(new_n64_), .b(x00), .O(z16));
  inv1   g82(.a(new_n78_), .O(z17));
  zero   g83(.O(z05));
  zero   g84(.O(z07));
endmodule
