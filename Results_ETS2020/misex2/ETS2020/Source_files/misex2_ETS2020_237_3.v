...
module FAU ( 
  ...
  nor2   g28(.a(x01), .b(x00), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(x02), .O(new_n74_));
  nand3  g30(.a(x19), .b(new_n48_), .c(x17), .O(new_n75_));
  nor3   g31(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(z08));
  ...
  nor2   g42(.a(new_n48_), .b(new_n81_), .O(new_n87_));
  ...
  nand3  g52(.a(new_n96_), .b(x12), .c(new_n63_), .O(new_n97_));
  ...
  nand3  g69(.a(new_n49_), .b(x17), .c(new_n113_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n73_), .O(new_n116_));
  inv1   g72(.a(x24), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g74(.a(new_n116_), .b(new_n111_), .c(new_n118_), .O(z12));
  nor2   g75(.a(x19), .b(new_n47_), .O(new_n120_));
  and2   g76(.a(new_n120_), .b(new_n45_), .O(z13));
  nor2   g77(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g78(.a(new_n54_), .b(x01), .c(new_n113_), .O(new_n123_));
  nand3  g79(.a(x19), .b(new_n113_), .c(new_n81_), .O(new_n124_));
  oai21  g80(.a(new_n123_), .b(new_n90_), .c(new_n124_), .O(z15));
  nor2   g81(.a(new_n81_), .b(x00), .O(z16));
  inv1   g82(.a(new_n74_), .O(z17));
  zero   g83(.O(z03));
endmodule
