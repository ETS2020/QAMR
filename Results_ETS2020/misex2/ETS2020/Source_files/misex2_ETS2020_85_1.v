// Benchmark "FAU" written by ABC on Tue Jun 23 01:31:46 2020
...
module FAU ( 
  ...
  nand3  g53(.a(new_n97_), .b(new_n96_), .c(new_n64_), .O(new_n98_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nor2   g55(.a(x20), .b(new_n65_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n58_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g57(.a(x13), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x12), .c(new_n61_), .O(new_n103_));
  ...
  nand2  g69(.a(new_n97_), .b(new_n64_), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g71(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n116_));
  ...
  nand3  g81(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n127_));
  oai21  g82(.a(new_n126_), .b(new_n64_), .c(new_n127_), .O(z15));
  nor2   g83(.a(new_n65_), .b(x00), .O(z16));
