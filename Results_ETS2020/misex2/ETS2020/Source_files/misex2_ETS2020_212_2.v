// Benchmark "FAU" written by ABC on Tue Jun 23 01:32:11 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n64_), .b(x10), .c(new_n45_), .O(new_n65_));
  ...
  nand3  g26(.a(new_n64_), .b(new_n45_), .c(x02), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(new_n69_), .O(z04));
  nand4  g28(.a(new_n68_), .b(x11), .c(x10), .d(new_n45_), .O(new_n74_));
  ...
  nand3  g56(.a(new_n101_), .b(x12), .c(new_n67_), .O(new_n102_));
  ...
  nand2  g67(.a(new_n96_), .b(new_n62_), .O(new_n113_));
  aoi21  g68(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g69(.a(new_n55_), .b(new_n44_), .c(new_n64_), .O(new_n115_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g71(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n117_));
  ...
  aoi21  g78(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n125_));
  nand3  g79(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n62_), .c(new_n126_), .O(z15));
  nor2   g81(.a(new_n63_), .b(x00), .O(z16));
