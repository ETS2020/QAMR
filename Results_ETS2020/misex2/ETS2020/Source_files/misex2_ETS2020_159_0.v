...
module FAU ( 
  ...
  oai22  g13(.a(new_n59_), .b(new_n54_), .c(new_n52_), .d(new_n48_), .O(z03));
  nand3  g14(.a(new_n53_), .b(new_n55_), .c(x02), .O(new_n63_));
  nor3   g15(.a(new_n63_), .b(new_n57_), .c(new_n56_), .O(z06));
  inv1   g16(.a(x12), .O(new_n65_));
  nand4  g17(.a(new_n53_), .b(new_n65_), .c(new_n55_), .d(x01), .O(new_n66_));
  nand2  g18(.a(x02), .b(x00), .O(new_n67_));
  aoi21  g19(.a(new_n66_), .b(x01), .c(new_n67_), .O(z07));
  nand2  g20(.a(x10), .b(x02), .O(new_n73_));
  nand2  g21(.a(new_n73_), .b(new_n58_), .O(new_n74_));
  oai21  g22(.a(x19), .b(x02), .c(x23), .O(new_n75_));
  nand3  g23(.a(new_n51_), .b(x17), .c(new_n49_), .O(new_n76_));
  nand2  g24(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand2  g25(.a(new_n77_), .b(new_n47_), .O(new_n78_));
  inv1   g26(.a(x24), .O(new_n79_));
  nand2  g27(.a(new_n79_), .b(x09), .O(new_n80_));
  aoi21  g28(.a(new_n78_), .b(new_n74_), .c(new_n80_), .O(z12));
  nor2   g29(.a(new_n76_), .b(new_n48_), .O(z13));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
  zero   g33(.O(z04));
