...
module FAU ( 
  ...
  nand4  g23(.a(x19), .b(new_n47_), .c(x17), .d(new_n70_), .O(new_n71_));
  ...
  nand3  g28(.a(new_n49_), .b(new_n75_), .c(x02), .O(new_n76_));
  nor3   g29(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(z08));
  inv1   g30(.a(x01), .O(new_n79_));
  nor2   g31(.a(x20), .b(new_n79_), .O(new_n80_));
  nand4  g32(.a(new_n80_), .b(new_n48_), .c(x22), .d(x21), .O(new_n81_));
  inv1   g33(.a(x21), .O(new_n82_));
  inv1   g34(.a(x22), .O(new_n83_));
  nand3  g35(.a(new_n83_), .b(new_n82_), .c(x20), .O(new_n84_));
  inv1   g36(.a(new_n84_), .O(new_n85_));
  inv1   g37(.a(x13), .O(new_n86_));
  inv1   g38(.a(x14), .O(new_n87_));
  nand4  g39(.a(x16), .b(x15), .c(new_n87_), .d(new_n86_), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(new_n89_));
  nand4  g41(.a(x12), .b(new_n53_), .c(x02), .d(new_n79_), .O(new_n90_));
  inv1   g42(.a(new_n90_), .O(new_n91_));
  nand3  g43(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(new_n92_));
  aoi21  g44(.a(new_n92_), .b(new_n81_), .c(x00), .O(z10));
  oai21  g45(.a(new_n52_), .b(new_n62_), .c(new_n58_), .O(new_n95_));
  oai21  g46(.a(x19), .b(x02), .c(x23), .O(new_n96_));
  inv1   g47(.a(x19), .O(new_n97_));
  nand3  g48(.a(new_n97_), .b(x17), .c(new_n62_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(new_n49_), .O(new_n100_));
  inv1   g51(.a(x24), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g53(.a(new_n100_), .b(new_n95_), .c(new_n102_), .O(z12));
  nor3   g54(.a(new_n98_), .b(x01), .c(x00), .O(z13));
  zero   g55(.O(z00));
  zero   g56(.O(z01));
  zero   g57(.O(z02));
  zero   g58(.O(z04));
