...
module FAU ( 
  ...
  nand4  g29(.a(x19), .b(new_n48_), .c(x17), .d(new_n74_), .O(new_n75_));
  ...
  nand3  g34(.a(new_n60_), .b(new_n79_), .c(x02), .O(new_n80_));
  ...
  nand2  g40(.a(x02), .b(new_n64_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  inv1   g42(.a(x13), .O(new_n88_));
  inv1   g43(.a(x14), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n71_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n87_), .c(new_n85_), .O(new_n92_));
  ...
  nand4  g54(.a(new_n99_), .b(new_n57_), .c(x22), .d(x21), .O(new_n100_));
  nand3  g55(.a(new_n88_), .b(x12), .c(new_n71_), .O(new_n101_));
  nor2   g56(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  nor2   g57(.a(new_n82_), .b(x14), .O(new_n103_));
  nand4  g58(.a(new_n96_), .b(new_n95_), .c(x20), .d(x16), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(new_n106_));
  aoi21  g61(.a(new_n106_), .b(new_n100_), .c(x00), .O(z10));
  nand4  g62(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n108_));
  nand3  g63(.a(new_n95_), .b(x20), .c(new_n83_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n103_), .c(new_n102_), .O(new_n111_));
  nand2  g66(.a(new_n96_), .b(new_n63_), .O(new_n112_));
  aoi21  g67(.a(new_n111_), .b(new_n108_), .c(new_n112_), .O(z11));
  oai21  g68(.a(new_n54_), .b(new_n59_), .c(new_n65_), .O(new_n114_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n116_));
  ...
  nor2   g76(.a(x19), .b(new_n47_), .O(new_n122_));
  and2   g77(.a(new_n122_), .b(new_n45_), .O(z13));
  nor2   g78(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g79(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n125_));
  nand3  g80(.a(x19), .b(new_n59_), .c(new_n64_), .O(new_n126_));
