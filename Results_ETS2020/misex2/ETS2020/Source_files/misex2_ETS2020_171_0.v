...
module FAU ( 
  ...
  inv1   g30(.a(x00), .O(new_n83_));
  aoi21  g31(.a(new_n61_), .b(x01), .c(new_n49_), .O(new_n84_));
  inv1   g32(.a(x01), .O(new_n85_));
  nand3  g33(.a(x19), .b(new_n49_), .c(new_n85_), .O(new_n86_));
  oai21  g34(.a(new_n84_), .b(new_n83_), .c(new_n86_), .O(z15));
  zero   g35(.O(z00));
  zero   g36(.O(z01));
  zero   g37(.O(z02));
  zero   g38(.O(z04));
