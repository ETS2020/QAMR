...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n103_, new_n104_, new_n109_, new_n110_, new_n111_, new_n113_,
    new_n116_, new_n117_, new_n118_, new_n119_, new_n120_, new_n121_,
    new_n122_, new_n123_, new_n129_, new_n134_;
  ...
  inv1   g56(.a(x14), .O(new_n113_));
  nor2   g57(.a(x20), .b(new_n113_), .O(z08));
  inv1   g58(.a(x06), .O(new_n116_));
  nand4  g59(.a(new_n54_), .b(new_n55_), .c(new_n60_), .d(new_n116_), .O(new_n117_));
  and2   g60(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nand3  g61(.a(new_n102_), .b(x09), .c(x08), .O(new_n119_));
  oai21  g62(.a(new_n118_), .b(new_n69_), .c(new_n119_), .O(new_n120_));
  nor2   g63(.a(new_n117_), .b(new_n81_), .O(new_n121_));
  aoi21  g64(.a(new_n120_), .b(new_n68_), .c(new_n121_), .O(new_n122_));
  nand2  g65(.a(new_n100_), .b(new_n54_), .O(new_n123_));
  oai21  g66(.a(new_n122_), .b(new_n109_), .c(new_n123_), .O(z10));
  inv1   g67(.a(new_n123_), .O(z13));
  ...
  nor4   g72(.a(new_n119_), .b(new_n88_), .c(x17), .d(x15), .O(z23));
  zero   g73(.O(z00));
  zero   g74(.O(z01));
  zero   g75(.O(z04));
  zero   g76(.O(z05));
