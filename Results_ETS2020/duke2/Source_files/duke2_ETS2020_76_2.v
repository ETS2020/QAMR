...
module FAU ( 
  ...
  nor2   g312(.a(new_n89_), .b(x20), .O(z26));
  nor4   g313(.a(new_n81_), .b(new_n296_), .c(x15), .d(x05), .O(new_n370_));
  oai21  g314(.a(new_n370_), .b(new_n244_), .c(new_n92_), .O(new_n371_));
  nand3  g315(.a(new_n208_), .b(x19), .c(new_n54_), .O(new_n372_));
  aoi21  g316(.a(new_n372_), .b(new_n371_), .c(x07), .O(new_n373_));
  nor4   g317(.a(new_n116_), .b(new_n207_), .c(new_n80_), .d(new_n53_), .O(new_n374_));
  oai21  g318(.a(new_n374_), .b(new_n373_), .c(new_n122_), .O(new_n375_));
  nand3  g319(.a(x15), .b(new_n53_), .c(x00), .O(new_n376_));
  oai21  g320(.a(x15), .b(new_n53_), .c(new_n376_), .O(new_n377_));
  nand4  g321(.a(new_n377_), .b(new_n108_), .c(x17), .d(new_n52_), .O(new_n378_));
  nand2  g322(.a(new_n378_), .b(new_n375_), .O(new_n379_));
  nand2  g323(.a(new_n379_), .b(new_n72_), .O(new_n380_));
  nand3  g324(.a(new_n104_), .b(new_n52_), .c(x03), .O(new_n381_));
  inv1   g325(.a(new_n381_), .O(new_n382_));
  nand4  g326(.a(new_n382_), .b(new_n129_), .c(new_n122_), .d(x19), .O(new_n383_));
  nand2  g327(.a(new_n383_), .b(new_n380_), .O(z27));
  nand3  g328(.a(new_n225_), .b(new_n92_), .c(x11), .O(new_n385_));
  aoi21  g329(.a(new_n385_), .b(new_n72_), .c(x02), .O(new_n386_));
  nand2  g330(.a(x11), .b(new_n53_), .O(new_n387_));
  oai21  g331(.a(new_n387_), .b(new_n386_), .c(x15), .O(new_n388_));
  nand3  g332(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n389_));
  inv1   g333(.a(new_n67_), .O(new_n390_));
  nor2   g334(.a(new_n390_), .b(x21), .O(new_n391_));
  nand4  g335(.a(new_n391_), .b(new_n389_), .c(new_n225_), .d(new_n138_), .O(new_n392_));
  aoi21  g336(.a(new_n392_), .b(new_n388_), .c(x05), .O(new_n393_));
  nand4  g337(.a(new_n213_), .b(new_n105_), .c(new_n54_), .d(x12), .O(new_n394_));
  nand2  g338(.a(new_n336_), .b(x21), .O(new_n395_));
  aoi21  g339(.a(new_n395_), .b(new_n394_), .c(x07), .O(new_n396_));
  oai21  g340(.a(new_n396_), .b(new_n393_), .c(x08), .O(new_n397_));
  nor3   g341(.a(new_n171_), .b(new_n390_), .c(new_n92_), .O(new_n398_));
  nor2   g342(.a(x19), .b(new_n54_), .O(new_n399_));
  nand3  g343(.a(new_n153_), .b(new_n72_), .c(new_n80_), .O(new_n400_));
  inv1   g344(.a(new_n400_), .O(new_n401_));
  oai21  g345(.a(new_n399_), .b(new_n398_), .c(new_n401_), .O(new_n402_));
  aoi21  g346(.a(new_n402_), .b(new_n397_), .c(new_n108_), .O(new_n403_));
  nand2  g347(.a(new_n336_), .b(new_n108_), .O(new_n404_));
  oai21  g348(.a(new_n73_), .b(new_n75_), .c(new_n253_), .O(new_n405_));
  nor2   g349(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  oai21  g350(.a(new_n406_), .b(new_n403_), .c(new_n117_), .O(new_n407_));
  oai21  g351(.a(new_n207_), .b(new_n53_), .c(new_n114_), .O(new_n408_));
  nand2  g352(.a(new_n408_), .b(new_n274_), .O(new_n409_));
  nand3  g353(.a(new_n409_), .b(new_n69_), .c(x17), .O(new_n410_));
  nand2  g354(.a(new_n410_), .b(new_n407_), .O(z28));
  zero   g355(.O(z02));
  zero   g356(.O(z10));
  zero   g357(.O(z13));
  zero   g358(.O(z23));
