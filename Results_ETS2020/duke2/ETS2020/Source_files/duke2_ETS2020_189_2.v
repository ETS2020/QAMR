// Benchmark "FAU" written by ABC on Tue Jun 23 03:50:18 2020
...
module FAU ( 
  ...
  inv1   g296(.a(new_n314_), .O(new_n352_));
  nand3  g297(.a(new_n216_), .b(x18), .c(new_n65_), .O(new_n353_));
  nand3  g298(.a(new_n328_), .b(new_n108_), .c(new_n193_), .O(new_n354_));
  nand2  g299(.a(new_n54_), .b(x04), .O(new_n355_));
  aoi21  g300(.a(new_n354_), .b(new_n353_), .c(new_n355_), .O(new_n356_));
  nand3  g301(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n357_));
  nand2  g302(.a(new_n105_), .b(new_n73_), .O(new_n358_));
  nand3  g303(.a(x18), .b(x15), .c(x08), .O(new_n359_));
  aoi21  g304(.a(new_n358_), .b(new_n357_), .c(new_n359_), .O(new_n360_));
  oai21  g305(.a(new_n360_), .b(new_n356_), .c(new_n92_), .O(new_n361_));
  nand3  g306(.a(new_n332_), .b(new_n80_), .c(new_n52_), .O(new_n362_));
  nand2  g307(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  nand2  g308(.a(new_n363_), .b(new_n53_), .O(new_n364_));
  nor2   g309(.a(x18), .b(x15), .O(new_n365_));
  nand4  g310(.a(new_n365_), .b(new_n253_), .c(x08), .d(x01), .O(new_n366_));
  aoi21  g311(.a(new_n366_), .b(new_n364_), .c(new_n352_), .O(z24));
  nand2  g312(.a(new_n336_), .b(new_n80_), .O(new_n368_));
  nand2  g313(.a(new_n153_), .b(new_n122_), .O(new_n369_));
  aoi21  g314(.a(new_n368_), .b(new_n346_), .c(new_n369_), .O(z25));
  nor2   g315(.a(new_n89_), .b(x20), .O(z26));
  nor4   g316(.a(new_n81_), .b(new_n296_), .c(x15), .d(x05), .O(new_n372_));
  oai21  g317(.a(new_n372_), .b(new_n244_), .c(new_n92_), .O(new_n373_));
  nand3  g318(.a(new_n208_), .b(x19), .c(new_n54_), .O(new_n374_));
  aoi21  g319(.a(new_n374_), .b(new_n373_), .c(x07), .O(new_n375_));
  nor4   g320(.a(new_n116_), .b(new_n207_), .c(new_n80_), .d(new_n53_), .O(new_n376_));
  oai21  g321(.a(new_n376_), .b(new_n375_), .c(new_n122_), .O(new_n377_));
  nand3  g322(.a(x15), .b(new_n53_), .c(x00), .O(new_n378_));
  oai21  g323(.a(x15), .b(new_n53_), .c(new_n378_), .O(new_n379_));
  nand4  g324(.a(new_n379_), .b(new_n108_), .c(x17), .d(new_n52_), .O(new_n380_));
  nand2  g325(.a(new_n380_), .b(new_n377_), .O(new_n381_));
  nand2  g326(.a(new_n381_), .b(new_n72_), .O(new_n382_));
  nand3  g327(.a(new_n104_), .b(new_n52_), .c(x03), .O(new_n383_));
  inv1   g328(.a(new_n383_), .O(new_n384_));
  nand4  g329(.a(new_n384_), .b(new_n129_), .c(new_n122_), .d(x19), .O(new_n385_));
  nand2  g330(.a(new_n385_), .b(new_n382_), .O(z27));
  nand3  g331(.a(new_n225_), .b(new_n92_), .c(x11), .O(new_n387_));
  aoi21  g332(.a(new_n387_), .b(new_n72_), .c(x02), .O(new_n388_));
  nand2  g333(.a(x11), .b(new_n53_), .O(new_n389_));
  oai21  g334(.a(new_n389_), .b(new_n388_), .c(x15), .O(new_n390_));
  nand3  g335(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n391_));
  inv1   g336(.a(new_n67_), .O(new_n392_));
  nor2   g337(.a(new_n392_), .b(x21), .O(new_n393_));
  nand4  g338(.a(new_n393_), .b(new_n391_), .c(new_n225_), .d(new_n138_), .O(new_n394_));
  aoi21  g339(.a(new_n394_), .b(new_n390_), .c(x05), .O(new_n395_));
  nand4  g340(.a(new_n213_), .b(new_n105_), .c(new_n54_), .d(x12), .O(new_n396_));
  nand2  g341(.a(new_n336_), .b(x21), .O(new_n397_));
  aoi21  g342(.a(new_n397_), .b(new_n396_), .c(x07), .O(new_n398_));
  oai21  g343(.a(new_n398_), .b(new_n395_), .c(x08), .O(new_n399_));
  nor3   g344(.a(new_n171_), .b(new_n392_), .c(new_n92_), .O(new_n400_));
  nor2   g345(.a(x19), .b(new_n54_), .O(new_n401_));
  nand3  g346(.a(new_n153_), .b(new_n72_), .c(new_n80_), .O(new_n402_));
  inv1   g347(.a(new_n402_), .O(new_n403_));
  oai21  g348(.a(new_n401_), .b(new_n400_), .c(new_n403_), .O(new_n404_));
  aoi21  g349(.a(new_n404_), .b(new_n399_), .c(new_n108_), .O(new_n405_));
  nand2  g350(.a(new_n336_), .b(new_n108_), .O(new_n406_));
  oai21  g351(.a(new_n73_), .b(new_n75_), .c(new_n253_), .O(new_n407_));
  nor2   g352(.a(new_n407_), .b(new_n406_), .O(new_n408_));
  oai21  g353(.a(new_n408_), .b(new_n405_), .c(new_n117_), .O(new_n409_));
  oai21  g354(.a(new_n207_), .b(new_n53_), .c(new_n114_), .O(new_n410_));
  nand2  g355(.a(new_n410_), .b(new_n274_), .O(new_n411_));
  nand3  g356(.a(new_n411_), .b(new_n69_), .c(x17), .O(new_n412_));
  nand2  g357(.a(new_n412_), .b(new_n409_), .O(z28));
  zero   g358(.O(z02));
  zero   g359(.O(z10));
  zero   g360(.O(z13));
  zero   g361(.O(z23));
