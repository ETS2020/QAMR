// Benchmark "FAU" written by ABC on Tue Jun 23 03:50:36 2020
...
module FAU ( 
  ...
  nand2  g335(.a(new_n194_), .b(x09), .O(new_n389_));
  nor3   g336(.a(new_n389_), .b(new_n294_), .c(new_n356_), .O(z23));
  inv1   g337(.a(new_n353_), .O(new_n391_));
  nand3  g338(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n392_));
  nand3  g339(.a(new_n366_), .b(new_n99_), .c(new_n234_), .O(new_n393_));
  nand2  g340(.a(new_n54_), .b(x04), .O(new_n394_));
  aoi21  g341(.a(new_n393_), .b(new_n392_), .c(new_n394_), .O(new_n395_));
  nand3  g342(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n396_));
  nand2  g343(.a(new_n107_), .b(new_n73_), .O(new_n397_));
  nand2  g344(.a(new_n120_), .b(x18), .O(new_n398_));
  aoi21  g345(.a(new_n397_), .b(new_n396_), .c(new_n398_), .O(new_n399_));
  oai21  g346(.a(new_n399_), .b(new_n395_), .c(new_n143_), .O(new_n400_));
  nand3  g347(.a(new_n370_), .b(new_n86_), .c(new_n52_), .O(new_n401_));
  nand2  g348(.a(new_n401_), .b(new_n400_), .O(new_n402_));
  nand2  g349(.a(new_n402_), .b(new_n53_), .O(new_n403_));
  nand4  g350(.a(new_n290_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n404_));
  aoi21  g351(.a(new_n404_), .b(new_n403_), .c(new_n391_), .O(z24));
  nand2  g352(.a(new_n374_), .b(new_n86_), .O(new_n406_));
  nand2  g353(.a(new_n168_), .b(new_n150_), .O(new_n407_));
  aoi21  g354(.a(new_n406_), .b(new_n384_), .c(new_n407_), .O(z25));
  nor2   g355(.a(new_n89_), .b(x20), .O(z26));
  nand2  g356(.a(new_n133_), .b(new_n81_), .O(new_n410_));
  nor2   g357(.a(new_n410_), .b(new_n335_), .O(new_n411_));
  oai21  g358(.a(new_n411_), .b(new_n281_), .c(new_n143_), .O(new_n412_));
  nand3  g359(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n413_));
  aoi21  g360(.a(new_n413_), .b(new_n412_), .c(x07), .O(new_n414_));
  nor3   g361(.a(new_n228_), .b(new_n161_), .c(new_n118_), .O(new_n415_));
  oai21  g362(.a(new_n415_), .b(new_n414_), .c(new_n168_), .O(new_n416_));
  nand3  g363(.a(x15), .b(new_n53_), .c(x00), .O(new_n417_));
  oai21  g364(.a(x15), .b(new_n53_), .c(new_n417_), .O(new_n418_));
  nand4  g365(.a(new_n418_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n419_));
  nand2  g366(.a(new_n419_), .b(new_n416_), .O(new_n420_));
  nand2  g367(.a(new_n420_), .b(new_n72_), .O(new_n421_));
  nand3  g368(.a(new_n159_), .b(new_n52_), .c(x03), .O(new_n422_));
  nand3  g369(.a(new_n172_), .b(new_n119_), .c(new_n106_), .O(new_n423_));
  oai21  g370(.a(new_n423_), .b(new_n422_), .c(new_n421_), .O(z27));
  nand3  g371(.a(new_n262_), .b(new_n143_), .c(x11), .O(new_n425_));
  aoi21  g372(.a(new_n425_), .b(new_n72_), .c(x02), .O(new_n426_));
  nand2  g373(.a(x11), .b(new_n53_), .O(new_n427_));
  oai21  g374(.a(new_n427_), .b(new_n426_), .c(x15), .O(new_n428_));
  nand3  g375(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n429_));
  inv1   g376(.a(new_n67_), .O(new_n430_));
  nor2   g377(.a(new_n430_), .b(x21), .O(new_n431_));
  nand4  g378(.a(new_n431_), .b(new_n429_), .c(new_n262_), .d(new_n180_), .O(new_n432_));
  aoi21  g379(.a(new_n432_), .b(new_n428_), .c(x05), .O(new_n433_));
  nand4  g380(.a(new_n256_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n434_));
  nand2  g381(.a(new_n374_), .b(x21), .O(new_n435_));
  aoi21  g382(.a(new_n435_), .b(new_n434_), .c(x07), .O(new_n436_));
  oai21  g383(.a(new_n436_), .b(new_n433_), .c(x08), .O(new_n437_));
  nor3   g384(.a(new_n212_), .b(new_n430_), .c(new_n143_), .O(new_n438_));
  nor2   g385(.a(x19), .b(new_n54_), .O(new_n439_));
  nand3  g386(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n440_));
  inv1   g387(.a(new_n440_), .O(new_n441_));
  oai21  g388(.a(new_n439_), .b(new_n438_), .c(new_n441_), .O(new_n442_));
  aoi21  g389(.a(new_n442_), .b(new_n437_), .c(new_n99_), .O(new_n443_));
  nand2  g390(.a(new_n374_), .b(new_n99_), .O(new_n444_));
  oai21  g391(.a(new_n73_), .b(new_n75_), .c(new_n290_), .O(new_n445_));
  nor2   g392(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  oai21  g393(.a(new_n446_), .b(new_n443_), .c(new_n159_), .O(new_n447_));
  oai21  g394(.a(new_n118_), .b(new_n53_), .c(new_n153_), .O(new_n448_));
  nand2  g395(.a(new_n448_), .b(new_n311_), .O(new_n449_));
  nand3  g396(.a(new_n449_), .b(new_n69_), .c(x17), .O(new_n450_));
  nand2  g397(.a(new_n450_), .b(new_n447_), .O(z28));
  zero   g398(.O(z10));
  zero   g399(.O(z13));
endmodule
