...
module FAU ( 
  ...
  nand2  g315(.a(new_n154_), .b(new_n130_), .O(new_n369_));
  nor2   g316(.a(new_n369_), .b(new_n118_), .O(z23));
  inv1   g317(.a(new_n333_), .O(new_n371_));
  nand3  g318(.a(new_n217_), .b(x18), .c(new_n65_), .O(new_n372_));
  nand3  g319(.a(new_n347_), .b(new_n108_), .c(new_n194_), .O(new_n373_));
  nand2  g320(.a(new_n54_), .b(x04), .O(new_n374_));
  aoi21  g321(.a(new_n373_), .b(new_n372_), .c(new_n374_), .O(new_n375_));
  nand3  g322(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n376_));
  nand2  g323(.a(new_n105_), .b(new_n73_), .O(new_n377_));
  nand3  g324(.a(x18), .b(x15), .c(x08), .O(new_n378_));
  aoi21  g325(.a(new_n377_), .b(new_n376_), .c(new_n378_), .O(new_n379_));
  oai21  g326(.a(new_n379_), .b(new_n375_), .c(new_n92_), .O(new_n380_));
  nand3  g327(.a(new_n247_), .b(new_n80_), .c(new_n52_), .O(new_n381_));
  nand2  g328(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  nand2  g329(.a(new_n382_), .b(new_n53_), .O(new_n383_));
  nor2   g330(.a(x18), .b(x15), .O(new_n384_));
  nand4  g331(.a(new_n384_), .b(new_n271_), .c(x08), .d(x01), .O(new_n385_));
  aoi21  g332(.a(new_n385_), .b(new_n383_), .c(new_n371_), .O(z24));
  nand2  g333(.a(new_n354_), .b(new_n80_), .O(new_n387_));
  nand2  g334(.a(new_n154_), .b(new_n124_), .O(new_n388_));
  aoi21  g335(.a(new_n387_), .b(new_n364_), .c(new_n388_), .O(z25));
  nor2   g336(.a(new_n89_), .b(x20), .O(z26));
  nor4   g337(.a(new_n81_), .b(new_n314_), .c(x15), .d(x05), .O(new_n391_));
  oai21  g338(.a(new_n391_), .b(new_n262_), .c(new_n92_), .O(new_n392_));
  nand3  g339(.a(new_n209_), .b(x19), .c(new_n54_), .O(new_n393_));
  aoi21  g340(.a(new_n393_), .b(new_n392_), .c(x07), .O(new_n394_));
  nor4   g341(.a(new_n116_), .b(new_n208_), .c(new_n80_), .d(new_n53_), .O(new_n395_));
  oai21  g342(.a(new_n395_), .b(new_n394_), .c(new_n124_), .O(new_n396_));
  nand3  g343(.a(x15), .b(new_n53_), .c(x00), .O(new_n397_));
  oai21  g344(.a(x15), .b(new_n53_), .c(new_n397_), .O(new_n398_));
  nand4  g345(.a(new_n398_), .b(new_n108_), .c(x17), .d(new_n52_), .O(new_n399_));
  nand2  g346(.a(new_n399_), .b(new_n396_), .O(new_n400_));
  nand2  g347(.a(new_n400_), .b(new_n72_), .O(new_n401_));
  nand3  g348(.a(new_n104_), .b(new_n52_), .c(x03), .O(new_n402_));
  inv1   g349(.a(new_n402_), .O(new_n403_));
  nand4  g350(.a(new_n403_), .b(new_n130_), .c(new_n124_), .d(x19), .O(new_n404_));
  nand2  g351(.a(new_n404_), .b(new_n401_), .O(z27));
  nand3  g352(.a(new_n226_), .b(new_n92_), .c(x11), .O(new_n406_));
  aoi21  g353(.a(new_n406_), .b(new_n72_), .c(x02), .O(new_n407_));
  nand2  g354(.a(x11), .b(new_n53_), .O(new_n408_));
  oai21  g355(.a(new_n408_), .b(new_n407_), .c(x15), .O(new_n409_));
  nand3  g356(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n410_));
  inv1   g357(.a(new_n67_), .O(new_n411_));
  nor2   g358(.a(new_n411_), .b(x21), .O(new_n412_));
  nand4  g359(.a(new_n412_), .b(new_n410_), .c(new_n226_), .d(new_n139_), .O(new_n413_));
  aoi21  g360(.a(new_n413_), .b(new_n409_), .c(x05), .O(new_n414_));
  nand4  g361(.a(new_n214_), .b(new_n105_), .c(new_n54_), .d(x12), .O(new_n415_));
  ...
  nor3   g365(.a(new_n172_), .b(new_n411_), .c(new_n92_), .O(new_n419_));
  nor2   g366(.a(x19), .b(new_n54_), .O(new_n420_));
  nand3  g367(.a(new_n154_), .b(new_n72_), .c(new_n80_), .O(new_n421_));
  inv1   g368(.a(new_n421_), .O(new_n422_));
  oai21  g369(.a(new_n420_), .b(new_n419_), .c(new_n422_), .O(new_n423_));
  aoi21  g370(.a(new_n423_), .b(new_n418_), .c(new_n108_), .O(new_n424_));
  nand2  g371(.a(new_n354_), .b(new_n108_), .O(new_n425_));
  oai21  g372(.a(new_n73_), .b(new_n75_), .c(new_n271_), .O(new_n426_));
  nor2   g373(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  oai21  g374(.a(new_n427_), .b(new_n424_), .c(new_n117_), .O(new_n428_));
  oai21  g375(.a(new_n208_), .b(new_n53_), .c(new_n114_), .O(new_n429_));
  nand2  g376(.a(new_n429_), .b(new_n292_), .O(new_n430_));
  nand3  g377(.a(new_n430_), .b(new_n69_), .c(x17), .O(new_n431_));
