...
module FAU ( 
  ...
  nor4   g078(.a(new_n126_), .b(new_n64_), .c(x17), .d(x15), .O(z23));
  nand4  g079(.a(x18), .b(new_n91_), .c(x08), .d(x05), .O(new_n147_));
  inv1   g080(.a(x14), .O(new_n148_));
  nand4  g081(.a(new_n64_), .b(new_n148_), .c(x12), .d(new_n78_), .O(new_n149_));
  nand2  g082(.a(new_n60_), .b(x04), .O(new_n150_));
  aoi21  g083(.a(new_n149_), .b(new_n147_), .c(new_n150_), .O(new_n151_));
  inv1   g084(.a(x02), .O(new_n152_));
  nand3  g085(.a(x11), .b(new_n78_), .c(new_n152_), .O(new_n153_));
  nand3  g086(.a(new_n73_), .b(x05), .c(new_n69_), .O(new_n154_));
  nand3  g087(.a(x18), .b(x15), .c(x08), .O(new_n155_));
  aoi21  g088(.a(new_n154_), .b(new_n153_), .c(new_n155_), .O(new_n156_));
  oai21  g089(.a(new_n156_), .b(new_n151_), .c(new_n74_), .O(new_n157_));
  nand4  g090(.a(x18), .b(new_n60_), .c(new_n55_), .d(new_n78_), .O(new_n158_));
  nand2  g091(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g092(.a(new_n159_), .b(new_n98_), .O(new_n160_));
  nand4  g093(.a(new_n103_), .b(new_n58_), .c(x08), .d(x01), .O(new_n161_));
  inv1   g094(.a(x17), .O(new_n162_));
  nand2  g095(.a(new_n162_), .b(new_n54_), .O(new_n163_));
  aoi21  g096(.a(new_n161_), .b(new_n160_), .c(new_n163_), .O(z24));
  zero   g097(.O(z00));
  zero   g098(.O(z01));
  zero   g099(.O(z04));
  zero   g100(.O(z05));
