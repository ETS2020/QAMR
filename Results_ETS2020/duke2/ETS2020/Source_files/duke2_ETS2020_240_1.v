...
module FAU ( 
  ...
  inv1   g298(.a(new_n318_), .O(new_n356_));
  nand3  g299(.a(new_n199_), .b(x18), .c(new_n64_), .O(new_n357_));
  nand3  g300(.a(new_n331_), .b(new_n109_), .c(new_n176_), .O(new_n358_));
  nand2  g301(.a(new_n53_), .b(x04), .O(new_n359_));
  aoi21  g302(.a(new_n358_), .b(new_n357_), .c(new_n359_), .O(new_n360_));
  nand3  g303(.a(x11), .b(new_n71_), .c(new_n75_), .O(new_n361_));
  nand2  g304(.a(new_n106_), .b(new_n73_), .O(new_n362_));
  nand3  g305(.a(x18), .b(x15), .c(x08), .O(new_n363_));
  aoi21  g306(.a(new_n362_), .b(new_n361_), .c(new_n363_), .O(new_n364_));
  oai21  g307(.a(new_n364_), .b(new_n360_), .c(new_n92_), .O(new_n365_));
  nand3  g308(.a(new_n335_), .b(new_n80_), .c(new_n71_), .O(new_n366_));
  nand2  g309(.a(new_n366_), .b(new_n365_), .O(new_n367_));
  nand2  g310(.a(new_n367_), .b(new_n99_), .O(new_n368_));
  nor2   g311(.a(x18), .b(x15), .O(new_n369_));
  nand4  g312(.a(new_n369_), .b(new_n252_), .c(x08), .d(x01), .O(new_n370_));
  aoi21  g313(.a(new_n370_), .b(new_n368_), .c(new_n356_), .O(z24));
  nand2  g314(.a(new_n339_), .b(new_n80_), .O(new_n372_));
  nand2  g315(.a(new_n157_), .b(new_n137_), .O(new_n373_));
  aoi21  g316(.a(new_n372_), .b(new_n350_), .c(new_n373_), .O(z25));
  nor2   g317(.a(new_n89_), .b(x20), .O(z26));
  nor4   g318(.a(new_n81_), .b(new_n299_), .c(x15), .d(x05), .O(new_n376_));
  oai21  g319(.a(new_n376_), .b(new_n243_), .c(new_n92_), .O(new_n377_));
  nand3  g320(.a(new_n191_), .b(x19), .c(new_n53_), .O(new_n378_));
  aoi21  g321(.a(new_n378_), .b(new_n377_), .c(x07), .O(new_n379_));
  nor4   g322(.a(new_n263_), .b(new_n190_), .c(new_n80_), .d(new_n99_), .O(new_n380_));
  oai21  g323(.a(new_n380_), .b(new_n379_), .c(new_n157_), .O(new_n381_));
  nand3  g324(.a(x15), .b(new_n99_), .c(x00), .O(new_n382_));
  oai21  g325(.a(x15), .b(new_n99_), .c(new_n382_), .O(new_n383_));
  nand4  g326(.a(new_n383_), .b(new_n109_), .c(x17), .d(new_n71_), .O(new_n384_));
  nand2  g327(.a(new_n384_), .b(new_n381_), .O(new_n385_));
  nand2  g328(.a(new_n385_), .b(new_n72_), .O(new_n386_));
  nand3  g329(.a(new_n105_), .b(new_n71_), .c(x03), .O(new_n387_));
  inv1   g330(.a(new_n387_), .O(new_n388_));
  nand4  g331(.a(new_n388_), .b(new_n341_), .c(new_n157_), .d(x19), .O(new_n389_));
  nand2  g332(.a(new_n389_), .b(new_n386_), .O(z27));
  nand2  g333(.a(new_n68_), .b(x17), .O(new_n391_));
  nand3  g334(.a(new_n208_), .b(new_n92_), .c(x11), .O(new_n392_));
  aoi21  g335(.a(new_n392_), .b(new_n72_), .c(x02), .O(new_n393_));
  nand2  g336(.a(x11), .b(new_n99_), .O(new_n394_));
  oai21  g337(.a(new_n394_), .b(new_n393_), .c(x15), .O(new_n395_));
  nand3  g338(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n396_));
  inv1   g339(.a(new_n66_), .O(new_n397_));
  nor2   g340(.a(new_n397_), .b(x21), .O(new_n398_));
  nand4  g341(.a(new_n398_), .b(new_n396_), .c(new_n208_), .d(new_n122_), .O(new_n399_));
  aoi21  g342(.a(new_n399_), .b(new_n395_), .c(x05), .O(new_n400_));
  nand4  g343(.a(new_n196_), .b(new_n106_), .c(new_n53_), .d(x12), .O(new_n401_));
  nand2  g344(.a(new_n339_), .b(x21), .O(new_n402_));
  aoi21  g345(.a(new_n402_), .b(new_n401_), .c(x07), .O(new_n403_));
  oai21  g346(.a(new_n403_), .b(new_n400_), .c(x08), .O(new_n404_));
  nor3   g347(.a(new_n154_), .b(new_n397_), .c(new_n92_), .O(new_n405_));
  nor2   g348(.a(x19), .b(new_n53_), .O(new_n406_));
  nand3  g349(.a(new_n137_), .b(new_n72_), .c(new_n80_), .O(new_n407_));
  inv1   g350(.a(new_n407_), .O(new_n408_));
  oai21  g351(.a(new_n406_), .b(new_n405_), .c(new_n408_), .O(new_n409_));
  aoi21  g352(.a(new_n409_), .b(new_n404_), .c(new_n109_), .O(new_n410_));
  nand2  g353(.a(new_n339_), .b(new_n109_), .O(new_n411_));
  oai21  g354(.a(new_n73_), .b(new_n75_), .c(new_n252_), .O(new_n412_));
  nor2   g355(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  oai21  g356(.a(new_n413_), .b(new_n410_), .c(new_n160_), .O(new_n414_));
  nand2  g357(.a(x19), .b(x07), .O(new_n415_));
  aoi22  g358(.a(new_n415_), .b(new_n54_), .c(new_n99_), .d(x05), .O(new_n416_));
  oai21  g359(.a(new_n416_), .b(new_n391_), .c(new_n414_), .O(z28));
  zero   g360(.O(z02));
  zero   g361(.O(z03));
  zero   g362(.O(z07));
  zero   g363(.O(z15));
