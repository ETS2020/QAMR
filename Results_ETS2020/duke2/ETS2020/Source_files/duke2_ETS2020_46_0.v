...
module FAU ( 
  ...
  nor2   g52(.a(x20), .b(x14), .O(z04));
  inv1   g53(.a(new_n97_), .O(new_n109_));
  nand3  g54(.a(new_n94_), .b(new_n83_), .c(new_n54_), .O(new_n110_));
  nand4  g55(.a(new_n103_), .b(new_n102_), .c(x16), .d(x08), .O(new_n111_));
  aoi21  g56(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(z07));
  inv1   g57(.a(x06), .O(new_n115_));
  nand4  g58(.a(new_n54_), .b(new_n55_), .c(new_n60_), .d(new_n115_), .O(new_n116_));
  and2   g59(.a(new_n116_), .b(new_n92_), .O(new_n117_));
  nand3  g60(.a(new_n102_), .b(x09), .c(x08), .O(new_n118_));
  oai21  g61(.a(new_n117_), .b(new_n69_), .c(new_n118_), .O(new_n119_));
  nor2   g62(.a(new_n116_), .b(new_n81_), .O(new_n120_));
  aoi21  g63(.a(new_n119_), .b(new_n68_), .c(new_n120_), .O(new_n121_));
  nand2  g64(.a(new_n100_), .b(new_n54_), .O(new_n122_));
  oai21  g65(.a(new_n121_), .b(new_n109_), .c(new_n122_), .O(z10));
  inv1   g66(.a(new_n122_), .O(z13));
  nand2  g67(.a(new_n88_), .b(x17), .O(new_n128_));
  nor4   g68(.a(new_n128_), .b(new_n82_), .c(x09), .d(x07), .O(z15));
  inv1   g69(.a(new_n102_), .O(new_n133_));
  nor4   g70(.a(new_n133_), .b(new_n128_), .c(x15), .d(x09), .O(z19));
  nor4   g71(.a(new_n118_), .b(new_n88_), .c(x17), .d(x15), .O(z23));
  zero   g72(.O(z00));
  zero   g73(.O(z01));
  zero   g74(.O(z05));
  zero   g75(.O(z06));
