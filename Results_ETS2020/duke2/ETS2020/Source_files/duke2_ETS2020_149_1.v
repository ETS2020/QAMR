...
module FAU ( 
  ...
  nand2  g316(.a(new_n177_), .b(x09), .O(new_n373_));
  nand2  g317(.a(new_n154_), .b(new_n148_), .O(new_n374_));
  nor2   g318(.a(new_n374_), .b(new_n373_), .O(z23));
  inv1   g319(.a(new_n337_), .O(new_n376_));
  nand3  g320(.a(new_n128_), .b(x18), .c(new_n64_), .O(new_n377_));
  nand3  g321(.a(new_n349_), .b(new_n99_), .c(new_n215_), .O(new_n378_));
  nand2  g322(.a(new_n53_), .b(x04), .O(new_n379_));
  aoi21  g323(.a(new_n378_), .b(new_n377_), .c(new_n379_), .O(new_n380_));
  nand3  g324(.a(x11), .b(new_n71_), .c(new_n75_), .O(new_n381_));
  nand2  g325(.a(new_n108_), .b(new_n73_), .O(new_n382_));
  aoi21  g326(.a(new_n382_), .b(new_n381_), .c(new_n119_), .O(new_n383_));
  oai21  g327(.a(new_n383_), .b(new_n380_), .c(new_n141_), .O(new_n384_));
  nand3  g328(.a(new_n353_), .b(new_n86_), .c(new_n71_), .O(new_n385_));
  nand2  g329(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  nand2  g330(.a(new_n386_), .b(new_n103_), .O(new_n387_));
  nand4  g331(.a(new_n272_), .b(new_n117_), .c(new_n99_), .d(x08), .O(new_n388_));
  aoi21  g332(.a(new_n388_), .b(new_n387_), .c(new_n376_), .O(z24));
  nand2  g333(.a(new_n357_), .b(new_n86_), .O(new_n390_));
  nand2  g334(.a(new_n197_), .b(new_n148_), .O(new_n391_));
  aoi21  g335(.a(new_n390_), .b(new_n368_), .c(new_n391_), .O(z25));
  nor2   g336(.a(new_n89_), .b(x20), .O(z26));
  nand2  g337(.a(new_n131_), .b(new_n81_), .O(new_n394_));
  nor2   g338(.a(new_n394_), .b(new_n318_), .O(new_n395_));
  oai21  g339(.a(new_n395_), .b(new_n262_), .c(new_n141_), .O(new_n396_));
  nand3  g340(.a(new_n134_), .b(x19), .c(new_n53_), .O(new_n397_));
  aoi21  g341(.a(new_n397_), .b(new_n396_), .c(x07), .O(new_n398_));
  nor4   g342(.a(new_n284_), .b(new_n145_), .c(new_n86_), .d(new_n103_), .O(new_n399_));
  oai21  g343(.a(new_n399_), .b(new_n398_), .c(new_n197_), .O(new_n400_));
  nand3  g344(.a(x15), .b(new_n103_), .c(x00), .O(new_n401_));
  oai21  g345(.a(x15), .b(new_n103_), .c(new_n401_), .O(new_n402_));
  nand4  g346(.a(new_n402_), .b(new_n99_), .c(x17), .d(new_n71_), .O(new_n403_));
  nand2  g347(.a(new_n403_), .b(new_n400_), .O(new_n404_));
  nand2  g348(.a(new_n404_), .b(new_n72_), .O(new_n405_));
  nand3  g349(.a(new_n107_), .b(new_n71_), .c(x03), .O(new_n406_));
  inv1   g350(.a(new_n406_), .O(new_n407_));
  nand4  g351(.a(new_n407_), .b(new_n359_), .c(new_n197_), .d(x19), .O(new_n408_));
  nand2  g352(.a(new_n408_), .b(new_n405_), .O(z27));
  nand2  g353(.a(new_n68_), .b(x17), .O(new_n410_));
  nand3  g354(.a(new_n243_), .b(new_n141_), .c(x11), .O(new_n411_));
  aoi21  g355(.a(new_n411_), .b(new_n72_), .c(x02), .O(new_n412_));
  nand2  g356(.a(x11), .b(new_n103_), .O(new_n413_));
  oai21  g357(.a(new_n413_), .b(new_n412_), .c(x15), .O(new_n414_));
  nand3  g358(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n415_));
  inv1   g359(.a(new_n66_), .O(new_n416_));
  nor2   g360(.a(new_n416_), .b(x21), .O(new_n417_));
  nand4  g361(.a(new_n417_), .b(new_n415_), .c(new_n243_), .d(new_n163_), .O(new_n418_));
  aoi21  g362(.a(new_n418_), .b(new_n414_), .c(x05), .O(new_n419_));
  nand4  g363(.a(new_n237_), .b(new_n108_), .c(new_n53_), .d(x12), .O(new_n420_));
  nand2  g364(.a(new_n357_), .b(x21), .O(new_n421_));
  aoi21  g365(.a(new_n421_), .b(new_n420_), .c(x07), .O(new_n422_));
  oai21  g366(.a(new_n422_), .b(new_n419_), .c(x08), .O(new_n423_));
  nor3   g367(.a(new_n194_), .b(new_n416_), .c(new_n141_), .O(new_n424_));
  nor2   g368(.a(x19), .b(new_n53_), .O(new_n425_));
  nand3  g369(.a(new_n148_), .b(new_n72_), .c(new_n86_), .O(new_n426_));
  inv1   g370(.a(new_n426_), .O(new_n427_));
  oai21  g371(.a(new_n425_), .b(new_n424_), .c(new_n427_), .O(new_n428_));
  aoi21  g372(.a(new_n428_), .b(new_n423_), .c(new_n99_), .O(new_n429_));
  nand2  g373(.a(new_n357_), .b(new_n99_), .O(new_n430_));
  oai21  g374(.a(new_n73_), .b(new_n75_), .c(new_n272_), .O(new_n431_));
  nor2   g375(.a(new_n431_), .b(new_n430_), .O(new_n432_));
  oai21  g376(.a(new_n432_), .b(new_n429_), .c(new_n200_), .O(new_n433_));
  nand2  g377(.a(x19), .b(x07), .O(new_n434_));
  aoi22  g378(.a(new_n434_), .b(new_n54_), .c(new_n103_), .d(x05), .O(new_n435_));
  oai21  g379(.a(new_n435_), .b(new_n410_), .c(new_n433_), .O(z28));
  zero   g380(.O(z03));
  zero   g381(.O(z07));
  zero   g382(.O(z10));
  zero   g383(.O(z15));
