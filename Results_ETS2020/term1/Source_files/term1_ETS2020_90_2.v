// Benchmark "FAU" written by ABC on Tue Jun 23 22:59:26 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n55_,
  ...
  nor2   g08(.a(x20), .b(x15), .O(new_n55_));
  nor2   g09(.a(x21), .b(x16), .O(new_n56_));
  nor2   g10(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nor2   g11(.a(x24), .b(x19), .O(new_n58_));
  oai22  g12(.a(x23), .b(x18), .c(x22), .d(x17), .O(new_n59_));
  nor2   g13(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  inv1   g14(.a(x26), .O(new_n61_));
  xor2a  g15(.a(x28), .b(x27), .O(new_n62_));
  nand2  g16(.a(x03), .b(x02), .O(new_n63_));
  and2   g17(.a(x25), .b(x01), .O(new_n64_));
  nand4  g18(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(new_n61_), .O(new_n65_));
  aoi21  g19(.a(new_n60_), .b(new_n57_), .c(new_n65_), .O(z4));
  oai21  g20(.a(x28), .b(x27), .c(x29), .O(new_n70_));
  inv1   g21(.a(x30), .O(new_n71_));
  ...
  nand2  g44(.a(x32), .b(new_n71_), .O(new_n94_));
  oai21  g45(.a(new_n93_), .b(new_n71_), .c(new_n94_), .O(new_n95_));
  nand2  g46(.a(new_n95_), .b(new_n70_), .O(new_n96_));
  inv1   g47(.a(new_n70_), .O(new_n97_));
  ...
  nand2  g65(.a(new_n61_), .b(x00), .O(new_n115_));
  ...
  nand2  g69(.a(new_n91_), .b(new_n71_), .O(new_n119_));
  oai22  g70(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n91_), .O(new_n120_));
  nand2  g71(.a(new_n120_), .b(new_n70_), .O(new_n121_));
  ...
  nand2  g79(.a(x31), .b(new_n71_), .O(new_n129_));
