...
module FAU ( 
  ...
  and2   g48(.a(x28), .b(x27), .O(new_n93_));
  xor2a  g49(.a(new_n93_), .b(x29), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n90_), .c(new_n57_), .O(new_n95_));
  aoi21  g51(.a(new_n81_), .b(new_n78_), .c(new_n95_), .O(z5));
  inv1   g52(.a(x31), .O(new_n98_));
  nand4  g53(.a(new_n93_), .b(new_n98_), .c(x30), .d(x29), .O(new_n99_));
  nand2  g54(.a(new_n90_), .b(new_n57_), .O(new_n100_));
  nand3  g55(.a(new_n93_), .b(x30), .c(x29), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(x31), .c(new_n100_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n99_), .c(new_n82_), .O(z7));
  zero   g58(.O(z6));
  zero   g59(.O(z8));
  zero   g60(.O(z9));
endmodule
