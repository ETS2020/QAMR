...
module FAU ( 
  ...
  nor2   g013(.a(new_n75_), .b(x36), .O(new_n76_));
  nor2   g014(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  ...
  inv1   g019(.a(new_n75_), .O(new_n82_));
  ...
  nand3  g025(.a(new_n87_), .b(new_n84_), .c(z08), .O(z02));
  inv1   g026(.a(x28), .O(new_n89_));
  oai21  g027(.a(new_n74_), .b(new_n89_), .c(x27), .O(new_n90_));
  ...
  nor2   g052(.a(x40), .b(new_n112_), .O(new_n115_));
  aoi21  g053(.a(new_n114_), .b(new_n64_), .c(new_n115_), .O(new_n116_));
  nand2  g054(.a(x37), .b(x06), .O(new_n117_));
  oai21  g055(.a(new_n116_), .b(new_n76_), .c(new_n117_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(x27), .O(new_n119_));
  nand4  g057(.a(new_n80_), .b(z08), .c(x05), .d(new_n64_), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n119_), .O(z10));
  nand2  g059(.a(x39), .b(x29), .O(new_n122_));
  nor2   g060(.a(new_n73_), .b(new_n64_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n82_), .c(new_n122_), .O(new_n124_));
  aoi21  g062(.a(x40), .b(x08), .c(new_n75_), .O(new_n125_));
  nor2   g063(.a(new_n73_), .b(x04), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(x08), .O(new_n127_));
  nor2   g065(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  inv1   g066(.a(x09), .O(new_n129_));
  nand2  g067(.a(new_n78_), .b(new_n129_), .O(new_n130_));
  aoi21  g068(.a(new_n128_), .b(new_n124_), .c(new_n130_), .O(z11));
  aoi22  g069(.a(new_n63_), .b(new_n91_), .c(x40), .d(new_n73_), .O(new_n132_));
  nand2  g070(.a(z08), .b(new_n64_), .O(new_n133_));
  oai21  g071(.a(new_n66_), .b(new_n73_), .c(new_n133_), .O(new_n134_));
  oai21  g072(.a(new_n132_), .b(x10), .c(new_n134_), .O(z12));
  ...
  nand4  g078(.a(new_n140_), .b(new_n138_), .c(x40), .d(new_n136_), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x20), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n66_), .c(new_n141_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nor2   g083(.a(x13), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n80_), .c(z08), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  nand4  g086(.a(new_n139_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n149_));
  inv1   g087(.a(new_n149_), .O(new_n150_));
  nand3  g088(.a(new_n138_), .b(x40), .c(new_n136_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n143_), .O(new_n152_));
  nand2  g090(.a(new_n151_), .b(new_n73_), .O(new_n153_));
  nand3  g091(.a(new_n91_), .b(new_n74_), .c(x28), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x27), .c(new_n80_), .O(new_n155_));
  nand2  g093(.a(new_n146_), .b(z08), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n66_), .c(new_n155_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(new_n152_), .O(z14));
  ...
  inv1   g103(.a(x08), .O(new_n166_));
  aoi22  g104(.a(new_n75_), .b(new_n73_), .c(z08), .d(x29), .O(new_n167_));
  aoi21  g105(.a(new_n126_), .b(new_n75_), .c(new_n130_), .O(new_n168_));
  oai21  g106(.a(new_n167_), .b(new_n166_), .c(new_n168_), .O(z18));
  oai21  g107(.a(new_n74_), .b(new_n73_), .c(new_n166_), .O(new_n170_));
  nand2  g108(.a(z08), .b(x29), .O(new_n171_));
  oai21  g109(.a(new_n89_), .b(x27), .c(x35), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n170_), .c(new_n130_), .O(z20));
  aoi21  g112(.a(new_n128_), .b(new_n124_), .c(new_n130_), .O(z19));
endmodule
