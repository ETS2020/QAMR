...
module FAU ( 
  ...
  nand3  g061(.a(new_n123_), .b(x27), .c(new_n64_), .O(new_n124_));
  ...
  aoi22  g066(.a(new_n63_), .b(new_n88_), .c(x40), .d(new_n72_), .O(new_n129_));
  nand2  g067(.a(new_n86_), .b(new_n88_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x27), .O(new_n131_));
  oai21  g069(.a(new_n107_), .b(x04), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g101(.a(new_n123_), .b(new_n72_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n119_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n124_), .c(new_n77_), .d(new_n126_), .O(z18));
  oai21  g105(.a(new_n122_), .b(new_n72_), .c(new_n83_), .O(new_n168_));
  oai21  g106(.a(new_n74_), .b(x27), .c(x35), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n119_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n127_), .O(z20));
  aoi21  g109(.a(new_n125_), .b(new_n121_), .c(new_n127_), .O(z19));
endmodule
