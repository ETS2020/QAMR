// Benchmark "FAU" written by ABC on Mon Jul  6 14:59:36 2020
...
module FAU ( 
  ...
  nand2  g050(.a(x40), .b(x05), .O(new_n113_));
  ...
  nand2  g061(.a(x39), .b(x08), .O(new_n124_));
  ...
  oai22  g088(.a(new_n145_), .b(new_n69_), .c(new_n142_), .d(new_n66_), .O(new_n151_));
  nand2  g089(.a(x39), .b(x13), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(x40), .c(new_n64_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n75_), .c(new_n68_), .O(new_n154_));
  ...
  aoi21  g108(.a(new_n78_), .b(new_n68_), .c(new_n170_), .O(new_n171_));
