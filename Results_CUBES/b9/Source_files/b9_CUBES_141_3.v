// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:39 2020
...
module FAU ( 
  ...
  oai22  g004(.a(new_n66_), .b(x15), .c(new_n65_), .d(new_n63_), .O(new_n67_));
  nand2  g005(.a(new_n67_), .b(x27), .O(new_n68_));
  nand2  g006(.a(x40), .b(x39), .O(new_n69_));
  inv1   g007(.a(new_n69_), .O(z08));
  nand3  g008(.a(z08), .b(x10), .c(new_n64_), .O(new_n71_));
  nand3  g009(.a(new_n71_), .b(new_n68_), .c(x16), .O(z00));
  ...
  nand2  g047(.a(new_n69_), .b(x07), .O(new_n110_));
  oai21  g048(.a(new_n69_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nor3   g049(.a(new_n78_), .b(new_n69_), .c(new_n109_), .O(new_n112_));
  aoi21  g050(.a(new_n111_), .b(new_n77_), .c(new_n112_), .O(new_n113_));
  nand3  g051(.a(x37), .b(x27), .c(x06), .O(new_n114_));
  oai21  g052(.a(new_n113_), .b(x04), .c(new_n114_), .O(z10));
  nand2  g053(.a(z08), .b(x29), .O(new_n116_));
  nor2   g054(.a(new_n73_), .b(new_n64_), .O(new_n117_));
  oai21  g055(.a(new_n117_), .b(new_n76_), .c(new_n116_), .O(new_n118_));
  nand4  g056(.a(x35), .b(new_n75_), .c(x27), .d(new_n64_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n83_), .O(new_n120_));
  nor2   g058(.a(x30), .b(x09), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  aoi21  g060(.a(new_n120_), .b(new_n118_), .c(new_n122_), .O(z11));
  aoi22  g061(.a(new_n63_), .b(new_n88_), .c(x40), .d(new_n73_), .O(new_n124_));
  oai22  g062(.a(new_n69_), .b(x04), .c(new_n66_), .d(new_n73_), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(x10), .c(new_n125_), .O(z12));
  inv1   g064(.a(x13), .O(new_n127_));
  inv1   g065(.a(x39), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(x04), .O(new_n129_));
  nand2  g067(.a(x36), .b(x35), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x28), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n129_), .c(x40), .d(new_n127_), .O(new_n132_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n79_), .c(z08), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(z13));
  inv1   g081(.a(x30), .O(new_n144_));
  inv1   g082(.a(x32), .O(new_n145_));
  nand4  g083(.a(new_n130_), .b(new_n145_), .c(new_n144_), .d(x28), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  nand2  g085(.a(new_n141_), .b(z08), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n136_), .O(new_n149_));
  nand3  g087(.a(new_n129_), .b(x40), .c(new_n127_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n73_), .O(new_n151_));
  nand3  g089(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n78_), .O(new_n154_));
  nand2  g092(.a(new_n148_), .b(new_n66_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .d(new_n149_), .O(z14));
  ...
  oai21  g101(.a(new_n76_), .b(x27), .c(new_n116_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n121_), .c(new_n119_), .O(z18));
  oai21  g104(.a(new_n86_), .b(new_n73_), .c(new_n83_), .O(new_n167_));
  oai21  g105(.a(new_n75_), .b(x27), .c(x35), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n116_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n122_), .O(z20));
  aoi21  g108(.a(new_n120_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
