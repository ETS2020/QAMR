...
module FAU ( 
  ...
  nand2  g062(.a(x39), .b(new_n64_), .O(new_n125_));
  inv1   g063(.a(new_n66_), .O(new_n126_));
  ...
  oai21  g068(.a(new_n130_), .b(new_n72_), .c(new_n129_), .O(new_n131_));
  inv1   g069(.a(x40), .O(new_n132_));
  nand3  g070(.a(new_n85_), .b(new_n132_), .c(new_n87_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n131_), .c(new_n128_), .O(z12));
  nand2  g072(.a(x36), .b(x35), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x28), .O(new_n136_));
  nor2   g074(.a(new_n132_), .b(x13), .O(new_n137_));
  ...
  nand2  g096(.a(new_n153_), .b(new_n127_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n158_), .c(new_n154_), .O(z14));
  ...
  oai21  g105(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x08), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g108(.a(new_n155_), .b(new_n72_), .c(new_n82_), .O(new_n171_));
  oai21  g109(.a(new_n74_), .b(x27), .c(x35), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n117_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n123_), .O(z20));
  aoi21  g112(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
