// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:16 2020
...
module FAU ( 
  ...
  nand3  g050(.a(new_n112_), .b(new_n111_), .c(x40), .O(new_n113_));
  inv1   g051(.a(x05), .O(new_n114_));
  nor3   g052(.a(new_n77_), .b(new_n106_), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g060(.a(new_n122_), .b(new_n82_), .O(new_n123_));
  ...
  nor2   g068(.a(new_n110_), .b(x04), .O(new_n131_));
  nand2  g069(.a(x36), .b(x35), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x28), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(new_n131_), .c(x40), .d(new_n130_), .O(new_n134_));
  ...
  nand4  g085(.a(new_n132_), .b(new_n147_), .c(new_n146_), .d(x28), .O(new_n148_));
  ...
  nand3  g089(.a(new_n131_), .b(x40), .c(new_n130_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n72_), .O(new_n153_));
  nand3  g091(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n154_));
  ...
  oai21  g103(.a(new_n75_), .b(x27), .c(new_n119_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n124_), .c(new_n122_), .O(z18));
  ...
  aoi21  g110(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(z19));
endmodule
