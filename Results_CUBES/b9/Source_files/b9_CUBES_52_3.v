...
module FAU ( 
  ...
  nand3  g090(.a(new_n68_), .b(new_n152_), .c(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n80_), .O(new_n155_));
  oai21  g093(.a(new_n71_), .b(new_n75_), .c(new_n150_), .O(new_n156_));
  ...
  oai21  g105(.a(new_n152_), .b(new_n75_), .c(new_n85_), .O(new_n168_));
