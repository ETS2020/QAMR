...
module FAU ( 
  ...
  oai21  g055(.a(new_n117_), .b(new_n75_), .c(new_n82_), .O(new_n118_));
  ...
  oai21  g100(.a(new_n75_), .b(x27), .c(new_n82_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g103(.a(new_n86_), .b(new_n72_), .c(new_n119_), .O(new_n166_));
  oai21  g104(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n82_), .O(new_n168_));
