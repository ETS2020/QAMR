...
module FAU ( 
  ...
  nand3  g090(.a(new_n89_), .b(new_n125_), .c(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n79_), .O(new_n155_));
  nand2  g093(.a(new_n146_), .b(z08), .O(new_n156_));
  aoi21  g094(.a(new_n146_), .b(x39), .c(x27), .O(new_n157_));
  aoi21  g095(.a(new_n156_), .b(new_n66_), .c(new_n157_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n155_), .c(new_n152_), .O(z14));
