...
module FAU ( 
  ...
  aoi22  g060(.a(new_n63_), .b(new_n85_), .c(x40), .d(new_n72_), .O(new_n123_));
  oai22  g061(.a(new_n104_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(x10), .c(new_n124_), .O(z12));
  inv1   g063(.a(x13), .O(new_n126_));
  ...
  nand4  g068(.a(new_n130_), .b(new_n128_), .c(x40), .d(new_n126_), .O(new_n131_));
  ...
  nand3  g086(.a(new_n128_), .b(x40), .c(new_n126_), .O(new_n149_));
  ...
  nand2  g091(.a(new_n147_), .b(new_n66_), .O(new_n154_));
  ...
  inv1   g100(.a(new_n75_), .O(new_n163_));
