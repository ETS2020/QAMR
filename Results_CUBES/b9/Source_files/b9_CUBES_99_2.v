...
module FAU ( 
  ...
  aoi21  g020(.a(new_n81_), .b(x04), .c(new_n82_), .O(new_n83_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n74_), .c(x27), .O(new_n115_));
  nand3  g053(.a(new_n78_), .b(z08), .c(x05), .O(new_n116_));
  ...
  nor2   g059(.a(new_n85_), .b(new_n64_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n81_), .c(new_n121_), .O(new_n123_));
  nand3  g061(.a(new_n80_), .b(x27), .c(new_n64_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n84_), .O(new_n125_));
  inv1   g063(.a(x09), .O(new_n126_));
  nand2  g064(.a(new_n76_), .b(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n123_), .c(new_n127_), .O(z11));
  aoi22  g066(.a(new_n63_), .b(new_n90_), .c(x40), .d(new_n85_), .O(new_n129_));
  nand2  g067(.a(z08), .b(new_n64_), .O(new_n130_));
  oai21  g068(.a(new_n66_), .b(new_n85_), .c(new_n130_), .O(new_n131_));
  oai21  g069(.a(new_n129_), .b(x10), .c(new_n131_), .O(z12));
  ...
  nand2  g078(.a(new_n88_), .b(new_n90_), .O(new_n141_));
  ...
  nand4  g086(.a(new_n136_), .b(new_n77_), .c(new_n76_), .d(x28), .O(new_n149_));
  ...
  nand3  g090(.a(new_n135_), .b(x40), .c(new_n133_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n85_), .O(new_n154_));
  nand3  g092(.a(new_n90_), .b(new_n72_), .c(x28), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n77_), .c(new_n76_), .O(new_n157_));
  nand2  g095(.a(new_n151_), .b(new_n66_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n154_), .d(new_n152_), .O(z14));
  ...
  nand2  g104(.a(new_n80_), .b(new_n85_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n121_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x08), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n124_), .c(new_n76_), .d(new_n126_), .O(z18));
  oai21  g108(.a(new_n72_), .b(new_n85_), .c(new_n84_), .O(new_n171_));
  inv1   g109(.a(x28), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(x27), .c(x35), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n121_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n127_), .O(z20));
  aoi21  g113(.a(new_n125_), .b(new_n123_), .c(new_n127_), .O(z19));
endmodule
