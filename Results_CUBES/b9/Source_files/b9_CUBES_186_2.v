// Benchmark "FAU" written by ABC on Mon Jul  6 15:01:04 2020
...
module FAU ( 
  ...
  inv1   g054(.a(x29), .O(new_n117_));
  inv1   g055(.a(x39), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x09), .c(x40), .O(new_n120_));
  nor2   g058(.a(new_n85_), .b(x28), .O(new_n121_));
  oai21  g059(.a(new_n72_), .b(new_n64_), .c(new_n121_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  inv1   g061(.a(x09), .O(new_n124_));
  nand3  g062(.a(new_n121_), .b(x27), .c(new_n64_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(new_n124_), .c(new_n82_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n123_), .c(x30), .O(z11));
  ...
  nand3  g069(.a(x40), .b(x39), .c(new_n64_), .O(new_n132_));
  ...
  inv1   g087(.a(x30), .O(new_n150_));
  inv1   g088(.a(x32), .O(new_n151_));
  nand4  g089(.a(new_n135_), .b(new_n151_), .c(new_n150_), .d(x28), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n147_), .c(x40), .d(x39), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n142_), .O(new_n154_));
  oai21  g092(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n155_));
  nand3  g093(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n156_));
  ...
  nand4  g097(.a(new_n159_), .b(new_n158_), .c(new_n155_), .d(new_n154_), .O(z14));
  ...
  oai22  g105(.a(new_n75_), .b(x27), .c(new_n106_), .d(new_n117_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x08), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n125_), .c(new_n150_), .d(new_n124_), .O(z18));
  oai21  g108(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n171_));
  aoi21  g109(.a(x28), .b(new_n72_), .c(new_n85_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n119_), .c(new_n171_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n124_), .O(new_n174_));
  or2    g112(.a(new_n172_), .b(x40), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(x30), .O(z20));
  aoi21  g114(.a(new_n126_), .b(new_n123_), .c(x30), .O(z19));
endmodule
