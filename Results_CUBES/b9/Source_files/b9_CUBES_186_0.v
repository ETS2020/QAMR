...
module FAU ( 
  ...
  nor2   g071(.a(new_n125_), .b(x13), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(new_n133_), .c(x39), .d(new_n64_), .O(new_n135_));
  ...
  nand2  g088(.a(new_n150_), .b(new_n139_), .O(new_n151_));
  ...
  oai22  g093(.a(new_n126_), .b(new_n66_), .c(x13), .d(x04), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n155_), .c(new_n152_), .d(new_n151_), .O(z14));
