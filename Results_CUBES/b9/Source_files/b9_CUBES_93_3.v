...
module FAU ( 
  ...
  oai21  g052(.a(new_n109_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand3  g053(.a(new_n115_), .b(new_n74_), .c(x27), .O(new_n116_));
  nand3  g054(.a(new_n78_), .b(z08), .c(x05), .O(new_n117_));
  ...
  nor2   g060(.a(new_n85_), .b(new_n64_), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n81_), .c(new_n122_), .O(new_n124_));
  nand3  g062(.a(new_n80_), .b(x27), .c(new_n64_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  inv1   g064(.a(x09), .O(new_n127_));
  nand2  g065(.a(new_n76_), .b(new_n127_), .O(new_n128_));
  aoi21  g066(.a(new_n126_), .b(new_n124_), .c(new_n128_), .O(z11));
  aoi22  g067(.a(new_n63_), .b(new_n90_), .c(x40), .d(new_n85_), .O(new_n130_));
  oai22  g068(.a(new_n109_), .b(x04), .c(new_n66_), .d(new_n85_), .O(new_n131_));
  ...
  nand2  g105(.a(new_n167_), .b(new_n122_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x08), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n125_), .c(new_n76_), .d(new_n127_), .O(z18));
  ...
  nand2  g111(.a(new_n173_), .b(new_n122_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n171_), .c(new_n128_), .O(z20));
  aoi21  g113(.a(new_n126_), .b(new_n124_), .c(new_n128_), .O(z19));
endmodule
