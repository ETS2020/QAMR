...
module FAU ( 
  ...
  oai21  g054(.a(z08), .b(x09), .c(x29), .O(new_n117_));
  ...
  aoi21  g061(.a(new_n123_), .b(new_n119_), .c(x30), .O(z11));
  aoi21  g062(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n125_));
  inv1   g063(.a(new_n66_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x27), .O(new_n127_));
  oai21  g065(.a(new_n82_), .b(x04), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n126_), .O(new_n139_));
  ...
  nand2  g091(.a(new_n149_), .b(new_n127_), .O(new_n154_));
  ...
  inv1   g100(.a(x29), .O(new_n163_));
  oai22  g101(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n163_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n122_), .c(new_n145_), .d(new_n121_), .O(z18));
  oai21  g104(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n167_));
  aoi21  g105(.a(x28), .b(new_n72_), .c(new_n86_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(z08), .c(new_n167_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n121_), .O(new_n170_));
  or2    g108(.a(new_n168_), .b(x29), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(x30), .O(z20));
  aoi21  g110(.a(new_n123_), .b(new_n119_), .c(x30), .O(z19));
endmodule
