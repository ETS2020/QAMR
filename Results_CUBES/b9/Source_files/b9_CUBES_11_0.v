// Benchmark "FAU" written by ABC on Mon Jul  6 14:59:26 2020
...
module FAU ( 
  ...
  nor2   g063(.a(new_n125_), .b(x27), .O(new_n126_));
  aoi21  g064(.a(new_n63_), .b(new_n87_), .c(new_n126_), .O(new_n127_));
  ...
  nand3  g070(.a(x36), .b(x35), .c(new_n132_), .O(new_n133_));
  nand2  g071(.a(x40), .b(new_n74_), .O(new_n134_));
  inv1   g072(.a(x13), .O(new_n135_));
  nand3  g073(.a(x39), .b(new_n135_), .c(new_n64_), .O(new_n136_));
  ...
  nor2   g077(.a(new_n139_), .b(new_n66_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n137_), .c(x27), .O(new_n141_));
  ...
  nand4  g084(.a(new_n146_), .b(new_n145_), .c(new_n132_), .d(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n142_), .c(x40), .d(x39), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n139_), .O(new_n149_));
  oai21  g087(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n150_));
  nand3  g088(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n77_), .O(new_n153_));
  oai22  g091(.a(new_n126_), .b(new_n66_), .c(x13), .d(x04), .O(new_n154_));
  ...
  nand3  g102(.a(new_n164_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g103(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n166_));
  oai21  g104(.a(new_n74_), .b(x27), .c(x35), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n117_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n123_), .O(z20));
  aoi21  g107(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
