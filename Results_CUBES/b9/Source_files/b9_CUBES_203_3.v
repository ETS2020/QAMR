...
module FAU ( 
  ...
  inv1   g064(.a(new_n75_), .O(new_n127_));
  ...
  aoi21  g070(.a(x39), .b(new_n64_), .c(new_n94_), .O(new_n133_));
  nor2   g071(.a(x40), .b(x37), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n133_), .c(new_n86_), .O(new_n135_));
  aoi21  g073(.a(new_n63_), .b(x40), .c(new_n72_), .O(new_n136_));
  or2    g074(.a(new_n136_), .b(x10), .O(new_n137_));
  oai21  g075(.a(new_n112_), .b(x04), .c(new_n72_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n135_), .O(z12));
  aoi21  g077(.a(x36), .b(x35), .c(new_n74_), .O(new_n140_));
  nand2  g078(.a(new_n96_), .b(z08), .O(new_n141_));
  nor2   g079(.a(x19), .b(x18), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x20), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n66_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n96_), .b(new_n78_), .c(z08), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n145_), .O(z13));
  aoi21  g085(.a(new_n96_), .b(x39), .c(new_n94_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n134_), .c(new_n86_), .O(new_n149_));
  nand3  g087(.a(x40), .b(new_n80_), .c(x28), .O(new_n150_));
  ...
  nand4  g092(.a(new_n73_), .b(new_n154_), .c(new_n153_), .d(x28), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n141_), .c(new_n143_), .O(new_n157_));
  nand2  g095(.a(new_n141_), .b(new_n72_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n152_), .d(new_n149_), .O(z14));
  ...
  oai21  g104(.a(new_n75_), .b(x27), .c(new_n123_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n130_), .c(new_n128_), .O(z18));
  oai21  g107(.a(new_n80_), .b(new_n72_), .c(new_n126_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n123_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n131_), .O(z20));
  aoi21  g111(.a(new_n129_), .b(new_n125_), .c(new_n131_), .O(z19));
endmodule
