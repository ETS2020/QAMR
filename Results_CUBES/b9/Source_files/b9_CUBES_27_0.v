// Benchmark "FAU" written by ABC on Mon Jul  6 14:59:35 2020
...
module FAU ( 
  ...
  aoi21  g051(.a(new_n113_), .b(x27), .c(new_n112_), .O(new_n114_));
  ...
  oai22  g060(.a(new_n77_), .b(x04), .c(new_n112_), .d(new_n122_), .O(new_n123_));
  ...
  oai22  g070(.a(new_n66_), .b(new_n74_), .c(new_n113_), .d(x04), .O(new_n133_));
  nor3   g071(.a(x37), .b(x36), .c(x35), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n74_), .c(new_n70_), .O(new_n135_));
  nand3  g073(.a(new_n87_), .b(new_n112_), .c(new_n89_), .O(new_n136_));
  ...
  aoi21  g094(.a(new_n146_), .b(x40), .c(x27), .O(new_n157_));
  ...
  aoi22  g111(.a(new_n173_), .b(new_n122_), .c(new_n112_), .d(new_n125_), .O(new_n174_));
