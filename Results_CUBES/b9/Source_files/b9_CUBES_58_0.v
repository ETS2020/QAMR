...
module FAU ( 
  ...
  aoi21  g075(.a(x35), .b(x28), .c(new_n137_), .O(new_n138_));
  nor2   g076(.a(x40), .b(x28), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n138_), .c(new_n90_), .O(new_n140_));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  nor2   g079(.a(new_n69_), .b(x27), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(new_n71_), .O(new_n143_));
  nand2  g081(.a(new_n126_), .b(z08), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(new_n140_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(new_n137_), .c(x40), .d(new_n147_), .O(new_n150_));
  nor2   g088(.a(x19), .b(x18), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x20), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n66_), .c(new_n150_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand2  g092(.a(new_n147_), .b(new_n64_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n120_), .c(new_n154_), .O(z13));
  inv1   g094(.a(x32), .O(new_n157_));
  nand4  g095(.a(new_n148_), .b(new_n157_), .c(new_n134_), .d(x28), .O(new_n158_));
  nand2  g096(.a(new_n155_), .b(x40), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n158_), .c(z08), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n152_), .O(new_n161_));
  oai21  g099(.a(new_n142_), .b(new_n66_), .c(new_n155_), .O(new_n162_));
  ...
  inv1   g103(.a(z08), .O(new_n166_));
  oai21  g104(.a(x37), .b(x28), .c(x27), .O(new_n167_));
  nor3   g105(.a(x39), .b(x37), .c(x35), .O(new_n168_));
  aoi21  g106(.a(new_n167_), .b(new_n166_), .c(new_n168_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n165_), .c(new_n162_), .d(new_n161_), .O(z14));
  ...
  nor2   g115(.a(new_n75_), .b(x28), .O(new_n178_));
  ...
  nor2   g119(.a(new_n89_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n178_), .c(new_n135_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n181_), .O(z18));
  nand2  g122(.a(x39), .b(x29), .O(new_n185_));
  nor2   g123(.a(new_n87_), .b(x27), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n75_), .c(new_n185_), .O(new_n187_));
  aoi21  g125(.a(x35), .b(x27), .c(x08), .O(new_n188_));
  aoi21  g126(.a(new_n186_), .b(new_n69_), .c(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n187_), .c(new_n135_), .O(z20));
  aoi21  g128(.a(new_n132_), .b(new_n128_), .c(new_n135_), .O(z19));
endmodule
