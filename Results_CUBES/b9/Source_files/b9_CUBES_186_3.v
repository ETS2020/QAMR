// Benchmark "FAU" written by ABC on Mon Jul  6 15:01:05 2020
...
module FAU ( 
  ...
  aoi21  g054(.a(x40), .b(x29), .c(x09), .O(new_n117_));
  inv1   g055(.a(x40), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(x39), .O(new_n119_));
  nor2   g057(.a(new_n72_), .b(new_n64_), .O(new_n120_));
  oai22  g058(.a(new_n120_), .b(new_n75_), .c(new_n119_), .d(new_n117_), .O(new_n121_));
  inv1   g059(.a(x09), .O(new_n122_));
  nand4  g060(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n122_), .c(new_n82_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n121_), .c(x30), .O(z11));
  aoi22  g063(.a(new_n63_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n126_));
  oai22  g064(.a(new_n106_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(x10), .c(new_n127_), .O(z12));
  nand2  g066(.a(x36), .b(x35), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x28), .O(new_n130_));
  nor2   g068(.a(new_n118_), .b(x13), .O(new_n131_));
  ...
  and2   g087(.a(x40), .b(x13), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n65_), .c(new_n72_), .O(new_n151_));
  ...
  oai22  g102(.a(new_n75_), .b(x27), .c(new_n106_), .d(new_n164_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(new_n123_), .c(new_n144_), .d(new_n122_), .O(z18));
  nor2   g105(.a(new_n118_), .b(new_n164_), .O(new_n168_));
  oai21  g106(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n169_));
  aoi21  g107(.a(x28), .b(new_n72_), .c(new_n85_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(new_n169_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n122_), .O(new_n172_));
  inv1   g110(.a(new_n170_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n119_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(x30), .O(z20));
  aoi21  g113(.a(new_n124_), .b(new_n121_), .c(x30), .O(z19));
endmodule
