...
module FAU ( 
  ...
  inv1   g084(.a(x20), .O(new_n147_));
  inv1   g085(.a(x32), .O(new_n148_));
  nand4  g086(.a(new_n135_), .b(new_n148_), .c(new_n125_), .d(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(new_n144_), .c(x40), .d(x39), .O(new_n150_));
  oai21  g088(.a(new_n147_), .b(x19), .c(new_n150_), .O(new_n151_));
  inv1   g089(.a(x35), .O(new_n152_));
  nand3  g090(.a(new_n87_), .b(new_n152_), .c(x28), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n77_), .c(x18), .O(new_n155_));
  oai22  g093(.a(new_n129_), .b(new_n66_), .c(x13), .d(x04), .O(new_n156_));
  oai21  g094(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n151_), .O(z14));
  ...
  nor2   g103(.a(new_n152_), .b(x28), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n72_), .c(z08), .d(x29), .O(new_n167_));
  nor2   g105(.a(new_n72_), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n126_), .O(new_n169_));
  oai21  g107(.a(new_n167_), .b(new_n120_), .c(new_n169_), .O(z18));
  oai21  g108(.a(new_n152_), .b(new_n72_), .c(new_n120_), .O(new_n171_));
