...
module FAU ( 
  ...
  nand4  g059(.a(x35), .b(new_n76_), .c(x27), .d(new_n64_), .O(new_n122_));
  ...
  oai21  g065(.a(new_n127_), .b(new_n74_), .c(new_n70_), .O(new_n128_));
  oai22  g066(.a(new_n68_), .b(x04), .c(new_n66_), .d(new_n74_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(z12));
  ...
  aoi21  g076(.a(new_n138_), .b(x27), .c(new_n80_), .O(new_n139_));
  inv1   g077(.a(x13), .O(new_n140_));
  nand4  g078(.a(x40), .b(x39), .c(new_n140_), .d(new_n64_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n139_), .c(new_n136_), .O(z13));
  nor2   g080(.a(x37), .b(x35), .O(new_n143_));
  aoi21  g081(.a(new_n137_), .b(new_n134_), .c(new_n143_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n76_), .c(x27), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n79_), .O(new_n146_));
  nand2  g084(.a(new_n140_), .b(new_n64_), .O(new_n147_));
  nand2  g085(.a(x27), .b(x18), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n131_), .c(x20), .d(new_n133_), .O(new_n149_));
  aoi22  g087(.a(new_n149_), .b(new_n147_), .c(new_n136_), .d(new_n68_), .O(new_n150_));
  ...
  oai21  g096(.a(new_n77_), .b(x27), .c(new_n118_), .O(new_n159_));
  ...
  nand2  g100(.a(new_n162_), .b(new_n121_), .O(new_n163_));
  oai21  g101(.a(new_n76_), .b(x27), .c(x35), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n118_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n163_), .c(new_n125_), .O(z20));
  aoi21  g104(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z19));
endmodule
