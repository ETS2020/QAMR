...
module FAU ( 
  ...
  nor2   g057(.a(new_n119_), .b(x28), .O(new_n120_));
  ...
  nand4  g076(.a(new_n138_), .b(x20), .c(new_n137_), .d(new_n136_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x27), .O(new_n141_));
  nor2   g079(.a(x13), .b(x04), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n112_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(z13));
  nand3  g082(.a(x20), .b(new_n137_), .c(new_n136_), .O(new_n145_));
  inv1   g083(.a(x32), .O(new_n146_));
  nand4  g084(.a(new_n133_), .b(new_n146_), .c(new_n124_), .d(x28), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  nand2  g086(.a(new_n142_), .b(z08), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n145_), .O(new_n150_));
  nand3  g088(.a(new_n132_), .b(x40), .c(new_n130_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n72_), .O(new_n152_));
  nand3  g090(.a(new_n87_), .b(new_n119_), .c(x28), .O(new_n153_));
  ...
  nand2  g102(.a(new_n120_), .b(new_n72_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n116_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x08), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n121_), .c(new_n124_), .d(new_n123_), .O(z18));
  oai21  g106(.a(new_n119_), .b(new_n72_), .c(new_n82_), .O(new_n169_));
  oai21  g107(.a(new_n74_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n116_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n125_), .O(z20));
  aoi21  g110(.a(new_n122_), .b(new_n118_), .c(new_n125_), .O(z19));
endmodule
