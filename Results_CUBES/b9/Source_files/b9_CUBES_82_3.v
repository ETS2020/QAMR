...
module FAU ( 
  ...
  aoi21  g020(.a(new_n74_), .b(x04), .c(new_n82_), .O(new_n83_));
  nand2  g021(.a(new_n77_), .b(x04), .O(new_n84_));
  nand4  g022(.a(new_n84_), .b(new_n83_), .c(x40), .d(x39), .O(z02));
  inv1   g023(.a(x35), .O(new_n86_));
  oai21  g024(.a(new_n86_), .b(new_n76_), .c(x27), .O(new_n87_));
  ...
  oai21  g048(.a(new_n68_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nor2   g049(.a(new_n79_), .b(new_n68_), .O(new_n112_));
  aoi22  g050(.a(new_n112_), .b(x05), .c(new_n111_), .d(new_n78_), .O(new_n113_));
  nand3  g051(.a(x37), .b(x27), .c(x06), .O(new_n114_));
  oai21  g052(.a(new_n113_), .b(x04), .c(new_n114_), .O(z10));
  inv1   g053(.a(x08), .O(new_n116_));
  nor2   g054(.a(new_n86_), .b(x28), .O(new_n117_));
  oai21  g055(.a(new_n74_), .b(new_n64_), .c(new_n117_), .O(new_n118_));
  aoi21  g056(.a(new_n74_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  nor2   g057(.a(x30), .b(x09), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n119_), .O(z11));
  nor3   g060(.a(x37), .b(x36), .c(x35), .O(new_n123_));
  nand2  g061(.a(x40), .b(new_n74_), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(new_n125_));
  oai21  g063(.a(new_n125_), .b(new_n123_), .c(new_n70_), .O(new_n126_));
  nand2  g064(.a(z08), .b(new_n64_), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(new_n64_), .O(new_n128_));
  aoi22  g066(.a(new_n128_), .b(new_n74_), .c(new_n127_), .d(new_n66_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n126_), .O(z12));
  inv1   g068(.a(x13), .O(new_n131_));
  inv1   g069(.a(x39), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(x04), .O(new_n133_));
  nand2  g071(.a(x36), .b(x35), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x28), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n133_), .c(x40), .d(new_n131_), .O(new_n136_));
  ...
  nand3  g082(.a(new_n112_), .b(new_n131_), .c(new_n64_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(z13));
  nor2   g084(.a(x37), .b(x35), .O(new_n147_));
  aoi21  g085(.a(new_n140_), .b(new_n134_), .c(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n76_), .c(x27), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n79_), .O(new_n150_));
  nand2  g088(.a(new_n131_), .b(new_n64_), .O(new_n151_));
  nand3  g089(.a(new_n141_), .b(new_n124_), .c(new_n137_), .O(new_n152_));
  nor2   g090(.a(x19), .b(x18), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n137_), .c(x27), .d(x20), .O(new_n154_));
  aoi22  g092(.a(new_n154_), .b(new_n68_), .c(new_n152_), .d(new_n151_), .O(new_n155_));
  ...
  nor2   g101(.a(new_n74_), .b(x04), .O(new_n164_));
  nor2   g102(.a(x27), .b(new_n116_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n117_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n120_), .O(z18));
  oai21  g105(.a(x28), .b(new_n116_), .c(new_n74_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x35), .c(new_n121_), .O(z20));
  nor2   g107(.a(new_n121_), .b(new_n119_), .O(z19));
endmodule
