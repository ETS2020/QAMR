...
module FAU ( 
  ...
  nand4  g081(.a(new_n131_), .b(new_n143_), .c(new_n142_), .d(x28), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  nand2  g083(.a(new_n139_), .b(z08), .O(new_n146_));
  oai22  g084(.a(new_n146_), .b(new_n145_), .c(x19), .d(x18), .O(new_n147_));
  nand3  g085(.a(new_n130_), .b(x40), .c(new_n128_), .O(new_n148_));
  ...
  aoi21  g091(.a(new_n146_), .b(new_n66_), .c(new_n153_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(z14));
