// Benchmark "FAU" written by ABC on Mon Jul  6 15:01:03 2020
...
module FAU ( 
  ...
  nor2   g051(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  aoi21  g052(.a(new_n112_), .b(new_n76_), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g059(.a(x40), .b(x04), .O(new_n122_));
  nand4  g060(.a(new_n122_), .b(x35), .c(new_n74_), .d(x27), .O(new_n123_));
  ...
  aoi21  g065(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z11));
  nor3   g066(.a(x37), .b(x36), .c(x35), .O(new_n129_));
  ...
  nand2  g071(.a(new_n122_), .b(z08), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(new_n72_), .c(new_n133_), .d(new_n66_), .O(new_n135_));
  ...
  inv1   g078(.a(x18), .O(new_n141_));
  inv1   g079(.a(x19), .O(new_n142_));
  nand3  g080(.a(x20), .b(new_n142_), .c(new_n141_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(new_n66_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n140_), .c(x27), .O(new_n145_));
  oai21  g083(.a(new_n138_), .b(new_n77_), .c(new_n145_), .O(z13));
  inv1   g084(.a(x32), .O(new_n147_));
  nand4  g085(.a(new_n139_), .b(new_n147_), .c(new_n126_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n122_), .c(x39), .d(new_n137_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n143_), .O(new_n150_));
  oai21  g088(.a(new_n85_), .b(new_n74_), .c(new_n138_), .O(new_n151_));
  nand4  g089(.a(new_n85_), .b(new_n147_), .c(new_n126_), .d(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n87_), .O(new_n154_));
  nand2  g092(.a(new_n122_), .b(x39), .O(new_n155_));
  nand2  g093(.a(new_n78_), .b(new_n137_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n155_), .c(new_n72_), .O(new_n157_));
  ...
  nor2   g103(.a(new_n85_), .b(x28), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n72_), .c(z08), .d(x29), .O(new_n167_));
  nor2   g105(.a(new_n72_), .b(x04), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n127_), .O(new_n169_));
  oai21  g107(.a(new_n167_), .b(new_n121_), .c(new_n169_), .O(z18));
  oai21  g108(.a(new_n85_), .b(new_n72_), .c(new_n121_), .O(new_n171_));
  oai21  g109(.a(new_n74_), .b(x27), .c(x35), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n118_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n127_), .O(z20));
  aoi21  g112(.a(new_n124_), .b(new_n120_), .c(new_n127_), .O(z19));
endmodule
