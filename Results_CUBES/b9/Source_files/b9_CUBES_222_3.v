...
module FAU ( 
  ...
  nand4  g058(.a(new_n120_), .b(x35), .c(new_n75_), .d(x27), .O(new_n121_));
  ...
  aoi21  g063(.a(new_n122_), .b(new_n118_), .c(new_n125_), .O(z11));
  ...
  nand2  g069(.a(new_n120_), .b(z08), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(new_n73_), .c(new_n131_), .d(new_n66_), .O(new_n133_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n79_), .c(z08), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(z13));
  inv1   g087(.a(x32), .O(new_n150_));
  nand4  g088(.a(new_n135_), .b(new_n150_), .c(new_n124_), .d(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n147_), .c(x40), .d(x39), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n142_), .O(new_n153_));
  oai21  g091(.a(new_n66_), .b(new_n73_), .c(new_n69_), .O(new_n154_));
  nand3  g092(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n78_), .O(new_n157_));
  oai22  g095(.a(new_n129_), .b(new_n66_), .c(x13), .d(x04), .O(new_n158_));
  ...
  nor2   g104(.a(new_n86_), .b(x28), .O(new_n167_));
  aoi22  g105(.a(new_n167_), .b(new_n73_), .c(z08), .d(x29), .O(new_n168_));
  nor2   g106(.a(new_n73_), .b(x04), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n125_), .O(new_n170_));
  oai21  g108(.a(new_n168_), .b(new_n119_), .c(new_n170_), .O(z18));
  oai21  g109(.a(new_n86_), .b(new_n73_), .c(new_n119_), .O(new_n172_));
  oai21  g110(.a(new_n75_), .b(x27), .c(x35), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n116_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n125_), .O(z20));
  aoi21  g113(.a(new_n122_), .b(new_n118_), .c(new_n125_), .O(z19));
endmodule
