...
module FAU ( 
  ...
  aoi21  g068(.a(new_n63_), .b(new_n87_), .c(new_n130_), .O(new_n131_));
  nand2  g069(.a(z08), .b(new_n64_), .O(new_n132_));
  nand2  g070(.a(new_n122_), .b(z08), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(new_n72_), .c(new_n132_), .d(new_n66_), .O(new_n134_));
  oai21  g072(.a(new_n131_), .b(x10), .c(new_n134_), .O(z12));
  nand2  g073(.a(x36), .b(x35), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x28), .O(new_n137_));
  nor2   g075(.a(new_n129_), .b(x13), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n137_), .c(x39), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(new_n85_), .b(new_n87_), .O(new_n140_));
  ...
  nand4  g089(.a(new_n136_), .b(new_n151_), .c(new_n126_), .d(x28), .O(new_n152_));
  ...
  nand3  g094(.a(new_n87_), .b(new_n156_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n77_), .O(new_n159_));
  oai22  g097(.a(new_n130_), .b(new_n66_), .c(x13), .d(x04), .O(new_n160_));
  ...
  nor2   g106(.a(new_n156_), .b(x28), .O(new_n169_));
  aoi22  g107(.a(new_n169_), .b(new_n72_), .c(z08), .d(x29), .O(new_n170_));
  nor2   g108(.a(new_n72_), .b(x04), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n127_), .O(new_n172_));
  oai21  g110(.a(new_n170_), .b(new_n82_), .c(new_n172_), .O(z18));
  oai21  g111(.a(new_n156_), .b(new_n72_), .c(new_n82_), .O(new_n174_));
