...
module FAU ( 
  ...
  nand2  g061(.a(new_n123_), .b(new_n80_), .O(new_n124_));
  ...
  nor2   g066(.a(new_n84_), .b(x27), .O(new_n129_));
  aoi21  g067(.a(new_n63_), .b(new_n90_), .c(new_n129_), .O(new_n130_));
  nand2  g068(.a(z08), .b(new_n64_), .O(new_n131_));
  nand2  g069(.a(new_n122_), .b(z08), .O(new_n132_));
  ...
  nor2   g074(.a(new_n84_), .b(x13), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(new_n136_), .c(x39), .d(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n88_), .b(new_n90_), .O(new_n139_));
  ...
  nand4  g088(.a(new_n135_), .b(new_n150_), .c(new_n126_), .d(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(new_n147_), .c(x40), .d(x39), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n142_), .O(new_n153_));
  oai21  g091(.a(new_n66_), .b(new_n72_), .c(new_n83_), .O(new_n154_));
  inv1   g092(.a(x35), .O(new_n155_));
  nand3  g093(.a(new_n90_), .b(new_n155_), .c(x28), .O(new_n156_));
  ...
  oai21  g105(.a(new_n75_), .b(x27), .c(new_n119_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x08), .O(new_n169_));
  inv1   g107(.a(new_n75_), .O(new_n170_));
  nor2   g108(.a(new_n72_), .b(x04), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(new_n127_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n169_), .O(z18));
  oai21  g111(.a(new_n155_), .b(new_n72_), .c(new_n80_), .O(new_n174_));
  oai21  g112(.a(new_n74_), .b(x27), .c(x35), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n119_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(new_n127_), .O(z20));
  aoi21  g115(.a(new_n124_), .b(new_n121_), .c(new_n127_), .O(z19));
endmodule
