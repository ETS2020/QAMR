...
module FAU ( 
  ...
  oai22  g019(.a(new_n81_), .b(x02), .c(x27), .d(new_n64_), .O(new_n82_));
  nand2  g020(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g021(.a(x40), .b(x39), .O(new_n84_));
  nor2   g022(.a(new_n81_), .b(new_n64_), .O(new_n85_));
  aoi21  g023(.a(new_n85_), .b(new_n75_), .c(new_n84_), .O(new_n86_));
  ...
  nand2  g050(.a(new_n84_), .b(x07), .O(new_n113_));
  oai21  g051(.a(new_n84_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nor3   g052(.a(new_n77_), .b(new_n84_), .c(new_n112_), .O(new_n115_));
  ...
  oai21  g057(.a(new_n119_), .b(new_n75_), .c(new_n84_), .O(new_n120_));
  ...
  aoi22  g063(.a(new_n63_), .b(new_n90_), .c(x40), .d(new_n72_), .O(new_n126_));
  oai22  g064(.a(new_n84_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(x10), .c(new_n127_), .O(z12));
  nand2  g066(.a(x36), .b(x35), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x28), .O(new_n130_));
  nor2   g068(.a(new_n81_), .b(x13), .O(new_n131_));
  ...
  nand3  g089(.a(new_n90_), .b(new_n88_), .c(x28), .O(new_n152_));
  ...
  oai21  g101(.a(new_n75_), .b(x27), .c(new_n84_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x08), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g104(.a(new_n88_), .b(new_n72_), .c(new_n80_), .O(new_n167_));
  ...
  aoi21  g108(.a(new_n122_), .b(new_n120_), .c(new_n124_), .O(z19));
endmodule
