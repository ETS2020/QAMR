// Benchmark "FAU" written by ABC on Mon Jul  6 15:01:18 2020
...
module FAU ( 
  ...
  nor2   g23(.a(x35), .b(x04), .O(new_n86_));
  oai21  g24(.a(new_n86_), .b(x28), .c(x35), .O(new_n87_));
  ...
  inv1   g45(.a(new_n82_), .O(z08));
  nand4  g46(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n109_));
  inv1   g47(.a(new_n109_), .O(z09));
  inv1   g48(.a(x05), .O(new_n111_));
  nand2  g49(.a(new_n82_), .b(x07), .O(new_n112_));
  oai21  g50(.a(new_n82_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand3  g51(.a(x40), .b(x39), .c(x05), .O(new_n114_));
  nor2   g52(.a(new_n114_), .b(new_n77_), .O(new_n115_));
  aoi21  g53(.a(new_n113_), .b(new_n76_), .c(new_n115_), .O(new_n116_));
  nand3  g54(.a(x37), .b(x27), .c(x06), .O(new_n117_));
  oai21  g55(.a(new_n116_), .b(x04), .c(new_n117_), .O(z10));
  nand2  g56(.a(z08), .b(x29), .O(new_n119_));
  nor2   g57(.a(new_n72_), .b(new_n64_), .O(new_n120_));
  oai21  g58(.a(new_n120_), .b(new_n75_), .c(new_n119_), .O(new_n121_));
  inv1   g59(.a(x08), .O(new_n122_));
  inv1   g60(.a(x35), .O(new_n123_));
  nor2   g61(.a(new_n123_), .b(x28), .O(new_n124_));
  nand3  g62(.a(new_n124_), .b(x27), .c(new_n64_), .O(new_n125_));
  nand2  g63(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  inv1   g64(.a(x09), .O(new_n127_));
  inv1   g65(.a(x30), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  aoi21  g67(.a(new_n126_), .b(new_n121_), .c(new_n129_), .O(z11));
  aoi21  g68(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n131_));
  oai22  g69(.a(new_n82_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n132_));
  oai21  g70(.a(new_n131_), .b(x10), .c(new_n132_), .O(z12));
  nand2  g71(.a(x36), .b(x35), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(x28), .O(new_n135_));
  nand2  g73(.a(new_n135_), .b(x27), .O(new_n136_));
  inv1   g74(.a(x13), .O(new_n137_));
  nand4  g75(.a(x40), .b(x39), .c(new_n137_), .d(new_n64_), .O(new_n138_));
  aoi21  g76(.a(new_n136_), .b(new_n77_), .c(new_n138_), .O(z13));
  oai21  g77(.a(new_n77_), .b(x04), .c(new_n72_), .O(new_n140_));
  nor2   g78(.a(new_n82_), .b(x13), .O(new_n141_));
  oai21  g79(.a(x28), .b(x27), .c(x04), .O(new_n142_));
  inv1   g80(.a(x32), .O(new_n143_));
  nand4  g81(.a(new_n134_), .b(new_n143_), .c(new_n128_), .d(x28), .O(new_n144_));
  nand4  g82(.a(new_n144_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(z14));
  ...
  nand2  g90(.a(new_n124_), .b(new_n72_), .O(new_n153_));
  nand2  g91(.a(new_n153_), .b(new_n119_), .O(new_n154_));
  nand2  g92(.a(new_n154_), .b(x08), .O(new_n155_));
  nand4  g93(.a(new_n155_), .b(new_n125_), .c(new_n128_), .d(new_n127_), .O(z18));
  oai21  g94(.a(new_n123_), .b(new_n72_), .c(new_n122_), .O(new_n157_));
  oai21  g95(.a(new_n74_), .b(x27), .c(x35), .O(new_n158_));
  nand2  g96(.a(new_n158_), .b(new_n119_), .O(new_n159_));
  aoi21  g97(.a(new_n159_), .b(new_n157_), .c(new_n129_), .O(z20));
  aoi21  g98(.a(new_n126_), .b(new_n121_), .c(new_n129_), .O(z19));
endmodule
