...
module FAU ( 
  ...
  inv1   g071(.a(x32), .O(new_n134_));
  nand3  g072(.a(x36), .b(x35), .c(new_n134_), .O(new_n135_));
  nand2  g073(.a(x40), .b(new_n74_), .O(new_n136_));
  ...
  nand4  g085(.a(new_n147_), .b(new_n134_), .c(new_n124_), .d(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(new_n144_), .c(x40), .d(x39), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  ...
  oai22  g092(.a(new_n128_), .b(new_n66_), .c(x13), .d(x04), .O(new_n155_));
