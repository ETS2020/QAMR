...
module FAU ( 
  ...
  nand2  g048(.a(new_n75_), .b(new_n73_), .O(new_n111_));
  nand4  g049(.a(new_n111_), .b(new_n107_), .c(x07), .d(new_n64_), .O(new_n112_));
  nand2  g050(.a(x37), .b(x06), .O(new_n113_));
  aoi21  g051(.a(new_n113_), .b(new_n112_), .c(new_n72_), .O(z10));
  ...
  aoi22  g061(.a(new_n63_), .b(new_n88_), .c(x40), .d(new_n72_), .O(new_n124_));
  oai22  g062(.a(new_n107_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(x10), .c(new_n125_), .O(z12));
  aoi21  g064(.a(x36), .b(x35), .c(new_n74_), .O(new_n127_));
  inv1   g065(.a(x13), .O(new_n128_));
  nand4  g066(.a(x40), .b(x39), .c(new_n128_), .d(new_n64_), .O(new_n129_));
  nor2   g067(.a(x19), .b(x18), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x20), .O(new_n131_));
  oai22  g069(.a(new_n131_), .b(new_n66_), .c(new_n129_), .d(new_n127_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x27), .O(new_n133_));
  inv1   g071(.a(new_n129_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n79_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(z13));
  nand2  g074(.a(x36), .b(x35), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n138_));
  inv1   g076(.a(new_n138_), .O(new_n139_));
  nand3  g077(.a(z08), .b(new_n128_), .c(new_n64_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(new_n131_), .O(new_n141_));
  nand4  g079(.a(x40), .b(x39), .c(new_n128_), .d(new_n64_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n72_), .O(new_n143_));
  nand3  g081(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x27), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n78_), .c(new_n77_), .O(new_n146_));
  nand2  g084(.a(new_n140_), .b(new_n66_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n146_), .c(new_n143_), .d(new_n141_), .O(z14));
  ...
  nand2  g093(.a(new_n118_), .b(new_n72_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n115_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x08), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n119_), .c(new_n77_), .d(new_n121_), .O(z18));
  oai21  g097(.a(new_n86_), .b(new_n72_), .c(new_n83_), .O(new_n160_));
  oai21  g098(.a(new_n74_), .b(x27), .c(x35), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n115_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n160_), .c(new_n122_), .O(z20));
  aoi21  g101(.a(new_n120_), .b(new_n117_), .c(new_n122_), .O(z19));
endmodule
