// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:30 2020
...
module FAU ( 
  ...
  nand2  g056(.a(new_n117_), .b(new_n118_), .O(new_n119_));
  oai21  g057(.a(z08), .b(new_n117_), .c(new_n119_), .O(new_n120_));
  nor2   g058(.a(new_n86_), .b(x28), .O(new_n121_));
  ...
  nand3  g062(.a(x35), .b(new_n74_), .c(new_n64_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x29), .O(new_n126_));
  nand2  g064(.a(new_n72_), .b(new_n118_), .O(new_n127_));
  ...
  aoi21  g068(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n131_));
  inv1   g069(.a(new_n66_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x27), .O(new_n133_));
  oai21  g071(.a(new_n82_), .b(x04), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n152_), .c(new_n151_), .d(x28), .O(new_n153_));
  ...
  nand3  g094(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n77_), .O(new_n159_));
  nand2  g097(.a(new_n155_), .b(new_n133_), .O(new_n160_));
  ...
  oai22  g106(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n117_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x08), .O(new_n170_));
  nand3  g108(.a(new_n121_), .b(x27), .c(new_n64_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n170_), .c(new_n151_), .d(new_n118_), .O(z18));
  oai21  g110(.a(x35), .b(new_n117_), .c(new_n127_), .O(new_n173_));
  ...
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(x30), .O(z20));
  aoi21  g115(.a(new_n129_), .b(new_n123_), .c(x30), .O(z19));
endmodule
