...
module FAU ( 
  ...
  nand3  g34(.a(x19), .b(new_n51_), .c(x17), .O(new_n78_));
  ...
  nand4  g39(.a(x04), .b(new_n82_), .c(x02), .d(new_n45_), .O(new_n83_));
  ...
  nand4  g45(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n62_), .O(new_n89_));
  nor2   g46(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nand3  g47(.a(new_n90_), .b(new_n85_), .c(x20), .O(new_n91_));
  inv1   g48(.a(x20), .O(new_n92_));
  nor2   g49(.a(new_n51_), .b(new_n46_), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  inv1   g51(.a(x21), .O(new_n95_));
  inv1   g52(.a(x22), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(new_n97_));
  aoi21  g54(.a(new_n94_), .b(new_n91_), .c(new_n97_), .O(z09));
  nand4  g55(.a(new_n93_), .b(x22), .c(x21), .d(new_n92_), .O(new_n99_));
  nand3  g56(.a(new_n87_), .b(x12), .c(new_n62_), .O(new_n100_));
  nor2   g57(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  inv1   g58(.a(x15), .O(new_n102_));
  nor2   g59(.a(new_n102_), .b(x14), .O(new_n103_));
  nand4  g60(.a(new_n96_), .b(new_n95_), .c(x20), .d(x16), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(new_n103_), .c(new_n101_), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n99_), .c(x00), .O(z10));
  nand3  g64(.a(new_n93_), .b(x21), .c(new_n92_), .O(new_n108_));
  nor2   g65(.a(new_n92_), .b(x16), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n103_), .c(new_n101_), .d(new_n95_), .O(new_n110_));
  nand2  g67(.a(new_n96_), .b(new_n45_), .O(new_n111_));
  aoi21  g68(.a(new_n110_), .b(new_n108_), .c(new_n111_), .O(z11));
  oai21  g69(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n113_));
  nand3  g70(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n114_));
  nand2  g71(.a(x23), .b(x02), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n114_), .c(x01), .O(new_n116_));
  and2   g73(.a(x23), .b(x19), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n116_), .c(new_n45_), .O(new_n118_));
  inv1   g75(.a(x24), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(x09), .O(new_n120_));
  aoi21  g77(.a(new_n118_), .b(new_n113_), .c(new_n120_), .O(z12));
  nor4   g78(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g79(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g80(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n124_));
  oai22  g81(.a(new_n124_), .b(new_n45_), .c(new_n52_), .d(x02), .O(z15));
  nor2   g82(.a(new_n46_), .b(x00), .O(z16));
  nand3  g83(.a(x02), .b(new_n46_), .c(new_n45_), .O(new_n127_));
