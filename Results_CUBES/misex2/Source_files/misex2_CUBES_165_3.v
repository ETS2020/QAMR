// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:08 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n118_, new_n119_, new_n120_, new_n121_, new_n122_, new_n126_,
    new_n127_;
  ...
  nor2   g42(.a(x20), .b(x19), .O(new_n86_));
  nand3  g43(.a(new_n86_), .b(x18), .c(x01), .O(new_n87_));
  nand2  g44(.a(x02), .b(new_n46_), .O(new_n88_));
  inv1   g45(.a(x13), .O(new_n89_));
  nand3  g46(.a(new_n89_), .b(x12), .c(new_n62_), .O(new_n90_));
  ...
  nand3  g51(.a(new_n94_), .b(x20), .c(new_n93_), .O(new_n95_));
  inv1   g52(.a(new_n95_), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n92_), .c(new_n91_), .O(new_n97_));
  inv1   g54(.a(x21), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n45_), .O(new_n99_));
  aoi21  g56(.a(new_n97_), .b(new_n87_), .c(new_n99_), .O(z09));
  nor2   g57(.a(new_n69_), .b(x11), .O(new_n101_));
  nor2   g58(.a(x14), .b(x13), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n101_), .c(x16), .d(x15), .O(new_n103_));
  inv1   g60(.a(new_n83_), .O(z17));
  inv1   g61(.a(x20), .O(new_n105_));
  nor2   g62(.a(x21), .b(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(z17), .c(new_n94_), .O(new_n107_));
  nor2   g64(.a(new_n107_), .b(new_n103_), .O(z10));
  nand4  g65(.a(new_n86_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  inv1   g66(.a(x15), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(x14), .O(new_n111_));
  nand4  g68(.a(new_n94_), .b(new_n98_), .c(x20), .d(new_n93_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n111_), .c(new_n91_), .O(new_n114_));
  aoi21  g71(.a(new_n114_), .b(new_n109_), .c(x00), .O(z11));
  oai21  g72(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  ...
  aoi21  g82(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n126_));
  nand3  g83(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n127_));
