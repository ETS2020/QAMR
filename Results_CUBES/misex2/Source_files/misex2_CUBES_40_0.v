...
module FAU ( 
  ...
  nand4  g10(.a(new_n53_), .b(new_n50_), .c(x10), .d(x09), .O(new_n54_));
  ...
  nor2   g14(.a(new_n57_), .b(new_n46_), .O(z02));
  nor2   g15(.a(x19), .b(new_n49_), .O(new_n59_));
  inv1   g16(.a(new_n59_), .O(new_n60_));
  nand3  g17(.a(new_n45_), .b(new_n48_), .c(new_n44_), .O(new_n61_));
  ...
  inv1   g21(.a(new_n62_), .O(new_n65_));
  nand2  g22(.a(new_n65_), .b(x02), .O(new_n66_));
  inv1   g23(.a(x11), .O(new_n67_));
  inv1   g24(.a(x12), .O(new_n68_));
  nand3  g25(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(new_n69_));
  nor2   g26(.a(new_n69_), .b(new_n66_), .O(z04));
  nor3   g27(.a(new_n66_), .b(new_n56_), .c(new_n47_), .O(z05));
  nor4   g28(.a(new_n62_), .b(new_n67_), .c(x09), .d(new_n44_), .O(z06));
  nand4  g29(.a(new_n68_), .b(x11), .c(new_n47_), .d(x01), .O(new_n73_));
  ...
  nand4  g48(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n86_), .O(new_n92_));
  ...
  nor2   g56(.a(x20), .b(new_n87_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n59_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g58(.a(x13), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x12), .c(new_n67_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  nor2   g61(.a(new_n83_), .b(x14), .O(new_n105_));
  ...
  nand4  g66(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g67(.a(new_n96_), .b(x20), .c(new_n84_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g70(.a(new_n97_), .b(new_n95_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g72(.a(new_n47_), .b(x02), .c(x10), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n65_), .O(new_n117_));
  ...
  nand3  g77(.a(new_n120_), .b(new_n45_), .c(x09), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n117_), .c(x24), .O(z12));
  nor3   g79(.a(new_n46_), .b(x19), .c(new_n48_), .O(z13));
  aoi21  g80(.a(new_n56_), .b(x01), .c(new_n44_), .O(new_n125_));
  nand3  g81(.a(x19), .b(new_n44_), .c(new_n87_), .O(new_n126_));
  oai21  g82(.a(new_n125_), .b(new_n95_), .c(new_n126_), .O(z15));
  nor2   g83(.a(new_n87_), .b(x00), .O(z16));
