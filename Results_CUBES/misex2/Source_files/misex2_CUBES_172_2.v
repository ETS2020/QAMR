...
module FAU ( 
  ...
  nand3  g17(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(new_n61_));
  inv1   g18(.a(x11), .O(new_n62_));
  nor2   g19(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  ...
  oai22  g25(.a(new_n68_), .b(new_n64_), .c(new_n61_), .d(new_n57_), .O(z03));
  ...
  nor3   g30(.a(new_n70_), .b(new_n53_), .c(new_n44_), .O(z05));
  ...
  nand4  g52(.a(new_n96_), .b(new_n56_), .c(x22), .d(x21), .O(new_n97_));
  ...
  oai21  g67(.a(new_n53_), .b(new_n58_), .c(new_n67_), .O(new_n112_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g69(.a(new_n48_), .b(x17), .c(new_n58_), .O(new_n114_));
  ...
  nor2   g75(.a(x19), .b(new_n59_), .O(new_n120_));
  and2   g76(.a(new_n120_), .b(new_n45_), .O(z13));
  nor2   g77(.a(new_n54_), .b(new_n46_), .O(z14));
  aoi21  g78(.a(new_n53_), .b(x01), .c(new_n58_), .O(new_n123_));
  nand3  g79(.a(x19), .b(new_n58_), .c(new_n66_), .O(new_n124_));
