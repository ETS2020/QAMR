...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n124_, new_n125_, new_n129_, new_n130_, new_n133_;
  ...
  nand3  g42(.a(new_n46_), .b(x04), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(new_n66_), .O(new_n101_));
  aoi21  g58(.a(new_n98_), .b(new_n96_), .c(new_n101_), .O(z09));
  nor2   g59(.a(x20), .b(new_n67_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n60_), .c(x22), .d(x21), .O(new_n104_));
  inv1   g61(.a(x13), .O(new_n105_));
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n63_), .O(new_n106_));
  ...
  nand2  g73(.a(new_n100_), .b(new_n66_), .O(new_n117_));
