// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:42 2020
...
module FAU ( 
  ...
  nor2   g43(.a(new_n48_), .b(new_n63_), .O(new_n88_));
  ...
  nand4  g49(.a(new_n88_), .b(x22), .c(x21), .d(new_n87_), .O(new_n94_));
  ...
  nand3  g58(.a(new_n88_), .b(x21), .c(new_n87_), .O(new_n103_));
