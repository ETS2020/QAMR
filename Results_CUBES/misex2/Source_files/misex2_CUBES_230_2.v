...
module FAU ( 
  ...
  nand4  g57(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n101_));
  nand4  g58(.a(new_n98_), .b(x20), .c(x16), .d(x15), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(new_n94_), .c(new_n90_), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g62(.a(new_n98_), .b(x20), .c(new_n87_), .d(x15), .O(new_n106_));
  nor3   g63(.a(new_n106_), .b(new_n93_), .c(new_n83_), .O(z11));
