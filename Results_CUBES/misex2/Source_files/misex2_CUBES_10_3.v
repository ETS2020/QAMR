...
module FAU ( 
  ...
  nand2  g14(.a(new_n44_), .b(x09), .O(new_n58_));
  nor3   g15(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z02));
  nand3  g16(.a(new_n47_), .b(x18), .c(new_n45_), .O(new_n60_));
  nor2   g17(.a(new_n60_), .b(new_n57_), .O(z03));
  nand3  g18(.a(x02), .b(new_n50_), .c(x00), .O(new_n65_));
  ...
  nand2  g24(.a(new_n56_), .b(x02), .O(new_n71_));
  ...
  nand2  g31(.a(x02), .b(new_n50_), .O(new_n78_));
  ...
  nor2   g39(.a(new_n46_), .b(new_n50_), .O(new_n86_));
  ...
  nand3  g61(.a(new_n47_), .b(x17), .c(new_n55_), .O(new_n108_));
  ...
  nor3   g68(.a(new_n57_), .b(x19), .c(new_n45_), .O(z13));
  nand2  g69(.a(new_n44_), .b(new_n53_), .O(new_n116_));
  nor3   g70(.a(new_n116_), .b(new_n57_), .c(new_n48_), .O(z14));
  nand3  g71(.a(x19), .b(new_n55_), .c(new_n50_), .O(new_n118_));
  oai21  g72(.a(new_n79_), .b(new_n49_), .c(new_n118_), .O(z15));
  nor2   g73(.a(new_n50_), .b(x00), .O(z16));
