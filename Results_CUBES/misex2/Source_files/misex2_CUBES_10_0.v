...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
  ...
  nand4  g09(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(x09), .O(new_n53_));
  nor2   g10(.a(new_n53_), .b(new_n46_), .O(z01));
  nor2   g11(.a(x19), .b(new_n49_), .O(new_n56_));
  inv1   g12(.a(new_n56_), .O(new_n57_));
  nand3  g13(.a(new_n45_), .b(new_n48_), .c(new_n44_), .O(new_n58_));
  ...
  oai22  g22(.a(new_n66_), .b(new_n62_), .c(new_n58_), .d(new_n57_), .O(z03));
  nand2  g23(.a(new_n65_), .b(x02), .O(new_n68_));
  inv1   g24(.a(x12), .O(new_n69_));
  nand4  g25(.a(new_n69_), .b(new_n60_), .c(x10), .d(new_n47_), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n68_), .O(z04));
  nor3   g27(.a(new_n68_), .b(new_n59_), .c(new_n47_), .O(z05));
  nand3  g28(.a(new_n61_), .b(new_n47_), .c(x02), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g30(.a(new_n61_), .b(new_n69_), .c(new_n47_), .d(x01), .O(new_n75_));
  ...
  nand3  g58(.a(new_n102_), .b(x12), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g71(.a(new_n59_), .b(new_n44_), .c(new_n65_), .O(new_n116_));
  ...
  nor3   g79(.a(new_n46_), .b(x19), .c(new_n48_), .O(z13));
  aoi21  g80(.a(new_n59_), .b(x01), .c(new_n44_), .O(new_n126_));
