// Benchmark "FAU" written by ABC on Mon Jul  6 13:30:55 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n122_, new_n124_, new_n127_, new_n128_;
  ...
  nand3  g52(.a(new_n95_), .b(new_n94_), .c(new_n65_), .O(new_n96_));
  aoi21  g53(.a(new_n93_), .b(new_n91_), .c(new_n96_), .O(z09));
  nor2   g54(.a(x20), .b(new_n66_), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n57_), .c(x22), .d(x21), .O(new_n99_));
  nor2   g56(.a(new_n59_), .b(x01), .O(new_n100_));
  nand4  g57(.a(new_n95_), .b(new_n94_), .c(x16), .d(x15), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  inv1   g60(.a(x14), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n103_), .c(x12), .d(new_n62_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n102_), .c(new_n100_), .O(new_n107_));
  aoi21  g64(.a(new_n107_), .b(new_n99_), .c(x00), .O(z10));
  nand4  g65(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  inv1   g66(.a(x16), .O(new_n110_));
  nand3  g67(.a(new_n94_), .b(new_n110_), .c(x15), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n89_), .c(new_n88_), .O(new_n113_));
  nand2  g70(.a(new_n95_), .b(new_n65_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n109_), .c(new_n114_), .O(z11));
  oai21  g72(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n60_), .O(new_n120_));
