...
module FAU ( 
  ...
  nand3  g27(.a(new_n73_), .b(new_n72_), .c(x17), .O(new_n74_));
  ...
  nor2   g42(.a(x19), .b(new_n57_), .O(new_n89_));
  ...
  nand4  g48(.a(new_n89_), .b(x22), .c(x21), .d(new_n88_), .O(new_n95_));
  ...
  nand3  g57(.a(new_n89_), .b(x21), .c(new_n88_), .O(new_n104_));
