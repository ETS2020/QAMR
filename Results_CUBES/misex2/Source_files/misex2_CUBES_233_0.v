...
module FAU ( 
  ...
  nor2   g27(.a(new_n70_), .b(new_n65_), .O(z04));
  nor4   g28(.a(new_n65_), .b(new_n54_), .c(new_n44_), .d(new_n59_), .O(z05));
  nand3  g29(.a(new_n63_), .b(new_n44_), .c(x02), .O(new_n73_));
  nor2   g30(.a(new_n73_), .b(new_n65_), .O(z06));
  ...
  nand2  g38(.a(new_n60_), .b(x02), .O(new_n82_));
  ...
  nand4  g43(.a(new_n86_), .b(x12), .c(new_n62_), .d(new_n85_), .O(new_n87_));
  ...
  nand4  g57(.a(new_n100_), .b(new_n57_), .c(new_n90_), .d(x01), .O(new_n101_));
  ...
  nand4  g62(.a(x15), .b(new_n105_), .c(new_n86_), .d(x12), .O(new_n106_));
  ...
  nand3  g72(.a(new_n115_), .b(new_n112_), .c(new_n88_), .O(new_n116_));
  nand2  g73(.a(new_n97_), .b(new_n95_), .O(new_n117_));
  ...
  nand3  g87(.a(x19), .b(new_n59_), .c(new_n85_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n95_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n85_), .b(x00), .O(z16));
  inv1   g90(.a(new_n82_), .O(z17));
endmodule
