// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:26 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n118_, new_n119_, new_n121_, new_n124_, new_n125_;
  ...
  nor3   g74(.a(x24), .b(new_n44_), .c(new_n65_), .O(new_n118_));
  oai21  g75(.a(new_n54_), .b(new_n59_), .c(new_n118_), .O(new_n119_));
  inv1   g76(.a(new_n119_), .O(z12));
  nor2   g77(.a(x19), .b(new_n47_), .O(new_n121_));
  and2   g78(.a(new_n121_), .b(new_n45_), .O(z13));
  nor2   g79(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g80(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n65_), .c(new_n125_), .O(z15));
