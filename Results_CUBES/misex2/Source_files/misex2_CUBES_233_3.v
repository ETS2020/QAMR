...
module FAU ( 
  ...
  nand4  g32(.a(new_n76_), .b(x12), .c(x02), .d(new_n66_), .O(new_n77_));
  inv1   g33(.a(new_n77_), .O(new_n78_));
  nor2   g34(.a(x15), .b(x14), .O(new_n79_));
  inv1   g35(.a(x20), .O(new_n80_));
  nor2   g36(.a(new_n80_), .b(x16), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(new_n82_));
  nor2   g38(.a(new_n51_), .b(new_n66_), .O(new_n83_));
  ...
  aoi21  g45(.a(new_n85_), .b(new_n82_), .c(new_n89_), .O(z09));
  nand4  g46(.a(new_n84_), .b(new_n83_), .c(x22), .d(x21), .O(new_n91_));
  nor2   g47(.a(new_n45_), .b(x01), .O(new_n92_));
  nand4  g48(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  inv1   g50(.a(x14), .O(new_n95_));
  nand4  g51(.a(x15), .b(new_n95_), .c(new_n76_), .d(x12), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n94_), .c(new_n92_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n91_), .c(x00), .O(z10));
  nand3  g55(.a(new_n84_), .b(new_n83_), .c(x21), .O(new_n100_));
  inv1   g56(.a(x15), .O(new_n101_));
  nor2   g57(.a(new_n101_), .b(x14), .O(new_n102_));
  inv1   g58(.a(x16), .O(new_n103_));
  nand3  g59(.a(new_n87_), .b(x20), .c(new_n103_), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n102_), .c(new_n78_), .O(new_n106_));
  nand2  g62(.a(new_n88_), .b(new_n86_), .O(new_n107_));
  aoi21  g63(.a(new_n106_), .b(new_n100_), .c(new_n107_), .O(z11));
  nand2  g64(.a(x10), .b(x02), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x01), .c(x00), .O(new_n110_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g67(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n112_));
  ...
  nor3   g73(.a(new_n47_), .b(x19), .c(new_n50_), .O(z13));
  nor2   g74(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g75(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n120_));
  nand3  g76(.a(x19), .b(new_n45_), .c(new_n66_), .O(new_n121_));
  oai21  g77(.a(new_n120_), .b(new_n86_), .c(new_n121_), .O(z15));
