...
module FAU ( 
  ...
  nand2  g46(.a(x02), .b(new_n67_), .O(new_n90_));
  inv1   g47(.a(x13), .O(new_n91_));
  inv1   g48(.a(x14), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n63_), .O(new_n93_));
  nor2   g50(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand4  g51(.a(new_n94_), .b(x20), .c(new_n89_), .d(new_n88_), .O(new_n95_));
  ...
  nand3  g56(.a(new_n99_), .b(new_n98_), .c(new_n66_), .O(new_n100_));
  aoi21  g57(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z09));
  nor2   g58(.a(x20), .b(new_n67_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n60_), .c(x22), .d(x21), .O(new_n103_));
  nand3  g60(.a(new_n91_), .b(x12), .c(new_n63_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  nor2   g62(.a(new_n88_), .b(x14), .O(new_n106_));
  ...
  aoi21  g66(.a(new_n109_), .b(new_n103_), .c(x00), .O(z10));
  nand4  g67(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  nand3  g68(.a(new_n98_), .b(x20), .c(new_n89_), .O(new_n112_));
  ...
  oai21  g73(.a(x24), .b(x10), .c(x02), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n68_), .O(new_n118_));
  nand2  g75(.a(new_n52_), .b(x17), .O(new_n119_));
  nand2  g76(.a(x23), .b(x19), .O(new_n120_));
  aoi21  g77(.a(new_n120_), .b(new_n119_), .c(x02), .O(new_n121_));
  nand2  g78(.a(x23), .b(x02), .O(new_n122_));
  nor2   g79(.a(new_n122_), .b(x24), .O(new_n123_));
  oai21  g80(.a(new_n123_), .b(new_n121_), .c(new_n46_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n118_), .c(new_n44_), .O(z12));
  nor2   g82(.a(new_n119_), .b(new_n47_), .O(z13));
  nor2   g83(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g84(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n128_));
  nand3  g85(.a(x19), .b(new_n45_), .c(new_n67_), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n66_), .c(new_n129_), .O(z15));
