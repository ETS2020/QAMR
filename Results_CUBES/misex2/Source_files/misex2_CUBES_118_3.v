// Benchmark "FAU" written by ABC on Mon Jul  6 13:30:48 2020
...
module FAU ( 
  ...
  nand3  g80(.a(new_n123_), .b(new_n63_), .c(new_n120_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n119_), .c(new_n44_), .O(z12));
  nor4   g82(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g83(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g84(.a(new_n57_), .b(x01), .c(new_n62_), .O(new_n128_));
  nand3  g85(.a(x19), .b(new_n62_), .c(new_n46_), .O(new_n129_));
