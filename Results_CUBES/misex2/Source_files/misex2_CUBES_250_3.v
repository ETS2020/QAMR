...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n62_, new_n63_, new_n64_, new_n67_, new_n69_, new_n70_, new_n72_,
  ...
  nor2   g21(.a(new_n64_), .b(x11), .O(z04));
  nor3   g22(.a(new_n62_), .b(new_n57_), .c(new_n44_), .O(z05));
  inv1   g23(.a(x11), .O(new_n67_));
  nor2   g24(.a(new_n64_), .b(new_n67_), .O(z06));
  nand4  g25(.a(x11), .b(x10), .c(new_n44_), .d(x01), .O(new_n69_));
  ...
  nand3  g33(.a(x19), .b(new_n51_), .c(x17), .O(new_n77_));
  nor3   g34(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(z08));
  inv1   g35(.a(x13), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(x12), .c(new_n67_), .d(x02), .O(new_n80_));
  inv1   g37(.a(new_n80_), .O(new_n81_));
  nor2   g38(.a(x15), .b(x14), .O(new_n82_));
  inv1   g39(.a(x20), .O(new_n83_));
  nor2   g40(.a(new_n83_), .b(x16), .O(new_n84_));
  nand3  g41(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(new_n85_));
  inv1   g42(.a(x01), .O(new_n86_));
  nor2   g43(.a(new_n51_), .b(new_n86_), .O(new_n87_));
  ...
  aoi21  g50(.a(new_n89_), .b(new_n85_), .c(new_n93_), .O(z09));
  nand4  g51(.a(new_n88_), .b(new_n87_), .c(x22), .d(x21), .O(new_n95_));
  nor2   g52(.a(x11), .b(new_n45_), .O(new_n96_));
  nand4  g53(.a(new_n92_), .b(new_n91_), .c(x20), .d(x16), .O(new_n97_));
  inv1   g54(.a(new_n97_), .O(new_n98_));
  inv1   g55(.a(x14), .O(new_n99_));
  nand4  g56(.a(x15), .b(new_n99_), .c(new_n79_), .d(x12), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n98_), .c(new_n96_), .O(new_n102_));
  aoi21  g59(.a(new_n102_), .b(new_n95_), .c(x00), .O(z10));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(x21), .O(new_n104_));
  inv1   g61(.a(x15), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(x14), .O(new_n106_));
  inv1   g63(.a(x16), .O(new_n107_));
  nand3  g64(.a(new_n91_), .b(x20), .c(new_n107_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(new_n106_), .c(new_n81_), .O(new_n110_));
  nand2  g67(.a(new_n92_), .b(new_n90_), .O(new_n111_));
  aoi21  g68(.a(new_n110_), .b(new_n104_), .c(new_n111_), .O(z11));
  nand2  g69(.a(x10), .b(x02), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(x01), .c(x00), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g72(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n116_));
  ...
  nor3   g78(.a(new_n47_), .b(x19), .c(new_n50_), .O(z13));
  nor2   g79(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g80(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n124_));
  nand3  g81(.a(x19), .b(new_n45_), .c(new_n86_), .O(new_n125_));
  oai21  g82(.a(new_n124_), .b(new_n90_), .c(new_n125_), .O(z15));
  nor2   g83(.a(new_n86_), .b(x00), .O(z16));
  inv1   g84(.a(new_n76_), .O(z17));
endmodule
