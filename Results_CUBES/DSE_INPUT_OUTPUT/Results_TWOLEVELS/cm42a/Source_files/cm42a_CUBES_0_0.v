...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n23_, new_n24_,
    new_n25_, new_n26_, new_n27_, new_n29_, new_n31_, new_n32_;
  ...
  assign z4 = new_n24_ | ~new_n27_;
  assign new_n29_ = x0 & x2;
  assign z5 = new_n17_ | ~new_n29_;
  assign new_n31_ = ~x0 & ~x1;
  assign new_n32_ = new_n26_ & ~new_n31_;
  assign z6 = new_n24_ | ~new_n32_;
  assign z7 = new_n20_ | ~new_n29_;
  assign z9 = x2 | new_n24_;
  assign z0 = 1'b1;
  assign z2 = 1'b1;
  assign z8 = 1'b1;
endmodule
