// Benchmark "FAU" written by ABC on Thu Aug 20 10:56:09 2020
...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    new_n34_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n43_,
    new_n45_;
  ...
  assign z8 = new_n31_ | new_n43_;
  assign new_n45_ = ~x1 & ~new_n38_;
  assign z9 = new_n31_ | new_n45_;
  assign z7 = 1'b1;
endmodule
