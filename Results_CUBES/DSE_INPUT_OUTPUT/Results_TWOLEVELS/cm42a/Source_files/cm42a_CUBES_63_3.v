...
module FAU ( 
  ...
  assign new_n49_ = ~x0 & ~new_n44_;
  assign new_n50_ = ~new_n29_ & ~new_n34_;
  assign z8 = ~new_n49_ | ~new_n50_;
  assign new_n52_ = x0 & ~x1;
  assign new_n53_ = ~x2 & ~new_n52_;
  assign new_n54_ = ~new_n15_ & ~new_n53_;
  assign z9 = x2 | ~new_n54_;
endmodule
