...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n23_, new_n24_,
    ...
    new_n35_, new_n37_, new_n38_, new_n40_, new_n41_;
  ...
  assign z7 = new_n19_ | ~new_n38_;
  assign new_n40_ = ~x1 & ~new_n16_;
  assign new_n41_ = x0 & ~new_n40_;
  assign z9 = new_n19_ | new_n41_;
  assign z0 = 1'b1;
  assign z8 = z2;
endmodule
