...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n29_, new_n31_, new_n32_;
  assign new_n16_ = ~x2 & ~x3;
  assign new_n17_ = x0 & ~x1;
  assign z1 = ~new_n16_ | ~new_n17_;
  ...
  assign new_n27_ = x0 & ~new_n20_;
  assign z5 = x3 | new_n27_;
  assign new_n29_ = x0 & ~new_n19_;
  assign z7 = x3 | new_n29_;
  assign new_n31_ = ~x2 & x3;
  assign new_n32_ = ~x1 & ~new_n17_;
  assign z8 = ~new_n31_ | ~new_n32_;
  assign z9 = ~new_n17_ | ~new_n31_;
  assign z0 = 1'b1;
  assign z4 = z2;
  assign z6 = z2;
endmodule
