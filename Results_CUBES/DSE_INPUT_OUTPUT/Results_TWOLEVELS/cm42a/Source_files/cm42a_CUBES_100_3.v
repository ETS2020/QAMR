...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_, new_n23_,
    ...
    new_n33_, new_n34_, new_n37_, new_n39_, new_n40_, new_n42_;
  ...
  assign z4 = ~new_n16_ | ~new_n34_;
  assign new_n37_ = x0 & ~new_n21_;
  assign z5 = ~new_n16_ | ~new_n37_;
  assign new_n39_ = ~x0 & ~x1;
  assign new_n40_ = ~x2 & ~new_n39_;
  assign z8 = new_n27_ | new_n40_;
  assign new_n42_ = x0 & ~x1;
  assign z9 = ~new_n34_ | ~new_n42_;
  assign z6 = 1'b1;
  assign z7 = 1'b1;
endmodule
