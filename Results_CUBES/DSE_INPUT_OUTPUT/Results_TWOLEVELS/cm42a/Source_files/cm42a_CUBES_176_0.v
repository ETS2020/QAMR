...
module FAU ( 
  ...
  wire new_n15_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_, new_n24_,
    new_n25_, new_n28_, new_n29_, new_n30_, new_n33_, new_n34_, new_n35_;
  assign new_n15_ = ~x2 & ~x3;
  assign z2 = x0 | x3;
  assign new_n17_ = x0 & ~x2;
  assign new_n18_ = z2 & ~new_n17_;
  ...
  assign z5 = ~new_n18_ | ~new_n23_;
  assign new_n28_ = x2 & ~new_n23_;
  assign new_n29_ = x0 & ~new_n28_;
  assign new_n30_ = ~x3 & z2;
  assign z7 = new_n29_ | ~new_n30_;
  assign z8 = ~new_n18_ | ~new_n20_;
