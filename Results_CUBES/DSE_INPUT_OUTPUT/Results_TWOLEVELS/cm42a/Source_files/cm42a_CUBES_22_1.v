...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_, new_n24_,
    ...
    new_n36_, new_n38_, new_n39_, new_n41_, new_n42_;
  ...
  assign z5 = new_n20_ | new_n34_;
  assign new_n36_ = ~x3 & ~new_n23_;
  assign z6 = x0 | new_n36_;
  assign new_n38_ = x0 & new_n23_;
  assign new_n39_ = ~x3 & ~new_n38_;
  assign z7 = new_n20_ | new_n39_;
  assign new_n41_ = ~x1 & ~x3;
  assign new_n42_ = ~new_n17_ & ~new_n41_;
  assign z9 = ~new_n16_ | ~new_n42_;
  assign z8 = 1'b1;
endmodule
