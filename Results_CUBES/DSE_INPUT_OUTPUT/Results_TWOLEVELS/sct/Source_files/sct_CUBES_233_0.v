...
module FAU ( 
  ...
  assign z05 = new_n69_ | ~new_n81_;
  assign new_n83_ = x10 & ~new_n78_;
  ...
  assign z07 = new_n93_ | ~new_n102_;
  assign new_n104_ = ~new_n48_ & ~new_n58_;
  ...
  assign z08 = new_n114_ | ~new_n122_;
  assign new_n124_ = ~x13 & ~new_n48_;
  ...
  assign new_n133_ = ~x09 & new_n106_;
  ...
  assign z09 = new_n69_ | ~new_n140_;
  assign new_n142_ = ~x09 & ~new_n48_;
  assign new_n143_ = x08 & new_n142_;
  assign new_n144_ = x07 & new_n143_;
  assign new_n145_ = x06 & new_n144_;
  assign new_n146_ = x00 & new_n145_;
  assign new_n147_ = x14 & new_n48_;
  assign new_n148_ = ~new_n146_ & ~new_n147_;
  assign new_n149_ = ~new_n35_ & ~new_n148_;
  assign new_n150_ = x15 & ~new_n48_;
  ...
  assign z10 = x04 & ~new_n159_;
  assign z11 = x02 & ~new_n35_;
  assign new_n162_ = x16 & ~new_n35_;
  assign new_n163_ = ~x02 & new_n162_;
  assign new_n164_ = ~x03 & ~new_n163_;
  assign new_n165_ = x04 & ~new_n164_;
  assign z12 = new_n35_ | new_n165_;
  assign new_n167_ = new_n58_ & new_n133_;
  assign new_n168_ = ~new_n104_ & ~new_n167_;
  ...
  assign z13 = x04 & ~new_n172_;
  assign new_n174_ = x17 & ~new_n35_;
  assign z14 = x04 & new_n174_;
endmodule
