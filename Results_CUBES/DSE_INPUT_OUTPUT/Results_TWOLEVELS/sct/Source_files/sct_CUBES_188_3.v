...
module FAU ( 
  ...
  assign z06 = ~x04 | new_n70_;
  assign new_n72_ = x04 & ~x11;
  assign new_n73_ = ~new_n62_ & new_n72_;
  assign z07 = new_n61_ | ~new_n73_;
  assign new_n75_ = x04 & ~x12;
  assign new_n76_ = ~new_n62_ & new_n75_;
  assign z08 = new_n61_ | ~new_n76_;
  assign new_n78_ = x04 & ~x13;
  assign new_n79_ = ~new_n62_ & new_n78_;
  assign z09 = new_n61_ | ~new_n79_;
  assign new_n81_ = x14 & new_n54_;
  assign new_n82_ = ~x07 & new_n81_;
  assign z10 = x04 & new_n82_;
  assign new_n84_ = x04 & ~x07;
  assign new_n85_ = x04 & ~new_n84_;
  assign z11 = x02 & ~new_n85_;
  assign new_n87_ = ~x03 & new_n60_;
  assign z12 = x04 & ~new_n87_;
  assign new_n89_ = ~x02 & x16;
