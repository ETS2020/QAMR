// Benchmark "FAU" written by ABC on Thu Aug 20 12:37:35 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n66_, new_n67_, new_n69_, new_n72_, new_n73_, new_n74_, new_n75_,
    new_n76_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_, new_n86_,
    new_n89_, new_n90_, new_n92_, new_n95_, new_n96_, new_n97_;
  assign z06 = ~x09 & x19;
  ...
  assign z02 = x19 & ~new_n67_;
  assign new_n69_ = x09 & x19;
  assign z03 = x20 | new_n69_;
  assign z04 = x21 | z03;
  assign new_n72_ = ~x08 & x19;
  ...
  assign new_n80_ = x24 & ~new_n69_;
  assign z07 = x18 & new_n80_;
  assign z08 = x11 & ~new_n69_;
  assign new_n83_ = x11 & x24;
  assign z09 = new_n69_ | new_n83_;
  assign new_n85_ = ~x24 & ~new_n69_;
  assign new_n86_ = x22 & new_n85_;
  assign z10 = x14 & new_n86_;
  assign z11 = x17 & new_n86_;
  assign new_n89_ = x23 & ~x24;
  assign new_n90_ = x14 & new_n89_;
  assign z12 = new_n69_ | new_n90_;
  assign new_n92_ = x23 & new_n85_;
  assign z13 = x17 & new_n92_;
  assign z14 = x16 & new_n85_;
  assign new_n95_ = ~x14 & ~x15;
  assign new_n96_ = ~x12 & ~new_n69_;
  assign new_n97_ = ~x13 & new_n96_;
  assign z15 = ~new_n95_ | ~new_n97_;
endmodule
