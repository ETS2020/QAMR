...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n73_, new_n76_, new_n79_, new_n82_, new_n84_, new_n85_,
    new_n87_, new_n88_, new_n90_, new_n93_, new_n95_, new_n96_, new_n97_;
  ...
  assign new_n79_ = x24 & ~new_n42_;
  assign z07 = x18 & new_n79_;
  assign z08 = x11 & ~new_n42_;
  assign new_n82_ = x11 & x24;
  assign z09 = new_n42_ | new_n82_;
  assign new_n84_ = x22 & ~x24;
  assign new_n85_ = x14 & new_n84_;
  assign z10 = new_n42_ | new_n85_;
  assign new_n87_ = ~x24 & ~new_n42_;
  assign new_n88_ = x22 & new_n87_;
  assign z11 = x17 & new_n88_;
  assign new_n90_ = x23 & new_n87_;
  assign z12 = x14 & new_n90_;
  assign z13 = x17 & new_n90_;
  assign new_n93_ = x16 & ~x24;
  assign z14 = new_n42_ | new_n93_;
  assign new_n95_ = ~x12 & ~x13;
  assign new_n96_ = ~x14 & ~x15;
  assign new_n97_ = new_n95_ & new_n96_;
  assign z15 = ~new_n42_ & ~new_n97_;
  assign z06 = x19;
endmodule
