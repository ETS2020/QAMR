// Benchmark "FAU" written by ABC on Thu Aug 20 14:08:48 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    new_n54_, new_n55_, new_n56_, new_n57_, new_n60_, new_n61_, new_n63_,
  ...
  assign new_n60_ = x18 & ~new_n55_;
  assign new_n61_ = x18 & ~new_n60_;
  assign z03 = ~x25 & ~new_n61_;
  ...
  assign z04 = new_n46_ | new_n78_;
  assign new_n80_ = ~x08 & ~x13;
  assign z05 = new_n46_ | new_n80_;
  assign new_n82_ = x14 & ~new_n46_;
  assign z06 = ~x08 & new_n82_;
  assign new_n84_ = x06 & ~new_n46_;
  assign z07 = x08 | ~new_n84_;
  ...
  assign new_n93_ = new_n50_ & new_n92_;
  ...
  assign new_n106_ = x18 & new_n55_;
  assign z08 = new_n105_ | new_n106_;
  assign new_n108_ = ~x07 & ~x15;
  assign new_n109_ = new_n49_ & new_n108_;
  assign z09 = new_n46_ | new_n109_;
  assign new_n111_ = ~new_n46_ & ~new_n49_;
  assign new_n112_ = ~x17 & new_n111_;
  assign new_n113_ = ~x15 & new_n112_;
  assign new_n114_ = ~x07 & new_n113_;
  assign z10 = new_n46_ | new_n114_;
  assign new_n116_ = ~x17 & x18;
  assign new_n117_ = ~x18 & x25;
  ...
  assign new_n150_ = x21 & x25;
  assign new_n151_ = ~x18 & new_n150_;
  assign new_n152_ = ~new_n149_ & ~new_n151_;
  assign z14 = new_n135_ | ~new_n152_;
  assign new_n154_ = x22 & ~new_n147_;
  assign new_n155_ = ~x20 & new_n94_;
  ...
  assign z15 = new_n135_ | ~new_n161_;
  assign new_n163_ = x23 & ~new_n156_;
  ...
  assign z17 = new_n135_ | ~new_n183_;
  assign new_n185_ = new_n91_ & new_n108_;
  assign new_n186_ = new_n98_ & new_n185_;
  assign new_n187_ = ~new_n90_ & new_n186_;
  assign new_n188_ = x25 & ~new_n187_;
  assign new_n189_ = x18 & ~new_n99_;
  assign new_n190_ = ~x25 & ~new_n189_;
  assign new_n191_ = x18 & ~new_n108_;
  assign new_n192_ = ~new_n109_ & ~new_n191_;
  assign new_n193_ = ~new_n190_ & new_n192_;
  assign z18 = new_n188_ | ~new_n193_;
endmodule
