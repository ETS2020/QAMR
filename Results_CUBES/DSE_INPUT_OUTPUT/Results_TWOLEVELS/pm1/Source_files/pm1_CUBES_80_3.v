// Benchmark "FAU" written by ABC on Thu Aug 20 13:18:48 2020
...
module FAU ( 
  ...
  assign z02 = ~x12 | new_n35_;
  assign new_n37_ = x11 & x12;
  assign new_n38_ = x09 & ~new_n32_;
  assign z03 = ~new_n37_ | ~new_n38_;
  assign z04 = ~x14 | new_n32_;
  assign z05 = ~x13 & ~new_n32_;
  ...
  assign z10 = x12 & ~new_n79_;
  assign new_n81_ = x12 & ~new_n47_;
