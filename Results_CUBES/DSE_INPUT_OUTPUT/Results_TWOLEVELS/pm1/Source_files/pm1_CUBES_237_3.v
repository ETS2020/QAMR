...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n34_, new_n35_, new_n36_, new_n37_,
    new_n38_, new_n40_, new_n41_, new_n42_, new_n43_, new_n44_, new_n49_,
  ...
  assign z07 = ~x15 & ~z10;
  assign new_n56_ = x00 & ~x10;
  assign new_n57_ = ~x12 & ~new_n56_;
  assign new_n58_ = ~z10 & ~new_n57_;
  assign z08 = new_n43_ | ~new_n58_;
  assign new_n60_ = ~x11 & new_n56_;
  assign z09 = ~x12 & new_n60_;
