// Benchmark "FAU" written by ABC on Thu Aug 20 11:03:29 2020
...
module FAU ( 
  ...
  assign z06 = new_n26_ | new_n78_;
  assign new_n80_ = x05 & new_n44_;
  assign new_n81_ = ~x04 & new_n80_;
  assign new_n82_ = ~x03 & new_n81_;
  assign z07 = ~x02 & new_n82_;
  ...
  assign z08 = new_n26_ | new_n89_;
  assign new_n91_ = x13 & ~new_n26_;
  assign z09 = x06 & new_n91_;
  assign new_n93_ = ~x02 & ~x08;
  assign new_n94_ = x05 & ~new_n93_;
  assign new_n95_ = x06 & ~new_n94_;
  assign z10 = ~x03 & new_n95_;
endmodule
