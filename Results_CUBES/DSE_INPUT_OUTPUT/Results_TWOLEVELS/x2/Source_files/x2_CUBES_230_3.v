// Benchmark "FAU" written by ABC on Thu Aug 20 15:00:11 2020
...
module FAU ( 
  ...
  assign new_n34_ = ~x7 & ~new_n23_;
  assign z1 = new_n33_ | new_n34_;
  assign new_n36_ = x4 & x7;
  assign new_n37_ = ~x7 & new_n23_;
  assign z2 = new_n36_ | new_n37_;
  assign new_n39_ = x9 & ~new_n18_;
  ...
  assign new_n48_ = x6 & ~new_n22_;
  assign new_n49_ = ~x4 & ~new_n48_;
  assign z4 = new_n28_ | new_n49_;
  ...
  assign z5 = new_n57_ | ~new_n65_;
  assign new_n67_ = ~x6 & ~new_n36_;
