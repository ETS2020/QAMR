...
module FAU ( 
  ...
  assign z1 = new_n24_ | ~new_n34_;
  assign new_n36_ = ~new_n18_ & ~new_n26_;
  assign new_n37_ = x1 & ~new_n36_;
  assign new_n38_ = ~x0 & new_n37_;
  assign z2 = new_n33_ | new_n38_;
  assign new_n40_ = x7 & ~new_n25_;
  assign new_n41_ = ~x2 & ~new_n40_;
  assign new_n42_ = x1 & new_n41_;
  assign z3 = ~x0 & new_n42_;
