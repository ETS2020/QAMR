// Benchmark "FAU" written by ABC on Thu Aug 20 12:29:52 2020
...
module FAU ( 
  ...
  assign new_n65_ = new_n37_ & new_n60_;
  assign z3 = new_n64_ | new_n65_;
  assign new_n67_ = ~new_n54_ & ~new_n60_;
  assign new_n68_ = x0 & ~new_n67_;
  assign new_n69_ = ~x5 & ~new_n45_;
  ...
  assign z4 = new_n74_ | new_n87_;
  assign new_n89_ = ~x0 & new_n25_;
  assign new_n90_ = ~new_n68_ & ~new_n89_;
  assign new_n91_ = ~x1 & ~new_n90_;
  assign new_n92_ = ~new_n22_ & ~new_n87_;
  ...
  assign new_n104_ = ~new_n22_ & ~new_n103_;
