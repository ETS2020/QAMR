// Benchmark "FAU" written by ABC on Thu Aug 20 12:29:45 2020
...
module FAU ( 
  ...
  assign z2 = new_n47_ | ~new_n51_;
  assign new_n53_ = x7 & ~new_n32_;
  ...
  assign z3 = new_n60_ | new_n63_;
  assign new_n65_ = x2 & new_n19_;
  assign new_n66_ = ~new_n24_ & ~new_n65_;
  assign new_n67_ = x0 & ~new_n66_;
  assign new_n68_ = ~x2 & new_n40_;
  ...
  assign z4 = new_n72_ | ~new_n82_;
  assign new_n84_ = ~new_n23_ & ~new_n67_;
  assign new_n85_ = ~x1 & ~new_n84_;
  assign z5 = ~new_n82_ | new_n85_;
  assign new_n87_ = ~x1 & ~new_n66_;
  assign new_n88_ = x0 & new_n87_;
  assign new_n89_ = ~x3 & ~new_n73_;
