...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n49_, new_n51_, new_n52_,
    new_n53_, new_n54_, new_n61_, new_n63_, new_n65_, new_n66_, new_n68_,
    new_n70_, new_n71_, new_n73_, new_n76_, new_n78_;
  ...
  assign new_n70_ = x16 & ~new_n42_;
  assign new_n71_ = ~x14 & new_n70_;
  assign z15 = x12 & new_n71_;
  assign new_n73_ = x17 & ~new_n42_;
