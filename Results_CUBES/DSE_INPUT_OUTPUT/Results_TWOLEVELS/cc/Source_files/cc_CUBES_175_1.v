...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n53_, new_n55_, new_n61_, new_n64_, new_n65_, new_n66_,
  ...
  assign z04 = ~x18 & ~new_n55_;
  assign z05 = x19 & ~new_n55_;
  assign z06 = x11 & x15;
  assign z07 = x17 & ~new_n55_;
  assign z08 = x16 & ~new_n55_;
  assign new_n61_ = x08 & x09;
  assign z10 = ~new_n55_ & ~new_n61_;
  assign z11 = x14 | new_n55_;
  ...
  assign z15 = new_n92_ | new_n98_;
  assign new_n100_ = x12 & x17;
  assign new_n101_ = x11 & ~new_n100_;
  assign new_n102_ = x15 & ~new_n101_;
  assign new_n103_ = x17 & ~new_n43_;
  ...
  assign z16 = new_n102_ | new_n107_;
  assign new_n109_ = x18 & ~new_n43_;
  assign new_n110_ = x05 & new_n43_;
