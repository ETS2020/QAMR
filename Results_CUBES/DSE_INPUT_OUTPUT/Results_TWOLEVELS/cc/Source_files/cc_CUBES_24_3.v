...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n53_, new_n54_, new_n55_, new_n56_, new_n58_, new_n64_,
  ...
  assign new_n58_ = x11 & x15;
  assign z04 = ~x18 | new_n58_;
  assign z05 = x19 | new_n58_;
  assign z06 = ~x11 & x15;
  assign z07 = x17 | new_n58_;
  assign z08 = x16 & ~new_n58_;
  assign new_n64_ = x08 & x09;
  assign z09 = new_n58_ | new_n64_;
  assign new_n66_ = x08 & ~new_n58_;
  ...
  assign new_n118_ = x19 & ~new_n53_;
  assign new_n119_ = x06 & new_n53_;
