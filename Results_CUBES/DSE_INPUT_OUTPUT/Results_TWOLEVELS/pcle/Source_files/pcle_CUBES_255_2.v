...
module FAU ( 
  ...
  wire new_n30_, new_n32_, new_n34_, new_n36_, new_n38_, new_n40_, new_n42_;
  assign z0 = x09 & ~x10;
  assign new_n30_ = x08 & ~z0;
  assign z1 = x00 & new_n30_;
  assign new_n32_ = x01 & x08;
  assign z2 = z0 | new_n32_;
  assign new_n34_ = x02 & x08;
  assign z3 = z0 | new_n34_;
  assign new_n36_ = x03 & x08;
  assign z4 = z0 | new_n36_;
  assign new_n38_ = x04 & x08;
  assign z5 = z0 | new_n38_;
  assign new_n40_ = x05 & x08;
  assign z6 = z0 | new_n40_;
  assign new_n42_ = x06 & x08;
  assign z7 = z0 | new_n42_;
  assign z8 = x07 & new_n30_;
endmodule
