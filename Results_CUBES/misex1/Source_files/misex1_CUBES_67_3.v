// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:41 2020
...
module FAU ( 
  ...
  oai21  g14(.a(new_n29_), .b(x3), .c(x1), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(new_n27_), .c(x2), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n26_), .c(new_n21_), .O(new_n32_));
  ...
  nor2   g43(.a(new_n27_), .b(x2), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n21_), .O(new_n60_));
