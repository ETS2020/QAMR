// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:56 2020
...
module FAU ( 
  ...
  nand3  g28(.a(new_n43_), .b(x2), .c(new_n17_), .O(new_n44_));
  ...
  aoi21  g34(.a(new_n47_), .b(new_n49_), .c(new_n21_), .O(new_n50_));
  oai21  g35(.a(new_n36_), .b(x3), .c(new_n27_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n21_), .c(new_n50_), .O(new_n52_));
  aoi21  g37(.a(new_n20_), .b(x2), .c(new_n17_), .O(new_n53_));
  nand3  g38(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n21_), .O(new_n56_));
  oai21  g41(.a(new_n52_), .b(x1), .c(new_n56_), .O(z4));
  nor2   g42(.a(new_n27_), .b(x0), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n50_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z5));
  nand3  g45(.a(new_n43_), .b(x2), .c(new_n21_), .O(new_n61_));
