// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:42 2020
...
module FAU ( 
  ...
  oai21  g23(.a(new_n44_), .b(new_n30_), .c(x04), .O(new_n45_));
  inv1   g24(.a(x07), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n22_), .c(new_n27_), .O(new_n47_));
