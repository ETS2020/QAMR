// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:05 2020
...
module FAU ( 
  ...
  nor2   g25(.a(new_n36_), .b(new_n22_), .O(new_n47_));
  oai21  g26(.a(x07), .b(x04), .c(x05), .O(new_n48_));
  aoi21  g27(.a(new_n47_), .b(x13), .c(new_n48_), .O(new_n49_));
  oai21  g28(.a(new_n46_), .b(x11), .c(new_n49_), .O(z3));
