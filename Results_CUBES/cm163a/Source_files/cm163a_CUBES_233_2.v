// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:45 2020
...
module FAU ( 
  ...
  nor3   g21(.a(x13), .b(x11), .c(x09), .O(new_n43_));
  aoi22  g22(.a(new_n43_), .b(new_n24_), .c(new_n37_), .d(x13), .O(new_n44_));
  nand3  g23(.a(x13), .b(x12), .c(x04), .O(new_n45_));
  inv1   g24(.a(new_n45_), .O(new_n46_));
  oai21  g25(.a(x07), .b(x04), .c(x05), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  oai21  g27(.a(new_n44_), .b(x12), .c(new_n48_), .O(z3));
