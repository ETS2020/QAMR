// Benchmark "FAU" written by ABC on Mon Jul  6 12:59:42 2020
...
module FAU ( 
  ...
  nor2   g11(.a(new_n23_), .b(x11), .O(new_n33_));
  aoi22  g12(.a(new_n33_), .b(new_n32_), .c(new_n30_), .d(x11), .O(new_n34_));
  ...
  oai21  g19(.a(new_n33_), .b(new_n31_), .c(new_n40_), .O(new_n41_));
  ...
  nor2   g24(.a(new_n23_), .b(x09), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n46_), .c(new_n40_), .d(x13), .O(new_n48_));
