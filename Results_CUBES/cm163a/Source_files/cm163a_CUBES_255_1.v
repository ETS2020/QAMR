...
module FAU ( 
  ...
  nand3  g18(.a(new_n39_), .b(new_n38_), .c(new_n29_), .O(new_n40_));
  nand2  g19(.a(new_n32_), .b(new_n29_), .O(new_n41_));
  ...
  nand2  g24(.a(new_n39_), .b(new_n29_), .O(new_n46_));
  nand2  g25(.a(new_n46_), .b(x13), .O(new_n47_));
  nand4  g26(.a(new_n39_), .b(new_n29_), .c(new_n37_), .d(x04), .O(new_n48_));
