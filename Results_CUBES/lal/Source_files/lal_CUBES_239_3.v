// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:58 2020
...
module FAU ( 
  ...
  aoi21  g07(.a(new_n52_), .b(new_n50_), .c(x23), .O(new_n53_));
  inv1   g08(.a(x24), .O(new_n54_));
  aoi21  g09(.a(new_n49_), .b(x18), .c(new_n54_), .O(new_n55_));
  ...
  nor2   g30(.a(x21), .b(x20), .O(new_n76_));
  nor2   g31(.a(x24), .b(x22), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  nor2   g33(.a(x22), .b(x21), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n78_), .c(x19), .d(x18), .O(new_n80_));
  ...
  oai21  g41(.a(new_n86_), .b(new_n83_), .c(new_n48_), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n82_), .O(new_n88_));
  aoi21  g43(.a(new_n83_), .b(new_n48_), .c(new_n49_), .O(new_n89_));
  inv1   g44(.a(x23), .O(new_n90_));
  aoi21  g45(.a(new_n48_), .b(new_n90_), .c(new_n54_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n88_), .c(new_n81_), .O(z08));
  nor2   g48(.a(x15), .b(x07), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n59_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(z09));
  nand3  g51(.a(new_n94_), .b(new_n58_), .c(new_n82_), .O(new_n97_));
  ...
  oai21  g56(.a(new_n84_), .b(new_n82_), .c(x19), .O(new_n102_));
  nor2   g57(.a(new_n84_), .b(new_n82_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n85_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(z12));
  nand2  g60(.a(new_n74_), .b(x20), .O(new_n106_));
  nor2   g61(.a(x20), .b(new_n85_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n103_), .O(new_n108_));
  nand2  g63(.a(new_n94_), .b(new_n58_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(z13));
  nand3  g66(.a(new_n103_), .b(new_n76_), .c(x19), .O(new_n112_));
  nand2  g67(.a(new_n108_), .b(x21), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n112_), .c(new_n110_), .O(z14));
  nand3  g69(.a(new_n79_), .b(new_n75_), .c(new_n49_), .O(new_n115_));
  nand2  g70(.a(new_n112_), .b(x22), .O(new_n116_));
  nand4  g71(.a(new_n116_), .b(new_n115_), .c(new_n94_), .d(new_n58_), .O(z15));
  nand4  g72(.a(new_n115_), .b(new_n94_), .c(new_n58_), .d(new_n90_), .O(z16));
  nand2  g73(.a(new_n115_), .b(x24), .O(new_n119_));
  inv1   g74(.a(x21), .O(new_n120_));
  nand4  g75(.a(new_n107_), .b(new_n103_), .c(new_n77_), .d(new_n120_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n110_), .O(z17));
  nand2  g77(.a(new_n78_), .b(x25), .O(new_n123_));
  inv1   g78(.a(new_n108_), .O(new_n124_));
  nand4  g79(.a(new_n124_), .b(new_n79_), .c(new_n48_), .d(new_n54_), .O(new_n125_));
