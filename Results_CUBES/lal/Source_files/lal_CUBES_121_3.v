...
module FAU ( 
  ...
  nand3  g40(.a(x21), .b(new_n76_), .c(new_n50_), .O(new_n86_));
  ...
  nand3  g51(.a(new_n94_), .b(new_n58_), .c(new_n53_), .O(new_n97_));
  ...
  oai21  g56(.a(new_n50_), .b(new_n53_), .c(x19), .O(new_n102_));
  nor2   g57(.a(new_n50_), .b(new_n53_), .O(new_n103_));
