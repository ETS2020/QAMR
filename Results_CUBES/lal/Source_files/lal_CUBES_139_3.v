...
module FAU ( 
  ...
  nand4  g29(.a(new_n72_), .b(new_n71_), .c(x19), .d(x18), .O(new_n75_));
  ...
  aoi21  g39(.a(new_n82_), .b(new_n78_), .c(new_n68_), .O(new_n85_));
  nor2   g40(.a(x25), .b(x24), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n70_), .O(new_n87_));
  ...
  nand3  g47(.a(new_n90_), .b(new_n52_), .c(new_n77_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  xnor2a g49(.a(x18), .b(x17), .O(new_n95_));
  nand2  g50(.a(new_n90_), .b(new_n52_), .O(new_n96_));
  ...
  nand4  g58(.a(new_n103_), .b(new_n90_), .c(new_n69_), .d(new_n52_), .O(z13));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand2  g61(.a(new_n90_), .b(new_n52_), .O(new_n107_));
  aoi21  g62(.a(new_n69_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g63(.a(new_n106_), .b(new_n102_), .c(new_n108_), .O(z14));
  inv1   g64(.a(new_n107_), .O(new_n110_));
  oai21  g65(.a(new_n106_), .b(new_n102_), .c(x22), .O(new_n111_));
  inv1   g66(.a(x21), .O(new_n112_));
  nor2   g67(.a(x20), .b(new_n80_), .O(new_n113_));
  nand2  g68(.a(new_n70_), .b(x22), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(new_n113_), .c(new_n99_), .d(new_n112_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n111_), .c(new_n110_), .O(z15));
  oai21  g71(.a(new_n106_), .b(new_n102_), .c(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand2  g73(.a(new_n105_), .b(new_n118_), .O(new_n119_));
  or2    g74(.a(new_n119_), .b(new_n102_), .O(new_n120_));
  ...
  inv1   g79(.a(new_n69_), .O(new_n125_));
  nand4  g80(.a(new_n86_), .b(new_n72_), .c(new_n125_), .d(new_n70_), .O(new_n126_));
