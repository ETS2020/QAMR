...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n87_, new_n89_, new_n91_, new_n93_;
  ...
  nor2   g37(.a(new_n82_), .b(new_n80_), .O(z12));
  inv1   g38(.a(x15), .O(new_n84_));
  nor2   g39(.a(z09), .b(x07), .O(new_n85_));
  nand3  g40(.a(new_n85_), .b(new_n49_), .c(new_n84_), .O(z13));
  nor2   g41(.a(x21), .b(x15), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(new_n85_), .O(z14));
  nor2   g43(.a(x22), .b(x15), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n85_), .O(z15));
  nor2   g45(.a(x23), .b(x15), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n85_), .O(z16));
  nor2   g47(.a(x24), .b(x15), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n85_), .O(z17));
  nand3  g49(.a(new_n85_), .b(new_n48_), .c(new_n84_), .O(z18));
  buf    g50(.a(x16), .O(z02));
endmodule
