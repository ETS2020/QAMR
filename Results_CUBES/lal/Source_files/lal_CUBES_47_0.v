...
module FAU ( 
  ...
  nand2  g56(.a(new_n79_), .b(new_n101_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n100_), .c(new_n97_), .O(z11));
  xor2a  g58(.a(x19), .b(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  nor2   g60(.a(new_n81_), .b(new_n79_), .O(new_n106_));
  xor2a  g61(.a(new_n106_), .b(x19), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n98_), .O(new_n108_));
  aoi21  g63(.a(new_n108_), .b(new_n105_), .c(new_n97_), .O(z12));
  nand2  g64(.a(new_n106_), .b(x19), .O(new_n110_));
