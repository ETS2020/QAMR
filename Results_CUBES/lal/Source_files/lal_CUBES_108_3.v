// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:51 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n86_, new_n88_, new_n90_, new_n92_, new_n94_;
  ...
  nand3  g35(.a(new_n74_), .b(new_n58_), .c(new_n80_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z11));
  nand3  g37(.a(new_n74_), .b(new_n58_), .c(x19), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z12));
  inv1   g39(.a(x15), .O(new_n85_));
  nor2   g40(.a(z09), .b(x07), .O(new_n86_));
  nand3  g41(.a(new_n86_), .b(new_n49_), .c(new_n85_), .O(z13));
  nor2   g42(.a(x21), .b(x15), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n86_), .O(z14));
  nor2   g44(.a(x22), .b(x15), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n86_), .O(z15));
  nor2   g46(.a(x23), .b(x15), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n86_), .O(z16));
  nor2   g48(.a(x24), .b(x15), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n86_), .O(z17));
  nand3  g50(.a(new_n86_), .b(new_n48_), .c(new_n85_), .O(z18));
  buf    g51(.a(x16), .O(z02));
endmodule
