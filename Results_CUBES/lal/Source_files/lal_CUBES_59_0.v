// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:25 2020
...
module FAU ( 
  ...
  oai21  g50(.a(new_n95_), .b(new_n89_), .c(x19), .O(new_n96_));
  inv1   g51(.a(x19), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(x18), .c(x17), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n96_), .c(new_n93_), .O(z12));
  aoi21  g54(.a(x19), .b(new_n95_), .c(new_n53_), .O(new_n100_));
  nand2  g55(.a(new_n74_), .b(x20), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n86_), .d(new_n69_), .O(z13));
  nand2  g57(.a(new_n69_), .b(x21), .O(new_n103_));
  nor2   g58(.a(x21), .b(x20), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n75_), .O(new_n105_));
  nand2  g60(.a(new_n86_), .b(new_n52_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n105_), .c(new_n103_), .O(z14));
  inv1   g63(.a(new_n69_), .O(new_n109_));
  nand2  g64(.a(new_n76_), .b(new_n109_), .O(new_n110_));
  ...
  nand3  g69(.a(new_n114_), .b(new_n109_), .c(new_n70_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n113_), .c(new_n107_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  nor2   g72(.a(x24), .b(x23), .O(new_n118_));
  nand4  g73(.a(new_n104_), .b(new_n118_), .c(new_n75_), .d(new_n71_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n107_), .O(z17));
  oai21  g75(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n121_));
  nand4  g76(.a(new_n114_), .b(new_n104_), .c(new_n82_), .d(new_n75_), .O(new_n122_));
