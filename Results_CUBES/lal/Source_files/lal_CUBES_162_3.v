...
module FAU ( 
  ...
  nand3  g50(.a(new_n54_), .b(new_n79_), .c(x17), .O(new_n96_));
  nand2  g51(.a(x18), .b(new_n77_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(z11));
  xor2a  g53(.a(x19), .b(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(x18), .O(new_n100_));
  nand3  g55(.a(new_n54_), .b(x19), .c(new_n79_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n100_), .c(new_n95_), .O(z12));
  nand3  g57(.a(x19), .b(x18), .c(x17), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(x20), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n90_), .c(new_n71_), .d(new_n54_), .O(z13));
  ...
  nand2  g64(.a(new_n90_), .b(new_n54_), .O(new_n110_));
  ...
  nand3  g68(.a(new_n106_), .b(new_n72_), .c(new_n70_), .O(new_n114_));
  ...
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n111_), .O(z16));
  inv1   g74(.a(new_n74_), .O(new_n120_));
  nand2  g75(.a(new_n118_), .b(x24), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n111_), .c(new_n120_), .O(z17));
  ...
  nand3  g80(.a(new_n125_), .b(new_n124_), .c(new_n111_), .O(z18));
  buf    g81(.a(x16), .O(z02));
endmodule
