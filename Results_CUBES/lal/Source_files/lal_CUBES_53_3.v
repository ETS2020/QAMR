...
module FAU ( 
  ...
  nand2  g49(.a(x18), .b(new_n77_), .O(new_n95_));
  inv1   g50(.a(x07), .O(new_n96_));
  nand3  g51(.a(new_n79_), .b(x17), .c(new_n96_), .O(new_n97_));
  inv1   g52(.a(x15), .O(new_n98_));
  nand2  g53(.a(new_n54_), .b(new_n98_), .O(new_n99_));
  aoi21  g54(.a(new_n97_), .b(new_n95_), .c(new_n99_), .O(z11));
  xor2a  g55(.a(x19), .b(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x18), .O(new_n102_));
  nand3  g57(.a(x19), .b(new_n79_), .c(new_n96_), .O(new_n103_));
