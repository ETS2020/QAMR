// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:57 2020
...
module FAU ( 
  ...
  nand3  g23(.a(new_n68_), .b(x19), .c(x18), .O(new_n69_));
  ...
  or2    g51(.a(new_n95_), .b(x19), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n93_), .O(z12));
  nor2   g53(.a(new_n53_), .b(new_n89_), .O(new_n99_));
  nand2  g54(.a(new_n74_), .b(x20), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n86_), .d(new_n69_), .O(z13));
  nand2  g56(.a(new_n69_), .b(x21), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n75_), .O(new_n104_));
  ...
  inv1   g62(.a(new_n69_), .O(new_n108_));
  nand2  g63(.a(new_n76_), .b(new_n108_), .O(new_n109_));
  ...
  nand3  g68(.a(new_n113_), .b(new_n108_), .c(new_n70_), .O(new_n114_));
  ...
  nand4  g72(.a(new_n103_), .b(new_n117_), .c(new_n75_), .d(new_n71_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n106_), .O(z17));
  oai21  g74(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n120_));
  nand4  g75(.a(new_n113_), .b(new_n103_), .c(new_n82_), .d(new_n75_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n106_), .O(z18));
  buf    g77(.a(x16), .O(z02));
endmodule
