// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:22 2020
...
module FAU ( 
  ...
  nand2  g28(.a(x19), .b(x17), .O(new_n74_));
  ...
  nor2   g55(.a(new_n100_), .b(new_n99_), .O(z12));
  nand2  g56(.a(new_n74_), .b(x20), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n94_), .c(new_n76_), .d(new_n58_), .O(z13));
  nand2  g58(.a(new_n76_), .b(x21), .O(new_n104_));
  nor2   g59(.a(x21), .b(x20), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n75_), .O(new_n106_));
  nand2  g61(.a(new_n94_), .b(new_n58_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(z14));
  inv1   g64(.a(new_n76_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n78_), .c(new_n77_), .O(new_n111_));
  aoi21  g66(.a(new_n106_), .b(x22), .c(new_n107_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n111_), .O(z15));
  nand2  g68(.a(new_n111_), .b(x23), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n110_), .c(new_n77_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n108_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  nand4  g73(.a(new_n105_), .b(new_n79_), .c(new_n75_), .d(new_n78_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n108_), .O(z17));
  oai21  g75(.a(new_n80_), .b(new_n76_), .c(x25), .O(new_n121_));
  inv1   g76(.a(new_n106_), .O(new_n122_));
  nand4  g77(.a(new_n115_), .b(new_n122_), .c(new_n48_), .d(new_n82_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n108_), .O(z18));
  buf    g79(.a(x16), .O(z02));
  inv1   g80(.a(new_n97_), .O(z11));
endmodule
