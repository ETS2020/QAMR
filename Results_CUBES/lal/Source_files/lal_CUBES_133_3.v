// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:04 2020
...
module FAU ( 
  ...
  nor2   g28(.a(x21), .b(x20), .O(new_n74_));
  nand4  g29(.a(new_n74_), .b(new_n73_), .c(new_n49_), .d(new_n71_), .O(new_n75_));
  ...
  nor2   g43(.a(x25), .b(x23), .O(new_n89_));
  nor2   g44(.a(new_n89_), .b(new_n49_), .O(new_n90_));
  nor2   g45(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n86_), .c(new_n78_), .O(z08));
  nor2   g47(.a(x15), .b(x07), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n56_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(z09));
  nand3  g50(.a(new_n93_), .b(new_n55_), .c(new_n79_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  xnor2a g52(.a(x18), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(new_n55_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(new_n98_), .O(z11));
  oai21  g55(.a(new_n81_), .b(new_n79_), .c(x19), .O(new_n101_));
  nor2   g56(.a(new_n81_), .b(new_n79_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n82_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z12));
  nand2  g59(.a(new_n72_), .b(x20), .O(new_n105_));
  nand3  g60(.a(new_n102_), .b(new_n87_), .c(x19), .O(new_n106_));
  nand2  g61(.a(new_n93_), .b(new_n55_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(z13));
  nand3  g64(.a(new_n102_), .b(new_n74_), .c(x19), .O(new_n110_));
  ...
  nand3  g68(.a(new_n76_), .b(new_n73_), .c(new_n87_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n108_), .O(z15));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n116_));
  nand4  g71(.a(new_n74_), .b(new_n73_), .c(new_n48_), .d(new_n71_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n108_), .O(z16));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n119_));
  inv1   g74(.a(new_n106_), .O(new_n120_));
  nand2  g75(.a(new_n80_), .b(x23), .O(new_n121_));
  nor3   g76(.a(x24), .b(x22), .c(x21), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n119_), .c(new_n108_), .O(z17));
  nand3  g79(.a(new_n122_), .b(new_n120_), .c(new_n89_), .O(new_n125_));
  aoi21  g80(.a(new_n75_), .b(x25), .c(new_n107_), .O(new_n126_));
