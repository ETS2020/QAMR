// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:56 2020
...
module FAU ( 
  ...
  nand3  g35(.a(new_n77_), .b(new_n54_), .c(new_n80_), .O(new_n81_));
  inv1   g36(.a(new_n81_), .O(z10));
  nand3  g37(.a(new_n77_), .b(new_n54_), .c(x17), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(z11));
  nand3  g39(.a(new_n77_), .b(new_n54_), .c(x19), .O(new_n85_));
  inv1   g40(.a(new_n85_), .O(z12));
  nor2   g41(.a(z09), .b(x07), .O(new_n87_));
  nor2   g42(.a(x20), .b(x15), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n87_), .O(z13));
  nor2   g44(.a(x21), .b(x15), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n87_), .O(z14));
  nor2   g46(.a(x22), .b(x15), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n87_), .O(z15));
  inv1   g48(.a(x15), .O(new_n94_));
  nand3  g49(.a(new_n87_), .b(new_n48_), .c(new_n94_), .O(z16));
  nand3  g50(.a(new_n87_), .b(new_n49_), .c(new_n94_), .O(z17));
  nand3  g51(.a(new_n87_), .b(new_n74_), .c(new_n94_), .O(z18));
  buf    g52(.a(x16), .O(z02));
endmodule
