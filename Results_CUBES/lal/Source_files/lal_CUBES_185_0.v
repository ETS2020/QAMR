// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:30 2020
...
module FAU ( 
  ...
  nand3  g47(.a(new_n86_), .b(new_n92_), .c(new_n52_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z11));
  nand2  g49(.a(new_n86_), .b(new_n52_), .O(new_n95_));
  nand2  g50(.a(new_n92_), .b(x19), .O(new_n96_));
  or2    g51(.a(new_n92_), .b(x19), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(z12));
  nand2  g53(.a(new_n75_), .b(x20), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n86_), .c(new_n69_), .d(new_n52_), .O(z13));
  nor2   g55(.a(x21), .b(x20), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  nand2  g57(.a(new_n69_), .b(x21), .O(new_n103_));
  nand2  g58(.a(new_n86_), .b(new_n52_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(z14));
  nand2  g61(.a(new_n102_), .b(x22), .O(new_n107_));
  nand3  g62(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(z15));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n110_));
  nand4  g65(.a(new_n101_), .b(new_n76_), .c(new_n48_), .d(new_n71_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n110_), .c(new_n105_), .O(z16));
  nand2  g67(.a(new_n111_), .b(x24), .O(new_n113_));
  nor2   g68(.a(new_n104_), .b(new_n73_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(new_n113_), .O(z17));
  inv1   g70(.a(new_n69_), .O(new_n116_));
  nand4  g71(.a(new_n82_), .b(new_n74_), .c(new_n116_), .d(new_n48_), .O(new_n117_));
  oai21  g72(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n117_), .c(new_n105_), .O(z18));
  buf    g74(.a(x16), .O(z02));
endmodule
