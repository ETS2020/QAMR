...
module FAU ( 
  ...
  nor2   g52(.a(new_n95_), .b(new_n89_), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  aoi21  g54(.a(new_n99_), .b(new_n96_), .c(new_n93_), .O(z12));
  nand2  g55(.a(new_n75_), .b(x20), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n86_), .c(new_n69_), .d(new_n52_), .O(z13));
  nand4  g57(.a(new_n98_), .b(new_n70_), .c(new_n68_), .d(x19), .O(new_n103_));
  ...
  nand2  g66(.a(new_n49_), .b(new_n95_), .O(new_n112_));
  nor2   g67(.a(new_n97_), .b(new_n89_), .O(new_n113_));
  nor2   g68(.a(x21), .b(x20), .O(new_n114_));
  nor2   g69(.a(x23), .b(x22), .O(new_n115_));
  nand4  g70(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n116_));
  nand3  g71(.a(new_n116_), .b(new_n111_), .c(new_n106_), .O(z16));
  nand2  g72(.a(new_n68_), .b(x19), .O(new_n118_));
  nand3  g73(.a(new_n115_), .b(new_n70_), .c(x17), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n118_), .c(x24), .O(new_n120_));
  nor2   g75(.a(new_n105_), .b(new_n73_), .O(new_n121_));
  nand2  g76(.a(new_n121_), .b(new_n120_), .O(z17));
  inv1   g77(.a(new_n69_), .O(new_n123_));
  nand4  g78(.a(new_n82_), .b(new_n74_), .c(new_n123_), .d(new_n48_), .O(new_n124_));
