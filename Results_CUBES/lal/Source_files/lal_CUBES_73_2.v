// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:33 2020
...
module FAU ( 
  ...
  nand3  g42(.a(new_n82_), .b(new_n49_), .c(x19), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(new_n74_), .d(new_n58_), .O(z13));
  nand2  g44(.a(x19), .b(x17), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(x18), .c(new_n59_), .O(new_n91_));
  oai21  g46(.a(x20), .b(new_n51_), .c(x21), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n74_), .O(z14));
  nor2   g48(.a(z09), .b(x07), .O(new_n94_));
  nor2   g49(.a(x22), .b(x15), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n94_), .O(z15));
  nor2   g51(.a(x23), .b(x15), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n94_), .O(z16));
  nor2   g53(.a(x24), .b(x15), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n94_), .O(z17));
  nor2   g55(.a(x25), .b(x15), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n94_), .O(z18));
  buf    g57(.a(x16), .O(z02));
endmodule
