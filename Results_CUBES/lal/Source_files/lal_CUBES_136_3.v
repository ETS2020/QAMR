// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:05 2020
...
module FAU ( 
  ...
  nor2   g32(.a(x22), .b(x20), .O(new_n78_));
  nor2   g33(.a(x24), .b(x23), .O(new_n79_));
  nand3  g34(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n75_), .c(new_n48_), .d(new_n53_), .O(new_n81_));
  ...
  nor2   g58(.a(x20), .b(new_n74_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  nand2  g60(.a(new_n76_), .b(x20), .O(new_n106_));
  nand4  g61(.a(new_n106_), .b(new_n105_), .c(new_n92_), .d(new_n57_), .O(z13));
  nand4  g62(.a(new_n105_), .b(new_n92_), .c(new_n57_), .d(new_n52_), .O(z14));
  nand3  g63(.a(new_n101_), .b(new_n78_), .c(x19), .O(new_n109_));
  nand2  g64(.a(new_n105_), .b(x22), .O(new_n110_));
  nand2  g65(.a(new_n92_), .b(new_n57_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(z15));
  ...
  nand3  g71(.a(new_n116_), .b(new_n114_), .c(new_n112_), .O(z16));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n118_));
  nand4  g73(.a(new_n104_), .b(new_n101_), .c(new_n79_), .d(new_n53_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n112_), .O(z17));
  ...
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n112_), .O(z18));
  buf    g79(.a(x16), .O(z02));
endmodule
