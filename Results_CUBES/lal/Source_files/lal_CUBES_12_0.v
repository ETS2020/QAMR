// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:01 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n122_, new_n123_, new_n125_, new_n126_;
  ...
  nand3  g23(.a(new_n68_), .b(x19), .c(x17), .O(new_n69_));
  ...
  nand3  g32(.a(new_n77_), .b(new_n74_), .c(new_n49_), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n73_), .c(x25), .O(new_n79_));
  inv1   g34(.a(x25), .O(new_n80_));
  nand3  g35(.a(x24), .b(x22), .c(x21), .O(new_n81_));
  aoi21  g36(.a(new_n81_), .b(new_n80_), .c(new_n68_), .O(new_n82_));
  nor2   g37(.a(x25), .b(x24), .O(new_n83_));
  nor2   g38(.a(new_n83_), .b(new_n48_), .O(new_n84_));
  nor2   g39(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  ...
  nand3  g44(.a(new_n87_), .b(new_n52_), .c(new_n75_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(z10));
  xnor2a g46(.a(x18), .b(x17), .O(new_n92_));
  nand2  g47(.a(new_n87_), .b(new_n52_), .O(new_n93_));
  nor2   g48(.a(new_n93_), .b(new_n92_), .O(z11));
  inv1   g49(.a(x18), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(new_n75_), .c(x19), .O(new_n96_));
  nor2   g51(.a(new_n95_), .b(new_n75_), .O(new_n97_));
  nand2  g52(.a(new_n97_), .b(new_n76_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n96_), .c(new_n93_), .O(z12));
  nand3  g54(.a(x19), .b(x18), .c(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x20), .O(new_n101_));
  nand3  g56(.a(new_n97_), .b(new_n68_), .c(x19), .O(new_n102_));
  nand2  g57(.a(new_n87_), .b(new_n52_), .O(new_n103_));
  ...
  nand3  g66(.a(new_n106_), .b(new_n74_), .c(new_n68_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n104_), .O(z15));
  nand3  g68(.a(new_n77_), .b(new_n74_), .c(new_n68_), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x23), .O(new_n115_));
  aoi21  g70(.a(x19), .b(new_n95_), .c(new_n53_), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand2  g72(.a(new_n117_), .b(new_n70_), .O(new_n118_));
  or2    g73(.a(new_n118_), .b(new_n69_), .O(new_n119_));
  nand4  g74(.a(new_n119_), .b(new_n116_), .c(new_n115_), .d(new_n87_), .O(z16));
  oai21  g75(.a(new_n118_), .b(new_n69_), .c(x24), .O(new_n121_));
  nor2   g76(.a(x24), .b(x23), .O(new_n122_));
  nand4  g77(.a(new_n107_), .b(new_n77_), .c(new_n122_), .d(new_n71_), .O(new_n123_));
  nand3  g78(.a(new_n123_), .b(new_n121_), .c(new_n104_), .O(z17));
  oai21  g79(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n125_));
  nand4  g80(.a(new_n117_), .b(new_n107_), .c(new_n83_), .d(new_n77_), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n104_), .O(z18));
  buf    g82(.a(x16), .O(z02));
endmodule
