// Benchmark "FAU" written by ABC on Mon Jul  6 14:39:56 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n65_, new_n69_, new_n70_, new_n72_, new_n73_, new_n74_, new_n76_,
  ...
  nand2  g27(.a(new_n69_), .b(new_n72_), .O(new_n73_));
  oai21  g28(.a(x25), .b(x18), .c(new_n52_), .O(new_n74_));
  nor2   g29(.a(new_n74_), .b(new_n73_), .O(z10));
  nand2  g30(.a(x18), .b(new_n72_), .O(new_n76_));
  inv1   g31(.a(x18), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(x17), .O(new_n78_));
  nand2  g33(.a(new_n69_), .b(new_n52_), .O(new_n79_));
  aoi21  g34(.a(new_n78_), .b(new_n76_), .c(new_n79_), .O(z11));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n82_), .c(new_n79_), .O(z12));
  nand3  g41(.a(x19), .b(x18), .c(x17), .O(new_n87_));
  nand2  g42(.a(new_n87_), .b(x20), .O(new_n88_));
  inv1   g43(.a(x20), .O(new_n89_));
  nand3  g44(.a(new_n84_), .b(new_n89_), .c(x19), .O(new_n90_));
  nand2  g45(.a(new_n69_), .b(new_n52_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n90_), .c(new_n88_), .O(z13));
  nor2   g48(.a(x21), .b(x20), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n84_), .c(x19), .O(new_n95_));
  nand2  g50(.a(new_n90_), .b(x21), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z14));
  nand2  g52(.a(new_n95_), .b(x22), .O(new_n98_));
  inv1   g53(.a(new_n87_), .O(new_n99_));
  nor2   g54(.a(x22), .b(x21), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n89_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n98_), .c(new_n92_), .O(z15));
  nand2  g57(.a(new_n101_), .b(x23), .O(new_n103_));
  nor2   g58(.a(x23), .b(x22), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n94_), .c(new_n99_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n103_), .c(new_n92_), .O(z16));
  nand2  g61(.a(new_n105_), .b(x24), .O(new_n107_));
  nor2   g62(.a(x20), .b(new_n83_), .O(new_n108_));
  nor2   g63(.a(x24), .b(x23), .O(new_n109_));
  nand4  g64(.a(new_n109_), .b(new_n100_), .c(new_n108_), .d(new_n84_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n92_), .O(z17));
  nand2  g66(.a(x25), .b(new_n72_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n78_), .c(new_n52_), .O(new_n113_));
  inv1   g68(.a(new_n113_), .O(new_n114_));
  inv1   g69(.a(x21), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n89_), .c(x19), .O(new_n116_));
  inv1   g71(.a(x22), .O(new_n117_));
  nand3  g72(.a(new_n49_), .b(new_n48_), .c(new_n117_), .O(new_n118_));
  oai21  g73(.a(new_n118_), .b(new_n116_), .c(x25), .O(new_n119_));
  nor2   g74(.a(new_n83_), .b(new_n72_), .O(new_n120_));
  nor2   g75(.a(x25), .b(x24), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(new_n120_), .c(new_n104_), .d(new_n94_), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n119_), .c(new_n114_), .d(new_n69_), .O(z18));
  buf    g78(.a(x16), .O(z02));
endmodule
