// Benchmark "FAU" written by ABC on Mon Jul  6 14:17:55 2020
...
module FAU ( 
  ...
  oai21  g011(.a(new_n63_), .b(new_n55_), .c(new_n58_), .O(new_n64_));
  ...
  nand2  g019(.a(new_n63_), .b(new_n57_), .O(new_n72_));
