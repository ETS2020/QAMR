// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:58 2020
...
module FAU ( 
  ...
  nor2   g033(.a(x18), .b(x07), .O(new_n86_));
  oai22  g034(.a(new_n86_), .b(new_n85_), .c(x24), .d(x19), .O(z04));
  inv1   g035(.a(x25), .O(new_n88_));
  nand3  g036(.a(new_n88_), .b(new_n55_), .c(x06), .O(new_n89_));
  inv1   g037(.a(x26), .O(new_n90_));
  nand3  g038(.a(new_n90_), .b(x19), .c(x18), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g040(.a(new_n92_), .b(new_n84_), .O(new_n93_));
  nand2  g041(.a(new_n88_), .b(new_n57_), .O(new_n94_));
  ...
  nand2  g047(.a(new_n90_), .b(new_n57_), .O(new_n100_));
