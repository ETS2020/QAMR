// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:06 2020
...
module FAU ( 
  ...
  nand3  g095(.a(x19), .b(new_n55_), .c(x14), .O(new_n148_));
  ...
  nand2  g101(.a(new_n153_), .b(new_n57_), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n152_), .O(z13));
  inv1   g103(.a(new_n58_), .O(new_n156_));
  nand2  g104(.a(new_n55_), .b(x13), .O(new_n157_));
  inv1   g105(.a(x35), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(x18), .O(new_n159_));
  aoi21  g107(.a(new_n159_), .b(new_n157_), .c(new_n156_), .O(z14));
  ...
  nand2  g112(.a(new_n158_), .b(new_n57_), .O(new_n165_));
