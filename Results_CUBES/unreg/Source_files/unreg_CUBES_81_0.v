...
module FAU ( 
  ...
  nand3  g046(.a(x19), .b(new_n55_), .c(x05), .O(new_n99_));
  inv1   g047(.a(x27), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(x18), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  inv1   g051(.a(x26), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n57_), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n103_), .O(z06));
  inv1   g054(.a(new_n58_), .O(new_n107_));
  nand2  g055(.a(new_n55_), .b(x04), .O(new_n108_));
  nand2  g056(.a(new_n60_), .b(x18), .O(new_n109_));
  aoi21  g057(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(z07));
