...
module FAU ( 
  ...
  nand3  g102(.a(x19), .b(new_n55_), .c(x13), .O(new_n155_));
  ...
  inv1   g110(.a(new_n58_), .O(new_n163_));
  nand2  g111(.a(new_n55_), .b(x12), .O(new_n164_));
  nand2  g112(.a(new_n116_), .b(x18), .O(new_n165_));
  aoi21  g113(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(z15));
endmodule
