...
module FAU ( 
  ...
  nand3  g071(.a(new_n123_), .b(new_n55_), .c(x09), .O(new_n124_));
  inv1   g072(.a(x31), .O(new_n125_));
  nand3  g073(.a(new_n125_), .b(x19), .c(x18), .O(new_n126_));
  nand2  g074(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g075(.a(new_n127_), .b(new_n119_), .O(new_n128_));
  nand2  g076(.a(new_n123_), .b(new_n57_), .O(new_n129_));
  ...
  nand2  g082(.a(new_n125_), .b(new_n57_), .O(new_n135_));
