// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:18 2020
...
module FAU ( 
  ...
  nor2   g047(.a(x18), .b(x05), .O(new_n100_));
  oai22  g048(.a(new_n100_), .b(new_n99_), .c(x26), .d(x19), .O(z06));
  nand3  g049(.a(new_n60_), .b(x19), .c(x18), .O(new_n102_));
  inv1   g050(.a(x27), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n55_), .c(x04), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g053(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand2  g054(.a(new_n103_), .b(new_n57_), .O(new_n107_));
