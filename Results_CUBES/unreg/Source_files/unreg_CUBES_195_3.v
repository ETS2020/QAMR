...
module FAU ( 
  ...
  nand3  g099(.a(new_n151_), .b(new_n55_), .c(x13), .O(new_n152_));
  inv1   g100(.a(x35), .O(new_n153_));
  nand3  g101(.a(new_n153_), .b(x19), .c(x18), .O(new_n154_));
  nand2  g102(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  nand2  g104(.a(new_n151_), .b(new_n57_), .O(new_n157_));
  ...
  nand2  g110(.a(new_n153_), .b(new_n57_), .O(new_n163_));
