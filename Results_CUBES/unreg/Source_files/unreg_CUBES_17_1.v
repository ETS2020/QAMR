...
module FAU ( 
  ...
  nor2   g013(.a(new_n59_), .b(x17), .O(new_n66_));
  ...
  nor2   g020(.a(x23), .b(new_n56_), .O(new_n73_));
  oai21  g021(.a(new_n73_), .b(new_n72_), .c(new_n66_), .O(new_n74_));
  ...
  nand2  g028(.a(new_n80_), .b(new_n66_), .O(new_n81_));
  ...
  nor2   g034(.a(x25), .b(new_n56_), .O(new_n87_));
  oai21  g035(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(new_n88_));
  ...
  nor2   g041(.a(x26), .b(new_n56_), .O(new_n94_));
  oai21  g042(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(new_n95_));
  ...
  nor2   g048(.a(x27), .b(new_n56_), .O(new_n101_));
  oai21  g049(.a(new_n101_), .b(new_n100_), .c(new_n66_), .O(new_n102_));
  ...
  nor2   g058(.a(x29), .b(new_n56_), .O(new_n111_));
  oai21  g059(.a(new_n111_), .b(new_n110_), .c(new_n66_), .O(new_n112_));
  ...
  nor2   g065(.a(x30), .b(new_n56_), .O(new_n118_));
  oai21  g066(.a(new_n118_), .b(new_n117_), .c(new_n66_), .O(new_n119_));
  ...
  nor2   g072(.a(x31), .b(new_n56_), .O(new_n125_));
  oai21  g073(.a(new_n125_), .b(new_n124_), .c(new_n66_), .O(new_n126_));
  ...
  nor2   g079(.a(x24), .b(new_n56_), .O(new_n132_));
  oai21  g080(.a(new_n132_), .b(new_n131_), .c(new_n66_), .O(new_n133_));
  ...
  nor2   g086(.a(x33), .b(new_n56_), .O(new_n139_));
  oai21  g087(.a(new_n139_), .b(new_n138_), .c(new_n66_), .O(new_n140_));
  ...
  nor2   g093(.a(x34), .b(new_n56_), .O(new_n146_));
  oai21  g094(.a(new_n146_), .b(new_n145_), .c(new_n66_), .O(new_n147_));
  ...
  nor2   g100(.a(x35), .b(new_n56_), .O(new_n153_));
  oai21  g101(.a(new_n153_), .b(new_n152_), .c(new_n66_), .O(new_n154_));
  ...
  nor2   g107(.a(x28), .b(new_n56_), .O(new_n160_));
  oai21  g108(.a(new_n160_), .b(new_n159_), .c(new_n66_), .O(new_n161_));
