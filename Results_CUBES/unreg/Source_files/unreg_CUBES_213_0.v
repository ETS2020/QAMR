// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:14 2020
...
module FAU ( 
  ...
  nand3  g032(.a(x19), .b(new_n55_), .c(x07), .O(new_n85_));
  inv1   g033(.a(x25), .O(new_n86_));
  nand2  g034(.a(new_n86_), .b(x18), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n84_), .O(new_n89_));
  inv1   g037(.a(x24), .O(new_n90_));
  nand2  g038(.a(new_n90_), .b(new_n57_), .O(new_n91_));
  nand2  g039(.a(new_n91_), .b(new_n89_), .O(z04));
  inv1   g040(.a(new_n58_), .O(new_n93_));
  nand2  g041(.a(new_n55_), .b(x06), .O(new_n94_));
  inv1   g042(.a(x26), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(x18), .O(new_n96_));
  aoi21  g044(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(z05));
  ...
  nand2  g049(.a(new_n95_), .b(new_n57_), .O(new_n102_));
