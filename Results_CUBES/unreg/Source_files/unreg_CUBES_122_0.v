...
module FAU ( 
  ...
  nand2  g068(.a(new_n114_), .b(new_n57_), .O(new_n121_));
  ...
  inv1   g105(.a(x17), .O(new_n158_));
  nand3  g106(.a(x19), .b(new_n55_), .c(x12), .O(new_n159_));
