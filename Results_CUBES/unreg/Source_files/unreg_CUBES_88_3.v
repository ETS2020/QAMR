// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:21 2020
...
module FAU ( 
  ...
  nand3  g061(.a(new_n113_), .b(new_n55_), .c(x11), .O(new_n114_));
  inv1   g062(.a(x29), .O(new_n115_));
  nand3  g063(.a(new_n115_), .b(x19), .c(x18), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g065(.a(new_n117_), .b(new_n112_), .O(new_n118_));
  nand2  g066(.a(new_n113_), .b(new_n57_), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n118_), .O(z08));
  inv1   g068(.a(x10), .O(new_n121_));
  nor2   g069(.a(x18), .b(new_n121_), .O(new_n122_));
  nor2   g070(.a(x30), .b(new_n55_), .O(new_n123_));
  oai21  g071(.a(new_n123_), .b(new_n122_), .c(new_n58_), .O(new_n124_));
  nand2  g072(.a(new_n115_), .b(new_n57_), .O(new_n125_));
  ...
  nand2  g109(.a(x19), .b(new_n112_), .O(new_n162_));
  nor2   g110(.a(x18), .b(x12), .O(new_n163_));
