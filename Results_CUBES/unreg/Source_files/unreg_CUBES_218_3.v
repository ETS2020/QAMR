// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:17 2020
...
module FAU ( 
  ...
  nor2   g096(.a(x34), .b(new_n55_), .O(new_n149_));
  oai21  g097(.a(new_n149_), .b(new_n148_), .c(new_n58_), .O(new_n150_));
  inv1   g098(.a(x33), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n57_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(z13));
  inv1   g101(.a(x17), .O(new_n154_));
  nand2  g102(.a(x19), .b(new_n154_), .O(new_n155_));
  nor2   g103(.a(x18), .b(x13), .O(new_n156_));
  ...
  nand3  g107(.a(new_n159_), .b(new_n55_), .c(x12), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n154_), .O(new_n162_));
  nand2  g110(.a(new_n159_), .b(new_n57_), .O(new_n163_));
