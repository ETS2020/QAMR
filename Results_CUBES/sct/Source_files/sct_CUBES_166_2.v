...
module FAU ( 
  ...
  oai21  g18(.a(new_n52_), .b(x08), .c(x16), .O(new_n53_));
  nand3  g19(.a(new_n53_), .b(x07), .c(x06), .O(new_n54_));
  nand2  g20(.a(x07), .b(x06), .O(new_n55_));
  nand3  g21(.a(new_n55_), .b(new_n44_), .c(x08), .O(new_n56_));
  aoi21  g22(.a(new_n56_), .b(new_n54_), .c(new_n40_), .O(z04));
  nand3  g23(.a(x08), .b(x07), .c(x06), .O(new_n58_));
  nand2  g24(.a(new_n58_), .b(x09), .O(new_n59_));
  oai21  g25(.a(new_n40_), .b(x02), .c(new_n51_), .O(new_n60_));
  ...
  nand3  g45(.a(new_n73_), .b(new_n51_), .c(x02), .O(new_n80_));
  ...
  nor2   g49(.a(new_n43_), .b(x02), .O(new_n84_));
  ...
  nor2   g62(.a(new_n84_), .b(x03), .O(new_n97_));
