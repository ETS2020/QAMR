...
module FAU ( 
  ...
  aoi21  g23(.a(new_n57_), .b(new_n43_), .c(new_n56_), .O(new_n58_));
  inv1   g24(.a(x09), .O(new_n59_));
  nand4  g25(.a(new_n59_), .b(x08), .c(x07), .d(x06), .O(new_n60_));
  inv1   g26(.a(new_n60_), .O(new_n61_));
  nor3   g27(.a(new_n61_), .b(new_n58_), .c(new_n40_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n55_), .O(z05));
  nor2   g29(.a(new_n58_), .b(new_n40_), .O(new_n64_));
  ...
  nand4  g41(.a(new_n67_), .b(new_n66_), .c(new_n75_), .d(new_n71_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n64_), .O(z08));
  nor2   g43(.a(new_n56_), .b(x02), .O(new_n78_));
  inv1   g44(.a(x10), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n71_), .d(new_n79_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  aoi21  g48(.a(new_n82_), .b(new_n61_), .c(new_n78_), .O(new_n83_));
  ...
  aoi21  g53(.a(new_n44_), .b(x16), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n88_), .b(new_n82_), .c(new_n61_), .O(new_n89_));
