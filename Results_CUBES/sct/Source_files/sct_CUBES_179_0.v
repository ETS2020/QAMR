...
module FAU ( 
  ...
  nand2  g20(.a(x16), .b(new_n35_), .O(new_n55_));
  and2   g21(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  ...
  nand3  g27(.a(new_n61_), .b(new_n50_), .c(x08), .O(new_n62_));
  inv1   g28(.a(x03), .O(new_n63_));
  oai21  g29(.a(new_n40_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand2  g30(.a(new_n64_), .b(x16), .O(new_n65_));
  nand3  g31(.a(new_n54_), .b(x10), .c(x04), .O(new_n66_));
  nand4  g32(.a(new_n66_), .b(new_n65_), .c(new_n62_), .d(x04), .O(z06));
  nand2  g33(.a(new_n62_), .b(x11), .O(new_n68_));
  inv1   g34(.a(x11), .O(new_n69_));
  inv1   g35(.a(new_n57_), .O(new_n70_));
  nand3  g36(.a(new_n61_), .b(new_n70_), .c(new_n69_), .O(new_n71_));
  aoi21  g37(.a(new_n64_), .b(x16), .c(new_n40_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n71_), .c(new_n68_), .O(z07));
  nand2  g39(.a(new_n71_), .b(x12), .O(new_n74_));
  inv1   g40(.a(x12), .O(new_n75_));
  nand4  g41(.a(new_n61_), .b(new_n70_), .c(new_n75_), .d(new_n69_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(z08));
  inv1   g43(.a(x10), .O(new_n78_));
  nand2  g44(.a(new_n54_), .b(x04), .O(new_n79_));
  nand2  g45(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(x13), .O(new_n81_));
  nor2   g47(.a(x09), .b(new_n49_), .O(new_n82_));
  nand2  g48(.a(new_n75_), .b(new_n69_), .O(new_n83_));
  nand4  g49(.a(new_n83_), .b(new_n82_), .c(new_n50_), .d(new_n78_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n81_), .c(new_n72_), .O(z09));
  nand2  g51(.a(x08), .b(x07), .O(new_n86_));
  nor2   g52(.a(new_n86_), .b(x09), .O(new_n87_));
  nand4  g53(.a(new_n87_), .b(new_n43_), .c(x06), .d(x00), .O(new_n88_));
  nand2  g54(.a(new_n44_), .b(x14), .O(new_n89_));
  aoi21  g55(.a(new_n89_), .b(new_n88_), .c(new_n40_), .O(z10));
  aoi21  g56(.a(new_n55_), .b(new_n63_), .c(new_n40_), .O(z12));
  nor2   g57(.a(x13), .b(x10), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n54_), .c(new_n40_), .O(z13));
