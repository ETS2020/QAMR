...
module FAU ( 
  ...
  aoi21  g19(.a(new_n53_), .b(new_n50_), .c(new_n40_), .O(z03));
  inv1   g20(.a(x08), .O(new_n55_));
  oai21  g21(.a(new_n45_), .b(new_n43_), .c(x16), .O(new_n56_));
  nand3  g22(.a(new_n56_), .b(new_n55_), .c(x07), .O(new_n57_));
  nor2   g23(.a(new_n51_), .b(new_n43_), .O(new_n58_));
  oai21  g24(.a(new_n58_), .b(new_n45_), .c(new_n53_), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(x08), .O(new_n60_));
  aoi21  g26(.a(new_n60_), .b(new_n57_), .c(new_n40_), .O(z04));
  ...
  nand3  g32(.a(new_n58_), .b(new_n66_), .c(x08), .O(new_n67_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n66_), .c(x08), .d(x07), .O(new_n92_));
  nor2   g58(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nor2   g59(.a(new_n52_), .b(x02), .O(new_n94_));
  aoi21  g60(.a(new_n93_), .b(new_n56_), .c(new_n94_), .O(new_n95_));
  ...
  nor3   g67(.a(x09), .b(new_n55_), .c(new_n51_), .O(new_n102_));
  nand3  g68(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(new_n103_));
