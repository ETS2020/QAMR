// Benchmark "FAU" written by ABC on Mon Jul  6 14:34:14 2020
...
module FAU ( 
  ...
  nand4  g35(.a(new_n64_), .b(new_n69_), .c(new_n63_), .d(new_n58_), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n68_), .c(new_n61_), .O(z07));
  oai21  g37(.a(new_n67_), .b(new_n54_), .c(x12), .O(new_n72_));
  inv1   g38(.a(x12), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n69_), .c(new_n63_), .d(new_n58_), .O(new_n74_));
  inv1   g40(.a(new_n74_), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n64_), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n72_), .c(new_n61_), .O(z08));
  inv1   g43(.a(x13), .O(new_n78_));
  nand4  g44(.a(new_n78_), .b(new_n73_), .c(new_n69_), .d(new_n63_), .O(new_n79_));
  nor2   g45(.a(new_n79_), .b(new_n59_), .O(new_n80_));
  nor2   g46(.a(new_n44_), .b(x02), .O(new_n81_));
  aoi21  g47(.a(new_n80_), .b(new_n47_), .c(new_n81_), .O(new_n82_));
  oai21  g48(.a(new_n74_), .b(new_n54_), .c(x13), .O(new_n83_));
