...
module FAU ( 
  ...
  nand3  g13(.a(x07), .b(new_n43_), .c(x04), .O(new_n48_));
  ...
  nand3  g19(.a(x08), .b(new_n43_), .c(x04), .O(new_n54_));
  ...
  nand4  g47(.a(new_n81_), .b(new_n76_), .c(new_n72_), .d(new_n71_), .O(new_n82_));
  inv1   g48(.a(new_n82_), .O(new_n83_));
  nand3  g49(.a(new_n83_), .b(new_n80_), .c(new_n44_), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n79_), .c(new_n64_), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand2  g52(.a(new_n82_), .b(new_n86_), .O(new_n87_));
  nand3  g53(.a(new_n87_), .b(new_n80_), .c(new_n44_), .O(new_n88_));
  nand3  g54(.a(new_n47_), .b(x14), .c(x04), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(z10));
  inv1   g56(.a(x16), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(x02), .c(new_n58_), .O(new_n92_));
  and2   g58(.a(new_n92_), .b(x04), .O(z12));
  aoi21  g59(.a(new_n44_), .b(new_n43_), .c(new_n92_), .O(new_n94_));
  oai21  g60(.a(new_n94_), .b(new_n40_), .c(new_n43_), .O(z13));
