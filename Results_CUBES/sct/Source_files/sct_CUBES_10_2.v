// Benchmark "FAU" written by ABC on Mon Jul  6 14:33:56 2020
...
module FAU ( 
  ...
  nand2  g14(.a(new_n43_), .b(x06), .O(new_n49_));
  aoi21  g15(.a(new_n49_), .b(new_n48_), .c(new_n40_), .O(z03));
  nand2  g16(.a(x07), .b(x06), .O(new_n51_));
  xnor2a g17(.a(new_n51_), .b(x08), .O(new_n52_));
  nand2  g18(.a(new_n52_), .b(new_n44_), .O(new_n53_));
  nand2  g19(.a(new_n43_), .b(x08), .O(new_n54_));
  aoi21  g20(.a(new_n54_), .b(new_n53_), .c(new_n40_), .O(z04));
  ...
  nand4  g38(.a(new_n66_), .b(new_n72_), .c(new_n71_), .d(new_n61_), .O(new_n73_));
  nand3  g39(.a(new_n73_), .b(new_n70_), .c(new_n64_), .O(z07));
  nand2  g40(.a(new_n73_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand4  g42(.a(new_n67_), .b(new_n66_), .c(new_n76_), .d(new_n72_), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(z08));
  nand3  g44(.a(new_n72_), .b(new_n58_), .c(x02), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n76_), .c(new_n71_), .d(new_n61_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nor2   g48(.a(new_n43_), .b(x02), .O(new_n83_));
  aoi21  g49(.a(new_n82_), .b(new_n66_), .c(new_n83_), .O(new_n84_));
  ...
  inv1   g53(.a(new_n62_), .O(new_n88_));
  inv1   g54(.a(x00), .O(new_n89_));
  nand2  g55(.a(new_n72_), .b(new_n71_), .O(new_n90_));
  nand2  g56(.a(new_n80_), .b(new_n76_), .O(new_n91_));
  oai21  g57(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n88_), .c(new_n44_), .O(new_n93_));
  nand2  g59(.a(new_n45_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(z10));
  nor2   g61(.a(new_n83_), .b(x03), .O(new_n96_));
