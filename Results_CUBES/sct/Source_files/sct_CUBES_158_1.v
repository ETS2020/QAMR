...
module FAU ( 
  ...
  inv1   g54(.a(new_n82_), .O(new_n89_));
  nor2   g55(.a(new_n89_), .b(x00), .O(new_n90_));
  nand2  g56(.a(x08), .b(x07), .O(new_n91_));
  nor2   g57(.a(new_n91_), .b(x09), .O(new_n92_));
  nand4  g58(.a(new_n92_), .b(new_n47_), .c(x06), .d(x04), .O(new_n93_));
  nand2  g59(.a(new_n45_), .b(x14), .O(new_n94_));
  oai21  g60(.a(new_n93_), .b(new_n90_), .c(new_n94_), .O(z10));
  nor2   g61(.a(new_n84_), .b(x03), .O(new_n96_));
