// Benchmark "FAU" written by ABC on Mon Jul  6 14:35:01 2020
...
module FAU ( 
  ...
  aoi21  g32(.a(new_n64_), .b(x09), .c(new_n66_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n63_), .O(z05));
  nor2   g34(.a(x10), .b(x09), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n54_), .c(x08), .O(new_n70_));
  nand2  g36(.a(new_n70_), .b(new_n61_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(x04), .O(new_n72_));
  aoi21  g38(.a(new_n60_), .b(x10), .c(new_n66_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n72_), .O(z06));
  inv1   g40(.a(x11), .O(new_n75_));
  inv1   g41(.a(new_n64_), .O(new_n76_));
  nand3  g42(.a(new_n69_), .b(new_n76_), .c(new_n75_), .O(new_n77_));
  and2   g43(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  ...
  nand2  g47(.a(new_n81_), .b(new_n69_), .O(new_n82_));
  oai21  g48(.a(new_n82_), .b(new_n64_), .c(new_n61_), .O(new_n83_));
  nand2  g49(.a(new_n83_), .b(x04), .O(new_n84_));
  aoi21  g50(.a(new_n77_), .b(x12), .c(new_n66_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n84_), .O(z08));
  nor2   g52(.a(new_n51_), .b(new_n53_), .O(new_n87_));
  nor3   g53(.a(x12), .b(x11), .c(x10), .O(new_n88_));
  nand3  g54(.a(new_n59_), .b(x08), .c(x07), .O(new_n89_));
  oai22  g55(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n45_), .O(new_n90_));
  nand2  g56(.a(x13), .b(x09), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n61_), .O(new_n92_));
  aoi21  g58(.a(new_n90_), .b(x06), .c(new_n92_), .O(new_n93_));
  nand2  g59(.a(x13), .b(new_n52_), .O(new_n94_));
  nand4  g60(.a(new_n94_), .b(new_n93_), .c(new_n65_), .d(x04), .O(z09));
  nand2  g61(.a(x06), .b(x00), .O(new_n96_));
  nor2   g62(.a(new_n96_), .b(new_n89_), .O(new_n97_));
  ...
  aoi21  g66(.a(new_n61_), .b(new_n43_), .c(new_n40_), .O(z12));
  nand2  g67(.a(new_n87_), .b(x06), .O(new_n102_));
  nand2  g68(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand4  g69(.a(new_n91_), .b(new_n61_), .c(new_n60_), .d(new_n43_), .O(new_n104_));
  inv1   g70(.a(new_n104_), .O(new_n105_));
  aoi21  g71(.a(new_n105_), .b(new_n103_), .c(new_n40_), .O(z13));
