...
module FAU ( 
  ...
  nand2  g21(.a(new_n49_), .b(x08), .O(new_n56_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n64_), .c(new_n52_), .d(x08), .O(new_n65_));
  nand3  g31(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(z06));
  nand2  g32(.a(new_n53_), .b(x04), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  nand2  g34(.a(new_n68_), .b(x11), .O(new_n69_));
  nor3   g35(.a(x11), .b(x10), .c(x09), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n49_), .c(x08), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n62_), .O(z07));
  inv1   g38(.a(x12), .O(new_n73_));
  aoi21  g39(.a(new_n53_), .b(x04), .c(x11), .O(new_n74_));
  oai21  g40(.a(x11), .b(new_n64_), .c(x04), .O(new_n75_));
  aoi21  g41(.a(new_n61_), .b(x16), .c(new_n75_), .O(new_n76_));
  oai21  g42(.a(new_n74_), .b(new_n73_), .c(new_n76_), .O(z08));
  nand2  g43(.a(new_n61_), .b(x16), .O(new_n78_));
  ...
  nand4  g48(.a(new_n82_), .b(new_n43_), .c(x06), .d(x00), .O(new_n83_));
  nand2  g49(.a(new_n44_), .b(x14), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n83_), .c(new_n40_), .O(z10));
  aoi21  g51(.a(new_n54_), .b(new_n60_), .c(new_n40_), .O(z12));
  nor2   g52(.a(x12), .b(x11), .O(new_n87_));
  aoi21  g53(.a(new_n87_), .b(new_n53_), .c(new_n40_), .O(z13));
