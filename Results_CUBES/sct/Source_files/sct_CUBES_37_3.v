...
module FAU ( 
  ...
  aoi21  g13(.a(new_n47_), .b(new_n44_), .c(new_n40_), .O(z02));
  nand2  g14(.a(new_n47_), .b(new_n44_), .O(new_n49_));
  ...
  aoi21  g22(.a(new_n56_), .b(new_n55_), .c(new_n40_), .O(z04));
  ...
  nand4  g34(.a(new_n68_), .b(new_n65_), .c(new_n61_), .d(x04), .O(z06));
  nand2  g35(.a(new_n68_), .b(x11), .O(new_n70_));
  inv1   g36(.a(x10), .O(new_n71_));
  inv1   g37(.a(x11), .O(new_n72_));
  nand4  g38(.a(new_n66_), .b(new_n72_), .c(new_n71_), .d(new_n62_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n70_), .c(new_n61_), .d(x04), .O(z07));
  nand2  g40(.a(new_n73_), .b(x12), .O(new_n75_));
  nor2   g41(.a(x12), .b(x11), .O(new_n76_));
  nand3  g42(.a(new_n76_), .b(new_n67_), .c(new_n66_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n61_), .d(x04), .O(z08));
  inv1   g44(.a(x12), .O(new_n79_));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n79_), .c(new_n72_), .d(new_n71_), .O(new_n81_));
  ...
  oai21  g50(.a(new_n46_), .b(new_n43_), .c(x04), .O(new_n85_));
  ...
  nand2  g57(.a(new_n43_), .b(x02), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(x16), .c(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n91_), .c(new_n40_), .O(z10));
  aoi21  g60(.a(new_n82_), .b(new_n43_), .c(new_n40_), .O(z12));
