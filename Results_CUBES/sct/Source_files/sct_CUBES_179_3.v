...
module FAU ( 
  ...
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n71_), .O(new_n77_));
  nand4  g43(.a(x13), .b(new_n71_), .c(new_n70_), .d(new_n58_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(new_n84_));
  oai21  g50(.a(new_n84_), .b(new_n54_), .c(x13), .O(new_n85_));
  nand4  g51(.a(new_n85_), .b(new_n83_), .c(new_n76_), .d(x04), .O(z09));
  inv1   g52(.a(new_n73_), .O(new_n87_));
  nor2   g53(.a(new_n59_), .b(new_n45_), .O(new_n88_));
  oai21  g54(.a(new_n87_), .b(x00), .c(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n45_), .b(x14), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n40_), .O(z10));
  nor2   g57(.a(new_n75_), .b(x03), .O(new_n92_));
