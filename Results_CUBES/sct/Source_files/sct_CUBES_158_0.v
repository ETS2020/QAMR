...
module FAU ( 
  ...
  aoi21  g19(.a(x14), .b(new_n40_), .c(x02), .O(new_n54_));
  oai21  g20(.a(new_n54_), .b(x03), .c(x16), .O(new_n55_));
  ...
  aoi21  g29(.a(new_n59_), .b(x10), .c(new_n40_), .O(new_n64_));
  nand3  g30(.a(new_n64_), .b(new_n63_), .c(new_n55_), .O(z06));
  nand2  g31(.a(new_n63_), .b(x11), .O(new_n66_));
  inv1   g32(.a(x10), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n61_), .b(new_n68_), .c(new_n67_), .d(new_n58_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n66_), .c(new_n55_), .d(x04), .O(z07));
  nand2  g36(.a(new_n69_), .b(x12), .O(new_n71_));
  inv1   g37(.a(x12), .O(new_n72_));
  nand4  g38(.a(new_n62_), .b(new_n61_), .c(new_n72_), .d(new_n68_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n55_), .d(x04), .O(z08));
  nand2  g40(.a(new_n73_), .b(x13), .O(new_n75_));
  and2   g41(.a(x06), .b(x04), .O(new_n76_));
  ...
  nand4  g45(.a(new_n79_), .b(new_n78_), .c(new_n76_), .d(new_n47_), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n55_), .d(x04), .O(z09));
  inv1   g47(.a(new_n59_), .O(new_n82_));
  inv1   g48(.a(x00), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n72_), .c(new_n68_), .d(new_n67_), .O(new_n85_));
  nand2  g51(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand3  g52(.a(new_n86_), .b(new_n82_), .c(new_n47_), .O(new_n87_));
  nand2  g53(.a(new_n45_), .b(x14), .O(new_n88_));
  aoi21  g54(.a(new_n88_), .b(new_n87_), .c(new_n40_), .O(z10));
  inv1   g55(.a(x14), .O(new_n90_));
  nor2   g56(.a(new_n90_), .b(x04), .O(new_n91_));
  nand2  g57(.a(x16), .b(new_n35_), .O(new_n92_));
  oai22  g58(.a(new_n92_), .b(new_n91_), .c(new_n40_), .d(new_n43_), .O(z12));
