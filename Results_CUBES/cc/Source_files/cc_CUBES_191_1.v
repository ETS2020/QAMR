// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:14 2020
...
module FAU ( 
  ...
  and2   g28(.a(x08), .b(x03), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n46_), .c(x12), .d(x10), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n69_), .O(z15));
