// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:24 2020
...
module FAU ( 
  ...
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n58_), .O(z12));
  aoi21  g22(.a(new_n45_), .b(new_n47_), .c(new_n58_), .O(z13));
  nand2  g23(.a(new_n43_), .b(x15), .O(new_n65_));
  nand3  g24(.a(new_n61_), .b(x08), .c(x02), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z14));
  nand2  g26(.a(x08), .b(x03), .O(new_n68_));
  nand2  g27(.a(x16), .b(x15), .O(new_n69_));
  oai21  g28(.a(new_n68_), .b(x15), .c(new_n69_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x10), .O(new_n71_));
  nand3  g30(.a(new_n43_), .b(x16), .c(new_n47_), .O(new_n72_));
  ...
  nand2  g41(.a(new_n49_), .b(x20), .O(new_n83_));
  nand3  g42(.a(new_n61_), .b(x08), .c(x07), .O(new_n84_));
