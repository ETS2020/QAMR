// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:22 2020
...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(new_n62_), .c(new_n57_), .O(z13));
  nand2  g23(.a(new_n51_), .b(x15), .O(new_n65_));
  nand4  g24(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n57_), .O(z14));
  nand3  g26(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n68_));
  nand4  g27(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(z15));
  nand2  g29(.a(new_n47_), .b(x17), .O(new_n71_));
  nand4  g30(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z16));
  nand2  g32(.a(new_n47_), .b(x18), .O(new_n74_));
  nand2  g33(.a(x08), .b(x05), .O(new_n75_));
  nand3  g34(.a(new_n46_), .b(x12), .c(x10), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(z17));
  nand2  g36(.a(new_n47_), .b(x19), .O(new_n78_));
  nand4  g37(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n57_), .O(z18));
  nand2  g39(.a(new_n47_), .b(x20), .O(new_n81_));
  nand4  g40(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n57_), .O(z19));
  buf    g42(.a(x19), .O(z05));
  buf    g43(.a(x15), .O(z06));
  buf    g44(.a(x17), .O(z07));
  buf    g45(.a(x16), .O(z08));
