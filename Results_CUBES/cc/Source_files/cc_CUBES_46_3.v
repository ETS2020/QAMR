// Benchmark "FAU" written by ABC on Mon Jul  6 13:08:11 2020
...
module FAU ( 
  ...
  inv1   g27(.a(new_n47_), .O(new_n69_));
  nand3  g28(.a(x16), .b(new_n43_), .c(x12), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(z15));
