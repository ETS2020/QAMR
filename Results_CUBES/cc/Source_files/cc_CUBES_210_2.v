...
module FAU ( 
  ...
  nand2  g21(.a(z04), .b(x14), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n45_), .c(x15), .O(new_n64_));
  inv1   g23(.a(x01), .O(new_n65_));
  oai21  g24(.a(new_n44_), .b(new_n65_), .c(x14), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n64_), .c(new_n53_), .O(z13));
  nand2  g26(.a(new_n44_), .b(x15), .O(new_n68_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x02), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n53_), .O(z14));
  nand3  g29(.a(new_n49_), .b(x16), .c(new_n43_), .O(new_n71_));
  ...
  nand2  g36(.a(x18), .b(x15), .O(new_n78_));
  ...
  nand2  g41(.a(new_n49_), .b(x19), .O(new_n83_));
  nand3  g42(.a(new_n60_), .b(x08), .c(x06), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n53_), .O(z18));
  nand2  g44(.a(new_n49_), .b(x20), .O(new_n86_));
  nand3  g45(.a(new_n60_), .b(x08), .c(x07), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n53_), .O(z19));
  buf    g47(.a(x19), .O(z05));
  buf    g48(.a(x15), .O(z06));
  buf    g49(.a(x17), .O(z07));
  buf    g50(.a(x16), .O(z08));
