// Benchmark "FAU" written by ABC on Mon Jul  6 13:08:07 2020
...
module FAU ( 
  ...
  nand2  g31(.a(x08), .b(x04), .O(new_n73_));
  nand3  g32(.a(new_n46_), .b(x12), .c(x10), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(z16));
