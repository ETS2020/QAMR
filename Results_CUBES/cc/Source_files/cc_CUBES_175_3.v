// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:08 2020
...
module FAU ( 
  ...
  nand2  g30(.a(x08), .b(x04), .O(new_n72_));
  nand3  g31(.a(new_n46_), .b(x12), .c(x10), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z16));
