...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    new_n52_, new_n56_, new_n58_, new_n59_, new_n60_, new_n62_, new_n63_,
  ...
  nor2   g14(.a(z04), .b(x14), .O(new_n56_));
  oai21  g15(.a(new_n56_), .b(x08), .c(x09), .O(z10));
  inv1   g16(.a(x12), .O(new_n58_));
  nand2  g17(.a(new_n47_), .b(x13), .O(new_n59_));
  ...
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n58_), .O(z19));
  buf    g43(.a(x19), .O(z05));
  buf    g44(.a(x15), .O(z06));
  buf    g45(.a(x17), .O(z07));
  buf    g46(.a(x16), .O(z08));
