// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:40 2020
...
module FAU ( 
  ...
  nor2   g36(.a(new_n77_), .b(x05), .O(new_n78_));
  nand2  g37(.a(x18), .b(x12), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n76_), .c(new_n79_), .O(z17));
  nand2  g39(.a(new_n47_), .b(x19), .O(new_n81_));
  nand4  g40(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n57_), .O(z18));
  nand2  g42(.a(new_n47_), .b(x20), .O(new_n84_));
  nand4  g43(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n57_), .O(z19));
  buf    g45(.a(x19), .O(z05));
  buf    g46(.a(x15), .O(z06));
  buf    g47(.a(x17), .O(z07));
  buf    g48(.a(x16), .O(z08));
