...
module FAU ( 
  ...
  or2    g22(.a(x17), .b(x13), .O(new_n64_));
  ...
  nand2  g36(.a(x17), .b(x15), .O(new_n78_));
  oai21  g37(.a(x15), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  nand2  g39(.a(new_n44_), .b(x17), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n53_), .O(z16));
  nand2  g41(.a(new_n49_), .b(x18), .O(new_n83_));
  nand3  g42(.a(new_n71_), .b(x08), .c(x05), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n53_), .O(z17));
  nand2  g44(.a(new_n49_), .b(x19), .O(new_n86_));
  nand3  g45(.a(new_n71_), .b(x08), .c(x06), .O(new_n87_));
