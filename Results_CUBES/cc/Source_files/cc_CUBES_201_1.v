...
module FAU ( 
  ...
  nand3  g24(.a(new_n65_), .b(new_n45_), .c(x15), .O(new_n66_));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n70_), .c(new_n53_), .O(z14));
  nand3  g33(.a(new_n49_), .b(x16), .c(new_n43_), .O(new_n75_));
  nand3  g34(.a(new_n72_), .b(x08), .c(x03), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n53_), .O(z15));
  nand2  g36(.a(new_n49_), .b(x17), .O(new_n78_));
