// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:03 2020
...
module FAU ( 
  ...
  nand2  g20(.a(new_n43_), .b(new_n61_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(x15), .c(x08), .O(new_n63_));
  ...
  oai21  g37(.a(new_n51_), .b(x06), .c(x19), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n63_), .c(new_n57_), .O(z18));
