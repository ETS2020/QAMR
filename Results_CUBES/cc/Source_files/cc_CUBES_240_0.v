...
module FAU ( 
  ...
  nand2  g40(.a(new_n60_), .b(x07), .O(new_n82_));
  inv1   g41(.a(x08), .O(new_n83_));
  nand2  g42(.a(new_n48_), .b(x10), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(x20), .c(new_n83_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n53_), .O(z19));
  buf    g45(.a(x19), .O(z05));
  buf    g46(.a(x15), .O(z06));
  buf    g47(.a(x17), .O(z07));
  buf    g48(.a(x16), .O(z08));
