...
module FAU ( 
  ...
  nand3  g65(.a(new_n111_), .b(new_n73_), .c(new_n51_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(x24), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n110_), .O(z14));
  ...
  nand4  g77(.a(new_n123_), .b(new_n111_), .c(new_n91_), .d(new_n73_), .O(new_n124_));
  ...
  nand4  g86(.a(new_n132_), .b(new_n111_), .c(new_n91_), .d(new_n73_), .O(new_n133_));
  ...
  nand4  g91(.a(new_n137_), .b(new_n132_), .c(new_n111_), .d(new_n91_), .O(new_n138_));
