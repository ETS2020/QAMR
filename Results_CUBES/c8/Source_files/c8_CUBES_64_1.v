// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:00 2020
...
module FAU ( 
  ...
  nand4  g71(.a(new_n117_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n118_));
  ...
  oai21  g75(.a(new_n119_), .b(x25), .c(x16), .O(new_n122_));
  ...
  nand2  g79(.a(new_n125_), .b(new_n122_), .O(z15));
  ...
  nand4  g84(.a(new_n69_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n131_));
  inv1   g85(.a(new_n131_), .O(new_n132_));
  aoi22  g86(.a(new_n132_), .b(new_n94_), .c(new_n118_), .d(x26), .O(new_n133_));
  oai21  g87(.a(new_n133_), .b(new_n87_), .c(new_n130_), .O(z16));
  nor2   g88(.a(x21), .b(x20), .O(new_n135_));
  nor2   g89(.a(x23), .b(x22), .O(new_n136_));
  nor3   g90(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nor2   g91(.a(new_n48_), .b(x17), .O(new_n138_));
  nand4  g92(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  nand2  g93(.a(x27), .b(x17), .O(new_n140_));
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n87_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
