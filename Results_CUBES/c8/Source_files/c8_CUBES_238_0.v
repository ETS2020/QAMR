...
module FAU ( 
  ...
  nor2   g007(.a(new_n47_), .b(x10), .O(z02));
  ...
  nand4  g045(.a(new_n91_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n92_));
  ...
  nand3  g060(.a(new_n100_), .b(new_n72_), .c(new_n51_), .O(new_n107_));
  ...
  aoi21  g068(.a(new_n108_), .b(new_n82_), .c(new_n61_), .O(new_n115_));
  nor2   g069(.a(x24), .b(x23), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n100_), .c(new_n72_), .d(new_n51_), .O(new_n117_));
