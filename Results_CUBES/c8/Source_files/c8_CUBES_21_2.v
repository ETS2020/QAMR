// Benchmark "FAU" written by ABC on Mon Jul  6 13:20:40 2020
...
module FAU ( 
  ...
  aoi22  g54(.a(new_n100_), .b(new_n84_), .c(new_n93_), .d(x22), .O(new_n101_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n100_), .c(new_n74_), .d(new_n51_), .O(new_n116_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n94_), .c(new_n116_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n87_), .c(new_n122_), .O(z15));
  ...
  nand4  g85(.a(new_n124_), .b(new_n123_), .c(new_n92_), .d(new_n72_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x26), .O(new_n133_));
  nor2   g87(.a(x20), .b(x17), .O(new_n134_));
  nor2   g88(.a(x26), .b(x25), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n115_), .d(new_n100_), .O(new_n136_));
  nand3  g90(.a(new_n136_), .b(new_n133_), .c(new_n48_), .O(new_n137_));
