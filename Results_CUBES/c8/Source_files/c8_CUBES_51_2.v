// Benchmark "FAU" written by ABC on Mon Jul  6 13:20:54 2020
...
module FAU ( 
  ...
  nand2  g45(.a(new_n74_), .b(new_n51_), .O(new_n92_));
  nand4  g46(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  aoi21  g48(.a(new_n92_), .b(x21), .c(new_n94_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n87_), .c(new_n91_), .O(z11));
  inv1   g50(.a(x11), .O(new_n97_));
  nand2  g51(.a(x18), .b(x03), .O(new_n98_));
  oai21  g52(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nor2   g54(.a(x22), .b(x21), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n84_), .c(new_n93_), .d(x22), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n87_), .c(new_n100_), .O(z12));
  inv1   g57(.a(x12), .O(new_n104_));
  nand2  g58(.a(x18), .b(x04), .O(new_n105_));
  oai21  g59(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  nand3  g61(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n84_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n87_), .c(new_n107_), .O(z13));
  inv1   g65(.a(x13), .O(new_n112_));
  nand2  g66(.a(x18), .b(x05), .O(new_n113_));
  oai21  g67(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n87_), .O(new_n115_));
  aoi21  g69(.a(new_n109_), .b(new_n84_), .c(new_n63_), .O(new_n116_));
  nand3  g70(.a(new_n101_), .b(new_n63_), .c(new_n60_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n116_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n115_), .O(z14));
  inv1   g74(.a(x14), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  oai21  g76(.a(x18), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  nor2   g78(.a(x25), .b(x24), .O(new_n125_));
  nand2  g79(.a(new_n125_), .b(new_n60_), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n57_), .c(new_n93_), .O(new_n127_));
  nor3   g81(.a(x24), .b(x23), .c(x21), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n84_), .c(new_n66_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n127_), .c(x16), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n124_), .O(z15));
  inv1   g85(.a(x15), .O(new_n132_));
  nand2  g86(.a(x18), .b(x07), .O(new_n133_));
  oai21  g87(.a(x18), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n87_), .O(new_n135_));
  nor2   g89(.a(x23), .b(x21), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n125_), .c(new_n74_), .d(new_n51_), .O(new_n137_));
  nand4  g91(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n138_));
  inv1   g92(.a(new_n138_), .O(new_n139_));
  aoi22  g93(.a(new_n139_), .b(new_n94_), .c(new_n137_), .d(x26), .O(new_n140_));
  oai21  g94(.a(new_n140_), .b(new_n87_), .c(new_n135_), .O(z16));
  nor2   g95(.a(x21), .b(x20), .O(new_n142_));
  nand4  g96(.a(new_n139_), .b(new_n142_), .c(x19), .d(new_n72_), .O(new_n143_));
  nand2  g97(.a(x27), .b(x17), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n87_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
