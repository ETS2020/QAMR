// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:39 2020
...
module FAU ( 
  ...
  oai21  g25(.a(new_n48_), .b(x17), .c(x16), .O(new_n72_));
  ...
  nor2   g30(.a(new_n51_), .b(new_n48_), .O(new_n77_));
  nor2   g31(.a(x20), .b(x19), .O(new_n78_));
  ...
  nor3   g41(.a(x21), .b(x20), .c(x19), .O(new_n88_));
  ...
  nand2  g50(.a(new_n96_), .b(new_n48_), .O(new_n97_));
  nand4  g51(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n48_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x22), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n91_), .c(new_n95_), .O(z12));
  ...
  nand2  g59(.a(new_n98_), .b(x23), .O(new_n106_));
  nor2   g60(.a(x23), .b(x22), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n78_), .c(new_n54_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n91_), .c(new_n105_), .O(z13));
  inv1   g64(.a(x13), .O(new_n111_));
  nand2  g65(.a(x18), .b(x05), .O(new_n112_));
  oai21  g66(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n91_), .O(new_n114_));
  nor3   g68(.a(x24), .b(x23), .c(x22), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n88_), .c(new_n108_), .d(x24), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n91_), .c(new_n114_), .O(z14));
  inv1   g71(.a(x14), .O(new_n118_));
  nand2  g72(.a(x18), .b(x06), .O(new_n119_));
  oai21  g73(.a(x18), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n91_), .O(new_n121_));
  aoi21  g75(.a(new_n115_), .b(new_n88_), .c(new_n66_), .O(new_n122_));
  nor2   g76(.a(x25), .b(x24), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n107_), .c(new_n96_), .d(new_n48_), .O(new_n124_));
  ...
  nand2  g84(.a(new_n130_), .b(new_n91_), .O(new_n131_));
  nand4  g85(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n132_));
  inv1   g86(.a(new_n132_), .O(new_n133_));
  aoi22  g87(.a(new_n133_), .b(new_n99_), .c(new_n124_), .d(x26), .O(new_n134_));
  oai21  g88(.a(new_n134_), .b(new_n91_), .c(new_n131_), .O(z16));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  inv1   g90(.a(x17), .O(new_n137_));
  nand3  g91(.a(new_n63_), .b(x19), .c(new_n137_), .O(new_n138_));
  inv1   g92(.a(new_n138_), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n136_), .c(new_n107_), .d(new_n96_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n91_), .O(z17));
  buf    g96(.a(x27), .O(z08));
endmodule
