...
module FAU ( 
  ...
  nor2   g37(.a(new_n74_), .b(new_n51_), .O(new_n84_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n99_));
  nand3  g53(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n99_), .c(x16), .O(new_n102_));
  oai21  g56(.a(new_n98_), .b(x16), .c(new_n102_), .O(z12));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n83_), .c(new_n100_), .d(x23), .O(new_n109_));
  ...
  nand3  g68(.a(new_n63_), .b(new_n60_), .c(new_n57_), .O(new_n115_));
  aoi21  g69(.a(new_n115_), .b(new_n54_), .c(new_n92_), .O(new_n116_));
  nor2   g70(.a(x23), .b(x22), .O(new_n117_));
  aoi21  g71(.a(new_n117_), .b(new_n83_), .c(new_n63_), .O(new_n118_));
  ...
  aoi21  g79(.a(new_n125_), .b(new_n83_), .c(new_n66_), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n117_), .c(new_n74_), .d(new_n51_), .O(new_n128_));
  ...
  nand4  g91(.a(new_n57_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n138_));
  inv1   g92(.a(new_n138_), .O(new_n139_));
  aoi22  g93(.a(new_n139_), .b(new_n137_), .c(new_n128_), .d(x26), .O(new_n140_));
  oai21  g94(.a(new_n140_), .b(new_n87_), .c(new_n135_), .O(z16));
  nor2   g95(.a(x22), .b(x20), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n137_), .c(x19), .d(new_n72_), .O(new_n143_));
