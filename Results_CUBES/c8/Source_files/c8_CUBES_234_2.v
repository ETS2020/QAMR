...
module FAU ( 
  ...
  nor3   g43(.a(x21), .b(x20), .c(x17), .O(new_n90_));
  nor2   g44(.a(x20), .b(x17), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n54_), .c(new_n48_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  oai21  g47(.a(new_n89_), .b(x16), .c(new_n93_), .O(z11));
  ...
  nand2  g52(.a(new_n91_), .b(new_n54_), .O(new_n99_));
  nand4  g53(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x22), .c(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n80_), .c(new_n98_), .O(z12));
  inv1   g57(.a(x12), .O(new_n104_));
  nand2  g58(.a(x18), .b(x04), .O(new_n105_));
  oai21  g59(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n80_), .O(new_n107_));
  nor2   g61(.a(x23), .b(x22), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n90_), .c(new_n100_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n80_), .c(new_n107_), .O(z13));
  inv1   g64(.a(x13), .O(new_n111_));
  nand2  g65(.a(x18), .b(x05), .O(new_n112_));
  oai21  g66(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n80_), .O(new_n114_));
  nand3  g68(.a(new_n108_), .b(new_n91_), .c(new_n54_), .O(new_n115_));
  nor3   g69(.a(x24), .b(x23), .c(x22), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n90_), .c(new_n115_), .d(x24), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n80_), .c(new_n114_), .O(z14));
  inv1   g72(.a(x14), .O(new_n119_));
  nand2  g73(.a(x18), .b(x06), .O(new_n120_));
  oai21  g74(.a(x18), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  aoi21  g76(.a(new_n116_), .b(new_n90_), .c(new_n66_), .O(new_n123_));
  nor2   g77(.a(x25), .b(x24), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n108_), .c(new_n91_), .d(new_n54_), .O(new_n125_));
  ...
  nand2  g85(.a(new_n131_), .b(new_n80_), .O(new_n132_));
  nand4  g86(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n133_));
  inv1   g87(.a(new_n133_), .O(new_n134_));
  aoi22  g88(.a(new_n134_), .b(new_n101_), .c(new_n125_), .d(x26), .O(new_n135_));
  oai21  g89(.a(new_n135_), .b(new_n80_), .c(new_n132_), .O(z16));
