...
module FAU ( 
  ...
  nand2  g90(.a(new_n66_), .b(new_n63_), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n117_), .d(new_n74_), .O(new_n138_));
  oai21  g92(.a(new_n109_), .b(new_n84_), .c(x26), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(new_n140_));
