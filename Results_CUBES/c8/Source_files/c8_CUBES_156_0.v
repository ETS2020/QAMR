// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:43 2020
...
module FAU ( 
  ...
  nand3  g44(.a(new_n51_), .b(new_n48_), .c(new_n72_), .O(new_n91_));
  ...
  aoi22  g53(.a(new_n99_), .b(new_n74_), .c(new_n98_), .d(x22), .O(new_n100_));
  ...
  nor2   g60(.a(new_n106_), .b(new_n91_), .O(new_n107_));
  aoi21  g61(.a(new_n74_), .b(new_n51_), .c(new_n60_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n107_), .c(x16), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n105_), .O(z13));
  ...
  oai21  g68(.a(new_n63_), .b(new_n87_), .c(new_n114_), .O(z14));
  inv1   g69(.a(x14), .O(new_n116_));
  nand2  g70(.a(x18), .b(x06), .O(new_n117_));
  oai21  g71(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  oai21  g73(.a(new_n66_), .b(new_n87_), .c(new_n119_), .O(z15));
  ...
  oai21  g78(.a(new_n69_), .b(new_n87_), .c(new_n124_), .O(z16));
  nand3  g79(.a(x27), .b(x17), .c(x16), .O(new_n126_));
