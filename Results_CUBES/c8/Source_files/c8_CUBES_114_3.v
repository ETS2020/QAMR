// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:24 2020
...
module FAU ( 
  ...
  nand2  g74(.a(new_n69_), .b(x24), .O(new_n121_));
  nor3   g75(.a(x25), .b(x23), .c(x22), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n91_), .d(new_n73_), .O(new_n123_));
  nand2  g77(.a(new_n114_), .b(x25), .O(new_n124_));
  ...
  nand2  g84(.a(new_n130_), .b(new_n86_), .O(new_n131_));
  nor2   g85(.a(x25), .b(x23), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(x26), .O(new_n134_));
  nor2   g88(.a(x26), .b(x24), .O(new_n135_));
  nand4  g89(.a(new_n122_), .b(new_n135_), .c(new_n91_), .d(new_n73_), .O(new_n136_));
  ...
  nand4  g94(.a(new_n140_), .b(new_n122_), .c(new_n135_), .d(new_n91_), .O(new_n141_));
