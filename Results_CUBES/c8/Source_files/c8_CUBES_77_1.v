// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:06 2020
...
module FAU ( 
  ...
  nand2  g03(.a(new_n48_), .b(new_n49_), .O(new_n50_));
  oai21  g04(.a(new_n48_), .b(x09), .c(new_n50_), .O(z01));
  ...
  nand2  g15(.a(new_n48_), .b(new_n61_), .O(new_n62_));
  oai21  g16(.a(new_n48_), .b(x13), .c(new_n62_), .O(z05));
