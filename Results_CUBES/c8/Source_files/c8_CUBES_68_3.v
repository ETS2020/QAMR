...
module FAU ( 
  ...
  aoi22  g055(.a(new_n101_), .b(new_n84_), .c(new_n92_), .d(x22), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n96_), .c(new_n100_), .O(z12));
  ...
  oai21  g064(.a(new_n110_), .b(new_n96_), .c(new_n107_), .O(z13));
  ...
  oai21  g082(.a(new_n128_), .b(new_n96_), .c(new_n125_), .O(z15));
  ...
  nor2   g097(.a(x22), .b(new_n48_), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n138_), .c(new_n117_), .d(new_n90_), .O(new_n145_));
  nand2  g099(.a(x27), .b(x17), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n145_), .c(new_n96_), .O(z17));
