// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:26 2020
...
module FAU ( 
  ...
  nand2  g36(.a(new_n75_), .b(new_n51_), .O(new_n83_));
  ...
  nand2  g46(.a(new_n92_), .b(new_n75_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  aoi21  g48(.a(new_n83_), .b(x21), .c(new_n94_), .O(new_n95_));
  ...
  nor2   g62(.a(new_n108_), .b(new_n83_), .O(new_n109_));
  aoi21  g63(.a(new_n101_), .b(new_n75_), .c(new_n60_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n92_), .c(new_n75_), .d(new_n57_), .O(new_n118_));
  oai21  g72(.a(new_n108_), .b(new_n83_), .c(x24), .O(new_n119_));
  ...
  nand2  g79(.a(new_n125_), .b(new_n87_), .O(new_n126_));
  nor2   g80(.a(x22), .b(x21), .O(new_n127_));
  nand4  g81(.a(new_n117_), .b(new_n127_), .c(new_n75_), .d(new_n51_), .O(new_n128_));
  nand4  g82(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n129_));
  inv1   g83(.a(new_n129_), .O(new_n130_));
  aoi22  g84(.a(new_n130_), .b(new_n94_), .c(new_n128_), .d(x25), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n87_), .c(new_n126_), .O(z15));
  inv1   g86(.a(x15), .O(new_n133_));
  nand2  g87(.a(x18), .b(x07), .O(new_n134_));
  oai21  g88(.a(x18), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n87_), .O(new_n136_));
  nor3   g90(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n138_));
  nor2   g92(.a(new_n75_), .b(new_n69_), .O(new_n139_));
  aoi21  g93(.a(new_n138_), .b(new_n75_), .c(new_n139_), .O(new_n140_));
  oai21  g94(.a(new_n140_), .b(new_n87_), .c(new_n136_), .O(z16));
