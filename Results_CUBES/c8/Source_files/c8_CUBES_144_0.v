...
module FAU ( 
  ...
  aoi22  g055(.a(new_n101_), .b(new_n75_), .c(new_n93_), .d(x22), .O(new_n102_));
  ...
  nand3  g061(.a(new_n60_), .b(new_n57_), .c(new_n54_), .O(new_n108_));
  nor2   g062(.a(new_n108_), .b(new_n83_), .O(new_n109_));
  aoi21  g063(.a(new_n101_), .b(new_n75_), .c(new_n60_), .O(new_n110_));
  ...
  nand4  g071(.a(new_n117_), .b(new_n92_), .c(new_n75_), .d(new_n57_), .O(new_n118_));
  oai21  g072(.a(new_n108_), .b(new_n83_), .c(x24), .O(new_n119_));
  ...
  nand4  g081(.a(new_n117_), .b(new_n127_), .c(new_n75_), .d(new_n51_), .O(new_n128_));
  nand4  g082(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  aoi22  g084(.a(new_n130_), .b(new_n94_), .c(new_n128_), .d(x25), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n87_), .c(new_n126_), .O(z15));
  inv1   g086(.a(x15), .O(new_n133_));
  nand2  g087(.a(x18), .b(x07), .O(new_n134_));
  oai21  g088(.a(x18), .b(new_n133_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n87_), .O(new_n136_));
  nor3   g090(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n138_));
  nor2   g092(.a(new_n75_), .b(new_n69_), .O(new_n139_));
  aoi21  g093(.a(new_n138_), .b(new_n75_), .c(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n87_), .c(new_n136_), .O(z16));
  nor2   g095(.a(x20), .b(x17), .O(new_n142_));
  nor2   g096(.a(x26), .b(x25), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n117_), .d(new_n127_), .O(new_n144_));
