// Benchmark "FAU" written by ABC on Mon Jul  6 13:22:15 2020
...
module FAU ( 
  ...
  aoi22  g47(.a(new_n93_), .b(new_n74_), .c(new_n92_), .d(x21), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n87_), .c(new_n91_), .O(z11));
  inv1   g49(.a(x11), .O(new_n96_));
  nand2  g50(.a(x18), .b(x03), .O(new_n97_));
  oai21  g51(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n87_), .O(new_n99_));
  nand2  g53(.a(new_n93_), .b(new_n74_), .O(new_n100_));
  nor2   g54(.a(x22), .b(x21), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n84_), .c(new_n100_), .d(x22), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n87_), .c(new_n99_), .O(z12));
  ...
  nand4  g70(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n117_));
  ...
  nor3   g78(.a(x21), .b(x20), .c(x17), .O(new_n125_));
  nor3   g79(.a(x24), .b(x23), .c(x22), .O(new_n126_));
  aoi21  g80(.a(new_n126_), .b(new_n125_), .c(new_n66_), .O(new_n127_));
  nor2   g81(.a(x23), .b(x22), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n93_), .d(new_n72_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n48_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n124_), .O(z15));
  inv1   g87(.a(x15), .O(new_n134_));
  nand2  g88(.a(x18), .b(x07), .O(new_n135_));
  oai21  g89(.a(x18), .b(new_n134_), .c(new_n135_), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  inv1   g91(.a(new_n117_), .O(new_n138_));
  nand4  g92(.a(new_n69_), .b(new_n66_), .c(new_n51_), .d(new_n72_), .O(new_n139_));
  inv1   g93(.a(new_n139_), .O(new_n140_));
  aoi22  g94(.a(new_n140_), .b(new_n138_), .c(new_n130_), .d(x26), .O(new_n141_));
  oai21  g95(.a(new_n141_), .b(new_n87_), .c(new_n137_), .O(z16));
