...
module FAU ( 
  ...
  nand2  g044(.a(new_n74_), .b(new_n51_), .O(new_n91_));
  nor2   g045(.a(x21), .b(x20), .O(new_n92_));
  aoi22  g046(.a(new_n92_), .b(new_n74_), .c(new_n91_), .d(x21), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n87_), .c(new_n90_), .O(z11));
  nand2  g048(.a(x18), .b(x03), .O(new_n95_));
  oai21  g049(.a(x18), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  nand2  g051(.a(new_n92_), .b(new_n74_), .O(new_n98_));
  nor2   g052(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g053(.a(new_n99_), .b(new_n84_), .c(new_n98_), .d(x22), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n87_), .c(new_n97_), .O(z12));
  ...
  nand3  g058(.a(new_n99_), .b(new_n74_), .c(new_n51_), .O(new_n105_));
  nor3   g059(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g060(.a(new_n106_), .b(new_n84_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n87_), .c(new_n104_), .O(z13));
  inv1   g062(.a(x13), .O(new_n109_));
  nand2  g063(.a(x18), .b(x05), .O(new_n110_));
  oai21  g064(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  aoi21  g066(.a(new_n106_), .b(new_n84_), .c(new_n63_), .O(new_n113_));
  nor2   g067(.a(x24), .b(x23), .O(new_n114_));
  nand4  g068(.a(new_n114_), .b(new_n99_), .c(new_n74_), .d(new_n51_), .O(new_n115_));
  ...
  nand2  g075(.a(new_n69_), .b(x19), .O(new_n122_));
  nor3   g076(.a(x25), .b(x24), .c(x23), .O(new_n123_));
  nor2   g077(.a(x20), .b(x17), .O(new_n124_));
  nand4  g078(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n99_), .O(new_n125_));
  nand2  g079(.a(new_n115_), .b(x25), .O(new_n126_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n92_), .d(new_n72_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x26), .O(new_n137_));
  nor3   g091(.a(x26), .b(x25), .c(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n134_), .c(new_n92_), .d(new_n74_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n133_), .O(z16));
  nor2   g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n135_), .c(new_n134_), .d(new_n92_), .O(new_n144_));
