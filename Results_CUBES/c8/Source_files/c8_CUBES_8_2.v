// Benchmark "FAU" written by ABC on Mon Jul  6 13:20:34 2020
...
module FAU ( 
  ...
  oai21  g057(.a(new_n95_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n101_), .O(z12));
  ...
  aoi22  g065(.a(new_n111_), .b(new_n84_), .c(new_n103_), .d(x23), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n87_), .c(new_n110_), .O(z13));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n84_), .c(new_n63_), .O(new_n118_));
  nor2   g072(.a(x24), .b(x23), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n102_), .c(new_n74_), .d(new_n51_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n60_), .c(new_n57_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n95_), .c(new_n120_), .d(x25), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n87_), .c(new_n126_), .O(z15));
  ...
  nand2  g089(.a(new_n135_), .b(new_n63_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n60_), .O(new_n137_));
  nand2  g091(.a(new_n48_), .b(new_n72_), .O(new_n138_));
  nand3  g092(.a(new_n57_), .b(new_n54_), .c(new_n51_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand4  g094(.a(new_n127_), .b(new_n102_), .c(new_n74_), .d(new_n51_), .O(new_n141_));
  aoi22  g095(.a(new_n141_), .b(x26), .c(new_n140_), .d(new_n137_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n134_), .O(z16));
  nor2   g097(.a(new_n48_), .b(x17), .O(new_n144_));
  nor2   g098(.a(x24), .b(x22), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n135_), .d(new_n93_), .O(new_n146_));
