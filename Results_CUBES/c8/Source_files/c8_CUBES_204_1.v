...
module FAU ( 
  ...
  oai21  g70(.a(new_n112_), .b(new_n87_), .c(new_n116_), .O(z14));
  ...
  aoi21  g75(.a(new_n109_), .b(new_n84_), .c(new_n66_), .O(new_n122_));
  nor2   g76(.a(x25), .b(x23), .O(new_n123_));
  ...
  nand4  g85(.a(new_n69_), .b(new_n66_), .c(new_n60_), .d(new_n57_), .O(new_n132_));
  ...
  nand3  g92(.a(new_n63_), .b(x19), .c(new_n72_), .O(new_n139_));
  inv1   g93(.a(new_n139_), .O(new_n140_));
  nand4  g94(.a(new_n140_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n141_));
