// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:55 2020
...
module FAU ( 
  ...
  nor2   g33(.a(new_n71_), .b(new_n51_), .O(new_n80_));
  ...
  nand2  g41(.a(new_n71_), .b(new_n51_), .O(new_n88_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n71_), .c(new_n51_), .O(new_n102_));
  ...
  aoi21  g64(.a(new_n103_), .b(new_n81_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n113_));
  ...
  oai21  g71(.a(x18), .b(new_n64_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  nand2  g73(.a(new_n113_), .b(x25), .O(new_n120_));
  nor2   g74(.a(x23), .b(x22), .O(new_n121_));
  nor2   g75(.a(x25), .b(x24), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n121_), .c(new_n89_), .d(new_n71_), .O(new_n123_));
  ...
  oai21  g81(.a(x18), .b(new_n67_), .c(new_n127_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand2  g83(.a(new_n123_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n121_), .c(new_n89_), .d(new_n71_), .O(new_n132_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n131_), .c(new_n121_), .d(new_n89_), .O(new_n137_));
