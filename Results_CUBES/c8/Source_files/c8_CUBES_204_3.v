// Benchmark "FAU" written by ABC on Mon Jul  6 13:22:06 2020
...
module FAU ( 
  ...
  and2   g025(.a(x19), .b(x17), .O(new_n72_));
  ...
  nor2   g035(.a(new_n73_), .b(new_n51_), .O(new_n82_));
  ...
  nor2   g044(.a(new_n83_), .b(new_n54_), .O(new_n91_));
  nor2   g045(.a(x21), .b(x20), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n73_), .O(new_n93_));
  inv1   g047(.a(new_n93_), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n91_), .c(x16), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n90_), .O(z11));
  ...
  aoi22  g054(.a(new_n100_), .b(new_n83_), .c(new_n93_), .d(x22), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n100_), .c(new_n60_), .O(new_n108_));
  aoi21  g062(.a(new_n63_), .b(x19), .c(new_n108_), .O(new_n109_));
  aoi21  g063(.a(new_n100_), .b(new_n83_), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n107_), .c(new_n54_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x24), .O(new_n119_));
  nor2   g073(.a(x24), .b(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n121_));
  ...
  nand4  g083(.a(new_n129_), .b(new_n117_), .c(new_n92_), .d(new_n73_), .O(new_n130_));
  ...
  nand2  g090(.a(new_n130_), .b(x26), .O(new_n137_));
  nor2   g091(.a(x26), .b(x25), .O(new_n138_));
  nor3   g092(.a(x24), .b(x23), .c(x22), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n92_), .d(new_n73_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n138_), .c(new_n117_), .d(new_n92_), .O(new_n145_));
  nand2  g099(.a(x27), .b(x17), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n145_), .c(new_n86_), .O(z17));
