// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:28 2020
...
module FAU ( 
  ...
  nand2  g046(.a(new_n57_), .b(x19), .O(new_n93_));
  nor3   g047(.a(x21), .b(x20), .c(x17), .O(new_n94_));
  aoi22  g048(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(x21), .O(new_n95_));
  ...
  aoi21  g054(.a(new_n100_), .b(new_n72_), .c(new_n57_), .O(new_n101_));
  ...
  oai21  g059(.a(new_n99_), .b(x16), .c(new_n105_), .O(z12));
  ...
  nand4  g072(.a(new_n118_), .b(new_n102_), .c(new_n74_), .d(new_n51_), .O(new_n119_));
  ...
  nand2  g079(.a(new_n119_), .b(x25), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nor2   g081(.a(x25), .b(x24), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n127_), .c(new_n100_), .d(new_n74_), .O(new_n129_));
  ...
  nand2  g089(.a(new_n129_), .b(x26), .O(new_n136_));
  nor2   g090(.a(x26), .b(x25), .O(new_n137_));
  nor3   g091(.a(x24), .b(x23), .c(x22), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n100_), .d(new_n74_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n135_), .O(z16));
  nor2   g096(.a(new_n48_), .b(x17), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n137_), .c(new_n118_), .d(new_n100_), .O(new_n144_));
