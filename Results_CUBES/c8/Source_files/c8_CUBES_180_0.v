...
module FAU ( 
  ...
  nor2   g016(.a(new_n47_), .b(x13), .O(z05));
  ...
  nand2  g043(.a(new_n72_), .b(new_n51_), .O(new_n90_));
  nand4  g044(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n91_));
  inv1   g045(.a(new_n91_), .O(new_n92_));
  aoi21  g046(.a(new_n90_), .b(x21), .c(new_n92_), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n85_), .c(new_n89_), .O(z11));
  ...
  aoi22  g053(.a(new_n99_), .b(new_n82_), .c(new_n91_), .d(x22), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n85_), .c(new_n98_), .O(z12));
  ...
  nand3  g059(.a(new_n99_), .b(new_n72_), .c(new_n51_), .O(new_n106_));
  nor3   g060(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g061(.a(new_n107_), .b(new_n82_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n85_), .c(new_n105_), .O(z13));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n82_), .c(new_n114_), .O(new_n115_));
  nor2   g069(.a(x24), .b(x23), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n117_));
  ...
  nand4  g078(.a(new_n64_), .b(new_n114_), .c(new_n60_), .d(new_n57_), .O(new_n125_));
  inv1   g079(.a(new_n125_), .O(new_n126_));
  aoi22  g080(.a(new_n126_), .b(new_n92_), .c(new_n117_), .d(x25), .O(new_n127_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n72_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(x26), .O(new_n136_));
  nor2   g090(.a(x26), .b(x25), .O(new_n137_));
  nor3   g091(.a(x24), .b(x23), .c(x22), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n132_), .d(new_n72_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n137_), .c(new_n116_), .d(new_n99_), .O(new_n144_));
