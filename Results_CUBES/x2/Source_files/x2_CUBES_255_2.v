...
module FAU ( 
  ...
  nand2  g24(.a(x7), .b(new_n29_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(new_n24_), .c(new_n27_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(x2), .c(new_n30_), .O(new_n44_));
  inv1   g27(.a(x6), .O(new_n45_));
  inv1   g28(.a(new_n24_), .O(new_n46_));
  ...
  aoi21  g33(.a(new_n32_), .b(x8), .c(new_n18_), .O(new_n51_));
  ...
  oai21  g37(.a(new_n24_), .b(new_n47_), .c(new_n22_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n20_), .c(new_n45_), .O(new_n56_));
