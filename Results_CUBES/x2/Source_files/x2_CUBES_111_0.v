...
module FAU ( 
  ...
  nand3  g23(.a(new_n40_), .b(new_n29_), .c(x2), .O(new_n41_));
  inv1   g24(.a(x6), .O(new_n42_));
  inv1   g25(.a(x5), .O(new_n43_));
  nor2   g26(.a(x7), .b(new_n43_), .O(new_n44_));
  aoi21  g27(.a(new_n44_), .b(new_n30_), .c(new_n42_), .O(new_n45_));
  ...
  nand2  g32(.a(x9), .b(new_n26_), .O(new_n50_));
  ...
  aoi21  g37(.a(new_n54_), .b(new_n29_), .c(new_n42_), .O(new_n55_));
