...
module FAU ( 
  ...
  nand2  g22(.a(x7), .b(new_n39_), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(new_n24_), .c(new_n27_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(x2), .c(new_n38_), .O(new_n42_));
  inv1   g25(.a(x6), .O(new_n43_));
  inv1   g26(.a(new_n24_), .O(new_n44_));
  inv1   g27(.a(x5), .O(new_n45_));
  nor2   g28(.a(x7), .b(new_n45_), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n44_), .c(new_n43_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n42_), .c(new_n37_), .O(z5));
  ...
  oai21  g37(.a(new_n24_), .b(new_n45_), .c(new_n22_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n20_), .c(new_n43_), .O(new_n56_));
