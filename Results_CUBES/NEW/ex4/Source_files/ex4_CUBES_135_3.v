// Benchmark "FAU" written by ABC on Tue Jul  7 07:45:20 2020
...
module FAU ( 
  ...
  oai21  g261(.a(new_n408_), .b(x093), .c(new_n229_), .O(new_n419_));
  ...
  nand4  g265(.a(x125), .b(new_n262_), .c(new_n243_), .d(x013), .O(new_n423_));
