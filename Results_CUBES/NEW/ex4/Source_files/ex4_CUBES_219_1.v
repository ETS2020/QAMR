// Benchmark "FAU" written by ABC on Tue Jul  7 07:46:58 2020
...
module FAU ( 
  ...
  nor2   g084(.a(new_n230_), .b(new_n235_), .O(new_n241_));
  ...
  nor2   g138(.a(new_n284_), .b(new_n289_), .O(new_n295_));
  ...
  inv1   g175(.a(x104), .O(new_n333_));
  inv1   g176(.a(x112), .O(new_n334_));
  nand2  g177(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  inv1   g178(.a(x056), .O(new_n336_));
  inv1   g179(.a(x088), .O(new_n337_));
  oai21  g180(.a(new_n337_), .b(new_n336_), .c(x024), .O(new_n338_));
  aoi21  g181(.a(new_n338_), .b(new_n158_), .c(x072), .O(new_n339_));
  oai21  g182(.a(new_n339_), .b(x008), .c(new_n335_), .O(new_n340_));
  nand2  g183(.a(new_n337_), .b(new_n336_), .O(new_n341_));
  aoi21  g184(.a(x024), .b(new_n158_), .c(new_n341_), .O(new_n342_));
  nor2   g185(.a(new_n342_), .b(new_n159_), .O(new_n343_));
  ...
  nor2   g191(.a(new_n348_), .b(new_n338_), .O(new_n349_));
  oai21  g192(.a(new_n349_), .b(new_n343_), .c(new_n163_), .O(new_n350_));
  aoi21  g193(.a(new_n350_), .b(new_n340_), .c(x048), .O(new_n351_));
  aoi21  g194(.a(new_n344_), .b(x024), .c(new_n341_), .O(new_n352_));
  nor3   g195(.a(new_n352_), .b(x072), .c(new_n161_), .O(new_n353_));
  oai21  g196(.a(new_n353_), .b(new_n351_), .c(new_n332_), .O(new_n354_));
  nand2  g197(.a(x064), .b(x032), .O(new_n355_));
  aoi21  g198(.a(new_n355_), .b(new_n335_), .c(x080), .O(new_n356_));
  nor2   g199(.a(x088), .b(x064), .O(new_n357_));
  nor2   g200(.a(x112), .b(x016), .O(new_n358_));
  aoi22  g201(.a(new_n358_), .b(x120), .c(new_n357_), .d(new_n347_), .O(new_n359_));
  oai21  g202(.a(new_n341_), .b(x024), .c(new_n344_), .O(new_n360_));
  oai22  g203(.a(new_n346_), .b(new_n337_), .c(new_n345_), .d(x032), .O(new_n361_));
  nand2  g204(.a(new_n361_), .b(new_n336_), .O(new_n362_));
  nand4  g205(.a(new_n362_), .b(new_n360_), .c(new_n359_), .d(new_n356_), .O(new_n363_));
  nand4  g206(.a(x120), .b(new_n333_), .c(x032), .d(new_n160_), .O(new_n364_));
  ...
  oai21  g210(.a(new_n366_), .b(x072), .c(new_n367_), .O(new_n368_));
  ...
  aoi21  g215(.a(new_n368_), .b(x000), .c(new_n372_), .O(new_n373_));
  ...
  nand2  g246(.a(new_n240_), .b(new_n403_), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(new_n246_), .O(new_n405_));
  ...
  oai21  g251(.a(new_n263_), .b(x029), .c(new_n408_), .O(new_n409_));
  nor2   g252(.a(x117), .b(x021), .O(new_n410_));
  aoi21  g253(.a(new_n410_), .b(x125), .c(x085), .O(new_n411_));
  oai21  g254(.a(new_n240_), .b(x109), .c(x037), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(x117), .O(new_n413_));
  oai21  g256(.a(new_n403_), .b(x093), .c(new_n229_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n243_), .O(new_n415_));
  nand4  g258(.a(new_n415_), .b(new_n413_), .c(new_n411_), .d(new_n409_), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(new_n407_), .c(new_n259_), .O(new_n417_));
  nand4  g260(.a(x125), .b(new_n262_), .c(new_n243_), .d(x013), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n417_), .c(x053), .O(new_n419_));
  nand3  g262(.a(x085), .b(new_n243_), .c(new_n234_), .O(new_n420_));
  inv1   g263(.a(new_n420_), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n419_), .c(x005), .O(new_n422_));
  nand2  g265(.a(new_n237_), .b(x029), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n235_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n259_), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n234_), .c(new_n406_), .O(new_n426_));
  nor2   g269(.a(new_n233_), .b(x021), .O(new_n427_));
  oai21  g270(.a(new_n427_), .b(new_n263_), .c(x069), .O(new_n428_));
  nand4  g271(.a(new_n408_), .b(new_n404_), .c(new_n237_), .d(x029), .O(new_n429_));
  aoi21  g272(.a(new_n429_), .b(new_n428_), .c(x077), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n426_), .c(new_n225_), .O(new_n431_));
  nand2  g274(.a(new_n408_), .b(x029), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n255_), .O(new_n433_));
  nand3  g276(.a(new_n433_), .b(new_n259_), .c(x037), .O(new_n434_));
  ...
  aoi21  g282(.a(new_n435_), .b(new_n239_), .c(new_n439_), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n422_), .c(x045), .O(z13));
  inv1   g284(.a(x102), .O(new_n442_));
  nand2  g285(.a(new_n294_), .b(new_n442_), .O(new_n443_));
  ...
  oai21  g290(.a(new_n317_), .b(x030), .c(new_n447_), .O(new_n448_));
  nor2   g291(.a(x118), .b(x022), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(x126), .c(x086), .O(new_n450_));
  oai21  g293(.a(new_n294_), .b(x110), .c(x038), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(x118), .O(new_n452_));
  oai21  g295(.a(new_n442_), .b(x062), .c(new_n283_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n297_), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n452_), .c(new_n450_), .d(new_n448_), .O(new_n455_));
  oai21  g298(.a(new_n455_), .b(new_n446_), .c(new_n313_), .O(new_n456_));
  nand4  g299(.a(x126), .b(new_n300_), .c(new_n297_), .d(x014), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n456_), .c(x054), .O(new_n458_));
  nand3  g301(.a(x086), .b(new_n297_), .c(new_n288_), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n458_), .c(x006), .O(new_n461_));
  nand2  g304(.a(new_n291_), .b(x030), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n289_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n313_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n288_), .c(new_n445_), .O(new_n465_));
  nor2   g308(.a(new_n287_), .b(x022), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n317_), .c(x070), .O(new_n467_));
  nand4  g310(.a(new_n447_), .b(new_n443_), .c(new_n291_), .d(x030), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n467_), .c(x078), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n465_), .c(new_n279_), .O(new_n470_));
  nand2  g313(.a(new_n447_), .b(x030), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n309_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n313_), .c(x038), .O(new_n473_));
  ...
  aoi21  g321(.a(new_n474_), .b(new_n293_), .c(new_n478_), .O(new_n479_));
