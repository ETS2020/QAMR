// Benchmark "FAU" written by ABC on Tue Jul  7 07:44:14 2020
...
module FAU ( 
  ...
  nand4  g094(.a(new_n240_), .b(x093), .c(x037), .d(new_n234_), .O(new_n251_));
  ...
  nand2  g106(.a(new_n246_), .b(new_n262_), .O(new_n263_));
