...
module FAU ( 
  ...
  oai21  g250(.a(x125), .b(x101), .c(new_n246_), .O(new_n408_));
  ...
  oai21  g260(.a(new_n417_), .b(x093), .c(new_n229_), .O(new_n418_));
  ...
  nand4  g264(.a(x125), .b(new_n262_), .c(new_n243_), .d(x013), .O(new_n422_));
