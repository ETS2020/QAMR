// Benchmark "FAU" written by ABC on Tue Jul  7 07:43:02 2020
...
module FAU ( 
  ...
  nand4  g095(.a(new_n239_), .b(x093), .c(x037), .d(new_n233_), .O(new_n252_));
  ...
  nand2  g109(.a(new_n247_), .b(new_n265_), .O(new_n266_));
  ...
  nand2  g257(.a(new_n414_), .b(new_n247_), .O(new_n415_));
  ...
  nand4  g270(.a(x125), .b(new_n265_), .c(new_n243_), .d(x013), .O(new_n428_));
