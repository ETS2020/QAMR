// Benchmark "FAU" written by ABC on Wed Jul  8 07:06:40 2020
...
module FAU ( 
  ...
  xor2a  g000(.a(x66), .b(x65), .O(new_n92_));
  ...
  nand4  g040(.a(new_n131_), .b(x66), .c(x65), .d(x48), .O(new_n132_));
  ...
  nor2   g065(.a(x67), .b(new_n144_), .O(new_n157_));
  ...
  nand2  g069(.a(new_n144_), .b(x48), .O(new_n161_));
  nand2  g070(.a(new_n157_), .b(x32), .O(new_n162_));
  ...
  nand3  g115(.a(new_n131_), .b(x66), .c(x65), .O(new_n207_));
  ...
  nand4  g900(.a(new_n991_), .b(new_n988_), .c(x69), .d(x66), .O(new_n992_));
