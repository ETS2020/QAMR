// Benchmark "FAU" written by ABC on Mon Jul  6 14:00:22 2020
...
module FAU ( 
  ...
  aoi21  g090(.a(new_n141_), .b(new_n140_), .c(new_n99_), .O(new_n142_));
  ...
  nor2   g105(.a(new_n99_), .b(new_n86_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n143_), .c(x17), .O(z02));
  inv1   g108(.a(new_n137_), .O(new_n160_));
  nand3  g109(.a(x09), .b(x08), .c(new_n52_), .O(new_n161_));
  oai21  g110(.a(new_n160_), .b(x09), .c(new_n161_), .O(new_n162_));
  nor2   g111(.a(new_n99_), .b(x17), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  inv1   g113(.a(x17), .O(new_n165_));
  nor2   g114(.a(x18), .b(new_n165_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n72_), .c(new_n52_), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n164_), .c(x15), .O(new_n168_));
  nand2  g117(.a(new_n69_), .b(x17), .O(new_n169_));
  ...
  nand2  g122(.a(new_n157_), .b(new_n165_), .O(new_n174_));
  nand2  g123(.a(new_n166_), .b(new_n52_), .O(new_n175_));
  oai21  g124(.a(new_n174_), .b(new_n173_), .c(new_n175_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n72_), .c(x07), .O(new_n177_));
  ...
  nand3  g135(.a(new_n144_), .b(new_n186_), .c(new_n87_), .O(new_n187_));
  oai22  g136(.a(new_n187_), .b(new_n185_), .c(new_n182_), .d(x08), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n80_), .O(new_n189_));
  nand3  g138(.a(new_n81_), .b(x21), .c(new_n73_), .O(new_n190_));
  nor2   g139(.a(new_n87_), .b(x10), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n144_), .c(x08), .d(new_n80_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n190_), .c(new_n75_), .O(new_n193_));
  nand3  g142(.a(new_n74_), .b(x21), .c(new_n86_), .O(new_n194_));
  nand3  g143(.a(new_n144_), .b(x16), .c(new_n87_), .O(new_n195_));
  ...
  nand4  g148(.a(new_n199_), .b(new_n198_), .c(new_n151_), .d(x18), .O(new_n200_));
  aoi21  g149(.a(new_n197_), .b(new_n189_), .c(new_n200_), .O(z05));
  inv1   g150(.a(new_n163_), .O(new_n202_));
  nor2   g151(.a(new_n74_), .b(new_n87_), .O(new_n203_));
  nor2   g152(.a(new_n203_), .b(new_n84_), .O(new_n204_));
  nand2  g153(.a(new_n191_), .b(x02), .O(new_n205_));
  nand3  g154(.a(new_n184_), .b(new_n186_), .c(new_n87_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n205_), .c(x06), .O(new_n207_));
  nor2   g156(.a(x21), .b(new_n86_), .O(new_n208_));
  oai21  g157(.a(new_n207_), .b(new_n204_), .c(new_n208_), .O(new_n209_));
  nand3  g158(.a(x21), .b(new_n86_), .c(new_n80_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(x12), .c(new_n62_), .O(new_n211_));
  aoi21  g160(.a(new_n196_), .b(x06), .c(new_n211_), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n209_), .c(x14), .O(new_n213_));
  nand3  g162(.a(new_n65_), .b(new_n80_), .c(x04), .O(new_n214_));
  inv1   g163(.a(new_n214_), .O(new_n215_));
  aoi21  g164(.a(new_n74_), .b(x06), .c(new_n215_), .O(new_n216_));
  nor3   g165(.a(new_n216_), .b(x21), .c(x08), .O(new_n217_));
  oai21  g166(.a(new_n217_), .b(new_n213_), .c(new_n54_), .O(new_n218_));
  aoi21  g167(.a(new_n218_), .b(new_n94_), .c(new_n202_), .O(new_n219_));
  nand3  g168(.a(new_n166_), .b(x15), .c(x00), .O(new_n220_));
  inv1   g169(.a(new_n220_), .O(new_n221_));
  oai21  g170(.a(new_n221_), .b(new_n219_), .c(new_n53_), .O(new_n222_));
  nand3  g171(.a(new_n166_), .b(new_n54_), .c(x07), .O(new_n223_));
  nand2  g172(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nand2  g173(.a(new_n224_), .b(new_n52_), .O(new_n225_));
  nand3  g174(.a(new_n144_), .b(x18), .c(new_n165_), .O(new_n226_));
  inv1   g175(.a(new_n226_), .O(new_n227_));
  nor2   g176(.a(x15), .b(x12), .O(new_n228_));
  nor2   g177(.a(new_n52_), .b(new_n62_), .O(new_n229_));
  nand4  g178(.a(new_n229_), .b(new_n228_), .c(new_n227_), .d(new_n106_), .O(new_n230_));
  aoi21  g179(.a(new_n230_), .b(new_n225_), .c(x09), .O(z06));
  inv1   g180(.a(new_n173_), .O(new_n232_));
  xnor2a g181(.a(x08), .b(x07), .O(new_n233_));
  nand3  g182(.a(new_n233_), .b(new_n232_), .c(new_n72_), .O(new_n234_));
  nand4  g183(.a(new_n134_), .b(new_n106_), .c(x16), .d(x09), .O(new_n235_));
  aoi21  g184(.a(new_n235_), .b(new_n234_), .c(new_n202_), .O(z07));
  ...
  nand2  g190(.a(new_n241_), .b(new_n181_), .O(new_n242_));
  ...
  aoi21  g196(.a(new_n247_), .b(new_n183_), .c(new_n240_), .O(new_n248_));
  aoi21  g197(.a(new_n246_), .b(x06), .c(new_n248_), .O(new_n249_));
  oai21  g198(.a(new_n249_), .b(x05), .c(new_n242_), .O(new_n250_));
  nand2  g199(.a(new_n137_), .b(new_n118_), .O(new_n251_));
  inv1   g200(.a(new_n251_), .O(new_n252_));
  aoi21  g201(.a(new_n250_), .b(new_n144_), .c(new_n252_), .O(new_n253_));
  nand3  g202(.a(new_n146_), .b(new_n107_), .c(x08), .O(new_n254_));
  oai21  g203(.a(new_n253_), .b(x09), .c(new_n254_), .O(new_n255_));
  inv1   g204(.a(new_n131_), .O(new_n256_));
  nor2   g205(.a(new_n256_), .b(new_n66_), .O(new_n257_));
  aoi21  g206(.a(new_n255_), .b(new_n53_), .c(new_n257_), .O(new_n258_));
  inv1   g207(.a(new_n145_), .O(new_n259_));
  nand3  g208(.a(new_n154_), .b(new_n259_), .c(new_n76_), .O(new_n260_));
  oai21  g209(.a(new_n259_), .b(new_n52_), .c(new_n260_), .O(new_n261_));
  nand2  g210(.a(new_n261_), .b(new_n106_), .O(new_n262_));
  ...
  nand2  g217(.a(new_n166_), .b(new_n54_), .O(new_n269_));
  inv1   g218(.a(new_n269_), .O(new_n270_));
  nand2  g219(.a(new_n270_), .b(new_n265_), .O(new_n271_));
  oai21  g220(.a(new_n268_), .b(x17), .c(new_n271_), .O(z09));
  inv1   g221(.a(new_n166_), .O(new_n273_));
  nand2  g222(.a(new_n163_), .b(new_n54_), .O(new_n274_));
  oai21  g223(.a(new_n274_), .b(new_n239_), .c(new_n273_), .O(new_n275_));
  nand2  g224(.a(new_n275_), .b(x05), .O(new_n276_));
  inv1   g225(.a(new_n239_), .O(new_n277_));
  nand2  g226(.a(new_n277_), .b(new_n163_), .O(new_n278_));
  oai21  g227(.a(new_n278_), .b(new_n54_), .c(new_n273_), .O(new_n279_));
  nand2  g228(.a(new_n279_), .b(new_n52_), .O(new_n280_));
  aoi21  g229(.a(new_n280_), .b(new_n276_), .c(x07), .O(new_n281_));
  nand3  g230(.a(new_n198_), .b(new_n131_), .c(new_n119_), .O(new_n282_));
  aoi21  g231(.a(new_n282_), .b(new_n175_), .c(new_n53_), .O(new_n283_));
  oai21  g232(.a(new_n283_), .b(new_n281_), .c(new_n72_), .O(new_n284_));
  inv1   g233(.a(new_n151_), .O(new_n285_));
  oai22  g234(.a(new_n285_), .b(new_n72_), .c(new_n149_), .d(new_n52_), .O(new_n286_));
  nand3  g235(.a(new_n286_), .b(new_n198_), .c(new_n157_), .O(new_n287_));
  nand2  g236(.a(new_n287_), .b(new_n284_), .O(z10));
  nand4  g237(.a(new_n165_), .b(new_n72_), .c(x07), .d(new_n52_), .O(new_n289_));
  nor2   g238(.a(new_n289_), .b(new_n117_), .O(z11));
  oai21  g239(.a(new_n77_), .b(new_n80_), .c(new_n214_), .O(new_n291_));
  nand2  g240(.a(new_n291_), .b(new_n86_), .O(new_n292_));
  nand3  g241(.a(new_n204_), .b(new_n237_), .c(x08), .O(new_n293_));
  aoi21  g242(.a(new_n293_), .b(new_n292_), .c(x15), .O(new_n294_));
  nand2  g243(.a(new_n97_), .b(new_n93_), .O(new_n295_));
  inv1   g244(.a(new_n295_), .O(new_n296_));
  oai21  g245(.a(new_n296_), .b(new_n294_), .c(new_n52_), .O(new_n297_));
  nand3  g246(.a(new_n131_), .b(x15), .c(new_n73_), .O(new_n298_));
  nand3  g247(.a(new_n277_), .b(new_n134_), .c(x12), .O(new_n299_));
  aoi21  g248(.a(new_n299_), .b(new_n298_), .c(x04), .O(new_n300_));
  inv1   g249(.a(new_n228_), .O(new_n301_));
  inv1   g250(.a(new_n229_), .O(new_n302_));
  nor3   g251(.a(new_n302_), .b(new_n301_), .c(new_n86_), .O(new_n303_));
  nor2   g252(.a(new_n303_), .b(new_n300_), .O(new_n304_));
  nand2  g253(.a(new_n163_), .b(new_n144_), .O(new_n305_));
  aoi21  g254(.a(new_n304_), .b(new_n297_), .c(new_n305_), .O(new_n306_));
  nor3   g255(.a(new_n175_), .b(new_n54_), .c(new_n58_), .O(new_n307_));
  oai21  g256(.a(new_n307_), .b(new_n306_), .c(new_n53_), .O(new_n308_));
  nor2   g257(.a(new_n53_), .b(x05), .O(new_n309_));
  nand2  g258(.a(new_n309_), .b(new_n270_), .O(new_n310_));
  aoi21  g259(.a(new_n310_), .b(new_n308_), .c(x09), .O(z12));
  inv1   g260(.a(new_n169_), .O(new_n312_));
  ...
  nand3  g268(.a(new_n232_), .b(new_n118_), .c(x07), .O(new_n320_));
  aoi21  g269(.a(new_n320_), .b(new_n319_), .c(new_n315_), .O(new_n321_));
  nor2   g270(.a(x21), .b(x15), .O(new_n322_));
  nand4  g271(.a(new_n322_), .b(new_n66_), .c(new_n237_), .d(x04), .O(new_n323_));
  ...
  oai21  g275(.a(new_n326_), .b(new_n321_), .c(new_n165_), .O(new_n327_));
  aoi21  g276(.a(new_n54_), .b(new_n53_), .c(new_n165_), .O(new_n328_));
  ...
  oai21  g284(.a(new_n191_), .b(new_n181_), .c(x02), .O(new_n336_));
  ...
  nand2  g293(.a(new_n118_), .b(x09), .O(new_n345_));
  ...
  nand3  g300(.a(new_n172_), .b(new_n351_), .c(x09), .O(new_n352_));
  aoi21  g301(.a(new_n352_), .b(new_n350_), .c(new_n174_), .O(z16));
  inv1   g302(.a(new_n223_), .O(new_n354_));
  nand2  g303(.a(new_n180_), .b(new_n80_), .O(new_n355_));
  oai21  g304(.a(new_n126_), .b(new_n75_), .c(new_n355_), .O(new_n356_));
  nor2   g305(.a(x15), .b(x08), .O(new_n357_));
  nand4  g306(.a(new_n357_), .b(new_n356_), .c(new_n163_), .d(new_n79_), .O(new_n358_));
  aoi21  g307(.a(new_n358_), .b(new_n220_), .c(x07), .O(new_n359_));
  oai21  g308(.a(new_n359_), .b(new_n354_), .c(new_n52_), .O(new_n360_));
  nand4  g309(.a(new_n227_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n361_));
  ...
  oai21  g314(.a(new_n365_), .b(new_n187_), .c(new_n363_), .O(new_n366_));
  nand2  g315(.a(new_n366_), .b(new_n80_), .O(new_n367_));
  inv1   g316(.a(new_n195_), .O(new_n368_));
  nand3  g317(.a(new_n364_), .b(new_n368_), .c(x06), .O(new_n369_));
  aoi21  g318(.a(new_n369_), .b(new_n367_), .c(new_n65_), .O(new_n370_));
  oai21  g319(.a(new_n370_), .b(new_n193_), .c(new_n67_), .O(new_n371_));
  nand3  g320(.a(x19), .b(x15), .c(new_n86_), .O(new_n372_));
  nor2   g321(.a(x17), .b(x09), .O(new_n373_));
  nand3  g322(.a(new_n373_), .b(new_n151_), .c(x18), .O(new_n374_));
  aoi21  g323(.a(new_n372_), .b(new_n371_), .c(new_n374_), .O(z18));
  nor2   g324(.a(new_n334_), .b(new_n285_), .O(z19));
  inv1   g325(.a(new_n300_), .O(new_n377_));
  nand2  g326(.a(new_n364_), .b(new_n237_), .O(new_n378_));
  oai21  g327(.a(new_n378_), .b(new_n203_), .c(new_n239_), .O(new_n379_));
  aoi21  g328(.a(new_n379_), .b(new_n52_), .c(new_n131_), .O(new_n380_));
  nand2  g329(.a(new_n181_), .b(new_n54_), .O(new_n381_));
  oai21  g330(.a(new_n381_), .b(new_n380_), .c(new_n377_), .O(new_n382_));
  nor4   g331(.a(new_n239_), .b(new_n182_), .c(new_n135_), .d(x14), .O(new_n383_));
  aoi21  g332(.a(new_n382_), .b(new_n144_), .c(new_n383_), .O(new_n384_));
  nor2   g333(.a(new_n65_), .b(x05), .O(new_n385_));
  nand4  g334(.a(new_n385_), .b(new_n264_), .c(new_n67_), .d(x04), .O(new_n386_));
  oai21  g335(.a(new_n384_), .b(new_n99_), .c(new_n386_), .O(new_n387_));
  nand2  g336(.a(new_n387_), .b(new_n72_), .O(new_n388_));
  nor2   g337(.a(new_n99_), .b(x15), .O(new_n389_));
  nand4  g338(.a(new_n389_), .b(new_n181_), .c(new_n131_), .d(x09), .O(new_n390_));
  nand2  g339(.a(new_n165_), .b(new_n53_), .O(new_n391_));
  aoi21  g340(.a(new_n390_), .b(new_n388_), .c(new_n391_), .O(z20));
  nor2   g341(.a(new_n54_), .b(x09), .O(new_n393_));
  nand2  g342(.a(new_n393_), .b(new_n277_), .O(new_n394_));
  nand4  g343(.a(new_n54_), .b(x09), .c(x08), .d(x06), .O(new_n395_));
  aoi21  g344(.a(new_n395_), .b(new_n394_), .c(x05), .O(new_n396_));
  nor4   g345(.a(new_n160_), .b(x15), .c(x09), .d(new_n80_), .O(new_n397_));
  oai21  g346(.a(new_n397_), .b(new_n396_), .c(new_n53_), .O(new_n398_));
  nand3  g347(.a(new_n393_), .b(new_n309_), .c(x08), .O(new_n399_));
  aoi21  g348(.a(new_n399_), .b(new_n398_), .c(new_n202_), .O(z21));
  nand2  g349(.a(new_n81_), .b(new_n72_), .O(new_n401_));
  nand3  g350(.a(new_n54_), .b(x09), .c(x08), .O(new_n402_));
  oai22  g351(.a(new_n402_), .b(x05), .c(new_n401_), .d(new_n173_), .O(new_n403_));
  nand2  g352(.a(new_n403_), .b(new_n53_), .O(new_n404_));
  nand2  g353(.a(new_n309_), .b(new_n120_), .O(new_n405_));
  aoi21  g354(.a(new_n405_), .b(new_n404_), .c(new_n202_), .O(z22));
  nand3  g355(.a(new_n151_), .b(x09), .c(x08), .O(new_n407_));
  nor2   g356(.a(new_n407_), .b(new_n274_), .O(z23));
  inv1   g357(.a(new_n373_), .O(new_n409_));
  nand3  g358(.a(new_n131_), .b(x18), .c(new_n65_), .O(new_n410_));
  nand3  g359(.a(new_n385_), .b(new_n99_), .c(new_n237_), .O(new_n411_));
  nand2  g360(.a(new_n54_), .b(x04), .O(new_n412_));
  aoi21  g361(.a(new_n411_), .b(new_n410_), .c(new_n412_), .O(new_n413_));
  nand3  g362(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n414_));
  nand2  g363(.a(new_n107_), .b(new_n73_), .O(new_n415_));
  nand2  g364(.a(new_n120_), .b(x18), .O(new_n416_));
  aoi21  g365(.a(new_n415_), .b(new_n414_), .c(new_n416_), .O(new_n417_));
  oai21  g366(.a(new_n417_), .b(new_n413_), .c(new_n144_), .O(new_n418_));
  nand3  g367(.a(new_n389_), .b(new_n86_), .c(new_n52_), .O(new_n419_));
  nand2  g368(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  nand2  g369(.a(new_n420_), .b(new_n53_), .O(new_n421_));
  nand4  g370(.a(new_n309_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n422_));
  aoi21  g371(.a(new_n422_), .b(new_n421_), .c(new_n409_), .O(z24));
  nand2  g372(.a(new_n393_), .b(new_n86_), .O(new_n424_));
  nand2  g373(.a(new_n163_), .b(new_n151_), .O(new_n425_));
  aoi21  g374(.a(new_n424_), .b(new_n402_), .c(new_n425_), .O(z25));
  nor2   g375(.a(new_n89_), .b(x20), .O(z26));
  inv1   g376(.a(new_n76_), .O(new_n428_));
  nand2  g377(.a(new_n134_), .b(new_n81_), .O(new_n429_));
  nor2   g378(.a(new_n429_), .b(new_n428_), .O(new_n430_));
  oai21  g379(.a(new_n430_), .b(new_n300_), .c(new_n144_), .O(new_n431_));
  nand3  g380(.a(new_n137_), .b(x19), .c(new_n54_), .O(new_n432_));
  aoi21  g381(.a(new_n432_), .b(new_n431_), .c(x07), .O(new_n433_));
  nor4   g382(.a(new_n173_), .b(new_n118_), .c(new_n86_), .d(new_n53_), .O(new_n434_));
  oai21  g383(.a(new_n434_), .b(new_n433_), .c(new_n163_), .O(new_n435_));
  nand3  g384(.a(x15), .b(new_n53_), .c(x00), .O(new_n436_));
  oai21  g385(.a(x15), .b(new_n53_), .c(new_n436_), .O(new_n437_));
  nand4  g386(.a(new_n437_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n438_));
  nand2  g387(.a(new_n438_), .b(new_n435_), .O(new_n439_));
  nand2  g388(.a(new_n439_), .b(new_n72_), .O(new_n440_));
  nand2  g389(.a(new_n198_), .b(new_n119_), .O(new_n441_));
  oai21  g390(.a(new_n441_), .b(new_n407_), .c(new_n440_), .O(z27));
  nand3  g391(.a(new_n265_), .b(new_n144_), .c(x11), .O(new_n443_));
  aoi21  g392(.a(new_n443_), .b(new_n72_), .c(x02), .O(new_n444_));
  nand2  g393(.a(x11), .b(new_n53_), .O(new_n445_));
  oai21  g394(.a(new_n445_), .b(new_n444_), .c(x15), .O(new_n446_));
  nand3  g395(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n447_));
  inv1   g396(.a(new_n67_), .O(new_n448_));
  nor2   g397(.a(new_n448_), .b(x21), .O(new_n449_));
  nand4  g398(.a(new_n449_), .b(new_n447_), .c(new_n265_), .d(new_n184_), .O(new_n450_));
  aoi21  g399(.a(new_n450_), .b(new_n446_), .c(x05), .O(new_n451_));
  nand4  g400(.a(new_n259_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n452_));
  nand2  g401(.a(new_n393_), .b(x21), .O(new_n453_));
  aoi21  g402(.a(new_n453_), .b(new_n452_), .c(x07), .O(new_n454_));
  oai21  g403(.a(new_n454_), .b(new_n451_), .c(x08), .O(new_n455_));
  nor3   g404(.a(new_n216_), .b(new_n448_), .c(new_n144_), .O(new_n456_));
  nor2   g405(.a(x19), .b(new_n54_), .O(new_n457_));
  nand3  g406(.a(new_n151_), .b(new_n72_), .c(new_n86_), .O(new_n458_));
  inv1   g407(.a(new_n458_), .O(new_n459_));
  oai21  g408(.a(new_n457_), .b(new_n456_), .c(new_n459_), .O(new_n460_));
  aoi21  g409(.a(new_n460_), .b(new_n455_), .c(new_n99_), .O(new_n461_));
  nand2  g410(.a(new_n393_), .b(new_n99_), .O(new_n462_));
  oai21  g411(.a(new_n73_), .b(new_n75_), .c(new_n309_), .O(new_n463_));
  nor2   g412(.a(new_n463_), .b(new_n462_), .O(new_n464_));
  oai21  g413(.a(new_n464_), .b(new_n461_), .c(new_n165_), .O(new_n465_));
  oai21  g414(.a(new_n118_), .b(new_n53_), .c(new_n154_), .O(new_n466_));
  nand2  g415(.a(new_n466_), .b(new_n333_), .O(new_n467_));
  nand2  g416(.a(new_n467_), .b(new_n312_), .O(new_n468_));
