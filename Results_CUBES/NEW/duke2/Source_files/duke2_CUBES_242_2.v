// Benchmark "FAU" written by ABC on Mon Jul  6 14:00:42 2020
...
module FAU ( 
  ...
  nand2  g194(.a(new_n132_), .b(new_n245_), .O(new_n246_));
  ...
  nand4  g230(.a(new_n158_), .b(new_n72_), .c(x07), .d(new_n52_), .O(new_n282_));
  ...
  nand3  g234(.a(new_n199_), .b(new_n231_), .c(x08), .O(new_n286_));
  ...
  nand3  g239(.a(new_n129_), .b(x15), .c(new_n73_), .O(new_n291_));
  nand3  g240(.a(new_n270_), .b(new_n134_), .c(x12), .O(new_n292_));
  aoi21  g241(.a(new_n292_), .b(new_n291_), .c(x04), .O(new_n293_));
  inv1   g242(.a(new_n223_), .O(new_n294_));
  inv1   g243(.a(new_n224_), .O(new_n295_));
  nor3   g244(.a(new_n295_), .b(new_n294_), .c(new_n86_), .O(new_n296_));
  nor2   g245(.a(new_n296_), .b(new_n293_), .O(new_n297_));
  nand2  g246(.a(new_n167_), .b(new_n142_), .O(new_n298_));
  aoi21  g247(.a(new_n297_), .b(new_n290_), .c(new_n298_), .O(new_n299_));
  nor3   g248(.a(new_n164_), .b(new_n54_), .c(new_n58_), .O(new_n300_));
  oai21  g249(.a(new_n300_), .b(new_n299_), .c(new_n53_), .O(new_n301_));
  nor2   g250(.a(new_n53_), .b(x05), .O(new_n302_));
  nand2  g251(.a(new_n302_), .b(new_n265_), .O(new_n303_));
  aoi21  g252(.a(new_n303_), .b(new_n301_), .c(x09), .O(z12));
  nand2  g253(.a(new_n69_), .b(x17), .O(new_n305_));
  inv1   g254(.a(new_n305_), .O(new_n306_));
  oai21  g255(.a(new_n53_), .b(new_n52_), .c(new_n306_), .O(new_n307_));
  inv1   g256(.a(new_n307_), .O(z13));
  inv1   g257(.a(new_n155_), .O(new_n309_));
  nand3  g258(.a(new_n97_), .b(new_n52_), .c(new_n75_), .O(new_n310_));
  oai21  g259(.a(new_n295_), .b(new_n294_), .c(new_n310_), .O(new_n311_));
  aoi21  g260(.a(x21), .b(new_n72_), .c(x07), .O(new_n312_));
  nand2  g261(.a(new_n312_), .b(new_n311_), .O(new_n313_));
  nand3  g262(.a(new_n161_), .b(new_n245_), .c(x07), .O(new_n314_));
  aoi21  g263(.a(new_n314_), .b(new_n313_), .c(new_n309_), .O(new_n315_));
  nor2   g264(.a(x21), .b(x15), .O(new_n316_));
  nand4  g265(.a(new_n316_), .b(new_n66_), .c(new_n231_), .d(x04), .O(new_n317_));
  ...
  oai21  g269(.a(new_n320_), .b(new_n315_), .c(new_n158_), .O(new_n321_));
  aoi21  g270(.a(new_n54_), .b(new_n53_), .c(new_n158_), .O(new_n322_));
  ...
  oai21  g279(.a(new_n186_), .b(new_n176_), .c(x02), .O(new_n331_));
  nor2   g280(.a(x16), .b(new_n65_), .O(new_n332_));
  oai21  g281(.a(new_n74_), .b(new_n87_), .c(new_n332_), .O(new_n333_));
  aoi21  g282(.a(new_n333_), .b(new_n331_), .c(new_n80_), .O(new_n334_));
  inv1   g283(.a(new_n74_), .O(new_n335_));
  nand3  g284(.a(x16), .b(x12), .c(new_n80_), .O(new_n336_));
  aoi22  g285(.a(new_n336_), .b(new_n84_), .c(new_n335_), .d(x13), .O(new_n337_));
  nor3   g286(.a(x21), .b(x14), .c(x09), .O(new_n338_));
  oai21  g287(.a(new_n337_), .b(new_n334_), .c(new_n338_), .O(new_n339_));
  nand2  g288(.a(new_n245_), .b(x09), .O(new_n340_));
  ...
  nand3  g295(.a(new_n159_), .b(new_n346_), .c(x09), .O(new_n347_));
  aoi21  g296(.a(new_n347_), .b(new_n345_), .c(new_n330_), .O(z16));
  inv1   g297(.a(new_n218_), .O(new_n349_));
  inv1   g298(.a(new_n76_), .O(new_n350_));
  nand2  g299(.a(new_n175_), .b(new_n80_), .O(new_n351_));
  oai21  g300(.a(new_n350_), .b(new_n80_), .c(new_n351_), .O(new_n352_));
  nor2   g301(.a(x15), .b(x08), .O(new_n353_));
  nand4  g302(.a(new_n353_), .b(new_n352_), .c(new_n167_), .d(new_n79_), .O(new_n354_));
  aoi21  g303(.a(new_n354_), .b(new_n215_), .c(x07), .O(new_n355_));
  oai21  g304(.a(new_n355_), .b(new_n349_), .c(new_n52_), .O(new_n356_));
  nand4  g305(.a(new_n222_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n357_));
  ...
  inv1   g322(.a(new_n293_), .O(new_n374_));
  nand2  g323(.a(new_n360_), .b(new_n231_), .O(new_n375_));
  oai21  g324(.a(new_n375_), .b(new_n198_), .c(new_n233_), .O(new_n376_));
  aoi21  g325(.a(new_n376_), .b(new_n52_), .c(new_n129_), .O(new_n377_));
  nand2  g326(.a(new_n176_), .b(new_n54_), .O(new_n378_));
  oai21  g327(.a(new_n378_), .b(new_n377_), .c(new_n374_), .O(new_n379_));
  nor4   g328(.a(new_n233_), .b(new_n177_), .c(new_n135_), .d(x14), .O(new_n380_));
  aoi21  g329(.a(new_n379_), .b(new_n142_), .c(new_n380_), .O(new_n381_));
  nor2   g330(.a(new_n65_), .b(x05), .O(new_n382_));
  nand4  g331(.a(new_n382_), .b(new_n259_), .c(new_n67_), .d(x04), .O(new_n383_));
  ...
  nand4  g335(.a(new_n386_), .b(new_n176_), .c(new_n129_), .d(x09), .O(new_n387_));
  nand2  g336(.a(new_n158_), .b(new_n53_), .O(new_n388_));
  aoi21  g337(.a(new_n387_), .b(new_n385_), .c(new_n388_), .O(z20));
  nor2   g338(.a(new_n54_), .b(x09), .O(new_n390_));
  nand2  g339(.a(new_n390_), .b(new_n270_), .O(new_n391_));
  nand3  g340(.a(new_n171_), .b(x08), .c(x06), .O(new_n392_));
  aoi21  g341(.a(new_n392_), .b(new_n391_), .c(x05), .O(new_n393_));
  inv1   g342(.a(new_n132_), .O(new_n394_));
  nor4   g343(.a(new_n394_), .b(x15), .c(x09), .d(new_n80_), .O(new_n395_));
  oai21  g344(.a(new_n395_), .b(new_n393_), .c(new_n53_), .O(new_n396_));
  nand3  g345(.a(new_n390_), .b(new_n302_), .c(x08), .O(new_n397_));
  aoi21  g346(.a(new_n397_), .b(new_n396_), .c(new_n197_), .O(z21));
  nand2  g347(.a(new_n390_), .b(new_n81_), .O(new_n399_));
  nand2  g348(.a(new_n171_), .b(x08), .O(new_n400_));
  aoi21  g349(.a(new_n400_), .b(new_n399_), .c(x05), .O(new_n401_));
  oai21  g350(.a(new_n401_), .b(new_n395_), .c(new_n53_), .O(new_n402_));
  nand2  g351(.a(new_n302_), .b(new_n119_), .O(new_n403_));
  aoi21  g352(.a(new_n403_), .b(new_n402_), .c(new_n197_), .O(z22));
  nor3   g353(.a(new_n280_), .b(new_n372_), .c(new_n72_), .O(z23));
  inv1   g354(.a(new_n369_), .O(new_n406_));
  nand3  g355(.a(new_n129_), .b(x18), .c(new_n65_), .O(new_n407_));
  nand3  g356(.a(new_n382_), .b(new_n99_), .c(new_n231_), .O(new_n408_));
  ...
  nand2  g360(.a(new_n107_), .b(new_n73_), .O(new_n412_));
  nand2  g361(.a(new_n119_), .b(x18), .O(new_n413_));
  aoi21  g362(.a(new_n412_), .b(new_n411_), .c(new_n413_), .O(new_n414_));
  oai21  g363(.a(new_n414_), .b(new_n410_), .c(new_n142_), .O(new_n415_));
  nand3  g364(.a(new_n386_), .b(new_n86_), .c(new_n52_), .O(new_n416_));
  nand2  g365(.a(new_n416_), .b(new_n415_), .O(new_n417_));
  nand2  g366(.a(new_n417_), .b(new_n53_), .O(new_n418_));
  nand4  g367(.a(new_n302_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n419_));
  aoi21  g368(.a(new_n419_), .b(new_n418_), .c(new_n406_), .O(z24));
  nand2  g369(.a(new_n390_), .b(new_n86_), .O(new_n421_));
  nand2  g370(.a(new_n167_), .b(new_n149_), .O(new_n422_));
  aoi21  g371(.a(new_n421_), .b(new_n400_), .c(new_n422_), .O(z25));
  nor2   g372(.a(new_n89_), .b(x20), .O(z26));
  nand2  g373(.a(new_n134_), .b(new_n81_), .O(new_n425_));
  nor2   g374(.a(new_n425_), .b(new_n350_), .O(new_n426_));
  oai21  g375(.a(new_n426_), .b(new_n293_), .c(new_n142_), .O(new_n427_));
  nand3  g376(.a(new_n132_), .b(x19), .c(new_n54_), .O(new_n428_));
  aoi21  g377(.a(new_n428_), .b(new_n427_), .c(x07), .O(new_n429_));
  nor4   g378(.a(new_n160_), .b(new_n245_), .c(new_n86_), .d(new_n53_), .O(new_n430_));
  oai21  g379(.a(new_n430_), .b(new_n429_), .c(new_n167_), .O(new_n431_));
  ...
  nand4  g387(.a(new_n438_), .b(new_n275_), .c(new_n171_), .d(new_n106_), .O(new_n439_));
  nand2  g388(.a(new_n439_), .b(new_n436_), .O(z27));
  nand3  g389(.a(new_n260_), .b(new_n142_), .c(x11), .O(new_n441_));
  ...
  nand4  g396(.a(new_n447_), .b(new_n445_), .c(new_n260_), .d(new_n179_), .O(new_n448_));
  aoi21  g397(.a(new_n448_), .b(new_n444_), .c(x05), .O(new_n449_));
  nand4  g398(.a(new_n254_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n450_));
  nand2  g399(.a(new_n390_), .b(x21), .O(new_n451_));
  aoi21  g400(.a(new_n451_), .b(new_n450_), .c(x07), .O(new_n452_));
  oai21  g401(.a(new_n452_), .b(new_n449_), .c(x08), .O(new_n453_));
  nor3   g402(.a(new_n211_), .b(new_n446_), .c(new_n142_), .O(new_n454_));
  nor2   g403(.a(x19), .b(new_n54_), .O(new_n455_));
  nand3  g404(.a(new_n149_), .b(new_n72_), .c(new_n86_), .O(new_n456_));
  inv1   g405(.a(new_n456_), .O(new_n457_));
  oai21  g406(.a(new_n455_), .b(new_n454_), .c(new_n457_), .O(new_n458_));
  aoi21  g407(.a(new_n458_), .b(new_n453_), .c(new_n99_), .O(new_n459_));
  nand2  g408(.a(new_n390_), .b(new_n99_), .O(new_n460_));
  oai21  g409(.a(new_n73_), .b(new_n75_), .c(new_n302_), .O(new_n461_));
  nor2   g410(.a(new_n461_), .b(new_n460_), .O(new_n462_));
  oai21  g411(.a(new_n462_), .b(new_n459_), .c(new_n158_), .O(new_n463_));
  oai21  g412(.a(new_n245_), .b(new_n53_), .c(new_n152_), .O(new_n464_));
  nand2  g413(.a(new_n464_), .b(new_n327_), .O(new_n465_));
  nand2  g414(.a(new_n465_), .b(new_n306_), .O(new_n466_));
