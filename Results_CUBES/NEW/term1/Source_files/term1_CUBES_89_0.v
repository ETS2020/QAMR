...
module FAU ( 
  ...
  inv1   g011(.a(x04), .O(new_n56_));
  aoi21  g012(.a(x05), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  inv1   g013(.a(x06), .O(new_n58_));
  oai21  g014(.a(new_n58_), .b(x02), .c(x07), .O(new_n59_));
  inv1   g015(.a(x07), .O(new_n60_));
  nor2   g016(.a(new_n58_), .b(x02), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  aoi21  g018(.a(new_n62_), .b(new_n59_), .c(new_n57_), .O(new_n63_));
  nor2   g019(.a(new_n61_), .b(new_n47_), .O(new_n64_));
  nor2   g020(.a(x06), .b(x05), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(new_n64_), .c(new_n60_), .O(new_n66_));
  nand4  g022(.a(x07), .b(x06), .c(x03), .d(new_n50_), .O(new_n67_));
  aoi21  g023(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(new_n68_));
  oai21  g024(.a(new_n68_), .b(new_n63_), .c(new_n55_), .O(new_n69_));
  xnor2a g025(.a(x07), .b(x02), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(x04), .c(x03), .O(new_n71_));
  nand2  g027(.a(x07), .b(new_n50_), .O(new_n72_));
  nand2  g028(.a(new_n60_), .b(x02), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g030(.a(new_n56_), .b(new_n47_), .c(new_n74_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  nand3  g032(.a(x07), .b(x06), .c(new_n50_), .O(new_n77_));
  ...
  aoi21  g038(.a(new_n80_), .b(new_n69_), .c(new_n82_), .O(z2));
