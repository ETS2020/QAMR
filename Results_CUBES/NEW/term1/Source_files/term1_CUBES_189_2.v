...
module FAU ( 
  ...
  nand2  g048(.a(new_n88_), .b(new_n57_), .O(new_n93_));
  ...
  oai22  g057(.a(new_n101_), .b(new_n98_), .c(new_n100_), .d(new_n97_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n94_), .c(new_n81_), .O(new_n103_));
  ...
  nor2   g063(.a(new_n97_), .b(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n91_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x31), .c(new_n93_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n106_), .c(new_n81_), .O(z7));
  ...
  nand2  g084(.a(x30), .b(new_n107_), .O(new_n129_));
  nand2  g085(.a(z0), .b(x31), .O(new_n130_));
  aoi21  g086(.a(new_n129_), .b(new_n101_), .c(new_n130_), .O(new_n131_));
  oai21  g087(.a(new_n128_), .b(new_n126_), .c(new_n131_), .O(new_n132_));
  nor2   g088(.a(new_n122_), .b(new_n112_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n124_), .O(new_n134_));
  ...
  oai21  g094(.a(new_n135_), .b(new_n138_), .c(new_n113_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n137_), .c(new_n134_), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n123_), .c(new_n112_), .O(new_n142_));
  inv1   g098(.a(x13), .O(new_n143_));
  oai21  g099(.a(new_n116_), .b(new_n143_), .c(new_n114_), .O(new_n144_));
  nor2   g100(.a(new_n108_), .b(new_n105_), .O(new_n145_));
  inv1   g101(.a(x14), .O(new_n146_));
  aoi22  g102(.a(new_n97_), .b(new_n107_), .c(new_n116_), .d(new_n146_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n144_), .d(new_n142_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n140_), .c(x32), .O(new_n149_));
  inv1   g105(.a(x26), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x00), .O(new_n151_));
  aoi21  g107(.a(new_n149_), .b(new_n132_), .c(new_n151_), .O(z8));
  nand2  g108(.a(new_n108_), .b(x31), .O(new_n153_));
  nand3  g109(.a(new_n105_), .b(new_n97_), .c(new_n107_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(x33), .O(new_n155_));
  oai21  g111(.a(new_n128_), .b(new_n126_), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n105_), .b(x30), .O(new_n157_));
  oai21  g113(.a(new_n114_), .b(new_n138_), .c(new_n113_), .O(new_n158_));
  aoi22  g114(.a(x31), .b(new_n107_), .c(new_n114_), .d(new_n143_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n101_), .O(new_n160_));
  nand2  g116(.a(new_n116_), .b(x14), .O(new_n161_));
  nor2   g117(.a(new_n114_), .b(new_n113_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n161_), .c(new_n133_), .O(new_n163_));
  nand2  g119(.a(new_n162_), .b(new_n133_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n116_), .O(new_n165_));
  inv1   g121(.a(new_n162_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n141_), .c(new_n112_), .O(new_n167_));
  nand2  g123(.a(new_n162_), .b(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n122_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n160_), .c(x33), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n156_), .c(new_n151_), .O(z9));
endmodule
