// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:37 2020
...
module FAU ( 
  ...
  and2   g038(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  ...
  inv1   g064(.a(new_n81_), .O(new_n109_));
  inv1   g065(.a(x19), .O(new_n110_));
  inv1   g066(.a(x24), .O(new_n111_));
  oai21  g067(.a(new_n80_), .b(new_n111_), .c(new_n110_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n109_), .c(new_n78_), .O(new_n113_));
  ...
  nand3  g079(.a(new_n110_), .b(x18), .c(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n121_), .O(new_n125_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n128_), .c(new_n120_), .O(new_n133_));
  nand3  g089(.a(x16), .b(new_n120_), .c(x10), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand2  g091(.a(new_n96_), .b(new_n95_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n102_), .c(x29), .O(new_n137_));
  ...
  nor2   g098(.a(new_n129_), .b(new_n120_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n131_), .O(new_n144_));
  nor2   g100(.a(new_n110_), .b(new_n122_), .O(new_n145_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n130_), .c(new_n120_), .O(new_n152_));
  nand2  g108(.a(new_n116_), .b(x27), .O(new_n153_));
  oai21  g109(.a(x30), .b(x27), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n96_), .O(new_n155_));
  inv1   g111(.a(x14), .O(new_n156_));
  nand2  g112(.a(new_n110_), .b(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x31), .O(new_n158_));
  aoi21  g114(.a(new_n102_), .b(new_n94_), .c(new_n158_), .O(new_n159_));
  ...
  aoi21  g121(.a(new_n163_), .b(new_n142_), .c(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  oai21  g123(.a(new_n135_), .b(new_n133_), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n114_), .b(new_n102_), .O(new_n169_));
  oai22  g125(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(new_n114_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n138_), .O(new_n171_));
  inv1   g127(.a(new_n138_), .O(new_n172_));
  nand2  g128(.a(x31), .b(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n114_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n168_), .c(new_n174_), .O(new_n175_));
  aoi21  g131(.a(x19), .b(x12), .c(x17), .O(new_n176_));
  nand2  g132(.a(new_n114_), .b(x30), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n102_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n157_), .c(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n122_), .b(x13), .O(new_n180_));
  nor2   g136(.a(new_n110_), .b(new_n121_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n143_), .c(new_n180_), .O(new_n182_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n151_), .c(new_n120_), .O(new_n186_));
  ...
  nor3   g145(.a(new_n189_), .b(new_n179_), .c(new_n176_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n167_), .O(new_n191_));
  aoi21  g147(.a(new_n175_), .b(new_n172_), .c(new_n191_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n171_), .c(new_n165_), .O(z9));
endmodule
