...
module FAU ( 
  ...
  oai21  g058(.a(new_n100_), .b(new_n98_), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n100_), .b(new_n107_), .c(x30), .O(new_n108_));
  ...
  oai21  g084(.a(x32), .b(new_n92_), .c(new_n93_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n101_), .O(new_n130_));
  aoi21  g086(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(z0), .c(x30), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(new_n107_), .O(new_n134_));
  ...
  aoi21  g101(.a(x29), .b(x27), .c(x30), .O(new_n146_));
  ...
  nand3  g106(.a(x30), .b(x29), .c(x27), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n150_), .c(new_n148_), .d(new_n145_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n143_), .c(x32), .O(new_n153_));
  inv1   g109(.a(x26), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x00), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(new_n135_), .c(new_n155_), .O(z8));
  inv1   g112(.a(x33), .O(new_n157_));
  oai21  g113(.a(new_n128_), .b(new_n126_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n107_), .b(new_n98_), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n107_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n132_), .O(new_n161_));
  nand2  g117(.a(x31), .b(x30), .O(new_n162_));
  nand2  g118(.a(x33), .b(new_n107_), .O(new_n163_));
  oai21  g119(.a(new_n162_), .b(new_n158_), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  nand2  g121(.a(new_n107_), .b(x30), .O(new_n166_));
  nand2  g122(.a(x31), .b(new_n98_), .O(new_n167_));
  nand2  g123(.a(new_n114_), .b(new_n149_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .O(new_n169_));
  nand2  g125(.a(new_n116_), .b(x14), .O(new_n170_));
  nor2   g126(.a(new_n114_), .b(new_n113_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n170_), .c(new_n136_), .O(new_n172_));
  nand2  g128(.a(new_n171_), .b(new_n136_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n116_), .O(new_n174_));
  inv1   g130(.a(new_n171_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n144_), .c(new_n112_), .O(new_n176_));
  nand2  g132(.a(new_n171_), .b(x11), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n122_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n176_), .c(new_n174_), .d(new_n172_), .O(new_n179_));
  nor3   g135(.a(new_n179_), .b(new_n169_), .c(new_n165_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n157_), .O(new_n181_));
  aoi21  g137(.a(new_n164_), .b(new_n131_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n161_), .c(new_n155_), .O(z9));
endmodule
