...
module FAU ( 
  ...
  nand2  g072(.a(x21), .b(x17), .O(new_n117_));
  oai21  g073(.a(new_n84_), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n88_), .c(new_n83_), .d(new_n79_), .O(new_n119_));
  ...
  nor2   g103(.a(new_n81_), .b(new_n86_), .O(new_n148_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n126_), .O(new_n152_));
