...
module FAU ( 
  ...
  nand3  g077(.a(new_n121_), .b(new_n119_), .c(x10), .O(new_n122_));
  ...
  aoi21  g082(.a(x27), .b(x11), .c(x28), .O(new_n127_));
  nand2  g083(.a(new_n124_), .b(x15), .O(new_n128_));
  ...
  oai21  g093(.a(new_n117_), .b(new_n115_), .c(x16), .O(new_n138_));
  nand3  g094(.a(new_n121_), .b(new_n124_), .c(x11), .O(new_n139_));
  ...
  aoi21  g098(.a(new_n140_), .b(x15), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(z0), .b(x31), .c(x30), .O(new_n144_));
  nand2  g100(.a(x32), .b(new_n97_), .O(new_n145_));
  oai21  g101(.a(new_n144_), .b(new_n143_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x10), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n120_), .c(new_n119_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x18), .O(new_n149_));
  nand2  g105(.a(x17), .b(x11), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n124_), .O(new_n151_));
  inv1   g107(.a(x13), .O(new_n152_));
  oai21  g108(.a(new_n113_), .b(new_n152_), .c(new_n111_), .O(new_n153_));
  inv1   g109(.a(x14), .O(new_n154_));
  aoi21  g110(.a(new_n113_), .b(new_n154_), .c(new_n105_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n153_), .c(new_n151_), .O(new_n156_));
  inv1   g112(.a(x12), .O(new_n157_));
  oai21  g113(.a(new_n149_), .b(new_n157_), .c(new_n110_), .O(new_n158_));
  nand3  g114(.a(new_n121_), .b(x16), .c(x15), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n148_), .c(z0), .O(new_n162_));
  aoi21  g118(.a(new_n146_), .b(new_n137_), .c(new_n162_), .O(new_n163_));
  inv1   g119(.a(x26), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x00), .O(new_n165_));
  aoi21  g121(.a(new_n163_), .b(new_n136_), .c(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(x31), .c(x30), .d(x16), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  aoi22  g125(.a(new_n169_), .b(new_n123_), .c(x33), .d(new_n105_), .O(new_n170_));
  inv1   g126(.a(new_n127_), .O(new_n171_));
  nand4  g127(.a(new_n167_), .b(x31), .c(x30), .d(x19), .O(new_n172_));
  nor3   g128(.a(new_n172_), .b(new_n129_), .c(new_n128_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  oai21  g130(.a(new_n170_), .b(new_n125_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x29), .O(new_n176_));
  nand3  g132(.a(new_n167_), .b(new_n105_), .c(new_n97_), .O(new_n177_));
  nand2  g133(.a(x33), .b(x31), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n143_), .c(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n105_), .b(x30), .O(new_n180_));
  nand2  g136(.a(x31), .b(new_n97_), .O(new_n181_));
  oai21  g137(.a(new_n111_), .b(new_n157_), .c(new_n110_), .O(new_n182_));
  nand2  g138(.a(new_n111_), .b(new_n152_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .d(new_n180_), .O(new_n184_));
  nand2  g140(.a(new_n113_), .b(x14), .O(new_n185_));
  inv1   g141(.a(new_n129_), .O(new_n186_));
  ...
  nand2  g145(.a(new_n187_), .b(new_n113_), .O(new_n190_));
  oai21  g146(.a(new_n147_), .b(new_n129_), .c(new_n119_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n129_), .b(new_n192_), .c(new_n124_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n191_), .c(new_n190_), .d(new_n189_), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n184_), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(new_n167_), .O(new_n196_));
  aoi21  g152(.a(new_n179_), .b(new_n137_), .c(new_n196_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n176_), .c(new_n165_), .O(z9));
endmodule
