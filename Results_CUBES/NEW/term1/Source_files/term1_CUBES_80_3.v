...
module FAU ( 
  ...
  nand4  g082(.a(x19), .b(x18), .c(new_n126_), .d(x12), .O(new_n127_));
  ...
  nor2   g087(.a(new_n116_), .b(new_n126_), .O(new_n132_));
  ...
  nand3  g094(.a(x16), .b(new_n112_), .c(x10), .O(new_n139_));
  ...
  nor2   g100(.a(new_n118_), .b(new_n116_), .O(new_n145_));
  inv1   g101(.a(x16), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n112_), .O(new_n147_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(new_n112_), .O(new_n156_));
  nand2  g112(.a(new_n107_), .b(x27), .O(new_n157_));
  ...
  aoi21  g118(.a(new_n107_), .b(x28), .c(new_n162_), .O(new_n163_));
  ...
  nor2   g135(.a(new_n173_), .b(new_n133_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n136_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n112_), .O(new_n182_));
  nand2  g138(.a(new_n180_), .b(new_n140_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n182_), .c(new_n169_), .O(new_n185_));
  nand2  g141(.a(new_n113_), .b(new_n107_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x31), .O(new_n187_));
  nand2  g143(.a(new_n147_), .b(new_n132_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n118_), .O(new_n189_));
  inv1   g145(.a(new_n132_), .O(new_n190_));
  oai21  g146(.a(new_n155_), .b(new_n190_), .c(new_n112_), .O(new_n191_));
  oai21  g147(.a(new_n190_), .b(new_n135_), .c(new_n146_), .O(new_n192_));
  ...
  nand3  g152(.a(new_n196_), .b(new_n147_), .c(new_n132_), .O(new_n197_));
  ...
  aoi21  g158(.a(new_n202_), .b(new_n185_), .c(new_n167_), .O(z9));
endmodule
