...
module FAU ( 
  ...
  nor2   g068(.a(x28), .b(x27), .O(new_n113_));
  nand2  g069(.a(x30), .b(new_n91_), .O(new_n114_));
  oai21  g070(.a(new_n113_), .b(new_n102_), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g087(.a(x16), .b(new_n116_), .O(new_n132_));
  nor3   g088(.a(new_n132_), .b(new_n127_), .c(new_n131_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n130_), .c(new_n115_), .O(new_n134_));
  nor2   g090(.a(new_n132_), .b(new_n127_), .O(new_n135_));
  nand2  g091(.a(new_n113_), .b(x30), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n135_), .b(new_n130_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nor2   g095(.a(x32), .b(new_n107_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nor2   g097(.a(new_n126_), .b(new_n116_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n128_), .O(new_n143_));
  nor2   g099(.a(new_n120_), .b(new_n118_), .O(new_n144_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n127_), .c(new_n116_), .O(new_n151_));
  nand2  g107(.a(new_n109_), .b(x27), .O(new_n152_));
  ...
  nand2  g119(.a(new_n129_), .b(new_n125_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(x15), .c(new_n133_), .O(new_n165_));
  inv1   g121(.a(x33), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x31), .c(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n107_), .O(new_n168_));
  oai21  g124(.a(new_n167_), .b(new_n165_), .c(new_n168_), .O(new_n169_));
  nor2   g125(.a(new_n113_), .b(new_n91_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  inv1   g127(.a(new_n170_), .O(new_n172_));
  nor2   g128(.a(x33), .b(x31), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n164_), .c(new_n98_), .d(x15), .O(new_n174_));
  nand2  g130(.a(x33), .b(x31), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g132(.a(new_n107_), .b(x30), .O(new_n177_));
  nand2  g133(.a(x18), .b(x12), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n117_), .O(new_n179_));
  nand2  g135(.a(x31), .b(new_n98_), .O(new_n180_));
  inv1   g136(.a(x13), .O(new_n181_));
  nand2  g137(.a(new_n118_), .b(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n183_));
  nand2  g139(.a(new_n120_), .b(x14), .O(new_n184_));
  nand2  g140(.a(x18), .b(x17), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n184_), .c(new_n142_), .O(new_n187_));
  nand2  g143(.a(new_n186_), .b(new_n142_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n120_), .O(new_n189_));
  oai21  g145(.a(new_n185_), .b(new_n150_), .c(new_n116_), .O(new_n190_));
  inv1   g146(.a(x11), .O(new_n191_));
  oai21  g147(.a(new_n185_), .b(new_n191_), .c(new_n126_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n190_), .c(new_n189_), .d(new_n187_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n183_), .c(x33), .O(new_n194_));
  nor2   g150(.a(x29), .b(new_n131_), .O(new_n195_));
  nand3  g151(.a(new_n173_), .b(new_n98_), .c(x19), .O(new_n196_));
  nor3   g152(.a(new_n196_), .b(new_n185_), .c(new_n132_), .O(new_n197_));
  oai21  g153(.a(new_n195_), .b(new_n113_), .c(new_n197_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n194_), .O(new_n199_));
  aoi21  g155(.a(new_n176_), .b(new_n172_), .c(new_n199_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n171_), .c(new_n162_), .O(z9));
endmodule
