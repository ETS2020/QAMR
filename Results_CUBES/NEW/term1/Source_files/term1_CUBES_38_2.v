...
module FAU ( 
  ...
  nand2  g038(.a(new_n57_), .b(x29), .O(new_n83_));
  nand2  g039(.a(x25), .b(x01), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  nand4  g041(.a(new_n85_), .b(new_n83_), .c(new_n82_), .d(new_n81_), .O(new_n86_));
  nor2   g042(.a(new_n86_), .b(new_n80_), .O(z3));
  inv1   g043(.a(x28), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(x27), .O(new_n89_));
  nor2   g045(.a(x28), .b(new_n82_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(x29), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n89_), .c(new_n50_), .O(new_n93_));
  oai21  g049(.a(new_n90_), .b(new_n89_), .c(new_n47_), .O(new_n94_));
  inv1   g050(.a(new_n80_), .O(new_n95_));
  nor2   g051(.a(new_n84_), .b(x26), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  aoi21  g053(.a(new_n94_), .b(new_n93_), .c(new_n97_), .O(z4));
  aoi22  g054(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x29), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  nor2   g057(.a(new_n88_), .b(new_n82_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n100_), .c(new_n97_), .O(z5));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n102_), .b(new_n105_), .c(x29), .O(new_n106_));
  oai21  g062(.a(new_n102_), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n58_), .O(new_n108_));
  nand2  g064(.a(x30), .b(new_n101_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n108_), .c(new_n97_), .O(z6));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n102_), .b(new_n111_), .c(x30), .d(x29), .O(new_n112_));
  nor2   g068(.a(new_n105_), .b(new_n101_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n102_), .c(new_n111_), .O(new_n114_));
  nand2  g070(.a(new_n96_), .b(new_n58_), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n112_), .c(new_n95_), .O(z7));
  ...
  nand2  g090(.a(new_n88_), .b(new_n82_), .O(new_n135_));
  ...
  nand2  g107(.a(new_n113_), .b(x27), .O(new_n152_));
  oai21  g108(.a(x30), .b(x27), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n88_), .O(new_n154_));
  oai21  g110(.a(x19), .b(x14), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n105_), .b(new_n101_), .c(new_n155_), .O(new_n156_));
  aoi21  g112(.a(x19), .b(x13), .c(x18), .O(new_n157_));
  aoi21  g113(.a(new_n113_), .b(x28), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g116(.a(new_n81_), .b(x00), .O(new_n161_));
  ...
  nand2  g120(.a(new_n111_), .b(new_n105_), .O(new_n165_));
