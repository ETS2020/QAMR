// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:37 2020
...
module FAU ( 
  ...
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z5));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n91_), .O(z6));
  ...
  aoi21  g069(.a(new_n113_), .b(x31), .c(new_n91_), .O(new_n114_));
  ...
  nand2  g088(.a(new_n94_), .b(new_n93_), .O(new_n133_));
