...
module FAU ( 
  ...
  nor2   g015(.a(x09), .b(x03), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(new_n50_), .O(new_n61_));
  aoi21  g017(.a(new_n61_), .b(new_n59_), .c(new_n57_), .O(new_n62_));
  oai21  g018(.a(x09), .b(x05), .c(new_n47_), .O(new_n63_));
  ...
  aoi21  g028(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(new_n73_));
  nand2  g029(.a(new_n64_), .b(new_n63_), .O(new_n74_));
  inv1   g030(.a(x09), .O(new_n75_));
  nand4  g031(.a(new_n65_), .b(new_n75_), .c(x05), .d(new_n47_), .O(new_n76_));
  aoi21  g032(.a(new_n76_), .b(new_n74_), .c(x01), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(new_n73_), .c(new_n70_), .O(new_n78_));
  aoi21  g034(.a(new_n78_), .b(new_n69_), .c(new_n55_), .O(z2));
  ...
  nand4  g043(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n59_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nor2   g046(.a(new_n85_), .b(x26), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n90_), .c(new_n84_), .d(new_n59_), .O(new_n92_));
  ...
  nand2  g054(.a(new_n91_), .b(new_n59_), .O(new_n99_));
