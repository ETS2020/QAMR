// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:25 2020
...
module FAU ( 
  ...
  nand2  g023(.a(x03), .b(new_n50_), .O(new_n68_));
  nand2  g024(.a(new_n47_), .b(x02), .O(new_n69_));
  aoi21  g025(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(new_n70_));
  nand2  g026(.a(x05), .b(new_n47_), .O(new_n71_));
  nand2  g027(.a(x06), .b(new_n50_), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g029(.a(new_n59_), .b(x06), .c(x05), .O(new_n74_));
  aoi21  g030(.a(new_n74_), .b(new_n73_), .c(x01), .O(new_n75_));
  oai21  g031(.a(new_n75_), .b(new_n70_), .c(new_n66_), .O(new_n76_));
  inv1   g032(.a(x09), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(x08), .O(new_n78_));
  aoi21  g034(.a(new_n76_), .b(new_n65_), .c(new_n78_), .O(z2));
  inv1   g035(.a(new_n61_), .O(new_n80_));
  ...
  nand4  g044(.a(new_n88_), .b(new_n87_), .c(new_n85_), .d(new_n80_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nor2   g047(.a(new_n86_), .b(x26), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n91_), .c(new_n85_), .d(new_n80_), .O(new_n93_));
  ...
  nand2  g055(.a(new_n92_), .b(new_n80_), .O(new_n100_));
  ...
  oai21  g118(.a(new_n132_), .b(new_n130_), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n110_), .b(new_n102_), .O(new_n164_));
  ...
  nand2  g128(.a(x31), .b(new_n102_), .O(new_n173_));
  inv1   g129(.a(x13), .O(new_n174_));
  nand2  g130(.a(new_n118_), .b(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n173_), .c(new_n172_), .O(new_n176_));
  nand2  g132(.a(new_n120_), .b(x14), .O(new_n177_));
  nor2   g133(.a(new_n118_), .b(new_n117_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n177_), .c(new_n140_), .O(new_n179_));
  nand2  g135(.a(new_n178_), .b(new_n140_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n120_), .O(new_n181_));
  inv1   g137(.a(new_n178_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n148_), .c(new_n116_), .O(new_n183_));
