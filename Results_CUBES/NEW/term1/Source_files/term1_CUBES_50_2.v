...
module FAU ( 
  ...
  nand3  g092(.a(new_n123_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(x19), .b(x18), .O(new_n138_));
  nand2  g094(.a(x17), .b(x11), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(new_n121_), .O(new_n140_));
  inv1   g096(.a(x12), .O(new_n141_));
  oai21  g097(.a(new_n138_), .b(new_n141_), .c(new_n112_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n140_), .c(new_n137_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n122_), .c(new_n111_), .O(new_n145_));
  nand3  g101(.a(x30), .b(x29), .c(x27), .O(new_n146_));
  oai21  g102(.a(x30), .b(x27), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n129_), .O(new_n148_));
  oai21  g104(.a(x19), .b(x14), .c(x31), .O(new_n149_));
  aoi21  g105(.a(new_n99_), .b(new_n91_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g113(.a(x29), .b(x27), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n105_), .c(new_n99_), .O(new_n159_));
  nand4  g115(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n159_), .c(x33), .O(new_n161_));
  oai21  g117(.a(new_n127_), .b(new_n125_), .c(new_n161_), .O(new_n162_));
  inv1   g118(.a(x11), .O(new_n163_));
  nand2  g119(.a(x18), .b(x17), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n121_), .O(new_n165_));
  nand4  g121(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n115_), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n144_), .c(new_n111_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n167_), .c(new_n165_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  aoi21  g126(.a(new_n115_), .b(x14), .c(new_n166_), .O(new_n171_));
  ...
  aoi21  g130(.a(new_n158_), .b(new_n99_), .c(x31), .O(new_n175_));
  nand2  g131(.a(new_n130_), .b(new_n106_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(x31), .c(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n174_), .c(new_n170_), .O(new_n178_));
  nor3   g134(.a(x31), .b(new_n91_), .c(new_n129_), .O(new_n179_));
