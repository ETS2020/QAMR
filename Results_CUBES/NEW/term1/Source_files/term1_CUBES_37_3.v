// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:00 2020
...
module FAU ( 
  ...
  nor2   g081(.a(x30), .b(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(new_n108_), .d(new_n58_), .O(new_n127_));
  ...
  nand3  g114(.a(z0), .b(x31), .c(x30), .O(new_n159_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n160_), .O(new_n170_));
  nor2   g126(.a(new_n135_), .b(new_n149_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n164_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  inv1   g129(.a(x11), .O(new_n174_));
  nand2  g130(.a(new_n149_), .b(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n135_), .b(new_n145_), .O(new_n176_));
  inv1   g132(.a(x13), .O(new_n177_));
  nand2  g133(.a(new_n83_), .b(new_n177_), .O(new_n178_));
  inv1   g134(.a(x14), .O(new_n179_));
  nand2  g135(.a(new_n86_), .b(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n176_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n173_), .c(x32), .O(new_n182_));
  oai21  g138(.a(new_n170_), .b(new_n159_), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n94_), .b(new_n96_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x29), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  inv1   g142(.a(new_n164_), .O(new_n187_));
  nand3  g143(.a(new_n171_), .b(new_n77_), .c(x10), .O(new_n188_));
  nor3   g144(.a(new_n188_), .b(new_n187_), .c(new_n159_), .O(new_n189_));
  aoi21  g145(.a(x32), .b(new_n120_), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n137_), .b(new_n77_), .O(new_n191_));
  nand2  g147(.a(x19), .b(x15), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n83_), .c(new_n130_), .O(new_n193_));
  nand3  g149(.a(new_n164_), .b(x17), .c(x15), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n149_), .O(new_n195_));
  oai21  g151(.a(new_n187_), .b(new_n77_), .c(new_n135_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n195_), .c(new_n193_), .d(new_n191_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(x32), .O(new_n198_));
  oai21  g154(.a(new_n190_), .b(new_n186_), .c(new_n198_), .O(new_n199_));
  aoi21  g155(.a(new_n183_), .b(x15), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n104_), .b(x00), .O(new_n201_));
  aoi21  g157(.a(new_n200_), .b(new_n158_), .c(new_n201_), .O(z8));
  inv1   g158(.a(x33), .O(new_n203_));
  nand3  g159(.a(new_n203_), .b(x31), .c(x30), .O(new_n204_));
  nand3  g160(.a(new_n184_), .b(x33), .c(new_n130_), .O(new_n205_));
  oai21  g161(.a(new_n204_), .b(new_n153_), .c(new_n205_), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(x29), .O(new_n207_));
  nor3   g163(.a(x33), .b(x31), .c(x30), .O(new_n208_));
  nand3  g164(.a(new_n208_), .b(new_n169_), .c(new_n160_), .O(new_n209_));
  nand2  g165(.a(new_n86_), .b(x14), .O(new_n210_));
  nand4  g166(.a(new_n210_), .b(new_n171_), .c(x33), .d(x18), .O(new_n211_));
  nand2  g167(.a(new_n211_), .b(new_n209_), .O(new_n212_));
  nand2  g168(.a(new_n208_), .b(new_n164_), .O(new_n213_));
  oai22  g169(.a(new_n213_), .b(new_n188_), .c(new_n203_), .d(new_n130_), .O(new_n214_));
  nand2  g170(.a(new_n214_), .b(new_n185_), .O(new_n215_));
  nand2  g171(.a(new_n130_), .b(x30), .O(new_n216_));
  nand2  g172(.a(x31), .b(new_n120_), .O(new_n217_));
  oai21  g173(.a(new_n83_), .b(new_n145_), .c(new_n135_), .O(new_n218_));
  nand4  g174(.a(new_n218_), .b(new_n178_), .c(new_n217_), .d(new_n216_), .O(new_n219_));
  oai21  g175(.a(new_n151_), .b(new_n174_), .c(new_n149_), .O(new_n220_));
  nand2  g176(.a(x16), .b(x15), .O(new_n221_));
  oai21  g177(.a(new_n221_), .b(new_n151_), .c(new_n86_), .O(new_n222_));
  nand2  g178(.a(x16), .b(x10), .O(new_n223_));
  oai21  g179(.a(new_n223_), .b(new_n151_), .c(new_n77_), .O(new_n224_));
  nand3  g180(.a(new_n224_), .b(new_n222_), .c(new_n220_), .O(new_n225_));
  oai21  g181(.a(new_n225_), .b(new_n219_), .c(x33), .O(new_n226_));
  nand2  g182(.a(new_n226_), .b(new_n215_), .O(new_n227_));
  aoi21  g183(.a(new_n212_), .b(x15), .c(new_n227_), .O(new_n228_));
  aoi21  g184(.a(new_n228_), .b(new_n207_), .c(new_n201_), .O(z9));
endmodule
