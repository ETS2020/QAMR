...
module FAU ( 
  ...
  nor2   g011(.a(new_n47_), .b(x02), .O(new_n56_));
  nor2   g012(.a(x03), .b(new_n50_), .O(new_n57_));
  oai21  g013(.a(new_n57_), .b(new_n56_), .c(x01), .O(new_n58_));
  inv1   g014(.a(x01), .O(new_n59_));
  nand4  g015(.a(x06), .b(x05), .c(new_n47_), .d(new_n50_), .O(new_n60_));
  inv1   g016(.a(x05), .O(new_n61_));
  oai21  g017(.a(new_n61_), .b(x03), .c(x02), .O(new_n62_));
  ...
  nand2  g022(.a(new_n66_), .b(new_n58_), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n55_), .O(new_n68_));
  xnor2a g024(.a(x07), .b(x04), .O(new_n69_));
  nand2  g025(.a(new_n47_), .b(new_n50_), .O(new_n70_));
  nor2   g026(.a(new_n47_), .b(new_n50_), .O(new_n71_));
  inv1   g027(.a(new_n71_), .O(new_n72_));
  aoi21  g028(.a(new_n72_), .b(new_n70_), .c(new_n59_), .O(new_n73_));
  oai21  g029(.a(new_n63_), .b(x05), .c(new_n47_), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  oai21  g031(.a(new_n57_), .b(new_n63_), .c(x05), .O(new_n76_));
  aoi21  g032(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(new_n73_), .c(new_n69_), .O(new_n78_));
  inv1   g034(.a(x09), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(x08), .O(new_n80_));
  aoi21  g036(.a(new_n78_), .b(new_n68_), .c(new_n80_), .O(z2));
  ...
  nand4  g045(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n72_), .O(new_n90_));
  inv1   g046(.a(new_n90_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nor2   g048(.a(new_n87_), .b(x26), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n86_), .d(new_n72_), .O(new_n94_));
  ...
  nand2  g056(.a(new_n93_), .b(new_n72_), .O(new_n101_));
