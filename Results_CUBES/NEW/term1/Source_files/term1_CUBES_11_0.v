...
module FAU ( 
  ...
  aoi21  g066(.a(new_n110_), .b(new_n94_), .c(new_n107_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n96_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n108_), .c(new_n81_), .O(z7));
  ...
  nand2  g086(.a(x30), .b(new_n91_), .O(new_n131_));
  nand2  g087(.a(z0), .b(x31), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(new_n102_), .c(new_n132_), .O(new_n133_));
  oai21  g089(.a(new_n130_), .b(new_n128_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n110_), .b(x27), .O(new_n135_));
  nand2  g091(.a(new_n98_), .b(new_n92_), .O(new_n136_));
  ...
  aoi22  g098(.a(new_n142_), .b(new_n115_), .c(new_n141_), .d(new_n124_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n125_), .c(new_n114_), .O(new_n145_));
  inv1   g101(.a(x14), .O(new_n146_));
  aoi21  g102(.a(new_n118_), .b(new_n146_), .c(new_n107_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  oai21  g105(.a(new_n118_), .b(new_n149_), .c(new_n116_), .O(new_n150_));
  oai21  g106(.a(new_n109_), .b(new_n93_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g117(.a(new_n107_), .b(new_n98_), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n107_), .O(new_n163_));
  ...
  nand2  g123(.a(new_n107_), .b(x30), .O(new_n168_));
  nand2  g124(.a(x18), .b(x12), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n115_), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n98_), .O(new_n171_));
  nand2  g127(.a(new_n116_), .b(new_n149_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n168_), .O(new_n173_));
  nor2   g129(.a(new_n116_), .b(new_n115_), .O(new_n174_));
  ...
  nand2  g133(.a(new_n175_), .b(new_n118_), .O(new_n178_));
  inv1   g134(.a(new_n174_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n144_), .c(new_n114_), .O(new_n180_));
