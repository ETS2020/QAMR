...
module FAU ( 
  ...
  aoi21  g081(.a(new_n125_), .b(new_n121_), .c(new_n79_), .O(new_n126_));
  nand3  g082(.a(x16), .b(new_n79_), .c(x10), .O(new_n127_));
  ...
  nor2   g091(.a(new_n122_), .b(new_n79_), .O(new_n136_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n123_), .c(new_n79_), .O(new_n145_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n144_), .c(new_n79_), .O(new_n179_));
