// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:11 2020
...
module FAU ( 
  ...
  oai22  g039(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n84_));
  ...
  nand3  g083(.a(x19), .b(new_n77_), .c(x13), .O(new_n128_));
  inv1   g084(.a(x19), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x18), .c(x14), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  nand4  g087(.a(x19), .b(x18), .c(new_n127_), .d(x12), .O(new_n132_));
  ...
  nor2   g106(.a(new_n129_), .b(new_n77_), .O(new_n151_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n127_), .O(new_n155_));
