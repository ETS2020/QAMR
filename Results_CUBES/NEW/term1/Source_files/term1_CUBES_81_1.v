...
module FAU ( 
  ...
  aoi21  g082(.a(x27), .b(x10), .c(x28), .O(new_n127_));
  nand2  g083(.a(x16), .b(new_n124_), .O(new_n128_));
  nand2  g084(.a(x18), .b(x17), .O(new_n129_));
  nor4   g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n113_), .O(new_n130_));
  aoi21  g086(.a(new_n126_), .b(new_n123_), .c(new_n130_), .O(new_n131_));
  nand3  g087(.a(z0), .b(x31), .c(new_n97_), .O(new_n132_));
  nand2  g088(.a(new_n92_), .b(new_n91_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x32), .c(x30), .O(new_n134_));
  ...
  nand3  g093(.a(x16), .b(new_n124_), .c(x10), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(new_n120_), .O(new_n139_));
  aoi21  g095(.a(new_n123_), .b(x15), .c(new_n139_), .O(new_n140_));
  nand3  g096(.a(z0), .b(x31), .c(x30), .O(new_n141_));
  nand2  g097(.a(x32), .b(new_n97_), .O(new_n142_));
  oai21  g098(.a(new_n141_), .b(new_n140_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n120_), .c(new_n124_), .O(new_n145_));
  nand2  g101(.a(x19), .b(x18), .O(new_n146_));
  nand2  g102(.a(x17), .b(x11), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(new_n119_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  oai21  g105(.a(new_n113_), .b(new_n149_), .c(new_n111_), .O(new_n150_));
  inv1   g106(.a(x14), .O(new_n151_));
  aoi21  g107(.a(new_n113_), .b(new_n151_), .c(new_n105_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .O(new_n153_));
  inv1   g109(.a(x12), .O(new_n154_));
  oai21  g110(.a(new_n146_), .b(new_n154_), .c(new_n110_), .O(new_n155_));
  nand3  g111(.a(new_n121_), .b(x16), .c(x15), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n145_), .c(z0), .O(new_n159_));
  aoi21  g115(.a(new_n143_), .b(new_n137_), .c(new_n159_), .O(new_n160_));
  inv1   g116(.a(x26), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x00), .O(new_n162_));
  aoi21  g118(.a(new_n160_), .b(new_n136_), .c(new_n162_), .O(z8));
  inv1   g119(.a(x33), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(x31), .c(x30), .d(x15), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  aoi22  g122(.a(new_n166_), .b(new_n123_), .c(x33), .d(new_n105_), .O(new_n167_));
  inv1   g123(.a(new_n127_), .O(new_n168_));
  nand4  g124(.a(new_n164_), .b(x31), .c(x30), .d(x19), .O(new_n169_));
  nor3   g125(.a(new_n169_), .b(new_n129_), .c(new_n128_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  oai21  g127(.a(new_n167_), .b(new_n125_), .c(new_n171_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x29), .O(new_n173_));
  nand3  g129(.a(new_n164_), .b(new_n105_), .c(new_n97_), .O(new_n174_));
  nand2  g130(.a(x33), .b(x31), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n140_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n105_), .b(x30), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n97_), .O(new_n178_));
  oai21  g134(.a(new_n111_), .b(new_n154_), .c(new_n110_), .O(new_n179_));
  nand2  g135(.a(new_n111_), .b(new_n149_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n177_), .O(new_n181_));
  nand2  g137(.a(new_n113_), .b(x14), .O(new_n182_));
  inv1   g138(.a(new_n129_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(x16), .c(x15), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n182_), .O(new_n186_));
  nand2  g142(.a(new_n184_), .b(new_n113_), .O(new_n187_));
  oai21  g143(.a(new_n144_), .b(new_n129_), .c(new_n124_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n129_), .b(new_n189_), .c(new_n119_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n187_), .d(new_n186_), .O(new_n191_));
  nor2   g147(.a(new_n191_), .b(new_n181_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n164_), .O(new_n193_));
  aoi21  g149(.a(new_n176_), .b(new_n137_), .c(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n173_), .c(new_n162_), .O(z9));
endmodule
