// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:38 2020
...
module FAU ( 
  ...
  aoi21  g039(.a(new_n82_), .b(new_n81_), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n92_), .c(new_n86_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nor2   g056(.a(new_n95_), .b(new_n77_), .O(new_n101_));
  nand2  g057(.a(new_n100_), .b(x29), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n77_), .c(new_n101_), .d(new_n100_), .O(new_n103_));
  nand2  g059(.a(new_n92_), .b(new_n57_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  aoi21  g062(.a(new_n84_), .b(new_n80_), .c(new_n106_), .O(z6));
  nor2   g063(.a(new_n100_), .b(new_n95_), .O(new_n108_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n110_), .c(new_n105_), .d(new_n85_), .O(z7));
  ...
  nand3  g075(.a(new_n81_), .b(x18), .c(x14), .O(new_n120_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n124_), .c(new_n116_), .O(new_n129_));
  nand3  g085(.a(x16), .b(new_n116_), .c(x10), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  nand2  g087(.a(x30), .b(new_n95_), .O(new_n132_));
  nand2  g088(.a(z0), .b(x31), .O(new_n133_));
  aoi21  g089(.a(new_n132_), .b(new_n102_), .c(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n131_), .b(new_n129_), .c(new_n134_), .O(new_n135_));
  nor2   g091(.a(new_n125_), .b(new_n116_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n127_), .O(new_n137_));
  ...
  oai21  g097(.a(new_n138_), .b(new_n141_), .c(new_n117_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n140_), .c(new_n137_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n126_), .c(new_n116_), .O(new_n145_));
  inv1   g101(.a(x13), .O(new_n146_));
  oai21  g102(.a(new_n81_), .b(new_n146_), .c(new_n118_), .O(new_n147_));
  nor2   g103(.a(new_n108_), .b(new_n111_), .O(new_n148_));
  inv1   g104(.a(x14), .O(new_n149_));
  aoi22  g105(.a(new_n100_), .b(new_n95_), .c(new_n81_), .d(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n148_), .c(new_n147_), .d(new_n145_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n143_), .c(x32), .O(new_n152_));
  nand2  g108(.a(new_n76_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n152_), .b(new_n135_), .c(new_n153_), .O(z8));
  nand2  g110(.a(new_n108_), .b(x31), .O(new_n155_));
  nand3  g111(.a(new_n111_), .b(new_n100_), .c(new_n95_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(x33), .O(new_n157_));
  oai21  g113(.a(new_n131_), .b(new_n129_), .c(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n118_), .b(new_n141_), .c(new_n117_), .O(new_n159_));
  aoi22  g115(.a(x31), .b(new_n95_), .c(new_n118_), .d(new_n146_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n159_), .c(new_n112_), .d(new_n102_), .O(new_n161_));
  nand2  g117(.a(new_n81_), .b(x14), .O(new_n162_));
  nor2   g118(.a(new_n118_), .b(new_n117_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n162_), .c(new_n136_), .O(new_n164_));
  nand2  g120(.a(new_n163_), .b(new_n136_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n81_), .O(new_n166_));
  inv1   g122(.a(new_n163_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n144_), .c(new_n116_), .O(new_n168_));
  nand2  g124(.a(new_n163_), .b(x11), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n125_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n161_), .c(x33), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n158_), .c(new_n153_), .O(z9));
endmodule
