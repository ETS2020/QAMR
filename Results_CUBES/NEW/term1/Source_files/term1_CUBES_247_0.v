...
module FAU ( 
  ...
  nand2  g040(.a(x28), .b(new_n56_), .O(new_n85_));
  inv1   g041(.a(x25), .O(new_n86_));
  nor2   g042(.a(x26), .b(new_n86_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n85_), .c(new_n57_), .d(new_n84_), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(new_n83_), .O(z3));
  nand3  g045(.a(x28), .b(new_n84_), .c(x01), .O(new_n90_));
  oai21  g046(.a(x28), .b(new_n84_), .c(new_n90_), .O(new_n91_));
  nand2  g047(.a(new_n87_), .b(new_n57_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n83_), .O(z4));
  inv1   g051(.a(x28), .O(new_n96_));
  inv1   g052(.a(x29), .O(new_n97_));
  nor2   g053(.a(new_n96_), .b(new_n84_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g055(.a(new_n97_), .b(x27), .c(new_n99_), .O(new_n100_));
  aoi22  g056(.a(new_n100_), .b(x01), .c(x29), .d(new_n96_), .O(new_n101_));
  nand2  g057(.a(new_n93_), .b(new_n82_), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n101_), .O(z5));
  oai21  g059(.a(new_n97_), .b(new_n84_), .c(x30), .O(new_n104_));
  ...
  nand2  g063(.a(new_n107_), .b(x01), .O(new_n108_));
  nand2  g064(.a(x30), .b(new_n96_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n108_), .c(new_n102_), .O(z6));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n98_), .b(new_n111_), .c(x30), .d(x29), .O(new_n112_));
  nor2   g068(.a(new_n105_), .b(new_n97_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n98_), .O(new_n114_));
  inv1   g070(.a(x26), .O(new_n115_));
  nand4  g071(.a(new_n57_), .b(new_n115_), .c(x25), .d(x01), .O(new_n116_));
  aoi21  g072(.a(new_n114_), .b(x31), .c(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n112_), .c(new_n82_), .O(z7));
  ...
  nand2  g091(.a(new_n96_), .b(new_n84_), .O(new_n136_));
  ...
  aoi21  g112(.a(new_n105_), .b(new_n97_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(x19), .b(x13), .c(x18), .O(new_n158_));
  aoi21  g114(.a(new_n113_), .b(x28), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g117(.a(new_n115_), .b(x00), .O(new_n162_));
  ...
  nand2  g121(.a(new_n111_), .b(new_n105_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n111_), .O(new_n167_));
  ...
  nand2  g130(.a(x31), .b(new_n105_), .O(new_n175_));
