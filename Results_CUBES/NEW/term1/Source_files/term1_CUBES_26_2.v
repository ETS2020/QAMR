...
module FAU ( 
  ...
  nand3  g085(.a(new_n77_), .b(x18), .c(x14), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(new_n127_), .O(new_n131_));
  ...
  nor2   g106(.a(new_n77_), .b(new_n128_), .O(new_n151_));
  ...
  nand2  g138(.a(new_n128_), .b(new_n182_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n181_), .c(new_n180_), .O(new_n184_));
  nand2  g140(.a(new_n77_), .b(x14), .O(new_n185_));
  nor2   g141(.a(new_n128_), .b(new_n127_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n185_), .c(new_n149_), .O(new_n187_));
  nand2  g143(.a(new_n186_), .b(new_n149_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n77_), .O(new_n189_));
