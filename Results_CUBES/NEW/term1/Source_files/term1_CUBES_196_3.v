...
module FAU ( 
  ...
  oai22  g067(.a(new_n83_), .b(new_n81_), .c(new_n82_), .d(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n80_), .c(new_n78_), .O(new_n113_));
  ...
  nand3  g076(.a(x19), .b(new_n111_), .c(x13), .O(new_n121_));
  ...
  aoi21  g113(.a(new_n116_), .b(x28), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g121(.a(new_n114_), .b(new_n104_), .O(new_n166_));
