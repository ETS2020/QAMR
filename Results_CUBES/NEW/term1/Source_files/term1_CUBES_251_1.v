...
module FAU ( 
  ...
  oai21  g037(.a(x19), .b(x02), .c(x03), .O(new_n82_));
  ...
  nand2  g059(.a(new_n76_), .b(new_n103_), .O(new_n104_));
  ...
  nand3  g073(.a(new_n103_), .b(x18), .c(x14), .O(new_n118_));
  ...
  nor2   g094(.a(new_n103_), .b(new_n116_), .O(new_n139_));
  ...
  nand2  g106(.a(new_n103_), .b(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x31), .O(new_n152_));
  aoi21  g108(.a(new_n96_), .b(new_n108_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g118(.a(new_n106_), .b(new_n96_), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n106_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  inv1   g121(.a(new_n132_), .O(new_n166_));
  nand2  g122(.a(x31), .b(x30), .O(new_n167_));
  nand2  g123(.a(x33), .b(new_n106_), .O(new_n168_));
  ...
  nand2  g127(.a(x31), .b(new_n96_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n151_), .c(new_n171_), .O(new_n173_));
  nand2  g129(.a(new_n116_), .b(x13), .O(new_n174_));
  nor2   g130(.a(new_n103_), .b(new_n115_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n137_), .c(new_n174_), .O(new_n176_));
  ...
  nor3   g139(.a(new_n183_), .b(new_n173_), .c(new_n170_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n161_), .O(new_n185_));
  aoi21  g141(.a(new_n169_), .b(new_n166_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n165_), .c(new_n159_), .O(z9));
endmodule
