...
module FAU ( 
  ...
  nor4   g093(.a(new_n133_), .b(new_n77_), .c(x15), .d(new_n137_), .O(new_n138_));
  ...
  nand2  g101(.a(new_n126_), .b(x13), .O(new_n146_));
  nor2   g102(.a(new_n81_), .b(new_n84_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n148_), .b(new_n126_), .O(new_n151_));
  nand3  g107(.a(new_n147_), .b(x16), .c(x10), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n116_), .O(new_n153_));
  nand2  g109(.a(new_n147_), .b(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n77_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n153_), .c(new_n151_), .d(new_n150_), .O(new_n156_));
  nand2  g112(.a(new_n122_), .b(x27), .O(new_n157_));
  oai21  g113(.a(x30), .b(x27), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n103_), .O(new_n159_));
  oai21  g115(.a(x19), .b(x14), .c(x31), .O(new_n160_));
  aoi21  g116(.a(new_n109_), .b(new_n101_), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(x19), .b(x12), .c(x17), .O(new_n162_));
  aoi21  g118(.a(new_n122_), .b(x28), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n161_), .c(new_n159_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n156_), .c(x32), .O(new_n165_));
  ...
  oai21  g125(.a(new_n138_), .b(new_n136_), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n120_), .b(new_n109_), .O(new_n171_));
  ...
  nand2  g133(.a(x17), .b(x16), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n137_), .c(new_n116_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n116_), .c(new_n81_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n179_), .c(new_n151_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  inv1   g138(.a(x14), .O(new_n183_));
  oai21  g139(.a(x19), .b(new_n183_), .c(x18), .O(new_n184_));
  oai21  g140(.a(new_n81_), .b(x13), .c(new_n184_), .O(new_n185_));
  nand3  g141(.a(x17), .b(x16), .c(x15), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n120_), .b(x30), .O(new_n188_));
  nand2  g144(.a(x17), .b(x11), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n77_), .O(new_n190_));
  nand2  g146(.a(x31), .b(new_n109_), .O(new_n191_));
  inv1   g147(.a(x12), .O(new_n192_));
  nand2  g148(.a(new_n84_), .b(new_n192_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n191_), .c(new_n190_), .d(new_n188_), .O(new_n194_));
  aoi21  g150(.a(new_n187_), .b(new_n185_), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n182_), .c(new_n169_), .O(new_n196_));
  aoi21  g152(.a(new_n177_), .b(new_n174_), .c(new_n196_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n173_), .c(new_n167_), .O(z9));
endmodule
