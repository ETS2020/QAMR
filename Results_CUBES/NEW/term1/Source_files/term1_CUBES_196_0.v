...
module FAU ( 
  ...
  oai21  g062(.a(x22), .b(x17), .c(x23), .O(new_n107_));
  oai21  g063(.a(x23), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nor2   g064(.a(new_n78_), .b(new_n77_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand3  g067(.a(new_n100_), .b(new_n111_), .c(x30), .O(new_n112_));
  nor2   g068(.a(new_n98_), .b(new_n91_), .O(new_n113_));
  ...
  nand3  g074(.a(x19), .b(new_n106_), .c(x13), .O(new_n119_));
  ...
  nand3  g086(.a(x16), .b(new_n117_), .c(x10), .O(new_n131_));
  ...
  nor2   g095(.a(new_n126_), .b(new_n117_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n128_), .O(new_n141_));
  nor2   g097(.a(new_n120_), .b(new_n106_), .O(new_n142_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n127_), .c(new_n117_), .O(new_n149_));
  nand2  g105(.a(new_n113_), .b(x27), .O(new_n150_));
  ...
  aoi21  g109(.a(new_n98_), .b(new_n91_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(x19), .b(x13), .c(x18), .O(new_n155_));
  aoi21  g111(.a(new_n113_), .b(x28), .c(new_n155_), .O(new_n156_));
  ...
  nand2  g119(.a(new_n111_), .b(new_n98_), .O(new_n164_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n148_), .c(new_n117_), .O(new_n183_));
