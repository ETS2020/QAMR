...
module FAU ( 
  ...
  nand3  g080(.a(new_n124_), .b(new_n79_), .c(x11), .O(new_n125_));
  ...
  nor2   g091(.a(new_n79_), .b(new_n113_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n124_), .O(new_n137_));
  nor2   g093(.a(new_n117_), .b(new_n115_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x17), .c(x11), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n79_), .O(new_n140_));
  ...
  nand2  g136(.a(new_n180_), .b(new_n79_), .O(new_n181_));
