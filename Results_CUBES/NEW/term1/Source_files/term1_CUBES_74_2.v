...
module FAU ( 
  ...
  oai21  g034(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  ...
  nand4  g043(.a(new_n87_), .b(new_n57_), .c(new_n85_), .d(new_n84_), .O(new_n88_));
  aoi21  g044(.a(new_n83_), .b(new_n79_), .c(new_n88_), .O(z3));
  inv1   g045(.a(new_n80_), .O(new_n90_));
  inv1   g046(.a(new_n81_), .O(new_n91_));
  inv1   g047(.a(new_n82_), .O(new_n92_));
  nand2  g048(.a(new_n77_), .b(new_n76_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n90_), .O(new_n94_));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nor2   g051(.a(new_n86_), .b(x26), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n57_), .O(new_n97_));
  ...
  nand3  g058(.a(new_n102_), .b(new_n94_), .c(new_n57_), .O(new_n103_));
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(x19), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n101_), .c(new_n57_), .d(new_n78_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n99_), .O(z5));
  inv1   g062(.a(x30), .O(new_n107_));
  nand3  g063(.a(new_n101_), .b(new_n107_), .c(x29), .O(new_n108_));
  oai21  g064(.a(new_n101_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n94_), .O(new_n110_));
  nand3  g066(.a(new_n104_), .b(x30), .c(new_n78_), .O(new_n111_));
  nand2  g067(.a(new_n96_), .b(new_n57_), .O(new_n112_));
  aoi21  g068(.a(new_n111_), .b(new_n110_), .c(new_n112_), .O(z6));
  inv1   g069(.a(x31), .O(new_n114_));
  nand4  g070(.a(new_n101_), .b(new_n114_), .c(x30), .d(x29), .O(new_n115_));
  nor2   g071(.a(new_n107_), .b(new_n78_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(x31), .c(new_n112_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n115_), .c(new_n94_), .O(z7));
  ...
  nand3  g079(.a(new_n76_), .b(x18), .c(x14), .O(new_n124_));
  ...
  nand3  g092(.a(new_n136_), .b(new_n107_), .c(x29), .O(new_n137_));
  ...
  nor2   g100(.a(new_n76_), .b(new_n122_), .O(new_n145_));
  ...
  aoi21  g112(.a(new_n107_), .b(new_n78_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(x19), .b(x13), .c(x18), .O(new_n158_));
  aoi21  g114(.a(new_n116_), .b(x28), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g117(.a(new_n84_), .b(x00), .O(new_n162_));
  ...
  nand2  g121(.a(new_n114_), .b(new_n107_), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n114_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n138_), .O(new_n168_));
  inv1   g124(.a(new_n138_), .O(new_n169_));
  nand2  g125(.a(x31), .b(x30), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n114_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n165_), .c(new_n171_), .O(new_n172_));
  aoi21  g128(.a(x18), .b(x12), .c(x17), .O(new_n173_));
  nand2  g129(.a(new_n114_), .b(x30), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n107_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  nand2  g132(.a(new_n122_), .b(new_n176_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n175_), .c(new_n174_), .O(new_n178_));
  nand2  g134(.a(new_n76_), .b(x14), .O(new_n179_));
  nor2   g135(.a(new_n122_), .b(new_n121_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n179_), .c(new_n143_), .O(new_n181_));
  nand2  g137(.a(new_n180_), .b(new_n143_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n76_), .O(new_n183_));
  inv1   g139(.a(new_n180_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n151_), .c(new_n120_), .O(new_n185_));
