...
module FAU ( 
  ...
  nand2  g011(.a(x08), .b(x03), .O(new_n56_));
  oai22  g012(.a(new_n56_), .b(x01), .c(x05), .d(x03), .O(new_n57_));
  inv1   g013(.a(x06), .O(new_n58_));
  nor2   g014(.a(new_n58_), .b(x02), .O(new_n59_));
  nand2  g015(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g016(.a(new_n47_), .b(new_n50_), .O(new_n61_));
  oai21  g017(.a(new_n56_), .b(new_n50_), .c(new_n61_), .O(new_n62_));
  nand2  g018(.a(new_n62_), .b(x01), .O(new_n63_));
  inv1   g019(.a(new_n59_), .O(new_n64_));
  nor2   g020(.a(x03), .b(x01), .O(new_n65_));
  nand3  g021(.a(new_n65_), .b(new_n64_), .c(x05), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(new_n63_), .c(new_n60_), .O(new_n67_));
  nand2  g023(.a(new_n67_), .b(new_n55_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  nand2  g025(.a(x05), .b(new_n47_), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(x08), .c(new_n58_), .O(new_n71_));
  nand4  g027(.a(x06), .b(x05), .c(new_n47_), .d(new_n50_), .O(new_n72_));
  aoi21  g028(.a(new_n72_), .b(new_n71_), .c(x01), .O(new_n73_));
  nor2   g029(.a(x03), .b(new_n50_), .O(new_n74_));
  nor2   g030(.a(new_n56_), .b(x02), .O(new_n75_));
  oai21  g031(.a(new_n75_), .b(new_n74_), .c(x01), .O(new_n76_));
  nand2  g032(.a(new_n57_), .b(x02), .O(new_n77_));
  nand2  g033(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  oai21  g034(.a(new_n78_), .b(new_n73_), .c(new_n69_), .O(new_n79_));
  aoi21  g035(.a(new_n79_), .b(new_n68_), .c(x09), .O(z2));
  ...
  nand2  g069(.a(new_n113_), .b(new_n99_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(x31), .c(new_n101_), .O(new_n115_));
