...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n91_), .c(new_n78_), .O(new_n93_));
  nor2   g049(.a(new_n92_), .b(new_n91_), .O(new_n94_));
  xor2a  g050(.a(new_n94_), .b(x29), .O(new_n95_));
  nor2   g051(.a(new_n79_), .b(new_n77_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n95_), .O(new_n98_));
  or2    g054(.a(new_n87_), .b(new_n57_), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(new_n93_), .c(new_n99_), .O(z5));
  nor2   g056(.a(new_n94_), .b(new_n80_), .O(new_n101_));
  nor2   g057(.a(new_n96_), .b(x29), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n101_), .c(x30), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  inv1   g060(.a(x29), .O(new_n105_));
  inv1   g061(.a(new_n78_), .O(new_n106_));
  oai21  g062(.a(new_n96_), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n94_), .c(new_n104_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n103_), .c(new_n99_), .O(z6));
  inv1   g065(.a(new_n80_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n94_), .b(new_n111_), .c(x30), .d(x29), .O(new_n112_));
  nor2   g068(.a(new_n104_), .b(new_n105_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n94_), .c(new_n111_), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n99_), .O(new_n115_));
  ...
  aoi21  g110(.a(new_n104_), .b(new_n105_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g115(.a(new_n86_), .b(x00), .O(new_n160_));
  ...
  nand2  g119(.a(new_n111_), .b(new_n104_), .O(new_n164_));
