...
module FAU ( 
  ...
  nand2  g085(.a(x27), .b(x00), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n93_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n98_), .c(x29), .O(new_n132_));
  aoi21  g088(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n133_));
  nand2  g089(.a(x30), .b(x00), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n129_), .c(z0), .d(x31), .O(new_n136_));
  nand2  g092(.a(new_n108_), .b(x28), .O(new_n137_));
  nand3  g093(.a(new_n98_), .b(new_n93_), .c(x00), .O(new_n138_));
  ...
  nor2   g098(.a(new_n115_), .b(new_n113_), .O(new_n143_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n122_), .c(new_n127_), .O(new_n150_));
  ...
  oai21  g109(.a(new_n115_), .b(new_n153_), .c(new_n113_), .O(new_n154_));
  nand2  g110(.a(new_n108_), .b(x27), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n148_), .c(x00), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n140_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x32), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n136_), .c(x26), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  nand2  g117(.a(new_n129_), .b(new_n161_), .O(new_n162_));
  nand2  g118(.a(x31), .b(x30), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(x31), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n131_), .c(x29), .O(new_n165_));
  nor2   g121(.a(x31), .b(x30), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n129_), .c(new_n161_), .O(new_n167_));
  ...
  nand2  g128(.a(new_n113_), .b(new_n153_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n171_), .O(new_n174_));
  nand2  g130(.a(new_n115_), .b(x14), .O(new_n175_));
  nor2   g131(.a(new_n113_), .b(new_n112_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n175_), .c(new_n141_), .O(new_n177_));
  nand2  g133(.a(new_n176_), .b(new_n141_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n115_), .O(new_n179_));
  inv1   g135(.a(new_n176_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n149_), .c(new_n127_), .O(new_n181_));
  ...
  nor3   g140(.a(new_n184_), .b(new_n174_), .c(new_n170_), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n161_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n169_), .c(x00), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n165_), .c(x26), .O(z9));
endmodule
