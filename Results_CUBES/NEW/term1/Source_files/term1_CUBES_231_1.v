...
module FAU ( 
  ...
  nand2  g050(.a(new_n77_), .b(x29), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n94_), .c(new_n88_), .O(z5));
  ...
  nand2  g058(.a(new_n77_), .b(x30), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(new_n88_), .O(z6));
  inv1   g060(.a(new_n79_), .O(new_n105_));
  inv1   g061(.a(x31), .O(new_n106_));
  nand3  g062(.a(new_n99_), .b(new_n106_), .c(x30), .O(new_n107_));
  inv1   g063(.a(x29), .O(new_n108_));
  nor2   g064(.a(new_n97_), .b(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x31), .c(new_n88_), .O(new_n111_));
  ...
  aoi21  g106(.a(new_n97_), .b(new_n108_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n87_), .b(x00), .O(new_n156_));
  ...
  nand2  g115(.a(new_n106_), .b(new_n97_), .O(new_n160_));
