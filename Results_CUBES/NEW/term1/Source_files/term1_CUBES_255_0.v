...
module FAU ( 
  ...
  aoi21  g032(.a(x25), .b(new_n50_), .c(new_n47_), .O(new_n77_));
  ...
  nor2   g039(.a(x26), .b(new_n56_), .O(new_n84_));
  nand4  g040(.a(new_n84_), .b(new_n83_), .c(new_n78_), .d(new_n76_), .O(new_n85_));
  inv1   g041(.a(new_n85_), .O(z3));
  xor2a  g042(.a(x28), .b(x27), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n84_), .c(new_n83_), .d(new_n78_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z4));
  inv1   g045(.a(x28), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n76_), .O(new_n91_));
  ...
  nand2  g063(.a(new_n107_), .b(new_n91_), .O(new_n108_));
  nand3  g064(.a(new_n84_), .b(new_n57_), .c(x25), .O(new_n109_));
  aoi21  g065(.a(new_n108_), .b(x31), .c(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n105_), .c(new_n83_), .O(z7));
  ...
  nand2  g084(.a(new_n90_), .b(new_n76_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n97_), .c(x29), .O(new_n130_));
  ...
  nand2  g101(.a(new_n107_), .b(x27), .O(new_n146_));
  oai21  g102(.a(x30), .b(x27), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n90_), .O(new_n148_));
  oai21  g104(.a(x19), .b(x14), .c(x31), .O(new_n149_));
  aoi21  g105(.a(new_n97_), .b(new_n106_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(x19), .b(x13), .c(x18), .O(new_n151_));
  aoi21  g107(.a(new_n107_), .b(x28), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g115(.a(new_n104_), .b(new_n97_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n104_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n131_), .O(new_n162_));
  inv1   g118(.a(new_n131_), .O(new_n163_));
  nand2  g119(.a(x31), .b(x30), .O(new_n164_));
  nand2  g120(.a(x33), .b(new_n104_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n159_), .c(new_n165_), .O(new_n166_));
  aoi21  g122(.a(x18), .b(x12), .c(x17), .O(new_n167_));
  nand2  g123(.a(new_n104_), .b(x30), .O(new_n168_));
  nand2  g124(.a(x31), .b(new_n97_), .O(new_n169_));
