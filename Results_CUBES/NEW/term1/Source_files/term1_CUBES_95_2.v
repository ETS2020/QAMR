// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:47 2020
...
module FAU ( 
  ...
  nor2   g104(.a(new_n136_), .b(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x19), .c(x17), .d(x16), .O(new_n150_));
  aoi21  g106(.a(new_n147_), .b(new_n144_), .c(new_n150_), .O(new_n151_));
  nor2   g107(.a(x32), .b(new_n120_), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(new_n142_), .c(new_n152_), .O(new_n153_));
  nor2   g109(.a(new_n130_), .b(new_n76_), .O(new_n154_));
  nor2   g110(.a(new_n127_), .b(new_n136_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n154_), .c(x17), .O(new_n156_));
  nand3  g112(.a(new_n154_), .b(x17), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n127_), .O(new_n158_));
  nand2  g114(.a(new_n154_), .b(x12), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n128_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .O(new_n161_));
  nand2  g117(.a(new_n154_), .b(x17), .O(new_n162_));
  nand2  g118(.a(x16), .b(x10), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n136_), .O(new_n164_));
  nand3  g120(.a(x30), .b(x29), .c(x27), .O(new_n165_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(x18), .O(new_n180_));
  ...
  aoi21  g144(.a(new_n188_), .b(new_n184_), .c(new_n150_), .O(new_n189_));
  ...
  nand2  g150(.a(new_n194_), .b(new_n155_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n130_), .O(new_n196_));
  inv1   g152(.a(new_n194_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n163_), .c(new_n136_), .O(new_n198_));
  ...
  nand2  g159(.a(new_n130_), .b(x14), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n194_), .c(new_n155_), .O(new_n205_));
  nand2  g161(.a(x18), .b(x12), .O(new_n206_));
  aoi22  g162(.a(new_n206_), .b(new_n128_), .c(new_n76_), .d(new_n148_), .O(new_n207_));
