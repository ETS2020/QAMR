...
module FAU ( 
  ...
  nor2   g039(.a(new_n83_), .b(x03), .O(new_n84_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n81_), .c(x11), .O(new_n126_));
  ...
  nor2   g092(.a(new_n81_), .b(new_n114_), .O(new_n137_));
  ...
  nand2  g137(.a(new_n181_), .b(new_n81_), .O(new_n182_));
