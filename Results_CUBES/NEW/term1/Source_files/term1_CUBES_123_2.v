...
module FAU ( 
  ...
  aoi21  g113(.a(new_n115_), .b(x14), .c(new_n121_), .O(new_n158_));
  nand3  g114(.a(new_n130_), .b(new_n106_), .c(x31), .O(new_n159_));
  nand3  g115(.a(new_n132_), .b(new_n105_), .c(new_n99_), .O(new_n160_));
  inv1   g116(.a(x33), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x19), .c(x11), .O(new_n162_));
  aoi21  g118(.a(new_n160_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(x18), .b(x17), .c(x15), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n163_), .b(new_n158_), .c(new_n165_), .O(new_n166_));
  inv1   g122(.a(x11), .O(new_n167_));
  nand2  g123(.a(x18), .b(x17), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n167_), .c(new_n121_), .O(new_n169_));
  nand2  g125(.a(x16), .b(x15), .O(new_n170_));
  oai21  g126(.a(new_n168_), .b(new_n170_), .c(new_n115_), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n144_), .c(new_n111_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n169_), .O(new_n173_));
  nand2  g129(.a(new_n132_), .b(new_n99_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n105_), .O(new_n175_));
  nand2  g131(.a(new_n130_), .b(new_n106_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x31), .O(new_n177_));
  aoi21  g133(.a(x18), .b(x12), .c(x17), .O(new_n178_));
  nor2   g134(.a(x18), .b(x13), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n177_), .c(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n173_), .c(x33), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n166_), .c(new_n156_), .O(z9));
endmodule
