// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:26 2020
...
module FAU ( 
  ...
  nand2  g063(.a(x30), .b(x29), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n94_), .c(new_n106_), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n96_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n107_), .c(new_n81_), .O(z7));
  ...
  oai21  g085(.a(new_n91_), .b(new_n92_), .c(x30), .O(new_n130_));
  nand3  g086(.a(new_n98_), .b(x29), .c(x27), .O(new_n131_));
  nand2  g087(.a(z0), .b(x31), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  oai21  g089(.a(new_n129_), .b(new_n127_), .c(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n109_), .b(x28), .O(new_n135_));
  nand3  g091(.a(x32), .b(new_n98_), .c(new_n93_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(x27), .O(new_n137_));
  nor2   g093(.a(new_n123_), .b(new_n113_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n125_), .O(new_n139_));
  nor2   g095(.a(new_n117_), .b(new_n115_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(x17), .c(x11), .O(new_n141_));
  nand2  g097(.a(new_n140_), .b(x12), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n114_), .c(new_n141_), .d(new_n123_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n124_), .c(new_n113_), .O(new_n145_));
  inv1   g101(.a(x14), .O(new_n146_));
  aoi21  g102(.a(new_n117_), .b(new_n146_), .c(new_n106_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n147_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  oai21  g105(.a(new_n117_), .b(new_n149_), .c(new_n115_), .O(new_n150_));
  oai21  g106(.a(new_n108_), .b(new_n92_), .c(new_n150_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n145_), .c(new_n143_), .d(new_n139_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(x32), .c(new_n137_), .O(new_n154_));
  inv1   g110(.a(x26), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x00), .O(new_n156_));
  aoi21  g112(.a(new_n154_), .b(new_n134_), .c(new_n156_), .O(z8));
  aoi21  g113(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  inv1   g115(.a(x33), .O(new_n160_));
  oai21  g116(.a(new_n129_), .b(new_n127_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n106_), .b(new_n98_), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n106_), .O(new_n163_));
  ...
  nand2  g124(.a(x18), .b(x12), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n114_), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n98_), .O(new_n171_));
  nand2  g127(.a(new_n115_), .b(new_n149_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .d(new_n168_), .O(new_n173_));
  nor2   g129(.a(new_n115_), .b(new_n114_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n138_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  oai21  g132(.a(x19), .b(new_n146_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n175_), .b(new_n117_), .O(new_n178_));
  inv1   g134(.a(new_n174_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n144_), .c(new_n113_), .O(new_n180_));
  nand2  g136(.a(new_n174_), .b(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n123_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n173_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n160_), .O(new_n185_));
  aoi21  g141(.a(new_n167_), .b(new_n158_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n164_), .c(new_n156_), .O(z9));
endmodule
