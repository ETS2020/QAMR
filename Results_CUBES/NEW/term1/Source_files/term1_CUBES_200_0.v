...
module FAU ( 
  ...
  oai21  g058(.a(new_n102_), .b(new_n92_), .c(new_n100_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n95_), .c(new_n81_), .O(new_n104_));
  ...
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(new_n109_));
  nand2  g065(.a(new_n108_), .b(new_n107_), .O(new_n110_));
  ...
  or2    g086(.a(new_n130_), .b(new_n102_), .O(new_n131_));
  oai21  g087(.a(new_n130_), .b(new_n91_), .c(x30), .O(new_n132_));
  nand2  g088(.a(z0), .b(x31), .O(new_n133_));
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n129_), .b(new_n127_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n125_), .b(x16), .c(x15), .O(new_n136_));
  nand2  g092(.a(x19), .b(x18), .O(new_n137_));
  nand2  g093(.a(x17), .b(x11), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n123_), .O(new_n139_));
  inv1   g095(.a(x12), .O(new_n140_));
  oai21  g096(.a(new_n137_), .b(new_n140_), .c(new_n114_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n139_), .c(new_n136_), .O(new_n142_));
  nand2  g098(.a(x16), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n124_), .c(new_n113_), .O(new_n144_));
  inv1   g100(.a(x28), .O(new_n145_));
  ...
  aoi21  g105(.a(new_n101_), .b(new_n91_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(x19), .b(x13), .c(x18), .O(new_n151_));
  aoi21  g107(.a(new_n108_), .b(x28), .c(new_n151_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n150_), .c(new_n148_), .d(new_n144_), .O(new_n153_));
  ...
  nand2  g113(.a(new_n108_), .b(x31), .O(new_n158_));
  nand3  g114(.a(new_n106_), .b(new_n101_), .c(new_n91_), .O(new_n159_));
  ...
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n123_), .O(new_n164_));
  nand4  g120(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n117_), .O(new_n166_));
  oai21  g122(.a(new_n163_), .b(new_n143_), .c(new_n113_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n115_), .b(new_n140_), .c(new_n114_), .O(new_n170_));
  nor2   g126(.a(new_n108_), .b(new_n106_), .O(new_n171_));
  nor2   g127(.a(x18), .b(x13), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  aoi21  g129(.a(new_n117_), .b(x14), .c(new_n165_), .O(new_n174_));
  aoi21  g130(.a(new_n99_), .b(new_n101_), .c(x31), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n173_), .c(new_n170_), .d(new_n169_), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n98_), .O(new_n178_));
  nand3  g134(.a(new_n106_), .b(x29), .c(x27), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n178_), .c(x28), .O(new_n180_));
  aoi21  g136(.a(new_n177_), .b(x33), .c(new_n180_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n161_), .c(new_n156_), .O(z9));
endmodule
