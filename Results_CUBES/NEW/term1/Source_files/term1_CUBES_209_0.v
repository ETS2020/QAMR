// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:20 2020
...
module FAU ( 
  ...
  nor4   g040(.a(new_n84_), .b(new_n81_), .c(new_n80_), .d(new_n57_), .O(z3));
  inv1   g041(.a(new_n80_), .O(new_n86_));
  xnor2a g042(.a(x28), .b(x27), .O(new_n87_));
  oai22  g043(.a(new_n87_), .b(x02), .c(x27), .d(x03), .O(new_n88_));
  nor2   g044(.a(new_n81_), .b(x26), .O(new_n89_));
  ...
  xor2a  g048(.a(x29), .b(x27), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n47_), .O(new_n94_));
  inv1   g050(.a(x28), .O(new_n95_));
  nor2   g051(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  xor2a  g052(.a(new_n96_), .b(x29), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n50_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  oai21  g056(.a(new_n95_), .b(x02), .c(x03), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n100_), .c(x29), .d(x27), .O(new_n102_));
  aoi21  g058(.a(x29), .b(x27), .c(new_n57_), .O(new_n103_));
  nor2   g059(.a(x28), .b(x02), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(x30), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n102_), .c(new_n92_), .O(z6));
  inv1   g062(.a(x31), .O(new_n107_));
  nand4  g063(.a(new_n96_), .b(new_n107_), .c(x30), .d(x29), .O(new_n108_));
  inv1   g064(.a(x29), .O(new_n109_));
  nor2   g065(.a(new_n100_), .b(new_n109_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n96_), .c(new_n107_), .O(new_n111_));
  nand2  g067(.a(new_n89_), .b(new_n58_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n108_), .c(new_n86_), .O(z7));
  ...
  nand2  g087(.a(new_n95_), .b(new_n83_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n100_), .c(x29), .O(new_n133_));
  ...
  nand2  g104(.a(new_n110_), .b(x27), .O(new_n149_));
  oai21  g105(.a(x30), .b(x27), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n95_), .O(new_n151_));
  oai21  g107(.a(x19), .b(x14), .c(x31), .O(new_n152_));
  aoi21  g108(.a(new_n100_), .b(new_n109_), .c(new_n152_), .O(new_n153_));
  aoi21  g109(.a(x19), .b(x13), .c(x18), .O(new_n154_));
  aoi21  g110(.a(new_n110_), .b(x28), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g125(.a(new_n107_), .b(x30), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n100_), .O(new_n171_));
  inv1   g127(.a(x13), .O(new_n172_));
  nand2  g128(.a(new_n117_), .b(new_n172_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n171_), .c(new_n170_), .O(new_n174_));
  nand2  g130(.a(new_n119_), .b(x14), .O(new_n175_));
  nor2   g131(.a(new_n117_), .b(new_n116_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n175_), .c(new_n139_), .O(new_n177_));
  nand2  g133(.a(new_n176_), .b(new_n139_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n119_), .O(new_n179_));
  inv1   g135(.a(new_n176_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n147_), .c(new_n115_), .O(new_n181_));
  nand2  g137(.a(new_n176_), .b(x11), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n125_), .O(new_n183_));
