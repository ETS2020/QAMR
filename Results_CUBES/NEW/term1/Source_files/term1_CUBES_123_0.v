...
module FAU ( 
  ...
  nand2  g081(.a(new_n111_), .b(x10), .O(new_n126_));
  ...
  aoi21  g093(.a(new_n115_), .b(x14), .c(new_n137_), .O(new_n138_));
  aoi21  g094(.a(new_n137_), .b(new_n115_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(x18), .b(x17), .O(new_n140_));
  nand2  g096(.a(x16), .b(x10), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(new_n111_), .O(new_n142_));
  inv1   g098(.a(x11), .O(new_n143_));
  oai21  g099(.a(new_n140_), .b(new_n143_), .c(new_n121_), .O(new_n144_));
  ...
  nor3   g106(.a(new_n150_), .b(new_n149_), .c(new_n105_), .O(new_n151_));
  ...
  oai21  g114(.a(new_n119_), .b(new_n117_), .c(x15), .O(new_n159_));
  oai21  g115(.a(new_n126_), .b(new_n122_), .c(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n130_), .b(new_n106_), .c(x31), .O(new_n161_));
  nand3  g117(.a(new_n132_), .b(new_n105_), .c(new_n99_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(x33), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand2  g120(.a(new_n130_), .b(new_n106_), .O(new_n165_));
  oai21  g121(.a(new_n140_), .b(new_n111_), .c(new_n115_), .O(new_n166_));
  inv1   g122(.a(x10), .O(new_n167_));
  oai21  g123(.a(new_n140_), .b(new_n167_), .c(new_n111_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  aoi21  g125(.a(new_n165_), .b(x31), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n132_), .b(new_n99_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n105_), .O(new_n172_));
  nor3   g128(.a(new_n152_), .b(new_n150_), .c(new_n138_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n170_), .O(new_n174_));
  nor2   g130(.a(new_n111_), .b(new_n143_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n123_), .c(x16), .O(new_n176_));
  aoi21  g132(.a(new_n174_), .b(x33), .c(new_n176_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n164_), .c(new_n157_), .O(z9));
endmodule
