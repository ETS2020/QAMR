...
module FAU ( 
  ...
  nand4  g022(.a(x06), .b(x04), .c(x03), .d(new_n50_), .O(new_n67_));
  aoi21  g023(.a(new_n67_), .b(new_n66_), .c(new_n56_), .O(new_n68_));
  oai21  g024(.a(new_n68_), .b(new_n63_), .c(new_n55_), .O(new_n69_));
  xnor2a g025(.a(x04), .b(x02), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(x07), .c(x03), .O(new_n71_));
  nand2  g027(.a(x04), .b(new_n50_), .O(new_n72_));
