...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n92_), .c(x30), .O(new_n100_));
  ...
  nor2   g063(.a(new_n107_), .b(new_n91_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n94_), .c(new_n106_), .O(new_n109_));
  aoi21  g065(.a(new_n108_), .b(new_n94_), .c(new_n106_), .O(new_n110_));
  ...
  nand2  g069(.a(new_n93_), .b(new_n92_), .O(new_n114_));
  oai21  g070(.a(x28), .b(x27), .c(x29), .O(new_n115_));
  aoi22  g071(.a(new_n115_), .b(x30), .c(new_n114_), .d(new_n101_), .O(new_n116_));
  ...
  nand2  g078(.a(new_n99_), .b(x30), .O(new_n123_));
  nand3  g079(.a(new_n107_), .b(x29), .c(x28), .O(new_n124_));
  ...
  oai21  g085(.a(new_n122_), .b(new_n116_), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x17), .O(new_n131_));
  nor2   g087(.a(new_n119_), .b(new_n117_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n116_), .O(new_n134_));
  ...
  aoi21  g093(.a(new_n137_), .b(new_n131_), .c(new_n113_), .O(new_n138_));
  nand4  g094(.a(x17), .b(new_n113_), .c(x15), .d(x11), .O(new_n139_));
  ...
  aoi21  g114(.a(new_n107_), .b(new_n91_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(x19), .b(x13), .c(x18), .O(new_n160_));
  aoi21  g116(.a(new_n108_), .b(x28), .c(new_n160_), .O(new_n161_));
  ...
  aoi22  g126(.a(new_n170_), .b(new_n115_), .c(new_n169_), .d(new_n114_), .O(new_n171_));
  nand3  g127(.a(new_n99_), .b(new_n106_), .c(new_n107_), .O(new_n172_));
  ...
  oai21  g131(.a(new_n171_), .b(new_n122_), .c(new_n175_), .O(new_n176_));
  ...
  aoi21  g135(.a(new_n179_), .b(new_n177_), .c(new_n113_), .O(new_n180_));
  ...
  nand2  g139(.a(new_n114_), .b(new_n108_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x31), .O(new_n185_));
  nor2   g141(.a(new_n117_), .b(new_n152_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x16), .c(x15), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n119_), .O(new_n188_));
