...
module FAU ( 
  ...
  nand4  g074(.a(x18), .b(x17), .c(new_n113_), .d(x10), .O(new_n119_));
  ...
  nand3  g082(.a(new_n112_), .b(x15), .c(x11), .O(new_n127_));
  ...
  nand4  g093(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n113_), .O(new_n139_));
  nand3  g095(.a(new_n125_), .b(x17), .c(x11), .O(new_n140_));
  ...
  nor3   g099(.a(new_n126_), .b(new_n112_), .c(new_n113_), .O(new_n144_));
