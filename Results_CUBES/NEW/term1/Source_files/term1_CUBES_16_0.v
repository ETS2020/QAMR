...
module FAU ( 
  ...
  oai22  g033(.a(x24), .b(x19), .c(x23), .d(x18), .O(new_n78_));
  ...
  nor2   g039(.a(new_n83_), .b(x02), .O(new_n84_));
  aoi21  g040(.a(new_n80_), .b(new_n57_), .c(new_n84_), .O(new_n85_));
  nand2  g041(.a(x25), .b(x01), .O(new_n86_));
  nor4   g042(.a(new_n86_), .b(new_n85_), .c(x27), .d(x26), .O(z3));
  xor2a  g043(.a(x28), .b(x27), .O(new_n88_));
  nor2   g044(.a(new_n86_), .b(x26), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n85_), .O(z4));
  ...
  nand2  g051(.a(new_n95_), .b(new_n89_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n85_), .O(z5));
  ...
  nor2   g059(.a(new_n103_), .b(new_n85_), .O(z6));
  nand3  g060(.a(new_n83_), .b(new_n79_), .c(new_n77_), .O(new_n105_));
  ...
  nand3  g068(.a(new_n112_), .b(new_n107_), .c(new_n105_), .O(z7));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n122_), .c(new_n81_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n81_), .c(x10), .O(new_n128_));
  ...
  nor2   g092(.a(new_n123_), .b(new_n81_), .O(new_n137_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n124_), .c(new_n81_), .O(new_n146_));
  ...
  aoi21  g106(.a(new_n98_), .b(new_n108_), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n145_), .c(new_n81_), .O(new_n180_));
