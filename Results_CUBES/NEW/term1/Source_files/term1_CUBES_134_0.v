...
module FAU ( 
  ...
  nand2  g011(.a(x05), .b(new_n47_), .O(new_n56_));
  inv1   g012(.a(new_n56_), .O(new_n57_));
  nand2  g013(.a(new_n57_), .b(x02), .O(new_n58_));
  nand3  g014(.a(x06), .b(x03), .c(new_n50_), .O(new_n59_));
  ...
  oai21  g019(.a(new_n61_), .b(new_n63_), .c(x01), .O(new_n64_));
  oai21  g020(.a(new_n62_), .b(x05), .c(new_n64_), .O(new_n65_));
  oai21  g021(.a(new_n65_), .b(new_n60_), .c(new_n55_), .O(new_n66_));
  xor2a  g022(.a(x07), .b(x04), .O(new_n67_));
  inv1   g023(.a(x01), .O(new_n68_));
  xnor2a g024(.a(x03), .b(x02), .O(new_n69_));
  nand2  g025(.a(new_n57_), .b(new_n50_), .O(new_n70_));
  nand2  g026(.a(new_n56_), .b(x02), .O(new_n71_));
  nand3  g027(.a(new_n71_), .b(new_n70_), .c(x06), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n68_), .O(new_n73_));
  oai21  g029(.a(new_n69_), .b(new_n68_), .c(new_n73_), .O(new_n74_));
  ...
  inv1   g034(.a(new_n63_), .O(new_n79_));
