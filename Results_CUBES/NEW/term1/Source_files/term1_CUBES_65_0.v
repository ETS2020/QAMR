...
module FAU ( 
  ...
  nand3  g038(.a(new_n82_), .b(new_n81_), .c(x25), .O(new_n83_));
  nor4   g039(.a(new_n83_), .b(new_n80_), .c(x02), .d(new_n56_), .O(z3));
  xnor2a g040(.a(x28), .b(x27), .O(new_n85_));
  oai22  g041(.a(new_n85_), .b(x02), .c(x28), .d(x03), .O(new_n86_));
  nand3  g042(.a(new_n81_), .b(x25), .c(x01), .O(new_n87_));
  ...
  nand2  g048(.a(x29), .b(new_n92_), .O(new_n93_));
  ...
  nor2   g053(.a(new_n92_), .b(new_n82_), .O(new_n98_));
  oai22  g054(.a(new_n98_), .b(new_n94_), .c(new_n95_), .d(new_n82_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n50_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n97_), .c(new_n91_), .O(z5));
  inv1   g057(.a(x30), .O(new_n102_));
  oai21  g058(.a(new_n82_), .b(x02), .c(x03), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n102_), .c(x29), .d(x28), .O(new_n104_));
  aoi21  g060(.a(x29), .b(x28), .c(new_n57_), .O(new_n105_));
  nor2   g061(.a(x27), .b(x02), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n105_), .c(x30), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n104_), .c(new_n91_), .O(z6));
  inv1   g064(.a(new_n80_), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand4  g066(.a(new_n98_), .b(new_n110_), .c(x30), .d(x29), .O(new_n111_));
  nor2   g067(.a(new_n102_), .b(new_n94_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n98_), .c(new_n110_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n87_), .c(new_n57_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n111_), .c(new_n109_), .O(z7));
  ...
  nand2  g088(.a(new_n92_), .b(new_n82_), .O(new_n133_));
  ...
  oai21  g106(.a(x30), .b(x28), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n82_), .O(new_n152_));
  oai21  g108(.a(x19), .b(x14), .c(x31), .O(new_n153_));
  aoi21  g109(.a(new_n102_), .b(new_n94_), .c(new_n153_), .O(new_n154_));
  aoi21  g110(.a(x19), .b(x13), .c(x18), .O(new_n155_));
  aoi21  g111(.a(new_n112_), .b(x27), .c(new_n155_), .O(new_n156_));
  ...
  nand2  g114(.a(new_n81_), .b(x00), .O(new_n159_));
  ...
  oai22  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n110_), .O(new_n164_));
