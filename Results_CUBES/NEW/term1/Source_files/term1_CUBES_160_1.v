...
module FAU ( 
  ...
  oai21  g069(.a(new_n80_), .b(new_n113_), .c(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n84_), .c(new_n111_), .d(new_n110_), .O(new_n115_));
  nor2   g071(.a(x31), .b(new_n102_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nor2   g074(.a(new_n102_), .b(new_n96_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n98_), .c(new_n118_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n100_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n117_), .c(new_n115_), .O(z7));
  nand4  g078(.a(x19), .b(new_n112_), .c(x16), .d(x13), .O(new_n123_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n102_), .c(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n133_), .c(z0), .d(x31), .O(new_n139_));
  nand2  g095(.a(new_n131_), .b(x12), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n82_), .O(new_n141_));
  nand3  g097(.a(new_n131_), .b(x17), .c(x10), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n130_), .O(new_n143_));
  nand2  g099(.a(new_n102_), .b(new_n96_), .O(new_n144_));
  inv1   g100(.a(x16), .O(new_n145_));
  nor2   g101(.a(x19), .b(x14), .O(new_n146_));
  nor3   g102(.a(new_n146_), .b(new_n118_), .c(new_n145_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n144_), .c(new_n143_), .d(new_n141_), .O(new_n148_));
  nand2  g104(.a(new_n119_), .b(x27), .O(new_n149_));
  oai21  g105(.a(x30), .b(x27), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n97_), .O(new_n151_));
  nand2  g107(.a(new_n119_), .b(x28), .O(new_n152_));
  aoi21  g108(.a(x19), .b(x13), .c(x18), .O(new_n153_));
  nor2   g109(.a(new_n82_), .b(new_n130_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n131_), .c(new_n153_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n152_), .c(new_n151_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n148_), .c(x32), .O(new_n157_));
  nand2  g113(.a(new_n77_), .b(x00), .O(new_n158_));
  aoi21  g114(.a(new_n157_), .b(new_n139_), .c(new_n158_), .O(z8));
  inv1   g115(.a(x33), .O(new_n160_));
  nand2  g116(.a(new_n133_), .b(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n118_), .b(new_n102_), .O(new_n162_));
  ...
  nor2   g121(.a(new_n118_), .b(new_n102_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n133_), .c(new_n160_), .O(new_n167_));
  ...
  oai22  g126(.a(new_n118_), .b(x30), .c(x18), .d(x13), .O(new_n171_));
  nor4   g127(.a(new_n171_), .b(new_n170_), .c(new_n116_), .d(new_n145_), .O(new_n172_));
  inv1   g128(.a(x10), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n173_), .c(new_n130_), .O(new_n175_));
  nand2  g131(.a(new_n124_), .b(x14), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n154_), .c(x18), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n130_), .c(new_n124_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n177_), .c(new_n175_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n172_), .c(new_n160_), .O(new_n181_));
  aoi21  g137(.a(new_n169_), .b(new_n137_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n165_), .c(new_n158_), .O(z9));
endmodule
