// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:40 2020
...
module FAU ( 
  ...
  oai22  g043(.a(new_n87_), .b(x03), .c(new_n81_), .d(x02), .O(new_n88_));
  ...
  aoi22  g051(.a(new_n95_), .b(new_n47_), .c(x29), .d(new_n50_), .O(new_n96_));
  ...
  nand2  g058(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g059(.a(x30), .b(new_n50_), .O(new_n104_));
