// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:46 2020
...
module FAU ( 
  ...
  nor2   g039(.a(new_n78_), .b(new_n76_), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  inv1   g042(.a(x27), .O(new_n87_));
  nand2  g043(.a(new_n77_), .b(new_n87_), .O(new_n88_));
  inv1   g044(.a(x26), .O(new_n89_));
  nand4  g045(.a(new_n57_), .b(new_n89_), .c(x25), .d(x01), .O(new_n90_));
  aoi21  g046(.a(new_n88_), .b(new_n86_), .c(new_n90_), .O(z4));
  xor2a  g047(.a(x29), .b(x27), .O(new_n92_));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n93_), .c(new_n90_), .O(z5));
  aoi21  g054(.a(x29), .b(x27), .c(new_n79_), .O(new_n99_));
  nor2   g055(.a(new_n84_), .b(x28), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n99_), .c(x30), .O(new_n101_));
  nor2   g057(.a(new_n84_), .b(new_n94_), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  nor3   g059(.a(x30), .b(new_n103_), .c(new_n87_), .O(new_n104_));
  oai21  g060(.a(new_n102_), .b(new_n77_), .c(new_n104_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n101_), .c(new_n90_), .O(z6));
  inv1   g062(.a(new_n79_), .O(new_n107_));
  inv1   g063(.a(x31), .O(new_n108_));
  nand4  g064(.a(new_n95_), .b(new_n108_), .c(x30), .d(x29), .O(new_n109_));
  inv1   g065(.a(x30), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n103_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n95_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x31), .c(new_n90_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n109_), .c(new_n107_), .O(z7));
  ...
  nand2  g087(.a(new_n94_), .b(new_n87_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n110_), .c(x29), .O(new_n133_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  oai21  g107(.a(x19), .b(x14), .c(x31), .O(new_n152_));
  aoi21  g108(.a(new_n110_), .b(new_n103_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g113(.a(new_n89_), .b(x00), .O(new_n158_));
  ...
  nand2  g117(.a(new_n108_), .b(new_n110_), .O(new_n162_));
