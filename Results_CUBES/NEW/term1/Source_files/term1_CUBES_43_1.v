...
module FAU ( 
  ...
  oai22  g034(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n79_));
  inv1   g035(.a(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  oai21  g037(.a(x18), .b(x02), .c(x03), .O(new_n82_));
  ...
  nand3  g071(.a(x19), .b(new_n103_), .c(x13), .O(new_n116_));
  ...
  nor2   g094(.a(new_n117_), .b(new_n103_), .O(new_n139_));
  ...
  nand2  g127(.a(new_n103_), .b(new_n171_), .O(new_n172_));
