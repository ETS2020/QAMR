// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:36 2020
...
module FAU ( 
  ...
  nor3   g038(.a(new_n82_), .b(new_n78_), .c(new_n77_), .O(new_n83_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n101_), .c(new_n84_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z6));
  inv1   g064(.a(new_n77_), .O(new_n109_));
  inv1   g065(.a(x17), .O(new_n110_));
  inv1   g066(.a(x22), .O(new_n111_));
  oai21  g067(.a(new_n78_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n81_), .c(new_n109_), .O(new_n113_));
  inv1   g069(.a(x31), .O(new_n114_));
  nand3  g070(.a(new_n104_), .b(new_n114_), .c(x30), .O(new_n115_));
  nor2   g071(.a(new_n102_), .b(new_n94_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n97_), .c(new_n114_), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n99_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n115_), .c(new_n113_), .O(z7));
  inv1   g075(.a(x15), .O(new_n120_));
  nand3  g076(.a(x19), .b(new_n79_), .c(x13), .O(new_n121_));
  inv1   g077(.a(x19), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x18), .c(x14), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(new_n110_), .O(new_n124_));
  nand4  g080(.a(x19), .b(x18), .c(new_n110_), .d(x12), .O(new_n125_));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n127_), .c(new_n120_), .O(new_n132_));
  nand3  g088(.a(x16), .b(new_n120_), .c(x10), .O(new_n133_));
  ...
  nor2   g097(.a(new_n128_), .b(new_n120_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n130_), .O(new_n143_));
  nor2   g099(.a(new_n122_), .b(new_n79_), .O(new_n144_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n129_), .c(new_n120_), .O(new_n151_));
  nand2  g107(.a(new_n116_), .b(x27), .O(new_n152_));
  oai21  g108(.a(x30), .b(x27), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  inv1   g110(.a(x14), .O(new_n155_));
  nand2  g111(.a(new_n122_), .b(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x31), .O(new_n157_));
  aoi21  g113(.a(new_n102_), .b(new_n94_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(x19), .b(x13), .c(x18), .O(new_n159_));
  aoi21  g115(.a(new_n116_), .b(x28), .c(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n154_), .d(new_n151_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n149_), .c(x32), .O(new_n162_));
  ...
  oai21  g122(.a(new_n134_), .b(new_n132_), .c(new_n166_), .O(new_n167_));
  nand2  g123(.a(new_n114_), .b(new_n102_), .O(new_n168_));
  oai22  g124(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n114_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n137_), .O(new_n170_));
  inv1   g126(.a(new_n137_), .O(new_n171_));
  ...
  aoi21  g130(.a(x19), .b(x12), .c(x17), .O(new_n175_));
  nand2  g131(.a(new_n114_), .b(x30), .O(new_n176_));
  nand2  g132(.a(x31), .b(new_n102_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n156_), .c(new_n176_), .O(new_n178_));
  nand2  g134(.a(new_n79_), .b(x13), .O(new_n179_));
  nor2   g135(.a(new_n122_), .b(new_n110_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n142_), .c(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n180_), .b(new_n142_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n79_), .O(new_n183_));
  inv1   g139(.a(new_n180_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n150_), .c(new_n120_), .O(new_n185_));
  ...
  nor3   g144(.a(new_n188_), .b(new_n178_), .c(new_n175_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n166_), .O(new_n190_));
  aoi21  g146(.a(new_n174_), .b(new_n171_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n170_), .c(new_n164_), .O(z9));
endmodule
