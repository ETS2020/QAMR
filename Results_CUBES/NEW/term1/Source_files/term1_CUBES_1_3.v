...
module FAU ( 
  ...
  nand4  g082(.a(x19), .b(x18), .c(new_n126_), .d(x11), .O(new_n127_));
  ...
  nand4  g094(.a(x17), .b(x16), .c(new_n112_), .d(x10), .O(new_n139_));
  ...
  nor2   g100(.a(new_n126_), .b(new_n112_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n132_), .c(x17), .O(new_n146_));
  nand3  g102(.a(new_n132_), .b(x17), .c(x11), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n126_), .O(new_n148_));
  inv1   g104(.a(x17), .O(new_n149_));
  oai21  g105(.a(new_n133_), .b(new_n135_), .c(new_n149_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .O(new_n151_));
  nand2  g107(.a(new_n132_), .b(x17), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n112_), .O(new_n154_));
  ...
  nor2   g141(.a(new_n116_), .b(new_n149_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n145_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n118_), .O(new_n188_));
  inv1   g144(.a(new_n186_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n153_), .c(new_n112_), .O(new_n190_));
  ...
  nand3  g152(.a(new_n196_), .b(new_n186_), .c(new_n145_), .O(new_n197_));
  ...
  aoi21  g158(.a(new_n202_), .b(new_n183_), .c(new_n165_), .O(z9));
endmodule
