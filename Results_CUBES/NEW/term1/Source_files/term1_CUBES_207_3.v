...
module FAU ( 
  ...
  nand3  g052(.a(x29), .b(x28), .c(x27), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(new_n98_));
  ...
  nor2   g076(.a(x30), .b(new_n77_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(x28), .c(x29), .O(new_n122_));
  ...
  nand2  g117(.a(new_n123_), .b(x31), .O(new_n162_));
  ...
  nand4  g124(.a(new_n168_), .b(new_n166_), .c(new_n161_), .d(new_n122_), .O(new_n169_));
