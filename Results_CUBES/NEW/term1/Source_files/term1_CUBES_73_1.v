...
module FAU ( 
  ...
  nand2  g056(.a(new_n98_), .b(x29), .O(new_n101_));
  oai22  g057(.a(new_n101_), .b(new_n92_), .c(new_n100_), .d(new_n98_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n95_), .c(new_n81_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(z6));
  inv1   g060(.a(x31), .O(new_n105_));
  nand3  g061(.a(new_n100_), .b(new_n105_), .c(x30), .O(new_n106_));
  nor2   g062(.a(new_n98_), .b(new_n91_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x27), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x31), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n106_), .c(new_n95_), .d(new_n81_), .O(z7));
  ...
  nand2  g083(.a(x30), .b(new_n91_), .O(new_n128_));
  nand2  g084(.a(z0), .b(x31), .O(new_n129_));
  aoi21  g085(.a(new_n128_), .b(new_n101_), .c(new_n129_), .O(new_n130_));
  oai21  g086(.a(new_n127_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  nand3  g087(.a(new_n123_), .b(x16), .c(x15), .O(new_n132_));
  nand2  g088(.a(x19), .b(x18), .O(new_n133_));
  nand2  g089(.a(x17), .b(x11), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n121_), .O(new_n135_));
  inv1   g091(.a(x12), .O(new_n136_));
  oai21  g092(.a(new_n133_), .b(new_n136_), .c(new_n112_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(new_n132_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n122_), .c(new_n111_), .O(new_n140_));
  inv1   g096(.a(x13), .O(new_n141_));
  oai21  g097(.a(new_n115_), .b(new_n141_), .c(new_n113_), .O(new_n142_));
  nor2   g098(.a(new_n107_), .b(new_n105_), .O(new_n143_));
  inv1   g099(.a(x14), .O(new_n144_));
  aoi22  g100(.a(new_n98_), .b(new_n91_), .c(new_n115_), .d(new_n144_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n142_), .d(new_n140_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n138_), .c(x32), .O(new_n147_));
  inv1   g103(.a(x26), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x00), .O(new_n149_));
  aoi21  g105(.a(new_n147_), .b(new_n131_), .c(new_n149_), .O(z8));
  oai22  g106(.a(x31), .b(x29), .c(x28), .d(x27), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n98_), .O(new_n152_));
  nand2  g108(.a(new_n107_), .b(x31), .O(new_n153_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n121_), .O(new_n158_));
  nand4  g114(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n115_), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n139_), .c(new_n111_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n158_), .O(new_n162_));
  oai21  g118(.a(new_n113_), .b(new_n136_), .c(new_n112_), .O(new_n163_));
  nand2  g119(.a(new_n105_), .b(x30), .O(new_n164_));
  nand2  g120(.a(x31), .b(new_n91_), .O(new_n165_));
  nand2  g121(.a(new_n113_), .b(new_n141_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n115_), .b(x14), .c(new_n159_), .O(new_n169_));
  nand2  g125(.a(new_n98_), .b(x28), .O(new_n170_));
  nand2  g126(.a(new_n105_), .b(x27), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(x29), .c(new_n169_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n168_), .c(new_n163_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n162_), .c(x33), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n155_), .c(new_n149_), .O(z9));
endmodule
