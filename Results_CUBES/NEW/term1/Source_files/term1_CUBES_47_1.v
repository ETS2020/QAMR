// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:08 2020
...
module FAU ( 
  ...
  nand3  g043(.a(x28), .b(new_n87_), .c(x01), .O(new_n88_));
  oai21  g044(.a(x28), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  inv1   g045(.a(x26), .O(new_n90_));
  nand3  g046(.a(new_n57_), .b(new_n90_), .c(x25), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n83_), .O(z4));
  inv1   g050(.a(x29), .O(new_n95_));
  inv1   g051(.a(x28), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n87_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n95_), .c(new_n56_), .O(new_n98_));
  nor3   g054(.a(x29), .b(new_n96_), .c(new_n87_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n98_), .c(new_n92_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n83_), .O(z5));
  nand2  g057(.a(new_n97_), .b(x29), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x30), .c(x01), .O(new_n103_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n92_), .c(new_n82_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z6));
  inv1   g064(.a(x31), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x30), .O(new_n110_));
  or2    g066(.a(new_n110_), .b(new_n102_), .O(new_n111_));
  nor2   g067(.a(new_n104_), .b(new_n95_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n97_), .O(new_n113_));
  nand4  g069(.a(new_n57_), .b(new_n90_), .c(x25), .d(x01), .O(new_n114_));
  aoi21  g070(.a(new_n113_), .b(x31), .c(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n111_), .c(new_n82_), .O(z7));
  ...
  nand2  g089(.a(new_n96_), .b(new_n87_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n104_), .c(x29), .O(new_n135_));
  ...
  aoi21  g110(.a(new_n104_), .b(new_n95_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g115(.a(new_n90_), .b(x00), .O(new_n160_));
  ...
  nand2  g119(.a(new_n109_), .b(new_n104_), .O(new_n164_));
  oai22  g120(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n109_), .O(new_n165_));
  ...
  nand2  g127(.a(x31), .b(new_n104_), .O(new_n172_));
  inv1   g128(.a(x13), .O(new_n173_));
  nand2  g129(.a(new_n119_), .b(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n172_), .c(new_n110_), .O(new_n175_));
  nand2  g131(.a(new_n121_), .b(x14), .O(new_n176_));
  nor2   g132(.a(new_n119_), .b(new_n118_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n176_), .c(new_n141_), .O(new_n178_));
  nand2  g134(.a(new_n177_), .b(new_n141_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n121_), .O(new_n180_));
  inv1   g136(.a(new_n177_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n149_), .c(new_n117_), .O(new_n182_));
  nand2  g138(.a(new_n177_), .b(x11), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n127_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n182_), .c(new_n180_), .d(new_n178_), .O(new_n185_));
  nor3   g141(.a(new_n185_), .b(new_n175_), .c(new_n171_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n162_), .O(new_n187_));
  aoi21  g143(.a(new_n170_), .b(new_n167_), .c(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n166_), .c(new_n160_), .O(z9));
endmodule
