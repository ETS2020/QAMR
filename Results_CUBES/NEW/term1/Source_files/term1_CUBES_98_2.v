// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:49 2020
...
module FAU ( 
  ...
  nand2  g002(.a(x03), .b(new_n46_), .O(new_n47_));
  ...
  nand4  g012(.a(x06), .b(x03), .c(new_n46_), .d(new_n56_), .O(new_n57_));
  ...
  nor2   g016(.a(x02), .b(new_n56_), .O(new_n61_));
  ...
  aoi21  g023(.a(new_n63_), .b(new_n67_), .c(x02), .O(new_n68_));
