...
module FAU ( 
  ...
  nor2   g061(.a(new_n97_), .b(new_n91_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n92_), .c(new_n104_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n94_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n105_), .c(new_n81_), .O(z7));
  ...
  aoi21  g087(.a(new_n130_), .b(new_n129_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g100(.a(new_n106_), .b(x27), .O(new_n145_));
  ...
  aoi21  g104(.a(new_n97_), .b(new_n91_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(x19), .b(x13), .c(x18), .O(new_n150_));
  aoi21  g106(.a(new_n106_), .b(x28), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g113(.a(new_n126_), .b(new_n124_), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(x31), .b(x30), .O(new_n159_));
  nand3  g115(.a(x33), .b(new_n104_), .c(x29), .O(new_n160_));
  oai21  g116(.a(new_n159_), .b(new_n158_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n128_), .O(new_n162_));
  inv1   g118(.a(new_n158_), .O(new_n163_));
  nand3  g119(.a(new_n127_), .b(new_n104_), .c(new_n97_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n114_), .b(x14), .O(new_n166_));
  nand2  g122(.a(x18), .b(x17), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n166_), .c(new_n134_), .O(new_n169_));
  nand2  g125(.a(x18), .b(x12), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n111_), .O(new_n171_));
  inv1   g127(.a(x13), .O(new_n172_));
  aoi22  g128(.a(new_n104_), .b(x30), .c(new_n112_), .d(new_n172_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(new_n174_));
  oai21  g130(.a(new_n127_), .b(new_n97_), .c(x31), .O(new_n175_));
  nand2  g131(.a(new_n168_), .b(new_n134_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n114_), .O(new_n177_));
  oai21  g133(.a(new_n167_), .b(new_n142_), .c(new_n110_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n167_), .b(new_n179_), .c(new_n120_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n174_), .c(x33), .O(new_n182_));
  oai21  g138(.a(new_n104_), .b(x29), .c(new_n182_), .O(new_n183_));
  aoi21  g139(.a(new_n165_), .b(new_n163_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n162_), .c(new_n155_), .O(z9));
endmodule
