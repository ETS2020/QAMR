// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:22 2020
...
module FAU ( 
  ...
  nor4   g047(.a(new_n91_), .b(new_n88_), .c(new_n87_), .d(new_n57_), .O(z3));
  nand3  g048(.a(new_n58_), .b(x28), .c(new_n90_), .O(new_n93_));
  oai21  g049(.a(x28), .b(new_n90_), .c(new_n93_), .O(new_n94_));
  nor2   g050(.a(new_n88_), .b(x26), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n87_), .O(z4));
  inv1   g053(.a(x28), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  oai22  g055(.a(new_n99_), .b(x03), .c(x27), .d(x02), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(x29), .O(new_n101_));
  inv1   g057(.a(x29), .O(new_n102_));
  nand2  g058(.a(new_n99_), .b(new_n102_), .O(new_n103_));
  nand2  g059(.a(new_n95_), .b(new_n86_), .O(new_n104_));
  aoi21  g060(.a(new_n103_), .b(new_n101_), .c(new_n104_), .O(z5));
  nor2   g061(.a(new_n57_), .b(x27), .O(new_n106_));
  aoi21  g062(.a(x29), .b(x28), .c(x03), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n106_), .c(x30), .O(new_n108_));
  inv1   g064(.a(x30), .O(new_n109_));
  nand3  g065(.a(new_n99_), .b(new_n109_), .c(x29), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n104_), .O(z6));
  inv1   g067(.a(x31), .O(new_n112_));
  nand4  g068(.a(new_n99_), .b(new_n112_), .c(x30), .d(x29), .O(new_n113_));
  nor2   g069(.a(new_n109_), .b(new_n102_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n99_), .c(new_n112_), .O(new_n115_));
  nand2  g071(.a(new_n95_), .b(new_n58_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n113_), .c(new_n86_), .O(z7));
  ...
  nand2  g091(.a(new_n98_), .b(new_n90_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n109_), .c(x29), .O(new_n137_));
  ...
  nand2  g108(.a(new_n114_), .b(x28), .O(new_n153_));
  oai21  g109(.a(x30), .b(x28), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n90_), .O(new_n155_));
  oai21  g111(.a(x19), .b(x14), .c(x31), .O(new_n156_));
  aoi21  g112(.a(new_n109_), .b(new_n102_), .c(new_n156_), .O(new_n157_));
  aoi21  g113(.a(x19), .b(x13), .c(x18), .O(new_n158_));
  aoi21  g114(.a(new_n114_), .b(x27), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g117(.a(new_n89_), .b(x00), .O(new_n162_));
  ...
  nand2  g121(.a(new_n112_), .b(new_n109_), .O(new_n166_));
  ...
  nand2  g130(.a(x31), .b(new_n109_), .O(new_n175_));
