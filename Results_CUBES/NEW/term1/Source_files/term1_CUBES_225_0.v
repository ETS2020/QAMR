// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:33 2020
...
module FAU ( 
  ...
  nor2   g037(.a(x30), .b(x28), .O(new_n82_));
  ...
  nor3   g050(.a(new_n94_), .b(new_n93_), .c(new_n91_), .O(z5));
  inv1   g051(.a(new_n94_), .O(new_n96_));
  inv1   g052(.a(x27), .O(new_n97_));
  inv1   g053(.a(x28), .O(new_n98_));
  inv1   g054(.a(x30), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(x29), .c(new_n98_), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n97_), .c(x30), .O(new_n102_));
  oai21  g058(.a(new_n100_), .b(new_n97_), .c(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n96_), .c(new_n81_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z6));
  inv1   g061(.a(x31), .O(new_n106_));
  inv1   g062(.a(new_n92_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n106_), .c(x30), .d(x29), .O(new_n108_));
  nor2   g064(.a(new_n99_), .b(new_n101_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x31), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n108_), .c(new_n96_), .d(new_n81_), .O(z7));
  ...
  nand2  g085(.a(x30), .b(new_n101_), .O(new_n130_));
  aoi22  g086(.a(new_n99_), .b(x29), .c(new_n98_), .d(new_n97_), .O(new_n131_));
  ...
  oai21  g090(.a(x28), .b(x27), .c(new_n109_), .O(new_n135_));
  ...
  oai21  g095(.a(new_n136_), .b(new_n139_), .c(new_n114_), .O(new_n140_));
  nor2   g096(.a(new_n123_), .b(new_n113_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n125_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n140_), .c(new_n138_), .d(new_n135_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n124_), .c(new_n113_), .O(new_n145_));
  inv1   g101(.a(x13), .O(new_n146_));
  oai21  g102(.a(new_n117_), .b(new_n146_), .c(new_n115_), .O(new_n147_));
  nand2  g103(.a(new_n99_), .b(new_n101_), .O(new_n148_));
  inv1   g104(.a(x14), .O(new_n149_));
  aoi21  g105(.a(new_n117_), .b(new_n149_), .c(new_n106_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n152_), .b(new_n134_), .c(new_n154_), .O(z8));
  nand2  g111(.a(new_n98_), .b(new_n97_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n109_), .c(x31), .O(new_n157_));
  nand3  g113(.a(new_n106_), .b(new_n99_), .c(new_n101_), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(x33), .O(new_n159_));
  oai21  g115(.a(new_n129_), .b(new_n127_), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(x31), .b(new_n101_), .O(new_n161_));
  aoi22  g117(.a(new_n106_), .b(x30), .c(new_n115_), .d(new_n146_), .O(new_n162_));
  oai21  g118(.a(new_n115_), .b(new_n139_), .c(new_n114_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n131_), .O(new_n164_));
  nand2  g120(.a(new_n117_), .b(x14), .O(new_n165_));
  nor2   g121(.a(new_n115_), .b(new_n114_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n165_), .c(new_n141_), .O(new_n167_));
  nand2  g123(.a(new_n166_), .b(new_n141_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n117_), .O(new_n169_));
  inv1   g125(.a(new_n166_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n144_), .c(new_n113_), .O(new_n171_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n164_), .c(x33), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n160_), .c(new_n154_), .O(z9));
endmodule
