// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:23 2020
...
module FAU ( 
  ...
  nand3  g043(.a(x28), .b(new_n77_), .c(x25), .O(new_n88_));
  oai21  g044(.a(x28), .b(new_n77_), .c(new_n88_), .O(new_n89_));
  ...
  nor2   g049(.a(new_n92_), .b(new_n77_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  oai21  g051(.a(new_n93_), .b(x27), .c(new_n95_), .O(new_n96_));
  aoi22  g052(.a(new_n96_), .b(x25), .c(x29), .d(new_n92_), .O(new_n97_));
  inv1   g053(.a(new_n81_), .O(new_n98_));
  nand3  g054(.a(new_n85_), .b(new_n98_), .c(new_n58_), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n97_), .O(z5));
  oai21  g056(.a(new_n93_), .b(new_n77_), .c(x30), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  nand3  g058(.a(new_n94_), .b(new_n102_), .c(x29), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x25), .O(new_n105_));
  nand2  g061(.a(x30), .b(new_n92_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n99_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand4  g064(.a(new_n94_), .b(new_n108_), .c(x30), .d(x29), .O(new_n109_));
  nor2   g065(.a(new_n102_), .b(new_n93_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n94_), .c(new_n108_), .O(new_n111_));
  nand3  g067(.a(new_n85_), .b(new_n58_), .c(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n109_), .c(new_n98_), .O(z7));
  ...
  nand2  g087(.a(new_n92_), .b(new_n77_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n102_), .c(x29), .O(new_n133_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n92_), .O(new_n151_));
  oai21  g107(.a(x19), .b(x14), .c(x31), .O(new_n152_));
  aoi21  g108(.a(new_n102_), .b(new_n93_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g118(.a(new_n108_), .b(new_n102_), .O(new_n163_));
