...
module FAU ( 
  ...
  nand2  g046(.a(x28), .b(new_n77_), .O(new_n91_));
  inv1   g047(.a(x28), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(x27), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nor2   g050(.a(new_n87_), .b(x26), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n94_), .c(new_n86_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(z4));
  inv1   g053(.a(new_n84_), .O(new_n98_));
  inv1   g054(.a(x29), .O(new_n99_));
  nor2   g055(.a(new_n92_), .b(new_n77_), .O(new_n100_));
  xor2a  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g057(.a(new_n95_), .b(new_n57_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n101_), .c(new_n98_), .O(z5));
  inv1   g059(.a(x30), .O(new_n104_));
  aoi21  g060(.a(new_n100_), .b(x29), .c(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n100_), .b(new_n104_), .c(x29), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n102_), .b(new_n98_), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n105_), .c(new_n108_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z6));
  nand3  g066(.a(new_n88_), .b(new_n92_), .c(new_n76_), .O(new_n111_));
  inv1   g067(.a(x31), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x30), .c(x29), .O(new_n113_));
  oai21  g069(.a(new_n111_), .b(new_n85_), .c(new_n113_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x27), .O(new_n115_));
  nand3  g071(.a(x30), .b(x29), .c(x27), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(x31), .c(new_n102_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n115_), .c(new_n84_), .O(z7));
  ...
  nand3  g089(.a(x16), .b(new_n133_), .c(x10), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n129_), .O(new_n135_));
  aoi21  g091(.a(new_n132_), .b(x15), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(z0), .b(x31), .c(new_n104_), .O(new_n137_));
  nand2  g093(.a(x32), .b(x30), .O(new_n138_));
  oai21  g094(.a(new_n137_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n92_), .b(new_n77_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x29), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  inv1   g099(.a(new_n136_), .O(new_n144_));
  nand2  g100(.a(x31), .b(new_n99_), .O(new_n145_));
  nand2  g101(.a(z0), .b(x30), .O(new_n146_));
  aoi21  g102(.a(new_n145_), .b(new_n140_), .c(new_n146_), .O(new_n147_));
  nor3   g103(.a(new_n129_), .b(new_n128_), .c(new_n133_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x18), .O(new_n149_));
  nand2  g105(.a(x17), .b(x11), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n128_), .O(new_n151_));
  inv1   g107(.a(x12), .O(new_n152_));
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n119_), .O(new_n153_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n129_), .c(new_n133_), .O(new_n157_));
  nand2  g113(.a(new_n141_), .b(new_n104_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n122_), .b(new_n159_), .c(new_n120_), .O(new_n160_));
  inv1   g116(.a(x14), .O(new_n161_));
  aoi21  g117(.a(new_n122_), .b(new_n161_), .c(new_n112_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n160_), .c(new_n158_), .d(new_n157_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n155_), .c(z0), .O(new_n165_));
  aoi21  g121(.a(new_n147_), .b(new_n144_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n76_), .b(x00), .O(new_n167_));
  aoi21  g123(.a(new_n166_), .b(new_n143_), .c(new_n167_), .O(z8));
  oai21  g124(.a(new_n112_), .b(new_n92_), .c(new_n93_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(x30), .c(x29), .O(new_n170_));
  nand3  g126(.a(new_n112_), .b(new_n104_), .c(new_n99_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n170_), .c(x33), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n144_), .O(new_n173_));
  nand2  g129(.a(new_n112_), .b(x29), .O(new_n174_));
  aoi22  g130(.a(x30), .b(new_n99_), .c(new_n120_), .d(new_n159_), .O(new_n175_));
  oai21  g131(.a(new_n120_), .b(new_n152_), .c(new_n119_), .O(new_n176_));
  aoi22  g132(.a(x31), .b(new_n104_), .c(new_n92_), .d(new_n77_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n176_), .c(new_n175_), .d(new_n174_), .O(new_n178_));
  ...
  oai21  g137(.a(x19), .b(new_n161_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n180_), .b(new_n122_), .O(new_n183_));
  inv1   g139(.a(new_n179_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n156_), .c(new_n133_), .O(new_n185_));
  nand2  g141(.a(new_n179_), .b(x11), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n128_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n185_), .c(new_n183_), .d(new_n182_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n178_), .c(x33), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n173_), .c(new_n167_), .O(z9));
endmodule
