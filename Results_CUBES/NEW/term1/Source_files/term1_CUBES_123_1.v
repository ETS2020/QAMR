...
module FAU ( 
  ...
  nand3  g091(.a(new_n124_), .b(x16), .c(x15), .O(new_n136_));
  nor2   g092(.a(new_n116_), .b(new_n114_), .O(new_n137_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n123_), .c(new_n112_), .O(new_n144_));
  ...
  nor2   g113(.a(x33), .b(new_n122_), .O(new_n158_));
  oai21  g114(.a(new_n120_), .b(new_n118_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n125_), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  nor4   g117(.a(new_n161_), .b(new_n127_), .c(x33), .d(new_n116_), .O(new_n162_));
  aoi21  g118(.a(new_n160_), .b(x15), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n106_), .b(new_n98_), .O(new_n164_));
  oai22  g120(.a(new_n164_), .b(new_n163_), .c(new_n157_), .d(new_n106_), .O(new_n165_));
  ...
  nand2  g130(.a(new_n114_), .b(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n173_), .c(new_n172_), .O(new_n176_));
  inv1   g132(.a(x10), .O(new_n177_));
  oai21  g133(.a(new_n161_), .b(new_n177_), .c(new_n112_), .O(new_n178_));
  nand2  g134(.a(new_n116_), .b(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x15), .O(new_n180_));
  oai21  g136(.a(new_n161_), .b(new_n112_), .c(new_n116_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n180_), .c(new_n178_), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n176_), .c(new_n171_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n157_), .O(new_n184_));
  aoi21  g140(.a(new_n170_), .b(new_n167_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n166_), .c(new_n155_), .O(z9));
endmodule
