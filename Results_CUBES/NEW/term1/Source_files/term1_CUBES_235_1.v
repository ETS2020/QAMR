// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:41 2020
...
module FAU ( 
  ...
  nand4  g071(.a(x19), .b(x18), .c(new_n110_), .d(x11), .O(new_n116_));
  ...
  aoi21  g083(.a(x27), .b(x12), .c(x28), .O(new_n128_));
  nand2  g084(.a(x16), .b(x15), .O(new_n129_));
  nand2  g085(.a(x18), .b(new_n125_), .O(new_n130_));
  nor4   g086(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n113_), .O(new_n131_));
  aoi21  g087(.a(new_n127_), .b(new_n124_), .c(new_n131_), .O(new_n132_));
  nand3  g088(.a(z0), .b(x31), .c(new_n97_), .O(new_n133_));
  nand2  g089(.a(new_n92_), .b(new_n91_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(x32), .c(x30), .O(new_n135_));
  oai21  g091(.a(new_n133_), .b(new_n132_), .c(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x29), .O(new_n137_));
  oai21  g093(.a(x28), .b(x27), .c(x29), .O(new_n138_));
  aoi21  g094(.a(new_n114_), .b(new_n112_), .c(new_n125_), .O(new_n139_));
  nand4  g095(.a(x19), .b(x18), .c(new_n125_), .d(x12), .O(new_n140_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n110_), .c(x11), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nor2   g102(.a(new_n143_), .b(new_n121_), .O(new_n147_));
  aoi21  g103(.a(new_n146_), .b(x15), .c(new_n147_), .O(new_n148_));
  nand3  g104(.a(z0), .b(x31), .c(x30), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n97_), .O(new_n150_));
  oai21  g106(.a(new_n149_), .b(new_n148_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n143_), .c(new_n120_), .O(new_n153_));
  nand3  g109(.a(new_n119_), .b(x17), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n110_), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  oai21  g112(.a(new_n113_), .b(new_n156_), .c(new_n111_), .O(new_n157_));
  inv1   g113(.a(x14), .O(new_n158_));
  aoi21  g114(.a(new_n113_), .b(new_n158_), .c(new_n105_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n157_), .c(new_n155_), .O(new_n160_));
  nand2  g116(.a(new_n119_), .b(x12), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n125_), .O(new_n162_));
  oai21  g118(.a(new_n143_), .b(new_n129_), .c(new_n162_), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n153_), .c(z0), .O(new_n165_));
  aoi21  g121(.a(new_n151_), .b(new_n138_), .c(new_n165_), .O(new_n166_));
  inv1   g122(.a(x26), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x00), .O(new_n168_));
  aoi21  g124(.a(new_n166_), .b(new_n137_), .c(new_n168_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x31), .c(x30), .d(x17), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  aoi22  g128(.a(new_n172_), .b(new_n124_), .c(x33), .d(new_n105_), .O(new_n173_));
  inv1   g129(.a(new_n128_), .O(new_n174_));
  nand4  g130(.a(new_n170_), .b(x31), .c(x30), .d(x19), .O(new_n175_));
  nor3   g131(.a(new_n175_), .b(new_n130_), .c(new_n129_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n126_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x29), .O(new_n179_));
  nand3  g135(.a(new_n170_), .b(new_n105_), .c(new_n97_), .O(new_n180_));
  nand2  g136(.a(x33), .b(x31), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n148_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n105_), .b(x30), .O(new_n183_));
  nand2  g139(.a(x31), .b(new_n97_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n125_), .O(new_n186_));
  nand2  g142(.a(new_n111_), .b(new_n156_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n184_), .d(new_n183_), .O(new_n188_));
  inv1   g144(.a(new_n129_), .O(new_n189_));
  nand2  g145(.a(new_n113_), .b(x14), .O(new_n190_));
  nor2   g146(.a(new_n111_), .b(new_n125_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  inv1   g148(.a(new_n191_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n129_), .c(new_n113_), .O(new_n194_));
  oai21  g150(.a(new_n193_), .b(new_n152_), .c(new_n120_), .O(new_n195_));
  nand2  g151(.a(new_n191_), .b(x11), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n110_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n195_), .c(new_n194_), .d(new_n192_), .O(new_n198_));
  nor2   g154(.a(new_n198_), .b(new_n188_), .O(new_n199_));
  nor2   g155(.a(new_n199_), .b(new_n170_), .O(new_n200_));
  aoi21  g156(.a(new_n182_), .b(new_n138_), .c(new_n200_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n179_), .c(new_n168_), .O(z9));
endmodule
