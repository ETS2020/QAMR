...
module FAU ( 
  ...
  aoi21  g062(.a(new_n108_), .b(new_n101_), .c(new_n60_), .O(new_n109_));
  nor2   g063(.a(x23), .b(x22), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n54_), .O(new_n111_));
  nor2   g065(.a(new_n111_), .b(new_n92_), .O(new_n112_));
  ...
  aoi21  g073(.a(new_n119_), .b(new_n84_), .c(new_n63_), .O(new_n120_));
  nor2   g074(.a(x24), .b(x23), .O(new_n121_));
  nand4  g075(.a(new_n121_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n122_));
  inv1   g076(.a(new_n122_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n118_), .O(z14));
  ...
  aoi22  g085(.a(new_n131_), .b(new_n94_), .c(new_n122_), .d(x25), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n87_), .c(new_n129_), .O(z15));
  ...
  nand4  g092(.a(new_n138_), .b(new_n110_), .c(new_n137_), .d(new_n74_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x26), .O(new_n140_));
  nor2   g094(.a(x26), .b(x25), .O(new_n141_));
  nor3   g095(.a(x24), .b(x23), .c(x22), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n137_), .d(new_n74_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n141_), .d(new_n137_), .O(new_n149_));
