...
module FAU ( 
  ...
  oai21  g49(.a(new_n95_), .b(new_n92_), .c(x16), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n91_), .O(z11));
  ...
  aoi22  g56(.a(new_n102_), .b(new_n84_), .c(new_n94_), .d(x22), .O(new_n103_));
  ...
  nand4  g63(.a(new_n109_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n110_));
  nand4  g64(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x23), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n110_), .c(new_n48_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n108_), .O(z13));
  inv1   g69(.a(x13), .O(new_n116_));
  nand2  g70(.a(x18), .b(x05), .O(new_n117_));
  oai21  g71(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nor3   g73(.a(x21), .b(x20), .c(x17), .O(new_n120_));
  nor3   g74(.a(x24), .b(x23), .c(x22), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n120_), .c(new_n110_), .d(x24), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n87_), .c(new_n119_), .O(z14));
  ...
  aoi21  g81(.a(new_n121_), .b(new_n120_), .c(new_n66_), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n109_), .c(new_n93_), .d(new_n72_), .O(new_n130_));
  inv1   g84(.a(new_n130_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(new_n127_), .O(z15));
  ...
  inv1   g91(.a(new_n111_), .O(new_n138_));
  nand4  g92(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n139_));
