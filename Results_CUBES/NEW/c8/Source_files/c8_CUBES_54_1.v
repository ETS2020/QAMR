...
module FAU ( 
  ...
  oai21  g50(.a(new_n94_), .b(x22), .c(x16), .O(new_n97_));
  nor2   g51(.a(x18), .b(new_n57_), .O(new_n98_));
  aoi21  g52(.a(x18), .b(x03), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(x16), .c(new_n97_), .O(z12));
  ...
  nor2   g58(.a(x23), .b(x21), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n84_), .c(new_n93_), .d(x23), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n87_), .c(new_n104_), .O(z13));
  inv1   g61(.a(x13), .O(new_n108_));
  nand2  g62(.a(x18), .b(x05), .O(new_n109_));
  oai21  g63(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n87_), .O(new_n111_));
  nand3  g65(.a(new_n105_), .b(new_n74_), .c(new_n51_), .O(new_n112_));
  nor3   g66(.a(x24), .b(x23), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n84_), .c(new_n112_), .d(x24), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n87_), .c(new_n111_), .O(z14));
  ...
  aoi21  g73(.a(new_n113_), .b(new_n84_), .c(new_n66_), .O(new_n120_));
  nor2   g74(.a(x25), .b(x24), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n105_), .c(new_n74_), .d(new_n51_), .O(new_n122_));
  ...
  nand2  g82(.a(new_n128_), .b(new_n87_), .O(new_n129_));
  nand4  g83(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n130_));
  inv1   g84(.a(new_n130_), .O(new_n131_));
  aoi22  g85(.a(new_n131_), .b(new_n94_), .c(new_n122_), .d(x26), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(new_n87_), .c(new_n129_), .O(z16));
  nor2   g87(.a(x21), .b(x20), .O(new_n134_));
  nor2   g88(.a(x26), .b(x25), .O(new_n135_));
  nor3   g89(.a(x24), .b(x23), .c(x22), .O(new_n136_));
  nor2   g90(.a(new_n48_), .b(x17), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n138_));
