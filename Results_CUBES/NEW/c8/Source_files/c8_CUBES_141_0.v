...
module FAU ( 
  ...
  xor2a  g38(.a(new_n75_), .b(new_n51_), .O(new_n85_));
  ...
  nand2  g42(.a(new_n88_), .b(new_n80_), .O(new_n89_));
  nand3  g43(.a(new_n51_), .b(new_n48_), .c(new_n76_), .O(new_n90_));
  nor2   g44(.a(x21), .b(x20), .O(new_n91_));
  aoi22  g45(.a(new_n91_), .b(new_n75_), .c(new_n90_), .d(x21), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n80_), .c(new_n89_), .O(z11));
  ...
  nand2  g50(.a(new_n48_), .b(new_n76_), .O(new_n97_));
  nor2   g51(.a(x21), .b(x20), .O(new_n98_));
  oai21  g52(.a(x19), .b(x17), .c(x22), .O(new_n99_));
  oai21  g53(.a(new_n98_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(x16), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n96_), .O(z12));
  inv1   g56(.a(x12), .O(new_n103_));
  nand2  g57(.a(x18), .b(x04), .O(new_n104_));
  oai21  g58(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(new_n80_), .O(new_n106_));
  oai21  g60(.a(new_n60_), .b(new_n80_), .c(new_n106_), .O(z13));
  inv1   g61(.a(x13), .O(new_n108_));
  nand2  g62(.a(x18), .b(x05), .O(new_n109_));
  oai21  g63(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n80_), .O(new_n111_));
  oai21  g65(.a(new_n63_), .b(new_n80_), .c(new_n111_), .O(z14));
  ...
  oai21  g70(.a(new_n66_), .b(new_n80_), .c(new_n116_), .O(z15));
  ...
  oai21  g75(.a(new_n69_), .b(new_n80_), .c(new_n121_), .O(z16));
  nor2   g76(.a(x24), .b(x23), .O(new_n123_));
  nor2   g77(.a(x26), .b(x25), .O(new_n124_));
  nor2   g78(.a(x20), .b(x17), .O(new_n125_));
  nor2   g79(.a(x22), .b(x21), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n127_));
  nand2  g81(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g82(.a(new_n128_), .b(new_n127_), .c(new_n80_), .O(z17));
  buf    g83(.a(x27), .O(z08));
endmodule
