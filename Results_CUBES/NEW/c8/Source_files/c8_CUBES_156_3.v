// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:44 2020
...
module FAU ( 
  ...
  nand2  g50(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  nand2  g51(.a(new_n92_), .b(new_n73_), .O(new_n98_));
  nor2   g52(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g53(.a(new_n99_), .b(new_n83_), .c(new_n98_), .d(x22), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n86_), .c(new_n97_), .O(z12));
  inv1   g55(.a(x12), .O(new_n102_));
  nand2  g56(.a(x18), .b(x04), .O(new_n103_));
  oai21  g57(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  aoi21  g59(.a(new_n99_), .b(new_n73_), .c(new_n60_), .O(new_n106_));
  nor2   g60(.a(x23), .b(x22), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  nor2   g62(.a(new_n108_), .b(new_n91_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  ...
  nand2  g68(.a(new_n114_), .b(new_n86_), .O(new_n115_));
  nor3   g69(.a(x23), .b(x22), .c(x21), .O(new_n116_));
  aoi21  g70(.a(new_n116_), .b(new_n83_), .c(new_n63_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n99_), .c(new_n73_), .d(new_n51_), .O(new_n119_));
  ...
  nand2  g78(.a(new_n124_), .b(new_n86_), .O(new_n125_));
  nand2  g79(.a(new_n119_), .b(x25), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n107_), .c(new_n92_), .d(new_n73_), .O(new_n128_));
  ...
  oai21  g86(.a(x18), .b(new_n69_), .c(new_n132_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n86_), .O(new_n134_));
  nand2  g88(.a(new_n128_), .b(x26), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n107_), .c(new_n92_), .d(new_n73_), .O(new_n137_));
  ...
  nor2   g94(.a(new_n48_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n136_), .c(new_n107_), .d(new_n92_), .O(new_n142_));
  nand2  g96(.a(x27), .b(x17), .O(new_n143_));
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n86_), .O(z17));
  buf    g98(.a(x27), .O(z08));
endmodule
