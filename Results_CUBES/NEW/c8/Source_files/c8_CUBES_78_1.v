// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:07 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  oai21  g01(.a(new_n47_), .b(x08), .c(x19), .O(z00));
  inv1   g02(.a(x20), .O(new_n49_));
  nand2  g03(.a(new_n47_), .b(new_n49_), .O(new_n50_));
  oai21  g04(.a(new_n47_), .b(x09), .c(new_n50_), .O(z01));
  inv1   g05(.a(x10), .O(new_n52_));
  nand2  g06(.a(x27), .b(new_n52_), .O(new_n53_));
  oai21  g07(.a(x27), .b(x21), .c(new_n53_), .O(z02));
  inv1   g08(.a(x11), .O(new_n55_));
  nand2  g09(.a(x27), .b(new_n55_), .O(new_n56_));
  oai21  g10(.a(x27), .b(x22), .c(new_n56_), .O(z03));
  inv1   g11(.a(x12), .O(new_n58_));
  nand2  g12(.a(x27), .b(new_n58_), .O(new_n59_));
  oai21  g13(.a(x27), .b(x23), .c(new_n59_), .O(z04));
  inv1   g14(.a(x24), .O(new_n61_));
  nand2  g15(.a(new_n47_), .b(new_n61_), .O(new_n62_));
  oai21  g16(.a(new_n47_), .b(x13), .c(new_n62_), .O(z05));
  inv1   g17(.a(x14), .O(new_n64_));
  nand2  g18(.a(x27), .b(new_n64_), .O(new_n65_));
  oai21  g19(.a(x27), .b(x25), .c(new_n65_), .O(z06));
  inv1   g20(.a(x15), .O(new_n67_));
  nand2  g21(.a(x27), .b(new_n67_), .O(new_n68_));
  oai21  g22(.a(x27), .b(x26), .c(new_n68_), .O(z07));
  and2   g23(.a(x19), .b(x17), .O(new_n70_));
  nor2   g24(.a(x19), .b(x17), .O(new_n71_));
  oai21  g25(.a(new_n71_), .b(new_n70_), .c(x16), .O(new_n72_));
  inv1   g26(.a(x08), .O(new_n73_));
  nor2   g27(.a(x18), .b(new_n73_), .O(new_n74_));
  aoi21  g28(.a(x18), .b(x00), .c(new_n74_), .O(new_n75_));
  oai21  g29(.a(new_n75_), .b(x16), .c(new_n72_), .O(z09));
  inv1   g30(.a(x09), .O(new_n77_));
  nor2   g31(.a(x18), .b(new_n77_), .O(new_n78_));
  aoi21  g32(.a(x18), .b(x01), .c(new_n78_), .O(new_n79_));
  nor2   g33(.a(new_n71_), .b(new_n49_), .O(new_n80_));
  ...
  oai21  g39(.a(x18), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g41(.a(new_n71_), .b(new_n49_), .O(new_n88_));
  nor2   g42(.a(x21), .b(x20), .O(new_n89_));
  aoi22  g43(.a(new_n89_), .b(new_n71_), .c(new_n88_), .d(x21), .O(new_n90_));
  oai21  g44(.a(new_n90_), .b(new_n84_), .c(new_n87_), .O(z11));
  nand2  g45(.a(x18), .b(x03), .O(new_n92_));
  oai21  g46(.a(x18), .b(new_n55_), .c(new_n92_), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n84_), .O(new_n94_));
  nand2  g48(.a(new_n89_), .b(new_n71_), .O(new_n95_));
  ...
  oai21  g53(.a(x18), .b(new_n58_), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  nand3  g55(.a(new_n96_), .b(new_n71_), .c(new_n49_), .O(new_n102_));
  ...
  aoi21  g63(.a(new_n103_), .b(new_n81_), .c(new_n61_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n49_), .O(new_n112_));
  ...
  oai21  g70(.a(x18), .b(new_n64_), .c(new_n116_), .O(new_n117_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n122_));
  ...
  oai21  g80(.a(x18), .b(new_n67_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g84(.a(new_n130_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n131_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n130_), .c(new_n120_), .d(new_n89_), .O(new_n137_));
  nand2  g91(.a(x27), .b(x17), .O(new_n138_));
  aoi21  g92(.a(new_n138_), .b(new_n137_), .c(new_n84_), .O(z17));
  buf    g93(.a(x27), .O(z08));
endmodule
