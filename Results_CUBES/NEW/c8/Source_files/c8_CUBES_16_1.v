...
module FAU ( 
  ...
  nand2  g81(.a(new_n124_), .b(new_n69_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(x16), .O(new_n129_));
  inv1   g83(.a(x15), .O(new_n130_));
  nor2   g84(.a(x18), .b(new_n130_), .O(new_n131_));
  aoi21  g85(.a(x18), .b(x07), .c(new_n131_), .O(new_n132_));
  oai21  g86(.a(new_n132_), .b(x16), .c(new_n129_), .O(z16));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nor2   g88(.a(new_n48_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n134_), .c(new_n122_), .d(new_n91_), .O(new_n136_));
