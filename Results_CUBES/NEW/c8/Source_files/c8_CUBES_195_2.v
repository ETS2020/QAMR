...
module FAU ( 
  ...
  nand3  g45(.a(new_n75_), .b(new_n54_), .c(new_n51_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(new_n93_));
  aoi21  g47(.a(new_n91_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n86_), .c(new_n90_), .O(z11));
  inv1   g49(.a(x11), .O(new_n96_));
  nand2  g50(.a(x18), .b(x03), .O(new_n97_));
  oai21  g51(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n86_), .O(new_n99_));
  nor2   g53(.a(x22), .b(x21), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n83_), .c(new_n92_), .d(x22), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n86_), .c(new_n99_), .O(z12));
  ...
  nand2  g60(.a(new_n100_), .b(new_n83_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n83_), .c(new_n107_), .d(x23), .O(new_n109_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n83_), .c(new_n63_), .O(new_n114_));
  ...
  nand3  g77(.a(new_n115_), .b(new_n100_), .c(new_n83_), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nor2   g81(.a(new_n127_), .b(new_n92_), .O(new_n128_));
  aoi21  g82(.a(new_n124_), .b(x25), .c(new_n128_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n86_), .c(new_n123_), .O(z15));
  ...
  nand3  g88(.a(new_n60_), .b(new_n57_), .c(new_n54_), .O(new_n135_));
  nand3  g89(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n136_));
  oai21  g90(.a(new_n136_), .b(new_n135_), .c(new_n51_), .O(new_n137_));
  nand4  g91(.a(new_n126_), .b(new_n125_), .c(new_n75_), .d(new_n54_), .O(new_n138_));
  aoi22  g92(.a(new_n138_), .b(x26), .c(new_n137_), .d(new_n75_), .O(new_n139_));
  oai21  g93(.a(new_n139_), .b(new_n86_), .c(new_n134_), .O(z16));
  nor2   g94(.a(x26), .b(x25), .O(new_n141_));
  nor2   g95(.a(new_n48_), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n141_), .c(new_n115_), .d(new_n100_), .O(new_n143_));
  nand2  g97(.a(x27), .b(x17), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n86_), .O(z17));
  buf    g99(.a(x27), .O(z08));
endmodule
