...
module FAU ( 
  ...
  nand2  g58(.a(new_n99_), .b(new_n84_), .O(new_n105_));
  ...
  nor2   g63(.a(x18), .b(new_n109_), .O(new_n110_));
  aoi21  g64(.a(x18), .b(x05), .c(new_n110_), .O(new_n111_));
  aoi21  g65(.a(new_n106_), .b(new_n84_), .c(new_n63_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n99_), .O(new_n114_));
  nor2   g68(.a(new_n114_), .b(new_n91_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  oai21  g70(.a(new_n111_), .b(x16), .c(new_n116_), .O(z14));
  ...
  nand3  g74(.a(new_n113_), .b(new_n99_), .c(new_n84_), .O(new_n121_));
  nor2   g75(.a(x23), .b(x22), .O(new_n122_));
  nor2   g76(.a(x25), .b(x24), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nor2   g78(.a(new_n124_), .b(new_n98_), .O(new_n125_));
  aoi21  g79(.a(new_n121_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n87_), .c(new_n120_), .O(z15));
  ...
  nor2   g84(.a(x26), .b(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n122_), .c(new_n92_), .d(new_n48_), .O(new_n132_));
  aoi21  g86(.a(new_n132_), .b(new_n72_), .c(x25), .O(new_n133_));
  nand4  g87(.a(new_n123_), .b(new_n122_), .c(new_n92_), .d(new_n48_), .O(new_n134_));
  and2   g88(.a(new_n134_), .b(x26), .O(new_n135_));
  oai21  g89(.a(new_n135_), .b(new_n133_), .c(x16), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n130_), .O(z16));
  inv1   g91(.a(new_n114_), .O(new_n138_));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n138_), .c(new_n51_), .d(x19), .O(new_n140_));
