// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:36 2020
...
module FAU ( 
  ...
  xor2a  g38(.a(new_n74_), .b(new_n51_), .O(new_n85_));
  oai21  g39(.a(new_n85_), .b(new_n80_), .c(new_n84_), .O(z10));
  inv1   g40(.a(x10), .O(new_n87_));
  nand2  g41(.a(x18), .b(x02), .O(new_n88_));
  oai21  g42(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n80_), .O(new_n90_));
  ...
  oai21  g47(.a(new_n93_), .b(new_n80_), .c(new_n90_), .O(z11));
  ...
  nor3   g52(.a(x21), .b(x20), .c(x17), .O(new_n99_));
  nor2   g53(.a(new_n99_), .b(new_n57_), .O(new_n100_));
  nand4  g54(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n48_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n100_), .c(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n98_), .O(z12));
  ...
  nand2  g62(.a(new_n101_), .b(x23), .O(new_n109_));
  nor2   g63(.a(x23), .b(x22), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n54_), .c(new_n51_), .d(new_n72_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n80_), .c(new_n108_), .O(z13));
  inv1   g67(.a(x13), .O(new_n114_));
  nand2  g68(.a(x18), .b(x05), .O(new_n115_));
  oai21  g69(.a(x18), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n80_), .O(new_n117_));
  nor3   g71(.a(x24), .b(x23), .c(x22), .O(new_n118_));
  aoi22  g72(.a(new_n118_), .b(new_n99_), .c(new_n111_), .d(x24), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n80_), .c(new_n117_), .O(z14));
  inv1   g74(.a(x14), .O(new_n121_));
  nand2  g75(.a(x18), .b(x06), .O(new_n122_));
  oai21  g76(.a(x18), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n80_), .O(new_n124_));
  aoi21  g78(.a(new_n118_), .b(new_n99_), .c(new_n66_), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n110_), .c(new_n92_), .d(new_n72_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n125_), .c(x16), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n124_), .O(z15));
  inv1   g84(.a(x15), .O(new_n131_));
  nand2  g85(.a(x18), .b(x07), .O(new_n132_));
  oai21  g86(.a(x18), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n80_), .O(new_n134_));
  inv1   g88(.a(new_n101_), .O(new_n135_));
  nand4  g89(.a(new_n69_), .b(new_n66_), .c(new_n63_), .d(new_n60_), .O(new_n136_));
  inv1   g90(.a(new_n136_), .O(new_n137_));
  aoi22  g91(.a(new_n137_), .b(new_n135_), .c(new_n127_), .d(x26), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(new_n80_), .c(new_n134_), .O(z16));
  nand3  g93(.a(x27), .b(x17), .c(x16), .O(new_n140_));
  inv1   g94(.a(new_n140_), .O(z17));
  buf    g95(.a(x27), .O(z08));
endmodule
