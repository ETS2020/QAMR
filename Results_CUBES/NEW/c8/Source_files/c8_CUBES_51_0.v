...
module FAU ( 
  ...
  nor2   g49(.a(x18), .b(new_n95_), .O(new_n96_));
  aoi21  g50(.a(x18), .b(x03), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x22), .b(x21), .O(new_n98_));
  nand3  g52(.a(new_n98_), .b(new_n74_), .c(new_n51_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n92_), .b(new_n74_), .c(new_n57_), .O(new_n101_));
  ...
  aoi22  g62(.a(new_n108_), .b(new_n84_), .c(new_n99_), .d(x23), .O(new_n109_));
  ...
  nand3  g69(.a(new_n98_), .b(new_n63_), .c(new_n60_), .O(new_n116_));
  ...
  nand2  g76(.a(new_n63_), .b(new_n60_), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n92_), .c(new_n74_), .d(new_n57_), .O(new_n124_));
  nand2  g78(.a(new_n99_), .b(x25), .O(new_n125_));
  ...
  oai21  g86(.a(new_n69_), .b(new_n87_), .c(new_n132_), .O(z16));
