// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:24 2020
...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n22_), .c(x03), .O(new_n37_));
  ...
  nand4  g24(.a(new_n45_), .b(new_n44_), .c(new_n32_), .d(x03), .O(new_n46_));
  aoi21  g25(.a(new_n46_), .b(new_n43_), .c(x09), .O(new_n47_));
  and2   g26(.a(new_n37_), .b(x13), .O(new_n48_));
  oai21  g27(.a(new_n48_), .b(new_n47_), .c(x04), .O(new_n49_));
