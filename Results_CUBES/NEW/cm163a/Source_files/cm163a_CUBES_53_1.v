// Benchmark "FAU" written by ABC on Mon Jul  6 12:59:30 2020
...
module FAU ( 
  ...
  nand2  g08(.a(new_n24_), .b(new_n22_), .O(new_n30_));
  ...
  aoi21  g15(.a(new_n29_), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  oai21  g16(.a(new_n34_), .b(new_n29_), .c(new_n37_), .O(z1));
  nor3   g17(.a(x12), .b(x11), .c(x09), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n24_), .c(new_n32_), .d(x12), .O(new_n40_));
  inv1   g19(.a(x06), .O(new_n41_));
  aoi21  g20(.a(new_n41_), .b(new_n29_), .c(new_n36_), .O(new_n42_));
  ...
  aoi21  g28(.a(new_n49_), .b(new_n29_), .c(new_n36_), .O(new_n50_));
