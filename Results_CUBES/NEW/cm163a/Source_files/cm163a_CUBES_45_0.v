...
module FAU ( 
  ...
  nand3  g13(.a(new_n34_), .b(new_n31_), .c(new_n29_), .O(new_n35_));
  inv1   g14(.a(x01), .O(new_n36_));
  aoi21  g15(.a(new_n22_), .b(new_n36_), .c(new_n26_), .O(new_n37_));
  nand3  g16(.a(new_n37_), .b(new_n35_), .c(new_n33_), .O(z1));
  nor2   g17(.a(x12), .b(x09), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n34_), .c(new_n30_), .d(x12), .O(new_n40_));
  oai21  g19(.a(x06), .b(x04), .c(x05), .O(new_n41_));
  aoi21  g20(.a(new_n32_), .b(x12), .c(new_n41_), .O(new_n42_));
  ...
  aoi22  g25(.a(new_n46_), .b(x04), .c(new_n30_), .d(new_n31_), .O(new_n47_));
  ...
  oai21  g30(.a(new_n47_), .b(new_n44_), .c(new_n51_), .O(z3));
