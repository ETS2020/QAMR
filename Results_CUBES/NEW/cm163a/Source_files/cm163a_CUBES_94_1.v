// Benchmark "FAU" written by ABC on Mon Jul  6 12:59:47 2020
...
module FAU ( 
  ...
  oai21  g16(.a(new_n37_), .b(new_n29_), .c(x05), .O(z1));
  nor3   g17(.a(x12), .b(x11), .c(x09), .O(new_n39_));
  aoi22  g18(.a(new_n39_), .b(new_n24_), .c(new_n35_), .d(x12), .O(new_n40_));
