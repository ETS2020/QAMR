...
module FAU ( 
  ...
  nand4  g18(.a(new_n34_), .b(new_n24_), .c(new_n39_), .d(x04), .O(new_n40_));
  ...
  nand3  g23(.a(new_n44_), .b(new_n42_), .c(new_n40_), .O(z2));
  nand4  g24(.a(new_n34_), .b(new_n39_), .c(x03), .d(x02), .O(new_n46_));
