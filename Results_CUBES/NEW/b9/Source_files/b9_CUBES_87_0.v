// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:09 2020
...
module FAU ( 
  ...
  nand3  g085(.a(new_n147_), .b(new_n142_), .c(x39), .O(new_n148_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n128_), .c(new_n130_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n72_), .O(new_n155_));
  nand2  g093(.a(new_n142_), .b(z08), .O(new_n156_));
  nand3  g094(.a(x27), .b(new_n136_), .c(new_n135_), .O(new_n157_));
  aoi22  g095(.a(new_n157_), .b(new_n153_), .c(new_n156_), .d(new_n66_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n155_), .c(new_n152_), .d(new_n149_), .O(z14));
  ...
  oai21  g104(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g107(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n117_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n123_), .O(z20));
  aoi21  g111(.a(new_n121_), .b(new_n119_), .c(new_n123_), .O(z19));
endmodule
