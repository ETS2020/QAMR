...
module FAU ( 
  ...
  oai21  g015(.a(new_n76_), .b(new_n73_), .c(new_n77_), .O(new_n78_));
  ...
  nand3  g023(.a(new_n85_), .b(new_n82_), .c(z08), .O(z02));
  inv1   g024(.a(x28), .O(new_n87_));
  oai21  g025(.a(new_n74_), .b(new_n87_), .c(x27), .O(new_n88_));
  ...
  oai21  g049(.a(x39), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nor2   g050(.a(x40), .b(new_n110_), .O(new_n113_));
  aoi21  g051(.a(new_n112_), .b(new_n64_), .c(new_n113_), .O(new_n114_));
  nand2  g052(.a(x37), .b(x06), .O(new_n115_));
  oai21  g053(.a(new_n114_), .b(new_n76_), .c(new_n115_), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(x27), .O(new_n117_));
  inv1   g055(.a(new_n77_), .O(new_n118_));
  nand4  g056(.a(new_n118_), .b(z08), .c(x05), .d(new_n64_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(z10));
  nand2  g058(.a(x39), .b(x29), .O(new_n121_));
  nor2   g059(.a(new_n73_), .b(new_n64_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n80_), .c(new_n121_), .O(new_n123_));
  aoi21  g061(.a(x40), .b(x08), .c(new_n75_), .O(new_n124_));
  nor2   g062(.a(new_n73_), .b(x04), .O(new_n125_));
  ...
  aoi22  g069(.a(new_n63_), .b(new_n89_), .c(x40), .d(new_n73_), .O(new_n132_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n118_), .c(z08), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(z13));
  inv1   g086(.a(x32), .O(new_n149_));
  nand4  g087(.a(new_n139_), .b(new_n149_), .c(new_n129_), .d(x28), .O(new_n150_));
  ...
  nand3  g091(.a(new_n138_), .b(x40), .c(new_n136_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n73_), .O(new_n155_));
  nand3  g093(.a(new_n89_), .b(new_n74_), .c(x28), .O(new_n156_));
  ...
  aoi22  g106(.a(new_n75_), .b(new_n73_), .c(z08), .d(x29), .O(new_n169_));
  aoi21  g107(.a(new_n125_), .b(new_n75_), .c(new_n130_), .O(new_n170_));
  oai21  g108(.a(new_n169_), .b(new_n168_), .c(new_n170_), .O(z18));
  oai21  g109(.a(new_n74_), .b(new_n73_), .c(new_n168_), .O(new_n172_));
  nand2  g110(.a(z08), .b(x29), .O(new_n173_));
  oai21  g111(.a(new_n87_), .b(x27), .c(x35), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n172_), .c(new_n130_), .O(z20));
  aoi21  g114(.a(new_n127_), .b(new_n123_), .c(new_n130_), .O(z19));
endmodule
