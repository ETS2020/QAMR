...
module FAU ( 
  ...
  nand4  g073(.a(x40), .b(x39), .c(new_n135_), .d(new_n64_), .O(new_n136_));
  nor2   g074(.a(x19), .b(x18), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x20), .O(new_n138_));
  oai22  g076(.a(new_n138_), .b(new_n66_), .c(new_n136_), .d(new_n134_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x27), .O(new_n140_));
  inv1   g078(.a(new_n136_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n78_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(z13));
  inv1   g081(.a(x32), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(new_n144_), .c(new_n124_), .d(x28), .O(new_n146_));
  nand2  g084(.a(new_n135_), .b(new_n64_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x40), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(z08), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n138_), .O(new_n150_));
  oai21  g088(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n151_));
  nand3  g089(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n77_), .O(new_n154_));
  oai21  g092(.a(new_n128_), .b(new_n66_), .c(new_n147_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .d(new_n150_), .O(z14));
  ...
  nor2   g101(.a(new_n85_), .b(x28), .O(new_n164_));
  aoi22  g102(.a(new_n164_), .b(new_n72_), .c(z08), .d(x29), .O(new_n165_));
  nor2   g103(.a(new_n72_), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n125_), .O(new_n167_));
  oai21  g105(.a(new_n165_), .b(new_n82_), .c(new_n167_), .O(z18));
  oai21  g106(.a(new_n85_), .b(new_n72_), .c(new_n82_), .O(new_n169_));
  oai21  g107(.a(new_n74_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n117_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n125_), .O(z20));
  aoi21  g110(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
