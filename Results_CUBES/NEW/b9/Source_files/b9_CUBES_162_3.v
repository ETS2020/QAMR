...
module FAU ( 
  ...
  nand3  g010(.a(new_n72_), .b(x27), .c(new_n63_), .O(new_n73_));
  ...
  oai21  g025(.a(new_n68_), .b(x28), .c(x35), .O(new_n88_));
  nand2  g026(.a(new_n88_), .b(x27), .O(new_n89_));
  aoi21  g027(.a(x28), .b(x27), .c(x37), .O(z06));
  inv1   g028(.a(z06), .O(new_n91_));
  nand3  g029(.a(new_n91_), .b(new_n89_), .c(x21), .O(z03));
  nor2   g030(.a(z06), .b(x21), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n89_), .O(z04));
  oai21  g032(.a(new_n77_), .b(new_n75_), .c(new_n68_), .O(z05));
  ...
  nor3   g051(.a(new_n107_), .b(new_n80_), .c(new_n111_), .O(new_n114_));
  ...
  nor2   g057(.a(new_n75_), .b(new_n119_), .O(new_n120_));
  oai21  g058(.a(new_n120_), .b(new_n78_), .c(new_n118_), .O(new_n121_));
  nand4  g059(.a(x35), .b(new_n77_), .c(x27), .d(new_n119_), .O(new_n122_));
  ...
  nand2  g064(.a(x37), .b(new_n75_), .O(new_n127_));
  nand2  g065(.a(z08), .b(new_n119_), .O(new_n128_));
  oai21  g066(.a(x36), .b(x35), .c(x27), .O(new_n129_));
  aoi21  g067(.a(new_n128_), .b(new_n69_), .c(new_n129_), .O(new_n130_));
  oai21  g068(.a(new_n130_), .b(x37), .c(new_n127_), .O(z12));
  inv1   g069(.a(x13), .O(new_n132_));
  nand2  g070(.a(x36), .b(x35), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x28), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(new_n66_), .c(x40), .d(new_n132_), .O(new_n135_));
  ...
  nand4  g086(.a(new_n148_), .b(new_n143_), .c(x40), .d(x39), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n138_), .O(new_n150_));
  inv1   g088(.a(x35), .O(new_n151_));
  nand3  g089(.a(new_n68_), .b(new_n151_), .c(x28), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n80_), .O(new_n154_));
  nand2  g092(.a(new_n143_), .b(z08), .O(new_n155_));
  oai21  g093(.a(new_n71_), .b(new_n75_), .c(new_n155_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n154_), .c(new_n150_), .O(z14));
  ...
  oai21  g102(.a(new_n78_), .b(x27), .c(new_n118_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x08), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n124_), .c(new_n122_), .O(z18));
  oai21  g105(.a(new_n151_), .b(new_n75_), .c(new_n85_), .O(new_n168_));
  oai21  g106(.a(new_n77_), .b(x27), .c(x35), .O(new_n169_));
