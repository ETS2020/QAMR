...
module FAU ( 
  ...
  oai21  g067(.a(new_n129_), .b(x37), .c(x40), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n85_), .O(new_n131_));
  ...
  oai21  g074(.a(new_n106_), .b(x04), .c(new_n72_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n136_), .c(new_n131_), .O(z12));
  inv1   g076(.a(x13), .O(new_n139_));
  nand2  g077(.a(x36), .b(x35), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x28), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n129_), .c(x40), .d(new_n139_), .O(new_n142_));
  inv1   g080(.a(new_n66_), .O(new_n143_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n78_), .c(z08), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z13));
  aoi21  g091(.a(new_n151_), .b(x39), .c(x37), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n134_), .c(new_n85_), .O(new_n155_));
  inv1   g093(.a(x32), .O(new_n156_));
  nand4  g094(.a(new_n140_), .b(new_n156_), .c(new_n125_), .d(x28), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n151_), .c(x40), .d(x39), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n146_), .O(new_n159_));
  inv1   g097(.a(x35), .O(new_n160_));
  nand3  g098(.a(new_n87_), .b(new_n160_), .c(x28), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x27), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n77_), .O(new_n163_));
  nor2   g101(.a(new_n134_), .b(new_n139_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n65_), .c(new_n72_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(new_n163_), .c(new_n159_), .d(new_n155_), .O(z14));
  ...
  nor2   g111(.a(new_n160_), .b(x28), .O(new_n174_));
  aoi22  g112(.a(new_n174_), .b(new_n72_), .c(z08), .d(x29), .O(new_n175_));
  nor2   g113(.a(new_n72_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(new_n126_), .O(new_n177_));
  oai21  g115(.a(new_n175_), .b(new_n120_), .c(new_n177_), .O(z18));
  oai21  g116(.a(new_n160_), .b(new_n72_), .c(new_n120_), .O(new_n179_));
  oai21  g117(.a(new_n74_), .b(x27), .c(x35), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n117_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n179_), .c(new_n126_), .O(z20));
  aoi21  g120(.a(new_n123_), .b(new_n119_), .c(new_n126_), .O(z19));
endmodule
