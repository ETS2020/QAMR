...
module FAU ( 
  ...
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n127_), .O(new_n171_));
  oai21  g109(.a(new_n169_), .b(new_n80_), .c(new_n171_), .O(z18));
  oai21  g110(.a(new_n155_), .b(new_n72_), .c(new_n80_), .O(new_n173_));
  oai21  g111(.a(new_n74_), .b(x27), .c(x35), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n119_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n127_), .O(z20));
  aoi21  g114(.a(new_n124_), .b(new_n121_), .c(new_n127_), .O(z19));
endmodule
