// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:52 2020
...
module FAU ( 
  ...
  nor2   g17(.a(new_n37_), .b(x11), .O(new_n46_));
  nor2   g18(.a(x12), .b(new_n35_), .O(new_n47_));
  nor2   g19(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  ...
  aoi21  g23(.a(x13), .b(new_n37_), .c(new_n46_), .O(new_n52_));
  nand2  g24(.a(x08), .b(x02), .O(new_n53_));
  oai21  g25(.a(new_n52_), .b(new_n49_), .c(new_n53_), .O(z3));
  nor2   g26(.a(new_n37_), .b(new_n35_), .O(new_n55_));
  xor2a  g27(.a(new_n55_), .b(new_n38_), .O(new_n56_));
  nand2  g28(.a(x08), .b(x03), .O(new_n57_));
  oai21  g29(.a(new_n56_), .b(new_n49_), .c(new_n57_), .O(z4));
  inv1   g30(.a(new_n49_), .O(new_n59_));
  inv1   g31(.a(x15), .O(new_n60_));
  nand3  g32(.a(x14), .b(x12), .c(x11), .O(new_n61_));
  inv1   g33(.a(new_n61_), .O(new_n62_));
  nand4  g34(.a(new_n60_), .b(x14), .c(x12), .d(x11), .O(new_n63_));
  ...
  nand4  g39(.a(x15), .b(x14), .c(x12), .d(x11), .O(new_n68_));
  nand2  g40(.a(x15), .b(x14), .O(new_n69_));
  nor2   g41(.a(new_n69_), .b(x16), .O(new_n70_));
  aoi22  g42(.a(new_n70_), .b(new_n55_), .c(new_n68_), .d(x16), .O(new_n71_));
  nand2  g43(.a(x08), .b(x05), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n49_), .c(new_n72_), .O(z6));
  ...
  nand2  g49(.a(new_n77_), .b(new_n59_), .O(new_n78_));
  ...
  nand2  g57(.a(new_n85_), .b(new_n59_), .O(new_n86_));
