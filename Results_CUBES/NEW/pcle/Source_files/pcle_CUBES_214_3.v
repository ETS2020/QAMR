...
module FAU ( 
  ...
  nor4   g07(.a(new_n35_), .b(new_n34_), .c(new_n33_), .d(new_n31_), .O(z0));
  ...
  oai21  g46(.a(new_n73_), .b(new_n33_), .c(new_n74_), .O(z6));
  ...
  oai21  g55(.a(new_n83_), .b(new_n81_), .c(new_n46_), .O(new_n84_));
  ...
  oai21  g67(.a(new_n94_), .b(new_n33_), .c(new_n95_), .O(z8));
endmodule
