...
module FAU ( 
  ...
  nor2   g32(.a(new_n36_), .b(x15), .O(new_n61_));
  aoi22  g33(.a(new_n61_), .b(new_n53_), .c(new_n60_), .d(x15), .O(new_n62_));
  nand2  g34(.a(x08), .b(x04), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(new_n46_), .c(new_n63_), .O(z5));
  inv1   g36(.a(new_n46_), .O(new_n65_));
  nand2  g37(.a(x15), .b(x14), .O(new_n66_));
  oai21  g38(.a(new_n66_), .b(new_n54_), .c(x16), .O(new_n67_));
