...
module FAU ( 
  ...
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n100_), .O(new_n140_));
  nand2  g107(.a(new_n34_), .b(new_n130_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n44_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n140_), .c(new_n72_), .O(new_n143_));
  aoi21  g110(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n74_), .c(x09), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x16), .c(new_n130_), .O(new_n146_));
  nand2  g113(.a(x08), .b(x07), .O(new_n147_));
  oai21  g114(.a(new_n146_), .b(new_n110_), .c(new_n147_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n95_), .O(new_n149_));
  inv1   g116(.a(new_n38_), .O(new_n150_));
  oai21  g117(.a(new_n55_), .b(x24), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(x19), .b(x08), .O(new_n152_));
  oai21  g119(.a(new_n146_), .b(new_n53_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g121(.a(x08), .b(x00), .O(new_n155_));
  oai21  g122(.a(new_n146_), .b(new_n54_), .c(new_n155_), .O(new_n156_));
  nor2   g123(.a(new_n56_), .b(x24), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n154_), .c(new_n149_), .d(new_n143_), .O(z4));
  ...
  nand2  g130(.a(new_n118_), .b(new_n113_), .O(z7));
