...
module FAU ( 
  ...
  nand3  g020(.a(x21), .b(new_n43_), .c(new_n42_), .O(new_n54_));
  ...
  oai21  g031(.a(x02), .b(new_n63_), .c(new_n64_), .O(new_n65_));
  ...
  nand2  g079(.a(x10), .b(x08), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(x21), .c(new_n42_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n53_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n35_), .O(new_n116_));
  nand2  g083(.a(x24), .b(x18), .O(new_n117_));
  nor2   g084(.a(new_n117_), .b(new_n39_), .O(new_n118_));
  aoi21  g085(.a(new_n39_), .b(x15), .c(new_n118_), .O(new_n119_));
  inv1   g086(.a(new_n56_), .O(new_n120_));
  nor2   g087(.a(new_n77_), .b(new_n76_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n120_), .c(x11), .d(x06), .O(new_n122_));
  aoi21  g089(.a(new_n119_), .b(new_n116_), .c(new_n122_), .O(z2));
  nor2   g090(.a(new_n76_), .b(new_n48_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n86_), .c(new_n55_), .d(x20), .O(new_n125_));
  nor2   g092(.a(x08), .b(x06), .O(new_n126_));
  nor3   g093(.a(x20), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n126_), .c(new_n65_), .d(new_n49_), .O(new_n128_));
  ...
  nand3  g098(.a(new_n50_), .b(new_n48_), .c(new_n106_), .O(new_n132_));
  nand2  g099(.a(new_n92_), .b(new_n49_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n85_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n98_), .O(new_n135_));
  nand3  g102(.a(new_n124_), .b(x20), .c(x15), .O(new_n136_));
  nand3  g103(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n107_), .c(new_n136_), .d(new_n85_), .O(new_n138_));
  ...
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n71_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n72_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n106_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(z5), .O(new_n146_));
  nand2  g113(.a(new_n39_), .b(x15), .O(new_n147_));
  nand2  g114(.a(x15), .b(x13), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(x24), .c(new_n117_), .O(new_n149_));
  ...
  nand4  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n147_), .O(z7));
  aoi21  g120(.a(x23), .b(new_n142_), .c(new_n71_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n72_), .c(x09), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(z7), .c(x16), .O(new_n156_));
  inv1   g123(.a(new_n150_), .O(new_n157_));
  nand3  g124(.a(new_n35_), .b(x21), .c(new_n42_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n152_), .c(new_n147_), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(new_n157_), .c(new_n106_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n156_), .c(new_n146_), .O(z4));
  inv1   g128(.a(x03), .O(new_n162_));
  aoi21  g129(.a(x20), .b(new_n76_), .c(x06), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x11), .c(new_n162_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(z5), .O(new_n165_));
  aoi21  g132(.a(new_n77_), .b(x14), .c(new_n47_), .O(new_n166_));
