...
module FAU ( 
  ...
  nand2  g022(.a(x23), .b(x15), .O(new_n56_));
  ...
  nand3  g027(.a(x22), .b(x20), .c(x17), .O(new_n61_));
  ...
  nand2  g032(.a(new_n53_), .b(x00), .O(new_n66_));
  oai21  g033(.a(new_n55_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g066(.a(new_n99_), .b(new_n87_), .c(new_n85_), .O(new_n100_));
  ...
  nand3  g073(.a(new_n106_), .b(new_n102_), .c(new_n101_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n93_), .c(new_n100_), .O(new_n108_));
  ...
  nand3  g081(.a(new_n53_), .b(new_n43_), .c(x21), .O(new_n115_));
  ...
  nor2   g092(.a(new_n120_), .b(new_n47_), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n125_), .c(new_n87_), .d(x20), .O(new_n127_));
  nor3   g094(.a(x20), .b(x14), .c(x11), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n104_), .c(new_n67_), .d(new_n48_), .O(new_n129_));
  ...
  nand3  g103(.a(new_n126_), .b(x20), .c(x15), .O(new_n137_));
  nand3  g104(.a(new_n48_), .b(new_n120_), .c(new_n47_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n105_), .c(new_n137_), .d(new_n86_), .O(new_n139_));
  aoi22  g106(.a(new_n139_), .b(new_n38_), .c(new_n136_), .d(new_n95_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n131_), .O(z3));
  nand2  g108(.a(x17), .b(x04), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n53_), .c(x21), .O(new_n143_));
  aoi21  g110(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n124_), .c(new_n143_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n43_), .O(new_n146_));
  inv1   g113(.a(new_n144_), .O(new_n147_));
  oai21  g114(.a(new_n111_), .b(new_n38_), .c(new_n117_), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(new_n146_), .c(new_n74_), .O(new_n150_));
  aoi21  g117(.a(new_n119_), .b(new_n114_), .c(x09), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n150_), .c(x16), .O(new_n152_));
  nand2  g119(.a(new_n119_), .b(new_n114_), .O(z7));
  oai21  g120(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n74_), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n133_), .O(new_n156_));
  aoi22  g123(.a(new_n156_), .b(z5), .c(z7), .d(new_n133_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(z4));
  nand2  g125(.a(x20), .b(new_n120_), .O(new_n159_));
  ...
  nand2  g129(.a(new_n103_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n47_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n162_), .c(z7), .O(new_n165_));
