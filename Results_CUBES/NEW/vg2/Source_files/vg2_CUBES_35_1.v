...
module FAU ( 
  ...
  nand3  g050(.a(x17), .b(x14), .c(x12), .O(new_n84_));
  ...
  nand3  g062(.a(x20), .b(x17), .c(x15), .O(new_n96_));
  nand4  g063(.a(x23), .b(x22), .c(x14), .d(x12), .O(new_n97_));
  nor4   g064(.a(new_n97_), .b(new_n96_), .c(new_n83_), .d(new_n82_), .O(new_n98_));
  nor2   g065(.a(x11), .b(x09), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(new_n89_), .O(new_n100_));
  nor2   g067(.a(x08), .b(x06), .O(new_n101_));
  nand3  g068(.a(new_n101_), .b(new_n76_), .c(x19), .O(new_n102_));
  nor2   g069(.a(x14), .b(x12), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n48_), .c(new_n70_), .d(new_n91_), .O(new_n104_));
  nor3   g071(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(new_n105_));
  oai21  g072(.a(new_n105_), .b(new_n98_), .c(new_n38_), .O(new_n106_));
  ...
  nor2   g085(.a(new_n118_), .b(new_n83_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n55_), .O(new_n120_));
  nor3   g087(.a(x20), .b(x14), .c(x11), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n101_), .c(new_n65_), .d(new_n48_), .O(new_n122_));
  ...
  nand3  g094(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n128_));
  oai22  g095(.a(new_n128_), .b(new_n127_), .c(new_n125_), .d(new_n83_), .O(new_n129_));
  nand4  g096(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n130_));
  nand3  g097(.a(new_n48_), .b(new_n75_), .c(new_n47_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n102_), .c(new_n130_), .d(new_n83_), .O(new_n132_));
  aoi22  g099(.a(new_n132_), .b(new_n38_), .c(new_n129_), .d(new_n94_), .O(new_n133_));
  nand2  g100(.a(new_n133_), .b(new_n124_), .O(z3));
  aoi21  g101(.a(new_n89_), .b(x04), .c(x09), .O(new_n135_));
  nor2   g102(.a(new_n135_), .b(x16), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(x08), .O(new_n137_));
  oai21  g104(.a(new_n71_), .b(x17), .c(x09), .O(new_n138_));
  nand4  g105(.a(x23), .b(x22), .c(x17), .d(new_n91_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(x08), .O(new_n140_));
  aoi21  g107(.a(new_n138_), .b(x16), .c(new_n140_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n115_), .c(new_n137_), .d(new_n45_), .O(z4));
  inv1   g109(.a(new_n45_), .O(z5));
  oai21  g110(.a(new_n76_), .b(x14), .c(new_n46_), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(new_n47_), .c(x03), .O(new_n145_));
  inv1   g112(.a(x03), .O(new_n146_));
  oai21  g113(.a(x20), .b(new_n75_), .c(x06), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x11), .c(new_n146_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n115_), .c(new_n145_), .d(new_n45_), .O(z6));
