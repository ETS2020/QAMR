...
module FAU ( 
  ...
  nand4  g044(.a(new_n43_), .b(x09), .c(new_n42_), .d(x01), .O(new_n78_));
  ...
  nor2   g050(.a(new_n83_), .b(new_n73_), .O(new_n84_));
  nand3  g051(.a(x17), .b(x16), .c(x14), .O(new_n85_));
  nand4  g052(.a(x12), .b(x11), .c(x09), .d(x01), .O(new_n86_));
  ...
  nand4  g059(.a(new_n92_), .b(new_n91_), .c(new_n89_), .d(new_n49_), .O(new_n93_));
  inv1   g060(.a(x04), .O(new_n94_));
  inv1   g061(.a(x08), .O(new_n95_));
  nor3   g062(.a(x20), .b(x17), .c(x12), .O(new_n96_));
  nor2   g063(.a(x11), .b(x09), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n93_), .c(new_n88_), .O(new_n99_));
  nor2   g066(.a(new_n39_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g068(.a(new_n92_), .b(new_n89_), .c(new_n95_), .d(new_n47_), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  inv1   g070(.a(x13), .O(new_n104_));
  nand3  g071(.a(new_n97_), .b(x19), .c(new_n104_), .O(new_n105_));
  nand3  g072(.a(new_n49_), .b(new_n34_), .c(new_n94_), .O(new_n106_));
  nor2   g073(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g074(.a(new_n107_), .b(new_n103_), .c(new_n96_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n101_), .c(new_n82_), .O(z1));
  ...
  nand3  g079(.a(new_n53_), .b(new_n36_), .c(x21), .O(new_n113_));
  ...
  nor2   g085(.a(new_n68_), .b(new_n67_), .O(new_n119_));
  nand4  g086(.a(new_n119_), .b(new_n118_), .c(x03), .d(x01), .O(new_n120_));
  nor2   g087(.a(new_n120_), .b(new_n117_), .O(z2));
  nand3  g088(.a(x15), .b(x13), .c(x05), .O(new_n122_));
  nand2  g089(.a(new_n53_), .b(x21), .O(new_n123_));
  ...
  nand3  g096(.a(new_n49_), .b(new_n95_), .c(new_n47_), .O(new_n130_));
  inv1   g097(.a(new_n130_), .O(new_n131_));
  nand3  g098(.a(new_n131_), .b(new_n129_), .c(new_n56_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n50_), .b(new_n48_), .c(new_n95_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n68_), .b(x19), .c(new_n67_), .d(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n130_), .c(new_n139_), .d(new_n126_), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n39_), .c(new_n138_), .d(new_n100_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n134_), .O(z3));
  inv1   g110(.a(x09), .O(new_n144_));
  aoi21  g111(.a(new_n64_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n144_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n61_), .c(x08), .O(new_n147_));
  aoi21  g114(.a(x23), .b(new_n94_), .c(new_n62_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n63_), .c(x09), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x16), .c(new_n95_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n117_), .c(new_n147_), .d(new_n46_), .O(z4));
  inv1   g118(.a(new_n46_), .O(z5));
  oai21  g119(.a(new_n68_), .b(x14), .c(new_n47_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n48_), .c(x03), .O(new_n154_));
  ...
  oai22  g124(.a(new_n157_), .b(new_n117_), .c(new_n154_), .d(new_n46_), .O(z6));
