...
module FAU ( 
  ...
  inv1   g115(.a(new_n38_), .O(new_n149_));
  ...
  aoi21  g120(.a(new_n140_), .b(x16), .c(new_n130_), .O(new_n154_));
  aoi21  g121(.a(new_n74_), .b(x17), .c(x09), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x16), .c(new_n130_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x07), .O(new_n157_));
  oai21  g124(.a(new_n154_), .b(new_n110_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n95_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n153_), .c(new_n148_), .O(z4));
  nand2  g127(.a(x20), .b(new_n119_), .O(new_n161_));
  ...
  nand2  g131(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g132(.a(new_n102_), .b(x14), .O(new_n166_));
