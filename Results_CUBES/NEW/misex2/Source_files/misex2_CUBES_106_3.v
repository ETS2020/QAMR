// Benchmark "FAU" written by ABC on Mon Jul  6 13:30:43 2020
...
module FAU ( 
  ...
  nand3  g18(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(new_n62_));
  inv1   g19(.a(x11), .O(new_n63_));
  nor2   g20(.a(new_n63_), .b(new_n57_), .O(new_n64_));
  nand2  g21(.a(new_n64_), .b(x12), .O(new_n65_));
  nor2   g22(.a(new_n46_), .b(new_n45_), .O(new_n66_));
  nand3  g23(.a(new_n66_), .b(new_n44_), .c(x02), .O(new_n67_));
  oai21  g24(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z03));
  nand2  g25(.a(new_n66_), .b(x02), .O(new_n69_));
  inv1   g26(.a(x12), .O(new_n70_));
  nand4  g27(.a(new_n70_), .b(new_n63_), .c(x10), .d(new_n44_), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n69_), .O(z04));
  nor3   g29(.a(new_n69_), .b(new_n57_), .c(new_n44_), .O(z05));
  nand3  g30(.a(new_n64_), .b(new_n44_), .c(x02), .O(new_n74_));
  nor3   g31(.a(new_n74_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand4  g32(.a(new_n64_), .b(new_n70_), .c(new_n44_), .d(x01), .O(new_n76_));
  nand2  g33(.a(x02), .b(x00), .O(new_n77_));
  aoi21  g34(.a(new_n76_), .b(x01), .c(new_n77_), .O(z07));
  nand2  g35(.a(new_n60_), .b(x02), .O(new_n79_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n61_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(x12), .c(new_n63_), .O(new_n104_));
  ...
  oai21  g74(.a(new_n57_), .b(new_n117_), .c(new_n66_), .O(new_n118_));
