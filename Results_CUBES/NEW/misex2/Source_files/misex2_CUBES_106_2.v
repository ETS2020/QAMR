...
module FAU ( 
  ...
  nand3  g16(.a(new_n45_), .b(new_n47_), .c(new_n59_), .O(new_n60_));
  ...
  oai22  g24(.a(new_n67_), .b(new_n63_), .c(new_n60_), .d(new_n58_), .O(z03));
  ...
  nand4  g51(.a(new_n95_), .b(new_n57_), .c(x22), .d(x21), .O(new_n96_));
  ...
  oai21  g66(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n111_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g68(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n121_));
  nand3  g77(.a(x19), .b(new_n59_), .c(new_n65_), .O(new_n122_));
  oai21  g78(.a(new_n121_), .b(new_n64_), .c(new_n122_), .O(z15));
  nor2   g79(.a(new_n65_), .b(x00), .O(z16));
  nand2  g80(.a(new_n45_), .b(x02), .O(new_n125_));
