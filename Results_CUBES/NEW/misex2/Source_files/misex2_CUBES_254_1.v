...
module FAU ( 
  ...
  nor2   g12(.a(x19), .b(new_n48_), .O(new_n56_));
  ...
  nor2   g18(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  ...
  nor3   g29(.a(new_n69_), .b(new_n53_), .c(new_n44_), .O(z05));
  ...
  nand4  g51(.a(new_n95_), .b(new_n56_), .c(x22), .d(x21), .O(new_n96_));
  ...
  oai21  g66(.a(new_n53_), .b(new_n58_), .c(new_n66_), .O(new_n111_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  inv1   g68(.a(x19), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(x17), .c(new_n58_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n59_), .O(new_n116_));
  ...
  nand3  g79(.a(x19), .b(new_n58_), .c(new_n65_), .O(new_n124_));
  oai21  g80(.a(new_n123_), .b(new_n64_), .c(new_n124_), .O(z15));
  nor2   g81(.a(new_n65_), .b(x00), .O(z16));
  nand2  g82(.a(new_n59_), .b(x02), .O(new_n127_));
