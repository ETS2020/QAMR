// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:37 2020
...
module FAU ( 
  ...
  nor2   g58(.a(new_n69_), .b(x11), .O(new_n102_));
  nor2   g59(.a(x14), .b(x13), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n102_), .c(x16), .d(x15), .O(new_n104_));
  inv1   g61(.a(new_n83_), .O(z17));
  nand3  g62(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(z17), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n104_), .O(z10));
  nand4  g66(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand4  g67(.a(new_n87_), .b(x15), .c(new_n92_), .d(new_n91_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand4  g69(.a(x12), .b(new_n62_), .c(x02), .d(new_n46_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n112_), .c(new_n107_), .O(new_n115_));
  aoi21  g72(.a(new_n115_), .b(new_n110_), .c(x00), .O(z11));
