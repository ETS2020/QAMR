...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n124_, new_n128_, new_n129_;
  ...
  oai21  g23(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(z03));
  ...
  nor2   g34(.a(x01), .b(x00), .O(new_n78_));
  nand2  g35(.a(new_n78_), .b(x02), .O(new_n79_));
  nor2   g36(.a(x08), .b(x07), .O(new_n80_));
  nand3  g37(.a(new_n80_), .b(x19), .c(x17), .O(new_n81_));
  inv1   g38(.a(x03), .O(new_n82_));
  nor2   g39(.a(x06), .b(x05), .O(new_n83_));
  nand3  g40(.a(new_n83_), .b(x04), .c(new_n82_), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(new_n81_), .c(new_n79_), .O(z08));
  ...
  nor2   g57(.a(x20), .b(new_n46_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n60_), .c(x22), .d(x21), .O(new_n102_));
  ...
  oai21  g74(.a(new_n57_), .b(new_n117_), .c(new_n65_), .O(new_n118_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g76(.a(new_n52_), .b(x17), .c(new_n117_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n78_), .O(new_n122_));
  inv1   g79(.a(x24), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x09), .O(new_n124_));
  aoi21  g81(.a(new_n122_), .b(new_n118_), .c(new_n124_), .O(z12));
  nor4   g82(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g83(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g84(.a(new_n57_), .b(x01), .c(new_n117_), .O(new_n128_));
  nand3  g85(.a(x19), .b(new_n117_), .c(new_n46_), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n45_), .c(new_n129_), .O(z15));
  nor2   g87(.a(new_n46_), .b(x00), .O(z16));
  inv1   g88(.a(new_n79_), .O(z17));
endmodule
