// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:15 2020
...
module FAU ( 
  ...
  nand3  g75(.a(new_n49_), .b(new_n47_), .c(new_n59_), .O(new_n119_));
  nand3  g76(.a(new_n119_), .b(new_n60_), .c(x23), .O(new_n120_));
  inv1   g77(.a(x24), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(x09), .O(new_n122_));
  aoi21  g79(.a(new_n120_), .b(new_n118_), .c(new_n122_), .O(z12));
  nor2   g80(.a(x19), .b(new_n47_), .O(new_n124_));
  and2   g81(.a(new_n124_), .b(new_n45_), .O(z13));
  nor2   g82(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g83(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n65_), .c(new_n128_), .O(z15));
  nor2   g86(.a(new_n66_), .b(x00), .O(z16));
  inv1   g87(.a(new_n84_), .O(z17));
endmodule
