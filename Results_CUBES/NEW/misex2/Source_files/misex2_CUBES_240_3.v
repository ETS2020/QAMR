// Benchmark "FAU" written by ABC on Mon Jul  6 13:31:41 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n124_, new_n125_, new_n126_, new_n130_;
  ...
  nand4  g20(.a(new_n50_), .b(new_n45_), .c(new_n63_), .d(new_n62_), .O(new_n64_));
  inv1   g21(.a(x11), .O(new_n65_));
  nor2   g22(.a(new_n65_), .b(new_n57_), .O(new_n66_));
  nand2  g23(.a(new_n66_), .b(x12), .O(new_n67_));
  nor2   g24(.a(new_n63_), .b(new_n62_), .O(new_n68_));
  ...
  nor3   g33(.a(new_n76_), .b(new_n63_), .c(new_n62_), .O(z06));
  ...
  nand2  g48(.a(x02), .b(new_n63_), .O(new_n92_));
  ...
  nor2   g59(.a(x20), .b(new_n63_), .O(new_n103_));
  ...
  nand2  g73(.a(new_n100_), .b(new_n62_), .O(new_n117_));
  aoi21  g74(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z11));
  oai21  g75(.a(new_n57_), .b(new_n45_), .c(new_n68_), .O(new_n119_));
  nand2  g76(.a(new_n45_), .b(new_n63_), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(x23), .O(new_n121_));
  nand2  g78(.a(new_n52_), .b(x17), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n120_), .c(new_n121_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n62_), .O(new_n124_));
  inv1   g81(.a(x24), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(x09), .O(new_n126_));
  aoi21  g83(.a(new_n124_), .b(new_n119_), .c(new_n126_), .O(z12));
  nor2   g84(.a(new_n122_), .b(new_n47_), .O(z13));
  nor2   g85(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g86(.a(new_n57_), .b(x01), .c(new_n45_), .O(new_n130_));
  oai22  g87(.a(new_n130_), .b(new_n62_), .c(new_n120_), .d(new_n52_), .O(z15));
  nor2   g88(.a(new_n63_), .b(x00), .O(z16));
