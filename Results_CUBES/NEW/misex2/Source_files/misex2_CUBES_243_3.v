...
module FAU ( 
  ...
  nand2  g40(.a(x02), .b(new_n66_), .O(new_n84_));
  inv1   g41(.a(x03), .O(new_n85_));
  nand2  g42(.a(x04), .b(new_n85_), .O(new_n86_));
  ...
  nor2   g49(.a(new_n92_), .b(new_n84_), .O(new_n93_));
  nand4  g50(.a(new_n93_), .b(x20), .c(new_n89_), .d(new_n88_), .O(new_n94_));
  ...
  nand3  g59(.a(new_n90_), .b(x12), .c(new_n62_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  nor2   g61(.a(new_n88_), .b(x14), .O(new_n105_));
  ...
  nand4  g66(.a(new_n95_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g67(.a(new_n97_), .b(x20), .c(new_n89_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g70(.a(new_n98_), .b(new_n65_), .O(new_n114_));
  ...
  and2   g76(.a(x23), .b(x19), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n119_), .c(new_n66_), .O(new_n121_));
  ...
  nand2  g88(.a(new_n60_), .b(x02), .O(new_n132_));
