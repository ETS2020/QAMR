...
module FAU ( 
  ...
  nand3  g07(.a(new_n48_), .b(x12), .c(new_n47_), .O(new_n49_));
  nor2   g08(.a(new_n49_), .b(new_n46_), .O(z02));
  nand3  g09(.a(x15), .b(new_n43_), .c(x12), .O(new_n51_));
  nor2   g10(.a(new_n51_), .b(new_n46_), .O(z03));
  inv1   g11(.a(x18), .O(z04));
  nand2  g12(.a(x09), .b(x08), .O(z10));
  inv1   g13(.a(z10), .O(z09));
  inv1   g14(.a(x12), .O(new_n56_));
  nand3  g15(.a(new_n48_), .b(x10), .c(x08), .O(new_n57_));
