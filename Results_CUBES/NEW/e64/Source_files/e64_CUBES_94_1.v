...
module FAU ( 
  ...
  inv1   g134(.a(new_n216_), .O(new_n302_));
  nand3  g135(.a(new_n302_), .b(new_n301_), .c(new_n167_), .O(new_n303_));
  nand4  g136(.a(new_n135_), .b(new_n138_), .c(new_n174_), .d(new_n173_), .O(new_n304_));
  inv1   g137(.a(new_n304_), .O(new_n305_));
  inv1   g138(.a(x03), .O(new_n306_));
  nand4  g139(.a(new_n172_), .b(new_n171_), .c(new_n169_), .d(new_n306_), .O(new_n307_));
  inv1   g140(.a(new_n307_), .O(new_n308_));
  nand4  g141(.a(new_n143_), .b(new_n144_), .c(x29), .d(new_n177_), .O(new_n309_));
  inv1   g142(.a(new_n309_), .O(new_n310_));
  inv1   g143(.a(x22), .O(new_n311_));
  nand4  g144(.a(new_n139_), .b(new_n181_), .c(new_n180_), .d(new_n311_), .O(new_n312_));
  inv1   g145(.a(new_n312_), .O(new_n313_));
  nand4  g146(.a(new_n313_), .b(new_n310_), .c(new_n308_), .d(new_n305_), .O(new_n314_));
  nor2   g147(.a(new_n314_), .b(new_n303_), .O(z57));
  nand4  g148(.a(new_n139_), .b(new_n181_), .c(new_n180_), .d(x22), .O(new_n316_));
  inv1   g149(.a(new_n316_), .O(new_n317_));
  nand4  g150(.a(new_n317_), .b(new_n310_), .c(new_n308_), .d(new_n305_), .O(new_n318_));
  nor2   g151(.a(new_n318_), .b(new_n303_), .O(z58));
  nor2   g152(.a(x58), .b(x50), .O(new_n320_));
  nand3  g153(.a(new_n320_), .b(new_n143_), .c(x40), .O(new_n321_));
  nor2   g154(.a(new_n321_), .b(new_n201_), .O(z59));
  nand2  g155(.a(new_n172_), .b(x07), .O(new_n323_));
  nor2   g156(.a(new_n323_), .b(new_n304_), .O(new_n324_));
  nand2  g157(.a(new_n156_), .b(new_n154_), .O(new_n325_));
  nor2   g158(.a(new_n325_), .b(new_n237_), .O(new_n326_));
  nand3  g159(.a(new_n326_), .b(new_n324_), .c(new_n234_), .O(new_n327_));
  inv1   g160(.a(new_n327_), .O(z60));
  nor2   g161(.a(x10), .b(new_n172_), .O(new_n329_));
  nand4  g162(.a(new_n329_), .b(new_n223_), .c(new_n190_), .d(new_n186_), .O(new_n330_));
  nand3  g163(.a(new_n212_), .b(new_n215_), .c(new_n160_), .O(new_n331_));
  inv1   g164(.a(new_n331_), .O(new_n332_));
  nand4  g165(.a(new_n159_), .b(new_n214_), .c(new_n143_), .d(new_n193_), .O(new_n333_));
  inv1   g166(.a(new_n333_), .O(new_n334_));
  nand3  g167(.a(new_n164_), .b(new_n144_), .c(x29), .O(new_n335_));
  inv1   g168(.a(new_n335_), .O(new_n336_));
  nand3  g169(.a(new_n336_), .b(new_n334_), .c(new_n332_), .O(new_n337_));
  nor2   g170(.a(new_n337_), .b(new_n330_), .O(z61));
  nand3  g171(.a(new_n232_), .b(x29), .c(new_n139_), .O(new_n339_));
  nor2   g172(.a(new_n339_), .b(new_n304_), .O(new_n340_));
  nand3  g173(.a(new_n236_), .b(new_n164_), .c(new_n140_), .O(new_n341_));
  inv1   g174(.a(new_n341_), .O(new_n342_));
  nand2  g175(.a(new_n160_), .b(x47), .O(new_n343_));
  nor2   g176(.a(new_n343_), .b(new_n325_), .O(new_n344_));
  nand3  g177(.a(new_n344_), .b(new_n342_), .c(new_n340_), .O(new_n345_));
  inv1   g178(.a(new_n345_), .O(z62));
  nand3  g179(.a(new_n320_), .b(new_n154_), .c(x56), .O(new_n347_));
  inv1   g180(.a(new_n347_), .O(new_n348_));
  nand3  g181(.a(new_n348_), .b(new_n342_), .c(new_n340_), .O(new_n349_));
  inv1   g182(.a(new_n349_), .O(z63));
  nand3  g183(.a(new_n305_), .b(new_n232_), .c(new_n199_), .O(new_n351_));
  nor2   g184(.a(x40), .b(x39), .O(new_n352_));
  nor3   g185(.a(x60), .b(x58), .c(x50), .O(new_n353_));
  inv1   g186(.a(x30), .O(new_n354_));
  nor2   g187(.a(x37), .b(new_n354_), .O(new_n355_));
  nand4  g188(.a(new_n355_), .b(new_n353_), .c(new_n352_), .d(new_n161_), .O(new_n356_));
  nor2   g189(.a(new_n356_), .b(new_n351_), .O(z64));
  zero   g190(.O(z00));
  zero   g191(.O(z01));
  zero   g192(.O(z02));
  zero   g193(.O(z03));
