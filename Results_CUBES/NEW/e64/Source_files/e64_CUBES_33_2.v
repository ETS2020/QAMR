...
module FAU ( 
  ...
  inv1   g525(.a(new_n335_), .O(new_n656_));
  nand4  g526(.a(new_n656_), .b(new_n332_), .c(new_n203_), .d(x07), .O(new_n657_));
  nand3  g527(.a(new_n361_), .b(new_n363_), .c(new_n348_), .O(new_n658_));
  nand2  g528(.a(new_n356_), .b(new_n196_), .O(new_n659_));
  nor2   g529(.a(x30), .b(x28), .O(new_n660_));
  nand2  g530(.a(new_n660_), .b(new_n160_), .O(new_n661_));
  nor4   g531(.a(new_n661_), .b(new_n659_), .c(new_n658_), .d(new_n657_), .O(z60));
  ...
  nor4   g535(.a(new_n665_), .b(new_n664_), .c(new_n659_), .d(new_n658_), .O(z61));
  nor2   g536(.a(new_n381_), .b(new_n376_), .O(new_n667_));
  nand2  g537(.a(new_n348_), .b(x47), .O(new_n668_));
  nor3   g538(.a(new_n668_), .b(new_n383_), .c(x60), .O(new_n669_));
