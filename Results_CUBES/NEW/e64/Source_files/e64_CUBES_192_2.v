// Benchmark "FAU" written by ABC on Mon Jul  6 13:46:23 2020
...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n672_, new_n674_, new_n675_, new_n676_, new_n678_;
  ...
  nand3  g190(.a(new_n320_), .b(x28), .c(new_n286_), .O(new_n321_));
  ...
  nand3  g213(.a(new_n160_), .b(x41), .c(new_n313_), .O(new_n344_));
  ...
  nand2  g222(.a(new_n352_), .b(new_n320_), .O(new_n353_));
  nand4  g223(.a(new_n152_), .b(new_n286_), .c(new_n219_), .d(x10), .O(new_n354_));
  nor2   g224(.a(new_n354_), .b(new_n353_), .O(z15));
  nand3  g225(.a(new_n160_), .b(new_n290_), .c(new_n313_), .O(new_n356_));
  ...
  nand2  g265(.a(new_n315_), .b(new_n196_), .O(new_n396_));
  ...
  nor2   g309(.a(new_n298_), .b(new_n254_), .O(new_n440_));
  ...
  nor2   g325(.a(x14), .b(x10), .O(new_n456_));
  nand3  g326(.a(new_n456_), .b(new_n286_), .c(x11), .O(new_n457_));
  nand3  g327(.a(new_n360_), .b(new_n348_), .c(new_n157_), .O(new_n458_));
  nor4   g328(.a(new_n458_), .b(new_n457_), .c(new_n380_), .d(new_n356_), .O(z24));
  nand2  g329(.a(new_n378_), .b(new_n328_), .O(new_n460_));
  inv1   g330(.a(new_n460_), .O(new_n461_));
  nor2   g331(.a(x37), .b(x28), .O(new_n462_));
  nand4  g332(.a(new_n462_), .b(new_n461_), .c(new_n337_), .d(x24), .O(new_n463_));
  nand2  g333(.a(new_n181_), .b(new_n348_), .O(new_n464_));
  nor2   g334(.a(new_n464_), .b(x60), .O(new_n465_));
  nand2  g335(.a(new_n465_), .b(new_n349_), .O(new_n466_));
  nor2   g336(.a(new_n466_), .b(new_n463_), .O(z25));
  inv1   g337(.a(new_n222_), .O(new_n468_));
  nand4  g338(.a(new_n378_), .b(new_n315_), .c(new_n262_), .d(new_n255_), .O(new_n469_));
  nor3   g339(.a(new_n469_), .b(new_n282_), .c(new_n280_), .O(new_n470_));
  nand2  g340(.a(new_n225_), .b(new_n224_), .O(new_n471_));
  or2    g341(.a(new_n471_), .b(new_n388_), .O(new_n472_));
  inv1   g342(.a(new_n472_), .O(new_n473_));
  inv1   g343(.a(x33), .O(new_n474_));
  nand3  g344(.a(new_n149_), .b(new_n474_), .c(x32), .O(new_n475_));
  nor2   g345(.a(new_n475_), .b(new_n309_), .O(new_n476_));
  nand4  g346(.a(new_n476_), .b(new_n473_), .c(new_n470_), .d(new_n274_), .O(new_n477_));
  nor2   g347(.a(new_n477_), .b(new_n468_), .O(z26));
  nor2   g348(.a(new_n446_), .b(new_n438_), .O(new_n479_));
  and2   g349(.a(new_n479_), .b(new_n440_), .O(new_n480_));
  nand2  g350(.a(new_n220_), .b(new_n176_), .O(new_n481_));
  nor3   g351(.a(new_n481_), .b(x14), .c(new_n218_), .O(new_n482_));
  nor3   g352(.a(new_n471_), .b(new_n435_), .c(new_n434_), .O(new_n483_));
  nand4  g353(.a(new_n483_), .b(new_n482_), .c(new_n480_), .d(new_n244_), .O(new_n484_));
  nor2   g354(.a(new_n484_), .b(new_n217_), .O(z27));
  nand4  g355(.a(new_n461_), .b(new_n320_), .c(new_n152_), .d(x25), .O(new_n486_));
  nor2   g356(.a(new_n486_), .b(new_n466_), .O(z28));
  nand2  g357(.a(new_n378_), .b(new_n290_), .O(new_n488_));
  or2    g358(.a(new_n488_), .b(new_n350_), .O(new_n489_));
  nand4  g359(.a(x60), .b(new_n181_), .c(new_n348_), .d(new_n157_), .O(new_n490_));
  ...
  nand2  g365(.a(new_n315_), .b(new_n255_), .O(new_n496_));
  nand4  g366(.a(new_n378_), .b(new_n262_), .c(new_n149_), .d(new_n148_), .O(new_n497_));
  nor3   g367(.a(new_n497_), .b(new_n496_), .c(new_n282_), .O(new_n498_));
  nand4  g368(.a(new_n498_), .b(new_n495_), .c(new_n493_), .d(new_n308_), .O(new_n499_));
  nor2   g369(.a(new_n499_), .b(new_n432_), .O(z30));
  and2   g370(.a(new_n403_), .b(new_n243_), .O(new_n501_));
  ...
  nand4  g375(.a(new_n505_), .b(new_n503_), .c(new_n501_), .d(new_n398_), .O(new_n506_));
  nor2   g376(.a(new_n506_), .b(new_n432_), .O(z31));
  nand3  g377(.a(new_n181_), .b(new_n348_), .c(x46), .O(new_n508_));
  nor2   g378(.a(new_n508_), .b(new_n489_), .O(z32));
  nand4  g379(.a(new_n352_), .b(new_n348_), .c(new_n313_), .d(x39), .O(new_n510_));
  nor2   g380(.a(new_n510_), .b(new_n350_), .O(z33));
  nor4   g381(.a(new_n430_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  nand2  g382(.a(new_n360_), .b(new_n144_), .O(new_n513_));
  inv1   g383(.a(new_n513_), .O(new_n514_));
  nand2  g384(.a(new_n186_), .b(new_n183_), .O(new_n515_));
  inv1   g385(.a(new_n515_), .O(new_n516_));
  nand4  g386(.a(new_n516_), .b(new_n514_), .c(new_n421_), .d(new_n196_), .O(new_n517_));
  nand3  g387(.a(new_n167_), .b(new_n165_), .c(x04), .O(new_n518_));
  nor2   g388(.a(new_n518_), .b(new_n141_), .O(new_n519_));
  nor2   g389(.a(new_n375_), .b(new_n174_), .O(new_n520_));
  inv1   g390(.a(new_n378_), .O(new_n521_));
  ...
  nor3   g397(.a(new_n527_), .b(new_n523_), .c(new_n422_), .O(new_n528_));
  nand3  g398(.a(new_n360_), .b(new_n192_), .c(x61), .O(new_n529_));
  nor3   g399(.a(new_n529_), .b(x56), .c(x55), .O(new_n530_));
  nand4  g400(.a(new_n530_), .b(new_n528_), .c(new_n415_), .d(new_n413_), .O(new_n531_));
  inv1   g401(.a(new_n531_), .O(z36));
  nand3  g402(.a(new_n444_), .b(new_n250_), .c(new_n160_), .O(new_n533_));
  ...
  nand4  g407(.a(new_n537_), .b(new_n535_), .c(new_n534_), .d(new_n295_), .O(new_n538_));
  nor2   g408(.a(new_n538_), .b(new_n468_), .O(z37));
  ...
  nand4  g416(.a(new_n546_), .b(new_n544_), .c(new_n541_), .d(new_n376_), .O(new_n547_));
  inv1   g417(.a(new_n361_), .O(new_n548_));
  ...
  nor2   g423(.a(x43), .b(new_n314_), .O(new_n554_));
  ...
  nand3  g429(.a(new_n393_), .b(new_n261_), .c(new_n255_), .O(new_n560_));
  inv1   g430(.a(x51), .O(new_n561_));
  nand2  g431(.a(new_n135_), .b(new_n561_), .O(new_n562_));
  nor3   g432(.a(new_n562_), .b(new_n560_), .c(new_n460_), .O(new_n563_));
  ...
  nor2   g453(.a(new_n388_), .b(new_n309_), .O(new_n584_));
  ...
  nand4  g461(.a(new_n591_), .b(new_n252_), .c(new_n158_), .d(new_n300_), .O(new_n592_));
  ...
  nand4  g469(.a(new_n599_), .b(new_n598_), .c(new_n444_), .d(new_n160_), .O(new_n600_));
  ...
  nor2   g481(.a(new_n611_), .b(new_n435_), .O(new_n612_));
  inv1   g482(.a(x35), .O(new_n613_));
  nand3  g483(.a(new_n377_), .b(new_n296_), .c(new_n613_), .O(new_n614_));
  nor2   g484(.a(new_n614_), .b(new_n298_), .O(new_n615_));
  nand3  g485(.a(new_n615_), .b(new_n612_), .c(new_n599_), .O(new_n616_));
  nor2   g486(.a(new_n616_), .b(new_n610_), .O(z47));
  nand3  g487(.a(new_n149_), .b(new_n474_), .c(x31), .O(new_n618_));
  ...
  nor2   g500(.a(new_n630_), .b(new_n298_), .O(new_n631_));
  ...
  nand2  g505(.a(new_n635_), .b(new_n386_), .O(new_n636_));
  nor2   g506(.a(new_n636_), .b(new_n634_), .O(z52));
  nand2  g507(.a(new_n239_), .b(x63), .O(new_n638_));
  nor2   g508(.a(new_n638_), .b(new_n406_), .O(z53));
  nor3   g509(.a(new_n361_), .b(x56), .c(new_n132_), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n528_), .c(new_n415_), .d(new_n413_), .O(new_n641_));
  inv1   g511(.a(new_n641_), .O(z54));
  nor2   g512(.a(x37), .b(new_n613_), .O(new_n643_));
  nand4  g513(.a(new_n643_), .b(new_n549_), .c(new_n423_), .d(new_n327_), .O(new_n644_));
  ...
  nand4  g517(.a(new_n647_), .b(new_n470_), .c(new_n274_), .d(new_n156_), .O(new_n648_));
  nor2   g518(.a(new_n648_), .b(new_n443_), .O(z56));
  ...
  inv1   g522(.a(new_n363_), .O(new_n653_));
  nand3  g523(.a(new_n423_), .b(new_n653_), .c(new_n548_), .O(new_n654_));
  nand3  g524(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n655_));
  nor4   g525(.a(new_n655_), .b(new_n654_), .c(new_n650_), .d(new_n424_), .O(z58));
  nor4   g526(.a(new_n464_), .b(new_n350_), .c(x43), .d(new_n313_), .O(z59));
  nor3   g527(.a(new_n375_), .b(x08), .c(new_n210_), .O(new_n658_));
  nand2  g528(.a(new_n133_), .b(new_n190_), .O(new_n659_));
  nor2   g529(.a(new_n659_), .b(new_n329_), .O(new_n660_));
  nand3  g530(.a(new_n660_), .b(new_n658_), .c(new_n381_), .O(new_n661_));
  inv1   g531(.a(new_n661_), .O(z60));
  nor2   g532(.a(x10), .b(new_n203_), .O(new_n663_));
  nand4  g533(.a(new_n663_), .b(new_n370_), .c(new_n338_), .d(new_n175_), .O(new_n664_));
  nand3  g534(.a(new_n360_), .b(new_n362_), .c(new_n348_), .O(new_n665_));
  nand3  g535(.a(new_n196_), .b(new_n290_), .c(new_n313_), .O(new_n666_));
  nand2  g536(.a(new_n160_), .b(new_n154_), .O(new_n667_));
  nor4   g537(.a(new_n667_), .b(new_n666_), .c(new_n665_), .d(new_n664_), .O(z61));
  nor2   g538(.a(new_n380_), .b(new_n375_), .O(new_n669_));
  nand2  g539(.a(new_n348_), .b(x47), .O(new_n670_));
  nor2   g540(.a(new_n670_), .b(new_n659_), .O(new_n671_));
  nand4  g541(.a(new_n671_), .b(new_n669_), .c(new_n461_), .d(new_n377_), .O(new_n672_));
  inv1   g542(.a(new_n672_), .O(z62));
  nand4  g543(.a(new_n190_), .b(new_n181_), .c(x56), .d(new_n348_), .O(new_n674_));
  inv1   g544(.a(new_n674_), .O(new_n675_));
  nand4  g545(.a(new_n675_), .b(new_n669_), .c(new_n461_), .d(new_n377_), .O(new_n676_));
  inv1   g546(.a(new_n676_), .O(z63));
  nand4  g547(.a(new_n465_), .b(new_n461_), .c(new_n289_), .d(x30), .O(new_n678_));
