...
module FAU ( 
  ...
  nand2  g536(.a(new_n173_), .b(new_n152_), .O(new_n667_));
  nor2   g537(.a(new_n667_), .b(new_n376_), .O(new_n668_));
  nand3  g538(.a(new_n328_), .b(new_n348_), .c(x47), .O(new_n669_));
  nor3   g539(.a(new_n669_), .b(new_n657_), .c(new_n380_), .O(new_n670_));
  and2   g540(.a(new_n670_), .b(new_n668_), .O(z62));
  nand2  g541(.a(new_n668_), .b(x29), .O(new_n672_));
  nand2  g542(.a(new_n190_), .b(x56), .O(new_n673_));
  nand2  g543(.a(new_n482_), .b(new_n378_), .O(new_n674_));
  nor4   g544(.a(new_n674_), .b(new_n673_), .c(new_n672_), .d(new_n484_), .O(z63));
  nand3  g545(.a(new_n482_), .b(new_n289_), .c(x30), .O(new_n676_));
  nor4   g546(.a(new_n676_), .b(new_n672_), .c(new_n484_), .d(x60), .O(z64));
