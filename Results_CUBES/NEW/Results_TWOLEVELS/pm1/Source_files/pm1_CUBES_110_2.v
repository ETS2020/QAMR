...
module FAU ( 
  ...
  nand3  g32(.a(new_n61_), .b(new_n50_), .c(x09), .O(new_n62_));
  nor2   g33(.a(new_n32_), .b(new_n31_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g35(.a(new_n64_), .b(new_n55_), .c(new_n57_), .O(z09));
  nand3  g36(.a(new_n58_), .b(new_n53_), .c(new_n50_), .O(new_n66_));
  inv1   g37(.a(new_n66_), .O(z10));
  nand4  g38(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n68_));
  ...
  nor4   g42(.a(new_n57_), .b(new_n32_), .c(new_n31_), .d(x09), .O(z12));
endmodule
