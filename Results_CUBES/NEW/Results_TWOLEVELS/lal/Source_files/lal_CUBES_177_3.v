// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:26 2020
...
module FAU ( 
  ...
  nand2  g39(.a(new_n82_), .b(new_n78_), .O(new_n85_));
  nor2   g40(.a(x25), .b(x24), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(new_n48_), .O(new_n87_));
  aoi21  g42(.a(new_n85_), .b(x20), .c(new_n87_), .O(new_n88_));
  ...
  nand3  g47(.a(new_n90_), .b(new_n54_), .c(new_n77_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  inv1   g49(.a(new_n56_), .O(new_n95_));
  nand2  g50(.a(x18), .b(new_n77_), .O(new_n96_));
  inv1   g51(.a(x15), .O(new_n97_));
  nand3  g52(.a(new_n79_), .b(x17), .c(new_n97_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n96_), .c(new_n95_), .O(z11));
  xor2a  g54(.a(x19), .b(x17), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(x18), .O(new_n101_));
  nand3  g56(.a(x19), .b(new_n79_), .c(new_n97_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n101_), .c(new_n95_), .O(z12));
  nand3  g58(.a(x19), .b(x18), .c(x17), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(x20), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n90_), .c(new_n71_), .d(new_n54_), .O(z13));
  inv1   g61(.a(new_n104_), .O(new_n107_));
  nor2   g62(.a(x21), .b(x20), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g64(.a(new_n71_), .b(x21), .O(new_n110_));
  nand2  g65(.a(new_n90_), .b(new_n54_), .O(new_n111_));
  ...
  nand3  g69(.a(new_n107_), .b(new_n72_), .c(new_n70_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n112_), .O(z15));
  nand2  g71(.a(new_n115_), .b(x23), .O(new_n117_));
  nor2   g72(.a(x23), .b(x22), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n108_), .c(new_n107_), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n117_), .c(new_n112_), .O(z16));
  inv1   g75(.a(new_n74_), .O(new_n121_));
  nand2  g76(.a(new_n119_), .b(x24), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n112_), .c(new_n121_), .O(z17));
  inv1   g78(.a(new_n71_), .O(new_n124_));
  nand4  g79(.a(new_n86_), .b(new_n72_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
  nand2  g80(.a(new_n121_), .b(x25), .O(new_n126_));
  nand3  g81(.a(new_n126_), .b(new_n125_), .c(new_n112_), .O(z18));
  buf    g82(.a(x16), .O(z02));
endmodule
