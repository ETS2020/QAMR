// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:27 2020
...
module FAU ( 
  ...
  nand2  g50(.a(x18), .b(x07), .O(new_n96_));
  nand4  g51(.a(new_n96_), .b(new_n56_), .c(new_n79_), .d(new_n95_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(z10));
  inv1   g53(.a(x07), .O(new_n99_));
  nand3  g54(.a(x18), .b(new_n79_), .c(new_n99_), .O(new_n100_));
  nand2  g55(.a(new_n81_), .b(x17), .O(new_n101_));
  nand2  g56(.a(new_n56_), .b(new_n95_), .O(new_n102_));
  aoi21  g57(.a(new_n101_), .b(new_n100_), .c(new_n102_), .O(z11));
  nor2   g58(.a(new_n82_), .b(x17), .O(new_n104_));
  nor3   g59(.a(x19), .b(new_n81_), .c(new_n79_), .O(new_n105_));
  oai21  g60(.a(new_n105_), .b(new_n104_), .c(new_n99_), .O(new_n106_));
  nand2  g61(.a(x19), .b(new_n81_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n102_), .O(z12));
