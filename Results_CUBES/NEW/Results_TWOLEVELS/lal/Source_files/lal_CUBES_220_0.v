...
module FAU ( 
  ...
  nand2  g44(.a(new_n86_), .b(new_n89_), .O(new_n90_));
  oai21  g45(.a(x19), .b(x18), .c(new_n52_), .O(new_n91_));
  nor2   g46(.a(new_n91_), .b(new_n90_), .O(z10));
  xnor2a g47(.a(x18), .b(x17), .O(new_n93_));
  nand2  g48(.a(new_n86_), .b(new_n52_), .O(new_n94_));
  nor2   g49(.a(new_n94_), .b(new_n93_), .O(z11));
  nand2  g50(.a(x19), .b(x18), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x17), .O(new_n97_));
  nand2  g52(.a(x19), .b(new_n89_), .O(new_n98_));
  aoi21  g53(.a(new_n98_), .b(new_n97_), .c(new_n94_), .O(z12));
  ...
  nand2  g58(.a(new_n69_), .b(x21), .O(new_n104_));
  nand2  g59(.a(new_n86_), .b(new_n52_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z14));
  nand2  g62(.a(new_n103_), .b(x22), .O(new_n108_));
  nand3  g63(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n108_), .c(new_n106_), .O(z15));
  nand2  g65(.a(new_n109_), .b(x23), .O(new_n111_));
  nand4  g66(.a(new_n102_), .b(new_n76_), .c(new_n48_), .d(new_n71_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n106_), .O(z16));
  nand2  g68(.a(new_n112_), .b(x24), .O(new_n114_));
  nor2   g69(.a(new_n105_), .b(new_n73_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(z17));
  inv1   g71(.a(new_n69_), .O(new_n117_));
  nand4  g72(.a(new_n82_), .b(new_n74_), .c(new_n117_), .d(new_n48_), .O(new_n118_));
  oai21  g73(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n106_), .O(z18));
  buf    g75(.a(x16), .O(z02));
endmodule
