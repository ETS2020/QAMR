...
module FAU ( 
  ...
  nand3  g32(.a(new_n77_), .b(new_n72_), .c(new_n49_), .O(new_n78_));
  oai21  g33(.a(new_n78_), .b(new_n74_), .c(x25), .O(new_n79_));
  inv1   g34(.a(x17), .O(new_n80_));
  inv1   g35(.a(x25), .O(new_n81_));
  nand2  g36(.a(new_n76_), .b(new_n75_), .O(new_n82_));
  ...
  nand2  g40(.a(new_n83_), .b(new_n81_), .O(new_n86_));
  nor2   g41(.a(x25), .b(x24), .O(new_n87_));
  nor2   g42(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  aoi21  g43(.a(new_n86_), .b(x20), .c(new_n88_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n85_), .c(new_n79_), .O(z08));
  nor2   g45(.a(x15), .b(x07), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n55_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z09));
  nand3  g48(.a(new_n91_), .b(new_n54_), .c(new_n80_), .O(new_n94_));
  ...
  oai21  g53(.a(new_n75_), .b(new_n80_), .c(x19), .O(new_n99_));
  nor2   g54(.a(new_n75_), .b(new_n80_), .O(new_n100_));
  nand2  g55(.a(new_n100_), .b(new_n76_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(z12));
  oai21  g57(.a(new_n76_), .b(new_n75_), .c(x20), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n91_), .c(new_n71_), .d(new_n54_), .O(z13));
  ...
  nand2  g62(.a(new_n91_), .b(new_n54_), .O(new_n108_));
  ...
  nand2  g66(.a(new_n77_), .b(x17), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n72_), .c(new_n70_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n111_), .c(new_n109_), .O(z15));
  nand2  g70(.a(new_n72_), .b(new_n70_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n112_), .c(x23), .O(new_n117_));
  inv1   g72(.a(x22), .O(new_n118_));
  nand3  g73(.a(new_n105_), .b(new_n48_), .c(new_n118_), .O(new_n119_));
  ...
  oai21  g78(.a(new_n119_), .b(new_n112_), .c(x24), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n109_), .c(new_n123_), .O(z17));
  inv1   g80(.a(new_n71_), .O(new_n126_));
  nand4  g81(.a(new_n87_), .b(new_n72_), .c(new_n126_), .d(new_n48_), .O(new_n127_));
  nand2  g82(.a(new_n123_), .b(x25), .O(new_n128_));
  nand3  g83(.a(new_n128_), .b(new_n127_), .c(new_n109_), .O(z18));
  buf    g84(.a(x16), .O(z02));
endmodule
