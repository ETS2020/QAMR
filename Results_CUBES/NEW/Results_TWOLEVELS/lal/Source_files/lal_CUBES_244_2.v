...
module FAU ( 
  ...
  nand3  g29(.a(new_n74_), .b(new_n51_), .c(new_n50_), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(new_n49_), .c(new_n54_), .O(new_n76_));
  oai21  g31(.a(new_n76_), .b(x23), .c(x24), .O(new_n77_));
  nand2  g32(.a(new_n77_), .b(new_n48_), .O(z08));
  nor2   g33(.a(x15), .b(x07), .O(new_n79_));
  nand2  g34(.a(new_n79_), .b(new_n59_), .O(new_n80_));
  inv1   g35(.a(new_n80_), .O(z09));
  nand3  g36(.a(new_n79_), .b(new_n58_), .c(new_n50_), .O(new_n82_));
  ...
  nand2  g44(.a(new_n87_), .b(new_n74_), .O(new_n90_));
  aoi21  g45(.a(new_n90_), .b(new_n89_), .c(new_n85_), .O(z12));
  oai21  g46(.a(new_n88_), .b(new_n74_), .c(x20), .O(new_n92_));
  nor2   g47(.a(x20), .b(new_n74_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n87_), .O(new_n94_));
  nand2  g49(.a(new_n79_), .b(new_n58_), .O(new_n95_));
  inv1   g50(.a(new_n95_), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n94_), .c(new_n92_), .O(z13));
  inv1   g52(.a(x21), .O(new_n98_));
  nand3  g53(.a(new_n93_), .b(new_n87_), .c(new_n98_), .O(new_n99_));
  nand2  g54(.a(new_n94_), .b(x21), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n96_), .O(z14));
  nand2  g56(.a(x19), .b(x17), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(x18), .c(new_n59_), .O(new_n103_));
  nand3  g58(.a(new_n93_), .b(new_n87_), .c(x21), .O(new_n104_));
  oai21  g59(.a(x20), .b(new_n51_), .c(x22), .O(new_n105_));
  nand4  g60(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n79_), .O(z15));
  inv1   g61(.a(x07), .O(new_n107_));
  inv1   g62(.a(x15), .O(new_n108_));
  inv1   g63(.a(x23), .O(new_n109_));
  nand4  g64(.a(new_n58_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(z16));
  inv1   g65(.a(x24), .O(new_n111_));
  nand4  g66(.a(new_n58_), .b(new_n111_), .c(new_n108_), .d(new_n107_), .O(z17));
  nand4  g67(.a(new_n58_), .b(new_n48_), .c(new_n108_), .d(new_n107_), .O(z18));
  buf    g68(.a(x16), .O(z02));
endmodule
