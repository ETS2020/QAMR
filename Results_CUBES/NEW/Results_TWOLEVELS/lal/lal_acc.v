...
module FAU ( 
  ...
  nand3  g46(.a(new_n91_), .b(new_n88_), .c(new_n87_), .O(z13));
  inv1   g47(.a(new_n86_), .O(new_n93_));
  nor2   g48(.a(x21), .b(x20), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g50(.a(new_n88_), .b(x21), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z14));
  inv1   g52(.a(new_n94_), .O(new_n98_));
  oai21  g53(.a(new_n98_), .b(new_n86_), .c(x22), .O(new_n99_));
  nor2   g54(.a(x22), .b(x21), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n93_), .c(new_n49_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n99_), .c(new_n91_), .O(z15));
  nand2  g57(.a(new_n100_), .b(new_n49_), .O(new_n103_));
  oai21  g58(.a(new_n103_), .b(new_n86_), .c(x23), .O(new_n104_));
  ...
  nand3  g64(.a(new_n109_), .b(new_n104_), .c(new_n91_), .O(z16));
  oai21  g65(.a(new_n107_), .b(new_n86_), .c(x24), .O(new_n111_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n111_), .c(new_n91_), .O(z17));
  nand4  g72(.a(new_n113_), .b(new_n100_), .c(new_n112_), .d(new_n48_), .O(new_n118_));
  oai21  g73(.a(new_n114_), .b(new_n88_), .c(x25), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n118_), .c(new_n91_), .O(z18));
  buf1   g75(.a(x16), .O(z02));
endmodule
