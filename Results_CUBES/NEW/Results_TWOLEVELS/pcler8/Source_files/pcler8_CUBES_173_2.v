...
module FAU ( 
  ...
  aoi21  g68(.a(x25), .b(x16), .c(new_n112_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nor3   g70(.a(new_n110_), .b(new_n112_), .c(x24), .O(new_n115_));
  ...
  nand3  g76(.a(new_n120_), .b(new_n118_), .c(new_n111_), .O(new_n121_));
  inv1   g77(.a(x25), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  inv1   g79(.a(new_n123_), .O(new_n124_));
  aoi22  g80(.a(new_n124_), .b(new_n111_), .c(new_n121_), .d(x25), .O(new_n125_));
