// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:12 2020
...
module FAU ( 
  ...
  nand3  g29(.a(new_n51_), .b(new_n52_), .c(new_n73_), .O(new_n74_));
  oai21  g30(.a(new_n57_), .b(new_n56_), .c(new_n74_), .O(z09));
  ...
  nor2   g34(.a(x20), .b(new_n52_), .O(new_n79_));
  aoi21  g35(.a(new_n78_), .b(x20), .c(new_n79_), .O(new_n80_));
  nand2  g36(.a(new_n51_), .b(new_n73_), .O(new_n81_));
  oai22  g37(.a(new_n81_), .b(new_n80_), .c(new_n57_), .d(new_n59_), .O(z10));
  ...
  oai21  g45(.a(new_n89_), .b(new_n81_), .c(new_n61_), .O(z11));
  ...
  oai21  g54(.a(new_n98_), .b(new_n81_), .c(new_n63_), .O(z12));
  ...
  nor2   g60(.a(new_n104_), .b(x23), .O(new_n105_));
  aoi22  g61(.a(new_n105_), .b(new_n86_), .c(new_n103_), .d(x23), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n81_), .c(new_n65_), .O(z13));
  nand3  g63(.a(x26), .b(x25), .c(x16), .O(new_n108_));
  nand3  g64(.a(x21), .b(x20), .c(x19), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n108_), .c(x23), .d(x22), .O(new_n111_));
  nand2  g67(.a(x23), .b(x22), .O(new_n112_));
  nor3   g68(.a(new_n109_), .b(new_n112_), .c(x24), .O(new_n113_));
  aoi21  g69(.a(new_n111_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n81_), .c(new_n67_), .O(z14));
  nand2  g71(.a(x26), .b(x17), .O(new_n116_));
  nand3  g72(.a(x24), .b(x23), .c(x22), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n110_), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(x24), .c(x23), .d(x22), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  aoi22  g78(.a(new_n122_), .b(new_n110_), .c(new_n119_), .d(x25), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n81_), .c(new_n69_), .O(z15));
  nor2   g80(.a(new_n52_), .b(x18), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n49_), .c(new_n45_), .O(new_n126_));
  inv1   g82(.a(x26), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(x25), .c(x22), .d(x21), .O(new_n128_));
  nand4  g84(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n129_));
  nor2   g85(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  aoi21  g86(.a(new_n126_), .b(x26), .c(new_n130_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n81_), .c(new_n71_), .O(z16));
endmodule
