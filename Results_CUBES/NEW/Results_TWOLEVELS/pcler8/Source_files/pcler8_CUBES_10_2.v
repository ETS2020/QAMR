...
module FAU ( 
  ...
  nor2   g22(.a(new_n54_), .b(new_n66_), .O(z07));
  ...
  nand2  g29(.a(new_n48_), .b(new_n46_), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  oai21  g32(.a(new_n54_), .b(new_n53_), .c(new_n76_), .O(z09));
  nand3  g33(.a(x22), .b(x21), .c(x12), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n70_), .c(x19), .O(new_n79_));
  inv1   g35(.a(x19), .O(new_n80_));
  nor2   g36(.a(x20), .b(new_n80_), .O(new_n81_));
  aoi21  g37(.a(new_n79_), .b(x20), .c(new_n81_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n74_), .c(new_n54_), .d(new_n56_), .O(z10));
  ...
  oai22  g46(.a(new_n90_), .b(new_n74_), .c(new_n54_), .d(new_n58_), .O(z11));
  ...
  oai21  g53(.a(new_n97_), .b(new_n74_), .c(new_n60_), .O(z12));
  inv1   g54(.a(x23), .O(new_n99_));
  and2   g55(.a(x26), .b(x25), .O(new_n100_));
  ...
  nand2  g60(.a(new_n71_), .b(new_n99_), .O(new_n105_));
  ...
  nand2  g66(.a(new_n100_), .b(x16), .O(new_n111_));
  ...
  nor3   g70(.a(new_n112_), .b(new_n109_), .c(x24), .O(new_n115_));
  aoi21  g71(.a(new_n114_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n74_), .c(new_n64_), .O(z14));
  nand2  g73(.a(x26), .b(x17), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n113_), .c(new_n110_), .d(x24), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(x24), .c(x23), .d(x22), .O(new_n121_));
  nor2   g77(.a(new_n121_), .b(new_n112_), .O(new_n122_));
  aoi21  g78(.a(new_n119_), .b(x25), .c(new_n122_), .O(new_n123_));
  oai22  g79(.a(new_n123_), .b(new_n74_), .c(new_n54_), .d(new_n66_), .O(z15));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(x25), .b(x24), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n45_), .c(x26), .O(new_n127_));
  nor2   g83(.a(x26), .b(new_n120_), .O(new_n128_));
  nand4  g84(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n129_));
  inv1   g85(.a(new_n129_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n128_), .c(new_n71_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n127_), .c(x10), .O(new_n132_));
  nand3  g88(.a(x26), .b(new_n80_), .c(new_n125_), .O(new_n133_));
  inv1   g89(.a(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n68_), .O(z16));
endmodule
