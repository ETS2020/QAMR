// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:03 2020
...
module FAU ( 
  ...
  nand4  g49(.a(new_n93_), .b(new_n53_), .c(x23), .d(x19), .O(new_n94_));
  ...
  aoi21  g59(.a(new_n53_), .b(x22), .c(new_n103_), .O(new_n104_));
