// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:40 2020
...
module FAU ( 
  ...
  nand2  g40(.a(x26), .b(x25), .O(new_n85_));
  nand4  g41(.a(x24), .b(x23), .c(x22), .d(x13), .O(new_n86_));
  ...
  aoi22  g51(.a(new_n95_), .b(new_n88_), .c(new_n93_), .d(x22), .O(new_n96_));
  ...
  nor2   g58(.a(new_n102_), .b(x23), .O(new_n103_));
  aoi22  g59(.a(new_n103_), .b(new_n88_), .c(new_n101_), .d(x23), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n78_), .c(new_n65_), .O(z13));
  inv1   g61(.a(new_n93_), .O(new_n106_));
  ...
  nor3   g65(.a(new_n93_), .b(new_n109_), .c(x24), .O(new_n110_));
  aoi21  g66(.a(new_n108_), .b(x24), .c(new_n110_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n78_), .c(new_n67_), .O(z14));
  ...
  oai21  g76(.a(new_n120_), .b(new_n78_), .c(new_n69_), .O(z15));
  nor2   g77(.a(new_n52_), .b(x18), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n49_), .c(new_n45_), .O(new_n123_));
  inv1   g79(.a(x26), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(x25), .c(x22), .d(x21), .O(new_n125_));
  nand4  g81(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n126_));
  nor2   g82(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  aoi21  g83(.a(new_n123_), .b(x26), .c(new_n127_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
