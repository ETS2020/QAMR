...
module FAU ( 
  ...
  oai22  g57(.a(new_n101_), .b(new_n77_), .c(new_n59_), .d(new_n63_), .O(z12));
  ...
  oai21  g66(.a(new_n59_), .b(new_n65_), .c(new_n110_), .O(z13));
  ...
  oai22  g74(.a(new_n118_), .b(new_n77_), .c(new_n59_), .d(new_n67_), .O(z14));
  inv1   g75(.a(x25), .O(new_n120_));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(x24), .c(x19), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(x20), .O(new_n123_));
  nand2  g79(.a(new_n48_), .b(new_n59_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n123_), .c(new_n120_), .O(new_n125_));
  nand2  g81(.a(new_n120_), .b(x24), .O(new_n126_));
  nor3   g82(.a(new_n126_), .b(new_n114_), .c(new_n113_), .O(new_n127_));
  nor2   g83(.a(x10), .b(new_n50_), .O(new_n128_));
  oai21  g84(.a(new_n127_), .b(new_n125_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g93(.a(new_n137_), .b(new_n77_), .c(new_n71_), .O(z16));
endmodule
