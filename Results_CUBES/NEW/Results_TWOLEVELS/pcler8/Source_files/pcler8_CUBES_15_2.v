...
module FAU ( 
  ...
  nor3   g63(.a(new_n86_), .b(new_n107_), .c(x23), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n106_), .c(new_n101_), .O(new_n109_));
  ...
  nor3   g71(.a(new_n113_), .b(new_n112_), .c(x24), .O(new_n116_));
  ...
  nor2   g75(.a(new_n107_), .b(x17), .O(new_n120_));
  nand4  g76(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n120_), .c(new_n119_), .O(new_n123_));
  nand2  g79(.a(new_n119_), .b(x24), .O(new_n124_));
  nor3   g80(.a(new_n124_), .b(new_n113_), .c(new_n112_), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n123_), .c(new_n101_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n68_), .O(z15));
  ...
  nor2   g86(.a(x26), .b(new_n119_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n122_), .c(x22), .d(x21), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n101_), .O(new_n134_));
