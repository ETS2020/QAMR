...
module FAU ( 
  ...
  nand3  g36(.a(x23), .b(x21), .c(x12), .O(new_n81_));
  ...
  and2   g49(.a(x21), .b(x19), .O(new_n94_));
  oai21  g50(.a(new_n93_), .b(new_n80_), .c(new_n94_), .O(new_n95_));
  inv1   g51(.a(x22), .O(new_n96_));
  nor2   g52(.a(new_n96_), .b(x20), .O(new_n97_));
  aoi21  g53(.a(new_n95_), .b(x20), .c(new_n97_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n76_), .c(new_n63_), .O(z12));
  ...
  nand3  g60(.a(new_n87_), .b(new_n100_), .c(x21), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n104_), .c(new_n77_), .O(new_n107_));
  ...
  nand3  g69(.a(new_n109_), .b(x23), .c(x21), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n113_), .c(new_n77_), .O(new_n116_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n76_), .c(new_n69_), .O(z15));
  ...
  nand2  g86(.a(new_n130_), .b(new_n77_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n71_), .O(z16));
endmodule
