...
module FAU ( 
  ...
  oai21  g63(.a(new_n106_), .b(new_n102_), .c(new_n107_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n104_), .c(new_n77_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n65_), .O(z13));
  inv1   g66(.a(x24), .O(new_n111_));
  nand3  g67(.a(x26), .b(x25), .c(x16), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n106_), .c(new_n111_), .O(new_n113_));
  nand3  g69(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  nand3  g70(.a(new_n111_), .b(x23), .c(x22), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n113_), .c(new_n77_), .O(new_n117_));
  ...
  nor3   g77(.a(new_n114_), .b(new_n45_), .c(x25), .O(new_n122_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n105_), .c(x26), .O(new_n127_));
