// Benchmark "FAU" written by ABC on Mon Jul  6 14:31:08 2020
...
module FAU ( 
  ...
  nand3  g19(.a(new_n23_), .b(new_n20_), .c(x5), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n36_), .c(x6), .O(z5));
  nand3  g21(.a(x9), .b(x8), .c(x5), .O(new_n39_));
  oai21  g22(.a(x9), .b(x8), .c(new_n39_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n20_), .O(new_n41_));
  nand2  g24(.a(x9), .b(new_n22_), .O(new_n42_));
