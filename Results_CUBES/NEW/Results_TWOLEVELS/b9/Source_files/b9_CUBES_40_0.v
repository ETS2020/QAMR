...
module FAU ( 
  ...
  aoi22  g001(.a(x40), .b(x36), .c(x35), .d(new_n63_), .O(new_n64_));
  ...
  nand3  g008(.a(z08), .b(x10), .c(new_n65_), .O(new_n71_));
  ...
  oai21  g026(.a(new_n88_), .b(new_n77_), .c(x27), .O(new_n89_));
  ...
  nand2  g049(.a(new_n69_), .b(x07), .O(new_n112_));
  oai21  g050(.a(new_n69_), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nor3   g051(.a(new_n80_), .b(new_n69_), .c(new_n111_), .O(new_n114_));
  aoi21  g052(.a(new_n113_), .b(new_n79_), .c(new_n114_), .O(new_n115_));
  nand3  g053(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g054(.a(new_n115_), .b(x04), .c(new_n116_), .O(z10));
  nand2  g055(.a(z08), .b(x29), .O(new_n118_));
  nor2   g056(.a(new_n75_), .b(new_n65_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(new_n78_), .c(new_n118_), .O(new_n120_));
  nand2  g058(.a(x40), .b(x04), .O(new_n121_));
  nand4  g059(.a(new_n121_), .b(x35), .c(new_n77_), .d(x27), .O(new_n122_));
  ...
  oai21  g066(.a(new_n128_), .b(new_n75_), .c(new_n63_), .O(new_n129_));
  nand2  g067(.a(z08), .b(new_n65_), .O(new_n130_));
  nand2  g068(.a(new_n121_), .b(z08), .O(new_n131_));
  aoi22  g069(.a(new_n131_), .b(new_n75_), .c(new_n130_), .d(new_n67_), .O(new_n132_));
  ...
  nand4  g075(.a(new_n137_), .b(new_n135_), .c(x39), .d(new_n65_), .O(new_n138_));
  nor2   g076(.a(x19), .b(x18), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x20), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n67_), .c(new_n138_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x27), .O(new_n142_));
  nor2   g080(.a(x13), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n81_), .c(z08), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(z13));
  inv1   g083(.a(x32), .O(new_n146_));
  nand4  g084(.a(new_n134_), .b(new_n146_), .c(new_n125_), .d(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n143_), .c(x40), .d(x39), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n140_), .O(new_n149_));
  oai21  g087(.a(new_n67_), .b(new_n75_), .c(new_n69_), .O(new_n150_));
  nand3  g088(.a(new_n90_), .b(new_n88_), .c(x28), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x27), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n80_), .O(new_n153_));
  nor2   g091(.a(new_n136_), .b(x27), .O(new_n154_));
  oai22  g092(.a(new_n154_), .b(new_n67_), .c(x13), .d(x04), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n153_), .c(new_n150_), .d(new_n149_), .O(z14));
  ...
  nor2   g103(.a(new_n75_), .b(x04), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n126_), .O(new_n167_));
  oai21  g105(.a(new_n165_), .b(new_n85_), .c(new_n167_), .O(z18));
  oai21  g106(.a(new_n88_), .b(new_n75_), .c(new_n85_), .O(new_n169_));
  oai21  g107(.a(new_n77_), .b(x27), .c(x35), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n118_), .O(new_n171_));
