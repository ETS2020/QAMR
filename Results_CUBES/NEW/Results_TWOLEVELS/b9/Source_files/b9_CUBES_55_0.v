...
module FAU ( 
  ...
  nand3  g083(.a(new_n87_), .b(new_n145_), .c(x28), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n77_), .O(new_n148_));
  nand2  g086(.a(new_n137_), .b(x27), .O(new_n149_));
  nor2   g087(.a(new_n138_), .b(x40), .O(new_n150_));
  aoi21  g088(.a(new_n149_), .b(new_n106_), .c(new_n150_), .O(new_n151_));
  nand2  g089(.a(new_n138_), .b(x20), .O(new_n152_));
  ...
  aoi21  g094(.a(new_n138_), .b(x27), .c(new_n134_), .O(new_n157_));
  nand2  g095(.a(new_n137_), .b(x20), .O(new_n158_));
  oai22  g096(.a(new_n158_), .b(new_n157_), .c(x13), .d(x04), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n156_), .c(new_n151_), .d(new_n148_), .O(z14));
  ...
  nor2   g105(.a(new_n145_), .b(x28), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n72_), .c(z08), .d(x29), .O(new_n169_));
  nor2   g107(.a(new_n72_), .b(x04), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n125_), .O(new_n171_));
  oai21  g109(.a(new_n169_), .b(new_n82_), .c(new_n171_), .O(z18));
  oai21  g110(.a(new_n145_), .b(new_n72_), .c(new_n82_), .O(new_n173_));
  oai21  g111(.a(new_n74_), .b(x27), .c(x35), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n117_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n125_), .O(z20));
  aoi21  g114(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
