// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:51 2020
...
module FAU ( 
  ...
  nand3  g019(.a(x40), .b(x39), .c(x02), .O(new_n82_));
  inv1   g020(.a(new_n82_), .O(new_n83_));
  oai21  g021(.a(new_n81_), .b(new_n64_), .c(new_n83_), .O(z02));
  ...
  aoi22  g059(.a(new_n63_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n122_));
  oai22  g060(.a(new_n106_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(x10), .c(new_n123_), .O(z12));
  inv1   g062(.a(x13), .O(new_n125_));
  inv1   g063(.a(x39), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(x04), .O(new_n127_));
  nand2  g065(.a(x36), .b(x35), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x28), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(new_n127_), .c(x40), .d(new_n125_), .O(new_n130_));
  inv1   g068(.a(new_n66_), .O(new_n131_));
  inv1   g069(.a(x18), .O(new_n132_));
  inv1   g070(.a(x19), .O(new_n133_));
  nand3  g071(.a(x20), .b(new_n133_), .c(new_n132_), .O(new_n134_));
  ...
  nand4  g081(.a(new_n128_), .b(new_n143_), .c(new_n142_), .d(x28), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(new_n145_));
  nand2  g083(.a(new_n139_), .b(z08), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n134_), .O(new_n147_));
  nand3  g085(.a(new_n127_), .b(x40), .c(new_n125_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n72_), .O(new_n149_));
  nand3  g087(.a(new_n87_), .b(new_n85_), .c(x28), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n77_), .O(new_n152_));
  nand2  g090(.a(new_n146_), .b(new_n66_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(z14));
