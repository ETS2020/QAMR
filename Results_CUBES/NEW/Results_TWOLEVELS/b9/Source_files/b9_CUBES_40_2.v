...
module FAU ( 
  ...
  nor3   g050(.a(new_n106_), .b(new_n77_), .c(new_n110_), .O(new_n113_));
  ...
  aoi21  g065(.a(new_n120_), .b(x39), .c(x27), .O(new_n128_));
  nand2  g066(.a(z08), .b(new_n64_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n66_), .c(new_n128_), .O(new_n130_));
  ...
  inv1   g074(.a(new_n66_), .O(new_n137_));
  ...
  nand3  g083(.a(new_n145_), .b(z08), .c(new_n78_), .O(new_n146_));
  ...
  oai21  g089(.a(new_n66_), .b(new_n72_), .c(new_n106_), .O(new_n152_));
  ...
  nor2   g093(.a(new_n134_), .b(x27), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(new_n66_), .c(x13), .d(x04), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n155_), .c(new_n152_), .d(new_n151_), .O(z14));
  ...
  aoi22  g104(.a(z08), .b(x29), .c(new_n166_), .d(new_n72_), .O(new_n167_));
  ...
  nand2  g110(.a(new_n172_), .b(new_n117_), .O(new_n173_));
