...
module FAU ( 
  ...
  nand3  g074(.a(new_n127_), .b(x20), .c(new_n136_), .O(new_n137_));
  ...
  nand2  g080(.a(x20), .b(new_n136_), .O(new_n143_));
  inv1   g081(.a(x30), .O(new_n144_));
  inv1   g082(.a(x32), .O(new_n145_));
  nand4  g083(.a(new_n131_), .b(new_n145_), .c(new_n144_), .d(x28), .O(new_n146_));
  ...
  nand3  g087(.a(new_n88_), .b(new_n86_), .c(x28), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x27), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n77_), .O(new_n152_));
  nand2  g090(.a(new_n148_), .b(new_n128_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n165_));
  oai21  g103(.a(new_n74_), .b(x27), .c(x35), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n117_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n124_), .O(z20));
