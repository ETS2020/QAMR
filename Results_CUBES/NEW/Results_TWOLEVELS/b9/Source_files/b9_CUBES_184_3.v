...
module FAU ( 
  ...
  nor2   g070(.a(new_n132_), .b(x27), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(new_n130_), .O(new_n134_));
  aoi22  g072(.a(z08), .b(new_n64_), .c(x35), .d(x28), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n87_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n134_), .c(new_n129_), .O(z12));
  nand2  g075(.a(x36), .b(x35), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x28), .c(new_n65_), .O(new_n139_));
  nor2   g077(.a(x19), .b(x18), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x20), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(new_n66_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n139_), .c(x27), .O(new_n143_));
  nand3  g081(.a(new_n78_), .b(z08), .c(new_n64_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(z13));
  inv1   g083(.a(x32), .O(new_n146_));
  nand4  g084(.a(new_n138_), .b(new_n146_), .c(new_n125_), .d(x28), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n128_), .c(new_n141_), .O(new_n149_));
  nand4  g087(.a(new_n85_), .b(new_n146_), .c(new_n125_), .d(x28), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n135_), .c(new_n87_), .O(new_n152_));
  nand2  g090(.a(x40), .b(new_n64_), .O(new_n153_));
  nand2  g091(.a(new_n78_), .b(x39), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n72_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n149_), .O(z14));
  ...
  oai21  g105(.a(new_n165_), .b(new_n120_), .c(new_n167_), .O(z18));
  oai21  g106(.a(new_n85_), .b(new_n72_), .c(new_n120_), .O(new_n169_));
  ...
  aoi21  g110(.a(new_n123_), .b(new_n119_), .c(new_n126_), .O(z19));
endmodule
