...
module FAU ( 
  ...
  oai21  g003(.a(x13), .b(new_n34_), .c(new_n36_), .O(new_n37_));
  ...
  oai21  g081(.a(new_n113_), .b(x13), .c(new_n114_), .O(new_n115_));
  ...
  aoi22  g103(.a(new_n136_), .b(new_n39_), .c(new_n133_), .d(new_n98_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n129_), .O(z3));
  aoi21  g105(.a(new_n73_), .b(x04), .c(x17), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x22), .c(new_n103_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n70_), .c(x08), .O(new_n141_));
  inv1   g108(.a(x05), .O(new_n142_));
  nand2  g109(.a(x24), .b(x07), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n36_), .c(new_n142_), .O(new_n144_));
  nor2   g111(.a(new_n144_), .b(new_n44_), .O(new_n145_));
  ...
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n106_), .O(new_n149_));
  nand2  g116(.a(x24), .b(x18), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n114_), .c(new_n142_), .O(new_n151_));
  nor2   g118(.a(new_n151_), .b(new_n119_), .O(new_n152_));
  oai22  g119(.a(new_n152_), .b(new_n149_), .c(new_n145_), .d(new_n141_), .O(z4));
  inv1   g120(.a(new_n145_), .O(z5));
  oai21  g121(.a(new_n77_), .b(x14), .c(new_n46_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n47_), .c(x03), .O(new_n156_));
  inv1   g123(.a(x03), .O(new_n157_));
  oai21  g124(.a(x20), .b(new_n76_), .c(x06), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x11), .c(new_n157_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n152_), .c(new_n156_), .d(new_n145_), .O(z6));
  inv1   g127(.a(new_n152_), .O(z7));
endmodule
