...
module FAU ( 
  ...
  nand4  g033(.a(new_n66_), .b(new_n43_), .c(new_n42_), .d(x00), .O(new_n67_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n76_), .d(new_n70_), .O(new_n92_));
  inv1   g059(.a(x20), .O(new_n93_));
  nor3   g060(.a(x04), .b(x03), .c(x01), .O(new_n94_));
  nor2   g061(.a(x23), .b(x22), .O(new_n95_));
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n73_), .O(new_n96_));
  oai21  g063(.a(new_n96_), .b(new_n92_), .c(new_n89_), .O(new_n97_));
  ...
  nor2   g070(.a(x17), .b(x12), .O(new_n104_));
  nor2   g071(.a(x08), .b(x06), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n91_), .O(new_n106_));
  nand4  g073(.a(new_n94_), .b(new_n74_), .c(new_n93_), .d(x19), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n106_), .c(new_n102_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n39_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n99_), .c(new_n81_), .O(z1));
  ...
  nand3  g102(.a(new_n50_), .b(new_n48_), .c(new_n135_), .O(new_n136_));
  nand2  g103(.a(new_n90_), .b(new_n49_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n134_), .d(new_n84_), .O(new_n138_));
  nand3  g105(.a(new_n124_), .b(x20), .c(x15), .O(new_n139_));
  nand4  g106(.a(new_n93_), .b(x19), .c(new_n120_), .d(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n129_), .c(new_n139_), .d(new_n84_), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n39_), .c(new_n138_), .d(new_n98_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n133_), .O(z3));
  aoi21  g110(.a(new_n74_), .b(x04), .c(x17), .O(new_n144_));
  nand2  g111(.a(new_n44_), .b(new_n41_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n66_), .O(new_n146_));
  inv1   g113(.a(new_n40_), .O(new_n147_));
  nand3  g114(.a(x24), .b(new_n66_), .c(x07), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(new_n36_), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x05), .c(new_n147_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n146_), .c(new_n144_), .O(new_n151_));
  inv1   g118(.a(x09), .O(new_n152_));
  aoi21  g119(.a(new_n46_), .b(new_n38_), .c(new_n152_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n151_), .c(new_n72_), .O(new_n154_));
  aoi21  g121(.a(x23), .b(new_n69_), .c(new_n73_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n66_), .c(x09), .O(new_n156_));
  aoi21  g123(.a(new_n156_), .b(x16), .c(new_n135_), .O(new_n157_));
  nand2  g124(.a(x08), .b(x07), .O(new_n158_));
  oai21  g125(.a(new_n157_), .b(new_n111_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n98_), .O(new_n160_));
  inv1   g127(.a(new_n39_), .O(new_n161_));
  oai21  g128(.a(new_n55_), .b(x24), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(x19), .b(x08), .O(new_n163_));
  oai21  g130(.a(new_n157_), .b(new_n53_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g132(.a(x08), .b(x00), .O(new_n166_));
  oai21  g133(.a(new_n157_), .b(new_n54_), .c(new_n166_), .O(new_n167_));
  nor2   g134(.a(new_n56_), .b(x24), .O(new_n168_));
  nand2  g135(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand4  g136(.a(new_n169_), .b(new_n165_), .c(new_n160_), .d(new_n154_), .O(z4));
  nand2  g137(.a(new_n46_), .b(new_n38_), .O(z5));
  nand2  g138(.a(x20), .b(new_n120_), .O(new_n172_));
  ...
  nand2  g142(.a(new_n119_), .b(new_n114_), .O(z7));
  nand2  g143(.a(new_n93_), .b(x14), .O(new_n177_));
  aoi21  g144(.a(new_n177_), .b(x06), .c(new_n48_), .O(new_n178_));
