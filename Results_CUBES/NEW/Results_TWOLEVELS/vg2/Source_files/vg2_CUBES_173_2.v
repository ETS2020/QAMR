...
module FAU ( 
  ...
  nand3  g099(.a(new_n50_), .b(new_n48_), .c(new_n107_), .O(new_n133_));
  ...
  oai22  g104(.a(new_n137_), .b(new_n108_), .c(new_n136_), .d(new_n86_), .O(new_n138_));
  ...
  oai21  g109(.a(x23), .b(new_n142_), .c(new_n72_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n73_), .c(x09), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x16), .c(new_n107_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(z5), .O(new_n146_));
  inv1   g113(.a(x13), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n114_), .O(new_n148_));
  nand3  g115(.a(new_n35_), .b(x13), .c(x05), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(x15), .O(new_n151_));
  nand3  g118(.a(x24), .b(x18), .c(x08), .O(new_n152_));
  nand3  g119(.a(new_n152_), .b(new_n151_), .c(new_n118_), .O(new_n153_));
  aoi21  g120(.a(x23), .b(new_n142_), .c(new_n72_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n73_), .c(x09), .O(new_n155_));
  nand3  g122(.a(new_n155_), .b(new_n153_), .c(x16), .O(new_n156_));
  oai21  g123(.a(new_n121_), .b(new_n117_), .c(new_n107_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n156_), .c(new_n146_), .O(z4));
  inv1   g125(.a(x03), .O(new_n159_));
  oai21  g126(.a(new_n121_), .b(new_n117_), .c(new_n159_), .O(new_n160_));
  aoi21  g127(.a(x20), .b(new_n77_), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x11), .c(new_n159_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(z5), .O(new_n163_));
  inv1   g130(.a(new_n151_), .O(new_n164_));
  oai21  g131(.a(new_n115_), .b(new_n159_), .c(new_n118_), .O(new_n165_));
  nand2  g132(.a(new_n78_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n48_), .O(new_n167_));
  oai21  g134(.a(new_n165_), .b(new_n164_), .c(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n163_), .c(new_n160_), .O(z6));
  inv1   g136(.a(new_n122_), .O(z7));
endmodule
