...
module FAU ( 
  ...
  nor2   g077(.a(new_n45_), .b(x13), .O(new_n111_));
  nor3   g078(.a(x24), .b(new_n55_), .c(new_n36_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n111_), .c(x05), .O(new_n113_));
  nand2  g080(.a(new_n45_), .b(x21), .O(new_n114_));
  inv1   g081(.a(x18), .O(new_n115_));
  nor2   g082(.a(new_n45_), .b(new_n115_), .O(new_n116_));
  aoi22  g083(.a(new_n116_), .b(x13), .c(new_n40_), .d(x15), .O(new_n117_));
  oai21  g084(.a(new_n114_), .b(new_n58_), .c(new_n117_), .O(new_n118_));
  inv1   g085(.a(new_n118_), .O(new_n119_));
  inv1   g086(.a(x14), .O(new_n120_));
  nor2   g087(.a(new_n103_), .b(new_n120_), .O(new_n121_));
  ...
  nand4  g091(.a(new_n124_), .b(new_n88_), .c(new_n59_), .d(x20), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n104_), .c(new_n68_), .d(new_n51_), .O(new_n127_));
  ...
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n130_), .d(new_n87_), .O(new_n134_));
  nand3  g101(.a(new_n124_), .b(x20), .c(x15), .O(new_n135_));
  nand3  g102(.a(new_n51_), .b(new_n120_), .c(new_n50_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n105_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  aoi22  g104(.a(new_n137_), .b(new_n40_), .c(new_n134_), .d(new_n96_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n129_), .O(z3));
  inv1   g106(.a(new_n40_), .O(new_n140_));
  oai21  g107(.a(new_n76_), .b(x04), .c(x17), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x22), .c(new_n101_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n73_), .c(x08), .O(new_n143_));
  and2   g110(.a(x07), .b(x05), .O(new_n144_));
  aoi21  g111(.a(new_n143_), .b(new_n140_), .c(new_n144_), .O(new_n145_));
  nand3  g112(.a(x13), .b(x08), .c(x07), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n115_), .c(new_n146_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x24), .O(new_n148_));
  nand2  g115(.a(new_n141_), .b(x22), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x16), .c(new_n131_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n56_), .c(new_n131_), .d(new_n67_), .O(new_n152_));
  nor2   g119(.a(new_n58_), .b(x24), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  oai21  g121(.a(new_n57_), .b(x24), .c(new_n140_), .O(new_n155_));
  oai21  g122(.a(new_n34_), .b(x18), .c(new_n46_), .O(new_n156_));
  aoi21  g123(.a(new_n155_), .b(x19), .c(new_n156_), .O(new_n157_));
  aoi21  g124(.a(new_n76_), .b(x04), .c(x17), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x22), .c(new_n101_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n73_), .O(new_n160_));
  nor2   g127(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  oai22  g128(.a(new_n151_), .b(new_n55_), .c(new_n37_), .d(new_n131_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n155_), .c(new_n161_), .O(new_n163_));
  nand3  g130(.a(new_n163_), .b(new_n154_), .c(new_n148_), .O(z4));
  inv1   g131(.a(x05), .O(new_n165_));
  aoi21  g132(.a(new_n116_), .b(x07), .c(new_n38_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n165_), .c(new_n48_), .O(z5));
  inv1   g134(.a(x03), .O(new_n168_));
  oai21  g135(.a(x20), .b(new_n120_), .c(x06), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x11), .c(new_n168_), .O(new_n170_));
  nor2   g137(.a(new_n170_), .b(new_n40_), .O(new_n171_));
  oai21  g138(.a(new_n171_), .b(new_n144_), .c(x18), .O(new_n172_));
  nand3  g139(.a(x13), .b(x07), .c(x03), .O(new_n173_));
  nand2  g140(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(x24), .O(new_n175_));
  oai22  g142(.a(new_n170_), .b(new_n56_), .c(new_n168_), .d(new_n67_), .O(new_n176_));
  nand2  g143(.a(new_n176_), .b(new_n153_), .O(new_n177_));
  aoi21  g144(.a(x20), .b(new_n120_), .c(x06), .O(new_n178_));
  nor3   g145(.a(new_n178_), .b(new_n157_), .c(x11), .O(new_n179_));
  oai22  g146(.a(new_n170_), .b(new_n55_), .c(new_n37_), .d(new_n168_), .O(new_n180_));
  aoi21  g147(.a(new_n180_), .b(new_n155_), .c(new_n179_), .O(new_n181_));
  nand3  g148(.a(new_n181_), .b(new_n177_), .c(new_n175_), .O(z6));
  oai21  g149(.a(new_n116_), .b(new_n112_), .c(x05), .O(new_n183_));
  nand2  g150(.a(new_n183_), .b(new_n119_), .O(z7));
endmodule
