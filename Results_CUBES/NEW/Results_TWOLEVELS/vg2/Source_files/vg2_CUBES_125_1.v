// Benchmark "FAU" written by ABC on Mon Jul  6 14:57:34 2020
...
module FAU ( 
  ...
  nand4  g080(.a(new_n35_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n114_));
  ...
  aoi22  g103(.a(new_n136_), .b(new_n39_), .c(new_n133_), .d(new_n95_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n128_), .O(z3));
  oai21  g105(.a(new_n111_), .b(new_n130_), .c(new_n114_), .O(new_n139_));
  oai21  g106(.a(new_n75_), .b(x04), .c(x17), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n139_), .c(x22), .O(new_n141_));
  oai21  g108(.a(new_n118_), .b(x09), .c(new_n141_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(x16), .O(new_n143_));
  inv1   g110(.a(new_n39_), .O(new_n144_));
  oai21  g111(.a(new_n55_), .b(x24), .c(new_n144_), .O(new_n145_));
  aoi21  g112(.a(new_n75_), .b(x04), .c(x17), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(x22), .c(new_n100_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n72_), .c(x08), .O(new_n148_));
  nand2  g115(.a(x15), .b(new_n130_), .O(new_n149_));
  oai21  g116(.a(new_n148_), .b(new_n66_), .c(new_n149_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n145_), .O(new_n151_));
  nand2  g118(.a(x18), .b(new_n130_), .O(new_n152_));
  oai21  g119(.a(new_n148_), .b(new_n34_), .c(new_n152_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n95_), .O(new_n154_));
  nand2  g121(.a(x21), .b(new_n130_), .O(new_n155_));
  oai21  g122(.a(new_n148_), .b(new_n65_), .c(new_n155_), .O(new_n156_));
  nor2   g123(.a(new_n56_), .b(x24), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand4  g125(.a(new_n158_), .b(new_n154_), .c(new_n151_), .d(new_n143_), .O(z4));
  nand2  g126(.a(x20), .b(new_n119_), .O(new_n160_));
  ...
  inv1   g130(.a(new_n118_), .O(z7));
  nand2  g131(.a(new_n102_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n47_), .O(new_n166_));
