// Benchmark "FAU" written by ABC on Mon Jul  6 14:57:59 2020
...
module FAU ( 
  ...
  nand4  g055(.a(x23), .b(x20), .c(x14), .d(x12), .O(new_n89_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n92_), .d(new_n68_), .O(new_n96_));
  inv1   g063(.a(x04), .O(new_n97_));
  nor2   g064(.a(x17), .b(x16), .O(new_n98_));
  nand4  g065(.a(new_n98_), .b(new_n49_), .c(new_n71_), .d(new_n97_), .O(new_n99_));
  ...
  nand3  g069(.a(x17), .b(x16), .c(x15), .O(new_n103_));
  inv1   g070(.a(new_n103_), .O(new_n104_));
  nand4  g071(.a(new_n104_), .b(new_n90_), .c(new_n87_), .d(new_n85_), .O(new_n105_));
  inv1   g072(.a(x09), .O(new_n106_));
  nand4  g073(.a(new_n73_), .b(new_n72_), .c(new_n75_), .d(new_n106_), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  inv1   g075(.a(x08), .O(new_n109_));
  nand4  g076(.a(new_n71_), .b(x19), .c(new_n109_), .d(new_n47_), .O(new_n110_));
  inv1   g077(.a(new_n110_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nor2   g079(.a(x16), .b(x14), .O(new_n113_));
  nand4  g080(.a(new_n113_), .b(new_n49_), .c(new_n78_), .d(new_n97_), .O(new_n114_));
  oai21  g081(.a(new_n114_), .b(new_n112_), .c(new_n105_), .O(new_n115_));
  nand2  g082(.a(new_n115_), .b(new_n39_), .O(new_n116_));
  nand3  g083(.a(new_n116_), .b(new_n102_), .c(new_n83_), .O(z1));
  ...
  nand3  g087(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n121_));
  nand3  g088(.a(x24), .b(x18), .c(x13), .O(new_n122_));
  nand2  g089(.a(new_n39_), .b(x15), .O(new_n123_));
  ...
  nor3   g093(.a(new_n126_), .b(new_n125_), .c(new_n57_), .O(z2));
  nor2   g094(.a(new_n76_), .b(new_n48_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n129_));
  nor2   g096(.a(x08), .b(x06), .O(new_n130_));
  nor3   g097(.a(x20), .b(x14), .c(x11), .O(new_n131_));
  nand4  g098(.a(new_n131_), .b(new_n130_), .c(new_n66_), .d(new_n49_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n50_), .b(new_n48_), .c(new_n109_), .O(new_n136_));
  ...
  nand3  g106(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n110_), .c(new_n139_), .d(new_n86_), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n39_), .c(new_n138_), .d(new_n101_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n134_), .O(z3));
  aoi21  g110(.a(new_n73_), .b(x04), .c(x17), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n106_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n77_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n97_), .c(new_n78_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n72_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n109_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n125_), .c(new_n146_), .d(new_n46_), .O(z4));
  inv1   g117(.a(new_n46_), .O(z5));
  oai21  g118(.a(new_n71_), .b(x14), .c(new_n47_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n48_), .c(x03), .O(new_n153_));
  inv1   g120(.a(x03), .O(new_n154_));
  oai21  g121(.a(x20), .b(new_n76_), .c(x06), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x11), .c(new_n154_), .O(new_n156_));
  oai22  g123(.a(new_n156_), .b(new_n125_), .c(new_n153_), .d(new_n46_), .O(z6));
  inv1   g124(.a(new_n125_), .O(z7));
endmodule
