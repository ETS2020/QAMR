...
module FAU ( 
  ...
  nand4  g037(.a(new_n70_), .b(new_n69_), .c(new_n46_), .d(new_n68_), .O(new_n71_));
  ...
  nand4  g047(.a(new_n80_), .b(new_n72_), .c(new_n67_), .d(new_n48_), .O(new_n81_));
  ...
  nand4  g059(.a(new_n92_), .b(x19), .c(new_n69_), .d(new_n46_), .O(new_n93_));
  inv1   g060(.a(new_n93_), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n48_), .c(new_n70_), .d(new_n68_), .O(new_n95_));
  inv1   g062(.a(x14), .O(new_n96_));
  nor3   g063(.a(x23), .b(x22), .c(x17), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n78_), .c(new_n73_), .d(new_n96_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n95_), .c(new_n91_), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(new_n38_), .O(new_n100_));
  nor4   g067(.a(new_n38_), .b(new_n34_), .c(x03), .d(x01), .O(new_n101_));
  nor3   g068(.a(new_n79_), .b(new_n77_), .c(new_n71_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n100_), .c(new_n83_), .O(z1));
  ...
  nand4  g075(.a(new_n43_), .b(x21), .c(new_n42_), .d(new_n41_), .O(new_n109_));
  ...
  nor2   g080(.a(new_n92_), .b(new_n96_), .O(new_n114_));
  nand4  g081(.a(new_n114_), .b(new_n58_), .c(x11), .d(x06), .O(new_n115_));
  aoi21  g082(.a(new_n113_), .b(new_n108_), .c(new_n115_), .O(z2));
  nor2   g083(.a(new_n96_), .b(new_n47_), .O(new_n117_));
  nand4  g084(.a(new_n117_), .b(new_n87_), .c(new_n57_), .d(x20), .O(new_n118_));
  nor3   g085(.a(x20), .b(x14), .c(x11), .O(new_n119_));
  nand3  g086(.a(new_n48_), .b(new_n69_), .c(new_n46_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n119_), .c(new_n67_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n118_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n43_), .O(new_n124_));
  nand3  g091(.a(new_n117_), .b(x20), .c(x18), .O(new_n125_));
  nand3  g092(.a(new_n49_), .b(new_n47_), .c(x07), .O(new_n126_));
  oai22  g093(.a(new_n126_), .b(new_n120_), .c(new_n125_), .d(new_n86_), .O(new_n127_));
  nor2   g094(.a(new_n38_), .b(new_n43_), .O(new_n128_));
  nand3  g095(.a(new_n117_), .b(x20), .c(x15), .O(new_n129_));
  nand3  g096(.a(new_n48_), .b(new_n96_), .c(new_n47_), .O(new_n130_));
  oai22  g097(.a(new_n130_), .b(new_n93_), .c(new_n129_), .d(new_n86_), .O(new_n131_));
  aoi22  g098(.a(new_n131_), .b(new_n38_), .c(new_n128_), .d(new_n127_), .O(new_n132_));
  nand2  g099(.a(new_n132_), .b(new_n124_), .O(z3));
  aoi21  g100(.a(x23), .b(new_n68_), .c(new_n74_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n75_), .c(x09), .O(new_n135_));
  nand2  g102(.a(new_n135_), .b(x16), .O(new_n136_));
  aoi21  g103(.a(new_n136_), .b(x08), .c(new_n54_), .O(new_n137_));
  aoi21  g104(.a(new_n76_), .b(x04), .c(x17), .O(new_n138_));
  oai21  g105(.a(new_n138_), .b(x22), .c(new_n70_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n73_), .O(new_n140_));
  aoi21  g107(.a(new_n140_), .b(new_n69_), .c(new_n65_), .O(new_n141_));
  nor2   g108(.a(new_n56_), .b(x24), .O(new_n142_));
  oai21  g109(.a(new_n141_), .b(new_n137_), .c(new_n142_), .O(new_n143_));
  inv1   g110(.a(new_n38_), .O(new_n144_));
  oai21  g111(.a(new_n55_), .b(x24), .c(new_n144_), .O(new_n145_));
  aoi21  g112(.a(new_n136_), .b(x08), .c(new_n53_), .O(new_n146_));
  aoi21  g113(.a(new_n140_), .b(new_n69_), .c(new_n66_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  inv1   g115(.a(x07), .O(new_n149_));
  aoi21  g116(.a(new_n139_), .b(new_n73_), .c(x08), .O(new_n150_));
  aoi21  g117(.a(x22), .b(new_n74_), .c(new_n70_), .O(new_n151_));
  ...
  nand3  g122(.a(new_n155_), .b(new_n148_), .c(new_n143_), .O(z4));
  nand2  g123(.a(x20), .b(new_n96_), .O(new_n157_));
  ...
  nand2  g127(.a(new_n113_), .b(new_n108_), .O(z7));
  nand2  g128(.a(new_n92_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n47_), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(new_n160_), .c(z7), .O(new_n164_));
