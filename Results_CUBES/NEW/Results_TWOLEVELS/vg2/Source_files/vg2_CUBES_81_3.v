...
module FAU ( 
  ...
  nand4  g061(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n49_), .O(new_n95_));
  nor3   g062(.a(x23), .b(x22), .c(x17), .O(new_n96_));
  nor2   g063(.a(x16), .b(x14), .O(new_n97_));
  nand4  g064(.a(new_n97_), .b(new_n96_), .c(new_n76_), .d(new_n48_), .O(new_n98_));
  oai21  g065(.a(new_n98_), .b(new_n95_), .c(new_n90_), .O(new_n99_));
  nand2  g066(.a(new_n99_), .b(new_n39_), .O(new_n100_));
  nor4   g067(.a(new_n39_), .b(new_n35_), .c(x03), .d(x01), .O(new_n101_));
  nand2  g068(.a(new_n68_), .b(new_n67_), .O(new_n102_));
  nor3   g069(.a(new_n79_), .b(new_n75_), .c(new_n102_), .O(new_n103_));
  nand2  g070(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n100_), .c(new_n83_), .O(z1));
  ...
  nand3  g075(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n109_));
  ...
  nor3   g081(.a(new_n114_), .b(new_n113_), .c(new_n57_), .O(z2));
  nand3  g082(.a(x20), .b(x14), .c(x11), .O(new_n116_));
  nor2   g083(.a(new_n116_), .b(new_n85_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n56_), .O(new_n118_));
  nor3   g085(.a(x20), .b(x14), .c(x11), .O(new_n119_));
  nand2  g086(.a(new_n92_), .b(new_n49_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand3  g088(.a(new_n121_), .b(new_n119_), .c(new_n66_), .O(new_n122_));
  ...
  oai22  g093(.a(new_n126_), .b(new_n120_), .c(new_n125_), .d(new_n85_), .O(new_n127_));
  nor2   g094(.a(new_n39_), .b(new_n36_), .O(new_n128_));
  nand3  g095(.a(new_n92_), .b(new_n78_), .c(x19), .O(new_n129_));
  nand4  g096(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n130_));
  nand3  g097(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n129_), .c(new_n130_), .d(new_n85_), .O(new_n132_));
  ...
  aoi21  g107(.a(x23), .b(new_n140_), .c(new_n72_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n73_), .c(x09), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(x16), .c(new_n139_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n113_), .c(new_n138_), .d(new_n46_), .O(z4));
  inv1   g111(.a(new_n46_), .O(z5));
  oai21  g112(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n48_), .c(x03), .O(new_n147_));
  inv1   g114(.a(x03), .O(new_n148_));
  oai21  g115(.a(x20), .b(new_n77_), .c(x06), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x11), .c(new_n148_), .O(new_n150_));
  oai22  g117(.a(new_n150_), .b(new_n113_), .c(new_n147_), .d(new_n46_), .O(z6));
  inv1   g118(.a(new_n113_), .O(z7));
endmodule
