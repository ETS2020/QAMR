...
module FAU ( 
  ...
  oai21  g012(.a(new_n44_), .b(x03), .c(new_n45_), .O(new_n46_));
  ...
  nor2   g084(.a(x10), .b(new_n34_), .O(new_n118_));
  nand4  g085(.a(new_n118_), .b(new_n117_), .c(new_n115_), .d(new_n113_), .O(new_n119_));
  inv1   g086(.a(new_n119_), .O(new_n120_));
  oai21  g087(.a(new_n120_), .b(new_n112_), .c(new_n40_), .O(new_n121_));
  nand3  g088(.a(x20), .b(x14), .c(x11), .O(new_n122_));
  nor3   g089(.a(new_n122_), .b(new_n88_), .c(new_n73_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  nand3  g091(.a(new_n124_), .b(new_n121_), .c(new_n111_), .O(z3));
  inv1   g092(.a(x09), .O(new_n126_));
  aoi21  g093(.a(new_n65_), .b(x04), .c(x17), .O(new_n127_));
  oai21  g094(.a(new_n127_), .b(x22), .c(new_n126_), .O(new_n128_));
  aoi21  g095(.a(new_n128_), .b(new_n68_), .c(x08), .O(new_n129_));
  aoi21  g096(.a(new_n45_), .b(new_n44_), .c(new_n35_), .O(new_n130_));
  nand3  g097(.a(new_n48_), .b(new_n41_), .c(new_n37_), .O(new_n131_));
  nor2   g098(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  inv1   g099(.a(x04), .O(new_n133_));
  aoi21  g100(.a(x23), .b(new_n133_), .c(new_n69_), .O(new_n134_));
  oai21  g101(.a(new_n134_), .b(new_n64_), .c(x09), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(x16), .c(new_n107_), .O(new_n136_));
  ...
  nand3  g106(.a(x15), .b(new_n36_), .c(new_n35_), .O(new_n140_));
  nand3  g107(.a(x24), .b(x18), .c(x13), .O(new_n141_));
  nand3  g108(.a(new_n141_), .b(new_n140_), .c(new_n102_), .O(new_n142_));
  nor2   g109(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n136_), .c(new_n132_), .d(new_n129_), .O(z4));
  inv1   g111(.a(new_n132_), .O(z5));
  inv1   g112(.a(x06), .O(new_n146_));
  nand2  g113(.a(x20), .b(new_n52_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n146_), .c(x11), .O(new_n148_));
  oai21  g115(.a(new_n131_), .b(new_n130_), .c(new_n148_), .O(new_n149_));
  aoi21  g116(.a(new_n53_), .b(x14), .c(new_n146_), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n51_), .c(x03), .O(new_n151_));
  nand3  g118(.a(new_n140_), .b(new_n102_), .c(new_n86_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g120(.a(new_n40_), .b(x15), .c(x05), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n137_), .c(new_n36_), .O(new_n155_));
  nand2  g122(.a(x19), .b(new_n35_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n96_), .c(new_n41_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x03), .c(new_n155_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n153_), .c(new_n149_), .O(z6));
  inv1   g126(.a(new_n143_), .O(z7));
endmodule
