...
module FAU ( 
  ...
  oai21  g034(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(new_n68_));
  ...
  nand3  g053(.a(new_n58_), .b(x08), .c(x06), .O(new_n87_));
  ...
  nand4  g059(.a(new_n81_), .b(new_n70_), .c(x07), .d(new_n47_), .O(new_n93_));
  nand3  g060(.a(new_n78_), .b(new_n49_), .c(new_n69_), .O(new_n94_));
  oai21  g061(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nor2   g062(.a(new_n38_), .b(new_n44_), .O(new_n96_));
  ...
  nand4  g073(.a(new_n106_), .b(new_n102_), .c(new_n48_), .d(new_n101_), .O(new_n107_));
  ...
  nor2   g078(.a(new_n44_), .b(new_n111_), .O(new_n112_));
  ...
  nand3  g082(.a(new_n55_), .b(new_n44_), .c(x21), .O(new_n116_));
  ...
  nor2   g088(.a(new_n103_), .b(new_n121_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n58_), .c(x11), .d(x06), .O(new_n123_));
  aoi21  g090(.a(new_n120_), .b(new_n115_), .c(new_n123_), .O(z2));
  nor2   g091(.a(new_n121_), .b(new_n48_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n88_), .c(new_n57_), .d(x20), .O(new_n126_));
  nor3   g093(.a(x20), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n104_), .c(new_n68_), .d(new_n49_), .O(new_n128_));
  ...
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n131_), .d(new_n87_), .O(new_n135_));
  nand3  g102(.a(new_n125_), .b(x20), .c(x15), .O(new_n136_));
  nand3  g103(.a(new_n49_), .b(new_n121_), .c(new_n48_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n105_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  aoi22  g105(.a(new_n138_), .b(new_n38_), .c(new_n135_), .d(new_n96_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n130_), .O(z3));
  aoi21  g107(.a(x23), .b(new_n69_), .c(new_n74_), .O(new_n141_));
  oai21  g108(.a(new_n141_), .b(new_n56_), .c(new_n54_), .O(new_n142_));
  nand2  g109(.a(new_n142_), .b(new_n44_), .O(new_n143_));
  inv1   g110(.a(new_n118_), .O(new_n144_));
  oai21  g111(.a(x13), .b(x05), .c(new_n74_), .O(new_n145_));
  nand4  g112(.a(x23), .b(x19), .c(x08), .d(new_n69_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(new_n112_), .c(new_n144_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n143_), .c(new_n75_), .O(new_n149_));
  aoi21  g116(.a(new_n120_), .b(new_n115_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n149_), .c(x16), .O(new_n151_));
  nor2   g118(.a(new_n66_), .b(x24), .O(new_n152_));
  nand3  g119(.a(new_n76_), .b(new_n75_), .c(x04), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n101_), .O(new_n154_));
  nor2   g121(.a(x22), .b(new_n74_), .O(new_n155_));
  aoi21  g122(.a(new_n154_), .b(x19), .c(new_n155_), .O(new_n156_));
  nor2   g123(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g124(.a(x15), .b(new_n132_), .O(new_n158_));
  oai21  g125(.a(new_n65_), .b(new_n132_), .c(new_n158_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n157_), .c(new_n152_), .d(new_n38_), .O(new_n160_));
  inv1   g127(.a(new_n45_), .O(new_n161_));
  nor2   g128(.a(new_n38_), .b(new_n34_), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(new_n161_), .c(new_n154_), .O(new_n163_));
  oai21  g130(.a(new_n161_), .b(new_n40_), .c(new_n155_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  inv1   g132(.a(x21), .O(new_n166_));
  nand2  g133(.a(x08), .b(x00), .O(new_n167_));
  oai21  g134(.a(new_n166_), .b(x08), .c(new_n167_), .O(new_n168_));
  nand3  g135(.a(new_n168_), .b(new_n55_), .c(new_n44_), .O(new_n169_));
  nand2  g136(.a(x08), .b(x07), .O(new_n170_));
  oai21  g137(.a(new_n111_), .b(x08), .c(new_n170_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n96_), .O(new_n172_));
  nand2  g139(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  aoi21  g140(.a(new_n165_), .b(new_n73_), .c(new_n173_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n160_), .c(new_n151_), .O(z4));
  nand2  g142(.a(x20), .b(new_n121_), .O(new_n176_));
  ...
  nand2  g146(.a(new_n120_), .b(new_n115_), .O(z7));
  nand2  g147(.a(new_n103_), .b(x14), .O(new_n181_));
  aoi21  g148(.a(new_n181_), .b(x06), .c(new_n48_), .O(new_n182_));
  oai21  g149(.a(new_n182_), .b(new_n179_), .c(z7), .O(new_n183_));
