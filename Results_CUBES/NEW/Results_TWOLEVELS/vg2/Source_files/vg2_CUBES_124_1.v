...
module FAU ( 
  ...
  nand4  g064(.a(new_n97_), .b(new_n49_), .c(new_n72_), .d(new_n96_), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n95_), .c(new_n90_), .d(new_n85_), .O(new_n99_));
  nor2   g066(.a(new_n39_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g068(.a(x20), .b(x17), .c(x15), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand3  g070(.a(new_n103_), .b(new_n89_), .c(new_n86_), .O(new_n104_));
  nor2   g071(.a(x11), .b(x09), .O(new_n105_));
  nor2   g072(.a(x14), .b(x12), .O(new_n106_));
  nor2   g073(.a(x08), .b(x06), .O(new_n107_));
  nand4  g074(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n94_), .O(new_n108_));
  nor2   g075(.a(x17), .b(x16), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n49_), .c(x19), .d(new_n96_), .O(new_n110_));
  oai22  g077(.a(new_n110_), .b(new_n108_), .c(new_n104_), .d(new_n85_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n39_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n101_), .c(new_n82_), .O(z1));
  ...
  nor2   g090(.a(new_n76_), .b(new_n48_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n84_), .c(new_n56_), .d(x20), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand2  g093(.a(new_n107_), .b(new_n49_), .O(new_n127_));
  ...
  nand4  g104(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n127_), .c(new_n137_), .d(new_n83_), .O(new_n139_));
  aoi22  g106(.a(new_n139_), .b(new_n39_), .c(new_n136_), .d(new_n100_), .O(new_n140_));
  ...
  aoi21  g111(.a(new_n144_), .b(new_n71_), .c(x08), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n96_), .c(new_n72_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n88_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n133_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n121_), .c(new_n145_), .d(new_n46_), .O(z4));
  ...
  oai22  g122(.a(new_n155_), .b(new_n121_), .c(new_n152_), .d(new_n46_), .O(z6));
