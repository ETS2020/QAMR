...
module FAU ( 
  ...
  nor2   g298(.a(new_n415_), .b(new_n368_), .O(new_n429_));
  nand4  g299(.a(new_n429_), .b(new_n412_), .c(new_n140_), .d(x00), .O(new_n430_));
  ...
  nand4  g334(.a(new_n379_), .b(new_n316_), .c(new_n262_), .d(new_n255_), .O(new_n465_));
  ...
  nand2  g351(.a(new_n379_), .b(new_n328_), .O(new_n482_));
  ...
  nand3  g521(.a(new_n425_), .b(new_n418_), .c(new_n547_), .O(new_n652_));
  nand3  g522(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n653_));
  nor4   g523(.a(new_n653_), .b(new_n652_), .c(new_n649_), .d(new_n426_), .O(z58));
  nor4   g524(.a(new_n485_), .b(new_n350_), .c(x43), .d(new_n314_), .O(z59));
  ...
  nand4  g539(.a(new_n669_), .b(new_n667_), .c(new_n483_), .d(new_n378_), .O(new_n670_));
  ...
  nand4  g543(.a(new_n673_), .b(new_n667_), .c(new_n483_), .d(new_n378_), .O(new_n674_));
