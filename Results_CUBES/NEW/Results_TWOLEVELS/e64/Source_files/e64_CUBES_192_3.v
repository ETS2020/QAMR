...
module FAU ( 
  ...
  nor3   g104(.a(x26), .b(x25), .c(x23), .O(new_n235_));
  ...
  nor2   g260(.a(x25), .b(x22), .O(new_n391_));
  ...
  inv1   g334(.a(new_n228_), .O(new_n466_));
  inv1   g335(.a(new_n321_), .O(new_n467_));
  nand3  g336(.a(new_n391_), .b(new_n231_), .c(new_n230_), .O(new_n468_));
  nor2   g337(.a(new_n468_), .b(new_n315_), .O(new_n469_));
  inv1   g338(.a(x34), .O(new_n470_));
  nand3  g339(.a(new_n397_), .b(new_n470_), .c(x32), .O(new_n471_));
  nor2   g340(.a(new_n471_), .b(new_n317_), .O(new_n472_));
  nand4  g341(.a(new_n472_), .b(new_n469_), .c(new_n467_), .d(new_n311_), .O(new_n473_));
  nor2   g342(.a(new_n473_), .b(new_n466_), .O(z26));
  inv1   g343(.a(new_n278_), .O(new_n475_));
  nand2  g344(.a(new_n447_), .b(new_n475_), .O(new_n476_));
  inv1   g345(.a(new_n277_), .O(new_n477_));
  nand2  g346(.a(new_n477_), .b(new_n275_), .O(new_n478_));
  nor2   g347(.a(new_n478_), .b(new_n476_), .O(new_n479_));
  inv1   g348(.a(new_n455_), .O(new_n480_));
  nand2  g349(.a(new_n480_), .b(new_n445_), .O(new_n481_));
  nand2  g350(.a(new_n449_), .b(new_n443_), .O(new_n482_));
  nor2   g351(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand2  g352(.a(new_n226_), .b(new_n178_), .O(new_n484_));
  nor3   g353(.a(new_n484_), .b(x14), .c(new_n224_), .O(new_n485_));
  nand4  g354(.a(new_n485_), .b(new_n483_), .c(new_n479_), .d(new_n469_), .O(new_n486_));
  nor2   g355(.a(new_n486_), .b(new_n223_), .O(z27));
  nand2  g356(.a(new_n361_), .b(new_n292_), .O(new_n488_));
  inv1   g357(.a(new_n463_), .O(new_n489_));
  nand4  g358(.a(new_n489_), .b(new_n297_), .c(new_n252_), .d(x25), .O(new_n490_));
  nor3   g359(.a(new_n490_), .b(new_n462_), .c(new_n488_), .O(z28));
  ...
  nor2   g376(.a(new_n507_), .b(new_n478_), .O(new_n508_));
  ...
  nand2  g533(.a(new_n489_), .b(new_n342_), .O(new_n665_));
  ...
  nand3  g539(.a(new_n489_), .b(new_n360_), .c(x30), .O(new_n671_));
