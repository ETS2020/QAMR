...
module FAU ( 
  ...
  aoi21  g55(.a(new_n95_), .b(new_n86_), .c(new_n98_), .O(z09));
  nor2   g56(.a(new_n48_), .b(new_n65_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(x22), .c(x21), .d(new_n49_), .O(new_n101_));
  inv1   g58(.a(x13), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x12), .c(new_n61_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n91_), .O(new_n104_));
  nor2   g61(.a(new_n87_), .b(x14), .O(new_n105_));
  ...
  nand3  g66(.a(new_n100_), .b(x21), .c(new_n49_), .O(new_n110_));
  nand3  g67(.a(new_n96_), .b(x20), .c(new_n88_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g70(.a(new_n97_), .b(new_n64_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g72(.a(new_n54_), .b(new_n58_), .c(new_n66_), .O(new_n116_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g74(.a(new_n49_), .b(x17), .c(new_n58_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n59_), .O(new_n120_));
  ...
  aoi21  g83(.a(new_n54_), .b(x01), .c(new_n58_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n58_), .c(new_n65_), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n64_), .c(new_n128_), .O(z15));
