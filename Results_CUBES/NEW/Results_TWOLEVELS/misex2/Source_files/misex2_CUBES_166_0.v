...
module FAU ( 
  ...
  nand2  g49(.a(new_n57_), .b(new_n92_), .O(new_n93_));
  ...
  nand4  g54(.a(new_n57_), .b(x22), .c(x21), .d(new_n92_), .O(new_n98_));
  nor2   g55(.a(new_n59_), .b(x01), .O(new_n99_));
  nand4  g56(.a(new_n95_), .b(new_n94_), .c(x16), .d(x15), .O(new_n100_));
  ...
  nand3  g64(.a(new_n57_), .b(x21), .c(new_n92_), .O(new_n108_));
  inv1   g65(.a(x16), .O(new_n109_));
  nand3  g66(.a(new_n94_), .b(new_n109_), .c(x15), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n89_), .c(new_n88_), .O(new_n112_));
  nand2  g69(.a(new_n95_), .b(new_n65_), .O(new_n113_));
  aoi21  g70(.a(new_n112_), .b(new_n108_), .c(new_n113_), .O(z11));
  oai21  g71(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n117_));
  nand2  g74(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n60_), .O(new_n119_));
