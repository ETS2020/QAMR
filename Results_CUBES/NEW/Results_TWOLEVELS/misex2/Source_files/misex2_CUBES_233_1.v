...
module FAU ( 
  ...
  nand3  g31(.a(x11), .b(x10), .c(new_n44_), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n62_), .c(new_n67_), .O(z06));
  nand2  g33(.a(x02), .b(new_n62_), .O(new_n77_));
  nand4  g34(.a(new_n63_), .b(new_n71_), .c(x11), .d(x10), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(new_n77_), .c(new_n67_), .O(z07));
  ...
  inv1   g43(.a(new_n77_), .O(new_n87_));
  ...
  nand4  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n87_), .O(new_n94_));
  ...
  nor2   g57(.a(x20), .b(new_n62_), .O(new_n101_));
  nand4  g58(.a(new_n101_), .b(new_n57_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g59(.a(x13), .O(new_n103_));
  nand3  g60(.a(new_n103_), .b(x12), .c(new_n70_), .O(new_n104_));
  nor2   g61(.a(new_n104_), .b(new_n77_), .O(new_n105_));
  ...
  nand3  g68(.a(new_n97_), .b(x20), .c(new_n89_), .O(new_n112_));
  inv1   g69(.a(new_n112_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n106_), .c(new_n105_), .O(new_n114_));
  nand2  g71(.a(new_n98_), .b(new_n67_), .O(new_n115_));
  aoi21  g72(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(z11));
  oai21  g73(.a(new_n54_), .b(new_n59_), .c(new_n68_), .O(new_n117_));
  ...
  nand3  g85(.a(x19), .b(new_n59_), .c(new_n62_), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(new_n67_), .c(new_n129_), .O(z15));
  nor2   g87(.a(new_n62_), .b(x00), .O(z16));
