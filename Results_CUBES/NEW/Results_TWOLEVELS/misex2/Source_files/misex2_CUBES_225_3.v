...
module FAU ( 
  ...
  oai22  g27(.a(new_n70_), .b(new_n67_), .c(new_n64_), .d(new_n61_), .O(z03));
  nand2  g28(.a(new_n69_), .b(x02), .O(new_n72_));
  inv1   g29(.a(x12), .O(new_n73_));
  nand4  g30(.a(new_n73_), .b(new_n65_), .c(x10), .d(new_n44_), .O(new_n74_));
  nor2   g31(.a(new_n74_), .b(new_n72_), .O(z04));
  nor3   g32(.a(new_n72_), .b(new_n57_), .c(new_n44_), .O(z05));
  nand3  g33(.a(new_n66_), .b(new_n44_), .c(x02), .O(new_n77_));
  nor2   g34(.a(new_n77_), .b(new_n68_), .O(z06));
  nand4  g35(.a(new_n66_), .b(new_n73_), .c(new_n44_), .d(x01), .O(new_n79_));
  ...
  nand2  g42(.a(new_n63_), .b(x02), .O(new_n86_));
  ...
  nand4  g52(.a(new_n95_), .b(x20), .c(new_n90_), .d(new_n89_), .O(new_n96_));
  ...
  nand3  g61(.a(new_n92_), .b(x12), .c(new_n65_), .O(new_n105_));
  nor2   g62(.a(new_n105_), .b(new_n91_), .O(new_n106_));
  nor2   g63(.a(new_n89_), .b(x14), .O(new_n107_));
  nand4  g64(.a(new_n100_), .b(new_n99_), .c(x20), .d(x16), .O(new_n108_));
