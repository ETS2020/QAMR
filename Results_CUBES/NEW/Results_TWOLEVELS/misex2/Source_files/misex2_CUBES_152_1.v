...
module FAU ( 
  ...
  nand2  g57(.a(new_n100_), .b(new_n65_), .O(new_n101_));
  aoi21  g58(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(z09));
  nand3  g59(.a(new_n92_), .b(x12), .c(new_n62_), .O(new_n103_));
  ...
  nand4  g65(.a(new_n108_), .b(new_n106_), .c(new_n104_), .d(new_n91_), .O(new_n109_));
  nor2   g66(.a(new_n100_), .b(x20), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n57_), .c(x22), .d(x01), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n109_), .c(x00), .O(z10));
  nand3  g69(.a(new_n88_), .b(x15), .c(new_n93_), .O(new_n113_));
  inv1   g70(.a(new_n113_), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n106_), .c(new_n104_), .d(new_n91_), .O(new_n115_));
  nand4  g72(.a(new_n110_), .b(new_n57_), .c(new_n97_), .d(x01), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(x00), .O(z11));
