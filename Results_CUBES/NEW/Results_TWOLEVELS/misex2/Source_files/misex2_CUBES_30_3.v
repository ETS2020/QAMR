...
module FAU ( 
  ...
  nand3  g35(.a(x19), .b(new_n49_), .c(x17), .O(new_n79_));
  ...
  nand4  g40(.a(x04), .b(new_n83_), .c(x02), .d(new_n64_), .O(new_n84_));
  nor3   g41(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z08));
  ...
  oai21  g73(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n117_));
  nor2   g74(.a(x19), .b(x02), .O(new_n118_));
  nand2  g75(.a(x23), .b(new_n65_), .O(new_n119_));
  nand3  g76(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n118_), .c(new_n120_), .O(new_n121_));
  nand2  g78(.a(new_n121_), .b(new_n64_), .O(new_n122_));
  inv1   g79(.a(x24), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(x09), .O(new_n124_));
  aoi21  g81(.a(new_n122_), .b(new_n117_), .c(new_n124_), .O(z12));
  nand4  g82(.a(new_n50_), .b(x17), .c(new_n44_), .d(new_n64_), .O(new_n126_));
  inv1   g83(.a(new_n126_), .O(z13));
  nor2   g84(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g85(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n129_));
  nand3  g86(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n130_));
  oai21  g87(.a(new_n129_), .b(new_n64_), .c(new_n130_), .O(z15));
  nor2   g88(.a(new_n65_), .b(x00), .O(z16));
  nand2  g89(.a(new_n46_), .b(x02), .O(new_n133_));
