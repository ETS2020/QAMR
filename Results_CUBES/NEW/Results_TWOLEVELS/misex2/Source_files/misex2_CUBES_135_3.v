...
module FAU ( 
  ...
  nand2  g77(.a(new_n45_), .b(new_n66_), .O(new_n121_));
  nand2  g78(.a(new_n52_), .b(x17), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n67_), .O(new_n124_));
  ...
  nand3  g87(.a(x19), .b(new_n45_), .c(new_n67_), .O(new_n131_));
  oai21  g88(.a(new_n130_), .b(new_n66_), .c(new_n131_), .O(z15));
  nor2   g89(.a(new_n67_), .b(x00), .O(z16));
