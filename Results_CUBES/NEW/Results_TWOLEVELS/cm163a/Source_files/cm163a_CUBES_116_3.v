// Benchmark "FAU" written by ABC on Mon Jul  6 12:59:57 2020
...
module FAU ( 
  ...
  aoi22  g20(.a(new_n41_), .b(new_n40_), .c(new_n39_), .d(x12), .O(new_n42_));
  ...
  aoi21  g24(.a(new_n22_), .b(x03), .c(x07), .O(new_n46_));
  aoi21  g25(.a(new_n40_), .b(x02), .c(new_n29_), .O(new_n47_));
  oai21  g26(.a(new_n47_), .b(new_n46_), .c(x13), .O(new_n48_));
  ...
  nand2  g31(.a(new_n52_), .b(new_n48_), .O(z3));
