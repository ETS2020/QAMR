...
module FAU ( 
  ...
  nand2  g22(.a(new_n43_), .b(x13), .O(new_n44_));
  inv1   g23(.a(x13), .O(new_n45_));
  nor2   g24(.a(x12), .b(new_n22_), .O(new_n46_));
  nand4  g25(.a(new_n46_), .b(new_n31_), .c(new_n24_), .d(new_n45_), .O(new_n47_));
  inv1   g26(.a(x07), .O(new_n48_));
  aoi21  g27(.a(new_n48_), .b(new_n22_), .c(new_n27_), .O(new_n49_));
  nand3  g28(.a(new_n49_), .b(new_n47_), .c(new_n44_), .O(z3));
