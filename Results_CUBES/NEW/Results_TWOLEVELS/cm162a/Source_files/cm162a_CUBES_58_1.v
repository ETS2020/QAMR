// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:33 2020
...
module FAU ( 
  ...
  oai21  g03(.a(x08), .b(new_n21_), .c(new_n22_), .O(new_n23_));
  ...
  aoi21  g13(.a(new_n32_), .b(new_n22_), .c(new_n30_), .O(new_n33_));
  inv1   g14(.a(x10), .O(new_n34_));
  nor2   g15(.a(x08), .b(new_n21_), .O(new_n35_));
  aoi21  g16(.a(new_n35_), .b(x02), .c(new_n34_), .O(new_n36_));
  ...
  nand3  g23(.a(new_n42_), .b(new_n41_), .c(x04), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n22_), .c(new_n30_), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  inv1   g26(.a(new_n24_), .O(new_n46_));
  aoi21  g27(.a(new_n31_), .b(new_n46_), .c(new_n45_), .O(new_n47_));
  ...
  nand4  g33(.a(new_n42_), .b(new_n52_), .c(new_n41_), .d(x04), .O(new_n53_));
  aoi21  g34(.a(new_n53_), .b(new_n22_), .c(new_n30_), .O(new_n54_));
  nor2   g35(.a(new_n24_), .b(x08), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n42_), .c(new_n52_), .O(new_n56_));
  oai21  g37(.a(new_n56_), .b(new_n54_), .c(x03), .O(new_n57_));
  inv1   g38(.a(x07), .O(new_n58_));
  aoi21  g39(.a(new_n58_), .b(new_n20_), .c(new_n27_), .O(new_n59_));
  nand2  g40(.a(new_n59_), .b(new_n57_), .O(z3));
  inv1   g41(.a(new_n22_), .O(z4));
endmodule
