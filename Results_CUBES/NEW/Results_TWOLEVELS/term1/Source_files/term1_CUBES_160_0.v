...
module FAU ( 
  ...
  nand2  g068(.a(x23), .b(new_n112_), .O(new_n113_));
  ...
  nand3  g077(.a(x19), .b(new_n82_), .c(x12), .O(new_n122_));
  inv1   g078(.a(x19), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x17), .c(x14), .O(new_n124_));
  nand2  g080(.a(x18), .b(x16), .O(new_n125_));
  aoi21  g081(.a(new_n124_), .b(new_n122_), .c(new_n125_), .O(new_n126_));
  inv1   g082(.a(x16), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x11), .O(new_n128_));
  nand2  g084(.a(new_n112_), .b(x13), .O(new_n129_));
  ...
  nand4  g091(.a(new_n135_), .b(x16), .c(new_n133_), .d(x10), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n97_), .b(new_n78_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n102_), .c(x29), .O(new_n139_));
  nand2  g095(.a(new_n138_), .b(x29), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n102_), .c(new_n139_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n137_), .c(z0), .d(x31), .O(new_n143_));
  nand2  g099(.a(x15), .b(x11), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n130_), .c(new_n127_), .O(new_n145_));
  nand2  g101(.a(x19), .b(x18), .O(new_n146_));
  nand2  g102(.a(x17), .b(x10), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(new_n133_), .O(new_n148_));
  inv1   g104(.a(x12), .O(new_n149_));
  oai21  g105(.a(new_n146_), .b(new_n149_), .c(new_n82_), .O(new_n150_));
  nor2   g106(.a(new_n127_), .b(new_n133_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n135_), .O(new_n152_));
  ...
  nor2   g126(.a(new_n116_), .b(new_n102_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n137_), .c(new_n165_), .O(new_n172_));
  ...
  oai21  g131(.a(new_n112_), .b(new_n149_), .c(new_n82_), .O(new_n176_));
  nand2  g132(.a(x31), .b(new_n102_), .O(new_n177_));
  inv1   g133(.a(x13), .O(new_n178_));
  nand2  g134(.a(new_n112_), .b(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .d(new_n175_), .O(new_n180_));
  nand2  g136(.a(new_n123_), .b(x14), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n151_), .c(x18), .d(x17), .O(new_n182_));
  nand3  g138(.a(x18), .b(x17), .c(x15), .O(new_n183_));
  nand3  g139(.a(x18), .b(x17), .c(x10), .O(new_n184_));
  aoi22  g140(.a(new_n184_), .b(new_n133_), .c(new_n183_), .d(new_n123_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n182_), .c(new_n145_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n180_), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n165_), .O(new_n188_));
  aoi21  g144(.a(new_n174_), .b(new_n141_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n170_), .c(new_n163_), .O(z9));
endmodule
