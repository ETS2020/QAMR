// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:26 2020
...
module FAU ( 
  ...
  nor2   g037(.a(x29), .b(x28), .O(new_n82_));
  nand2  g038(.a(x25), .b(x01), .O(new_n83_));
  nor4   g039(.a(new_n83_), .b(new_n82_), .c(x27), .d(x26), .O(new_n84_));
  nand3  g040(.a(new_n84_), .b(new_n81_), .c(new_n57_), .O(new_n85_));
  ...
  inv1   g046(.a(new_n81_), .O(new_n91_));
  ...
  nor2   g051(.a(new_n93_), .b(x27), .O(new_n96_));
  aoi21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand2  g053(.a(new_n88_), .b(new_n57_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n97_), .c(new_n91_), .O(z5));
  inv1   g055(.a(new_n98_), .O(new_n100_));
  inv1   g056(.a(x27), .O(new_n101_));
  oai21  g057(.a(new_n95_), .b(new_n101_), .c(x30), .O(new_n102_));
  inv1   g058(.a(x30), .O(new_n103_));
  nor2   g059(.a(new_n92_), .b(new_n101_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(x29), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n100_), .c(new_n81_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z6));
  inv1   g064(.a(x31), .O(new_n109_));
  nor2   g065(.a(new_n103_), .b(new_n93_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n104_), .c(new_n109_), .O(new_n111_));
  nand2  g067(.a(new_n110_), .b(new_n104_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x31), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n111_), .c(new_n100_), .d(new_n81_), .O(z7));
  ...
  nand2  g087(.a(new_n92_), .b(new_n101_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n103_), .c(x29), .O(new_n133_));
  ...
  xnor2a g094(.a(x30), .b(x27), .O(new_n139_));
  ...
  nor2   g101(.a(new_n125_), .b(new_n115_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n127_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(new_n140_), .O(new_n148_));
  nand2  g104(.a(x16), .b(x10), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n126_), .c(new_n115_), .O(new_n150_));
  oai21  g106(.a(x19), .b(x14), .c(x31), .O(new_n151_));
  aoi21  g107(.a(new_n103_), .b(new_n93_), .c(new_n151_), .O(new_n152_));
  inv1   g108(.a(x13), .O(new_n153_));
  oai21  g109(.a(new_n119_), .b(new_n153_), .c(new_n117_), .O(new_n154_));
  nand2  g110(.a(new_n110_), .b(x28), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n148_), .c(x32), .O(new_n157_));
  inv1   g113(.a(x26), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x00), .O(new_n159_));
  aoi21  g115(.a(new_n157_), .b(new_n138_), .c(new_n159_), .O(z8));
  nand3  g116(.a(x31), .b(x30), .c(x27), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nor3   g118(.a(x31), .b(x30), .c(x27), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n92_), .O(new_n164_));
  nor2   g120(.a(new_n109_), .b(new_n103_), .O(new_n165_));
  nor3   g121(.a(x31), .b(x30), .c(x29), .O(new_n166_));
  aoi21  g122(.a(new_n165_), .b(new_n94_), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n164_), .c(x33), .O(new_n168_));
  oai21  g124(.a(new_n131_), .b(new_n129_), .c(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n94_), .b(x30), .c(new_n109_), .O(new_n170_));
  nor2   g126(.a(new_n117_), .b(new_n116_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n146_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n119_), .O(new_n173_));
  inv1   g129(.a(new_n171_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n149_), .c(new_n115_), .O(new_n175_));
  nand2  g131(.a(new_n171_), .b(x11), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n125_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n175_), .c(new_n173_), .d(new_n170_), .O(new_n178_));
  oai21  g134(.a(new_n117_), .b(new_n144_), .c(new_n116_), .O(new_n179_));
  nor2   g135(.a(new_n110_), .b(new_n109_), .O(new_n180_));
  aoi21  g136(.a(new_n117_), .b(new_n153_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n119_), .b(x14), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n171_), .c(new_n146_), .O(new_n183_));
  xor2a  g139(.a(x31), .b(x27), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n92_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n183_), .c(new_n181_), .d(new_n179_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n178_), .c(x33), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n169_), .c(new_n159_), .O(z9));
endmodule
