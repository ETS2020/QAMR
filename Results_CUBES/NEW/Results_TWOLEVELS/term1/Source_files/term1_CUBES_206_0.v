...
module FAU ( 
  ...
  oai22  g033(.a(x24), .b(x19), .c(x22), .d(x17), .O(new_n78_));
  ...
  nand3  g071(.a(x19), .b(new_n81_), .c(x13), .O(new_n116_));
  ...
  nor2   g094(.a(new_n117_), .b(new_n81_), .O(new_n139_));
