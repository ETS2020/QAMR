// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:29 2020
...
module FAU ( 
  ...
  nand2  g125(.a(new_n114_), .b(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n168_), .c(new_n167_), .O(new_n171_));
  oai21  g127(.a(new_n116_), .b(new_n112_), .c(x14), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x18), .c(x17), .d(x16), .O(new_n173_));
  nand2  g129(.a(x16), .b(x15), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(new_n116_), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(new_n143_), .c(new_n112_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n178_), .c(new_n122_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .d(new_n173_), .O(new_n180_));
  nor3   g136(.a(new_n180_), .b(new_n171_), .c(new_n166_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n157_), .O(new_n182_));
  aoi21  g138(.a(new_n165_), .b(new_n162_), .c(new_n182_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n161_), .c(new_n155_), .O(z9));
endmodule
