// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:43 2020
...
module FAU ( 
  ...
  oai22  g043(.a(new_n87_), .b(x03), .c(x27), .d(x02), .O(new_n88_));
  ...
  nand2  g049(.a(new_n93_), .b(new_n50_), .O(new_n94_));
