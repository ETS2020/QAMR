...
module FAU ( 
  ...
  nand3  g074(.a(new_n118_), .b(x17), .c(x13), .O(new_n119_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n131_), .c(new_n112_), .O(new_n137_));
  nand3  g093(.a(x16), .b(new_n112_), .c(x10), .O(new_n138_));
  ...
  oai21  g098(.a(new_n141_), .b(new_n137_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n107_), .b(x28), .O(new_n144_));
  aoi21  g100(.a(x19), .b(x13), .c(x18), .O(new_n145_));
  oai21  g101(.a(x30), .b(x29), .c(x31), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  inv1   g103(.a(x16), .O(new_n148_));
  nor2   g104(.a(new_n126_), .b(new_n118_), .O(new_n149_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n116_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n151_), .c(new_n147_), .d(new_n144_), .O(new_n154_));
  nor2   g110(.a(x19), .b(x14), .O(new_n155_));
  nand2  g111(.a(new_n149_), .b(x17), .O(new_n156_));
  nor3   g112(.a(new_n156_), .b(new_n148_), .c(new_n112_), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g114(.a(new_n107_), .b(x27), .O(new_n159_));
  oai21  g115(.a(x30), .b(x27), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n93_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n156_), .c(new_n112_), .O(new_n163_));
  ...
  aoi21  g123(.a(new_n165_), .b(new_n143_), .c(new_n167_), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  nand3  g125(.a(x31), .b(x30), .c(x29), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nor2   g127(.a(x31), .b(x30), .O(new_n172_));
  aoi22  g128(.a(new_n172_), .b(new_n114_), .c(new_n171_), .d(new_n113_), .O(new_n173_));
  nand3  g129(.a(new_n122_), .b(new_n106_), .c(new_n98_), .O(new_n174_));
  ...
  oai21  g133(.a(new_n173_), .b(new_n121_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x16), .O(new_n179_));
  nor2   g135(.a(new_n173_), .b(new_n132_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n135_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n112_), .O(new_n182_));
  nand2  g138(.a(new_n180_), .b(new_n139_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n182_), .c(new_n169_), .O(new_n185_));
  inv1   g141(.a(new_n145_), .O(new_n186_));
  nand2  g142(.a(new_n113_), .b(new_n107_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x31), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n153_), .c(new_n151_), .d(new_n186_), .O(new_n189_));
  nand2  g145(.a(new_n114_), .b(new_n98_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n106_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n163_), .c(new_n158_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n189_), .c(x33), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n185_), .c(new_n167_), .O(z9));
endmodule
