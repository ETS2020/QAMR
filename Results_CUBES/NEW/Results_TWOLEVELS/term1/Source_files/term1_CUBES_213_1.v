...
module FAU ( 
  ...
  oai22  g034(.a(x22), .b(x17), .c(x21), .d(x16), .O(new_n79_));
  ...
  nand2  g089(.a(new_n78_), .b(x15), .O(new_n134_));
  aoi21  g090(.a(new_n133_), .b(new_n127_), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(x16), .b(new_n82_), .c(x10), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n131_), .O(new_n137_));
  nand2  g093(.a(new_n95_), .b(new_n77_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n101_), .c(x29), .O(new_n139_));
  ...
  nor2   g100(.a(new_n128_), .b(new_n82_), .O(new_n145_));
  ...
  nand2  g109(.a(new_n153_), .b(new_n95_), .O(new_n154_));
  oai21  g110(.a(x19), .b(x14), .c(x31), .O(new_n155_));
  aoi21  g111(.a(new_n101_), .b(new_n113_), .c(new_n155_), .O(new_n156_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n151_), .c(new_n78_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n131_), .c(new_n82_), .O(new_n162_));
  ...
  aoi21  g121(.a(new_n133_), .b(new_n127_), .c(x33), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n111_), .c(new_n101_), .d(x15), .O(new_n167_));
  nand2  g123(.a(x33), .b(x31), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(x26), .O(new_n169_));
  nand4  g125(.a(x17), .b(x16), .c(new_n82_), .d(x10), .O(new_n170_));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n130_), .b(new_n171_), .c(new_n111_), .d(new_n101_), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n169_), .c(new_n140_), .O(new_n174_));
  inv1   g130(.a(new_n140_), .O(new_n175_));
  nand3  g131(.a(x31), .b(x30), .c(x15), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  nor2   g133(.a(new_n171_), .b(x31), .O(new_n178_));
  aoi21  g134(.a(new_n177_), .b(new_n166_), .c(new_n178_), .O(new_n179_));
  inv1   g135(.a(new_n170_), .O(new_n180_));
  nor3   g136(.a(x33), .b(new_n111_), .c(new_n101_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n180_), .c(new_n130_), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(x26), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n111_), .b(x30), .O(new_n184_));
  oai21  g140(.a(new_n120_), .b(new_n149_), .c(new_n119_), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n101_), .O(new_n186_));
  inv1   g142(.a(x13), .O(new_n187_));
  nand2  g143(.a(new_n120_), .b(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n186_), .c(new_n185_), .d(new_n184_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  nand2  g146(.a(x18), .b(x17), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n190_), .c(new_n128_), .O(new_n192_));
  nand2  g148(.a(new_n122_), .b(x14), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n145_), .c(x18), .d(x17), .O(new_n194_));
  oai21  g150(.a(new_n191_), .b(new_n128_), .c(new_n122_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n194_), .c(new_n192_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n189_), .c(new_n78_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n162_), .c(new_n171_), .O(new_n198_));
  aoi21  g154(.a(new_n183_), .b(new_n175_), .c(new_n198_), .O(new_n199_));
  aoi21  g155(.a(new_n199_), .b(new_n174_), .c(new_n118_), .O(z9));
endmodule
