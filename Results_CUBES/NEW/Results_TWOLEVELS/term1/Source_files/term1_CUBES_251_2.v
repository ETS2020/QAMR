...
module FAU ( 
  ...
  nand3  g072(.a(new_n79_), .b(x18), .c(x14), .O(new_n117_));
  ...
  nor2   g093(.a(new_n79_), .b(new_n115_), .O(new_n138_));
  ...
  nand2  g105(.a(new_n79_), .b(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x31), .O(new_n151_));
  aoi21  g107(.a(new_n95_), .b(new_n107_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g117(.a(new_n105_), .b(new_n95_), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(new_n105_), .O(new_n163_));
  ...
  nand2  g125(.a(new_n105_), .b(x30), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n95_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n150_), .c(new_n170_), .O(new_n172_));
  nand2  g128(.a(new_n115_), .b(x13), .O(new_n173_));
  ...
  nand2  g132(.a(new_n176_), .b(new_n115_), .O(new_n177_));
