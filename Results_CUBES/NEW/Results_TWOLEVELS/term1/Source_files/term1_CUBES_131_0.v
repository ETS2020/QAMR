...
module FAU ( 
  ...
  aoi21  g082(.a(new_n126_), .b(new_n122_), .c(new_n80_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n80_), .c(x10), .O(new_n128_));
  ...
  nor2   g092(.a(new_n123_), .b(new_n80_), .O(new_n137_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n124_), .c(new_n80_), .O(new_n146_));
  ...
  aoi21  g106(.a(new_n108_), .b(new_n92_), .c(new_n150_), .O(new_n151_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n145_), .c(new_n80_), .O(new_n179_));
  ...
  nor3   g138(.a(new_n182_), .b(new_n172_), .c(new_n168_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n159_), .O(new_n184_));
  aoi21  g140(.a(new_n167_), .b(new_n164_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n163_), .c(new_n157_), .O(z9));
endmodule
