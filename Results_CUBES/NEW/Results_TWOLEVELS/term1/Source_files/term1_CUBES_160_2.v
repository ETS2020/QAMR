...
module FAU ( 
  ...
  nand3  g081(.a(x19), .b(new_n84_), .c(x12), .O(new_n126_));
  nand3  g082(.a(new_n81_), .b(x17), .c(x14), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n126_), .c(new_n116_), .O(new_n128_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n128_), .c(x15), .O(new_n132_));
  nor2   g088(.a(new_n81_), .b(new_n84_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x16), .c(new_n77_), .d(x10), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g091(.a(new_n103_), .b(new_n102_), .O(new_n136_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n109_), .c(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n135_), .c(z0), .d(x31), .O(new_n141_));
  nand2  g097(.a(new_n133_), .b(x11), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n116_), .O(new_n143_));
  nand3  g099(.a(new_n133_), .b(x16), .c(x10), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n77_), .O(new_n145_));
  nand2  g101(.a(new_n109_), .b(new_n101_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nand2  g103(.a(x31), .b(x18), .O(new_n148_));
  aoi21  g104(.a(new_n81_), .b(new_n147_), .c(new_n148_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n146_), .c(new_n145_), .d(new_n143_), .O(new_n150_));
  nand2  g106(.a(new_n122_), .b(x27), .O(new_n151_));
  oai21  g107(.a(x30), .b(x27), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n103_), .O(new_n153_));
  nand2  g109(.a(new_n122_), .b(x28), .O(new_n154_));
  aoi21  g110(.a(x19), .b(x12), .c(x17), .O(new_n155_));
  nor2   g111(.a(new_n116_), .b(new_n77_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n133_), .c(new_n155_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n154_), .c(new_n153_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n150_), .c(x32), .O(new_n159_));
  inv1   g115(.a(x26), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x00), .O(new_n161_));
  aoi21  g117(.a(new_n159_), .b(new_n141_), .c(new_n161_), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand2  g119(.a(new_n135_), .b(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n120_), .b(new_n109_), .O(new_n165_));
  ...
  nor2   g124(.a(new_n120_), .b(new_n109_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n135_), .c(new_n163_), .O(new_n170_));
  nand2  g126(.a(x33), .b(new_n120_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g128(.a(x17), .b(x11), .c(x16), .O(new_n173_));
  oai21  g129(.a(x31), .b(new_n109_), .c(x18), .O(new_n174_));
  nor2   g130(.a(x17), .b(x12), .O(new_n175_));
  nor2   g131(.a(new_n120_), .b(x30), .O(new_n176_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n77_), .O(new_n180_));
  nand2  g136(.a(new_n81_), .b(x14), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n156_), .c(x17), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n77_), .c(new_n81_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n182_), .c(new_n180_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n177_), .c(new_n163_), .O(new_n186_));
  aoi21  g142(.a(new_n172_), .b(new_n139_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n168_), .c(new_n161_), .O(z9));
endmodule
