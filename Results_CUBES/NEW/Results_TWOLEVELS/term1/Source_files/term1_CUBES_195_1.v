...
module FAU ( 
  ...
  nand2  g078(.a(x27), .b(x16), .O(new_n123_));
  ...
  nand3  g082(.a(new_n126_), .b(x30), .c(x16), .O(new_n127_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n132_), .c(x11), .O(new_n134_));
  ...
  nand3  g097(.a(x17), .b(new_n117_), .c(x10), .O(new_n142_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n117_), .O(new_n158_));
  ...
  nand4  g129(.a(new_n126_), .b(new_n111_), .c(new_n101_), .d(x16), .O(new_n174_));
  ...
  oai21  g147(.a(new_n191_), .b(new_n157_), .c(new_n117_), .O(new_n192_));
  nand2  g148(.a(new_n188_), .b(x11), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n132_), .O(new_n194_));
