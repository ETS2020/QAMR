...
module FAU ( 
  ...
  nand3  g070(.a(x19), .b(new_n114_), .c(x11), .O(new_n115_));
  ...
  nand3  g077(.a(new_n121_), .b(x16), .c(x14), .O(new_n122_));
  ...
  nand4  g091(.a(x17), .b(x16), .c(new_n135_), .d(x10), .O(new_n136_));
  ...
  nor2   g099(.a(new_n114_), .b(new_n135_), .O(new_n144_));
  ...
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n135_), .O(new_n153_));
  ...
  oai21  g145(.a(new_n189_), .b(new_n152_), .c(new_n135_), .O(new_n190_));
  nand2  g146(.a(new_n186_), .b(x11), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n114_), .O(new_n192_));
