// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:48 2020
...
module FAU ( 
  ...
  oai21  g066(.a(new_n92_), .b(new_n102_), .c(new_n84_), .O(new_n111_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n84_), .c(new_n114_), .d(new_n79_), .O(new_n116_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n82_), .c(x11), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n124_), .O(new_n137_));
  ...
  nor2   g102(.a(new_n82_), .b(new_n124_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n135_), .O(new_n148_));
  nor2   g104(.a(new_n128_), .b(new_n126_), .O(new_n149_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n125_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n151_), .c(new_n148_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n134_), .c(new_n124_), .O(new_n156_));
  ...
  nand2  g138(.a(new_n128_), .b(x14), .O(new_n183_));
  nor2   g139(.a(new_n126_), .b(new_n125_), .O(new_n184_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n155_), .c(new_n124_), .O(new_n189_));
  nand2  g145(.a(new_n184_), .b(x11), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n82_), .O(new_n191_));
