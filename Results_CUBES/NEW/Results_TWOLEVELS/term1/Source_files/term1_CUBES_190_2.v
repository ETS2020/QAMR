// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:04 2020
...
module FAU ( 
  ...
  nand3  g077(.a(new_n121_), .b(x17), .c(x14), .O(new_n122_));
  ...
  nor2   g086(.a(new_n130_), .b(new_n114_), .O(new_n131_));
  inv1   g087(.a(x11), .O(new_n132_));
  nor2   g088(.a(x16), .b(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n125_), .d(x19), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n129_), .c(x15), .O(new_n136_));
  inv1   g092(.a(x15), .O(new_n137_));
  nand3  g093(.a(x16), .b(new_n137_), .c(x10), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n131_), .c(new_n125_), .d(x19), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nor2   g097(.a(x32), .b(new_n106_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nor2   g099(.a(new_n121_), .b(new_n130_), .O(new_n144_));
  nor2   g100(.a(new_n112_), .b(new_n137_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n144_), .c(x17), .O(new_n146_));
  nand3  g102(.a(new_n144_), .b(x17), .c(x11), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n112_), .O(new_n148_));
  nand2  g104(.a(new_n144_), .b(x12), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n114_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n148_), .c(new_n146_), .O(new_n151_));
  nand2  g107(.a(new_n144_), .b(x17), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n137_), .O(new_n154_));
  ...
  aoi21  g114(.a(new_n100_), .b(new_n91_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(x19), .b(x13), .c(x18), .O(new_n160_));
  aoi21  g116(.a(new_n107_), .b(x28), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n151_), .c(x32), .O(new_n163_));
  inv1   g119(.a(x26), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x00), .O(new_n165_));
  aoi21  g121(.a(new_n163_), .b(new_n143_), .c(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand3  g123(.a(x31), .b(x30), .c(x29), .O(new_n168_));
  nand3  g124(.a(new_n106_), .b(new_n100_), .c(new_n91_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n168_), .c(new_n115_), .O(new_n170_));
  inv1   g126(.a(new_n168_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n117_), .O(new_n172_));
  nand3  g128(.a(new_n119_), .b(new_n106_), .c(new_n100_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n172_), .c(new_n122_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n170_), .c(x18), .O(new_n175_));
  nand2  g131(.a(new_n173_), .b(new_n172_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n127_), .c(x19), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n175_), .c(new_n112_), .O(new_n178_));
  nand4  g134(.a(new_n176_), .b(new_n133_), .c(new_n131_), .d(x19), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n178_), .c(x15), .O(new_n181_));
  nand4  g137(.a(new_n176_), .b(new_n139_), .c(new_n131_), .d(x19), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n167_), .O(new_n184_));
  nand2  g140(.a(new_n117_), .b(new_n107_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x31), .O(new_n186_));
  nand2  g142(.a(new_n145_), .b(new_n131_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n121_), .O(new_n188_));
  inv1   g144(.a(new_n131_), .O(new_n189_));
  oai21  g145(.a(new_n153_), .b(new_n189_), .c(new_n137_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n132_), .c(new_n112_), .O(new_n191_));
  ...
  nand3  g151(.a(new_n195_), .b(new_n145_), .c(new_n131_), .O(new_n196_));
  nand2  g152(.a(x18), .b(x12), .O(new_n197_));
  aoi22  g153(.a(new_n197_), .b(new_n114_), .c(new_n130_), .d(new_n126_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n196_), .c(new_n194_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n192_), .c(x33), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n184_), .c(new_n165_), .O(z9));
endmodule
