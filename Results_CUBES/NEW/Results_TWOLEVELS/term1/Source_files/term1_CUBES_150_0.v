...
module FAU ( 
  ...
  nand2  g091(.a(new_n113_), .b(x12), .O(new_n136_));
  ...
  nand2  g096(.a(new_n138_), .b(new_n113_), .O(new_n141_));
  ...
  nand2  g123(.a(x18), .b(x16), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n127_), .c(new_n112_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n112_), .c(new_n116_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n169_), .c(new_n141_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  inv1   g128(.a(x14), .O(new_n173_));
  oai21  g129(.a(x19), .b(new_n173_), .c(x17), .O(new_n174_));
  oai21  g130(.a(new_n116_), .b(x12), .c(new_n174_), .O(new_n175_));
  nand3  g131(.a(x18), .b(x16), .c(x15), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n106_), .b(x30), .O(new_n178_));
  nand2  g134(.a(x18), .b(x11), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n122_), .O(new_n180_));
  nand2  g136(.a(x31), .b(new_n98_), .O(new_n181_));
  inv1   g137(.a(x13), .O(new_n182_));
  nand2  g138(.a(new_n114_), .b(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n181_), .c(new_n180_), .d(new_n178_), .O(new_n184_));
  aoi21  g140(.a(new_n177_), .b(new_n175_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n172_), .c(new_n159_), .O(new_n186_));
  aoi21  g142(.a(new_n167_), .b(new_n164_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n163_), .c(new_n157_), .O(z9));
endmodule
