// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:09 2020
...
module FAU ( 
  ...
  nand3  g070(.a(new_n106_), .b(new_n85_), .c(x20), .O(new_n115_));
  ...
  nand4  g111(.a(new_n155_), .b(x19), .c(x16), .d(x10), .O(new_n156_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n143_), .c(new_n76_), .O(new_n169_));
  ...
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(x15), .O(new_n185_));
  ...
  oai21  g156(.a(new_n200_), .b(new_n168_), .c(new_n76_), .O(new_n201_));
  nand2  g157(.a(new_n155_), .b(x11), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n142_), .O(new_n203_));
