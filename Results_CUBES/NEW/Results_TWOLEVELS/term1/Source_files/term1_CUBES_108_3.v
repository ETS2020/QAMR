...
module FAU ( 
  ...
  nor2   g072(.a(x32), .b(new_n114_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n116_), .c(x13), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n115_), .c(new_n113_), .O(new_n119_));
  nand2  g075(.a(new_n113_), .b(x12), .O(new_n120_));
  nand2  g076(.a(new_n117_), .b(x18), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n123_), .c(new_n112_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n112_), .c(x10), .O(new_n128_));
  nor2   g084(.a(new_n116_), .b(new_n113_), .O(new_n129_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n106_), .O(new_n136_));
  oai21  g092(.a(new_n131_), .b(new_n127_), .c(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n129_), .b(x11), .O(new_n138_));
  ...
  nand2  g099(.a(new_n98_), .b(new_n91_), .O(new_n144_));
  inv1   g100(.a(x13), .O(new_n145_));
  nand2  g101(.a(x31), .b(x19), .O(new_n146_));
  aoi21  g102(.a(new_n116_), .b(new_n145_), .c(new_n146_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n144_), .c(new_n143_), .d(new_n139_), .O(new_n148_));
  ...
  nand2  g107(.a(new_n108_), .b(x28), .O(new_n152_));
  aoi21  g108(.a(x18), .b(x12), .c(x17), .O(new_n153_));
  nor2   g109(.a(new_n124_), .b(new_n112_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n129_), .c(new_n153_), .O(new_n155_));
  ...
  aoi21  g115(.a(new_n157_), .b(new_n137_), .c(new_n159_), .O(z8));
  inv1   g116(.a(x33), .O(new_n161_));
  nand3  g117(.a(x19), .b(new_n116_), .c(x13), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n115_), .c(new_n113_), .O(new_n163_));
  nand4  g119(.a(x19), .b(x18), .c(new_n113_), .d(x12), .O(new_n164_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n124_), .c(x11), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n166_), .c(new_n112_), .O(new_n170_));
  nor2   g126(.a(new_n167_), .b(new_n128_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n170_), .c(new_n161_), .O(new_n172_));
  nand2  g128(.a(new_n106_), .b(new_n98_), .O(new_n173_));
  oai22  g129(.a(new_n173_), .b(new_n172_), .c(new_n161_), .d(new_n106_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n134_), .O(new_n175_));
  inv1   g131(.a(new_n134_), .O(new_n176_));
  nand2  g132(.a(x31), .b(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n106_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n172_), .c(new_n178_), .O(new_n179_));
  nand4  g135(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n124_), .O(new_n181_));
  nand3  g137(.a(x19), .b(x18), .c(x12), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n113_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  aoi21  g140(.a(new_n168_), .b(new_n154_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n168_), .b(new_n141_), .c(x15), .O(new_n186_));
  nand2  g142(.a(new_n106_), .b(x30), .O(new_n187_));
  oai21  g143(.a(new_n114_), .b(new_n145_), .c(new_n116_), .O(new_n188_));
  nand2  g144(.a(x31), .b(new_n98_), .O(new_n189_));
  inv1   g145(.a(x14), .O(new_n190_));
  nand2  g146(.a(new_n114_), .b(new_n190_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n189_), .c(new_n188_), .d(new_n187_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n186_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n185_), .c(new_n161_), .O(new_n194_));
  aoi21  g150(.a(new_n179_), .b(new_n176_), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n175_), .c(new_n159_), .O(z9));
endmodule
