...
module FAU ( 
  ...
  and2   g037(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand2  g038(.a(x25), .b(x01), .O(new_n83_));
  nor4   g039(.a(new_n83_), .b(new_n82_), .c(x27), .d(x26), .O(z3));
  xor2a  g040(.a(x28), .b(x27), .O(new_n85_));
  nor2   g041(.a(new_n83_), .b(x26), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n82_), .O(z4));
  ...
  nor2   g049(.a(new_n93_), .b(new_n82_), .O(z5));
  ...
  nor2   g056(.a(new_n100_), .b(new_n82_), .O(z6));
  inv1   g057(.a(new_n76_), .O(new_n102_));
  inv1   g058(.a(new_n77_), .O(new_n103_));
  nand3  g059(.a(new_n81_), .b(new_n103_), .c(new_n102_), .O(new_n104_));
  inv1   g060(.a(x31), .O(new_n105_));
  nand3  g061(.a(new_n97_), .b(new_n105_), .c(x30), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nor2   g063(.a(new_n95_), .b(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n91_), .O(new_n109_));
  nand2  g065(.a(new_n86_), .b(new_n57_), .O(new_n110_));
  aoi21  g066(.a(new_n109_), .b(x31), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n106_), .c(new_n104_), .O(z7));
  inv1   g068(.a(x15), .O(new_n113_));
  inv1   g069(.a(x17), .O(new_n114_));
  nand3  g070(.a(x19), .b(new_n79_), .c(x13), .O(new_n115_));
  ...
  nand2  g084(.a(new_n90_), .b(new_n89_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n95_), .c(x29), .O(new_n130_));
  ...
  nor2   g091(.a(new_n122_), .b(new_n113_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n124_), .O(new_n137_));
  nor2   g093(.a(new_n116_), .b(new_n79_), .O(new_n138_));
  ...
  nand2  g097(.a(new_n141_), .b(new_n114_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n140_), .c(new_n137_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n123_), .c(new_n113_), .O(new_n145_));
  ...
  aoi21  g105(.a(new_n95_), .b(new_n107_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g115(.a(new_n105_), .b(new_n95_), .O(new_n160_));
  ...
  nand2  g124(.a(x31), .b(new_n95_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  nand2  g126(.a(new_n79_), .b(new_n170_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n169_), .c(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n116_), .b(x14), .O(new_n173_));
  nor2   g129(.a(new_n79_), .b(new_n114_), .O(new_n174_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n144_), .c(new_n113_), .O(new_n179_));
