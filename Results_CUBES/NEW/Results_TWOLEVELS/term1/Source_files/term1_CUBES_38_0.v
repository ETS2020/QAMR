...
module FAU ( 
  ...
  aoi21  g047(.a(x28), .b(x27), .c(x03), .O(new_n92_));
  inv1   g048(.a(x28), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n78_), .O(new_n94_));
  xor2a  g050(.a(new_n94_), .b(x29), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n50_), .c(new_n92_), .O(new_n96_));
  inv1   g052(.a(new_n82_), .O(new_n97_));
  nand2  g053(.a(new_n89_), .b(new_n97_), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n96_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x02), .c(x03), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n94_), .c(new_n100_), .O(new_n103_));
  nor2   g059(.a(new_n94_), .b(new_n57_), .O(new_n104_));
  nor2   g060(.a(x29), .b(x02), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n104_), .c(x30), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n103_), .c(new_n98_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand4  g064(.a(new_n94_), .b(new_n108_), .c(x30), .d(x29), .O(new_n109_));
  nor2   g065(.a(new_n100_), .b(new_n101_), .O(new_n110_));
  ...
  nand3  g069(.a(new_n113_), .b(new_n109_), .c(new_n97_), .O(z7));
  ...
  nand2  g087(.a(new_n93_), .b(new_n78_), .O(new_n132_));
  ...
  aoi21  g108(.a(new_n100_), .b(new_n101_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g113(.a(new_n77_), .b(x00), .O(new_n158_));
