...
module FAU ( 
  ...
  nand3  g039(.a(new_n58_), .b(new_n83_), .c(x27), .O(new_n84_));
  oai21  g040(.a(new_n83_), .b(x27), .c(new_n84_), .O(new_n85_));
  nor2   g041(.a(new_n81_), .b(x26), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n80_), .O(z4));
  inv1   g044(.a(new_n86_), .O(new_n89_));
  inv1   g045(.a(new_n80_), .O(new_n90_));
  nand2  g046(.a(x29), .b(new_n83_), .O(new_n91_));
  inv1   g047(.a(x29), .O(new_n92_));
  inv1   g048(.a(x27), .O(new_n93_));
  nor2   g049(.a(new_n83_), .b(new_n93_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n91_), .c(new_n57_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n90_), .O(new_n97_));
  nand3  g053(.a(new_n90_), .b(x29), .c(new_n93_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n89_), .O(z5));
  oai21  g055(.a(new_n92_), .b(new_n83_), .c(x30), .O(new_n100_));
  ...
  nand2  g060(.a(x30), .b(new_n93_), .O(new_n105_));
  nand2  g061(.a(new_n86_), .b(new_n90_), .O(new_n106_));
  aoi21  g062(.a(new_n105_), .b(new_n104_), .c(new_n106_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand4  g064(.a(new_n94_), .b(new_n108_), .c(x30), .d(x29), .O(new_n109_));
  nor2   g065(.a(new_n101_), .b(new_n92_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n94_), .c(new_n108_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n89_), .c(new_n57_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n109_), .c(new_n90_), .O(z7));
  ...
  nand2  g086(.a(new_n83_), .b(new_n93_), .O(new_n131_));
  ...
  aoi21  g107(.a(new_n101_), .b(new_n92_), .c(new_n151_), .O(new_n152_));
