// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:57 2020
...
module FAU ( 
  ...
  nand2  g073(.a(new_n117_), .b(x18), .O(new_n118_));
  ...
  nor2   g094(.a(new_n115_), .b(new_n114_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand3  g096(.a(new_n139_), .b(x16), .c(x10), .O(new_n141_));
  aoi22  g097(.a(new_n141_), .b(new_n113_), .c(new_n140_), .d(new_n117_), .O(new_n142_));
  nand2  g098(.a(new_n139_), .b(x11), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(new_n123_), .c(new_n138_), .d(new_n125_), .O(new_n144_));
  nand2  g100(.a(new_n98_), .b(new_n92_), .O(new_n145_));
  oai21  g101(.a(new_n108_), .b(new_n92_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n93_), .O(new_n147_));
  nand2  g103(.a(new_n98_), .b(new_n91_), .O(new_n148_));
  inv1   g104(.a(x13), .O(new_n149_));
  nand2  g105(.a(new_n115_), .b(new_n149_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n148_), .c(x31), .O(new_n151_));
  nand2  g107(.a(x18), .b(x12), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n114_), .O(new_n153_));
  oai21  g109(.a(new_n108_), .b(new_n93_), .c(new_n153_), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n147_), .c(new_n144_), .d(new_n142_), .O(new_n156_));
  aoi22  g112(.a(new_n156_), .b(x32), .c(new_n117_), .d(new_n137_), .O(new_n157_));
  ...
  nand3  g117(.a(new_n117_), .b(x18), .c(x14), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n116_), .c(new_n114_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n121_), .c(x16), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n126_), .c(new_n113_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n129_), .c(new_n161_), .O(new_n166_));
  nand2  g122(.a(new_n106_), .b(new_n98_), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(new_n166_), .c(new_n161_), .d(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n132_), .O(new_n169_));
  inv1   g125(.a(new_n132_), .O(new_n170_));
  nand2  g126(.a(x31), .b(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n106_), .O(new_n172_));
  ...
  nand4  g131(.a(new_n175_), .b(new_n153_), .c(new_n150_), .d(new_n174_), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  aoi21  g133(.a(new_n117_), .b(x14), .c(new_n140_), .O(new_n178_));
  aoi21  g134(.a(new_n143_), .b(new_n123_), .c(new_n178_), .O(new_n179_));
  and2   g135(.a(new_n179_), .b(new_n142_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n177_), .c(new_n161_), .O(new_n181_));
  aoi21  g137(.a(new_n173_), .b(new_n170_), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n169_), .c(new_n159_), .O(z9));
endmodule
