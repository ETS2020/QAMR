// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:46 2020
...
module FAU ( 
  ...
  nand3  g067(.a(x19), .b(new_n111_), .c(x12), .O(new_n112_));
  ...
  nand4  g071(.a(x19), .b(x17), .c(new_n110_), .d(x11), .O(new_n116_));
  ...
  nand3  g076(.a(x16), .b(new_n120_), .c(x10), .O(new_n121_));
  ...
  oai21  g084(.a(new_n91_), .b(new_n128_), .c(new_n92_), .O(new_n129_));
  nor2   g085(.a(new_n110_), .b(new_n120_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n129_), .c(new_n119_), .d(new_n125_), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n127_), .b(new_n124_), .c(new_n132_), .O(new_n133_));
  nand3  g089(.a(z0), .b(x31), .c(new_n97_), .O(new_n134_));
  nand2  g090(.a(new_n92_), .b(new_n91_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(x32), .c(x30), .O(new_n136_));
  oai21  g092(.a(new_n134_), .b(new_n133_), .c(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x29), .O(new_n138_));
  oai21  g094(.a(x28), .b(x27), .c(x29), .O(new_n139_));
  nand3  g095(.a(x19), .b(new_n125_), .c(x13), .O(new_n140_));
  nand3  g096(.a(new_n113_), .b(x18), .c(x14), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n140_), .c(new_n111_), .O(new_n142_));
  nand4  g098(.a(x19), .b(x18), .c(new_n111_), .d(x12), .O(new_n143_));
  ...
  nand3  g103(.a(new_n147_), .b(new_n110_), .c(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nor2   g105(.a(new_n146_), .b(new_n121_), .O(new_n150_));
  aoi21  g106(.a(new_n149_), .b(x15), .c(new_n150_), .O(new_n151_));
  nand3  g107(.a(z0), .b(x31), .c(x30), .O(new_n152_));
  nand2  g108(.a(x32), .b(new_n97_), .O(new_n153_));
  oai21  g109(.a(new_n152_), .b(new_n151_), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n146_), .c(new_n120_), .O(new_n156_));
  nand2  g112(.a(x19), .b(x18), .O(new_n157_));
  nand2  g113(.a(x17), .b(x11), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n110_), .O(new_n159_));
  oai21  g115(.a(new_n113_), .b(new_n128_), .c(new_n125_), .O(new_n160_));
  inv1   g116(.a(x14), .O(new_n161_));
  aoi21  g117(.a(new_n113_), .b(new_n161_), .c(new_n105_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n160_), .c(new_n159_), .O(new_n163_));
  inv1   g119(.a(x12), .O(new_n164_));
  oai21  g120(.a(new_n157_), .b(new_n164_), .c(new_n111_), .O(new_n165_));
  nand2  g121(.a(new_n147_), .b(new_n130_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n156_), .c(z0), .O(new_n169_));
  aoi21  g125(.a(new_n154_), .b(new_n139_), .c(new_n169_), .O(new_n170_));
  inv1   g126(.a(x26), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x00), .O(new_n172_));
  aoi21  g128(.a(new_n170_), .b(new_n138_), .c(new_n172_), .O(z8));
  nor2   g129(.a(x33), .b(new_n105_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(x30), .c(x18), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(new_n124_), .c(x33), .d(new_n105_), .O(new_n177_));
  nor2   g133(.a(new_n97_), .b(x18), .O(new_n178_));
  nand2  g134(.a(new_n130_), .b(new_n119_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n174_), .d(new_n129_), .O(new_n181_));
  oai21  g137(.a(new_n177_), .b(new_n126_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x29), .O(new_n183_));
  inv1   g139(.a(x33), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n105_), .c(new_n97_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n151_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n105_), .b(x30), .O(new_n188_));
  nand2  g144(.a(x31), .b(new_n97_), .O(new_n189_));
  oai21  g145(.a(new_n125_), .b(new_n164_), .c(new_n111_), .O(new_n190_));
  nand2  g146(.a(new_n125_), .b(new_n128_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n188_), .O(new_n192_));
  nand2  g148(.a(new_n113_), .b(x14), .O(new_n193_));
  nor2   g149(.a(new_n125_), .b(new_n111_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n193_), .c(new_n130_), .O(new_n195_));
  nand2  g151(.a(new_n194_), .b(new_n130_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n113_), .O(new_n197_));
  inv1   g153(.a(new_n194_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n155_), .c(new_n120_), .O(new_n199_));
  nand2  g155(.a(new_n194_), .b(x11), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n110_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n199_), .c(new_n197_), .d(new_n195_), .O(new_n202_));
  nor2   g158(.a(new_n202_), .b(new_n192_), .O(new_n203_));
  nor2   g159(.a(new_n203_), .b(new_n184_), .O(new_n204_));
  aoi21  g160(.a(new_n187_), .b(new_n139_), .c(new_n204_), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n183_), .c(new_n172_), .O(z9));
endmodule
