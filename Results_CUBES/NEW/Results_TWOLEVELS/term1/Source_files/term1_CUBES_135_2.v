// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:20 2020
...
module FAU ( 
  ...
  oai21  g079(.a(new_n123_), .b(new_n116_), .c(x17), .O(new_n124_));
  nand2  g080(.a(new_n120_), .b(new_n118_), .O(new_n125_));
  nor2   g081(.a(new_n121_), .b(new_n114_), .O(new_n126_));
  inv1   g082(.a(x12), .O(new_n127_));
  nor2   g083(.a(x17), .b(new_n127_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n126_), .c(new_n125_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n124_), .c(new_n112_), .O(new_n130_));
  inv1   g086(.a(x11), .O(new_n131_));
  nor2   g087(.a(x16), .b(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n126_), .c(new_n125_), .d(x17), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n130_), .c(x15), .O(new_n135_));
  inv1   g091(.a(x15), .O(new_n136_));
  nand3  g092(.a(x16), .b(new_n136_), .c(x10), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n126_), .c(new_n125_), .d(x17), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nor2   g096(.a(x32), .b(new_n106_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nor2   g098(.a(new_n112_), .b(new_n136_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n126_), .c(x17), .O(new_n144_));
  nand3  g100(.a(new_n126_), .b(x17), .c(x11), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n112_), .O(new_n146_));
  inv1   g102(.a(x17), .O(new_n147_));
  nand2  g103(.a(new_n126_), .b(x12), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n146_), .c(new_n144_), .O(new_n150_));
  nand2  g106(.a(new_n126_), .b(x17), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n136_), .O(new_n153_));
  ...
  aoi21  g120(.a(new_n162_), .b(new_n142_), .c(new_n164_), .O(z8));
  ...
  oai21  g129(.a(new_n173_), .b(new_n169_), .c(x17), .O(new_n174_));
  nand2  g130(.a(new_n172_), .b(new_n171_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n128_), .c(new_n126_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n174_), .c(new_n112_), .O(new_n177_));
  nand4  g133(.a(new_n175_), .b(new_n132_), .c(new_n126_), .d(x17), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(x15), .O(new_n180_));
  nand4  g136(.a(new_n175_), .b(new_n138_), .c(new_n126_), .d(x17), .O(new_n181_));
  ...
  nor2   g141(.a(new_n114_), .b(new_n147_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n143_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n121_), .O(new_n188_));
  inv1   g144(.a(new_n186_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n152_), .c(new_n136_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n131_), .c(new_n112_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n188_), .d(new_n185_), .O(new_n192_));
  nand2  g148(.a(new_n119_), .b(new_n100_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n106_), .O(new_n194_));
  nand2  g150(.a(new_n121_), .b(x14), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n186_), .c(new_n143_), .O(new_n196_));
