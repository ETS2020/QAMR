...
module FAU ( 
  ...
  nand2  g011(.a(x06), .b(x02), .O(new_n56_));
  inv1   g012(.a(x06), .O(new_n57_));
  nand2  g013(.a(new_n57_), .b(new_n47_), .O(new_n58_));
  inv1   g014(.a(x01), .O(new_n59_));
  nand2  g015(.a(x05), .b(new_n59_), .O(new_n60_));
  aoi21  g016(.a(new_n58_), .b(new_n56_), .c(new_n60_), .O(new_n61_));
  ...
  nand3  g021(.a(x06), .b(new_n65_), .c(new_n50_), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n61_), .c(new_n55_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  nand3  g025(.a(x06), .b(x05), .c(new_n59_), .O(new_n70_));
  aoi21  g026(.a(new_n70_), .b(new_n47_), .c(x02), .O(new_n71_));
  nor2   g027(.a(x03), .b(new_n59_), .O(new_n72_));
  nor2   g028(.a(x05), .b(x01), .O(new_n73_));
  oai21  g029(.a(new_n73_), .b(new_n72_), .c(x02), .O(new_n74_));
  nor2   g030(.a(x06), .b(x05), .O(new_n75_));
  oai21  g031(.a(new_n75_), .b(x03), .c(new_n59_), .O(new_n76_));
  nand2  g032(.a(new_n76_), .b(new_n74_), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(new_n71_), .c(new_n69_), .O(new_n78_));
  inv1   g034(.a(x09), .O(new_n79_));
  nand2  g035(.a(new_n79_), .b(x08), .O(new_n80_));
  aoi21  g036(.a(new_n78_), .b(new_n68_), .c(new_n80_), .O(z2));
  inv1   g037(.a(new_n62_), .O(new_n82_));
