// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:06 2020
...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n91_), .c(x30), .O(new_n99_));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(x29), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n98_), .c(new_n99_), .O(new_n102_));
  ...
  nor2   g062(.a(new_n100_), .b(new_n91_), .O(new_n107_));
  ...
  nand2  g068(.a(x30), .b(new_n91_), .O(new_n113_));
  inv1   g069(.a(x15), .O(new_n114_));
  nand3  g070(.a(x19), .b(new_n114_), .c(x10), .O(new_n115_));
  aoi21  g071(.a(new_n113_), .b(new_n101_), .c(new_n115_), .O(new_n116_));
  nand2  g072(.a(new_n93_), .b(new_n92_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n100_), .c(x29), .O(new_n118_));
  oai21  g074(.a(x28), .b(x27), .c(x29), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x30), .O(new_n120_));
  inv1   g076(.a(x19), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x15), .c(x14), .O(new_n122_));
  aoi21  g078(.a(new_n120_), .b(new_n118_), .c(new_n122_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n116_), .c(x18), .O(new_n124_));
  nand2  g080(.a(new_n120_), .b(new_n118_), .O(new_n125_));
  inv1   g081(.a(x13), .O(new_n126_));
  nor3   g082(.a(x18), .b(new_n114_), .c(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(x19), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n124_), .c(new_n112_), .O(new_n129_));
  nand2  g085(.a(x15), .b(x12), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(x17), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n125_), .c(x19), .d(x18), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n129_), .c(x16), .O(new_n134_));
  inv1   g090(.a(x16), .O(new_n135_));
  nand4  g091(.a(x17), .b(new_n135_), .c(x15), .d(x11), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n125_), .c(x19), .d(x18), .O(new_n138_));
  ...
  nor2   g098(.a(new_n121_), .b(new_n142_), .O(new_n143_));
  nor2   g099(.a(new_n135_), .b(new_n114_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n143_), .c(x17), .O(new_n145_));
  nand3  g101(.a(new_n143_), .b(x17), .c(x11), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n135_), .O(new_n147_));
  nand2  g103(.a(new_n143_), .b(x12), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n147_), .c(new_n145_), .O(new_n150_));
  nand2  g106(.a(new_n143_), .b(x17), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(new_n114_), .O(new_n153_));
  nand2  g109(.a(new_n107_), .b(x27), .O(new_n154_));
  oai21  g110(.a(x30), .b(x27), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n93_), .O(new_n156_));
  oai21  g112(.a(x19), .b(x14), .c(x31), .O(new_n157_));
  aoi21  g113(.a(new_n100_), .b(new_n91_), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(x19), .b(x13), .c(x18), .O(new_n159_));
  aoi21  g115(.a(new_n107_), .b(x28), .c(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n158_), .c(new_n156_), .d(new_n153_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n150_), .c(x32), .O(new_n162_));
  inv1   g118(.a(x26), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x00), .O(new_n164_));
  aoi21  g120(.a(new_n162_), .b(new_n141_), .c(new_n164_), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand3  g122(.a(x31), .b(x30), .c(x29), .O(new_n167_));
  nand3  g123(.a(new_n106_), .b(new_n100_), .c(new_n91_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n115_), .O(new_n169_));
  inv1   g125(.a(new_n167_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n117_), .O(new_n171_));
  nand3  g127(.a(new_n119_), .b(new_n106_), .c(new_n100_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(new_n122_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n169_), .c(x18), .O(new_n174_));
  nand2  g130(.a(new_n172_), .b(new_n171_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n127_), .c(x19), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n174_), .c(new_n112_), .O(new_n177_));
  nand4  g133(.a(new_n175_), .b(new_n131_), .c(x19), .d(x18), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(x16), .O(new_n180_));
  nand4  g136(.a(new_n175_), .b(new_n137_), .c(x19), .d(x18), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n166_), .O(new_n183_));
  nand2  g139(.a(new_n117_), .b(new_n107_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x31), .O(new_n185_));
  nor2   g141(.a(new_n142_), .b(new_n112_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n144_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n121_), .O(new_n188_));
  inv1   g144(.a(new_n186_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n152_), .c(new_n114_), .O(new_n190_));
  nand2  g146(.a(new_n186_), .b(x11), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n135_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n190_), .c(new_n188_), .d(new_n185_), .O(new_n193_));
  nand2  g149(.a(new_n119_), .b(new_n100_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n106_), .O(new_n195_));
  nand2  g151(.a(new_n121_), .b(x14), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n186_), .c(new_n144_), .O(new_n197_));
  nand2  g153(.a(x18), .b(x12), .O(new_n198_));
  aoi22  g154(.a(new_n198_), .b(new_n112_), .c(new_n142_), .d(new_n126_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n197_), .c(new_n195_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n193_), .c(x33), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n183_), .c(new_n164_), .O(z9));
endmodule
