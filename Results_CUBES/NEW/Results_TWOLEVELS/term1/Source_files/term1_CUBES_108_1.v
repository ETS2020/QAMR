...
module FAU ( 
  ...
  nor2   g091(.a(new_n114_), .b(new_n113_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n116_), .O(new_n138_));
  nand3  g094(.a(new_n136_), .b(x16), .c(x10), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n112_), .O(new_n140_));
  nand2  g096(.a(new_n136_), .b(x11), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n122_), .O(new_n142_));
  nand3  g098(.a(new_n124_), .b(x16), .c(x15), .O(new_n143_));
  ...
  nand2  g123(.a(new_n140_), .b(new_n138_), .O(new_n168_));
  nand2  g124(.a(new_n106_), .b(x30), .O(new_n169_));
  inv1   g125(.a(new_n152_), .O(new_n170_));
  nand2  g126(.a(x31), .b(new_n98_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n170_), .c(new_n149_), .d(new_n169_), .O(new_n172_));
  inv1   g128(.a(x14), .O(new_n173_));
  nor2   g129(.a(x19), .b(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n137_), .c(new_n142_), .O(new_n175_));
  nor3   g131(.a(new_n175_), .b(new_n172_), .c(new_n168_), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n159_), .O(new_n177_));
  aoi21  g133(.a(new_n167_), .b(new_n164_), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n163_), .c(new_n157_), .O(z9));
endmodule
