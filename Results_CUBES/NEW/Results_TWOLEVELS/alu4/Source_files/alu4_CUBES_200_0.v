// Benchmark "FAU" written by ABC on Tue Jul  7 08:28:37 2020
...
module FAU ( 
  ...
  aoi21  g353(.a(new_n232_), .b(new_n65_), .c(x03), .O(new_n376_));
  inv1   g354(.a(new_n376_), .O(new_n377_));
  aoi21  g355(.a(new_n377_), .b(x12), .c(x10), .O(new_n378_));
  nand3  g356(.a(new_n349_), .b(x04), .c(x03), .O(new_n379_));
  inv1   g357(.a(new_n379_), .O(new_n380_));
  nor2   g358(.a(x13), .b(x02), .O(new_n381_));
  oai21  g359(.a(new_n380_), .b(new_n378_), .c(new_n381_), .O(new_n382_));
  nor2   g360(.a(new_n28_), .b(new_n48_), .O(new_n383_));
  nand2  g361(.a(new_n383_), .b(new_n256_), .O(new_n384_));
  aoi21  g362(.a(new_n384_), .b(new_n382_), .c(x06), .O(new_n385_));
  nand2  g363(.a(new_n346_), .b(x04), .O(new_n386_));
  nor2   g364(.a(new_n77_), .b(x03), .O(new_n387_));
  oai21  g365(.a(new_n387_), .b(new_n48_), .c(new_n37_), .O(new_n388_));
  aoi21  g366(.a(new_n388_), .b(new_n386_), .c(new_n32_), .O(new_n389_));
  nand3  g367(.a(new_n79_), .b(new_n76_), .c(new_n58_), .O(new_n390_));
  aoi21  g368(.a(new_n390_), .b(new_n65_), .c(x10), .O(new_n391_));
  nor2   g369(.a(x13), .b(x09), .O(new_n392_));
  oai21  g370(.a(new_n391_), .b(new_n389_), .c(new_n392_), .O(new_n393_));
  nand2  g371(.a(new_n262_), .b(new_n65_), .O(new_n394_));
  nand2  g372(.a(new_n394_), .b(new_n49_), .O(new_n395_));
  nand2  g373(.a(new_n395_), .b(new_n36_), .O(new_n396_));
  nor2   g374(.a(new_n156_), .b(new_n48_), .O(new_n397_));
  nor2   g375(.a(new_n238_), .b(new_n58_), .O(new_n398_));
  oai21  g376(.a(new_n398_), .b(new_n301_), .c(x06), .O(new_n399_));
  nand2  g377(.a(x10), .b(x03), .O(new_n400_));
  aoi21  g378(.a(new_n400_), .b(new_n399_), .c(new_n37_), .O(new_n401_));
  oai21  g379(.a(new_n401_), .b(new_n397_), .c(x09), .O(new_n402_));
  nand3  g380(.a(new_n402_), .b(new_n396_), .c(new_n393_), .O(new_n403_));
  oai21  g381(.a(new_n403_), .b(new_n385_), .c(x01), .O(new_n404_));
  nand3  g382(.a(new_n322_), .b(new_n304_), .c(new_n49_), .O(new_n405_));
  nand2  g383(.a(new_n405_), .b(new_n76_), .O(new_n406_));
  nand2  g384(.a(new_n140_), .b(new_n58_), .O(new_n407_));
  aoi21  g385(.a(new_n407_), .b(new_n233_), .c(x09), .O(new_n408_));
  oai21  g386(.a(new_n408_), .b(new_n228_), .c(new_n328_), .O(new_n409_));
  aoi21  g387(.a(new_n409_), .b(new_n406_), .c(x06), .O(new_n410_));
  nand3  g388(.a(new_n287_), .b(x03), .c(x02), .O(new_n411_));
  aoi21  g389(.a(new_n411_), .b(new_n49_), .c(x12), .O(new_n412_));
  nand2  g390(.a(new_n73_), .b(x04), .O(new_n413_));
  nand2  g391(.a(new_n381_), .b(x12), .O(new_n414_));
  aoi21  g392(.a(new_n413_), .b(new_n377_), .c(new_n414_), .O(new_n415_));
  oai21  g393(.a(new_n415_), .b(new_n412_), .c(x06), .O(new_n416_));
  inv1   g394(.a(new_n333_), .O(new_n417_));
  nand3  g395(.a(new_n198_), .b(new_n112_), .c(new_n65_), .O(new_n418_));
  nand2  g396(.a(new_n49_), .b(x12), .O(new_n419_));
  inv1   g397(.a(new_n419_), .O(new_n420_));
  nand2  g398(.a(new_n420_), .b(x04), .O(new_n421_));
  oai21  g399(.a(new_n421_), .b(new_n417_), .c(new_n418_), .O(new_n422_));
  aoi21  g400(.a(new_n422_), .b(x11), .c(new_n340_), .O(new_n423_));
  nand2  g401(.a(new_n423_), .b(new_n416_), .O(new_n424_));
  oai21  g402(.a(new_n424_), .b(new_n410_), .c(new_n141_), .O(new_n425_));
  inv1   g403(.a(new_n287_), .O(new_n426_));
  nor2   g404(.a(new_n376_), .b(new_n426_), .O(new_n427_));
  nand2  g405(.a(new_n146_), .b(new_n49_), .O(new_n428_));
  nand2  g406(.a(new_n302_), .b(new_n346_), .O(new_n429_));
  nand3  g407(.a(new_n429_), .b(new_n34_), .c(new_n76_), .O(new_n430_));
  oai21  g408(.a(new_n428_), .b(new_n427_), .c(new_n430_), .O(new_n431_));
  nand2  g409(.a(new_n32_), .b(x03), .O(new_n432_));
  nand2  g410(.a(new_n42_), .b(new_n60_), .O(new_n433_));
  oai22  g411(.a(new_n433_), .b(new_n432_), .c(new_n362_), .d(new_n32_), .O(new_n434_));
  nand2  g412(.a(new_n434_), .b(x02), .O(new_n435_));
  oai21  g413(.a(x08), .b(x02), .c(x09), .O(new_n436_));
  aoi22  g414(.a(new_n436_), .b(x04), .c(new_n136_), .d(new_n110_), .O(new_n437_));
  nand2  g415(.a(new_n328_), .b(new_n156_), .O(new_n438_));
  oai21  g416(.a(new_n438_), .b(new_n437_), .c(new_n435_), .O(new_n439_));
  aoi21  g417(.a(new_n431_), .b(x12), .c(new_n439_), .O(new_n440_));
  nand3  g418(.a(new_n440_), .b(new_n425_), .c(new_n404_), .O(z5));
  nand2  g419(.a(new_n400_), .b(x02), .O(new_n442_));
  aoi21  g420(.a(new_n442_), .b(new_n79_), .c(x09), .O(new_n443_));
  inv1   g421(.a(new_n312_), .O(new_n444_));
  nor3   g422(.a(new_n444_), .b(new_n37_), .c(x02), .O(new_n445_));
  oai21  g423(.a(new_n445_), .b(new_n443_), .c(x04), .O(new_n446_));
  nor3   g424(.a(new_n69_), .b(x09), .c(x03), .O(new_n447_));
  nand3  g425(.a(new_n301_), .b(x12), .c(x09), .O(new_n448_));
  inv1   g426(.a(new_n448_), .O(new_n449_));
  oai21  g427(.a(new_n449_), .b(new_n447_), .c(x02), .O(new_n450_));
  nand4  g428(.a(new_n333_), .b(x12), .c(new_n76_), .d(new_n60_), .O(new_n451_));
  nand3  g429(.a(new_n451_), .b(new_n450_), .c(new_n446_), .O(new_n452_));
  nand2  g430(.a(new_n452_), .b(new_n49_), .O(new_n453_));
  oai22  g431(.a(new_n233_), .b(x13), .c(new_n28_), .d(new_n24_), .O(new_n454_));
  nand2  g432(.a(new_n454_), .b(x02), .O(new_n455_));
  oai21  g433(.a(new_n61_), .b(x02), .c(new_n59_), .O(new_n456_));
  nor2   g434(.a(x13), .b(x12), .O(new_n457_));
  nand2  g435(.a(new_n457_), .b(new_n456_), .O(new_n458_));
  aoi21  g436(.a(new_n458_), .b(new_n455_), .c(new_n58_), .O(new_n459_));
  nor2   g437(.a(new_n303_), .b(new_n228_), .O(new_n460_));
  nor3   g438(.a(new_n387_), .b(x13), .c(x04), .O(new_n461_));
  aoi21  g439(.a(x13), .b(x07), .c(new_n461_), .O(new_n462_));
  nor2   g440(.a(x11), .b(x02), .O(new_n463_));
  oai21  g441(.a(new_n463_), .b(new_n383_), .c(new_n83_), .O(new_n464_));
  oai21  g442(.a(new_n462_), .b(new_n460_), .c(new_n464_), .O(new_n465_));
  nor2   g443(.a(new_n465_), .b(new_n459_), .O(new_n466_));
  nand2  g444(.a(new_n466_), .b(new_n453_), .O(z6));
  inv1   g445(.a(new_n392_), .O(new_n468_));
  ...
  oai21  g557(.a(new_n579_), .b(new_n419_), .c(new_n578_), .O(new_n580_));
  nand2  g558(.a(new_n580_), .b(x01), .O(new_n581_));
  nand3  g559(.a(x06), .b(x05), .c(new_n65_), .O(new_n582_));
  oai21  g560(.a(new_n582_), .b(new_n419_), .c(new_n489_), .O(new_n583_));
  ...
  oai22  g570(.a(new_n592_), .b(new_n586_), .c(new_n419_), .d(new_n591_), .O(new_n593_));
  ...
  nand4  g574(.a(new_n457_), .b(new_n55_), .c(x11), .d(new_n65_), .O(new_n597_));
  oai21  g575(.a(new_n597_), .b(new_n596_), .c(new_n595_), .O(new_n598_));
  nand2  g576(.a(new_n420_), .b(x11), .O(new_n599_));
  ...
  nand3  g581(.a(new_n420_), .b(new_n215_), .c(new_n177_), .O(new_n604_));
  ...
  oai21  g608(.a(new_n586_), .b(new_n83_), .c(new_n421_), .O(new_n631_));
  ...
  oai21  g652(.a(x08), .b(new_n141_), .c(new_n432_), .O(new_n675_));
