...
module FAU ( 
  ...
  nor4   g19(.a(new_n44_), .b(new_n34_), .c(x01), .d(new_n37_), .O(z03));
  nor3   g20(.a(new_n40_), .b(new_n38_), .c(x00), .O(z04));
  nor4   g21(.a(new_n44_), .b(new_n34_), .c(new_n38_), .d(new_n37_), .O(z05));
  ...
  nand2  g26(.a(x05), .b(x00), .O(new_n52_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g39(.a(new_n64_), .b(new_n28_), .c(x02), .O(new_n65_));
  nand2  g40(.a(x04), .b(new_n26_), .O(new_n66_));
  aoi21  g41(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(z06));
  aoi21  g42(.a(new_n28_), .b(x00), .c(new_n40_), .O(z07));
  nand4  g43(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n65_), .c(new_n66_), .O(z08));
