// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:39 2020
...
module FAU ( 
  ...
  nand2  g11(.a(new_n31_), .b(new_n27_), .O(new_n37_));
  ...
  nor3   g25(.a(x08), .b(x01), .c(x00), .O(new_n51_));
  nand2  g26(.a(x05), .b(new_n27_), .O(new_n52_));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  nand3  g29(.a(x13), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  oai21  g31(.a(new_n51_), .b(new_n50_), .c(new_n56_), .O(new_n57_));
  nand3  g32(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n58_));
  nand2  g33(.a(x04), .b(new_n26_), .O(new_n59_));
  aoi21  g34(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z06));
  nor2   g35(.a(new_n39_), .b(new_n37_), .O(z07));
  nand4  g36(.a(x13), .b(new_n54_), .c(x05), .d(new_n27_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n58_), .c(new_n59_), .O(z08));
