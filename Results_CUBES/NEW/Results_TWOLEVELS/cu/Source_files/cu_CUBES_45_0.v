// Benchmark "FAU" written by ABC on Mon Jul  6 13:05:59 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n42_, new_n45_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
  ...
  nand3  g14(.a(new_n39_), .b(new_n27_), .c(new_n31_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(new_n41_));
  nand3  g16(.a(new_n41_), .b(new_n38_), .c(new_n37_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z02));
  nor3   g18(.a(new_n40_), .b(x01), .c(new_n37_), .O(z03));
  inv1   g19(.a(new_n39_), .O(new_n45_));
  nor4   g20(.a(new_n45_), .b(new_n34_), .c(new_n38_), .d(x00), .O(z04));
  nor4   g21(.a(new_n45_), .b(new_n34_), .c(new_n38_), .d(new_n37_), .O(z05));
  ...
  aoi21  g26(.a(new_n51_), .b(new_n49_), .c(new_n37_), .O(new_n52_));
  ...
  nand4  g34(.a(x13), .b(new_n59_), .c(new_n58_), .d(new_n31_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(new_n61_));
  oai21  g36(.a(new_n57_), .b(new_n52_), .c(new_n61_), .O(new_n62_));
  inv1   g37(.a(x13), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n26_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(z06));
  aoi21  g41(.a(new_n28_), .b(x01), .c(new_n40_), .O(z07));
  nand4  g42(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n68_));
