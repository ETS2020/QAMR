...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n65_, new_n66_, new_n67_, new_n70_,
    new_n71_;
  ...
  nand4  g36(.a(new_n38_), .b(new_n28_), .c(x04), .d(x02), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n61_), .c(x03), .O(z06));
  nor2   g38(.a(new_n39_), .b(new_n37_), .O(z07));
  nand4  g39(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n65_));
  nand3  g40(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n66_));
  nand2  g41(.a(x04), .b(new_n26_), .O(new_n67_));
  aoi21  g42(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(z08));
