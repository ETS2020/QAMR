...
module FAU ( 
  ...
  inv1   g175(.a(new_n227_), .O(new_n327_));
  nor2   g176(.a(new_n323_), .b(new_n327_), .O(new_n328_));
  nand2  g177(.a(new_n328_), .b(x68), .O(new_n329_));
  nor2   g178(.a(x77), .b(x52), .O(new_n330_));
  nand4  g179(.a(new_n330_), .b(new_n172_), .c(x08), .d(x04), .O(new_n331_));
  aoi21  g180(.a(new_n331_), .b(new_n329_), .c(x01), .O(z48));
  ...
  nand2  g185(.a(new_n328_), .b(x69), .O(new_n337_));
  ...
  nand2  g191(.a(new_n328_), .b(x70), .O(new_n343_));
  ...
  nand2  g197(.a(new_n328_), .b(x71), .O(new_n349_));
  ...
  nand2  g203(.a(new_n328_), .b(x72), .O(new_n355_));
  ...
  nand2  g209(.a(new_n328_), .b(x73), .O(new_n361_));
