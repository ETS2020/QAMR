// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:30 2020
...
module FAU ( 
  ...
  inv1   g180(.a(new_n233_), .O(new_n332_));
  nor2   g181(.a(new_n328_), .b(new_n332_), .O(new_n333_));
  nand2  g182(.a(new_n333_), .b(x68), .O(new_n334_));
  nor2   g183(.a(x77), .b(new_n292_), .O(new_n335_));
  nand4  g184(.a(new_n335_), .b(new_n175_), .c(x16), .d(x04), .O(new_n336_));
  aoi21  g185(.a(new_n336_), .b(new_n334_), .c(x01), .O(z48));
  inv1   g186(.a(x09), .O(new_n338_));
  nand2  g187(.a(x52), .b(x17), .O(new_n339_));
  oai21  g188(.a(x52), .b(new_n338_), .c(new_n339_), .O(new_n340_));
  nand2  g189(.a(new_n340_), .b(new_n324_), .O(new_n341_));
  nand2  g190(.a(new_n333_), .b(x69), .O(new_n342_));
  ...
  nand2  g195(.a(new_n346_), .b(new_n324_), .O(new_n347_));
  nand2  g196(.a(new_n333_), .b(x70), .O(new_n348_));
  ...
  nand2  g201(.a(new_n352_), .b(new_n324_), .O(new_n353_));
  nand2  g202(.a(new_n333_), .b(x71), .O(new_n354_));
  ...
  nand2  g207(.a(new_n358_), .b(new_n324_), .O(new_n359_));
  nand2  g208(.a(new_n333_), .b(x72), .O(new_n360_));
  ...
  nand2  g213(.a(new_n364_), .b(new_n324_), .O(new_n365_));
  nand2  g214(.a(new_n333_), .b(x73), .O(new_n366_));
  aoi21  g215(.a(new_n366_), .b(new_n365_), .c(x01), .O(z53));
  nand2  g216(.a(x52), .b(x22), .O(new_n368_));
  nand2  g217(.a(new_n292_), .b(x14), .O(new_n369_));
  inv1   g218(.a(new_n170_), .O(new_n370_));
  ...
  nand3  g222(.a(new_n279_), .b(x84), .c(new_n373_), .O(new_n374_));
  inv1   g223(.a(x80), .O(new_n375_));
  nand4  g224(.a(new_n251_), .b(new_n165_), .c(new_n375_), .d(x79), .O(new_n376_));
  nor2   g225(.a(new_n376_), .b(new_n374_), .O(z55));
  nand2  g226(.a(new_n249_), .b(x76), .O(new_n378_));
  ...
  nand2  g234(.a(new_n385_), .b(new_n383_), .O(z56));
  inv1   g235(.a(x02), .O(new_n387_));
  nand3  g236(.a(new_n247_), .b(x03), .c(new_n387_), .O(new_n388_));
  inv1   g237(.a(new_n388_), .O(z57));
  nand4  g238(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n390_));
  oai22  g239(.a(new_n390_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n391_));
  nand3  g240(.a(new_n391_), .b(new_n236_), .c(x79), .O(new_n392_));
  nand3  g241(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(new_n392_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(x77), .O(new_n395_));
  oai21  g244(.a(new_n370_), .b(new_n160_), .c(new_n154_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(new_n395_), .c(x01), .O(z58));
  aoi21  g246(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n398_));
  oai21  g247(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(x79), .c(new_n163_), .O(new_n400_));
  ...
  aoi21  g253(.a(new_n380_), .b(x79), .c(new_n402_), .O(new_n405_));
  aoi21  g254(.a(new_n405_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g255(.a(new_n173_), .O(new_n407_));
  nand2  g256(.a(new_n171_), .b(new_n170_), .O(new_n408_));
  aoi22  g257(.a(new_n408_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n409_));
  nor3   g258(.a(new_n409_), .b(new_n407_), .c(new_n375_), .O(z61));
  nand3  g259(.a(x84), .b(x81), .c(x79), .O(new_n411_));
  oai21  g260(.a(x79), .b(new_n160_), .c(new_n411_), .O(new_n412_));
  nand2  g261(.a(new_n412_), .b(new_n159_), .O(new_n413_));
  nand2  g262(.a(new_n399_), .b(x79), .O(new_n414_));
  nand3  g263(.a(x81), .b(x79), .c(new_n160_), .O(new_n415_));
  ...
  nand2  g269(.a(new_n420_), .b(new_n327_), .O(new_n421_));
  aoi21  g270(.a(new_n421_), .b(new_n419_), .c(x01), .O(z62));
  nor3   g271(.a(new_n409_), .b(new_n407_), .c(new_n373_), .O(z63));
  nand2  g272(.a(x83), .b(x79), .O(new_n424_));
  or2    g273(.a(new_n424_), .b(new_n409_), .O(new_n425_));
  nand3  g274(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n426_));
  aoi21  g275(.a(new_n426_), .b(new_n425_), .c(x01), .O(z64));
  nor2   g276(.a(new_n164_), .b(x04), .O(new_n428_));
  nor2   g277(.a(new_n258_), .b(x78), .O(new_n429_));
  oai21  g278(.a(new_n429_), .b(new_n428_), .c(x77), .O(new_n430_));
  nand2  g279(.a(new_n370_), .b(x81), .O(new_n431_));
  nand2  g280(.a(new_n173_), .b(x84), .O(new_n432_));
