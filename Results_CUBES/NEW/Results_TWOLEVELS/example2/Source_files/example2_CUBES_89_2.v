...
module FAU ( 
  ...
  nand2  g228(.a(new_n171_), .b(new_n170_), .O(new_n380_));
  xor2a  g229(.a(x84), .b(x81), .O(new_n381_));
  nand3  g230(.a(new_n381_), .b(new_n380_), .c(x79), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(new_n383_));
  aoi21  g232(.a(new_n164_), .b(new_n159_), .c(new_n383_), .O(new_n384_));
  nand2  g233(.a(new_n249_), .b(x76), .O(new_n385_));
  nand4  g234(.a(new_n385_), .b(new_n384_), .c(new_n153_), .d(x00), .O(z56));
  ...
  oai21  g244(.a(new_n372_), .b(new_n160_), .c(new_n154_), .O(new_n396_));
  ...
  and2   g252(.a(new_n402_), .b(new_n382_), .O(new_n404_));
  aoi21  g253(.a(new_n404_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g254(.a(new_n173_), .O(new_n406_));
  aoi22  g255(.a(new_n380_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n407_));
  nor3   g256(.a(new_n407_), .b(new_n406_), .c(new_n377_), .O(z61));
  ...
  nand2  g260(.a(new_n399_), .b(x79), .O(new_n412_));
  ...
  nand2  g267(.a(new_n418_), .b(new_n327_), .O(new_n419_));
  aoi21  g268(.a(new_n419_), .b(new_n417_), .c(x01), .O(z62));
  nor3   g269(.a(new_n407_), .b(new_n406_), .c(new_n375_), .O(z63));
  ...
  nand2  g277(.a(new_n372_), .b(x81), .O(new_n429_));
