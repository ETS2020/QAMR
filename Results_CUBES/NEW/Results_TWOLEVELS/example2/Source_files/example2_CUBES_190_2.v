// Benchmark "FAU" written by ABC on Mon Jul  6 20:04:56 2020
...
module FAU ( 
  ...
  oai21  g171(.a(new_n154_), .b(new_n166_), .c(new_n322_), .O(new_n323_));
  nand3  g172(.a(new_n323_), .b(new_n226_), .c(new_n321_), .O(new_n324_));
  ...
  nand2  g178(.a(new_n321_), .b(x79), .O(new_n330_));
