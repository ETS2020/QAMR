...
module FAU ( 
  ...
  nand2  g267(.a(new_n154_), .b(x04), .O(new_n420_));
  nand3  g268(.a(x84), .b(x81), .c(x79), .O(new_n421_));
  aoi21  g269(.a(new_n421_), .b(new_n420_), .c(x77), .O(new_n422_));
  nand2  g270(.a(x79), .b(x42), .O(new_n423_));
  nand2  g271(.a(new_n423_), .b(x04), .O(new_n424_));
  nand3  g272(.a(x81), .b(x79), .c(new_n160_), .O(new_n425_));
  aoi21  g273(.a(new_n425_), .b(new_n424_), .c(new_n159_), .O(new_n426_));
  oai21  g274(.a(new_n426_), .b(new_n422_), .c(x78), .O(new_n427_));
  inv1   g275(.a(new_n421_), .O(new_n428_));
  nand2  g276(.a(new_n428_), .b(new_n342_), .O(new_n429_));
  aoi21  g277(.a(new_n429_), .b(new_n427_), .c(x01), .O(z62));
  xnor2a g278(.a(x78), .b(x77), .O(new_n431_));
  oai22  g279(.a(new_n431_), .b(new_n233_), .c(new_n164_), .d(x04), .O(new_n432_));
  nand2  g280(.a(new_n174_), .b(x82), .O(new_n433_));
  inv1   g281(.a(new_n433_), .O(new_n434_));
  and2   g282(.a(new_n434_), .b(new_n432_), .O(z63));
  nand3  g283(.a(new_n432_), .b(x83), .c(x79), .O(new_n436_));
  nand3  g284(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n437_));
  aoi21  g285(.a(new_n437_), .b(new_n436_), .c(x01), .O(z64));
  nor2   g286(.a(new_n171_), .b(x04), .O(new_n439_));
  nor2   g287(.a(new_n249_), .b(x78), .O(new_n440_));
  oai21  g288(.a(new_n440_), .b(new_n439_), .c(x77), .O(new_n441_));
  nand2  g289(.a(new_n386_), .b(x81), .O(new_n442_));
  nand2  g290(.a(new_n174_), .b(x84), .O(new_n443_));
  aoi21  g291(.a(new_n442_), .b(new_n441_), .c(new_n443_), .O(z65));
  zero   g292(.O(z61));
endmodule
