// Benchmark "FAU" written by ABC on Mon Jul  6 20:04:29 2020
...
module FAU ( 
  ...
  aoi21  g090(.a(new_n161_), .b(x05), .c(new_n154_), .O(new_n242_));
  nor2   g091(.a(x04), .b(x01), .O(new_n243_));
  inv1   g092(.a(new_n243_), .O(new_n244_));
  nor3   g093(.a(new_n244_), .b(new_n242_), .c(x43), .O(z24));
  ...
  aoi21  g101(.a(new_n252_), .b(new_n249_), .c(new_n162_), .O(new_n253_));
  nand4  g102(.a(new_n253_), .b(new_n243_), .c(new_n246_), .d(x05), .O(new_n254_));
  inv1   g103(.a(new_n254_), .O(z25));
  nand4  g104(.a(new_n253_), .b(new_n243_), .c(x44), .d(new_n246_), .O(new_n256_));
  inv1   g105(.a(new_n256_), .O(z26));
  nand4  g106(.a(new_n253_), .b(new_n243_), .c(x45), .d(new_n246_), .O(new_n258_));
  inv1   g107(.a(new_n258_), .O(z27));
  nand4  g108(.a(new_n253_), .b(new_n243_), .c(x46), .d(new_n246_), .O(new_n260_));
  inv1   g109(.a(new_n260_), .O(z28));
  nand4  g110(.a(new_n253_), .b(new_n243_), .c(x47), .d(new_n246_), .O(new_n262_));
  inv1   g111(.a(new_n262_), .O(z29));
  nand4  g112(.a(new_n253_), .b(new_n243_), .c(x48), .d(new_n246_), .O(new_n264_));
  inv1   g113(.a(new_n264_), .O(z30));
  nand4  g114(.a(new_n253_), .b(new_n243_), .c(x49), .d(new_n246_), .O(new_n266_));
  inv1   g115(.a(new_n266_), .O(z31));
  nand4  g116(.a(new_n253_), .b(new_n243_), .c(x50), .d(new_n246_), .O(new_n268_));
  inv1   g117(.a(new_n268_), .O(z32));
  nor2   g118(.a(new_n229_), .b(x81), .O(new_n270_));
  nor2   g119(.a(x83), .b(new_n250_), .O(new_n271_));
  nor2   g120(.a(new_n271_), .b(new_n270_), .O(new_n272_));
  nand2  g121(.a(x42), .b(x05), .O(new_n273_));
  nand2  g122(.a(x51), .b(new_n246_), .O(new_n274_));
  oai22  g123(.a(new_n274_), .b(new_n250_), .c(new_n273_), .d(new_n272_), .O(new_n275_));
  ...
  nand2  g129(.a(new_n243_), .b(new_n280_), .O(new_n281_));
  ...
  nand2  g138(.a(new_n270_), .b(x42), .O(new_n290_));
  aoi21  g139(.a(new_n290_), .b(new_n289_), .c(new_n247_), .O(new_n291_));
  oai21  g140(.a(new_n291_), .b(new_n288_), .c(new_n280_), .O(new_n292_));
  nor3   g141(.a(new_n292_), .b(new_n244_), .c(new_n283_), .O(z34));
  nand2  g142(.a(new_n243_), .b(x53), .O(new_n294_));
  nor2   g143(.a(new_n294_), .b(new_n292_), .O(z35));
  nand2  g144(.a(new_n243_), .b(x54), .O(new_n296_));
  nor2   g145(.a(new_n296_), .b(new_n292_), .O(z36));
  nand2  g146(.a(new_n243_), .b(x55), .O(new_n298_));
  nor2   g147(.a(new_n298_), .b(new_n292_), .O(z37));
  nand2  g148(.a(new_n243_), .b(x56), .O(new_n300_));
  nor2   g149(.a(new_n300_), .b(new_n292_), .O(z38));
  nor3   g150(.a(new_n292_), .b(new_n244_), .c(new_n199_), .O(z39));
  nor3   g151(.a(new_n292_), .b(new_n244_), .c(new_n196_), .O(z40));
  nor3   g152(.a(new_n292_), .b(new_n244_), .c(new_n193_), .O(z41));
  nor3   g153(.a(new_n292_), .b(new_n244_), .c(new_n190_), .O(z42));
  nor3   g154(.a(new_n292_), .b(new_n244_), .c(new_n187_), .O(z43));
  nor3   g155(.a(new_n292_), .b(new_n244_), .c(new_n184_), .O(z44));
  nor3   g156(.a(new_n292_), .b(new_n244_), .c(new_n181_), .O(z45));
  nor3   g157(.a(new_n292_), .b(new_n244_), .c(new_n178_), .O(z46));
  inv1   g158(.a(x07), .O(new_n310_));
  nand2  g159(.a(x52), .b(x15), .O(new_n311_));
  oai21  g160(.a(x52), .b(new_n310_), .c(new_n311_), .O(new_n312_));
  nor2   g161(.a(x79), .b(x77), .O(new_n313_));
  ...
  inv1   g166(.a(new_n168_), .O(new_n318_));
  nand2  g167(.a(new_n318_), .b(x79), .O(new_n319_));
  nor2   g168(.a(new_n319_), .b(new_n317_), .O(new_n320_));
  nand2  g169(.a(new_n320_), .b(new_n226_), .O(new_n321_));
  ...
  nand2  g174(.a(new_n325_), .b(new_n315_), .O(new_n326_));
  inv1   g175(.a(new_n226_), .O(new_n327_));
  nor2   g176(.a(new_n319_), .b(new_n327_), .O(new_n328_));
  nand2  g177(.a(new_n328_), .b(x68), .O(new_n329_));
  aoi21  g178(.a(new_n329_), .b(new_n326_), .c(x01), .O(z48));
  inv1   g179(.a(x09), .O(new_n331_));
  nand2  g180(.a(x52), .b(x17), .O(new_n332_));
  oai21  g181(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g182(.a(new_n333_), .b(new_n315_), .O(new_n334_));
  ...
  nand2  g188(.a(new_n339_), .b(new_n315_), .O(new_n340_));
  ...
  nand2  g194(.a(new_n345_), .b(new_n315_), .O(new_n346_));
  ...
  nand2  g200(.a(new_n351_), .b(new_n315_), .O(new_n352_));
  ...
  nand2  g206(.a(new_n357_), .b(new_n315_), .O(new_n358_));
  nand2  g207(.a(new_n328_), .b(x73), .O(new_n359_));
  aoi21  g208(.a(new_n359_), .b(new_n358_), .c(x01), .O(z53));
  nand2  g209(.a(x52), .b(x22), .O(new_n361_));
  nand2  g210(.a(new_n283_), .b(x14), .O(new_n362_));
  inv1   g211(.a(new_n167_), .O(new_n363_));
  nand4  g212(.a(new_n363_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n364_));
  aoi21  g213(.a(new_n362_), .b(new_n361_), .c(new_n364_), .O(z54));
  inv1   g214(.a(x82), .O(new_n366_));
  nand3  g215(.a(new_n270_), .b(x84), .c(new_n366_), .O(new_n367_));
  inv1   g216(.a(x80), .O(new_n368_));
  nand4  g217(.a(new_n243_), .b(new_n161_), .c(new_n368_), .d(x79), .O(new_n369_));
  nor2   g218(.a(new_n369_), .b(new_n367_), .O(z55));
  ...
  oai21  g225(.a(new_n161_), .b(new_n373_), .c(new_n376_), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(x79), .O(new_n378_));
  nand3  g227(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n379_));
  nand3  g228(.a(new_n379_), .b(new_n378_), .c(new_n372_), .O(z56));
  inv1   g229(.a(x02), .O(new_n381_));
  nand3  g230(.a(new_n372_), .b(x03), .c(new_n381_), .O(new_n382_));
  inv1   g231(.a(new_n382_), .O(z57));
  nand4  g232(.a(x80), .b(new_n231_), .c(x43), .d(new_n246_), .O(new_n384_));
  oai22  g233(.a(new_n384_), .b(new_n230_), .c(new_n246_), .d(x40), .O(new_n385_));
  nand3  g234(.a(new_n385_), .b(new_n236_), .c(x79), .O(new_n386_));
  nor2   g235(.a(x79), .b(x78), .O(new_n387_));
  nand3  g236(.a(new_n387_), .b(new_n246_), .c(x40), .O(new_n388_));
  nand2  g237(.a(new_n388_), .b(new_n386_), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(x77), .O(new_n390_));
  inv1   g239(.a(x04), .O(new_n391_));
  oai21  g240(.a(new_n363_), .b(new_n391_), .c(new_n154_), .O(new_n392_));
  aoi21  g241(.a(new_n392_), .b(new_n390_), .c(x01), .O(z58));
  inv1   g242(.a(new_n387_), .O(new_n394_));
  aoi21  g243(.a(new_n235_), .b(new_n394_), .c(new_n152_), .O(new_n395_));
  oai21  g244(.a(new_n232_), .b(new_n230_), .c(new_n246_), .O(new_n396_));
  aoi21  g245(.a(new_n396_), .b(x79), .c(new_n235_), .O(new_n397_));
  oai21  g246(.a(new_n397_), .b(new_n395_), .c(x77), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n240_), .c(x01), .O(z59));
  aoi21  g248(.a(new_n375_), .b(x79), .c(new_n239_), .O(new_n400_));
  aoi21  g249(.a(new_n400_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g250(.a(new_n170_), .O(new_n402_));
  nand2  g251(.a(new_n168_), .b(new_n167_), .O(new_n403_));
  aoi22  g252(.a(new_n403_), .b(new_n226_), .c(new_n161_), .d(new_n391_), .O(new_n404_));
  nor3   g253(.a(new_n404_), .b(new_n402_), .c(new_n368_), .O(z61));
  nand3  g254(.a(x84), .b(x81), .c(x79), .O(new_n406_));
  oai21  g255(.a(x79), .b(new_n391_), .c(new_n406_), .O(new_n407_));
  nand2  g256(.a(new_n407_), .b(new_n159_), .O(new_n408_));
  nand2  g257(.a(new_n396_), .b(x79), .O(new_n409_));
  nand3  g258(.a(x81), .b(x79), .c(new_n391_), .O(new_n410_));
  inv1   g259(.a(new_n410_), .O(new_n411_));
  aoi21  g260(.a(new_n409_), .b(x04), .c(new_n411_), .O(new_n412_));
  oai21  g261(.a(new_n412_), .b(new_n159_), .c(new_n408_), .O(new_n413_));
  nand2  g262(.a(new_n413_), .b(x78), .O(new_n414_));
  inv1   g263(.a(new_n406_), .O(new_n415_));
  nand2  g264(.a(new_n415_), .b(new_n318_), .O(new_n416_));
  aoi21  g265(.a(new_n416_), .b(new_n414_), .c(x01), .O(z62));
  nor3   g266(.a(new_n404_), .b(new_n402_), .c(new_n366_), .O(z63));
  nand2  g267(.a(x83), .b(x79), .O(new_n419_));
  or2    g268(.a(new_n419_), .b(new_n404_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n314_), .c(x01), .O(z64));
  nor2   g270(.a(new_n160_), .b(x04), .O(new_n422_));
  nor2   g271(.a(new_n250_), .b(x78), .O(new_n423_));
  oai21  g272(.a(new_n423_), .b(new_n422_), .c(x77), .O(new_n424_));
  nand2  g273(.a(new_n363_), .b(x81), .O(new_n425_));
