// Benchmark "FAU" written by ABC on Mon Jul  6 20:02:48 2020
...
module FAU ( 
  ...
  nor3   g155(.a(new_n297_), .b(new_n288_), .c(new_n200_), .O(z39));
  nor3   g156(.a(new_n297_), .b(new_n288_), .c(new_n197_), .O(z40));
  nor3   g157(.a(new_n297_), .b(new_n288_), .c(new_n194_), .O(z41));
  nor3   g158(.a(new_n297_), .b(new_n288_), .c(new_n191_), .O(z42));
  nor3   g159(.a(new_n297_), .b(new_n288_), .c(new_n188_), .O(z43));
  nor3   g160(.a(new_n297_), .b(new_n288_), .c(new_n185_), .O(z44));
  nor3   g161(.a(new_n297_), .b(new_n288_), .c(new_n182_), .O(z45));
  nor3   g162(.a(new_n297_), .b(new_n288_), .c(new_n179_), .O(z46));
  nor2   g163(.a(x75), .b(x67), .O(new_n315_));
  inv1   g164(.a(new_n168_), .O(new_n316_));
  nand2  g165(.a(new_n316_), .b(x79), .O(new_n317_));
  nor2   g166(.a(new_n317_), .b(new_n315_), .O(new_n318_));
  nand2  g167(.a(new_n318_), .b(new_n227_), .O(new_n319_));
  nor2   g168(.a(x77), .b(new_n287_), .O(new_n320_));
  nand4  g169(.a(new_n320_), .b(new_n172_), .c(x15), .d(x04), .O(new_n321_));
  ...
  inv1   g177(.a(new_n227_), .O(new_n329_));
  nor2   g178(.a(new_n317_), .b(new_n329_), .O(new_n330_));
  ...
  nand2  g184(.a(new_n335_), .b(new_n327_), .O(new_n336_));
  ...
  nand2  g190(.a(new_n341_), .b(new_n327_), .O(new_n342_));
  ...
  nand2  g202(.a(new_n353_), .b(new_n327_), .O(new_n354_));
  ...
  nand4  g232(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n384_));
  oai22  g233(.a(new_n384_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n385_));
  ...
  oai21  g243(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n395_));
  ...
  aoi21  g250(.a(new_n401_), .b(new_n238_), .c(x01), .O(z60));
  inv1   g251(.a(new_n170_), .O(new_n403_));
  nand2  g252(.a(new_n168_), .b(new_n167_), .O(new_n404_));
  aoi22  g253(.a(new_n404_), .b(new_n227_), .c(new_n161_), .d(new_n240_), .O(new_n405_));
  nor3   g254(.a(new_n405_), .b(new_n403_), .c(new_n370_), .O(z61));
