// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:28 2020
...
module FAU ( 
  ...
  nand4  g088(.a(x82), .b(x81), .c(x80), .d(new_n239_), .O(new_n240_));
  ...
  nor2   g126(.a(new_n237_), .b(x81), .O(new_n278_));
  ...
  nor3   g159(.a(new_n301_), .b(new_n292_), .c(new_n206_), .O(z39));
  nor3   g160(.a(new_n301_), .b(new_n292_), .c(new_n203_), .O(z40));
  nor3   g161(.a(new_n301_), .b(new_n292_), .c(new_n200_), .O(z41));
  nor3   g162(.a(new_n301_), .b(new_n292_), .c(new_n197_), .O(z42));
  nor3   g163(.a(new_n301_), .b(new_n292_), .c(new_n194_), .O(z43));
  nor3   g164(.a(new_n301_), .b(new_n292_), .c(new_n191_), .O(z44));
  nor3   g165(.a(new_n301_), .b(new_n292_), .c(new_n188_), .O(z45));
  nor3   g166(.a(new_n301_), .b(new_n292_), .c(new_n185_), .O(z46));
  inv1   g167(.a(x07), .O(new_n319_));
  nand2  g168(.a(x52), .b(x15), .O(new_n320_));
  oai21  g169(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand3  g170(.a(new_n236_), .b(new_n154_), .c(new_n159_), .O(new_n322_));
  inv1   g171(.a(new_n322_), .O(new_n323_));
  nand2  g172(.a(new_n323_), .b(new_n321_), .O(new_n324_));
  nor2   g173(.a(x75), .b(x67), .O(new_n325_));
  inv1   g174(.a(new_n171_), .O(new_n326_));
  nand2  g175(.a(new_n326_), .b(x79), .O(new_n327_));
  nor2   g176(.a(new_n327_), .b(new_n325_), .O(new_n328_));
  nand2  g177(.a(new_n328_), .b(new_n233_), .O(new_n329_));
  ...
  inv1   g219(.a(new_n170_), .O(new_n371_));
  ...
  inv1   g227(.a(x76), .O(new_n379_));
  nor2   g228(.a(new_n165_), .b(new_n379_), .O(new_n380_));
  xnor2a g229(.a(x84), .b(x81), .O(new_n381_));
  aoi21  g230(.a(new_n171_), .b(new_n170_), .c(new_n381_), .O(new_n382_));
  aoi21  g231(.a(new_n382_), .b(new_n153_), .c(new_n380_), .O(new_n383_));
  nor2   g232(.a(x77), .b(x01), .O(new_n384_));
  aoi21  g233(.a(new_n384_), .b(new_n164_), .c(new_n246_), .O(new_n385_));
  oai21  g234(.a(new_n383_), .b(new_n154_), .c(new_n385_), .O(z56));
  inv1   g235(.a(x02), .O(new_n387_));
  nand3  g236(.a(new_n247_), .b(x03), .c(new_n387_), .O(new_n388_));
  inv1   g237(.a(new_n388_), .O(z57));
  nand2  g238(.a(x42), .b(new_n152_), .O(new_n390_));
  inv1   g239(.a(new_n238_), .O(new_n391_));
  nand3  g240(.a(x82), .b(x81), .c(x80), .O(new_n392_));
  inv1   g241(.a(new_n392_), .O(new_n393_));
  nand4  g242(.a(new_n393_), .b(new_n391_), .c(new_n239_), .d(new_n253_), .O(new_n394_));
  nand2  g243(.a(new_n236_), .b(x79), .O(new_n395_));
  aoi21  g244(.a(new_n394_), .b(new_n390_), .c(new_n395_), .O(new_n396_));
  nand3  g245(.a(new_n178_), .b(new_n253_), .c(x40), .O(new_n397_));
  inv1   g246(.a(new_n397_), .O(new_n398_));
  oai21  g247(.a(new_n398_), .b(new_n396_), .c(x77), .O(new_n399_));
  oai21  g248(.a(new_n371_), .b(new_n160_), .c(new_n154_), .O(new_n400_));
  aoi21  g249(.a(new_n400_), .b(new_n399_), .c(x01), .O(z58));
  aoi21  g250(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n402_));
  oai21  g251(.a(new_n240_), .b(new_n238_), .c(new_n253_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(x79), .c(new_n163_), .O(new_n404_));
  ...
  aoi21  g257(.a(new_n382_), .b(x79), .c(new_n406_), .O(new_n409_));
  aoi21  g258(.a(new_n409_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g259(.a(new_n173_), .O(new_n411_));
  nand2  g260(.a(new_n171_), .b(new_n170_), .O(new_n412_));
  aoi22  g261(.a(new_n412_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n413_));
  nor3   g262(.a(new_n413_), .b(new_n411_), .c(new_n376_), .O(z61));
  nand3  g263(.a(x84), .b(x81), .c(x79), .O(new_n415_));
  oai21  g264(.a(x79), .b(new_n160_), .c(new_n415_), .O(new_n416_));
  nand2  g265(.a(new_n416_), .b(new_n159_), .O(new_n417_));
  nand2  g266(.a(new_n403_), .b(x79), .O(new_n418_));
  nand3  g267(.a(x81), .b(x79), .c(new_n160_), .O(new_n419_));
  inv1   g268(.a(new_n419_), .O(new_n420_));
  aoi21  g269(.a(new_n418_), .b(x04), .c(new_n420_), .O(new_n421_));
  oai21  g270(.a(new_n421_), .b(new_n159_), .c(new_n417_), .O(new_n422_));
  nand2  g271(.a(new_n422_), .b(x78), .O(new_n423_));
  inv1   g272(.a(new_n415_), .O(new_n424_));
  nand2  g273(.a(new_n424_), .b(new_n326_), .O(new_n425_));
  aoi21  g274(.a(new_n425_), .b(new_n423_), .c(x01), .O(z62));
  nor3   g275(.a(new_n413_), .b(new_n411_), .c(new_n374_), .O(z63));
  nand2  g276(.a(x83), .b(x79), .O(new_n428_));
  or2    g277(.a(new_n428_), .b(new_n413_), .O(new_n429_));
  nand3  g278(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n430_));
  aoi21  g279(.a(new_n430_), .b(new_n429_), .c(x01), .O(z64));
  nor2   g280(.a(new_n164_), .b(x04), .O(new_n432_));
  nor2   g281(.a(new_n257_), .b(x78), .O(new_n433_));
  oai21  g282(.a(new_n433_), .b(new_n432_), .c(x77), .O(new_n434_));
  nand2  g283(.a(new_n371_), .b(x81), .O(new_n435_));
