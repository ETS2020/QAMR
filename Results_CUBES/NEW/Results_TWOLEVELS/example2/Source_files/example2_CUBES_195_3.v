...
module FAU ( 
  ...
  nand2  g207(.a(new_n292_), .b(x12), .O(new_n359_));
  inv1   g208(.a(new_n170_), .O(new_n360_));
  nand4  g209(.a(new_n360_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n361_));
  aoi21  g210(.a(new_n359_), .b(new_n358_), .c(new_n361_), .O(z52));
  ...
  aoi21  g219(.a(new_n370_), .b(new_n369_), .c(new_n361_), .O(z54));
  ...
  oai21  g243(.a(new_n360_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g278(.a(new_n360_), .b(x81), .O(new_n430_));
