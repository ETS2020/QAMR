// Benchmark "FAU" written by ABC on Mon Jul  6 13:22:02 2020
...
module FAU ( 
  ...
  nand4  g79(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n94_), .c(new_n118_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n87_), .c(new_n125_), .O(z15));
  nor2   g83(.a(new_n126_), .b(new_n93_), .O(new_n130_));
  oai21  g84(.a(new_n130_), .b(x26), .c(x16), .O(new_n131_));
  ...
  nand2  g88(.a(new_n134_), .b(new_n131_), .O(z16));
  nor2   g89(.a(x21), .b(x20), .O(new_n136_));
  nand4  g90(.a(new_n127_), .b(new_n136_), .c(x19), .d(new_n72_), .O(new_n137_));
