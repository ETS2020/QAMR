...
module FAU ( 
  ...
  oai21  g049(.a(new_n95_), .b(new_n80_), .c(new_n91_), .O(z11));
  ...
  aoi22  g055(.a(new_n101_), .b(new_n81_), .c(new_n93_), .d(x22), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n80_), .c(new_n100_), .O(z12));
  inv1   g057(.a(x12), .O(new_n104_));
  nand2  g058(.a(x18), .b(x04), .O(new_n105_));
  oai21  g059(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n80_), .O(new_n107_));
  nand3  g061(.a(new_n101_), .b(new_n74_), .c(new_n51_), .O(new_n108_));
  nor3   g062(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g063(.a(new_n109_), .b(new_n81_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n80_), .c(new_n107_), .O(z13));
