...
module FAU ( 
  ...
  nand2  g74(.a(new_n69_), .b(x23), .O(new_n121_));
  nor3   g75(.a(x25), .b(x24), .c(x22), .O(new_n122_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n91_), .d(new_n73_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n131_), .O(z16));
  nor2   g94(.a(new_n48_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n136_), .c(new_n135_), .d(new_n91_), .O(new_n142_));
