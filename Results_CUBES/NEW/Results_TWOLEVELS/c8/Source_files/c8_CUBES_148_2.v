// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:40 2020
...
module FAU ( 
  ...
  nor2   g038(.a(new_n74_), .b(new_n51_), .O(new_n85_));
  nor2   g039(.a(x20), .b(x19), .O(new_n86_));
  aoi21  g040(.a(new_n86_), .b(new_n72_), .c(new_n85_), .O(new_n87_));
  ...
  nand2  g045(.a(x21), .b(x17), .O(new_n92_));
  nor2   g046(.a(x21), .b(x20), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n72_), .O(new_n94_));
  aoi21  g048(.a(new_n94_), .b(new_n92_), .c(x19), .O(new_n95_));
  nor2   g049(.a(new_n86_), .b(new_n54_), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  oai21  g051(.a(new_n91_), .b(x16), .c(new_n97_), .O(z11));
  inv1   g052(.a(x11), .O(new_n99_));
  nor2   g053(.a(x18), .b(new_n99_), .O(new_n100_));
  aoi21  g054(.a(x18), .b(x03), .c(new_n100_), .O(new_n101_));
  nand2  g055(.a(x22), .b(x17), .O(new_n102_));
  nor2   g056(.a(x20), .b(x17), .O(new_n103_));
  nor2   g057(.a(x22), .b(x21), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi21  g059(.a(new_n105_), .b(new_n102_), .c(x19), .O(new_n106_));
  ...
  oai21  g063(.a(new_n101_), .b(x16), .c(new_n109_), .O(z12));
  inv1   g064(.a(x12), .O(new_n111_));
  nor2   g065(.a(x18), .b(new_n111_), .O(new_n112_));
  aoi21  g066(.a(x18), .b(x04), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(x23), .b(x17), .O(new_n114_));
  nor2   g068(.a(x23), .b(x22), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n103_), .c(new_n54_), .O(new_n116_));
  aoi21  g070(.a(new_n116_), .b(new_n114_), .c(x19), .O(new_n117_));
  aoi21  g071(.a(new_n104_), .b(new_n86_), .c(new_n60_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n117_), .c(x16), .O(new_n119_));
  oai21  g073(.a(new_n113_), .b(x16), .c(new_n119_), .O(z13));
  inv1   g074(.a(x13), .O(new_n121_));
  nand2  g075(.a(x18), .b(x05), .O(new_n122_));
  oai21  g076(.a(x18), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n80_), .O(new_n124_));
  nand2  g078(.a(x24), .b(x17), .O(new_n125_));
  nor2   g079(.a(x24), .b(x23), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n93_), .c(new_n57_), .d(new_n72_), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(new_n125_), .c(x19), .O(new_n128_));
  nor3   g082(.a(x23), .b(x22), .c(x21), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n86_), .c(new_n63_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n124_), .O(z14));
  ...
  nand2  g090(.a(x25), .b(x17), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n115_), .c(new_n93_), .d(new_n72_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x19), .O(new_n140_));
  nor3   g094(.a(x24), .b(x23), .c(x22), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n107_), .c(new_n66_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n140_), .c(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n136_), .O(z15));
  nand2  g098(.a(x18), .b(x07), .O(new_n145_));
  oai21  g099(.a(x18), .b(new_n69_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n80_), .O(new_n147_));
  nand2  g101(.a(x26), .b(x17), .O(new_n148_));
  nor2   g102(.a(x26), .b(x25), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n126_), .c(new_n104_), .d(new_n103_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n148_), .c(x19), .O(new_n151_));
  nand4  g105(.a(new_n138_), .b(new_n115_), .c(new_n93_), .d(new_n48_), .O(new_n152_));
  and2   g106(.a(new_n152_), .b(x26), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n151_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n147_), .O(z16));
  nand3  g109(.a(new_n63_), .b(x19), .c(new_n72_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n149_), .c(new_n115_), .d(new_n93_), .O(new_n158_));
  nand2  g112(.a(x27), .b(x17), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n158_), .c(new_n80_), .O(z17));
