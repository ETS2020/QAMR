// Benchmark "FAU" written by ABC on Mon Jul  6 13:22:01 2020
...
module FAU ( 
  ...
  aoi21  g36(.a(new_n48_), .b(new_n72_), .c(new_n51_), .O(new_n83_));
  ...
  inv1   g45(.a(new_n84_), .O(new_n92_));
  nor2   g46(.a(x21), .b(x20), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n74_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  aoi21  g49(.a(new_n92_), .b(x21), .c(new_n95_), .O(new_n96_));
  ...
  aoi22  g56(.a(new_n102_), .b(new_n74_), .c(new_n94_), .d(x22), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n87_), .c(new_n101_), .O(z12));
  inv1   g58(.a(x12), .O(new_n105_));
  nand2  g59(.a(x18), .b(x04), .O(new_n106_));
  oai21  g60(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nand2  g62(.a(new_n102_), .b(new_n74_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  nor3   g64(.a(x20), .b(x19), .c(x17), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(x23), .O(new_n112_));
  ...
  nand2  g70(.a(new_n93_), .b(new_n57_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n74_), .O(new_n119_));
  nor2   g73(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  aoi21  g74(.a(new_n110_), .b(new_n84_), .c(new_n63_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n120_), .c(x16), .O(new_n122_));
  oai21  g76(.a(new_n116_), .b(x16), .c(new_n122_), .O(z14));
  inv1   g77(.a(x14), .O(new_n124_));
  nand2  g78(.a(x18), .b(x06), .O(new_n125_));
  oai21  g79(.a(x18), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(new_n87_), .O(new_n127_));
  nand4  g81(.a(new_n118_), .b(new_n84_), .c(new_n57_), .d(new_n54_), .O(new_n128_));
  nand4  g82(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n129_));
  nor2   g83(.a(new_n129_), .b(new_n94_), .O(new_n130_));
  aoi21  g84(.a(new_n128_), .b(x25), .c(new_n130_), .O(new_n131_));
  oai21  g85(.a(new_n131_), .b(new_n87_), .c(new_n127_), .O(z15));
  ...
  nand4  g90(.a(new_n136_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n48_), .c(x17), .O(new_n138_));
  oai21  g92(.a(x20), .b(x19), .c(x26), .O(new_n139_));
  oai21  g93(.a(new_n138_), .b(x20), .c(new_n139_), .O(new_n140_));
