...
module FAU ( 
  ...
  nor2   g036(.a(new_n75_), .b(new_n51_), .O(new_n83_));
  ...
  nor2   g045(.a(new_n84_), .b(new_n54_), .O(new_n92_));
  nand3  g046(.a(new_n75_), .b(new_n54_), .c(new_n51_), .O(new_n93_));
  ...
  inv1   g061(.a(new_n75_), .O(new_n108_));
  nor2   g062(.a(x23), .b(x22), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n54_), .O(new_n110_));
  aoi21  g064(.a(new_n110_), .b(new_n51_), .c(new_n108_), .O(new_n111_));
  aoi21  g065(.a(new_n101_), .b(new_n75_), .c(new_n60_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n111_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n107_), .O(z13));
  ...
  nand3  g072(.a(new_n109_), .b(new_n75_), .c(new_n54_), .O(new_n119_));
  nor3   g073(.a(x21), .b(x19), .c(x17), .O(new_n120_));
  nor3   g074(.a(x24), .b(x23), .c(x22), .O(new_n121_));
  aoi22  g075(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(x24), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n87_), .c(new_n118_), .O(z14));
  ...
  aoi21  g081(.a(new_n121_), .b(new_n120_), .c(new_n66_), .O(new_n128_));
  nor2   g082(.a(x25), .b(x24), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n109_), .c(new_n75_), .d(new_n54_), .O(new_n130_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n101_), .c(x19), .d(new_n76_), .O(new_n144_));
