...
module FAU ( 
  ...
  aoi22  g047(.a(new_n93_), .b(new_n74_), .c(new_n84_), .d(x21), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n88_), .c(new_n92_), .O(z11));
  ...
  oai21  g056(.a(new_n102_), .b(new_n88_), .c(new_n99_), .O(z12));
  ...
  nand2  g069(.a(new_n66_), .b(x19), .O(new_n116_));
  nor2   g070(.a(x20), .b(x17), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nor2   g072(.a(x24), .b(x23), .O(new_n119_));
  nand4  g073(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  oai21  g074(.a(new_n109_), .b(new_n84_), .c(x24), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n115_), .O(z14));
  ...
  nand2  g093(.a(new_n133_), .b(x26), .O(new_n140_));
  nor3   g094(.a(x26), .b(x25), .c(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n131_), .c(new_n93_), .d(new_n74_), .O(new_n142_));
  ...
  nor2   g100(.a(x26), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n131_), .d(new_n93_), .O(new_n148_));
  nand2  g102(.a(x27), .b(x17), .O(new_n149_));
  aoi21  g103(.a(new_n149_), .b(new_n148_), .c(new_n88_), .O(z17));
