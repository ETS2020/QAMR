// Benchmark "FAU" written by ABC on Mon Jul  6 13:22:14 2020
...
module FAU ( 
  ...
  nand2  g45(.a(new_n75_), .b(new_n51_), .O(new_n92_));
  nand3  g46(.a(new_n75_), .b(new_n54_), .c(new_n51_), .O(new_n93_));
  ...
  aoi22  g55(.a(new_n101_), .b(new_n75_), .c(new_n93_), .d(x22), .O(new_n102_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n75_), .c(new_n51_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n84_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n87_), .c(new_n107_), .O(z13));
  inv1   g66(.a(x13), .O(new_n113_));
  nand2  g67(.a(x18), .b(x05), .O(new_n114_));
  oai21  g68(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  aoi21  g70(.a(new_n110_), .b(new_n84_), .c(new_n63_), .O(new_n117_));
  nand3  g71(.a(new_n108_), .b(new_n63_), .c(new_n60_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n92_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n117_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n116_), .O(z14));
  inv1   g75(.a(x14), .O(new_n122_));
  nand2  g76(.a(x18), .b(x06), .O(new_n123_));
  oai21  g77(.a(x18), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n87_), .O(new_n125_));
  nor2   g79(.a(x24), .b(x23), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n127_));
  nor2   g81(.a(new_n75_), .b(new_n66_), .O(new_n128_));
  aoi21  g82(.a(new_n127_), .b(new_n75_), .c(new_n128_), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n87_), .c(new_n125_), .O(z15));
  inv1   g84(.a(x15), .O(new_n131_));
  nand2  g85(.a(x18), .b(x07), .O(new_n132_));
  oai21  g86(.a(x18), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n87_), .O(new_n134_));
  oai21  g88(.a(new_n69_), .b(new_n87_), .c(new_n134_), .O(z16));
  inv1   g89(.a(new_n118_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n136_), .c(new_n51_), .d(new_n76_), .O(new_n138_));
