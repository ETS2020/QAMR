...
module FAU ( 
  ...
  aoi22  g54(.a(new_n100_), .b(new_n75_), .c(new_n99_), .d(x22), .O(new_n101_));
  ...
  nand3  g61(.a(new_n107_), .b(new_n75_), .c(new_n51_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n83_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n86_), .c(new_n106_), .O(z13));
  ...
  nand4  g69(.a(new_n60_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n116_));
  nor2   g70(.a(new_n75_), .b(new_n63_), .O(new_n117_));
  aoi21  g71(.a(new_n116_), .b(new_n75_), .c(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n86_), .c(new_n115_), .O(z14));
  inv1   g73(.a(x14), .O(new_n120_));
  nand2  g74(.a(x18), .b(x06), .O(new_n121_));
  oai21  g75(.a(x18), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  oai21  g77(.a(new_n66_), .b(new_n86_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x15), .O(new_n125_));
  nand2  g79(.a(x18), .b(x07), .O(new_n126_));
  oai21  g80(.a(x18), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n86_), .O(new_n128_));
  oai21  g82(.a(new_n69_), .b(new_n86_), .c(new_n128_), .O(z16));
  nor2   g83(.a(x24), .b(x23), .O(new_n130_));
  nor2   g84(.a(x26), .b(x25), .O(new_n131_));
  nor2   g85(.a(x20), .b(x17), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n107_), .O(new_n133_));
  nand2  g87(.a(x27), .b(x17), .O(new_n134_));
  aoi21  g88(.a(new_n134_), .b(new_n133_), .c(new_n86_), .O(z17));
  buf    g89(.a(x27), .O(z08));
endmodule
