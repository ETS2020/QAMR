...
module FAU ( 
  ...
  aoi21  g47(.a(new_n90_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n86_), .c(new_n89_), .O(z11));
  ...
  nand3  g60(.a(new_n100_), .b(new_n73_), .c(new_n51_), .O(new_n107_));
  ...
  aoi21  g68(.a(new_n108_), .b(new_n83_), .c(new_n63_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n117_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n93_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n86_), .c(new_n124_), .O(z15));
  ...
  oai21  g86(.a(x26), .b(x25), .c(new_n63_), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n132_), .c(new_n91_), .d(new_n73_), .O(new_n134_));
  nor2   g88(.a(x25), .b(x23), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n136_));
  ...
  nand4  g96(.a(new_n142_), .b(new_n141_), .c(new_n132_), .d(new_n91_), .O(new_n143_));
