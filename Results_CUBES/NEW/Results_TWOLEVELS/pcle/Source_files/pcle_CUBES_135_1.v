// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:57 2020
...
module FAU ( 
  ...
  nand2  g55(.a(new_n83_), .b(x12), .O(new_n84_));
  inv1   g56(.a(x08), .O(new_n85_));
  nand4  g57(.a(x15), .b(x13), .c(x12), .d(x11), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(new_n82_), .O(new_n88_));
