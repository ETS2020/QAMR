// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:10 2020
...
module FAU ( 
  ...
  nor2   g41(.a(new_n67_), .b(x15), .O(new_n70_));
  aoi21  g42(.a(new_n69_), .b(new_n30_), .c(new_n70_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x05), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n65_), .c(new_n72_), .O(z6));
  nand3  g45(.a(x16), .b(x14), .c(x13), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n45_), .c(x17), .O(new_n75_));
  ...
  nor2   g59(.a(new_n85_), .b(x15), .O(new_n88_));
  aoi21  g60(.a(new_n87_), .b(new_n30_), .c(new_n88_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x07), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(new_n65_), .c(new_n90_), .O(z8));
endmodule
