...
module FAU ( 
  ...
  nor2   g33(.a(new_n35_), .b(x15), .O(new_n62_));
  ...
  nand3  g42(.a(new_n70_), .b(new_n55_), .c(new_n69_), .O(new_n71_));
  ...
  oai21  g61(.a(new_n89_), .b(new_n85_), .c(new_n87_), .O(new_n90_));
