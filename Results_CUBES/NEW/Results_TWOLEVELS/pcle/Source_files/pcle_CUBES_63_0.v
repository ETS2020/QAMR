...
module FAU ( 
  ...
  nor2   g12(.a(x17), .b(x12), .O(new_n41_));
  ...
  nand3  g32(.a(new_n54_), .b(x14), .c(x13), .O(new_n61_));
  nand2  g33(.a(x14), .b(x13), .O(new_n62_));
  nor3   g34(.a(new_n62_), .b(new_n50_), .c(x15), .O(new_n63_));
  aoi21  g35(.a(new_n61_), .b(x15), .c(new_n63_), .O(new_n64_));
  ...
  oai21  g48(.a(new_n76_), .b(new_n62_), .c(x12), .O(new_n77_));
  and2   g49(.a(x16), .b(x15), .O(new_n78_));
  nand3  g50(.a(x14), .b(x13), .c(x11), .O(new_n79_));
  inv1   g51(.a(new_n79_), .O(new_n80_));
  aoi21  g52(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(new_n81_));
  aoi21  g53(.a(new_n77_), .b(x11), .c(new_n81_), .O(new_n82_));
  nand2  g54(.a(x08), .b(x06), .O(new_n83_));
  oai21  g55(.a(new_n82_), .b(new_n47_), .c(new_n83_), .O(z7));
  nand4  g56(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n55_), .c(x18), .O(new_n86_));
  inv1   g58(.a(x18), .O(new_n87_));
  nand3  g59(.a(new_n78_), .b(new_n87_), .c(x17), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n61_), .c(new_n86_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n67_), .O(new_n90_));
