...
module FAU ( 
  ...
  nor2   g50(.a(new_n76_), .b(x12), .O(new_n79_));
  aoi21  g51(.a(new_n78_), .b(new_n72_), .c(new_n79_), .O(new_n80_));
  nand2  g52(.a(new_n32_), .b(x09), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(new_n80_), .c(new_n82_), .O(z7));
  ...
  nand2  g60(.a(new_n88_), .b(new_n51_), .O(new_n89_));
