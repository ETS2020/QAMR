...
module FAU ( 
  ...
  nand3  g15(.a(new_n43_), .b(x11), .c(x09), .O(new_n44_));
  oai21  g16(.a(new_n43_), .b(x11), .c(new_n44_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(new_n40_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  nand2  g19(.a(new_n47_), .b(new_n46_), .O(z2));
  nand2  g20(.a(x13), .b(new_n43_), .O(new_n49_));
  inv1   g21(.a(x13), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(x12), .c(x11), .O(new_n51_));
  aoi21  g23(.a(new_n51_), .b(new_n49_), .c(new_n33_), .O(new_n52_));
  ...
  oai21  g28(.a(new_n50_), .b(new_n43_), .c(x14), .O(new_n57_));
  inv1   g29(.a(x14), .O(new_n58_));
  nand4  g30(.a(new_n58_), .b(x13), .c(x12), .d(x11), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n57_), .c(new_n33_), .O(new_n60_));
  nor2   g32(.a(new_n58_), .b(x11), .O(new_n61_));
  oai21  g33(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(new_n62_));
  ...
  aoi22  g42(.a(new_n70_), .b(x09), .c(x15), .d(new_n35_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x04), .O(new_n72_));
  oai21  g44(.a(new_n71_), .b(new_n41_), .c(new_n72_), .O(z5));
  ...
  aoi21  g50(.a(new_n77_), .b(x09), .c(new_n78_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  oai21  g52(.a(new_n79_), .b(new_n41_), .c(new_n80_), .O(z6));
  ...
  aoi21  g60(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  oai21  g62(.a(new_n89_), .b(new_n41_), .c(new_n90_), .O(z7));
  ...
  aoi21  g70(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  nand2  g71(.a(x08), .b(x07), .O(new_n100_));
  oai21  g72(.a(new_n99_), .b(new_n41_), .c(new_n100_), .O(z8));
endmodule
