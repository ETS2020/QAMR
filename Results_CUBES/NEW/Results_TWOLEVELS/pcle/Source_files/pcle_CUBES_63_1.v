...
module FAU ( 
  ...
  nand3  g12(.a(new_n32_), .b(new_n33_), .c(new_n40_), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(new_n39_), .O(z1));
  xnor2a g14(.a(x12), .b(x11), .O(new_n43_));
  nand2  g15(.a(new_n32_), .b(new_n40_), .O(new_n44_));
  ...
  nand4  g26(.a(new_n52_), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  ...
  nor2   g32(.a(new_n35_), .b(x15), .O(new_n61_));
  aoi22  g33(.a(new_n61_), .b(new_n47_), .c(new_n60_), .d(x15), .O(new_n62_));
  nand2  g34(.a(x08), .b(x04), .O(new_n63_));
  oai21  g35(.a(new_n62_), .b(new_n44_), .c(new_n63_), .O(z5));
  nand2  g36(.a(x15), .b(x14), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n53_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  inv1   g39(.a(new_n65_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n54_), .c(new_n67_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n66_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n51_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x05), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z6));
  nand2  g45(.a(x16), .b(x15), .O(new_n74_));
  nand3  g46(.a(x14), .b(x13), .c(x11), .O(new_n75_));
  oai21  g47(.a(new_n75_), .b(new_n74_), .c(x17), .O(new_n76_));
  ...
  nand2  g51(.a(new_n79_), .b(new_n51_), .O(new_n80_));
  ...
  oai21  g56(.a(new_n84_), .b(new_n83_), .c(x18), .O(new_n85_));
  inv1   g57(.a(x18), .O(new_n86_));
  nand4  g58(.a(new_n86_), .b(x17), .c(x16), .d(x15), .O(new_n87_));
  oai21  g59(.a(new_n87_), .b(new_n83_), .c(new_n85_), .O(new_n88_));
