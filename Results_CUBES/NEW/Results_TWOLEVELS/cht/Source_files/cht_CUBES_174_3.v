...
module FAU ( 
  ...
  nand3  g049(.a(x26), .b(new_n132_), .c(new_n103_), .O(new_n133_));
  oai21  g050(.a(new_n131_), .b(new_n103_), .c(new_n133_), .O(z15));
  nand3  g051(.a(x28), .b(new_n132_), .c(x08), .O(new_n135_));
  oai21  g052(.a(new_n131_), .b(x08), .c(new_n135_), .O(z16));
