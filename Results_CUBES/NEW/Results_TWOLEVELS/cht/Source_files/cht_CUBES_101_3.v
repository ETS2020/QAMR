// Benchmark "FAU" written by ABC on Mon Jul  6 13:18:49 2020
...
module FAU ( 
  ...
  nand3  g028(.a(x19), .b(new_n111_), .c(new_n103_), .O(new_n112_));
  oai21  g029(.a(new_n110_), .b(new_n103_), .c(new_n112_), .O(z08));
  nand3  g030(.a(x21), .b(new_n111_), .c(x08), .O(new_n114_));
  oai21  g031(.a(new_n110_), .b(x08), .c(new_n114_), .O(z09));
