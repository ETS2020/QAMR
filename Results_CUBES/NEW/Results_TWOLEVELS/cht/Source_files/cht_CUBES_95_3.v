...
module FAU ( 
  ...
  nand3  g025(.a(x18), .b(new_n108_), .c(new_n103_), .O(new_n109_));
  oai21  g026(.a(new_n107_), .b(new_n103_), .c(new_n109_), .O(z07));
  nand3  g027(.a(x20), .b(new_n108_), .c(x08), .O(new_n111_));
  oai21  g028(.a(new_n107_), .b(x08), .c(new_n111_), .O(z08));
