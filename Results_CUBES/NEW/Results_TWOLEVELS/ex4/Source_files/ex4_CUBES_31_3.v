// Benchmark "FAU" written by ABC on Tue Jul  7 07:43:17 2020
...
module FAU ( 
  ...
  nand2  g251(.a(new_n408_), .b(new_n245_), .O(new_n409_));
  ...
  oai21  g260(.a(new_n407_), .b(x093), .c(new_n228_), .O(new_n418_));
  ...
  nand4  g264(.a(x125), .b(new_n261_), .c(new_n242_), .d(x013), .O(new_n422_));
