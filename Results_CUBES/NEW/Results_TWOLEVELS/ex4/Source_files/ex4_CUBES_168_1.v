// Benchmark "FAU" written by ABC on Tue Jul  7 07:45:59 2020
...
module FAU ( 
  ...
  and2   g138(.a(x110), .b(x022), .O(new_n295_));
  aoi21  g139(.a(new_n295_), .b(new_n294_), .c(new_n293_), .O(new_n296_));
  inv1   g140(.a(x038), .O(new_n297_));
  oai21  g141(.a(x126), .b(new_n284_), .c(new_n297_), .O(new_n298_));
  nand2  g142(.a(new_n298_), .b(new_n283_), .O(new_n299_));
