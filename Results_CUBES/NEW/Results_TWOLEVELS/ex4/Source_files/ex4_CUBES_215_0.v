// Benchmark "FAU" written by ABC on Tue Jul  7 07:46:53 2020
...
module FAU ( 
  ...
  nand2  g070(.a(new_n226_), .b(x077), .O(new_n227_));
  inv1   g071(.a(new_n227_), .O(new_n228_));
  oai22  g072(.a(new_n228_), .b(new_n225_), .c(x021), .d(x013), .O(new_n229_));
  inv1   g073(.a(x061), .O(new_n230_));
  ...
  aoi21  g079(.a(new_n235_), .b(new_n232_), .c(new_n230_), .O(new_n236_));
  ...
  nand3  g085(.a(new_n234_), .b(x117), .c(x021), .O(new_n242_));
  nand4  g086(.a(new_n242_), .b(new_n241_), .c(new_n239_), .d(x085), .O(new_n243_));
  oai21  g087(.a(new_n243_), .b(new_n236_), .c(x077), .O(new_n244_));
  aoi21  g088(.a(new_n244_), .b(new_n229_), .c(new_n224_), .O(new_n245_));
  ...
  nand4  g093(.a(new_n234_), .b(x109), .c(x077), .d(new_n249_), .O(new_n250_));
  aoi21  g094(.a(new_n250_), .b(new_n248_), .c(new_n246_), .O(new_n251_));
  oai21  g095(.a(new_n251_), .b(new_n245_), .c(new_n223_), .O(new_n252_));
  oai21  g096(.a(x093), .b(x061), .c(new_n225_), .O(new_n253_));
  inv1   g097(.a(x021), .O(new_n254_));
  aoi21  g098(.a(x077), .b(new_n254_), .c(new_n246_), .O(new_n255_));
  aoi22  g099(.a(new_n255_), .b(new_n253_), .c(x117), .d(x109), .O(new_n256_));
  oai21  g100(.a(x021), .b(x013), .c(new_n240_), .O(new_n257_));
  nor2   g101(.a(new_n257_), .b(new_n253_), .O(new_n258_));
  oai21  g102(.a(new_n258_), .b(new_n256_), .c(x053), .O(new_n259_));
  aoi21  g103(.a(new_n254_), .b(new_n246_), .c(x029), .O(new_n260_));
  oai21  g104(.a(new_n260_), .b(new_n228_), .c(new_n249_), .O(new_n261_));
  nand2  g105(.a(new_n261_), .b(new_n259_), .O(new_n262_));
  inv1   g106(.a(x069), .O(new_n263_));
  nand2  g107(.a(x053), .b(x013), .O(new_n264_));
  nand2  g108(.a(x077), .b(x037), .O(new_n265_));
  aoi21  g109(.a(new_n265_), .b(new_n264_), .c(x021), .O(new_n266_));
  nand2  g110(.a(x037), .b(new_n225_), .O(new_n267_));
  nand2  g111(.a(x085), .b(x053), .O(new_n268_));
  aoi21  g112(.a(new_n267_), .b(new_n227_), .c(new_n268_), .O(new_n269_));
  oai21  g113(.a(new_n269_), .b(new_n266_), .c(new_n263_), .O(new_n270_));
  inv1   g114(.a(x077), .O(new_n271_));
  aoi22  g115(.a(new_n271_), .b(new_n246_), .c(new_n224_), .d(new_n249_), .O(new_n272_));
  nand2  g116(.a(new_n272_), .b(new_n270_), .O(new_n273_));
  aoi21  g117(.a(new_n262_), .b(x085), .c(new_n273_), .O(new_n274_));
  aoi21  g118(.a(new_n274_), .b(new_n252_), .c(new_n222_), .O(z05));
  ...
  nand2  g249(.a(new_n238_), .b(new_n237_), .O(new_n407_));
  oai21  g250(.a(new_n226_), .b(x021), .c(new_n407_), .O(new_n408_));
  nand2  g251(.a(x021), .b(x013), .O(new_n409_));
  nand2  g252(.a(new_n234_), .b(new_n231_), .O(new_n410_));
  nand3  g253(.a(new_n410_), .b(new_n409_), .c(new_n226_), .O(new_n411_));
  aoi21  g254(.a(new_n411_), .b(new_n408_), .c(x085), .O(new_n412_));
  oai22  g255(.a(x093), .b(x069), .c(x061), .d(x037), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n410_), .O(new_n414_));
  nor2   g257(.a(new_n409_), .b(x085), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n414_), .c(new_n223_), .O(new_n416_));
  oai21  g259(.a(new_n416_), .b(new_n412_), .c(new_n224_), .O(new_n417_));
  nand2  g260(.a(new_n249_), .b(x021), .O(new_n418_));
  nand3  g261(.a(new_n247_), .b(new_n224_), .c(new_n254_), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n418_), .c(new_n263_), .O(new_n420_));
  nor2   g263(.a(x093), .b(x061), .O(new_n421_));
  inv1   g264(.a(new_n409_), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n421_), .c(new_n248_), .O(new_n423_));
  nor2   g266(.a(new_n423_), .b(new_n420_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n417_), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n271_), .O(new_n426_));
  nand3  g269(.a(new_n407_), .b(new_n247_), .c(new_n224_), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n271_), .c(new_n246_), .O(new_n428_));
  nand3  g271(.a(x069), .b(new_n224_), .c(x021), .O(new_n429_));
  nand3  g272(.a(x085), .b(new_n249_), .c(x005), .O(new_n430_));
  aoi21  g273(.a(new_n430_), .b(new_n429_), .c(x013), .O(new_n431_));
  nor2   g274(.a(new_n224_), .b(new_n249_), .O(new_n432_));
  nor3   g275(.a(new_n432_), .b(new_n431_), .c(new_n428_), .O(new_n433_));
  aoi21  g276(.a(new_n433_), .b(new_n426_), .c(x045), .O(z13));
  inv1   g277(.a(x102), .O(new_n435_));
  nand2  g278(.a(new_n293_), .b(new_n435_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n315_), .O(new_n437_));
  ...
  oai21  g283(.a(new_n316_), .b(x030), .c(new_n440_), .O(new_n441_));
  nor2   g284(.a(x118), .b(x022), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(x126), .c(x086), .O(new_n443_));
  oai21  g286(.a(new_n293_), .b(x110), .c(x038), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(x118), .O(new_n445_));
  oai21  g288(.a(new_n435_), .b(x062), .c(new_n282_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n296_), .O(new_n447_));
  nand4  g290(.a(new_n447_), .b(new_n445_), .c(new_n443_), .d(new_n441_), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(new_n439_), .c(new_n312_), .O(new_n449_));
  nand4  g292(.a(x126), .b(new_n299_), .c(new_n296_), .d(x014), .O(new_n450_));
  aoi21  g293(.a(new_n450_), .b(new_n449_), .c(x054), .O(new_n451_));
  nand3  g294(.a(x086), .b(new_n296_), .c(new_n287_), .O(new_n452_));
  inv1   g295(.a(new_n452_), .O(new_n453_));
  oai21  g296(.a(new_n453_), .b(new_n451_), .c(x006), .O(new_n454_));
  nand2  g297(.a(new_n290_), .b(x030), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n288_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n312_), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n287_), .c(new_n438_), .O(new_n458_));
  nor2   g301(.a(new_n286_), .b(x022), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n316_), .c(x070), .O(new_n460_));
  nand4  g303(.a(new_n440_), .b(new_n436_), .c(new_n290_), .d(x030), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n460_), .c(x078), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n458_), .c(new_n278_), .O(new_n463_));
  nand2  g306(.a(new_n440_), .b(x030), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n308_), .O(new_n465_));
  nand3  g308(.a(new_n465_), .b(new_n312_), .c(x038), .O(new_n466_));
  ...
  aoi21  g314(.a(new_n467_), .b(new_n292_), .c(new_n471_), .O(new_n472_));
