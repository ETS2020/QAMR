// Benchmark "FAU" written by ABC on Tue Jul  7 07:45:23 2020
...
module FAU ( 
  ...
  nand2  g129(.a(new_n285_), .b(x062), .O(new_n286_));
  ...
  nand4  g152(.a(new_n298_), .b(x094), .c(x038), .d(new_n292_), .O(new_n309_));
  ...
  nand2  g164(.a(new_n304_), .b(new_n320_), .O(new_n321_));
  ...
  nand2  g296(.a(new_n453_), .b(new_n304_), .O(new_n454_));
  ...
  nand4  g309(.a(x126), .b(new_n320_), .c(new_n301_), .d(x014), .O(new_n467_));
