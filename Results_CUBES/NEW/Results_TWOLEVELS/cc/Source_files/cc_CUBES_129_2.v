// Benchmark "FAU" written by ABC on Mon Jul  6 13:08:47 2020
...
module FAU ( 
  ...
  oai21  g16(.a(new_n51_), .b(x00), .c(x13), .O(new_n58_));
  nand3  g17(.a(x15), .b(x10), .c(x08), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z12));
  inv1   g19(.a(x01), .O(new_n61_));
  oai21  g20(.a(new_n51_), .b(new_n61_), .c(x14), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n57_), .O(z13));
