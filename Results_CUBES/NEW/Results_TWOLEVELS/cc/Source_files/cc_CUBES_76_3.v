...
module FAU ( 
  ...
  oai21  g21(.a(new_n44_), .b(new_n62_), .c(x14), .O(new_n63_));
  nand2  g22(.a(new_n45_), .b(x15), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n63_), .c(new_n58_), .O(z13));
  nor3   g24(.a(new_n45_), .b(new_n48_), .c(new_n58_), .O(z14));
  nand3  g25(.a(new_n49_), .b(x16), .c(new_n43_), .O(new_n67_));
  nand4  g26(.a(new_n48_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n67_), .c(new_n58_), .O(z15));
  nand2  g28(.a(new_n49_), .b(x17), .O(new_n70_));
  nand4  g29(.a(new_n48_), .b(x10), .c(x08), .d(x04), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(z16));
  nand2  g31(.a(new_n49_), .b(x18), .O(new_n73_));
  nand4  g32(.a(new_n48_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z17));
  nand2  g34(.a(new_n49_), .b(x19), .O(new_n76_));
  nand4  g35(.a(new_n48_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n58_), .O(z18));
  nand2  g37(.a(new_n49_), .b(x20), .O(new_n79_));
  nand4  g38(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n58_), .O(z19));
  buf    g40(.a(x19), .O(z05));
  buf    g41(.a(x15), .O(z06));
  buf    g42(.a(x17), .O(z07));
  buf    g43(.a(x16), .O(z08));
