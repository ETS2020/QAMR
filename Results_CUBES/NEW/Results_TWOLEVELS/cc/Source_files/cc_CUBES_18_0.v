// Benchmark "FAU" written by ABC on Mon Jul  6 13:07:58 2020
...
module FAU ( 
  ...
  oai21  g22(.a(new_n44_), .b(new_n63_), .c(x14), .O(new_n64_));
  nand2  g23(.a(new_n45_), .b(x15), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z13));
  ...
  nand2  g38(.a(new_n48_), .b(x08), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x19), .c(new_n59_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n53_), .O(z18));
  nand2  g41(.a(new_n49_), .b(x20), .O(new_n83_));
  nand3  g42(.a(new_n60_), .b(x08), .c(x07), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n53_), .O(z19));
  buf    g44(.a(x19), .O(z05));
  buf    g45(.a(x15), .O(z06));
  buf    g46(.a(x17), .O(z07));
  buf    g47(.a(x16), .O(z08));
