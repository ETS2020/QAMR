// Benchmark "FAU" written by ABC on Wed Jul  8 07:05:11 2020
...
module FAU ( 
  ...
  nor2   g0742(.a(new_n153_), .b(x67), .O(new_n834_));
  inv1   g0743(.a(new_n834_), .O(new_n835_));
  aoi21  g0744(.a(new_n833_), .b(new_n832_), .c(new_n835_), .O(new_n836_));
  oai21  g0745(.a(new_n836_), .b(new_n831_), .c(new_n137_), .O(new_n837_));
  nand2  g0746(.a(new_n777_), .b(new_n131_), .O(new_n838_));
  oai21  g0747(.a(new_n131_), .b(new_n320_), .c(new_n838_), .O(new_n839_));
  nand2  g0748(.a(new_n839_), .b(new_n367_), .O(new_n840_));
  aoi21  g0749(.a(new_n840_), .b(new_n837_), .c(x66), .O(new_n841_));
  nand2  g0750(.a(new_n830_), .b(new_n137_), .O(new_n842_));
  nand3  g0751(.a(new_n163_), .b(x68), .c(x42), .O(new_n843_));
  aoi21  g0752(.a(new_n843_), .b(new_n842_), .c(new_n372_), .O(new_n844_));
  oai21  g0753(.a(new_n844_), .b(new_n841_), .c(new_n171_), .O(new_n845_));
  nand2  g0754(.a(new_n845_), .b(new_n825_), .O(z10));
  ...
  nand2  g0759(.a(new_n209_), .b(x59), .O(new_n851_));
  nand2  g0760(.a(new_n708_), .b(new_n707_), .O(new_n852_));
  nand2  g0761(.a(new_n852_), .b(new_n214_), .O(new_n853_));
  ...
  nand2  g0769(.a(new_n270_), .b(x58), .O(new_n861_));
  ...
  nand2  g0775(.a(new_n209_), .b(x27), .O(new_n867_));
  ...
  aoi21  g0790(.a(new_n870_), .b(new_n869_), .c(new_n206_), .O(new_n882_));
  ...
  aoi21  g0797(.a(new_n854_), .b(new_n853_), .c(new_n206_), .O(new_n889_));
  ...
  nand2  g0844(.a(new_n211_), .b(x58), .O(new_n936_));
  ...
  nand2  g0859(.a(new_n211_), .b(x26), .O(new_n951_));
  ...
  nand2  g0864(.a(new_n955_), .b(new_n206_), .O(new_n956_));
  nand3  g0865(.a(new_n956_), .b(new_n949_), .c(new_n945_), .O(new_n957_));
  and2   g0866(.a(new_n957_), .b(new_n795_), .O(new_n958_));
  oai21  g0867(.a(new_n958_), .b(new_n944_), .c(new_n101_), .O(new_n959_));
  aoi21  g0868(.a(new_n947_), .b(new_n946_), .c(new_n206_), .O(new_n960_));
  ...
  nand2  g0874(.a(new_n965_), .b(new_n209_), .O(new_n966_));
  aoi21  g0875(.a(new_n932_), .b(new_n931_), .c(new_n206_), .O(new_n967_));
  ...
  nand2  g0879(.a(new_n970_), .b(new_n221_), .O(new_n971_));
  nand2  g0880(.a(new_n810_), .b(x32), .O(new_n972_));
  nand2  g0881(.a(new_n972_), .b(x44), .O(new_n973_));
  inv1   g0882(.a(x44), .O(new_n974_));
  nand3  g0883(.a(new_n810_), .b(new_n974_), .c(x32), .O(new_n975_));
  aoi21  g0884(.a(new_n975_), .b(new_n973_), .c(x71), .O(new_n976_));
  nand2  g0885(.a(new_n976_), .b(new_n817_), .O(new_n977_));
  ...
  nand2  g0889(.a(new_n928_), .b(new_n101_), .O(new_n981_));
  ...
  oai22  g0893(.a(new_n154_), .b(new_n963_), .c(new_n116_), .d(new_n974_), .O(new_n985_));
  ...
  nand2  g0900(.a(new_n942_), .b(new_n142_), .O(new_n992_));
  aoi21  g0901(.a(new_n992_), .b(new_n991_), .c(new_n835_), .O(new_n993_));
  oai21  g0902(.a(new_n993_), .b(new_n990_), .c(new_n137_), .O(new_n994_));
  nand2  g0903(.a(new_n942_), .b(new_n131_), .O(new_n995_));
  oai21  g0904(.a(new_n131_), .b(new_n974_), .c(new_n995_), .O(new_n996_));
  nand2  g0905(.a(new_n996_), .b(new_n367_), .O(new_n997_));
  aoi21  g0906(.a(new_n997_), .b(new_n994_), .c(x66), .O(new_n998_));
  nand2  g0907(.a(new_n989_), .b(new_n137_), .O(new_n999_));
  nand3  g0908(.a(new_n163_), .b(x68), .c(x44), .O(new_n1000_));
  aoi21  g0909(.a(new_n1000_), .b(new_n999_), .c(new_n372_), .O(new_n1001_));
  oai21  g0910(.a(new_n1001_), .b(new_n998_), .c(new_n171_), .O(new_n1002_));
  nand2  g0911(.a(new_n1002_), .b(new_n984_), .O(z12));
  inv1   g0912(.a(new_n176_), .O(new_n1004_));
  nand3  g0913(.a(new_n1004_), .b(new_n310_), .c(x00), .O(new_n1005_));
  oai21  g0914(.a(new_n176_), .b(new_n96_), .c(x13), .O(new_n1006_));
  ...
  nand2  g0918(.a(new_n209_), .b(x61), .O(new_n1010_));
  nand2  g0919(.a(new_n859_), .b(new_n214_), .O(new_n1011_));
  nand2  g0920(.a(new_n766_), .b(x53), .O(new_n1012_));
  ...
  aoi21  g0931(.a(new_n1022_), .b(new_n778_), .c(new_n1009_), .O(new_n1023_));
  nand2  g0932(.a(new_n209_), .b(x29), .O(new_n1024_));
  nand2  g0933(.a(new_n874_), .b(new_n214_), .O(new_n1025_));
  nand2  g0934(.a(new_n766_), .b(x21), .O(new_n1026_));
  ...
  aoi21  g0947(.a(new_n1026_), .b(new_n1025_), .c(new_n206_), .O(new_n1039_));
  ...
  aoi21  g0954(.a(new_n1012_), .b(new_n1011_), .c(new_n206_), .O(new_n1046_));
  ...
  nand2  g0978(.a(new_n1022_), .b(new_n142_), .O(new_n1070_));
  aoi21  g0979(.a(new_n1070_), .b(new_n1069_), .c(new_n835_), .O(new_n1071_));
  ...
  nand3  g0996(.a(new_n211_), .b(x73), .c(x22), .O(new_n1088_));
  ...
  nand2  g1000(.a(new_n211_), .b(x28), .O(new_n1092_));
  aoi21  g1001(.a(new_n1092_), .b(new_n1091_), .c(new_n214_), .O(new_n1093_));
  nand3  g1002(.a(x74), .b(new_n214_), .c(x29), .O(new_n1094_));
  inv1   g1003(.a(new_n1094_), .O(new_n1095_));
  oai21  g1004(.a(new_n1095_), .b(new_n1093_), .c(new_n206_), .O(new_n1096_));
  aoi21  g1005(.a(new_n1096_), .b(new_n1090_), .c(new_n145_), .O(new_n1097_));
  oai21  g1006(.a(new_n1097_), .b(new_n1086_), .c(new_n174_), .O(new_n1098_));
  nand2  g1007(.a(x47), .b(x32), .O(new_n1099_));
  xor2a  g1008(.a(new_n1099_), .b(x46), .O(new_n1100_));
  nor2   g1009(.a(new_n1100_), .b(new_n816_), .O(new_n1101_));
  oai21  g1010(.a(new_n1101_), .b(new_n1097_), .c(new_n188_), .O(new_n1102_));
  aoi21  g1011(.a(new_n1102_), .b(new_n1098_), .c(new_n93_), .O(new_n1103_));
  nand4  g1012(.a(x70), .b(x69), .c(new_n137_), .d(x30), .O(new_n1104_));
  nor2   g1013(.a(x70), .b(x69), .O(new_n1105_));
  nand3  g1014(.a(new_n1105_), .b(x68), .c(x62), .O(new_n1106_));
  nand2  g1015(.a(new_n1106_), .b(new_n1104_), .O(new_n1107_));
  nand2  g1016(.a(new_n1107_), .b(x66), .O(new_n1108_));
  nand3  g1017(.a(new_n1105_), .b(x68), .c(x67), .O(new_n1109_));
  aoi21  g1018(.a(new_n1109_), .b(new_n1108_), .c(new_n222_), .O(new_n1110_));
  inv1   g1019(.a(new_n1100_), .O(new_n1111_));
  nand3  g1020(.a(new_n1111_), .b(new_n93_), .c(x70), .O(new_n1112_));
  oai21  g1021(.a(x73), .b(new_n149_), .c(new_n131_), .O(new_n1113_));
  nand3  g1022(.a(new_n1113_), .b(x74), .c(x57), .O(new_n1114_));
  oai21  g1023(.a(x74), .b(new_n149_), .c(new_n131_), .O(new_n1115_));
  nand3  g1024(.a(new_n1115_), .b(x73), .c(x54), .O(new_n1116_));
  nand3  g1025(.a(new_n207_), .b(x66), .c(x58), .O(new_n1117_));
  nand3  g1026(.a(new_n1117_), .b(new_n1116_), .c(new_n1114_), .O(new_n1118_));
  nand2  g1027(.a(new_n1118_), .b(x72), .O(new_n1119_));
  aoi21  g1028(.a(x74), .b(x66), .c(x67), .O(new_n1120_));
  nand2  g1029(.a(new_n214_), .b(x61), .O(new_n1121_));
  nand3  g1030(.a(new_n211_), .b(x67), .c(x60), .O(new_n1122_));
  oai21  g1031(.a(new_n1121_), .b(new_n1120_), .c(new_n1122_), .O(new_n1123_));
  nand2  g1032(.a(new_n1123_), .b(new_n206_), .O(new_n1124_));
  aoi21  g1033(.a(new_n206_), .b(x66), .c(x67), .O(new_n1125_));
  nand2  g1034(.a(x74), .b(x59), .O(new_n1126_));
  nand4  g1035(.a(new_n211_), .b(new_n206_), .c(x66), .d(x60), .O(new_n1127_));
  oai21  g1036(.a(new_n1126_), .b(new_n1125_), .c(new_n1127_), .O(new_n1128_));
  nand3  g1037(.a(new_n207_), .b(x67), .c(x58), .O(new_n1129_));
  inv1   g1038(.a(new_n1129_), .O(new_n1130_));
  aoi21  g1039(.a(new_n1128_), .b(x73), .c(new_n1130_), .O(new_n1131_));
  nand3  g1040(.a(new_n1131_), .b(new_n1124_), .c(new_n1119_), .O(new_n1132_));
  nand2  g1041(.a(new_n1132_), .b(new_n101_), .O(new_n1133_));
  aoi21  g1042(.a(new_n1133_), .b(new_n1112_), .c(new_n139_), .O(new_n1134_));
  oai21  g1043(.a(new_n1134_), .b(new_n1110_), .c(new_n116_), .O(new_n1135_));
  nand2  g1044(.a(new_n1084_), .b(new_n93_), .O(new_n1136_));
  inv1   g1045(.a(x30), .O(new_n1137_));
  nor2   g1046(.a(new_n149_), .b(new_n1137_), .O(new_n1138_));
  nand3  g1047(.a(new_n1138_), .b(new_n209_), .c(new_n166_), .O(new_n1139_));
  aoi21  g1048(.a(new_n1139_), .b(new_n1136_), .c(x70), .O(new_n1140_));
  oai21  g1049(.a(x70), .b(x30), .c(x67), .O(new_n1141_));
  nand3  g1050(.a(x70), .b(x66), .c(x62), .O(new_n1142_));
  nand2  g1051(.a(new_n1142_), .b(new_n1141_), .O(new_n1143_));
  nand2  g1052(.a(new_n1143_), .b(new_n209_), .O(new_n1144_));
  nand2  g1053(.a(new_n1132_), .b(x70), .O(new_n1145_));
  aoi21  g1054(.a(new_n1145_), .b(new_n1144_), .c(new_n167_), .O(new_n1146_));
  oai21  g1055(.a(new_n1146_), .b(new_n1140_), .c(x71), .O(new_n1147_));
  nand3  g1056(.a(x70), .b(x69), .c(x67), .O(new_n1148_));
  nor3   g1057(.a(new_n1148_), .b(x68), .c(new_n1137_), .O(new_n1149_));
  nand2  g1058(.a(new_n1149_), .b(new_n209_), .O(new_n1150_));
  nand3  g1059(.a(new_n1150_), .b(new_n1147_), .c(new_n1135_), .O(new_n1151_));
  aoi21  g1060(.a(new_n1151_), .b(x65), .c(new_n1103_), .O(new_n1152_));
  inv1   g1061(.a(x46), .O(new_n1153_));
  oai22  g1062(.a(new_n154_), .b(new_n1137_), .c(new_n116_), .d(new_n1153_), .O(new_n1154_));
  nand2  g1063(.a(new_n1154_), .b(x70), .O(new_n1155_));
  oai21  g1064(.a(x71), .b(new_n153_), .c(new_n102_), .O(new_n1156_));
  aoi22  g1065(.a(new_n1156_), .b(x14), .c(new_n126_), .d(x69), .O(new_n1157_));
  aoi21  g1066(.a(new_n1157_), .b(new_n1155_), .c(new_n131_), .O(new_n1158_));
  nand2  g1067(.a(new_n209_), .b(x30), .O(new_n1159_));
  nand3  g1068(.a(new_n1159_), .b(new_n1096_), .c(new_n1090_), .O(new_n1160_));
  nand2  g1069(.a(new_n1160_), .b(new_n141_), .O(new_n1161_));
  nand2  g1070(.a(new_n211_), .b(x60), .O(new_n1162_));
  aoi21  g1071(.a(new_n1162_), .b(new_n1126_), .c(new_n214_), .O(new_n1163_));
  nand3  g1072(.a(x74), .b(new_n214_), .c(x61), .O(new_n1164_));
  inv1   g1073(.a(new_n1164_), .O(new_n1165_));
  oai21  g1074(.a(new_n1165_), .b(new_n1163_), .c(new_n206_), .O(new_n1166_));
  nand2  g1075(.a(new_n209_), .b(x62), .O(new_n1167_));
  aoi21  g1076(.a(new_n936_), .b(new_n935_), .c(x73), .O(new_n1168_));
  nand3  g1077(.a(new_n211_), .b(x73), .c(x54), .O(new_n1169_));
  ...
  nand2  g1081(.a(new_n1172_), .b(new_n142_), .O(new_n1173_));
  aoi21  g1082(.a(new_n1173_), .b(new_n1161_), .c(new_n835_), .O(new_n1174_));
  oai21  g1083(.a(new_n1174_), .b(new_n1158_), .c(new_n137_), .O(new_n1175_));
  nand2  g1084(.a(new_n1172_), .b(new_n131_), .O(new_n1176_));
  oai21  g1085(.a(new_n131_), .b(new_n1153_), .c(new_n1176_), .O(new_n1177_));
  nand2  g1086(.a(new_n1177_), .b(new_n367_), .O(new_n1178_));
  aoi21  g1087(.a(new_n1178_), .b(new_n1175_), .c(x66), .O(new_n1179_));
  nand2  g1088(.a(new_n157_), .b(x14), .O(new_n1180_));
  nand3  g1089(.a(new_n126_), .b(x69), .c(x62), .O(new_n1181_));
  nand3  g1090(.a(new_n1181_), .b(new_n1180_), .c(new_n1155_), .O(new_n1182_));
  ...
  oai21  g1094(.a(new_n1185_), .b(new_n1179_), .c(new_n171_), .O(new_n1186_));
  oai21  g1095(.a(new_n1152_), .b(x64), .c(new_n1186_), .O(z14));
  inv1   g1096(.a(x31), .O(new_n1188_));
  inv1   g1097(.a(x47), .O(new_n1189_));
  oai22  g1098(.a(new_n154_), .b(new_n1188_), .c(new_n116_), .d(new_n1189_), .O(new_n1190_));
  nand2  g1099(.a(new_n1190_), .b(x70), .O(new_n1191_));
  nand2  g1100(.a(new_n157_), .b(x15), .O(new_n1192_));
  nand3  g1101(.a(new_n126_), .b(x69), .c(x63), .O(new_n1193_));
  ...
  nand2  g1105(.a(new_n211_), .b(x29), .O(new_n1197_));
  aoi21  g1106(.a(new_n1197_), .b(new_n1196_), .c(new_n214_), .O(new_n1198_));
  nand2  g1107(.a(new_n270_), .b(x30), .O(new_n1199_));
  inv1   g1108(.a(new_n1199_), .O(new_n1200_));
  oai21  g1109(.a(new_n1200_), .b(new_n1198_), .c(new_n206_), .O(new_n1201_));
  nand2  g1110(.a(new_n209_), .b(x31), .O(new_n1202_));
  nand2  g1111(.a(new_n1030_), .b(new_n214_), .O(new_n1203_));
  nand2  g1112(.a(new_n766_), .b(x23), .O(new_n1204_));
  ...
  nand3  g1116(.a(new_n1207_), .b(new_n834_), .c(new_n141_), .O(new_n1208_));
  aoi21  g1117(.a(new_n1208_), .b(new_n1195_), .c(x66), .O(new_n1209_));
  and2   g1118(.a(new_n1194_), .b(new_n150_), .O(new_n1210_));
  oai21  g1119(.a(new_n1210_), .b(new_n1209_), .c(new_n137_), .O(new_n1211_));
  inv1   g1120(.a(new_n151_), .O(new_n1212_));
  nor2   g1121(.a(new_n137_), .b(new_n1189_), .O(new_n1213_));
  nand4  g1122(.a(new_n1213_), .b(new_n1105_), .c(new_n1212_), .d(new_n116_), .O(new_n1214_));
  aoi21  g1123(.a(new_n1214_), .b(new_n1211_), .c(new_n92_), .O(new_n1215_));
  aoi22  g1124(.a(new_n188_), .b(x47), .c(new_n174_), .d(x15), .O(new_n1216_));
  nand4  g1125(.a(new_n94_), .b(new_n153_), .c(x68), .d(new_n92_), .O(new_n1217_));
  nor2   g1126(.a(new_n1217_), .b(new_n1216_), .O(new_n1218_));
  oai21  g1127(.a(new_n1218_), .b(new_n1215_), .c(new_n132_), .O(new_n1219_));
  nor2   g1128(.a(new_n132_), .b(x64), .O(new_n1220_));
  aoi21  g1129(.a(new_n166_), .b(new_n142_), .c(new_n367_), .O(new_n1221_));
  nand2  g1130(.a(new_n1220_), .b(x66), .O(new_n1222_));
  oai21  g1131(.a(new_n637_), .b(new_n94_), .c(new_n1222_), .O(new_n1223_));
  ...
  oai21  g1137(.a(new_n1228_), .b(new_n1226_), .c(new_n206_), .O(new_n1229_));
  nand2  g1138(.a(new_n209_), .b(x63), .O(new_n1230_));
  aoi21  g1139(.a(new_n1016_), .b(new_n1015_), .c(x73), .O(new_n1231_));
  nand2  g1140(.a(new_n766_), .b(x55), .O(new_n1232_));
  ...
  nand2  g1144(.a(new_n1235_), .b(new_n1223_), .O(new_n1236_));
  inv1   g1145(.a(x59), .O(new_n1237_));
  nand2  g1146(.a(x73), .b(x55), .O(new_n1238_));
  oai21  g1147(.a(x73), .b(new_n1237_), .c(new_n1238_), .O(new_n1239_));
  nand2  g1148(.a(new_n1239_), .b(x72), .O(new_n1240_));
  nand3  g1149(.a(x73), .b(new_n206_), .c(x61), .O(new_n1241_));
  aoi21  g1150(.a(new_n1241_), .b(new_n1240_), .c(x74), .O(new_n1242_));
  inv1   g1151(.a(new_n205_), .O(new_n1243_));
  nor2   g1152(.a(x73), .b(x72), .O(new_n1244_));
  oai21  g1153(.a(new_n1244_), .b(new_n1243_), .c(x63), .O(new_n1245_));
  inv1   g1154(.a(x60), .O(new_n1246_));
  aoi21  g1155(.a(x73), .b(new_n1246_), .c(x72), .O(new_n1247_));
  inv1   g1156(.a(x58), .O(new_n1248_));
  nor2   g1157(.a(x73), .b(new_n1248_), .O(new_n1249_));
  oai21  g1158(.a(new_n1249_), .b(new_n1247_), .c(x74), .O(new_n1250_));
  nand2  g1159(.a(new_n1250_), .b(new_n1245_), .O(new_n1251_));
  nand2  g1160(.a(new_n1220_), .b(x67), .O(new_n1252_));
  inv1   g1161(.a(new_n1252_), .O(new_n1253_));
  oai21  g1162(.a(new_n1251_), .b(new_n1242_), .c(new_n1253_), .O(new_n1254_));
  aoi21  g1163(.a(new_n1254_), .b(new_n1236_), .c(new_n1221_), .O(new_n1255_));
  nand2  g1164(.a(new_n138_), .b(new_n93_), .O(new_n1256_));
  inv1   g1165(.a(new_n141_), .O(new_n1257_));
  nand2  g1166(.a(new_n1197_), .b(new_n1196_), .O(new_n1258_));
  nand2  g1167(.a(new_n1258_), .b(new_n206_), .O(new_n1259_));
  nand3  g1168(.a(new_n211_), .b(x72), .c(x23), .O(new_n1260_));
  aoi21  g1169(.a(new_n1260_), .b(new_n1259_), .c(new_n214_), .O(new_n1261_));
  oai21  g1170(.a(new_n1203_), .b(new_n206_), .c(new_n1202_), .O(new_n1262_));
  oai21  g1171(.a(new_n1262_), .b(new_n1261_), .c(new_n94_), .O(new_n1263_));
  nand3  g1172(.a(new_n1138_), .b(new_n270_), .c(new_n206_), .O(new_n1264_));
  aoi21  g1173(.a(new_n1264_), .b(new_n1263_), .c(new_n1257_), .O(new_n1265_));
  nor3   g1174(.a(new_n126_), .b(new_n131_), .c(new_n1137_), .O(new_n1266_));
  nand3  g1175(.a(new_n1266_), .b(new_n1244_), .c(x74), .O(new_n1267_));
  inv1   g1176(.a(new_n1267_), .O(new_n1268_));
  oai21  g1177(.a(new_n1268_), .b(new_n1265_), .c(new_n166_), .O(new_n1269_));
  oai21  g1178(.a(new_n1256_), .b(new_n1216_), .c(new_n1269_), .O(new_n1270_));
  aoi21  g1179(.a(new_n1270_), .b(new_n1220_), .c(new_n1255_), .O(new_n1271_));
  nand2  g1180(.a(new_n1271_), .b(new_n1219_), .O(z15));
endmodule
