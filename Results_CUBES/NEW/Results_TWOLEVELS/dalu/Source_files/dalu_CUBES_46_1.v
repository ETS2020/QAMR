...
module FAU ( 
  ...
  aoi21  g0462(.a(x72), .b(x67), .c(x66), .O(new_n554_));
  inv1   g0463(.a(new_n554_), .O(new_n555_));
  nand2  g0464(.a(new_n555_), .b(x18), .O(new_n556_));
  aoi21  g0465(.a(x67), .b(x22), .c(x66), .O(new_n557_));
  ...
  aoi21  g0469(.a(x73), .b(x67), .c(x66), .O(new_n561_));
  ...
  oai21  g0473(.a(x73), .b(new_n129_), .c(new_n150_), .O(new_n565_));
  ...
  aoi21  g0477(.a(new_n208_), .b(x67), .c(x66), .O(new_n569_));
  nand2  g0478(.a(x73), .b(x19), .O(new_n570_));
  nand4  g0479(.a(new_n209_), .b(new_n208_), .c(x67), .d(x21), .O(new_n571_));
  oai21  g0480(.a(new_n570_), .b(new_n569_), .c(new_n571_), .O(new_n572_));
  oai21  g0481(.a(new_n572_), .b(new_n568_), .c(x74), .O(new_n573_));
  nand4  g0482(.a(new_n209_), .b(new_n208_), .c(x66), .d(x21), .O(new_n574_));
  ...
  oai21  g0489(.a(new_n100_), .b(new_n129_), .c(new_n150_), .O(new_n581_));
  ...
  nor2   g0509(.a(new_n154_), .b(x66), .O(new_n601_));
  aoi22  g0510(.a(new_n601_), .b(new_n600_), .c(x66), .d(x06), .O(new_n602_));
  ...
  nand2  g0526(.a(new_n613_), .b(new_n150_), .O(new_n618_));
  nand2  g0527(.a(x66), .b(x38), .O(new_n619_));
  ...
  oai21  g0537(.a(new_n628_), .b(new_n627_), .c(new_n149_), .O(new_n629_));
  oai21  g0538(.a(new_n621_), .b(x67), .c(new_n629_), .O(new_n630_));
  ...
  nand2  g0542(.a(new_n210_), .b(x67), .O(new_n634_));
  nand2  g0543(.a(new_n208_), .b(x23), .O(new_n635_));
  aoi21  g0544(.a(new_n634_), .b(new_n150_), .c(new_n635_), .O(new_n636_));
  ...
  aoi21  g0607(.a(new_n462_), .b(new_n461_), .c(new_n209_), .O(new_n699_));
  nand2  g0608(.a(new_n274_), .b(x22), .O(new_n700_));
  ...
  and2   g0612(.a(new_n459_), .b(new_n209_), .O(new_n704_));
  oai21  g0613(.a(new_n704_), .b(new_n598_), .c(x72), .O(new_n705_));
  nand3  g0614(.a(new_n705_), .b(new_n703_), .c(new_n702_), .O(new_n706_));
  nand2  g0615(.a(new_n706_), .b(new_n225_), .O(new_n707_));
  nand2  g0616(.a(new_n670_), .b(new_n226_), .O(new_n708_));
  nand2  g0617(.a(x69), .b(new_n129_), .O(new_n709_));
  ...
  aoi21  g0643(.a(x74), .b(x67), .c(x66), .O(new_n735_));
  ...
  aoi21  g0707(.a(new_n798_), .b(new_n797_), .c(new_n709_), .O(new_n799_));
  ...
  aoi21  g0718(.a(new_n634_), .b(new_n150_), .c(new_n692_), .O(new_n810_));
  ...
  nand3  g0738(.a(x71), .b(x67), .c(x54), .O(new_n830_));
  ...
  aoi21  g0795(.a(new_n886_), .b(new_n885_), .c(new_n709_), .O(new_n887_));
  ...
  nand3  g0811(.a(new_n455_), .b(x67), .c(x26), .O(new_n903_));
  ...
  nand3  g0818(.a(new_n455_), .b(x66), .c(x26), .O(new_n910_));
  ...
  aoi21  g0885(.a(new_n976_), .b(new_n975_), .c(new_n709_), .O(new_n977_));
  ...
  aoi21  g0980(.a(new_n1071_), .b(new_n1070_), .c(new_n709_), .O(new_n1072_));
  ...
  aoi21  g1054(.a(new_n1145_), .b(new_n1144_), .c(new_n709_), .O(new_n1146_));
  ...
  aoi21  g1125(.a(new_n1216_), .b(new_n1215_), .c(new_n709_), .O(new_n1217_));
  ...
  aoi21  g1220(.a(new_n1311_), .b(new_n1310_), .c(new_n709_), .O(new_n1312_));
  ...
  aoi21  g1264(.a(new_n1355_), .b(new_n1343_), .c(new_n709_), .O(new_n1356_));
