...
module FAU ( 
  ...
  nand3  g25(.a(new_n52_), .b(new_n59_), .c(x08), .O(new_n60_));
  nand2  g26(.a(new_n60_), .b(x04), .O(new_n61_));
  nor2   g27(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g28(.a(new_n62_), .b(new_n56_), .O(z05));
  ...
  nand3  g37(.a(new_n71_), .b(new_n66_), .c(new_n59_), .O(new_n72_));
  nand3  g38(.a(new_n72_), .b(new_n70_), .c(new_n64_), .O(z07));
  nand2  g39(.a(new_n71_), .b(new_n59_), .O(new_n74_));
  oai21  g40(.a(new_n74_), .b(new_n55_), .c(x12), .O(new_n75_));
  inv1   g41(.a(x11), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n77_), .d(new_n76_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n75_), .c(new_n64_), .O(z08));
  nand3  g45(.a(new_n59_), .b(x08), .c(x07), .O(new_n80_));
  inv1   g46(.a(x10), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n77_), .c(new_n76_), .d(new_n81_), .O(new_n83_));
  ...
  nand3  g52(.a(new_n77_), .b(new_n76_), .c(new_n81_), .O(new_n87_));
  oai21  g53(.a(new_n87_), .b(new_n80_), .c(x13), .O(new_n88_));
  nand2  g54(.a(x16), .b(x03), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(x04), .O(z09));
  nand2  g56(.a(x06), .b(x00), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n83_), .O(new_n92_));
  nand2  g58(.a(x08), .b(x07), .O(new_n93_));
  nor2   g59(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g60(.a(new_n94_), .b(new_n92_), .c(new_n47_), .O(new_n95_));
