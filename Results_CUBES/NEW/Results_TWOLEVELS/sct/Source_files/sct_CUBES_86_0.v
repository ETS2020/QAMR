...
module FAU ( 
  ...
  xnor2a g19(.a(new_n53_), .b(x08), .O(new_n54_));
  ...
  nor2   g29(.a(new_n44_), .b(x02), .O(new_n64_));
  oai21  g30(.a(new_n64_), .b(new_n46_), .c(x04), .O(new_n65_));
  ...
  nor2   g40(.a(new_n57_), .b(x09), .O(new_n75_));
  nand2  g41(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n60_), .d(x04), .O(z07));
  nand2  g43(.a(new_n76_), .b(x12), .O(new_n78_));
  inv1   g44(.a(x12), .O(new_n79_));
  inv1   g45(.a(new_n66_), .O(new_n80_));
  nand3  g46(.a(new_n74_), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n78_), .c(new_n60_), .d(x04), .O(z08));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n79_), .c(new_n83_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n68_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n49_), .c(new_n64_), .O(new_n87_));
  nand2  g53(.a(new_n81_), .b(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n69_), .d(x04), .O(z09));
  nand2  g55(.a(x06), .b(x00), .O(new_n90_));
  nand3  g56(.a(new_n74_), .b(new_n84_), .c(new_n79_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n75_), .c(new_n49_), .O(new_n93_));
  nand2  g59(.a(new_n45_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(z10));
  nor2   g61(.a(new_n64_), .b(x03), .O(new_n96_));
