// Benchmark "FAU" written by ABC on Mon Jul  6 14:34:39 2020
...
module FAU ( 
  ...
  nor2   g27(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g28(.a(x16), .b(x03), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n62_), .c(new_n57_), .d(x04), .O(z05));
  nand2  g30(.a(new_n58_), .b(x10), .O(new_n65_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n65_), .d(x04), .O(z06));
  nand2  g36(.a(new_n69_), .b(x11), .O(new_n71_));
  nor2   g37(.a(x11), .b(x10), .O(new_n72_));
  nand2  g38(.a(new_n72_), .b(new_n59_), .O(new_n73_));
  nand4  g39(.a(new_n73_), .b(new_n71_), .c(new_n67_), .d(x04), .O(z07));
  nand2  g40(.a(new_n73_), .b(x12), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand3  g42(.a(new_n72_), .b(new_n59_), .c(new_n76_), .O(new_n77_));
  nand4  g43(.a(new_n77_), .b(new_n75_), .c(new_n67_), .d(x04), .O(z08));
  ...
  aoi21  g48(.a(new_n82_), .b(new_n47_), .c(new_n61_), .O(new_n83_));
  nand2  g49(.a(new_n77_), .b(x13), .O(new_n84_));
  nand4  g50(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(x04), .O(z09));
  inv1   g51(.a(x00), .O(new_n86_));
  nand3  g52(.a(new_n72_), .b(new_n80_), .c(new_n76_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g54(.a(new_n88_), .b(new_n59_), .c(new_n47_), .O(new_n89_));
  nand2  g55(.a(new_n45_), .b(x14), .O(new_n90_));
  aoi21  g56(.a(new_n90_), .b(new_n89_), .c(new_n40_), .O(z10));
  aoi21  g57(.a(new_n60_), .b(new_n43_), .c(new_n40_), .O(z12));
  nand3  g58(.a(x08), .b(x07), .c(x06), .O(new_n93_));
  nand3  g59(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(new_n94_));
  aoi21  g60(.a(new_n93_), .b(new_n47_), .c(new_n94_), .O(new_n95_));
  nor2   g61(.a(new_n95_), .b(new_n40_), .O(z13));
