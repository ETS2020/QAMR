// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:48 2020
...
module FAU ( 
  ...
  aoi22  g055(.a(new_n106_), .b(new_n72_), .c(new_n102_), .d(x25), .O(new_n107_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n79_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n103_), .b(new_n70_), .c(new_n55_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  aoi21  g069(.a(new_n114_), .b(x26), .c(new_n120_), .O(new_n121_));
  ...
  nor3   g074(.a(x26), .b(x20), .c(x17), .O(new_n126_));
  aoi21  g075(.a(new_n126_), .b(new_n113_), .c(new_n125_), .O(new_n127_));
  nor3   g076(.a(x27), .b(x26), .c(x25), .O(new_n128_));
  inv1   g077(.a(new_n128_), .O(new_n129_));
  nor2   g078(.a(x20), .b(x17), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n95_), .c(new_n79_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n129_), .c(new_n53_), .O(new_n132_));
  ...
  nand3  g087(.a(new_n130_), .b(new_n103_), .c(new_n68_), .O(new_n139_));
  nor2   g088(.a(x28), .b(x27), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n104_), .c(new_n117_), .O(new_n141_));
  ...
  nand4  g098(.a(new_n149_), .b(new_n130_), .c(new_n148_), .d(new_n89_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n95_), .b(new_n70_), .c(new_n82_), .d(new_n52_), .O(new_n156_));
  inv1   g105(.a(x28), .O(new_n157_));
  nor2   g106(.a(x27), .b(x26), .O(new_n158_));
  nor2   g107(.a(x30), .b(x29), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n158_), .c(new_n157_), .d(new_n116_), .O(new_n160_));
  nor2   g109(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  aoi21  g110(.a(new_n150_), .b(x30), .c(new_n161_), .O(new_n162_));
  ...
  nor3   g114(.a(x21), .b(x20), .c(x17), .O(new_n166_));
  nor3   g115(.a(x24), .b(x23), .c(x22), .O(new_n167_));
  nor3   g116(.a(x30), .b(x29), .c(x28), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n167_), .c(new_n166_), .d(new_n128_), .O(new_n169_));
  nor2   g118(.a(x29), .b(x28), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n170_), .c(new_n158_), .d(new_n116_), .O(new_n172_));
  ...
  oai21  g126(.a(new_n172_), .b(new_n156_), .c(x32), .O(new_n178_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n166_), .c(new_n179_), .d(new_n106_), .O(new_n183_));
  ...
  nand4  g137(.a(new_n104_), .b(new_n103_), .c(new_n70_), .d(new_n52_), .O(new_n189_));
  nand4  g138(.a(new_n180_), .b(new_n159_), .c(new_n140_), .d(new_n117_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n189_), .c(x33), .O(new_n191_));
  nand2  g140(.a(new_n171_), .b(new_n170_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n158_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n193_), .c(new_n166_), .d(new_n106_), .O(new_n197_));
  ...
  nand4  g151(.a(new_n194_), .b(new_n171_), .c(new_n170_), .d(new_n158_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n189_), .c(x34), .O(new_n204_));
  nand2  g153(.a(new_n130_), .b(new_n79_), .O(new_n205_));
  inv1   g154(.a(new_n205_), .O(new_n206_));
  nand4  g155(.a(new_n157_), .b(new_n125_), .c(new_n117_), .d(new_n116_), .O(new_n207_));
  inv1   g156(.a(new_n207_), .O(new_n208_));
  nor2   g157(.a(x34), .b(x33), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(new_n95_), .O(new_n210_));
  inv1   g159(.a(new_n210_), .O(new_n211_));
  nand4  g160(.a(new_n211_), .b(new_n208_), .c(new_n182_), .d(new_n206_), .O(new_n212_));
