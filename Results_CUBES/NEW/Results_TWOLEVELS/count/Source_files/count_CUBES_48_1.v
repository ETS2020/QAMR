...
module FAU ( 
  ...
  aoi21  g057(.a(new_n108_), .b(new_n65_), .c(new_n107_), .O(new_n109_));
  ...
  nand3  g066(.a(new_n110_), .b(new_n78_), .c(new_n117_), .O(new_n118_));
  nand3  g067(.a(new_n63_), .b(new_n52_), .c(x16), .O(new_n119_));
  inv1   g068(.a(x08), .O(new_n120_));
  aoi21  g069(.a(new_n58_), .b(new_n120_), .c(x18), .O(new_n121_));
  oai21  g070(.a(new_n119_), .b(new_n118_), .c(new_n121_), .O(z07));
  inv1   g071(.a(x27), .O(new_n123_));
  aoi21  g072(.a(new_n118_), .b(new_n53_), .c(new_n64_), .O(new_n124_));
  nor3   g073(.a(x27), .b(x25), .c(x24), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n88_), .c(new_n72_), .O(new_n126_));
  oai21  g075(.a(new_n124_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g083(.a(new_n134_), .b(new_n88_), .c(new_n133_), .d(new_n70_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n53_), .O(new_n136_));
  aoi21  g085(.a(new_n136_), .b(new_n65_), .c(new_n132_), .O(new_n137_));
  nand3  g086(.a(new_n78_), .b(new_n55_), .c(new_n61_), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n98_), .c(new_n107_), .O(new_n140_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n110_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n89_), .c(new_n53_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n65_), .c(new_n146_), .O(new_n149_));
  nand2  g098(.a(new_n110_), .b(new_n117_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n134_), .c(new_n98_), .d(new_n78_), .O(new_n159_));
  ...
  oai22  g111(.a(new_n162_), .b(new_n91_), .c(new_n160_), .d(new_n158_), .O(new_n163_));
  ...
  nand3  g118(.a(new_n134_), .b(new_n98_), .c(new_n78_), .O(new_n170_));
  ...
  oai21  g130(.a(new_n181_), .b(new_n118_), .c(new_n53_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n65_), .c(new_n180_), .O(new_n183_));
  nor2   g132(.a(x32), .b(x31), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n161_), .c(new_n139_), .d(new_n107_), .O(new_n185_));
  ...
  nand4  g140(.a(new_n184_), .b(new_n151_), .c(new_n158_), .d(new_n123_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n118_), .c(new_n53_), .O(new_n193_));
  ...
  and2   g157(.a(new_n208_), .b(new_n112_), .O(new_n209_));
