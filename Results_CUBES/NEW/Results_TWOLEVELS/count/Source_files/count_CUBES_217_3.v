...
module FAU ( 
  ...
  nand2  g133(.a(new_n184_), .b(x27), .O(new_n185_));
  inv1   g134(.a(x32), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n171_), .c(new_n159_), .O(new_n187_));
  nand4  g136(.a(new_n149_), .b(new_n139_), .c(new_n114_), .d(new_n104_), .O(new_n188_));
  ...
  nor2   g142(.a(new_n64_), .b(new_n186_), .O(new_n194_));
  ...
  nand4  g147(.a(new_n175_), .b(new_n152_), .c(new_n186_), .d(new_n114_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n116_), .c(new_n53_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n64_), .c(new_n184_), .O(new_n201_));
  nand2  g150(.a(new_n152_), .b(new_n132_), .O(new_n202_));
  nor2   g151(.a(x33), .b(x32), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(new_n175_), .O(new_n204_));
  nor3   g153(.a(new_n204_), .b(new_n202_), .c(new_n108_), .O(new_n205_));
  ...
  nand4  g159(.a(new_n175_), .b(new_n152_), .c(new_n186_), .d(new_n125_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n128_), .c(new_n53_), .O(new_n212_));
  nand3  g161(.a(new_n55_), .b(new_n184_), .c(new_n61_), .O(new_n213_));
  inv1   g162(.a(new_n213_), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n212_), .c(new_n210_), .O(new_n215_));
  nand3  g164(.a(new_n203_), .b(new_n175_), .c(new_n210_), .O(new_n216_));
  nor3   g165(.a(new_n216_), .b(new_n202_), .c(new_n108_), .O(new_n217_));
