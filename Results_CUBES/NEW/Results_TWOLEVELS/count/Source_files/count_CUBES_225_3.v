// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:44 2020
...
module FAU ( 
  ...
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n115_), .O(new_n138_));
  ...
  nand4  g107(.a(new_n111_), .b(new_n77_), .c(new_n84_), .d(new_n57_), .O(new_n159_));
  inv1   g108(.a(new_n159_), .O(new_n160_));
  inv1   g109(.a(x31), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(x19), .O(new_n162_));
  nor3   g111(.a(x30), .b(x29), .c(x28), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n162_), .c(new_n160_), .d(new_n139_), .O(new_n164_));
  nand3  g113(.a(new_n116_), .b(new_n94_), .c(new_n74_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n153_), .c(x30), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n164_), .c(x17), .O(new_n167_));
  ...
  nor2   g124(.a(x22), .b(x17), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n175_), .c(new_n68_), .d(new_n174_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n129_), .c(x31), .O(new_n178_));
  nor2   g127(.a(x31), .b(x30), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n152_), .c(new_n128_), .d(new_n96_), .O(new_n180_));
  ...
  nand3  g136(.a(new_n175_), .b(new_n187_), .c(new_n174_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n112_), .c(new_n60_), .O(new_n189_));
  nand3  g138(.a(new_n58_), .b(new_n161_), .c(new_n57_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(new_n186_), .O(new_n192_));
  nand3  g141(.a(new_n175_), .b(new_n186_), .c(new_n161_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n149_), .O(new_n194_));
  and2   g143(.a(new_n194_), .b(new_n96_), .O(new_n195_));
  ...
  nand4  g149(.a(new_n175_), .b(new_n142_), .c(new_n186_), .d(new_n136_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n112_), .c(new_n60_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n191_), .c(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n152_), .b(new_n187_), .O(new_n204_));
  nor2   g153(.a(x33), .b(x32), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(new_n179_), .O(new_n206_));
  nor3   g155(.a(new_n206_), .b(new_n204_), .c(new_n105_), .O(new_n207_));
  ...
  nand4  g161(.a(new_n205_), .b(new_n152_), .c(new_n168_), .d(new_n137_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n124_), .c(new_n60_), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n191_), .c(new_n212_), .O(new_n215_));
  nand3  g164(.a(new_n205_), .b(new_n179_), .c(new_n212_), .O(new_n216_));
  nor3   g165(.a(new_n216_), .b(new_n204_), .c(new_n105_), .O(new_n217_));
