...
module FAU ( 
  ...
  nand3  g051(.a(new_n102_), .b(new_n92_), .c(new_n55_), .O(new_n103_));
  nand2  g052(.a(new_n93_), .b(new_n76_), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(new_n63_), .c(x25), .O(new_n105_));
  ...
  nand2  g060(.a(new_n100_), .b(new_n111_), .O(new_n112_));
  inv1   g061(.a(new_n112_), .O(new_n113_));
  nand3  g062(.a(new_n84_), .b(new_n69_), .c(new_n55_), .O(new_n114_));
  inv1   g063(.a(new_n114_), .O(new_n115_));
  nand3  g064(.a(new_n100_), .b(new_n84_), .c(new_n71_), .O(new_n116_));
  aoi22  g065(.a(new_n116_), .b(x26), .c(new_n115_), .d(new_n113_), .O(new_n117_));
  ...
  nand4  g070(.a(new_n121_), .b(new_n84_), .c(new_n71_), .d(new_n91_), .O(new_n122_));
  nand3  g071(.a(new_n113_), .b(new_n84_), .c(new_n71_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(x27), .O(new_n124_));
  ...
  nand2  g080(.a(new_n121_), .b(new_n93_), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n77_), .c(x28), .O(new_n133_));
  oai21  g082(.a(new_n131_), .b(new_n116_), .c(new_n133_), .O(new_n134_));
  ...
  nor3   g088(.a(new_n139_), .b(new_n112_), .c(x29), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n115_), .O(new_n141_));
  nand3  g090(.a(new_n130_), .b(new_n102_), .c(new_n111_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n77_), .c(x29), .O(new_n143_));
  ...
  nand2  g097(.a(new_n140_), .b(new_n86_), .O(new_n149_));
  nor4   g098(.a(new_n139_), .b(new_n112_), .c(x30), .d(x29), .O(new_n150_));
  aoi22  g099(.a(new_n150_), .b(new_n86_), .c(new_n149_), .d(x30), .O(new_n151_));
  ...
  nand4  g108(.a(new_n159_), .b(new_n158_), .c(new_n111_), .d(new_n157_), .O(new_n160_));
  nor2   g109(.a(new_n160_), .b(x24), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n156_), .c(new_n155_), .d(new_n83_), .O(new_n162_));
  and2   g111(.a(new_n63_), .b(x31), .O(new_n163_));
  aoi21  g112(.a(new_n162_), .b(new_n64_), .c(new_n163_), .O(new_n164_));
