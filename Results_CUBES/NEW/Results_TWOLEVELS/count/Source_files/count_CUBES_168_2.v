...
module FAU ( 
  ...
  oai22  g107(.a(new_n158_), .b(new_n91_), .c(new_n154_), .d(new_n152_), .O(new_n159_));
  ...
  oai21  g114(.a(new_n165_), .b(new_n156_), .c(new_n53_), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n64_), .c(new_n164_), .O(new_n167_));
  ...
  nand4  g135(.a(new_n179_), .b(new_n145_), .c(new_n152_), .d(new_n117_), .O(new_n187_));
  ...
  nand4  g147(.a(new_n198_), .b(new_n157_), .c(new_n121_), .d(new_n90_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n53_), .c(new_n63_), .O(new_n200_));
  nand2  g149(.a(new_n155_), .b(new_n135_), .O(new_n201_));
  ...
  aoi21  g155(.a(new_n204_), .b(new_n112_), .c(new_n206_), .O(new_n207_));
  oai21  g156(.a(new_n200_), .b(new_n197_), .c(new_n207_), .O(z14));
  inv1   g157(.a(x34), .O(new_n209_));
  nand4  g158(.a(new_n202_), .b(new_n179_), .c(new_n155_), .d(new_n128_), .O(new_n210_));
  ...
  nor3   g162(.a(new_n213_), .b(new_n201_), .c(new_n111_), .O(new_n214_));
