...
module FAU ( 
  ...
  nand3  g042(.a(new_n93_), .b(new_n66_), .c(new_n65_), .O(new_n94_));
  nor2   g043(.a(x24), .b(x23), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(new_n74_), .O(new_n96_));
  inv1   g045(.a(new_n96_), .O(new_n97_));
  aoi22  g046(.a(new_n97_), .b(new_n60_), .c(new_n94_), .d(x24), .O(new_n98_));
  inv1   g047(.a(x10), .O(new_n99_));
  aoi21  g048(.a(new_n52_), .b(new_n99_), .c(x18), .O(new_n100_));
  oai21  g049(.a(new_n98_), .b(new_n52_), .c(new_n100_), .O(z05));
  nand3  g050(.a(new_n97_), .b(new_n66_), .c(new_n65_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n86_), .c(new_n68_), .d(new_n58_), .O(new_n105_));
  ...
  nand3  g067(.a(new_n86_), .b(new_n68_), .c(new_n58_), .O(new_n119_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n93_), .c(new_n66_), .d(new_n65_), .O(new_n138_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n97_), .c(new_n66_), .d(new_n65_), .O(new_n149_));
  ...
  nand3  g106(.a(new_n117_), .b(new_n95_), .c(new_n74_), .O(new_n158_));
  ...
  nor3   g111(.a(new_n162_), .b(new_n87_), .c(new_n67_), .O(new_n163_));
  ...
  nand3  g121(.a(new_n95_), .b(new_n74_), .c(new_n60_), .O(new_n173_));
