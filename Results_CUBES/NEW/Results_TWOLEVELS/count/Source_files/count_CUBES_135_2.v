...
module FAU ( 
  ...
  nand2  g042(.a(new_n61_), .b(new_n52_), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(new_n88_), .c(x24), .O(new_n95_));
  nor2   g044(.a(x24), .b(x23), .O(new_n96_));
  nand4  g045(.a(new_n96_), .b(new_n70_), .c(new_n79_), .d(new_n52_), .O(new_n97_));
  ...
  nand3  g051(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(z05));
  nand2  g052(.a(new_n96_), .b(new_n76_), .O(new_n104_));
  inv1   g053(.a(new_n104_), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n68_), .c(new_n52_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand4  g057(.a(new_n108_), .b(new_n87_), .c(new_n70_), .d(new_n55_), .O(new_n109_));
  ...
  nor2   g077(.a(new_n122_), .b(new_n88_), .O(new_n129_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n68_), .c(new_n52_), .O(new_n142_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n105_), .c(new_n68_), .d(new_n52_), .O(new_n153_));
  ...
  nand3  g110(.a(new_n121_), .b(new_n96_), .c(new_n76_), .O(new_n162_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n118_), .c(new_n68_), .d(new_n52_), .O(new_n176_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n118_), .c(new_n68_), .d(new_n52_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n198_), .b(new_n129_), .c(new_n68_), .d(new_n52_), .O(new_n199_));
  ...
  nand4  g157(.a(new_n208_), .b(new_n129_), .c(new_n68_), .d(new_n52_), .O(new_n209_));
