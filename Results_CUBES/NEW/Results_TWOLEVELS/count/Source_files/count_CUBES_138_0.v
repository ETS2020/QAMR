...
module FAU ( 
  ...
  nor2   g051(.a(new_n102_), .b(x23), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n69_), .c(new_n55_), .d(new_n92_), .O(new_n104_));
  nand2  g053(.a(new_n93_), .b(new_n76_), .O(new_n105_));
  nor2   g054(.a(new_n105_), .b(new_n63_), .O(new_n106_));
  oai21  g055(.a(new_n106_), .b(new_n100_), .c(new_n104_), .O(new_n107_));
  ...
  nor2   g063(.a(new_n114_), .b(x24), .O(new_n115_));
  inv1   g064(.a(new_n115_), .O(new_n116_));
  nand3  g065(.a(new_n84_), .b(new_n69_), .c(new_n55_), .O(new_n117_));
  nand2  g066(.a(new_n101_), .b(new_n84_), .O(new_n118_));
  nor2   g067(.a(new_n118_), .b(new_n70_), .O(new_n119_));
  oai22  g068(.a(new_n119_), .b(new_n112_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  ...
  nor2   g073(.a(new_n114_), .b(x27), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n84_), .c(new_n71_), .d(new_n91_), .O(new_n126_));
  nand3  g075(.a(new_n115_), .b(new_n84_), .c(new_n71_), .O(new_n127_));
  ...
  nand3  g084(.a(new_n125_), .b(new_n93_), .c(new_n78_), .O(new_n136_));
  ...
  nor4   g094(.a(new_n145_), .b(new_n117_), .c(new_n102_), .d(x26), .O(new_n146_));
  nand3  g095(.a(new_n134_), .b(new_n103_), .c(new_n78_), .O(new_n147_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n152_), .c(new_n143_), .d(new_n112_), .O(new_n154_));
  nor4   g103(.a(new_n154_), .b(new_n70_), .c(x30), .d(x29), .O(new_n155_));
  inv1   g104(.a(x30), .O(new_n156_));
  nor2   g105(.a(new_n145_), .b(new_n116_), .O(new_n157_));
  ...
  nand3  g112(.a(new_n144_), .b(new_n143_), .c(new_n112_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n163_), .c(new_n153_), .d(new_n71_), .O(new_n166_));
  inv1   g115(.a(x29), .O(new_n167_));
  nand4  g116(.a(new_n156_), .b(new_n167_), .c(new_n152_), .d(new_n143_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n115_), .c(new_n86_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(x31), .O(new_n171_));
  ...
  inv1   g125(.a(new_n106_), .O(new_n177_));
  nand3  g126(.a(new_n163_), .b(new_n144_), .c(new_n125_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n177_), .c(x32), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n169_), .c(new_n113_), .d(new_n106_), .O(new_n181_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n188_), .c(new_n156_), .d(new_n167_), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(x28), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n143_), .c(new_n112_), .d(new_n100_), .O(new_n192_));
  nor2   g141(.a(new_n192_), .b(x24), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n187_), .c(new_n92_), .d(new_n83_), .O(new_n194_));
  and2   g143(.a(new_n63_), .b(x33), .O(new_n195_));
  aoi21  g144(.a(new_n194_), .b(new_n64_), .c(new_n195_), .O(new_n196_));
  inv1   g145(.a(x01), .O(new_n197_));
  aoi21  g146(.a(new_n58_), .b(new_n197_), .c(x18), .O(new_n198_));
  oai21  g147(.a(new_n196_), .b(new_n58_), .c(new_n198_), .O(z14));
  aoi21  g148(.a(x34), .b(x16), .c(x18), .O(new_n200_));
  oai21  g149(.a(x16), .b(x00), .c(new_n200_), .O(z15));
endmodule
