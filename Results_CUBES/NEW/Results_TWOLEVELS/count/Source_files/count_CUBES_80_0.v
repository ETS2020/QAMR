...
module FAU ( 
  ...
  aoi21  g32(.a(new_n78_), .b(new_n60_), .c(new_n83_), .O(new_n84_));
  ...
  nor2   g43(.a(new_n94_), .b(new_n71_), .O(new_n95_));
  aoi21  g44(.a(new_n86_), .b(x25), .c(new_n95_), .O(new_n96_));
  inv1   g45(.a(x09), .O(new_n97_));
  aoi21  g46(.a(new_n52_), .b(new_n97_), .c(x18), .O(new_n98_));
  oai21  g47(.a(new_n96_), .b(new_n52_), .c(new_n98_), .O(z06));
  oai21  g48(.a(new_n94_), .b(new_n71_), .c(x26), .O(new_n100_));
  ...
  nand3  g58(.a(new_n109_), .b(new_n85_), .c(new_n108_), .O(new_n110_));
  ...
  aoi21  g66(.a(new_n52_), .b(new_n117_), .c(x18), .O(new_n118_));
  oai21  g67(.a(new_n116_), .b(new_n111_), .c(new_n118_), .O(z09));
