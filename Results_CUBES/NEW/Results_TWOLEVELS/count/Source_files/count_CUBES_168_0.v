...
module FAU ( 
  ...
  inv1   g144(.a(x18), .O(new_n196_));
  inv1   g145(.a(x33), .O(new_n197_));
  nand4  g146(.a(new_n189_), .b(new_n155_), .c(new_n162_), .d(new_n128_), .O(new_n198_));
  ...
  nand2  g154(.a(new_n205_), .b(new_n196_), .O(z14));
  inv1   g155(.a(x34), .O(new_n207_));
  nand4  g156(.a(new_n202_), .b(new_n178_), .c(new_n155_), .d(new_n128_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n131_), .c(new_n53_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n64_), .c(new_n207_), .O(new_n210_));
  nand3  g159(.a(new_n202_), .b(new_n178_), .c(new_n207_), .O(new_n211_));
  nor3   g160(.a(new_n211_), .b(new_n201_), .c(new_n111_), .O(new_n212_));
