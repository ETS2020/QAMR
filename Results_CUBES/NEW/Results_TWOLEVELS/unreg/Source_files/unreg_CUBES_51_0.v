...
module FAU ( 
  ...
  aoi21  g007(.a(new_n56_), .b(new_n54_), .c(new_n59_), .O(z00));
  ...
  nand2  g012(.a(new_n55_), .b(new_n57_), .O(new_n65_));
  ...
  oai21  g017(.a(new_n69_), .b(new_n68_), .c(new_n58_), .O(new_n70_));
  ...
  nor2   g060(.a(x29), .b(new_n53_), .O(new_n113_));
  ...
  nor2   g067(.a(x30), .b(new_n53_), .O(new_n120_));
  ...
  nor2   g074(.a(x31), .b(new_n53_), .O(new_n127_));
  ...
  nor2   g081(.a(x24), .b(new_n53_), .O(new_n134_));
  ...
  nor2   g088(.a(x33), .b(new_n53_), .O(new_n141_));
  ...
  nor2   g095(.a(x34), .b(new_n53_), .O(new_n148_));
  ...
  nor2   g102(.a(x35), .b(new_n53_), .O(new_n155_));
  ...
  nor2   g109(.a(x28), .b(new_n53_), .O(new_n162_));
