// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:26 2020
...
module FAU ( 
  ...
  nand3  g034(.a(new_n86_), .b(x19), .c(x18), .O(new_n87_));
  ...
  nor2   g042(.a(x26), .b(new_n55_), .O(new_n95_));
  oai21  g043(.a(new_n95_), .b(new_n94_), .c(new_n58_), .O(new_n96_));
  nand2  g044(.a(new_n86_), .b(new_n57_), .O(new_n97_));
