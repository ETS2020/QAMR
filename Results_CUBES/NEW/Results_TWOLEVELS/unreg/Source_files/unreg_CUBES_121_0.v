...
module FAU ( 
  ...
  nand3  g074(.a(x19), .b(new_n55_), .c(x09), .O(new_n127_));
  ...
  nand2  g080(.a(new_n132_), .b(new_n57_), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g082(.a(new_n58_), .O(new_n135_));
  nand2  g083(.a(new_n55_), .b(x08), .O(new_n136_));
  nand2  g084(.a(new_n88_), .b(x18), .O(new_n137_));
  aoi21  g085(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(z11));
