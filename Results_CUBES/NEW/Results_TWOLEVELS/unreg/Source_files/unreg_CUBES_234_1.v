// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:23 2020
...
module FAU ( 
  ...
  nand2  g006(.a(new_n58_), .b(x19), .O(z00));
  inv1   g007(.a(x02), .O(new_n60_));
  nor2   g008(.a(x18), .b(new_n60_), .O(new_n61_));
  nor2   g009(.a(x22), .b(new_n56_), .O(new_n62_));
  inv1   g010(.a(x19), .O(new_n63_));
  nor2   g011(.a(new_n63_), .b(x17), .O(new_n64_));
  oai21  g012(.a(new_n62_), .b(new_n61_), .c(new_n64_), .O(new_n65_));
  inv1   g013(.a(x21), .O(new_n66_));
  nand2  g014(.a(new_n66_), .b(new_n63_), .O(new_n67_));
  nand2  g015(.a(new_n67_), .b(new_n65_), .O(z01));
  inv1   g016(.a(x01), .O(new_n69_));
  nor2   g017(.a(x18), .b(new_n69_), .O(new_n70_));
  nor2   g018(.a(x23), .b(new_n56_), .O(new_n71_));
  oai21  g019(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(new_n72_));
  inv1   g020(.a(x22), .O(new_n73_));
  nand2  g021(.a(new_n73_), .b(new_n63_), .O(new_n74_));
  ...
  nand2  g026(.a(new_n78_), .b(new_n64_), .O(new_n79_));
  inv1   g027(.a(x23), .O(new_n80_));
  nand2  g028(.a(new_n80_), .b(new_n63_), .O(new_n81_));
  nand2  g029(.a(new_n81_), .b(new_n79_), .O(z03));
  inv1   g030(.a(x07), .O(new_n83_));
  nor2   g031(.a(x18), .b(new_n83_), .O(new_n84_));
  nor2   g032(.a(x25), .b(new_n56_), .O(new_n85_));
  oai21  g033(.a(new_n85_), .b(new_n84_), .c(new_n64_), .O(new_n86_));
  inv1   g034(.a(x24), .O(new_n87_));
  nand2  g035(.a(new_n87_), .b(new_n63_), .O(new_n88_));
  nand2  g036(.a(new_n88_), .b(new_n86_), .O(z04));
  inv1   g037(.a(x06), .O(new_n90_));
  nor2   g038(.a(x18), .b(new_n90_), .O(new_n91_));
  nor2   g039(.a(x26), .b(new_n56_), .O(new_n92_));
  oai21  g040(.a(new_n92_), .b(new_n91_), .c(new_n64_), .O(new_n93_));
  inv1   g041(.a(x25), .O(new_n94_));
  nand2  g042(.a(new_n94_), .b(new_n63_), .O(new_n95_));
  nand2  g043(.a(new_n95_), .b(new_n93_), .O(z05));
  inv1   g044(.a(x05), .O(new_n97_));
  nor2   g045(.a(x18), .b(new_n97_), .O(new_n98_));
  nor2   g046(.a(x27), .b(new_n56_), .O(new_n99_));
  oai21  g047(.a(new_n99_), .b(new_n98_), .c(new_n64_), .O(new_n100_));
  inv1   g048(.a(x26), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n63_), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(new_n100_), .O(z06));
  inv1   g051(.a(x04), .O(new_n104_));
  nor2   g052(.a(x18), .b(new_n104_), .O(new_n105_));
  nor2   g053(.a(x20), .b(new_n56_), .O(new_n106_));
  oai21  g054(.a(new_n106_), .b(new_n105_), .c(new_n64_), .O(new_n107_));
  inv1   g055(.a(x27), .O(new_n108_));
  nand2  g056(.a(new_n108_), .b(new_n63_), .O(new_n109_));
  nand2  g057(.a(new_n109_), .b(new_n107_), .O(z07));
  inv1   g058(.a(x11), .O(new_n111_));
  nor2   g059(.a(x18), .b(new_n111_), .O(new_n112_));
  nor2   g060(.a(x29), .b(new_n56_), .O(new_n113_));
  oai21  g061(.a(new_n113_), .b(new_n112_), .c(new_n64_), .O(new_n114_));
  inv1   g062(.a(x28), .O(new_n115_));
  nand2  g063(.a(new_n115_), .b(new_n63_), .O(new_n116_));
  nand2  g064(.a(new_n116_), .b(new_n114_), .O(z08));
  inv1   g065(.a(x10), .O(new_n118_));
  nor2   g066(.a(x18), .b(new_n118_), .O(new_n119_));
  nor2   g067(.a(x30), .b(new_n56_), .O(new_n120_));
  oai21  g068(.a(new_n120_), .b(new_n119_), .c(new_n64_), .O(new_n121_));
  inv1   g069(.a(x29), .O(new_n122_));
  nand2  g070(.a(new_n122_), .b(new_n63_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n121_), .O(z09));
  inv1   g072(.a(x09), .O(new_n125_));
  nor2   g073(.a(x18), .b(new_n125_), .O(new_n126_));
  nor2   g074(.a(x31), .b(new_n56_), .O(new_n127_));
  oai21  g075(.a(new_n127_), .b(new_n126_), .c(new_n64_), .O(new_n128_));
  inv1   g076(.a(x30), .O(new_n129_));
  nand2  g077(.a(new_n129_), .b(new_n63_), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g079(.a(x08), .O(new_n132_));
  nor2   g080(.a(x18), .b(new_n132_), .O(new_n133_));
  nor2   g081(.a(x24), .b(new_n56_), .O(new_n134_));
  oai21  g082(.a(new_n134_), .b(new_n133_), .c(new_n64_), .O(new_n135_));
  inv1   g083(.a(x31), .O(new_n136_));
  nand2  g084(.a(new_n136_), .b(new_n63_), .O(new_n137_));
  nand2  g085(.a(new_n137_), .b(new_n135_), .O(z11));
  inv1   g086(.a(x15), .O(new_n139_));
  nor2   g087(.a(x18), .b(new_n139_), .O(new_n140_));
  nor2   g088(.a(x33), .b(new_n56_), .O(new_n141_));
  oai21  g089(.a(new_n141_), .b(new_n140_), .c(new_n64_), .O(new_n142_));
  inv1   g090(.a(x32), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n63_), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n142_), .O(z12));
  inv1   g093(.a(x14), .O(new_n146_));
  nor2   g094(.a(x18), .b(new_n146_), .O(new_n147_));
  nor2   g095(.a(x34), .b(new_n56_), .O(new_n148_));
  oai21  g096(.a(new_n148_), .b(new_n147_), .c(new_n64_), .O(new_n149_));
  inv1   g097(.a(x33), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n63_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n149_), .O(z13));
  inv1   g100(.a(x13), .O(new_n153_));
  nor2   g101(.a(x18), .b(new_n153_), .O(new_n154_));
  nor2   g102(.a(x35), .b(new_n56_), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n154_), .c(new_n64_), .O(new_n156_));
  inv1   g104(.a(x34), .O(new_n157_));
  nand2  g105(.a(new_n157_), .b(new_n63_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n156_), .O(z14));
  inv1   g107(.a(x12), .O(new_n160_));
  nor2   g108(.a(x18), .b(new_n160_), .O(new_n161_));
  nor2   g109(.a(x28), .b(new_n56_), .O(new_n162_));
  oai21  g110(.a(new_n162_), .b(new_n161_), .c(new_n64_), .O(new_n163_));
  inv1   g111(.a(x35), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n63_), .O(new_n165_));
