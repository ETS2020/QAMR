// Benchmark "FAU" written by ABC on Mon Jul  6 14:17:59 2020
...
module FAU ( 
  ...
  inv1   g096(.a(new_n58_), .O(new_n149_));
  nand2  g097(.a(new_n55_), .b(x14), .O(new_n150_));
  inv1   g098(.a(x34), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(x18), .O(new_n152_));
  aoi21  g100(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(z13));
  ...
  nand2  g105(.a(new_n151_), .b(new_n57_), .O(new_n158_));
