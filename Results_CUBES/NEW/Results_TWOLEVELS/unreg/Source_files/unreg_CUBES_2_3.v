// Benchmark "FAU" written by ABC on Mon Jul  6 14:17:44 2020
...
module FAU ( 
  ...
  inv1   g059(.a(x17), .O(new_n112_));
  nand2  g060(.a(x19), .b(new_n112_), .O(new_n113_));
  nor2   g061(.a(x18), .b(x11), .O(new_n114_));
  oai22  g062(.a(new_n114_), .b(new_n113_), .c(x28), .d(x19), .O(z08));
  inv1   g063(.a(x29), .O(new_n116_));
  nand3  g064(.a(new_n116_), .b(new_n55_), .c(x10), .O(new_n117_));
  inv1   g065(.a(x30), .O(new_n118_));
  nand3  g066(.a(new_n118_), .b(x19), .c(x18), .O(new_n119_));
  nand2  g067(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g068(.a(new_n120_), .b(new_n112_), .O(new_n121_));
  nand2  g069(.a(new_n116_), .b(new_n57_), .O(new_n122_));
  ...
  nand2  g075(.a(new_n118_), .b(new_n57_), .O(new_n128_));
