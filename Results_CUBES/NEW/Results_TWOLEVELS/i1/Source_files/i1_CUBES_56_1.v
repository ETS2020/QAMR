...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(new_n54_), .c(new_n45_), .O(new_n56_));
  ...
  aoi21  g21(.a(new_n62_), .b(new_n51_), .c(x07), .O(new_n63_));
  ...
  nand3  g26(.a(x19), .b(new_n67_), .c(new_n43_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n56_), .c(new_n66_), .O(z05));
  oai21  g28(.a(x09), .b(new_n67_), .c(x07), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n55_), .c(new_n54_), .d(new_n45_), .O(new_n71_));
  nand2  g30(.a(new_n43_), .b(x00), .O(new_n72_));
  aoi21  g31(.a(new_n56_), .b(x00), .c(new_n72_), .O(new_n73_));
