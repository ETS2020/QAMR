// Benchmark "FAU" written by ABC on Mon Jul  6 13:16:47 2020
...
module FAU ( 
  ...
  nand4  g26(.a(new_n59_), .b(x19), .c(new_n45_), .d(new_n44_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z05));
  nand2  g28(.a(new_n45_), .b(x07), .O(new_n70_));
