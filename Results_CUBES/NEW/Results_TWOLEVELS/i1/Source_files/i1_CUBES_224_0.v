// Benchmark "FAU" written by ABC on Mon Jul  6 13:17:52 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n67_, new_n71_, new_n72_, new_n74_, new_n76_, new_n79_, new_n81_,
    new_n82_;
  ...
  nand2  g13(.a(x07), .b(x00), .O(new_n55_));
  aoi21  g14(.a(new_n55_), .b(new_n54_), .c(new_n42_), .O(z02));
  or2    g15(.a(x21), .b(x20), .O(z04));
  inv1   g16(.a(x10), .O(new_n58_));
  inv1   g17(.a(x08), .O(new_n59_));
  nand3  g18(.a(x19), .b(new_n59_), .c(new_n49_), .O(new_n60_));
  nand3  g19(.a(new_n46_), .b(new_n45_), .c(new_n50_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(new_n58_), .O(z05));
  nor2   g21(.a(x09), .b(new_n59_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n53_), .c(new_n49_), .O(new_n65_));
  inv1   g24(.a(x00), .O(new_n66_));
  nor2   g25(.a(x07), .b(new_n66_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n42_), .O(z06));
  and2   g27(.a(x24), .b(x18), .O(z07));
  and2   g28(.a(x24), .b(x11), .O(z09));
  inv1   g29(.a(x14), .O(new_n71_));
  inv1   g30(.a(x22), .O(new_n72_));
  nor3   g31(.a(x24), .b(new_n72_), .c(new_n71_), .O(z10));
  inv1   g32(.a(x17), .O(new_n74_));
  nor3   g33(.a(x24), .b(new_n72_), .c(new_n74_), .O(z11));
  inv1   g34(.a(x23), .O(new_n76_));
  nor3   g35(.a(x24), .b(new_n76_), .c(new_n71_), .O(z12));
  nor3   g36(.a(x24), .b(new_n76_), .c(new_n74_), .O(z13));
  inv1   g37(.a(x16), .O(new_n79_));
  nor2   g38(.a(x24), .b(new_n79_), .O(z14));
