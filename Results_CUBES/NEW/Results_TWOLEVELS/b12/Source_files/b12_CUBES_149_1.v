// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:07 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n55_, new_n57_, new_n59_, new_n60_, new_n63_, new_n64_, new_n65_,
  ...
  nand2  g39(.a(new_n64_), .b(x03), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n25_), .c(new_n57_), .O(new_n66_));
  nor2   g41(.a(new_n64_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n27_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n70_));
  nand2  g45(.a(new_n65_), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n25_), .O(new_n72_));
  oai21  g47(.a(new_n67_), .b(x02), .c(new_n27_), .O(new_n73_));
  inv1   g48(.a(x14), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n57_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n70_), .c(new_n46_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n27_), .O(new_n79_));
  nand4  g54(.a(new_n42_), .b(new_n63_), .c(new_n41_), .d(x01), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  oai21  g57(.a(x07), .b(new_n25_), .c(x03), .O(new_n83_));
  aoi21  g58(.a(new_n83_), .b(new_n63_), .c(new_n46_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n82_), .O(z7));
  inv1   g60(.a(x12), .O(new_n86_));
  nand4  g61(.a(new_n86_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(x09), .O(new_n88_));
  aoi21  g63(.a(new_n64_), .b(new_n57_), .c(new_n46_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(new_n88_), .O(z8));
  one    g65(.O(z5));
endmodule
