...
module FAU ( 
  ...
  nand3  g46(.a(new_n65_), .b(x03), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(x14), .b(x02), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x01), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n71_), .c(new_n68_), .d(new_n28_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n57_), .O(new_n75_));
  ...
  nand4  g60(.a(new_n84_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n65_), .b(new_n57_), .c(new_n46_), .O(new_n87_));
