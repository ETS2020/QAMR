// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:03 2020
...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n56_, new_n59_, new_n61_, new_n62_, new_n63_, new_n64_, new_n65_,
  ...
  nor3   g22(.a(new_n46_), .b(x03), .c(x01), .O(new_n47_));
  aoi21  g23(.a(new_n45_), .b(x02), .c(new_n47_), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n35_), .O(new_n50_));
  nand2  g26(.a(new_n42_), .b(x09), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x01), .O(new_n52_));
  nor2   g28(.a(x08), .b(new_n25_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n52_), .c(new_n41_), .O(new_n54_));
  oai21  g30(.a(new_n48_), .b(x00), .c(new_n54_), .O(z2));
  inv1   g31(.a(x00), .O(new_n56_));
  aoi22  g32(.a(x12), .b(new_n56_), .c(x11), .d(x07), .O(z3));
  nand2  g33(.a(x11), .b(x07), .O(z4));
  nor2   g34(.a(x12), .b(x00), .O(new_n59_));
  nand4  g35(.a(new_n59_), .b(x13), .c(new_n42_), .d(new_n41_), .O(z5));
  inv1   g36(.a(new_n46_), .O(new_n61_));
  inv1   g37(.a(x09), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x03), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n25_), .c(x01), .O(new_n64_));
  oai21  g40(.a(x14), .b(new_n25_), .c(new_n26_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n56_), .O(new_n66_));
  nor2   g42(.a(x03), .b(x01), .O(new_n67_));
  aoi21  g43(.a(new_n62_), .b(x03), .c(x01), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n56_), .c(new_n28_), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(new_n49_), .c(new_n67_), .d(x09), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n66_), .c(new_n61_), .O(z6));
  nor3   g47(.a(x10), .b(x07), .c(x01), .O(new_n72_));
  oai21  g48(.a(new_n53_), .b(x09), .c(new_n72_), .O(new_n73_));
  aoi21  g49(.a(x03), .b(new_n27_), .c(x08), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(new_n61_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n73_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n25_), .c(new_n27_), .O(new_n78_));
  aoi21  g54(.a(new_n67_), .b(new_n46_), .c(new_n78_), .O(new_n79_));
  aoi21  g55(.a(new_n62_), .b(new_n56_), .c(new_n61_), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(new_n62_), .c(new_n80_), .O(z8));
endmodule
