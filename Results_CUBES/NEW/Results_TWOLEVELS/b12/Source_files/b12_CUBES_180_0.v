...
module FAU ( 
  ...
  oai21  g33(.a(new_n57_), .b(x00), .c(new_n41_), .O(new_n58_));
  inv1   g34(.a(x11), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(x07), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n58_), .O(z3));
  ...
  nand3  g43(.a(new_n67_), .b(new_n42_), .c(new_n41_), .O(z5));
  inv1   g44(.a(x08), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x03), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n25_), .c(new_n65_), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n35_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x01), .c(new_n26_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n25_), .c(x01), .O(new_n76_));
  nand2  g52(.a(x14), .b(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x01), .O(new_n78_));
  oai21  g54(.a(new_n71_), .b(x02), .c(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n76_), .c(new_n65_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n75_), .c(new_n46_), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n27_), .O(new_n82_));
  nand4  g58(.a(new_n42_), .b(new_n69_), .c(new_n41_), .d(x01), .O(new_n83_));
  ...
  aoi21  g62(.a(new_n86_), .b(new_n69_), .c(new_n46_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n85_), .O(z7));
  nand4  g64(.a(new_n57_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n70_), .b(new_n65_), .c(new_n46_), .O(new_n91_));
