...
module FAU ( 
  ...
  oai21  g33(.a(x12), .b(x11), .c(new_n57_), .O(z3));
  ...
  nand2  g47(.a(new_n30_), .b(new_n62_), .O(new_n72_));
  oai21  g48(.a(x08), .b(new_n62_), .c(new_n72_), .O(new_n73_));
  ...
  nand2  g60(.a(new_n56_), .b(new_n30_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n82_), .c(x09), .O(new_n86_));
  aoi21  g62(.a(new_n66_), .b(new_n62_), .c(new_n45_), .O(new_n87_));
