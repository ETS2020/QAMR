// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:04 2020
...
module FAU ( 
  ...
  oai21  g27(.a(new_n49_), .b(x00), .c(new_n51_), .O(z2));
  ...
  oai21  g32(.a(x11), .b(new_n40_), .c(new_n56_), .O(z4));
  nor2   g33(.a(x12), .b(x00), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  oai21  g35(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n30_), .O(new_n61_));
  inv1   g37(.a(x09), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x03), .c(new_n30_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n25_), .O(new_n64_));
  inv1   g40(.a(x14), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x02), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  nand2  g44(.a(new_n50_), .b(x00), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n68_), .c(new_n45_), .O(z6));
  nand4  g46(.a(x09), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n41_), .c(x08), .d(new_n40_), .O(z7));
  inv1   g48(.a(x12), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x09), .O(new_n75_));
  aoi21  g51(.a(new_n62_), .b(new_n53_), .c(new_n45_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(z8));
endmodule
