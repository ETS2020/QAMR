...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(x01), .c(x09), .d(new_n34_), .O(new_n65_));
  oai21  g41(.a(new_n63_), .b(new_n56_), .c(new_n65_), .O(new_n66_));
  ...
  aoi22  g46(.a(new_n70_), .b(new_n67_), .c(new_n69_), .d(x01), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n66_), .c(new_n45_), .O(z6));
  nand3  g48(.a(x09), .b(x03), .c(new_n30_), .O(new_n73_));
  nand4  g49(.a(new_n41_), .b(new_n63_), .c(new_n40_), .d(x02), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n63_), .c(new_n45_), .O(new_n78_));
  ...
  nor2   g59(.a(new_n83_), .b(new_n45_), .O(new_n84_));
