...
module FAU ( 
  ...
  nand2  g39(.a(new_n34_), .b(x01), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n25_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x01), .c(new_n64_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(new_n38_), .O(new_n67_));
  aoi21  g43(.a(new_n65_), .b(new_n34_), .c(x01), .O(new_n68_));
  ...
  aoi21  g48(.a(new_n72_), .b(new_n67_), .c(new_n48_), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n37_), .O(new_n74_));
  nand4  g50(.a(new_n39_), .b(new_n38_), .c(new_n47_), .d(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n34_), .O(new_n77_));
  oai21  g53(.a(x07), .b(new_n34_), .c(x03), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n38_), .c(new_n48_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  inv1   g56(.a(x12), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x03), .c(new_n34_), .d(new_n37_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  aoi21  g59(.a(new_n41_), .b(new_n44_), .c(new_n48_), .O(new_n84_));
