...
module FAU ( 
  ...
  oai21  g34(.a(new_n58_), .b(x11), .c(x07), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  nor2   g36(.a(x11), .b(new_n40_), .O(new_n61_));
  oai21  g37(.a(new_n58_), .b(x00), .c(new_n61_), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  nor2   g39(.a(new_n53_), .b(new_n63_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n60_), .O(z4));
  inv1   g41(.a(new_n45_), .O(new_n66_));
  nor2   g42(.a(x11), .b(x00), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x09), .c(x12), .O(new_n68_));
  nand2  g44(.a(new_n40_), .b(x00), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n66_), .d(x13), .O(z5));
  oai21  g46(.a(new_n63_), .b(x03), .c(new_n30_), .O(new_n71_));
  aoi21  g47(.a(x08), .b(x00), .c(x01), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  oai21  g50(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n30_), .b(new_n56_), .O(new_n76_));
  oai21  g52(.a(x08), .b(new_n56_), .c(new_n76_), .O(new_n77_));
  nor2   g53(.a(new_n25_), .b(x00), .O(new_n78_));
  aoi22  g54(.a(new_n78_), .b(new_n74_), .c(new_n77_), .d(new_n75_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n73_), .c(new_n45_), .O(z6));
  nand3  g56(.a(x09), .b(x03), .c(new_n30_), .O(new_n81_));
  inv1   g57(.a(x08), .O(new_n82_));
  nand4  g58(.a(new_n41_), .b(new_n82_), .c(new_n40_), .d(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(new_n85_));
  nand2  g61(.a(x03), .b(new_n25_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n82_), .c(new_n45_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n85_), .O(z7));
  nand2  g64(.a(new_n58_), .b(new_n30_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n86_), .c(x09), .O(new_n90_));
  aoi21  g66(.a(new_n63_), .b(new_n56_), .c(new_n45_), .O(new_n91_));
