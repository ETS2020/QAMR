// Benchmark "FAU" written by ABC on Mon Jul  6 14:14:06 2020
...
module FAU ( 
  ...
  nor2   g01(.a(new_n34_), .b(x08), .O(z08));
  inv1   g02(.a(x10), .O(new_n36_));
  nand2  g03(.a(x08), .b(x01), .O(new_n37_));
  oai21  g04(.a(new_n36_), .b(x08), .c(new_n37_), .O(z09));
