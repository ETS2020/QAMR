...
module FAU ( 
  ...
  nor2   g153(.a(new_n305_), .b(new_n302_), .O(z36));
  nand2  g154(.a(new_n251_), .b(x55), .O(new_n307_));
  nor2   g155(.a(new_n307_), .b(new_n302_), .O(z37));
  nand2  g156(.a(new_n251_), .b(x56), .O(new_n309_));
  nor2   g157(.a(new_n309_), .b(new_n302_), .O(z38));
  nor3   g158(.a(new_n302_), .b(new_n293_), .c(new_n206_), .O(z39));
  nor3   g159(.a(new_n302_), .b(new_n293_), .c(new_n203_), .O(z40));
  nor3   g160(.a(new_n302_), .b(new_n293_), .c(new_n200_), .O(z41));
  nor3   g161(.a(new_n302_), .b(new_n293_), .c(new_n197_), .O(z42));
  nor3   g162(.a(new_n302_), .b(new_n293_), .c(new_n194_), .O(z43));
  nor3   g163(.a(new_n302_), .b(new_n293_), .c(new_n191_), .O(z44));
  nor3   g164(.a(new_n302_), .b(new_n293_), .c(new_n188_), .O(z45));
  nor3   g165(.a(new_n302_), .b(new_n293_), .c(new_n185_), .O(z46));
  ...
  nand2  g217(.a(new_n292_), .b(x14), .O(new_n370_));
  ...
  nand3  g222(.a(new_n279_), .b(x84), .c(new_n374_), .O(new_n375_));
