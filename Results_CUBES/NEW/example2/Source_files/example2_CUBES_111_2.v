// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:45 2020
...
module FAU ( 
  ...
  nand2  g013(.a(new_n161_), .b(x77), .O(new_n165_));
  nand4  g014(.a(x79), .b(x78), .c(new_n160_), .d(x75), .O(new_n166_));
  ...
  nor2   g019(.a(new_n161_), .b(new_n160_), .O(new_n171_));
  aoi21  g020(.a(new_n171_), .b(new_n159_), .c(x01), .O(z04));
  ...
  nand3  g074(.a(new_n225_), .b(new_n167_), .c(new_n224_), .O(new_n226_));
  ...
  inv1   g090(.a(new_n171_), .O(new_n242_));
  ...
  nand2  g102(.a(new_n171_), .b(x79), .O(new_n254_));
  aoi21  g103(.a(new_n253_), .b(new_n250_), .c(new_n254_), .O(new_n255_));
  nand4  g104(.a(new_n255_), .b(new_n244_), .c(new_n247_), .d(x05), .O(new_n256_));
  inv1   g105(.a(new_n256_), .O(z25));
  nand4  g106(.a(new_n255_), .b(new_n244_), .c(x44), .d(new_n247_), .O(new_n258_));
  inv1   g107(.a(new_n258_), .O(z26));
  nand4  g108(.a(new_n255_), .b(new_n244_), .c(x45), .d(new_n247_), .O(new_n260_));
  inv1   g109(.a(new_n260_), .O(z27));
  nand4  g110(.a(new_n255_), .b(new_n244_), .c(x46), .d(new_n247_), .O(new_n262_));
  inv1   g111(.a(new_n262_), .O(z28));
  nand4  g112(.a(new_n255_), .b(new_n244_), .c(x47), .d(new_n247_), .O(new_n264_));
  inv1   g113(.a(new_n264_), .O(z29));
  nand4  g114(.a(new_n255_), .b(new_n244_), .c(x48), .d(new_n247_), .O(new_n266_));
  inv1   g115(.a(new_n266_), .O(z30));
  nand4  g116(.a(new_n255_), .b(new_n244_), .c(x49), .d(new_n247_), .O(new_n268_));
  inv1   g117(.a(new_n268_), .O(z31));
  nand4  g118(.a(new_n255_), .b(new_n244_), .c(x50), .d(new_n247_), .O(new_n270_));
  inv1   g119(.a(new_n270_), .O(z32));
  nor2   g120(.a(new_n227_), .b(x81), .O(new_n272_));
  nor2   g121(.a(x83), .b(new_n251_), .O(new_n273_));
  nor2   g122(.a(new_n273_), .b(new_n272_), .O(new_n274_));
  nand2  g123(.a(x42), .b(x05), .O(new_n275_));
  nand2  g124(.a(x51), .b(new_n247_), .O(new_n276_));
  oai22  g125(.a(new_n276_), .b(new_n251_), .c(new_n275_), .d(new_n274_), .O(new_n277_));
  ...
  inv1   g134(.a(new_n244_), .O(new_n286_));
  nand2  g135(.a(x83), .b(x42), .O(new_n287_));
  nand2  g136(.a(new_n287_), .b(new_n251_), .O(new_n288_));
  nand3  g137(.a(x83), .b(x81), .c(x42), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n288_), .O(new_n290_));
  and2   g139(.a(new_n290_), .b(new_n252_), .O(new_n291_));
  nand2  g140(.a(new_n287_), .b(x81), .O(new_n292_));
  nand2  g141(.a(new_n272_), .b(x42), .O(new_n293_));
  aoi21  g142(.a(new_n293_), .b(new_n292_), .c(new_n248_), .O(new_n294_));
  oai21  g143(.a(new_n294_), .b(new_n291_), .c(new_n282_), .O(new_n295_));
  nor3   g144(.a(new_n295_), .b(new_n286_), .c(new_n285_), .O(z34));
  nand2  g145(.a(new_n244_), .b(x53), .O(new_n297_));
  nor2   g146(.a(new_n297_), .b(new_n295_), .O(z35));
  nand2  g147(.a(new_n244_), .b(x54), .O(new_n299_));
  nor2   g148(.a(new_n299_), .b(new_n295_), .O(z36));
  nand2  g149(.a(new_n244_), .b(x55), .O(new_n301_));
  nor2   g150(.a(new_n301_), .b(new_n295_), .O(z37));
  nand2  g151(.a(new_n244_), .b(x56), .O(new_n303_));
  nor2   g152(.a(new_n303_), .b(new_n295_), .O(z38));
  nor3   g153(.a(new_n295_), .b(new_n286_), .c(new_n197_), .O(z39));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n194_), .O(z40));
  nor3   g155(.a(new_n295_), .b(new_n286_), .c(new_n191_), .O(z41));
  nor3   g156(.a(new_n295_), .b(new_n286_), .c(new_n188_), .O(z42));
  nor3   g157(.a(new_n295_), .b(new_n286_), .c(new_n185_), .O(z43));
  nor3   g158(.a(new_n295_), .b(new_n286_), .c(new_n182_), .O(z44));
  nor3   g159(.a(new_n295_), .b(new_n286_), .c(new_n179_), .O(z45));
  nor3   g160(.a(new_n295_), .b(new_n286_), .c(new_n176_), .O(z46));
  ...
  inv1   g178(.a(new_n225_), .O(new_n330_));
  ...
  nand2  g213(.a(new_n285_), .b(x14), .O(new_n365_));
  nand4  g214(.a(new_n316_), .b(x78), .c(x04), .d(new_n153_), .O(new_n366_));
  aoi21  g215(.a(new_n365_), .b(new_n364_), .c(new_n366_), .O(z54));
  inv1   g216(.a(x82), .O(new_n368_));
  nand3  g217(.a(new_n272_), .b(x84), .c(new_n368_), .O(new_n369_));
  inv1   g218(.a(x80), .O(new_n370_));
  nand4  g219(.a(new_n244_), .b(new_n171_), .c(new_n370_), .d(x79), .O(new_n371_));
  nor2   g220(.a(new_n371_), .b(new_n369_), .O(z55));
  nand2  g221(.a(new_n242_), .b(x76), .O(new_n373_));
  xnor2a g222(.a(x84), .b(x81), .O(new_n374_));
  nand2  g223(.a(x78), .b(new_n160_), .O(new_n375_));
  aoi21  g224(.a(new_n375_), .b(new_n165_), .c(new_n374_), .O(new_n376_));
  nand2  g225(.a(new_n376_), .b(new_n153_), .O(new_n377_));
  nand2  g226(.a(new_n377_), .b(new_n373_), .O(new_n378_));
  nand2  g227(.a(new_n378_), .b(x79), .O(new_n379_));
  nand3  g228(.a(new_n161_), .b(new_n160_), .c(new_n153_), .O(new_n380_));
  nand3  g229(.a(new_n380_), .b(new_n379_), .c(new_n240_), .O(z56));
  inv1   g230(.a(x02), .O(new_n382_));
  nand3  g231(.a(new_n240_), .b(x03), .c(new_n382_), .O(new_n383_));
  inv1   g232(.a(new_n383_), .O(z57));
  nand4  g233(.a(x80), .b(new_n229_), .c(x43), .d(new_n247_), .O(new_n385_));
  oai22  g234(.a(new_n385_), .b(new_n228_), .c(new_n247_), .d(x40), .O(new_n386_));
  nand3  g235(.a(new_n386_), .b(new_n234_), .c(x79), .O(new_n387_));
  nor2   g236(.a(x79), .b(x78), .O(new_n388_));
  nand3  g237(.a(new_n388_), .b(new_n247_), .c(x40), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n387_), .O(new_n390_));
  nand2  g239(.a(new_n390_), .b(x77), .O(new_n391_));
  inv1   g240(.a(new_n375_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n237_), .c(new_n154_), .O(new_n393_));
  aoi21  g242(.a(new_n393_), .b(new_n391_), .c(x01), .O(z58));
  inv1   g243(.a(new_n388_), .O(new_n395_));
  ...
  aoi21  g251(.a(new_n376_), .b(x79), .c(new_n400_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n235_), .c(x01), .O(z60));
  nand2  g253(.a(new_n375_), .b(new_n165_), .O(new_n405_));
  aoi22  g254(.a(new_n405_), .b(new_n225_), .c(new_n171_), .d(new_n237_), .O(new_n406_));
  nor2   g255(.a(new_n154_), .b(x01), .O(new_n407_));
  inv1   g256(.a(new_n407_), .O(new_n408_));
  nor3   g257(.a(new_n408_), .b(new_n406_), .c(new_n370_), .O(z61));
  nand3  g258(.a(x84), .b(x81), .c(x79), .O(new_n410_));
  oai21  g259(.a(x79), .b(new_n237_), .c(new_n410_), .O(new_n411_));
  nand2  g260(.a(new_n411_), .b(new_n160_), .O(new_n412_));
  nand2  g261(.a(new_n397_), .b(x79), .O(new_n413_));
  nand3  g262(.a(x81), .b(x79), .c(new_n237_), .O(new_n414_));
  inv1   g263(.a(new_n414_), .O(new_n415_));
  aoi21  g264(.a(new_n413_), .b(x04), .c(new_n415_), .O(new_n416_));
  oai21  g265(.a(new_n416_), .b(new_n160_), .c(new_n412_), .O(new_n417_));
  ...
  nor3   g270(.a(new_n408_), .b(new_n406_), .c(new_n368_), .O(z63));
  nand2  g271(.a(x83), .b(x79), .O(new_n423_));
  or2    g272(.a(new_n423_), .b(new_n406_), .O(new_n424_));
  aoi21  g273(.a(new_n424_), .b(new_n317_), .c(x01), .O(z64));
  nor2   g274(.a(new_n161_), .b(x04), .O(new_n426_));
  nor2   g275(.a(new_n251_), .b(x78), .O(new_n427_));
  oai21  g276(.a(new_n427_), .b(new_n426_), .c(x77), .O(new_n428_));
  nand2  g277(.a(new_n392_), .b(x81), .O(new_n429_));
  nand2  g278(.a(new_n407_), .b(x84), .O(new_n430_));
