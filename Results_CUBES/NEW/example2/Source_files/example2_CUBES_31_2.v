...
module FAU ( 
  ...
  oai21  g073(.a(new_n223_), .b(new_n152_), .c(new_n224_), .O(z21));
  ...
  inv1   g108(.a(new_n248_), .O(new_n260_));
  nor4   g109(.a(new_n260_), .b(new_n235_), .c(new_n160_), .d(new_n223_), .O(new_n261_));
  and2   g110(.a(new_n261_), .b(new_n256_), .O(z26));
  nand4  g111(.a(new_n257_), .b(new_n248_), .c(x45), .d(new_n234_), .O(new_n263_));
  inv1   g112(.a(new_n263_), .O(z27));
  nand4  g113(.a(new_n257_), .b(new_n248_), .c(x46), .d(new_n234_), .O(new_n265_));
  inv1   g114(.a(new_n265_), .O(z28));
  nand4  g115(.a(new_n257_), .b(new_n248_), .c(x47), .d(new_n234_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z29));
  nand4  g117(.a(new_n257_), .b(new_n248_), .c(x48), .d(new_n234_), .O(new_n269_));
  ...
  nor3   g146(.a(new_n297_), .b(new_n260_), .c(new_n288_), .O(z34));
  ...
  nor3   g155(.a(new_n297_), .b(new_n260_), .c(new_n199_), .O(z39));
  nor3   g156(.a(new_n297_), .b(new_n260_), .c(new_n196_), .O(z40));
  nor3   g157(.a(new_n297_), .b(new_n260_), .c(new_n193_), .O(z41));
  nor3   g158(.a(new_n297_), .b(new_n260_), .c(new_n190_), .O(z42));
  nor3   g159(.a(new_n297_), .b(new_n260_), .c(new_n187_), .O(z43));
  nor3   g160(.a(new_n297_), .b(new_n260_), .c(new_n184_), .O(z44));
  nor3   g161(.a(new_n297_), .b(new_n260_), .c(new_n181_), .O(z45));
  nor3   g162(.a(new_n297_), .b(new_n260_), .c(new_n178_), .O(z46));
