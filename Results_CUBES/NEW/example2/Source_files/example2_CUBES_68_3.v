// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:12 2020
...
module FAU ( 
  ...
  oai21  g243(.a(new_n366_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g278(.a(new_n366_), .b(x81), .O(new_n430_));
