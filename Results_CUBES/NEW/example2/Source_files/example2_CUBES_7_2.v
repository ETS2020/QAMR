...
module FAU ( 
  ...
  nand2  g206(.a(new_n337_), .b(x72), .O(new_n358_));
  nor2   g207(.a(x77), .b(new_n292_), .O(new_n359_));
  nand4  g208(.a(new_n359_), .b(new_n175_), .c(x20), .d(x04), .O(new_n360_));
  aoi21  g209(.a(new_n360_), .b(new_n358_), .c(x01), .O(z52));
  ...
  nand2  g214(.a(new_n337_), .b(x73), .O(new_n366_));
