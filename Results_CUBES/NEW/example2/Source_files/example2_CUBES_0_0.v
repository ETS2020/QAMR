...
module FAU ( 
  ...
  nand2  g146(.a(new_n279_), .b(x42), .O(new_n298_));
  aoi21  g147(.a(new_n298_), .b(new_n297_), .c(new_n255_), .O(new_n299_));
  oai21  g148(.a(new_n299_), .b(new_n296_), .c(new_n289_), .O(new_n300_));
  nand2  g149(.a(new_n251_), .b(x52), .O(new_n301_));
  nor2   g150(.a(new_n301_), .b(new_n300_), .O(z34));
  nand2  g151(.a(new_n251_), .b(x53), .O(new_n303_));
  nor2   g152(.a(new_n303_), .b(new_n300_), .O(z35));
  nand2  g153(.a(new_n251_), .b(x54), .O(new_n305_));
  nor2   g154(.a(new_n305_), .b(new_n300_), .O(z36));
  nand2  g155(.a(new_n251_), .b(x55), .O(new_n307_));
  nor2   g156(.a(new_n307_), .b(new_n300_), .O(z37));
  nand2  g157(.a(new_n251_), .b(x56), .O(new_n309_));
  nor2   g158(.a(new_n309_), .b(new_n300_), .O(z38));
  inv1   g159(.a(new_n251_), .O(new_n311_));
  nor3   g160(.a(new_n300_), .b(new_n311_), .c(new_n206_), .O(z39));
  nor3   g161(.a(new_n300_), .b(new_n311_), .c(new_n203_), .O(z40));
  nor3   g162(.a(new_n300_), .b(new_n311_), .c(new_n200_), .O(z41));
  nor3   g163(.a(new_n300_), .b(new_n311_), .c(new_n197_), .O(z42));
  nor3   g164(.a(new_n300_), .b(new_n311_), .c(new_n194_), .O(z43));
  nor3   g165(.a(new_n300_), .b(new_n311_), .c(new_n191_), .O(z44));
  nor3   g166(.a(new_n300_), .b(new_n311_), .c(new_n188_), .O(z45));
  nor3   g167(.a(new_n300_), .b(new_n311_), .c(new_n185_), .O(z46));
  ...
  nand2  g219(.a(x04), .b(new_n153_), .O(new_n371_));
  nor4   g220(.a(new_n371_), .b(new_n370_), .c(new_n170_), .d(x79), .O(z54));
  ...
  oai21  g245(.a(new_n396_), .b(new_n160_), .c(new_n154_), .O(new_n397_));
  ...
  nand2  g280(.a(new_n396_), .b(x81), .O(new_n432_));
