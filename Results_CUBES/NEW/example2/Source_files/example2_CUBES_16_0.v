...
module FAU ( 
  ...
  nor2   g162(.a(x79), .b(x77), .O(new_n314_));
  nand2  g163(.a(new_n314_), .b(new_n236_), .O(new_n315_));
  inv1   g164(.a(new_n315_), .O(new_n316_));
  oai21  g165(.a(x52), .b(x07), .c(new_n316_), .O(new_n317_));
  nor2   g166(.a(x75), .b(x67), .O(new_n318_));
  inv1   g167(.a(new_n168_), .O(new_n319_));
  nand2  g168(.a(new_n319_), .b(x79), .O(new_n320_));
  nor2   g169(.a(new_n320_), .b(new_n318_), .O(new_n321_));
  ...
  nand2  g175(.a(new_n326_), .b(new_n316_), .O(new_n327_));
  ...
  nand2  g183(.a(new_n334_), .b(new_n316_), .O(new_n335_));
  ...
  nand2  g189(.a(new_n340_), .b(new_n316_), .O(new_n341_));
  ...
  nand2  g195(.a(new_n346_), .b(new_n316_), .O(new_n347_));
  ...
  nand2  g201(.a(new_n352_), .b(new_n316_), .O(new_n353_));
  ...
  nand2  g207(.a(new_n358_), .b(new_n316_), .O(new_n359_));
  ...
  nand2  g264(.a(new_n415_), .b(new_n319_), .O(new_n416_));
  ...
  aoi21  g269(.a(new_n420_), .b(new_n315_), .c(x01), .O(z64));
