// Benchmark "FAU" written by ABC on Mon Jul  6 20:04:32 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n300_, new_n301_, new_n302_, new_n305_, new_n307_, new_n309_,
  ...
  nor2   g152(.a(new_n302_), .b(new_n293_), .O(z35));
  nand2  g153(.a(new_n251_), .b(x54), .O(new_n305_));
  nor2   g154(.a(new_n305_), .b(new_n302_), .O(z36));
  nand2  g155(.a(new_n251_), .b(x55), .O(new_n307_));
  nor2   g156(.a(new_n307_), .b(new_n302_), .O(z37));
  nand2  g157(.a(new_n251_), .b(x56), .O(new_n309_));
  nor2   g158(.a(new_n309_), .b(new_n302_), .O(z38));
  nor3   g159(.a(new_n302_), .b(new_n293_), .c(new_n206_), .O(z39));
  nor3   g160(.a(new_n302_), .b(new_n293_), .c(new_n203_), .O(z40));
  ...
  nand3  g223(.a(new_n279_), .b(x84), .c(new_n374_), .O(new_n375_));
  inv1   g224(.a(x80), .O(new_n376_));
  nand4  g225(.a(new_n251_), .b(new_n165_), .c(new_n376_), .d(x79), .O(new_n377_));
  nor2   g226(.a(new_n377_), .b(new_n375_), .O(z55));
  nand2  g227(.a(new_n249_), .b(x76), .O(new_n379_));
  ...
  aoi21  g234(.a(new_n385_), .b(new_n164_), .c(new_n246_), .O(new_n386_));
  nand2  g235(.a(new_n386_), .b(new_n384_), .O(z56));
  inv1   g236(.a(x02), .O(new_n388_));
  nand3  g237(.a(new_n247_), .b(x03), .c(new_n388_), .O(new_n389_));
  inv1   g238(.a(new_n389_), .O(z57));
  nand4  g239(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n391_));
  oai22  g240(.a(new_n391_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n392_));
  nand3  g241(.a(new_n392_), .b(new_n236_), .c(x79), .O(new_n393_));
  nand3  g242(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n394_));
  ...
  oai21  g248(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n400_));
  ...
  aoi21  g255(.a(new_n406_), .b(new_n243_), .c(x01), .O(z60));
  ...
  nor2   g278(.a(new_n258_), .b(x78), .O(new_n430_));
