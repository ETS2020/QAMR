// Benchmark "FAU" written by ABC on Mon Jul  6 20:02:10 2020
...
module FAU ( 
  ...
  nand4  g218(.a(new_n292_), .b(x14), .c(x04), .d(new_n153_), .O(new_n370_));
  nor3   g219(.a(new_n370_), .b(new_n170_), .c(x79), .O(z54));
  ...
  inv1   g243(.a(new_n170_), .O(new_n395_));
  oai21  g244(.a(new_n395_), .b(new_n160_), .c(new_n154_), .O(new_n396_));
  ...
  nand2  g279(.a(new_n395_), .b(x81), .O(new_n431_));
