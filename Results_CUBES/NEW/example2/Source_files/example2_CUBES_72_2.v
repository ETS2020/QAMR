// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:15 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n296_, new_n298_, new_n300_, new_n302_, new_n310_,
  ...
  nand4  g158(.a(new_n246_), .b(x78), .c(x77), .d(x63), .O(new_n310_));
  aoi21  g159(.a(new_n292_), .b(new_n288_), .c(new_n310_), .O(z45));
