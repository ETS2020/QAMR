// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:37 2020
...
module FAU ( 
  ...
  nand3  g181(.a(new_n154_), .b(new_n292_), .c(x08), .O(new_n333_));
  nand2  g182(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  nand3  g183(.a(new_n334_), .b(new_n236_), .c(new_n159_), .O(new_n335_));
