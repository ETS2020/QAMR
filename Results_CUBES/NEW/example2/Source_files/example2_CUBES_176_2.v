// Benchmark "FAU" written by ABC on Mon Jul  6 20:04:44 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n296_, new_n298_, new_n300_, new_n302_, new_n311_,
  ...
  nand4  g159(.a(new_n246_), .b(x78), .c(x77), .d(x64), .O(new_n311_));
  aoi21  g160(.a(new_n292_), .b(new_n288_), .c(new_n311_), .O(z46));
