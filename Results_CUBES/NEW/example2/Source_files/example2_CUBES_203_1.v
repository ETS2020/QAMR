// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:08 2020
...
module FAU ( 
  ...
  nand4  g241(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n393_));
  oai21  g242(.a(new_n393_), .b(new_n238_), .c(new_n392_), .O(new_n394_));
  nand2  g243(.a(new_n394_), .b(new_n236_), .O(new_n395_));
  nand3  g244(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(new_n395_), .O(new_n397_));
  nand2  g246(.a(new_n397_), .b(x77), .O(new_n398_));
  oai21  g247(.a(new_n372_), .b(new_n160_), .c(new_n154_), .O(new_n399_));
  aoi21  g248(.a(new_n399_), .b(new_n398_), .c(x01), .O(z58));
  aoi21  g249(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n401_));
  oai21  g250(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n402_));
  aoi21  g251(.a(new_n402_), .b(x79), .c(new_n163_), .O(new_n403_));
  ...
  aoi21  g256(.a(new_n382_), .b(x79), .c(new_n405_), .O(new_n408_));
  aoi21  g257(.a(new_n408_), .b(new_n243_), .c(x01), .O(z60));
  nand2  g258(.a(new_n171_), .b(new_n170_), .O(new_n410_));
  aoi22  g259(.a(new_n410_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n411_));
  nor3   g260(.a(new_n411_), .b(new_n377_), .c(x01), .O(z61));
  ...
  nand2  g264(.a(new_n402_), .b(x79), .O(new_n416_));
  ...
  nor2   g274(.a(new_n425_), .b(new_n411_), .O(z63));
  nand2  g275(.a(x83), .b(x79), .O(new_n427_));
  or2    g276(.a(new_n427_), .b(new_n411_), .O(new_n428_));
  nand3  g277(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n429_));
  aoi21  g278(.a(new_n429_), .b(new_n428_), .c(x01), .O(z64));
  nor2   g279(.a(new_n164_), .b(x04), .O(new_n431_));
  nor2   g280(.a(new_n258_), .b(x78), .O(new_n432_));
  oai21  g281(.a(new_n432_), .b(new_n431_), .c(x77), .O(new_n433_));
  nand2  g282(.a(new_n372_), .b(x81), .O(new_n434_));
  nand2  g283(.a(new_n173_), .b(x84), .O(new_n435_));
