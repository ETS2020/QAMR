...
module FAU ( 
  ...
  nand2  g131(.a(new_n246_), .b(new_n161_), .O(new_n283_));
  ...
  nor3   g145(.a(new_n296_), .b(new_n286_), .c(new_n285_), .O(z34));
  ...
  nor3   g154(.a(new_n296_), .b(new_n286_), .c(new_n199_), .O(z39));
  nor3   g155(.a(new_n296_), .b(new_n286_), .c(new_n196_), .O(z40));
  nor3   g156(.a(new_n296_), .b(new_n286_), .c(new_n193_), .O(z41));
  nor3   g157(.a(new_n296_), .b(new_n286_), .c(new_n190_), .O(z42));
  nor3   g158(.a(new_n296_), .b(new_n286_), .c(new_n187_), .O(z43));
  nor3   g159(.a(new_n296_), .b(new_n286_), .c(new_n184_), .O(z44));
  nor3   g160(.a(new_n296_), .b(new_n286_), .c(new_n181_), .O(z45));
  nor3   g161(.a(new_n296_), .b(new_n286_), .c(new_n178_), .O(z46));
  ...
  nand2  g214(.a(new_n285_), .b(x14), .O(new_n366_));
