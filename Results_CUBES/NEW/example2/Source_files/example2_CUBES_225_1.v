// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:31 2020
...
module FAU ( 
  ...
  nor2   g098(.a(new_n165_), .b(new_n154_), .O(new_n250_));
  nor2   g099(.a(x04), .b(x01), .O(new_n251_));
  inv1   g100(.a(new_n251_), .O(new_n252_));
  nor4   g101(.a(new_n252_), .b(new_n250_), .c(x43), .d(new_n249_), .O(z24));
  ...
  nand2  g128(.a(new_n237_), .b(new_n258_), .O(new_n280_));
  aoi21  g129(.a(new_n280_), .b(new_n279_), .c(new_n249_), .O(new_n281_));
  nor2   g130(.a(x81), .b(x42), .O(new_n282_));
  oai21  g131(.a(new_n282_), .b(new_n281_), .c(new_n259_), .O(new_n283_));
  nand3  g132(.a(x83), .b(new_n258_), .c(x42), .O(new_n284_));
  nand2  g133(.a(new_n237_), .b(x81), .O(new_n285_));
  aoi21  g134(.a(new_n285_), .b(new_n284_), .c(new_n249_), .O(new_n286_));
  nor2   g135(.a(new_n258_), .b(x42), .O(new_n287_));
  oai21  g136(.a(new_n287_), .b(new_n286_), .c(new_n256_), .O(new_n288_));
  inv1   g137(.a(new_n261_), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n251_), .O(new_n290_));
  aoi21  g139(.a(new_n288_), .b(new_n283_), .c(new_n290_), .O(z33));
  inv1   g140(.a(x52), .O(new_n292_));
  nand2  g141(.a(x83), .b(x42), .O(new_n293_));
  nand2  g142(.a(new_n293_), .b(new_n258_), .O(new_n294_));
  nand2  g143(.a(new_n294_), .b(new_n279_), .O(new_n295_));
  and2   g144(.a(new_n295_), .b(new_n259_), .O(new_n296_));
  nand2  g145(.a(new_n293_), .b(x81), .O(new_n297_));
  aoi21  g146(.a(new_n297_), .b(new_n284_), .c(new_n255_), .O(new_n298_));
  oai21  g147(.a(new_n298_), .b(new_n296_), .c(new_n289_), .O(new_n299_));
  nor3   g148(.a(new_n299_), .b(new_n252_), .c(new_n292_), .O(z34));
  nand2  g149(.a(new_n251_), .b(x53), .O(new_n301_));
  nor2   g150(.a(new_n301_), .b(new_n299_), .O(z35));
  nand2  g151(.a(new_n251_), .b(x54), .O(new_n303_));
  nor2   g152(.a(new_n303_), .b(new_n299_), .O(z36));
  nand2  g153(.a(new_n251_), .b(x55), .O(new_n305_));
  nor2   g154(.a(new_n305_), .b(new_n299_), .O(z37));
  nand2  g155(.a(new_n251_), .b(x56), .O(new_n307_));
  nor2   g156(.a(new_n307_), .b(new_n299_), .O(z38));
  nor3   g157(.a(new_n299_), .b(new_n252_), .c(new_n206_), .O(z39));
  nor3   g158(.a(new_n299_), .b(new_n252_), .c(new_n203_), .O(z40));
  nor3   g159(.a(new_n299_), .b(new_n252_), .c(new_n200_), .O(z41));
  nor3   g160(.a(new_n299_), .b(new_n252_), .c(new_n197_), .O(z42));
  nor3   g161(.a(new_n299_), .b(new_n252_), .c(new_n194_), .O(z43));
  nor3   g162(.a(new_n299_), .b(new_n252_), .c(new_n191_), .O(z44));
  nor3   g163(.a(new_n299_), .b(new_n252_), .c(new_n188_), .O(z45));
  nor3   g164(.a(new_n299_), .b(new_n252_), .c(new_n185_), .O(z46));
  inv1   g165(.a(x07), .O(new_n317_));
  nand2  g166(.a(x52), .b(x15), .O(new_n318_));
  oai21  g167(.a(x52), .b(new_n317_), .c(new_n318_), .O(new_n319_));
  nand3  g168(.a(new_n236_), .b(new_n154_), .c(new_n159_), .O(new_n320_));
  inv1   g169(.a(new_n320_), .O(new_n321_));
  nand2  g170(.a(new_n321_), .b(new_n319_), .O(new_n322_));
  nor2   g171(.a(x75), .b(x67), .O(new_n323_));
  inv1   g172(.a(new_n171_), .O(new_n324_));
  nand2  g173(.a(new_n324_), .b(x79), .O(new_n325_));
  nor2   g174(.a(new_n325_), .b(new_n323_), .O(new_n326_));
  nand2  g175(.a(new_n326_), .b(new_n233_), .O(new_n327_));
  ...
  inv1   g181(.a(new_n233_), .O(new_n333_));
  ...
  nand2  g216(.a(new_n292_), .b(x14), .O(new_n368_));
  inv1   g217(.a(new_n170_), .O(new_n369_));
  ...
  nand4  g221(.a(x84), .b(x83), .c(new_n372_), .d(new_n258_), .O(new_n373_));
  ...
  nor2   g226(.a(new_n165_), .b(new_n377_), .O(new_n378_));
  xnor2a g227(.a(x84), .b(x81), .O(new_n379_));
  aoi21  g228(.a(new_n171_), .b(new_n170_), .c(new_n379_), .O(new_n380_));
  aoi21  g229(.a(new_n380_), .b(new_n153_), .c(new_n378_), .O(new_n381_));
  nor2   g230(.a(x77), .b(x01), .O(new_n382_));
  aoi21  g231(.a(new_n382_), .b(new_n164_), .c(new_n246_), .O(new_n383_));
  oai21  g232(.a(new_n381_), .b(new_n154_), .c(new_n383_), .O(z56));
  inv1   g233(.a(x02), .O(new_n385_));
  nand3  g234(.a(new_n247_), .b(x03), .c(new_n385_), .O(new_n386_));
  inv1   g235(.a(new_n386_), .O(z57));
  nand4  g236(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n388_));
  oai22  g237(.a(new_n388_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n389_));
  nand3  g238(.a(new_n389_), .b(new_n236_), .c(x79), .O(new_n390_));
  nand3  g239(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n391_));
  nand2  g240(.a(new_n391_), .b(new_n390_), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(x77), .O(new_n393_));
  oai21  g242(.a(new_n369_), .b(new_n160_), .c(new_n154_), .O(new_n394_));
  aoi21  g243(.a(new_n394_), .b(new_n393_), .c(x01), .O(z58));
  aoi21  g244(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n396_));
  oai21  g245(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n397_));
  aoi21  g246(.a(new_n397_), .b(x79), .c(new_n163_), .O(new_n398_));
  ...
  aoi21  g251(.a(new_n380_), .b(x79), .c(new_n400_), .O(new_n403_));
  aoi21  g252(.a(new_n403_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g253(.a(new_n173_), .O(new_n405_));
  nand2  g254(.a(new_n171_), .b(new_n170_), .O(new_n406_));
  aoi22  g255(.a(new_n406_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n407_));
  nor3   g256(.a(new_n407_), .b(new_n405_), .c(new_n374_), .O(z61));
  nand3  g257(.a(x84), .b(x81), .c(x79), .O(new_n409_));
  oai21  g258(.a(x79), .b(new_n160_), .c(new_n409_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(new_n159_), .O(new_n411_));
  nand2  g260(.a(new_n397_), .b(x79), .O(new_n412_));
  nand3  g261(.a(x81), .b(x79), .c(new_n160_), .O(new_n413_));
  ...
  nand2  g267(.a(new_n418_), .b(new_n324_), .O(new_n419_));
  aoi21  g268(.a(new_n419_), .b(new_n417_), .c(x01), .O(z62));
  nor3   g269(.a(new_n407_), .b(new_n405_), .c(new_n372_), .O(z63));
  nand2  g270(.a(x83), .b(x79), .O(new_n422_));
  or2    g271(.a(new_n422_), .b(new_n407_), .O(new_n423_));
  nand3  g272(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n424_));
  aoi21  g273(.a(new_n424_), .b(new_n423_), .c(x01), .O(z64));
  nor2   g274(.a(new_n164_), .b(x04), .O(new_n426_));
  nor2   g275(.a(new_n258_), .b(x78), .O(new_n427_));
  oai21  g276(.a(new_n427_), .b(new_n426_), .c(x77), .O(new_n428_));
  nand2  g277(.a(new_n369_), .b(x81), .O(new_n429_));
  nand2  g278(.a(new_n173_), .b(x84), .O(new_n430_));
