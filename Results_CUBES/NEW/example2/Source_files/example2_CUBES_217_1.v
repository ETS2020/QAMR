// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:23 2020
...
module FAU ( 
  ...
  nand2  g115(.a(new_n264_), .b(new_n251_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z26));
  nand4  g117(.a(new_n262_), .b(new_n251_), .c(x45), .d(new_n254_), .O(new_n269_));
