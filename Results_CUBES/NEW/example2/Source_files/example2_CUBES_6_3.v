...
module FAU ( 
  ...
  inv1   g203(.a(new_n167_), .O(new_n355_));
  nand4  g204(.a(new_n355_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n356_));
  aoi21  g205(.a(new_n354_), .b(new_n353_), .c(new_n356_), .O(z52));
  ...
  aoi21  g214(.a(new_n365_), .b(new_n364_), .c(new_n356_), .O(z54));
  ...
  oai21  g238(.a(new_n355_), .b(new_n239_), .c(new_n154_), .O(new_n390_));
  ...
  nand2  g273(.a(new_n355_), .b(x81), .O(new_n425_));
