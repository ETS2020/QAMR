...
module FAU ( 
  ...
  nand4  g152(.a(new_n246_), .b(x78), .c(x77), .d(x57), .O(new_n304_));
  aoi21  g153(.a(new_n292_), .b(new_n288_), .c(new_n304_), .O(z39));
  nor3   g154(.a(new_n294_), .b(new_n284_), .c(new_n196_), .O(z40));
