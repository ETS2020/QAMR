...
module FAU ( 
  ...
  oai21  g070(.a(new_n220_), .b(new_n152_), .c(new_n221_), .O(z20));
  ...
  inv1   g110(.a(new_n248_), .O(new_n262_));
  nor4   g111(.a(new_n262_), .b(new_n235_), .c(new_n160_), .d(new_n220_), .O(new_n263_));
  and2   g112(.a(new_n263_), .b(new_n256_), .O(z27));
  ...
  nor3   g146(.a(new_n297_), .b(new_n262_), .c(new_n288_), .O(z34));
  ...
  nor3   g155(.a(new_n297_), .b(new_n262_), .c(new_n199_), .O(z39));
  nor3   g156(.a(new_n297_), .b(new_n262_), .c(new_n196_), .O(z40));
  nor3   g157(.a(new_n297_), .b(new_n262_), .c(new_n193_), .O(z41));
  nor3   g158(.a(new_n297_), .b(new_n262_), .c(new_n190_), .O(z42));
  nor3   g159(.a(new_n297_), .b(new_n262_), .c(new_n187_), .O(z43));
  nor3   g160(.a(new_n297_), .b(new_n262_), .c(new_n184_), .O(z44));
  nor3   g161(.a(new_n297_), .b(new_n262_), .c(new_n181_), .O(z45));
  nor3   g162(.a(new_n297_), .b(new_n262_), .c(new_n178_), .O(z46));
