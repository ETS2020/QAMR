...
module FAU ( 
  ...
  nand2  g181(.a(new_n292_), .b(x08), .O(new_n333_));
  inv1   g182(.a(new_n170_), .O(new_n334_));
  nand4  g183(.a(new_n334_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n335_));
  aoi21  g184(.a(new_n333_), .b(new_n332_), .c(new_n335_), .O(z48));
  inv1   g185(.a(x09), .O(new_n337_));
  nand2  g186(.a(x52), .b(x17), .O(new_n338_));
  oai21  g187(.a(x52), .b(new_n337_), .c(new_n338_), .O(new_n339_));
  nand2  g188(.a(new_n339_), .b(new_n324_), .O(new_n340_));
  inv1   g189(.a(new_n233_), .O(new_n341_));
  nor2   g190(.a(new_n328_), .b(new_n341_), .O(new_n342_));
  nand2  g191(.a(new_n342_), .b(x69), .O(new_n343_));
  aoi21  g192(.a(new_n343_), .b(new_n340_), .c(x01), .O(z49));
  ...
  nand2  g197(.a(new_n342_), .b(x70), .O(new_n349_));
  ...
  nand2  g203(.a(new_n342_), .b(x71), .O(new_n355_));
  ...
  nand2  g209(.a(new_n342_), .b(x72), .O(new_n361_));
  ...
  oai21  g243(.a(new_n334_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g278(.a(new_n334_), .b(x81), .O(new_n430_));
