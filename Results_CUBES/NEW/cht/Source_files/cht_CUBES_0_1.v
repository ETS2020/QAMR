// Benchmark "FAU" written by ABC on Mon Jul  6 13:18:02 2020
...
module FAU ( 
  ...
  nand3  g030(.a(x20), .b(new_n113_), .c(new_n103_), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z09));
  nand3  g032(.a(x22), .b(new_n113_), .c(x08), .O(new_n116_));
