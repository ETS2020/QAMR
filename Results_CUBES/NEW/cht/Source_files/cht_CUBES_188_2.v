...
module FAU ( 
  ...
  inv1   g084(.a(x10), .O(new_n168_));
  nand3  g085(.a(x14), .b(new_n168_), .c(x00), .O(new_n169_));
  inv1   g086(.a(x14), .O(new_n170_));
  nand2  g087(.a(x39), .b(new_n170_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(x09), .O(new_n173_));
  nand3  g090(.a(x38), .b(new_n168_), .c(new_n146_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(new_n173_), .O(z27));
  inv1   g092(.a(x39), .O(new_n176_));
  nand2  g093(.a(x40), .b(x09), .O(new_n177_));
  oai21  g094(.a(new_n176_), .b(x09), .c(new_n177_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n170_), .O(new_n179_));
  nor2   g096(.a(new_n170_), .b(x10), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(x39), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n179_), .O(z28));
  inv1   g099(.a(x40), .O(new_n183_));
  nand2  g100(.a(x41), .b(x09), .O(new_n184_));
  oai21  g101(.a(new_n183_), .b(x09), .c(new_n184_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n170_), .O(new_n186_));
  nand2  g103(.a(new_n180_), .b(x40), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z29));
  inv1   g105(.a(x41), .O(new_n189_));
  nand2  g106(.a(x42), .b(x09), .O(new_n190_));
  oai21  g107(.a(new_n189_), .b(x09), .c(new_n190_), .O(new_n191_));
  nand2  g108(.a(new_n191_), .b(new_n170_), .O(new_n192_));
  nand2  g109(.a(new_n180_), .b(x41), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n192_), .O(z30));
  inv1   g111(.a(x42), .O(new_n195_));
  nand2  g112(.a(x43), .b(x09), .O(new_n196_));
  oai21  g113(.a(new_n195_), .b(x09), .c(new_n196_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n170_), .O(new_n198_));
  nand2  g115(.a(new_n180_), .b(x42), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n198_), .O(z31));
  inv1   g117(.a(x43), .O(new_n201_));
  nand2  g118(.a(x44), .b(x09), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(x09), .c(new_n202_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n170_), .O(new_n204_));
  nand2  g121(.a(new_n180_), .b(x43), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n204_), .O(z32));
  inv1   g123(.a(x44), .O(new_n207_));
  nand2  g124(.a(x45), .b(x09), .O(new_n208_));
  oai21  g125(.a(new_n207_), .b(x09), .c(new_n208_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n170_), .O(new_n210_));
  nand2  g127(.a(new_n180_), .b(x44), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n210_), .O(z33));
  inv1   g129(.a(x45), .O(new_n213_));
  nand2  g130(.a(x46), .b(x09), .O(new_n214_));
  oai21  g131(.a(new_n213_), .b(x09), .c(new_n214_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n170_), .O(new_n216_));
  nand2  g133(.a(new_n180_), .b(x45), .O(new_n217_));
  nand2  g134(.a(new_n217_), .b(new_n216_), .O(z34));
  inv1   g135(.a(x46), .O(new_n219_));
  nand2  g136(.a(x09), .b(x00), .O(new_n220_));
  oai21  g137(.a(new_n219_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n170_), .O(new_n222_));
  nand2  g139(.a(new_n180_), .b(x46), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n222_), .O(z35));
endmodule
