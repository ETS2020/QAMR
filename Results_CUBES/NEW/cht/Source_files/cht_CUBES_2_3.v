...
module FAU ( 
  ...
  inv1   g076(.a(x10), .O(new_n160_));
  nand3  g077(.a(x35), .b(new_n160_), .c(new_n146_), .O(new_n161_));
  oai21  g078(.a(new_n159_), .b(new_n146_), .c(new_n161_), .O(z24));
  nand3  g079(.a(x37), .b(new_n160_), .c(x09), .O(new_n163_));
  oai21  g080(.a(new_n159_), .b(x09), .c(new_n163_), .O(z25));
