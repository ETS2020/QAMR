// Benchmark "FAU" written by ABC on Mon Jul  6 13:19:03 2020
...
module FAU ( 
  ...
  inv1   g073(.a(x10), .O(new_n157_));
  nand3  g074(.a(x34), .b(new_n157_), .c(new_n146_), .O(new_n158_));
  oai21  g075(.a(new_n156_), .b(new_n146_), .c(new_n158_), .O(z23));
  nand3  g076(.a(x36), .b(new_n157_), .c(x09), .O(new_n160_));
  oai21  g077(.a(new_n156_), .b(x09), .c(new_n160_), .O(z24));
