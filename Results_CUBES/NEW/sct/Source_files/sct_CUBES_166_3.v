...
module FAU ( 
  ...
  nand3  g16(.a(x16), .b(new_n43_), .c(x02), .O(new_n51_));
  inv1   g17(.a(x08), .O(new_n52_));
  nand2  g18(.a(new_n44_), .b(new_n52_), .O(new_n53_));
  ...
  nand4  g35(.a(new_n69_), .b(new_n66_), .c(new_n62_), .d(x04), .O(z06));
  nand2  g36(.a(new_n69_), .b(x11), .O(new_n71_));
  inv1   g37(.a(x10), .O(new_n72_));
  inv1   g38(.a(x11), .O(new_n73_));
  nand4  g39(.a(new_n67_), .b(new_n73_), .c(new_n72_), .d(new_n63_), .O(new_n74_));
  nand4  g40(.a(new_n74_), .b(new_n71_), .c(new_n62_), .d(x04), .O(z07));
  ...
  nand4  g44(.a(new_n78_), .b(new_n76_), .c(new_n62_), .d(x04), .O(z08));
  inv1   g45(.a(x12), .O(new_n80_));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n80_), .c(new_n73_), .d(new_n72_), .O(new_n82_));
  nand2  g48(.a(x16), .b(new_n35_), .O(new_n83_));
  oai21  g49(.a(new_n82_), .b(new_n64_), .c(new_n83_), .O(new_n84_));
  nand2  g50(.a(new_n84_), .b(x04), .O(new_n85_));
  oai21  g51(.a(new_n44_), .b(new_n43_), .c(x04), .O(new_n86_));
  aoi21  g52(.a(new_n78_), .b(x13), .c(new_n86_), .O(new_n87_));
  nand2  g53(.a(new_n87_), .b(new_n85_), .O(z09));
  inv1   g54(.a(new_n64_), .O(new_n89_));
  inv1   g55(.a(x00), .O(new_n90_));
  nand2  g56(.a(new_n82_), .b(new_n90_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g58(.a(new_n45_), .b(x14), .O(new_n93_));
  aoi21  g59(.a(new_n93_), .b(new_n92_), .c(new_n40_), .O(z10));
  aoi21  g60(.a(new_n83_), .b(new_n43_), .c(new_n40_), .O(z12));
