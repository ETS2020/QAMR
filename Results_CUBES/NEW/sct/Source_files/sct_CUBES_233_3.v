// Benchmark "FAU" written by ABC on Mon Jul  6 14:35:02 2020
...
module FAU ( 
  ...
  nand3  g31(.a(new_n56_), .b(new_n65_), .c(new_n54_), .O(new_n66_));
  nand3  g32(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand2  g33(.a(new_n65_), .b(new_n54_), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n55_), .c(x11), .O(new_n69_));
  nor2   g35(.a(x11), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n56_), .c(new_n54_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n63_), .O(z07));
  nand2  g38(.a(new_n70_), .b(new_n54_), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n55_), .c(x12), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n65_), .d(new_n54_), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n56_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n63_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n76_), .c(new_n75_), .d(new_n65_), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(new_n59_), .O(new_n83_));
  nor2   g49(.a(new_n44_), .b(x02), .O(new_n84_));
  aoi21  g50(.a(new_n83_), .b(new_n47_), .c(new_n84_), .O(new_n85_));
  oai21  g51(.a(new_n77_), .b(new_n55_), .c(x13), .O(new_n86_));
  ...
  nand4  g57(.a(new_n91_), .b(new_n47_), .c(x06), .d(x04), .O(new_n92_));
  aoi21  g58(.a(new_n82_), .b(new_n89_), .c(new_n92_), .O(z10));
