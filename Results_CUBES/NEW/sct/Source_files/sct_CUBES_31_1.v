...
module FAU ( 
  ...
  or2    g36(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n68_), .c(new_n61_), .O(z07));
  nand2  g38(.a(x08), .b(x06), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n70_), .c(x12), .O(new_n74_));
  inv1   g40(.a(x12), .O(new_n75_));
  nand4  g41(.a(new_n75_), .b(new_n69_), .c(new_n63_), .d(new_n58_), .O(new_n76_));
  inv1   g42(.a(new_n76_), .O(new_n77_));
  nand2  g43(.a(new_n77_), .b(new_n64_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n74_), .c(new_n61_), .O(z08));
  inv1   g45(.a(x13), .O(new_n80_));
  nand4  g46(.a(new_n80_), .b(new_n75_), .c(new_n69_), .d(new_n63_), .O(new_n81_));
