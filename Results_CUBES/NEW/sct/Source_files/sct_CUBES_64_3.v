...
module FAU ( 
  ...
  nand3  g50(.a(new_n84_), .b(new_n74_), .c(new_n83_), .O(new_n85_));
  aoi21  g51(.a(new_n82_), .b(new_n80_), .c(new_n85_), .O(new_n86_));
  nor2   g52(.a(new_n81_), .b(x02), .O(new_n87_));
  aoi21  g53(.a(new_n86_), .b(new_n79_), .c(new_n87_), .O(new_n88_));
  oai21  g54(.a(new_n75_), .b(new_n54_), .c(x13), .O(new_n89_));
  nand2  g55(.a(x16), .b(x03), .O(new_n90_));
  nand4  g56(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x04), .O(z09));
  inv1   g57(.a(x00), .O(new_n92_));
  aoi21  g58(.a(new_n44_), .b(x16), .c(new_n92_), .O(new_n93_));
  oai21  g59(.a(new_n93_), .b(new_n86_), .c(new_n79_), .O(new_n94_));
  nand2  g60(.a(new_n46_), .b(x14), .O(new_n95_));
  aoi21  g61(.a(new_n95_), .b(new_n94_), .c(new_n40_), .O(z10));
  nor2   g62(.a(new_n87_), .b(x03), .O(new_n97_));
