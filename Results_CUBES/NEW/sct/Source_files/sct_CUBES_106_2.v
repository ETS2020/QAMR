...
module FAU ( 
  ...
  nand2  g36(.a(new_n64_), .b(new_n68_), .O(new_n71_));
  oai21  g37(.a(new_n71_), .b(new_n54_), .c(x12), .O(new_n72_));
  inv1   g38(.a(x12), .O(new_n73_));
  nand3  g39(.a(new_n64_), .b(new_n73_), .c(new_n68_), .O(new_n74_));
  ...
  nand4  g46(.a(new_n80_), .b(new_n73_), .c(new_n68_), .d(new_n79_), .O(new_n81_));
  nor2   g47(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  nor2   g48(.a(new_n44_), .b(x02), .O(new_n83_));
  aoi21  g49(.a(new_n82_), .b(new_n78_), .c(new_n83_), .O(new_n84_));
  oai21  g50(.a(new_n74_), .b(new_n54_), .c(x13), .O(new_n85_));
  nand2  g51(.a(x16), .b(x03), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(x04), .O(z09));
  nand2  g53(.a(new_n44_), .b(x00), .O(new_n88_));
  oai21  g54(.a(new_n81_), .b(new_n45_), .c(new_n88_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n78_), .O(new_n90_));
  nand2  g56(.a(new_n45_), .b(x14), .O(new_n91_));
  aoi21  g57(.a(new_n91_), .b(new_n90_), .c(new_n40_), .O(z10));
  nor2   g58(.a(new_n83_), .b(x03), .O(new_n93_));
