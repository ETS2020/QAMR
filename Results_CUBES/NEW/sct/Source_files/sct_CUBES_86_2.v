...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n43_,
    ...
    new_n78_, new_n80_, new_n82_, new_n83_, new_n84_, new_n87_, new_n88_,
    new_n89_;
  ...
  aoi21  g33(.a(new_n44_), .b(x16), .c(new_n52_), .O(new_n68_));
  nand2  g34(.a(x10), .b(x09), .O(new_n69_));
  nand2  g35(.a(new_n69_), .b(new_n61_), .O(new_n70_));
  aoi21  g36(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  nand2  g37(.a(x10), .b(new_n52_), .O(new_n72_));
  nand4  g38(.a(new_n72_), .b(new_n71_), .c(new_n65_), .d(x04), .O(z06));
  oai21  g39(.a(new_n40_), .b(x02), .c(new_n43_), .O(new_n74_));
  nand2  g40(.a(new_n74_), .b(x16), .O(new_n75_));
  nor2   g41(.a(x11), .b(new_n40_), .O(new_n76_));
  nand2  g42(.a(new_n76_), .b(new_n75_), .O(z07));
  nor2   g43(.a(x12), .b(new_n40_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n75_), .O(z08));
  nor2   g45(.a(x13), .b(new_n40_), .O(new_n80_));
  nand2  g46(.a(new_n80_), .b(new_n75_), .O(z09));
  nor3   g47(.a(x09), .b(new_n51_), .c(new_n53_), .O(new_n82_));
  nand4  g48(.a(new_n82_), .b(new_n45_), .c(x06), .d(x00), .O(new_n83_));
  nand2  g49(.a(new_n46_), .b(x14), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n83_), .c(new_n40_), .O(z10));
  aoi21  g51(.a(new_n61_), .b(new_n43_), .c(new_n40_), .O(z12));
  oai21  g52(.a(new_n67_), .b(new_n52_), .c(new_n45_), .O(new_n87_));
  nand4  g53(.a(new_n69_), .b(new_n61_), .c(new_n60_), .d(new_n43_), .O(new_n88_));
