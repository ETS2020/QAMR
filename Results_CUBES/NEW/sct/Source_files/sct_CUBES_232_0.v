...
module FAU ( 
  ...
  nand4  g42(.a(new_n76_), .b(new_n73_), .c(new_n69_), .d(new_n68_), .O(new_n77_));
  ...
  aoi21  g47(.a(new_n74_), .b(x13), .c(new_n81_), .O(new_n82_));
  nand2  g48(.a(new_n82_), .b(new_n80_), .O(z09));
  inv1   g49(.a(new_n59_), .O(new_n84_));
  inv1   g50(.a(x00), .O(new_n85_));
  oai21  g51(.a(new_n45_), .b(new_n85_), .c(new_n77_), .O(new_n86_));
