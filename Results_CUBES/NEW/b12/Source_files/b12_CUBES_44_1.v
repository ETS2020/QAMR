// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:18 2020
...
module FAU ( 
  ...
  aoi21  g45(.a(new_n69_), .b(new_n25_), .c(new_n57_), .O(new_n70_));
  ...
  nand2  g56(.a(new_n80_), .b(new_n57_), .O(new_n81_));
  ...
  nand2  g67(.a(new_n68_), .b(new_n57_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n62_), .O(z8));
endmodule
