...
module FAU ( 
  ...
  nor2   g41(.a(x08), .b(new_n56_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(new_n67_));
  oai21  g43(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n59_), .c(new_n25_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n67_), .c(new_n45_), .O(z6));
  nand3  g46(.a(x09), .b(x03), .c(new_n30_), .O(new_n71_));
  ...
  aoi21  g57(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
