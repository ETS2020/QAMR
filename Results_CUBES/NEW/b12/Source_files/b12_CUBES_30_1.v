...
module FAU ( 
  ...
  oai22  g39(.a(x10), .b(new_n25_), .c(x09), .d(new_n34_), .O(new_n64_));
  nand2  g40(.a(new_n30_), .b(new_n56_), .O(new_n65_));
  oai21  g41(.a(x08), .b(new_n56_), .c(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  aoi21  g43(.a(x09), .b(new_n34_), .c(x02), .O(new_n68_));
  nand2  g44(.a(new_n59_), .b(new_n25_), .O(new_n69_));
  nand2  g45(.a(x01), .b(new_n56_), .O(new_n70_));
  oai22  g46(.a(new_n70_), .b(x14), .c(new_n69_), .d(new_n68_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n41_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n67_), .c(x07), .O(z6));
