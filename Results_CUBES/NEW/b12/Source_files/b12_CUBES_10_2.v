// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:02 2020
...
module FAU ( 
  ...
  nand2  g40(.a(new_n30_), .b(new_n56_), .O(new_n65_));
  inv1   g41(.a(x08), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x00), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n25_), .O(new_n68_));
  nand2  g44(.a(x09), .b(new_n34_), .O(new_n69_));
  nand2  g45(.a(new_n59_), .b(new_n25_), .O(new_n70_));
  aoi21  g46(.a(new_n69_), .b(new_n30_), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n41_), .O(new_n72_));
  inv1   g48(.a(x14), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x02), .c(new_n56_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n72_), .c(x07), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n30_), .O(new_n76_));
  nand4  g52(.a(new_n41_), .b(new_n66_), .c(new_n40_), .d(x02), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n66_), .c(new_n45_), .O(new_n81_));
  ...
  aoi21  g61(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n86_));
