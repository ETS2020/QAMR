...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(new_n61_), .c(new_n41_), .d(new_n40_), .O(z5));
  inv1   g40(.a(x08), .O(new_n65_));
  aoi21  g41(.a(x09), .b(new_n34_), .c(x02), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(x03), .c(new_n30_), .O(new_n68_));
  oai21  g44(.a(new_n66_), .b(x01), .c(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n65_), .b(new_n56_), .c(new_n69_), .O(new_n70_));
  aoi21  g46(.a(x14), .b(x02), .c(x00), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n56_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(x01), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n70_), .c(new_n45_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n30_), .O(new_n75_));
  nand4  g51(.a(new_n41_), .b(new_n65_), .c(new_n40_), .d(x02), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n65_), .c(new_n45_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n78_), .O(z7));
  nand2  g57(.a(new_n61_), .b(new_n30_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n79_), .c(x09), .O(new_n83_));
  aoi21  g59(.a(new_n67_), .b(new_n56_), .c(new_n45_), .O(new_n84_));
