// Benchmark "FAU" written by ABC on Mon Jul  6 20:47:38 2020
...
module FAU ( 
  ...
  nand3  g1126(.a(new_n1217_), .b(x21), .c(new_n495_), .O(new_n1218_));
  nor2   g1127(.a(new_n1218_), .b(new_n1117_), .O(z32));
  ...
  nand2  g1272(.a(new_n460_), .b(new_n495_), .O(new_n1364_));
  ...
  nand2  g1277(.a(new_n112_), .b(x13), .O(new_n1369_));
  nand3  g1278(.a(new_n1217_), .b(new_n680_), .c(x21), .O(new_n1370_));
  nand2  g1279(.a(new_n103_), .b(new_n495_), .O(new_n1371_));
  ...
  nor2   g1315(.a(x30), .b(x23), .O(new_n1407_));
  nand4  g1316(.a(new_n1407_), .b(new_n99_), .c(new_n112_), .d(new_n495_), .O(new_n1408_));
  inv1   g1317(.a(new_n1408_), .O(new_n1409_));
  oai21  g1318(.a(new_n1409_), .b(new_n1406_), .c(new_n150_), .O(new_n1410_));
  oai21  g1319(.a(new_n1403_), .b(new_n103_), .c(new_n1410_), .O(new_n1411_));
  oai21  g1320(.a(new_n1411_), .b(new_n1391_), .c(x20), .O(new_n1412_));
  aoi21  g1321(.a(new_n107_), .b(new_n94_), .c(new_n109_), .O(new_n1413_));
  nand3  g1322(.a(new_n93_), .b(new_n109_), .c(x09), .O(new_n1414_));
  nor3   g1323(.a(new_n1414_), .b(new_n616_), .c(new_n172_), .O(new_n1415_));
  nor2   g1324(.a(new_n362_), .b(new_n114_), .O(new_n1416_));
  oai21  g1325(.a(new_n1415_), .b(new_n1413_), .c(new_n1416_), .O(new_n1417_));
  nand3  g1326(.a(new_n1417_), .b(new_n1412_), .c(new_n1378_), .O(z36));
  xor2a  g1327(.a(x44), .b(x43), .O(new_n1419_));
  aoi21  g1328(.a(new_n1419_), .b(new_n109_), .c(new_n790_), .O(new_n1420_));
  nand2  g1329(.a(x40), .b(new_n109_), .O(new_n1421_));
  oai21  g1330(.a(new_n1420_), .b(x40), .c(new_n1421_), .O(new_n1422_));
  nor2   g1331(.a(x42), .b(x39), .O(new_n1423_));
  nor2   g1332(.a(new_n277_), .b(x19), .O(new_n1424_));
  aoi21  g1333(.a(new_n1423_), .b(new_n1422_), .c(new_n1424_), .O(new_n1425_));
  oai21  g1334(.a(new_n611_), .b(x00), .c(new_n265_), .O(new_n1426_));
  oai21  g1335(.a(new_n1425_), .b(new_n967_), .c(new_n1426_), .O(new_n1427_));
  oai21  g1336(.a(new_n340_), .b(new_n147_), .c(new_n439_), .O(new_n1428_));
  aoi21  g1337(.a(new_n1427_), .b(new_n103_), .c(new_n1428_), .O(new_n1429_));
  nand2  g1338(.a(new_n148_), .b(x00), .O(new_n1430_));
  nand3  g1339(.a(new_n1430_), .b(new_n94_), .c(new_n112_), .O(new_n1431_));
  nand2  g1340(.a(new_n1431_), .b(new_n109_), .O(new_n1432_));
  oai21  g1341(.a(x28), .b(new_n157_), .c(new_n91_), .O(new_n1433_));
  nand3  g1342(.a(new_n1433_), .b(new_n594_), .c(x22), .O(new_n1434_));
  nand2  g1343(.a(new_n1434_), .b(new_n1432_), .O(new_n1435_));
  aoi21  g1344(.a(new_n1238_), .b(new_n1199_), .c(new_n103_), .O(new_n1436_));
  aoi21  g1345(.a(new_n1435_), .b(x20), .c(new_n1436_), .O(new_n1437_));
  oai21  g1346(.a(new_n1429_), .b(x20), .c(new_n1437_), .O(new_n1438_));
  oai21  g1347(.a(new_n181_), .b(new_n91_), .c(new_n234_), .O(new_n1439_));
  nor2   g1348(.a(x04), .b(new_n91_), .O(new_n1440_));
  aoi21  g1349(.a(new_n1440_), .b(x28), .c(new_n93_), .O(new_n1441_));
  aoi21  g1350(.a(new_n1439_), .b(new_n93_), .c(new_n1441_), .O(new_n1442_));
  nand3  g1351(.a(new_n103_), .b(new_n321_), .c(new_n91_), .O(new_n1443_));
  nand3  g1352(.a(new_n1443_), .b(new_n211_), .c(x26), .O(new_n1444_));
  oai21  g1353(.a(new_n1442_), .b(new_n109_), .c(new_n1444_), .O(new_n1445_));
  oai22  g1354(.a(new_n1293_), .b(new_n1308_), .c(new_n306_), .d(new_n93_), .O(new_n1446_));
  nand2  g1355(.a(new_n1446_), .b(x22), .O(new_n1447_));
  nand2  g1356(.a(new_n1014_), .b(new_n231_), .O(new_n1448_));
  oai21  g1357(.a(new_n1331_), .b(x19), .c(new_n1448_), .O(new_n1449_));
  aoi21  g1358(.a(new_n1449_), .b(new_n103_), .c(new_n136_), .O(new_n1450_));
  oai21  g1359(.a(new_n1450_), .b(new_n112_), .c(new_n1447_), .O(new_n1451_));
  aoi21  g1360(.a(new_n1445_), .b(new_n112_), .c(new_n1451_), .O(new_n1452_));
  oai21  g1361(.a(new_n1452_), .b(new_n92_), .c(new_n317_), .O(new_n1453_));
  aoi21  g1362(.a(new_n1438_), .b(new_n92_), .c(new_n1453_), .O(new_n1454_));
  oai21  g1363(.a(x21), .b(new_n1393_), .c(x16), .O(new_n1455_));
  inv1   g1364(.a(x07), .O(new_n1456_));
  oai21  g1365(.a(x21), .b(new_n1456_), .c(new_n1153_), .O(new_n1457_));
  aoi21  g1366(.a(new_n1457_), .b(new_n1455_), .c(x18), .O(new_n1458_));
  oai21  g1367(.a(new_n1458_), .b(new_n112_), .c(x22), .O(new_n1459_));
  aoi21  g1368(.a(new_n1459_), .b(new_n475_), .c(new_n93_), .O(new_n1460_));
  nand2  g1369(.a(new_n297_), .b(new_n184_), .O(new_n1461_));
  inv1   g1370(.a(new_n1461_), .O(new_n1462_));
  oai21  g1371(.a(new_n1462_), .b(new_n1460_), .c(x19), .O(new_n1463_));
  nand3  g1372(.a(new_n297_), .b(x20), .c(x17), .O(new_n1464_));
  aoi21  g1373(.a(new_n1464_), .b(new_n364_), .c(new_n92_), .O(new_n1465_));
  nor2   g1374(.a(x21), .b(x18), .O(new_n1466_));
  oai21  g1375(.a(new_n1466_), .b(new_n1465_), .c(new_n109_), .O(new_n1467_));
  aoi21  g1376(.a(new_n1467_), .b(new_n1463_), .c(new_n103_), .O(new_n1468_));
  nand2  g1377(.a(new_n540_), .b(new_n92_), .O(new_n1469_));
  nand2  g1378(.a(new_n698_), .b(x18), .O(new_n1470_));
  aoi21  g1379(.a(new_n1470_), .b(new_n1469_), .c(x19), .O(new_n1471_));
  inv1   g1380(.a(x13), .O(new_n1472_));
  nor2   g1381(.a(x28), .b(new_n1472_), .O(new_n1473_));
  oai21  g1382(.a(new_n1473_), .b(new_n1471_), .c(new_n112_), .O(new_n1474_));
  nand3  g1383(.a(new_n1217_), .b(new_n498_), .c(x21), .O(new_n1475_));
  nand2  g1384(.a(new_n1475_), .b(new_n1474_), .O(new_n1476_));
  nand2  g1385(.a(new_n1476_), .b(new_n495_), .O(new_n1477_));
  nand2  g1386(.a(new_n1477_), .b(new_n1005_), .O(new_n1478_));
  oai21  g1387(.a(new_n1478_), .b(new_n1468_), .c(new_n150_), .O(new_n1479_));
  oai21  g1388(.a(new_n1454_), .b(new_n150_), .c(new_n1479_), .O(new_n1480_));
  nand2  g1389(.a(new_n1480_), .b(new_n120_), .O(new_n1481_));
  inv1   g1390(.a(new_n1084_), .O(new_n1482_));
  nor2   g1391(.a(new_n521_), .b(x05), .O(new_n1483_));
  oai21  g1392(.a(new_n1483_), .b(new_n1148_), .c(new_n1080_), .O(new_n1484_));
  nand4  g1393(.a(x25), .b(new_n194_), .c(new_n157_), .d(x00), .O(new_n1485_));
  nand2  g1394(.a(new_n1485_), .b(new_n1137_), .O(new_n1486_));
  nand2  g1395(.a(new_n1486_), .b(x10), .O(new_n1487_));
  nand2  g1396(.a(new_n1013_), .b(x18), .O(new_n1488_));
  nand2  g1397(.a(new_n1488_), .b(new_n1102_), .O(new_n1489_));
  nand3  g1398(.a(x18), .b(x15), .c(new_n157_), .O(new_n1490_));
  inv1   g1399(.a(new_n1490_), .O(new_n1491_));
  aoi21  g1400(.a(new_n1489_), .b(x05), .c(new_n1491_), .O(new_n1492_));
  nand3  g1401(.a(new_n1492_), .b(new_n1487_), .c(new_n1484_), .O(new_n1493_));
  aoi21  g1402(.a(new_n1493_), .b(x21), .c(new_n1482_), .O(new_n1494_));
  oai21  g1403(.a(new_n1494_), .b(x19), .c(new_n1087_), .O(new_n1495_));
  nand2  g1404(.a(new_n995_), .b(new_n1199_), .O(new_n1496_));
  nand2  g1405(.a(new_n1496_), .b(x00), .O(new_n1497_));
  aoi21  g1406(.a(new_n1497_), .b(new_n576_), .c(new_n92_), .O(new_n1498_));
  aoi21  g1407(.a(new_n1495_), .b(new_n103_), .c(new_n1498_), .O(new_n1499_));
  oai21  g1408(.a(new_n128_), .b(x22), .c(x20), .O(new_n1500_));
  oai21  g1409(.a(new_n144_), .b(new_n103_), .c(new_n93_), .O(new_n1501_));
  nand3  g1410(.a(new_n1501_), .b(new_n1500_), .c(new_n149_), .O(new_n1502_));
  nand2  g1411(.a(new_n1502_), .b(new_n109_), .O(new_n1503_));
  aoi21  g1412(.a(new_n1324_), .b(new_n675_), .c(new_n260_), .O(new_n1504_));
  oai21  g1413(.a(x03), .b(new_n155_), .c(x20), .O(new_n1505_));
  aoi21  g1414(.a(new_n172_), .b(x19), .c(new_n1505_), .O(new_n1506_));
  oai21  g1415(.a(new_n1506_), .b(new_n1504_), .c(x28), .O(new_n1507_));
  nand2  g1416(.a(new_n148_), .b(new_n136_), .O(new_n1508_));
  nand3  g1417(.a(new_n1508_), .b(new_n1507_), .c(new_n1503_), .O(new_n1509_));
  nand2  g1418(.a(new_n1509_), .b(new_n112_), .O(new_n1510_));
  nand3  g1419(.a(new_n103_), .b(x22), .c(x20), .O(new_n1511_));
  oai21  g1420(.a(new_n1511_), .b(new_n195_), .c(new_n103_), .O(new_n1512_));
  nand2  g1421(.a(new_n1512_), .b(x00), .O(new_n1513_));
  aoi21  g1422(.a(new_n194_), .b(new_n157_), .c(new_n246_), .O(new_n1514_));
  nand2  g1423(.a(new_n1111_), .b(new_n1013_), .O(new_n1515_));
  oai21  g1424(.a(new_n1515_), .b(new_n1514_), .c(new_n103_), .O(new_n1516_));
  aoi21  g1425(.a(new_n1516_), .b(new_n1513_), .c(new_n109_), .O(new_n1517_));
  nand2  g1426(.a(new_n1276_), .b(new_n93_), .O(new_n1518_));
  inv1   g1427(.a(new_n1040_), .O(new_n1519_));
  oai21  g1428(.a(new_n1519_), .b(new_n106_), .c(new_n1240_), .O(new_n1520_));
  ...
  nand2  g1432(.a(new_n1094_), .b(new_n112_), .O(new_n1524_));
  aoi22  g1433(.a(new_n987_), .b(x00), .c(new_n292_), .d(new_n109_), .O(new_n1525_));
  aoi21  g1434(.a(new_n1525_), .b(new_n1524_), .c(new_n183_), .O(new_n1526_));
  aoi21  g1435(.a(new_n1523_), .b(new_n92_), .c(new_n1526_), .O(new_n1527_));
  oai21  g1436(.a(new_n1499_), .b(new_n93_), .c(new_n1527_), .O(new_n1528_));
  nand2  g1437(.a(new_n1528_), .b(new_n150_), .O(new_n1529_));
  nand2  g1438(.a(new_n1011_), .b(x21), .O(new_n1530_));
  oai21  g1439(.a(new_n333_), .b(x17), .c(x18), .O(new_n1531_));
  nand2  g1440(.a(new_n1531_), .b(new_n112_), .O(new_n1532_));
  aoi21  g1441(.a(new_n1532_), .b(new_n1530_), .c(x19), .O(new_n1533_));
  nor2   g1442(.a(x05), .b(x00), .O(new_n1534_));
  oai22  g1443(.a(new_n1534_), .b(new_n475_), .c(new_n251_), .d(x18), .O(new_n1535_));
  aoi22  g1444(.a(new_n1535_), .b(x19), .c(new_n639_), .d(new_n92_), .O(new_n1536_));
  nand3  g1445(.a(new_n297_), .b(new_n116_), .c(new_n93_), .O(new_n1537_));
  oai21  g1446(.a(new_n1536_), .b(new_n93_), .c(new_n1537_), .O(new_n1538_));
  oai21  g1447(.a(new_n1538_), .b(new_n1533_), .c(new_n103_), .O(new_n1539_));
  nor2   g1448(.a(new_n828_), .b(x18), .O(new_n1540_));
  aoi21  g1449(.a(new_n207_), .b(x18), .c(new_n1540_), .O(new_n1541_));
  oai21  g1450(.a(new_n467_), .b(new_n201_), .c(x18), .O(new_n1542_));
  oai21  g1451(.a(new_n1541_), .b(new_n103_), .c(new_n1542_), .O(new_n1543_));
  aoi22  g1452(.a(new_n1543_), .b(x19), .c(new_n201_), .d(new_n99_), .O(new_n1544_));
  nand2  g1453(.a(new_n1544_), .b(new_n1539_), .O(new_n1545_));
  nand2  g1454(.a(new_n103_), .b(new_n352_), .O(new_n1546_));
  aoi21  g1455(.a(new_n1546_), .b(new_n99_), .c(new_n116_), .O(new_n1547_));
  oai22  g1456(.a(new_n1547_), .b(new_n172_), .c(new_n117_), .d(new_n1013_), .O(new_n1548_));
  aoi22  g1457(.a(new_n1548_), .b(x21), .c(new_n465_), .d(new_n402_), .O(new_n1549_));
  nand2  g1458(.a(new_n116_), .b(x21), .O(new_n1550_));
  aoi21  g1459(.a(new_n246_), .b(new_n104_), .c(new_n1550_), .O(new_n1551_));
  nor2   g1460(.a(new_n1551_), .b(new_n534_), .O(new_n1552_));
  oai21  g1461(.a(new_n1549_), .b(x20), .c(new_n1552_), .O(new_n1553_));
  aoi21  g1462(.a(new_n1545_), .b(x29), .c(new_n1553_), .O(new_n1554_));
  nand2  g1463(.a(new_n1554_), .b(new_n1529_), .O(new_n1555_));
  inv1   g1464(.a(new_n756_), .O(new_n1556_));
  oai21  g1465(.a(new_n1102_), .b(x18), .c(new_n1556_), .O(new_n1557_));
  nand2  g1466(.a(new_n1557_), .b(x20), .O(new_n1558_));
  nand2  g1467(.a(new_n1069_), .b(new_n347_), .O(new_n1559_));
  aoi21  g1468(.a(new_n1559_), .b(new_n1558_), .c(new_n340_), .O(new_n1560_));
  aoi21  g1469(.a(new_n1555_), .b(x30), .c(new_n1560_), .O(new_n1561_));
  nand2  g1470(.a(new_n1561_), .b(new_n1481_), .O(z37));
  inv1   g1471(.a(new_n637_), .O(new_n1563_));
  xor2a  g1472(.a(x20), .b(x02), .O(new_n1564_));
  nor3   g1473(.a(new_n1564_), .b(new_n222_), .c(new_n103_), .O(new_n1565_));
  aoi21  g1474(.a(new_n1040_), .b(new_n392_), .c(new_n200_), .O(new_n1566_));
  oai21  g1475(.a(new_n1566_), .b(new_n1565_), .c(new_n92_), .O(new_n1567_));
  oai21  g1476(.a(new_n196_), .b(new_n93_), .c(new_n229_), .O(new_n1568_));
  oai21  g1477(.a(new_n667_), .b(new_n486_), .c(new_n1568_), .O(new_n1569_));
  nand2  g1478(.a(new_n1569_), .b(x18), .O(new_n1570_));
  aoi21  g1479(.a(new_n1570_), .b(new_n1567_), .c(x19), .O(new_n1571_));
  nand2  g1480(.a(new_n307_), .b(new_n233_), .O(new_n1572_));
  nand2  g1481(.a(new_n201_), .b(x24), .O(new_n1573_));
  aoi21  g1482(.a(new_n1573_), .b(new_n1572_), .c(new_n92_), .O(new_n1574_));
  oai21  g1483(.a(new_n1574_), .b(new_n1349_), .c(x19), .O(new_n1575_));
  nand4  g1484(.a(new_n285_), .b(new_n196_), .c(x20), .d(new_n92_), .O(new_n1576_));
  nand2  g1485(.a(new_n1576_), .b(new_n1575_), .O(new_n1577_));
  oai21  g1486(.a(new_n1577_), .b(new_n1571_), .c(new_n150_), .O(new_n1578_));
  nand3  g1487(.a(new_n1185_), .b(new_n410_), .c(new_n207_), .O(new_n1579_));
  aoi21  g1488(.a(new_n1579_), .b(new_n1578_), .c(new_n120_), .O(new_n1580_));
  nand3  g1489(.a(new_n698_), .b(new_n109_), .c(new_n161_), .O(new_n1581_));
  aoi21  g1490(.a(new_n1581_), .b(new_n1324_), .c(x05), .O(new_n1582_));
  nand2  g1491(.a(new_n517_), .b(x19), .O(new_n1583_));
  nand2  g1492(.a(new_n148_), .b(new_n109_), .O(new_n1584_));
  aoi21  g1493(.a(new_n1584_), .b(new_n1583_), .c(new_n93_), .O(new_n1585_));
  oai21  g1494(.a(new_n1585_), .b(new_n1582_), .c(new_n92_), .O(new_n1586_));
  oai21  g1495(.a(new_n139_), .b(x04), .c(new_n315_), .O(new_n1587_));
  nand2  g1496(.a(new_n1587_), .b(x20), .O(new_n1588_));
  nand2  g1497(.a(new_n1058_), .b(x19), .O(new_n1589_));
  nand2  g1498(.a(new_n1589_), .b(new_n1588_), .O(new_n1590_));
  nand2  g1499(.a(new_n1590_), .b(x18), .O(new_n1591_));
  aoi21  g1500(.a(new_n1591_), .b(new_n1586_), .c(new_n1210_), .O(new_n1592_));
  oai21  g1501(.a(new_n1592_), .b(new_n1580_), .c(new_n91_), .O(new_n1593_));
  nand3  g1502(.a(new_n215_), .b(new_n92_), .c(new_n373_), .O(new_n1594_));
  oai21  g1503(.a(new_n1594_), .b(new_n1563_), .c(new_n1593_), .O(z38));
  nand3  g1504(.a(new_n269_), .b(new_n93_), .c(x01), .O(new_n1596_));
  nand3  g1505(.a(new_n198_), .b(x20), .c(x05), .O(new_n1597_));
  aoi21  g1506(.a(new_n1597_), .b(new_n1596_), .c(new_n152_), .O(new_n1598_));
  nor4   g1507(.a(new_n516_), .b(new_n260_), .c(new_n374_), .d(new_n93_), .O(new_n1599_));
  oai21  g1508(.a(new_n1599_), .b(new_n1598_), .c(new_n112_), .O(new_n1600_));
  nand3  g1509(.a(new_n845_), .b(new_n93_), .c(x01), .O(new_n1601_));
  nand2  g1510(.a(new_n1601_), .b(new_n205_), .O(new_n1602_));
  nand2  g1511(.a(new_n1602_), .b(x21), .O(new_n1603_));
  aoi21  g1512(.a(new_n1603_), .b(new_n1600_), .c(x18), .O(new_n1604_));
  oai21  g1513(.a(new_n994_), .b(new_n92_), .c(new_n251_), .O(new_n1605_));
  nand2  g1514(.a(new_n1605_), .b(x20), .O(new_n1606_));
  oai21  g1515(.a(new_n486_), .b(new_n183_), .c(new_n1606_), .O(new_n1607_));
  nand2  g1516(.a(new_n1607_), .b(new_n120_), .O(new_n1608_));
  inv1   g1517(.a(new_n329_), .O(new_n1609_));
  nand4  g1518(.a(new_n1609_), .b(new_n184_), .c(x30), .d(new_n112_), .O(new_n1610_));
  aoi21  g1519(.a(new_n1610_), .b(new_n1608_), .c(new_n150_), .O(new_n1611_));
  oai21  g1520(.a(new_n1611_), .b(new_n1604_), .c(x19), .O(new_n1612_));
  aoi21  g1521(.a(new_n693_), .b(new_n103_), .c(new_n92_), .O(new_n1613_));
  oai21  g1522(.a(new_n1613_), .b(x19), .c(new_n856_), .O(new_n1614_));
  aoi22  g1523(.a(new_n1614_), .b(x21), .c(new_n402_), .d(new_n235_), .O(new_n1615_));
  oai21  g1524(.a(new_n104_), .b(x17), .c(x18), .O(new_n1616_));
  nand3  g1525(.a(new_n1616_), .b(new_n429_), .c(new_n265_), .O(new_n1617_));
  oai21  g1526(.a(new_n1615_), .b(x30), .c(new_n1617_), .O(new_n1618_));
  aoi22  g1527(.a(new_n290_), .b(new_n92_), .c(new_n229_), .d(new_n184_), .O(new_n1619_));
  nor3   g1528(.a(new_n1619_), .b(x30), .c(x19), .O(new_n1620_));
  aoi21  g1529(.a(new_n1618_), .b(x20), .c(new_n1620_), .O(new_n1621_));
  oai21  g1530(.a(new_n1621_), .b(new_n150_), .c(new_n1612_), .O(z39));
  nand2  g1531(.a(new_n133_), .b(x21), .O(new_n1623_));
  aoi21  g1532(.a(new_n1623_), .b(new_n213_), .c(new_n711_), .O(new_n1624_));
  nor2   g1533(.a(new_n310_), .b(new_n213_), .O(new_n1625_));
  oai21  g1534(.a(new_n1625_), .b(new_n1624_), .c(x05), .O(new_n1626_));
  nand3  g1535(.a(new_n309_), .b(new_n214_), .c(x03), .O(new_n1627_));
  nand2  g1536(.a(new_n1627_), .b(new_n1626_), .O(new_n1628_));
  nand2  g1537(.a(new_n1628_), .b(new_n92_), .O(new_n1629_));
  nand3  g1538(.a(new_n1102_), .b(new_n339_), .c(new_n150_), .O(new_n1630_));
  oai21  g1539(.a(new_n1232_), .b(new_n109_), .c(new_n1630_), .O(new_n1631_));
  nand3  g1540(.a(new_n1631_), .b(new_n1138_), .c(new_n788_), .O(new_n1632_));
  aoi21  g1541(.a(new_n1632_), .b(new_n1629_), .c(x28), .O(z40));
  nand4  g1542(.a(new_n92_), .b(new_n194_), .c(new_n157_), .d(x00), .O(new_n1634_));
  nor4   g1543(.a(new_n1634_), .b(new_n844_), .c(new_n251_), .d(new_n718_), .O(z41));
  nor4   g1544(.a(new_n1040_), .b(new_n947_), .c(new_n374_), .d(new_n100_), .O(z43));
  zero   g1545(.O(z02));
  zero   g1546(.O(z42));
  nor4   g1547(.a(new_n866_), .b(new_n947_), .c(new_n100_), .d(new_n120_), .O(z44));
endmodule
