...
module FAU ( 
  ...
  nor2   g0554(.a(x32), .b(new_n645_), .O(new_n646_));
  nand2  g0555(.a(new_n646_), .b(new_n379_), .O(new_n647_));
  aoi21  g0556(.a(new_n644_), .b(new_n642_), .c(new_n647_), .O(new_n648_));
  nand3  g0557(.a(new_n128_), .b(x22), .c(new_n376_), .O(new_n649_));
  nand2  g0558(.a(new_n614_), .b(new_n393_), .O(new_n650_));
  nor2   g0559(.a(new_n650_), .b(new_n649_), .O(new_n651_));
  nand3  g0560(.a(new_n651_), .b(new_n395_), .c(new_n283_), .O(new_n652_));
  ...
  oai21  g0568(.a(new_n659_), .b(new_n645_), .c(new_n120_), .O(new_n660_));
  ...
  aoi21  g0664(.a(new_n105_), .b(new_n645_), .c(x28), .O(new_n756_));
  ...
  nand2  g0710(.a(new_n379_), .b(new_n659_), .O(new_n802_));
  ...
  nor2   g0750(.a(x28), .b(new_n645_), .O(new_n842_));
  ...
  nand2  g0759(.a(new_n850_), .b(new_n645_), .O(new_n851_));
  ...
  aoi21  g0782(.a(new_n873_), .b(new_n642_), .c(new_n802_), .O(new_n874_));
  ...
  nand4  g0835(.a(new_n646_), .b(x35), .c(new_n642_), .d(new_n379_), .O(new_n927_));
  nand2  g0836(.a(new_n802_), .b(x23), .O(new_n928_));
  nand4  g0837(.a(new_n928_), .b(new_n927_), .c(new_n652_), .d(new_n120_), .O(new_n929_));
  ...
  oai22  g0860(.a(new_n951_), .b(new_n201_), .c(new_n122_), .d(new_n645_), .O(new_n952_));
  ...
  nor4   g0903(.a(new_n860_), .b(new_n994_), .c(new_n230_), .d(new_n386_), .O(z21));
  ...
  aoi22  g0918(.a(new_n1009_), .b(new_n817_), .c(new_n455_), .d(new_n388_), .O(new_n1010_));
  ...
  nand3  g0972(.a(new_n849_), .b(new_n490_), .c(new_n381_), .O(new_n1064_));
  ...
  nor3   g1030(.a(new_n1121_), .b(new_n852_), .c(new_n558_), .O(z23));
  nor3   g1031(.a(new_n911_), .b(new_n861_), .c(new_n116_), .O(z24));
  aoi21  g1032(.a(new_n120_), .b(x19), .c(new_n645_), .O(new_n1124_));
  ...
  oai21  g1116(.a(new_n386_), .b(new_n645_), .c(new_n749_), .O(new_n1208_));
  nand2  g1117(.a(new_n1208_), .b(new_n96_), .O(new_n1209_));
  nand4  g1118(.a(new_n817_), .b(new_n391_), .c(new_n457_), .d(new_n376_), .O(new_n1210_));
  ...
  oai22  g1141(.a(new_n155_), .b(new_n326_), .c(new_n645_), .d(x18), .O(new_n1233_));
  ...
  oai22  g1213(.a(new_n1304_), .b(new_n425_), .c(new_n944_), .d(new_n427_), .O(new_n1305_));
  ...
  oai21  g1251(.a(new_n182_), .b(x09), .c(new_n645_), .O(new_n1343_));
  ...
  nand3  g1417(.a(new_n1430_), .b(new_n645_), .c(new_n96_), .O(new_n1509_));
  ...
  nor2   g1503(.a(new_n483_), .b(new_n860_), .O(new_n1595_));
