// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:01 2020
...
module FAU ( 
  ...
  nand2  g29(.a(x20), .b(x11), .O(new_n74_));
  nor3   g30(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nor2   g31(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  nand2  g32(.a(new_n49_), .b(new_n47_), .O(new_n77_));
  oai22  g33(.a(new_n77_), .b(new_n76_), .c(new_n55_), .d(new_n54_), .O(z09));
  nand3  g34(.a(x22), .b(x21), .c(x12), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n72_), .c(x19), .O(new_n80_));
  nor2   g36(.a(x20), .b(new_n71_), .O(new_n81_));
  aoi21  g37(.a(new_n80_), .b(x20), .c(new_n81_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n77_), .c(new_n55_), .d(new_n57_), .O(z10));
  nand3  g39(.a(x26), .b(x25), .c(x24), .O(new_n84_));
  nand2  g40(.a(new_n45_), .b(x13), .O(new_n85_));
  ...
  oai21  g46(.a(new_n90_), .b(new_n77_), .c(new_n59_), .O(z11));
  ...
  aoi22  g53(.a(new_n97_), .b(new_n87_), .c(new_n95_), .d(x22), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n77_), .c(new_n61_), .O(z12));
  ...
  nand2  g58(.a(x23), .b(new_n47_), .O(new_n103_));
  aoi21  g59(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nor3   g60(.a(new_n86_), .b(new_n73_), .c(x23), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n104_), .c(new_n49_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n63_), .O(z13));
  nand3  g63(.a(x26), .b(x25), .c(x16), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n101_), .c(x24), .O(new_n110_));
  inv1   g66(.a(x24), .O(new_n111_));
  nand3  g67(.a(new_n94_), .b(new_n45_), .c(new_n111_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n110_), .c(x10), .O(new_n113_));
  nor2   g69(.a(new_n111_), .b(x23), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n113_), .c(new_n49_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n65_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x24), .c(x22), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n93_), .c(x25), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n94_), .b(new_n45_), .c(new_n120_), .d(x24), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n119_), .c(x10), .O(new_n122_));
  nor2   g78(.a(new_n120_), .b(x23), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n122_), .c(new_n49_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n67_), .O(z15));
  inv1   g81(.a(x18), .O(new_n126_));
  nand3  g82(.a(x25), .b(x24), .c(new_n126_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n101_), .c(x26), .O(new_n128_));
  and2   g84(.a(x24), .b(x23), .O(new_n129_));
  inv1   g85(.a(new_n73_), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n120_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n87_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n128_), .c(x10), .O(new_n133_));
  inv1   g89(.a(x26), .O(new_n134_));
  nor2   g90(.a(new_n134_), .b(x23), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n133_), .c(new_n49_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n69_), .O(z16));
endmodule
