...
module FAU ( 
  ...
  and2   g46(.a(x21), .b(x20), .O(new_n91_));
  ...
  nand3  g54(.a(x22), .b(x21), .c(x20), .O(new_n99_));
  ...
  nand4  g63(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n108_));
  ...
  nand3  g72(.a(x22), .b(x21), .c(x20), .O(new_n117_));
