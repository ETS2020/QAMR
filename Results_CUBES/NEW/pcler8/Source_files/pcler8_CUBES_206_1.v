...
module FAU ( 
  ...
  nor2   g49(.a(new_n93_), .b(new_n80_), .O(new_n94_));
  inv1   g50(.a(x22), .O(new_n95_));
  nand3  g51(.a(x21), .b(x20), .c(x19), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nand2  g53(.a(new_n95_), .b(x21), .O(new_n98_));
  oai22  g54(.a(new_n98_), .b(new_n89_), .c(new_n97_), .d(new_n95_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n94_), .c(new_n77_), .O(new_n100_));
  ...
  nand3  g71(.a(new_n111_), .b(x23), .c(x21), .O(new_n116_));
  nor2   g72(.a(new_n116_), .b(new_n89_), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n115_), .c(new_n77_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n67_), .O(z14));
  nand2  g75(.a(x26), .b(x17), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n97_), .c(new_n46_), .O(new_n121_));
  nor3   g77(.a(new_n96_), .b(new_n45_), .c(x25), .O(new_n122_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n113_), .c(x26), .O(new_n127_));
  inv1   g83(.a(x26), .O(new_n128_));
  nand4  g84(.a(new_n97_), .b(new_n46_), .c(new_n128_), .d(x25), .O(new_n129_));
