...
module FAU ( 
  ...
  oai22  g34(.a(new_n78_), .b(new_n76_), .c(new_n50_), .d(new_n57_), .O(z09));
  ...
  nor2   g82(.a(new_n53_), .b(x18), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n49_), .c(new_n45_), .O(new_n128_));
  inv1   g84(.a(x26), .O(new_n129_));
  nor2   g85(.a(new_n129_), .b(x10), .O(new_n130_));
  nand4  g86(.a(new_n129_), .b(x25), .c(x22), .d(x21), .O(new_n131_));
  nand4  g87(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n132_));
  nor2   g88(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  aoi21  g89(.a(new_n130_), .b(new_n128_), .c(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n51_), .c(new_n71_), .O(z16));
endmodule
