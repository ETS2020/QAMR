...
module FAU ( 
  ...
  aoi21  g28(.a(new_n72_), .b(new_n46_), .c(new_n49_), .O(new_n73_));
  inv1   g29(.a(x10), .O(new_n74_));
  nand2  g30(.a(new_n48_), .b(new_n74_), .O(new_n75_));
  oai22  g31(.a(new_n75_), .b(new_n73_), .c(new_n55_), .d(new_n54_), .O(z09));
  nand3  g32(.a(x26), .b(x25), .c(x24), .O(new_n77_));
  nand3  g33(.a(x23), .b(x21), .c(x12), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n77_), .c(x19), .O(new_n79_));
  nor2   g35(.a(x20), .b(new_n49_), .O(new_n80_));
  aoi21  g36(.a(new_n79_), .b(x20), .c(new_n80_), .O(new_n81_));
  oai22  g37(.a(new_n81_), .b(new_n75_), .c(new_n55_), .d(new_n57_), .O(z10));
  nand2  g38(.a(x23), .b(x13), .O(new_n83_));
  nand2  g39(.a(x20), .b(x19), .O(new_n84_));
  inv1   g40(.a(new_n84_), .O(new_n85_));
  oai21  g41(.a(new_n83_), .b(new_n77_), .c(new_n85_), .O(new_n86_));
  nor2   g42(.a(new_n84_), .b(x21), .O(new_n87_));
  aoi21  g43(.a(new_n86_), .b(x21), .c(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n75_), .c(new_n59_), .O(z11));
  inv1   g45(.a(new_n75_), .O(new_n90_));
  nand2  g46(.a(x23), .b(x14), .O(new_n91_));
  nor2   g47(.a(new_n91_), .b(new_n77_), .O(new_n92_));
  ...
  oai22  g52(.a(new_n96_), .b(new_n84_), .c(new_n95_), .d(new_n93_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n92_), .c(new_n90_), .O(new_n98_));
  ...
  nor3   g61(.a(new_n105_), .b(new_n84_), .c(x23), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n104_), .c(new_n90_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n63_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n95_), .c(x23), .d(x22), .O(new_n110_));
  nand2  g66(.a(x23), .b(x22), .O(new_n111_));
  nor3   g67(.a(new_n111_), .b(new_n94_), .c(x24), .O(new_n112_));
  aoi21  g68(.a(new_n110_), .b(x24), .c(new_n112_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n75_), .c(new_n65_), .O(z14));
  ...
  aoi22  g77(.a(new_n121_), .b(new_n95_), .c(new_n118_), .d(x25), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n75_), .c(new_n67_), .O(z15));
  ...
  and2   g83(.a(x24), .b(x23), .O(new_n128_));
  inv1   g84(.a(new_n105_), .O(new_n129_));
  nor2   g85(.a(x26), .b(new_n119_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n129_), .c(new_n85_), .d(new_n128_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n90_), .O(new_n133_));
