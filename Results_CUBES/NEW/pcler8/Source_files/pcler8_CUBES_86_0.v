...
module FAU ( 
  ...
  nor2   g27(.a(x26), .b(x22), .O(new_n72_));
  ...
  nand3  g43(.a(new_n87_), .b(new_n46_), .c(x13), .O(new_n88_));
  inv1   g44(.a(x20), .O(new_n89_));
  oai21  g45(.a(x26), .b(x22), .c(new_n89_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n88_), .c(x19), .O(new_n91_));
  nand2  g47(.a(x20), .b(x19), .O(new_n92_));
  nor2   g48(.a(new_n92_), .b(x21), .O(new_n93_));
  aoi21  g49(.a(new_n91_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n76_), .c(new_n60_), .O(z11));
  inv1   g51(.a(x21), .O(new_n96_));
  nand2  g52(.a(x22), .b(new_n89_), .O(new_n97_));
  ...
  oai21  g58(.a(new_n101_), .b(new_n86_), .c(new_n102_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(x22), .c(new_n100_), .O(new_n104_));
  oai22  g60(.a(new_n104_), .b(new_n76_), .c(new_n58_), .d(new_n62_), .O(z12));
  ...
  nor3   g66(.a(x23), .b(new_n98_), .c(new_n96_), .O(new_n111_));
  aoi22  g67(.a(new_n111_), .b(new_n106_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai22  g68(.a(new_n112_), .b(new_n76_), .c(new_n58_), .d(new_n64_), .O(z13));
  nand3  g69(.a(x26), .b(x25), .c(x16), .O(new_n114_));
  nand3  g70(.a(x21), .b(x20), .c(x19), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n46_), .O(new_n117_));
  nor3   g73(.a(new_n115_), .b(new_n45_), .c(x24), .O(new_n118_));
  aoi21  g74(.a(new_n117_), .b(x24), .c(new_n118_), .O(new_n119_));
  oai22  g75(.a(new_n119_), .b(new_n76_), .c(new_n58_), .d(new_n66_), .O(z14));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n116_), .c(new_n46_), .d(x24), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(x24), .O(new_n124_));
  nor3   g80(.a(new_n124_), .b(new_n115_), .c(new_n45_), .O(new_n125_));
  aoi21  g81(.a(new_n122_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n76_), .c(new_n68_), .O(z15));
  nand2  g83(.a(x26), .b(new_n89_), .O(new_n128_));
  inv1   g84(.a(x26), .O(new_n129_));
  and2   g85(.a(x24), .b(x23), .O(new_n130_));
  nand4  g86(.a(new_n106_), .b(new_n130_), .c(new_n129_), .d(x25), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(new_n96_), .O(new_n132_));
  ...
  nand2  g92(.a(x23), .b(new_n98_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n132_), .c(new_n77_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n70_), .O(z16));
endmodule
