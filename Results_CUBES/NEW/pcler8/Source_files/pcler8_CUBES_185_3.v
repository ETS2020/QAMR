...
module FAU ( 
  ...
  aoi21  g52(.a(new_n96_), .b(new_n94_), .c(x10), .O(new_n97_));
  inv1   g53(.a(x14), .O(new_n98_));
  nand2  g54(.a(x23), .b(x22), .O(new_n99_));
  nor3   g55(.a(new_n85_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n97_), .c(new_n51_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n63_), .O(z12));
  ...
  aoi22  g64(.a(new_n108_), .b(new_n88_), .c(new_n106_), .d(x23), .O(new_n109_));
  ...
  nor3   g69(.a(new_n93_), .b(new_n99_), .c(x24), .O(new_n114_));
