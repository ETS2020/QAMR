...
module FAU ( 
  ...
  nand3  g062(.a(new_n113_), .b(new_n57_), .c(new_n65_), .O(new_n114_));
  ...
  aoi21  g071(.a(x26), .b(x19), .c(new_n122_), .O(new_n123_));
  oai21  g072(.a(new_n120_), .b(new_n52_), .c(new_n123_), .O(z07));
  nor2   g073(.a(new_n117_), .b(new_n86_), .O(new_n125_));
  ...
  nand2  g095(.a(new_n140_), .b(new_n116_), .O(new_n147_));
  ...
  nand4  g110(.a(new_n161_), .b(new_n140_), .c(new_n116_), .d(new_n115_), .O(new_n162_));
  ...
  nand4  g134(.a(new_n185_), .b(new_n161_), .c(new_n140_), .d(new_n116_), .O(new_n186_));
