...
module FAU ( 
  ...
  nand2  g081(.a(new_n119_), .b(new_n91_), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n75_), .c(x28), .O(new_n134_));
  oai21  g083(.a(new_n132_), .b(new_n114_), .c(new_n134_), .O(new_n135_));
  ...
  nor3   g088(.a(new_n130_), .b(new_n110_), .c(x29), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n113_), .O(new_n141_));
  nand3  g090(.a(new_n131_), .b(new_n100_), .c(new_n76_), .O(new_n142_));
  ...
  aoi21  g098(.a(new_n140_), .b(new_n84_), .c(new_n149_), .O(new_n150_));
  nor4   g099(.a(new_n130_), .b(new_n110_), .c(x30), .d(x29), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n84_), .c(new_n150_), .O(new_n152_));
  ...
  nand4  g107(.a(new_n149_), .b(new_n158_), .c(new_n129_), .d(new_n128_), .O(new_n159_));
  inv1   g108(.a(new_n159_), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n109_), .c(new_n157_), .d(new_n89_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(x23), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n156_), .c(new_n81_), .d(new_n59_), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  nor2   g113(.a(new_n52_), .b(new_n164_), .O(new_n165_));
  aoi21  g114(.a(new_n163_), .b(new_n52_), .c(new_n165_), .O(new_n166_));
  inv1   g115(.a(x03), .O(new_n167_));
  aoi21  g116(.a(new_n56_), .b(new_n167_), .c(x18), .O(new_n168_));
  oai21  g117(.a(new_n166_), .b(new_n56_), .c(new_n168_), .O(z12));
  aoi21  g118(.a(x32), .b(x16), .c(x18), .O(new_n170_));
  oai21  g119(.a(x16), .b(x02), .c(new_n170_), .O(z13));
  aoi21  g120(.a(x33), .b(x16), .c(x18), .O(new_n172_));
  oai21  g121(.a(x16), .b(x01), .c(new_n172_), .O(z14));
  aoi21  g122(.a(x34), .b(x16), .c(x18), .O(new_n174_));
  oai21  g123(.a(x16), .b(x00), .c(new_n174_), .O(z15));
endmodule
