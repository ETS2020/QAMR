...
module FAU ( 
  ...
  oai21  g089(.a(new_n136_), .b(x28), .c(x16), .O(new_n141_));
  ...
  nand4  g094(.a(new_n134_), .b(new_n109_), .c(new_n87_), .d(new_n69_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n53_), .c(new_n63_), .O(new_n147_));
  nor2   g096(.a(x29), .b(x27), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n109_), .c(new_n116_), .d(new_n117_), .O(new_n149_));
  oai22  g098(.a(new_n149_), .b(new_n133_), .c(new_n147_), .d(new_n145_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n129_), .c(new_n97_), .d(new_n77_), .O(new_n156_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n127_), .O(new_n166_));
  nand3  g115(.a(new_n129_), .b(new_n97_), .c(new_n77_), .O(new_n167_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n134_), .c(new_n145_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n118_), .c(new_n53_), .O(new_n179_));
  ...
  nand3  g132(.a(new_n183_), .b(new_n134_), .c(new_n106_), .O(new_n184_));
  ...
  nand4  g139(.a(new_n181_), .b(new_n148_), .c(new_n155_), .d(new_n116_), .O(new_n191_));
  ...
  nand4  g143(.a(new_n194_), .b(new_n170_), .c(new_n148_), .d(new_n129_), .O(new_n195_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n158_), .c(new_n165_), .d(new_n127_), .O(new_n202_));
  ...
  nand3  g154(.a(new_n205_), .b(new_n183_), .c(new_n134_), .O(new_n206_));
