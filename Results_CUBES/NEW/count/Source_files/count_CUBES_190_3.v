// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:33 2020
...
module FAU ( 
  ...
  nand2  g018(.a(new_n69_), .b(x19), .O(new_n70_));
  ...
  aoi21  g025(.a(new_n76_), .b(new_n52_), .c(new_n69_), .O(new_n77_));
  ...
  aoi21  g038(.a(new_n89_), .b(new_n86_), .c(x17), .O(new_n90_));
  inv1   g039(.a(x23), .O(new_n91_));
  nand3  g040(.a(new_n55_), .b(new_n69_), .c(new_n78_), .O(new_n92_));
  ...
  oai21  g049(.a(new_n100_), .b(new_n92_), .c(x24), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand3  g051(.a(new_n102_), .b(new_n79_), .c(new_n64_), .O(new_n103_));
  ...
  inv1   g057(.a(new_n102_), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(x21), .c(new_n52_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(new_n93_), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n88_), .c(new_n76_), .d(new_n55_), .O(new_n113_));
  ...
  nand2  g068(.a(new_n112_), .b(new_n99_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n52_), .c(new_n92_), .O(new_n121_));
  nor3   g070(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n88_), .c(new_n76_), .d(new_n55_), .O(new_n123_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n99_), .c(new_n130_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n52_), .O(new_n133_));
  aoi21  g082(.a(new_n133_), .b(new_n93_), .c(new_n129_), .O(new_n134_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n102_), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n80_), .O(new_n137_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n102_), .c(new_n143_), .d(new_n87_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n52_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n93_), .c(new_n142_), .O(new_n147_));
  nor2   g096(.a(x28), .b(x27), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n112_), .c(new_n119_), .d(new_n91_), .O(new_n149_));
  nor2   g098(.a(new_n149_), .b(new_n80_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n131_), .c(new_n102_), .d(new_n87_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n52_), .c(new_n92_), .O(new_n157_));
  nand3  g106(.a(new_n88_), .b(new_n64_), .c(new_n87_), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n122_), .c(new_n129_), .O(new_n160_));
  oai22  g109(.a(new_n160_), .b(new_n158_), .c(new_n157_), .d(new_n155_), .O(new_n161_));
  ...
  nand2  g115(.a(new_n159_), .b(new_n144_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n120_), .c(new_n52_), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n93_), .c(new_n166_), .O(new_n169_));
  nor2   g118(.a(x30), .b(x29), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n148_), .c(new_n122_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n158_), .O(new_n172_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n142_), .O(new_n178_));
  nand3  g127(.a(new_n144_), .b(new_n112_), .c(new_n99_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n178_), .c(new_n52_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n93_), .c(new_n177_), .O(new_n181_));
  nor2   g130(.a(x31), .b(x30), .O(new_n182_));
  nand3  g131(.a(new_n182_), .b(new_n159_), .c(new_n135_), .O(new_n183_));
  ...
  nand3  g138(.a(new_n182_), .b(new_n148_), .c(new_n155_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n132_), .c(new_n52_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n93_), .c(new_n189_), .O(new_n192_));
  nor2   g141(.a(x32), .b(x31), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n170_), .c(new_n148_), .d(new_n131_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n159_), .c(new_n166_), .d(new_n129_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n132_), .c(new_n52_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n93_), .c(new_n200_), .O(new_n203_));
  nor2   g152(.a(x33), .b(x32), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n182_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n167_), .c(new_n113_), .O(new_n206_));
  ...
  nand4  g160(.a(new_n204_), .b(new_n170_), .c(new_n177_), .d(new_n142_), .O(new_n212_));
  oai21  g161(.a(new_n212_), .b(new_n145_), .c(new_n52_), .O(new_n213_));
  aoi21  g162(.a(new_n213_), .b(new_n93_), .c(new_n211_), .O(new_n214_));
  nand3  g163(.a(new_n204_), .b(new_n182_), .c(new_n211_), .O(new_n215_));
  nor3   g164(.a(new_n215_), .b(new_n167_), .c(new_n113_), .O(new_n216_));
