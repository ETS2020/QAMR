// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:12 2020
...
module FAU ( 
  ...
  nand3  g050(.a(new_n101_), .b(new_n61_), .c(new_n60_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n85_), .c(new_n68_), .d(new_n58_), .O(new_n105_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n74_), .c(new_n111_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n60_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n63_), .O(new_n114_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n85_), .c(new_n115_), .d(new_n84_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(new_n60_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n63_), .O(new_n126_));
  nand3  g075(.a(new_n74_), .b(new_n58_), .c(new_n57_), .O(new_n127_));
  inv1   g076(.a(x25), .O(new_n128_));
  nor2   g077(.a(x27), .b(x26), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n94_), .c(new_n128_), .O(new_n130_));
  ...
  oai21  g083(.a(new_n132_), .b(new_n52_), .c(new_n134_), .O(z08));
  inv1   g084(.a(x26), .O(new_n136_));
  inv1   g085(.a(x27), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n128_), .d(new_n115_), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n92_), .c(new_n61_), .d(new_n60_), .O(new_n140_));
  nand2  g089(.a(new_n104_), .b(new_n111_), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n136_), .O(new_n143_));
  nor3   g092(.a(new_n143_), .b(new_n127_), .c(new_n141_), .O(new_n144_));
  ...
  oai21  g096(.a(new_n145_), .b(new_n52_), .c(new_n147_), .O(z09));
  nand2  g097(.a(new_n142_), .b(new_n116_), .O(new_n149_));
  inv1   g098(.a(new_n149_), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n101_), .c(new_n61_), .d(new_n60_), .O(new_n151_));
  nor2   g100(.a(x29), .b(x28), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n137_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n117_), .O(new_n154_));
  ...
  nand3  g107(.a(new_n116_), .b(new_n94_), .c(new_n74_), .O(new_n159_));
  nor2   g108(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n61_), .c(new_n60_), .O(new_n161_));
  nor2   g110(.a(x30), .b(x29), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(new_n142_), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n117_), .O(new_n164_));
  aoi22  g113(.a(new_n164_), .b(new_n87_), .c(new_n161_), .d(x30), .O(new_n165_));
  ...
  nand4  g117(.a(new_n111_), .b(new_n77_), .c(new_n84_), .d(new_n57_), .O(new_n169_));
  inv1   g118(.a(new_n169_), .O(new_n170_));
  inv1   g119(.a(x32), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x19), .O(new_n172_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n172_), .c(new_n170_), .d(new_n139_), .O(new_n179_));
  nand3  g128(.a(new_n162_), .b(new_n129_), .c(new_n173_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n112_), .c(x31), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n179_), .c(x17), .O(new_n182_));
  nor2   g131(.a(new_n63_), .b(new_n176_), .O(new_n183_));
  ...
  nand3  g137(.a(new_n188_), .b(new_n152_), .c(new_n94_), .O(new_n189_));
  nor2   g138(.a(x22), .b(x17), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n129_), .c(new_n68_), .d(new_n128_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n189_), .c(x32), .O(new_n192_));
  nor2   g141(.a(x32), .b(x31), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n162_), .c(new_n150_), .d(new_n96_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n188_), .b(new_n142_), .c(new_n174_), .d(new_n136_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n112_), .c(new_n60_), .O(new_n202_));
  nand3  g151(.a(new_n58_), .b(new_n171_), .c(new_n57_), .O(new_n203_));
  inv1   g152(.a(new_n203_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n202_), .c(new_n200_), .O(new_n205_));
  nand2  g154(.a(new_n152_), .b(new_n129_), .O(new_n206_));
  nor2   g155(.a(x33), .b(x32), .O(new_n207_));
  nand2  g156(.a(new_n207_), .b(new_n188_), .O(new_n208_));
  nor3   g157(.a(new_n208_), .b(new_n206_), .c(new_n105_), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n205_), .c(x16), .O(new_n210_));
  inv1   g159(.a(x01), .O(new_n211_));
  aoi21  g160(.a(new_n52_), .b(new_n211_), .c(x18), .O(new_n212_));
  nand2  g161(.a(new_n212_), .b(new_n210_), .O(z14));
  inv1   g162(.a(x34), .O(new_n214_));
  nand4  g163(.a(new_n188_), .b(new_n152_), .c(new_n200_), .d(new_n137_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n124_), .c(new_n60_), .O(new_n216_));
  aoi21  g165(.a(new_n216_), .b(new_n204_), .c(new_n214_), .O(new_n217_));
  nand3  g166(.a(new_n207_), .b(new_n188_), .c(new_n214_), .O(new_n218_));
  nor3   g167(.a(new_n218_), .b(new_n206_), .c(new_n105_), .O(new_n219_));
