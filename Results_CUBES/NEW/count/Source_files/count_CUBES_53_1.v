// Benchmark "FAU" written by ABC on Mon Jul  6 14:17:49 2020
...
module FAU ( 
  ...
  aoi21  g067(.a(new_n118_), .b(new_n64_), .c(new_n115_), .O(new_n119_));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(new_n70_), .O(new_n122_));
  ...
  nand4  g075(.a(new_n69_), .b(new_n53_), .c(new_n52_), .d(x16), .O(new_n127_));
  inv1   g076(.a(x07), .O(new_n128_));
  aoi21  g077(.a(new_n58_), .b(new_n128_), .c(x18), .O(new_n129_));
  oai21  g078(.a(new_n127_), .b(new_n121_), .c(new_n129_), .O(z08));
  inv1   g079(.a(x28), .O(new_n131_));
  inv1   g080(.a(x24), .O(new_n132_));
  nor2   g081(.a(x26), .b(x25), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n87_), .c(new_n132_), .d(new_n86_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n64_), .c(new_n131_), .O(new_n136_));
  nand2  g085(.a(new_n77_), .b(new_n64_), .O(new_n137_));
  nor2   g086(.a(x28), .b(x26), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n97_), .c(new_n106_), .O(new_n139_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n108_), .c(new_n87_), .d(new_n86_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n53_), .c(new_n63_), .O(new_n147_));
  nor2   g096(.a(x29), .b(x28), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n108_), .c(new_n115_), .d(new_n116_), .O(new_n149_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(new_n97_), .d(new_n77_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n53_), .c(new_n63_), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n120_), .c(new_n131_), .O(new_n159_));
  oai22  g108(.a(new_n159_), .b(new_n90_), .c(new_n157_), .d(new_n155_), .O(new_n160_));
  ...
  nand3  g115(.a(new_n133_), .b(new_n97_), .c(new_n77_), .O(new_n167_));
  ...
  nand3  g119(.a(new_n170_), .b(new_n148_), .c(new_n120_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n90_), .O(new_n172_));
  ...
  oai21  g127(.a(new_n178_), .b(new_n117_), .c(new_n53_), .O(new_n179_));
  ...
  nand3  g132(.a(new_n183_), .b(new_n138_), .c(new_n106_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n100_), .O(new_n185_));
  ...
  nand4  g139(.a(new_n181_), .b(new_n148_), .c(new_n155_), .d(new_n115_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n117_), .c(new_n53_), .O(new_n192_));
  ...
  nor2   g155(.a(new_n206_), .b(new_n109_), .O(new_n207_));
