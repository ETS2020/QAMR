...
module FAU ( 
  ...
  oai21  g071(.a(new_n118_), .b(x27), .c(x16), .O(new_n123_));
  inv1   g072(.a(x07), .O(new_n124_));
  aoi21  g073(.a(new_n52_), .b(new_n124_), .c(x18), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n123_), .O(z08));
  nand3  g075(.a(new_n109_), .b(new_n76_), .c(new_n107_), .O(new_n127_));
  nor2   g076(.a(new_n116_), .b(new_n127_), .O(new_n128_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n90_), .c(new_n111_), .O(new_n132_));
  ...
  nand2  g086(.a(new_n131_), .b(new_n100_), .O(new_n138_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n154_), .c(new_n131_), .d(new_n111_), .O(new_n182_));
  ...
  nand4  g151(.a(new_n202_), .b(new_n128_), .c(new_n72_), .d(new_n82_), .O(new_n203_));
