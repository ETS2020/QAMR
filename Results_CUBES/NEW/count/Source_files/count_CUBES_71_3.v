...
module FAU ( 
  ...
  nand3  g049(.a(new_n96_), .b(new_n57_), .c(new_n65_), .O(new_n101_));
  ...
  aoi21  g057(.a(x25), .b(x19), .c(new_n108_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(new_n106_), .O(z06));
  inv1   g059(.a(new_n74_), .O(new_n111_));
  inv1   g060(.a(x23), .O(new_n112_));
  nand2  g061(.a(new_n103_), .b(new_n112_), .O(new_n113_));
  nor2   g062(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n66_), .c(new_n65_), .O(new_n115_));
  inv1   g064(.a(x24), .O(new_n116_));
  nor2   g065(.a(x26), .b(x25), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g067(.a(new_n85_), .b(new_n68_), .c(new_n58_), .O(new_n119_));
  ...
  nor2   g073(.a(new_n118_), .b(new_n86_), .O(new_n125_));
  ...
  nand3  g106(.a(new_n117_), .b(new_n94_), .c(new_n74_), .O(new_n158_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n114_), .c(new_n66_), .d(new_n65_), .O(new_n172_));
  ...
  nand4  g132(.a(new_n183_), .b(new_n114_), .c(new_n66_), .d(new_n65_), .O(new_n184_));
