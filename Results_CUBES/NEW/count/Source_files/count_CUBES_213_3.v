...
module FAU ( 
  ...
  nand4  g096(.a(new_n147_), .b(new_n96_), .c(new_n57_), .d(new_n65_), .O(new_n148_));
  ...
  oai21  g103(.a(x16), .b(x05), .c(new_n154_), .O(new_n155_));
  aoi21  g104(.a(x29), .b(x19), .c(new_n155_), .O(new_n156_));
  oai21  g105(.a(new_n153_), .b(new_n52_), .c(new_n156_), .O(z10));
  ...
  nand4  g123(.a(new_n174_), .b(new_n150_), .c(new_n128_), .d(new_n127_), .O(new_n175_));
