// Benchmark "FAU" written by ABC on Mon Jul  6 13:01:24 2020
...
module FAU ( 
  ...
  nand4  g32(.a(new_n24_), .b(new_n41_), .c(new_n35_), .d(new_n23_), .O(new_n52_));
  aoi22  g33(.a(new_n52_), .b(x12), .c(new_n51_), .d(new_n24_), .O(new_n53_));
  inv1   g34(.a(x07), .O(new_n54_));
  aoi21  g35(.a(new_n54_), .b(new_n28_), .c(new_n29_), .O(new_n55_));
  oai21  g36(.a(new_n53_), .b(new_n28_), .c(new_n55_), .O(z3));
