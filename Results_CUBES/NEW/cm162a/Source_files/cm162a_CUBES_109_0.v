// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:56 2020
...
module FAU ( 
  ...
  nand3  g29(.a(new_n43_), .b(new_n24_), .c(new_n40_), .O(new_n49_));
  nand4  g30(.a(x13), .b(x09), .c(x04), .d(x02), .O(new_n50_));
  inv1   g31(.a(new_n50_), .O(new_n51_));
  aoi21  g32(.a(new_n49_), .b(x12), .c(new_n51_), .O(new_n52_));
