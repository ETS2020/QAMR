...
module FAU ( 
  ...
  nand2  g074(.a(x19), .b(new_n126_), .O(new_n127_));
  nor2   g075(.a(x18), .b(x09), .O(new_n128_));
  oai22  g076(.a(new_n128_), .b(new_n127_), .c(x30), .d(x19), .O(z10));
  nand3  g077(.a(new_n88_), .b(x19), .c(x18), .O(new_n130_));
  inv1   g078(.a(x31), .O(new_n131_));
  nand3  g079(.a(new_n131_), .b(new_n55_), .c(x08), .O(new_n132_));
  nand2  g080(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g081(.a(new_n133_), .b(new_n126_), .O(new_n134_));
  nand2  g082(.a(new_n131_), .b(new_n57_), .O(new_n135_));
