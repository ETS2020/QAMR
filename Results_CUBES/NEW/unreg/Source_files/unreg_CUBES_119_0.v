...
module FAU ( 
  ...
  inv1   g047(.a(new_n58_), .O(new_n100_));
  nand2  g048(.a(new_n55_), .b(x05), .O(new_n101_));
  inv1   g049(.a(x27), .O(new_n102_));
  nand2  g050(.a(new_n102_), .b(x18), .O(new_n103_));
  aoi21  g051(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(z06));
  ...
  nand2  g056(.a(new_n102_), .b(new_n57_), .O(new_n109_));
