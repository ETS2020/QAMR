...
module FAU ( 
  ...
  nand2  g074(.a(new_n55_), .b(x09), .O(new_n127_));
  ...
  nor2   g084(.a(x24), .b(new_n55_), .O(new_n137_));
  oai21  g085(.a(new_n137_), .b(new_n136_), .c(new_n58_), .O(new_n138_));
  nand2  g086(.a(new_n128_), .b(new_n57_), .O(new_n139_));
