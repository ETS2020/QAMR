// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:10 2020
...
module FAU ( 
  ...
  nand2  g088(.a(new_n55_), .b(x15), .O(new_n141_));
  inv1   g089(.a(x33), .O(new_n142_));
  nand3  g090(.a(new_n142_), .b(x19), .c(x18), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g092(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  inv1   g093(.a(x32), .O(new_n146_));
  nand2  g094(.a(new_n146_), .b(new_n57_), .O(new_n147_));
  nand2  g095(.a(new_n147_), .b(new_n145_), .O(z12));
  inv1   g096(.a(x14), .O(new_n149_));
  nor2   g097(.a(x18), .b(new_n149_), .O(new_n150_));
  nor2   g098(.a(x34), .b(new_n55_), .O(new_n151_));
  oai21  g099(.a(new_n151_), .b(new_n150_), .c(new_n58_), .O(new_n152_));
  nand2  g100(.a(new_n142_), .b(new_n57_), .O(new_n153_));
