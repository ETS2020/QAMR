// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:36 2020
...
module FAU ( 
  ...
  inv1   g038(.a(x17), .O(new_n91_));
  nand2  g039(.a(x19), .b(new_n91_), .O(new_n92_));
  nor2   g040(.a(x18), .b(x06), .O(new_n93_));
  oai22  g041(.a(new_n93_), .b(new_n92_), .c(x25), .d(x19), .O(z05));
  inv1   g042(.a(x26), .O(new_n95_));
  nand3  g043(.a(new_n95_), .b(new_n55_), .c(x05), .O(new_n96_));
  inv1   g044(.a(x27), .O(new_n97_));
  nand3  g045(.a(new_n97_), .b(x19), .c(x18), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g047(.a(new_n99_), .b(new_n91_), .O(new_n100_));
  nand2  g048(.a(new_n95_), .b(new_n57_), .O(new_n101_));
  nand2  g049(.a(new_n101_), .b(new_n100_), .O(z06));
  inv1   g050(.a(x04), .O(new_n103_));
  nor2   g051(.a(x18), .b(new_n103_), .O(new_n104_));
  nor2   g052(.a(x20), .b(new_n55_), .O(new_n105_));
  oai21  g053(.a(new_n105_), .b(new_n104_), .c(new_n58_), .O(new_n106_));
  nand2  g054(.a(new_n97_), .b(new_n57_), .O(new_n107_));
