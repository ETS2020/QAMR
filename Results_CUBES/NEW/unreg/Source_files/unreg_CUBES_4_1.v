...
module FAU ( 
  ...
  oai21  g004(.a(new_n54_), .b(new_n53_), .c(new_n56_), .O(new_n57_));
  inv1   g005(.a(x20), .O(new_n58_));
  nand2  g006(.a(new_n58_), .b(new_n55_), .O(new_n59_));
  nand2  g007(.a(new_n59_), .b(new_n57_), .O(z00));
  inv1   g008(.a(x02), .O(new_n61_));
  nor2   g009(.a(x18), .b(new_n61_), .O(new_n62_));
  nor2   g010(.a(x22), .b(new_n53_), .O(new_n63_));
  oai21  g011(.a(new_n63_), .b(new_n62_), .c(new_n56_), .O(new_n64_));
  nand2  g012(.a(new_n54_), .b(new_n55_), .O(new_n65_));
  ...
  oai21  g017(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(new_n70_));
  ...
  oai21  g031(.a(new_n83_), .b(new_n82_), .c(new_n56_), .O(new_n84_));
  ...
  oai21  g045(.a(new_n97_), .b(new_n96_), .c(new_n56_), .O(new_n98_));
  ...
  oai21  g052(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(new_n105_));
  ...
  oai21  g059(.a(new_n111_), .b(new_n110_), .c(new_n56_), .O(new_n112_));
  ...
  oai21  g066(.a(new_n118_), .b(new_n117_), .c(new_n56_), .O(new_n119_));
  ...
  oai21  g073(.a(new_n125_), .b(new_n124_), .c(new_n56_), .O(new_n126_));
  ...
  oai21  g080(.a(new_n132_), .b(new_n131_), .c(new_n56_), .O(new_n133_));
  ...
  oai21  g087(.a(new_n139_), .b(new_n138_), .c(new_n56_), .O(new_n140_));
  ...
  oai21  g094(.a(new_n146_), .b(new_n145_), .c(new_n56_), .O(new_n147_));
  ...
  oai21  g101(.a(new_n153_), .b(new_n152_), .c(new_n56_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n160_), .b(new_n159_), .c(new_n56_), .O(new_n161_));
