...
module FAU ( 
  ...
  nand2  g067(.a(new_n55_), .b(x10), .O(new_n120_));
  ...
  nor2   g077(.a(x31), .b(new_n55_), .O(new_n130_));
  oai21  g078(.a(new_n130_), .b(new_n129_), .c(new_n58_), .O(new_n131_));
  nand2  g079(.a(new_n121_), .b(new_n57_), .O(new_n132_));
