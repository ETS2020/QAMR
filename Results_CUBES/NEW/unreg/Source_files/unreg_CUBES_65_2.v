...
module FAU ( 
  ...
  nand3  g039(.a(x19), .b(new_n55_), .c(x06), .O(new_n92_));
  ...
  nand2  g045(.a(new_n97_), .b(new_n57_), .O(new_n98_));
  nand2  g046(.a(new_n98_), .b(new_n96_), .O(z05));
  inv1   g047(.a(x05), .O(new_n100_));
  nor2   g048(.a(x18), .b(new_n100_), .O(new_n101_));
  nor2   g049(.a(x27), .b(new_n55_), .O(new_n102_));
  oai21  g050(.a(new_n102_), .b(new_n101_), .c(new_n58_), .O(new_n103_));
  nand2  g051(.a(new_n93_), .b(new_n57_), .O(new_n104_));
