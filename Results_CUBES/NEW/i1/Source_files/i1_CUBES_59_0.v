...
module FAU ( 
  ...
  nor2   g11(.a(x07), .b(x01), .O(new_n53_));
  inv1   g12(.a(x09), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(x08), .O(new_n55_));
  nand4  g14(.a(new_n55_), .b(new_n53_), .c(new_n47_), .d(new_n45_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  nand2  g16(.a(x02), .b(x00), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(z02));
  or2    g18(.a(x21), .b(x20), .O(z04));
  inv1   g19(.a(x10), .O(new_n61_));
  inv1   g20(.a(x08), .O(new_n62_));
  nand3  g21(.a(x19), .b(new_n62_), .c(new_n43_), .O(new_n63_));
  nand2  g22(.a(new_n49_), .b(new_n45_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(z05));
  nor2   g24(.a(x09), .b(new_n62_), .O(new_n66_));
  nand3  g25(.a(new_n53_), .b(new_n47_), .c(new_n45_), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n56_), .c(new_n52_), .O(new_n69_));
  inv1   g28(.a(x00), .O(new_n70_));
  nor2   g29(.a(x02), .b(new_n70_), .O(new_n71_));
