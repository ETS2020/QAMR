...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    ...
    new_n67_, new_n68_, new_n72_, new_n73_, new_n75_, new_n77_, new_n80_,
    new_n82_, new_n83_;
  ...
  nand3  g09(.a(new_n50_), .b(new_n46_), .c(new_n45_), .O(new_n51_));
  aoi21  g10(.a(new_n51_), .b(x19), .c(x05), .O(new_n52_));
  inv1   g11(.a(x05), .O(new_n53_));
  inv1   g12(.a(x09), .O(new_n54_));
  nand4  g13(.a(x19), .b(new_n54_), .c(x08), .d(new_n53_), .O(new_n55_));
  oai22  g14(.a(new_n55_), .b(new_n51_), .c(new_n52_), .d(new_n49_), .O(z02));
  ...
  nand3  g20(.a(new_n46_), .b(new_n45_), .c(new_n61_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(z05));
  inv1   g22(.a(new_n51_), .O(new_n64_));
  nand4  g23(.a(new_n50_), .b(new_n46_), .c(new_n45_), .d(new_n53_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(new_n64_), .c(x00), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(x19), .O(new_n67_));
  nand2  g26(.a(x05), .b(x00), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n67_), .O(z06));
