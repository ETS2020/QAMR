...
module FAU ( 
  ...
  nand4  g16(.a(new_n38_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x01), .c(new_n41_), .O(z03));
  inv1   g18(.a(x01), .O(new_n44_));
  nor4   g19(.a(new_n39_), .b(new_n37_), .c(new_n44_), .d(x00), .O(z04));
  nor3   g20(.a(new_n42_), .b(new_n44_), .c(new_n41_), .O(z05));
  ...
  nand2  g30(.a(new_n31_), .b(new_n41_), .O(new_n56_));
  ...
  oai21  g36(.a(new_n57_), .b(new_n51_), .c(new_n61_), .O(new_n62_));
  ...
  aoi21  g40(.a(x02), .b(new_n41_), .c(new_n42_), .O(z07));
