// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:41 2020
...
module FAU ( 
  ...
  aoi21  g27(.a(new_n52_), .b(x08), .c(x00), .O(new_n53_));
  nand2  g28(.a(x05), .b(new_n27_), .O(new_n54_));
  ...
  nand4  g38(.a(x13), .b(new_n56_), .c(x05), .d(new_n27_), .O(new_n64_));
