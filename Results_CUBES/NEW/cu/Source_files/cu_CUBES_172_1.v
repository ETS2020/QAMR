// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:53 2020
...
module FAU ( 
  ...
  nand2  g30(.a(x05), .b(new_n27_), .O(new_n56_));
  ...
  nand4  g40(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n62_), .c(new_n63_), .O(z08));
  and2   g42(.a(x13), .b(x06), .O(z09));
  nand3  g43(.a(x06), .b(new_n26_), .c(new_n27_), .O(new_n69_));
