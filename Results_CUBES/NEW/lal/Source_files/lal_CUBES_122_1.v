// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:58 2020
...
module FAU ( 
  ...
  inv1   g52(.a(x05), .O(new_n98_));
  xor2a  g53(.a(x18), .b(x17), .O(new_n99_));
  nand2  g54(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  inv1   g55(.a(x04), .O(new_n101_));
  nand2  g56(.a(x17), .b(new_n101_), .O(new_n102_));
  aoi21  g57(.a(new_n102_), .b(new_n100_), .c(new_n97_), .O(z11));
  nor2   g58(.a(new_n81_), .b(new_n79_), .O(new_n104_));
  xor2a  g59(.a(new_n104_), .b(x19), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n98_), .O(new_n106_));
  nand2  g61(.a(x19), .b(new_n101_), .O(new_n107_));
  aoi21  g62(.a(new_n107_), .b(new_n106_), .c(new_n97_), .O(z12));
  nand2  g63(.a(new_n104_), .b(x19), .O(new_n109_));
