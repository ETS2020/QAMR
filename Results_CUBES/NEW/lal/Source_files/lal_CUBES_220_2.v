// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:48 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n90_, new_n91_, new_n93_, new_n95_, new_n96_, new_n97_,
  ...
  nand3  g25(.a(new_n70_), .b(x18), .c(x17), .O(new_n71_));
  ...
  nand4  g31(.a(new_n49_), .b(new_n73_), .c(new_n72_), .d(x18), .O(new_n77_));
  ...
  nand4  g39(.a(x24), .b(x22), .c(x21), .d(new_n84_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n79_), .O(new_n86_));
  aoi21  g41(.a(new_n79_), .b(new_n49_), .c(new_n48_), .O(new_n87_));
  aoi21  g42(.a(new_n86_), .b(new_n83_), .c(new_n87_), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(new_n82_), .c(new_n78_), .O(z08));
  nor2   g44(.a(x15), .b(x07), .O(new_n90_));
  nand2  g45(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  inv1   g46(.a(new_n91_), .O(z09));
  nand3  g47(.a(new_n90_), .b(new_n54_), .c(new_n83_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(z10));
  nand2  g49(.a(x18), .b(new_n83_), .O(new_n95_));
  inv1   g50(.a(x18), .O(new_n96_));
  nand2  g51(.a(new_n96_), .b(x17), .O(new_n97_));
  nand2  g52(.a(new_n90_), .b(new_n54_), .O(new_n98_));
  aoi21  g53(.a(new_n97_), .b(new_n95_), .c(new_n98_), .O(z11));
  nand2  g54(.a(x19), .b(new_n96_), .O(new_n100_));
  aoi21  g55(.a(new_n100_), .b(new_n95_), .c(new_n98_), .O(z12));
  nand2  g56(.a(x18), .b(x17), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(x20), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n90_), .c(new_n71_), .d(new_n54_), .O(z13));
  nand2  g59(.a(new_n71_), .b(x21), .O(new_n105_));
  inv1   g60(.a(new_n102_), .O(new_n106_));
  nor2   g61(.a(x21), .b(x20), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g63(.a(new_n90_), .b(new_n54_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n105_), .O(z14));
  inv1   g66(.a(new_n71_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n73_), .c(new_n72_), .O(new_n113_));
  nand2  g68(.a(new_n108_), .b(x22), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n110_), .O(z15));
  nand2  g70(.a(new_n113_), .b(x23), .O(new_n116_));
  nor2   g71(.a(x23), .b(x22), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n112_), .c(new_n72_), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(new_n116_), .c(new_n110_), .O(z16));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n120_));
  nand4  g75(.a(new_n107_), .b(new_n74_), .c(new_n106_), .d(new_n73_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n120_), .c(new_n110_), .O(z17));
  oai21  g77(.a(new_n75_), .b(new_n71_), .c(x25), .O(new_n123_));
  inv1   g78(.a(new_n108_), .O(new_n124_));
  nand4  g79(.a(new_n117_), .b(new_n124_), .c(new_n79_), .d(new_n49_), .O(new_n125_));
