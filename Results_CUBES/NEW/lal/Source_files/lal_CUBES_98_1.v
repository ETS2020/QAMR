// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:45 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n89_, new_n90_, new_n92_, new_n94_, new_n96_, new_n98_, new_n99_,
  ...
  nand3  g25(.a(new_n70_), .b(x19), .c(x18), .O(new_n71_));
  ...
  nand3  g46(.a(new_n89_), .b(new_n54_), .c(new_n83_), .O(new_n92_));
  inv1   g47(.a(new_n92_), .O(z10));
  inv1   g48(.a(new_n89_), .O(new_n94_));
  nor4   g49(.a(new_n94_), .b(new_n55_), .c(x18), .d(new_n83_), .O(z11));
  xnor2a g50(.a(x19), .b(x18), .O(new_n96_));
  nor3   g51(.a(new_n96_), .b(new_n94_), .c(new_n55_), .O(z12));
  nand2  g52(.a(x19), .b(x18), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(x20), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n89_), .c(new_n71_), .d(new_n54_), .O(z13));
  nand2  g55(.a(new_n71_), .b(x21), .O(new_n101_));
  inv1   g56(.a(new_n98_), .O(new_n102_));
  nor2   g57(.a(x21), .b(x20), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g59(.a(new_n89_), .b(new_n54_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n104_), .c(new_n101_), .O(z14));
  inv1   g62(.a(new_n71_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n73_), .c(new_n72_), .O(new_n109_));
  nand2  g64(.a(new_n104_), .b(x22), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n106_), .O(z15));
  nand2  g66(.a(new_n109_), .b(x23), .O(new_n112_));
  nor2   g67(.a(x23), .b(x22), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n108_), .c(new_n72_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n112_), .c(new_n106_), .O(z16));
  nand2  g70(.a(new_n114_), .b(x24), .O(new_n116_));
  nand4  g71(.a(new_n103_), .b(new_n74_), .c(new_n102_), .d(new_n73_), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(new_n116_), .c(new_n106_), .O(z17));
  oai21  g73(.a(new_n75_), .b(new_n71_), .c(x25), .O(new_n119_));
  inv1   g74(.a(new_n104_), .O(new_n120_));
  nand4  g75(.a(new_n113_), .b(new_n120_), .c(new_n79_), .d(new_n49_), .O(new_n121_));
