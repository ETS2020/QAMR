// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:37 2020
...
module FAU ( 
  ...
  nor3   g35(.a(new_n59_), .b(x07), .c(new_n56_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x11), .c(new_n58_), .O(z4));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  oai21  g39(.a(new_n59_), .b(x03), .c(new_n30_), .O(new_n64_));
  aoi21  g40(.a(x08), .b(x00), .c(x01), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  inv1   g42(.a(x14), .O(new_n67_));
  oai21  g43(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n30_), .b(new_n56_), .O(new_n69_));
  oai21  g45(.a(x08), .b(new_n56_), .c(new_n69_), .O(new_n70_));
  nor2   g46(.a(new_n25_), .b(x00), .O(new_n71_));
  aoi22  g47(.a(new_n71_), .b(new_n67_), .c(new_n70_), .d(new_n68_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n66_), .c(new_n45_), .O(z6));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n75_), .c(new_n45_), .O(new_n80_));
  ...
  aoi21  g60(.a(new_n59_), .b(new_n56_), .c(new_n45_), .O(new_n85_));
