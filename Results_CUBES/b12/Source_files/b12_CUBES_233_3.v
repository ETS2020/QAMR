...
module FAU ( 
  ...
  aoi21  g39(.a(new_n63_), .b(new_n30_), .c(x00), .O(new_n64_));
  inv1   g40(.a(x08), .O(new_n65_));
  nand3  g41(.a(x09), .b(new_n65_), .c(new_n34_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n25_), .O(new_n68_));
  oai22  g44(.a(x14), .b(x00), .c(x08), .d(x02), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n70_));
  nor2   g46(.a(new_n30_), .b(new_n56_), .O(new_n71_));
  aoi22  g47(.a(new_n71_), .b(new_n65_), .c(new_n70_), .d(new_n69_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n68_), .c(new_n45_), .O(z6));
  nand3  g49(.a(x09), .b(x03), .c(new_n25_), .O(new_n74_));
  nand4  g50(.a(new_n41_), .b(new_n65_), .c(new_n40_), .d(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n30_), .O(new_n77_));
  oai21  g53(.a(x07), .b(new_n30_), .c(x03), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n65_), .c(new_n45_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n77_), .O(z7));
  nor2   g56(.a(x07), .b(x03), .O(new_n81_));
  inv1   g57(.a(x12), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n30_), .c(new_n25_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(x09), .O(new_n84_));
  nor2   g60(.a(x09), .b(x00), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n84_), .O(z8));
endmodule
