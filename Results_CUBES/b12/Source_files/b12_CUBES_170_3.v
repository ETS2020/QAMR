// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:17 2020
...
module FAU ( 
  ...
  nor2   g34(.a(x13), .b(x00), .O(new_n59_));
  ...
  nor2   g39(.a(new_n59_), .b(x00), .O(new_n64_));
  ...
  nand4  g61(.a(new_n63_), .b(x03), .c(new_n25_), .d(new_n27_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  aoi21  g63(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(new_n88_));
