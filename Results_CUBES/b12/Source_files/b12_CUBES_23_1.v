...
module FAU ( 
  ...
  oai21  g09(.a(new_n33_), .b(x05), .c(x02), .O(new_n34_));
  aoi21  g10(.a(new_n34_), .b(new_n29_), .c(x00), .O(z0));
  aoi21  g11(.a(x06), .b(x05), .c(new_n30_), .O(new_n36_));
  oai21  g12(.a(new_n36_), .b(new_n33_), .c(x02), .O(new_n37_));
  inv1   g13(.a(x01), .O(new_n38_));
  oai22  g14(.a(x06), .b(new_n31_), .c(x02), .d(new_n38_), .O(new_n39_));
  ...
  aoi21  g26(.a(new_n50_), .b(new_n46_), .c(x01), .O(new_n51_));
  nand4  g27(.a(new_n31_), .b(new_n30_), .c(new_n25_), .d(new_n38_), .O(new_n52_));
  and2   g28(.a(new_n52_), .b(x02), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n42_), .O(new_n54_));
  nand2  g30(.a(x10), .b(new_n25_), .O(new_n55_));
  nand2  g31(.a(new_n44_), .b(x09), .O(new_n56_));
  ...
  aoi22  g36(.a(x12), .b(new_n42_), .c(x11), .d(x07), .O(z3));
  nand2  g37(.a(x08), .b(x00), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n48_), .c(new_n43_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n48_), .b(x03), .c(new_n27_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n62_), .c(new_n38_), .O(new_n68_));
  inv1   g44(.a(x14), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n25_), .c(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n27_), .b(new_n42_), .O(new_n71_));
  oai21  g47(.a(x08), .b(new_n42_), .c(new_n71_), .O(new_n72_));
  nor2   g48(.a(new_n38_), .b(x00), .O(new_n73_));
  ...
  nand2  g56(.a(x03), .b(new_n38_), .O(new_n81_));
  ...
  aoi21  g62(.a(new_n48_), .b(new_n42_), .c(new_n45_), .O(new_n87_));
