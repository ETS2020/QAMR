// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:21 2020
...
module FAU ( 
  ...
  aoi21  g34(.a(x11), .b(new_n41_), .c(new_n58_), .O(new_n59_));
  oai21  g35(.a(x12), .b(x00), .c(new_n59_), .O(z3));
  ...
  aoi21  g40(.a(new_n64_), .b(x07), .c(new_n57_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z4));
  inv1   g42(.a(new_n46_), .O(new_n67_));
  nand2  g43(.a(x12), .b(new_n57_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n59_), .c(new_n67_), .d(x13), .O(z5));
  nand2  g45(.a(new_n62_), .b(x03), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n25_), .c(new_n57_), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n35_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x01), .c(new_n26_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n61_), .O(new_n74_));
  ...
  oai21  g54(.a(new_n78_), .b(new_n75_), .c(new_n57_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n74_), .c(new_n46_), .O(z6));
  nand3  g56(.a(x09), .b(x03), .c(new_n27_), .O(new_n81_));
  nand4  g57(.a(new_n42_), .b(new_n61_), .c(new_n41_), .d(x01), .O(new_n82_));
  ...
  aoi21  g61(.a(new_n85_), .b(new_n61_), .c(new_n46_), .O(new_n86_));
  ...
  nand2  g66(.a(new_n62_), .b(new_n57_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n67_), .O(z8));
endmodule
