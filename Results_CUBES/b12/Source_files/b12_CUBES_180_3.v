...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(new_n57_), .c(new_n58_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n56_), .O(z3));
  inv1   g37(.a(x08), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x07), .c(new_n57_), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x00), .c(new_n59_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n63_), .O(z4));
  nand4  g42(.a(new_n59_), .b(x13), .c(new_n58_), .d(new_n41_), .O(z5));
  oai21  g43(.a(new_n64_), .b(x03), .c(new_n30_), .O(new_n68_));
  ...
  nand2  g48(.a(new_n30_), .b(new_n56_), .O(new_n73_));
  oai21  g49(.a(x08), .b(new_n56_), .c(new_n73_), .O(new_n74_));
  nor2   g50(.a(new_n25_), .b(x00), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n71_), .c(new_n74_), .d(new_n72_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n70_), .c(new_n45_), .O(z6));
  nand3  g53(.a(x09), .b(x03), .c(new_n30_), .O(new_n78_));
  nand4  g54(.a(new_n41_), .b(new_n62_), .c(new_n40_), .d(x02), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n62_), .c(new_n45_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n81_), .O(z7));
  nand2  g60(.a(new_n58_), .b(new_n30_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n82_), .c(x09), .O(new_n86_));
  aoi21  g62(.a(new_n64_), .b(new_n56_), .c(new_n45_), .O(new_n87_));
