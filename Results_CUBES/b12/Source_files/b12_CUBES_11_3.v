...
module FAU ( 
  ...
  nand4  g48(.a(new_n41_), .b(new_n63_), .c(new_n40_), .d(x02), .O(new_n73_));
  oai21  g49(.a(new_n64_), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g51(.a(x03), .b(new_n25_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n63_), .c(new_n45_), .O(new_n77_));
  ...
  aoi21  g57(.a(new_n72_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(new_n72_), .c(new_n82_), .O(z8));
endmodule
