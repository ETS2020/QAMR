// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:49 2020
...
module FAU ( 
  ...
  nand4  g40(.a(new_n64_), .b(new_n62_), .c(new_n42_), .d(new_n41_), .O(z5));
  ...
  aoi21  g48(.a(new_n68_), .b(new_n27_), .c(x02), .O(new_n73_));
  nand2  g49(.a(x14), .b(x01), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n70_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n57_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n72_), .c(new_n46_), .O(z6));
  oai21  g54(.a(x10), .b(new_n27_), .c(new_n25_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n41_), .c(new_n35_), .O(new_n80_));
  nor2   g56(.a(new_n35_), .b(x01), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(x09), .c(new_n46_), .O(new_n82_));
  oai21  g58(.a(new_n80_), .b(x08), .c(new_n82_), .O(z7));
  nand2  g59(.a(new_n81_), .b(new_n62_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n67_), .b(new_n57_), .c(new_n46_), .O(new_n86_));
