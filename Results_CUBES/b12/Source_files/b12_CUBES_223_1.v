...
module FAU ( 
  ...
  oai21  g34(.a(new_n58_), .b(new_n56_), .c(new_n40_), .O(new_n59_));
  inv1   g35(.a(x08), .O(new_n60_));
  inv1   g36(.a(x11), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(x07), .c(new_n60_), .O(new_n62_));
  ...
  nand2  g46(.a(new_n30_), .b(new_n56_), .O(new_n71_));
  ...
  nand4  g52(.a(new_n41_), .b(new_n60_), .c(new_n40_), .d(x02), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n60_), .c(new_n45_), .O(new_n81_));
