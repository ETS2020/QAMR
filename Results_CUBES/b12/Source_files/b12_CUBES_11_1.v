...
module FAU ( 
  ...
  aoi21  g52(.a(x08), .b(x00), .c(x01), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  oai21  g55(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n30_), .b(new_n59_), .O(new_n81_));
  oai21  g57(.a(x08), .b(new_n59_), .c(new_n81_), .O(new_n82_));
  nor2   g58(.a(new_n25_), .b(x00), .O(new_n83_));
  aoi22  g59(.a(new_n83_), .b(new_n79_), .c(new_n82_), .d(new_n80_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n78_), .c(new_n46_), .O(z6));
  nand2  g61(.a(new_n38_), .b(x09), .O(new_n86_));
  nand4  g62(.a(new_n42_), .b(new_n63_), .c(new_n41_), .d(x02), .O(new_n87_));
  ...
  aoi21  g66(.a(new_n90_), .b(new_n63_), .c(new_n46_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n89_), .O(z7));
  nand3  g68(.a(new_n41_), .b(x01), .c(x00), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n38_), .c(new_n57_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  nand2  g71(.a(new_n30_), .b(x01), .O(new_n96_));
  oai21  g72(.a(new_n46_), .b(new_n96_), .c(x09), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n95_), .c(new_n70_), .O(z8));
endmodule
