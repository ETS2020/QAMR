...
module FAU ( 
  ...
  nand2  g33(.a(new_n57_), .b(x12), .O(z3));
  inv1   g34(.a(x00), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x07), .c(x11), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  inv1   g38(.a(x08), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n40_), .O(new_n65_));
  nand3  g41(.a(new_n56_), .b(x07), .c(x00), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n62_), .O(z4));
  nor2   g43(.a(x12), .b(x00), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  oai21  g45(.a(new_n64_), .b(x03), .c(new_n30_), .O(new_n70_));
  aoi21  g46(.a(x08), .b(x00), .c(x01), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  inv1   g48(.a(x14), .O(new_n73_));
  oai21  g49(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n30_), .b(new_n59_), .O(new_n75_));
  oai21  g51(.a(x08), .b(new_n59_), .c(new_n75_), .O(new_n76_));
  nor2   g52(.a(new_n25_), .b(x00), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n73_), .c(new_n76_), .d(new_n74_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n72_), .c(new_n45_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n30_), .O(new_n80_));
  nand4  g56(.a(new_n41_), .b(new_n63_), .c(new_n40_), .d(x02), .O(new_n81_));
  ...
  aoi21  g60(.a(new_n84_), .b(new_n63_), .c(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n83_), .O(z7));
  nand2  g62(.a(new_n60_), .b(new_n30_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n84_), .c(x09), .O(new_n88_));
  aoi21  g64(.a(new_n64_), .b(new_n59_), .c(new_n45_), .O(new_n89_));
