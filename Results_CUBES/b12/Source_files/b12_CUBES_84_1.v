...
module FAU ( 
  ...
  nand3  g29(.a(new_n53_), .b(new_n50_), .c(new_n40_), .O(new_n54_));
  ...
  oai22  g38(.a(new_n51_), .b(new_n56_), .c(new_n30_), .d(x01), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n34_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n30_), .c(x01), .O(new_n66_));
  nand2  g42(.a(x14), .b(x02), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x01), .O(new_n68_));
  nand3  g44(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n66_), .c(new_n56_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n64_), .c(new_n45_), .O(z6));
  nand3  g48(.a(x09), .b(x03), .c(new_n30_), .O(new_n73_));
  nand4  g49(.a(new_n41_), .b(new_n50_), .c(new_n40_), .d(x02), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n50_), .c(new_n45_), .O(new_n78_));
