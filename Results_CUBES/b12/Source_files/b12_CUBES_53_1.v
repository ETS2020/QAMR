// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:22 2020
...
module FAU ( 
  ...
  nand2  g33(.a(new_n57_), .b(x07), .O(new_n58_));
  aoi21  g34(.a(new_n57_), .b(x00), .c(new_n41_), .O(new_n59_));
  oai21  g35(.a(new_n58_), .b(x12), .c(new_n59_), .O(z3));
  oai21  g36(.a(x12), .b(x07), .c(new_n57_), .O(new_n61_));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n41_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n61_), .O(z4));
  inv1   g40(.a(x00), .O(new_n65_));
  nand4  g41(.a(x13), .b(new_n42_), .c(new_n41_), .d(new_n65_), .O(z5));
  inv1   g42(.a(x08), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x03), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n25_), .c(new_n65_), .O(new_n70_));
  nor2   g46(.a(new_n68_), .b(x03), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n27_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n26_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n70_), .c(new_n67_), .O(new_n74_));
  nand2  g50(.a(new_n69_), .b(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  oai21  g52(.a(new_n71_), .b(x02), .c(new_n27_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x02), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n65_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n74_), .c(new_n46_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n27_), .O(new_n83_));
  nand4  g59(.a(new_n42_), .b(new_n67_), .c(new_n41_), .d(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  oai21  g62(.a(x07), .b(new_n25_), .c(x03), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n67_), .c(new_n46_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  nand3  g65(.a(x03), .b(new_n25_), .c(new_n27_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  aoi21  g67(.a(new_n68_), .b(new_n65_), .c(new_n46_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(z8));
endmodule
