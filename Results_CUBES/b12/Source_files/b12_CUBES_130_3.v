...
module FAU ( 
  ...
  nand2  g02(.a(new_n25_), .b(x01), .O(new_n27_));
  ...
  nand4  g20(.a(new_n44_), .b(new_n31_), .c(new_n35_), .d(new_n41_), .O(new_n45_));
  ...
  aoi22  g24(.a(new_n48_), .b(new_n41_), .c(new_n45_), .d(x02), .O(new_n49_));
  ...
  oai21  g43(.a(new_n67_), .b(x01), .c(new_n27_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n63_), .O(new_n69_));
  aoi21  g45(.a(new_n67_), .b(new_n25_), .c(x01), .O(new_n70_));
  nand2  g46(.a(x14), .b(x02), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x01), .O(new_n72_));
  oai21  g48(.a(new_n65_), .b(x02), .c(new_n72_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n70_), .c(new_n56_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n69_), .c(new_n44_), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n41_), .O(new_n76_));
  nand4  g52(.a(new_n43_), .b(new_n63_), .c(new_n42_), .d(x01), .O(new_n77_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n63_), .c(new_n44_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z7));
  inv1   g58(.a(x12), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(x03), .c(new_n25_), .d(new_n41_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n64_), .b(new_n56_), .c(new_n44_), .O(new_n86_));
