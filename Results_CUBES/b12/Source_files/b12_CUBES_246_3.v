...
module FAU ( 
  ...
  nand4  g36(.a(x13), .b(new_n41_), .c(new_n40_), .d(new_n56_), .O(z5));
  inv1   g37(.a(x08), .O(new_n62_));
  aoi21  g38(.a(x09), .b(new_n34_), .c(x02), .O(new_n63_));
  inv1   g39(.a(x09), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(x03), .c(new_n30_), .O(new_n65_));
  oai21  g41(.a(new_n63_), .b(x01), .c(new_n65_), .O(new_n66_));
  oai21  g42(.a(new_n62_), .b(new_n56_), .c(new_n66_), .O(new_n67_));
  ...
  nand4  g48(.a(new_n41_), .b(new_n62_), .c(new_n40_), .d(x02), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n76_), .b(new_n62_), .c(new_n45_), .O(new_n77_));
  ...
  aoi21  g57(.a(new_n64_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
