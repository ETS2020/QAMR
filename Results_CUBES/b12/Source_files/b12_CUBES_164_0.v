...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n73_, new_n75_, new_n77_, new_n78_, new_n79_, new_n80_;
  ...
  aoi21  g25(.a(x10), .b(x03), .c(x01), .O(new_n50_));
  ...
  oai22  g38(.a(new_n62_), .b(new_n54_), .c(x03), .d(x01), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  oai21  g40(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n30_), .O(new_n66_));
  ...
  aoi21  g49(.a(new_n73_), .b(new_n64_), .c(new_n45_), .O(z6));
  nand3  g50(.a(new_n62_), .b(x09), .c(x03), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n41_), .c(x08), .d(new_n40_), .O(z7));
  inv1   g52(.a(x12), .O(new_n77_));
  nand3  g53(.a(new_n62_), .b(new_n77_), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x09), .O(new_n79_));
  aoi21  g55(.a(new_n67_), .b(new_n54_), .c(new_n45_), .O(new_n80_));
