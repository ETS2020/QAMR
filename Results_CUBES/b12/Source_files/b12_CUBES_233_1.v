// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:41 2020
...
module FAU ( 
  ...
  oai21  g38(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n63_));
  oai21  g39(.a(x02), .b(x00), .c(x08), .O(new_n64_));
  ...
  oai21  g44(.a(x01), .b(x00), .c(x08), .O(new_n69_));
  nor2   g45(.a(new_n25_), .b(x00), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n66_), .c(new_n69_), .d(new_n68_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n65_), .c(new_n45_), .O(z6));
  oai21  g48(.a(x10), .b(new_n25_), .c(new_n30_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n40_), .c(new_n34_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x01), .O(new_n75_));
  nor2   g51(.a(new_n67_), .b(new_n34_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(new_n45_), .O(new_n77_));
  oai21  g53(.a(new_n74_), .b(x08), .c(new_n77_), .O(z7));
  inv1   g54(.a(x12), .O(new_n79_));
  nand3  g55(.a(new_n75_), .b(new_n79_), .c(x03), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x09), .O(new_n81_));
  aoi21  g57(.a(new_n67_), .b(new_n56_), .c(new_n45_), .O(new_n82_));
