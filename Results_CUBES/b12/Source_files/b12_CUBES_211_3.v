...
module FAU ( 
  ...
  oai21  g31(.a(x12), .b(new_n40_), .c(x00), .O(new_n56_));
  inv1   g32(.a(x00), .O(new_n57_));
  nor2   g33(.a(x11), .b(new_n40_), .O(new_n58_));
  aoi21  g34(.a(new_n40_), .b(new_n57_), .c(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(x12), .c(new_n56_), .O(z3));
  inv1   g36(.a(x12), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  nor2   g38(.a(x12), .b(x11), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n61_), .b(x07), .O(new_n65_));
  aoi21  g41(.a(x09), .b(x08), .c(x07), .O(new_n66_));
  aoi21  g42(.a(new_n65_), .b(new_n57_), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n64_), .O(z4));
  inv1   g44(.a(new_n45_), .O(new_n69_));
  nand2  g45(.a(x12), .b(new_n57_), .O(new_n70_));
  nand2  g46(.a(new_n40_), .b(x00), .O(new_n71_));
  ...
  aoi21  g50(.a(x08), .b(x00), .c(x01), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  inv1   g52(.a(x14), .O(new_n77_));
  oai21  g53(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n78_));
  nand2  g54(.a(new_n30_), .b(new_n57_), .O(new_n79_));
  oai21  g55(.a(x08), .b(new_n57_), .c(new_n79_), .O(new_n80_));
  nor2   g56(.a(new_n25_), .b(x00), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(new_n77_), .c(new_n80_), .d(new_n78_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n76_), .c(new_n45_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n30_), .O(new_n84_));
  inv1   g60(.a(x08), .O(new_n85_));
  nand4  g61(.a(new_n41_), .b(new_n85_), .c(new_n40_), .d(x02), .O(new_n86_));
  ...
  aoi21  g65(.a(new_n89_), .b(new_n85_), .c(new_n45_), .O(new_n90_));
  ...
  aoi21  g69(.a(new_n73_), .b(new_n57_), .c(new_n45_), .O(new_n94_));
