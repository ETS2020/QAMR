// Benchmark "FAU" written by ABC on Mon Jul  6 13:27:20 2020
...
module FAU ( 
  ...
  oai21  g33(.a(x13), .b(x07), .c(x11), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  inv1   g35(.a(x08), .O(new_n60_));
  inv1   g36(.a(x09), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(new_n62_));
  inv1   g38(.a(x11), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(x07), .c(x00), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n59_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(new_n40_), .c(x12), .d(new_n63_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n41_), .c(new_n40_), .d(new_n56_), .O(z5));
  oai21  g44(.a(new_n61_), .b(x03), .c(new_n30_), .O(new_n69_));
  ...
  nand2  g49(.a(new_n30_), .b(new_n56_), .O(new_n74_));
  oai21  g50(.a(x08), .b(new_n56_), .c(new_n74_), .O(new_n75_));
  nor2   g51(.a(new_n25_), .b(x00), .O(new_n76_));
  aoi22  g52(.a(new_n76_), .b(new_n72_), .c(new_n75_), .d(new_n73_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n71_), .c(new_n45_), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n30_), .O(new_n79_));
  nand4  g55(.a(new_n41_), .b(new_n60_), .c(new_n40_), .d(x02), .O(new_n80_));
  ...
  aoi21  g59(.a(new_n83_), .b(new_n60_), .c(new_n45_), .O(new_n84_));
  ...
  aoi21  g64(.a(new_n61_), .b(new_n56_), .c(new_n45_), .O(new_n89_));
