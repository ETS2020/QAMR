// Benchmark "FAU" written by ABC on Mon Jul  6 13:25:58 2020
...
module FAU ( 
  ...
  nand2  g42(.a(new_n30_), .b(new_n56_), .O(new_n67_));
  oai21  g43(.a(x08), .b(new_n56_), .c(new_n67_), .O(new_n68_));
  nor2   g44(.a(x14), .b(new_n30_), .O(new_n69_));
  aoi21  g45(.a(new_n68_), .b(new_n66_), .c(new_n69_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n65_), .c(new_n45_), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n30_), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand4  g49(.a(new_n41_), .b(new_n73_), .c(new_n40_), .d(x02), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n73_), .c(new_n45_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(z7));
  inv1   g55(.a(x12), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n30_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n77_), .c(x09), .O(new_n82_));
  aoi21  g58(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n83_));
