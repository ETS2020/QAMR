// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:24 2020
...
module FAU ( 
  ...
  nand3  g39(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n64_));
  oai21  g40(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  inv1   g41(.a(x09), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x03), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n34_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n30_), .c(x01), .O(new_n71_));
  ...
  nor2   g52(.a(x09), .b(x02), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x07), .c(x03), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n63_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x01), .O(new_n80_));
  nor2   g56(.a(new_n66_), .b(new_n34_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(z7));
  nand2  g59(.a(x03), .b(new_n30_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x12), .c(x09), .O(new_n85_));
  nand2  g61(.a(new_n66_), .b(new_n56_), .O(new_n86_));
  nor3   g62(.a(x10), .b(x07), .c(x01), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(z8));
endmodule
