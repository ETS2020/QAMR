...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n42_), .c(new_n41_), .O(z5));
  inv1   g42(.a(x02), .O(new_n67_));
  oai21  g43(.a(new_n59_), .b(x03), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n60_), .c(new_n25_), .O(new_n69_));
  inv1   g45(.a(x14), .O(new_n70_));
  oai21  g46(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n67_), .b(new_n57_), .O(new_n72_));
  oai21  g48(.a(x08), .b(new_n57_), .c(new_n72_), .O(new_n73_));
  nor2   g49(.a(new_n25_), .b(x00), .O(new_n74_));
  aoi22  g50(.a(new_n74_), .b(new_n70_), .c(new_n73_), .d(new_n71_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n69_), .c(new_n46_), .O(z6));
  nand2  g52(.a(new_n38_), .b(x09), .O(new_n77_));
  inv1   g53(.a(x08), .O(new_n78_));
  nand4  g54(.a(new_n42_), .b(new_n78_), .c(new_n41_), .d(x02), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n78_), .c(new_n46_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n81_), .O(z7));
  nand3  g60(.a(new_n46_), .b(new_n31_), .c(new_n25_), .O(new_n85_));
  nor2   g61(.a(new_n46_), .b(x09), .O(new_n86_));
  aoi22  g62(.a(new_n86_), .b(new_n38_), .c(new_n85_), .d(x02), .O(new_n87_));
  nor2   g63(.a(x02), .b(x01), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n63_), .c(new_n59_), .O(new_n89_));
  aoi21  g65(.a(new_n59_), .b(x00), .c(x03), .O(new_n90_));
  nor3   g66(.a(new_n90_), .b(new_n89_), .c(new_n46_), .O(new_n91_));
  oai21  g67(.a(new_n87_), .b(x00), .c(new_n91_), .O(z8));
endmodule
