...
module FAU ( 
  ...
  nand4  g37(.a(x13), .b(new_n42_), .c(new_n41_), .d(new_n57_), .O(z5));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n70_), .c(new_n46_), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n27_), .O(new_n79_));
  nand3  g55(.a(new_n42_), .b(new_n63_), .c(x01), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(x02), .O(new_n81_));
  aoi21  g57(.a(new_n63_), .b(x02), .c(new_n81_), .O(new_n82_));
  nand2  g58(.a(new_n63_), .b(new_n35_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n82_), .c(new_n42_), .d(new_n41_), .O(z7));
  nand3  g60(.a(x03), .b(new_n25_), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  aoi21  g62(.a(new_n64_), .b(new_n57_), .c(new_n46_), .O(new_n87_));
