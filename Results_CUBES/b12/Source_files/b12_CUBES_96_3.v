...
module FAU ( 
  ...
  nand3  g53(.a(new_n41_), .b(new_n77_), .c(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n40_), .c(new_n25_), .O(new_n80_));
  ...
  aoi21  g62(.a(new_n65_), .b(new_n56_), .c(new_n45_), .O(new_n87_));
