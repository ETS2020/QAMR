...
module FAU ( 
  ...
  nor2   g38(.a(x09), .b(new_n34_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x01), .c(x00), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x03), .c(new_n30_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n64_), .c(x08), .O(new_n68_));
  nor2   g44(.a(x14), .b(new_n25_), .O(new_n69_));
  aoi21  g45(.a(new_n63_), .b(new_n30_), .c(new_n69_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n67_), .c(x00), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n41_), .O(new_n72_));
  nand4  g48(.a(x14), .b(new_n30_), .c(x01), .d(new_n56_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x07), .O(z6));
  ...
  aoi21  g61(.a(new_n65_), .b(new_n56_), .c(new_n45_), .O(new_n86_));
