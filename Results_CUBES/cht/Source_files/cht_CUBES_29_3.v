// Benchmark "FAU" written by ABC on Mon Jul  6 13:18:16 2020
...
module FAU ( 
  ...
  nand3  g098(.a(new_n175_), .b(x40), .c(new_n181_), .O(new_n182_));
  oai21  g099(.a(new_n175_), .b(new_n180_), .c(new_n182_), .O(z29));
  nand3  g100(.a(new_n177_), .b(x42), .c(new_n181_), .O(new_n184_));
  oai21  g101(.a(new_n177_), .b(new_n180_), .c(new_n184_), .O(z30));
