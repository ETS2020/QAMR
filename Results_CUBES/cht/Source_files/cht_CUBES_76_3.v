...
module FAU ( 
  ...
  inv1   g093(.a(x10), .O(new_n177_));
  nand3  g094(.a(new_n176_), .b(x39), .c(new_n177_), .O(new_n178_));
  oai21  g095(.a(new_n176_), .b(new_n174_), .c(new_n178_), .O(z28));
  nor2   g096(.a(x14), .b(new_n146_), .O(new_n180_));
  nand3  g097(.a(new_n180_), .b(x41), .c(new_n177_), .O(new_n181_));
  oai21  g098(.a(new_n180_), .b(new_n174_), .c(new_n181_), .O(z29));
  ...
  nand2  g115(.a(new_n180_), .b(x00), .O(new_n199_));
