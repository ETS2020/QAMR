// Benchmark "FAU" written by ABC on Mon Jul  6 13:19:27 2020
...
module FAU ( 
  ...
  inv1   g082(.a(x10), .O(new_n166_));
  nand3  g083(.a(x37), .b(new_n166_), .c(new_n146_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n165_), .O(z26));
  inv1   g085(.a(x39), .O(new_n169_));
  nand2  g086(.a(x14), .b(x00), .O(new_n170_));
  oai21  g087(.a(new_n169_), .b(x14), .c(new_n170_), .O(new_n171_));
  nor2   g088(.a(x10), .b(new_n146_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand2  g090(.a(x38), .b(new_n146_), .O(new_n174_));
  ...
  nand3  g095(.a(x40), .b(new_n176_), .c(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z28));
  nand2  g097(.a(new_n177_), .b(x40), .O(new_n181_));
  nand3  g098(.a(x41), .b(new_n176_), .c(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z29));
  nand2  g100(.a(new_n177_), .b(x41), .O(new_n184_));
  nand3  g101(.a(x42), .b(new_n176_), .c(x09), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z30));
  nand2  g103(.a(new_n177_), .b(x42), .O(new_n187_));
  nand3  g104(.a(x43), .b(new_n176_), .c(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z31));
  nand2  g106(.a(new_n177_), .b(x43), .O(new_n190_));
  nand3  g107(.a(x44), .b(new_n176_), .c(x09), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z32));
  nand2  g109(.a(new_n177_), .b(x44), .O(new_n193_));
  nand3  g110(.a(x45), .b(new_n176_), .c(x09), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z33));
  nand2  g112(.a(new_n177_), .b(x45), .O(new_n196_));
  nand3  g113(.a(x46), .b(new_n176_), .c(x09), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z34));
  nand2  g115(.a(new_n177_), .b(x46), .O(new_n199_));
  nand3  g116(.a(new_n176_), .b(x09), .c(x00), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z35));
endmodule
