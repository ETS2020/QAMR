...
module FAU ( 
  ...
  nand3  g101(.a(new_n175_), .b(x41), .c(new_n184_), .O(new_n185_));
  oai21  g102(.a(new_n175_), .b(new_n183_), .c(new_n185_), .O(z30));
  nand3  g103(.a(new_n177_), .b(x43), .c(new_n184_), .O(new_n187_));
  oai21  g104(.a(new_n177_), .b(new_n183_), .c(new_n187_), .O(z31));
