...
module FAU ( 
  ...
  inv1   g099(.a(x10), .O(new_n183_));
  nand2  g100(.a(x41), .b(new_n183_), .O(new_n184_));
  nor2   g101(.a(new_n184_), .b(new_n177_), .O(z30));
  nand3  g102(.a(new_n177_), .b(x43), .c(new_n183_), .O(new_n186_));
