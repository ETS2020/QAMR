// Benchmark "FAU" written by ABC on Mon Jul  6 13:18:09 2020
...
module FAU ( 
  ...
  aoi21  g066(.a(new_n149_), .b(x09), .c(x10), .O(z21));
  nand2  g067(.a(x33), .b(new_n146_), .O(new_n151_));
  ...
  nor2   g091(.a(x14), .b(new_n146_), .O(new_n175_));
