// Benchmark "FAU" written by ABC on Mon Jul  6 13:19:21 2020
...
module FAU ( 
  ...
  nand3  g022(.a(x17), .b(new_n105_), .c(new_n103_), .O(new_n106_));
  oai21  g023(.a(new_n104_), .b(new_n103_), .c(new_n106_), .O(z06));
  nand3  g024(.a(x19), .b(new_n105_), .c(x08), .O(new_n108_));
  oai21  g025(.a(new_n104_), .b(x08), .c(new_n108_), .O(z07));
